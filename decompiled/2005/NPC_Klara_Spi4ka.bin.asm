...
0x554: Push("head")
0x555: @ LookAsyncCamera(Stack[-1])
0x556: Pop(1)
0x557: @ CameraWaitForPlayFinish()
0x558: Pop(0)
0x559: @ ResumeWorld()
0x55a: Pop(0)
0x55b: Stack[-21] = (bool) 1
0x55c: Return(); Pop(18)

0x55d: PushEmpty(bool, bool)
0x55e: @ CameraSwitchToNormal()
0x55f: Pop(0)
...
0x56a: Push("head")
0x56b: @ UnlookAsync(Stack[-1])
0x56c: Pop(1)
0x56d: Return(); Pop(2)

0x56e: PushEmpty(int, int, int, int)
0x56f: Push("voice_common")
0x570: @ GetVariable(Stack[-1], Stack[-3])
0x571: Pop(1)
0x572: Push(Stack[-2])
0x573: IF (Stack[-1] == 0) GOTO 0x594; Pop(1)
...
0x588: Push((int) 1)
0x589: Pop(1); Push(Stack[-4] + Stack[-1]);
0x58a: Push((int) 3)
0x58b: Pop(2); Push(Stack[-2] % Stack[-1]);
0x58c: @ SetVariable(Stack[-2], Stack[-1])
0x58d: Pop(2)
0x58e: GOTO 0x593

0x58f: Push("voice_common")
0x590: Push((int) 0)
...
0x5a0: Stack[-6] = (bool) 0
0x5a1: Return(); Pop(4)

0x5a2: Push("voice_common")
0x5a3: Push((int) 1)
0x5a4: @ SetVariable(Stack[-2], Stack[-1])
0x5a5: Pop(2)
0x5a6: Stack[-6] = (bool) 1
0x5a7: Return(); Pop(4)

0x5a8: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x5a9: Stack[-5] = "c"
0x5aa: Stack[-4] = (int) 0
0x5ab: Push((int) 1)
...
0x5ad: Push((int) 1)
0x5ae: Pop(1); Push(Stack[-5] + Stack[-1]);
0x5af: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5b0: @@ HasProperty(Stack[-1], Stack[-4])
0x5b1: Pop(1)
0x5b2: Pop(0); Push((bool) Stack[-3] == 0)
0x5b3: IF (Stack[-1] == 0) GOTO 0x5b5; Pop(1)

0x5b4: GOTO 0x5b8

0x5b5: Push((int) 1)
0x5b6: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x5b7: GOTO 0x5ab

0x5b8: Pop(0); Push((bool) Stack[-4] == 0)
0x5b9: IF (Stack[-1] == 0) GOTO 0x5bc; Pop(1)

0x5ba: Stack[-12] = (bool) 0
0x5bb: Return(); Pop(10)

0x5bc: Stack[-2] = (int) 0
0x5bd: Push((int) 1)
0x5be: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x5bf: IF (Stack[-1] == 0) GOTO 0x5c2; Pop(1)

0x5c0: @ irand(Stack[-2], Stack[-4])
0x5c1: Pop(0)
0x5c2: Push((int) 1)
0x5c3: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5c4: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5c5: @@ GetProperty(Stack[-1], Stack[-2])
0x5c6: Pop(1)
0x5c7: PushEmpty(bool, string)
0x5c8: Stack[-1] = Stack[-3]
0x5c9: Call2 0x617

0x5ca: Stack[-14] = Stack[-2]
0x5cb: Pop(2)
0x5cc: Return(); Pop(10)

0x5cd: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x5ce: Push("d")
0x5cf: PushEmpty(int)
0x5d0: Call2 0x642
...
0x5d3: Push("m")
0x5d4: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5d5: Stack[-4] = (int) 0
0x5d6: Push((int) 1)
0x5d7: IF (Stack[-1] == 0) GOTO 0x5e3; Pop(1)

0x5d8: Push((int) 1)
0x5d9: Pop(1); Push(Stack[-5] + Stack[-1]);
0x5da: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5db: @@ HasProperty(Stack[-1], Stack[-4])
0x5dc: Pop(1)
0x5dd: Pop(0); Push((bool) Stack[-3] == 0)
0x5de: IF (Stack[-1] == 0) GOTO 0x5e0; Pop(1)

0x5df: GOTO 0x5e3

0x5e0: Push((int) 1)
0x5e1: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x5e2: GOTO 0x5d6

0x5e3: Pop(0); Push((bool) Stack[-4] == 0)
0x5e4: IF (Stack[-1] == 0) GOTO 0x5e7; Pop(1)

0x5e5: Stack[-12] = (bool) 0
0x5e6: Return(); Pop(10)

0x5e7: Stack[-2] = (int) 0
0x5e8: Push((int) 1)
0x5e9: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x5ea: IF (Stack[-1] == 0) GOTO 0x5ed; Pop(1)

0x5eb: @ irand(Stack[-2], Stack[-4])
0x5ec: Pop(0)
0x5ed: Push((int) 1)
0x5ee: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5ef: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5f0: @@ GetProperty(Stack[-1], Stack[-2])
0x5f1: Pop(1)
0x5f2: PushEmpty(bool, string)
0x5f3: Stack[-1] = Stack[-3]
0x5f4: Call2 0x617

0x5f5: Stack[-14] = Stack[-2]
0x5f6: Pop(2)
0x5f7: Return(); Pop(10)

0x5f8: PushEmpty(bool, float, float, bool, float, float)
0x5f9: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5fa: Pop(0)
0x5fb: Push(Stack[-3])
0x5fc: IF (Stack[-1] == 0) GOTO 0x603; Pop(1)

0x5fd: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5fe: Pop(0)
0x5ff: Push((bool) 0)
0x600: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x601: Pop(1)
0x602: GOTO 0x607
...
0x608: PushEmpty(bool, float, float, bool, float, float)
0x609: @ lshHasAnimation(Stack[-3], Stack[-8])
0x60a: Pop(0)
0x60b: Push(Stack[-3])
0x60c: IF (Stack[-1] == 0) GOTO 0x612; Pop(1)

0x60d: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x60e: Pop(0)
0x60f: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x610: Pop(0)
0x611: GOTO 0x616

0x612: Push("Can't find lsh animation : ")
0x613: Pop(1); Push(Stack[-1] + Stack[-9]);
0x614: @ Trace(Stack[-1])
0x615: Pop(1)
0x616: Return(); Pop(6)
...
0x61a: Pop(0)
0x61b: IF (Stack[-1] == 0) GOTO 0x624; Pop(1)

0x61c: @ lshHasSpeech(Stack[-1], Stack[-3])
0x61d: Pop(0)
0x61e: Push(Stack[-1])
0x61f: IF (Stack[-1] == 0) GOTO 0x624; Pop(1)

0x620: @ lshPlaySpeech(Stack[-3])
0x621: Pop(0)
0x622: Stack[-4] = (bool) 1
0x623: Return(); Pop(2)

0x624: Stack[-4] = (bool) 0
0x625: Return(); Pop(2)
...
0x632: Stack[-1] = 0
0x633: PushEmpty(float, float)
0x634: Pop(0); Push(Stack[-3] | Stack[-3]);
0x635: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x636: Push((float)0.0)
0x637: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x638: IF (Stack[-1] == 0) GOTO 0x63b; Pop(1)

0x639: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x63a: Return(); Pop(2)

0x63b: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x63c: Return(); Pop(2)

0x63d: PushEmpty(int, int)
0x63e: @ GetVariable(Stack[-3], Stack[-1])
0x63f: Pop(0)
0x640: Stack[-4] = Stack[-1]
0x641: Return(); Pop(2)

0x642: PushEmpty(float, float)
0x643: @ GetGameTime(Stack[-1])
0x644: Pop(0)
0x645: Push((int) 1)
0x646: PushEmpty(int)
0x647: Push((int) 24)
0x648: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x649: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x64a: Return(); Pop(2)
...
0x64e: Pop(0)
0x64f: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x650: Return(); Pop(0)

0x651: PushEmpty(string, string)
0x652: Stack[-1] = "idle"
0x653: Push(Stack[-3])
0x654: IF (Stack[-1] == 0) GOTO 0x656; Pop(1)

0x655: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x656: Stack[-4] = Stack[-1]
0x657: Return(); Pop(2)

0x658: PushEmpty(int, bool, int, bool)
0x659: Stack[-2] = (int) 0
0x65a: Push("all")
0x65b: PushEmpty(string, int)
0x65c: Stack[-1] = Stack[-5]
0x65d: Call2 0x651

0x65e: Pop(1)
0x65f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x660: Pop(2)
0x661: Pop(0); Push((bool) Stack[-1] == 0)
0x662: IF (Stack[-1] == 0) GOTO 0x664; Pop(1)

0x663: GOTO 0x667

0x664: Push((int) 1)
0x665: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x666: GOTO 0x65a

0x667: Stack[-5] = Stack[-2]
0x668: Return(); Pop(4)

0x669: Stack[-1] = (int) 515552
0x66a: Return(); Pop(0)

0x66b: Stack[-1] = (int) 502877
0x66c: Return(); Pop(0)

0x66d: Stack[-1] = "ui/NPC_Spi4ka.png"
0x66e: Return(); Pop(0)

0x66f: Stack[-1] = "ui/NPC_Spi4ka_b.png"
0x670: Return(); Pop(0)
...
0x6bc: Stack[-2] = 0
0x6bd: Stack[-3] = 0
0x6be: PushEmpty(int, int)
0x6bf: Push("branch")
0x6c0: @ GetVariable(Stack[-1], Stack[-2])
0x6c1: Pop(1)
0x6c2: Push((int) 0)
...
0x6d0: Push("mt_spi4ka")
0x6d1: @ GetVariable(Stack[-1], Stack[-2])
0x6d2: Pop(1)
0x6d3: Pop(0); Push((bool) Stack[-1] == 0)
0x6d4: IF (Stack[-1] == 0) GOTO 0x6df; Pop(1)

0x6d5: PushEmpty(int, object)
0x6d6: Stack[-1] = Stack[-5]
0x6d7: Push(-2, 1); TaskCall(0)
0x6d8: Call2 0x0

0x6d9: Pop(-2, 1); TaskReturn
0x6da: Pop(2)
0x6db: Push("mt_spi4ka")
0x6dc: Push((int) 1)
0x6dd: @ SetVariable(Stack[-2], Stack[-1])
0x6de: Pop(2)
0x6df: PushEmpty(bool, int)
0x6e0: Stack[-1] = (int) 8
0x6e1: Call2 0x64b
...
0x6eb: PushEmpty(bool, int)
0x6ec: Stack[-1] = (int) 12
0x6ed: Call2 0x64b

0x6ee: Pop(1)
0x6ef: IF (Stack[-1] == 0) GOTO 0x6f7; Pop(1)

0x6f0: PushEmpty(int, object)
0x6f1: Stack[-1] = Stack[-5]
0x6f2: Push(-2, 1); TaskCall(4)
0x6f3: Call2 0x22b

0x6f4: Pop(-2, 1); TaskReturn
0x6f5: Pop(2)
0x6f6: Return(); Pop(2)

0x6f7: PushEmpty(int, object)
0x6f8: Stack[-1] = Stack[-5]
0x6f9: Push(-2, 1); TaskCall(6)
0x6fa: Call2 0x32e

0x6fb: Pop(-2, 1); TaskReturn
0x6fc: Pop(2)
0x6fd: Return(); Pop(2)
