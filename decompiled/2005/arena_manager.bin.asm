...
0x4bf: @ StopWorld()
0x4c0: Pop(0)
0x4c1: @ CameraTransit(Stack[-3], Stack[-5])
0x4c2: Pop(0)
0x4c3: Push(CvectorIndex(Stack[-4], 0))
0x4c4: Push(CvectorIndex(Stack[-5], 2))
0x4c5: @ Rotate(Stack[-2], Stack[-1])
0x4c6: Pop(2)
...
0x4cc: Push("head")
0x4cd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4ce: Pop(1)
0x4cf: Push(Stack[-1])
0x4d0: IF (Stack[-1] == 0) GOTO 0x4d4; Pop(1)

0x4d1: Push("head")
0x4d2: @ LookAsyncCamera(Stack[-1])
0x4d3: Pop(1)
0x4d4: @ CameraWaitForPlayFinish()
0x4d5: Pop(0)
0x4d6: @ ResumeWorld()
0x4d7: Pop(0)
0x4d8: Stack[-21] = (bool) 1
0x4d9: Return(); Pop(18)

0x4da: PushEmpty(bool, bool)
0x4db: @ CameraSwitchToNormal()
0x4dc: Pop(0)
...
0x4e2: Push("head")
0x4e3: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4e4: Pop(1)
0x4e5: Push(Stack[-1])
...
0x4eb: PushEmpty(bool, int, bool, int)
...
0x4ef: Push("noaccess")
0x4f0: @@ HasProperty(Stack[-1], Stack[-3])
0x4f1: Pop(1)
0x4f2: Push(Stack[-2])
0x4f3: IF (Stack[-1] == 0) GOTO 0x4fd; Pop(1)

0x4f4: Push("noaccess")
0x4f5: @@ GetProperty(Stack[-1], Stack[-2])
0x4f6: Pop(1)
0x4f7: Push("noaccess")
0x4f8: Push((int) 1)
...
0x502: PushEmpty(int, int)
0x503: Pop(0); Push((bool) Stack[-3] == 0)
0x504: IF (Stack[-1] == 0) GOTO 0x506; Pop(1)

0x505: Return(); Pop(2)

0x506: Push("noaccess")
0x507: @@ GetProperty(Stack[-1], Stack[-2])
0x508: Pop(1)
0x509: Push((int) 1)
...
0x50c: Push("noaccess")
0x50d: Push((int) 1)
0x50e: Pop(1); Push(Stack[-3] - Stack[-1]);
0x50f: @@ SetProperty(Stack[-2], Stack[-1])
0x510: Pop(2)
0x511: GOTO 0x515

0x512: Push("noaccess")
0x513: @@ RemoveProperty(Stack[-1])
0x514: Pop(1)
0x515: Return(); Pop(2)

0x516: PushEmpty(bool, float, float, bool, float, float)
0x517: @ lshHasAnimation(Stack[-3], Stack[-7])
0x518: Pop(0)
0x519: Push(Stack[-3])
0x51a: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x51b: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x51c: Pop(0)
0x51d: Push((bool) 0)
0x51e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x51f: Pop(1)
0x520: GOTO 0x525

0x521: Push("Can't find lsh animation : ")
0x522: Pop(1); Push(Stack[-1] + Stack[-8]);
0x523: @ Trace(Stack[-1])
0x524: Pop(1)
0x525: Return(); Pop(6)

0x526: PushEmpty(bool, float, float, bool, float, float)
0x527: @ lshHasAnimation(Stack[-3], Stack[-8])
0x528: Pop(0)
0x529: Push(Stack[-3])
0x52a: IF (Stack[-1] == 0) GOTO 0x530; Pop(1)

0x52b: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x52c: Pop(0)
0x52d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x52e: Pop(0)
0x52f: GOTO 0x534

0x530: Push("Can't find lsh animation : ")
0x531: Pop(1); Push(Stack[-1] + Stack[-9]);
0x532: @ Trace(Stack[-1])
0x533: Pop(1)
0x534: Return(); Pop(6)

0x535: PushEmpty(object, int, int, object, int, object, int, int, object, int)
0x536: PushEmpty(object)
0x537: Call2 0x5a2

0x538: Stack[-6] = Stack[-1]
0x539: Pop(1)
0x53a: @@ GetItemCount(Stack[-4], Stack[-12])
0x53b: Pop(0)
0x53c: Stack[-3] = (int) 0
0x53d: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x53e: IF (Stack[-1] == 0) GOTO 0x54b; Pop(1)

0x53f: @@ GetItem(Stack[-2], Stack[-3], Stack[-12])
0x540: Pop(0)
0x541: @@ add(Stack[-2])
0x542: Pop(0)
0x543: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12])
0x544: Pop(0)
0x545: @@ add(Stack[-1])
0x546: Pop(0)
0x547: Stack[-2] = 0
0x548: Push((int) 1)
0x549: Stack[-4] = Stack[-4] + Stack[-1]; Pop(1);
0x54a: GOTO 0x53d

0x54b: Stack[-14] = Stack[-5]
0x54c: Return(); Pop(10)

0x54d: Stack[-5] = 0
0x54e: PushEmpty(object, int, int, bool, object, int, int, bool)
0x54f: @ CreateIntVector(Stack[-4])
0x550: Pop(0)
0x551: @@ GetItemCount(Stack[-3], Stack[-9])
0x552: Pop(0)
0x553: Stack[-2] = (int) 0
0x554: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x555: IF (Stack[-1] == 0) GOTO 0x55f; Pop(1)

0x556: @@ IsItemSelected(Stack[-1], Stack[-2], Stack[-9])
0x557: Pop(0)
0x558: Push(Stack[-1])
...
0x55b: Pop(0)
0x55c: Push((int) 1)
0x55d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x55e: GOTO 0x554

0x55f: Stack[-11] = Stack[-4]
0x560: Return(); Pop(8)

0x561: Stack[-4] = 0
0x562: PushEmpty(int, int, object, int, bool, int, int, int, int, object, int, bool, int, int)
0x563: @@ RemoveAllItems(Stack[-18])
0x564: Pop(0)
0x565: @@ size(Stack[-7])
0x566: Pop(0)
0x567: Stack[-6] = (int) 0
0x568: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x569: IF (Stack[-1] == 0) GOTO 0x574; Pop(1)

0x56a: @@ get(Stack[-5], Stack[-6])
0x56b: Pop(0)
0x56c: @@ get(Stack[-4], Stack[-6])
0x56d: Pop(0)
0x56e: @@ AddItem(Stack[-3], Stack[-5], Stack[-18], Stack[-4])
0x56f: Pop(0)
0x570: Stack[-5] = 0
0x571: Push((int) 1)
...
0x575: Pop(0)
0x576: Stack[-2] = (int) 0
0x577: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x578: IF (Stack[-1] == 0) GOTO 0x581; Pop(1)

0x579: @@ get(Stack[-1], Stack[-2])
0x57a: Pop(0)
0x57b: Push((bool) 1)
0x57c: @@ SelectItem(Stack[-2], Stack[-1], Stack[-19])
0x57d: Pop(1)
0x57e: Push((int) 1)
0x57f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x580: GOTO 0x577
...
0x59e: PushEmpty(cvector, cvector)
0x59f: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x5a0: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x5a1: Return(); Pop(2)

0x5a2: PushEmpty(object, object)
0x5a3: @ CreateObjectVector(Stack[-1])
0x5a4: Pop(0)
0x5a5: Stack[-3] = Stack[-1]
0x5a6: Return(); Pop(2)

0x5a7: Stack[-1] = 0
0x5a8: PushEmpty(int, int)
0x5a9: @ GetVariable(Stack[-3], Stack[-1])
0x5aa: Pop(0)
0x5ab: Stack[-4] = Stack[-1]
0x5ac: Return(); Pop(2)

0x5ad: PushEmpty(int, int)
0x5ae: @ GetVariable(Stack[-4], Stack[-1])
0x5af: Pop(0)
0x5b0: Pop(0); Push(Stack[-1] + Stack[-3]);
0x5b1: @ SetVariable(Stack[-5], Stack[-1])
0x5b2: Pop(1)
0x5b3: Return(); Pop(2)

0x5b4: PushEmpty(string, int)
0x5b5: Stack[-2] = "noinv_drop"
0x5b6: Stack[-1] = (int) -1
0x5b7: Call2 0x5ad
...
0x5ba: PushEmpty(string, int)
0x5bb: Stack[-2] = "noinv_drop"
0x5bc: Stack[-1] = (int) 1
0x5bd: Call2 0x5ad
...
0x5c0: PushEmpty(string, int)
0x5c1: Stack[-2] = "nouse_container"
0x5c2: Stack[-1] = (int) -1
0x5c3: Call2 0x5ad
...
0x5c6: PushEmpty(string, int)
0x5c7: Stack[-2] = "nouse_container"
0x5c8: Stack[-1] = (int) 1
0x5c9: Call2 0x5ad
...
0x5d9: @@ GetItemID(Stack[-3])
0x5da: Pop(0)
0x5db: Push("Category")
0x5dc: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5dd: Pop(1)
0x5de: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x5df: Pop(0)
0x5e0: Pop(0); Push((bool) Stack[-1] == 0)
0x5e1: IF (Stack[-1] == 0) GOTO 0x5e5; Pop(1)

0x5e2: @@ DropItems(Stack[-8], Stack[-7])
0x5e3: Pop(0)
0x5e4: GOTO 0x5ea

0x5e5: PushEmpty(int, int)
0x5e6: Stack[-2] = Stack[-5]
0x5e7: Stack[-1] = Stack[-9]
0x5e8: Call2 0x5cc
...
0x5ed: Pop(0)
0x5ee: @@ SetItemName(Stack[-4])
0x5ef: Pop(0)
0x5f0: PushEmpty(object, object, int)
0x5f1: Stack[-3] = Stack[-8]
...
0x5f7: Stack[-1] = 0
0x5f8: PushEmpty(bool, float, float, bool, float, float)
0x5f9: Stack[-3] = Stack[-8] > Stack[-9]; Pop(0);
0x5fa: Pop(0); Push(Stack[-8] - Stack[-9]);
0x5fb: Stack[-3] = Stack[-1] / Stack[-8]; Pop(1);
0x5fc: Push(Stack[-3])
0x5fd: IF (Stack[-1] == 0) GOTO 0x600; Pop(1)

0x5fe: Pop(0); Push((bool) Stack[-9] < Stack[-8])
0x5ff: GOTO 0x601

0x600: Pop(0); Push((bool) Stack[-8] < Stack[-9])
0x601: IF (Stack[-1] == 0) GOTO 0x609; Pop(1)

0x602: @ ModDarkenLevel(Stack[-9])
0x603: Pop(0)
0x604: @ sync(Stack[-1])
0x605: Pop(0)
0x606: Pop(0); Push(Stack[-1] * Stack[-2]);
0x607: Stack[-10] = Stack[-10] + Stack[-1]; Pop(1);
0x608: GOTO 0x5fc

0x609: @ ModDarkenLevel(Stack[-8])
0x60a: Pop(0)
0x60b: Return(); Pop(6)

0x60c: PushEmpty(string, string)
0x60d: Stack[-1] = "idle"
0x60e: Push(Stack[-3])
0x60f: IF (Stack[-1] == 0) GOTO 0x611; Pop(1)

0x610: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x611: Stack[-4] = Stack[-1]
0x612: Return(); Pop(2)

0x613: PushEmpty(int, bool, int, bool)
0x614: Stack[-2] = (int) 0
0x615: Push("all")
...
0x619: Pop(1)
0x61a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x61b: Pop(2)
...
0x61f: Push((int) 1)
0x620: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x621: GOTO 0x615

0x622: Stack[-5] = Stack[-2]
0x623: Return(); Pop(4)

0x624: Stack[-1] = (int) 521048
0x625: Return(); Pop(0)

0x626: Stack[-1] = (int) 521047
0x627: Return(); Pop(0)

0x628: Stack[-1] = "ui/NPC_Citizen2.png"
0x629: Return(); Pop(0)

0x62a: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x62b: Return(); Pop(0)
...
0x62e: PushEmpty()
0x62f: Push("ooArenaManager1")
0x630: Push((int) 1)
0x631: @ SetVariable(Stack[-2], Stack[-1])
0x632: Pop(2)
0x633: Return(); Pop(0)

0x634: PushEmpty()
0x635: Push((int) 1)
0x636: @@ SetReturnValue(Stack[-1])
0x637: Pop(1)
0x638: Return(); Pop(0)

0x639: PushEmpty()
0x63a: Push("blood is given")
0x63b: @ Trace(Stack[-1])
0x63c: Pop(1)
0x63d: PushEmpty(object, string, int)
0x63e: Stack[-3] = Stack[-5]
0x63f: Stack[-2] = "blood"
0x640: Stack[-1] = (int) 1
0x641: Call2 0x5eb
...
0x644: PushEmpty()
0x645: Push("playsound")
0x646: Push("giveitem")
0x647: @ TriggerWorld(Stack[-2], Stack[-1])
0x648: Pop(2)
0x649: Return(); Pop(0)

0x64a: PushEmpty()
0x64b: PushEmpty(int, string)
0x64c: Stack[-1] = "ooArenaManager1"
0x64d: Call2 0x5a8
...
0x652: Stack[-2] = (bool) 1
0x653: Return(); Pop(0)

0x654: Stack[-2] = (bool) 0
0x655: Return(); Pop(0)

0x656: PushEmpty(int, int)
0x657: Push("branch")
0x658: @ GetVariable(Stack[-1], Stack[-2])
0x659: Pop(1)
0x65a: Push((int) 0)
...
0x667: PushEmpty(float, float)
0x668: Pop(0); Push((bool) Stack[-3] == 0)
0x669: IF (Stack[-1] == 0) GOTO 0x66c; Pop(1)

0x66a: Stack[-4] = (bool) 0
0x66b: Return(); Pop(2)

0x66c: PushEmpty(float, object)
0x66d: Stack[-1] = Stack[-5]
0x66e: Call2 0x48e

0x66f: Pop(1)
0x670: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x671: Push(GlobalVars[1])
0x672: IF (Stack[-1] == 0) GOTO 0x675; Pop(1)

0x673: Push((int) 100)
0x674: Stack[-2] = Stack[-2] - Stack[-1]; Pop(1);
0x675: Push((int) 300)
