...
Events:
EVENT_16 Op = 0xcc7 Vars = (object, string)
EVENT_41 Op = 0xcd4 Vars = (object)
EVENT_22 Op = 0xcda Vars = (object, int, float, float)
EVENT_43 Op = 0xce2 Vars = (object, int, float, float, cvector, cvector)
...
0xa7e: @ StopWorld()
0xa7f: Pop(0)
0xa80: @ CameraTransit(Stack[-3], Stack[-5])
0xa81: Pop(0)
0xa82: Push(CvectorIndex(Stack[-4], 0))
0xa83: Push(CvectorIndex(Stack[-5], 2))
0xa84: @ Rotate(Stack[-2], Stack[-1])
0xa85: Pop(2)
...
0xa8b: Push("head")
0xa8c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xa8d: Pop(1)
0xa8e: Push(Stack[-1])
0xa8f: IF (Stack[-1] == 0) GOTO 0xa93; Pop(1)

0xa90: Push("head")
0xa91: @ LookAsyncCamera(Stack[-1])
0xa92: Pop(1)
0xa93: @ CameraWaitForPlayFinish()
0xa94: Pop(0)
0xa95: @ ResumeWorld()
0xa96: Pop(0)
0xa97: Stack[-21] = (bool) 1
0xa98: Return(); Pop(18)

0xa99: PushEmpty(bool, bool)
0xa9a: @ CameraSwitchToNormal()
0xa9b: Pop(0)
...
0xaa1: Push("head")
0xaa2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xaa3: Pop(1)
0xaa4: Push(Stack[-1])
0xaa5: IF (Stack[-1] == 0) GOTO 0xaa9; Pop(1)

0xaa6: Push("head")
0xaa7: @ UnlookAsync(Stack[-1])
0xaa8: Pop(1)
0xaa9: Return(); Pop(2)

0xaaa: PushEmpty(bool, float, float, bool, float, float)
0xaab: @ lshHasAnimation(Stack[-3], Stack[-7])
0xaac: Pop(0)
0xaad: Push(Stack[-3])
0xaae: IF (Stack[-1] == 0) GOTO 0xab5; Pop(1)

0xaaf: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0xab0: Pop(0)
0xab1: Push((bool) 0)
0xab2: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0xab3: Pop(1)
0xab4: GOTO 0xab9

0xab5: Push("Can't find lsh animation : ")
0xab6: Pop(1); Push(Stack[-1] + Stack[-8]);
0xab7: @ Trace(Stack[-1])
0xab8: Pop(1)
0xab9: Return(); Pop(6)

0xaba: PushEmpty(bool, float, float, bool, float, float)
0xabb: @ lshHasAnimation(Stack[-3], Stack[-8])
0xabc: Pop(0)
0xabd: Push(Stack[-3])
0xabe: IF (Stack[-1] == 0) GOTO 0xac4; Pop(1)

0xabf: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0xac0: Pop(0)
0xac1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0xac2: Pop(0)
0xac3: GOTO 0xac8

0xac4: Push("Can't find lsh animation : ")
0xac5: Pop(1); Push(Stack[-1] + Stack[-9]);
0xac6: @ Trace(Stack[-1])
0xac7: Pop(1)
0xac8: Return(); Pop(6)

0xac9: PushEmpty(float, cvector, float, cvector)
0xaca: @@ GetEyesHeight(Stack[-2])
0xacb: Pop(0)
0xacc: Stack[-1] = CVector(0.0, 0.0, 0.0)
0xacd: Push(CvectorIndex(Stack[-1], 1))
0xace: Stack[-1] = Stack[-3]
0xacf: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xad0: Push("head")
0xad1: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0xad2: Pop(1)
0xad3: Return(); Pop(4)
...
0xadb: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0xadc: @ IsExisting3DSound(Stack[-8], Stack[-17])
0xadd: Pop(0)
0xade: Pop(0); Push((bool) Stack[-8] == 0)
0xadf: IF (Stack[-1] == 0) GOTO 0xaf4; Pop(1)

0xae0: Stack[-7] = (int) 0
0xae1: Push((int) 1)
0xae2: Pop(1); Push(Stack[-8] + Stack[-1]);
0xae3: Pop(1); Push(Stack[-18] + Stack[-1]);
0xae4: @ IsExisting3DSound(Stack[-7], Stack[-1])
0xae5: Pop(1)
0xae6: Pop(0); Push((bool) Stack[-6] == 0)
0xae7: IF (Stack[-1] == 0) GOTO 0xae9; Pop(1)

0xae8: GOTO 0xaec

0xae9: Push((int) 1)
0xaea: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0xaeb: GOTO 0xae1

0xaec: Pop(0); Push((bool) Stack[-7] == 0)
0xaed: IF (Stack[-1] == 0) GOTO 0xaef; Pop(1)

0xaee: Return(); Pop(16)

0xaef: @ irand(Stack[-5], Stack[-7])
0xaf0: Pop(0)
0xaf1: Push((int) 1)
0xaf2: Pop(1); Push(Stack[-6] + Stack[-1]);
0xaf3: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0xaf4: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0xaf5: Pop(0)
0xaf6: Push(Stack[-4])
0xaf7: IF (Stack[-1] == 0) GOTO 0xb03; Pop(1)

0xaf8: @ GetEyesHeight(Stack[-3])
0xaf9: Pop(0)
0xafa: @ GetDirection(Stack[-2])
0xafb: Pop(0)
0xafc: Push((int) 50)
0xafd: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0xafe: Push(CvectorIndex(Stack[-1], 1))
0xaff: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0xb00: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xb01: @ PlayGlobalSound(Stack[-17], Stack[-1])
0xb02: Pop(0)
0xb03: Return(); Pop(16)
...
0xb05: @ self(Stack[-1])
0xb06: Pop(0)
0xb07: Stack[-3] = Stack[-1]
0xb08: Return(); Pop(2)

0xb09: Stack[-1] = 0
0xb0a: PushEmpty(float, float)
0xb0b: Pop(0); Push(Stack[-3] | Stack[-3]);
0xb0c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xb0d: Push((float)0.0)
0xb0e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xb0f: IF (Stack[-1] == 0) GOTO 0xb12; Pop(1)

0xb10: Stack[-4] = CVector(0.0, 0.0, 0.0)
0xb11: Return(); Pop(2)

0xb12: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xb13: Return(); Pop(2)

0xb14: PushEmpty()
0xb15: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0xb16: IF (Stack[-1] == 0) GOTO 0xb19; Pop(1)

0xb17: Stack[-3] = Stack[-2]
0xb18: GOTO 0xb1a
...
0xb1b: PushEmpty()
0xb1c: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xb1d: IF (Stack[-1] == 0) GOTO 0xb20; Pop(1)

0xb1e: Stack[-4] = Stack[-2]
0xb1f: Return(); Pop(0)

0xb20: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xb21: IF (Stack[-1] == 0) GOTO 0xb24; Pop(1)

0xb22: Stack[-4] = Stack[-1]
0xb23: Return(); Pop(0)

0xb24: Stack[-4] = Stack[-3]
0xb25: Return(); Pop(0)

0xb26: PushEmpty()
0xb27: Push(CvectorIndex(Stack[-2], 0))
0xb28: Push(CvectorIndex(Stack[-2], 0))
0xb29: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb2a: Push(CvectorIndex(Stack[-3], 2))
0xb2b: Push(CvectorIndex(Stack[-3], 2))
0xb2c: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb2d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xb2e: Return(); Pop(0)

0xb2f: PushEmpty()
0xb30: Push(CvectorIndex(Stack[-1], 0))
0xb31: Push(CvectorIndex(Stack[-2], 0))
0xb32: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb33: Push(CvectorIndex(Stack[-2], 2))
0xb34: Push(CvectorIndex(Stack[-3], 2))
0xb35: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb36: Pop(2); Push(Stack[-2] + Stack[-1]);
0xb37: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0xb38: Return(); Pop(0)

0xb39: PushEmpty()
0xb3a: PushEmpty(float, cvector, cvector)
0xb3b: Stack[-2] = Stack[-5]
0xb3c: Stack[-1] = Stack[-4]
0xb3d: Call2 0xb26

0xb3e: Pop(2)
0xb3f: PushEmpty(float, cvector)
0xb40: Stack[-1] = Stack[-5]
0xb41: Call2 0xb2f

0xb42: Pop(1)
0xb43: PushEmpty(float, cvector)
0xb44: Stack[-1] = Stack[-5]
0xb45: Call2 0xb2f

0xb46: Pop(1)
0xb47: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb48: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0xb49: Return(); Pop(0)

0xb4a: PushEmpty(int, int)
0xb4b: @ GetVariable(Stack[-3], Stack[-1])
0xb4c: Pop(0)
0xb4d: Stack[-4] = Stack[-1]
0xb4e: Return(); Pop(2)

0xb4f: PushEmpty(object, object)
0xb50: @ CreateFloatVector(Stack[-1])
0xb51: Pop(0)
0xb52: @@ add(Stack[-3])
0xb53: Pop(0)
0xb54: Push((int) 15)
0xb55: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xb56: Pop(1)
0xb57: Return(); Pop(2)

0xb58: Stack[-1] = 0
0xb59: PushEmpty(float, float)
0xb5a: @ GetGameTime(Stack[-1])
0xb5b: Pop(0)
0xb5c: Push((int) 1)
0xb5d: PushEmpty(int)
0xb5e: Push((int) 24)
0xb5f: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
...
0xb67: Push("attack")
0xb68: @ PlayGlobalMusic(Stack[-1])
0xb69: Pop(1)
0xb6a: Return(); Pop(2)

0xb6b: PushEmpty(object, object)
0xb6c: @ GetScene(Stack[-1])
0xb6d: Pop(0)
0xb6e: Push("battle")
0xb6f: PushEmpty(object)
0xb70: Call2 0xb04

0xb71: Pop(0)
0xb72: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xb73: Pop(2)
0xb74: Return(); Pop(2)
...
0xb9b: Pop(0)
0xb9c: Push((int) 1)
0xb9d: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0xb9e: Return(); Pop(0)

0xb9f: PushEmpty(int, int)
0xba0: Push("branch")
0xba1: @ GetVariable(Stack[-1], Stack[-2])
0xba2: Pop(1)
0xba3: Push((int) 0)
0xba4: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xba5: IF (Stack[-1] == 0) GOTO 0xba9; Pop(1)
...
0xbb0: PushEmpty(int, int)
0xbb1: Push("branch")
0xbb2: @ GetVariable(Stack[-1], Stack[-2])
0xbb3: Pop(1)
...
0xbb9: Pop(0)
0xbba: Push((int) 1)
0xbbb: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xbbc: IF (Stack[-1] == 0) GOTO 0xbc0; Pop(1)

0xbbd: @ WorkWithCorpse(Stack[-1])
0xbbe: Pop(0)
0xbbf: GOTO 0xbc2

0xbc0: @ Barter(Stack[-1])
0xbc1: Pop(0)
0xbc2: Return(); Pop(0)

0xbc3: PushEmpty(int, bool, int, bool)
0xbc4: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0xbc5: IF (Stack[-1] == 0) GOTO 0xbca; Pop(1)

0xbc6: Push("GenerateMoney: iMin > iMax")
0xbc7: @ Trace(Stack[-1])
0xbc8: Pop(1)
0xbc9: Return(); Pop(4)

0xbca: Stack[-2] = (int) 0
0xbcb: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0xbcc: IF (Stack[-1] == 0) GOTO 0xbd1; Pop(1)

0xbcd: Pop(0); Push(Stack[-5] - Stack[-6]);
0xbce: @ irand(Stack[-3], Stack[-1])
0xbcf: Pop(1)
0xbd0: GOTO 0xbd5

0xbd1: Push((int) 0)
0xbd2: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xbd3: IF (Stack[-1] == 0) GOTO 0xbd5; Pop(1)

0xbd4: Return(); Pop(4)

0xbd5: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0xbd6: Push((int) 0)
...
0xbdd: Pop(1)
0xbde: Push((int) 0)
0xbdf: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xbe0: Pop(2)
0xbe1: Return(); Pop(4)

0xbe2: PushEmpty(object, int, bool, object, int, bool)
0xbe3: @ CreateInvItem(Stack[-3])
0xbe4: Pop(0)
0xbe5: @@ SetItemName(Stack[-7])
0xbe6: Pop(0)
0xbe7: Push("Organ")
0xbe8: Push((int) 1)
0xbe9: @@ SetProperty(Stack[-2], Stack[-1])
0xbea: Pop(2)
0xbeb: @@ GetItemID(Stack[-2])
0xbec: Pop(0)
0xbed: Push((int) 0)
0xbee: Push((int) 1)
0xbef: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xbf0: Pop(2)
0xbf1: Return(); Pop(6)
...
0xbfa: PushEmpty(string)
0xbfb: Stack[-1] = "liver"
0xbfc: Call2 0xbe2

0xbfd: Pop(1)
0xbfe: PushEmpty(string)
0xbff: Stack[-1] = "kidney"
0xc00: Call2 0xbe2
...
0xc0b: PushEmpty(int, bool, int, bool)
0xc0c: Push(Stack[-5])
0xc0d: IF (Stack[-1] == 0) GOTO 0xc64; Pop(1)

0xc0e: PushEmpty(int, int)
0xc0f: Stack[-2] = (int) 0
0xc10: Push((int) 100)
0xc11: PushEmpty(int)
0xc12: Call2 0xb59
...
0xc13: Pop(0)
0xc14: Push((int) 100)
0xc15: Pop(2); Push(Stack[-2] * Stack[-1]);
0xc16: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xc17: Call2 0xbc3

0xc18: Pop(2)
0xc19: Push((int) 8)
0xc1a: @ irand(Stack[-3], Stack[-1])
0xc1b: Pop(1)
0xc1c: Push((int) 0)
0xc1d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc1e: IF (Stack[-1] == 0) GOTO 0xc28; Pop(1)
...
0xc23: Push((int) 0)
0xc24: Push((int) 1)
0xc25: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc26: Pop(3)
0xc27: GOTO 0xc63

0xc28: Push((int) 1)
0xc29: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc2a: IF (Stack[-1] == 0) GOTO 0xc34; Pop(1)
...
0xc2f: Push((int) 0)
0xc30: Push((int) 1)
0xc31: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc32: Pop(3)
0xc33: GOTO 0xc63

0xc34: Push((int) 2)
0xc35: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc36: IF (Stack[-1] == 0) GOTO 0xc40; Pop(1)
...
0xc3b: Push((int) 0)
0xc3c: Push((int) 1)
0xc3d: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc3e: Pop(3)
0xc3f: GOTO 0xc63

0xc40: Push((int) 4)
0xc41: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc42: IF (Stack[-1] == 0) GOTO 0xc4c; Pop(1)

0xc43: PushEmpty(int, string)
0xc44: Stack[-1] = "syringe"
0xc45: Call2 0xcba

0xc46: Pop(1)
0xc47: Push((int) 0)
0xc48: Push((int) 1)
0xc49: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc4a: Pop(3)
0xc4b: GOTO 0xc63

0xc4c: Push((int) 5)
0xc4d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc4e: IF (Stack[-1] == 0) GOTO 0xc58; Pop(1)
...
0xc53: Push((int) 0)
0xc54: Push((int) 1)
0xc55: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc56: Pop(3)
0xc57: GOTO 0xc63

0xc58: Push((int) 6)
0xc59: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc5a: IF (Stack[-1] == 0) GOTO 0xc63; Pop(1)
...
0xc5f: Push((int) 0)
0xc60: Push((int) 1)
0xc61: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc62: Pop(3)
0xc63: GOTO 0xcb9

0xc64: PushEmpty(int, int)
0xc65: Stack[-2] = (int) 0
0xc66: Push((int) 50)
0xc67: PushEmpty(int)
0xc68: Call2 0xb59
...
0xc69: Pop(0)
0xc6a: Push((int) 50)
0xc6b: Pop(2); Push(Stack[-2] * Stack[-1]);
0xc6c: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xc6d: Call2 0xbc3

0xc6e: Pop(2)
0xc6f: Push((int) 7)
0xc70: @ irand(Stack[-3], Stack[-1])
0xc71: Pop(1)
0xc72: Push((int) 0)
0xc73: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc74: IF (Stack[-1] == 0) GOTO 0xc7e; Pop(1)
...
0xc79: Push((int) 0)
0xc7a: Push((int) 1)
0xc7b: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc7c: Pop(3)
0xc7d: GOTO 0xcb9

0xc7e: Push((int) 1)
0xc7f: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc80: IF (Stack[-1] == 0) GOTO 0xc8a; Pop(1)

0xc81: PushEmpty(int, string)
0xc82: Stack[-1] = "bracelet"
0xc83: Call2 0xcba

0xc84: Pop(1)
0xc85: Push((int) 0)
0xc86: Push((int) 1)
0xc87: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc88: Pop(3)
0xc89: GOTO 0xcb9
...
0xc98: IF (Stack[-1] == 0) GOTO 0xca2; Pop(1)

0xc99: PushEmpty(int, string)
0xc9a: Stack[-1] = "gold_ring"
0xc9b: Call2 0xcba

0xc9c: Pop(1)
0xc9d: Push((int) 0)
0xc9e: Push((int) 1)
0xc9f: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xca0: Pop(3)
0xca1: GOTO 0xcb9

0xca2: Push((int) 4)
0xca3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xca4: IF (Stack[-1] == 0) GOTO 0xcae; Pop(1)

0xca5: PushEmpty(int, string)
0xca6: Stack[-1] = "silver_ring"
0xca7: Call2 0xcba

0xca8: Pop(1)
0xca9: Push((int) 0)
0xcaa: Push((int) 1)
0xcab: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xcac: Pop(3)
0xcad: GOTO 0xcb9

0xcae: Push((int) 5)
0xcaf: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xcb0: IF (Stack[-1] == 0) GOTO 0xcb9; Pop(1)

0xcb1: PushEmpty(int, string)
0xcb2: Stack[-1] = "flower"
0xcb3: Call2 0xcba

0xcb4: Pop(1)
0xcb5: Push((int) 0)
0xcb6: Push((int) 1)
0xcb7: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xcb8: Pop(3)
0xcb9: Return(); Pop(4)

0xcba: PushEmpty(int, int)
0xcbb: @ GetInvItemByName(Stack[-1], Stack[-3])
0xcbc: Pop(0)
0xcbd: Stack[-4] = Stack[-1]
0xcbe: Return(); Pop(2)

0xcbf: PushEmpty()
0xcc0: PushEmpty(object)
0xcc1: Stack[-1] = Stack[-2]
0xcc2: Push(-1, 0); TaskCall(2)
0xcc3: Call2 0x14a

0xcc4: Pop(-1, 0); TaskReturn
0xcc5: Pop(1)
0xcc6: Return(); Pop(0)

0xcc7: PushEmpty(float, float)
0xcc8: Push("health")
0xcc9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xcca: IF (Stack[-1] == 0) GOTO 0xcd3; Pop(1)
...
0xcd1: @ SignalDeath(Stack[-4])
0xcd2: Pop(0)
0xcd3: Return(); Pop(2)

0xcd4: PushEmpty()
0xcd5: PushEmpty(object)
0xcd6: Stack[-1] = Stack[-2]
0xcd7: Call2 0xcbf
...
0xcda: PushEmpty()
0xcdb: PushEmpty(object, int, float)
0xcdc: Stack[-3] = Stack[-7]
0xcdd: Stack[-2] = Stack[-6]
0xcde: Stack[-1] = Stack[-5]
0xcdf: Call2 0x9f3
...
0xce2: PushEmpty()
0xce3: PushEmpty(object, int, float, cvector, cvector)
0xce4: Stack[-5] = Stack[-11]
0xce5: Stack[-4] = Stack[-10]
0xce6: Stack[-3] = Stack[-9]
0xce7: Stack[-2] = Stack[-7]
0xce8: Stack[-1] = Stack[-6]
0xce9: Call2 0xa37
...
0xcec: PushEmpty()
0xced: Push("unholster")
0xcee: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xcef: IF (Stack[-1] == 0) GOTO 0xcf7; Pop(1)

0xcf0: PushEmpty(bool, object)
0xcf1: Stack[-1] = Stack[-4]
0xcf2: Call2 0xe59

0xcf3: Stack[-5] = Stack[-2]
0xcf4: Pop(2)
0xcf5: Return(); Pop(0)

0xcf6: GOTO 0xd0a

0xcf7: Push("player_shot")
0xcf8: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xcf9: IF (Stack[-1] == 0) GOTO 0xd01; Pop(1)

0xcfa: PushEmpty(bool, object)
0xcfb: Stack[-1] = Stack[-4]
0xcfc: Call2 0xe5e

0xcfd: Stack[-5] = Stack[-2]
0xcfe: Pop(2)
0xcff: Return(); Pop(0)
...
0xd01: Push("battle")
0xd02: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd03: IF (Stack[-1] == 0) GOTO 0xd0a; Pop(1)

0xd04: PushEmpty(bool, object)
0xd05: Stack[-1] = Stack[-4]
0xd06: Call2 0xe73

0xd07: Stack[-5] = Stack[-2]
0xd08: Pop(2)
0xd09: Return(); Pop(0)

0xd0a: Stack[-3] = (bool) 0
0xd0b: Return(); Pop(0)

0xd0c: PushEmpty()
0xd0d: Push("unholster")
0xd0e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd0f: IF (Stack[-1] == 0) GOTO 0xd15; Pop(1)

0xd10: PushEmpty(object)
...
0xd1d: Push("battle")
0xd1e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd1f: IF (Stack[-1] == 0) GOTO 0xd24; Pop(1)
...
0xd25: PushEmpty(bool, bool)
0xd26: PushEmpty(bool)
0xd27: Stack[-1] = (bool) 0
0xd28: PushEmpty(bool, object)
0xd29: Stack[-1] = Stack[-6]
0xd2a: Call2 0xe59

0xd2b: Pop(1)
0xd2c: IF (Stack[-1] == 0) GOTO 0xd33; Pop(1)

0xd2d: PushEmpty(bool, object)
0xd2e: Stack[-1] = Stack[-6]
0xd2f: Call2 0x92c

0xd30: Pop(1)
0xd31: IF (Stack[-1] == 0) GOTO 0xd33; Pop(1)

0xd32: Stack[-1] = (bool) 1
0xd33: IF (Stack[-1] == 0) GOTO 0xd3a; Pop(1)

0xd34: @@ IsWeaponHolstered(Stack[-1])
0xd35: Pop(0)
0xd36: Pop(0); Push((bool) Stack[-1] == 0)
0xd37: IF (Stack[-1] == 0) GOTO 0xd3a; Pop(1)

0xd38: Stack[-4] = (bool) 1
0xd39: Return(); Pop(2)

0xd3a: Stack[-4] = (bool) 0
0xd3b: Return(); Pop(2)

0xd3c: PushEmpty()
0xd3d: PushEmpty(object)
...
0xd42: PushEmpty()
0xd43: PushEmpty(bool, object)
0xd44: Stack[-1] = Stack[-3]
0xd45: Call2 0x92c

0xd46: Pop(1)
0xd47: IF (Stack[-1] == 0) GOTO 0xd4e; Pop(1)

0xd48: PushEmpty(object)
0xd49: Call2 0xb04

0xd4a: Pop(0)
0xd4b: Push((float)-0.03)
0xd4c: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0xd4d: Pop(2)
0xd4e: Return(); Pop(0)

0xd4f: PushEmpty(object, object)
0xd50: Push("heal")
0xd51: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xd52: IF (Stack[-1] == 0) GOTO 0xd5d; Pop(1)

0xd53: Push("player")
0xd54: @ FindActor(Stack[-2], Stack[-1])
0xd55: Pop(1)
0xd56: PushEmpty(bool, object)
0xd57: Stack[-1] = Stack[-3]
0xd58: Call2 0xe78

0xd59: Stack[-6] = Stack[-2]
0xd5a: Pop(2)
0xd5b: Return(); Pop(2)

0xd5c: Stack[-1] = 0
0xd5d: Stack[-4] = (bool) 0
0xd5e: Return(); Pop(2)

0xd5f: PushEmpty(object, object)
0xd60: Push("heal")
0xd61: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xd62: IF (Stack[-1] == 0) GOTO 0xd6b; Pop(1)

0xd63: Push("player")
0xd64: @ FindActor(Stack[-2], Stack[-1])
0xd65: Pop(1)
0xd66: PushEmpty(object)
0xd67: Stack[-1] = Stack[-2]
0xd68: Call2 0xe7b
...
0xd6c: PushEmpty(string, string)
0xd6d: Stack[-1] = "idle"
0xd6e: Push(Stack[-3])
0xd6f: IF (Stack[-1] == 0) GOTO 0xd71; Pop(1)

0xd70: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xd71: Stack[-4] = Stack[-1]
0xd72: Return(); Pop(2)

0xd73: PushEmpty(int, bool, int, bool)
0xd74: Stack[-2] = (int) 0
0xd75: Push("all")
0xd76: PushEmpty(string, int)
0xd77: Stack[-1] = Stack[-5]
0xd78: Call2 0xd6c

0xd79: Pop(1)
0xd7a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xd7b: Pop(2)
...
0xd7f: Push((int) 1)
0xd80: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xd81: GOTO 0xd75

0xd82: Stack[-5] = Stack[-2]
0xd83: Return(); Pop(4)
...
0xd8f: Stack[-1] = Stack[-2]
0xd90: Push(-1, 1); TaskCall(5)
0xd91: Call2 0x451

0xd92: Pop(-1, 1); TaskReturn
0xd93: Pop(1)
0xd94: Return(); Pop(0)
...
0xd9f: PushEmpty()
0xda0: PushEmpty(object)
0xda1: Stack[-1] = Stack[-2]
0xda2: Push(-1, 6); TaskCall(6)
0xda3: Call2 0x564

0xda4: Pop(-1, 6); TaskReturn
0xda5: Pop(1)
0xda6: Return(); Pop(0)

0xda7: PushEmpty(string, string, string, string)
0xda8: PushEmpty(bool, object, string)
0xda9: Stack[-2] = Stack[-9]
0xdaa: Stack[-1] = "class"
0xdab: Call2 0x931

0xdac: Pop(2)
0xdad: Pop(1); Push((bool) Stack[-1] == 0)
0xdae: IF (Stack[-1] == 0) GOTO 0xdb1; Pop(1)

0xdaf: Stack[-7] = (bool) 0
0xdb0: Return(); Pop(4)

0xdb1: Push("class")
0xdb2: @ GetProperty(Stack[-1], Stack[-3])
0xdb3: Pop(1)
0xdb4: Push("class")
0xdb5: @@ GetProperty(Stack[-1], Stack[-2])
0xdb6: Pop(1)
0xdb7: PushEmpty(bool)
0xdb8: Stack[-1] = (bool) 0
0xdb9: Pop(0); Push((bool) Stack[-6] == 0)
0xdba: IF (Stack[-1] == 0) GOTO 0xdbe; Pop(1)

0xdbb: Pop(0); Push((bool) Stack[-3] == Stack[-2])
0xdbc: IF (Stack[-1] == 0) GOTO 0xdbe; Pop(1)

0xdbd: Stack[-1] = (bool) 1
...
0xdc4: Stack[-7] = (bool) 0
0xdc5: Return(); Pop(4)

0xdc6: GOTO 0xdf0

0xdc7: Push("rat_big")
0xdc8: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xdc9: IF (Stack[-1] == 0) GOTO 0xdcd; Pop(1)

0xdca: Stack[-7] = (bool) 0
0xdcb: Return(); Pop(4)
...
0xddb: IF (Stack[-1] == 0) GOTO 0xddf; Pop(1)

0xddc: Stack[-7] = (bool) 0
0xddd: Return(); Pop(4)
...
0xdee: Stack[-7] = (bool) 0
0xdef: Return(); Pop(4)

0xdf0: Stack[-7] = (bool) 1
0xdf1: Return(); Pop(4)

0xdf2: PushEmpty()
0xdf3: PushEmpty(int, object)
0xdf4: Stack[-1] = Stack[-4]
0xdf5: Call2 0xd95
...
0xdff: PushEmpty(bool, bool)
0xe00: PushEmpty(bool, object, bool)
0xe01: Stack[-2] = Stack[-8]
0xe02: Stack[-1] = !Stack[-6]; Pop(0);
0xe03: Call2 0xda7
...
0xe07: Stack[-7] = (bool) 0
0xe08: Return(); Pop(2)

0xe09: @ CanSee(Stack[-1], Stack[-6])
0xe0a: Pop(0)
0xe0b: PushEmpty(bool)
0xe0c: Stack[-1] = (bool) 1
0xe0d: Push(Stack[-2])
0xe0e: IF (Stack[-1] == 0) GOTO 0xe17; Pop(1)

0xe0f: PushEmpty(float, object)
0xe10: Stack[-1] = Stack[-9]
0xe11: Call2 0x924

0xe12: Pop(1)
0xe13: Pop(0); Push(Stack[-6] * Stack[-6]);
0xe14: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xe15: IF (Stack[-1] == 0) GOTO 0xe17; Pop(1)

0xe16: Stack[-1] = (bool) 0
0xe17: IF (Stack[-1] == 0) GOTO 0xe1a; Pop(1)

0xe18: Stack[-7] = (bool) 1
0xe19: Return(); Pop(2)

0xe1a: Stack[-7] = (bool) 0
0xe1b: Return(); Pop(2)
...
0xe25: PushEmpty(int, object)
0xe26: Stack[-1] = Stack[-3]
0xe27: Call2 0xe37

0xe28: Stack[-5] = Stack[-2]
0xe29: Pop(2)
0xe2a: Return(); Pop(0)
...
0xe30: IF (Stack[-1] == 0) GOTO 0xe36; Pop(1)
...
0xe37: PushEmpty()
0xe38: PushEmpty(bool, object)
0xe39: Stack[-1] = Stack[-3]
0xe3a: Call2 0x9af

0xe3b: Pop(1)
0xe3c: Pop(1); Push((bool) Stack[-1] == 0)
...
0xe41: Stack[-1] = Stack[-3]
0xe42: Call2 0xea1

0xe43: Pop(1)
0xe44: IF (Stack[-1] == 0) GOTO 0xe47; Pop(1)
...
0xe49: PushEmpty()
0xe4a: PushEmpty(object)
0xe4b: Stack[-1] = Stack[-2]
0xe4c: Call2 0xd9f
...
0xe59: PushEmpty()
0xe5a: Stack[-2] = (bool) 0
0xe5b: Return(); Pop(0)

0xe5c: PushEmpty()
0xe5d: Return(); Pop(0)

0xe5e: PushEmpty(bool, bool)
0xe5f: @ CanSee(Stack[-1], Stack[-3])
0xe60: Pop(0)
0xe61: Stack[-4] = (bool) 1
0xe62: Push(Stack[-1])
0xe63: IF (Stack[-1] == 0) GOTO 0xe6c; Pop(1)

0xe64: PushEmpty(float, object)
0xe65: Stack[-1] = Stack[-5]
0xe66: Call2 0x924

0xe67: Pop(1)
0xe68: Push((int) 2250000)
0xe69: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xe6a: IF (Stack[-1] == 0) GOTO 0xe6c; Pop(1)

0xe6b: Stack[-4] = (bool) 0
0xe6c: Return(); Pop(2)

0xe6d: PushEmpty()
0xe6e: PushEmpty(object)
0xe6f: Stack[-1] = Stack[-2]
0xe70: Call2 0xd8d
...
0xe7d: Stack[-1] = (int) 515556
0xe7e: Return(); Pop(0)

0xe7f: Stack[-1] = (int) 503341
0xe80: Return(); Pop(0)

0xe81: Stack[-1] = "ui/NPC_Citizen3.png"
0xe82: Return(); Pop(0)

0xe83: Stack[-1] = "ui/NPC_Citizen3_b.png"
0xe84: Return(); Pop(0)

0xe85: Stack[-1] = (bool) 0
0xe86: Return(); Pop(0)

0xe87: Push(GlobalVars[0])
0xe88: Stack[-1] = (bool) 0
0xe89: GlobalVars[0] = Stack[-1]; Pop(1)
0xe8a: Return(); Pop(0)

0xe8b: PushEmpty(bool, bool)
0xe8c: Push(GlobalVars[0])
0xe8d: IF (Stack[-1] == 0) GOTO 0xe98; Pop(1)

0xe8e: @ IsOverrideActive(Stack[-1])
0xe8f: Pop(0)
0xe90: Pop(0); Push((bool) Stack[-1] == 0)
0xe91: IF (Stack[-1] == 0) GOTO 0xe96; Pop(1)
...
0xe98: PushEmpty(int, object)
0xe99: Stack[-1] = Stack[-5]
0xe9a: Push(-2, 1); TaskCall(0)
0xe9b: Call2 0x0

0xe9c: Pop(-2, 1); TaskReturn
0xe9d: Pop(2)
0xe9e: Return(); Pop(2)
...
0xea1: PushEmpty()
0xea2: Stack[-2] = (bool) 1
0xea3: Return(); Pop(0)

0xea4: PushEmpty()
0xea5: PushEmpty(bool, object, object, float, bool)
0xea6: Stack[-4] = Stack[-8]
0xea7: Stack[-3] = Stack[-7]
0xea8: Stack[-2] = (float) 700.0
0xea9: Stack[-1] = Stack[-6]
0xeaa: Call2 0xdff

0xeab: Stack[-9] = Stack[-5]
0xeac: Pop(5)
0xead: Return(); Pop(0)

0xeae: PushEmpty()
0xeaf: PushEmpty(bool, object)
0xeb0: Stack[-1] = Stack[-3]
0xeb1: Call2 0x92c

0xeb2: Pop(1)
0xeb3: IF (Stack[-1] == 0) GOTO 0xebf; Pop(1)

0xeb4: PushEmpty(object)
0xeb5: Call2 0xb04

0xeb6: Pop(0)
0xeb7: Push((float)-0.07)
0xeb8: Push((bool) 1)
0xeb9: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xeba: Pop(3)
0xebb: PushEmpty(bool)
...
0xec1: Pop(0)
0xec2: Push(GlobalVars[0])
0xec3: Stack[-1] = (bool) 1
0xec4: GlobalVars[0] = Stack[-1]; Pop(1)
0xec5: Push((int) 50)
0xec6: Push((int) 40)
0xec7: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xec8: Pop(2)
0xec9: Return(); Pop(0)
