...
func_130(var_8_int, var_9_string)
{
	var_10_int = 0; var_11_int = 0; // 0x82 PushV
	GetInvItemByName(var_11_int, var_9_string); // 0x83 Func
	var_8_int = var_11_int; // 0x85 Mov
	return 2; // 0x86 Return
}


func_135(var_0_bool, var_1_string, var_2_int, var_3_int)
{
	var_4_int = 0; var_5_bool = 0; var_6_int = 0; var_7_bool = 0; // 0x87 PushV
	var_8_int = 0; var_9_string = ""; // 0x88 PushV
	var_9_string = var_1_string; // 0x89 Mov
	func_130(var_8_int, var_9_string); // 0x8a NEW_2
	var_6_int = var_8_int; // 0x8b Mov
	var_12_int = -1; // 0x8d PushI
	var_13_bool = var_6_int == var_12_int; // 0x8e Eq
	if(var_13_bool == 0) goto Label_146; // 0x8f JumpB
	var_0_bool = 0; // 0x90 MovB
	return 4; // 0x91 Return
	
Label_146:
	var_14_int = 0; // 0x92 PushI
	var_15_bool = var_2_int == var_14_int; // 0x93 Eq
	if(var_15_bool == 0) goto Label_151; // 0x94 JumpB
	var_0_bool = 1; // 0x95 MovB
	return 4; // 0x96 Return
	
Label_151:
	AddItem(var_7_bool, var_6_int, var_3_int, var_2_int); // 0x97 Func
	var_0_bool = var_7_bool; // 0x99 Mov
...
func_40()
{
	...
	var_3_int = 3; // 0x2a MovI
	func_106(var_2_bool, var_3_int); // 0x2b NEW_2
...
Label_51:
	...
	func_118(var_20_bool, var_21_int); // 0x3a NEW_2
	if(var_20_bool == 0) goto Label_71; // 0x3c JumpB
	var_33_bool = 1; // 0x3d PushB
	SetVisibility(var_33_bool); // 0x3e Func
	var_34_string = "I am in region "; // 0x40 PushS
	var_35_int = var_34_string + var_1_int; // 0x41 Add
	var_36_string = " and visible"; // 0x42 PushS
	var_37_int = var_35_int + var_36_string; // 0x43 Add
	Trace(var_37_int); // 0x44 Func
...
Label_71:
	var_38_bool = 1; // 0x47 PushB
	SetVisibility(var_38_bool); // 0x48 Func
	var_39_string = "I am in region "; // 0x4a PushS
	var_40_int = var_39_string + var_1_int; // 0x4b Add
	var_41_string = " and not visible"; // 0x4c PushS
	var_42_int = var_40_int + var_41_string; // 0x4d Add
	Trace(var_42_int); // 0x4e Func
}
...
func_86(var_12_int)
{
	...
	func_81(var_17_cvector); // 0x5a NEW_2
...
func_118(var_20_bool, var_21_int)
{
	...
	func_112(var_25_string, var_26_int); // 0x79 NEW_2
	...
	var_20_bool = var_31_int == var_32_int; // 0x80 Eq2
...
func_28()
{
	...
	var_1_string = "blooddiseased"; // 0x1d MovS
	var_2_int = 1; // 0x1e MovI
	var_3_int = 0; // 0x1f MovI
	func_135(var_0_bool, var_1_string, var_2_int, var_3_int); // 0x20 NEW_2
