...
0x584: Stack[-1] = "grass_black_tvir"
0x585: Call2 0x5a3
...
0x590: Stack[-1] = "grass_blood_tvir"
0x591: Call2 0x5a3
...
0x595: Pop(2)
0x596: Push((int) 15)
0x597: @ irand(Stack[-2], Stack[-1])
0x598: Pop(1)
0x599: Push((int) 5)
0x59a: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x59b: PushEmpty(int, string)
0x59c: Stack[-1] = "grass_brown_tvir"
0x59d: Call2 0x5a3

0x59e: Pop(1)
0x59f: Push((int) 0)
0x5a0: @ AddItem(Stack[-4], Stack[-2], Stack[-1], Stack[-3])
0x5a1: Pop(2)
0x5a2: Return(); Pop(4)

0x5a3: PushEmpty(int, int)
0x5a4: @ GetInvItemByName(Stack[-1], Stack[-3])
0x5a5: Pop(0)
...
0x5ba: Push("branch")
0x5bb: @ GetVariable(Stack[-1], Stack[-2])
0x5bc: Pop(1)
0x5bd: Stack[-3] = Stack[-1]
0x5be: Return(); Pop(2)

0x5bf: Stack[-1] = (int) 521048
0x5c0: Return(); Pop(0)

0x5c1: Stack[-1] = (int) 521047
0x5c2: Return(); Pop(0)

0x5c3: Stack[-1] = "ui/NPC_Citizen2.png"
0x5c4: Return(); Pop(0)

0x5c5: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x5c6: Return(); Pop(0)
