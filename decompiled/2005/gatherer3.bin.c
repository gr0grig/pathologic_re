task_0_event_11(var_0_bool, var_1_int, var_2_object, var_3_object, var_4_object, var_5_string, var_6_bool, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int, var_14_bool, var_15_bool, var_16_object, var_17_bool, var_18_bool, var_19_int)
{
	...
	func_1467(var_20_bool); // 0x1c NEW_2
...
Label_223:
	...
	func_1467(var_49_bool); // 0xe1 NEW_2
...
Label_738:
	...
	func_1467(var_197_bool); // 0x2e4 NEW_2
...
task_5_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_string, var_10_bool, var_11_int, var_12_int, var_13_bool, var_14_bool, var_15_object, var_16_bool, var_17_bool, var_18_int, var_19_object)
{
	...
	func_1453(var_25_int); // 0x301 NEW_2
...
Label_782:
	...
	func_1453(var_258_int); // 0x30f NEW_2
...
task_5_event_5(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_string, var_10_bool, var_11_int, var_12_int, var_13_bool, var_14_bool, var_15_object, var_16_bool, var_17_bool, var_18_int)
{
	...
	var_43_int = 0; // 0x33b PushV
	func_1292(var_43_int); // 0x33c NEW_2
	var_7_object = var_43_int; // 0x33d TMov
...
main(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_string, var_10_bool, var_11_int, var_12_int, var_13_bool, var_14_bool, var_15_object, var_16_bool, var_17_bool, var_18_int)
{
	...
	var_42_float = 0; var_43_float = 0; // 0x2f6 PushV
	var_42_float = 300; // 0x2f7 MovI
	var_43_float = 100; // 0x2f8 MovI
	func_832(var_18_int, var_42_float, var_43_float); // 0x2f9 NEW_2
...
Label_4:
	...
	func_1467(var_252_bool); // 0x5 NEW_2
...
func_901(var_0_bool, var_1_object, var_2_object, var_3_object, var_47_bool, var_51_float, var_52_float)
{
	var_53_bool = 0; // 0x386 PushV
	func_1074(var_53_bool); // 0x387 NEW_2
	var_56_bool = var_53_bool == 0; // 0x389 Not
	if(var_56_bool == 0) goto Label_908; // 0x38a JumpB
	return 0; // 0x38b Return
	
Label_908:
	var_57_string = "player"; // 0x38c PushS
	FindActor(var_47_bool, var_57_string); // 0x38d Func
	var_2_object = 0; // 0x38f TMovB
	var_3_object = 0; // 0x390 TMovB
	var_0_bool = var_51_float; // 0x391 TMov
	var_1_object = var_52_float; // 0x392 TMov
	var_58_int = 10; // 0x393 PushI
	var_59_float = 1.0; // 0x394 PushF
	SetTimer(var_58_int, var_59_float); // 0x395 Func
	func_980(); // 0x398 NEW_2
	var_111_bool = var_3_object == 0; // 0x39a Not
	if(var_111_bool == 0) goto Label_927; // 0x39b JumpB
	var_112_int = 10; // 0x39c PushI
	KillTimer(var_112_int); // 0x39d Func
...
func_1301(var_82_string, var_83_int)
{
	var_84_string = ""; var_85_string = ""; // 0x515 PushV
	var_85_string = "idle"; // 0x516 MovS
	var_86_int = var_83_int; // 0x517 Push
	if(var_86_int == 0) goto Label_1306; // 0x518 JumpB
	var_85_string = var_85_string + var_83_int; // 0x519 Add2
	
Label_1306:
	var_82_string = var_85_string; // 0x51a Mov
	return 2; // 0x51b Return
}


func_1431(var_32_int, var_33_string)
{
	var_34_int = 0; var_35_int = 0; // 0x597 PushV
	GetInvItemByName(var_35_int, var_33_string); // 0x598 Func
	var_32_int = var_35_int; // 0x59a Mov
	return 2; // 0x59b Return
}


func_1308(var_76_int)
{
	var_77_int = 0; var_78_bool = 0; var_79_int = 0; var_80_bool = 0; // 0x51c PushV
	var_79_int = 0; // 0x51d MovI
	
Label_1310:
	var_81_string = "all"; // 0x51e PushS
	var_82_string = ""; var_83_int = 0; // 0x51f PushV
	var_83_int = var_79_int; // 0x520 Mov
	func_1301(var_82_string, var_83_int); // 0x521 NEW_2
	HasAnimation(var_80_bool, var_81_string, var_82_string); // 0x523 Func
	var_87_bool = var_80_bool == 0; // 0x525 Not
	if(var_87_bool == 0) goto Label_1320; // 0x526 JumpB
	goto Label_1323; // 0x527 Jump
	
Label_1323:
	var_76_int = var_79_int; // 0x52b Mov
	return 4; // 0x52c Return
	
Label_1320:
	var_88_int = 1; // 0x528 PushI
	var_79_int = var_79_int + var_88_int; // 0x529 Add2
	goto Label_1310; // 0x52a Jump
}


func_1436(var_93_int)
{
	var_94_int = 0; var_95_int = 0; // 0x59c PushV
	var_96_string = "branch"; // 0x59d PushS
	GetVariable(var_96_string, var_95_int); // 0x59e Func
	var_97_int = 0; // 0x5a0 PushI
	var_98_bool = var_95_int == var_97_int; // 0x5a1 Eq
	if(var_98_bool == 0) goto Label_1446; // 0x5a2 JumpB
	var_93_int = 1; // 0x5a3 MovI
	return 2; // 0x5a4 Return
	
Label_1446:
	var_99_int = 1; // 0x5a6 PushI
	var_100_bool = var_95_int == var_99_int; // 0x5a7 Eq
	if(var_100_bool == 0) goto Label_1451; // 0x5a8 JumpB
	var_93_int = 2; // 0x5a9 MovI
	return 2; // 0x5aa Return
	
Label_1451:
	var_93_int = 3; // 0x5ab MovI
...
func_172(var_2_object, var_289_string)
{
	...
	func_1467(var_290_bool); // 0xae NEW_2
...
func_1453(var_25_int)
{
	var_26_int = 0; var_27_int = 0; // 0x5ad PushV
	var_28_string = "branch"; // 0x5ae PushS
	GetVariable(var_28_string, var_27_int); // 0x5af Func
	var_25_int = var_27_int; // 0x5b1 Mov
...
{
	var_54_bool = 0; var_55_bool = 0; // 0x432 PushV
	IsLoaded(var_55_bool); // 0x433 Func
	var_53_bool = var_55_bool; // 0x435 Mov
	return 2; // 0x436 Return
}


func_1459(var_90_int)
{
	var_90_int = 521048; // 0x5b3 MovI
	return 0; // 0x5b4 Return
}


func_1461(var_89_int)
{
	var_89_int = 521047; // 0x5b5 MovI
...
Label_414:
	...
	func_1467(var_162_bool); // 0x19f NEW_2
...
func_1463(var_91_string)
{
	var_91_string = "ui/NPC_Citizen2.png"; // 0x5b7 MovS
...
Label_1120:
	...
	func_1467(var_84_bool); // 0x469 NEW_2
...
func_1465(var_92_string)
{
	var_92_string = "ui/NPC_Citizen2_b.png"; // 0x5b9 MovS
	return 0; // 0x5ba Return
}


func_1467(var_84_bool)
{
	var_84_bool = 0; // 0x5bb MovB
...
func_444(var_2_object, var_138_string)
{
	...
	func_1467(var_139_bool); // 0x1be NEW_2
...
func_832(var_6_object, var_42_float, var_43_float)
{
	var_44_float = 0; var_45_bool = 0; var_46_float = 0; var_47_bool = 0; // 0x340 PushV
	var_6_object = 0; // 0x341 TMovB
	
Label_834:
	var_48_int = 3; // 0x342 PushI
	rand(var_46_float, var_48_int); // 0x343 Func
	var_49_int = 3; // 0x345 PushI
	var_50_int = var_46_float + var_49_int; // 0x346 Add
	Sleep(var_50_int, var_47_bool); // 0x347 Func
	var_6_object = 1; // 0x349 TMovB
	var_51_float = 0; var_52_float = 0; // 0x34a PushV
	var_51_float = var_42_float; // 0x34b Mov
	var_52_float = var_43_float; // 0x34c Mov
	func_901(var_43_float, var_44_float, var_45_bool, var_46_float, var_47_bool, var_51_float, var_52_float); // 0x34d NEW_2
...
func_980()
{
	var_60_int = 0; var_61_int = 0; var_62_int = 0; var_63_int = 0; var_64_bool = 0; var_65_float = 0; var_66_bool = 0; var_67_int = 0; var_68_int = 0; var_69_int = 0; var_70_int = 0; var_71_bool = 0; var_72_float = 0; var_73_bool = 0; // 0x3d4 PushV
	WaitForAnimEnd(); // 0x3d5 Func
	var_74_bool = 0; // 0x3d7 PushV
	func_1074(var_74_bool); // 0x3d8 NEW_2
	var_75_bool = var_74_bool == 0; // 0x3da Not
	if(var_75_bool == 0) goto Label_989; // 0x3db JumpB
	return 14; // 0x3dc Return
	
Label_989:
	var_76_int = 0; // 0x3dd PushV
	func_1308(var_76_int); // 0x3de NEW_2
	var_67_int = var_76_int; // 0x3df Mov
	var_68_int = 0; // 0x3e1 MovI
	
Label_994:
	var_89_bool = 0; // 0x3e2 PushV
	var_89_bool = 0; // 0x3e3 MovB
	var_90_int = 5; // 0x3e4 PushI
	var_91_bool = var_68_int < var_90_int; // 0x3e5 LT
	if(var_91_bool == 0) goto Label_1004; // 0x3e6 JumpB
	var_92_bool = 0; // 0x3e7 PushV
	func_1074(var_92_bool); // 0x3e8 NEW_2
	if(var_92_bool == 0) goto Label_1004; // 0x3ea JumpB
	var_89_bool = 1; // 0x3eb MovB
	
Label_1004:
	if(var_89_bool == 0) goto Label_1056; // 0x3ec JumpB
	var_93_int = 3; // 0x3ed PushI
	irand(var_69_int, var_93_int); // 0x3ee Func
	var_94_int = 0; // 0x3f0 PushI
	var_95_bool = var_69_int == var_94_int; // 0x3f1 Eq
	if(var_95_bool == 0) goto Label_1028; // 0x3f2 JumpB
	var_96_int = var_67_int; // 0x3f3 Push
	if(var_96_int == 0) goto Label_1027; // 0x3f4 JumpB
	irand(var_70_int, var_67_int); // 0x3f5 Func
	var_97_string = "all"; // 0x3f7 PushS
	var_98_string = ""; var_99_int = 0; // 0x3f8 PushV
	var_99_int = var_70_int; // 0x3f9 Mov
	func_1301(var_98_string, var_99_int); // 0x3fa NEW_2
	PlayAnimation(var_97_string, var_98_string); // 0x3fc Func
	WaitForAnimEnd(var_71_bool); // 0x3fe Func
	var_100_bool = var_71_bool == 0; // 0x400 Not
	if(var_100_bool == 0) goto Label_1027; // 0x401 JumpB
...
Label_1045:
	var_101_bool = 0; // 0x415 PushV
	func_1059(var_101_bool); // 0x416 NEW_2
	var_102_bool = var_101_bool == 0; // 0x418 Not
	if(var_102_bool == 0) goto Label_1051; // 0x419 JumpB
	goto Label_1056; // 0x41a Jump
	
Label_1051:
	ResetAAS(); // 0x41b Func
	var_103_int = 1; // 0x41d PushI
	var_68_int = var_68_int + var_103_int; // 0x41e Add2
	goto Label_994; // 0x41f Jump
	
Label_1028:
	var_104_int = 1; // 0x404 PushI
	var_105_bool = var_69_int == var_104_int; // 0x405 Eq
	if(var_105_bool == 0) goto Label_1042; // 0x406 JumpB
	var_106_int = 4; // 0x407 PushI
	rand(var_72_float, var_106_int); // 0x408 Func
	var_107_int = 1; // 0x40a PushI
	var_108_int = var_72_float + var_107_int; // 0x40b Add
	Sleep(var_108_int, var_73_bool); // 0x40c Func
	var_109_bool = var_73_bool == 0; // 0x40e Not
	if(var_109_bool == 0) goto Label_1041; // 0x40f JumpB
...
Label_1042:
	var_110_int = var_68_int; // 0x412 Push
	if(var_110_int == 0) goto Label_1045; // 0x413 JumpB
...
func_1257()
{
	...
	func_1467(var_22_bool); // 0x4ea NEW_2
...
Label_142:
	...
	func_1467(var_304_bool); // 0x8f NEW_2
...
func_1147()
{
	...
	func_1467(var_214_bool); // 0x47f NEW_2
