...
Label_70:
	...
	var_113_bool = 0; var_114_object = Obj(); // 0x4d PushV
	var_115_object = GlobalVars[0]; // 0x4e PushGE
	var_114_object = var_115_object; // 0x4f Mov
	func_287(var_113_bool, var_114_object); // 0x51 NEW_2
	if(var_113_bool == 0) goto Label_110; // 0x53 JumpB
	var_116_object = GlobalVars[0]; // 0x54 PushGE
	ReportAttack(var_1_object, var_116_object); // 0x55 Func
	var_117_float = var_5_float; // 0x57 Push
	if(var_117_float == 0) goto Label_110; // 0x58 JumpB
	var_118_object = GlobalVars[0]; // 0x59 PushGE
	var_119_int = 1; // 0x5a PushI
	var_120_float = 0.9; // 0x5b PushF
	ReportHit(var_1_object, var_118_object, var_119_int, var_5_float, var_120_float); // 0x5c Func
	var_121_bool = 0; // 0x5e PushV
	var_121_bool = 0; // 0x5f MovB
	var_122_object = GlobalVars[2]; // 0x60 PushGE
	var_123_bool = var_1_object == var_122_object; // 0x61 Eq
	if(var_123_bool == 0) goto Label_105; // 0x62 JumpB
	var_124_bool = 0; var_125_object = Obj(); // 0x63 PushV
	var_125_object = var_1_object; // 0x64 Mov
	func_215(var_124_bool, var_125_object); // 0x65 NEW_2
	if(var_124_bool == 0) goto Label_105; // 0x67 JumpB
	var_121_bool = 1; // 0x68 MovB
	
Label_105:
	if(var_121_bool == 0) goto Label_110; // 0x69 JumpB
	var_141_object = GlobalVars[0]; // 0x6a PushGE
	var_142_string = "kill"; // 0x6b PushS
	Trigger(var_141_object, var_142_string); // 0x6c Func
...
Label_161:
	var_112_string = "armor"; // 0xa1 PushS
	GetProperty(var_112_string, var_63_int); // 0xa2 ObjFunc
}
...
func_335(var_108_float)
{
	...
	var_111_int = 15; // 0x154 PushI
	SendWorldWndMessage(var_111_int, var_110_object); // 0x155 Func
...
{
	var_136_bool = 0; var_137_bool = 0; // 0x159 PushV
	var_138_string = "god_mode"; // 0x15a PushS
	GetVariable(var_138_string, var_137_bool); // 0x15b Func
	var_135_bool = var_137_bool; // 0x15d Mov
...
{
	var_126_float = 0; var_127_float = 0; // 0xd7 PushV
	var_128_bool = 0; var_129_object = Obj(); var_130_string = ""; // 0xd8 PushV
	var_129_object = var_125_object; // 0xd9 Mov
	var_130_string = "health"; // 0xda MovS
	func_130(var_128_bool, var_129_object, var_130_string); // 0xdb NEW_2
	var_131_bool = var_128_bool == 0; // 0xdd Not
	if(var_131_bool == 0) goto Label_225; // 0xde JumpB
	var_124_bool = 0; // 0xdf MovB
	return 2; // 0xe0 Return
	
Label_225:
	var_132_bool = 0; // 0xe1 PushV
	var_132_bool = 0; // 0xe2 MovB
	var_133_bool = 0; var_134_object = Obj(); // 0xe3 PushV
	var_134_object = var_125_object; // 0xe4 Mov
	func_125(var_133_bool, var_134_object); // 0xe5 NEW_2
	if(var_133_bool == 0) goto Label_237; // 0xe7 JumpB
	var_135_bool = 0; // 0xe8 PushV
	func_345(var_135_bool); // 0xe9 NEW_2
	if(var_135_bool == 0) goto Label_237; // 0xeb JumpB
	var_132_bool = 1; // 0xec MovB
	
Label_237:
	if(var_132_bool == 0) goto Label_240; // 0xed JumpB
	var_124_bool = 0; // 0xee MovB
	return 2; // 0xef Return
	
Label_240:
	var_139_string = "health"; // 0xf0 PushS
	GetProperty(var_139_string, var_127_float); // 0xf1 ObjFunc
	var_140_float = 0.0; // 0xf3 PushF
	var_124_bool = var_127_float <= var_140_float; // 0xf4 LE2
