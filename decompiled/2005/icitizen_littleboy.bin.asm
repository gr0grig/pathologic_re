...
0x120d: PushEmpty()
0x120e: Stack[-2] = (int) 2
0x120f: Return(); Pop(0)

0x1210: PushEmpty()
0x1211: PushEmpty(object)
0x1212: Stack[-1] = Stack[-2]
0x1213: Call2 0x13e1
...
0x1376: PushEmpty()
0x1377: PushEmpty(int)
0x1378: Call2 0x1370

0x1379: Pop(0)
0x137a: Push((int) 1)
0x137b: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x137c: IF (Stack[-1] == 0) GOTO 0x1380; Pop(1)

0x137d: @ WorkWithCorpse(Stack[-1])
0x137e: Pop(0)
0x137f: GOTO 0x1382

0x1380: @ Barter(Stack[-1])
0x1381: Pop(0)
0x1382: Return(); Pop(0)

0x1383: PushEmpty(int, int)
0x1384: Push((int) 0)
0x1385: @ ClearSubContainer(Stack[-1])
0x1386: Pop(1)
0x1387: Push(Stack[-3])
0x1388: IF (Stack[-1] == 0) GOTO 0x139f; Pop(1)

0x1389: PushEmpty(string, int, int, int)
0x138a: Stack[-4] = "rifle_ammo"
0x138b: Stack[-3] = (int) 1
0x138c: Stack[-2] = (int) 2
0x138d: Stack[-1] = (int) 2
0x138e: Call2 0x1090

0x138f: Pop(4)
0x1390: PushEmpty(string, int, int, int)
0x1391: Stack[-4] = "revolver_ammo"
0x1392: Stack[-3] = (int) 1
0x1393: Stack[-2] = (int) 2
0x1394: Stack[-1] = (int) 2
0x1395: Call2 0x1090

0x1396: Pop(4)
0x1397: PushEmpty(string, int, int, int)
0x1398: Stack[-4] = "samopal_ammo"
0x1399: Stack[-3] = (int) 2
...
0x139f: PushEmpty(string, int, int)
0x13a0: Stack[-3] = "lockpick"
0x13a1: Stack[-2] = (int) 1
0x13a2: Stack[-1] = (int) 4
0x13a3: Call2 0x1085

0x13a4: Pop(3)
0x13a5: PushEmpty(string, int, int, int)
0x13a6: Stack[-4] = "alpha_pills"
0x13a7: Stack[-3] = (int) 1
0x13a8: Stack[-2] = (int) 2
0x13a9: Stack[-1] = (int) 3
0x13aa: Call2 0x1090

0x13ab: Pop(4)
0x13ac: PushEmpty(string, int, int)
0x13ad: Stack[-3] = "meradorm"
0x13ae: Stack[-2] = (int) 1
0x13af: Stack[-1] = (int) 2
0x13b0: Call2 0x1085

0x13b1: Pop(3)
0x13b2: PushEmpty(string, int, int)
0x13b3: Stack[-3] = "powder"
0x13b4: Stack[-2] = (int) 1
0x13b5: Stack[-1] = (int) 15
0x13b6: Call2 0x1085
...
0x13ba: Stack[-2] = Stack[-1]
0x13bb: Pop(1)
0x13bc: Push((int) 4)
0x13bd: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x13be: IF (Stack[-1] == 0) GOTO 0x13c5; Pop(1)

0x13bf: PushEmpty(string, int, int)
0x13c0: Stack[-3] = "beta_pills"
0x13c1: Stack[-2] = (int) 1
0x13c2: Stack[-1] = (int) 2
0x13c3: Call2 0x1085

0x13c4: Pop(3)
0x13c5: Push((int) 6)
0x13c6: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x13c7: IF (Stack[-1] == 0) GOTO 0x13ce; Pop(1)

0x13c8: PushEmpty(string, int, int)
0x13c9: Stack[-3] = "gamma_pills"
0x13ca: Stack[-2] = (int) 1
0x13cb: Stack[-1] = (int) 7
0x13cc: Call2 0x1085

0x13cd: Pop(3)
0x13ce: Return(); Pop(2)

0x13cf: Stack[-1] = (int) 515560
0x13d0: Return(); Pop(0)

0x13d1: Stack[-1] = (int) 503345
0x13d2: Return(); Pop(0)

0x13d3: Stack[-1] = "ui/NPC_Citizen3.png"
0x13d4: Return(); Pop(0)

0x13d5: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x13d6: Return(); Pop(0)

0x13d7: Stack[-1] = (bool) 0
0x13d8: Return(); Pop(0)

0x13d9: Push(GlobalVars[0])
0x13da: Stack[-1] = (bool) 0
0x13db: GlobalVars[0] = Stack[-1]; Pop(1)
0x13dc: PushEmpty(bool)
0x13dd: Stack[-1] = (bool) 1
0x13de: Call2 0x1383

0x13df: Pop(1)
0x13e0: Return(); Pop(0)

0x13e1: PushEmpty(bool, bool)
0x13e2: Push(GlobalVars[0])
0x13e3: IF (Stack[-1] == 0) GOTO 0x13ee; Pop(1)

0x13e4: @ IsOverrideActive(Stack[-1])
0x13e5: Pop(0)
0x13e6: Pop(0); Push((bool) Stack[-1] == 0)
0x13e7: IF (Stack[-1] == 0) GOTO 0x13ec; Pop(1)

0x13e8: PushEmpty(object)
0x13e9: Stack[-1] = Stack[-4]
0x13ea: Call2 0x1376
...
0x13ee: Push((int) 1000)
0x13ef: PushEmpty(int, object)
0x13f0: Stack[-1] = Stack[-6]
0x13f1: Push(-2, 1); TaskCall(8)
0x13f2: Call2 0x6c3

0x13f3: Pop(-2, 1); TaskReturn
0x13f4: Pop(1)
0x13f5: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x13f6: IF (Stack[-1] == 0) GOTO 0x1408; Pop(1)
...
0x13fa: Pop(1)
0x13fb: Pop(1); Push((bool) Stack[-1] == 0)
0x13fc: IF (Stack[-1] == 0) GOTO 0x13fe; Pop(1)

0x13fd: Return(); Pop(2)

0x13fe: PushEmpty(object)
0x13ff: Stack[-1] = Stack[-4]
0x1400: Push(-1, 1); TaskCall(0)
0x1401: Call2 0x0

0x1402: Pop(-1, 1); TaskReturn
0x1403: Pop(1)
0x1404: PushEmpty(object)
0x1405: Stack[-1] = Stack[-4]
0x1406: Call2 0x1050

0x1407: Pop(1)
0x1408: Return(); Pop(2)

0x1409: Stack[-1] = (bool) 1
0x140a: Return(); Pop(0)

0x140b: PushEmpty()
0x140c: PushEmpty(bool, object, object, float)
0x140d: Stack[-3] = Stack[-7]
0x140e: Stack[-2] = Stack[-6]
0x140f: Stack[-1] = (float) 500.0
0x1410: Call2 0x11cb

0x1411: Pop(3)
0x1412: IF (Stack[-1] == 0) GOTO 0x1419; Pop(1)

0x1413: Push("ToDie")
0x1414: Push((bool) 1)
0x1415: @ SetProperty(Stack[-2], Stack[-1])
0x1416: Pop(2)
0x1417: Stack[-4] = (bool) 1
0x1418: Return(); Pop(0)

0x1419: Stack[-4] = (bool) 0
0x141a: Return(); Pop(0)
