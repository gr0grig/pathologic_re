...
0xd7b: GlobalVars[0] = Stack[-1]; Pop(1)
...
0xd85: Pop(0)
0xd86: Pop(0); Push((bool) Stack[-1] == 0)
...
0xd9a: Pop(1)
0xd9b: Pop(1); Push((bool) Stack[-1] == 0)
...
0xda0: Push(-1, 1); TaskCall(0)
0xda1: Call2 0x0

0xda2: Pop(-1, 1); TaskReturn
0xda3: Pop(1)
