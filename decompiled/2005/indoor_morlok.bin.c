task_0_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2409(var_15_object); // 0x12 NEW_2
	...
	func_2412(var_18_object); // 0x1a NEW_2
...
task_1_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2409(var_15_object); // 0x9f NEW_2
...
Label_171:
	...
	func_2412(var_20_object); // 0xad NEW_2
...
task_1_event_17(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2302(var_14_object); // 0xb3 NEW_2
	var_23_int = 0; var_24_object = Obj(); // 0xb5 PushV
	var_24_object = var_11_bool; // 0xb6 Mov
	func_2368(var_23_int, var_24_object); // 0xb7 NEW_2
...
Label_195:
	...
	func_2378(var_63_object); // 0xc5 NEW_2
...
task_1_event_30(var_0_object, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_object, var_11_bool, var_12_bool, var_13_bool)
{
	...
	func_2456(var_18_object, var_19_bool); // 0xcd NEW_2
	...
	func_2386(var_38_object, var_39_bool); // 0xd3 NEW_2
...
Label_223:
	...
	func_2393(var_74_object); // 0xe1 NEW_2
...
task_1_event_40(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2399(var_15_object); // 0xe7 NEW_2
...
task_1_event_42(var_0_object, var_1_string, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool)
{
	...
	func_2216(var_15_bool, var_16_object, var_17_string); // 0xfc NEW_2
	...
	func_2248(var_30_object, var_31_string); // 0x105 NEW_2
...
Label_264:
	...
	func_2404(var_43_object); // 0x10b NEW_2
...
task_1_event_26(var_0_string, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2315(var_12_bool, var_13_string); // 0x120 NEW_2
	...
	func_2331(var_21_string); // 0x128 NEW_2
...
task_1_event_1(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2273(var_12_bool, var_13_object); // 0x135 NEW_2
	...
	func_2296(var_24_object); // 0x13d NEW_2
...
task_3_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int, var_10_bool, var_11_bool)
{
	...
	func_2074(var_14_object); // 0x478 NEW_2
...
task_4_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2409(var_15_object); // 0x565 NEW_2
...
Label_1393:
	...
	func_2412(var_20_object); // 0x573 NEW_2
...
task_4_event_17(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2302(var_14_object); // 0x579 NEW_2
	var_23_int = 0; var_24_object = Obj(); // 0x57b PushV
	var_24_object = var_11_object; // 0x57c Mov
	func_2368(var_23_int, var_24_object); // 0x57d NEW_2
...
Label_1417:
	...
	func_2378(var_63_object); // 0x58b NEW_2
...
task_4_event_30(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object, var_12_object, var_13_bool)
{
	...
	func_2456(var_18_object, var_19_bool); // 0x593 NEW_2
	...
	func_2386(var_38_object, var_39_bool); // 0x599 NEW_2
...
Label_1445:
	...
	func_2393(var_74_object); // 0x5a7 NEW_2
...
task_4_event_40(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2399(var_15_object); // 0x5ad NEW_2
...
task_4_event_42(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object, var_12_string)
{
	...
	func_2216(var_15_bool, var_16_object, var_17_string); // 0x5c2 NEW_2
	...
	func_2248(var_30_object, var_31_string); // 0x5cb NEW_2
...
Label_1486:
	...
	func_2404(var_43_object); // 0x5d1 NEW_2
...
task_4_event_26(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_string)
{
	...
	func_2315(var_12_bool, var_13_string); // 0x5e6 NEW_2
	...
	func_2331(var_21_string); // 0x5ee NEW_2
...
task_4_event_1(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2273(var_12_bool, var_13_object); // 0x5f4 NEW_2
	...
	func_2296(var_24_object); // 0x5fc NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0x883 PushV
	var_15_string = "health"; // 0x884 PushS
	var_16_bool = var_12_string == var_15_string; // 0x885 Eq
	if(var_16_bool == 0) goto Label_2191; // 0x886 JumpB
	var_17_string = "health"; // 0x887 PushS
	GetProperty(var_17_string, var_14_float); // 0x888 Func
	var_18_int = 0; // 0x88a PushI
	var_19_bool = var_14_float <= var_18_int; // 0x88b LE
	if(var_19_bool == 0) goto Label_2191; // 0x88c JumpB
	SignalDeath(var_11_object); // 0x88d Func
...
{
	var_12_object = Obj(); // 0x891 PushV
	var_12_object = var_11_object; // 0x892 Mov
	func_2171(var_12_object); // 0x893 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0x897 PushV
	var_15_object = var_11_object; // 0x898 Mov
	var_16_int = var_12_int; // 0x899 Mov
	var_17_float = var_13_float; // 0x89a Mov
	func_1849(var_15_object, var_16_int, var_17_float); // 0x89b NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0x89f PushV
	var_17_object = var_11_object; // 0x8a0 Mov
	var_18_int = var_12_int; // 0x8a1 Mov
	var_19_float = var_13_float; // 0x8a2 Mov
	var_20_cvector = var_15_cvector; // 0x8a3 Mov
	var_21_cvector = var_16_cvector; // 0x8a4 Mov
	func_1917(var_19_float, var_20_cvector, var_21_cvector); // 0x8a5 NEW_2
...
func_0(var_13_object)
{
	...
	func_2478(var_94_object); // 0x8 NEW_2
...
func_2064(var_479_float)
{
	...
	var_482_int = 15; // 0x815 PushI
	SendWorldWndMessage(var_482_int, var_481_object); // 0x816 Func
	return 2; // 0x818 Return
}


func_2074(var_147_object)
{
	var_148_bool = 0; var_149_bool = 0; // 0x81a PushV
	IsPlayerActor(var_147_object, var_149_bool); // 0x81b Func
	var_150_bool = var_149_bool; // 0x81d Push
	if(var_150_bool == 0) goto Label_2082; // 0x81e JumpB
	var_151_string = "attack"; // 0x81f PushS
	PlayGlobalMusic(var_151_string); // 0x820 Func
...
func_2083()
{
	var_384_object = Obj(); var_385_object = Obj(); // 0x823 PushV
	GetScene(var_385_object); // 0x824 Func
	var_386_string = "battle"; // 0x826 PushS
	var_387_object = Obj(); // 0x827 PushV
	func_2025(var_387_object); // 0x828 NEW_2
	BroadcastMessage(var_386_string, var_387_object, var_385_object); // 0x82a Func
...
func_1062(var_0_object)
{
	...
	func_2074(var_147_object); // 0x428 NEW_2
...
{
	var_131_int = 0; var_132_int = 0; // 0x82e PushV
	var_133_string = "branch"; // 0x82f PushS
	GetVariable(var_133_string, var_132_int); // 0x830 Func
	var_130_int = var_132_int; // 0x832 Mov
...
{
	var_27_int = 0; // 0x835 PushV
	func_2094(var_27_int); // 0x836 NEW_2
	var_31_int = 1; // 0x838 PushI
	var_32_bool = var_27_int == var_31_int; // 0x839 Eq
	if(var_32_bool == 0) goto Label_2110; // 0x83a JumpB
	WorkWithCorpse(var_26_object); // 0x83b Func
...
Label_2110:
	Barter(var_26_object); // 0x83e Func
}
...
func_1089(var_2_int, var_154_bool, var_155_object, var_156_float, var_157_float, var_158_bool, var_159_bool)
{
	...
	func_2074(var_167_object); // 0x444 NEW_2
...
func_2113(var_136_string)
{
	var_137_object = Obj(); var_138_int = 0; var_139_bool = 0; var_140_object = Obj(); var_141_int = 0; var_142_bool = 0; // 0x841 PushV
	CreateInvItem(var_140_object); // 0x842 Func
	SetItemName(var_136_string); // 0x844 ObjFunc
	var_143_string = "Organ"; // 0x846 PushS
	var_144_int = 1; // 0x847 PushI
	SetProperty(var_143_string, var_144_int); // 0x848 ObjFunc
	GetItemID(var_141_int); // 0x84a ObjFunc
	var_145_int = 0; // 0x84c PushI
	var_146_int = 1; // 0x84d PushI
	AddItem(var_142_bool, var_140_object, var_145_int, var_146_int); // 0x84e Func
...
func_2130()
{
	var_130_int = 0; // 0x852 PushV
	func_2094(var_130_int); // 0x853 NEW_2
	var_134_int = 1; // 0x855 PushI
	var_135_bool = var_130_int != var_134_int; // 0x856 Neq
	if(var_135_bool == 0) goto Label_2137; // 0x857 JumpB
	return 0; // 0x858 Return
	
Label_2137:
	var_136_string = ""; // 0x859 PushV
	var_136_string = "liver"; // 0x85a MovS
	func_2113(var_136_string); // 0x85b NEW_2
	var_147_string = ""; // 0x85d PushV
	var_147_string = "kidney"; // 0x85e MovS
	func_2113(var_147_string); // 0x85f NEW_2
	var_148_string = ""; // 0x861 PushV
	var_148_string = "heart"; // 0x862 MovS
	func_2113(var_148_string); // 0x863 NEW_2
	var_149_string = ""; // 0x865 PushV
	var_149_string = "blood"; // 0x866 MovS
	func_2113(var_149_string); // 0x867 NEW_2
...
func_2154()
{
	var_104_int = 0; // 0x86a PushI
	ClearSubContainer(var_104_int); // 0x86b Func
	var_105_string = ""; var_106_int = 0; var_107_int = 0; var_108_int = 0; // 0x86d PushV
	var_105_string = "rusk"; // 0x86e MovS
	var_106_int = 1; // 0x86f MovI
	var_107_int = 1; // 0x870 MovI
	var_108_int = 2; // 0x871 MovI
	func_1969(var_105_string, var_106_int, var_107_int, var_108_int); // 0x872 NEW_2
	var_121_string = ""; var_122_int = 0; var_123_int = 0; // 0x874 PushV
	var_121_string = "peanut"; // 0x875 MovS
	var_122_int = 1; // 0x876 MovI
	var_123_int = 4; // 0x877 MovI
	func_1958(var_121_string, var_122_int, var_123_int); // 0x878 NEW_2
...
{
	var_13_object = Obj(); // 0x87c PushV
	var_13_object = var_12_object; // 0x87d Mov
	TaskCall(0); // 0x87e TaskCall
	func_0(var_13_object); // 0x87f NEW_2
	TaskReturn(); // 0x880 TaskReturn
...
Label_1686:
	var_483_string = "armor"; // 0x696 PushS
	GetProperty(var_483_string, var_436_int); // 0x697 ObjFunc
}
...
{
	var_18_string = "unholster"; // 0x8a9 PushS
	var_19_bool = var_17_string == var_18_string; // 0x8aa Eq
	if(var_19_bool == 0) goto Label_2227; // 0x8ab JumpB
	var_20_bool = 0; var_21_object = Obj(); // 0x8ac PushV
	var_21_object = var_16_object; // 0x8ad Mov
	func_2419(var_21_object); // 0x8ae NEW_2
	var_15_bool = var_20_bool; // 0x8af Mov
	return 0; // 0x8b1 Return
	
Label_2227:
	var_22_string = "player_shot"; // 0x8b3 PushS
	var_23_bool = var_17_string == var_22_string; // 0x8b4 Eq
	if(var_23_bool == 0) goto Label_2237; // 0x8b5 JumpB
	var_24_bool = 0; var_25_object = Obj(); // 0x8b6 PushV
	var_25_object = var_16_object; // 0x8b7 Mov
	func_2424(var_25_object); // 0x8b8 NEW_2
	var_15_bool = var_24_bool; // 0x8b9 Mov
	return 0; // 0x8bb Return
	
Label_2237:
	var_26_string = "battle"; // 0x8bd PushS
	var_27_bool = var_17_string == var_26_string; // 0x8be Eq
	if(var_27_bool == 0) goto Label_2246; // 0x8bf JumpB
	var_28_bool = 0; var_29_object = Obj(); // 0x8c0 PushV
	var_29_object = var_16_object; // 0x8c1 Mov
	func_2429(var_29_object); // 0x8c2 NEW_2
	var_15_bool = var_28_bool; // 0x8c3 Mov
	return 0; // 0x8c5 Return
	
Label_2246:
	var_15_bool = 0; // 0x8c6 MovB
...
func_684(var_0_object, var_409_float, var_410_int)
{
	...
	var_484_int = 0; // 0x2c7 PushV
	func_1067(var_484_int); // 0x2c8 NEW_2
	ReportHit(var_0_object, var_484_int, var_416_float, var_415_float); // 0x2ca Func
	var_485_object = Obj(); var_486_float = 0; // 0x2cc PushV
	var_485_object = var_414_object; // 0x2cd Mov
	var_486_float = var_416_float; // 0x2ce Mov
...
{
	var_32_string = "unholster"; // 0x8c9 PushS
	var_33_bool = var_31_string == var_32_string; // 0x8ca Eq
	if(var_33_bool == 0) goto Label_2257; // 0x8cb JumpB
	var_34_object = Obj(); // 0x8cc PushV
	var_34_object = var_30_object; // 0x8cd Mov
	func_2422(); // 0x8ce NEW_2
	goto Label_2272; // 0x8d0 Jump
	
Label_2272:
	return 0; // 0x8e0 Return
	
Label_2257:
	var_35_string = "player_shot"; // 0x8d1 PushS
	var_36_bool = var_31_string == var_35_string; // 0x8d2 Eq
	if(var_36_bool == 0) goto Label_2265; // 0x8d3 JumpB
	var_37_object = Obj(); // 0x8d4 PushV
	var_37_object = var_30_object; // 0x8d5 Mov
	func_2427(); // 0x8d6 NEW_2
	goto Label_2272; // 0x8d8 Jump
	
Label_2265:
	var_38_string = "battle"; // 0x8d9 PushS
	var_39_bool = var_31_string == var_38_string; // 0x8da Eq
	if(var_39_bool == 0) goto Label_2272; // 0x8db JumpB
	var_40_object = Obj(); // 0x8dc PushV
	var_40_object = var_30_object; // 0x8dd Mov
	func_2432(); // 0x8de NEW_2
}
...
Label_759:
	...
	var_487_string = "all"; // 0x2fc PushS
	var_488_string = "attack_middle"; // 0x2fd PushS
	var_489_int = var_488_string + var_378_int; // 0x2fe Add
	HasAnimation(var_379_bool, var_487_string, var_489_int); // 0x2ff Func
	var_490_bool = var_379_bool; // 0x301 Push
	if(var_490_bool == 0) goto Label_840; // 0x302 JumpB
	func_2083(); // 0x304 NEW_2
	var_491_string = "all"; // 0x306 PushS
	var_492_string = "attack_middle"; // 0x307 PushS
	var_493_int = var_492_string + var_378_int; // 0x308 Add
	PlayAnimation(var_491_string, var_493_int); // 0x309 Func
	WaitForAnimEnd(); // 0x30b Func
	func_1062(var_381_string); // 0x30e NEW_2
	var_494_bool = 0; var_495_object = Obj(); // 0x310 PushV
	var_495_object = var_0_object; // 0x311 MovT
	func_1781(var_494_bool, var_495_object); // 0x312 NEW_2
	var_496_bool = var_494_bool == 0; // 0x314 Not
	if(var_496_bool == 0) goto Label_794; // 0x315 JumpB
	StopAsync(); // 0x316 Func
	var_372_bool = 0; // 0x318 MovB
	return 8; // 0x319 Return
	
Label_794:
	var_497_float = 0; var_498_int = 0; // 0x31a PushV
	var_497_float = var_373_float; // 0x31b Mov
	var_498_int = var_378_int; // 0x31c Mov
	func_684(var_381_string, var_497_float, var_498_int); // 0x31d NEW_2
	var_380_int = 1; // 0x31f MovI
	
Label_800:
	var_499_string = "attack_middle"; // 0x320 PushS
	var_500_int = var_499_string + var_378_int; // 0x321 Add
	var_501_string = "_"; // 0x322 PushS
	var_502_int = var_500_int + var_501_string; // 0x323 Add
	var_381_string = var_502_int + var_380_int; // 0x324 Add2
	var_503_string = "all"; // 0x325 PushS
	HasAnimation(var_379_bool, var_503_string, var_381_string); // 0x326 Func
	var_504_bool = var_379_bool == 0; // 0x328 Not
	if(var_504_bool == 0) goto Label_811; // 0x329 JumpB
	goto Label_840; // 0x32a Jump
	
Label_840:
	var_505_bool = 0; // 0x348 PushB
	SetAttackState(var_505_bool); // 0x349 Func
	var_506_string = "all"; // 0x34b PushS
	var_507_string = "attack_end"; // 0x34c PushS
	var_508_int = var_507_string + var_378_int; // 0x34d Add
	PlayAnimation(var_506_string, var_508_int); // 0x34e Func
	var_509_bool = 0; // 0x350 PushV
	func_1076(var_509_bool); // 0x351 NEW_2
	if(var_509_bool == 0) goto Label_858; // 0x353 JumpB
	var_510_bool = 0; var_511_float = 0; // 0x354 PushV
	var_511_float = 0.75; // 0x355 MovF
	func_860(var_510_bool, var_511_float); // 0x356 NEW_2
...
Label_811:
	func_2083(); // 0x32c NEW_2
	var_519_string = "all"; // 0x32e PushS
	PlayAnimation(var_519_string, var_381_string); // 0x32f Func
	WaitForAnimEnd(); // 0x331 Func
	func_1062(var_381_string); // 0x334 NEW_2
	var_520_bool = 0; var_521_object = Obj(); // 0x336 PushV
	var_521_object = var_0_object; // 0x337 MovT
	func_1781(var_520_bool, var_521_object); // 0x338 NEW_2
	var_522_bool = var_520_bool == 0; // 0x33a Not
	if(var_522_bool == 0) goto Label_832; // 0x33b JumpB
	StopAsync(); // 0x33c Func
	var_372_bool = 0; // 0x33e MovB
	return 8; // 0x33f Return
	
Label_832:
	var_523_float = 0; var_524_int = 0; // 0x340 PushV
	var_523_float = var_373_float; // 0x341 Mov
	var_524_int = var_378_int; // 0x342 Mov
	func_684(var_381_string, var_523_float, var_524_int); // 0x343 NEW_2
	var_525_int = 1; // 0x345 PushI
	var_380_int = var_380_int + var_525_int; // 0x346 Add2
...
{
	var_14_bool = 0; var_15_bool = 0; // 0x8e1 PushV
	var_16_bool = 0; // 0x8e2 PushV
	var_16_bool = 0; // 0x8e3 MovB
	var_17_bool = 0; var_18_object = Obj(); // 0x8e4 PushV
	var_18_object = var_13_object; // 0x8e5 Mov
	func_2419(var_18_object); // 0x8e6 NEW_2
	if(var_17_bool == 0) goto Label_2287; // 0x8e8 JumpB
	var_19_bool = 0; var_20_object = Obj(); // 0x8e9 PushV
	var_20_object = var_13_object; // 0x8ea Mov
	func_1650(var_19_bool, var_20_object); // 0x8eb NEW_2
	if(var_19_bool == 0) goto Label_2287; // 0x8ed JumpB
	var_16_bool = 1; // 0x8ee MovB
	
Label_2287:
	if(var_16_bool == 0) goto Label_2294; // 0x8ef JumpB
	IsWeaponHolstered(var_15_bool); // 0x8f0 ObjFunc
	var_23_bool = var_15_bool == 0; // 0x8f2 Not
	if(var_23_bool == 0) goto Label_2294; // 0x8f3 JumpB
	var_12_bool = 1; // 0x8f4 MovB
	return 2; // 0x8f5 Return
	
Label_2294:
	var_12_bool = 0; // 0x8f6 MovB
...
{
	var_25_object = Obj(); // 0x8f9 PushV
	var_25_object = var_24_object; // 0x8fa Mov
	func_2422(); // 0x8fb NEW_2
...
{
	var_15_bool = 0; var_16_object = Obj(); // 0x8ff PushV
	var_16_object = var_14_object; // 0x900 Mov
	func_1650(var_15_bool, var_16_object); // 0x901 NEW_2
	if(var_15_bool == 0) goto Label_2314; // 0x903 JumpB
	var_19_object = Obj(); // 0x904 PushV
	func_2025(var_19_object); // 0x905 NEW_2
	var_22_float = -0.03; // 0x907 PushF
	ReportReputationChange(var_14_object, var_19_object, var_22_float); // 0x908 Func
...
{
	var_14_object = Obj(); var_15_object = Obj(); // 0x90b PushV
	var_16_string = "heal"; // 0x90c PushS
	var_17_bool = var_13_string == var_16_string; // 0x90d Eq
	if(var_17_bool == 0) goto Label_2329; // 0x90e JumpB
	var_18_string = "player"; // 0x90f PushS
	FindActor(var_15_object, var_18_string); // 0x910 Func
	var_19_bool = 0; var_20_object = Obj(); // 0x912 PushV
	var_20_object = var_15_object; // 0x913 Mov
	func_2434(var_20_object); // 0x914 NEW_2
	var_12_bool = var_19_bool; // 0x915 Mov
	return 2; // 0x917 Return
	
Label_2329:
	var_12_bool = 0; // 0x919 MovB
...
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x91b PushV
	var_24_string = "heal"; // 0x91c PushS
	var_25_bool = var_21_string == var_24_string; // 0x91d Eq
	if(var_25_bool == 0) goto Label_2343; // 0x91e JumpB
	var_26_string = "player"; // 0x91f PushS
	FindActor(var_23_object, var_26_string); // 0x920 Func
	var_27_object = Obj(); // 0x922 PushV
	var_27_object = var_23_object; // 0x923 Mov
	func_2437(); // 0x924 NEW_2
	var_23_object = 0; // 0x926 SetNull
...
{
	var_70_string = ""; var_71_string = ""; // 0x928 PushV
	var_71_string = "idle"; // 0x929 MovS
	var_72_int = var_69_int; // 0x92a Push
	if(var_72_int == 0) goto Label_2349; // 0x92b JumpB
	var_71_string = var_71_string + var_69_int; // 0x92c Add2
	
Label_2349:
	var_68_string = var_71_string; // 0x92d Mov
...
{
	var_63_int = 0; var_64_bool = 0; var_65_int = 0; var_66_bool = 0; // 0x92f PushV
	var_65_int = 0; // 0x930 MovI
	
Label_2353:
	var_67_string = "all"; // 0x931 PushS
	var_68_string = ""; var_69_int = 0; // 0x932 PushV
	var_69_int = var_65_int; // 0x933 Mov
	func_2344(var_68_string, var_69_int); // 0x934 NEW_2
	HasAnimation(var_66_bool, var_67_string, var_68_string); // 0x936 Func
	var_73_bool = var_66_bool == 0; // 0x938 Not
	if(var_73_bool == 0) goto Label_2363; // 0x939 JumpB
	goto Label_2366; // 0x93a Jump
	
Label_2366:
	var_62_int = var_65_int; // 0x93e Mov
	return 4; // 0x93f Return
	
Label_2363:
	var_74_int = 1; // 0x93b PushI
	var_65_int = var_65_int + var_74_int; // 0x93c Add2
	goto Label_2353; // 0x93d Jump
}
...
{
	var_42_bool = 0; var_43_object = Obj(); // 0x941 PushV
	var_43_object = var_41_object; // 0x942 Mov
	func_1781(var_42_bool, var_43_object); // 0x943 NEW_2
	if(var_42_bool == 0) goto Label_2376; // 0x945 JumpB
	var_40_int = 2; // 0x946 MovI
...
Label_329:
	...
	func_2351(var_62_int); // 0x14a NEW_2
...
Label_344:
	...
	func_2344(var_84_string, var_85_int); // 0x166 NEW_2
...
{
	var_76_object = Obj(); // 0x94b PushV
	var_76_object = var_75_object; // 0x94c Mov
	TaskCall(2); // 0x94d TaskCall
	func_406(var_76_object); // 0x94e NEW_2
	TaskReturn(); // 0x94f TaskReturn
	return 0; // 0x951 Return
}


func_2386(var_37_int, var_38_object)
{
	var_40_int = 0; var_41_object = Obj(); // 0x953 PushV
	var_41_object = var_38_object; // 0x954 Mov
	func_2368(var_40_int, var_41_object); // 0x955 NEW_2
	var_37_int = var_40_int; // 0x956 Mov
...
{
	var_75_object = Obj(); // 0x95a PushV
	var_75_object = var_74_object; // 0x95b Mov
	func_2378(var_75_object); // 0x95c NEW_2
...
func_860(var_510_bool, var_511_float)
{
	var_512_float = 0; var_513_bool = 0; var_514_float = 0; var_515_bool = 0; // 0x35c PushV
	rand(var_514_float); // 0x35d Func
	var_516_bool = var_514_float < var_511_float; // 0x35f LT
	if(var_516_bool == 0) goto Label_880; // 0x360 JumpB
	
Label_865:
	IsAnimationPlaying(var_515_bool); // 0x361 Func
	var_517_bool = var_515_bool == 0; // 0x363 Not
	if(var_517_bool == 0) goto Label_870; // 0x364 JumpB
...
Label_885:
	var_510_bool = 0; // 0x375 MovB
	return 4; // 0x376 Return
	
Label_870:
	var_518_bool = 0; // 0x366 PushV
	func_958(var_518_bool); // 0x367 NEW_2
	if(var_518_bool == 0) goto Label_876; // 0x369 JumpB
	var_510_bool = 1; // 0x36a MovB
...
Label_880:
	...
	func_1062(var_515_bool); // 0x373 NEW_2
}


func_2399(var_14_int)
{
	var_14_int = 0; // 0x960 MovI
...
func_2404(var_41_int)
{
	var_41_int = 0; // 0x965 MovI
...
func_2409(var_14_int)
{
	var_14_int = 2; // 0x96a MovI
...
{
	var_21_object = Obj(); // 0x96d PushV
	var_21_object = var_20_object; // 0x96e Mov
	func_2439(var_21_object); // 0x96f NEW_2
...
func_2419(var_17_bool)
{
	var_17_bool = 0; // 0x974 MovB
...
func_2424(var_24_bool)
{
	var_24_bool = 0; // 0x979 MovB
...
func_2429(var_28_bool)
{
	var_28_bool = 0; // 0x97e MovB
...
func_2434(var_19_bool)
{
	var_19_bool = 0; // 0x983 MovB
...
{
	var_22_bool = 0; var_23_bool = 0; // 0x987 PushV
	var_24_bool = GlobalVars[0]; // 0x988 PushGE
	if(var_24_bool == 0) goto Label_2451; // 0x989 JumpB
	IsOverrideActive(var_23_bool); // 0x98a Func
	var_25_bool = var_23_bool == 0; // 0x98c Not
	if(var_25_bool == 0) goto Label_2450; // 0x98d JumpB
	var_26_object = Obj(); // 0x98e PushV
	var_26_object = var_21_object; // 0x98f Mov
	func_2100(var_26_object); // 0x990 NEW_2
...
func_2452()
{
	var_12_bool = GlobalVars[0]; // 0x994 PushGE
	var_12_bool = 0; // 0x995 MovB
	GlobalVars[0] = var_12_bool; // 0x996 PopGE
...
func_2456(var_16_bool, var_18_object)
{
	var_20_string = ""; var_21_string = ""; // 0x998 PushV
	var_22_bool = 0; var_23_object = Obj(); var_24_string = ""; // 0x999 PushV
	var_23_object = var_18_object; // 0x99a Mov
	var_24_string = "class"; // 0x99b MovS
	func_1655(var_22_bool, var_23_object, var_24_string); // 0x99c NEW_2
	var_31_bool = var_22_bool == 0; // 0x99e Not
	if(var_31_bool == 0) goto Label_2466; // 0x99f JumpB
	var_16_bool = 0; // 0x9a0 MovB
	return 2; // 0x9a1 Return
	
Label_2466:
	var_32_string = "class"; // 0x9a2 PushS
	GetProperty(var_32_string, var_21_string); // 0x9a3 ObjFunc
	var_16_bool = 1; // 0x9a5 MovB
	var_33_string = "butcher"; // 0x9a6 PushS
	var_34_bool = var_21_string == var_33_string; // 0x9a7 Eq
	if(var_34_bool == 0) goto Label_2477; // 0x9a8 JumpB
	var_35_string = "morlok"; // 0x9a9 PushS
	var_36_bool = var_21_string == var_35_string; // 0x9aa Eq
	if(var_36_bool == 0) goto Label_2477; // 0x9ab JumpB
	var_16_bool = 0; // 0x9ac MovB
...
Label_576:
	...
	var_526_string = "all"; // 0x242 PushS
	var_527_string = "fjump"; // 0x243 PushS
	PlayAnimation(var_526_string, var_527_string); // 0x244 Func
	WaitForAnimEnd(); // 0x246 Func
	func_1062(var_107_float); // 0x249 NEW_2
	var_528_cvector = CVector(0.0, 0.0, 0.0); // 0x24b PushVec
	SetSpeed(var_528_cvector); // 0x24c Func
	Stop(); // 0x24e Func
	StopAsync(); // 0x250 Func
	var_529_bool = 0; // 0x252 PushV
	func_1019(var_107_float, var_529_bool); // 0x253 NEW_2
	var_530_bool = var_529_bool == 0; // 0x255 Not
	if(var_530_bool == 0) goto Label_622; // 0x256 JumpB
	var_531_bool = 0; var_532_object = Obj(); // 0x257 PushV
	var_532_object = var_0_object; // 0x258 MovT
	func_1781(var_531_bool, var_532_object); // 0x259 NEW_2
	var_533_bool = var_531_bool == 0; // 0x25b Not
	if(var_533_bool == 0) goto Label_606; // 0x25c JumpB
...
Label_606:
	...
	var_534_float = var_85_float * var_85_float; // 0x264 Mult
	var_535_bool = var_104_float < var_534_float; // 0x265 LT
	if(var_535_bool == 0) goto Label_622; // 0x266 JumpB
	var_536_bool = 0; var_537_float = 0; // 0x267 PushV
	var_537_float = var_85_float; // 0x268 Mov
	func_723(var_107_float, var_536_bool, var_537_float); // 0x269 NEW_2
	var_538_bool = var_536_bool == 0; // 0x26b Not
	if(var_538_bool == 0) goto Label_622; // 0x26c JumpB
	goto Label_632; // 0x26d Jump
	
Label_623:
	var_539_bool = 0; var_540_float = 0; // 0x26f PushV
	var_540_float = var_85_float; // 0x270 Mov
	func_723(var_107_float, var_539_bool, var_540_float); // 0x271 NEW_2
	var_541_bool = var_539_bool == 0; // 0x273 Not
	if(var_541_bool == 0) goto Label_630; // 0x274 JumpB
...
{
	var_95_bool = 0; var_96_object = Obj(); // 0x9af PushV
	var_96_object = var_94_object; // 0x9b0 Mov
	func_1650(var_95_bool, var_96_object); // 0x9b1 NEW_2
	if(var_95_bool == 0) goto Label_2494; // 0x9b3 JumpB
	var_99_object = Obj(); // 0x9b4 PushV
	func_2025(var_99_object); // 0x9b5 NEW_2
	var_102_float = -0.07; // 0x9b7 PushF
	var_103_bool = 1; // 0x9b8 PushB
	ReportReputationChange(var_94_object, var_99_object, var_102_float, var_103_bool); // 0x9b9 Func
	func_2154(); // 0x9bc NEW_2
	
Label_2494:
	func_2130(); // 0x9bf NEW_2
	var_150_bool = GlobalVars[0]; // 0x9c1 PushGE
	var_150_bool = 1; // 0x9c2 MovB
	GlobalVars[0] = var_150_bool; // 0x9c3 PopGE
	var_151_int = 50; // 0x9c4 PushI
	var_152_int = 40; // 0x9c5 PushI
	SetRTEnvelope(var_151_int, var_152_int); // 0x9c6 Func
