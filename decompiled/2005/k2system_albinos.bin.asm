...
0x3f8: @ StopWorld()
0x3f9: Pop(0)
0x3fa: @ CameraTransit(Stack[-3], Stack[-5])
0x3fb: Pop(0)
0x3fc: Push(CvectorIndex(Stack[-4], 0))
0x3fd: Push(CvectorIndex(Stack[-5], 2))
...
0x405: Push("head")
0x406: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x407: Pop(1)
0x408: Push(Stack[-1])
0x409: IF (Stack[-1] == 0) GOTO 0x40d; Pop(1)

0x40a: Push("head")
0x40b: @ LookAsyncCamera(Stack[-1])
0x40c: Pop(1)
0x40d: @ CameraWaitForPlayFinish()
0x40e: Pop(0)
0x40f: @ ResumeWorld()
0x410: Pop(0)
0x411: Stack[-21] = (bool) 1
0x412: Return(); Pop(18)

0x413: PushEmpty(bool, bool)
0x414: @ CameraSwitchToNormal()
0x415: Pop(0)
...
0x424: PushEmpty(bool, float, float, bool, float, float)
0x425: @ lshHasAnimation(Stack[-3], Stack[-7])
0x426: Pop(0)
0x427: Push(Stack[-3])
0x428: IF (Stack[-1] == 0) GOTO 0x42f; Pop(1)

0x429: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x42a: Pop(0)
0x42b: Push((bool) 0)
0x42c: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x42d: Pop(1)
0x42e: GOTO 0x433

0x42f: Push("Can't find lsh animation : ")
0x430: Pop(1); Push(Stack[-1] + Stack[-8]);
0x431: @ Trace(Stack[-1])
0x432: Pop(1)
0x433: Return(); Pop(6)

0x434: PushEmpty(bool, float, float, bool, float, float)
0x435: @ lshHasAnimation(Stack[-3], Stack[-8])
0x436: Pop(0)
0x437: Push(Stack[-3])
0x438: IF (Stack[-1] == 0) GOTO 0x43e; Pop(1)

0x439: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x43a: Pop(0)
0x43b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x43c: Pop(0)
0x43d: GOTO 0x442

0x43e: Push("Can't find lsh animation : ")
0x43f: Pop(1); Push(Stack[-1] + Stack[-9]);
0x440: @ Trace(Stack[-1])
0x441: Pop(1)
0x442: Return(); Pop(6)

0x443: PushEmpty(float, cvector, float, cvector)
0x444: @@ GetEyesHeight(Stack[-2])
0x445: Pop(0)
0x446: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x447: Push(CvectorIndex(Stack[-1], 1))
0x448: Stack[-1] = Stack[-3]
0x449: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x44a: Push("head")
0x44b: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x44c: Pop(1)
0x44d: Return(); Pop(4)
...
0x460: @ FindActor(Stack[-1], Stack[-4])
0x461: Pop(0)
0x462: Pop(0); Push((bool) Stack[-1] == 0)
0x463: IF (Stack[-1] == 0) GOTO 0x466; Pop(1)

0x464: Stack[-5] = (bool) 0
0x465: Return(); Pop(2)

0x466: @ Trigger(Stack[-1], Stack[-3])
0x467: Pop(0)
0x468: Stack[-5] = (bool) 1
0x469: Return(); Pop(2)

0x46a: Stack[-1] = 0
0x46b: PushEmpty(float, float)
0x46c: @ GetGameTime(Stack[-1])
0x46d: Pop(0)
0x46e: Push((int) 1)
0x46f: PushEmpty(int)
0x470: Push((int) 24)
0x471: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x472: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x473: Return(); Pop(2)
...
0x494: Stack[-2] = "klara2_svita_positioner"
0x495: Stack[-1] = "wonder"
0x496: Call2 0x45f
...
0x49b: Stack[-2] = "klara2_svita_positioner"
0x49c: Stack[-1] = "bad_wonder"
0x49d: Call2 0x45f
...
0x4c1: Stack[-2] = (bool) 1
0x4c2: Return(); Pop(0)

0x4c3: Stack[-2] = (bool) 0
0x4c4: Return(); Pop(0)
...
0x4cf: PushEmpty()
0x4d0: PushEmpty(bool, string)
0x4d1: Stack[-1] = "AlbinosLate1"
0x4d2: Call2 0x536

0x4d3: Stack[-4] = Stack[-2]
0x4d4: Pop(2)
0x4d5: Return(); Pop(0)

0x4d6: PushEmpty()
0x4d7: PushEmpty(bool, string)
0x4d8: Stack[-1] = "Albinos1"
0x4d9: Call2 0x536
...
0x52b: PushEmpty(int, int)
0x52c: Push("day")
0x52d: @ GetProperty(Stack[-1], Stack[-2])
0x52e: Pop(1)
0x52f: Push("K2S_Klara2Svita")
0x530: Pop(1); Push(Stack[-1] + Stack[-4]);
0x531: Pop(1); Push(Stack[-1] + Stack[-2]);
0x532: Push((int) 1)
0x533: @ SetVariable(Stack[-2], Stack[-1])
0x534: Pop(2)
0x535: Return(); Pop(2)

0x536: PushEmpty(int, int, int, int)
0x537: Push("day")
0x538: @ GetProperty(Stack[-1], Stack[-3])
0x539: Pop(1)
0x53a: Push("K2S_Klara2Svita")
0x53b: Pop(1); Push(Stack[-1] + Stack[-6]);
0x53c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x53d: @ GetVariable(Stack[-1], Stack[-2])
0x53e: Pop(1)
0x53f: Push((int) 0)
0x540: Stack[-7] = Stack[-2] == Stack[-1]; Pop(1);
0x541: Return(); Pop(4)

0x542: Stack[-1] = (int) 515595
0x543: Return(); Pop(0)

0x544: Stack[-1] = (int) 512611
0x545: Return(); Pop(0)

0x546: Stack[-1] = "ui/NPC_Albinos.png"
0x547: Return(); Pop(0)

0x548: Stack[-1] = "ui/NPC_Albinos_b.png"
0x549: Return(); Pop(0)
