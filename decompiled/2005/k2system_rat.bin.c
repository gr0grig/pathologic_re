task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1210(var_10_bool, var_11_object); // 0x14 NEW_2
	...
	func_1217(var_53_object); // 0x1c NEW_2
...
task_0_event_16(var_0_bool, var_1_bool, var_2_object, var_3_string, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1244(var_11_bool, var_12_object, var_13_string); // 0x23 NEW_2
...
Label_41:
	...
	func_1271(var_59_object, var_60_string); // 0x2c NEW_2
...
Label_55:
	...
	func_1227(var_45_object); // 0x3c NEW_2
...
task_0_event_0(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1321(var_10_object); // 0x42 NEW_2
...
task_3_event_16(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1244(var_11_bool, var_12_object, var_13_string); // 0x148 NEW_2
...
Label_334:
	...
	func_1271(var_59_object, var_60_string); // 0x151 NEW_2
...
task_4_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1244(var_11_bool, var_12_object, var_13_string); // 0x197 NEW_2
...
Label_413:
	...
	func_1271(var_61_object, var_62_string); // 0x1a0 NEW_2
...
task_5_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_string)
{
	...
	func_1244(var_11_bool, var_12_object, var_13_string); // 0x297 NEW_2
...
Label_669:
	...
	func_1271(var_61_object, var_62_string); // 0x2a0 NEW_2
...
task_5_event_0(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object)
{
	...
	func_1321(var_10_object); // 0x2b6 NEW_2
...
{
	var_10_object = Obj(); // 0x517 PushV
	var_10_object = var_9_object; // 0x518 Mov
	func_1237(); // 0x519 NEW_2
...
{
	var_9_object = Obj(); // 0x543 PushV
	func_1097(var_9_object); // 0x544 NEW_2
	RemoveActor(var_9_object); // 0x546 Func
...
func_1308(var_97_object)
{
	var_98_float = 0; var_99_float = 0; // 0x51c PushV
	var_100_float = 0; var_101_object = Obj(); var_102_float = 0; var_103_int = 0; // 0x51d PushV
	var_101_object = var_97_object; // 0x51e Mov
	var_102_float = 0.025; // 0x51f MovF
	var_103_int = 0; // 0x520 MovI
	func_918(var_100_float, var_101_object, var_102_float, var_103_int); // 0x521 NEW_2
	var_99_float = var_100_float; // 0x522 Mov
	var_158_int = 7; // 0x524 PushI
	var_159_float = 0.025; // 0x525 PushF
	ReportHit(var_97_object, var_158_int, var_99_float, var_159_float); // 0x526 Func
...
func_1184()
{
	var_84_object = Obj(); var_85_object = Obj(); // 0x4a0 PushV
	GetScene(var_85_object); // 0x4a1 Func
	var_86_string = "battle"; // 0x4a3 PushS
	var_87_object = Obj(); // 0x4a4 PushV
	func_1097(var_87_object); // 0x4a5 NEW_2
	BroadcastMessage(var_86_string, var_87_object, var_85_object); // 0x4a7 Func
...
func_1321(var_10_object)
{
	var_11_object = Obj(); var_12_float = 0; var_13_object = Obj(); var_14_float = 0; // 0x529 PushV
	CreateInvItem(var_13_object); // 0x52a Func
	var_15_string = "rat"; // 0x52c PushS
	SetItemName(var_15_string); // 0x52d ObjFunc
	var_16_float = 0.25; // 0x52f PushF
	var_17_float = 0.5; // 0x530 PushF
	rand(var_14_float, var_16_float, var_17_float); // 0x531 Func
	var_18_string = "quality"; // 0x533 PushS
	SetProperty(var_18_string, var_14_float); // 0x534 ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x536 PushV
	var_19_object = var_10_object; // 0x537 Mov
	var_20_object = var_13_object; // 0x538 Mov
	var_21_int = 1; // 0x539 MovI
	func_1155(var_20_object, var_21_int); // 0x53a NEW_2
	var_35_object = Obj(); // 0x53c PushV
	func_1097(var_35_object); // 0x53d NEW_2
	RemoveActor(var_35_object); // 0x53f Func
...
func_1195(var_67_bool, var_68_object)
{
	var_69_bool = 0; var_70_object = Obj(); // 0x4ac PushV
	var_70_object = var_68_object; // 0x4ad Mov
	func_1032(var_69_bool, var_70_object); // 0x4ae NEW_2
	var_71_bool = var_69_bool == 0; // 0x4b0 Not
	if(var_71_bool == 0) goto Label_1204; // 0x4b1 JumpB
	var_67_bool = 0; // 0x4b2 MovB
	return 0; // 0x4b3 Return
	
Label_1204:
	var_72_bool = 0; var_73_object = Obj(); // 0x4b4 PushV
	var_73_object = var_68_object; // 0x4b5 Mov
	func_901(var_72_bool, var_73_object); // 0x4b6 NEW_2
	var_67_bool = var_72_bool; // 0x4b7 Mov
...
func_1210(var_10_bool, var_11_object)
{
	var_12_bool = 0; var_13_object = Obj(); // 0x4bb PushV
	var_13_object = var_11_object; // 0x4bc Mov
	func_1195(var_12_bool, var_13_object); // 0x4bd NEW_2
	var_10_bool = var_12_bool; // 0x4be Mov
...
func_1217(var_53_object)
{
	var_54_object = Obj(); // 0x4c2 PushV
	var_54_object = var_53_object; // 0x4c3 Mov
	TaskCall(3); // 0x4c4 TaskCall
	func_228(var_53_object, var_55_object, var_54_object); // 0x4c5 NEW_2
	TaskReturn(); // 0x4c6 TaskReturn
	ResetAAS(); // 0x4c8 Func
...
func_1097(var_9_object)
{
	var_10_object = Obj(); var_11_object = Obj(); // 0x449 PushV
	self(var_11_object); // 0x44a Func
	var_9_object = var_11_object; // 0x44c Mov
	return 2; // 0x44d Return
}


func_1227(var_45_object)
{
	var_46_object = Obj(); // 0x4cc PushV
	var_46_object = var_45_object; // 0x4cd Mov
	TaskCall(3); // 0x4ce TaskCall
	func_228(var_45_object, var_47_object, var_46_object); // 0x4cf NEW_2
	TaskReturn(); // 0x4d0 TaskReturn
	ResetAAS(); // 0x4d2 Func
...
func_1237()
{
	TaskCall(2); // 0x4d7 TaskCall
	func_179(); // 0x4d8 NEW_2
...
func_1244(var_11_bool, var_12_object, var_13_string)
{
	var_14_float = 0; var_15_bool = 0; var_16_float = 0; var_17_bool = 0; // 0x4dc PushV
	var_18_string = "health"; // 0x4dd PushS
	var_19_bool = var_13_string == var_18_string; // 0x4de Eq
	if(var_19_bool == 0) goto Label_1269; // 0x4df JumpB
	var_20_string = "health"; // 0x4e0 PushS
	GetProperty(var_20_string, var_16_float); // 0x4e1 Func
	var_21_float = GlobalVars[0]; // 0x4e3 PushGE
	var_17_bool = var_16_float < var_21_float; // 0x4e4 LT2
	var_22_float = GlobalVars[0]; // 0x4e5 PushGE
	var_22_float = var_16_float; // 0x4e6 Mov
	GlobalVars[0] = var_22_float; // 0x4e7 PopGE
	var_23_bool = 0; // 0x4e8 PushV
	var_23_bool = 0; // 0x4e9 MovB
	var_24_bool = var_17_bool; // 0x4ea Push
	if(var_24_bool == 0) goto Label_1266; // 0x4eb JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x4ec PushV
	var_26_object = var_12_object; // 0x4ed Mov
	func_1032(var_25_bool, var_26_object); // 0x4ee NEW_2
	if(var_25_bool == 0) goto Label_1266; // 0x4f0 JumpB
	var_23_bool = 1; // 0x4f1 MovB
	
Label_1266:
	if(var_23_bool == 0) goto Label_1269; // 0x4f2 JumpB
	var_11_bool = 1; // 0x4f3 MovB
	return 4; // 0x4f4 Return
...
func_991(var_40_bool)
{
	var_42_bool = 0; var_43_bool = 0; // 0x3df PushV
	IsDead(var_43_bool); // 0x3e0 ObjFunc
	var_40_bool = var_43_bool; // 0x3e2 Mov
...
Label_236:
	...
	func_1195(var_67_bool, var_68_object); // 0xee NEW_2
...
Label_277:
	...
	func_1308(var_97_object); // 0x122 NEW_2
...
func_1271(var_61_object, var_62_string)
{
	var_63_float = 0; var_64_float = 0; // 0x4f7 PushV
	var_65_string = "health"; // 0x4f8 PushS
	var_66_bool = var_62_string == var_65_string; // 0x4f9 Eq
	if(var_66_bool == 0) goto Label_1301; // 0x4fa JumpB
	var_67_string = "health"; // 0x4fb PushS
	GetProperty(var_67_string, var_64_float); // 0x4fc Func
	var_68_int = 0; // 0x4fe PushI
	var_69_bool = var_64_float <= var_68_int; // 0x4ff LE
	if(var_69_bool == 0) goto Label_1283; // 0x500 JumpB
	SignalDeath(var_61_object); // 0x501 Func
	
Label_1283:
	var_70_bool = 0; // 0x503 PushV
	var_70_bool = 0; // 0x504 MovB
	var_71_float = GlobalVars[0]; // 0x505 PushGE
	var_72_bool = var_64_float < var_71_float; // 0x506 LT
	if(var_72_bool == 0) goto Label_1294; // 0x507 JumpB
	var_73_bool = 0; var_74_object = Obj(); // 0x508 PushV
	var_74_object = var_61_object; // 0x509 Mov
	func_1032(var_73_bool, var_74_object); // 0x50a NEW_2
	if(var_73_bool == 0) goto Label_1294; // 0x50c JumpB
	var_70_bool = 1; // 0x50d MovB
	
Label_1294:
	if(var_70_bool == 0) goto Label_1301; // 0x50e JumpB
	var_75_object = Obj(); // 0x50f PushV
	var_75_object = var_61_object; // 0x510 Mov
	TaskCall(5); // 0x511 TaskCall
	func_607(var_79_object, var_75_object); // 0x512 NEW_2
	TaskReturn(); // 0x513 TaskReturn
