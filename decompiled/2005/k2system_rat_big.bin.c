task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1311(var_10_bool, var_11_object); // 0x14 NEW_2
	...
	func_1318(var_53_object); // 0x1c NEW_2
...
task_0_event_16(var_0_bool, var_1_bool, var_2_object, var_3_string, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1345(var_11_bool, var_12_object, var_13_string); // 0x23 NEW_2
...
Label_41:
	...
	func_1372(var_59_object, var_60_string); // 0x2c NEW_2
...
task_0_event_17(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1123(var_10_bool, var_11_object); // 0x32 NEW_2
...
Label_55:
	...
	func_1328(var_45_object); // 0x3c NEW_2
...
task_0_event_0(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1432(var_10_object); // 0x42 NEW_2
...
task_3_event_16(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1345(var_11_bool, var_12_object, var_13_string); // 0x148 NEW_2
...
Label_334:
	...
	func_1372(var_59_object, var_60_string); // 0x151 NEW_2
...
task_4_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1345(var_11_bool, var_12_object, var_13_string); // 0x197 NEW_2
...
Label_413:
	...
	func_1372(var_61_object, var_62_string); // 0x1a0 NEW_2
...
task_5_event_7(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_int)
{
	...
	func_1123(var_16_bool, var_17_object); // 0x276 NEW_2
...
Label_638:
	...
	func_1204(var_53_float, var_54_cvector, var_55_cvector); // 0x285 NEW_2
...
task_5_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_string)
{
	...
	func_1345(var_11_bool, var_12_object, var_13_string); // 0x297 NEW_2
...
Label_669:
	...
	func_1372(var_61_object, var_62_string); // 0x2a0 NEW_2
...
task_5_event_0(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object)
{
	...
	func_1432(var_10_object); // 0x2b6 NEW_2
...
{
	var_10_object = Obj(); // 0x57c PushV
	var_10_object = var_9_object; // 0x57d Mov
	func_1338(); // 0x57e NEW_2
...
{
	var_9_object = Obj(); // 0x5b2 PushV
	func_1188(var_9_object); // 0x5b3 NEW_2
	RemoveActor(var_9_object); // 0x5b5 Func
...
func_1409(var_97_object)
{
	var_98_float = 0; var_99_float = 0; // 0x581 PushV
	var_100_float = 0; var_101_object = Obj(); var_102_float = 0; var_103_int = 0; // 0x582 PushV
	var_101_object = var_97_object; // 0x583 Mov
	var_102_float = 0.02; // 0x584 MovF
	var_103_int = 0; // 0x585 MovI
	func_940(var_100_float, var_101_object, var_102_float, var_103_int); // 0x586 NEW_2
	var_99_float = var_100_float; // 0x587 Mov
	var_158_int = 7; // 0x589 PushI
	var_159_float = 0.02; // 0x58a PushF
	ReportHit(var_97_object, var_158_int, var_99_float, var_159_float); // 0x58b Func
	var_160_float = 0; var_161_object = Obj(); var_162_float = 0; // 0x58d PushV
	var_161_object = var_97_object; // 0x58e Mov
	var_162_float = 0.05; // 0x58f MovF
	func_1013(var_160_float, var_161_object, var_162_float); // 0x590 NEW_2
	var_99_float = var_160_float; // 0x591 Mov
	var_214_int = 5; // 0x593 PushI
	var_215_float = 0.05; // 0x594 PushF
	ReportHit(var_97_object, var_214_int, var_99_float, var_215_float); // 0x595 Func
...
func_1285()
{
	var_84_object = Obj(); var_85_object = Obj(); // 0x505 PushV
	GetScene(var_85_object); // 0x506 Func
	var_86_string = "battle"; // 0x508 PushS
	var_87_object = Obj(); // 0x509 PushV
	func_1188(var_87_object); // 0x50a NEW_2
	BroadcastMessage(var_86_string, var_87_object, var_85_object); // 0x50c Func
...
{
	var_15_bool = 0; var_16_int = 0; var_17_bool = 0; var_18_int = 0; var_19_bool = 0; var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_cvector = CVector(0,0,0); var_23_bool = 0; var_24_int = 0; var_25_bool = 0; var_26_int = 0; var_27_bool = 0; var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_cvector = CVector(0,0,0); // 0x47b PushV
	IsExisting3DSound(var_23_bool, var_14_string); // 0x47c Func
	var_31_bool = var_23_bool == 0; // 0x47e Not
	if(var_31_bool == 0) goto Label_1172; // 0x47f JumpB
	var_24_int = 0; // 0x480 MovI
	
Label_1153:
	var_32_int = 1; // 0x481 PushI
	var_33_int = var_24_int + var_32_int; // 0x482 Add
	var_34_int = var_14_string + var_33_int; // 0x483 Add
	IsExisting3DSound(var_25_bool, var_34_int); // 0x484 Func
	var_35_bool = var_25_bool == 0; // 0x486 Not
	if(var_35_bool == 0) goto Label_1161; // 0x487 JumpB
	goto Label_1164; // 0x488 Jump
	
Label_1164:
	var_36_bool = var_24_int == 0; // 0x48c Not
	if(var_36_bool == 0) goto Label_1167; // 0x48d JumpB
	return 16; // 0x48e Return
	
Label_1167:
	irand(var_26_int, var_24_int); // 0x48f Func
	var_37_int = 1; // 0x491 PushI
	var_38_int = var_26_int + var_37_int; // 0x492 Add
	var_14_string = var_14_string + var_38_int; // 0x493 Add2
	
Label_1172:
	Is3DSoundLoaded(var_27_bool, var_14_string); // 0x494 Func
	var_39_bool = var_27_bool; // 0x496 Push
	if(var_39_bool == 0) goto Label_1187; // 0x497 JumpB
	GetEyesHeight(var_28_float); // 0x498 Func
	GetDirection(var_29_cvector); // 0x49a Func
	var_40_int = 50; // 0x49c PushI
	var_30_cvector = var_29_cvector * var_40_int; // 0x49d Mult2
	var_41_float = GetByIndex(var_30_cvector, 1); // 0x49e PushE
	var_41_float = var_41_float + var_28_float; // 0x49f Add2
	SetByIndex(var_30_cvector, 1) = var_41_float; // 0x4a0 PopE
	PlayGlobalSound(var_14_string, var_30_cvector); // 0x4a1 Func
	
Label_1187:
	return 16; // 0x4a3 Return
	
Label_1161:
	var_42_int = 1; // 0x489 PushI
	var_24_int = var_24_int + var_42_int; // 0x48a Add2
	goto Label_1153; // 0x48b Jump
}
...
func_1296(var_67_bool, var_68_object)
{
	var_69_bool = 0; var_70_object = Obj(); // 0x511 PushV
	var_70_object = var_68_object; // 0x512 Mov
	func_1123(var_69_bool, var_70_object); // 0x513 NEW_2
	var_71_bool = var_69_bool == 0; // 0x515 Not
	if(var_71_bool == 0) goto Label_1305; // 0x516 JumpB
	var_67_bool = 0; // 0x517 MovB
	return 0; // 0x518 Return
	
Label_1305:
	var_72_bool = 0; var_73_object = Obj(); // 0x519 PushV
	var_73_object = var_68_object; // 0x51a Mov
	func_901(var_72_bool, var_73_object); // 0x51b NEW_2
	var_67_bool = var_72_bool; // 0x51c Mov
	return 0; // 0x51e Return
}


func_918(var_180_bool, var_181_object, var_182_string, var_183_float, var_184_float, var_185_float)
{
	var_186_float = 0; var_187_float = 0; // 0x396 PushV
	var_188_bool = 0; var_189_object = Obj(); var_190_string = ""; // 0x397 PushV
	var_189_object = var_181_object; // 0x398 Mov
	var_190_string = var_182_string; // 0x399 Mov
	func_906(var_188_bool, var_189_object, var_190_string); // 0x39a NEW_2
	var_191_bool = var_188_bool == 0; // 0x39c Not
	if(var_191_bool == 0) goto Label_928; // 0x39d JumpB
	var_180_bool = 0; // 0x39e MovB
	return 2; // 0x39f Return
	
Label_928:
	GetProperty(var_182_string, var_187_float); // 0x3a0 ObjFunc
	var_192_float = 0; var_193_float = 0; var_194_float = 0; var_195_float = 0; // 0x3a2 PushV
	var_193_float = var_187_float + var_183_float; // 0x3a3 Add2
	var_194_float = var_184_float; // 0x3a4 Mov
	var_195_float = var_185_float; // 0x3a5 Mov
	func_1215(var_192_float, var_193_float, var_194_float, var_195_float); // 0x3a6 NEW_2
	SetProperty(var_182_string, var_192_float); // 0x3a8 ObjFunc
	var_180_bool = 1; // 0x3aa MovB
	return 2; // 0x3ab Return
}


func_1432(var_10_object)
{
	var_11_object = Obj(); var_12_float = 0; var_13_object = Obj(); var_14_float = 0; // 0x598 PushV
	CreateInvItem(var_13_object); // 0x599 Func
	var_15_string = "rat_big"; // 0x59b PushS
	SetItemName(var_15_string); // 0x59c ObjFunc
	var_16_float = 0.5; // 0x59e PushF
	var_17_int = 1; // 0x59f PushI
	rand(var_14_float, var_16_float, var_17_int); // 0x5a0 Func
	var_18_string = "quality"; // 0x5a2 PushS
	SetProperty(var_18_string, var_14_float); // 0x5a3 ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x5a5 PushV
	var_19_object = var_10_object; // 0x5a6 Mov
	var_20_object = var_13_object; // 0x5a7 Mov
	var_21_int = 1; // 0x5a8 MovI
	func_1246(var_20_object, var_21_int); // 0x5a9 NEW_2
	var_35_object = Obj(); // 0x5ab PushV
	func_1188(var_35_object); // 0x5ac NEW_2
	RemoveActor(var_35_object); // 0x5ae Func
...
func_1311(var_10_bool, var_11_object)
{
	var_12_bool = 0; var_13_object = Obj(); // 0x520 PushV
	var_13_object = var_11_object; // 0x521 Mov
	func_1296(var_12_bool, var_13_object); // 0x522 NEW_2
	var_10_bool = var_12_bool; // 0x523 Mov
...
func_1188(var_9_object)
{
	var_10_object = Obj(); var_11_object = Obj(); // 0x4a4 PushV
	self(var_11_object); // 0x4a5 Func
	var_9_object = var_11_object; // 0x4a7 Mov
	return 2; // 0x4a8 Return
}


func_1318(var_53_object)
{
	var_54_object = Obj(); // 0x527 PushV
	var_54_object = var_53_object; // 0x528 Mov
	TaskCall(3); // 0x529 TaskCall
	func_228(var_53_object, var_55_object, var_54_object); // 0x52a NEW_2
	TaskReturn(); // 0x52b TaskReturn
	ResetAAS(); // 0x52d Func
...
{
	var_112_float = 0; var_113_float = 0; // 0x4aa PushV
	var_114_int = var_111_cvector | var_111_cvector; // 0x4ab Or
	var_113_float = sqrt(var_114_int); // 0x4ac Sqrt2
	var_115_float = 0.0; // 0x4ad PushF
	var_116_bool = var_113_float < var_115_float; // 0x4ae LT
	if(var_116_bool == 0) goto Label_1202; // 0x4af JumpB
	var_110_cvector = CVector(0.0, 0.0, 0.0); // 0x4b0 MovV
	return 2; // 0x4b1 Return
	
Label_1202:
	var_110_cvector = var_111_cvector / var_111_cvector; // 0x4b2 Div2
...
{
	var_104_int = 0; var_105_string = ""; var_106_int = 0; var_107_float = 0; var_108_float = 0; var_109_float = 0; var_110_int = 0; var_111_string = ""; var_112_int = 0; var_113_float = 0; var_114_float = 0; var_115_float = 0; // 0x3ac PushV
	var_116_bool = 0; var_117_object = Obj(); var_118_string = ""; // 0x3ad PushV
	var_117_object = var_101_object; // 0x3ae Mov
	var_118_string = "health"; // 0x3af MovS
	func_906(var_116_bool, var_117_object, var_118_string); // 0x3b0 NEW_2
	var_119_bool = var_116_bool == 0; // 0x3b2 Not
	if(var_119_bool == 0) goto Label_950; // 0x3b3 JumpB
	var_100_float = 0.0; // 0x3b4 MovF
	return 12; // 0x3b5 Return
	
Label_950:
	var_120_bool = 0; var_121_object = Obj(); var_122_string = ""; // 0x3b6 PushV
	var_121_object = var_101_object; // 0x3b7 Mov
	var_122_string = "armor"; // 0x3b8 MovS
	func_906(var_120_bool, var_121_object, var_122_string); // 0x3b9 NEW_2
	var_123_bool = var_120_bool == 0; // 0x3bb Not
	if(var_123_bool == 0) goto Label_959; // 0x3bc JumpB
	var_110_int = 0; // 0x3bd MovI
	goto Label_962; // 0x3be Jump
	
Label_962:
	var_124_string = "armor_"; // 0x3c2 PushS
	var_125_string = ""; var_126_int = 0; // 0x3c3 PushV
	var_126_int = var_103_int; // 0x3c4 Mov
	func_875(var_125_string, var_126_int); // 0x3c5 NEW_2
	var_111_string = var_124_string + var_125_string; // 0x3c7 Add2
	var_131_bool = 0; var_132_object = Obj(); var_133_string = ""; // 0x3c8 PushV
	var_132_object = var_101_object; // 0x3c9 Mov
	var_133_string = var_111_string; // 0x3ca Mov
	func_906(var_131_bool, var_132_object, var_133_string); // 0x3cb NEW_2
	var_134_bool = var_131_bool == 0; // 0x3cd Not
	if(var_134_bool == 0) goto Label_977; // 0x3ce JumpB
	var_112_int = 0; // 0x3cf MovI
	goto Label_979; // 0x3d0 Jump
	
Label_979:
	var_135_float = 0; var_136_float = 0; var_137_float = 0; // 0x3d3 PushV
	var_138_int = var_110_int + var_112_int; // 0x3d4 Add
	var_139_float = 100.0; // 0x3d5 PushF
	var_136_float = var_138_int / var_138_int; // 0x3d6 Div2
	var_137_float = 1; // 0x3d7 MovI
	func_1208(var_135_float, var_136_float, var_137_float); // 0x3d8 NEW_2
	var_113_float = var_135_float; // 0x3d9 Mov
	var_141_string = "health"; // 0x3db PushS
	GetProperty(var_141_string, var_114_float); // 0x3dc ObjFunc
	var_142_int = 1; // 0x3de PushI
	var_143_int = var_142_int - var_113_float; // 0x3df Sub
	var_115_float = var_102_float * var_143_int; // 0x3e0 Mult2
	var_144_string = "health"; // 0x3e1 PushS
	var_145_float = 0; var_146_float = 0; var_147_float = 0; var_148_float = 0; // 0x3e2 PushV
	var_146_float = var_114_float - var_115_float; // 0x3e3 Sub2
	var_147_float = 0; // 0x3e4 MovI
	var_148_float = 1; // 0x3e5 MovI
	func_1215(var_145_float, var_146_float, var_147_float, var_148_float); // 0x3e6 NEW_2
	SetProperty(var_144_string, var_145_float); // 0x3e8 ObjFunc
	var_151_bool = 0; var_152_object = Obj(); // 0x3ea PushV
	var_152_object = var_101_object; // 0x3eb Mov
	func_901(var_151_bool, var_152_object); // 0x3ec NEW_2
	if(var_151_bool == 0) goto Label_1011; // 0x3ee JumpB
	var_153_float = 0; // 0x3ef PushV
	var_153_float = -var_115_float; // 0x3f0 Neg2
	func_1275(var_153_float); // 0x3f1 NEW_2
	
Label_1011:
	var_100_float = var_115_float; // 0x3f3 Mov
	return 12; // 0x3f4 Return
	
Label_977:
	GetProperty(var_111_string, var_112_int); // 0x3d1 ObjFunc
	
Label_959:
	var_157_string = "armor"; // 0x3bf PushS
	GetProperty(var_157_string, var_110_int); // 0x3c0 ObjFunc
}


func_1328(var_45_object)
{
	var_46_object = Obj(); // 0x531 PushV
	var_46_object = var_45_object; // 0x532 Mov
	TaskCall(3); // 0x533 TaskCall
	func_228(var_45_object, var_47_object, var_46_object); // 0x534 NEW_2
	TaskReturn(); // 0x535 TaskReturn
	ResetAAS(); // 0x537 Func
...
{
	var_56_cvector = CVector(0,0,0); var_57_cvector = CVector(0,0,0); // 0x4b4 PushV
	var_57_cvector = var_55_cvector - var_54_cvector; // 0x4b5 Sub2
	var_53_float = var_57_cvector | var_57_cvector; // 0x4b6 Or2
...
{
	var_140_bool = var_136_float < var_137_float; // 0x4b9 LT
	if(var_140_bool == 0) goto Label_1213; // 0x4ba JumpB
	var_135_float = var_136_float; // 0x4bb Mov
	goto Label_1214; // 0x4bc Jump
	
Label_1214:
	return 0; // 0x4be Return
	
Label_1213:
	var_135_float = var_137_float; // 0x4bd Mov
}
...
func_697(var_94_cvector, var_95_float)
{
	...
	func_1194(var_110_cvector, var_111_cvector); // 0x2c3 NEW_2
	...
	func_1194(var_108_cvector, var_109_cvector); // 0x2c8 NEW_2
...
func_1082(var_40_bool)
{
	var_42_bool = 0; var_43_bool = 0; // 0x43a PushV
	IsDead(var_43_bool); // 0x43b ObjFunc
	var_40_bool = var_43_bool; // 0x43d Mov
...
func_1338()
{
	TaskCall(2); // 0x53c TaskCall
	func_179(); // 0x53d NEW_2
...
{
	var_149_bool = var_146_float < var_147_float; // 0x4c0 LT
	if(var_149_bool == 0) goto Label_1220; // 0x4c1 JumpB
	var_145_float = var_147_float; // 0x4c2 Mov
	return 0; // 0x4c3 Return
	
Label_1220:
	var_150_bool = var_146_float > var_148_float; // 0x4c4 GT
	if(var_150_bool == 0) goto Label_1224; // 0x4c5 JumpB
	var_145_float = var_148_float; // 0x4c6 Mov
	return 0; // 0x4c7 Return
	
Label_1224:
	var_145_float = var_146_float; // 0x4c8 Mov
...
{
	var_31_object = Obj(); var_32_object = Obj(); var_33_object = Obj(); var_34_object = Obj(); // 0x43f PushV
	var_35_bool = var_30_object == 0; // 0x440 NullEq
	if(var_35_bool == 0) goto Label_1092; // 0x441 JumpB
	var_29_bool = 0; // 0x442 MovB
	return 4; // 0x443 Return
	
Label_1092:
	var_36_bool = 0; // 0x444 PushV
	var_36_bool = 0; // 0x445 MovB
	var_37_string = "IsDead"; // 0x446 PushS
	var_38_int = 1; // 0x447 PushI
	var_39_bool = IsFuncExist(var_30_object, var_37_string, var_38_int); // 0x448 FuncExist
	if(var_39_bool == 0) goto Label_1104; // 0x449 JumpB
	var_40_bool = 0; var_41_object = Obj(); // 0x44a PushV
	var_41_object = var_30_object; // 0x44b Mov
	func_1082(var_41_object); // 0x44c NEW_2
	if(var_40_bool == 0) goto Label_1104; // 0x44e JumpB
	var_36_bool = 1; // 0x44f MovB
	
Label_1104:
	if(var_36_bool == 0) goto Label_1107; // 0x450 JumpB
	var_29_bool = 0; // 0x451 MovB
	return 4; // 0x452 Return
	
Label_1107:
	GetScene(var_33_object); // 0x453 Func
	var_44_bool = var_33_object == 0; // 0x455 NullEq
	if(var_44_bool == 0) goto Label_1113; // 0x456 JumpB
	var_29_bool = 0; // 0x457 MovB
	return 4; // 0x458 Return
	
Label_1113:
	GetScene(var_34_object); // 0x459 ObjFunc
	var_45_bool = var_33_object != var_34_object; // 0x45b Neq
	if(var_45_bool == 0) goto Label_1119; // 0x45c JumpB
	var_29_bool = 0; // 0x45d MovB
	return 4; // 0x45e Return
	
Label_1119:
	var_29_bool = 1; // 0x45f MovB
	return 4; // 0x460 Return
}


func_1345(var_11_bool, var_12_object, var_13_string)
{
	var_14_float = 0; var_15_bool = 0; var_16_float = 0; var_17_bool = 0; // 0x541 PushV
	var_18_string = "health"; // 0x542 PushS
	var_19_bool = var_13_string == var_18_string; // 0x543 Eq
	if(var_19_bool == 0) goto Label_1370; // 0x544 JumpB
	var_20_string = "health"; // 0x545 PushS
	GetProperty(var_20_string, var_16_float); // 0x546 Func
	var_21_float = GlobalVars[0]; // 0x548 PushGE
	var_17_bool = var_16_float < var_21_float; // 0x549 LT2
	var_22_float = GlobalVars[0]; // 0x54a PushGE
	var_22_float = var_16_float; // 0x54b Mov
	GlobalVars[0] = var_22_float; // 0x54c PopGE
	var_23_bool = 0; // 0x54d PushV
	var_23_bool = 0; // 0x54e MovB
	var_24_bool = var_17_bool; // 0x54f Push
	if(var_24_bool == 0) goto Label_1367; // 0x550 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x551 PushV
	var_26_object = var_12_object; // 0x552 Mov
	func_1123(var_25_bool, var_26_object); // 0x553 NEW_2
	if(var_25_bool == 0) goto Label_1367; // 0x555 JumpB
	var_23_bool = 1; // 0x556 MovB
	
Label_1367:
	if(var_23_bool == 0) goto Label_1370; // 0x557 JumpB
	var_11_bool = 1; // 0x558 MovB
	return 4; // 0x559 Return
	
Label_1370:
	var_11_bool = 0; // 0x55a MovB
...
func_196(var_13_string)
{
	...
	func_1147(var_14_string); // 0xd1 NEW_2
...
{
	var_126_int = var_124_cvector | var_125_cvector; // 0x4cb Or
	var_127_int = var_124_cvector | var_124_cvector; // 0x4cc Or
	var_128_int = var_125_cvector | var_125_cvector; // 0x4cd Or
	var_129_float = var_127_int * var_128_int; // 0x4ce Mult
	var_130_float = sqrt(var_129_float); // 0x4cf Sqrt
	var_123_float = var_126_int / var_126_int; // 0x4d0 Div2
...
func_465(var_0_bool, var_1_bool, var_233_bool, var_234_object, var_235_float, var_236_float, var_237_bool, var_238_bool)
{
	var_240_bool = 0; var_241_bool = 0; var_242_object = Obj(); var_243_cvector = CVector(0,0,0); var_244_cvector = CVector(0,0,0); var_245_cvector = CVector(0,0,0); var_246_float = 0; var_247_object = Obj(); var_248_bool = 0; var_249_bool = 0; var_250_object = Obj(); var_251_cvector = CVector(0,0,0); var_252_cvector = CVector(0,0,0); var_253_cvector = CVector(0,0,0); var_254_float = 0; var_255_object = Obj(); // 0x1d1 PushV
	var_0_bool = 0; // 0x1d2 TMovB
	var_1_bool = var_234_object; // 0x1d3 TMov
	var_249_bool = var_238_bool; // 0x1d4 Mov
	
Label_469:
	var_256_bool = 0; var_257_object = Obj(); // 0x1d5 PushV
	var_257_object = var_234_object; // 0x1d6 Mov
	func_596(var_256_bool, var_257_object); // 0x1d7 NEW_2
	var_260_bool = var_256_bool == 0; // 0x1d9 Not
	if(var_260_bool == 0) goto Label_477; // 0x1da JumpB
	var_233_bool = 0; // 0x1db MovB
	return 16; // 0x1dc Return
	
Label_477:
	GetPosition(var_251_cvector); // 0x1dd ObjFunc
	GetPosition(var_252_cvector); // 0x1df Func
	var_253_cvector = var_251_cvector - var_252_cvector; // 0x1e1 Sub2
	var_254_float = var_253_cvector | var_253_cvector; // 0x1e2 Or2
	var_261_bool = 0; // 0x1e3 PushV
	var_261_bool = 0; // 0x1e4 MovB
	var_262_int = 0; // 0x1e5 PushI
	var_263_bool = var_236_float > var_262_int; // 0x1e6 GT
	if(var_263_bool == 0) goto Label_492; // 0x1e7 JumpB
	var_264_float = var_236_float * var_236_float; // 0x1e8 Mult
	var_265_bool = var_254_float > var_264_float; // 0x1e9 GT
	if(var_265_bool == 0) goto Label_492; // 0x1ea JumpB
	var_261_bool = 1; // 0x1eb MovB
	
Label_492:
	if(var_261_bool == 0) goto Label_497; // 0x1ec JumpB
	Stop(); // 0x1ed Func
	var_233_bool = 0; // 0x1ef MovB
	return 16; // 0x1f0 Return
	
Label_497:
	var_266_float = var_235_float * var_235_float; // 0x1f1 Mult
	var_267_bool = var_254_float > var_266_float; // 0x1f2 GT
	if(var_267_bool == 0) goto Label_559; // 0x1f3 JumpB
	GetPFPosition(var_251_cvector); // 0x1f4 ObjFunc
	FindPathTo(var_255_object, var_251_cvector); // 0x1f6 Func
	var_268_bool = var_255_object != 0; // 0x1f8 NullNeq
	if(var_268_bool == 0) goto Label_508; // 0x1f9 JumpB
	var_250_object = var_255_object; // 0x1fa Mov
	var_255_object = 0; // 0x1fb SetNull
	
Label_508:
	var_269_bool = var_250_object != 0; // 0x1fc NullNeq
	if(var_269_bool == 0) goto Label_541; // 0x1fd JumpB
	var_270_bool = var_249_bool; // 0x1fe Push
	if(var_270_bool == 0) goto Label_518; // 0x1ff JumpB
	var_249_bool = 0; // 0x200 MovB
	RotatePath(var_250_object, var_248_bool); // 0x201 Func
	var_271_bool = var_248_bool == 0; // 0x203 Not
	if(var_271_bool == 0) goto Label_518; // 0x204 JumpB
	goto Label_565; // 0x205 Jump
	
Label_565:
	var_233_bool = !var_0_bool; // 0x235 Not2
	return 16; // 0x236 Return
	
Label_518:
	var_272_int = 0; // 0x206 PushI
	var_273_float = 0.3; // 0x207 PushF
	SetTimer(var_272_int, var_273_float); // 0x208 Func
	var_274_string = ""; // 0x20a PushV
	func_603(var_274_string); // 0x20b NEW_2
	var_275_string = ""; // 0x20d PushV
	func_605(var_275_string); // 0x20e NEW_2
	FollowPath(var_250_object, var_237_bool, var_248_bool, var_274_string, var_275_string); // 0x210 Func
	var_276_bool = var_248_bool == 0; // 0x212 Not
	if(var_276_bool == 0) goto Label_539; // 0x213 JumpB
	var_277_bool = var_0_bool; // 0x214 PushT
	if(var_277_bool == 0) goto Label_537; // 0x215 JumpB
	var_250_object = 0; // 0x216 SetNull
...
Label_539:
	var_250_object = 0; // 0x21b SetNull
	goto Label_557; // 0x21c Jump
	
Label_557:
	var_255_object = 0; // 0x22d SetNull
	goto Label_563; // 0x22e Jump
	
Label_563:
	var_250_object = 0; // 0x233 SetNull
	
Label_541:
	var_278_int = 0; // 0x21d PushI
	KillTimer(var_278_int); // 0x21e Func
	var_279_float = 0.5; // 0x220 PushF
	Sleep(var_279_float, var_248_bool); // 0x221 Func
	var_280_bool = var_248_bool == 0; // 0x223 Not
	if(var_280_bool == 0) goto Label_553; // 0x224 JumpB
	var_281_bool = var_0_bool; // 0x225 PushT
	if(var_281_bool == 0) goto Label_553; // 0x226 JumpB
	var_250_object = 0; // 0x227 SetNull
	goto Label_565; // 0x228 Jump
	
Label_553:
	var_282_int = 0; // 0x229 PushI
	var_283_float = 0.3; // 0x22a PushF
	SetTimer(var_282_int, var_283_float); // 0x22b Func
	
Label_559:
	var_284_int = 0; // 0x22f PushI
	KillTimer(var_284_int); // 0x230 Func
...
{
	var_32_object = Obj(); var_33_object = Obj(); // 0x4d2 PushV
	CreateIntVector(var_33_object); // 0x4d3 Func
	add(var_30_int); // 0x4d5 ObjFunc
	add(var_31_int); // 0x4d7 ObjFunc
	var_34_int = 3; // 0x4d9 PushI
	SendWorldWndMessage(var_34_int, var_33_object); // 0x4da Func
...
func_596(var_22_bool, var_23_object)
{
	...
	func_1123(var_24_bool, var_25_object); // 0x257 NEW_2
...
func_603(var_274_string)
{
	var_274_string = "walk"; // 0x25b MovS
	return 0; // 0x25c Return
}


func_1372(var_61_object, var_62_string)
{
	var_63_float = 0; var_64_float = 0; // 0x55c PushV
	var_65_string = "health"; // 0x55d PushS
	var_66_bool = var_62_string == var_65_string; // 0x55e Eq
	if(var_66_bool == 0) goto Label_1402; // 0x55f JumpB
	var_67_string = "health"; // 0x560 PushS
	GetProperty(var_67_string, var_64_float); // 0x561 Func
	var_68_int = 0; // 0x563 PushI
	var_69_bool = var_64_float <= var_68_int; // 0x564 LE
	if(var_69_bool == 0) goto Label_1384; // 0x565 JumpB
	SignalDeath(var_61_object); // 0x566 Func
	
Label_1384:
	var_70_bool = 0; // 0x568 PushV
	var_70_bool = 0; // 0x569 MovB
	var_71_float = GlobalVars[0]; // 0x56a PushGE
	var_72_bool = var_64_float < var_71_float; // 0x56b LT
	if(var_72_bool == 0) goto Label_1395; // 0x56c JumpB
	var_73_bool = 0; var_74_object = Obj(); // 0x56d PushV
	var_74_object = var_61_object; // 0x56e Mov
	func_1123(var_73_bool, var_74_object); // 0x56f NEW_2
	if(var_73_bool == 0) goto Label_1395; // 0x571 JumpB
	var_70_bool = 1; // 0x572 MovB
	
Label_1395:
	if(var_70_bool == 0) goto Label_1402; // 0x573 JumpB
	var_75_object = Obj(); // 0x574 PushV
	var_75_object = var_61_object; // 0x575 Mov
	TaskCall(5); // 0x576 TaskCall
	func_607(var_79_object, var_75_object); // 0x577 NEW_2
	TaskReturn(); // 0x578 TaskReturn
...
func_605(var_275_string)
{
	var_275_string = "run"; // 0x25d MovS
...
func_859(var_0_bool, var_112_bool)
{
	...
	func_1226(var_123_float, var_124_cvector, var_125_cvector); // 0x366 NEW_2
...
func_1246(var_20_object, var_21_int)
{
	var_22_int = 0; var_23_int = 0; var_24_bool = 0; var_25_int = 0; var_26_int = 0; var_27_bool = 0; // 0x4de PushV
	GetItemID(var_25_int); // 0x4df ObjFunc
	var_28_string = "Category"; // 0x4e1 PushS
	GetInvItemProperty(var_26_int, var_25_int, var_28_string); // 0x4e2 Func
	AddItem(var_27_bool, var_20_object, var_26_int, var_21_int); // 0x4e4 ObjFunc
	var_29_bool = var_27_bool == 0; // 0x4e6 Not
	if(var_29_bool == 0) goto Label_1259; // 0x4e7 JumpB
	DropItems(var_20_object, var_21_int); // 0x4e8 ObjFunc
	goto Label_1264; // 0x4ea Jump
	
Label_1264:
	return 6; // 0x4f0 Return
	
Label_1259:
	var_30_int = 0; var_31_int = 0; // 0x4eb PushV
	var_30_int = var_25_int; // 0x4ec Mov
	var_31_int = var_21_int; // 0x4ed Mov
	func_1234(var_30_int, var_31_int); // 0x4ee NEW_2
}


func_1123(var_25_bool, var_26_object)
{
	var_27_int = 0; var_28_int = 0; // 0x463 PushV
	var_29_bool = 0; var_30_object = Obj(); // 0x464 PushV
	var_30_object = var_26_object; // 0x465 Mov
	func_1087(var_29_bool, var_30_object); // 0x466 NEW_2
	var_46_bool = var_29_bool == 0; // 0x468 Not
	if(var_46_bool == 0) goto Label_1132; // 0x469 JumpB
	var_25_bool = 0; // 0x46a MovB
	return 2; // 0x46b Return
	
Label_1132:
	var_47_bool = 0; var_48_object = Obj(); var_49_string = ""; // 0x46c PushV
	var_48_object = var_26_object; // 0x46d Mov
	var_49_string = "noaccess"; // 0x46e MovS
	func_906(var_47_bool, var_48_object, var_49_string); // 0x46f NEW_2
	var_56_bool = var_47_bool == 0; // 0x471 Not
	if(var_56_bool == 0) goto Label_1141; // 0x472 JumpB
	var_25_bool = 1; // 0x473 MovB
	return 2; // 0x474 Return
	
Label_1141:
	var_57_string = "noaccess"; // 0x475 PushS
	GetProperty(var_57_string, var_28_int); // 0x476 ObjFunc
	var_58_int = 0; // 0x478 PushI
	var_25_bool = var_28_int == var_58_int; // 0x479 Eq2
	return 2; // 0x47a Return
}


func_228(var_0_bool, var_46_object, var_223_bool)
{
...
Label_236:
	...
	func_1296(var_67_bool, var_68_object); // 0xee NEW_2
...
Label_277:
	...
	func_1123(var_94_bool, var_95_object); // 0x117 NEW_2
	...
	func_1409(var_97_object); // 0x122 NEW_2
	
Label_292:
	var_65_object = 0; // 0x124 SetNull
	
Label_293:
	var_216_bool = 0; // 0x125 PushB
	SetAttackState(var_216_bool); // 0x126 Func
	var_217_string = "all"; // 0x128 PushS
	var_218_string = "attack_end"; // 0x129 PushS
	PlayAnimation(var_217_string, var_218_string); // 0x12a Func
	WaitForAnimEnd(var_59_bool); // 0x12c Func
	var_219_bool = var_59_bool == 0; // 0x12e Not
	if(var_219_bool == 0) goto Label_305; // 0x12f JumpB
...
Label_306:
	...
	var_220_bool = 0; var_221_object = Obj(); var_222_float = 0; // 0x134 PushV
	var_221_object = var_0_bool; // 0x135 MovT
	var_222_float = var_58_float; // 0x136 Mov
	TaskCall(4); // 0x137 TaskCall
	func_370(var_220_bool, var_221_object, var_222_float); // 0x138 NEW_2
	TaskReturn(); // 0x139 TaskReturn
	var_286_bool = var_223_bool == 0; // 0x13b Not
	if(var_286_bool == 0) goto Label_318; // 0x13c JumpB
...
func_1265(var_210_float)
{
	var_211_object = Obj(); var_212_object = Obj(); // 0x4f1 PushV
	CreateFloatVector(var_212_object); // 0x4f2 Func
	add(var_210_float); // 0x4f4 ObjFunc
	var_213_int = 14; // 0x4f6 PushI
	SendWorldWndMessage(var_213_int, var_212_object); // 0x4f7 Func
	return 2; // 0x4f9 Return
}


func_370(var_220_bool, var_221_object, var_222_float)
{
	var_225_bool = 0; var_226_bool = 0; // 0x172 PushV
	func_389(); // 0x174 NEW_2
	var_233_bool = 0; var_234_object = Obj(); var_235_float = 0; var_236_float = 0; var_237_bool = 0; var_238_bool = 0; // 0x176 PushV
	var_234_object = var_221_object; // 0x177 Mov
	var_239_float = 0.9; // 0x178 PushF
	var_235_float = var_222_float * var_239_float; // 0x179 Mult2
	var_236_float = 5000; // 0x17a MovI
	var_237_bool = 1; // 0x17b MovB
	var_238_bool = 1; // 0x17c MovB
	func_465(var_225_bool, var_226_bool, var_233_bool, var_234_object, var_235_float, var_236_float, var_237_bool, var_238_bool); // 0x17d NEW_2
	var_226_bool = var_233_bool; // 0x17e Mov
	func_399(); // 0x181 NEW_2
	var_220_bool = var_226_bool; // 0x183 Mov
	return 2; // 0x184 Return
}


func_1013(var_160_float, var_161_object, var_162_float)
{
	var_163_float = 0; var_164_float = 0; var_165_float = 0; var_166_float = 0; // 0x3f5 PushV
	var_167_bool = 0; var_168_object = Obj(); var_169_string = ""; // 0x3f6 PushV
	var_168_object = var_161_object; // 0x3f7 Mov
	var_169_string = "disease"; // 0x3f8 MovS
	func_906(var_167_bool, var_168_object, var_169_string); // 0x3f9 NEW_2
	var_170_bool = var_167_bool == 0; // 0x3fb Not
	if(var_170_bool == 0) goto Label_1023; // 0x3fc JumpB
	var_160_float = 0; // 0x3fd MovI
	return 4; // 0x3fe Return
	
Label_1023:
	var_165_float = 0; // 0x3ff MovI
	var_171_bool = 0; var_172_object = Obj(); var_173_string = ""; // 0x400 PushV
	var_172_object = var_161_object; // 0x401 Mov
	var_173_string = "armor_disease"; // 0x402 MovS
	func_906(var_171_bool, var_172_object, var_173_string); // 0x403 NEW_2
	if(var_171_bool == 0) goto Label_1035; // 0x405 JumpB
	var_174_string = "armor_disease"; // 0x406 PushS
	GetProperty(var_174_string, var_165_float); // 0x407 ObjFunc
	var_175_int = 100; // 0x409 PushI
	var_165_float = var_165_float / var_165_float; // 0x40a Div2
	
Label_1035:
	var_176_bool = 0; var_177_object = Obj(); var_178_string = ""; // 0x40b PushV
	var_177_object = var_161_object; // 0x40c Mov
	var_178_string = "immunity"; // 0x40d MovS
	func_906(var_176_bool, var_177_object, var_178_string); // 0x40e NEW_2
	if(var_176_bool == 0) goto Label_1053; // 0x410 JumpB
	var_179_string = "immunity"; // 0x411 PushS
	GetProperty(var_179_string, var_166_float); // 0x412 ObjFunc
	var_165_float = var_165_float + var_166_float; // 0x414 Add2
	var_180_bool = 0; var_181_object = Obj(); var_182_string = ""; var_183_float = 0; var_184_float = 0; var_185_float = 0; // 0x415 PushV
	var_181_object = var_161_object; // 0x416 Mov
	var_182_string = "immunity"; // 0x417 MovS
	var_183_float = -var_162_float; // 0x418 Neg2
	var_184_float = 0; // 0x419 MovI
	var_185_float = 1; // 0x41a MovI
	func_918(var_180_bool, var_181_object, var_182_string, var_183_float, var_184_float, var_185_float); // 0x41b NEW_2
	
Label_1053:
	var_196_int = 1; // 0x41d PushI
	var_197_bool = var_165_float >= var_196_int; // 0x41e GE
	if(var_197_bool == 0) goto Label_1058; // 0x41f JumpB
	var_160_float = 0.0; // 0x420 MovF
	return 4; // 0x421 Return
	
Label_1058:
	var_198_int = 1; // 0x422 PushI
	var_199_int = var_198_int - var_165_float; // 0x423 Sub
	var_200_int = 2; // 0x424 PushI
	var_201_float = var_199_int / var_200_int; // 0x425 Div
	var_162_float = var_162_float * var_201_float; // 0x426 Mult2
	var_202_bool = 0; var_203_object = Obj(); var_204_string = ""; var_205_float = 0; var_206_float = 0; var_207_float = 0; // 0x427 PushV
	var_203_object = var_161_object; // 0x428 Mov
	var_204_string = "disease"; // 0x429 MovS
	var_205_float = var_162_float; // 0x42a Mov
	var_206_float = 0; // 0x42b MovI
	var_207_float = 1; // 0x42c MovI
	func_918(var_202_bool, var_203_object, var_204_string, var_205_float, var_206_float, var_207_float); // 0x42d NEW_2
	var_208_bool = 0; var_209_object = Obj(); // 0x42f PushV
	var_209_object = var_161_object; // 0x430 Mov
	func_901(var_208_bool, var_209_object); // 0x431 NEW_2
	if(var_208_bool == 0) goto Label_1080; // 0x433 JumpB
	var_210_float = 0; // 0x434 PushV
	var_210_float = var_162_float; // 0x435 Mov
	func_1265(var_210_float); // 0x436 NEW_2
	
Label_1080:
	var_160_float = var_162_float; // 0x438 Mov
...
{
	var_154_object = Obj(); var_155_object = Obj(); // 0x4fb PushV
	CreateFloatVector(var_155_object); // 0x4fc Func
	add(var_153_float); // 0x4fe ObjFunc
	var_156_int = 15; // 0x500 PushI
	SendWorldWndMessage(var_156_int, var_155_object); // 0x501 Func
