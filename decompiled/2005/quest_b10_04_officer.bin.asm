...
0x25e: @ StopWorld()
0x25f: Pop(0)
0x260: @ CameraTransit(Stack[-3], Stack[-5])
0x261: Pop(0)
0x262: Push(CvectorIndex(Stack[-4], 0))
0x263: Push(CvectorIndex(Stack[-5], 2))
0x264: @ Rotate(Stack[-2], Stack[-1])
0x265: Pop(2)
...
0x270: Push("head")
0x271: @ LookAsyncCamera(Stack[-1])
0x272: Pop(1)
0x273: @ CameraWaitForPlayFinish()
0x274: Pop(0)
0x275: @ ResumeWorld()
0x276: Pop(0)
0x277: Stack[-21] = (bool) 1
0x278: Return(); Pop(18)

0x279: PushEmpty(bool, bool)
0x27a: @ CameraSwitchToNormal()
0x27b: Pop(0)
...
0x286: Push("head")
0x287: @ UnlookAsync(Stack[-1])
0x288: Pop(1)
0x289: Return(); Pop(2)

0x28a: PushEmpty(bool, float, float, bool, float, float)
0x28b: @ lshHasAnimation(Stack[-3], Stack[-7])
0x28c: Pop(0)
0x28d: Push(Stack[-3])
0x28e: IF (Stack[-1] == 0) GOTO 0x295; Pop(1)

0x28f: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x290: Pop(0)
0x291: Push((bool) 0)
0x292: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x293: Pop(1)
0x294: GOTO 0x299

0x295: Push("Can't find lsh animation : ")
0x296: Pop(1); Push(Stack[-1] + Stack[-8]);
0x297: @ Trace(Stack[-1])
0x298: Pop(1)
0x299: Return(); Pop(6)

0x29a: PushEmpty(bool, float, float, bool, float, float)
0x29b: @ lshHasAnimation(Stack[-3], Stack[-8])
0x29c: Pop(0)
0x29d: Push(Stack[-3])
0x29e: IF (Stack[-1] == 0) GOTO 0x2a4; Pop(1)

0x29f: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2a0: Pop(0)
0x2a1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2a2: Pop(0)
0x2a3: GOTO 0x2a8

0x2a4: Push("Can't find lsh animation : ")
0x2a5: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2a6: @ Trace(Stack[-1])
0x2a7: Pop(1)
0x2a8: Return(); Pop(6)

0x2a9: PushEmpty(float, cvector, float, cvector)
0x2aa: @@ GetEyesHeight(Stack[-2])
0x2ab: Pop(0)
0x2ac: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x2ad: Push(CvectorIndex(Stack[-1], 1))
0x2ae: Stack[-1] = Stack[-3]
0x2af: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2b0: Push("head")
0x2b1: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2b2: Pop(1)
0x2b3: Return(); Pop(4)
...
0x2c2: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2c3: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2c4: Push((float)0.0)
0x2c5: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2c6: IF (Stack[-1] == 0) GOTO 0x2c9; Pop(1)

0x2c7: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2c8: Return(); Pop(2)

0x2c9: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2ca: Return(); Pop(2)

0x2cb: PushEmpty(int, int)
0x2cc: @ GetVariable(Stack[-3], Stack[-1])
0x2cd: Pop(0)
...
0x2e8: Stack[-1] = (int) 515597
0x2e9: Return(); Pop(0)

0x2ea: Stack[-1] = (int) 514841
0x2eb: Return(); Pop(0)

0x2ec: Stack[-1] = "ui/NPC_Citizen2.png"
0x2ed: Return(); Pop(0)

0x2ee: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x2ef: Return(); Pop(0)
