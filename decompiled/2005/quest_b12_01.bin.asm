...
0x4b3: IF (Stack[-1] == 0) GOTO 0x4c1; Pop(1)
...
0x4b9: Push("gameover_termit_chudo.xml")
0x4ba: @ GameOver(Stack[-1])
0x4bb: Pop(1)
0x4bc: GOTO 0x4c0

0x4bd: Push("gameover_termit.xml")
0x4be: @ GameOver(Stack[-1])
0x4bf: Pop(1)
0x4c0: GOTO 0x4f3
...
0x4c6: IF (Stack[-1] == 0) GOTO 0x4d4; Pop(1)
...
0x4cc: Push("gameover_utopist_chudo.xml")
0x4cd: @ GameOver(Stack[-1])
0x4ce: Pop(1)
0x4cf: GOTO 0x4d3

0x4d0: Push("gameover_utopist.xml")
0x4d1: @ GameOver(Stack[-1])
0x4d2: Pop(1)
0x4d3: GOTO 0x4f3
...
0x4d9: IF (Stack[-1] == 0) GOTO 0x4e7; Pop(1)

0x4da: Push("fin_smiren")
0x4db: @ Trace(Stack[-1])
0x4dc: Pop(1)
0x4dd: Push(Stack[-1])
0x4de: IF (Stack[-1] == 0) GOTO 0x4e3; Pop(1)

0x4df: Push("gameover_smirennik_chudo.xml")
0x4e0: @ GameOver(Stack[-1])
0x4e1: Pop(1)
0x4e2: GOTO 0x4e6

0x4e3: Push("gameover_smirennik.xml")
...
0x4ec: Push("gameover_beda_chudo.xml")
0x4ed: @ GameOver(Stack[-1])
0x4ee: Pop(1)
0x4ef: GOTO 0x4f3

0x4f0: Push("gameover_beda.xml")
0x4f1: @ GameOver(Stack[-1])
0x4f2: Pop(1)
0x4f3: Return(); Pop(18)

0x4f4: PushEmpty(int, int)
0x4f5: Push("b12q01KlaraInSobor")
0x4f6: @ GetVariable(Stack[-1], Stack[-2])
0x4f7: Pop(1)
0x4f8: Push((int) 0)
0x4f9: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x4fa: Return(); Pop(2)

0x4fb: PushEmpty(int, int)
0x4fc: Push("b12q01DankoInSobor")
0x4fd: @ GetVariable(Stack[-1], Stack[-2])
0x4fe: Pop(1)
0x4ff: Push((int) 0)
0x500: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x501: Return(); Pop(2)

0x502: PushEmpty(bool, bool)
0x503: @ IsOverrideActive(Stack[-1])
0x504: Pop(0)
0x505: Stack[-3] = !Stack[-1]; Pop(0);
0x506: Return(); Pop(2)

0x507: PushEmpty(object, object)
0x508: Push("warehouse_rubin")
0x509: @ GetSceneByName(Stack[-2], Stack[-1])
0x50a: Pop(1)
0x50b: Push("rubin")
0x50c: @ Trigger(Stack[-2], Stack[-1])
0x50d: Pop(1)
0x50e: PushEmpty(string, bool)
0x50f: Stack[-2] = "warehouse_rubin@door1"
