task_0_event_9(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_int, var_16_float)
{
	...
	func_1282(var_24_bool); // 0x95 NEW_2
...
Label_173:
	var_148_int = 1; // 0xad PushI
	var_149_bool = var_15_int == var_148_int; // 0xae Eq
	if(var_149_bool == 0) goto Label_189; // 0xaf JumpB
	var_150_bool = 0; // 0xb0 PushV
	func_1006(var_150_bool); // 0xb1 NEW_2
	if(var_150_bool == 0) goto Label_186; // 0xb3 JumpB
	var_263_bool = 0; var_264_string = ""; var_265_string = ""; var_266_string = ""; // 0xb4 PushV
	var_264_string = "volonteers_burah"; // 0xb5 MovS
	var_265_string = "childs_letter"; // 0xb6 MovS
	var_266_string = ""; // 0xb7 MovS
	func_636(var_263_bool, var_264_string, var_265_string, var_266_string); // 0xb8 NEW_2
...
Label_189:
	var_270_int = 2; // 0xbd PushI
	var_271_bool = var_15_int == var_270_int; // 0xbe Eq
	if(var_271_bool == 0) goto Label_197; // 0xbf JumpB
...
Label_239:
	...
	func_1268(var_86_bool); // 0x10e NEW_2
...
Label_281:
	...
	func_1275(var_96_bool); // 0x11a NEW_2
...
func_1282(var_24_bool)
{
	var_25_bool = 0; var_26_bool = 0; // 0x502 PushV
	IsOverrideActive(var_26_bool); // 0x503 Func
	var_24_bool = !var_26_bool; // 0x505 Not2
...
func_1287()
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x507 PushV
	var_21_string = "warehouse_rubin"; // 0x508 PushS
	GetSceneByName(var_20_object, var_21_string); // 0x509 Func
	var_22_string = "rubin"; // 0x50b PushS
	Trigger(var_20_object, var_22_string); // 0x50c Func
	var_23_string = ""; var_24_bool = 0; // 0x50e PushV
	var_23_string = "warehouse_rubin@door1"; // 0x50f MovS
	var_24_bool = 0; // 0x510 MovB
	func_619(var_23_string, var_24_bool); // 0x511 NEW_2
...
Label_1195:
	...
	if(var_113_bool == 0) goto Label_1217; // 0x4b3 JumpB
	var_114_string = "fin_termit"; // 0x4b4 PushS
	Trace(var_114_string); // 0x4b5 Func
	var_115_bool = var_49_bool; // 0x4b7 Push
	if(var_115_bool == 0) goto Label_1213; // 0x4b8 JumpB
	var_116_string = "gameover_termit_chudo.xml"; // 0x4b9 PushS
	GameOver(var_116_string); // 0x4ba Func
	goto Label_1216; // 0x4bc Jump
	
Label_1216:
	goto Label_1267; // 0x4c0 Jump
	
Label_1267:
	return 18; // 0x4f3 Return
	
Label_1213:
	var_117_string = "gameover_termit.xml"; // 0x4bd PushS
	GameOver(var_117_string); // 0x4be Func
	
Label_1217:
	var_118_int = 0; // 0x4c1 PushV
	func_1053(var_118_int); // 0x4c2 NEW_2
	var_119_int = 2; // 0x4c4 PushI
	var_120_bool = var_118_int == var_119_int; // 0x4c5 Eq
	if(var_120_bool == 0) goto Label_1236; // 0x4c6 JumpB
	var_121_string = "fin_utop"; // 0x4c7 PushS
	Trace(var_121_string); // 0x4c8 Func
	var_122_bool = var_49_bool; // 0x4ca Push
	if(var_122_bool == 0) goto Label_1232; // 0x4cb JumpB
	var_123_string = "gameover_utopist_chudo.xml"; // 0x4cc PushS
	GameOver(var_123_string); // 0x4cd Func
	goto Label_1235; // 0x4cf Jump
	
Label_1235:
	goto Label_1267; // 0x4d3 Jump
	
Label_1232:
	var_124_string = "gameover_utopist.xml"; // 0x4d0 PushS
	GameOver(var_124_string); // 0x4d1 Func
	
Label_1236:
	var_125_int = 0; // 0x4d4 PushV
	func_1053(var_125_int); // 0x4d5 NEW_2
	var_126_int = 3; // 0x4d7 PushI
	var_127_bool = var_125_int == var_126_int; // 0x4d8 Eq
	if(var_127_bool == 0) goto Label_1255; // 0x4d9 JumpB
	var_128_string = "fin_smiren"; // 0x4da PushS
	Trace(var_128_string); // 0x4db Func
	var_129_bool = var_49_bool; // 0x4dd Push
	if(var_129_bool == 0) goto Label_1251; // 0x4de JumpB
	var_130_string = "gameover_smirennik_chudo.xml"; // 0x4df PushS
	GameOver(var_130_string); // 0x4e0 Func
	goto Label_1254; // 0x4e2 Jump
	
Label_1254:
	goto Label_1267; // 0x4e6 Jump
	
Label_1251:
	var_131_string = "gameover_smirennik.xml"; // 0x4e3 PushS
	GameOver(var_131_string); // 0x4e4 Func
	
Label_1255:
	var_132_string = "fin_beda"; // 0x4e7 PushS
	Trace(var_132_string); // 0x4e8 Func
	var_133_bool = var_49_bool; // 0x4ea Push
	if(var_133_bool == 0) goto Label_1264; // 0x4eb JumpB
	var_134_string = "gameover_beda_chudo.xml"; // 0x4ec PushS
	GameOver(var_134_string); // 0x4ed Func
	goto Label_1267; // 0x4ef Jump
	
Label_1264:
	var_135_string = "gameover_beda.xml"; // 0x4f0 PushS
	GameOver(var_135_string); // 0x4f1 Func
	
Label_1087:
	var_136_int = 1; // 0x43f PushI
	var_137_bool = var_41_int == var_136_int; // 0x440 Eq
	if(var_137_bool == 0) goto Label_1101; // 0x441 JumpB
	var_138_string = "b12q01ChildsAreVisited"; // 0x442 PushS
	GetVariable(var_138_string, var_46_int); // 0x443 Func
	var_139_int = 0; // 0x445 PushI
	var_43_bool = var_46_int != var_139_int; // 0x446 Neq2
	var_140_string = "b12q01TheaterIsVisited"; // 0x447 PushS
	GetVariable(var_140_string, var_46_int); // 0x448 Func
	var_141_int = 0; // 0x44a PushI
	var_44_bool = var_46_int != var_141_int; // 0x44b Neq2
	goto Label_1114; // 0x44c Jump
	
Label_1101:
	var_142_int = 2; // 0x44d PushI
	var_143_bool = var_41_int == var_142_int; // 0x44e Eq
	if(var_143_bool == 0) goto Label_1114; // 0x44f JumpB
	var_144_string = "k12q01ChildsAreVisited"; // 0x450 PushS
	GetVariable(var_144_string, var_47_int); // 0x451 Func
	var_145_int = 0; // 0x453 PushI
	var_43_bool = var_47_int != var_145_int; // 0x454 Neq2
	var_146_string = "k12q01TheaterIsVisited"; // 0x455 PushS
	GetVariable(var_146_string, var_47_int); // 0x456 Func
	var_147_int = 0; // 0x458 PushI
	var_44_bool = var_47_int != var_147_int; // 0x459 Neq2
}
...
func_1268(var_86_bool)
{
	var_87_int = 0; var_88_int = 0; // 0x4f4 PushV
	var_89_string = "b12q01KlaraInSobor"; // 0x4f5 PushS
	GetVariable(var_89_string, var_88_int); // 0x4f6 Func
	var_90_int = 0; // 0x4f8 PushI
	var_86_bool = var_88_int != var_90_int; // 0x4f9 Neq2
	return 2; // 0x4fa Return
}


func_1275(var_96_bool)
{
	var_97_int = 0; var_98_int = 0; // 0x4fb PushV
	var_99_string = "b12q01DankoInSobor"; // 0x4fc PushS
	GetVariable(var_99_string, var_98_int); // 0x4fd Func
	var_100_int = 0; // 0x4ff PushI
	var_96_bool = var_98_int != var_100_int; // 0x500 Neq2
