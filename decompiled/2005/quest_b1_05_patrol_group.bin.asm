...
Events:
EVENT_22 Op = 0x8e0 Vars = (object, int, float, float)
EVENT_43 Op = 0x8e8 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8f2 Vars = (object, string)
EVENT_41 Op = 0x8ff Vars = (object)
...
0x7ac: PushEmpty(bool, float, float, bool, float, float)
0x7ad: @ lshHasAnimation(Stack[-3], Stack[-7])
0x7ae: Pop(0)
0x7af: Push(Stack[-3])
0x7b0: IF (Stack[-1] == 0) GOTO 0x7b7; Pop(1)

0x7b1: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x7b2: Pop(0)
0x7b3: Push((bool) 0)
...
0x7b7: Push("Can't find lsh animation : ")
0x7b8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7b9: @ Trace(Stack[-1])
0x7ba: Pop(1)
0x7bb: Return(); Pop(6)

0x7bc: PushEmpty(bool, float, float, bool, float, float)
0x7bd: @ lshHasAnimation(Stack[-3], Stack[-8])
0x7be: Pop(0)
0x7bf: Push(Stack[-3])
0x7c0: IF (Stack[-1] == 0) GOTO 0x7c6; Pop(1)

0x7c1: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x7c2: Pop(0)
0x7c3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x7c4: Pop(0)
0x7c5: GOTO 0x7ca

0x7c6: Push("Can't find lsh animation : ")
0x7c7: Pop(1); Push(Stack[-1] + Stack[-9]);
0x7c8: @ Trace(Stack[-1])
0x7c9: Pop(1)
0x7ca: Return(); Pop(6)

0x7cb: PushEmpty(float, cvector, float, cvector)
0x7cc: @@ GetEyesHeight(Stack[-2])
0x7cd: Pop(0)
0x7ce: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x7cf: Push(CvectorIndex(Stack[-1], 1))
0x7d0: Stack[-1] = Stack[-3]
0x7d1: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7d2: Push("head")
0x7d3: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x7d4: Pop(1)
0x7d5: Return(); Pop(4)
...
0x7dd: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7de: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7df: Pop(0)
0x7e0: Pop(0); Push((bool) Stack[-8] == 0)
0x7e1: IF (Stack[-1] == 0) GOTO 0x7f6; Pop(1)

0x7e2: Stack[-7] = (int) 0
0x7e3: Push((int) 1)
0x7e4: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7e5: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7e6: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7e7: Pop(1)
0x7e8: Pop(0); Push((bool) Stack[-6] == 0)
0x7e9: IF (Stack[-1] == 0) GOTO 0x7eb; Pop(1)

0x7ea: GOTO 0x7ee

0x7eb: Push((int) 1)
0x7ec: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7ed: GOTO 0x7e3

0x7ee: Pop(0); Push((bool) Stack[-7] == 0)
0x7ef: IF (Stack[-1] == 0) GOTO 0x7f1; Pop(1)

0x7f0: Return(); Pop(16)

0x7f1: @ irand(Stack[-5], Stack[-7])
0x7f2: Pop(0)
0x7f3: Push((int) 1)
0x7f4: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7f5: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7f6: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7f7: Pop(0)
0x7f8: Push(Stack[-4])
0x7f9: IF (Stack[-1] == 0) GOTO 0x805; Pop(1)

0x7fa: @ GetEyesHeight(Stack[-3])
0x7fb: Pop(0)
0x7fc: @ GetDirection(Stack[-2])
0x7fd: Pop(0)
0x7fe: Push((int) 50)
0x7ff: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x800: Push(CvectorIndex(Stack[-1], 1))
0x801: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x802: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x803: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x804: Pop(0)
0x805: Return(); Pop(16)
...
0x807: @ self(Stack[-1])
0x808: Pop(0)
0x809: Stack[-3] = Stack[-1]
0x80a: Return(); Pop(2)

0x80b: Stack[-1] = 0
0x80c: PushEmpty(float, float)
0x80d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x80e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x80f: Push((float)0.0)
0x810: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x811: IF (Stack[-1] == 0) GOTO 0x814; Pop(1)

0x812: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x813: Return(); Pop(2)

0x814: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x815: Return(); Pop(2)

0x816: PushEmpty()
0x817: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x818: IF (Stack[-1] == 0) GOTO 0x81b; Pop(1)

0x819: Stack[-3] = Stack[-2]
0x81a: GOTO 0x81c
...
0x81d: PushEmpty()
0x81e: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x81f: IF (Stack[-1] == 0) GOTO 0x822; Pop(1)

0x820: Stack[-4] = Stack[-2]
0x821: Return(); Pop(0)

0x822: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x823: IF (Stack[-1] == 0) GOTO 0x826; Pop(1)

0x824: Stack[-4] = Stack[-1]
0x825: Return(); Pop(0)

0x826: Stack[-4] = Stack[-3]
0x827: Return(); Pop(0)

0x828: PushEmpty(object, object)
0x829: @ CreateFloatVector(Stack[-1])
0x82a: Pop(0)
0x82b: @@ add(Stack[-3])
0x82c: Pop(0)
0x82d: Push((int) 15)
0x82e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x82f: Pop(1)
0x830: Return(); Pop(2)

0x831: Stack[-1] = 0
0x832: PushEmpty(object, object)
0x833: @ FindActor(Stack[-1], Stack[-4])
0x834: Pop(0)
0x835: Pop(0); Push((bool) Stack[-1] == 0)
0x836: IF (Stack[-1] == 0) GOTO 0x839; Pop(1)

0x837: Stack[-5] = (bool) 0
0x838: Return(); Pop(2)

0x839: @ Trigger(Stack[-1], Stack[-3])
0x83a: Pop(0)
0x83b: Stack[-5] = (bool) 1
0x83c: Return(); Pop(2)

0x83d: Stack[-1] = 0
0x83e: PushEmpty(bool, bool)
0x83f: @ IsPlayerActor(Stack[-3], Stack[-1])
0x840: Pop(0)
0x841: Push(Stack[-1])
0x842: IF (Stack[-1] == 0) GOTO 0x846; Pop(1)

0x843: Push("attack")
0x844: @ PlayGlobalMusic(Stack[-1])
0x845: Pop(1)
0x846: Return(); Pop(2)

0x847: PushEmpty(object, object)
0x848: @ GetScene(Stack[-1])
0x849: Pop(0)
0x84a: Push("battle")
...
0x84d: Pop(0)
0x84e: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x84f: Pop(2)
0x850: Return(); Pop(2)

0x851: Stack[-1] = 0
0x852: PushEmpty(string, string)
0x853: Stack[-1] = "idle"
0x854: Push(Stack[-3])
0x855: IF (Stack[-1] == 0) GOTO 0x857; Pop(1)

0x856: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x857: Stack[-4] = Stack[-1]
0x858: Return(); Pop(2)

0x859: PushEmpty(int, bool, int, bool)
0x85a: Stack[-2] = (int) 0
0x85b: Push("all")
0x85c: PushEmpty(string, int)
0x85d: Stack[-1] = Stack[-5]
0x85e: Call2 0x852

0x85f: Pop(1)
0x860: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x861: Pop(2)
0x862: Pop(0); Push((bool) Stack[-1] == 0)
0x863: IF (Stack[-1] == 0) GOTO 0x865; Pop(1)

0x864: GOTO 0x868

0x865: Push((int) 1)
0x866: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x867: GOTO 0x85b

0x868: Stack[-5] = Stack[-2]
0x869: Return(); Pop(4)

0x86a: PushEmpty(int, int)
0x86b: Push("branch")
0x86c: @ GetVariable(Stack[-1], Stack[-2])
0x86d: Pop(1)
0x86e: Push((int) 0)
...
0x884: Pop(0)
0x885: Push((int) 1)
0x886: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x887: IF (Stack[-1] == 0) GOTO 0x88b; Pop(1)

0x888: @ WorkWithCorpse(Stack[-1])
0x889: Pop(0)
0x88a: GOTO 0x88d

0x88b: @ Barter(Stack[-1])
0x88c: Pop(0)
0x88d: Return(); Pop(0)
...
0x8b7: Stack[-1] = (int) 515572
0x8b8: Return(); Pop(0)

0x8b9: Stack[-1] = (int) 504031
0x8ba: Return(); Pop(0)

0x8bb: Stack[-1] = "ui/NPC_Citizen2.png"
0x8bc: Return(); Pop(0)

0x8bd: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x8be: Return(); Pop(0)
...
0x8c2: Push("b1q05ToAttack1")
0x8c3: @ GetVariable(Stack[-1], Stack[-2])
0x8c4: Pop(1)
0x8c5: Push((int) 0)
0x8c6: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x8c7: Return(); Pop(2)

0x8c8: Push("b1q05ToAttack1")
0x8c9: Push((int) 1)
0x8ca: @ SetVariable(Stack[-2], Stack[-1])
0x8cb: Pop(2)
0x8cc: Return(); Pop(0)

0x8cd: PushEmpty(object, object)
0x8ce: @ GetScene(Stack[-1])
0x8cf: Pop(0)
0x8d0: PushEmpty(object)
0x8d1: Call2 0x806

0x8d2: Pop(0)
0x8d3: @@ RemoveStationaryActor(Stack[-1])
0x8d4: Pop(1)
0x8d5: PushEmpty()
0x8d6: Call2 0x89f
...
0x8d9: Stack[-1] = Stack[-4]
0x8da: Push(-1, 0); TaskCall(5)
0x8db: Call2 0x57d

0x8dc: Pop(-1, 0); TaskReturn
0x8dd: Pop(1)
0x8de: Return(); Pop(2)

0x8df: Stack[-1] = 0
0x8e0: PushEmpty()
0x8e1: PushEmpty(object, int, float)
0x8e2: Stack[-3] = Stack[-7]
0x8e3: Stack[-2] = Stack[-6]
0x8e4: Stack[-1] = Stack[-5]
0x8e5: Call2 0x6f5
...
0x8e8: PushEmpty()
0x8e9: PushEmpty(object, int, float, cvector, cvector)
0x8ea: Stack[-5] = Stack[-11]
0x8eb: Stack[-4] = Stack[-10]
0x8ec: Stack[-3] = Stack[-9]
0x8ed: Stack[-2] = Stack[-7]
...
0x8f3: Push("health")
0x8f4: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8f5: IF (Stack[-1] == 0) GOTO 0x8fe; Pop(1)

0x8f6: Push("health")
0x8f7: @ GetProperty(Stack[-1], Stack[-2])
0x8f8: Pop(1)
0x8f9: Push((int) 0)
0x8fa: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x8fb: IF (Stack[-1] == 0) GOTO 0x8fe; Pop(1)

0x8fc: @ SignalDeath(Stack[-4])
0x8fd: Pop(0)
0x8fe: Return(); Pop(2)
