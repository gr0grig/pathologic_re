...
0x52a: Stack[-3] = Stack[-7]
0x52b: Stack[-2] = (float) 0.025
0x52c: Stack[-1] = (int) 0
0x52d: Call2 0x396

0x52e: Stack[-5] = Stack[-4]
0x52f: Pop(4)
0x530: Push((int) 7)
0x531: Push((float)0.025)
...
0x53e: Pop(2)
0x53f: Push("quality")
0x540: @@ SetProperty(Stack[-1], Stack[-2])
0x541: Pop(1)
0x542: PushEmpty(object, object, int)
0x543: Stack[-3] = Stack[-8]
...
0x558: Stack[-2] = "quest_b1_05"
0x559: Stack[-1] = "rat_dead"
0x55a: Call2 0x4a0
