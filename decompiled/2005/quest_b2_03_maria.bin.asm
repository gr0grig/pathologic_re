...
0x3cf: Push("head")
0x3d0: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3d1: Pop(1)
0x3d2: Push(Stack[-1])
0x3d3: IF (Stack[-1] == 0) GOTO 0x3d7; Pop(1)

0x3d4: Push("head")
0x3d5: @ LookAsyncCamera(Stack[-1])
0x3d6: Pop(1)
0x3d7: @ CameraWaitForPlayFinish()
0x3d8: Pop(0)
0x3d9: @ ResumeWorld()
0x3da: Pop(0)
0x3db: Stack[-21] = (bool) 1
0x3dc: Return(); Pop(18)

0x3dd: PushEmpty(bool, bool)
0x3de: @ CameraSwitchToNormal()
0x3df: Pop(0)
...
0x3ea: Push("head")
0x3eb: @ UnlookAsync(Stack[-1])
0x3ec: Pop(1)
0x3ed: Return(); Pop(2)

0x3ee: PushEmpty(int, int, int, int)
0x3ef: Push("voice_common")
0x3f0: @ GetVariable(Stack[-1], Stack[-3])
0x3f1: Pop(1)
0x3f2: Push(Stack[-2])
0x3f3: IF (Stack[-1] == 0) GOTO 0x414; Pop(1)
...
0x402: Push((int) 2)
0x403: @ irand(Stack[-2], Stack[-1])
0x404: Pop(1)
0x405: Push(Stack[-1])
0x406: IF (Stack[-1] == 0) GOTO 0x40f; Pop(1)

0x407: Push("voice_common")
0x408: Push((int) 1)
...
0x422: Push("voice_common")
0x423: Push((int) 1)
0x424: @ SetVariable(Stack[-2], Stack[-1])
0x425: Pop(2)
0x426: Stack[-6] = (bool) 1
0x427: Return(); Pop(4)
...
0x42d: Push((int) 1)
0x42e: Pop(1); Push(Stack[-5] + Stack[-1]);
0x42f: Pop(1); Push(Stack[-6] + Stack[-1]);
0x430: @@ HasProperty(Stack[-1], Stack[-4])
0x431: Pop(1)
0x432: Pop(0); Push((bool) Stack[-3] == 0)
0x433: IF (Stack[-1] == 0) GOTO 0x435; Pop(1)

0x434: GOTO 0x438

0x435: Push((int) 1)
0x436: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x437: GOTO 0x42b

0x438: Pop(0); Push((bool) Stack[-4] == 0)
...
0x43c: Stack[-2] = (int) 0
0x43d: Push((int) 1)
0x43e: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x43f: IF (Stack[-1] == 0) GOTO 0x442; Pop(1)

0x440: @ irand(Stack[-2], Stack[-4])
0x441: Pop(0)
0x442: Push((int) 1)
0x443: Pop(1); Push(Stack[-3] + Stack[-1]);
0x444: Pop(1); Push(Stack[-6] + Stack[-1]);
0x445: @@ GetProperty(Stack[-1], Stack[-2])
0x446: Pop(1)
0x447: PushEmpty(bool, string)
0x448: Stack[-1] = Stack[-3]
0x449: Call2 0x497

0x44a: Stack[-14] = Stack[-2]
0x44b: Pop(2)
0x44c: Return(); Pop(10)

0x44d: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x44e: Push("d")
0x44f: PushEmpty(int)
0x450: Call2 0x50d
...
0x453: Push("m")
0x454: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x455: Stack[-4] = (int) 0
0x456: Push((int) 1)
...
0x45b: @@ HasProperty(Stack[-1], Stack[-4])
0x45c: Pop(1)
...
0x470: @@ GetProperty(Stack[-1], Stack[-2])
0x471: Pop(1)
0x472: PushEmpty(bool, string)
0x473: Stack[-1] = Stack[-3]
0x474: Call2 0x497

0x475: Stack[-14] = Stack[-2]
0x476: Pop(2)
0x477: Return(); Pop(10)

0x478: PushEmpty(bool, float, float, bool, float, float)
0x479: @ lshHasAnimation(Stack[-3], Stack[-7])
0x47a: Pop(0)
0x47b: Push(Stack[-3])
0x47c: IF (Stack[-1] == 0) GOTO 0x483; Pop(1)

0x47d: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x47e: Pop(0)
0x47f: Push((bool) 0)
0x480: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x481: Pop(1)
0x482: GOTO 0x487

0x483: Push("Can't find lsh animation : ")
0x484: Pop(1); Push(Stack[-1] + Stack[-8]);
0x485: @ Trace(Stack[-1])
0x486: Pop(1)
0x487: Return(); Pop(6)

0x488: PushEmpty(bool, float, float, bool, float, float)
0x489: @ lshHasAnimation(Stack[-3], Stack[-8])
0x48a: Pop(0)
0x48b: Push(Stack[-3])
0x48c: IF (Stack[-1] == 0) GOTO 0x492; Pop(1)

0x48d: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x48e: Pop(0)
0x48f: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x490: Pop(0)
0x491: GOTO 0x496

0x492: Push("Can't find lsh animation : ")
0x493: Pop(1); Push(Stack[-1] + Stack[-9]);
0x494: @ Trace(Stack[-1])
0x495: Pop(1)
0x496: Return(); Pop(6)
...
0x49c: @ lshHasSpeech(Stack[-1], Stack[-3])
0x49d: Pop(0)
0x49e: Push(Stack[-1])
0x49f: IF (Stack[-1] == 0) GOTO 0x4a4; Pop(1)

0x4a0: @ lshPlaySpeech(Stack[-3])
0x4a1: Pop(0)
0x4a2: Stack[-4] = (bool) 1
0x4a3: Return(); Pop(2)

0x4a4: Stack[-4] = (bool) 0
0x4a5: Return(); Pop(2)
...
0x4b2: Stack[-1] = 0
0x4b3: PushEmpty(float, float)
0x4b4: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4b5: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x4b6: Push((float)0.0)
0x4b7: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x4b8: IF (Stack[-1] == 0) GOTO 0x4bb; Pop(1)

0x4b9: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x4ba: Return(); Pop(2)

0x4bb: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x4bc: Return(); Pop(2)

0x4bd: PushEmpty(int, int)
0x4be: @ GetVariable(Stack[-3], Stack[-1])
0x4bf: Pop(0)
0x4c0: Stack[-4] = Stack[-1]
0x4c1: Return(); Pop(2)

0x4c2: PushEmpty(object, object)
0x4c3: @ CreateIntVector(Stack[-1])
0x4c4: Pop(0)
0x4c5: @@ add(Stack[-4])
0x4c6: Pop(0)
0x4c7: @@ add(Stack[-3])
0x4c8: Pop(0)
0x4c9: Push((int) 3)
0x4ca: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x4cb: Pop(1)
0x4cc: Return(); Pop(2)

0x4cd: Stack[-1] = 0
0x4ce: PushEmpty(int, int)
0x4cf: PushEmpty(object, string, int)
0x4d0: Stack[-3] = Stack[-7]
0x4d1: Stack[-2] = "money"
...
0x4d4: Pop(3)
0x4d5: Push((int) 0)
0x4d6: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x4d7: IF (Stack[-1] == 0) GOTO 0x4e0; Pop(1)

0x4d8: Push("Money")
0x4d9: @ GetInvItemByName(Stack[-2], Stack[-1])
0x4da: Pop(1)
0x4db: PushEmpty(int, int)
0x4dc: Stack[-2] = Stack[-3]
...
0x4e1: PushEmpty(int, int, bool, int, int, bool)
0x4e2: @@ GetItemID(Stack[-3])
0x4e3: Pop(0)
0x4e4: Push("Category")
0x4e5: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x4e6: Pop(1)
0x4e7: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x4e8: Pop(0)
0x4e9: Pop(0); Push((bool) Stack[-1] == 0)
0x4ea: IF (Stack[-1] == 0) GOTO 0x4ee; Pop(1)

0x4eb: @@ DropItems(Stack[-8], Stack[-7])
0x4ec: Pop(0)
0x4ed: GOTO 0x4f3

0x4ee: PushEmpty(int, int)
0x4ef: Stack[-2] = Stack[-5]
...
0x4f5: @ CreateInvItem(Stack[-1])
0x4f6: Pop(0)
0x4f7: @@ SetItemName(Stack[-4])
0x4f8: Pop(0)
0x4f9: PushEmpty(object, object, int)
0x4fa: Stack[-3] = Stack[-8]
0x4fb: Stack[-2] = Stack[-4]
0x4fc: Stack[-1] = Stack[-6]
0x4fd: Call2 0x4e1
...
0x502: @ FindActor(Stack[-1], Stack[-4])
0x503: Pop(0)
...
0x508: @ Trigger(Stack[-1], Stack[-3])
0x509: Pop(0)
0x50a: Stack[-5] = (bool) 1
0x50b: Return(); Pop(2)
...
0x52c: Stack[-5] = Stack[-2]
0x52d: Return(); Pop(4)

0x52e: PushEmpty()
0x52f: Push("playsound")
0x530: Push("giveitem")
0x531: @ TriggerWorld(Stack[-2], Stack[-1])
0x532: Pop(2)
0x533: Return(); Pop(0)

0x534: PushEmpty()
0x535: Push("oob2MariaKabak1")
0x536: Push((int) 1)
0x537: @ SetVariable(Stack[-2], Stack[-1])
0x538: Pop(2)
0x539: Return(); Pop(0)
...
0x53b: Push("b2q03_1")
0x53c: Push((int) 1)
0x53d: @ SetVariable(Stack[-2], Stack[-1])
0x53e: Pop(2)
0x53f: PushEmpty()
0x540: Call2 0x599
...
0x547: Push("b2q03_1")
0x548: Push((int) 1000)
0x549: @ SetVariable(Stack[-2], Stack[-1])
0x54a: Pop(2)
0x54b: PushEmpty()
0x54c: Call2 0x5a6

0x54d: Pop(0)
0x54e: PushEmpty(bool, string, string)
0x54f: Stack[-2] = "quest_b2_03"
0x550: Stack[-1] = "fail"
0x551: Call2 0x501
...
0x554: PushEmpty()
0x555: Push("recipe5 is given")
0x556: @ Trace(Stack[-1])
0x557: Pop(1)
0x558: PushEmpty(object, string, int)
0x559: Stack[-3] = Stack[-5]
0x55a: Stack[-2] = "recipe5"
0x55b: Stack[-1] = (int) 1
0x55c: Call2 0x4f4
...
0x55f: PushEmpty()
0x560: Push("money 5000 is given")
0x561: @ Trace(Stack[-1])
0x562: Pop(1)
0x563: PushEmpty(object, int)
0x564: Stack[-2] = Stack[-4]
0x565: Stack[-1] = (int) 5000
0x566: Call2 0x4ce
...
0x569: PushEmpty()
0x56a: PushEmpty(int, string)
0x56b: Stack[-1] = "b2q03"
0x56c: Call2 0x4bd

0x56d: Pop(1)
0x56e: Push((int) 1000)
0x56f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x570: IF (Stack[-1] == 0) GOTO 0x573; Pop(1)

0x571: Stack[-2] = (bool) 1
0x572: Return(); Pop(0)

0x573: Stack[-2] = (bool) 0
0x574: Return(); Pop(0)

0x575: PushEmpty()
0x576: PushEmpty(int, string)
0x577: Stack[-1] = "oob2MariaKabak1"
0x578: Call2 0x4bd

0x579: Pop(1)
0x57a: Push((int) 0)
0x57b: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x57c: IF (Stack[-1] == 0) GOTO 0x57f; Pop(1)

0x57d: Stack[-2] = (bool) 1
0x57e: Return(); Pop(0)

0x57f: Stack[-2] = (bool) 0
0x580: Return(); Pop(0)

0x581: PushEmpty()
0x582: PushEmpty(int, string)
0x583: Stack[-1] = "b2q03_1"
0x584: Call2 0x4bd

0x585: Pop(1)
0x586: Push((int) 0)
0x587: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x588: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)

0x589: Stack[-2] = (bool) 1
0x58a: Return(); Pop(0)

0x58b: Stack[-2] = (bool) 0
0x58c: Return(); Pop(0)

0x58d: PushEmpty()
0x58e: PushEmpty(int, string)
0x58f: Stack[-1] = "b2q03_1"
0x590: Call2 0x4bd

0x591: Pop(1)
0x592: Push((int) 2)
0x593: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x594: IF (Stack[-1] == 0) GOTO 0x597; Pop(1)

0x595: Stack[-2] = (bool) 1
0x596: Return(); Pop(0)

0x597: Stack[-2] = (bool) 0
0x598: Return(); Pop(0)

0x599: PushEmpty(object, object)
0x59a: Push((int) 588)
0x59b: Push((int) 2)
0x59c: Push((int) 531074)
0x59d: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x59e: Pop(3)
0x59f: PushEmpty(bool, object, int)
...
0x5a7: Push((int) 590)
0x5a8: Push((int) 2)
0x5a9: Push((int) 531076)
0x5aa: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5ab: Pop(3)
0x5ac: PushEmpty(bool, object, int)
0x5ad: Stack[-2] = Stack[-4]
0x5ae: Stack[-1] = (int) 588
0x5af: Call2 0x5cd
...
0x5b4: Push((int) 589)
0x5b5: Push((int) 2)
0x5b6: Push((int) 531075)
0x5b7: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5b8: Pop(3)
0x5b9: PushEmpty(bool, object, int)
0x5ba: Stack[-2] = Stack[-4]
0x5bb: Stack[-1] = (int) 588
0x5bc: Call2 0x5cd
...
0x5c1: @ GetDiaryRoot(Stack[-1])
0x5c2: Pop(0)
0x5c3: Pop(0); Push((bool) Stack[-1] == 0)
0x5c4: IF (Stack[-1] == 0) GOTO 0x5ca; Pop(1)

0x5c5: Push("Can't retrieve diary root")
0x5c6: @ Trace(Stack[-1])
0x5c7: Pop(1)
0x5c8: Stack[-3] = (bool) 0
0x5c9: Return(); Pop(2)
...
0x5cc: Stack[-1] = 0
0x5cd: PushEmpty(object, object, int, object, object, int)
0x5ce: PushEmpty(object)
0x5cf: Call2 0x5c0

0x5d0: Stack[-4] = Stack[-1]
0x5d1: Pop(1)
0x5d2: @@ Find(Stack[-7], Stack[-2])
0x5d3: Pop(0)
0x5d4: Pop(0); Push((bool) Stack[-2] == 0)
0x5d5: IF (Stack[-1] == 0) GOTO 0x5dc; Pop(1)

0x5d6: Push("Can't find diary parent with id: ")
0x5d7: Pop(1); Push(Stack[-1] + Stack[-8]);
0x5d8: @ Trace(Stack[-1])
0x5d9: Pop(1)
0x5da: Stack[-9] = (bool) 0
0x5db: Return(); Pop(6)

0x5dc: @@ AddChild(Stack[-8])
0x5dd: Pop(0)
0x5de: Push((int) 7)
0x5df: @ SendWorldWndMessage(Stack[-1])
0x5e0: Pop(1)
0x5e1: @@ GetCategory(Stack[-1])
0x5e2: Pop(0)
0x5e3: @ SetDiarySection(Stack[-1])
0x5e4: Pop(0)
0x5e5: Stack[-9] = (bool) 0
0x5e6: Return(); Pop(6)
...
0x5ea: Push("branch")
0x5eb: @ GetVariable(Stack[-1], Stack[-2])
0x5ec: Pop(1)
0x5ed: Push((int) 0)
0x5ee: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x5ef: IF (Stack[-1] == 0) GOTO 0x5f3; Pop(1)
...
0x5fa: Stack[-1] = (int) 515543
0x5fb: Return(); Pop(0)

0x5fc: Stack[-1] = (int) 502868
0x5fd: Return(); Pop(0)

0x5fe: Stack[-1] = "ui/NPC_Maria.png"
0x5ff: Return(); Pop(0)

0x600: Stack[-1] = "ui/NPC_Maria_b.png"
0x601: Return(); Pop(0)
