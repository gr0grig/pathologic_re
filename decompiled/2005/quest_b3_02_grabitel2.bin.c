...
task_0_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2344(var_15_object); // 0x75 NEW_2
...
task_1_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2344(var_15_object); // 0xc0 NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2344(var_15_object); // 0x369 NEW_2
...
task_2_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2055(var_13_object); // 0x3ae NEW_2
...
task_2_event_41(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2329(var_15_bool, var_16_object); // 0x482 NEW_2
	...
	func_2336(var_51_object); // 0x48a NEW_2
...
task_4_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2146(var_14_object); // 0x519 NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x8f5 PushV
	var_14_object = var_10_object; // 0x8f6 Mov
	var_15_int = var_11_int; // 0x8f7 Mov
	var_16_float = var_12_float; // 0x8f8 Mov
	func_1768(var_14_object, var_15_int, var_16_float); // 0x8f9 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x8fd PushV
	var_16_object = var_10_object; // 0x8fe Mov
	var_17_int = var_11_int; // 0x8ff Mov
	var_18_float = var_12_float; // 0x900 Mov
	var_19_cvector = var_14_cvector; // 0x901 Mov
	var_20_cvector = var_15_cvector; // 0x902 Mov
	func_1836(var_18_float, var_19_cvector, var_20_cvector); // 0x903 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x906 PushV
	var_14_string = "health"; // 0x907 PushS
	var_15_bool = var_11_string == var_14_string; // 0x908 Eq
	if(var_15_bool == 0) goto Label_2322; // 0x909 JumpB
	var_16_string = "health"; // 0x90a PushS
	GetProperty(var_16_string, var_13_float); // 0x90b Func
	var_17_int = 0; // 0x90d PushI
	var_18_bool = var_13_float <= var_17_int; // 0x90e LE
	if(var_18_bool == 0) goto Label_2322; // 0x90f JumpB
	SignalDeath(var_10_object); // 0x910 Func
...
{
	var_11_object = Obj(); // 0x914 PushV
	var_11_object = var_10_object; // 0x915 Mov
	func_2266(var_11_object); // 0x916 NEW_2
...
Label_1555:
	var_594_string = "armor"; // 0x613 PushS
	GetProperty(var_594_string, var_547_int); // 0x614 ObjFunc
}
...
func_0(var_0_bool, var_79_bool, var_80_object, var_197_object)
{
	...
	func_2055(var_96_object); // 0x3 NEW_2
...
Label_39:
	...
	func_2105(var_139_cvector, var_140_cvector, var_141_cvector, var_142_float); // 0x4b NEW_2
...
{
	var_97_bool = 0; var_98_bool = 0; // 0x807 PushV
	IsPlayerActor(var_96_object, var_98_bool); // 0x808 Func
	var_99_bool = var_98_bool; // 0x80a Push
	if(var_99_bool == 0) goto Label_2063; // 0x80b JumpB
	var_100_string = "attack"; // 0x80c PushS
	PlayGlobalMusic(var_100_string); // 0x80d Func
...
func_2064()
{
	var_118_object = Obj(); var_119_object = Obj(); // 0x810 PushV
	GetScene(var_119_object); // 0x811 Func
	var_120_string = "battle"; // 0x813 PushS
	var_121_object = Obj(); // 0x814 PushV
	func_1929(var_121_object); // 0x815 NEW_2
	BroadcastMessage(var_120_string, var_121_object, var_119_object); // 0x817 Func
...
{
	var_613_bool = 0; var_614_bool = 0; // 0x81b PushV
	var_615_string = "god_mode"; // 0x81c PushS
	GetVariable(var_615_string, var_614_bool); // 0x81d Func
	var_612_bool = var_614_bool; // 0x81f Mov
...
{
	var_37_string = ""; var_38_string = ""; // 0x821 PushV
	var_38_string = "idle"; // 0x822 MovS
	var_39_int = var_36_int; // 0x823 Push
	if(var_39_int == 0) goto Label_2086; // 0x824 JumpB
	var_38_string = var_38_string + var_36_int; // 0x825 Add2
	
Label_2086:
	var_35_string = var_38_string; // 0x826 Mov
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x828 PushV
	var_32_int = 0; // 0x829 MovI
	
Label_2090:
	var_34_string = "all"; // 0x82a PushS
	var_35_string = ""; var_36_int = 0; // 0x82b PushV
	var_36_int = var_32_int; // 0x82c Mov
	func_2081(var_35_string, var_36_int); // 0x82d NEW_2
	HasAnimation(var_33_bool, var_34_string, var_35_string); // 0x82f Func
	var_40_bool = var_33_bool == 0; // 0x831 Not
	if(var_40_bool == 0) goto Label_2100; // 0x832 JumpB
	goto Label_2103; // 0x833 Jump
	
Label_2103:
	var_29_int = var_32_int; // 0x837 Mov
	return 4; // 0x838 Return
	
Label_2100:
	var_41_int = 1; // 0x834 PushI
	var_32_int = var_32_int + var_41_int; // 0x835 Add2
	goto Label_2090; // 0x836 Jump
}


func_2105(var_139_cvector, var_140_cvector, var_141_cvector, var_142_float)
{
	var_143_cvector = CVector(0,0,0); var_144_float = 0; var_145_float = 0; var_146_float = 0; var_147_float = 0; var_148_float = 0; var_149_cvector = CVector(0,0,0); var_150_float = 0; var_151_float = 0; var_152_float = 0; var_153_float = 0; var_154_float = 0; // 0x839 PushV
	var_149_cvector = var_141_cvector - var_140_cvector; // 0x83a Sub2
	var_150_float = 250000; // 0x83b MovI
	var_155_float = GetByIndex(var_149_cvector, 1); // 0x83c PushE
	var_156_int = 1000; // 0x83d PushI
	var_157_float = var_155_float * var_156_int; // 0x83e Mult
	var_158_float = var_142_float * var_142_float; // 0x83f Mult
	var_151_float = var_157_float - var_158_float; // 0x840 Sub2
	var_152_float = var_149_cvector | var_149_cvector; // 0x841 Or2
	var_159_float = 0; var_160_float = 0; var_161_float = 0; var_162_float = 0; // 0x842 PushV
	var_160_float = var_150_float; // 0x843 Mov
	var_161_float = var_151_float; // 0x844 Mov
	var_162_float = var_152_float; // 0x845 Mov
	func_1952(var_159_float, var_160_float, var_161_float, var_162_float); // 0x846 NEW_2
	var_153_float = var_159_float; // 0x847 Mov
	var_167_int = 0; // 0x849 PushI
	var_168_bool = var_153_float < var_167_int; // 0x84a LT
	if(var_168_bool == 0) goto Label_2126; // 0x84b JumpB
	var_154_float = 1; // 0x84c MovI
	goto Label_2134; // 0x84d Jump
	
Label_2134:
	var_169_cvector = CVector(0.0, 500.0, 0.0); // 0x856 PushVec
	var_170_float = var_169_cvector * var_154_float; // 0x857 Mult
	var_171_float = var_170_float * var_154_float; // 0x858 Mult
	var_172_int = var_149_cvector + var_171_float; // 0x859 Add
	var_139_cvector = var_172_int / var_172_int; // 0x85a Div2
	return 12; // 0x85b Return
	
Label_2126:
	var_173_float = 0; var_174_float = 0; var_175_float = 0; var_176_float = 0; var_177_float = 0; // 0x84e PushV
	var_174_float = var_150_float; // 0x84f Mov
	var_175_float = var_151_float; // 0x850 Mov
	var_176_float = var_152_float; // 0x851 Mov
	var_177_float = sqrt(var_153_float); // 0x852 Sqrt2
	func_1959(var_174_float, var_175_float, var_176_float, var_177_float); // 0x853 NEW_2
	var_154_float = sqrt(var_173_float); // 0x855 Sqrt2
}
...
{
	var_603_float = 0; var_604_float = 0; // 0x649 PushV
	var_605_bool = 0; var_606_object = Obj(); var_607_string = ""; // 0x64a PushV
	var_606_object = var_602_object; // 0x64b Mov
	var_607_string = "health"; // 0x64c MovS
	func_1502(var_605_bool, var_606_object, var_607_string); // 0x64d NEW_2
	var_608_bool = var_605_bool == 0; // 0x64f Not
	if(var_608_bool == 0) goto Label_1619; // 0x650 JumpB
	var_601_bool = 0; // 0x651 MovB
	return 2; // 0x652 Return
	
Label_1619:
	var_609_bool = 0; // 0x653 PushV
	var_609_bool = 0; // 0x654 MovB
	var_610_bool = 0; var_611_object = Obj(); // 0x655 PushV
	var_611_object = var_602_object; // 0x656 Mov
	func_1497(var_610_bool, var_611_object); // 0x657 NEW_2
	if(var_610_bool == 0) goto Label_1631; // 0x659 JumpB
	var_612_bool = 0; // 0x65a PushV
	func_2075(var_612_bool); // 0x65b NEW_2
	if(var_612_bool == 0) goto Label_1631; // 0x65d JumpB
	var_609_bool = 1; // 0x65e MovB
	
Label_1631:
	if(var_609_bool == 0) goto Label_1634; // 0x65f JumpB
	var_601_bool = 0; // 0x660 MovB
	return 2; // 0x661 Return
	
Label_1634:
	var_616_string = "health"; // 0x662 PushS
	GetProperty(var_616_string, var_604_float); // 0x663 ObjFunc
	var_617_float = 0.0; // 0x665 PushF
	var_601_bool = var_604_float <= var_617_float; // 0x666 LE2
...
{
	var_103_int = 0; var_104_int = 0; // 0x85c PushV
	var_105_string = "branch"; // 0x85d PushS
	GetVariable(var_105_string, var_104_int); // 0x85e Func
	var_102_int = var_104_int; // 0x860 Mov
...
{
	var_15_int = 0; // 0x863 PushV
	func_2140(var_15_int); // 0x864 NEW_2
	var_19_int = 1; // 0x866 PushI
	var_20_bool = var_15_int == var_19_int; // 0x867 Eq
	if(var_20_bool == 0) goto Label_2156; // 0x868 JumpB
	WorkWithCorpse(var_14_object); // 0x869 Func
...
Label_2156:
	Barter(var_14_object); // 0x86c Func
}
...
func_2159(var_65_int, var_66_int)
{
	var_67_int = 0; var_68_bool = 0; var_69_int = 0; var_70_bool = 0; // 0x86f PushV
	var_71_bool = var_65_int > var_66_int; // 0x870 GT
	if(var_71_bool == 0) goto Label_2166; // 0x871 JumpB
	var_72_string = "GenerateMoney: iMin > iMax"; // 0x872 PushS
	Trace(var_72_string); // 0x873 Func
	return 4; // 0x875 Return
	
Label_2166:
	var_69_int = 0; // 0x876 MovI
	var_73_bool = var_65_int != var_66_int; // 0x877 Neq
	if(var_73_bool == 0) goto Label_2173; // 0x878 JumpB
	var_74_int = var_66_int - var_65_int; // 0x879 Sub
	irand(var_69_int, var_74_int); // 0x87a Func
	goto Label_2177; // 0x87c Jump
	
Label_2177:
	var_69_int = var_69_int + var_65_int; // 0x881 Add2
	var_75_int = 0; // 0x882 PushI
	var_76_bool = var_69_int == var_75_int; // 0x883 Eq
	if(var_76_bool == 0) goto Label_2182; // 0x884 JumpB
	return 4; // 0x885 Return
	
Label_2182:
	var_77_int = 0; var_78_string = ""; // 0x886 PushV
	var_78_string = "Money"; // 0x887 MovS
	func_2261(var_77_int, var_78_string); // 0x888 NEW_2
	var_81_int = 0; // 0x88a PushI
	AddItem(var_70_bool, var_77_int, var_81_int, var_69_int); // 0x88b Func
	return 4; // 0x88d Return
	
Label_2173:
	var_82_int = 0; // 0x87d PushI
	var_83_bool = var_65_int == var_82_int; // 0x87e Eq
	if(var_83_bool == 0) goto Label_2177; // 0x87f JumpB
...
func_126(var_195_bool, var_196_object)
{
	...
	var_674_bool = 0; // 0x88 PushV
	var_674_bool = 0; // 0x89 MovB
	var_675_bool = GlobalVars[0]; // 0x8a PushGE
	if(var_675_bool == 0) goto Label_143; // 0x8b JumpB
	var_676_int = var_3_int; // 0x8c PushT
	if(var_676_int == 0) goto Label_143; // 0x8d JumpB
	var_674_bool = 1; // 0x8e MovB
	
Label_143:
	if(var_674_bool == 0) goto Label_150; // 0x8f JumpB
	var_677_string = "all"; // 0x90 PushS
	var_678_string = "attack_off"; // 0x91 PushS
	PlayAnimation(var_677_string, var_678_string); // 0x92 Func
	WaitForAnimEnd(); // 0x94 Func
	
Label_150:
	var_679_bool = GlobalVars[0]; // 0x96 PushGE
	var_195_bool = var_679_bool; // 0x97 Mov
...
func_645(var_642_bool, var_643_float)
{
	var_644_float = 0; var_645_bool = 0; var_646_float = 0; var_647_bool = 0; // 0x285 PushV
	rand(var_646_float); // 0x286 Func
	var_648_bool = var_646_float < var_643_float; // 0x288 LT
	if(var_648_bool == 0) goto Label_665; // 0x289 JumpB
	
Label_650:
	IsAnimationPlaying(var_647_bool); // 0x28a Func
	var_649_bool = var_647_bool == 0; // 0x28c Not
	if(var_649_bool == 0) goto Label_655; // 0x28d JumpB
...
Label_670:
	var_642_bool = 0; // 0x29e MovB
	return 4; // 0x29f Return
	
Label_655:
	var_650_bool = 0; // 0x28f PushV
	func_743(var_650_bool); // 0x290 NEW_2
	if(var_650_bool == 0) goto Label_661; // 0x292 JumpB
	var_642_bool = 1; // 0x293 MovB
...
Label_665:
	...
	func_847(var_647_bool); // 0x29c NEW_2
}


func_2190(var_108_string)
{
	var_109_object = Obj(); var_110_int = 0; var_111_bool = 0; var_112_object = Obj(); var_113_int = 0; var_114_bool = 0; // 0x88e PushV
	CreateInvItem(var_112_object); // 0x88f Func
	SetItemName(var_108_string); // 0x891 ObjFunc
	var_115_string = "Organ"; // 0x893 PushS
	var_116_int = 1; // 0x894 PushI
	SetProperty(var_115_string, var_116_int); // 0x895 ObjFunc
	GetItemID(var_113_int); // 0x897 ObjFunc
	var_117_int = 0; // 0x899 PushI
	var_118_int = 1; // 0x89a PushI
	AddItem(var_114_bool, var_112_object, var_117_int, var_118_int); // 0x89b Func
...
func_2207()
{
	var_102_int = 0; // 0x89f PushV
	func_2140(var_102_int); // 0x8a0 NEW_2
	var_106_int = 1; // 0x8a2 PushI
	var_107_bool = var_102_int != var_106_int; // 0x8a3 Neq
	if(var_107_bool == 0) goto Label_2214; // 0x8a4 JumpB
	return 0; // 0x8a5 Return
	
Label_2214:
	var_108_string = ""; // 0x8a6 PushV
	var_108_string = "liver"; // 0x8a7 MovS
	func_2190(var_108_string); // 0x8a8 NEW_2
	var_119_string = ""; // 0x8aa PushV
	var_119_string = "kidney"; // 0x8ab MovS
	func_2190(var_119_string); // 0x8ac NEW_2
	var_120_string = ""; // 0x8ae PushV
	var_120_string = "heart"; // 0x8af MovS
	func_2190(var_120_string); // 0x8b0 NEW_2
	var_121_string = ""; // 0x8b2 PushV
	var_121_string = "blood"; // 0x8b3 MovS
	func_2190(var_121_string); // 0x8b4 NEW_2
...
{
	var_598_bool = 0; // 0xa3 PushV
	var_598_bool = 0; // 0xa4 MovB
	var_599_int = 0; // 0xa5 PushI
	var_600_bool = var_597_float > var_599_int; // 0xa6 GT
	if(var_600_bool == 0) goto Label_174; // 0xa7 JumpB
	var_601_bool = 0; var_602_object = Obj(); // 0xa8 PushV
	var_602_object = var_596_object; // 0xa9 Mov
	func_1609(var_601_bool, var_602_object); // 0xaa NEW_2
	if(var_601_bool == 0) goto Label_174; // 0xac JumpB
	var_598_bool = 1; // 0xad MovB
	
Label_174:
	if(var_598_bool == 0) goto Label_181; // 0xae JumpB
	var_618_bool = GlobalVars[0]; // 0xaf PushGE
	var_618_bool = 1; // 0xb0 MovB
	GlobalVars[0] = var_618_bool; // 0xb1 PopGE
	func_643(var_597_float); // 0xb3 NEW_2
...
Label_1194:
	...
	func_2088(var_29_int); // 0x4ab NEW_2
...
Label_1209:
	...
	func_2081(var_51_string, var_52_int); // 0x4c7 NEW_2
...
func_2231()
{
	var_60_int = 0; var_61_bool = 0; var_62_int = 0; var_63_bool = 0; // 0x8b7 PushV
	var_64_int = 0; // 0x8b8 PushI
	ClearSubContainer(var_64_int); // 0x8b9 Func
	var_65_int = 0; var_66_int = 0; // 0x8bb PushV
	var_65_int = 300; // 0x8bc MovI
	var_66_int = 750; // 0x8bd MovI
	func_2159(var_65_int, var_66_int); // 0x8be NEW_2
	var_84_string = ""; var_85_int = 0; var_86_int = 0; // 0x8c0 PushV
	var_84_string = "Knife"; // 0x8c1 MovS
	var_85_int = 1; // 0x8c2 MovI
	var_86_int = 8; // 0x8c3 MovI
	func_1877(var_84_string, var_85_int, var_86_int); // 0x8c4 NEW_2
	var_95_string = ""; var_96_int = 0; var_97_int = 0; // 0x8c6 PushV
	var_95_string = "lockpick"; // 0x8c7 MovS
	var_96_int = 1; // 0x8c8 MovI
	var_97_int = 6; // 0x8c9 MovI
	func_1877(var_95_string, var_96_int, var_97_int); // 0x8ca NEW_2
	var_98_int = 0; var_99_string = ""; // 0x8cc PushV
	var_99_string = "grabitel_mark"; // 0x8cd MovS
	func_2261(var_98_int, var_99_string); // 0x8ce NEW_2
	var_100_int = 0; // 0x8d0 PushI
	var_101_int = 1; // 0x8d1 PushI
	AddItem(var_63_bool, var_98_int, var_100_int, var_101_int); // 0x8d2 Func
	return 4; // 0x8d4 Return
}
...
Label_359:
	...
	var_658_string = "all"; // 0x169 PushS
	var_659_string = "fjump"; // 0x16a PushS
	PlayAnimation(var_658_string, var_659_string); // 0x16b Func
	WaitForAnimEnd(); // 0x16d Func
	func_847(var_228_float); // 0x170 NEW_2
	var_660_cvector = CVector(0.0, 0.0, 0.0); // 0x172 PushVec
	SetSpeed(var_660_cvector); // 0x173 Func
	Stop(); // 0x175 Func
	StopAsync(); // 0x177 Func
	var_661_bool = 0; // 0x179 PushV
	func_804(var_228_float, var_661_bool); // 0x17a NEW_2
	var_662_bool = var_661_bool == 0; // 0x17c Not
	if(var_662_bool == 0) goto Label_405; // 0x17d JumpB
	var_663_bool = 0; var_664_object = Obj(); // 0x17e PushV
	var_664_object = var_0_bool; // 0x17f MovT
	func_1681(var_663_bool, var_664_object); // 0x180 NEW_2
	var_665_bool = var_663_bool == 0; // 0x182 Not
	if(var_665_bool == 0) goto Label_389; // 0x183 JumpB
...
Label_389:
	...
	var_666_float = var_206_float * var_206_float; // 0x18b Mult
	var_667_bool = var_225_float < var_666_float; // 0x18c LT
	if(var_667_bool == 0) goto Label_405; // 0x18d JumpB
	var_668_bool = 0; var_669_float = 0; // 0x18e PushV
	var_669_float = var_206_float; // 0x18f Mov
	func_506(var_228_float, var_668_bool, var_669_float); // 0x190 NEW_2
	var_670_bool = var_668_bool == 0; // 0x192 Not
	if(var_670_bool == 0) goto Label_405; // 0x193 JumpB
	goto Label_415; // 0x194 Jump
	
Label_406:
	var_671_bool = 0; var_672_float = 0; // 0x196 PushV
	var_672_float = var_206_float; // 0x197 Mov
	func_506(var_228_float, var_671_bool, var_672_float); // 0x198 NEW_2
	var_673_bool = var_671_bool == 0; // 0x19a Not
	if(var_673_bool == 0) goto Label_413; // 0x19b JumpB
...
func_2261(var_77_int, var_78_string)
{
	var_79_int = 0; var_80_int = 0; // 0x8d5 PushV
	GetInvItemByName(var_80_int, var_78_string); // 0x8d6 Func
	var_77_int = var_80_int; // 0x8d8 Mov
...
{
	var_12_object = Obj(); var_13_object = Obj(); // 0x8da PushV
	GetScene(var_13_object); // 0x8db Func
	var_14_object = Obj(); // 0x8dd PushV
	func_1929(var_14_object); // 0x8de NEW_2
	RemoveStationaryActor(var_14_object); // 0x8e0 ObjFunc
	var_17_bool = 0; var_18_object = Obj(); // 0x8e2 PushV
	var_18_object = var_11_object; // 0x8e3 Mov
	func_1497(var_17_bool, var_18_object); // 0x8e4 NEW_2
	if(var_17_bool == 0) goto Label_2284; // 0x8e6 JumpB
	var_21_bool = 0; var_22_object = Obj(); var_23_float = 0; // 0x8e7 PushV
	var_22_object = var_11_object; // 0x8e8 Mov
	var_23_float = 0.02; // 0x8e9 MovF
	func_2000(var_21_bool, var_22_object, var_23_float); // 0x8ea NEW_2
	
Label_2284:
	var_59_object = Obj(); // 0x8ec PushV
	var_59_object = var_11_object; // 0x8ed Mov
	TaskCall(4); // 0x8ee TaskCall
	func_1271(var_59_object); // 0x8ef NEW_2
	TaskReturn(); // 0x8f0 TaskReturn
...
{
	func_2231(); // 0x4f9 NEW_2
	func_2207(); // 0x4fc NEW_2
...
{
	var_17_bool = 0; var_18_object = Obj(); // 0x91a PushV
	var_18_object = var_16_object; // 0x91b Mov
	func_1681(var_17_bool, var_18_object); // 0x91c NEW_2
	var_15_bool = var_17_bool; // 0x91d Mov
...
{
	var_52_object = Obj(); // 0x921 PushV
	var_52_object = var_51_object; // 0x922 Mov
	func_2347(var_52_object); // 0x923 NEW_2
...
func_2344(var_13_bool)
{
	var_13_bool = 0; // 0x929 MovB
...
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x92b PushV
	GetScene(var_54_object); // 0x92c Func
	var_55_object = Obj(); // 0x92e PushV
	func_1929(var_55_object); // 0x92f NEW_2
	RemoveStationaryActor(var_55_object); // 0x931 ObjFunc
	var_58_bool = 0; var_59_object = Obj(); // 0x933 PushV
	var_59_object = var_52_object; // 0x934 Mov
	TaskCall(5); // 0x935 TaskCall
	func_1431(var_53_object, var_54_object, var_58_bool, var_59_object); // 0x936 NEW_2
	TaskReturn(); // 0x937 TaskReturn
...
func_847(var_0_bool)
{
	...
	func_2055(var_266_object); // 0x351 NEW_2
...
func_887(var_2_int, var_269_bool, var_270_object, var_271_float, var_272_float, var_273_bool, var_274_bool)
{
	...
	func_2055(var_282_object); // 0x37a NEW_2
...
func_1431(var_58_bool, var_59_object, var_81_bool, var_682_object)
{
...
Label_1460:
	var_680_bool = 0; var_681_object = Obj(); // 0x5b4 PushV
	var_681_object = var_59_object; // 0x5b5 Mov
	TaskCall(1); // 0x5b6 TaskCall
	func_126(var_680_bool, var_681_object); // 0x5b7 NEW_2
	TaskReturn(); // 0x5b8 TaskReturn
	var_58_bool = var_682_object; // 0x5b9 Mov
...
Label_2021:
	...
	func_2045(var_28_float); // 0x7e7 NEW_2
...
func_467(var_0_bool, var_520_float, var_521_int)
{
	...
	var_595_int = 0; // 0x1ee PushV
	func_160(var_595_int); // 0x1ef NEW_2
	ReportHit(var_0_bool, var_595_int, var_527_float, var_526_float); // 0x1f1 Func
	var_596_object = Obj(); var_597_float = 0; // 0x1f3 PushV
	var_596_object = var_525_object; // 0x1f4 Mov
	var_597_float = var_527_float; // 0x1f5 Mov
	func_162(var_596_object, var_597_float); // 0x1f6 NEW_2
...
func_2035(var_590_float)
{
	...
	var_593_int = 15; // 0x7f8 PushI
	SendWorldWndMessage(var_593_int, var_592_object); // 0x7f9 Func
...
Label_542:
	...
	var_619_string = "all"; // 0x223 PushS
	var_620_string = "attack_middle"; // 0x224 PushS
	var_621_int = var_620_string + var_493_int; // 0x225 Add
	HasAnimation(var_494_bool, var_619_string, var_621_int); // 0x226 Func
	var_622_bool = var_494_bool; // 0x228 Push
	if(var_622_bool == 0) goto Label_623; // 0x229 JumpB
	func_2064(); // 0x22b NEW_2
	var_623_string = "all"; // 0x22d PushS
	var_624_string = "attack_middle"; // 0x22e PushS
	var_625_int = var_624_string + var_493_int; // 0x22f Add
	PlayAnimation(var_623_string, var_625_int); // 0x230 Func
	WaitForAnimEnd(); // 0x232 Func
	func_847(var_496_string); // 0x235 NEW_2
	var_626_bool = 0; var_627_object = Obj(); // 0x237 PushV
	var_627_object = var_0_bool; // 0x238 MovT
	func_1681(var_626_bool, var_627_object); // 0x239 NEW_2
	var_628_bool = var_626_bool == 0; // 0x23b Not
	if(var_628_bool == 0) goto Label_577; // 0x23c JumpB
	StopAsync(); // 0x23d Func
	var_487_bool = 0; // 0x23f MovB
	return 8; // 0x240 Return
	
Label_577:
	var_629_float = 0; var_630_int = 0; // 0x241 PushV
	var_629_float = var_488_float; // 0x242 Mov
	var_630_int = var_493_int; // 0x243 Mov
	func_467(var_496_string, var_629_float, var_630_int); // 0x244 NEW_2
	var_495_int = 1; // 0x246 MovI
	
Label_583:
	var_631_string = "attack_middle"; // 0x247 PushS
	var_632_int = var_631_string + var_493_int; // 0x248 Add
	var_633_string = "_"; // 0x249 PushS
	var_634_int = var_632_int + var_633_string; // 0x24a Add
	var_496_string = var_634_int + var_495_int; // 0x24b Add2
	var_635_string = "all"; // 0x24c PushS
	HasAnimation(var_494_bool, var_635_string, var_496_string); // 0x24d Func
	var_636_bool = var_494_bool == 0; // 0x24f Not
	if(var_636_bool == 0) goto Label_594; // 0x250 JumpB
	goto Label_623; // 0x251 Jump
	
Label_623:
	var_637_bool = 0; // 0x26f PushB
	SetAttackState(var_637_bool); // 0x270 Func
	var_638_string = "all"; // 0x272 PushS
	var_639_string = "attack_end"; // 0x273 PushS
	var_640_int = var_639_string + var_493_int; // 0x274 Add
	PlayAnimation(var_638_string, var_640_int); // 0x275 Func
	var_641_bool = 0; // 0x277 PushV
	func_857(var_641_bool); // 0x278 NEW_2
	if(var_641_bool == 0) goto Label_641; // 0x27a JumpB
	var_642_bool = 0; var_643_float = 0; // 0x27b PushV
	var_643_float = 0.45; // 0x27c MovF
	func_645(var_642_bool, var_643_float); // 0x27d NEW_2
...
Label_594:
	func_2064(); // 0x253 NEW_2
	var_651_string = "all"; // 0x255 PushS
	PlayAnimation(var_651_string, var_496_string); // 0x256 Func
	WaitForAnimEnd(); // 0x258 Func
	func_847(var_496_string); // 0x25b NEW_2
	var_652_bool = 0; var_653_object = Obj(); // 0x25d PushV
	var_653_object = var_0_bool; // 0x25e MovT
	func_1681(var_652_bool, var_653_object); // 0x25f NEW_2
	var_654_bool = var_652_bool == 0; // 0x261 Not
	if(var_654_bool == 0) goto Label_615; // 0x262 JumpB
	StopAsync(); // 0x263 Func
	var_487_bool = 0; // 0x265 MovB
	return 8; // 0x266 Return
	
Label_615:
	var_655_float = 0; var_656_int = 0; // 0x267 PushV
	var_655_float = var_488_float; // 0x268 Mov
	var_656_int = var_493_int; // 0x269 Mov
	func_467(var_496_string, var_655_float, var_656_int); // 0x26a NEW_2
	var_657_int = 1; // 0x26c PushI
	var_495_int = var_495_int + var_657_int; // 0x26d Add2
...
{
	var_29_object = Obj(); var_30_object = Obj(); // 0x7fd PushV
	CreateFloatVector(var_30_object); // 0x7fe Func
	add(var_28_float); // 0x800 ObjFunc
	var_31_int = 16; // 0x802 PushI
	SendWorldWndMessage(var_31_int, var_30_object); // 0x803 Func
