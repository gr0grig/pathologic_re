...
task_2_event_7(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_int)
{
	...
	func_1631(var_14_object); // 0x367 NEW_2
...
task_3_event_0(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_object)
{
	...
	func_1657(var_15_object); // 0x444 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0x6d2 PushV
	var_15_object = var_11_object; // 0x6d3 Mov
	var_16_int = var_12_int; // 0x6d4 Mov
	var_17_float = var_13_float; // 0x6d5 Mov
	func_1438(var_15_object, var_16_int, var_17_float); // 0x6d6 NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0x6da PushV
	var_17_object = var_11_object; // 0x6db Mov
	var_18_int = var_12_int; // 0x6dc Mov
	var_19_float = var_13_float; // 0x6dd Mov
	var_20_cvector = var_15_cvector; // 0x6de Mov
	var_21_cvector = var_16_cvector; // 0x6df Mov
	func_1506(var_19_float, var_20_cvector, var_21_cvector); // 0x6e0 NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0x6e3 PushV
	var_15_string = "health"; // 0x6e4 PushS
	var_16_bool = var_12_string == var_15_string; // 0x6e5 Eq
	if(var_16_bool == 0) goto Label_1775; // 0x6e6 JumpB
	var_17_string = "health"; // 0x6e7 PushS
	GetProperty(var_17_string, var_14_float); // 0x6e8 Func
	var_18_int = 0; // 0x6ea PushI
	var_19_bool = var_14_float <= var_18_int; // 0x6eb LE
	if(var_19_bool == 0) goto Label_1775; // 0x6ec JumpB
	SignalDeath(var_11_object); // 0x6ed Func
...
{
	var_12_object = Obj(); // 0x6f1 PushV
	var_12_object = var_11_object; // 0x6f2 Mov
	func_1721(var_12_object); // 0x6f3 NEW_2
...
func_1670(var_27_string)
{
	var_28_object = Obj(); var_29_int = 0; var_30_bool = 0; var_31_object = Obj(); var_32_int = 0; var_33_bool = 0; // 0x686 PushV
	CreateInvItem(var_31_object); // 0x687 Func
	SetItemName(var_27_string); // 0x689 ObjFunc
	var_34_string = "Organ"; // 0x68b PushS
	var_35_int = 1; // 0x68c PushI
	SetProperty(var_34_string, var_35_int); // 0x68d ObjFunc
	GetItemID(var_32_int); // 0x68f ObjFunc
	var_36_int = 0; // 0x691 PushI
	var_37_int = 1; // 0x692 PushI
	AddItem(var_33_bool, var_31_object, var_36_int, var_37_int); // 0x693 Func
...
func_1687()
{
	var_21_int = 0; // 0x697 PushV
	func_1651(var_21_int); // 0x698 NEW_2
	var_25_int = 1; // 0x69a PushI
	var_26_bool = var_21_int != var_25_int; // 0x69b Neq
	if(var_26_bool == 0) goto Label_1694; // 0x69c JumpB
	return 0; // 0x69d Return
	
Label_1694:
	var_27_string = ""; // 0x69e PushV
	var_27_string = "liver"; // 0x69f MovS
	func_1670(var_27_string); // 0x6a0 NEW_2
	var_38_string = ""; // 0x6a2 PushV
	var_38_string = "kidney"; // 0x6a3 MovS
	func_1670(var_38_string); // 0x6a4 NEW_2
	var_39_string = ""; // 0x6a6 PushV
	var_39_string = "heart"; // 0x6a7 MovS
	func_1670(var_39_string); // 0x6a8 NEW_2
	var_40_string = ""; // 0x6aa PushV
	var_40_string = "blood"; // 0x6ab MovS
	func_1670(var_40_string); // 0x6ac NEW_2
...
Label_310:
	...
	var_500_string = "all"; // 0x138 PushS
	var_501_string = "fjump"; // 0x139 PushS
	PlayAnimation(var_500_string, var_501_string); // 0x13a Func
	WaitForAnimEnd(); // 0x13c Func
	func_796(var_49_float); // 0x13f NEW_2
	var_502_cvector = CVector(0.0, 0.0, 0.0); // 0x141 PushVec
	SetSpeed(var_502_cvector); // 0x142 Func
	Stop(); // 0x144 Func
	StopAsync(); // 0x146 Func
	var_503_bool = 0; // 0x148 PushV
	func_753(var_49_float, var_503_bool); // 0x149 NEW_2
	var_504_bool = var_503_bool == 0; // 0x14b Not
	if(var_504_bool == 0) goto Label_356; // 0x14c JumpB
	var_505_bool = 0; var_506_object = Obj(); // 0x14d PushV
	var_506_object = var_0_cvector; // 0x14e MovT
	func_1370(var_505_bool, var_506_object); // 0x14f NEW_2
	var_507_bool = var_505_bool == 0; // 0x151 Not
	if(var_507_bool == 0) goto Label_340; // 0x152 JumpB
...
Label_340:
	...
	var_508_float = var_27_float * var_27_float; // 0x15a Mult
	var_509_bool = var_46_float < var_508_float; // 0x15b LT
	if(var_509_bool == 0) goto Label_356; // 0x15c JumpB
	var_510_bool = 0; var_511_float = 0; // 0x15d PushV
	var_511_float = var_27_float; // 0x15e Mov
	func_457(var_49_float, var_510_bool, var_511_float); // 0x15f NEW_2
	var_512_bool = var_510_bool == 0; // 0x161 Not
	if(var_512_bool == 0) goto Label_356; // 0x162 JumpB
	goto Label_366; // 0x163 Jump
	
Label_357:
	var_513_bool = 0; var_514_float = 0; // 0x165 PushV
	var_514_float = var_27_float; // 0x166 Mov
	func_457(var_49_float, var_513_bool, var_514_float); // 0x167 NEW_2
	var_515_bool = var_513_bool == 0; // 0x169 Not
	if(var_515_bool == 0) goto Label_364; // 0x16a JumpB
...
func_796(var_0_cvector)
{
	...
	func_1631(var_121_object); // 0x31e NEW_2
...
func_418(var_0_cvector, var_383_float, var_384_int)
{
	...
	var_458_int = 0; // 0x1bd PushV
	func_801(var_458_int); // 0x1be NEW_2
	ReportHit(var_0_cvector, var_458_int, var_390_float, var_389_float); // 0x1c0 Func
	var_459_object = Obj(); var_460_float = 0; // 0x1c2 PushV
	var_459_object = var_388_object; // 0x1c3 Mov
	var_460_float = var_390_float; // 0x1c4 Mov
...
func_816(var_2_object, var_128_bool, var_129_object, var_130_float, var_131_float, var_132_bool, var_133_bool)
{
	...
	func_1631(var_141_object); // 0x333 NEW_2
...
func_1711()
{
	var_41_object = Obj(); var_42_object = Obj(); // 0x6af PushV
	GetScene(var_42_object); // 0x6b0 Func
	var_43_object = Obj(); // 0x6b2 PushV
	func_1583(var_43_object); // 0x6b3 NEW_2
	RemoveStationaryActor(var_43_object); // 0x6b5 ObjFunc
...
func_1721(var_12_object)
{
	var_13_bool = 0; var_14_bool = 0; // 0x6b9 PushV
	var_15_string = "revolver_ammo"; // 0x6ba PushS
	var_16_int = 0; // 0x6bb PushI
	var_17_int = 2; // 0x6bc PushI
	AddItem(var_14_bool, var_15_string, var_16_int, var_17_int); // 0x6bd Func
	var_18_string = "alpha_pills"; // 0x6bf PushS
	var_19_int = 0; // 0x6c0 PushI
	var_20_int = 12; // 0x6c1 PushI
	AddItem(var_14_bool, var_18_string, var_19_int, var_20_int); // 0x6c2 Func
	func_1687(); // 0x6c5 NEW_2
	func_1711(); // 0x6c8 NEW_2
	var_46_object = Obj(); // 0x6ca PushV
	var_46_object = var_12_object; // 0x6cb Mov
	TaskCall(3); // 0x6cc TaskCall
	func_1072(var_46_object); // 0x6cd NEW_2
	TaskReturn(); // 0x6ce TaskReturn
...
Label_493:
	...
	var_461_string = "all"; // 0x1f2 PushS
	var_462_string = "attack_middle"; // 0x1f3 PushS
	var_463_int = var_462_string + var_352_int; // 0x1f4 Add
	HasAnimation(var_353_bool, var_461_string, var_463_int); // 0x1f5 Func
	var_464_bool = var_353_bool; // 0x1f7 Push
	if(var_464_bool == 0) goto Label_574; // 0x1f8 JumpB
	func_1640(); // 0x1fa NEW_2
	var_465_string = "all"; // 0x1fc PushS
	var_466_string = "attack_middle"; // 0x1fd PushS
	var_467_int = var_466_string + var_352_int; // 0x1fe Add
	PlayAnimation(var_465_string, var_467_int); // 0x1ff Func
	WaitForAnimEnd(); // 0x201 Func
	func_796(var_355_string); // 0x204 NEW_2
	var_468_bool = 0; var_469_object = Obj(); // 0x206 PushV
	var_469_object = var_0_cvector; // 0x207 MovT
	func_1370(var_468_bool, var_469_object); // 0x208 NEW_2
	var_470_bool = var_468_bool == 0; // 0x20a Not
	if(var_470_bool == 0) goto Label_528; // 0x20b JumpB
	StopAsync(); // 0x20c Func
	var_346_bool = 0; // 0x20e MovB
	return 8; // 0x20f Return
	
Label_528:
	var_471_float = 0; var_472_int = 0; // 0x210 PushV
	var_471_float = var_347_float; // 0x211 Mov
	var_472_int = var_352_int; // 0x212 Mov
	func_418(var_355_string, var_471_float, var_472_int); // 0x213 NEW_2
	var_354_int = 1; // 0x215 MovI
	
Label_534:
	var_473_string = "attack_middle"; // 0x216 PushS
	var_474_int = var_473_string + var_352_int; // 0x217 Add
	var_475_string = "_"; // 0x218 PushS
	var_476_int = var_474_int + var_475_string; // 0x219 Add
	var_355_string = var_476_int + var_354_int; // 0x21a Add2
	var_477_string = "all"; // 0x21b PushS
	HasAnimation(var_353_bool, var_477_string, var_355_string); // 0x21c Func
	var_478_bool = var_353_bool == 0; // 0x21e Not
	if(var_478_bool == 0) goto Label_545; // 0x21f JumpB
	goto Label_574; // 0x220 Jump
	
Label_574:
	var_479_bool = 0; // 0x23e PushB
	SetAttackState(var_479_bool); // 0x23f Func
	var_480_string = "all"; // 0x241 PushS
	var_481_string = "attack_end"; // 0x242 PushS
	var_482_int = var_481_string + var_352_int; // 0x243 Add
	PlayAnimation(var_480_string, var_482_int); // 0x244 Func
	var_483_bool = 0; // 0x246 PushV
	func_810(var_483_bool); // 0x247 NEW_2
	if(var_483_bool == 0) goto Label_592; // 0x249 JumpB
	var_484_bool = 0; var_485_float = 0; // 0x24a PushV
	var_485_float = 0.75; // 0x24b MovF
	func_594(var_484_bool, var_485_float); // 0x24c NEW_2
...
Label_545:
	func_1640(); // 0x222 NEW_2
	var_493_string = "all"; // 0x224 PushS
	PlayAnimation(var_493_string, var_355_string); // 0x225 Func
	WaitForAnimEnd(); // 0x227 Func
	func_796(var_355_string); // 0x22a NEW_2
	var_494_bool = 0; var_495_object = Obj(); // 0x22c PushV
	var_495_object = var_0_cvector; // 0x22d MovT
	func_1370(var_494_bool, var_495_object); // 0x22e NEW_2
	var_496_bool = var_494_bool == 0; // 0x230 Not
	if(var_496_bool == 0) goto Label_566; // 0x231 JumpB
	StopAsync(); // 0x232 Func
	var_346_bool = 0; // 0x234 MovB
	return 8; // 0x235 Return
	
Label_566:
	var_497_float = 0; var_498_int = 0; // 0x236 PushV
	var_497_float = var_347_float; // 0x237 Mov
	var_498_int = var_352_int; // 0x238 Mov
	func_418(var_355_string, var_497_float, var_498_int); // 0x239 NEW_2
	var_499_int = 1; // 0x23b PushI
	var_354_int = var_354_int + var_499_int; // 0x23c Add2
...
func_594(var_484_bool, var_485_float)
{
	var_486_float = 0; var_487_bool = 0; var_488_float = 0; var_489_bool = 0; // 0x252 PushV
	rand(var_488_float); // 0x253 Func
	var_490_bool = var_488_float < var_485_float; // 0x255 LT
	if(var_490_bool == 0) goto Label_614; // 0x256 JumpB
	
Label_599:
	IsAnimationPlaying(var_489_bool); // 0x257 Func
	var_491_bool = var_489_bool == 0; // 0x259 Not
	if(var_491_bool == 0) goto Label_604; // 0x25a JumpB
...
Label_619:
	var_484_bool = 0; // 0x26b MovB
	return 4; // 0x26c Return
	
Label_604:
	var_492_bool = 0; // 0x25c PushV
	func_692(var_492_bool); // 0x25d NEW_2
	if(var_492_bool == 0) goto Label_610; // 0x25f JumpB
	var_484_bool = 1; // 0x260 MovB
...
Label_614:
	...
	func_796(var_489_bool); // 0x269 NEW_2
}
...
func_1621(var_453_float)
{
	...
	var_456_int = 15; // 0x65a PushI
	SendWorldWndMessage(var_456_int, var_455_object); // 0x65b Func
...
func_1631(var_14_object)
{
	var_15_bool = 0; var_16_bool = 0; // 0x65f PushV
	IsPlayerActor(var_14_object, var_16_bool); // 0x660 Func
	var_17_bool = var_16_bool; // 0x662 Push
	if(var_17_bool == 0) goto Label_1639; // 0x663 JumpB
	var_18_string = "attack"; // 0x664 PushS
	PlayGlobalMusic(var_18_string); // 0x665 Func
...
Label_1275:
	var_457_string = "armor"; // 0x4fb PushS
	GetProperty(var_457_string, var_410_int); // 0x4fc ObjFunc
}


func_1640()
{
	var_358_object = Obj(); var_359_object = Obj(); // 0x668 PushV
	GetScene(var_359_object); // 0x669 Func
	var_360_string = "battle"; // 0x66b PushS
	var_361_object = Obj(); // 0x66c PushV
	func_1583(var_361_object); // 0x66d NEW_2
	BroadcastMessage(var_360_string, var_361_object, var_359_object); // 0x66f Func
...
{
	var_22_int = 0; var_23_int = 0; // 0x673 PushV
	var_24_string = "branch"; // 0x674 PushS
	GetVariable(var_24_string, var_23_int); // 0x675 Func
	var_21_int = var_23_int; // 0x677 Mov
...
{
	var_16_int = 0; // 0x67a PushV
	func_1651(var_16_int); // 0x67b NEW_2
	var_20_int = 1; // 0x67d PushI
	var_21_bool = var_16_int == var_20_int; // 0x67e Eq
	if(var_21_bool == 0) goto Label_1667; // 0x67f JumpB
	WorkWithCorpse(var_15_object); // 0x680 Func
	goto Label_1669; // 0x682 Jump
	
Label_1669:
	return 0; // 0x685 Return
	
Label_1667:
	Barter(var_15_object); // 0x683 Func
}
