...
0x37c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x37d: Pop(0)
0x37e: Push(Stack[-3])
0x37f: IF (Stack[-1] == 0) GOTO 0x386; Pop(1)

0x380: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x381: Pop(0)
0x382: Push((bool) 0)
0x383: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x384: Pop(1)
0x385: GOTO 0x38a

0x386: Push("Can't find lsh animation : ")
0x387: Pop(1); Push(Stack[-1] + Stack[-8]);
0x388: @ Trace(Stack[-1])
0x389: Pop(1)
0x38a: Return(); Pop(6)

0x38b: PushEmpty(bool, float, float, bool, float, float)
0x38c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x38d: Pop(0)
0x38e: Push(Stack[-3])
0x38f: IF (Stack[-1] == 0) GOTO 0x395; Pop(1)

0x390: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x391: Pop(0)
0x392: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x393: Pop(0)
0x394: GOTO 0x399

0x395: Push("Can't find lsh animation : ")
0x396: Pop(1); Push(Stack[-1] + Stack[-9]);
0x397: @ Trace(Stack[-1])
0x398: Pop(1)
0x399: Return(); Pop(6)
...
0x3a6: Stack[-1] = 0
0x3a7: PushEmpty(float, float)
0x3a8: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3a9: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3aa: Push((float)0.0)
0x3ab: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3ac: IF (Stack[-1] == 0) GOTO 0x3af; Pop(1)

0x3ad: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3ae: Return(); Pop(2)

0x3af: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3b0: Return(); Pop(2)

0x3b1: PushEmpty(object, object)
0x3b2: @ CreateObjectVector(Stack[-1])
0x3b3: Pop(0)
...
0x3b8: @ GetVariable(Stack[-3], Stack[-1])
0x3b9: Pop(0)
0x3ba: Stack[-4] = Stack[-1]
0x3bb: Return(); Pop(2)

0x3bc: PushEmpty(object, object)
0x3bd: @ FindActor(Stack[-1], Stack[-4])
0x3be: Pop(0)
0x3bf: Pop(0); Push((bool) Stack[-1] == 0)
0x3c0: IF (Stack[-1] == 0) GOTO 0x3c3; Pop(1)

0x3c1: Stack[-5] = (bool) 0
0x3c2: Return(); Pop(2)

0x3c3: @ Trigger(Stack[-1], Stack[-3])
0x3c4: Pop(0)
0x3c5: Stack[-5] = (bool) 1
0x3c6: Return(); Pop(2)

0x3c7: Stack[-1] = 0
0x3c8: PushEmpty(string, string)
0x3c9: Stack[-1] = "idle"
0x3ca: Push(Stack[-3])
0x3cb: IF (Stack[-1] == 0) GOTO 0x3cd; Pop(1)

0x3cc: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3cd: Stack[-4] = Stack[-1]
0x3ce: Return(); Pop(2)

0x3cf: PushEmpty(int, bool, int, bool)
0x3d0: Stack[-2] = (int) 0
0x3d1: Push("all")
0x3d2: PushEmpty(string, int)
0x3d3: Stack[-1] = Stack[-5]
0x3d4: Call2 0x3c8

0x3d5: Pop(1)
0x3d6: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3d7: Pop(2)
...
0x3de: Stack[-5] = Stack[-2]
0x3df: Return(); Pop(4)

0x3e0: PushEmpty()
0x3e1: Push("oob6Morlok1")
0x3e2: Push((int) 1)
...
0x40a: Pop(1)
0x40b: Push((int) 4)
0x40c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x40d: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x40e: Stack[-2] = (bool) 1
0x40f: Return(); Pop(0)

0x410: Stack[-2] = (bool) 0
0x411: Return(); Pop(0)

0x412: PushEmpty(int, int, object, int, bool, int, int, int, object, int, bool, int)
0x413: Push((int) 4)
0x414: @@ GetItemCount(Stack[-7], Stack[-1])
0x415: Pop(1)
0x416: Stack[-5] = (int) 0
0x417: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x418: IF (Stack[-1] == 0) GOTO 0x430; Pop(1)

0x419: Push((int) 4)
0x41a: @@ GetItem(Stack[-5], Stack[-6], Stack[-1])
0x41b: Pop(1)
0x41c: @@ GetItemID(Stack[-3])
0x41d: Pop(0)
0x41e: Push("Microscope")
0x41f: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x420: Pop(1)
...
0x424: Push("Microscope")
0x425: @ GetInvItemProperty(Stack[-2], Stack[-4], Stack[-1])
0x426: Pop(1)
0x427: Push((int) 2)
0x428: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x429: IF (Stack[-1] == 0) GOTO 0x42c; Pop(1)

0x42a: Stack[-14] = (bool) 1
0x42b: Return(); Pop(12)

0x42c: Stack[-4] = 0
0x42d: Push((int) 1)
0x42e: Stack[-6] = Stack[-6] + Stack[-1]; Pop(1);
0x42f: GOTO 0x417

0x430: Stack[-14] = (bool) 0
0x431: Return(); Pop(12)

0x432: PushEmpty(object, object)
0x433: Push((int) 365)
0x434: Push((int) 1)
0x435: Push((int) 525665)
0x436: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x437: Pop(3)
0x438: PushEmpty(bool, object, int)
0x439: Stack[-2] = Stack[-4]
0x43a: Stack[-1] = (int) 265
0x43b: Call2 0x44c
...
0x44b: Stack[-1] = 0
0x44c: PushEmpty(object, object, int, object, object, int)
0x44d: PushEmpty(object)
0x44e: Call2 0x43f

0x44f: Stack[-4] = Stack[-1]
0x450: Pop(1)
0x451: @@ Find(Stack[-7], Stack[-2])
0x452: Pop(0)
0x453: Pop(0); Push((bool) Stack[-2] == 0)
0x454: IF (Stack[-1] == 0) GOTO 0x45b; Pop(1)

0x455: Push("Can't find diary parent with id: ")
...
0x45b: @@ AddChild(Stack[-8])
0x45c: Pop(0)
0x45d: Push((int) 7)
0x45e: @ SendWorldWndMessage(Stack[-1])
0x45f: Pop(1)
0x460: @@ GetCategory(Stack[-1])
0x461: Pop(0)
0x462: @ SetDiarySection(Stack[-1])
0x463: Pop(0)
0x464: Stack[-9] = (bool) 0
0x465: Return(); Pop(6)
...
0x469: Push("branch")
0x46a: @ GetVariable(Stack[-1], Stack[-2])
0x46b: Pop(1)
0x46c: Push((int) 0)
...
0x479: Stack[-1] = (int) 521048
0x47a: Return(); Pop(0)

0x47b: Stack[-1] = (int) 521047
0x47c: Return(); Pop(0)

0x47d: Stack[-1] = "ui/NPC_Citizen2.png"
0x47e: Return(); Pop(0)

0x47f: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x480: Return(); Pop(0)
