...
0x69f: Stack[-5] = Stack[-8]
0x6a0: Stack[-4] = "reputation"
0x6a1: Stack[-3] = Stack[-7]
0x6a2: Stack[-2] = (int) 0
0x6a3: Stack[-1] = (int) 1
0x6a4: Call2 0x4cd
...
0x6e9: Push("GenerateMoney: iMin > iMax")
0x6ea: @ Trace(Stack[-1])
0x6eb: Pop(1)
0x6ec: Return(); Pop(4)
...
0x707: Pop(0)
0x708: @@ SetItemName(Stack[-7])
0x709: Pop(0)
0x70a: Push("Organ")
0x70b: Push((int) 1)
0x70c: @@ SetProperty(Stack[-2], Stack[-1])
0x70d: Pop(2)
0x70e: @@ GetItemID(Stack[-2])
0x70f: Pop(0)
0x710: Push((int) 0)
0x711: Push((int) 1)
...
0x764: Pop(1)
0x765: Push("class")
0x766: @@ GetProperty(Stack[-1], Stack[-2])
0x767: Pop(1)
...
0x7ea: Stack[-3] = Stack[-7]
0x7eb: Stack[-2] = Stack[-6]
0x7ec: Stack[-1] = Stack[-5]
0x7ed: Call2 0x563
...
0x7f2: Stack[-5] = Stack[-11]
0x7f3: Stack[-4] = Stack[-10]
0x7f4: Stack[-3] = Stack[-9]
0x7f5: Stack[-2] = Stack[-7]
0x7f6: Stack[-1] = Stack[-6]
0x7f7: Call2 0x5a7
...
0x854: Stack[-2] = Stack[-12]
0x855: Stack[-1] = "disease"
0x856: Call2 0x4c1
...
0x85c: Push("disease")
0x85d: @@ GetProperty(Stack[-1], Stack[-4])
0x85e: Pop(1)
