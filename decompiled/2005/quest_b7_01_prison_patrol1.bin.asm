...
0x251: PushEmpty(bool, float, float, bool, float, float)
0x252: @ lshHasAnimation(Stack[-3], Stack[-7])
0x253: Pop(0)
0x254: Push(Stack[-3])
0x255: IF (Stack[-1] == 0) GOTO 0x25c; Pop(1)

0x256: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x257: Pop(0)
0x258: Push((bool) 0)
0x259: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x25a: Pop(1)
0x25b: GOTO 0x260

0x25c: Push("Can't find lsh animation : ")
...
0x262: @ lshHasAnimation(Stack[-3], Stack[-8])
0x263: Pop(0)
0x264: Push(Stack[-3])
0x265: IF (Stack[-1] == 0) GOTO 0x26b; Pop(1)

0x266: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x267: Pop(0)
0x268: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x269: Pop(0)
0x26a: GOTO 0x26f

0x26b: Push("Can't find lsh animation : ")
0x26c: Pop(1); Push(Stack[-1] + Stack[-9]);
0x26d: @ Trace(Stack[-1])
0x26e: Pop(1)
0x26f: Return(); Pop(6)
...
0x27e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x27f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x280: Push((float)0.0)
0x281: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x282: IF (Stack[-1] == 0) GOTO 0x285; Pop(1)

0x283: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x284: Return(); Pop(2)

0x285: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x286: Return(); Pop(2)

0x287: PushEmpty(int, int)
0x288: @ GetVariable(Stack[-3], Stack[-1])
0x289: Pop(0)
0x28a: Stack[-4] = Stack[-1]
0x28b: Return(); Pop(2)

0x28c: PushEmpty(object, object)
0x28d: @ FindActor(Stack[-1], Stack[-4])
0x28e: Pop(0)
0x28f: Pop(0); Push((bool) Stack[-1] == 0)
0x290: IF (Stack[-1] == 0) GOTO 0x293; Pop(1)

0x291: Stack[-5] = (bool) 0
0x292: Return(); Pop(2)

0x293: @ Trigger(Stack[-1], Stack[-3])
0x294: Pop(0)
0x295: Stack[-5] = (bool) 1
0x296: Return(); Pop(2)

0x297: Stack[-1] = 0
0x298: PushEmpty(float, float)
0x299: @ GetGameTime(Stack[-1])
0x29a: Pop(0)
0x29b: Stack[-3] = Stack[-1]
0x29c: Return(); Pop(2)

0x29d: PushEmpty(string, string)
0x29e: Stack[-1] = "idle"
0x29f: Push(Stack[-3])
0x2a0: IF (Stack[-1] == 0) GOTO 0x2a2; Pop(1)

0x2a1: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2a2: Stack[-4] = Stack[-1]
0x2a3: Return(); Pop(2)

0x2a4: PushEmpty(int, bool, int, bool)
0x2a5: Stack[-2] = (int) 0
0x2a6: Push("all")
...
0x2aa: Pop(1)
0x2ab: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ac: Pop(2)
...
0x2bd: Pop(1)
0x2be: Push("b7q01PatrolGotoGorbun")
0x2bf: Push("pt_map_gorbun")
0x2c0: Push((int) 1)
0x2c1: Push((int) 521025)
0x2c2: PushEmpty(float)
0x2c3: Call2 0x298

0x2c4: Pop(0)
0x2c5: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2c6: Pop(5)
0x2c7: PushEmpty()
0x2c8: Call2 0x2ed

0x2c9: Pop(0)
0x2ca: PushEmpty(bool, string, string)
0x2cb: Stack[-2] = "quest_b7_01"
0x2cc: Stack[-1] = "init_gorbun_house"
0x2cd: Call2 0x28c
...
0x2d0: Stack[-1] = 0
0x2d1: PushEmpty()
0x2d2: PushEmpty(object, string, float)
0x2d3: PushEmpty(object)
0x2d4: Call2 0x323

0x2d5: Stack[-4] = Stack[-1]
0x2d6: Pop(1)
0x2d7: Stack[-2] = "pt_map_gorbun"
0x2d8: Stack[-1] = (int) 2
0x2d9: Call2 0x334
...
0x2dd: Pop(0)
0x2de: @@ ShowMap(Stack[-1])
0x2df: Pop(1)
0x2e0: Return(); Pop(0)

0x2e1: PushEmpty()
0x2e2: PushEmpty(int, string)
0x2e3: Stack[-1] = "b7q01"
0x2e4: Call2 0x287

0x2e5: Pop(1)
0x2e6: Push((int) 3)
0x2e7: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x2e8: IF (Stack[-1] == 0) GOTO 0x2eb; Pop(1)

0x2e9: Stack[-2] = (bool) 1
0x2ea: Return(); Pop(0)

0x2eb: Stack[-2] = (bool) 0
0x2ec: Return(); Pop(0)

0x2ed: PushEmpty(object, object)
0x2ee: Push((int) 257)
0x2ef: Push((int) 1)
0x2f0: Push((int) 521029)
0x2f1: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2f2: Pop(3)
0x2f3: PushEmpty(bool, object, int)
0x2f4: Stack[-2] = Stack[-4]
0x2f5: Stack[-1] = (int) 253
0x2f6: Call2 0x307
...
0x306: Stack[-1] = 0
0x307: PushEmpty(object, object, int, object, object, int)
0x308: PushEmpty(object)
0x309: Call2 0x2fa

0x30a: Stack[-4] = Stack[-1]
0x30b: Pop(1)
0x30c: @@ Find(Stack[-7], Stack[-2])
0x30d: Pop(0)
0x30e: Pop(0); Push((bool) Stack[-2] == 0)
0x30f: IF (Stack[-1] == 0) GOTO 0x316; Pop(1)

0x310: Push("Can't find diary parent with id: ")
...
0x316: @@ AddChild(Stack[-8])
0x317: Pop(0)
0x318: Push((int) 7)
0x319: @ SendWorldWndMessage(Stack[-1])
0x31a: Pop(1)
0x31b: @@ GetCategory(Stack[-1])
0x31c: Pop(0)
0x31d: @ SetDiarySection(Stack[-1])
0x31e: Pop(0)
...
0x321: Stack[-2] = 0
0x322: Stack[-3] = 0
0x323: PushEmpty(object, object, object, object)
0x324: @ GetMainOutdoorScene(Stack[-2])
0x325: Pop(0)
0x326: Pop(0); Push((bool) Stack[-2] == 0)
0x327: IF (Stack[-1] == 0) GOTO 0x32e; Pop(1)

0x328: Push("Can't find main outdoor scene")
0x329: @ Trace(Stack[-1])
0x32a: Pop(1)
0x32b: Stack[-1] = 0
0x32c: Stack[-5] = Stack[-1]
0x32d: Return(); Pop(4)

0x32e: @@ GetMap(Stack[-1])
0x32f: Pop(0)
0x330: Stack[-5] = Stack[-1]
0x331: Return(); Pop(4)

0x332: Stack[-1] = 0
0x333: Stack[-2] = 0
0x334: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
...
0x33d: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x33e: Pop(0)
0x33f: Pop(0); Push((bool) Stack[-1] == 0)
0x340: IF (Stack[-1] == 0) GOTO 0x347; Pop(1)

0x341: Push("Warning: outdoor scene locator ")
0x342: Pop(1); Push(Stack[-1] + Stack[-11]);
0x343: Push(" doesnt exist")
0x344: Pop(2); Push(Stack[-2] + Stack[-1]);
0x345: @ Trace(Stack[-1])
0x346: Pop(1)
0x347: @@ GetMap(Stack[-11])
0x348: Pop(0)
0x349: Pop(0); Push((bool) Stack[-11] == 0)
0x34a: IF (Stack[-1] == 0) GOTO 0x34f; Pop(1)

0x34b: Push("Can't find map")
0x34c: @ Trace(Stack[-1])
0x34d: Pop(1)
0x34e: Return(); Pop(8)
...
0x351: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x352: Pop(2)
0x353: Return(); Pop(8)
...
0x366: Stack[-1] = (int) 515572
0x367: Return(); Pop(0)

0x368: Stack[-1] = (int) 504031
0x369: Return(); Pop(0)

0x36a: Stack[-1] = "ui/NPC_Citizen2.png"
0x36b: Return(); Pop(0)

0x36c: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x36d: Return(); Pop(0)
