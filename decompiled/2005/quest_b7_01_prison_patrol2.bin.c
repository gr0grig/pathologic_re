...
{
	var_67_string = "ui/NPC_Citizen2.png"; // 0x23c MovS
...
{
	var_68_string = "ui/NPC_Citizen2_b.png"; // 0x23e MovS
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_78_object, var_79_object)
{
	...
	var_102_int = 520994; // 0x54 PushI
	SetMessage(var_102_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_103_int = 520995; // 0x59 PushI
	var_104_int = 29851; // 0x5a PushI
	var_105_int = 22208; // 0x5b PushI
	AddReply(var_103_int, var_104_int, var_105_int); // 0x5c TObjFunc
	var_106_int = 528463; // 0x5e PushI
	var_107_int = -1; // 0x5f PushI
	var_108_int = 29850; // 0x60 PushI
