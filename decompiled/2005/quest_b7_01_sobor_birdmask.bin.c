...
Label_201:
	...
	func_576(var_43_bool); // 0xcb NEW_2
...
Label_288:
	...
	func_511(var_9_object); // 0x122 NEW_2
...
func_388(var_18_bool, var_20_float)
{
	...
	func_517(var_45_cvector, var_46_cvector); // 0x19f NEW_2
...
Label_429:
	...
	CameraTransit(var_36_cvector, var_34_cvector); // 0x1af Func
	var_58_float = GetByIndex(var_35_cvector, 0); // 0x1b1 PushE
	var_59_float = GetByIndex(var_35_cvector, 2); // 0x1b2 PushE
	Rotate(var_58_float, var_59_float); // 0x1b3 Func
	var_60_bool = 0; // 0x1b5 PushV
	func_576(var_60_bool); // 0x1b6 NEW_2
	if(var_60_bool == 0) goto Label_442; // 0x1b8 JumpB
	goto Label_450; // 0x1b9 Jump
	
Label_450:
	CameraWaitForPlayFinish(); // 0x1c2 Func
	ResumeWorld(); // 0x1c4 Func
	var_18_bool = 1; // 0x1c6 MovB
	return 18; // 0x1c7 Return
	
Label_442:
	var_61_string = "head"; // 0x1ba PushS
	HasAnimationTrack(var_38_bool, var_61_string); // 0x1bb Func
	var_62_bool = var_38_bool; // 0x1bd Push
	if(var_62_bool == 0) goto Label_450; // 0x1be JumpB
	var_63_string = "head"; // 0x1bf PushS
	LookAsyncCamera(var_63_string); // 0x1c0 Func
}
...
func_132(var_2_object, var_85_string)
{
	...
	func_576(var_86_bool); // 0x86 NEW_2
...
Label_150:
	func_489(var_89_string, var_90_bool); // 0x96 NEW_2
...
func_517(var_45_cvector, var_46_cvector)
{
	var_48_float = 0; var_49_float = 0; // 0x205 PushV
	var_50_int = var_46_cvector | var_46_cvector; // 0x206 Or
	var_49_float = sqrt(var_50_int); // 0x207 Sqrt2
	var_51_float = 0.0; // 0x208 PushF
	var_52_bool = var_49_float < var_51_float; // 0x209 LT
	if(var_52_bool == 0) goto Label_525; // 0x20a JumpB
	var_45_cvector = CVector(0.0, 0.0, 0.0); // 0x20b MovV
	return 2; // 0x20c Return
	
Label_525:
	var_45_cvector = var_46_cvector / var_46_cvector; // 0x20d Div2
...
func_527(var_37_string, var_38_int)
{
	var_39_string = ""; var_40_string = ""; // 0x20f PushV
	var_40_string = "idle"; // 0x210 MovS
	var_41_int = var_38_int; // 0x211 Push
	if(var_41_int == 0) goto Label_532; // 0x212 JumpB
	var_40_string = var_40_string + var_38_int; // 0x213 Add2
	
Label_532:
	var_37_string = var_40_string; // 0x214 Mov
...
func_534(var_31_int)
{
	var_32_int = 0; var_33_bool = 0; var_34_int = 0; var_35_bool = 0; // 0x216 PushV
	var_34_int = 0; // 0x217 MovI
	
Label_536:
	var_36_string = "all"; // 0x218 PushS
	var_37_string = ""; var_38_int = 0; // 0x219 PushV
	var_38_int = var_34_int; // 0x21a Mov
	func_527(var_37_string, var_38_int); // 0x21b NEW_2
	HasAnimation(var_35_bool, var_36_string, var_37_string); // 0x21d Func
	var_42_bool = var_35_bool == 0; // 0x21f Not
	if(var_42_bool == 0) goto Label_546; // 0x220 JumpB
	goto Label_549; // 0x221 Jump
	
Label_549:
	var_31_int = var_34_int; // 0x225 Mov
	return 4; // 0x226 Return
	
Label_546:
	var_43_int = 1; // 0x222 PushI
	var_34_int = var_34_int + var_43_int; // 0x223 Add2
	goto Label_536; // 0x224 Jump
}


func_551(var_69_int)
{
	var_70_int = 0; var_71_int = 0; // 0x227 PushV
	var_72_string = "branch"; // 0x228 PushS
	GetVariable(var_72_string, var_71_int); // 0x229 Func
	var_73_int = 0; // 0x22b PushI
	var_74_bool = var_71_int == var_73_int; // 0x22c Eq
	if(var_74_bool == 0) goto Label_561; // 0x22d JumpB
	var_69_int = 1; // 0x22e MovI
	return 2; // 0x22f Return
	
Label_561:
	var_75_int = 1; // 0x231 PushI
	var_76_bool = var_71_int == var_75_int; // 0x232 Eq
	if(var_76_bool == 0) goto Label_566; // 0x233 JumpB
	var_69_int = 2; // 0x234 MovI
	return 2; // 0x235 Return
	
Label_566:
	var_69_int = 3; // 0x236 MovI
...
Label_306:
	...
	func_534(var_31_int); // 0x133 NEW_2
...
Label_321:
	...
	func_527(var_53_string, var_54_int); // 0x14f NEW_2
...
func_570(var_65_int)
{
	var_65_int = 504029; // 0x23a MovI
	return 0; // 0x23b Return
}


func_572(var_67_string)
{
	var_67_string = "ui/NPC_bmask.png"; // 0x23c MovS
...
{
	var_68_string = "ui/NPC_bmask_b.png"; // 0x23e MovS
	return 0; // 0x23f Return
}


func_576(var_60_bool)
{
	var_60_bool = 0; // 0x240 MovB
...
func_456()
{
	var_129_bool = 0; var_130_bool = 0; // 0x1c8 PushV
	CameraSwitchToNormal(); // 0x1c9 Func
	var_131_bool = 0; // 0x1cb PushV
	func_576(var_131_bool); // 0x1cc NEW_2
	if(var_131_bool == 0) goto Label_464; // 0x1ce JumpB
	goto Label_472; // 0x1cf Jump
	
Label_472:
	return 2; // 0x1d8 Return
	
Label_464:
	var_132_string = "head"; // 0x1d0 PushS
	HasAnimationTrack(var_130_bool, var_132_string); // 0x1d1 Func
	var_133_bool = var_130_bool; // 0x1d3 Push
	if(var_133_bool == 0) goto Label_472; // 0x1d4 JumpB
	var_134_string = "head"; // 0x1d5 PushS
	UnlookAsync(var_134_string); // 0x1d6 Func
}
...
Label_111:
	...
	func_473(var_111_string); // 0x71 NEW_2
...
func_473(var_111_string)
{
	var_112_bool = 0; var_113_float = 0; var_114_float = 0; var_115_bool = 0; var_116_float = 0; var_117_float = 0; // 0x1d9 PushV
	lshHasAnimation(var_115_bool, var_111_string); // 0x1da Func
	var_118_bool = var_115_bool; // 0x1dc Push
	if(var_118_bool == 0) goto Label_484; // 0x1dd JumpB
	lshGetAnimTimes(var_111_string, var_116_float, var_117_float); // 0x1de Func
	var_119_bool = 0; // 0x1e0 PushB
	lshPlayAnimation(var_116_float, var_117_float, var_119_bool); // 0x1e1 Func
...
Label_484:
	var_120_string = "Can't find lsh animation : "; // 0x1e4 PushS
	var_121_int = var_120_string + var_111_string; // 0x1e5 Add
	Trace(var_121_int); // 0x1e6 Func
}
...
func_489(var_89_string, var_90_bool)
{
	var_93_bool = 0; var_94_float = 0; var_95_float = 0; var_96_bool = 0; var_97_float = 0; var_98_float = 0; // 0x1e9 PushV
	lshHasAnimation(var_96_bool, var_89_string); // 0x1ea Func
	var_99_bool = var_96_bool; // 0x1ec Push
	if(var_99_bool == 0) goto Label_499; // 0x1ed JumpB
	lshGetAnimTimes(var_89_string, var_97_float, var_98_float); // 0x1ee Func
	lshPlayAnimation(var_97_float, var_98_float, var_90_bool); // 0x1f0 Func
...
Label_499:
	var_100_string = "Can't find lsh animation : "; // 0x1f3 PushS
	var_101_int = var_100_string + var_89_string; // 0x1f4 Add
	Trace(var_101_int); // 0x1f5 Func
}
...
Label_259:
	...
	func_511(var_14_object); // 0x105 NEW_2
...
func_504()
{
	var_9_bool = 0; // 0x1f8 PushV
	func_576(var_9_bool); // 0x1f9 NEW_2
	if(var_9_bool == 0) goto Label_510; // 0x1fb JumpB
	lshStopSpeech(); // 0x1fc Func
...
func_511(var_9_object)
{
	var_10_object = Obj(); var_11_object = Obj(); // 0x1ff PushV
	self(var_11_object); // 0x200 Func
	var_9_object = var_11_object; // 0x202 Mov
