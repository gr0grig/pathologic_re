...
0x1f1: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1f2: Pop(0)
0x1f3: Push(Stack[-3])
0x1f4: IF (Stack[-1] == 0) GOTO 0x1fb; Pop(1)

0x1f5: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1f6: Pop(0)
0x1f7: Push((bool) 0)
...
0x1fb: Push("Can't find lsh animation : ")
0x1fc: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1fd: @ Trace(Stack[-1])
0x1fe: Pop(1)
0x1ff: Return(); Pop(6)

0x200: PushEmpty(bool, float, float, bool, float, float)
0x201: @ lshHasAnimation(Stack[-3], Stack[-8])
0x202: Pop(0)
0x203: Push(Stack[-3])
0x204: IF (Stack[-1] == 0) GOTO 0x20a; Pop(1)

0x205: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x206: Pop(0)
0x207: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x208: Pop(0)
0x209: GOTO 0x20e

0x20a: Push("Can't find lsh animation : ")
0x20b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x20c: @ Trace(Stack[-1])
0x20d: Pop(1)
0x20e: Return(); Pop(6)
...
0x226: PushEmpty(string, string)
0x227: Stack[-1] = "idle"
0x228: Push(Stack[-3])
0x229: IF (Stack[-1] == 0) GOTO 0x22b; Pop(1)

0x22a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x22b: Stack[-4] = Stack[-1]
0x22c: Return(); Pop(2)

0x22d: PushEmpty(int, bool, int, bool)
0x22e: Stack[-2] = (int) 0
0x22f: Push("all")
0x230: PushEmpty(string, int)
0x231: Stack[-1] = Stack[-5]
0x232: Call2 0x226

0x233: Pop(1)
0x234: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x235: Pop(2)
...
0x239: Push((int) 1)
0x23a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x23b: GOTO 0x22f

0x23c: Stack[-5] = Stack[-2]
0x23d: Return(); Pop(4)

0x23e: PushEmpty(int, int)
0x23f: Push("branch")
0x240: @ GetVariable(Stack[-1], Stack[-2])
0x241: Pop(1)
0x242: Push((int) 0)
...
0x24f: Stack[-1] = (int) 515572
0x250: Return(); Pop(0)

0x251: Stack[-1] = (int) 504031
0x252: Return(); Pop(0)

0x253: Stack[-1] = "ui/NPC_Citizen2.png"
0x254: Return(); Pop(0)

0x255: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x256: Return(); Pop(0)
