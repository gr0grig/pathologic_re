...
0x2d3: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2d4: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2d5: Push((float)0.0)
0x2d6: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2d7: IF (Stack[-1] == 0) GOTO 0x2da; Pop(1)

0x2d8: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2d9: Return(); Pop(2)

0x2da: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2db: Return(); Pop(2)

0x2dc: PushEmpty(int, int)
0x2dd: @ GetVariable(Stack[-3], Stack[-1])
0x2de: Pop(0)
0x2df: Stack[-4] = Stack[-1]
0x2e0: Return(); Pop(2)

0x2e1: PushEmpty(object, object)
0x2e2: @ FindActor(Stack[-1], Stack[-4])
0x2e3: Pop(0)
0x2e4: Pop(0); Push((bool) Stack[-1] == 0)
0x2e5: IF (Stack[-1] == 0) GOTO 0x2e8; Pop(1)

0x2e6: Stack[-5] = (bool) 0
0x2e7: Return(); Pop(2)

0x2e8: @ Trigger(Stack[-1], Stack[-3])
0x2e9: Pop(0)
0x2ea: Stack[-5] = (bool) 1
0x2eb: Return(); Pop(2)
...
0x30c: Pop(0)
0x30d: Push("disease")
0x30e: @@ GetProperty(Stack[-1], Stack[-2])
0x30f: Pop(1)
0x310: Push((float)0.5)
0x311: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x312: IF (Stack[-1] == 0) GOTO 0x317; Pop(1)

0x313: Push("disease")
0x314: Push((float)0.5)
0x315: @@ SetProperty(Stack[-2], Stack[-1])
0x316: Pop(2)
0x317: PushEmpty(bool, string, string)
0x318: Stack[-2] = "quest_b7_03"
0x319: Stack[-1] = "remove_birdmask"
0x31a: Call2 0x2e1
...
0x34e: @ GetDiaryRoot(Stack[-1])
0x34f: Pop(0)
0x350: Pop(0); Push((bool) Stack[-1] == 0)
0x351: IF (Stack[-1] == 0) GOTO 0x357; Pop(1)

0x352: Push("Can't retrieve diary root")
0x353: @ Trace(Stack[-1])
0x354: Pop(1)
0x355: Stack[-3] = (bool) 0
0x356: Return(); Pop(2)
...
0x359: Stack[-1] = 0
0x35a: PushEmpty(object, object, int, object, object, int)
0x35b: PushEmpty(object)
0x35c: Call2 0x34d

0x35d: Stack[-4] = Stack[-1]
0x35e: Pop(1)
0x35f: @@ Find(Stack[-7], Stack[-2])
0x360: Pop(0)
0x361: Pop(0); Push((bool) Stack[-2] == 0)
0x362: IF (Stack[-1] == 0) GOTO 0x369; Pop(1)

0x363: Push("Can't find diary parent with id: ")
0x364: Pop(1); Push(Stack[-1] + Stack[-8]);
0x365: @ Trace(Stack[-1])
0x366: Pop(1)
0x367: Stack[-9] = (bool) 0
0x368: Return(); Pop(6)

0x369: @@ AddChild(Stack[-8])
0x36a: Pop(0)
0x36b: Push((int) 7)
0x36c: @ SendWorldWndMessage(Stack[-1])
0x36d: Pop(1)
0x36e: @@ GetCategory(Stack[-1])
0x36f: Pop(0)
0x370: @ SetDiarySection(Stack[-1])
0x371: Pop(0)
...
0x387: Stack[-1] = (int) 515571
0x388: Return(); Pop(0)

0x389: Stack[-1] = (int) 504029
0x38a: Return(); Pop(0)

0x38b: Stack[-1] = "ui/NPC_bmask.png"
0x38c: Return(); Pop(0)

0x38d: Stack[-1] = "ui/NPC_bmask_b.png"
0x38e: Return(); Pop(0)
