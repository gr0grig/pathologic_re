...
Label_195:
	...
	func_749(var_119_object); // 0xd3 NEW_2
	...
	func_761(var_125_object); // 0xd8 NEW_2
...
Label_332:
	...
	func_902(var_177_bool); // 0x14e NEW_2
...
Label_416:
	...
	func_634(var_9_object); // 0x1a2 NEW_2
...
func_898(var_67_string)
{
	var_67_string = "ui/NPC_Citizen2.png"; // 0x382 MovS
...
{
	var_68_string = "ui/NPC_Citizen2_b.png"; // 0x384 MovS
...
func_773()
{
	var_42_object = Obj(); var_43_object = Obj(); // 0x305 PushV
	var_44_int = 300; // 0x306 PushI
	var_45_int = 1; // 0x307 PushI
	var_46_int = 521615; // 0x308 PushI
	CreateDiaryEntry(var_43_object, var_44_int, var_45_int, var_46_int); // 0x309 Func
	var_47_bool = 0; var_48_object = Obj(); var_49_int = 0; // 0x30b PushV
	var_48_object = var_43_object; // 0x30c Mov
	var_49_int = 297; // 0x30d MovI
	func_799(var_47_bool, var_48_object, var_49_int); // 0x30e NEW_2
	return 2; // 0x310 Return
}


func_902(var_60_bool)
{
	var_60_bool = 0; // 0x386 MovB
	return 0; // 0x387 Return
}


func_650(var_106_int, var_107_string)
{
	var_108_int = 0; var_109_int = 0; // 0x28a PushV
	GetVariable(var_107_string, var_109_int); // 0x28b Func
	var_106_int = var_109_int; // 0x28d Mov
	return 2; // 0x28e Return
}


func_655(var_65_bool, var_66_string, var_67_string)
{
	var_68_object = Obj(); var_69_object = Obj(); // 0x28f PushV
	FindActor(var_69_object, var_66_string); // 0x290 Func
	var_70_bool = var_69_object == 0; // 0x292 NullEq
	if(var_70_bool == 0) goto Label_662; // 0x293 JumpB
	var_65_bool = 0; // 0x294 MovB
	return 2; // 0x295 Return
	
Label_662:
	Trigger(var_69_object, var_67_string); // 0x296 Func
	var_65_bool = 1; // 0x298 MovB
...
func_146(var_2_object, var_85_string)
{
	...
	func_902(var_86_bool); // 0x94 NEW_2
...
Label_156:
	var_89_string = ""; var_90_bool = 0; // 0x9c PushV
	var_89_string = var_85_string; // 0x9d Mov
	var_91_string = ""; // 0x9e PushS
	var_92_bool = var_85_string == var_91_string; // 0x9f Eq
	if(var_92_bool == 0) goto Label_163; // 0xa0 JumpB
	var_90_bool = 0; // 0xa1 MovB
	goto Label_164; // 0xa2 Jump
	
Label_164:
	func_612(var_89_string, var_90_bool); // 0xa4 NEW_2
	var_2_object = var_85_string; // 0xa6 TMov
	return 0; // 0xa7 Return
	
Label_163:
	var_90_bool = 1; // 0xa3 MovB
}


func_786(var_56_object)
{
	var_57_object = Obj(); var_58_object = Obj(); // 0x312 PushV
	GetDiaryRoot(var_58_object); // 0x313 Func
	var_59_bool = var_58_object == 0; // 0x315 Not
	if(var_59_bool == 0) goto Label_796; // 0x316 JumpB
	var_60_string = "Can't retrieve diary root"; // 0x317 PushS
	Trace(var_60_string); // 0x318 Func
	var_56_object = 0; // 0x31a MovB
	return 2; // 0x31b Return
	
Label_796:
	var_56_object = var_58_object; // 0x31c Mov
	return 2; // 0x31d Return
}


func_667(var_39_float)
{
	var_40_float = 0; var_41_float = 0; // 0x29b PushV
	GetGameTime(var_41_float); // 0x29c Func
	var_39_float = var_41_float; // 0x29e Mov
	return 2; // 0x29f Return
}


func_799(var_47_bool, var_48_object, var_49_int)
{
	var_50_object = Obj(); var_51_object = Obj(); var_52_int = 0; var_53_object = Obj(); var_54_object = Obj(); var_55_int = 0; // 0x31f PushV
	var_56_object = Obj(); // 0x320 PushV
	func_786(var_56_object); // 0x321 NEW_2
	var_53_object = var_56_object; // 0x322 Mov
	Find(var_49_int, var_54_object); // 0x324 ObjFunc
	var_61_bool = var_54_object == 0; // 0x326 Not
	if(var_61_bool == 0) goto Label_814; // 0x327 JumpB
	var_62_string = "Can't find diary parent with id: "; // 0x328 PushS
	var_63_int = var_62_string + var_49_int; // 0x329 Add
	Trace(var_63_int); // 0x32a Func
	var_47_bool = 0; // 0x32c MovB
	return 6; // 0x32d Return
	
Label_814:
	AddChild(var_48_object); // 0x32e ObjFunc
	var_64_int = 7; // 0x330 PushI
	SendWorldWndMessage(var_64_int); // 0x331 Func
	GetCategory(var_55_int); // 0x333 ObjFunc
	SetDiarySection(var_55_int); // 0x335 Func
	var_47_bool = 0; // 0x337 MovB
	return 6; // 0x338 Return
}


func_672(var_37_string, var_38_int)
{
	var_39_string = ""; var_40_string = ""; // 0x2a0 PushV
	var_40_string = "idle"; // 0x2a1 MovS
	var_41_int = var_38_int; // 0x2a2 Push
	if(var_41_int == 0) goto Label_677; // 0x2a3 JumpB
	var_40_string = var_40_string + var_38_int; // 0x2a4 Add2
	
Label_677:
	var_37_string = var_40_string; // 0x2a5 Mov
...
func_679(var_31_int)
{
	var_32_int = 0; var_33_bool = 0; var_34_int = 0; var_35_bool = 0; // 0x2a7 PushV
	var_34_int = 0; // 0x2a8 MovI
	
Label_681:
	var_36_string = "all"; // 0x2a9 PushS
	var_37_string = ""; var_38_int = 0; // 0x2aa PushV
	var_38_int = var_34_int; // 0x2ab Mov
	func_672(var_37_string, var_38_int); // 0x2ac NEW_2
	HasAnimation(var_35_bool, var_36_string, var_37_string); // 0x2ae Func
	var_42_bool = var_35_bool == 0; // 0x2b0 Not
	if(var_42_bool == 0) goto Label_691; // 0x2b1 JumpB
	goto Label_694; // 0x2b2 Jump
	
Label_694:
	var_31_int = var_34_int; // 0x2b6 Mov
	return 4; // 0x2b7 Return
	
Label_691:
	var_43_int = 1; // 0x2b3 PushI
	var_34_int = var_34_int + var_43_int; // 0x2b4 Add2
	goto Label_681; // 0x2b5 Jump
}
...
Label_434:
	...
	func_679(var_31_int); // 0x1b3 NEW_2
...
Label_449:
	...
	func_672(var_53_string, var_54_int); // 0x1cf NEW_2
...
func_696()
{
	var_14_string = "oob9MDoberman1"; // 0x2b9 PushS
	var_15_int = 1; // 0x2ba PushI
	SetVariable(var_14_string, var_15_int); // 0x2bb Func
	return 0; // 0x2bd Return
}


func_827(var_28_object)
{
	var_29_object = Obj(); var_30_object = Obj(); var_31_object = Obj(); var_32_object = Obj(); // 0x33b PushV
	GetMainOutdoorScene(var_31_object); // 0x33c Func
	var_33_bool = var_31_object == 0; // 0x33e NullEq
	if(var_33_bool == 0) goto Label_838; // 0x33f JumpB
	var_34_string = "Can't find main outdoor scene"; // 0x340 PushS
	Trace(var_34_string); // 0x341 Func
	var_32_object = 0; // 0x343 SetNull
	var_28_object = var_32_object; // 0x344 Mov
	return 4; // 0x345 Return
	
Label_838:
	GetMap(var_32_object); // 0x346 ObjFunc
	var_28_object = var_32_object; // 0x348 Mov
...
func_702()
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x2be PushV
	var_22_int = 0; var_23_string = ""; // 0x2bf PushV
	var_23_string = "b9q01"; // 0x2c0 MovS
	func_650(var_22_int, var_23_string); // 0x2c1 NEW_2
	var_26_int = 2; // 0x2c3 PushI
	var_27_bool = var_22_int == var_26_int; // 0x2c4 Eq
	if(var_27_bool == 0) goto Label_732; // 0x2c5 JumpB
	var_28_object = Obj(); // 0x2c6 PushV
	func_827(var_28_object); // 0x2c7 NEW_2
	var_21_object = var_28_object; // 0x2c8 Mov
	var_35_string = "b9q01MDobermanGotoFactory"; // 0x2ca PushS
	var_36_string = "pt_gmap_factory"; // 0x2cb PushS
	var_37_int = 1; // 0x2cc PushI
	var_38_int = 530198; // 0x2cd PushI
	var_39_float = 0; // 0x2ce PushV
	func_667(var_39_float); // 0x2cf NEW_2
	AddMark(var_35_string, var_36_string, var_37_int, var_38_int, var_39_float); // 0x2d1 ObjFunc
	func_773(); // 0x2d4 NEW_2
	var_65_bool = 0; var_66_string = ""; var_67_string = ""; // 0x2d6 PushV
	var_66_string = "quest_b9_01"; // 0x2d7 MovS
	var_67_string = "remove_mdoberman"; // 0x2d8 MovS
	func_655(var_65_bool, var_66_string, var_67_string); // 0x2d9 NEW_2
	var_21_object = 0; // 0x2db SetNull
...
func_579()
{
	var_144_bool = 0; var_145_bool = 0; // 0x243 PushV
	CameraSwitchToNormal(); // 0x244 Func
	var_146_bool = 0; // 0x246 PushV
	func_902(var_146_bool); // 0x247 NEW_2
	if(var_146_bool == 0) goto Label_587; // 0x249 JumpB
...
Label_587:
	var_147_string = "head"; // 0x24b PushS
	HasAnimationTrack(var_145_bool, var_147_string); // 0x24c Func
	var_148_bool = var_145_bool; // 0x24e Push
	if(var_148_bool == 0) goto Label_595; // 0x24f JumpB
	var_149_string = "head"; // 0x250 PushS
	UnlookAsync(var_149_string); // 0x251 Func
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_78_object, var_79_object)
{
	...
	if(var_84_int == 0) goto Label_116; // 0x4f JumpB
	var_85_string = ""; // 0x50 PushV
	var_85_string = "Neutral"; // 0x51 MovS
	func_146(var_79_object, var_85_string); // 0x52 NEW_2
	var_102_int = 521558; // 0x54 PushI
	SetMessage(var_102_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_103_bool = 0; // 0x59 PushV
	var_103_bool = 0; // 0x5a MovB
	var_104_bool = 0; var_105_object = Obj(); // 0x5b PushV
	var_105_object = var_1_object; // 0x5c MovT
	func_749(var_105_object); // 0x5d NEW_2
	if(var_104_bool == 0) goto Label_102; // 0x5f JumpB
	var_112_bool = 0; var_113_object = Obj(); // 0x60 PushV
	var_113_object = var_1_object; // 0x61 MovT
	func_761(var_113_object); // 0x62 NEW_2
	if(var_112_bool == 0) goto Label_102; // 0x64 JumpB
	var_103_bool = 1; // 0x65 MovB
	
Label_102:
	if(var_103_bool == 0) goto Label_108; // 0x66 JumpB
	var_118_int = 521559; // 0x67 PushI
	var_119_int = 22721; // 0x68 PushI
	var_120_int = 22720; // 0x69 PushI
	AddReply(var_118_int, var_119_int, var_120_int); // 0x6a TObjFunc
	
Label_108:
	var_121_int = 521562; // 0x6c PushI
	var_122_int = -1; // 0x6d PushI
	var_123_int = 22723; // 0x6e PushI
	AddReply(var_121_int, var_122_int, var_123_int); // 0x6f TObjFunc
	goto Label_116; // 0x71 Jump
	
Label_116:
	var_124_bool = 0; // 0x74 PushV
	func_902(var_124_bool); // 0x75 NEW_2
	if(var_124_bool == 0) goto Label_131; // 0x77 JumpB
...
Label_125:
	var_126_string = ""; // 0x7d PushV
	var_126_string = var_2_object; // 0x7e MovT
	func_596(var_126_string); // 0x7f NEW_2
	goto Label_120; // 0x81 Jump
	
Label_131:
	var_137_string = "all"; // 0x83 PushS
	var_138_string = "idle"; // 0x84 PushS
	PlayAnimation(var_137_string, var_138_string); // 0x85 Func
	
Label_135:
	WaitForAnimEnd(); // 0x87 Func
	var_139_string = var_3_string; // 0x89 PushT
	if(var_139_string == 0) goto Label_140; // 0x8a JumpB
	goto Label_145; // 0x8b Jump
	
Label_140:
	var_140_string = "all"; // 0x8c PushS
	var_141_string = "idle"; // 0x8d PushS
	PlayAnimation(var_140_string, var_141_string); // 0x8e Func
	goto Label_135; // 0x90 Jump
}


func_844(var_73_object, var_74_string, var_75_float)
{
	var_77_cvector = CVector(0,0,0); var_78_cvector = CVector(0,0,0); var_79_object = Obj(); var_80_bool = 0; var_81_cvector = CVector(0,0,0); var_82_cvector = CVector(0,0,0); var_83_object = Obj(); var_84_bool = 0; // 0x34c PushV
	GetMainOutdoorScene(var_83_object); // 0x34d Func
	var_85_bool = var_83_object == 0; // 0x34f NullEq
	if(var_85_bool == 0) goto Label_853; // 0x350 JumpB
	var_86_string = "Can't find main outdoor scene"; // 0x351 PushS
	Trace(var_86_string); // 0x352 Func
	return 8; // 0x354 Return
	
Label_853:
	GetLocator(var_74_string, var_84_bool, var_81_cvector, var_82_cvector); // 0x355 ObjFunc
	var_87_bool = var_84_bool == 0; // 0x357 Not
	if(var_87_bool == 0) goto Label_863; // 0x358 JumpB
	var_88_string = "Warning: outdoor scene locator "; // 0x359 PushS
	var_89_int = var_88_string + var_74_string; // 0x35a Add
	var_90_string = " doesnt exist"; // 0x35b PushS
	var_91_int = var_89_int + var_90_string; // 0x35c Add
	Trace(var_91_int); // 0x35d Func
	
Label_863:
	GetMap(var_73_object); // 0x35f ObjFunc
	var_92_bool = var_73_object == 0; // 0x361 NullEq
	if(var_92_bool == 0) goto Label_871; // 0x362 JumpB
	var_93_string = "Can't find map"; // 0x363 PushS
	Trace(var_93_string); // 0x364 Func
	return 8; // 0x366 Return
	
Label_871:
	var_94_float = GetByIndex(var_81_cvector, 0); // 0x367 PushE
	var_95_float = GetByIndex(var_81_cvector, 2); // 0x368 PushE
	SetMapParams(var_94_float, var_95_float, var_75_float); // 0x369 ObjFunc
	return 8; // 0x36b Return
}


func_596(var_126_string)
{
	var_127_bool = 0; var_128_float = 0; var_129_float = 0; var_130_bool = 0; var_131_float = 0; var_132_float = 0; // 0x254 PushV
	lshHasAnimation(var_130_bool, var_126_string); // 0x255 Func
	var_133_bool = var_130_bool; // 0x257 Push
	if(var_133_bool == 0) goto Label_607; // 0x258 JumpB
	lshGetAnimTimes(var_126_string, var_131_float, var_132_float); // 0x259 Func
	var_134_bool = 0; // 0x25b PushB
	lshPlayAnimation(var_131_float, var_132_float, var_134_bool); // 0x25c Func
...
Label_607:
	var_135_string = "Can't find lsh animation : "; // 0x25f PushS
	var_136_int = var_135_string + var_126_string; // 0x260 Add
	Trace(var_136_int); // 0x261 Func
}


func_733()
{
	var_73_object = Obj(); var_74_string = ""; var_75_float = 0; // 0x2de PushV
	var_76_object = Obj(); // 0x2df PushV
	func_827(var_76_object); // 0x2e0 NEW_2
	var_73_object = var_76_object; // 0x2e1 Mov
	var_74_string = "pt_gmap_factory"; // 0x2e3 MovS
	var_75_float = 2; // 0x2e4 MovI
	func_844(var_73_object, var_74_string, var_75_float); // 0x2e5 NEW_2
	var_96_object = Obj(); // 0x2e7 PushV
	func_827(var_96_object); // 0x2e8 NEW_2
	ShowMap(var_96_object); // 0x2ea ObjFunc
	return 0; // 0x2ec Return
}


func_612(var_89_string, var_90_bool)
{
	var_93_bool = 0; var_94_float = 0; var_95_float = 0; var_96_bool = 0; var_97_float = 0; var_98_float = 0; // 0x264 PushV
	lshHasAnimation(var_96_bool, var_89_string); // 0x265 Func
	var_99_bool = var_96_bool; // 0x267 Push
	if(var_99_bool == 0) goto Label_622; // 0x268 JumpB
	lshGetAnimTimes(var_89_string, var_97_float, var_98_float); // 0x269 Func
	lshPlayAnimation(var_97_float, var_98_float, var_90_bool); // 0x26b Func
	goto Label_626; // 0x26d Jump
	
Label_626:
	return 6; // 0x272 Return
	
Label_622:
	var_100_string = "Can't find lsh animation : "; // 0x26e PushS
	var_101_int = var_100_string + var_89_string; // 0x26f Add
	Trace(var_101_int); // 0x270 Func
}


func_877(var_69_int)
{
	var_70_int = 0; var_71_int = 0; // 0x36d PushV
	var_72_string = "branch"; // 0x36e PushS
	GetVariable(var_72_string, var_71_int); // 0x36f Func
	var_73_int = 0; // 0x371 PushI
	var_74_bool = var_71_int == var_73_int; // 0x372 Eq
	if(var_74_bool == 0) goto Label_887; // 0x373 JumpB
	var_69_int = 1; // 0x374 MovI
	return 2; // 0x375 Return
	
Label_887:
	var_75_int = 1; // 0x377 PushI
	var_76_bool = var_71_int == var_75_int; // 0x378 Eq
	if(var_76_bool == 0) goto Label_892; // 0x379 JumpB
	var_69_int = 2; // 0x37a MovI
	return 2; // 0x37b Return
	
Label_892:
	var_69_int = 3; // 0x37c MovI
	return 2; // 0x37d Return
}


func_749(var_104_bool)
{
	var_106_int = 0; var_107_string = ""; // 0x2ee PushV
	var_107_string = "b9q01"; // 0x2ef MovS
	func_650(var_106_int, var_107_string); // 0x2f0 NEW_2
	var_110_int = 2; // 0x2f2 PushI
	var_111_bool = var_106_int == var_110_int; // 0x2f3 Eq
	if(var_111_bool == 0) goto Label_759; // 0x2f4 JumpB
	var_104_bool = 1; // 0x2f5 MovB
	return 0; // 0x2f6 Return
	
Label_759:
	var_104_bool = 0; // 0x2f7 MovB
...
func_627()
{
	...
	func_902(var_9_bool); // 0x274 NEW_2
...
Label_387:
	...
	func_634(var_14_object); // 0x185 NEW_2
...
func_761(var_112_bool)
{
	var_114_int = 0; var_115_string = ""; // 0x2fa PushV
	var_115_string = "oob9MDoberman1"; // 0x2fb MovS
	func_650(var_114_int, var_115_string); // 0x2fc NEW_2
	var_116_int = 0; // 0x2fe PushI
	var_117_bool = var_114_int == var_116_int; // 0x2ff Eq
	if(var_117_bool == 0) goto Label_771; // 0x300 JumpB
	var_112_bool = 1; // 0x301 MovB
	return 0; // 0x302 Return
	
Label_771:
	var_112_bool = 0; // 0x303 MovB
...
func_511(var_18_bool, var_20_float)
{
	...
	func_640(var_45_cvector, var_46_cvector); // 0x21a NEW_2
...
Label_552:
	...
	CameraTransit(var_36_cvector, var_34_cvector); // 0x22a Func
	var_58_float = GetByIndex(var_35_cvector, 0); // 0x22c PushE
	var_59_float = GetByIndex(var_35_cvector, 2); // 0x22d PushE
	Rotate(var_58_float, var_59_float); // 0x22e Func
	var_60_bool = 0; // 0x230 PushV
	func_902(var_60_bool); // 0x231 NEW_2
	if(var_60_bool == 0) goto Label_565; // 0x233 JumpB
	goto Label_573; // 0x234 Jump
	
Label_573:
	CameraWaitForPlayFinish(); // 0x23d Func
	ResumeWorld(); // 0x23f Func
	var_18_bool = 1; // 0x241 MovB
	return 18; // 0x242 Return
	
Label_565:
	var_61_string = "head"; // 0x235 PushS
	HasAnimationTrack(var_38_bool, var_61_string); // 0x236 Func
	var_62_bool = var_38_bool; // 0x238 Push
	if(var_62_bool == 0) goto Label_573; // 0x239 JumpB
	var_63_string = "head"; // 0x23a PushS
	LookAsyncCamera(var_63_string); // 0x23b Func
}
