...
Events:
EVENT_22 Op = 0xa9d Vars = (object, int, float, float)
EVENT_43 Op = 0xaa5 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xaaf Vars = (object, string)
EVENT_41 Op = 0xabc Vars = (object)
...
0x92e: PushEmpty(int, int)
0x92f: @ GetVariable(Stack[-3], Stack[-1])
0x930: Pop(0)
0x931: Stack[-4] = Stack[-1]
0x932: Return(); Pop(2)

0x933: PushEmpty()
0x934: Pop(0); Push((bool) Stack[-2] == 0)
0x935: IF (Stack[-1] == 0) GOTO 0x938; Pop(1)

0x936: Stack[-3] = (bool) 0
0x937: Return(); Pop(0)

0x938: Push((int) 0)
0x939: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x93a: IF (Stack[-1] == 0) GOTO 0x93f; Pop(1)

0x93b: Push((int) 8)
0x93c: @ SendWorldWndMessage(Stack[-1])
0x93d: Pop(1)
0x93e: GOTO 0x948

0x93f: Push((int) 0)
0x940: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x941: IF (Stack[-1] == 0) GOTO 0x946; Pop(1)

0x942: Push((int) 9)
0x943: @ SendWorldWndMessage(Stack[-1])
0x944: Pop(1)
0x945: GOTO 0x948

0x946: Stack[-3] = (bool) 0
0x947: Return(); Pop(0)

0x948: PushEmpty(float)
0x949: Stack[-1] = Stack[-2]
0x94a: Call2 0x960

0x94b: Pop(1)
0x94c: PushEmpty(bool, object, string, float, float, float)
0x94d: Stack[-5] = Stack[-8]
0x94e: Stack[-4] = "reputation"
0x94f: Stack[-3] = Stack[-7]
0x950: Stack[-2] = (int) 0
0x951: Stack[-1] = (int) 1
0x952: Call2 0x734

0x953: Pop(6)
0x954: Stack[-3] = (bool) 1
0x955: Return(); Pop(0)

0x956: PushEmpty(object, object)
0x957: @ CreateFloatVector(Stack[-1])
0x958: Pop(0)
0x959: @@ add(Stack[-3])
0x95a: Pop(0)
0x95b: Push((int) 15)
0x95c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x95d: Pop(1)
0x95e: Return(); Pop(2)

0x95f: Stack[-1] = 0
0x960: PushEmpty(object, object)
0x961: @ CreateFloatVector(Stack[-1])
0x962: Pop(0)
0x963: @@ add(Stack[-3])
0x964: Pop(0)
0x965: Push((int) 16)
0x966: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x967: Pop(1)
0x968: Return(); Pop(2)

0x969: Stack[-1] = 0
0x96a: PushEmpty(object, object)
0x96b: @ FindActor(Stack[-1], Stack[-4])
0x96c: Pop(0)
0x96d: Pop(0); Push((bool) Stack[-1] == 0)
0x96e: IF (Stack[-1] == 0) GOTO 0x971; Pop(1)

0x96f: Stack[-5] = (bool) 0
0x970: Return(); Pop(2)

0x971: @ Trigger(Stack[-1], Stack[-3])
0x972: Pop(0)
0x973: Stack[-5] = (bool) 1
0x974: Return(); Pop(2)

0x975: Stack[-1] = 0
0x976: PushEmpty(bool, bool)
0x977: @ IsPlayerActor(Stack[-3], Stack[-1])
0x978: Pop(0)
0x979: Push(Stack[-1])
0x97a: IF (Stack[-1] == 0) GOTO 0x97e; Pop(1)

0x97b: Push("attack")
0x97c: @ PlayGlobalMusic(Stack[-1])
0x97d: Pop(1)
0x97e: Return(); Pop(2)

0x97f: PushEmpty(object, object)
0x980: @ GetScene(Stack[-1])
0x981: Pop(0)
0x982: Push("battle")
...
0x985: Pop(0)
0x986: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x987: Pop(2)
0x988: Return(); Pop(2)

0x989: Stack[-1] = 0
0x98a: PushEmpty(int, int)
0x98b: Push("rifle_ammo")
0x98c: Push((int) 30)
0x98d: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1])
0x98e: Pop(2)
0x98f: Return(); Pop(2)

0x990: PushEmpty()
0x991: Push("oob9Doberman1")
0x992: Push((int) 1)
...
0x996: PushEmpty()
0x997: Push("oob9Doberman2")
0x998: Push((int) 1)
0x999: @ SetVariable(Stack[-2], Stack[-1])
0x99a: Pop(2)
0x99b: Return(); Pop(0)
...
0x9a1: PushEmpty()
0x9a2: Push("b9q01DankoFree")
0x9a3: Push((int) 1)
0x9a4: @ SetVariable(Stack[-2], Stack[-1])
0x9a5: Pop(2)
0x9a6: PushEmpty()
0x9a7: Call2 0xa1a

0x9a8: Pop(0)
0x9a9: PushEmpty(bool, string, string)
0x9aa: Stack[-2] = "quest_b9_01"
0x9ab: Stack[-1] = "danko_free"
0x9ac: Call2 0x96a
...
0x9af: PushEmpty()
0x9b0: Push("playsound")
0x9b1: Push("giveitem")
0x9b2: @ TriggerWorld(Stack[-2], Stack[-1])
0x9b3: Pop(2)
0x9b4: Return(); Pop(0)

0x9b5: PushEmpty()
0x9b6: PushEmpty(int, string)
0x9b7: Stack[-1] = "b9q01"
0x9b8: Call2 0x92e

0x9b9: Pop(1)
0x9ba: Push((int) 2)
0x9bb: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9bc: IF (Stack[-1] == 0) GOTO 0x9bf; Pop(1)

0x9bd: Stack[-2] = (bool) 1
0x9be: Return(); Pop(0)

0x9bf: Stack[-2] = (bool) 0
0x9c0: Return(); Pop(0)

0x9c1: PushEmpty()
0x9c2: PushEmpty(bool, object)
0x9c3: Stack[-1] = Stack[-3]
0x9c4: Call2 0xa06
...
0x9d7: PushEmpty()
0x9d8: PushEmpty(int, string)
0x9d9: Stack[-1] = "oob9Doberman2"
0x9da: Call2 0x92e
...
0x9df: Stack[-2] = (bool) 1
0x9e0: Return(); Pop(0)

0x9e1: Stack[-2] = (bool) 0
0x9e2: Return(); Pop(0)
...
0x9e7: Stack[-1] = "b1q03_retreat"
0x9e8: Call2 0x92e

0x9e9: Pop(1)
0x9ea: Push((int) 0)
0x9eb: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x9ec: IF (Stack[-1] == 0) GOTO 0x9f5; Pop(1)

0x9ed: PushEmpty(int, string)
0x9ee: Stack[-1] = "b1q03_dead"
0x9ef: Call2 0x92e
...
0x9f6: Stack[-2] = (bool) 1
0x9f7: Return(); Pop(0)

0x9f8: Stack[-2] = (bool) 0
0x9f9: Return(); Pop(0)

0x9fa: PushEmpty()
0x9fb: PushEmpty(int, string)
0x9fc: Stack[-1] = "b9q01DankoFree"
0x9fd: Call2 0x92e

0x9fe: Pop(1)
0x9ff: Push((int) 0)
0xa00: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0xa01: IF (Stack[-1] == 0) GOTO 0xa04; Pop(1)

0xa02: Stack[-2] = (bool) 1
0xa03: Return(); Pop(0)

0xa04: Stack[-2] = (bool) 0
0xa05: Return(); Pop(0)

0xa06: PushEmpty(int, int)
0xa07: Push("rifle_ammo")
0xa08: @@ GetItemCountOfType(Stack[-2], Stack[-1])
0xa09: Pop(1)
0xa0a: Push((int) 30)
0xa0b: Stack[-5] = Stack[-2] >= Stack[-1]; Pop(1);
0xa0c: Return(); Pop(2)

0xa0d: PushEmpty(object, object)
0xa0e: Push((int) 301)
0xa0f: Push((int) 1)
0xa10: Push((int) 521616)
0xa11: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa12: Pop(3)
0xa13: PushEmpty(bool, object, int)
0xa14: Stack[-2] = Stack[-4]
0xa15: Stack[-1] = (int) 297
0xa16: Call2 0xa34
...
0xa1b: Push((int) 302)
0xa1c: Push((int) 1)
0xa1d: Push((int) 521617)
0xa1e: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa1f: Pop(3)
0xa20: PushEmpty(bool, object, int)
0xa21: Stack[-2] = Stack[-4]
0xa22: Stack[-1] = (int) 297
0xa23: Call2 0xa34
...
0xa28: @ GetDiaryRoot(Stack[-1])
0xa29: Pop(0)
0xa2a: Pop(0); Push((bool) Stack[-1] == 0)
0xa2b: IF (Stack[-1] == 0) GOTO 0xa31; Pop(1)

0xa2c: Push("Can't retrieve diary root")
0xa2d: @ Trace(Stack[-1])
0xa2e: Pop(1)
0xa2f: Stack[-3] = (bool) 0
0xa30: Return(); Pop(2)

0xa31: Stack[-3] = Stack[-1]
0xa32: Return(); Pop(2)

0xa33: Stack[-1] = 0
0xa34: PushEmpty(object, object, int, object, object, int)
0xa35: PushEmpty(object)
0xa36: Call2 0xa27

0xa37: Stack[-4] = Stack[-1]
0xa38: Pop(1)
0xa39: @@ Find(Stack[-7], Stack[-2])
0xa3a: Pop(0)
0xa3b: Pop(0); Push((bool) Stack[-2] == 0)
0xa3c: IF (Stack[-1] == 0) GOTO 0xa43; Pop(1)

0xa3d: Push("Can't find diary parent with id: ")
0xa3e: Pop(1); Push(Stack[-1] + Stack[-8]);
0xa3f: @ Trace(Stack[-1])
0xa40: Pop(1)
0xa41: Stack[-9] = (bool) 0
0xa42: Return(); Pop(6)

0xa43: @@ AddChild(Stack[-8])
0xa44: Pop(0)
0xa45: Push((int) 7)
0xa46: @ SendWorldWndMessage(Stack[-1])
0xa47: Pop(1)
0xa48: @@ GetCategory(Stack[-1])
0xa49: Pop(0)
0xa4a: @ SetDiarySection(Stack[-1])
0xa4b: Pop(0)
0xa4c: Stack[-9] = (bool) 0
0xa4d: Return(); Pop(6)

0xa4e: Stack[-2] = 0
0xa4f: Stack[-3] = 0
0xa50: PushEmpty(int, int)
0xa51: Push("branch")
0xa52: @ GetVariable(Stack[-1], Stack[-2])
0xa53: Pop(1)
0xa54: Push((int) 0)
...
0xa62: Push("branch")
0xa63: @ GetVariable(Stack[-1], Stack[-2])
0xa64: Pop(1)
0xa65: Stack[-3] = Stack[-1]
0xa66: Return(); Pop(2)
...
0xa6a: Pop(0)
0xa6b: Push((int) 1)
0xa6c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xa6d: IF (Stack[-1] == 0) GOTO 0xa71; Pop(1)

0xa6e: @ WorkWithCorpse(Stack[-1])
0xa6f: Pop(0)
0xa70: GOTO 0xa73

0xa71: @ Barter(Stack[-1])
0xa72: Pop(0)
0xa73: Return(); Pop(0)

0xa74: PushEmpty(object, int, bool, object, int, bool)
0xa75: @ CreateInvItem(Stack[-3])
0xa76: Pop(0)
0xa77: @@ SetItemName(Stack[-7])
0xa78: Pop(0)
0xa79: Push("Organ")
0xa7a: Push((int) 1)
0xa7b: @@ SetProperty(Stack[-2], Stack[-1])
0xa7c: Pop(2)
0xa7d: @@ GetItemID(Stack[-2])
0xa7e: Pop(0)
0xa7f: Push((int) 0)
0xa80: Push((int) 1)
0xa81: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xa82: Pop(2)
0xa83: Return(); Pop(6)
...
0xa87: Pop(0)
0xa88: Push((int) 1)
0xa89: Pop(2); Push((bool) Stack[-2] != Stack[-1])
...
0xa9d: PushEmpty()
0xa9e: PushEmpty(object, int, float)
0xa9f: Stack[-3] = Stack[-7]
0xaa0: Stack[-2] = Stack[-6]
...
0xaa5: PushEmpty()
0xaa6: PushEmpty(object, int, float, cvector, cvector)
0xaa7: Stack[-5] = Stack[-11]
0xaa8: Stack[-4] = Stack[-10]
0xaa9: Stack[-3] = Stack[-9]
0xaaa: Stack[-2] = Stack[-7]
0xaab: Stack[-1] = Stack[-6]
0xaac: Call2 0x844

0xaad: Pop(5)
0xaae: Return(); Pop(0)

0xaaf: PushEmpty(float, float)
0xab0: Push("health")
0xab1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xab2: IF (Stack[-1] == 0) GOTO 0xabb; Pop(1)

0xab3: Push("health")
0xab4: @ GetProperty(Stack[-1], Stack[-2])
0xab5: Pop(1)
0xab6: Push((int) 0)
0xab7: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xab8: IF (Stack[-1] == 0) GOTO 0xabb; Pop(1)

0xab9: @ SignalDeath(Stack[-4])
0xaba: Pop(0)
0xabb: Return(); Pop(2)

0xabc: PushEmpty()
0xabd: PushEmpty(object)
0xabe: Stack[-1] = Stack[-2]
0xabf: Call2 0xacc

0xac0: Pop(1)
0xac1: Return(); Pop(0)

0xac2: Stack[-1] = (int) 543371
0xac3: Return(); Pop(0)

0xac4: Stack[-1] = (int) 543370
0xac5: Return(); Pop(0)

0xac6: Stack[-1] = "ui/NPC_Citizen2.png"
0xac7: Return(); Pop(0)

0xac8: Stack[-1] = "ui/NPC_Citizen2_b.png"
0xac9: Return(); Pop(0)
...
0xace: Stack[-1] = Stack[-2]
0xacf: Push(-1, 0); TaskCall(4)
0xad0: Call2 0x635

0xad1: Pop(-1, 0); TaskReturn
0xad2: Pop(1)
0xad3: Return(); Pop(0)
