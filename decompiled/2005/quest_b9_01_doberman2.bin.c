task_1_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1638(var_12_object); // 0x2e2 NEW_2
...
task_2_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object)
{
	...
	func_1664(var_13_object); // 0x3d1 NEW_2
...
task_3_event_17(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object)
{
	...
	func_1626(var_13_bool, var_14_string, var_15_string); // 0x471 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x6b7 PushV
	var_13_object = var_9_object; // 0x6b8 Mov
	var_14_int = var_10_int; // 0x6b9 Mov
	var_15_float = var_11_float; // 0x6ba Mov
	func_1392(var_13_object, var_14_int, var_15_float); // 0x6bb NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x6bf PushV
	var_15_object = var_9_object; // 0x6c0 Mov
	var_16_int = var_10_int; // 0x6c1 Mov
	var_17_float = var_11_float; // 0x6c2 Mov
	var_18_cvector = var_13_cvector; // 0x6c3 Mov
	var_19_cvector = var_14_cvector; // 0x6c4 Mov
	func_1460(var_17_float, var_18_cvector, var_19_cvector); // 0x6c5 NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x6c8 PushV
	var_13_string = "health"; // 0x6c9 PushS
	var_14_bool = var_10_string == var_13_string; // 0x6ca Eq
	if(var_14_bool == 0) goto Label_1748; // 0x6cb JumpB
	var_15_string = "health"; // 0x6cc PushS
	GetProperty(var_15_string, var_12_float); // 0x6cd Func
	var_16_int = 0; // 0x6cf PushI
	var_17_bool = var_12_float <= var_16_int; // 0x6d0 LE
	if(var_17_bool == 0) goto Label_1748; // 0x6d1 JumpB
	SignalDeath(var_9_object); // 0x6d2 Func
...
{
	var_10_object = Obj(); // 0x6d6 PushV
	var_10_object = var_9_object; // 0x6d7 Mov
	func_1755(var_10_object); // 0x6d8 NEW_2
...
func_1664(var_13_object)
{
	var_14_int = 0; // 0x681 PushV
	func_1658(var_14_int); // 0x682 NEW_2
	var_18_int = 1; // 0x684 PushI
	var_19_bool = var_14_int == var_18_int; // 0x685 Eq
	if(var_19_bool == 0) goto Label_1674; // 0x686 JumpB
	WorkWithCorpse(var_13_object); // 0x687 Func
...
Label_1674:
	Barter(var_13_object); // 0x68a Func
}
...
func_1677(var_106_string)
{
	var_107_object = Obj(); var_108_int = 0; var_109_bool = 0; var_110_object = Obj(); var_111_int = 0; var_112_bool = 0; // 0x68d PushV
	CreateInvItem(var_110_object); // 0x68e Func
	SetItemName(var_106_string); // 0x690 ObjFunc
	var_113_string = "Organ"; // 0x692 PushS
	var_114_int = 1; // 0x693 PushI
	SetProperty(var_113_string, var_114_int); // 0x694 ObjFunc
	GetItemID(var_111_int); // 0x696 ObjFunc
	var_115_int = 0; // 0x698 PushI
	var_116_int = 1; // 0x699 PushI
	AddItem(var_112_bool, var_110_object, var_115_int, var_116_int); // 0x69a Func
...
Label_177:
	...
	var_497_string = "all"; // 0xb3 PushS
	var_498_string = "fjump"; // 0xb4 PushS
	PlayAnimation(var_497_string, var_498_string); // 0xb5 Func
	WaitForAnimEnd(); // 0xb7 Func
	func_663(var_46_float); // 0xba NEW_2
	var_499_cvector = CVector(0.0, 0.0, 0.0); // 0xbc PushVec
	SetSpeed(var_499_cvector); // 0xbd Func
	Stop(); // 0xbf Func
	StopAsync(); // 0xc1 Func
	var_500_bool = 0; // 0xc3 PushV
	func_620(var_46_float, var_500_bool); // 0xc4 NEW_2
	var_501_bool = var_500_bool == 0; // 0xc6 Not
	if(var_501_bool == 0) goto Label_223; // 0xc7 JumpB
	var_502_bool = 0; var_503_object = Obj(); // 0xc8 PushV
	var_503_object = var_0_object; // 0xc9 MovT
	func_1324(var_502_bool, var_503_object); // 0xca NEW_2
	var_504_bool = var_502_bool == 0; // 0xcc Not
	if(var_504_bool == 0) goto Label_207; // 0xcd JumpB
...
Label_207:
	...
	var_505_float = var_24_float * var_24_float; // 0xd5 Mult
	var_506_bool = var_43_float < var_505_float; // 0xd6 LT
	if(var_506_bool == 0) goto Label_223; // 0xd7 JumpB
	var_507_bool = 0; var_508_float = 0; // 0xd8 PushV
	var_508_float = var_24_float; // 0xd9 Mov
	func_324(var_46_float, var_507_bool, var_508_float); // 0xda NEW_2
	var_509_bool = var_507_bool == 0; // 0xdc Not
	if(var_509_bool == 0) goto Label_223; // 0xdd JumpB
	goto Label_233; // 0xde Jump
	
Label_224:
	var_510_bool = 0; var_511_float = 0; // 0xe0 PushV
	var_511_float = var_24_float; // 0xe1 Mov
	func_324(var_46_float, var_510_bool, var_511_float); // 0xe2 NEW_2
	var_512_bool = var_510_bool == 0; // 0xe4 Not
	if(var_512_bool == 0) goto Label_231; // 0xe5 JumpB
...
func_663(var_0_object)
{
	...
	func_1638(var_118_object); // 0x299 NEW_2
...
func_1658(var_100_int)
{
	var_101_int = 0; var_102_int = 0; // 0x67a PushV
	var_103_string = "branch"; // 0x67b PushS
	GetVariable(var_103_string, var_102_int); // 0x67c Func
	var_100_int = var_102_int; // 0x67e Mov
	return 2; // 0x67f Return
}


func_668(var_455_int)
{
	var_455_int = 0; // 0x29c MovI
...
func_285(var_0_object, var_380_float, var_381_int)
{
	...
	var_455_int = 0; // 0x138 PushV
	func_668(var_455_int); // 0x139 NEW_2
	ReportHit(var_0_object, var_455_int, var_387_float, var_386_float); // 0x13b Func
	var_456_object = Obj(); var_457_float = 0; // 0x13d PushV
	var_456_object = var_385_object; // 0x13e Mov
	var_457_float = var_387_float; // 0x13f Mov
...
func_1694()
{
	var_100_int = 0; // 0x69e PushV
	func_1658(var_100_int); // 0x69f NEW_2
	var_104_int = 1; // 0x6a1 PushI
	var_105_bool = var_100_int != var_104_int; // 0x6a2 Neq
	if(var_105_bool == 0) goto Label_1701; // 0x6a3 JumpB
	return 0; // 0x6a4 Return
	
Label_1701:
	var_106_string = ""; // 0x6a5 PushV
	var_106_string = "liver"; // 0x6a6 MovS
	func_1677(var_106_string); // 0x6a7 NEW_2
	var_117_string = ""; // 0x6a9 PushV
	var_117_string = "kidney"; // 0x6aa MovS
	func_1677(var_117_string); // 0x6ab NEW_2
	var_118_string = ""; // 0x6ad PushV
	var_118_string = "heart"; // 0x6ae MovS
	func_1677(var_118_string); // 0x6af NEW_2
	var_119_string = ""; // 0x6b1 PushV
	var_119_string = "blood"; // 0x6b2 MovS
	func_1677(var_119_string); // 0x6b3 NEW_2
...
Label_1592:
	...
	func_1616(var_131_float); // 0x63a NEW_2
...
func_677(var_480_bool)
{
	var_480_bool = 1; // 0x2a5 MovB
...
func_683(var_2_int, var_125_bool, var_126_object, var_127_float, var_128_float, var_129_bool, var_130_bool)
{
	...
	func_1638(var_138_object); // 0x2ae NEW_2
...
func_939(var_11_object)
{
	...
	func_1626(var_12_bool, var_13_string, var_14_string); // 0x3af NEW_2
...
Label_1229:
	var_454_string = "armor"; // 0x4cd PushS
	GetProperty(var_454_string, var_407_int); // 0x4ce ObjFunc
}
...
Label_360:
	...
	var_458_string = "all"; // 0x16d PushS
	var_459_string = "attack_middle"; // 0x16e PushS
	var_460_int = var_459_string + var_349_int; // 0x16f Add
	HasAnimation(var_350_bool, var_458_string, var_460_int); // 0x170 Func
	var_461_bool = var_350_bool; // 0x172 Push
	if(var_461_bool == 0) goto Label_441; // 0x173 JumpB
	func_1647(); // 0x175 NEW_2
	var_462_string = "all"; // 0x177 PushS
	var_463_string = "attack_middle"; // 0x178 PushS
	var_464_int = var_463_string + var_349_int; // 0x179 Add
	PlayAnimation(var_462_string, var_464_int); // 0x17a Func
	WaitForAnimEnd(); // 0x17c Func
	func_663(var_352_string); // 0x17f NEW_2
	var_465_bool = 0; var_466_object = Obj(); // 0x181 PushV
	var_466_object = var_0_object; // 0x182 MovT
	func_1324(var_465_bool, var_466_object); // 0x183 NEW_2
	var_467_bool = var_465_bool == 0; // 0x185 Not
	if(var_467_bool == 0) goto Label_395; // 0x186 JumpB
	StopAsync(); // 0x187 Func
	var_343_bool = 0; // 0x189 MovB
	return 8; // 0x18a Return
	
Label_395:
	var_468_float = 0; var_469_int = 0; // 0x18b PushV
	var_468_float = var_344_float; // 0x18c Mov
	var_469_int = var_349_int; // 0x18d Mov
	func_285(var_352_string, var_468_float, var_469_int); // 0x18e NEW_2
	var_351_int = 1; // 0x190 MovI
	
Label_401:
	var_470_string = "attack_middle"; // 0x191 PushS
	var_471_int = var_470_string + var_349_int; // 0x192 Add
	var_472_string = "_"; // 0x193 PushS
	var_473_int = var_471_int + var_472_string; // 0x194 Add
	var_352_string = var_473_int + var_351_int; // 0x195 Add2
	var_474_string = "all"; // 0x196 PushS
	HasAnimation(var_350_bool, var_474_string, var_352_string); // 0x197 Func
	var_475_bool = var_350_bool == 0; // 0x199 Not
	if(var_475_bool == 0) goto Label_412; // 0x19a JumpB
	goto Label_441; // 0x19b Jump
	
Label_441:
	var_476_bool = 0; // 0x1b9 PushB
	SetAttackState(var_476_bool); // 0x1ba Func
	var_477_string = "all"; // 0x1bc PushS
	var_478_string = "attack_end"; // 0x1bd PushS
	var_479_int = var_478_string + var_349_int; // 0x1be Add
	PlayAnimation(var_477_string, var_479_int); // 0x1bf Func
	var_480_bool = 0; // 0x1c1 PushV
	func_677(var_480_bool); // 0x1c2 NEW_2
	if(var_480_bool == 0) goto Label_459; // 0x1c4 JumpB
	var_481_bool = 0; var_482_float = 0; // 0x1c5 PushV
	var_482_float = 0.75; // 0x1c6 MovF
	func_461(var_481_bool, var_482_float); // 0x1c7 NEW_2
...
Label_412:
	func_1647(); // 0x19d NEW_2
	var_490_string = "all"; // 0x19f PushS
	PlayAnimation(var_490_string, var_352_string); // 0x1a0 Func
	WaitForAnimEnd(); // 0x1a2 Func
	func_663(var_352_string); // 0x1a5 NEW_2
	var_491_bool = 0; var_492_object = Obj(); // 0x1a7 PushV
	var_492_object = var_0_object; // 0x1a8 MovT
	func_1324(var_491_bool, var_492_object); // 0x1a9 NEW_2
	var_493_bool = var_491_bool == 0; // 0x1ab Not
	if(var_493_bool == 0) goto Label_433; // 0x1ac JumpB
	StopAsync(); // 0x1ad Func
	var_343_bool = 0; // 0x1af MovB
	return 8; // 0x1b0 Return
	
Label_433:
	var_494_float = 0; var_495_int = 0; // 0x1b1 PushV
	var_494_float = var_344_float; // 0x1b2 Mov
	var_495_int = var_349_int; // 0x1b3 Mov
	func_285(var_352_string, var_494_float, var_495_int); // 0x1b4 NEW_2
	var_496_int = 1; // 0x1b6 PushI
	var_351_int = var_351_int + var_496_int; // 0x1b7 Add2
...
func_1606(var_450_float)
{
	...
	var_453_int = 15; // 0x64b PushI
	SendWorldWndMessage(var_453_int, var_452_object); // 0x64c Func
	return 2; // 0x64e Return
}


func_461(var_481_bool, var_482_float)
{
	var_483_float = 0; var_484_bool = 0; var_485_float = 0; var_486_bool = 0; // 0x1cd PushV
	rand(var_485_float); // 0x1ce Func
	var_487_bool = var_485_float < var_482_float; // 0x1d0 LT
	if(var_487_bool == 0) goto Label_481; // 0x1d1 JumpB
	
Label_466:
	IsAnimationPlaying(var_486_bool); // 0x1d2 Func
	var_488_bool = var_486_bool == 0; // 0x1d4 Not
	if(var_488_bool == 0) goto Label_471; // 0x1d5 JumpB
...
Label_486:
	var_481_bool = 0; // 0x1e6 MovB
	return 4; // 0x1e7 Return
	
Label_471:
	var_489_bool = 0; // 0x1d7 PushV
	func_559(var_489_bool); // 0x1d8 NEW_2
	if(var_489_bool == 0) goto Label_477; // 0x1da JumpB
	var_481_bool = 1; // 0x1db MovB
...
Label_481:
	...
	func_663(var_486_bool); // 0x1e4 NEW_2
}
...
func_1616(var_131_float)
{
	var_132_object = Obj(); var_133_object = Obj(); // 0x650 PushV
	CreateFloatVector(var_133_object); // 0x651 Func
	add(var_131_float); // 0x653 ObjFunc
	var_134_int = 16; // 0x655 PushI
	SendWorldWndMessage(var_134_int, var_133_object); // 0x656 Func
...
func_1626(var_12_bool, var_13_string, var_14_string)
{
	var_15_object = Obj(); var_16_object = Obj(); // 0x65a PushV
	FindActor(var_16_object, var_13_string); // 0x65b Func
	var_17_bool = var_16_object == 0; // 0x65d NullEq
	if(var_17_bool == 0) goto Label_1633; // 0x65e JumpB
	var_12_bool = 0; // 0x65f MovB
	return 2; // 0x660 Return
	
Label_1633:
	Trigger(var_16_object, var_14_string); // 0x661 Func
	var_12_bool = 1; // 0x663 MovB
	return 2; // 0x664 Return
}


func_1755(var_10_object)
{
	var_11_object = Obj(); // 0x6dc PushV
	var_11_object = var_10_object; // 0x6dd Mov
	TaskCall(2); // 0x6de TaskCall
	func_939(var_11_object); // 0x6df NEW_2
	TaskReturn(); // 0x6e0 TaskReturn
...
func_1638(var_118_object)
{
	var_119_bool = 0; var_120_bool = 0; // 0x666 PushV
	IsPlayerActor(var_118_object, var_120_bool); // 0x667 Func
	var_121_bool = var_120_bool; // 0x669 Push
	if(var_121_bool == 0) goto Label_1646; // 0x66a JumpB
	var_122_string = "attack"; // 0x66b PushS
	PlayGlobalMusic(var_122_string); // 0x66c Func
...
func_1647()
{
	var_355_object = Obj(); var_356_object = Obj(); // 0x66f PushV
	GetScene(var_356_object); // 0x670 Func
	var_357_string = "battle"; // 0x672 PushS
	var_358_object = Obj(); // 0x673 PushV
	func_1537(var_358_object); // 0x674 NEW_2
	BroadcastMessage(var_357_string, var_358_object, var_356_object); // 0x676 Func
