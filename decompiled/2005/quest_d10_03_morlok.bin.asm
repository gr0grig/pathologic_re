...
0x221: PushEmpty(bool, float, float, bool, float, float)
0x222: @ lshHasAnimation(Stack[-3], Stack[-7])
0x223: Pop(0)
0x224: Push(Stack[-3])
0x225: IF (Stack[-1] == 0) GOTO 0x22c; Pop(1)

0x226: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x227: Pop(0)
0x228: Push((bool) 0)
...
0x22d: Pop(1); Push(Stack[-1] + Stack[-8]);
0x22e: @ Trace(Stack[-1])
0x22f: Pop(1)
0x230: Return(); Pop(6)

0x231: PushEmpty(bool, float, float, bool, float, float)
0x232: @ lshHasAnimation(Stack[-3], Stack[-8])
0x233: Pop(0)
0x234: Push(Stack[-3])
0x235: IF (Stack[-1] == 0) GOTO 0x23b; Pop(1)

0x236: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x237: Pop(0)
0x238: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x239: Pop(0)
0x23a: GOTO 0x23f

0x23b: Push("Can't find lsh animation : ")
0x23c: Pop(1); Push(Stack[-1] + Stack[-9]);
0x23d: @ Trace(Stack[-1])
0x23e: Pop(1)
0x23f: Return(); Pop(6)

0x240: PushEmpty(float, cvector, float, cvector)
0x241: @@ GetEyesHeight(Stack[-2])
0x242: Pop(0)
0x243: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x244: Push(CvectorIndex(Stack[-1], 1))
0x245: Stack[-1] = Stack[-3]
0x246: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x247: Push("head")
0x248: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x249: Pop(1)
0x24a: Return(); Pop(4)
...
0x278: Stack[-5] = Stack[-2]
0x279: Return(); Pop(4)

0x27a: PushEmpty(int, int)
0x27b: Push("branch")
0x27c: @ GetVariable(Stack[-1], Stack[-2])
0x27d: Pop(1)
0x27e: Push((int) 0)
...
0x28b: Stack[-1] = (int) 521048
0x28c: Return(); Pop(0)

0x28d: Stack[-1] = (int) 521047
0x28e: Return(); Pop(0)

0x28f: Stack[-1] = "ui/NPC_Citizen2.png"
0x290: Return(); Pop(0)

0x291: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x292: Return(); Pop(0)
