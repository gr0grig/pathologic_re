...
Events:
EVENT_6 Op = 0x5f6 Vars = ()
EVENT_22 Op = 0x606 Vars = (object, int, float, float)
EVENT_43 Op = 0x60e Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x618 Vars = (object, string)
EVENT_41 Op = 0x625 Vars = (object)
...
0x5dc: Pop(0)
0x5dd: Push((int) 15)
0x5de: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x5df: Pop(1)
0x5e0: Return(); Pop(2)

0x5e1: Stack[-1] = 0
0x5e2: PushEmpty(bool, bool)
0x5e3: @ IsPlayerActor(Stack[-3], Stack[-1])
0x5e4: Pop(0)
0x5e5: Push(Stack[-1])
0x5e6: IF (Stack[-1] == 0) GOTO 0x5ea; Pop(1)

0x5e7: Push("attack")
0x5e8: @ PlayGlobalMusic(Stack[-1])
0x5e9: Pop(1)
0x5ea: Return(); Pop(2)
...
0x5f1: Pop(0)
0x5f2: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x5f3: Pop(2)
0x5f4: Return(); Pop(2)
...
0x606: PushEmpty()
0x607: PushEmpty(object, int, float)
0x608: Stack[-3] = Stack[-7]
...
0x60e: PushEmpty()
0x60f: PushEmpty(object, int, float, cvector, cvector)
0x610: Stack[-5] = Stack[-11]
0x611: Stack[-4] = Stack[-10]
0x612: Stack[-3] = Stack[-9]
0x613: Stack[-2] = Stack[-7]
...
0x618: PushEmpty(float, float)
0x619: Push("health")
0x61a: Pop(1); Push((bool) Stack[-4] == Stack[-1])
...
0x622: @ SignalDeath(Stack[-4])
0x623: Pop(0)
0x624: Return(); Pop(2)

0x625: PushEmpty()
0x626: PushEmpty(object)
