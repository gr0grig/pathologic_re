...
0x26a: @ lshHasAnimation(Stack[-3], Stack[-7])
0x26b: Pop(0)
0x26c: Push(Stack[-3])
0x26d: IF (Stack[-1] == 0) GOTO 0x274; Pop(1)

0x26e: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x26f: Pop(0)
0x270: Push((bool) 0)
...
0x274: Push("Can't find lsh animation : ")
0x275: Pop(1); Push(Stack[-1] + Stack[-8]);
0x276: @ Trace(Stack[-1])
0x277: Pop(1)
0x278: Return(); Pop(6)

0x279: PushEmpty(bool, float, float, bool, float, float)
0x27a: @ lshHasAnimation(Stack[-3], Stack[-8])
0x27b: Pop(0)
0x27c: Push(Stack[-3])
0x27d: IF (Stack[-1] == 0) GOTO 0x283; Pop(1)

0x27e: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x27f: Pop(0)
0x280: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x281: Pop(0)
0x282: GOTO 0x287

0x283: Push("Can't find lsh animation : ")
0x284: Pop(1); Push(Stack[-1] + Stack[-9]);
0x285: @ Trace(Stack[-1])
0x286: Pop(1)
0x287: Return(); Pop(6)
...
0x2a5: @ FindActor(Stack[-1], Stack[-4])
0x2a6: Pop(0)
0x2a7: Pop(0); Push((bool) Stack[-1] == 0)
0x2a8: IF (Stack[-1] == 0) GOTO 0x2ab; Pop(1)

0x2a9: Stack[-5] = (bool) 0
0x2aa: Return(); Pop(2)

0x2ab: @ Trigger(Stack[-1], Stack[-3])
0x2ac: Pop(0)
0x2ad: Stack[-5] = (bool) 1
0x2ae: Return(); Pop(2)

0x2af: Stack[-1] = 0
0x2b0: PushEmpty(float, float)
0x2b1: @ GetGameTime(Stack[-1])
0x2b2: Pop(0)
0x2b3: Stack[-3] = Stack[-1]
0x2b4: Return(); Pop(2)

0x2b5: PushEmpty()
0x2b6: PushEmpty(object, string, float)
0x2b7: PushEmpty(object)
0x2b8: Call2 0x33e

0x2b9: Stack[-4] = Stack[-1]
0x2ba: Pop(1)
0x2bb: Stack[-2] = "pt_map_uprava_admin"
0x2bc: Stack[-1] = (int) 2
0x2bd: Call2 0x34f
...
0x2c1: Pop(0)
0x2c2: @@ ShowMap(Stack[-1])
0x2c3: Pop(1)
0x2c4: Return(); Pop(0)

0x2c5: PushEmpty()
0x2c6: Push("ood11Nude1")
0x2c7: Push((int) 1)
...
0x2d3: Pop(1)
0x2d4: Push("d11q01NudeGotoRastrel")
0x2d5: Push("pt_d11q01_msoldier")
0x2d6: Push((int) 1)
0x2d7: Push((int) 515482)
...
0x2dc: Pop(5)
0x2dd: Push("d11q01NudeGotoBlock")
0x2de: Push("pt_map_uprava_admin")
0x2df: Push((int) 1)
0x2e0: Push((int) 515305)
0x2e1: PushEmpty(float)
0x2e2: Call2 0x2b0

0x2e3: Pop(0)
0x2e4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2e5: Pop(5)
0x2e6: PushEmpty()
0x2e7: Call2 0x308
...
0x2ea: Stack[-2] = "quest_d11_01"
0x2eb: Stack[-1] = "init_soldiers"
0x2ec: Call2 0x2a4
...
0x309: Push((int) 194)
0x30a: Push((int) 1)
0x30b: Push((int) 515479)
0x30c: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x30d: Pop(3)
0x30e: PushEmpty(bool, object, int)
0x30f: Stack[-2] = Stack[-4]
0x310: Stack[-1] = (int) 192
0x311: Call2 0x322
...
0x316: @ GetDiaryRoot(Stack[-1])
0x317: Pop(0)
0x318: Pop(0); Push((bool) Stack[-1] == 0)
0x319: IF (Stack[-1] == 0) GOTO 0x31f; Pop(1)

0x31a: Push("Can't retrieve diary root")
0x31b: @ Trace(Stack[-1])
0x31c: Pop(1)
0x31d: Stack[-3] = (bool) 0
0x31e: Return(); Pop(2)
...
0x321: Stack[-1] = 0
0x322: PushEmpty(object, object, int, object, object, int)
0x323: PushEmpty(object)
0x324: Call2 0x315

0x325: Stack[-4] = Stack[-1]
0x326: Pop(1)
0x327: @@ Find(Stack[-7], Stack[-2])
0x328: Pop(0)
0x329: Pop(0); Push((bool) Stack[-2] == 0)
0x32a: IF (Stack[-1] == 0) GOTO 0x331; Pop(1)

0x32b: Push("Can't find diary parent with id: ")
0x32c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x32d: @ Trace(Stack[-1])
0x32e: Pop(1)
0x32f: Stack[-9] = (bool) 0
0x330: Return(); Pop(6)

0x331: @@ AddChild(Stack[-8])
0x332: Pop(0)
0x333: Push((int) 7)
0x334: @ SendWorldWndMessage(Stack[-1])
0x335: Pop(1)
...
0x33c: Stack[-2] = 0
0x33d: Stack[-3] = 0
0x33e: PushEmpty(object, object, object, object)
0x33f: @ GetMainOutdoorScene(Stack[-2])
0x340: Pop(0)
0x341: Pop(0); Push((bool) Stack[-2] == 0)
0x342: IF (Stack[-1] == 0) GOTO 0x349; Pop(1)

0x343: Push("Can't find main outdoor scene")
0x344: @ Trace(Stack[-1])
0x345: Pop(1)
0x346: Stack[-1] = 0
...
0x349: @@ GetMap(Stack[-1])
0x34a: Pop(0)
0x34b: Stack[-5] = Stack[-1]
0x34c: Return(); Pop(4)

0x34d: Stack[-1] = 0
0x34e: Stack[-2] = 0
0x34f: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
...
0x358: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x359: Pop(0)
0x35a: Pop(0); Push((bool) Stack[-1] == 0)
0x35b: IF (Stack[-1] == 0) GOTO 0x362; Pop(1)

0x35c: Push("Warning: outdoor scene locator ")
0x35d: Pop(1); Push(Stack[-1] + Stack[-11]);
0x35e: Push(" doesnt exist")
0x35f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x360: @ Trace(Stack[-1])
0x361: Pop(1)
0x362: @@ GetMap(Stack[-11])
0x363: Pop(0)
0x364: Pop(0); Push((bool) Stack[-11] == 0)
0x365: IF (Stack[-1] == 0) GOTO 0x36a; Pop(1)

0x366: Push("Can't find map")
0x367: @ Trace(Stack[-1])
0x368: Pop(1)
0x369: Return(); Pop(8)

0x36a: Push(CvectorIndex(Stack[-4], 0))
0x36b: Push(CvectorIndex(Stack[-5], 2))
0x36c: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x36d: Pop(2)
0x36e: Return(); Pop(8)
...
0x381: Stack[-1] = (int) 515596
0x382: Return(); Pop(0)

0x383: Stack[-1] = (int) 514839
0x384: Return(); Pop(0)

0x385: Stack[-1] = "ui/NPC_Citizen3.png"
0x386: Return(); Pop(0)

0x387: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x388: Return(); Pop(0)
