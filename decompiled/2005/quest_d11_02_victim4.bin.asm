...
0x16f: @ StopWorld()
0x170: Pop(0)
0x171: @ CameraTransit(Stack[-3], Stack[-5])
0x172: Pop(0)
0x173: Push(CvectorIndex(Stack[-4], 0))
0x174: Push(CvectorIndex(Stack[-5], 2))
0x175: @ Rotate(Stack[-2], Stack[-1])
0x176: Pop(2)
...
0x17c: Push("head")
0x17d: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x17e: Pop(1)
0x17f: Push(Stack[-1])
0x180: IF (Stack[-1] == 0) GOTO 0x184; Pop(1)

0x181: Push("head")
0x182: @ LookAsyncCamera(Stack[-1])
0x183: Pop(1)
0x184: @ CameraWaitForPlayFinish()
0x185: Pop(0)
0x186: @ ResumeWorld()
0x187: Pop(0)
0x188: Stack[-21] = (bool) 1
0x189: Return(); Pop(18)

0x18a: PushEmpty(bool, bool)
0x18b: @ CameraSwitchToNormal()
0x18c: Pop(0)
...
0x192: Push("head")
0x193: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x194: Pop(1)
0x195: Push(Stack[-1])
...
0x19b: PushEmpty(bool, float, float, bool, float, float)
0x19c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x19d: Pop(0)
0x19e: Push(Stack[-3])
0x19f: IF (Stack[-1] == 0) GOTO 0x1a6; Pop(1)

0x1a0: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1a1: Pop(0)
0x1a2: Push((bool) 0)
0x1a3: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1a4: Pop(1)
0x1a5: GOTO 0x1aa

0x1a6: Push("Can't find lsh animation : ")
0x1a7: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1a8: @ Trace(Stack[-1])
0x1a9: Pop(1)
0x1aa: Return(); Pop(6)

0x1ab: PushEmpty(bool, float, float, bool, float, float)
0x1ac: @ lshHasAnimation(Stack[-3], Stack[-8])
0x1ad: Pop(0)
0x1ae: Push(Stack[-3])
0x1af: IF (Stack[-1] == 0) GOTO 0x1b5; Pop(1)

0x1b0: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x1b1: Pop(0)
0x1b2: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x1b3: Pop(0)
0x1b4: GOTO 0x1b9

0x1b5: Push("Can't find lsh animation : ")
0x1b6: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1b7: @ Trace(Stack[-1])
0x1b8: Pop(1)
0x1b9: Return(); Pop(6)
...
0x1c8: Pop(0); Push(Stack[-3] | Stack[-3]);
0x1c9: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x1ca: Push((float)0.0)
0x1cb: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x1cc: IF (Stack[-1] == 0) GOTO 0x1cf; Pop(1)

0x1cd: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x1ce: Return(); Pop(2)

0x1cf: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x1d0: Return(); Pop(2)

0x1d1: PushEmpty(object, object)
0x1d2: @ FindActor(Stack[-1], Stack[-4])
0x1d3: Pop(0)
...
0x1d8: @ Trigger(Stack[-1], Stack[-3])
0x1d9: Pop(0)
0x1da: Stack[-5] = (bool) 1
0x1db: Return(); Pop(2)

0x1dc: Stack[-1] = 0
0x1dd: PushEmpty(bool, string, string)
0x1de: Stack[-2] = "quest_d11_02"
0x1df: Stack[-1] = "actor_unload"
0x1e0: Call2 0x1d1
...
0x1e4: Push("branch")
0x1e5: @ GetVariable(Stack[-1], Stack[-2])
0x1e6: Pop(1)
0x1e7: Push((int) 0)
...
0x1f4: Stack[-1] = (int) 515564
0x1f5: Return(); Pop(0)

0x1f6: Stack[-1] = (int) 503349
0x1f7: Return(); Pop(0)

0x1f8: Stack[-1] = "ui/NPC_Citizen2.png"
0x1f9: Return(); Pop(0)

0x1fa: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x1fb: Return(); Pop(0)
