...
0x1e7: PushEmpty(bool, float, float, bool, float, float)
0x1e8: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1e9: Pop(0)
0x1ea: Push(Stack[-3])
0x1eb: IF (Stack[-1] == 0) GOTO 0x1f2; Pop(1)

0x1ec: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1ed: Pop(0)
0x1ee: Push((bool) 0)
0x1ef: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1f0: Pop(1)
0x1f1: GOTO 0x1f6

0x1f2: Push("Can't find lsh animation : ")
0x1f3: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1f4: @ Trace(Stack[-1])
0x1f5: Pop(1)
0x1f6: Return(); Pop(6)

0x1f7: PushEmpty(bool, float, float, bool, float, float)
0x1f8: @ lshHasAnimation(Stack[-3], Stack[-8])
0x1f9: Pop(0)
0x1fa: Push(Stack[-3])
0x1fb: IF (Stack[-1] == 0) GOTO 0x201; Pop(1)

0x1fc: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x1fd: Pop(0)
0x1fe: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x1ff: Pop(0)
0x200: GOTO 0x205

0x201: Push("Can't find lsh animation : ")
0x202: Pop(1); Push(Stack[-1] + Stack[-9]);
0x203: @ Trace(Stack[-1])
0x204: Pop(1)
0x205: Return(); Pop(6)

0x206: PushEmpty(float, cvector, float, cvector)
0x207: @@ GetEyesHeight(Stack[-2])
0x208: Pop(0)
0x209: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x20a: Push(CvectorIndex(Stack[-1], 1))
0x20b: Stack[-1] = Stack[-3]
0x20c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x20d: Push("head")
0x20e: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x20f: Pop(1)
0x210: Return(); Pop(4)
...
0x22d: Stack[-1] = 0
0x22e: PushEmpty(string, string)
0x22f: Stack[-1] = "idle"
0x230: Push(Stack[-3])
0x231: IF (Stack[-1] == 0) GOTO 0x233; Pop(1)

0x232: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x233: Stack[-4] = Stack[-1]
0x234: Return(); Pop(2)

0x235: PushEmpty(int, bool, int, bool)
0x236: Stack[-2] = (int) 0
0x237: Push("all")
...
0x23b: Pop(1)
0x23c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x23d: Pop(2)
...
0x241: Push((int) 1)
0x242: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x243: GOTO 0x237

0x244: Stack[-5] = Stack[-2]
0x245: Return(); Pop(4)

0x246: Stack[-1] = (int) 518097
0x247: Return(); Pop(0)

0x248: Stack[-1] = (int) 518096
0x249: Return(); Pop(0)

0x24a: Stack[-1] = "ui/NPC_Citizen2.png"
0x24b: Return(); Pop(0)

0x24c: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x24d: Return(); Pop(0)
...
0x250: PushEmpty()
0x251: PushEmpty(bool, string, string)
0x252: Stack[-2] = "quest_d11_05"
0x253: Stack[-1] = "teleport"
0x254: Call2 0x222

0x255: Pop(3)
0x256: Return(); Pop(0)

0x257: PushEmpty(int, int)
0x258: Push("branch")
0x259: @ GetVariable(Stack[-1], Stack[-2])
0x25a: Pop(1)
0x25b: Push((int) 0)
