...
0x843: Stack[-3] = Stack[-7]
0x844: Stack[-2] = Stack[-6]
0x845: Stack[-1] = Stack[-5]
0x846: Call2 0x6f8
...
0x84b: Stack[-5] = Stack[-11]
0x84c: Stack[-4] = Stack[-10]
0x84d: Stack[-3] = Stack[-9]
0x84e: Stack[-2] = Stack[-7]
...
0x88b: Pop(0)
0x88c: @@ RemoveStationaryActor(Stack[-1])
0x88d: Pop(1)
0x88e: PushEmpty(object)
0x88f: Stack[-1] = Stack[-4]
...
0x8a0: Stack[-3] = Stack[-9]
0x8a1: Stack[-2] = Stack[-8]
0x8a2: Stack[-1] = Stack[-7]
0x8a3: Call2 0x7a5

0x8a4: Stack[-6] = Stack[-4]
0x8a5: Pop(4)
0x8a6: Push((int) 0)
