...
task_1_event_0(var_0_object, var_1_bool, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_2169(var_14_object); // 0xa6 NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2235(var_15_object); // 0x1be NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2235(var_15_object); // 0x209 NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2235(var_15_object); // 0x4b2 NEW_2
...
task_5_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2055(var_13_object); // 0x4f7 NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x842 PushV
	var_14_object = var_10_object; // 0x843 Mov
	var_15_int = var_11_int; // 0x844 Mov
	var_16_float = var_12_float; // 0x845 Mov
	func_1784(var_14_object, var_15_int, var_16_float); // 0x846 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x84a PushV
	var_16_object = var_10_object; // 0x84b Mov
	var_17_int = var_11_int; // 0x84c Mov
	var_18_float = var_12_float; // 0x84d Mov
	var_19_cvector = var_14_cvector; // 0x84e Mov
	var_20_cvector = var_15_cvector; // 0x84f Mov
	func_1852(var_18_float, var_19_cvector, var_20_cvector); // 0x850 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x853 PushV
	var_14_string = "health"; // 0x854 PushS
	var_15_bool = var_11_string == var_14_string; // 0x855 Eq
	if(var_15_bool == 0) goto Label_2143; // 0x856 JumpB
	var_16_string = "health"; // 0x857 PushS
	GetProperty(var_16_string, var_13_float); // 0x858 Func
	var_17_int = 0; // 0x85a PushI
	var_18_bool = var_13_float <= var_17_int; // 0x85b LE
	if(var_18_bool == 0) goto Label_2143; // 0x85c JumpB
	SignalDeath(var_10_object); // 0x85d Func
...
{
	var_11_object = Obj(); // 0x861 PushV
	var_11_object = var_10_object; // 0x862 Mov
	func_2105(var_11_object); // 0x863 NEW_2
...
func_2055(var_13_object)
{
	var_14_bool = 0; var_15_bool = 0; // 0x807 PushV
	IsPlayerActor(var_13_object, var_15_bool); // 0x808 Func
	var_16_bool = var_15_bool; // 0x80a Push
	if(var_16_bool == 0) goto Label_2063; // 0x80b JumpB
	var_17_string = "attack"; // 0x80c PushS
	PlayGlobalMusic(var_17_string); // 0x80d Func
...
func_2064()
{
	var_119_object = Obj(); var_120_object = Obj(); // 0x810 PushV
	GetScene(var_120_object); // 0x811 Func
	var_121_string = "battle"; // 0x813 PushS
	var_122_object = Obj(); // 0x814 PushV
	func_1934(var_122_object); // 0x815 NEW_2
	BroadcastMessage(var_121_string, var_122_object, var_120_object); // 0x817 Func
...
Label_1571:
	var_595_string = "armor"; // 0x623 PushS
	GetProperty(var_595_string, var_548_int); // 0x624 ObjFunc
}
...
Label_688:
	...
	var_659_string = "all"; // 0x2b2 PushS
	var_660_string = "fjump"; // 0x2b3 PushS
	PlayAnimation(var_659_string, var_660_string); // 0x2b4 Func
	WaitForAnimEnd(); // 0x2b6 Func
	func_1176(var_229_float); // 0x2b9 NEW_2
	var_661_cvector = CVector(0.0, 0.0, 0.0); // 0x2bb PushVec
	SetSpeed(var_661_cvector); // 0x2bc Func
	Stop(); // 0x2be Func
	StopAsync(); // 0x2c0 Func
	var_662_bool = 0; // 0x2c2 PushV
	func_1133(var_229_float, var_662_bool); // 0x2c3 NEW_2
	var_663_bool = var_662_bool == 0; // 0x2c5 Not
	if(var_663_bool == 0) goto Label_734; // 0x2c6 JumpB
	var_664_bool = 0; var_665_object = Obj(); // 0x2c7 PushV
	var_665_object = var_0_object; // 0x2c8 MovT
	func_1697(var_664_bool, var_665_object); // 0x2c9 NEW_2
	var_666_bool = var_664_bool == 0; // 0x2cb Not
	if(var_666_bool == 0) goto Label_718; // 0x2cc JumpB
...
Label_718:
	...
	var_667_float = var_207_float * var_207_float; // 0x2d4 Mult
	var_668_bool = var_226_float < var_667_float; // 0x2d5 LT
	if(var_668_bool == 0) goto Label_734; // 0x2d6 JumpB
	var_669_bool = 0; var_670_float = 0; // 0x2d7 PushV
	var_670_float = var_207_float; // 0x2d8 Mov
	func_835(var_229_float, var_669_bool, var_670_float); // 0x2d9 NEW_2
	var_671_bool = var_669_bool == 0; // 0x2db Not
	if(var_671_bool == 0) goto Label_734; // 0x2dc JumpB
	goto Label_744; // 0x2dd Jump
	
Label_735:
	var_672_bool = 0; var_673_float = 0; // 0x2df PushV
	var_673_float = var_207_float; // 0x2e0 Mov
	func_835(var_229_float, var_672_bool, var_673_float); // 0x2e1 NEW_2
	var_674_bool = var_672_bool == 0; // 0x2e3 Not
	if(var_674_bool == 0) goto Label_742; // 0x2e4 JumpB
...
{
	var_614_bool = 0; var_615_bool = 0; // 0x81b PushV
	var_616_string = "god_mode"; // 0x81c PushS
	GetVariable(var_616_string, var_615_bool); // 0x81d Func
	var_613_bool = var_615_bool; // 0x81f Mov
...
Label_51:
	...
	func_2088(var_29_int); // 0x34 NEW_2
...
Label_66:
	...
	func_2081(var_51_string, var_52_int); // 0x50 NEW_2
...
{
	var_12_object = Obj(); // 0x83a PushV
	var_12_object = var_11_object; // 0x83b Mov
	TaskCall(1); // 0x83c TaskCall
	func_128(var_12_object); // 0x83d NEW_2
	TaskReturn(); // 0x83e TaskReturn
...
{
	var_604_float = 0; var_605_float = 0; // 0x659 PushV
	var_606_bool = 0; var_607_object = Obj(); var_608_string = ""; // 0x65a PushV
	var_607_object = var_603_object; // 0x65b Mov
	var_608_string = "health"; // 0x65c MovS
	func_1518(var_606_bool, var_607_object, var_608_string); // 0x65d NEW_2
	var_609_bool = var_606_bool == 0; // 0x65f Not
	if(var_609_bool == 0) goto Label_1635; // 0x660 JumpB
	var_602_bool = 0; // 0x661 MovB
	return 2; // 0x662 Return
	
Label_1635:
	var_610_bool = 0; // 0x663 PushV
	var_610_bool = 0; // 0x664 MovB
	var_611_bool = 0; var_612_object = Obj(); // 0x665 PushV
	var_612_object = var_603_object; // 0x666 Mov
	func_1513(var_611_bool, var_612_object); // 0x667 NEW_2
	if(var_611_bool == 0) goto Label_1647; // 0x669 JumpB
	var_613_bool = 0; // 0x66a PushV
	func_2075(var_613_bool); // 0x66b NEW_2
	if(var_613_bool == 0) goto Label_1647; // 0x66d JumpB
	var_610_bool = 1; // 0x66e MovB
	
Label_1647:
	if(var_610_bool == 0) goto Label_1650; // 0x66f JumpB
	var_602_bool = 0; // 0x670 MovB
	return 2; // 0x671 Return
	
Label_1650:
	var_617_string = "health"; // 0x672 PushS
	GetProperty(var_617_string, var_605_float); // 0x673 ObjFunc
	var_618_float = 0.0; // 0x675 PushF
	var_602_bool = var_605_float <= var_618_float; // 0x676 LE2
...
{
	var_17_bool = 0; var_18_object = Obj(); // 0x867 PushV
	var_18_object = var_16_object; // 0x868 Mov
	func_1697(var_17_bool, var_18_object); // 0x869 NEW_2
	var_15_bool = var_17_bool; // 0x86a Mov
...
{
	var_52_object = Obj(); // 0x86e PushV
	var_52_object = var_51_object; // 0x86f Mov
	func_2182(var_52_object); // 0x870 NEW_2
...
{
	var_16_int = 0; var_17_int = 0; // 0x873 PushV
	var_18_string = "branch"; // 0x874 PushS
	GetVariable(var_18_string, var_17_int); // 0x875 Func
	var_15_int = var_17_int; // 0x877 Mov
...
{
	var_15_int = 0; // 0x87a PushV
	func_2163(var_15_int); // 0x87b NEW_2
	var_19_int = 1; // 0x87d PushI
	var_20_bool = var_15_int == var_19_int; // 0x87e Eq
	if(var_20_bool == 0) goto Label_2179; // 0x87f JumpB
	WorkWithCorpse(var_14_object); // 0x880 Func
...
Label_2179:
	Barter(var_14_object); // 0x883 Func
}
...
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x886 PushV
	GetScene(var_54_object); // 0x887 Func
	var_55_object = Obj(); // 0x889 PushV
	func_1934(var_55_object); // 0x88a NEW_2
	RemoveStationaryActor(var_55_object); // 0x88c ObjFunc
	var_58_object = Obj(); // 0x88e PushV
	var_58_object = var_52_object; // 0x88f Mov
	TaskCall(6); // 0x890 TaskCall
	func_1472(var_58_object); // 0x891 NEW_2
	TaskReturn(); // 0x892 TaskReturn
...
func_2198(var_140_cvector, var_141_cvector, var_142_cvector, var_143_float)
{
	var_144_cvector = CVector(0,0,0); var_145_float = 0; var_146_float = 0; var_147_float = 0; var_148_float = 0; var_149_float = 0; var_150_cvector = CVector(0,0,0); var_151_float = 0; var_152_float = 0; var_153_float = 0; var_154_float = 0; var_155_float = 0; // 0x896 PushV
	var_150_cvector = var_142_cvector - var_141_cvector; // 0x897 Sub2
	var_151_float = 250000; // 0x898 MovI
	var_156_float = GetByIndex(var_150_cvector, 1); // 0x899 PushE
	var_157_int = 1000; // 0x89a PushI
	var_158_float = var_156_float * var_157_int; // 0x89b Mult
	var_159_float = var_143_float * var_143_float; // 0x89c Mult
	var_152_float = var_158_float - var_159_float; // 0x89d Sub2
	var_153_float = var_150_cvector | var_150_cvector; // 0x89e Or2
	var_160_float = 0; var_161_float = 0; var_162_float = 0; var_163_float = 0; // 0x89f PushV
	var_161_float = var_151_float; // 0x8a0 Mov
	var_162_float = var_152_float; // 0x8a1 Mov
	var_163_float = var_153_float; // 0x8a2 Mov
	func_1957(var_160_float, var_161_float, var_162_float, var_163_float); // 0x8a3 NEW_2
	var_154_float = var_160_float; // 0x8a4 Mov
	var_168_int = 0; // 0x8a6 PushI
	var_169_bool = var_154_float < var_168_int; // 0x8a7 LT
	if(var_169_bool == 0) goto Label_2219; // 0x8a8 JumpB
	var_155_float = 1; // 0x8a9 MovI
	goto Label_2227; // 0x8aa Jump
	
Label_2227:
	var_170_cvector = CVector(0.0, 500.0, 0.0); // 0x8b3 PushVec
	var_171_float = var_170_cvector * var_155_float; // 0x8b4 Mult
	var_172_float = var_171_float * var_155_float; // 0x8b5 Mult
	var_173_int = var_150_cvector + var_172_float; // 0x8b6 Add
	var_140_cvector = var_173_int / var_173_int; // 0x8b7 Div2
	return 12; // 0x8b8 Return
	
Label_2219:
	var_174_float = 0; var_175_float = 0; var_176_float = 0; var_177_float = 0; var_178_float = 0; // 0x8ab PushV
	var_175_float = var_151_float; // 0x8ac Mov
	var_176_float = var_152_float; // 0x8ad Mov
	var_177_float = var_153_float; // 0x8ae Mov
	var_178_float = sqrt(var_154_float); // 0x8af Sqrt2
	func_1964(var_175_float, var_176_float, var_177_float, var_178_float); // 0x8b0 NEW_2
	var_155_float = sqrt(var_174_float); // 0x8b2 Sqrt2
}
...
func_1176(var_0_object)
{
	...
	func_2055(var_267_object); // 0x49a NEW_2
...
func_2235(var_13_bool)
{
	var_13_bool = 0; // 0x8bc MovB
...
func_1216(var_2_object, var_270_bool, var_271_object, var_272_float, var_273_float, var_274_bool, var_275_bool)
{
	...
	func_2055(var_283_object); // 0x4c3 NEW_2
...
func_796(var_0_object, var_521_float, var_522_int)
{
	...
	var_596_int = 0; // 0x337 PushV
	func_489(var_596_int); // 0x338 NEW_2
	ReportHit(var_0_object, var_596_int, var_528_float, var_527_float); // 0x33a Func
	var_597_object = Obj(); var_598_float = 0; // 0x33c PushV
	var_597_object = var_526_object; // 0x33d Mov
	var_598_float = var_528_float; // 0x33e Mov
	func_491(var_597_object, var_598_float); // 0x33f NEW_2
...
func_292(var_59_bool, var_60_object, var_82_bool, var_683_object)
{
...
Label_321:
	var_681_bool = 0; var_682_object = Obj(); // 0x141 PushV
	var_682_object = var_60_object; // 0x142 Mov
	TaskCall(4); // 0x143 TaskCall
	func_455(var_681_bool, var_682_object); // 0x144 NEW_2
	TaskReturn(); // 0x145 TaskReturn
	var_59_bool = var_683_object; // 0x146 Mov
...
Label_871:
	...
	var_620_string = "all"; // 0x36c PushS
	var_621_string = "attack_middle"; // 0x36d PushS
	var_622_int = var_621_string + var_494_int; // 0x36e Add
	HasAnimation(var_495_bool, var_620_string, var_622_int); // 0x36f Func
	var_623_bool = var_495_bool; // 0x371 Push
	if(var_623_bool == 0) goto Label_952; // 0x372 JumpB
	func_2064(); // 0x374 NEW_2
	var_624_string = "all"; // 0x376 PushS
	var_625_string = "attack_middle"; // 0x377 PushS
	var_626_int = var_625_string + var_494_int; // 0x378 Add
	PlayAnimation(var_624_string, var_626_int); // 0x379 Func
	WaitForAnimEnd(); // 0x37b Func
	func_1176(var_497_string); // 0x37e NEW_2
	var_627_bool = 0; var_628_object = Obj(); // 0x380 PushV
	var_628_object = var_0_object; // 0x381 MovT
	func_1697(var_627_bool, var_628_object); // 0x382 NEW_2
	var_629_bool = var_627_bool == 0; // 0x384 Not
	if(var_629_bool == 0) goto Label_906; // 0x385 JumpB
	StopAsync(); // 0x386 Func
	var_488_bool = 0; // 0x388 MovB
	return 8; // 0x389 Return
	
Label_906:
	var_630_float = 0; var_631_int = 0; // 0x38a PushV
	var_630_float = var_489_float; // 0x38b Mov
	var_631_int = var_494_int; // 0x38c Mov
	func_796(var_497_string, var_630_float, var_631_int); // 0x38d NEW_2
	var_496_int = 1; // 0x38f MovI
	
Label_912:
	var_632_string = "attack_middle"; // 0x390 PushS
	var_633_int = var_632_string + var_494_int; // 0x391 Add
	var_634_string = "_"; // 0x392 PushS
	var_635_int = var_633_int + var_634_string; // 0x393 Add
	var_497_string = var_635_int + var_496_int; // 0x394 Add2
	var_636_string = "all"; // 0x395 PushS
	HasAnimation(var_495_bool, var_636_string, var_497_string); // 0x396 Func
	var_637_bool = var_495_bool == 0; // 0x398 Not
	if(var_637_bool == 0) goto Label_923; // 0x399 JumpB
	goto Label_952; // 0x39a Jump
	
Label_952:
	var_638_bool = 0; // 0x3b8 PushB
	SetAttackState(var_638_bool); // 0x3b9 Func
	var_639_string = "all"; // 0x3bb PushS
	var_640_string = "attack_end"; // 0x3bc PushS
	var_641_int = var_640_string + var_494_int; // 0x3bd Add
	PlayAnimation(var_639_string, var_641_int); // 0x3be Func
	var_642_bool = 0; // 0x3c0 PushV
	func_1186(var_642_bool); // 0x3c1 NEW_2
	if(var_642_bool == 0) goto Label_970; // 0x3c3 JumpB
	var_643_bool = 0; var_644_float = 0; // 0x3c4 PushV
	var_644_float = 0.45; // 0x3c5 MovF
	func_974(var_643_bool, var_644_float); // 0x3c6 NEW_2
...
Label_923:
	func_2064(); // 0x39c NEW_2
	var_652_string = "all"; // 0x39e PushS
	PlayAnimation(var_652_string, var_497_string); // 0x39f Func
	WaitForAnimEnd(); // 0x3a1 Func
	func_1176(var_497_string); // 0x3a4 NEW_2
	var_653_bool = 0; var_654_object = Obj(); // 0x3a6 PushV
	var_654_object = var_0_object; // 0x3a7 MovT
	func_1697(var_653_bool, var_654_object); // 0x3a8 NEW_2
	var_655_bool = var_653_bool == 0; // 0x3aa Not
	if(var_655_bool == 0) goto Label_944; // 0x3ab JumpB
	StopAsync(); // 0x3ac Func
	var_488_bool = 0; // 0x3ae MovB
	return 8; // 0x3af Return
	
Label_944:
	var_656_float = 0; var_657_int = 0; // 0x3b0 PushV
	var_656_float = var_489_float; // 0x3b1 Mov
	var_657_int = var_494_int; // 0x3b2 Mov
	func_796(var_497_string, var_656_float, var_657_int); // 0x3b3 NEW_2
	var_658_int = 1; // 0x3b5 PushI
	var_496_int = var_496_int + var_658_int; // 0x3b6 Add2
...
func_329(var_0_object, var_80_bool, var_81_object, var_198_object)
{
	...
	func_2055(var_97_object); // 0x14c NEW_2
...
Label_368:
	...
	func_2198(var_140_cvector, var_141_cvector, var_142_cvector, var_143_float); // 0x194 NEW_2
...
Label_1473:
	...
	var_689_int = 1; // 0x5c7 PushI
	Sleep(var_689_int); // 0x5c8 Func
...
func_455(var_196_bool, var_197_object)
{
	...
	var_675_bool = 0; // 0x1d1 PushV
	var_675_bool = 0; // 0x1d2 MovB
	var_676_bool = GlobalVars[0]; // 0x1d3 PushGE
	if(var_676_bool == 0) goto Label_472; // 0x1d4 JumpB
	var_677_int = var_3_int; // 0x1d5 PushT
	if(var_677_int == 0) goto Label_472; // 0x1d6 JumpB
	var_675_bool = 1; // 0x1d7 MovB
	
Label_472:
	if(var_675_bool == 0) goto Label_479; // 0x1d8 JumpB
	var_678_string = "all"; // 0x1d9 PushS
	var_679_string = "attack_off"; // 0x1da PushS
	PlayAnimation(var_678_string, var_679_string); // 0x1db Func
	WaitForAnimEnd(); // 0x1dd Func
	
Label_479:
	var_680_bool = GlobalVars[0]; // 0x1df PushGE
	var_196_bool = var_680_bool; // 0x1e0 Mov
...
func_974(var_643_bool, var_644_float)
{
	var_645_float = 0; var_646_bool = 0; var_647_float = 0; var_648_bool = 0; // 0x3ce PushV
	rand(var_647_float); // 0x3cf Func
	var_649_bool = var_647_float < var_644_float; // 0x3d1 LT
	if(var_649_bool == 0) goto Label_994; // 0x3d2 JumpB
	
Label_979:
	IsAnimationPlaying(var_648_bool); // 0x3d3 Func
	var_650_bool = var_648_bool == 0; // 0x3d5 Not
	if(var_650_bool == 0) goto Label_984; // 0x3d6 JumpB
...
Label_999:
	var_643_bool = 0; // 0x3e7 MovB
	return 4; // 0x3e8 Return
	
Label_984:
	var_651_bool = 0; // 0x3d8 PushV
	func_1072(var_651_bool); // 0x3d9 NEW_2
	if(var_651_bool == 0) goto Label_990; // 0x3db JumpB
	var_643_bool = 1; // 0x3dc MovB
...
Label_994:
	...
	func_1176(var_648_bool); // 0x3e5 NEW_2
}
...
Label_2021:
	...
	func_2045(var_24_float); // 0x7e7 NEW_2
...
{
	var_599_bool = 0; // 0x1ec PushV
	var_599_bool = 0; // 0x1ed MovB
	var_600_int = 0; // 0x1ee PushI
	var_601_bool = var_598_float > var_600_int; // 0x1ef GT
	if(var_601_bool == 0) goto Label_503; // 0x1f0 JumpB
	var_602_bool = 0; var_603_object = Obj(); // 0x1f1 PushV
	var_603_object = var_597_object; // 0x1f2 Mov
	func_1625(var_602_bool, var_603_object); // 0x1f3 NEW_2
	if(var_602_bool == 0) goto Label_503; // 0x1f5 JumpB
	var_599_bool = 1; // 0x1f6 MovB
	
Label_503:
	if(var_599_bool == 0) goto Label_510; // 0x1f7 JumpB
	var_619_bool = GlobalVars[0]; // 0x1f8 PushGE
	var_619_bool = 1; // 0x1f9 MovB
	GlobalVars[0] = var_619_bool; // 0x1fa PopGE
	func_972(var_598_float); // 0x1fc NEW_2
...
func_2035(var_591_float)
{
	...
	var_594_int = 15; // 0x7f8 PushI
	SendWorldWndMessage(var_594_int, var_593_object); // 0x7f9 Func
...
{
	var_25_object = Obj(); var_26_object = Obj(); // 0x7fd PushV
	CreateFloatVector(var_26_object); // 0x7fe Func
	add(var_24_float); // 0x800 ObjFunc
	var_27_int = 16; // 0x802 PushI
	SendWorldWndMessage(var_27_int, var_26_object); // 0x803 Func
