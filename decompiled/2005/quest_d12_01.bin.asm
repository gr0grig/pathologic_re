...
0x4d6: Push("gameover_termit_chudo.xml")
0x4d7: @ GameOver(Stack[-1])
0x4d8: Pop(1)
0x4d9: GOTO 0x4dd

0x4da: Push("gameover_termit.xml")
...
0x4e3: IF (Stack[-1] == 0) GOTO 0x4f1; Pop(1)
...
0x4e9: Push("gameover_utopist_chudo.xml")
0x4ea: @ GameOver(Stack[-1])
0x4eb: Pop(1)
0x4ec: GOTO 0x4f0

0x4ed: Push("gameover_utopist.xml")
0x4ee: @ GameOver(Stack[-1])
0x4ef: Pop(1)
0x4f0: GOTO 0x510
...
0x4f6: IF (Stack[-1] == 0) GOTO 0x504; Pop(1)

0x4f7: Push("fin_smiren")
0x4f8: @ Trace(Stack[-1])
0x4f9: Pop(1)
0x4fa: Push(Stack[-1])
0x4fb: IF (Stack[-1] == 0) GOTO 0x500; Pop(1)

0x4fc: Push("gameover_smirennik_chudo.xml")
0x4fd: @ GameOver(Stack[-1])
0x4fe: Pop(1)
0x4ff: GOTO 0x503

0x500: Push("gameover_smirennik.xml")
0x501: @ GameOver(Stack[-1])
0x502: Pop(1)
0x503: GOTO 0x510
...
0x509: Push("gameover_beda_chudo.xml")
0x50a: @ GameOver(Stack[-1])
0x50b: Pop(1)
0x50c: GOTO 0x510

0x50d: Push("gameover_beda.xml")
0x50e: @ GameOver(Stack[-1])
0x50f: Pop(1)
0x510: Return(); Pop(18)

0x511: PushEmpty(int, int)
0x512: Push("d12q01KlaraInSobor")
0x513: @ GetVariable(Stack[-1], Stack[-2])
0x514: Pop(1)
0x515: Push((int) 0)
0x516: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x517: Return(); Pop(2)

0x518: PushEmpty(int, int)
0x519: Push("d12q01BurahInSobor")
0x51a: @ GetVariable(Stack[-1], Stack[-2])
0x51b: Pop(1)
0x51c: Push((int) 0)
0x51d: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x51e: Return(); Pop(2)

0x51f: PushEmpty(bool, bool)
0x520: @ IsOverrideActive(Stack[-1])
0x521: Pop(0)
0x522: Stack[-3] = !Stack[-1]; Pop(0);
0x523: Return(); Pop(2)

0x524: PushEmpty(object, object)
0x525: Push("warehouse_rubin")
0x526: @ GetSceneByName(Stack[-2], Stack[-1])
0x527: Pop(1)
0x528: Push("rubin")
0x529: @ Trigger(Stack[-2], Stack[-1])
0x52a: Pop(1)
0x52b: PushEmpty(string, bool)
0x52c: Stack[-2] = "warehouse_rubin@door1"
