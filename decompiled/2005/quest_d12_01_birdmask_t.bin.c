task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_924(); // 0x105 NEW_2
	
Label_263:
	var_20_int = 37188; // 0x107 PushI
	...
	func_930(); // 0x10d NEW_2
	
Label_271:
	var_30_int = 37172; // 0x10f PushI
	...
	var_162_int = 535490; // 0x11c PushI
	...
	func_959(var_164_object); // 0x123 NEW_2
	if(var_163_bool == 0) goto Label_299; // 0x125 JumpB
	var_171_int = 535491; // 0x126 PushI
	var_172_int = 37174; // 0x127 PushI
	var_173_int = 37173; // 0x128 PushI
	AddReply(var_171_int, var_172_int, var_173_int); // 0x129 TObjFunc
	
Label_299:
	var_174_int = 535504; // 0x12b PushI
	var_175_int = -1; // 0x12c PushI
	var_176_int = 37186; // 0x12d PushI
...
Label_305:
	...
	func_971(var_178_object); // 0x133 NEW_2
	...
	var_185_int = 541615; // 0x13b PushI
	SetMessage(var_185_int); // 0x13c TObjFunc
	ClearReplies(); // 0x13e TObjFunc
	var_186_int = 541616; // 0x140 PushI
	var_187_int = 43789; // 0x141 PushI
	var_188_int = 43788; // 0x142 PushI
	AddReply(var_186_int, var_187_int, var_188_int); // 0x143 TObjFunc
	var_189_int = 541620; // 0x145 PushI
	var_190_int = -1; // 0x146 PushI
	var_191_int = 43792; // 0x147 PushI
...
Label_331:
	...
	func_971(var_195_object); // 0x151 NEW_2
	...
	func_937(var_196_bool, var_197_object); // 0x156 NEW_2
	if(var_196_bool == 0) goto Label_346; // 0x158 JumpB
	var_193_bool = 1; // 0x159 MovB
	
Label_346:
	if(var_193_bool == 0) goto Label_353; // 0x15a JumpB
	var_198_bool = 0; var_199_object = Obj(); // 0x15b PushV
	var_199_object = var_1_object; // 0x15c MovT
	func_947(var_199_object); // 0x15d NEW_2
	if(var_198_bool == 0) goto Label_353; // 0x15f JumpB
...
Label_353:
	...
	var_209_int = 535505; // 0x16b PushI
	SetMessage(var_209_int); // 0x16c TObjFunc
	ClearReplies(); // 0x16e TObjFunc
	var_210_int = 535506; // 0x170 PushI
	var_211_int = -1; // 0x171 PushI
	var_212_int = 37188; // 0x172 PushI
...
Label_412:
	...
	var_231_int = 535492; // 0x1a3 PushI
	SetMessage(var_231_int); // 0x1a4 TObjFunc
	ClearReplies(); // 0x1a6 TObjFunc
	var_232_int = 535493; // 0x1a8 PushI
	var_233_int = 37176; // 0x1a9 PushI
	var_234_int = 37175; // 0x1aa PushI
	AddReply(var_232_int, var_233_int, var_234_int); // 0x1ab TObjFunc
	var_235_int = 535497; // 0x1ad PushI
	var_236_int = 37180; // 0x1ae PushI
	var_237_int = 37179; // 0x1af PushI
	AddReply(var_235_int, var_236_int, var_237_int); // 0x1b0 TObjFunc
	return 0; // 0x1b2 Return
	
Label_435:
	var_238_int = 37180; // 0x1b3 PushI
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object)
{
	...
	var_13_string = "d12q01TheaterIsVisited"; // 0x212 PushS
...
func_918()
{
	var_288_string = "ood12BirdmaskT"; // 0x397 PushS
...
func_924()
{
	var_18_string = "ood12BirdmaskT2"; // 0x39d PushS
	var_19_int = 1; // 0x39e PushI
	SetVariable(var_18_string, var_19_int); // 0x39f Func
...
func_930()
{
	var_24_bool = 0; var_25_string = ""; var_26_string = ""; // 0x3a3 PushV
	var_25_string = "quest_d12_01"; // 0x3a4 MovS
	var_26_string = "init_theater"; // 0x3a5 MovS
	func_872(var_24_bool, var_25_string, var_26_string); // 0x3a6 NEW_2
...
func_947(var_280_bool)
{
	var_282_int = 0; var_283_string = ""; // 0x3b4 PushV
	var_283_string = "ood12BirdmaskT"; // 0x3b5 MovS
	func_867(var_282_int, var_283_string); // 0x3b6 NEW_2
	var_284_int = 0; // 0x3b8 PushI
	var_285_bool = var_282_int == var_284_int; // 0x3b9 Eq
	if(var_285_bool == 0) goto Label_957; // 0x3ba JumpB
	var_280_bool = 1; // 0x3bb MovB
	return 0; // 0x3bc Return
	
Label_957:
	var_280_bool = 0; // 0x3bd MovB
...
func_959(var_227_bool)
{
	var_229_int = 0; var_230_string = ""; // 0x3c0 PushV
	var_230_string = "ood12BirdmaskT2"; // 0x3c1 MovS
	func_867(var_229_int, var_230_string); // 0x3c2 NEW_2
	var_233_int = 0; // 0x3c4 PushI
	var_234_bool = var_229_int == var_233_int; // 0x3c5 Eq
	if(var_234_bool == 0) goto Label_969; // 0x3c6 JumpB
	var_227_bool = 1; // 0x3c7 MovB
	return 0; // 0x3c8 Return
	
Label_969:
	var_227_bool = 0; // 0x3c9 MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_89_object, var_90_object)
{
	...
	func_959(var_228_object); // 0x61 NEW_2
	if(var_227_bool == 0) goto Label_105; // 0x63 JumpB
	var_235_int = 535491; // 0x64 PushI
	var_236_int = 37174; // 0x65 PushI
	var_237_int = 37173; // 0x66 PushI
	AddReply(var_235_int, var_236_int, var_237_int); // 0x67 TObjFunc
	
Label_105:
	var_238_int = 535504; // 0x69 PushI
	var_239_int = -1; // 0x6a PushI
	var_240_int = 37186; // 0x6b PushI
...
Label_111:
	...
	func_971(var_260_object); // 0x71 NEW_2
	...
	var_267_int = 541615; // 0x79 PushI
	SetMessage(var_267_int); // 0x7a TObjFunc
	ClearReplies(); // 0x7c TObjFunc
	var_268_int = 541616; // 0x7e PushI
	var_269_int = 43789; // 0x7f PushI
	var_270_int = 43788; // 0x80 PushI
	AddReply(var_268_int, var_269_int, var_270_int); // 0x81 TObjFunc
	var_271_int = 541620; // 0x83 PushI
	var_272_int = -1; // 0x84 PushI
	var_273_int = 43792; // 0x85 PushI
...
Label_137:
	...
	func_971(var_277_object); // 0x8f NEW_2
	...
	func_937(var_278_bool, var_279_object); // 0x94 NEW_2
	if(var_278_bool == 0) goto Label_152; // 0x96 JumpB
	var_275_bool = 1; // 0x97 MovB
	
Label_152:
	if(var_275_bool == 0) goto Label_159; // 0x98 JumpB
	var_280_bool = 0; var_281_object = Obj(); // 0x99 PushV
	var_281_object = var_1_object; // 0x9a MovT
	func_947(var_281_object); // 0x9b NEW_2
	if(var_280_bool == 0) goto Label_159; // 0x9d JumpB
...
Label_159:
	...
	var_291_int = 535505; // 0xa9 PushI
	SetMessage(var_291_int); // 0xaa TObjFunc
	ClearReplies(); // 0xac TObjFunc
	var_292_int = 535506; // 0xae PushI
	var_293_int = -1; // 0xaf PushI
	var_294_int = 37188; // 0xb0 PushI
...
Label_180:
	...
	var_296_int = 535507; // 0xb8 PushI
	SetMessage(var_296_int); // 0xb9 TObjFunc
	ClearReplies(); // 0xbb TObjFunc
	var_297_int = 535508; // 0xbd PushI
	var_298_int = -1; // 0xbe PushI
	var_299_int = 37190; // 0xbf PushI
	AddReply(var_297_int, var_298_int, var_299_int); // 0xc0 TObjFunc
	goto Label_197; // 0xc2 Jump
}


func_971(var_259_bool)
{
	var_261_int = 0; var_262_string = ""; // 0x3cc PushV
	var_262_string = "d12q01ChildsAreVisited"; // 0x3cd MovS
	func_867(var_261_int, var_262_string); // 0x3ce NEW_2
	var_263_int = 0; // 0x3d0 PushI
	var_264_bool = var_261_int != var_263_int; // 0x3d1 Neq
	if(var_264_bool == 0) goto Label_981; // 0x3d2 JumpB
	var_259_bool = 1; // 0x3d3 MovB
	return 0; // 0x3d4 Return
	
Label_981:
	var_259_bool = 0; // 0x3d5 MovB
