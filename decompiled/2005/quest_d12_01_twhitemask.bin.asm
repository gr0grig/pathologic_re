...
0x32e: Pop(0)
0x32f: Push(CvectorIndex(Stack[-4], 0))
0x330: Push(CvectorIndex(Stack[-5], 2))
...
0x372: Pop(1); Push(Stack[-1] + Stack[-9]);
0x373: @ Trace(Stack[-1])
0x374: Pop(1)
0x375: Return(); Pop(6)
...
0x37a: Push(CvectorIndex(Stack[-1], 1))
0x37b: Stack[-1] = Stack[-3]
0x37c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x37d: Push("head")
...
0x38f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x390: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x396: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x397: Return(); Pop(2)
...
0x3b2: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
