...
0x1f4: PushEmpty(bool, float, float, bool, float, float)
0x1f5: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1f6: Pop(0)
0x1f7: Push(Stack[-3])
0x1f8: IF (Stack[-1] == 0) GOTO 0x1ff; Pop(1)

0x1f9: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1fa: Pop(0)
0x1fb: Push((bool) 0)
0x1fc: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1fd: Pop(1)
0x1fe: GOTO 0x203

0x1ff: Push("Can't find lsh animation : ")
0x200: Pop(1); Push(Stack[-1] + Stack[-8]);
0x201: @ Trace(Stack[-1])
0x202: Pop(1)
0x203: Return(); Pop(6)

0x204: PushEmpty(bool, float, float, bool, float, float)
0x205: @ lshHasAnimation(Stack[-3], Stack[-8])
0x206: Pop(0)
0x207: Push(Stack[-3])
0x208: IF (Stack[-1] == 0) GOTO 0x20e; Pop(1)

0x209: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x20a: Pop(0)
0x20b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x20c: Pop(0)
0x20d: GOTO 0x212

0x20e: Push("Can't find lsh animation : ")
0x20f: Pop(1); Push(Stack[-1] + Stack[-9]);
0x210: @ Trace(Stack[-1])
0x211: Pop(1)
0x212: Return(); Pop(6)
...
0x248: Stack[-1] = (int) 515569
0x249: Return(); Pop(0)

0x24a: Stack[-1] = (int) 503354
0x24b: Return(); Pop(0)

0x24c: Stack[-1] = "ui/NPC_wmask.png"
0x24d: Return(); Pop(0)

0x24e: Stack[-1] = "ui/NPC_wmask_b.png"
0x24f: Return(); Pop(0)
...
0x253: Push("branch")
0x254: @ GetVariable(Stack[-1], Stack[-2])
0x255: Pop(1)
0x256: Push((int) 0)
