...
Label_237:
	...
	func_2190(var_75_bool); // 0xef NEW_2
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool)
{
	...
	func_2083(var_19_bool, var_20_string, var_21_string); // 0x10d NEW_2
...
Label_292:
	var_527_string = ""; // 0x124 PushV
	var_527_string = var_15_bool; // 0x125 Mov
	func_338(var_527_string); // 0x126 NEW_2
}
...
Label_360:
	...
	func_2039(var_18_object); // 0x16a NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_2095(var_18_object); // 0x4a6 NEW_2
...
Label_1219:
	...
	func_1980(var_19_object); // 0x4c7 NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object)
{
	...
	func_2169(var_19_object); // 0x585 NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x899 PushV
	var_19_object = var_15_object; // 0x89a Mov
	var_20_int = var_16_int; // 0x89b Mov
	var_21_float = var_17_float; // 0x89c Mov
	func_1766(var_19_object, var_20_int, var_21_float); // 0x89d NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x8a1 PushV
	var_21_object = var_15_object; // 0x8a2 Mov
	var_22_int = var_16_int; // 0x8a3 Mov
	var_23_float = var_17_float; // 0x8a4 Mov
	var_24_cvector = var_19_cvector; // 0x8a5 Mov
	var_25_cvector = var_20_cvector; // 0x8a6 Mov
	func_1834(var_23_float, var_24_cvector, var_25_cvector); // 0x8a7 NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x8aa PushV
	var_19_string = "health"; // 0x8ab PushS
	var_20_bool = var_16_string == var_19_string; // 0x8ac Eq
	if(var_20_bool == 0) goto Label_2230; // 0x8ad JumpB
	var_21_string = "health"; // 0x8ae PushS
	GetProperty(var_21_string, var_18_float); // 0x8af Func
	var_22_int = 0; // 0x8b1 PushI
	var_23_bool = var_18_float <= var_22_int; // 0x8b2 LE
	if(var_23_bool == 0) goto Label_2230; // 0x8b3 JumpB
	SignalDeath(var_15_object); // 0x8b4 Func
...
{
	var_16_object = Obj(); // 0x8b8 PushV
	var_16_object = var_15_object; // 0x8b9 Mov
	func_2192(var_16_object); // 0x8ba NEW_2
...
{
	var_15_object = Obj(); // 0x8bd PushV
	func_2039(var_15_object); // 0x8be NEW_2
	RemoveActor(var_15_object); // 0x8c0 Func
	Hold(); // 0x8c2 Func
...
func_2055(var_445_float, var_446_float, var_447_float)
{
	var_450_bool = var_446_float < var_447_float; // 0x808 LT
	if(var_450_bool == 0) goto Label_2060; // 0x809 JumpB
	var_445_float = var_446_float; // 0x80a Mov
...
Label_2060:
	var_445_float = var_447_float; // 0x80c Mov
}


func_2062(var_455_float, var_456_float, var_457_float, var_458_float)
{
	var_459_bool = var_456_float < var_457_float; // 0x80f LT
	if(var_459_bool == 0) goto Label_2067; // 0x810 JumpB
	var_455_float = var_457_float; // 0x811 Mov
	return 0; // 0x812 Return
	
Label_2067:
	var_460_bool = var_456_float > var_458_float; // 0x813 GT
	if(var_460_bool == 0) goto Label_2071; // 0x814 JumpB
	var_455_float = var_458_float; // 0x815 Mov
	return 0; // 0x816 Return
	
Label_2071:
	var_455_float = var_456_float; // 0x817 Mov
...
func_2073(var_463_float)
{
	var_464_object = Obj(); var_465_object = Obj(); // 0x819 PushV
	CreateFloatVector(var_465_object); // 0x81a Func
	add(var_463_float); // 0x81c ObjFunc
	var_466_int = 15; // 0x81e PushI
	SendWorldWndMessage(var_466_int, var_465_object); // 0x81f Func
...
func_2083(var_19_bool, var_20_string, var_21_string)
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x823 PushV
	FindActor(var_23_object, var_20_string); // 0x824 Func
	var_24_bool = var_23_object == 0; // 0x826 NullEq
	if(var_24_bool == 0) goto Label_2090; // 0x827 JumpB
	var_19_bool = 0; // 0x828 MovB
	return 2; // 0x829 Return
	
Label_2090:
	Trigger(var_23_object, var_21_string); // 0x82a Func
	var_19_bool = 1; // 0x82c MovB
...
func_2095(var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0x82f PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x830 Func
	var_21_bool = var_20_bool; // 0x832 Push
	if(var_21_bool == 0) goto Label_2103; // 0x833 JumpB
	var_22_string = "attack"; // 0x834 PushS
	PlayGlobalMusic(var_22_string); // 0x835 Func
...
Label_1623:
	...
	func_2055(var_445_float, var_446_float, var_447_float); // 0x65c NEW_2
	...
	func_2062(var_455_float, var_456_float, var_457_float, var_458_float); // 0x66a NEW_2
	...
	func_2073(var_463_float); // 0x675 NEW_2
...
Label_1603:
	var_467_string = "armor"; // 0x643 PushS
	GetProperty(var_467_string, var_420_int); // 0x644 ObjFunc
}


func_2104()
{
	var_368_object = Obj(); var_369_object = Obj(); // 0x838 PushV
	GetScene(var_369_object); // 0x839 Func
	var_370_string = "battle"; // 0x83b PushS
	var_371_object = Obj(); // 0x83c PushV
	func_2039(var_371_object); // 0x83d NEW_2
	BroadcastMessage(var_370_string, var_371_object, var_369_object); // 0x83f Func
...
func_2115(var_46_string, var_47_int)
{
	var_48_string = ""; var_49_string = ""; // 0x843 PushV
	var_49_string = "idle"; // 0x844 MovS
	var_50_int = var_47_int; // 0x845 Push
	if(var_50_int == 0) goto Label_2120; // 0x846 JumpB
	var_49_string = var_49_string + var_47_int; // 0x847 Add2
	
Label_2120:
	var_46_string = var_49_string; // 0x848 Mov
...
Label_111:
	...
	func_1949(var_120_string); // 0x71 NEW_2
...
func_2122(var_40_int)
{
	var_41_int = 0; var_42_bool = 0; var_43_int = 0; var_44_bool = 0; // 0x84a PushV
	var_43_int = 0; // 0x84b MovI
	
Label_2124:
	var_45_string = "all"; // 0x84c PushS
	var_46_string = ""; var_47_int = 0; // 0x84d PushV
	var_47_int = var_43_int; // 0x84e Mov
	func_2115(var_46_string, var_47_int); // 0x84f NEW_2
	HasAnimation(var_44_bool, var_45_string, var_46_string); // 0x851 Func
	var_51_bool = var_44_bool == 0; // 0x853 Not
	if(var_51_bool == 0) goto Label_2134; // 0x854 JumpB
	goto Label_2137; // 0x855 Jump
	
Label_2137:
	var_40_int = var_43_int; // 0x859 Mov
	return 4; // 0x85a Return
	
Label_2134:
	var_52_int = 1; // 0x856 PushI
	var_43_int = var_43_int + var_52_int; // 0x857 Add2
	goto Label_2124; // 0x858 Jump
}


func_2139()
{
	var_23_bool = 0; var_24_string = ""; var_25_string = ""; // 0x85c PushV
	var_24_string = "quest_d1_01"; // 0x85d MovS
	var_25_string = "attack"; // 0x85e MovS
	func_2083(var_23_bool, var_24_string, var_25_string); // 0x85f NEW_2
...
func_1115(var_0_object)
{
	...
	func_2095(var_131_object); // 0x45d NEW_2
	return 0; // 0x45f Return
}


func_1120(var_468_int)
{
	var_468_int = 0; // 0x460 MovI
	return 0; // 0x461 Return
}


func_2146(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x862 PushV
	var_81_string = "branch"; // 0x863 PushS
	GetVariable(var_81_string, var_80_int); // 0x864 Func
	var_82_int = 0; // 0x866 PushI
	var_83_bool = var_80_int == var_82_int; // 0x867 Eq
	if(var_83_bool == 0) goto Label_2156; // 0x868 JumpB
	var_78_int = 1; // 0x869 MovI
	return 2; // 0x86a Return
	
Label_2156:
	var_84_int = 1; // 0x86c PushI
	var_85_bool = var_80_int == var_84_int; // 0x86d Eq
	if(var_85_bool == 0) goto Label_2161; // 0x86e JumpB
	var_78_int = 2; // 0x86f MovI
	return 2; // 0x870 Return
	
Label_2161:
	var_78_int = 3; // 0x871 MovI
...
func_1122()
{
	...
	func_1998(var_264_string); // 0x464 NEW_2
...
func_1129(var_493_bool)
{
	var_493_bool = 1; // 0x469 MovB
...
func_1135(var_2_object, var_138_bool, var_139_object, var_140_float, var_141_float, var_142_bool, var_143_bool)
{
	...
	func_2095(var_151_object); // 0x472 NEW_2
	...
	func_1980(var_155_object); // 0x47f NEW_2
...
Label_1155:
	...
	func_2039(var_166_object); // 0x489 NEW_2
...
func_2163(var_20_int)
{
	var_21_int = 0; var_22_int = 0; // 0x873 PushV
	var_23_string = "branch"; // 0x874 PushS
	GetVariable(var_23_string, var_22_int); // 0x875 Func
	var_20_int = var_22_int; // 0x877 Mov
...
func_2169(var_19_object)
{
	var_20_int = 0; // 0x87a PushV
	func_2163(var_20_int); // 0x87b NEW_2
	var_24_int = 1; // 0x87d PushI
	var_25_bool = var_20_int == var_24_int; // 0x87e Eq
	if(var_25_bool == 0) goto Label_2179; // 0x87f JumpB
	WorkWithCorpse(var_19_object); // 0x880 Func
	goto Label_2181; // 0x882 Jump
	
Label_2181:
	return 0; // 0x885 Return
	
Label_2179:
	Barter(var_19_object); // 0x883 Func
}
...
func_132(var_2_object, var_94_string)
{
	...
	func_2190(var_95_bool); // 0x86 NEW_2
...
Label_150:
	func_1965(var_98_string, var_99_bool); // 0x96 NEW_2
...
func_2182(var_75_int)
{
	var_75_int = 515568; // 0x886 MovI
	return 0; // 0x887 Return
}


func_2184(var_74_int)
{
	var_74_int = 503353; // 0x888 MovI
	return 0; // 0x889 Return
}


func_2186(var_76_string)
{
	var_76_string = "ui/NPC_Citizen1.png"; // 0x88a MovS
	return 0; // 0x88b Return
}


func_2188(var_77_string)
{
	var_77_string = "ui/NPC_Citizen1_b.png"; // 0x88c MovS
	return 0; // 0x88d Return
}


func_2190(var_69_bool)
{
	var_69_bool = 0; // 0x88e MovB
	return 0; // 0x88f Return
}


func_2192(var_16_object)
{
	var_17_object = Obj(); // 0x891 PushV
	var_17_object = var_16_object; // 0x892 Mov
	TaskCall(5); // 0x893 TaskCall
	func_1391(var_17_object); // 0x894 NEW_2
	TaskReturn(); // 0x895 TaskReturn
...
func_737(var_0_object, var_393_float, var_394_int)
{
	...
	var_468_int = 0; // 0x2fc PushV
	func_1120(var_468_int); // 0x2fd NEW_2
	ReportHit(var_0_object, var_468_int, var_400_float, var_399_float); // 0x2ff Func
	var_469_object = Obj(); var_470_float = 0; // 0x301 PushV
	var_469_object = var_398_object; // 0x302 Mov
	var_470_float = var_400_float; // 0x303 Mov
...
Label_1782:
	...
	func_2045(var_47_cvector, var_48_cvector); // 0x6fd NEW_2
...
Label_812:
	...
	var_471_string = "all"; // 0x331 PushS
	var_472_string = "attack_middle"; // 0x332 PushS
	var_473_int = var_472_string + var_362_int; // 0x333 Add
	HasAnimation(var_363_bool, var_471_string, var_473_int); // 0x334 Func
	var_474_bool = var_363_bool; // 0x336 Push
	if(var_474_bool == 0) goto Label_893; // 0x337 JumpB
	func_2104(); // 0x339 NEW_2
	var_475_string = "all"; // 0x33b PushS
	var_476_string = "attack_middle"; // 0x33c PushS
	var_477_int = var_476_string + var_362_int; // 0x33d Add
	PlayAnimation(var_475_string, var_477_int); // 0x33e Func
	WaitForAnimEnd(); // 0x340 Func
	func_1115(var_365_string); // 0x343 NEW_2
	var_478_bool = 0; var_479_object = Obj(); // 0x345 PushV
	var_479_object = var_0_object; // 0x346 MovT
	func_1698(var_478_bool, var_479_object); // 0x347 NEW_2
	var_480_bool = var_478_bool == 0; // 0x349 Not
	if(var_480_bool == 0) goto Label_847; // 0x34a JumpB
	StopAsync(); // 0x34b Func
	var_356_bool = 0; // 0x34d MovB
	return 8; // 0x34e Return
	
Label_847:
	var_481_float = 0; var_482_int = 0; // 0x34f PushV
	var_481_float = var_357_float; // 0x350 Mov
	var_482_int = var_362_int; // 0x351 Mov
	func_737(var_365_string, var_481_float, var_482_int); // 0x352 NEW_2
	var_364_int = 1; // 0x354 MovI
	
Label_853:
	var_483_string = "attack_middle"; // 0x355 PushS
	var_484_int = var_483_string + var_362_int; // 0x356 Add
	var_485_string = "_"; // 0x357 PushS
	var_486_int = var_484_int + var_485_string; // 0x358 Add
	var_365_string = var_486_int + var_364_int; // 0x359 Add2
	var_487_string = "all"; // 0x35a PushS
	HasAnimation(var_363_bool, var_487_string, var_365_string); // 0x35b Func
	var_488_bool = var_363_bool == 0; // 0x35d Not
	if(var_488_bool == 0) goto Label_864; // 0x35e JumpB
	goto Label_893; // 0x35f Jump
	
Label_893:
	var_489_bool = 0; // 0x37d PushB
	SetAttackState(var_489_bool); // 0x37e Func
	var_490_string = "all"; // 0x380 PushS
	var_491_string = "attack_end"; // 0x381 PushS
	var_492_int = var_491_string + var_362_int; // 0x382 Add
	PlayAnimation(var_490_string, var_492_int); // 0x383 Func
	var_493_bool = 0; // 0x385 PushV
	func_1129(var_493_bool); // 0x386 NEW_2
	if(var_493_bool == 0) goto Label_911; // 0x388 JumpB
	var_494_bool = 0; var_495_float = 0; // 0x389 PushV
	var_495_float = 0.75; // 0x38a MovF
	func_913(var_494_bool, var_495_float); // 0x38b NEW_2
...
Label_864:
	func_2104(); // 0x361 NEW_2
	var_503_string = "all"; // 0x363 PushS
	PlayAnimation(var_503_string, var_365_string); // 0x364 Func
	WaitForAnimEnd(); // 0x366 Func
	func_1115(var_365_string); // 0x369 NEW_2
	var_504_bool = 0; var_505_object = Obj(); // 0x36b PushV
	var_505_object = var_0_object; // 0x36c MovT
	func_1698(var_504_bool, var_505_object); // 0x36d NEW_2
	var_506_bool = var_504_bool == 0; // 0x36f Not
	if(var_506_bool == 0) goto Label_885; // 0x370 JumpB
	StopAsync(); // 0x371 Func
	var_356_bool = 0; // 0x373 MovB
	return 8; // 0x374 Return
	
Label_885:
	var_507_float = 0; var_508_int = 0; // 0x375 PushV
	var_507_float = var_357_float; // 0x376 Mov
	var_508_int = var_362_int; // 0x377 Mov
	func_737(var_365_string, var_507_float, var_508_int); // 0x378 NEW_2
	var_509_int = 1; // 0x37a PushI
	var_364_int = var_364_int + var_509_int; // 0x37b Add2
...
Label_331:
	...
	func_2039(var_23_object); // 0x14d NEW_2
...
func_1864(var_27_bool, var_29_float)
{
	...
	func_2045(var_54_cvector, var_55_cvector); // 0x763 NEW_2
...
Label_1905:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x773 Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x775 PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x776 PushE
	Rotate(var_67_float, var_68_float); // 0x777 Func
	var_69_bool = 0; // 0x779 PushV
	func_2190(var_69_bool); // 0x77a NEW_2
	if(var_69_bool == 0) goto Label_1918; // 0x77c JumpB
	goto Label_1926; // 0x77d Jump
	
Label_1926:
	CameraWaitForPlayFinish(); // 0x786 Func
	ResumeWorld(); // 0x788 Func
	var_27_bool = 1; // 0x78a MovB
	return 18; // 0x78b Return
	
Label_1918:
	var_70_string = "head"; // 0x77e PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x77f Func
	var_71_bool = var_47_bool; // 0x781 Push
	if(var_71_bool == 0) goto Label_1926; // 0x782 JumpB
	var_72_string = "head"; // 0x783 PushS
	LookAsyncCamera(var_72_string); // 0x784 Func
}


func_338(var_527_string)
{
	var_528_string = "cleanup"; // 0x153 PushS
	var_529_bool = var_527_string == var_528_string; // 0x154 Eq
	if(var_529_bool == 0) goto Label_345; // 0x155 JumpB
	func_318(var_527_string); // 0x157 NEW_2
...
Label_378:
	...
	func_2122(var_40_int); // 0x17b NEW_2
...
Label_393:
	...
	func_2115(var_62_string, var_63_int); // 0x197 NEW_2
...
Label_1484:
	...
	func_1998(var_93_string); // 0x5ce NEW_2
...
func_1932()
{
	var_138_bool = 0; var_139_bool = 0; // 0x78c PushV
	CameraSwitchToNormal(); // 0x78d Func
	var_140_bool = 0; // 0x78f PushV
	func_2190(var_140_bool); // 0x790 NEW_2
	if(var_140_bool == 0) goto Label_1940; // 0x792 JumpB
	goto Label_1948; // 0x793 Jump
	
Label_1948:
	return 2; // 0x79c Return
	
Label_1940:
	var_141_string = "head"; // 0x794 PushS
	HasAnimationTrack(var_139_bool, var_141_string); // 0x795 Func
	var_142_bool = var_139_bool; // 0x797 Push
	if(var_142_bool == 0) goto Label_1948; // 0x798 JumpB
	var_143_string = "head"; // 0x799 PushS
	UnlookAsync(var_143_string); // 0x79a Func
}


func_913(var_494_bool, var_495_float)
{
	var_496_float = 0; var_497_bool = 0; var_498_float = 0; var_499_bool = 0; // 0x391 PushV
	rand(var_498_float); // 0x392 Func
	var_500_bool = var_498_float < var_495_float; // 0x394 LT
	if(var_500_bool == 0) goto Label_933; // 0x395 JumpB
	
Label_918:
	IsAnimationPlaying(var_499_bool); // 0x396 Func
	var_501_bool = var_499_bool == 0; // 0x398 Not
	if(var_501_bool == 0) goto Label_923; // 0x399 JumpB
...
Label_938:
	var_494_bool = 0; // 0x3aa MovB
	return 4; // 0x3ab Return
	
Label_923:
	var_502_bool = 0; // 0x39b PushV
	func_1011(var_502_bool); // 0x39c NEW_2
	if(var_502_bool == 0) goto Label_929; // 0x39e JumpB
	var_494_bool = 1; // 0x39f MovB
...
Label_933:
	...
	func_1115(var_499_bool); // 0x3a8 NEW_2
}


func_1949(var_120_string)
{
	var_121_bool = 0; var_122_float = 0; var_123_float = 0; var_124_bool = 0; var_125_float = 0; var_126_float = 0; // 0x79d PushV
	lshHasAnimation(var_124_bool, var_120_string); // 0x79e Func
	var_127_bool = var_124_bool; // 0x7a0 Push
	if(var_127_bool == 0) goto Label_1960; // 0x7a1 JumpB
	lshGetAnimTimes(var_120_string, var_125_float, var_126_float); // 0x7a2 Func
	var_128_bool = 0; // 0x7a4 PushB
	lshPlayAnimation(var_125_float, var_126_float, var_128_bool); // 0x7a5 Func
...
Label_1960:
	var_129_string = "Can't find lsh animation : "; // 0x7a8 PushS
	var_130_int = var_129_string + var_120_string; // 0x7a9 Add
	Trace(var_130_int); // 0x7aa Func
}
...
func_1965(var_98_string, var_99_bool)
{
	var_102_bool = 0; var_103_float = 0; var_104_float = 0; var_105_bool = 0; var_106_float = 0; var_107_float = 0; // 0x7ad PushV
	lshHasAnimation(var_105_bool, var_98_string); // 0x7ae Func
	var_108_bool = var_105_bool; // 0x7b0 Push
	if(var_108_bool == 0) goto Label_1975; // 0x7b1 JumpB
	lshGetAnimTimes(var_98_string, var_106_float, var_107_float); // 0x7b2 Func
	lshPlayAnimation(var_106_float, var_107_float, var_99_bool); // 0x7b4 Func
...
Label_1975:
	var_109_string = "Can't find lsh animation : "; // 0x7b7 PushS
	var_110_int = var_109_string + var_98_string; // 0x7b8 Add
	Trace(var_110_int); // 0x7b9 Func
}


func_1980(var_19_object)
{
	var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_float = 0; var_23_cvector = CVector(0,0,0); // 0x7bc PushV
	GetEyesHeight(var_22_float); // 0x7bd ObjFunc
	var_23_cvector = CVector(0.0, 0.0, 0.0); // 0x7bf MovV
	var_24_float = GetByIndex(var_23_cvector, 1); // 0x7c0 PushE
	var_24_float = var_22_float; // 0x7c1 Mov
	SetByIndex(var_23_cvector, 1) = var_24_float; // 0x7c2 PopE
	var_25_string = "head"; // 0x7c3 PushS
	LookAsync(var_19_object, var_25_string, var_23_cvector); // 0x7c4 Func
...
func_1991()
{
	var_18_bool = 0; // 0x7c7 PushV
	func_2190(var_18_bool); // 0x7c8 NEW_2
	if(var_18_bool == 0) goto Label_1997; // 0x7ca JumpB
	lshStopSpeech(); // 0x7cb Func
...
Label_456:
	...
	var_526_int = 1; // 0x1ce PushI
	Sleep(var_526_int); // 0x1cf Func
	goto Label_456; // 0x1d1 Jump
}


func_1998(var_41_string)
{
	var_42_bool = 0; var_43_int = 0; var_44_bool = 0; var_45_int = 0; var_46_bool = 0; var_47_float = 0; var_48_cvector = CVector(0,0,0); var_49_cvector = CVector(0,0,0); var_50_bool = 0; var_51_int = 0; var_52_bool = 0; var_53_int = 0; var_54_bool = 0; var_55_float = 0; var_56_cvector = CVector(0,0,0); var_57_cvector = CVector(0,0,0); // 0x7ce PushV
	IsExisting3DSound(var_50_bool, var_41_string); // 0x7cf Func
	var_58_bool = var_50_bool == 0; // 0x7d1 Not
	if(var_58_bool == 0) goto Label_2023; // 0x7d2 JumpB
	var_51_int = 0; // 0x7d3 MovI
	
Label_2004:
	var_59_int = 1; // 0x7d4 PushI
	var_60_int = var_51_int + var_59_int; // 0x7d5 Add
	var_61_int = var_41_string + var_60_int; // 0x7d6 Add
	IsExisting3DSound(var_52_bool, var_61_int); // 0x7d7 Func
	var_62_bool = var_52_bool == 0; // 0x7d9 Not
	if(var_62_bool == 0) goto Label_2012; // 0x7da JumpB
	goto Label_2015; // 0x7db Jump
	
Label_2015:
	var_63_bool = var_51_int == 0; // 0x7df Not
	if(var_63_bool == 0) goto Label_2018; // 0x7e0 JumpB
	return 16; // 0x7e1 Return
	
Label_2018:
	irand(var_53_int, var_51_int); // 0x7e2 Func
	var_64_int = 1; // 0x7e4 PushI
	var_65_int = var_53_int + var_64_int; // 0x7e5 Add
	var_41_string = var_41_string + var_65_int; // 0x7e6 Add2
	
Label_2023:
	Is3DSoundLoaded(var_54_bool, var_41_string); // 0x7e7 Func
	var_66_bool = var_54_bool; // 0x7e9 Push
	if(var_66_bool == 0) goto Label_2038; // 0x7ea JumpB
	GetEyesHeight(var_55_float); // 0x7eb Func
	GetDirection(var_56_cvector); // 0x7ed Func
	var_67_int = 50; // 0x7ef PushI
	var_57_cvector = var_56_cvector * var_67_int; // 0x7f0 Mult2
	var_68_float = GetByIndex(var_57_cvector, 1); // 0x7f1 PushE
	var_68_float = var_68_float + var_55_float; // 0x7f2 Add2
	SetByIndex(var_57_cvector, 1) = var_68_float; // 0x7f3 PopE
	PlayGlobalSound(var_41_string, var_57_cvector); // 0x7f4 Func
	
Label_2038:
	return 16; // 0x7f6 Return
	
Label_2012:
	var_69_int = 1; // 0x7dc PushI
	var_51_int = var_51_int + var_69_int; // 0x7dd Add2
...
Label_492:
	...
	func_2039(var_92_object); // 0x1f6 NEW_2
...
Label_629:
	...
	var_510_string = "all"; // 0x277 PushS
	var_511_string = "fjump"; // 0x278 PushS
	PlayAnimation(var_510_string, var_511_string); // 0x279 Func
	WaitForAnimEnd(); // 0x27b Func
	func_1115(var_61_float); // 0x27e NEW_2
	var_512_cvector = CVector(0.0, 0.0, 0.0); // 0x280 PushVec
	SetSpeed(var_512_cvector); // 0x281 Func
	Stop(); // 0x283 Func
	StopAsync(); // 0x285 Func
	var_513_bool = 0; // 0x287 PushV
	func_1072(var_61_float, var_513_bool); // 0x288 NEW_2
	var_514_bool = var_513_bool == 0; // 0x28a Not
	if(var_514_bool == 0) goto Label_675; // 0x28b JumpB
	var_515_bool = 0; var_516_object = Obj(); // 0x28c PushV
	var_516_object = var_0_object; // 0x28d MovT
	func_1698(var_515_bool, var_516_object); // 0x28e NEW_2
	var_517_bool = var_515_bool == 0; // 0x290 Not
	if(var_517_bool == 0) goto Label_659; // 0x291 JumpB
...
Label_659:
	...
	var_518_float = var_39_float * var_39_float; // 0x299 Mult
	var_519_bool = var_58_float < var_518_float; // 0x29a LT
	if(var_519_bool == 0) goto Label_675; // 0x29b JumpB
	var_520_bool = 0; var_521_float = 0; // 0x29c PushV
	var_521_float = var_39_float; // 0x29d Mov
	func_776(var_61_float, var_520_bool, var_521_float); // 0x29e NEW_2
	var_522_bool = var_520_bool == 0; // 0x2a0 Not
	if(var_522_bool == 0) goto Label_675; // 0x2a1 JumpB
	goto Label_685; // 0x2a2 Jump
	
Label_676:
	var_523_bool = 0; var_524_float = 0; // 0x2a4 PushV
	var_524_float = var_39_float; // 0x2a5 Mov
	func_776(var_61_float, var_523_bool, var_524_float); // 0x2a6 NEW_2
	var_525_bool = var_523_bool == 0; // 0x2a8 Not
	if(var_525_bool == 0) goto Label_683; // 0x2a9 JumpB
...
func_1507(var_40_string)
{
	...
	func_1998(var_41_string); // 0x5f0 NEW_2
...
{
	var_16_object = Obj(); var_17_object = Obj(); // 0x7f7 PushV
	self(var_17_object); // 0x7f8 Func
	var_15_object = var_17_object; // 0x7fa Mov
	return 2; // 0x7fb Return
}


func_2045(var_47_cvector, var_48_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x7fd PushV
	var_57_int = var_48_cvector | var_48_cvector; // 0x7fe Or
	var_56_float = sqrt(var_57_int); // 0x7ff Sqrt2
	var_58_float = 0.0; // 0x800 PushF
	var_59_bool = var_56_float < var_58_float; // 0x801 LT
	if(var_59_bool == 0) goto Label_2053; // 0x802 JumpB
	var_47_cvector = CVector(0.0, 0.0, 0.0); // 0x803 MovV
	return 2; // 0x804 Return
	
Label_2053:
	var_47_cvector = var_48_cvector / var_48_cvector; // 0x805 Div2
