...
0x171: Push("Can't retrieve diary root")
0x172: @ Trace(Stack[-1])
0x173: Pop(1)
0x174: Stack[-3] = (bool) 0
0x175: Return(); Pop(2)

0x176: Stack[-3] = Stack[-1]
0x177: Return(); Pop(2)
...
0x17c: Stack[-4] = Stack[-1]
0x17d: Pop(1)
0x17e: @@ Find(Stack[-7], Stack[-2])
0x17f: Pop(0)
0x180: Pop(0); Push((bool) Stack[-2] == 0)
0x181: IF (Stack[-1] == 0) GOTO 0x188; Pop(1)

0x182: Push("Can't find diary parent with id: ")
...
0x188: @@ AddChild(Stack[-8])
0x189: Pop(0)
0x18a: Push((int) 7)
0x18b: @ SendWorldWndMessage(Stack[-1])
0x18c: Pop(1)
0x18d: @@ GetCategory(Stack[-1])
0x18e: Pop(0)
