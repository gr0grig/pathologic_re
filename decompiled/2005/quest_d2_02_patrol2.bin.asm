...
0x7c5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7c6: @ Trace(Stack[-1])
0x7c7: Pop(1)
0x7c8: Return(); Pop(6)
...
0x7d4: Pop(1); Push(Stack[-1] + Stack[-9]);
0x7d5: @ Trace(Stack[-1])
0x7d6: Pop(1)
0x7d7: Return(); Pop(6)
...
0x7dc: Push(CvectorIndex(Stack[-1], 1))
0x7dd: Stack[-1] = Stack[-3]
0x7de: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7df: Push("head")
...
0x7fb: Pop(0)
0x7fc: Pop(0); Push((bool) Stack[-8] == 0)
0x7fd: IF (Stack[-1] == 0) GOTO 0x812; Pop(1)

0x7fe: Stack[-7] = (int) 0
0x7ff: Push((int) 1)
0x800: Pop(1); Push(Stack[-8] + Stack[-1]);
0x801: Pop(1); Push(Stack[-18] + Stack[-1]);
0x802: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x803: Pop(1)
0x804: Pop(0); Push((bool) Stack[-6] == 0)
0x805: IF (Stack[-1] == 0) GOTO 0x807; Pop(1)

0x806: GOTO 0x80a

0x807: Push((int) 1)
0x808: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x809: GOTO 0x7ff

0x80a: Pop(0); Push((bool) Stack[-7] == 0)
...
0x811: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x819: Pop(0)
0x81a: Push((int) 50)
0x81b: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x81c: Push(CvectorIndex(Stack[-1], 1))
0x81d: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
...
0x829: Pop(0); Push(Stack[-3] | Stack[-3]);
0x82a: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x830: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x831: Return(); Pop(2)

0x832: PushEmpty(cvector, cvector)
0x833: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x834: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x835: Return(); Pop(2)
...
0x848: PushEmpty()
0x849: Pop(0); Push((bool) Stack[-2] == 0)
...
0x88f: PushEmpty(int)
0x890: Push((int) 24)
0x891: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x892: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x893: Return(); Pop(2)
...
0x8ff: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x926: Push(-1, 0); TaskCall(4)
0x927: Call2 0x476

0x928: Pop(-1, 0); TaskReturn
0x929: Pop(1)
0x92a: Return(); Pop(2)
