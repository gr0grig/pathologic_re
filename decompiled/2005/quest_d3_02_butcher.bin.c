...
Label_38:
	var_525_string = ""; // 0x26 PushV
	var_525_string = var_16_bool; // 0x27 Mov
	func_81(var_525_string); // 0x28 NEW_2
}
...
task_2_event_7(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_bool, var_6_bool, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_int)
{
	...
	func_1803(var_19_object); // 0x404 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0x745 PushV
	var_20_object = var_16_object; // 0x746 Mov
	var_21_int = var_17_int; // 0x747 Mov
	var_22_float = var_18_float; // 0x748 Mov
	func_1597(var_20_object, var_21_int, var_22_float); // 0x749 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0x74d PushV
	var_22_object = var_16_object; // 0x74e Mov
	var_23_int = var_17_int; // 0x74f Mov
	var_24_float = var_18_float; // 0x750 Mov
	var_25_cvector = var_20_cvector; // 0x751 Mov
	var_26_cvector = var_21_cvector; // 0x752 Mov
	func_1665(var_24_float, var_25_cvector, var_26_cvector); // 0x753 NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0x756 PushV
	var_20_string = "health"; // 0x757 PushS
	var_21_bool = var_17_string == var_20_string; // 0x758 Eq
	if(var_21_bool == 0) goto Label_1890; // 0x759 JumpB
	var_22_string = "health"; // 0x75a PushS
	GetProperty(var_22_string, var_19_float); // 0x75b Func
	var_23_int = 0; // 0x75d PushI
	var_24_bool = var_19_float <= var_23_int; // 0x75e LE
	if(var_24_bool == 0) goto Label_1890; // 0x75f JumpB
	SignalDeath(var_16_object); // 0x760 Func
...
{
	var_17_object = Obj(); // 0x764 PushV
	var_17_object = var_16_object; // 0x765 Mov
	func_1847(var_17_object); // 0x766 NEW_2
...
Label_1434:
	var_466_string = "armor"; // 0x59a PushS
	GetProperty(var_466_string, var_419_int); // 0x59b ObjFunc
}
...
func_1803(var_19_object)
{
	var_20_bool = 0; var_21_bool = 0; // 0x70b PushV
	IsPlayerActor(var_19_object, var_21_bool); // 0x70c Func
	var_22_bool = var_21_bool; // 0x70e Push
	if(var_22_bool == 0) goto Label_1811; // 0x70f JumpB
	var_23_string = "attack"; // 0x710 PushS
	PlayGlobalMusic(var_23_string); // 0x711 Func
...
func_1812()
{
	var_367_object = Obj(); var_368_object = Obj(); // 0x714 PushV
	GetScene(var_368_object); // 0x715 Func
	var_369_string = "battle"; // 0x717 PushS
	var_370_object = Obj(); // 0x718 PushV
	func_1747(var_370_object); // 0x719 NEW_2
	BroadcastMessage(var_369_string, var_370_object, var_368_object); // 0x71b Func
...
func_1823(var_57_string, var_58_int)
{
	var_59_string = ""; var_60_string = ""; // 0x71f PushV
	var_60_string = "idle"; // 0x720 MovS
	var_61_int = var_58_int; // 0x721 Push
	if(var_61_int == 0) goto Label_1828; // 0x722 JumpB
	var_60_string = var_60_string + var_58_int; // 0x723 Add2
	
Label_1828:
	var_57_string = var_60_string; // 0x724 Mov
...
func_1830(var_51_int)
{
	var_52_int = 0; var_53_bool = 0; var_54_int = 0; var_55_bool = 0; // 0x726 PushV
	var_54_int = 0; // 0x727 MovI
	
Label_1832:
	var_56_string = "all"; // 0x728 PushS
	var_57_string = ""; var_58_int = 0; // 0x729 PushV
	var_58_int = var_54_int; // 0x72a Mov
	func_1823(var_57_string, var_58_int); // 0x72b NEW_2
	HasAnimation(var_55_bool, var_56_string, var_57_string); // 0x72d Func
	var_62_bool = var_55_bool == 0; // 0x72f Not
	if(var_62_bool == 0) goto Label_1842; // 0x730 JumpB
	goto Label_1845; // 0x731 Jump
	
Label_1845:
	var_51_int = var_54_int; // 0x735 Mov
	return 4; // 0x736 Return
	
Label_1842:
	var_63_int = 1; // 0x732 PushI
	var_54_int = var_54_int + var_63_int; // 0x733 Add2
	goto Label_1832; // 0x734 Jump
}
...
Label_459:
	...
	var_509_string = "all"; // 0x1cd PushS
	var_510_string = "fjump"; // 0x1ce PushS
	PlayAnimation(var_509_string, var_510_string); // 0x1cf Func
	WaitForAnimEnd(); // 0x1d1 Func
	func_945(var_58_float); // 0x1d4 NEW_2
	var_511_cvector = CVector(0.0, 0.0, 0.0); // 0x1d6 PushVec
	SetSpeed(var_511_cvector); // 0x1d7 Func
	Stop(); // 0x1d9 Func
	StopAsync(); // 0x1db Func
	var_512_bool = 0; // 0x1dd PushV
	func_902(var_58_float, var_512_bool); // 0x1de NEW_2
	var_513_bool = var_512_bool == 0; // 0x1e0 Not
	if(var_513_bool == 0) goto Label_505; // 0x1e1 JumpB
	var_514_bool = 0; var_515_object = Obj(); // 0x1e2 PushV
	var_515_object = var_0_int; // 0x1e3 MovT
	func_1529(var_514_bool, var_515_object); // 0x1e4 NEW_2
	var_516_bool = var_514_bool == 0; // 0x1e6 Not
	if(var_516_bool == 0) goto Label_489; // 0x1e7 JumpB
...
Label_489:
	...
	var_517_float = var_36_float * var_36_float; // 0x1ef Mult
	var_518_bool = var_55_float < var_517_float; // 0x1f0 LT
	if(var_518_bool == 0) goto Label_505; // 0x1f1 JumpB
	var_519_bool = 0; var_520_float = 0; // 0x1f2 PushV
	var_520_float = var_36_float; // 0x1f3 Mov
	func_606(var_58_float, var_519_bool, var_520_float); // 0x1f4 NEW_2
	var_521_bool = var_519_bool == 0; // 0x1f6 Not
	if(var_521_bool == 0) goto Label_505; // 0x1f7 JumpB
	goto Label_515; // 0x1f8 Jump
	
Label_506:
	var_522_bool = 0; var_523_float = 0; // 0x1fa PushV
	var_523_float = var_36_float; // 0x1fb Mov
	func_606(var_58_float, var_522_bool, var_523_float); // 0x1fc NEW_2
	var_524_bool = var_522_bool == 0; // 0x1fe Not
	if(var_524_bool == 0) goto Label_513; // 0x1ff JumpB
...
func_945(var_0_int)
{
	...
	func_1803(var_130_object); // 0x3b3 NEW_2
...
func_950(var_467_int)
{
	var_467_int = 0; // 0x3b6 MovI
...
func_567(var_0_int, var_392_float, var_393_int)
{
	...
	var_467_int = 0; // 0x252 PushV
	func_950(var_467_int); // 0x253 NEW_2
	ReportHit(var_0_int, var_467_int, var_399_float, var_398_float); // 0x255 Func
	var_468_object = Obj(); var_469_float = 0; // 0x257 PushV
	var_468_object = var_397_object; // 0x258 Mov
	var_469_float = var_399_float; // 0x259 Mov
...
func_1847(var_17_object)
{
	var_18_bool = 0; var_19_string = ""; var_20_string = ""; // 0x738 PushV
	var_19_string = "quest_d1_03"; // 0x739 MovS
	var_20_string = "butcher_death"; // 0x73a MovS
	func_1791(var_18_bool, var_19_string, var_20_string); // 0x73b NEW_2
	var_24_object = Obj(); // 0x73d PushV
	var_24_object = var_17_object; // 0x73e Mov
	TaskCall(3); // 0x73f TaskCall
	func_1237(var_24_object); // 0x740 NEW_2
	TaskReturn(); // 0x741 TaskReturn
...
func_61(var_5_bool)
{
	...
	var_528_bool = 0; // 0x3e PushV
	var_528_bool = 0; // 0x3f MovB
	var_529_bool = 0; // 0x40 PushV
	func_1690(var_529_bool); // 0x41 NEW_2
	var_532_bool = var_529_bool == 0; // 0x43 Not
	if(var_532_bool == 0) goto Label_74; // 0x44 JumpB
	var_533_bool = 0; // 0x45 PushV
	func_110(var_533_bool); // 0x46 NEW_2
	if(var_533_bool == 0) goto Label_74; // 0x48 JumpB
	var_528_bool = 1; // 0x49 MovB
	
Label_74:
	if(var_528_bool == 0) goto Label_80; // 0x4a JumpB
	var_534_object = Obj(); // 0x4b PushV
	func_1747(var_534_object); // 0x4c NEW_2
	RemoveActor(var_534_object); // 0x4e Func
...
Label_200:
	...
	func_1830(var_51_int); // 0xc9 NEW_2
...
Label_215:
	...
	func_1823(var_73_string, var_74_int); // 0xe5 NEW_2
...
func_959(var_492_bool)
{
	var_492_bool = 1; // 0x3bf MovB
...
func_973(var_2_bool, var_137_bool, var_138_object, var_139_float, var_140_float, var_141_bool, var_142_bool)
{
	...
	func_1803(var_150_object); // 0x3d0 NEW_2
...
func_81(var_525_string)
{
	var_526_string = "cleanup"; // 0x52 PushS
	var_527_bool = var_525_string == var_526_string; // 0x53 Eq
	if(var_527_bool == 0) goto Label_88; // 0x54 JumpB
	func_61(var_525_string); // 0x56 NEW_2
...
Label_642:
	...
	var_470_string = "all"; // 0x287 PushS
	var_471_string = "attack_middle"; // 0x288 PushS
	var_472_int = var_471_string + var_361_int; // 0x289 Add
	HasAnimation(var_362_bool, var_470_string, var_472_int); // 0x28a Func
	var_473_bool = var_362_bool; // 0x28c Push
	if(var_473_bool == 0) goto Label_723; // 0x28d JumpB
	func_1812(); // 0x28f NEW_2
	var_474_string = "all"; // 0x291 PushS
	var_475_string = "attack_middle"; // 0x292 PushS
	var_476_int = var_475_string + var_361_int; // 0x293 Add
	PlayAnimation(var_474_string, var_476_int); // 0x294 Func
	WaitForAnimEnd(); // 0x296 Func
	func_945(var_364_string); // 0x299 NEW_2
	var_477_bool = 0; var_478_object = Obj(); // 0x29b PushV
	var_478_object = var_0_int; // 0x29c MovT
	func_1529(var_477_bool, var_478_object); // 0x29d NEW_2
	var_479_bool = var_477_bool == 0; // 0x29f Not
	if(var_479_bool == 0) goto Label_677; // 0x2a0 JumpB
	StopAsync(); // 0x2a1 Func
	var_355_bool = 0; // 0x2a3 MovB
	return 8; // 0x2a4 Return
	
Label_677:
	var_480_float = 0; var_481_int = 0; // 0x2a5 PushV
	var_480_float = var_356_float; // 0x2a6 Mov
	var_481_int = var_361_int; // 0x2a7 Mov
	func_567(var_364_string, var_480_float, var_481_int); // 0x2a8 NEW_2
	var_363_int = 1; // 0x2aa MovI
	
Label_683:
	var_482_string = "attack_middle"; // 0x2ab PushS
	var_483_int = var_482_string + var_361_int; // 0x2ac Add
	var_484_string = "_"; // 0x2ad PushS
	var_485_int = var_483_int + var_484_string; // 0x2ae Add
	var_364_string = var_485_int + var_363_int; // 0x2af Add2
	var_486_string = "all"; // 0x2b0 PushS
	HasAnimation(var_362_bool, var_486_string, var_364_string); // 0x2b1 Func
	var_487_bool = var_362_bool == 0; // 0x2b3 Not
	if(var_487_bool == 0) goto Label_694; // 0x2b4 JumpB
	goto Label_723; // 0x2b5 Jump
	
Label_723:
	var_488_bool = 0; // 0x2d3 PushB
	SetAttackState(var_488_bool); // 0x2d4 Func
	var_489_string = "all"; // 0x2d6 PushS
	var_490_string = "attack_end"; // 0x2d7 PushS
	var_491_int = var_490_string + var_361_int; // 0x2d8 Add
	PlayAnimation(var_489_string, var_491_int); // 0x2d9 Func
	var_492_bool = 0; // 0x2db PushV
	func_959(var_492_bool); // 0x2dc NEW_2
	if(var_492_bool == 0) goto Label_741; // 0x2de JumpB
	var_493_bool = 0; var_494_float = 0; // 0x2df PushV
	var_494_float = 0.75; // 0x2e0 MovF
	func_743(var_493_bool, var_494_float); // 0x2e1 NEW_2
...
Label_694:
	func_1812(); // 0x2b7 NEW_2
	var_502_string = "all"; // 0x2b9 PushS
	PlayAnimation(var_502_string, var_364_string); // 0x2ba Func
	WaitForAnimEnd(); // 0x2bc Func
	func_945(var_364_string); // 0x2bf NEW_2
	var_503_bool = 0; var_504_object = Obj(); // 0x2c1 PushV
	var_504_object = var_0_int; // 0x2c2 MovT
	func_1529(var_503_bool, var_504_object); // 0x2c3 NEW_2
	var_505_bool = var_503_bool == 0; // 0x2c5 Not
	if(var_505_bool == 0) goto Label_715; // 0x2c6 JumpB
	StopAsync(); // 0x2c7 Func
	var_355_bool = 0; // 0x2c9 MovB
	return 8; // 0x2ca Return
	
Label_715:
	var_506_float = 0; var_507_int = 0; // 0x2cb PushV
	var_506_float = var_356_float; // 0x2cc Mov
	var_507_int = var_361_int; // 0x2cd Mov
	func_567(var_364_string, var_506_float, var_507_int); // 0x2ce NEW_2
	var_508_int = 1; // 0x2d0 PushI
	var_363_int = var_363_int + var_508_int; // 0x2d1 Add2
...
func_743(var_493_bool, var_494_float)
{
	var_495_float = 0; var_496_bool = 0; var_497_float = 0; var_498_bool = 0; // 0x2e7 PushV
	rand(var_497_float); // 0x2e8 Func
	var_499_bool = var_497_float < var_494_float; // 0x2ea LT
	if(var_499_bool == 0) goto Label_763; // 0x2eb JumpB
	
Label_748:
	IsAnimationPlaying(var_498_bool); // 0x2ec Func
	var_500_bool = var_498_bool == 0; // 0x2ee Not
	if(var_500_bool == 0) goto Label_753; // 0x2ef JumpB
...
Label_768:
	var_493_bool = 0; // 0x300 MovB
	return 4; // 0x301 Return
	
Label_753:
	var_501_bool = 0; // 0x2f1 PushV
	func_841(var_501_bool); // 0x2f2 NEW_2
	if(var_501_bool == 0) goto Label_759; // 0x2f4 JumpB
	var_493_bool = 1; // 0x2f5 MovB
...
Label_763:
	...
	func_945(var_498_bool); // 0x2fe NEW_2
}
...
func_1781(var_462_float)
{
	...
	var_465_int = 15; // 0x6fa PushI
	SendWorldWndMessage(var_465_int, var_464_object); // 0x6fb Func
...
func_1791(var_18_bool, var_19_string, var_20_string)
{
	var_21_object = Obj(); var_22_object = Obj(); // 0x6ff PushV
	FindActor(var_22_object, var_19_string); // 0x700 Func
	var_23_bool = var_22_object == 0; // 0x702 NullEq
	if(var_23_bool == 0) goto Label_1798; // 0x703 JumpB
	var_18_bool = 0; // 0x704 MovB
	return 2; // 0x705 Return
	
Label_1798:
	Trigger(var_22_object, var_20_string); // 0x706 Func
	var_18_bool = 1; // 0x708 MovB
