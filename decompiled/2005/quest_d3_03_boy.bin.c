...
Label_409:
	...
	func_1601(var_207_bool); // 0x19b NEW_2
...
task_3_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_cvector, var_10_bool)
{
	...
	func_1648(var_11_bool, var_12_object); // 0x1ca NEW_2
	...
	func_1655(var_47_object); // 0x1d2 NEW_2
...
task_4_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_cvector, var_10_bool)
{
	...
	func_1648(var_11_bool, var_12_object); // 0x235 NEW_2
	...
	func_1655(var_47_object); // 0x23d NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x64c PushV
	var_14_object = var_10_object; // 0x64d Mov
	var_15_int = var_11_int; // 0x64e Mov
	var_16_float = var_12_float; // 0x64f Mov
	func_1114(var_14_object, var_15_int, var_16_float); // 0x650 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x654 PushV
	var_16_object = var_10_object; // 0x655 Mov
	var_17_int = var_11_int; // 0x656 Mov
	var_18_float = var_12_float; // 0x657 Mov
	var_19_cvector = var_14_cvector; // 0x658 Mov
	var_20_cvector = var_15_cvector; // 0x659 Mov
	func_1182(var_18_float, var_19_cvector, var_20_cvector); // 0x65a NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x65d PushV
	var_14_string = "health"; // 0x65e PushS
	var_15_bool = var_11_string == var_14_string; // 0x65f Eq
	if(var_15_bool == 0) goto Label_1641; // 0x660 JumpB
	var_16_string = "health"; // 0x661 PushS
	GetProperty(var_16_string, var_13_float); // 0x662 Func
	var_17_int = 0; // 0x664 PushI
	var_18_bool = var_13_float <= var_17_int; // 0x665 LE
	if(var_18_bool == 0) goto Label_1641; // 0x666 JumpB
	SignalDeath(var_10_object); // 0x667 Func
...
{
	var_11_object = Obj(); // 0x66b PushV
	var_11_object = var_10_object; // 0x66c Mov
	func_1603(var_11_object); // 0x66d NEW_2
...
{
	var_11_bool = 0; var_12_bool = 0; // 0x67f PushV
	IsPlayerActor(var_10_object, var_12_bool); // 0x680 Func
	var_13_bool = var_12_bool; // 0x682 Push
	if(var_13_bool == 0) goto Label_1673; // 0x683 JumpB
	var_14_bool = 0; var_15_string = ""; var_16_string = ""; // 0x684 PushV
	var_15_string = "quest_d3_03"; // 0x685 MovS
	var_16_string = "boy_attacked"; // 0x686 MovS
	func_1427(var_14_bool, var_15_string, var_16_string); // 0x687 NEW_2
...
func_132(var_2_object, var_89_string)
{
	...
	func_1601(var_90_bool); // 0x86 NEW_2
...
Label_150:
	func_1302(var_93_string, var_94_bool); // 0x96 NEW_2
...
func_1414(var_53_object, var_54_string, var_55_int)
{
	var_56_object = Obj(); var_57_object = Obj(); // 0x586 PushV
	CreateInvItem(var_57_object); // 0x587 Func
	SetItemName(var_54_string); // 0x589 ObjFunc
	var_58_object = Obj(); var_59_object = Obj(); var_60_int = 0; // 0x58b PushV
	var_58_object = var_53_object; // 0x58c Mov
	var_59_object = var_57_object; // 0x58d Mov
	var_60_int = var_55_int; // 0x58e Mov
	func_1395(var_59_object, var_60_int); // 0x58f NEW_2
	return 2; // 0x591 Return
}


func_1286(var_115_string)
{
	var_116_bool = 0; var_117_float = 0; var_118_float = 0; var_119_bool = 0; var_120_float = 0; var_121_float = 0; // 0x506 PushV
	lshHasAnimation(var_119_bool, var_115_string); // 0x507 Func
	var_122_bool = var_119_bool; // 0x509 Push
	if(var_122_bool == 0) goto Label_1297; // 0x50a JumpB
	lshGetAnimTimes(var_115_string, var_120_float, var_121_float); // 0x50b Func
	var_123_bool = 0; // 0x50d PushB
	lshPlayAnimation(var_120_float, var_121_float, var_123_bool); // 0x50e Func
	goto Label_1301; // 0x510 Jump
	
Label_1301:
	return 6; // 0x515 Return
	
Label_1297:
	var_124_string = "Can't find lsh animation : "; // 0x511 PushS
	var_125_int = var_124_string + var_115_string; // 0x512 Add
	Trace(var_125_int); // 0x513 Func
}


func_1548(var_27_bool, var_28_object, var_29_int)
{
	var_30_object = Obj(); var_31_object = Obj(); var_32_int = 0; var_33_object = Obj(); var_34_object = Obj(); var_35_int = 0; // 0x60c PushV
	var_36_object = Obj(); // 0x60d PushV
	func_1535(var_36_object); // 0x60e NEW_2
	var_33_object = var_36_object; // 0x60f Mov
	Find(var_29_int, var_34_object); // 0x611 ObjFunc
	var_41_bool = var_34_object == 0; // 0x613 Not
	if(var_41_bool == 0) goto Label_1563; // 0x614 JumpB
	var_42_string = "Can't find diary parent with id: "; // 0x615 PushS
	var_43_int = var_42_string + var_29_int; // 0x616 Add
	Trace(var_43_int); // 0x617 Func
	var_27_bool = 0; // 0x619 MovB
	return 6; // 0x61a Return
	
Label_1563:
	AddChild(var_28_object); // 0x61b ObjFunc
	var_44_int = 7; // 0x61d PushI
	SendWorldWndMessage(var_44_int); // 0x61e Func
	GetCategory(var_35_int); // 0x620 ObjFunc
	SetDiarySection(var_35_int); // 0x622 Func
	var_27_bool = 0; // 0x624 MovB
	return 6; // 0x625 Return
}


func_655(var_219_bool)
{
	var_219_bool = 1; // 0x28f MovB
	return 0; // 0x290 Return
}


func_528(var_164_float)
{
	var_165_float = 0; var_166_float = 0; // 0x210 PushV
	GetCameraFarDistance(var_166_float); // 0x211 Func
	var_164_float = var_166_float; // 0x213 Mov
...
func_1427(var_14_bool, var_15_string, var_16_string)
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x593 PushV
	FindActor(var_18_object, var_15_string); // 0x594 Func
	var_19_bool = var_18_object == 0; // 0x596 NullEq
	if(var_19_bool == 0) goto Label_1434; // 0x597 JumpB
	var_14_bool = 0; // 0x598 MovB
	return 2; // 0x599 Return
	
Label_1434:
	Trigger(var_18_object, var_16_string); // 0x59a Func
	var_14_bool = 1; // 0x59c MovB
	return 2; // 0x59d Return
}


func_1302(var_93_string, var_94_bool)
{
	var_97_bool = 0; var_98_float = 0; var_99_float = 0; var_100_bool = 0; var_101_float = 0; var_102_float = 0; // 0x516 PushV
	lshHasAnimation(var_100_bool, var_93_string); // 0x517 Func
	var_103_bool = var_100_bool; // 0x519 Push
	if(var_103_bool == 0) goto Label_1312; // 0x51a JumpB
	lshGetAnimTimes(var_93_string, var_101_float, var_102_float); // 0x51b Func
	lshPlayAnimation(var_101_float, var_102_float, var_94_bool); // 0x51d Func
	goto Label_1316; // 0x51f Jump
	
Label_1316:
	return 6; // 0x524 Return
	
Label_1312:
	var_104_string = "Can't find lsh animation : "; // 0x520 PushS
	var_105_int = var_104_string + var_93_string; // 0x521 Add
	Trace(var_105_int); // 0x522 Func
}
...
func_662(var_24_cvector, var_25_float)
{
	...
	func_1365(var_40_cvector, var_41_cvector); // 0x2a0 NEW_2
	...
	func_1365(var_38_cvector, var_39_cvector); // 0x2a5 NEW_2
...
func_1439(var_200_string, var_201_int)
{
	var_202_string = ""; var_203_string = ""; // 0x59f PushV
	var_203_string = "idle"; // 0x5a0 MovS
	var_204_int = var_201_int; // 0x5a1 Push
	if(var_204_int == 0) goto Label_1444; // 0x5a2 JumpB
	var_203_string = var_203_string + var_201_int; // 0x5a3 Add2
	
Label_1444:
	var_200_string = var_203_string; // 0x5a4 Mov
...
func_1317()
{
	var_13_bool = 0; // 0x525 PushV
	func_1601(var_13_bool); // 0x526 NEW_2
	if(var_13_bool == 0) goto Label_1323; // 0x528 JumpB
	lshStopSpeech(); // 0x529 Func
...
func_1446(var_194_int)
{
	var_195_int = 0; var_196_bool = 0; var_197_int = 0; var_198_bool = 0; // 0x5a6 PushV
	var_197_int = 0; // 0x5a7 MovI
	
Label_1448:
	var_199_string = "all"; // 0x5a8 PushS
	var_200_string = ""; var_201_int = 0; // 0x5a9 PushV
	var_201_int = var_197_int; // 0x5aa Mov
	func_1439(var_200_string, var_201_int); // 0x5ab NEW_2
	HasAnimation(var_198_bool, var_199_string, var_200_string); // 0x5ad Func
	var_205_bool = var_198_bool == 0; // 0x5af Not
	if(var_205_bool == 0) goto Label_1458; // 0x5b0 JumpB
	goto Label_1461; // 0x5b1 Jump
	
Label_1461:
	var_194_int = var_197_int; // 0x5b5 Mov
	return 4; // 0x5b6 Return
	
Label_1458:
	var_206_int = 1; // 0x5b2 PushI
	var_197_int = var_197_int + var_206_int; // 0x5b3 Add2
	goto Label_1448; // 0x5b4 Jump
}


func_1576(var_73_int)
{
	var_74_int = 0; var_75_int = 0; // 0x628 PushV
	var_76_string = "branch"; // 0x629 PushS
	GetVariable(var_76_string, var_75_int); // 0x62a Func
	var_77_int = 0; // 0x62c PushI
	var_78_bool = var_75_int == var_77_int; // 0x62d Eq
	if(var_78_bool == 0) goto Label_1586; // 0x62e JumpB
	var_73_int = 1; // 0x62f MovI
	return 2; // 0x630 Return
	
Label_1586:
	var_79_int = 1; // 0x632 PushI
	var_80_bool = var_75_int == var_79_int; // 0x633 Eq
	if(var_80_bool == 0) goto Label_1591; // 0x634 JumpB
	var_73_int = 2; // 0x635 MovI
	return 2; // 0x636 Return
	
Label_1591:
	var_73_int = 3; // 0x637 MovI
	return 2; // 0x638 Return
}


func_556(var_168_object, var_169_cvector)
{
	var_170_object = Obj(); var_171_object = Obj(); // 0x22c PushV
	FindShiftedPathTo(var_171_object, var_169_cvector); // 0x22d Func
	var_168_object = var_171_object; // 0x22f Mov
	return 2; // 0x230 Return
}


func_1196(var_190_bool)
{
	var_191_bool = 0; var_192_bool = 0; // 0x4ac PushV
	IsLoaded(var_192_bool); // 0x4ad Func
	var_190_bool = var_192_bool; // 0x4af Mov
	return 2; // 0x4b0 Return
}


func_1324(var_36_string)
{
	var_37_bool = 0; var_38_int = 0; var_39_bool = 0; var_40_int = 0; var_41_bool = 0; var_42_float = 0; var_43_cvector = CVector(0,0,0); var_44_cvector = CVector(0,0,0); var_45_bool = 0; var_46_int = 0; var_47_bool = 0; var_48_int = 0; var_49_bool = 0; var_50_float = 0; var_51_cvector = CVector(0,0,0); var_52_cvector = CVector(0,0,0); // 0x52c PushV
	IsExisting3DSound(var_45_bool, var_36_string); // 0x52d Func
	var_53_bool = var_45_bool == 0; // 0x52f Not
	if(var_53_bool == 0) goto Label_1349; // 0x530 JumpB
	var_46_int = 0; // 0x531 MovI
	
Label_1330:
	var_54_int = 1; // 0x532 PushI
	var_55_int = var_46_int + var_54_int; // 0x533 Add
	var_56_int = var_36_string + var_55_int; // 0x534 Add
	IsExisting3DSound(var_47_bool, var_56_int); // 0x535 Func
	var_57_bool = var_47_bool == 0; // 0x537 Not
	if(var_57_bool == 0) goto Label_1338; // 0x538 JumpB
	goto Label_1341; // 0x539 Jump
	
Label_1341:
	var_58_bool = var_46_int == 0; // 0x53d Not
	if(var_58_bool == 0) goto Label_1344; // 0x53e JumpB
	return 16; // 0x53f Return
	
Label_1344:
	irand(var_48_int, var_46_int); // 0x540 Func
	var_59_int = 1; // 0x542 PushI
	var_60_int = var_48_int + var_59_int; // 0x543 Add
	var_36_string = var_36_string + var_60_int; // 0x544 Add2
	
Label_1349:
	Is3DSoundLoaded(var_49_bool, var_36_string); // 0x545 Func
	var_61_bool = var_49_bool; // 0x547 Push
	if(var_61_bool == 0) goto Label_1364; // 0x548 JumpB
	GetEyesHeight(var_50_float); // 0x549 Func
	GetDirection(var_51_cvector); // 0x54b Func
	var_62_int = 50; // 0x54d PushI
	var_52_cvector = var_51_cvector * var_62_int; // 0x54e Mult2
	var_63_float = GetByIndex(var_52_cvector, 1); // 0x54f PushE
	var_63_float = var_63_float + var_50_float; // 0x550 Add2
	SetByIndex(var_52_cvector, 1) = var_63_float; // 0x551 PopE
	PlayGlobalSound(var_36_string, var_52_cvector); // 0x552 Func
	
Label_1364:
	return 16; // 0x554 Return
	
Label_1338:
	var_64_int = 1; // 0x53a PushI
	var_46_int = var_46_int + var_64_int; // 0x53b Add2
	goto Label_1330; // 0x53c Jump
}
...
func_1201(var_22_bool, var_24_float)
{
	...
	func_1365(var_49_cvector, var_50_cvector); // 0x4cc NEW_2
...
Label_1242:
	...
	CameraTransit(var_40_cvector, var_38_cvector); // 0x4dc Func
	var_62_float = GetByIndex(var_39_cvector, 0); // 0x4de PushE
	var_63_float = GetByIndex(var_39_cvector, 2); // 0x4df PushE
	Rotate(var_62_float, var_63_float); // 0x4e0 Func
	var_64_bool = 0; // 0x4e2 PushV
	func_1601(var_64_bool); // 0x4e3 NEW_2
	if(var_64_bool == 0) goto Label_1255; // 0x4e5 JumpB
	goto Label_1263; // 0x4e6 Jump
	
Label_1263:
	CameraWaitForPlayFinish(); // 0x4ef Func
	ResumeWorld(); // 0x4f1 Func
	var_22_bool = 1; // 0x4f3 MovB
	return 18; // 0x4f4 Return
	
Label_1255:
	var_65_string = "head"; // 0x4e7 PushS
	HasAnimationTrack(var_42_bool, var_65_string); // 0x4e8 Func
	var_66_bool = var_42_bool; // 0x4ea Push
	if(var_66_bool == 0) goto Label_1263; // 0x4eb JumpB
	var_67_string = "head"; // 0x4ec PushS
	LookAsyncCamera(var_67_string); // 0x4ed Func
}
...
func_949(var_35_string)
{
	...
	func_1324(var_36_string); // 0x3c2 NEW_2
...
func_439()
{
	var_141_bool = 0; var_142_string = ""; var_143_string = ""; // 0x1b7 PushV
	var_142_string = "quest_d3_03"; // 0x1b8 MovS
	var_143_string = "boy_free"; // 0x1b9 MovS
	func_1427(var_141_bool, var_142_string, var_143_string); // 0x1ba NEW_2
	var_147_string = "noaccess"; // 0x1bc PushS
	var_148_int = 0; // 0x1bd PushI
	SetProperty(var_147_string, var_148_int); // 0x1be Func
	
Label_448:
	func_469(var_139_bool, var_140_bool); // 0x1c1 NEW_2
...
func_1463()
{
	var_76_string = "playsound"; // 0x5b8 PushS
	var_77_string = "giveitem"; // 0x5b9 PushS
	TriggerWorld(var_76_string, var_77_string); // 0x5ba Func
	return 0; // 0x5bc Return
}


func_1593(var_70_int)
{
	var_70_int = 515560; // 0x639 MovI
	return 0; // 0x63a Return
}


func_1595(var_69_int)
{
	var_69_int = 503345; // 0x63b MovI
...
func_1469()
{
	var_18_float = 0; var_19_float = 0; // 0x5bd PushV
	var_20_string = "d3q03"; // 0x5be PushS
	var_21_int = 2; // 0x5bf PushI
	SetVariable(var_20_string, var_21_int); // 0x5c0 Func
	func_1509(); // 0x5c3 NEW_2
	var_45_string = "disease"; // 0x5c5 PushS
	GetProperty(var_45_string, var_19_float); // 0x5c6 ObjFunc
	var_46_float = 0.5; // 0x5c8 PushF
	var_47_bool = var_19_float < var_46_float; // 0x5c9 LT
	if(var_47_bool == 0) goto Label_1487; // 0x5ca JumpB
	var_48_string = "disease"; // 0x5cb PushS
	var_49_float = 0.5; // 0x5cc PushF
	SetProperty(var_48_string, var_49_float); // 0x5cd ObjFunc
...
func_1597(var_71_string)
{
	var_71_string = "ui/NPC_Citizen3.png"; // 0x63d MovS
...
{
	var_72_string = "ui/NPC_Citizen3_b.png"; // 0x63f MovS
...
func_576()
{
	var_176_int = 0; var_177_int = 0; var_178_int = 0; var_179_int = 0; var_180_bool = 0; var_181_float = 0; var_182_bool = 0; var_183_int = 0; var_184_int = 0; var_185_int = 0; var_186_int = 0; var_187_bool = 0; var_188_float = 0; var_189_bool = 0; // 0x240 PushV
	WaitForAnimEnd(); // 0x241 Func
	var_190_bool = 0; // 0x243 PushV
	func_1196(var_190_bool); // 0x244 NEW_2
	var_193_bool = var_190_bool == 0; // 0x246 Not
	if(var_193_bool == 0) goto Label_585; // 0x247 JumpB
	return 14; // 0x248 Return
	
Label_585:
	var_194_int = 0; // 0x249 PushV
	func_1446(var_194_int); // 0x24a NEW_2
	var_183_int = var_194_int; // 0x24b Mov
	var_184_int = 0; // 0x24d MovI
	
Label_590:
	var_207_bool = 0; // 0x24e PushV
	var_207_bool = 0; // 0x24f MovB
	var_208_int = 5; // 0x250 PushI
	var_209_bool = var_184_int < var_208_int; // 0x251 LT
	if(var_209_bool == 0) goto Label_600; // 0x252 JumpB
	var_210_bool = 0; // 0x253 PushV
	func_1196(var_210_bool); // 0x254 NEW_2
	if(var_210_bool == 0) goto Label_600; // 0x256 JumpB
	var_207_bool = 1; // 0x257 MovB
	
Label_600:
	if(var_207_bool == 0) goto Label_652; // 0x258 JumpB
	var_211_int = 3; // 0x259 PushI
	irand(var_185_int, var_211_int); // 0x25a Func
	var_212_int = 0; // 0x25c PushI
	var_213_bool = var_185_int == var_212_int; // 0x25d Eq
	if(var_213_bool == 0) goto Label_624; // 0x25e JumpB
	var_214_int = var_183_int; // 0x25f Push
	if(var_214_int == 0) goto Label_623; // 0x260 JumpB
	irand(var_186_int, var_183_int); // 0x261 Func
	var_215_string = "all"; // 0x263 PushS
	var_216_string = ""; var_217_int = 0; // 0x264 PushV
	var_217_int = var_186_int; // 0x265 Mov
	func_1439(var_216_string, var_217_int); // 0x266 NEW_2
	PlayAnimation(var_215_string, var_216_string); // 0x268 Func
	WaitForAnimEnd(var_187_bool); // 0x26a Func
	var_218_bool = var_187_bool == 0; // 0x26c Not
	if(var_218_bool == 0) goto Label_623; // 0x26d JumpB
...
Label_641:
	var_219_bool = 0; // 0x281 PushV
	func_655(var_219_bool); // 0x282 NEW_2
	var_220_bool = var_219_bool == 0; // 0x284 Not
	if(var_220_bool == 0) goto Label_647; // 0x285 JumpB
	goto Label_652; // 0x286 Jump
	
Label_647:
	ResetAAS(); // 0x287 Func
	var_221_int = 1; // 0x289 PushI
	var_184_int = var_184_int + var_221_int; // 0x28a Add2
	goto Label_590; // 0x28b Jump
	
Label_624:
	var_222_int = 1; // 0x270 PushI
	var_223_bool = var_185_int == var_222_int; // 0x271 Eq
	if(var_223_bool == 0) goto Label_638; // 0x272 JumpB
	var_224_int = 4; // 0x273 PushI
	rand(var_188_float, var_224_int); // 0x274 Func
	var_225_int = 1; // 0x276 PushI
	var_226_int = var_188_float + var_225_int; // 0x277 Add
	Sleep(var_226_int, var_189_bool); // 0x278 Func
	var_227_bool = var_189_bool == 0; // 0x27a Not
	if(var_227_bool == 0) goto Label_637; // 0x27b JumpB
...
Label_638:
	var_228_int = var_184_int; // 0x27e Push
	if(var_228_int == 0) goto Label_641; // 0x27f JumpB
	goto Label_652; // 0x280 Jump
}


func_1601(var_64_bool)
{
	var_64_bool = 0; // 0x641 MovB
...
func_833(var_0_object, var_62_bool)
{
	...
	func_1375(var_73_float, var_74_cvector, var_75_cvector); // 0x34c NEW_2
...
func_1603(var_11_object)
{
	var_12_object = Obj(); // 0x644 PushV
	var_12_object = var_11_object; // 0x645 Mov
	TaskCall(6); // 0x646 TaskCall
	func_849(var_12_object); // 0x647 NEW_2
	TaskReturn(); // 0x648 TaskReturn
	return 0; // 0x64a Return
}


func_453(var_174_bool)
{
	var_174_bool = 1; // 0x1c5 MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_82_object, var_83_object)
{
	...
	var_106_int = 510904; // 0x54 PushI
	SetMessage(var_106_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_107_int = 510905; // 0x59 PushI
	var_108_int = 35745; // 0x5a PushI
	var_109_int = 12053; // 0x5b PushI
	AddReply(var_107_int, var_108_int, var_109_int); // 0x5c TObjFunc
	var_110_int = 534166; // 0x5e PushI
	var_111_int = -1; // 0x5f PushI
	var_112_int = 35746; // 0x60 PushI
	AddReply(var_110_int, var_111_int, var_112_int); // 0x61 TObjFunc
	goto Label_102; // 0x63 Jump
	
Label_102:
	var_113_bool = 0; // 0x66 PushV
	func_1601(var_113_bool); // 0x67 NEW_2
...
Label_111:
	...
	func_1286(var_115_string); // 0x71 NEW_2
...
func_1488(var_50_object)
{
	var_52_string = "powder is given"; // 0x5d1 PushS
	Trace(var_52_string); // 0x5d2 Func
	var_53_object = Obj(); var_54_string = ""; var_55_int = 0; // 0x5d4 PushV
	var_53_object = var_50_object; // 0x5d5 Mov
	var_54_string = "powder"; // 0x5d6 MovS
	var_55_int = 1; // 0x5d7 MovI
	func_1414(var_53_object, var_54_string, var_55_int); // 0x5d8 NEW_2
...
{
	var_149_float = 0; var_150_cvector = CVector(0,0,0); var_151_cvector = CVector(0,0,0); var_152_bool = 0; var_153_object = Obj(); var_154_bool = 0; var_155_float = 0; var_156_cvector = CVector(0,0,0); var_157_cvector = CVector(0,0,0); var_158_bool = 0; var_159_object = Obj(); var_160_bool = 0; // 0x1d5 PushV
	var_0_object = 0; // 0x1d6 TMovB
	var_1_object = 0; // 0x1d7 TMovB
	var_161_float = 0.5; // 0x1d8 PushF
	rand(var_155_float, var_161_float); // 0x1d9 Func
	Sleep(var_155_float); // 0x1db Func
	
Label_477:
	var_162_bool = var_0_object == 0; // 0x1dd Not
	if(var_162_bool == 0) goto Label_527; // 0x1de JumpB
	var_163_bool = var_1_object == 0; // 0x1df Not
	if(var_163_bool == 0) goto Label_496; // 0x1e0 JumpB
	
Label_481:
	GetPosition(var_157_cvector); // 0x1e1 Func
	var_164_float = 0; // 0x1e3 PushV
	func_528(var_164_float); // 0x1e4 NEW_2
	GetRandomPFPointInCircle(var_156_cvector, var_157_cvector, var_164_float, var_158_bool); // 0x1e6 Func
	var_167_bool = var_158_bool; // 0x1e8 Push
	if(var_167_bool == 0) goto Label_491; // 0x1e9 JumpB
...
Label_497:
	var_168_object = Obj(); var_169_cvector = CVector(0,0,0); // 0x1f1 PushV
	var_169_cvector = var_156_cvector; // 0x1f2 Mov
	func_556(var_168_object, var_169_cvector); // 0x1f3 NEW_2
	var_159_object = var_168_object; // 0x1f4 Mov
	var_172_bool = var_159_object != 0; // 0x1f6 NullNeq
	if(var_172_bool == 0) goto Label_522; // 0x1f7 JumpB
	RotatePath(var_159_object, var_160_bool); // 0x1f8 Func
	var_173_bool = var_160_bool; // 0x1fa Push
	if(var_173_bool == 0) goto Label_521; // 0x1fb JumpB
	var_174_bool = 0; // 0x1fc PushV
	func_453(var_174_bool); // 0x1fd NEW_2
	FollowPath(var_159_object, var_174_bool, var_160_bool); // 0x1ff Func
	var_159_object = 0; // 0x201 SetNull
	var_175_bool = var_160_bool; // 0x202 Push
	if(var_175_bool == 0) goto Label_521; // 0x203 JumpB
...
Label_525:
	var_159_object = 0; // 0x20d SetNull
	goto Label_477; // 0x20e Jump
	
Label_522:
	var_229_int = 1; // 0x20a PushI
	Sleep(var_229_int); // 0x20b Func
	
Label_491:
	var_230_int = 1; // 0x1eb PushI
	Sleep(var_230_int); // 0x1ec Func
...
func_1365(var_42_cvector, var_43_cvector)
{
	var_50_float = 0; var_51_float = 0; // 0x555 PushV
	var_52_int = var_43_cvector | var_43_cvector; // 0x556 Or
	var_51_float = sqrt(var_52_int); // 0x557 Sqrt2
	var_53_float = 0.0; // 0x558 PushF
	var_54_bool = var_51_float < var_53_float; // 0x559 LT
	if(var_54_bool == 0) goto Label_1373; // 0x55a JumpB
	var_42_cvector = CVector(0.0, 0.0, 0.0); // 0x55b MovV
	return 2; // 0x55c Return
	
Label_1373:
	var_42_cvector = var_43_cvector / var_43_cvector; // 0x55d Div2
...
func_1499()
{
	func_1522(); // 0x5dd NEW_2
	var_90_bool = 0; var_91_string = ""; var_92_string = ""; // 0x5df PushV
	var_91_string = "quest_d3_03"; // 0x5e0 MovS
	var_92_string = "fail"; // 0x5e1 MovS
	func_1427(var_90_bool, var_91_string, var_92_string); // 0x5e2 NEW_2
...
Label_926:
	...
	func_1324(var_88_string); // 0x3a0 NEW_2
...
Label_1130:
	...
	func_1365(var_42_cvector, var_43_cvector); // 0x471 NEW_2
...
func_1375(var_73_float, var_74_cvector, var_75_cvector)
{
	var_76_int = var_74_cvector | var_75_cvector; // 0x560 Or
	var_77_int = var_74_cvector | var_74_cvector; // 0x561 Or
	var_78_int = var_75_cvector | var_75_cvector; // 0x562 Or
	var_79_float = var_77_int * var_78_int; // 0x563 Mult
	var_80_float = sqrt(var_79_float); // 0x564 Sqrt
	var_73_float = var_76_int / var_76_int; // 0x565 Div2
...
func_1509()
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x5e5 PushV
	var_24_int = 84; // 0x5e6 PushI
	var_25_int = 2; // 0x5e7 PushI
	var_26_int = 512166; // 0x5e8 PushI
	CreateDiaryEntry(var_23_object, var_24_int, var_25_int, var_26_int); // 0x5e9 Func
	var_27_bool = 0; var_28_object = Obj(); var_29_int = 0; // 0x5eb PushV
	var_28_object = var_23_object; // 0x5ec Mov
	var_29_int = 27; // 0x5ed MovI
	func_1548(var_27_bool, var_28_object, var_29_int); // 0x5ee NEW_2
	return 2; // 0x5f0 Return
}


func_1383(var_69_int, var_70_int)
{
	var_71_object = Obj(); var_72_object = Obj(); // 0x567 PushV
	CreateIntVector(var_72_object); // 0x568 Func
	add(var_69_int); // 0x56a ObjFunc
	add(var_70_int); // 0x56c ObjFunc
	var_73_int = 3; // 0x56e PushI
	SendWorldWndMessage(var_73_int, var_72_object); // 0x56f Func
...
func_1648(var_11_bool, var_12_object)
{
	var_13_bool = 0; var_14_object = Obj(); // 0x671 PushV
	var_14_object = var_12_object; // 0x672 Mov
	func_1046(var_13_bool, var_14_object); // 0x673 NEW_2
	var_11_bool = var_13_bool; // 0x674 Mov
...
func_1395(var_59_object, var_60_int)
{
	var_61_int = 0; var_62_int = 0; var_63_bool = 0; var_64_int = 0; var_65_int = 0; var_66_bool = 0; // 0x573 PushV
	GetItemID(var_64_int); // 0x574 ObjFunc
	var_67_string = "Category"; // 0x576 PushS
	GetInvItemProperty(var_65_int, var_64_int, var_67_string); // 0x577 Func
	AddItem(var_66_bool, var_59_object, var_65_int, var_60_int); // 0x579 ObjFunc
	var_68_bool = var_66_bool == 0; // 0x57b Not
	if(var_68_bool == 0) goto Label_1408; // 0x57c JumpB
	DropItems(var_59_object, var_60_int); // 0x57d ObjFunc
	goto Label_1413; // 0x57f Jump
	
Label_1413:
	return 6; // 0x585 Return
	
Label_1408:
	var_69_int = 0; var_70_int = 0; // 0x580 PushV
	var_69_int = var_64_int; // 0x581 Mov
	var_70_int = var_60_int; // 0x582 Mov
	func_1383(var_69_int, var_70_int); // 0x583 NEW_2
}


func_1522()
{
	var_82_object = Obj(); var_83_object = Obj(); // 0x5f2 PushV
	var_84_int = 86; // 0x5f3 PushI
	var_85_int = 2; // 0x5f4 PushI
	var_86_int = 512168; // 0x5f5 PushI
	CreateDiaryEntry(var_83_object, var_84_int, var_85_int, var_86_int); // 0x5f6 Func
	var_87_bool = 0; var_88_object = Obj(); var_89_int = 0; // 0x5f8 PushV
	var_88_object = var_83_object; // 0x5f9 Mov
	var_89_int = 27; // 0x5fa MovI
	func_1548(var_87_bool, var_88_object, var_89_int); // 0x5fb NEW_2
...
func_1269()
{
	var_133_bool = 0; var_134_bool = 0; // 0x4f5 PushV
	CameraSwitchToNormal(); // 0x4f6 Func
	var_135_bool = 0; // 0x4f8 PushV
	func_1601(var_135_bool); // 0x4f9 NEW_2
	if(var_135_bool == 0) goto Label_1277; // 0x4fb JumpB
...
Label_1277:
	var_136_string = "head"; // 0x4fd PushS
	HasAnimationTrack(var_134_bool, var_136_string); // 0x4fe Func
	var_137_bool = var_134_bool; // 0x500 Push
	if(var_137_bool == 0) goto Label_1285; // 0x501 JumpB
	var_138_string = "head"; // 0x502 PushS
	UnlookAsync(var_138_string); // 0x503 Func
}


func_1655(var_47_object)
{
	var_48_object = Obj(); // 0x678 PushV
	var_48_object = var_47_object; // 0x679 Mov
	TaskCall(5); // 0x67a TaskCall
	func_692(var_49_object, var_50_cvector, var_51_bool, var_48_object); // 0x67b NEW_2
	TaskReturn(); // 0x67c TaskReturn
	return 0; // 0x67e Return
}


func_1535(var_36_object)
{
	var_37_object = Obj(); var_38_object = Obj(); // 0x5ff PushV
	GetDiaryRoot(var_38_object); // 0x600 Func
	var_39_bool = var_38_object == 0; // 0x602 Not
	if(var_39_bool == 0) goto Label_1545; // 0x603 JumpB
	var_40_string = "Can't retrieve diary root"; // 0x604 PushS
	Trace(var_40_string); // 0x605 Func
	var_36_object = 0; // 0x607 MovB
	return 2; // 0x608 Return
	
Label_1545:
	var_36_object = var_38_object; // 0x609 Mov
