task_0_event_17(var_0_bool, var_1_object, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_1736(var_14_bool, var_15_string, var_16_string); // 0x16 NEW_2
...
task_0_event_1(var_0_bool, var_1_object, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_1736(var_14_bool, var_15_string, var_16_string); // 0x26 NEW_2
...
task_0_event_3(var_0_bool, var_1_object, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_1736(var_14_bool, var_15_string, var_16_string); // 0x36 NEW_2
...
Label_72:
	var_513_string = ""; // 0x48 PushV
	var_513_string = var_10_bool; // 0x49 Mov
	func_81(var_10_bool, var_513_string); // 0x4a NEW_2
}
...
task_2_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_1748(var_13_object); // 0x36e NEW_2
...
task_3_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_1774(var_14_object); // 0x45e NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x755 PushV
	var_14_object = var_10_object; // 0x756 Mov
	var_15_int = var_11_int; // 0x757 Mov
	var_16_float = var_12_float; // 0x758 Mov
	func_1486(var_14_object, var_15_int, var_16_float); // 0x759 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x75d PushV
	var_16_object = var_10_object; // 0x75e Mov
	var_17_int = var_11_int; // 0x75f Mov
	var_18_float = var_12_float; // 0x760 Mov
	var_19_cvector = var_14_cvector; // 0x761 Mov
	var_20_cvector = var_15_cvector; // 0x762 Mov
	func_1554(var_18_float, var_19_cvector, var_20_cvector); // 0x763 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x766 PushV
	var_14_string = "health"; // 0x767 PushS
	var_15_bool = var_11_string == var_14_string; // 0x768 Eq
	if(var_15_bool == 0) goto Label_1906; // 0x769 JumpB
	var_16_string = "health"; // 0x76a PushS
	GetProperty(var_16_string, var_13_float); // 0x76b Func
	var_17_int = 0; // 0x76d PushI
	var_18_bool = var_13_float <= var_17_int; // 0x76e LE
	if(var_18_bool == 0) goto Label_1906; // 0x76f JumpB
	SignalDeath(var_10_object); // 0x770 Func
...
{
	var_11_object = Obj(); // 0x774 PushV
	var_11_object = var_10_object; // 0x775 Mov
	func_1853(var_11_object); // 0x776 NEW_2
...
Label_1702:
	...
	func_1726(var_29_float); // 0x6a8 NEW_2
...
Label_1323:
	var_454_string = "armor"; // 0x52b PushS
	GetProperty(var_454_string, var_407_int); // 0x52c ObjFunc
}
...
Label_309:
	...
	var_497_string = "all"; // 0x137 PushS
	var_498_string = "fjump"; // 0x138 PushS
	PlayAnimation(var_497_string, var_498_string); // 0x139 Func
	WaitForAnimEnd(); // 0x13b Func
	func_795(var_46_float); // 0x13e NEW_2
	var_499_cvector = CVector(0.0, 0.0, 0.0); // 0x140 PushVec
	SetSpeed(var_499_cvector); // 0x141 Func
	Stop(); // 0x143 Func
	StopAsync(); // 0x145 Func
	var_500_bool = 0; // 0x147 PushV
	func_752(var_46_float, var_500_bool); // 0x148 NEW_2
	var_501_bool = var_500_bool == 0; // 0x14a Not
	if(var_501_bool == 0) goto Label_355; // 0x14b JumpB
	var_502_bool = 0; var_503_object = Obj(); // 0x14c PushV
	var_503_object = var_0_bool; // 0x14d MovT
	func_1418(var_502_bool, var_503_object); // 0x14e NEW_2
	var_504_bool = var_502_bool == 0; // 0x150 Not
	if(var_504_bool == 0) goto Label_339; // 0x151 JumpB
...
Label_339:
	...
	var_505_float = var_24_float * var_24_float; // 0x159 Mult
	var_506_bool = var_43_float < var_505_float; // 0x15a LT
	if(var_506_bool == 0) goto Label_355; // 0x15b JumpB
	var_507_bool = 0; var_508_float = 0; // 0x15c PushV
	var_508_float = var_24_float; // 0x15d Mov
	func_456(var_46_float, var_507_bool, var_508_float); // 0x15e NEW_2
	var_509_bool = var_507_bool == 0; // 0x160 Not
	if(var_509_bool == 0) goto Label_355; // 0x161 JumpB
	goto Label_365; // 0x162 Jump
	
Label_356:
	var_510_bool = 0; var_511_float = 0; // 0x164 PushV
	var_511_float = var_24_float; // 0x165 Mov
	func_456(var_46_float, var_510_bool, var_511_float); // 0x166 NEW_2
	var_512_bool = var_510_bool == 0; // 0x168 Not
	if(var_512_bool == 0) goto Label_363; // 0x169 JumpB
...
func_1818()
{
	var_61_int = 0; var_62_bool = 0; var_63_int = 0; var_64_bool = 0; // 0x71a PushV
	var_65_int = 0; // 0x71b PushI
	ClearSubContainer(var_65_int); // 0x71c Func
	var_66_int = 0; var_67_int = 0; // 0x71e PushV
	var_66_int = 300; // 0x71f MovI
	var_67_int = 750; // 0x720 MovI
	func_1787(var_66_int, var_67_int); // 0x721 NEW_2
	var_85_string = ""; var_86_int = 0; var_87_int = 0; // 0x723 PushV
	var_85_string = "Knife"; // 0x724 MovS
	var_86_int = 1; // 0x725 MovI
	var_87_int = 8; // 0x726 MovI
	func_1590(var_85_string, var_86_int, var_87_int); // 0x727 NEW_2
	var_96_string = ""; var_97_int = 0; var_98_int = 0; // 0x729 PushV
	var_96_string = "lockpick"; // 0x72a MovS
	var_97_int = 1; // 0x72b MovI
	var_98_int = 6; // 0x72c MovI
	func_1590(var_96_string, var_97_int, var_98_int); // 0x72d NEW_2
	var_99_int = 0; var_100_string = ""; // 0x72f PushV
	var_100_string = "grabitel_mark"; // 0x730 MovS
	func_1848(var_99_int, var_100_string); // 0x731 NEW_2
	var_101_int = 0; // 0x733 PushI
	var_102_int = 1; // 0x734 PushI
	AddItem(var_64_bool, var_99_int, var_101_int, var_102_int); // 0x735 Func
...
func_795(var_0_bool)
{
	...
	func_1748(var_118_object); // 0x31d NEW_2
...
func_417(var_0_bool, var_380_float, var_381_int)
{
	...
	var_455_int = 0; // 0x1bc PushV
	func_800(var_455_int); // 0x1bd NEW_2
	ReportHit(var_0_bool, var_455_int, var_387_float, var_386_float); // 0x1bf Func
	var_456_object = Obj(); var_457_float = 0; // 0x1c1 PushV
	var_456_object = var_385_object; // 0x1c2 Mov
	var_457_float = var_387_float; // 0x1c3 Mov
...
func_1716(var_450_float)
{
	...
	var_453_int = 15; // 0x6b9 PushI
	SendWorldWndMessage(var_453_int, var_452_object); // 0x6ba Func
...
func_823(var_2_object, var_125_bool, var_126_object, var_127_float, var_128_float, var_129_bool, var_130_bool)
{
	...
	func_1748(var_138_object); // 0x33a NEW_2
...
func_1848(var_78_int, var_79_string)
{
	var_80_int = 0; var_81_int = 0; // 0x738 PushV
	GetInvItemByName(var_81_int, var_79_string); // 0x739 Func
	var_78_int = var_81_int; // 0x73b Mov
...
{
	var_12_bool = 0; var_13_string = ""; var_14_string = ""; // 0x73e PushV
	var_13_string = "quest_d4_03"; // 0x73f MovS
	var_14_string = "death"; // 0x740 MovS
	func_1736(var_12_bool, var_13_string, var_14_string); // 0x741 NEW_2
	var_18_bool = 0; var_19_object = Obj(); // 0x743 PushV
	var_19_object = var_11_object; // 0x744 Mov
	func_1265(var_18_bool, var_19_object); // 0x745 NEW_2
	if(var_18_bool == 0) goto Label_1869; // 0x747 JumpB
	var_22_bool = 0; var_23_object = Obj(); var_24_float = 0; // 0x748 PushV
	var_23_object = var_11_object; // 0x749 Mov
	var_24_float = 0.03; // 0x74a MovF
	func_1681(var_22_bool, var_23_object, var_24_float); // 0x74b NEW_2
	
Label_1869:
	var_60_object = Obj(); // 0x74d PushV
	var_60_object = var_11_object; // 0x74e Mov
	TaskCall(3); // 0x74f TaskCall
	func_1079(var_60_object); // 0x750 NEW_2
	TaskReturn(); // 0x751 TaskReturn
...
{
	var_30_object = Obj(); var_31_object = Obj(); // 0x6be PushV
	CreateFloatVector(var_31_object); // 0x6bf Func
	add(var_29_float); // 0x6c1 ObjFunc
	var_32_int = 16; // 0x6c3 PushI
	SendWorldWndMessage(var_32_int, var_31_object); // 0x6c4 Func
...
func_1736(var_12_bool, var_13_string, var_14_string)
{
	var_15_object = Obj(); var_16_object = Obj(); // 0x6c8 PushV
	FindActor(var_16_object, var_13_string); // 0x6c9 Func
	var_17_bool = var_16_object == 0; // 0x6cb NullEq
	if(var_17_bool == 0) goto Label_1743; // 0x6cc JumpB
	var_12_bool = 0; // 0x6cd MovB
	return 2; // 0x6ce Return
	
Label_1743:
	Trigger(var_16_object, var_14_string); // 0x6cf Func
	var_12_bool = 1; // 0x6d1 MovB
...
Label_492:
	...
	var_458_string = "all"; // 0x1f1 PushS
	var_459_string = "attack_middle"; // 0x1f2 PushS
	var_460_int = var_459_string + var_349_int; // 0x1f3 Add
	HasAnimation(var_350_bool, var_458_string, var_460_int); // 0x1f4 Func
	var_461_bool = var_350_bool; // 0x1f6 Push
	if(var_461_bool == 0) goto Label_573; // 0x1f7 JumpB
	func_1757(); // 0x1f9 NEW_2
	var_462_string = "all"; // 0x1fb PushS
	var_463_string = "attack_middle"; // 0x1fc PushS
	var_464_int = var_463_string + var_349_int; // 0x1fd Add
	PlayAnimation(var_462_string, var_464_int); // 0x1fe Func
	WaitForAnimEnd(); // 0x200 Func
	func_795(var_352_string); // 0x203 NEW_2
	var_465_bool = 0; var_466_object = Obj(); // 0x205 PushV
	var_466_object = var_0_bool; // 0x206 MovT
	func_1418(var_465_bool, var_466_object); // 0x207 NEW_2
	var_467_bool = var_465_bool == 0; // 0x209 Not
	if(var_467_bool == 0) goto Label_527; // 0x20a JumpB
	StopAsync(); // 0x20b Func
	var_343_bool = 0; // 0x20d MovB
	return 8; // 0x20e Return
	
Label_527:
	var_468_float = 0; var_469_int = 0; // 0x20f PushV
	var_468_float = var_344_float; // 0x210 Mov
	var_469_int = var_349_int; // 0x211 Mov
	func_417(var_352_string, var_468_float, var_469_int); // 0x212 NEW_2
	var_351_int = 1; // 0x214 MovI
	
Label_533:
	var_470_string = "attack_middle"; // 0x215 PushS
	var_471_int = var_470_string + var_349_int; // 0x216 Add
	var_472_string = "_"; // 0x217 PushS
	var_473_int = var_471_int + var_472_string; // 0x218 Add
	var_352_string = var_473_int + var_351_int; // 0x219 Add2
	var_474_string = "all"; // 0x21a PushS
	HasAnimation(var_350_bool, var_474_string, var_352_string); // 0x21b Func
	var_475_bool = var_350_bool == 0; // 0x21d Not
	if(var_475_bool == 0) goto Label_544; // 0x21e JumpB
	goto Label_573; // 0x21f Jump
	
Label_573:
	var_476_bool = 0; // 0x23d PushB
	SetAttackState(var_476_bool); // 0x23e Func
	var_477_string = "all"; // 0x240 PushS
	var_478_string = "attack_end"; // 0x241 PushS
	var_479_int = var_478_string + var_349_int; // 0x242 Add
	PlayAnimation(var_477_string, var_479_int); // 0x243 Func
	var_480_bool = 0; // 0x245 PushV
	func_809(var_480_bool); // 0x246 NEW_2
	if(var_480_bool == 0) goto Label_591; // 0x248 JumpB
	var_481_bool = 0; var_482_float = 0; // 0x249 PushV
	var_482_float = 0.75; // 0x24a MovF
	func_593(var_481_bool, var_482_float); // 0x24b NEW_2
...
Label_544:
	func_1757(); // 0x221 NEW_2
	var_490_string = "all"; // 0x223 PushS
	PlayAnimation(var_490_string, var_352_string); // 0x224 Func
	WaitForAnimEnd(); // 0x226 Func
	func_795(var_352_string); // 0x229 NEW_2
	var_491_bool = 0; var_492_object = Obj(); // 0x22b PushV
	var_492_object = var_0_bool; // 0x22c MovT
	func_1418(var_491_bool, var_492_object); // 0x22d NEW_2
	var_493_bool = var_491_bool == 0; // 0x22f Not
	if(var_493_bool == 0) goto Label_565; // 0x230 JumpB
	StopAsync(); // 0x231 Func
	var_343_bool = 0; // 0x233 MovB
	return 8; // 0x234 Return
	
Label_565:
	var_494_float = 0; var_495_int = 0; // 0x235 PushV
	var_494_float = var_344_float; // 0x236 Mov
	var_495_int = var_349_int; // 0x237 Mov
	func_417(var_352_string, var_494_float, var_495_int); // 0x238 NEW_2
	var_496_int = 1; // 0x23a PushI
	var_351_int = var_351_int + var_496_int; // 0x23b Add2
...
func_81(var_0_bool, var_513_string)
{
	var_514_bool = 0; var_515_bool = 0; // 0x51 PushV
	var_516_string = "cleanup"; // 0x52 PushS
	var_517_bool = var_513_string == var_516_string; // 0x53 Eq
	if(var_517_bool == 0) goto Label_104; // 0x54 JumpB
	var_0_bool = 1; // 0x55 TMovB
	IsLoaded(var_515_bool); // 0x56 Func
	var_518_bool = 0; // 0x58 PushV
	var_518_bool = 0; // 0x59 MovB
	var_519_bool = var_515_bool == 0; // 0x5a Not
	if(var_519_bool == 0) goto Label_97; // 0x5b JumpB
	var_520_bool = 0; // 0x5c PushV
	func_125(var_520_bool); // 0x5d NEW_2
	if(var_520_bool == 0) goto Label_97; // 0x5f JumpB
	var_518_bool = 1; // 0x60 MovB
	
Label_97:
	if(var_518_bool == 0) goto Label_103; // 0x61 JumpB
	var_521_object = Obj(); // 0x62 PushV
	func_1642(var_521_object); // 0x63 NEW_2
	RemoveActor(var_521_object); // 0x65 Func
...
Label_104:
	var_522_string = "restore"; // 0x68 PushS
	var_523_bool = var_513_string == var_522_string; // 0x69 Eq
	if(var_523_bool == 0) goto Label_108; // 0x6a JumpB
	var_0_bool = 0; // 0x6b TMovB
}


func_593(var_481_bool, var_482_float)
{
	var_483_float = 0; var_484_bool = 0; var_485_float = 0; var_486_bool = 0; // 0x251 PushV
	rand(var_485_float); // 0x252 Func
	var_487_bool = var_485_float < var_482_float; // 0x254 LT
	if(var_487_bool == 0) goto Label_613; // 0x255 JumpB
	
Label_598:
	IsAnimationPlaying(var_486_bool); // 0x256 Func
	var_488_bool = var_486_bool == 0; // 0x258 Not
	if(var_488_bool == 0) goto Label_603; // 0x259 JumpB
...
Label_618:
	var_481_bool = 0; // 0x26a MovB
	return 4; // 0x26b Return
	
Label_603:
	var_489_bool = 0; // 0x25b PushV
	func_691(var_489_bool); // 0x25c NEW_2
	if(var_489_bool == 0) goto Label_609; // 0x25e JumpB
	var_481_bool = 1; // 0x25f MovB
...
Label_613:
	...
	func_795(var_486_bool); // 0x268 NEW_2
}


func_1748(var_13_object)
{
	var_14_bool = 0; var_15_bool = 0; // 0x6d4 PushV
	IsPlayerActor(var_13_object, var_15_bool); // 0x6d5 Func
	var_16_bool = var_15_bool; // 0x6d7 Push
	if(var_16_bool == 0) goto Label_1756; // 0x6d8 JumpB
	var_17_string = "attack"; // 0x6d9 PushS
	PlayGlobalMusic(var_17_string); // 0x6da Func
...
func_1757()
{
	var_355_object = Obj(); var_356_object = Obj(); // 0x6dd PushV
	GetScene(var_356_object); // 0x6de Func
	var_357_string = "battle"; // 0x6e0 PushS
	var_358_object = Obj(); // 0x6e1 PushV
	func_1642(var_358_object); // 0x6e2 NEW_2
	BroadcastMessage(var_357_string, var_358_object, var_356_object); // 0x6e4 Func
...
{
	var_16_int = 0; var_17_int = 0; // 0x6e8 PushV
	var_18_string = "branch"; // 0x6e9 PushS
	GetVariable(var_18_string, var_17_int); // 0x6ea Func
	var_15_int = var_17_int; // 0x6ec Mov
...
{
	var_15_int = 0; // 0x6ef PushV
	func_1768(var_15_int); // 0x6f0 NEW_2
	var_19_int = 1; // 0x6f2 PushI
	var_20_bool = var_15_int == var_19_int; // 0x6f3 Eq
	if(var_20_bool == 0) goto Label_1784; // 0x6f4 JumpB
	WorkWithCorpse(var_14_object); // 0x6f5 Func
	goto Label_1786; // 0x6f7 Jump
	
Label_1786:
	return 0; // 0x6fa Return
	
Label_1784:
	Barter(var_14_object); // 0x6f8 Func
}
...
func_1787(var_66_int, var_67_int)
{
	var_68_int = 0; var_69_bool = 0; var_70_int = 0; var_71_bool = 0; // 0x6fb PushV
	var_72_bool = var_66_int > var_67_int; // 0x6fc GT
	if(var_72_bool == 0) goto Label_1794; // 0x6fd JumpB
	var_73_string = "GenerateMoney: iMin > iMax"; // 0x6fe PushS
	Trace(var_73_string); // 0x6ff Func
	return 4; // 0x701 Return
	
Label_1794:
	var_70_int = 0; // 0x702 MovI
	var_74_bool = var_66_int != var_67_int; // 0x703 Neq
	if(var_74_bool == 0) goto Label_1801; // 0x704 JumpB
	var_75_int = var_67_int - var_66_int; // 0x705 Sub
	irand(var_70_int, var_75_int); // 0x706 Func
	goto Label_1805; // 0x708 Jump
	
Label_1805:
	var_70_int = var_70_int + var_66_int; // 0x70d Add2
	var_76_int = 0; // 0x70e PushI
	var_77_bool = var_70_int == var_76_int; // 0x70f Eq
	if(var_77_bool == 0) goto Label_1810; // 0x710 JumpB
	return 4; // 0x711 Return
	
Label_1810:
	var_78_int = 0; var_79_string = ""; // 0x712 PushV
	var_79_string = "Money"; // 0x713 MovS
	func_1848(var_78_int, var_79_string); // 0x714 NEW_2
	var_82_int = 0; // 0x716 PushI
	AddItem(var_71_bool, var_78_int, var_82_int, var_70_int); // 0x717 Func
	return 4; // 0x719 Return
	
Label_1801:
	var_83_int = 0; // 0x709 PushI
	var_84_bool = var_66_int == var_83_int; // 0x70a Eq
	if(var_84_bool == 0) goto Label_1805; // 0x70b JumpB
