...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_85_object, var_86_object)
{
	...
	var_109_int = 536353; // 0x54 PushI
	SetMessage(var_109_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_110_int = 536354; // 0x59 PushI
	var_111_int = 38137; // 0x5a PushI
	var_112_int = 38136; // 0x5b PushI
	AddReply(var_110_int, var_111_int, var_112_int); // 0x5c TObjFunc
	var_113_int = 536361; // 0x5e PushI
	var_114_int = 38137; // 0x5f PushI
	var_115_int = 38143; // 0x60 PushI
	AddReply(var_113_int, var_114_int, var_115_int); // 0x61 TObjFunc
	var_116_int = 536362; // 0x63 PushI
	var_117_int = 38137; // 0x64 PushI
	var_118_int = 38145; // 0x65 PushI
