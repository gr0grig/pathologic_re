...
Label_191:
	...
	func_828(var_47_object); // 0xcd NEW_2
...
Label_213:
	...
	func_840(var_58_object); // 0xd7 NEW_2
...
Label_431:
	...
	func_877(var_156_bool); // 0x1b1 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_759(var_27_object); // 0x207 NEW_2
...
func_770()
{
	var_13_bool = 0; // 0x302 PushV
	func_877(var_13_bool); // 0x303 NEW_2
	if(var_13_bool == 0) goto Label_776; // 0x305 JumpB
...
func_643(var_25_bool, var_27_float)
{
	...
	func_777(var_52_cvector, var_53_cvector); // 0x29e NEW_2
...
Label_684:
	...
	CameraTransit(var_43_cvector, var_41_cvector); // 0x2ae Func
	var_65_float = GetByIndex(var_42_cvector, 0); // 0x2b0 PushE
	var_66_float = GetByIndex(var_42_cvector, 2); // 0x2b1 PushE
	Rotate(var_65_float, var_66_float); // 0x2b2 Func
	var_67_bool = 0; // 0x2b4 PushV
	func_877(var_67_bool); // 0x2b5 NEW_2
	if(var_67_bool == 0) goto Label_697; // 0x2b7 JumpB
	goto Label_705; // 0x2b8 Jump
	
Label_705:
	CameraWaitForPlayFinish(); // 0x2c1 Func
	ResumeWorld(); // 0x2c3 Func
	var_25_bool = 1; // 0x2c5 MovB
	return 18; // 0x2c6 Return
	
Label_697:
	var_68_string = "head"; // 0x2b9 PushS
	HasAnimationTrack(var_45_bool, var_68_string); // 0x2ba Func
	var_69_bool = var_45_bool; // 0x2bc Push
	if(var_69_bool == 0) goto Label_705; // 0x2bd JumpB
	var_70_string = "head"; // 0x2be PushS
	LookAsyncCamera(var_70_string); // 0x2bf Func
}


func_711()
{
	var_153_bool = 0; var_154_bool = 0; // 0x2c7 PushV
	CameraSwitchToNormal(); // 0x2c8 Func
	var_155_bool = 0; // 0x2ca PushV
	func_877(var_155_bool); // 0x2cb NEW_2
	if(var_155_bool == 0) goto Label_719; // 0x2cd JumpB
...
Label_719:
	var_156_string = "head"; // 0x2cf PushS
	HasAnimationTrack(var_154_bool, var_156_string); // 0x2d0 Func
	var_157_bool = var_154_bool; // 0x2d2 Push
	if(var_157_bool == 0) goto Label_727; // 0x2d3 JumpB
	var_158_string = "head"; // 0x2d4 PushS
	UnlookAsync(var_158_string); // 0x2d5 Func
}


func_840(var_121_bool)
{
	var_123_int = 0; var_124_string = ""; // 0x349 PushV
	var_124_string = "ood5Whitemask2"; // 0x34a MovS
	func_787(var_123_int, var_124_string); // 0x34b NEW_2
	var_125_int = 0; // 0x34d PushI
	var_126_bool = var_123_int == var_125_int; // 0x34e Eq
	if(var_126_bool == 0) goto Label_850; // 0x34f JumpB
	var_121_bool = 1; // 0x350 MovB
	return 0; // 0x351 Return
	
Label_850:
	var_121_bool = 0; // 0x352 MovB
	return 0; // 0x353 Return
}


func_777(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x309 PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x30a Or
	var_56_float = sqrt(var_57_int); // 0x30b Sqrt2
	var_58_float = 0.0; // 0x30c PushF
	var_59_bool = var_56_float < var_58_float; // 0x30d LT
	if(var_59_bool == 0) goto Label_785; // 0x30e JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x30f MovV
	return 2; // 0x310 Return
	
Label_785:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x311 Div2
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_85_object, var_86_object)
{
	...
	func_828(var_111_object); // 0x5b NEW_2
	if(var_110_bool == 0) goto Label_99; // 0x5d JumpB
	var_118_int = 502917; // 0x5e PushI
	var_119_int = 3252; // 0x5f PushI
	var_120_int = 3243; // 0x60 PushI
...
Label_126:
	...
	func_728(var_135_string); // 0x80 NEW_2
...
func_147(var_2_object, var_92_string)
{
	...
	func_877(var_93_bool); // 0x95 NEW_2
...
Label_165:
	func_744(var_96_string, var_97_bool); // 0xa5 NEW_2
...
func_787(var_112_int, var_113_string)
{
	var_114_int = 0; var_115_int = 0; // 0x313 PushV
	GetVariable(var_113_string, var_115_int); // 0x314 Func
	var_112_int = var_115_int; // 0x316 Mov
...
func_852(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x354 PushV
	var_79_string = "branch"; // 0x355 PushS
	GetVariable(var_79_string, var_78_int); // 0x356 Func
	var_80_int = 0; // 0x358 PushI
	var_81_bool = var_78_int == var_80_int; // 0x359 Eq
	if(var_81_bool == 0) goto Label_862; // 0x35a JumpB
	var_76_int = 1; // 0x35b MovI
	return 2; // 0x35c Return
	
Label_862:
	var_82_int = 1; // 0x35e PushI
	var_83_bool = var_78_int == var_82_int; // 0x35f Eq
	if(var_83_bool == 0) goto Label_867; // 0x360 JumpB
	var_76_int = 2; // 0x361 MovI
	return 2; // 0x362 Return
	
Label_867:
	var_76_int = 3; // 0x363 MovI
	return 2; // 0x364 Return
}


func_792(var_42_string, var_43_int)
{
	var_44_string = ""; var_45_string = ""; // 0x318 PushV
	var_45_string = "idle"; // 0x319 MovS
	var_46_int = var_43_int; // 0x31a Push
	if(var_46_int == 0) goto Label_797; // 0x31b JumpB
	var_45_string = var_45_string + var_43_int; // 0x31c Add2
	
Label_797:
	var_42_string = var_45_string; // 0x31d Mov
	return 2; // 0x31e Return
}


func_728(var_135_string)
{
	var_136_bool = 0; var_137_float = 0; var_138_float = 0; var_139_bool = 0; var_140_float = 0; var_141_float = 0; // 0x2d8 PushV
	lshHasAnimation(var_139_bool, var_135_string); // 0x2d9 Func
	var_142_bool = var_139_bool; // 0x2db Push
	if(var_142_bool == 0) goto Label_739; // 0x2dc JumpB
	lshGetAnimTimes(var_135_string, var_140_float, var_141_float); // 0x2dd Func
	var_143_bool = 0; // 0x2df PushB
	lshPlayAnimation(var_140_float, var_141_float, var_143_bool); // 0x2e0 Func
...
Label_739:
	var_144_string = "Can't find lsh animation : "; // 0x2e3 PushS
	var_145_int = var_144_string + var_135_string; // 0x2e4 Add
	Trace(var_145_int); // 0x2e5 Func
}


func_799(var_36_int)
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x31f PushV
	var_39_int = 0; // 0x320 MovI
	
Label_801:
	var_41_string = "all"; // 0x321 PushS
	var_42_string = ""; var_43_int = 0; // 0x322 PushV
	var_43_int = var_39_int; // 0x323 Mov
	func_792(var_42_string, var_43_int); // 0x324 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x326 Func
	var_47_bool = var_40_bool == 0; // 0x328 Not
	if(var_47_bool == 0) goto Label_811; // 0x329 JumpB
	goto Label_814; // 0x32a Jump
	
Label_814:
	var_36_int = var_39_int; // 0x32e Mov
	return 4; // 0x32f Return
	
Label_811:
	var_48_int = 1; // 0x32b PushI
	var_39_int = var_39_int + var_48_int; // 0x32c Add2
	goto Label_801; // 0x32d Jump
}
...
Label_553:
	...
	func_799(var_36_int); // 0x22a NEW_2
...
Label_568:
	...
	func_792(var_58_string, var_59_int); // 0x246 NEW_2
...
func_871(var_72_int)
{
	var_72_int = 503354; // 0x367 MovI
	return 0; // 0x368 Return
}


func_744(var_96_string, var_97_bool)
{
	var_100_bool = 0; var_101_float = 0; var_102_float = 0; var_103_bool = 0; var_104_float = 0; var_105_float = 0; // 0x2e8 PushV
	lshHasAnimation(var_103_bool, var_96_string); // 0x2e9 Func
	var_106_bool = var_103_bool; // 0x2eb Push
	if(var_106_bool == 0) goto Label_754; // 0x2ec JumpB
	lshGetAnimTimes(var_96_string, var_104_float, var_105_float); // 0x2ed Func
	lshPlayAnimation(var_104_float, var_105_float, var_97_bool); // 0x2ef Func
	goto Label_758; // 0x2f1 Jump
	
Label_758:
	return 6; // 0x2f6 Return
	
Label_754:
	var_107_string = "Can't find lsh animation : "; // 0x2f2 PushS
	var_108_int = var_107_string + var_96_string; // 0x2f3 Add
	Trace(var_108_int); // 0x2f4 Func
}


func_873(var_74_string)
{
	var_74_string = "ui/NPC_wmask.png"; // 0x369 MovS
...
{
	var_75_string = "ui/NPC_wmask_b.png"; // 0x36b MovS
...
func_877(var_67_bool)
{
	var_67_bool = 0; // 0x36d MovB
	return 0; // 0x36e Return
}


func_759(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x2f7 PushV
	GetEyesHeight(var_30_float); // 0x2f8 ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x2fa MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x2fb PushE
	var_32_float = var_30_float; // 0x2fc Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x2fd PopE
	var_33_string = "head"; // 0x2fe PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x2ff Func
...
func_816()
{
	var_18_string = "ood5Whitemask1"; // 0x331 PushS
	var_19_int = 1; // 0x332 PushI
	SetVariable(var_18_string, var_19_int); // 0x333 Func
...
func_822()
{
	var_24_string = "ood5Whitemask2"; // 0x337 PushS
	var_25_int = 1; // 0x338 PushI
	SetVariable(var_24_string, var_25_int); // 0x339 Func
...
func_828(var_110_bool)
{
	var_112_int = 0; var_113_string = ""; // 0x33d PushV
	var_113_string = "ood5Whitemask1"; // 0x33e MovS
	func_787(var_112_int, var_113_string); // 0x33f NEW_2
	var_116_int = 0; // 0x341 PushI
	var_117_bool = var_112_int == var_116_int; // 0x342 Eq
	if(var_117_bool == 0) goto Label_838; // 0x343 JumpB
	var_110_bool = 1; // 0x344 MovB
	return 0; // 0x345 Return
	
Label_838:
	var_110_bool = 0; // 0x346 MovB
