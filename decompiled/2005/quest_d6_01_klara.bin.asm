...
0x67a: @ StopWorld()
0x67b: Pop(0)
0x67c: @ CameraTransit(Stack[-3], Stack[-5])
0x67d: Pop(0)
0x67e: Push(CvectorIndex(Stack[-4], 0))
0x67f: Push(CvectorIndex(Stack[-5], 2))
0x680: @ Rotate(Stack[-2], Stack[-1])
0x681: Pop(2)
...
0x687: Push("head")
0x688: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x689: Pop(1)
0x68a: Push(Stack[-1])
0x68b: IF (Stack[-1] == 0) GOTO 0x68f; Pop(1)

0x68c: Push("head")
0x68d: @ LookAsyncCamera(Stack[-1])
0x68e: Pop(1)
0x68f: @ CameraWaitForPlayFinish()
0x690: Pop(0)
0x691: @ ResumeWorld()
0x692: Pop(0)
0x693: Stack[-21] = (bool) 1
0x694: Return(); Pop(18)

0x695: PushEmpty(bool, bool)
0x696: @ CameraSwitchToNormal()
0x697: Pop(0)
...
0x69d: Push("head")
0x69e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x69f: Pop(1)
0x6a0: Push(Stack[-1])
0x6a1: IF (Stack[-1] == 0) GOTO 0x6a5; Pop(1)

0x6a2: Push("head")
0x6a3: @ UnlookAsync(Stack[-1])
0x6a4: Pop(1)
0x6a5: Return(); Pop(2)

0x6a6: PushEmpty(int, int, int, int)
0x6a7: Push("voice_common")
0x6a8: @ GetVariable(Stack[-1], Stack[-3])
0x6a9: Pop(1)
0x6aa: Push(Stack[-2])
0x6ab: IF (Stack[-1] == 0) GOTO 0x6cc; Pop(1)

0x6ac: PushEmpty(bool, object)
0x6ad: Stack[-1] = Stack[-7]
0x6ae: Call2 0x6e0
...
0x6b8: Stack[-6] = (bool) 0
0x6b9: Return(); Pop(4)

0x6ba: Push((int) 2)
0x6bb: @ irand(Stack[-2], Stack[-1])
0x6bc: Pop(1)
0x6bd: Push(Stack[-1])
0x6be: IF (Stack[-1] == 0) GOTO 0x6c7; Pop(1)

0x6bf: Push("voice_common")
0x6c0: Push((int) 1)
0x6c1: Pop(1); Push(Stack[-4] + Stack[-1]);
0x6c2: Push((int) 3)
0x6c3: Pop(2); Push(Stack[-2] % Stack[-1]);
0x6c4: @ SetVariable(Stack[-2], Stack[-1])
0x6c5: Pop(2)
0x6c6: GOTO 0x6cb

0x6c7: Push("voice_common")
0x6c8: Push((int) 0)
0x6c9: @ SetVariable(Stack[-2], Stack[-1])
0x6ca: Pop(2)
0x6cb: GOTO 0x6de
...
0x6d1: IF (Stack[-1] == 0) GOTO 0x6da; Pop(1)

0x6d2: PushEmpty(bool, object)
0x6d3: Stack[-1] = Stack[-7]
0x6d4: Call2 0x6e0
...
0x6da: Push("voice_common")
0x6db: Push((int) 1)
0x6dc: @ SetVariable(Stack[-2], Stack[-1])
0x6dd: Pop(2)
0x6de: Stack[-6] = (bool) 1
0x6df: Return(); Pop(4)
...
0x6e2: Stack[-4] = (int) 0
0x6e3: Push((int) 1)
0x6e4: IF (Stack[-1] == 0) GOTO 0x6f0; Pop(1)

0x6e5: Push((int) 1)
0x6e6: Pop(1); Push(Stack[-5] + Stack[-1]);
0x6e7: Pop(1); Push(Stack[-6] + Stack[-1]);
0x6e8: @@ HasProperty(Stack[-1], Stack[-4])
0x6e9: Pop(1)
0x6ea: Pop(0); Push((bool) Stack[-3] == 0)
0x6eb: IF (Stack[-1] == 0) GOTO 0x6ed; Pop(1)

0x6ec: GOTO 0x6f0

0x6ed: Push((int) 1)
0x6ee: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x6ef: GOTO 0x6e3

0x6f0: Pop(0); Push((bool) Stack[-4] == 0)
0x6f1: IF (Stack[-1] == 0) GOTO 0x6f4; Pop(1)

0x6f2: Stack[-12] = (bool) 0
0x6f3: Return(); Pop(10)
...
0x6f8: @ irand(Stack[-2], Stack[-4])
0x6f9: Pop(0)
0x6fa: Push((int) 1)
0x6fb: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6fc: Pop(1); Push(Stack[-6] + Stack[-1]);
0x6fd: @@ GetProperty(Stack[-1], Stack[-2])
0x6fe: Pop(1)
0x6ff: PushEmpty(bool, string)
0x700: Stack[-1] = Stack[-3]
0x701: Call2 0x74f

0x702: Stack[-14] = Stack[-2]
0x703: Pop(2)
0x704: Return(); Pop(10)

0x705: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x706: Push("d")
0x707: PushEmpty(int)
0x708: Call2 0x7b2
...
0x70b: Push("m")
0x70c: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x70d: Stack[-4] = (int) 0
0x70e: Push((int) 1)
0x70f: IF (Stack[-1] == 0) GOTO 0x71b; Pop(1)

0x710: Push((int) 1)
0x711: Pop(1); Push(Stack[-5] + Stack[-1]);
0x712: Pop(1); Push(Stack[-6] + Stack[-1]);
0x713: @@ HasProperty(Stack[-1], Stack[-4])
0x714: Pop(1)
...
0x718: Push((int) 1)
0x719: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x71a: GOTO 0x70e

0x71b: Pop(0); Push((bool) Stack[-4] == 0)
0x71c: IF (Stack[-1] == 0) GOTO 0x71f; Pop(1)

0x71d: Stack[-12] = (bool) 0
0x71e: Return(); Pop(10)

0x71f: Stack[-2] = (int) 0
0x720: Push((int) 1)
0x721: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x722: IF (Stack[-1] == 0) GOTO 0x725; Pop(1)

0x723: @ irand(Stack[-2], Stack[-4])
0x724: Pop(0)
0x725: Push((int) 1)
0x726: Pop(1); Push(Stack[-3] + Stack[-1]);
0x727: Pop(1); Push(Stack[-6] + Stack[-1]);
0x728: @@ GetProperty(Stack[-1], Stack[-2])
0x729: Pop(1)
0x72a: PushEmpty(bool, string)
0x72b: Stack[-1] = Stack[-3]
0x72c: Call2 0x74f

0x72d: Stack[-14] = Stack[-2]
0x72e: Pop(2)
0x72f: Return(); Pop(10)

0x730: PushEmpty(bool, float, float, bool, float, float)
0x731: @ lshHasAnimation(Stack[-3], Stack[-7])
0x732: Pop(0)
0x733: Push(Stack[-3])
0x734: IF (Stack[-1] == 0) GOTO 0x73b; Pop(1)

0x735: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x736: Pop(0)
0x737: Push((bool) 0)
0x738: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x739: Pop(1)
0x73a: GOTO 0x73f

0x73b: Push("Can't find lsh animation : ")
0x73c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x73d: @ Trace(Stack[-1])
0x73e: Pop(1)
0x73f: Return(); Pop(6)

0x740: PushEmpty(bool, float, float, bool, float, float)
0x741: @ lshHasAnimation(Stack[-3], Stack[-8])
0x742: Pop(0)
0x743: Push(Stack[-3])
0x744: IF (Stack[-1] == 0) GOTO 0x74a; Pop(1)

0x745: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x746: Pop(0)
0x747: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x748: Pop(0)
0x749: GOTO 0x74e

0x74a: Push("Can't find lsh animation : ")
0x74b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x74c: @ Trace(Stack[-1])
0x74d: Pop(1)
0x74e: Return(); Pop(6)
...
0x754: @ lshHasSpeech(Stack[-1], Stack[-3])
0x755: Pop(0)
0x756: Push(Stack[-1])
0x757: IF (Stack[-1] == 0) GOTO 0x75c; Pop(1)

0x758: @ lshPlaySpeech(Stack[-3])
0x759: Pop(0)
0x75a: Stack[-4] = (bool) 1
0x75b: Return(); Pop(2)
...
0x76a: Stack[-1] = 0
0x76b: PushEmpty(float, float)
0x76c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x76d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x76e: Push((float)0.0)
0x76f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x770: IF (Stack[-1] == 0) GOTO 0x773; Pop(1)

0x771: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x772: Return(); Pop(2)

0x773: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x774: Return(); Pop(2)

0x775: PushEmpty(int, int)
0x776: @ GetVariable(Stack[-3], Stack[-1])
0x777: Pop(0)
0x778: Stack[-4] = Stack[-1]
0x779: Return(); Pop(2)

0x77a: PushEmpty(object, object)
0x77b: @ CreateIntVector(Stack[-1])
0x77c: Pop(0)
0x77d: @@ add(Stack[-4])
0x77e: Pop(0)
0x77f: @@ add(Stack[-3])
0x780: Pop(0)
0x781: Push((int) 3)
0x782: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x783: Pop(1)
0x784: Return(); Pop(2)

0x785: Stack[-1] = 0
0x786: PushEmpty(int, int, bool, int, int, bool)
0x787: @@ GetItemID(Stack[-3])
0x788: Pop(0)
0x789: Push("Category")
0x78a: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x78b: Pop(1)
0x78c: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x78d: Pop(0)
0x78e: Pop(0); Push((bool) Stack[-1] == 0)
0x78f: IF (Stack[-1] == 0) GOTO 0x793; Pop(1)

0x790: @@ DropItems(Stack[-8], Stack[-7])
0x791: Pop(0)
0x792: GOTO 0x798

0x793: PushEmpty(int, int)
0x794: Stack[-2] = Stack[-5]
0x795: Stack[-1] = Stack[-9]
0x796: Call2 0x77a
...
0x79a: @ CreateInvItem(Stack[-1])
0x79b: Pop(0)
0x79c: @@ SetItemName(Stack[-4])
0x79d: Pop(0)
0x79e: PushEmpty(object, object, int)
0x79f: Stack[-3] = Stack[-8]
0x7a0: Stack[-2] = Stack[-4]
0x7a1: Stack[-1] = Stack[-6]
0x7a2: Call2 0x786
...
0x7a7: @ FindActor(Stack[-1], Stack[-4])
0x7a8: Pop(0)
0x7a9: Pop(0); Push((bool) Stack[-1] == 0)
0x7aa: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7ab: Stack[-5] = (bool) 0
0x7ac: Return(); Pop(2)

0x7ad: @ Trigger(Stack[-1], Stack[-3])
0x7ae: Pop(0)
0x7af: Stack[-5] = (bool) 1
0x7b0: Return(); Pop(2)

0x7b1: Stack[-1] = 0
0x7b2: PushEmpty(float, float)
0x7b3: @ GetGameTime(Stack[-1])
0x7b4: Pop(0)
0x7b5: Push((int) 1)
0x7b6: PushEmpty(int)
0x7b7: Push((int) 24)
0x7b8: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x7b9: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x7ba: Return(); Pop(2)

0x7bb: PushEmpty(string, string)
0x7bc: Stack[-1] = "idle"
0x7bd: Push(Stack[-3])
0x7be: IF (Stack[-1] == 0) GOTO 0x7c0; Pop(1)

0x7bf: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x7c0: Stack[-4] = Stack[-1]
0x7c1: Return(); Pop(2)

0x7c2: PushEmpty(int, bool, int, bool)
0x7c3: Stack[-2] = (int) 0
0x7c4: Push("all")
0x7c5: PushEmpty(string, int)
0x7c6: Stack[-1] = Stack[-5]
0x7c7: Call2 0x7bb

0x7c8: Pop(1)
0x7c9: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7ca: Pop(2)
0x7cb: Pop(0); Push((bool) Stack[-1] == 0)
0x7cc: IF (Stack[-1] == 0) GOTO 0x7ce; Pop(1)

0x7cd: GOTO 0x7d1

0x7ce: Push((int) 1)
0x7cf: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x7d0: GOTO 0x7c4

0x7d1: Stack[-5] = Stack[-2]
0x7d2: Return(); Pop(4)
...
0x7d6: Pop(0)
0x7d7: PushEmpty(bool, string, string)
0x7d8: Stack[-2] = "quest_d6_01"
0x7d9: Stack[-1] = "completed"
0x7da: Call2 0x7a6
...
0x7e0: Pop(0)
0x7e1: Push("klara blood is given")
0x7e2: @ Trace(Stack[-1])
0x7e3: Pop(1)
0x7e4: PushEmpty(object, string, int)
0x7e5: Stack[-3] = Stack[-5]
0x7e6: Stack[-2] = "d6q01_klara_blood"
0x7e7: Stack[-1] = (int) 1
0x7e8: Call2 0x799
...
0x7eb: PushEmpty()
0x7ec: Push("playsound")
0x7ed: Push("giveitem")
0x7ee: @ TriggerWorld(Stack[-2], Stack[-1])
0x7ef: Pop(2)
0x7f0: Return(); Pop(0)

0x7f1: PushEmpty()
0x7f2: Push("ood6Klara1")
0x7f3: Push((int) 1)
...
0x7f7: PushEmpty()
0x7f8: Push("ood6Klara2")
0x7f9: Push((int) 1)
0x7fa: @ SetVariable(Stack[-2], Stack[-1])
0x7fb: Pop(2)
0x7fc: Return(); Pop(0)

0x7fd: PushEmpty()
0x7fe: Push("d6q01KlaraVolonteer")
0x7ff: Push((int) 1)
0x800: @ SetVariable(Stack[-2], Stack[-1])
0x801: Pop(2)
0x802: PushEmpty()
0x803: Call2 0x888

0x804: Pop(0)
0x805: PushEmpty(bool, string, string)
0x806: Stack[-2] = "quest_d6_01"
0x807: Stack[-1] = "completed"
0x808: Call2 0x7a6
...
0x80b: PushEmpty()
0x80c: Push("ood6Klara3")
0x80d: Push((int) 1)
0x80e: @ SetVariable(Stack[-2], Stack[-1])
0x80f: Pop(2)
0x810: Return(); Pop(0)
...
0x814: Pop(0)
0x815: PushEmpty(bool, string, string)
0x816: Stack[-2] = "quest_d6_01"
0x817: Stack[-1] = "failed"
0x818: Call2 0x7a6
...
0x84d: Stack[-1] = "microscope_d6q01_klara_blood"
0x84e: Call2 0x775
...
0x85f: Stack[-2] = (bool) 1
0x860: Return(); Pop(0)

0x861: Stack[-2] = (bool) 0
0x862: Return(); Pop(0)

0x863: PushEmpty()
0x864: PushEmpty(int, string)
0x865: Stack[-1] = "d6q01"
0x866: Call2 0x775

0x867: Pop(1)
0x868: Push((int) -1)
0x869: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x86a: IF (Stack[-1] == 0) GOTO 0x86d; Pop(1)

0x86b: Stack[-2] = (bool) 1
0x86c: Return(); Pop(0)
...
0x889: Push((int) 122)
0x88a: Push((int) 1)
0x88b: Push((int) 513745)
0x88c: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x88d: Pop(3)
0x88e: PushEmpty(bool, object, int)
0x88f: Stack[-2] = Stack[-4]
0x890: Stack[-1] = (int) 111
0x891: Call2 0x8bc
...
0x896: Push((int) 635)
0x897: Push((int) 1)
0x898: Push((int) 533083)
0x899: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x89a: Pop(3)
0x89b: PushEmpty(bool, object, int)
0x89c: Stack[-2] = Stack[-4]
0x89d: Stack[-1] = (int) 111
0x89e: Call2 0x8bc
...
0x8a3: Push((int) 119)
0x8a4: Push((int) 1)
0x8a5: Push((int) 513742)
0x8a6: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8a7: Pop(3)
0x8a8: PushEmpty(bool, object, int)
0x8a9: Stack[-2] = Stack[-4]
0x8aa: Stack[-1] = (int) 111
0x8ab: Call2 0x8bc
...
0x8b0: @ GetDiaryRoot(Stack[-1])
0x8b1: Pop(0)
0x8b2: Pop(0); Push((bool) Stack[-1] == 0)
0x8b3: IF (Stack[-1] == 0) GOTO 0x8b9; Pop(1)

0x8b4: Push("Can't retrieve diary root")
0x8b5: @ Trace(Stack[-1])
0x8b6: Pop(1)
0x8b7: Stack[-3] = (bool) 0
0x8b8: Return(); Pop(2)

0x8b9: Stack[-3] = Stack[-1]
0x8ba: Return(); Pop(2)

0x8bb: Stack[-1] = 0
0x8bc: PushEmpty(object, object, int, object, object, int)
0x8bd: PushEmpty(object)
0x8be: Call2 0x8af

0x8bf: Stack[-4] = Stack[-1]
0x8c0: Pop(1)
0x8c1: @@ Find(Stack[-7], Stack[-2])
0x8c2: Pop(0)
0x8c3: Pop(0); Push((bool) Stack[-2] == 0)
0x8c4: IF (Stack[-1] == 0) GOTO 0x8cb; Pop(1)

0x8c5: Push("Can't find diary parent with id: ")
0x8c6: Pop(1); Push(Stack[-1] + Stack[-8]);
0x8c7: @ Trace(Stack[-1])
0x8c8: Pop(1)
0x8c9: Stack[-9] = (bool) 0
0x8ca: Return(); Pop(6)

0x8cb: @@ AddChild(Stack[-8])
0x8cc: Pop(0)
0x8cd: Push((int) 7)
0x8ce: @ SendWorldWndMessage(Stack[-1])
0x8cf: Pop(1)
0x8d0: @@ GetCategory(Stack[-1])
0x8d1: Pop(0)
0x8d2: @ SetDiarySection(Stack[-1])
0x8d3: Pop(0)
0x8d4: Stack[-9] = (bool) 0
0x8d5: Return(); Pop(6)
...
0x8e9: Stack[-1] = (int) 515540
0x8ea: Return(); Pop(0)

0x8eb: Stack[-1] = (int) 502865
0x8ec: Return(); Pop(0)

0x8ed: Stack[-1] = "ui/NPC_Klara.png"
0x8ee: Return(); Pop(0)

0x8ef: Stack[-1] = "ui/NPC_Klara_b.png"
0x8f0: Return(); Pop(0)
