...
0x20b: PushEmpty(bool, float, float, bool, float, float)
0x20c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x20d: Pop(0)
0x20e: Push(Stack[-3])
0x20f: IF (Stack[-1] == 0) GOTO 0x216; Pop(1)

0x210: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x211: Pop(0)
0x212: Push((bool) 0)
0x213: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x214: Pop(1)
0x215: GOTO 0x21a

0x216: Push("Can't find lsh animation : ")
0x217: Pop(1); Push(Stack[-1] + Stack[-8]);
0x218: @ Trace(Stack[-1])
0x219: Pop(1)
0x21a: Return(); Pop(6)

0x21b: PushEmpty(bool, float, float, bool, float, float)
0x21c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x21d: Pop(0)
0x21e: Push(Stack[-3])
0x21f: IF (Stack[-1] == 0) GOTO 0x225; Pop(1)

0x220: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x221: Pop(0)
0x222: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x223: Pop(0)
0x224: GOTO 0x229

0x225: Push("Can't find lsh animation : ")
0x226: Pop(1); Push(Stack[-1] + Stack[-9]);
0x227: @ Trace(Stack[-1])
0x228: Pop(1)
0x229: Return(); Pop(6)

0x22a: PushEmpty(float, cvector, float, cvector)
0x22b: @@ GetEyesHeight(Stack[-2])
0x22c: Pop(0)
0x22d: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x22e: Push(CvectorIndex(Stack[-1], 1))
0x22f: Stack[-1] = Stack[-3]
0x230: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x231: Push("head")
0x232: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x233: Pop(1)
0x234: Return(); Pop(4)
...
0x23d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x23e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x23f: Push((float)0.0)
0x240: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x241: IF (Stack[-1] == 0) GOTO 0x244; Pop(1)

0x242: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x243: Return(); Pop(2)

0x244: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x245: Return(); Pop(2)

0x246: PushEmpty(int, int)
0x247: @ GetVariable(Stack[-3], Stack[-1])
0x248: Pop(0)
0x249: Stack[-4] = Stack[-1]
0x24a: Return(); Pop(2)
...
0x263: Stack[-1] = (int) 515560
0x264: Return(); Pop(0)

0x265: Stack[-1] = (int) 503345
0x266: Return(); Pop(0)

0x267: Stack[-1] = "ui/NPC_Citizen3.png"
0x268: Return(); Pop(0)

0x269: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x26a: Return(); Pop(0)
...
0x26d: PushEmpty()
0x26e: Push("ood6Littleboy1")
0x26f: Push((int) 1)
0x270: @ SetVariable(Stack[-2], Stack[-1])
0x271: Pop(2)
0x272: Return(); Pop(0)

0x273: PushEmpty()
0x274: PushEmpty(int, string)
0x275: Stack[-1] = "ood6Littleboy1"
0x276: Call2 0x246
