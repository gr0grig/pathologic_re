...
Label_173:
	...
	func_627(var_41_object); // 0xbb NEW_2
...
Label_224:
	...
	func_619(var_64_bool); // 0xe2 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_554(var_27_object); // 0x13a NEW_2
...
func_582(var_112_int, var_113_string)
{
	var_114_int = 0; var_115_int = 0; // 0x246 PushV
	GetVariable(var_113_string, var_115_int); // 0x247 Func
	var_112_int = var_115_int; // 0x249 Mov
...
func_137(var_2_object, var_92_string)
{
	...
	func_619(var_93_bool); // 0x8b NEW_2
...
Label_155:
	func_539(var_96_string, var_97_bool); // 0x9b NEW_2
...
Label_116:
	...
	func_523(var_126_string); // 0x76 NEW_2
...
func_523(var_126_string)
{
	var_127_bool = 0; var_128_float = 0; var_129_float = 0; var_130_bool = 0; var_131_float = 0; var_132_float = 0; // 0x20b PushV
	lshHasAnimation(var_130_bool, var_126_string); // 0x20c Func
	var_133_bool = var_130_bool; // 0x20e Push
	if(var_133_bool == 0) goto Label_534; // 0x20f JumpB
	lshGetAnimTimes(var_126_string, var_131_float, var_132_float); // 0x210 Func
	var_134_bool = 0; // 0x212 PushB
	lshPlayAnimation(var_131_float, var_132_float, var_134_bool); // 0x213 Func
	goto Label_538; // 0x215 Jump
	
Label_538:
	return 6; // 0x21a Return
	
Label_534:
	var_135_string = "Can't find lsh animation : "; // 0x216 PushS
	var_136_int = var_135_string + var_126_string; // 0x217 Add
	Trace(var_136_int); // 0x218 Func
}


func_587(var_43_string, var_44_int)
{
	var_45_string = ""; var_46_string = ""; // 0x24b PushV
	var_46_string = "idle"; // 0x24c MovS
	var_47_int = var_44_int; // 0x24d Push
	if(var_47_int == 0) goto Label_592; // 0x24e JumpB
	var_46_string = var_46_string + var_44_int; // 0x24f Add2
	
Label_592:
	var_43_string = var_46_string; // 0x250 Mov
...
func_594(var_37_int)
{
	var_38_int = 0; var_39_bool = 0; var_40_int = 0; var_41_bool = 0; // 0x252 PushV
	var_40_int = 0; // 0x253 MovI
	
Label_596:
	var_42_string = "all"; // 0x254 PushS
	var_43_string = ""; var_44_int = 0; // 0x255 PushV
	var_44_int = var_40_int; // 0x256 Mov
	func_587(var_43_string, var_44_int); // 0x257 NEW_2
	HasAnimation(var_41_bool, var_42_string, var_43_string); // 0x259 Func
	var_48_bool = var_41_bool == 0; // 0x25b Not
	if(var_48_bool == 0) goto Label_606; // 0x25c JumpB
	goto Label_609; // 0x25d Jump
	
Label_609:
	var_37_int = var_40_int; // 0x261 Mov
	return 4; // 0x262 Return
	
Label_606:
	var_49_int = 1; // 0x25e PushI
	var_40_int = var_40_int + var_49_int; // 0x25f Add2
...
Label_348:
	...
	func_594(var_37_int); // 0x15d NEW_2
...
Label_363:
	...
	func_587(var_59_string, var_60_int); // 0x179 NEW_2
...
func_539(var_96_string, var_97_bool)
{
	var_100_bool = 0; var_101_float = 0; var_102_float = 0; var_103_bool = 0; var_104_float = 0; var_105_float = 0; // 0x21b PushV
	lshHasAnimation(var_103_bool, var_96_string); // 0x21c Func
	var_106_bool = var_103_bool; // 0x21e Push
	if(var_106_bool == 0) goto Label_549; // 0x21f JumpB
	lshGetAnimTimes(var_96_string, var_104_float, var_105_float); // 0x220 Func
	lshPlayAnimation(var_104_float, var_105_float, var_97_bool); // 0x222 Func
...
Label_549:
	var_107_string = "Can't find lsh animation : "; // 0x225 PushS
	var_108_int = var_107_string + var_96_string; // 0x226 Add
	Trace(var_108_int); // 0x227 Func
}
...
func_613(var_72_int)
{
	var_72_int = 503345; // 0x265 MovI
	return 0; // 0x266 Return
}


func_615(var_74_string)
{
	var_74_string = "ui/NPC_Citizen3.png"; // 0x267 MovS
...
func_554(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x22a PushV
	GetEyesHeight(var_30_float); // 0x22b ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x22d MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x22e PushE
	var_32_float = var_30_float; // 0x22f Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x230 PopE
	var_33_string = "head"; // 0x231 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x232 Func
...
{
	var_75_string = "ui/NPC_Citizen3_b.png"; // 0x269 MovS
	return 0; // 0x26a Return
}


func_619(var_67_bool)
{
	var_67_bool = 0; // 0x26b MovB
...
func_621()
{
	var_18_string = "ood6Littleboy1"; // 0x26e PushS
	var_19_int = 1; // 0x26f PushI
	SetVariable(var_18_string, var_19_int); // 0x270 Func
...
func_627(var_110_bool)
{
	var_112_int = 0; var_113_string = ""; // 0x274 PushV
	var_113_string = "ood6Littleboy1"; // 0x275 MovS
	func_582(var_112_int, var_113_string); // 0x276 NEW_2
	var_116_int = 0; // 0x278 PushI
	var_117_bool = var_112_int == var_116_int; // 0x279 Eq
	if(var_117_bool == 0) goto Label_637; // 0x27a JumpB
	var_110_bool = 1; // 0x27b MovB
	return 0; // 0x27c Return
	
Label_637:
	var_110_bool = 0; // 0x27d MovB
...
func_565()
{
	var_13_bool = 0; // 0x235 PushV
	func_619(var_13_bool); // 0x236 NEW_2
	if(var_13_bool == 0) goto Label_571; // 0x238 JumpB
...
func_438(var_25_bool, var_27_float)
{
	...
	func_572(var_52_cvector, var_53_cvector); // 0x1d1 NEW_2
...
Label_479:
	...
	CameraTransit(var_43_cvector, var_41_cvector); // 0x1e1 Func
	var_65_float = GetByIndex(var_42_cvector, 0); // 0x1e3 PushE
	var_66_float = GetByIndex(var_42_cvector, 2); // 0x1e4 PushE
	Rotate(var_65_float, var_66_float); // 0x1e5 Func
	var_67_bool = 0; // 0x1e7 PushV
	func_619(var_67_bool); // 0x1e8 NEW_2
	if(var_67_bool == 0) goto Label_492; // 0x1ea JumpB
	goto Label_500; // 0x1eb Jump
	
Label_500:
	CameraWaitForPlayFinish(); // 0x1f4 Func
	ResumeWorld(); // 0x1f6 Func
	var_25_bool = 1; // 0x1f8 MovB
	return 18; // 0x1f9 Return
	
Label_492:
	var_68_string = "head"; // 0x1ec PushS
	HasAnimationTrack(var_45_bool, var_68_string); // 0x1ed Func
	var_69_bool = var_45_bool; // 0x1ef Push
	if(var_69_bool == 0) goto Label_500; // 0x1f0 JumpB
	var_70_string = "head"; // 0x1f1 PushS
	LookAsyncCamera(var_70_string); // 0x1f2 Func
}


func_506()
{
	var_144_bool = 0; var_145_bool = 0; // 0x1fa PushV
	CameraSwitchToNormal(); // 0x1fb Func
	var_146_bool = 0; // 0x1fd PushV
	func_619(var_146_bool); // 0x1fe NEW_2
	if(var_146_bool == 0) goto Label_514; // 0x200 JumpB
...
Label_514:
	var_147_string = "head"; // 0x202 PushS
	HasAnimationTrack(var_145_bool, var_147_string); // 0x203 Func
	var_148_bool = var_145_bool; // 0x205 Push
	if(var_148_bool == 0) goto Label_522; // 0x206 JumpB
	var_149_string = "head"; // 0x207 PushS
	UnlookAsync(var_149_string); // 0x208 Func
}


func_572(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x23c PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x23d Or
	var_56_float = sqrt(var_57_int); // 0x23e Sqrt2
	var_58_float = 0.0; // 0x23f PushF
	var_59_bool = var_56_float < var_58_float; // 0x240 LT
	if(var_59_bool == 0) goto Label_580; // 0x241 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x242 MovV
	return 2; // 0x243 Return
	
Label_580:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x244 Div2
...
func_639(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x27f PushV
	var_79_string = "branch"; // 0x280 PushS
	GetVariable(var_79_string, var_78_int); // 0x281 Func
	var_80_int = 0; // 0x283 PushI
	var_81_bool = var_78_int == var_80_int; // 0x284 Eq
	if(var_81_bool == 0) goto Label_649; // 0x285 JumpB
	var_76_int = 1; // 0x286 MovI
	return 2; // 0x287 Return
	
Label_649:
	var_82_int = 1; // 0x289 PushI
	var_83_bool = var_78_int == var_82_int; // 0x28a Eq
	if(var_83_bool == 0) goto Label_654; // 0x28b JumpB
	var_76_int = 2; // 0x28c MovI
	return 2; // 0x28d Return
	
Label_654:
	var_76_int = 3; // 0x28e MovI
