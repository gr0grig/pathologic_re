...
0x256: @ lshHasAnimation(Stack[-3], Stack[-7])
0x257: Pop(0)
0x258: Push(Stack[-3])
0x259: IF (Stack[-1] == 0) GOTO 0x260; Pop(1)

0x25a: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x25b: Pop(0)
0x25c: Push((bool) 0)
0x25d: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x25e: Pop(1)
0x25f: GOTO 0x264

0x260: Push("Can't find lsh animation : ")
0x261: Pop(1); Push(Stack[-1] + Stack[-8]);
0x262: @ Trace(Stack[-1])
0x263: Pop(1)
0x264: Return(); Pop(6)

0x265: PushEmpty(bool, float, float, bool, float, float)
0x266: @ lshHasAnimation(Stack[-3], Stack[-8])
0x267: Pop(0)
0x268: Push(Stack[-3])
0x269: IF (Stack[-1] == 0) GOTO 0x26f; Pop(1)

0x26a: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x26b: Pop(0)
0x26c: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x26d: Pop(0)
0x26e: GOTO 0x273

0x26f: Push("Can't find lsh animation : ")
0x270: Pop(1); Push(Stack[-1] + Stack[-9]);
0x271: @ Trace(Stack[-1])
0x272: Pop(1)
0x273: Return(); Pop(6)

0x274: PushEmpty(float, cvector, float, cvector)
0x275: @@ GetEyesHeight(Stack[-2])
0x276: Pop(0)
0x277: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x278: Push(CvectorIndex(Stack[-1], 1))
0x279: Stack[-1] = Stack[-3]
0x27a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x27b: Push("head")
0x27c: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x27d: Pop(1)
0x27e: Return(); Pop(4)
...
0x291: @ GetVariable(Stack[-3], Stack[-1])
0x292: Pop(0)
0x293: Stack[-4] = Stack[-1]
0x294: Return(); Pop(2)

0x295: PushEmpty(string, string)
0x296: Stack[-1] = "idle"
0x297: Push(Stack[-3])
0x298: IF (Stack[-1] == 0) GOTO 0x29a; Pop(1)

0x299: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x29a: Stack[-4] = Stack[-1]
0x29b: Return(); Pop(2)

0x29c: PushEmpty(int, bool, int, bool)
0x29d: Stack[-2] = (int) 0
0x29e: Push("all")
0x29f: PushEmpty(string, int)
0x2a0: Stack[-1] = Stack[-5]
0x2a1: Call2 0x295

0x2a2: Pop(1)
0x2a3: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2a4: Pop(2)
...
0x2ad: Stack[-1] = (int) 515555
0x2ae: Return(); Pop(0)

0x2af: Stack[-1] = (int) 503340
0x2b0: Return(); Pop(0)

0x2b1: Stack[-1] = "ui/NPC_Citizen2.png"
0x2b2: Return(); Pop(0)

0x2b3: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x2b4: Return(); Pop(0)
...
0x2bf: Stack[-1] = "ood6WastedWoman1"
0x2c0: Call2 0x290
