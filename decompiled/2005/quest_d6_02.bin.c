...
Label_39:
	...
	func_180(var_36_object, var_37_object, var_38_string, var_39_string, var_40_string); // 0x37 NEW_2
	...
	func_180(var_54_object, var_55_object, var_56_string, var_57_string, var_58_string); // 0x3e NEW_2
	...
	func_180(var_59_object, var_60_object, var_61_string, var_62_string, var_63_string); // 0x45 NEW_2
	...
	func_180(var_64_object, var_65_object, var_66_string, var_67_string, var_68_string); // 0x4c NEW_2
	...
	var_72_string = "pers_gorbun"; // 0x51 MovS
	var_73_string = "d6q02_gorbun.xml"; // 0x52 MovS
	func_180(var_69_object, var_70_object, var_71_string, var_72_string, var_73_string); // 0x53 NEW_2
...
Label_87:
	...
	func_198(); // 0x5b NEW_2
	var_99_string = "d6q02GorbunDeath"; // 0x5d PushS
	var_100_int = 1; // 0x5e PushI
	SetVariable(var_99_string, var_100_int); // 0x5f Func
}
...
main(var_0_object)
{
	...
	func_150(var_3_int); // 0x6 NEW_2
	return 0; // 0x8 Return
}


func_224(var_81_bool, var_82_object, var_83_int)
{
	var_84_object = Obj(); var_85_object = Obj(); var_86_int = 0; var_87_object = Obj(); var_88_object = Obj(); var_89_int = 0; // 0xe0 PushV
	var_90_object = Obj(); // 0xe1 PushV
	func_211(var_90_object); // 0xe2 NEW_2
	var_87_object = var_90_object; // 0xe3 Mov
	Find(var_83_int, var_88_object); // 0xe5 ObjFunc
	var_95_bool = var_88_object == 0; // 0xe7 Not
	if(var_95_bool == 0) goto Label_239; // 0xe8 JumpB
	var_96_string = "Can't find diary parent with id: "; // 0xe9 PushS
	var_97_int = var_96_string + var_83_int; // 0xea Add
	Trace(var_97_int); // 0xeb Func
	var_81_bool = 0; // 0xed MovB
	return 6; // 0xee Return
	
Label_239:
	AddChild(var_82_object); // 0xef ObjFunc
	var_98_int = 7; // 0xf1 PushI
	SendWorldWndMessage(var_98_int); // 0xf2 Func
	GetCategory(var_89_int); // 0xf4 ObjFunc
	SetDiarySection(var_89_int); // 0xf6 Func
	var_81_bool = 0; // 0xf8 MovB
	return 6; // 0xf9 Return
}
...
func_198()
{
	var_76_object = Obj(); var_77_object = Obj(); // 0xc6 PushV
	var_78_int = 103; // 0xc7 PushI
	var_79_int = 2; // 0xc8 PushI
	var_80_int = 513726; // 0xc9 PushI
	CreateDiaryEntry(var_77_object, var_78_int, var_79_int, var_80_int); // 0xca Func
	var_81_bool = 0; var_82_object = Obj(); var_83_int = 0; // 0xcc PushV
	var_82_object = var_77_object; // 0xcd Mov
	var_83_int = 102; // 0xce MovI
	func_224(var_81_bool, var_82_object, var_83_int); // 0xcf NEW_2
...
Label_144:
	...
	func_174(var_10_object); // 0x91 NEW_2
...
{
	var_91_object = Obj(); var_92_object = Obj(); // 0xd3 PushV
	GetDiaryRoot(var_92_object); // 0xd4 Func
	var_93_bool = var_92_object == 0; // 0xd6 Not
	if(var_93_bool == 0) goto Label_221; // 0xd7 JumpB
	var_94_string = "Can't retrieve diary root"; // 0xd8 PushS
	Trace(var_94_string); // 0xd9 Func
	var_90_object = 0; // 0xdb MovB
	return 2; // 0xdc Return
	
Label_221:
	var_90_object = var_92_object; // 0xdd Mov
...
func_150(var_3_int)
{
	...
	func_139(var_5_float); // 0x9e NEW_2
