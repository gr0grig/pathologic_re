...
0x2ef: Push(CvectorIndex(Stack[-1], 1))
0x2f0: Stack[-1] = Stack[-3]
0x2f1: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2f2: Push("head")
...
0x409: Push(CvectorIndex(Stack[-4], 0))
0x40a: Push(CvectorIndex(Stack[-5], 2))
...
0x424: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x433: Push((int) 1)
0x434: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x435: GOTO 0x429
