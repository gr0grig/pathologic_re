...
Label_204:
	...
	func_906(var_128_object); // 0xda NEW_2
...
Label_424:
	...
	func_1084(var_222_bool); // 0x1aa NEW_2
...
Label_511:
	...
	func_832(var_19_object); // 0x201 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_814(var_29_object); // 0x23e NEW_2
...
func_906(var_109_bool)
{
	var_111_int = 0; var_112_string = ""; // 0x38b PushV
	var_112_string = "ood8Doberman1"; // 0x38c MovS
	func_848(var_111_int, var_112_string); // 0x38d NEW_2
	var_115_int = 0; // 0x38f PushI
	var_116_bool = var_111_int == var_115_int; // 0x390 Eq
	if(var_116_bool == 0) goto Label_916; // 0x391 JumpB
	var_109_bool = 1; // 0x392 MovB
...
func_1035(var_75_int)
{
	var_76_int = 0; var_77_int = 0; // 0x40b PushV
	var_78_string = "branch"; // 0x40c PushS
	GetVariable(var_78_string, var_77_int); // 0x40d Func
	var_79_int = 0; // 0x40f PushI
	var_80_bool = var_77_int == var_79_int; // 0x410 Eq
	if(var_80_bool == 0) goto Label_1045; // 0x411 JumpB
	var_75_int = 1; // 0x412 MovI
	return 2; // 0x413 Return
	
Label_1045:
	var_81_int = 1; // 0x415 PushI
	var_82_bool = var_77_int == var_81_int; // 0x416 Eq
	if(var_82_bool == 0) goto Label_1050; // 0x417 JumpB
	var_75_int = 2; // 0x418 MovI
	return 2; // 0x419 Return
	
Label_1050:
	var_75_int = 3; // 0x41a MovI
...
func_142(var_2_object, var_91_string)
{
	...
	func_1084(var_92_bool); // 0x90 NEW_2
...
Label_160:
	func_799(var_95_string, var_96_bool); // 0xa0 NEW_2
...
func_783(var_128_string)
{
	var_129_bool = 0; var_130_float = 0; var_131_float = 0; var_132_bool = 0; var_133_float = 0; var_134_float = 0; // 0x30f PushV
	lshHasAnimation(var_132_bool, var_128_string); // 0x310 Func
	var_135_bool = var_132_bool; // 0x312 Push
	if(var_135_bool == 0) goto Label_794; // 0x313 JumpB
	lshGetAnimTimes(var_128_string, var_133_float, var_134_float); // 0x314 Func
	var_136_bool = 0; // 0x316 PushB
	lshPlayAnimation(var_133_float, var_134_float, var_136_bool); // 0x317 Func
	goto Label_798; // 0x319 Jump
	
Label_798:
	return 6; // 0x31e Return
	
Label_794:
	var_137_string = "Can't find lsh animation : "; // 0x31a PushS
	var_138_int = var_137_string + var_128_string; // 0x31b Add
	Trace(var_138_int); // 0x31c Func
}


func_918()
{
	var_44_object = Obj(); var_45_object = Obj(); // 0x396 PushV
	var_46_int = 127; // 0x397 PushI
	var_47_int = 2; // 0x398 PushI
	var_48_int = 513772; // 0x399 PushI
	CreateDiaryEntry(var_45_object, var_46_int, var_47_int, var_48_int); // 0x39a Func
	var_49_bool = 0; var_50_object = Obj(); var_51_int = 0; // 0x39c PushV
	var_50_object = var_45_object; // 0x39d Mov
	var_51_int = -1; // 0x39e MovI
	func_957(var_49_bool, var_50_object, var_51_int); // 0x39f NEW_2
	return 2; // 0x3a1 Return
}


func_1052(var_52_string, var_53_int)
{
	var_54_string = ""; var_55_string = ""; // 0x41c PushV
	var_55_string = "idle"; // 0x41d MovS
	var_56_int = var_53_int; // 0x41e Push
	if(var_56_int == 0) goto Label_1057; // 0x41f JumpB
	var_55_string = var_55_string + var_53_int; // 0x420 Add2
	
Label_1057:
	var_52_string = var_55_string; // 0x421 Mov
	return 2; // 0x422 Return
}


func_799(var_95_string, var_96_bool)
{
	var_99_bool = 0; var_100_float = 0; var_101_float = 0; var_102_bool = 0; var_103_float = 0; var_104_float = 0; // 0x31f PushV
	lshHasAnimation(var_102_bool, var_95_string); // 0x320 Func
	var_105_bool = var_102_bool; // 0x322 Push
	if(var_105_bool == 0) goto Label_809; // 0x323 JumpB
	lshGetAnimTimes(var_95_string, var_103_float, var_104_float); // 0x324 Func
	lshPlayAnimation(var_103_float, var_104_float, var_96_bool); // 0x326 Func
	goto Label_813; // 0x328 Jump
	
Label_813:
	return 6; // 0x32d Return
	
Label_809:
	var_106_string = "Can't find lsh animation : "; // 0x329 PushS
	var_107_int = var_106_string + var_95_string; // 0x32a Add
	Trace(var_107_int); // 0x32b Func
}
...
func_1059(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x423 PushV
	var_49_int = 0; // 0x424 MovI
	
Label_1061:
	var_51_string = "all"; // 0x425 PushS
	var_52_string = ""; var_53_int = 0; // 0x426 PushV
	var_53_int = var_49_int; // 0x427 Mov
	func_1052(var_52_string, var_53_int); // 0x428 NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x42a Func
	var_57_bool = var_50_bool == 0; // 0x42c Not
	if(var_57_bool == 0) goto Label_1071; // 0x42d JumpB
	goto Label_1074; // 0x42e Jump
	
Label_1074:
	var_46_int = var_49_int; // 0x432 Mov
	return 4; // 0x433 Return
	
Label_1071:
	var_58_int = 1; // 0x42f PushI
	var_49_int = var_49_int + var_58_int; // 0x430 Add2
...
func_931()
{
	var_67_object = Obj(); var_68_object = Obj(); // 0x3a3 PushV
	var_69_int = 648; // 0x3a4 PushI
	var_70_int = 2; // 0x3a5 PushI
	var_71_int = 533321; // 0x3a6 PushI
	CreateDiaryEntry(var_68_object, var_69_int, var_70_int, var_71_int); // 0x3a7 Func
	var_72_bool = 0; var_73_object = Obj(); var_74_int = 0; // 0x3a9 PushV
	var_73_object = var_68_object; // 0x3aa Mov
	var_74_int = 127; // 0x3ab MovI
	func_957(var_72_bool, var_73_object, var_74_int); // 0x3ac NEW_2
...
func_814(var_29_object)
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x32e PushV
	GetEyesHeight(var_32_float); // 0x32f ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x331 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x332 PushE
	var_34_float = var_32_float; // 0x333 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x334 PopE
	var_35_string = "head"; // 0x335 PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x336 Func
	return 4; // 0x338 Return
}


func_944(var_58_object)
{
	var_59_object = Obj(); var_60_object = Obj(); // 0x3b0 PushV
	GetDiaryRoot(var_60_object); // 0x3b1 Func
	var_61_bool = var_60_object == 0; // 0x3b3 Not
	if(var_61_bool == 0) goto Label_954; // 0x3b4 JumpB
	var_62_string = "Can't retrieve diary root"; // 0x3b5 PushS
	Trace(var_62_string); // 0x3b6 Func
	var_58_object = 0; // 0x3b8 MovB
	return 2; // 0x3b9 Return
	
Label_954:
	var_58_object = var_60_object; // 0x3ba Mov
	return 2; // 0x3bb Return
}


func_1076(var_72_int)
{
	var_72_int = 518097; // 0x434 MovI
...
func_1078(var_71_int)
{
	var_71_int = 518096; // 0x436 MovI
	return 0; // 0x437 Return
}


func_1080(var_73_string)
{
	var_73_string = "ui/NPC_Citizen2.png"; // 0x438 MovS
...
func_825()
{
	var_15_bool = 0; // 0x339 PushV
	func_1084(var_15_bool); // 0x33a NEW_2
	if(var_15_bool == 0) goto Label_831; // 0x33c JumpB
	lshStopSpeech(); // 0x33d Func
...
{
	var_74_string = "ui/NPC_Citizen2_b.png"; // 0x43a MovS
...
func_698(var_24_bool, var_26_float)
{
	...
	func_838(var_51_cvector, var_52_cvector); // 0x2d5 NEW_2
...
Label_739:
	...
	CameraTransit(var_42_cvector, var_40_cvector); // 0x2e5 Func
	var_64_float = GetByIndex(var_41_cvector, 0); // 0x2e7 PushE
	var_65_float = GetByIndex(var_41_cvector, 2); // 0x2e8 PushE
	Rotate(var_64_float, var_65_float); // 0x2e9 Func
	var_66_bool = 0; // 0x2eb PushV
	func_1084(var_66_bool); // 0x2ec NEW_2
	if(var_66_bool == 0) goto Label_752; // 0x2ee JumpB
	goto Label_760; // 0x2ef Jump
	
Label_760:
	CameraWaitForPlayFinish(); // 0x2f8 Func
	ResumeWorld(); // 0x2fa Func
	var_24_bool = 1; // 0x2fc MovB
	return 18; // 0x2fd Return
	
Label_752:
	var_67_string = "head"; // 0x2f0 PushS
	HasAnimationTrack(var_44_bool, var_67_string); // 0x2f1 Func
	var_68_bool = var_44_bool; // 0x2f3 Push
	if(var_68_bool == 0) goto Label_760; // 0x2f4 JumpB
	var_69_string = "head"; // 0x2f5 PushS
	LookAsyncCamera(var_69_string); // 0x2f6 Func
}


func_1084(var_66_bool)
{
	var_66_bool = 0; // 0x43c MovB
	return 0; // 0x43d Return
}


func_957(var_49_bool, var_50_object, var_51_int)
{
	var_52_object = Obj(); var_53_object = Obj(); var_54_int = 0; var_55_object = Obj(); var_56_object = Obj(); var_57_int = 0; // 0x3bd PushV
	var_58_object = Obj(); // 0x3be PushV
	func_944(var_58_object); // 0x3bf NEW_2
	var_55_object = var_58_object; // 0x3c0 Mov
	Find(var_51_int, var_56_object); // 0x3c2 ObjFunc
	var_63_bool = var_56_object == 0; // 0x3c4 Not
	if(var_63_bool == 0) goto Label_972; // 0x3c5 JumpB
	var_64_string = "Can't find diary parent with id: "; // 0x3c6 PushS
	var_65_int = var_64_string + var_51_int; // 0x3c7 Add
	Trace(var_65_int); // 0x3c8 Func
	var_49_bool = 0; // 0x3ca MovB
	return 6; // 0x3cb Return
	
Label_972:
	AddChild(var_50_object); // 0x3cc ObjFunc
	var_66_int = 7; // 0x3ce PushI
	SendWorldWndMessage(var_66_int); // 0x3cf Func
	GetCategory(var_57_int); // 0x3d1 ObjFunc
	SetDiarySection(var_57_int); // 0x3d3 Func
	var_49_bool = 0; // 0x3d5 MovB
	return 6; // 0x3d6 Return
}


func_832(var_19_object)
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x340 PushV
	self(var_21_object); // 0x341 Func
	var_19_object = var_21_object; // 0x343 Mov
...
func_838(var_51_cvector, var_52_cvector)
{
	var_54_float = 0; var_55_float = 0; // 0x346 PushV
	var_56_int = var_52_cvector | var_52_cvector; // 0x347 Or
	var_55_float = sqrt(var_56_int); // 0x348 Sqrt2
	var_57_float = 0.0; // 0x349 PushF
	var_58_bool = var_55_float < var_57_float; // 0x34a LT
	if(var_58_bool == 0) goto Label_846; // 0x34b JumpB
	var_51_cvector = CVector(0.0, 0.0, 0.0); // 0x34c MovV
	return 2; // 0x34d Return
	
Label_846:
	var_51_cvector = var_52_cvector / var_52_cvector; // 0x34e Div2
...
Label_121:
	...
	func_783(var_128_string); // 0x7b NEW_2
...
func_848(var_111_int, var_112_string)
{
	var_113_int = 0; var_114_int = 0; // 0x350 PushV
	GetVariable(var_112_string, var_114_int); // 0x351 Func
	var_111_int = var_114_int; // 0x353 Mov
...
Label_482:
	...
	func_832(var_21_object); // 0x1e4 NEW_2
...
func_853(var_41_float)
{
	var_42_float = 0; var_43_float = 0; // 0x355 PushV
	GetGameTime(var_43_float); // 0x356 Func
	var_41_float = var_43_float; // 0x358 Mov
...
Label_608:
	...
	func_1059(var_46_int); // 0x261 NEW_2
...
Label_623:
	...
	func_1052(var_68_string, var_69_int); // 0x27d NEW_2
...
func_985(var_30_object)
{
	var_31_object = Obj(); var_32_object = Obj(); var_33_object = Obj(); var_34_object = Obj(); // 0x3d9 PushV
	GetMainOutdoorScene(var_33_object); // 0x3da Func
	var_35_bool = var_33_object == 0; // 0x3dc NullEq
	if(var_35_bool == 0) goto Label_996; // 0x3dd JumpB
	var_36_string = "Can't find main outdoor scene"; // 0x3de PushS
	Trace(var_36_string); // 0x3df Func
	var_34_object = 0; // 0x3e1 SetNull
	var_30_object = var_34_object; // 0x3e2 Mov
	return 4; // 0x3e3 Return
	
Label_996:
	GetMap(var_34_object); // 0x3e4 ObjFunc
	var_30_object = var_34_object; // 0x3e6 Mov
...
func_858()
{
	var_20_string = "ood8Doberman1"; // 0x35b PushS
	var_21_int = 1; // 0x35c PushI
	SetVariable(var_20_string, var_21_int); // 0x35d Func
...
func_864()
{
	var_77_object = Obj(); var_78_string = ""; var_79_float = 0; // 0x361 PushV
	var_80_object = Obj(); // 0x362 PushV
	func_985(var_80_object); // 0x363 NEW_2
	var_77_object = var_80_object; // 0x364 Mov
	var_78_string = "pt_map_kapella"; // 0x366 MovS
	var_79_float = 2; // 0x367 MovI
	func_1002(var_77_object, var_78_string, var_79_float); // 0x368 NEW_2
	var_100_object = Obj(); // 0x36a PushV
	func_985(var_100_object); // 0x36b NEW_2
	ShowMap(var_100_object); // 0x36d ObjFunc
	return 0; // 0x36f Return
}


func_1002(var_77_object, var_78_string, var_79_float)
{
	var_81_cvector = CVector(0,0,0); var_82_cvector = CVector(0,0,0); var_83_object = Obj(); var_84_bool = 0; var_85_cvector = CVector(0,0,0); var_86_cvector = CVector(0,0,0); var_87_object = Obj(); var_88_bool = 0; // 0x3ea PushV
	GetMainOutdoorScene(var_87_object); // 0x3eb Func
	var_89_bool = var_87_object == 0; // 0x3ed NullEq
	if(var_89_bool == 0) goto Label_1011; // 0x3ee JumpB
	var_90_string = "Can't find main outdoor scene"; // 0x3ef PushS
	Trace(var_90_string); // 0x3f0 Func
	return 8; // 0x3f2 Return
	
Label_1011:
	GetLocator(var_78_string, var_88_bool, var_85_cvector, var_86_cvector); // 0x3f3 ObjFunc
	var_91_bool = var_88_bool == 0; // 0x3f5 Not
	if(var_91_bool == 0) goto Label_1021; // 0x3f6 JumpB
	var_92_string = "Warning: outdoor scene locator "; // 0x3f7 PushS
	var_93_int = var_92_string + var_78_string; // 0x3f8 Add
	var_94_string = " doesnt exist"; // 0x3f9 PushS
	var_95_int = var_93_int + var_94_string; // 0x3fa Add
	Trace(var_95_int); // 0x3fb Func
	
Label_1021:
	GetMap(var_77_object); // 0x3fd ObjFunc
	var_96_bool = var_77_object == 0; // 0x3ff NullEq
	if(var_96_bool == 0) goto Label_1029; // 0x400 JumpB
	var_97_string = "Can't find map"; // 0x401 PushS
	Trace(var_97_string); // 0x402 Func
	return 8; // 0x404 Return
	
Label_1029:
	var_98_float = GetByIndex(var_85_cvector, 0); // 0x405 PushE
	var_99_float = GetByIndex(var_85_cvector, 2); // 0x406 PushE
	SetMapParams(var_98_float, var_99_float, var_79_float); // 0x407 ObjFunc
...
func_880()
{
	var_26_object = Obj(); var_27_object = Obj(); // 0x370 PushV
	var_28_string = "d8q02"; // 0x371 PushS
	var_29_int = 1; // 0x372 PushI
	SetVariable(var_28_string, var_29_int); // 0x373 Func
	var_30_object = Obj(); // 0x375 PushV
	func_985(var_30_object); // 0x376 NEW_2
	var_27_object = var_30_object; // 0x377 Mov
	var_37_string = "d8q02GotoKapella"; // 0x379 PushS
	var_38_string = "pt_map_kapella"; // 0x37a PushS
	var_39_int = 0; // 0x37b PushI
	var_40_int = 540068; // 0x37c PushI
	var_41_float = 0; // 0x37d PushV
	func_853(var_41_float); // 0x37e NEW_2
	AddMark(var_37_string, var_38_string, var_39_int, var_40_int, var_41_float); // 0x380 ObjFunc
	func_918(); // 0x383 NEW_2
	func_931(); // 0x386 NEW_2
...
func_766()
{
	var_146_bool = 0; var_147_bool = 0; // 0x2fe PushV
	CameraSwitchToNormal(); // 0x2ff Func
	var_148_bool = 0; // 0x301 PushV
	func_1084(var_148_bool); // 0x302 NEW_2
	if(var_148_bool == 0) goto Label_774; // 0x304 JumpB
...
Label_774:
	var_149_string = "head"; // 0x306 PushS
	HasAnimationTrack(var_147_bool, var_149_string); // 0x307 Func
	var_150_bool = var_147_bool; // 0x309 Push
	if(var_150_bool == 0) goto Label_782; // 0x30a JumpB
	var_151_string = "head"; // 0x30b PushS
	UnlookAsync(var_151_string); // 0x30c Func
}
