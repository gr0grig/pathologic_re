...
Label_204:
	...
	func_2278(var_96_object); // 0xda NEW_2
...
Label_375:
	...
	func_2401(var_172_bool); // 0x179 NEW_2
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool)
{
	...
	var_156_bool = var_16_int != var_19_object; // 0x18f Neq
	if(var_156_bool == 0) goto Label_406; // 0x190 JumpB
	var_157_bool = 0; var_158_string = ""; var_159_string = ""; // 0x191 PushV
	var_158_string = "quest_d8_04"; // 0x192 MovS
	var_159_string = "attack"; // 0x193 MovS
	func_2198(var_157_bool, var_158_string, var_159_string); // 0x194 NEW_2
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool)
{
	...
	func_2198(var_19_bool, var_20_string, var_21_string); // 0x19f NEW_2
...
Label_470:
	...
	func_2149(var_18_object); // 0x1d8 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_2210(var_18_object); // 0x514 NEW_2
...
Label_1329:
	...
	func_2090(var_19_object); // 0x535 NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object)
{
	...
	func_2380(var_19_object); // 0x5f3 NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x96c PushV
	var_19_object = var_15_object; // 0x96d Mov
	var_20_int = var_16_int; // 0x96e Mov
	var_21_float = var_17_float; // 0x96f Mov
	func_1876(var_19_object, var_20_int, var_21_float); // 0x970 NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x974 PushV
	var_21_object = var_15_object; // 0x975 Mov
	var_22_int = var_16_int; // 0x976 Mov
	var_23_float = var_17_float; // 0x977 Mov
	var_24_cvector = var_19_cvector; // 0x978 Mov
	var_25_cvector = var_20_cvector; // 0x979 Mov
	func_1944(var_23_float, var_24_cvector, var_25_cvector); // 0x97a NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x97d PushV
	var_19_string = "health"; // 0x97e PushS
	var_20_bool = var_16_string == var_19_string; // 0x97f Eq
	if(var_20_bool == 0) goto Label_2441; // 0x980 JumpB
	var_21_string = "health"; // 0x981 PushS
	GetProperty(var_21_string, var_18_float); // 0x982 Func
	var_22_int = 0; // 0x984 PushI
	var_23_bool = var_18_float <= var_22_int; // 0x985 LE
	if(var_23_bool == 0) goto Label_2441; // 0x986 JumpB
	SignalDeath(var_15_object); // 0x987 Func
...
{
	var_16_bool = 0; var_17_string = ""; var_18_string = ""; // 0x98b PushV
	var_17_string = "quest_d8_04"; // 0x98c MovS
	var_18_string = "death"; // 0x98d MovS
	func_2198(var_16_bool, var_17_string, var_18_string); // 0x98e NEW_2
	var_22_object = Obj(); // 0x990 PushV
	var_22_object = var_15_object; // 0x991 Mov
	func_2403(var_22_object); // 0x992 NEW_2
...
{
	var_15_object = Obj(); // 0x995 PushV
	func_2149(var_15_object); // 0x996 NEW_2
	RemoveActor(var_15_object); // 0x998 Func
	Hold(); // 0x99a Func
...
Label_56:
	var_148_bool = var_27_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_149_object = var_18_object; // 0x40 Mov
	func_2042(); // 0x41 NEW_2
...
func_2059(var_132_string)
{
	var_133_bool = 0; var_134_float = 0; var_135_float = 0; var_136_bool = 0; var_137_float = 0; var_138_float = 0; // 0x80b PushV
	lshHasAnimation(var_136_bool, var_132_string); // 0x80c Func
	var_139_bool = var_136_bool; // 0x80e Push
	if(var_139_bool == 0) goto Label_2070; // 0x80f JumpB
	lshGetAnimTimes(var_132_string, var_137_float, var_138_float); // 0x810 Func
	var_140_bool = 0; // 0x812 PushB
	lshPlayAnimation(var_137_float, var_138_float, var_140_bool); // 0x813 Func
	goto Label_2074; // 0x815 Jump
	
Label_2074:
	return 6; // 0x81a Return
	
Label_2070:
	var_141_string = "Can't find lsh animation : "; // 0x816 PushS
	var_142_int = var_141_string + var_132_string; // 0x817 Add
	Trace(var_142_int); // 0x818 Func
}


func_2316(var_39_object)
{
	var_40_object = Obj(); var_41_object = Obj(); // 0x90c PushV
	GetDiaryRoot(var_41_object); // 0x90d Func
	var_42_bool = var_41_object == 0; // 0x90f Not
	if(var_42_bool == 0) goto Label_2326; // 0x910 JumpB
	var_43_string = "Can't retrieve diary root"; // 0x911 PushS
	Trace(var_43_string); // 0x912 Func
	var_39_object = 0; // 0x914 MovB
	return 2; // 0x915 Return
	
Label_2326:
	var_39_object = var_41_object; // 0x916 Mov
...
func_2329(var_30_bool, var_31_object, var_32_int)
{
	var_33_object = Obj(); var_34_object = Obj(); var_35_int = 0; var_36_object = Obj(); var_37_object = Obj(); var_38_int = 0; // 0x919 PushV
	var_39_object = Obj(); // 0x91a PushV
	func_2316(var_39_object); // 0x91b NEW_2
	var_36_object = var_39_object; // 0x91c Mov
	Find(var_32_int, var_37_object); // 0x91e ObjFunc
	var_44_bool = var_37_object == 0; // 0x920 Not
	if(var_44_bool == 0) goto Label_2344; // 0x921 JumpB
	var_45_string = "Can't find diary parent with id: "; // 0x922 PushS
	var_46_int = var_45_string + var_32_int; // 0x923 Add
	Trace(var_46_int); // 0x924 Func
	var_30_bool = 0; // 0x926 MovB
	return 6; // 0x927 Return
	
Label_2344:
	AddChild(var_31_object); // 0x928 ObjFunc
	var_47_int = 7; // 0x92a PushI
	SendWorldWndMessage(var_47_int); // 0x92b Func
	GetCategory(var_38_int); // 0x92d ObjFunc
	SetDiarySection(var_38_int); // 0x92f Func
	var_30_bool = 0; // 0x931 MovB
	return 6; // 0x932 Return
}
...
func_2075(var_99_string, var_100_bool)
{
	var_103_bool = 0; var_104_float = 0; var_105_float = 0; var_106_bool = 0; var_107_float = 0; var_108_float = 0; // 0x81b PushV
	lshHasAnimation(var_106_bool, var_99_string); // 0x81c Func
	var_109_bool = var_106_bool; // 0x81e Push
	if(var_109_bool == 0) goto Label_2085; // 0x81f JumpB
	lshGetAnimTimes(var_99_string, var_107_float, var_108_float); // 0x820 Func
	lshPlayAnimation(var_107_float, var_108_float, var_100_bool); // 0x822 Func
...
Label_2085:
	var_110_string = "Can't find lsh animation : "; // 0x825 PushS
	var_111_int = var_110_string + var_99_string; // 0x826 Add
	Trace(var_111_int); // 0x827 Func
}
...
func_1023(var_488_bool, var_489_float)
{
	var_490_float = 0; var_491_bool = 0; var_492_float = 0; var_493_bool = 0; // 0x3ff PushV
	rand(var_492_float); // 0x400 Func
	var_494_bool = var_492_float < var_489_float; // 0x402 LT
	if(var_494_bool == 0) goto Label_1043; // 0x403 JumpB
	
Label_1028:
	IsAnimationPlaying(var_493_bool); // 0x404 Func
	var_495_bool = var_493_bool == 0; // 0x406 Not
	if(var_495_bool == 0) goto Label_1033; // 0x407 JumpB
...
Label_1048:
	var_488_bool = 0; // 0x418 MovB
	return 4; // 0x419 Return
	
Label_1033:
	var_496_bool = 0; // 0x409 PushV
	func_1121(var_496_bool); // 0x40a NEW_2
	if(var_496_bool == 0) goto Label_1039; // 0x40c JumpB
	var_488_bool = 1; // 0x40d MovB
...
Label_1043:
	...
	func_1225(var_493_bool); // 0x416 NEW_2
}
...
func_2090(var_19_object)
{
	var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_float = 0; var_23_cvector = CVector(0,0,0); // 0x82a PushV
	GetEyesHeight(var_22_float); // 0x82b ObjFunc
	var_23_cvector = CVector(0.0, 0.0, 0.0); // 0x82d MovV
	var_24_float = GetByIndex(var_23_cvector, 1); // 0x82e PushE
	var_24_float = var_22_float; // 0x82f Mov
	SetByIndex(var_23_cvector, 1) = var_24_float; // 0x830 PopE
	var_25_string = "head"; // 0x831 PushS
	LookAsync(var_19_object, var_25_string, var_23_cvector); // 0x832 Func
	return 4; // 0x834 Return
}
...
func_2101()
{
	var_18_bool = 0; // 0x835 PushV
	func_2401(var_18_bool); // 0x836 NEW_2
	if(var_18_bool == 0) goto Label_2107; // 0x838 JumpB
	lshStopSpeech(); // 0x839 Func
...
Label_566:
	...
	var_520_int = 1; // 0x23c PushI
	Sleep(var_520_int); // 0x23d Func
	goto Label_566; // 0x23f Jump
}


func_2357(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x935 PushV
	var_82_string = "branch"; // 0x936 PushS
	GetVariable(var_82_string, var_81_int); // 0x937 Func
	var_83_int = 0; // 0x939 PushI
	var_84_bool = var_81_int == var_83_int; // 0x93a Eq
	if(var_84_bool == 0) goto Label_2367; // 0x93b JumpB
	var_79_int = 1; // 0x93c MovI
	return 2; // 0x93d Return
	
Label_2367:
	var_85_int = 1; // 0x93f PushI
	var_86_bool = var_81_int == var_85_int; // 0x940 Eq
	if(var_86_bool == 0) goto Label_2372; // 0x941 JumpB
	var_79_int = 2; // 0x942 MovI
	return 2; // 0x943 Return
	
Label_2372:
	var_79_int = 3; // 0x944 MovI
	return 2; // 0x945 Return
}


func_2108(var_47_string)
{
	var_48_bool = 0; var_49_int = 0; var_50_bool = 0; var_51_int = 0; var_52_bool = 0; var_53_float = 0; var_54_cvector = CVector(0,0,0); var_55_cvector = CVector(0,0,0); var_56_bool = 0; var_57_int = 0; var_58_bool = 0; var_59_int = 0; var_60_bool = 0; var_61_float = 0; var_62_cvector = CVector(0,0,0); var_63_cvector = CVector(0,0,0); // 0x83c PushV
	IsExisting3DSound(var_56_bool, var_47_string); // 0x83d Func
	var_64_bool = var_56_bool == 0; // 0x83f Not
	if(var_64_bool == 0) goto Label_2133; // 0x840 JumpB
	var_57_int = 0; // 0x841 MovI
	
Label_2114:
	var_65_int = 1; // 0x842 PushI
	var_66_int = var_57_int + var_65_int; // 0x843 Add
	var_67_int = var_47_string + var_66_int; // 0x844 Add
	IsExisting3DSound(var_58_bool, var_67_int); // 0x845 Func
	var_68_bool = var_58_bool == 0; // 0x847 Not
	if(var_68_bool == 0) goto Label_2122; // 0x848 JumpB
	goto Label_2125; // 0x849 Jump
	
Label_2125:
	var_69_bool = var_57_int == 0; // 0x84d Not
	if(var_69_bool == 0) goto Label_2128; // 0x84e JumpB
	return 16; // 0x84f Return
	
Label_2128:
	irand(var_59_int, var_57_int); // 0x850 Func
	var_70_int = 1; // 0x852 PushI
	var_71_int = var_59_int + var_70_int; // 0x853 Add
	var_47_string = var_47_string + var_71_int; // 0x854 Add2
	
Label_2133:
	Is3DSoundLoaded(var_60_bool, var_47_string); // 0x855 Func
	var_72_bool = var_60_bool; // 0x857 Push
	if(var_72_bool == 0) goto Label_2148; // 0x858 JumpB
	GetEyesHeight(var_61_float); // 0x859 Func
	GetDirection(var_62_cvector); // 0x85b Func
	var_73_int = 50; // 0x85d PushI
	var_63_cvector = var_62_cvector * var_73_int; // 0x85e Mult2
	var_74_float = GetByIndex(var_63_cvector, 1); // 0x85f PushE
	var_74_float = var_74_float + var_61_float; // 0x860 Add2
	SetByIndex(var_63_cvector, 1) = var_74_float; // 0x861 PopE
	PlayGlobalSound(var_47_string, var_63_cvector); // 0x862 Func
	
Label_2148:
	return 16; // 0x864 Return
	
Label_2122:
	var_75_int = 1; // 0x84a PushI
	var_57_int = var_57_int + var_75_int; // 0x84b Add2
	goto Label_2114; // 0x84c Jump
}
...
Label_602:
	...
	func_2149(var_84_object); // 0x264 NEW_2
...
Label_739:
	...
	var_504_string = "all"; // 0x2e5 PushS
	var_505_string = "fjump"; // 0x2e6 PushS
	PlayAnimation(var_504_string, var_505_string); // 0x2e7 Func
	WaitForAnimEnd(); // 0x2e9 Func
	func_1225(var_53_float); // 0x2ec NEW_2
	var_506_cvector = CVector(0.0, 0.0, 0.0); // 0x2ee PushVec
	SetSpeed(var_506_cvector); // 0x2ef Func
	Stop(); // 0x2f1 Func
	StopAsync(); // 0x2f3 Func
	var_507_bool = 0; // 0x2f5 PushV
	func_1182(var_53_float, var_507_bool); // 0x2f6 NEW_2
	var_508_bool = var_507_bool == 0; // 0x2f8 Not
	if(var_508_bool == 0) goto Label_785; // 0x2f9 JumpB
	var_509_bool = 0; var_510_object = Obj(); // 0x2fa PushV
	var_510_object = var_0_object; // 0x2fb MovT
	func_1808(var_509_bool, var_510_object); // 0x2fc NEW_2
	var_511_bool = var_509_bool == 0; // 0x2fe Not
	if(var_511_bool == 0) goto Label_769; // 0x2ff JumpB
...
Label_769:
	...
	var_512_float = var_31_float * var_31_float; // 0x307 Mult
	var_513_bool = var_50_float < var_512_float; // 0x308 LT
	if(var_513_bool == 0) goto Label_785; // 0x309 JumpB
	var_514_bool = 0; var_515_float = 0; // 0x30a PushV
	var_515_float = var_31_float; // 0x30b Mov
	func_886(var_53_float, var_514_bool, var_515_float); // 0x30c NEW_2
	var_516_bool = var_514_bool == 0; // 0x30e Not
	if(var_516_bool == 0) goto Label_785; // 0x30f JumpB
	goto Label_795; // 0x310 Jump
	
Label_786:
	var_517_bool = 0; var_518_float = 0; // 0x312 PushV
	var_518_float = var_31_float; // 0x313 Mov
	func_886(var_53_float, var_517_bool, var_518_float); // 0x314 NEW_2
...
func_2374(var_20_int)
{
	var_21_int = 0; var_22_int = 0; // 0x946 PushV
	var_23_string = "branch"; // 0x947 PushS
	GetVariable(var_23_string, var_22_int); // 0x948 Func
	var_20_int = var_22_int; // 0x94a Mov
...
Label_121:
	...
	func_2059(var_132_string); // 0x7b NEW_2
...
func_2380(var_19_object)
{
	var_20_int = 0; // 0x94d PushV
	func_2374(var_20_int); // 0x94e NEW_2
	var_24_int = 1; // 0x950 PushI
	var_25_bool = var_20_int == var_24_int; // 0x951 Eq
	if(var_25_bool == 0) goto Label_2390; // 0x952 JumpB
	WorkWithCorpse(var_19_object); // 0x953 Func
	goto Label_2392; // 0x955 Jump
	
Label_2392:
	return 0; // 0x958 Return
	
Label_2390:
	Barter(var_19_object); // 0x956 Func
}
...
func_847(var_0_object, var_387_float, var_388_int)
{
	...
	var_462_int = 0; // 0x36a PushV
	func_1230(var_462_int); // 0x36b NEW_2
	ReportHit(var_0_object, var_462_int, var_394_float, var_393_float); // 0x36d Func
	var_463_object = Obj(); var_464_float = 0; // 0x36f PushV
	var_463_object = var_392_object; // 0x370 Mov
	var_464_float = var_394_float; // 0x371 Mov
...
func_1617(var_46_string)
{
	...
	func_2108(var_47_string); // 0x65e NEW_2
...
Label_1892:
	...
	func_2155(var_47_cvector, var_48_cvector); // 0x76b NEW_2
...
func_2393(var_76_int)
{
	var_76_int = 521048; // 0x959 MovI
	return 0; // 0x95a Return
}


func_2395(var_75_int)
{
	var_75_int = 521047; // 0x95b MovI
	return 0; // 0x95c Return
}


func_2397(var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png"; // 0x95d MovS
	return 0; // 0x95e Return
}


func_2399(var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png"; // 0x95f MovS
...
func_2401(var_70_bool)
{
	var_70_bool = 0; // 0x961 MovB
	return 0; // 0x962 Return
}


func_2403(var_22_object)
{
	var_23_object = Obj(); // 0x964 PushV
	var_23_object = var_22_object; // 0x965 Mov
	TaskCall(5); // 0x966 TaskCall
	func_1501(var_23_object); // 0x967 NEW_2
	TaskReturn(); // 0x968 TaskReturn
	return 0; // 0x96a Return
}


func_2149(var_15_object)
{
	var_16_object = Obj(); var_17_object = Obj(); // 0x865 PushV
	self(var_17_object); // 0x866 Func
	var_15_object = var_17_object; // 0x868 Mov
	return 2; // 0x869 Return
}


func_2155(var_47_cvector, var_48_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x86b PushV
	var_57_int = var_48_cvector | var_48_cvector; // 0x86c Or
	var_56_float = sqrt(var_57_int); // 0x86d Sqrt2
	var_58_float = 0.0; // 0x86e PushF
	var_59_bool = var_56_float < var_58_float; // 0x86f LT
	if(var_59_bool == 0) goto Label_2163; // 0x870 JumpB
	var_47_cvector = CVector(0.0, 0.0, 0.0); // 0x871 MovV
	return 2; // 0x872 Return
	
Label_2163:
	var_47_cvector = var_48_cvector / var_48_cvector; // 0x873 Div2
...
func_2165(var_439_float, var_440_float, var_441_float)
{
	var_444_bool = var_440_float < var_441_float; // 0x876 LT
	if(var_444_bool == 0) goto Label_2170; // 0x877 JumpB
	var_439_float = var_440_float; // 0x878 Mov
	goto Label_2171; // 0x879 Jump
	
Label_2171:
	return 0; // 0x87b Return
	
Label_2170:
	var_439_float = var_441_float; // 0x87a Mov
}
...
Label_922:
	...
	var_465_string = "all"; // 0x39f PushS
	var_466_string = "attack_middle"; // 0x3a0 PushS
	var_467_int = var_466_string + var_356_int; // 0x3a1 Add
	HasAnimation(var_357_bool, var_465_string, var_467_int); // 0x3a2 Func
	var_468_bool = var_357_bool; // 0x3a4 Push
	if(var_468_bool == 0) goto Label_1003; // 0x3a5 JumpB
	func_2219(); // 0x3a7 NEW_2
	var_469_string = "all"; // 0x3a9 PushS
	var_470_string = "attack_middle"; // 0x3aa PushS
	var_471_int = var_470_string + var_356_int; // 0x3ab Add
	PlayAnimation(var_469_string, var_471_int); // 0x3ac Func
	WaitForAnimEnd(); // 0x3ae Func
	func_1225(var_359_string); // 0x3b1 NEW_2
	var_472_bool = 0; var_473_object = Obj(); // 0x3b3 PushV
	var_473_object = var_0_object; // 0x3b4 MovT
	func_1808(var_472_bool, var_473_object); // 0x3b5 NEW_2
	var_474_bool = var_472_bool == 0; // 0x3b7 Not
	if(var_474_bool == 0) goto Label_957; // 0x3b8 JumpB
	StopAsync(); // 0x3b9 Func
	var_350_bool = 0; // 0x3bb MovB
	return 8; // 0x3bc Return
	
Label_957:
	var_475_float = 0; var_476_int = 0; // 0x3bd PushV
	var_475_float = var_351_float; // 0x3be Mov
	var_476_int = var_356_int; // 0x3bf Mov
	func_847(var_359_string, var_475_float, var_476_int); // 0x3c0 NEW_2
	var_358_int = 1; // 0x3c2 MovI
	
Label_963:
	var_477_string = "attack_middle"; // 0x3c3 PushS
	var_478_int = var_477_string + var_356_int; // 0x3c4 Add
	var_479_string = "_"; // 0x3c5 PushS
	var_480_int = var_478_int + var_479_string; // 0x3c6 Add
	var_359_string = var_480_int + var_358_int; // 0x3c7 Add2
	var_481_string = "all"; // 0x3c8 PushS
	HasAnimation(var_357_bool, var_481_string, var_359_string); // 0x3c9 Func
	var_482_bool = var_357_bool == 0; // 0x3cb Not
	if(var_482_bool == 0) goto Label_974; // 0x3cc JumpB
	goto Label_1003; // 0x3cd Jump
	
Label_1003:
	var_483_bool = 0; // 0x3eb PushB
	SetAttackState(var_483_bool); // 0x3ec Func
	var_484_string = "all"; // 0x3ee PushS
	var_485_string = "attack_end"; // 0x3ef PushS
	var_486_int = var_485_string + var_356_int; // 0x3f0 Add
	PlayAnimation(var_484_string, var_486_int); // 0x3f1 Func
	var_487_bool = 0; // 0x3f3 PushV
	func_1239(var_487_bool); // 0x3f4 NEW_2
	if(var_487_bool == 0) goto Label_1021; // 0x3f6 JumpB
	var_488_bool = 0; var_489_float = 0; // 0x3f7 PushV
	var_489_float = 0.75; // 0x3f8 MovF
	func_1023(var_488_bool, var_489_float); // 0x3f9 NEW_2
...
Label_974:
	func_2219(); // 0x3cf NEW_2
	var_497_string = "all"; // 0x3d1 PushS
	PlayAnimation(var_497_string, var_359_string); // 0x3d2 Func
	WaitForAnimEnd(); // 0x3d4 Func
	func_1225(var_359_string); // 0x3d7 NEW_2
	var_498_bool = 0; var_499_object = Obj(); // 0x3d9 PushV
	var_499_object = var_0_object; // 0x3da MovT
	func_1808(var_498_bool, var_499_object); // 0x3db NEW_2
	var_500_bool = var_498_bool == 0; // 0x3dd Not
	if(var_500_bool == 0) goto Label_995; // 0x3de JumpB
	StopAsync(); // 0x3df Func
	var_350_bool = 0; // 0x3e1 MovB
	return 8; // 0x3e2 Return
	
Label_995:
	var_501_float = 0; var_502_int = 0; // 0x3e3 PushV
	var_501_float = var_351_float; // 0x3e4 Mov
	var_502_int = var_356_int; // 0x3e5 Mov
	func_847(var_359_string, var_501_float, var_502_int); // 0x3e6 NEW_2
	var_503_int = 1; // 0x3e8 PushI
	var_358_int = var_358_int + var_503_int; // 0x3e9 Add2
	goto Label_963; // 0x3ea Jump
}


func_2172(var_449_float, var_450_float, var_451_float, var_452_float)
{
	var_453_bool = var_450_float < var_451_float; // 0x87d LT
	if(var_453_bool == 0) goto Label_2177; // 0x87e JumpB
	var_449_float = var_451_float; // 0x87f Mov
	return 0; // 0x880 Return
	
Label_2177:
	var_454_bool = var_450_float > var_452_float; // 0x881 GT
	if(var_454_bool == 0) goto Label_2181; // 0x882 JumpB
	var_449_float = var_452_float; // 0x883 Mov
	return 0; // 0x884 Return
	
Label_2181:
	var_449_float = var_450_float; // 0x885 Mov
...
func_2183(var_115_int, var_116_string)
{
	var_117_int = 0; var_118_int = 0; // 0x887 PushV
	GetVariable(var_116_string, var_118_int); // 0x888 Func
	var_115_int = var_118_int; // 0x88a Mov
	return 2; // 0x88b Return
}


func_2188(var_457_float)
{
	var_458_object = Obj(); var_459_object = Obj(); // 0x88c PushV
	CreateFloatVector(var_459_object); // 0x88d Func
	add(var_457_float); // 0x88f ObjFunc
	var_460_int = 15; // 0x891 PushI
	SendWorldWndMessage(var_460_int, var_459_object); // 0x892 Func
...
func_142(var_2_object, var_95_string)
{
	...
	func_2401(var_96_bool); // 0x90 NEW_2
...
Label_160:
	func_2075(var_99_string, var_100_bool); // 0xa0 NEW_2
...
func_2198(var_16_bool, var_17_string, var_18_string)
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x896 PushV
	FindActor(var_20_object, var_17_string); // 0x897 Func
	var_21_bool = var_20_object == 0; // 0x899 NullEq
	if(var_21_bool == 0) goto Label_2205; // 0x89a JumpB
	var_16_bool = 0; // 0x89b MovB
	return 2; // 0x89c Return
	
Label_2205:
	Trigger(var_20_object, var_18_string); // 0x89d Func
	var_16_bool = 1; // 0x89f MovB
...
Label_1733:
	...
	func_2165(var_439_float, var_440_float, var_441_float); // 0x6ca NEW_2
	...
	func_2172(var_449_float, var_450_float, var_451_float, var_452_float); // 0x6d8 NEW_2
	...
	func_2188(var_457_float); // 0x6e3 NEW_2
...
Label_1713:
	var_461_string = "armor"; // 0x6b1 PushS
	GetProperty(var_461_string, var_414_int); // 0x6b2 ObjFunc
}


func_2210(var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0x8a2 PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x8a3 Func
	var_21_bool = var_20_bool; // 0x8a5 Push
	if(var_21_bool == 0) goto Label_2218; // 0x8a6 JumpB
	var_22_string = "attack"; // 0x8a7 PushS
	PlayGlobalMusic(var_22_string); // 0x8a8 Func
...
func_2219()
{
	var_362_object = Obj(); var_363_object = Obj(); // 0x8ab PushV
	GetScene(var_363_object); // 0x8ac Func
	var_364_string = "battle"; // 0x8ae PushS
	var_365_object = Obj(); // 0x8af PushV
	func_2149(var_365_object); // 0x8b0 NEW_2
	BroadcastMessage(var_364_string, var_365_object, var_363_object); // 0x8b2 Func
	return 2; // 0x8b4 Return
}
...
func_2230(var_46_string, var_47_int)
{
	var_48_string = ""; var_49_string = ""; // 0x8b6 PushV
	var_49_string = "idle"; // 0x8b7 MovS
	var_50_int = var_47_int; // 0x8b8 Push
	if(var_50_int == 0) goto Label_2235; // 0x8b9 JumpB
	var_49_string = var_49_string + var_47_int; // 0x8ba Add2
	
Label_2235:
	var_46_string = var_49_string; // 0x8bb Mov
	return 2; // 0x8bc Return
}
...
func_1974(var_28_bool, var_30_float)
{
	...
	func_2155(var_55_cvector, var_56_cvector); // 0x7d1 NEW_2
...
Label_2015:
	...
	CameraTransit(var_46_cvector, var_44_cvector); // 0x7e1 Func
	var_68_float = GetByIndex(var_45_cvector, 0); // 0x7e3 PushE
	var_69_float = GetByIndex(var_45_cvector, 2); // 0x7e4 PushE
	Rotate(var_68_float, var_69_float); // 0x7e5 Func
	var_70_bool = 0; // 0x7e7 PushV
	func_2401(var_70_bool); // 0x7e8 NEW_2
	if(var_70_bool == 0) goto Label_2028; // 0x7ea JumpB
	goto Label_2036; // 0x7eb Jump
	
Label_2036:
	CameraWaitForPlayFinish(); // 0x7f4 Func
	ResumeWorld(); // 0x7f6 Func
	var_28_bool = 1; // 0x7f8 MovB
	return 18; // 0x7f9 Return
	
Label_2028:
	var_71_string = "head"; // 0x7ec PushS
	HasAnimationTrack(var_48_bool, var_71_string); // 0x7ed Func
	var_72_bool = var_48_bool; // 0x7ef Push
	if(var_72_bool == 0) goto Label_2036; // 0x7f0 JumpB
	var_73_string = "head"; // 0x7f1 PushS
	LookAsyncCamera(var_73_string); // 0x7f2 Func
}


func_2237(var_40_int)
{
	var_41_int = 0; var_42_bool = 0; var_43_int = 0; var_44_bool = 0; // 0x8bd PushV
	var_43_int = 0; // 0x8be MovI
	
Label_2239:
	var_45_string = "all"; // 0x8bf PushS
	var_46_string = ""; var_47_int = 0; // 0x8c0 PushV
	var_47_int = var_43_int; // 0x8c1 Mov
	func_2230(var_46_string, var_47_int); // 0x8c2 NEW_2
	HasAnimation(var_44_bool, var_45_string, var_46_string); // 0x8c4 Func
	var_51_bool = var_44_bool == 0; // 0x8c6 Not
	if(var_51_bool == 0) goto Label_2249; // 0x8c7 JumpB
	goto Label_2252; // 0x8c8 Jump
	
Label_2252:
	var_40_int = var_43_int; // 0x8cc Mov
	return 4; // 0x8cd Return
	
Label_2249:
	var_52_int = 1; // 0x8c9 PushI
	var_43_int = var_43_int + var_52_int; // 0x8ca Add2
	goto Label_2239; // 0x8cb Jump
}
...
func_1225(var_0_object)
{
	...
	func_2210(var_125_object); // 0x4cb NEW_2
...
func_2254()
{
	var_50_int = 1; // 0x8cf PushI
	SetReturnValue(var_50_int); // 0x8d0 ObjFunc
...
func_1232()
{
	...
	func_2108(var_258_string); // 0x4d2 NEW_2
...
func_2259()
{
	var_23_string = "d8q04"; // 0x8d4 PushS
	var_24_int = 2; // 0x8d5 PushI
	SetVariable(var_23_string, var_24_int); // 0x8d6 Func
	func_2303(); // 0x8d9 NEW_2
...
func_2268()
{
	func_2290(); // 0x8de NEW_2
	var_67_bool = 0; var_68_string = ""; var_69_string = ""; // 0x8e0 PushV
	var_68_string = "quest_d8_04"; // 0x8e1 MovS
	var_69_string = "fail"; // 0x8e2 MovS
	func_2198(var_67_bool, var_68_string, var_69_string); // 0x8e3 NEW_2
...
func_1245(var_2_object, var_132_bool, var_133_object, var_134_float, var_135_float, var_136_bool, var_137_bool)
{
	...
	func_2210(var_145_object); // 0x4e0 NEW_2
	...
	func_2090(var_149_object); // 0x4ed NEW_2
...
Label_1265:
	...
	func_2149(var_160_object); // 0x4f7 NEW_2
...
Label_488:
	...
	func_2237(var_40_int); // 0x1e9 NEW_2
...
Label_503:
	...
	func_2230(var_62_string, var_63_int); // 0x205 NEW_2
...
func_2278(var_113_bool)
{
	var_115_int = 0; var_116_string = ""; // 0x8e7 PushV
	var_116_string = "d8q04"; // 0x8e8 MovS
	func_2183(var_115_int, var_116_string); // 0x8e9 NEW_2
	var_119_int = 1; // 0x8eb PushI
	var_120_bool = var_115_int == var_119_int; // 0x8ec Eq
	if(var_120_bool == 0) goto Label_2288; // 0x8ed JumpB
	var_113_bool = 1; // 0x8ee MovB
	return 0; // 0x8ef Return
	
Label_2288:
	var_113_bool = 0; // 0x8f0 MovB
...
func_2290()
{
	var_59_object = Obj(); var_60_object = Obj(); // 0x8f2 PushV
	var_61_int = 654; // 0x8f3 PushI
	var_62_int = 2; // 0x8f4 PushI
	var_63_int = 533367; // 0x8f5 PushI
	CreateDiaryEntry(var_60_object, var_61_int, var_62_int, var_63_int); // 0x8f6 Func
	var_64_bool = 0; var_65_object = Obj(); var_66_int = 0; // 0x8f8 PushV
	var_65_object = var_60_object; // 0x8f9 Mov
	var_66_int = 649; // 0x8fa MovI
	func_2329(var_64_bool, var_65_object, var_66_int); // 0x8fb NEW_2
...
Label_1594:
	...
	func_2108(var_99_string); // 0x63c NEW_2
...
func_2042()
{
	var_150_bool = 0; var_151_bool = 0; // 0x7fa PushV
	CameraSwitchToNormal(); // 0x7fb Func
	var_152_bool = 0; // 0x7fd PushV
	func_2401(var_152_bool); // 0x7fe NEW_2
	if(var_152_bool == 0) goto Label_2050; // 0x800 JumpB
	goto Label_2058; // 0x801 Jump
	
Label_2058:
	return 2; // 0x80a Return
	
Label_2050:
	var_153_string = "head"; // 0x802 PushS
	HasAnimationTrack(var_151_bool, var_153_string); // 0x803 Func
	var_154_bool = var_151_bool; // 0x805 Push
	if(var_154_bool == 0) goto Label_2058; // 0x806 JumpB
	var_155_string = "head"; // 0x807 PushS
	UnlookAsync(var_155_string); // 0x808 Func
}


func_2303()
{
	var_25_object = Obj(); var_26_object = Obj(); // 0x8ff PushV
	var_27_int = 651; // 0x900 PushI
	var_28_int = 2; // 0x901 PushI
	var_29_int = 533364; // 0x902 PushI
	CreateDiaryEntry(var_26_object, var_27_int, var_28_int, var_29_int); // 0x903 Func
	var_30_bool = 0; var_31_object = Obj(); var_32_int = 0; // 0x905 PushV
	var_31_object = var_26_object; // 0x906 Mov
	var_32_int = 649; // 0x907 MovI
	func_2329(var_30_bool, var_31_object, var_32_int); // 0x908 NEW_2
