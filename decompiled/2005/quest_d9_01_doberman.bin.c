...
Label_263:
	...
	func_660(var_81_bool); // 0x109 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_588(var_27_object); // 0x15c NEW_2
...
func_132(var_2_object, var_92_string)
{
	...
	func_660(var_93_bool); // 0x86 NEW_2
...
Label_150:
	func_573(var_96_string, var_97_bool); // 0x96 NEW_2
...
Label_111:
	...
	func_557(var_118_string); // 0x71 NEW_2
...
func_652(var_73_int)
{
	var_73_int = 518097; // 0x28c MovI
	return 0; // 0x28d Return
}


func_588(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x24c PushV
	GetEyesHeight(var_30_float); // 0x24d ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x24f MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x250 PushE
	var_32_float = var_30_float; // 0x251 Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x252 PopE
	var_33_string = "head"; // 0x253 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x254 Func
...
func_654(var_72_int)
{
	var_72_int = 518096; // 0x28e MovI
	return 0; // 0x28f Return
}


func_656(var_74_string)
{
	var_74_string = "ui/NPC_Citizen2.png"; // 0x290 MovS
...
{
	var_75_string = "ui/NPC_Citizen2_b.png"; // 0x292 MovS
...
func_660(var_67_bool)
{
	var_67_bool = 0; // 0x294 MovB
...
func_662()
{
	var_18_bool = 0; var_19_string = ""; var_20_string = ""; // 0x297 PushV
	var_19_string = "quest_d9_01"; // 0x298 MovS
	var_20_string = "teleport_to_han"; // 0x299 MovS
	func_616(var_18_bool, var_19_string, var_20_string); // 0x29a NEW_2
...
func_599()
{
	var_13_bool = 0; // 0x257 PushV
	func_660(var_13_bool); // 0x258 NEW_2
	if(var_13_bool == 0) goto Label_605; // 0x25a JumpB
...
func_472(var_25_bool, var_27_float)
{
	...
	func_606(var_52_cvector, var_53_cvector); // 0x1f3 NEW_2
...
Label_513:
	...
	CameraTransit(var_43_cvector, var_41_cvector); // 0x203 Func
	var_65_float = GetByIndex(var_42_cvector, 0); // 0x205 PushE
	var_66_float = GetByIndex(var_42_cvector, 2); // 0x206 PushE
	Rotate(var_65_float, var_66_float); // 0x207 Func
	var_67_bool = 0; // 0x209 PushV
	func_660(var_67_bool); // 0x20a NEW_2
	if(var_67_bool == 0) goto Label_526; // 0x20c JumpB
	goto Label_534; // 0x20d Jump
	
Label_534:
	CameraWaitForPlayFinish(); // 0x216 Func
	ResumeWorld(); // 0x218 Func
	var_25_bool = 1; // 0x21a MovB
	return 18; // 0x21b Return
	
Label_526:
	var_68_string = "head"; // 0x20e PushS
	HasAnimationTrack(var_45_bool, var_68_string); // 0x20f Func
	var_69_bool = var_45_bool; // 0x211 Push
	if(var_69_bool == 0) goto Label_534; // 0x212 JumpB
	var_70_string = "head"; // 0x213 PushS
	LookAsyncCamera(var_70_string); // 0x214 Func
}


func_540()
{
	var_136_bool = 0; var_137_bool = 0; // 0x21c PushV
	CameraSwitchToNormal(); // 0x21d Func
	var_138_bool = 0; // 0x21f PushV
	func_660(var_138_bool); // 0x220 NEW_2
	if(var_138_bool == 0) goto Label_548; // 0x222 JumpB
...
Label_548:
	var_139_string = "head"; // 0x224 PushS
	HasAnimationTrack(var_137_bool, var_139_string); // 0x225 Func
	var_140_bool = var_137_bool; // 0x227 Push
	if(var_140_bool == 0) goto Label_556; // 0x228 JumpB
	var_141_string = "head"; // 0x229 PushS
	UnlookAsync(var_141_string); // 0x22a Func
}


func_669(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x29d PushV
	var_79_string = "branch"; // 0x29e PushS
	GetVariable(var_79_string, var_78_int); // 0x29f Func
	var_80_int = 0; // 0x2a1 PushI
	var_81_bool = var_78_int == var_80_int; // 0x2a2 Eq
	if(var_81_bool == 0) goto Label_679; // 0x2a3 JumpB
	var_76_int = 1; // 0x2a4 MovI
	return 2; // 0x2a5 Return
	
Label_679:
	var_82_int = 1; // 0x2a7 PushI
	var_83_bool = var_78_int == var_82_int; // 0x2a8 Eq
	if(var_83_bool == 0) goto Label_684; // 0x2a9 JumpB
	var_76_int = 2; // 0x2aa MovI
	return 2; // 0x2ab Return
	
Label_684:
	var_76_int = 3; // 0x2ac MovI
	return 2; // 0x2ad Return
}


func_606(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x25e PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x25f Or
	var_56_float = sqrt(var_57_int); // 0x260 Sqrt2
	var_58_float = 0.0; // 0x261 PushF
	var_59_bool = var_56_float < var_58_float; // 0x262 LT
	if(var_59_bool == 0) goto Label_614; // 0x263 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x264 MovV
	return 2; // 0x265 Return
	
Label_614:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x266 Div2
...
func_616(var_18_bool, var_19_string, var_20_string)
{
	var_21_object = Obj(); var_22_object = Obj(); // 0x268 PushV
	FindActor(var_22_object, var_19_string); // 0x269 Func
	var_23_bool = var_22_object == 0; // 0x26b NullEq
	if(var_23_bool == 0) goto Label_623; // 0x26c JumpB
	var_18_bool = 0; // 0x26d MovB
	return 2; // 0x26e Return
	
Label_623:
	Trigger(var_22_object, var_20_string); // 0x26f Func
	var_18_bool = 1; // 0x271 MovB
	return 2; // 0x272 Return
}


func_557(var_118_string)
{
	var_119_bool = 0; var_120_float = 0; var_121_float = 0; var_122_bool = 0; var_123_float = 0; var_124_float = 0; // 0x22d PushV
	lshHasAnimation(var_122_bool, var_118_string); // 0x22e Func
	var_125_bool = var_122_bool; // 0x230 Push
	if(var_125_bool == 0) goto Label_568; // 0x231 JumpB
	lshGetAnimTimes(var_118_string, var_123_float, var_124_float); // 0x232 Func
	var_126_bool = 0; // 0x234 PushB
	lshPlayAnimation(var_123_float, var_124_float, var_126_bool); // 0x235 Func
	goto Label_572; // 0x237 Jump
	
Label_572:
	return 6; // 0x23c Return
	
Label_568:
	var_127_string = "Can't find lsh animation : "; // 0x238 PushS
	var_128_int = var_127_string + var_118_string; // 0x239 Add
	Trace(var_128_int); // 0x23a Func
}


func_628(var_41_string, var_42_int)
{
	var_43_string = ""; var_44_string = ""; // 0x274 PushV
	var_44_string = "idle"; // 0x275 MovS
	var_45_int = var_42_int; // 0x276 Push
	if(var_45_int == 0) goto Label_633; // 0x277 JumpB
	var_44_string = var_44_string + var_42_int; // 0x278 Add2
	
Label_633:
	var_41_string = var_44_string; // 0x279 Mov
...
Label_382:
	...
	func_635(var_35_int); // 0x17f NEW_2
...
Label_397:
	...
	func_628(var_57_string, var_58_int); // 0x19b NEW_2
...
func_635(var_35_int)
{
	var_36_int = 0; var_37_bool = 0; var_38_int = 0; var_39_bool = 0; // 0x27b PushV
	var_38_int = 0; // 0x27c MovI
	
Label_637:
	var_40_string = "all"; // 0x27d PushS
	var_41_string = ""; var_42_int = 0; // 0x27e PushV
	var_42_int = var_38_int; // 0x27f Mov
	func_628(var_41_string, var_42_int); // 0x280 NEW_2
	HasAnimation(var_39_bool, var_40_string, var_41_string); // 0x282 Func
	var_46_bool = var_39_bool == 0; // 0x284 Not
	if(var_46_bool == 0) goto Label_647; // 0x285 JumpB
	goto Label_650; // 0x286 Jump
	
Label_650:
	var_35_int = var_38_int; // 0x28a Mov
	return 4; // 0x28b Return
	
Label_647:
	var_47_int = 1; // 0x287 PushI
	var_38_int = var_38_int + var_47_int; // 0x288 Add2
	goto Label_637; // 0x289 Jump
}


func_573(var_96_string, var_97_bool)
{
	var_100_bool = 0; var_101_float = 0; var_102_float = 0; var_103_bool = 0; var_104_float = 0; var_105_float = 0; // 0x23d PushV
	lshHasAnimation(var_103_bool, var_96_string); // 0x23e Func
	var_106_bool = var_103_bool; // 0x240 Push
	if(var_106_bool == 0) goto Label_583; // 0x241 JumpB
	lshGetAnimTimes(var_96_string, var_104_float, var_105_float); // 0x242 Func
	lshPlayAnimation(var_104_float, var_105_float, var_97_bool); // 0x244 Func
...
Label_583:
	var_107_string = "Can't find lsh animation : "; // 0x247 PushS
	var_108_int = var_107_string + var_96_string; // 0x248 Add
	Trace(var_108_int); // 0x249 Func
}
