...
0xcf8: Stack[-2] = Stack[-4]
0xcf9: PushEmpty(string)
0xcfa: Call2 0xe2d

0xcfb: Stack[-2] = Stack[-1]
0xcfc: Pop(1)
0xcfd: Call2 0xa97
...
0xd04: Pop(0)
0xd05: Push((int) 1)
0xd06: @@ SetProperty(Stack[-2], Stack[-1])
0xd07: Pop(2)
...
0xd3d: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5])
0xd3e: Pop(1)
...
0xd47: Push("Pantrol point count: ")
...
0xd5d: Push("changing state to c_iStateWaitForLoad")
0xd5e: @ Trace(Stack[-1])
0xd5f: Pop(1)
0xd60: GOTO 0xd78
...
0xd64: Push("changing state to c_iStateHeatHands")
0xd65: @ Trace(Stack[-1])
0xd66: Pop(1)
0xd67: GOTO 0xd78
...
0xd6b: Push("changing state to c_iStateIdle")
0xd6c: @ Trace(Stack[-1])
0xd6d: Pop(1)
0xd6e: GOTO 0xd78
...
0xd72: Push("changing state to c_iStatePatrol")
0xd73: @ Trace(Stack[-1])
0xd74: Pop(1)
0xd75: GOTO 0xd78
...
0xd87: Push("changing state to c_iStateAware")
0xd88: @ Trace(Stack[-1])
0xd89: Pop(1)
...
0xd99: Push("changing state to c_iStateSearchEnemy")
0xd9a: @ Trace(Stack[-1])
0xd9b: Pop(1)
0xd9c: Push(GlobalVars[5])
0xd9d: Stack[-1] = Stack[-2]
...
0xdab: Push("changing state to c_iStateHearEnemy")
0xdac: @ Trace(Stack[-1])
0xdad: Pop(1)
0xdae: Push(GlobalVars[6])
0xdaf: Stack[-1] = Stack[-2]
...
0xdbd: Push("changing state to c_iStateAttack")
0xdbe: @ Trace(Stack[-1])
0xdbf: Pop(1)
0xdc0: Push(GlobalVars[7])
0xdc1: Stack[-1] = Stack[-2]
...
0xe04: Stack[-3] = Stack[-7]
0xe05: Stack[-2] = Stack[-6]
...
0xe0c: Stack[-5] = Stack[-11]
0xe0d: Stack[-4] = Stack[-10]
0xe0e: Stack[-3] = Stack[-9]
0xe0f: Stack[-2] = Stack[-7]
0xe10: Stack[-1] = Stack[-6]
0xe11: Call2 0xbb3
...
0xe29: Stack[-1] = "pt_d9q02_patrol"
0xe2a: Return(); Pop(0)

0xe2b: Stack[-1] = "d9q02_helpme"
0xe2c: Return(); Pop(0)

0xe2d: Stack[-1] = "d9q02_corpse"
0xe2e: Return(); Pop(0)

0xe2f: Stack[-1] = "pt_d9q02_center"
0xe30: Return(); Pop(0)
