...
0x23d: @ lshHasAnimation(Stack[-3], Stack[-7])
0x23e: Pop(0)
0x23f: Push(Stack[-3])
0x240: IF (Stack[-1] == 0) GOTO 0x247; Pop(1)

0x241: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x242: Pop(0)
0x243: Push((bool) 0)
0x244: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x245: Pop(1)
0x246: GOTO 0x24b

0x247: Push("Can't find lsh animation : ")
0x248: Pop(1); Push(Stack[-1] + Stack[-8]);
0x249: @ Trace(Stack[-1])
0x24a: Pop(1)
0x24b: Return(); Pop(6)

0x24c: PushEmpty(bool, float, float, bool, float, float)
0x24d: @ lshHasAnimation(Stack[-3], Stack[-8])
0x24e: Pop(0)
0x24f: Push(Stack[-3])
0x250: IF (Stack[-1] == 0) GOTO 0x256; Pop(1)

0x251: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x252: Pop(0)
0x253: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x254: Pop(0)
0x255: GOTO 0x25a

0x256: Push("Can't find lsh animation : ")
0x257: Pop(1); Push(Stack[-1] + Stack[-9]);
0x258: @ Trace(Stack[-1])
0x259: Pop(1)
0x25a: Return(); Pop(6)

0x25b: PushEmpty(float, cvector, float, cvector)
0x25c: @@ GetEyesHeight(Stack[-2])
0x25d: Pop(0)
0x25e: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x25f: Push(CvectorIndex(Stack[-1], 1))
0x260: Stack[-1] = Stack[-3]
0x261: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x262: Push("head")
0x263: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x264: Pop(1)
0x265: Return(); Pop(4)
...
0x26e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x26f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x270: Push((float)0.0)
0x271: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x272: IF (Stack[-1] == 0) GOTO 0x275; Pop(1)

0x273: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x274: Return(); Pop(2)

0x275: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x276: Return(); Pop(2)

0x277: PushEmpty(int, int)
0x278: @ GetVariable(Stack[-3], Stack[-1])
0x279: Pop(0)
...
0x287: Stack[-1] = 0
0x288: Stack[-1] = (int) 518716
0x289: Return(); Pop(0)

0x28a: Stack[-1] = (int) 518715
0x28b: Return(); Pop(0)

0x28c: Stack[-1] = "ui/NPC_Prophet.png"
0x28d: Return(); Pop(0)

0x28e: Stack[-1] = "ui/NPC_Prophet_b.png"
0x28f: Return(); Pop(0)

0x290: Stack[-1] = (bool) 0
0x291: Return(); Pop(0)

0x292: PushEmpty(string, string)
0x293: Stack[-1] = "idle"
0x294: Push(Stack[-3])
0x295: IF (Stack[-1] == 0) GOTO 0x297; Pop(1)

0x296: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x297: Stack[-4] = Stack[-1]
0x298: Return(); Pop(2)

0x299: PushEmpty(int, bool, int, bool)
0x29a: Stack[-2] = (int) 0
0x29b: Push("all")
0x29c: PushEmpty(string, int)
0x29d: Stack[-1] = Stack[-5]
0x29e: Call2 0x292

0x29f: Pop(1)
0x2a0: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2a1: Pop(2)
...
0x2a5: Push((int) 1)
0x2a6: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2a7: GOTO 0x29b

0x2a8: Stack[-5] = Stack[-2]
0x2a9: Return(); Pop(4)

0x2aa: PushEmpty()
0x2ab: PushEmpty(bool, string, string)
0x2ac: Stack[-2] = "quest_k10_01"
0x2ad: Stack[-1] = "teleport"
0x2ae: Call2 0x27c
