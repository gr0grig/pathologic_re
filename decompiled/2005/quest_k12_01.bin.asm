...
0x4a3: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)
...
0x4a9: Push("gameover_termit_chudo.xml")
0x4aa: @ GameOver(Stack[-1])
0x4ab: Pop(1)
0x4ac: GOTO 0x4b0

0x4ad: Push("gameover_termit.xml")
0x4ae: @ GameOver(Stack[-1])
0x4af: Pop(1)
0x4b0: GOTO 0x4e3
...
0x4bc: Push("gameover_utopist_chudo.xml")
0x4bd: @ GameOver(Stack[-1])
0x4be: Pop(1)
0x4bf: GOTO 0x4c3

0x4c0: Push("gameover_utopist.xml")
0x4c1: @ GameOver(Stack[-1])
0x4c2: Pop(1)
0x4c3: GOTO 0x4e3
...
0x4c6: Pop(0)
0x4c7: Push((int) 3)
0x4c8: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x4c9: IF (Stack[-1] == 0) GOTO 0x4d7; Pop(1)

0x4ca: Push("fin_smiren")
0x4cb: @ Trace(Stack[-1])
0x4cc: Pop(1)
0x4cd: Push(Stack[-1])
0x4ce: IF (Stack[-1] == 0) GOTO 0x4d3; Pop(1)

0x4cf: Push("gameover_smirennik_chudo.xml")
0x4d0: @ GameOver(Stack[-1])
0x4d1: Pop(1)
0x4d2: GOTO 0x4d6

0x4d3: Push("gameover_smirennik.xml")
0x4d4: @ GameOver(Stack[-1])
0x4d5: Pop(1)
0x4d6: GOTO 0x4e3
...
0x4dc: Push("gameover_beda_chudo.xml")
0x4dd: @ GameOver(Stack[-1])
0x4de: Pop(1)
0x4df: GOTO 0x4e3

0x4e0: Push("gameover_beda.xml")
0x4e1: @ GameOver(Stack[-1])
0x4e2: Pop(1)
0x4e3: Return(); Pop(18)

0x4e4: PushEmpty(int, int)
0x4e5: Push("k12q01BurahInSobor")
0x4e6: @ GetVariable(Stack[-1], Stack[-2])
0x4e7: Pop(1)
0x4e8: Push((int) 0)
0x4e9: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x4ea: Return(); Pop(2)

0x4eb: PushEmpty(int, int)
0x4ec: Push("k12q01DankoInSobor")
0x4ed: @ GetVariable(Stack[-1], Stack[-2])
0x4ee: Pop(1)
0x4ef: Push((int) 0)
0x4f0: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x4f1: Return(); Pop(2)

0x4f2: PushEmpty(bool, bool)
0x4f3: @ IsOverrideActive(Stack[-1])
0x4f4: Pop(0)
0x4f5: Stack[-3] = !Stack[-1]; Pop(0);
0x4f6: Return(); Pop(2)

0x4f7: PushEmpty(object, object)
0x4f8: Push("warehouse_rubin")
0x4f9: @ GetSceneByName(Stack[-2], Stack[-1])
0x4fa: Pop(1)
0x4fb: Push("rubin")
0x4fc: @ Trigger(Stack[-2], Stack[-1])
0x4fd: Pop(1)
0x4fe: PushEmpty(string, bool)
0x4ff: Stack[-2] = "warehouse_rubin@door1"
0x500: Stack[-1] = (bool) 0
0x501: Call2 0x25b

0x502: Pop(2)
0x503: Push("cot_eva")
0x504: @ GetSceneByName(Stack[-2], Stack[-1])
0x505: Pop(1)
0x506: Push("danko")
0x507: @ Trigger(Stack[-2], Stack[-1])
0x508: Pop(1)
0x509: PushEmpty(string, bool)
0x50a: Stack[-2] = "cot_eva@door1"
