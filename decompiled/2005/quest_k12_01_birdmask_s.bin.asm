...
0x2ff: @ StopWorld()
0x300: Pop(0)
0x301: @ CameraTransit(Stack[-3], Stack[-5])
0x302: Pop(0)
0x303: Push(CvectorIndex(Stack[-4], 0))
0x304: Push(CvectorIndex(Stack[-5], 2))
0x305: @ Rotate(Stack[-2], Stack[-1])
0x306: Pop(2)
...
0x311: Push("head")
0x312: @ LookAsyncCamera(Stack[-1])
0x313: Pop(1)
0x314: @ CameraWaitForPlayFinish()
0x315: Pop(0)
0x316: @ ResumeWorld()
0x317: Pop(0)
0x318: Stack[-21] = (bool) 1
0x319: Return(); Pop(18)

0x31a: PushEmpty(bool, bool)
0x31b: @ CameraSwitchToNormal()
0x31c: Pop(0)
...
0x32b: PushEmpty(bool, float, float, bool, float, float)
0x32c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x32d: Pop(0)
0x32e: Push(Stack[-3])
0x32f: IF (Stack[-1] == 0) GOTO 0x336; Pop(1)

0x330: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x331: Pop(0)
0x332: Push((bool) 0)
0x333: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x334: Pop(1)
0x335: GOTO 0x33a

0x336: Push("Can't find lsh animation : ")
0x337: Pop(1); Push(Stack[-1] + Stack[-8]);
0x338: @ Trace(Stack[-1])
0x339: Pop(1)
0x33a: Return(); Pop(6)

0x33b: PushEmpty(bool, float, float, bool, float, float)
0x33c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x33d: Pop(0)
0x33e: Push(Stack[-3])
0x33f: IF (Stack[-1] == 0) GOTO 0x345; Pop(1)

0x340: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x341: Pop(0)
0x342: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x343: Pop(0)
0x344: GOTO 0x349

0x345: Push("Can't find lsh animation : ")
0x346: Pop(1); Push(Stack[-1] + Stack[-9]);
0x347: @ Trace(Stack[-1])
0x348: Pop(1)
0x349: Return(); Pop(6)

0x34a: PushEmpty(float, cvector, float, cvector)
0x34b: @@ GetEyesHeight(Stack[-2])
0x34c: Pop(0)
0x34d: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x34e: Push(CvectorIndex(Stack[-1], 1))
0x34f: Stack[-1] = Stack[-3]
0x350: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x351: Push("head")
0x352: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x353: Pop(1)
0x354: Return(); Pop(4)
...
0x35c: PushEmpty(float, float)
0x35d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x35e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x35f: Push((float)0.0)
0x360: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x361: IF (Stack[-1] == 0) GOTO 0x364; Pop(1)

0x362: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x363: Return(); Pop(2)

0x364: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x365: Return(); Pop(2)

0x366: PushEmpty(int, int)
0x367: @ GetVariable(Stack[-3], Stack[-1])
0x368: Pop(0)
...
0x36f: IF (Stack[-1] == 0) GOTO 0x377; Pop(1)

0x370: Push("Door ")
0x371: Pop(1); Push(Stack[-1] + Stack[-5]);
0x372: Push(" not found")
...
0x377: Push("locked")
0x378: @@ SetProperty(Stack[-1], Stack[-4])
0x379: Pop(1)
0x37a: Return(); Pop(2)

0x37b: Stack[-1] = 0
0x37c: PushEmpty(object, object)
0x37d: @ FindActor(Stack[-1], Stack[-4])
0x37e: Pop(0)
0x37f: Pop(0); Push((bool) Stack[-1] == 0)
0x380: IF (Stack[-1] == 0) GOTO 0x383; Pop(1)

0x381: Stack[-5] = (bool) 0
0x382: Return(); Pop(2)

0x383: @ Trigger(Stack[-1], Stack[-3])
0x384: Pop(0)
0x385: Stack[-5] = (bool) 1
0x386: Return(); Pop(2)
...
0x3a8: Stack[-1] = (int) 515571
0x3a9: Return(); Pop(0)

0x3aa: Stack[-1] = (int) 504029
0x3ab: Return(); Pop(0)

0x3ac: Stack[-1] = "ui/NPC_bmask.png"
0x3ad: Return(); Pop(0)

0x3ae: Stack[-1] = "ui/NPC_bmask_b.png"
0x3af: Return(); Pop(0)
...
0x3b4: Stack[-2] = "quest_k12_01"
0x3b5: Stack[-1] = "init_sobor"
0x3b6: Call2 0x37c
...
0x3bf: PushEmpty()
0x3c0: PushEmpty(string, bool)
0x3c1: Stack[-2] = "sobor@door1"
...
0x428: PushEmpty(int, int)
0x429: Push("vol_")
0x42a: Pop(1); Push(Stack[-1] + Stack[-4]);
0x42b: @ GetVariable(Stack[-1], Stack[-2])
0x42c: Pop(1)
0x42d: Push((int) 4)
0x42e: Pop(1); Push(Stack[-2] & Stack[-1]);
0x42f: Push((int) 0)
0x430: Stack[-6] = Stack[-2] != Stack[-1]; Pop(2);
0x431: Return(); Pop(2)

0x432: PushEmpty(int, int)
0x433: Push("vol_")
0x434: Pop(1); Push(Stack[-1] + Stack[-4]);
0x435: @ GetVariable(Stack[-1], Stack[-2])
0x436: Pop(1)
0x437: Push((int) 16)
0x438: Pop(1); Push(Stack[-2] & Stack[-1]);
0x439: Push((int) 0)
0x43a: Stack[-6] = Stack[-2] != Stack[-1]; Pop(2);
0x43b: Return(); Pop(2)

0x43c: PushEmpty(object, int, int, int, object, int, int, int)
0x43d: @ CreateIntVector(Stack[-4])
0x43e: Pop(0)
0x43f: PushEmpty(object, bool, int)
0x440: Stack[-3] = Stack[-7]
...
0x446: Pop(0)
0x447: Stack[-2] = (int) 0
0x448: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x449: IF (Stack[-1] == 0) GOTO 0x45f; Pop(1)

0x44a: @@ get(Stack[-1], Stack[-2])
0x44b: Pop(0)
0x44c: PushEmpty(bool)
0x44d: Stack[-1] = (bool) 1
0x44e: PushEmpty(bool, int)
...
0x45f: Stack[-9] = (bool) 1
0x460: Return(); Pop(8)

0x461: Stack[-4] = 0
0x462: PushEmpty(int, int)
0x463: Push("game_final")
0x464: @ GetVariable(Stack[-1], Stack[-2])
0x465: Pop(1)
