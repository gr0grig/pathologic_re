...
Label_271:
	...
	var_162_int = 539228; // 0x11c PushI
	...
	var_171_int = 539229; // 0x126 PushI
	var_172_int = 45272; // 0x127 PushI
	var_173_int = 41172; // 0x128 PushI
	AddReply(var_171_int, var_172_int, var_173_int); // 0x129 TObjFunc
	
Label_299:
	var_174_int = 539242; // 0x12b PushI
	var_175_int = -1; // 0x12c PushI
	var_176_int = 41185; // 0x12d PushI
...
Label_305:
	...
	func_947(var_178_object); // 0x133 NEW_2
	...
	var_185_int = 541628; // 0x13b PushI
	SetMessage(var_185_int); // 0x13c TObjFunc
	ClearReplies(); // 0x13e TObjFunc
	var_186_int = 541629; // 0x140 PushI
	var_187_int = 43802; // 0x141 PushI
	var_188_int = 43801; // 0x142 PushI
	AddReply(var_186_int, var_187_int, var_188_int); // 0x143 TObjFunc
	var_189_int = 541633; // 0x145 PushI
	var_190_int = -1; // 0x146 PushI
	var_191_int = 43805; // 0x147 PushI
...
Label_331:
	...
	func_947(var_195_object); // 0x151 NEW_2
...
Label_346:
	...
	func_959(var_199_object); // 0x15d NEW_2
...
Label_353:
	...
	var_209_int = 539243; // 0x16b PushI
	SetMessage(var_209_int); // 0x16c TObjFunc
	ClearReplies(); // 0x16e TObjFunc
	var_210_int = 539244; // 0x170 PushI
	var_211_int = -1; // 0x171 PushI
	var_212_int = 41187; // 0x172 PushI
...
Label_412:
	...
	var_231_int = 542846; // 0x1a3 PushI
	SetMessage(var_231_int); // 0x1a4 TObjFunc
	ClearReplies(); // 0x1a6 TObjFunc
	var_232_int = 542847; // 0x1a8 PushI
	var_233_int = 45275; // 0x1a9 PushI
	var_234_int = 45273; // 0x1aa PushI
	AddReply(var_232_int, var_233_int, var_234_int); // 0x1ab TObjFunc
	var_235_int = 542848; // 0x1ad PushI
	var_236_int = -1; // 0x1ae PushI
	var_237_int = 45274; // 0x1af PushI
	AddReply(var_235_int, var_236_int, var_237_int); // 0x1b0 TObjFunc
	return 0; // 0x1b2 Return
	
Label_435:
	var_238_int = 45275; // 0x1b3 PushI
	var_239_bool = var_10_bool == var_238_int; // 0x1b4 Eq
	if(var_239_bool == 0) goto Label_463; // 0x1b5 JumpB
	var_240_string = ""; // 0x1b6 PushV
	var_240_string = "Neutral"; // 0x1b7 MovS
	func_227(var_11_object, var_240_string); // 0x1b8 NEW_2
	var_241_int = 542849; // 0x1ba PushI
	SetMessage(var_241_int); // 0x1bb TObjFunc
	ClearReplies(); // 0x1bd TObjFunc
	var_242_int = 542850; // 0x1bf PushI
	var_243_int = -1; // 0x1c0 PushI
	var_244_int = 45276; // 0x1c1 PushI
	AddReply(var_242_int, var_243_int, var_244_int); // 0x1c2 TObjFunc
	var_245_int = 542851; // 0x1c4 PushI
	var_246_int = 45278; // 0x1c5 PushI
	var_247_int = 45277; // 0x1c6 PushI
	AddReply(var_245_int, var_246_int, var_247_int); // 0x1c7 TObjFunc
	var_248_int = 542855; // 0x1c9 PushI
	var_249_int = 45282; // 0x1ca PushI
	var_250_int = 45281; // 0x1cb PushI
	AddReply(var_248_int, var_249_int, var_250_int); // 0x1cc TObjFunc
	return 0; // 0x1ce Return
	
Label_463:
	var_251_int = 45282; // 0x1cf PushI
	var_252_bool = var_10_bool == var_251_int; // 0x1d0 Eq
	if(var_252_bool == 0) goto Label_481; // 0x1d1 JumpB
	var_253_string = ""; // 0x1d2 PushV
	var_253_string = "Neutral"; // 0x1d3 MovS
	func_227(var_11_object, var_253_string); // 0x1d4 NEW_2
	var_254_int = 542856; // 0x1d6 PushI
	SetMessage(var_254_int); // 0x1d7 TObjFunc
	ClearReplies(); // 0x1d9 TObjFunc
	var_255_int = 542857; // 0x1db PushI
	var_256_int = -1; // 0x1dc PushI
	var_257_int = 45283; // 0x1dd PushI
	AddReply(var_255_int, var_256_int, var_257_int); // 0x1de TObjFunc
	return 0; // 0x1e0 Return
	
Label_481:
	var_258_int = 45278; // 0x1e1 PushI
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object)
{
	...
	var_13_string = "k12q01TheaterIsVisited"; // 0x212 PushS
...
func_918()
{
	var_288_string = "ook12BirdmaskT1"; // 0x397 PushS
...
func_924()
{
	...
	var_25_string = "quest_k12_01"; // 0x39e MovS
...
func_931()
{
	var_18_string = "ook12BirdmaskT2"; // 0x3a4 PushS
...
func_947(var_259_bool)
{
	var_261_int = 0; var_262_string = ""; // 0x3b4 PushV
	var_262_string = "k12q01ChildsAreVisited"; // 0x3b5 MovS
	func_867(var_261_int, var_262_string); // 0x3b6 NEW_2
	var_263_int = 0; // 0x3b8 PushI
	var_264_bool = var_261_int != var_263_int; // 0x3b9 Neq
	if(var_264_bool == 0) goto Label_957; // 0x3ba JumpB
	var_259_bool = 1; // 0x3bb MovB
	return 0; // 0x3bc Return
	
Label_957:
	var_259_bool = 0; // 0x3bd MovB
...
func_959(var_280_bool)
{
	var_282_int = 0; var_283_string = ""; // 0x3c0 PushV
	var_283_string = "ook12BirdmaskT1"; // 0x3c1 MovS
	func_867(var_282_int, var_283_string); // 0x3c2 NEW_2
	var_284_int = 0; // 0x3c4 PushI
	var_285_bool = var_282_int == var_284_int; // 0x3c5 Eq
	if(var_285_bool == 0) goto Label_969; // 0x3c6 JumpB
	var_280_bool = 1; // 0x3c7 MovB
	return 0; // 0x3c8 Return
	
Label_969:
	var_280_bool = 0; // 0x3c9 MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_89_object, var_90_object)
{
	...
	var_235_int = 539229; // 0x64 PushI
	var_236_int = 45272; // 0x65 PushI
	var_237_int = 41172; // 0x66 PushI
	AddReply(var_235_int, var_236_int, var_237_int); // 0x67 TObjFunc
	
Label_105:
	var_238_int = 539242; // 0x69 PushI
	var_239_int = -1; // 0x6a PushI
	var_240_int = 41185; // 0x6b PushI
...
Label_111:
	...
	func_947(var_260_object); // 0x71 NEW_2
	...
	var_267_int = 541628; // 0x79 PushI
	SetMessage(var_267_int); // 0x7a TObjFunc
	ClearReplies(); // 0x7c TObjFunc
	var_268_int = 541629; // 0x7e PushI
	var_269_int = 43802; // 0x7f PushI
	var_270_int = 43801; // 0x80 PushI
	AddReply(var_268_int, var_269_int, var_270_int); // 0x81 TObjFunc
	var_271_int = 541633; // 0x83 PushI
	var_272_int = -1; // 0x84 PushI
	var_273_int = 43805; // 0x85 PushI
...
Label_137:
	...
	func_947(var_277_object); // 0x8f NEW_2
...
Label_152:
	...
	func_959(var_281_object); // 0x9b NEW_2
...
Label_159:
	...
	var_291_int = 539243; // 0xa9 PushI
	SetMessage(var_291_int); // 0xaa TObjFunc
	ClearReplies(); // 0xac TObjFunc
	var_292_int = 539244; // 0xae PushI
	var_293_int = -1; // 0xaf PushI
	var_294_int = 41187; // 0xb0 PushI
...
Label_180:
	...
	var_296_int = 539245; // 0xb8 PushI
	SetMessage(var_296_int); // 0xb9 TObjFunc
	ClearReplies(); // 0xbb TObjFunc
	var_297_int = 539246; // 0xbd PushI
	var_298_int = -1; // 0xbe PushI
	var_299_int = 41189; // 0xbf PushI
...
func_971(var_227_bool)
{
	...
	var_230_string = "ook12BirdmaskT2"; // 0x3cd MovS
