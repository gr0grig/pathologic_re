...
0x2d8: @ StopWorld()
0x2d9: Pop(0)
0x2da: @ CameraTransit(Stack[-3], Stack[-5])
0x2db: Pop(0)
...
0x300: Push("head")
0x301: @ UnlookAsync(Stack[-1])
0x302: Pop(1)
0x303: Return(); Pop(2)

0x304: PushEmpty(int, int, int, int)
0x305: Push("voice_common")
0x306: @ GetVariable(Stack[-1], Stack[-3])
0x307: Pop(1)
0x308: Push(Stack[-2])
0x309: IF (Stack[-1] == 0) GOTO 0x32a; Pop(1)

0x30a: PushEmpty(bool, object)
0x30b: Stack[-1] = Stack[-7]
0x30c: Call2 0x33e
...
0x31e: Push((int) 1)
0x31f: Pop(1); Push(Stack[-4] + Stack[-1]);
0x320: Push((int) 3)
...
0x33b: Pop(2)
0x33c: Stack[-6] = (bool) 1
0x33d: Return(); Pop(4)

0x33e: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x33f: Stack[-5] = "c"
0x340: Stack[-4] = (int) 0
0x341: Push((int) 1)
...
0x363: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x364: Push("d")
0x365: PushEmpty(int)
0x366: Call2 0x3e9

0x367: Pop(0)
0x368: Pop(2); Push(Stack[-2] + Stack[-1]);
0x369: Push("m")
0x36a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x36b: Stack[-4] = (int) 0
0x36c: Push((int) 1)
...
0x371: @@ HasProperty(Stack[-1], Stack[-4])
0x372: Pop(1)
...
0x386: @@ GetProperty(Stack[-1], Stack[-2])
0x387: Pop(1)
0x388: PushEmpty(bool, string)
0x389: Stack[-1] = Stack[-3]
0x38a: Call2 0x3ad

0x38b: Stack[-14] = Stack[-2]
0x38c: Pop(2)
0x38d: Return(); Pop(10)

0x38e: PushEmpty(bool, float, float, bool, float, float)
0x38f: @ lshHasAnimation(Stack[-3], Stack[-7])
0x390: Pop(0)
0x391: Push(Stack[-3])
0x392: IF (Stack[-1] == 0) GOTO 0x399; Pop(1)

0x393: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x394: Pop(0)
0x395: Push((bool) 0)
0x396: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x397: Pop(1)
0x398: GOTO 0x39d

0x399: Push("Can't find lsh animation : ")
0x39a: Pop(1); Push(Stack[-1] + Stack[-8]);
0x39b: @ Trace(Stack[-1])
0x39c: Pop(1)
0x39d: Return(); Pop(6)

0x39e: PushEmpty(bool, float, float, bool, float, float)
0x39f: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3a0: Pop(0)
0x3a1: Push(Stack[-3])
0x3a2: IF (Stack[-1] == 0) GOTO 0x3a8; Pop(1)

0x3a3: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3a4: Pop(0)
0x3a5: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3a6: Pop(0)
0x3a7: GOTO 0x3ac

0x3a8: Push("Can't find lsh animation : ")
0x3a9: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3aa: @ Trace(Stack[-1])
0x3ab: Pop(1)
0x3ac: Return(); Pop(6)

0x3ad: PushEmpty(bool, bool)
0x3ae: PushEmpty(bool)
0x3af: Call2 0x4bf

0x3b0: Pop(0)
0x3b1: IF (Stack[-1] == 0) GOTO 0x3ba; Pop(1)

0x3b2: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3b3: Pop(0)
0x3b4: Push(Stack[-1])
0x3b5: IF (Stack[-1] == 0) GOTO 0x3ba; Pop(1)

0x3b6: @ lshPlaySpeech(Stack[-3])
0x3b7: Pop(0)
0x3b8: Stack[-4] = (bool) 1
0x3b9: Return(); Pop(2)
...
0x3c8: Stack[-1] = 0
0x3c9: PushEmpty(float, float)
0x3ca: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3cb: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3cc: Push((float)0.0)
0x3cd: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3ce: IF (Stack[-1] == 0) GOTO 0x3d1; Pop(1)

0x3cf: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3d0: Return(); Pop(2)

0x3d1: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3d2: Return(); Pop(2)

0x3d3: PushEmpty(int, int)
0x3d4: @ GetVariable(Stack[-3], Stack[-1])
0x3d5: Pop(0)
0x3d6: Stack[-4] = Stack[-1]
0x3d7: Return(); Pop(2)

0x3d8: PushEmpty(object, object)
0x3d9: @ FindActor(Stack[-1], Stack[-4])
0x3da: Pop(0)
0x3db: Pop(0); Push((bool) Stack[-1] == 0)
0x3dc: IF (Stack[-1] == 0) GOTO 0x3e4; Pop(1)

0x3dd: Push("Door ")
0x3de: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3df: Push(" not found")
...
0x3e4: Push("locked")
0x3e5: @@ SetProperty(Stack[-1], Stack[-4])
0x3e6: Pop(1)
0x3e7: Return(); Pop(2)
...
0x404: PushEmpty()
0x405: PushEmpty(string, bool)
0x406: Stack[-2] = "isobor@door1"
...
0x433: Stack[-1] = "k12q01BurahInSobor"
0x434: Call2 0x3d3
...
0x43f: Stack[-1] = "k12q01DankoInSobor"
0x440: Call2 0x3d3
...
0x457: Push((int) 734)
0x458: Push((int) 1)
0x459: Push((int) 539364)
0x45a: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x45b: Pop(3)
0x45c: PushEmpty(bool, object, int)
0x45d: Stack[-2] = Stack[-4]
0x45e: Stack[-1] = (int) 729
0x45f: Call2 0x48a
...
0x471: Push((int) 733)
0x472: Push((int) 1)
0x473: Push((int) 539363)
0x474: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x475: Pop(3)
0x476: PushEmpty(bool, object, int)
0x477: Stack[-2] = Stack[-4]
0x478: Stack[-1] = (int) 729
0x479: Call2 0x48a
...
0x47e: @ GetDiaryRoot(Stack[-1])
0x47f: Pop(0)
0x480: Pop(0); Push((bool) Stack[-1] == 0)
0x481: IF (Stack[-1] == 0) GOTO 0x487; Pop(1)

0x482: Push("Can't retrieve diary root")
0x483: @ Trace(Stack[-1])
0x484: Pop(1)
0x485: Stack[-3] = (bool) 0
0x486: Return(); Pop(2)

0x487: Stack[-3] = Stack[-1]
0x488: Return(); Pop(2)

0x489: Stack[-1] = 0
0x48a: PushEmpty(object, object, int, object, object, int)
0x48b: PushEmpty(object)
0x48c: Call2 0x47d

0x48d: Stack[-4] = Stack[-1]
0x48e: Pop(1)
0x48f: @@ Find(Stack[-7], Stack[-2])
0x490: Pop(0)
0x491: Pop(0); Push((bool) Stack[-2] == 0)
0x492: IF (Stack[-1] == 0) GOTO 0x499; Pop(1)

0x493: Push("Can't find diary parent with id: ")
0x494: Pop(1); Push(Stack[-1] + Stack[-8]);
0x495: @ Trace(Stack[-1])
0x496: Pop(1)
0x497: Stack[-9] = (bool) 0
0x498: Return(); Pop(6)

0x499: @@ AddChild(Stack[-8])
0x49a: Pop(0)
0x49b: Push((int) 7)
0x49c: @ SendWorldWndMessage(Stack[-1])
0x49d: Pop(1)
0x49e: @@ GetCategory(Stack[-1])
0x49f: Pop(0)
0x4a0: @ SetDiarySection(Stack[-1])
0x4a1: Pop(0)
0x4a2: Stack[-9] = (bool) 0
0x4a3: Return(); Pop(6)
...
0x4b7: Stack[-1] = (int) 515532
0x4b8: Return(); Pop(0)

0x4b9: Stack[-1] = (int) 514840
0x4ba: Return(); Pop(0)

0x4bb: Stack[-1] = "ui/NPC_Block.png"
0x4bc: Return(); Pop(0)

0x4bd: Stack[-1] = "ui/NPC_Block_b.png"
0x4be: Return(); Pop(0)
