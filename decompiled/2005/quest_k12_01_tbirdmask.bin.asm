...
0x52a: @ StopWorld()
0x52b: Pop(0)
0x52c: @ CameraTransit(Stack[-3], Stack[-5])
0x52d: Pop(0)
0x52e: Push(CvectorIndex(Stack[-4], 0))
0x52f: Push(CvectorIndex(Stack[-5], 2))
0x530: @ Rotate(Stack[-2], Stack[-1])
0x531: Pop(2)
...
0x537: Push("head")
0x538: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x539: Pop(1)
0x53a: Push(Stack[-1])
0x53b: IF (Stack[-1] == 0) GOTO 0x53f; Pop(1)

0x53c: Push("head")
0x53d: @ LookAsyncCamera(Stack[-1])
0x53e: Pop(1)
0x53f: @ CameraWaitForPlayFinish()
0x540: Pop(0)
0x541: @ ResumeWorld()
0x542: Pop(0)
0x543: Stack[-21] = (bool) 1
0x544: Return(); Pop(18)

0x545: PushEmpty(bool, bool)
0x546: @ CameraSwitchToNormal()
0x547: Pop(0)
...
0x54d: Push("head")
0x54e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x54f: Pop(1)
0x550: Push(Stack[-1])
0x551: IF (Stack[-1] == 0) GOTO 0x555; Pop(1)

0x552: Push("head")
0x553: @ UnlookAsync(Stack[-1])
0x554: Pop(1)
0x555: Return(); Pop(2)

0x556: PushEmpty(bool, float, float, bool, float, float)
0x557: @ lshHasAnimation(Stack[-3], Stack[-7])
0x558: Pop(0)
0x559: Push(Stack[-3])
0x55a: IF (Stack[-1] == 0) GOTO 0x561; Pop(1)

0x55b: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x55c: Pop(0)
0x55d: Push((bool) 0)
0x55e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x55f: Pop(1)
0x560: GOTO 0x565

0x561: Push("Can't find lsh animation : ")
0x562: Pop(1); Push(Stack[-1] + Stack[-8]);
0x563: @ Trace(Stack[-1])
0x564: Pop(1)
0x565: Return(); Pop(6)

0x566: PushEmpty(bool, float, float, bool, float, float)
0x567: @ lshHasAnimation(Stack[-3], Stack[-8])
0x568: Pop(0)
0x569: Push(Stack[-3])
0x56a: IF (Stack[-1] == 0) GOTO 0x570; Pop(1)

0x56b: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x56c: Pop(0)
0x56d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x56e: Pop(0)
0x56f: GOTO 0x574

0x570: Push("Can't find lsh animation : ")
0x571: Pop(1); Push(Stack[-1] + Stack[-9]);
0x572: @ Trace(Stack[-1])
0x573: Pop(1)
0x574: Return(); Pop(6)

0x575: PushEmpty(float, cvector, float, cvector)
0x576: @@ GetEyesHeight(Stack[-2])
0x577: Pop(0)
0x578: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x579: Push(CvectorIndex(Stack[-1], 1))
0x57a: Stack[-1] = Stack[-3]
0x57b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x57c: Push("head")
0x57d: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x57e: Pop(1)
0x57f: Return(); Pop(4)
...
0x58e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x58f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x590: Push((float)0.0)
0x591: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x592: IF (Stack[-1] == 0) GOTO 0x595; Pop(1)

0x593: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x594: Return(); Pop(2)

0x595: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x596: Return(); Pop(2)

0x597: PushEmpty(int, int)
0x598: @ GetVariable(Stack[-3], Stack[-1])
0x599: Pop(0)
...
0x5a0: IF (Stack[-1] == 0) GOTO 0x5a8; Pop(1)

0x5a1: Push("Door ")
0x5a2: Pop(1); Push(Stack[-1] + Stack[-5]);
0x5a3: Push(" not found")
0x5a4: Pop(2); Push(Stack[-2] + Stack[-1]);
0x5a5: @ Trace(Stack[-1])
0x5a6: Pop(1)
0x5a7: GOTO 0x5ab

0x5a8: Push("locked")
0x5a9: @@ SetProperty(Stack[-1], Stack[-4])
0x5aa: Pop(1)
0x5ab: Return(); Pop(2)

0x5ac: Stack[-1] = 0
0x5ad: PushEmpty(string, string)
0x5ae: Stack[-1] = "idle"
0x5af: Push(Stack[-3])
0x5b0: IF (Stack[-1] == 0) GOTO 0x5b2; Pop(1)

0x5b1: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x5b2: Stack[-4] = Stack[-1]
0x5b3: Return(); Pop(2)

0x5b4: PushEmpty(int, bool, int, bool)
0x5b5: Stack[-2] = (int) 0
0x5b6: Push("all")
0x5b7: PushEmpty(string, int)
0x5b8: Stack[-1] = Stack[-5]
0x5b9: Call2 0x5ad

0x5ba: Pop(1)
0x5bb: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5bc: Pop(2)
0x5bd: Pop(0); Push((bool) Stack[-1] == 0)
0x5be: IF (Stack[-1] == 0) GOTO 0x5c0; Pop(1)

0x5bf: GOTO 0x5c3

0x5c0: Push((int) 1)
0x5c1: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x5c2: GOTO 0x5b6

0x5c3: Stack[-5] = Stack[-2]
0x5c4: Return(); Pop(4)

0x5c5: PushEmpty()
0x5c6: PushEmpty(string, bool)
0x5c7: Stack[-2] = "itheater@door1"
...
0x609: Push("branch")
0x60a: @ GetVariable(Stack[-1], Stack[-2])
0x60b: Pop(1)
0x60c: Push((int) 0)
...
0x619: Stack[-1] = (int) 515571
0x61a: Return(); Pop(0)

0x61b: Stack[-1] = (int) 504029
0x61c: Return(); Pop(0)

0x61d: Stack[-1] = "ui/NPC_bmask.png"
0x61e: Return(); Pop(0)

0x61f: Stack[-1] = "ui/NPC_bmask_b.png"
0x620: Return(); Pop(0)
