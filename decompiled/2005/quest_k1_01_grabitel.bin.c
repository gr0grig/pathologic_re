...
task_1_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2196(var_15_object); // 0x9a NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2196(var_15_object); // 0xe5 NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2196(var_15_object); // 0x38e NEW_2
...
task_3_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2056(var_13_object); // 0x3d3 NEW_2
...
task_3_event_41(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2127(var_15_bool, var_16_object); // 0x4ba NEW_2
	...
	func_2134(var_51_object); // 0x4c2 NEW_2
...
task_6_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2146(var_14_object); // 0x54f NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x82b PushV
	var_14_object = var_10_object; // 0x82c Mov
	var_15_int = var_11_int; // 0x82d Mov
	var_16_float = var_12_float; // 0x82e Mov
	func_1785(var_14_object, var_15_int, var_16_float); // 0x82f NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x833 PushV
	var_16_object = var_10_object; // 0x834 Mov
	var_17_int = var_11_int; // 0x835 Mov
	var_18_float = var_12_float; // 0x836 Mov
	var_19_cvector = var_14_cvector; // 0x837 Mov
	var_20_cvector = var_15_cvector; // 0x838 Mov
	func_1853(var_18_float, var_19_cvector, var_20_cvector); // 0x839 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x83c PushV
	var_14_string = "health"; // 0x83d PushS
	var_15_bool = var_11_string == var_14_string; // 0x83e Eq
	if(var_15_bool == 0) goto Label_2120; // 0x83f JumpB
	var_16_string = "health"; // 0x840 PushS
	GetProperty(var_16_string, var_13_float); // 0x841 Func
	var_17_int = 0; // 0x843 PushI
	var_18_bool = var_13_float <= var_17_int; // 0x844 LE
	if(var_18_bool == 0) goto Label_2120; // 0x845 JumpB
	SignalDeath(var_10_object); // 0x846 Func
...
{
	var_11_object = Obj(); // 0x84a PushV
	var_11_object = var_10_object; // 0x84b Mov
	func_2082(var_11_object); // 0x84c NEW_2
...
func_0(var_61_bool, var_62_object, var_84_bool, var_685_object)
{
...
Label_29:
	var_683_bool = 0; var_684_object = Obj(); // 0x1d PushV
	var_684_object = var_62_object; // 0x1e Mov
	TaskCall(2); // 0x1f TaskCall
	func_163(var_683_bool, var_684_object); // 0x20 NEW_2
	TaskReturn(); // 0x21 TaskReturn
	var_61_bool = var_685_object; // 0x22 Mov
...
func_2056(var_99_object)
{
	var_100_bool = 0; var_101_bool = 0; // 0x808 PushV
	IsPlayerActor(var_99_object, var_101_bool); // 0x809 Func
	var_102_bool = var_101_bool; // 0x80b Push
	if(var_102_bool == 0) goto Label_2064; // 0x80c JumpB
	var_103_string = "attack"; // 0x80d PushS
	PlayGlobalMusic(var_103_string); // 0x80e Func
...
func_2065()
{
	var_121_object = Obj(); var_122_object = Obj(); // 0x811 PushV
	GetScene(var_122_object); // 0x812 Func
	var_123_string = "battle"; // 0x814 PushS
	var_124_object = Obj(); // 0x815 PushV
	func_1935(var_124_object); // 0x816 NEW_2
	BroadcastMessage(var_123_string, var_124_object, var_122_object); // 0x818 Func
...
Label_1572:
	var_597_string = "armor"; // 0x624 PushS
	GetProperty(var_597_string, var_550_int); // 0x625 ObjFunc
}


func_2076(var_615_bool)
{
	var_616_bool = 0; var_617_bool = 0; // 0x81c PushV
	var_618_string = "god_mode"; // 0x81d PushS
	GetVariable(var_618_string, var_617_bool); // 0x81e Func
	var_615_bool = var_617_bool; // 0x820 Mov
...
Label_579:
	...
	var_622_string = "all"; // 0x248 PushS
	var_623_string = "attack_middle"; // 0x249 PushS
	var_624_int = var_623_string + var_496_int; // 0x24a Add
	HasAnimation(var_497_bool, var_622_string, var_624_int); // 0x24b Func
	var_625_bool = var_497_bool; // 0x24d Push
	if(var_625_bool == 0) goto Label_660; // 0x24e JumpB
	func_2065(); // 0x250 NEW_2
	var_626_string = "all"; // 0x252 PushS
	var_627_string = "attack_middle"; // 0x253 PushS
	var_628_int = var_627_string + var_496_int; // 0x254 Add
	PlayAnimation(var_626_string, var_628_int); // 0x255 Func
	WaitForAnimEnd(); // 0x257 Func
	func_884(var_499_string); // 0x25a NEW_2
	var_629_bool = 0; var_630_object = Obj(); // 0x25c PushV
	var_630_object = var_0_bool; // 0x25d MovT
	func_1698(var_629_bool, var_630_object); // 0x25e NEW_2
	var_631_bool = var_629_bool == 0; // 0x260 Not
	if(var_631_bool == 0) goto Label_614; // 0x261 JumpB
	StopAsync(); // 0x262 Func
	var_490_bool = 0; // 0x264 MovB
	return 8; // 0x265 Return
	
Label_614:
	var_632_float = 0; var_633_int = 0; // 0x266 PushV
	var_632_float = var_491_float; // 0x267 Mov
	var_633_int = var_496_int; // 0x268 Mov
	func_504(var_499_string, var_632_float, var_633_int); // 0x269 NEW_2
	var_498_int = 1; // 0x26b MovI
	
Label_620:
	var_634_string = "attack_middle"; // 0x26c PushS
	var_635_int = var_634_string + var_496_int; // 0x26d Add
	var_636_string = "_"; // 0x26e PushS
	var_637_int = var_635_int + var_636_string; // 0x26f Add
	var_499_string = var_637_int + var_498_int; // 0x270 Add2
	var_638_string = "all"; // 0x271 PushS
	HasAnimation(var_497_bool, var_638_string, var_499_string); // 0x272 Func
	var_639_bool = var_497_bool == 0; // 0x274 Not
	if(var_639_bool == 0) goto Label_631; // 0x275 JumpB
	goto Label_660; // 0x276 Jump
	
Label_660:
	var_640_bool = 0; // 0x294 PushB
	SetAttackState(var_640_bool); // 0x295 Func
	var_641_string = "all"; // 0x297 PushS
	var_642_string = "attack_end"; // 0x298 PushS
	var_643_int = var_642_string + var_496_int; // 0x299 Add
	PlayAnimation(var_641_string, var_643_int); // 0x29a Func
	var_644_bool = 0; // 0x29c PushV
	func_894(var_644_bool); // 0x29d NEW_2
	if(var_644_bool == 0) goto Label_678; // 0x29f JumpB
	var_645_bool = 0; var_646_float = 0; // 0x2a0 PushV
	var_646_float = 0.45; // 0x2a1 MovF
	func_682(var_645_bool, var_646_float); // 0x2a2 NEW_2
...
Label_631:
	func_2065(); // 0x278 NEW_2
	var_654_string = "all"; // 0x27a PushS
	PlayAnimation(var_654_string, var_499_string); // 0x27b Func
	WaitForAnimEnd(); // 0x27d Func
	func_884(var_499_string); // 0x280 NEW_2
	var_655_bool = 0; var_656_object = Obj(); // 0x282 PushV
	var_656_object = var_0_bool; // 0x283 MovT
	func_1698(var_655_bool, var_656_object); // 0x284 NEW_2
	var_657_bool = var_655_bool == 0; // 0x286 Not
	if(var_657_bool == 0) goto Label_652; // 0x287 JumpB
	StopAsync(); // 0x288 Func
	var_490_bool = 0; // 0x28a MovB
	return 8; // 0x28b Return
	
Label_652:
	var_658_float = 0; var_659_int = 0; // 0x28c PushV
	var_658_float = var_491_float; // 0x28d Mov
	var_659_int = var_496_int; // 0x28e Mov
	func_504(var_499_string, var_658_float, var_659_int); // 0x28f NEW_2
	var_660_int = 1; // 0x291 PushI
	var_498_int = var_498_int + var_660_int; // 0x292 Add2
	goto Label_620; // 0x293 Jump
}


func_2082(var_11_object)
{
	var_12_object = Obj(); // 0x823 PushV
	var_12_object = var_11_object; // 0x824 Mov
	TaskCall(6); // 0x825 TaskCall
	func_1317(var_12_object); // 0x826 NEW_2
	TaskReturn(); // 0x827 TaskReturn
...
func_37(var_0_bool, var_82_bool, var_83_object, var_200_object)
{
	...
	func_2056(var_99_object); // 0x28 NEW_2
...
Label_76:
	...
	func_2159(var_142_cvector, var_143_cvector, var_144_cvector, var_145_float); // 0x70 NEW_2
...
func_2127(var_15_bool, var_16_object)
{
	var_17_bool = 0; var_18_object = Obj(); // 0x850 PushV
	var_18_object = var_16_object; // 0x851 Mov
	func_1698(var_17_bool, var_18_object); // 0x852 NEW_2
	var_15_bool = var_17_bool; // 0x853 Mov
	return 0; // 0x855 Return
}


func_2134(var_51_object)
{
	var_52_object = Obj(); // 0x857 PushV
	var_52_object = var_51_object; // 0x858 Mov
	func_2199(var_52_object); // 0x859 NEW_2
	return 0; // 0x85b Return
}


func_1626(var_604_bool, var_605_object)
{
	var_606_float = 0; var_607_float = 0; // 0x65a PushV
	var_608_bool = 0; var_609_object = Obj(); var_610_string = ""; // 0x65b PushV
	var_609_object = var_605_object; // 0x65c Mov
	var_610_string = "health"; // 0x65d MovS
	func_1519(var_608_bool, var_609_object, var_610_string); // 0x65e NEW_2
	var_611_bool = var_608_bool == 0; // 0x660 Not
	if(var_611_bool == 0) goto Label_1636; // 0x661 JumpB
	var_604_bool = 0; // 0x662 MovB
	return 2; // 0x663 Return
	
Label_1636:
	var_612_bool = 0; // 0x664 PushV
	var_612_bool = 0; // 0x665 MovB
	var_613_bool = 0; var_614_object = Obj(); // 0x666 PushV
	var_614_object = var_605_object; // 0x667 Mov
	func_1514(var_613_bool, var_614_object); // 0x668 NEW_2
	if(var_613_bool == 0) goto Label_1648; // 0x66a JumpB
	var_615_bool = 0; // 0x66b PushV
	func_2076(var_615_bool); // 0x66c NEW_2
	if(var_615_bool == 0) goto Label_1648; // 0x66e JumpB
	var_612_bool = 1; // 0x66f MovB
	
Label_1648:
	if(var_612_bool == 0) goto Label_1651; // 0x670 JumpB
	var_604_bool = 0; // 0x671 MovB
	return 2; // 0x672 Return
	
Label_1651:
	var_619_string = "health"; // 0x673 PushS
	GetProperty(var_619_string, var_607_float); // 0x674 ObjFunc
	var_620_float = 0.0; // 0x676 PushF
	var_604_bool = var_607_float <= var_620_float; // 0x677 LE2
...
{
	var_16_int = 0; var_17_int = 0; // 0x85c PushV
	var_18_string = "branch"; // 0x85d PushS
	GetVariable(var_18_string, var_17_int); // 0x85e Func
	var_15_int = var_17_int; // 0x860 Mov
...
func_2159(var_142_cvector, var_143_cvector, var_144_cvector, var_145_float)
{
	var_146_cvector = CVector(0,0,0); var_147_float = 0; var_148_float = 0; var_149_float = 0; var_150_float = 0; var_151_float = 0; var_152_cvector = CVector(0,0,0); var_153_float = 0; var_154_float = 0; var_155_float = 0; var_156_float = 0; var_157_float = 0; // 0x86f PushV
	var_152_cvector = var_144_cvector - var_143_cvector; // 0x870 Sub2
	var_153_float = 250000; // 0x871 MovI
	var_158_float = GetByIndex(var_152_cvector, 1); // 0x872 PushE
	var_159_int = 1000; // 0x873 PushI
	var_160_float = var_158_float * var_159_int; // 0x874 Mult
	var_161_float = var_145_float * var_145_float; // 0x875 Mult
	var_154_float = var_160_float - var_161_float; // 0x876 Sub2
	var_155_float = var_152_cvector | var_152_cvector; // 0x877 Or2
	var_162_float = 0; var_163_float = 0; var_164_float = 0; var_165_float = 0; // 0x878 PushV
	var_163_float = var_153_float; // 0x879 Mov
	var_164_float = var_154_float; // 0x87a Mov
	var_165_float = var_155_float; // 0x87b Mov
	func_1958(var_162_float, var_163_float, var_164_float, var_165_float); // 0x87c NEW_2
	var_156_float = var_162_float; // 0x87d Mov
	var_170_int = 0; // 0x87f PushI
	var_171_bool = var_156_float < var_170_int; // 0x880 LT
	if(var_171_bool == 0) goto Label_2180; // 0x881 JumpB
	var_157_float = 1; // 0x882 MovI
	goto Label_2188; // 0x883 Jump
	
Label_2188:
	var_172_cvector = CVector(0.0, 500.0, 0.0); // 0x88c PushVec
	var_173_float = var_172_cvector * var_157_float; // 0x88d Mult
	var_174_float = var_173_float * var_157_float; // 0x88e Mult
	var_175_int = var_152_cvector + var_174_float; // 0x88f Add
	var_142_cvector = var_175_int / var_175_int; // 0x890 Div2
	return 12; // 0x891 Return
	
Label_2180:
	var_176_float = 0; var_177_float = 0; var_178_float = 0; var_179_float = 0; var_180_float = 0; // 0x884 PushV
	var_177_float = var_153_float; // 0x885 Mov
	var_178_float = var_154_float; // 0x886 Mov
	var_179_float = var_155_float; // 0x887 Mov
	var_180_float = sqrt(var_156_float); // 0x888 Sqrt2
	func_1965(var_177_float, var_178_float, var_179_float, var_180_float); // 0x889 NEW_2
	var_157_float = sqrt(var_176_float); // 0x88b Sqrt2
}
...
func_2196(var_13_bool)
{
	var_13_bool = 0; // 0x895 MovB
	return 0; // 0x896 Return
}


func_2199(var_52_object)
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x897 PushV
	var_55_string = "b1q04_attack"; // 0x898 PushS
	var_56_int = 1; // 0x899 PushI
	SetVariable(var_55_string, var_56_int); // 0x89a Func
	GetScene(var_54_object); // 0x89c Func
	var_57_object = Obj(); // 0x89e PushV
	func_1935(var_57_object); // 0x89f NEW_2
	RemoveStationaryActor(var_57_object); // 0x8a1 ObjFunc
	var_60_object = Obj(); // 0x8a3 PushV
	var_60_object = var_52_object; // 0x8a4 Mov
	TaskCall(4); // 0x8a5 TaskCall
	func_1180(var_60_object); // 0x8a6 NEW_2
	TaskReturn(); // 0x8a7 TaskReturn
...
Label_1181:
	...
	var_691_int = 1; // 0x4a3 PushI
	Sleep(var_691_int); // 0x4a4 Func
...
func_163(var_198_bool, var_199_object)
{
	...
	var_677_bool = 0; // 0xad PushV
	var_677_bool = 0; // 0xae MovB
	var_678_bool = GlobalVars[0]; // 0xaf PushGE
	if(var_678_bool == 0) goto Label_180; // 0xb0 JumpB
	var_679_int = var_3_int; // 0xb1 PushT
	if(var_679_int == 0) goto Label_180; // 0xb2 JumpB
	var_677_bool = 1; // 0xb3 MovB
	
Label_180:
	if(var_677_bool == 0) goto Label_187; // 0xb4 JumpB
	var_680_string = "all"; // 0xb5 PushS
	var_681_string = "attack_off"; // 0xb6 PushS
	PlayAnimation(var_680_string, var_681_string); // 0xb7 Func
	WaitForAnimEnd(); // 0xb9 Func
	
Label_187:
	var_682_bool = GlobalVars[0]; // 0xbb PushGE
	var_198_bool = var_682_bool; // 0xbc Mov
...
func_682(var_645_bool, var_646_float)
{
	var_647_float = 0; var_648_bool = 0; var_649_float = 0; var_650_bool = 0; // 0x2aa PushV
	rand(var_649_float); // 0x2ab Func
	var_651_bool = var_649_float < var_646_float; // 0x2ad LT
	if(var_651_bool == 0) goto Label_702; // 0x2ae JumpB
	
Label_687:
	IsAnimationPlaying(var_650_bool); // 0x2af Func
	var_652_bool = var_650_bool == 0; // 0x2b1 Not
	if(var_652_bool == 0) goto Label_692; // 0x2b2 JumpB
...
Label_707:
	var_645_bool = 0; // 0x2c3 MovB
	return 4; // 0x2c4 Return
	
Label_692:
	var_653_bool = 0; // 0x2b4 PushV
	func_780(var_653_bool); // 0x2b5 NEW_2
	if(var_653_bool == 0) goto Label_698; // 0x2b7 JumpB
	var_645_bool = 1; // 0x2b8 MovB
...
Label_702:
	...
	func_884(var_650_bool); // 0x2c1 NEW_2
}
...
func_197(var_598_int)
{
	var_598_int = 1; // 0xc5 MovI
	return 0; // 0xc6 Return
}


func_199(var_599_object, var_600_float)
{
	var_601_bool = 0; // 0xc8 PushV
	var_601_bool = 0; // 0xc9 MovB
	var_602_int = 0; // 0xca PushI
	var_603_bool = var_600_float > var_602_int; // 0xcb GT
	if(var_603_bool == 0) goto Label_211; // 0xcc JumpB
	var_604_bool = 0; var_605_object = Obj(); // 0xcd PushV
	var_605_object = var_599_object; // 0xce Mov
	func_1626(var_604_bool, var_605_object); // 0xcf NEW_2
	if(var_604_bool == 0) goto Label_211; // 0xd1 JumpB
	var_601_bool = 1; // 0xd2 MovB
	
Label_211:
	if(var_601_bool == 0) goto Label_218; // 0xd3 JumpB
	var_621_bool = GlobalVars[0]; // 0xd4 PushGE
	var_621_bool = 1; // 0xd5 MovB
	GlobalVars[0] = var_621_bool; // 0xd6 PopGE
	func_680(var_600_float); // 0xd8 NEW_2
...
Label_396:
	...
	var_661_string = "all"; // 0x18e PushS
	var_662_string = "fjump"; // 0x18f PushS
	PlayAnimation(var_661_string, var_662_string); // 0x190 Func
	WaitForAnimEnd(); // 0x192 Func
	func_884(var_231_float); // 0x195 NEW_2
	var_663_cvector = CVector(0.0, 0.0, 0.0); // 0x197 PushVec
	SetSpeed(var_663_cvector); // 0x198 Func
	Stop(); // 0x19a Func
	StopAsync(); // 0x19c Func
	var_664_bool = 0; // 0x19e PushV
	func_841(var_231_float, var_664_bool); // 0x19f NEW_2
	var_665_bool = var_664_bool == 0; // 0x1a1 Not
	if(var_665_bool == 0) goto Label_442; // 0x1a2 JumpB
	var_666_bool = 0; var_667_object = Obj(); // 0x1a3 PushV
	var_667_object = var_0_bool; // 0x1a4 MovT
	func_1698(var_666_bool, var_667_object); // 0x1a5 NEW_2
	var_668_bool = var_666_bool == 0; // 0x1a7 Not
	if(var_668_bool == 0) goto Label_426; // 0x1a8 JumpB
...
Label_426:
	...
	var_669_float = var_209_float * var_209_float; // 0x1b0 Mult
	var_670_bool = var_228_float < var_669_float; // 0x1b1 LT
	if(var_670_bool == 0) goto Label_442; // 0x1b2 JumpB
	var_671_bool = 0; var_672_float = 0; // 0x1b3 PushV
	var_672_float = var_209_float; // 0x1b4 Mov
	func_543(var_231_float, var_671_bool, var_672_float); // 0x1b5 NEW_2
	var_673_bool = var_671_bool == 0; // 0x1b7 Not
	if(var_673_bool == 0) goto Label_442; // 0x1b8 JumpB
	goto Label_452; // 0x1b9 Jump
	
Label_443:
	var_674_bool = 0; var_675_float = 0; // 0x1bb PushV
	var_675_float = var_209_float; // 0x1bc Mov
	func_543(var_231_float, var_674_bool, var_675_float); // 0x1bd NEW_2
	var_676_bool = var_674_bool == 0; // 0x1bf Not
	if(var_676_bool == 0) goto Label_450; // 0x1c0 JumpB
...
func_884(var_0_bool)
{
	...
	func_2056(var_269_object); // 0x376 NEW_2
...
func_894(var_644_bool)
{
	var_644_bool = 1; // 0x37e MovB
...
func_924(var_2_int, var_272_bool, var_273_object, var_274_float, var_275_float, var_276_bool, var_277_bool)
{
	...
	func_2056(var_285_object); // 0x39f NEW_2
...
Label_2022:
	...
	func_2046(var_26_float); // 0x7e8 NEW_2
...
func_2036(var_593_float)
{
	...
	var_596_int = 15; // 0x7f9 PushI
	SendWorldWndMessage(var_596_int, var_595_object); // 0x7fa Func
...
func_504(var_0_bool, var_523_float, var_524_int)
{
	...
	var_598_int = 0; // 0x213 PushV
	func_197(var_598_int); // 0x214 NEW_2
	ReportHit(var_0_bool, var_598_int, var_530_float, var_529_float); // 0x216 Func
	var_599_object = Obj(); var_600_float = 0; // 0x218 PushV
	var_599_object = var_528_object; // 0x219 Mov
	var_600_float = var_530_float; // 0x21a Mov
	func_199(var_599_object, var_600_float); // 0x21b NEW_2
...
func_2046(var_26_float)
{
	var_27_object = Obj(); var_28_object = Obj(); // 0x7fe PushV
	CreateFloatVector(var_28_object); // 0x7ff Func
	add(var_26_float); // 0x801 ObjFunc
	var_29_int = 16; // 0x803 PushI
	SendWorldWndMessage(var_29_int, var_28_object); // 0x804 Func
