...
0xcce: Pop(0)
0xccf: Push((int) 1)
0xcd0: @@ SetProperty(Stack[-2], Stack[-1])
0xcd1: Pop(2)
...
0xd07: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5])
0xd08: Pop(1)
...
0xd11: Push("Pantrol point count: ")
...
0xd27: Push("changing state to c_iStateWaitForLoad")
0xd28: @ Trace(Stack[-1])
0xd29: Pop(1)
0xd2a: GOTO 0xd42
...
0xd2e: Push("changing state to c_iStateHeatHands")
0xd2f: @ Trace(Stack[-1])
0xd30: Pop(1)
0xd31: GOTO 0xd42
...
0xd35: Push("changing state to c_iStateIdle")
0xd36: @ Trace(Stack[-1])
0xd37: Pop(1)
0xd38: GOTO 0xd42
...
0xd3c: Push("changing state to c_iStatePatrol")
0xd3d: @ Trace(Stack[-1])
0xd3e: Pop(1)
0xd3f: GOTO 0xd42
...
0xd51: Push("changing state to c_iStateAware")
0xd52: @ Trace(Stack[-1])
0xd53: Pop(1)
0xd54: Push(GlobalVars[4])
0xd55: Stack[-1] = Stack[-2]
...
0xd63: Push("changing state to c_iStateSearchEnemy")
0xd64: @ Trace(Stack[-1])
0xd65: Pop(1)
...
0xd75: Push("changing state to c_iStateHearEnemy")
0xd76: @ Trace(Stack[-1])
0xd77: Pop(1)
...
0xd87: Push("changing state to c_iStateAttack")
0xd88: @ Trace(Stack[-1])
0xd89: Pop(1)
...
0xdce: Stack[-3] = Stack[-7]
0xdcf: Stack[-2] = Stack[-6]
...
0xdd6: Stack[-5] = Stack[-11]
0xdd7: Stack[-4] = Stack[-10]
0xdd8: Stack[-3] = Stack[-9]
0xdd9: Stack[-2] = Stack[-7]
...
0xdf3: Stack[-1] = "pt_k5q03_patrol"
0xdf4: Return(); Pop(0)

0xdf5: Stack[-1] = "k5q03_helpme"
0xdf6: Return(); Pop(0)

0xdf7: Stack[-1] = "k5q03_corpse"
0xdf8: Return(); Pop(0)

0xdf9: Stack[-1] = "pt_k5q03_center"
0xdfa: Return(); Pop(0)
