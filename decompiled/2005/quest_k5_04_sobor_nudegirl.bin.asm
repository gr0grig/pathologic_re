...
0x1e0: PushEmpty(bool, float, float, bool, float, float)
0x1e1: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1e2: Pop(0)
0x1e3: Push(Stack[-3])
0x1e4: IF (Stack[-1] == 0) GOTO 0x1eb; Pop(1)

0x1e5: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1e6: Pop(0)
0x1e7: Push((bool) 0)
0x1e8: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1e9: Pop(1)
0x1ea: GOTO 0x1ef

0x1eb: Push("Can't find lsh animation : ")
0x1ec: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1ed: @ Trace(Stack[-1])
0x1ee: Pop(1)
0x1ef: Return(); Pop(6)

0x1f0: PushEmpty(bool, float, float, bool, float, float)
0x1f1: @ lshHasAnimation(Stack[-3], Stack[-8])
0x1f2: Pop(0)
0x1f3: Push(Stack[-3])
0x1f4: IF (Stack[-1] == 0) GOTO 0x1fa; Pop(1)

0x1f5: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x1f6: Pop(0)
0x1f7: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x1f8: Pop(0)
0x1f9: GOTO 0x1fe

0x1fa: Push("Can't find lsh animation : ")
0x1fb: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1fc: @ Trace(Stack[-1])
0x1fd: Pop(1)
0x1fe: Return(); Pop(6)

0x1ff: PushEmpty(float, cvector, float, cvector)
0x200: @@ GetEyesHeight(Stack[-2])
0x201: Pop(0)
0x202: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x203: Push(CvectorIndex(Stack[-1], 1))
0x204: Stack[-1] = Stack[-3]
0x205: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x206: Push("head")
0x207: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x208: Pop(1)
0x209: Return(); Pop(4)
...
0x212: Pop(0); Push(Stack[-3] | Stack[-3]);
0x213: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x214: Push((float)0.0)
0x215: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x216: IF (Stack[-1] == 0) GOTO 0x219; Pop(1)

0x217: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x218: Return(); Pop(2)

0x219: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x21a: Return(); Pop(2)

0x21b: PushEmpty(string, string)
0x21c: Stack[-1] = "idle"
0x21d: Push(Stack[-3])
0x21e: IF (Stack[-1] == 0) GOTO 0x220; Pop(1)

0x21f: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x220: Stack[-4] = Stack[-1]
0x221: Return(); Pop(2)

0x222: PushEmpty(int, bool, int, bool)
0x223: Stack[-2] = (int) 0
0x224: Push("all")
0x225: PushEmpty(string, int)
0x226: Stack[-1] = Stack[-5]
0x227: Call2 0x21b

0x228: Pop(1)
0x229: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x22a: Pop(2)
...
0x22e: Push((int) 1)
0x22f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x230: GOTO 0x224
...
0x234: Push("branch")
0x235: @ GetVariable(Stack[-1], Stack[-2])
0x236: Pop(1)
0x237: Push((int) 0)
...
0x244: Stack[-1] = (int) 515596
0x245: Return(); Pop(0)

0x246: Stack[-1] = (int) 514839
0x247: Return(); Pop(0)

0x248: Stack[-1] = "ui/NPC_Citizen3.png"
0x249: Return(); Pop(0)

0x24a: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x24b: Return(); Pop(0)
