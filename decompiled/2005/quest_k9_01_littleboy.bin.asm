...
0x2a7: Push("head")
0x2a8: @ LookAsyncCamera(Stack[-1])
0x2a9: Pop(1)
0x2aa: @ CameraWaitForPlayFinish()
0x2ab: Pop(0)
0x2ac: @ ResumeWorld()
0x2ad: Pop(0)
0x2ae: Stack[-21] = (bool) 1
0x2af: Return(); Pop(18)

0x2b0: PushEmpty(bool, bool)
0x2b1: @ CameraSwitchToNormal()
0x2b2: Pop(0)
...
0x2bd: Push("head")
0x2be: @ UnlookAsync(Stack[-1])
0x2bf: Pop(1)
0x2c0: Return(); Pop(2)

0x2c1: PushEmpty(bool, float, float, bool, float, float)
0x2c2: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2c3: Pop(0)
0x2c4: Push(Stack[-3])
0x2c5: IF (Stack[-1] == 0) GOTO 0x2cc; Pop(1)

0x2c6: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2c7: Pop(0)
0x2c8: Push((bool) 0)
0x2c9: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ca: Pop(1)
0x2cb: GOTO 0x2d0

0x2cc: Push("Can't find lsh animation : ")
0x2cd: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2ce: @ Trace(Stack[-1])
0x2cf: Pop(1)
0x2d0: Return(); Pop(6)

0x2d1: PushEmpty(bool, float, float, bool, float, float)
0x2d2: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2d3: Pop(0)
0x2d4: Push(Stack[-3])
0x2d5: IF (Stack[-1] == 0) GOTO 0x2db; Pop(1)

0x2d6: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2d7: Pop(0)
0x2d8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2d9: Pop(0)
0x2da: GOTO 0x2df

0x2db: Push("Can't find lsh animation : ")
0x2dc: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2dd: @ Trace(Stack[-1])
0x2de: Pop(1)
0x2df: Return(); Pop(6)

0x2e0: PushEmpty(float, cvector, float, cvector)
0x2e1: @@ GetEyesHeight(Stack[-2])
0x2e2: Pop(0)
0x2e3: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x32e: Push((int) 524)
0x32f: Push((int) 1)
0x330: Push((int) 529816)
0x331: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x332: Pop(3)
0x333: PushEmpty(bool, object, int)
0x334: Stack[-2] = Stack[-4]
0x335: Stack[-1] = (int) 517
0x336: Call2 0x347
...
0x33b: @ GetDiaryRoot(Stack[-1])
0x33c: Pop(0)
0x33d: Pop(0); Push((bool) Stack[-1] == 0)
0x33e: IF (Stack[-1] == 0) GOTO 0x344; Pop(1)

0x33f: Push("Can't retrieve diary root")
0x340: @ Trace(Stack[-1])
0x341: Pop(1)
0x342: Stack[-3] = (bool) 0
0x343: Return(); Pop(2)
...
0x346: Stack[-1] = 0
0x347: PushEmpty(object, object, int, object, object, int)
0x348: PushEmpty(object)
0x349: Call2 0x33a

0x34a: Stack[-4] = Stack[-1]
0x34b: Pop(1)
0x34c: @@ Find(Stack[-7], Stack[-2])
0x34d: Pop(0)
0x34e: Pop(0); Push((bool) Stack[-2] == 0)
0x34f: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x350: Push("Can't find diary parent with id: ")
0x351: Pop(1); Push(Stack[-1] + Stack[-8]);
0x352: @ Trace(Stack[-1])
0x353: Pop(1)
0x354: Stack[-9] = (bool) 0
0x355: Return(); Pop(6)

0x356: @@ AddChild(Stack[-8])
0x357: Pop(0)
0x358: Push((int) 7)
0x359: @ SendWorldWndMessage(Stack[-1])
0x35a: Pop(1)
0x35b: @@ GetCategory(Stack[-1])
0x35c: Pop(0)
0x35d: @ SetDiarySection(Stack[-1])
0x35e: Pop(0)
0x35f: Stack[-9] = (bool) 0
0x360: Return(); Pop(6)
...
0x374: Stack[-1] = (int) 515560
0x375: Return(); Pop(0)

0x376: Stack[-1] = (int) 503345
0x377: Return(); Pop(0)

0x378: Stack[-1] = "ui/NPC_Citizen3.png"
0x379: Return(); Pop(0)

0x37a: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x37b: Return(); Pop(0)

0x37c: Stack[-1] = (bool) 0
0x37d: Return(); Pop(0)

0x37e: PushEmpty(string, string)
0x37f: Stack[-1] = "idle"
0x380: Push(Stack[-3])
0x381: IF (Stack[-1] == 0) GOTO 0x383; Pop(1)

0x382: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x38b: Pop(1)
0x38c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x38d: Pop(2)
...
0x391: Push((int) 1)
0x392: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x393: GOTO 0x387
