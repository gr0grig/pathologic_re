task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	...
	func_801(var_19_object); // 0xc3 NEW_2
...
Label_343:
	...
	func_892(var_133_bool); // 0x159 NEW_2
...
Label_433:
	...
	func_754(var_19_object); // 0x1b3 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_736(var_29_object); // 0x1f0 NEW_2
...
Label_56:
	var_186_bool = var_26_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_187_object = var_17_object; // 0x40 Mov
	func_688(); // 0x41 NEW_2
...
func_770(var_96_int, var_97_string)
{
	var_98_int = 0; var_99_int = 0; // 0x302 PushV
	GetVariable(var_97_string, var_99_int); // 0x303 Func
	var_96_int = var_99_int; // 0x305 Mov
...
func_901(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x385 PushV
	var_49_int = 0; // 0x386 MovI
	
Label_903:
	var_51_string = "all"; // 0x387 PushS
	var_52_string = ""; var_53_int = 0; // 0x388 PushV
	var_53_int = var_49_int; // 0x389 Mov
	func_894(var_52_string, var_53_int); // 0x38a NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x38c Func
	var_57_bool = var_50_bool == 0; // 0x38e Not
	if(var_57_bool == 0) goto Label_913; // 0x38f JumpB
	goto Label_916; // 0x390 Jump
	
Label_916:
	var_46_int = var_49_int; // 0x394 Mov
	return 4; // 0x395 Return
	
Label_913:
	var_58_int = 1; // 0x391 PushI
	var_49_int = var_49_int + var_58_int; // 0x392 Add2
	goto Label_903; // 0x393 Jump
}
...
Label_404:
	...
	func_754(var_21_object); // 0x196 NEW_2
...
func_775()
{
	var_104_string = "ook9Littleboy1"; // 0x308 PushS
	var_105_int = 1; // 0x309 PushI
	SetVariable(var_104_string, var_105_int); // 0x30a Func
...
Label_530:
	...
	func_901(var_46_int); // 0x213 NEW_2
...
Label_545:
	...
	func_894(var_68_string, var_69_int); // 0x22f NEW_2
...
func_781()
{
	var_108_int = 0; var_109_string = ""; // 0x30e PushV
	var_109_string = "k9q01ChildTalk"; // 0x30f MovS
	func_770(var_108_int, var_109_string); // 0x310 NEW_2
	var_110_int = 0; // 0x312 PushI
	var_111_bool = var_108_int == var_110_int; // 0x313 Eq
	if(var_111_bool == 0) goto Label_800; // 0x314 JumpB
	var_112_string = "k9q01ChildTalk"; // 0x315 PushS
	var_113_int = 1; // 0x316 PushI
	SetVariable(var_112_string, var_113_int); // 0x317 Func
	var_114_string = "k9q01"; // 0x319 PushS
	var_115_int = 7; // 0x31a PushI
	SetVariable(var_114_string, var_115_int); // 0x31b Func
	func_813(); // 0x31e NEW_2
...
func_801(var_94_bool)
{
	var_96_int = 0; var_97_string = ""; // 0x322 PushV
	var_97_string = "ook9Littleboy1"; // 0x323 MovS
	func_770(var_96_int, var_97_string); // 0x324 NEW_2
	var_100_int = 0; // 0x326 PushI
	var_101_bool = var_96_int == var_100_int; // 0x327 Eq
	if(var_101_bool == 0) goto Label_811; // 0x328 JumpB
	var_94_bool = 1; // 0x329 MovB
	return 0; // 0x32a Return
	
Label_811:
	var_94_bool = 0; // 0x32b MovB
	return 0; // 0x32c Return
}


func_162(var_2_object, var_139_string)
{
	var_140_bool = 0; // 0xa3 PushV
	func_892(var_140_bool); // 0xa4 NEW_2
	var_141_bool = var_140_bool == 0; // 0xa6 Not
	if(var_141_bool == 0) goto Label_169; // 0xa7 JumpB
	return 0; // 0xa8 Return
	
Label_169:
	var_142_bool = var_139_string == var_2_object; // 0xa9 Eq
	if(var_142_bool == 0) goto Label_172; // 0xaa JumpB
	return 0; // 0xab Return
	
Label_172:
	var_143_string = ""; var_144_bool = 0; // 0xac PushV
	var_143_string = var_139_string; // 0xad Mov
	var_145_string = ""; // 0xae PushS
	var_146_bool = var_139_string == var_145_string; // 0xaf Eq
	if(var_146_bool == 0) goto Label_179; // 0xb0 JumpB
	var_144_bool = 0; // 0xb1 MovB
	goto Label_180; // 0xb2 Jump
	
Label_180:
	func_721(var_143_string, var_144_bool); // 0xb4 NEW_2
	var_2_object = var_139_string; // 0xb6 TMov
	return 0; // 0xb7 Return
	
Label_179:
	var_144_bool = 1; // 0xb3 MovB
}


func_813()
{
	var_116_object = Obj(); var_117_object = Obj(); // 0x32d PushV
	var_118_int = 524; // 0x32e PushI
	var_119_int = 1; // 0x32f PushI
	var_120_int = 529816; // 0x330 PushI
	CreateDiaryEntry(var_117_object, var_118_int, var_119_int, var_120_int); // 0x331 Func
	var_121_bool = 0; var_122_object = Obj(); var_123_int = 0; // 0x333 PushV
	var_122_object = var_117_object; // 0x334 Mov
	var_123_int = 517; // 0x335 MovI
	func_839(var_121_bool, var_122_object, var_123_int); // 0x336 NEW_2
...
func_688()
{
	var_188_bool = 0; var_189_bool = 0; // 0x2b0 PushV
	CameraSwitchToNormal(); // 0x2b1 Func
	var_190_bool = 0; // 0x2b3 PushV
	func_892(var_190_bool); // 0x2b4 NEW_2
	if(var_190_bool == 0) goto Label_696; // 0x2b6 JumpB
	goto Label_704; // 0x2b7 Jump
	
Label_704:
	return 2; // 0x2c0 Return
	
Label_696:
	var_191_string = "head"; // 0x2b8 PushS
	HasAnimationTrack(var_189_bool, var_191_string); // 0x2b9 Func
	var_192_bool = var_189_bool; // 0x2bb Push
	if(var_192_bool == 0) goto Label_704; // 0x2bc JumpB
	var_193_string = "head"; // 0x2bd PushS
	UnlookAsync(var_193_string); // 0x2be Func
}
...
func_826(var_130_object)
{
	var_131_object = Obj(); var_132_object = Obj(); // 0x33a PushV
	GetDiaryRoot(var_132_object); // 0x33b Func
	var_133_bool = var_132_object == 0; // 0x33d Not
	if(var_133_bool == 0) goto Label_836; // 0x33e JumpB
	var_134_string = "Can't retrieve diary root"; // 0x33f PushS
	Trace(var_134_string); // 0x340 Func
	var_130_object = 0; // 0x342 MovB
	return 2; // 0x343 Return
	
Label_836:
	var_130_object = var_132_object; // 0x344 Mov
	return 2; // 0x345 Return
}


func_705(var_162_string)
{
	var_163_bool = 0; var_164_float = 0; var_165_float = 0; var_166_bool = 0; var_167_float = 0; var_168_float = 0; // 0x2c1 PushV
	lshHasAnimation(var_166_bool, var_162_string); // 0x2c2 Func
	var_169_bool = var_166_bool; // 0x2c4 Push
	if(var_169_bool == 0) goto Label_716; // 0x2c5 JumpB
	lshGetAnimTimes(var_162_string, var_167_float, var_168_float); // 0x2c6 Func
	var_170_bool = 0; // 0x2c8 PushB
	lshPlayAnimation(var_167_float, var_168_float, var_170_bool); // 0x2c9 Func
	goto Label_720; // 0x2cb Jump
	
Label_720:
	return 6; // 0x2d0 Return
	
Label_716:
	var_171_string = "Can't find lsh animation : "; // 0x2cc PushS
	var_172_int = var_171_string + var_162_string; // 0x2cd Add
	Trace(var_172_int); // 0x2ce Func
}


func_839(var_121_bool, var_122_object, var_123_int)
{
	var_124_object = Obj(); var_125_object = Obj(); var_126_int = 0; var_127_object = Obj(); var_128_object = Obj(); var_129_int = 0; // 0x347 PushV
	var_130_object = Obj(); // 0x348 PushV
	func_826(var_130_object); // 0x349 NEW_2
	var_127_object = var_130_object; // 0x34a Mov
	Find(var_123_int, var_128_object); // 0x34c ObjFunc
	var_135_bool = var_128_object == 0; // 0x34e Not
	if(var_135_bool == 0) goto Label_854; // 0x34f JumpB
	var_136_string = "Can't find diary parent with id: "; // 0x350 PushS
	var_137_int = var_136_string + var_123_int; // 0x351 Add
	Trace(var_137_int); // 0x352 Func
	var_121_bool = 0; // 0x354 MovB
	return 6; // 0x355 Return
	
Label_854:
	AddChild(var_122_object); // 0x356 ObjFunc
	var_138_int = 7; // 0x358 PushI
	SendWorldWndMessage(var_138_int); // 0x359 Func
	GetCategory(var_129_int); // 0x35b ObjFunc
	SetDiarySection(var_129_int); // 0x35d Func
	var_121_bool = 0; // 0x35f MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_87_object, var_88_object)
{
	...
	func_801(var_95_object); // 0x52 NEW_2
	...
	func_162(var_88_object, var_139_string); // 0x61 NEW_2
	var_156_int = 529790; // 0x63 PushI
	SetMessage(var_156_int); // 0x64 TObjFunc
	ClearReplies(); // 0x66 TObjFunc
	var_157_int = 529794; // 0x68 PushI
	var_158_int = 31253; // 0x69 PushI
	var_159_int = 31252; // 0x6a PushI
	AddReply(var_157_int, var_158_int, var_159_int); // 0x6b TObjFunc
	goto Label_132; // 0x6d Jump
	
Label_132:
	var_160_bool = 0; // 0x84 PushV
	func_892(var_160_bool); // 0x85 NEW_2
	if(var_160_bool == 0) goto Label_147; // 0x87 JumpB
	
Label_136:
	lshWaitForAnimEnd(); // 0x88 Func
	var_161_string = var_3_string; // 0x8a PushT
	if(var_161_string == 0) goto Label_141; // 0x8b JumpB
...
Label_141:
	var_162_string = ""; // 0x8d PushV
	var_162_string = var_2_object; // 0x8e MovT
	func_705(var_162_string); // 0x8f NEW_2
	goto Label_136; // 0x91 Jump
	
Label_147:
	var_173_string = "all"; // 0x93 PushS
	var_174_string = "idle"; // 0x94 PushS
	PlayAnimation(var_173_string, var_174_string); // 0x95 Func
	
Label_151:
	WaitForAnimEnd(); // 0x97 Func
	var_175_string = var_3_string; // 0x99 PushT
	if(var_175_string == 0) goto Label_156; // 0x9a JumpB
	goto Label_161; // 0x9b Jump
	
Label_156:
	var_176_string = "all"; // 0x9c PushS
	var_177_string = "idle"; // 0x9d PushS
	PlayAnimation(var_176_string, var_177_string); // 0x9e Func
	goto Label_151; // 0xa0 Jump
	
Label_110:
	var_178_string = ""; // 0x6e PushV
	var_178_string = "Neutral"; // 0x6f MovS
	func_162(var_88_object, var_178_string); // 0x70 NEW_2
	var_179_int = 529791; // 0x72 PushI
	SetMessage(var_179_int); // 0x73 TObjFunc
	ClearReplies(); // 0x75 TObjFunc
	var_180_int = 529792; // 0x77 PushI
	var_181_int = -1; // 0x78 PushI
	var_182_int = 31250; // 0x79 PushI
	AddReply(var_180_int, var_181_int, var_182_int); // 0x7a TObjFunc
	var_183_int = 529793; // 0x7c PushI
	var_184_int = -1; // 0x7d PushI
	var_185_int = 31251; // 0x7e PushI
	AddReply(var_183_int, var_184_int, var_185_int); // 0x7f TObjFunc
	goto Label_132; // 0x81 Jump
}


func_721(var_143_string, var_144_bool)
{
	var_147_bool = 0; var_148_float = 0; var_149_float = 0; var_150_bool = 0; var_151_float = 0; var_152_float = 0; // 0x2d1 PushV
	lshHasAnimation(var_150_bool, var_143_string); // 0x2d2 Func
	var_153_bool = var_150_bool; // 0x2d4 Push
	if(var_153_bool == 0) goto Label_731; // 0x2d5 JumpB
	lshGetAnimTimes(var_143_string, var_151_float, var_152_float); // 0x2d6 Func
	lshPlayAnimation(var_151_float, var_152_float, var_144_bool); // 0x2d8 Func
...
Label_731:
	...
	var_155_int = var_154_string + var_143_string; // 0x2dc Add
...
func_736(var_29_object)
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x2e0 PushV
	GetEyesHeight(var_32_float); // 0x2e1 ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x2e3 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x2e4 PushE
	var_34_float = var_32_float; // 0x2e5 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x2e6 PopE
	var_35_string = "head"; // 0x2e7 PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x2e8 Func
...
func_867(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x363 PushV
	var_81_string = "branch"; // 0x364 PushS
	GetVariable(var_81_string, var_80_int); // 0x365 Func
	var_82_int = 0; // 0x367 PushI
	var_83_bool = var_80_int == var_82_int; // 0x368 Eq
	if(var_83_bool == 0) goto Label_877; // 0x369 JumpB
	var_78_int = 1; // 0x36a MovI
	return 2; // 0x36b Return
	
Label_877:
	var_84_int = 1; // 0x36d PushI
	var_85_bool = var_80_int == var_84_int; // 0x36e Eq
	if(var_85_bool == 0) goto Label_882; // 0x36f JumpB
	var_78_int = 2; // 0x370 MovI
	return 2; // 0x371 Return
	
Label_882:
	var_78_int = 3; // 0x372 MovI
...
func_747()
{
	var_15_bool = 0; // 0x2eb PushV
	func_892(var_15_bool); // 0x2ec NEW_2
	if(var_15_bool == 0) goto Label_753; // 0x2ee JumpB
...
func_620(var_27_bool, var_29_float)
{
	...
	func_760(var_54_cvector, var_55_cvector); // 0x287 NEW_2
...
Label_661:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x297 Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x299 PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x29a PushE
	Rotate(var_67_float, var_68_float); // 0x29b Func
	var_69_bool = 0; // 0x29d PushV
	func_892(var_69_bool); // 0x29e NEW_2
	if(var_69_bool == 0) goto Label_674; // 0x2a0 JumpB
	goto Label_682; // 0x2a1 Jump
	
Label_682:
	CameraWaitForPlayFinish(); // 0x2aa Func
	ResumeWorld(); // 0x2ac Func
	var_27_bool = 1; // 0x2ae MovB
	return 18; // 0x2af Return
	
Label_674:
	var_70_string = "head"; // 0x2a2 PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x2a3 Func
	var_71_bool = var_47_bool; // 0x2a5 Push
	if(var_71_bool == 0) goto Label_682; // 0x2a6 JumpB
	var_72_string = "head"; // 0x2a7 PushS
	LookAsyncCamera(var_72_string); // 0x2a8 Func
}


func_754(var_19_object)
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x2f2 PushV
	self(var_21_object); // 0x2f3 Func
	var_19_object = var_21_object; // 0x2f5 Mov
...
func_886(var_74_int)
{
	var_74_int = 503345; // 0x376 MovI
	return 0; // 0x377 Return
}


func_888(var_76_string)
{
	var_76_string = "ui/NPC_Citizen3.png"; // 0x378 MovS
	return 0; // 0x379 Return
}


func_760(var_54_cvector, var_55_cvector)
{
	var_57_float = 0; var_58_float = 0; // 0x2f8 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x2f9 Or
	var_58_float = sqrt(var_59_int); // 0x2fa Sqrt2
	var_60_float = 0.0; // 0x2fb PushF
	var_61_bool = var_58_float < var_60_float; // 0x2fc LT
	if(var_61_bool == 0) goto Label_768; // 0x2fd JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x2fe MovV
	return 2; // 0x2ff Return
	
Label_768:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x300 Div2
...
{
	var_77_string = "ui/NPC_Citizen3_b.png"; // 0x37a MovS
...
func_892(var_69_bool)
{
	var_69_bool = 0; // 0x37c MovB
	return 0; // 0x37d Return
}


func_894(var_52_string, var_53_int)
{
	var_54_string = ""; var_55_string = ""; // 0x37e PushV
	var_55_string = "idle"; // 0x37f MovS
	var_56_int = var_53_int; // 0x380 Push
	if(var_56_int == 0) goto Label_899; // 0x381 JumpB
	var_55_string = var_55_string + var_53_int; // 0x382 Add2
	
Label_899:
	var_52_string = var_55_string; // 0x383 Mov
