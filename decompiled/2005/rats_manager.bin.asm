...
GlobalTasks: 
	...
	GTASK_9 Vars = (bool, int, int) Params = 3
		EVENT_0 Op = 0x5e7 Vars = (object)
		EVENT_26 Op = 0x5ef Vars = (string)
		EVENT_6 Op = 0x695 Vars = ()
...
0x530: Stack[1 + Tasks[-1].StackPointer] = (int)0
0x531: PushEmpty(string, float)
0x532: Stack[-2] = Stack[-6]
0x533: Stack[-1] = Stack[-5]
0x534: Call2 0x548

0x535: Pop(2)
0x536: @ Hold()
0x537: Pop(0)
0x538: Pop(0); Push((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x539: IF (Stack[-1] == 0) GOTO 0x536; Pop(1)

0x53a: Stack[-1] = (int) 0
0x53b: Push((int) 6)
0x53c: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x53d: IF (Stack[-1] == 0) GOTO 0x546; Pop(1)

0x53e: PushEmpty(int, bool)
0x53f: Stack[-2] = Stack[-3]
...
0x546: Stack[-5] = Stack[2 + Tasks[-1].StackPointer]
0x547: Return(); Pop(2)

0x548: PushEmpty(object, object, object, int, int, int, int, object, object, object, object, int, object, object, object, int, int, int, int, object, object, object, object, int)
0x549: @ CreateIntVector(Stack[-12])
0x54a: Pop(0)
0x54b: @ CreateIntVector(Stack[-11])
0x54c: Pop(0)
0x54d: @ CreateIntVector(Stack[-10])
0x54e: Pop(0)
0x54f: PushEmpty(int, object)
0x550: Stack[-1] = Stack[-14]
0x551: Call2 0x632

0x552: Stack[-11] = Stack[-2]
0x553: Pop(2)
0x554: Push((int) 72)
0x555: Pop(1); Push((bool) Stack[-10] > Stack[-1])
0x556: IF (Stack[-1] == 0) GOTO 0x558; Pop(1)

0x557: GOTO 0x579

0x558: PushEmpty(int, object)
0x559: Stack[-1] = Stack[-13]
0x55a: Call2 0x632

0x55b: Stack[-10] = Stack[-2]
0x55c: Pop(2)
0x55d: Push((int) 72)
0x55e: Pop(1); Push((bool) Stack[-9] > Stack[-1])
0x55f: IF (Stack[-1] == 0) GOTO 0x561; Pop(1)

0x560: GOTO 0x579

0x561: PushEmpty(int, object)
0x562: Stack[-1] = Stack[-12]
0x563: Call2 0x632

0x564: Stack[-9] = Stack[-2]
0x565: Pop(2)
0x566: Push((int) 72)
0x567: Pop(1); Push((bool) Stack[-8] > Stack[-1])
...
0x57a: PushEmpty(bool, float)
0x57b: Push((float)0.1)
0x57c: Push((float)0.4)
0x57d: Pop(1); Push(Stack[-29] * Stack[-1]);
0x57e: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x57f: Call2 0x751

0x580: Pop(1)
0x581: IF (Stack[-1] == 0) GOTO 0x58d; Pop(1)

0x582: PushEmpty(int, int, int, int)
0x583: Stack[-3] = Stack[-13]
0x584: Stack[-2] = Stack[-12]
0x585: Stack[-1] = Stack[-11]
0x586: Call2 0x721

0x587: Stack[-10] = Stack[-4]
0x588: Pop(4)
0x589: Push("winner")
0x58a: @ Trace(Stack[-1])
0x58b: Pop(1)
...
0x58d: PushEmpty(int, int, int, int)
0x58e: Stack[-3] = Stack[-13]
0x58f: Stack[-2] = Stack[-12]
0x590: Stack[-1] = Stack[-11]
0x591: Call2 0x730

0x592: Stack[-10] = Stack[-4]
0x593: Pop(4)
0x594: Push("looser")
0x595: @ Trace(Stack[-1])
0x596: Pop(1)
0x597: Push((int) 1)
0x598: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x599: IF (Stack[-1] == 0) GOTO 0x59f; Pop(1)

0x59a: Stack[-5] = Stack[-12]
0x59b: Stack[-12] = Stack[-11]
0x59c: Stack[-11] = Stack[-5]
0x59d: Stack[-5] = 0
0x59e: GOTO 0x5a6

0x59f: Push((int) 2)
0x5a0: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x5a1: IF (Stack[-1] == 0) GOTO 0x5a6; Pop(1)

0x5a2: Stack[-4] = Stack[-12]
0x5a3: Stack[-12] = Stack[-10]
0x5a4: Stack[-10] = Stack[-4]
0x5a5: Stack[-4] = 0
0x5a6: @ GetScene(Stack[-3])
0x5a7: Pop(0)
0x5a8: PushEmpty(object, object, string, string, string)
0x5a9: Stack[-4] = Stack[-8]
0x5aa: Stack[-3] = "pt_rat1"
0x5ab: Stack[-2] = Stack[-31]
0x5ac: Stack[-1] = "rat_race.xml"
0x5ad: Call2 0x761

0x5ae: Stack[-7] = Stack[-5]
0x5af: Pop(5)
0x5b0: Push("Index")
0x5b1: Push((int) 1)
0x5b2: @@ SetScriptProperty(Stack[-2], Stack[-1])
0x5b3: Pop(2)
0x5b4: Push("Race")
0x5b5: @@ SetScriptProperty(Stack[-1], Stack[-13])
0x5b6: Pop(1)
0x5b7: PushEmpty(object, object, string, string, string)
0x5b8: Stack[-4] = Stack[-8]
0x5b9: Stack[-3] = "pt_rat2"
0x5ba: Stack[-2] = "pers_rat"
0x5bb: Stack[-1] = "rat_race.xml"
0x5bc: Call2 0x761

0x5bd: Stack[-7] = Stack[-5]
0x5be: Pop(5)
0x5bf: Push("Index")
0x5c0: Push((int) 2)
0x5c1: @@ SetScriptProperty(Stack[-2], Stack[-1])
0x5c2: Pop(2)
0x5c3: Push("Race")
0x5c4: @@ SetScriptProperty(Stack[-1], Stack[-12])
0x5c5: Pop(1)
0x5c6: PushEmpty(object, object, string, string, string)
0x5c7: Stack[-4] = Stack[-8]
0x5c8: Stack[-3] = "pt_rat3"
0x5c9: Stack[-2] = "pers_rat"
0x5ca: Stack[-1] = "rat_race.xml"
0x5cb: Call2 0x761

0x5cc: Stack[-7] = Stack[-5]
0x5cd: Pop(5)
0x5ce: Push("Index")
0x5cf: Push((int) 3)
0x5d0: @@ SetScriptProperty(Stack[-2], Stack[-1])
0x5d1: Pop(2)
0x5d2: Push("Race")
0x5d3: @@ SetScriptProperty(Stack[-1], Stack[-11])
0x5d4: Pop(1)
0x5d5: Stack[-1] = (int) 0
0x5d6: Push((int) 6)
0x5d7: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x5d8: IF (Stack[-1] == 0) GOTO 0x5e1; Pop(1)

0x5d9: PushEmpty(int, bool)
...
0x5dd: Pop(2)
0x5de: Push((int) 1)
0x5df: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x5e0: GOTO 0x5d6
...
0x5ea: Push(-2, 1); TaskCall(4)
0x5eb: Call2 0x1b6

0x5ec: Pop(-2, 1); TaskReturn
0x5ed: Pop(2)
0x5ee: Return(); Pop(0)

0x5ef: PushEmpty()
0x5f0: Push("race_over1")
0x5f1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x5f2: IF (Stack[-1] == 0) GOTO 0x606; Pop(1)

0x5f3: PushEmpty(int, bool)
0x5f4: Stack[-2] = (int) 3
0x5f5: Stack[-1] = (bool) 0
0x5f6: Call2 0x684

0x5f7: Pop(2)
0x5f8: Push((int) 1)
0x5f9: Stack[1 + Tasks[-1].StackPointer] = Stack[1 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x5fa: Push((int) 1)
0x5fb: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
0x5fc: IF (Stack[-1] == 0) GOTO 0x5ff; Pop(1)

0x5fd: Stack[2 + Tasks[-1].StackPointer] = (int)1
0x5fe: GOTO 0x605

0x5ff: Push((int) 3)
0x600: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
0x601: IF (Stack[-1] == 0) GOTO 0x605; Pop(1)

0x602: Stack[0 + Tasks[-1].StackPointer] = (bool)1
0x603: @ StopGroup0()
0x604: Pop(0)
0x605: GOTO 0x631

0x606: Push("race_over2")
0x607: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x608: IF (Stack[-1] == 0) GOTO 0x61c; Pop(1)

0x609: PushEmpty(int, bool)
0x60a: Stack[-2] = (int) 4
...
0x60d: Pop(2)
0x60e: Push((int) 1)
0x60f: Stack[1 + Tasks[-1].StackPointer] = Stack[1 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x610: Push((int) 1)
0x611: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
0x612: IF (Stack[-1] == 0) GOTO 0x615; Pop(1)

0x613: Stack[2 + Tasks[-1].StackPointer] = (int)0
0x614: GOTO 0x61b

0x615: Push((int) 3)
0x616: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
...
0x61c: Push("race_over3")
0x61d: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x61e: IF (Stack[-1] == 0) GOTO 0x631; Pop(1)

0x61f: PushEmpty(int, bool)
0x620: Stack[-2] = (int) 5
...
0x623: Pop(2)
0x624: Push((int) 1)
0x625: Stack[1 + Tasks[-1].StackPointer] = Stack[1 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x626: Push((int) 1)
0x627: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
0x628: IF (Stack[-1] == 0) GOTO 0x62b; Pop(1)

0x629: Stack[2 + Tasks[-1].StackPointer] = (int)0
0x62a: GOTO 0x631

0x62b: Push((int) 3)
0x62c: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] == Stack[-1])
0x62d: IF (Stack[-1] == 0) GOTO 0x631; Pop(1)

0x62e: Stack[0 + Tasks[-1].StackPointer] = (bool)1
0x62f: @ StopGroup0()
0x630: Pop(0)
0x631: Return(); Pop(0)

0x632: PushEmpty(int, int, bool, bool, int, int, int, bool, bool, int)
0x633: Stack[-5] = (int) 0
0x634: Stack[-4] = (int) 0
0x635: Stack[-3] = (bool) 1
...
0x63f: Push((int) 3)
0x640: @ irand(Stack[-2], Stack[-1])
0x641: Pop(1)
0x642: Push((int) 1)
0x643: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x644: GOTO 0x668

0x645: PushEmpty(bool, float)
0x646: Stack[-1] = (float) 0.66667
0x647: Call2 0x751
...
0x64a: Push((int) 3)
0x64b: @ irand(Stack[-2], Stack[-1])
0x64c: Pop(1)
0x64d: Push((int) 1)
0x64e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x64f: GOTO 0x668

0x650: PushEmpty(bool)
0x651: Stack[-1] = (bool) 0
0x652: Pop(0); Push((bool) Stack[-3] == 0)
0x653: IF (Stack[-1] == 0) GOTO 0x65a; Pop(1)

0x654: PushEmpty(bool, float)
0x655: Stack[-1] = (float) 0.5
0x656: Call2 0x751
...
0x65f: Pop(1)
0x660: Push((int) 1)
0x661: Pop(1); Push(Stack[-2] + Stack[-1]);
0x662: Stack[-2] = -Stack[-1]; Pop(1);
0x663: Pop(0); Push(Stack[-5] + Stack[-1]);
0x664: Push((int) 0)
...
0x668: Stack[-5] = Stack[-5] + Stack[-1]; Pop(0);
0x669: Push((int) 12)
0x66a: Pop(1); Push((bool) Stack[-6] >= Stack[-1])
0x66b: IF (Stack[-1] == 0) GOTO 0x672; Pop(1)

0x66c: Push((int) 12)
0x66d: Pop(1); Push(Stack[-6] - Stack[-1]);
0x66e: Pop(1); Push(Stack[-2] - Stack[-1]);
0x66f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x670: GOTO 0x682
...
0x679: Push((int) 1)
0x67a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x67b: @@ add(Stack[-5])
0x67c: Pop(0)
0x67d: Push((int) 0)
0x67e: Stack[-3] = Stack[-2] == Stack[-1]; Pop(1);
0x67f: Push((int) 0)
0x680: Stack[-4] = Stack[-2] < Stack[-1]; Pop(1);
0x681: GOTO 0x637

0x682: Stack[-12] = Stack[-4]
0x683: Return(); Pop(10)

0x684: PushEmpty(object, object)
0x685: Push("rats_track_door")
0x686: Push((int) 1)
0x687: Pop(1); Push(Stack[-6] + Stack[-1]);
0x688: Pop(2); Push(Stack[-2] + Stack[-1]);
0x689: @ FindActor(Stack[-2], Stack[-1])
0x68a: Pop(1)
0x68b: Push(Stack[-3])
...
0x694: Stack[-1] = 0
0x695: Stack[2 + Tasks[-1].StackPointer] = (int)-1
...
0x69b: @@ GetProperty(Stack[-4], Stack[-1])
0x69c: Pop(0)
0x69d: Pop(0); Push(Stack[-1] + Stack[-3]);
0x69e: @@ SetProperty(Stack[-5], Stack[-1])
0x69f: Pop(1)
0x6a0: Return(); Pop(2)

0x6a1: PushEmpty(bool, bool)
0x6a2: @ IsLoaded(Stack[-1])
0x6a3: Pop(0)
0x6a4: Stack[-3] = Stack[-1]
0x6a5: Return(); Pop(2)

0x6a6: PushEmpty(float, cvector, cvector, cvector, cvector, cvector, cvector, bool, bool, float, cvector, cvector, cvector, cvector, cvector, cvector, bool, bool)
0x6a7: @@ GetPosition(Stack[-8])
0x6a8: Pop(0)
0x6a9: @@ GetEyesHeight(Stack[-9])
0x6aa: Pop(0)
0x6ab: Push(CvectorIndex(Stack[-8], 1))
0x6ac: Stack[-1] = Stack[-1] + Stack[-10]; Pop(0);
0x6ad: CvectorIndex(Stack[-9], 1) = Stack[-1];
0x6ae: @ GetPosition(Stack[-7])
0x6af: Pop(0)
0x6b0: @ GetEyesHeight(Stack[-9])
0x6b1: Pop(0)
0x6b2: Push(CvectorIndex(Stack[-7], 1))
0x6b3: Stack[-1] = Stack[-1] + Stack[-10]; Pop(0);
0x6b4: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x6b5: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0x6b6: Push(CvectorIndex(Stack[-6], 1))
0x6b7: Stack[-1] = (int) 0
0x6b8: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x6b9: Pop(0); Push(Stack[-6] | Stack[-6]);
0x6ba: Pop(1); Push(Sqrt(Stack[-1]))
0x6bb: Stack[-7] = Stack[-7] / Stack[-1]; Pop(1);
0x6bc: Stack[-5] = -Stack[-6]; Pop(0);
0x6bd: Pop(0); Push(Stack[-6] * Stack[-19]);
0x6be: PushEmpty(cvector, cvector)
0x6bf: Push(CVector(0.0, 1.0, 0.0))
0x6c0: Stack[-2] = Stack[-9] ^ Stack[-1]; Pop(1);
0x6c1: Call2 0x73f
...
0x6c7: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x6c8: Stack[-3] = Stack[-7] + Stack[-4]; Pop(0);
0x6c9: @ IsOverrideActive(Stack[-2])
0x6ca: Pop(0)
0x6cb: Push(Stack[-2])
0x6cc: IF (Stack[-1] == 0) GOTO 0x6cf; Pop(1)

0x6cd: Stack[-21] = (bool) 0
0x6ce: Return(); Pop(18)

0x6cf: @ StopWorld()
0x6d0: Pop(0)
0x6d1: @ CameraTransit(Stack[-3], Stack[-5])
0x6d2: Pop(0)
...
0x6dc: Push("head")
0x6dd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6de: Pop(1)
0x6df: Push(Stack[-1])
0x6e0: IF (Stack[-1] == 0) GOTO 0x6e4; Pop(1)

0x6e1: Push("head")
0x6e2: @ LookAsyncCamera(Stack[-1])
0x6e3: Pop(1)
0x6e4: @ CameraWaitForPlayFinish()
0x6e5: Pop(0)
0x6e6: @ ResumeWorld()
0x6e7: Pop(0)
0x6e8: Stack[-21] = (bool) 1
0x6e9: Return(); Pop(18)

0x6ea: PushEmpty(bool, bool)
0x6eb: @ CameraSwitchToNormal()
0x6ec: Pop(0)
...
0x6f2: Push("head")
0x6f3: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6f4: Pop(1)
0x6f5: Push(Stack[-1])
0x6f6: IF (Stack[-1] == 0) GOTO 0x6fa; Pop(1)

0x6f7: Push("head")
0x6f8: @ UnlookAsync(Stack[-1])
0x6f9: Pop(1)
0x6fa: Return(); Pop(2)

0x6fb: PushEmpty(bool, float, float, bool, float, float)
0x6fc: @ lshHasAnimation(Stack[-3], Stack[-7])
0x6fd: Pop(0)
0x6fe: Push(Stack[-3])
0x6ff: IF (Stack[-1] == 0) GOTO 0x706; Pop(1)

0x700: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x701: Pop(0)
0x702: Push((bool) 0)
0x703: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x704: Pop(1)
0x705: GOTO 0x70a

0x706: Push("Can't find lsh animation : ")
...
0x70c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x70d: Pop(0)
0x70e: Push(Stack[-3])
0x70f: IF (Stack[-1] == 0) GOTO 0x715; Pop(1)

0x710: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x711: Pop(0)
0x712: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x713: Pop(0)
0x714: GOTO 0x719

0x715: Push("Can't find lsh animation : ")
0x716: Pop(1); Push(Stack[-1] + Stack[-9]);
0x717: @ Trace(Stack[-1])
0x718: Pop(1)
0x719: Return(); Pop(6)
...
0x721: PushEmpty()
0x722: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x723: IF (Stack[-1] == 0) GOTO 0x72a; Pop(1)

0x724: Pop(0); Push((bool) Stack[-3] < Stack[-1])
...
0x730: PushEmpty()
0x731: Pop(0); Push((bool) Stack[-3] > Stack[-2])
...
0x740: Pop(0); Push(Stack[-3] | Stack[-3]);
0x741: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x742: Push((float)0.0)
0x743: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x744: IF (Stack[-1] == 0) GOTO 0x747; Pop(1)

0x745: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x746: Return(); Pop(2)

0x747: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x748: Return(); Pop(2)
...
0x752: @ rand(Stack[-1])
0x753: Pop(0)
0x754: Stack[-4] = Stack[-1] < Stack[-3]; Pop(0);
0x755: Return(); Pop(2)

0x756: PushEmpty(object, object)
0x757: @ CreateObjectVector(Stack[-1])
0x758: Pop(0)
...
0x761: PushEmpty(bool, cvector, cvector, object, bool, cvector, cvector, object)
0x762: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2])
0x763: Pop(0)
0x764: Pop(0); Push((bool) Stack[-4] == 0)
0x765: IF (Stack[-1] == 0) GOTO 0x76e; Pop(1)

0x766: Push("Locator ")
0x767: Pop(1); Push(Stack[-1] + Stack[-12]);
0x768: Push(" doesn't exist")
0x769: Pop(2); Push(Stack[-2] + Stack[-1]);
0x76a: @ Trace(Stack[-1])
0x76b: Pop(1)
0x76c: Stack[-1] = 0
0x76d: GOTO 0x770

0x76e: @ AddActor(Stack[-1], Stack[-10], Stack[-12], Stack[-3], Stack[-2], Stack[-9])
0x76f: Pop(0)
0x770: Stack[-13] = Stack[-1]
0x771: Return(); Pop(8)

0x772: Stack[-1] = 0
0x773: PushEmpty(object, object)
0x774: @ CreateIntVector(Stack[-1])
0x775: Pop(0)
0x776: @@ add(Stack[-4])
0x777: Pop(0)
0x778: @@ add(Stack[-3])
0x779: Pop(0)
0x77a: Push((int) 3)
0x77b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x77c: Pop(1)
0x77d: Return(); Pop(2)

0x77e: Stack[-1] = 0
0x77f: PushEmpty(int, int)
0x780: PushEmpty(object, string, int)
0x781: Stack[-3] = Stack[-7]
0x782: Stack[-2] = "money"
...
0x789: Push("Money")
0x78a: @ GetInvItemByName(Stack[-2], Stack[-1])
0x78b: Pop(1)
...
0x792: PushEmpty(int, bool, int, bool)
0x793: @ GetInvItemByName(Stack[-2], Stack[-5])
0x794: Pop(0)
0x795: @@ HasItem(Stack[-2], Stack[-1])
0x796: Pop(0)
0x797: Stack[-7] = Stack[-1]
0x798: Return(); Pop(4)

0x799: PushEmpty()
0x79a: Push((int) 1)
0x79b: @@ SetReturnValue(Stack[-1])
0x79c: Pop(1)
0x79d: Return(); Pop(0)

0x79e: PushEmpty()
0x79f: Push("ooRatsManager1")
0x7a0: Push((int) 1)
0x7a1: @ SetVariable(Stack[-2], Stack[-1])
0x7a2: Pop(2)
0x7a3: Return(); Pop(0)

0x7a4: PushEmpty()
0x7a5: Push("money500 is given")
0x7a6: @ Trace(Stack[-1])
0x7a7: Pop(1)
0x7a8: PushEmpty(object, int)
0x7a9: Stack[-2] = Stack[-4]
0x7aa: Stack[-1] = (int) 500
0x7ab: Call2 0x77f
...
0x7ae: PushEmpty()
0x7af: Push("playsound")
0x7b0: Push("givemoney")
0x7b1: @ TriggerWorld(Stack[-2], Stack[-1])
0x7b2: Pop(2)
0x7b3: Return(); Pop(0)

0x7b4: PushEmpty()
0x7b5: PushEmpty(int, string)
0x7b6: Stack[-1] = "branch"
0x7b7: Call2 0x75c
...
0x7bc: Stack[-2] = (bool) 1
0x7bd: Return(); Pop(0)

0x7be: Stack[-2] = (bool) 0
0x7bf: Return(); Pop(0)

0x7c0: PushEmpty()
0x7c1: PushEmpty(int, string)
0x7c2: Stack[-1] = "branch"
0x7c3: Call2 0x75c
...
0x7c8: Stack[-2] = (bool) 1
0x7c9: Return(); Pop(0)

0x7ca: Stack[-2] = (bool) 0
0x7cb: Return(); Pop(0)

0x7cc: PushEmpty()
0x7cd: PushEmpty(int, string)
0x7ce: Stack[-1] = "branch"
0x7cf: Call2 0x75c
...
0x7d4: Stack[-2] = (bool) 1
0x7d5: Return(); Pop(0)

0x7d6: Stack[-2] = (bool) 0
0x7d7: Return(); Pop(0)
...
0x7df: Pop(2)
0x7e0: IF (Stack[-1] == 0) GOTO 0x7e8; Pop(1)

0x7e1: PushEmpty(bool, object, string)
0x7e2: Stack[-2] = Stack[-5]
0x7e3: Stack[-1] = "rat_big"
0x7e4: Call2 0x792
...
0x7ed: PushEmpty()
0x7ee: PushEmpty(int, string)
0x7ef: Stack[-1] = "ooRatsManager1"
0x7f0: Call2 0x75c

0x7f1: Pop(1)
0x7f2: Push((int) 0)
0x7f3: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x7f4: IF (Stack[-1] == 0) GOTO 0x7f7; Pop(1)

0x7f5: Stack[-2] = (bool) 1
0x7f6: Return(); Pop(0)

0x7f7: Stack[-2] = (bool) 0
0x7f8: Return(); Pop(0)
...
0x80a: Stack[-1] = (int) 518097
0x80b: Return(); Pop(0)

0x80c: Stack[-1] = (int) 518096
0x80d: Return(); Pop(0)

0x80e: Stack[-1] = "ui/NPC_Citizen2.png"
0x80f: Return(); Pop(0)

0x810: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x811: Return(); Pop(0)
