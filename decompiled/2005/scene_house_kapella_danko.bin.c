task_0_event_5(var_0_bool, var_1_object)
{
	...
	var_5_string = "pt_kapella"; // 0xc MovS
	var_6_string = "NPC_Kapella"; // 0xd MovS
	var_7_string = "NPC_Danko_Kapella.xml"; // 0xe MovS
...
{
	var_3_string = "nokapella"; // 0x19 PushS
...
Label_30:
	var_5_string = "kapella"; // 0x1e PushS
