task_0_event_5(var_0_bool, var_1_object)
{
	...
	var_5_string = "pt_spi4ka"; // 0xc MovS
	var_6_string = "NPC_Spi4ka"; // 0xd MovS
	var_7_string = "NPC_Danko_Spi4ka.xml"; // 0xe MovS
...
{
	var_3_string = "nospi4ka"; // 0x19 PushS
...
Label_30:
	var_5_string = "spi4ka"; // 0x1e PushS
