...
{
	var_2_bool = var_1_bool; // 0x5 PushT
	...
	var_5_string = "pt_han"; // 0xc MovS
	var_6_string = "NPC_Han"; // 0xd MovS
	var_7_string = "NPC_Danko_Han.xml"; // 0xe MovS
	func_41(var_3_object, var_4_object, var_5_string, var_6_string, var_7_string); // 0xf NEW_2
	var_0_object = var_3_object; // 0x10 TMov
...
{
	var_2_object = var_0_object; // 0x13 PushT
	if(var_2_object == 0) goto Label_23; // 0x14 JumpB
	RemoveActor(var_0_object); // 0x15 Func
