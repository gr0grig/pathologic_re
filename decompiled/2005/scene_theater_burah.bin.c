task_0_event_5()
{
	...
	var_93_string = "quest_b12_01"; // 0x4 MovS
...
func_19()
{
	...
	var_37_string = "cs_mask_burah"; // 0x21 PushS
	...
	var_43_string = "cs_mask_burah.xml"; // 0x27 PushS
	...
	var_62_string = "cs_mask_burah"; // 0x34 PushS
