...
func_0(var_25_object)
{
	...
	func_995(var_26_bool, var_27_object); // 0x3 NEW_2
...
func_133(var_127_string)
{
	...
	func_1320(var_128_string); // 0x92 NEW_2
...
func_1294(var_72_string, var_73_int, var_74_int)
{
	var_75_bool = 0; var_76_bool = 0; // 0x50e PushV
	var_77_bool = 0; var_78_int = 0; var_79_int = 0; // 0x50f PushV
	var_78_int = var_73_int; // 0x510 Mov
	var_79_int = var_74_int; // 0x511 Mov
	func_1486(var_77_bool, var_78_int, var_79_int); // 0x512 NEW_2
	if(var_77_bool == 0) goto Label_1304; // 0x514 JumpB
	var_80_int = 0; // 0x515 PushI
	AddItem(var_76_bool, var_72_string, var_80_int); // 0x516 Func
...
func_1305(var_52_string, var_53_int, var_54_int, var_55_int)
{
	var_56_int = 0; var_57_bool = 0; var_58_int = 0; var_59_bool = 0; // 0x519 PushV
	var_60_bool = 0; var_61_int = 0; var_62_int = 0; // 0x51a PushV
	var_61_int = var_53_int; // 0x51b Mov
	var_62_int = var_54_int; // 0x51c Mov
	func_1486(var_60_bool, var_61_int, var_62_int); // 0x51d NEW_2
	if(var_60_bool == 0) goto Label_1319; // 0x51f JumpB
	irand(var_58_int, var_55_int); // 0x520 Func
	var_65_int = 0; // 0x522 PushI
	var_66_int = 1; // 0x523 PushI
	var_67_int = var_58_int + var_66_int; // 0x524 Add
	AddItem(var_59_bool, var_52_string, var_65_int, var_67_int); // 0x525 Func
...
func_1690(var_45_int, var_46_string)
{
	var_47_int = 0; var_48_int = 0; // 0x69a PushV
	GetInvItemByName(var_48_int, var_46_string); // 0x69b Func
	var_45_int = var_48_int; // 0x69d Mov
	return 2; // 0x69e Return
}


func_1563(var_84_int)
{
	var_85_int = 0; var_86_int = 0; // 0x61b PushV
	var_87_string = "branch"; // 0x61c PushS
	GetVariable(var_87_string, var_86_int); // 0x61d Func
	var_84_int = var_86_int; // 0x61f Mov
...
func_1695(var_24_object)
{
	var_25_object = Obj(); // 0x6a0 PushV
	var_25_object = var_24_object; // 0x6a1 Mov
	TaskCall(0); // 0x6a2 TaskCall
	func_0(var_25_object); // 0x6a3 NEW_2
...
func_1320(var_128_string)
{
	var_129_bool = 0; var_130_int = 0; var_131_bool = 0; var_132_int = 0; var_133_bool = 0; var_134_float = 0; var_135_cvector = CVector(0,0,0); var_136_cvector = CVector(0,0,0); var_137_bool = 0; var_138_int = 0; var_139_bool = 0; var_140_int = 0; var_141_bool = 0; var_142_float = 0; var_143_cvector = CVector(0,0,0); var_144_cvector = CVector(0,0,0); // 0x528 PushV
	IsExisting3DSound(var_137_bool, var_128_string); // 0x529 Func
	var_145_bool = var_137_bool == 0; // 0x52b Not
	if(var_145_bool == 0) goto Label_1345; // 0x52c JumpB
	var_138_int = 0; // 0x52d MovI
	
Label_1326:
	var_146_int = 1; // 0x52e PushI
	var_147_int = var_138_int + var_146_int; // 0x52f Add
	var_148_int = var_128_string + var_147_int; // 0x530 Add
	IsExisting3DSound(var_139_bool, var_148_int); // 0x531 Func
	var_149_bool = var_139_bool == 0; // 0x533 Not
	if(var_149_bool == 0) goto Label_1334; // 0x534 JumpB
	goto Label_1337; // 0x535 Jump
	
Label_1337:
	var_150_bool = var_138_int == 0; // 0x539 Not
	if(var_150_bool == 0) goto Label_1340; // 0x53a JumpB
	return 16; // 0x53b Return
	
Label_1340:
	irand(var_140_int, var_138_int); // 0x53c Func
	var_151_int = 1; // 0x53e PushI
	var_152_int = var_140_int + var_151_int; // 0x53f Add
	var_128_string = var_128_string + var_152_int; // 0x540 Add2
	
Label_1345:
	Is3DSoundLoaded(var_141_bool, var_128_string); // 0x541 Func
	var_153_bool = var_141_bool; // 0x543 Push
	if(var_153_bool == 0) goto Label_1360; // 0x544 JumpB
	GetEyesHeight(var_142_float); // 0x545 Func
	GetDirection(var_143_cvector); // 0x547 Func
	var_154_int = 50; // 0x549 PushI
	var_144_cvector = var_143_cvector * var_154_int; // 0x54a Mult2
	var_155_float = GetByIndex(var_144_cvector, 1); // 0x54b PushE
	var_155_float = var_155_float + var_142_float; // 0x54c Add2
	SetByIndex(var_144_cvector, 1) = var_155_float; // 0x54d PopE
	PlayGlobalSound(var_128_string, var_144_cvector); // 0x54e Func
	
Label_1360:
	return 16; // 0x550 Return
	
Label_1334:
	var_156_int = 1; // 0x536 PushI
	var_138_int = var_138_int + var_156_int; // 0x537 Add2
...
Label_110:
	...
	func_1320(var_180_string); // 0x70 NEW_2
...
func_1582(var_33_int, var_34_int)
{
	var_35_int = 0; var_36_bool = 0; var_37_int = 0; var_38_bool = 0; // 0x62e PushV
	var_39_bool = var_33_int > var_34_int; // 0x62f GT
	if(var_39_bool == 0) goto Label_1589; // 0x630 JumpB
	var_40_string = "GenerateMoney: iMin > iMax"; // 0x631 PushS
	Trace(var_40_string); // 0x632 Func
	return 4; // 0x634 Return
	
Label_1589:
	var_37_int = 0; // 0x635 MovI
	var_41_bool = var_33_int != var_34_int; // 0x636 Neq
	if(var_41_bool == 0) goto Label_1596; // 0x637 JumpB
	var_42_int = var_34_int - var_33_int; // 0x638 Sub
	irand(var_37_int, var_42_int); // 0x639 Func
	goto Label_1600; // 0x63b Jump
	
Label_1600:
	var_37_int = var_37_int + var_33_int; // 0x640 Add2
	var_43_int = 0; // 0x641 PushI
	var_44_bool = var_37_int == var_43_int; // 0x642 Eq
	if(var_44_bool == 0) goto Label_1605; // 0x643 JumpB
	return 4; // 0x644 Return
	
Label_1605:
	var_45_int = 0; var_46_string = ""; // 0x645 PushV
	var_46_string = "Money"; // 0x646 MovS
	func_1690(var_45_int, var_46_string); // 0x647 NEW_2
	var_49_int = 0; // 0x649 PushI
	AddItem(var_38_bool, var_45_int, var_49_int, var_37_int); // 0x64a Func
	return 4; // 0x64c Return
	
Label_1596:
	var_50_int = 0; // 0x63c PushI
	var_51_bool = var_33_int == var_50_int; // 0x63d Eq
	if(var_51_bool == 0) goto Label_1600; // 0x63e JumpB
...
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x83e PushV
	var_21_bool = 0; var_22_object = Obj(); // 0x83f PushV
	var_22_object = var_18_object; // 0x840 Mov
	func_995(var_21_bool, var_22_object); // 0x841 NEW_2
	if(var_21_bool == 0) goto Label_2124; // 0x843 JumpB
	GetScene(var_20_object); // 0x844 Func
	var_23_object = Obj(); // 0x846 PushV
	func_1448(var_23_object); // 0x847 NEW_2
	RemoveStationaryActor(var_23_object); // 0x849 ObjFunc
	var_20_object = 0; // 0x84b SetNull
	
Label_2124:
	var_24_object = Obj(); // 0x84c PushV
	var_24_object = var_18_object; // 0x84d Mov
	func_1695(var_24_object); // 0x84e NEW_2
...
func_1613(var_90_string)
{
	var_91_object = Obj(); var_92_int = 0; var_93_bool = 0; var_94_object = Obj(); var_95_int = 0; var_96_bool = 0; // 0x64d PushV
	CreateInvItem(var_94_object); // 0x64e Func
	SetItemName(var_90_string); // 0x650 ObjFunc
	var_97_string = "Organ"; // 0x652 PushS
	var_98_int = 1; // 0x653 PushI
	SetProperty(var_97_string, var_98_int); // 0x654 ObjFunc
	GetItemID(var_95_int); // 0x656 ObjFunc
	var_99_int = 0; // 0x658 PushI
	var_100_int = 1; // 0x659 PushI
	AddItem(var_96_bool, var_94_object, var_99_int, var_100_int); // 0x65a Func
	return 6; // 0x65c Return
}


func_1486(var_60_bool, var_61_int, var_62_int)
{
	var_63_int = 0; var_64_int = 0; // 0x5ce PushV
	irand(var_64_int, var_62_int); // 0x5cf Func
	var_60_bool = var_64_int < var_61_int; // 0x5d1 LT2
...
func_1630()
{
	var_84_int = 0; // 0x65e PushV
	func_1563(var_84_int); // 0x65f NEW_2
	var_88_int = 1; // 0x661 PushI
	var_89_bool = var_84_int != var_88_int; // 0x662 Neq
	if(var_89_bool == 0) goto Label_1637; // 0x663 JumpB
	return 0; // 0x664 Return
	
Label_1637:
	var_90_string = ""; // 0x665 PushV
	var_90_string = "liver"; // 0x666 MovS
	func_1613(var_90_string); // 0x667 NEW_2
	var_101_string = ""; // 0x669 PushV
	var_101_string = "kidney"; // 0x66a MovS
	func_1613(var_101_string); // 0x66b NEW_2
	var_102_string = ""; // 0x66d PushV
	var_102_string = "heart"; // 0x66e MovS
	func_1613(var_102_string); // 0x66f NEW_2
	var_103_string = ""; // 0x671 PushV
	var_103_string = "blood"; // 0x672 MovS
	func_1613(var_103_string); // 0x673 NEW_2
...
func_1654()
{
	var_28_int = 0; var_29_bool = 0; var_30_int = 0; var_31_bool = 0; // 0x676 PushV
	var_32_int = 0; // 0x677 PushI
	ClearSubContainer(var_32_int); // 0x678 Func
	var_33_int = 0; var_34_int = 0; // 0x67a PushV
	var_33_int = 500; // 0x67b MovI
	var_34_int = 1000; // 0x67c MovI
	func_1582(var_33_int, var_34_int); // 0x67d NEW_2
	var_52_string = ""; var_53_int = 0; var_54_int = 0; var_55_int = 0; // 0x67f PushV
	var_52_string = "rifle_ammo"; // 0x680 MovS
	var_53_int = 1; // 0x681 MovI
	var_54_int = 3; // 0x682 MovI
	var_55_int = 3; // 0x683 MovI
	func_1305(var_52_string, var_53_int, var_54_int, var_55_int); // 0x684 NEW_2
	var_68_string = ""; var_69_int = 0; var_70_int = 0; var_71_int = 0; // 0x686 PushV
	var_68_string = "rusk"; // 0x687 MovS
	var_69_int = 1; // 0x688 MovI
	var_70_int = 3; // 0x689 MovI
	var_71_int = 2; // 0x68a MovI
	func_1305(var_68_string, var_69_int, var_70_int, var_71_int); // 0x68b NEW_2
	var_72_string = ""; var_73_int = 0; var_74_int = 0; // 0x68d PushV
	var_72_string = "bandage"; // 0x68e MovS
	var_73_int = 1; // 0x68f MovI
	var_74_int = 6; // 0x690 MovI
	func_1294(var_72_string, var_73_int, var_74_int); // 0x691 NEW_2
	var_81_string = ""; var_82_int = 0; var_83_int = 0; // 0x693 PushV
	var_81_string = "tourniquet"; // 0x694 MovS
	var_82_int = 1; // 0x695 MovI
	var_83_int = 6; // 0x696 MovI
	func_1294(var_81_string, var_82_int, var_83_int); // 0x697 NEW_2
