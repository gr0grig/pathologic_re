...
0x2b1: PushEmpty(bool, float, float, bool, float, float)
0x2b2: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2b3: Pop(0)
0x2b4: Push(Stack[-3])
0x2b5: IF (Stack[-1] == 0) GOTO 0x2bc; Pop(1)

0x2b6: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2b7: Pop(0)
0x2b8: Push((bool) 0)
...
0x2c2: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2c3: Pop(0)
0x2c4: Push(Stack[-3])
0x2c5: IF (Stack[-1] == 0) GOTO 0x2cb; Pop(1)

0x2c6: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2c7: Pop(0)
0x2c8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2c9: Pop(0)
0x2ca: GOTO 0x2cf

0x2cb: Push("Can't find lsh animation : ")
0x2cc: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2cd: @ Trace(Stack[-1])
0x2ce: Pop(1)
0x2cf: Return(); Pop(6)
...
0x2d8: @ self(Stack[-1])
0x2d9: Pop(0)
0x2da: Stack[-3] = Stack[-1]
0x2db: Return(); Pop(2)

0x2dc: Stack[-1] = 0
0x2dd: PushEmpty(float, float)
0x2de: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2df: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2e0: Push((float)0.0)
0x2e1: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2e2: IF (Stack[-1] == 0) GOTO 0x2e5; Pop(1)

0x2e3: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2e4: Return(); Pop(2)

0x2e5: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2e6: Return(); Pop(2)

0x2e7: PushEmpty(string, string)
0x2e8: Stack[-1] = "idle"
0x2e9: Push(Stack[-3])
0x2ea: IF (Stack[-1] == 0) GOTO 0x2ec; Pop(1)

0x2eb: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2ec: Stack[-4] = Stack[-1]
0x2ed: Return(); Pop(2)

0x2ee: PushEmpty(int, bool, int, bool)
0x2ef: Stack[-2] = (int) 0
0x2f0: Push("all")
0x2f1: PushEmpty(string, int)
0x2f2: Stack[-1] = Stack[-5]
0x2f3: Call2 0x2e7

0x2f4: Pop(1)
0x2f5: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2f6: Pop(2)
...
0x2fa: Push((int) 1)
0x2fb: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2fc: GOTO 0x2f0

0x2fd: Stack[-5] = Stack[-2]
0x2fe: Return(); Pop(4)

0x2ff: Stack[-1] = (int) 515569
0x300: Return(); Pop(0)

0x301: Stack[-1] = (int) 503354
0x302: Return(); Pop(0)

0x303: Stack[-1] = "ui/NPC_wmask.png"
0x304: Return(); Pop(0)

0x305: Stack[-1] = "ui/NPC_wmask_b.png"
0x306: Return(); Pop(0)

0x307: Stack[-1] = (bool) 0
0x308: Return(); Pop(0)

0x309: PushEmpty(int, int)
0x30a: Push("branch")
0x30b: @ GetVariable(Stack[-1], Stack[-2])
0x30c: Pop(1)
0x30d: Push((int) 0)
