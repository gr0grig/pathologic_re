...
0xa19: Push("vol_")
0xa1a: Pop(1); Push(Stack[-1] + Stack[-4]);
0xa1b: @ GetVariable(Stack[-1], Stack[-2])
0xa1c: Pop(1)
0xa1d: Push((int) 16)
0xa1e: Pop(1); Push(Stack[-2] & Stack[-1]);
0xa1f: Push((int) 0)
...
0xa50: Pop(0)
0xa51: Pop(0); Push((bool) Stack[-1] == 0)
...
0xa84: Push("Door ")
0xa85: Pop(1); Push(Stack[-1] + Stack[-5]);
0xa86: Push(" not found")
0xa87: Pop(2); Push(Stack[-2] + Stack[-1]);
0xa88: @ Trace(Stack[-1])
0xa89: Pop(1)
0xa8a: GOTO 0xa8e
...
0xab0: Push((int) 1)
0xab1: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xab2: GOTO 0xa9c
...
0xad6: Push((int) 1)
0xad7: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xad8: GOTO 0xac2
...
0xafc: Push((int) 1)
0xafd: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xafe: GOTO 0xae8
...
0xb08: Push((int) 1)
0xb09: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
...
0xb0e: Push((int) 1)
0xb0f: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
...
0xb14: Push((int) 1)
0xb15: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xb16: Push((int) 2)
0xb17: Stack[-4] = Stack[-2] >= Stack[-1]; Pop(1);
0xb18: Return(); Pop(2)
