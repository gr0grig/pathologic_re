...
0x3b2: @@ HasProperty(Stack[-1], Stack[-4])
0x3b3: Pop(1)
...
0x3c7: @@ GetProperty(Stack[-1], Stack[-2])
0x3c8: Pop(1)
0x3c9: PushEmpty(bool, string)
0x3ca: Stack[-1] = Stack[-3]
0x3cb: Call2 0x3ee

0x3cc: Stack[-14] = Stack[-2]
0x3cd: Pop(2)
0x3ce: Return(); Pop(10)
...
0x3da: Push("Can't find lsh animation : ")
...
0x3e9: Push("Can't find lsh animation : ")
...
0x43f: Stack[-1] = "ui/NPC_Rubin.png"
0x440: Return(); Pop(0)

0x441: Stack[-1] = "ui/NPC_Rubin_b.png"
0x442: Return(); Pop(0)
