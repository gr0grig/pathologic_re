...
0x8af: @@ HasProperty(Stack[-1], Stack[-4])
0x8b0: Pop(1)
...
0x8c4: @@ GetProperty(Stack[-1], Stack[-2])
0x8c5: Pop(1)
0x8c6: PushEmpty(bool, string)
0x8c7: Stack[-1] = Stack[-3]
0x8c8: Call2 0x953

0x8c9: Stack[-14] = Stack[-2]
0x8ca: Pop(2)
0x8cb: Return(); Pop(10)
...
0x8da: @@ HasProperty(Stack[-1], Stack[-4])
0x8db: Pop(1)
...
0x8ef: @@ GetProperty(Stack[-1], Stack[-2])
0x8f0: Pop(1)
0x8f1: PushEmpty(bool, string)
0x8f2: Stack[-1] = Stack[-3]
0x8f3: Call2 0x953

0x8f4: Stack[-14] = Stack[-2]
0x8f5: Pop(2)
0x8f6: Return(); Pop(10)

0x8f7: PushEmpty()
0x8f8: PushEmpty(bool, object, float)
0x8f9: Stack[-2] = Stack[-4]
0x8fa: Stack[-1] = (int) 70
0x8fb: Call2 0x8ff

0x8fc: Stack[-5] = Stack[-3]
0x8fd: Pop(3)
0x8fe: Return(); Pop(0)
...
0x900: @@ GetPosition(Stack[-7])
0x901: Pop(0)
0x902: @@ GetEyesHeight(Stack[-8])
0x903: Pop(0)
...
0x93f: Push("Can't find lsh animation : ")
...
0x94e: Push("Can't find lsh animation : ")
...
0x9a9: Stack[-1] = "ui/NPC_Andrei.png"
0x9aa: Return(); Pop(0)

0x9ab: Stack[-1] = "ui/NPC_Andrei_b.png"
0x9ac: Return(); Pop(0)
...
0x9fd: Push("Can't retrieve diary root")
0x9fe: @ Trace(Stack[-1])
0x9ff: Pop(1)
0xa00: Stack[-3] = (bool) 0
0xa01: Return(); Pop(2)

0xa02: Stack[-3] = Stack[-1]
0xa03: Return(); Pop(2)
...
0xa08: Stack[-4] = Stack[-1]
0xa09: Pop(1)
0xa0a: @@ Find(Stack[-7], Stack[-2])
0xa0b: Pop(0)
0xa0c: Pop(0); Push((bool) Stack[-2] == 0)
0xa0d: IF (Stack[-1] == 0) GOTO 0xa14; Pop(1)

0xa0e: Push("Can't find diary parent with id: ")
...
0xa14: @@ AddChild(Stack[-8])
0xa15: Pop(0)
0xa16: Push((int) 7)
0xa17: @ SendWorldWndMessage(Stack[-1])
0xa18: Pop(1)
0xa19: @@ GetCategory(Stack[-1])
0xa1a: Pop(0)
...
0xa2e: Pop(0)
0xa2f: Push("grass_combination")
0xa30: @@ SetItemName(Stack[-1])
0xa31: Pop(1)
0xa32: Push((int) 50)
...
0xa43: @@ SetProperty(Stack[-2], Stack[-1])
0xa44: Pop(2)
0xa45: Push((int) 0)
...
0xaeb: IF (Stack[-1] == 0) GOTO 0xaf2; Pop(1)
...
0xaef: Pop(1)
0xaf0: IF (Stack[-1] == 0) GOTO 0xaf2; Pop(1)
