...
0x601: @@ HasProperty(Stack[-1], Stack[-4])
0x602: Pop(1)
...
0x616: @@ GetProperty(Stack[-1], Stack[-2])
0x617: Pop(1)
0x618: PushEmpty(bool, string)
0x619: Stack[-1] = Stack[-3]
0x61a: Call2 0x668

0x61b: Stack[-14] = Stack[-2]
0x61c: Pop(2)
0x61d: Return(); Pop(10)
...
0x62c: @@ HasProperty(Stack[-1], Stack[-4])
0x62d: Pop(1)
...
0x641: @@ GetProperty(Stack[-1], Stack[-2])
0x642: Pop(1)
0x643: PushEmpty(bool, string)
0x644: Stack[-1] = Stack[-3]
0x645: Call2 0x668

0x646: Stack[-14] = Stack[-2]
0x647: Pop(2)
0x648: Return(); Pop(10)
...
0x654: Push("Can't find lsh animation : ")
...
0x663: Push("Can't find lsh animation : ")
...
0x6be: Stack[-1] = "ui/NPC_Han.png"
0x6bf: Return(); Pop(0)

0x6c0: Stack[-1] = "ui/NPC_Han_b.png"
0x6c1: Return(); Pop(0)
...
0x6eb: Push("Can't retrieve diary root")
0x6ec: @ Trace(Stack[-1])
0x6ed: Pop(1)
...
0x6f7: Pop(1)
0x6f8: @@ Find(Stack[-7], Stack[-2])
0x6f9: Pop(0)
0x6fa: Pop(0); Push((bool) Stack[-2] == 0)
0x6fb: IF (Stack[-1] == 0) GOTO 0x702; Pop(1)

0x6fc: Push("Can't find diary parent with id: ")
...
0x702: @@ AddChild(Stack[-8])
0x703: Pop(0)
0x704: Push((int) 7)
0x705: @ SendWorldWndMessage(Stack[-1])
0x706: Pop(1)
0x707: @@ GetCategory(Stack[-1])
0x708: Pop(0)
