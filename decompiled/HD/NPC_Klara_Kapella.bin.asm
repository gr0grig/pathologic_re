...
0xd24: @@ HasProperty(Stack[-1], Stack[-4])
0xd25: Pop(1)
...
0xd39: @@ GetProperty(Stack[-1], Stack[-2])
0xd3a: Pop(1)
0xd3b: PushEmpty(bool, string)
0xd3c: Stack[-1] = Stack[-3]
0xd3d: Call2 0xd8b

0xd3e: Stack[-14] = Stack[-2]
0xd3f: Pop(2)
0xd40: Return(); Pop(10)
...
0xd4f: @@ HasProperty(Stack[-1], Stack[-4])
0xd50: Pop(1)
...
0xd64: @@ GetProperty(Stack[-1], Stack[-2])
0xd65: Pop(1)
0xd66: PushEmpty(bool, string)
0xd67: Stack[-1] = Stack[-3]
0xd68: Call2 0xd8b

0xd69: Stack[-14] = Stack[-2]
0xd6a: Pop(2)
0xd6b: Return(); Pop(10)
...
0xd77: Push("Can't find lsh animation : ")
...
0xd86: Push("Can't find lsh animation : ")
...
0xdda: Stack[-3] = Stack[-7]
0xddb: Stack[-2] = "money"
0xddc: Stack[-1] = Stack[-6]
0xddd: Call2 0xc6c
...
0xde6: Stack[-2] = Stack[-3]
0xde7: Stack[-1] = Stack[-5]
0xde8: Call2 0xdcc
...
0xe01: Stack[-1] = Stack[-2]
0xe02: Call2 0xe0e

0xe03: Pop(1)
0xe04: PushEmpty(bool, object, string, float, float, float)
0xe05: Stack[-5] = Stack[-8]
0xe06: Stack[-4] = "reputation"
0xe07: Stack[-3] = Stack[-7]
0xe08: Stack[-2] = (int) 0
0xe09: Stack[-1] = (int) 1
0xe0a: Call2 0xc56
...
0xe1a: Pop(0)
0xe1b: Pop(0); Push((bool) Stack[-1] == 0)
...
0xe54: Stack[-1] = "ui/NPC_Kapella.png"
0xe55: Return(); Pop(0)

0xe56: Stack[-1] = "ui/NPC_Kapella_b.png"
0xe57: Return(); Pop(0)
...
0xe5a: PushEmpty()
0xe5b: Push("money 4000 is given")
0xe5c: @ Trace(Stack[-1])
0xe5d: Pop(1)
...
0xe66: Stack[-2] = Stack[-5]
0xe67: Stack[-1] = (float) 0.05
0xe68: Call2 0xdeb
...
0xe6c: Push("k3q01KapellaAboutHan")
0xe6d: Push((int) 1)
...
0xe72: Stack[-2] = Stack[-1]
0xe73: Pop(1)
0xe74: Push("k3q01KapellaGotoAnna")
0xe75: Push("pt_map_anna")
0xe76: Push((int) 1)
...
0xe7a: Pop(0)
0xe7b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xe7c: Pop(5)
0xe7d: PushEmpty()
0xe7e: Call2 0xf9b
...
0xe86: Pop(1)
0xe87: Push("k3q04KapellaGotoDanko")
0xe88: Push("pt_gmap_dt_house2_08")
0xe89: Push((int) 0)
...
0xe8d: Pop(0)
0xe8e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xe8f: Pop(5)
0xe90: PushEmpty()
0xe91: Call2 0xfa8
...
0xe97: Stack[-1] = "quest_k3_04"
0xe98: Call2 0xdc1

0xe99: Pop(2)
0xe9a: PushEmpty(bool, string, string)
0xe9b: Stack[-2] = "quest_k3_04"
0xe9c: Stack[-1] = "place_burah_lopuh"
0xe9d: Call2 0xe18
...
0xeb9: PushEmpty()
0xeba: Push("playsound")
0xebb: Push("givemoney")
0xebc: @ TriggerWorld(Stack[-2], Stack[-1])
0xebd: Pop(2)
0xebe: Return(); Pop(0)

0xebf: PushEmpty()
0xec0: Push("ook5Kapella1")
0xec1: Push((int) 1)
...
0xecd: Pop(1)
0xece: Push("k5q04KapellaGotoMaria")
0xecf: Push("pt_map_maria")
0xed0: Push((int) 0)
...
0xed4: Pop(0)
0xed5: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xed6: Pop(5)
0xed7: PushEmpty()
0xed8: Call2 0xfc2
...
0xee4: Stack[-2] = "quest_k5_04"
0xee5: Stack[-1] = "completed"
0xee6: Call2 0xe18
...
0xef1: Stack[-2] = Stack[-5]
0xef2: Stack[-1] = (float) 0.02
0xef3: Call2 0xdeb
...
0xefc: PushEmpty()
0xefd: Push("money 5000 is given")
0xefe: @ Trace(Stack[-1])
0xeff: Pop(1)
0xf00: PushEmpty(object, int)
0xf01: Stack[-2] = Stack[-4]
...
0xf0e: Stack[-2] = Stack[-5]
0xf0f: Stack[-1] = (float) 0.1
0xf10: Call2 0xdeb
...
0xf17: Stack[-4] = Stack[-1]
0xf18: Pop(1)
0xf19: Stack[-2] = "pt_map_maria"
0xf1a: Stack[-1] = (int) 2
0xf1b: Call2 0x103d
...
0x1008: Push("Can't retrieve diary root")
0x1009: @ Trace(Stack[-1])
0x100a: Pop(1)
0x100b: Stack[-3] = (bool) 0
0x100c: Return(); Pop(2)

0x100d: Stack[-3] = Stack[-1]
0x100e: Return(); Pop(2)
...
0x1013: Stack[-4] = Stack[-1]
0x1014: Pop(1)
0x1015: @@ Find(Stack[-7], Stack[-2])
0x1016: Pop(0)
0x1017: Pop(0); Push((bool) Stack[-2] == 0)
0x1018: IF (Stack[-1] == 0) GOTO 0x101f; Pop(1)

0x1019: Push("Can't find diary parent with id: ")
...
0x101f: @@ AddChild(Stack[-8])
0x1020: Pop(0)
0x1021: Push((int) 7)
0x1022: @ SendWorldWndMessage(Stack[-1])
0x1023: Pop(1)
0x1024: @@ GetCategory(Stack[-1])
0x1025: Pop(0)
...
0x102e: Pop(0)
0x102f: Pop(0); Push((bool) Stack[-2] == 0)
0x1030: IF (Stack[-1] == 0) GOTO 0x1037; Pop(1)

0x1031: Push("Can't find main outdoor scene")
0x1032: @ Trace(Stack[-1])
0x1033: Pop(1)
0x1034: Stack[-1] = 0
0x1035: Stack[-5] = Stack[-1]
0x1036: Return(); Pop(4)

0x1037: @@ GetMap(Stack[-1])
0x1038: Pop(0)
...
0x103f: Pop(0)
0x1040: Pop(0); Push((bool) Stack[-2] == 0)
0x1041: IF (Stack[-1] == 0) GOTO 0x1046; Pop(1)

0x1042: Push("Can't find main outdoor scene")
0x1043: @ Trace(Stack[-1])
0x1044: Pop(1)
0x1045: Return(); Pop(8)

0x1046: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x1047: Pop(0)
0x1048: Pop(0); Push((bool) Stack[-1] == 0)
0x1049: IF (Stack[-1] == 0) GOTO 0x1050; Pop(1)

0x104a: Push("Warning: outdoor scene locator ")
0x104b: Pop(1); Push(Stack[-1] + Stack[-11]);
0x104c: Push(" doesnt exist")
0x104d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x104e: @ Trace(Stack[-1])
0x104f: Pop(1)
0x1050: @@ GetMap(Stack[-11])
0x1051: Pop(0)
0x1052: Pop(0); Push((bool) Stack[-11] == 0)
0x1053: IF (Stack[-1] == 0) GOTO 0x1058; Pop(1)

0x1054: Push("Can't find map")
...
0x105a: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x105b: Pop(2)
0x105c: Return(); Pop(8)
