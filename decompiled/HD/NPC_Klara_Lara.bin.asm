...
0xd65: @@ HasProperty(Stack[-1], Stack[-4])
0xd66: Pop(1)
...
0xd90: @@ HasProperty(Stack[-1], Stack[-4])
0xd91: Pop(1)
...
0xda5: @@ GetProperty(Stack[-1], Stack[-2])
0xda6: Pop(1)
0xda7: PushEmpty(bool, string)
0xda8: Stack[-1] = Stack[-3]
0xda9: Call2 0xdcc

0xdaa: Stack[-14] = Stack[-2]
0xdab: Pop(2)
0xdac: Return(); Pop(10)
...
0xdb8: Push("Can't find lsh animation : ")
...
0xdc7: Push("Can't find lsh animation : ")
...
0xe1b: Stack[-3] = Stack[-7]
0xe1c: Stack[-2] = "money"
0xe1d: Stack[-1] = Stack[-6]
0xe1e: Call2 0xcad
...
0xe2d: @@ GetItemID(Stack[-3])
0xe2e: Pop(0)
0xe2f: Push("Category")
0xe30: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xe31: Pop(1)
0xe32: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0xe33: Pop(0)
0xe34: Pop(0); Push((bool) Stack[-1] == 0)
0xe35: IF (Stack[-1] == 0) GOTO 0xe39; Pop(1)

0xe36: @@ DropItems(Stack[-8], Stack[-7])
0xe37: Pop(0)
0xe38: GOTO 0xe3e

0xe39: PushEmpty(int, int)
0xe3a: Stack[-2] = Stack[-5]
0xe3b: Stack[-1] = Stack[-9]
0xe3c: Call2 0xe0d
...
0xe41: Pop(0)
0xe42: @@ SetItemName(Stack[-4])
0xe43: Pop(0)
0xe44: PushEmpty(object, object, int)
0xe45: Stack[-3] = Stack[-8]
0xe46: Stack[-2] = Stack[-4]
0xe47: Stack[-1] = Stack[-6]
0xe48: Call2 0xe2c
...
0xe66: Stack[-5] = Stack[-8]
0xe67: Stack[-4] = "reputation"
0xe68: Stack[-3] = Stack[-7]
0xe69: Stack[-2] = (int) 0
0xe6a: Stack[-1] = (int) 1
0xe6b: Call2 0xc97
...
0xe7b: Pop(0)
0xe7c: Pop(0); Push((bool) Stack[-1] == 0)
...
0xeb5: Stack[-1] = "ui/NPC_Lara.png"
0xeb6: Return(); Pop(0)

0xeb7: Stack[-1] = "ui/NPC_Lara_b.png"
0xeb8: Return(); Pop(0)
...
0xebd: Stack[-2] = Stack[-5]
0xebe: Stack[-1] = (float) 0.05
0xebf: Call2 0xe4c
...
0xed8: Stack[-2] = Stack[-1]
0xed9: Pop(1)
0xeda: Push("k2q03Arfist")
0xedb: Push("pt_map_k2q03_arfist")
0xedc: Push((int) 0)
...
0xee0: Pop(0)
0xee1: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xee2: Pop(5)
0xee3: PushEmpty()
0xee4: Call2 0x10dd
...
0xeea: Stack[-1] = "quest_k2_03"
0xeeb: Call2 0xe02

0xeec: Pop(2)
0xeed: PushEmpty(bool, string, string)
0xeee: Stack[-2] = "quest_k2_03"
0xeef: Stack[-1] = "place_arfist"
0xef0: Call2 0xe79
...
0xef9: Stack[-2] = "quest_k2_03"
0xefa: Stack[-1] = "completed"
0xefb: Call2 0xe79
...
0xf05: Stack[-2] = Stack[-1]
0xf06: Pop(1)
0xf07: Push("k4q03LaraGotoAlexandr")
0xf08: Push("pt_map_alexandr")
0xf09: Push((int) 0)
...
0xf0d: Pop(0)
0xf0e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xf0f: Pop(5)
0xf10: PushEmpty()
0xf11: Call2 0x1104
...
0xf2d: Stack[-2] = "quest_k4_03"
0xf2e: Stack[-1] = "completed"
0xf2f: Call2 0xe79
...
0xf32: PushEmpty()
0xf33: Push("smoked_meat2 is given")
0xf34: @ Trace(Stack[-1])
0xf35: Pop(1)
0xf36: PushEmpty(object, string, int)
0xf37: Stack[-3] = Stack[-5]
0xf38: Stack[-2] = "smoked_meat"
0xf39: Stack[-1] = (int) 2
0xf3a: Call2 0xe3f
...
0xf8f: Stack[-4] = Stack[-1]
0xf90: Pop(1)
0xf91: Stack[-2] = "pt_map_k2q03_arfist"
0xf92: Stack[-1] = (int) 2
0xf93: Call2 0x1172
...
0xf97: Pop(0)
0xf98: @@ ShowMap(Stack[-1])
0xf99: Pop(1)
0xf9a: Return(); Pop(0)

0xf9b: PushEmpty()
0xf9c: Push("playsound")
0xf9d: Push("givemoney")
0xf9e: @ TriggerWorld(Stack[-2], Stack[-1])
0xf9f: Pop(2)
0xfa0: Return(); Pop(0)

0xfa1: PushEmpty()
0xfa2: Push("playsound")
0xfa3: Push("giveitem")
...
0xfb7: Stack[-4] = Stack[-1]
0xfb8: Pop(1)
0xfb9: Stack[-2] = "pt_map_alexandr"
0xfba: Stack[-1] = (int) 2
0xfbb: Call2 0x1172
...
0xfbf: Pop(0)
0xfc0: @@ ShowMap(Stack[-1])
0xfc1: Pop(1)
0xfc2: Return(); Pop(0)

0xfc3: PushEmpty()
0xfc4: Push("etorfin is given")
0xfc5: @ Trace(Stack[-1])
0xfc6: Pop(1)
0xfc7: PushEmpty(object, string, int)
0xfc8: Stack[-3] = Stack[-5]
0xfc9: Stack[-2] = "etorfin"
0xfca: Stack[-1] = (int) 1
0xfcb: Call2 0xe3f
...
0x113d: Push("Can't retrieve diary root")
0x113e: @ Trace(Stack[-1])
0x113f: Pop(1)
0x1140: Stack[-3] = (bool) 0
0x1141: Return(); Pop(2)

0x1142: Stack[-3] = Stack[-1]
0x1143: Return(); Pop(2)
...
0x1148: Stack[-4] = Stack[-1]
0x1149: Pop(1)
0x114a: @@ Find(Stack[-7], Stack[-2])
0x114b: Pop(0)
0x114c: Pop(0); Push((bool) Stack[-2] == 0)
0x114d: IF (Stack[-1] == 0) GOTO 0x1154; Pop(1)

0x114e: Push("Can't find diary parent with id: ")
...
0x1154: @@ AddChild(Stack[-8])
0x1155: Pop(0)
0x1156: Push((int) 7)
0x1157: @ SendWorldWndMessage(Stack[-1])
0x1158: Pop(1)
0x1159: @@ GetCategory(Stack[-1])
0x115a: Pop(0)
...
0x1163: Pop(0)
0x1164: Pop(0); Push((bool) Stack[-2] == 0)
0x1165: IF (Stack[-1] == 0) GOTO 0x116c; Pop(1)

0x1166: Push("Can't find main outdoor scene")
0x1167: @ Trace(Stack[-1])
0x1168: Pop(1)
0x1169: Stack[-1] = 0
0x116a: Stack[-5] = Stack[-1]
0x116b: Return(); Pop(4)

0x116c: @@ GetMap(Stack[-1])
0x116d: Pop(0)
...
0x1174: Pop(0)
0x1175: Pop(0); Push((bool) Stack[-2] == 0)
0x1176: IF (Stack[-1] == 0) GOTO 0x117b; Pop(1)

0x1177: Push("Can't find main outdoor scene")
0x1178: @ Trace(Stack[-1])
0x1179: Pop(1)
0x117a: Return(); Pop(8)

0x117b: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x117c: Pop(0)
0x117d: Pop(0); Push((bool) Stack[-1] == 0)
0x117e: IF (Stack[-1] == 0) GOTO 0x1185; Pop(1)

0x117f: Push("Warning: outdoor scene locator ")
0x1180: Pop(1); Push(Stack[-1] + Stack[-11]);
0x1181: Push(" doesnt exist")
0x1182: Pop(2); Push(Stack[-2] + Stack[-1]);
0x1183: @ Trace(Stack[-1])
0x1184: Pop(1)
0x1185: @@ GetMap(Stack[-11])
0x1186: Pop(0)
0x1187: Pop(0); Push((bool) Stack[-11] == 0)
0x1188: IF (Stack[-1] == 0) GOTO 0x118d; Pop(1)

0x1189: Push("Can't find map")
...
0x118f: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x1190: Pop(2)
0x1191: Return(); Pop(8)
