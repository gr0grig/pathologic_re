...
Label_203:
	...
	func_1873(var_58_bool); // 0xcd NEW_2
...
Label_443:
	...
	func_1908(var_118_object); // 0x1c9 NEW_2
...
Label_465:
	...
	func_1920(var_129_object); // 0x1d3 NEW_2
...
Label_749:
	...
	func_1873(var_249_bool); // 0x2ef NEW_2
...
Label_1008:
	...
	func_1873(var_74_bool); // 0x3f2 NEW_2
...
Label_1211:
	...
	func_1873(var_51_bool); // 0x4bd NEW_2
...
Label_1318:
	...
	func_1793(var_67_object); // 0x52d NEW_2
	var_66_object = var_67_object; // 0x52e Mov
	func_1660(var_66_object); // 0x530 NEW_2
...
task_8_event_5(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_object, var_8_string, var_9_bool, var_10_object, var_11_object, var_12_object, var_13_string, var_14_bool, var_15_object, var_16_object, var_17_object, var_18_string, var_19_bool, var_20_cvector)
{
	...
	func_1740(var_22_string); // 0x550 NEW_2
...
Label_1373:
	...
	func_1740(var_28_string); // 0x55f NEW_2
}
...
task_8_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_object, var_8_string, var_9_bool, var_10_object, var_11_object, var_12_object, var_13_string, var_14_bool, var_15_object, var_16_object, var_17_object, var_18_string, var_19_bool, var_20_cvector, var_21_object)
{
	...
	func_2029(var_39_object); // 0x572 NEW_2
	var_461_string = ""; // 0x574 PushV
	var_461_string = "Neutral"; // 0x575 MovS
	func_1740(var_461_string); // 0x576 NEW_2
...
{
	var_321_int = 0; var_322_string = ""; // 0x781 PushV
	var_322_string = "k8q01"; // 0x782 MovS
	func_1809(var_321_int, var_322_string); // 0x783 NEW_2
	var_323_int = 3; // 0x785 PushI
	var_324_bool = var_321_int == var_323_int; // 0x786 Eq
	if(var_324_bool == 0) goto Label_1930; // 0x787 JumpB
	var_319_bool = 1; // 0x788 MovB
	return 0; // 0x789 Return
	
Label_1930:
	var_319_bool = 0; // 0x78a MovB
...
{
	var_117_object = Obj(); var_118_object = Obj(); // 0x701 PushV
	self(var_118_object); // 0x702 Func
	var_116_object = var_118_object; // 0x704 Mov
...
Label_45:
	...
	func_1793(var_116_object); // 0x31 NEW_2
	var_115_object = var_116_object; // 0x32 Mov
	func_1602(var_114_bool, var_115_object); // 0x34 NEW_2
...
Label_63:
	var_255_bool = var_52_bool == 0; // 0x3f Not
...
Label_70:
	...
	var_256_object = var_43_object; // 0x47 Mov
	func_1584(); // 0x48 NEW_2
...
{
	var_217_bool = 0; // 0x87 PushV
	func_1873(var_217_bool); // 0x88 NEW_2
	var_218_bool = var_217_bool == 0; // 0x8a Not
	if(var_218_bool == 0) goto Label_141; // 0x8b JumpB
	return 0; // 0x8c Return
	
Label_141:
	var_219_bool = var_216_string == var_2_object; // 0x8d Eq
	if(var_219_bool == 0) goto Label_144; // 0x8e JumpB
	return 0; // 0x8f Return
	
Label_144:
	var_220_string = ""; var_221_bool = 0; // 0x90 PushV
	var_220_string = var_216_string; // 0x91 Mov
	var_222_string = ""; // 0x92 PushS
	var_223_bool = var_216_string == var_222_string; // 0x93 Eq
	if(var_223_bool == 0) goto Label_151; // 0x94 JumpB
	var_221_bool = 0; // 0x95 MovB
	goto Label_152; // 0x96 Jump
	
Label_152:
	func_1756(var_220_string, var_221_bool); // 0x98 NEW_2
	var_2_object = var_216_string; // 0x9a TMov
	return 0; // 0x9b Return
	
Label_151:
	var_221_bool = 1; // 0x97 MovB
}


func_1287()
{
	var_463_float = 0; var_464_float = 0; // 0x507 PushV
	var_465_int = 8; // 0x508 PushI
	var_466_int = 16; // 0x509 PushI
	rand(var_464_float, var_465_int, var_466_int); // 0x50a Func
	var_467_int = 10; // 0x50c PushI
	SetTimer(var_467_int, var_464_float); // 0x50d Func
...
{
	var_437_bool = 0; // 0x489 PushV
	func_1873(var_437_bool); // 0x48a NEW_2
	var_438_bool = var_437_bool == 0; // 0x48c Not
	if(var_438_bool == 0) goto Label_1167; // 0x48d JumpB
	return 0; // 0x48e Return
	
Label_1167:
	var_439_bool = var_436_string == var_2_object; // 0x48f Eq
	if(var_439_bool == 0) goto Label_1170; // 0x490 JumpB
	return 0; // 0x491 Return
	
Label_1170:
	var_440_string = ""; var_441_bool = 0; // 0x492 PushV
	var_440_string = var_436_string; // 0x493 Mov
	var_442_string = ""; // 0x494 PushS
	var_443_bool = var_436_string == var_442_string; // 0x495 Eq
	if(var_443_bool == 0) goto Label_1177; // 0x496 JumpB
	var_441_bool = 0; // 0x497 MovB
	goto Label_1178; // 0x498 Jump
	
Label_1178:
	func_1756(var_440_string, var_441_bool); // 0x49a NEW_2
	var_2_object = var_436_string; // 0x49c TMov
	return 0; // 0x49d Return
	
Label_1177:
	var_441_bool = 1; // 0x499 MovB
}


func_1799(var_80_cvector, var_81_cvector)
{
	var_83_float = 0; var_84_float = 0; // 0x707 PushV
	var_85_int = var_81_cvector | var_81_cvector; // 0x708 Or
	var_84_float = sqrt(var_85_int); // 0x709 Sqrt2
	var_86_float = 0.0; // 0x70a PushF
	var_87_bool = var_84_float < var_86_float; // 0x70b LT
	if(var_87_bool == 0) goto Label_1807; // 0x70c JumpB
	var_80_cvector = CVector(0.0, 0.0, 0.0); // 0x70d MovV
	return 2; // 0x70e Return
	
Label_1807:
	var_80_cvector = var_81_cvector / var_81_cvector; // 0x70f Div2
...
{
	var_378_bool = 0; // 0x38b PushV
	func_1873(var_378_bool); // 0x38c NEW_2
	var_379_bool = var_378_bool == 0; // 0x38e Not
	if(var_379_bool == 0) goto Label_913; // 0x38f JumpB
	return 0; // 0x390 Return
	
Label_913:
	var_380_bool = var_377_string == var_2_object; // 0x391 Eq
	if(var_380_bool == 0) goto Label_916; // 0x392 JumpB
	return 0; // 0x393 Return
	
Label_916:
	var_381_string = ""; var_382_bool = 0; // 0x394 PushV
	var_381_string = var_377_string; // 0x395 Mov
	var_383_string = ""; // 0x396 PushS
	var_384_bool = var_377_string == var_383_string; // 0x397 Eq
	if(var_384_bool == 0) goto Label_923; // 0x398 JumpB
	var_382_bool = 0; // 0x399 MovB
	goto Label_924; // 0x39a Jump
	
Label_924:
	func_1756(var_381_string, var_382_bool); // 0x39c NEW_2
	var_2_object = var_377_string; // 0x39e TMov
	return 0; // 0x39f Return
	
Label_923:
	var_382_bool = 1; // 0x39b MovB
}


func_1932()
{
	var_58_object = Obj(); var_59_object = Obj(); // 0x78c PushV
	var_60_int = 530; // 0x78d PushI
	var_61_int = 1; // 0x78e PushI
	var_62_int = 530194; // 0x78f PushI
	CreateDiaryEntry(var_59_object, var_60_int, var_61_int, var_62_int); // 0x790 Func
	var_63_bool = 0; var_64_object = Obj(); var_65_int = 0; // 0x792 PushV
	var_64_object = var_59_object; // 0x793 Mov
	var_65_int = 438; // 0x794 MovI
	func_1984(var_63_bool, var_64_object, var_65_int); // 0x795 NEW_2
...
func_1296()
{
	var_462_int = 10; // 0x510 PushI
	KillTimer(var_462_int); // 0x511 Func
...
{
	var_312_int = 0; var_313_int = 0; // 0x711 PushV
	GetVariable(var_311_string, var_313_int); // 0x712 Func
	var_310_int = var_313_int; // 0x714 Mov
...
{
	var_69_object = Obj(); var_70_object = Obj(); // 0x716 PushV
	FindActor(var_70_object, var_67_string); // 0x717 Func
	var_71_bool = var_70_object == 0; // 0x719 NullEq
	if(var_71_bool == 0) goto Label_1821; // 0x71a JumpB
	var_66_bool = 0; // 0x71b MovB
	return 2; // 0x71c Return
	
Label_1821:
	Trigger(var_70_object, var_68_string); // 0x71d Func
	var_66_bool = 1; // 0x71f MovB
...
func_1945()
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x799 PushV
	var_33_int = 440; // 0x79a PushI
	var_34_int = 1; // 0x79b PushI
	var_35_int = 526465; // 0x79c PushI
	CreateDiaryEntry(var_32_object, var_33_int, var_34_int, var_35_int); // 0x79d Func
	var_36_bool = 0; var_37_object = Obj(); var_38_int = 0; // 0x79f PushV
	var_37_object = var_32_object; // 0x7a0 Mov
	var_38_int = 438; // 0x7a1 MovI
	func_1984(var_36_bool, var_37_object, var_38_int); // 0x7a2 NEW_2
...
func_1786()
{
	var_24_bool = 0; // 0x6fa PushV
	func_1873(var_24_bool); // 0x6fb NEW_2
	if(var_24_bool == 0) goto Label_1792; // 0x6fd JumpB
	lshStopSpeech(); // 0x6fe Func
...
func_1697(var_156_bool)
{
	var_158_string = ""; var_159_int = 0; var_160_bool = 0; var_161_int = 0; var_162_string = ""; var_163_string = ""; var_164_int = 0; var_165_bool = 0; var_166_int = 0; var_167_string = ""; // 0x6a1 PushV
	var_168_string = "d"; // 0x6a2 PushS
	var_169_int = 0; // 0x6a3 PushV
	func_1826(var_169_int); // 0x6a4 NEW_2
	var_175_int = var_168_string + var_169_int; // 0x6a6 Add
	var_176_string = "m"; // 0x6a7 PushS
	var_163_string = var_175_int + var_176_string; // 0x6a8 Add2
	var_164_int = 0; // 0x6a9 MovI
	
Label_1706:
	var_177_int = 1; // 0x6aa PushI
	if(var_177_int == 0) goto Label_1719; // 0x6ab JumpB
	var_178_int = 1; // 0x6ac PushI
	var_179_int = var_164_int + var_178_int; // 0x6ad Add
	var_180_int = var_163_string + var_179_int; // 0x6ae Add
	HasProperty(var_180_int, var_165_bool); // 0x6af ObjFunc
	var_181_bool = var_165_bool == 0; // 0x6b1 Not
	if(var_181_bool == 0) goto Label_1716; // 0x6b2 JumpB
	goto Label_1719; // 0x6b3 Jump
	
Label_1719:
	var_182_bool = var_164_int == 0; // 0x6b7 Not
	if(var_182_bool == 0) goto Label_1723; // 0x6b8 JumpB
	var_156_bool = 0; // 0x6b9 MovB
	return 10; // 0x6ba Return
	
Label_1723:
	var_166_int = 0; // 0x6bb MovI
	var_183_int = 1; // 0x6bc PushI
	var_184_bool = var_164_int > var_183_int; // 0x6bd GT
	if(var_184_bool == 0) goto Label_1729; // 0x6be JumpB
	irand(var_166_int, var_164_int); // 0x6bf Func
	
Label_1729:
	var_185_int = 1; // 0x6c1 PushI
	var_186_int = var_166_int + var_185_int; // 0x6c2 Add
	var_187_int = var_163_string + var_186_int; // 0x6c3 Add
	GetProperty(var_187_int, var_167_string); // 0x6c4 ObjFunc
	var_188_bool = 0; var_189_string = ""; // 0x6c6 PushV
	var_189_string = var_167_string; // 0x6c7 Mov
	func_1771(var_188_bool, var_189_string); // 0x6c8 NEW_2
	var_156_bool = var_188_bool; // 0x6c9 Mov
	return 10; // 0x6cb Return
	
Label_1716:
	var_190_int = 1; // 0x6b4 PushI
	var_164_int = var_164_int + var_190_int; // 0x6b5 Add2
	goto Label_1706; // 0x6b6 Jump
}


func_1826(var_169_int)
{
	var_170_float = 0; var_171_float = 0; // 0x722 PushV
	GetGameTime(var_171_float); // 0x723 Func
	var_172_int = 1; // 0x725 PushI
	var_173_int = 0; // 0x726 PushV
	var_174_int = 24; // 0x727 PushI
	var_173_int = var_171_float / var_171_float; // 0x728 Div2
	var_169_int = var_172_int + var_173_int; // 0x729 Add2
...
func_1958()
{
	var_82_object = Obj(); var_83_object = Obj(); // 0x7a6 PushV
	var_84_int = 442; // 0x7a7 PushI
	var_85_int = 1; // 0x7a8 PushI
	var_86_int = 526467; // 0x7a9 PushI
	CreateDiaryEntry(var_83_object, var_84_int, var_85_int, var_86_int); // 0x7aa Func
	var_87_bool = 0; var_88_object = Obj(); var_89_int = 0; // 0x7ac PushV
	var_88_object = var_83_object; // 0x7ad Mov
	var_89_int = 438; // 0x7ae MovI
	func_1984(var_87_bool, var_88_object, var_89_int); // 0x7af NEW_2
...
{
	var_0_object = var_293_object; // 0x12a TMov
	var_1_object = var_292_object; // 0x12b TMov
	var_3_string = 0; // 0x12c TMovB
	var_298_int = 1; // 0x12d PushI
	if(var_298_int == 0) goto Label_345; // 0x12e JumpB
	var_299_string = ""; // 0x12f PushV
	var_299_string = "Neutral"; // 0x130 MovS
	func_375(var_293_object, var_299_string); // 0x131 NEW_2
	var_307_int = 526405; // 0x133 PushI
	SetMessage(var_307_int); // 0x134 TObjFunc
	ClearReplies(); // 0x136 TObjFunc
	var_308_bool = 0; var_309_object = Obj(); // 0x138 PushV
	var_309_object = var_1_object; // 0x139 MovT
	func_1908(var_309_object); // 0x13a NEW_2
	if(var_308_bool == 0) goto Label_322; // 0x13c JumpB
	var_316_int = 526406; // 0x13d PushI
	var_317_int = 27682; // 0x13e PushI
	var_318_int = 27681; // 0x13f PushI
	AddReply(var_316_int, var_317_int, var_318_int); // 0x140 TObjFunc
	
Label_322:
	var_319_bool = 0; var_320_object = Obj(); // 0x142 PushV
	var_320_object = var_1_object; // 0x143 MovT
	func_1920(var_320_object); // 0x144 NEW_2
	if(var_319_bool == 0) goto Label_332; // 0x146 JumpB
	var_325_int = 526420; // 0x147 PushI
	var_326_int = 27696; // 0x148 PushI
	var_327_int = 27695; // 0x149 PushI
	AddReply(var_325_int, var_326_int, var_327_int); // 0x14a TObjFunc
	
Label_332:
	var_328_int = 526411; // 0x14c PushI
	var_329_int = -1; // 0x14d PushI
	var_330_int = 27686; // 0x14e PushI
	AddReply(var_328_int, var_329_int, var_330_int); // 0x14f TObjFunc
	var_331_int = 529012; // 0x151 PushI
	var_332_int = -1; // 0x152 PushI
	var_333_int = 30452; // 0x153 PushI
	AddReply(var_331_int, var_332_int, var_333_int); // 0x154 TObjFunc
	goto Label_345; // 0x156 Jump
	
Label_345:
	var_334_bool = 0; // 0x159 PushV
	func_1873(var_334_bool); // 0x15a NEW_2
	if(var_334_bool == 0) goto Label_360; // 0x15c JumpB
	
Label_349:
	lshWaitForAnimEnd(); // 0x15d Func
	var_335_string = var_3_string; // 0x15f PushT
	if(var_335_string == 0) goto Label_354; // 0x160 JumpB
...
Label_354:
	var_336_string = ""; // 0x162 PushV
	var_336_string = var_2_object; // 0x163 MovT
	func_1740(var_336_string); // 0x164 NEW_2
	goto Label_349; // 0x166 Jump
	
Label_360:
	var_337_string = "all"; // 0x168 PushS
	var_338_string = "idle"; // 0x169 PushS
	PlayAnimation(var_337_string, var_338_string); // 0x16a Func
	
Label_364:
	WaitForAnimEnd(); // 0x16c Func
	var_339_string = var_3_string; // 0x16e PushT
	if(var_339_string == 0) goto Label_369; // 0x16f JumpB
	goto Label_374; // 0x170 Jump
	
Label_369:
	var_340_string = "all"; // 0x171 PushS
	var_341_string = "idle"; // 0x172 PushS
	PlayAnimation(var_340_string, var_341_string); // 0x173 Func
...
{
	var_267_int = 0; // 0x72c PushV
	func_1826(var_267_int); // 0x72d NEW_2
	var_265_bool = var_267_int == var_266_int; // 0x72f Eq2
...
func_1584()
{
	var_257_bool = 0; var_258_bool = 0; // 0x630 PushV
	var_259_bool = 1; // 0x631 PushB
	CameraSwitchToNormal(var_259_bool); // 0x632 Func
	var_260_bool = 0; // 0x634 PushV
	func_1873(var_260_bool); // 0x635 NEW_2
	if(var_260_bool == 0) goto Label_1593; // 0x637 JumpB
	goto Label_1601; // 0x638 Jump
	
Label_1601:
	return 2; // 0x641 Return
	
Label_1593:
	var_261_string = "head"; // 0x639 PushS
	HasAnimationTrack(var_258_bool, var_261_string); // 0x63a Func
	var_262_bool = var_258_bool; // 0x63c Push
	if(var_262_bool == 0) goto Label_1601; // 0x63d JumpB
	var_263_string = "head"; // 0x63e PushS
	UnlookAsync(var_263_string); // 0x63f Func
}


func_1841(var_46_string, var_47_int)
{
	var_48_string = ""; var_49_string = ""; // 0x731 PushV
	var_49_string = "idle"; // 0x732 MovS
	var_50_int = var_47_int; // 0x733 Push
	if(var_50_int == 0) goto Label_1846; // 0x734 JumpB
	var_49_string = var_49_string + var_47_int; // 0x735 Add2
	
Label_1846:
	var_46_string = var_49_string; // 0x736 Mov
...
{
	var_46_object = Obj(); var_47_object = Obj(); // 0x7b3 PushV
	GetDiaryRoot(var_47_object); // 0x7b4 Func
	var_48_bool = var_47_object == 0; // 0x7b6 Not
	if(var_48_bool == 0) goto Label_1981; // 0x7b7 JumpB
	var_49_string = "Can't retrieve diary root"; // 0x7b8 PushS
	Trace(var_49_string); // 0x7b9 Func
	var_45_object = 0; // 0x7bb MovB
	return 2; // 0x7bc Return
	
Label_1981:
	var_45_object = var_47_object; // 0x7bd Mov
...
{
	var_41_int = 0; var_42_bool = 0; var_43_int = 0; var_44_bool = 0; // 0x738 PushV
	var_43_int = 0; // 0x739 MovI
	
Label_1850:
	var_45_string = "all"; // 0x73a PushS
	var_46_string = ""; var_47_int = 0; // 0x73b PushV
	var_47_int = var_43_int; // 0x73c Mov
	func_1841(var_46_string, var_47_int); // 0x73d NEW_2
	HasAnimation(var_44_bool, var_45_string, var_46_string); // 0x73f Func
	var_51_bool = var_44_bool == 0; // 0x741 Not
	if(var_51_bool == 0) goto Label_1860; // 0x742 JumpB
	goto Label_1863; // 0x743 Jump
	
Label_1863:
	var_40_int = var_43_int; // 0x747 Mov
	return 4; // 0x748 Return
	
Label_1860:
	var_52_int = 1; // 0x744 PushI
	var_43_int = var_43_int + var_52_int; // 0x745 Add2
	goto Label_1850; // 0x746 Jump
}


func_1984(var_36_bool, var_37_object, var_38_int)
{
	var_39_object = Obj(); var_40_object = Obj(); var_41_int = 0; var_42_object = Obj(); var_43_object = Obj(); var_44_int = 0; // 0x7c0 PushV
	var_45_object = Obj(); // 0x7c1 PushV
	func_1971(var_45_object); // 0x7c2 NEW_2
	var_42_object = var_45_object; // 0x7c3 Mov
	Find(var_38_int, var_43_object); // 0x7c5 ObjFunc
	var_50_bool = var_43_object == 0; // 0x7c7 Not
	if(var_50_bool == 0) goto Label_1999; // 0x7c8 JumpB
	var_51_string = "Can't find diary parent with id: "; // 0x7c9 PushS
	var_52_int = var_51_string + var_38_int; // 0x7ca Add
	Trace(var_52_int); // 0x7cb Func
	var_36_bool = 0; // 0x7cd MovB
	return 6; // 0x7ce Return
	
Label_1999:
	AddChild(var_37_object); // 0x7cf ObjFunc
	var_53_int = 7; // 0x7d1 PushI
	SendWorldWndMessage(var_53_int); // 0x7d2 Func
	GetCategory(var_44_int); // 0x7d4 ObjFunc
	SetDiarySection(var_44_int); // 0x7d6 Func
...
{
	var_119_int = 0; var_120_int = 0; var_121_int = 0; var_122_int = 0; // 0x642 PushV
	var_123_string = "voice_common"; // 0x643 PushS
	GetVariable(var_123_string, var_121_int); // 0x644 Func
	var_124_int = var_121_int; // 0x646 Push
	if(var_124_int == 0) goto Label_1640; // 0x647 JumpB
	var_125_bool = 0; var_126_object = Obj(); // 0x648 PushV
	var_126_object = var_115_object; // 0x649 Mov
	func_1660(var_126_object); // 0x64a NEW_2
	var_155_bool = var_125_bool == 0; // 0x64c Not
	if(var_155_bool == 0) goto Label_1622; // 0x64d JumpB
	var_156_bool = 0; var_157_object = Obj(); // 0x64e PushV
	var_157_object = var_115_object; // 0x64f Mov
	func_1697(var_157_object); // 0x650 NEW_2
	var_191_bool = var_156_bool == 0; // 0x652 Not
	if(var_191_bool == 0) goto Label_1622; // 0x653 JumpB
	var_114_bool = 0; // 0x654 MovB
	return 4; // 0x655 Return
	
Label_1622:
	var_192_int = 2; // 0x656 PushI
	irand(var_122_int, var_192_int); // 0x657 Func
	var_193_int = var_122_int; // 0x659 Push
	if(var_193_int == 0) goto Label_1635; // 0x65a JumpB
	var_194_string = "voice_common"; // 0x65b PushS
	var_195_int = 1; // 0x65c PushI
	var_196_int = var_121_int + var_195_int; // 0x65d Add
	var_197_int = 3; // 0x65e PushI
	var_198_int = var_196_int / var_197_int; // 0x65f Mod
	SetVariable(var_194_string, var_198_int); // 0x660 Func
	goto Label_1639; // 0x662 Jump
	
Label_1639:
	goto Label_1658; // 0x667 Jump
	
Label_1658:
	var_114_bool = 1; // 0x67a MovB
	return 4; // 0x67b Return
	
Label_1635:
	var_199_string = "voice_common"; // 0x663 PushS
	var_200_int = 0; // 0x664 PushI
	SetVariable(var_199_string, var_200_int); // 0x665 Func
	
Label_1640:
	var_201_bool = 0; var_202_object = Obj(); // 0x668 PushV
	var_202_object = var_115_object; // 0x669 Mov
	func_1697(var_202_object); // 0x66a NEW_2
	var_203_bool = var_201_bool == 0; // 0x66c Not
	if(var_203_bool == 0) goto Label_1654; // 0x66d JumpB
	var_204_bool = 0; var_205_object = Obj(); // 0x66e PushV
	var_205_object = var_115_object; // 0x66f Mov
	func_1660(var_205_object); // 0x670 NEW_2
	var_206_bool = var_204_bool == 0; // 0x672 Not
	if(var_206_bool == 0) goto Label_1654; // 0x673 JumpB
	var_114_bool = 0; // 0x674 MovB
	return 4; // 0x675 Return
	
Label_1654:
	var_207_string = "voice_common"; // 0x676 PushS
	var_208_int = 1; // 0x677 PushI
	SetVariable(var_207_string, var_208_int); // 0x678 Func
}
...
{
	var_240_bool = 0; var_241_float = 0; var_242_float = 0; var_243_bool = 0; var_244_float = 0; var_245_float = 0; // 0x6cc PushV
	lshHasAnimation(var_243_bool, var_239_string); // 0x6cd Func
	var_246_bool = var_243_bool; // 0x6cf Push
	if(var_246_bool == 0) goto Label_1751; // 0x6d0 JumpB
	lshGetAnimTimes(var_239_string, var_244_float, var_245_float); // 0x6d1 Func
	var_247_bool = 0; // 0x6d3 PushB
	lshPlayAnimation(var_244_float, var_245_float, var_247_bool); // 0x6d4 Func
...
Label_1751:
	var_248_string = "Can't find lsh animation : "; // 0x6d7 PushS
	var_249_int = var_248_string + var_239_string; // 0x6d8 Add
	Trace(var_249_int); // 0x6d9 Func
}


func_1869(var_103_string)
{
	var_103_string = "ui/NPC_Mat.png"; // 0x74d MovS
...
{
	var_0_object = var_371_object; // 0x34c TMov
	var_1_object = var_370_object; // 0x34d TMov
	var_3_string = 0; // 0x34e TMovB
	var_376_int = 1; // 0x34f PushI
	if(var_376_int == 0) goto Label_876; // 0x350 JumpB
	var_377_string = ""; // 0x351 PushV
	var_377_string = "Neutral"; // 0x352 MovS
	func_906(var_371_object, var_377_string); // 0x353 NEW_2
	var_385_int = 535284; // 0x355 PushI
	SetMessage(var_385_int); // 0x356 TObjFunc
	ClearReplies(); // 0x358 TObjFunc
	var_386_int = 535285; // 0x35a PushI
	var_387_int = 36962; // 0x35b PushI
	var_388_int = 36961; // 0x35c PushI
	AddReply(var_386_int, var_387_int, var_388_int); // 0x35d TObjFunc
	var_389_int = 535292; // 0x35f PushI
	var_390_int = -1; // 0x360 PushI
	var_391_int = 36968; // 0x361 PushI
	AddReply(var_389_int, var_390_int, var_391_int); // 0x362 TObjFunc
	var_392_int = 535293; // 0x364 PushI
	var_393_int = -1; // 0x365 PushI
	var_394_int = 36969; // 0x366 PushI
	AddReply(var_392_int, var_393_int, var_394_int); // 0x367 TObjFunc
	goto Label_876; // 0x369 Jump
	
Label_876:
	var_395_bool = 0; // 0x36c PushV
	func_1873(var_395_bool); // 0x36d NEW_2
	if(var_395_bool == 0) goto Label_891; // 0x36f JumpB
	
Label_880:
	lshWaitForAnimEnd(); // 0x370 Func
	var_396_string = var_3_string; // 0x372 PushT
	if(var_396_string == 0) goto Label_885; // 0x373 JumpB
...
Label_885:
	var_397_string = ""; // 0x375 PushV
	var_397_string = var_2_object; // 0x376 MovT
	func_1740(var_397_string); // 0x377 NEW_2
	goto Label_880; // 0x379 Jump
	
Label_891:
	var_398_string = "all"; // 0x37b PushS
	var_399_string = "idle"; // 0x37c PushS
	PlayAnimation(var_398_string, var_399_string); // 0x37d Func
	
Label_895:
	WaitForAnimEnd(); // 0x37f Func
	var_400_string = var_3_string; // 0x381 PushT
	if(var_400_string == 0) goto Label_900; // 0x382 JumpB
	goto Label_905; // 0x383 Jump
	
Label_900:
	var_401_string = "all"; // 0x384 PushS
	var_402_string = "idle"; // 0x385 PushS
	PlayAnimation(var_401_string, var_402_string); // 0x386 Func
...
{
	var_104_string = "ui/NPC_Mat_b.png"; // 0x74f MovS
...
{
	var_0_object = var_430_object; // 0x44f TMov
	var_1_object = var_429_object; // 0x450 TMov
	var_3_string = 0; // 0x451 TMovB
	var_435_int = 1; // 0x452 PushI
	if(var_435_int == 0) goto Label_1130; // 0x453 JumpB
	var_436_string = ""; // 0x454 PushV
	var_436_string = "Neutral"; // 0x455 MovS
	func_1160(var_430_object, var_436_string); // 0x456 NEW_2
	var_444_int = 540539; // 0x458 PushI
	SetMessage(var_444_int); // 0x459 TObjFunc
	ClearReplies(); // 0x45b TObjFunc
	var_445_int = 540540; // 0x45d PushI
	var_446_int = -1; // 0x45e PushI
	var_447_int = 42549; // 0x45f PushI
	AddReply(var_445_int, var_446_int, var_447_int); // 0x460 TObjFunc
	var_448_int = 540799; // 0x462 PushI
	var_449_int = -1; // 0x463 PushI
	var_450_int = 42848; // 0x464 PushI
	AddReply(var_448_int, var_449_int, var_450_int); // 0x465 TObjFunc
	goto Label_1130; // 0x467 Jump
	
Label_1130:
	var_451_bool = 0; // 0x46a PushV
	func_1873(var_451_bool); // 0x46b NEW_2
	if(var_451_bool == 0) goto Label_1145; // 0x46d JumpB
	
Label_1134:
	lshWaitForAnimEnd(); // 0x46e Func
	var_452_string = var_3_string; // 0x470 PushT
	if(var_452_string == 0) goto Label_1139; // 0x471 JumpB
...
Label_1139:
	var_453_string = ""; // 0x473 PushV
	var_453_string = var_2_object; // 0x474 MovT
	func_1740(var_453_string); // 0x475 NEW_2
	goto Label_1134; // 0x477 Jump
	
Label_1145:
	var_454_string = "all"; // 0x479 PushS
	var_455_string = "idle"; // 0x47a PushS
	PlayAnimation(var_454_string, var_455_string); // 0x47b Func
	
Label_1149:
	WaitForAnimEnd(); // 0x47d Func
	var_456_string = var_3_string; // 0x47f PushT
	if(var_456_string == 0) goto Label_1154; // 0x480 JumpB
	goto Label_1159; // 0x481 Jump
	
Label_1154:
	var_457_string = "all"; // 0x482 PushS
	var_458_string = "idle"; // 0x483 PushS
	PlayAnimation(var_457_string, var_458_string); // 0x484 Func
...
func_81(var_0_object, var_1_object, var_2_object, var_3_string, var_209_object, var_210_object)
{
	...
	if(var_215_int == 0) goto Label_104; // 0x56 JumpB
	var_216_string = ""; // 0x57 PushV
	var_216_string = "Neutral"; // 0x58 MovS
	func_134(var_210_object, var_216_string); // 0x59 NEW_2
	var_233_int = 525507; // 0x5b PushI
	SetMessage(var_233_int); // 0x5c TObjFunc
	ClearReplies(); // 0x5e TObjFunc
	var_234_int = 525508; // 0x60 PushI
	var_235_int = 30772; // 0x61 PushI
	var_236_int = 26864; // 0x62 PushI
	AddReply(var_234_int, var_235_int, var_236_int); // 0x63 TObjFunc
	goto Label_104; // 0x65 Jump
	
Label_104:
	var_237_bool = 0; // 0x68 PushV
	func_1873(var_237_bool); // 0x69 NEW_2
	if(var_237_bool == 0) goto Label_119; // 0x6b JumpB
	
Label_108:
	lshWaitForAnimEnd(); // 0x6c Func
	var_238_string = var_3_string; // 0x6e PushT
	if(var_238_string == 0) goto Label_113; // 0x6f JumpB
...
Label_113:
	var_239_string = ""; // 0x71 PushV
	var_239_string = var_2_object; // 0x72 MovT
	func_1740(var_239_string); // 0x73 NEW_2
	goto Label_108; // 0x75 Jump
	
Label_119:
	var_250_string = "all"; // 0x77 PushS
	var_251_string = "idle"; // 0x78 PushS
	PlayAnimation(var_250_string, var_251_string); // 0x79 Func
	
Label_123:
	WaitForAnimEnd(); // 0x7b Func
	var_252_string = var_3_string; // 0x7d PushT
	if(var_252_string == 0) goto Label_128; // 0x7e JumpB
	goto Label_133; // 0x7f Jump
	
Label_128:
	var_253_string = "all"; // 0x80 PushS
	var_254_string = "idle"; // 0x81 PushS
	PlayAnimation(var_253_string, var_254_string); // 0x82 Func
...
func_1875()
{
	var_29_string = "k8q01"; // 0x754 PushS
	var_30_int = 2; // 0x755 PushI
	SetVariable(var_29_string, var_30_int); // 0x756 Func
	func_1945(); // 0x759 NEW_2
...
{
	var_271_object = Obj(); var_272_bool = 0; var_273_int = 0; var_274_bool = 0; var_275_object = Obj(); var_276_bool = 0; var_277_int = 0; var_278_bool = 0; // 0xd8 PushV
	var_0_object = var_269_object; // 0xd9 TMov
	var_279_bool = 0; var_280_object = Obj(); var_281_float = 0; // 0xda PushV
	var_280_object = var_269_object; // 0xdb Mov
	var_281_float = 70.0; // 0xdc MovF
	func_1515(var_280_object, var_281_float); // 0xdd NEW_2
	var_282_bool = var_279_bool == 0; // 0xdf Not
	if(var_282_bool == 0) goto Label_227; // 0xe0 JumpB
	var_268_int = -2; // 0xe1 MovI
	return 8; // 0xe2 Return
	
Label_227:
	CreateDialog(var_275_object); // 0xe3 Func
	var_283_int = 0; // 0xe5 PushV
	func_1867(var_283_int); // 0xe6 NEW_2
	SetNPCName(var_283_int); // 0xe8 ObjFunc
	var_284_int = 0; // 0xea PushV
	func_1865(var_284_int); // 0xeb NEW_2
	SetNPCDescription(var_284_int); // 0xed ObjFunc
	var_285_string = ""; // 0xef PushV
	func_1869(var_285_string); // 0xf0 NEW_2
	SetPhoto(var_285_string); // 0xf2 ObjFunc
	var_286_string = ""; // 0xf4 PushV
	func_1871(var_286_string); // 0xf5 NEW_2
	SetPhoto2(var_286_string); // 0xf7 ObjFunc
	var_287_int = 0; // 0xf9 PushV
	func_2012(var_287_int); // 0xfa NEW_2
	SetPlayerName(var_287_int); // 0xfc ObjFunc
	var_277_int = -1; // 0xfe MovI
	IsOverrideActive(var_276_bool); // 0xff Func
	var_288_bool = var_276_bool; // 0x101 Push
	if(var_288_bool == 0) goto Label_261; // 0x102 JumpB
	var_268_int = -2; // 0x103 MovI
	return 8; // 0x104 Return
	
Label_261:
	DoDialog(var_275_object); // 0x105 Func
	var_289_bool = 0; var_290_object = Obj(); // 0x107 PushV
	var_291_object = Obj(); // 0x108 PushV
	func_1793(var_291_object); // 0x109 NEW_2
	var_290_object = var_291_object; // 0x10a Mov
	func_1602(var_289_bool, var_290_object); // 0x10c NEW_2
	var_292_object = Obj(); var_293_object = Obj(); // 0x10e PushV
	var_292_object = var_269_object; // 0x10f Mov
	var_293_object = var_275_object; // 0x110 Mov
	TaskCall(3); // 0x111 TaskCall
	func_297(var_294_object, var_295_object, var_296_string, var_297_bool, var_292_object, var_293_object); // 0x112 NEW_2
	TaskReturn(); // 0x113 TaskReturn
	IsDialogEnd(var_278_bool); // 0x115 ObjFunc
	
Label_279:
	var_342_bool = var_278_bool == 0; // 0x117 Not
	if(var_342_bool == 0) goto Label_286; // 0x118 JumpB
	sync(); // 0x119 Func
	IsDialogEnd(var_278_bool); // 0x11b ObjFunc
	goto Label_279; // 0x11d Jump
	
Label_286:
	var_343_object = Obj(); // 0x11e PushV
	var_343_object = var_269_object; // 0x11f Mov
	func_1584(); // 0x120 NEW_2
	StopDialog(var_275_object); // 0x122 Func
	GetReturnValue(var_277_int); // 0x124 ObjFunc
	var_268_int = var_277_int; // 0x126 Mov
...
{
	var_224_bool = 0; var_225_float = 0; var_226_float = 0; var_227_bool = 0; var_228_float = 0; var_229_float = 0; // 0x6dc PushV
	lshHasAnimation(var_227_bool, var_220_string); // 0x6dd Func
	var_230_bool = var_227_bool; // 0x6df Push
	if(var_230_bool == 0) goto Label_1766; // 0x6e0 JumpB
	lshGetAnimTimes(var_220_string, var_228_float, var_229_float); // 0x6e1 Func
	lshPlayAnimation(var_228_float, var_229_float, var_221_bool); // 0x6e3 Func
...
Label_1766:
	var_231_string = "Can't find lsh animation : "; // 0x6e6 PushS
	var_232_int = var_231_string + var_220_string; // 0x6e7 Add
	Trace(var_232_int); // 0x6e8 Func
}


func_2012(var_105_int)
{
	var_106_int = 0; var_107_int = 0; // 0x7dc PushV
	var_108_string = "branch"; // 0x7dd PushS
	GetVariable(var_108_string, var_107_int); // 0x7de Func
	var_109_int = 0; // 0x7e0 PushI
	var_110_bool = var_107_int == var_109_int; // 0x7e1 Eq
	if(var_110_bool == 0) goto Label_2022; // 0x7e2 JumpB
	var_105_int = 1; // 0x7e3 MovI
	return 2; // 0x7e4 Return
	
Label_2022:
	var_111_int = 1; // 0x7e6 PushI
	var_112_bool = var_107_int == var_111_int; // 0x7e7 Eq
	if(var_112_bool == 0) goto Label_2027; // 0x7e8 JumpB
	var_105_int = 2; // 0x7e9 MovI
	return 2; // 0x7ea Return
	
Label_2027:
	var_105_int = 3; // 0x7eb MovI
...
func_1884()
{
	var_80_string = "k8q01"; // 0x75d PushS
	var_81_int = 4; // 0x75e PushI
	SetVariable(var_80_string, var_81_int); // 0x75f Func
	func_1958(); // 0x762 NEW_2
	var_90_bool = 0; var_91_string = ""; var_92_string = ""; // 0x764 PushV
	var_91_string = "quest_k8_01"; // 0x765 MovS
	var_92_string = "unlock_boiny"; // 0x766 MovS
	func_1814(var_90_bool, var_91_string, var_92_string); // 0x767 NEW_2
...
func_1898()
{
	func_1932(); // 0x76c NEW_2
	var_66_bool = 0; var_67_string = ""; var_68_string = ""; // 0x76e PushV
	var_67_string = "quest_k8_01"; // 0x76f MovS
	var_68_string = "fail"; // 0x770 MovS
	func_1814(var_66_bool, var_67_string, var_68_string); // 0x771 NEW_2
...
func_1515(var_53_bool, var_55_float)
{
	...
	func_1799(var_80_cvector, var_81_cvector); // 0x606 NEW_2
...
Label_1556:
	...
	var_93_bool = 1; // 0x616 PushB
	CameraTransit(var_71_cvector, var_69_cvector, var_93_bool); // 0x617 Func
	var_94_float = GetByIndex(var_70_cvector, 0); // 0x619 PushE
	var_95_float = GetByIndex(var_70_cvector, 2); // 0x61a PushE
	Rotate(var_94_float, var_95_float); // 0x61b Func
	var_96_bool = 0; // 0x61d PushV
	func_1873(var_96_bool); // 0x61e NEW_2
	if(var_96_bool == 0) goto Label_1570; // 0x620 JumpB
	goto Label_1578; // 0x621 Jump
	
Label_1578:
	CameraWaitForPlayFinish(); // 0x62a Func
	ResumeWorld(); // 0x62c Func
	var_53_bool = 1; // 0x62e MovB
	return 18; // 0x62f Return
	
Label_1570:
	var_97_string = "head"; // 0x622 PushS
	HasAnimationTrack(var_73_bool, var_97_string); // 0x623 Func
	var_98_bool = var_73_bool; // 0x625 Push
	if(var_98_bool == 0) goto Label_1578; // 0x626 JumpB
	var_99_string = "head"; // 0x627 PushS
	LookAsyncCamera(var_99_string); // 0x628 Func
}
...
{
	var_40_bool = GlobalVars[1]; // 0x7ee PushGE
	var_41_bool = var_40_bool == 0; // 0x7ef Not
	if(var_41_bool == 0) goto Label_2042; // 0x7f0 JumpB
	var_42_int = 0; var_43_object = Obj(); // 0x7f1 PushV
	var_43_object = var_39_object; // 0x7f2 Mov
	TaskCall(0); // 0x7f3 TaskCall
	func_0(var_44_object, var_42_int, var_43_object); // 0x7f4 NEW_2
	TaskReturn(); // 0x7f5 TaskReturn
	var_264_bool = GlobalVars[1]; // 0x7f7 PushGE
	var_264_bool = 1; // 0x7f8 MovB
	GlobalVars[1] = var_264_bool; // 0x7f9 PopGE
	
Label_2042:
	var_265_bool = 0; var_266_int = 0; // 0x7fa PushV
	var_266_int = 8; // 0x7fb MovI
	func_1835(var_265_bool, var_266_int); // 0x7fc NEW_2
	if(var_265_bool == 0) goto Label_2054; // 0x7fe JumpB
	var_268_int = 0; var_269_object = Obj(); // 0x7ff PushV
	var_269_object = var_39_object; // 0x800 Mov
	TaskCall(2); // 0x801 TaskCall
	func_216(var_270_object, var_268_int, var_269_object); // 0x802 NEW_2
	TaskReturn(); // 0x803 TaskReturn
	return 0; // 0x805 Return
	
Label_2054:
	var_344_bool = 0; var_345_int = 0; // 0x806 PushV
	var_345_int = 12; // 0x807 MovI
	func_1835(var_344_bool, var_345_int); // 0x808 NEW_2
	if(var_344_bool == 0) goto Label_2066; // 0x80a JumpB
	var_346_int = 0; var_347_object = Obj(); // 0x80b PushV
	var_347_object = var_39_object; // 0x80c Mov
	TaskCall(4); // 0x80d TaskCall
	func_762(var_348_object, var_346_int, var_347_object); // 0x80e NEW_2
	TaskReturn(); // 0x80f TaskReturn
	return 0; // 0x811 Return
	
Label_2066:
	var_405_int = 0; var_406_object = Obj(); // 0x812 PushV
	var_406_object = var_39_object; // 0x813 Mov
	TaskCall(6); // 0x814 TaskCall
	func_1021(var_407_object, var_405_int, var_406_object); // 0x815 NEW_2
	TaskReturn(); // 0x816 TaskReturn
...
{
	var_150_bool = 0; var_151_bool = 0; // 0x6eb PushV
	var_152_bool = 0; // 0x6ec PushV
	func_1873(var_152_bool); // 0x6ed NEW_2
	if(var_152_bool == 0) goto Label_1784; // 0x6ef JumpB
	lshHasSpeech(var_151_bool, var_149_string); // 0x6f0 Func
	var_153_bool = var_151_bool; // 0x6f2 Push
	if(var_153_bool == 0) goto Label_1784; // 0x6f3 JumpB
	lshPlaySpeech(var_149_string); // 0x6f4 Func
	var_148_bool = 1; // 0x6f6 MovB
	return 2; // 0x6f7 Return
	
Label_1784:
	var_148_bool = 0; // 0x6f8 MovB
	return 2; // 0x6f9 Return
}
...
{
	var_310_int = 0; var_311_string = ""; // 0x775 PushV
	var_311_string = "k8q01"; // 0x776 MovS
	func_1809(var_310_int, var_311_string); // 0x777 NEW_2
	var_314_int = 1; // 0x779 PushI
	var_315_bool = var_310_int == var_314_int; // 0x77a Eq
	if(var_315_bool == 0) goto Label_1918; // 0x77b JumpB
	var_308_bool = 1; // 0x77c MovB
	return 0; // 0x77d Return
	
Label_1918:
	var_308_bool = 0; // 0x77e MovB
...
{
	var_300_bool = 0; // 0x178 PushV
	func_1873(var_300_bool); // 0x179 NEW_2
	var_301_bool = var_300_bool == 0; // 0x17b Not
	if(var_301_bool == 0) goto Label_382; // 0x17c JumpB
	return 0; // 0x17d Return
	
Label_382:
	var_302_bool = var_299_string == var_2_object; // 0x17e Eq
	if(var_302_bool == 0) goto Label_385; // 0x17f JumpB
	return 0; // 0x180 Return
	
Label_385:
	var_303_string = ""; var_304_bool = 0; // 0x181 PushV
	var_303_string = var_299_string; // 0x182 Mov
	var_305_string = ""; // 0x183 PushS
	var_306_bool = var_299_string == var_305_string; // 0x184 Eq
	if(var_306_bool == 0) goto Label_392; // 0x185 JumpB
	var_304_bool = 0; // 0x186 MovB
	goto Label_393; // 0x187 Jump
	
Label_393:
	func_1756(var_303_string, var_304_bool); // 0x189 NEW_2
	var_2_object = var_299_string; // 0x18b TMov
	return 0; // 0x18c Return
	
Label_392:
	var_304_bool = 1; // 0x188 MovB
}


func_762(var_0_object, var_346_int, var_347_object)
{
	var_349_object = Obj(); var_350_bool = 0; var_351_int = 0; var_352_bool = 0; var_353_object = Obj(); var_354_bool = 0; var_355_int = 0; var_356_bool = 0; // 0x2fa PushV
	var_0_object = var_347_object; // 0x2fb TMov
	var_357_bool = 0; var_358_object = Obj(); var_359_float = 0; // 0x2fc PushV
	var_358_object = var_347_object; // 0x2fd Mov
	var_359_float = 70.0; // 0x2fe MovF
	func_1515(var_358_object, var_359_float); // 0x2ff NEW_2
	var_360_bool = var_357_bool == 0; // 0x301 Not
	if(var_360_bool == 0) goto Label_773; // 0x302 JumpB
	var_346_int = -2; // 0x303 MovI
	return 8; // 0x304 Return
	
Label_773:
	CreateDialog(var_353_object); // 0x305 Func
	var_361_int = 0; // 0x307 PushV
	func_1867(var_361_int); // 0x308 NEW_2
	SetNPCName(var_361_int); // 0x30a ObjFunc
	var_362_int = 0; // 0x30c PushV
	func_1865(var_362_int); // 0x30d NEW_2
	SetNPCDescription(var_362_int); // 0x30f ObjFunc
	var_363_string = ""; // 0x311 PushV
	func_1869(var_363_string); // 0x312 NEW_2
	SetPhoto(var_363_string); // 0x314 ObjFunc
	var_364_string = ""; // 0x316 PushV
	func_1871(var_364_string); // 0x317 NEW_2
	SetPhoto2(var_364_string); // 0x319 ObjFunc
	var_365_int = 0; // 0x31b PushV
	func_2012(var_365_int); // 0x31c NEW_2
	SetPlayerName(var_365_int); // 0x31e ObjFunc
	var_355_int = -1; // 0x320 MovI
	IsOverrideActive(var_354_bool); // 0x321 Func
	var_366_bool = var_354_bool; // 0x323 Push
	if(var_366_bool == 0) goto Label_807; // 0x324 JumpB
	var_346_int = -2; // 0x325 MovI
	return 8; // 0x326 Return
	
Label_807:
	DoDialog(var_353_object); // 0x327 Func
	var_367_bool = 0; var_368_object = Obj(); // 0x329 PushV
	var_369_object = Obj(); // 0x32a PushV
	func_1793(var_369_object); // 0x32b NEW_2
	var_368_object = var_369_object; // 0x32c Mov
	func_1602(var_367_bool, var_368_object); // 0x32e NEW_2
	var_370_object = Obj(); var_371_object = Obj(); // 0x330 PushV
	var_370_object = var_347_object; // 0x331 Mov
	var_371_object = var_353_object; // 0x332 Mov
	TaskCall(5); // 0x333 TaskCall
	func_843(var_372_object, var_373_object, var_374_string, var_375_bool, var_370_object, var_371_object); // 0x334 NEW_2
	TaskReturn(); // 0x335 TaskReturn
	IsDialogEnd(var_356_bool); // 0x337 ObjFunc
	
Label_825:
	var_403_bool = var_356_bool == 0; // 0x339 Not
	if(var_403_bool == 0) goto Label_832; // 0x33a JumpB
	sync(); // 0x33b Func
	IsDialogEnd(var_356_bool); // 0x33d ObjFunc
	goto Label_825; // 0x33f Jump
	
Label_832:
	var_404_object = Obj(); // 0x340 PushV
	var_404_object = var_347_object; // 0x341 Mov
	func_1584(); // 0x342 NEW_2
	StopDialog(var_353_object); // 0x344 Func
	GetReturnValue(var_355_int); // 0x346 ObjFunc
	var_346_int = var_355_int; // 0x348 Mov
	return 8; // 0x349 Return
}


func_1660(var_125_bool)
{
	var_127_string = ""; var_128_int = 0; var_129_bool = 0; var_130_int = 0; var_131_string = ""; var_132_string = ""; var_133_int = 0; var_134_bool = 0; var_135_int = 0; var_136_string = ""; // 0x67c PushV
	var_132_string = "c"; // 0x67d MovS
	var_133_int = 0; // 0x67e MovI
	
Label_1663:
	var_137_int = 1; // 0x67f PushI
	if(var_137_int == 0) goto Label_1676; // 0x680 JumpB
	var_138_int = 1; // 0x681 PushI
	var_139_int = var_133_int + var_138_int; // 0x682 Add
	var_140_int = var_132_string + var_139_int; // 0x683 Add
	HasProperty(var_140_int, var_134_bool); // 0x684 ObjFunc
	var_141_bool = var_134_bool == 0; // 0x686 Not
	if(var_141_bool == 0) goto Label_1673; // 0x687 JumpB
	goto Label_1676; // 0x688 Jump
	
Label_1676:
	var_142_bool = var_133_int == 0; // 0x68c Not
	if(var_142_bool == 0) goto Label_1680; // 0x68d JumpB
	var_125_bool = 0; // 0x68e MovB
	return 10; // 0x68f Return
	
Label_1680:
	var_135_int = 0; // 0x690 MovI
	var_143_int = 1; // 0x691 PushI
	var_144_bool = var_133_int > var_143_int; // 0x692 GT
	if(var_144_bool == 0) goto Label_1686; // 0x693 JumpB
	irand(var_135_int, var_133_int); // 0x694 Func
	
Label_1686:
	var_145_int = 1; // 0x696 PushI
	var_146_int = var_135_int + var_145_int; // 0x697 Add
	var_147_int = var_132_string + var_146_int; // 0x698 Add
	GetProperty(var_147_int, var_136_string); // 0x699 ObjFunc
	var_148_bool = 0; var_149_string = ""; // 0x69b PushV
	var_149_string = var_136_string; // 0x69c Mov
	func_1771(var_148_bool, var_149_string); // 0x69d NEW_2
	var_125_bool = var_148_bool; // 0x69e Mov
	return 10; // 0x6a0 Return
	
Label_1673:
	var_154_int = 1; // 0x689 PushI
	var_133_int = var_133_int + var_154_int; // 0x68a Add2
	goto Label_1663; // 0x68b Jump
}


func_1021(var_0_object, var_405_int, var_406_object)
{
	var_408_object = Obj(); var_409_bool = 0; var_410_int = 0; var_411_bool = 0; var_412_object = Obj(); var_413_bool = 0; var_414_int = 0; var_415_bool = 0; // 0x3fd PushV
	var_0_object = var_406_object; // 0x3fe TMov
	var_416_bool = 0; var_417_object = Obj(); var_418_float = 0; // 0x3ff PushV
	var_417_object = var_406_object; // 0x400 Mov
	var_418_float = 70.0; // 0x401 MovF
	func_1515(var_417_object, var_418_float); // 0x402 NEW_2
	var_419_bool = var_416_bool == 0; // 0x404 Not
	if(var_419_bool == 0) goto Label_1032; // 0x405 JumpB
	var_405_int = -2; // 0x406 MovI
	return 8; // 0x407 Return
	
Label_1032:
	CreateDialog(var_412_object); // 0x408 Func
	var_420_int = 0; // 0x40a PushV
	func_1867(var_420_int); // 0x40b NEW_2
	SetNPCName(var_420_int); // 0x40d ObjFunc
	var_421_int = 0; // 0x40f PushV
	func_1865(var_421_int); // 0x410 NEW_2
	SetNPCDescription(var_421_int); // 0x412 ObjFunc
	var_422_string = ""; // 0x414 PushV
	func_1869(var_422_string); // 0x415 NEW_2
	SetPhoto(var_422_string); // 0x417 ObjFunc
	var_423_string = ""; // 0x419 PushV
	func_1871(var_423_string); // 0x41a NEW_2
	SetPhoto2(var_423_string); // 0x41c ObjFunc
	var_424_int = 0; // 0x41e PushV
	func_2012(var_424_int); // 0x41f NEW_2
	SetPlayerName(var_424_int); // 0x421 ObjFunc
	var_414_int = -1; // 0x423 MovI
	IsOverrideActive(var_413_bool); // 0x424 Func
	var_425_bool = var_413_bool; // 0x426 Push
	if(var_425_bool == 0) goto Label_1066; // 0x427 JumpB
	var_405_int = -2; // 0x428 MovI
	return 8; // 0x429 Return
	
Label_1066:
	DoDialog(var_412_object); // 0x42a Func
	var_426_bool = 0; var_427_object = Obj(); // 0x42c PushV
	var_428_object = Obj(); // 0x42d PushV
	func_1793(var_428_object); // 0x42e NEW_2
	var_427_object = var_428_object; // 0x42f Mov
	func_1602(var_426_bool, var_427_object); // 0x431 NEW_2
	var_429_object = Obj(); var_430_object = Obj(); // 0x433 PushV
	var_429_object = var_406_object; // 0x434 Mov
	var_430_object = var_412_object; // 0x435 Mov
	TaskCall(7); // 0x436 TaskCall
	func_1102(var_431_object, var_432_object, var_433_string, var_434_bool, var_429_object, var_430_object); // 0x437 NEW_2
	TaskReturn(); // 0x438 TaskReturn
	IsDialogEnd(var_415_bool); // 0x43a ObjFunc
	
Label_1084:
	var_459_bool = var_415_bool == 0; // 0x43c Not
	if(var_459_bool == 0) goto Label_1091; // 0x43d JumpB
	sync(); // 0x43e Func
	IsDialogEnd(var_415_bool); // 0x440 ObjFunc
	goto Label_1084; // 0x442 Jump
	
Label_1091:
	var_460_object = Obj(); // 0x443 PushV
	var_460_object = var_406_object; // 0x444 Mov
	func_1584(); // 0x445 NEW_2
	StopDialog(var_412_object); // 0x447 Func
	GetReturnValue(var_414_int); // 0x449 ObjFunc
	var_405_int = var_414_int; // 0x44b Mov
...
Label_1416:
	...
	func_1848(var_40_int); // 0x589 NEW_2
...
Label_1450:
	...
	func_1841(var_67_string, var_68_int); // 0x5ad NEW_2
