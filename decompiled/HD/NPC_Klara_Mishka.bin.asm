...
0x46c: @@ HasProperty(Stack[-1], Stack[-4])
0x46d: Pop(1)
...
0x497: @@ HasProperty(Stack[-1], Stack[-4])
0x498: Pop(1)
...
0x4bf: Push("Can't find lsh animation : ")
...
0x524: Stack[-1] = "ui/NPC_Mishka.png"
0x525: Return(); Pop(0)

0x526: Stack[-1] = "ui/NPC_Mishka_b.png"
0x527: Return(); Pop(0)
