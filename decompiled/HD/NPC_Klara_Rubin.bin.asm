...
0x9f5: @@ HasProperty(Stack[-1], Stack[-4])
0x9f6: Pop(1)
...
0xa0a: @@ GetProperty(Stack[-1], Stack[-2])
0xa0b: Pop(1)
0xa0c: PushEmpty(bool, string)
0xa0d: Stack[-1] = Stack[-3]
0xa0e: Call2 0xa5c

0xa0f: Stack[-14] = Stack[-2]
0xa10: Pop(2)
0xa11: Return(); Pop(10)
...
0xa20: @@ HasProperty(Stack[-1], Stack[-4])
0xa21: Pop(1)
...
0xa35: @@ GetProperty(Stack[-1], Stack[-2])
0xa36: Pop(1)
0xa37: PushEmpty(bool, string)
0xa38: Stack[-1] = Stack[-3]
0xa39: Call2 0xa5c

0xa3a: Stack[-14] = Stack[-2]
0xa3b: Pop(2)
0xa3c: Return(); Pop(10)
...
0xa48: Push("Can't find lsh animation : ")
...
0xa57: Push("Can't find lsh animation : ")
...
0xa94: @@ GetItemID(Stack[-3])
0xa95: Pop(0)
0xa96: Push("Category")
0xa97: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xa98: Pop(1)
0xa99: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0xa9a: Pop(0)
0xa9b: Pop(0); Push((bool) Stack[-1] == 0)
0xa9c: IF (Stack[-1] == 0) GOTO 0xaa0; Pop(1)

0xa9d: @@ DropItems(Stack[-8], Stack[-7])
0xa9e: Pop(0)
0xa9f: GOTO 0xaa5

0xaa0: PushEmpty(int, int)
0xaa1: Stack[-2] = Stack[-5]
0xaa2: Stack[-1] = Stack[-9]
0xaa3: Call2 0xa87
...
0xaa8: Pop(0)
0xaa9: @@ SetItemName(Stack[-4])
0xaaa: Pop(0)
0xaab: PushEmpty(object, object, int)
0xaac: Stack[-3] = Stack[-8]
0xaad: Stack[-2] = Stack[-4]
0xaae: Stack[-1] = Stack[-6]
0xaaf: Call2 0xa93
...
0xae3: Stack[-1] = "ui/NPC_Rubin.png"
0xae4: Return(); Pop(0)

0xae5: Stack[-1] = "ui/NPC_Rubin_b.png"
0xae6: Return(); Pop(0)
...
0xaf9: Stack[-2] = Stack[-1]
0xafa: Pop(1)
0xafb: Push("k5q01RubinGotoGeorg")
0xafc: Push("pt_map_georg")
0xafd: Push((int) 1)
...
0xb01: Pop(0)
0xb02: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb03: Pop(5)
0xb04: PushEmpty()
0xb05: Call2 0xc37
...
0xb13: Push("tvirin")
0xb14: Push((int) 3)
0xb15: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1])
0xb16: Pop(2)
0xb17: Push("fresh_meat")
0xb18: Push((int) 3)
0xb19: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1])
0xb1a: Pop(2)
0xb1b: Return(); Pop(2)

0xb1c: PushEmpty(int, int)
0xb1d: Push("k11q01SoulCount")
0xb1e: @ GetVariable(Stack[-1], Stack[-2])
0xb1f: Pop(1)
0xb20: Push((int) 1)
0xb21: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xb22: Push("k11q01SoulCount")
...
0xb67: Pop(0)
0xb68: @@ ShowMap(Stack[-1])
0xb69: Pop(1)
0xb6a: Return(); Pop(0)

0xb6b: PushEmpty()
0xb6c: Push("blackvaccine2 is given")
0xb6d: @ Trace(Stack[-1])
0xb6e: Pop(1)
0xb6f: PushEmpty(object, string, int)
0xb70: Stack[-3] = Stack[-5]
0xb71: Stack[-2] = "black_vaccine"
0xb72: Stack[-1] = (int) 2
0xb73: Call2 0xaa6
...
0xbbd: Push("tvirin")
0xbbe: @@ GetItemCountOfType(Stack[-2], Stack[-1])
0xbbf: Pop(1)
0xbc0: Push((int) 3)
...
0xbc5: Push("fresh_meat")
0xbc6: @@ GetItemCountOfType(Stack[-2], Stack[-1])
0xbc7: Pop(1)
0xbc8: Push((int) 3)
...
0xc49: Push("Can't retrieve diary root")
0xc4a: @ Trace(Stack[-1])
0xc4b: Pop(1)
...
0xc54: Stack[-4] = Stack[-1]
0xc55: Pop(1)
0xc56: @@ Find(Stack[-7], Stack[-2])
0xc57: Pop(0)
0xc58: Pop(0); Push((bool) Stack[-2] == 0)
0xc59: IF (Stack[-1] == 0) GOTO 0xc60; Pop(1)

0xc5a: Push("Can't find diary parent with id: ")
...
0xc60: @@ AddChild(Stack[-8])
0xc61: Pop(0)
0xc62: Push((int) 7)
0xc63: @ SendWorldWndMessage(Stack[-1])
0xc64: Pop(1)
0xc65: @@ GetCategory(Stack[-1])
0xc66: Pop(0)
...
0xc6f: Pop(0)
0xc70: Pop(0); Push((bool) Stack[-2] == 0)
0xc71: IF (Stack[-1] == 0) GOTO 0xc78; Pop(1)

0xc72: Push("Can't find main outdoor scene")
0xc73: @ Trace(Stack[-1])
0xc74: Pop(1)
0xc75: Stack[-1] = 0
0xc76: Stack[-5] = Stack[-1]
0xc77: Return(); Pop(4)

0xc78: @@ GetMap(Stack[-1])
0xc79: Pop(0)
0xc7a: Stack[-5] = Stack[-1]
0xc7b: Return(); Pop(4)
...
0xc80: Pop(0)
0xc81: Pop(0); Push((bool) Stack[-2] == 0)
0xc82: IF (Stack[-1] == 0) GOTO 0xc87; Pop(1)

0xc83: Push("Can't find main outdoor scene")
0xc84: @ Trace(Stack[-1])
0xc85: Pop(1)
0xc86: Return(); Pop(8)

0xc87: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0xc88: Pop(0)
0xc89: Pop(0); Push((bool) Stack[-1] == 0)
0xc8a: IF (Stack[-1] == 0) GOTO 0xc91; Pop(1)

0xc8b: Push("Warning: outdoor scene locator ")
0xc8c: Pop(1); Push(Stack[-1] + Stack[-11]);
0xc8d: Push(" doesnt exist")
0xc8e: Pop(2); Push(Stack[-2] + Stack[-1]);
0xc8f: @ Trace(Stack[-1])
0xc90: Pop(1)
0xc91: @@ GetMap(Stack[-11])
0xc92: Pop(0)
0xc93: Pop(0); Push((bool) Stack[-11] == 0)
0xc94: IF (Stack[-1] == 0) GOTO 0xc99; Pop(1)

0xc95: Push("Can't find map")
0xc96: @ Trace(Stack[-1])
0xc97: Pop(1)
0xc98: Return(); Pop(8)
...
0xc9b: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0xc9c: Pop(2)
0xc9d: Return(); Pop(8)
