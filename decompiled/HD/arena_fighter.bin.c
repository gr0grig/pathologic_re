...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1473(var_12_object); // 0x377 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x5de PushV
	var_13_object = var_9_object; // 0x5df Mov
	var_14_int = var_10_int; // 0x5e0 Mov
	var_15_float = var_11_float; // 0x5e1 Mov
	func_1277(var_13_object, var_14_int, var_15_float); // 0x5e2 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x5e6 PushV
	var_15_object = var_9_object; // 0x5e7 Mov
	var_16_int = var_10_int; // 0x5e8 Mov
	var_17_float = var_11_float; // 0x5e9 Mov
	var_18_cvector = var_13_cvector; // 0x5ea Mov
	var_19_cvector = var_14_cvector; // 0x5eb Mov
	func_1345(var_17_float, var_18_cvector, var_19_cvector); // 0x5ec NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x5ef PushV
	var_13_string = "health"; // 0x5f0 PushS
	var_14_bool = var_10_string == var_13_string; // 0x5f1 Eq
	if(var_14_bool == 0) goto Label_1531; // 0x5f2 JumpB
	var_15_string = "health"; // 0x5f3 PushS
	GetProperty(var_15_string, var_12_float); // 0x5f4 Func
	var_16_int = 0; // 0x5f6 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x5f7 LE
	if(var_17_bool == 0) goto Label_1531; // 0x5f8 JumpB
	SignalDeath(var_9_object); // 0x5f9 Func
...
{
	var_10_object = Obj(); // 0x5fd PushV
	var_10_object = var_9_object; // 0x5fe Mov
	func_1493(var_10_object); // 0x5ff NEW_2
...
Label_319:
	...
	var_484_string = "all"; // 0x141 PushS
	var_485_string = "fjump"; // 0x142 PushS
	PlayAnimation(var_484_string, var_485_string); // 0x143 Func
	WaitForAnimEnd(); // 0x145 Func
	func_805(var_38_float); // 0x148 NEW_2
	var_486_cvector = CVector(0.0, 0.0, 0.0); // 0x14a PushVec
	SetSpeed(var_486_cvector); // 0x14b Func
	Stop(); // 0x14d Func
	StopAsync(); // 0x14f Func
	var_487_bool = 0; // 0x151 PushV
	func_762(var_38_float, var_487_bool); // 0x152 NEW_2
	var_488_bool = var_487_bool == 0; // 0x154 Not
	if(var_488_bool == 0) goto Label_365; // 0x155 JumpB
	var_489_bool = 0; var_490_object = Obj(); // 0x156 PushV
	var_490_object = var_0_object; // 0x157 MovT
	func_156(var_489_bool, var_490_object); // 0x158 NEW_2
	var_491_bool = var_489_bool == 0; // 0x15a Not
	if(var_491_bool == 0) goto Label_349; // 0x15b JumpB
...
Label_349:
	...
	var_492_float = var_16_float * var_16_float; // 0x163 Mult
	var_493_bool = var_35_float < var_492_float; // 0x164 LT
	if(var_493_bool == 0) goto Label_365; // 0x165 JumpB
	var_494_bool = 0; var_495_float = 0; // 0x166 PushV
	var_495_float = var_16_float; // 0x167 Mov
	func_466(var_38_float, var_494_bool, var_495_float); // 0x168 NEW_2
	var_496_bool = var_494_bool == 0; // 0x16a Not
	if(var_496_bool == 0) goto Label_365; // 0x16b JumpB
	goto Label_375; // 0x16c Jump
	
Label_366:
	var_497_bool = 0; var_498_float = 0; // 0x16e PushV
	var_498_float = var_16_float; // 0x16f Mov
	func_466(var_38_float, var_497_bool, var_498_float); // 0x170 NEW_2
	var_499_bool = var_497_bool == 0; // 0x172 Not
	if(var_499_bool == 0) goto Label_373; // 0x173 JumpB
...
func_805(var_0_object)
{
	...
	func_1473(var_95_object); // 0x327 NEW_2
...
func_427(var_0_object, var_357_float, var_358_int)
{
	...
	var_442_int = 0; // 0x1c6 PushV
	func_810(var_442_int); // 0x1c7 NEW_2
	ReportHit(var_0_object, var_442_int, var_364_float, var_363_float); // 0x1c9 Func
	var_443_object = Obj(); var_444_float = 0; // 0x1cb PushV
	var_443_object = var_362_object; // 0x1cc Mov
	var_444_float = var_364_float; // 0x1cd Mov
...
func_1456(var_433_float)
{
	...
	var_436_int = 0; // 0x5b5 PushI
	var_437_bool = var_433_float < var_436_int; // 0x5b6 LT
	if(var_437_bool == 0) goto Label_1468; // 0x5b7 JumpB
	var_438_float = 0.7; // 0x5b8 PushF
	var_439_int = 500; // 0x5b9 PushI
	RumblePlay(var_438_float, var_439_int); // 0x5ba Func
	
Label_1468:
	var_440_int = 15; // 0x5bc PushI
	SendWorldWndMessage(var_440_int, var_435_object); // 0x5bd Func
...
func_832(var_2_int, var_102_bool, var_103_object, var_104_float, var_105_float, var_106_bool, var_107_bool)
{
	...
	func_1473(var_115_object); // 0x343 NEW_2
...
{
	var_96_bool = 0; var_97_bool = 0; // 0x5c1 PushV
	IsPlayerActor(var_95_object, var_97_bool); // 0x5c2 Func
	var_98_bool = var_97_bool; // 0x5c4 Push
	if(var_98_bool == 0) goto Label_1481; // 0x5c5 JumpB
	var_99_string = "attack"; // 0x5c6 PushS
	PlayGlobalMusic(var_99_string); // 0x5c7 Func
...
func_1482()
{
	var_332_object = Obj(); var_333_object = Obj(); // 0x5ca PushV
	GetScene(var_333_object); // 0x5cb Func
	var_334_string = "battle"; // 0x5cd PushS
	var_335_object = Obj(); // 0x5ce PushV
	func_1422(var_335_object); // 0x5cf NEW_2
	BroadcastMessage(var_334_string, var_335_object, var_333_object); // 0x5d1 Func
...
Label_502:
	...
	var_445_string = "all"; // 0x1fb PushS
	var_446_string = "attack_middle"; // 0x1fc PushS
	var_447_int = var_446_string + var_326_int; // 0x1fd Add
	HasAnimation(var_327_bool, var_445_string, var_447_int); // 0x1fe Func
	var_448_bool = var_327_bool; // 0x200 Push
	if(var_448_bool == 0) goto Label_583; // 0x201 JumpB
	func_1482(); // 0x203 NEW_2
	var_449_string = "all"; // 0x205 PushS
	var_450_string = "attack_middle"; // 0x206 PushS
	var_451_int = var_450_string + var_326_int; // 0x207 Add
	PlayAnimation(var_449_string, var_451_int); // 0x208 Func
	WaitForAnimEnd(); // 0x20a Func
	func_805(var_329_string); // 0x20d NEW_2
	var_452_bool = 0; var_453_object = Obj(); // 0x20f PushV
	var_453_object = var_0_object; // 0x210 MovT
	func_156(var_452_bool, var_453_object); // 0x211 NEW_2
	var_454_bool = var_452_bool == 0; // 0x213 Not
	if(var_454_bool == 0) goto Label_537; // 0x214 JumpB
	StopAsync(); // 0x215 Func
	var_320_bool = 0; // 0x217 MovB
	return 8; // 0x218 Return
	
Label_537:
	var_455_float = 0; var_456_int = 0; // 0x219 PushV
	var_455_float = var_321_float; // 0x21a Mov
	var_456_int = var_326_int; // 0x21b Mov
	func_427(var_329_string, var_455_float, var_456_int); // 0x21c NEW_2
	var_328_int = 1; // 0x21e MovI
	
Label_543:
	var_457_string = "attack_middle"; // 0x21f PushS
	var_458_int = var_457_string + var_326_int; // 0x220 Add
	var_459_string = "_"; // 0x221 PushS
	var_460_int = var_458_int + var_459_string; // 0x222 Add
	var_329_string = var_460_int + var_328_int; // 0x223 Add2
	var_461_string = "all"; // 0x224 PushS
	HasAnimation(var_327_bool, var_461_string, var_329_string); // 0x225 Func
	var_462_bool = var_327_bool == 0; // 0x227 Not
	if(var_462_bool == 0) goto Label_554; // 0x228 JumpB
	goto Label_583; // 0x229 Jump
	
Label_583:
	var_463_bool = 0; // 0x247 PushB
	SetAttackState(var_463_bool); // 0x248 Func
	var_464_string = "all"; // 0x24a PushS
	var_465_string = "attack_end"; // 0x24b PushS
	var_466_int = var_465_string + var_326_int; // 0x24c Add
	PlayAnimation(var_464_string, var_466_int); // 0x24d Func
	var_467_bool = 0; // 0x24f PushV
	func_819(var_467_bool); // 0x250 NEW_2
	if(var_467_bool == 0) goto Label_601; // 0x252 JumpB
	var_468_bool = 0; var_469_float = 0; // 0x253 PushV
	var_469_float = 0.75; // 0x254 MovF
	func_603(var_468_bool, var_469_float); // 0x255 NEW_2
...
Label_554:
	func_1482(); // 0x22b NEW_2
	var_477_string = "all"; // 0x22d PushS
	PlayAnimation(var_477_string, var_329_string); // 0x22e Func
	WaitForAnimEnd(); // 0x230 Func
	func_805(var_329_string); // 0x233 NEW_2
	var_478_bool = 0; var_479_object = Obj(); // 0x235 PushV
	var_479_object = var_0_object; // 0x236 MovT
	func_156(var_478_bool, var_479_object); // 0x237 NEW_2
	var_480_bool = var_478_bool == 0; // 0x239 Not
	if(var_480_bool == 0) goto Label_575; // 0x23a JumpB
	StopAsync(); // 0x23b Func
	var_320_bool = 0; // 0x23d MovB
	return 8; // 0x23e Return
	
Label_575:
	var_481_float = 0; var_482_int = 0; // 0x23f PushV
	var_481_float = var_321_float; // 0x240 Mov
	var_482_int = var_326_int; // 0x241 Mov
	func_427(var_329_string, var_481_float, var_482_int); // 0x242 NEW_2
	var_483_int = 1; // 0x244 PushI
	var_328_int = var_328_int + var_483_int; // 0x245 Add2
...
{
	var_11_object = Obj(); // 0x5d6 PushV
	var_11_object = var_10_object; // 0x5d7 Mov
	TaskCall(0); // 0x5d8 TaskCall
	func_0(var_11_object); // 0x5d9 NEW_2
	TaskReturn(); // 0x5da TaskReturn
...
{
	var_470_float = 0; var_471_bool = 0; var_472_float = 0; var_473_bool = 0; // 0x25b PushV
	rand(var_472_float); // 0x25c Func
	var_474_bool = var_472_float < var_469_float; // 0x25e LT
	if(var_474_bool == 0) goto Label_623; // 0x25f JumpB
	
Label_608:
	IsAnimationPlaying(var_473_bool); // 0x260 Func
	var_475_bool = var_473_bool == 0; // 0x262 Not
	if(var_475_bool == 0) goto Label_613; // 0x263 JumpB
...
Label_628:
	var_468_bool = 0; // 0x274 MovB
	return 4; // 0x275 Return
	
Label_613:
	var_476_bool = 0; // 0x265 PushV
	func_701(var_476_bool); // 0x266 NEW_2
	if(var_476_bool == 0) goto Label_619; // 0x268 JumpB
	var_468_bool = 1; // 0x269 MovB
...
Label_623:
	...
	func_805(var_473_bool); // 0x272 NEW_2
}
...
Label_1138:
	var_441_string = "armor"; // 0x472 PushS
	GetProperty(var_441_string, var_384_int); // 0x473 ObjFunc
}
