...
0x918: Stack[-2] = Stack[-7]
0x919: Stack[-1] = Stack[-6]
0x91a: Call2 0x97b
...
0x96c: Stack[-3] = Stack[-2]
0x96d: GOTO 0x96f

0x96e: Stack[-3] = Stack[-1]
0x96f: Return(); Pop(0)
...
0x995: Stack[-2] = Stack[-5]
0x996: Stack[-1] = Stack[-4]
0x997: Call2 0x980

0x998: Pop(2)
0x999: PushEmpty(float, cvector)
0x99a: Stack[-1] = Stack[-5]
0x99b: Call2 0x989
...
0x9e8: Push("GenerateMoney: iMin > iMax")
0x9e9: @ Trace(Stack[-1])
0x9ea: Pop(1)
0x9eb: Return(); Pop(4)
...
0xa06: Pop(0)
0xa07: @@ SetItemName(Stack[-7])
0xa08: Pop(0)
0xa09: Push("Organ")
0xa0a: Push((int) 1)
0xa0b: @@ SetProperty(Stack[-2], Stack[-1])
0xa0c: Pop(2)
0xa0d: @@ GetItemID(Stack[-2])
0xa0e: Pop(0)
0xa0f: Push((int) 0)
0xa10: Push((int) 1)
...
0xacf: Stack[-3] = Stack[-7]
0xad0: Stack[-2] = Stack[-6]
0xad1: Stack[-1] = Stack[-5]
0xad2: Call2 0x8a9
...
0xad7: Stack[-5] = Stack[-11]
0xad8: Stack[-4] = Stack[-10]
0xad9: Stack[-3] = Stack[-9]
0xada: Stack[-2] = Stack[-7]
0xadb: Stack[-1] = Stack[-6]
0xadc: Call2 0x8ed
...
0xb27: @@ IsWeaponHolstered(Stack[-1])
0xb28: Pop(0)
...
0xba6: Pop(1)
0xba7: Push("class")
0xba8: @@ GetProperty(Stack[-1], Stack[-2])
0xba9: Pop(1)
...
0xc2c: Push(Stack[-1])
0xc2d: IF (Stack[-1] == 0) GOTO 0xc36; Pop(1)

0xc2e: PushEmpty(float, object)
0xc2f: Stack[-1] = Stack[-5]
0xc30: Call2 0x7da
...
0xc61: Stack[-4] = Stack[-8]
0xc62: Stack[-3] = Stack[-7]
0xc63: Stack[-2] = (float) 700.0
0xc64: Stack[-1] = Stack[-6]
0xc65: Call2 0xbf2

0xc66: Stack[-9] = Stack[-5]
0xc67: Pop(5)
0xc68: Return(); Pop(0)
