task_0_event_11(var_0_bool, var_1_int, var_2_object, var_3_object, var_4_object, var_5_string, var_6_bool, var_7_bool, var_8_bool, var_9_bool, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6948(var_20_bool); // 0x1c NEW_2
...
Label_3283:
	...
	func_6948(var_1198_bool); // 0xcd5 NEW_2
...
task_3_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_bool, var_8_bool, var_9_bool, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6894(var_23_object); // 0xcf2 NEW_2
	...
	func_6897(var_26_object); // 0xcfa NEW_2
...
task_4_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6894(var_23_object); // 0xd97 NEW_2
...
Label_3491:
	...
	func_6897(var_29_object); // 0xda5 NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_bool, var_12_object, var_13_object, var_14_int, var_15_int, var_16_bool, var_17_float, var_18_int, var_19_bool, var_20_object, var_21_bool)
{
	...
	func_7000(var_24_bool, var_25_object, var_26_object, var_27_bool); // 0xdc5 NEW_2
...
task_4_event_40(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6884(var_23_object); // 0xddf NEW_2
	var_21_int = var_22_int; // 0xde0 Mov
	var_24_int = 0; // 0xde2 PushI
	var_25_bool = var_21_int > var_24_int; // 0xde3 GT
	if(var_25_bool == 0) goto Label_3567; // 0xde4 JumpB
	var_26_int = 1; // 0xde5 PushI
	var_27_bool = var_21_int > var_26_int; // 0xde6 GT
	if(var_27_bool == 0) goto Label_3563; // 0xde7 JumpB
	func_3663(var_21_int); // 0xde9 NEW_2
	
Label_3563:
	var_29_object = Obj(); // 0xdeb PushV
	var_29_object = var_19_bool; // 0xdec Mov
	func_6887(); // 0xded NEW_2
...
Label_3584:
	...
	func_6889(var_130_object); // 0xe03 NEW_2
...
task_5_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6894(var_23_object); // 0xef0 NEW_2
...
Label_3836:
	...
	func_6897(var_28_object); // 0xefe NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_bool, var_12_object, var_13_object, var_14_int, var_15_int, var_16_bool, var_17_float, var_18_int, var_19_bool, var_20_object, var_21_bool)
{
	...
	func_7000(var_24_bool, var_25_object, var_26_object, var_27_bool); // 0xf1e NEW_2
...
task_5_event_40(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6884(var_23_object); // 0xf38 NEW_2
	var_21_int = var_22_int; // 0xf39 Mov
	var_24_int = 0; // 0xf3b PushI
	var_25_bool = var_21_int > var_24_int; // 0xf3c GT
	if(var_25_bool == 0) goto Label_3912; // 0xf3d JumpB
	var_26_int = 1; // 0xf3e PushI
	var_27_bool = var_21_int > var_26_int; // 0xf3f GT
	if(var_27_bool == 0) goto Label_3908; // 0xf40 JumpB
	func_4066(); // 0xf42 NEW_2
	
Label_3908:
	var_28_object = Obj(); // 0xf44 PushV
	var_28_object = var_19_bool; // 0xf45 Mov
	func_6887(); // 0xf46 NEW_2
...
Label_3929:
	...
	func_6889(var_129_object); // 0xf5c NEW_2
...
task_6_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6894(var_23_object); // 0x1022 NEW_2
...
Label_4142:
	...
	func_6897(var_30_object); // 0x1030 NEW_2
...
task_6_event_30(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_bool, var_13_object, var_14_int, var_15_int, var_16_bool, var_17_float, var_18_int, var_19_bool, var_20_object, var_21_bool)
{
	...
	func_7000(var_24_bool, var_25_object, var_26_object, var_27_bool); // 0x1050 NEW_2
...
task_6_event_40(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_6884(var_23_object); // 0x106a NEW_2
	var_21_int = var_22_int; // 0x106b Mov
	var_24_int = 0; // 0x106d PushI
	var_25_bool = var_21_int > var_24_int; // 0x106e GT
	if(var_25_bool == 0) goto Label_4218; // 0x106f JumpB
	var_26_int = 1; // 0x1070 PushI
	var_27_bool = var_21_int > var_26_int; // 0x1071 GT
	if(var_27_bool == 0) goto Label_4214; // 0x1072 JumpB
	func_4270(); // 0x1074 NEW_2
	
Label_4214:
	var_30_object = Obj(); // 0x1076 PushV
	var_30_object = var_19_bool; // 0x1077 Mov
	func_6887(); // 0x1078 NEW_2
...
Label_4235:
	...
	func_6889(var_131_object); // 0x108e NEW_2
...
Label_4:
	...
	func_6948(var_535_bool); // 0x5 NEW_2
...
{
	var_240_bool = 0; var_241_bool = 0; var_242_object = Obj(); var_243_cvector = CVector(0,0,0); var_244_cvector = CVector(0,0,0); var_245_cvector = CVector(0,0,0); var_246_float = 0; var_247_object = Obj(); var_248_bool = 0; var_249_bool = 0; var_250_object = Obj(); var_251_cvector = CVector(0,0,0); var_252_cvector = CVector(0,0,0); var_253_cvector = CVector(0,0,0); var_254_float = 0; var_255_object = Obj(); // 0x140e PushV
	var_0_bool = 0; // 0x140f TMovB
	var_1_object = var_235_object; // 0x1410 TMov
	var_249_bool = var_239_bool; // 0x1411 Mov
	
Label_5138:
	var_256_bool = 0; var_257_object = Obj(); // 0x1412 PushV
	var_257_object = var_235_object; // 0x1413 Mov
	func_5274(var_256_bool, var_257_object); // 0x1414 NEW_2
	var_260_bool = var_256_bool == 0; // 0x1416 Not
	if(var_260_bool == 0) goto Label_5146; // 0x1417 JumpB
	var_234_bool = 0; // 0x1418 MovB
	return 16; // 0x1419 Return
	
Label_5146:
	GetPosition(var_251_cvector); // 0x141a ObjFunc
	GetPosition(var_252_cvector); // 0x141c Func
	var_253_cvector = var_251_cvector - var_252_cvector; // 0x141e Sub2
	var_254_float = var_253_cvector | var_253_cvector; // 0x141f Or2
	var_261_bool = 0; // 0x1420 PushV
	var_261_bool = 0; // 0x1421 MovB
	var_262_int = 0; // 0x1422 PushI
	var_263_bool = var_237_float > var_262_int; // 0x1423 GT
	if(var_263_bool == 0) goto Label_5161; // 0x1424 JumpB
	var_264_float = var_237_float * var_237_float; // 0x1425 Mult
	var_265_bool = var_254_float > var_264_float; // 0x1426 GT
	if(var_265_bool == 0) goto Label_5161; // 0x1427 JumpB
	var_261_bool = 1; // 0x1428 MovB
	
Label_5161:
	if(var_261_bool == 0) goto Label_5166; // 0x1429 JumpB
	Stop(); // 0x142a Func
	var_234_bool = 0; // 0x142c MovB
	return 16; // 0x142d Return
	
Label_5166:
	var_266_float = var_236_float * var_236_float; // 0x142e Mult
	var_267_bool = var_254_float > var_266_float; // 0x142f GT
	if(var_267_bool == 0) goto Label_5228; // 0x1430 JumpB
	GetPFPosition(var_251_cvector); // 0x1431 ObjFunc
	FindPathTo(var_255_object, var_251_cvector); // 0x1433 Func
	var_268_bool = var_255_object != 0; // 0x1435 NullNeq
	if(var_268_bool == 0) goto Label_5177; // 0x1436 JumpB
	var_250_object = var_255_object; // 0x1437 Mov
	var_255_object = 0; // 0x1438 SetNull
	
Label_5177:
	var_269_bool = var_250_object != 0; // 0x1439 NullNeq
	if(var_269_bool == 0) goto Label_5210; // 0x143a JumpB
	var_270_bool = var_249_bool; // 0x143b Push
	if(var_270_bool == 0) goto Label_5187; // 0x143c JumpB
	var_249_bool = 0; // 0x143d MovB
	RotatePath(var_250_object, var_248_bool); // 0x143e Func
	var_271_bool = var_248_bool == 0; // 0x1440 Not
	if(var_271_bool == 0) goto Label_5187; // 0x1441 JumpB
	goto Label_5234; // 0x1442 Jump
	
Label_5234:
	var_234_bool = !var_0_bool; // 0x1472 Not2
	return 16; // 0x1473 Return
	
Label_5187:
	var_272_int = 0; // 0x1443 PushI
	var_273_float = 0.3; // 0x1444 PushF
	SetTimer(var_272_int, var_273_float); // 0x1445 Func
	var_274_string = ""; // 0x1447 PushV
	func_5281(var_274_string); // 0x1448 NEW_2
	var_275_string = ""; // 0x144a PushV
	func_5283(var_275_string); // 0x144b NEW_2
	FollowPath(var_250_object, var_238_bool, var_248_bool, var_274_string, var_275_string); // 0x144d Func
	var_276_bool = var_248_bool == 0; // 0x144f Not
	if(var_276_bool == 0) goto Label_5208; // 0x1450 JumpB
	var_277_bool = var_0_bool; // 0x1451 PushT
	if(var_277_bool == 0) goto Label_5206; // 0x1452 JumpB
	var_250_object = 0; // 0x1453 SetNull
...
Label_5208:
	var_250_object = 0; // 0x1458 SetNull
	goto Label_5226; // 0x1459 Jump
	
Label_5226:
	var_255_object = 0; // 0x146a SetNull
	goto Label_5232; // 0x146b Jump
	
Label_5232:
	var_250_object = 0; // 0x1470 SetNull
	
Label_5210:
	var_278_int = 0; // 0x145a PushI
	KillTimer(var_278_int); // 0x145b Func
	var_279_float = 0.5; // 0x145d PushF
	Sleep(var_279_float, var_248_bool); // 0x145e Func
	var_280_bool = var_248_bool == 0; // 0x1460 Not
	if(var_280_bool == 0) goto Label_5222; // 0x1461 JumpB
	var_281_bool = var_0_bool; // 0x1462 PushT
	if(var_281_bool == 0) goto Label_5222; // 0x1463 JumpB
	var_250_object = 0; // 0x1464 SetNull
	goto Label_5234; // 0x1465 Jump
	
Label_5222:
	var_282_int = 0; // 0x1466 PushI
	var_283_float = 0.3; // 0x1467 PushF
	SetTimer(var_282_int, var_283_float); // 0x1468 Func
	
Label_5228:
	var_284_int = 0; // 0x146c PushI
	KillTimer(var_284_int); // 0x146d Func
...
{
	var_462_object = Obj(); var_463_float = 0; var_464_float = 0; var_465_object = Obj(); var_466_float = 0; var_467_float = 0; // 0x1210 PushV
	var_468_float = 0.9; // 0x1211 PushF
	var_469_float = var_460_float * var_468_float; // 0x1212 Mult
	GetVictim(var_469_float, var_465_object); // 0x1213 Func
	ReportAttack(var_0_bool); // 0x1215 Func
	var_470_bool = var_465_object == var_0_bool; // 0x1217 Eq
	if(var_470_bool == 0) goto Label_4661; // 0x1218 JumpB
	var_471_float = 0; var_472_object = Obj(); var_473_int = 0; // 0x1219 PushV
	var_472_object = var_465_object; // 0x121a Mov
	var_473_int = var_461_int; // 0x121b Mov
	func_4354(var_473_int); // 0x121c NEW_2
	var_466_float = var_471_float; // 0x121d Mov
	var_474_float = 0; var_475_object = Obj(); var_476_float = 0; var_477_int = 0; // 0x121f PushV
	var_475_object = var_465_object; // 0x1220 Mov
	var_476_float = var_466_float; // 0x1221 Mov
	var_478_int = 0; var_479_object = Obj(); var_480_int = 0; // 0x1222 PushV
	var_479_object = var_465_object; // 0x1223 Mov
	var_480_int = var_461_int; // 0x1224 Mov
	func_4357(var_480_int); // 0x1225 NEW_2
	var_477_int = var_478_int; // 0x1226 Mov
	func_5331(var_474_float, var_475_object, var_476_float, var_477_int); // 0x1228 NEW_2
	var_467_float = var_474_float; // 0x1229 Mov
	var_539_int = 0; // 0x122b PushV
	func_5007(var_539_int); // 0x122c NEW_2
	ReportHit(var_0_bool, var_539_int, var_467_float, var_466_float); // 0x122e Func
	var_540_object = Obj(); var_541_float = 0; // 0x1230 PushV
	var_540_object = var_465_object; // 0x1231 Mov
	var_541_float = var_467_float; // 0x1232 Mov
...
func_6679(var_20_bool, var_21_string)
{
	...
	func_6935(var_28_object); // 0x1a20 NEW_2
...
func_5680()
{
	...
	func_6948(var_495_bool); // 0x1635 NEW_2
...
func_4663(var_0_bool, var_423_bool, var_424_float)
{
	var_425_int = 0; var_426_bool = 0; var_427_int = 0; var_428_string = ""; var_429_int = 0; var_430_bool = 0; var_431_int = 0; var_432_string = ""; // 0x1237 PushV
	func_5002(var_432_string); // 0x1239 NEW_2
	irand(var_429_int, var_432_string); // 0x123b Func
	var_433_int = 1; // 0x123d PushI
	var_429_int = var_429_int + var_433_int; // 0x123e Add2
	Face(var_0_bool); // 0x123f Func
	var_434_bool = 1; // 0x1241 PushB
	SetAttackState(var_434_bool); // 0x1242 Func
	func_5998(); // 0x1245 NEW_2
	var_439_string = "all"; // 0x1247 PushS
	var_440_string = "attack_begin"; // 0x1248 PushS
	var_441_int = var_440_string + var_429_int; // 0x1249 Add
	PlayAnimation(var_439_string, var_441_int); // 0x124a Func
	WaitForAnimEnd(); // 0x124c Func
	func_4970(var_431_int, var_432_string); // 0x124f NEW_2
	var_457_bool = 0; var_458_object = Obj(); // 0x1251 PushV
	var_458_object = var_0_bool; // 0x1252 MovT
	func_5445(var_457_bool, var_458_object); // 0x1253 NEW_2
	var_459_bool = var_457_bool == 0; // 0x1255 Not
	if(var_459_bool == 0) goto Label_4699; // 0x1256 JumpB
	StopAsync(); // 0x1257 Func
	var_423_bool = 0; // 0x1259 MovB
	return 8; // 0x125a Return
	
Label_4699:
	var_460_float = 0; var_461_int = 0; // 0x125b PushV
	var_460_float = var_424_float; // 0x125c Mov
	var_461_int = var_429_int; // 0x125d Mov
	func_4624(var_432_string, var_460_float, var_461_int); // 0x125e NEW_2
	var_542_string = "all"; // 0x1260 PushS
	var_543_string = "attack_middle"; // 0x1261 PushS
	var_544_int = var_543_string + var_429_int; // 0x1262 Add
	HasAnimation(var_430_bool, var_542_string, var_544_int); // 0x1263 Func
	var_545_bool = var_430_bool; // 0x1265 Push
	if(var_545_bool == 0) goto Label_4780; // 0x1266 JumpB
	func_5998(); // 0x1268 NEW_2
	var_546_string = "all"; // 0x126a PushS
	var_547_string = "attack_middle"; // 0x126b PushS
	var_548_int = var_547_string + var_429_int; // 0x126c Add
	PlayAnimation(var_546_string, var_548_int); // 0x126d Func
	WaitForAnimEnd(); // 0x126f Func
	func_5002(var_432_string); // 0x1272 NEW_2
	var_549_bool = 0; var_550_object = Obj(); // 0x1274 PushV
	var_550_object = var_0_bool; // 0x1275 MovT
	func_5445(var_549_bool, var_550_object); // 0x1276 NEW_2
	var_551_bool = var_549_bool == 0; // 0x1278 Not
	if(var_551_bool == 0) goto Label_4734; // 0x1279 JumpB
	StopAsync(); // 0x127a Func
	var_423_bool = 0; // 0x127c MovB
	return 8; // 0x127d Return
	
Label_4734:
	var_552_float = 0; var_553_int = 0; // 0x127e PushV
	var_552_float = var_424_float; // 0x127f Mov
	var_553_int = var_429_int; // 0x1280 Mov
	func_4624(var_432_string, var_552_float, var_553_int); // 0x1281 NEW_2
	var_431_int = 1; // 0x1283 MovI
	
Label_4740:
	var_554_string = "attack_middle"; // 0x1284 PushS
	var_555_int = var_554_string + var_429_int; // 0x1285 Add
	var_556_string = "_"; // 0x1286 PushS
	var_557_int = var_555_int + var_556_string; // 0x1287 Add
	var_432_string = var_557_int + var_431_int; // 0x1288 Add2
	var_558_string = "all"; // 0x1289 PushS
	HasAnimation(var_430_bool, var_558_string, var_432_string); // 0x128a Func
	var_559_bool = var_430_bool == 0; // 0x128c Not
	if(var_559_bool == 0) goto Label_4751; // 0x128d JumpB
	goto Label_4780; // 0x128e Jump
	
Label_4780:
	var_560_bool = 0; // 0x12ac PushB
	SetAttackState(var_560_bool); // 0x12ad Func
	var_561_string = "all"; // 0x12af PushS
	var_562_string = "attack_end"; // 0x12b0 PushS
	var_563_int = var_562_string + var_429_int; // 0x12b1 Add
	PlayAnimation(var_561_string, var_563_int); // 0x12b2 Func
	var_564_bool = 0; // 0x12b4 PushV
	func_5016(var_564_bool); // 0x12b5 NEW_2
	if(var_564_bool == 0) goto Label_4798; // 0x12b7 JumpB
	var_565_bool = 0; var_566_float = 0; // 0x12b8 PushV
	var_566_float = 0.75; // 0x12b9 MovF
	func_4800(var_565_bool, var_566_float); // 0x12ba NEW_2
	StopAsync(); // 0x12bc Func
	
Label_4798:
	var_423_bool = 1; // 0x12be MovB
	return 8; // 0x12bf Return
	
Label_4751:
	func_5998(); // 0x1290 NEW_2
	var_574_string = "all"; // 0x1292 PushS
	PlayAnimation(var_574_string, var_432_string); // 0x1293 Func
	WaitForAnimEnd(); // 0x1295 Func
	func_5002(var_432_string); // 0x1298 NEW_2
	var_575_bool = 0; var_576_object = Obj(); // 0x129a PushV
	var_576_object = var_0_bool; // 0x129b MovT
	func_5445(var_575_bool, var_576_object); // 0x129c NEW_2
	var_577_bool = var_575_bool == 0; // 0x129e Not
	if(var_577_bool == 0) goto Label_4772; // 0x129f JumpB
	StopAsync(); // 0x12a0 Func
	var_423_bool = 0; // 0x12a2 MovB
	return 8; // 0x12a3 Return
	
Label_4772:
	var_578_float = 0; var_579_int = 0; // 0x12a4 PushV
	var_578_float = var_424_float; // 0x12a5 Mov
	var_579_int = var_429_int; // 0x12a6 Mov
	func_4624(var_432_string, var_578_float, var_579_int); // 0x12a7 NEW_2
	var_580_int = 1; // 0x12a9 PushI
	var_431_int = var_431_int + var_580_int; // 0x12aa Add2
...
func_6732(var_62_int)
{
	...
	func_6998(var_64_bool); // 0x1a4e NEW_2
...
{
	var_91_bool = 0; var_92_object = Obj(); // 0x1a5e PushV
	var_92_object = var_90_object; // 0x1a5f Mov
	func_5445(var_91_bool, var_92_object); // 0x1a60 NEW_2
	if(var_91_bool == 0) goto Label_6757; // 0x1a62 JumpB
	var_89_int = 2; // 0x1a63 MovI
...
{
	var_127_object = Obj(); // 0x1a68 PushV
	var_127_object = var_126_object; // 0x1a69 Mov
	TaskCall(7); // 0x1a6a TaskCall
	func_4346(var_127_object); // 0x1a6b NEW_2
...
Label_712:
	...
	func_6948(var_349_bool); // 0x2c9 NEW_2
...
{
	var_274_string = "walk"; // 0x14a1 MovS
...
{
	var_275_string = "run"; // 0x14a3 MovS
...
{
	var_504_int = 2; // 0x14a6 PushI
	var_505_bool = var_503_int == var_504_int; // 0x14a7 Eq
	if(var_505_bool == 0) goto Label_5292; // 0x14a8 JumpB
	var_502_string = "fire"; // 0x14a9 MovS
	return 0; // 0x14aa Return
	
Label_5292:
	var_506_int = 1; // 0x14ac PushI
	var_507_bool = var_503_int == var_506_int; // 0x14ad Eq
	if(var_507_bool == 0) goto Label_5297; // 0x14ae JumpB
	var_502_string = "bullet"; // 0x14af MovS
	return 0; // 0x14b0 Return
	
Label_5297:
	var_502_string = "phys"; // 0x14b1 MovS
...
func_5801()
{
	...
	func_6948(var_22_bool); // 0x16aa NEW_2
...
{
	var_567_float = 0; var_568_bool = 0; var_569_float = 0; var_570_bool = 0; // 0x12c0 PushV
	rand(var_569_float); // 0x12c1 Func
	var_571_bool = var_569_float < var_566_float; // 0x12c3 LT
	if(var_571_bool == 0) goto Label_4820; // 0x12c4 JumpB
	
Label_4805:
	IsAnimationPlaying(var_570_bool); // 0x12c5 Func
	var_572_bool = var_570_bool == 0; // 0x12c7 Not
	if(var_572_bool == 0) goto Label_4810; // 0x12c8 JumpB
...
Label_4825:
	var_565_bool = 0; // 0x12d9 MovB
	return 4; // 0x12da Return
	
Label_4810:
	var_573_bool = 0; // 0x12ca PushV
	func_4898(var_573_bool); // 0x12cb NEW_2
	if(var_573_bool == 0) goto Label_4816; // 0x12cd JumpB
	var_565_bool = 1; // 0x12ce MovB
...
Label_4820:
	...
	func_5002(var_570_bool); // 0x12d7 NEW_2
}
...
{
	var_481_int = 0; var_482_string = ""; var_483_int = 0; var_484_float = 0; var_485_float = 0; var_486_float = 0; var_487_int = 0; var_488_string = ""; var_489_int = 0; var_490_float = 0; var_491_float = 0; var_492_float = 0; // 0x14d3 PushV
	var_493_bool = 0; var_494_object = Obj(); var_495_string = ""; // 0x14d4 PushV
	var_494_object = var_475_object; // 0x14d5 Mov
	var_495_string = "health"; // 0x14d6 MovS
	func_5319(var_493_bool, var_494_object, var_495_string); // 0x14d7 NEW_2
	var_496_bool = var_493_bool == 0; // 0x14d9 Not
	if(var_496_bool == 0) goto Label_5341; // 0x14da JumpB
	var_474_float = 0.0; // 0x14db MovF
	return 12; // 0x14dc Return
	
Label_5341:
	var_497_bool = 0; var_498_object = Obj(); var_499_string = ""; // 0x14dd PushV
	var_498_object = var_475_object; // 0x14de Mov
	var_499_string = "armor"; // 0x14df MovS
	func_5319(var_497_bool, var_498_object, var_499_string); // 0x14e0 NEW_2
	var_500_bool = var_497_bool == 0; // 0x14e2 Not
	if(var_500_bool == 0) goto Label_5350; // 0x14e3 JumpB
	var_487_int = 0; // 0x14e4 MovI
	goto Label_5353; // 0x14e5 Jump
	
Label_5353:
	var_501_string = "armor_"; // 0x14e9 PushS
	var_502_string = ""; var_503_int = 0; // 0x14ea PushV
	var_503_int = var_477_int; // 0x14eb Mov
	func_5285(var_502_string, var_503_int); // 0x14ec NEW_2
	var_488_string = var_501_string + var_502_string; // 0x14ee Add2
	var_508_bool = 0; var_509_object = Obj(); var_510_string = ""; // 0x14ef PushV
	var_509_object = var_475_object; // 0x14f0 Mov
	var_510_string = var_488_string; // 0x14f1 Mov
	func_5319(var_508_bool, var_509_object, var_510_string); // 0x14f2 NEW_2
	var_511_bool = var_508_bool == 0; // 0x14f4 Not
	if(var_511_bool == 0) goto Label_5368; // 0x14f5 JumpB
	var_489_int = 0; // 0x14f6 MovI
	goto Label_5370; // 0x14f7 Jump
	
Label_5370:
	var_512_float = 0; var_513_float = 0; var_514_float = 0; // 0x14fa PushV
	var_515_int = var_487_int + var_489_int; // 0x14fb Add
	var_516_float = 100.0; // 0x14fc PushF
	var_513_float = var_515_int / var_515_int; // 0x14fd Div2
	var_514_float = 1; // 0x14fe MovI
	func_5891(var_512_float, var_513_float, var_514_float); // 0x14ff NEW_2
	var_490_float = var_512_float; // 0x1500 Mov
	var_518_string = "health"; // 0x1502 PushS
	GetProperty(var_518_string, var_491_float); // 0x1503 ObjFunc
	var_519_int = 1; // 0x1505 PushI
	var_520_int = var_519_int - var_490_float; // 0x1506 Sub
	var_492_float = var_476_float * var_520_int; // 0x1507 Mult2
	var_521_string = "health"; // 0x1508 PushS
	var_522_float = 0; var_523_float = 0; var_524_float = 0; var_525_float = 0; // 0x1509 PushV
	var_523_float = var_491_float - var_492_float; // 0x150a Sub2
	var_524_float = 0; // 0x150b MovI
	var_525_float = 1; // 0x150c MovI
	func_5898(var_522_float, var_523_float, var_524_float, var_525_float); // 0x150d NEW_2
	SetProperty(var_521_string, var_522_float); // 0x150f ObjFunc
	var_528_bool = 0; var_529_object = Obj(); // 0x1511 PushV
	var_529_object = var_475_object; // 0x1512 Mov
	func_5314(var_528_bool, var_529_object); // 0x1513 NEW_2
	if(var_528_bool == 0) goto Label_5402; // 0x1515 JumpB
	var_530_float = 0; // 0x1516 PushV
	var_530_float = -var_492_float; // 0x1517 Neg2
	func_5955(var_530_float); // 0x1518 NEW_2
	
Label_5402:
	var_474_float = var_492_float; // 0x151a Mov
	return 12; // 0x151b Return
	
Label_5368:
	GetProperty(var_488_string, var_489_int); // 0x14f8 ObjFunc
	
Label_5350:
	var_538_string = "armor"; // 0x14e6 PushS
	GetProperty(var_538_string, var_487_int); // 0x14e7 ObjFunc
}
...
{
	var_364_bool = 0; var_365_cvector = CVector(0,0,0); var_366_cvector = CVector(0,0,0); var_367_cvector = CVector(0,0,0); var_368_float = 0; var_369_bool = 0; var_370_cvector = CVector(0,0,0); var_371_cvector = CVector(0,0,0); var_372_cvector = CVector(0,0,0); var_373_float = 0; // 0x12db PushV
	
Label_4828:
	IsAnimationPlaying(var_369_bool); // 0x12dc Func
	var_374_bool = var_369_bool == 0; // 0x12de Not
	if(var_374_bool == 0) goto Label_4833; // 0x12df JumpB
	goto Label_4865; // 0x12e0 Jump
	
Label_4865:
	func_5002(var_373_float); // 0x1302 NEW_2
	var_362_bool = 0; // 0x1304 MovB
	return 10; // 0x1305 Return
	
Label_4833:
	var_375_bool = 0; // 0x12e1 PushV
	func_4898(var_375_bool); // 0x12e2 NEW_2
	if(var_375_bool == 0) goto Label_4839; // 0x12e4 JumpB
	var_362_bool = 1; // 0x12e5 MovB
	return 10; // 0x12e6 Return
	
Label_4839:
	var_418_bool = 0; var_419_object = Obj(); // 0x12e7 PushV
	var_419_object = var_0_bool; // 0x12e8 MovT
	func_5445(var_418_bool, var_419_object); // 0x12e9 NEW_2
	var_420_bool = var_418_bool == 0; // 0x12eb Not
	if(var_420_bool == 0) goto Label_4847; // 0x12ec JumpB
	var_362_bool = 0; // 0x12ed MovB
	return 10; // 0x12ee Return
	
Label_4847:
	GetPFPosition(var_370_cvector); // 0x12ef TObjFunc
	GetPFPosition(var_371_cvector); // 0x12f1 Func
	var_372_cvector = var_370_cvector - var_371_cvector; // 0x12f3 Sub2
	var_373_float = var_372_cvector | var_372_cvector; // 0x12f4 Or2
	var_421_float = var_363_float * var_363_float; // 0x12f5 Mult
	var_422_bool = var_373_float < var_421_float; // 0x12f6 LT
	if(var_422_bool == 0) goto Label_4862; // 0x12f7 JumpB
	var_423_bool = 0; var_424_float = 0; // 0x12f8 PushV
	var_424_float = var_363_float; // 0x12f9 Mov
	func_4663(var_373_float, var_423_bool, var_424_float); // 0x12fa NEW_2
	var_362_bool = 1; // 0x12fc MovB
...
func_3296(var_21_object)
{
	...
	func_7010(var_102_object); // 0xce8 NEW_2
...
func_742(var_2_object, var_131_string)
{
	...
	func_6948(var_132_bool); // 0x2e8 NEW_2
...
{
	var_31_object = Obj(); // 0x1af2 PushV
	var_31_object = var_30_object; // 0x1af3 Mov
	func_6958(var_30_object, var_31_object); // 0x1af4 NEW_2
...
{
	var_134_object = Obj(); var_135_bool = 0; var_136_float = 0; // 0x10fb PushV
	var_134_object = var_127_object; // 0x10fc Mov
	var_135_bool = 1; // 0x10fd MovB
	var_136_float = 180.0; // 0x10fe MovF
	func_4360(var_130_int, var_131_bool, var_132_float, var_133_int, var_127_object, var_134_object, var_135_bool, var_136_float); // 0x10ff NEW_2
...
func_6907()
{
	return 0; // 0x1afc Return
}


func_6909(var_32_bool, var_33_object)
{
	var_34_bool = 0; var_35_bool = 0; // 0x1afd PushV
	CanSee(var_35_bool, var_33_object); // 0x1afe Func
	var_32_bool = 1; // 0x1b00 MovB
	var_36_bool = var_35_bool; // 0x1b01 Push
	if(var_36_bool == 0) goto Label_6923; // 0x1b02 JumpB
	var_37_float = 0; var_38_object = Obj(); // 0x1b03 PushV
	var_38_object = var_33_object; // 0x1b04 Mov
	func_5306(var_38_object); // 0x1b05 NEW_2
	var_45_int = 2250000; // 0x1b07 PushI
	var_46_bool = var_37_float <= var_45_int; // 0x1b08 LE
	if(var_46_bool == 0) goto Label_6923; // 0x1b09 JumpB
	var_32_bool = 0; // 0x1b0a MovB
	
Label_6923:
	return 2; // 0x1b0b Return
}
...
{
	var_471_float = 0.03; // 0x1103 MovF
...
{
	var_517_bool = var_513_float < var_514_float; // 0x1704 LT
	if(var_517_bool == 0) goto Label_5896; // 0x1705 JumpB
	var_512_float = var_513_float; // 0x1706 Mov
...
Label_5896:
	var_512_float = var_514_float; // 0x1708 Mov
}
...
{
	var_378_cvector = CVector(0,0,0); var_379_cvector = CVector(0,0,0); var_380_cvector = CVector(0,0,0); var_381_float = 0; var_382_float = 0; var_383_cvector = CVector(0,0,0); var_384_cvector = CVector(0,0,0); var_385_cvector = CVector(0,0,0); var_386_float = 0; var_387_float = 0; // 0x1306 PushV
	var_388_bool = 0; var_389_object = Obj(); // 0x1307 PushV
	var_389_object = var_0_bool; // 0x1308 MovT
	func_5445(var_388_bool, var_389_object); // 0x1309 NEW_2
	var_390_bool = var_388_bool == 0; // 0x130b Not
	if(var_390_bool == 0) goto Label_4879; // 0x130c JumpB
	var_377_bool = 0; // 0x130d MovB
	return 10; // 0x130e Return
	
Label_4879:
	var_391_bool = 0; // 0x130f PushV
	func_4959(var_387_float, var_391_bool); // 0x1310 NEW_2
	if(var_391_bool == 0) goto Label_4896; // 0x1312 JumpB
	GetPFPosition(var_383_cvector); // 0x1313 TObjFunc
	GetPFPosition(var_384_cvector); // 0x1315 Func
	var_385_cvector = var_383_cvector - var_384_cvector; // 0x1317 Sub2
	var_386_float = var_385_cvector | var_385_cvector; // 0x1318 Or2
	GetAttackDistance(var_387_float); // 0x1319 TObjFunc
	var_392_int = 50; // 0x131b PushI
	var_387_float = var_387_float + var_392_int; // 0x131c Add2
	var_393_float = var_387_float * var_387_float; // 0x131d Mult
	var_377_bool = var_386_float <= var_393_float; // 0x131e LE2
	return 10; // 0x131f Return
	
Label_4896:
	var_377_bool = 0; // 0x1320 MovB
...
func_4360(var_0_bool, var_3_object, var_5_bool, var_134_object, var_135_bool, var_136_float, var_211_bool, var_303_bool)
{
	...
	func_4589(var_156_cvector, var_157_bool, var_158_float); // 0x110a NEW_2
	var_5_bool = 0; // 0x110c TMovI
	var_181_string = "@GetAttackDistance"; // 0x110d PushS
	var_182_int = 1; // 0x110e PushI
	var_183_bool = IsFuncExist(var_134_object, var_181_string, var_182_int); // 0x110f FuncExist
	if(var_183_bool == 0) goto Label_4374; // 0x1110 JumpB
	GetAttackDistance(var_148_float); // 0x1111 ObjFunc
	var_184_int = 50; // 0x1113 PushI
	var_148_float = var_148_float + var_184_int; // 0x1114 Add2
	goto Label_4375; // 0x1115 Jump
	
Label_4375:
	var_185_int = 150; // 0x1117 PushI
	var_186_bool = var_148_float >= var_185_int; // 0x1118 GE
	if(var_186_bool == 0) goto Label_4379; // 0x1119 JumpB
	var_148_float = 150; // 0x111a MovI
	
Label_4379:
	var_3_object = 0; // 0x111b TMovB
	var_0_bool = var_134_object; // 0x111c TMov
	IsPlayerActor(var_0_bool, var_151_bool); // 0x111d Func
	var_187_bool = var_151_bool; // 0x111f Push
	if(var_187_bool == 0) goto Label_4393; // 0x1120 JumpB
	var_188_string = "attack"; // 0x1121 PushS
	PlayGlobalMusic(var_188_string); // 0x1122 Func
	var_189_object = Obj(); // 0x1124 PushV
	func_5875(var_189_object); // 0x1125 NEW_2
	SendPlayerEnemy(var_134_object, var_189_object); // 0x1127 Func
	
Label_4393:
	var_192_bool = var_135_bool; // 0x1129 Push
	if(var_192_bool == 0) goto Label_4397; // 0x112a JumpB
	var_152_bool = 0; // 0x112b MovB
	goto Label_4398; // 0x112c Jump
	
Label_4398:
	var_193_float = 400.0; // 0x112e PushF
	var_153_float = var_193_float + var_148_float; // 0x112f Add2
	
Label_4400:
	var_194_bool = 0; // 0x1130 PushV
	var_194_bool = 0; // 0x1131 MovB
	var_195_bool = 0; var_196_object = Obj(); // 0x1132 PushV
	var_196_object = var_0_bool; // 0x1133 MovT
	func_5445(var_195_bool, var_196_object); // 0x1134 NEW_2
	if(var_195_bool == 0) goto Label_4410; // 0x1136 JumpB
	var_197_bool = var_3_object == 0; // 0x1137 Not
	if(var_197_bool == 0) goto Label_4410; // 0x1138 JumpB
	var_194_bool = 1; // 0x1139 MovB
	
Label_4410:
	if(var_194_bool == 0) goto Label_4572; // 0x113a JumpB
	func_5002(var_158_float); // 0x113c NEW_2
	GetPFPosition(var_149_cvector); // 0x113e TObjFunc
	GetPFPosition(var_150_cvector); // 0x1140 Func
	var_154_cvector = var_149_cvector - var_150_cvector; // 0x1142 Sub2
	var_155_float = var_154_cvector | var_154_cvector; // 0x1143 Or2
	var_203_float = var_153_float * var_153_float; // 0x1144 Mult
	var_204_bool = var_155_float >= var_203_float; // 0x1145 GE
	if(var_204_bool == 0) goto Label_4438; // 0x1146 JumpB
	var_205_bool = 0; var_206_object = Obj(); var_207_float = 0; var_208_float = 0; var_209_bool = 0; var_210_bool = 0; // 0x1147 PushV
	var_206_object = var_0_bool; // 0x1148 MovT
	var_207_float = var_148_float; // 0x1149 Mov
	var_208_float = 3000.0; // 0x114a MovF
	var_209_bool = 1; // 0x114b MovB
	var_210_bool = 0; // 0x114c MovB
	TaskCall(8); // 0x114d TaskCall
	func_5029(var_213_bool, var_205_bool, var_206_object, var_207_float, var_208_float, var_209_bool, var_210_bool); // 0x114e NEW_2
	TaskReturn(); // 0x114f TaskReturn
	var_288_bool = var_211_bool == 0; // 0x1151 Not
	if(var_288_bool == 0) goto Label_4436; // 0x1152 JumpB
	goto Label_4572; // 0x1153 Jump
	
Label_4572:
	WaitForAnimEnd(); // 0x11dc Func
	var_289_object = var_3_object; // 0x11de PushT
	if(var_289_object == 0) goto Label_4577; // 0x11df JumpB
	return 22; // 0x11e0 Return
	
Label_4577:
	var_290_string = "all"; // 0x11e1 PushS
	var_291_string = "attack_off"; // 0x11e2 PushS
	PlayAnimation(var_290_string, var_291_string); // 0x11e3 Func
	WaitForAnimEnd(); // 0x11e5 Func
	var_292_bool = var_151_bool; // 0x11e7 Push
	if(var_292_bool == 0) goto Label_4588; // 0x11e8 JumpB
	var_293_float = 2.0; // 0x11e9 PushF
	Sleep(var_293_float); // 0x11ea Func
	
Label_4588:
	return 22; // 0x11ec Return
	
Label_4436:
	var_152_bool = 0; // 0x1154 MovB
...
Label_4438:
	var_294_float = var_136_float * var_136_float; // 0x1156 Mult
	var_295_bool = var_155_float >= var_294_float; // 0x1157 GE
	if(var_295_bool == 0) goto Label_4563; // 0x1158 JumpB
	GetPFPosition(var_156_cvector); // 0x1159 TObjFunc
	CanReachByPF(var_157_bool, var_156_cvector); // 0x115b Func
	var_296_bool = var_157_bool == 0; // 0x115d Not
	if(var_296_bool == 0) goto Label_4462; // 0x115e JumpB
	var_297_bool = 0; var_298_object = Obj(); var_299_float = 0; var_300_float = 0; var_301_bool = 0; var_302_bool = 0; // 0x115f PushV
	var_298_object = var_0_bool; // 0x1160 MovT
	var_299_float = var_148_float; // 0x1161 Mov
	var_300_float = 3000.0; // 0x1162 MovF
	var_301_bool = 1; // 0x1163 MovB
	var_302_bool = 0; // 0x1164 MovB
	TaskCall(8); // 0x1165 TaskCall
	func_5029(var_305_bool, var_297_bool, var_298_object, var_299_float, var_300_float, var_301_bool, var_302_bool); // 0x1166 NEW_2
	TaskReturn(); // 0x1167 TaskReturn
	var_306_bool = var_303_bool == 0; // 0x1169 Not
	if(var_306_bool == 0) goto Label_4460; // 0x116a JumpB
	goto Label_4572; // 0x116b Jump
	
Label_4460:
	var_152_bool = 0; // 0x116c MovB
	goto Label_4400; // 0x116d Jump
	
Label_4462:
	var_307_bool = var_152_bool == 0; // 0x116e Not
	if(var_307_bool == 0) goto Label_4487; // 0x116f JumpB
	var_308_object = Obj(); // 0x1170 PushV
	var_308_object = var_0_bool; // 0x1171 MovT
	func_5595(); // 0x1172 NEW_2
	var_317_string = "all"; // 0x1174 PushS
	var_318_string = "attack_on"; // 0x1175 PushS
	PlayAnimation(var_317_string, var_318_string); // 0x1176 Func
	WaitForAnimEnd(); // 0x1178 Func
	func_5002(var_158_float); // 0x117b NEW_2
	StopAsync(); // 0x117d Func
	var_152_bool = 1; // 0x117f MovB
	var_319_bool = 0; var_320_object = Obj(); // 0x1180 PushV
	var_320_object = var_0_bool; // 0x1181 MovT
	func_5445(var_319_bool, var_320_object); // 0x1182 NEW_2
	var_321_bool = var_319_bool == 0; // 0x1184 Not
	if(var_321_bool == 0) goto Label_4487; // 0x1185 JumpB
	goto Label_4572; // 0x1186 Jump
	
Label_4487:
	rand(var_158_float); // 0x1187 Func
	var_322_bool = 0; // 0x1189 PushV
	var_322_bool = 1; // 0x118a MovB
	var_323_float = 0.25; // 0x118b PushF
	var_324_bool = var_158_float < var_323_float; // 0x118c LT
	if(var_324_bool == 0) goto Label_4499; // 0x118d JumpB
	var_325_bool = 0; // 0x118e PushV
	func_4959(var_322_bool, var_325_bool); // 0x118f NEW_2
	if(var_325_bool == 0) goto Label_4499; // 0x1191 JumpB
	var_322_bool = 0; // 0x1192 MovB
	
Label_4499:
	if(var_322_bool == 0) goto Label_4516; // 0x1193 JumpB
	Face(var_0_bool); // 0x1194 Func
	func_5009(); // 0x1197 NEW_2
	var_360_string = "all"; // 0x1199 PushS
	var_361_string = "attack_stay"; // 0x119a PushS
	PlayAnimation(var_360_string, var_361_string); // 0x119b Func
	var_362_bool = 0; var_363_float = 0; // 0x119d PushV
	var_363_float = var_136_float; // 0x119e Mov
	func_4827(var_158_float, var_362_bool, var_363_float); // 0x119f NEW_2
...
Label_4516:
	...
	var_581_string = "all"; // 0x11a6 PushS
	var_582_string = "fjump"; // 0x11a7 PushS
	PlayAnimation(var_581_string, var_582_string); // 0x11a8 Func
	WaitForAnimEnd(); // 0x11aa Func
	func_5002(var_158_float); // 0x11ad NEW_2
	var_583_cvector = CVector(0.0, 0.0, 0.0); // 0x11af PushVec
	SetSpeed(var_583_cvector); // 0x11b0 Func
	Stop(); // 0x11b2 Func
	StopAsync(); // 0x11b4 Func
	var_584_bool = 0; // 0x11b6 PushV
	func_4959(var_158_float, var_584_bool); // 0x11b7 NEW_2
	var_585_bool = var_584_bool == 0; // 0x11b9 Not
	if(var_585_bool == 0) goto Label_4562; // 0x11ba JumpB
	var_586_bool = 0; var_587_object = Obj(); // 0x11bb PushV
	var_587_object = var_0_bool; // 0x11bc MovT
	func_5445(var_586_bool, var_587_object); // 0x11bd NEW_2
	var_588_bool = var_586_bool == 0; // 0x11bf Not
	if(var_588_bool == 0) goto Label_4546; // 0x11c0 JumpB
	goto Label_4572; // 0x11c1 Jump
	
Label_4546:
	GetPFPosition(var_149_cvector); // 0x11c2 TObjFunc
	GetPFPosition(var_150_cvector); // 0x11c4 Func
	var_154_cvector = var_149_cvector - var_150_cvector; // 0x11c6 Sub2
	var_155_float = var_154_cvector | var_154_cvector; // 0x11c7 Or2
	var_589_float = var_136_float * var_136_float; // 0x11c8 Mult
	var_590_bool = var_155_float < var_589_float; // 0x11c9 LT
	if(var_590_bool == 0) goto Label_4562; // 0x11ca JumpB
	var_591_bool = 0; var_592_float = 0; // 0x11cb PushV
	var_592_float = var_136_float; // 0x11cc Mov
	func_4663(var_158_float, var_591_bool, var_592_float); // 0x11cd NEW_2
	var_593_bool = var_591_bool == 0; // 0x11cf Not
	if(var_593_bool == 0) goto Label_4562; // 0x11d0 JumpB
	goto Label_4572; // 0x11d1 Jump
	
Label_4563:
	var_594_bool = 0; var_595_float = 0; // 0x11d3 PushV
	var_595_float = var_136_float; // 0x11d4 Mov
	func_4663(var_158_float, var_594_bool, var_595_float); // 0x11d5 NEW_2
	var_596_bool = var_594_bool == 0; // 0x11d7 Not
	if(var_596_bool == 0) goto Label_4570; // 0x11d8 JumpB
	goto Label_4572; // 0x11d9 Jump
	
Label_4570:
	var_152_bool = 1; // 0x11da MovB
	
Label_4397:
	var_152_bool = 1; // 0x112d MovB
	
Label_4374:
	var_148_float = var_136_float; // 0x1116 Mov
}


func_5898(var_522_float, var_523_float, var_524_float, var_525_float)
{
	var_526_bool = var_523_float < var_524_float; // 0x170b LT
	if(var_526_bool == 0) goto Label_5903; // 0x170c JumpB
	var_522_float = var_524_float; // 0x170d Mov
	return 0; // 0x170e Return
	
Label_5903:
	var_527_bool = var_523_float > var_525_float; // 0x170f GT
	if(var_527_bool == 0) goto Label_5907; // 0x1710 JumpB
	var_522_float = var_525_float; // 0x1711 Mov
	return 0; // 0x1712 Return
	
Label_5907:
	var_522_float = var_523_float; // 0x1713 Mov
...
{
	var_61_object = Obj(); // 0x1b0d PushV
	var_61_object = var_60_object; // 0x1b0e Mov
	func_6741(var_61_object); // 0x1b0f NEW_2
...
func_6938()
{
	return 0; // 0x1b1b Return
}


func_6940(var_104_int)
{
	var_104_int = 515558; // 0x1b1c MovI
...
{
	var_103_int = 503343; // 0x1b1e MovI
...
{
	var_105_string = "ui/NPC_Citizen3.png"; // 0x1b20 MovS
...
{
	var_106_string = "ui/NPC_Citizen3_b.png"; // 0x1b22 MovS
...
{
	var_376_bool = 0; // 0x1322 PushV
	var_376_bool = 0; // 0x1323 MovB
	var_377_bool = 0; // 0x1324 PushV
	func_4870(var_376_bool, var_377_bool); // 0x1325 NEW_2
	if(var_377_bool == 0) goto Label_4909; // 0x1327 JumpB
	var_394_bool = 0; // 0x1328 PushV
	func_4914(var_375_bool, var_376_bool, var_394_bool); // 0x1329 NEW_2
	if(var_394_bool == 0) goto Label_4909; // 0x132b JumpB
	var_376_bool = 1; // 0x132c MovB
	
Label_4909:
	if(var_376_bool == 0) goto Label_4912; // 0x132d JumpB
	var_375_bool = 1; // 0x132e MovB
	return 0; // 0x132f Return
	
Label_4912:
	var_375_bool = 0; // 0x1330 MovB
...
func_6950()
{
	var_20_bool = GlobalVars[0]; // 0x1b26 PushGE
	var_20_bool = 0; // 0x1b27 MovB
	GlobalVars[0] = var_20_bool; // 0x1b28 PopGE
	var_21_bool = 0; // 0x1b29 PushV
	var_21_bool = 1; // 0x1b2a MovB
	func_6430(var_21_bool); // 0x1b2b NEW_2
...
{
	var_32_bool = 0; var_33_bool = 0; // 0x1b2e PushV
	var_34_bool = GlobalVars[0]; // 0x1b2f PushGE
	if(var_34_bool == 0) goto Label_6971; // 0x1b30 JumpB
	IsOverrideActive(var_33_bool); // 0x1b31 Func
	var_35_bool = var_33_bool == 0; // 0x1b33 Not
	if(var_35_bool == 0) goto Label_6969; // 0x1b34 JumpB
	var_36_object = Obj(); // 0x1b35 PushV
	var_36_object = var_31_object; // 0x1b36 Mov
	func_6317(var_36_object); // 0x1b37 NEW_2
	
Label_6969:
	return 2; // 0x1b39 Return
	
Label_6971:
	var_43_int = 1000; // 0x1b3b PushI
	var_44_int = 0; var_45_object = Obj(); // 0x1b3c PushV
	var_45_object = var_31_object; // 0x1b3d Mov
	TaskCall(1); // 0x1b3e TaskCall
	func_40(var_46_object, var_44_int, var_45_object); // 0x1b3f NEW_2
	TaskReturn(); // 0x1b40 TaskReturn
	var_499_bool = var_43_int == var_46_object; // 0x1b42 Eq
	if(var_499_bool == 0) goto Label_6997; // 0x1b43 JumpB
	var_500_bool = 0; var_501_object = Obj(); // 0x1b44 PushV
	var_501_object = var_31_object; // 0x1b45 Mov
	func_5698(var_500_bool, var_501_object); // 0x1b46 NEW_2
	var_532_bool = var_500_bool == 0; // 0x1b48 Not
	if(var_532_bool == 0) goto Label_6987; // 0x1b49 JumpB
	return 2; // 0x1b4a Return
	
Label_6987:
	var_533_object = Obj(); // 0x1b4b PushV
	var_533_object = var_31_object; // 0x1b4c Mov
	TaskCall(0); // 0x1b4d TaskCall
	func_0(var_533_object); // 0x1b4e NEW_2
	TaskReturn(); // 0x1b4f TaskReturn
	var_540_object = Obj(); // 0x1b51 PushV
	var_540_object = var_31_object; // 0x1b52 Mov
	func_5754(); // 0x1b53 NEW_2
	
Label_6997:
	return 2; // 0x1b55 Return
}


func_4914(var_0_bool, var_4_string, var_394_bool)
{
	var_395_object = Obj(); var_396_bool = 0; var_397_float = 0; var_398_cvector = CVector(0,0,0); var_399_cvector = CVector(0,0,0); var_400_object = Obj(); var_401_bool = 0; var_402_float = 0; var_403_cvector = CVector(0,0,0); var_404_cvector = CVector(0,0,0); // 0x1332 PushV
	GetScene(var_400_object); // 0x1333 Func
	var_401_bool = 0; // 0x1335 MovB
	
Label_4918:
	var_405_cvector = CVector(0,0,0); var_406_object = Obj(); // 0x1336 PushV
	var_406_object = var_0_bool; // 0x1337 MovT
	func_5299(var_406_object); // 0x1338 NEW_2
	var_411_int = -var_405_cvector; // 0x133a Neg
	FindDirLength(var_402_float, var_411_int, var_402_float); // 0x133b Func
	var_412_bool = var_402_float < var_4_string; // 0x133d LT
	if(var_412_bool == 0) goto Label_4928; // 0x133e JumpB
	goto Label_4956; // 0x133f Jump
	
Label_4956:
	var_394_bool = var_401_bool; // 0x135c Mov
	return 10; // 0x135d Return
	
Label_4928:
	Face(var_0_bool); // 0x1340 Func
	var_413_string = "all"; // 0x1342 PushS
	var_414_string = "bjump"; // 0x1343 PushS
	PlayAnimation(var_413_string, var_414_string); // 0x1344 Func
	GetPFPosition(var_403_cvector); // 0x1346 TObjFunc
	GetPFPosition(var_404_cvector); // 0x1348 Func
	WaitForAnimEnd(); // 0x134a Func
	func_5002(var_404_cvector); // 0x134d NEW_2
	StopAsync(); // 0x134f Func
	var_415_cvector = CVector(0.0, 0.0, 0.0); // 0x1351 PushVec
	SetSpeed(var_415_cvector); // 0x1352 Func
	var_401_bool = 1; // 0x1354 MovB
	var_416_bool = 0; // 0x1355 PushV
	func_4870(var_404_cvector, var_416_bool); // 0x1356 NEW_2
	var_417_bool = var_416_bool == 0; // 0x1358 Not
	if(var_417_bool == 0) goto Label_4955; // 0x1359 JumpB
...
{
	var_531_object = Obj(); var_532_object = Obj(); // 0x1743 PushV
	CreateFloatVector(var_532_object); // 0x1744 Func
	add(var_530_float); // 0x1746 ObjFunc
	var_533_int = 0; // 0x1748 PushI
	var_534_bool = var_530_float < var_533_int; // 0x1749 LT
	if(var_534_bool == 0) goto Label_5967; // 0x174a JumpB
	var_535_float = 0.7; // 0x174b PushF
	var_536_int = 500; // 0x174c PushI
	RumblePlay(var_535_float, var_536_int); // 0x174d Func
	
Label_5967:
	var_537_int = 15; // 0x174f PushI
	SendWorldWndMessage(var_537_int, var_532_object); // 0x1750 Func
...
{
	var_28_bool = 0; var_29_object = Obj(); var_30_object = Obj(); var_31_float = 0; var_32_bool = 0; // 0x1b59 PushV
	var_29_object = var_25_object; // 0x1b5a Mov
	var_30_object = var_26_object; // 0x1b5b Mov
	var_31_float = 700.0; // 0x1b5c MovF
	var_32_bool = var_27_bool; // 0x1b5d Mov
	func_6855(var_28_bool, var_29_object, var_30_object, var_31_float, var_32_bool); // 0x1b5e NEW_2
	var_24_bool = var_28_bool; // 0x1b5f Mov
	return 0; // 0x1b61 Return
}
...
{
	var_326_bool = 0; var_327_bool = 0; // 0x135f PushV
	var_328_string = "IsAttacking"; // 0x1360 PushS
	var_329_int = 1; // 0x1361 PushI
	var_330_bool = IsFuncExist(var_0_bool, var_328_string, var_329_int); // 0x1362 FuncExist
	if(var_330_bool == 0) goto Label_4968; // 0x1363 JumpB
	IsAttacking(var_327_bool); // 0x1364 TObjFunc
	var_325_bool = var_327_bool; // 0x1366 Mov
	return 2; // 0x1367 Return
	
Label_4968:
	var_325_bool = 0; // 0x1368 MovB
...
{
	var_103_bool = 0; var_104_object = Obj(); // 0x1b63 PushV
	var_104_object = var_102_object; // 0x1b64 Mov
	func_5314(var_103_bool, var_104_object); // 0x1b65 NEW_2
	if(var_103_bool == 0) goto Label_7027; // 0x1b67 JumpB
	var_107_object = Obj(); // 0x1b68 PushV
	func_5875(var_107_object); // 0x1b69 NEW_2
	var_110_float = -0.1; // 0x1b6b PushF
	var_111_bool = 1; // 0x1b6c PushB
	ReportReputationChange(var_102_object, var_107_object, var_110_float, var_111_bool); // 0x1b6d Func
	var_112_bool = 0; // 0x1b6f PushV
	var_112_bool = 1; // 0x1b70 MovB
	func_6402(); // 0x1b71 NEW_2
	
Label_7027:
	func_6378(); // 0x1b74 NEW_2
	var_178_bool = GlobalVars[0]; // 0x1b76 PushGE
	var_178_bool = 1; // 0x1b77 MovB
	GlobalVars[0] = var_178_bool; // 0x1b78 PopGE
	var_179_int = 50; // 0x1b79 PushI
	var_180_int = 40; // 0x1b7a PushI
	SetRTEnvelope(var_179_int, var_180_int); // 0x1b7b Func
...
{
	var_442_float = 0; var_443_int = 0; var_444_float = 0; var_445_int = 0; // 0x136a PushV
	var_446_bool = var_2_object == 0; // 0x136b Not
	if(var_446_bool == 0) goto Label_4974; // 0x136c JumpB
	return 4; // 0x136d Return
	
Label_4974:
	var_447_bool = var_5_bool; // 0x136e PushT
	if(var_447_bool == 0) goto Label_4982; // 0x136f JumpB
	var_448_int = -1; // 0x1370 PushI
	var_5_bool = var_5_bool + var_448_int; // 0x1371 Add2
	var_449_int = 0; // 0x1372 PushI
	var_450_bool = var_5_bool > var_449_int; // 0x1373 GT
	if(var_450_bool == 0) goto Label_4982; // 0x1374 JumpB
	return 4; // 0x1375 Return
	
Label_4982:
	rand(var_444_float); // 0x1376 Func
	var_451_float = 0; // 0x1378 PushV
	func_5020(var_451_float); // 0x1379 NEW_2
	var_452_bool = var_444_float < var_451_float; // 0x137b LT
	if(var_452_bool == 0) goto Label_5001; // 0x137c JumpB
	irand(var_445_int, var_444_float); // 0x137d Func
	var_453_int = 1; // 0x137f PushI
	var_445_int = var_445_int + var_453_int; // 0x1380 Add2
	var_454_string = "attack"; // 0x1381 PushS
	var_455_int = var_454_string + var_445_int; // 0x1382 Add
	Speak(var_455_int); // 0x1383 Func
	var_456_int = 0; // 0x1385 PushV
	func_5018(var_456_int); // 0x1386 NEW_2
	var_5_bool = var_456_int; // 0x1387 TMov
...
func_5998()
{
	var_435_object = Obj(); var_436_object = Obj(); // 0x176e PushV
	GetScene(var_436_object); // 0x176f Func
	var_437_string = "battle"; // 0x1771 PushS
	var_438_object = Obj(); // 0x1772 PushV
	func_5875(var_438_object); // 0x1773 NEW_2
	BroadcastMessage(var_437_string, var_438_object, var_436_object); // 0x1775 Func
...
{
	var_198_object = Obj(); // 0x138a PushV
	var_198_object = var_0_bool; // 0x138b MovT
	func_5989(var_198_object); // 0x138c NEW_2
...
func_5009()
{
	var_331_string = ""; // 0x1391 PushV
	var_331_string = "attack_stay"; // 0x1392 MovS
	func_5834(var_331_string); // 0x1393 NEW_2
...
{
	var_214_bool = 0; var_215_bool = 0; var_216_bool = 0; var_217_bool = 0; // 0x13a5 PushV
	var_218_object = Obj(); // 0x13a6 PushV
	var_218_object = var_206_object; // 0x13a7 Mov
	func_5989(var_218_object); // 0x13a8 NEW_2
	var_219_int = 1; // 0x13aa PushI
	var_220_int = 5; // 0x13ab PushI
	SetTimer(var_219_int, var_220_int); // 0x13ac Func
	CanSee(var_216_bool, var_206_object); // 0x13ae Func
	var_221_bool = var_216_bool; // 0x13b0 Push
	if(var_221_bool == 0) goto Label_5048; // 0x13b1 JumpB
	var_2_object = 1; // 0x13b2 TMovB
	var_222_object = Obj(); // 0x13b3 PushV
	var_222_object = var_206_object; // 0x13b4 Mov
	func_5790(var_222_object); // 0x13b5 NEW_2
	goto Label_5049; // 0x13b7 Jump
	
Label_5049:
	var_229_bool = 0; var_230_object = Obj(); // 0x13b9 PushV
	var_230_object = var_206_object; // 0x13ba Mov
	func_5314(var_229_bool, var_230_object); // 0x13bb NEW_2
	if(var_229_bool == 0) goto Label_5059; // 0x13bd JumpB
	var_233_object = Obj(); // 0x13be PushV
	func_5875(var_233_object); // 0x13bf NEW_2
	SendPlayerEnemy(var_206_object, var_233_object); // 0x13c1 Func
	
Label_5059:
	var_234_bool = 0; var_235_object = Obj(); var_236_float = 0; var_237_float = 0; var_238_bool = 0; var_239_bool = 0; // 0x13c3 PushV
	var_235_object = var_206_object; // 0x13c4 Mov
	var_236_float = var_207_float; // 0x13c5 Mov
	var_237_float = var_208_float; // 0x13c6 Mov
	var_238_bool = var_209_bool; // 0x13c7 Mov
	var_239_bool = var_210_bool; // 0x13c8 Mov
	func_5134(var_216_bool, var_217_bool, var_234_bool, var_235_object, var_236_float, var_237_float, var_238_bool, var_239_bool); // 0x13c9 NEW_2
	var_217_bool = var_234_bool; // 0x13ca Mov
	var_285_object = var_2_object; // 0x13cc PushT
	if(var_285_object == 0) goto Label_5073; // 0x13cd JumpB
	var_286_string = "head"; // 0x13ce PushS
	UnlookAsync(var_286_string); // 0x13cf Func
	
Label_5073:
	var_287_int = 1; // 0x13d1 PushI
	KillTimer(var_287_int); // 0x13d2 Func
	var_205_bool = var_217_bool; // 0x13d4 Mov
...
func_6580(var_23_bool, var_24_object, var_25_string)
{
	...
	func_6904(var_29_object); // 0x19ba NEW_2
...
Label_6591:
	...
	func_6909(var_32_bool, var_33_object); // 0x19c4 NEW_2
...
Label_6601:
	...
	func_6930(var_50_object); // 0x19ce NEW_2
...
Label_6621:
	...
	func_6924(var_60_object); // 0x19e2 NEW_2
...
Label_5652:
	...
	func_6948(var_98_bool); // 0x161e NEW_2
...
func_6637(var_20_bool, var_21_object)
{
	...
	func_6904(var_26_object); // 0x19f2 NEW_2
...
{
	var_159_bool = 0; var_160_bool = 0; var_161_cvector = CVector(0,0,0); var_162_bool = 0; var_163_bool = 0; var_164_cvector = CVector(0,0,0); // 0x11ed PushV
	var_1_object = 0; // 0x11ee TMovI
	
Label_4591:
	var_165_string = "all"; // 0x11ef PushS
	var_166_string = "attack_begin"; // 0x11f0 PushS
	var_167_int = 1; // 0x11f1 PushI
	var_168_int = var_1_object + var_167_int; // 0x11f2 Add
	var_169_int = var_166_string + var_168_int; // 0x11f3 Add
	HasAnimation(var_162_bool, var_165_string, var_169_int); // 0x11f4 Func
	var_170_bool = var_162_bool == 0; // 0x11f6 Not
	if(var_170_bool == 0) goto Label_4601; // 0x11f7 JumpB
...
Label_4605:
	var_171_string = "attack"; // 0x11fd PushS
	var_172_int = 1; // 0x11fe PushI
	var_173_int = var_2_object + var_172_int; // 0x11ff Add
	var_174_int = var_171_string + var_173_int; // 0x1200 Add
	IsExisting3DSound(var_163_bool, var_174_int); // 0x1201 Func
	var_175_bool = var_163_bool == 0; // 0x1203 Not
	if(var_175_bool == 0) goto Label_4614; // 0x1204 JumpB
	goto Label_4617; // 0x1205 Jump
	
Label_4617:
	var_176_string = "all"; // 0x1209 PushS
	var_177_string = "bjump"; // 0x120a PushS
	GetAnimationOffset(var_164_cvector, var_176_string, var_177_string); // 0x120b Func
	var_178_float = GetByIndex(var_164_cvector, 2); // 0x120d PushE
	var_4_string = -var_178_float; // 0x120e Neg2
	return 6; // 0x120f Return
	
Label_4614:
	var_179_int = 1; // 0x1206 PushI
	var_2_object = var_2_object + var_179_int; // 0x1207 Add2
	goto Label_4605; // 0x1208 Jump
	
Label_4601:
	var_180_int = 1; // 0x11f9 PushI
	var_1_object = var_1_object + var_180_int; // 0x11fa Add2
