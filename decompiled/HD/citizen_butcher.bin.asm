...
0xc3c: Push(Stack[-1])
0xc3d: IF (Stack[-1] == 0) GOTO 0xc46; Pop(1)
...
0xc6c: Stack[-4] = Stack[-8]
0xc6d: Stack[-3] = Stack[-7]
0xc6e: Stack[-2] = (float) 700.0
0xc6f: Stack[-1] = Stack[-6]
0xc70: Call2 0xc02

0xc71: Stack[-9] = Stack[-5]
0xc72: Pop(5)
0xc73: Return(); Pop(0)
