task_0_event_0(var_0_object, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3040(var_20_object); // 0x12 NEW_2
	...
	func_3043(var_23_object); // 0x1a NEW_2
...
task_1_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3040(var_20_object); // 0xb7 NEW_2
...
Label_195:
	...
	func_3043(var_26_object); // 0xc5 NEW_2
...
task_1_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2812(var_19_object); // 0xcb NEW_2
	var_28_int = 0; var_29_object = Obj(); // 0xcd PushV
	var_29_object = var_16_bool; // 0xce Mov
	func_2895(var_28_int, var_29_object); // 0xcf NEW_2
...
Label_219:
	...
	func_2905(var_69_object); // 0xdd NEW_2
...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_cvector, var_18_bool)
{
	...
	func_3096(var_21_bool, var_22_object, var_23_object, var_24_bool); // 0xe5 NEW_2
	...
	func_2988(var_84_object, var_85_bool); // 0xeb NEW_2
...
Label_247:
	...
	func_2995(var_121_object); // 0xf9 NEW_2
...
task_1_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3030(var_20_object); // 0xff NEW_2
...
task_1_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_cvector, var_17_bool)
{
	...
	func_2726(var_20_bool, var_21_object, var_22_string); // 0x114 NEW_2
	...
	func_2758(var_49_object, var_50_string); // 0x11d NEW_2
...
Label_288:
	...
	func_3035(var_134_object); // 0x123 NEW_2
...
task_1_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2825(var_17_bool, var_18_string); // 0x138 NEW_2
	...
	func_2841(var_27_string); // 0x140 NEW_2
...
task_1_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2783(var_17_bool, var_18_object); // 0x146 NEW_2
	...
	func_2806(var_30_object); // 0x14e NEW_2
...
task_2_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3040(var_20_object); // 0x210 NEW_2
...
Label_540:
	...
	func_3043(var_25_object); // 0x21e NEW_2
...
task_2_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2812(var_19_object); // 0x224 NEW_2
	var_28_int = 0; var_29_object = Obj(); // 0x226 PushV
	var_29_object = var_16_bool; // 0x227 Mov
	func_2895(var_28_int, var_29_object); // 0x228 NEW_2
...
Label_564:
	...
	func_2905(var_68_object); // 0x236 NEW_2
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_cvector, var_18_bool)
{
	...
	func_3096(var_21_bool, var_22_object, var_23_object, var_24_bool); // 0x23e NEW_2
	...
	func_2988(var_84_object, var_85_bool); // 0x244 NEW_2
...
Label_592:
	...
	func_2995(var_120_object); // 0x252 NEW_2
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3030(var_20_object); // 0x258 NEW_2
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_cvector, var_17_bool)
{
	...
	func_2726(var_20_bool, var_21_object, var_22_string); // 0x26d NEW_2
	...
	func_2758(var_48_object, var_49_string); // 0x276 NEW_2
...
Label_633:
	...
	func_3035(var_133_object); // 0x27c NEW_2
...
task_2_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2825(var_17_bool, var_18_string); // 0x291 NEW_2
	...
	func_2841(var_26_string); // 0x299 NEW_2
...
task_2_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2783(var_17_bool, var_18_object); // 0x2a6 NEW_2
	...
	func_2806(var_29_object); // 0x2ae NEW_2
...
task_3_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3040(var_20_object); // 0x342 NEW_2
...
Label_846:
	...
	func_3043(var_27_object); // 0x350 NEW_2
...
task_3_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2812(var_19_object); // 0x356 NEW_2
	var_28_int = 0; var_29_object = Obj(); // 0x358 PushV
	var_29_object = var_16_bool; // 0x359 Mov
	func_2895(var_28_int, var_29_object); // 0x35a NEW_2
...
Label_870:
	...
	func_2905(var_70_object); // 0x368 NEW_2
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_cvector, var_18_bool)
{
	...
	func_3096(var_21_bool, var_22_object, var_23_object, var_24_bool); // 0x370 NEW_2
	...
	func_2988(var_84_object, var_85_bool); // 0x376 NEW_2
...
Label_898:
	...
	func_2995(var_122_object); // 0x384 NEW_2
...
task_3_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_3030(var_20_object); // 0x38a NEW_2
...
task_3_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_string, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_cvector, var_17_bool)
{
	...
	func_2726(var_20_bool, var_21_object, var_22_string); // 0x39f NEW_2
	...
	func_2758(var_50_object, var_51_string); // 0x3a8 NEW_2
...
Label_939:
	...
	func_3035(var_135_object); // 0x3ae NEW_2
...
task_3_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2825(var_17_bool, var_18_string); // 0x3c3 NEW_2
	...
	func_2841(var_28_string); // 0x3cb NEW_2
...
task_3_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2783(var_17_bool, var_18_object); // 0x40f NEW_2
	...
	func_2806(var_31_object); // 0x417 NEW_2
...
task_5_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool, var_13_int, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2661(var_19_object); // 0x6fc NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0xa81 PushV
	var_20_string = "health"; // 0xa82 PushS
	var_21_bool = var_17_string == var_20_string; // 0xa83 Eq
	if(var_21_bool == 0) goto Label_2701; // 0xa84 JumpB
	var_22_string = "health"; // 0xa85 PushS
	GetProperty(var_22_string, var_19_float); // 0xa86 Func
	var_23_int = 0; // 0xa88 PushI
	var_24_bool = var_19_float <= var_23_int; // 0xa89 LE
	if(var_24_bool == 0) goto Label_2701; // 0xa8a JumpB
	SignalDeath(var_16_object); // 0xa8b Func
...
{
	var_17_object = Obj(); // 0xa8f PushV
	var_17_object = var_16_object; // 0xa90 Mov
	func_2681(var_17_object); // 0xa91 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0xa95 PushV
	var_20_object = var_16_object; // 0xa96 Mov
	var_21_int = var_17_int; // 0xa97 Mov
	var_22_float = var_18_float; // 0xa98 Mov
	func_2416(var_20_object, var_21_int, var_22_float); // 0xa99 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0xa9d PushV
	var_22_object = var_16_object; // 0xa9e Mov
	var_23_int = var_17_int; // 0xa9f Mov
	var_24_float = var_18_float; // 0xaa0 Mov
	var_25_cvector = var_20_cvector; // 0xaa1 Mov
	var_26_cvector = var_21_cvector; // 0xaa2 Mov
	func_2484(var_24_float, var_25_cvector, var_26_cvector); // 0xaa3 NEW_2
...
func_0(var_18_object)
{
	...
	func_3106(var_99_object); // 0x8 NEW_2
...
func_3088()
{
	var_17_bool = GlobalVars[0]; // 0xc10 PushGE
	var_17_bool = 0; // 0xc11 MovB
	GlobalVars[0] = var_17_bool; // 0xc12 PopGE
...
{
	var_25_bool = 0; var_26_object = Obj(); var_27_object = Obj(); var_28_float = 0; var_29_bool = 0; // 0xc19 PushV
	var_26_object = var_22_object; // 0xc1a Mov
	var_27_object = var_23_object; // 0xc1b Mov
	var_28_float = 500.0; // 0xc1c MovF
	var_29_bool = var_24_bool; // 0xc1d Mov
	func_3001(var_25_bool, var_26_object, var_27_object, var_28_float, var_29_bool); // 0xc1e NEW_2
	var_21_bool = var_25_bool; // 0xc1f Mov
...
{
	var_100_bool = 0; var_101_object = Obj(); // 0xc23 PushV
	var_101_object = var_99_object; // 0xc24 Mov
	func_2217(var_100_bool, var_101_object); // 0xc25 NEW_2
	if(var_100_bool == 0) goto Label_3119; // 0xc27 JumpB
	var_104_object = Obj(); // 0xc28 PushV
	func_2566(var_104_object); // 0xc29 NEW_2
	var_107_float = 0.0; // 0xc2b PushF
	var_108_bool = 1; // 0xc2c PushB
	ReportReputationChange(var_99_object, var_104_object, var_107_float, var_108_bool); // 0xc2d Func
	
Label_3119:
	var_109_bool = GlobalVars[0]; // 0xc2f PushGE
	var_109_bool = 1; // 0xc30 MovB
	GlobalVars[0] = var_109_bool; // 0xc31 PopGE
	var_110_int = 50; // 0xc32 PushI
	var_111_int = 40; // 0xc33 PushI
	SetRTEnvelope(var_110_int, var_111_int); // 0xc34 Func
...
Label_1220:
	...
	var_578_string = "all"; // 0x4c6 PushS
	var_579_string = "fjump"; // 0x4c7 PushS
	PlayAnimation(var_578_string, var_579_string); // 0x4c8 Func
	WaitForAnimEnd(); // 0x4ca Func
	func_1706(var_155_float); // 0x4cd NEW_2
	var_580_cvector = CVector(0.0, 0.0, 0.0); // 0x4cf PushVec
	SetSpeed(var_580_cvector); // 0x4d0 Func
	Stop(); // 0x4d2 Func
	StopAsync(); // 0x4d4 Func
	var_581_bool = 0; // 0x4d6 PushV
	func_1663(var_155_float, var_581_bool); // 0x4d7 NEW_2
	var_582_bool = var_581_bool == 0; // 0x4d9 Not
	if(var_582_bool == 0) goto Label_1266; // 0x4da JumpB
	var_583_bool = 0; var_584_object = Obj(); // 0x4db PushV
	var_584_object = var_0_bool; // 0x4dc MovT
	func_2348(var_583_bool, var_584_object); // 0x4dd NEW_2
	var_585_bool = var_583_bool == 0; // 0x4df Not
	if(var_585_bool == 0) goto Label_1250; // 0x4e0 JumpB
...
Label_1250:
	...
	var_586_float = var_133_float * var_133_float; // 0x4e8 Mult
	var_587_bool = var_152_float < var_586_float; // 0x4e9 LT
	if(var_587_bool == 0) goto Label_1266; // 0x4ea JumpB
	var_588_bool = 0; var_589_float = 0; // 0x4eb PushV
	var_589_float = var_133_float; // 0x4ec Mov
	func_1367(var_155_float, var_588_bool, var_589_float); // 0x4ed NEW_2
	var_590_bool = var_588_bool == 0; // 0x4ef Not
	if(var_590_bool == 0) goto Label_1266; // 0x4f0 JumpB
	goto Label_1276; // 0x4f1 Jump
	
Label_1267:
	var_591_bool = 0; var_592_float = 0; // 0x4f3 PushV
	var_592_float = var_133_float; // 0x4f4 Mov
	func_1367(var_155_float, var_591_bool, var_592_float); // 0x4f5 NEW_2
	var_593_bool = var_591_bool == 0; // 0x4f7 Not
	if(var_593_bool == 0) goto Label_1274; // 0x4f8 JumpB
...
func_2644(var_527_float)
{
	...
	var_530_int = 0; // 0xa59 PushI
	var_531_bool = var_527_float < var_530_int; // 0xa5a LT
	if(var_531_bool == 0) goto Label_2656; // 0xa5b JumpB
	var_532_float = 0.7; // 0xa5c PushF
	var_533_int = 500; // 0xa5d PushI
	RumblePlay(var_532_float, var_533_int); // 0xa5e Func
	
Label_2656:
	var_534_int = 15; // 0xa60 PushI
	SendWorldWndMessage(var_534_int, var_529_object); // 0xa61 Func
...
{
	var_58_object = Obj(); // 0xbff PushV
	var_58_object = var_57_object; // 0xc00 Mov
	TaskCall(6); // 0xc01 TaskCall
	func_2026(var_59_object, var_60_cvector, var_61_bool, var_58_object); // 0xc02 NEW_2
	TaskReturn(); // 0xc03 TaskReturn
...
{
	var_20_bool = 0; var_21_bool = 0; // 0xa65 PushV
	IsPlayerActor(var_19_object, var_21_bool); // 0xa66 Func
	var_22_bool = var_21_bool; // 0xa68 Push
	if(var_22_bool == 0) goto Label_2669; // 0xa69 JumpB
	var_23_string = "attack"; // 0xa6a PushS
	PlayGlobalMusic(var_23_string); // 0xa6b Func
...
func_2670()
{
	var_432_object = Obj(); var_433_object = Obj(); // 0xa6e PushV
	GetScene(var_433_object); // 0xa6f Func
	var_434_string = "battle"; // 0xa71 PushS
	var_435_object = Obj(); // 0xa72 PushV
	func_2566(var_435_object); // 0xa73 NEW_2
	BroadcastMessage(var_434_string, var_435_object, var_433_object); // 0xa75 Func
...
{
	var_18_object = Obj(); // 0xa7a PushV
	var_18_object = var_17_object; // 0xa7b Mov
	TaskCall(0); // 0xa7c TaskCall
	func_0(var_18_object); // 0xa7d NEW_2
...
{
	var_23_string = "unholster"; // 0xaa7 PushS
	var_24_bool = var_22_string == var_23_string; // 0xaa8 Eq
	if(var_24_bool == 0) goto Label_2737; // 0xaa9 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0xaaa PushV
	var_26_object = var_21_object; // 0xaab Mov
	func_3050(var_26_object); // 0xaac NEW_2
	var_20_bool = var_25_bool; // 0xaad Mov
	return 0; // 0xaaf Return
	
Label_2737:
	var_27_string = "player_shot"; // 0xab1 PushS
	var_28_bool = var_22_string == var_27_string; // 0xab2 Eq
	if(var_28_bool == 0) goto Label_2747; // 0xab3 JumpB
	var_29_bool = 0; var_30_object = Obj(); // 0xab4 PushV
	var_30_object = var_21_object; // 0xab5 Mov
	func_3055(var_29_bool, var_30_object); // 0xab6 NEW_2
	var_20_bool = var_29_bool; // 0xab7 Mov
	return 0; // 0xab9 Return
	
Label_2747:
	var_44_string = "battle"; // 0xabb PushS
	var_45_bool = var_22_string == var_44_string; // 0xabc Eq
	if(var_45_bool == 0) goto Label_2756; // 0xabd JumpB
	var_46_bool = 0; var_47_object = Obj(); // 0xabe PushV
	var_47_object = var_21_object; // 0xabf Mov
	func_3078(var_47_object); // 0xac0 NEW_2
	var_20_bool = var_46_bool; // 0xac1 Mov
...
func_1706(var_0_bool)
{
	...
	func_2661(var_195_object); // 0x6ac NEW_2
...
Label_698:
	...
	func_2861(var_65_int); // 0x2bb NEW_2
...
Label_713:
	...
	func_2854(var_87_string, var_88_int); // 0x2d7 NEW_2
...
Label_2253:
	var_535_string = "armor"; // 0x8cd PushS
	GetProperty(var_535_string, var_484_int); // 0x8ce ObjFunc
}
...
func_1733(var_2_bool, var_202_bool, var_203_object, var_204_float, var_205_float, var_206_bool, var_207_bool)
{
	...
	func_2661(var_215_object); // 0x6c8 NEW_2
...
{
	var_52_string = "unholster"; // 0xac7 PushS
	var_53_bool = var_51_string == var_52_string; // 0xac8 Eq
	if(var_53_bool == 0) goto Label_2767; // 0xac9 JumpB
	var_54_object = Obj(); // 0xaca PushV
	var_54_object = var_50_object; // 0xacb Mov
	func_3053(); // 0xacc NEW_2
	goto Label_2782; // 0xace Jump
	
Label_2782:
	return 0; // 0xade Return
	
Label_2767:
	var_55_string = "player_shot"; // 0xacf PushS
	var_56_bool = var_51_string == var_55_string; // 0xad0 Eq
	if(var_56_bool == 0) goto Label_2775; // 0xad1 JumpB
	var_57_object = Obj(); // 0xad2 PushV
	var_57_object = var_50_object; // 0xad3 Mov
	func_3070(var_57_object); // 0xad4 NEW_2
	goto Label_2782; // 0xad6 Jump
	
Label_2775:
	var_130_string = "battle"; // 0xad7 PushS
	var_131_bool = var_51_string == var_130_string; // 0xad8 Eq
	if(var_131_bool == 0) goto Label_2782; // 0xad9 JumpB
	var_132_object = Obj(); // 0xada PushV
	var_132_object = var_50_object; // 0xadb Mov
	func_3081(); // 0xadc NEW_2
}


func_2783(var_17_bool, var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0xadf PushV
	var_21_bool = 0; // 0xae0 PushV
	var_21_bool = 0; // 0xae1 MovB
	var_22_bool = 0; var_23_object = Obj(); // 0xae2 PushV
	var_23_object = var_18_object; // 0xae3 Mov
	func_3050(var_23_object); // 0xae4 NEW_2
	if(var_22_bool == 0) goto Label_2797; // 0xae6 JumpB
	var_24_bool = 0; var_25_object = Obj(); // 0xae7 PushV
	var_25_object = var_18_object; // 0xae8 Mov
	func_2217(var_24_bool, var_25_object); // 0xae9 NEW_2
	if(var_24_bool == 0) goto Label_2797; // 0xaeb JumpB
	var_21_bool = 1; // 0xaec MovB
	
Label_2797:
	if(var_21_bool == 0) goto Label_2804; // 0xaed JumpB
	IsWeaponHolstered(var_20_bool); // 0xaee ObjFunc
	var_28_bool = var_20_bool == 0; // 0xaf0 Not
	if(var_28_bool == 0) goto Label_2804; // 0xaf1 JumpB
	var_17_bool = 1; // 0xaf2 MovB
	return 2; // 0xaf3 Return
	
Label_2804:
	var_17_bool = 0; // 0xaf4 MovB
...
{
	var_32_object = Obj(); // 0xaf7 PushV
	var_32_object = var_31_object; // 0xaf8 Mov
	func_3053(); // 0xaf9 NEW_2
...
{
	var_20_bool = 0; var_21_object = Obj(); // 0xafd PushV
	var_21_object = var_19_object; // 0xafe Mov
	func_2217(var_20_bool, var_21_object); // 0xaff NEW_2
	if(var_20_bool == 0) goto Label_2824; // 0xb01 JumpB
	var_24_object = Obj(); // 0xb02 PushV
	func_2566(var_24_object); // 0xb03 NEW_2
	var_27_float = 0.0; // 0xb05 PushF
	ReportReputationChange(var_19_object, var_24_object, var_27_float); // 0xb06 Func
...
{
	var_19_object = Obj(); var_20_object = Obj(); // 0xb09 PushV
	var_21_string = "heal"; // 0xb0a PushS
	var_22_bool = var_18_string == var_21_string; // 0xb0b Eq
	if(var_22_bool == 0) goto Label_2839; // 0xb0c JumpB
	var_23_string = "player"; // 0xb0d PushS
	FindActor(var_20_object, var_23_string); // 0xb0e Func
	var_24_bool = 0; var_25_object = Obj(); // 0xb10 PushV
	var_25_object = var_20_object; // 0xb11 Mov
	func_3083(var_25_object); // 0xb12 NEW_2
	var_17_bool = var_24_bool; // 0xb13 Mov
	return 2; // 0xb15 Return
	
Label_2839:
	var_17_bool = 0; // 0xb17 MovB
...
{
	var_29_object = Obj(); var_30_object = Obj(); // 0xb19 PushV
	var_31_string = "heal"; // 0xb1a PushS
	var_32_bool = var_28_string == var_31_string; // 0xb1b Eq
	if(var_32_bool == 0) goto Label_2853; // 0xb1c JumpB
	var_33_string = "player"; // 0xb1d PushS
	FindActor(var_30_object, var_33_string); // 0xb1e Func
	var_34_object = Obj(); // 0xb20 PushV
	var_34_object = var_30_object; // 0xb21 Mov
	func_3086(); // 0xb22 NEW_2
	var_30_object = 0; // 0xb24 SetNull
...
{
	var_73_string = ""; var_74_string = ""; // 0xb26 PushV
	var_74_string = "idle"; // 0xb27 MovS
	var_75_int = var_72_int; // 0xb28 Push
	if(var_75_int == 0) goto Label_2859; // 0xb29 JumpB
	var_74_string = var_74_string + var_72_int; // 0xb2a Add2
	
Label_2859:
	var_71_string = var_74_string; // 0xb2b Mov
...
{
	var_66_int = 0; var_67_bool = 0; var_68_int = 0; var_69_bool = 0; // 0xb2d PushV
	var_68_int = 0; // 0xb2e MovI
	
Label_2863:
	var_70_string = "all"; // 0xb2f PushS
	var_71_string = ""; var_72_int = 0; // 0xb30 PushV
	var_72_int = var_68_int; // 0xb31 Mov
	func_2854(var_71_string, var_72_int); // 0xb32 NEW_2
	HasAnimation(var_69_bool, var_70_string, var_71_string); // 0xb34 Func
	var_76_bool = var_69_bool == 0; // 0xb36 Not
	if(var_76_bool == 0) goto Label_2873; // 0xb37 JumpB
	goto Label_2876; // 0xb38 Jump
	
Label_2876:
	var_65_int = var_68_int; // 0xb3c Mov
	return 4; // 0xb3d Return
	
Label_2873:
	var_77_int = 1; // 0xb39 PushI
	var_68_int = var_68_int + var_77_int; // 0xb3a Add2
	goto Label_2863; // 0xb3b Jump
}
...
func_1328(var_0_bool, var_457_float, var_458_int)
{
	...
	var_536_int = 0; // 0x54b PushV
	func_1711(var_536_int); // 0x54c NEW_2
	ReportHit(var_0_bool, var_536_int, var_464_float, var_463_float); // 0x54e Func
	var_537_object = Obj(); var_538_float = 0; // 0x550 PushV
	var_537_object = var_462_object; // 0x551 Mov
	var_538_float = var_464_float; // 0x552 Mov
...
{
	var_61_bool = 0; // 0xb3f PushV
	func_3094(var_61_bool); // 0xb40 NEW_2
	if(var_61_bool == 0) goto Label_2885; // 0xb42 JumpB
	var_59_int = 2; // 0xb43 MovI
	goto Label_2886; // 0xb44 Jump
	
Label_2886:
	return 0; // 0xb46 Return
	
Label_2885:
	var_59_int = 0; // 0xb45 MovI
}
...
{
	var_68_object = Obj(); // 0xb48 PushV
	var_68_object = var_67_object; // 0xb49 Mov
	TaskCall(3); // 0xb4a TaskCall
	func_775(var_69_object, var_68_object); // 0xb4b NEW_2
	TaskReturn(); // 0xb4c TaskReturn
...
{
	var_88_bool = 0; var_89_object = Obj(); // 0xb50 PushV
	var_89_object = var_87_object; // 0xb51 Mov
	func_2348(var_88_bool, var_89_object); // 0xb52 NEW_2
	if(var_88_bool == 0) goto Label_2903; // 0xb54 JumpB
	var_86_int = 2; // 0xb55 MovI
...
Label_1403:
	...
	var_539_string = "all"; // 0x580 PushS
	var_540_string = "attack_middle"; // 0x581 PushS
	var_541_int = var_540_string + var_426_int; // 0x582 Add
	HasAnimation(var_427_bool, var_539_string, var_541_int); // 0x583 Func
	var_542_bool = var_427_bool; // 0x585 Push
	if(var_542_bool == 0) goto Label_1484; // 0x586 JumpB
	func_2670(); // 0x588 NEW_2
	var_543_string = "all"; // 0x58a PushS
	var_544_string = "attack_middle"; // 0x58b PushS
	var_545_int = var_544_string + var_426_int; // 0x58c Add
	PlayAnimation(var_543_string, var_545_int); // 0x58d Func
	WaitForAnimEnd(); // 0x58f Func
	func_1706(var_429_string); // 0x592 NEW_2
	var_546_bool = 0; var_547_object = Obj(); // 0x594 PushV
	var_547_object = var_0_bool; // 0x595 MovT
	func_2348(var_546_bool, var_547_object); // 0x596 NEW_2
	var_548_bool = var_546_bool == 0; // 0x598 Not
	if(var_548_bool == 0) goto Label_1438; // 0x599 JumpB
	StopAsync(); // 0x59a Func
	var_420_bool = 0; // 0x59c MovB
	return 8; // 0x59d Return
	
Label_1438:
	var_549_float = 0; var_550_int = 0; // 0x59e PushV
	var_549_float = var_421_float; // 0x59f Mov
	var_550_int = var_426_int; // 0x5a0 Mov
	func_1328(var_429_string, var_549_float, var_550_int); // 0x5a1 NEW_2
	var_428_int = 1; // 0x5a3 MovI
	
Label_1444:
	var_551_string = "attack_middle"; // 0x5a4 PushS
	var_552_int = var_551_string + var_426_int; // 0x5a5 Add
	var_553_string = "_"; // 0x5a6 PushS
	var_554_int = var_552_int + var_553_string; // 0x5a7 Add
	var_429_string = var_554_int + var_428_int; // 0x5a8 Add2
	var_555_string = "all"; // 0x5a9 PushS
	HasAnimation(var_427_bool, var_555_string, var_429_string); // 0x5aa Func
	var_556_bool = var_427_bool == 0; // 0x5ac Not
	if(var_556_bool == 0) goto Label_1455; // 0x5ad JumpB
	goto Label_1484; // 0x5ae Jump
	
Label_1484:
	var_557_bool = 0; // 0x5cc PushB
	SetAttackState(var_557_bool); // 0x5cd Func
	var_558_string = "all"; // 0x5cf PushS
	var_559_string = "attack_end"; // 0x5d0 PushS
	var_560_int = var_559_string + var_426_int; // 0x5d1 Add
	PlayAnimation(var_558_string, var_560_int); // 0x5d2 Func
	var_561_bool = 0; // 0x5d4 PushV
	func_1720(var_561_bool); // 0x5d5 NEW_2
	if(var_561_bool == 0) goto Label_1502; // 0x5d7 JumpB
	var_562_bool = 0; var_563_float = 0; // 0x5d8 PushV
	var_563_float = 0.75; // 0x5d9 MovF
	func_1504(var_562_bool, var_563_float); // 0x5da NEW_2
...
Label_1455:
	func_2670(); // 0x5b0 NEW_2
	var_571_string = "all"; // 0x5b2 PushS
	PlayAnimation(var_571_string, var_429_string); // 0x5b3 Func
	WaitForAnimEnd(); // 0x5b5 Func
	func_1706(var_429_string); // 0x5b8 NEW_2
	var_572_bool = 0; var_573_object = Obj(); // 0x5ba PushV
	var_573_object = var_0_bool; // 0x5bb MovT
	func_2348(var_572_bool, var_573_object); // 0x5bc NEW_2
	var_574_bool = var_572_bool == 0; // 0x5be Not
	if(var_574_bool == 0) goto Label_1476; // 0x5bf JumpB
	StopAsync(); // 0x5c0 Func
	var_420_bool = 0; // 0x5c2 MovB
	return 8; // 0x5c3 Return
	
Label_1476:
	var_575_float = 0; var_576_int = 0; // 0x5c4 PushV
	var_575_float = var_421_float; // 0x5c5 Mov
	var_576_int = var_426_int; // 0x5c6 Mov
	func_1328(var_429_string, var_575_float, var_576_int); // 0x5c7 NEW_2
	var_577_int = 1; // 0x5c9 PushI
	var_428_int = var_428_int + var_577_int; // 0x5ca Add2
...
{
	var_124_object = Obj(); // 0xb5a PushV
	var_124_object = var_123_object; // 0xb5b Mov
	TaskCall(4); // 0xb5c TaskCall
	func_1050(var_124_object); // 0xb5d NEW_2
	TaskReturn(); // 0xb5e TaskReturn
...
{
	var_35_string = ""; var_36_string = ""; var_37_string = ""; var_38_string = ""; // 0xb61 PushV
	var_39_bool = 0; var_40_object = Obj(); var_41_string = ""; // 0xb62 PushV
	var_40_object = var_33_object; // 0xb63 Mov
	var_41_string = "class"; // 0xb64 MovS
	func_2222(var_39_bool, var_40_object, var_41_string); // 0xb65 NEW_2
	var_48_bool = var_39_bool == 0; // 0xb67 Not
	if(var_48_bool == 0) goto Label_2923; // 0xb68 JumpB
	var_32_bool = 0; // 0xb69 MovB
	return 4; // 0xb6a Return
	
Label_2923:
	var_49_string = "class"; // 0xb6b PushS
	GetProperty(var_49_string, var_37_string); // 0xb6c Func
	var_50_string = "class"; // 0xb6e PushS
	GetProperty(var_50_string, var_38_string); // 0xb6f ObjFunc
	var_51_bool = 0; // 0xb71 PushV
	var_51_bool = 0; // 0xb72 MovB
	var_52_bool = var_34_bool == 0; // 0xb73 Not
	if(var_52_bool == 0) goto Label_2936; // 0xb74 JumpB
	var_53_bool = var_37_string == var_38_string; // 0xb75 Eq
	if(var_53_bool == 0) goto Label_2936; // 0xb76 JumpB
	var_51_bool = 1; // 0xb77 MovB
	
Label_2936:
	if(var_51_bool == 0) goto Label_2939; // 0xb78 JumpB
	var_32_bool = 1; // 0xb79 MovB
	return 4; // 0xb7a Return
	
Label_2939:
	var_54_string = "rat"; // 0xb7b PushS
	var_55_bool = var_38_string == var_54_string; // 0xb7c Eq
	if(var_55_bool == 0) goto Label_2945; // 0xb7d JumpB
	var_32_bool = 0; // 0xb7e MovB
	return 4; // 0xb7f Return
	
Label_2945:
	var_56_string = "rat_big"; // 0xb81 PushS
	var_57_bool = var_38_string == var_56_string; // 0xb82 Eq
	if(var_57_bool == 0) goto Label_2951; // 0xb83 JumpB
	var_32_bool = 0; // 0xb84 MovB
	return 4; // 0xb85 Return
	
Label_2951:
	var_58_string = "dog"; // 0xb87 PushS
	var_59_bool = var_38_string == var_58_string; // 0xb88 Eq
	if(var_59_bool == 0) goto Label_2957; // 0xb89 JumpB
	var_32_bool = 0; // 0xb8a MovB
	return 4; // 0xb8b Return
	
Label_2957:
	var_60_string = "grabitel"; // 0xb8d PushS
	var_61_bool = var_38_string == var_60_string; // 0xb8e Eq
	if(var_61_bool == 0) goto Label_2963; // 0xb8f JumpB
	var_32_bool = 0; // 0xb90 MovB
	return 4; // 0xb91 Return
	
Label_2963:
	var_62_string = "bomber"; // 0xb93 PushS
	var_63_bool = var_38_string == var_62_string; // 0xb94 Eq
	if(var_63_bool == 0) goto Label_2969; // 0xb95 JumpB
	var_32_bool = 0; // 0xb96 MovB
	return 4; // 0xb97 Return
	
Label_2969:
	var_64_string = "sanitar"; // 0xb99 PushS
	var_65_bool = var_38_string == var_64_string; // 0xb9a Eq
	if(var_65_bool == 0) goto Label_2975; // 0xb9b JumpB
	var_32_bool = 0; // 0xb9c MovB
	return 4; // 0xb9d Return
	
Label_2975:
	var_66_string = "hunter"; // 0xb9f PushS
	var_67_bool = var_38_string == var_66_string; // 0xba0 Eq
	if(var_67_bool == 0) goto Label_2981; // 0xba1 JumpB
	var_32_bool = 0; // 0xba2 MovB
	return 4; // 0xba3 Return
	
Label_2981:
	var_68_string = "soldier"; // 0xba5 PushS
	var_69_bool = var_38_string == var_68_string; // 0xba6 Eq
	if(var_69_bool == 0) goto Label_2986; // 0xba7 JumpB
	var_32_bool = 0; // 0xba8 MovB
	return 4; // 0xba9 Return
	
Label_2986:
	var_32_bool = 1; // 0xbaa MovB
	return 4; // 0xbab Return
}
...
Label_408:
	...
	func_2878(var_60_object); // 0x19a NEW_2
...
Label_422:
	...
	func_2887(var_67_object); // 0x1a8 NEW_2
...
{
	var_86_int = 0; var_87_object = Obj(); // 0xbad PushV
	var_87_object = var_84_object; // 0xbae Mov
	func_2895(var_86_int, var_87_object); // 0xbaf NEW_2
	var_83_int = var_86_int; // 0xbb0 Mov
...
{
	var_123_object = Obj(); // 0xbb4 PushV
	var_123_object = var_122_object; // 0xbb5 Mov
	func_2905(var_123_object); // 0xbb6 NEW_2
...
{
	var_30_bool = 0; var_31_bool = 0; // 0xbb9 PushV
	var_32_bool = 0; var_33_object = Obj(); var_34_bool = 0; // 0xbba PushV
	var_33_object = var_27_object; // 0xbbb Mov
	var_34_bool = !var_29_bool; // 0xbbc Not2
	func_2913(var_32_bool, var_33_object, var_34_bool); // 0xbbd NEW_2
	var_70_bool = var_32_bool == 0; // 0xbbf Not
	if(var_70_bool == 0) goto Label_3011; // 0xbc0 JumpB
	var_25_bool = 0; // 0xbc1 MovB
	return 2; // 0xbc2 Return
	
Label_3011:
	CanSee(var_31_bool, var_26_object); // 0xbc3 Func
	var_71_bool = 0; // 0xbc5 PushV
	var_71_bool = 1; // 0xbc6 MovB
	var_72_bool = var_31_bool; // 0xbc7 Push
	if(var_72_bool == 0) goto Label_3025; // 0xbc8 JumpB
	var_73_float = 0; var_74_object = Obj(); // 0xbc9 PushV
	var_74_object = var_26_object; // 0xbca Mov
	func_2209(var_74_object); // 0xbcb NEW_2
	var_81_float = var_28_float * var_28_float; // 0xbcd Mult
	var_82_bool = var_73_float <= var_81_float; // 0xbce LE
	if(var_82_bool == 0) goto Label_3025; // 0xbcf JumpB
	var_71_bool = 0; // 0xbd0 MovB
	
Label_3025:
	if(var_71_bool == 0) goto Label_3028; // 0xbd1 JumpB
	var_25_bool = 1; // 0xbd2 MovB
	return 2; // 0xbd3 Return
	
Label_3028:
	var_25_bool = 0; // 0xbd4 MovB
	return 2; // 0xbd5 Return
}
...
{
	var_564_float = 0; var_565_bool = 0; var_566_float = 0; var_567_bool = 0; // 0x5e0 PushV
	rand(var_566_float); // 0x5e1 Func
	var_568_bool = var_566_float < var_563_float; // 0x5e3 LT
	if(var_568_bool == 0) goto Label_1524; // 0x5e4 JumpB
	
Label_1509:
	IsAnimationPlaying(var_567_bool); // 0x5e5 Func
	var_569_bool = var_567_bool == 0; // 0x5e7 Not
	if(var_569_bool == 0) goto Label_1514; // 0x5e8 JumpB
...
Label_1529:
	var_562_bool = 0; // 0x5f9 MovB
	return 4; // 0x5fa Return
	
Label_1514:
	var_570_bool = 0; // 0x5ea PushV
	func_1602(var_570_bool); // 0x5eb NEW_2
	if(var_570_bool == 0) goto Label_1520; // 0x5ed JumpB
	var_562_bool = 1; // 0x5ee MovB
...
Label_1524:
	...
	func_1706(var_567_bool); // 0x5f7 NEW_2
}


func_3043(var_27_object)
{
	var_28_object = Obj(); // 0xbe4 PushV
	var_28_object = var_27_object; // 0xbe5 Mov
	func_3092(); // 0xbe6 NEW_2
...
{
	var_31_bool = 0; var_32_bool = 0; // 0xbef PushV
	CanSee(var_32_bool, var_30_object); // 0xbf0 Func
	var_29_bool = 1; // 0xbf2 MovB
	var_33_bool = var_32_bool; // 0xbf3 Push
	if(var_33_bool == 0) goto Label_3069; // 0xbf4 JumpB
	var_34_float = 0; var_35_object = Obj(); // 0xbf5 PushV
	var_35_object = var_30_object; // 0xbf6 Mov
	func_2209(var_35_object); // 0xbf7 NEW_2
	var_42_int = 4000000; // 0xbf9 PushI
	var_43_bool = var_34_float <= var_42_int; // 0xbfa LE
	if(var_43_bool == 0) goto Label_3069; // 0xbfb JumpB
	var_29_bool = 0; // 0xbfc MovB
	
Label_3069:
	return 2; // 0xbfd Return
}
