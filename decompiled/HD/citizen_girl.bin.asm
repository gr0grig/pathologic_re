...
0x17aa: Pop(0)
0x17ab: Stack[-4] = Stack[-1]
0x17ac: Return(); Pop(2)

0x17ad: PushEmpty()
0x17ae: PushEmpty(object)
0x17af: Stack[-1] = Stack[-2]
...
0x17b9: Push(Stack[-1])
0x17ba: IF (Stack[-1] == 0) GOTO 0x17c3; Pop(1)

0x17bb: PushEmpty(float, object)
0x17bc: Stack[-1] = Stack[-5]
0x17bd: Call2 0x14d2
...
0x17ce: Stack[-1] = Stack[-3]
0x17cf: Call2 0x17b5

0x17d0: Stack[-4] = Stack[-2]
0x17d1: Pop(2)
0x17d2: Return(); Pop(0)

0x17d3: PushEmpty()
0x17d4: PushEmpty(object)
0x17d5: Stack[-1] = Stack[-2]
0x17d6: Call2 0x17c4
...
0x17de: PushEmpty()
0x17df: Push("d1GhostCatHDPathologic")
0x17e0: Push((int) 1)
0x17e1: @ SetVariable(Stack[-2], Stack[-1])
0x17e2: Pop(2)
0x17e3: PushEmpty(object, string)
0x17e4: Stack[-1] = "quest_ghost_cat"
0x17e5: Call2 0x1661
...
0x17ea: @@ SetReturnValue(Stack[-1])
0x17eb: Pop(1)
0x17ec: Return(); Pop(0)

0x17ed: PushEmpty()
0x17ee: PushEmpty(int, string)
0x17ef: Stack[-1] = "branch"
0x17f0: Call2 0x165c
...
0x1924: Push("reputation")
0x1925: @@ GetProperty(Stack[-1], Stack[-2])
0x1926: Pop(1)
0x1927: Stack[-5] = Stack[-1]
0x1928: Return(); Pop(4)
...
0x199f: Stack[-1] = "ui/NPC_Citizen1.png"
0x19a0: Return(); Pop(0)

0x19a1: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x19a2: Return(); Pop(0)
