task_0_event_0(var_0_object, var_1_bool, var_2_bool, var_3_bool, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2706(var_18_object); // 0x12 NEW_2
	...
	func_2709(var_21_object); // 0x1a NEW_2
...
task_1_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2706(var_18_object); // 0xb7 NEW_2
...
Label_195:
	...
	func_2709(var_24_object); // 0xc5 NEW_2
...
task_1_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2601(var_17_object); // 0xcb NEW_2
	var_26_int = 0; var_27_object = Obj(); // 0xcd PushV
	var_27_object = var_14_bool; // 0xce Mov
	func_2810(var_26_int, var_27_object); // 0xcf NEW_2
...
Label_219:
	...
	func_2820(var_67_object); // 0xdd NEW_2
...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_cvector, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2780(var_22_bool); // 0xe5 NEW_2
	...
	func_2678(var_24_object, var_25_bool); // 0xeb NEW_2
...
Label_247:
	...
	func_2688(var_65_object); // 0xf9 NEW_2
...
task_1_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2696(var_18_object); // 0xff NEW_2
...
task_1_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_cvector, var_15_bool)
{
	...
	func_2515(var_18_bool, var_19_object, var_20_string); // 0x114 NEW_2
	...
	func_2547(var_34_object, var_35_string); // 0x11d NEW_2
...
Label_288:
	...
	func_2701(var_47_object); // 0x123 NEW_2
...
task_1_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2614(var_15_bool, var_16_string); // 0x138 NEW_2
	...
	func_2630(var_59_string); // 0x140 NEW_2
...
task_1_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2572(var_15_bool, var_16_object); // 0x146 NEW_2
	...
	func_2595(var_28_object); // 0x14e NEW_2
...
task_2_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2706(var_18_object); // 0x210 NEW_2
...
Label_540:
	...
	func_2709(var_23_object); // 0x21e NEW_2
...
task_2_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2601(var_17_object); // 0x224 NEW_2
	var_26_int = 0; var_27_object = Obj(); // 0x226 PushV
	var_27_object = var_14_bool; // 0x227 Mov
	func_2810(var_26_int, var_27_object); // 0x228 NEW_2
...
Label_564:
	...
	func_2820(var_66_object); // 0x236 NEW_2
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_cvector, var_13_bool, var_14_object, var_15_cvector, var_16_bool)
{
	...
	func_2780(var_22_bool); // 0x23e NEW_2
	...
	func_2678(var_24_object, var_25_bool); // 0x244 NEW_2
...
Label_592:
	...
	func_2688(var_64_object); // 0x252 NEW_2
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2696(var_18_object); // 0x258 NEW_2
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_cvector, var_15_bool)
{
	...
	func_2515(var_18_bool, var_19_object, var_20_string); // 0x26d NEW_2
	...
	func_2547(var_33_object, var_34_string); // 0x276 NEW_2
...
Label_633:
	...
	func_2701(var_46_object); // 0x27c NEW_2
...
task_2_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2614(var_15_bool, var_16_string); // 0x291 NEW_2
	...
	func_2630(var_58_string); // 0x299 NEW_2
...
task_2_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2572(var_15_bool, var_16_object); // 0x2a6 NEW_2
	...
	func_2595(var_27_object); // 0x2ae NEW_2
...
task_3_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2614(var_15_bool, var_16_string); // 0x32d NEW_2
	...
	func_2630(var_58_string); // 0x335 NEW_2
...
task_4_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_2614(var_15_bool, var_16_string); // 0x399 NEW_2
	...
	func_2630(var_59_string); // 0x3a1 NEW_2
...
{
	var_16_float = 0; var_17_float = 0; // 0x9ae PushV
	var_18_string = "health"; // 0x9af PushS
	var_19_bool = var_15_string == var_18_string; // 0x9b0 Eq
	if(var_19_bool == 0) goto Label_2490; // 0x9b1 JumpB
	var_20_string = "health"; // 0x9b2 PushS
	GetProperty(var_20_string, var_17_float); // 0x9b3 Func
	var_21_int = 0; // 0x9b5 PushI
	var_22_bool = var_17_float <= var_21_int; // 0x9b6 LE
	if(var_22_bool == 0) goto Label_2490; // 0x9b7 JumpB
	SignalDeath(var_14_object); // 0x9b8 Func
	
Label_2490:
	return 2; // 0x9ba Return
}
...
{
	var_15_object = Obj(); // 0x9bc PushV
	var_15_object = var_14_object; // 0x9bd Mov
	func_2470(var_15_object); // 0x9be NEW_2
...
{
	var_18_object = Obj(); var_19_int = 0; var_20_float = 0; // 0x9c2 PushV
	var_18_object = var_14_object; // 0x9c3 Mov
	var_19_int = var_15_int; // 0x9c4 Mov
	var_20_float = var_16_float; // 0x9c5 Mov
	func_1955(var_18_object, var_19_int, var_20_float); // 0x9c6 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; var_23_cvector = CVector(0,0,0); var_24_cvector = CVector(0,0,0); // 0x9ca PushV
	var_20_object = var_14_object; // 0x9cb Mov
	var_21_int = var_15_int; // 0x9cc Mov
	var_22_float = var_16_float; // 0x9cd Mov
	var_23_cvector = var_18_cvector; // 0x9ce Mov
	var_24_cvector = var_19_cvector; // 0x9cf Mov
	func_2023(var_22_float, var_23_cvector, var_24_cvector); // 0x9d0 NEW_2
...
func_0(var_16_object)
{
	...
	func_2783(var_97_object); // 0x8 NEW_2
...
{
	var_17_bool = 0; var_18_bool = 0; // 0xa0c PushV
	var_19_bool = 0; // 0xa0d PushV
	var_19_bool = 0; // 0xa0e MovB
	var_20_bool = 0; var_21_object = Obj(); // 0xa0f PushV
	var_21_object = var_16_object; // 0xa10 Mov
	func_2723(var_21_object); // 0xa11 NEW_2
	if(var_20_bool == 0) goto Label_2586; // 0xa13 JumpB
	var_22_bool = 0; var_23_object = Obj(); // 0xa14 PushV
	var_23_object = var_16_object; // 0xa15 Mov
	func_1738(var_22_bool, var_23_object); // 0xa16 NEW_2
	if(var_22_bool == 0) goto Label_2586; // 0xa18 JumpB
	var_19_bool = 1; // 0xa19 MovB
	
Label_2586:
	if(var_19_bool == 0) goto Label_2593; // 0xa1a JumpB
	IsWeaponHolstered(var_18_bool); // 0xa1b ObjFunc
	var_26_bool = var_18_bool == 0; // 0xa1d Not
	if(var_26_bool == 0) goto Label_2593; // 0xa1e JumpB
	var_15_bool = 1; // 0xa1f MovB
	return 2; // 0xa20 Return
	
Label_2593:
	var_15_bool = 0; // 0xa21 MovB
...
{
	var_28_object = Obj(); // 0xa24 PushV
	var_28_object = var_27_object; // 0xa25 Mov
	func_2726(); // 0xa26 NEW_2
...
{
	var_18_bool = 0; var_19_object = Obj(); // 0xa2a PushV
	var_19_object = var_17_object; // 0xa2b Mov
	func_1738(var_18_bool, var_19_object); // 0xa2c NEW_2
	if(var_18_bool == 0) goto Label_2613; // 0xa2e JumpB
	var_22_object = Obj(); // 0xa2f PushV
	func_2083(var_22_object); // 0xa30 NEW_2
	var_25_float = -0.03; // 0xa32 PushF
	ReportReputationChange(var_17_object, var_22_object, var_25_float); // 0xa33 Func
...
{
	var_17_object = Obj(); var_18_object = Obj(); // 0xa36 PushV
	var_19_string = "heal"; // 0xa37 PushS
	var_20_bool = var_16_string == var_19_string; // 0xa38 Eq
	if(var_20_bool == 0) goto Label_2628; // 0xa39 JumpB
	var_21_string = "player"; // 0xa3a PushS
	FindActor(var_18_object, var_21_string); // 0xa3b Func
	var_22_bool = 0; var_23_object = Obj(); // 0xa3d PushV
	var_23_object = var_18_object; // 0xa3e Mov
	func_2738(var_22_bool, var_23_object); // 0xa3f NEW_2
	var_15_bool = var_22_bool; // 0xa40 Mov
	return 2; // 0xa42 Return
	
Label_2628:
	var_15_bool = 0; // 0xa44 MovB
...
{
	var_60_object = Obj(); var_61_object = Obj(); // 0xa46 PushV
	var_62_string = "heal"; // 0xa47 PushS
	var_63_bool = var_59_string == var_62_string; // 0xa48 Eq
	if(var_63_bool == 0) goto Label_2642; // 0xa49 JumpB
	var_64_string = "player"; // 0xa4a PushS
	FindActor(var_61_object, var_64_string); // 0xa4b Func
	var_65_object = Obj(); // 0xa4d PushV
	var_65_object = var_61_object; // 0xa4e Mov
	func_2745(var_65_object); // 0xa4f NEW_2
	var_61_object = 0; // 0xa51 SetNull
...
Label_2139:
	...
	func_2180(var_79_float); // 0x85d NEW_2
...
{
	var_74_string = ""; var_75_string = ""; // 0xa53 PushV
	var_75_string = "idle"; // 0xa54 MovS
	var_76_int = var_73_int; // 0xa55 Push
	if(var_76_int == 0) goto Label_2648; // 0xa56 JumpB
	var_75_string = var_75_string + var_73_int; // 0xa57 Add2
	
Label_2648:
	var_72_string = var_75_string; // 0xa58 Mov
...
{
	var_67_int = 0; var_68_bool = 0; var_69_int = 0; var_70_bool = 0; // 0xa5a PushV
	var_69_int = 0; // 0xa5b MovI
	
Label_2652:
	var_71_string = "all"; // 0xa5c PushS
	var_72_string = ""; var_73_int = 0; // 0xa5d PushV
	var_73_int = var_69_int; // 0xa5e Mov
	func_2643(var_72_string, var_73_int); // 0xa5f NEW_2
	HasAnimation(var_70_bool, var_71_string, var_72_string); // 0xa61 Func
	var_77_bool = var_70_bool == 0; // 0xa63 Not
	if(var_77_bool == 0) goto Label_2662; // 0xa64 JumpB
	goto Label_2665; // 0xa65 Jump
	
Label_2665:
	var_66_int = var_69_int; // 0xa69 Mov
	return 4; // 0xa6a Return
	
Label_2662:
	var_78_int = 1; // 0xa66 PushI
	var_69_int = var_69_int + var_78_int; // 0xa67 Add2
	goto Label_2652; // 0xa68 Jump
}
...
{
	var_65_object = Obj(); // 0xa6f PushV
	var_65_object = var_64_object; // 0xa70 Mov
	TaskCall(3); // 0xa71 TaskCall
	func_775(var_65_object); // 0xa72 NEW_2
...
func_2163(var_106_float)
{
	...
	var_109_int = 0; // 0x878 PushI
	var_110_bool = var_106_float < var_109_int; // 0x879 LT
	if(var_110_bool == 0) goto Label_2175; // 0x87a JumpB
	var_111_float = 0.7; // 0x87b PushF
	var_112_int = 500; // 0x87c PushI
	RumblePlay(var_111_float, var_112_int); // 0x87d Func
	
Label_2175:
	var_113_int = 15; // 0x87f PushI
	SendWorldWndMessage(var_113_int, var_108_object); // 0x880 Func
...
{
	var_26_bool = 0; var_27_object = Obj(); // 0xa77 PushV
	var_27_object = var_24_object; // 0xa78 Mov
	func_1887(var_26_bool, var_27_object); // 0xa79 NEW_2
	if(var_26_bool == 0) goto Label_2686; // 0xa7b JumpB
	var_23_int = 2; // 0xa7c MovI
	goto Label_2687; // 0xa7d Jump
	
Label_2687:
	return 0; // 0xa7f Return
	
Label_2686:
	var_23_int = 0; // 0xa7e MovI
}
...
{
	var_65_object = Obj(); // 0xa81 PushV
	var_65_object = var_64_object; // 0xa82 Mov
	TaskCall(5); // 0xa83 TaskCall
	func_1131(var_66_object, var_67_cvector, var_68_bool, var_65_object); // 0xa84 NEW_2
...
{
	var_80_object = Obj(); var_81_object = Obj(); // 0x884 PushV
	CreateFloatVector(var_81_object); // 0x885 Func
	add(var_79_float); // 0x887 ObjFunc
	var_82_int = 16; // 0x889 PushI
	SendWorldWndMessage(var_82_int, var_81_object); // 0x88a Func
...
{
	var_116_float = 0; var_117_float = 0; // 0x88e PushV
	GetGameTime(var_117_float); // 0x88f Func
	var_118_int = 1; // 0x891 PushI
	var_119_int = 0; // 0x892 PushV
	var_120_int = 24; // 0x893 PushI
	var_119_int = var_117_float / var_117_float; // 0x894 Div2
	var_115_int = var_118_int + var_119_int; // 0x895 Add2
...
{
	var_24_object = Obj(); // 0xa96 PushV
	var_24_object = var_23_object; // 0xa97 Mov
	func_2757(var_24_object); // 0xa98 NEW_2
...
{
	var_221_int = 0; var_222_int = 0; // 0x897 PushV
	var_223_string = "branch"; // 0x898 PushS
	GetVariable(var_223_string, var_222_int); // 0x899 Func
	var_220_int = var_222_int; // 0x89b Mov
...
func_2715()
{
	var_20_object = Obj(); // 0xa9b PushV
	func_2083(var_20_object); // 0xa9c NEW_2
	RemoveActor(var_20_object); // 0xa9e Func
	Hold(); // 0xaa0 Func
...
{
	var_30_int = 0; // 0x89e PushV
	func_2199(var_30_int); // 0x89f NEW_2
	var_34_int = 1; // 0x8a1 PushI
	var_35_bool = var_30_int == var_34_int; // 0x8a2 Eq
	if(var_35_bool == 0) goto Label_2215; // 0x8a3 JumpB
	WorkWithCorpse(var_29_object); // 0x8a4 Func
	goto Label_2217; // 0x8a6 Jump
	
Label_2217:
	return 0; // 0x8a9 Return
	
Label_2215:
	Barter(var_29_object); // 0x8a7 Func
}


func_2723(var_20_bool)
{
	var_20_bool = 0; // 0xaa4 MovB
...
{
	var_123_int = 0; var_124_bool = 0; var_125_int = 0; var_126_bool = 0; // 0x8aa PushV
	var_127_bool = var_112_int > var_113_int; // 0x8ab GT
	if(var_127_bool == 0) goto Label_2225; // 0x8ac JumpB
	var_128_string = "GenerateMoney: iMin > iMax"; // 0x8ad PushS
	Trace(var_128_string); // 0x8ae Func
	return 4; // 0x8b0 Return
	
Label_2225:
	var_125_int = 0; // 0x8b1 MovI
	var_129_bool = var_112_int != var_113_int; // 0x8b2 Neq
	if(var_129_bool == 0) goto Label_2232; // 0x8b3 JumpB
	var_130_int = var_113_int - var_112_int; // 0x8b4 Sub
	irand(var_125_int, var_130_int); // 0x8b5 Func
	goto Label_2236; // 0x8b7 Jump
	
Label_2236:
	var_125_int = var_125_int + var_112_int; // 0x8bc Add2
	var_131_int = 0; // 0x8bd PushI
	var_132_bool = var_125_int == var_131_int; // 0x8be Eq
	if(var_132_bool == 0) goto Label_2241; // 0x8bf JumpB
	return 4; // 0x8c0 Return
	
Label_2241:
	var_133_int = 0; var_134_string = ""; // 0x8c1 PushV
	var_134_string = "Money"; // 0x8c2 MovS
	func_2465(var_133_int, var_134_string); // 0x8c3 NEW_2
	var_137_int = 0; // 0x8c5 PushI
	AddItem(var_126_bool, var_133_int, var_137_int, var_125_int); // 0x8c6 Func
	return 4; // 0x8c8 Return
	
Label_2232:
	var_138_int = 0; // 0x8b8 PushI
	var_139_bool = var_112_int == var_138_int; // 0x8b9 Eq
	if(var_139_bool == 0) goto Label_2236; // 0x8ba JumpB
...
Label_698:
	...
	func_2650(var_66_int); // 0x2bb NEW_2
...
Label_713:
	...
	func_2643(var_88_string, var_89_int); // 0x2d7 NEW_2
...
{
	var_24_bool = 0; var_25_object = Obj(); // 0xab3 PushV
	var_25_object = var_23_object; // 0xab4 Mov
	func_1887(var_24_bool, var_25_object); // 0xab5 NEW_2
	var_22_bool = var_24_bool; // 0xab6 Mov
...
{
	var_66_object = Obj(); // 0xaba PushV
	var_66_object = var_65_object; // 0xabb Mov
	TaskCall(6); // 0xabc TaskCall
	func_1288(var_66_object); // 0xabd NEW_2
	TaskReturn(); // 0xabe TaskReturn
...
func_2753()
{
	var_15_bool = GlobalVars[0]; // 0xac1 PushGE
	var_15_bool = 0; // 0xac2 MovB
	GlobalVars[0] = var_15_bool; // 0xac3 PopGE
...
{
	var_25_bool = 0; var_26_bool = 0; // 0xac5 PushV
	var_27_bool = GlobalVars[0]; // 0xac6 PushGE
	if(var_27_bool == 0) goto Label_2769; // 0xac7 JumpB
	IsOverrideActive(var_26_bool); // 0xac8 Func
	var_28_bool = var_26_bool == 0; // 0xaca Not
	if(var_28_bool == 0) goto Label_2768; // 0xacb JumpB
	var_29_object = Obj(); // 0xacc PushV
	var_29_object = var_24_object; // 0xacd Mov
	func_2205(var_29_object); // 0xace NEW_2
...
{
	var_227_object = Obj(); var_228_int = 0; var_229_bool = 0; var_230_object = Obj(); var_231_int = 0; var_232_bool = 0; // 0x8c9 PushV
	CreateInvItem(var_230_object); // 0x8ca Func
	SetItemName(var_226_string); // 0x8cc ObjFunc
	var_233_string = "Organ"; // 0x8ce PushS
	var_234_int = 1; // 0x8cf PushI
	SetProperty(var_233_string, var_234_int); // 0x8d0 ObjFunc
	GetItemID(var_231_int); // 0x8d2 ObjFunc
	var_235_int = 0; // 0x8d4 PushI
	var_236_int = 1; // 0x8d5 PushI
	AddItem(var_232_bool, var_230_object, var_235_int, var_236_int); // 0x8d6 Func
	return 6; // 0x8d8 Return
}
...
{
	var_68_bool = 0; var_69_bool = 0; // 0xad2 PushV
	IsPlayerActor(var_67_object, var_69_bool); // 0xad3 Func
	var_66_bool = var_69_bool; // 0xad5 Mov
...
func_2266()
{
	var_220_int = 0; // 0x8da PushV
	func_2199(var_220_int); // 0x8db NEW_2
	var_224_int = 1; // 0x8dd PushI
	var_225_bool = var_220_int != var_224_int; // 0x8de Neq
	if(var_225_bool == 0) goto Label_2273; // 0x8df JumpB
	return 0; // 0x8e0 Return
	
Label_2273:
	var_226_string = ""; // 0x8e1 PushV
	var_226_string = "diseased_liver"; // 0x8e2 MovS
	func_2249(var_226_string); // 0x8e3 NEW_2
	var_237_string = ""; // 0x8e5 PushV
	var_237_string = "diseased_kidney"; // 0x8e6 MovS
	func_2249(var_237_string); // 0x8e7 NEW_2
	var_238_string = ""; // 0x8e9 PushV
	var_238_string = "diseased_heart"; // 0x8ea MovS
	func_2249(var_238_string); // 0x8eb NEW_2
	var_239_string = ""; // 0x8ed PushV
	var_239_string = "diseased_blood"; // 0x8ee MovS
	func_2249(var_239_string); // 0x8ef NEW_2
...
{
	var_98_bool = 0; var_99_object = Obj(); // 0xae0 PushV
	var_99_object = var_97_object; // 0xae1 Mov
	func_1738(var_98_bool, var_99_object); // 0xae2 NEW_2
	if(var_98_bool == 0) goto Label_2799; // 0xae4 JumpB
	var_102_object = Obj(); // 0xae5 PushV
	func_2083(var_102_object); // 0xae6 NEW_2
	var_105_float = -0.05; // 0xae8 PushF
	ReportReputationChange(var_97_object, var_102_object, var_105_float); // 0xae9 Func
	var_106_bool = 0; // 0xaeb PushV
	var_106_bool = 1; // 0xaec MovB
	func_2290(var_106_bool); // 0xaed NEW_2
	
Label_2799:
	func_2266(); // 0xaf0 NEW_2
	var_240_bool = GlobalVars[0]; // 0xaf2 PushGE
	var_240_bool = 1; // 0xaf3 MovB
	GlobalVars[0] = var_240_bool; // 0xaf4 PopGE
	var_241_int = 50; // 0xaf5 PushI
	var_242_int = 40; // 0xaf6 PushI
	SetRTEnvelope(var_241_int, var_242_int); // 0xaf7 Func
...
{
	var_107_int = 0; var_108_bool = 0; var_109_int = 0; var_110_bool = 0; // 0x8f2 PushV
	var_111_bool = var_106_bool; // 0x8f3 Push
	if(var_111_bool == 0) goto Label_2379; // 0x8f4 JumpB
	var_112_int = 0; var_113_int = 0; // 0x8f5 PushV
	var_112_int = 0; // 0x8f6 MovI
	var_114_int = 100; // 0x8f7 PushI
	var_115_int = 0; // 0x8f8 PushV
	func_2190(var_115_int); // 0x8f9 NEW_2
	var_121_int = 100; // 0x8fb PushI
	var_122_float = var_115_int * var_121_int; // 0x8fc Mult
	var_113_int = var_114_int + var_122_float; // 0x8fd Add2
	func_2218(var_112_int, var_113_int); // 0x8fe NEW_2
	var_140_int = 8; // 0x900 PushI
	irand(var_109_int, var_140_int); // 0x901 Func
	var_141_int = 0; // 0x903 PushI
	var_142_bool = var_109_int == var_141_int; // 0x904 Eq
	if(var_142_bool == 0) goto Label_2319; // 0x905 JumpB
	var_143_int = 0; var_144_string = ""; // 0x906 PushV
	var_144_string = "lemon"; // 0x907 MovS
	func_2465(var_143_int, var_144_string); // 0x908 NEW_2
	var_145_int = 0; // 0x90a PushI
	var_146_int = 1; // 0x90b PushI
	AddItem(var_110_bool, var_143_int, var_145_int, var_146_int); // 0x90c Func
	goto Label_2378; // 0x90e Jump
	
Label_2378:
	goto Label_2464; // 0x94a Jump
	
Label_2464:
	return 4; // 0x9a0 Return
	
Label_2319:
	var_147_int = 1; // 0x90f PushI
	var_148_bool = var_109_int == var_147_int; // 0x910 Eq
	if(var_148_bool == 0) goto Label_2331; // 0x911 JumpB
	var_149_int = 0; var_150_string = ""; // 0x912 PushV
	var_150_string = "rusk"; // 0x913 MovS
	func_2465(var_149_int, var_150_string); // 0x914 NEW_2
	var_151_int = 0; // 0x916 PushI
	var_152_int = 1; // 0x917 PushI
	AddItem(var_110_bool, var_149_int, var_151_int, var_152_int); // 0x918 Func
	goto Label_2378; // 0x91a Jump
	
Label_2331:
	var_153_int = 2; // 0x91b PushI
	var_154_bool = var_109_int == var_153_int; // 0x91c Eq
	if(var_154_bool == 0) goto Label_2343; // 0x91d JumpB
	var_155_int = 0; var_156_string = ""; // 0x91e PushV
	var_156_string = "hook"; // 0x91f MovS
	func_2465(var_155_int, var_156_string); // 0x920 NEW_2
	var_157_int = 0; // 0x922 PushI
	var_158_int = 1; // 0x923 PushI
	AddItem(var_110_bool, var_155_int, var_157_int, var_158_int); // 0x924 Func
	goto Label_2378; // 0x926 Jump
	
Label_2343:
	var_159_int = 4; // 0x927 PushI
	var_160_bool = var_109_int == var_159_int; // 0x928 Eq
	if(var_160_bool == 0) goto Label_2355; // 0x929 JumpB
	var_161_int = 0; var_162_string = ""; // 0x92a PushV
	var_162_string = "syringe"; // 0x92b MovS
	func_2465(var_161_int, var_162_string); // 0x92c NEW_2
	var_163_int = 0; // 0x92e PushI
	var_164_int = 1; // 0x92f PushI
	AddItem(var_110_bool, var_161_int, var_163_int, var_164_int); // 0x930 Func
	goto Label_2378; // 0x932 Jump
	
Label_2355:
	var_165_int = 5; // 0x933 PushI
	var_166_bool = var_109_int == var_165_int; // 0x934 Eq
	if(var_166_bool == 0) goto Label_2367; // 0x935 JumpB
	var_167_int = 0; var_168_string = ""; // 0x936 PushV
	var_168_string = "watch"; // 0x937 MovS
	func_2465(var_167_int, var_168_string); // 0x938 NEW_2
	var_169_int = 0; // 0x93a PushI
	var_170_int = 1; // 0x93b PushI
	AddItem(var_110_bool, var_167_int, var_169_int, var_170_int); // 0x93c Func
	goto Label_2378; // 0x93e Jump
	
Label_2367:
	var_171_int = 6; // 0x93f PushI
	var_172_bool = var_109_int == var_171_int; // 0x940 Eq
	if(var_172_bool == 0) goto Label_2378; // 0x941 JumpB
	var_173_int = 0; var_174_string = ""; // 0x942 PushV
	var_174_string = "razor"; // 0x943 MovS
	func_2465(var_173_int, var_174_string); // 0x944 NEW_2
	var_175_int = 0; // 0x946 PushI
	var_176_int = 1; // 0x947 PushI
	AddItem(var_110_bool, var_173_int, var_175_int, var_176_int); // 0x948 Func
	
Label_2379:
	var_177_int = 0; var_178_int = 0; // 0x94b PushV
	var_177_int = 0; // 0x94c MovI
	var_179_int = 50; // 0x94d PushI
	var_180_int = 0; // 0x94e PushV
	func_2190(var_180_int); // 0x94f NEW_2
	var_181_int = 50; // 0x951 PushI
	var_182_float = var_180_int * var_181_int; // 0x952 Mult
	var_178_int = var_179_int + var_182_float; // 0x953 Add2
	func_2218(var_177_int, var_178_int); // 0x954 NEW_2
	var_183_int = 7; // 0x956 PushI
	irand(var_109_int, var_183_int); // 0x957 Func
	var_184_int = 0; // 0x959 PushI
	var_185_bool = var_109_int == var_184_int; // 0x95a Eq
	if(var_185_bool == 0) goto Label_2405; // 0x95b JumpB
	var_186_int = 0; var_187_string = ""; // 0x95c PushV
	var_187_string = "beads"; // 0x95d MovS
	func_2465(var_186_int, var_187_string); // 0x95e NEW_2
	var_188_int = 0; // 0x960 PushI
	var_189_int = 1; // 0x961 PushI
	AddItem(var_110_bool, var_186_int, var_188_int, var_189_int); // 0x962 Func
	goto Label_2464; // 0x964 Jump
	
Label_2405:
	var_190_int = 1; // 0x965 PushI
	var_191_bool = var_109_int == var_190_int; // 0x966 Eq
	if(var_191_bool == 0) goto Label_2417; // 0x967 JumpB
	var_192_int = 0; var_193_string = ""; // 0x968 PushV
	var_193_string = "bracelet"; // 0x969 MovS
	func_2465(var_192_int, var_193_string); // 0x96a NEW_2
	var_194_int = 0; // 0x96c PushI
	var_195_int = 1; // 0x96d PushI
	AddItem(var_110_bool, var_192_int, var_194_int, var_195_int); // 0x96e Func
	goto Label_2464; // 0x970 Jump
	
Label_2417:
	var_196_int = 2; // 0x971 PushI
	var_197_bool = var_109_int == var_196_int; // 0x972 Eq
	if(var_197_bool == 0) goto Label_2429; // 0x973 JumpB
	var_198_int = 0; var_199_string = ""; // 0x974 PushV
	var_199_string = "ear_ring"; // 0x975 MovS
	func_2465(var_198_int, var_199_string); // 0x976 NEW_2
	var_200_int = 0; // 0x978 PushI
	var_201_int = 1; // 0x979 PushI
	AddItem(var_110_bool, var_198_int, var_200_int, var_201_int); // 0x97a Func
	goto Label_2464; // 0x97c Jump
	
Label_2429:
	var_202_int = 3; // 0x97d PushI
	var_203_bool = var_109_int == var_202_int; // 0x97e Eq
	if(var_203_bool == 0) goto Label_2441; // 0x97f JumpB
	var_204_int = 0; var_205_string = ""; // 0x980 PushV
	var_205_string = "gold_ring"; // 0x981 MovS
	func_2465(var_204_int, var_205_string); // 0x982 NEW_2
	var_206_int = 0; // 0x984 PushI
	var_207_int = 1; // 0x985 PushI
	AddItem(var_110_bool, var_204_int, var_206_int, var_207_int); // 0x986 Func
	goto Label_2464; // 0x988 Jump
	
Label_2441:
	var_208_int = 4; // 0x989 PushI
	var_209_bool = var_109_int == var_208_int; // 0x98a Eq
	if(var_209_bool == 0) goto Label_2453; // 0x98b JumpB
	var_210_int = 0; var_211_string = ""; // 0x98c PushV
	var_211_string = "silver_ring"; // 0x98d MovS
	func_2465(var_210_int, var_211_string); // 0x98e NEW_2
	var_212_int = 0; // 0x990 PushI
	var_213_int = 1; // 0x991 PushI
	AddItem(var_110_bool, var_210_int, var_212_int, var_213_int); // 0x992 Func
	goto Label_2464; // 0x994 Jump
	
Label_2453:
	var_214_int = 5; // 0x995 PushI
	var_215_bool = var_109_int == var_214_int; // 0x996 Eq
	if(var_215_bool == 0) goto Label_2464; // 0x997 JumpB
	var_216_int = 0; var_217_string = ""; // 0x998 PushV
	var_217_string = "flower"; // 0x999 MovS
	func_2465(var_216_int, var_217_string); // 0x99a NEW_2
	var_218_int = 0; // 0x99c PushI
	var_219_int = 1; // 0x99d PushI
	AddItem(var_110_bool, var_216_int, var_218_int, var_219_int); // 0x99e Func
}
...
{
	var_28_bool = 0; var_29_object = Obj(); // 0xafb PushV
	var_29_object = var_27_object; // 0xafc Mov
	func_1887(var_28_bool, var_29_object); // 0xafd NEW_2
	if(var_28_bool == 0) goto Label_2818; // 0xaff JumpB
	var_26_int = 2; // 0xb00 MovI
	goto Label_2819; // 0xb01 Jump
	
Label_2819:
	return 0; // 0xb03 Return
	
Label_2818:
	var_26_int = 0; // 0xb02 MovI
}
...
{
	var_67_object = Obj(); // 0xb05 PushV
	var_67_object = var_66_object; // 0xb06 Mov
	TaskCall(7); // 0xb07 TaskCall
	func_1561(var_68_object, var_69_cvector, var_70_bool, var_67_object); // 0xb08 NEW_2
	TaskReturn(); // 0xb09 TaskReturn
...
func_775(var_65_object)
{
	...
	func_2770(var_66_bool, var_67_object); // 0x30a NEW_2
...
func_1288(var_66_object)
{
	...
	var_114_bool = 0; var_115_object = Obj(); var_116_string = ""; var_117_float = 0; var_118_float = 0; var_119_float = 0; // 0x51c PushV
	var_115_object = var_66_object; // 0x51d Mov
	var_116_string = "health"; // 0x51e MovS
	var_117_float = -0.06; // 0x51f MovF
	var_118_float = 0; // 0x520 MovI
	var_119_float = 1; // 0x521 MovI
	func_1755(var_114_bool, var_115_object, var_116_string, var_117_float, var_118_float, var_119_float); // 0x522 NEW_2
	var_120_string = "disease"; // 0x524 PushS
	HasProperty(var_120_string, var_71_bool); // 0x525 Func
	var_121_bool = var_71_bool; // 0x527 Push
	if(var_121_bool == 0) goto Label_1325; // 0x528 JumpB
	var_122_string = "disease"; // 0x529 PushS
	var_123_int = 0; // 0x52a PushI
	SetProperty(var_122_string, var_123_int); // 0x52b Func
	
Label_1325:
	var_124_object = Obj(); // 0x52d PushV
	var_124_object = var_66_object; // 0x52e Mov
	func_1367(var_66_object, var_70_bool, var_71_bool, var_124_object); // 0x52f NEW_2
...
{
	var_125_cvector = CVector(0,0,0); var_126_float = 0; var_127_bool = 0; var_128_cvector = CVector(0,0,0); var_129_float = 0; var_130_cvector = CVector(0,0,0); var_131_float = 0; var_132_bool = 0; var_133_cvector = CVector(0,0,0); var_134_float = 0; // 0x557 PushV
	var_0_bool = var_124_object; // 0x558 TMov
	var_135_cvector = CVector(0,0,0); var_136_float = 0; // 0x559 PushV
	var_136_float = 1.74533; // 0x55a MovF
	func_1337(var_135_cvector, var_136_float); // 0x55b NEW_2
	var_130_cvector = var_135_cvector; // 0x55c Mov
	var_131_float = var_130_cvector | var_130_cvector; // 0x55e Or2
	var_165_float = 2500.0; // 0x55f PushF
	var_166_bool = var_131_float < var_165_float; // 0x560 LT
	if(var_166_bool == 0) goto Label_1396; // 0x561 JumpB
	var_167_cvector = CVector(0,0,0); var_168_float = 0; // 0x562 PushV
	var_168_float = 2.61799; // 0x563 MovF
	func_1337(var_167_cvector, var_168_float); // 0x564 NEW_2
	var_130_cvector = var_167_cvector; // 0x565 Mov
	var_131_float = var_130_cvector | var_130_cvector; // 0x567 Or2
	var_169_float = 2500.0; // 0x568 PushF
	var_170_bool = var_131_float < var_169_float; // 0x569 LT
	if(var_170_bool == 0) goto Label_1396; // 0x56a JumpB
	var_171_string = "Can't retreat, distance: "; // 0x56b PushS
	var_172_float = sqrt(var_131_float); // 0x56c Sqrt
	var_173_int = var_171_string + var_172_float; // 0x56d Add
	Trace(var_173_int); // 0x56e Func
	var_174_float = 0.5; // 0x570 PushF
	Sleep(var_174_float); // 0x571 Func
	return 10; // 0x573 Return
	
Label_1396:
	var_175_float = GetByIndex(var_130_cvector, 0); // 0x574 PushE
	var_176_float = GetByIndex(var_130_cvector, 2); // 0x575 PushE
	Rotate(var_175_float, var_176_float); // 0x576 Func
	var_177_cvector = CVector(0,0,0); // 0x578 PushV
	func_1718(var_177_cvector); // 0x579 NEW_2
	var_1_bool = var_177_cvector + var_130_cvector; // 0x57b Add2
	var_180_int = 120; // 0x57c PushI
	var_181_float = 0.5; // 0x57d PushF
	SetTimer(var_180_int, var_181_float); // 0x57e Func
	var_2_bool = 0; // 0x580 TMovB
	
Label_1409:
	var_182_int = 1; // 0x581 PushI
	MovePoint(var_182_int, var_182_int, var_132_bool); // 0x582 Func
	var_183_bool = var_132_bool; // 0x584 Push
	if(var_183_bool == 0) goto Label_1437; // 0x585 JumpB
	var_184_bool = var_0_bool == 0; // 0x586 NullEq
	if(var_184_bool == 0) goto Label_1418; // 0x587 JumpB
...
Label_1418:
	var_185_cvector = CVector(0,0,0); var_186_float = 0; // 0x58a PushV
	var_186_float = 2.61799; // 0x58b MovF
	func_1337(var_185_cvector, var_186_float); // 0x58c NEW_2
	var_133_cvector = var_185_cvector; // 0x58d Mov
	var_134_float = var_133_cvector | var_133_cvector; // 0x58f Or2
	var_187_float = 2500.0; // 0x590 PushF
	var_188_bool = var_134_float >= var_187_float; // 0x591 GE
	if(var_188_bool == 0) goto Label_1436; // 0x592 JumpB
	var_189_cvector = CVector(0,0,0); // 0x593 PushV
	func_1718(var_189_cvector); // 0x594 NEW_2
	var_1_bool = var_189_cvector + var_133_cvector; // 0x596 Add2
	var_190_int = 120; // 0x597 PushI
	var_191_float = 0.5; // 0x598 PushF
	SetTimer(var_190_int, var_191_float); // 0x599 Func
	goto Label_1437; // 0x59b Jump
	
Label_1437:
	var_192_bool = var_2_bool == 0; // 0x59d Not
	if(var_192_bool == 0) goto Label_1409; // 0x59e JumpB
...
Label_408:
	...
	func_2667(var_58_object); // 0x19a NEW_2
...
Label_422:
	...
	func_2670(var_64_object); // 0x1a8 NEW_2
...
{
	var_135_int = 0; var_136_int = 0; // 0x9a1 PushV
	GetInvItemByName(var_136_int, var_134_string); // 0x9a2 Func
	var_133_int = var_136_int; // 0x9a4 Mov
...
{
	var_16_object = Obj(); // 0x9a7 PushV
	var_16_object = var_15_object; // 0x9a8 Mov
	TaskCall(0); // 0x9a9 TaskCall
	func_0(var_16_object); // 0x9aa NEW_2
	TaskReturn(); // 0x9ab TaskReturn
...
{
	var_21_string = "unholster"; // 0x9d4 PushS
	var_22_bool = var_20_string == var_21_string; // 0x9d5 Eq
	if(var_22_bool == 0) goto Label_2526; // 0x9d6 JumpB
	var_23_bool = 0; var_24_object = Obj(); // 0x9d7 PushV
	var_24_object = var_19_object; // 0x9d8 Mov
	func_2723(var_24_object); // 0x9d9 NEW_2
	var_18_bool = var_23_bool; // 0x9da Mov
	return 0; // 0x9dc Return
	
Label_2526:
	var_25_string = "player_shot"; // 0x9de PushS
	var_26_bool = var_20_string == var_25_string; // 0x9df Eq
	if(var_26_bool == 0) goto Label_2536; // 0x9e0 JumpB
	var_27_bool = 0; var_28_object = Obj(); // 0x9e1 PushV
	var_28_object = var_19_object; // 0x9e2 Mov
	func_2728(var_28_object); // 0x9e3 NEW_2
	var_18_bool = var_27_bool; // 0x9e4 Mov
	return 0; // 0x9e6 Return
	
Label_2536:
	var_29_string = "battle"; // 0x9e8 PushS
	var_30_bool = var_20_string == var_29_string; // 0x9e9 Eq
	if(var_30_bool == 0) goto Label_2545; // 0x9ea JumpB
	var_31_bool = 0; var_32_object = Obj(); // 0x9eb PushV
	var_32_object = var_19_object; // 0x9ec Mov
	func_2733(var_32_object); // 0x9ed NEW_2
	var_18_bool = var_31_bool; // 0x9ee Mov
	return 0; // 0x9f0 Return
	
Label_2545:
	var_18_bool = 0; // 0x9f1 MovB
...
{
	var_35_string = "unholster"; // 0x9f4 PushS
	var_36_bool = var_34_string == var_35_string; // 0x9f5 Eq
	if(var_36_bool == 0) goto Label_2556; // 0x9f6 JumpB
	var_37_object = Obj(); // 0x9f7 PushV
	var_37_object = var_33_object; // 0x9f8 Mov
	func_2726(); // 0x9f9 NEW_2
	goto Label_2571; // 0x9fb Jump
	
Label_2571:
	return 0; // 0xa0b Return
	
Label_2556:
	var_38_string = "player_shot"; // 0x9fc PushS
	var_39_bool = var_34_string == var_38_string; // 0x9fd Eq
	if(var_39_bool == 0) goto Label_2564; // 0x9fe JumpB
	var_40_object = Obj(); // 0x9ff PushV
	var_40_object = var_33_object; // 0xa00 Mov
	func_2731(); // 0xa01 NEW_2
	goto Label_2571; // 0xa03 Jump
	
Label_2564:
	var_41_string = "battle"; // 0xa04 PushS
	var_42_bool = var_34_string == var_41_string; // 0xa05 Eq
	if(var_42_bool == 0) goto Label_2571; // 0xa06 JumpB
	var_43_object = Obj(); // 0xa07 PushV
	var_43_object = var_33_object; // 0xa08 Mov
	func_2736(); // 0xa09 NEW_2
}
