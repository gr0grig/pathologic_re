...
0x650: Push("Can't find lsh animation : ")
...
0x65f: Push("Can't find lsh animation : ")
...
0x7b6: Stack[-3] = Stack[-7]
0x7b7: Stack[-2] = Stack[-6]
0x7b8: Stack[-1] = Stack[-5]
0x7b9: Call2 0x597
...
0x7be: Stack[-5] = Stack[-11]
0x7bf: Stack[-4] = Stack[-10]
0x7c0: Stack[-3] = Stack[-9]
0x7c1: Stack[-2] = Stack[-7]
0x7c2: Stack[-1] = Stack[-6]
0x7c3: Call2 0x5db
...
0x7cd: Stack[-5] = Stack[-2]
0x7ce: Pop(2)
0x7cf: Return(); Pop(0)

0x7d0: GOTO 0x7e4

0x7d1: Push("player_shot")
...
0x7df: Stack[-1] = Stack[-4]
0x7e0: Call2 0x89f

0x7e1: Stack[-5] = Stack[-2]
0x7e2: Pop(2)
0x7e3: Return(); Pop(0)
...
0x80e: @@ IsWeaponHolstered(Stack[-1])
0x80f: Pop(0)
...
0x8ad: Stack[-1] = "ui/NPC_Citizen3.png"
0x8ae: Return(); Pop(0)

0x8af: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x8b0: Return(); Pop(0)
