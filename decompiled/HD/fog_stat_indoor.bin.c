...
{
	var_1_bool = 0; var_2_bool = 0; // 0x101 PushV
	var_3_string = "cleanup"; // 0x102 PushS
	var_4_bool = var_0_string == var_3_string; // 0x103 Eq
	if(var_4_bool == 0) goto Label_274; // 0x104 JumpB
	var_5_bool = GlobalVars[0]; // 0x105 PushGE
	var_5_bool = 1; // 0x106 MovB
	GlobalVars[0] = var_5_bool; // 0x107 PopGE
	IsLoaded(var_2_bool); // 0x108 Func
	var_6_bool = var_2_bool == 0; // 0x10a Not
	if(var_6_bool == 0) goto Label_273; // 0x10b JumpB
	var_7_object = Obj(); // 0x10c PushV
	func_209(var_7_object); // 0x10d NEW_2
	RemoveActor(var_7_object); // 0x10f Func
...
Label_274:
	var_10_string = "restore"; // 0x112 PushS
	var_11_bool = var_0_string == var_10_string; // 0x113 Eq
	if(var_11_bool == 0) goto Label_280; // 0x114 JumpB
	var_12_bool = GlobalVars[0]; // 0x115 PushGE
	var_12_bool = 0; // 0x116 MovB
	GlobalVars[0] = var_12_bool; // 0x117 PopGE
}


event_6()
{
	var_0_bool = GlobalVars[0]; // 0x119 PushGE
	if(var_0_bool == 0) goto Label_288; // 0x11a JumpB
	var_1_object = Obj(); // 0x11b PushV
	func_209(var_1_object); // 0x11c NEW_2
	RemoveActor(var_1_object); // 0x11e Func
...
{
	var_2_object = Obj(); var_3_object = Obj(); // 0xd1 PushV
	self(var_3_object); // 0xd2 Func
	var_1_object = var_3_object; // 0xd4 Mov
