task_0_event_11(var_0_bool, var_1_int, var_2_object, var_3_object, var_4_object, var_5_string, var_6_bool, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int, var_14_bool, var_15_bool, var_16_object, var_17_bool, var_18_bool, var_19_int)
{
	...
	func_1471(var_20_bool); // 0x1c NEW_2
...
Label_542:
	...
	func_1471(var_197_bool); // 0x220 NEW_2
...
Label_738:
	...
	func_1471(var_49_bool); // 0x2e4 NEW_2
...
task_5_event_0(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_string, var_10_bool, var_11_int, var_12_int, var_13_bool, var_14_bool, var_15_object, var_16_bool, var_17_bool, var_18_int, var_19_object)
{
	...
	func_1457(var_25_int); // 0x301 NEW_2
...
Label_782:
	...
	func_1457(var_262_int); // 0x30f NEW_2
...
task_5_event_5(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_string, var_10_bool, var_11_int, var_12_int, var_13_bool, var_14_bool, var_15_object, var_16_bool, var_17_bool, var_18_int)
{
	...
	func_1296(var_43_int); // 0x33c NEW_2
...
Label_4:
	...
	func_1471(var_255_bool); // 0x5 NEW_2
...
{
	var_84_string = ""; var_85_string = ""; // 0x519 PushV
	var_85_string = "idle"; // 0x51a MovS
	var_86_int = var_83_int; // 0x51b Push
	if(var_86_int == 0) goto Label_1310; // 0x51c JumpB
	var_85_string = var_85_string + var_83_int; // 0x51d Add2
	
Label_1310:
	var_82_string = var_85_string; // 0x51e Mov
	return 2; // 0x51f Return
}


func_1435(var_32_int, var_33_string)
{
	var_34_int = 0; var_35_int = 0; // 0x59b PushV
	GetInvItemByName(var_35_int, var_33_string); // 0x59c Func
	var_32_int = var_35_int; // 0x59e Mov
...
{
	var_95_int = 0; var_96_int = 0; // 0x5a0 PushV
	var_97_string = "branch"; // 0x5a1 PushS
	GetVariable(var_97_string, var_96_int); // 0x5a2 Func
	var_98_int = 0; // 0x5a4 PushI
	var_99_bool = var_96_int == var_98_int; // 0x5a5 Eq
	if(var_99_bool == 0) goto Label_1450; // 0x5a6 JumpB
	var_94_int = 1; // 0x5a7 MovI
	return 2; // 0x5a8 Return
	
Label_1450:
	var_100_int = 1; // 0x5aa PushI
	var_101_bool = var_96_int == var_100_int; // 0x5ab Eq
	if(var_101_bool == 0) goto Label_1455; // 0x5ac JumpB
	var_94_int = 2; // 0x5ad MovI
	return 2; // 0x5ae Return
	
Label_1455:
	var_94_int = 3; // 0x5af MovI
...
{
	var_77_int = 0; var_78_bool = 0; var_79_int = 0; var_80_bool = 0; // 0x520 PushV
	var_79_int = 0; // 0x521 MovI
	
Label_1314:
	var_81_string = "all"; // 0x522 PushS
	var_82_string = ""; var_83_int = 0; // 0x523 PushV
	var_83_int = var_79_int; // 0x524 Mov
	func_1305(var_82_string, var_83_int); // 0x525 NEW_2
	HasAnimation(var_80_bool, var_81_string, var_82_string); // 0x527 Func
	var_87_bool = var_80_bool == 0; // 0x529 Not
	if(var_87_bool == 0) goto Label_1324; // 0x52a JumpB
	goto Label_1327; // 0x52b Jump
	
Label_1327:
	var_76_int = var_79_int; // 0x52f Mov
	return 4; // 0x530 Return
	
Label_1324:
	var_88_int = 1; // 0x52c PushI
	var_79_int = var_79_int + var_88_int; // 0x52d Add2
...
func_687(var_2_object, var_293_string)
{
	...
	func_1471(var_294_bool); // 0x2b1 NEW_2
...
{
	var_26_int = 0; var_27_int = 0; // 0x5b1 PushV
	var_28_string = "branch"; // 0x5b2 PushS
	GetVariable(var_28_string, var_27_int); // 0x5b3 Func
	var_25_int = var_27_int; // 0x5b5 Mov
...
Label_1120:
	...
	func_1471(var_85_bool); // 0x46a NEW_2
...
{
	var_92_string = "ui/NPC_Morlok.png"; // 0x5bb MovS
...
{
	var_93_string = "ui/NPC_Morlok_b.png"; // 0x5bd MovS
...
Label_989:
	...
	func_1312(var_76_int); // 0x3de NEW_2
...
Label_1004:
	...
	func_1305(var_98_string, var_99_int); // 0x3fa NEW_2
...
func_1261()
{
	...
	func_1471(var_22_bool); // 0x4ee NEW_2
...
Label_218:
	...
	func_1471(var_163_bool); // 0xdb NEW_2
...
Label_657:
	...
	func_1471(var_308_bool); // 0x292 NEW_2
...
func_248(var_2_object, var_139_string)
{
	...
	func_1471(var_140_bool); // 0xfa NEW_2
...
func_1148()
{
	...
	func_1471(var_216_bool); // 0x481 NEW_2
