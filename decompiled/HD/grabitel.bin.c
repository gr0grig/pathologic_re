task_0_event_17(var_0_bool, var_1_object, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2912(var_17_object); // 0x6e NEW_2
...
task_0_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0x75 NEW_2
...
task_1_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2912(var_17_object); // 0xb9 NEW_2
...
task_1_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0xc0 NEW_2
...
task_2_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2912(var_17_object); // 0x362 NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0x369 NEW_2
...
task_2_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2709(var_19_object); // 0x3ae NEW_2
...
task_3_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2888(var_17_bool, var_18_object); // 0x4be NEW_2
	...
	func_2895(var_115_object); // 0x4c6 NEW_2
...
task_3_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2864(var_17_bool, var_18_object); // 0x4cc NEW_2
	...
	func_2871(var_115_object); // 0x4d4 NEW_2
...
Label_1238:
	...
	func_2925(var_61_object); // 0x4dd NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0x4e4 NEW_2
...
task_4_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2888(var_17_bool, var_18_object); // 0x54c NEW_2
	...
	func_2895(var_114_object); // 0x554 NEW_2
...
task_4_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2864(var_17_bool, var_18_object); // 0x55a NEW_2
	...
	func_2871(var_114_object); // 0x562 NEW_2
...
Label_1380:
	...
	func_2925(var_60_object); // 0x56b NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0x572 NEW_2
...
task_5_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2888(var_17_bool, var_18_object); // 0x5e5 NEW_2
	...
	func_2895(var_114_object); // 0x5ed NEW_2
...
task_5_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2864(var_17_bool, var_18_object); // 0x5f3 NEW_2
	...
	func_2871(var_114_object); // 0x5fb NEW_2
...
Label_1533:
	...
	func_2925(var_60_object); // 0x604 NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2953(var_19_bool, var_20_object, var_21_object); // 0x60b NEW_2
...
task_6_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_2925(var_19_object); // 0x660 NEW_2
...
task_8_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_3047(var_20_object); // 0x746 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0xbbd PushV
	var_20_object = var_16_object; // 0xbbe Mov
	var_21_int = var_17_int; // 0xbbf Mov
	var_22_float = var_18_float; // 0xbc0 Mov
	func_2322(var_20_object, var_21_int, var_22_float); // 0xbc1 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0xbc5 PushV
	var_22_object = var_16_object; // 0xbc6 Mov
	var_23_int = var_17_int; // 0xbc7 Mov
	var_24_float = var_18_float; // 0xbc8 Mov
	var_25_cvector = var_20_cvector; // 0xbc9 Mov
	var_26_cvector = var_21_cvector; // 0xbca Mov
	func_2390(var_24_float, var_25_cvector, var_26_cvector); // 0xbcb NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0xbce PushV
	var_20_string = "health"; // 0xbcf PushS
	var_21_bool = var_17_string == var_20_string; // 0xbd0 Eq
	if(var_21_bool == 0) goto Label_3034; // 0xbd1 JumpB
	var_22_string = "health"; // 0xbd2 PushS
	GetProperty(var_22_string, var_19_float); // 0xbd3 Func
	var_23_int = 0; // 0xbd5 PushI
	var_24_bool = var_19_float <= var_23_int; // 0xbd6 LE
	if(var_24_bool == 0) goto Label_3034; // 0xbd7 JumpB
	SignalDeath(var_16_object); // 0xbd8 Func
...
{
	var_17_object = Obj(); // 0xbdc PushV
	var_17_object = var_16_object; // 0xbdd Mov
	func_2986(var_17_object); // 0xbde NEW_2
...
func_0(var_0_bool, var_92_bool, var_93_object, var_210_object)
{
	...
	func_2709(var_109_object); // 0x3 NEW_2
...
Label_39:
	...
	func_2759(var_152_cvector, var_153_cvector, var_154_cvector, var_155_float); // 0x4b NEW_2
...
Label_2075:
	var_609_string = "armor"; // 0x81b PushS
	GetProperty(var_609_string, var_558_int); // 0x81c ObjFunc
}
...
{
	var_113_object = Obj(); var_114_int = 0; var_115_bool = 0; var_116_object = Obj(); var_117_int = 0; var_118_bool = 0; // 0xc13 PushV
	CreateInvItem(var_116_object); // 0xc14 Func
	SetItemName(var_112_string); // 0xc16 ObjFunc
	var_119_string = "Organ"; // 0xc18 PushS
	var_120_int = 1; // 0xc19 PushI
	SetProperty(var_119_string, var_120_int); // 0xc1a ObjFunc
	GetItemID(var_117_int); // 0xc1c ObjFunc
	var_121_int = 0; // 0xc1e PushI
	var_122_int = 1; // 0xc1f PushI
	AddItem(var_118_bool, var_116_object, var_121_int, var_122_int); // 0xc20 Func
	return 6; // 0xc22 Return
}
...
func_3108()
{
	var_106_int = 0; // 0xc24 PushV
	func_3041(var_106_int); // 0xc25 NEW_2
	var_110_int = 1; // 0xc27 PushI
	var_111_bool = var_106_int != var_110_int; // 0xc28 Neq
	if(var_111_bool == 0) goto Label_3115; // 0xc29 JumpB
	return 0; // 0xc2a Return
	
Label_3115:
	var_112_string = ""; // 0xc2b PushV
	var_112_string = "liver"; // 0xc2c MovS
	func_3091(var_112_string); // 0xc2d NEW_2
	var_123_string = ""; // 0xc2f PushV
	var_123_string = "kidney"; // 0xc30 MovS
	func_3091(var_123_string); // 0xc31 NEW_2
	var_124_string = ""; // 0xc33 PushV
	var_124_string = "heart"; // 0xc34 MovS
	func_3091(var_124_string); // 0xc35 NEW_2
	var_125_string = ""; // 0xc37 PushV
	var_125_string = "blood"; // 0xc38 MovS
	func_3091(var_125_string); // 0xc39 NEW_2
...
func_3132()
{
	var_64_int = 0; var_65_bool = 0; var_66_int = 0; var_67_bool = 0; // 0xc3c PushV
	var_68_int = 0; // 0xc3d PushI
	ClearSubContainer(var_68_int); // 0xc3e Func
	var_69_int = 0; var_70_int = 0; // 0xc40 PushV
	var_69_int = 300; // 0xc41 MovI
	var_70_int = 750; // 0xc42 MovI
	func_3060(var_69_int, var_70_int); // 0xc43 NEW_2
	var_88_string = ""; var_89_int = 0; var_90_int = 0; // 0xc45 PushV
	var_88_string = "Knife"; // 0xc46 MovS
	var_89_int = 1; // 0xc47 MovI
	var_90_int = 8; // 0xc48 MovI
	func_2431(var_88_string, var_89_int, var_90_int); // 0xc49 NEW_2
	var_99_string = ""; var_100_int = 0; var_101_int = 0; // 0xc4b PushV
	var_99_string = "lockpick"; // 0xc4c MovS
	var_100_int = 1; // 0xc4d MovI
	var_101_int = 6; // 0xc4e MovI
	func_2431(var_99_string, var_100_int, var_101_int); // 0xc4f NEW_2
	var_102_int = 0; var_103_string = ""; // 0xc51 PushV
	var_103_string = "grabitel_mark"; // 0xc52 MovS
	func_3162(var_102_int, var_103_string); // 0xc53 NEW_2
	var_104_int = 0; // 0xc55 PushI
	var_105_int = 1; // 0xc56 PushI
	AddItem(var_67_bool, var_102_int, var_104_int, var_105_int); // 0xc57 Func
...
{
	var_618_float = 0; var_619_float = 0; // 0x851 PushV
	var_620_bool = 0; var_621_object = Obj(); var_622_string = ""; // 0x852 PushV
	var_621_object = var_617_object; // 0x853 Mov
	var_622_string = "health"; // 0x854 MovS
	func_2022(var_620_bool, var_621_object, var_622_string); // 0x855 NEW_2
	var_623_bool = var_620_bool == 0; // 0x857 Not
	if(var_623_bool == 0) goto Label_2139; // 0x858 JumpB
	var_616_bool = 0; // 0x859 MovB
	return 2; // 0x85a Return
	
Label_2139:
	var_624_bool = 0; // 0x85b PushV
	var_624_bool = 0; // 0x85c MovB
	var_625_bool = 0; var_626_object = Obj(); // 0x85d PushV
	var_626_object = var_617_object; // 0x85e Mov
	func_2017(var_625_bool, var_626_object); // 0x85f NEW_2
	if(var_625_bool == 0) goto Label_2151; // 0x861 JumpB
	var_627_bool = 0; // 0x862 PushV
	func_2729(var_627_bool); // 0x863 NEW_2
	if(var_627_bool == 0) goto Label_2151; // 0x865 JumpB
	var_624_bool = 1; // 0x866 MovB
	
Label_2151:
	if(var_624_bool == 0) goto Label_2154; // 0x867 JumpB
	var_616_bool = 0; // 0x868 MovB
	return 2; // 0x869 Return
	
Label_2154:
	var_631_string = "health"; // 0x86a PushS
	GetProperty(var_631_string, var_619_float); // 0x86b ObjFunc
	var_632_float = 0.0; // 0x86d PushF
	var_616_bool = var_619_float <= var_632_float; // 0x86e LE2
...
Label_2668:
	...
	func_2699(var_29_float); // 0xa6e NEW_2
...
{
	var_83_int = 0; var_84_int = 0; // 0xc5a PushV
	GetInvItemByName(var_84_int, var_82_string); // 0xc5b Func
	var_81_int = var_84_int; // 0xc5d Mov
...
func_2682(var_601_float)
{
	...
	var_604_int = 0; // 0xa7f PushI
	var_605_bool = var_601_float < var_604_int; // 0xa80 LT
	if(var_605_bool == 0) goto Label_2694; // 0xa81 JumpB
	var_606_float = 0.7; // 0xa82 PushF
	var_607_int = 500; // 0xa83 PushI
	RumblePlay(var_606_float, var_607_int); // 0xa84 Func
	
Label_2694:
	var_608_int = 15; // 0xa86 PushI
	SendWorldWndMessage(var_608_int, var_603_object); // 0xa87 Func
...
{
	var_30_object = Obj(); var_31_object = Obj(); // 0xa8b PushV
	CreateFloatVector(var_31_object); // 0xa8c Func
	add(var_29_float); // 0xa8e ObjFunc
	var_32_int = 16; // 0xa90 PushI
	SendWorldWndMessage(var_32_int, var_31_object); // 0xa91 Func
...
{
	var_110_bool = 0; var_111_bool = 0; // 0xa95 PushV
	IsPlayerActor(var_109_object, var_111_bool); // 0xa96 Func
	var_112_bool = var_111_bool; // 0xa98 Push
	if(var_112_bool == 0) goto Label_2717; // 0xa99 JumpB
	var_113_string = "attack"; // 0xa9a PushS
	PlayGlobalMusic(var_113_string); // 0xa9b Func
...
func_2718()
{
	var_131_object = Obj(); var_132_object = Obj(); // 0xa9e PushV
	GetScene(var_132_object); // 0xa9f Func
	var_133_string = "battle"; // 0xaa1 PushS
	var_134_object = Obj(); // 0xaa2 PushV
	func_2570(var_134_object); // 0xaa3 NEW_2
	BroadcastMessage(var_133_string, var_134_object, var_132_object); // 0xaa5 Func
...
func_162(var_611_object, var_612_float)
{
	...
	func_2129(var_616_bool, var_617_object); // 0xaa NEW_2
...
{
	var_628_bool = 0; var_629_bool = 0; // 0xaa9 PushV
	var_630_string = "god_mode"; // 0xaaa PushS
	GetVariable(var_630_string, var_629_bool); // 0xaab Func
	var_627_bool = var_629_bool; // 0xaad Mov
...
{
	var_75_string = ""; var_76_string = ""; // 0xaaf PushV
	var_76_string = "idle"; // 0xab0 MovS
	var_77_int = var_74_int; // 0xab1 Push
	if(var_77_int == 0) goto Label_2740; // 0xab2 JumpB
	var_76_string = var_76_string + var_74_int; // 0xab3 Add2
	
Label_2740:
	var_73_string = var_76_string; // 0xab4 Mov
...
{
	var_68_int = 0; var_69_bool = 0; var_70_int = 0; var_71_bool = 0; // 0xab6 PushV
	var_70_int = 0; // 0xab7 MovI
	
Label_2744:
	var_72_string = "all"; // 0xab8 PushS
	var_73_string = ""; var_74_int = 0; // 0xab9 PushV
	var_74_int = var_70_int; // 0xaba Mov
	func_2735(var_73_string, var_74_int); // 0xabb NEW_2
	HasAnimation(var_71_bool, var_72_string, var_73_string); // 0xabd Func
	var_78_bool = var_71_bool == 0; // 0xabf Not
	if(var_78_bool == 0) goto Label_2754; // 0xac0 JumpB
	goto Label_2757; // 0xac1 Jump
	
Label_2757:
	var_67_int = var_70_int; // 0xac5 Mov
	return 4; // 0xac6 Return
	
Label_2754:
	var_79_int = 1; // 0xac2 PushI
	var_70_int = var_70_int + var_79_int; // 0xac3 Add2
	goto Label_2744; // 0xac4 Jump
}


func_2759(var_152_cvector, var_153_cvector, var_154_cvector, var_155_float)
{
	var_156_cvector = CVector(0,0,0); var_157_float = 0; var_158_float = 0; var_159_float = 0; var_160_float = 0; var_161_float = 0; var_162_cvector = CVector(0,0,0); var_163_float = 0; var_164_float = 0; var_165_float = 0; var_166_float = 0; var_167_float = 0; // 0xac7 PushV
	var_162_cvector = var_154_cvector - var_153_cvector; // 0xac8 Sub2
	var_163_float = 250000; // 0xac9 MovI
	var_168_float = GetByIndex(var_162_cvector, 1); // 0xaca PushE
	var_169_int = 1000; // 0xacb PushI
	var_170_float = var_168_float * var_169_int; // 0xacc Mult
	var_171_float = var_155_float * var_155_float; // 0xacd Mult
	var_164_float = var_170_float - var_171_float; // 0xace Sub2
	var_165_float = var_162_cvector | var_162_cvector; // 0xacf Or2
	var_172_float = 0; var_173_float = 0; var_174_float = 0; var_175_float = 0; // 0xad0 PushV
	var_173_float = var_163_float; // 0xad1 Mov
	var_174_float = var_164_float; // 0xad2 Mov
	var_175_float = var_165_float; // 0xad3 Mov
	func_2593(var_172_float, var_173_float, var_174_float, var_175_float); // 0xad4 NEW_2
	var_166_float = var_172_float; // 0xad5 Mov
	var_180_int = 0; // 0xad7 PushI
	var_181_bool = var_166_float < var_180_int; // 0xad8 LT
	if(var_181_bool == 0) goto Label_2780; // 0xad9 JumpB
	var_167_float = 1; // 0xada MovI
	goto Label_2788; // 0xadb Jump
	
Label_2788:
	var_182_cvector = CVector(0.0, 500.0, 0.0); // 0xae4 PushVec
	var_183_float = var_182_cvector * var_167_float; // 0xae5 Mult
	var_184_float = var_183_float * var_167_float; // 0xae6 Mult
	var_185_int = var_162_cvector + var_184_float; // 0xae7 Add
	var_152_cvector = var_185_int / var_185_int; // 0xae8 Div2
	return 12; // 0xae9 Return
	
Label_2780:
	var_186_float = 0; var_187_float = 0; var_188_float = 0; var_189_float = 0; var_190_float = 0; // 0xadc PushV
	var_187_float = var_163_float; // 0xadd Mov
	var_188_float = var_164_float; // 0xade Mov
	var_189_float = var_165_float; // 0xadf Mov
	var_190_float = sqrt(var_166_float); // 0xae0 Sqrt2
	func_2600(var_187_float, var_188_float, var_189_float, var_190_float); // 0xae1 NEW_2
	var_167_float = sqrt(var_186_float); // 0xae3 Sqrt2
}
...
Label_359:
	...
	func_2201(var_678_bool, var_679_object); // 0x180 NEW_2
...
{
	var_28_string = ""; var_29_string = ""; var_30_string = ""; var_31_string = ""; // 0xaea PushV
	var_32_bool = 0; var_33_object = Obj(); var_34_string = ""; // 0xaeb PushV
	var_33_object = var_27_object; // 0xaec Mov
	var_34_string = "class"; // 0xaed MovS
	func_2022(var_32_bool, var_33_object, var_34_string); // 0xaee NEW_2
	var_41_bool = var_32_bool == 0; // 0xaf0 Not
	if(var_41_bool == 0) goto Label_2804; // 0xaf1 JumpB
	var_26_bool = 0; // 0xaf2 MovB
	return 4; // 0xaf3 Return
	
Label_2804:
	var_42_string = "class"; // 0xaf4 PushS
	GetProperty(var_42_string, var_30_string); // 0xaf5 Func
	var_43_string = "class"; // 0xaf7 PushS
	GetProperty(var_43_string, var_31_string); // 0xaf8 ObjFunc
	var_26_bool = var_31_string == var_30_string; // 0xafa Eq2
	return 4; // 0xafb Return
}
...
func_2812()
{
	var_16_object = GlobalVars[1]; // 0xafc PushGE
	var_17_object = Obj(); // 0xafd PushV
	func_2641(var_17_object); // 0xafe NEW_2
	var_16_object = var_17_object; // 0xaff Mov
	GlobalVars[1] = var_16_object; // 0xb01 PopGE
...
{
	var_21_bool = 0; var_22_float = 0; var_23_string = ""; var_24_bool = 0; var_25_float = 0; var_26_string = ""; // 0xb03 PushV
	var_27_bool = 0; var_28_object = Obj(); // 0xb04 PushV
	var_28_object = var_20_object; // 0xb05 Mov
	func_2201(var_27_bool, var_28_object); // 0xb06 NEW_2
	var_61_bool = var_27_bool == 0; // 0xb08 Not
	if(var_61_bool == 0) goto Label_2828; // 0xb09 JumpB
	var_19_bool = 0; // 0xb0a MovB
	return 6; // 0xb0b Return
	
Label_2828:
	var_62_object = GlobalVars[1]; // 0xb0c PushGE
	in(var_24_bool, var_20_object); // 0xb0d ObjFunc
	var_63_bool = var_24_bool; // 0xb0f Push
	if(var_63_bool == 0) goto Label_2835; // 0xb10 JumpB
	var_19_bool = 1; // 0xb11 MovB
	return 6; // 0xb12 Return
	
Label_2835:
	var_64_bool = 0; var_65_object = Obj(); // 0xb13 PushV
	var_65_object = var_20_object; // 0xb14 Mov
	func_2017(var_64_bool, var_65_object); // 0xb15 NEW_2
	if(var_64_bool == 0) goto Label_2846; // 0xb17 JumpB
	var_68_string = "reputation"; // 0xb18 PushS
	GetProperty(var_68_string, var_25_float); // 0xb19 ObjFunc
	var_69_float = 0.33; // 0xb1b PushF
	var_19_bool = var_25_float >= var_69_float; // 0xb1c GE2
	return 6; // 0xb1d Return
	
Label_2846:
	var_70_bool = 0; var_71_object = Obj(); var_72_string = ""; // 0xb1e PushV
	var_71_object = var_20_object; // 0xb1f Mov
	var_72_string = "class"; // 0xb20 MovS
	func_2022(var_70_bool, var_71_object, var_72_string); // 0xb21 NEW_2
	var_73_bool = var_70_bool == 0; // 0xb23 Not
	if(var_73_bool == 0) goto Label_2855; // 0xb24 JumpB
	var_19_bool = 0; // 0xb25 MovB
	return 6; // 0xb26 Return
	
Label_2855:
	var_74_string = "class"; // 0xb27 PushS
	GetProperty(var_74_string, var_26_string); // 0xb28 ObjFunc
	var_75_bool = 0; var_76_string = ""; // 0xb2a PushV
	var_76_string = var_26_string; // 0xb2b Mov
	func_2483(var_75_bool, var_76_string); // 0xb2c NEW_2
	var_19_bool = var_75_bool; // 0xb2d Mov
	return 6; // 0xb2f Return
}
...
func_1824(var_60_object)
{
	...
	func_3132(); // 0x726 NEW_2
	
Label_1832:
	func_3108(); // 0x729 NEW_2
...
{
	var_19_bool = 0; var_20_object = Obj(); // 0xb31 PushV
	var_20_object = var_18_object; // 0xb32 Mov
	func_2819(var_19_bool, var_20_object); // 0xb33 NEW_2
	var_17_bool = var_19_bool; // 0xb34 Mov
...
{
	var_115_bool = 0; var_116_object = Obj(); // 0xb38 PushV
	var_116_object = var_114_object; // 0xb39 Mov
	TaskCall(7); // 0xb3a TaskCall
	func_1770(var_115_bool, var_116_object); // 0xb3b NEW_2
	TaskReturn(); // 0xb3c TaskReturn
	if(var_115_bool == 0) goto Label_2885; // 0xb3e JumpB
	var_754_object = Obj(); // 0xb3f PushV
	var_754_object = var_114_object; // 0xb40 Mov
	TaskCall(6); // 0xb41 TaskCall
	func_1555(var_757_bool, var_754_object); // 0xb42 NEW_2
	TaskReturn(); // 0xb43 TaskReturn
...
{
	var_19_bool = 0; var_20_object = Obj(); // 0xb49 PushV
	var_20_object = var_18_object; // 0xb4a Mov
	func_2819(var_19_bool, var_20_object); // 0xb4b NEW_2
	var_17_bool = var_19_bool; // 0xb4c Mov
...
func_847(var_0_bool)
{
	...
	func_2709(var_279_object); // 0x351 NEW_2
...
{
	var_115_bool = 0; var_116_object = Obj(); // 0xb50 PushV
	var_116_object = var_114_object; // 0xb51 Mov
	TaskCall(7); // 0xb52 TaskCall
	func_1770(var_115_bool, var_116_object); // 0xb53 NEW_2
	TaskReturn(); // 0xb54 TaskReturn
	if(var_115_bool == 0) goto Label_2909; // 0xb56 JumpB
	var_754_object = Obj(); // 0xb57 PushV
	var_754_object = var_114_object; // 0xb58 Mov
	TaskCall(6); // 0xb59 TaskCall
	func_1555(var_757_bool, var_754_object); // 0xb5a NEW_2
...
{
	var_21_bool = 0; var_22_bool = 0; // 0xb60 PushV
	var_23_bool = var_20_object == 0; // 0xb61 NullEq
	if(var_23_bool == 0) goto Label_2916; // 0xb62 JumpB
	return 2; // 0xb63 Return
	
Label_2916:
	var_24_object = GlobalVars[1]; // 0xb64 PushGE
	in(var_22_bool, var_20_object); // 0xb65 ObjFunc
	var_25_bool = var_22_bool == 0; // 0xb67 Not
	if(var_25_bool == 0) goto Label_2924; // 0xb68 JumpB
	var_26_object = GlobalVars[1]; // 0xb69 PushGE
	add(var_20_object); // 0xb6a ObjFunc
	
Label_2924:
	return 2; // 0xb6c Return
}
...
{
	var_20_object = Obj(); // 0xb6e PushV
	var_20_object = var_19_object; // 0xb6f Mov
	func_2912(var_20_object); // 0xb70 NEW_2
	var_27_bool = 0; var_28_object = Obj(); // 0xb72 PushV
	var_28_object = var_19_object; // 0xb73 Mov
	func_2201(var_27_bool, var_28_object); // 0xb74 NEW_2
	var_61_bool = var_27_bool == 0; // 0xb76 Not
	if(var_61_bool == 0) goto Label_2937; // 0xb77 JumpB
	return 0; // 0xb78 Return
	
Label_2937:
	var_62_bool = 0; var_63_object = Obj(); // 0xb79 PushV
	var_63_object = var_19_object; // 0xb7a Mov
	TaskCall(7); // 0xb7b TaskCall
	func_1770(var_62_bool, var_63_object); // 0xb7c NEW_2
	TaskReturn(); // 0xb7d TaskReturn
	if(var_62_bool == 0) goto Label_2950; // 0xb7f JumpB
	var_703_object = Obj(); // 0xb80 PushV
	var_703_object = var_19_object; // 0xb81 Mov
	TaskCall(6); // 0xb82 TaskCall
	func_1555(var_706_bool, var_703_object); // 0xb83 NEW_2
	TaskReturn(); // 0xb84 TaskReturn
...
func_887(var_2_int, var_282_bool, var_283_object, var_284_float, var_285_float, var_286_bool, var_287_bool)
{
	...
	func_2709(var_295_object); // 0x37a NEW_2
...
Label_1411:
	...
	func_2742(var_67_int); // 0x584 NEW_2
...
Label_1426:
	...
	func_2735(var_89_string, var_90_int); // 0x5a0 NEW_2
...
{
	var_22_bool = 0; var_23_float = 0; var_24_bool = 0; var_25_float = 0; // 0xb89 PushV
	var_26_bool = 0; var_27_object = Obj(); // 0xb8a PushV
	var_27_object = var_21_object; // 0xb8b Mov
	func_2794(var_26_bool, var_27_object); // 0xb8c NEW_2
	if(var_26_bool == 0) goto Label_2984; // 0xb8e JumpB
	CanSee(var_24_bool, var_20_object); // 0xb8f Func
	var_44_float = 0; var_45_object = Obj(); // 0xb91 PushV
	var_45_object = var_20_object; // 0xb92 Mov
	func_2009(var_45_object); // 0xb93 NEW_2
	var_25_float = var_44_float; // 0xb94 Mov
	var_52_bool = 0; // 0xb96 PushV
	var_52_bool = 0; // 0xb97 MovB
	var_53_float = 1000000.0; // 0xb98 PushF
	var_54_bool = var_25_float <= var_53_float; // 0xb99 LE
	if(var_54_bool == 0) goto Label_2981; // 0xb9a JumpB
	var_55_bool = 0; // 0xb9b PushV
	var_55_bool = 1; // 0xb9c MovB
	var_56_bool = var_24_bool; // 0xb9d Push
	if(var_56_bool == 0) goto Label_2979; // 0xb9e JumpB
	var_57_float = 490000.0; // 0xb9f PushF
	var_58_bool = var_25_float <= var_57_float; // 0xba0 LE
	if(var_58_bool == 0) goto Label_2979; // 0xba1 JumpB
	var_55_bool = 0; // 0xba2 MovB
	
Label_2979:
	if(var_55_bool == 0) goto Label_2981; // 0xba3 JumpB
	var_52_bool = 1; // 0xba4 MovB
	
Label_2981:
	if(var_52_bool == 0) goto Label_2984; // 0xba5 JumpB
	var_19_bool = 1; // 0xba6 MovB
	return 4; // 0xba7 Return
	
Label_2984:
	var_19_bool = 0; // 0xba8 MovB
	return 4; // 0xba9 Return
}
...
{
	var_18_bool = 0; var_19_object = Obj(); // 0xbab PushV
	var_19_object = var_17_object; // 0xbac Mov
	func_2017(var_18_bool, var_19_object); // 0xbad NEW_2
	if(var_18_bool == 0) goto Label_2997; // 0xbaf JumpB
	var_22_bool = 0; var_23_object = Obj(); var_24_float = 0; // 0xbb0 PushV
	var_23_object = var_17_object; // 0xbb1 Mov
	var_24_float = 0.05; // 0xbb2 MovF
	func_2647(var_22_bool, var_23_object, var_24_float); // 0xbb3 NEW_2
	
Label_2997:
	var_60_object = Obj(); // 0xbb5 PushV
	var_60_object = var_17_object; // 0xbb6 Mov
	TaskCall(8); // 0xbb7 TaskCall
	func_1824(var_60_object); // 0xbb8 NEW_2
	TaskReturn(); // 0xbb9 TaskReturn
...
{
	var_107_int = 0; var_108_int = 0; // 0xbe1 PushV
	var_109_string = "branch"; // 0xbe2 PushS
	GetVariable(var_109_string, var_108_int); // 0xbe3 Func
	var_106_int = var_108_int; // 0xbe5 Mov
...
{
	var_21_int = 0; // 0xbe8 PushV
	func_3041(var_21_int); // 0xbe9 NEW_2
	var_25_int = 1; // 0xbeb PushI
	var_26_bool = var_21_int == var_25_int; // 0xbec Eq
	if(var_26_bool == 0) goto Label_3057; // 0xbed JumpB
	WorkWithCorpse(var_20_object); // 0xbee Func
...
Label_3057:
	Barter(var_20_object); // 0xbf1 Func
}
...
{
	var_71_int = 0; var_72_bool = 0; var_73_int = 0; var_74_bool = 0; // 0xbf4 PushV
	var_75_bool = var_69_int > var_70_int; // 0xbf5 GT
	if(var_75_bool == 0) goto Label_3067; // 0xbf6 JumpB
	var_76_string = "GenerateMoney: iMin > iMax"; // 0xbf7 PushS
	Trace(var_76_string); // 0xbf8 Func
	return 4; // 0xbfa Return
	
Label_3067:
	var_73_int = 0; // 0xbfb MovI
	var_77_bool = var_69_int != var_70_int; // 0xbfc Neq
	if(var_77_bool == 0) goto Label_3074; // 0xbfd JumpB
	var_78_int = var_70_int - var_69_int; // 0xbfe Sub
	irand(var_73_int, var_78_int); // 0xbff Func
	goto Label_3078; // 0xc01 Jump
	
Label_3078:
	var_73_int = var_73_int + var_69_int; // 0xc06 Add2
	var_79_int = 0; // 0xc07 PushI
	var_80_bool = var_73_int == var_79_int; // 0xc08 Eq
	if(var_80_bool == 0) goto Label_3083; // 0xc09 JumpB
	return 4; // 0xc0a Return
	
Label_3083:
	var_81_int = 0; var_82_string = ""; // 0xc0b PushV
	var_82_string = "Money"; // 0xc0c MovS
	func_3162(var_81_int, var_82_string); // 0xc0d NEW_2
	var_85_int = 0; // 0xc0f PushI
	AddItem(var_74_bool, var_81_int, var_85_int, var_73_int); // 0xc10 Func
	return 4; // 0xc12 Return
	
Label_3074:
	var_86_int = 0; // 0xc02 PushI
	var_87_bool = var_69_int == var_86_int; // 0xc03 Eq
	if(var_87_bool == 0) goto Label_3078; // 0xc04 JumpB
...
Label_542:
	...
	func_2201(var_641_bool, var_642_object); // 0x239 NEW_2
...
Label_594:
	...
	func_2201(var_667_bool, var_668_object); // 0x25f NEW_2
