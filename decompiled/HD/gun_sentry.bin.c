...
func_0(var_20_object)
{
	...
	func_1001(var_21_bool, var_22_object); // 0x3 NEW_2
...
func_1667()
{
	var_23_int = 0; var_24_bool = 0; var_25_int = 0; var_26_bool = 0; // 0x683 PushV
	var_27_int = 0; // 0x684 PushI
	ClearSubContainer(var_27_int); // 0x685 Func
	var_28_int = 0; var_29_int = 0; // 0x687 PushV
	var_28_int = 500; // 0x688 MovI
	var_29_int = 1000; // 0x689 MovI
	func_1595(var_28_int, var_29_int); // 0x68a NEW_2
	var_47_string = ""; var_48_int = 0; var_49_int = 0; var_50_int = 0; // 0x68c PushV
	var_47_string = "rifle_ammo"; // 0x68d MovS
	var_48_int = 1; // 0x68e MovI
	var_49_int = 3; // 0x68f MovI
	var_50_int = 3; // 0x690 MovI
	func_1311(var_47_string, var_48_int, var_49_int, var_50_int); // 0x691 NEW_2
	var_63_string = ""; var_64_int = 0; var_65_int = 0; var_66_int = 0; // 0x693 PushV
	var_63_string = "rusk"; // 0x694 MovS
	var_64_int = 1; // 0x695 MovI
	var_65_int = 3; // 0x696 MovI
	var_66_int = 2; // 0x697 MovI
	func_1311(var_63_string, var_64_int, var_65_int, var_66_int); // 0x698 NEW_2
	var_67_string = ""; var_68_int = 0; var_69_int = 0; // 0x69a PushV
	var_67_string = "bandage"; // 0x69b MovS
	var_68_int = 1; // 0x69c MovI
	var_69_int = 6; // 0x69d MovI
	func_1300(var_67_string, var_68_int, var_69_int); // 0x69e NEW_2
	var_76_string = ""; var_77_int = 0; var_78_int = 0; // 0x6a0 PushV
	var_76_string = "tourniquet"; // 0x6a1 MovS
	var_77_int = 1; // 0x6a2 MovI
	var_78_int = 6; // 0x6a3 MovI
	func_1300(var_76_string, var_77_int, var_78_int); // 0x6a4 NEW_2
...
func_133(var_122_string)
{
	...
	func_1326(var_123_string); // 0x92 NEW_2
...
{
	var_70_bool = 0; var_71_bool = 0; // 0x514 PushV
	var_72_bool = 0; var_73_int = 0; var_74_int = 0; // 0x515 PushV
	var_73_int = var_68_int; // 0x516 Mov
	var_74_int = var_69_int; // 0x517 Mov
	func_1492(var_72_bool, var_73_int, var_74_int); // 0x518 NEW_2
	if(var_72_bool == 0) goto Label_1310; // 0x51a JumpB
	var_75_int = 0; // 0x51b PushI
	AddItem(var_71_bool, var_67_string, var_75_int); // 0x51c Func
...
{
	var_51_int = 0; var_52_bool = 0; var_53_int = 0; var_54_bool = 0; // 0x51f PushV
	var_55_bool = 0; var_56_int = 0; var_57_int = 0; // 0x520 PushV
	var_56_int = var_48_int; // 0x521 Mov
	var_57_int = var_49_int; // 0x522 Mov
	func_1492(var_55_bool, var_56_int, var_57_int); // 0x523 NEW_2
	if(var_55_bool == 0) goto Label_1325; // 0x525 JumpB
	irand(var_53_int, var_50_int); // 0x526 Func
	var_60_int = 0; // 0x528 PushI
	var_61_int = 1; // 0x529 PushI
	var_62_int = var_53_int + var_61_int; // 0x52a Add
	AddItem(var_54_bool, var_47_string, var_60_int, var_62_int); // 0x52b Func
...
{
	var_42_int = 0; var_43_int = 0; // 0x6a7 PushV
	GetInvItemByName(var_43_int, var_41_string); // 0x6a8 Func
	var_40_int = var_43_int; // 0x6aa Mov
...
{
	var_80_int = 0; var_81_int = 0; // 0x628 PushV
	var_82_string = "branch"; // 0x629 PushS
	GetVariable(var_82_string, var_81_int); // 0x62a Func
	var_79_int = var_81_int; // 0x62c Mov
...
Label_110:
	...
	func_1326(var_175_string); // 0x70 NEW_2
...
{
	var_20_object = Obj(); // 0x6ad PushV
	var_20_object = var_19_object; // 0x6ae Mov
	TaskCall(0); // 0x6af TaskCall
	func_0(var_20_object); // 0x6b0 NEW_2
...
{
	var_124_bool = 0; var_125_int = 0; var_126_bool = 0; var_127_int = 0; var_128_bool = 0; var_129_float = 0; var_130_cvector = CVector(0,0,0); var_131_cvector = CVector(0,0,0); var_132_bool = 0; var_133_int = 0; var_134_bool = 0; var_135_int = 0; var_136_bool = 0; var_137_float = 0; var_138_cvector = CVector(0,0,0); var_139_cvector = CVector(0,0,0); // 0x52e PushV
	IsExisting3DSound(var_132_bool, var_123_string); // 0x52f Func
	var_140_bool = var_132_bool == 0; // 0x531 Not
	if(var_140_bool == 0) goto Label_1351; // 0x532 JumpB
	var_133_int = 0; // 0x533 MovI
	
Label_1332:
	var_141_int = 1; // 0x534 PushI
	var_142_int = var_133_int + var_141_int; // 0x535 Add
	var_143_int = var_123_string + var_142_int; // 0x536 Add
	IsExisting3DSound(var_134_bool, var_143_int); // 0x537 Func
	var_144_bool = var_134_bool == 0; // 0x539 Not
	if(var_144_bool == 0) goto Label_1340; // 0x53a JumpB
	goto Label_1343; // 0x53b Jump
	
Label_1343:
	var_145_bool = var_133_int == 0; // 0x53f Not
	if(var_145_bool == 0) goto Label_1346; // 0x540 JumpB
	return 16; // 0x541 Return
	
Label_1346:
	irand(var_135_int, var_133_int); // 0x542 Func
	var_146_int = 1; // 0x544 PushI
	var_147_int = var_135_int + var_146_int; // 0x545 Add
	var_123_string = var_123_string + var_147_int; // 0x546 Add2
	
Label_1351:
	Is3DSoundLoaded(var_136_bool, var_123_string); // 0x547 Func
	var_148_bool = var_136_bool; // 0x549 Push
	if(var_148_bool == 0) goto Label_1366; // 0x54a JumpB
	GetEyesHeight(var_137_float); // 0x54b Func
	GetDirection(var_138_cvector); // 0x54d Func
	var_149_int = 50; // 0x54f PushI
	var_139_cvector = var_138_cvector * var_149_int; // 0x550 Mult2
	var_150_float = GetByIndex(var_139_cvector, 1); // 0x551 PushE
	var_150_float = var_150_float + var_137_float; // 0x552 Add2
	SetByIndex(var_139_cvector, 1) = var_150_float; // 0x553 PopE
	PlayGlobalSound(var_123_string, var_139_cvector); // 0x554 Func
	
Label_1366:
	return 16; // 0x556 Return
	
Label_1340:
	var_151_int = 1; // 0x53c PushI
	var_133_int = var_133_int + var_151_int; // 0x53d Add2
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x63b PushV
	var_34_bool = var_28_int > var_29_int; // 0x63c GT
	if(var_34_bool == 0) goto Label_1602; // 0x63d JumpB
	var_35_string = "GenerateMoney: iMin > iMax"; // 0x63e PushS
	Trace(var_35_string); // 0x63f Func
	return 4; // 0x641 Return
	
Label_1602:
	var_32_int = 0; // 0x642 MovI
	var_36_bool = var_28_int != var_29_int; // 0x643 Neq
	if(var_36_bool == 0) goto Label_1609; // 0x644 JumpB
	var_37_int = var_29_int - var_28_int; // 0x645 Sub
	irand(var_32_int, var_37_int); // 0x646 Func
	goto Label_1613; // 0x648 Jump
	
Label_1613:
	var_32_int = var_32_int + var_28_int; // 0x64d Add2
	var_38_int = 0; // 0x64e PushI
	var_39_bool = var_32_int == var_38_int; // 0x64f Eq
	if(var_39_bool == 0) goto Label_1618; // 0x650 JumpB
	return 4; // 0x651 Return
	
Label_1618:
	var_40_int = 0; var_41_string = ""; // 0x652 PushV
	var_41_string = "Money"; // 0x653 MovS
	func_1703(var_40_int, var_41_string); // 0x654 NEW_2
	var_44_int = 0; // 0x656 PushI
	AddItem(var_33_bool, var_40_int, var_44_int, var_32_int); // 0x657 Func
	return 4; // 0x659 Return
	
Label_1609:
	var_45_int = 0; // 0x649 PushI
	var_46_bool = var_28_int == var_45_int; // 0x64a Eq
	if(var_46_bool == 0) goto Label_1613; // 0x64b JumpB
...
{
	var_19_object = Obj(); // 0x84c PushV
	var_19_object = var_18_object; // 0x84d Mov
	func_1708(var_19_object); // 0x84e NEW_2
...
{
	var_58_int = 0; var_59_int = 0; // 0x5d4 PushV
	irand(var_59_int, var_57_int); // 0x5d5 Func
	var_55_bool = var_59_int < var_56_int; // 0x5d7 LT2
...
{
	var_86_object = Obj(); var_87_int = 0; var_88_bool = 0; var_89_object = Obj(); var_90_int = 0; var_91_bool = 0; // 0x65a PushV
	CreateInvItem(var_89_object); // 0x65b Func
	SetItemName(var_85_string); // 0x65d ObjFunc
	var_92_string = "Organ"; // 0x65f PushS
	var_93_int = 1; // 0x660 PushI
	SetProperty(var_92_string, var_93_int); // 0x661 ObjFunc
	GetItemID(var_90_int); // 0x663 ObjFunc
	var_94_int = 0; // 0x665 PushI
	var_95_int = 1; // 0x666 PushI
	AddItem(var_91_bool, var_89_object, var_94_int, var_95_int); // 0x667 Func
...
func_1643()
{
	var_79_int = 0; // 0x66b PushV
	func_1576(var_79_int); // 0x66c NEW_2
	var_83_int = 1; // 0x66e PushI
	var_84_bool = var_79_int != var_83_int; // 0x66f Neq
	if(var_84_bool == 0) goto Label_1650; // 0x670 JumpB
	return 0; // 0x671 Return
	
Label_1650:
	var_85_string = ""; // 0x672 PushV
	var_85_string = "liver"; // 0x673 MovS
	func_1626(var_85_string); // 0x674 NEW_2
	var_96_string = ""; // 0x676 PushV
	var_96_string = "kidney"; // 0x677 MovS
	func_1626(var_96_string); // 0x678 NEW_2
	var_97_string = ""; // 0x67a PushV
	var_97_string = "heart"; // 0x67b MovS
	func_1626(var_97_string); // 0x67c NEW_2
	var_98_string = ""; // 0x67e PushV
	var_98_string = "blood"; // 0x67f MovS
	func_1626(var_98_string); // 0x680 NEW_2
