...
0x80f: Push("GenerateMoney: iMin > iMax")
0x810: @ Trace(Stack[-1])
0x811: Pop(1)
0x812: Return(); Pop(4)
...
0x82d: Pop(0)
0x82e: @@ SetItemName(Stack[-7])
0x82f: Pop(0)
0x830: Push("Organ")
0x831: Push((int) 1)
0x832: @@ SetProperty(Stack[-2], Stack[-1])
0x833: Pop(2)
0x834: @@ GetItemID(Stack[-2])
0x835: Pop(0)
0x836: Push((int) 0)
0x837: Push((int) 1)
...
0x89a: Stack[-2] = Stack[-4]
0x89b: Stack[-1] = (float) 0.1
0x89c: Call2 0x79e
...
0x8a0: Stack[-2] = Stack[-4]
0x8a1: Stack[-1] = (float) 0.05
0x8a2: Call2 0x79e
