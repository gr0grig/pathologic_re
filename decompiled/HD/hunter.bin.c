task_0_event_0(var_0_object, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_bool, var_12_bool)
{
	...
	func_2047(var_16_object); // 0x22 NEW_2
...
task_1_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_bool, var_12_bool)
{
	...
	func_2351(var_13_object); // 0xa3 NEW_2
...
task_1_event_7(var_0_bool, var_1_object, var_2_bool, var_3_int, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_bool, var_12_bool)
{
	...
	func_2021(var_15_object); // 0xdd NEW_2
...
task_2_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_object, var_11_bool, var_12_bool)
{
	...
	func_2351(var_13_object); // 0x1b7 NEW_2
...
task_3_event_1(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2327(var_13_bool, var_14_object); // 0x4bf NEW_2
	...
	func_2334(var_23_object); // 0x4c7 NEW_2
...
task_3_event_3(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2299(var_13_bool, var_14_object); // 0x4cd NEW_2
	...
	func_2321(var_37_object); // 0x4d5 NEW_2
...
task_3_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2351(var_48_object); // 0x4e1 NEW_2
...
Label_1252:
	...
	func_2364(var_55_object); // 0x4e9 NEW_2
...
task_4_event_1(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2327(var_13_bool, var_14_object); // 0x54e NEW_2
	...
	func_2334(var_23_object); // 0x556 NEW_2
...
task_4_event_3(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2299(var_13_bool, var_14_object); // 0x55c NEW_2
	...
	func_2321(var_37_object); // 0x564 NEW_2
...
task_4_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_bool, var_11_bool, var_12_object)
{
	...
	func_2351(var_48_object); // 0x570 NEW_2
...
Label_1395:
	...
	func_2364(var_55_object); // 0x578 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; // 0x8ac PushV
	var_16_object = var_12_object; // 0x8ad Mov
	var_17_int = var_13_int; // 0x8ae Mov
	var_18_float = var_14_float; // 0x8af Mov
	func_1731(var_16_object, var_17_int, var_18_float); // 0x8b0 NEW_2
...
{
	var_18_object = Obj(); var_19_int = 0; var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_cvector = CVector(0,0,0); // 0x8b4 PushV
	var_18_object = var_12_object; // 0x8b5 Mov
	var_19_int = var_13_int; // 0x8b6 Mov
	var_20_float = var_14_float; // 0x8b7 Mov
	var_21_cvector = var_16_cvector; // 0x8b8 Mov
	var_22_cvector = var_17_cvector; // 0x8b9 Mov
	func_1799(var_20_float, var_21_cvector, var_22_cvector); // 0x8ba NEW_2
...
{
	var_14_float = 0; var_15_float = 0; // 0x8bd PushV
	var_16_string = "health"; // 0x8be PushS
	var_17_bool = var_13_string == var_16_string; // 0x8bf Eq
	if(var_17_bool == 0) goto Label_2249; // 0x8c0 JumpB
	var_18_string = "health"; // 0x8c1 PushS
	GetProperty(var_18_string, var_15_float); // 0x8c2 Func
	var_19_int = 0; // 0x8c4 PushI
	var_20_bool = var_15_float <= var_19_int; // 0x8c5 LE
	if(var_20_bool == 0) goto Label_2249; // 0x8c6 JumpB
	SignalDeath(var_12_object); // 0x8c7 Func
...
{
	var_13_object = Obj(); // 0x8cb PushV
	var_13_object = var_12_object; // 0x8cc Mov
	func_2179(var_13_object); // 0x8cd NEW_2
...
{
	var_79_int = 0; var_80_bool = 0; var_81_int = 0; var_82_bool = 0; // 0x80c PushV
	var_83_bool = var_77_int > var_78_int; // 0x80d GT
	if(var_83_bool == 0) goto Label_2067; // 0x80e JumpB
	var_84_string = "GenerateMoney: iMin > iMax"; // 0x80f PushS
	Trace(var_84_string); // 0x810 Func
	return 4; // 0x812 Return
	
Label_2067:
	var_81_int = 0; // 0x813 MovI
	var_85_bool = var_77_int != var_78_int; // 0x814 Neq
	if(var_85_bool == 0) goto Label_2074; // 0x815 JumpB
	var_86_int = var_78_int - var_77_int; // 0x816 Sub
	irand(var_81_int, var_86_int); // 0x817 Func
	goto Label_2078; // 0x819 Jump
	
Label_2078:
	var_81_int = var_81_int + var_77_int; // 0x81e Add2
	var_87_int = 0; // 0x81f PushI
	var_88_bool = var_81_int == var_87_int; // 0x820 Eq
	if(var_88_bool == 0) goto Label_2083; // 0x821 JumpB
	return 4; // 0x822 Return
	
Label_2083:
	var_89_int = 0; var_90_string = ""; // 0x823 PushV
	var_90_string = "Money"; // 0x824 MovS
	func_2174(var_89_int, var_90_string); // 0x825 NEW_2
	var_93_int = 0; // 0x827 PushI
	AddItem(var_82_bool, var_89_int, var_93_int, var_81_int); // 0x828 Func
	return 4; // 0x82a Return
	
Label_2074:
	var_94_int = 0; // 0x81a PushI
	var_95_bool = var_77_int == var_94_int; // 0x81b Eq
	if(var_95_bool == 0) goto Label_2078; // 0x81c JumpB
...
Label_1568:
	var_470_string = "armor"; // 0x620 PushS
	GetProperty(var_470_string, var_419_int); // 0x621 ObjFunc
}
...
Label_700:
	...
	var_585_string = "all"; // 0x2be PushS
	var_586_string = "fjump"; // 0x2bf PushS
	PlayAnimation(var_585_string, var_586_string); // 0x2c0 Func
	WaitForAnimEnd(); // 0x2c2 Func
	func_1186(var_90_float); // 0x2c5 NEW_2
	var_587_cvector = CVector(0.0, 0.0, 0.0); // 0x2c7 PushVec
	SetSpeed(var_587_cvector); // 0x2c8 Func
	Stop(); // 0x2ca Func
	StopAsync(); // 0x2cc Func
	var_588_bool = 0; // 0x2ce PushV
	func_1143(var_90_float, var_588_bool); // 0x2cf NEW_2
	var_589_bool = var_588_bool == 0; // 0x2d1 Not
	if(var_589_bool == 0) goto Label_746; // 0x2d2 JumpB
	var_590_bool = 0; var_591_object = Obj(); // 0x2d3 PushV
	var_591_object = var_0_bool; // 0x2d4 MovT
	func_1663(var_590_bool, var_591_object); // 0x2d5 NEW_2
	var_592_bool = var_590_bool == 0; // 0x2d7 Not
	if(var_592_bool == 0) goto Label_730; // 0x2d8 JumpB
...
Label_730:
	...
	var_593_float = var_68_float * var_68_float; // 0x2e0 Mult
	var_594_bool = var_87_float < var_593_float; // 0x2e1 LT
	if(var_594_bool == 0) goto Label_746; // 0x2e2 JumpB
	var_595_bool = 0; var_596_float = 0; // 0x2e3 PushV
	var_596_float = var_68_float; // 0x2e4 Mov
	func_847(var_90_float, var_595_bool, var_596_float); // 0x2e5 NEW_2
	var_597_bool = var_595_bool == 0; // 0x2e7 Not
	if(var_597_bool == 0) goto Label_746; // 0x2e8 JumpB
	goto Label_756; // 0x2e9 Jump
	
Label_747:
	var_598_bool = 0; var_599_float = 0; // 0x2eb PushV
	var_599_float = var_68_float; // 0x2ec Mov
	func_847(var_90_float, var_598_bool, var_599_float); // 0x2ed NEW_2
	var_600_bool = var_598_bool == 0; // 0x2ef Not
	if(var_600_bool == 0) goto Label_754; // 0x2f0 JumpB
...
{
	var_124_object = Obj(); var_125_int = 0; var_126_bool = 0; var_127_object = Obj(); var_128_int = 0; var_129_bool = 0; // 0x82b PushV
	CreateInvItem(var_127_object); // 0x82c Func
	SetItemName(var_123_string); // 0x82e ObjFunc
	var_130_string = "Organ"; // 0x830 PushS
	var_131_int = 1; // 0x831 PushI
	SetProperty(var_130_string, var_131_int); // 0x832 ObjFunc
	GetItemID(var_128_int); // 0x834 ObjFunc
	var_132_int = 0; // 0x836 PushI
	var_133_int = 1; // 0x837 PushI
	AddItem(var_129_bool, var_127_object, var_132_int, var_133_int); // 0x838 Func
...
func_2108()
{
	var_120_int = 0; // 0x83c PushV
	func_2041(var_120_int); // 0x83d NEW_2
	var_121_int = 1; // 0x83f PushI
	var_122_bool = var_120_int != var_121_int; // 0x840 Neq
	if(var_122_bool == 0) goto Label_2115; // 0x841 JumpB
	return 0; // 0x842 Return
	
Label_2115:
	var_123_string = ""; // 0x843 PushV
	var_123_string = "liver"; // 0x844 MovS
	func_2091(var_123_string); // 0x845 NEW_2
	var_134_string = ""; // 0x847 PushV
	var_134_string = "kidney"; // 0x848 MovS
	func_2091(var_134_string); // 0x849 NEW_2
	var_135_string = ""; // 0x84b PushV
	var_135_string = "heart"; // 0x84c MovS
	func_2091(var_135_string); // 0x84d NEW_2
	var_136_string = ""; // 0x84f PushV
	var_136_string = "blood"; // 0x850 MovS
	func_2091(var_136_string); // 0x851 NEW_2
...
func_2132()
{
	var_72_int = 0; var_73_bool = 0; var_74_int = 0; var_75_bool = 0; // 0x854 PushV
	var_76_int = 0; // 0x855 PushI
	ClearSubContainer(var_76_int); // 0x856 Func
	var_77_int = 0; var_78_int = 0; // 0x858 PushV
	var_77_int = 200; // 0x859 MovI
	var_78_int = 500; // 0x85a MovI
	func_2060(var_77_int, var_78_int); // 0x85b NEW_2
	var_96_string = ""; var_97_int = 0; var_98_int = 0; // 0x85d PushV
	var_96_string = "revolver_ammo"; // 0x85e MovS
	var_97_int = 1; // 0x85f MovI
	var_98_int = 80; // 0x860 MovI
	func_1840(var_96_string, var_97_int, var_98_int); // 0x861 NEW_2
	var_107_string = ""; var_108_int = 0; var_109_int = 0; // 0x863 PushV
	var_107_string = "samopal_ammo"; // 0x864 MovS
	var_108_int = 1; // 0x865 MovI
	var_109_int = 80; // 0x866 MovI
	func_1840(var_107_string, var_108_int, var_109_int); // 0x867 NEW_2
	var_110_string = ""; var_111_int = 0; var_112_int = 0; // 0x869 PushV
	var_110_string = "rifle_ammo"; // 0x86a MovS
	var_111_int = 1; // 0x86b MovI
	var_112_int = 80; // 0x86c MovI
	func_1840(var_110_string, var_111_int, var_112_int); // 0x86d NEW_2
	var_113_string = ""; var_114_int = 0; var_115_int = 0; // 0x86f PushV
	var_113_string = "lockpick"; // 0x870 MovS
	var_114_int = 1; // 0x871 MovI
	var_115_int = 80; // 0x872 MovI
	func_1840(var_113_string, var_114_int, var_115_int); // 0x873 NEW_2
	var_116_int = 0; var_117_string = ""; // 0x875 PushV
	var_117_string = "hunter_mark"; // 0x876 MovS
	func_2174(var_116_int, var_117_string); // 0x877 NEW_2
	var_118_int = 0; // 0x879 PushI
	var_119_int = 1; // 0x87a PushI
	AddItem(var_75_bool, var_116_int, var_118_int, var_119_int); // 0x87b Func
...
{
	var_91_int = 0; var_92_int = 0; // 0x87e PushV
	GetInvItemByName(var_92_int, var_90_string); // 0x87f Func
	var_89_int = var_92_int; // 0x881 Mov
...
{
	var_14_bool = 0; var_15_object = Obj(); // 0x884 PushV
	var_15_object = var_13_object; // 0x885 Mov
	func_1510(var_14_bool, var_15_object); // 0x886 NEW_2
	if(var_14_bool == 0) goto Label_2212; // 0x888 JumpB
	var_18_bool = 0; // 0x889 PushV
	var_18_bool = 0; // 0x88a MovB
	var_19_int = 0; // 0x88b PushV
	func_2041(var_19_int); // 0x88c NEW_2
	var_23_int = 2; // 0x88e PushI
	var_24_bool = var_19_int == var_23_int; // 0x88f Eq
	if(var_24_bool == 0) goto Label_2200; // 0x890 JumpB
	var_25_int = 0; // 0x891 PushV
	func_2012(var_25_int); // 0x892 NEW_2
	var_31_int = 6; // 0x894 PushI
	var_32_bool = var_25_int == var_31_int; // 0x895 Eq
	if(var_32_bool == 0) goto Label_2200; // 0x896 JumpB
	var_18_bool = 1; // 0x897 MovB
	
Label_2200:
	if(var_18_bool == 0) goto Label_2207; // 0x898 JumpB
	var_33_bool = 0; var_34_object = Obj(); var_35_float = 0; // 0x899 PushV
	var_34_object = var_13_object; // 0x89a Mov
	var_35_float = 0.1; // 0x89b MovF
	func_1950(var_33_bool, var_34_object, var_35_float); // 0x89c NEW_2
	goto Label_2212; // 0x89e Jump
	
Label_2212:
	var_71_object = Obj(); // 0x8a4 PushV
	var_71_object = var_13_object; // 0x8a5 Mov
	TaskCall(0); // 0x8a6 TaskCall
	func_0(var_71_object); // 0x8a7 NEW_2
	TaskReturn(); // 0x8a8 TaskReturn
	return 0; // 0x8aa Return
	
Label_2207:
	var_220_bool = 0; var_221_object = Obj(); var_222_float = 0; // 0x89f PushV
	var_221_object = var_13_object; // 0x8a0 Mov
	var_222_float = 0.05; // 0x8a1 MovF
	func_1950(var_220_bool, var_221_object, var_222_float); // 0x8a2 NEW_2
}
...
func_1186(var_0_bool)
{
	...
	func_2021(var_130_object); // 0x4a4 NEW_2
...
func_166(var_2_bool, var_137_bool, var_138_object, var_139_float, var_140_float, var_141_bool, var_142_bool)
{
	...
	func_2021(var_150_object); // 0xa9 NEW_2
...
{
	var_69_string = ""; var_70_string = ""; // 0x8d0 PushV
	var_70_string = "idle"; // 0x8d1 MovS
	var_71_int = var_68_int; // 0x8d2 Push
	if(var_71_int == 0) goto Label_2261; // 0x8d3 JumpB
	var_70_string = var_70_string + var_68_int; // 0x8d4 Add2
	
Label_2261:
	var_67_string = var_70_string; // 0x8d5 Mov
...
{
	var_62_int = 0; var_63_bool = 0; var_64_int = 0; var_65_bool = 0; // 0x8d7 PushV
	var_64_int = 0; // 0x8d8 MovI
	
Label_2265:
	var_66_string = "all"; // 0x8d9 PushS
	var_67_string = ""; var_68_int = 0; // 0x8da PushV
	var_68_int = var_64_int; // 0x8db Mov
	func_2256(var_67_string, var_68_int); // 0x8dc NEW_2
	HasAnimation(var_65_bool, var_66_string, var_67_string); // 0x8de Func
	var_72_bool = var_65_bool == 0; // 0x8e0 Not
	if(var_72_bool == 0) goto Label_2275; // 0x8e1 JumpB
	goto Label_2278; // 0x8e2 Jump
	
Label_2278:
	var_61_int = var_64_int; // 0x8e6 Mov
	return 4; // 0x8e7 Return
	
Label_2275:
	var_73_int = 1; // 0x8e3 PushI
	var_64_int = var_64_int + var_73_int; // 0x8e4 Add2
	goto Label_2265; // 0x8e5 Jump
}
...
func_2280()
{
	var_12_object = GlobalVars[0]; // 0x8e8 PushGE
	var_13_object = Obj(); // 0x8e9 PushV
	func_1944(var_13_object); // 0x8ea NEW_2
	var_12_object = var_13_object; // 0x8eb Mov
	GlobalVars[0] = var_12_object; // 0x8ed PopGE
...
{
	var_19_bool = 0; var_20_bool = 0; var_21_bool = 0; var_22_bool = 0; // 0x8ef PushV
	var_23_object = GlobalVars[0]; // 0x8f0 PushGE
	in(var_21_bool, var_18_object); // 0x8f1 ObjFunc
	var_24_bool = var_21_bool; // 0x8f3 Push
	if(var_24_bool == 0) goto Label_2295; // 0x8f4 JumpB
	var_17_bool = 1; // 0x8f5 MovB
	return 4; // 0x8f6 Return
	
Label_2295:
	IsPlayerActor(var_18_object, var_22_bool); // 0x8f7 Func
	var_17_bool = var_22_bool; // 0x8f9 Mov
	return 4; // 0x8fa Return
}


func_2299(var_13_bool, var_14_object)
{
	var_15_cvector = CVector(0,0,0); var_16_cvector = CVector(0,0,0); // 0x8fb PushV
	var_17_bool = 0; var_18_object = Obj(); // 0x8fc PushV
	var_18_object = var_14_object; // 0x8fd Mov
	func_2287(var_17_bool, var_18_object); // 0x8fe NEW_2
	if(var_17_bool == 0) goto Label_2319; // 0x900 JumpB
	var_25_cvector = CVector(0,0,0); var_26_object = Obj(); // 0x901 PushV
	var_26_object = var_14_object; // 0x902 Mov
	func_1503(var_26_object); // 0x903 NEW_2
	var_16_cvector = var_25_cvector; // 0x904 Mov
	var_31_float = 0; var_32_float = 0; // 0x906 PushV
	var_33_float = GetByIndex(var_16_cvector, 1); // 0x907 PushE
	var_32_float = var_33_float; // 0x908 Mov
	func_1915(var_31_float, var_32_float); // 0x90a NEW_2
	var_36_int = 200; // 0x90c PushI
	var_13_bool = var_31_float < var_36_int; // 0x90d LT2
	return 2; // 0x90e Return
	
Label_2319:
	var_13_bool = 0; // 0x90f MovB
...
{
	var_38_object = Obj(); // 0x912 PushV
	var_38_object = var_37_object; // 0x913 Mov
	func_2340(var_38_object); // 0x914 NEW_2
...
{
	var_15_bool = 0; var_16_object = Obj(); // 0x918 PushV
	var_16_object = var_14_object; // 0x919 Mov
	func_2287(var_15_bool, var_16_object); // 0x91a NEW_2
	var_13_bool = var_15_bool; // 0x91b Mov
...
{
	var_24_object = Obj(); // 0x91f PushV
	var_24_object = var_23_object; // 0x920 Mov
	func_2340(var_24_object); // 0x921 NEW_2
...
{
	var_39_object = Obj(); var_40_bool = 0; // 0x925 PushV
	var_39_object = var_38_object; // 0x926 Mov
	var_40_bool = 1; // 0x927 MovB
	TaskCall(2); // 0x928 TaskCall
	func_422(var_39_object, var_40_bool); // 0x929 NEW_2
...
func_808(var_0_bool, var_392_float, var_393_int)
{
	...
	var_471_int = 0; // 0x343 PushV
	func_1191(var_471_int); // 0x344 NEW_2
	ReportHit(var_0_bool, var_471_int, var_399_float, var_398_float); // 0x346 Func
	var_472_object = Obj(); var_473_float = 0; // 0x348 PushV
	var_472_object = var_397_object; // 0x349 Mov
	var_473_float = var_399_float; // 0x34a Mov
...
{
	var_49_bool = 0; var_50_bool = 0; // 0x92f PushV
	var_51_bool = var_48_object == 0; // 0x930 NullEq
	if(var_51_bool == 0) goto Label_2355; // 0x931 JumpB
	return 2; // 0x932 Return
	
Label_2355:
	var_52_object = GlobalVars[0]; // 0x933 PushGE
	in(var_50_bool, var_48_object); // 0x934 ObjFunc
	var_53_bool = var_50_bool == 0; // 0x936 Not
	if(var_53_bool == 0) goto Label_2363; // 0x937 JumpB
	var_54_object = GlobalVars[0]; // 0x938 PushGE
	add(var_48_object); // 0x939 ObjFunc
	
Label_2363:
	return 2; // 0x93b Return
}
...
{
	var_56_object = Obj(); // 0x93d PushV
	var_56_object = var_55_object; // 0x93e Mov
	func_2351(var_56_object); // 0x93f NEW_2
	var_57_object = Obj(); var_58_bool = 0; // 0x941 PushV
	var_57_object = var_55_object; // 0x942 Mov
	var_58_bool = 1; // 0x943 MovB
	TaskCall(2); // 0x944 TaskCall
	func_422(var_57_object, var_58_bool); // 0x945 NEW_2
	TaskReturn(); // 0x946 TaskReturn
	ResetAAS(); // 0x948 Func
...
Label_883:
	...
	var_474_string = "all"; // 0x378 PushS
	var_475_string = "attack_middle"; // 0x379 PushS
	var_476_int = var_475_string + var_361_int; // 0x37a Add
	HasAnimation(var_362_bool, var_474_string, var_476_int); // 0x37b Func
	var_477_bool = var_362_bool; // 0x37d Push
	if(var_477_bool == 0) goto Label_964; // 0x37e JumpB
	func_2030(); // 0x380 NEW_2
	var_478_string = "all"; // 0x382 PushS
	var_479_string = "attack_middle"; // 0x383 PushS
	var_480_int = var_479_string + var_361_int; // 0x384 Add
	PlayAnimation(var_478_string, var_480_int); // 0x385 Func
	WaitForAnimEnd(); // 0x387 Func
	func_1186(var_364_string); // 0x38a NEW_2
	var_481_bool = 0; var_482_object = Obj(); // 0x38c PushV
	var_482_object = var_0_bool; // 0x38d MovT
	func_1663(var_481_bool, var_482_object); // 0x38e NEW_2
	var_483_bool = var_481_bool == 0; // 0x390 Not
	if(var_483_bool == 0) goto Label_918; // 0x391 JumpB
	StopAsync(); // 0x392 Func
	var_355_bool = 0; // 0x394 MovB
	return 8; // 0x395 Return
	
Label_918:
	var_484_float = 0; var_485_int = 0; // 0x396 PushV
	var_484_float = var_356_float; // 0x397 Mov
	var_485_int = var_361_int; // 0x398 Mov
	func_808(var_364_string, var_484_float, var_485_int); // 0x399 NEW_2
	var_363_int = 1; // 0x39b MovI
	
Label_924:
	var_486_string = "attack_middle"; // 0x39c PushS
	var_487_int = var_486_string + var_361_int; // 0x39d Add
	var_488_string = "_"; // 0x39e PushS
	var_489_int = var_487_int + var_488_string; // 0x39f Add
	var_364_string = var_489_int + var_363_int; // 0x3a0 Add2
	var_490_string = "all"; // 0x3a1 PushS
	HasAnimation(var_362_bool, var_490_string, var_364_string); // 0x3a2 Func
	var_491_bool = var_362_bool == 0; // 0x3a4 Not
	if(var_491_bool == 0) goto Label_935; // 0x3a5 JumpB
	goto Label_964; // 0x3a6 Jump
	
Label_964:
	var_492_bool = 0; // 0x3c4 PushB
	SetAttackState(var_492_bool); // 0x3c5 Func
	var_493_string = "all"; // 0x3c7 PushS
	var_494_string = "attack_end"; // 0x3c8 PushS
	var_495_int = var_494_string + var_361_int; // 0x3c9 Add
	PlayAnimation(var_493_string, var_495_int); // 0x3ca Func
	var_496_bool = 0; // 0x3cc PushV
	func_442(var_363_int, var_364_string, var_496_bool); // 0x3cd NEW_2
	if(var_496_bool == 0) goto Label_982; // 0x3cf JumpB
	var_569_bool = 0; var_570_float = 0; // 0x3d0 PushV
	var_570_float = 0.75; // 0x3d1 MovF
	func_984(var_569_bool, var_570_float); // 0x3d2 NEW_2
...
Label_935:
	func_2030(); // 0x3a8 NEW_2
	var_578_string = "all"; // 0x3aa PushS
	PlayAnimation(var_578_string, var_364_string); // 0x3ab Func
	WaitForAnimEnd(); // 0x3ad Func
	func_1186(var_364_string); // 0x3b0 NEW_2
	var_579_bool = 0; var_580_object = Obj(); // 0x3b2 PushV
	var_580_object = var_0_bool; // 0x3b3 MovT
	func_1663(var_579_bool, var_580_object); // 0x3b4 NEW_2
	var_581_bool = var_579_bool == 0; // 0x3b6 Not
	if(var_581_bool == 0) goto Label_956; // 0x3b7 JumpB
	StopAsync(); // 0x3b8 Func
	var_355_bool = 0; // 0x3ba MovB
	return 8; // 0x3bb Return
	
Label_956:
	var_582_float = 0; var_583_int = 0; // 0x3bc PushV
	var_582_float = var_356_float; // 0x3bd Mov
	var_583_int = var_361_int; // 0x3be Mov
	func_808(var_364_string, var_582_float, var_583_int); // 0x3bf NEW_2
	var_584_int = 1; // 0x3c1 PushI
	var_363_int = var_363_int + var_584_int; // 0x3c2 Add2
...
Label_1412:
	...
	func_2263(var_61_int); // 0x585 NEW_2
...
Label_1427:
	...
	func_2256(var_83_string, var_84_int); // 0x5a1 NEW_2
...
{
	var_524_float = 0; var_525_float = 0; // 0x78e PushV
	rand(var_525_float); // 0x78f Func
	var_522_bool = var_525_float < var_523_float; // 0x791 LT2
...
Label_1971:
	...
	func_2002(var_40_float); // 0x7b5 NEW_2
...
func_442(var_0_bool, var_6_bool, var_496_bool)
{
	...
	var_519_bool = 0; // 0x1bb PushV
	var_519_bool = 0; // 0x1bc MovB
	var_520_bool = 0; var_521_object = Obj(); // 0x1bd PushV
	var_521_object = var_0_bool; // 0x1be MovT
	func_1663(var_520_bool, var_521_object); // 0x1bf NEW_2
	if(var_520_bool == 0) goto Label_456; // 0x1c1 JumpB
	var_522_bool = 0; var_523_float = 0; // 0x1c2 PushV
	var_523_float = 0.5; // 0x1c3 MovF
	func_1934(var_522_bool, var_523_float); // 0x1c4 NEW_2
	if(var_522_bool == 0) goto Label_456; // 0x1c6 JumpB
	var_519_bool = 1; // 0x1c7 MovB
	
Label_456:
	if(var_519_bool == 0) goto Label_542; // 0x1c8 JumpB
	GetPosition(var_508_cvector); // 0x1c9 Func
	GetPosition(var_509_cvector); // 0x1cb TObjFunc
	GetDirection(var_510_cvector); // 0x1cd Func
	var_526_cvector = CVector(0,0,0); var_527_cvector = CVector(0,0,0); // 0x1cf PushV
	var_527_cvector = var_508_cvector - var_509_cvector; // 0x1d0 Sub2
	func_1898(var_526_cvector, var_527_cvector); // 0x1d1 NEW_2
	var_511_cvector = var_526_cvector; // 0x1d2 Mov
	var_533_string = "all"; // 0x1d4 PushS
	var_534_string = "jump1"; // 0x1d5 PushS
	GetAnimationOffset(var_512_cvector, var_533_string, var_534_string); // 0x1d6 Func
	var_535_string = "all"; // 0x1d8 PushS
	var_536_string = "jump2"; // 0x1d9 PushS
	GetAnimationOffset(var_513_cvector, var_535_string, var_536_string); // 0x1da Func
	var_537_float = GetByIndex(var_512_cvector, 2); // 0x1dc PushE
	var_538_float = GetByIndex(var_513_cvector, 2); // 0x1dd PushE
	var_539_bool = var_537_float < var_538_float; // 0x1de LT
	if(var_539_bool == 0) goto Label_485; // 0x1df JumpB
	var_540_float = GetByIndex(var_513_cvector, 2); // 0x1e0 PushE
	var_514_float = -var_540_float; // 0x1e1 Neg2
	var_541_float = GetByIndex(var_512_cvector, 2); // 0x1e2 PushE
	var_515_float = -var_541_float; // 0x1e3 Neg2
	goto Label_489; // 0x1e4 Jump
	
Label_489:
	var_542_float = 0.17453; // 0x1e9 PushF
	var_543_int = 6; // 0x1ea PushI
	var_544_int = 3; // 0x1eb PushI
	var_545_float = var_515_float * var_544_int; // 0x1ec Mult
	FindLongestDir(var_516_cvector, var_517_float, var_511_cvector, var_542_float, var_543_int, var_545_float); // 0x1ed Func
	var_546_bool = var_517_float < var_514_float; // 0x1ef LT
	if(var_546_bool == 0) goto Label_503; // 0x1f0 JumpB
	var_547_float = 0.5236; // 0x1f1 PushF
	var_548_int = 16; // 0x1f2 PushI
	var_549_int = 3; // 0x1f3 PushI
	var_550_float = var_515_float * var_549_int; // 0x1f4 Mult
	FindLongestDir(var_516_cvector, var_517_float, var_511_cvector, var_547_float, var_548_int, var_550_float); // 0x1f5 Func
	
Label_503:
	var_551_bool = var_517_float >= var_514_float; // 0x1f7 GE
	if(var_551_bool == 0) goto Label_542; // 0x1f8 JumpB
	StopAsync(); // 0x1f9 Func
	var_552_int = -var_516_cvector; // 0x1fb Neg
	SetDirection(var_552_int); // 0x1fc Func
	var_6_bool = 1; // 0x1fe TMovB
	var_553_bool = var_517_float >= var_515_float; // 0x1ff GE
	if(var_553_bool == 0) goto Label_524; // 0x200 JumpB
	var_554_int = 2; // 0x201 PushI
	irand(var_518_int, var_554_int); // 0x202 Func
	var_555_string = "all"; // 0x204 PushS
	var_556_string = "jump"; // 0x205 PushS
	var_557_int = 1; // 0x206 PushI
	var_558_int = var_518_int + var_557_int; // 0x207 Add
	var_559_int = var_556_string + var_558_int; // 0x208 Add
	PlayAnimation(var_555_string, var_559_int); // 0x209 Func
	goto Label_537; // 0x20b Jump
	
Label_537:
	WaitForAnimEnd(); // 0x219 Func
	var_6_bool = 0; // 0x21b TMovB
	var_496_bool = 0; // 0x21c MovB
	return 22; // 0x21d Return
	
Label_524:
	var_560_float = GetByIndex(var_512_cvector, 2); // 0x20c PushE
	var_561_int = -var_560_float; // 0x20d Neg
	var_562_bool = var_561_int <= var_517_float; // 0x20e LE
	if(var_562_bool == 0) goto Label_533; // 0x20f JumpB
	var_563_string = "all"; // 0x210 PushS
	var_564_string = "jump1"; // 0x211 PushS
	PlayAnimation(var_563_string, var_564_string); // 0x212 Func
	goto Label_537; // 0x214 Jump
	
Label_533:
	var_565_string = "all"; // 0x215 PushS
	var_566_string = "jump2"; // 0x216 PushS
	PlayAnimation(var_565_string, var_566_string); // 0x217 Func
	
Label_542:
	var_496_bool = 1; // 0x21e MovB
	return 22; // 0x21f Return
	
Label_485:
	var_567_float = GetByIndex(var_512_cvector, 2); // 0x1e5 PushE
	var_514_float = -var_567_float; // 0x1e6 Neg2
	var_568_float = GetByIndex(var_513_cvector, 2); // 0x1e7 PushE
	var_515_float = -var_568_float; // 0x1e8 Neg2
}
...
func_1985(var_462_float)
{
	...
	var_465_int = 0; // 0x7c6 PushI
	var_466_bool = var_462_float < var_465_int; // 0x7c7 LT
	if(var_466_bool == 0) goto Label_1997; // 0x7c8 JumpB
	var_467_float = 0.7; // 0x7c9 PushF
	var_468_int = 500; // 0x7ca PushI
	RumblePlay(var_467_float, var_468_int); // 0x7cb Func
	
Label_1997:
	var_469_int = 15; // 0x7cd PushI
	SendWorldWndMessage(var_469_int, var_464_object); // 0x7ce Func
...
{
	var_41_object = Obj(); var_42_object = Obj(); // 0x7d2 PushV
	CreateFloatVector(var_42_object); // 0x7d3 Func
	add(var_40_float); // 0x7d5 ObjFunc
	var_43_int = 16; // 0x7d7 PushI
	SendWorldWndMessage(var_43_int, var_42_object); // 0x7d8 Func
...
{
	var_571_float = 0; var_572_bool = 0; var_573_float = 0; var_574_bool = 0; // 0x3d8 PushV
	rand(var_573_float); // 0x3d9 Func
	var_575_bool = var_573_float < var_570_float; // 0x3db LT
	if(var_575_bool == 0) goto Label_1004; // 0x3dc JumpB
	
Label_989:
	IsAnimationPlaying(var_574_bool); // 0x3dd Func
	var_576_bool = var_574_bool == 0; // 0x3df Not
	if(var_576_bool == 0) goto Label_994; // 0x3e0 JumpB
...
Label_1009:
	var_569_bool = 0; // 0x3f1 MovB
	return 4; // 0x3f2 Return
	
Label_994:
	var_577_bool = 0; // 0x3e2 PushV
	func_1082(var_577_bool); // 0x3e3 NEW_2
	if(var_577_bool == 0) goto Label_1000; // 0x3e5 JumpB
	var_569_bool = 1; // 0x3e6 MovB
...
Label_1004:
	...
	func_1186(var_574_bool); // 0x3ef NEW_2
}


func_2012(var_25_int)
{
	var_26_float = 0; var_27_float = 0; // 0x7dc PushV
	GetGameTime(var_27_float); // 0x7dd Func
	var_28_int = 1; // 0x7df PushI
	var_29_int = 0; // 0x7e0 PushV
	var_30_int = 24; // 0x7e1 PushI
	var_29_int = var_27_float / var_27_float; // 0x7e2 Div2
	var_25_int = var_28_int + var_29_int; // 0x7e3 Add2
...
{
	var_131_bool = 0; var_132_bool = 0; // 0x7e5 PushV
	IsPlayerActor(var_130_object, var_132_bool); // 0x7e6 Func
	var_133_bool = var_132_bool; // 0x7e8 Push
	if(var_133_bool == 0) goto Label_2029; // 0x7e9 JumpB
	var_134_string = "attack"; // 0x7ea PushS
	PlayGlobalMusic(var_134_string); // 0x7eb Func
...
func_2030()
{
	var_367_object = Obj(); var_368_object = Obj(); // 0x7ee PushV
	GetScene(var_368_object); // 0x7ef Func
	var_369_string = "battle"; // 0x7f1 PushS
	var_370_object = Obj(); // 0x7f2 PushV
	func_1892(var_370_object); // 0x7f3 NEW_2
	BroadcastMessage(var_369_string, var_370_object, var_368_object); // 0x7f5 Func
...
{
	var_20_int = 0; var_21_int = 0; // 0x7f9 PushV
	var_22_string = "branch"; // 0x7fa PushS
	GetVariable(var_22_string, var_21_int); // 0x7fb Func
	var_19_int = var_21_int; // 0x7fd Mov
...
{
	var_17_int = 0; // 0x800 PushV
	func_2041(var_17_int); // 0x801 NEW_2
	var_21_int = 1; // 0x803 PushI
	var_22_bool = var_17_int == var_21_int; // 0x804 Eq
	if(var_22_bool == 0) goto Label_2057; // 0x805 JumpB
	WorkWithCorpse(var_16_object); // 0x806 Func
	goto Label_2059; // 0x808 Jump
	
Label_2059:
	return 0; // 0x80b Return
	
Label_2057:
	Barter(var_16_object); // 0x809 Func
}
