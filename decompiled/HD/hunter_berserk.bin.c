task_0_event_0(var_0_object, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool)
{
	...
	func_1762(var_14_object); // 0x22 NEW_2
...
task_1_event_7(var_0_bool, var_1_object, var_2_bool, var_3_int, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool)
{
	...
	func_1736(var_13_object); // 0xdd NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x78f PushV
	var_14_object = var_10_object; // 0x790 Mov
	var_15_int = var_11_int; // 0x791 Mov
	var_16_float = var_12_float; // 0x792 Mov
	func_1465(var_14_object, var_15_int, var_16_float); // 0x793 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x797 PushV
	var_16_object = var_10_object; // 0x798 Mov
	var_17_int = var_11_int; // 0x799 Mov
	var_18_float = var_12_float; // 0x79a Mov
	var_19_cvector = var_14_cvector; // 0x79b Mov
	var_20_cvector = var_15_cvector; // 0x79c Mov
	func_1533(var_18_float, var_19_cvector, var_20_cvector); // 0x79d NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x7a0 PushV
	var_14_string = "health"; // 0x7a1 PushS
	var_15_bool = var_11_string == var_14_string; // 0x7a2 Eq
	if(var_15_bool == 0) goto Label_1964; // 0x7a3 JumpB
	var_16_string = "health"; // 0x7a4 PushS
	GetProperty(var_16_string, var_13_float); // 0x7a5 Func
	var_17_int = 0; // 0x7a7 PushI
	var_18_bool = var_13_float <= var_17_int; // 0x7a8 LE
	if(var_18_bool == 0) goto Label_1964; // 0x7a9 JumpB
	SignalDeath(var_10_object); // 0x7aa Func
...
{
	var_11_object = Obj(); // 0x7ae PushV
	var_11_object = var_10_object; // 0x7af Mov
	func_1894(var_11_object); // 0x7b0 NEW_2
...
Label_1686:
	...
	func_1717(var_38_float); // 0x698 NEW_2
...
Label_1302:
	var_459_string = "armor"; // 0x516 PushS
	GetProperty(var_459_string, var_408_int); // 0x517 ObjFunc
}
...
{
	var_122_object = Obj(); var_123_int = 0; var_124_bool = 0; var_125_object = Obj(); var_126_int = 0; var_127_bool = 0; // 0x70e PushV
	CreateInvItem(var_125_object); // 0x70f Func
	SetItemName(var_121_string); // 0x711 ObjFunc
	var_128_string = "Organ"; // 0x713 PushS
	var_129_int = 1; // 0x714 PushI
	SetProperty(var_128_string, var_129_int); // 0x715 ObjFunc
	GetItemID(var_126_int); // 0x717 ObjFunc
	var_130_int = 0; // 0x719 PushI
	var_131_int = 1; // 0x71a PushI
	AddItem(var_127_bool, var_125_object, var_130_int, var_131_int); // 0x71b Func
...
func_1823()
{
	var_118_int = 0; // 0x71f PushV
	func_1756(var_118_int); // 0x720 NEW_2
	var_119_int = 1; // 0x722 PushI
	var_120_bool = var_118_int != var_119_int; // 0x723 Neq
	if(var_120_bool == 0) goto Label_1830; // 0x724 JumpB
	return 0; // 0x725 Return
	
Label_1830:
	var_121_string = ""; // 0x726 PushV
	var_121_string = "liver"; // 0x727 MovS
	func_1806(var_121_string); // 0x728 NEW_2
	var_132_string = ""; // 0x72a PushV
	var_132_string = "kidney"; // 0x72b MovS
	func_1806(var_132_string); // 0x72c NEW_2
	var_133_string = ""; // 0x72e PushV
	var_133_string = "heart"; // 0x72f MovS
	func_1806(var_133_string); // 0x730 NEW_2
	var_134_string = ""; // 0x732 PushV
	var_134_string = "blood"; // 0x733 MovS
	func_1806(var_134_string); // 0x734 NEW_2
...
Label_700:
	...
	var_574_string = "all"; // 0x2be PushS
	var_575_string = "fjump"; // 0x2bf PushS
	PlayAnimation(var_574_string, var_575_string); // 0x2c0 Func
	WaitForAnimEnd(); // 0x2c2 Func
	func_1186(var_47_float); // 0x2c5 NEW_2
	var_576_cvector = CVector(0.0, 0.0, 0.0); // 0x2c7 PushVec
	SetSpeed(var_576_cvector); // 0x2c8 Func
	Stop(); // 0x2ca Func
	StopAsync(); // 0x2cc Func
	var_577_bool = 0; // 0x2ce PushV
	func_1143(var_47_float, var_577_bool); // 0x2cf NEW_2
	var_578_bool = var_577_bool == 0; // 0x2d1 Not
	if(var_578_bool == 0) goto Label_746; // 0x2d2 JumpB
	var_579_bool = 0; var_580_object = Obj(); // 0x2d3 PushV
	var_580_object = var_0_bool; // 0x2d4 MovT
	func_1397(var_579_bool, var_580_object); // 0x2d5 NEW_2
	var_581_bool = var_579_bool == 0; // 0x2d7 Not
	if(var_581_bool == 0) goto Label_730; // 0x2d8 JumpB
...
Label_730:
	...
	var_582_float = var_25_float * var_25_float; // 0x2e0 Mult
	var_583_bool = var_44_float < var_582_float; // 0x2e1 LT
	if(var_583_bool == 0) goto Label_746; // 0x2e2 JumpB
	var_584_bool = 0; var_585_float = 0; // 0x2e3 PushV
	var_585_float = var_25_float; // 0x2e4 Mov
	func_847(var_47_float, var_584_bool, var_585_float); // 0x2e5 NEW_2
	var_586_bool = var_584_bool == 0; // 0x2e7 Not
	if(var_586_bool == 0) goto Label_746; // 0x2e8 JumpB
	goto Label_756; // 0x2e9 Jump
	
Label_747:
	var_587_bool = 0; var_588_float = 0; // 0x2eb PushV
	var_588_float = var_25_float; // 0x2ec Mov
	func_847(var_47_float, var_587_bool, var_588_float); // 0x2ed NEW_2
	var_589_bool = var_587_bool == 0; // 0x2ef Not
	if(var_589_bool == 0) goto Label_754; // 0x2f0 JumpB
...
func_1186(var_0_bool)
{
	...
	func_1736(var_119_object); // 0x4a4 NEW_2
...
func_166(var_2_bool, var_126_bool, var_127_object, var_128_float, var_129_float, var_130_bool, var_131_bool)
{
	...
	func_1736(var_139_object); // 0xa9 NEW_2
...
func_808(var_0_bool, var_381_float, var_382_int)
{
	...
	var_460_int = 0; // 0x343 PushV
	func_1191(var_460_int); // 0x344 NEW_2
	ReportHit(var_0_bool, var_460_int, var_388_float, var_387_float); // 0x346 Func
	var_461_object = Obj(); var_462_float = 0; // 0x348 PushV
	var_461_object = var_386_object; // 0x349 Mov
	var_462_float = var_388_float; // 0x34a Mov
...
func_1700(var_451_float)
{
	...
	var_454_int = 0; // 0x6a9 PushI
	var_455_bool = var_451_float < var_454_int; // 0x6aa LT
	if(var_455_bool == 0) goto Label_1712; // 0x6ab JumpB
	var_456_float = 0.7; // 0x6ac PushF
	var_457_int = 500; // 0x6ad PushI
	RumblePlay(var_456_float, var_457_int); // 0x6ae Func
	
Label_1712:
	var_458_int = 15; // 0x6b0 PushI
	SendWorldWndMessage(var_458_int, var_453_object); // 0x6b1 Func
...
{
	var_39_object = Obj(); var_40_object = Obj(); // 0x6b5 PushV
	CreateFloatVector(var_40_object); // 0x6b6 Func
	add(var_38_float); // 0x6b8 ObjFunc
	var_41_int = 16; // 0x6ba PushI
	SendWorldWndMessage(var_41_int, var_40_object); // 0x6bb Func
...
func_1847()
{
	var_70_int = 0; var_71_bool = 0; var_72_int = 0; var_73_bool = 0; // 0x737 PushV
	var_74_int = 0; // 0x738 PushI
	ClearSubContainer(var_74_int); // 0x739 Func
	var_75_int = 0; var_76_int = 0; // 0x73b PushV
	var_75_int = 200; // 0x73c MovI
	var_76_int = 500; // 0x73d MovI
	func_1775(var_75_int, var_76_int); // 0x73e NEW_2
	var_94_string = ""; var_95_int = 0; var_96_int = 0; // 0x740 PushV
	var_94_string = "revolver_ammo"; // 0x741 MovS
	var_95_int = 1; // 0x742 MovI
	var_96_int = 80; // 0x743 MovI
	func_1569(var_94_string, var_95_int, var_96_int); // 0x744 NEW_2
	var_105_string = ""; var_106_int = 0; var_107_int = 0; // 0x746 PushV
	var_105_string = "samopal_ammo"; // 0x747 MovS
	var_106_int = 1; // 0x748 MovI
	var_107_int = 80; // 0x749 MovI
	func_1569(var_105_string, var_106_int, var_107_int); // 0x74a NEW_2
	var_108_string = ""; var_109_int = 0; var_110_int = 0; // 0x74c PushV
	var_108_string = "rifle_ammo"; // 0x74d MovS
	var_109_int = 1; // 0x74e MovI
	var_110_int = 80; // 0x74f MovI
	func_1569(var_108_string, var_109_int, var_110_int); // 0x750 NEW_2
	var_111_string = ""; var_112_int = 0; var_113_int = 0; // 0x752 PushV
	var_111_string = "lockpick"; // 0x753 MovS
	var_112_int = 1; // 0x754 MovI
	var_113_int = 80; // 0x755 MovI
	func_1569(var_111_string, var_112_int, var_113_int); // 0x756 NEW_2
	var_114_int = 0; var_115_string = ""; // 0x758 PushV
	var_115_string = "hunter_mark"; // 0x759 MovS
	func_1889(var_114_int, var_115_string); // 0x75a NEW_2
	var_116_int = 0; // 0x75c PushI
	var_117_int = 1; // 0x75d PushI
	AddItem(var_73_bool, var_114_int, var_116_int, var_117_int); // 0x75e Func
...
func_442(var_0_bool, var_6_bool, var_485_bool)
{
	...
	var_508_bool = 0; // 0x1bb PushV
	var_508_bool = 0; // 0x1bc MovB
	var_509_bool = 0; var_510_object = Obj(); // 0x1bd PushV
	var_510_object = var_0_bool; // 0x1be MovT
	func_1397(var_509_bool, var_510_object); // 0x1bf NEW_2
	if(var_509_bool == 0) goto Label_456; // 0x1c1 JumpB
	var_511_bool = 0; var_512_float = 0; // 0x1c2 PushV
	var_512_float = 0.5; // 0x1c3 MovF
	func_1655(var_511_bool, var_512_float); // 0x1c4 NEW_2
	if(var_511_bool == 0) goto Label_456; // 0x1c6 JumpB
	var_508_bool = 1; // 0x1c7 MovB
	
Label_456:
	if(var_508_bool == 0) goto Label_542; // 0x1c8 JumpB
	GetPosition(var_497_cvector); // 0x1c9 Func
	GetPosition(var_498_cvector); // 0x1cb TObjFunc
	GetDirection(var_499_cvector); // 0x1cd Func
	var_515_cvector = CVector(0,0,0); var_516_cvector = CVector(0,0,0); // 0x1cf PushV
	var_516_cvector = var_497_cvector - var_498_cvector; // 0x1d0 Sub2
	func_1627(var_515_cvector, var_516_cvector); // 0x1d1 NEW_2
	var_500_cvector = var_515_cvector; // 0x1d2 Mov
	var_522_string = "all"; // 0x1d4 PushS
	var_523_string = "jump1"; // 0x1d5 PushS
	GetAnimationOffset(var_501_cvector, var_522_string, var_523_string); // 0x1d6 Func
	var_524_string = "all"; // 0x1d8 PushS
	var_525_string = "jump2"; // 0x1d9 PushS
	GetAnimationOffset(var_502_cvector, var_524_string, var_525_string); // 0x1da Func
	var_526_float = GetByIndex(var_501_cvector, 2); // 0x1dc PushE
	var_527_float = GetByIndex(var_502_cvector, 2); // 0x1dd PushE
	var_528_bool = var_526_float < var_527_float; // 0x1de LT
	if(var_528_bool == 0) goto Label_485; // 0x1df JumpB
	var_529_float = GetByIndex(var_502_cvector, 2); // 0x1e0 PushE
	var_503_float = -var_529_float; // 0x1e1 Neg2
	var_530_float = GetByIndex(var_501_cvector, 2); // 0x1e2 PushE
	var_504_float = -var_530_float; // 0x1e3 Neg2
	goto Label_489; // 0x1e4 Jump
	
Label_489:
	var_531_float = 0.17453; // 0x1e9 PushF
	var_532_int = 6; // 0x1ea PushI
	var_533_int = 3; // 0x1eb PushI
	var_534_float = var_504_float * var_533_int; // 0x1ec Mult
	FindLongestDir(var_505_cvector, var_506_float, var_500_cvector, var_531_float, var_532_int, var_534_float); // 0x1ed Func
	var_535_bool = var_506_float < var_503_float; // 0x1ef LT
	if(var_535_bool == 0) goto Label_503; // 0x1f0 JumpB
	var_536_float = 0.5236; // 0x1f1 PushF
	var_537_int = 16; // 0x1f2 PushI
	var_538_int = 3; // 0x1f3 PushI
	var_539_float = var_504_float * var_538_int; // 0x1f4 Mult
	FindLongestDir(var_505_cvector, var_506_float, var_500_cvector, var_536_float, var_537_int, var_539_float); // 0x1f5 Func
	
Label_503:
	var_540_bool = var_506_float >= var_503_float; // 0x1f7 GE
	if(var_540_bool == 0) goto Label_542; // 0x1f8 JumpB
	StopAsync(); // 0x1f9 Func
	var_541_int = -var_505_cvector; // 0x1fb Neg
	SetDirection(var_541_int); // 0x1fc Func
	var_6_bool = 1; // 0x1fe TMovB
	var_542_bool = var_506_float >= var_504_float; // 0x1ff GE
	if(var_542_bool == 0) goto Label_524; // 0x200 JumpB
	var_543_int = 2; // 0x201 PushI
	irand(var_507_int, var_543_int); // 0x202 Func
	var_544_string = "all"; // 0x204 PushS
	var_545_string = "jump"; // 0x205 PushS
	var_546_int = 1; // 0x206 PushI
	var_547_int = var_507_int + var_546_int; // 0x207 Add
	var_548_int = var_545_string + var_547_int; // 0x208 Add
	PlayAnimation(var_544_string, var_548_int); // 0x209 Func
	goto Label_537; // 0x20b Jump
	
Label_537:
	WaitForAnimEnd(); // 0x219 Func
	var_6_bool = 0; // 0x21b TMovB
	var_485_bool = 0; // 0x21c MovB
	return 22; // 0x21d Return
	
Label_524:
	var_549_float = GetByIndex(var_501_cvector, 2); // 0x20c PushE
	var_550_int = -var_549_float; // 0x20d Neg
	var_551_bool = var_550_int <= var_506_float; // 0x20e LE
	if(var_551_bool == 0) goto Label_533; // 0x20f JumpB
	var_552_string = "all"; // 0x210 PushS
	var_553_string = "jump1"; // 0x211 PushS
	PlayAnimation(var_552_string, var_553_string); // 0x212 Func
	goto Label_537; // 0x214 Jump
	
Label_533:
	var_554_string = "all"; // 0x215 PushS
	var_555_string = "jump2"; // 0x216 PushS
	PlayAnimation(var_554_string, var_555_string); // 0x217 Func
	
Label_542:
	var_485_bool = 1; // 0x21e MovB
	return 22; // 0x21f Return
	
Label_485:
	var_556_float = GetByIndex(var_501_cvector, 2); // 0x1e5 PushE
	var_503_float = -var_556_float; // 0x1e6 Neg2
	var_557_float = GetByIndex(var_502_cvector, 2); // 0x1e7 PushE
	var_504_float = -var_557_float; // 0x1e8 Neg2
}
...
{
	var_24_float = 0; var_25_float = 0; // 0x6bf PushV
	GetGameTime(var_25_float); // 0x6c0 Func
	var_26_int = 1; // 0x6c2 PushI
	var_27_int = 0; // 0x6c3 PushV
	var_28_int = 24; // 0x6c4 PushI
	var_27_int = var_25_float / var_25_float; // 0x6c5 Div2
	var_23_int = var_26_int + var_27_int; // 0x6c6 Add2
...
{
	var_120_bool = 0; var_121_bool = 0; // 0x6c8 PushV
	IsPlayerActor(var_119_object, var_121_bool); // 0x6c9 Func
	var_122_bool = var_121_bool; // 0x6cb Push
	if(var_122_bool == 0) goto Label_1744; // 0x6cc JumpB
	var_123_string = "attack"; // 0x6cd PushS
	PlayGlobalMusic(var_123_string); // 0x6ce Func
...
Label_883:
	...
	var_463_string = "all"; // 0x378 PushS
	var_464_string = "attack_middle"; // 0x379 PushS
	var_465_int = var_464_string + var_350_int; // 0x37a Add
	HasAnimation(var_351_bool, var_463_string, var_465_int); // 0x37b Func
	var_466_bool = var_351_bool; // 0x37d Push
	if(var_466_bool == 0) goto Label_964; // 0x37e JumpB
	func_1745(); // 0x380 NEW_2
	var_467_string = "all"; // 0x382 PushS
	var_468_string = "attack_middle"; // 0x383 PushS
	var_469_int = var_468_string + var_350_int; // 0x384 Add
	PlayAnimation(var_467_string, var_469_int); // 0x385 Func
	WaitForAnimEnd(); // 0x387 Func
	func_1186(var_353_string); // 0x38a NEW_2
	var_470_bool = 0; var_471_object = Obj(); // 0x38c PushV
	var_471_object = var_0_bool; // 0x38d MovT
	func_1397(var_470_bool, var_471_object); // 0x38e NEW_2
	var_472_bool = var_470_bool == 0; // 0x390 Not
	if(var_472_bool == 0) goto Label_918; // 0x391 JumpB
	StopAsync(); // 0x392 Func
	var_344_bool = 0; // 0x394 MovB
	return 8; // 0x395 Return
	
Label_918:
	var_473_float = 0; var_474_int = 0; // 0x396 PushV
	var_473_float = var_345_float; // 0x397 Mov
	var_474_int = var_350_int; // 0x398 Mov
	func_808(var_353_string, var_473_float, var_474_int); // 0x399 NEW_2
	var_352_int = 1; // 0x39b MovI
	
Label_924:
	var_475_string = "attack_middle"; // 0x39c PushS
	var_476_int = var_475_string + var_350_int; // 0x39d Add
	var_477_string = "_"; // 0x39e PushS
	var_478_int = var_476_int + var_477_string; // 0x39f Add
	var_353_string = var_478_int + var_352_int; // 0x3a0 Add2
	var_479_string = "all"; // 0x3a1 PushS
	HasAnimation(var_351_bool, var_479_string, var_353_string); // 0x3a2 Func
	var_480_bool = var_351_bool == 0; // 0x3a4 Not
	if(var_480_bool == 0) goto Label_935; // 0x3a5 JumpB
	goto Label_964; // 0x3a6 Jump
	
Label_964:
	var_481_bool = 0; // 0x3c4 PushB
	SetAttackState(var_481_bool); // 0x3c5 Func
	var_482_string = "all"; // 0x3c7 PushS
	var_483_string = "attack_end"; // 0x3c8 PushS
	var_484_int = var_483_string + var_350_int; // 0x3c9 Add
	PlayAnimation(var_482_string, var_484_int); // 0x3ca Func
	var_485_bool = 0; // 0x3cc PushV
	func_442(var_352_int, var_353_string, var_485_bool); // 0x3cd NEW_2
	if(var_485_bool == 0) goto Label_982; // 0x3cf JumpB
	var_558_bool = 0; var_559_float = 0; // 0x3d0 PushV
	var_559_float = 0.75; // 0x3d1 MovF
	func_984(var_558_bool, var_559_float); // 0x3d2 NEW_2
...
Label_935:
	func_1745(); // 0x3a8 NEW_2
	var_567_string = "all"; // 0x3aa PushS
	PlayAnimation(var_567_string, var_353_string); // 0x3ab Func
	WaitForAnimEnd(); // 0x3ad Func
	func_1186(var_353_string); // 0x3b0 NEW_2
	var_568_bool = 0; var_569_object = Obj(); // 0x3b2 PushV
	var_569_object = var_0_bool; // 0x3b3 MovT
	func_1397(var_568_bool, var_569_object); // 0x3b4 NEW_2
	var_570_bool = var_568_bool == 0; // 0x3b6 Not
	if(var_570_bool == 0) goto Label_956; // 0x3b7 JumpB
	StopAsync(); // 0x3b8 Func
	var_344_bool = 0; // 0x3ba MovB
	return 8; // 0x3bb Return
	
Label_956:
	var_571_float = 0; var_572_int = 0; // 0x3bc PushV
	var_571_float = var_345_float; // 0x3bd Mov
	var_572_int = var_350_int; // 0x3be Mov
	func_808(var_353_string, var_571_float, var_572_int); // 0x3bf NEW_2
	var_573_int = 1; // 0x3c1 PushI
	var_352_int = var_352_int + var_573_int; // 0x3c2 Add2
...
func_1745()
{
	var_356_object = Obj(); var_357_object = Obj(); // 0x6d1 PushV
	GetScene(var_357_object); // 0x6d2 Func
	var_358_string = "battle"; // 0x6d4 PushS
	var_359_object = Obj(); // 0x6d5 PushV
	func_1621(var_359_object); // 0x6d6 NEW_2
	BroadcastMessage(var_358_string, var_359_object, var_357_object); // 0x6d8 Func
...
{
	var_560_float = 0; var_561_bool = 0; var_562_float = 0; var_563_bool = 0; // 0x3d8 PushV
	rand(var_562_float); // 0x3d9 Func
	var_564_bool = var_562_float < var_559_float; // 0x3db LT
	if(var_564_bool == 0) goto Label_1004; // 0x3dc JumpB
	
Label_989:
	IsAnimationPlaying(var_563_bool); // 0x3dd Func
	var_565_bool = var_563_bool == 0; // 0x3df Not
	if(var_565_bool == 0) goto Label_994; // 0x3e0 JumpB
...
Label_1009:
	var_558_bool = 0; // 0x3f1 MovB
	return 4; // 0x3f2 Return
	
Label_994:
	var_566_bool = 0; // 0x3e2 PushV
	func_1082(var_566_bool); // 0x3e3 NEW_2
	if(var_566_bool == 0) goto Label_1000; // 0x3e5 JumpB
	var_558_bool = 1; // 0x3e6 MovB
...
Label_1004:
	...
	func_1186(var_563_bool); // 0x3ef NEW_2
}
...
{
	var_18_int = 0; var_19_int = 0; // 0x6dc PushV
	var_20_string = "branch"; // 0x6dd PushS
	GetVariable(var_20_string, var_19_int); // 0x6de Func
	var_17_int = var_19_int; // 0x6e0 Mov
...
{
	var_15_int = 0; // 0x6e3 PushV
	func_1756(var_15_int); // 0x6e4 NEW_2
	var_19_int = 1; // 0x6e6 PushI
	var_20_bool = var_15_int == var_19_int; // 0x6e7 Eq
	if(var_20_bool == 0) goto Label_1772; // 0x6e8 JumpB
	WorkWithCorpse(var_14_object); // 0x6e9 Func
	goto Label_1774; // 0x6eb Jump
	
Label_1774:
	return 0; // 0x6ee Return
	
Label_1772:
	Barter(var_14_object); // 0x6ec Func
}


func_1889(var_87_int, var_88_string)
{
	var_89_int = 0; var_90_int = 0; // 0x761 PushV
	GetInvItemByName(var_90_int, var_88_string); // 0x762 Func
	var_87_int = var_90_int; // 0x764 Mov
...
{
	var_12_bool = 0; var_13_object = Obj(); // 0x767 PushV
	var_13_object = var_11_object; // 0x768 Mov
	func_1244(var_12_bool, var_13_object); // 0x769 NEW_2
	if(var_12_bool == 0) goto Label_1927; // 0x76b JumpB
	var_16_bool = 0; // 0x76c PushV
	var_16_bool = 0; // 0x76d MovB
	var_17_int = 0; // 0x76e PushV
	func_1756(var_17_int); // 0x76f NEW_2
	var_21_int = 2; // 0x771 PushI
	var_22_bool = var_17_int == var_21_int; // 0x772 Eq
	if(var_22_bool == 0) goto Label_1915; // 0x773 JumpB
	var_23_int = 0; // 0x774 PushV
	func_1727(var_23_int); // 0x775 NEW_2
	var_29_int = 6; // 0x777 PushI
	var_30_bool = var_23_int == var_29_int; // 0x778 Eq
	if(var_30_bool == 0) goto Label_1915; // 0x779 JumpB
	var_16_bool = 1; // 0x77a MovB
	
Label_1915:
	if(var_16_bool == 0) goto Label_1922; // 0x77b JumpB
	var_31_bool = 0; var_32_object = Obj(); var_33_float = 0; // 0x77c PushV
	var_32_object = var_11_object; // 0x77d Mov
	var_33_float = 0.1; // 0x77e MovF
	func_1665(var_31_bool, var_32_object, var_33_float); // 0x77f NEW_2
	goto Label_1927; // 0x781 Jump
	
Label_1927:
	var_69_object = Obj(); // 0x787 PushV
	var_69_object = var_11_object; // 0x788 Mov
	TaskCall(0); // 0x789 TaskCall
	func_0(var_69_object); // 0x78a NEW_2
	TaskReturn(); // 0x78b TaskReturn
	return 0; // 0x78d Return
	
Label_1922:
	var_218_bool = 0; var_219_object = Obj(); var_220_float = 0; // 0x782 PushV
	var_219_object = var_11_object; // 0x783 Mov
	var_220_float = 0.05; // 0x784 MovF
	func_1665(var_218_bool, var_219_object, var_220_float); // 0x785 NEW_2
}
...
{
	var_77_int = 0; var_78_bool = 0; var_79_int = 0; var_80_bool = 0; // 0x6ef PushV
	var_81_bool = var_75_int > var_76_int; // 0x6f0 GT
	if(var_81_bool == 0) goto Label_1782; // 0x6f1 JumpB
	var_82_string = "GenerateMoney: iMin > iMax"; // 0x6f2 PushS
	Trace(var_82_string); // 0x6f3 Func
	return 4; // 0x6f5 Return
	
Label_1782:
	var_79_int = 0; // 0x6f6 MovI
	var_83_bool = var_75_int != var_76_int; // 0x6f7 Neq
	if(var_83_bool == 0) goto Label_1789; // 0x6f8 JumpB
	var_84_int = var_76_int - var_75_int; // 0x6f9 Sub
	irand(var_79_int, var_84_int); // 0x6fa Func
	goto Label_1793; // 0x6fc Jump
	
Label_1793:
	var_79_int = var_79_int + var_75_int; // 0x701 Add2
	var_85_int = 0; // 0x702 PushI
	var_86_bool = var_79_int == var_85_int; // 0x703 Eq
	if(var_86_bool == 0) goto Label_1798; // 0x704 JumpB
	return 4; // 0x705 Return
	
Label_1798:
	var_87_int = 0; var_88_string = ""; // 0x706 PushV
	var_88_string = "Money"; // 0x707 MovS
	func_1889(var_87_int, var_88_string); // 0x708 NEW_2
	var_91_int = 0; // 0x70a PushI
	AddItem(var_80_bool, var_87_int, var_91_int, var_79_int); // 0x70b Func
	return 4; // 0x70d Return
	
Label_1789:
	var_92_int = 0; // 0x6fd PushI
	var_93_bool = var_75_int == var_92_int; // 0x6fe Eq
	if(var_93_bool == 0) goto Label_1793; // 0x6ff JumpB
...
{
	var_513_float = 0; var_514_float = 0; // 0x677 PushV
	rand(var_514_float); // 0x678 Func
	var_511_bool = var_514_float < var_512_float; // 0x67a LT2
