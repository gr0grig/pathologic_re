...
0x1af7: Stack[-1] = Stack[-5]
0x1af8: Call2 0x1a5d

0x1af9: Stack[-6] = Stack[-2]
0x1afa: Pop(2)
0x1afb: Return(); Pop(2)
...
0x1b12: Push(Stack[-1])
0x1b13: IF (Stack[-1] == 0) GOTO 0x1b1c; Pop(1)

0x1b14: PushEmpty(float, object)
0x1b15: Stack[-1] = Stack[-5]
0x1b16: Call2 0x14ba

0x1b17: Pop(1)
0x1b18: Push((int) 2250000)
0x1b19: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x1b1a: IF (Stack[-1] == 0) GOTO 0x1b1c; Pop(1)
...
0x1b31: Stack[-1] = "ui/NPC_Citizen3.png"
0x1b32: Return(); Pop(0)

0x1b33: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x1b34: Return(); Pop(0)
...
0x1b6b: Stack[-4] = Stack[-8]
0x1b6c: Stack[-3] = Stack[-7]
0x1b6d: Stack[-2] = (float) 500.0
0x1b6e: Stack[-1] = Stack[-6]
0x1b6f: Call2 0x1ac7

0x1b70: Stack[-9] = Stack[-5]
0x1b71: Pop(5)
0x1b72: Return(); Pop(0)

0x1b73: PushEmpty()
0x1b74: PushEmpty(bool, object)
0x1b75: Stack[-1] = Stack[-3]
0x1b76: Call2 0x14c2
