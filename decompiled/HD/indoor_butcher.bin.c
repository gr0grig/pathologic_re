task_0_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2405(var_15_object); // 0x12 NEW_2
	...
	func_2408(var_18_object); // 0x1a NEW_2
...
task_1_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2405(var_15_object); // 0x9f NEW_2
...
Label_171:
	...
	func_2408(var_20_object); // 0xad NEW_2
...
task_1_event_17(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2306(var_14_object); // 0xb3 NEW_2
	var_23_int = 0; var_24_object = Obj(); // 0xb5 PushV
	var_24_object = var_11_bool; // 0xb6 Mov
	func_2372(var_23_int, var_24_object); // 0xb7 NEW_2
...
Label_195:
	...
	func_2382(var_63_object); // 0xc5 NEW_2
...
task_1_event_30(var_0_object, var_1_object, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_object, var_11_bool, var_12_bool, var_13_bool)
{
	...
	func_2452(var_19_bool); // 0xcd NEW_2
	...
	func_2390(var_22_bool); // 0xd3 NEW_2
...
task_1_event_40(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2395(var_15_object); // 0xe7 NEW_2
...
task_1_event_42(var_0_object, var_1_string, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool)
{
	...
	func_2220(var_15_bool, var_16_object, var_17_string); // 0xfc NEW_2
	...
	func_2252(var_30_object, var_31_string); // 0x105 NEW_2
...
Label_264:
	...
	func_2400(var_43_object); // 0x10b NEW_2
...
task_1_event_26(var_0_string, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2319(var_12_bool, var_13_string); // 0x120 NEW_2
	...
	func_2335(var_21_string); // 0x128 NEW_2
...
task_1_event_1(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool)
{
	...
	func_2277(var_12_bool, var_13_object); // 0x135 NEW_2
	...
	func_2300(var_24_object); // 0x13d NEW_2
...
task_3_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int, var_10_bool, var_11_bool)
{
	...
	func_2078(var_14_object); // 0x478 NEW_2
...
task_4_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2405(var_15_object); // 0x565 NEW_2
...
Label_1393:
	...
	func_2408(var_20_object); // 0x573 NEW_2
...
task_4_event_17(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2306(var_14_object); // 0x579 NEW_2
	var_23_int = 0; var_24_object = Obj(); // 0x57b PushV
	var_24_object = var_11_object; // 0x57c Mov
	func_2372(var_23_int, var_24_object); // 0x57d NEW_2
...
Label_1417:
	...
	func_2382(var_63_object); // 0x58b NEW_2
...
task_4_event_30(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object, var_12_object, var_13_bool)
{
	...
	func_2452(var_19_bool); // 0x593 NEW_2
	...
	func_2390(var_22_bool); // 0x599 NEW_2
...
task_4_event_40(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2395(var_15_object); // 0x5ad NEW_2
...
task_4_event_42(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object, var_12_string)
{
	...
	func_2220(var_15_bool, var_16_object, var_17_string); // 0x5c2 NEW_2
	...
	func_2252(var_30_object, var_31_string); // 0x5cb NEW_2
...
Label_1486:
	...
	func_2400(var_43_object); // 0x5d1 NEW_2
...
task_4_event_26(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_string)
{
	...
	func_2319(var_12_bool, var_13_string); // 0x5e6 NEW_2
	...
	func_2335(var_21_string); // 0x5ee NEW_2
...
task_4_event_1(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_2277(var_12_bool, var_13_object); // 0x5f4 NEW_2
	...
	func_2300(var_24_object); // 0x5fc NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0x887 PushV
	var_15_string = "health"; // 0x888 PushS
	var_16_bool = var_12_string == var_15_string; // 0x889 Eq
	if(var_16_bool == 0) goto Label_2195; // 0x88a JumpB
	var_17_string = "health"; // 0x88b PushS
	GetProperty(var_17_string, var_14_float); // 0x88c Func
	var_18_int = 0; // 0x88e PushI
	var_19_bool = var_14_float <= var_18_int; // 0x88f LE
	if(var_19_bool == 0) goto Label_2195; // 0x890 JumpB
	SignalDeath(var_11_object); // 0x891 Func
...
{
	var_12_object = Obj(); // 0x895 PushV
	var_12_object = var_11_object; // 0x896 Mov
	func_2175(var_12_object); // 0x897 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0x89b PushV
	var_15_object = var_11_object; // 0x89c Mov
	var_16_int = var_12_int; // 0x89d Mov
	var_17_float = var_13_float; // 0x89e Mov
	func_1846(var_15_object, var_16_int, var_17_float); // 0x89f NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0x8a3 PushV
	var_17_object = var_11_object; // 0x8a4 Mov
	var_18_int = var_12_int; // 0x8a5 Mov
	var_19_float = var_13_float; // 0x8a6 Mov
	var_20_cvector = var_15_cvector; // 0x8a7 Mov
	var_21_cvector = var_16_cvector; // 0x8a8 Mov
	func_1914(var_19_float, var_20_cvector, var_21_cvector); // 0x8a9 NEW_2
...
func_0(var_13_object)
{
	...
	func_2455(var_94_object); // 0x8 NEW_2
...
func_2061(var_463_float)
{
	...
	var_466_int = 0; // 0x812 PushI
	var_467_bool = var_463_float < var_466_int; // 0x813 LT
	if(var_467_bool == 0) goto Label_2073; // 0x814 JumpB
	var_468_float = 0.7; // 0x815 PushF
	var_469_int = 500; // 0x816 PushI
	RumblePlay(var_468_float, var_469_int); // 0x817 Func
	
Label_2073:
	var_470_int = 15; // 0x819 PushI
	SendWorldWndMessage(var_470_int, var_465_object); // 0x81a Func
...
{
	var_134_bool = 0; var_135_bool = 0; // 0x81e PushV
	IsPlayerActor(var_133_object, var_135_bool); // 0x81f Func
	var_136_bool = var_135_bool; // 0x821 Push
	if(var_136_bool == 0) goto Label_2086; // 0x822 JumpB
	var_137_string = "attack"; // 0x823 PushS
	PlayGlobalMusic(var_137_string); // 0x824 Func
...
func_1062(var_0_object)
{
	...
	func_2078(var_133_object); // 0x428 NEW_2
...
func_2087()
{
	var_368_object = Obj(); var_369_object = Obj(); // 0x827 PushV
	GetScene(var_369_object); // 0x828 Func
	var_370_string = "battle"; // 0x82a PushS
	var_371_object = Obj(); // 0x82b PushV
	func_2022(var_371_object); // 0x82c NEW_2
	BroadcastMessage(var_370_string, var_371_object, var_369_object); // 0x82e Func
...
{
	var_131_int = 0; var_132_int = 0; // 0x832 PushV
	var_133_string = "branch"; // 0x833 PushS
	GetVariable(var_133_string, var_132_int); // 0x834 Func
	var_130_int = var_132_int; // 0x836 Mov
...
{
	var_27_int = 0; // 0x839 PushV
	func_2098(var_27_int); // 0x83a NEW_2
	var_31_int = 1; // 0x83c PushI
	var_32_bool = var_27_int == var_31_int; // 0x83d Eq
	if(var_32_bool == 0) goto Label_2114; // 0x83e JumpB
	WorkWithCorpse(var_26_object); // 0x83f Func
...
Label_2114:
	Barter(var_26_object); // 0x842 Func
}
...
func_1089(var_2_int, var_140_bool, var_141_object, var_142_float, var_143_float, var_144_bool, var_145_bool)
{
	...
	func_2078(var_153_object); // 0x444 NEW_2
...
{
	var_137_object = Obj(); var_138_int = 0; var_139_bool = 0; var_140_object = Obj(); var_141_int = 0; var_142_bool = 0; // 0x845 PushV
	CreateInvItem(var_140_object); // 0x846 Func
	SetItemName(var_136_string); // 0x848 ObjFunc
	var_143_string = "Organ"; // 0x84a PushS
	var_144_int = 1; // 0x84b PushI
	SetProperty(var_143_string, var_144_int); // 0x84c ObjFunc
	GetItemID(var_141_int); // 0x84e ObjFunc
	var_145_int = 0; // 0x850 PushI
	var_146_int = 1; // 0x851 PushI
	AddItem(var_142_bool, var_140_object, var_145_int, var_146_int); // 0x852 Func
	return 6; // 0x854 Return
}
...
func_2134()
{
	var_130_int = 0; // 0x856 PushV
	func_2098(var_130_int); // 0x857 NEW_2
	var_134_int = 1; // 0x859 PushI
	var_135_bool = var_130_int != var_134_int; // 0x85a Neq
	if(var_135_bool == 0) goto Label_2141; // 0x85b JumpB
	return 0; // 0x85c Return
	
Label_2141:
	var_136_string = ""; // 0x85d PushV
	var_136_string = "liver"; // 0x85e MovS
	func_2117(var_136_string); // 0x85f NEW_2
	var_147_string = ""; // 0x861 PushV
	var_147_string = "kidney"; // 0x862 MovS
	func_2117(var_147_string); // 0x863 NEW_2
	var_148_string = ""; // 0x865 PushV
	var_148_string = "heart"; // 0x866 MovS
	func_2117(var_148_string); // 0x867 NEW_2
	var_149_string = ""; // 0x869 PushV
	var_149_string = "blood"; // 0x86a MovS
	func_2117(var_149_string); // 0x86b NEW_2
...
func_2158()
{
	var_104_int = 0; // 0x86e PushI
	ClearSubContainer(var_104_int); // 0x86f Func
	var_105_string = ""; var_106_int = 0; var_107_int = 0; var_108_int = 0; // 0x871 PushV
	var_105_string = "rusk"; // 0x872 MovS
	var_106_int = 1; // 0x873 MovI
	var_107_int = 1; // 0x874 MovI
	var_108_int = 3; // 0x875 MovI
	func_1966(var_105_string, var_106_int, var_107_int, var_108_int); // 0x876 NEW_2
	var_121_string = ""; var_122_int = 0; var_123_int = 0; // 0x878 PushV
	var_121_string = "peanut"; // 0x879 MovS
	var_122_int = 1; // 0x87a MovI
	var_123_int = 5; // 0x87b MovI
	func_1955(var_121_string, var_122_int, var_123_int); // 0x87c NEW_2
...
{
	var_13_object = Obj(); // 0x880 PushV
	var_13_object = var_12_object; // 0x881 Mov
	TaskCall(0); // 0x882 TaskCall
	func_0(var_13_object); // 0x883 NEW_2
	TaskReturn(); // 0x884 TaskReturn
...
Label_1683:
	var_471_string = "armor"; // 0x693 PushS
	GetProperty(var_471_string, var_420_int); // 0x694 ObjFunc
}
...
{
	var_18_string = "unholster"; // 0x8ad PushS
	var_19_bool = var_17_string == var_18_string; // 0x8ae Eq
	if(var_19_bool == 0) goto Label_2231; // 0x8af JumpB
	var_20_bool = 0; var_21_object = Obj(); // 0x8b0 PushV
	var_21_object = var_16_object; // 0x8b1 Mov
	func_2415(var_21_object); // 0x8b2 NEW_2
	var_15_bool = var_20_bool; // 0x8b3 Mov
	return 0; // 0x8b5 Return
	
Label_2231:
	var_22_string = "player_shot"; // 0x8b7 PushS
	var_23_bool = var_17_string == var_22_string; // 0x8b8 Eq
	if(var_23_bool == 0) goto Label_2241; // 0x8b9 JumpB
	var_24_bool = 0; var_25_object = Obj(); // 0x8ba PushV
	var_25_object = var_16_object; // 0x8bb Mov
	func_2420(var_25_object); // 0x8bc NEW_2
	var_15_bool = var_24_bool; // 0x8bd Mov
	return 0; // 0x8bf Return
	
Label_2241:
	var_26_string = "battle"; // 0x8c1 PushS
	var_27_bool = var_17_string == var_26_string; // 0x8c2 Eq
	if(var_27_bool == 0) goto Label_2250; // 0x8c3 JumpB
	var_28_bool = 0; var_29_object = Obj(); // 0x8c4 PushV
	var_29_object = var_16_object; // 0x8c5 Mov
	func_2425(var_29_object); // 0x8c6 NEW_2
	var_15_bool = var_28_bool; // 0x8c7 Mov
	return 0; // 0x8c9 Return
	
Label_2250:
	var_15_bool = 0; // 0x8ca MovB
...
func_684(var_0_object, var_393_float, var_394_int)
{
	...
	var_472_int = 0; // 0x2c7 PushV
	func_1067(var_472_int); // 0x2c8 NEW_2
	ReportHit(var_0_object, var_472_int, var_400_float, var_399_float); // 0x2ca Func
	var_473_object = Obj(); var_474_float = 0; // 0x2cc PushV
	var_473_object = var_398_object; // 0x2cd Mov
	var_474_float = var_400_float; // 0x2ce Mov
...
{
	var_32_string = "unholster"; // 0x8cd PushS
	var_33_bool = var_31_string == var_32_string; // 0x8ce Eq
	if(var_33_bool == 0) goto Label_2261; // 0x8cf JumpB
	var_34_object = Obj(); // 0x8d0 PushV
	var_34_object = var_30_object; // 0x8d1 Mov
	func_2418(); // 0x8d2 NEW_2
	goto Label_2276; // 0x8d4 Jump
	
Label_2276:
	return 0; // 0x8e4 Return
	
Label_2261:
	var_35_string = "player_shot"; // 0x8d5 PushS
	var_36_bool = var_31_string == var_35_string; // 0x8d6 Eq
	if(var_36_bool == 0) goto Label_2269; // 0x8d7 JumpB
	var_37_object = Obj(); // 0x8d8 PushV
	var_37_object = var_30_object; // 0x8d9 Mov
	func_2423(); // 0x8da NEW_2
	goto Label_2276; // 0x8dc Jump
	
Label_2269:
	var_38_string = "battle"; // 0x8dd PushS
	var_39_bool = var_31_string == var_38_string; // 0x8de Eq
	if(var_39_bool == 0) goto Label_2276; // 0x8df JumpB
	var_40_object = Obj(); // 0x8e0 PushV
	var_40_object = var_30_object; // 0x8e1 Mov
	func_2428(); // 0x8e2 NEW_2
}
...
Label_759:
	...
	HasAnimation(var_363_bool, var_475_string, var_477_int); // 0x2ff Func
	var_478_bool = var_363_bool; // 0x301 Push
	if(var_478_bool == 0) goto Label_840; // 0x302 JumpB
	func_2087(); // 0x304 NEW_2
	var_479_string = "all"; // 0x306 PushS
	var_480_string = "attack_middle"; // 0x307 PushS
	var_481_int = var_480_string + var_362_int; // 0x308 Add
	PlayAnimation(var_479_string, var_481_int); // 0x309 Func
	WaitForAnimEnd(); // 0x30b Func
	func_1062(var_365_string); // 0x30e NEW_2
	var_482_bool = 0; var_483_object = Obj(); // 0x310 PushV
	var_483_object = var_0_object; // 0x311 MovT
	func_1778(var_482_bool, var_483_object); // 0x312 NEW_2
	var_484_bool = var_482_bool == 0; // 0x314 Not
	if(var_484_bool == 0) goto Label_794; // 0x315 JumpB
	StopAsync(); // 0x316 Func
	var_356_bool = 0; // 0x318 MovB
	return 8; // 0x319 Return
	
Label_794:
	var_485_float = 0; var_486_int = 0; // 0x31a PushV
	var_485_float = var_357_float; // 0x31b Mov
	var_486_int = var_362_int; // 0x31c Mov
	func_684(var_365_string, var_485_float, var_486_int); // 0x31d NEW_2
	var_364_int = 1; // 0x31f MovI
	
Label_800:
	var_487_string = "attack_middle"; // 0x320 PushS
	var_488_int = var_487_string + var_362_int; // 0x321 Add
	var_489_string = "_"; // 0x322 PushS
	var_490_int = var_488_int + var_489_string; // 0x323 Add
	var_365_string = var_490_int + var_364_int; // 0x324 Add2
	var_491_string = "all"; // 0x325 PushS
	HasAnimation(var_363_bool, var_491_string, var_365_string); // 0x326 Func
	var_492_bool = var_363_bool == 0; // 0x328 Not
	if(var_492_bool == 0) goto Label_811; // 0x329 JumpB
	goto Label_840; // 0x32a Jump
	
Label_840:
	var_493_bool = 0; // 0x348 PushB
	SetAttackState(var_493_bool); // 0x349 Func
	var_494_string = "all"; // 0x34b PushS
	var_495_string = "attack_end"; // 0x34c PushS
	var_496_int = var_495_string + var_362_int; // 0x34d Add
	PlayAnimation(var_494_string, var_496_int); // 0x34e Func
	var_497_bool = 0; // 0x350 PushV
	func_1076(var_497_bool); // 0x351 NEW_2
	if(var_497_bool == 0) goto Label_858; // 0x353 JumpB
	var_498_bool = 0; var_499_float = 0; // 0x354 PushV
	var_499_float = 0.75; // 0x355 MovF
	func_860(var_498_bool, var_499_float); // 0x356 NEW_2
...
Label_811:
	func_2087(); // 0x32c NEW_2
	var_507_string = "all"; // 0x32e PushS
	PlayAnimation(var_507_string, var_365_string); // 0x32f Func
	WaitForAnimEnd(); // 0x331 Func
	func_1062(var_365_string); // 0x334 NEW_2
	var_508_bool = 0; var_509_object = Obj(); // 0x336 PushV
	var_509_object = var_0_object; // 0x337 MovT
	func_1778(var_508_bool, var_509_object); // 0x338 NEW_2
	var_510_bool = var_508_bool == 0; // 0x33a Not
	if(var_510_bool == 0) goto Label_832; // 0x33b JumpB
	StopAsync(); // 0x33c Func
	var_356_bool = 0; // 0x33e MovB
	return 8; // 0x33f Return
	
Label_832:
	var_511_float = 0; var_512_int = 0; // 0x340 PushV
	var_511_float = var_357_float; // 0x341 Mov
	var_512_int = var_362_int; // 0x342 Mov
	func_684(var_365_string, var_511_float, var_512_int); // 0x343 NEW_2
	var_513_int = 1; // 0x345 PushI
	var_364_int = var_364_int + var_513_int; // 0x346 Add2
...
{
	var_14_bool = 0; var_15_bool = 0; // 0x8e5 PushV
	var_16_bool = 0; // 0x8e6 PushV
	var_16_bool = 0; // 0x8e7 MovB
	var_17_bool = 0; var_18_object = Obj(); // 0x8e8 PushV
	var_18_object = var_13_object; // 0x8e9 Mov
	func_2415(var_18_object); // 0x8ea NEW_2
	if(var_17_bool == 0) goto Label_2291; // 0x8ec JumpB
	var_19_bool = 0; var_20_object = Obj(); // 0x8ed PushV
	var_20_object = var_13_object; // 0x8ee Mov
	func_1647(var_19_bool, var_20_object); // 0x8ef NEW_2
	if(var_19_bool == 0) goto Label_2291; // 0x8f1 JumpB
	var_16_bool = 1; // 0x8f2 MovB
	
Label_2291:
	if(var_16_bool == 0) goto Label_2298; // 0x8f3 JumpB
	IsWeaponHolstered(var_15_bool); // 0x8f4 ObjFunc
	var_23_bool = var_15_bool == 0; // 0x8f6 Not
	if(var_23_bool == 0) goto Label_2298; // 0x8f7 JumpB
	var_12_bool = 1; // 0x8f8 MovB
	return 2; // 0x8f9 Return
	
Label_2298:
	var_12_bool = 0; // 0x8fa MovB
...
{
	var_25_object = Obj(); // 0x8fd PushV
	var_25_object = var_24_object; // 0x8fe Mov
	func_2418(); // 0x8ff NEW_2
...
{
	var_15_bool = 0; var_16_object = Obj(); // 0x903 PushV
	var_16_object = var_14_object; // 0x904 Mov
	func_1647(var_15_bool, var_16_object); // 0x905 NEW_2
	if(var_15_bool == 0) goto Label_2318; // 0x907 JumpB
	var_19_object = Obj(); // 0x908 PushV
	func_2022(var_19_object); // 0x909 NEW_2
	var_22_float = -0.03; // 0x90b PushF
	ReportReputationChange(var_14_object, var_19_object, var_22_float); // 0x90c Func
...
{
	var_14_object = Obj(); var_15_object = Obj(); // 0x90f PushV
	var_16_string = "heal"; // 0x910 PushS
	var_17_bool = var_13_string == var_16_string; // 0x911 Eq
	if(var_17_bool == 0) goto Label_2333; // 0x912 JumpB
	var_18_string = "player"; // 0x913 PushS
	FindActor(var_15_object, var_18_string); // 0x914 Func
	var_19_bool = 0; var_20_object = Obj(); // 0x916 PushV
	var_20_object = var_15_object; // 0x917 Mov
	func_2430(var_20_object); // 0x918 NEW_2
	var_12_bool = var_19_bool; // 0x919 Mov
	return 2; // 0x91b Return
	
Label_2333:
	var_12_bool = 0; // 0x91d MovB
...
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x91f PushV
	var_24_string = "heal"; // 0x920 PushS
	var_25_bool = var_21_string == var_24_string; // 0x921 Eq
	if(var_25_bool == 0) goto Label_2347; // 0x922 JumpB
	var_26_string = "player"; // 0x923 PushS
	FindActor(var_23_object, var_26_string); // 0x924 Func
	var_27_object = Obj(); // 0x926 PushV
	var_27_object = var_23_object; // 0x927 Mov
	func_2433(); // 0x928 NEW_2
	var_23_object = 0; // 0x92a SetNull
...
{
	var_68_string = ""; var_69_string = ""; // 0x92c PushV
	var_69_string = "idle"; // 0x92d MovS
	var_70_int = var_67_int; // 0x92e Push
	if(var_70_int == 0) goto Label_2353; // 0x92f JumpB
	var_69_string = var_69_string + var_67_int; // 0x930 Add2
	
Label_2353:
	var_66_string = var_69_string; // 0x931 Mov
...
{
	var_61_int = 0; var_62_bool = 0; var_63_int = 0; var_64_bool = 0; // 0x933 PushV
	var_63_int = 0; // 0x934 MovI
	
Label_2357:
	var_65_string = "all"; // 0x935 PushS
	var_66_string = ""; var_67_int = 0; // 0x936 PushV
	var_67_int = var_63_int; // 0x937 Mov
	func_2348(var_66_string, var_67_int); // 0x938 NEW_2
	HasAnimation(var_64_bool, var_65_string, var_66_string); // 0x93a Func
	var_71_bool = var_64_bool == 0; // 0x93c Not
	if(var_71_bool == 0) goto Label_2367; // 0x93d JumpB
	goto Label_2370; // 0x93e Jump
	
Label_2370:
	var_60_int = var_63_int; // 0x942 Mov
	return 4; // 0x943 Return
	
Label_2367:
	var_72_int = 1; // 0x93f PushI
	var_63_int = var_63_int + var_72_int; // 0x940 Add2
	goto Label_2357; // 0x941 Jump
}
...
Label_329:
	...
	func_2355(var_60_int); // 0x14a NEW_2
...
Label_344:
	...
	func_2348(var_82_string, var_83_int); // 0x166 NEW_2
...
{
	var_25_bool = 0; var_26_object = Obj(); // 0x945 PushV
	var_26_object = var_24_object; // 0x946 Mov
	func_1778(var_25_bool, var_26_object); // 0x947 NEW_2
	if(var_25_bool == 0) goto Label_2380; // 0x949 JumpB
	var_23_int = 2; // 0x94a MovI
	goto Label_2381; // 0x94b Jump
	
Label_2381:
	return 0; // 0x94d Return
	
Label_2380:
	var_23_int = 0; // 0x94c MovI
}


func_2382(var_63_object)
{
	var_64_object = Obj(); // 0x94f PushV
	var_64_object = var_63_object; // 0x950 Mov
	TaskCall(2); // 0x951 TaskCall
	func_406(var_64_object); // 0x952 NEW_2
	TaskReturn(); // 0x953 TaskReturn
...
{
	var_500_float = 0; var_501_bool = 0; var_502_float = 0; var_503_bool = 0; // 0x35c PushV
	rand(var_502_float); // 0x35d Func
	var_504_bool = var_502_float < var_499_float; // 0x35f LT
	if(var_504_bool == 0) goto Label_880; // 0x360 JumpB
	
Label_865:
	IsAnimationPlaying(var_503_bool); // 0x361 Func
	var_505_bool = var_503_bool == 0; // 0x363 Not
	if(var_505_bool == 0) goto Label_870; // 0x364 JumpB
...
Label_885:
	var_498_bool = 0; // 0x375 MovB
	return 4; // 0x376 Return
	
Label_870:
	var_506_bool = 0; // 0x366 PushV
	func_958(var_506_bool); // 0x367 NEW_2
	if(var_506_bool == 0) goto Label_876; // 0x369 JumpB
	var_498_bool = 1; // 0x36a MovB
...
Label_880:
	...
	func_1062(var_503_bool); // 0x373 NEW_2
}
...
{
	var_21_object = Obj(); // 0x969 PushV
	var_21_object = var_20_object; // 0x96a Mov
	func_2435(var_21_object); // 0x96b NEW_2
...
{
	var_22_bool = 0; var_23_bool = 0; // 0x983 PushV
	var_24_bool = GlobalVars[0]; // 0x984 PushGE
	if(var_24_bool == 0) goto Label_2447; // 0x985 JumpB
	IsOverrideActive(var_23_bool); // 0x986 Func
	var_25_bool = var_23_bool == 0; // 0x988 Not
	if(var_25_bool == 0) goto Label_2446; // 0x989 JumpB
	var_26_object = Obj(); // 0x98a PushV
	var_26_object = var_21_object; // 0x98b Mov
	func_2104(var_26_object); // 0x98c NEW_2
...
func_2448()
{
	var_12_bool = GlobalVars[0]; // 0x990 PushGE
	var_12_bool = 0; // 0x991 MovB
	GlobalVars[0] = var_12_bool; // 0x992 PopGE
...
{
	var_95_bool = 0; var_96_object = Obj(); // 0x998 PushV
	var_96_object = var_94_object; // 0x999 Mov
	func_1647(var_95_bool, var_96_object); // 0x99a NEW_2
	if(var_95_bool == 0) goto Label_2471; // 0x99c JumpB
	var_99_object = Obj(); // 0x99d PushV
	func_2022(var_99_object); // 0x99e NEW_2
	var_102_float = -0.07; // 0x9a0 PushF
	var_103_bool = 1; // 0x9a1 PushB
	ReportReputationChange(var_94_object, var_99_object, var_102_float, var_103_bool); // 0x9a2 Func
	func_2158(); // 0x9a5 NEW_2
	
Label_2471:
	func_2134(); // 0x9a8 NEW_2
	var_150_bool = GlobalVars[0]; // 0x9aa PushGE
	var_150_bool = 1; // 0x9ab MovB
	GlobalVars[0] = var_150_bool; // 0x9ac PopGE
	var_151_int = 50; // 0x9ad PushI
	var_152_int = 40; // 0x9ae PushI
	SetRTEnvelope(var_151_int, var_152_int); // 0x9af Func
...
Label_576:
	...
	var_514_string = "all"; // 0x242 PushS
	var_515_string = "fjump"; // 0x243 PushS
	PlayAnimation(var_514_string, var_515_string); // 0x244 Func
	WaitForAnimEnd(); // 0x246 Func
	func_1062(var_95_float); // 0x249 NEW_2
	var_516_cvector = CVector(0.0, 0.0, 0.0); // 0x24b PushVec
	SetSpeed(var_516_cvector); // 0x24c Func
	Stop(); // 0x24e Func
	StopAsync(); // 0x250 Func
	var_517_bool = 0; // 0x252 PushV
	func_1019(var_95_float, var_517_bool); // 0x253 NEW_2
	var_518_bool = var_517_bool == 0; // 0x255 Not
	if(var_518_bool == 0) goto Label_622; // 0x256 JumpB
	var_519_bool = 0; var_520_object = Obj(); // 0x257 PushV
	var_520_object = var_0_object; // 0x258 MovT
	func_1778(var_519_bool, var_520_object); // 0x259 NEW_2
	var_521_bool = var_519_bool == 0; // 0x25b Not
	if(var_521_bool == 0) goto Label_606; // 0x25c JumpB
...
Label_606:
	...
	var_522_float = var_73_float * var_73_float; // 0x264 Mult
	var_523_bool = var_92_float < var_522_float; // 0x265 LT
	if(var_523_bool == 0) goto Label_622; // 0x266 JumpB
	var_524_bool = 0; var_525_float = 0; // 0x267 PushV
	var_525_float = var_73_float; // 0x268 Mov
	func_723(var_95_float, var_524_bool, var_525_float); // 0x269 NEW_2
	var_526_bool = var_524_bool == 0; // 0x26b Not
	if(var_526_bool == 0) goto Label_622; // 0x26c JumpB
	goto Label_632; // 0x26d Jump
	
Label_623:
	var_527_bool = 0; var_528_float = 0; // 0x26f PushV
	var_528_float = var_73_float; // 0x270 Mov
	func_723(var_95_float, var_527_bool, var_528_float); // 0x271 NEW_2
	var_529_bool = var_527_bool == 0; // 0x273 Not
	if(var_529_bool == 0) goto Label_630; // 0x274 JumpB
