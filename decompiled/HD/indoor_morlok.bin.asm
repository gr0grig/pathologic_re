...
0x84a: Pop(0)
0x84b: @@ SetItemName(Stack[-7])
0x84c: Pop(0)
0x84d: Push("Organ")
0x84e: Push((int) 1)
0x84f: @@ SetProperty(Stack[-2], Stack[-1])
0x850: Pop(2)
0x851: @@ GetItemID(Stack[-2])
0x852: Pop(0)
0x853: Push((int) 0)
0x854: Push((int) 1)
...
0x89f: Stack[-3] = Stack[-7]
0x8a0: Stack[-2] = Stack[-6]
...
0x8a7: Stack[-5] = Stack[-11]
0x8a8: Stack[-4] = Stack[-10]
0x8a9: Stack[-3] = Stack[-9]
0x8aa: Stack[-2] = Stack[-7]
...
0x8f7: @@ IsWeaponHolstered(Stack[-1])
0x8f8: Pop(0)
...
0x95b: Stack[-1] = Stack[-4]
0x95c: Call2 0x947

0x95d: Stack[-5] = Stack[-2]
0x95e: Pop(2)
0x95f: Return(); Pop(0)

0x960: PushEmpty()
0x961: PushEmpty(object)
0x962: Stack[-1] = Stack[-2]
0x963: Call2 0x951
...
0x9a9: Push("class")
0x9aa: @@ GetProperty(Stack[-1], Stack[-2])
0x9ab: Pop(1)
