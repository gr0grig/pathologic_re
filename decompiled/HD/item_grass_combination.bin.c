...
Label_19:
	...
	var_57_bool = 0; var_58_string = ""; var_59_float = 0; var_60_float = 0; var_61_float = 0; // 0x31 PushV
	var_58_string = "immunity"; // 0x32 MovS
	var_59_float = var_8_float; // 0x33 Mov
	var_60_float = 0; // 0x34 MovI
	var_61_float = 1; // 0x35 MovI
	func_66(var_57_bool, var_58_string, var_59_float, var_60_float, var_61_float); // 0x36 NEW_2
	var_62_float = 0; // 0x38 PushV
	var_62_float = var_8_float; // 0x39 Mov
	func_96(var_62_float); // 0x3a NEW_2
	var_66_int = 1; // 0x3c PushI
	var_67_int = GlobalVars[2]; // 0x3d PushGE
	RemoveItem(var_5_int, var_66_int, var_67_int); // 0x3e Func
...
{
	var_63_object = Obj(); var_64_object = Obj(); // 0x60 PushV
	CreateFloatVector(var_64_object); // 0x61 Func
	add(var_62_float); // 0x63 ObjFunc
	var_65_int = 13; // 0x65 PushI
	SendWorldWndMessage(var_65_int, var_64_object); // 0x66 Func
...
func_106(var_49_float)
{
	...
	var_53_bool = var_49_float < var_52_int; // 0x70 LT
	if(var_53_bool == 0) goto Label_118; // 0x71 JumpB
	var_54_float = 0.7; // 0x72 PushF
	var_55_int = 500; // 0x73 PushI
	RumblePlay(var_54_float, var_55_int); // 0x74 Func
	
Label_118:
	var_56_int = 15; // 0x76 PushI
	SendWorldWndMessage(var_56_int, var_51_object); // 0x77 Func
