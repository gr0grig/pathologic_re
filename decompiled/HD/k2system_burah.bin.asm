...
0x509: @@ HasProperty(Stack[-1], Stack[-4])
0x50a: Pop(1)
...
0x534: @@ HasProperty(Stack[-1], Stack[-4])
0x535: Pop(1)
...
0x55c: Push("Can't find lsh animation : ")
...
0x56b: Push("Can't find lsh animation : ")
...
0x5ae: @@ GetItemID(Stack[-3])
0x5af: Pop(0)
0x5b0: Push("Category")
0x5b1: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5b2: Pop(1)
0x5b3: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x5b4: Pop(0)
0x5b5: Pop(0); Push((bool) Stack[-1] == 0)
0x5b6: IF (Stack[-1] == 0) GOTO 0x5ba; Pop(1)

0x5b7: @@ DropItems(Stack[-8], Stack[-7])
0x5b8: Pop(0)
0x5b9: GOTO 0x5bf

0x5ba: PushEmpty(int, int)
0x5bb: Stack[-2] = Stack[-5]
0x5bc: Stack[-1] = Stack[-9]
0x5bd: Call2 0x5a1
...
0x5c2: Pop(0)
0x5c3: @@ SetItemName(Stack[-4])
0x5c4: Pop(0)
0x5c5: PushEmpty(object, object, int)
0x5c6: Stack[-3] = Stack[-8]
0x5c7: Stack[-2] = Stack[-4]
...
0x5e3: Stack[-1] = Stack[-2]
0x5e4: Call2 0x5f0

0x5e5: Pop(1)
0x5e6: PushEmpty(bool, object, string, float, float, float)
0x5e7: Stack[-5] = Stack[-8]
0x5e8: Stack[-4] = "reputation"
0x5e9: Stack[-3] = Stack[-7]
0x5ea: Stack[-2] = (int) 0
0x5eb: Stack[-1] = (int) 1
0x5ec: Call2 0x442
...
0x62b: Stack[-1] = "ui/NPC_Burah.png"
0x62c: Return(); Pop(0)

0x62d: Stack[-1] = "ui/NPC_Burah_b.png"
0x62e: Return(); Pop(0)
...
0x63f: PushEmpty()
0x640: Push("beta_pills 5 is given")
0x641: @ Trace(Stack[-1])
0x642: Pop(1)
0x643: PushEmpty(object, string, int)
0x644: Stack[-3] = Stack[-5]
0x645: Stack[-2] = "beta_pills"
0x646: Stack[-1] = (int) 5
0x647: Call2 0x5c0
...
0x650: PushEmpty()
0x651: Push("burah_serum is given")
0x652: @ Trace(Stack[-1])
0x653: Pop(1)
0x654: PushEmpty(object, string, int)
0x655: Stack[-3] = Stack[-5]
0x656: Stack[-2] = "burah_serum"
0x657: Stack[-1] = (int) 1
0x658: Call2 0x5c0
...
0x67b: Stack[-2] = Stack[-5]
0x67c: Stack[-1] = (float) -0.3
0x67d: Call2 0x5cd
...
0x6dc: Push("Can't retrieve diary root")
0x6dd: @ Trace(Stack[-1])
0x6de: Pop(1)
...
0x6e7: Stack[-4] = Stack[-1]
0x6e8: Pop(1)
0x6e9: @@ Find(Stack[-7], Stack[-2])
0x6ea: Pop(0)
0x6eb: Pop(0); Push((bool) Stack[-2] == 0)
0x6ec: IF (Stack[-1] == 0) GOTO 0x6f3; Pop(1)

0x6ed: Push("Can't find diary parent with id: ")
...
0x6f3: @@ AddChild(Stack[-8])
0x6f4: Pop(0)
0x6f5: Push((int) 7)
0x6f6: @ SendWorldWndMessage(Stack[-1])
0x6f7: Pop(1)
0x6f8: @@ GetCategory(Stack[-1])
0x6f9: Pop(0)
...
0x712: Stack[-2] = "klara2_npc_positioner"
0x713: Stack[-1] = "remove_danko"
0x714: Call2 0x5fa
...
0x718: Stack[-2] = "klara2_npc_positioner"
0x719: Stack[-1] = "remove_burah"
0x71a: Call2 0x5fa
...
0x733: Pop(1)
0x734: Push("k2system_burah_state")
...
0x73e: Pop(1)
0x73f: Push("k2system_burah_state")
...
0x747: Stack[-3] = Stack[-1]
0x748: Pop(1)
0x749: Push("k2system_danko_state")
...
0x753: Pop(1)
0x754: Push("k2system_danko_state")
...
0x75d: Pop(1)
0x75e: Push("k2system_klara_state")
...
0x768: Pop(1)
0x769: Push("k2system_klara_state")
