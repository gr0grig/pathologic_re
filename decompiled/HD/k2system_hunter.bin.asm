...
0x6c3: Pop(0)
0x6c4: @@ SetItemName(Stack[-7])
0x6c5: Pop(0)
0x6c6: Push("Organ")
0x6c7: Push((int) 1)
0x6c8: @@ SetProperty(Stack[-2], Stack[-1])
0x6c9: Pop(2)
0x6ca: @@ GetItemID(Stack[-2])
0x6cb: Pop(0)
0x6cc: Push((int) 0)
0x6cd: Push((int) 1)
...
0x706: Stack[-3] = Stack[-7]
0x707: Stack[-2] = Stack[-6]
...
0x70e: Stack[-5] = Stack[-11]
0x70f: Stack[-4] = Stack[-10]
0x710: Stack[-3] = Stack[-9]
0x711: Stack[-2] = Stack[-7]
