...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1666(var_12_object); // 0x380 NEW_2
...
task_3_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object)
{
	...
	func_1716(var_13_object); // 0x45f NEW_2
...
{
	var_9_object = Obj(); // 0x6ea PushV
	func_1615(var_9_object); // 0x6eb NEW_2
	RemoveActor(var_9_object); // 0x6ed Func
	Hold(); // 0x6ef Func
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x705 PushV
	var_13_object = var_9_object; // 0x706 Mov
	var_14_int = var_10_int; // 0x707 Mov
	var_15_float = var_11_float; // 0x708 Mov
	func_1465(var_13_object, var_14_int, var_15_float); // 0x709 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x70d PushV
	var_15_object = var_9_object; // 0x70e Mov
	var_16_int = var_10_int; // 0x70f Mov
	var_17_float = var_11_float; // 0x710 Mov
	var_18_cvector = var_13_cvector; // 0x711 Mov
	var_19_cvector = var_14_cvector; // 0x712 Mov
	func_1533(var_17_float, var_18_cvector, var_19_cvector); // 0x713 NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x716 PushV
	var_13_string = "health"; // 0x717 PushS
	var_14_bool = var_10_string == var_13_string; // 0x718 Eq
	if(var_14_bool == 0) goto Label_1826; // 0x719 JumpB
	var_15_string = "health"; // 0x71a PushS
	GetProperty(var_15_string, var_12_float); // 0x71b Func
	var_16_int = 0; // 0x71d PushI
	var_17_bool = var_12_float <= var_16_int; // 0x71e LE
	if(var_17_bool == 0) goto Label_1826; // 0x71f JumpB
	SignalDeath(var_9_object); // 0x720 Func
...
{
	var_10_object = Obj(); // 0x724 PushV
	var_10_object = var_9_object; // 0x725 Mov
	func_1778(var_10_object); // 0x726 NEW_2
...
{
	var_13_bool = 0; var_14_bool = 0; // 0x682 PushV
	IsPlayerActor(var_12_object, var_14_bool); // 0x683 Func
	var_15_bool = var_14_bool; // 0x685 Push
	if(var_15_bool == 0) goto Label_1674; // 0x686 JumpB
	var_16_string = "attack"; // 0x687 PushS
	PlayGlobalMusic(var_16_string); // 0x688 Func
...
Label_1302:
	var_453_string = "armor"; // 0x516 PushS
	GetProperty(var_453_string, var_402_int); // 0x517 ObjFunc
}
...
func_1675()
{
	var_350_object = Obj(); var_351_object = Obj(); // 0x68b PushV
	GetScene(var_351_object); // 0x68c Func
	var_352_string = "battle"; // 0x68e PushS
	var_353_object = Obj(); // 0x68f PushV
	func_1615(var_353_object); // 0x690 NEW_2
	BroadcastMessage(var_352_string, var_353_object, var_351_object); // 0x692 Func
...
{
	var_37_string = ""; var_38_string = ""; // 0x696 PushV
	var_38_string = "idle"; // 0x697 MovS
	var_39_int = var_36_int; // 0x698 Push
	if(var_39_int == 0) goto Label_1691; // 0x699 JumpB
	var_38_string = var_38_string + var_36_int; // 0x69a Add2
	
Label_1691:
	var_35_string = var_38_string; // 0x69b Mov
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x69d PushV
	var_32_int = 0; // 0x69e MovI
	
Label_1695:
	var_34_string = "all"; // 0x69f PushS
	var_35_string = ""; var_36_int = 0; // 0x6a0 PushV
	var_36_int = var_32_int; // 0x6a1 Mov
	func_1686(var_35_string, var_36_int); // 0x6a2 NEW_2
	HasAnimation(var_33_bool, var_34_string, var_35_string); // 0x6a4 Func
	var_40_bool = var_33_bool == 0; // 0x6a6 Not
	if(var_40_bool == 0) goto Label_1705; // 0x6a7 JumpB
	goto Label_1708; // 0x6a8 Jump
	
Label_1708:
	var_29_int = var_32_int; // 0x6ac Mov
	return 4; // 0x6ad Return
	
Label_1705:
	var_41_int = 1; // 0x6a9 PushI
	var_32_int = var_32_int + var_41_int; // 0x6aa Add2
	goto Label_1695; // 0x6ab Jump
}
...
Label_162:
	...
	var_512_int = 1; // 0xa8 PushI
	Sleep(var_512_int); // 0xa9 Func
...
{
	var_14_int = 0; var_15_int = 0; // 0x6ae PushV
	var_16_string = "branch"; // 0x6af PushS
	GetVariable(var_16_string, var_15_int); // 0x6b0 Func
	var_13_int = var_15_int; // 0x6b2 Mov
...
Label_335:
	...
	var_496_string = "all"; // 0x151 PushS
	var_497_string = "fjump"; // 0x152 PushS
	PlayAnimation(var_496_string, var_497_string); // 0x153 Func
	WaitForAnimEnd(); // 0x155 Func
	func_821(var_41_float); // 0x158 NEW_2
	var_498_cvector = CVector(0.0, 0.0, 0.0); // 0x15a PushVec
	SetSpeed(var_498_cvector); // 0x15b Func
	Stop(); // 0x15d Func
	StopAsync(); // 0x15f Func
	var_499_bool = 0; // 0x161 PushV
	func_778(var_41_float, var_499_bool); // 0x162 NEW_2
	var_500_bool = var_499_bool == 0; // 0x164 Not
	if(var_500_bool == 0) goto Label_381; // 0x165 JumpB
	var_501_bool = 0; var_502_object = Obj(); // 0x166 PushV
	var_502_object = var_0_object; // 0x167 MovT
	func_1397(var_501_bool, var_502_object); // 0x168 NEW_2
	var_503_bool = var_501_bool == 0; // 0x16a Not
	if(var_503_bool == 0) goto Label_365; // 0x16b JumpB
...
Label_365:
	...
	var_504_float = var_19_float * var_19_float; // 0x173 Mult
	var_505_bool = var_38_float < var_504_float; // 0x174 LT
	if(var_505_bool == 0) goto Label_381; // 0x175 JumpB
	var_506_bool = 0; var_507_float = 0; // 0x176 PushV
	var_507_float = var_19_float; // 0x177 Mov
	func_482(var_41_float, var_506_bool, var_507_float); // 0x178 NEW_2
	var_508_bool = var_506_bool == 0; // 0x17a Not
	if(var_508_bool == 0) goto Label_381; // 0x17b JumpB
	goto Label_391; // 0x17c Jump
	
Label_382:
	var_509_bool = 0; var_510_float = 0; // 0x17e PushV
	var_510_float = var_19_float; // 0x17f Mov
	func_482(var_41_float, var_509_bool, var_510_float); // 0x180 NEW_2
	var_511_bool = var_509_bool == 0; // 0x182 Not
	if(var_511_bool == 0) goto Label_389; // 0x183 JumpB
...
{
	var_14_int = 0; // 0x6b5 PushV
	func_1710(var_14_int); // 0x6b6 NEW_2
	var_18_int = 1; // 0x6b8 PushI
	var_19_bool = var_14_int == var_18_int; // 0x6b9 Eq
	if(var_19_bool == 0) goto Label_1726; // 0x6ba JumpB
	WorkWithCorpse(var_13_object); // 0x6bb Func
	goto Label_1728; // 0x6bd Jump
	
Label_1728:
	return 0; // 0x6c0 Return
	
Label_1726:
	Barter(var_13_object); // 0x6be Func
}
...
func_821(var_0_object)
{
	...
	func_1666(var_113_object); // 0x337 NEW_2
...
func_443(var_0_object, var_375_float, var_376_int)
{
	...
	var_454_int = 0; // 0x1d6 PushV
	func_826(var_454_int); // 0x1d7 NEW_2
	ReportHit(var_0_object, var_454_int, var_382_float, var_381_float); // 0x1d9 Func
	var_455_object = Obj(); var_456_float = 0; // 0x1db PushV
	var_455_object = var_380_object; // 0x1dc Mov
	var_456_float = var_382_float; // 0x1dd Mov
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_bool = 0; var_23_object = Obj(); var_24_int = 0; var_25_bool = 0; // 0x6c1 PushV
	CreateInvItem(var_23_object); // 0x6c2 Func
	SetItemName(var_19_string); // 0x6c4 ObjFunc
	var_26_string = "Organ"; // 0x6c6 PushS
	var_27_int = 1; // 0x6c7 PushI
	SetProperty(var_26_string, var_27_int); // 0x6c8 ObjFunc
	GetItemID(var_24_int); // 0x6ca ObjFunc
	var_28_int = 0; // 0x6cc PushI
	var_29_int = 1; // 0x6cd PushI
	AddItem(var_25_bool, var_23_object, var_28_int, var_29_int); // 0x6ce Func
...
func_841(var_2_int, var_120_bool, var_121_object, var_122_float, var_123_float, var_124_bool, var_125_bool)
{
	...
	func_1666(var_133_object); // 0x34c NEW_2
...
Label_84:
	...
	func_1693(var_29_int); // 0x55 NEW_2
...
Label_99:
	...
	func_1686(var_51_string, var_52_int); // 0x71 NEW_2
...
func_1746()
{
	var_13_int = 0; // 0x6d2 PushV
	func_1710(var_13_int); // 0x6d3 NEW_2
	var_17_int = 1; // 0x6d5 PushI
	var_18_bool = var_13_int != var_17_int; // 0x6d6 Neq
	if(var_18_bool == 0) goto Label_1753; // 0x6d7 JumpB
	return 0; // 0x6d8 Return
	
Label_1753:
	var_19_string = ""; // 0x6d9 PushV
	var_19_string = "liver"; // 0x6da MovS
	func_1729(var_19_string); // 0x6db NEW_2
	var_30_string = ""; // 0x6dd PushV
	var_30_string = "kidney"; // 0x6de MovS
	func_1729(var_30_string); // 0x6df NEW_2
	var_31_string = ""; // 0x6e1 PushV
	var_31_string = "heart"; // 0x6e2 MovS
	func_1729(var_31_string); // 0x6e3 NEW_2
	var_32_string = ""; // 0x6e5 PushV
	var_32_string = "blood"; // 0x6e6 MovS
	func_1729(var_32_string); // 0x6e7 NEW_2
...
Label_518:
	...
	var_457_string = "all"; // 0x20b PushS
	var_458_string = "attack_middle"; // 0x20c PushS
	var_459_int = var_458_string + var_344_int; // 0x20d Add
	HasAnimation(var_345_bool, var_457_string, var_459_int); // 0x20e Func
	var_460_bool = var_345_bool; // 0x210 Push
	if(var_460_bool == 0) goto Label_599; // 0x211 JumpB
	func_1675(); // 0x213 NEW_2
	var_461_string = "all"; // 0x215 PushS
	var_462_string = "attack_middle"; // 0x216 PushS
	var_463_int = var_462_string + var_344_int; // 0x217 Add
	PlayAnimation(var_461_string, var_463_int); // 0x218 Func
	WaitForAnimEnd(); // 0x21a Func
	func_821(var_347_string); // 0x21d NEW_2
	var_464_bool = 0; var_465_object = Obj(); // 0x21f PushV
	var_465_object = var_0_object; // 0x220 MovT
	func_1397(var_464_bool, var_465_object); // 0x221 NEW_2
	var_466_bool = var_464_bool == 0; // 0x223 Not
	if(var_466_bool == 0) goto Label_553; // 0x224 JumpB
	StopAsync(); // 0x225 Func
	var_338_bool = 0; // 0x227 MovB
	return 8; // 0x228 Return
	
Label_553:
	var_467_float = 0; var_468_int = 0; // 0x229 PushV
	var_467_float = var_339_float; // 0x22a Mov
	var_468_int = var_344_int; // 0x22b Mov
	func_443(var_347_string, var_467_float, var_468_int); // 0x22c NEW_2
	var_346_int = 1; // 0x22e MovI
	
Label_559:
	var_469_string = "attack_middle"; // 0x22f PushS
	var_470_int = var_469_string + var_344_int; // 0x230 Add
	var_471_string = "_"; // 0x231 PushS
	var_472_int = var_470_int + var_471_string; // 0x232 Add
	var_347_string = var_472_int + var_346_int; // 0x233 Add2
	var_473_string = "all"; // 0x234 PushS
	HasAnimation(var_345_bool, var_473_string, var_347_string); // 0x235 Func
	var_474_bool = var_345_bool == 0; // 0x237 Not
	if(var_474_bool == 0) goto Label_570; // 0x238 JumpB
	goto Label_599; // 0x239 Jump
	
Label_599:
	var_475_bool = 0; // 0x257 PushB
	SetAttackState(var_475_bool); // 0x258 Func
	var_476_string = "all"; // 0x25a PushS
	var_477_string = "attack_end"; // 0x25b PushS
	var_478_int = var_477_string + var_344_int; // 0x25c Add
	PlayAnimation(var_476_string, var_478_int); // 0x25d Func
	var_479_bool = 0; // 0x25f PushV
	func_835(var_479_bool); // 0x260 NEW_2
	if(var_479_bool == 0) goto Label_617; // 0x262 JumpB
	var_480_bool = 0; var_481_float = 0; // 0x263 PushV
	var_481_float = 0.75; // 0x264 MovF
	func_619(var_480_bool, var_481_float); // 0x265 NEW_2
...
Label_570:
	func_1675(); // 0x23b NEW_2
	var_489_string = "all"; // 0x23d PushS
	PlayAnimation(var_489_string, var_347_string); // 0x23e Func
	WaitForAnimEnd(); // 0x240 Func
	func_821(var_347_string); // 0x243 NEW_2
	var_490_bool = 0; var_491_object = Obj(); // 0x245 PushV
	var_491_object = var_0_object; // 0x246 MovT
	func_1397(var_490_bool, var_491_object); // 0x247 NEW_2
	var_492_bool = var_490_bool == 0; // 0x249 Not
	if(var_492_bool == 0) goto Label_591; // 0x24a JumpB
	StopAsync(); // 0x24b Func
	var_338_bool = 0; // 0x24d MovB
	return 8; // 0x24e Return
	
Label_591:
	var_493_float = 0; var_494_int = 0; // 0x24f PushV
	var_493_float = var_339_float; // 0x250 Mov
	var_494_int = var_344_int; // 0x251 Mov
	func_443(var_347_string, var_493_float, var_494_int); // 0x252 NEW_2
	var_495_int = 1; // 0x254 PushI
	var_346_int = var_346_int + var_495_int; // 0x255 Add2
...
{
	var_482_float = 0; var_483_bool = 0; var_484_float = 0; var_485_bool = 0; // 0x26b PushV
	rand(var_484_float); // 0x26c Func
	var_486_bool = var_484_float < var_481_float; // 0x26e LT
	if(var_486_bool == 0) goto Label_639; // 0x26f JumpB
	
Label_624:
	IsAnimationPlaying(var_485_bool); // 0x270 Func
	var_487_bool = var_485_bool == 0; // 0x272 Not
	if(var_487_bool == 0) goto Label_629; // 0x273 JumpB
...
Label_644:
	var_480_bool = 0; // 0x284 MovB
	return 4; // 0x285 Return
	
Label_629:
	var_488_bool = 0; // 0x275 PushV
	func_717(var_488_bool); // 0x276 NEW_2
	if(var_488_bool == 0) goto Label_635; // 0x278 JumpB
	var_480_bool = 1; // 0x279 MovB
...
Label_639:
	...
	func_821(var_485_bool); // 0x282 NEW_2
}
...
func_1649(var_445_float)
{
	...
	var_448_int = 0; // 0x676 PushI
	var_449_bool = var_445_float < var_448_int; // 0x677 LT
	if(var_449_bool == 0) goto Label_1661; // 0x678 JumpB
	var_450_float = 0.7; // 0x679 PushF
	var_451_int = 500; // 0x67a PushI
	RumblePlay(var_450_float, var_451_int); // 0x67b Func
	
Label_1661:
	var_452_int = 15; // 0x67d PushI
	SendWorldWndMessage(var_452_int, var_447_object); // 0x67e Func
...
{
	var_11_object = Obj(); var_12_object = Obj(); // 0x6f2 PushV
	GetScene(var_12_object); // 0x6f3 Func
	func_1746(); // 0x6f6 NEW_2
	var_33_string = "dead"; // 0x6f8 PushS
	var_34_int = 1; // 0x6f9 PushI
	SetProperty(var_33_string, var_34_int); // 0x6fa Func
	var_35_object = Obj(); // 0x6fc PushV
	var_35_object = var_10_object; // 0x6fd Mov
	TaskCall(3); // 0x6fe TaskCall
	func_1097(var_35_object); // 0x6ff NEW_2
	TaskReturn(); // 0x700 TaskReturn
