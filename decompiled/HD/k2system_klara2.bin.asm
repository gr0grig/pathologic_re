...
0x5a1: @@ HasProperty(Stack[-1], Stack[-4])
0x5a2: Pop(1)
...
0x5b6: @@ GetProperty(Stack[-1], Stack[-2])
0x5b7: Pop(1)
0x5b8: PushEmpty(bool, string)
0x5b9: Stack[-1] = Stack[-3]
0x5ba: Call2 0x608

0x5bb: Stack[-14] = Stack[-2]
0x5bc: Pop(2)
0x5bd: Return(); Pop(10)
...
0x5cc: @@ HasProperty(Stack[-1], Stack[-4])
0x5cd: Pop(1)
...
0x5e1: @@ GetProperty(Stack[-1], Stack[-2])
0x5e2: Pop(1)
0x5e3: PushEmpty(bool, string)
0x5e4: Stack[-1] = Stack[-3]
0x5e5: Call2 0x608

0x5e6: Stack[-14] = Stack[-2]
0x5e7: Pop(2)
0x5e8: Return(); Pop(10)
...
0x603: Push("Can't find lsh animation : ")
...
0x630: Pop(0)
0x631: Pop(0); Push((bool) Stack[-1] == 0)
...
0x65f: Stack[-1] = "ui/NPC_Klara.png"
0x660: Return(); Pop(0)

0x661: Stack[-1] = "ui/NPC_Klara_b.png"
0x662: Return(); Pop(0)
...
0x673: Stack[-2] = "klara2_positioner"
0x674: Stack[-1] = "remove_klara"
0x675: Call2 0x62e
...
0x67a: Stack[-2] = "klara2_svita_positioner"
0x67b: Stack[-1] = "place_svita"
0x67c: Call2 0x62e
...
0x681: Stack[-2] = "klara2_positioner"
0x682: Stack[-1] = "klara_stay"
0x683: Call2 0x62e
...
0x6f8: Push("k2system_klara_day")
0x6f9: @ GetVariable(Stack[-1], Stack[-2])
0x6fa: Pop(1)
0x6fb: Stack[-3] = Stack[-1]
0x6fc: Return(); Pop(2)
...
0x701: Pop(1)
0x702: Push("k2system_klara_state")
...
0x717: Pop(2)
0x718: Push("mt_klara2")
0x719: Push((int) 1)
0x71a: @ SetVariable(Stack[-2], Stack[-1])
0x71b: Pop(2)
0x71c: Push("ACHIEVEMENT_SOMETHING")
