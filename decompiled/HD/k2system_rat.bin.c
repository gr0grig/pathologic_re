task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1217(var_10_bool, var_11_object); // 0x14 NEW_2
	...
	func_1224(var_53_object); // 0x1c NEW_2
...
task_0_event_16(var_0_bool, var_1_bool, var_2_object, var_3_string, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1251(var_11_bool, var_12_object, var_13_string); // 0x23 NEW_2
...
Label_41:
	...
	func_1278(var_59_object, var_60_string); // 0x2c NEW_2
...
Label_55:
	...
	func_1234(var_45_object); // 0x3c NEW_2
...
task_0_event_0(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1328(var_10_object); // 0x42 NEW_2
...
task_3_event_16(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1251(var_11_bool, var_12_object, var_13_string); // 0x148 NEW_2
...
Label_334:
	...
	func_1278(var_59_object, var_60_string); // 0x151 NEW_2
...
task_4_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1251(var_11_bool, var_12_object, var_13_string); // 0x197 NEW_2
...
Label_413:
	...
	func_1278(var_61_object, var_62_string); // 0x1a0 NEW_2
...
task_5_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_string)
{
	...
	func_1251(var_11_bool, var_12_object, var_13_string); // 0x297 NEW_2
...
Label_669:
	...
	func_1278(var_61_object, var_62_string); // 0x2a0 NEW_2
...
task_5_event_0(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object)
{
	...
	func_1328(var_10_object); // 0x2b6 NEW_2
...
{
	var_10_object = Obj(); // 0x51e PushV
	var_10_object = var_9_object; // 0x51f Mov
	func_1244(); // 0x520 NEW_2
...
{
	var_9_object = Obj(); // 0x54a PushV
	func_1097(var_9_object); // 0x54b NEW_2
	RemoveActor(var_9_object); // 0x54d Func
...
func_1315(var_97_object)
{
	var_98_float = 0; var_99_float = 0; // 0x523 PushV
	var_100_float = 0; var_101_object = Obj(); var_102_float = 0; var_103_int = 0; // 0x524 PushV
	var_101_object = var_97_object; // 0x525 Mov
	var_102_float = 0.025; // 0x526 MovF
	var_103_int = 0; // 0x527 MovI
	func_918(var_100_float, var_101_object, var_102_float, var_103_int); // 0x528 NEW_2
	var_99_float = var_100_float; // 0x529 Mov
	var_162_int = 7; // 0x52b PushI
	var_163_float = 0.025; // 0x52c PushF
	ReportHit(var_97_object, var_162_int, var_99_float, var_163_float); // 0x52d Func
...
func_1191()
{
	var_84_object = Obj(); var_85_object = Obj(); // 0x4a7 PushV
	GetScene(var_85_object); // 0x4a8 Func
	var_86_string = "battle"; // 0x4aa PushS
	var_87_object = Obj(); // 0x4ab PushV
	func_1097(var_87_object); // 0x4ac NEW_2
	BroadcastMessage(var_86_string, var_87_object, var_85_object); // 0x4ae Func
...
{
	var_11_object = Obj(); var_12_float = 0; var_13_object = Obj(); var_14_float = 0; // 0x530 PushV
	CreateInvItem(var_13_object); // 0x531 Func
	var_15_string = "rat"; // 0x533 PushS
	SetItemName(var_15_string); // 0x534 ObjFunc
	var_16_float = 0.25; // 0x536 PushF
	var_17_float = 0.5; // 0x537 PushF
	rand(var_14_float, var_16_float, var_17_float); // 0x538 Func
	var_18_string = "quality"; // 0x53a PushS
	SetProperty(var_18_string, var_14_float); // 0x53b ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x53d PushV
	var_19_object = var_10_object; // 0x53e Mov
	var_20_object = var_13_object; // 0x53f Mov
	var_21_int = 1; // 0x540 MovI
	func_1155(var_20_object, var_21_int); // 0x541 NEW_2
	var_35_object = Obj(); // 0x543 PushV
	func_1097(var_35_object); // 0x544 NEW_2
	RemoveActor(var_35_object); // 0x546 Func
...
func_1202(var_67_bool, var_68_object)
{
	var_69_bool = 0; var_70_object = Obj(); // 0x4b3 PushV
	var_70_object = var_68_object; // 0x4b4 Mov
	func_1032(var_69_bool, var_70_object); // 0x4b5 NEW_2
	var_71_bool = var_69_bool == 0; // 0x4b7 Not
	if(var_71_bool == 0) goto Label_1211; // 0x4b8 JumpB
	var_67_bool = 0; // 0x4b9 MovB
	return 0; // 0x4ba Return
	
Label_1211:
	var_72_bool = 0; var_73_object = Obj(); // 0x4bb PushV
	var_73_object = var_68_object; // 0x4bc Mov
	func_901(var_72_bool, var_73_object); // 0x4bd NEW_2
	var_67_bool = var_72_bool; // 0x4be Mov
...
{
	var_12_bool = 0; var_13_object = Obj(); // 0x4c2 PushV
	var_13_object = var_11_object; // 0x4c3 Mov
	func_1202(var_12_bool, var_13_object); // 0x4c4 NEW_2
	var_10_bool = var_12_bool; // 0x4c5 Mov
...
{
	var_54_object = Obj(); // 0x4c9 PushV
	var_54_object = var_53_object; // 0x4ca Mov
	TaskCall(3); // 0x4cb TaskCall
	func_228(var_53_object, var_55_object, var_54_object); // 0x4cc NEW_2
...
{
	var_46_object = Obj(); // 0x4d3 PushV
	var_46_object = var_45_object; // 0x4d4 Mov
	TaskCall(3); // 0x4d5 TaskCall
	func_228(var_45_object, var_47_object, var_46_object); // 0x4d6 NEW_2
	TaskReturn(); // 0x4d7 TaskReturn
	ResetAAS(); // 0x4d9 Func
...
func_1244()
{
	TaskCall(2); // 0x4de TaskCall
	func_179(); // 0x4df NEW_2
...
{
	var_14_float = 0; var_15_bool = 0; var_16_float = 0; var_17_bool = 0; // 0x4e3 PushV
	var_18_string = "health"; // 0x4e4 PushS
	var_19_bool = var_13_string == var_18_string; // 0x4e5 Eq
	if(var_19_bool == 0) goto Label_1276; // 0x4e6 JumpB
	var_20_string = "health"; // 0x4e7 PushS
	GetProperty(var_20_string, var_16_float); // 0x4e8 Func
	var_21_float = GlobalVars[0]; // 0x4ea PushGE
	var_17_bool = var_16_float < var_21_float; // 0x4eb LT2
	var_22_float = GlobalVars[0]; // 0x4ec PushGE
	var_22_float = var_16_float; // 0x4ed Mov
	GlobalVars[0] = var_22_float; // 0x4ee PopGE
	var_23_bool = 0; // 0x4ef PushV
	var_23_bool = 0; // 0x4f0 MovB
	var_24_bool = var_17_bool; // 0x4f1 Push
	if(var_24_bool == 0) goto Label_1273; // 0x4f2 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x4f3 PushV
	var_26_object = var_12_object; // 0x4f4 Mov
	func_1032(var_25_bool, var_26_object); // 0x4f5 NEW_2
	if(var_25_bool == 0) goto Label_1273; // 0x4f7 JumpB
	var_23_bool = 1; // 0x4f8 MovB
	
Label_1273:
	if(var_23_bool == 0) goto Label_1276; // 0x4f9 JumpB
	var_11_bool = 1; // 0x4fa MovB
...
Label_236:
	...
	func_1202(var_67_bool, var_68_object); // 0xee NEW_2
...
Label_277:
	...
	func_1315(var_97_object); // 0x122 NEW_2
...
{
	var_63_float = 0; var_64_float = 0; // 0x4fe PushV
	var_65_string = "health"; // 0x4ff PushS
	var_66_bool = var_62_string == var_65_string; // 0x500 Eq
	if(var_66_bool == 0) goto Label_1308; // 0x501 JumpB
	var_67_string = "health"; // 0x502 PushS
	GetProperty(var_67_string, var_64_float); // 0x503 Func
	var_68_int = 0; // 0x505 PushI
	var_69_bool = var_64_float <= var_68_int; // 0x506 LE
	if(var_69_bool == 0) goto Label_1290; // 0x507 JumpB
	SignalDeath(var_61_object); // 0x508 Func
	
Label_1290:
	var_70_bool = 0; // 0x50a PushV
	var_70_bool = 0; // 0x50b MovB
	var_71_float = GlobalVars[0]; // 0x50c PushGE
	var_72_bool = var_64_float < var_71_float; // 0x50d LT
	if(var_72_bool == 0) goto Label_1301; // 0x50e JumpB
	var_73_bool = 0; var_74_object = Obj(); // 0x50f PushV
	var_74_object = var_61_object; // 0x510 Mov
	func_1032(var_73_bool, var_74_object); // 0x511 NEW_2
	if(var_73_bool == 0) goto Label_1301; // 0x513 JumpB
	var_70_bool = 1; // 0x514 MovB
	
Label_1301:
	if(var_70_bool == 0) goto Label_1308; // 0x515 JumpB
	var_75_object = Obj(); // 0x516 PushV
	var_75_object = var_61_object; // 0x517 Mov
	TaskCall(5); // 0x518 TaskCall
	func_607(var_79_object, var_75_object); // 0x519 NEW_2
