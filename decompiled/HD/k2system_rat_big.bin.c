task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1318(var_10_bool, var_11_object); // 0x14 NEW_2
	...
	func_1325(var_53_object); // 0x1c NEW_2
...
task_0_event_16(var_0_bool, var_1_bool, var_2_object, var_3_string, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1352(var_11_bool, var_12_object, var_13_string); // 0x23 NEW_2
...
Label_41:
	...
	func_1379(var_59_object, var_60_string); // 0x2c NEW_2
...
Label_55:
	...
	func_1335(var_45_object); // 0x3c NEW_2
...
task_0_event_0(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1439(var_10_object); // 0x42 NEW_2
...
task_3_event_16(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1352(var_11_bool, var_12_object, var_13_string); // 0x148 NEW_2
...
Label_334:
	...
	func_1379(var_59_object, var_60_string); // 0x151 NEW_2
...
task_4_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1352(var_11_bool, var_12_object, var_13_string); // 0x197 NEW_2
...
Label_413:
	...
	func_1379(var_61_object, var_62_string); // 0x1a0 NEW_2
...
task_5_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_string)
{
	...
	func_1352(var_11_bool, var_12_object, var_13_string); // 0x297 NEW_2
...
Label_669:
	...
	func_1379(var_61_object, var_62_string); // 0x2a0 NEW_2
...
task_5_event_0(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object)
{
	...
	func_1439(var_10_object); // 0x2b6 NEW_2
...
{
	var_10_object = Obj(); // 0x583 PushV
	var_10_object = var_9_object; // 0x584 Mov
	func_1345(); // 0x585 NEW_2
...
{
	var_9_object = Obj(); // 0x5b9 PushV
	func_1188(var_9_object); // 0x5ba NEW_2
	RemoveActor(var_9_object); // 0x5bc Func
...
{
	var_98_float = 0; var_99_float = 0; // 0x588 PushV
	var_100_float = 0; var_101_object = Obj(); var_102_float = 0; var_103_int = 0; // 0x589 PushV
	var_101_object = var_97_object; // 0x58a Mov
	var_102_float = 0.02; // 0x58b MovF
	var_103_int = 0; // 0x58c MovI
	func_940(var_100_float, var_101_object, var_102_float, var_103_int); // 0x58d NEW_2
	var_99_float = var_100_float; // 0x58e Mov
	var_162_int = 7; // 0x590 PushI
	var_163_float = 0.02; // 0x591 PushF
	ReportHit(var_97_object, var_162_int, var_99_float, var_163_float); // 0x592 Func
	var_164_float = 0; var_165_object = Obj(); var_166_float = 0; // 0x594 PushV
	var_165_object = var_97_object; // 0x595 Mov
	var_166_float = 0.05; // 0x596 MovF
	func_1013(var_164_float, var_165_object, var_166_float); // 0x597 NEW_2
	var_99_float = var_164_float; // 0x598 Mov
	var_218_int = 5; // 0x59a PushI
	var_219_float = 0.05; // 0x59b PushF
	ReportHit(var_97_object, var_218_int, var_99_float, var_219_float); // 0x59c Func
...
func_1292()
{
	var_84_object = Obj(); var_85_object = Obj(); // 0x50c PushV
	GetScene(var_85_object); // 0x50d Func
	var_86_string = "battle"; // 0x50f PushS
	var_87_object = Obj(); // 0x510 PushV
	func_1188(var_87_object); // 0x511 NEW_2
	BroadcastMessage(var_86_string, var_87_object, var_85_object); // 0x513 Func
...
func_1275(var_153_float)
{
	...
	var_156_int = 0; // 0x500 PushI
	var_157_bool = var_153_float < var_156_int; // 0x501 LT
	if(var_157_bool == 0) goto Label_1287; // 0x502 JumpB
	var_158_float = 0.7; // 0x503 PushF
	var_159_int = 500; // 0x504 PushI
	RumblePlay(var_158_float, var_159_int); // 0x505 Func
	
Label_1287:
	var_160_int = 15; // 0x507 PushI
	SendWorldWndMessage(var_160_int, var_155_object); // 0x508 Func
...
{
	var_190_float = 0; var_191_float = 0; // 0x396 PushV
	var_192_bool = 0; var_193_object = Obj(); var_194_string = ""; // 0x397 PushV
	var_193_object = var_185_object; // 0x398 Mov
	var_194_string = var_186_string; // 0x399 Mov
	func_906(var_192_bool, var_193_object, var_194_string); // 0x39a NEW_2
	var_195_bool = var_192_bool == 0; // 0x39c Not
	if(var_195_bool == 0) goto Label_928; // 0x39d JumpB
	var_184_bool = 0; // 0x39e MovB
	return 2; // 0x39f Return
	
Label_928:
	GetProperty(var_186_string, var_191_float); // 0x3a0 ObjFunc
	var_196_float = 0; var_197_float = 0; var_198_float = 0; var_199_float = 0; // 0x3a2 PushV
	var_197_float = var_191_float + var_187_float; // 0x3a3 Add2
	var_198_float = var_188_float; // 0x3a4 Mov
	var_199_float = var_189_float; // 0x3a5 Mov
	func_1215(var_196_float, var_197_float, var_198_float, var_199_float); // 0x3a6 NEW_2
	SetProperty(var_186_string, var_196_float); // 0x3a8 ObjFunc
	var_184_bool = 1; // 0x3aa MovB
...
{
	var_69_bool = 0; var_70_object = Obj(); // 0x518 PushV
	var_70_object = var_68_object; // 0x519 Mov
	func_1123(var_69_bool, var_70_object); // 0x51a NEW_2
	var_71_bool = var_69_bool == 0; // 0x51c Not
	if(var_71_bool == 0) goto Label_1312; // 0x51d JumpB
	var_67_bool = 0; // 0x51e MovB
	return 0; // 0x51f Return
	
Label_1312:
	var_72_bool = 0; var_73_object = Obj(); // 0x520 PushV
	var_73_object = var_68_object; // 0x521 Mov
	func_901(var_72_bool, var_73_object); // 0x522 NEW_2
	var_67_bool = var_72_bool; // 0x523 Mov
...
{
	var_11_object = Obj(); var_12_float = 0; var_13_object = Obj(); var_14_float = 0; // 0x59f PushV
	CreateInvItem(var_13_object); // 0x5a0 Func
	var_15_string = "rat_big"; // 0x5a2 PushS
	SetItemName(var_15_string); // 0x5a3 ObjFunc
	var_16_float = 0.5; // 0x5a5 PushF
	var_17_int = 1; // 0x5a6 PushI
	rand(var_14_float, var_16_float, var_17_int); // 0x5a7 Func
	var_18_string = "quality"; // 0x5a9 PushS
	SetProperty(var_18_string, var_14_float); // 0x5aa ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x5ac PushV
	var_19_object = var_10_object; // 0x5ad Mov
	var_20_object = var_13_object; // 0x5ae Mov
	var_21_int = 1; // 0x5af MovI
	func_1246(var_20_object, var_21_int); // 0x5b0 NEW_2
	var_35_object = Obj(); // 0x5b2 PushV
	func_1188(var_35_object); // 0x5b3 NEW_2
	RemoveActor(var_35_object); // 0x5b5 Func
	return 4; // 0x5b7 Return
}
...
{
	var_12_bool = 0; var_13_object = Obj(); // 0x527 PushV
	var_13_object = var_11_object; // 0x528 Mov
	func_1303(var_12_bool, var_13_object); // 0x529 NEW_2
	var_10_bool = var_12_bool; // 0x52a Mov
...
{
	var_54_object = Obj(); // 0x52e PushV
	var_54_object = var_53_object; // 0x52f Mov
	TaskCall(3); // 0x530 TaskCall
	func_228(var_53_object, var_55_object, var_54_object); // 0x531 NEW_2
	TaskReturn(); // 0x532 TaskReturn
	ResetAAS(); // 0x534 Func
...
Label_959:
	var_161_string = "armor"; // 0x3bf PushS
	GetProperty(var_161_string, var_110_int); // 0x3c0 ObjFunc
}
...
{
	var_46_object = Obj(); // 0x538 PushV
	var_46_object = var_45_object; // 0x539 Mov
	TaskCall(3); // 0x53a TaskCall
	func_228(var_45_object, var_47_object, var_46_object); // 0x53b NEW_2
	TaskReturn(); // 0x53c TaskReturn
	ResetAAS(); // 0x53e Func
...
func_1345()
{
	TaskCall(2); // 0x543 TaskCall
	func_179(); // 0x544 NEW_2
	TaskReturn(); // 0x545 TaskReturn
...
{
	var_14_float = 0; var_15_bool = 0; var_16_float = 0; var_17_bool = 0; // 0x548 PushV
	var_18_string = "health"; // 0x549 PushS
	var_19_bool = var_13_string == var_18_string; // 0x54a Eq
	if(var_19_bool == 0) goto Label_1377; // 0x54b JumpB
	var_20_string = "health"; // 0x54c PushS
	GetProperty(var_20_string, var_16_float); // 0x54d Func
	var_21_float = GlobalVars[0]; // 0x54f PushGE
	var_17_bool = var_16_float < var_21_float; // 0x550 LT2
	var_22_float = GlobalVars[0]; // 0x551 PushGE
	var_22_float = var_16_float; // 0x552 Mov
	GlobalVars[0] = var_22_float; // 0x553 PopGE
	var_23_bool = 0; // 0x554 PushV
	var_23_bool = 0; // 0x555 MovB
	var_24_bool = var_17_bool; // 0x556 Push
	if(var_24_bool == 0) goto Label_1374; // 0x557 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x558 PushV
	var_26_object = var_12_object; // 0x559 Mov
	func_1123(var_25_bool, var_26_object); // 0x55a NEW_2
	if(var_25_bool == 0) goto Label_1374; // 0x55c JumpB
	var_23_bool = 1; // 0x55d MovB
	
Label_1374:
	if(var_23_bool == 0) goto Label_1377; // 0x55e JumpB
	var_11_bool = 1; // 0x55f MovB
	return 4; // 0x560 Return
	
Label_1377:
	var_11_bool = 0; // 0x561 MovB
...
{
	var_244_bool = 0; var_245_bool = 0; var_246_object = Obj(); var_247_cvector = CVector(0,0,0); var_248_cvector = CVector(0,0,0); var_249_cvector = CVector(0,0,0); var_250_float = 0; var_251_object = Obj(); var_252_bool = 0; var_253_bool = 0; var_254_object = Obj(); var_255_cvector = CVector(0,0,0); var_256_cvector = CVector(0,0,0); var_257_cvector = CVector(0,0,0); var_258_float = 0; var_259_object = Obj(); // 0x1d1 PushV
	var_0_bool = 0; // 0x1d2 TMovB
	var_1_bool = var_238_object; // 0x1d3 TMov
	var_253_bool = var_242_bool; // 0x1d4 Mov
	
Label_469:
	var_260_bool = 0; var_261_object = Obj(); // 0x1d5 PushV
	var_261_object = var_238_object; // 0x1d6 Mov
	func_596(var_260_bool, var_261_object); // 0x1d7 NEW_2
	var_264_bool = var_260_bool == 0; // 0x1d9 Not
	if(var_264_bool == 0) goto Label_477; // 0x1da JumpB
	var_237_bool = 0; // 0x1db MovB
	return 16; // 0x1dc Return
	
Label_477:
	GetPosition(var_255_cvector); // 0x1dd ObjFunc
	GetPosition(var_256_cvector); // 0x1df Func
	var_257_cvector = var_255_cvector - var_256_cvector; // 0x1e1 Sub2
	var_258_float = var_257_cvector | var_257_cvector; // 0x1e2 Or2
	var_265_bool = 0; // 0x1e3 PushV
	var_265_bool = 0; // 0x1e4 MovB
	var_266_int = 0; // 0x1e5 PushI
	var_267_bool = var_240_float > var_266_int; // 0x1e6 GT
	if(var_267_bool == 0) goto Label_492; // 0x1e7 JumpB
	var_268_float = var_240_float * var_240_float; // 0x1e8 Mult
	var_269_bool = var_258_float > var_268_float; // 0x1e9 GT
	if(var_269_bool == 0) goto Label_492; // 0x1ea JumpB
	var_265_bool = 1; // 0x1eb MovB
	
Label_492:
	if(var_265_bool == 0) goto Label_497; // 0x1ec JumpB
	Stop(); // 0x1ed Func
	var_237_bool = 0; // 0x1ef MovB
	return 16; // 0x1f0 Return
	
Label_497:
	var_270_float = var_239_float * var_239_float; // 0x1f1 Mult
	var_271_bool = var_258_float > var_270_float; // 0x1f2 GT
	if(var_271_bool == 0) goto Label_559; // 0x1f3 JumpB
	GetPFPosition(var_255_cvector); // 0x1f4 ObjFunc
	FindPathTo(var_259_object, var_255_cvector); // 0x1f6 Func
	var_272_bool = var_259_object != 0; // 0x1f8 NullNeq
	if(var_272_bool == 0) goto Label_508; // 0x1f9 JumpB
	var_254_object = var_259_object; // 0x1fa Mov
	var_259_object = 0; // 0x1fb SetNull
	
Label_508:
	var_273_bool = var_254_object != 0; // 0x1fc NullNeq
	if(var_273_bool == 0) goto Label_541; // 0x1fd JumpB
	var_274_bool = var_253_bool; // 0x1fe Push
	if(var_274_bool == 0) goto Label_518; // 0x1ff JumpB
	var_253_bool = 0; // 0x200 MovB
	RotatePath(var_254_object, var_252_bool); // 0x201 Func
	var_275_bool = var_252_bool == 0; // 0x203 Not
	if(var_275_bool == 0) goto Label_518; // 0x204 JumpB
	goto Label_565; // 0x205 Jump
	
Label_565:
	var_237_bool = !var_0_bool; // 0x235 Not2
	return 16; // 0x236 Return
	
Label_518:
	var_276_int = 0; // 0x206 PushI
	var_277_float = 0.3; // 0x207 PushF
	SetTimer(var_276_int, var_277_float); // 0x208 Func
	var_278_string = ""; // 0x20a PushV
	func_603(var_278_string); // 0x20b NEW_2
	var_279_string = ""; // 0x20d PushV
	func_605(var_279_string); // 0x20e NEW_2
	FollowPath(var_254_object, var_241_bool, var_252_bool, var_278_string, var_279_string); // 0x210 Func
	var_280_bool = var_252_bool == 0; // 0x212 Not
	if(var_280_bool == 0) goto Label_539; // 0x213 JumpB
	var_281_bool = var_0_bool; // 0x214 PushT
	if(var_281_bool == 0) goto Label_537; // 0x215 JumpB
	var_254_object = 0; // 0x216 SetNull
...
Label_539:
	var_254_object = 0; // 0x21b SetNull
	goto Label_557; // 0x21c Jump
	
Label_557:
	var_259_object = 0; // 0x22d SetNull
	goto Label_563; // 0x22e Jump
	
Label_563:
	var_254_object = 0; // 0x233 SetNull
	
Label_541:
	var_282_int = 0; // 0x21d PushI
	KillTimer(var_282_int); // 0x21e Func
	var_283_float = 0.5; // 0x220 PushF
	Sleep(var_283_float, var_252_bool); // 0x221 Func
	var_284_bool = var_252_bool == 0; // 0x223 Not
	if(var_284_bool == 0) goto Label_553; // 0x224 JumpB
	var_285_bool = var_0_bool; // 0x225 PushT
	if(var_285_bool == 0) goto Label_553; // 0x226 JumpB
	var_254_object = 0; // 0x227 SetNull
	goto Label_565; // 0x228 Jump
	
Label_553:
	var_286_int = 0; // 0x229 PushI
	var_287_float = 0.3; // 0x22a PushF
	SetTimer(var_286_int, var_287_float); // 0x22b Func
	
Label_559:
	var_288_int = 0; // 0x22f PushI
	KillTimer(var_288_int); // 0x230 Func
...
{
	var_278_string = "walk"; // 0x25b MovS
...
{
	var_63_float = 0; var_64_float = 0; // 0x563 PushV
	var_65_string = "health"; // 0x564 PushS
	var_66_bool = var_62_string == var_65_string; // 0x565 Eq
	if(var_66_bool == 0) goto Label_1409; // 0x566 JumpB
	var_67_string = "health"; // 0x567 PushS
	GetProperty(var_67_string, var_64_float); // 0x568 Func
	var_68_int = 0; // 0x56a PushI
	var_69_bool = var_64_float <= var_68_int; // 0x56b LE
	if(var_69_bool == 0) goto Label_1391; // 0x56c JumpB
	SignalDeath(var_61_object); // 0x56d Func
	
Label_1391:
	var_70_bool = 0; // 0x56f PushV
	var_70_bool = 0; // 0x570 MovB
	var_71_float = GlobalVars[0]; // 0x571 PushGE
	var_72_bool = var_64_float < var_71_float; // 0x572 LT
	if(var_72_bool == 0) goto Label_1402; // 0x573 JumpB
	var_73_bool = 0; var_74_object = Obj(); // 0x574 PushV
	var_74_object = var_61_object; // 0x575 Mov
	func_1123(var_73_bool, var_74_object); // 0x576 NEW_2
	if(var_73_bool == 0) goto Label_1402; // 0x578 JumpB
	var_70_bool = 1; // 0x579 MovB
	
Label_1402:
	if(var_70_bool == 0) goto Label_1409; // 0x57a JumpB
	var_75_object = Obj(); // 0x57b PushV
	var_75_object = var_61_object; // 0x57c Mov
	TaskCall(5); // 0x57d TaskCall
	func_607(var_79_object, var_75_object); // 0x57e NEW_2
...
Label_236:
	...
	func_1303(var_67_bool, var_68_object); // 0xee NEW_2
...
Label_277:
	...
	func_1416(var_97_object); // 0x122 NEW_2
	
Label_292:
	var_65_object = 0; // 0x124 SetNull
	
Label_293:
	var_220_bool = 0; // 0x125 PushB
	SetAttackState(var_220_bool); // 0x126 Func
	var_221_string = "all"; // 0x128 PushS
	var_222_string = "attack_end"; // 0x129 PushS
	PlayAnimation(var_221_string, var_222_string); // 0x12a Func
	WaitForAnimEnd(var_59_bool); // 0x12c Func
	var_223_bool = var_59_bool == 0; // 0x12e Not
	if(var_223_bool == 0) goto Label_305; // 0x12f JumpB
...
Label_306:
	...
	var_224_bool = 0; var_225_object = Obj(); var_226_float = 0; // 0x134 PushV
	var_225_object = var_0_bool; // 0x135 MovT
	var_226_float = var_58_float; // 0x136 Mov
	TaskCall(4); // 0x137 TaskCall
	func_370(var_224_bool, var_225_object, var_226_float); // 0x138 NEW_2
	TaskReturn(); // 0x139 TaskReturn
	var_290_bool = var_227_bool == 0; // 0x13b Not
	if(var_290_bool == 0) goto Label_318; // 0x13c JumpB
...
{
	var_215_object = Obj(); var_216_object = Obj(); // 0x4f1 PushV
	CreateFloatVector(var_216_object); // 0x4f2 Func
	add(var_214_float); // 0x4f4 ObjFunc
	var_217_int = 14; // 0x4f6 PushI
	SendWorldWndMessage(var_217_int, var_216_object); // 0x4f7 Func
...
{
	var_229_bool = 0; var_230_bool = 0; // 0x172 PushV
	func_389(); // 0x174 NEW_2
	var_237_bool = 0; var_238_object = Obj(); var_239_float = 0; var_240_float = 0; var_241_bool = 0; var_242_bool = 0; // 0x176 PushV
	var_238_object = var_225_object; // 0x177 Mov
	var_243_float = 0.9; // 0x178 PushF
	var_239_float = var_226_float * var_243_float; // 0x179 Mult2
	var_240_float = 5000; // 0x17a MovI
	var_241_bool = 1; // 0x17b MovB
	var_242_bool = 1; // 0x17c MovB
	func_465(var_229_bool, var_230_bool, var_237_bool, var_238_object, var_239_float, var_240_float, var_241_bool, var_242_bool); // 0x17d NEW_2
	var_230_bool = var_237_bool; // 0x17e Mov
	func_399(); // 0x181 NEW_2
	var_224_bool = var_230_bool; // 0x183 Mov
...
{
	var_167_float = 0; var_168_float = 0; var_169_float = 0; var_170_float = 0; // 0x3f5 PushV
	var_171_bool = 0; var_172_object = Obj(); var_173_string = ""; // 0x3f6 PushV
	var_172_object = var_165_object; // 0x3f7 Mov
	var_173_string = "disease"; // 0x3f8 MovS
	func_906(var_171_bool, var_172_object, var_173_string); // 0x3f9 NEW_2
	var_174_bool = var_171_bool == 0; // 0x3fb Not
	if(var_174_bool == 0) goto Label_1023; // 0x3fc JumpB
	var_164_float = 0; // 0x3fd MovI
	return 4; // 0x3fe Return
	
Label_1023:
	var_169_float = 0; // 0x3ff MovI
	var_175_bool = 0; var_176_object = Obj(); var_177_string = ""; // 0x400 PushV
	var_176_object = var_165_object; // 0x401 Mov
	var_177_string = "armor_disease"; // 0x402 MovS
	func_906(var_175_bool, var_176_object, var_177_string); // 0x403 NEW_2
	if(var_175_bool == 0) goto Label_1035; // 0x405 JumpB
	var_178_string = "armor_disease"; // 0x406 PushS
	GetProperty(var_178_string, var_169_float); // 0x407 ObjFunc
	var_179_int = 100; // 0x409 PushI
	var_169_float = var_169_float / var_169_float; // 0x40a Div2
	
Label_1035:
	var_180_bool = 0; var_181_object = Obj(); var_182_string = ""; // 0x40b PushV
	var_181_object = var_165_object; // 0x40c Mov
	var_182_string = "immunity"; // 0x40d MovS
	func_906(var_180_bool, var_181_object, var_182_string); // 0x40e NEW_2
	if(var_180_bool == 0) goto Label_1053; // 0x410 JumpB
	var_183_string = "immunity"; // 0x411 PushS
	GetProperty(var_183_string, var_170_float); // 0x412 ObjFunc
	var_169_float = var_169_float + var_170_float; // 0x414 Add2
	var_184_bool = 0; var_185_object = Obj(); var_186_string = ""; var_187_float = 0; var_188_float = 0; var_189_float = 0; // 0x415 PushV
	var_185_object = var_165_object; // 0x416 Mov
	var_186_string = "immunity"; // 0x417 MovS
	var_187_float = -var_166_float; // 0x418 Neg2
	var_188_float = 0; // 0x419 MovI
	var_189_float = 1; // 0x41a MovI
	func_918(var_184_bool, var_185_object, var_186_string, var_187_float, var_188_float, var_189_float); // 0x41b NEW_2
	
Label_1053:
	var_200_int = 1; // 0x41d PushI
	var_201_bool = var_169_float >= var_200_int; // 0x41e GE
	if(var_201_bool == 0) goto Label_1058; // 0x41f JumpB
	var_164_float = 0.0; // 0x420 MovF
	return 4; // 0x421 Return
	
Label_1058:
	var_202_int = 1; // 0x422 PushI
	var_203_int = var_202_int - var_169_float; // 0x423 Sub
	var_204_int = 2; // 0x424 PushI
	var_205_float = var_203_int / var_204_int; // 0x425 Div
	var_166_float = var_166_float * var_205_float; // 0x426 Mult2
	var_206_bool = 0; var_207_object = Obj(); var_208_string = ""; var_209_float = 0; var_210_float = 0; var_211_float = 0; // 0x427 PushV
	var_207_object = var_165_object; // 0x428 Mov
	var_208_string = "disease"; // 0x429 MovS
	var_209_float = var_166_float; // 0x42a Mov
	var_210_float = 0; // 0x42b MovI
	var_211_float = 1; // 0x42c MovI
	func_918(var_206_bool, var_207_object, var_208_string, var_209_float, var_210_float, var_211_float); // 0x42d NEW_2
	var_212_bool = 0; var_213_object = Obj(); // 0x42f PushV
	var_213_object = var_165_object; // 0x430 Mov
	func_901(var_212_bool, var_213_object); // 0x431 NEW_2
	if(var_212_bool == 0) goto Label_1080; // 0x433 JumpB
	var_214_float = 0; // 0x434 PushV
	var_214_float = var_166_float; // 0x435 Mov
	func_1265(var_214_float); // 0x436 NEW_2
	
Label_1080:
	var_164_float = var_166_float; // 0x438 Mov
