...
task_1_event_17(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2111(var_18_bool, var_19_object); // 0xba NEW_2
	...
	func_2118(var_55_object); // 0xc2 NEW_2
...
task_3_event_7(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool, var_17_int)
{
	...
	func_1991(var_20_object); // 0x467 NEW_2
...
task_4_event_0(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool, var_17_object)
{
	...
	func_2041(var_21_object); // 0x54c NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; // 0x826 PushV
	var_21_object = var_17_object; // 0x827 Mov
	var_22_int = var_18_int; // 0x828 Mov
	var_23_float = var_19_float; // 0x829 Mov
	func_1737(var_21_object, var_22_int, var_23_float); // 0x82a NEW_2
...
{
	var_23_object = Obj(); var_24_int = 0; var_25_float = 0; var_26_cvector = CVector(0,0,0); var_27_cvector = CVector(0,0,0); // 0x82e PushV
	var_23_object = var_17_object; // 0x82f Mov
	var_24_int = var_18_int; // 0x830 Mov
	var_25_float = var_19_float; // 0x831 Mov
	var_26_cvector = var_21_cvector; // 0x832 Mov
	var_27_cvector = var_22_cvector; // 0x833 Mov
	func_1805(var_25_float, var_26_cvector, var_27_cvector); // 0x834 NEW_2
...
{
	var_18_object = Obj(); // 0x83a PushV
	var_18_object = var_17_object; // 0x83b Mov
	func_2064(var_18_object); // 0x83c NEW_2
...
func_2054()
{
	var_61_object = Obj(); var_62_object = Obj(); // 0x806 PushV
	GetScene(var_62_object); // 0x807 Func
	var_63_object = Obj(); // 0x809 PushV
	func_1887(var_63_object); // 0x80a NEW_2
	RemoveStationaryActor(var_63_object); // 0x80c ObjFunc
...
{
	var_19_bool = 0; var_20_object = Obj(); // 0x811 PushV
	var_20_object = var_18_object; // 0x812 Mov
	func_1516(var_19_bool, var_20_object); // 0x813 NEW_2
	if(var_19_bool == 0) goto Label_2075; // 0x815 JumpB
	var_23_bool = 0; var_24_object = Obj(); var_25_float = 0; // 0x816 PushV
	var_24_object = var_18_object; // 0x817 Mov
	var_25_float = -0.1; // 0x818 MovF
	func_1929(var_23_bool, var_24_object, var_25_float); // 0x819 NEW_2
	
Label_2075:
	func_2054(); // 0x81c NEW_2
	var_66_object = Obj(); // 0x81e PushV
	var_66_object = var_18_object; // 0x81f Mov
	TaskCall(4); // 0x820 TaskCall
	func_1328(var_66_object); // 0x821 NEW_2
...
Label_1574:
	var_471_string = "armor"; // 0x626 PushS
	GetProperty(var_471_string, var_420_int); // 0x627 ObjFunc
}
...
func_1052(var_0_int)
{
	...
	func_1991(var_131_object); // 0x41e NEW_2
...
func_1072(var_2_bool, var_138_bool, var_139_object, var_140_float, var_141_float, var_142_bool, var_143_bool)
{
	...
	func_1991(var_151_object); // 0x433 NEW_2
...
{
	var_20_bool = 0; var_21_object = Obj(); // 0x840 PushV
	var_21_object = var_19_object; // 0x841 Mov
	func_1669(var_20_bool, var_21_object); // 0x842 NEW_2
	var_18_bool = var_20_bool; // 0x843 Mov
...
{
	var_56_object = Obj(); var_57_bool = 0; // 0x847 PushV
	var_56_object = var_55_object; // 0x848 Mov
	var_57_bool = 1; // 0x849 MovB
	TaskCall(2); // 0x84a TaskCall
	func_384(var_56_object, var_57_bool); // 0x84b NEW_2
...
Label_102:
	...
	func_2018(var_43_int); // 0x67 NEW_2
...
Label_117:
	...
	func_2011(var_65_string, var_66_int); // 0x83 NEW_2
...
func_674(var_0_int, var_393_float, var_394_int)
{
	...
	var_472_int = 0; // 0x2bd PushV
	func_1057(var_472_int); // 0x2be NEW_2
	ReportHit(var_0_int, var_472_int, var_400_float, var_399_float); // 0x2c0 Func
	var_473_object = Obj(); var_474_float = 0; // 0x2c2 PushV
	var_473_object = var_398_object; // 0x2c3 Mov
	var_474_float = var_400_float; // 0x2c4 Mov
...
Label_749:
	...
	var_475_string = "all"; // 0x2f2 PushS
	var_476_string = "attack_middle"; // 0x2f3 PushS
	var_477_int = var_476_string + var_362_int; // 0x2f4 Add
	HasAnimation(var_363_bool, var_475_string, var_477_int); // 0x2f5 Func
	var_478_bool = var_363_bool; // 0x2f7 Push
	if(var_478_bool == 0) goto Label_830; // 0x2f8 JumpB
	func_2000(); // 0x2fa NEW_2
	var_479_string = "all"; // 0x2fc PushS
	var_480_string = "attack_middle"; // 0x2fd PushS
	var_481_int = var_480_string + var_362_int; // 0x2fe Add
	PlayAnimation(var_479_string, var_481_int); // 0x2ff Func
	WaitForAnimEnd(); // 0x301 Func
	func_1052(var_365_string); // 0x304 NEW_2
	var_482_bool = 0; var_483_object = Obj(); // 0x306 PushV
	var_483_object = var_0_int; // 0x307 MovT
	func_1669(var_482_bool, var_483_object); // 0x308 NEW_2
	var_484_bool = var_482_bool == 0; // 0x30a Not
	if(var_484_bool == 0) goto Label_784; // 0x30b JumpB
	StopAsync(); // 0x30c Func
	var_356_bool = 0; // 0x30e MovB
	return 8; // 0x30f Return
	
Label_784:
	var_485_float = 0; var_486_int = 0; // 0x310 PushV
	var_485_float = var_357_float; // 0x311 Mov
	var_486_int = var_362_int; // 0x312 Mov
	func_674(var_365_string, var_485_float, var_486_int); // 0x313 NEW_2
	var_364_int = 1; // 0x315 MovI
	
Label_790:
	var_487_string = "attack_middle"; // 0x316 PushS
	var_488_int = var_487_string + var_362_int; // 0x317 Add
	var_489_string = "_"; // 0x318 PushS
	var_490_int = var_488_int + var_489_string; // 0x319 Add
	var_365_string = var_490_int + var_364_int; // 0x31a Add2
	var_491_string = "all"; // 0x31b PushS
	HasAnimation(var_363_bool, var_491_string, var_365_string); // 0x31c Func
	var_492_bool = var_363_bool == 0; // 0x31e Not
	if(var_492_bool == 0) goto Label_801; // 0x31f JumpB
	goto Label_830; // 0x320 Jump
	
Label_830:
	var_493_bool = 0; // 0x33e PushB
	SetAttackState(var_493_bool); // 0x33f Func
	var_494_string = "all"; // 0x341 PushS
	var_495_string = "attack_end"; // 0x342 PushS
	var_496_int = var_495_string + var_362_int; // 0x343 Add
	PlayAnimation(var_494_string, var_496_int); // 0x344 Func
	var_497_bool = 0; // 0x346 PushV
	func_1066(var_497_bool); // 0x347 NEW_2
	if(var_497_bool == 0) goto Label_848; // 0x349 JumpB
	var_498_bool = 0; var_499_float = 0; // 0x34a PushV
	var_499_float = 0.75; // 0x34b MovF
	func_850(var_498_bool, var_499_float); // 0x34c NEW_2
...
Label_801:
	func_2000(); // 0x322 NEW_2
	var_507_string = "all"; // 0x324 PushS
	PlayAnimation(var_507_string, var_365_string); // 0x325 Func
	WaitForAnimEnd(); // 0x327 Func
	func_1052(var_365_string); // 0x32a NEW_2
	var_508_bool = 0; var_509_object = Obj(); // 0x32c PushV
	var_509_object = var_0_int; // 0x32d MovT
	func_1669(var_508_bool, var_509_object); // 0x32e NEW_2
	var_510_bool = var_508_bool == 0; // 0x330 Not
	if(var_510_bool == 0) goto Label_822; // 0x331 JumpB
	StopAsync(); // 0x332 Func
	var_356_bool = 0; // 0x334 MovB
	return 8; // 0x335 Return
	
Label_822:
	var_511_float = 0; var_512_int = 0; // 0x336 PushV
	var_511_float = var_357_float; // 0x337 Mov
	var_512_int = var_362_int; // 0x338 Mov
	func_674(var_365_string, var_511_float, var_512_int); // 0x339 NEW_2
	var_513_int = 1; // 0x33b PushI
	var_364_int = var_364_int + var_513_int; // 0x33c Add2
...
{
	var_500_float = 0; var_501_bool = 0; var_502_float = 0; var_503_bool = 0; // 0x352 PushV
	rand(var_502_float); // 0x353 Func
	var_504_bool = var_502_float < var_499_float; // 0x355 LT
	if(var_504_bool == 0) goto Label_870; // 0x356 JumpB
	
Label_855:
	IsAnimationPlaying(var_503_bool); // 0x357 Func
	var_505_bool = var_503_bool == 0; // 0x359 Not
	if(var_505_bool == 0) goto Label_860; // 0x35a JumpB
...
Label_875:
	var_498_bool = 0; // 0x36b MovB
	return 4; // 0x36c Return
	
Label_860:
	var_506_bool = 0; // 0x35c PushV
	func_948(var_506_bool); // 0x35d NEW_2
	if(var_506_bool == 0) goto Label_866; // 0x35f JumpB
	var_498_bool = 1; // 0x360 MovB
...
Label_870:
	...
	func_1052(var_503_bool); // 0x369 NEW_2
}
...
Label_392:
	...
	var_530_int = 1; // 0x18e PushI
	Sleep(var_530_int); // 0x18f Func
...
Label_1950:
	...
	func_1981(var_30_float); // 0x7a0 NEW_2
...
Label_566:
	...
	var_514_string = "all"; // 0x238 PushS
	var_515_string = "fjump"; // 0x239 PushS
	PlayAnimation(var_514_string, var_515_string); // 0x23a Func
	WaitForAnimEnd(); // 0x23c Func
	func_1052(var_93_float); // 0x23f NEW_2
	var_516_cvector = CVector(0.0, 0.0, 0.0); // 0x241 PushVec
	SetSpeed(var_516_cvector); // 0x242 Func
	Stop(); // 0x244 Func
	StopAsync(); // 0x246 Func
	var_517_bool = 0; // 0x248 PushV
	func_1009(var_93_float, var_517_bool); // 0x249 NEW_2
	var_518_bool = var_517_bool == 0; // 0x24b Not
	if(var_518_bool == 0) goto Label_612; // 0x24c JumpB
	var_519_bool = 0; var_520_object = Obj(); // 0x24d PushV
	var_520_object = var_0_int; // 0x24e MovT
	func_1669(var_519_bool, var_520_object); // 0x24f NEW_2
	var_521_bool = var_519_bool == 0; // 0x251 Not
	if(var_521_bool == 0) goto Label_596; // 0x252 JumpB
...
Label_596:
	...
	var_522_float = var_71_float * var_71_float; // 0x25a Mult
	var_523_bool = var_90_float < var_522_float; // 0x25b LT
	if(var_523_bool == 0) goto Label_612; // 0x25c JumpB
	var_524_bool = 0; var_525_float = 0; // 0x25d PushV
	var_525_float = var_71_float; // 0x25e Mov
	func_713(var_93_float, var_524_bool, var_525_float); // 0x25f NEW_2
	var_526_bool = var_524_bool == 0; // 0x261 Not
	if(var_526_bool == 0) goto Label_612; // 0x262 JumpB
	goto Label_622; // 0x263 Jump
	
Label_613:
	var_527_bool = 0; var_528_float = 0; // 0x265 PushV
	var_528_float = var_71_float; // 0x266 Mov
	func_713(var_93_float, var_527_bool, var_528_float); // 0x267 NEW_2
	var_529_bool = var_527_bool == 0; // 0x269 Not
	if(var_529_bool == 0) goto Label_620; // 0x26a JumpB
...
func_1964(var_463_float)
{
	...
	var_466_int = 0; // 0x7b1 PushI
	var_467_bool = var_463_float < var_466_int; // 0x7b2 LT
	if(var_467_bool == 0) goto Label_1976; // 0x7b3 JumpB
	var_468_float = 0.7; // 0x7b4 PushF
	var_469_int = 500; // 0x7b5 PushI
	RumblePlay(var_468_float, var_469_int); // 0x7b6 Func
	
Label_1976:
	var_470_int = 15; // 0x7b8 PushI
	SendWorldWndMessage(var_470_int, var_465_object); // 0x7b9 Func
...
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x7bd PushV
	CreateFloatVector(var_32_object); // 0x7be Func
	add(var_30_float); // 0x7c0 ObjFunc
	var_33_int = 16; // 0x7c2 PushI
	SendWorldWndMessage(var_33_int, var_32_object); // 0x7c3 Func
...
{
	var_21_bool = 0; var_22_bool = 0; // 0x7c7 PushV
	IsPlayerActor(var_20_object, var_22_bool); // 0x7c8 Func
	var_23_bool = var_22_bool; // 0x7ca Push
	if(var_23_bool == 0) goto Label_1999; // 0x7cb JumpB
	var_24_string = "attack"; // 0x7cc PushS
	PlayGlobalMusic(var_24_string); // 0x7cd Func
...
func_2000()
{
	var_368_object = Obj(); var_369_object = Obj(); // 0x7d0 PushV
	GetScene(var_369_object); // 0x7d1 Func
	var_370_string = "battle"; // 0x7d3 PushS
	var_371_object = Obj(); // 0x7d4 PushV
	func_1887(var_371_object); // 0x7d5 NEW_2
	BroadcastMessage(var_370_string, var_371_object, var_369_object); // 0x7d7 Func
...
{
	var_51_string = ""; var_52_string = ""; // 0x7db PushV
	var_52_string = "idle"; // 0x7dc MovS
	var_53_int = var_50_int; // 0x7dd Push
	if(var_53_int == 0) goto Label_2016; // 0x7de JumpB
	var_52_string = var_52_string + var_50_int; // 0x7df Add2
	
Label_2016:
	var_49_string = var_52_string; // 0x7e0 Mov
...
{
	var_44_int = 0; var_45_bool = 0; var_46_int = 0; var_47_bool = 0; // 0x7e2 PushV
	var_46_int = 0; // 0x7e3 MovI
	
Label_2020:
	var_48_string = "all"; // 0x7e4 PushS
	var_49_string = ""; var_50_int = 0; // 0x7e5 PushV
	var_50_int = var_46_int; // 0x7e6 Mov
	func_2011(var_49_string, var_50_int); // 0x7e7 NEW_2
	HasAnimation(var_47_bool, var_48_string, var_49_string); // 0x7e9 Func
	var_54_bool = var_47_bool == 0; // 0x7eb Not
	if(var_54_bool == 0) goto Label_2030; // 0x7ec JumpB
	goto Label_2033; // 0x7ed Jump
	
Label_2033:
	var_43_int = var_46_int; // 0x7f1 Mov
	return 4; // 0x7f2 Return
	
Label_2030:
	var_55_int = 1; // 0x7ee PushI
	var_46_int = var_46_int + var_55_int; // 0x7ef Add2
	goto Label_2020; // 0x7f0 Jump
}
...
{
	var_23_int = 0; var_24_int = 0; // 0x7f3 PushV
	var_25_string = "branch"; // 0x7f4 PushS
	GetVariable(var_25_string, var_24_int); // 0x7f5 Func
	var_22_int = var_24_int; // 0x7f7 Mov
...
{
	var_22_int = 0; // 0x7fa PushV
	func_2035(var_22_int); // 0x7fb NEW_2
	var_26_int = 1; // 0x7fd PushI
	var_27_bool = var_22_int == var_26_int; // 0x7fe Eq
	if(var_27_bool == 0) goto Label_2051; // 0x7ff JumpB
	WorkWithCorpse(var_21_object); // 0x800 Func
...
Label_2051:
	Barter(var_21_object); // 0x803 Func
}
