...
task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int)
{
	...
	func_2476(var_12_bool, var_13_object); // 0x10 NEW_2
	...
	func_2483(var_76_object); // 0x18 NEW_2
...
task_0_event_3(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int)
{
	...
	func_2463(var_12_bool, var_13_object); // 0x1e NEW_2
	...
	func_2470(var_76_object); // 0x26 NEW_2
...
Label_40:
	...
	func_2500(var_130_object); // 0x32 NEW_2
...
Label_53:
	...
	func_2524(var_145_object); // 0x3a NEW_2
...
task_0_event_30(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_bool, var_6_object, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int)
{
	...
	func_2603(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0x42 NEW_2
...
Label_201:
	...
	func_2500(var_130_object); // 0xd3 NEW_2
...
Label_214:
	...
	func_2524(var_145_object); // 0xdb NEW_2
...
task_1_event_30(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_bool, var_6_object, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int)
{
	...
	func_2603(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0xe3 NEW_2
...
task_2_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int)
{
	...
	func_2500(var_12_object); // 0x144 NEW_2
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int)
{
	...
	func_2603(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0x14c NEW_2
...
task_2_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_int, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int)
{
	...
	func_1924(var_14_object); // 0x186 NEW_2
...
task_3_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_object)
{
	...
	func_2500(var_12_object); // 0x260 NEW_2
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_object, var_12_object, var_13_bool)
{
	...
	func_2603(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0x268 NEW_2
...
task_4_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_object)
{
	...
	func_1974(var_15_object); // 0x52b NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0xa00 PushV
	var_15_object = var_11_object; // 0xa01 Mov
	var_16_int = var_12_int; // 0xa02 Mov
	var_17_float = var_13_float; // 0xa03 Mov
	func_1677(var_15_object, var_16_int, var_17_float); // 0xa04 NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0xa08 PushV
	var_17_object = var_11_object; // 0xa09 Mov
	var_18_int = var_12_int; // 0xa0a Mov
	var_19_float = var_13_float; // 0xa0b Mov
	var_20_cvector = var_15_cvector; // 0xa0c Mov
	var_21_cvector = var_16_cvector; // 0xa0d Mov
	func_1745(var_19_float, var_20_cvector, var_21_cvector); // 0xa0e NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0xa11 PushV
	var_15_string = "health"; // 0xa12 PushS
	var_16_bool = var_12_string == var_15_string; // 0xa13 Eq
	if(var_16_bool == 0) goto Label_2589; // 0xa14 JumpB
	var_17_string = "health"; // 0xa15 PushS
	GetProperty(var_17_string, var_14_float); // 0xa16 Func
	var_18_int = 0; // 0xa18 PushI
	var_19_bool = var_14_float <= var_18_int; // 0xa19 LE
	if(var_19_bool == 0) goto Label_2589; // 0xa1a JumpB
	SignalDeath(var_11_object); // 0xa1b Func
...
{
	var_13_string = "prc"; // 0xa1f PushS
	var_14_bool = var_12_string == var_13_string; // 0xa20 Eq
	if(var_14_bool == 0) goto Label_2596; // 0xa21 JumpB
	ResetAAS(); // 0xa22 Func
...
{
	var_12_object = Obj(); // 0xa26 PushV
	var_12_object = var_11_object; // 0xa27 Mov
	func_2539(var_12_object); // 0xa28 NEW_2
...
func_2059()
{
	var_26_int = 0; var_27_bool = 0; var_28_int = 0; var_29_int = 0; var_30_bool = 0; var_31_int = 0; // 0x80b PushV
	var_32_int = 0; // 0x80c PushI
	ClearSubContainer(var_32_int); // 0x80d Func
	var_33_int = 0; // 0x80f PushV
	func_1915(var_33_int); // 0x810 NEW_2
	var_31_int = var_33_int; // 0x811 Mov
	var_39_int = 0; var_40_int = 0; // 0x813 PushV
	var_39_int = 0; // 0x814 MovI
	var_41_int = 100; // 0x815 PushI
	var_42_int = 100; // 0x816 PushI
	var_43_float = var_31_int * var_42_int; // 0x817 Mult
	var_40_int = var_41_int + var_43_float; // 0x818 Add2
	func_1987(var_39_int, var_40_int); // 0x819 NEW_2
	var_61_string = ""; var_62_int = 0; var_63_int = 0; // 0x81b PushV
	var_61_string = "tourniquet"; // 0x81c MovS
	var_62_int = 1; // 0x81d MovI
	var_63_int = 7; // 0x81e MovI
	func_1786(var_61_string, var_62_int, var_63_int); // 0x81f NEW_2
	var_72_string = ""; var_73_int = 0; var_74_int = 0; // 0x821 PushV
	var_72_string = "bandage"; // 0x822 MovS
	var_73_int = 1; // 0x823 MovI
	var_74_int = 7; // 0x824 MovI
	func_1786(var_72_string, var_73_int, var_74_int); // 0x825 NEW_2
	var_75_string = ""; var_76_int = 0; var_77_int = 0; // 0x827 PushV
	var_75_string = "packet"; // 0x828 MovS
	var_76_int = 1; // 0x829 MovI
	var_77_int = 10; // 0x82a MovI
	func_1786(var_75_string, var_76_int, var_77_int); // 0x82b NEW_2
	var_78_string = ""; var_79_int = 0; var_80_int = 0; // 0x82d PushV
	var_78_string = "bottle_water"; // 0x82e MovS
	var_79_int = 1; // 0x82f MovI
	var_80_int = 3; // 0x830 MovI
	func_1786(var_78_string, var_79_int, var_80_int); // 0x831 NEW_2
	var_81_string = ""; var_82_int = 0; var_83_int = 0; var_84_int = 0; // 0x833 PushV
	var_81_string = "rusk"; // 0x834 MovS
	var_82_int = 1; // 0x835 MovI
	var_83_int = 3; // 0x836 MovI
	var_84_int = 4; // 0x837 MovI
	func_1797(var_81_string, var_82_int, var_83_int, var_84_int); // 0x838 NEW_2
	var_95_string = ""; var_96_int = 0; var_97_int = 0; // 0x83a PushV
	var_95_string = "hook"; // 0x83b MovS
	var_96_int = 1; // 0x83c MovI
	var_97_int = 20; // 0x83d MovI
	func_1786(var_95_string, var_96_int, var_97_int); // 0x83e NEW_2
	var_98_string = ""; var_99_int = 0; var_100_int = 0; // 0x840 PushV
	var_98_string = "watch"; // 0x841 MovS
	var_99_int = 1; // 0x842 MovI
	var_100_int = 20; // 0x843 MovI
	func_1786(var_98_string, var_99_int, var_100_int); // 0x844 NEW_2
	var_101_bool = 0; // 0x846 PushV
	var_101_bool = 0; // 0x847 MovB
	var_102_int = 3; // 0x848 PushI
	var_103_bool = var_31_int >= var_102_int; // 0x849 GE
	if(var_103_bool == 0) goto Label_2127; // 0x84a JumpB
	var_104_int = 6; // 0x84b PushI
	var_105_bool = var_31_int < var_104_int; // 0x84c LT
	if(var_105_bool == 0) goto Label_2127; // 0x84d JumpB
	var_101_bool = 1; // 0x84e MovB
	
Label_2127:
	if(var_101_bool == 0) goto Label_2135; // 0x84f JumpB
	var_106_string = ""; var_107_int = 0; var_108_int = 0; var_109_int = 0; // 0x850 PushV
	var_106_string = "alpha_pills"; // 0x851 MovS
	var_107_int = 1; // 0x852 MovI
	var_108_int = 2; // 0x853 MovI
	var_109_int = 3; // 0x854 MovI
	func_1797(var_106_string, var_107_int, var_108_int, var_109_int); // 0x855 NEW_2
	
Label_2135:
	var_110_int = 4; // 0x857 PushI
	var_111_bool = var_31_int >= var_110_int; // 0x858 GE
	if(var_111_bool == 0) goto Label_2145; // 0x859 JumpB
	var_112_string = ""; var_113_int = 0; var_114_int = 0; var_115_int = 0; // 0x85a PushV
	var_112_string = "beta_pills"; // 0x85b MovS
	var_113_int = 1; // 0x85c MovI
	var_114_int = 4; // 0x85d MovI
	var_115_int = 3; // 0x85e MovI
	func_1797(var_112_string, var_113_int, var_114_int, var_115_int); // 0x85f NEW_2
	
Label_2145:
	var_116_int = 6; // 0x861 PushI
	var_117_bool = var_31_int >= var_116_int; // 0x862 GE
	if(var_117_bool == 0) goto Label_2162; // 0x863 JumpB
	var_118_string = ""; var_119_int = 0; var_120_int = 0; var_121_int = 0; // 0x864 PushV
	var_118_string = "alpha_pills"; // 0x865 MovS
	var_119_int = 1; // 0x866 MovI
	var_120_int = 2; // 0x867 MovI
	var_121_int = 8; // 0x868 MovI
	func_1797(var_118_string, var_119_int, var_120_int, var_121_int); // 0x869 NEW_2
	var_122_string = ""; var_123_int = 0; var_124_int = 0; var_125_int = 0; // 0x86b PushV
	var_122_string = "gamma_pills"; // 0x86c MovS
	var_123_int = 1; // 0x86d MovI
	var_124_int = 8; // 0x86e MovI
	var_125_int = 3; // 0x86f MovI
	func_1797(var_122_string, var_123_int, var_124_int, var_125_int); // 0x870 NEW_2
	
Label_2162:
	var_126_int = 8; // 0x872 PushI
	var_127_bool = var_31_int >= var_126_int; // 0x873 GE
	if(var_127_bool == 0) goto Label_2177; // 0x874 JumpB
	var_128_string = ""; var_129_int = 0; var_130_int = 0; // 0x875 PushV
	var_128_string = "revolver_ammo"; // 0x876 MovS
	var_129_int = 1; // 0x877 MovI
	var_130_int = 3; // 0x878 MovI
	func_1786(var_128_string, var_129_int, var_130_int); // 0x879 NEW_2
	var_131_string = ""; var_132_int = 0; var_133_int = 0; // 0x87b PushV
	var_131_string = "rifle_ammo"; // 0x87c MovS
	var_132_int = 1; // 0x87d MovI
	var_133_int = 3; // 0x87e MovI
	func_1786(var_131_string, var_132_int, var_133_int); // 0x87f NEW_2
	
Label_2177:
	var_134_int = 0; var_135_string = ""; // 0x881 PushV
	var_135_string = "patrol_mark"; // 0x882 MovS
	func_2315(var_134_int, var_135_string); // 0x883 NEW_2
	var_136_int = 0; // 0x885 PushI
	var_137_int = 1; // 0x886 PushI
	AddItem(var_30_bool, var_134_int, var_136_int, var_137_int); // 0x887 Func
	return 6; // 0x889 Return
}
...
{
	var_584_float = 0; var_585_bool = 0; var_586_float = 0; var_587_bool = 0; // 0x423 PushV
	rand(var_586_float); // 0x424 Func
	var_588_bool = var_586_float < var_583_float; // 0x426 LT
	if(var_588_bool == 0) goto Label_1079; // 0x427 JumpB
	
Label_1064:
	IsAnimationPlaying(var_587_bool); // 0x428 Func
	var_589_bool = var_587_bool == 0; // 0x42a Not
	if(var_589_bool == 0) goto Label_1069; // 0x42b JumpB
...
Label_1084:
	var_582_bool = 0; // 0x43c MovB
	return 4; // 0x43d Return
	
Label_1069:
	var_590_bool = 0; // 0x42d PushV
	func_1157(var_590_bool); // 0x42e NEW_2
	if(var_590_bool == 0) goto Label_1075; // 0x430 JumpB
	var_582_bool = 1; // 0x431 MovB
...
Label_1079:
	...
	func_1261(var_587_bool); // 0x43a NEW_2
}
...
{
	var_18_bool = 0; var_19_bool = 0; // 0xa2b PushV
	var_20_bool = 0; var_21_object = Obj(); var_22_bool = 0; // 0xa2c PushV
	var_21_object = var_16_object; // 0xa2d Mov
	var_22_bool = !var_17_bool; // 0xa2e Not2
	func_2320(var_20_bool, var_21_object, var_22_bool); // 0xa2f NEW_2
	if(var_20_bool == 0) goto Label_2627; // 0xa31 JumpB
	CanSee(var_19_bool, var_15_object); // 0xa32 Func
	var_88_bool = 0; // 0xa34 PushV
	var_88_bool = 1; // 0xa35 MovB
	var_89_bool = var_19_bool; // 0xa36 Push
	if(var_89_bool == 0) goto Label_2624; // 0xa37 JumpB
	var_90_float = 0; var_91_object = Obj(); // 0xa38 PushV
	var_91_object = var_15_object; // 0xa39 Mov
	func_1470(var_91_object); // 0xa3a NEW_2
	var_98_float = 160000.0; // 0xa3c PushF
	var_99_bool = var_90_float <= var_98_float; // 0xa3d LE
	if(var_99_bool == 0) goto Label_2624; // 0xa3e JumpB
	var_88_bool = 0; // 0xa3f MovB
	
Label_2624:
	if(var_88_bool == 0) goto Label_2627; // 0xa40 JumpB
	var_14_bool = 1; // 0xa41 MovB
	return 2; // 0xa42 Return
	
Label_2627:
	var_14_bool = 0; // 0xa43 MovB
...
{
	var_16_bool = 0; var_17_float = 0; var_18_string = ""; var_19_bool = 0; var_20_float = 0; var_21_string = ""; // 0xa45 PushV
	var_22_bool = 0; var_23_object = Obj(); // 0xa46 PushV
	var_23_object = var_15_object; // 0xa47 Mov
	func_1609(var_22_bool, var_23_object); // 0xa48 NEW_2
	var_56_bool = var_22_bool == 0; // 0xa4a Not
	if(var_56_bool == 0) goto Label_2638; // 0xa4b JumpB
	var_14_bool = 0; // 0xa4c MovB
	return 6; // 0xa4d Return
	
Label_2638:
	var_57_object = GlobalVars[0]; // 0xa4e PushGE
	in(var_19_bool, var_15_object); // 0xa4f ObjFunc
	var_58_bool = var_19_bool; // 0xa51 Push
	if(var_58_bool == 0) goto Label_2645; // 0xa52 JumpB
	var_14_bool = 1; // 0xa53 MovB
	return 6; // 0xa54 Return
	
Label_2645:
	var_59_bool = 0; var_60_object = Obj(); // 0xa55 PushV
	var_60_object = var_15_object; // 0xa56 Mov
	func_1478(var_59_bool, var_60_object); // 0xa57 NEW_2
	if(var_59_bool == 0) goto Label_2656; // 0xa59 JumpB
	var_63_string = "reputation"; // 0xa5a PushS
	GetProperty(var_63_string, var_20_float); // 0xa5b ObjFunc
	var_64_float = 0.33; // 0xa5d PushF
	var_14_bool = var_20_float < var_64_float; // 0xa5e LT2
	return 6; // 0xa5f Return
	
Label_2656:
	var_65_bool = 0; var_66_object = Obj(); var_67_string = ""; // 0xa60 PushV
	var_66_object = var_15_object; // 0xa61 Mov
	var_67_string = "class"; // 0xa62 MovS
	func_1483(var_65_bool, var_66_object, var_67_string); // 0xa63 NEW_2
	if(var_65_bool == 0) goto Label_2681; // 0xa65 JumpB
	var_68_string = "class"; // 0xa66 PushS
	GetProperty(var_68_string, var_21_string); // 0xa67 ObjFunc
	var_14_bool = 1; // 0xa69 MovB
	var_69_bool = 0; // 0xa6a PushV
	var_69_bool = 1; // 0xa6b MovB
	var_70_string = "bomber"; // 0xa6c PushS
	var_71_bool = var_21_string == var_70_string; // 0xa6d Eq
	if(var_71_bool == 0) goto Label_2675; // 0xa6e JumpB
	var_72_string = "hunter"; // 0xa6f PushS
	var_73_bool = var_21_string == var_72_string; // 0xa70 Eq
	if(var_73_bool == 0) goto Label_2675; // 0xa71 JumpB
	var_69_bool = 0; // 0xa72 MovB
	
Label_2675:
	if(var_69_bool == 0) goto Label_2680; // 0xa73 JumpB
	var_74_string = "grabitel"; // 0xa74 PushS
	var_75_bool = var_21_string == var_74_string; // 0xa75 Eq
	if(var_75_bool == 0) goto Label_2680; // 0xa76 JumpB
	var_14_bool = 0; // 0xa77 MovB
	
Label_2680:
	return 6; // 0xa78 Return
	
Label_2681:
	var_14_bool = 0; // 0xa79 MovB
	return 6; // 0xa7a Return
}
...
Label_775:
	...
	var_598_string = "all"; // 0x309 PushS
	var_599_string = "fjump"; // 0x30a PushS
	PlayAnimation(var_598_string, var_599_string); // 0x30b Func
	WaitForAnimEnd(); // 0x30d Func
	func_1261(var_179_float); // 0x310 NEW_2
	var_600_cvector = CVector(0.0, 0.0, 0.0); // 0x312 PushVec
	SetSpeed(var_600_cvector); // 0x313 Func
	Stop(); // 0x315 Func
	StopAsync(); // 0x317 Func
	var_601_bool = 0; // 0x319 PushV
	func_1218(var_179_float, var_601_bool); // 0x31a NEW_2
	var_602_bool = var_601_bool == 0; // 0x31c Not
	if(var_602_bool == 0) goto Label_821; // 0x31d JumpB
	var_603_bool = 0; var_604_object = Obj(); // 0x31e PushV
	var_604_object = var_0_bool; // 0x31f MovT
	func_1609(var_603_bool, var_604_object); // 0x320 NEW_2
	var_605_bool = var_603_bool == 0; // 0x322 Not
	if(var_605_bool == 0) goto Label_805; // 0x323 JumpB
...
Label_805:
	...
	var_606_float = var_157_float * var_157_float; // 0x32b Mult
	var_607_bool = var_176_float < var_606_float; // 0x32c LT
	if(var_607_bool == 0) goto Label_821; // 0x32d JumpB
	var_608_bool = 0; var_609_float = 0; // 0x32e PushV
	var_609_float = var_157_float; // 0x32f Mov
	func_922(var_179_float, var_608_bool, var_609_float); // 0x330 NEW_2
	var_610_bool = var_608_bool == 0; // 0x332 Not
	if(var_610_bool == 0) goto Label_821; // 0x333 JumpB
	goto Label_831; // 0x334 Jump
	
Label_822:
	var_611_bool = 0; var_612_float = 0; // 0x336 PushV
	var_612_float = var_157_float; // 0x337 Mov
	func_922(var_179_float, var_611_bool, var_612_float); // 0x338 NEW_2
	var_613_bool = var_611_bool == 0; // 0x33a Not
	if(var_613_bool == 0) goto Label_829; // 0x33b JumpB
...
func_2186()
{
	var_241_int = 0; var_242_bool = 0; var_243_int = 0; var_244_int = 0; var_245_bool = 0; var_246_int = 0; // 0x88a PushV
	var_247_int = 0; // 0x88b PushI
	ClearSubContainer(var_247_int); // 0x88c Func
	var_248_int = 0; // 0x88e PushV
	func_1915(var_248_int); // 0x88f NEW_2
	var_246_int = var_248_int; // 0x890 Mov
	var_249_int = 0; var_250_int = 0; // 0x892 PushV
	var_249_int = 0; // 0x893 MovI
	var_251_int = 10; // 0x894 PushI
	var_252_int = 5; // 0x895 PushI
	var_253_float = var_246_int * var_252_int; // 0x896 Mult
	var_250_int = var_251_int + var_253_float; // 0x897 Add2
	func_1987(var_249_int, var_250_int); // 0x898 NEW_2
	var_254_string = ""; var_255_int = 0; var_256_int = 0; // 0x89a PushV
	var_254_string = "bottle_water"; // 0x89b MovS
	var_255_int = 1; // 0x89c MovI
	var_256_int = 3; // 0x89d MovI
	func_1786(var_254_string, var_255_int, var_256_int); // 0x89e NEW_2
	var_257_string = ""; var_258_int = 0; var_259_int = 0; // 0x8a0 PushV
	var_257_string = "rusk"; // 0x8a1 MovS
	var_258_int = 1; // 0x8a2 MovI
	var_259_int = 20; // 0x8a3 MovI
	func_1786(var_257_string, var_258_int, var_259_int); // 0x8a4 NEW_2
	var_260_string = ""; var_261_int = 0; var_262_int = 0; // 0x8a6 PushV
	var_260_string = "hook"; // 0x8a7 MovS
	var_261_int = 1; // 0x8a8 MovI
	var_262_int = 30; // 0x8a9 MovI
	func_1786(var_260_string, var_261_int, var_262_int); // 0x8aa NEW_2
	var_263_string = ""; var_264_int = 0; var_265_int = 0; // 0x8ac PushV
	var_263_string = "watch"; // 0x8ad MovS
	var_264_int = 1; // 0x8ae MovI
	var_265_int = 30; // 0x8af MovI
	func_1786(var_263_string, var_264_int, var_265_int); // 0x8b0 NEW_2
	var_266_int = 3; // 0x8b2 PushI
	var_267_bool = var_246_int >= var_266_int; // 0x8b3 GE
	if(var_267_bool == 0) goto Label_2236; // 0x8b4 JumpB
	var_268_string = ""; var_269_int = 0; var_270_int = 0; var_271_int = 0; // 0x8b5 PushV
	var_268_string = "alpha_pills"; // 0x8b6 MovS
	var_269_int = 1; // 0x8b7 MovI
	var_270_int = 4; // 0x8b8 MovI
	var_271_int = 3; // 0x8b9 MovI
	func_1797(var_268_string, var_269_int, var_270_int, var_271_int); // 0x8ba NEW_2
	
Label_2236:
	var_272_int = 4; // 0x8bc PushI
	var_273_bool = var_246_int >= var_272_int; // 0x8bd GE
	if(var_273_bool == 0) goto Label_2246; // 0x8be JumpB
	var_274_string = ""; var_275_int = 0; var_276_int = 0; var_277_int = 0; // 0x8bf PushV
	var_274_string = "beta_pills"; // 0x8c0 MovS
	var_275_int = 1; // 0x8c1 MovI
	var_276_int = 8; // 0x8c2 MovI
	var_277_int = 3; // 0x8c3 MovI
	func_1797(var_274_string, var_275_int, var_276_int, var_277_int); // 0x8c4 NEW_2
	
Label_2246:
	var_278_int = 6; // 0x8c6 PushI
	var_279_bool = var_246_int >= var_278_int; // 0x8c7 GE
	if(var_279_bool == 0) goto Label_2256; // 0x8c8 JumpB
	var_280_string = ""; var_281_int = 0; var_282_int = 0; var_283_int = 0; // 0x8c9 PushV
	var_280_string = "gamma_pills"; // 0x8ca MovS
	var_281_int = 1; // 0x8cb MovI
	var_282_int = 16; // 0x8cc MovI
	var_283_int = 3; // 0x8cd MovI
	func_1797(var_280_string, var_281_int, var_282_int, var_283_int); // 0x8ce NEW_2
...
func_2257()
{
	var_15_int = 0; var_16_bool = 0; var_17_int = 0; var_18_int = 0; var_19_bool = 0; var_20_int = 0; // 0x8d1 PushV
	var_21_int = 0; // 0x8d2 PushI
	ClearSubContainer(var_21_int); // 0x8d3 Func
	var_22_int = 0; // 0x8d5 PushV
	func_1915(var_22_int); // 0x8d6 NEW_2
	var_20_int = var_22_int; // 0x8d7 Mov
	var_28_string = ""; var_29_int = 0; var_30_int = 0; var_31_int = 0; // 0x8d9 PushV
	var_28_string = "fresh_meat"; // 0x8da MovS
	var_29_int = 1; // 0x8db MovI
	var_30_int = 4; // 0x8dc MovI
	var_31_int = 3; // 0x8dd MovI
	func_1797(var_28_string, var_29_int, var_30_int, var_31_int); // 0x8de NEW_2
	var_44_string = ""; var_45_int = 0; var_46_int = 0; var_47_int = 0; // 0x8e0 PushV
	var_44_string = "dried_meat"; // 0x8e1 MovS
	var_45_int = 1; // 0x8e2 MovI
	var_46_int = 4; // 0x8e3 MovI
	var_47_int = 3; // 0x8e4 MovI
	func_1797(var_44_string, var_45_int, var_46_int, var_47_int); // 0x8e5 NEW_2
	var_48_string = ""; var_49_int = 0; var_50_int = 0; var_51_int = 0; // 0x8e7 PushV
	var_48_string = "smoked_meat"; // 0x8e8 MovS
	var_49_int = 1; // 0x8e9 MovI
	var_50_int = 4; // 0x8ea MovI
	var_51_int = 3; // 0x8eb MovI
	func_1797(var_48_string, var_49_int, var_50_int, var_51_int); // 0x8ec NEW_2
	var_52_string = ""; var_53_int = 0; var_54_int = 0; var_55_int = 0; // 0x8ee PushV
	var_52_string = "vegetables"; // 0x8ef MovS
	var_53_int = 1; // 0x8f0 MovI
	var_54_int = 3; // 0x8f1 MovI
	var_55_int = 3; // 0x8f2 MovI
	func_1797(var_52_string, var_53_int, var_54_int, var_55_int); // 0x8f3 NEW_2
	var_56_int = 3; // 0x8f5 PushI
	var_57_bool = var_20_int >= var_56_int; // 0x8f6 GE
	if(var_57_bool == 0) goto Label_2314; // 0x8f7 JumpB
	var_58_string = ""; var_59_int = 0; var_60_int = 0; // 0x8f8 PushV
	var_58_string = "revolver_ammo"; // 0x8f9 MovS
	var_59_int = 1; // 0x8fa MovI
	var_60_int = 5; // 0x8fb MovI
	func_1786(var_58_string, var_59_int, var_60_int); // 0x8fc NEW_2
	var_67_string = ""; var_68_int = 0; var_69_int = 0; // 0x8fe PushV
	var_67_string = "rifle_ammo"; // 0x8ff MovS
	var_68_int = 1; // 0x900 MovI
	var_69_int = 5; // 0x901 MovI
	func_1786(var_67_string, var_68_int, var_69_int); // 0x902 NEW_2
	var_70_string = ""; var_71_int = 0; var_72_int = 0; // 0x904 PushV
	var_70_string = "samopal_ammo"; // 0x905 MovS
	var_71_int = 1; // 0x906 MovI
	var_72_int = 5; // 0x907 MovI
	func_1786(var_70_string, var_71_int, var_72_int); // 0x908 NEW_2
...
Label_244:
	...
	func_1951(var_118_int); // 0xf5 NEW_2
...
Label_259:
	...
	func_1944(var_140_string, var_141_int); // 0x111 NEW_2
...
func_1261(var_0_bool)
{
	...
	func_1924(var_217_object); // 0x4ef NEW_2
...
func_1281(var_22_object)
{
	...
	func_2059(); // 0x507 NEW_2
	goto Label_1293; // 0x509 Jump
	
Label_1293:
	func_2035(); // 0x50e NEW_2
...
{
	var_56_int = 0; var_57_int = 0; // 0x90b PushV
	GetInvItemByName(var_57_int, var_55_string); // 0x90c Func
	var_54_int = var_57_int; // 0x90e Mov
...
{
	var_23_string = ""; var_24_string = ""; // 0x910 PushV
	var_25_bool = 0; var_26_object = Obj(); var_27_string = ""; // 0x911 PushV
	var_26_object = var_21_object; // 0x912 Mov
	var_27_string = "class"; // 0x913 MovS
	func_1483(var_25_bool, var_26_object, var_27_string); // 0x914 NEW_2
	var_34_bool = var_25_bool == 0; // 0x916 Not
	if(var_34_bool == 0) goto Label_2330; // 0x917 JumpB
	var_20_bool = 0; // 0x918 MovB
	return 2; // 0x919 Return
	
Label_2330:
	var_35_string = "class"; // 0x91a PushS
	GetProperty(var_35_string, var_24_string); // 0x91b ObjFunc
	var_36_bool = 0; // 0x91d PushV
	var_36_bool = 1; // 0x91e MovB
	var_37_bool = 0; // 0x91f PushV
	var_37_bool = 1; // 0x920 MovB
	var_38_bool = 0; // 0x921 PushV
	var_38_bool = 1; // 0x922 MovB
	var_39_bool = 0; // 0x923 PushV
	var_39_bool = 1; // 0x924 MovB
	var_40_bool = 0; // 0x925 PushV
	var_40_bool = 1; // 0x926 MovB
	var_41_bool = 0; // 0x927 PushV
	var_41_bool = 1; // 0x928 MovB
	var_42_bool = 0; // 0x929 PushV
	var_42_bool = 1; // 0x92a MovB
	var_43_bool = 0; // 0x92b PushV
	var_43_bool = 1; // 0x92c MovB
	var_44_bool = 0; // 0x92d PushV
	var_44_bool = 1; // 0x92e MovB
	var_45_bool = 0; // 0x92f PushV
	var_45_bool = 1; // 0x930 MovB
	var_46_string = "patrol"; // 0x931 PushS
	var_47_bool = var_24_string == var_46_string; // 0x932 Eq
	if(var_47_bool == 0) goto Label_2360; // 0x933 JumpB
	var_48_string = "sanitar"; // 0x934 PushS
	var_49_bool = var_24_string == var_48_string; // 0x935 Eq
	if(var_49_bool == 0) goto Label_2360; // 0x936 JumpB
	var_45_bool = 0; // 0x937 MovB
	
Label_2360:
	if(var_45_bool == 0) goto Label_2365; // 0x938 JumpB
	var_50_string = "soldier"; // 0x939 PushS
	var_51_bool = var_24_string == var_50_string; // 0x93a Eq
	if(var_51_bool == 0) goto Label_2365; // 0x93b JumpB
	var_44_bool = 0; // 0x93c MovB
	
Label_2365:
	if(var_44_bool == 0) goto Label_2370; // 0x93d JumpB
	var_52_string = "woman"; // 0x93e PushS
	var_53_bool = var_24_string == var_52_string; // 0x93f Eq
	if(var_53_bool == 0) goto Label_2370; // 0x940 JumpB
	var_43_bool = 0; // 0x941 MovB
	
Label_2370:
	if(var_43_bool == 0) goto Label_2375; // 0x942 JumpB
	var_54_string = "wasted_girl"; // 0x943 PushS
	var_55_bool = var_24_string == var_54_string; // 0x944 Eq
	if(var_55_bool == 0) goto Label_2375; // 0x945 JumpB
	var_42_bool = 0; // 0x946 MovB
	
Label_2375:
	if(var_42_bool == 0) goto Label_2380; // 0x947 JumpB
	var_56_string = "vaxxabitka"; // 0x948 PushS
	var_57_bool = var_24_string == var_56_string; // 0x949 Eq
	if(var_57_bool == 0) goto Label_2380; // 0x94a JumpB
	var_41_bool = 0; // 0x94b MovB
	
Label_2380:
	if(var_41_bool == 0) goto Label_2385; // 0x94c JumpB
	var_58_string = "vaxxabit"; // 0x94d PushS
	var_59_bool = var_24_string == var_58_string; // 0x94e Eq
	if(var_59_bool == 0) goto Label_2385; // 0x94f JumpB
	var_40_bool = 0; // 0x950 MovB
	
Label_2385:
	if(var_40_bool == 0) goto Label_2390; // 0x951 JumpB
	var_60_string = "little_girl"; // 0x952 PushS
	var_61_bool = var_24_string == var_60_string; // 0x953 Eq
	if(var_61_bool == 0) goto Label_2390; // 0x954 JumpB
	var_39_bool = 0; // 0x955 MovB
	
Label_2390:
	if(var_39_bool == 0) goto Label_2395; // 0x956 JumpB
	var_62_string = "girl"; // 0x957 PushS
	var_63_bool = var_24_string == var_62_string; // 0x958 Eq
	if(var_63_bool == 0) goto Label_2395; // 0x959 JumpB
	var_38_bool = 0; // 0x95a MovB
	
Label_2395:
	if(var_38_bool == 0) goto Label_2400; // 0x95b JumpB
	var_64_string = "dohodyaga"; // 0x95c PushS
	var_65_bool = var_24_string == var_64_string; // 0x95d Eq
	if(var_65_bool == 0) goto Label_2400; // 0x95e JumpB
	var_37_bool = 0; // 0x95f MovB
	
Label_2400:
	if(var_37_bool == 0) goto Label_2405; // 0x960 JumpB
	var_66_string = "nudegirl"; // 0x961 PushS
	var_67_bool = var_24_string == var_66_string; // 0x962 Eq
	if(var_67_bool == 0) goto Label_2405; // 0x963 JumpB
	var_36_bool = 0; // 0x964 MovB
	
Label_2405:
	if(var_36_bool == 0) goto Label_2408; // 0x965 JumpB
	var_20_bool = 1; // 0x966 MovB
	return 2; // 0x967 Return
	
Label_2408:
	var_68_bool = var_22_bool; // 0x968 Push
	if(var_68_bool == 0) goto Label_2412; // 0x969 JumpB
	var_20_bool = 0; // 0x96a MovB
	return 2; // 0x96b Return
	
Label_2412:
	var_20_bool = 1; // 0x96c MovB
	var_69_bool = 0; // 0x96d PushV
	var_69_bool = 1; // 0x96e MovB
	var_70_bool = 0; // 0x96f PushV
	var_70_bool = 1; // 0x970 MovB
	var_71_bool = 0; // 0x971 PushV
	var_71_bool = 1; // 0x972 MovB
	var_72_bool = 0; // 0x973 PushV
	var_72_bool = 1; // 0x974 MovB
	var_73_bool = 0; // 0x975 PushV
	var_73_bool = 1; // 0x976 MovB
	var_74_string = "worker"; // 0x977 PushS
	var_75_bool = var_24_string == var_74_string; // 0x978 Eq
	if(var_75_bool == 0) goto Label_2430; // 0x979 JumpB
	var_76_string = "butcher"; // 0x97a PushS
	var_77_bool = var_24_string == var_76_string; // 0x97b Eq
	if(var_77_bool == 0) goto Label_2430; // 0x97c JumpB
	var_73_bool = 0; // 0x97d MovB
	
Label_2430:
	if(var_73_bool == 0) goto Label_2435; // 0x97e JumpB
	var_78_string = "boy"; // 0x97f PushS
	var_79_bool = var_24_string == var_78_string; // 0x980 Eq
	if(var_79_bool == 0) goto Label_2435; // 0x981 JumpB
	var_72_bool = 0; // 0x982 MovB
	
Label_2435:
	if(var_72_bool == 0) goto Label_2440; // 0x983 JumpB
	var_80_string = "unosha"; // 0x984 PushS
	var_81_bool = var_24_string == var_80_string; // 0x985 Eq
	if(var_81_bool == 0) goto Label_2440; // 0x986 JumpB
	var_71_bool = 0; // 0x987 MovB
	
Label_2440:
	if(var_71_bool == 0) goto Label_2445; // 0x988 JumpB
	var_82_string = "wasted_male"; // 0x989 PushS
	var_83_bool = var_24_string == var_82_string; // 0x98a Eq
	if(var_83_bool == 0) goto Label_2445; // 0x98b JumpB
	var_70_bool = 0; // 0x98c MovB
	
Label_2445:
	if(var_70_bool == 0) goto Label_2450; // 0x98d JumpB
	var_84_string = "alkash"; // 0x98e PushS
	var_85_bool = var_24_string == var_84_string; // 0x98f Eq
	if(var_85_bool == 0) goto Label_2450; // 0x990 JumpB
	var_69_bool = 0; // 0x991 MovB
	
Label_2450:
	if(var_69_bool == 0) goto Label_2455; // 0x992 JumpB
	var_86_string = "morlok"; // 0x993 PushS
	var_87_bool = var_24_string == var_86_string; // 0x994 Eq
	if(var_87_bool == 0) goto Label_2455; // 0x995 JumpB
	var_20_bool = 0; // 0x996 MovB
...
func_335(var_2_object, var_224_bool, var_225_object, var_226_float, var_227_float, var_228_bool, var_229_bool)
{
	...
	func_1924(var_237_object); // 0x152 NEW_2
...
func_1898(var_547_float)
{
	...
	var_550_int = 0; // 0x76f PushI
	var_551_bool = var_547_float < var_550_int; // 0x770 LT
	if(var_551_bool == 0) goto Label_1910; // 0x771 JumpB
	var_552_float = 0.7; // 0x772 PushF
	var_553_int = 500; // 0x773 PushI
	RumblePlay(var_552_float, var_553_int); // 0x774 Func
	
Label_1910:
	var_554_int = 15; // 0x776 PushI
	SendWorldWndMessage(var_554_int, var_549_object); // 0x777 Func
...
func_883(var_0_bool, var_477_float, var_478_int)
{
	...
	var_556_int = 0; // 0x38e PushV
	func_1266(var_556_int); // 0x38f NEW_2
	ReportHit(var_0_bool, var_556_int, var_484_float, var_483_float); // 0x391 Func
	var_557_object = Obj(); var_558_float = 0; // 0x393 PushV
	var_557_object = var_482_object; // 0x394 Mov
	var_558_float = var_484_float; // 0x395 Mov
...
{
	var_23_float = 0; var_24_float = 0; // 0x77b PushV
	GetGameTime(var_24_float); // 0x77c Func
	var_25_int = 1; // 0x77e PushI
	var_26_int = 0; // 0x77f PushV
	var_27_int = 24; // 0x780 PushI
	var_26_int = var_24_float / var_24_float; // 0x781 Div2
	var_22_int = var_25_int + var_26_int; // 0x782 Add2
...
{
	var_15_bool = 0; var_16_bool = 0; // 0x784 PushV
	IsPlayerActor(var_14_object, var_16_bool); // 0x785 Func
	var_17_bool = var_16_bool; // 0x787 Push
	if(var_17_bool == 0) goto Label_1932; // 0x788 JumpB
	var_18_string = "attack"; // 0x789 PushS
	PlayGlobalMusic(var_18_string); // 0x78a Func
...
func_1933()
{
	var_452_object = Obj(); var_453_object = Obj(); // 0x78d PushV
	GetScene(var_453_object); // 0x78e Func
	var_454_string = "battle"; // 0x790 PushS
	var_455_object = Obj(); // 0x791 PushV
	func_1853(var_455_object); // 0x792 NEW_2
	BroadcastMessage(var_454_string, var_455_object, var_453_object); // 0x794 Func
...
func_2456()
{
	var_11_object = GlobalVars[0]; // 0x998 PushGE
	var_12_object = Obj(); // 0x999 PushV
	func_1892(var_12_object); // 0x99a NEW_2
	var_11_object = var_12_object; // 0x99b Mov
	GlobalVars[0] = var_11_object; // 0x99d PopGE
...
{
	var_126_string = ""; var_127_string = ""; // 0x798 PushV
	var_127_string = "idle"; // 0x799 MovS
	var_128_int = var_125_int; // 0x79a Push
	if(var_128_int == 0) goto Label_1949; // 0x79b JumpB
	var_127_string = var_127_string + var_125_int; // 0x79c Add2
	
Label_1949:
	var_124_string = var_127_string; // 0x79d Mov
...
Label_958:
	...
	var_559_string = "all"; // 0x3c3 PushS
	var_560_string = "attack_middle"; // 0x3c4 PushS
	var_561_int = var_560_string + var_446_int; // 0x3c5 Add
	HasAnimation(var_447_bool, var_559_string, var_561_int); // 0x3c6 Func
	var_562_bool = var_447_bool; // 0x3c8 Push
	if(var_562_bool == 0) goto Label_1039; // 0x3c9 JumpB
	func_1933(); // 0x3cb NEW_2
	var_563_string = "all"; // 0x3cd PushS
	var_564_string = "attack_middle"; // 0x3ce PushS
	var_565_int = var_564_string + var_446_int; // 0x3cf Add
	PlayAnimation(var_563_string, var_565_int); // 0x3d0 Func
	WaitForAnimEnd(); // 0x3d2 Func
	func_1261(var_449_string); // 0x3d5 NEW_2
	var_566_bool = 0; var_567_object = Obj(); // 0x3d7 PushV
	var_567_object = var_0_bool; // 0x3d8 MovT
	func_1609(var_566_bool, var_567_object); // 0x3d9 NEW_2
	var_568_bool = var_566_bool == 0; // 0x3db Not
	if(var_568_bool == 0) goto Label_993; // 0x3dc JumpB
	StopAsync(); // 0x3dd Func
	var_440_bool = 0; // 0x3df MovB
	return 8; // 0x3e0 Return
	
Label_993:
	var_569_float = 0; var_570_int = 0; // 0x3e1 PushV
	var_569_float = var_441_float; // 0x3e2 Mov
	var_570_int = var_446_int; // 0x3e3 Mov
	func_883(var_449_string, var_569_float, var_570_int); // 0x3e4 NEW_2
	var_448_int = 1; // 0x3e6 MovI
	
Label_999:
	var_571_string = "attack_middle"; // 0x3e7 PushS
	var_572_int = var_571_string + var_446_int; // 0x3e8 Add
	var_573_string = "_"; // 0x3e9 PushS
	var_574_int = var_572_int + var_573_string; // 0x3ea Add
	var_449_string = var_574_int + var_448_int; // 0x3eb Add2
	var_575_string = "all"; // 0x3ec PushS
	HasAnimation(var_447_bool, var_575_string, var_449_string); // 0x3ed Func
	var_576_bool = var_447_bool == 0; // 0x3ef Not
	if(var_576_bool == 0) goto Label_1010; // 0x3f0 JumpB
	goto Label_1039; // 0x3f1 Jump
	
Label_1039:
	var_577_bool = 0; // 0x40f PushB
	SetAttackState(var_577_bool); // 0x410 Func
	var_578_string = "all"; // 0x412 PushS
	var_579_string = "attack_end"; // 0x413 PushS
	var_580_int = var_579_string + var_446_int; // 0x414 Add
	PlayAnimation(var_578_string, var_580_int); // 0x415 Func
	var_581_bool = 0; // 0x417 PushV
	func_1275(var_581_bool); // 0x418 NEW_2
	if(var_581_bool == 0) goto Label_1057; // 0x41a JumpB
	var_582_bool = 0; var_583_float = 0; // 0x41b PushV
	var_583_float = 0.75; // 0x41c MovF
	func_1059(var_582_bool, var_583_float); // 0x41d NEW_2
...
Label_1010:
	func_1933(); // 0x3f3 NEW_2
	var_591_string = "all"; // 0x3f5 PushS
	PlayAnimation(var_591_string, var_449_string); // 0x3f6 Func
	WaitForAnimEnd(); // 0x3f8 Func
	func_1261(var_449_string); // 0x3fb NEW_2
	var_592_bool = 0; var_593_object = Obj(); // 0x3fd PushV
	var_593_object = var_0_bool; // 0x3fe MovT
	func_1609(var_592_bool, var_593_object); // 0x3ff NEW_2
	var_594_bool = var_592_bool == 0; // 0x401 Not
	if(var_594_bool == 0) goto Label_1031; // 0x402 JumpB
	StopAsync(); // 0x403 Func
	var_440_bool = 0; // 0x405 MovB
	return 8; // 0x406 Return
	
Label_1031:
	var_595_float = 0; var_596_int = 0; // 0x407 PushV
	var_595_float = var_441_float; // 0x408 Mov
	var_596_int = var_446_int; // 0x409 Mov
	func_883(var_449_string, var_595_float, var_596_int); // 0x40a NEW_2
	var_597_int = 1; // 0x40c PushI
	var_448_int = var_448_int + var_597_int; // 0x40d Add2
...
{
	var_14_bool = 0; var_15_object = Obj(); // 0x9a0 PushV
	var_15_object = var_13_object; // 0x9a1 Mov
	func_2629(var_14_bool, var_15_object); // 0x9a2 NEW_2
	var_12_bool = var_14_bool; // 0x9a3 Mov
...
{
	var_119_int = 0; var_120_bool = 0; var_121_int = 0; var_122_bool = 0; // 0x79f PushV
	var_121_int = 0; // 0x7a0 MovI
	
Label_1953:
	var_123_string = "all"; // 0x7a1 PushS
	var_124_string = ""; var_125_int = 0; // 0x7a2 PushV
	var_125_int = var_121_int; // 0x7a3 Mov
	func_1944(var_124_string, var_125_int); // 0x7a4 NEW_2
	HasAnimation(var_122_bool, var_123_string, var_124_string); // 0x7a6 Func
	var_129_bool = var_122_bool == 0; // 0x7a8 Not
	if(var_129_bool == 0) goto Label_1963; // 0x7a9 JumpB
	goto Label_1966; // 0x7aa Jump
	
Label_1966:
	var_118_int = var_121_int; // 0x7ae Mov
	return 4; // 0x7af Return
	
Label_1963:
	var_130_int = 1; // 0x7ab PushI
	var_121_int = var_121_int + var_130_int; // 0x7ac Add2
	goto Label_1953; // 0x7ad Jump
}


func_2470(var_76_object)
{
	var_77_object = Obj(); // 0x9a7 PushV
	var_77_object = var_76_object; // 0x9a8 Mov
	func_2489(var_77_object); // 0x9a9 NEW_2
...
{
	var_14_bool = 0; var_15_object = Obj(); // 0x9ad PushV
	var_15_object = var_13_object; // 0x9ae Mov
	func_2629(var_14_bool, var_15_object); // 0x9af NEW_2
	var_12_bool = var_14_bool; // 0x9b0 Mov
...
{
	var_139_int = 0; var_140_int = 0; // 0x7b0 PushV
	var_141_string = "branch"; // 0x7b1 PushS
	GetVariable(var_141_string, var_140_int); // 0x7b2 Func
	var_138_int = var_140_int; // 0x7b4 Mov
...
{
	var_77_object = Obj(); // 0x9b4 PushV
	var_77_object = var_76_object; // 0x9b5 Mov
	func_2489(var_77_object); // 0x9b6 NEW_2
...
{
	var_16_int = 0; // 0x7b7 PushV
	func_1968(var_16_int); // 0x7b8 NEW_2
	var_20_int = 1; // 0x7ba PushI
	var_21_bool = var_16_int == var_20_int; // 0x7bb Eq
	if(var_21_bool == 0) goto Label_1984; // 0x7bc JumpB
	WorkWithCorpse(var_15_object); // 0x7bd Func
	goto Label_1986; // 0x7bf Jump
	
Label_1986:
	return 0; // 0x7c2 Return
	
Label_1984:
	Barter(var_15_object); // 0x7c0 Func
}
...
{
	var_78_object = Obj(); var_79_bool = 0; // 0x9ba PushV
	var_78_object = var_77_object; // 0x9bb Mov
	var_79_bool = 1; // 0x9bc MovB
	TaskCall(3); // 0x9bd TaskCall
	func_591(var_78_object, var_79_bool); // 0x9be NEW_2
	TaskReturn(); // 0x9bf TaskReturn
	ResetAAS(); // 0x9c1 Func
...
{
	var_44_int = 0; var_45_bool = 0; var_46_int = 0; var_47_bool = 0; // 0x7c3 PushV
	var_48_bool = var_39_int > var_40_int; // 0x7c4 GT
	if(var_48_bool == 0) goto Label_1994; // 0x7c5 JumpB
	var_49_string = "GenerateMoney: iMin > iMax"; // 0x7c6 PushS
	Trace(var_49_string); // 0x7c7 Func
	return 4; // 0x7c9 Return
	
Label_1994:
	var_46_int = 0; // 0x7ca MovI
	var_50_bool = var_39_int != var_40_int; // 0x7cb Neq
	if(var_50_bool == 0) goto Label_2001; // 0x7cc JumpB
	var_51_int = var_40_int - var_39_int; // 0x7cd Sub
	irand(var_46_int, var_51_int); // 0x7ce Func
	goto Label_2005; // 0x7d0 Jump
	
Label_2005:
	var_46_int = var_46_int + var_39_int; // 0x7d5 Add2
	var_52_int = 0; // 0x7d6 PushI
	var_53_bool = var_46_int == var_52_int; // 0x7d7 Eq
	if(var_53_bool == 0) goto Label_2010; // 0x7d8 JumpB
	return 4; // 0x7d9 Return
	
Label_2010:
	var_54_int = 0; var_55_string = ""; // 0x7da PushV
	var_55_string = "Money"; // 0x7db MovS
	func_2315(var_54_int, var_55_string); // 0x7dc NEW_2
	var_58_int = 0; // 0x7de PushI
	AddItem(var_47_bool, var_54_int, var_58_int, var_46_int); // 0x7df Func
	return 4; // 0x7e1 Return
	
Label_2001:
	var_59_int = 0; // 0x7d1 PushI
	var_60_bool = var_39_int == var_59_int; // 0x7d2 Eq
	if(var_60_bool == 0) goto Label_2005; // 0x7d3 JumpB
...
{
	var_13_bool = 0; var_14_bool = 0; // 0x9c4 PushV
	var_15_bool = var_12_object == 0; // 0x9c5 NullEq
	if(var_15_bool == 0) goto Label_2504; // 0x9c6 JumpB
	return 2; // 0x9c7 Return
	
Label_2504:
	var_16_object = GlobalVars[0]; // 0x9c8 PushGE
	in(var_14_bool, var_12_object); // 0x9c9 ObjFunc
	var_17_bool = var_14_bool == 0; // 0x9cb Not
	if(var_17_bool == 0) goto Label_2512; // 0x9cc JumpB
	var_18_object = GlobalVars[0]; // 0x9cd PushGE
	add(var_12_object); // 0x9ce ObjFunc
	
Label_2512:
	var_19_bool = 0; var_20_object = Obj(); // 0x9d0 PushV
	var_20_object = var_12_object; // 0x9d1 Mov
	func_1478(var_19_bool, var_20_object); // 0x9d2 NEW_2
	if(var_19_bool == 0) goto Label_2523; // 0x9d4 JumpB
	var_23_object = Obj(); // 0x9d5 PushV
	func_1853(var_23_object); // 0x9d6 NEW_2
	var_26_float = -0.07; // 0x9d8 PushF
	ReportReputationChange(var_12_object, var_23_object, var_26_float); // 0x9d9 Func
...
Label_1514:
	var_555_string = "armor"; // 0x5ea PushS
	GetProperty(var_555_string, var_504_int); // 0x5eb ObjFunc
}


func_2524(var_145_object)
{
	var_146_object = Obj(); // 0x9dd PushV
	var_146_object = var_145_object; // 0x9de Mov
	func_2500(var_146_object); // 0x9df NEW_2
	var_147_object = Obj(); var_148_bool = 0; // 0x9e1 PushV
	var_147_object = var_145_object; // 0x9e2 Mov
	var_148_bool = 1; // 0x9e3 MovB
	TaskCall(3); // 0x9e4 TaskCall
	func_591(var_147_object, var_148_bool); // 0x9e5 NEW_2
	TaskReturn(); // 0x9e6 TaskReturn
	ResetAAS(); // 0x9e8 Func
...
{
	var_145_object = Obj(); var_146_int = 0; var_147_bool = 0; var_148_object = Obj(); var_149_int = 0; var_150_bool = 0; // 0x7e2 PushV
	CreateInvItem(var_148_object); // 0x7e3 Func
	SetItemName(var_144_string); // 0x7e5 ObjFunc
	var_151_string = "Organ"; // 0x7e7 PushS
	var_152_int = 1; // 0x7e8 PushI
	SetProperty(var_151_string, var_152_int); // 0x7e9 ObjFunc
	GetItemID(var_149_int); // 0x7eb ObjFunc
	var_153_int = 0; // 0x7ed PushI
	var_154_int = 1; // 0x7ee PushI
	AddItem(var_150_bool, var_148_object, var_153_int, var_154_int); // 0x7ef Func
...
{
	var_13_bool = 0; var_14_object = Obj(); // 0x9ec PushV
	var_14_object = var_12_object; // 0x9ed Mov
	func_1478(var_13_bool, var_14_object); // 0x9ee NEW_2
	if(var_13_bool == 0) goto Label_2552; // 0x9f0 JumpB
	var_17_object = Obj(); // 0x9f1 PushV
	func_1853(var_17_object); // 0x9f2 NEW_2
	var_20_float = -0.13; // 0x9f4 PushF
	var_21_bool = 1; // 0x9f5 PushB
	ReportReputationChange(var_12_object, var_17_object, var_20_float, var_21_bool); // 0x9f6 Func
	
Label_2552:
	var_22_object = Obj(); // 0x9f8 PushV
	var_22_object = var_12_object; // 0x9f9 Mov
	TaskCall(4); // 0x9fa TaskCall
	func_1281(var_22_object); // 0x9fb NEW_2
...
func_2035()
{
	var_138_int = 0; // 0x7f3 PushV
	func_1968(var_138_int); // 0x7f4 NEW_2
	var_142_int = 1; // 0x7f6 PushI
	var_143_bool = var_138_int != var_142_int; // 0x7f7 Neq
	if(var_143_bool == 0) goto Label_2042; // 0x7f8 JumpB
	return 0; // 0x7f9 Return
	
Label_2042:
	var_144_string = ""; // 0x7fa PushV
	var_144_string = "liver"; // 0x7fb MovS
	func_2018(var_144_string); // 0x7fc NEW_2
	var_155_string = ""; // 0x7fe PushV
	var_155_string = "kidney"; // 0x7ff MovS
	func_2018(var_155_string); // 0x800 NEW_2
	var_156_string = ""; // 0x802 PushV
	var_156_string = "heart"; // 0x803 MovS
	func_2018(var_156_string); // 0x804 NEW_2
	var_157_string = ""; // 0x806 PushV
	var_157_string = "blood"; // 0x807 MovS
	func_2018(var_157_string); // 0x808 NEW_2
