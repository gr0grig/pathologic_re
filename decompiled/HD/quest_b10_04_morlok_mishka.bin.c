...
Label_521:
	...
	var_157_int = 530543; // 0x216 PushI
	SetMessage(var_157_int); // 0x217 TObjFunc
	ClearReplies(); // 0x219 TObjFunc
	var_158_int = 530544; // 0x21b PushI
	var_159_int = -1; // 0x21c PushI
	var_160_int = 31891; // 0x21d PushI
...
Label_545:
	...
	func_1050(var_162_object); // 0x223 NEW_2
	...
	var_168_int = 530416; // 0x22a PushI
	SetMessage(var_168_int); // 0x22b TObjFunc
	ClearReplies(); // 0x22d TObjFunc
	var_169_int = 530417; // 0x22f PushI
	var_170_int = -1; // 0x230 PushI
	var_171_int = 31789; // 0x231 PushI
...
Label_565:
	...
	var_173_int = 530418; // 0x239 PushI
	...
	if(var_176_bool == 0) goto Label_590; // 0x246 JumpB
	var_182_bool = 0; var_183_object = Obj(); // 0x247 PushV
	var_183_object = var_1_int; // 0x248 MovT
	func_1038(var_183_object); // 0x249 NEW_2
	var_188_bool = var_182_bool == 0; // 0x24b Not
	if(var_188_bool == 0) goto Label_590; // 0x24c JumpB
	var_175_bool = 1; // 0x24d MovB
	
Label_590:
	if(var_175_bool == 0) goto Label_597; // 0x24e JumpB
	var_189_bool = 0; var_190_object = Obj(); // 0x24f PushV
	var_190_object = var_1_int; // 0x250 MovT
	func_1062(var_190_object); // 0x251 NEW_2
	if(var_189_bool == 0) goto Label_597; // 0x253 JumpB
	var_174_bool = 1; // 0x254 MovB
	
Label_597:
	if(var_174_bool == 0) goto Label_603; // 0x255 JumpB
	var_195_int = 530419; // 0x256 PushI
	var_196_int = 31792; // 0x257 PushI
	var_197_int = 31791; // 0x258 PushI
	AddReply(var_195_int, var_196_int, var_197_int); // 0x259 TObjFunc
	
Label_603:
	var_198_int = 530424; // 0x25b PushI
	var_199_int = -1; // 0x25c PushI
	var_200_int = 31796; // 0x25d PushI
	AddReply(var_198_int, var_199_int, var_200_int); // 0x25e TObjFunc
	return 0; // 0x260 Return
	
Label_609:
	var_201_int = 31792; // 0x261 PushI
	...
	var_225_int = 530420; // 0x26d PushI
	SetMessage(var_225_int); // 0x26e TObjFunc
	ClearReplies(); // 0x270 TObjFunc
	var_226_int = 530421; // 0x272 PushI
	var_227_int = -1; // 0x273 PushI
	var_228_int = 31793; // 0x274 PushI
...
Label_632:
	...
	var_233_int = 530422; // 0x282 PushI
	SetMessage(var_233_int); // 0x283 TObjFunc
	ClearReplies(); // 0x285 TObjFunc
	var_234_int = 530423; // 0x287 PushI
	var_235_int = -1; // 0x288 PushI
	var_236_int = 31795; // 0x289 PushI
...
func_1026(var_176_bool)
{
	...
	var_179_string = "b10q04MishkaTalk"; // 0x404 MovS
...
func_1038(var_182_bool)
{
	var_184_int = 0; var_185_string = ""; // 0x40f PushV
	var_185_string = "b10q04"; // 0x410 MovS
	func_831(var_184_int, var_185_string); // 0x411 NEW_2
	var_186_int = -1; // 0x413 PushI
	var_187_bool = var_184_int == var_186_int; // 0x414 Eq
	if(var_187_bool == 0) goto Label_1048; // 0x415 JumpB
	var_182_bool = 1; // 0x416 MovB
	return 0; // 0x417 Return
	
Label_1048:
	var_182_bool = 0; // 0x418 MovB
...
func_1050(var_161_bool)
{
	var_163_int = 0; var_164_string = ""; // 0x41b PushV
	var_164_string = "b10q04MishkaTalk"; // 0x41c MovS
	func_831(var_163_int, var_164_string); // 0x41d NEW_2
	var_165_int = 0; // 0x41f PushI
	var_166_bool = var_163_int == var_165_int; // 0x420 Eq
	if(var_166_bool == 0) goto Label_1060; // 0x421 JumpB
	var_161_bool = 1; // 0x422 MovB
	return 0; // 0x423 Return
	
Label_1060:
	var_161_bool = 0; // 0x424 MovB
...
func_930()
{
	...
	var_22_string = "b10q04MishkaTalk"; // 0x3a3 PushS
	...
	var_31_string = "b10q04MorlokGotoMishka"; // 0x3ab PushS
	var_32_string = "pt_map_mishka"; // 0x3ac PushS
	var_33_int = 0; // 0x3ad PushI
	var_34_int = 530550; // 0x3ae PushI
...
func_1062(var_189_bool)
{
	var_191_int = 0; var_192_string = ""; // 0x427 PushV
	var_192_string = "oob10MorlokMishka1"; // 0x428 MovS
	func_831(var_191_int, var_192_string); // 0x429 NEW_2
	var_193_int = 0; // 0x42b PushI
	var_194_bool = var_191_int == var_193_int; // 0x42c Eq
	if(var_194_bool == 0) goto Label_1072; // 0x42d JumpB
	var_189_bool = 1; // 0x42e MovB
	return 0; // 0x42f Return
	
Label_1072:
	var_189_bool = 0; // 0x430 MovB
...
func_953()
{
	var_91_string = "oob10MorlokMishka1"; // 0x3ba PushS
...
func_1086()
{
	...
	var_40_int = 549; // 0x43f PushI
	var_41_int = 2; // 0x440 PushI
	var_42_int = 530440; // 0x441 PushI
...
func_323(var_0_int, var_1_int, var_2_bool, var_3_bool, var_89_object, var_90_object)
{
	...
	var_122_int = 530543; // 0x153 PushI
	SetMessage(var_122_int); // 0x154 TObjFunc
	ClearReplies(); // 0x156 TObjFunc
	var_123_int = 530544; // 0x158 PushI
	var_124_int = -1; // 0x159 PushI
	var_125_int = 31891; // 0x15a PushI
...
Label_350:
	...
	func_1050(var_145_object); // 0x160 NEW_2
	...
	var_151_int = 530416; // 0x167 PushI
	SetMessage(var_151_int); // 0x168 TObjFunc
	ClearReplies(); // 0x16a TObjFunc
	var_152_int = 530417; // 0x16c PushI
	var_153_int = -1; // 0x16d PushI
	var_154_int = 31789; // 0x16e PushI
...
Label_370:
	...
	var_156_int = 530418; // 0x176 PushI
	...
	if(var_159_bool == 0) goto Label_395; // 0x183 JumpB
	var_165_bool = 0; var_166_object = Obj(); // 0x184 PushV
	var_166_object = var_1_int; // 0x185 MovT
	func_1038(var_166_object); // 0x186 NEW_2
	var_171_bool = var_165_bool == 0; // 0x188 Not
	if(var_171_bool == 0) goto Label_395; // 0x189 JumpB
	var_158_bool = 1; // 0x18a MovB
	
Label_395:
	if(var_158_bool == 0) goto Label_402; // 0x18b JumpB
	var_172_bool = 0; var_173_object = Obj(); // 0x18c PushV
	var_173_object = var_1_int; // 0x18d MovT
	func_1062(var_173_object); // 0x18e NEW_2
	if(var_172_bool == 0) goto Label_402; // 0x190 JumpB
	var_157_bool = 1; // 0x191 MovB
	
Label_402:
	if(var_157_bool == 0) goto Label_408; // 0x192 JumpB
	var_178_int = 530419; // 0x193 PushI
	var_179_int = 31792; // 0x194 PushI
	var_180_int = 31791; // 0x195 PushI
	AddReply(var_178_int, var_179_int, var_180_int); // 0x196 TObjFunc
	
Label_408:
	var_181_int = 530424; // 0x198 PushI
	var_182_int = -1; // 0x199 PushI
	var_183_int = 31796; // 0x19a PushI
...
func_965()
{
	...
	var_64_string = "pt_map_mishka"; // 0x3cb MovS
