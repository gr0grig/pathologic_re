...
0x214: Push("Can't find lsh animation : ")
...
0x260: Stack[-1] = "ui/NPC_bmask.png"
0x261: Return(); Pop(0)

0x262: Stack[-1] = "ui/NPC_bmask_b.png"
0x263: Return(); Pop(0)
