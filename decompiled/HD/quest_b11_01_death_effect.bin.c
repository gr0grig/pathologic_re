...
func_55(var_24_float)
{
	...
	var_30_bool = var_24_float < var_29_int; // 0x3d LT
	if(var_30_bool == 0) goto Label_67; // 0x3e JumpB
	var_31_float = 0.7; // 0x3f PushF
	var_32_int = 500; // 0x40 PushI
	RumblePlay(var_31_float, var_32_int); // 0x41 Func
	
Label_67:
	var_33_int = 15; // 0x43 PushI
	SendWorldWndMessage(var_33_int, var_28_object); // 0x44 Func
