...
0x732: Pop(0)
0x733: @@ GetLocator(Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x734: Pop(0)
0x735: Pop(0); Push((bool) Stack[-3] == 0)
0x736: IF (Stack[-1] == 0) GOTO 0x741; Pop(1)

0x737: Push("Teleport location '")
0x738: Pop(1); Push(Stack[-1] + Stack[-10]);
0x739: Push("' not found in scene '")
...
0x76f: Stack[-3] = Stack[-7]
0x770: Stack[-2] = Stack[-6]
...
0x777: Stack[-5] = Stack[-11]
0x778: Stack[-4] = Stack[-10]
0x779: Stack[-3] = Stack[-9]
