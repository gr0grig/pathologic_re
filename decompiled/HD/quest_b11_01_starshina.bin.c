task_1_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1873(var_12_object); // 0x372 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x76e PushV
	var_13_object = var_9_object; // 0x76f Mov
	var_14_int = var_10_int; // 0x770 Mov
	var_15_float = var_11_float; // 0x771 Mov
	func_1540(var_13_object, var_14_int, var_15_float); // 0x772 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x776 PushV
	var_15_object = var_9_object; // 0x777 Mov
	var_16_int = var_10_int; // 0x778 Mov
	var_17_float = var_11_float; // 0x779 Mov
	var_18_cvector = var_13_cvector; // 0x77a Mov
	var_19_cvector = var_14_cvector; // 0x77b Mov
	func_1608(var_17_float, var_18_cvector, var_19_cvector); // 0x77c NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x77f PushV
	var_13_string = "health"; // 0x780 PushS
	var_14_bool = var_10_string == var_13_string; // 0x781 Eq
	if(var_14_bool == 0) goto Label_1931; // 0x782 JumpB
	var_15_string = "health"; // 0x783 PushS
	GetProperty(var_15_string, var_12_float); // 0x784 Func
	var_16_int = 0; // 0x786 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x787 LE
	if(var_17_bool == 0) goto Label_1931; // 0x788 JumpB
	SignalDeath(var_9_object); // 0x789 Func
...
{
	var_10_object = Obj(); // 0x78d PushV
	var_10_object = var_9_object; // 0x78e Mov
	func_1893(var_10_object); // 0x78f NEW_2
...
Label_147:
	...
	var_605_int = 1; // 0x99 PushI
	Sleep(var_605_int); // 0x9a Func
...
func_1808(var_538_float)
{
	...
	var_541_int = 0; // 0x715 PushI
	var_542_bool = var_538_float < var_541_int; // 0x716 LT
	if(var_542_bool == 0) goto Label_1820; // 0x717 JumpB
	var_543_float = 0.7; // 0x718 PushF
	var_544_int = 500; // 0x719 PushI
	RumblePlay(var_543_float, var_544_int); // 0x71a Func
	
Label_1820:
	var_545_int = 15; // 0x71c PushI
	SendWorldWndMessage(var_545_int, var_540_object); // 0x71d Func
...
{
	var_188_object = Obj(); var_189_object = Obj(); // 0x721 PushV
	FindActor(var_189_object, var_186_string); // 0x722 Func
	var_190_bool = var_189_object == 0; // 0x724 NullEq
	if(var_190_bool == 0) goto Label_1832; // 0x725 JumpB
	var_185_bool = 0; // 0x726 MovB
	return 2; // 0x727 Return
	
Label_1832:
	Trigger(var_189_object, var_187_string); // 0x728 Func
	var_185_bool = 1; // 0x72a MovB
...
Label_321:
	...
	var_589_string = "all"; // 0x143 PushS
	var_590_string = "fjump"; // 0x144 PushS
	PlayAnimation(var_589_string, var_590_string); // 0x145 Func
	WaitForAnimEnd(); // 0x147 Func
	func_807(var_134_float); // 0x14a NEW_2
	var_591_cvector = CVector(0.0, 0.0, 0.0); // 0x14c PushVec
	SetSpeed(var_591_cvector); // 0x14d Func
	Stop(); // 0x14f Func
	StopAsync(); // 0x151 Func
	var_592_bool = 0; // 0x153 PushV
	func_764(var_134_float, var_592_bool); // 0x154 NEW_2
	var_593_bool = var_592_bool == 0; // 0x156 Not
	if(var_593_bool == 0) goto Label_367; // 0x157 JumpB
	var_594_bool = 0; var_595_object = Obj(); // 0x158 PushV
	var_595_object = var_0_object; // 0x159 MovT
	func_1472(var_594_bool, var_595_object); // 0x15a NEW_2
	var_596_bool = var_594_bool == 0; // 0x15c Not
	if(var_596_bool == 0) goto Label_351; // 0x15d JumpB
...
Label_351:
	...
	var_597_float = var_112_float * var_112_float; // 0x165 Mult
	var_598_bool = var_131_float < var_597_float; // 0x166 LT
	if(var_598_bool == 0) goto Label_367; // 0x167 JumpB
	var_599_bool = 0; var_600_float = 0; // 0x168 PushV
	var_600_float = var_112_float; // 0x169 Mov
	func_468(var_134_float, var_599_bool, var_600_float); // 0x16a NEW_2
	var_601_bool = var_599_bool == 0; // 0x16c Not
	if(var_601_bool == 0) goto Label_367; // 0x16d JumpB
	goto Label_377; // 0x16e Jump
	
Label_368:
	var_602_bool = 0; var_603_float = 0; // 0x170 PushV
	var_603_float = var_112_float; // 0x171 Mov
	func_468(var_134_float, var_602_bool, var_603_float); // 0x172 NEW_2
	var_604_bool = var_602_bool == 0; // 0x174 Not
	if(var_604_bool == 0) goto Label_375; // 0x175 JumpB
...
func_807(var_0_object)
{
	...
	func_1873(var_206_object); // 0x329 NEW_2
...
func_429(var_0_object, var_468_float, var_469_int)
{
	...
	var_547_int = 0; // 0x1c8 PushV
	func_812(var_547_int); // 0x1c9 NEW_2
	ReportHit(var_0_object, var_547_int, var_475_float, var_474_float); // 0x1cb Func
	var_548_object = Obj(); var_549_float = 0; // 0x1cd PushV
	var_548_object = var_473_object; // 0x1ce Mov
	var_549_float = var_475_float; // 0x1cf Mov
...
{
	var_168_object = Obj(); var_169_bool = 0; var_170_cvector = CVector(0,0,0); var_171_cvector = CVector(0,0,0); var_172_object = Obj(); var_173_bool = 0; var_174_cvector = CVector(0,0,0); var_175_cvector = CVector(0,0,0); // 0x72d PushV
	var_176_bool = var_165_object == 0; // 0x72e Not
	if(var_176_bool == 0) goto Label_1841; // 0x72f JumpB
	return 8; // 0x730 Return
	
Label_1841:
	GetSceneByName(var_172_object, var_166_string); // 0x731 Func
	GetLocator(var_167_string, var_173_bool, var_174_cvector, var_175_cvector); // 0x733 ObjFunc
	var_177_bool = var_173_bool == 0; // 0x735 Not
	if(var_177_bool == 0) goto Label_1857; // 0x736 JumpB
	var_178_string = "Teleport location '"; // 0x737 PushS
	var_179_int = var_178_string + var_167_string; // 0x738 Add
	var_180_string = "' not found in scene '"; // 0x739 PushS
	var_181_int = var_179_int + var_180_string; // 0x73a Add
	var_182_int = var_181_int + var_166_string; // 0x73b Add
	var_183_string = "'"; // 0x73c PushS
	var_184_int = var_182_int + var_183_string; // 0x73d Add
	Trace(var_184_int); // 0x73e Func
	goto Label_1859; // 0x740 Jump
	
Label_1859:
	return 8; // 0x743 Return
	
Label_1857:
	Teleport(var_165_object, var_172_object, var_174_cvector, var_175_cvector); // 0x741 Func
}
...
func_827(var_2_int, var_213_bool, var_214_object, var_215_float, var_216_float, var_217_bool, var_218_bool)
{
	...
	func_1873(var_226_object); // 0x33e NEW_2
...
func_1083(var_11_object)
{
	...
	func_1861(var_97_bool, var_98_string); // 0x447 NEW_2
	...
	func_1837(var_165_object, var_166_string, var_167_string); // 0x499 NEW_2
	...
	func_1825(var_185_bool, var_186_string, var_187_string); // 0x49e NEW_2
...
{
	var_99_object = Obj(); var_100_object = Obj(); // 0x745 PushV
	FindActor(var_100_object, var_98_string); // 0x746 Func
	var_101_bool = var_100_object == 0; // 0x748 Not
	if(var_101_bool == 0) goto Label_1868; // 0x749 JumpB
	var_97_bool = 0; // 0x74a MovB
	return 2; // 0x74b Return
	
Label_1868:
	RemoveActor(var_100_object); // 0x74c Func
	var_97_bool = 1; // 0x74e MovB
...
Label_1377:
	var_546_string = "armor"; // 0x561 PushS
	GetProperty(var_546_string, var_495_int); // 0x562 ObjFunc
}
...
{
	var_207_bool = 0; var_208_bool = 0; // 0x751 PushV
	IsPlayerActor(var_206_object, var_208_bool); // 0x752 Func
	var_209_bool = var_208_bool; // 0x754 Push
	if(var_209_bool == 0) goto Label_1881; // 0x755 JumpB
	var_210_string = "attack"; // 0x756 PushS
	PlayGlobalMusic(var_210_string); // 0x757 Func
...
Label_504:
	...
	var_550_string = "all"; // 0x1fd PushS
	var_551_string = "attack_middle"; // 0x1fe PushS
	var_552_int = var_551_string + var_437_int; // 0x1ff Add
	HasAnimation(var_438_bool, var_550_string, var_552_int); // 0x200 Func
	var_553_bool = var_438_bool; // 0x202 Push
	if(var_553_bool == 0) goto Label_585; // 0x203 JumpB
	func_1882(); // 0x205 NEW_2
	var_554_string = "all"; // 0x207 PushS
	var_555_string = "attack_middle"; // 0x208 PushS
	var_556_int = var_555_string + var_437_int; // 0x209 Add
	PlayAnimation(var_554_string, var_556_int); // 0x20a Func
	WaitForAnimEnd(); // 0x20c Func
	func_807(var_440_string); // 0x20f NEW_2
	var_557_bool = 0; var_558_object = Obj(); // 0x211 PushV
	var_558_object = var_0_object; // 0x212 MovT
	func_1472(var_557_bool, var_558_object); // 0x213 NEW_2
	var_559_bool = var_557_bool == 0; // 0x215 Not
	if(var_559_bool == 0) goto Label_539; // 0x216 JumpB
	StopAsync(); // 0x217 Func
	var_431_bool = 0; // 0x219 MovB
	return 8; // 0x21a Return
	
Label_539:
	var_560_float = 0; var_561_int = 0; // 0x21b PushV
	var_560_float = var_432_float; // 0x21c Mov
	var_561_int = var_437_int; // 0x21d Mov
	func_429(var_440_string, var_560_float, var_561_int); // 0x21e NEW_2
	var_439_int = 1; // 0x220 MovI
	
Label_545:
	var_562_string = "attack_middle"; // 0x221 PushS
	var_563_int = var_562_string + var_437_int; // 0x222 Add
	var_564_string = "_"; // 0x223 PushS
	var_565_int = var_563_int + var_564_string; // 0x224 Add
	var_440_string = var_565_int + var_439_int; // 0x225 Add2
	var_566_string = "all"; // 0x226 PushS
	HasAnimation(var_438_bool, var_566_string, var_440_string); // 0x227 Func
	var_567_bool = var_438_bool == 0; // 0x229 Not
	if(var_567_bool == 0) goto Label_556; // 0x22a JumpB
	goto Label_585; // 0x22b Jump
	
Label_585:
	var_568_bool = 0; // 0x249 PushB
	SetAttackState(var_568_bool); // 0x24a Func
	var_569_string = "all"; // 0x24c PushS
	var_570_string = "attack_end"; // 0x24d PushS
	var_571_int = var_570_string + var_437_int; // 0x24e Add
	PlayAnimation(var_569_string, var_571_int); // 0x24f Func
	var_572_bool = 0; // 0x251 PushV
	func_821(var_572_bool); // 0x252 NEW_2
	if(var_572_bool == 0) goto Label_603; // 0x254 JumpB
	var_573_bool = 0; var_574_float = 0; // 0x255 PushV
	var_574_float = 0.75; // 0x256 MovF
	func_605(var_573_bool, var_574_float); // 0x257 NEW_2
...
Label_556:
	func_1882(); // 0x22d NEW_2
	var_582_string = "all"; // 0x22f PushS
	PlayAnimation(var_582_string, var_440_string); // 0x230 Func
	WaitForAnimEnd(); // 0x232 Func
	func_807(var_440_string); // 0x235 NEW_2
	var_583_bool = 0; var_584_object = Obj(); // 0x237 PushV
	var_584_object = var_0_object; // 0x238 MovT
	func_1472(var_583_bool, var_584_object); // 0x239 NEW_2
	var_585_bool = var_583_bool == 0; // 0x23b Not
	if(var_585_bool == 0) goto Label_577; // 0x23c JumpB
	StopAsync(); // 0x23d Func
	var_431_bool = 0; // 0x23f MovB
	return 8; // 0x240 Return
	
Label_577:
	var_586_float = 0; var_587_int = 0; // 0x241 PushV
	var_586_float = var_432_float; // 0x242 Mov
	var_587_int = var_437_int; // 0x243 Mov
	func_429(var_440_string, var_586_float, var_587_int); // 0x244 NEW_2
	var_588_int = 1; // 0x246 PushI
	var_439_int = var_439_int + var_588_int; // 0x247 Add2
...
func_1882()
{
	var_443_object = Obj(); var_444_object = Obj(); // 0x75a PushV
	GetScene(var_444_object); // 0x75b Func
	var_445_string = "battle"; // 0x75d PushS
	var_446_object = Obj(); // 0x75e PushV
	func_1762(var_446_object); // 0x75f NEW_2
	BroadcastMessage(var_445_string, var_446_object, var_444_object); // 0x761 Func
...
{
	var_575_float = 0; var_576_bool = 0; var_577_float = 0; var_578_bool = 0; // 0x25d PushV
	rand(var_577_float); // 0x25e Func
	var_579_bool = var_577_float < var_574_float; // 0x260 LT
	if(var_579_bool == 0) goto Label_625; // 0x261 JumpB
	
Label_610:
	IsAnimationPlaying(var_578_bool); // 0x262 Func
	var_580_bool = var_578_bool == 0; // 0x264 Not
	if(var_580_bool == 0) goto Label_615; // 0x265 JumpB
...
Label_630:
	var_573_bool = 0; // 0x276 MovB
	return 4; // 0x277 Return
	
Label_615:
	var_581_bool = 0; // 0x267 PushV
	func_703(var_581_bool); // 0x268 NEW_2
	if(var_581_bool == 0) goto Label_621; // 0x26a JumpB
	var_573_bool = 1; // 0x26b MovB
...
Label_625:
	...
	func_807(var_578_bool); // 0x274 NEW_2
}
...
{
	var_11_object = Obj(); // 0x766 PushV
	var_11_object = var_10_object; // 0x767 Mov
	TaskCall(2); // 0x768 TaskCall
	func_1083(var_11_object); // 0x769 NEW_2
	TaskReturn(); // 0x76a TaskReturn
