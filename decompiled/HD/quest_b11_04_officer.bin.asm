...
0x2cf: Push("Can't find lsh animation : ")
...
0x2de: Push("Can't find lsh animation : ")
...
0x326: Stack[-1] = "ui/NPC_Citizen2.png"
0x327: Return(); Pop(0)

0x328: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x329: Return(); Pop(0)
...
0x353: Push("Can't retrieve diary root")
0x354: @ Trace(Stack[-1])
0x355: Pop(1)
...
0x35f: Pop(1)
0x360: @@ Find(Stack[-7], Stack[-2])
0x361: Pop(0)
0x362: Pop(0); Push((bool) Stack[-2] == 0)
0x363: IF (Stack[-1] == 0) GOTO 0x36a; Pop(1)

0x364: Push("Can't find diary parent with id: ")
...
0x36a: @@ AddChild(Stack[-8])
0x36b: Pop(0)
0x36c: Push((int) 7)
0x36d: @ SendWorldWndMessage(Stack[-1])
0x36e: Pop(1)
0x36f: @@ GetCategory(Stack[-1])
0x370: Pop(0)
