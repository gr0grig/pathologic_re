...
Label_196:
	...
	func_821(var_52_object); // 0xc9 NEW_2
...
Label_344:
	...
	func_810(var_132_bool); // 0x15a NEW_2
...
Label_434:
	...
	func_757(var_19_object); // 0x1b4 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_739(var_29_object); // 0x1f1 NEW_2
...
Label_56:
	var_150_bool = var_26_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_151_object = var_17_object; // 0x40 Mov
	func_690(); // 0x41 NEW_2
...
{
	var_99_int = 0; var_100_int = 0; // 0x305 PushV
	GetVariable(var_98_string, var_100_int); // 0x306 Func
	var_97_int = var_100_int; // 0x308 Mov
...
Label_405:
	...
	func_757(var_21_object); // 0x197 NEW_2
...
{
	var_54_string = ""; var_55_string = ""; // 0x30a PushV
	var_55_string = "idle"; // 0x30b MovS
	var_56_int = var_53_int; // 0x30c Push
	if(var_56_int == 0) goto Label_783; // 0x30d JumpB
	var_55_string = var_55_string + var_53_int; // 0x30e Add2
	
Label_783:
	var_52_string = var_55_string; // 0x30f Mov
...
Label_531:
	...
	func_785(var_46_int); // 0x214 NEW_2
...
Label_546:
	...
	func_778(var_68_string, var_69_int); // 0x230 NEW_2
...
func_785(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x311 PushV
	var_49_int = 0; // 0x312 MovI
	
Label_787:
	var_51_string = "all"; // 0x313 PushS
	var_52_string = ""; var_53_int = 0; // 0x314 PushV
	var_53_int = var_49_int; // 0x315 Mov
	func_778(var_52_string, var_53_int); // 0x316 NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x318 Func
	var_57_bool = var_50_bool == 0; // 0x31a Not
	if(var_57_bool == 0) goto Label_797; // 0x31b JumpB
	goto Label_800; // 0x31c Jump
	
Label_800:
	var_46_int = var_49_int; // 0x320 Mov
	return 4; // 0x321 Return
	
Label_797:
	var_58_int = 1; // 0x31d PushI
	var_49_int = var_49_int + var_58_int; // 0x31e Add2
...
{
	var_104_bool = 0; // 0x99 PushV
	func_810(var_104_bool); // 0x9a NEW_2
	var_105_bool = var_104_bool == 0; // 0x9c Not
	if(var_105_bool == 0) goto Label_159; // 0x9d JumpB
	return 0; // 0x9e Return
	
Label_159:
	var_106_bool = var_103_string == var_2_object; // 0x9f Eq
	if(var_106_bool == 0) goto Label_162; // 0xa0 JumpB
	return 0; // 0xa1 Return
	
Label_162:
	var_107_string = ""; var_108_bool = 0; // 0xa2 PushV
	var_107_string = var_103_string; // 0xa3 Mov
	var_109_string = ""; // 0xa4 PushS
	var_110_bool = var_103_string == var_109_string; // 0xa5 Eq
	if(var_110_bool == 0) goto Label_169; // 0xa6 JumpB
	var_108_bool = 0; // 0xa7 MovB
	goto Label_170; // 0xa8 Jump
	
Label_170:
	func_724(var_107_string, var_108_bool); // 0xaa NEW_2
	var_2_object = var_103_string; // 0xac TMov
	return 0; // 0xad Return
	
Label_169:
	var_108_bool = 1; // 0xa9 MovB
}


func_802(var_76_int)
{
	var_76_int = 515597; // 0x322 MovI
...
{
	var_77_string = "ui/NPC_Citizen2.png"; // 0x326 MovS
...
{
	var_78_string = "ui/NPC_Citizen2_b.png"; // 0x328 MovS
...
func_812()
{
	var_20_string = "b11q04"; // 0x32d PushS
	var_21_int = 3; // 0x32e PushI
	SetVariable(var_20_string, var_21_int); // 0x32f Func
	func_833(); // 0x332 NEW_2
...
func_690()
{
	var_152_bool = 0; var_153_bool = 0; // 0x2b2 PushV
	var_154_bool = 1; // 0x2b3 PushB
	CameraSwitchToNormal(var_154_bool); // 0x2b4 Func
	var_155_bool = 0; // 0x2b6 PushV
	func_810(var_155_bool); // 0x2b7 NEW_2
	if(var_155_bool == 0) goto Label_699; // 0x2b9 JumpB
...
Label_699:
	var_156_string = "head"; // 0x2bb PushS
	HasAnimationTrack(var_153_bool, var_156_string); // 0x2bc Func
	var_157_bool = var_153_bool; // 0x2be Push
	if(var_157_bool == 0) goto Label_707; // 0x2bf JumpB
	var_158_string = "head"; // 0x2c0 PushS
	UnlookAsync(var_158_string); // 0x2c1 Func
}


func_821(var_95_bool)
{
	var_97_int = 0; var_98_string = ""; // 0x336 PushV
	var_98_string = "b11q04"; // 0x337 MovS
	func_773(var_97_int, var_98_string); // 0x338 NEW_2
	var_101_int = 2; // 0x33a PushI
	var_102_bool = var_97_int == var_101_int; // 0x33b Eq
	if(var_102_bool == 0) goto Label_831; // 0x33c JumpB
	var_95_bool = 1; // 0x33d MovB
	return 0; // 0x33e Return
	
Label_831:
	var_95_bool = 0; // 0x33f MovB
...
func_833()
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x341 PushV
	var_24_int = 554; // 0x342 PushI
	var_25_int = 2; // 0x343 PushI
	var_26_int = 530529; // 0x344 PushI
	CreateDiaryEntry(var_23_object, var_24_int, var_25_int, var_26_int); // 0x345 Func
	var_27_bool = 0; var_28_object = Obj(); var_29_int = 0; // 0x347 PushV
	var_28_object = var_23_object; // 0x348 Mov
	var_29_int = 551; // 0x349 MovI
	func_859(var_27_bool, var_28_object, var_29_int); // 0x34a NEW_2
...
{
	var_127_bool = 0; var_128_float = 0; var_129_float = 0; var_130_bool = 0; var_131_float = 0; var_132_float = 0; // 0x2c4 PushV
	lshHasAnimation(var_130_bool, var_126_string); // 0x2c5 Func
	var_133_bool = var_130_bool; // 0x2c7 Push
	if(var_133_bool == 0) goto Label_719; // 0x2c8 JumpB
	lshGetAnimTimes(var_126_string, var_131_float, var_132_float); // 0x2c9 Func
	var_134_bool = 0; // 0x2cb PushB
	lshPlayAnimation(var_131_float, var_132_float, var_134_bool); // 0x2cc Func
...
Label_719:
	var_135_string = "Can't find lsh animation : "; // 0x2cf PushS
	var_136_int = var_135_string + var_126_string; // 0x2d0 Add
	Trace(var_136_int); // 0x2d1 Func
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_821(var_96_object); // 0x52 NEW_2
	if(var_95_bool == 0) goto Label_100; // 0x54 JumpB
	var_103_string = ""; // 0x55 PushV
	var_103_string = "Neutral"; // 0x56 MovS
	func_152(var_89_object, var_103_string); // 0x57 NEW_2
	var_120_int = 530515; // 0x59 PushI
	SetMessage(var_120_int); // 0x5a TObjFunc
	ClearReplies(); // 0x5c TObjFunc
	var_121_int = 530516; // 0x5e PushI
	var_122_int = 32774; // 0x5f PushI
	var_123_int = 31875; // 0x60 PushI
	AddReply(var_121_int, var_122_int, var_123_int); // 0x61 TObjFunc
	goto Label_122; // 0x63 Jump
	
Label_122:
	var_124_bool = 0; // 0x7a PushV
	func_810(var_124_bool); // 0x7b NEW_2
	if(var_124_bool == 0) goto Label_137; // 0x7d JumpB
	
Label_126:
	lshWaitForAnimEnd(); // 0x7e Func
	var_125_string = var_3_string; // 0x80 PushT
	if(var_125_string == 0) goto Label_131; // 0x81 JumpB
...
Label_131:
	var_126_string = ""; // 0x83 PushV
	var_126_string = var_2_object; // 0x84 MovT
	func_708(var_126_string); // 0x85 NEW_2
	goto Label_126; // 0x87 Jump
	
Label_137:
	var_137_string = "all"; // 0x89 PushS
	var_138_string = "idle"; // 0x8a PushS
	PlayAnimation(var_137_string, var_138_string); // 0x8b Func
...
Label_146:
	var_140_string = "all"; // 0x92 PushS
	var_141_string = "idle"; // 0x93 PushS
	PlayAnimation(var_140_string, var_141_string); // 0x94 Func
	goto Label_141; // 0x96 Jump
	
Label_100:
	var_142_string = ""; // 0x64 PushV
	var_142_string = "Neutral"; // 0x65 MovS
	func_152(var_89_object, var_142_string); // 0x66 NEW_2
	var_143_int = 530523; // 0x68 PushI
	SetMessage(var_143_int); // 0x69 TObjFunc
	ClearReplies(); // 0x6b TObjFunc
	var_144_int = 530524; // 0x6d PushI
	var_145_int = -1; // 0x6e PushI
	var_146_int = 31883; // 0x6f PushI
	AddReply(var_144_int, var_145_int, var_146_int); // 0x70 TObjFunc
	var_147_int = 531426; // 0x72 PushI
	var_148_int = -1; // 0x73 PushI
	var_149_int = 32770; // 0x74 PushI
...
{
	var_37_object = Obj(); var_38_object = Obj(); // 0x34e PushV
	GetDiaryRoot(var_38_object); // 0x34f Func
	var_39_bool = var_38_object == 0; // 0x351 Not
	if(var_39_bool == 0) goto Label_856; // 0x352 JumpB
	var_40_string = "Can't retrieve diary root"; // 0x353 PushS
	Trace(var_40_string); // 0x354 Func
	var_36_object = 0; // 0x356 MovB
	return 2; // 0x357 Return
	
Label_856:
	var_36_object = var_38_object; // 0x358 Mov
...
{
	var_111_bool = 0; var_112_float = 0; var_113_float = 0; var_114_bool = 0; var_115_float = 0; var_116_float = 0; // 0x2d4 PushV
	lshHasAnimation(var_114_bool, var_107_string); // 0x2d5 Func
	var_117_bool = var_114_bool; // 0x2d7 Push
	if(var_117_bool == 0) goto Label_734; // 0x2d8 JumpB
	lshGetAnimTimes(var_107_string, var_115_float, var_116_float); // 0x2d9 Func
	lshPlayAnimation(var_115_float, var_116_float, var_108_bool); // 0x2db Func
...
Label_734:
	var_118_string = "Can't find lsh animation : "; // 0x2de PushS
	var_119_int = var_118_string + var_107_string; // 0x2df Add
	Trace(var_119_int); // 0x2e0 Func
}
...
{
	var_30_object = Obj(); var_31_object = Obj(); var_32_int = 0; var_33_object = Obj(); var_34_object = Obj(); var_35_int = 0; // 0x35b PushV
	var_36_object = Obj(); // 0x35c PushV
	func_846(var_36_object); // 0x35d NEW_2
	var_33_object = var_36_object; // 0x35e Mov
	Find(var_29_int, var_34_object); // 0x360 ObjFunc
	var_41_bool = var_34_object == 0; // 0x362 Not
	if(var_41_bool == 0) goto Label_874; // 0x363 JumpB
	var_42_string = "Can't find diary parent with id: "; // 0x364 PushS
	var_43_int = var_42_string + var_29_int; // 0x365 Add
	Trace(var_43_int); // 0x366 Func
	var_27_bool = 0; // 0x368 MovB
	return 6; // 0x369 Return
	
Label_874:
	AddChild(var_28_object); // 0x36a ObjFunc
	var_44_int = 7; // 0x36c PushI
	SendWorldWndMessage(var_44_int); // 0x36d Func
	GetCategory(var_35_int); // 0x36f ObjFunc
	SetDiarySection(var_35_int); // 0x371 Func
	var_27_bool = 0; // 0x373 MovB
...
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x2e3 PushV
	GetEyesHeight(var_32_float); // 0x2e4 ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x2e6 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x2e7 PushE
	var_34_float = var_32_float; // 0x2e8 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x2e9 PopE
	var_35_string = "head"; // 0x2ea PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x2eb Func
...
func_621(var_27_bool, var_29_float)
{
	...
	func_763(var_54_cvector, var_55_cvector); // 0x288 NEW_2
...
Label_662:
	...
	var_67_bool = 1; // 0x298 PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x299 Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x29b PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x29c PushE
	Rotate(var_68_float, var_69_float); // 0x29d Func
	var_70_bool = 0; // 0x29f PushV
	func_810(var_70_bool); // 0x2a0 NEW_2
	if(var_70_bool == 0) goto Label_676; // 0x2a2 JumpB
...
Label_676:
	var_71_string = "head"; // 0x2a4 PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x2a5 Func
	var_72_bool = var_47_bool; // 0x2a7 Push
	if(var_72_bool == 0) goto Label_684; // 0x2a8 JumpB
	var_73_string = "head"; // 0x2a9 PushS
	LookAsyncCamera(var_73_string); // 0x2aa Func
}


func_750()
{
	var_15_bool = 0; // 0x2ee PushV
	func_810(var_15_bool); // 0x2ef NEW_2
	if(var_15_bool == 0) goto Label_756; // 0x2f1 JumpB
	lshStopSpeech(); // 0x2f2 Func
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x2f5 PushV
	self(var_21_object); // 0x2f6 Func
	var_19_object = var_21_object; // 0x2f8 Mov
...
func_887(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x377 PushV
	var_82_string = "branch"; // 0x378 PushS
	GetVariable(var_82_string, var_81_int); // 0x379 Func
	var_83_int = 0; // 0x37b PushI
	var_84_bool = var_81_int == var_83_int; // 0x37c Eq
	if(var_84_bool == 0) goto Label_897; // 0x37d JumpB
	var_79_int = 1; // 0x37e MovI
	return 2; // 0x37f Return
	
Label_897:
	var_85_int = 1; // 0x381 PushI
	var_86_bool = var_81_int == var_85_int; // 0x382 Eq
	if(var_86_bool == 0) goto Label_902; // 0x383 JumpB
	var_79_int = 2; // 0x384 MovI
	return 2; // 0x385 Return
	
Label_902:
	var_79_int = 3; // 0x386 MovI
...
{
	var_57_float = 0; var_58_float = 0; // 0x2fb PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x2fc Or
	var_58_float = sqrt(var_59_int); // 0x2fd Sqrt2
	var_60_float = 0.0; // 0x2fe PushF
	var_61_bool = var_58_float < var_60_float; // 0x2ff LT
	if(var_61_bool == 0) goto Label_771; // 0x300 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x301 MovV
	return 2; // 0x302 Return
	
Label_771:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x303 Div2
