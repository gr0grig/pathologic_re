...
0x2bc: Push("Can't find lsh animation : ")
...
0x315: Stack[-1] = "ui/NPC_Citizen3.png"
0x316: Return(); Pop(0)

0x317: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x318: Return(); Pop(0)
...
0x323: Pop(1)
0x324: Push("b11q04SanitarGotoOfficer")
0x325: Push("pt_gmap_vagon_army")
0x326: Push((int) 0)
...
0x32a: Pop(0)
0x32b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x32c: Pop(5)
0x32d: PushEmpty()
0x32e: Call2 0x353
...
0x331: Stack[-2] = "quest_b11_04"
0x332: Stack[-1] = "place_officer"
0x333: Call2 0x2e8
...
0x33b: Stack[-4] = Stack[-1]
0x33c: Pop(1)
0x33d: Stack[-2] = "pt_gmap_vagon_army"
0x33e: Stack[-1] = (int) 2
0x33f: Call2 0x39a
...
0x343: Pop(0)
0x344: @@ ShowMap(Stack[-1])
0x345: Pop(1)
0x346: Return(); Pop(0)

0x347: PushEmpty()
0x348: PushEmpty(int, string)
0x349: Stack[-1] = "b11q04"
0x34a: Call2 0x2e3
...
0x365: Push("Can't retrieve diary root")
0x366: @ Trace(Stack[-1])
0x367: Pop(1)
...
0x371: Pop(1)
0x372: @@ Find(Stack[-7], Stack[-2])
0x373: Pop(0)
0x374: Pop(0); Push((bool) Stack[-2] == 0)
0x375: IF (Stack[-1] == 0) GOTO 0x37c; Pop(1)

0x376: Push("Can't find diary parent with id: ")
...
0x37c: @@ AddChild(Stack[-8])
0x37d: Pop(0)
0x37e: Push((int) 7)
0x37f: @ SendWorldWndMessage(Stack[-1])
0x380: Pop(1)
0x381: @@ GetCategory(Stack[-1])
0x382: Pop(0)
...
0x38e: Push("Can't find main outdoor scene")
0x38f: @ Trace(Stack[-1])
0x390: Pop(1)
0x391: Stack[-1] = 0
...
0x39f: Push("Can't find main outdoor scene")
0x3a0: @ Trace(Stack[-1])
0x3a1: Pop(1)
0x3a2: Return(); Pop(8)

0x3a3: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x3a4: Pop(0)
0x3a5: Pop(0); Push((bool) Stack[-1] == 0)
0x3a6: IF (Stack[-1] == 0) GOTO 0x3ad; Pop(1)

0x3a7: Push("Warning: outdoor scene locator ")
0x3a8: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3a9: Push(" doesnt exist")
0x3aa: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3ab: @ Trace(Stack[-1])
0x3ac: Pop(1)
0x3ad: @@ GetMap(Stack[-11])
0x3ae: Pop(0)
0x3af: Pop(0); Push((bool) Stack[-11] == 0)
0x3b0: IF (Stack[-1] == 0) GOTO 0x3b5; Pop(1)

0x3b1: Push("Can't find map")
0x3b2: @ Trace(Stack[-1])
0x3b3: Pop(1)
0x3b4: Return(); Pop(8)
...
0x3b7: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x3b8: Pop(2)
0x3b9: Return(); Pop(8)
