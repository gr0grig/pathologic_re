...
0x2cb: @@ HasProperty(Stack[-1], Stack[-4])
0x2cc: Pop(1)
...
0x2e0: @@ GetProperty(Stack[-1], Stack[-2])
0x2e1: Pop(1)
0x2e2: PushEmpty(bool, string)
0x2e3: Stack[-1] = Stack[-3]
0x2e4: Call2 0x332

0x2e5: Stack[-14] = Stack[-2]
0x2e6: Pop(2)
0x2e7: Return(); Pop(10)
...
0x32d: Push("Can't find lsh animation : ")
...
0x37a: Stack[-1] = "oob12KapellaSobor1"
0x37b: Call2 0x358
...
0x399: Stack[-1] = "ui/NPC_Kapella.png"
0x39a: Return(); Pop(0)

0x39b: Stack[-1] = "ui/NPC_Kapella_b.png"
0x39c: Return(); Pop(0)
