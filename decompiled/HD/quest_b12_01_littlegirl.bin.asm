...
0x346: Push("locked")
0x347: @@ SetProperty(Stack[-1], Stack[-4])
0x348: Pop(1)
0x349: Return(); Pop(2)

0x34a: Stack[-1] = 0
0x34b: PushEmpty()
0x34c: Push("oob12Littlegirl1")
0x34d: Push((int) 1)
...
0x359: Stack[-2] = "mnogogrannik@door2"
...
0x37e: PushEmpty()
0x37f: Push("b12q01ChildsAreVisited")
0x380: Push((int) 1)
...
0x386: Stack[-1] = "oob12Littlegirl1"
0x387: Call2 0x335
...
0x392: Stack[-1] = "oob12Littlegirl2"
0x393: Call2 0x335
...
0x3ae: Push("Can't retrieve diary root")
0x3af: @ Trace(Stack[-1])
0x3b0: Pop(1)
...
0x3ba: Pop(1)
0x3bb: @@ Find(Stack[-7], Stack[-2])
0x3bc: Pop(0)
0x3bd: Pop(0); Push((bool) Stack[-2] == 0)
0x3be: IF (Stack[-1] == 0) GOTO 0x3c5; Pop(1)

0x3bf: Push("Can't find diary parent with id: ")
...
0x3c5: @@ AddChild(Stack[-8])
0x3c6: Pop(0)
0x3c7: Push((int) 7)
0x3c8: @ SendWorldWndMessage(Stack[-1])
0x3c9: Pop(1)
0x3ca: @@ GetCategory(Stack[-1])
0x3cb: Pop(0)
...
0x3f8: Stack[-1] = "ui/NPC_Citizen1.png"
0x3f9: Return(); Pop(0)

0x3fa: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x3fb: Return(); Pop(0)
