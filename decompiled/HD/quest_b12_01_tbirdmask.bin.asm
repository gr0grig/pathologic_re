...
0x346: Push("Can't find lsh animation : ")
...
0x355: Push("Can't find lsh animation : ")
...
0x38d: Push("locked")
0x38e: @@ SetProperty(Stack[-1], Stack[-4])
0x38f: Pop(1)
0x390: Return(); Pop(2)
...
0x3b7: PushEmpty()
0x3b8: Push("b12q01TheaterIsVisited")
0x3b9: Push((int) 1)
...
0x3de: Stack[-1] = "ui/NPC_bmask.png"
0x3df: Return(); Pop(0)

0x3e0: Stack[-1] = "ui/NPC_bmask_b.png"
0x3e1: Return(); Pop(0)
