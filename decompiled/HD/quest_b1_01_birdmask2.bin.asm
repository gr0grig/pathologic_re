...
0x2de: Pop(0)
0x2df: Pop(0); Push((bool) Stack[-1] == 0)
...
0x2ec: Stack[-1] = "ui/NPC_bmask.png"
0x2ed: Return(); Pop(0)

0x2ee: Stack[-1] = "ui/NPC_bmask_b.png"
0x2ef: Return(); Pop(0)
...
0x308: Stack[-5] = Stack[-2]
0x309: Return(); Pop(4)

0x30a: PushEmpty()
0x30b: Push("oob1Birdmask2_1")
0x30c: Push((int) 1)
0x30d: @ SetVariable(Stack[-2], Stack[-1])
0x30e: Pop(2)
0x30f: PushEmpty(bool, string, string)
0x310: Stack[-2] = "quest_b1_01"
0x311: Stack[-1] = "remove2"
0x312: Call2 0x2dc
