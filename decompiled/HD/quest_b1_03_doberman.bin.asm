...
0x8ed: Push("Can't find lsh animation : ")
...
0x8fc: Push("Can't find lsh animation : ")
...
0x980: Stack[-5] = Stack[-8]
0x981: Stack[-4] = "reputation"
0x982: Stack[-3] = Stack[-7]
0x983: Stack[-2] = (int) 0
0x984: Stack[-1] = (int) 1
0x985: Call2 0x75d
...
0x9a6: Pop(0)
0x9a7: Pop(0); Push((bool) Stack[-1] == 0)
...
0x9e1: PushEmpty()
0x9e2: Push("b1q03_retreat")
0x9e3: Push((int) 1)
0x9e4: @ SetVariable(Stack[-2], Stack[-1])
0x9e5: Pop(2)
0x9e6: Push((int) 0)
0x9e7: @@ SetReturnValue(Stack[-1])
0x9e8: Pop(1)
0x9e9: Return(); Pop(0)
...
0xa12: Stack[-1] = "ui/NPC_Citizen2.png"
0xa13: Return(); Pop(0)

0xa14: Stack[-1] = "ui/NPC_Citizen2_b.png"
0xa15: Return(); Pop(0)
...
0xa1d: Pop(0)
0xa1e: @@ RemoveStationaryActor(Stack[-1])
0xa1f: Pop(1)
0xa20: Return(); Pop(2)
...
0xa2a: Stack[-1] = (float) -0.1
0xa2b: Call2 0x966

0xa2c: Pop(3)
0xa2d: PushEmpty(bool, string, string)
0xa2e: Stack[-2] = "quest_b1_03"
0xa2f: Stack[-1] = "doberman_dead"
0xa30: Call2 0x9a4
...
0xa3e: Stack[-3] = Stack[-7]
0xa3f: Stack[-2] = Stack[-6]
0xa40: Stack[-1] = Stack[-5]
0xa41: Call2 0x829
...
0xa46: Stack[-5] = Stack[-11]
0xa47: Stack[-4] = Stack[-10]
0xa48: Stack[-3] = Stack[-9]
0xa49: Stack[-2] = Stack[-7]
0xa4a: Stack[-1] = Stack[-6]
0xa4b: Call2 0x86d
...
0xa63: Stack[-1] = Stack[-3]
0xa64: Call2 0x7e5

0xa65: Stack[-4] = Stack[-2]
0xa66: Pop(2)
0xa67: Return(); Pop(0)

0xa68: PushEmpty()
0xa69: PushEmpty(object, bool)
0xa6a: Stack[-2] = Stack[-3]
