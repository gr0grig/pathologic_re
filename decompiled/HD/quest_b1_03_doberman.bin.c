...
Label_371:
	...
	func_2582(var_134_bool); // 0x175 NEW_2
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	var_150_int = 0; // 0x193 PushI
	var_151_bool = var_19_int == var_150_int; // 0x194 Eq
	if(var_151_bool == 0) goto Label_418; // 0x195 JumpB
	var_152_bool = 0; var_153_object = Obj(); var_154_float = 0; // 0x196 PushV
	var_153_object = var_17_bool; // 0x197 Mov
	var_154_float = 0.05; // 0x198 MovF
	func_2406(var_152_bool, var_153_object, var_154_float); // 0x199 NEW_2
	var_190_object = Obj(); // 0x19b PushV
	var_190_object = var_17_bool; // 0x19c Mov
	TaskCall(3); // 0x19d TaskCall
	func_529(var_190_object); // 0x19e NEW_2
...
Label_418:
	var_263_int = 1; // 0x1a2 PushI
	var_264_bool = var_19_int == var_263_int; // 0x1a3 Eq
	if(var_264_bool == 0) goto Label_428; // 0x1a4 JumpB
	var_265_object = Obj(); var_266_bool = 0; // 0x1a5 PushV
	var_265_object = var_17_bool; // 0x1a6 Mov
	var_266_bool = 1; // 0x1a7 MovB
	TaskCall(4); // 0x1a8 TaskCall
	func_739(var_265_object, var_266_bool); // 0x1a9 NEW_2
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2657(var_18_bool, var_19_object); // 0x1b0 NEW_2
	...
	func_2664(var_54_object); // 0x1b8 NEW_2
...
task_3_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2657(var_18_bool, var_19_object); // 0x21d NEW_2
	...
	func_2664(var_55_object); // 0x225 NEW_2
...
task_5_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool, var_17_int)
{
	...
	func_2480(var_20_object); // 0x5ca NEW_2
...
Label_1511:
	...
	func_2305(var_21_object); // 0x5eb NEW_2
...
task_6_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool, var_17_object)
{
	...
	func_2561(var_21_object); // 0x6b4 NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; // 0xa3d PushV
	var_21_object = var_17_object; // 0xa3e Mov
	var_22_int = var_18_int; // 0xa3f Mov
	var_23_float = var_19_float; // 0xa40 Mov
	func_2089(var_21_object, var_22_int, var_23_float); // 0xa41 NEW_2
...
{
	var_23_object = Obj(); var_24_int = 0; var_25_float = 0; var_26_cvector = CVector(0,0,0); var_27_cvector = CVector(0,0,0); // 0xa45 PushV
	var_23_object = var_17_object; // 0xa46 Mov
	var_24_int = var_18_int; // 0xa47 Mov
	var_25_float = var_19_float; // 0xa48 Mov
	var_26_cvector = var_21_cvector; // 0xa49 Mov
	var_27_cvector = var_22_cvector; // 0xa4a Mov
	func_2157(var_25_float, var_26_cvector, var_27_cvector); // 0xa4b NEW_2
...
{
	var_19_float = 0; var_20_float = 0; // 0xa4e PushV
	var_21_string = "health"; // 0xa4f PushS
	var_22_bool = var_18_string == var_21_string; // 0xa50 Eq
	if(var_22_bool == 0) goto Label_2650; // 0xa51 JumpB
	var_23_string = "health"; // 0xa52 PushS
	GetProperty(var_23_string, var_20_float); // 0xa53 Func
	var_24_int = 0; // 0xa55 PushI
	var_25_bool = var_20_float <= var_24_int; // 0xa56 LE
	if(var_25_bool == 0) goto Label_2650; // 0xa57 JumpB
	SignalDeath(var_17_object); // 0xa58 Func
...
{
	var_18_object = Obj(); // 0xa5c PushV
	var_18_object = var_17_object; // 0xa5d Mov
	func_2594(var_18_object); // 0xa5e NEW_2
...
{
	var_22_int = 0; // 0xa02 PushV
	func_2555(var_22_int); // 0xa03 NEW_2
	var_26_int = 1; // 0xa05 PushI
	var_27_bool = var_22_int == var_26_int; // 0xa06 Eq
	if(var_27_bool == 0) goto Label_2571; // 0xa07 JumpB
	WorkWithCorpse(var_21_object); // 0xa08 Func
	goto Label_2573; // 0xa0a Jump
	
Label_2573:
	return 0; // 0xa0d Return
	
Label_2571:
	Barter(var_21_object); // 0xa0b Func
}


func_2305(var_21_object)
{
	var_22_float = 0; var_23_cvector = CVector(0,0,0); var_24_float = 0; var_25_cvector = CVector(0,0,0); // 0x901 PushV
	GetEyesHeight(var_24_float); // 0x902 ObjFunc
	var_25_cvector = CVector(0.0, 0.0, 0.0); // 0x904 MovV
	var_26_float = GetByIndex(var_25_cvector, 1); // 0x905 PushE
	var_26_float = var_24_float; // 0x906 Mov
	SetByIndex(var_25_cvector, 1) = var_26_float; // 0x907 PopE
	var_27_string = "head"; // 0x908 PushS
	LookAsync(var_21_object, var_27_string, var_25_cvector); // 0x909 Func
	return 4; // 0x90b Return
}
...
func_1029(var_0_object, var_393_float, var_394_int)
{
	...
	var_472_int = 0; // 0x420 PushV
	func_1412(var_472_int); // 0x421 NEW_2
	ReportHit(var_0_object, var_472_int, var_400_float, var_399_float); // 0x423 Func
	var_473_object = Obj(); var_474_float = 0; // 0x425 PushV
	var_473_object = var_398_object; // 0x426 Mov
	var_474_float = var_400_float; // 0x427 Mov
...
func_2316()
{
	var_20_bool = 0; // 0x90c PushV
	func_2582(var_20_bool); // 0x90d NEW_2
	if(var_20_bool == 0) goto Label_2322; // 0x90f JumpB
	lshStopSpeech(); // 0x910 Func
...
{
	func_2584(); // 0x213 NEW_2
	var_199_object = Obj(); // 0x215 PushV
	var_199_object = var_190_object; // 0x216 Mov
	func_582(var_192_cvector, var_193_bool, var_190_object, var_199_object); // 0x217 NEW_2
...
{
	var_81_string = "ui/NPC_Citizen2.png"; // 0xa12 MovS
...
func_1810(var_101_string)
{
	...
	func_2323(var_102_string); // 0x71f NEW_2
...
{
	var_82_string = "ui/NPC_Citizen2_b.png"; // 0xa14 MovS
...
{
	var_103_bool = 0; var_104_int = 0; var_105_bool = 0; var_106_int = 0; var_107_bool = 0; var_108_float = 0; var_109_cvector = CVector(0,0,0); var_110_cvector = CVector(0,0,0); var_111_bool = 0; var_112_int = 0; var_113_bool = 0; var_114_int = 0; var_115_bool = 0; var_116_float = 0; var_117_cvector = CVector(0,0,0); var_118_cvector = CVector(0,0,0); // 0x913 PushV
	IsExisting3DSound(var_111_bool, var_102_string); // 0x914 Func
	var_119_bool = var_111_bool == 0; // 0x916 Not
	if(var_119_bool == 0) goto Label_2348; // 0x917 JumpB
	var_112_int = 0; // 0x918 MovI
	
Label_2329:
	var_120_int = 1; // 0x919 PushI
	var_121_int = var_112_int + var_120_int; // 0x91a Add
	var_122_int = var_102_string + var_121_int; // 0x91b Add
	IsExisting3DSound(var_113_bool, var_122_int); // 0x91c Func
	var_123_bool = var_113_bool == 0; // 0x91e Not
	if(var_123_bool == 0) goto Label_2337; // 0x91f JumpB
	goto Label_2340; // 0x920 Jump
	
Label_2340:
	var_124_bool = var_112_int == 0; // 0x924 Not
	if(var_124_bool == 0) goto Label_2343; // 0x925 JumpB
	return 16; // 0x926 Return
	
Label_2343:
	irand(var_114_int, var_112_int); // 0x927 Func
	var_125_int = 1; // 0x929 PushI
	var_126_int = var_114_int + var_125_int; // 0x92a Add
	var_102_string = var_102_string + var_126_int; // 0x92b Add2
	
Label_2348:
	Is3DSoundLoaded(var_115_bool, var_102_string); // 0x92c Func
	var_127_bool = var_115_bool; // 0x92e Push
	if(var_127_bool == 0) goto Label_2363; // 0x92f JumpB
	GetEyesHeight(var_116_float); // 0x930 Func
	GetDirection(var_117_cvector); // 0x932 Func
	var_128_int = 50; // 0x934 PushI
	var_118_cvector = var_117_cvector * var_128_int; // 0x935 Mult2
	var_129_float = GetByIndex(var_118_cvector, 1); // 0x936 PushE
	var_129_float = var_129_float + var_116_float; // 0x937 Add2
	SetByIndex(var_118_cvector, 1) = var_129_float; // 0x938 PopE
	PlayGlobalSound(var_102_string, var_118_cvector); // 0x939 Func
	
Label_2363:
	return 16; // 0x93b Return
	
Label_2337:
	var_130_int = 1; // 0x921 PushI
	var_112_int = var_112_int + var_130_int; // 0x922 Add2
	goto Label_2329; // 0x923 Jump
}


func_2582(var_74_bool)
{
	var_74_bool = 0; // 0xa16 MovB
...
func_2584()
{
	var_67_object = Obj(); var_68_object = Obj(); // 0xa18 PushV
	GetScene(var_68_object); // 0xa19 Func
	var_69_object = Obj(); // 0xa1b PushV
	func_2364(var_69_object); // 0xa1c NEW_2
	RemoveStationaryActor(var_69_object); // 0xa1e ObjFunc
...
{
	var_19_bool = 0; var_20_object = Obj(); // 0xa23 PushV
	var_20_object = var_18_object; // 0xa24 Mov
	func_1868(var_19_bool, var_20_object); // 0xa25 NEW_2
	if(var_19_bool == 0) goto Label_2610; // 0xa27 JumpB
	var_23_bool = 0; var_24_object = Obj(); var_25_float = 0; // 0xa28 PushV
	var_24_object = var_18_object; // 0xa29 Mov
	var_25_float = -0.1; // 0xa2a MovF
	func_2406(var_23_bool, var_24_object, var_25_float); // 0xa2b NEW_2
	var_61_bool = 0; var_62_string = ""; var_63_string = ""; // 0xa2d PushV
	var_62_string = "quest_b1_03"; // 0xa2e MovS
	var_63_string = "doberman_dead"; // 0xa2f MovS
	func_2468(var_61_bool, var_62_string, var_63_string); // 0xa30 NEW_2
	
Label_2610:
	func_2584(); // 0xa33 NEW_2
	var_72_object = Obj(); // 0xa35 PushV
	var_72_object = var_18_object; // 0xa36 Mov
	TaskCall(6); // 0xa37 TaskCall
	func_1683(var_72_object); // 0xa38 NEW_2
...
func_552(var_31_cvector, var_32_float)
{
	...
	func_2370(var_47_cvector, var_48_cvector); // 0x232 NEW_2
	...
	func_2370(var_45_cvector, var_46_cvector); // 0x237 NEW_2
...
Label_2105:
	...
	func_2370(var_49_cvector, var_50_cvector); // 0x840 NEW_2
...
Label_1104:
	...
	var_475_string = "all"; // 0x455 PushS
	var_476_string = "attack_middle"; // 0x456 PushS
	var_477_int = var_476_string + var_362_int; // 0x457 Add
	HasAnimation(var_363_bool, var_475_string, var_477_int); // 0x458 Func
	var_478_bool = var_363_bool; // 0x45a Push
	if(var_478_bool == 0) goto Label_1185; // 0x45b JumpB
	func_2489(); // 0x45d NEW_2
	var_479_string = "all"; // 0x45f PushS
	var_480_string = "attack_middle"; // 0x460 PushS
	var_481_int = var_480_string + var_362_int; // 0x461 Add
	PlayAnimation(var_479_string, var_481_int); // 0x462 Func
	WaitForAnimEnd(); // 0x464 Func
	func_1407(var_365_string); // 0x467 NEW_2
	var_482_bool = 0; var_483_object = Obj(); // 0x469 PushV
	var_483_object = var_0_object; // 0x46a MovT
	func_2021(var_482_bool, var_483_object); // 0x46b NEW_2
	var_484_bool = var_482_bool == 0; // 0x46d Not
	if(var_484_bool == 0) goto Label_1139; // 0x46e JumpB
	StopAsync(); // 0x46f Func
	var_356_bool = 0; // 0x471 MovB
	return 8; // 0x472 Return
	
Label_1139:
	var_485_float = 0; var_486_int = 0; // 0x473 PushV
	var_485_float = var_357_float; // 0x474 Mov
	var_486_int = var_362_int; // 0x475 Mov
	func_1029(var_365_string, var_485_float, var_486_int); // 0x476 NEW_2
	var_364_int = 1; // 0x478 MovI
	
Label_1145:
	var_487_string = "attack_middle"; // 0x479 PushS
	var_488_int = var_487_string + var_362_int; // 0x47a Add
	var_489_string = "_"; // 0x47b PushS
	var_490_int = var_488_int + var_489_string; // 0x47c Add
	var_365_string = var_490_int + var_364_int; // 0x47d Add2
	var_491_string = "all"; // 0x47e PushS
	HasAnimation(var_363_bool, var_491_string, var_365_string); // 0x47f Func
	var_492_bool = var_363_bool == 0; // 0x481 Not
	if(var_492_bool == 0) goto Label_1156; // 0x482 JumpB
	goto Label_1185; // 0x483 Jump
	
Label_1185:
	var_493_bool = 0; // 0x4a1 PushB
	SetAttackState(var_493_bool); // 0x4a2 Func
	var_494_string = "all"; // 0x4a4 PushS
	var_495_string = "attack_end"; // 0x4a5 PushS
	var_496_int = var_495_string + var_362_int; // 0x4a6 Add
	PlayAnimation(var_494_string, var_496_int); // 0x4a7 Func
	var_497_bool = 0; // 0x4a9 PushV
	func_1421(var_497_bool); // 0x4aa NEW_2
	if(var_497_bool == 0) goto Label_1203; // 0x4ac JumpB
	var_498_bool = 0; var_499_float = 0; // 0x4ad PushV
	var_499_float = 0.75; // 0x4ae MovF
	func_1205(var_498_bool, var_499_float); // 0x4af NEW_2
...
Label_1156:
	func_2489(); // 0x485 NEW_2
	var_507_string = "all"; // 0x487 PushS
	PlayAnimation(var_507_string, var_365_string); // 0x488 Func
	WaitForAnimEnd(); // 0x48a Func
	func_1407(var_365_string); // 0x48d NEW_2
	var_508_bool = 0; var_509_object = Obj(); // 0x48f PushV
	var_509_object = var_0_object; // 0x490 MovT
	func_2021(var_508_bool, var_509_object); // 0x491 NEW_2
	var_510_bool = var_508_bool == 0; // 0x493 Not
	if(var_510_bool == 0) goto Label_1177; // 0x494 JumpB
	StopAsync(); // 0x495 Func
	var_356_bool = 0; // 0x497 MovB
	return 8; // 0x498 Return
	
Label_1177:
	var_511_float = 0; var_512_int = 0; // 0x499 PushV
	var_511_float = var_357_float; // 0x49a Mov
	var_512_int = var_362_int; // 0x49b Mov
	func_1029(var_365_string, var_511_float, var_512_int); // 0x49c NEW_2
	var_513_int = 1; // 0x49e PushI
	var_364_int = var_364_int + var_513_int; // 0x49f Add2
...
{
	var_23_int = 0; var_24_int = 0; // 0x9fb PushV
	var_25_string = "branch"; // 0x9fc PushS
	GetVariable(var_25_string, var_24_int); // 0x9fd Func
	var_22_int = var_24_int; // 0x9ff Mov
...
{
	var_70_object = Obj(); var_71_object = Obj(); // 0x93c PushV
	self(var_71_object); // 0x93d Func
	var_69_object = var_71_object; // 0x93f Mov
...
{
	var_57_float = 0; var_58_float = 0; // 0x942 PushV
	var_59_int = var_50_cvector | var_50_cvector; // 0x943 Or
	var_58_float = sqrt(var_59_int); // 0x944 Sqrt2
	var_60_float = 0.0; // 0x945 PushF
	var_61_bool = var_58_float < var_60_float; // 0x946 LT
	if(var_61_bool == 0) goto Label_2378; // 0x947 JumpB
	var_49_cvector = CVector(0.0, 0.0, 0.0); // 0x948 MovV
	return 2; // 0x949 Return
	
Label_2378:
	var_49_cvector = var_50_cvector / var_50_cvector; // 0x94a Div2
	return 2; // 0x94b Return
}
...
{
	var_200_cvector = CVector(0,0,0); var_201_float = 0; var_202_bool = 0; var_203_cvector = CVector(0,0,0); var_204_float = 0; var_205_cvector = CVector(0,0,0); var_206_float = 0; var_207_bool = 0; var_208_cvector = CVector(0,0,0); var_209_float = 0; // 0x246 PushV
	var_0_object = var_199_object; // 0x247 TMov
	var_210_cvector = CVector(0,0,0); var_211_float = 0; // 0x248 PushV
	var_211_float = 1.74533; // 0x249 MovF
	func_552(var_210_cvector, var_211_float); // 0x24a NEW_2
	var_205_cvector = var_210_cvector; // 0x24b Mov
	var_206_float = var_205_cvector | var_205_cvector; // 0x24d Or2
	var_235_float = 2500.0; // 0x24e PushF
	var_236_bool = var_206_float < var_235_float; // 0x24f LT
	if(var_236_bool == 0) goto Label_611; // 0x250 JumpB
	var_237_cvector = CVector(0,0,0); var_238_float = 0; // 0x251 PushV
	var_238_float = 2.61799; // 0x252 MovF
	func_552(var_237_cvector, var_238_float); // 0x253 NEW_2
	var_205_cvector = var_237_cvector; // 0x254 Mov
	var_206_float = var_205_cvector | var_205_cvector; // 0x256 Or2
	var_239_float = 2500.0; // 0x257 PushF
	var_240_bool = var_206_float < var_239_float; // 0x258 LT
	if(var_240_bool == 0) goto Label_611; // 0x259 JumpB
	var_241_string = "Can't retreat, distance: "; // 0x25a PushS
	var_242_float = sqrt(var_206_float); // 0x25b Sqrt
	var_243_int = var_241_string + var_242_float; // 0x25c Add
	Trace(var_243_int); // 0x25d Func
	var_244_float = 0.5; // 0x25f PushF
	Sleep(var_244_float); // 0x260 Func
	return 10; // 0x262 Return
	
Label_611:
	var_245_float = GetByIndex(var_205_cvector, 0); // 0x263 PushE
	var_246_float = GetByIndex(var_205_cvector, 2); // 0x264 PushE
	Rotate(var_245_float, var_246_float); // 0x265 Func
	var_247_cvector = CVector(0,0,0); // 0x267 PushV
	func_1856(var_247_cvector); // 0x268 NEW_2
	var_1_object = var_247_cvector + var_205_cvector; // 0x26a Add2
	var_250_int = 120; // 0x26b PushI
	var_251_float = 0.5; // 0x26c PushF
	SetTimer(var_250_int, var_251_float); // 0x26d Func
	var_2_object = 0; // 0x26f TMovB
	
Label_624:
	var_252_int = 1; // 0x270 PushI
	MovePoint(var_252_int, var_252_int, var_207_bool); // 0x271 Func
	var_253_bool = var_207_bool; // 0x273 Push
	if(var_253_bool == 0) goto Label_652; // 0x274 JumpB
	var_254_bool = var_0_object == 0; // 0x275 NullEq
	if(var_254_bool == 0) goto Label_633; // 0x276 JumpB
...
Label_633:
	var_255_cvector = CVector(0,0,0); var_256_float = 0; // 0x279 PushV
	var_256_float = 2.61799; // 0x27a MovF
	func_552(var_255_cvector, var_256_float); // 0x27b NEW_2
	var_208_cvector = var_255_cvector; // 0x27c Mov
	var_209_float = var_208_cvector | var_208_cvector; // 0x27e Or2
	var_257_float = 2500.0; // 0x27f PushF
	var_258_bool = var_209_float >= var_257_float; // 0x280 GE
	if(var_258_bool == 0) goto Label_651; // 0x281 JumpB
	var_259_cvector = CVector(0,0,0); // 0x282 PushV
	func_1856(var_259_cvector); // 0x283 NEW_2
	var_1_object = var_259_cvector + var_208_cvector; // 0x285 Add2
	var_260_int = 120; // 0x286 PushI
	var_261_float = 0.5; // 0x287 PushF
	SetTimer(var_260_int, var_261_float); // 0x288 Func
	goto Label_652; // 0x28a Jump
	
Label_652:
	var_262_bool = var_2_object == 0; // 0x28c Not
	if(var_262_bool == 0) goto Label_624; // 0x28d JumpB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_92_object, var_93_object)
{
	...
	var_116_int = 518092; // 0x54 PushI
	SetMessage(var_116_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_117_int = 519592; // 0x59 PushI
	var_118_int = 20773; // 0x5a PushI
	var_119_int = 20772; // 0x5b PushI
	AddReply(var_117_int, var_118_int, var_119_int); // 0x5c TObjFunc
	var_120_int = 519588; // 0x5e PushI
	var_121_int = 20769; // 0x5f PushI
	var_122_int = 20768; // 0x60 PushI
	AddReply(var_120_int, var_121_int, var_122_int); // 0x61 TObjFunc
	goto Label_102; // 0x63 Jump
	
Label_102:
	var_123_bool = 0; // 0x66 PushV
	func_2582(var_123_bool); // 0x67 NEW_2
...
Label_111:
	...
	func_2274(var_125_string); // 0x71 NEW_2
...
{
	var_450_bool = var_446_float < var_447_float; // 0x94d LT
	if(var_450_bool == 0) goto Label_2385; // 0x94e JumpB
	var_445_float = var_446_float; // 0x94f Mov
	goto Label_2386; // 0x950 Jump
	
Label_2386:
	return 0; // 0x952 Return
	
Label_2385:
	var_445_float = var_447_float; // 0x951 Mov
}
...
{
	var_56_bool = var_53_float < var_54_float; // 0x954 LT
	if(var_56_bool == 0) goto Label_2392; // 0x955 JumpB
	var_52_float = var_54_float; // 0x956 Mov
	return 0; // 0x957 Return
	
Label_2392:
	var_57_bool = var_53_float > var_55_float; // 0x958 GT
	if(var_57_bool == 0) goto Label_2396; // 0x959 JumpB
	var_52_float = var_55_float; // 0x95a Mov
	return 0; // 0x95b Return
	
Label_2396:
	var_52_float = var_53_float; // 0x95c Mov
...
Label_1895:
	...
	func_2387(var_52_float, var_53_float, var_54_float, var_55_float); // 0x76d NEW_2
...
{
	var_83_int = var_81_cvector | var_82_cvector; // 0x95f Or
	var_84_int = var_81_cvector | var_81_cvector; // 0x960 Or
	var_85_int = var_82_cvector | var_82_cvector; // 0x961 Or
	var_86_float = var_84_int * var_85_int; // 0x962 Mult
	var_87_float = sqrt(var_86_float); // 0x963 Sqrt
	var_80_float = var_83_int / var_83_int; // 0x964 Div2
...
{
	var_20_bool = 0; var_21_object = Obj(); // 0xa62 PushV
	var_21_object = var_19_object; // 0xa63 Mov
	func_2021(var_20_bool, var_21_object); // 0xa64 NEW_2
	var_18_bool = var_20_bool; // 0xa65 Mov
...
{
	var_26_bool = var_24_object == 0; // 0x967 Not
	if(var_26_bool == 0) goto Label_2411; // 0x968 JumpB
	var_23_bool = 0; // 0x969 MovB
	return 0; // 0x96a Return
	
Label_2411:
	var_27_int = 0; // 0x96b PushI
	var_28_bool = var_25_float > var_27_int; // 0x96c GT
	if(var_28_bool == 0) goto Label_2418; // 0x96d JumpB
	var_29_int = 8; // 0x96e PushI
	SendWorldWndMessage(var_29_int); // 0x96f Func
	goto Label_2427; // 0x971 Jump
	
Label_2427:
	var_30_float = 0; // 0x97b PushV
	var_30_float = var_25_float; // 0x97c Mov
	func_2458(var_30_float); // 0x97d NEW_2
	var_34_bool = 0; var_35_object = Obj(); var_36_string = ""; var_37_float = 0; var_38_float = 0; var_39_float = 0; // 0x97f PushV
	var_35_object = var_24_object; // 0x980 Mov
	var_36_string = "reputation"; // 0x981 MovS
	var_37_float = var_25_float; // 0x982 Mov
	var_38_float = 0; // 0x983 MovI
	var_39_float = 1; // 0x984 MovI
	func_1885(var_34_bool, var_35_object, var_36_string, var_37_float, var_38_float, var_39_float); // 0x985 NEW_2
	var_23_bool = 1; // 0x987 MovB
	return 0; // 0x988 Return
	
Label_2418:
	var_58_int = 0; // 0x972 PushI
	var_59_bool = var_25_float < var_58_int; // 0x973 LT
	if(var_59_bool == 0) goto Label_2425; // 0x974 JumpB
	var_60_int = 9; // 0x975 PushI
	SendWorldWndMessage(var_60_int); // 0x976 Func
	goto Label_2427; // 0x978 Jump
	
Label_2425:
	var_23_bool = 0; // 0x979 MovB
...
{
	var_56_object = Obj(); var_57_bool = 0; // 0xa69 PushV
	var_56_object = var_55_object; // 0xa6a Mov
	var_57_bool = 1; // 0xa6b MovB
	TaskCall(4); // 0xa6c TaskCall
	func_739(var_56_object, var_57_bool); // 0xa6d NEW_2
	TaskReturn(); // 0xa6e TaskReturn
...
Label_1946:
	...
	func_2380(var_445_float, var_446_float, var_447_float); // 0x79f NEW_2
	...
	func_2387(var_455_float, var_456_float, var_457_float, var_458_float); // 0x7ad NEW_2
	...
	func_2441(var_463_float); // 0x7b8 NEW_2
...
Label_1926:
	var_471_string = "armor"; // 0x786 PushS
	GetProperty(var_471_string, var_420_int); // 0x787 ObjFunc
}
...
func_1407(var_0_object)
{
	...
	func_2480(var_131_object); // 0x581 NEW_2
...
func_132(var_2_object, var_99_string)
{
	...
	func_2582(var_100_bool); // 0x86 NEW_2
...
Label_150:
	func_2290(var_103_string, var_104_bool); // 0x96 NEW_2
...
func_1414()
{
	...
	func_2323(var_264_string); // 0x588 NEW_2
...
{
	var_464_object = Obj(); var_465_object = Obj(); // 0x989 PushV
	CreateFloatVector(var_465_object); // 0x98a Func
	add(var_463_float); // 0x98c ObjFunc
	var_466_int = 0; // 0x98e PushI
	var_467_bool = var_463_float < var_466_int; // 0x98f LT
	if(var_467_bool == 0) goto Label_2453; // 0x990 JumpB
	var_468_float = 0.7; // 0x991 PushF
	var_469_int = 500; // 0x992 PushI
	RumblePlay(var_468_float, var_469_int); // 0x993 Func
	
Label_2453:
	var_470_int = 15; // 0x995 PushI
	SendWorldWndMessage(var_470_int, var_465_object); // 0x996 Func
...
func_2187(var_31_bool, var_33_float)
{
	...
	func_2370(var_58_cvector, var_59_cvector); // 0x8a6 NEW_2
...
Label_2228:
	...
	var_71_bool = 1; // 0x8b6 PushB
	CameraTransit(var_49_cvector, var_47_cvector, var_71_bool); // 0x8b7 Func
	var_72_float = GetByIndex(var_48_cvector, 0); // 0x8b9 PushE
	var_73_float = GetByIndex(var_48_cvector, 2); // 0x8ba PushE
	Rotate(var_72_float, var_73_float); // 0x8bb Func
	var_74_bool = 0; // 0x8bd PushV
	func_2582(var_74_bool); // 0x8be NEW_2
	if(var_74_bool == 0) goto Label_2242; // 0x8c0 JumpB
	goto Label_2250; // 0x8c1 Jump
	
Label_2250:
	CameraWaitForPlayFinish(); // 0x8ca Func
	ResumeWorld(); // 0x8cc Func
	var_31_bool = 1; // 0x8ce MovB
	return 18; // 0x8cf Return
	
Label_2242:
	var_75_string = "head"; // 0x8c2 PushS
	HasAnimationTrack(var_51_bool, var_75_string); // 0x8c3 Func
	var_76_bool = var_51_bool; // 0x8c5 Push
	if(var_76_bool == 0) goto Label_2250; // 0x8c6 JumpB
	var_77_string = "head"; // 0x8c7 PushS
	LookAsyncCamera(var_77_string); // 0x8c8 Func
}
...
func_1427(var_2_object, var_138_bool, var_139_object, var_140_float, var_141_float, var_142_bool, var_143_bool)
{
	...
	func_2480(var_151_object); // 0x596 NEW_2
	...
	func_2305(var_155_object); // 0x5a3 NEW_2
...
Label_1447:
	...
	func_2364(var_166_object); // 0x5ad NEW_2
...
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x99a PushV
	CreateFloatVector(var_32_object); // 0x99b Func
	add(var_30_float); // 0x99d ObjFunc
	var_33_int = 16; // 0x99f PushI
	SendWorldWndMessage(var_33_int, var_32_object); // 0x9a0 Func
...
{
	var_64_object = Obj(); var_65_object = Obj(); // 0x9a4 PushV
	FindActor(var_65_object, var_62_string); // 0x9a5 Func
	var_66_bool = var_65_object == 0; // 0x9a7 NullEq
	if(var_66_bool == 0) goto Label_2475; // 0x9a8 JumpB
	var_61_bool = 0; // 0x9a9 MovB
	return 2; // 0x9aa Return
	
Label_2475:
	Trigger(var_65_object, var_63_string); // 0x9ab Func
	var_61_bool = 1; // 0x9ad MovB
...
{
	var_21_bool = 0; var_22_bool = 0; // 0x9b0 PushV
	IsPlayerActor(var_20_object, var_22_bool); // 0x9b1 Func
	var_23_bool = var_22_bool; // 0x9b3 Push
	if(var_23_bool == 0) goto Label_2488; // 0x9b4 JumpB
	var_24_string = "attack"; // 0x9b5 PushS
	PlayGlobalMusic(var_24_string); // 0x9b6 Func
...
{
	var_500_float = 0; var_501_bool = 0; var_502_float = 0; var_503_bool = 0; // 0x4b5 PushV
	rand(var_502_float); // 0x4b6 Func
	var_504_bool = var_502_float < var_499_float; // 0x4b8 LT
	if(var_504_bool == 0) goto Label_1225; // 0x4b9 JumpB
	
Label_1210:
	IsAnimationPlaying(var_503_bool); // 0x4ba Func
	var_505_bool = var_503_bool == 0; // 0x4bc Not
	if(var_505_bool == 0) goto Label_1215; // 0x4bd JumpB
...
Label_1230:
	var_498_bool = 0; // 0x4ce MovB
	return 4; // 0x4cf Return
	
Label_1215:
	var_506_bool = 0; // 0x4bf PushV
	func_1303(var_506_bool); // 0x4c0 NEW_2
	if(var_506_bool == 0) goto Label_1221; // 0x4c2 JumpB
	var_498_bool = 1; // 0x4c3 MovB
...
Label_1225:
	...
	func_1407(var_503_bool); // 0x4cc NEW_2
}
...
Label_1787:
	...
	func_2323(var_154_string); // 0x6fd NEW_2
...
func_2489()
{
	var_368_object = Obj(); var_369_object = Obj(); // 0x9b9 PushV
	GetScene(var_369_object); // 0x9ba Func
	var_370_string = "battle"; // 0x9bc PushS
	var_371_object = Obj(); // 0x9bd PushV
	func_2364(var_371_object); // 0x9be NEW_2
	BroadcastMessage(var_370_string, var_371_object, var_369_object); // 0x9c0 Func
...
Label_452:
	...
	func_2507(var_36_int); // 0x1c5 NEW_2
...
Label_467:
	...
	func_2500(var_58_string, var_59_int); // 0x1e1 NEW_2
...
{
	var_44_string = ""; var_45_string = ""; // 0x9c4 PushV
	var_45_string = "idle"; // 0x9c5 MovS
	var_46_int = var_43_int; // 0x9c6 Push
	if(var_46_int == 0) goto Label_2505; // 0x9c7 JumpB
	var_45_string = var_45_string + var_43_int; // 0x9c8 Add2
	
Label_2505:
	var_42_string = var_45_string; // 0x9c9 Mov
...
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x9cb PushV
	var_39_int = 0; // 0x9cc MovI
	
Label_2509:
	var_41_string = "all"; // 0x9cd PushS
	var_42_string = ""; var_43_int = 0; // 0x9ce PushV
	var_43_int = var_39_int; // 0x9cf Mov
	func_2500(var_42_string, var_43_int); // 0x9d0 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x9d2 Func
	var_47_bool = var_40_bool == 0; // 0x9d4 Not
	if(var_47_bool == 0) goto Label_2519; // 0x9d5 JumpB
	goto Label_2522; // 0x9d6 Jump
	
Label_2522:
	var_36_int = var_39_int; // 0x9da Mov
	return 4; // 0x9db Return
	
Label_2519:
	var_48_int = 1; // 0x9d7 PushI
	var_39_int = var_39_int + var_48_int; // 0x9d8 Add2
...
func_2256()
{
	var_143_bool = 0; var_144_bool = 0; // 0x8d0 PushV
	var_145_bool = 1; // 0x8d1 PushB
	CameraSwitchToNormal(var_145_bool); // 0x8d2 Func
	var_146_bool = 0; // 0x8d4 PushV
	func_2582(var_146_bool); // 0x8d5 NEW_2
	if(var_146_bool == 0) goto Label_2265; // 0x8d7 JumpB
	goto Label_2273; // 0x8d8 Jump
	
Label_2273:
	return 2; // 0x8e1 Return
	
Label_2265:
	var_147_string = "head"; // 0x8d9 PushS
	HasAnimationTrack(var_144_bool, var_147_string); // 0x8da Func
	var_148_bool = var_144_bool; // 0x8dc Push
	if(var_148_bool == 0) goto Label_2273; // 0x8dd JumpB
	var_149_string = "head"; // 0x8de PushS
	UnlookAsync(var_149_string); // 0x8df Func
}
...
func_723(var_0_object, var_69_bool)
{
	...
	func_2398(var_80_float, var_81_cvector, var_82_cvector); // 0x2de NEW_2
...
func_2524()
{
	var_32_int = 1; // 0x9dd PushI
	SetReturnValue(var_32_int); // 0x9de ObjFunc
...
func_2529()
{
	var_25_string = "b1q03_retreat"; // 0x9e2 PushS
	var_26_int = 1; // 0x9e3 PushI
	SetVariable(var_25_string, var_26_int); // 0x9e4 Func
	var_27_int = 0; // 0x9e6 PushI
	SetReturnValue(var_27_int); // 0x9e7 ObjFunc
...
{
	var_126_bool = 0; var_127_float = 0; var_128_float = 0; var_129_bool = 0; var_130_float = 0; var_131_float = 0; // 0x8e2 PushV
	lshHasAnimation(var_129_bool, var_125_string); // 0x8e3 Func
	var_132_bool = var_129_bool; // 0x8e5 Push
	if(var_132_bool == 0) goto Label_2285; // 0x8e6 JumpB
	lshGetAnimTimes(var_125_string, var_130_float, var_131_float); // 0x8e7 Func
	var_133_bool = 0; // 0x8e9 PushB
	lshPlayAnimation(var_130_float, var_131_float, var_133_bool); // 0x8ea Func
	goto Label_2289; // 0x8ec Jump
	
Label_2289:
	return 6; // 0x8f1 Return
	
Label_2285:
	var_134_string = "Can't find lsh animation : "; // 0x8ed PushS
	var_135_int = var_134_string + var_125_string; // 0x8ee Add
	Trace(var_135_int); // 0x8ef Func
}
...
func_739(var_56_object, var_57_bool)
{
	...
	func_2364(var_66_object); // 0x2e7 NEW_2
...
Label_747:
	...
	var_530_int = 1; // 0x2f1 PushI
	Sleep(var_530_int); // 0x2f2 Func
...
{
	var_84_int = 0; var_85_int = 0; // 0x9ea PushV
	var_86_string = "branch"; // 0x9eb PushS
	GetVariable(var_86_string, var_85_int); // 0x9ec Func
	var_87_int = 0; // 0x9ee PushI
	var_88_bool = var_85_int == var_87_int; // 0x9ef Eq
	if(var_88_bool == 0) goto Label_2548; // 0x9f0 JumpB
	var_83_int = 1; // 0x9f1 MovI
	return 2; // 0x9f2 Return
	
Label_2548:
	var_89_int = 1; // 0x9f4 PushI
	var_90_bool = var_85_int == var_89_int; // 0x9f5 Eq
	if(var_90_bool == 0) goto Label_2553; // 0x9f6 JumpB
	var_83_int = 2; // 0x9f7 MovI
	return 2; // 0x9f8 Return
	
Label_2553:
	var_83_int = 3; // 0x9f9 MovI
...
{
	var_107_bool = 0; var_108_float = 0; var_109_float = 0; var_110_bool = 0; var_111_float = 0; var_112_float = 0; // 0x8f2 PushV
	lshHasAnimation(var_110_bool, var_103_string); // 0x8f3 Func
	var_113_bool = var_110_bool; // 0x8f5 Push
	if(var_113_bool == 0) goto Label_2300; // 0x8f6 JumpB
	lshGetAnimTimes(var_103_string, var_111_float, var_112_float); // 0x8f7 Func
	lshPlayAnimation(var_111_float, var_112_float, var_104_bool); // 0x8f9 Func
	goto Label_2304; // 0x8fb Jump
	
Label_2304:
	return 6; // 0x900 Return
	
Label_2300:
	var_114_string = "Can't find lsh animation : "; // 0x8fc PushS
	var_115_int = var_114_string + var_103_string; // 0x8fd Add
	Trace(var_115_int); // 0x8fe Func
}
...
Label_784:
	...
	func_2364(var_124_object); // 0x31a NEW_2
...
Label_921:
	...
	var_514_string = "all"; // 0x39b PushS
	var_515_string = "fjump"; // 0x39c PushS
	PlayAnimation(var_514_string, var_515_string); // 0x39d Func
	WaitForAnimEnd(); // 0x39f Func
	func_1407(var_93_float); // 0x3a2 NEW_2
	var_516_cvector = CVector(0.0, 0.0, 0.0); // 0x3a4 PushVec
	SetSpeed(var_516_cvector); // 0x3a5 Func
	Stop(); // 0x3a7 Func
	StopAsync(); // 0x3a9 Func
	var_517_bool = 0; // 0x3ab PushV
	func_1364(var_93_float, var_517_bool); // 0x3ac NEW_2
	var_518_bool = var_517_bool == 0; // 0x3ae Not
	if(var_518_bool == 0) goto Label_967; // 0x3af JumpB
	var_519_bool = 0; var_520_object = Obj(); // 0x3b0 PushV
	var_520_object = var_0_object; // 0x3b1 MovT
	func_2021(var_519_bool, var_520_object); // 0x3b2 NEW_2
	var_521_bool = var_519_bool == 0; // 0x3b4 Not
	if(var_521_bool == 0) goto Label_951; // 0x3b5 JumpB
...
Label_951:
	...
	var_522_float = var_71_float * var_71_float; // 0x3bd Mult
	var_523_bool = var_90_float < var_522_float; // 0x3be LT
	if(var_523_bool == 0) goto Label_967; // 0x3bf JumpB
	var_524_bool = 0; var_525_float = 0; // 0x3c0 PushV
	var_525_float = var_71_float; // 0x3c1 Mov
	func_1068(var_93_float, var_524_bool, var_525_float); // 0x3c2 NEW_2
	var_526_bool = var_524_bool == 0; // 0x3c4 Not
	if(var_526_bool == 0) goto Label_967; // 0x3c5 JumpB
	goto Label_977; // 0x3c6 Jump
	
Label_968:
	var_527_bool = 0; var_528_float = 0; // 0x3c8 PushV
	var_528_float = var_71_float; // 0x3c9 Mov
	func_1068(var_93_float, var_527_bool, var_528_float); // 0x3ca NEW_2
	var_529_bool = var_527_bool == 0; // 0x3cc Not
	if(var_529_bool == 0) goto Label_975; // 0x3cd JumpB
