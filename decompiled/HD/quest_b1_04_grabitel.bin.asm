...
0x851: Stack[-3] = Stack[-7]
0x852: Stack[-2] = Stack[-6]
0x853: Stack[-1] = Stack[-5]
0x854: Call2 0x6ff
...
0x859: Stack[-5] = Stack[-11]
0x85a: Stack[-4] = Stack[-10]
0x85b: Stack[-3] = Stack[-9]
0x85c: Stack[-2] = Stack[-7]
0x85d: Stack[-1] = Stack[-6]
0x85e: Call2 0x743
...
0x896: Pop(0)
0x897: @@ SetItemName(Stack[-7])
0x898: Pop(0)
0x899: Push("Organ")
0x89a: Push((int) 1)
0x89b: @@ SetProperty(Stack[-2], Stack[-1])
0x89c: Pop(2)
0x89d: @@ GetItemID(Stack[-2])
0x89e: Pop(0)
0x89f: Push((int) 0)
0x8a0: Push((int) 1)
...
0x8c6: Pop(0)
0x8c7: @@ RemoveStationaryActor(Stack[-1])
0x8c8: Pop(1)
...
0x8db: Stack[-3] = Stack[-9]
0x8dc: Stack[-2] = Stack[-8]
0x8dd: Stack[-1] = Stack[-7]
0x8de: Call2 0x7ac

0x8df: Stack[-6] = Stack[-4]
0x8e0: Pop(4)
0x8e1: Push((int) 0)
...
0x8e7: Stack[-4] = Stack[-10]
0x8e8: Stack[-3] = Stack[-9]
0x8e9: Stack[-2] = Stack[-8]
