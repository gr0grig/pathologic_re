...
task_1_event_0(var_0_object, var_1_bool, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_2183(var_14_object); // 0xad NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2294(var_15_object); // 0x1c5 NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2294(var_15_object); // 0x210 NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2294(var_15_object); // 0x4b9 NEW_2
...
task_5_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2069(var_13_object); // 0x4fe NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x850 PushV
	var_14_object = var_10_object; // 0x851 Mov
	var_15_int = var_11_int; // 0x852 Mov
	var_16_float = var_12_float; // 0x853 Mov
	func_1791(var_14_object, var_15_int, var_16_float); // 0x854 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x858 PushV
	var_16_object = var_10_object; // 0x859 Mov
	var_17_int = var_11_int; // 0x85a Mov
	var_18_float = var_12_float; // 0x85b Mov
	var_19_cvector = var_14_cvector; // 0x85c Mov
	var_20_cvector = var_15_cvector; // 0x85d Mov
	func_1859(var_18_float, var_19_cvector, var_20_cvector); // 0x85e NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x861 PushV
	var_14_string = "health"; // 0x862 PushS
	var_15_bool = var_11_string == var_14_string; // 0x863 Eq
	if(var_15_bool == 0) goto Label_2157; // 0x864 JumpB
	var_16_string = "health"; // 0x865 PushS
	GetProperty(var_16_string, var_13_float); // 0x866 Func
	var_17_int = 0; // 0x868 PushI
	var_18_bool = var_13_float <= var_17_int; // 0x869 LE
	if(var_18_bool == 0) goto Label_2157; // 0x86a JumpB
	SignalDeath(var_10_object); // 0x86b Func
...
{
	var_11_object = Obj(); // 0x86f PushV
	var_11_object = var_10_object; // 0x870 Mov
	func_2119(var_11_object); // 0x871 NEW_2
...
{
	var_25_object = Obj(); var_26_object = Obj(); // 0x80b PushV
	CreateFloatVector(var_26_object); // 0x80c Func
	add(var_24_float); // 0x80e ObjFunc
	var_27_int = 16; // 0x810 PushI
	SendWorldWndMessage(var_27_int, var_26_object); // 0x811 Func
...
{
	var_14_bool = 0; var_15_bool = 0; // 0x815 PushV
	IsPlayerActor(var_13_object, var_15_bool); // 0x816 Func
	var_16_bool = var_15_bool; // 0x818 Push
	if(var_16_bool == 0) goto Label_2077; // 0x819 JumpB
	var_17_string = "attack"; // 0x81a PushS
	PlayGlobalMusic(var_17_string); // 0x81b Func
...
Label_1578:
	var_601_string = "armor"; // 0x62a PushS
	GetProperty(var_601_string, var_550_int); // 0x62b ObjFunc
}
...
Label_695:
	...
	var_665_string = "all"; // 0x2b9 PushS
	var_666_string = "fjump"; // 0x2ba PushS
	PlayAnimation(var_665_string, var_666_string); // 0x2bb Func
	WaitForAnimEnd(); // 0x2bd Func
	func_1183(var_231_float); // 0x2c0 NEW_2
	var_667_cvector = CVector(0.0, 0.0, 0.0); // 0x2c2 PushVec
	SetSpeed(var_667_cvector); // 0x2c3 Func
	Stop(); // 0x2c5 Func
	StopAsync(); // 0x2c7 Func
	var_668_bool = 0; // 0x2c9 PushV
	func_1140(var_231_float, var_668_bool); // 0x2ca NEW_2
	var_669_bool = var_668_bool == 0; // 0x2cc Not
	if(var_669_bool == 0) goto Label_741; // 0x2cd JumpB
	var_670_bool = 0; var_671_object = Obj(); // 0x2ce PushV
	var_671_object = var_0_object; // 0x2cf MovT
	func_1704(var_670_bool, var_671_object); // 0x2d0 NEW_2
	var_672_bool = var_670_bool == 0; // 0x2d2 Not
	if(var_672_bool == 0) goto Label_725; // 0x2d3 JumpB
...
Label_725:
	...
	var_673_float = var_209_float * var_209_float; // 0x2db Mult
	var_674_bool = var_228_float < var_673_float; // 0x2dc LT
	if(var_674_bool == 0) goto Label_741; // 0x2dd JumpB
	var_675_bool = 0; var_676_float = 0; // 0x2de PushV
	var_676_float = var_209_float; // 0x2df Mov
	func_842(var_231_float, var_675_bool, var_676_float); // 0x2e0 NEW_2
	var_677_bool = var_675_bool == 0; // 0x2e2 Not
	if(var_677_bool == 0) goto Label_741; // 0x2e3 JumpB
	goto Label_751; // 0x2e4 Jump
	
Label_742:
	var_678_bool = 0; var_679_float = 0; // 0x2e6 PushV
	var_679_float = var_209_float; // 0x2e7 Mov
	func_842(var_231_float, var_678_bool, var_679_float); // 0x2e8 NEW_2
	var_680_bool = var_678_bool == 0; // 0x2ea Not
	if(var_680_bool == 0) goto Label_749; // 0x2eb JumpB
...
func_2078()
{
	var_121_object = Obj(); var_122_object = Obj(); // 0x81e PushV
	GetScene(var_122_object); // 0x81f Func
	var_123_string = "battle"; // 0x821 PushS
	var_124_object = Obj(); // 0x822 PushV
	func_1941(var_124_object); // 0x823 NEW_2
	BroadcastMessage(var_123_string, var_124_object, var_122_object); // 0x825 Func
...
{
	var_620_bool = 0; var_621_bool = 0; // 0x829 PushV
	var_622_string = "god_mode"; // 0x82a PushS
	GetVariable(var_622_string, var_621_bool); // 0x82b Func
	var_619_bool = var_621_bool; // 0x82d Mov
...
Label_51:
	...
	func_2102(var_29_int); // 0x34 NEW_2
...
Label_66:
	...
	func_2095(var_51_string, var_52_int); // 0x50 NEW_2
...
{
	var_37_string = ""; var_38_string = ""; // 0x82f PushV
	var_38_string = "idle"; // 0x830 MovS
	var_39_int = var_36_int; // 0x831 Push
	if(var_39_int == 0) goto Label_2100; // 0x832 JumpB
	var_38_string = var_38_string + var_36_int; // 0x833 Add2
	
Label_2100:
	var_35_string = var_38_string; // 0x834 Mov
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x836 PushV
	var_32_int = 0; // 0x837 MovI
	
Label_2104:
	var_34_string = "all"; // 0x838 PushS
	var_35_string = ""; var_36_int = 0; // 0x839 PushV
	var_36_int = var_32_int; // 0x83a Mov
	func_2095(var_35_string, var_36_int); // 0x83b NEW_2
	HasAnimation(var_33_bool, var_34_string, var_35_string); // 0x83d Func
	var_40_bool = var_33_bool == 0; // 0x83f Not
	if(var_40_bool == 0) goto Label_2114; // 0x840 JumpB
	goto Label_2117; // 0x841 Jump
	
Label_2117:
	var_29_int = var_32_int; // 0x845 Mov
	return 4; // 0x846 Return
	
Label_2114:
	var_41_int = 1; // 0x842 PushI
	var_32_int = var_32_int + var_41_int; // 0x843 Add2
	goto Label_2104; // 0x844 Jump
}
...
{
	var_12_object = Obj(); // 0x848 PushV
	var_12_object = var_11_object; // 0x849 Mov
	TaskCall(1); // 0x84a TaskCall
	func_128(var_12_object); // 0x84b NEW_2
	TaskReturn(); // 0x84c TaskReturn
...
{
	var_610_float = 0; var_611_float = 0; // 0x660 PushV
	var_612_bool = 0; var_613_object = Obj(); var_614_string = ""; // 0x661 PushV
	var_613_object = var_609_object; // 0x662 Mov
	var_614_string = "health"; // 0x663 MovS
	func_1525(var_612_bool, var_613_object, var_614_string); // 0x664 NEW_2
	var_615_bool = var_612_bool == 0; // 0x666 Not
	if(var_615_bool == 0) goto Label_1642; // 0x667 JumpB
	var_608_bool = 0; // 0x668 MovB
	return 2; // 0x669 Return
	
Label_1642:
	var_616_bool = 0; // 0x66a PushV
	var_616_bool = 0; // 0x66b MovB
	var_617_bool = 0; var_618_object = Obj(); // 0x66c PushV
	var_618_object = var_609_object; // 0x66d Mov
	func_1520(var_617_bool, var_618_object); // 0x66e NEW_2
	if(var_617_bool == 0) goto Label_1654; // 0x670 JumpB
	var_619_bool = 0; // 0x671 PushV
	func_2089(var_619_bool); // 0x672 NEW_2
	if(var_619_bool == 0) goto Label_1654; // 0x674 JumpB
	var_616_bool = 1; // 0x675 MovB
	
Label_1654:
	if(var_616_bool == 0) goto Label_1657; // 0x676 JumpB
	var_608_bool = 0; // 0x677 MovB
	return 2; // 0x678 Return
	
Label_1657:
	var_623_string = "health"; // 0x679 PushS
	GetProperty(var_623_string, var_611_float); // 0x67a ObjFunc
	var_624_float = 0.0; // 0x67c PushF
	var_608_bool = var_611_float <= var_624_float; // 0x67d LE2
...
{
	var_17_bool = 0; var_18_object = Obj(); // 0x875 PushV
	var_18_object = var_16_object; // 0x876 Mov
	func_1704(var_17_bool, var_18_object); // 0x877 NEW_2
	var_15_bool = var_17_bool; // 0x878 Mov
...
{
	var_52_object = Obj(); // 0x87c PushV
	var_52_object = var_51_object; // 0x87d Mov
	func_2237(var_52_object); // 0x87e NEW_2
...
{
	var_56_int = 0; var_57_int = 0; // 0x881 PushV
	var_58_string = "branch"; // 0x882 PushS
	GetVariable(var_58_string, var_57_int); // 0x883 Func
	var_55_int = var_57_int; // 0x885 Mov
...
{
	var_15_int = 0; // 0x888 PushV
	func_2177(var_15_int); // 0x889 NEW_2
	var_19_int = 1; // 0x88b PushI
	var_20_bool = var_15_int == var_19_int; // 0x88c Eq
	if(var_20_bool == 0) goto Label_2193; // 0x88d JumpB
	WorkWithCorpse(var_14_object); // 0x88e Func
...
Label_2193:
	Barter(var_14_object); // 0x891 Func
}


func_2196(var_61_string)
{
	var_62_object = Obj(); var_63_int = 0; var_64_bool = 0; var_65_object = Obj(); var_66_int = 0; var_67_bool = 0; // 0x894 PushV
	CreateInvItem(var_65_object); // 0x895 Func
	SetItemName(var_61_string); // 0x897 ObjFunc
	var_68_string = "Organ"; // 0x899 PushS
	var_69_int = 1; // 0x89a PushI
	SetProperty(var_68_string, var_69_int); // 0x89b ObjFunc
	GetItemID(var_66_int); // 0x89d ObjFunc
	var_70_int = 0; // 0x89f PushI
	var_71_int = 1; // 0x8a0 PushI
	AddItem(var_67_bool, var_65_object, var_70_int, var_71_int); // 0x8a1 Func
...
func_1183(var_0_object)
{
	...
	func_2069(var_269_object); // 0x4a1 NEW_2
...
func_2213()
{
	var_55_int = 0; // 0x8a5 PushV
	func_2177(var_55_int); // 0x8a6 NEW_2
	var_59_int = 1; // 0x8a8 PushI
	var_60_bool = var_55_int != var_59_int; // 0x8a9 Neq
	if(var_60_bool == 0) goto Label_2220; // 0x8aa JumpB
	return 0; // 0x8ab Return
	
Label_2220:
	var_61_string = ""; // 0x8ac PushV
	var_61_string = "liver"; // 0x8ad MovS
	func_2196(var_61_string); // 0x8ae NEW_2
	var_72_string = ""; // 0x8b0 PushV
	var_72_string = "kidney"; // 0x8b1 MovS
	func_2196(var_72_string); // 0x8b2 NEW_2
	var_73_string = ""; // 0x8b4 PushV
	var_73_string = "heart"; // 0x8b5 MovS
	func_2196(var_73_string); // 0x8b6 NEW_2
	var_74_string = ""; // 0x8b8 PushV
	var_74_string = "blood"; // 0x8b9 MovS
	func_2196(var_74_string); // 0x8ba NEW_2
...
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x8bd PushV
	var_55_string = "b1q04_attack"; // 0x8be PushS
	var_56_int = 1; // 0x8bf PushI
	SetVariable(var_55_string, var_56_int); // 0x8c0 Func
	GetScene(var_54_object); // 0x8c2 Func
	var_57_object = Obj(); // 0x8c4 PushV
	func_1941(var_57_object); // 0x8c5 NEW_2
	RemoveStationaryActor(var_57_object); // 0x8c7 ObjFunc
	var_60_object = Obj(); // 0x8c9 PushV
	var_60_object = var_52_object; // 0x8ca Mov
	TaskCall(6); // 0x8cb TaskCall
	func_1479(var_60_object); // 0x8cc NEW_2
	TaskReturn(); // 0x8cd TaskReturn
...
func_1223(var_2_object, var_272_bool, var_273_object, var_274_float, var_275_float, var_276_bool, var_277_bool)
{
	...
	func_2069(var_285_object); // 0x4ca NEW_2
...
{
	var_146_cvector = CVector(0,0,0); var_147_float = 0; var_148_float = 0; var_149_float = 0; var_150_float = 0; var_151_float = 0; var_152_cvector = CVector(0,0,0); var_153_float = 0; var_154_float = 0; var_155_float = 0; var_156_float = 0; var_157_float = 0; // 0x8d1 PushV
	var_152_cvector = var_144_cvector - var_143_cvector; // 0x8d2 Sub2
	var_153_float = 250000; // 0x8d3 MovI
	var_158_float = GetByIndex(var_152_cvector, 1); // 0x8d4 PushE
	var_159_int = 1000; // 0x8d5 PushI
	var_160_float = var_158_float * var_159_int; // 0x8d6 Mult
	var_161_float = var_145_float * var_145_float; // 0x8d7 Mult
	var_154_float = var_160_float - var_161_float; // 0x8d8 Sub2
	var_155_float = var_152_cvector | var_152_cvector; // 0x8d9 Or2
	var_162_float = 0; var_163_float = 0; var_164_float = 0; var_165_float = 0; // 0x8da PushV
	var_163_float = var_153_float; // 0x8db Mov
	var_164_float = var_154_float; // 0x8dc Mov
	var_165_float = var_155_float; // 0x8dd Mov
	func_1964(var_162_float, var_163_float, var_164_float, var_165_float); // 0x8de NEW_2
	var_156_float = var_162_float; // 0x8df Mov
	var_170_int = 0; // 0x8e1 PushI
	var_171_bool = var_156_float < var_170_int; // 0x8e2 LT
	if(var_171_bool == 0) goto Label_2278; // 0x8e3 JumpB
	var_157_float = 1; // 0x8e4 MovI
	goto Label_2286; // 0x8e5 Jump
	
Label_2286:
	var_172_cvector = CVector(0.0, 500.0, 0.0); // 0x8ee PushVec
	var_173_float = var_172_cvector * var_157_float; // 0x8ef Mult
	var_174_float = var_173_float * var_157_float; // 0x8f0 Mult
	var_175_int = var_152_cvector + var_174_float; // 0x8f1 Add
	var_142_cvector = var_175_int / var_175_int; // 0x8f2 Div2
	return 12; // 0x8f3 Return
	
Label_2278:
	var_176_float = 0; var_177_float = 0; var_178_float = 0; var_179_float = 0; var_180_float = 0; // 0x8e6 PushV
	var_177_float = var_153_float; // 0x8e7 Mov
	var_178_float = var_154_float; // 0x8e8 Mov
	var_179_float = var_155_float; // 0x8e9 Mov
	var_180_float = sqrt(var_156_float); // 0x8ea Sqrt2
	func_1971(var_177_float, var_178_float, var_179_float, var_180_float); // 0x8eb NEW_2
	var_157_float = sqrt(var_176_float); // 0x8ed Sqrt2
}
...
func_803(var_0_object, var_523_float, var_524_int)
{
	...
	var_602_int = 0; // 0x33e PushV
	func_496(var_602_int); // 0x33f NEW_2
	ReportHit(var_0_object, var_602_int, var_530_float, var_529_float); // 0x341 Func
	var_603_object = Obj(); var_604_float = 0; // 0x343 PushV
	var_603_object = var_528_object; // 0x344 Mov
	var_604_float = var_530_float; // 0x345 Mov
	func_498(var_603_object, var_604_float); // 0x346 NEW_2
...
Label_328:
	var_687_bool = 0; var_688_object = Obj(); // 0x148 PushV
	var_688_object = var_62_object; // 0x149 Mov
	TaskCall(4); // 0x14a TaskCall
	func_462(var_687_bool, var_688_object); // 0x14b NEW_2
	TaskReturn(); // 0x14c TaskReturn
	var_61_bool = var_689_object; // 0x14d Mov
...
Label_878:
	...
	var_626_string = "all"; // 0x373 PushS
	var_627_string = "attack_middle"; // 0x374 PushS
	var_628_int = var_627_string + var_496_int; // 0x375 Add
	HasAnimation(var_497_bool, var_626_string, var_628_int); // 0x376 Func
	var_629_bool = var_497_bool; // 0x378 Push
	if(var_629_bool == 0) goto Label_959; // 0x379 JumpB
	func_2078(); // 0x37b NEW_2
	var_630_string = "all"; // 0x37d PushS
	var_631_string = "attack_middle"; // 0x37e PushS
	var_632_int = var_631_string + var_496_int; // 0x37f Add
	PlayAnimation(var_630_string, var_632_int); // 0x380 Func
	WaitForAnimEnd(); // 0x382 Func
	func_1183(var_499_string); // 0x385 NEW_2
	var_633_bool = 0; var_634_object = Obj(); // 0x387 PushV
	var_634_object = var_0_object; // 0x388 MovT
	func_1704(var_633_bool, var_634_object); // 0x389 NEW_2
	var_635_bool = var_633_bool == 0; // 0x38b Not
	if(var_635_bool == 0) goto Label_913; // 0x38c JumpB
	StopAsync(); // 0x38d Func
	var_490_bool = 0; // 0x38f MovB
	return 8; // 0x390 Return
	
Label_913:
	var_636_float = 0; var_637_int = 0; // 0x391 PushV
	var_636_float = var_491_float; // 0x392 Mov
	var_637_int = var_496_int; // 0x393 Mov
	func_803(var_499_string, var_636_float, var_637_int); // 0x394 NEW_2
	var_498_int = 1; // 0x396 MovI
	
Label_919:
	var_638_string = "attack_middle"; // 0x397 PushS
	var_639_int = var_638_string + var_496_int; // 0x398 Add
	var_640_string = "_"; // 0x399 PushS
	var_641_int = var_639_int + var_640_string; // 0x39a Add
	var_499_string = var_641_int + var_498_int; // 0x39b Add2
	var_642_string = "all"; // 0x39c PushS
	HasAnimation(var_497_bool, var_642_string, var_499_string); // 0x39d Func
	var_643_bool = var_497_bool == 0; // 0x39f Not
	if(var_643_bool == 0) goto Label_930; // 0x3a0 JumpB
	goto Label_959; // 0x3a1 Jump
	
Label_959:
	var_644_bool = 0; // 0x3bf PushB
	SetAttackState(var_644_bool); // 0x3c0 Func
	var_645_string = "all"; // 0x3c2 PushS
	var_646_string = "attack_end"; // 0x3c3 PushS
	var_647_int = var_646_string + var_496_int; // 0x3c4 Add
	PlayAnimation(var_645_string, var_647_int); // 0x3c5 Func
	var_648_bool = 0; // 0x3c7 PushV
	func_1193(var_648_bool); // 0x3c8 NEW_2
	if(var_648_bool == 0) goto Label_977; // 0x3ca JumpB
	var_649_bool = 0; var_650_float = 0; // 0x3cb PushV
	var_650_float = 0.45; // 0x3cc MovF
	func_981(var_649_bool, var_650_float); // 0x3cd NEW_2
...
Label_930:
	func_2078(); // 0x3a3 NEW_2
	var_658_string = "all"; // 0x3a5 PushS
	PlayAnimation(var_658_string, var_499_string); // 0x3a6 Func
	WaitForAnimEnd(); // 0x3a8 Func
	func_1183(var_499_string); // 0x3ab NEW_2
	var_659_bool = 0; var_660_object = Obj(); // 0x3ad PushV
	var_660_object = var_0_object; // 0x3ae MovT
	func_1704(var_659_bool, var_660_object); // 0x3af NEW_2
	var_661_bool = var_659_bool == 0; // 0x3b1 Not
	if(var_661_bool == 0) goto Label_951; // 0x3b2 JumpB
	StopAsync(); // 0x3b3 Func
	var_490_bool = 0; // 0x3b5 MovB
	return 8; // 0x3b6 Return
	
Label_951:
	var_662_float = 0; var_663_int = 0; // 0x3b7 PushV
	var_662_float = var_491_float; // 0x3b8 Mov
	var_663_int = var_496_int; // 0x3b9 Mov
	func_803(var_499_string, var_662_float, var_663_int); // 0x3ba NEW_2
	var_664_int = 1; // 0x3bc PushI
	var_498_int = var_498_int + var_664_int; // 0x3bd Add2
...
func_336(var_0_object, var_82_bool, var_83_object, var_200_object)
{
	...
	func_2069(var_99_object); // 0x153 NEW_2
...
Label_375:
	...
	func_2257(var_142_cvector, var_143_cvector, var_144_cvector, var_145_float); // 0x19b NEW_2
...
Label_1480:
	...
	var_695_int = 1; // 0x5ce PushI
	Sleep(var_695_int); // 0x5cf Func
...
func_462(var_198_bool, var_199_object)
{
	...
	var_681_bool = 0; // 0x1d8 PushV
	var_681_bool = 0; // 0x1d9 MovB
	var_682_bool = GlobalVars[0]; // 0x1da PushGE
	if(var_682_bool == 0) goto Label_479; // 0x1db JumpB
	var_683_int = var_3_int; // 0x1dc PushT
	if(var_683_int == 0) goto Label_479; // 0x1dd JumpB
	var_681_bool = 1; // 0x1de MovB
	
Label_479:
	if(var_681_bool == 0) goto Label_486; // 0x1df JumpB
	var_684_string = "all"; // 0x1e0 PushS
	var_685_string = "attack_off"; // 0x1e1 PushS
	PlayAnimation(var_684_string, var_685_string); // 0x1e2 Func
	WaitForAnimEnd(); // 0x1e4 Func
	
Label_486:
	var_686_bool = GlobalVars[0]; // 0x1e6 PushGE
	var_198_bool = var_686_bool; // 0x1e7 Mov
...
{
	var_651_float = 0; var_652_bool = 0; var_653_float = 0; var_654_bool = 0; // 0x3d5 PushV
	rand(var_653_float); // 0x3d6 Func
	var_655_bool = var_653_float < var_650_float; // 0x3d8 LT
	if(var_655_bool == 0) goto Label_1001; // 0x3d9 JumpB
	
Label_986:
	IsAnimationPlaying(var_654_bool); // 0x3da Func
	var_656_bool = var_654_bool == 0; // 0x3dc Not
	if(var_656_bool == 0) goto Label_991; // 0x3dd JumpB
...
Label_1006:
	var_649_bool = 0; // 0x3ee MovB
	return 4; // 0x3ef Return
	
Label_991:
	var_657_bool = 0; // 0x3df PushV
	func_1079(var_657_bool); // 0x3e0 NEW_2
	if(var_657_bool == 0) goto Label_997; // 0x3e2 JumpB
	var_649_bool = 1; // 0x3e3 MovB
...
Label_1001:
	...
	func_1183(var_654_bool); // 0x3ec NEW_2
}
...
Label_2028:
	...
	func_2059(var_24_float); // 0x7ee NEW_2
...
{
	var_605_bool = 0; // 0x1f3 PushV
	var_605_bool = 0; // 0x1f4 MovB
	var_606_int = 0; // 0x1f5 PushI
	var_607_bool = var_604_float > var_606_int; // 0x1f6 GT
	if(var_607_bool == 0) goto Label_510; // 0x1f7 JumpB
	var_608_bool = 0; var_609_object = Obj(); // 0x1f8 PushV
	var_609_object = var_603_object; // 0x1f9 Mov
	func_1632(var_608_bool, var_609_object); // 0x1fa NEW_2
	if(var_608_bool == 0) goto Label_510; // 0x1fc JumpB
	var_605_bool = 1; // 0x1fd MovB
	
Label_510:
	if(var_605_bool == 0) goto Label_517; // 0x1fe JumpB
	var_625_bool = GlobalVars[0]; // 0x1ff PushGE
	var_625_bool = 1; // 0x200 MovB
	GlobalVars[0] = var_625_bool; // 0x201 PopGE
	func_979(var_604_float); // 0x203 NEW_2
...
func_2042(var_593_float)
{
	...
	var_596_int = 0; // 0x7ff PushI
	var_597_bool = var_593_float < var_596_int; // 0x800 LT
	if(var_597_bool == 0) goto Label_2054; // 0x801 JumpB
	var_598_float = 0.7; // 0x802 PushF
	var_599_int = 500; // 0x803 PushI
	RumblePlay(var_598_float, var_599_int); // 0x804 Func
	
Label_2054:
	var_600_int = 15; // 0x806 PushI
	SendWorldWndMessage(var_600_int, var_595_object); // 0x807 Func
