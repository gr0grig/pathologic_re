...
task_1_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool)
{
	...
	func_1831(var_13_object); // 0xad NEW_2
...
task_3_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1723(var_12_object); // 0x40a NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x6f0 PushV
	var_13_object = var_9_object; // 0x6f1 Mov
	var_14_int = var_10_int; // 0x6f2 Mov
	var_15_float = var_11_float; // 0x6f3 Mov
	func_1477(var_13_object, var_14_int, var_15_float); // 0x6f4 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x6f8 PushV
	var_15_object = var_9_object; // 0x6f9 Mov
	var_16_int = var_10_int; // 0x6fa Mov
	var_17_float = var_11_float; // 0x6fb Mov
	var_18_cvector = var_13_cvector; // 0x6fc Mov
	var_19_cvector = var_14_cvector; // 0x6fd Mov
	func_1545(var_17_float, var_18_cvector, var_19_cvector); // 0x6fe NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x701 PushV
	var_13_string = "health"; // 0x702 PushS
	var_14_bool = var_10_string == var_13_string; // 0x703 Eq
	if(var_14_bool == 0) goto Label_1805; // 0x704 JumpB
	var_15_string = "health"; // 0x705 PushS
	GetProperty(var_15_string, var_12_float); // 0x706 Func
	var_16_int = 0; // 0x708 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x709 LE
	if(var_17_bool == 0) goto Label_1805; // 0x70a JumpB
	SignalDeath(var_9_object); // 0x70b Func
...
{
	var_10_object = Obj(); // 0x70f PushV
	var_10_object = var_9_object; // 0x710 Mov
	func_1767(var_10_object); // 0x711 NEW_2
...
Label_1314:
	var_468_string = "armor"; // 0x522 PushS
	GetProperty(var_468_string, var_417_int); // 0x523 ObjFunc
}
...
{
	var_16_bool = 0; var_17_object = Obj(); // 0x715 PushV
	var_17_object = var_15_object; // 0x716 Mov
	func_1409(var_16_bool, var_17_object); // 0x717 NEW_2
	var_14_bool = var_16_bool; // 0x718 Mov
...
{
	var_51_object = Obj(); // 0x71c PushV
	var_51_object = var_50_object; // 0x71d Mov
	func_1885(var_51_object); // 0x71e NEW_2
...
{
	var_55_int = 0; var_56_int = 0; // 0x721 PushV
	var_57_string = "branch"; // 0x722 PushS
	GetVariable(var_57_string, var_56_int); // 0x723 Func
	var_54_int = var_56_int; // 0x725 Mov
...
{
	var_14_int = 0; // 0x728 PushV
	func_1825(var_14_int); // 0x729 NEW_2
	var_18_int = 1; // 0x72b PushI
	var_19_bool = var_14_int == var_18_int; // 0x72c Eq
	if(var_19_bool == 0) goto Label_1841; // 0x72d JumpB
	WorkWithCorpse(var_13_object); // 0x72e Func
	goto Label_1843; // 0x730 Jump
	
Label_1843:
	return 0; // 0x733 Return
	
Label_1841:
	Barter(var_13_object); // 0x731 Func
}
...
Label_51:
	...
	func_1750(var_28_int); // 0x34 NEW_2
...
Label_66:
	...
	func_1743(var_50_string, var_51_int); // 0x50 NEW_2
...
Label_300:
	...
	var_527_int = 1; // 0x132 PushI
	Sleep(var_527_int); // 0x133 Func
...
{
	var_61_object = Obj(); var_62_int = 0; var_63_bool = 0; var_64_object = Obj(); var_65_int = 0; var_66_bool = 0; // 0x734 PushV
	CreateInvItem(var_64_object); // 0x735 Func
	SetItemName(var_60_string); // 0x737 ObjFunc
	var_67_string = "Organ"; // 0x739 PushS
	var_68_int = 1; // 0x73a PushI
	SetProperty(var_67_string, var_68_int); // 0x73b ObjFunc
	GetItemID(var_65_int); // 0x73d ObjFunc
	var_69_int = 0; // 0x73f PushI
	var_70_int = 1; // 0x740 PushI
	AddItem(var_66_bool, var_64_object, var_69_int, var_70_int); // 0x741 Func
	return 6; // 0x743 Return
}
...
Label_473:
	...
	var_511_string = "all"; // 0x1db PushS
	var_512_string = "fjump"; // 0x1dc PushS
	PlayAnimation(var_511_string, var_512_string); // 0x1dd Func
	WaitForAnimEnd(); // 0x1df Func
	func_959(var_90_float); // 0x1e2 NEW_2
	var_513_cvector = CVector(0.0, 0.0, 0.0); // 0x1e4 PushVec
	SetSpeed(var_513_cvector); // 0x1e5 Func
	Stop(); // 0x1e7 Func
	StopAsync(); // 0x1e9 Func
	var_514_bool = 0; // 0x1eb PushV
	func_916(var_90_float, var_514_bool); // 0x1ec NEW_2
	var_515_bool = var_514_bool == 0; // 0x1ee Not
	if(var_515_bool == 0) goto Label_519; // 0x1ef JumpB
	var_516_bool = 0; var_517_object = Obj(); // 0x1f0 PushV
	var_517_object = var_0_object; // 0x1f1 MovT
	func_1409(var_516_bool, var_517_object); // 0x1f2 NEW_2
	var_518_bool = var_516_bool == 0; // 0x1f4 Not
	if(var_518_bool == 0) goto Label_503; // 0x1f5 JumpB
...
Label_503:
	...
	var_519_float = var_68_float * var_68_float; // 0x1fd Mult
	var_520_bool = var_87_float < var_519_float; // 0x1fe LT
	if(var_520_bool == 0) goto Label_519; // 0x1ff JumpB
	var_521_bool = 0; var_522_float = 0; // 0x200 PushV
	var_522_float = var_68_float; // 0x201 Mov
	func_620(var_90_float, var_521_bool, var_522_float); // 0x202 NEW_2
	var_523_bool = var_521_bool == 0; // 0x204 Not
	if(var_523_bool == 0) goto Label_519; // 0x205 JumpB
	goto Label_529; // 0x206 Jump
	
Label_520:
	var_524_bool = 0; var_525_float = 0; // 0x208 PushV
	var_525_float = var_68_float; // 0x209 Mov
	func_620(var_90_float, var_524_bool, var_525_float); // 0x20a NEW_2
	var_526_bool = var_524_bool == 0; // 0x20c Not
	if(var_526_bool == 0) goto Label_527; // 0x20d JumpB
...
func_1861()
{
	var_54_int = 0; // 0x745 PushV
	func_1825(var_54_int); // 0x746 NEW_2
	var_58_int = 1; // 0x748 PushI
	var_59_bool = var_54_int != var_58_int; // 0x749 Neq
	if(var_59_bool == 0) goto Label_1868; // 0x74a JumpB
	return 0; // 0x74b Return
	
Label_1868:
	var_60_string = ""; // 0x74c PushV
	var_60_string = "liver"; // 0x74d MovS
	func_1844(var_60_string); // 0x74e NEW_2
	var_71_string = ""; // 0x750 PushV
	var_71_string = "kidney"; // 0x751 MovS
	func_1844(var_71_string); // 0x752 NEW_2
	var_72_string = ""; // 0x754 PushV
	var_72_string = "heart"; // 0x755 MovS
	func_1844(var_72_string); // 0x756 NEW_2
	var_73_string = ""; // 0x758 PushV
	var_73_string = "blood"; // 0x759 MovS
	func_1844(var_73_string); // 0x75a NEW_2
...
func_581(var_0_object, var_390_float, var_391_int)
{
	...
	var_469_int = 0; // 0x260 PushV
	func_964(var_469_int); // 0x261 NEW_2
	ReportHit(var_0_object, var_469_int, var_397_float, var_396_float); // 0x263 Func
	var_470_object = Obj(); var_471_float = 0; // 0x265 PushV
	var_470_object = var_395_object; // 0x266 Mov
	var_471_float = var_397_float; // 0x267 Mov
...
{
	var_52_object = Obj(); var_53_object = Obj(); // 0x75d PushV
	var_54_string = "b1q04_attack"; // 0x75e PushS
	var_55_int = 1; // 0x75f PushI
	SetVariable(var_54_string, var_55_int); // 0x760 Func
	GetScene(var_53_object); // 0x762 Func
	var_56_object = Obj(); // 0x764 PushV
	func_1627(var_56_object); // 0x765 NEW_2
	RemoveStationaryActor(var_56_object); // 0x767 ObjFunc
	var_59_object = Obj(); // 0x769 PushV
	var_59_object = var_51_object; // 0x76a Mov
	TaskCall(2); // 0x76b TaskCall
	func_299(var_59_object); // 0x76c NEW_2
...
Label_656:
	...
	var_472_string = "all"; // 0x295 PushS
	var_473_string = "attack_middle"; // 0x296 PushS
	var_474_int = var_473_string + var_359_int; // 0x297 Add
	HasAnimation(var_360_bool, var_472_string, var_474_int); // 0x298 Func
	var_475_bool = var_360_bool; // 0x29a Push
	if(var_475_bool == 0) goto Label_737; // 0x29b JumpB
	func_1732(); // 0x29d NEW_2
	var_476_string = "all"; // 0x29f PushS
	var_477_string = "attack_middle"; // 0x2a0 PushS
	var_478_int = var_477_string + var_359_int; // 0x2a1 Add
	PlayAnimation(var_476_string, var_478_int); // 0x2a2 Func
	WaitForAnimEnd(); // 0x2a4 Func
	func_959(var_362_string); // 0x2a7 NEW_2
	var_479_bool = 0; var_480_object = Obj(); // 0x2a9 PushV
	var_480_object = var_0_object; // 0x2aa MovT
	func_1409(var_479_bool, var_480_object); // 0x2ab NEW_2
	var_481_bool = var_479_bool == 0; // 0x2ad Not
	if(var_481_bool == 0) goto Label_691; // 0x2ae JumpB
	StopAsync(); // 0x2af Func
	var_353_bool = 0; // 0x2b1 MovB
	return 8; // 0x2b2 Return
	
Label_691:
	var_482_float = 0; var_483_int = 0; // 0x2b3 PushV
	var_482_float = var_354_float; // 0x2b4 Mov
	var_483_int = var_359_int; // 0x2b5 Mov
	func_581(var_362_string, var_482_float, var_483_int); // 0x2b6 NEW_2
	var_361_int = 1; // 0x2b8 MovI
	
Label_697:
	var_484_string = "attack_middle"; // 0x2b9 PushS
	var_485_int = var_484_string + var_359_int; // 0x2ba Add
	var_486_string = "_"; // 0x2bb PushS
	var_487_int = var_485_int + var_486_string; // 0x2bc Add
	var_362_string = var_487_int + var_361_int; // 0x2bd Add2
	var_488_string = "all"; // 0x2be PushS
	HasAnimation(var_360_bool, var_488_string, var_362_string); // 0x2bf Func
	var_489_bool = var_360_bool == 0; // 0x2c1 Not
	if(var_489_bool == 0) goto Label_708; // 0x2c2 JumpB
	goto Label_737; // 0x2c3 Jump
	
Label_737:
	var_490_bool = 0; // 0x2e1 PushB
	SetAttackState(var_490_bool); // 0x2e2 Func
	var_491_string = "all"; // 0x2e4 PushS
	var_492_string = "attack_end"; // 0x2e5 PushS
	var_493_int = var_492_string + var_359_int; // 0x2e6 Add
	PlayAnimation(var_491_string, var_493_int); // 0x2e7 Func
	var_494_bool = 0; // 0x2e9 PushV
	func_973(var_494_bool); // 0x2ea NEW_2
	if(var_494_bool == 0) goto Label_755; // 0x2ec JumpB
	var_495_bool = 0; var_496_float = 0; // 0x2ed PushV
	var_496_float = 0.75; // 0x2ee MovF
	func_757(var_495_bool, var_496_float); // 0x2ef NEW_2
...
Label_708:
	func_1732(); // 0x2c5 NEW_2
	var_504_string = "all"; // 0x2c7 PushS
	PlayAnimation(var_504_string, var_362_string); // 0x2c8 Func
	WaitForAnimEnd(); // 0x2ca Func
	func_959(var_362_string); // 0x2cd NEW_2
	var_505_bool = 0; var_506_object = Obj(); // 0x2cf PushV
	var_506_object = var_0_object; // 0x2d0 MovT
	func_1409(var_505_bool, var_506_object); // 0x2d1 NEW_2
	var_507_bool = var_505_bool == 0; // 0x2d3 Not
	if(var_507_bool == 0) goto Label_729; // 0x2d4 JumpB
	StopAsync(); // 0x2d5 Func
	var_353_bool = 0; // 0x2d7 MovB
	return 8; // 0x2d8 Return
	
Label_729:
	var_508_float = 0; var_509_int = 0; // 0x2d9 PushV
	var_508_float = var_354_float; // 0x2da Mov
	var_509_int = var_359_int; // 0x2db Mov
	func_581(var_362_string, var_508_float, var_509_int); // 0x2dc NEW_2
	var_510_int = 1; // 0x2de PushI
	var_361_int = var_361_int + var_510_int; // 0x2df Add2
...
Label_1682:
	...
	func_1713(var_23_float); // 0x694 NEW_2
...
func_1696(var_460_float)
{
	...
	var_463_int = 0; // 0x6a5 PushI
	var_464_bool = var_460_float < var_463_int; // 0x6a6 LT
	if(var_464_bool == 0) goto Label_1708; // 0x6a7 JumpB
	var_465_float = 0.7; // 0x6a8 PushF
	var_466_int = 500; // 0x6a9 PushI
	RumblePlay(var_465_float, var_466_int); // 0x6aa Func
	
Label_1708:
	var_467_int = 15; // 0x6ac PushI
	SendWorldWndMessage(var_467_int, var_462_object); // 0x6ad Func
...
{
	var_24_object = Obj(); var_25_object = Obj(); // 0x6b1 PushV
	CreateFloatVector(var_25_object); // 0x6b2 Func
	add(var_23_float); // 0x6b4 ObjFunc
	var_26_int = 16; // 0x6b6 PushI
	SendWorldWndMessage(var_26_int, var_25_object); // 0x6b7 Func
...
{
	var_13_bool = 0; var_14_bool = 0; // 0x6bb PushV
	IsPlayerActor(var_12_object, var_14_bool); // 0x6bc Func
	var_15_bool = var_14_bool; // 0x6be Push
	if(var_15_bool == 0) goto Label_1731; // 0x6bf JumpB
	var_16_string = "attack"; // 0x6c0 PushS
	PlayGlobalMusic(var_16_string); // 0x6c1 Func
...
func_959(var_0_object)
{
	...
	func_1723(var_128_object); // 0x3c1 NEW_2
...
func_1732()
{
	var_365_object = Obj(); var_366_object = Obj(); // 0x6c4 PushV
	GetScene(var_366_object); // 0x6c5 Func
	var_367_string = "battle"; // 0x6c7 PushS
	var_368_object = Obj(); // 0x6c8 PushV
	func_1627(var_368_object); // 0x6c9 NEW_2
	BroadcastMessage(var_367_string, var_368_object, var_366_object); // 0x6cb Func
...
{
	var_36_string = ""; var_37_string = ""; // 0x6cf PushV
	var_37_string = "idle"; // 0x6d0 MovS
	var_38_int = var_35_int; // 0x6d1 Push
	if(var_38_int == 0) goto Label_1748; // 0x6d2 JumpB
	var_37_string = var_37_string + var_35_int; // 0x6d3 Add2
	
Label_1748:
	var_34_string = var_37_string; // 0x6d4 Mov
...
func_979(var_2_int, var_135_bool, var_136_object, var_137_float, var_138_float, var_139_bool, var_140_bool)
{
	...
	func_1723(var_148_object); // 0x3d6 NEW_2
...
{
	var_29_int = 0; var_30_bool = 0; var_31_int = 0; var_32_bool = 0; // 0x6d6 PushV
	var_31_int = 0; // 0x6d7 MovI
	
Label_1752:
	var_33_string = "all"; // 0x6d8 PushS
	var_34_string = ""; var_35_int = 0; // 0x6d9 PushV
	var_35_int = var_31_int; // 0x6da Mov
	func_1743(var_34_string, var_35_int); // 0x6db NEW_2
	HasAnimation(var_32_bool, var_33_string, var_34_string); // 0x6dd Func
	var_39_bool = var_32_bool == 0; // 0x6df Not
	if(var_39_bool == 0) goto Label_1762; // 0x6e0 JumpB
	goto Label_1765; // 0x6e1 Jump
	
Label_1765:
	var_28_int = var_31_int; // 0x6e5 Mov
	return 4; // 0x6e6 Return
	
Label_1762:
	var_40_int = 1; // 0x6e2 PushI
	var_31_int = var_31_int + var_40_int; // 0x6e3 Add2
	goto Label_1752; // 0x6e4 Jump
}
...
{
	var_11_object = Obj(); // 0x6e8 PushV
	var_11_object = var_10_object; // 0x6e9 Mov
	TaskCall(1); // 0x6ea TaskCall
	func_128(var_11_object); // 0x6eb NEW_2
...
{
	var_497_float = 0; var_498_bool = 0; var_499_float = 0; var_500_bool = 0; // 0x2f5 PushV
	rand(var_499_float); // 0x2f6 Func
	var_501_bool = var_499_float < var_496_float; // 0x2f8 LT
	if(var_501_bool == 0) goto Label_777; // 0x2f9 JumpB
	
Label_762:
	IsAnimationPlaying(var_500_bool); // 0x2fa Func
	var_502_bool = var_500_bool == 0; // 0x2fc Not
	if(var_502_bool == 0) goto Label_767; // 0x2fd JumpB
...
Label_782:
	var_495_bool = 0; // 0x30e MovB
	return 4; // 0x30f Return
	
Label_767:
	var_503_bool = 0; // 0x2ff PushV
	func_855(var_503_bool); // 0x300 NEW_2
	if(var_503_bool == 0) goto Label_773; // 0x302 JumpB
	var_495_bool = 1; // 0x303 MovB
...
Label_777:
	...
	func_959(var_500_bool); // 0x30c NEW_2
}
