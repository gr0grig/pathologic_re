...
0x39c: @@ HasProperty(Stack[-1], Stack[-4])
0x39d: Pop(1)
...
0x3b1: @@ GetProperty(Stack[-1], Stack[-2])
0x3b2: Pop(1)
0x3b3: PushEmpty(bool, string)
0x3b4: Stack[-1] = Stack[-3]
0x3b5: Call2 0x3d8

0x3b6: Stack[-14] = Stack[-2]
0x3b7: Pop(2)
0x3b8: Return(); Pop(10)
...
0x475: Stack[-1] = "ui/NPC_Petr.png"
0x476: Return(); Pop(0)

0x477: Stack[-1] = "ui/NPC_Petr_b.png"
0x478: Return(); Pop(0)
