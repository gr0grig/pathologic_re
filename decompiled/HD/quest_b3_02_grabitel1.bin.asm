...
0x965: Push("Can't find lsh animation : ")
...
0x974: Push("Can't find lsh animation : ")
...
0xa21: Stack[-1] = Stack[-2]
0xa22: Call2 0xa3f

0xa23: Pop(1)
0xa24: PushEmpty(bool, object, string, float, float, float)
0xa25: Stack[-5] = Stack[-8]
0xa26: Stack[-4] = "reputation"
0xa27: Stack[-3] = Stack[-7]
0xa28: Stack[-2] = (int) 0
0xa29: Stack[-1] = (int) 1
0xa2a: Call2 0x7a3
...
0xa79: Stack[-3] = Stack[-9]
0xa7a: Stack[-2] = Stack[-8]
0xa7b: Stack[-1] = Stack[-7]
0xa7c: Call2 0x9d6

0xa7d: Stack[-6] = Stack[-4]
0xa7e: Pop(4)
0xa7f: Push((int) 0)
...
0xa96: Stack[-1] = "ui/NPC_Citizen1.png"
0xa97: Return(); Pop(0)

0xa98: Stack[-1] = "ui/NPC_Citizen1_b.png"
0xa99: Return(); Pop(0)
...
0xab2: Stack[-5] = Stack[-2]
0xab3: Return(); Pop(4)

0xab4: PushEmpty()
0xab5: Push("b3q02GrabitelTalk")
0xab6: Push((int) 1)
...
0xabc: Stack[-2] = "quest_b3_02"
0xabd: Stack[-1] = "grabitel_attack"
0xabe: Call2 0xa49
...
0xaf4: Push("GenerateMoney: iMin > iMax")
0xaf5: @ Trace(Stack[-1])
0xaf6: Pop(1)
0xaf7: Return(); Pop(4)
...
0xb12: Pop(0)
0xb13: @@ SetItemName(Stack[-7])
0xb14: Pop(0)
0xb15: Push("Organ")
0xb16: Push((int) 1)
0xb17: @@ SetProperty(Stack[-2], Stack[-1])
0xb18: Pop(2)
0xb19: @@ GetItemID(Stack[-2])
0xb1a: Pop(0)
0xb1b: Push((int) 0)
0xb1c: Push((int) 1)
...
0xb61: Pop(0)
0xb62: @@ RemoveStationaryActor(Stack[-1])
0xb63: Pop(1)
0xb64: PushEmpty(bool, string, string)
0xb65: Stack[-2] = "quest_b3_02"
0xb66: Stack[-1] = "grabitel_dead"
0xb67: Call2 0xa49
...
0xb6f: Stack[-2] = Stack[-6]
0xb70: Stack[-1] = (float) 0.03
0xb71: Call2 0xa0b
...
0xb7d: Stack[-3] = Stack[-7]
0xb7e: Stack[-2] = Stack[-6]
0xb7f: Stack[-1] = Stack[-5]
0xb80: Call2 0x8a1
...
0xb85: Stack[-5] = Stack[-11]
0xb86: Stack[-4] = Stack[-10]
0xb87: Stack[-3] = Stack[-9]
0xb88: Stack[-2] = Stack[-7]
0xb89: Stack[-1] = Stack[-6]
0xb8a: Call2 0x8e5
