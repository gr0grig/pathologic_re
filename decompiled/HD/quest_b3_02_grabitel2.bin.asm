...
0x84a: Stack[-3] = Stack[-9]
0x84b: Stack[-2] = Stack[-8]
0x84c: Stack[-1] = Stack[-7]
0x84d: Call2 0x7a0

0x84e: Stack[-6] = Stack[-4]
0x84f: Pop(4)
0x850: Push((int) 0)
...
0x856: Stack[-4] = Stack[-10]
0x857: Stack[-3] = Stack[-9]
0x858: Stack[-2] = Stack[-8]
...
0x879: Push("GenerateMoney: iMin > iMax")
0x87a: @ Trace(Stack[-1])
0x87b: Pop(1)
0x87c: Return(); Pop(4)
...
0x897: Pop(0)
0x898: @@ SetItemName(Stack[-7])
0x899: Pop(0)
0x89a: Push("Organ")
0x89b: Push((int) 1)
0x89c: @@ SetProperty(Stack[-2], Stack[-1])
0x89d: Pop(2)
0x89e: @@ GetItemID(Stack[-2])
0x89f: Pop(0)
0x8a0: Push((int) 0)
0x8a1: Push((int) 1)
...
0x8e6: Pop(0)
0x8e7: @@ RemoveStationaryActor(Stack[-1])
0x8e8: Pop(1)
...
0x8ef: Stack[-2] = Stack[-6]
0x8f0: Stack[-1] = (float) 0.02
0x8f1: Call2 0x7d0
...
0x8fd: Stack[-3] = Stack[-7]
0x8fe: Stack[-2] = Stack[-6]
0x8ff: Stack[-1] = Stack[-5]
0x900: Call2 0x6e8
...
0x905: Stack[-5] = Stack[-11]
0x906: Stack[-4] = Stack[-10]
0x907: Stack[-3] = Stack[-9]
0x908: Stack[-2] = Stack[-7]
0x909: Stack[-1] = Stack[-6]
0x90a: Call2 0x72c
...
0x922: Stack[-1] = Stack[-3]
0x923: Call2 0x691

0x924: Stack[-4] = Stack[-2]
0x925: Pop(2)
0x926: Return(); Pop(0)
...
0x937: Pop(0)
0x938: @@ RemoveStationaryActor(Stack[-1])
0x939: Pop(1)
