...
task_1_event_17(var_0_int, var_1_bool, var_2_object, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_object, var_11_bool)
{
	...
	func_1705(var_15_bool, var_16_string, var_17_string); // 0x36 NEW_2
...
task_3_event_7(var_0_int, var_1_bool, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_int)
{
	...
	func_1717(var_14_object); // 0x386 NEW_2
...
task_4_event_0(var_0_int, var_1_bool, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_object)
{
	...
	func_1743(var_15_object); // 0x463 NEW_2
...
{
	var_11_object = Obj(); // 0x705 PushV
	func_1649(var_11_object); // 0x706 NEW_2
	RemoveActor(var_11_object); // 0x708 Func
	Hold(); // 0x70a Func
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0x73b PushV
	var_15_object = var_11_object; // 0x73c Mov
	var_16_int = var_12_int; // 0x73d Mov
	var_17_float = var_13_float; // 0x73e Mov
	func_1484(var_15_object, var_16_int, var_17_float); // 0x73f NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0x743 PushV
	var_17_object = var_11_object; // 0x744 Mov
	var_18_int = var_12_int; // 0x745 Mov
	var_19_float = var_13_float; // 0x746 Mov
	var_20_cvector = var_15_cvector; // 0x747 Mov
	var_21_cvector = var_16_cvector; // 0x748 Mov
	func_1552(var_19_float, var_20_cvector, var_21_cvector); // 0x749 NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0x74c PushV
	var_15_string = "health"; // 0x74d PushS
	var_16_bool = var_12_string == var_15_string; // 0x74e Eq
	if(var_16_bool == 0) goto Label_1880; // 0x74f JumpB
	var_17_string = "health"; // 0x750 PushS
	GetProperty(var_17_string, var_14_float); // 0x751 Func
	var_18_int = 0; // 0x753 PushI
	var_19_bool = var_14_float <= var_18_int; // 0x754 LE
	if(var_19_bool == 0) goto Label_1880; // 0x755 JumpB
	SignalDeath(var_11_object); // 0x756 Func
...
{
	var_12_object = Obj(); // 0x75a PushV
	var_12_object = var_11_object; // 0x75b Mov
	func_1805(var_12_object); // 0x75c NEW_2
...
Label_1311:
	var_460_string = "armor"; // 0x51f PushS
	GetProperty(var_460_string, var_409_int); // 0x520 ObjFunc
}
...
{
	var_13_bool = 0; var_14_bool = 0; // 0x70d PushV
	var_15_bool = 0; var_16_string = ""; var_17_string = ""; // 0x70e PushV
	var_16_string = "quest_b4_01"; // 0x70f MovS
	var_17_string = "patrol_dead"; // 0x710 MovS
	func_1705(var_15_bool, var_16_string, var_17_string); // 0x711 NEW_2
	var_21_string = "revolver_ammo"; // 0x713 PushS
	var_22_int = 0; // 0x714 PushI
	var_23_int = 4; // 0x715 PushI
	AddItem(var_14_bool, var_21_string, var_22_int, var_23_int); // 0x716 Func
	var_24_string = "meradorm"; // 0x718 PushS
	var_25_int = 0; // 0x719 PushI
	var_26_int = 1; // 0x71a PushI
	AddItem(var_14_bool, var_24_string, var_25_int, var_26_int); // 0x71b Func
	var_27_string = "morfin"; // 0x71d PushS
	var_28_int = 0; // 0x71e PushI
	var_29_int = 1; // 0x71f PushI
	AddItem(var_14_bool, var_27_string, var_28_int, var_29_int); // 0x720 Func
	var_30_string = ""; var_31_int = 0; var_32_int = 0; var_33_int = 0; // 0x722 PushV
	var_30_string = "alpha_pills"; // 0x723 MovS
	var_31_int = 2; // 0x724 MovI
	var_32_int = 3; // 0x725 MovI
	var_33_int = 5; // 0x726 MovI
	func_1593(var_30_string, var_31_int, var_32_int, var_33_int); // 0x727 NEW_2
	var_46_string = ""; var_47_int = 0; var_48_int = 0; var_49_int = 0; // 0x729 PushV
	var_46_string = "beta_pills"; // 0x72a MovS
	var_47_int = 2; // 0x72b MovI
	var_48_int = 3; // 0x72c MovI
	var_49_int = 4; // 0x72d MovI
	func_1593(var_46_string, var_47_int, var_48_int, var_49_int); // 0x72e NEW_2
	func_1773(); // 0x731 NEW_2
	var_70_object = Obj(); // 0x733 PushV
	var_70_object = var_12_object; // 0x734 Mov
	TaskCall(4); // 0x735 TaskCall
	func_1103(var_70_object); // 0x736 NEW_2
...
func_1688(var_452_float)
{
	...
	var_455_int = 0; // 0x69d PushI
	var_456_bool = var_452_float < var_455_int; // 0x69e LT
	if(var_456_bool == 0) goto Label_1700; // 0x69f JumpB
	var_457_float = 0.7; // 0x6a0 PushF
	var_458_int = 500; // 0x6a1 PushI
	RumblePlay(var_457_float, var_458_int); // 0x6a2 Func
	
Label_1700:
	var_459_int = 15; // 0x6a4 PushI
	SendWorldWndMessage(var_459_int, var_454_object); // 0x6a5 Func
...
Label_167:
	...
	var_519_int = 1; // 0xad PushI
	Sleep(var_519_int); // 0xae Func
...
{
	var_18_object = Obj(); var_19_object = Obj(); // 0x6a9 PushV
	FindActor(var_19_object, var_16_string); // 0x6aa Func
	var_20_bool = var_19_object == 0; // 0x6ac NullEq
	if(var_20_bool == 0) goto Label_1712; // 0x6ad JumpB
	var_15_bool = 0; // 0x6ae MovB
	return 2; // 0x6af Return
	
Label_1712:
	Trigger(var_19_object, var_17_string); // 0x6b0 Func
	var_15_bool = 1; // 0x6b2 MovB
...
{
	var_15_bool = 0; var_16_bool = 0; // 0x6b5 PushV
	IsPlayerActor(var_14_object, var_16_bool); // 0x6b6 Func
	var_17_bool = var_16_bool; // 0x6b8 Push
	if(var_17_bool == 0) goto Label_1725; // 0x6b9 JumpB
	var_18_string = "attack"; // 0x6ba PushS
	PlayGlobalMusic(var_18_string); // 0x6bb Func
...
Label_341:
	...
	var_503_string = "all"; // 0x157 PushS
	var_504_string = "fjump"; // 0x158 PushS
	PlayAnimation(var_503_string, var_504_string); // 0x159 Func
	WaitForAnimEnd(); // 0x15b Func
	func_827(var_48_float); // 0x15e NEW_2
	var_505_cvector = CVector(0.0, 0.0, 0.0); // 0x160 PushVec
	SetSpeed(var_505_cvector); // 0x161 Func
	Stop(); // 0x163 Func
	StopAsync(); // 0x165 Func
	var_506_bool = 0; // 0x167 PushV
	func_784(var_48_float, var_506_bool); // 0x168 NEW_2
	var_507_bool = var_506_bool == 0; // 0x16a Not
	if(var_507_bool == 0) goto Label_387; // 0x16b JumpB
	var_508_bool = 0; var_509_object = Obj(); // 0x16c PushV
	var_509_object = var_0_int; // 0x16d MovT
	func_1406(var_508_bool, var_509_object); // 0x16e NEW_2
	var_510_bool = var_508_bool == 0; // 0x170 Not
	if(var_510_bool == 0) goto Label_371; // 0x171 JumpB
...
Label_371:
	...
	var_511_float = var_26_float * var_26_float; // 0x179 Mult
	var_512_bool = var_45_float < var_511_float; // 0x17a LT
	if(var_512_bool == 0) goto Label_387; // 0x17b JumpB
	var_513_bool = 0; var_514_float = 0; // 0x17c PushV
	var_514_float = var_26_float; // 0x17d Mov
	func_488(var_48_float, var_513_bool, var_514_float); // 0x17e NEW_2
	var_515_bool = var_513_bool == 0; // 0x180 Not
	if(var_515_bool == 0) goto Label_387; // 0x181 JumpB
	goto Label_397; // 0x182 Jump
	
Label_388:
	var_516_bool = 0; var_517_float = 0; // 0x184 PushV
	var_517_float = var_26_float; // 0x185 Mov
	func_488(var_48_float, var_516_bool, var_517_float); // 0x186 NEW_2
	var_518_bool = var_516_bool == 0; // 0x188 Not
	if(var_518_bool == 0) goto Label_395; // 0x189 JumpB
...
func_827(var_0_int)
{
	...
	func_1717(var_120_object); // 0x33d NEW_2
...
func_1726()
{
	var_357_object = Obj(); var_358_object = Obj(); // 0x6be PushV
	GetScene(var_358_object); // 0x6bf Func
	var_359_string = "battle"; // 0x6c1 PushS
	var_360_object = Obj(); // 0x6c2 PushV
	func_1649(var_360_object); // 0x6c3 NEW_2
	BroadcastMessage(var_359_string, var_360_object, var_358_object); // 0x6c5 Func
...
func_449(var_0_int, var_382_float, var_383_int)
{
	...
	var_461_int = 0; // 0x1dc PushV
	func_832(var_461_int); // 0x1dd NEW_2
	ReportHit(var_0_int, var_461_int, var_389_float, var_388_float); // 0x1df Func
	var_462_object = Obj(); var_463_float = 0; // 0x1e1 PushV
	var_462_object = var_387_object; // 0x1e2 Mov
	var_463_float = var_389_float; // 0x1e3 Mov
...
{
	var_51_int = 0; var_52_int = 0; // 0x6c9 PushV
	var_53_string = "branch"; // 0x6ca PushS
	GetVariable(var_53_string, var_52_int); // 0x6cb Func
	var_50_int = var_52_int; // 0x6cd Mov
...
func_847(var_2_string, var_127_bool, var_128_object, var_129_float, var_130_float, var_131_bool, var_132_bool)
{
	...
	func_1717(var_140_object); // 0x352 NEW_2
...
{
	var_16_int = 0; // 0x6d0 PushV
	func_1737(var_16_int); // 0x6d1 NEW_2
	var_20_int = 1; // 0x6d3 PushI
	var_21_bool = var_16_int == var_20_int; // 0x6d4 Eq
	if(var_21_bool == 0) goto Label_1753; // 0x6d5 JumpB
	WorkWithCorpse(var_15_object); // 0x6d6 Func
...
Label_1753:
	Barter(var_15_object); // 0x6d9 Func
}
...
{
	var_57_object = Obj(); var_58_int = 0; var_59_bool = 0; var_60_object = Obj(); var_61_int = 0; var_62_bool = 0; // 0x6dc PushV
	CreateInvItem(var_60_object); // 0x6dd Func
	SetItemName(var_56_string); // 0x6df ObjFunc
	var_63_string = "Organ"; // 0x6e1 PushS
	var_64_int = 1; // 0x6e2 PushI
	SetProperty(var_63_string, var_64_int); // 0x6e3 ObjFunc
	GetItemID(var_61_int); // 0x6e5 ObjFunc
	var_65_int = 0; // 0x6e7 PushI
	var_66_int = 1; // 0x6e8 PushI
	AddItem(var_62_bool, var_60_object, var_65_int, var_66_int); // 0x6e9 Func
	return 6; // 0x6eb Return
}
...
Label_524:
	...
	var_464_string = "all"; // 0x211 PushS
	var_465_string = "attack_middle"; // 0x212 PushS
	var_466_int = var_465_string + var_351_int; // 0x213 Add
	HasAnimation(var_352_bool, var_464_string, var_466_int); // 0x214 Func
	var_467_bool = var_352_bool; // 0x216 Push
	if(var_467_bool == 0) goto Label_605; // 0x217 JumpB
	func_1726(); // 0x219 NEW_2
	var_468_string = "all"; // 0x21b PushS
	var_469_string = "attack_middle"; // 0x21c PushS
	var_470_int = var_469_string + var_351_int; // 0x21d Add
	PlayAnimation(var_468_string, var_470_int); // 0x21e Func
	WaitForAnimEnd(); // 0x220 Func
	func_827(var_354_string); // 0x223 NEW_2
	var_471_bool = 0; var_472_object = Obj(); // 0x225 PushV
	var_472_object = var_0_int; // 0x226 MovT
	func_1406(var_471_bool, var_472_object); // 0x227 NEW_2
	var_473_bool = var_471_bool == 0; // 0x229 Not
	if(var_473_bool == 0) goto Label_559; // 0x22a JumpB
	StopAsync(); // 0x22b Func
	var_345_bool = 0; // 0x22d MovB
	return 8; // 0x22e Return
	
Label_559:
	var_474_float = 0; var_475_int = 0; // 0x22f PushV
	var_474_float = var_346_float; // 0x230 Mov
	var_475_int = var_351_int; // 0x231 Mov
	func_449(var_354_string, var_474_float, var_475_int); // 0x232 NEW_2
	var_353_int = 1; // 0x234 MovI
	
Label_565:
	var_476_string = "attack_middle"; // 0x235 PushS
	var_477_int = var_476_string + var_351_int; // 0x236 Add
	var_478_string = "_"; // 0x237 PushS
	var_479_int = var_477_int + var_478_string; // 0x238 Add
	var_354_string = var_479_int + var_353_int; // 0x239 Add2
	var_480_string = "all"; // 0x23a PushS
	HasAnimation(var_352_bool, var_480_string, var_354_string); // 0x23b Func
	var_481_bool = var_352_bool == 0; // 0x23d Not
	if(var_481_bool == 0) goto Label_576; // 0x23e JumpB
	goto Label_605; // 0x23f Jump
	
Label_605:
	var_482_bool = 0; // 0x25d PushB
	SetAttackState(var_482_bool); // 0x25e Func
	var_483_string = "all"; // 0x260 PushS
	var_484_string = "attack_end"; // 0x261 PushS
	var_485_int = var_484_string + var_351_int; // 0x262 Add
	PlayAnimation(var_483_string, var_485_int); // 0x263 Func
	var_486_bool = 0; // 0x265 PushV
	func_841(var_486_bool); // 0x266 NEW_2
	if(var_486_bool == 0) goto Label_623; // 0x268 JumpB
	var_487_bool = 0; var_488_float = 0; // 0x269 PushV
	var_488_float = 0.75; // 0x26a MovF
	func_625(var_487_bool, var_488_float); // 0x26b NEW_2
...
Label_576:
	func_1726(); // 0x241 NEW_2
	var_496_string = "all"; // 0x243 PushS
	PlayAnimation(var_496_string, var_354_string); // 0x244 Func
	WaitForAnimEnd(); // 0x246 Func
	func_827(var_354_string); // 0x249 NEW_2
	var_497_bool = 0; var_498_object = Obj(); // 0x24b PushV
	var_498_object = var_0_int; // 0x24c MovT
	func_1406(var_497_bool, var_498_object); // 0x24d NEW_2
	var_499_bool = var_497_bool == 0; // 0x24f Not
	if(var_499_bool == 0) goto Label_597; // 0x250 JumpB
	StopAsync(); // 0x251 Func
	var_345_bool = 0; // 0x253 MovB
	return 8; // 0x254 Return
	
Label_597:
	var_500_float = 0; var_501_int = 0; // 0x255 PushV
	var_500_float = var_346_float; // 0x256 Mov
	var_501_int = var_351_int; // 0x257 Mov
	func_449(var_354_string, var_500_float, var_501_int); // 0x258 NEW_2
	var_502_int = 1; // 0x25a PushI
	var_353_int = var_353_int + var_502_int; // 0x25b Add2
...
func_1773()
{
	var_50_int = 0; // 0x6ed PushV
	func_1737(var_50_int); // 0x6ee NEW_2
	var_54_int = 1; // 0x6f0 PushI
	var_55_bool = var_50_int != var_54_int; // 0x6f1 Neq
	if(var_55_bool == 0) goto Label_1780; // 0x6f2 JumpB
	return 0; // 0x6f3 Return
	
Label_1780:
	var_56_string = ""; // 0x6f4 PushV
	var_56_string = "liver"; // 0x6f5 MovS
	func_1756(var_56_string); // 0x6f6 NEW_2
	var_67_string = ""; // 0x6f8 PushV
	var_67_string = "kidney"; // 0x6f9 MovS
	func_1756(var_67_string); // 0x6fa NEW_2
	var_68_string = ""; // 0x6fc PushV
	var_68_string = "heart"; // 0x6fd MovS
	func_1756(var_68_string); // 0x6fe NEW_2
	var_69_string = ""; // 0x700 PushV
	var_69_string = "blood"; // 0x701 MovS
	func_1756(var_69_string); // 0x702 NEW_2
...
{
	var_489_float = 0; var_490_bool = 0; var_491_float = 0; var_492_bool = 0; // 0x271 PushV
	rand(var_491_float); // 0x272 Func
	var_493_bool = var_491_float < var_488_float; // 0x274 LT
	if(var_493_bool == 0) goto Label_645; // 0x275 JumpB
	
Label_630:
	IsAnimationPlaying(var_492_bool); // 0x276 Func
	var_494_bool = var_492_bool == 0; // 0x278 Not
	if(var_494_bool == 0) goto Label_635; // 0x279 JumpB
...
Label_650:
	var_487_bool = 0; // 0x28a MovB
	return 4; // 0x28b Return
	
Label_635:
	var_495_bool = 0; // 0x27b PushV
	func_723(var_495_bool); // 0x27c NEW_2
	if(var_495_bool == 0) goto Label_641; // 0x27e JumpB
	var_487_bool = 1; // 0x27f MovB
...
Label_645:
	...
	func_827(var_492_bool); // 0x288 NEW_2
}
