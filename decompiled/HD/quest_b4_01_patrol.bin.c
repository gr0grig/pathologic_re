...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1510(var_12_object); // 0x2f9 NEW_2
...
{
	var_9_object = Obj(); // 0x5fa PushV
	func_1459(var_9_object); // 0x5fb NEW_2
	RemoveActor(var_9_object); // 0x5fd Func
	Hold(); // 0x5ff Func
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x60b PushV
	var_13_object = var_9_object; // 0x60c Mov
	var_14_int = var_10_int; // 0x60d Mov
	var_15_float = var_11_float; // 0x60e Mov
	func_1314(var_13_object, var_14_int, var_15_float); // 0x60f NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x613 PushV
	var_15_object = var_9_object; // 0x614 Mov
	var_16_int = var_10_int; // 0x615 Mov
	var_17_float = var_11_float; // 0x616 Mov
	var_18_cvector = var_13_cvector; // 0x617 Mov
	var_19_cvector = var_14_cvector; // 0x618 Mov
	func_1382(var_17_float, var_18_cvector, var_19_cvector); // 0x619 NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x61c PushV
	var_13_string = "health"; // 0x61d PushS
	var_14_bool = var_10_string == var_13_string; // 0x61e Eq
	if(var_14_bool == 0) goto Label_1576; // 0x61f JumpB
	var_15_string = "health"; // 0x620 PushS
	GetProperty(var_15_string, var_12_float); // 0x621 Func
	var_16_int = 0; // 0x623 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x624 LE
	if(var_17_bool == 0) goto Label_1576; // 0x625 JumpB
	SignalDeath(var_9_object); // 0x626 Func
...
{
	var_10_object = Obj(); // 0x62a PushV
	var_10_object = var_9_object; // 0x62b Mov
	func_1538(var_10_object); // 0x62c NEW_2
...
{
	var_11_object = Obj(); // 0x603 PushV
	var_11_object = var_10_object; // 0x604 Mov
	TaskCall(3); // 0x605 TaskCall
	func_962(var_11_object); // 0x606 NEW_2
	TaskReturn(); // 0x607 TaskReturn
...
Label_26:
	...
	var_514_int = 1; // 0x20 PushI
	Sleep(var_514_int); // 0x21 Func
...
Label_200:
	...
	var_498_string = "all"; // 0xca PushS
	var_499_string = "fjump"; // 0xcb PushS
	PlayAnimation(var_498_string, var_499_string); // 0xcc Func
	WaitForAnimEnd(); // 0xce Func
	func_686(var_43_float); // 0xd1 NEW_2
	var_500_cvector = CVector(0.0, 0.0, 0.0); // 0xd3 PushVec
	SetSpeed(var_500_cvector); // 0xd4 Func
	Stop(); // 0xd6 Func
	StopAsync(); // 0xd8 Func
	var_501_bool = 0; // 0xda PushV
	func_643(var_43_float, var_501_bool); // 0xdb NEW_2
	var_502_bool = var_501_bool == 0; // 0xdd Not
	if(var_502_bool == 0) goto Label_246; // 0xde JumpB
	var_503_bool = 0; var_504_object = Obj(); // 0xdf PushV
	var_504_object = var_0_object; // 0xe0 MovT
	func_1246(var_503_bool, var_504_object); // 0xe1 NEW_2
	var_505_bool = var_503_bool == 0; // 0xe3 Not
	if(var_505_bool == 0) goto Label_230; // 0xe4 JumpB
...
Label_230:
	...
	var_506_float = var_21_float * var_21_float; // 0xec Mult
	var_507_bool = var_40_float < var_506_float; // 0xed LT
	if(var_507_bool == 0) goto Label_246; // 0xee JumpB
	var_508_bool = 0; var_509_float = 0; // 0xef PushV
	var_509_float = var_21_float; // 0xf0 Mov
	func_347(var_43_float, var_508_bool, var_509_float); // 0xf1 NEW_2
	var_510_bool = var_508_bool == 0; // 0xf3 Not
	if(var_510_bool == 0) goto Label_246; // 0xf4 JumpB
	goto Label_256; // 0xf5 Jump
	
Label_247:
	var_511_bool = 0; var_512_float = 0; // 0xf7 PushV
	var_512_float = var_21_float; // 0xf8 Mov
	func_347(var_43_float, var_511_bool, var_512_float); // 0xf9 NEW_2
	var_513_bool = var_511_bool == 0; // 0xfb Not
	if(var_513_bool == 0) goto Label_254; // 0xfc JumpB
...
func_686(var_0_object)
{
	...
	func_1510(var_115_object); // 0x2b0 NEW_2
...
func_308(var_0_object, var_377_float, var_378_int)
{
	...
	var_456_int = 0; // 0x14f PushV
	func_691(var_456_int); // 0x150 NEW_2
	ReportHit(var_0_object, var_456_int, var_384_float, var_383_float); // 0x152 Func
	var_457_object = Obj(); var_458_float = 0; // 0x154 PushV
	var_457_object = var_382_object; // 0x155 Mov
	var_458_float = var_384_float; // 0x156 Mov
...
func_706(var_2_int, var_122_bool, var_123_object, var_124_float, var_125_float, var_126_bool, var_127_bool)
{
	...
	func_1510(var_135_object); // 0x2c5 NEW_2
...
func_1493(var_447_float)
{
	...
	var_450_int = 0; // 0x5da PushI
	var_451_bool = var_447_float < var_450_int; // 0x5db LT
	if(var_451_bool == 0) goto Label_1505; // 0x5dc JumpB
	var_452_float = 0.7; // 0x5dd PushF
	var_453_int = 500; // 0x5de PushI
	RumblePlay(var_452_float, var_453_int); // 0x5df Func
	
Label_1505:
	var_454_int = 15; // 0x5e1 PushI
	SendWorldWndMessage(var_454_int, var_449_object); // 0x5e2 Func
...
Label_383:
	...
	var_459_string = "all"; // 0x184 PushS
	var_460_string = "attack_middle"; // 0x185 PushS
	var_461_int = var_460_string + var_346_int; // 0x186 Add
	HasAnimation(var_347_bool, var_459_string, var_461_int); // 0x187 Func
	var_462_bool = var_347_bool; // 0x189 Push
	if(var_462_bool == 0) goto Label_464; // 0x18a JumpB
	func_1519(); // 0x18c NEW_2
	var_463_string = "all"; // 0x18e PushS
	var_464_string = "attack_middle"; // 0x18f PushS
	var_465_int = var_464_string + var_346_int; // 0x190 Add
	PlayAnimation(var_463_string, var_465_int); // 0x191 Func
	WaitForAnimEnd(); // 0x193 Func
	func_686(var_349_string); // 0x196 NEW_2
	var_466_bool = 0; var_467_object = Obj(); // 0x198 PushV
	var_467_object = var_0_object; // 0x199 MovT
	func_1246(var_466_bool, var_467_object); // 0x19a NEW_2
	var_468_bool = var_466_bool == 0; // 0x19c Not
	if(var_468_bool == 0) goto Label_418; // 0x19d JumpB
	StopAsync(); // 0x19e Func
	var_340_bool = 0; // 0x1a0 MovB
	return 8; // 0x1a1 Return
	
Label_418:
	var_469_float = 0; var_470_int = 0; // 0x1a2 PushV
	var_469_float = var_341_float; // 0x1a3 Mov
	var_470_int = var_346_int; // 0x1a4 Mov
	func_308(var_349_string, var_469_float, var_470_int); // 0x1a5 NEW_2
	var_348_int = 1; // 0x1a7 MovI
	
Label_424:
	var_471_string = "attack_middle"; // 0x1a8 PushS
	var_472_int = var_471_string + var_346_int; // 0x1a9 Add
	var_473_string = "_"; // 0x1aa PushS
	var_474_int = var_472_int + var_473_string; // 0x1ab Add
	var_349_string = var_474_int + var_348_int; // 0x1ac Add2
	var_475_string = "all"; // 0x1ad PushS
	HasAnimation(var_347_bool, var_475_string, var_349_string); // 0x1ae Func
	var_476_bool = var_347_bool == 0; // 0x1b0 Not
	if(var_476_bool == 0) goto Label_435; // 0x1b1 JumpB
	goto Label_464; // 0x1b2 Jump
	
Label_464:
	var_477_bool = 0; // 0x1d0 PushB
	SetAttackState(var_477_bool); // 0x1d1 Func
	var_478_string = "all"; // 0x1d3 PushS
	var_479_string = "attack_end"; // 0x1d4 PushS
	var_480_int = var_479_string + var_346_int; // 0x1d5 Add
	PlayAnimation(var_478_string, var_480_int); // 0x1d6 Func
	var_481_bool = 0; // 0x1d8 PushV
	func_700(var_481_bool); // 0x1d9 NEW_2
	if(var_481_bool == 0) goto Label_482; // 0x1db JumpB
	var_482_bool = 0; var_483_float = 0; // 0x1dc PushV
	var_483_float = 0.75; // 0x1dd MovF
	func_484(var_482_bool, var_483_float); // 0x1de NEW_2
...
Label_435:
	func_1519(); // 0x1b4 NEW_2
	var_491_string = "all"; // 0x1b6 PushS
	PlayAnimation(var_491_string, var_349_string); // 0x1b7 Func
	WaitForAnimEnd(); // 0x1b9 Func
	func_686(var_349_string); // 0x1bc NEW_2
	var_492_bool = 0; var_493_object = Obj(); // 0x1be PushV
	var_493_object = var_0_object; // 0x1bf MovT
	func_1246(var_492_bool, var_493_object); // 0x1c0 NEW_2
	var_494_bool = var_492_bool == 0; // 0x1c2 Not
	if(var_494_bool == 0) goto Label_456; // 0x1c3 JumpB
	StopAsync(); // 0x1c4 Func
	var_340_bool = 0; // 0x1c6 MovB
	return 8; // 0x1c7 Return
	
Label_456:
	var_495_float = 0; var_496_int = 0; // 0x1c8 PushV
	var_495_float = var_341_float; // 0x1c9 Mov
	var_496_int = var_346_int; // 0x1ca Mov
	func_308(var_349_string, var_495_float, var_496_int); // 0x1cb NEW_2
	var_497_int = 1; // 0x1cd PushI
	var_348_int = var_348_int + var_497_int; // 0x1ce Add2
...
{
	var_484_float = 0; var_485_bool = 0; var_486_float = 0; var_487_bool = 0; // 0x1e4 PushV
	rand(var_486_float); // 0x1e5 Func
	var_488_bool = var_486_float < var_483_float; // 0x1e7 LT
	if(var_488_bool == 0) goto Label_504; // 0x1e8 JumpB
	
Label_489:
	IsAnimationPlaying(var_487_bool); // 0x1e9 Func
	var_489_bool = var_487_bool == 0; // 0x1eb Not
	if(var_489_bool == 0) goto Label_494; // 0x1ec JumpB
...
Label_509:
	var_482_bool = 0; // 0x1fd MovB
	return 4; // 0x1fe Return
	
Label_494:
	var_490_bool = 0; // 0x1ee PushV
	func_582(var_490_bool); // 0x1ef NEW_2
	if(var_490_bool == 0) goto Label_500; // 0x1f1 JumpB
	var_482_bool = 1; // 0x1f2 MovB
...
Label_504:
	...
	func_686(var_487_bool); // 0x1fb NEW_2
}


func_1510(var_12_object)
{
	var_13_bool = 0; var_14_bool = 0; // 0x5e6 PushV
	IsPlayerActor(var_12_object, var_14_bool); // 0x5e7 Func
	var_15_bool = var_14_bool; // 0x5e9 Push
	if(var_15_bool == 0) goto Label_1518; // 0x5ea JumpB
	var_16_string = "attack"; // 0x5eb PushS
	PlayGlobalMusic(var_16_string); // 0x5ec Func
...
Label_1151:
	var_455_string = "armor"; // 0x47f PushS
	GetProperty(var_455_string, var_404_int); // 0x480 ObjFunc
}


func_1519()
{
	var_352_object = Obj(); var_353_object = Obj(); // 0x5ef PushV
	GetScene(var_353_object); // 0x5f0 Func
	var_354_string = "battle"; // 0x5f2 PushS
	var_355_object = Obj(); // 0x5f3 PushV
	func_1459(var_355_object); // 0x5f4 NEW_2
	BroadcastMessage(var_354_string, var_355_object, var_353_object); // 0x5f6 Func
