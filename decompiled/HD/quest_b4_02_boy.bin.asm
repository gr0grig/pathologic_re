...
0x888: Push("Can't find lsh animation : ")
...
0x897: Push("Can't find lsh animation : ")
...
0x8ea: Stack[-3] = Stack[-2]
0x8eb: GOTO 0x8ed

0x8ec: Stack[-3] = Stack[-1]
0x8ed: Return(); Pop(0)
...
0x8f5: Stack[-4] = Stack[-1]
0x8f6: Return(); Pop(0)

0x8f7: Stack[-4] = Stack[-3]
0x8f8: Return(); Pop(0)

0x8f9: PushEmpty(int, int)
0x8fa: @ GetVariable(Stack[-3], Stack[-1])
0x8fb: Pop(0)
0x8fc: Stack[-4] = Stack[-1]
0x8fd: Return(); Pop(2)
...
0x914: Stack[-1] = Stack[-2]
0x915: Call2 0x932

0x916: Pop(1)
0x917: PushEmpty(bool, object, string, float, float, float)
0x918: Stack[-5] = Stack[-8]
0x919: Stack[-4] = "reputation"
0x91a: Stack[-3] = Stack[-7]
0x91b: Stack[-2] = (int) 0
0x91c: Stack[-1] = (int) 1
0x91d: Call2 0x6f8
...
0x960: Stack[-1] = "ui/NPC_Citizen3.png"
0x961: Return(); Pop(0)

0x962: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x963: Return(); Pop(0)
...
0x986: Stack[-2] = "quest_b4_02"
0x987: Stack[-1] = "boy_run"
0x988: Call2 0x93c
...
0x9d7: Stack[-3] = Stack[-7]
0x9d8: Stack[-2] = Stack[-6]
...
0x9df: Stack[-5] = Stack[-11]
0x9e0: Stack[-4] = Stack[-10]
0x9e1: Stack[-3] = Stack[-9]
0x9e2: Stack[-2] = Stack[-7]
0x9e3: Stack[-1] = Stack[-6]
0x9e4: Call2 0x808
...
0x9fb: Stack[-2] = Stack[-4]
0x9fc: Stack[-1] = (float) -0.1
0x9fd: Call2 0x8fe
