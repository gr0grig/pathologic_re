...
Label_231:
	...
	func_2449(var_36_object); // 0xec NEW_2
...
Label_259:
	...
	func_2461(var_69_object); // 0x105 NEW_2
...
Label_409:
	...
	func_2404(var_135_bool); // 0x19b NEW_2
...
task_5_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_2376(var_18_object); // 0x575 NEW_2
...
Label_1426:
	...
	func_2204(var_19_object); // 0x596 NEW_2
...
task_6_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object)
{
	...
	func_2496(var_19_object); // 0x654 NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x9d6 PushV
	var_19_object = var_15_object; // 0x9d7 Mov
	var_20_int = var_16_int; // 0x9d8 Mov
	var_21_float = var_17_float; // 0x9d9 Mov
	func_1988(var_19_object, var_20_int, var_21_float); // 0x9da NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x9de PushV
	var_21_object = var_15_object; // 0x9df Mov
	var_22_int = var_16_int; // 0x9e0 Mov
	var_23_float = var_17_float; // 0x9e1 Mov
	var_24_cvector = var_19_cvector; // 0x9e2 Mov
	var_25_cvector = var_20_cvector; // 0x9e3 Mov
	func_2056(var_23_float, var_24_cvector, var_25_cvector); // 0x9e4 NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x9e7 PushV
	var_19_string = "health"; // 0x9e8 PushS
	var_20_bool = var_16_string == var_19_string; // 0x9e9 Eq
	if(var_20_bool == 0) goto Label_2547; // 0x9ea JumpB
	var_21_string = "health"; // 0x9eb PushS
	GetProperty(var_21_string, var_18_float); // 0x9ec Func
	var_22_int = 0; // 0x9ee PushI
	var_23_bool = var_18_float <= var_22_int; // 0x9ef LE
	if(var_23_bool == 0) goto Label_2547; // 0x9f0 JumpB
	SignalDeath(var_15_object); // 0x9f1 Func
...
{
	var_16_bool = 0; var_17_object = Obj(); // 0x9f5 PushV
	var_17_object = var_15_object; // 0x9f6 Mov
	func_1767(var_16_bool, var_17_object); // 0x9f7 NEW_2
	if(var_16_bool == 0) goto Label_2559; // 0x9f9 JumpB
	var_20_bool = 0; var_21_object = Obj(); var_22_float = 0; // 0x9fa PushV
	var_21_object = var_15_object; // 0x9fb Mov
	var_22_float = -0.1; // 0x9fc MovF
	func_2302(var_20_bool, var_21_object, var_22_float); // 0x9fd NEW_2
	
Label_2559:
	var_58_object = Obj(); // 0x9ff PushV
	var_58_object = var_15_object; // 0xa00 Mov
	func_2509(var_58_object); // 0xa01 NEW_2
...
Label_1845:
	...
	func_2279(var_436_float, var_437_float, var_438_float); // 0x73a NEW_2
	...
	func_2286(var_446_float, var_447_float, var_448_float, var_449_float); // 0x748 NEW_2
	...
	func_2337(var_454_float); // 0x753 NEW_2
...
Label_1825:
	var_462_string = "armor"; // 0x721 PushS
	GetProperty(var_462_string, var_411_int); // 0x722 ObjFunc
}
...
{
	var_455_object = Obj(); var_456_object = Obj(); // 0x921 PushV
	CreateFloatVector(var_456_object); // 0x922 Func
	add(var_454_float); // 0x924 ObjFunc
	var_457_int = 0; // 0x926 PushI
	var_458_bool = var_454_float < var_457_int; // 0x927 LT
	if(var_458_bool == 0) goto Label_2349; // 0x928 JumpB
	var_459_float = 0.7; // 0x929 PushF
	var_460_int = 500; // 0x92a PushI
	RumblePlay(var_459_float, var_460_int); // 0x92b Func
	
Label_2349:
	var_461_int = 15; // 0x92d PushI
	SendWorldWndMessage(var_461_int, var_456_object); // 0x92e Func
...
func_2086(var_27_bool, var_29_float)
{
	...
	func_2269(var_54_cvector, var_55_cvector); // 0x841 NEW_2
...
Label_2127:
	...
	var_67_bool = 1; // 0x851 PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x852 Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x854 PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x855 PushE
	Rotate(var_68_float, var_69_float); // 0x856 Func
	var_70_bool = 0; // 0x858 PushV
	func_2404(var_70_bool); // 0x859 NEW_2
	if(var_70_bool == 0) goto Label_2141; // 0x85b JumpB
	goto Label_2149; // 0x85c Jump
	
Label_2149:
	CameraWaitForPlayFinish(); // 0x865 Func
	ResumeWorld(); // 0x867 Func
	var_27_bool = 1; // 0x869 MovB
	return 18; // 0x86a Return
	
Label_2141:
	var_71_string = "head"; // 0x85d PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x85e Func
	var_72_bool = var_47_bool; // 0x860 Push
	if(var_72_bool == 0) goto Label_2149; // 0x861 JumpB
	var_73_string = "head"; // 0x862 PushS
	LookAsyncCamera(var_73_string); // 0x863 Func
}
...
func_1322(var_0_object)
{
	...
	func_2376(var_122_object); // 0x52c NEW_2
...
func_557()
{
	...
	func_2263(var_21_object); // 0x231 NEW_2
...
func_1329()
{
	...
	func_2222(var_255_string); // 0x533 NEW_2
...
{
	var_28_object = Obj(); var_29_object = Obj(); // 0x932 PushV
	CreateFloatVector(var_29_object); // 0x933 Func
	add(var_27_float); // 0x935 ObjFunc
	var_30_int = 16; // 0x937 PushI
	SendWorldWndMessage(var_30_int, var_29_object); // 0x938 Func
...
{
	var_26_object = Obj(); var_27_object = Obj(); // 0x93c PushV
	FindActor(var_27_object, var_24_string); // 0x93d Func
	var_28_bool = var_27_object == 0; // 0x93f NullEq
	if(var_28_bool == 0) goto Label_2371; // 0x940 JumpB
	var_23_bool = 0; // 0x941 MovB
	return 2; // 0x942 Return
	
Label_2371:
	Trigger(var_27_object, var_25_string); // 0x943 Func
	var_23_bool = 1; // 0x945 MovB
...
func_1342(var_2_object, var_129_bool, var_130_object, var_131_float, var_132_float, var_133_bool, var_134_bool)
{
	...
	func_2376(var_142_object); // 0x541 NEW_2
	...
	func_2204(var_146_object); // 0x54e NEW_2
...
Label_1362:
	...
	func_2263(var_157_object); // 0x558 NEW_2
...
{
	var_19_bool = 0; var_20_bool = 0; // 0x948 PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x949 Func
	var_21_bool = var_20_bool; // 0x94b Push
	if(var_21_bool == 0) goto Label_2384; // 0x94c JumpB
	var_22_string = "attack"; // 0x94d PushS
	PlayGlobalMusic(var_22_string); // 0x94e Func
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_2449(var_96_object); // 0x52 NEW_2
	...
	func_2430(); // 0x58 NEW_2
	var_107_string = ""; // 0x5a PushV
	var_107_string = "Neutral"; // 0x5b MovS
	func_187(var_89_object, var_107_string); // 0x5c NEW_2
	var_124_int = 518563; // 0x5e PushI
	SetMessage(var_124_int); // 0x5f TObjFunc
	ClearReplies(); // 0x61 TObjFunc
	var_125_int = 518962; // 0x63 PushI
	var_126_int = 20075; // 0x64 PushI
	var_127_int = 20074; // 0x65 PushI
	AddReply(var_125_int, var_126_int, var_127_int); // 0x66 TObjFunc
	goto Label_157; // 0x68 Jump
	
Label_157:
	var_128_bool = 0; // 0x9d PushV
	func_2404(var_128_bool); // 0x9e NEW_2
	if(var_128_bool == 0) goto Label_172; // 0xa0 JumpB
	
Label_161:
	lshWaitForAnimEnd(); // 0xa1 Func
	var_129_string = var_3_string; // 0xa3 PushT
	if(var_129_string == 0) goto Label_166; // 0xa4 JumpB
...
Label_166:
	var_130_string = ""; // 0xa6 PushV
	var_130_string = var_2_object; // 0xa7 MovT
	func_2173(var_130_string); // 0xa8 NEW_2
...
Label_176:
	...
	var_143_string = var_3_string; // 0xb2 PushT
	if(var_143_string == 0) goto Label_181; // 0xb3 JumpB
	goto Label_186; // 0xb4 Jump
	
Label_181:
	var_144_string = "all"; // 0xb5 PushS
	var_145_string = "idle"; // 0xb6 PushS
	PlayAnimation(var_144_string, var_145_string); // 0xb7 Func
	goto Label_176; // 0xb9 Jump
	
Label_105:
	var_146_bool = 0; var_147_object = Obj(); // 0x69 PushV
	var_147_object = var_1_object; // 0x6a MovT
	func_2461(var_147_object); // 0x6b NEW_2
	if(var_146_bool == 0) goto Label_135; // 0x6d JumpB
	var_152_object = Obj(); var_153_object = Obj(); // 0x6e PushV
	var_152_object = var_1_object; // 0x6f MovT
	var_153_object = var_0_object; // 0x70 MovT
	func_2443(); // 0x71 NEW_2
	var_156_string = ""; // 0x73 PushV
	var_156_string = "Neutral"; // 0x74 MovS
	func_187(var_89_object, var_156_string); // 0x75 NEW_2
	var_157_int = 518565; // 0x77 PushI
	SetMessage(var_157_int); // 0x78 TObjFunc
	ClearReplies(); // 0x7a TObjFunc
	var_158_int = 518566; // 0x7c PushI
	var_159_int = 20046; // 0x7d PushI
	var_160_int = 19676; // 0x7e PushI
	AddReply(var_158_int, var_159_int, var_160_int); // 0x7f TObjFunc
	var_161_int = 518934; // 0x81 PushI
	var_162_int = -1; // 0x82 PushI
	var_163_int = 20045; // 0x83 PushI
	AddReply(var_161_int, var_162_int, var_163_int); // 0x84 TObjFunc
	goto Label_157; // 0x86 Jump
	
Label_135:
	var_164_string = ""; // 0x87 PushV
	var_164_string = "Neutral"; // 0x88 MovS
	func_187(var_89_object, var_164_string); // 0x89 NEW_2
	var_165_int = 518569; // 0x8b PushI
	SetMessage(var_165_int); // 0x8c TObjFunc
	ClearReplies(); // 0x8e TObjFunc
	var_166_int = 518570; // 0x90 PushI
	var_167_int = -1; // 0x91 PushI
	var_168_int = 19680; // 0x92 PushI
	AddReply(var_166_int, var_167_int, var_168_int); // 0x93 TObjFunc
	var_169_int = 518940; // 0x95 PushI
	var_170_int = -1; // 0x96 PushI
	var_171_int = 20051; // 0x97 PushI
...
func_2385()
{
	var_359_object = Obj(); var_360_object = Obj(); // 0x951 PushV
	GetScene(var_360_object); // 0x952 Func
	var_361_string = "battle"; // 0x954 PushS
	var_362_object = Obj(); // 0x955 PushV
	func_2263(var_362_object); // 0x956 NEW_2
	BroadcastMessage(var_361_string, var_362_object, var_360_object); // 0x958 Func
	return 2; // 0x95a Return
}
...
Label_1691:
	...
	func_2222(var_135_string); // 0x69d NEW_2
...
{
	var_491_float = 0; var_492_bool = 0; var_493_float = 0; var_494_bool = 0; // 0x460 PushV
	rand(var_493_float); // 0x461 Func
	var_495_bool = var_493_float < var_490_float; // 0x463 LT
	if(var_495_bool == 0) goto Label_1140; // 0x464 JumpB
	
Label_1125:
	IsAnimationPlaying(var_494_bool); // 0x465 Func
	var_496_bool = var_494_bool == 0; // 0x467 Not
	if(var_496_bool == 0) goto Label_1130; // 0x468 JumpB
...
Label_1145:
	var_489_bool = 0; // 0x479 MovB
	return 4; // 0x47a Return
	
Label_1130:
	var_497_bool = 0; // 0x46a PushV
	func_1218(var_497_bool); // 0x46b NEW_2
	if(var_497_bool == 0) goto Label_1136; // 0x46d JumpB
	var_489_bool = 1; // 0x46e MovB
...
Label_1140:
	...
	func_1322(var_494_bool); // 0x477 NEW_2
}


func_2400(var_77_string)
{
	var_77_string = "ui/NPC_Citizen3.png"; // 0x960 MovS
...
{
	var_78_string = "ui/NPC_Citizen3_b.png"; // 0x962 MovS
...
{
	var_41_string = ""; var_42_string = ""; // 0x966 PushV
	var_42_string = "idle"; // 0x967 MovS
	var_43_int = var_40_int; // 0x968 Push
	if(var_43_int == 0) goto Label_2411; // 0x969 JumpB
	var_42_string = var_42_string + var_40_int; // 0x96a Add2
	
Label_2411:
	var_39_string = var_42_string; // 0x96b Mov
...
func_2155()
{
	var_174_bool = 0; var_175_bool = 0; // 0x86b PushV
	var_176_bool = 1; // 0x86c PushB
	CameraSwitchToNormal(var_176_bool); // 0x86d Func
	var_177_bool = 0; // 0x86f PushV
	func_2404(var_177_bool); // 0x870 NEW_2
	if(var_177_bool == 0) goto Label_2164; // 0x872 JumpB
	goto Label_2172; // 0x873 Jump
	
Label_2172:
	return 2; // 0x87c Return
	
Label_2164:
	var_178_string = "head"; // 0x874 PushS
	HasAnimationTrack(var_175_bool, var_178_string); // 0x875 Func
	var_179_bool = var_175_bool; // 0x877 Push
	if(var_179_bool == 0) goto Label_2172; // 0x878 JumpB
	var_180_string = "head"; // 0x879 PushS
	UnlookAsync(var_180_string); // 0x87a Func
}


func_2413(var_33_int)
{
	var_34_int = 0; var_35_bool = 0; var_36_int = 0; var_37_bool = 0; // 0x96d PushV
	var_36_int = 0; // 0x96e MovI
	
Label_2415:
	var_38_string = "all"; // 0x96f PushS
	var_39_string = ""; var_40_int = 0; // 0x970 PushV
	var_40_int = var_36_int; // 0x971 Mov
	func_2406(var_39_string, var_40_int); // 0x972 NEW_2
	HasAnimation(var_37_bool, var_38_string, var_39_string); // 0x974 Func
	var_44_bool = var_37_bool == 0; // 0x976 Not
	if(var_44_bool == 0) goto Label_2425; // 0x977 JumpB
	goto Label_2428; // 0x978 Jump
	
Label_2428:
	var_33_int = var_36_int; // 0x97c Mov
	return 4; // 0x97d Return
	
Label_2425:
	var_45_int = 1; // 0x979 PushI
	var_36_int = var_36_int + var_45_int; // 0x97a Add2
	goto Label_2415; // 0x97b Jump
}
...
{
	var_131_bool = 0; var_132_float = 0; var_133_float = 0; var_134_bool = 0; var_135_float = 0; var_136_float = 0; // 0x87d PushV
	lshHasAnimation(var_134_bool, var_130_string); // 0x87e Func
	var_137_bool = var_134_bool; // 0x880 Push
	if(var_137_bool == 0) goto Label_2184; // 0x881 JumpB
	lshGetAnimTimes(var_130_string, var_135_float, var_136_float); // 0x882 Func
	var_138_bool = 0; // 0x884 PushB
	lshPlayAnimation(var_135_float, var_136_float, var_138_bool); // 0x885 Func
	goto Label_2188; // 0x887 Jump
	
Label_2188:
	return 6; // 0x88c Return
	
Label_2184:
	var_139_string = "Can't find lsh animation : "; // 0x888 PushS
	var_140_int = var_139_string + var_130_string; // 0x889 Add
	Trace(var_140_int); // 0x88a Func
}
...
func_2430()
{
	var_105_string = "oob4boy1"; // 0x97f PushS
	var_106_int = 1; // 0x980 PushI
	SetVariable(var_105_string, var_106_int); // 0x981 Func
...
func_2436()
{
	var_23_bool = 0; var_24_string = ""; var_25_string = ""; // 0x985 PushV
	var_24_string = "quest_b4_02"; // 0x986 MovS
	var_25_string = "boy_run"; // 0x987 MovS
	func_2364(var_23_bool, var_24_string, var_25_string); // 0x988 NEW_2
...
func_2443()
{
	var_154_string = "oob4boy2"; // 0x98c PushS
	var_155_int = 1; // 0x98d PushI
	SetVariable(var_154_string, var_155_int); // 0x98e Func
...
{
	var_115_bool = 0; var_116_float = 0; var_117_float = 0; var_118_bool = 0; var_119_float = 0; var_120_float = 0; // 0x88d PushV
	lshHasAnimation(var_118_bool, var_111_string); // 0x88e Func
	var_121_bool = var_118_bool; // 0x890 Push
	if(var_121_bool == 0) goto Label_2199; // 0x891 JumpB
	lshGetAnimTimes(var_111_string, var_119_float, var_120_float); // 0x892 Func
	lshPlayAnimation(var_119_float, var_120_float, var_112_bool); // 0x894 Func
	goto Label_2203; // 0x896 Jump
	
Label_2203:
	return 6; // 0x89b Return
	
Label_2199:
	var_122_string = "Can't find lsh animation : "; // 0x897 PushS
	var_123_int = var_122_string + var_111_string; // 0x898 Add
	Trace(var_123_int); // 0x899 Func
}
...
func_654(var_16_object)
{
	...
	func_2263(var_25_object); // 0x292 NEW_2
...
Label_662:
	...
	var_521_int = 1; // 0x29c PushI
	Sleep(var_521_int); // 0x29d Func
...
{
	var_97_int = 0; var_98_string = ""; // 0x992 PushV
	var_98_string = "oob4boy1"; // 0x993 MovS
	func_2297(var_97_int, var_98_string); // 0x994 NEW_2
	var_101_int = 0; // 0x996 PushI
	var_102_bool = var_97_int == var_101_int; // 0x997 Eq
	if(var_102_bool == 0) goto Label_2459; // 0x998 JumpB
	var_95_bool = 1; // 0x999 MovB
	return 0; // 0x99a Return
	
Label_2459:
	var_95_bool = 0; // 0x99b MovB
...
{
	var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_float = 0; var_23_cvector = CVector(0,0,0); // 0x89c PushV
	GetEyesHeight(var_22_float); // 0x89d ObjFunc
	var_23_cvector = CVector(0.0, 0.0, 0.0); // 0x89f MovV
	var_24_float = GetByIndex(var_23_cvector, 1); // 0x8a0 PushE
	var_24_float = var_22_float; // 0x8a1 Mov
	SetByIndex(var_23_cvector, 1) = var_24_float; // 0x8a2 PopE
	var_25_string = "head"; // 0x8a3 PushS
	LookAsync(var_19_object, var_25_string, var_23_cvector); // 0x8a4 Func
...
{
	var_148_int = 0; var_149_string = ""; // 0x99e PushV
	var_149_string = "oob4boy2"; // 0x99f MovS
	func_2297(var_148_int, var_149_string); // 0x9a0 NEW_2
	var_150_int = 0; // 0x9a2 PushI
	var_151_bool = var_148_int == var_150_int; // 0x9a3 Eq
	if(var_151_bool == 0) goto Label_2471; // 0x9a4 JumpB
	var_146_bool = 1; // 0x9a5 MovB
	return 0; // 0x9a6 Return
	
Label_2471:
	var_146_bool = 0; // 0x9a7 MovB
...
func_2215()
{
	var_18_bool = 0; // 0x8a7 PushV
	func_2404(var_18_bool); // 0x8a8 NEW_2
	if(var_18_bool == 0) goto Label_2221; // 0x8aa JumpB
	lshStopSpeech(); // 0x8ab Func
...
Label_699:
	...
	func_2263(var_83_object); // 0x2c5 NEW_2
...
Label_836:
	...
	var_505_string = "all"; // 0x346 PushS
	var_506_string = "fjump"; // 0x347 PushS
	PlayAnimation(var_505_string, var_506_string); // 0x348 Func
	WaitForAnimEnd(); // 0x34a Func
	func_1322(var_52_float); // 0x34d NEW_2
	var_507_cvector = CVector(0.0, 0.0, 0.0); // 0x34f PushVec
	SetSpeed(var_507_cvector); // 0x350 Func
	Stop(); // 0x352 Func
	StopAsync(); // 0x354 Func
	var_508_bool = 0; // 0x356 PushV
	func_1279(var_52_float, var_508_bool); // 0x357 NEW_2
	var_509_bool = var_508_bool == 0; // 0x359 Not
	if(var_509_bool == 0) goto Label_882; // 0x35a JumpB
	var_510_bool = 0; var_511_object = Obj(); // 0x35b PushV
	var_511_object = var_0_object; // 0x35c MovT
	func_1920(var_510_bool, var_511_object); // 0x35d NEW_2
	var_512_bool = var_510_bool == 0; // 0x35f Not
	if(var_512_bool == 0) goto Label_866; // 0x360 JumpB
...
Label_866:
	...
	var_513_float = var_30_float * var_30_float; // 0x368 Mult
	var_514_bool = var_49_float < var_513_float; // 0x369 LT
	if(var_514_bool == 0) goto Label_882; // 0x36a JumpB
	var_515_bool = 0; var_516_float = 0; // 0x36b PushV
	var_516_float = var_30_float; // 0x36c Mov
	func_983(var_52_float, var_515_bool, var_516_float); // 0x36d NEW_2
	var_517_bool = var_515_bool == 0; // 0x36f Not
	if(var_517_bool == 0) goto Label_882; // 0x370 JumpB
	goto Label_892; // 0x371 Jump
	
Label_883:
	var_518_bool = 0; var_519_float = 0; // 0x373 PushV
	var_519_float = var_30_float; // 0x374 Mov
	func_983(var_52_float, var_518_bool, var_519_float); // 0x375 NEW_2
	var_520_bool = var_518_bool == 0; // 0x377 Not
	if(var_520_bool == 0) goto Label_890; // 0x378 JumpB
...
{
	var_80_int = 0; var_81_int = 0; // 0x9a9 PushV
	var_82_string = "branch"; // 0x9aa PushS
	GetVariable(var_82_string, var_81_int); // 0x9ab Func
	var_83_int = 0; // 0x9ad PushI
	var_84_bool = var_81_int == var_83_int; // 0x9ae Eq
	if(var_84_bool == 0) goto Label_2483; // 0x9af JumpB
	var_79_int = 1; // 0x9b0 MovI
	return 2; // 0x9b1 Return
	
Label_2483:
	var_85_int = 1; // 0x9b3 PushI
	var_86_bool = var_81_int == var_85_int; // 0x9b4 Eq
	if(var_86_bool == 0) goto Label_2488; // 0x9b5 JumpB
	var_79_int = 2; // 0x9b6 MovI
	return 2; // 0x9b7 Return
	
Label_2488:
	var_79_int = 3; // 0x9b8 MovI
...
{
	var_84_bool = 0; var_85_int = 0; var_86_bool = 0; var_87_int = 0; var_88_bool = 0; var_89_float = 0; var_90_cvector = CVector(0,0,0); var_91_cvector = CVector(0,0,0); var_92_bool = 0; var_93_int = 0; var_94_bool = 0; var_95_int = 0; var_96_bool = 0; var_97_float = 0; var_98_cvector = CVector(0,0,0); var_99_cvector = CVector(0,0,0); // 0x8ae PushV
	IsExisting3DSound(var_92_bool, var_83_string); // 0x8af Func
	var_100_bool = var_92_bool == 0; // 0x8b1 Not
	if(var_100_bool == 0) goto Label_2247; // 0x8b2 JumpB
	var_93_int = 0; // 0x8b3 MovI
	
Label_2228:
	var_101_int = 1; // 0x8b4 PushI
	var_102_int = var_93_int + var_101_int; // 0x8b5 Add
	var_103_int = var_83_string + var_102_int; // 0x8b6 Add
	IsExisting3DSound(var_94_bool, var_103_int); // 0x8b7 Func
	var_104_bool = var_94_bool == 0; // 0x8b9 Not
	if(var_104_bool == 0) goto Label_2236; // 0x8ba JumpB
	goto Label_2239; // 0x8bb Jump
	
Label_2239:
	var_105_bool = var_93_int == 0; // 0x8bf Not
	if(var_105_bool == 0) goto Label_2242; // 0x8c0 JumpB
	return 16; // 0x8c1 Return
	
Label_2242:
	irand(var_95_int, var_93_int); // 0x8c2 Func
	var_106_int = 1; // 0x8c4 PushI
	var_107_int = var_95_int + var_106_int; // 0x8c5 Add
	var_83_string = var_83_string + var_107_int; // 0x8c6 Add2
	
Label_2247:
	Is3DSoundLoaded(var_96_bool, var_83_string); // 0x8c7 Func
	var_108_bool = var_96_bool; // 0x8c9 Push
	if(var_108_bool == 0) goto Label_2262; // 0x8ca JumpB
	GetEyesHeight(var_97_float); // 0x8cb Func
	GetDirection(var_98_cvector); // 0x8cd Func
	var_109_int = 50; // 0x8cf PushI
	var_99_cvector = var_98_cvector * var_109_int; // 0x8d0 Mult2
	var_110_float = GetByIndex(var_99_cvector, 1); // 0x8d1 PushE
	var_110_float = var_110_float + var_97_float; // 0x8d2 Add2
	SetByIndex(var_99_cvector, 1) = var_110_float; // 0x8d3 PopE
	PlayGlobalSound(var_83_string, var_99_cvector); // 0x8d4 Func
	
Label_2262:
	return 16; // 0x8d6 Return
	
Label_2236:
	var_111_int = 1; // 0x8bc PushI
	var_93_int = var_93_int + var_111_int; // 0x8bd Add2
	goto Label_2228; // 0x8be Jump
}
...
func_944(var_0_object, var_384_float, var_385_int)
{
	...
	var_463_int = 0; // 0x3cb PushV
	func_1327(var_463_int); // 0x3cc NEW_2
	ReportHit(var_0_object, var_463_int, var_391_float, var_390_float); // 0x3ce Func
	var_464_object = Obj(); var_465_float = 0; // 0x3d0 PushV
	var_464_object = var_389_object; // 0x3d1 Mov
	var_465_float = var_391_float; // 0x3d2 Mov
...
func_1714(var_82_string)
{
	...
	func_2222(var_83_string); // 0x6bf NEW_2
...
{
	var_21_int = 0; var_22_int = 0; // 0x9ba PushV
	var_23_string = "branch"; // 0x9bb PushS
	GetVariable(var_23_string, var_22_int); // 0x9bc Func
	var_20_int = var_22_int; // 0x9be Mov
	return 2; // 0x9bf Return
}


func_187(var_2_object, var_107_string)
{
	var_108_bool = 0; // 0xbc PushV
	func_2404(var_108_bool); // 0xbd NEW_2
	var_109_bool = var_108_bool == 0; // 0xbf Not
	if(var_109_bool == 0) goto Label_194; // 0xc0 JumpB
	return 0; // 0xc1 Return
	
Label_194:
	var_110_bool = var_107_string == var_2_object; // 0xc2 Eq
	if(var_110_bool == 0) goto Label_197; // 0xc3 JumpB
	return 0; // 0xc4 Return
	
Label_197:
	var_111_string = ""; var_112_bool = 0; // 0xc5 PushV
	var_111_string = var_107_string; // 0xc6 Mov
	var_113_string = ""; // 0xc7 PushS
	var_114_bool = var_107_string == var_113_string; // 0xc8 Eq
	if(var_114_bool == 0) goto Label_204; // 0xc9 JumpB
	var_112_bool = 0; // 0xca MovB
	goto Label_205; // 0xcb Jump
	
Label_205:
	func_2189(var_111_string, var_112_bool); // 0xcd NEW_2
	var_2_object = var_107_string; // 0xcf TMov
	return 0; // 0xd0 Return
	
Label_204:
	var_112_bool = 1; // 0xcc MovB
}


func_2496(var_19_object)
{
	var_20_int = 0; // 0x9c1 PushV
	func_2490(var_20_int); // 0x9c2 NEW_2
	var_24_int = 1; // 0x9c4 PushI
	var_25_bool = var_20_int == var_24_int; // 0x9c5 Eq
	if(var_25_bool == 0) goto Label_2506; // 0x9c6 JumpB
	WorkWithCorpse(var_19_object); // 0x9c7 Func
	goto Label_2508; // 0x9c9 Jump
	
Label_2508:
	return 0; // 0x9cc Return
	
Label_2506:
	Barter(var_19_object); // 0x9ca Func
}
...
Label_2004:
	...
	func_2269(var_47_cvector, var_48_cvector); // 0x7db NEW_2
...
{
	var_59_object = Obj(); // 0x9ce PushV
	var_59_object = var_58_object; // 0x9cf Mov
	TaskCall(6); // 0x9d0 TaskCall
	func_1598(var_59_object); // 0x9d1 NEW_2
...
{
	var_26_object = Obj(); var_27_object = Obj(); // 0x8d7 PushV
	self(var_27_object); // 0x8d8 Func
	var_25_object = var_27_object; // 0x8da Mov
...
Label_480:
	...
	func_2413(var_33_int); // 0x1e1 NEW_2
...
Label_495:
	...
	func_2406(var_55_string, var_56_int); // 0x1fd NEW_2
...
Label_1019:
	...
	var_466_string = "all"; // 0x400 PushS
	var_467_string = "attack_middle"; // 0x401 PushS
	var_468_int = var_467_string + var_353_int; // 0x402 Add
	HasAnimation(var_354_bool, var_466_string, var_468_int); // 0x403 Func
	var_469_bool = var_354_bool; // 0x405 Push
	if(var_469_bool == 0) goto Label_1100; // 0x406 JumpB
	func_2385(); // 0x408 NEW_2
	var_470_string = "all"; // 0x40a PushS
	var_471_string = "attack_middle"; // 0x40b PushS
	var_472_int = var_471_string + var_353_int; // 0x40c Add
	PlayAnimation(var_470_string, var_472_int); // 0x40d Func
	WaitForAnimEnd(); // 0x40f Func
	func_1322(var_356_string); // 0x412 NEW_2
	var_473_bool = 0; var_474_object = Obj(); // 0x414 PushV
	var_474_object = var_0_object; // 0x415 MovT
	func_1920(var_473_bool, var_474_object); // 0x416 NEW_2
	var_475_bool = var_473_bool == 0; // 0x418 Not
	if(var_475_bool == 0) goto Label_1054; // 0x419 JumpB
	StopAsync(); // 0x41a Func
	var_347_bool = 0; // 0x41c MovB
	return 8; // 0x41d Return
	
Label_1054:
	var_476_float = 0; var_477_int = 0; // 0x41e PushV
	var_476_float = var_348_float; // 0x41f Mov
	var_477_int = var_353_int; // 0x420 Mov
	func_944(var_356_string, var_476_float, var_477_int); // 0x421 NEW_2
	var_355_int = 1; // 0x423 MovI
	
Label_1060:
	var_478_string = "attack_middle"; // 0x424 PushS
	var_479_int = var_478_string + var_353_int; // 0x425 Add
	var_480_string = "_"; // 0x426 PushS
	var_481_int = var_479_int + var_480_string; // 0x427 Add
	var_356_string = var_481_int + var_355_int; // 0x428 Add2
	var_482_string = "all"; // 0x429 PushS
	HasAnimation(var_354_bool, var_482_string, var_356_string); // 0x42a Func
	var_483_bool = var_354_bool == 0; // 0x42c Not
	if(var_483_bool == 0) goto Label_1071; // 0x42d JumpB
	goto Label_1100; // 0x42e Jump
	
Label_1100:
	var_484_bool = 0; // 0x44c PushB
	SetAttackState(var_484_bool); // 0x44d Func
	var_485_string = "all"; // 0x44f PushS
	var_486_string = "attack_end"; // 0x450 PushS
	var_487_int = var_486_string + var_353_int; // 0x451 Add
	PlayAnimation(var_485_string, var_487_int); // 0x452 Func
	var_488_bool = 0; // 0x454 PushV
	func_1336(var_488_bool); // 0x455 NEW_2
	if(var_488_bool == 0) goto Label_1118; // 0x457 JumpB
	var_489_bool = 0; var_490_float = 0; // 0x458 PushV
	var_490_float = 0.75; // 0x459 MovF
	func_1120(var_489_bool, var_490_float); // 0x45a NEW_2
...
Label_1071:
	func_2385(); // 0x430 NEW_2
	var_498_string = "all"; // 0x432 PushS
	PlayAnimation(var_498_string, var_356_string); // 0x433 Func
	WaitForAnimEnd(); // 0x435 Func
	func_1322(var_356_string); // 0x438 NEW_2
	var_499_bool = 0; var_500_object = Obj(); // 0x43a PushV
	var_500_object = var_0_object; // 0x43b MovT
	func_1920(var_499_bool, var_500_object); // 0x43c NEW_2
	var_501_bool = var_499_bool == 0; // 0x43e Not
	if(var_501_bool == 0) goto Label_1092; // 0x43f JumpB
	StopAsync(); // 0x440 Func
	var_347_bool = 0; // 0x442 MovB
	return 8; // 0x443 Return
	
Label_1092:
	var_502_float = 0; var_503_int = 0; // 0x444 PushV
	var_502_float = var_348_float; // 0x445 Mov
	var_503_int = var_353_int; // 0x446 Mov
	func_944(var_356_string, var_502_float, var_503_int); // 0x447 NEW_2
	var_504_int = 1; // 0x449 PushI
	var_355_int = var_355_int + var_504_int; // 0x44a Add2
...
{
	var_55_float = 0; var_56_float = 0; // 0x8dd PushV
	var_57_int = var_48_cvector | var_48_cvector; // 0x8de Or
	var_56_float = sqrt(var_57_int); // 0x8df Sqrt2
	var_58_float = 0.0; // 0x8e0 PushF
	var_59_bool = var_56_float < var_58_float; // 0x8e1 LT
	if(var_59_bool == 0) goto Label_2277; // 0x8e2 JumpB
	var_47_cvector = CVector(0.0, 0.0, 0.0); // 0x8e3 MovV
	return 2; // 0x8e4 Return
	
Label_2277:
	var_47_cvector = var_48_cvector / var_48_cvector; // 0x8e5 Div2
...
{
	var_441_bool = var_437_float < var_438_float; // 0x8e8 LT
	if(var_441_bool == 0) goto Label_2284; // 0x8e9 JumpB
	var_436_float = var_437_float; // 0x8ea Mov
	goto Label_2285; // 0x8eb Jump
	
Label_2285:
	return 0; // 0x8ed Return
	
Label_2284:
	var_436_float = var_438_float; // 0x8ec Mov
}
...
{
	var_53_bool = var_50_float < var_51_float; // 0x8ef LT
	if(var_53_bool == 0) goto Label_2291; // 0x8f0 JumpB
	var_49_float = var_51_float; // 0x8f1 Mov
	return 0; // 0x8f2 Return
	
Label_2291:
	var_54_bool = var_50_float > var_52_float; // 0x8f3 GT
	if(var_54_bool == 0) goto Label_2295; // 0x8f4 JumpB
	var_49_float = var_52_float; // 0x8f5 Mov
	return 0; // 0x8f6 Return
	
Label_2295:
	var_49_float = var_50_float; // 0x8f7 Mov
...
Label_1794:
	...
	func_2286(var_49_float, var_50_float, var_51_float, var_52_float); // 0x708 NEW_2
...
{
	var_99_int = 0; var_100_int = 0; // 0x8f9 PushV
	GetVariable(var_98_string, var_100_int); // 0x8fa Func
	var_97_int = var_100_int; // 0x8fc Mov
...
{
	var_23_bool = var_21_object == 0; // 0x8ff Not
	if(var_23_bool == 0) goto Label_2307; // 0x900 JumpB
	var_20_bool = 0; // 0x901 MovB
	return 0; // 0x902 Return
	
Label_2307:
	var_24_int = 0; // 0x903 PushI
	var_25_bool = var_22_float > var_24_int; // 0x904 GT
	if(var_25_bool == 0) goto Label_2314; // 0x905 JumpB
	var_26_int = 8; // 0x906 PushI
	SendWorldWndMessage(var_26_int); // 0x907 Func
	goto Label_2323; // 0x909 Jump
	
Label_2323:
	var_27_float = 0; // 0x913 PushV
	var_27_float = var_22_float; // 0x914 Mov
	func_2354(var_27_float); // 0x915 NEW_2
	var_31_bool = 0; var_32_object = Obj(); var_33_string = ""; var_34_float = 0; var_35_float = 0; var_36_float = 0; // 0x917 PushV
	var_32_object = var_21_object; // 0x918 Mov
	var_33_string = "reputation"; // 0x919 MovS
	var_34_float = var_22_float; // 0x91a Mov
	var_35_float = 0; // 0x91b MovI
	var_36_float = 1; // 0x91c MovI
	func_1784(var_31_bool, var_32_object, var_33_string, var_34_float, var_35_float, var_36_float); // 0x91d NEW_2
	var_20_bool = 1; // 0x91f MovB
	return 0; // 0x920 Return
	
Label_2314:
	var_55_int = 0; // 0x90a PushI
	var_56_bool = var_22_float < var_55_int; // 0x90b LT
	if(var_56_bool == 0) goto Label_2321; // 0x90c JumpB
	var_57_int = 9; // 0x90d PushI
	SendWorldWndMessage(var_57_int); // 0x90e Func
	goto Label_2323; // 0x910 Jump
