...
0x860: Stack[-3] = Stack[-7]
0x861: Stack[-2] = Stack[-6]
...
0x868: Stack[-5] = Stack[-11]
0x869: Stack[-4] = Stack[-10]
0x86a: Stack[-3] = Stack[-9]
0x86b: Stack[-2] = Stack[-7]
...
0x887: Stack[-4] = Stack[-2]
0x888: Pop(2)
0x889: Return(); Pop(0)

0x88a: PushEmpty()
0x88b: PushEmpty(object)
0x88c: Stack[-1] = Stack[-2]
0x88d: Call2 0x931
...
0x918: Stack[-3] = Stack[-9]
0x919: Stack[-2] = Stack[-8]
0x91a: Stack[-1] = Stack[-7]
0x91b: Call2 0x7b6

0x91c: Stack[-6] = Stack[-4]
0x91d: Pop(4)
0x91e: Push((int) 0)
...
0x924: Stack[-4] = Stack[-10]
0x925: Stack[-3] = Stack[-9]
0x926: Stack[-2] = Stack[-8]
...
0x936: Pop(0)
0x937: @@ RemoveStationaryActor(Stack[-1])
0x938: Pop(1)
0x939: PushEmpty(object)
0x93a: Stack[-1] = Stack[-4]
