...
task_1_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2371(var_15_object); // 0x9a NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2371(var_15_object); // 0xe5 NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2371(var_15_object); // 0x38e NEW_2
...
task_3_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2084(var_13_object); // 0x3d3 NEW_2
...
task_3_event_41(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2179(var_15_bool, var_16_object); // 0x4a7 NEW_2
	...
	func_2186(var_51_object); // 0x4af NEW_2
...
task_6_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2198(var_14_object); // 0x554 NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x85f PushV
	var_14_object = var_10_object; // 0x860 Mov
	var_15_int = var_11_int; // 0x861 Mov
	var_16_float = var_12_float; // 0x862 Mov
	func_1790(var_14_object, var_15_int, var_16_float); // 0x863 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x867 PushV
	var_16_object = var_10_object; // 0x868 Mov
	var_17_int = var_11_int; // 0x869 Mov
	var_18_float = var_12_float; // 0x86a Mov
	var_19_cvector = var_14_cvector; // 0x86b Mov
	var_20_cvector = var_15_cvector; // 0x86c Mov
	func_1858(var_18_float, var_19_cvector, var_20_cvector); // 0x86d NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x870 PushV
	var_14_string = "health"; // 0x871 PushS
	var_15_bool = var_11_string == var_14_string; // 0x872 Eq
	if(var_15_bool == 0) goto Label_2172; // 0x873 JumpB
	var_16_string = "health"; // 0x874 PushS
	GetProperty(var_16_string, var_13_float); // 0x875 Func
	var_17_int = 0; // 0x877 PushI
	var_18_bool = var_13_float <= var_17_int; // 0x878 LE
	if(var_18_bool == 0) goto Label_2172; // 0x879 JumpB
	SignalDeath(var_10_object); // 0x87a Func
...
{
	var_11_object = Obj(); // 0x87e PushV
	var_11_object = var_10_object; // 0x87f Mov
	func_2134(var_11_object); // 0x880 NEW_2
...
Label_29:
	var_685_bool = 0; var_686_object = Obj(); // 0x1d PushV
	var_686_object = var_60_object; // 0x1e Mov
	TaskCall(2); // 0x1f TaskCall
	func_163(var_685_bool, var_686_object); // 0x20 NEW_2
	TaskReturn(); // 0x21 TaskReturn
	var_59_bool = var_687_object; // 0x22 Mov
...
func_2057(var_591_float)
{
	...
	var_594_int = 0; // 0x80e PushI
	var_595_bool = var_591_float < var_594_int; // 0x80f LT
	if(var_595_bool == 0) goto Label_2069; // 0x810 JumpB
	var_596_float = 0.7; // 0x811 PushF
	var_597_int = 500; // 0x812 PushI
	RumblePlay(var_596_float, var_597_int); // 0x813 Func
	
Label_2069:
	var_598_int = 15; // 0x815 PushI
	SendWorldWndMessage(var_598_int, var_593_object); // 0x816 Func
...
Label_1577:
	var_599_string = "armor"; // 0x629 PushS
	GetProperty(var_599_string, var_548_int); // 0x62a ObjFunc
}


func_2074(var_86_float)
{
	var_87_object = Obj(); var_88_object = Obj(); // 0x81a PushV
	CreateFloatVector(var_88_object); // 0x81b Func
	add(var_86_float); // 0x81d ObjFunc
	var_89_int = 16; // 0x81f PushI
	SendWorldWndMessage(var_89_int, var_88_object); // 0x820 Func
...
Label_579:
	...
	var_624_string = "all"; // 0x248 PushS
	var_625_string = "attack_middle"; // 0x249 PushS
	var_626_int = var_625_string + var_494_int; // 0x24a Add
	HasAnimation(var_495_bool, var_624_string, var_626_int); // 0x24b Func
	var_627_bool = var_495_bool; // 0x24d Push
	if(var_627_bool == 0) goto Label_660; // 0x24e JumpB
	func_2093(); // 0x250 NEW_2
	var_628_string = "all"; // 0x252 PushS
	var_629_string = "attack_middle"; // 0x253 PushS
	var_630_int = var_629_string + var_494_int; // 0x254 Add
	PlayAnimation(var_628_string, var_630_int); // 0x255 Func
	WaitForAnimEnd(); // 0x257 Func
	func_884(var_497_string); // 0x25a NEW_2
	var_631_bool = 0; var_632_object = Obj(); // 0x25c PushV
	var_632_object = var_0_bool; // 0x25d MovT
	func_1703(var_631_bool, var_632_object); // 0x25e NEW_2
	var_633_bool = var_631_bool == 0; // 0x260 Not
	if(var_633_bool == 0) goto Label_614; // 0x261 JumpB
	StopAsync(); // 0x262 Func
	var_488_bool = 0; // 0x264 MovB
	return 8; // 0x265 Return
	
Label_614:
	var_634_float = 0; var_635_int = 0; // 0x266 PushV
	var_634_float = var_489_float; // 0x267 Mov
	var_635_int = var_494_int; // 0x268 Mov
	func_504(var_497_string, var_634_float, var_635_int); // 0x269 NEW_2
	var_496_int = 1; // 0x26b MovI
	
Label_620:
	var_636_string = "attack_middle"; // 0x26c PushS
	var_637_int = var_636_string + var_494_int; // 0x26d Add
	var_638_string = "_"; // 0x26e PushS
	var_639_int = var_637_int + var_638_string; // 0x26f Add
	var_497_string = var_639_int + var_496_int; // 0x270 Add2
	var_640_string = "all"; // 0x271 PushS
	HasAnimation(var_495_bool, var_640_string, var_497_string); // 0x272 Func
	var_641_bool = var_495_bool == 0; // 0x274 Not
	if(var_641_bool == 0) goto Label_631; // 0x275 JumpB
	goto Label_660; // 0x276 Jump
	
Label_660:
	var_642_bool = 0; // 0x294 PushB
	SetAttackState(var_642_bool); // 0x295 Func
	var_643_string = "all"; // 0x297 PushS
	var_644_string = "attack_end"; // 0x298 PushS
	var_645_int = var_644_string + var_494_int; // 0x299 Add
	PlayAnimation(var_643_string, var_645_int); // 0x29a Func
	var_646_bool = 0; // 0x29c PushV
	func_894(var_646_bool); // 0x29d NEW_2
	if(var_646_bool == 0) goto Label_678; // 0x29f JumpB
	var_647_bool = 0; var_648_float = 0; // 0x2a0 PushV
	var_648_float = 0.45; // 0x2a1 MovF
	func_682(var_647_bool, var_648_float); // 0x2a2 NEW_2
...
Label_631:
	func_2093(); // 0x278 NEW_2
	var_656_string = "all"; // 0x27a PushS
	PlayAnimation(var_656_string, var_497_string); // 0x27b Func
	WaitForAnimEnd(); // 0x27d Func
	func_884(var_497_string); // 0x280 NEW_2
	var_657_bool = 0; var_658_object = Obj(); // 0x282 PushV
	var_658_object = var_0_bool; // 0x283 MovT
	func_1703(var_657_bool, var_658_object); // 0x284 NEW_2
	var_659_bool = var_657_bool == 0; // 0x286 Not
	if(var_659_bool == 0) goto Label_652; // 0x287 JumpB
	StopAsync(); // 0x288 Func
	var_488_bool = 0; // 0x28a MovB
	return 8; // 0x28b Return
	
Label_652:
	var_660_float = 0; var_661_int = 0; // 0x28c PushV
	var_660_float = var_489_float; // 0x28d Mov
	var_661_int = var_494_int; // 0x28e Mov
	func_504(var_497_string, var_660_float, var_661_int); // 0x28f NEW_2
	var_662_int = 1; // 0x291 PushI
	var_496_int = var_496_int + var_662_int; // 0x292 Add2
...
{
	var_98_bool = 0; var_99_bool = 0; // 0x824 PushV
	IsPlayerActor(var_97_object, var_99_bool); // 0x825 Func
	var_100_bool = var_99_bool; // 0x827 Push
	if(var_100_bool == 0) goto Label_2092; // 0x828 JumpB
	var_101_string = "attack"; // 0x829 PushS
	PlayGlobalMusic(var_101_string); // 0x82a Func
...
func_37(var_0_bool, var_80_bool, var_81_object, var_198_object)
{
	...
	func_2084(var_97_object); // 0x28 NEW_2
...
Label_76:
	...
	func_2318(var_140_cvector, var_141_cvector, var_142_cvector, var_143_float); // 0x70 NEW_2
...
func_2093()
{
	var_119_object = Obj(); var_120_object = Obj(); // 0x82d PushV
	GetScene(var_120_object); // 0x82e Func
	var_121_string = "battle"; // 0x830 PushS
	var_122_object = Obj(); // 0x831 PushV
	func_1951(var_122_object); // 0x832 NEW_2
	BroadcastMessage(var_121_string, var_122_object, var_120_object); // 0x834 Func
...
{
	var_618_bool = 0; var_619_bool = 0; // 0x838 PushV
	var_620_string = "god_mode"; // 0x839 PushS
	GetVariable(var_620_string, var_619_bool); // 0x83a Func
	var_617_bool = var_619_bool; // 0x83c Mov
...
{
	var_37_string = ""; var_38_string = ""; // 0x83e PushV
	var_38_string = "idle"; // 0x83f MovS
	var_39_int = var_36_int; // 0x840 Push
	if(var_39_int == 0) goto Label_2115; // 0x841 JumpB
	var_38_string = var_38_string + var_36_int; // 0x842 Add2
	
Label_2115:
	var_35_string = var_38_string; // 0x843 Mov
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x845 PushV
	var_32_int = 0; // 0x846 MovI
	
Label_2119:
	var_34_string = "all"; // 0x847 PushS
	var_35_string = ""; var_36_int = 0; // 0x848 PushV
	var_36_int = var_32_int; // 0x849 Mov
	func_2110(var_35_string, var_36_int); // 0x84a NEW_2
	HasAnimation(var_33_bool, var_34_string, var_35_string); // 0x84c Func
	var_40_bool = var_33_bool == 0; // 0x84e Not
	if(var_40_bool == 0) goto Label_2129; // 0x84f JumpB
	goto Label_2132; // 0x850 Jump
	
Label_2132:
	var_29_int = var_32_int; // 0x854 Mov
	return 4; // 0x855 Return
	
Label_2129:
	var_41_int = 1; // 0x851 PushI
	var_32_int = var_32_int + var_41_int; // 0x852 Add2
...
{
	var_12_object = Obj(); // 0x857 PushV
	var_12_object = var_11_object; // 0x858 Mov
	TaskCall(6); // 0x859 TaskCall
	func_1320(var_12_object); // 0x85a NEW_2
...
{
	var_608_float = 0; var_609_float = 0; // 0x65f PushV
	var_610_bool = 0; var_611_object = Obj(); var_612_string = ""; // 0x660 PushV
	var_611_object = var_607_object; // 0x661 Mov
	var_612_string = "health"; // 0x662 MovS
	func_1524(var_610_bool, var_611_object, var_612_string); // 0x663 NEW_2
	var_613_bool = var_610_bool == 0; // 0x665 Not
	if(var_613_bool == 0) goto Label_1641; // 0x666 JumpB
	var_606_bool = 0; // 0x667 MovB
	return 2; // 0x668 Return
	
Label_1641:
	var_614_bool = 0; // 0x669 PushV
	var_614_bool = 0; // 0x66a MovB
	var_615_bool = 0; var_616_object = Obj(); // 0x66b PushV
	var_616_object = var_607_object; // 0x66c Mov
	func_1519(var_615_bool, var_616_object); // 0x66d NEW_2
	if(var_615_bool == 0) goto Label_1653; // 0x66f JumpB
	var_617_bool = 0; // 0x670 PushV
	func_2104(var_617_bool); // 0x671 NEW_2
	if(var_617_bool == 0) goto Label_1653; // 0x673 JumpB
	var_614_bool = 1; // 0x674 MovB
	
Label_1653:
	if(var_614_bool == 0) goto Label_1656; // 0x675 JumpB
	var_606_bool = 0; // 0x676 MovB
	return 2; // 0x677 Return
	
Label_1656:
	var_621_string = "health"; // 0x678 PushS
	GetProperty(var_621_string, var_609_float); // 0x679 ObjFunc
	var_622_float = 0.0; // 0x67b PushF
	var_606_bool = var_609_float <= var_622_float; // 0x67c LE2
...
{
	var_17_bool = 0; var_18_object = Obj(); // 0x884 PushV
	var_18_object = var_16_object; // 0x885 Mov
	func_1703(var_17_bool, var_18_object); // 0x886 NEW_2
	var_15_bool = var_17_bool; // 0x887 Mov
...
{
	var_52_object = Obj(); // 0x88b PushV
	var_52_object = var_51_object; // 0x88c Mov
	func_2353(var_52_object); // 0x88d NEW_2
...
{
	var_56_int = 0; var_57_int = 0; // 0x890 PushV
	var_58_string = "branch"; // 0x891 PushS
	GetVariable(var_58_string, var_57_int); // 0x892 Func
	var_55_int = var_57_int; // 0x894 Mov
...
{
	var_15_int = 0; // 0x897 PushV
	func_2192(var_15_int); // 0x898 NEW_2
	var_19_int = 1; // 0x89a PushI
	var_20_bool = var_15_int == var_19_int; // 0x89b Eq
	if(var_20_bool == 0) goto Label_2208; // 0x89c JumpB
	WorkWithCorpse(var_14_object); // 0x89d Func
...
Label_2208:
	Barter(var_14_object); // 0x8a0 Func
}
...
func_163(var_196_bool, var_197_object)
{
	...
	var_679_bool = 0; // 0xad PushV
	var_679_bool = 0; // 0xae MovB
	var_680_bool = GlobalVars[0]; // 0xaf PushGE
	if(var_680_bool == 0) goto Label_180; // 0xb0 JumpB
	var_681_int = var_3_int; // 0xb1 PushT
	if(var_681_int == 0) goto Label_180; // 0xb2 JumpB
	var_679_bool = 1; // 0xb3 MovB
	
Label_180:
	if(var_679_bool == 0) goto Label_187; // 0xb4 JumpB
	var_682_string = "all"; // 0xb5 PushS
	var_683_string = "attack_off"; // 0xb6 PushS
	PlayAnimation(var_682_string, var_683_string); // 0xb7 Func
	WaitForAnimEnd(); // 0xb9 Func
	
Label_187:
	var_684_bool = GlobalVars[0]; // 0xbb PushGE
	var_196_bool = var_684_bool; // 0xbc Mov
...
{
	var_20_int = 0; var_21_bool = 0; var_22_int = 0; var_23_bool = 0; // 0x8a3 PushV
	var_24_bool = var_18_int > var_19_int; // 0x8a4 GT
	if(var_24_bool == 0) goto Label_2218; // 0x8a5 JumpB
	var_25_string = "GenerateMoney: iMin > iMax"; // 0x8a6 PushS
	Trace(var_25_string); // 0x8a7 Func
	return 4; // 0x8a9 Return
	
Label_2218:
	var_22_int = 0; // 0x8aa MovI
	var_26_bool = var_18_int != var_19_int; // 0x8ab Neq
	if(var_26_bool == 0) goto Label_2225; // 0x8ac JumpB
	var_27_int = var_19_int - var_18_int; // 0x8ad Sub
	irand(var_22_int, var_27_int); // 0x8ae Func
	goto Label_2229; // 0x8b0 Jump
	
Label_2229:
	var_22_int = var_22_int + var_18_int; // 0x8b5 Add2
	var_28_int = 0; // 0x8b6 PushI
	var_29_bool = var_22_int == var_28_int; // 0x8b7 Eq
	if(var_29_bool == 0) goto Label_2234; // 0x8b8 JumpB
	return 4; // 0x8b9 Return
	
Label_2234:
	var_30_int = 0; var_31_string = ""; // 0x8ba PushV
	var_31_string = "Money"; // 0x8bb MovS
	func_2313(var_30_int, var_31_string); // 0x8bc NEW_2
	var_34_int = 0; // 0x8be PushI
	AddItem(var_23_bool, var_30_int, var_34_int, var_22_int); // 0x8bf Func
	return 4; // 0x8c1 Return
	
Label_2225:
	var_35_int = 0; // 0x8b1 PushI
	var_36_bool = var_18_int == var_35_int; // 0x8b2 Eq
	if(var_36_bool == 0) goto Label_2229; // 0x8b3 JumpB
...
{
	var_649_float = 0; var_650_bool = 0; var_651_float = 0; var_652_bool = 0; // 0x2aa PushV
	rand(var_651_float); // 0x2ab Func
	var_653_bool = var_651_float < var_648_float; // 0x2ad LT
	if(var_653_bool == 0) goto Label_702; // 0x2ae JumpB
	
Label_687:
	IsAnimationPlaying(var_652_bool); // 0x2af Func
	var_654_bool = var_652_bool == 0; // 0x2b1 Not
	if(var_654_bool == 0) goto Label_692; // 0x2b2 JumpB
...
Label_707:
	var_647_bool = 0; // 0x2c3 MovB
	return 4; // 0x2c4 Return
	
Label_692:
	var_655_bool = 0; // 0x2b4 PushV
	func_780(var_655_bool); // 0x2b5 NEW_2
	if(var_655_bool == 0) goto Label_698; // 0x2b7 JumpB
	var_647_bool = 1; // 0x2b8 MovB
...
Label_702:
	...
	func_884(var_652_bool); // 0x2c1 NEW_2
}
...
{
	var_62_object = Obj(); var_63_int = 0; var_64_bool = 0; var_65_object = Obj(); var_66_int = 0; var_67_bool = 0; // 0x8c2 PushV
	CreateInvItem(var_65_object); // 0x8c3 Func
	SetItemName(var_61_string); // 0x8c5 ObjFunc
	var_68_string = "Organ"; // 0x8c7 PushS
	var_69_int = 1; // 0x8c8 PushI
	SetProperty(var_68_string, var_69_int); // 0x8c9 ObjFunc
	GetItemID(var_66_int); // 0x8cb ObjFunc
	var_70_int = 0; // 0x8cd PushI
	var_71_int = 1; // 0x8ce PushI
	AddItem(var_67_bool, var_65_object, var_70_int, var_71_int); // 0x8cf Func
...
{
	var_603_bool = 0; // 0xc8 PushV
	var_603_bool = 0; // 0xc9 MovB
	var_604_int = 0; // 0xca PushI
	var_605_bool = var_602_float > var_604_int; // 0xcb GT
	if(var_605_bool == 0) goto Label_211; // 0xcc JumpB
	var_606_bool = 0; var_607_object = Obj(); // 0xcd PushV
	var_607_object = var_601_object; // 0xce Mov
	func_1631(var_606_bool, var_607_object); // 0xcf NEW_2
	if(var_606_bool == 0) goto Label_211; // 0xd1 JumpB
	var_603_bool = 1; // 0xd2 MovB
	
Label_211:
	if(var_603_bool == 0) goto Label_218; // 0xd3 JumpB
	var_623_bool = GlobalVars[0]; // 0xd4 PushGE
	var_623_bool = 1; // 0xd5 MovB
	GlobalVars[0] = var_623_bool; // 0xd6 PopGE
	func_680(var_602_float); // 0xd8 NEW_2
...
Label_1231:
	...
	func_2117(var_29_int); // 0x4d0 NEW_2
...
Label_1246:
	...
	func_2110(var_51_string, var_52_int); // 0x4ec NEW_2
...
func_2259()
{
	var_55_int = 0; // 0x8d3 PushV
	func_2192(var_55_int); // 0x8d4 NEW_2
	var_59_int = 1; // 0x8d6 PushI
	var_60_bool = var_55_int != var_59_int; // 0x8d7 Neq
	if(var_60_bool == 0) goto Label_2266; // 0x8d8 JumpB
	return 0; // 0x8d9 Return
	
Label_2266:
	var_61_string = ""; // 0x8da PushV
	var_61_string = "liver"; // 0x8db MovS
	func_2242(var_61_string); // 0x8dc NEW_2
	var_72_string = ""; // 0x8de PushV
	var_72_string = "kidney"; // 0x8df MovS
	func_2242(var_72_string); // 0x8e0 NEW_2
	var_73_string = ""; // 0x8e2 PushV
	var_73_string = "heart"; // 0x8e3 MovS
	func_2242(var_73_string); // 0x8e4 NEW_2
	var_74_string = ""; // 0x8e6 PushV
	var_74_string = "blood"; // 0x8e7 MovS
	func_2242(var_74_string); // 0x8e8 NEW_2
...
func_2283()
{
	var_13_int = 0; var_14_bool = 0; var_15_int = 0; var_16_bool = 0; // 0x8eb PushV
	var_17_int = 0; // 0x8ec PushI
	ClearSubContainer(var_17_int); // 0x8ed Func
	var_18_int = 0; var_19_int = 0; // 0x8ef PushV
	var_18_int = 300; // 0x8f0 MovI
	var_19_int = 750; // 0x8f1 MovI
	func_2211(var_18_int, var_19_int); // 0x8f2 NEW_2
	var_37_string = ""; var_38_int = 0; var_39_int = 0; // 0x8f4 PushV
	var_37_string = "Knife"; // 0x8f5 MovS
	var_38_int = 1; // 0x8f6 MovI
	var_39_int = 8; // 0x8f7 MovI
	func_1899(var_37_string, var_38_int, var_39_int); // 0x8f8 NEW_2
	var_48_string = ""; var_49_int = 0; var_50_int = 0; // 0x8fa PushV
	var_48_string = "lockpick"; // 0x8fb MovS
	var_49_int = 1; // 0x8fc MovI
	var_50_int = 6; // 0x8fd MovI
	func_1899(var_48_string, var_49_int, var_50_int); // 0x8fe NEW_2
	var_51_int = 0; var_52_string = ""; // 0x900 PushV
	var_52_string = "grabitel_mark"; // 0x901 MovS
	func_2313(var_51_int, var_52_string); // 0x902 NEW_2
	var_53_int = 0; // 0x904 PushI
	var_54_int = 1; // 0x905 PushI
	AddItem(var_16_bool, var_51_int, var_53_int, var_54_int); // 0x906 Func
	return 4; // 0x908 Return
}
...
Label_396:
	...
	var_663_string = "all"; // 0x18e PushS
	var_664_string = "fjump"; // 0x18f PushS
	PlayAnimation(var_663_string, var_664_string); // 0x190 Func
	WaitForAnimEnd(); // 0x192 Func
	func_884(var_229_float); // 0x195 NEW_2
	var_665_cvector = CVector(0.0, 0.0, 0.0); // 0x197 PushVec
	SetSpeed(var_665_cvector); // 0x198 Func
	Stop(); // 0x19a Func
	StopAsync(); // 0x19c Func
	var_666_bool = 0; // 0x19e PushV
	func_841(var_229_float, var_666_bool); // 0x19f NEW_2
	var_667_bool = var_666_bool == 0; // 0x1a1 Not
	if(var_667_bool == 0) goto Label_442; // 0x1a2 JumpB
	var_668_bool = 0; var_669_object = Obj(); // 0x1a3 PushV
	var_669_object = var_0_bool; // 0x1a4 MovT
	func_1703(var_668_bool, var_669_object); // 0x1a5 NEW_2
	var_670_bool = var_668_bool == 0; // 0x1a7 Not
	if(var_670_bool == 0) goto Label_426; // 0x1a8 JumpB
...
Label_426:
	...
	var_671_float = var_207_float * var_207_float; // 0x1b0 Mult
	var_672_bool = var_226_float < var_671_float; // 0x1b1 LT
	if(var_672_bool == 0) goto Label_442; // 0x1b2 JumpB
	var_673_bool = 0; var_674_float = 0; // 0x1b3 PushV
	var_674_float = var_207_float; // 0x1b4 Mov
	func_543(var_229_float, var_673_bool, var_674_float); // 0x1b5 NEW_2
	var_675_bool = var_673_bool == 0; // 0x1b7 Not
	if(var_675_bool == 0) goto Label_442; // 0x1b8 JumpB
	goto Label_452; // 0x1b9 Jump
	
Label_443:
	var_676_bool = 0; var_677_float = 0; // 0x1bb PushV
	var_677_float = var_207_float; // 0x1bc Mov
	func_543(var_229_float, var_676_bool, var_677_float); // 0x1bd NEW_2
	var_678_bool = var_676_bool == 0; // 0x1bf Not
	if(var_678_bool == 0) goto Label_450; // 0x1c0 JumpB
...
{
	var_32_int = 0; var_33_int = 0; // 0x909 PushV
	GetInvItemByName(var_33_int, var_31_string); // 0x90a Func
	var_30_int = var_33_int; // 0x90c Mov
...
{
	var_144_cvector = CVector(0,0,0); var_145_float = 0; var_146_float = 0; var_147_float = 0; var_148_float = 0; var_149_float = 0; var_150_cvector = CVector(0,0,0); var_151_float = 0; var_152_float = 0; var_153_float = 0; var_154_float = 0; var_155_float = 0; // 0x90e PushV
	var_150_cvector = var_142_cvector - var_141_cvector; // 0x90f Sub2
	var_151_float = 250000; // 0x910 MovI
	var_156_float = GetByIndex(var_150_cvector, 1); // 0x911 PushE
	var_157_int = 1000; // 0x912 PushI
	var_158_float = var_156_float * var_157_int; // 0x913 Mult
	var_159_float = var_143_float * var_143_float; // 0x914 Mult
	var_152_float = var_158_float - var_159_float; // 0x915 Sub2
	var_153_float = var_150_cvector | var_150_cvector; // 0x916 Or2
	var_160_float = 0; var_161_float = 0; var_162_float = 0; var_163_float = 0; // 0x917 PushV
	var_161_float = var_151_float; // 0x918 Mov
	var_162_float = var_152_float; // 0x919 Mov
	var_163_float = var_153_float; // 0x91a Mov
	func_1974(var_160_float, var_161_float, var_162_float, var_163_float); // 0x91b NEW_2
	var_154_float = var_160_float; // 0x91c Mov
	var_168_int = 0; // 0x91e PushI
	var_169_bool = var_154_float < var_168_int; // 0x91f LT
	if(var_169_bool == 0) goto Label_2339; // 0x920 JumpB
	var_155_float = 1; // 0x921 MovI
	goto Label_2347; // 0x922 Jump
	
Label_2347:
	var_170_cvector = CVector(0.0, 500.0, 0.0); // 0x92b PushVec
	var_171_float = var_170_cvector * var_155_float; // 0x92c Mult
	var_172_float = var_171_float * var_155_float; // 0x92d Mult
	var_173_int = var_150_cvector + var_172_float; // 0x92e Add
	var_140_cvector = var_173_int / var_173_int; // 0x92f Div2
	return 12; // 0x930 Return
	
Label_2339:
	var_174_float = 0; var_175_float = 0; var_176_float = 0; var_177_float = 0; var_178_float = 0; // 0x923 PushV
	var_175_float = var_151_float; // 0x924 Mov
	var_176_float = var_152_float; // 0x925 Mov
	var_177_float = var_153_float; // 0x926 Mov
	var_178_float = sqrt(var_154_float); // 0x927 Sqrt2
	func_1981(var_175_float, var_176_float, var_177_float, var_178_float); // 0x928 NEW_2
	var_155_float = sqrt(var_174_float); // 0x92a Sqrt2
}
...
Label_1309:
	...
	var_693_int = 1; // 0x523 PushI
	Sleep(var_693_int); // 0x524 Func
...
{
	func_2283(); // 0x52a NEW_2
	func_2259(); // 0x52d NEW_2
...
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x931 PushV
	GetScene(var_54_object); // 0x932 Func
	var_55_object = Obj(); // 0x934 PushV
	func_1951(var_55_object); // 0x935 NEW_2
	RemoveStationaryActor(var_55_object); // 0x937 ObjFunc
	var_58_object = Obj(); // 0x939 PushV
	var_58_object = var_52_object; // 0x93a Mov
	TaskCall(5); // 0x93b TaskCall
	func_1308(var_58_object); // 0x93c NEW_2
	TaskReturn(); // 0x93d TaskReturn
...
func_884(var_0_bool)
{
	...
	func_2084(var_267_object); // 0x376 NEW_2
...
func_924(var_2_int, var_270_bool, var_271_object, var_272_float, var_273_float, var_274_bool, var_275_bool)
{
	...
	func_2084(var_283_object); // 0x39f NEW_2
...
Label_2043:
	...
	func_2074(var_86_float); // 0x7fd NEW_2
...
func_504(var_0_bool, var_521_float, var_522_int)
{
	...
	var_600_int = 0; // 0x213 PushV
	func_197(var_600_int); // 0x214 NEW_2
	ReportHit(var_0_bool, var_600_int, var_528_float, var_527_float); // 0x216 Func
	var_601_object = Obj(); var_602_float = 0; // 0x218 PushV
	var_601_object = var_526_object; // 0x219 Mov
	var_602_float = var_528_float; // 0x21a Mov
	func_199(var_601_object, var_602_float); // 0x21b NEW_2
