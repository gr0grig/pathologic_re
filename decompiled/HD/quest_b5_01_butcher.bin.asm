...
0x911: Push("Can't find lsh animation : ")
...
0x920: Push("Can't find lsh animation : ")
...
0x973: Stack[-3] = Stack[-2]
0x974: GOTO 0x976

0x975: Stack[-3] = Stack[-1]
0x976: Return(); Pop(0)
...
0x99a: Pop(0)
0x99b: Pop(0); Push((bool) Stack[-1] == 0)
...
0x9ba: Stack[-2] = "quest_b5_01"
0x9bb: Stack[-1] = "butcher_attack"
0x9bc: Call2 0x998
...
0xa1d: Stack[-1] = "ui/NPC_Citizen1.png"
0xa1e: Return(); Pop(0)

0xa1f: Stack[-1] = "ui/NPC_Citizen1_b.png"
0xa20: Return(); Pop(0)
...
0xa28: Pop(0)
0xa29: @@ RemoveStationaryActor(Stack[-1])
0xa2a: Pop(1)
0xa2b: PushEmpty(object)
0xa2c: Stack[-1] = Stack[-4]
