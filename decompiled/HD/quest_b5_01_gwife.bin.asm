...
0x4a1: Push("Can't find lsh animation : ")
...
0x4b0: Push("Can't find lsh animation : ")
...
0x539: Stack[-1] = "oob5GathererWife1"
0x53a: Call2 0x508
...
0x56b: Stack[-1] = "ui/NPC_Citizen2.png"
0x56c: Return(); Pop(0)

0x56d: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x56e: Return(); Pop(0)
...
0x576: Pop(0)
0x577: @@ RemoveStationaryActor(Stack[-1])
0x578: Pop(1)
0x579: Push("b5q01NudeDead")
0x57a: Push((bool) 1)
0x57b: @ SetVariable(Stack[-2], Stack[-1])
0x57c: Pop(2)
0x57d: PushEmpty(bool, string, string)
0x57e: Stack[-2] = "quest_b5_01"
0x57f: Stack[-1] = "gwife_dead"
0x580: Call2 0x50d
...
0x58c: Stack[-3] = Stack[-7]
0x58d: Stack[-2] = Stack[-6]
...
0x594: Stack[-5] = Stack[-11]
0x595: Stack[-4] = Stack[-10]
0x596: Stack[-3] = Stack[-9]
0x597: Stack[-2] = Stack[-7]
