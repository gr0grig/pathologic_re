task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_object, var_13_cvector, var_14_bool)
{
	...
	func_1335(var_20_object); // 0xc3 NEW_2
...
Label_353:
	...
	func_1391(var_110_bool); // 0x163 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int, var_11_object, var_12_cvector, var_13_bool)
{
	...
	func_1205(var_30_object); // 0x1ca NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_cvector, var_12_bool, var_13_object)
{
	...
	func_1370(var_17_object); // 0x323 NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; // 0x58b PushV
	var_17_object = var_13_object; // 0x58c Mov
	var_18_int = var_14_int; // 0x58d Mov
	var_19_float = var_15_float; // 0x58e Mov
	func_1000(var_17_object, var_18_int, var_19_float); // 0x58f NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; var_22_cvector = CVector(0,0,0); var_23_cvector = CVector(0,0,0); // 0x593 PushV
	var_19_object = var_13_object; // 0x594 Mov
	var_20_int = var_14_int; // 0x595 Mov
	var_21_float = var_15_float; // 0x596 Mov
	var_22_cvector = var_17_cvector; // 0x597 Mov
	var_23_cvector = var_18_cvector; // 0x598 Mov
	func_1068(var_21_float, var_22_cvector, var_23_cvector); // 0x599 NEW_2
...
{
	var_14_object = Obj(); // 0x59d PushV
	var_14_object = var_13_object; // 0x59e Mov
	func_1393(var_14_object); // 0x59f NEW_2
...
Label_56:
	var_158_bool = var_27_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_159_object = var_18_object; // 0x40 Mov
	func_1156(); // 0x41 NEW_2
...
{
	var_79_int = var_77_cvector | var_78_cvector; // 0x501 Or
	var_80_int = var_77_cvector | var_77_cvector; // 0x502 Or
	var_81_int = var_78_cvector | var_78_cvector; // 0x503 Or
	var_82_float = var_80_int * var_81_int; // 0x504 Mult
	var_83_float = sqrt(var_82_float); // 0x505 Sqrt
	var_76_float = var_79_int / var_79_int; // 0x506 Div2
...
func_897(var_51_string)
{
	...
	func_1223(var_52_string); // 0x38e NEW_2
...
func_1156()
{
	var_160_bool = 0; var_161_bool = 0; // 0x484 PushV
	var_162_bool = 1; // 0x485 PushB
	CameraSwitchToNormal(var_162_bool); // 0x486 Func
	var_163_bool = 0; // 0x488 PushV
	func_1391(var_163_bool); // 0x489 NEW_2
	if(var_163_bool == 0) goto Label_1165; // 0x48b JumpB
	goto Label_1173; // 0x48c Jump
	
Label_1173:
	return 2; // 0x495 Return
	
Label_1165:
	var_164_string = "head"; // 0x48d PushS
	HasAnimationTrack(var_161_bool, var_164_string); // 0x48e Func
	var_165_bool = var_161_bool; // 0x490 Push
	if(var_165_bool == 0) goto Label_1173; // 0x491 JumpB
	var_166_string = "head"; // 0x492 PushS
	UnlookAsync(var_166_string); // 0x493 Func
}


func_1288(var_98_int, var_99_string)
{
	var_100_int = 0; var_101_int = 0; // 0x508 PushV
	GetVariable(var_99_string, var_101_int); // 0x509 Func
	var_98_int = var_101_int; // 0x50b Mov
...
{
	var_25_object = Obj(); var_26_object = Obj(); // 0x50d PushV
	FindActor(var_26_object, var_23_string); // 0x50e Func
	var_27_bool = var_26_object == 0; // 0x510 NullEq
	if(var_27_bool == 0) goto Label_1300; // 0x511 JumpB
	var_22_bool = 0; // 0x512 MovB
	return 2; // 0x513 Return
	
Label_1300:
	Trigger(var_26_object, var_24_string); // 0x514 Func
	var_22_bool = 1; // 0x516 MovB
...
{
	var_135_bool = 0; var_136_float = 0; var_137_float = 0; var_138_bool = 0; var_139_float = 0; var_140_float = 0; // 0x496 PushV
	lshHasAnimation(var_138_bool, var_134_string); // 0x497 Func
	var_141_bool = var_138_bool; // 0x499 Push
	if(var_141_bool == 0) goto Label_1185; // 0x49a JumpB
	lshGetAnimTimes(var_134_string, var_139_float, var_140_float); // 0x49b Func
	var_142_bool = 0; // 0x49d PushB
	lshPlayAnimation(var_139_float, var_140_float, var_142_bool); // 0x49e Func
	goto Label_1189; // 0x4a0 Jump
	
Label_1189:
	return 6; // 0x4a5 Return
	
Label_1185:
	var_143_string = "Can't find lsh animation : "; // 0x4a1 PushS
	var_144_int = var_143_string + var_134_string; // 0x4a2 Add
	Trace(var_144_int); // 0x4a3 Func
}


func_1305(var_44_string, var_45_int)
{
	var_46_string = ""; var_47_string = ""; // 0x519 PushV
	var_47_string = "idle"; // 0x51a MovS
	var_48_int = var_45_int; // 0x51b Push
	if(var_48_int == 0) goto Label_1310; // 0x51c JumpB
	var_47_string = var_47_string + var_45_int; // 0x51d Add2
	
Label_1310:
	var_44_string = var_47_string; // 0x51e Mov
...
{
	var_39_int = 0; var_40_bool = 0; var_41_int = 0; var_42_bool = 0; // 0x520 PushV
	var_41_int = 0; // 0x521 MovI
	
Label_1314:
	var_43_string = "all"; // 0x522 PushS
	var_44_string = ""; var_45_int = 0; // 0x523 PushV
	var_45_int = var_41_int; // 0x524 Mov
	func_1305(var_44_string, var_45_int); // 0x525 NEW_2
	HasAnimation(var_42_bool, var_43_string, var_44_string); // 0x527 Func
	var_49_bool = var_42_bool == 0; // 0x529 Not
	if(var_49_bool == 0) goto Label_1324; // 0x52a JumpB
	goto Label_1327; // 0x52b Jump
	
Label_1327:
	var_38_int = var_41_int; // 0x52f Mov
	return 4; // 0x530 Return
	
Label_1324:
	var_50_int = 1; // 0x52c PushI
	var_41_int = var_41_int + var_50_int; // 0x52d Add2
...
{
	var_109_bool = 0; // 0xa3 PushV
	func_1391(var_109_bool); // 0xa4 NEW_2
	var_110_bool = var_109_bool == 0; // 0xa6 Not
	if(var_110_bool == 0) goto Label_169; // 0xa7 JumpB
	return 0; // 0xa8 Return
	
Label_169:
	var_111_bool = var_108_string == var_2_object; // 0xa9 Eq
	if(var_111_bool == 0) goto Label_172; // 0xaa JumpB
	return 0; // 0xab Return
	
Label_172:
	var_112_string = ""; var_113_bool = 0; // 0xac PushV
	var_112_string = var_108_string; // 0xad Mov
	var_114_string = ""; // 0xae PushS
	var_115_bool = var_108_string == var_114_string; // 0xaf Eq
	if(var_115_bool == 0) goto Label_179; // 0xb0 JumpB
	var_113_bool = 0; // 0xb1 MovB
	goto Label_180; // 0xb2 Jump
	
Label_180:
	func_1190(var_112_string, var_113_bool); // 0xb4 NEW_2
	var_2_object = var_108_string; // 0xb6 TMov
	return 0; // 0xb7 Return
	
Label_179:
	var_113_bool = 1; // 0xb3 MovB
}


func_1190(var_112_string, var_113_bool)
{
	var_116_bool = 0; var_117_float = 0; var_118_float = 0; var_119_bool = 0; var_120_float = 0; var_121_float = 0; // 0x4a6 PushV
	lshHasAnimation(var_119_bool, var_112_string); // 0x4a7 Func
	var_122_bool = var_119_bool; // 0x4a9 Push
	if(var_122_bool == 0) goto Label_1200; // 0x4aa JumpB
	lshGetAnimTimes(var_112_string, var_120_float, var_121_float); // 0x4ab Func
	lshPlayAnimation(var_120_float, var_121_float, var_113_bool); // 0x4ad Func
	goto Label_1204; // 0x4af Jump
	
Label_1204:
	return 6; // 0x4b4 Return
	
Label_1200:
	var_123_string = "Can't find lsh animation : "; // 0x4b0 PushS
	var_124_int = var_123_string + var_112_string; // 0x4b1 Add
	Trace(var_124_int); // 0x4b2 Func
}
...
Label_874:
	...
	func_1223(var_104_string); // 0x36c NEW_2
...
func_1329()
{
	var_106_string = "oob5GathererWife1"; // 0x532 PushS
	var_107_int = 1; // 0x533 PushI
	SetVariable(var_106_string, var_107_int); // 0x534 Func
...
{
	var_31_float = 0; var_32_cvector = CVector(0,0,0); var_33_float = 0; var_34_cvector = CVector(0,0,0); // 0x4b5 PushV
	GetEyesHeight(var_33_float); // 0x4b6 ObjFunc
	var_34_cvector = CVector(0.0, 0.0, 0.0); // 0x4b8 MovV
	var_35_float = GetByIndex(var_34_cvector, 1); // 0x4b9 PushE
	var_35_float = var_33_float; // 0x4ba Mov
	SetByIndex(var_34_cvector, 1) = var_35_float; // 0x4bb PopE
	var_36_string = "head"; // 0x4bc PushS
	LookAsync(var_30_object, var_36_string, var_34_cvector); // 0x4bd Func
	return 4; // 0x4bf Return
}
...
{
	var_98_int = 0; var_99_string = ""; // 0x538 PushV
	var_99_string = "oob5GathererWife1"; // 0x539 MovS
	func_1288(var_98_int, var_99_string); // 0x53a NEW_2
	var_102_int = 0; // 0x53c PushI
	var_103_bool = var_98_int == var_102_int; // 0x53d Eq
	if(var_103_bool == 0) goto Label_1345; // 0x53e JumpB
	var_96_bool = 1; // 0x53f MovB
	return 0; // 0x540 Return
	
Label_1345:
	var_96_bool = 0; // 0x541 MovB
...
func_569()
{
	...
	func_1264(var_24_object); // 0x23d NEW_2
...
func_1087(var_28_bool, var_30_float)
{
	...
	func_1270(var_55_cvector, var_56_cvector); // 0x45a NEW_2
...
Label_1128:
	...
	var_68_bool = 1; // 0x46a PushB
	CameraTransit(var_46_cvector, var_44_cvector, var_68_bool); // 0x46b Func
	var_69_float = GetByIndex(var_45_cvector, 0); // 0x46d PushE
	var_70_float = GetByIndex(var_45_cvector, 2); // 0x46e PushE
	Rotate(var_69_float, var_70_float); // 0x46f Func
	var_71_bool = 0; // 0x471 PushV
	func_1391(var_71_bool); // 0x472 NEW_2
	if(var_71_bool == 0) goto Label_1142; // 0x474 JumpB
	goto Label_1150; // 0x475 Jump
	
Label_1150:
	CameraWaitForPlayFinish(); // 0x47e Func
	ResumeWorld(); // 0x480 Func
	var_28_bool = 1; // 0x482 MovB
	return 18; // 0x483 Return
	
Label_1142:
	var_72_string = "head"; // 0x476 PushS
	HasAnimationTrack(var_48_bool, var_72_string); // 0x477 Func
	var_73_bool = var_48_bool; // 0x479 Push
	if(var_73_bool == 0) goto Label_1150; // 0x47a JumpB
	var_74_string = "head"; // 0x47b PushS
	LookAsyncCamera(var_74_string); // 0x47c Func
}


func_1216()
{
	var_16_bool = 0; // 0x4c0 PushV
	func_1391(var_16_bool); // 0x4c1 NEW_2
	if(var_16_bool == 0) goto Label_1222; // 0x4c3 JumpB
...
{
	var_81_int = 0; var_82_int = 0; // 0x543 PushV
	var_83_string = "branch"; // 0x544 PushS
	GetVariable(var_83_string, var_82_int); // 0x545 Func
	var_84_int = 0; // 0x547 PushI
	var_85_bool = var_82_int == var_84_int; // 0x548 Eq
	if(var_85_bool == 0) goto Label_1357; // 0x549 JumpB
	var_80_int = 1; // 0x54a MovI
	return 2; // 0x54b Return
	
Label_1357:
	var_86_int = 1; // 0x54d PushI
	var_87_bool = var_82_int == var_86_int; // 0x54e Eq
	if(var_87_bool == 0) goto Label_1362; // 0x54f JumpB
	var_80_int = 2; // 0x550 MovI
	return 2; // 0x551 Return
	
Label_1362:
	var_80_int = 3; // 0x552 MovI
...
{
	var_53_bool = 0; var_54_int = 0; var_55_bool = 0; var_56_int = 0; var_57_bool = 0; var_58_float = 0; var_59_cvector = CVector(0,0,0); var_60_cvector = CVector(0,0,0); var_61_bool = 0; var_62_int = 0; var_63_bool = 0; var_64_int = 0; var_65_bool = 0; var_66_float = 0; var_67_cvector = CVector(0,0,0); var_68_cvector = CVector(0,0,0); // 0x4c7 PushV
	IsExisting3DSound(var_61_bool, var_52_string); // 0x4c8 Func
	var_69_bool = var_61_bool == 0; // 0x4ca Not
	if(var_69_bool == 0) goto Label_1248; // 0x4cb JumpB
	var_62_int = 0; // 0x4cc MovI
	
Label_1229:
	var_70_int = 1; // 0x4cd PushI
	var_71_int = var_62_int + var_70_int; // 0x4ce Add
	var_72_int = var_52_string + var_71_int; // 0x4cf Add
	IsExisting3DSound(var_63_bool, var_72_int); // 0x4d0 Func
	var_73_bool = var_63_bool == 0; // 0x4d2 Not
	if(var_73_bool == 0) goto Label_1237; // 0x4d3 JumpB
	goto Label_1240; // 0x4d4 Jump
	
Label_1240:
	var_74_bool = var_62_int == 0; // 0x4d8 Not
	if(var_74_bool == 0) goto Label_1243; // 0x4d9 JumpB
	return 16; // 0x4da Return
	
Label_1243:
	irand(var_64_int, var_62_int); // 0x4db Func
	var_75_int = 1; // 0x4dd PushI
	var_76_int = var_64_int + var_75_int; // 0x4de Add
	var_52_string = var_52_string + var_76_int; // 0x4df Add2
	
Label_1248:
	Is3DSoundLoaded(var_65_bool, var_52_string); // 0x4e0 Func
	var_77_bool = var_65_bool; // 0x4e2 Push
	if(var_77_bool == 0) goto Label_1263; // 0x4e3 JumpB
	GetEyesHeight(var_66_float); // 0x4e4 Func
	GetDirection(var_67_cvector); // 0x4e6 Func
	var_78_int = 50; // 0x4e8 PushI
	var_68_cvector = var_67_cvector * var_78_int; // 0x4e9 Mult2
	var_79_float = GetByIndex(var_68_cvector, 1); // 0x4ea PushE
	var_79_float = var_79_float + var_66_float; // 0x4eb Add2
	SetByIndex(var_68_cvector, 1) = var_79_float; // 0x4ec PopE
	PlayGlobalSound(var_52_string, var_68_cvector); // 0x4ed Func
	
Label_1263:
	return 16; // 0x4ef Return
	
Label_1237:
	var_80_int = 1; // 0x4d5 PushI
	var_62_int = var_62_int + var_80_int; // 0x4d6 Add2
	goto Label_1229; // 0x4d7 Jump
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_89_object, var_90_object)
{
	...
	func_1329(); // 0x58 NEW_2
	var_108_string = ""; // 0x5a PushV
	var_108_string = "Neutral"; // 0x5b MovS
	func_162(var_90_object, var_108_string); // 0x5c NEW_2
	var_125_int = 518656; // 0x5e PushI
	SetMessage(var_125_int); // 0x5f TObjFunc
	ClearReplies(); // 0x61 TObjFunc
	var_126_int = 518795; // 0x63 PushI
	var_127_int = 19900; // 0x64 PushI
	var_128_int = 19898; // 0x65 PushI
	AddReply(var_126_int, var_127_int, var_128_int); // 0x66 TObjFunc
	var_129_int = 518796; // 0x68 PushI
	var_130_int = 19900; // 0x69 PushI
	var_131_int = 19899; // 0x6a PushI
	AddReply(var_129_int, var_130_int, var_131_int); // 0x6b TObjFunc
	goto Label_132; // 0x6d Jump
	
Label_132:
	var_132_bool = 0; // 0x84 PushV
	func_1391(var_132_bool); // 0x85 NEW_2
	if(var_132_bool == 0) goto Label_147; // 0x87 JumpB
	
Label_136:
	lshWaitForAnimEnd(); // 0x88 Func
	var_133_string = var_3_string; // 0x8a PushT
	if(var_133_string == 0) goto Label_141; // 0x8b JumpB
...
Label_141:
	var_134_string = ""; // 0x8d PushV
	var_134_string = var_2_object; // 0x8e MovT
	func_1174(var_134_string); // 0x8f NEW_2
	goto Label_136; // 0x91 Jump
	
Label_147:
	var_145_string = "all"; // 0x93 PushS
	var_146_string = "idle"; // 0x94 PushS
	PlayAnimation(var_145_string, var_146_string); // 0x95 Func
	
Label_151:
	WaitForAnimEnd(); // 0x97 Func
	var_147_string = var_3_string; // 0x99 PushT
	if(var_147_string == 0) goto Label_156; // 0x9a JumpB
	goto Label_161; // 0x9b Jump
	
Label_156:
	var_148_string = "all"; // 0x9c PushS
	var_149_string = "idle"; // 0x9d PushS
	PlayAnimation(var_148_string, var_149_string); // 0x9e Func
	goto Label_151; // 0xa0 Jump
	
Label_110:
	var_150_string = ""; // 0x6e PushV
	var_150_string = "Neutral"; // 0x6f MovS
	func_162(var_90_object, var_150_string); // 0x70 NEW_2
	var_151_int = 518660; // 0x72 PushI
	SetMessage(var_151_int); // 0x73 TObjFunc
	ClearReplies(); // 0x75 TObjFunc
	var_152_int = 518661; // 0x77 PushI
	var_153_int = -1; // 0x78 PushI
	var_154_int = 19753; // 0x79 PushI
	AddReply(var_152_int, var_153_int, var_154_int); // 0x7a TObjFunc
	var_155_int = 518800; // 0x7c PushI
	var_156_int = -1; // 0x7d PushI
	var_157_int = 19903; // 0x7e PushI
	AddReply(var_155_int, var_156_int, var_157_int); // 0x7f TObjFunc
...
func_594(var_27_cvector, var_28_float)
{
	...
	func_1270(var_43_cvector, var_44_cvector); // 0x25c NEW_2
	...
	func_1270(var_41_cvector, var_42_cvector); // 0x261 NEW_2
...
{
	var_19_int = 0; var_20_int = 0; // 0x554 PushV
	var_21_string = "branch"; // 0x555 PushS
	GetVariable(var_21_string, var_20_int); // 0x556 Func
	var_18_int = var_20_int; // 0x558 Mov
...
{
	var_18_int = 0; // 0x55b PushV
	func_1364(var_18_int); // 0x55c NEW_2
	var_22_int = 1; // 0x55e PushI
	var_23_bool = var_18_int == var_22_int; // 0x55f Eq
	if(var_23_bool == 0) goto Label_1380; // 0x560 JumpB
	WorkWithCorpse(var_17_object); // 0x561 Func
...
Label_1380:
	Barter(var_17_object); // 0x564 Func
}
...
Label_492:
	...
	func_1312(var_38_int); // 0x1ed NEW_2
...
Label_507:
	...
	func_1305(var_60_string, var_61_int); // 0x209 NEW_2
...
Label_1016:
	...
	func_1270(var_45_cvector, var_46_cvector); // 0x3ff NEW_2
...
{
	var_78_string = "ui/NPC_Citizen2.png"; // 0x56b MovS
...
{
	var_79_string = "ui/NPC_Citizen2_b.png"; // 0x56d MovS
...
{
	var_18_object = Obj(); var_19_object = Obj(); // 0x4f0 PushV
	self(var_19_object); // 0x4f1 Func
	var_17_object = var_19_object; // 0x4f3 Mov
...
{
	var_15_object = Obj(); var_16_object = Obj(); // 0x571 PushV
	GetScene(var_16_object); // 0x572 Func
	var_17_object = Obj(); // 0x574 PushV
	func_1264(var_17_object); // 0x575 NEW_2
	RemoveStationaryActor(var_17_object); // 0x577 ObjFunc
	var_20_string = "b5q01NudeDead"; // 0x579 PushS
	var_21_bool = 1; // 0x57a PushB
	SetVariable(var_20_string, var_21_bool); // 0x57b Func
	var_22_bool = 0; var_23_string = ""; var_24_string = ""; // 0x57d PushV
	var_23_string = "quest_b5_01"; // 0x57e MovS
	var_24_string = "gwife_dead"; // 0x57f MovS
	func_1293(var_22_bool, var_23_string, var_24_string); // 0x580 NEW_2
	var_28_object = Obj(); // 0x582 PushV
	var_28_object = var_14_object; // 0x583 Mov
	TaskCall(4); // 0x584 TaskCall
	func_781(var_28_object); // 0x585 NEW_2
	TaskReturn(); // 0x586 TaskReturn
...
{
	var_53_float = 0; var_54_float = 0; // 0x4f6 PushV
	var_55_int = var_46_cvector | var_46_cvector; // 0x4f7 Or
	var_54_float = sqrt(var_55_int); // 0x4f8 Sqrt2
	var_56_float = 0.0; // 0x4f9 PushF
	var_57_bool = var_54_float < var_56_float; // 0x4fa LT
	if(var_57_bool == 0) goto Label_1278; // 0x4fb JumpB
	var_45_cvector = CVector(0.0, 0.0, 0.0); // 0x4fc MovV
	return 2; // 0x4fd Return
	
Label_1278:
	var_45_cvector = var_46_cvector / var_46_cvector; // 0x4fe Div2
...
func_765(var_0_object, var_65_bool)
{
	...
	func_1280(var_76_float, var_77_cvector, var_78_cvector); // 0x308 NEW_2
