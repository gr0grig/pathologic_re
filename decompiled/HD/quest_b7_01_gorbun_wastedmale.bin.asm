...
0x1d4: Push("Can't find lsh animation : ")
...
0x1e3: Push("Can't find lsh animation : ")
...
0x22c: Stack[-1] = "ui/NPC_Citizen3.png"
0x22d: Return(); Pop(0)

0x22e: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x22f: Return(); Pop(0)
