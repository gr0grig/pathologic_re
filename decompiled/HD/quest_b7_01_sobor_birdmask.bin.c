...
{
	var_68_string = "ui/NPC_bmask.png"; // 0x23e MovS
...
{
	var_69_string = "ui/NPC_bmask_b.png"; // 0x240 MovS
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_79_object, var_80_object)
{
	...
	var_103_int = 520978; // 0x54 PushI
	SetMessage(var_103_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_104_int = 520979; // 0x59 PushI
	var_105_int = 29847; // 0x5a PushI
	var_106_int = 22192; // 0x5b PushI
	AddReply(var_104_int, var_105_int, var_106_int); // 0x5c TObjFunc
	var_107_int = 528462; // 0x5e PushI
	var_108_int = -1; // 0x5f PushI
	var_109_int = 29849; // 0x60 PushI
