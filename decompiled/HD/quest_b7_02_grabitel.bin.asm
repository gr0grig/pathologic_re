...
0x7c5: Stack[-3] = Stack[-9]
0x7c6: Stack[-2] = Stack[-8]
0x7c7: Stack[-1] = Stack[-7]
0x7c8: Call2 0x733

0x7c9: Stack[-6] = Stack[-4]
0x7ca: Pop(4)
0x7cb: Push((int) 0)
...
0x7d1: Stack[-4] = Stack[-10]
0x7d2: Stack[-3] = Stack[-9]
0x7d3: Stack[-2] = Stack[-8]
...
0x7f4: Push("GenerateMoney: iMin > iMax")
0x7f5: @ Trace(Stack[-1])
0x7f6: Pop(1)
0x7f7: Return(); Pop(4)
...
0x812: Pop(0)
0x813: @@ SetItemName(Stack[-7])
0x814: Pop(0)
0x815: Push("Organ")
0x816: Push((int) 1)
0x817: @@ SetProperty(Stack[-2], Stack[-1])
0x818: Pop(2)
0x819: @@ GetItemID(Stack[-2])
0x81a: Pop(0)
0x81b: Push((int) 0)
0x81c: Push((int) 1)
...
0x86e: Stack[-2] = Stack[-4]
0x86f: Stack[-1] = (float) 0.03
0x870: Call2 0x763
...
0x883: Stack[-3] = Stack[-7]
0x884: Stack[-2] = Stack[-6]
0x885: Stack[-1] = Stack[-5]
0x886: Call2 0x680
...
0x88b: Stack[-5] = Stack[-11]
0x88c: Stack[-4] = Stack[-10]
0x88d: Stack[-3] = Stack[-9]
0x88e: Stack[-2] = Stack[-7]
