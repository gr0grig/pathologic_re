...
task_0_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2174(var_15_object); // 0x75 NEW_2
...
task_1_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2174(var_15_object); // 0xc0 NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2174(var_15_object); // 0x369 NEW_2
...
task_2_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_1953(var_13_object); // 0x3ae NEW_2
...
task_5_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object)
{
	...
	func_2020(var_14_object); // 0x4d6 NEW_2
...
{
	var_10_object = Obj(); // 0x85c PushV
	func_1820(var_10_object); // 0x85d NEW_2
	RemoveActor(var_10_object); // 0x85f Func
	Hold(); // 0x861 Func
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x882 PushV
	var_14_object = var_10_object; // 0x883 Mov
	var_15_int = var_11_int; // 0x884 Mov
	var_16_float = var_12_float; // 0x885 Mov
	func_1664(var_14_object, var_15_int, var_16_float); // 0x886 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x88a PushV
	var_16_object = var_10_object; // 0x88b Mov
	var_17_int = var_11_int; // 0x88c Mov
	var_18_float = var_12_float; // 0x88d Mov
	var_19_cvector = var_14_cvector; // 0x88e Mov
	var_20_cvector = var_15_cvector; // 0x88f Mov
	func_1732(var_18_float, var_19_cvector, var_20_cvector); // 0x890 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x893 PushV
	var_14_string = "health"; // 0x894 PushS
	var_15_bool = var_11_string == var_14_string; // 0x895 Eq
	if(var_15_bool == 0) goto Label_2207; // 0x896 JumpB
	var_16_string = "health"; // 0x897 PushS
	GetProperty(var_16_string, var_13_float); // 0x898 Func
	var_17_int = 0; // 0x89a PushI
	var_18_bool = var_13_float <= var_17_int; // 0x89b LE
	if(var_18_bool == 0) goto Label_2207; // 0x89c JumpB
	SignalDeath(var_10_object); // 0x89d Func
...
{
	var_11_object = Obj(); // 0x8a1 PushV
	var_11_object = var_10_object; // 0x8a2 Mov
	func_2148(var_11_object); // 0x8a3 NEW_2
...
func_0(var_0_bool, var_67_bool, var_68_object, var_187_object)
{
	...
	func_1953(var_84_object); // 0x3 NEW_2
...
Label_39:
	...
	func_1979(var_129_cvector, var_130_cvector, var_131_cvector, var_132_float); // 0x4b NEW_2
...
{
	var_103_object = Obj(); var_104_int = 0; var_105_bool = 0; var_106_object = Obj(); var_107_int = 0; var_108_bool = 0; // 0x810 PushV
	CreateInvItem(var_106_object); // 0x811 Func
	SetItemName(var_102_string); // 0x813 ObjFunc
	var_109_string = "Organ"; // 0x815 PushS
	var_110_int = 1; // 0x816 PushI
	SetProperty(var_109_string, var_110_int); // 0x817 ObjFunc
	GetItemID(var_107_int); // 0x819 ObjFunc
	var_111_int = 0; // 0x81b PushI
	var_112_int = 1; // 0x81c PushI
	AddItem(var_108_bool, var_106_object, var_111_int, var_112_int); // 0x81d Func
	return 6; // 0x81f Return
}


func_2081()
{
	var_96_int = 0; // 0x821 PushV
	func_2014(var_96_int); // 0x822 NEW_2
	var_100_int = 1; // 0x824 PushI
	var_101_bool = var_96_int != var_100_int; // 0x825 Neq
	if(var_101_bool == 0) goto Label_2088; // 0x826 JumpB
	return 0; // 0x827 Return
	
Label_2088:
	var_102_string = ""; // 0x828 PushV
	var_102_string = "liver"; // 0x829 MovS
	func_2064(var_102_string); // 0x82a NEW_2
	var_113_string = ""; // 0x82c PushV
	var_113_string = "kidney"; // 0x82d MovS
	func_2064(var_113_string); // 0x82e NEW_2
	var_114_string = ""; // 0x830 PushV
	var_114_string = "heart"; // 0x831 MovS
	func_2064(var_114_string); // 0x832 NEW_2
	var_115_string = ""; // 0x834 PushV
	var_115_string = "blood"; // 0x835 MovS
	func_2064(var_115_string); // 0x836 NEW_2
...
func_2105()
{
	var_16_int = 0; var_17_bool = 0; var_18_int = 0; var_19_bool = 0; // 0x839 PushV
	var_20_int = 0; // 0x83a PushI
	ClearSubContainer(var_20_int); // 0x83b Func
	var_21_int = 0; var_22_int = 0; // 0x83d PushV
	var_21_int = 300; // 0x83e MovI
	var_22_int = 750; // 0x83f MovI
	func_2033(var_21_int, var_22_int); // 0x840 NEW_2
	var_40_string = ""; var_41_int = 0; var_42_int = 0; // 0x842 PushV
	var_40_string = "Knife"; // 0x843 MovS
	var_41_int = 1; // 0x844 MovI
	var_42_int = 8; // 0x845 MovI
	func_1768(var_40_string, var_41_int, var_42_int); // 0x846 NEW_2
	var_51_string = ""; var_52_int = 0; var_53_int = 0; // 0x848 PushV
	var_51_string = "lockpick"; // 0x849 MovS
	var_52_int = 1; // 0x84a MovI
	var_53_int = 6; // 0x84b MovI
	func_1768(var_51_string, var_52_int, var_53_int); // 0x84c NEW_2
	var_54_int = 0; var_55_string = ""; // 0x84e PushV
	var_55_string = "grabitel_mark"; // 0x84f MovS
	func_2135(var_54_int, var_55_string); // 0x850 NEW_2
	var_56_int = 0; // 0x852 PushI
	var_57_int = 1; // 0x853 PushI
	AddItem(var_19_bool, var_54_int, var_56_int, var_57_int); // 0x854 Func
...
{
	var_35_int = 0; var_36_int = 0; // 0x857 PushV
	GetInvItemByName(var_36_int, var_34_string); // 0x858 Func
	var_33_int = var_36_int; // 0x85a Mov
...
{
	var_12_bool = 0; var_13_object = Obj(); // 0x865 PushV
	var_13_object = var_11_object; // 0x866 Mov
	func_1393(var_12_bool, var_13_object); // 0x867 NEW_2
	if(var_12_bool == 0) goto Label_2162; // 0x869 JumpB
	func_2105(); // 0x86b NEW_2
	var_58_bool = 0; var_59_object = Obj(); var_60_float = 0; // 0x86d PushV
	var_59_object = var_11_object; // 0x86e Mov
	var_60_float = 0.03; // 0x86f MovF
	func_1891(var_58_bool, var_59_object, var_60_float); // 0x870 NEW_2
	
Label_2162:
	func_2081(); // 0x873 NEW_2
	var_116_object = Obj(); // 0x875 PushV
	var_116_object = var_11_object; // 0x876 Mov
	TaskCall(5); // 0x877 TaskCall
	func_1216(var_116_object); // 0x878 NEW_2
...
func_126(var_185_bool, var_186_object)
{
	...
	var_668_bool = 0; // 0x88 PushV
	var_668_bool = 0; // 0x89 MovB
	var_669_bool = GlobalVars[0]; // 0x8a PushGE
	if(var_669_bool == 0) goto Label_143; // 0x8b JumpB
	var_670_int = var_3_int; // 0x8c PushT
	if(var_670_int == 0) goto Label_143; // 0x8d JumpB
	var_668_bool = 1; // 0x8e MovB
	
Label_143:
	if(var_668_bool == 0) goto Label_150; // 0x8f JumpB
	var_671_string = "all"; // 0x90 PushS
	var_672_string = "attack_off"; // 0x91 PushS
	PlayAnimation(var_671_string, var_672_string); // 0x92 Func
	WaitForAnimEnd(); // 0x94 Func
	
Label_150:
	var_673_bool = GlobalVars[0]; // 0x96 PushGE
	var_185_bool = var_673_bool; // 0x97 Mov
...
{
	var_638_float = 0; var_639_bool = 0; var_640_float = 0; var_641_bool = 0; // 0x285 PushV
	rand(var_640_float); // 0x286 Func
	var_642_bool = var_640_float < var_637_float; // 0x288 LT
	if(var_642_bool == 0) goto Label_665; // 0x289 JumpB
	
Label_650:
	IsAnimationPlaying(var_641_bool); // 0x28a Func
	var_643_bool = var_641_bool == 0; // 0x28c Not
	if(var_643_bool == 0) goto Label_655; // 0x28d JumpB
...
Label_670:
	var_636_bool = 0; // 0x29e MovB
	return 4; // 0x29f Return
	
Label_655:
	var_644_bool = 0; // 0x28f PushV
	func_743(var_644_bool); // 0x290 NEW_2
	if(var_644_bool == 0) goto Label_661; // 0x292 JumpB
	var_636_bool = 1; // 0x293 MovB
...
Label_665:
	...
	func_847(var_641_bool); // 0x29c NEW_2
}
...
Label_1169:
	...
	var_682_int = 1; // 0x495 PushI
	Sleep(var_682_int); // 0x496 Func
...
Label_1208:
	var_674_bool = 0; var_675_object = Obj(); // 0x4b8 PushV
	var_675_object = var_15_object; // 0x4b9 Mov
	TaskCall(1); // 0x4ba TaskCall
	func_126(var_674_bool, var_675_object); // 0x4bb NEW_2
	TaskReturn(); // 0x4bc TaskReturn
	var_14_bool = var_676_object; // 0x4bd Mov
...
{
	var_592_bool = 0; // 0xa3 PushV
	var_592_bool = 0; // 0xa4 MovB
	var_593_int = 0; // 0xa5 PushI
	var_594_bool = var_591_float > var_593_int; // 0xa6 GT
	if(var_594_bool == 0) goto Label_174; // 0xa7 JumpB
	var_595_bool = 0; var_596_object = Obj(); // 0xa8 PushV
	var_596_object = var_590_object; // 0xa9 Mov
	func_1505(var_595_bool, var_596_object); // 0xaa NEW_2
	if(var_595_bool == 0) goto Label_174; // 0xac JumpB
	var_592_bool = 1; // 0xad MovB
	
Label_174:
	if(var_592_bool == 0) goto Label_181; // 0xae JumpB
	var_612_bool = GlobalVars[0]; // 0xaf PushGE
	var_612_bool = 1; // 0xb0 MovB
	GlobalVars[0] = var_612_bool; // 0xb1 PopGE
	func_643(var_591_float); // 0xb3 NEW_2
...
Label_359:
	...
	var_652_string = "all"; // 0x169 PushS
	var_653_string = "fjump"; // 0x16a PushS
	PlayAnimation(var_652_string, var_653_string); // 0x16b Func
	WaitForAnimEnd(); // 0x16d Func
	func_847(var_218_float); // 0x170 NEW_2
	var_654_cvector = CVector(0.0, 0.0, 0.0); // 0x172 PushVec
	SetSpeed(var_654_cvector); // 0x173 Func
	Stop(); // 0x175 Func
	StopAsync(); // 0x177 Func
	var_655_bool = 0; // 0x179 PushV
	func_804(var_218_float, var_655_bool); // 0x17a NEW_2
	var_656_bool = var_655_bool == 0; // 0x17c Not
	if(var_656_bool == 0) goto Label_405; // 0x17d JumpB
	var_657_bool = 0; var_658_object = Obj(); // 0x17e PushV
	var_658_object = var_0_bool; // 0x17f MovT
	func_1577(var_657_bool, var_658_object); // 0x180 NEW_2
	var_659_bool = var_657_bool == 0; // 0x182 Not
	if(var_659_bool == 0) goto Label_389; // 0x183 JumpB
...
Label_389:
	...
	var_660_float = var_196_float * var_196_float; // 0x18b Mult
	var_661_bool = var_215_float < var_660_float; // 0x18c LT
	if(var_661_bool == 0) goto Label_405; // 0x18d JumpB
	var_662_bool = 0; var_663_float = 0; // 0x18e PushV
	var_663_float = var_196_float; // 0x18f Mov
	func_506(var_218_float, var_662_bool, var_663_float); // 0x190 NEW_2
	var_664_bool = var_662_bool == 0; // 0x192 Not
	if(var_664_bool == 0) goto Label_405; // 0x193 JumpB
	goto Label_415; // 0x194 Jump
	
Label_406:
	var_665_bool = 0; var_666_float = 0; // 0x196 PushV
	var_666_float = var_196_float; // 0x197 Mov
	func_506(var_218_float, var_665_bool, var_666_float); // 0x198 NEW_2
	var_667_bool = var_665_bool == 0; // 0x19a Not
	if(var_667_bool == 0) goto Label_413; // 0x19b JumpB
...
func_847(var_0_bool)
{
	...
	func_1953(var_256_object); // 0x351 NEW_2
...
Label_1912:
	...
	func_1943(var_65_float); // 0x77a NEW_2
...
func_887(var_2_int, var_259_bool, var_260_object, var_261_float, var_262_float, var_263_bool, var_264_bool)
{
	...
	func_1953(var_272_object); // 0x37a NEW_2
...
func_1926(var_580_float)
{
	...
	var_583_int = 0; // 0x78b PushI
	var_584_bool = var_580_float < var_583_int; // 0x78c LT
	if(var_584_bool == 0) goto Label_1938; // 0x78d JumpB
	var_585_float = 0.7; // 0x78e PushF
	var_586_int = 500; // 0x78f PushI
	RumblePlay(var_585_float, var_586_int); // 0x790 Func
	
Label_1938:
	var_587_int = 15; // 0x792 PushI
	SendWorldWndMessage(var_587_int, var_582_object); // 0x793 Func
...
{
	var_66_object = Obj(); var_67_object = Obj(); // 0x797 PushV
	CreateFloatVector(var_67_object); // 0x798 Func
	add(var_65_float); // 0x79a ObjFunc
	var_68_int = 16; // 0x79c PushI
	SendWorldWndMessage(var_68_int, var_67_object); // 0x79d Func
...
Label_1451:
	var_588_string = "armor"; // 0x5ab PushS
	GetProperty(var_588_string, var_537_int); // 0x5ac ObjFunc
}


func_1953(var_84_object)
{
	var_85_bool = 0; var_86_bool = 0; // 0x7a1 PushV
	IsPlayerActor(var_84_object, var_86_bool); // 0x7a2 Func
	var_87_bool = var_86_bool; // 0x7a4 Push
	if(var_87_bool == 0) goto Label_1961; // 0x7a5 JumpB
	var_88_string = "attack"; // 0x7a6 PushS
	PlayGlobalMusic(var_88_string); // 0x7a7 Func
...
func_1962()
{
	var_106_object = Obj(); var_107_object = Obj(); // 0x7aa PushV
	GetScene(var_107_object); // 0x7ab Func
	var_108_string = "battle"; // 0x7ad PushS
	var_109_object = Obj(); // 0x7ae PushV
	func_1820(var_109_object); // 0x7af NEW_2
	BroadcastMessage(var_108_string, var_109_object, var_107_object); // 0x7b1 Func
...
{
	var_607_bool = 0; var_608_bool = 0; // 0x7b5 PushV
	var_609_string = "god_mode"; // 0x7b6 PushS
	GetVariable(var_609_string, var_608_bool); // 0x7b7 Func
	var_606_bool = var_608_bool; // 0x7b9 Mov
...
{
	var_133_cvector = CVector(0,0,0); var_134_float = 0; var_135_float = 0; var_136_float = 0; var_137_float = 0; var_138_float = 0; var_139_cvector = CVector(0,0,0); var_140_float = 0; var_141_float = 0; var_142_float = 0; var_143_float = 0; var_144_float = 0; // 0x7bb PushV
	var_139_cvector = var_131_cvector - var_130_cvector; // 0x7bc Sub2
	var_140_float = 250000; // 0x7bd MovI
	var_145_float = GetByIndex(var_139_cvector, 1); // 0x7be PushE
	var_146_int = 1000; // 0x7bf PushI
	var_147_float = var_145_float * var_146_int; // 0x7c0 Mult
	var_148_float = var_132_float * var_132_float; // 0x7c1 Mult
	var_141_float = var_147_float - var_148_float; // 0x7c2 Sub2
	var_142_float = var_139_cvector | var_139_cvector; // 0x7c3 Or2
	var_149_float = 0; var_150_float = 0; var_151_float = 0; var_152_float = 0; // 0x7c4 PushV
	var_150_float = var_140_float; // 0x7c5 Mov
	var_151_float = var_141_float; // 0x7c6 Mov
	var_152_float = var_142_float; // 0x7c7 Mov
	func_1843(var_149_float, var_150_float, var_151_float, var_152_float); // 0x7c8 NEW_2
	var_143_float = var_149_float; // 0x7c9 Mov
	var_157_int = 0; // 0x7cb PushI
	var_158_bool = var_143_float < var_157_int; // 0x7cc LT
	if(var_158_bool == 0) goto Label_2000; // 0x7cd JumpB
	var_144_float = 1; // 0x7ce MovI
	goto Label_2008; // 0x7cf Jump
	
Label_2008:
	var_159_cvector = CVector(0.0, 500.0, 0.0); // 0x7d8 PushVec
	var_160_float = var_159_cvector * var_144_float; // 0x7d9 Mult
	var_161_float = var_160_float * var_144_float; // 0x7da Mult
	var_162_int = var_139_cvector + var_161_float; // 0x7db Add
	var_129_cvector = var_162_int / var_162_int; // 0x7dc Div2
	return 12; // 0x7dd Return
	
Label_2000:
	var_163_float = 0; var_164_float = 0; var_165_float = 0; var_166_float = 0; var_167_float = 0; // 0x7d0 PushV
	var_164_float = var_140_float; // 0x7d1 Mov
	var_165_float = var_141_float; // 0x7d2 Mov
	var_166_float = var_142_float; // 0x7d3 Mov
	var_167_float = sqrt(var_143_float); // 0x7d4 Sqrt2
	func_1850(var_164_float, var_165_float, var_166_float, var_167_float); // 0x7d5 NEW_2
	var_144_float = sqrt(var_163_float); // 0x7d7 Sqrt2
}
...
func_467(var_0_bool, var_510_float, var_511_int)
{
	...
	var_589_int = 0; // 0x1ee PushV
	func_160(var_589_int); // 0x1ef NEW_2
	ReportHit(var_0_bool, var_589_int, var_517_float, var_516_float); // 0x1f1 Func
	var_590_object = Obj(); var_591_float = 0; // 0x1f3 PushV
	var_590_object = var_515_object; // 0x1f4 Mov
	var_591_float = var_517_float; // 0x1f5 Mov
	func_162(var_590_object, var_591_float); // 0x1f6 NEW_2
...
{
	var_97_int = 0; var_98_int = 0; // 0x7de PushV
	var_99_string = "branch"; // 0x7df PushS
	GetVariable(var_99_string, var_98_int); // 0x7e0 Func
	var_96_int = var_98_int; // 0x7e2 Mov
...
{
	var_597_float = 0; var_598_float = 0; // 0x5e1 PushV
	var_599_bool = 0; var_600_object = Obj(); var_601_string = ""; // 0x5e2 PushV
	var_600_object = var_596_object; // 0x5e3 Mov
	var_601_string = "health"; // 0x5e4 MovS
	func_1398(var_599_bool, var_600_object, var_601_string); // 0x5e5 NEW_2
	var_602_bool = var_599_bool == 0; // 0x5e7 Not
	if(var_602_bool == 0) goto Label_1515; // 0x5e8 JumpB
	var_595_bool = 0; // 0x5e9 MovB
	return 2; // 0x5ea Return
	
Label_1515:
	var_603_bool = 0; // 0x5eb PushV
	var_603_bool = 0; // 0x5ec MovB
	var_604_bool = 0; var_605_object = Obj(); // 0x5ed PushV
	var_605_object = var_596_object; // 0x5ee Mov
	func_1393(var_604_bool, var_605_object); // 0x5ef NEW_2
	if(var_604_bool == 0) goto Label_1527; // 0x5f1 JumpB
	var_606_bool = 0; // 0x5f2 PushV
	func_1973(var_606_bool); // 0x5f3 NEW_2
	if(var_606_bool == 0) goto Label_1527; // 0x5f5 JumpB
	var_603_bool = 1; // 0x5f6 MovB
	
Label_1527:
	if(var_603_bool == 0) goto Label_1530; // 0x5f7 JumpB
	var_595_bool = 0; // 0x5f8 MovB
	return 2; // 0x5f9 Return
	
Label_1530:
	var_610_string = "health"; // 0x5fa PushS
	GetProperty(var_610_string, var_598_float); // 0x5fb ObjFunc
	var_611_float = 0.0; // 0x5fd PushF
	var_595_bool = var_598_float <= var_611_float; // 0x5fe LE2
...
{
	var_15_int = 0; // 0x7e5 PushV
	func_2014(var_15_int); // 0x7e6 NEW_2
	var_19_int = 1; // 0x7e8 PushI
	var_20_bool = var_15_int == var_19_int; // 0x7e9 Eq
	if(var_20_bool == 0) goto Label_2030; // 0x7ea JumpB
	WorkWithCorpse(var_14_object); // 0x7eb Func
...
Label_2030:
	Barter(var_14_object); // 0x7ee Func
}


func_2033(var_21_int, var_22_int)
{
	var_23_int = 0; var_24_bool = 0; var_25_int = 0; var_26_bool = 0; // 0x7f1 PushV
	var_27_bool = var_21_int > var_22_int; // 0x7f2 GT
	if(var_27_bool == 0) goto Label_2040; // 0x7f3 JumpB
	var_28_string = "GenerateMoney: iMin > iMax"; // 0x7f4 PushS
	Trace(var_28_string); // 0x7f5 Func
	return 4; // 0x7f7 Return
	
Label_2040:
	var_25_int = 0; // 0x7f8 MovI
	var_29_bool = var_21_int != var_22_int; // 0x7f9 Neq
	if(var_29_bool == 0) goto Label_2047; // 0x7fa JumpB
	var_30_int = var_22_int - var_21_int; // 0x7fb Sub
	irand(var_25_int, var_30_int); // 0x7fc Func
	goto Label_2051; // 0x7fe Jump
	
Label_2051:
	var_25_int = var_25_int + var_21_int; // 0x803 Add2
	var_31_int = 0; // 0x804 PushI
	var_32_bool = var_25_int == var_31_int; // 0x805 Eq
	if(var_32_bool == 0) goto Label_2056; // 0x806 JumpB
	return 4; // 0x807 Return
	
Label_2056:
	var_33_int = 0; var_34_string = ""; // 0x808 PushV
	var_34_string = "Money"; // 0x809 MovS
	func_2135(var_33_int, var_34_string); // 0x80a NEW_2
	var_37_int = 0; // 0x80c PushI
	AddItem(var_26_bool, var_33_int, var_37_int, var_25_int); // 0x80d Func
	return 4; // 0x80f Return
	
Label_2047:
	var_38_int = 0; // 0x7ff PushI
	var_39_bool = var_21_int == var_38_int; // 0x800 Eq
...
Label_542:
	...
	var_613_string = "all"; // 0x223 PushS
	var_614_string = "attack_middle"; // 0x224 PushS
	var_615_int = var_614_string + var_483_int; // 0x225 Add
	HasAnimation(var_484_bool, var_613_string, var_615_int); // 0x226 Func
	var_616_bool = var_484_bool; // 0x228 Push
	if(var_616_bool == 0) goto Label_623; // 0x229 JumpB
	func_1962(); // 0x22b NEW_2
	var_617_string = "all"; // 0x22d PushS
	var_618_string = "attack_middle"; // 0x22e PushS
	var_619_int = var_618_string + var_483_int; // 0x22f Add
	PlayAnimation(var_617_string, var_619_int); // 0x230 Func
	WaitForAnimEnd(); // 0x232 Func
	func_847(var_486_string); // 0x235 NEW_2
	var_620_bool = 0; var_621_object = Obj(); // 0x237 PushV
	var_621_object = var_0_bool; // 0x238 MovT
	func_1577(var_620_bool, var_621_object); // 0x239 NEW_2
	var_622_bool = var_620_bool == 0; // 0x23b Not
	if(var_622_bool == 0) goto Label_577; // 0x23c JumpB
	StopAsync(); // 0x23d Func
	var_477_bool = 0; // 0x23f MovB
	return 8; // 0x240 Return
	
Label_577:
	var_623_float = 0; var_624_int = 0; // 0x241 PushV
	var_623_float = var_478_float; // 0x242 Mov
	var_624_int = var_483_int; // 0x243 Mov
	func_467(var_486_string, var_623_float, var_624_int); // 0x244 NEW_2
	var_485_int = 1; // 0x246 MovI
	
Label_583:
	var_625_string = "attack_middle"; // 0x247 PushS
	var_626_int = var_625_string + var_483_int; // 0x248 Add
	var_627_string = "_"; // 0x249 PushS
	var_628_int = var_626_int + var_627_string; // 0x24a Add
	var_486_string = var_628_int + var_485_int; // 0x24b Add2
	var_629_string = "all"; // 0x24c PushS
	HasAnimation(var_484_bool, var_629_string, var_486_string); // 0x24d Func
	var_630_bool = var_484_bool == 0; // 0x24f Not
	if(var_630_bool == 0) goto Label_594; // 0x250 JumpB
	goto Label_623; // 0x251 Jump
	
Label_623:
	var_631_bool = 0; // 0x26f PushB
	SetAttackState(var_631_bool); // 0x270 Func
	var_632_string = "all"; // 0x272 PushS
	var_633_string = "attack_end"; // 0x273 PushS
	var_634_int = var_633_string + var_483_int; // 0x274 Add
	PlayAnimation(var_632_string, var_634_int); // 0x275 Func
	var_635_bool = 0; // 0x277 PushV
	func_857(var_635_bool); // 0x278 NEW_2
	if(var_635_bool == 0) goto Label_641; // 0x27a JumpB
	var_636_bool = 0; var_637_float = 0; // 0x27b PushV
	var_637_float = 0.45; // 0x27c MovF
	func_645(var_636_bool, var_637_float); // 0x27d NEW_2
...
Label_594:
	func_1962(); // 0x253 NEW_2
	var_645_string = "all"; // 0x255 PushS
	PlayAnimation(var_645_string, var_486_string); // 0x256 Func
	WaitForAnimEnd(); // 0x258 Func
	func_847(var_486_string); // 0x25b NEW_2
	var_646_bool = 0; var_647_object = Obj(); // 0x25d PushV
	var_647_object = var_0_bool; // 0x25e MovT
	func_1577(var_646_bool, var_647_object); // 0x25f NEW_2
	var_648_bool = var_646_bool == 0; // 0x261 Not
	if(var_648_bool == 0) goto Label_615; // 0x262 JumpB
	StopAsync(); // 0x263 Func
	var_477_bool = 0; // 0x265 MovB
	return 8; // 0x266 Return
	
Label_615:
	var_649_float = 0; var_650_int = 0; // 0x267 PushV
	var_649_float = var_478_float; // 0x268 Mov
	var_650_int = var_483_int; // 0x269 Mov
	func_467(var_486_string, var_649_float, var_650_int); // 0x26a NEW_2
	var_651_int = 1; // 0x26c PushI
	var_485_int = var_485_int + var_651_int; // 0x26d Add2
