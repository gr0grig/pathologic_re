...
0x425: @@ HasProperty(Stack[-1], Stack[-4])
0x426: Pop(1)
...
0x43a: @@ GetProperty(Stack[-1], Stack[-2])
0x43b: Pop(1)
0x43c: PushEmpty(bool, string)
0x43d: Stack[-1] = Stack[-3]
0x43e: Call2 0x461

0x43f: Stack[-14] = Stack[-2]
0x440: Pop(2)
0x441: Return(); Pop(10)
...
0x44d: Push("Can't find lsh animation : ")
...
0x45c: Push("Can't find lsh animation : ")
...
0x4f7: Push("Can't retrieve diary root")
0x4f8: @ Trace(Stack[-1])
0x4f9: Pop(1)
...
0x503: Pop(1)
0x504: @@ Find(Stack[-7], Stack[-2])
0x505: Pop(0)
0x506: Pop(0); Push((bool) Stack[-2] == 0)
0x507: IF (Stack[-1] == 0) GOTO 0x50e; Pop(1)

0x508: Push("Can't find diary parent with id: ")
...
0x50e: @@ AddChild(Stack[-8])
0x50f: Pop(0)
0x510: Push((int) 7)
0x511: @ SendWorldWndMessage(Stack[-1])
0x512: Pop(1)
0x513: @@ GetCategory(Stack[-1])
0x514: Pop(0)
...
0x530: Stack[-1] = "ui/NPC_Klara.png"
0x531: Return(); Pop(0)

0x532: Stack[-1] = "ui/NPC_Klara_b.png"
0x533: Return(); Pop(0)
