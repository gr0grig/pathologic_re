...
0xae6: Stack[-3] = Stack[-9]
0xae7: Stack[-2] = Stack[-8]
0xae8: Stack[-1] = Stack[-7]
0xae9: Call2 0xa36

0xaea: Stack[-6] = Stack[-4]
0xaeb: Pop(4)
0xaec: Push((int) 0)
...
0xaf2: Stack[-4] = Stack[-10]
0xaf3: Stack[-3] = Stack[-9]
0xaf4: Stack[-2] = Stack[-8]
...
0xb0b: Pop(1)
0xb0c: Push("class")
0xb0d: @@ GetProperty(Stack[-1], Stack[-2])
0xb0e: Pop(1)
...
0xb29: Stack[-1] = Stack[-9]
0xb2a: Call2 0x7e7

0xb2b: Pop(1)
0xb2c: IF (Stack[-1] == 0) GOTO 0xb33; Pop(1)

0xb2d: Push("reputation")
0xb2e: @@ GetProperty(Stack[-1], Stack[-3])
0xb2f: Pop(1)
0xb30: Push((float)0.33)
0xb31: Stack[-9] = Stack[-3] >= Stack[-1]; Pop(1);
0xb32: Return(); Pop(6)

0xb33: PushEmpty(bool, object, string)
0xb34: Stack[-2] = Stack[-10]
0xb35: Stack[-1] = "class"
0xb36: Call2 0x7ec
...
0xb3c: Push("class")
0xb3d: @@ GetProperty(Stack[-1], Stack[-2])
0xb3e: Pop(1)
0xb3f: PushEmpty(bool, string)
0xb40: Stack[-1] = Stack[-3]
0xb41: Call2 0x9c8

0xb42: Stack[-10] = Stack[-2]
0xb43: Pop(2)
0xb44: Return(); Pop(6)
...
0xb61: Stack[-4] = Stack[-2]
0xb62: Pop(2)
0xb63: Return(); Pop(0)

0xb64: PushEmpty()
0xb65: PushEmpty(bool, object)
0xb66: Stack[-1] = Stack[-3]
...
0xba7: Stack[-1] = Stack[-8]
0xba8: Call2 0x7df

0xba9: Stack[-3] = Stack[-2]
0xbaa: Pop(2)
...
0xbc6: Stack[-2] = Stack[-4]
0xbc7: Stack[-1] = (float) 0.05
0xbc8: Call2 0xa6c
...
0xbd3: Stack[-3] = Stack[-7]
0xbd4: Stack[-2] = Stack[-6]
0xbd5: Stack[-1] = Stack[-5]
0xbd6: Call2 0x918
...
0xbdb: Stack[-5] = Stack[-11]
0xbdc: Stack[-4] = Stack[-10]
0xbdd: Stack[-3] = Stack[-9]
0xbde: Stack[-2] = Stack[-7]
...
0xc0c: Push("GenerateMoney: iMin > iMax")
0xc0d: @ Trace(Stack[-1])
0xc0e: Pop(1)
0xc0f: Return(); Pop(4)
...
0xc2a: Pop(0)
0xc2b: @@ SetItemName(Stack[-7])
0xc2c: Pop(0)
0xc2d: Push("Organ")
0xc2e: Push((int) 1)
0xc2f: @@ SetProperty(Stack[-2], Stack[-1])
0xc30: Pop(2)
0xc31: @@ GetItemID(Stack[-2])
0xc32: Pop(0)
0xc33: Push((int) 0)
0xc34: Push((int) 1)
