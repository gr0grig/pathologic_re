...
Label_280:
	...
	func_2516(var_117_object); // 0x128 NEW_2
	...
	func_2494(var_125_object); // 0x12d NEW_2
...
Label_311:
	...
	func_2494(var_138_object); // 0x141 NEW_2
	...
	func_2506(var_139_bool, var_140_object); // 0x146 NEW_2
...
Label_330:
	...
	func_2528(var_148_object); // 0x14d NEW_2
...
Label_337:
	...
	func_2516(var_154_object); // 0x154 NEW_2
...
Label_345:
	...
	func_2563(var_157_object); // 0x15c NEW_2
...
Label_406:
	...
	func_2540(var_189_object); // 0x19b NEW_2
...
Label_430:
	...
	func_2540(var_206_object); // 0x1b0 NEW_2
...
Label_637:
	...
	func_2771(var_289_bool); // 0x27f NEW_2
...
task_3_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_int)
{
	...
	func_2431(var_17_object); // 0x56c NEW_2
...
Label_1417:
	...
	func_2259(var_18_object); // 0x58d NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object)
{
	...
	func_2672(var_18_object); // 0x65b NEW_2
...
task_4_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool)
{
	...
	func_2318(var_14_object); // 0x65f NEW_2
...
task_5_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object)
{
	...
	func_2419(var_18_bool, var_19_string, var_20_string); // 0x701 NEW_2
...
{
	var_18_object = Obj(); var_19_int = 0; var_20_float = 0; // 0xaa7 PushV
	var_18_object = var_14_object; // 0xaa8 Mov
	var_19_int = var_15_int; // 0xaa9 Mov
	var_20_float = var_16_float; // 0xaaa Mov
	func_2048(var_18_object, var_19_int, var_20_float); // 0xaab NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; var_23_cvector = CVector(0,0,0); var_24_cvector = CVector(0,0,0); // 0xaaf PushV
	var_20_object = var_14_object; // 0xab0 Mov
	var_21_int = var_15_int; // 0xab1 Mov
	var_22_float = var_16_float; // 0xab2 Mov
	var_23_cvector = var_18_cvector; // 0xab3 Mov
	var_24_cvector = var_19_cvector; // 0xab4 Mov
	func_2116(var_22_float, var_23_cvector, var_24_cvector); // 0xab5 NEW_2
...
{
	var_16_float = 0; var_17_float = 0; // 0xab8 PushV
	var_18_string = "health"; // 0xab9 PushS
	var_19_bool = var_15_string == var_18_string; // 0xaba Eq
	if(var_19_bool == 0) goto Label_2756; // 0xabb JumpB
	var_20_string = "health"; // 0xabc PushS
	GetProperty(var_20_string, var_17_float); // 0xabd Func
	var_21_int = 0; // 0xabf PushI
	var_22_bool = var_17_float <= var_21_int; // 0xac0 LE
	if(var_22_bool == 0) goto Label_2756; // 0xac1 JumpB
	SignalDeath(var_14_object); // 0xac2 Func
...
{
	var_15_object = Obj(); // 0xac6 PushV
	var_15_object = var_14_object; // 0xac7 Mov
	func_2773(var_15_object); // 0xac8 NEW_2
...
Label_56:
	var_186_bool = var_27_bool == 0; // 0x38 Not
	if(var_186_bool == 0) goto Label_63; // 0x39 JumpB
	sync(); // 0x3a Func
	IsDialogEnd(var_27_bool); // 0x3c ObjFunc
	goto Label_56; // 0x3e Jump
	
Label_63:
	var_187_object = Obj(); // 0x3f PushV
	var_187_object = var_18_object; // 0x40 Mov
...
Label_2064:
	...
	func_2324(var_46_cvector, var_47_cvector); // 0x817 NEW_2
...
{
	var_157_int = 0; var_158_string = ""; // 0xa04 PushV
	var_158_string = "b9q01DankoFree"; // 0xa05 MovS
	func_2352(var_157_int, var_158_string); // 0xa06 NEW_2
	var_159_int = 0; // 0xa08 PushI
	var_160_bool = var_157_int != var_159_int; // 0xa09 Neq
	if(var_160_bool == 0) goto Label_2573; // 0xa0a JumpB
	var_155_bool = 1; // 0xa0b MovB
	return 0; // 0xa0c Return
	
Label_2573:
	var_155_bool = 0; // 0xa0d MovB
...
{
	var_83_object = Obj(); var_84_object = Obj(); // 0x90e PushV
	self(var_84_object); // 0x90f Func
	var_82_object = var_84_object; // 0x911 Mov
	return 2; // 0x912 Return
}


func_2575(var_140_bool)
{
	var_142_int = 0; var_143_int = 0; // 0xa0f PushV
	var_144_string = "rifle_ammo"; // 0xa10 PushS
	GetItemCountOfType(var_143_int, var_144_string); // 0xa11 ObjFunc
	var_145_int = 30; // 0xa13 PushI
	var_140_bool = var_143_int >= var_145_int; // 0xa14 GE2
...
{
	var_54_float = 0; var_55_float = 0; // 0x914 PushV
	var_56_int = var_47_cvector | var_47_cvector; // 0x915 Or
	var_55_float = sqrt(var_56_int); // 0x916 Sqrt2
	var_57_float = 0.0; // 0x917 PushF
	var_58_bool = var_55_float < var_57_float; // 0x918 LT
	if(var_58_bool == 0) goto Label_2332; // 0x919 JumpB
	var_46_cvector = CVector(0.0, 0.0, 0.0); // 0x91a MovV
	return 2; // 0x91b Return
	
Label_2332:
	var_46_cvector = var_47_cvector / var_47_cvector; // 0x91c Div2
...
func_2582()
{
	var_28_object = Obj(); var_29_object = Obj(); // 0xa16 PushV
	var_30_int = 301; // 0xa17 PushI
	var_31_int = 1; // 0xa18 PushI
	var_32_int = 521616; // 0xa19 PushI
	CreateDiaryEntry(var_29_object, var_30_int, var_31_int, var_32_int); // 0xa1a Func
	var_33_bool = 0; var_34_object = Obj(); var_35_int = 0; // 0xa1c PushV
	var_34_object = var_29_object; // 0xa1d Mov
	var_35_int = 297; // 0xa1e MovI
	func_2621(var_33_bool, var_34_object, var_35_int); // 0xa1f NEW_2
...
{
	var_442_bool = var_438_float < var_439_float; // 0x91f LT
	if(var_442_bool == 0) goto Label_2339; // 0x920 JumpB
	var_437_float = var_438_float; // 0x921 Mov
...
Label_2339:
	var_437_float = var_439_float; // 0x923 Mov
}
...
func_1313(var_0_object)
{
	...
	func_2431(var_123_object); // 0x523 NEW_2
...
func_2595()
{
	var_61_object = Obj(); var_62_object = Obj(); // 0xa23 PushV
	var_63_int = 302; // 0xa24 PushI
	var_64_int = 1; // 0xa25 PushI
	var_65_int = 521617; // 0xa26 PushI
	CreateDiaryEntry(var_62_object, var_63_int, var_64_int, var_65_int); // 0xa27 Func
	var_66_bool = 0; var_67_object = Obj(); var_68_int = 0; // 0xa29 PushV
	var_67_object = var_62_object; // 0xa2a Mov
	var_68_int = 297; // 0xa2b MovI
	func_2621(var_66_bool, var_67_object, var_68_int); // 0xa2c NEW_2
...
{
	var_162_bool = var_159_float < var_160_float; // 0x926 LT
	if(var_162_bool == 0) goto Label_2346; // 0x927 JumpB
	var_158_float = var_160_float; // 0x928 Mov
	return 0; // 0x929 Return
	
Label_2346:
	var_163_bool = var_159_float > var_161_float; // 0x92a GT
	if(var_163_bool == 0) goto Label_2350; // 0x92b JumpB
	var_158_float = var_161_float; // 0x92c Mov
	return 0; // 0x92d Return
	
Label_2350:
	var_158_float = var_159_float; // 0x92e Mov
...
func_1320()
{
	...
	func_2277(var_256_string); // 0x52a NEW_2
...
{
	var_43_object = Obj(); var_44_object = Obj(); // 0xa30 PushV
	GetDiaryRoot(var_44_object); // 0xa31 Func
	var_45_bool = var_44_object == 0; // 0xa33 Not
	if(var_45_bool == 0) goto Label_2618; // 0xa34 JumpB
	var_46_string = "Can't retrieve diary root"; // 0xa35 PushS
	Trace(var_46_string); // 0xa36 Func
	var_42_object = 0; // 0xa38 MovB
	return 2; // 0xa39 Return
	
Label_2618:
	var_42_object = var_44_object; // 0xa3a Mov
...
{
	var_119_int = 0; var_120_int = 0; // 0x930 PushV
	GetVariable(var_118_string, var_120_int); // 0x931 Func
	var_117_int = var_120_int; // 0x933 Mov
...
func_1589(var_16_object)
{
	...
	func_2419(var_17_bool, var_18_string, var_19_string); // 0x639 NEW_2
	...
	func_2357(var_129_bool, var_130_object, var_131_float); // 0x64e NEW_2
...
Label_1854:
	...
	func_2341(var_158_float, var_159_float, var_160_float, var_161_float); // 0x744 NEW_2
...
func_1333(var_2_object, var_130_bool, var_131_object, var_132_float, var_133_float, var_134_bool, var_135_bool)
{
	...
	func_2431(var_143_object); // 0x538 NEW_2
	...
	func_2259(var_147_object); // 0x545 NEW_2
...
Label_1353:
	...
	func_2318(var_158_object); // 0x54f NEW_2
...
{
	var_132_bool = var_130_object == 0; // 0x936 Not
	if(var_132_bool == 0) goto Label_2362; // 0x937 JumpB
	var_129_bool = 0; // 0x938 MovB
	return 0; // 0x939 Return
	
Label_2362:
	var_133_int = 0; // 0x93a PushI
	var_134_bool = var_131_float > var_133_int; // 0x93b GT
	if(var_134_bool == 0) goto Label_2369; // 0x93c JumpB
	var_135_int = 8; // 0x93d PushI
	SendWorldWndMessage(var_135_int); // 0x93e Func
	goto Label_2378; // 0x940 Jump
	
Label_2378:
	var_136_float = 0; // 0x94a PushV
	var_136_float = var_131_float; // 0x94b Mov
	func_2409(var_136_float); // 0x94c NEW_2
	var_140_bool = 0; var_141_object = Obj(); var_142_string = ""; var_143_float = 0; var_144_float = 0; var_145_float = 0; // 0x94e PushV
	var_141_object = var_130_object; // 0x94f Mov
	var_142_string = "reputation"; // 0x950 MovS
	var_143_float = var_131_float; // 0x951 Mov
	var_144_float = 0; // 0x952 MovI
	var_145_float = 1; // 0x953 MovI
	func_1844(var_140_bool, var_141_object, var_142_string, var_143_float, var_144_float, var_145_float); // 0x954 NEW_2
	var_129_bool = 1; // 0x956 MovB
	return 0; // 0x957 Return
	
Label_2369:
	var_164_int = 0; // 0x941 PushI
	var_165_bool = var_131_float < var_164_int; // 0x942 LT
	if(var_165_bool == 0) goto Label_2376; // 0x943 JumpB
	var_166_int = 9; // 0x944 PushI
	SendWorldWndMessage(var_166_int); // 0x945 Func
	goto Label_2378; // 0x947 Jump
	
Label_2376:
	var_129_bool = 0; // 0x948 MovB
...
{
	var_36_object = Obj(); var_37_object = Obj(); var_38_int = 0; var_39_object = Obj(); var_40_object = Obj(); var_41_int = 0; // 0xa3d PushV
	var_42_object = Obj(); // 0xa3e PushV
	func_2608(var_42_object); // 0xa3f NEW_2
	var_39_object = var_42_object; // 0xa40 Mov
	Find(var_35_int, var_40_object); // 0xa42 ObjFunc
	var_47_bool = var_40_object == 0; // 0xa44 Not
	if(var_47_bool == 0) goto Label_2636; // 0xa45 JumpB
	var_48_string = "Can't find diary parent with id: "; // 0xa46 PushS
	var_49_int = var_48_string + var_35_int; // 0xa47 Add
	Trace(var_49_int); // 0xa48 Func
	var_33_bool = 0; // 0xa4a MovB
	return 6; // 0xa4b Return
	
Label_2636:
	AddChild(var_34_object); // 0xa4c ObjFunc
	var_50_int = 7; // 0xa4e PushI
	SendWorldWndMessage(var_50_int); // 0xa4f Func
	GetCategory(var_41_int); // 0xa51 ObjFunc
	SetDiarySection(var_41_int); // 0xa53 Func
	var_33_bool = 0; // 0xa55 MovB
	return 6; // 0xa56 Return
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_89_object, var_90_object)
{
	...
	if(var_95_int == 0) goto Label_164; // 0x4f JumpB
	var_96_string = ""; // 0x50 PushV
	var_96_string = "Neutral"; // 0x51 MovS
	func_194(var_90_object, var_96_string); // 0x52 NEW_2
	var_113_int = 521564; // 0x54 PushI
	SetMessage(var_113_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_114_bool = 0; // 0x59 PushV
	var_114_bool = 0; // 0x5a MovB
	var_115_bool = 0; var_116_object = Obj(); // 0x5b PushV
	var_116_object = var_1_object; // 0x5c MovT
	func_2516(var_116_object); // 0x5d NEW_2
	if(var_115_bool == 0) goto Label_102; // 0x5f JumpB
	var_123_bool = 0; var_124_object = Obj(); // 0x60 PushV
	var_124_object = var_1_object; // 0x61 MovT
	func_2494(var_124_object); // 0x62 NEW_2
	if(var_123_bool == 0) goto Label_102; // 0x64 JumpB
	var_114_bool = 1; // 0x65 MovB
	
Label_102:
	if(var_114_bool == 0) goto Label_108; // 0x66 JumpB
	var_129_int = 521565; // 0x67 PushI
	var_130_int = 22727; // 0x68 PushI
	var_131_int = 22726; // 0x69 PushI
	AddReply(var_129_int, var_130_int, var_131_int); // 0x6a TObjFunc
	
Label_108:
	var_132_bool = 0; // 0x6c PushV
	var_132_bool = 0; // 0x6d MovB
	var_133_bool = 0; // 0x6e PushV
	var_133_bool = 0; // 0x6f MovB
	var_134_bool = 0; // 0x70 PushV
	var_134_bool = 0; // 0x71 MovB
	var_135_bool = 0; // 0x72 PushV
	var_135_bool = 0; // 0x73 MovB
	var_136_bool = 0; var_137_object = Obj(); // 0x74 PushV
	var_137_object = var_1_object; // 0x75 MovT
	func_2494(var_137_object); // 0x76 NEW_2
	if(var_136_bool == 0) goto Label_127; // 0x78 JumpB
	var_138_bool = 0; var_139_object = Obj(); // 0x79 PushV
	var_139_object = var_1_object; // 0x7a MovT
	func_2506(var_138_bool, var_139_object); // 0x7b NEW_2
	if(var_138_bool == 0) goto Label_127; // 0x7d JumpB
	var_135_bool = 1; // 0x7e MovB
	
Label_127:
	if(var_135_bool == 0) goto Label_134; // 0x7f JumpB
	var_146_bool = 0; var_147_object = Obj(); // 0x80 PushV
	var_147_object = var_1_object; // 0x81 MovT
	func_2528(var_147_object); // 0x82 NEW_2
	if(var_146_bool == 0) goto Label_134; // 0x84 JumpB
	var_134_bool = 1; // 0x85 MovB
	
Label_134:
	if(var_134_bool == 0) goto Label_142; // 0x86 JumpB
	var_152_bool = 0; var_153_object = Obj(); // 0x87 PushV
	var_153_object = var_1_object; // 0x88 MovT
	func_2516(var_153_object); // 0x89 NEW_2
	var_154_bool = var_152_bool == 0; // 0x8b Not
	if(var_154_bool == 0) goto Label_142; // 0x8c JumpB
	var_133_bool = 1; // 0x8d MovB
	
Label_142:
	if(var_133_bool == 0) goto Label_150; // 0x8e JumpB
	var_155_bool = 0; var_156_object = Obj(); // 0x8f PushV
	var_156_object = var_1_object; // 0x90 MovT
	func_2563(var_156_object); // 0x91 NEW_2
	var_161_bool = var_155_bool == 0; // 0x93 Not
	if(var_161_bool == 0) goto Label_150; // 0x94 JumpB
	var_132_bool = 1; // 0x95 MovB
	
Label_150:
	if(var_132_bool == 0) goto Label_156; // 0x96 JumpB
	var_162_int = 521573; // 0x97 PushI
	var_163_int = 23390; // 0x98 PushI
	var_164_int = 22734; // 0x99 PushI
	AddReply(var_162_int, var_163_int, var_164_int); // 0x9a TObjFunc
	
Label_156:
	var_165_int = 521572; // 0x9c PushI
	var_166_int = -1; // 0x9d PushI
	var_167_int = 22733; // 0x9e PushI
	AddReply(var_165_int, var_166_int, var_167_int); // 0x9f TObjFunc
	goto Label_164; // 0xa1 Jump
	
Label_164:
	var_168_bool = 0; // 0xa4 PushV
	func_2771(var_168_bool); // 0xa5 NEW_2
	if(var_168_bool == 0) goto Label_179; // 0xa7 JumpB
	
Label_168:
	lshWaitForAnimEnd(); // 0xa8 Func
	var_169_string = var_3_string; // 0xaa PushT
	if(var_169_string == 0) goto Label_173; // 0xab JumpB
...
Label_173:
	var_170_string = ""; // 0xad PushV
	var_170_string = var_2_object; // 0xae MovT
	func_2228(var_170_string); // 0xaf NEW_2
	goto Label_168; // 0xb1 Jump
	
Label_179:
	var_181_string = "all"; // 0xb3 PushS
	var_182_string = "idle"; // 0xb4 PushS
	PlayAnimation(var_181_string, var_182_string); // 0xb5 Func
	
Label_183:
	WaitForAnimEnd(); // 0xb7 Func
	var_183_string = var_3_string; // 0xb9 PushT
	if(var_183_string == 0) goto Label_188; // 0xba JumpB
	goto Label_193; // 0xbb Jump
	
Label_188:
	var_184_string = "all"; // 0xbc PushS
	var_185_string = "idle"; // 0xbd PushS
	PlayAnimation(var_184_string, var_185_string); // 0xbe Func
...
Label_1905:
	...
	func_2334(var_437_float, var_438_float, var_439_float); // 0x776 NEW_2
	...
	func_2341(var_447_float, var_448_float, var_449_float, var_450_float); // 0x784 NEW_2
	...
	func_2392(var_455_float); // 0x78f NEW_2
...
Label_1885:
	var_463_string = "armor"; // 0x75d PushS
	GetProperty(var_463_string, var_412_int); // 0x75e ObjFunc
}
...
{
	var_492_float = 0; var_493_bool = 0; var_494_float = 0; var_495_bool = 0; // 0x457 PushV
	rand(var_494_float); // 0x458 Func
	var_496_bool = var_494_float < var_491_float; // 0x45a LT
	if(var_496_bool == 0) goto Label_1131; // 0x45b JumpB
	
Label_1116:
	IsAnimationPlaying(var_495_bool); // 0x45c Func
	var_497_bool = var_495_bool == 0; // 0x45e Not
	if(var_497_bool == 0) goto Label_1121; // 0x45f JumpB
...
Label_1136:
	var_490_bool = 0; // 0x470 MovB
	return 4; // 0x471 Return
	
Label_1121:
	var_498_bool = 0; // 0x461 PushV
	func_1209(var_498_bool); // 0x462 NEW_2
	if(var_498_bool == 0) goto Label_1127; // 0x464 JumpB
	var_490_bool = 1; // 0x465 MovB
...
Label_1131:
	...
	func_1313(var_495_bool); // 0x46e NEW_2
}


func_2392(var_455_float)
{
	var_456_object = Obj(); var_457_object = Obj(); // 0x958 PushV
	CreateFloatVector(var_457_object); // 0x959 Func
	add(var_455_float); // 0x95b ObjFunc
	var_458_int = 0; // 0x95d PushI
	var_459_bool = var_455_float < var_458_int; // 0x95e LT
	if(var_459_bool == 0) goto Label_2404; // 0x95f JumpB
	var_460_float = 0.7; // 0x960 PushF
	var_461_int = 500; // 0x961 PushI
	RumblePlay(var_460_float, var_461_int); // 0x962 Func
	
Label_2404:
	var_462_int = 15; // 0x964 PushI
	SendWorldWndMessage(var_462_int, var_457_object); // 0x965 Func
...
{
	var_81_int = 0; var_82_int = 0; // 0xa59 PushV
	var_83_string = "branch"; // 0xa5a PushS
	GetVariable(var_83_string, var_82_int); // 0xa5b Func
	var_84_int = 0; // 0xa5d PushI
	var_85_bool = var_82_int == var_84_int; // 0xa5e Eq
	if(var_85_bool == 0) goto Label_2659; // 0xa5f JumpB
	var_80_int = 1; // 0xa60 MovI
	return 2; // 0xa61 Return
	
Label_2659:
	var_86_int = 1; // 0xa63 PushI
	var_87_bool = var_82_int == var_86_int; // 0xa64 Eq
	if(var_87_bool == 0) goto Label_2664; // 0xa65 JumpB
	var_80_int = 2; // 0xa66 MovI
	return 2; // 0xa67 Return
	
Label_2664:
	var_80_int = 3; // 0xa68 MovI
...
func_2141(var_28_bool, var_30_float)
{
	...
	func_2324(var_55_cvector, var_56_cvector); // 0x878 NEW_2
...
Label_2182:
	...
	var_68_bool = 1; // 0x888 PushB
	CameraTransit(var_46_cvector, var_44_cvector, var_68_bool); // 0x889 Func
	var_69_float = GetByIndex(var_45_cvector, 0); // 0x88b PushE
	var_70_float = GetByIndex(var_45_cvector, 2); // 0x88c PushE
	Rotate(var_69_float, var_70_float); // 0x88d Func
	var_71_bool = 0; // 0x88f PushV
	func_2771(var_71_bool); // 0x890 NEW_2
	if(var_71_bool == 0) goto Label_2196; // 0x892 JumpB
	goto Label_2204; // 0x893 Jump
	
Label_2204:
	CameraWaitForPlayFinish(); // 0x89c Func
	ResumeWorld(); // 0x89e Func
	var_28_bool = 1; // 0x8a0 MovB
	return 18; // 0x8a1 Return
	
Label_2196:
	var_72_string = "head"; // 0x894 PushS
	HasAnimationTrack(var_48_bool, var_72_string); // 0x895 Func
	var_73_bool = var_48_bool; // 0x897 Push
	if(var_73_bool == 0) goto Label_2204; // 0x898 JumpB
	var_74_string = "head"; // 0x899 PushS
	LookAsyncCamera(var_74_string); // 0x89a Func
}
...
Label_1706:
	...
	func_2277(var_98_string); // 0x6ac NEW_2
...
{
	var_137_object = Obj(); var_138_object = Obj(); // 0x969 PushV
	CreateFloatVector(var_138_object); // 0x96a Func
	add(var_136_float); // 0x96c ObjFunc
	var_139_int = 16; // 0x96e PushI
	SendWorldWndMessage(var_139_int, var_138_object); // 0x96f Func
...
{
	var_106_int = 0; var_107_int = 0; // 0xa6a PushV
	var_108_string = "branch"; // 0xa6b PushS
	GetVariable(var_108_string, var_107_int); // 0xa6c Func
	var_105_int = var_107_int; // 0xa6e Mov
...
{
	var_19_int = 0; // 0xa71 PushV
	func_2666(var_19_int); // 0xa72 NEW_2
	var_23_int = 1; // 0xa74 PushI
	var_24_bool = var_19_int == var_23_int; // 0xa75 Eq
	if(var_24_bool == 0) goto Label_2682; // 0xa76 JumpB
	WorkWithCorpse(var_18_object); // 0xa77 Func
...
Label_2682:
	Barter(var_18_object); // 0xa7a Func
}
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x973 PushV
	FindActor(var_21_object, var_18_string); // 0x974 Func
	var_22_bool = var_21_object == 0; // 0x976 NullEq
	if(var_22_bool == 0) goto Label_2426; // 0x977 JumpB
	var_17_bool = 0; // 0x978 MovB
	return 2; // 0x979 Return
	
Label_2426:
	Trigger(var_21_object, var_19_string); // 0x97a Func
	var_17_bool = 1; // 0x97c MovB
...
{
	var_112_object = Obj(); var_113_int = 0; var_114_bool = 0; var_115_object = Obj(); var_116_int = 0; var_117_bool = 0; // 0xa7d PushV
	CreateInvItem(var_115_object); // 0xa7e Func
	SetItemName(var_111_string); // 0xa80 ObjFunc
	var_118_string = "Organ"; // 0xa82 PushS
	var_119_int = 1; // 0xa83 PushI
	SetProperty(var_118_string, var_119_int); // 0xa84 ObjFunc
	GetItemID(var_116_int); // 0xa86 ObjFunc
	var_120_int = 0; // 0xa88 PushI
	var_121_int = 1; // 0xa89 PushI
	AddItem(var_117_bool, var_115_object, var_120_int, var_121_int); // 0xa8a Func
	return 6; // 0xa8c Return
}


func_2431(var_123_object)
{
	var_124_bool = 0; var_125_bool = 0; // 0x97f PushV
	IsPlayerActor(var_123_object, var_125_bool); // 0x980 Func
	var_126_bool = var_125_bool; // 0x982 Push
	if(var_126_bool == 0) goto Label_2439; // 0x983 JumpB
	var_127_string = "attack"; // 0x984 PushS
	PlayGlobalMusic(var_127_string); // 0x985 Func
...
func_2440()
{
	var_360_object = Obj(); var_361_object = Obj(); // 0x988 PushV
	GetScene(var_361_object); // 0x989 Func
	var_362_string = "battle"; // 0x98b PushS
	var_363_object = Obj(); // 0x98c PushV
	func_2318(var_363_object); // 0x98d NEW_2
	BroadcastMessage(var_362_string, var_363_object, var_361_object); // 0x98f Func
...
func_2702()
{
	var_105_int = 0; // 0xa8e PushV
	func_2666(var_105_int); // 0xa8f NEW_2
	var_109_int = 1; // 0xa91 PushI
	var_110_bool = var_105_int != var_109_int; // 0xa92 Neq
	if(var_110_bool == 0) goto Label_2709; // 0xa93 JumpB
	return 0; // 0xa94 Return
	
Label_2709:
	var_111_string = ""; // 0xa95 PushV
	var_111_string = "liver"; // 0xa96 MovS
	func_2685(var_111_string); // 0xa97 NEW_2
	var_122_string = ""; // 0xa99 PushV
	var_122_string = "kidney"; // 0xa9a MovS
	func_2685(var_122_string); // 0xa9b NEW_2
	var_123_string = ""; // 0xa9d PushV
	var_123_string = "heart"; // 0xa9e MovS
	func_2685(var_123_string); // 0xa9f NEW_2
	var_124_string = ""; // 0xaa1 PushV
	var_124_string = "blood"; // 0xaa2 MovS
	func_2685(var_124_string); // 0xaa3 NEW_2
...
func_2451()
{
	var_85_int = 0; var_86_int = 0; // 0x993 PushV
	var_87_string = "rifle_ammo"; // 0x994 PushS
	var_88_int = 30; // 0x995 PushI
	RemoveItemByType(var_86_int, var_87_string, var_88_int); // 0x996 ObjFunc
...
func_2457()
{
	var_22_string = "oob9Doberman1"; // 0x99a PushS
	var_23_int = 1; // 0x99b PushI
	SetVariable(var_22_string, var_23_int); // 0x99c Func
...
Label_690:
	...
	func_2318(var_82_object); // 0x2bc NEW_2
...
Label_827:
	...
	var_506_string = "all"; // 0x33d PushS
	var_507_string = "fjump"; // 0x33e PushS
	PlayAnimation(var_506_string, var_507_string); // 0x33f Func
	WaitForAnimEnd(); // 0x341 Func
	func_1313(var_51_float); // 0x344 NEW_2
	var_508_cvector = CVector(0.0, 0.0, 0.0); // 0x346 PushVec
	SetSpeed(var_508_cvector); // 0x347 Func
	Stop(); // 0x349 Func
	StopAsync(); // 0x34b Func
	var_509_bool = 0; // 0x34d PushV
	func_1270(var_51_float, var_509_bool); // 0x34e NEW_2
	var_510_bool = var_509_bool == 0; // 0x350 Not
	if(var_510_bool == 0) goto Label_873; // 0x351 JumpB
	var_511_bool = 0; var_512_object = Obj(); // 0x352 PushV
	var_512_object = var_0_object; // 0x353 MovT
	func_1980(var_511_bool, var_512_object); // 0x354 NEW_2
	var_513_bool = var_511_bool == 0; // 0x356 Not
	if(var_513_bool == 0) goto Label_857; // 0x357 JumpB
...
Label_857:
	...
	var_514_float = var_29_float * var_29_float; // 0x35f Mult
	var_515_bool = var_48_float < var_514_float; // 0x360 LT
	if(var_515_bool == 0) goto Label_873; // 0x361 JumpB
	var_516_bool = 0; var_517_float = 0; // 0x362 PushV
	var_517_float = var_29_float; // 0x363 Mov
	func_974(var_51_float, var_516_bool, var_517_float); // 0x364 NEW_2
	var_518_bool = var_516_bool == 0; // 0x366 Not
	if(var_518_bool == 0) goto Label_873; // 0x367 JumpB
	goto Label_883; // 0x368 Jump
	
Label_874:
	var_519_bool = 0; var_520_float = 0; // 0x36a PushV
	var_520_float = var_29_float; // 0x36b Mov
	func_974(var_51_float, var_519_bool, var_520_float); // 0x36c NEW_2
	var_521_bool = var_519_bool == 0; // 0x36e Not
	if(var_521_bool == 0) goto Label_881; // 0x36f JumpB
...
func_2463()
{
	var_79_string = "oob9Doberman2"; // 0x9a0 PushS
	var_80_int = 1; // 0x9a1 PushI
	SetVariable(var_79_string, var_80_int); // 0x9a2 Func
...
func_2210()
{
	var_188_bool = 0; var_189_bool = 0; // 0x8a2 PushV
	var_190_bool = 1; // 0x8a3 PushB
	CameraSwitchToNormal(var_190_bool); // 0x8a4 Func
	var_191_bool = 0; // 0x8a6 PushV
	func_2771(var_191_bool); // 0x8a7 NEW_2
	if(var_191_bool == 0) goto Label_2219; // 0x8a9 JumpB
...
Label_2219:
	var_192_string = "head"; // 0x8ab PushS
	HasAnimationTrack(var_189_bool, var_192_string); // 0x8ac Func
	var_193_bool = var_189_bool; // 0x8ae Push
	if(var_193_bool == 0) goto Label_2227; // 0x8af JumpB
	var_194_string = "head"; // 0x8b0 PushS
	UnlookAsync(var_194_string); // 0x8b1 Func
}


func_2469()
{
	func_2582(); // 0x9a7 NEW_2
...
func_935(var_0_object, var_385_float, var_386_int)
{
	...
	var_464_int = 0; // 0x3c2 PushV
	func_1318(var_464_int); // 0x3c3 NEW_2
	ReportHit(var_0_object, var_464_int, var_392_float, var_391_float); // 0x3c5 Func
	var_465_object = Obj(); var_466_float = 0; // 0x3c7 PushV
	var_465_object = var_390_object; // 0x3c8 Mov
	var_466_float = var_392_float; // 0x3c9 Mov
...
func_2474()
{
	var_59_string = "b9q01DankoFree"; // 0x9ab PushS
	var_60_int = 1; // 0x9ac PushI
	SetVariable(var_59_string, var_60_int); // 0x9ad Func
	func_2595(); // 0x9b0 NEW_2
	var_69_bool = 0; var_70_string = ""; var_71_string = ""; // 0x9b2 PushV
	var_70_string = "quest_b9_01"; // 0x9b3 MovS
	var_71_string = "danko_free"; // 0x9b4 MovS
	func_2419(var_69_bool, var_70_string, var_71_string); // 0x9b5 NEW_2
...
{
	var_171_bool = 0; var_172_float = 0; var_173_float = 0; var_174_bool = 0; var_175_float = 0; var_176_float = 0; // 0x8b4 PushV
	lshHasAnimation(var_174_bool, var_170_string); // 0x8b5 Func
	var_177_bool = var_174_bool; // 0x8b7 Push
	if(var_177_bool == 0) goto Label_2239; // 0x8b8 JumpB
	lshGetAnimTimes(var_170_string, var_175_float, var_176_float); // 0x8b9 Func
	var_178_bool = 0; // 0x8bb PushB
	lshPlayAnimation(var_175_float, var_176_float, var_178_bool); // 0x8bc Func
...
Label_2239:
	var_179_string = "Can't find lsh animation : "; // 0x8bf PushS
	var_180_int = var_179_string + var_170_string; // 0x8c0 Add
	Trace(var_180_int); // 0x8c1 Func
}


func_2488()
{
	var_91_string = "playsound"; // 0x9b9 PushS
	var_92_string = "giveitem"; // 0x9ba PushS
	TriggerWorld(var_91_string, var_92_string); // 0x9bb Func
...
{
	var_125_int = 0; var_126_string = ""; // 0x9bf PushV
	var_126_string = "b9q01"; // 0x9c0 MovS
	func_2352(var_125_int, var_126_string); // 0x9c1 NEW_2
	var_127_int = 2; // 0x9c3 PushI
	var_128_bool = var_125_int == var_127_int; // 0x9c4 Eq
	if(var_128_bool == 0) goto Label_2504; // 0x9c5 JumpB
	var_123_bool = 1; // 0x9c6 MovB
	return 0; // 0x9c7 Return
	
Label_2504:
	var_123_bool = 0; // 0x9c8 MovB
...
func_1729(var_45_string)
{
	...
	func_2277(var_46_string); // 0x6ce NEW_2
...
{
	var_97_bool = 0; // 0xc3 PushV
	func_2771(var_97_bool); // 0xc4 NEW_2
	var_98_bool = var_97_bool == 0; // 0xc6 Not
	if(var_98_bool == 0) goto Label_201; // 0xc7 JumpB
	return 0; // 0xc8 Return
	
Label_201:
	var_99_bool = var_96_string == var_2_object; // 0xc9 Eq
	if(var_99_bool == 0) goto Label_204; // 0xca JumpB
	return 0; // 0xcb Return
	
Label_204:
	var_100_string = ""; var_101_bool = 0; // 0xcc PushV
	var_100_string = var_96_string; // 0xcd Mov
	var_102_string = ""; // 0xce PushS
	var_103_bool = var_96_string == var_102_string; // 0xcf Eq
	if(var_103_bool == 0) goto Label_211; // 0xd0 JumpB
	var_101_bool = 0; // 0xd1 MovB
	goto Label_212; // 0xd2 Jump
	
Label_212:
	func_2244(var_100_string, var_101_bool); // 0xd4 NEW_2
	var_2_object = var_96_string; // 0xd6 TMov
	return 0; // 0xd7 Return
	
Label_211:
	var_101_bool = 1; // 0xd3 MovB
}


func_2244(var_100_string, var_101_bool)
{
	var_104_bool = 0; var_105_float = 0; var_106_float = 0; var_107_bool = 0; var_108_float = 0; var_109_float = 0; // 0x8c4 PushV
	lshHasAnimation(var_107_bool, var_100_string); // 0x8c5 Func
	var_110_bool = var_107_bool; // 0x8c7 Push
	if(var_110_bool == 0) goto Label_2254; // 0x8c8 JumpB
	lshGetAnimTimes(var_100_string, var_108_float, var_109_float); // 0x8c9 Func
	lshPlayAnimation(var_108_float, var_109_float, var_101_bool); // 0x8cb Func
...
Label_2254:
	var_111_string = "Can't find lsh animation : "; // 0x8ce PushS
	var_112_int = var_111_string + var_100_string; // 0x8cf Add
	Trace(var_112_int); // 0x8d0 Func
}
...
{
	var_140_bool = 0; var_141_object = Obj(); // 0x9cb PushV
	var_141_object = var_139_object; // 0x9cc Mov
	func_2575(var_141_object); // 0x9cd NEW_2
	if(var_140_bool == 0) goto Label_2514; // 0x9cf JumpB
	var_138_bool = 1; // 0x9d0 MovB
	return 0; // 0x9d1 Return
	
Label_2514:
	var_138_bool = 0; // 0x9d2 MovB
...
Label_1010:
	...
	var_467_string = "all"; // 0x3f7 PushS
	var_468_string = "attack_middle"; // 0x3f8 PushS
	var_469_int = var_468_string + var_354_int; // 0x3f9 Add
	HasAnimation(var_355_bool, var_467_string, var_469_int); // 0x3fa Func
	var_470_bool = var_355_bool; // 0x3fc Push
	if(var_470_bool == 0) goto Label_1091; // 0x3fd JumpB
	func_2440(); // 0x3ff NEW_2
	var_471_string = "all"; // 0x401 PushS
	var_472_string = "attack_middle"; // 0x402 PushS
	var_473_int = var_472_string + var_354_int; // 0x403 Add
	PlayAnimation(var_471_string, var_473_int); // 0x404 Func
	WaitForAnimEnd(); // 0x406 Func
	func_1313(var_357_string); // 0x409 NEW_2
	var_474_bool = 0; var_475_object = Obj(); // 0x40b PushV
	var_475_object = var_0_object; // 0x40c MovT
	func_1980(var_474_bool, var_475_object); // 0x40d NEW_2
	var_476_bool = var_474_bool == 0; // 0x40f Not
	if(var_476_bool == 0) goto Label_1045; // 0x410 JumpB
	StopAsync(); // 0x411 Func
	var_348_bool = 0; // 0x413 MovB
	return 8; // 0x414 Return
	
Label_1045:
	var_477_float = 0; var_478_int = 0; // 0x415 PushV
	var_477_float = var_349_float; // 0x416 Mov
	var_478_int = var_354_int; // 0x417 Mov
	func_935(var_357_string, var_477_float, var_478_int); // 0x418 NEW_2
	var_356_int = 1; // 0x41a MovI
	
Label_1051:
	var_479_string = "attack_middle"; // 0x41b PushS
	var_480_int = var_479_string + var_354_int; // 0x41c Add
	var_481_string = "_"; // 0x41d PushS
	var_482_int = var_480_int + var_481_string; // 0x41e Add
	var_357_string = var_482_int + var_356_int; // 0x41f Add2
	var_483_string = "all"; // 0x420 PushS
	HasAnimation(var_355_bool, var_483_string, var_357_string); // 0x421 Func
	var_484_bool = var_355_bool == 0; // 0x423 Not
	if(var_484_bool == 0) goto Label_1062; // 0x424 JumpB
	goto Label_1091; // 0x425 Jump
	
Label_1091:
	var_485_bool = 0; // 0x443 PushB
	SetAttackState(var_485_bool); // 0x444 Func
	var_486_string = "all"; // 0x446 PushS
	var_487_string = "attack_end"; // 0x447 PushS
	var_488_int = var_487_string + var_354_int; // 0x448 Add
	PlayAnimation(var_486_string, var_488_int); // 0x449 Func
	var_489_bool = 0; // 0x44b PushV
	func_1327(var_489_bool); // 0x44c NEW_2
	if(var_489_bool == 0) goto Label_1109; // 0x44e JumpB
	var_490_bool = 0; var_491_float = 0; // 0x44f PushV
	var_491_float = 0.75; // 0x450 MovF
	func_1111(var_490_bool, var_491_float); // 0x451 NEW_2
...
Label_1062:
	func_2440(); // 0x427 NEW_2
	var_499_string = "all"; // 0x429 PushS
	PlayAnimation(var_499_string, var_357_string); // 0x42a Func
	WaitForAnimEnd(); // 0x42c Func
	func_1313(var_357_string); // 0x42f NEW_2
	var_500_bool = 0; var_501_object = Obj(); // 0x431 PushV
	var_501_object = var_0_object; // 0x432 MovT
	func_1980(var_500_bool, var_501_object); // 0x433 NEW_2
	var_502_bool = var_500_bool == 0; // 0x435 Not
	if(var_502_bool == 0) goto Label_1083; // 0x436 JumpB
	StopAsync(); // 0x437 Func
	var_348_bool = 0; // 0x439 MovB
	return 8; // 0x43a Return
	
Label_1083:
	var_503_float = 0; var_504_int = 0; // 0x43b PushV
	var_503_float = var_349_float; // 0x43c Mov
	var_504_int = var_354_int; // 0x43d Mov
	func_935(var_357_string, var_503_float, var_504_int); // 0x43e NEW_2
	var_505_int = 1; // 0x440 PushI
	var_356_int = var_356_int + var_505_int; // 0x441 Add2
...
{
	var_78_string = "ui/NPC_Citizen2.png"; // 0xacf MovS
...
{
	var_79_string = "ui/NPC_Citizen2_b.png"; // 0xad1 MovS
...
{
	var_148_float = 0; var_149_cvector = CVector(0,0,0); var_150_float = 0; var_151_cvector = CVector(0,0,0); // 0x8d3 PushV
	GetEyesHeight(var_150_float); // 0x8d4 ObjFunc
	var_151_cvector = CVector(0.0, 0.0, 0.0); // 0x8d6 MovV
	var_152_float = GetByIndex(var_151_cvector, 1); // 0x8d7 PushE
	var_152_float = var_150_float; // 0x8d8 Mov
	SetByIndex(var_151_cvector, 1) = var_152_float; // 0x8d9 PopE
	var_153_string = "head"; // 0x8da PushS
	LookAsync(var_147_object, var_153_string, var_151_cvector); // 0x8db Func
...
{
	var_16_object = Obj(); // 0xad6 PushV
	var_16_object = var_15_object; // 0xad7 Mov
	TaskCall(4); // 0xad8 TaskCall
	func_1589(var_16_object); // 0xad9 NEW_2
	TaskReturn(); // 0xada TaskReturn
...
{
	var_117_int = 0; var_118_string = ""; // 0x9d5 PushV
	var_118_string = "oob9Doberman1"; // 0x9d6 MovS
	func_2352(var_117_int, var_118_string); // 0x9d7 NEW_2
	var_121_int = 0; // 0x9d9 PushI
	var_122_bool = var_117_int == var_121_int; // 0x9da Eq
	if(var_122_bool == 0) goto Label_2526; // 0x9db JumpB
	var_115_bool = 1; // 0x9dc MovB
	return 0; // 0x9dd Return
	
Label_2526:
	var_115_bool = 0; // 0x9de MovB
...
func_2270()
{
	var_17_bool = 0; // 0x8de PushV
	func_2771(var_17_bool); // 0x8df NEW_2
	if(var_17_bool == 0) goto Label_2276; // 0x8e1 JumpB
...
{
	var_148_int = 0; var_149_string = ""; // 0x9e1 PushV
	var_149_string = "oob9Doberman2"; // 0x9e2 MovS
	func_2352(var_148_int, var_149_string); // 0x9e3 NEW_2
	var_150_int = 0; // 0x9e5 PushI
	var_151_bool = var_148_int == var_150_int; // 0x9e6 Eq
	if(var_151_bool == 0) goto Label_2538; // 0x9e7 JumpB
	var_146_bool = 1; // 0x9e8 MovB
	return 0; // 0x9e9 Return
	
Label_2538:
	var_146_bool = 0; // 0x9ea MovB
...
{
	var_47_bool = 0; var_48_int = 0; var_49_bool = 0; var_50_int = 0; var_51_bool = 0; var_52_float = 0; var_53_cvector = CVector(0,0,0); var_54_cvector = CVector(0,0,0); var_55_bool = 0; var_56_int = 0; var_57_bool = 0; var_58_int = 0; var_59_bool = 0; var_60_float = 0; var_61_cvector = CVector(0,0,0); var_62_cvector = CVector(0,0,0); // 0x8e5 PushV
	IsExisting3DSound(var_55_bool, var_46_string); // 0x8e6 Func
	var_63_bool = var_55_bool == 0; // 0x8e8 Not
	if(var_63_bool == 0) goto Label_2302; // 0x8e9 JumpB
	var_56_int = 0; // 0x8ea MovI
	
Label_2283:
	var_64_int = 1; // 0x8eb PushI
	var_65_int = var_56_int + var_64_int; // 0x8ec Add
	var_66_int = var_46_string + var_65_int; // 0x8ed Add
	IsExisting3DSound(var_57_bool, var_66_int); // 0x8ee Func
	var_67_bool = var_57_bool == 0; // 0x8f0 Not
	if(var_67_bool == 0) goto Label_2291; // 0x8f1 JumpB
	goto Label_2294; // 0x8f2 Jump
	
Label_2294:
	var_68_bool = var_56_int == 0; // 0x8f6 Not
	if(var_68_bool == 0) goto Label_2297; // 0x8f7 JumpB
	return 16; // 0x8f8 Return
	
Label_2297:
	irand(var_58_int, var_56_int); // 0x8f9 Func
	var_69_int = 1; // 0x8fb PushI
	var_70_int = var_58_int + var_69_int; // 0x8fc Add
	var_46_string = var_46_string + var_70_int; // 0x8fd Add2
	
Label_2302:
	Is3DSoundLoaded(var_59_bool, var_46_string); // 0x8fe Func
	var_71_bool = var_59_bool; // 0x900 Push
	if(var_71_bool == 0) goto Label_2317; // 0x901 JumpB
	GetEyesHeight(var_60_float); // 0x902 Func
	GetDirection(var_61_cvector); // 0x904 Func
	var_72_int = 50; // 0x906 PushI
	var_62_cvector = var_61_cvector * var_72_int; // 0x907 Mult2
	var_73_float = GetByIndex(var_62_cvector, 1); // 0x908 PushE
	var_73_float = var_73_float + var_60_float; // 0x909 Add2
	SetByIndex(var_62_cvector, 1) = var_73_float; // 0x90a PopE
	PlayGlobalSound(var_46_string, var_62_cvector); // 0x90b Func
	
Label_2317:
	return 16; // 0x90d Return
	
Label_2291:
	var_74_int = 1; // 0x8f3 PushI
	var_56_int = var_56_int + var_74_int; // 0x8f4 Add2
...
{
	var_190_bool = 0; // 0x9ed PushV
	var_190_bool = 0; // 0x9ee MovB
	var_191_int = 0; var_192_string = ""; // 0x9ef PushV
	var_192_string = "b1q03_retreat"; // 0x9f0 MovS
	func_2352(var_191_int, var_192_string); // 0x9f1 NEW_2
	var_193_int = 0; // 0x9f3 PushI
	var_194_bool = var_191_int != var_193_int; // 0x9f4 Neq
	if(var_194_bool == 0) goto Label_2558; // 0x9f5 JumpB
	var_195_int = 0; var_196_string = ""; // 0x9f6 PushV
	var_196_string = "b1q03_dead"; // 0x9f7 MovS
	func_2352(var_195_int, var_196_string); // 0x9f8 NEW_2
	var_197_int = 0; // 0x9fa PushI
	var_198_bool = var_195_int == var_197_int; // 0x9fb Eq
	if(var_198_bool == 0) goto Label_2558; // 0x9fc JumpB
	var_190_bool = 1; // 0x9fd MovB
	
Label_2558:
	if(var_190_bool == 0) goto Label_2561; // 0x9fe JumpB
	var_188_bool = 1; // 0x9ff MovB
	return 0; // 0xa00 Return
	
Label_2561:
	var_188_bool = 0; // 0xa01 MovB
