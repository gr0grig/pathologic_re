...
0x3e6: Push("Can't find lsh animation : ")
...
0x43b: Stack[-1] = "ui/NPC_Spi4ka.png"
0x43c: Return(); Pop(0)

0x43d: Stack[-1] = "ui/NPC_Spi4ka_b.png"
0x43e: Return(); Pop(0)
...
0x441: PushEmpty()
0x442: Push("oob9Spi4ka_Kapella1")
0x443: Push((int) 1)
...
0x449: Stack[-1] = "oob9Spi4ka_Kapella1"
0x44a: Call2 0x411
