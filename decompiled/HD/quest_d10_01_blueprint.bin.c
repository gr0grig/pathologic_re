task_0_event_26(var_0_bool, var_1_string)
{
	...
	func_166(var_7_object); // 0x17 NEW_2
...
Label_63:
	...
	func_32(var_60_object); // 0x4e NEW_2
...
{
	var_61_bool = 0; var_62_string = ""; var_63_string = ""; // 0x21 PushV
	var_62_string = "quest_d10_01"; // 0x22 MovS
	var_63_string = "soldier_fight"; // 0x23 MovS
	func_201(var_61_bool, var_62_string, var_63_string); // 0x24 NEW_2
	var_67_object = Obj(); // 0x26 PushV
	var_67_object = var_60_object; // 0x27 Mov
	func_82(); // 0x28 NEW_2
...
func_5()
{
	...
	func_166(var_2_object); // 0x8 NEW_2
