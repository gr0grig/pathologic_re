...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1513(var_12_object); // 0x2fc NEW_2
...
{
	var_9_object = Obj(); // 0x5fd PushV
	func_1462(var_9_object); // 0x5fe NEW_2
	RemoveActor(var_9_object); // 0x600 Func
	Hold(); // 0x602 Func
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x60e PushV
	var_13_object = var_9_object; // 0x60f Mov
	var_14_int = var_10_int; // 0x610 Mov
	var_15_float = var_11_float; // 0x611 Mov
	func_1317(var_13_object, var_14_int, var_15_float); // 0x612 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x616 PushV
	var_15_object = var_9_object; // 0x617 Mov
	var_16_int = var_10_int; // 0x618 Mov
	var_17_float = var_11_float; // 0x619 Mov
	var_18_cvector = var_13_cvector; // 0x61a Mov
	var_19_cvector = var_14_cvector; // 0x61b Mov
	func_1385(var_17_float, var_18_cvector, var_19_cvector); // 0x61c NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x61f PushV
	var_13_string = "health"; // 0x620 PushS
	var_14_bool = var_10_string == var_13_string; // 0x621 Eq
	if(var_14_bool == 0) goto Label_1579; // 0x622 JumpB
	var_15_string = "health"; // 0x623 PushS
	GetProperty(var_15_string, var_12_float); // 0x624 Func
	var_16_int = 0; // 0x626 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x627 LE
	if(var_17_bool == 0) goto Label_1579; // 0x628 JumpB
	SignalDeath(var_9_object); // 0x629 Func
...
{
	var_10_object = Obj(); // 0x62d PushV
	var_10_object = var_9_object; // 0x62e Mov
	func_1541(var_10_object); // 0x62f NEW_2
...
{
	var_11_object = Obj(); // 0x606 PushV
	var_11_object = var_10_object; // 0x607 Mov
	TaskCall(3); // 0x608 TaskCall
	func_965(var_11_object); // 0x609 NEW_2
	TaskReturn(); // 0x60a TaskReturn
...
Label_29:
	...
	var_515_int = 1; // 0x23 PushI
	Sleep(var_515_int); // 0x24 Func
...
Label_203:
	...
	var_499_string = "all"; // 0xcd PushS
	var_500_string = "fjump"; // 0xce PushS
	PlayAnimation(var_499_string, var_500_string); // 0xcf Func
	WaitForAnimEnd(); // 0xd1 Func
	func_689(var_44_float); // 0xd4 NEW_2
	var_501_cvector = CVector(0.0, 0.0, 0.0); // 0xd6 PushVec
	SetSpeed(var_501_cvector); // 0xd7 Func
	Stop(); // 0xd9 Func
	StopAsync(); // 0xdb Func
	var_502_bool = 0; // 0xdd PushV
	func_646(var_44_float, var_502_bool); // 0xde NEW_2
	var_503_bool = var_502_bool == 0; // 0xe0 Not
	if(var_503_bool == 0) goto Label_249; // 0xe1 JumpB
	var_504_bool = 0; var_505_object = Obj(); // 0xe2 PushV
	var_505_object = var_0_object; // 0xe3 MovT
	func_1249(var_504_bool, var_505_object); // 0xe4 NEW_2
...
Label_233:
	...
	var_507_float = var_22_float * var_22_float; // 0xef Mult
	var_508_bool = var_41_float < var_507_float; // 0xf0 LT
	if(var_508_bool == 0) goto Label_249; // 0xf1 JumpB
	var_509_bool = 0; var_510_float = 0; // 0xf2 PushV
	var_510_float = var_22_float; // 0xf3 Mov
	func_350(var_44_float, var_509_bool, var_510_float); // 0xf4 NEW_2
	var_511_bool = var_509_bool == 0; // 0xf6 Not
	if(var_511_bool == 0) goto Label_249; // 0xf7 JumpB
	goto Label_259; // 0xf8 Jump
	
Label_250:
	var_512_bool = 0; var_513_float = 0; // 0xfa PushV
	var_513_float = var_22_float; // 0xfb Mov
	func_350(var_44_float, var_512_bool, var_513_float); // 0xfc NEW_2
	var_514_bool = var_512_bool == 0; // 0xfe Not
	if(var_514_bool == 0) goto Label_257; // 0xff JumpB
...
func_689(var_0_object)
{
	...
	func_1513(var_116_object); // 0x2b3 NEW_2
...
func_311(var_0_object, var_378_float, var_379_int)
{
	...
	var_457_int = 0; // 0x152 PushV
	func_694(var_457_int); // 0x153 NEW_2
	ReportHit(var_0_object, var_457_int, var_385_float, var_384_float); // 0x155 Func
	var_458_object = Obj(); var_459_float = 0; // 0x157 PushV
	var_458_object = var_383_object; // 0x158 Mov
	var_459_float = var_385_float; // 0x159 Mov
...
func_709(var_2_int, var_123_bool, var_124_object, var_125_float, var_126_float, var_127_bool, var_128_bool)
{
	...
	func_1513(var_136_object); // 0x2c8 NEW_2
...
func_1496(var_448_float)
{
	...
	var_451_int = 0; // 0x5dd PushI
	var_452_bool = var_448_float < var_451_int; // 0x5de LT
	if(var_452_bool == 0) goto Label_1508; // 0x5df JumpB
	var_453_float = 0.7; // 0x5e0 PushF
	var_454_int = 500; // 0x5e1 PushI
	RumblePlay(var_453_float, var_454_int); // 0x5e2 Func
	
Label_1508:
	var_455_int = 15; // 0x5e4 PushI
	SendWorldWndMessage(var_455_int, var_450_object); // 0x5e5 Func
...
Label_386:
	...
	var_460_string = "all"; // 0x187 PushS
	var_461_string = "attack_middle"; // 0x188 PushS
	var_462_int = var_461_string + var_347_int; // 0x189 Add
	HasAnimation(var_348_bool, var_460_string, var_462_int); // 0x18a Func
	var_463_bool = var_348_bool; // 0x18c Push
	if(var_463_bool == 0) goto Label_467; // 0x18d JumpB
	func_1522(); // 0x18f NEW_2
	var_464_string = "all"; // 0x191 PushS
	var_465_string = "attack_middle"; // 0x192 PushS
	var_466_int = var_465_string + var_347_int; // 0x193 Add
	PlayAnimation(var_464_string, var_466_int); // 0x194 Func
	WaitForAnimEnd(); // 0x196 Func
	func_689(var_350_string); // 0x199 NEW_2
	var_467_bool = 0; var_468_object = Obj(); // 0x19b PushV
	var_468_object = var_0_object; // 0x19c MovT
	func_1249(var_467_bool, var_468_object); // 0x19d NEW_2
	var_469_bool = var_467_bool == 0; // 0x19f Not
	if(var_469_bool == 0) goto Label_421; // 0x1a0 JumpB
	StopAsync(); // 0x1a1 Func
	var_341_bool = 0; // 0x1a3 MovB
	return 8; // 0x1a4 Return
	
Label_421:
	var_470_float = 0; var_471_int = 0; // 0x1a5 PushV
	var_470_float = var_342_float; // 0x1a6 Mov
	var_471_int = var_347_int; // 0x1a7 Mov
	func_311(var_350_string, var_470_float, var_471_int); // 0x1a8 NEW_2
	var_349_int = 1; // 0x1aa MovI
	
Label_427:
	var_472_string = "attack_middle"; // 0x1ab PushS
	var_473_int = var_472_string + var_347_int; // 0x1ac Add
	var_474_string = "_"; // 0x1ad PushS
	var_475_int = var_473_int + var_474_string; // 0x1ae Add
	var_350_string = var_475_int + var_349_int; // 0x1af Add2
	var_476_string = "all"; // 0x1b0 PushS
	HasAnimation(var_348_bool, var_476_string, var_350_string); // 0x1b1 Func
	var_477_bool = var_348_bool == 0; // 0x1b3 Not
	if(var_477_bool == 0) goto Label_438; // 0x1b4 JumpB
	goto Label_467; // 0x1b5 Jump
	
Label_467:
	var_478_bool = 0; // 0x1d3 PushB
	SetAttackState(var_478_bool); // 0x1d4 Func
	var_479_string = "all"; // 0x1d6 PushS
	var_480_string = "attack_end"; // 0x1d7 PushS
	var_481_int = var_480_string + var_347_int; // 0x1d8 Add
	PlayAnimation(var_479_string, var_481_int); // 0x1d9 Func
	var_482_bool = 0; // 0x1db PushV
	func_703(var_482_bool); // 0x1dc NEW_2
	if(var_482_bool == 0) goto Label_485; // 0x1de JumpB
	var_483_bool = 0; var_484_float = 0; // 0x1df PushV
	var_484_float = 0.75; // 0x1e0 MovF
	func_487(var_483_bool, var_484_float); // 0x1e1 NEW_2
...
Label_438:
	func_1522(); // 0x1b7 NEW_2
	var_492_string = "all"; // 0x1b9 PushS
	PlayAnimation(var_492_string, var_350_string); // 0x1ba Func
	WaitForAnimEnd(); // 0x1bc Func
	func_689(var_350_string); // 0x1bf NEW_2
	var_493_bool = 0; var_494_object = Obj(); // 0x1c1 PushV
	var_494_object = var_0_object; // 0x1c2 MovT
	func_1249(var_493_bool, var_494_object); // 0x1c3 NEW_2
	var_495_bool = var_493_bool == 0; // 0x1c5 Not
	if(var_495_bool == 0) goto Label_459; // 0x1c6 JumpB
	StopAsync(); // 0x1c7 Func
	var_341_bool = 0; // 0x1c9 MovB
	return 8; // 0x1ca Return
	
Label_459:
	var_496_float = 0; var_497_int = 0; // 0x1cb PushV
	var_496_float = var_342_float; // 0x1cc Mov
	var_497_int = var_347_int; // 0x1cd Mov
	func_311(var_350_string, var_496_float, var_497_int); // 0x1ce NEW_2
	var_498_int = 1; // 0x1d0 PushI
	var_349_int = var_349_int + var_498_int; // 0x1d1 Add2
...
{
	var_485_float = 0; var_486_bool = 0; var_487_float = 0; var_488_bool = 0; // 0x1e7 PushV
	rand(var_487_float); // 0x1e8 Func
	var_489_bool = var_487_float < var_484_float; // 0x1ea LT
	if(var_489_bool == 0) goto Label_507; // 0x1eb JumpB
	
Label_492:
	IsAnimationPlaying(var_488_bool); // 0x1ec Func
	var_490_bool = var_488_bool == 0; // 0x1ee Not
	if(var_490_bool == 0) goto Label_497; // 0x1ef JumpB
...
Label_512:
	var_483_bool = 0; // 0x200 MovB
	return 4; // 0x201 Return
	
Label_497:
	var_491_bool = 0; // 0x1f1 PushV
	func_585(var_491_bool); // 0x1f2 NEW_2
	if(var_491_bool == 0) goto Label_503; // 0x1f4 JumpB
	var_483_bool = 1; // 0x1f5 MovB
...
Label_507:
	...
	func_689(var_488_bool); // 0x1fe NEW_2
}


func_1513(var_12_object)
{
	var_13_bool = 0; var_14_bool = 0; // 0x5e9 PushV
	IsPlayerActor(var_12_object, var_14_bool); // 0x5ea Func
	var_15_bool = var_14_bool; // 0x5ec Push
	if(var_15_bool == 0) goto Label_1521; // 0x5ed JumpB
	var_16_string = "attack"; // 0x5ee PushS
	PlayGlobalMusic(var_16_string); // 0x5ef Func
...
Label_1154:
	var_456_string = "armor"; // 0x482 PushS
	GetProperty(var_456_string, var_405_int); // 0x483 ObjFunc
}


func_1522()
{
	var_353_object = Obj(); var_354_object = Obj(); // 0x5f2 PushV
	GetScene(var_354_object); // 0x5f3 Func
	var_355_string = "battle"; // 0x5f5 PushS
	var_356_object = Obj(); // 0x5f6 PushV
	func_1462(var_356_object); // 0x5f7 NEW_2
	BroadcastMessage(var_355_string, var_356_object, var_354_object); // 0x5f9 Func
