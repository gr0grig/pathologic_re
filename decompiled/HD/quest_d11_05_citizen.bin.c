...
task_1_event_0(var_0_object, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool)
{
	...
	func_1824(var_13_object); // 0xa6 NEW_2
...
task_3_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1716(var_12_object); // 0x403 NEW_2
...
event_22(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object, var_10_int, var_11_float, var_12_float)
{
	...
	func_1470(var_13_object, var_14_int, var_15_float); // 0x6ed NEW_2
...
event_43(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object, var_10_int, var_11_float, var_12_float, var_13_cvector, var_14_cvector)
{
	...
	func_1538(var_17_float, var_18_cvector, var_19_cvector); // 0x6f7 NEW_2
...
Label_1307:
	var_466_string = "armor"; // 0x51b PushS
	GetProperty(var_466_string, var_415_int); // 0x51c ObjFunc
}
...
func_1805(var_14_bool, var_15_object)
{
	...
	func_1402(var_16_bool, var_17_object); // 0x710 NEW_2
...
func_1812(var_50_object)
{
	...
	func_1837(var_51_object); // 0x717 NEW_2
...
func_1689(var_458_float)
{
	...
	var_461_int = 0; // 0x69e PushI
	var_462_bool = var_458_float < var_461_int; // 0x69f LT
	if(var_462_bool == 0) goto Label_1701; // 0x6a0 JumpB
	var_463_float = 0.7; // 0x6a1 PushF
	var_464_int = 500; // 0x6a2 PushI
	RumblePlay(var_463_float, var_464_int); // 0x6a3 Func
	
Label_1701:
	var_465_int = 15; // 0x6a5 PushI
	SendWorldWndMessage(var_465_int, var_460_object); // 0x6a6 Func
...
{
	var_15_int = 0; var_16_int = 0; // 0x71a PushV
	var_17_string = "branch"; // 0x71b PushS
	GetVariable(var_17_string, var_16_int); // 0x71c Func
	var_14_int = var_16_int; // 0x71e Mov
...
Label_293:
	...
	var_525_int = 1; // 0x12b PushI
	Sleep(var_525_int); // 0x12c Func
...
{
	var_52_object = Obj(); var_53_object = Obj(); // 0x72d PushV
	GetScene(var_53_object); // 0x72e Func
	var_54_object = Obj(); // 0x730 PushV
	func_1620(var_54_object); // 0x731 NEW_2
	RemoveStationaryActor(var_54_object); // 0x733 ObjFunc
	var_57_object = Obj(); // 0x735 PushV
	var_57_object = var_51_object; // 0x736 Mov
	TaskCall(2); // 0x737 TaskCall
	func_292(var_57_object); // 0x738 NEW_2
...
Label_466:
	...
	var_509_string = "all"; // 0x1d4 PushS
	var_510_string = "fjump"; // 0x1d5 PushS
	PlayAnimation(var_509_string, var_510_string); // 0x1d6 Func
	WaitForAnimEnd(); // 0x1d8 Func
	func_952(var_88_float); // 0x1db NEW_2
	var_511_cvector = CVector(0.0, 0.0, 0.0); // 0x1dd PushVec
	SetSpeed(var_511_cvector); // 0x1de Func
	Stop(); // 0x1e0 Func
	StopAsync(); // 0x1e2 Func
	var_512_bool = 0; // 0x1e4 PushV
	func_909(var_88_float, var_512_bool); // 0x1e5 NEW_2
	var_513_bool = var_512_bool == 0; // 0x1e7 Not
	if(var_513_bool == 0) goto Label_512; // 0x1e8 JumpB
	var_514_bool = 0; var_515_object = Obj(); // 0x1e9 PushV
	var_515_object = var_0_object; // 0x1ea MovT
	func_1402(var_514_bool, var_515_object); // 0x1eb NEW_2
	var_516_bool = var_514_bool == 0; // 0x1ed Not
	if(var_516_bool == 0) goto Label_496; // 0x1ee JumpB
...
Label_496:
	...
	var_517_float = var_66_float * var_66_float; // 0x1f6 Mult
	var_518_bool = var_85_float < var_517_float; // 0x1f7 LT
	if(var_518_bool == 0) goto Label_512; // 0x1f8 JumpB
	var_519_bool = 0; var_520_float = 0; // 0x1f9 PushV
	var_520_float = var_66_float; // 0x1fa Mov
	func_613(var_88_float, var_519_bool, var_520_float); // 0x1fb NEW_2
	var_521_bool = var_519_bool == 0; // 0x1fd Not
	if(var_521_bool == 0) goto Label_512; // 0x1fe JumpB
	goto Label_522; // 0x1ff Jump
	
Label_513:
	var_522_bool = 0; var_523_float = 0; // 0x201 PushV
	var_523_float = var_66_float; // 0x202 Mov
	func_613(var_88_float, var_522_bool, var_523_float); // 0x203 NEW_2
	var_524_bool = var_522_bool == 0; // 0x205 Not
	if(var_524_bool == 0) goto Label_520; // 0x206 JumpB
...
func_952(var_0_object)
{
	...
	func_1716(var_126_object); // 0x3ba NEW_2
...
func_1725()
{
	var_363_object = Obj(); var_364_object = Obj(); // 0x6bd PushV
	GetScene(var_364_object); // 0x6be Func
	var_365_string = "battle"; // 0x6c0 PushS
	var_366_object = Obj(); // 0x6c1 PushV
	func_1620(var_366_object); // 0x6c2 NEW_2
	BroadcastMessage(var_365_string, var_366_object, var_364_object); // 0x6c4 Func
...
func_574(var_0_object, var_388_float, var_389_int)
{
	...
	var_467_int = 0; // 0x259 PushV
	func_957(var_467_int); // 0x25a NEW_2
	ReportHit(var_0_object, var_467_int, var_395_float, var_394_float); // 0x25c Func
	var_468_object = Obj(); var_469_float = 0; // 0x25e PushV
	var_468_object = var_393_object; // 0x25f Mov
	var_469_float = var_395_float; // 0x260 Mov
...
func_972(var_2_int, var_133_bool, var_134_object, var_135_float, var_136_float, var_137_bool, var_138_bool)
{
	...
	func_1716(var_146_object); // 0x3cf NEW_2
...
Label_649:
	...
	var_470_string = "all"; // 0x28e PushS
	var_471_string = "attack_middle"; // 0x28f PushS
	var_472_int = var_471_string + var_357_int; // 0x290 Add
	HasAnimation(var_358_bool, var_470_string, var_472_int); // 0x291 Func
	var_473_bool = var_358_bool; // 0x293 Push
	if(var_473_bool == 0) goto Label_730; // 0x294 JumpB
	func_1725(); // 0x296 NEW_2
	var_474_string = "all"; // 0x298 PushS
	var_475_string = "attack_middle"; // 0x299 PushS
	var_476_int = var_475_string + var_357_int; // 0x29a Add
	PlayAnimation(var_474_string, var_476_int); // 0x29b Func
	WaitForAnimEnd(); // 0x29d Func
	func_952(var_360_string); // 0x2a0 NEW_2
	var_477_bool = 0; var_478_object = Obj(); // 0x2a2 PushV
	var_478_object = var_0_object; // 0x2a3 MovT
	func_1402(var_477_bool, var_478_object); // 0x2a4 NEW_2
	var_479_bool = var_477_bool == 0; // 0x2a6 Not
	if(var_479_bool == 0) goto Label_684; // 0x2a7 JumpB
	StopAsync(); // 0x2a8 Func
	var_351_bool = 0; // 0x2aa MovB
	return 8; // 0x2ab Return
	
Label_684:
	var_480_float = 0; var_481_int = 0; // 0x2ac PushV
	var_480_float = var_352_float; // 0x2ad Mov
	var_481_int = var_357_int; // 0x2ae Mov
	func_574(var_360_string, var_480_float, var_481_int); // 0x2af NEW_2
	var_359_int = 1; // 0x2b1 MovI
	
Label_690:
	var_482_string = "attack_middle"; // 0x2b2 PushS
	var_483_int = var_482_string + var_357_int; // 0x2b3 Add
	var_484_string = "_"; // 0x2b4 PushS
	var_485_int = var_483_int + var_484_string; // 0x2b5 Add
	var_360_string = var_485_int + var_359_int; // 0x2b6 Add2
	var_486_string = "all"; // 0x2b7 PushS
	HasAnimation(var_358_bool, var_486_string, var_360_string); // 0x2b8 Func
	var_487_bool = var_358_bool == 0; // 0x2ba Not
	if(var_487_bool == 0) goto Label_701; // 0x2bb JumpB
	goto Label_730; // 0x2bc Jump
	
Label_730:
	var_488_bool = 0; // 0x2da PushB
	SetAttackState(var_488_bool); // 0x2db Func
	var_489_string = "all"; // 0x2dd PushS
	var_490_string = "attack_end"; // 0x2de PushS
	var_491_int = var_490_string + var_357_int; // 0x2df Add
	PlayAnimation(var_489_string, var_491_int); // 0x2e0 Func
	var_492_bool = 0; // 0x2e2 PushV
	func_966(var_492_bool); // 0x2e3 NEW_2
	if(var_492_bool == 0) goto Label_748; // 0x2e5 JumpB
	var_493_bool = 0; var_494_float = 0; // 0x2e6 PushV
	var_494_float = 0.75; // 0x2e7 MovF
	func_750(var_493_bool, var_494_float); // 0x2e8 NEW_2
...
Label_701:
	func_1725(); // 0x2be NEW_2
	var_502_string = "all"; // 0x2c0 PushS
	PlayAnimation(var_502_string, var_360_string); // 0x2c1 Func
	WaitForAnimEnd(); // 0x2c3 Func
	func_952(var_360_string); // 0x2c6 NEW_2
	var_503_bool = 0; var_504_object = Obj(); // 0x2c8 PushV
	var_504_object = var_0_object; // 0x2c9 MovT
	func_1402(var_503_bool, var_504_object); // 0x2ca NEW_2
	var_505_bool = var_503_bool == 0; // 0x2cc Not
	if(var_505_bool == 0) goto Label_722; // 0x2cd JumpB
	StopAsync(); // 0x2ce Func
	var_351_bool = 0; // 0x2d0 MovB
	return 8; // 0x2d1 Return
	
Label_722:
	var_506_float = 0; var_507_int = 0; // 0x2d2 PushV
	var_506_float = var_352_float; // 0x2d3 Mov
	var_507_int = var_357_int; // 0x2d4 Mov
	func_574(var_360_string, var_506_float, var_507_int); // 0x2d5 NEW_2
	var_508_int = 1; // 0x2d7 PushI
	var_359_int = var_359_int + var_508_int; // 0x2d8 Add2
...
{
	var_495_float = 0; var_496_bool = 0; var_497_float = 0; var_498_bool = 0; // 0x2ee PushV
	rand(var_497_float); // 0x2ef Func
	var_499_bool = var_497_float < var_494_float; // 0x2f1 LT
	if(var_499_bool == 0) goto Label_770; // 0x2f2 JumpB
	
Label_755:
	IsAnimationPlaying(var_498_bool); // 0x2f3 Func
	var_500_bool = var_498_bool == 0; // 0x2f5 Not
	if(var_500_bool == 0) goto Label_760; // 0x2f6 JumpB
...
Label_775:
	var_493_bool = 0; // 0x307 MovB
	return 4; // 0x308 Return
	
Label_760:
	var_501_bool = 0; // 0x2f8 PushV
	func_848(var_501_bool); // 0x2f9 NEW_2
	if(var_501_bool == 0) goto Label_766; // 0x2fb JumpB
	var_493_bool = 1; // 0x2fc MovB
...
Label_770:
	...
	func_952(var_498_bool); // 0x305 NEW_2
}
...
Label_1675:
	...
	func_1706(var_23_float); // 0x68d NEW_2
