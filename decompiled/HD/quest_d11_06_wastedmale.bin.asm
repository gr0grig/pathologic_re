...
0x26f: Stack[-1] = "ui/NPC_Citizen3.png"
0x270: Return(); Pop(0)

0x271: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x272: Return(); Pop(0)
...
0x296: Stack[-2] = "quest_d11_06"
0x297: Stack[-1] = "place_maria"
0x298: Call2 0x25f
...
0x29f: Stack[-2] = Stack[-5]
0x2a0: Stack[-1] = "d11q06KapellaBeads"
0x2a1: Call2 0x258
...
0x2c9: Push("Can't retrieve diary root")
0x2ca: @ Trace(Stack[-1])
0x2cb: Pop(1)
...
0x2d5: Pop(1)
0x2d6: @@ Find(Stack[-7], Stack[-2])
0x2d7: Pop(0)
0x2d8: Pop(0); Push((bool) Stack[-2] == 0)
0x2d9: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2da: Push("Can't find diary parent with id: ")
...
0x2e0: @@ AddChild(Stack[-8])
0x2e1: Pop(0)
0x2e2: Push((int) 7)
0x2e3: @ SendWorldWndMessage(Stack[-1])
0x2e4: Pop(1)
0x2e5: @@ GetCategory(Stack[-1])
0x2e6: Pop(0)
