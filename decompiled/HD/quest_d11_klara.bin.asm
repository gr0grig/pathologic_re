...
0x620: Pop(0)
0x621: Push("d11q06KlaraRing is given")
0x622: @ Trace(Stack[-1])
0x623: Pop(1)
0x624: PushEmpty(object, string, int)
0x625: Stack[-3] = Stack[-5]
0x626: Stack[-2] = "d11q06KlaraRing"
0x627: Stack[-1] = (int) 1
0x628: Call2 0x5eb
...
0x62f: Stack[-1] = "d11q06KapellaRing"
0x630: Call2 0x5c7
...
0x6e2: Stack[-1] = "ui/NPC_Klara_b.png"
0x6e3: Return(); Pop(0)
