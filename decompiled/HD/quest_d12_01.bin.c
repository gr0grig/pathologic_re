task_0_event_9(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_object, var_16_object, var_17_int, var_18_float)
{
	...
	func_1326(var_26_bool); // 0xa0 NEW_2
...
Label_184:
	var_156_int = 1; // 0xb8 PushI
	var_157_bool = var_17_int == var_156_int; // 0xb9 Eq
	if(var_157_bool == 0) goto Label_200; // 0xba JumpB
	var_158_bool = 0; // 0xbb PushV
	func_1035(var_158_bool); // 0xbc NEW_2
	if(var_158_bool == 0) goto Label_197; // 0xbe JumpB
	var_271_bool = 0; var_272_string = ""; var_273_string = ""; var_274_string = ""; // 0xbf PushV
	var_272_string = "volonteers_danko"; // 0xc0 MovS
	var_273_string = "childs_letter"; // 0xc1 MovS
	var_274_string = ""; // 0xc2 MovS
	func_665(var_271_bool, var_272_string, var_273_string, var_274_string); // 0xc3 NEW_2
...
Label_200:
	var_278_int = 2; // 0xc8 PushI
	var_279_bool = var_17_int == var_278_int; // 0xc9 Eq
	if(var_279_bool == 0) goto Label_208; // 0xca JumpB
...
Label_255:
	...
	func_1312(var_90_bool); // 0x11e NEW_2
...
Label_297:
	...
	func_1319(var_100_bool); // 0x12a NEW_2
...
{
	var_91_int = 0; var_92_int = 0; // 0x520 PushV
	var_93_string = "d12q01KlaraInSobor"; // 0x521 PushS
	GetVariable(var_93_string, var_92_int); // 0x522 Func
	var_94_int = 0; // 0x524 PushI
	var_90_bool = var_92_int != var_94_int; // 0x525 Neq2
...
{
	var_101_int = 0; var_102_int = 0; // 0x527 PushV
	var_103_string = "d12q01BurahInSobor"; // 0x528 PushS
	GetVariable(var_103_string, var_102_int); // 0x529 Func
	var_104_int = 0; // 0x52b PushI
	var_100_bool = var_102_int != var_104_int; // 0x52c Neq2
...
{
	var_27_bool = 0; var_28_bool = 0; // 0x52e PushV
	IsOverrideActive(var_28_bool); // 0x52f Func
	var_26_bool = !var_28_bool; // 0x531 Not2
...
func_1331()
{
	var_21_object = Obj(); var_22_object = Obj(); // 0x533 PushV
	var_23_string = "warehouse_rubin"; // 0x534 PushS
	GetSceneByName(var_22_object, var_23_string); // 0x535 Func
	var_24_string = "rubin"; // 0x537 PushS
	Trigger(var_22_object, var_24_string); // 0x538 Func
	var_25_string = ""; var_26_bool = 0; // 0x53a PushV
	var_25_string = "warehouse_rubin@door1"; // 0x53b MovS
	var_26_bool = 0; // 0x53c MovB
	func_648(var_25_string, var_26_bool); // 0x53d NEW_2
...
Label_1224:
	...
	if(var_115_bool == 0) goto Label_1251; // 0x4d0 JumpB
	var_116_string = "fin_termit"; // 0x4d1 PushS
	Trace(var_116_string); // 0x4d2 Func
	var_117_bool = var_50_bool == 0; // 0x4d4 Not
	if(var_117_bool == 0) goto Label_1241; // 0x4d5 JumpB
	var_118_string = "ACHIEVEMENT_HELLO_2"; // 0x4d6 PushS
	UnlockAchievement(var_118_string); // 0x4d7 Func
	
Label_1241:
	var_119_bool = var_51_bool; // 0x4d9 Push
	if(var_119_bool == 0) goto Label_1247; // 0x4da JumpB
	var_120_string = "gameover_termit_chudo.xml"; // 0x4db PushS
	GameOver(var_120_string); // 0x4dc Func
	goto Label_1250; // 0x4de Jump
	
Label_1250:
	goto Label_1311; // 0x4e2 Jump
	
Label_1311:
	return 18; // 0x51f Return
	
Label_1247:
	var_121_string = "gameover_termit.xml"; // 0x4df PushS
	GameOver(var_121_string); // 0x4e0 Func
	
Label_1251:
	var_122_int = 0; // 0x4e3 PushV
	func_1082(var_122_int); // 0x4e4 NEW_2
	var_123_int = 2; // 0x4e6 PushI
	var_124_bool = var_122_int == var_123_int; // 0x4e7 Eq
	if(var_124_bool == 0) goto Label_1275; // 0x4e8 JumpB
	var_125_string = "fin_utop"; // 0x4e9 PushS
	Trace(var_125_string); // 0x4ea Func
	var_126_bool = var_50_bool == 0; // 0x4ec Not
	if(var_126_bool == 0) goto Label_1265; // 0x4ed JumpB
	var_127_string = "ACHIEVEMENT_HELLO_2"; // 0x4ee PushS
	UnlockAchievement(var_127_string); // 0x4ef Func
	
Label_1265:
	var_128_bool = var_51_bool; // 0x4f1 Push
	if(var_128_bool == 0) goto Label_1271; // 0x4f2 JumpB
	var_129_string = "gameover_utopist_chudo.xml"; // 0x4f3 PushS
	GameOver(var_129_string); // 0x4f4 Func
	goto Label_1274; // 0x4f6 Jump
	
Label_1274:
	goto Label_1311; // 0x4fa Jump
	
Label_1271:
	var_130_string = "gameover_utopist.xml"; // 0x4f7 PushS
	GameOver(var_130_string); // 0x4f8 Func
	
Label_1275:
	var_131_int = 0; // 0x4fb PushV
	func_1082(var_131_int); // 0x4fc NEW_2
	var_132_int = 3; // 0x4fe PushI
	var_133_bool = var_131_int == var_132_int; // 0x4ff Eq
	if(var_133_bool == 0) goto Label_1299; // 0x500 JumpB
	var_134_string = "fin_smiren"; // 0x501 PushS
	Trace(var_134_string); // 0x502 Func
	var_135_bool = var_50_bool == 0; // 0x504 Not
	if(var_135_bool == 0) goto Label_1289; // 0x505 JumpB
	var_136_string = "ACHIEVEMENT_HELLO_2"; // 0x506 PushS
	UnlockAchievement(var_136_string); // 0x507 Func
	
Label_1289:
	var_137_bool = var_51_bool; // 0x509 Push
	if(var_137_bool == 0) goto Label_1295; // 0x50a JumpB
	var_138_string = "gameover_smirennik_chudo.xml"; // 0x50b PushS
	GameOver(var_138_string); // 0x50c Func
	goto Label_1298; // 0x50e Jump
	
Label_1298:
	goto Label_1311; // 0x512 Jump
	
Label_1295:
	var_139_string = "gameover_smirennik.xml"; // 0x50f PushS
	GameOver(var_139_string); // 0x510 Func
	
Label_1299:
	var_140_string = "fin_beda"; // 0x513 PushS
	Trace(var_140_string); // 0x514 Func
	var_141_bool = var_51_bool; // 0x516 Push
	if(var_141_bool == 0) goto Label_1308; // 0x517 JumpB
	var_142_string = "gameover_beda_chudo.xml"; // 0x518 PushS
	GameOver(var_142_string); // 0x519 Func
	goto Label_1311; // 0x51b Jump
	
Label_1308:
	var_143_string = "gameover_beda.xml"; // 0x51c PushS
	GameOver(var_143_string); // 0x51d Func
	
Label_1116:
	var_144_int = 1; // 0x45c PushI
	var_145_bool = var_43_int == var_144_int; // 0x45d Eq
	if(var_145_bool == 0) goto Label_1130; // 0x45e JumpB
	var_146_string = "b12q01ChildsAreVisited"; // 0x45f PushS
	GetVariable(var_146_string, var_48_int); // 0x460 Func
	var_147_int = 0; // 0x462 PushI
	var_45_bool = var_48_int != var_147_int; // 0x463 Neq2
	var_148_string = "b12q01TheaterIsVisited"; // 0x464 PushS
	GetVariable(var_148_string, var_48_int); // 0x465 Func
	var_149_int = 0; // 0x467 PushI
	var_46_bool = var_48_int != var_149_int; // 0x468 Neq2
	goto Label_1143; // 0x469 Jump
	
Label_1130:
	var_150_int = 2; // 0x46a PushI
	var_151_bool = var_43_int == var_150_int; // 0x46b Eq
	if(var_151_bool == 0) goto Label_1143; // 0x46c JumpB
	var_152_string = "k12q01ChildsAreVisited"; // 0x46d PushS
	GetVariable(var_152_string, var_49_int); // 0x46e Func
	var_153_int = 0; // 0x470 PushI
	var_45_bool = var_49_int != var_153_int; // 0x471 Neq2
	var_154_string = "k12q01TheaterIsVisited"; // 0x472 PushS
	GetVariable(var_154_string, var_49_int); // 0x473 Func
	var_155_int = 0; // 0x475 PushI
	var_46_bool = var_49_int != var_155_int; // 0x476 Neq2
}
