...
Label_271:
	...
	func_961(var_164_object); // 0x123 NEW_2
...
Label_305:
	...
	func_973(var_178_object); // 0x133 NEW_2
...
Label_331:
	...
	func_973(var_195_object); // 0x151 NEW_2
	...
	func_939(var_196_bool, var_197_object); // 0x156 NEW_2
...
Label_346:
	...
	func_949(var_199_object); // 0x15d NEW_2
...
func_920()
{
	var_289_string = "ood12BirdmaskT"; // 0x399 PushS
...
func_926()
{
	var_18_string = "ood12BirdmaskT2"; // 0x39f PushS
	var_19_int = 1; // 0x3a0 PushI
	SetVariable(var_18_string, var_19_int); // 0x3a1 Func
...
func_932()
{
	var_24_bool = 0; var_25_string = ""; var_26_string = ""; // 0x3a5 PushV
	var_25_string = "quest_d12_01"; // 0x3a6 MovS
	var_26_string = "init_theater"; // 0x3a7 MovS
	func_874(var_24_bool, var_25_string, var_26_string); // 0x3a8 NEW_2
...
func_949(var_281_bool)
{
	...
	var_284_string = "ood12BirdmaskT"; // 0x3b7 MovS
	func_869(var_283_int, var_284_string); // 0x3b8 NEW_2
	var_285_int = 0; // 0x3ba PushI
	var_286_bool = var_283_int == var_285_int; // 0x3bb Eq
	if(var_286_bool == 0) goto Label_959; // 0x3bc JumpB
	var_281_bool = 1; // 0x3bd MovB
	return 0; // 0x3be Return
	
Label_959:
	var_281_bool = 0; // 0x3bf MovB
...
{
	var_230_int = 0; var_231_string = ""; // 0x3c2 PushV
	var_231_string = "ood12BirdmaskT2"; // 0x3c3 MovS
	func_869(var_230_int, var_231_string); // 0x3c4 NEW_2
	var_234_int = 0; // 0x3c6 PushI
	var_235_bool = var_230_int == var_234_int; // 0x3c7 Eq
	if(var_235_bool == 0) goto Label_971; // 0x3c8 JumpB
	var_228_bool = 1; // 0x3c9 MovB
	return 0; // 0x3ca Return
	
Label_971:
	var_228_bool = 0; // 0x3cb MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_90_object, var_91_object)
{
	...
	func_961(var_229_object); // 0x61 NEW_2
	if(var_228_bool == 0) goto Label_105; // 0x63 JumpB
	var_236_int = 535491; // 0x64 PushI
	var_237_int = 37174; // 0x65 PushI
	var_238_int = 37173; // 0x66 PushI
	AddReply(var_236_int, var_237_int, var_238_int); // 0x67 TObjFunc
	
Label_105:
	var_239_int = 535504; // 0x69 PushI
	var_240_int = -1; // 0x6a PushI
	var_241_int = 37186; // 0x6b PushI
...
Label_111:
	...
	func_973(var_261_object); // 0x71 NEW_2
	...
	var_268_int = 541615; // 0x79 PushI
	SetMessage(var_268_int); // 0x7a TObjFunc
	ClearReplies(); // 0x7c TObjFunc
	var_269_int = 541616; // 0x7e PushI
	var_270_int = 43789; // 0x7f PushI
	var_271_int = 43788; // 0x80 PushI
	AddReply(var_269_int, var_270_int, var_271_int); // 0x81 TObjFunc
	var_272_int = 541620; // 0x83 PushI
	var_273_int = -1; // 0x84 PushI
	var_274_int = 43792; // 0x85 PushI
...
Label_137:
	...
	func_973(var_278_object); // 0x8f NEW_2
	...
	func_939(var_279_bool, var_280_object); // 0x94 NEW_2
	if(var_279_bool == 0) goto Label_152; // 0x96 JumpB
	var_276_bool = 1; // 0x97 MovB
	
Label_152:
	if(var_276_bool == 0) goto Label_159; // 0x98 JumpB
	var_281_bool = 0; var_282_object = Obj(); // 0x99 PushV
	var_282_object = var_1_object; // 0x9a MovT
	func_949(var_282_object); // 0x9b NEW_2
	if(var_281_bool == 0) goto Label_159; // 0x9d JumpB
...
Label_159:
	...
	var_292_int = 535505; // 0xa9 PushI
	SetMessage(var_292_int); // 0xaa TObjFunc
	ClearReplies(); // 0xac TObjFunc
	var_293_int = 535506; // 0xae PushI
	var_294_int = -1; // 0xaf PushI
	var_295_int = 37188; // 0xb0 PushI
...
Label_180:
	...
	var_297_int = 535507; // 0xb8 PushI
	SetMessage(var_297_int); // 0xb9 TObjFunc
	ClearReplies(); // 0xbb TObjFunc
	var_298_int = 535508; // 0xbd PushI
	var_299_int = -1; // 0xbe PushI
	var_300_int = 37190; // 0xbf PushI
...
{
	var_262_int = 0; var_263_string = ""; // 0x3ce PushV
	var_263_string = "d12q01ChildsAreVisited"; // 0x3cf MovS
	func_869(var_262_int, var_263_string); // 0x3d0 NEW_2
	var_264_int = 0; // 0x3d2 PushI
	var_265_bool = var_262_int != var_264_int; // 0x3d3 Neq
	if(var_265_bool == 0) goto Label_983; // 0x3d4 JumpB
	var_260_bool = 1; // 0x3d5 MovB
	return 0; // 0x3d6 Return
	
Label_983:
	var_260_bool = 0; // 0x3d7 MovB
