...
0x309: @@ HasProperty(Stack[-1], Stack[-4])
0x30a: Pop(1)
...
0x31e: @@ GetProperty(Stack[-1], Stack[-2])
0x31f: Pop(1)
0x320: PushEmpty(bool, string)
0x321: Stack[-1] = Stack[-3]
0x322: Call2 0x370

0x323: Stack[-14] = Stack[-2]
0x324: Pop(2)
0x325: Return(); Pop(10)
...
0x334: @@ HasProperty(Stack[-1], Stack[-4])
0x335: Pop(1)
...
0x349: @@ GetProperty(Stack[-1], Stack[-2])
0x34a: Pop(1)
0x34b: PushEmpty(bool, string)
0x34c: Stack[-1] = Stack[-3]
0x34d: Call2 0x370

0x34e: Stack[-14] = Stack[-2]
0x34f: Pop(2)
0x350: Return(); Pop(10)
...
0x36b: Push("Can't find lsh animation : ")
...
0x3c4: Stack[-1] = "ood12BurahSobor1"
0x3c5: Call2 0x396
...
0x3d0: Stack[-1] = "ood12BurahSobor2"
0x3d1: Call2 0x396
...
0x3dc: Stack[-1] = "ood12BurahSobor3"
0x3dd: Call2 0x396
...
0x3fb: Stack[-1] = "ui/NPC_Burah.png"
0x3fc: Return(); Pop(0)

0x3fd: Stack[-1] = "ui/NPC_Burah_b.png"
0x3fe: Return(); Pop(0)
