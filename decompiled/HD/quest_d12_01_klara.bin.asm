...
0x318: @@ HasProperty(Stack[-1], Stack[-4])
0x319: Pop(1)
...
0x32d: @@ GetProperty(Stack[-1], Stack[-2])
0x32e: Pop(1)
0x32f: PushEmpty(bool, string)
0x330: Stack[-1] = Stack[-3]
0x331: Call2 0x37f

0x332: Stack[-14] = Stack[-2]
0x333: Pop(2)
0x334: Return(); Pop(10)
...
0x343: @@ HasProperty(Stack[-1], Stack[-4])
0x344: Pop(1)
...
0x358: @@ GetProperty(Stack[-1], Stack[-2])
0x359: Pop(1)
0x35a: PushEmpty(bool, string)
0x35b: Stack[-1] = Stack[-3]
0x35c: Call2 0x37f

0x35d: Stack[-14] = Stack[-2]
0x35e: Pop(2)
0x35f: Return(); Pop(10)
...
0x37a: Push("Can't find lsh animation : ")
...
0x3cd: Stack[-1] = "ood12KlaraSobor1"
0x3ce: Call2 0x3a5
...
0x3d9: Stack[-1] = "ood12KlaraSobor2"
0x3da: Call2 0x3a5
...
0x3f8: Stack[-1] = "ui/NPC_Klara.png"
0x3f9: Return(); Pop(0)

0x3fa: Stack[-1] = "ui/NPC_Klara_b.png"
0x3fb: Return(); Pop(0)
