...
0x559: @@ HasProperty(Stack[-1], Stack[-4])
0x55a: Pop(1)
...
0x56e: @@ GetProperty(Stack[-1], Stack[-2])
0x56f: Pop(1)
0x570: PushEmpty(bool, string)
0x571: Stack[-1] = Stack[-3]
0x572: Call2 0x5c0

0x573: Stack[-14] = Stack[-2]
0x574: Pop(2)
0x575: Return(); Pop(10)
...
0x584: @@ HasProperty(Stack[-1], Stack[-4])
0x585: Pop(1)
...
0x599: @@ GetProperty(Stack[-1], Stack[-2])
0x59a: Pop(1)
0x59b: PushEmpty(bool, string)
0x59c: Stack[-1] = Stack[-3]
0x59d: Call2 0x5c0

0x59e: Stack[-14] = Stack[-2]
0x59f: Pop(2)
0x5a0: Return(); Pop(10)
...
0x5ac: Push("Can't find lsh animation : ")
...
0x5bb: Push("Can't find lsh animation : ")
...
0x627: Stack[-1] = "b12q01TheaterIsVisited"
0x628: Call2 0x5e6
...
0x649: Stack[-1] = "d12q01KlaraInSobor"
0x64a: Call2 0x5e6
...
0x679: Stack[-1] = "d12q01ChildsAreVisited"
0x67a: Call2 0x5e6
...
0x6a8: Push("Can't retrieve diary root")
0x6a9: @ Trace(Stack[-1])
0x6aa: Pop(1)
...
0x6b4: Pop(1)
0x6b5: @@ Find(Stack[-7], Stack[-2])
0x6b6: Pop(0)
0x6b7: Pop(0); Push((bool) Stack[-2] == 0)
0x6b8: IF (Stack[-1] == 0) GOTO 0x6bf; Pop(1)

0x6b9: Push("Can't find diary parent with id: ")
...
0x6bf: @@ AddChild(Stack[-8])
0x6c0: Pop(0)
0x6c1: Push((int) 7)
0x6c2: @ SendWorldWndMessage(Stack[-1])
0x6c3: Pop(1)
0x6c4: @@ GetCategory(Stack[-1])
0x6c5: Pop(0)
...
0x73b: Stack[-1] = "ui/NPC_Klara.png"
0x73c: Return(); Pop(0)

0x73d: Stack[-1] = "ui/NPC_Klara_b.png"
0x73e: Return(); Pop(0)
