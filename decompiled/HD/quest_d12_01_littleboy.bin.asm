...
0x3ee: Push("Can't find lsh animation : ")
...
0x4c9: Stack[-1] = "ui/NPC_Citizen3.png"
0x4ca: Return(); Pop(0)

0x4cb: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x4cc: Return(); Pop(0)
