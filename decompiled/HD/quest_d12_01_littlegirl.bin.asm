...
0x2f0: Push("Can't find lsh animation : ")
...
0x359: Stack[-1] = "ood12Littlegirl2"
0x35a: Call2 0x326
...
0x365: Stack[-1] = "ood12Littlegirl1"
0x366: Call2 0x326
...
0x381: Push("Can't retrieve diary root")
0x382: @ Trace(Stack[-1])
0x383: Pop(1)
...
0x38d: Pop(1)
0x38e: @@ Find(Stack[-7], Stack[-2])
0x38f: Pop(0)
0x390: Pop(0); Push((bool) Stack[-2] == 0)
0x391: IF (Stack[-1] == 0) GOTO 0x398; Pop(1)

0x392: Push("Can't find diary parent with id: ")
...
0x398: @@ AddChild(Stack[-8])
0x399: Pop(0)
0x39a: Push((int) 7)
0x39b: @ SendWorldWndMessage(Stack[-1])
0x39c: Pop(1)
0x39d: @@ GetCategory(Stack[-1])
0x39e: Pop(0)
...
0x3cb: Stack[-1] = "ui/NPC_Citizen1.png"
0x3cc: Return(); Pop(0)

0x3cd: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x3ce: Return(); Pop(0)
