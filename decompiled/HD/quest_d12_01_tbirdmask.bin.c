...
Label_178:
	...
	func_904(var_55_object); // 0xc5 NEW_2
...
Label_416:
	...
	func_941(var_153_bool); // 0x1a2 NEW_2
...
Label_506:
	...
	func_829(var_19_object); // 0x1fc NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_811(var_29_object); // 0x239 NEW_2
...
func_898()
{
	var_20_string = "ood12TBirdmask1"; // 0x383 PushS
	var_21_int = 1; // 0x384 PushI
	SetVariable(var_20_string, var_21_int); // 0x385 Func
...
{
	var_127_int = 0; var_128_string = ""; // 0x389 PushV
	var_128_string = "ood12TBirdmask1"; // 0x38a MovS
	func_845(var_127_int, var_128_string); // 0x38b NEW_2
	var_131_int = 0; // 0x38d PushI
	var_132_bool = var_127_int == var_131_int; // 0x38e Eq
	if(var_132_bool == 0) goto Label_914; // 0x38f JumpB
	var_125_bool = 1; // 0x390 MovB
	return 0; // 0x391 Return
	
Label_914:
	var_125_bool = 0; // 0x392 MovB
...
{
	var_142_bool = 0; var_143_float = 0; var_144_float = 0; var_145_bool = 0; var_146_float = 0; var_147_float = 0; // 0x30c PushV
	lshHasAnimation(var_145_bool, var_141_string); // 0x30d Func
	var_148_bool = var_145_bool; // 0x30f Push
	if(var_148_bool == 0) goto Label_791; // 0x310 JumpB
	lshGetAnimTimes(var_141_string, var_146_float, var_147_float); // 0x311 Func
	var_149_bool = 0; // 0x313 PushB
	lshPlayAnimation(var_146_float, var_147_float, var_149_bool); // 0x314 Func
...
Label_791:
	var_150_string = "Can't find lsh animation : "; // 0x317 PushS
	var_151_int = var_150_string + var_141_string; // 0x318 Add
	Trace(var_151_int); // 0x319 Func
}
...
func_142(var_2_object, var_107_string)
{
	...
	func_941(var_108_bool); // 0x90 NEW_2
...
Label_160:
	func_796(var_111_string, var_112_bool); // 0xa0 NEW_2
...
func_916(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x394 PushV
	var_82_string = "branch"; // 0x395 PushS
	GetVariable(var_82_string, var_81_int); // 0x396 Func
	var_83_int = 0; // 0x398 PushI
	var_84_bool = var_81_int == var_83_int; // 0x399 Eq
	if(var_84_bool == 0) goto Label_926; // 0x39a JumpB
	var_79_int = 1; // 0x39b MovI
	return 2; // 0x39c Return
	
Label_926:
	var_85_int = 1; // 0x39e PushI
	var_86_bool = var_81_int == var_85_int; // 0x39f Eq
	if(var_86_bool == 0) goto Label_931; // 0x3a0 JumpB
	var_79_int = 2; // 0x3a1 MovI
	return 2; // 0x3a2 Return
	
Label_931:
	var_79_int = 3; // 0x3a3 MovI
...
{
	var_115_bool = 0; var_116_float = 0; var_117_float = 0; var_118_bool = 0; var_119_float = 0; var_120_float = 0; // 0x31c PushV
	lshHasAnimation(var_118_bool, var_111_string); // 0x31d Func
	var_121_bool = var_118_bool; // 0x31f Push
	if(var_121_bool == 0) goto Label_806; // 0x320 JumpB
	lshGetAnimTimes(var_111_string, var_119_float, var_120_float); // 0x321 Func
	lshPlayAnimation(var_119_float, var_120_float, var_112_bool); // 0x323 Func
...
Label_806:
	var_122_string = "Can't find lsh animation : "; // 0x326 PushS
	var_123_int = var_122_string + var_111_string; // 0x327 Add
	Trace(var_123_int); // 0x328 Func
}
...
{
	var_77_string = "ui/NPC_bmask.png"; // 0x3a9 MovS
...
{
	var_78_string = "ui/NPC_bmask_b.png"; // 0x3ab MovS
...
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x32b PushV
	GetEyesHeight(var_32_float); // 0x32c ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x32e MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x32f PushE
	var_34_float = var_32_float; // 0x330 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x331 PopE
	var_35_string = "head"; // 0x332 PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x333 Func
...
func_693(var_27_bool, var_29_float)
{
	...
	func_835(var_54_cvector, var_55_cvector); // 0x2d0 NEW_2
...
Label_734:
	...
	func_941(var_70_bool); // 0x2e8 NEW_2
...
func_822()
{
	var_15_bool = 0; // 0x336 PushV
	func_941(var_15_bool); // 0x337 NEW_2
	if(var_15_bool == 0) goto Label_828; // 0x339 JumpB
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x33d PushV
	self(var_21_object); // 0x33e Func
	var_19_object = var_21_object; // 0x340 Mov
...
{
	var_57_float = 0; var_58_float = 0; // 0x343 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x344 Or
	var_58_float = sqrt(var_59_int); // 0x345 Sqrt2
	var_60_float = 0.0; // 0x346 PushF
	var_61_bool = var_58_float < var_60_float; // 0x347 LT
	if(var_61_bool == 0) goto Label_843; // 0x348 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x349 MovV
	return 2; // 0x34a Return
	
Label_843:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x34b Div2
...
Label_121:
	...
	func_780(var_141_string); // 0x7b NEW_2
...
{
	var_129_int = 0; var_130_int = 0; // 0x34d PushV
	GetVariable(var_128_string, var_130_int); // 0x34e Func
	var_127_int = var_130_int; // 0x350 Mov
...
Label_477:
	...
	func_829(var_21_object); // 0x1df NEW_2
...
Label_603:
	...
	func_874(var_46_int); // 0x25c NEW_2
...
Label_618:
	...
	func_867(var_68_string, var_69_int); // 0x278 NEW_2
...
{
	var_99_object = Obj(); var_100_object = Obj(); // 0x352 PushV
	FindActor(var_100_object, var_97_string); // 0x353 Func
	var_101_bool = var_100_object == 0; // 0x355 Not
	if(var_101_bool == 0) goto Label_862; // 0x356 JumpB
	var_102_string = "Door "; // 0x357 PushS
	var_103_int = var_102_string + var_97_string; // 0x358 Add
	var_104_string = " not found"; // 0x359 PushS
	var_105_int = var_103_int + var_104_string; // 0x35a Add
	Trace(var_105_int); // 0x35b Func
...
Label_862:
	var_106_string = "locked"; // 0x35e PushS
	SetProperty(var_106_string, var_98_bool); // 0x35f ObjFunc
}
...
func_762()
{
	var_159_bool = 0; var_160_bool = 0; // 0x2fa PushV
	var_161_bool = 1; // 0x2fb PushB
	CameraSwitchToNormal(var_161_bool); // 0x2fc Func
	var_162_bool = 0; // 0x2fe PushV
	func_941(var_162_bool); // 0x2ff NEW_2
	if(var_162_bool == 0) goto Label_771; // 0x301 JumpB
...
Label_771:
	var_163_string = "head"; // 0x303 PushS
	HasAnimationTrack(var_160_bool, var_163_string); // 0x304 Func
	var_164_bool = var_160_bool; // 0x306 Push
	if(var_164_bool == 0) goto Label_779; // 0x307 JumpB
	var_165_string = "head"; // 0x308 PushS
	UnlookAsync(var_165_string); // 0x309 Func
}


func_891()
{
	var_97_string = ""; var_98_bool = 0; // 0x37c PushV
	var_97_string = "itheater@door1"; // 0x37d MovS
	var_98_bool = 0; // 0x37e MovB
	func_850(var_97_string, var_98_bool); // 0x37f NEW_2
