...
Label_244:
	...
	func_987(var_33_object); // 0xf9 NEW_2
...
Label_282:
	...
	func_999(var_83_object); // 0x125 NEW_2
...
Label_301:
	...
	func_999(var_92_object); // 0x12f NEW_2
...
Label_311:
	...
	func_999(var_97_object); // 0x139 NEW_2
...
Label_493:
	...
	func_1036(var_177_bool); // 0x1ef NEW_2
...
Label_583:
	...
	func_906(var_19_object); // 0x249 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_888(var_29_object); // 0x286 NEW_2
...
Label_56:
	var_185_bool = var_26_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_186_object = var_17_object; // 0x40 Mov
	func_839(); // 0x41 NEW_2
...
func_770(var_27_bool, var_29_float)
{
	...
	func_912(var_54_cvector, var_55_cvector); // 0x31d NEW_2
...
Label_811:
	...
	var_67_bool = 1; // 0x32d PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x32e Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x330 PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x331 PushE
	Rotate(var_68_float, var_69_float); // 0x332 Func
	var_70_bool = 0; // 0x334 PushV
	func_1036(var_70_bool); // 0x335 NEW_2
	if(var_70_bool == 0) goto Label_825; // 0x337 JumpB
	goto Label_833; // 0x338 Jump
	
Label_833:
	CameraWaitForPlayFinish(); // 0x341 Func
	ResumeWorld(); // 0x343 Func
	var_27_bool = 1; // 0x345 MovB
	return 18; // 0x346 Return
	
Label_825:
	var_71_string = "head"; // 0x339 PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x33a Func
	var_72_bool = var_47_bool; // 0x33c Push
	if(var_72_bool == 0) goto Label_833; // 0x33d JumpB
	var_73_string = "head"; // 0x33e PushS
	LookAsyncCamera(var_73_string); // 0x33f Func
}


func_899()
{
	var_15_bool = 0; // 0x383 PushV
	func_1036(var_15_bool); // 0x384 NEW_2
	if(var_15_bool == 0) goto Label_905; // 0x386 JumpB
	lshStopSpeech(); // 0x387 Func
...
{
	var_77_string = "ui/NPC_wmask.png"; // 0x408 MovS
...
{
	var_78_string = "ui/NPC_wmask_b.png"; // 0x40a MovS
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x38a PushV
	self(var_21_object); // 0x38b Func
	var_19_object = var_21_object; // 0x38d Mov
...
{
	var_57_float = 0; var_58_float = 0; // 0x390 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x391 Or
	var_58_float = sqrt(var_59_int); // 0x392 Sqrt2
	var_60_float = 0.0; // 0x393 PushF
	var_61_bool = var_58_float < var_60_float; // 0x394 LT
	if(var_61_bool == 0) goto Label_920; // 0x395 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x396 MovV
	return 2; // 0x397 Return
	
Label_920:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x398 Div2
...
{
	var_99_int = 0; var_100_int = 0; // 0x39a PushV
	GetVariable(var_98_string, var_100_int); // 0x39b Func
	var_97_int = var_100_int; // 0x39d Mov
...
Label_554:
	...
	func_906(var_21_object); // 0x22c NEW_2
...
{
	var_111_object = Obj(); var_112_object = Obj(); // 0x39f PushV
	FindActor(var_112_object, var_109_string); // 0x3a0 Func
	var_113_bool = var_112_object == 0; // 0x3a2 Not
	if(var_113_bool == 0) goto Label_939; // 0x3a3 JumpB
	var_114_string = "Door "; // 0x3a4 PushS
	var_115_int = var_114_string + var_109_string; // 0x3a5 Add
	var_116_string = " not found"; // 0x3a6 PushS
	var_117_int = var_115_int + var_116_string; // 0x3a7 Add
	Trace(var_117_int); // 0x3a8 Func
	goto Label_942; // 0x3aa Jump
	
Label_942:
	return 2; // 0x3ae Return
	
Label_939:
	var_118_string = "locked"; // 0x3ab PushS
	SetProperty(var_118_string, var_110_bool); // 0x3ac ObjFunc
}
...
Label_680:
	...
	func_951(var_46_int); // 0x2a9 NEW_2
...
Label_695:
	...
	func_944(var_68_string, var_69_int); // 0x2c5 NEW_2
...
{
	var_54_string = ""; var_55_string = ""; // 0x3b0 PushV
	var_55_string = "idle"; // 0x3b1 MovS
	var_56_int = var_53_int; // 0x3b2 Push
	if(var_56_int == 0) goto Label_949; // 0x3b3 JumpB
	var_55_string = var_55_string + var_53_int; // 0x3b4 Add2
	
Label_949:
	var_52_string = var_55_string; // 0x3b5 Mov
...
func_951(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x3b7 PushV
	var_49_int = 0; // 0x3b8 MovI
	
Label_953:
	var_51_string = "all"; // 0x3b9 PushS
	var_52_string = ""; var_53_int = 0; // 0x3ba PushV
	var_53_int = var_49_int; // 0x3bb Mov
	func_944(var_52_string, var_53_int); // 0x3bc NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x3be Func
	var_57_bool = var_50_bool == 0; // 0x3c0 Not
	if(var_57_bool == 0) goto Label_963; // 0x3c1 JumpB
	goto Label_966; // 0x3c2 Jump
	
Label_966:
	var_46_int = var_49_int; // 0x3c6 Mov
	return 4; // 0x3c7 Return
	
Label_963:
	var_58_int = 1; // 0x3c3 PushI
	var_49_int = var_49_int + var_58_int; // 0x3c4 Add2
	goto Label_953; // 0x3c5 Jump
}


func_192(var_2_object, var_119_string)
{
	var_120_bool = 0; // 0xc1 PushV
	func_1036(var_120_bool); // 0xc2 NEW_2
	var_121_bool = var_120_bool == 0; // 0xc4 Not
	if(var_121_bool == 0) goto Label_199; // 0xc5 JumpB
	return 0; // 0xc6 Return
	
Label_199:
	var_122_bool = var_119_string == var_2_object; // 0xc7 Eq
	if(var_122_bool == 0) goto Label_202; // 0xc8 JumpB
	return 0; // 0xc9 Return
	
Label_202:
	var_123_string = ""; var_124_bool = 0; // 0xca PushV
	var_123_string = var_119_string; // 0xcb Mov
	var_125_string = ""; // 0xcc PushS
	var_126_bool = var_119_string == var_125_string; // 0xcd Eq
	if(var_126_bool == 0) goto Label_209; // 0xce JumpB
	var_124_bool = 0; // 0xcf MovB
	goto Label_210; // 0xd0 Jump
	
Label_210:
	func_873(var_123_string, var_124_bool); // 0xd2 NEW_2
	var_2_object = var_119_string; // 0xd4 TMov
	return 0; // 0xd5 Return
	
Label_209:
	var_124_bool = 1; // 0xd1 MovB
}


func_839()
{
	var_187_bool = 0; var_188_bool = 0; // 0x347 PushV
	var_189_bool = 1; // 0x348 PushB
	CameraSwitchToNormal(var_189_bool); // 0x349 Func
	var_190_bool = 0; // 0x34b PushV
	func_1036(var_190_bool); // 0x34c NEW_2
	if(var_190_bool == 0) goto Label_848; // 0x34e JumpB
	goto Label_856; // 0x34f Jump
	
Label_856:
	return 2; // 0x358 Return
	
Label_848:
	var_191_string = "head"; // 0x350 PushS
	HasAnimationTrack(var_188_bool, var_191_string); // 0x351 Func
	var_192_bool = var_188_bool; // 0x353 Push
	if(var_192_bool == 0) goto Label_856; // 0x354 JumpB
	var_193_string = "head"; // 0x355 PushS
	UnlookAsync(var_193_string); // 0x356 Func
}


func_968()
{
	var_109_string = ""; var_110_bool = 0; // 0x3c9 PushV
	var_109_string = "itheater@door1"; // 0x3ca MovS
	var_110_bool = 0; // 0x3cb MovB
	func_927(var_109_string, var_110_bool); // 0x3cc NEW_2
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_968(); // 0x5d NEW_2
	var_119_string = ""; // 0x5f PushV
	var_119_string = "Neutral"; // 0x60 MovS
	func_192(var_89_object, var_119_string); // 0x61 NEW_2
	var_136_int = 515058; // 0x63 PushI
	SetMessage(var_136_int); // 0x64 TObjFunc
	ClearReplies(); // 0x66 TObjFunc
	var_137_int = 515059; // 0x68 PushI
	var_138_int = 16324; // 0x69 PushI
	var_139_int = 16323; // 0x6a PushI
	AddReply(var_137_int, var_138_int, var_139_int); // 0x6b TObjFunc
	var_140_int = 515072; // 0x6d PushI
	var_141_int = -1; // 0x6e PushI
	var_142_int = 16336; // 0x6f PushI
	AddReply(var_140_int, var_141_int, var_142_int); // 0x70 TObjFunc
	goto Label_162; // 0x72 Jump
	
Label_162:
	var_143_bool = 0; // 0xa2 PushV
	func_1036(var_143_bool); // 0xa3 NEW_2
	if(var_143_bool == 0) goto Label_177; // 0xa5 JumpB
	
Label_166:
	lshWaitForAnimEnd(); // 0xa6 Func
	var_144_string = var_3_string; // 0xa8 PushT
	if(var_144_string == 0) goto Label_171; // 0xa9 JumpB
...
Label_171:
	var_145_string = ""; // 0xab PushV
	var_145_string = var_2_object; // 0xac MovT
	func_857(var_145_string); // 0xad NEW_2
	goto Label_166; // 0xaf Jump
	
Label_177:
	var_156_string = "all"; // 0xb1 PushS
	var_157_string = "idle"; // 0xb2 PushS
	PlayAnimation(var_156_string, var_157_string); // 0xb3 Func
	
Label_181:
	WaitForAnimEnd(); // 0xb5 Func
	var_158_string = var_3_string; // 0xb7 PushT
	if(var_158_string == 0) goto Label_186; // 0xb8 JumpB
	goto Label_191; // 0xb9 Jump
	
Label_186:
	var_159_string = "all"; // 0xba PushS
	var_160_string = "idle"; // 0xbb PushS
	PlayAnimation(var_159_string, var_160_string); // 0xbc Func
	goto Label_181; // 0xbe Jump
	
Label_115:
	var_161_string = ""; // 0x73 PushV
	var_161_string = "Neutral"; // 0x74 MovS
	func_192(var_89_object, var_161_string); // 0x75 NEW_2
	var_162_int = 515073; // 0x77 PushI
	SetMessage(var_162_int); // 0x78 TObjFunc
	ClearReplies(); // 0x7a TObjFunc
	var_163_bool = 0; var_164_object = Obj(); // 0x7c PushV
	var_164_object = var_1_object; // 0x7d MovT
	func_999(var_164_object); // 0x7e NEW_2
	if(var_163_bool == 0) goto Label_134; // 0x80 JumpB
	var_169_int = 515074; // 0x81 PushI
	var_170_int = 16339; // 0x82 PushI
	var_171_int = 16338; // 0x83 PushI
	AddReply(var_169_int, var_170_int, var_171_int); // 0x84 TObjFunc
	
Label_134:
	var_172_bool = 0; var_173_object = Obj(); // 0x86 PushV
	var_173_object = var_1_object; // 0x87 MovT
	func_999(var_173_object); // 0x88 NEW_2
	if(var_172_bool == 0) goto Label_144; // 0x8a JumpB
	var_174_int = 515085; // 0x8b PushI
	var_175_int = 16341; // 0x8c PushI
	var_176_int = 16349; // 0x8d PushI
	AddReply(var_174_int, var_175_int, var_176_int); // 0x8e TObjFunc
	
Label_144:
	var_177_bool = 0; var_178_object = Obj(); // 0x90 PushV
	var_178_object = var_1_object; // 0x91 MovT
	func_999(var_178_object); // 0x92 NEW_2
	if(var_177_bool == 0) goto Label_154; // 0x94 JumpB
	var_179_int = 515086; // 0x95 PushI
	var_180_int = 16341; // 0x96 PushI
	var_181_int = 16351; // 0x97 PushI
	AddReply(var_179_int, var_180_int, var_181_int); // 0x98 TObjFunc
	
Label_154:
	var_182_int = 515087; // 0x9a PushI
	var_183_int = -1; // 0x9b PushI
	var_184_int = 16353; // 0x9c PushI
	AddReply(var_182_int, var_183_int, var_184_int); // 0x9d TObjFunc
...
func_975()
{
	var_105_string = "ood12Whitemask1"; // 0x3d0 PushS
	var_106_int = 1; // 0x3d1 PushI
	SetVariable(var_105_string, var_106_int); // 0x3d2 Func
...
func_981()
{
	var_20_string = "ood12Whitemask2"; // 0x3d6 PushS
	var_21_int = 1; // 0x3d7 PushI
	SetVariable(var_20_string, var_21_int); // 0x3d8 Func
...
{
	var_146_bool = 0; var_147_float = 0; var_148_float = 0; var_149_bool = 0; var_150_float = 0; var_151_float = 0; // 0x359 PushV
	lshHasAnimation(var_149_bool, var_145_string); // 0x35a Func
	var_152_bool = var_149_bool; // 0x35c Push
	if(var_152_bool == 0) goto Label_868; // 0x35d JumpB
	lshGetAnimTimes(var_145_string, var_150_float, var_151_float); // 0x35e Func
	var_153_bool = 0; // 0x360 PushB
	lshPlayAnimation(var_150_float, var_151_float, var_153_bool); // 0x361 Func
...
Label_868:
	var_154_string = "Can't find lsh animation : "; // 0x364 PushS
	var_155_int = var_154_string + var_145_string; // 0x365 Add
	Trace(var_155_int); // 0x366 Func
}


func_987(var_95_bool)
{
	var_97_int = 0; var_98_string = ""; // 0x3dc PushV
	var_98_string = "ood12Whitemask1"; // 0x3dd MovS
	func_922(var_97_int, var_98_string); // 0x3de NEW_2
	var_101_int = 0; // 0x3e0 PushI
	var_102_bool = var_97_int == var_101_int; // 0x3e1 Eq
	if(var_102_bool == 0) goto Label_997; // 0x3e2 JumpB
	var_95_bool = 1; // 0x3e3 MovB
	return 0; // 0x3e4 Return
	
Label_997:
	var_95_bool = 0; // 0x3e5 MovB
...
{
	var_165_int = 0; var_166_string = ""; // 0x3e8 PushV
	var_166_string = "ood12Whitemask2"; // 0x3e9 MovS
	func_922(var_165_int, var_166_string); // 0x3ea NEW_2
	var_167_int = 0; // 0x3ec PushI
	var_168_bool = var_165_int == var_167_int; // 0x3ed Eq
	if(var_168_bool == 0) goto Label_1009; // 0x3ee JumpB
	var_163_bool = 1; // 0x3ef MovB
	return 0; // 0x3f0 Return
	
Label_1009:
	var_163_bool = 0; // 0x3f1 MovB
...
{
	var_127_bool = 0; var_128_float = 0; var_129_float = 0; var_130_bool = 0; var_131_float = 0; var_132_float = 0; // 0x369 PushV
	lshHasAnimation(var_130_bool, var_123_string); // 0x36a Func
	var_133_bool = var_130_bool; // 0x36c Push
	if(var_133_bool == 0) goto Label_883; // 0x36d JumpB
	lshGetAnimTimes(var_123_string, var_131_float, var_132_float); // 0x36e Func
	lshPlayAnimation(var_131_float, var_132_float, var_124_bool); // 0x370 Func
	goto Label_887; // 0x372 Jump
	
Label_887:
	return 6; // 0x377 Return
	
Label_883:
	var_134_string = "Can't find lsh animation : "; // 0x373 PushS
	var_135_int = var_134_string + var_123_string; // 0x374 Add
	Trace(var_135_int); // 0x375 Func
}
...
{
	var_80_int = 0; var_81_int = 0; // 0x3f3 PushV
	var_82_string = "branch"; // 0x3f4 PushS
	GetVariable(var_82_string, var_81_int); // 0x3f5 Func
	var_83_int = 0; // 0x3f7 PushI
	var_84_bool = var_81_int == var_83_int; // 0x3f8 Eq
	if(var_84_bool == 0) goto Label_1021; // 0x3f9 JumpB
	var_79_int = 1; // 0x3fa MovI
	return 2; // 0x3fb Return
	
Label_1021:
	var_85_int = 1; // 0x3fd PushI
	var_86_bool = var_81_int == var_85_int; // 0x3fe Eq
	if(var_86_bool == 0) goto Label_1026; // 0x3ff JumpB
	var_79_int = 2; // 0x400 MovI
	return 2; // 0x401 Return
	
Label_1026:
	var_79_int = 3; // 0x402 MovI
...
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x378 PushV
	GetEyesHeight(var_32_float); // 0x379 ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x37b MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x37c PushE
	var_34_float = var_32_float; // 0x37d Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x37e PopE
	var_35_string = "head"; // 0x37f PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x380 Func
