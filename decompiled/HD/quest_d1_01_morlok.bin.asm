...
0x779: Push("Can't find lsh animation : ")
...
0x788: Push("Can't find lsh animation : ")
...
0x7e6: Stack[-4] = Stack[-1]
0x7e7: Return(); Pop(0)

0x7e8: Stack[-4] = Stack[-3]
0x7e9: Return(); Pop(0)
...
0x7fd: Pop(0)
0x7fe: Pop(0); Push((bool) Stack[-1] == 0)
...
0x831: Stack[-5] = Stack[-2]
0x832: Return(); Pop(4)

0x833: PushEmpty()
0x834: PushEmpty(bool, string, string)
0x835: Stack[-2] = "quest_d1_01"
0x836: Stack[-1] = "attack"
0x837: Call2 0x7fb
...
0x862: Stack[-1] = "ui/NPC_Morlok.png"
0x863: Return(); Pop(0)

0x864: Stack[-1] = "ui/NPC_Morlok_b.png"
0x865: Return(); Pop(0)
...
0x872: Stack[-3] = Stack[-7]
0x873: Stack[-2] = Stack[-6]
0x874: Stack[-1] = Stack[-5]
0x875: Call2 0x6b5
...
0x87a: Stack[-5] = Stack[-11]
0x87b: Stack[-4] = Stack[-10]
0x87c: Stack[-3] = Stack[-9]
0x87d: Stack[-2] = Stack[-7]
0x87e: Stack[-1] = Stack[-6]
0x87f: Call2 0x6f9
