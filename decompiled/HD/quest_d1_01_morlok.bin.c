...
Label_191:
	...
	func_2150(var_55_bool); // 0xc1 NEW_2
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool)
{
	...
	func_2043(var_19_bool, var_20_string, var_21_string); // 0xdf NEW_2
...
Label_243:
	var_525_string = ""; // 0xf3 PushV
	var_525_string = var_15_bool; // 0xf4 Mov
	func_289(var_525_string); // 0xf5 NEW_2
}
...
Label_311:
	...
	func_1992(var_18_object); // 0x139 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_2055(var_18_object); // 0x475 NEW_2
...
Label_1170:
	...
	func_1933(var_19_object); // 0x496 NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object)
{
	...
	func_2129(var_19_object); // 0x554 NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x871 PushV
	var_19_object = var_15_object; // 0x872 Mov
	var_20_int = var_16_int; // 0x873 Mov
	var_21_float = var_17_float; // 0x874 Mov
	func_1717(var_19_object, var_20_int, var_21_float); // 0x875 NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x879 PushV
	var_21_object = var_15_object; // 0x87a Mov
	var_22_int = var_16_int; // 0x87b Mov
	var_23_float = var_17_float; // 0x87c Mov
	var_24_cvector = var_19_cvector; // 0x87d Mov
	var_25_cvector = var_20_cvector; // 0x87e Mov
	func_1785(var_23_float, var_24_cvector, var_25_cvector); // 0x87f NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x882 PushV
	var_19_string = "health"; // 0x883 PushS
	var_20_bool = var_16_string == var_19_string; // 0x884 Eq
	if(var_20_bool == 0) goto Label_2190; // 0x885 JumpB
	var_21_string = "health"; // 0x886 PushS
	GetProperty(var_21_string, var_18_float); // 0x887 Func
	var_22_int = 0; // 0x889 PushI
	var_23_bool = var_18_float <= var_22_int; // 0x88a LE
	if(var_23_bool == 0) goto Label_2190; // 0x88b JumpB
	SignalDeath(var_15_object); // 0x88c Func
...
{
	var_16_object = Obj(); // 0x890 PushV
	var_16_object = var_15_object; // 0x891 Mov
	func_2152(var_16_object); // 0x892 NEW_2
...
{
	var_15_object = Obj(); // 0x895 PushV
	func_1992(var_15_object); // 0x896 NEW_2
	RemoveActor(var_15_object); // 0x898 Func
	Hold(); // 0x89a Func
...
{
	var_19_bool = 0; var_20_bool = 0; // 0x807 PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x808 Func
	var_21_bool = var_20_bool; // 0x80a Push
	if(var_21_bool == 0) goto Label_2063; // 0x80b JumpB
	var_22_string = "attack"; // 0x80c PushS
	PlayGlobalMusic(var_22_string); // 0x80d Func
...
func_2064()
{
	var_362_object = Obj(); var_363_object = Obj(); // 0x810 PushV
	GetScene(var_363_object); // 0x811 Func
	var_364_string = "battle"; // 0x813 PushS
	var_365_object = Obj(); // 0x814 PushV
	func_1992(var_365_object); // 0x815 NEW_2
	BroadcastMessage(var_364_string, var_365_object, var_363_object); // 0x817 Func
...
{
	var_48_string = ""; var_49_string = ""; // 0x81b PushV
	var_49_string = "idle"; // 0x81c MovS
	var_50_int = var_47_int; // 0x81d Push
	if(var_50_int == 0) goto Label_2080; // 0x81e JumpB
	var_49_string = var_49_string + var_47_int; // 0x81f Add2
	
Label_2080:
	var_46_string = var_49_string; // 0x820 Mov
...
{
	var_41_int = 0; var_42_bool = 0; var_43_int = 0; var_44_bool = 0; // 0x822 PushV
	var_43_int = 0; // 0x823 MovI
	
Label_2084:
	var_45_string = "all"; // 0x824 PushS
	var_46_string = ""; var_47_int = 0; // 0x825 PushV
	var_47_int = var_43_int; // 0x826 Mov
	func_2075(var_46_string, var_47_int); // 0x827 NEW_2
	HasAnimation(var_44_bool, var_45_string, var_46_string); // 0x829 Func
	var_51_bool = var_44_bool == 0; // 0x82b Not
	if(var_51_bool == 0) goto Label_2094; // 0x82c JumpB
	goto Label_2097; // 0x82d Jump
	
Label_2097:
	var_40_int = var_43_int; // 0x831 Mov
	return 4; // 0x832 Return
	
Label_2094:
	var_52_int = 1; // 0x82e PushI
	var_43_int = var_43_int + var_52_int; // 0x82f Add2
	goto Label_2084; // 0x830 Jump
}
...
func_1066(var_0_object)
{
	...
	func_2055(var_125_object); // 0x42c NEW_2
...
func_1073()
{
	...
	func_1951(var_258_string); // 0x433 NEW_2
...
func_2099()
{
	var_23_bool = 0; var_24_string = ""; var_25_string = ""; // 0x834 PushV
	var_24_string = "quest_d1_01"; // 0x835 MovS
	var_25_string = "attack"; // 0x836 MovS
	func_2043(var_23_bool, var_24_string, var_25_string); // 0x837 NEW_2
...
{
	var_80_int = 0; var_81_int = 0; // 0x83a PushV
	var_82_string = "branch"; // 0x83b PushS
	GetVariable(var_82_string, var_81_int); // 0x83c Func
	var_83_int = 0; // 0x83e PushI
	var_84_bool = var_81_int == var_83_int; // 0x83f Eq
	if(var_84_bool == 0) goto Label_2116; // 0x840 JumpB
	var_79_int = 1; // 0x841 MovI
	return 2; // 0x842 Return
	
Label_2116:
	var_85_int = 1; // 0x844 PushI
	var_86_bool = var_81_int == var_85_int; // 0x845 Eq
	if(var_86_bool == 0) goto Label_2121; // 0x846 JumpB
	var_79_int = 2; // 0x847 MovI
	return 2; // 0x848 Return
	
Label_2121:
	var_79_int = 3; // 0x849 MovI
...
func_1086(var_2_object, var_132_bool, var_133_object, var_134_float, var_135_float, var_136_bool, var_137_bool)
{
	...
	func_2055(var_145_object); // 0x441 NEW_2
	...
	func_1933(var_149_object); // 0x44e NEW_2
...
Label_1106:
	...
	func_1992(var_160_object); // 0x458 NEW_2
...
Label_111:
	...
	func_1902(var_121_string); // 0x71 NEW_2
...
{
	var_21_int = 0; var_22_int = 0; // 0x84b PushV
	var_23_string = "branch"; // 0x84c PushS
	GetVariable(var_23_string, var_22_int); // 0x84d Func
	var_20_int = var_22_int; // 0x84f Mov
...
{
	var_20_int = 0; // 0x852 PushV
	func_2123(var_20_int); // 0x853 NEW_2
	var_24_int = 1; // 0x855 PushI
	var_25_bool = var_20_int == var_24_int; // 0x856 Eq
	if(var_25_bool == 0) goto Label_2139; // 0x857 JumpB
	WorkWithCorpse(var_19_object); // 0x858 Func
...
Label_2139:
	Barter(var_19_object); // 0x85b Func
}


func_2142(var_76_int)
{
	var_76_int = 521048; // 0x85e MovI
...
{
	var_77_string = "ui/NPC_Morlok.png"; // 0x862 MovS
...
{
	var_78_string = "ui/NPC_Morlok_b.png"; // 0x864 MovS
...
{
	var_17_object = Obj(); // 0x869 PushV
	var_17_object = var_16_object; // 0x86a Mov
	TaskCall(5); // 0x86b TaskCall
	func_1342(var_17_object); // 0x86c NEW_2
...
func_132(var_2_object, var_95_string)
{
	...
	func_2150(var_96_bool); // 0x86 NEW_2
...
Label_150:
	func_1918(var_99_string, var_100_bool); // 0x96 NEW_2
...
func_688(var_0_object, var_387_float, var_388_int)
{
	...
	var_466_int = 0; // 0x2cb PushV
	func_1071(var_466_int); // 0x2cc NEW_2
	ReportHit(var_0_object, var_466_int, var_394_float, var_393_float); // 0x2ce Func
	var_467_object = Obj(); var_468_float = 0; // 0x2d0 PushV
	var_467_object = var_392_object; // 0x2d1 Mov
	var_468_float = var_394_float; // 0x2d2 Mov
...
Label_1733:
	...
	func_1998(var_47_cvector, var_48_cvector); // 0x6cc NEW_2
...
Label_763:
	...
	var_469_string = "all"; // 0x300 PushS
	var_470_string = "attack_middle"; // 0x301 PushS
	var_471_int = var_470_string + var_356_int; // 0x302 Add
	HasAnimation(var_357_bool, var_469_string, var_471_int); // 0x303 Func
	var_472_bool = var_357_bool; // 0x305 Push
	if(var_472_bool == 0) goto Label_844; // 0x306 JumpB
	func_2064(); // 0x308 NEW_2
	var_473_string = "all"; // 0x30a PushS
	var_474_string = "attack_middle"; // 0x30b PushS
	var_475_int = var_474_string + var_356_int; // 0x30c Add
	PlayAnimation(var_473_string, var_475_int); // 0x30d Func
	WaitForAnimEnd(); // 0x30f Func
	func_1066(var_359_string); // 0x312 NEW_2
	var_476_bool = 0; var_477_object = Obj(); // 0x314 PushV
	var_477_object = var_0_object; // 0x315 MovT
	func_1649(var_476_bool, var_477_object); // 0x316 NEW_2
	var_478_bool = var_476_bool == 0; // 0x318 Not
	if(var_478_bool == 0) goto Label_798; // 0x319 JumpB
	StopAsync(); // 0x31a Func
	var_350_bool = 0; // 0x31c MovB
	return 8; // 0x31d Return
	
Label_798:
	var_479_float = 0; var_480_int = 0; // 0x31e PushV
	var_479_float = var_351_float; // 0x31f Mov
	var_480_int = var_356_int; // 0x320 Mov
	func_688(var_359_string, var_479_float, var_480_int); // 0x321 NEW_2
	var_358_int = 1; // 0x323 MovI
	
Label_804:
	var_481_string = "attack_middle"; // 0x324 PushS
	var_482_int = var_481_string + var_356_int; // 0x325 Add
	var_483_string = "_"; // 0x326 PushS
	var_484_int = var_482_int + var_483_string; // 0x327 Add
	var_359_string = var_484_int + var_358_int; // 0x328 Add2
	var_485_string = "all"; // 0x329 PushS
	HasAnimation(var_357_bool, var_485_string, var_359_string); // 0x32a Func
	var_486_bool = var_357_bool == 0; // 0x32c Not
	if(var_486_bool == 0) goto Label_815; // 0x32d JumpB
	goto Label_844; // 0x32e Jump
	
Label_844:
	var_487_bool = 0; // 0x34c PushB
	SetAttackState(var_487_bool); // 0x34d Func
	var_488_string = "all"; // 0x34f PushS
	var_489_string = "attack_end"; // 0x350 PushS
	var_490_int = var_489_string + var_356_int; // 0x351 Add
	PlayAnimation(var_488_string, var_490_int); // 0x352 Func
	var_491_bool = 0; // 0x354 PushV
	func_1080(var_491_bool); // 0x355 NEW_2
	if(var_491_bool == 0) goto Label_862; // 0x357 JumpB
	var_492_bool = 0; var_493_float = 0; // 0x358 PushV
	var_493_float = 0.75; // 0x359 MovF
	func_864(var_492_bool, var_493_float); // 0x35a NEW_2
...
Label_815:
	func_2064(); // 0x330 NEW_2
	var_501_string = "all"; // 0x332 PushS
	PlayAnimation(var_501_string, var_359_string); // 0x333 Func
	WaitForAnimEnd(); // 0x335 Func
	func_1066(var_359_string); // 0x338 NEW_2
	var_502_bool = 0; var_503_object = Obj(); // 0x33a PushV
	var_503_object = var_0_object; // 0x33b MovT
	func_1649(var_502_bool, var_503_object); // 0x33c NEW_2
	var_504_bool = var_502_bool == 0; // 0x33e Not
	if(var_504_bool == 0) goto Label_836; // 0x33f JumpB
	StopAsync(); // 0x340 Func
	var_350_bool = 0; // 0x342 MovB
	return 8; // 0x343 Return
	
Label_836:
	var_505_float = 0; var_506_int = 0; // 0x344 PushV
	var_505_float = var_351_float; // 0x345 Mov
	var_506_int = var_356_int; // 0x346 Mov
	func_688(var_359_string, var_505_float, var_506_int); // 0x347 NEW_2
	var_507_int = 1; // 0x349 PushI
	var_358_int = var_358_int + var_507_int; // 0x34a Add2
...
{
	var_528_bool = 0; var_529_bool = 0; // 0x10d PushV
	var_0_object = 1; // 0x10e TMovB
	IsLoaded(var_529_bool); // 0x10f Func
	var_530_bool = 0; // 0x111 PushV
	var_530_bool = 0; // 0x112 MovB
	var_531_bool = var_529_bool == 0; // 0x113 Not
	if(var_531_bool == 0) goto Label_282; // 0x114 JumpB
	var_532_bool = 0; // 0x115 PushV
	func_318(var_532_bool); // 0x116 NEW_2
	if(var_532_bool == 0) goto Label_282; // 0x118 JumpB
	var_530_bool = 1; // 0x119 MovB
	
Label_282:
	if(var_530_bool == 0) goto Label_288; // 0x11a JumpB
	var_533_object = Obj(); // 0x11b PushV
	func_1992(var_533_object); // 0x11c NEW_2
	RemoveActor(var_533_object); // 0x11e Func
...
func_1815(var_27_bool, var_29_float)
{
	...
	func_1998(var_54_cvector, var_55_cvector); // 0x732 NEW_2
...
Label_1856:
	...
	var_67_bool = 1; // 0x742 PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x743 Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x745 PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x746 PushE
	Rotate(var_68_float, var_69_float); // 0x747 Func
	var_70_bool = 0; // 0x749 PushV
	func_2150(var_70_bool); // 0x74a NEW_2
	if(var_70_bool == 0) goto Label_1870; // 0x74c JumpB
	goto Label_1878; // 0x74d Jump
	
Label_1878:
	CameraWaitForPlayFinish(); // 0x756 Func
	ResumeWorld(); // 0x758 Func
	var_27_bool = 1; // 0x75a MovB
	return 18; // 0x75b Return
	
Label_1870:
	var_71_string = "head"; // 0x74e PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x74f Func
	var_72_bool = var_47_bool; // 0x751 Push
	if(var_72_bool == 0) goto Label_1878; // 0x752 JumpB
	var_73_string = "head"; // 0x753 PushS
	LookAsyncCamera(var_73_string); // 0x754 Func
}


func_289(var_525_string)
{
	var_526_string = "cleanup"; // 0x122 PushS
	var_527_bool = var_525_string == var_526_string; // 0x123 Eq
	if(var_527_bool == 0) goto Label_296; // 0x124 JumpB
	func_269(var_525_string); // 0x126 NEW_2
...
Label_329:
	...
	func_2082(var_40_int); // 0x14a NEW_2
...
Label_344:
	...
	func_2075(var_62_string, var_63_int); // 0x166 NEW_2
...
Label_1435:
	...
	func_1951(var_93_string); // 0x59d NEW_2
...
func_1884()
{
	var_139_bool = 0; var_140_bool = 0; // 0x75c PushV
	var_141_bool = 1; // 0x75d PushB
	CameraSwitchToNormal(var_141_bool); // 0x75e Func
	var_142_bool = 0; // 0x760 PushV
	func_2150(var_142_bool); // 0x761 NEW_2
	if(var_142_bool == 0) goto Label_1893; // 0x763 JumpB
	goto Label_1901; // 0x764 Jump
	
Label_1901:
	return 2; // 0x76d Return
	
Label_1893:
	var_143_string = "head"; // 0x765 PushS
	HasAnimationTrack(var_140_bool, var_143_string); // 0x766 Func
	var_144_bool = var_140_bool; // 0x768 Push
	if(var_144_bool == 0) goto Label_1901; // 0x769 JumpB
	var_145_string = "head"; // 0x76a PushS
	UnlookAsync(var_145_string); // 0x76b Func
}


func_864(var_492_bool, var_493_float)
{
	var_494_float = 0; var_495_bool = 0; var_496_float = 0; var_497_bool = 0; // 0x360 PushV
	rand(var_496_float); // 0x361 Func
	var_498_bool = var_496_float < var_493_float; // 0x363 LT
	if(var_498_bool == 0) goto Label_884; // 0x364 JumpB
	
Label_869:
	IsAnimationPlaying(var_497_bool); // 0x365 Func
	var_499_bool = var_497_bool == 0; // 0x367 Not
	if(var_499_bool == 0) goto Label_874; // 0x368 JumpB
...
Label_889:
	var_492_bool = 0; // 0x379 MovB
	return 4; // 0x37a Return
	
Label_874:
	var_500_bool = 0; // 0x36a PushV
	func_962(var_500_bool); // 0x36b NEW_2
	if(var_500_bool == 0) goto Label_880; // 0x36d JumpB
	var_492_bool = 1; // 0x36e MovB
...
Label_884:
	...
	func_1066(var_497_bool); // 0x377 NEW_2
}


func_1902(var_121_string)
{
	var_122_bool = 0; var_123_float = 0; var_124_float = 0; var_125_bool = 0; var_126_float = 0; var_127_float = 0; // 0x76e PushV
	lshHasAnimation(var_125_bool, var_121_string); // 0x76f Func
	var_128_bool = var_125_bool; // 0x771 Push
	if(var_128_bool == 0) goto Label_1913; // 0x772 JumpB
	lshGetAnimTimes(var_121_string, var_126_float, var_127_float); // 0x773 Func
	var_129_bool = 0; // 0x775 PushB
	lshPlayAnimation(var_126_float, var_127_float, var_129_bool); // 0x776 Func
	goto Label_1917; // 0x778 Jump
	
Label_1917:
	return 6; // 0x77d Return
	
Label_1913:
	var_130_string = "Can't find lsh animation : "; // 0x779 PushS
	var_131_int = var_130_string + var_121_string; // 0x77a Add
	Trace(var_131_int); // 0x77b Func
}
...
{
	var_103_bool = 0; var_104_float = 0; var_105_float = 0; var_106_bool = 0; var_107_float = 0; var_108_float = 0; // 0x77e PushV
	lshHasAnimation(var_106_bool, var_99_string); // 0x77f Func
	var_109_bool = var_106_bool; // 0x781 Push
	if(var_109_bool == 0) goto Label_1928; // 0x782 JumpB
	lshGetAnimTimes(var_99_string, var_107_float, var_108_float); // 0x783 Func
	lshPlayAnimation(var_107_float, var_108_float, var_100_bool); // 0x785 Func
	goto Label_1932; // 0x787 Jump
	
Label_1932:
	return 6; // 0x78c Return
	
Label_1928:
	var_110_string = "Can't find lsh animation : "; // 0x788 PushS
	var_111_int = var_110_string + var_99_string; // 0x789 Add
	Trace(var_111_int); // 0x78a Func
}


func_1933(var_19_object)
{
	var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_float = 0; var_23_cvector = CVector(0,0,0); // 0x78d PushV
	GetEyesHeight(var_22_float); // 0x78e ObjFunc
	var_23_cvector = CVector(0.0, 0.0, 0.0); // 0x790 MovV
	var_24_float = GetByIndex(var_23_cvector, 1); // 0x791 PushE
	var_24_float = var_22_float; // 0x792 Mov
	SetByIndex(var_23_cvector, 1) = var_24_float; // 0x793 PopE
	var_25_string = "head"; // 0x794 PushS
	LookAsync(var_19_object, var_25_string, var_23_cvector); // 0x795 Func
...
Label_407:
	...
	var_524_int = 1; // 0x19d PushI
	Sleep(var_524_int); // 0x19e Func
...
func_1944()
{
	var_18_bool = 0; // 0x798 PushV
	func_2150(var_18_bool); // 0x799 NEW_2
	if(var_18_bool == 0) goto Label_1950; // 0x79b JumpB
	lshStopSpeech(); // 0x79c Func
...
{
	var_42_bool = 0; var_43_int = 0; var_44_bool = 0; var_45_int = 0; var_46_bool = 0; var_47_float = 0; var_48_cvector = CVector(0,0,0); var_49_cvector = CVector(0,0,0); var_50_bool = 0; var_51_int = 0; var_52_bool = 0; var_53_int = 0; var_54_bool = 0; var_55_float = 0; var_56_cvector = CVector(0,0,0); var_57_cvector = CVector(0,0,0); // 0x79f PushV
	IsExisting3DSound(var_50_bool, var_41_string); // 0x7a0 Func
	var_58_bool = var_50_bool == 0; // 0x7a2 Not
	if(var_58_bool == 0) goto Label_1976; // 0x7a3 JumpB
	var_51_int = 0; // 0x7a4 MovI
	
Label_1957:
	var_59_int = 1; // 0x7a5 PushI
	var_60_int = var_51_int + var_59_int; // 0x7a6 Add
	var_61_int = var_41_string + var_60_int; // 0x7a7 Add
	IsExisting3DSound(var_52_bool, var_61_int); // 0x7a8 Func
	var_62_bool = var_52_bool == 0; // 0x7aa Not
	if(var_62_bool == 0) goto Label_1965; // 0x7ab JumpB
	goto Label_1968; // 0x7ac Jump
	
Label_1968:
	var_63_bool = var_51_int == 0; // 0x7b0 Not
	if(var_63_bool == 0) goto Label_1971; // 0x7b1 JumpB
	return 16; // 0x7b2 Return
	
Label_1971:
	irand(var_53_int, var_51_int); // 0x7b3 Func
	var_64_int = 1; // 0x7b5 PushI
	var_65_int = var_53_int + var_64_int; // 0x7b6 Add
	var_41_string = var_41_string + var_65_int; // 0x7b7 Add2
	
Label_1976:
	Is3DSoundLoaded(var_54_bool, var_41_string); // 0x7b8 Func
	var_66_bool = var_54_bool; // 0x7ba Push
	if(var_66_bool == 0) goto Label_1991; // 0x7bb JumpB
	GetEyesHeight(var_55_float); // 0x7bc Func
	GetDirection(var_56_cvector); // 0x7be Func
	var_67_int = 50; // 0x7c0 PushI
	var_57_cvector = var_56_cvector * var_67_int; // 0x7c1 Mult2
	var_68_float = GetByIndex(var_57_cvector, 1); // 0x7c2 PushE
	var_68_float = var_68_float + var_55_float; // 0x7c3 Add2
	SetByIndex(var_57_cvector, 1) = var_68_float; // 0x7c4 PopE
	PlayGlobalSound(var_41_string, var_57_cvector); // 0x7c5 Func
	
Label_1991:
	return 16; // 0x7c7 Return
	
Label_1965:
	var_69_int = 1; // 0x7ad PushI
	var_51_int = var_51_int + var_69_int; // 0x7ae Add2
	goto Label_1957; // 0x7af Jump
}
...
Label_443:
	...
	func_1992(var_84_object); // 0x1c5 NEW_2
...
Label_580:
	...
	var_508_string = "all"; // 0x246 PushS
	var_509_string = "fjump"; // 0x247 PushS
	PlayAnimation(var_508_string, var_509_string); // 0x248 Func
	WaitForAnimEnd(); // 0x24a Func
	func_1066(var_53_float); // 0x24d NEW_2
	var_510_cvector = CVector(0.0, 0.0, 0.0); // 0x24f PushVec
	SetSpeed(var_510_cvector); // 0x250 Func
	Stop(); // 0x252 Func
	StopAsync(); // 0x254 Func
	var_511_bool = 0; // 0x256 PushV
	func_1023(var_53_float, var_511_bool); // 0x257 NEW_2
	var_512_bool = var_511_bool == 0; // 0x259 Not
	if(var_512_bool == 0) goto Label_626; // 0x25a JumpB
	var_513_bool = 0; var_514_object = Obj(); // 0x25b PushV
	var_514_object = var_0_object; // 0x25c MovT
	func_1649(var_513_bool, var_514_object); // 0x25d NEW_2
	var_515_bool = var_513_bool == 0; // 0x25f Not
	if(var_515_bool == 0) goto Label_610; // 0x260 JumpB
...
Label_610:
	...
	var_516_float = var_31_float * var_31_float; // 0x268 Mult
	var_517_bool = var_50_float < var_516_float; // 0x269 LT
	if(var_517_bool == 0) goto Label_626; // 0x26a JumpB
	var_518_bool = 0; var_519_float = 0; // 0x26b PushV
	var_519_float = var_31_float; // 0x26c Mov
	func_727(var_53_float, var_518_bool, var_519_float); // 0x26d NEW_2
	var_520_bool = var_518_bool == 0; // 0x26f Not
	if(var_520_bool == 0) goto Label_626; // 0x270 JumpB
	goto Label_636; // 0x271 Jump
	
Label_627:
	var_521_bool = 0; var_522_float = 0; // 0x273 PushV
	var_522_float = var_31_float; // 0x274 Mov
	func_727(var_53_float, var_521_bool, var_522_float); // 0x275 NEW_2
	var_523_bool = var_521_bool == 0; // 0x277 Not
	if(var_523_bool == 0) goto Label_634; // 0x278 JumpB
...
func_1458(var_40_string)
{
	...
	func_1951(var_41_string); // 0x5bf NEW_2
...
{
	var_55_float = 0; var_56_float = 0; // 0x7ce PushV
	var_57_int = var_48_cvector | var_48_cvector; // 0x7cf Or
	var_56_float = sqrt(var_57_int); // 0x7d0 Sqrt2
	var_58_float = 0.0; // 0x7d1 PushF
	var_59_bool = var_56_float < var_58_float; // 0x7d2 LT
	if(var_59_bool == 0) goto Label_2006; // 0x7d3 JumpB
	var_47_cvector = CVector(0.0, 0.0, 0.0); // 0x7d4 MovV
	return 2; // 0x7d5 Return
	
Label_2006:
	var_47_cvector = var_48_cvector / var_48_cvector; // 0x7d6 Div2
...
{
	var_444_bool = var_440_float < var_441_float; // 0x7d9 LT
	if(var_444_bool == 0) goto Label_2013; // 0x7da JumpB
	var_439_float = var_440_float; // 0x7db Mov
...
Label_2013:
	var_439_float = var_441_float; // 0x7dd Mov
}


func_2015(var_449_float, var_450_float, var_451_float, var_452_float)
{
	var_453_bool = var_450_float < var_451_float; // 0x7e0 LT
	if(var_453_bool == 0) goto Label_2020; // 0x7e1 JumpB
	var_449_float = var_451_float; // 0x7e2 Mov
	return 0; // 0x7e3 Return
	
Label_2020:
	var_454_bool = var_450_float > var_452_float; // 0x7e4 GT
	if(var_454_bool == 0) goto Label_2024; // 0x7e5 JumpB
	var_449_float = var_452_float; // 0x7e6 Mov
	return 0; // 0x7e7 Return
	
Label_2024:
	var_449_float = var_450_float; // 0x7e8 Mov
...
{
	var_458_object = Obj(); var_459_object = Obj(); // 0x7ea PushV
	CreateFloatVector(var_459_object); // 0x7eb Func
	add(var_457_float); // 0x7ed ObjFunc
	var_460_int = 0; // 0x7ef PushI
	var_461_bool = var_457_float < var_460_int; // 0x7f0 LT
	if(var_461_bool == 0) goto Label_2038; // 0x7f1 JumpB
	var_462_float = 0.7; // 0x7f2 PushF
	var_463_int = 500; // 0x7f3 PushI
	RumblePlay(var_462_float, var_463_int); // 0x7f4 Func
	
Label_2038:
	var_464_int = 15; // 0x7f6 PushI
	SendWorldWndMessage(var_464_int, var_459_object); // 0x7f7 Func
...
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x7fb PushV
	FindActor(var_23_object, var_20_string); // 0x7fc Func
	var_24_bool = var_23_object == 0; // 0x7fe NullEq
	if(var_24_bool == 0) goto Label_2050; // 0x7ff JumpB
	var_19_bool = 0; // 0x800 MovB
	return 2; // 0x801 Return
	
Label_2050:
	Trigger(var_23_object, var_21_string); // 0x802 Func
	var_19_bool = 1; // 0x804 MovB
...
Label_1574:
	...
	func_2008(var_439_float, var_440_float, var_441_float); // 0x62b NEW_2
	...
	func_2015(var_449_float, var_450_float, var_451_float, var_452_float); // 0x639 NEW_2
	...
	func_2026(var_457_float); // 0x644 NEW_2
...
Label_1554:
	var_465_string = "armor"; // 0x612 PushS
	GetProperty(var_465_string, var_414_int); // 0x613 ObjFunc
}
