...
0x6dc: Push("Can't find lsh animation : ")
...
0x6eb: Push("Can't find lsh animation : ")
...
0x793: Stack[-1] = "ui/NPC_Citizen1.png"
0x794: Return(); Pop(0)

0x795: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x796: Return(); Pop(0)
...
0x79f: Stack[-2] = "quest_d1_03"
0x7a0: Stack[-1] = "butcher_fail"
0x7a1: Call2 0x75e
...
0x7a6: Stack[-2] = "quest_d1_03"
0x7a7: Stack[-1] = "butcher_death"
0x7a8: Call2 0x75e
...
0x7b3: Stack[-3] = Stack[-7]
0x7b4: Stack[-2] = Stack[-6]
...
0x7bb: Stack[-5] = Stack[-11]
0x7bc: Stack[-4] = Stack[-10]
0x7bd: Stack[-3] = Stack[-9]
0x7be: Stack[-2] = Stack[-7]
