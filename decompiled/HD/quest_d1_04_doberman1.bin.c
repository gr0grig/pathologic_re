task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_bool, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_3126(var_25_object); // 0xc3 NEW_2
...
Label_463:
	...
	func_3688(var_162_bool); // 0x1d1 NEW_2
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3624(var_22_object); // 0x1ee NEW_2
	...
	func_3627(var_25_object); // 0x1f6 NEW_2
...
task_3_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3624(var_22_object); // 0x293 NEW_2
...
Label_671:
	...
	func_3627(var_28_object); // 0x2a1 NEW_2
...
task_3_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3510(var_21_object); // 0x2a7 NEW_2
	var_30_int = 0; var_31_object = Obj(); // 0x2a9 PushV
	var_31_object = var_18_bool; // 0x2aa Mov
	func_3593(var_30_int, var_31_object); // 0x2ab NEW_2
...
Label_695:
	...
	func_3603(var_71_object); // 0x2b9 NEW_2
...
task_3_event_30(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_bool, var_11_object, var_12_object, var_13_int, var_14_int, var_15_bool, var_16_float, var_17_int, var_18_bool, var_19_object, var_20_bool)
{
	...
	func_3718(var_26_bool); // 0x2c1 NEW_2
	...
	func_3611(var_28_object, var_29_bool); // 0x2c7 NEW_2
...
Label_723:
	...
	func_3618(var_71_object); // 0x2d5 NEW_2
...
task_3_event_40(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3670(var_22_object); // 0x2db NEW_2
...
task_3_event_42(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_string, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_3424(var_22_bool, var_23_object, var_24_string); // 0x2f0 NEW_2
	...
	func_3456(var_51_object, var_52_string); // 0x2f9 NEW_2
...
Label_764:
	...
	func_3634(var_129_object); // 0x2ff NEW_2
...
task_3_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_string, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3523(var_19_bool, var_20_string); // 0x314 NEW_2
	...
	func_3539(var_29_string); // 0x31c NEW_2
...
task_3_event_1(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3481(var_19_bool, var_20_object); // 0x322 NEW_2
	...
	func_3504(var_32_object); // 0x32a NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3624(var_22_object); // 0x3ec NEW_2
...
Label_1016:
	...
	func_3627(var_27_object); // 0x3fa NEW_2
...
task_4_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3510(var_21_object); // 0x400 NEW_2
	var_30_int = 0; var_31_object = Obj(); // 0x402 PushV
	var_31_object = var_18_bool; // 0x403 Mov
	func_3593(var_30_int, var_31_object); // 0x404 NEW_2
...
Label_1040:
	...
	func_3603(var_70_object); // 0x412 NEW_2
...
task_4_event_30(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_bool, var_11_object, var_12_object, var_13_int, var_14_int, var_15_bool, var_16_float, var_17_int, var_18_bool, var_19_object, var_20_bool)
{
	...
	func_3718(var_26_bool); // 0x41a NEW_2
	...
	func_3611(var_28_object, var_29_bool); // 0x420 NEW_2
...
Label_1068:
	...
	func_3618(var_70_object); // 0x42e NEW_2
...
task_4_event_40(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3670(var_22_object); // 0x434 NEW_2
...
task_4_event_42(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_string, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_3424(var_22_bool, var_23_object, var_24_string); // 0x449 NEW_2
	...
	func_3456(var_50_object, var_51_string); // 0x452 NEW_2
...
Label_1109:
	...
	func_3634(var_128_object); // 0x458 NEW_2
...
task_4_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_string, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3523(var_19_bool, var_20_string); // 0x46d NEW_2
	...
	func_3539(var_28_string); // 0x475 NEW_2
...
task_4_event_1(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3481(var_19_bool, var_20_object); // 0x482 NEW_2
	...
	func_3504(var_31_object); // 0x48a NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3624(var_22_object); // 0x51e NEW_2
...
Label_1322:
	...
	func_3627(var_29_object); // 0x52c NEW_2
...
task_5_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3510(var_21_object); // 0x532 NEW_2
	var_30_int = 0; var_31_object = Obj(); // 0x534 PushV
	var_31_object = var_18_bool; // 0x535 Mov
	func_3593(var_30_int, var_31_object); // 0x536 NEW_2
...
Label_1346:
	...
	func_3603(var_72_object); // 0x544 NEW_2
...
task_5_event_30(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_bool, var_12_object, var_13_int, var_14_int, var_15_bool, var_16_float, var_17_int, var_18_bool, var_19_object, var_20_bool)
{
	...
	func_3718(var_26_bool); // 0x54c NEW_2
	...
	func_3611(var_28_object, var_29_bool); // 0x552 NEW_2
...
Label_1374:
	...
	func_3618(var_72_object); // 0x560 NEW_2
...
task_5_event_40(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3670(var_22_object); // 0x566 NEW_2
...
task_5_event_42(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_string, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_3424(var_22_bool, var_23_object, var_24_string); // 0x57b NEW_2
	...
	func_3456(var_52_object, var_53_string); // 0x584 NEW_2
...
Label_1415:
	...
	func_3634(var_130_object); // 0x58a NEW_2
...
task_5_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_string, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3523(var_19_bool, var_20_string); // 0x59f NEW_2
	...
	func_3539(var_30_string); // 0x5a7 NEW_2
...
Label_1485:
	...
	func_3052(var_68_float, var_69_cvector, var_70_cvector); // 0x5d7 NEW_2
...
task_5_event_1(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_3481(var_19_bool, var_20_object); // 0x5eb NEW_2
	...
	func_3504(var_33_object); // 0x5f3 NEW_2
...
task_7_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool, var_18_int)
{
	...
	func_3100(var_21_object); // 0x8d8 NEW_2
...
Label_2293:
	...
	func_2909(var_22_object); // 0x8f9 NEW_2
...
{
	var_20_float = 0; var_21_float = 0; // 0xd3b PushV
	var_22_string = "health"; // 0xd3c PushS
	var_23_bool = var_19_string == var_22_string; // 0xd3d Eq
	if(var_23_bool == 0) goto Label_3399; // 0xd3e JumpB
	var_24_string = "health"; // 0xd3f PushS
	GetProperty(var_24_string, var_21_float); // 0xd40 Func
	var_25_int = 0; // 0xd42 PushI
	var_26_bool = var_21_float <= var_25_int; // 0xd43 LE
	if(var_26_bool == 0) goto Label_3399; // 0xd44 JumpB
	SignalDeath(var_18_object); // 0xd45 Func
	
Label_3399:
	return 2; // 0xd47 Return
}
...
{
	var_19_object = Obj(); // 0xd49 PushV
	var_19_object = var_18_object; // 0xd4a Mov
	func_3379(var_19_object); // 0xd4b NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; // 0xd4f PushV
	var_22_object = var_18_object; // 0xd50 Mov
	var_23_int = var_19_int; // 0xd51 Mov
	var_24_float = var_20_float; // 0xd52 Mov
	func_2693(var_22_object, var_23_int, var_24_float); // 0xd53 NEW_2
...
{
	var_24_object = Obj(); var_25_int = 0; var_26_float = 0; var_27_cvector = CVector(0,0,0); var_28_cvector = CVector(0,0,0); // 0xd57 PushV
	var_24_object = var_18_object; // 0xd58 Mov
	var_25_int = var_19_int; // 0xd59 Mov
	var_26_float = var_20_float; // 0xd5a Mov
	var_27_cvector = var_22_cvector; // 0xd5b Mov
	var_28_cvector = var_23_cvector; // 0xd5c Mov
	func_2761(var_26_float, var_27_cvector, var_28_cvector); // 0xd5d NEW_2
...
{
	var_61_object = Obj(); // 0xe02 PushV
	var_61_object = var_60_object; // 0xe03 Mov
	TaskCall(5); // 0xe04 TaskCall
	func_1251(var_62_object, var_61_object); // 0xe05 NEW_2
	TaskReturn(); // 0xe06 TaskReturn
...
Label_1559:
	...
	func_2994(var_136_object); // 0x621 NEW_2
...
Label_1696:
	...
	var_528_string = "all"; // 0x6a2 PushS
	var_529_string = "fjump"; // 0x6a3 PushS
	PlayAnimation(var_528_string, var_529_string); // 0x6a4 Func
	WaitForAnimEnd(); // 0x6a6 Func
	func_2182(var_105_float); // 0x6a9 NEW_2
	var_530_cvector = CVector(0.0, 0.0, 0.0); // 0x6ab PushVec
	SetSpeed(var_530_cvector); // 0x6ac Func
	Stop(); // 0x6ae Func
	StopAsync(); // 0x6b0 Func
	var_531_bool = 0; // 0x6b2 PushV
	func_2139(var_105_float, var_531_bool); // 0x6b3 NEW_2
	var_532_bool = var_531_bool == 0; // 0x6b5 Not
	if(var_532_bool == 0) goto Label_1742; // 0x6b6 JumpB
	var_533_bool = 0; var_534_object = Obj(); // 0x6b7 PushV
	var_534_object = var_0_object; // 0x6b8 MovT
	func_2625(var_533_bool, var_534_object); // 0x6b9 NEW_2
	var_535_bool = var_533_bool == 0; // 0x6bb Not
	if(var_535_bool == 0) goto Label_1726; // 0x6bc JumpB
...
Label_1726:
	...
	var_536_float = var_83_float * var_83_float; // 0x6c4 Mult
	var_537_bool = var_102_float < var_536_float; // 0x6c5 LT
	if(var_537_bool == 0) goto Label_1742; // 0x6c6 JumpB
	var_538_bool = 0; var_539_float = 0; // 0x6c7 PushV
	var_539_float = var_83_float; // 0x6c8 Mov
	func_1843(var_105_float, var_538_bool, var_539_float); // 0x6c9 NEW_2
	var_540_bool = var_538_bool == 0; // 0x6cb Not
	if(var_540_bool == 0) goto Label_1742; // 0x6cc JumpB
	goto Label_1752; // 0x6cd Jump
	
Label_1743:
	var_541_bool = 0; var_542_float = 0; // 0x6cf PushV
	var_542_float = var_83_float; // 0x6d0 Mov
	func_1843(var_105_float, var_541_bool, var_542_float); // 0x6d1 NEW_2
	var_543_bool = var_541_bool == 0; // 0x6d3 Not
	if(var_543_bool == 0) goto Label_1750; // 0x6d4 JumpB
...
{
	var_478_object = Obj(); var_479_object = Obj(); // 0xc02 PushV
	CreateFloatVector(var_479_object); // 0xc03 Func
	add(var_477_float); // 0xc05 ObjFunc
	var_480_int = 0; // 0xc07 PushI
	var_481_bool = var_477_float < var_480_int; // 0xc08 LT
	if(var_481_bool == 0) goto Label_3086; // 0xc09 JumpB
	var_482_float = 0.7; // 0xc0a PushF
	var_483_int = 500; // 0xc0b PushI
	RumblePlay(var_482_float, var_483_int); // 0xc0c Func
	
Label_3086:
	var_484_int = 15; // 0xc0e PushI
	SendWorldWndMessage(var_484_int, var_479_object); // 0xc0f Func
...
{
	var_32_bool = 0; var_33_object = Obj(); // 0xe0a PushV
	var_33_object = var_31_object; // 0xe0b Mov
	func_2625(var_32_bool, var_33_object); // 0xe0c NEW_2
	if(var_32_bool == 0) goto Label_3601; // 0xe0e JumpB
	var_30_int = 2; // 0xe0f MovI
	goto Label_3602; // 0xe10 Jump
	
Label_3602:
	return 0; // 0xe12 Return
	
Label_3601:
	var_30_int = 0; // 0xe11 MovI
}


func_3603(var_73_object)
{
	var_74_object = Obj(); // 0xe14 PushV
	var_74_object = var_73_object; // 0xe15 Mov
	TaskCall(6); // 0xe16 TaskCall
	func_1526(var_74_object); // 0xe17 NEW_2
...
{
	var_29_float = 0; var_30_float = 0; // 0xc13 PushV
	GetGameTime(var_30_float); // 0xc14 Func
	var_31_int = 1; // 0xc16 PushI
	var_32_int = 0; // 0xc17 PushV
	var_33_int = 24; // 0xc18 PushI
	var_32_int = var_30_float / var_30_float; // 0xc19 Div2
	var_28_int = var_31_int + var_32_int; // 0xc1a Add2
...
{
	var_30_int = 0; var_31_object = Obj(); // 0xe1c PushV
	var_31_object = var_28_object; // 0xe1d Mov
	func_3593(var_30_int, var_31_object); // 0xe1e NEW_2
	var_27_int = var_30_int; // 0xe1f Mov
...
{
	var_22_bool = 0; var_23_bool = 0; // 0xc1c PushV
	IsPlayerActor(var_21_object, var_23_bool); // 0xc1d Func
	var_24_bool = var_23_bool; // 0xc1f Push
	if(var_24_bool == 0) goto Label_3108; // 0xc20 JumpB
	var_25_string = "attack"; // 0xc21 PushS
	PlayGlobalMusic(var_25_string); // 0xc22 Func
	
Label_3108:
	return 2; // 0xc24 Return
}
...
{
	var_73_object = Obj(); // 0xe23 PushV
	var_73_object = var_72_object; // 0xe24 Mov
	func_3603(var_73_object); // 0xe25 NEW_2
...
func_3109()
{
	var_382_object = Obj(); var_383_object = Obj(); // 0xc25 PushV
	GetScene(var_383_object); // 0xc26 Func
	var_384_string = "battle"; // 0xc28 PushS
	var_385_object = Obj(); // 0xc29 PushV
	func_2994(var_385_object); // 0xc2a NEW_2
	BroadcastMessage(var_384_string, var_385_object, var_383_object); // 0xc2c Func
...
{
	var_30_object = Obj(); // 0xe2c PushV
	var_30_object = var_29_object; // 0xe2d Mov
	func_3698(var_30_object); // 0xe2e NEW_2
...
func_3120()
{
	var_132_string = "ood1Doberman1_1"; // 0xc31 PushS
	var_133_int = 1; // 0xc32 PushI
	SetVariable(var_132_string, var_133_int); // 0xc33 Func
...
{
	var_124_int = 0; var_125_string = ""; // 0xc37 PushV
	var_125_string = "ood1Doberman1_1"; // 0xc38 MovS
	func_3069(var_124_int, var_125_string); // 0xc39 NEW_2
	var_128_int = 0; // 0xc3b PushI
	var_129_bool = var_124_int == var_128_int; // 0xc3c Eq
	if(var_129_bool == 0) goto Label_3136; // 0xc3d JumpB
	var_122_bool = 1; // 0xc3e MovB
	return 0; // 0xc3f Return
	
Label_3136:
	var_122_bool = 0; // 0xc40 MovB
...
{
	var_33_bool = 0; var_34_bool = 0; // 0xe3c PushV
	CanSee(var_34_bool, var_32_object); // 0xe3d Func
	var_31_bool = 1; // 0xe3f MovB
	var_35_bool = var_34_bool; // 0xe40 Push
	if(var_35_bool == 0) goto Label_3658; // 0xe41 JumpB
	var_36_float = 0; var_37_object = Obj(); // 0xe42 PushV
	var_37_object = var_32_object; // 0xe43 Mov
	func_2486(var_37_object); // 0xe44 NEW_2
	var_44_int = 2250000; // 0xe46 PushI
	var_45_bool = var_36_float <= var_44_int; // 0xe47 LE
	if(var_45_bool == 0) goto Label_3658; // 0xe48 JumpB
	var_31_bool = 0; // 0xe49 MovB
	
Label_3658:
	return 2; // 0xe4a Return
}
...
{
	var_107_int = 0; var_108_int = 0; // 0xc42 PushV
	var_109_string = "branch"; // 0xc43 PushS
	GetVariable(var_109_string, var_108_int); // 0xc44 Func
	var_110_int = 0; // 0xc46 PushI
	var_111_bool = var_108_int == var_110_int; // 0xc47 Eq
	if(var_111_bool == 0) goto Label_3148; // 0xc48 JumpB
	var_106_int = 1; // 0xc49 MovI
	return 2; // 0xc4a Return
	
Label_3148:
	var_112_int = 1; // 0xc4c PushI
	var_113_bool = var_108_int == var_112_int; // 0xc4d Eq
	if(var_113_bool == 0) goto Label_3153; // 0xc4e JumpB
	var_106_int = 2; // 0xc4f MovI
	return 2; // 0xc50 Return
	
Label_3153:
	var_106_int = 3; // 0xc51 MovI
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_115_object, var_116_object)
{
	...
	func_3126(var_123_object); // 0x52 NEW_2
...
Label_141:
	...
	func_2878(var_160_string); // 0x8f NEW_2
...
{
	var_60_object = Obj(); // 0xe4c PushV
	var_60_object = var_59_object; // 0xe4d Mov
	func_3585(var_60_object); // 0xe4e NEW_2
...
{
	var_126_int = 0; var_127_int = 0; // 0xbfd PushV
	GetVariable(var_125_string, var_127_int); // 0xbfe Func
	var_124_int = var_127_int; // 0xc00 Mov
...
{
	var_158_int = 0; var_159_int = 0; // 0xc53 PushV
	var_160_string = "branch"; // 0xc54 PushS
	GetVariable(var_160_string, var_159_int); // 0xc55 Func
	var_157_int = var_159_int; // 0xc57 Mov
...
func_600(var_43_string)
{
	...
	func_2953(var_44_string); // 0x265 NEW_2
...
{
	var_36_int = 0; // 0xc5a PushV
	func_3155(var_36_int); // 0xc5b NEW_2
	var_40_int = 1; // 0xc5d PushI
	var_41_bool = var_36_int == var_40_int; // 0xc5e Eq
	if(var_41_bool == 0) goto Label_3171; // 0xc5f JumpB
	WorkWithCorpse(var_35_object); // 0xc60 Func
	goto Label_3173; // 0xc62 Jump
	
Label_3173:
	return 0; // 0xc65 Return
	
Label_3171:
	Barter(var_35_object); // 0xc63 Func
}
...
{
	var_104_string = "ui/NPC_Citizen2.png"; // 0xe64 MovS
...
{
	var_105_string = "ui/NPC_Citizen2_b.png"; // 0xe66 MovS
...
{
	var_126_int = 0; var_127_bool = 0; var_128_int = 0; var_129_bool = 0; // 0xc66 PushV
	var_130_bool = var_115_int > var_116_int; // 0xc67 GT
	if(var_130_bool == 0) goto Label_3181; // 0xc68 JumpB
	var_131_string = "GenerateMoney: iMin > iMax"; // 0xc69 PushS
	Trace(var_131_string); // 0xc6a Func
	return 4; // 0xc6c Return
	
Label_3181:
	var_128_int = 0; // 0xc6d MovI
	var_132_bool = var_115_int != var_116_int; // 0xc6e Neq
	if(var_132_bool == 0) goto Label_3188; // 0xc6f JumpB
	var_133_int = var_116_int - var_115_int; // 0xc70 Sub
	irand(var_128_int, var_133_int); // 0xc71 Func
	goto Label_3192; // 0xc73 Jump
	
Label_3192:
	var_128_int = var_128_int + var_115_int; // 0xc78 Add2
	var_134_int = 0; // 0xc79 PushI
	var_135_bool = var_128_int == var_134_int; // 0xc7a Eq
	if(var_135_bool == 0) goto Label_3197; // 0xc7b JumpB
	return 4; // 0xc7c Return
	
Label_3197:
	var_136_int = 0; var_137_string = ""; // 0xc7d PushV
	var_137_string = "Money"; // 0xc7e MovS
	func_3374(var_136_int, var_137_string); // 0xc7f NEW_2
	var_140_int = 0; // 0xc81 PushI
	AddItem(var_129_bool, var_136_int, var_140_int, var_128_int); // 0xc82 Func
	return 4; // 0xc84 Return
	
Label_3188:
	var_141_int = 0; // 0xc74 PushI
	var_142_bool = var_115_int == var_141_int; // 0xc75 Eq
	if(var_142_bool == 0) goto Label_3192; // 0xc76 JumpB
...
func_3690()
{
	var_19_bool = GlobalVars[0]; // 0xe6a PushGE
	var_19_bool = 0; // 0xe6b MovB
	GlobalVars[0] = var_19_bool; // 0xe6c PopGE
	var_20_bool = 0; // 0xe6d PushV
	var_20_bool = 1; // 0xe6e MovB
	func_3274(var_20_bool); // 0xe6f NEW_2
...
{
	var_31_bool = 0; var_32_bool = 0; // 0xe72 PushV
	var_33_bool = GlobalVars[0]; // 0xe73 PushGE
	if(var_33_bool == 0) goto Label_3711; // 0xe74 JumpB
	IsOverrideActive(var_32_bool); // 0xe75 Func
	var_34_bool = var_32_bool == 0; // 0xe77 Not
	if(var_34_bool == 0) goto Label_3709; // 0xe78 JumpB
	var_35_object = Obj(); // 0xe79 PushV
	var_35_object = var_30_object; // 0xe7a Mov
	func_3161(var_35_object); // 0xe7b NEW_2
	
Label_3709:
	return 2; // 0xe7d Return
	
Label_3711:
	var_42_object = Obj(); // 0xe7f PushV
	var_42_object = var_30_object; // 0xe80 Mov
	func_3749(var_42_object); // 0xe81 NEW_2
	return 2; // 0xe83 Return
}


func_3716(var_63_bool)
{
	var_63_bool = 0; // 0xe84 MovB
...
{
	var_164_object = Obj(); var_165_int = 0; var_166_bool = 0; var_167_object = Obj(); var_168_int = 0; var_169_bool = 0; // 0xc85 PushV
	CreateInvItem(var_167_object); // 0xc86 Func
	SetItemName(var_163_string); // 0xc88 ObjFunc
	var_170_string = "Organ"; // 0xc8a PushS
	var_171_int = 1; // 0xc8b PushI
	SetProperty(var_170_string, var_171_int); // 0xc8c ObjFunc
	GetItemID(var_168_int); // 0xc8e ObjFunc
	var_172_int = 0; // 0xc90 PushI
	var_173_int = 1; // 0xc91 PushI
	AddItem(var_169_bool, var_167_object, var_172_int, var_173_int); // 0xc92 Func
	return 6; // 0xc94 Return
}


func_3718(var_23_bool)
{
	var_23_bool = 1; // 0xe87 MovB
...
func_2182(var_0_object)
{
	...
	func_3100(var_145_object); // 0x888 NEW_2
...
{
	var_102_bool = 0; var_103_object = Obj(); // 0xe8a PushV
	var_103_object = var_101_object; // 0xe8b Mov
	func_2494(var_102_bool, var_103_object); // 0xe8c NEW_2
	if(var_102_bool == 0) goto Label_3738; // 0xe8e JumpB
	var_106_object = Obj(); // 0xe8f PushV
	func_2994(var_106_object); // 0xe90 NEW_2
	var_109_float = -0.1; // 0xe92 PushF
	var_110_bool = 1; // 0xe93 PushB
	ReportReputationChange(var_101_object, var_106_object, var_109_float, var_110_bool); // 0xe94 Func
	var_111_bool = 0; // 0xe96 PushV
	var_111_bool = 1; // 0xe97 MovB
	func_3246(); // 0xe98 NEW_2
	
Label_3738:
	func_3222(); // 0xe9b NEW_2
	var_177_bool = GlobalVars[0]; // 0xe9d PushGE
	var_177_bool = 1; // 0xe9e MovB
	GlobalVars[0] = var_177_bool; // 0xe9f PopGE
	var_178_int = 50; // 0xea0 PushI
	var_179_int = 40; // 0xea1 PushI
	SetRTEnvelope(var_178_int, var_179_int); // 0xea2 Func
...
Label_2709:
	...
	func_3000(var_50_cvector, var_51_cvector); // 0xa9c NEW_2
...
Label_1174:
	...
	func_3559(var_148_int); // 0x497 NEW_2
...
Label_1189:
	...
	func_3552(var_170_string, var_171_int); // 0x4b3 NEW_2
...
func_2189()
{
	...
	func_2953(var_278_string); // 0x88f NEW_2
...
func_3222()
{
	var_157_int = 0; // 0xc96 PushV
	func_3155(var_157_int); // 0xc97 NEW_2
	var_161_int = 1; // 0xc99 PushI
	var_162_bool = var_157_int != var_161_int; // 0xc9a Neq
	if(var_162_bool == 0) goto Label_3229; // 0xc9b JumpB
	return 0; // 0xc9c Return
	
Label_3229:
	var_163_string = ""; // 0xc9d PushV
	var_163_string = "liver"; // 0xc9e MovS
	func_3205(var_163_string); // 0xc9f NEW_2
	var_174_string = ""; // 0xca1 PushV
	var_174_string = "kidney"; // 0xca2 MovS
	func_3205(var_174_string); // 0xca3 NEW_2
	var_175_string = ""; // 0xca5 PushV
	var_175_string = "heart"; // 0xca6 MovS
	func_3205(var_175_string); // 0xca7 NEW_2
	var_176_string = ""; // 0xca9 PushV
	var_176_string = "blood"; // 0xcaa MovS
	func_3205(var_176_string); // 0xcab NEW_2
...
func_2209(var_2_object, var_152_bool, var_153_object, var_154_float, var_155_float, var_156_bool, var_157_bool)
{
	...
	func_3100(var_165_object); // 0x8a4 NEW_2
	...
	func_2909(var_169_object); // 0x8b1 NEW_2
...
Label_2229:
	...
	func_2994(var_180_object); // 0x8bb NEW_2
...
func_162(var_2_object, var_134_string)
{
	...
	func_3688(var_135_bool); // 0xa4 NEW_2
...
Label_180:
	func_2894(var_138_string, var_139_bool); // 0xb4 NEW_2
...
{
	var_43_int = 0; var_44_object = Obj(); // 0xea6 PushV
	var_44_object = var_42_object; // 0xea7 Mov
	TaskCall(0); // 0xea8 TaskCall
	func_0(var_45_object, var_43_int, var_44_object); // 0xea9 NEW_2
	TaskReturn(); // 0xeaa TaskReturn
...
func_3246()
{
	var_112_bool = 0; var_113_bool = 0; // 0xcae PushV
	var_114_int = 0; // 0xcaf PushI
	ClearSubContainer(var_114_int); // 0xcb0 Func
	var_115_int = 0; var_116_int = 0; // 0xcb2 PushV
	var_115_int = 0; // 0xcb3 MovI
	var_117_int = 10; // 0xcb4 PushI
	var_118_int = 0; // 0xcb5 PushV
	func_3091(var_118_int); // 0xcb6 NEW_2
	var_124_int = 10; // 0xcb8 PushI
	var_125_float = var_118_int * var_124_int; // 0xcb9 Mult
	var_116_int = var_117_int + var_125_float; // 0xcba Add2
	func_3174(var_115_int, var_116_int); // 0xcbb NEW_2
	var_143_string = ""; var_144_int = 0; var_145_int = 0; // 0xcbd PushV
	var_143_string = "hook"; // 0xcbe MovS
	var_144_int = 1; // 0xcbf MovI
	var_145_int = 4; // 0xcc0 MovI
	func_2927(var_143_string, var_144_int, var_145_int); // 0xcc1 NEW_2
	var_154_string = ""; var_155_int = 0; var_156_int = 0; // 0xcc3 PushV
	var_154_string = "watch"; // 0xcc4 MovS
	var_155_int = 1; // 0xcc5 MovI
	var_156_int = 10; // 0xcc6 MovI
	func_2927(var_154_string, var_155_int, var_156_int); // 0xcc7 NEW_2
...
{
	var_21_int = 0; var_22_bool = 0; var_23_int = 0; var_24_int = 0; var_25_bool = 0; var_26_int = 0; // 0xcca PushV
	var_27_int = 0; // 0xccb PushI
	ClearSubContainer(var_27_int); // 0xccc Func
	var_28_int = 0; // 0xcce PushV
	func_3091(var_28_int); // 0xccf NEW_2
	var_26_int = var_28_int; // 0xcd0 Mov
	var_34_bool = var_20_bool; // 0xcd2 Push
	if(var_34_bool == 0) goto Label_3328; // 0xcd3 JumpB
	var_35_string = ""; var_36_int = 0; var_37_int = 0; var_38_int = 0; // 0xcd4 PushV
	var_35_string = "alpha_pills"; // 0xcd5 MovS
	var_36_int = 1; // 0xcd6 MovI
	var_37_int = 2; // 0xcd7 MovI
	var_38_int = 4; // 0xcd8 MovI
	func_2938(var_35_string, var_36_int, var_37_int, var_38_int); // 0xcd9 NEW_2
	var_51_string = ""; var_52_int = 0; var_53_int = 0; var_54_int = 0; // 0xcdb PushV
	var_51_string = "meradorm"; // 0xcdc MovS
	var_52_int = 2; // 0xcdd MovI
	var_53_int = 3; // 0xcde MovI
	var_54_int = 3; // 0xcdf MovI
	func_2938(var_51_string, var_52_int, var_53_int, var_54_int); // 0xce0 NEW_2
	var_55_int = 3; // 0xce2 PushI
	var_56_bool = var_26_int >= var_55_int; // 0xce3 GE
	if(var_56_bool == 0) goto Label_3307; // 0xce4 JumpB
	var_57_string = ""; var_58_int = 0; var_59_int = 0; // 0xce5 PushV
	var_57_string = "beta_pills"; // 0xce6 MovS
	var_58_int = 1; // 0xce7 MovI
	var_59_int = 4; // 0xce8 MovI
	func_2927(var_57_string, var_58_int, var_59_int); // 0xce9 NEW_2
	
Label_3307:
	var_66_int = 8; // 0xceb PushI
	var_67_bool = var_26_int >= var_66_int; // 0xcec GE
	if(var_67_bool == 0) goto Label_3318; // 0xced JumpB
	var_68_string = ""; var_69_int = 0; var_70_int = 0; var_71_int = 0; // 0xcee PushV
	var_68_string = "monomicin"; // 0xcef MovS
	var_69_int = 1; // 0xcf0 MovI
	var_70_int = 2; // 0xcf1 MovI
	var_71_int = 2; // 0xcf2 MovI
	func_2938(var_68_string, var_69_int, var_70_int, var_71_int); // 0xcf3 NEW_2
	goto Label_3327; // 0xcf5 Jump
	
Label_3327:
	goto Label_3373; // 0xcff Jump
	
Label_3373:
	return 6; // 0xd2d Return
	
Label_3318:
	var_72_int = 4; // 0xcf6 PushI
	var_73_bool = var_26_int >= var_72_int; // 0xcf7 GE
	if(var_73_bool == 0) goto Label_3327; // 0xcf8 JumpB
	var_74_string = ""; var_75_int = 0; var_76_int = 0; // 0xcf9 PushV
	var_74_string = "monomicin"; // 0xcfa MovS
	var_75_int = 1; // 0xcfb MovI
	var_76_int = 2; // 0xcfc MovI
	func_2927(var_74_string, var_75_int, var_76_int); // 0xcfd NEW_2
	
Label_3328:
	var_77_string = ""; var_78_int = 0; var_79_int = 0; // 0xd00 PushV
	var_77_string = "lockpick"; // 0xd01 MovS
	var_78_int = 1; // 0xd02 MovI
	var_79_int = 4; // 0xd03 MovI
	func_2927(var_77_string, var_78_int, var_79_int); // 0xd04 NEW_2
	var_80_string = ""; var_81_int = 0; var_82_int = 0; // 0xd06 PushV
	var_80_string = "rifle_ammo"; // 0xd07 MovS
	var_81_int = 1; // 0xd08 MovI
	var_82_int = 2; // 0xd09 MovI
	func_2927(var_80_string, var_81_int, var_82_int); // 0xd0a NEW_2
	var_83_string = ""; var_84_int = 0; var_85_int = 0; // 0xd0c PushV
	var_83_string = "revolver_ammo"; // 0xd0d MovS
	var_84_int = 1; // 0xd0e MovI
	var_85_int = 2; // 0xd0f MovI
	func_2927(var_83_string, var_84_int, var_85_int); // 0xd10 NEW_2
	var_86_string = ""; var_87_int = 0; var_88_int = 0; var_89_int = 0; // 0xd12 PushV
	var_86_string = "samopal_ammo"; // 0xd13 MovS
	var_87_int = 1; // 0xd14 MovI
	var_88_int = 2; // 0xd15 MovI
	var_89_int = 2; // 0xd16 MovI
	func_2938(var_86_string, var_87_int, var_88_int, var_89_int); // 0xd17 NEW_2
	var_90_int = 8; // 0xd19 PushI
	var_91_bool = var_26_int >= var_90_int; // 0xd1a GE
	if(var_91_bool == 0) goto Label_3364; // 0xd1b JumpB
	var_92_string = ""; var_93_int = 0; var_94_int = 0; var_95_int = 0; // 0xd1c PushV
	var_92_string = "monomicin"; // 0xd1d MovS
	var_93_int = 1; // 0xd1e MovI
	var_94_int = 2; // 0xd1f MovI
	var_95_int = 2; // 0xd20 MovI
	func_2938(var_92_string, var_93_int, var_94_int, var_95_int); // 0xd21 NEW_2
	goto Label_3373; // 0xd23 Jump
	
Label_3364:
	var_96_int = 4; // 0xd24 PushI
	var_97_bool = var_26_int >= var_96_int; // 0xd25 GE
	if(var_97_bool == 0) goto Label_3373; // 0xd26 JumpB
	var_98_string = ""; var_99_int = 0; var_100_int = 0; // 0xd27 PushV
	var_98_string = "monomicin"; // 0xd28 MovS
	var_99_int = 1; // 0xd29 MovI
	var_100_int = 2; // 0xd2a MovI
	func_2927(var_98_string, var_99_int, var_100_int); // 0xd2b NEW_2
}
...
func_1251(var_0_object, var_61_object)
{
	...
	func_3052(var_82_float, var_83_cvector, var_84_cvector); // 0x4f2 NEW_2
...
func_2791(var_54_bool, var_56_float)
{
	...
	func_3000(var_81_cvector, var_82_cvector); // 0xb02 NEW_2
...
Label_2832:
	...
	var_94_bool = 1; // 0xb12 PushB
	CameraTransit(var_72_cvector, var_70_cvector, var_94_bool); // 0xb13 Func
	var_95_float = GetByIndex(var_71_cvector, 0); // 0xb15 PushE
	var_96_float = GetByIndex(var_71_cvector, 2); // 0xb16 PushE
	Rotate(var_95_float, var_96_float); // 0xb17 Func
	var_97_bool = 0; // 0xb19 PushV
	func_3688(var_97_bool); // 0xb1a NEW_2
	if(var_97_bool == 0) goto Label_2846; // 0xb1c JumpB
	goto Label_2854; // 0xb1d Jump
	
Label_2854:
	CameraWaitForPlayFinish(); // 0xb26 Func
	ResumeWorld(); // 0xb28 Func
	var_54_bool = 1; // 0xb2a MovB
	return 18; // 0xb2b Return
	
Label_2846:
	var_98_string = "head"; // 0xb1e PushS
	HasAnimationTrack(var_74_bool, var_98_string); // 0xb1f Func
	var_99_bool = var_74_bool; // 0xb21 Push
	if(var_99_bool == 0) goto Label_2854; // 0xb22 JumpB
	var_100_string = "head"; // 0xb23 PushS
	LookAsyncCamera(var_100_string); // 0xb24 Func
}
...
func_1804(var_0_object, var_407_float, var_408_int)
{
	...
	var_486_int = 0; // 0x727 PushV
	func_2187(var_486_int); // 0x728 NEW_2
	ReportHit(var_0_object, var_486_int, var_414_float, var_413_float); // 0x72a Func
	var_487_object = Obj(); var_488_float = 0; // 0x72c PushV
	var_487_object = var_412_object; // 0x72d Mov
	var_488_float = var_414_float; // 0x72e Mov
...
func_1302(var_0_object)
{
	...
	func_2909(var_69_object); // 0x518 NEW_2
...
func_2860()
{
	var_186_bool = 0; var_187_bool = 0; // 0xb2c PushV
	var_188_bool = 1; // 0xb2d PushB
	CameraSwitchToNormal(var_188_bool); // 0xb2e Func
	var_189_bool = 0; // 0xb30 PushV
	func_3688(var_189_bool); // 0xb31 NEW_2
	if(var_189_bool == 0) goto Label_2869; // 0xb33 JumpB
	goto Label_2877; // 0xb34 Jump
	
Label_2877:
	return 2; // 0xb3d Return
	
Label_2869:
	var_190_string = "head"; // 0xb35 PushS
	HasAnimationTrack(var_187_bool, var_190_string); // 0xb36 Func
	var_191_bool = var_187_bool; // 0xb38 Push
	if(var_191_bool == 0) goto Label_2877; // 0xb39 JumpB
	var_192_string = "head"; // 0xb3a PushS
	UnlookAsync(var_192_string); // 0xb3b Func
}


func_3374(var_136_int, var_137_string)
{
	var_138_int = 0; var_139_int = 0; // 0xd2e PushV
	GetInvItemByName(var_139_int, var_137_string); // 0xd2f Func
	var_136_int = var_139_int; // 0xd31 Mov
...
Label_1879:
	...
	var_489_string = "all"; // 0x75c PushS
	var_490_string = "attack_middle"; // 0x75d PushS
	var_491_int = var_490_string + var_376_int; // 0x75e Add
	HasAnimation(var_377_bool, var_489_string, var_491_int); // 0x75f Func
	var_492_bool = var_377_bool; // 0x761 Push
	if(var_492_bool == 0) goto Label_1960; // 0x762 JumpB
	func_3109(); // 0x764 NEW_2
	var_493_string = "all"; // 0x766 PushS
	var_494_string = "attack_middle"; // 0x767 PushS
	var_495_int = var_494_string + var_376_int; // 0x768 Add
	PlayAnimation(var_493_string, var_495_int); // 0x769 Func
	WaitForAnimEnd(); // 0x76b Func
	func_2182(var_379_string); // 0x76e NEW_2
	var_496_bool = 0; var_497_object = Obj(); // 0x770 PushV
	var_497_object = var_0_object; // 0x771 MovT
	func_2625(var_496_bool, var_497_object); // 0x772 NEW_2
	var_498_bool = var_496_bool == 0; // 0x774 Not
	if(var_498_bool == 0) goto Label_1914; // 0x775 JumpB
	StopAsync(); // 0x776 Func
	var_370_bool = 0; // 0x778 MovB
	return 8; // 0x779 Return
	
Label_1914:
	var_499_float = 0; var_500_int = 0; // 0x77a PushV
	var_499_float = var_371_float; // 0x77b Mov
	var_500_int = var_376_int; // 0x77c Mov
	func_1804(var_379_string, var_499_float, var_500_int); // 0x77d NEW_2
	var_378_int = 1; // 0x77f MovI
	
Label_1920:
	var_501_string = "attack_middle"; // 0x780 PushS
	var_502_int = var_501_string + var_376_int; // 0x781 Add
	var_503_string = "_"; // 0x782 PushS
	var_504_int = var_502_int + var_503_string; // 0x783 Add
	var_379_string = var_504_int + var_378_int; // 0x784 Add2
	var_505_string = "all"; // 0x785 PushS
	HasAnimation(var_377_bool, var_505_string, var_379_string); // 0x786 Func
	var_506_bool = var_377_bool == 0; // 0x788 Not
	if(var_506_bool == 0) goto Label_1931; // 0x789 JumpB
	goto Label_1960; // 0x78a Jump
	
Label_1960:
	var_507_bool = 0; // 0x7a8 PushB
	SetAttackState(var_507_bool); // 0x7a9 Func
	var_508_string = "all"; // 0x7ab PushS
	var_509_string = "attack_end"; // 0x7ac PushS
	var_510_int = var_509_string + var_376_int; // 0x7ad Add
	PlayAnimation(var_508_string, var_510_int); // 0x7ae Func
	var_511_bool = 0; // 0x7b0 PushV
	func_2196(var_511_bool); // 0x7b1 NEW_2
	if(var_511_bool == 0) goto Label_1978; // 0x7b3 JumpB
	var_512_bool = 0; var_513_float = 0; // 0x7b4 PushV
	var_513_float = 0.75; // 0x7b5 MovF
	func_1980(var_512_bool, var_513_float); // 0x7b6 NEW_2
...
Label_1931:
	func_3109(); // 0x78c NEW_2
	var_521_string = "all"; // 0x78e PushS
	PlayAnimation(var_521_string, var_379_string); // 0x78f Func
	WaitForAnimEnd(); // 0x791 Func
	func_2182(var_379_string); // 0x794 NEW_2
	var_522_bool = 0; var_523_object = Obj(); // 0x796 PushV
	var_523_object = var_0_object; // 0x797 MovT
	func_2625(var_522_bool, var_523_object); // 0x798 NEW_2
	var_524_bool = var_522_bool == 0; // 0x79a Not
	if(var_524_bool == 0) goto Label_1952; // 0x79b JumpB
	StopAsync(); // 0x79c Func
	var_370_bool = 0; // 0x79e MovB
	return 8; // 0x79f Return
	
Label_1952:
	var_525_float = 0; var_526_int = 0; // 0x7a0 PushV
	var_525_float = var_371_float; // 0x7a1 Mov
	var_526_int = var_376_int; // 0x7a2 Mov
	func_1804(var_379_string, var_525_float, var_526_int); // 0x7a3 NEW_2
	var_527_int = 1; // 0x7a5 PushI
	var_378_int = var_378_int + var_527_int; // 0x7a6 Add2
...
{
	var_20_object = Obj(); // 0xd34 PushV
	var_20_object = var_19_object; // 0xd35 Mov
	TaskCall(2); // 0xd36 TaskCall
	func_476(var_20_object); // 0xd37 NEW_2
...
{
	var_161_bool = 0; var_162_float = 0; var_163_float = 0; var_164_bool = 0; var_165_float = 0; var_166_float = 0; // 0xb3e PushV
	lshHasAnimation(var_164_bool, var_160_string); // 0xb3f Func
	var_167_bool = var_164_bool; // 0xb41 Push
	if(var_167_bool == 0) goto Label_2889; // 0xb42 JumpB
	lshGetAnimTimes(var_160_string, var_165_float, var_166_float); // 0xb43 Func
	var_168_bool = 0; // 0xb45 PushB
	lshPlayAnimation(var_165_float, var_166_float, var_168_bool); // 0xb46 Func
	goto Label_2893; // 0xb48 Jump
	
Label_2893:
	return 6; // 0xb4d Return
	
Label_2889:
	var_169_string = "Can't find lsh animation : "; // 0xb49 PushS
	var_170_int = var_169_string + var_160_string; // 0xb4a Add
	Trace(var_170_int); // 0xb4b Func
}
...
{
	var_142_bool = 0; var_143_float = 0; var_144_float = 0; var_145_bool = 0; var_146_float = 0; var_147_float = 0; // 0xb4e PushV
	lshHasAnimation(var_145_bool, var_138_string); // 0xb4f Func
	var_148_bool = var_145_bool; // 0xb51 Push
	if(var_148_bool == 0) goto Label_2904; // 0xb52 JumpB
	lshGetAnimTimes(var_138_string, var_146_float, var_147_float); // 0xb53 Func
	lshPlayAnimation(var_146_float, var_147_float, var_139_bool); // 0xb55 Func
	goto Label_2908; // 0xb57 Jump
	
Label_2908:
	return 6; // 0xb5c Return
	
Label_2904:
	var_149_string = "Can't find lsh animation : "; // 0xb58 PushS
	var_150_int = var_149_string + var_138_string; // 0xb59 Add
	Trace(var_150_int); // 0xb5a Func
}
...
{
	var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_float = 0; var_26_cvector = CVector(0,0,0); // 0xb5d PushV
	GetEyesHeight(var_25_float); // 0xb5e ObjFunc
	var_26_cvector = CVector(0.0, 0.0, 0.0); // 0xb60 MovV
	var_27_float = GetByIndex(var_26_cvector, 1); // 0xb61 PushE
	var_27_float = var_25_float; // 0xb62 Mov
	SetByIndex(var_26_cvector, 1) = var_27_float; // 0xb63 PopE
	var_28_string = "head"; // 0xb64 PushS
	LookAsync(var_22_object, var_28_string, var_26_cvector); // 0xb65 Func
	return 4; // 0xb67 Return
}


func_3424(var_22_bool, var_23_object, var_24_string)
{
	var_25_string = "unholster"; // 0xd61 PushS
	var_26_bool = var_24_string == var_25_string; // 0xd62 Eq
	if(var_26_bool == 0) goto Label_3435; // 0xd63 JumpB
	var_27_bool = 0; var_28_object = Obj(); // 0xd64 PushV
	var_28_object = var_23_object; // 0xd65 Mov
	func_3639(var_28_object); // 0xd66 NEW_2
	var_22_bool = var_27_bool; // 0xd67 Mov
	return 0; // 0xd69 Return
	
Label_3435:
	var_29_string = "player_shot"; // 0xd6b PushS
	var_30_bool = var_24_string == var_29_string; // 0xd6c Eq
	if(var_30_bool == 0) goto Label_3445; // 0xd6d JumpB
	var_31_bool = 0; var_32_object = Obj(); // 0xd6e PushV
	var_32_object = var_23_object; // 0xd6f Mov
	func_3644(var_31_bool, var_32_object); // 0xd70 NEW_2
	var_22_bool = var_31_bool; // 0xd71 Mov
	return 0; // 0xd73 Return
	
Label_3445:
	var_46_string = "battle"; // 0xd75 PushS
	var_47_bool = var_24_string == var_46_string; // 0xd76 Eq
	if(var_47_bool == 0) goto Label_3454; // 0xd77 JumpB
	var_48_bool = 0; var_49_object = Obj(); // 0xd78 PushV
	var_49_object = var_23_object; // 0xd79 Mov
	func_3665(var_49_object); // 0xd7a NEW_2
	var_22_bool = var_48_bool; // 0xd7b Mov
	return 0; // 0xd7d Return
	
Label_3454:
	var_22_bool = 0; // 0xd7e MovB
...
Label_884:
	...
	func_3576(var_62_object); // 0x376 NEW_2
...
Label_898:
	...
	func_3585(var_69_object); // 0x384 NEW_2
...
func_2920()
{
	var_21_bool = 0; // 0xb68 PushV
	func_3688(var_21_bool); // 0xb69 NEW_2
	if(var_21_bool == 0) goto Label_2926; // 0xb6b JumpB
...
{
	var_60_bool = 0; var_61_bool = 0; // 0xb6f PushV
	var_62_bool = 0; var_63_int = 0; var_64_int = 0; // 0xb70 PushV
	var_63_int = var_58_int; // 0xb71 Mov
	var_64_int = var_59_int; // 0xb72 Mov
	func_3028(var_62_bool, var_63_int, var_64_int); // 0xb73 NEW_2
	if(var_62_bool == 0) goto Label_2937; // 0xb75 JumpB
	var_65_int = 0; // 0xb76 PushI
	AddItem(var_61_bool, var_57_string, var_65_int); // 0xb77 Func
...
{
	var_39_int = 0; var_40_bool = 0; var_41_int = 0; var_42_bool = 0; // 0xb7a PushV
	var_43_bool = 0; var_44_int = 0; var_45_int = 0; // 0xb7b PushV
	var_44_int = var_36_int; // 0xb7c Mov
	var_45_int = var_37_int; // 0xb7d Mov
	func_3028(var_43_bool, var_44_int, var_45_int); // 0xb7e NEW_2
	if(var_43_bool == 0) goto Label_2952; // 0xb80 JumpB
	irand(var_41_int, var_38_int); // 0xb81 Func
	var_48_int = 0; // 0xb83 PushI
	var_49_int = 1; // 0xb84 PushI
	var_50_int = var_41_int + var_49_int; // 0xb85 Add
	AddItem(var_42_bool, var_35_string, var_48_int, var_50_int); // 0xb86 Func
...
{
	var_54_string = "unholster"; // 0xd81 PushS
	var_55_bool = var_53_string == var_54_string; // 0xd82 Eq
	if(var_55_bool == 0) goto Label_3465; // 0xd83 JumpB
	var_56_object = Obj(); // 0xd84 PushV
	var_56_object = var_52_object; // 0xd85 Mov
	func_3642(); // 0xd86 NEW_2
	goto Label_3480; // 0xd88 Jump
	
Label_3480:
	return 0; // 0xd98 Return
	
Label_3465:
	var_57_string = "player_shot"; // 0xd89 PushS
	var_58_bool = var_53_string == var_57_string; // 0xd8a Eq
	if(var_58_bool == 0) goto Label_3473; // 0xd8b JumpB
	var_59_object = Obj(); // 0xd8c PushV
	var_59_object = var_52_object; // 0xd8d Mov
	func_3659(var_59_object); // 0xd8e NEW_2
	goto Label_3480; // 0xd90 Jump
	
Label_3473:
	var_125_string = "battle"; // 0xd91 PushS
	var_126_bool = var_53_string == var_125_string; // 0xd92 Eq
	if(var_126_bool == 0) goto Label_3480; // 0xd93 JumpB
	var_127_object = Obj(); // 0xd94 PushV
	var_127_object = var_52_object; // 0xd95 Mov
	func_3668(); // 0xd96 NEW_2
}
...
{
	var_45_bool = 0; var_46_int = 0; var_47_bool = 0; var_48_int = 0; var_49_bool = 0; var_50_float = 0; var_51_cvector = CVector(0,0,0); var_52_cvector = CVector(0,0,0); var_53_bool = 0; var_54_int = 0; var_55_bool = 0; var_56_int = 0; var_57_bool = 0; var_58_float = 0; var_59_cvector = CVector(0,0,0); var_60_cvector = CVector(0,0,0); // 0xb89 PushV
	IsExisting3DSound(var_53_bool, var_44_string); // 0xb8a Func
	var_61_bool = var_53_bool == 0; // 0xb8c Not
	if(var_61_bool == 0) goto Label_2978; // 0xb8d JumpB
	var_54_int = 0; // 0xb8e MovI
	
Label_2959:
	var_62_int = 1; // 0xb8f PushI
	var_63_int = var_54_int + var_62_int; // 0xb90 Add
	var_64_int = var_44_string + var_63_int; // 0xb91 Add
	IsExisting3DSound(var_55_bool, var_64_int); // 0xb92 Func
	var_65_bool = var_55_bool == 0; // 0xb94 Not
	if(var_65_bool == 0) goto Label_2967; // 0xb95 JumpB
	goto Label_2970; // 0xb96 Jump
	
Label_2970:
	var_66_bool = var_54_int == 0; // 0xb9a Not
	if(var_66_bool == 0) goto Label_2973; // 0xb9b JumpB
	return 16; // 0xb9c Return
	
Label_2973:
	irand(var_56_int, var_54_int); // 0xb9d Func
	var_67_int = 1; // 0xb9f PushI
	var_68_int = var_56_int + var_67_int; // 0xba0 Add
	var_44_string = var_44_string + var_68_int; // 0xba1 Add2
	
Label_2978:
	Is3DSoundLoaded(var_57_bool, var_44_string); // 0xba2 Func
	var_69_bool = var_57_bool; // 0xba4 Push
	if(var_69_bool == 0) goto Label_2993; // 0xba5 JumpB
	GetEyesHeight(var_58_float); // 0xba6 Func
	GetDirection(var_59_cvector); // 0xba8 Func
	var_70_int = 50; // 0xbaa PushI
	var_60_cvector = var_59_cvector * var_70_int; // 0xbab Mult2
	var_71_float = GetByIndex(var_60_cvector, 1); // 0xbac PushE
	var_71_float = var_71_float + var_58_float; // 0xbad Add2
	SetByIndex(var_60_cvector, 1) = var_71_float; // 0xbae PopE
	PlayGlobalSound(var_44_string, var_60_cvector); // 0xbaf Func
	
Label_2993:
	return 16; // 0xbb1 Return
	
Label_2967:
	var_72_int = 1; // 0xb97 PushI
	var_54_int = var_54_int + var_72_int; // 0xb98 Add2
	goto Label_2959; // 0xb99 Jump
}
...
{
	var_21_bool = 0; var_22_bool = 0; // 0xd99 PushV
	var_23_bool = 0; // 0xd9a PushV
	var_23_bool = 0; // 0xd9b MovB
	var_24_bool = 0; var_25_object = Obj(); // 0xd9c PushV
	var_25_object = var_20_object; // 0xd9d Mov
	func_3639(var_25_object); // 0xd9e NEW_2
	if(var_24_bool == 0) goto Label_3495; // 0xda0 JumpB
	var_26_bool = 0; var_27_object = Obj(); // 0xda1 PushV
	var_27_object = var_20_object; // 0xda2 Mov
	func_2494(var_26_bool, var_27_object); // 0xda3 NEW_2
	if(var_26_bool == 0) goto Label_3495; // 0xda5 JumpB
	var_23_bool = 1; // 0xda6 MovB
	
Label_3495:
	if(var_23_bool == 0) goto Label_3502; // 0xda7 JumpB
	IsWeaponHolstered(var_22_bool); // 0xda8 ObjFunc
	var_30_bool = var_22_bool == 0; // 0xdaa Not
	if(var_30_bool == 0) goto Label_3502; // 0xdab JumpB
	var_19_bool = 1; // 0xdac MovB
	return 2; // 0xdad Return
	
Label_3502:
	var_19_bool = 0; // 0xdae MovB
	return 2; // 0xdaf Return
}
...
{
	var_34_object = Obj(); // 0xdb1 PushV
	var_34_object = var_33_object; // 0xdb2 Mov
	func_3642(); // 0xdb3 NEW_2
...
{
	var_107_object = Obj(); var_108_object = Obj(); // 0xbb2 PushV
	self(var_108_object); // 0xbb3 Func
	var_106_object = var_108_object; // 0xbb5 Mov
...
{
	var_22_bool = 0; var_23_object = Obj(); // 0xdb7 PushV
	var_23_object = var_21_object; // 0xdb8 Mov
	func_2494(var_22_bool, var_23_object); // 0xdb9 NEW_2
	if(var_22_bool == 0) goto Label_3522; // 0xdbb JumpB
	var_26_object = Obj(); // 0xdbc PushV
	func_2994(var_26_object); // 0xdbd NEW_2
	var_29_float = -0.05; // 0xdbf PushF
	ReportReputationChange(var_21_object, var_26_object, var_29_float); // 0xdc0 Func
...
{
	var_58_float = 0; var_59_float = 0; // 0xbb8 PushV
	var_60_int = var_51_cvector | var_51_cvector; // 0xbb9 Or
	var_59_float = sqrt(var_60_int); // 0xbba Sqrt2
	var_61_float = 0.0; // 0xbbb PushF
	var_62_bool = var_59_float < var_61_float; // 0xbbc LT
	if(var_62_bool == 0) goto Label_3008; // 0xbbd JumpB
	var_50_cvector = CVector(0.0, 0.0, 0.0); // 0xbbe MovV
	return 2; // 0xbbf Return
	
Label_3008:
	var_50_cvector = var_51_cvector / var_51_cvector; // 0xbc0 Div2
	return 2; // 0xbc1 Return
}


func_1980(var_512_bool, var_513_float)
{
	var_514_float = 0; var_515_bool = 0; var_516_float = 0; var_517_bool = 0; // 0x7bc PushV
	rand(var_516_float); // 0x7bd Func
	var_518_bool = var_516_float < var_513_float; // 0x7bf LT
	if(var_518_bool == 0) goto Label_2000; // 0x7c0 JumpB
	
Label_1985:
	IsAnimationPlaying(var_517_bool); // 0x7c1 Func
	var_519_bool = var_517_bool == 0; // 0x7c3 Not
	if(var_519_bool == 0) goto Label_1990; // 0x7c4 JumpB
...
Label_2005:
	var_512_bool = 0; // 0x7d5 MovB
	return 4; // 0x7d6 Return
	
Label_1990:
	var_520_bool = 0; // 0x7c6 PushV
	func_2078(var_520_bool); // 0x7c7 NEW_2
	if(var_520_bool == 0) goto Label_1996; // 0x7c9 JumpB
	var_512_bool = 1; // 0x7ca MovB
...
Label_2000:
	...
	func_2182(var_517_bool); // 0x7d3 NEW_2
}
...
{
	var_464_bool = var_460_float < var_461_float; // 0xbc3 LT
	if(var_464_bool == 0) goto Label_3015; // 0xbc4 JumpB
	var_459_float = var_460_float; // 0xbc5 Mov
	goto Label_3016; // 0xbc6 Jump
	
Label_3016:
	return 0; // 0xbc8 Return
	
Label_3015:
	var_459_float = var_461_float; // 0xbc7 Mov
}


func_3523(var_19_bool, var_20_string)
{
	var_21_object = Obj(); var_22_object = Obj(); // 0xdc3 PushV
	var_23_string = "heal"; // 0xdc4 PushS
	var_24_bool = var_20_string == var_23_string; // 0xdc5 Eq
	if(var_24_bool == 0) goto Label_3537; // 0xdc6 JumpB
	var_25_string = "player"; // 0xdc7 PushS
	FindActor(var_22_object, var_25_string); // 0xdc8 Func
	var_26_bool = 0; var_27_object = Obj(); // 0xdca PushV
	var_27_object = var_22_object; // 0xdcb Mov
	func_3675(var_27_object); // 0xdcc NEW_2
	var_19_bool = var_26_bool; // 0xdcd Mov
	return 2; // 0xdcf Return
	
Label_3537:
	var_19_bool = 0; // 0xdd1 MovB
...
{
	var_473_bool = var_470_float < var_471_float; // 0xbca LT
	if(var_473_bool == 0) goto Label_3022; // 0xbcb JumpB
	var_469_float = var_471_float; // 0xbcc Mov
	return 0; // 0xbcd Return
	
Label_3022:
	var_474_bool = var_470_float > var_472_float; // 0xbce GT
	if(var_474_bool == 0) goto Label_3026; // 0xbcf JumpB
	var_469_float = var_472_float; // 0xbd0 Mov
	return 0; // 0xbd1 Return
	
Label_3026:
	var_469_float = var_470_float; // 0xbd2 Mov
...
Label_2550:
	...
	func_3010(var_459_float, var_460_float, var_461_float); // 0x9fb NEW_2
	...
	func_3017(var_469_float, var_470_float, var_471_float, var_472_float); // 0xa09 NEW_2
	...
	func_3074(var_477_float); // 0xa14 NEW_2
...
Label_2530:
	var_485_string = "armor"; // 0x9e2 PushS
	GetProperty(var_485_string, var_434_int); // 0x9e3 ObjFunc
}


func_3539(var_30_string)
{
	var_31_object = Obj(); var_32_object = Obj(); // 0xdd3 PushV
	var_33_string = "heal"; // 0xdd4 PushS
	var_34_bool = var_30_string == var_33_string; // 0xdd5 Eq
	if(var_34_bool == 0) goto Label_3551; // 0xdd6 JumpB
	var_35_string = "player"; // 0xdd7 PushS
	FindActor(var_32_object, var_35_string); // 0xdd8 Func
	var_36_object = Obj(); // 0xdda PushV
	var_36_object = var_32_object; // 0xddb Mov
	func_3678(); // 0xddc NEW_2
	var_32_object = 0; // 0xdde SetNull
...
{
	var_46_int = 0; var_47_int = 0; // 0xbd4 PushV
	irand(var_47_int, var_45_int); // 0xbd5 Func
	var_43_bool = var_47_int < var_44_int; // 0xbd7 LT2
...
{
	var_74_float = GetByIndex(var_72_cvector, 0); // 0xbda PushE
	var_75_float = GetByIndex(var_73_cvector, 0); // 0xbdb PushE
	var_76_float = var_74_float * var_75_float; // 0xbdc Mult
	var_77_float = GetByIndex(var_72_cvector, 2); // 0xbdd PushE
	var_78_float = GetByIndex(var_73_cvector, 2); // 0xbde PushE
	var_79_float = var_77_float * var_78_float; // 0xbdf Mult
	var_71_float = var_76_float + var_79_float; // 0xbe0 Add2
...
func_476(var_20_object)
{
	...
	func_3721(var_101_object); // 0x1e4 NEW_2
...
{
	var_156_string = ""; var_157_string = ""; // 0xde0 PushV
	var_157_string = "idle"; // 0xde1 MovS
	var_158_int = var_155_int; // 0xde2 Push
	if(var_158_int == 0) goto Label_3557; // 0xde3 JumpB
	var_157_string = var_157_string + var_155_int; // 0xde4 Add2
	
Label_3557:
	var_154_string = var_157_string; // 0xde5 Mov
...
{
	var_82_float = GetByIndex(var_81_cvector, 0); // 0xbe3 PushE
	var_83_float = GetByIndex(var_81_cvector, 0); // 0xbe4 PushE
	var_84_float = var_82_float * var_83_float; // 0xbe5 Mult
	var_85_float = GetByIndex(var_81_cvector, 2); // 0xbe6 PushE
	var_86_float = GetByIndex(var_81_cvector, 2); // 0xbe7 PushE
	var_87_float = var_85_float * var_86_float; // 0xbe8 Mult
	var_88_int = var_84_float + var_87_float; // 0xbe9 Add
	var_80_float = sqrt(var_88_int); // 0xbea Sqrt2
...
{
	var_149_int = 0; var_150_bool = 0; var_151_int = 0; var_152_bool = 0; // 0xde7 PushV
	var_151_int = 0; // 0xde8 MovI
	
Label_3561:
	var_153_string = "all"; // 0xde9 PushS
	var_154_string = ""; var_155_int = 0; // 0xdea PushV
	var_155_int = var_151_int; // 0xdeb Mov
	func_3552(var_154_string, var_155_int); // 0xdec NEW_2
	HasAnimation(var_152_bool, var_153_string, var_154_string); // 0xdee Func
	var_159_bool = var_152_bool == 0; // 0xdf0 Not
	if(var_159_bool == 0) goto Label_3571; // 0xdf1 JumpB
	goto Label_3574; // 0xdf2 Jump
	
Label_3574:
	var_148_int = var_151_int; // 0xdf6 Mov
	return 4; // 0xdf7 Return
	
Label_3571:
	var_160_int = 1; // 0xdf3 PushI
	var_151_int = var_151_int + var_160_int; // 0xdf4 Add2
	goto Label_3561; // 0xdf5 Jump
}


func_3052(var_68_float, var_69_cvector, var_70_cvector)
{
	var_71_float = 0; var_72_cvector = CVector(0,0,0); var_73_cvector = CVector(0,0,0); // 0xbed PushV
	var_72_cvector = var_69_cvector; // 0xbee Mov
	var_73_cvector = var_70_cvector; // 0xbef Mov
	func_3033(var_71_float, var_72_cvector, var_73_cvector); // 0xbf0 NEW_2
	var_80_float = 0; var_81_cvector = CVector(0,0,0); // 0xbf2 PushV
	var_81_cvector = var_69_cvector; // 0xbf3 Mov
	func_3042(var_80_float, var_81_cvector); // 0xbf4 NEW_2
	var_89_float = 0; var_90_cvector = CVector(0,0,0); // 0xbf6 PushV
	var_90_cvector = var_70_cvector; // 0xbf7 Mov
	func_3042(var_89_float, var_90_cvector); // 0xbf8 NEW_2
	var_91_float = var_80_float * var_89_float; // 0xbfa Mult
	var_68_float = var_71_float / var_71_float; // 0xbfb Div2
...
{
	var_63_bool = 0; // 0xdf9 PushV
	func_3716(var_63_bool); // 0xdfa NEW_2
	if(var_63_bool == 0) goto Label_3583; // 0xdfc JumpB
	var_61_int = 2; // 0xdfd MovI
...
Label_577:
	...
	func_2953(var_96_string); // 0x243 NEW_2
