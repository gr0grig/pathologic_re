...
Label_36:
	...
	func_320(var_18_object, var_19_string, var_20_string, var_21_string); // 0x30 NEW_2
	...
	func_320(var_36_object, var_37_string, var_38_string, var_39_string); // 0x38 NEW_2
	...
	func_320(var_41_object, var_42_string, var_43_string, var_44_string); // 0x40 NEW_2
	...
	func_320(var_46_object, var_47_string, var_48_string, var_49_string); // 0x48 NEW_2
...
Label_101:
	var_122_string = "completed"; // 0x65 PushS
	var_123_bool = var_6_string == var_122_string; // 0x66 Eq
	if(var_123_bool == 0) goto Label_107; // 0x67 JumpB
	func_162(); // 0x69 NEW_2
	
Label_108:
	var_124_string = "driver_unload"; // 0x6c PushS
	var_125_bool = var_6_string == var_124_string; // 0x6d Eq
	if(var_125_bool == 0) goto Label_116; // 0x6e JumpB
	var_126_int = 0; // 0x6f PushV
	var_126_int = 0; // 0x70 MovI
	func_196(var_7_object, var_8_object, var_9_object, var_10_object, var_126_int); // 0x71 NEW_2
	goto Label_139; // 0x73 Jump
	
Label_116:
	var_127_string = "mpatrol_unload"; // 0x74 PushS
	var_128_bool = var_6_string == var_127_string; // 0x75 Eq
	if(var_128_bool == 0) goto Label_124; // 0x76 JumpB
	var_129_int = 0; // 0x77 PushV
	var_129_int = 1; // 0x78 MovI
	func_196(var_7_object, var_8_object, var_9_object, var_10_object, var_129_int); // 0x79 NEW_2
	goto Label_139; // 0x7b Jump
	
Label_124:
	var_130_string = "patrol1_unload"; // 0x7c PushS
	var_131_bool = var_6_string == var_130_string; // 0x7d Eq
	if(var_131_bool == 0) goto Label_132; // 0x7e JumpB
	var_132_int = 0; // 0x7f PushV
	var_132_int = 2; // 0x80 MovI
	func_196(var_7_object, var_8_object, var_9_object, var_10_object, var_132_int); // 0x81 NEW_2
	goto Label_139; // 0x83 Jump
	
Label_132:
	var_133_string = "patrol2_unload"; // 0x84 PushS
	var_134_bool = var_6_string == var_133_string; // 0x85 Eq
	if(var_134_bool == 0) goto Label_139; // 0x86 JumpB
	var_135_int = 0; // 0x87 PushV
	var_135_int = 3; // 0x88 MovI
	func_196(var_7_object, var_8_object, var_9_object, var_10_object, var_135_int); // 0x89 NEW_2
	
Label_23:
	var_136_string = "patrol1_unload"; // 0x17 PushS
	var_137_bool = var_6_string == var_136_string; // 0x18 Eq
	if(var_137_bool == 0) goto Label_30; // 0x19 JumpB
	Remove(); // 0x1a TObjFunc
	var_2_object = 0; // 0x1c SetNullT
	goto Label_36; // 0x1d Jump
	
Label_30:
	var_138_string = "patrol2_unload"; // 0x1e PushS
	var_139_bool = var_6_string == var_138_string; // 0x1f Eq
	if(var_139_bool == 0) goto Label_36; // 0x20 JumpB
...
Label_175:
	...
	func_338(); // 0xb5 NEW_2
	func_187(var_56_int); // 0xb8 NEW_2
...
func_290(var_8_int)
{
	...
	func_187(var_10_float); // 0x12a NEW_2
...
func_196(var_0_object, var_1_object, var_2_object, var_3_object, var_14_int)
{
	...
	func_280(var_21_bool, var_22_object); // 0xd2 NEW_2
...
Label_214:
	...
	func_280(var_29_bool, var_30_object); // 0xde NEW_2
...
Label_228:
	...
	func_280(var_34_bool, var_35_object); // 0xec NEW_2
...
Label_242:
	...
	func_280(var_39_bool, var_40_object); // 0xfa NEW_2
...
Label_274:
	...
	func_314(var_45_object); // 0x113 NEW_2
...
func_364(var_27_object)
{
	var_28_object = Obj(); var_29_object = Obj(); // 0x16c PushV
	GetDiaryRoot(var_29_object); // 0x16d Func
	var_30_bool = var_29_object == 0; // 0x16f Not
	if(var_30_bool == 0) goto Label_374; // 0x170 JumpB
	var_31_string = "Can't retrieve diary root"; // 0x171 PushS
	Trace(var_31_string); // 0x172 Func
	var_27_object = 0; // 0x174 MovB
	return 2; // 0x175 Return
	
Label_374:
	var_27_object = var_29_object; // 0x176 Mov
...
func_338()
{
	var_65_object = Obj(); var_66_object = Obj(); // 0x152 PushV
	var_67_int = 61; // 0x153 PushI
	var_68_int = 2; // 0x154 PushI
	var_69_int = 512143; // 0x155 PushI
	CreateDiaryEntry(var_66_object, var_67_int, var_68_int, var_69_int); // 0x156 Func
	var_70_bool = 0; var_71_object = Obj(); var_72_int = 0; // 0x158 PushV
	var_71_object = var_66_object; // 0x159 Mov
	var_72_int = 11; // 0x15a MovI
	func_377(var_70_bool, var_71_object, var_72_int); // 0x15b NEW_2
...
{
	func_351(); // 0x98 NEW_2
	var_36_string = "d2q02"; // 0x9a PushS
	var_37_int = -1; // 0x9b PushI
	SetVariable(var_36_string, var_37_int); // 0x9c Func
	func_187(var_9_int); // 0x9f NEW_2
...
func_377(var_18_bool, var_19_object, var_20_int)
{
	var_21_object = Obj(); var_22_object = Obj(); var_23_int = 0; var_24_object = Obj(); var_25_object = Obj(); var_26_int = 0; // 0x179 PushV
	var_27_object = Obj(); // 0x17a PushV
	func_364(var_27_object); // 0x17b NEW_2
	var_24_object = var_27_object; // 0x17c Mov
	Find(var_20_int, var_25_object); // 0x17e ObjFunc
	var_32_bool = var_25_object == 0; // 0x180 Not
	if(var_32_bool == 0) goto Label_392; // 0x181 JumpB
	var_33_string = "Can't find diary parent with id: "; // 0x182 PushS
	var_34_int = var_33_string + var_20_int; // 0x183 Add
	Trace(var_34_int); // 0x184 Func
	var_18_bool = 0; // 0x186 MovB
	return 6; // 0x187 Return
	
Label_392:
	AddChild(var_19_object); // 0x188 ObjFunc
	var_35_int = 7; // 0x18a PushI
	SendWorldWndMessage(var_35_int); // 0x18b Func
	GetCategory(var_26_int); // 0x18d ObjFunc
	SetDiarySection(var_26_int); // 0x18f Func
	var_18_bool = 0; // 0x191 MovB
...
func_187(var_4_bool)
{
	...
	func_196(var_5_bool, var_8_int, var_9_float, var_10_float, var_14_int); // 0xc1 NEW_2
...
func_351()
{
	var_13_object = Obj(); var_14_object = Obj(); // 0x15f PushV
	var_15_int = 62; // 0x160 PushI
	var_16_int = 2; // 0x161 PushI
	var_17_int = 512144; // 0x162 PushI
	CreateDiaryEntry(var_14_object, var_15_int, var_16_int, var_17_int); // 0x163 Func
	var_18_bool = 0; var_19_object = Obj(); var_20_int = 0; // 0x165 PushV
	var_19_object = var_14_object; // 0x166 Mov
	var_20_int = 11; // 0x167 MovI
	func_377(var_18_bool, var_19_object, var_20_int); // 0x168 NEW_2
