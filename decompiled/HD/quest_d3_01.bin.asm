...
0xa5: @@ get(Stack[-7], Stack[-8])
0xa6: Pop(0)
0xa7: @@ GetActor(Stack[-6])
0xa8: Pop(0)
0xa9: Push(Stack[-6])
...
0xc5: @@ get(Stack[-3], Stack[-4])
0xc6: Pop(0)
0xc7: @@ GetActor(Stack[-2])
0xc8: Pop(0)
0xc9: Push(Stack[-2])
...
0x13c: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2])
0x13d: Pop(0)
...
0x148: @@ AddStationaryActor(Stack[-1], Stack[-3], Stack[-2], Stack[-10], Stack[-9])
0x149: Pop(0)
0x14a: Stack[-13] = Stack[-1]
0x14b: Return(); Pop(8)
