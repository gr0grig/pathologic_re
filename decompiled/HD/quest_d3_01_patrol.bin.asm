...
0x7cc: Push("Can't find lsh animation : ")
...
0x848: Stack[-1] = Stack[-2]
0x849: Call2 0x866

0x84a: Pop(1)
0x84b: PushEmpty(bool, object, string, float, float, float)
0x84c: Stack[-5] = Stack[-8]
0x84d: Stack[-4] = "reputation"
0x84e: Stack[-3] = Stack[-7]
0x84f: Stack[-2] = (int) 0
0x850: Stack[-1] = (int) 1
0x851: Call2 0x632
