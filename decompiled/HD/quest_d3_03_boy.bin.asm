...
0x513: Push("Can't find lsh animation : ")
...
0x522: Push("Can't find lsh animation : ")
...
0x576: @@ GetItemID(Stack[-3])
0x577: Pop(0)
0x578: Push("Category")
0x579: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x57a: Pop(1)
0x57b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x57c: Pop(0)
0x57d: Pop(0); Push((bool) Stack[-1] == 0)
0x57e: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x57f: @@ DropItems(Stack[-8], Stack[-7])
0x580: Pop(0)
0x581: GOTO 0x587

0x582: PushEmpty(int, int)
0x583: Stack[-2] = Stack[-5]
0x584: Stack[-1] = Stack[-9]
0x585: Call2 0x569
...
0x58a: Pop(0)
0x58b: @@ SetItemName(Stack[-4])
0x58c: Pop(0)
0x58d: PushEmpty(object, object, int)
0x58e: Stack[-3] = Stack[-8]
0x58f: Stack[-2] = Stack[-4]
...
0x597: Pop(0)
0x598: Pop(0); Push((bool) Stack[-1] == 0)
...
0x5b7: Stack[-5] = Stack[-2]
0x5b8: Return(); Pop(4)

0x5b9: PushEmpty()
0x5ba: Push("playsound")
0x5bb: Push("giveitem")
...
0x5c6: Pop(0)
0x5c7: Push("disease")
0x5c8: @@ GetProperty(Stack[-1], Stack[-2])
0x5c9: Pop(1)
...
0x5cf: @@ SetProperty(Stack[-2], Stack[-1])
0x5d0: Pop(2)
0x5d1: Return(); Pop(2)

0x5d2: PushEmpty()
0x5d3: Push("powder is given")
0x5d4: @ Trace(Stack[-1])
0x5d5: Pop(1)
0x5d6: PushEmpty(object, string, int)
0x5d7: Stack[-3] = Stack[-5]
0x5d8: Stack[-2] = "powder"
0x5d9: Stack[-1] = (int) 1
0x5da: Call2 0x588
...
0x606: Push("Can't retrieve diary root")
0x607: @ Trace(Stack[-1])
0x608: Pop(1)
...
0x612: Pop(1)
0x613: @@ Find(Stack[-7], Stack[-2])
0x614: Pop(0)
0x615: Pop(0); Push((bool) Stack[-2] == 0)
0x616: IF (Stack[-1] == 0) GOTO 0x61d; Pop(1)

0x617: Push("Can't find diary parent with id: ")
...
0x61d: @@ AddChild(Stack[-8])
0x61e: Pop(0)
0x61f: Push((int) 7)
0x620: @ SendWorldWndMessage(Stack[-1])
0x621: Pop(1)
0x622: @@ GetCategory(Stack[-1])
0x623: Pop(0)
...
0x63f: Stack[-1] = "ui/NPC_Citizen3.png"
0x640: Return(); Pop(0)

0x641: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x642: Return(); Pop(0)
...
0x64f: Stack[-3] = Stack[-7]
0x650: Stack[-2] = Stack[-6]
0x651: Stack[-1] = Stack[-5]
0x652: Call2 0x45a
...
0x657: Stack[-5] = Stack[-11]
0x658: Stack[-4] = Stack[-10]
0x659: Stack[-3] = Stack[-9]
0x65a: Stack[-2] = Stack[-7]
...
0x687: Stack[-2] = "quest_d3_03"
0x688: Stack[-1] = "boy_attacked"
0x689: Call2 0x595
