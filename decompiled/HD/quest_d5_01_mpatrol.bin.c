...
Label_219:
	...
	func_2148(var_79_object); // 0xe0 NEW_2
...
Label_364:
	...
	func_2332(var_162_bool); // 0x16e NEW_2
...
task_3_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_int)
{
	...
	func_2086(var_17_object); // 0x45b NEW_2
...
Label_1144:
	...
	func_1954(var_18_object); // 0x47c NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object)
{
	...
	func_2233(var_18_object); // 0x540 NEW_2
...
task_4_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool)
{
	...
	func_2013(var_14_object); // 0x544 NEW_2
...
task_5_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object)
{
	...
	func_2069(var_18_bool, var_19_string, var_20_string); // 0x5e6 NEW_2
...
{
	var_18_object = Obj(); var_19_int = 0; var_20_float = 0; // 0x8f0 PushV
	var_18_object = var_14_object; // 0x8f1 Mov
	var_19_int = var_15_int; // 0x8f2 Mov
	var_20_float = var_16_float; // 0x8f3 Mov
	func_1743(var_18_object, var_19_int, var_20_float); // 0x8f4 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; var_23_cvector = CVector(0,0,0); var_24_cvector = CVector(0,0,0); // 0x8f8 PushV
	var_20_object = var_14_object; // 0x8f9 Mov
	var_21_int = var_15_int; // 0x8fa Mov
	var_22_float = var_16_float; // 0x8fb Mov
	var_23_cvector = var_18_cvector; // 0x8fc Mov
	var_24_cvector = var_19_cvector; // 0x8fd Mov
	func_1811(var_22_float, var_23_cvector, var_24_cvector); // 0x8fe NEW_2
...
{
	var_16_float = 0; var_17_float = 0; // 0x901 PushV
	var_18_string = "health"; // 0x902 PushS
	var_19_bool = var_15_string == var_18_string; // 0x903 Eq
	if(var_19_bool == 0) goto Label_2317; // 0x904 JumpB
	var_20_string = "health"; // 0x905 PushS
	GetProperty(var_20_string, var_17_float); // 0x906 Func
	var_21_int = 0; // 0x908 PushI
	var_22_bool = var_17_float <= var_21_int; // 0x909 LE
	if(var_22_bool == 0) goto Label_2317; // 0x90a JumpB
	SignalDeath(var_14_object); // 0x90b Func
...
{
	var_15_object = Obj(); // 0x90f PushV
	var_15_object = var_14_object; // 0x910 Mov
	func_2334(var_15_object); // 0x911 NEW_2
...
{
	var_456_object = Obj(); var_457_object = Obj(); // 0x804 PushV
	CreateFloatVector(var_457_object); // 0x805 Func
	add(var_455_float); // 0x807 ObjFunc
	var_458_int = 0; // 0x809 PushI
	var_459_bool = var_455_float < var_458_int; // 0x80a LT
	if(var_459_bool == 0) goto Label_2064; // 0x80b JumpB
	var_460_float = 0.7; // 0x80c PushF
	var_461_int = 500; // 0x80d PushI
	RumblePlay(var_460_float, var_461_int); // 0x80e Func
	
Label_2064:
	var_462_int = 15; // 0x810 PushI
	SendWorldWndMessage(var_462_int, var_457_object); // 0x811 Func
...
func_1040(var_0_object)
{
	...
	func_2086(var_123_object); // 0x412 NEW_2
...
{
	var_28_object = Obj(); var_29_object = Obj(); // 0x815 PushV
	FindActor(var_29_object, var_26_string); // 0x816 Func
	var_30_bool = var_29_object == 0; // 0x818 NullEq
	if(var_30_bool == 0) goto Label_2076; // 0x819 JumpB
	var_25_bool = 0; // 0x81a MovB
	return 2; // 0x81b Return
	
Label_2076:
	Trigger(var_29_object, var_27_string); // 0x81c Func
	var_25_bool = 1; // 0x81e MovB
...
func_1047()
{
	...
	func_1972(var_256_string); // 0x419 NEW_2
...
Label_1600:
	...
	func_2029(var_437_float, var_438_float, var_439_float); // 0x645 NEW_2
	...
	func_2036(var_447_float, var_448_float, var_449_float, var_450_float); // 0x653 NEW_2
	...
	func_2052(var_455_float); // 0x65e NEW_2
...
Label_1580:
	var_463_string = "armor"; // 0x62c PushS
	GetProperty(var_463_string, var_412_int); // 0x62d ObjFunc
}


func_2328(var_78_string)
{
	var_78_string = "ui/NPC_Citizen2.png"; // 0x918 MovS
...
{
	var_79_string = "ui/NPC_Citizen2_b.png"; // 0x91a MovS
...
{
	var_38_float = 0; var_39_float = 0; // 0x821 PushV
	GetGameTime(var_39_float); // 0x822 Func
	var_37_float = var_39_float; // 0x824 Mov
...
{
	var_16_bool = 0; var_17_bool = 0; // 0x91e PushV
	var_18_string = "revolver_ammo"; // 0x91f PushS
	var_19_int = 0; // 0x920 PushI
	var_20_int = 2; // 0x921 PushI
	AddItem(var_17_bool, var_18_string, var_19_int, var_20_int); // 0x922 Func
	var_21_string = "alpha_pills"; // 0x924 PushS
	var_22_int = 0; // 0x925 PushI
	var_23_int = 2; // 0x926 PushI
	AddItem(var_17_bool, var_21_string, var_22_int, var_23_int); // 0x927 Func
	var_24_object = Obj(); // 0x929 PushV
	var_24_object = var_15_object; // 0x92a Mov
	TaskCall(4); // 0x92b TaskCall
	func_1316(var_24_object); // 0x92c NEW_2
	TaskReturn(); // 0x92d TaskReturn
...
func_1060(var_2_object, var_130_bool, var_131_object, var_132_float, var_133_float, var_134_bool, var_135_bool)
{
	...
	func_2086(var_143_object); // 0x427 NEW_2
	...
	func_1954(var_147_object); // 0x434 NEW_2
...
Label_1080:
	...
	func_2013(var_158_object); // 0x43e NEW_2
...
{
	var_124_bool = 0; var_125_bool = 0; // 0x826 PushV
	IsPlayerActor(var_123_object, var_125_bool); // 0x827 Func
	var_126_bool = var_125_bool; // 0x829 Push
	if(var_126_bool == 0) goto Label_2094; // 0x82a JumpB
	var_127_string = "attack"; // 0x82b PushS
	PlayGlobalMusic(var_127_string); // 0x82c Func
...
func_1316(var_24_object)
{
	...
	func_2069(var_25_bool, var_26_string, var_27_string); // 0x528 NEW_2
...
func_1836(var_28_bool, var_30_float)
{
	...
	func_2019(var_55_cvector, var_56_cvector); // 0x747 NEW_2
...
Label_1877:
	...
	var_68_bool = 1; // 0x757 PushB
	CameraTransit(var_46_cvector, var_44_cvector, var_68_bool); // 0x758 Func
	var_69_float = GetByIndex(var_45_cvector, 0); // 0x75a PushE
	var_70_float = GetByIndex(var_45_cvector, 2); // 0x75b PushE
	Rotate(var_69_float, var_70_float); // 0x75c Func
	var_71_bool = 0; // 0x75e PushV
	func_2332(var_71_bool); // 0x75f NEW_2
	if(var_71_bool == 0) goto Label_1891; // 0x761 JumpB
	goto Label_1899; // 0x762 Jump
	
Label_1899:
	CameraWaitForPlayFinish(); // 0x76b Func
	ResumeWorld(); // 0x76d Func
	var_28_bool = 1; // 0x76f MovB
	return 18; // 0x770 Return
	
Label_1891:
	var_72_string = "head"; // 0x763 PushS
	HasAnimationTrack(var_48_bool, var_72_string); // 0x764 Func
	var_73_bool = var_48_bool; // 0x766 Push
	if(var_73_bool == 0) goto Label_1899; // 0x767 JumpB
	var_74_string = "head"; // 0x768 PushS
	LookAsyncCamera(var_74_string); // 0x769 Func
}


func_2095()
{
	var_360_object = Obj(); var_361_object = Obj(); // 0x82f PushV
	GetScene(var_361_object); // 0x830 Func
	var_362_string = "battle"; // 0x832 PushS
	var_363_object = Obj(); // 0x833 PushV
	func_2013(var_363_object); // 0x834 NEW_2
	BroadcastMessage(var_362_string, var_363_object, var_361_object); // 0x836 Func
...
func_2106()
{
	var_42_object = Obj(); var_43_string = ""; var_44_float = 0; // 0x83b PushV
	var_45_object = Obj(); // 0x83c PushV
	func_2160(var_45_object); // 0x83d NEW_2
	var_42_object = var_45_object; // 0x83e Mov
	var_43_string = "pt_map_grif"; // 0x840 MovS
	var_44_float = 2; // 0x841 MovI
	func_2177(var_42_object, var_43_string, var_44_float); // 0x842 NEW_2
	var_65_object = Obj(); // 0x844 PushV
	func_2160(var_65_object); // 0x845 NEW_2
	ShowMap(var_65_object); // 0x847 ObjFunc
...
{
	var_492_float = 0; var_493_bool = 0; var_494_float = 0; var_495_bool = 0; // 0x346 PushV
	rand(var_494_float); // 0x347 Func
	var_496_bool = var_494_float < var_491_float; // 0x349 LT
	if(var_496_bool == 0) goto Label_858; // 0x34a JumpB
	
Label_843:
	IsAnimationPlaying(var_495_bool); // 0x34b Func
	var_497_bool = var_495_bool == 0; // 0x34d Not
	if(var_497_bool == 0) goto Label_848; // 0x34e JumpB
...
Label_863:
	var_490_bool = 0; // 0x35f MovB
	return 4; // 0x360 Return
	
Label_848:
	var_498_bool = 0; // 0x350 PushV
	func_936(var_498_bool); // 0x351 NEW_2
	if(var_498_bool == 0) goto Label_854; // 0x353 JumpB
	var_490_bool = 1; // 0x354 MovB
...
Label_858:
	...
	func_1040(var_495_bool); // 0x35d NEW_2
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_89_object, var_90_object)
{
	...
	func_2148(var_97_object); // 0x52 NEW_2
...
Label_136:
	...
	func_1923(var_131_string); // 0x8a NEW_2
...
func_2122()
{
	var_106_string = "ood5PatrolGuard1"; // 0x84b PushS
	var_107_int = 1; // 0x84c PushI
	SetVariable(var_106_string, var_107_int); // 0x84d Func
...
Label_1423:
	...
	func_1972(var_106_string); // 0x591 NEW_2
...
func_2128()
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x850 PushV
	var_24_string = "d5q01"; // 0x851 PushS
	var_25_int = 6; // 0x852 PushI
	SetVariable(var_24_string, var_25_int); // 0x853 Func
	var_26_object = Obj(); // 0x855 PushV
	func_2160(var_26_object); // 0x856 NEW_2
	var_23_object = var_26_object; // 0x857 Mov
	var_33_string = "d5q01PatrolGotoGrif"; // 0x859 PushS
	var_34_string = "pt_map_grif"; // 0x85a PushS
	var_35_int = 1; // 0x85b PushI
	var_36_int = 515349; // 0x85c PushI
	var_37_float = 0; // 0x85d PushV
	func_2081(var_37_float); // 0x85e NEW_2
	AddMark(var_33_string, var_34_string, var_35_int, var_36_int, var_37_float); // 0x860 ObjFunc
...
{
	var_98_int = 0; var_99_string = ""; // 0x865 PushV
	var_99_string = "ood5PatrolGuard1"; // 0x866 MovS
	func_2047(var_98_int, var_99_string); // 0x867 NEW_2
	var_102_int = 0; // 0x869 PushI
	var_103_bool = var_98_int == var_102_int; // 0x86a Eq
	if(var_103_bool == 0) goto Label_2158; // 0x86b JumpB
	var_96_bool = 1; // 0x86c MovB
	return 0; // 0x86d Return
	
Label_2158:
	var_96_bool = 0; // 0x86e MovB
...
{
	var_27_object = Obj(); var_28_object = Obj(); var_29_object = Obj(); var_30_object = Obj(); // 0x870 PushV
	GetMainOutdoorScene(var_29_object); // 0x871 Func
	var_31_bool = var_29_object == 0; // 0x873 NullEq
	if(var_31_bool == 0) goto Label_2171; // 0x874 JumpB
	var_32_string = "Can't find main outdoor scene"; // 0x875 PushS
	Trace(var_32_string); // 0x876 Func
	var_30_object = 0; // 0x878 SetNull
	var_26_object = var_30_object; // 0x879 Mov
	return 4; // 0x87a Return
	
Label_2171:
	GetMap(var_30_object); // 0x87b ObjFunc
	var_26_object = var_30_object; // 0x87d Mov
...
func_1905()
{
	var_157_bool = 0; var_158_bool = 0; // 0x771 PushV
	var_159_bool = 1; // 0x772 PushB
	CameraSwitchToNormal(var_159_bool); // 0x773 Func
	var_160_bool = 0; // 0x775 PushV
	func_2332(var_160_bool); // 0x776 NEW_2
	if(var_160_bool == 0) goto Label_1914; // 0x778 JumpB
...
Label_1914:
	var_161_string = "head"; // 0x77a PushS
	HasAnimationTrack(var_158_bool, var_161_string); // 0x77b Func
	var_162_bool = var_158_bool; // 0x77d Push
	if(var_162_bool == 0) goto Label_1922; // 0x77e JumpB
	var_163_string = "head"; // 0x77f PushS
	UnlookAsync(var_163_string); // 0x780 Func
}
...
{
	var_46_cvector = CVector(0,0,0); var_47_cvector = CVector(0,0,0); var_48_object = Obj(); var_49_bool = 0; var_50_cvector = CVector(0,0,0); var_51_cvector = CVector(0,0,0); var_52_object = Obj(); var_53_bool = 0; // 0x881 PushV
	GetMainOutdoorScene(var_52_object); // 0x882 Func
	var_54_bool = var_52_object == 0; // 0x884 NullEq
	if(var_54_bool == 0) goto Label_2186; // 0x885 JumpB
	var_55_string = "Can't find main outdoor scene"; // 0x886 PushS
	Trace(var_55_string); // 0x887 Func
	return 8; // 0x889 Return
	
Label_2186:
	GetLocator(var_43_string, var_53_bool, var_50_cvector, var_51_cvector); // 0x88a ObjFunc
	var_56_bool = var_53_bool == 0; // 0x88c Not
	if(var_56_bool == 0) goto Label_2196; // 0x88d JumpB
	var_57_string = "Warning: outdoor scene locator "; // 0x88e PushS
	var_58_int = var_57_string + var_43_string; // 0x88f Add
	var_59_string = " doesnt exist"; // 0x890 PushS
	var_60_int = var_58_int + var_59_string; // 0x891 Add
	Trace(var_60_int); // 0x892 Func
	
Label_2196:
	GetMap(var_42_object); // 0x894 ObjFunc
	var_61_bool = var_42_object == 0; // 0x896 NullEq
	if(var_61_bool == 0) goto Label_2204; // 0x897 JumpB
	var_62_string = "Can't find map"; // 0x898 PushS
	Trace(var_62_string); // 0x899 Func
	return 8; // 0x89b Return
	
Label_2204:
	var_63_float = GetByIndex(var_50_cvector, 0); // 0x89c PushE
	var_64_float = GetByIndex(var_50_cvector, 2); // 0x89d PushE
	SetMapParams(var_63_float, var_64_float, var_44_float); // 0x89e ObjFunc
	return 8; // 0x8a0 Return
}


func_1923(var_131_string)
{
	var_132_bool = 0; var_133_float = 0; var_134_float = 0; var_135_bool = 0; var_136_float = 0; var_137_float = 0; // 0x783 PushV
	lshHasAnimation(var_135_bool, var_131_string); // 0x784 Func
	var_138_bool = var_135_bool; // 0x786 Push
	if(var_138_bool == 0) goto Label_1934; // 0x787 JumpB
	lshGetAnimTimes(var_131_string, var_136_float, var_137_float); // 0x788 Func
	var_139_bool = 0; // 0x78a PushB
	lshPlayAnimation(var_136_float, var_137_float, var_139_bool); // 0x78b Func
	goto Label_1938; // 0x78d Jump
	
Label_1938:
	return 6; // 0x792 Return
	
Label_1934:
	var_140_string = "Can't find lsh animation : "; // 0x78e PushS
	var_141_int = var_140_string + var_131_string; // 0x78f Add
	Trace(var_141_int); // 0x790 Func
}
...
Label_417:
	...
	func_2013(var_82_object); // 0x1ab NEW_2
...
Label_554:
	...
	var_506_string = "all"; // 0x22c PushS
	var_507_string = "fjump"; // 0x22d PushS
	PlayAnimation(var_506_string, var_507_string); // 0x22e Func
	WaitForAnimEnd(); // 0x230 Func
	func_1040(var_51_float); // 0x233 NEW_2
	var_508_cvector = CVector(0.0, 0.0, 0.0); // 0x235 PushVec
	SetSpeed(var_508_cvector); // 0x236 Func
	Stop(); // 0x238 Func
	StopAsync(); // 0x23a Func
	var_509_bool = 0; // 0x23c PushV
	func_997(var_51_float, var_509_bool); // 0x23d NEW_2
	var_510_bool = var_509_bool == 0; // 0x23f Not
	if(var_510_bool == 0) goto Label_600; // 0x240 JumpB
	var_511_bool = 0; var_512_object = Obj(); // 0x241 PushV
	var_512_object = var_0_object; // 0x242 MovT
	func_1675(var_511_bool, var_512_object); // 0x243 NEW_2
	var_513_bool = var_511_bool == 0; // 0x245 Not
	if(var_513_bool == 0) goto Label_584; // 0x246 JumpB
...
Label_584:
	...
	var_514_float = var_29_float * var_29_float; // 0x24e Mult
	var_515_bool = var_48_float < var_514_float; // 0x24f LT
	if(var_515_bool == 0) goto Label_600; // 0x250 JumpB
	var_516_bool = 0; var_517_float = 0; // 0x251 PushV
	var_517_float = var_29_float; // 0x252 Mov
	func_701(var_51_float, var_516_bool, var_517_float); // 0x253 NEW_2
	var_518_bool = var_516_bool == 0; // 0x255 Not
	if(var_518_bool == 0) goto Label_600; // 0x256 JumpB
	goto Label_610; // 0x257 Jump
	
Label_601:
	var_519_bool = 0; var_520_float = 0; // 0x259 PushV
	var_520_float = var_29_float; // 0x25a Mov
	func_701(var_51_float, var_519_bool, var_520_float); // 0x25b NEW_2
	var_521_bool = var_519_bool == 0; // 0x25d Not
	if(var_521_bool == 0) goto Label_608; // 0x25e JumpB
...
{
	var_116_bool = 0; var_117_float = 0; var_118_float = 0; var_119_bool = 0; var_120_float = 0; var_121_float = 0; // 0x793 PushV
	lshHasAnimation(var_119_bool, var_112_string); // 0x794 Func
	var_122_bool = var_119_bool; // 0x796 Push
	if(var_122_bool == 0) goto Label_1949; // 0x797 JumpB
	lshGetAnimTimes(var_112_string, var_120_float, var_121_float); // 0x798 Func
	lshPlayAnimation(var_120_float, var_121_float, var_113_bool); // 0x79a Func
...
Label_1949:
	var_123_string = "Can't find lsh animation : "; // 0x79d PushS
	var_124_int = var_123_string + var_112_string; // 0x79e Add
	Trace(var_124_int); // 0x79f Func
}
...
func_662(var_0_object, var_385_float, var_386_int)
{
	...
	var_464_int = 0; // 0x2b1 PushV
	func_1045(var_464_int); // 0x2b2 NEW_2
	ReportHit(var_0_object, var_464_int, var_392_float, var_391_float); // 0x2b4 Func
	var_465_object = Obj(); var_466_float = 0; // 0x2b6 PushV
	var_465_object = var_390_object; // 0x2b7 Mov
	var_466_float = var_392_float; // 0x2b8 Mov
...
func_157(var_2_object, var_108_string)
{
	...
	func_2332(var_109_bool); // 0x9f NEW_2
...
Label_175:
	func_1939(var_112_string, var_113_bool); // 0xaf NEW_2
...
{
	var_81_int = 0; var_82_int = 0; // 0x8a2 PushV
	var_83_string = "branch"; // 0x8a3 PushS
	GetVariable(var_83_string, var_82_int); // 0x8a4 Func
	var_84_int = 0; // 0x8a6 PushI
	var_85_bool = var_82_int == var_84_int; // 0x8a7 Eq
	if(var_85_bool == 0) goto Label_2220; // 0x8a8 JumpB
	var_80_int = 1; // 0x8a9 MovI
	return 2; // 0x8aa Return
	
Label_2220:
	var_86_int = 1; // 0x8ac PushI
	var_87_bool = var_82_int == var_86_int; // 0x8ad Eq
	if(var_87_bool == 0) goto Label_2225; // 0x8ae JumpB
	var_80_int = 2; // 0x8af MovI
	return 2; // 0x8b0 Return
	
Label_2225:
	var_80_int = 3; // 0x8b1 MovI
...
{
	var_148_float = 0; var_149_cvector = CVector(0,0,0); var_150_float = 0; var_151_cvector = CVector(0,0,0); // 0x7a2 PushV
	GetEyesHeight(var_150_float); // 0x7a3 ObjFunc
	var_151_cvector = CVector(0.0, 0.0, 0.0); // 0x7a5 MovV
	var_152_float = GetByIndex(var_151_cvector, 1); // 0x7a6 PushE
	var_152_float = var_150_float; // 0x7a7 Mov
	SetByIndex(var_151_cvector, 1) = var_152_float; // 0x7a8 PopE
	var_153_string = "head"; // 0x7a9 PushS
	LookAsync(var_147_object, var_153_string, var_151_cvector); // 0x7aa Func
...
func_1446(var_53_string)
{
	...
	func_1972(var_54_string); // 0x5b3 NEW_2
...
func_1965()
{
	var_17_bool = 0; // 0x7ad PushV
	func_2332(var_17_bool); // 0x7ae NEW_2
	if(var_17_bool == 0) goto Label_1971; // 0x7b0 JumpB
	lshStopSpeech(); // 0x7b1 Func
...
{
	var_114_int = 0; var_115_int = 0; // 0x8b3 PushV
	var_116_string = "branch"; // 0x8b4 PushS
	GetVariable(var_116_string, var_115_int); // 0x8b5 Func
	var_113_int = var_115_int; // 0x8b7 Mov
...
{
	var_55_bool = 0; var_56_int = 0; var_57_bool = 0; var_58_int = 0; var_59_bool = 0; var_60_float = 0; var_61_cvector = CVector(0,0,0); var_62_cvector = CVector(0,0,0); var_63_bool = 0; var_64_int = 0; var_65_bool = 0; var_66_int = 0; var_67_bool = 0; var_68_float = 0; var_69_cvector = CVector(0,0,0); var_70_cvector = CVector(0,0,0); // 0x7b4 PushV
	IsExisting3DSound(var_63_bool, var_54_string); // 0x7b5 Func
	var_71_bool = var_63_bool == 0; // 0x7b7 Not
	if(var_71_bool == 0) goto Label_1997; // 0x7b8 JumpB
	var_64_int = 0; // 0x7b9 MovI
	
Label_1978:
	var_72_int = 1; // 0x7ba PushI
	var_73_int = var_64_int + var_72_int; // 0x7bb Add
	var_74_int = var_54_string + var_73_int; // 0x7bc Add
	IsExisting3DSound(var_65_bool, var_74_int); // 0x7bd Func
	var_75_bool = var_65_bool == 0; // 0x7bf Not
	if(var_75_bool == 0) goto Label_1986; // 0x7c0 JumpB
	goto Label_1989; // 0x7c1 Jump
	
Label_1989:
	var_76_bool = var_64_int == 0; // 0x7c5 Not
	if(var_76_bool == 0) goto Label_1992; // 0x7c6 JumpB
	return 16; // 0x7c7 Return
	
Label_1992:
	irand(var_66_int, var_64_int); // 0x7c8 Func
	var_77_int = 1; // 0x7ca PushI
	var_78_int = var_66_int + var_77_int; // 0x7cb Add
	var_54_string = var_54_string + var_78_int; // 0x7cc Add2
	
Label_1997:
	Is3DSoundLoaded(var_67_bool, var_54_string); // 0x7cd Func
	var_79_bool = var_67_bool; // 0x7cf Push
	if(var_79_bool == 0) goto Label_2012; // 0x7d0 JumpB
	GetEyesHeight(var_68_float); // 0x7d1 Func
	GetDirection(var_69_cvector); // 0x7d3 Func
	var_80_int = 50; // 0x7d5 PushI
	var_70_cvector = var_69_cvector * var_80_int; // 0x7d6 Mult2
	var_81_float = GetByIndex(var_70_cvector, 1); // 0x7d7 PushE
	var_81_float = var_81_float + var_68_float; // 0x7d8 Add2
	SetByIndex(var_70_cvector, 1) = var_81_float; // 0x7d9 PopE
	PlayGlobalSound(var_54_string, var_70_cvector); // 0x7da Func
	
Label_2012:
	return 16; // 0x7dc Return
	
Label_1986:
	var_82_int = 1; // 0x7c2 PushI
	var_64_int = var_64_int + var_82_int; // 0x7c3 Add2
	goto Label_1978; // 0x7c4 Jump
}
...
{
	var_19_int = 0; // 0x8ba PushV
	func_2227(var_19_int); // 0x8bb NEW_2
	var_23_int = 1; // 0x8bd PushI
	var_24_bool = var_19_int == var_23_int; // 0x8be Eq
	if(var_24_bool == 0) goto Label_2243; // 0x8bf JumpB
	WorkWithCorpse(var_18_object); // 0x8c0 Func
	goto Label_2245; // 0x8c2 Jump
	
Label_2245:
	return 0; // 0x8c5 Return
	
Label_2243:
	Barter(var_18_object); // 0x8c3 Func
}
...
Label_737:
	...
	var_467_string = "all"; // 0x2e6 PushS
	var_468_string = "attack_middle"; // 0x2e7 PushS
	var_469_int = var_468_string + var_354_int; // 0x2e8 Add
	HasAnimation(var_355_bool, var_467_string, var_469_int); // 0x2e9 Func
	var_470_bool = var_355_bool; // 0x2eb Push
	if(var_470_bool == 0) goto Label_818; // 0x2ec JumpB
	func_2095(); // 0x2ee NEW_2
	var_471_string = "all"; // 0x2f0 PushS
	var_472_string = "attack_middle"; // 0x2f1 PushS
	var_473_int = var_472_string + var_354_int; // 0x2f2 Add
	PlayAnimation(var_471_string, var_473_int); // 0x2f3 Func
	WaitForAnimEnd(); // 0x2f5 Func
	func_1040(var_357_string); // 0x2f8 NEW_2
	var_474_bool = 0; var_475_object = Obj(); // 0x2fa PushV
	var_475_object = var_0_object; // 0x2fb MovT
	func_1675(var_474_bool, var_475_object); // 0x2fc NEW_2
	var_476_bool = var_474_bool == 0; // 0x2fe Not
	if(var_476_bool == 0) goto Label_772; // 0x2ff JumpB
	StopAsync(); // 0x300 Func
	var_348_bool = 0; // 0x302 MovB
	return 8; // 0x303 Return
	
Label_772:
	var_477_float = 0; var_478_int = 0; // 0x304 PushV
	var_477_float = var_349_float; // 0x305 Mov
	var_478_int = var_354_int; // 0x306 Mov
	func_662(var_357_string, var_477_float, var_478_int); // 0x307 NEW_2
	var_356_int = 1; // 0x309 MovI
	
Label_778:
	var_479_string = "attack_middle"; // 0x30a PushS
	var_480_int = var_479_string + var_354_int; // 0x30b Add
	var_481_string = "_"; // 0x30c PushS
	var_482_int = var_480_int + var_481_string; // 0x30d Add
	var_357_string = var_482_int + var_356_int; // 0x30e Add2
	var_483_string = "all"; // 0x30f PushS
	HasAnimation(var_355_bool, var_483_string, var_357_string); // 0x310 Func
	var_484_bool = var_355_bool == 0; // 0x312 Not
	if(var_484_bool == 0) goto Label_789; // 0x313 JumpB
	goto Label_818; // 0x314 Jump
	
Label_818:
	var_485_bool = 0; // 0x332 PushB
	SetAttackState(var_485_bool); // 0x333 Func
	var_486_string = "all"; // 0x335 PushS
	var_487_string = "attack_end"; // 0x336 PushS
	var_488_int = var_487_string + var_354_int; // 0x337 Add
	PlayAnimation(var_486_string, var_488_int); // 0x338 Func
	var_489_bool = 0; // 0x33a PushV
	func_1054(var_489_bool); // 0x33b NEW_2
	if(var_489_bool == 0) goto Label_836; // 0x33d JumpB
	var_490_bool = 0; var_491_float = 0; // 0x33e PushV
	var_491_float = 0.75; // 0x33f MovF
	func_838(var_490_bool, var_491_float); // 0x340 NEW_2
...
Label_789:
	func_2095(); // 0x316 NEW_2
	var_499_string = "all"; // 0x318 PushS
	PlayAnimation(var_499_string, var_357_string); // 0x319 Func
	WaitForAnimEnd(); // 0x31b Func
	func_1040(var_357_string); // 0x31e NEW_2
	var_500_bool = 0; var_501_object = Obj(); // 0x320 PushV
	var_501_object = var_0_object; // 0x321 MovT
	func_1675(var_500_bool, var_501_object); // 0x322 NEW_2
	var_502_bool = var_500_bool == 0; // 0x324 Not
	if(var_502_bool == 0) goto Label_810; // 0x325 JumpB
	StopAsync(); // 0x326 Func
	var_348_bool = 0; // 0x328 MovB
	return 8; // 0x329 Return
	
Label_810:
	var_503_float = 0; var_504_int = 0; // 0x32a PushV
	var_503_float = var_349_float; // 0x32b Mov
	var_504_int = var_354_int; // 0x32c Mov
	func_662(var_357_string, var_503_float, var_504_int); // 0x32d NEW_2
	var_505_int = 1; // 0x32f PushI
	var_356_int = var_356_int + var_505_int; // 0x330 Add2
...
{
	var_120_object = Obj(); var_121_int = 0; var_122_bool = 0; var_123_object = Obj(); var_124_int = 0; var_125_bool = 0; // 0x8c6 PushV
	CreateInvItem(var_123_object); // 0x8c7 Func
	SetItemName(var_119_string); // 0x8c9 ObjFunc
	var_126_string = "Organ"; // 0x8cb PushS
	var_127_int = 1; // 0x8cc PushI
	SetProperty(var_126_string, var_127_int); // 0x8cd ObjFunc
	GetItemID(var_124_int); // 0x8cf ObjFunc
	var_128_int = 0; // 0x8d1 PushI
	var_129_int = 1; // 0x8d2 PushI
	AddItem(var_125_bool, var_123_object, var_128_int, var_129_int); // 0x8d3 Func
...
Label_1759:
	...
	func_2019(var_46_cvector, var_47_cvector); // 0x6e6 NEW_2
...
func_2263()
{
	var_113_int = 0; // 0x8d7 PushV
	func_2227(var_113_int); // 0x8d8 NEW_2
	var_117_int = 1; // 0x8da PushI
	var_118_bool = var_113_int != var_117_int; // 0x8db Neq
	if(var_118_bool == 0) goto Label_2270; // 0x8dc JumpB
	return 0; // 0x8dd Return
	
Label_2270:
	var_119_string = ""; // 0x8de PushV
	var_119_string = "liver"; // 0x8df MovS
	func_2246(var_119_string); // 0x8e0 NEW_2
	var_130_string = ""; // 0x8e2 PushV
	var_130_string = "kidney"; // 0x8e3 MovS
	func_2246(var_130_string); // 0x8e4 NEW_2
	var_131_string = ""; // 0x8e6 PushV
	var_131_string = "heart"; // 0x8e7 MovS
	func_2246(var_131_string); // 0x8e8 NEW_2
	var_132_string = ""; // 0x8ea PushV
	var_132_string = "blood"; // 0x8eb MovS
	func_2246(var_132_string); // 0x8ec NEW_2
...
{
	var_83_object = Obj(); var_84_object = Obj(); // 0x7dd PushV
	self(var_84_object); // 0x7de Func
	var_82_object = var_84_object; // 0x7e0 Mov
...
{
	var_54_float = 0; var_55_float = 0; // 0x7e3 PushV
	var_56_int = var_47_cvector | var_47_cvector; // 0x7e4 Or
	var_55_float = sqrt(var_56_int); // 0x7e5 Sqrt2
	var_57_float = 0.0; // 0x7e6 PushF
	var_58_bool = var_55_float < var_57_float; // 0x7e7 LT
	if(var_58_bool == 0) goto Label_2027; // 0x7e8 JumpB
	var_46_cvector = CVector(0.0, 0.0, 0.0); // 0x7e9 MovV
	return 2; // 0x7ea Return
	
Label_2027:
	var_46_cvector = var_47_cvector / var_47_cvector; // 0x7eb Div2
...
{
	var_442_bool = var_438_float < var_439_float; // 0x7ee LT
	if(var_442_bool == 0) goto Label_2034; // 0x7ef JumpB
	var_437_float = var_438_float; // 0x7f0 Mov
...
Label_2034:
	var_437_float = var_439_float; // 0x7f2 Mov
}
...
{
	var_451_bool = var_448_float < var_449_float; // 0x7f5 LT
	if(var_451_bool == 0) goto Label_2041; // 0x7f6 JumpB
	var_447_float = var_449_float; // 0x7f7 Mov
	return 0; // 0x7f8 Return
	
Label_2041:
	var_452_bool = var_448_float > var_450_float; // 0x7f9 GT
	if(var_452_bool == 0) goto Label_2045; // 0x7fa JumpB
	var_447_float = var_450_float; // 0x7fb Mov
	return 0; // 0x7fc Return
	
Label_2045:
	var_447_float = var_448_float; // 0x7fd Mov
...
{
	var_100_int = 0; var_101_int = 0; // 0x7ff PushV
	GetVariable(var_99_string, var_101_int); // 0x800 Func
	var_98_int = var_101_int; // 0x802 Mov
