...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_86_object, var_87_object)
{
	...
	var_110_int = 510591; // 0x54 PushI
	SetMessage(var_110_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_111_int = 510592; // 0x59 PushI
	var_112_int = 11685; // 0x5a PushI
	var_113_int = 11684; // 0x5b PushI
	AddReply(var_111_int, var_112_int, var_113_int); // 0x5c TObjFunc
	var_114_int = 510599; // 0x5e PushI
	var_115_int = 11685; // 0x5f PushI
	var_116_int = 11692; // 0x60 PushI
	AddReply(var_114_int, var_115_int, var_116_int); // 0x61 TObjFunc
	var_117_int = 510600; // 0x63 PushI
	var_118_int = -1; // 0x64 PushI
	var_119_int = 11694; // 0x65 PushI
