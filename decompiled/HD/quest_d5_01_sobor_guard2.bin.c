...
Label_257:
	...
	func_664(var_73_bool); // 0x103 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_587(var_27_object); // 0x159 NEW_2
...
func_132(var_2_object, var_93_string)
{
	...
	func_664(var_94_bool); // 0x86 NEW_2
...
Label_150:
	func_572(var_97_string, var_98_bool); // 0x96 NEW_2
...
Label_111:
	...
	func_556(var_119_string); // 0x71 NEW_2
...
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x24b PushV
	GetEyesHeight(var_30_float); // 0x24c ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x24e MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x24f PushE
	var_32_float = var_30_float; // 0x250 Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x251 PopE
	var_33_string = "head"; // 0x252 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x253 Func
...
{
	var_75_string = "ui/NPC_Citizen3.png"; // 0x294 MovS
...
func_469(var_25_bool, var_27_float)
{
	...
	func_605(var_52_cvector, var_53_cvector); // 0x1f0 NEW_2
...
Label_510:
	...
	var_65_bool = 1; // 0x200 PushB
	CameraTransit(var_43_cvector, var_41_cvector, var_65_bool); // 0x201 Func
	var_66_float = GetByIndex(var_42_cvector, 0); // 0x203 PushE
	var_67_float = GetByIndex(var_42_cvector, 2); // 0x204 PushE
	Rotate(var_66_float, var_67_float); // 0x205 Func
	var_68_bool = 0; // 0x207 PushV
	func_664(var_68_bool); // 0x208 NEW_2
	if(var_68_bool == 0) goto Label_524; // 0x20a JumpB
...
Label_524:
	var_69_string = "head"; // 0x20c PushS
	HasAnimationTrack(var_45_bool, var_69_string); // 0x20d Func
	var_70_bool = var_45_bool; // 0x20f Push
	if(var_70_bool == 0) goto Label_532; // 0x210 JumpB
	var_71_string = "head"; // 0x211 PushS
	LookAsyncCamera(var_71_string); // 0x212 Func
}


func_662(var_76_string)
{
	var_76_string = "ui/NPC_Citizen3_b.png"; // 0x296 MovS
...
func_598()
{
	var_13_bool = 0; // 0x256 PushV
	func_664(var_13_bool); // 0x257 NEW_2
	if(var_13_bool == 0) goto Label_604; // 0x259 JumpB
...
func_538()
{
	var_137_bool = 0; var_138_bool = 0; // 0x21a PushV
	var_139_bool = 1; // 0x21b PushB
	CameraSwitchToNormal(var_139_bool); // 0x21c Func
	var_140_bool = 0; // 0x21e PushV
	func_664(var_140_bool); // 0x21f NEW_2
	if(var_140_bool == 0) goto Label_547; // 0x221 JumpB
	goto Label_555; // 0x222 Jump
	
Label_555:
	return 2; // 0x22b Return
	
Label_547:
	var_141_string = "head"; // 0x223 PushS
	HasAnimationTrack(var_138_bool, var_141_string); // 0x224 Func
	var_142_bool = var_138_bool; // 0x226 Push
	if(var_142_bool == 0) goto Label_555; // 0x227 JumpB
	var_143_string = "head"; // 0x228 PushS
	UnlookAsync(var_143_string); // 0x229 Func
}


func_605(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x25d PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x25e Or
	var_56_float = sqrt(var_57_int); // 0x25f Sqrt2
	var_58_float = 0.0; // 0x260 PushF
	var_59_bool = var_56_float < var_58_float; // 0x261 LT
	if(var_59_bool == 0) goto Label_613; // 0x262 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x263 MovV
	return 2; // 0x264 Return
	
Label_613:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x265 Div2
...
{
	var_44_string = ""; var_45_string = ""; // 0x267 PushV
	var_45_string = "idle"; // 0x268 MovS
	var_46_int = var_43_int; // 0x269 Push
	if(var_46_int == 0) goto Label_620; // 0x26a JumpB
	var_45_string = var_45_string + var_43_int; // 0x26b Add2
	
Label_620:
	var_42_string = var_45_string; // 0x26c Mov
...
{
	var_120_bool = 0; var_121_float = 0; var_122_float = 0; var_123_bool = 0; var_124_float = 0; var_125_float = 0; // 0x22c PushV
	lshHasAnimation(var_123_bool, var_119_string); // 0x22d Func
	var_126_bool = var_123_bool; // 0x22f Push
	if(var_126_bool == 0) goto Label_567; // 0x230 JumpB
	lshGetAnimTimes(var_119_string, var_124_float, var_125_float); // 0x231 Func
	var_127_bool = 0; // 0x233 PushB
	lshPlayAnimation(var_124_float, var_125_float, var_127_bool); // 0x234 Func
...
Label_567:
	var_128_string = "Can't find lsh animation : "; // 0x237 PushS
	var_129_int = var_128_string + var_119_string; // 0x238 Add
	Trace(var_129_int); // 0x239 Func
}


func_622(var_36_int)
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x26e PushV
	var_39_int = 0; // 0x26f MovI
	
Label_624:
	var_41_string = "all"; // 0x270 PushS
	var_42_string = ""; var_43_int = 0; // 0x271 PushV
	var_43_int = var_39_int; // 0x272 Mov
	func_615(var_42_string, var_43_int); // 0x273 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x275 Func
	var_47_bool = var_40_bool == 0; // 0x277 Not
	if(var_47_bool == 0) goto Label_634; // 0x278 JumpB
	goto Label_637; // 0x279 Jump
	
Label_637:
	var_36_int = var_39_int; // 0x27d Mov
	return 4; // 0x27e Return
	
Label_634:
	var_48_int = 1; // 0x27a PushI
	var_39_int = var_39_int + var_48_int; // 0x27b Add2
	goto Label_624; // 0x27c Jump
}
...
Label_379:
	...
	func_622(var_36_int); // 0x17c NEW_2
...
Label_394:
	...
	func_615(var_58_string, var_59_int); // 0x198 NEW_2
...
{
	var_101_bool = 0; var_102_float = 0; var_103_float = 0; var_104_bool = 0; var_105_float = 0; var_106_float = 0; // 0x23c PushV
	lshHasAnimation(var_104_bool, var_97_string); // 0x23d Func
	var_107_bool = var_104_bool; // 0x23f Push
	if(var_107_bool == 0) goto Label_582; // 0x240 JumpB
	lshGetAnimTimes(var_97_string, var_105_float, var_106_float); // 0x241 Func
	lshPlayAnimation(var_105_float, var_106_float, var_98_bool); // 0x243 Func
...
Label_582:
	var_108_string = "Can't find lsh animation : "; // 0x246 PushS
	var_109_int = var_108_string + var_97_string; // 0x247 Add
	Trace(var_109_int); // 0x248 Func
}
...
func_639(var_77_int)
{
	var_78_int = 0; var_79_int = 0; // 0x27f PushV
	var_80_string = "branch"; // 0x280 PushS
	GetVariable(var_80_string, var_79_int); // 0x281 Func
	var_81_int = 0; // 0x283 PushI
	var_82_bool = var_79_int == var_81_int; // 0x284 Eq
	if(var_82_bool == 0) goto Label_649; // 0x285 JumpB
	var_77_int = 1; // 0x286 MovI
	return 2; // 0x287 Return
	
Label_649:
	var_83_int = 1; // 0x289 PushI
	var_84_bool = var_79_int == var_83_int; // 0x28a Eq
	if(var_84_bool == 0) goto Label_654; // 0x28b JumpB
	var_77_int = 2; // 0x28c MovI
	return 2; // 0x28d Return
	
Label_654:
	var_77_int = 3; // 0x28e MovI
