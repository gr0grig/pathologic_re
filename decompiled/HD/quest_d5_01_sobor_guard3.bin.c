task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	...
	var_33_int = 536353; // 0xac PushI
	SetMessage(var_33_int); // 0xad TObjFunc
	ClearReplies(); // 0xaf TObjFunc
	var_34_int = 536354; // 0xb1 PushI
	var_35_int = 38137; // 0xb2 PushI
	var_36_int = 38136; // 0xb3 PushI
	AddReply(var_34_int, var_35_int, var_36_int); // 0xb4 TObjFunc
	var_37_int = 536361; // 0xb6 PushI
	var_38_int = 38137; // 0xb7 PushI
	var_39_int = 38143; // 0xb8 PushI
	AddReply(var_37_int, var_38_int, var_39_int); // 0xb9 TObjFunc
	var_40_int = 536362; // 0xbb PushI
	var_41_int = 38137; // 0xbc PushI
	var_42_int = 38145; // 0xbd PushI
	AddReply(var_40_int, var_41_int, var_42_int); // 0xbe TObjFunc
	return 0; // 0xc0 Return
	
Label_193:
	var_43_int = 38137; // 0xc1 PushI
	...
	var_46_int = 536355; // 0xc8 PushI
	SetMessage(var_46_int); // 0xc9 TObjFunc
	ClearReplies(); // 0xcb TObjFunc
	var_47_int = 536356; // 0xcd PushI
	var_48_int = -1; // 0xce PushI
	var_49_int = 38138; // 0xcf PushI
	AddReply(var_47_int, var_48_int, var_49_int); // 0xd0 TObjFunc
	var_50_int = 536357; // 0xd2 PushI
	var_51_int = 38140; // 0xd3 PushI
	var_52_int = 38139; // 0xd4 PushI
	AddReply(var_50_int, var_51_int, var_52_int); // 0xd5 TObjFunc
	return 0; // 0xd7 Return
	
Label_216:
	var_53_int = 38140; // 0xd8 PushI
...
Label_239:
	...
	func_646(var_63_bool); // 0xf1 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_569(var_27_object); // 0x147 NEW_2
...
Label_56:
	var_138_bool = var_24_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_139_object = var_15_object; // 0x40 Mov
	func_520(); // 0x41 NEW_2
...
{
	var_75_string = "ui/NPC_Citizen3.png"; // 0x282 MovS
...
func_451(var_25_bool, var_27_float)
{
	...
	func_587(var_52_cvector, var_53_cvector); // 0x1de NEW_2
...
Label_492:
	...
	var_65_bool = 1; // 0x1ee PushB
	CameraTransit(var_43_cvector, var_41_cvector, var_65_bool); // 0x1ef Func
	var_66_float = GetByIndex(var_42_cvector, 0); // 0x1f1 PushE
	var_67_float = GetByIndex(var_42_cvector, 2); // 0x1f2 PushE
	Rotate(var_66_float, var_67_float); // 0x1f3 Func
	var_68_bool = 0; // 0x1f5 PushV
	func_646(var_68_bool); // 0x1f6 NEW_2
	if(var_68_bool == 0) goto Label_506; // 0x1f8 JumpB
	goto Label_514; // 0x1f9 Jump
	
Label_514:
	CameraWaitForPlayFinish(); // 0x202 Func
	ResumeWorld(); // 0x204 Func
	var_25_bool = 1; // 0x206 MovB
	return 18; // 0x207 Return
	
Label_506:
	var_69_string = "head"; // 0x1fa PushS
	HasAnimationTrack(var_45_bool, var_69_string); // 0x1fb Func
	var_70_bool = var_45_bool; // 0x1fd Push
	if(var_70_bool == 0) goto Label_514; // 0x1fe JumpB
	var_71_string = "head"; // 0x1ff PushS
	LookAsyncCamera(var_71_string); // 0x200 Func
}


func_644(var_76_string)
{
	var_76_string = "ui/NPC_Citizen3_b.png"; // 0x284 MovS
...
func_580()
{
	...
	func_646(var_13_bool); // 0x245 NEW_2
	if(var_13_bool == 0) goto Label_586; // 0x247 JumpB
...
func_520()
{
	var_140_bool = 0; var_141_bool = 0; // 0x208 PushV
	var_142_bool = 1; // 0x209 PushB
	CameraSwitchToNormal(var_142_bool); // 0x20a Func
	var_143_bool = 0; // 0x20c PushV
	func_646(var_143_bool); // 0x20d NEW_2
	if(var_143_bool == 0) goto Label_529; // 0x20f JumpB
	goto Label_537; // 0x210 Jump
	
Label_537:
	return 2; // 0x219 Return
	
Label_529:
	var_144_string = "head"; // 0x211 PushS
	HasAnimationTrack(var_141_bool, var_144_string); // 0x212 Func
	var_145_bool = var_141_bool; // 0x214 Push
	if(var_145_bool == 0) goto Label_537; // 0x215 JumpB
	var_146_string = "head"; // 0x216 PushS
	UnlookAsync(var_146_string); // 0x217 Func
}
...
func_137(var_2_object, var_93_string)
{
	...
	func_646(var_94_bool); // 0x8b NEW_2
...
Label_155:
	func_554(var_97_string, var_98_bool); // 0x9b NEW_2
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_86_object, var_87_object)
{
	...
	var_110_int = 536353; // 0x54 PushI
	SetMessage(var_110_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_111_int = 536354; // 0x59 PushI
	var_112_int = 38137; // 0x5a PushI
	var_113_int = 38136; // 0x5b PushI
	AddReply(var_111_int, var_112_int, var_113_int); // 0x5c TObjFunc
	var_114_int = 536361; // 0x5e PushI
	var_115_int = 38137; // 0x5f PushI
	var_116_int = 38143; // 0x60 PushI
	AddReply(var_114_int, var_115_int, var_116_int); // 0x61 TObjFunc
	var_117_int = 536362; // 0x63 PushI
	var_118_int = 38137; // 0x64 PushI
	var_119_int = 38145; // 0x65 PushI
	AddReply(var_117_int, var_118_int, var_119_int); // 0x66 TObjFunc
	goto Label_107; // 0x68 Jump
	
Label_107:
	var_120_bool = 0; // 0x6b PushV
	func_646(var_120_bool); // 0x6c NEW_2
	if(var_120_bool == 0) goto Label_122; // 0x6e JumpB
	
Label_111:
	lshWaitForAnimEnd(); // 0x6f Func
	var_121_string = var_3_string; // 0x71 PushT
	if(var_121_string == 0) goto Label_116; // 0x72 JumpB
...
Label_116:
	var_122_string = ""; // 0x74 PushV
	var_122_string = var_2_object; // 0x75 MovT
	func_538(var_122_string); // 0x76 NEW_2
	goto Label_111; // 0x78 Jump
	
Label_122:
	var_133_string = "all"; // 0x7a PushS
	var_134_string = "idle"; // 0x7b PushS
	PlayAnimation(var_133_string, var_134_string); // 0x7c Func
	
Label_126:
	WaitForAnimEnd(); // 0x7e Func
	var_135_string = var_3_string; // 0x80 PushT
	if(var_135_string == 0) goto Label_131; // 0x81 JumpB
	goto Label_136; // 0x82 Jump
	
Label_131:
	var_136_string = "all"; // 0x83 PushS
	var_137_string = "idle"; // 0x84 PushS
	PlayAnimation(var_136_string, var_137_string); // 0x85 Func
...
{
	var_55_float = 0; var_56_float = 0; // 0x24b PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x24c Or
	var_56_float = sqrt(var_57_int); // 0x24d Sqrt2
	var_58_float = 0.0; // 0x24e PushF
	var_59_bool = var_56_float < var_58_float; // 0x24f LT
	if(var_59_bool == 0) goto Label_595; // 0x250 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x251 MovV
	return 2; // 0x252 Return
	
Label_595:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x253 Div2
...
{
	var_44_string = ""; var_45_string = ""; // 0x255 PushV
	var_45_string = "idle"; // 0x256 MovS
	var_46_int = var_43_int; // 0x257 Push
	if(var_46_int == 0) goto Label_602; // 0x258 JumpB
	var_45_string = var_45_string + var_43_int; // 0x259 Add2
	
Label_602:
	var_42_string = var_45_string; // 0x25a Mov
...
{
	var_123_bool = 0; var_124_float = 0; var_125_float = 0; var_126_bool = 0; var_127_float = 0; var_128_float = 0; // 0x21a PushV
	lshHasAnimation(var_126_bool, var_122_string); // 0x21b Func
	var_129_bool = var_126_bool; // 0x21d Push
	if(var_129_bool == 0) goto Label_549; // 0x21e JumpB
	lshGetAnimTimes(var_122_string, var_127_float, var_128_float); // 0x21f Func
	var_130_bool = 0; // 0x221 PushB
	lshPlayAnimation(var_127_float, var_128_float, var_130_bool); // 0x222 Func
	goto Label_553; // 0x224 Jump
	
Label_553:
	return 6; // 0x229 Return
	
Label_549:
	var_131_string = "Can't find lsh animation : "; // 0x225 PushS
	var_132_int = var_131_string + var_122_string; // 0x226 Add
	Trace(var_132_int); // 0x227 Func
}


func_604(var_36_int)
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x25c PushV
	var_39_int = 0; // 0x25d MovI
	
Label_606:
	var_41_string = "all"; // 0x25e PushS
	var_42_string = ""; var_43_int = 0; // 0x25f PushV
	var_43_int = var_39_int; // 0x260 Mov
	func_597(var_42_string, var_43_int); // 0x261 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x263 Func
	var_47_bool = var_40_bool == 0; // 0x265 Not
	if(var_47_bool == 0) goto Label_616; // 0x266 JumpB
	goto Label_619; // 0x267 Jump
	
Label_619:
	var_36_int = var_39_int; // 0x26b Mov
	return 4; // 0x26c Return
	
Label_616:
	var_48_int = 1; // 0x268 PushI
	var_39_int = var_39_int + var_48_int; // 0x269 Add2
	goto Label_606; // 0x26a Jump
}
...
Label_361:
	...
	func_604(var_36_int); // 0x16a NEW_2
...
Label_376:
	...
	func_597(var_58_string, var_59_int); // 0x186 NEW_2
...
{
	var_101_bool = 0; var_102_float = 0; var_103_float = 0; var_104_bool = 0; var_105_float = 0; var_106_float = 0; // 0x22a PushV
	lshHasAnimation(var_104_bool, var_97_string); // 0x22b Func
	var_107_bool = var_104_bool; // 0x22d Push
	if(var_107_bool == 0) goto Label_564; // 0x22e JumpB
	lshGetAnimTimes(var_97_string, var_105_float, var_106_float); // 0x22f Func
	lshPlayAnimation(var_105_float, var_106_float, var_98_bool); // 0x231 Func
	goto Label_568; // 0x233 Jump
	
Label_568:
	return 6; // 0x238 Return
	
Label_564:
	var_108_string = "Can't find lsh animation : "; // 0x234 PushS
	var_109_int = var_108_string + var_97_string; // 0x235 Add
	Trace(var_109_int); // 0x236 Func
}
...
func_621(var_77_int)
{
	var_78_int = 0; var_79_int = 0; // 0x26d PushV
	var_80_string = "branch"; // 0x26e PushS
	GetVariable(var_80_string, var_79_int); // 0x26f Func
	var_81_int = 0; // 0x271 PushI
	var_82_bool = var_79_int == var_81_int; // 0x272 Eq
	if(var_82_bool == 0) goto Label_631; // 0x273 JumpB
	var_77_int = 1; // 0x274 MovI
	return 2; // 0x275 Return
	
Label_631:
	var_83_int = 1; // 0x277 PushI
	var_84_bool = var_79_int == var_83_int; // 0x278 Eq
	if(var_84_bool == 0) goto Label_636; // 0x279 JumpB
	var_77_int = 2; // 0x27a MovI
	return 2; // 0x27b Return
	
Label_636:
	var_77_int = 3; // 0x27c MovI
...
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x239 PushV
	GetEyesHeight(var_30_float); // 0x23a ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x23c MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x23d PushE
	var_32_float = var_30_float; // 0x23e Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x23f PopE
	var_33_string = "head"; // 0x240 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x241 Func
