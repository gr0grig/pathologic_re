...
Label_199:
	...
	func_889(var_108_object); // 0xcc NEW_2
...
Label_373:
	...
	func_1030(var_200_bool); // 0x177 NEW_2
...
Label_460:
	...
	func_783(var_19_object); // 0x1ce NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_765(var_29_object); // 0x20b NEW_2
...
Label_56:
	var_139_bool = var_23_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_140_object = var_14_object; // 0x40 Mov
	func_716(); // 0x41 NEW_2
...
{
	var_74_string = "ui/NPC_Citizen1.png"; // 0x402 MovS
...
{
	var_75_string = "ui/NPC_Citizen1_b.png"; // 0x404 MovS
...
func_132(var_2_object, var_100_string)
{
	...
	func_1030(var_101_bool); // 0x86 NEW_2
...
Label_150:
	func_750(var_104_string, var_105_bool); // 0x96 NEW_2
...
func_647(var_24_bool, var_26_float)
{
	...
	func_789(var_51_cvector, var_52_cvector); // 0x2a2 NEW_2
...
Label_688:
	...
	var_64_bool = 1; // 0x2b2 PushB
	CameraTransit(var_42_cvector, var_40_cvector, var_64_bool); // 0x2b3 Func
	var_65_float = GetByIndex(var_41_cvector, 0); // 0x2b5 PushE
	var_66_float = GetByIndex(var_41_cvector, 2); // 0x2b6 PushE
	Rotate(var_65_float, var_66_float); // 0x2b7 Func
	var_67_bool = 0; // 0x2b9 PushV
	func_1030(var_67_bool); // 0x2ba NEW_2
	if(var_67_bool == 0) goto Label_702; // 0x2bc JumpB
	goto Label_710; // 0x2bd Jump
	
Label_710:
	CameraWaitForPlayFinish(); // 0x2c6 Func
	ResumeWorld(); // 0x2c8 Func
	var_24_bool = 1; // 0x2ca MovB
	return 18; // 0x2cb Return
	
Label_702:
	var_68_string = "head"; // 0x2be PushS
	HasAnimationTrack(var_44_bool, var_68_string); // 0x2bf Func
	var_69_bool = var_44_bool; // 0x2c1 Push
	if(var_69_bool == 0) goto Label_710; // 0x2c2 JumpB
	var_70_string = "head"; // 0x2c3 PushS
	LookAsyncCamera(var_70_string); // 0x2c4 Func
}
...
func_776()
{
	...
	func_1030(var_15_bool); // 0x309 NEW_2
...
func_901()
{
	var_38_object = Obj(); var_39_object = Obj(); // 0x385 PushV
	var_40_int = 152; // 0x386 PushI
	var_41_int = 2; // 0x387 PushI
	var_42_int = 515358; // 0x388 PushI
	CreateDiaryEntry(var_39_object, var_40_int, var_41_int, var_42_int); // 0x389 Func
	var_43_bool = 0; var_44_object = Obj(); var_45_int = 0; // 0x38b PushV
	var_44_object = var_39_object; // 0x38c Mov
	var_45_int = 148; // 0x38d MovI
	func_927(var_43_bool, var_44_object, var_45_int); // 0x38e NEW_2
...
{
	var_53_object = Obj(); var_54_object = Obj(); // 0x392 PushV
	GetDiaryRoot(var_54_object); // 0x393 Func
	var_55_bool = var_54_object == 0; // 0x395 Not
	if(var_55_bool == 0) goto Label_924; // 0x396 JumpB
	var_56_string = "Can't retrieve diary root"; // 0x397 PushS
	Trace(var_56_string); // 0x398 Func
	var_52_object = 0; // 0x39a MovB
	return 2; // 0x39b Return
	
Label_924:
	var_52_object = var_54_object; // 0x39c Mov
...
{
	var_54_float = 0; var_55_float = 0; // 0x315 PushV
	var_56_int = var_52_cvector | var_52_cvector; // 0x316 Or
	var_55_float = sqrt(var_56_int); // 0x317 Sqrt2
	var_57_float = 0.0; // 0x318 PushF
	var_58_bool = var_55_float < var_57_float; // 0x319 LT
	if(var_58_bool == 0) goto Label_797; // 0x31a JumpB
	var_51_cvector = CVector(0.0, 0.0, 0.0); // 0x31b MovV
	return 2; // 0x31c Return
	
Label_797:
	var_51_cvector = var_52_cvector / var_52_cvector; // 0x31d Div2
...
{
	var_46_object = Obj(); var_47_object = Obj(); var_48_int = 0; var_49_object = Obj(); var_50_object = Obj(); var_51_int = 0; // 0x39f PushV
	var_52_object = Obj(); // 0x3a0 PushV
	func_914(var_52_object); // 0x3a1 NEW_2
	var_49_object = var_52_object; // 0x3a2 Mov
	Find(var_45_int, var_50_object); // 0x3a4 ObjFunc
	var_57_bool = var_50_object == 0; // 0x3a6 Not
	if(var_57_bool == 0) goto Label_942; // 0x3a7 JumpB
	var_58_string = "Can't find diary parent with id: "; // 0x3a8 PushS
	var_59_int = var_58_string + var_45_int; // 0x3a9 Add
	Trace(var_59_int); // 0x3aa Func
	var_43_bool = 0; // 0x3ac MovB
	return 6; // 0x3ad Return
	
Label_942:
	AddChild(var_44_object); // 0x3ae ObjFunc
	var_60_int = 7; // 0x3b0 PushI
	SendWorldWndMessage(var_60_int); // 0x3b1 Func
	GetCategory(var_51_int); // 0x3b3 ObjFunc
	SetDiarySection(var_51_int); // 0x3b5 Func
	var_43_bool = 0; // 0x3b7 MovB
...
{
	var_96_int = 0; var_97_int = 0; // 0x31f PushV
	GetVariable(var_95_string, var_97_int); // 0x320 Func
	var_94_int = var_97_int; // 0x322 Mov
...
Label_431:
	...
	func_783(var_21_object); // 0x1b1 NEW_2
...
Label_557:
	...
	func_828(var_46_int); // 0x22e NEW_2
...
Label_572:
	...
	func_821(var_68_string, var_69_int); // 0x24a NEW_2
...
{
	var_64_object = Obj(); var_65_object = Obj(); // 0x324 PushV
	FindActor(var_65_object, var_62_string); // 0x325 Func
	var_66_bool = var_65_object == 0; // 0x327 NullEq
	if(var_66_bool == 0) goto Label_811; // 0x328 JumpB
	var_61_bool = 0; // 0x329 MovB
	return 2; // 0x32a Return
	
Label_811:
	Trigger(var_65_object, var_63_string); // 0x32b Func
	var_61_bool = 1; // 0x32d MovB
...
{
	var_36_float = 0; var_37_float = 0; // 0x330 PushV
	GetGameTime(var_37_float); // 0x331 Func
	var_35_float = var_37_float; // 0x333 Mov
...
{
	var_25_object = Obj(); var_26_object = Obj(); var_27_object = Obj(); var_28_object = Obj(); // 0x3bb PushV
	GetMainOutdoorScene(var_27_object); // 0x3bc Func
	var_29_bool = var_27_object == 0; // 0x3be NullEq
	if(var_29_bool == 0) goto Label_966; // 0x3bf JumpB
	var_30_string = "Can't find main outdoor scene"; // 0x3c0 PushS
	Trace(var_30_string); // 0x3c1 Func
	var_28_object = 0; // 0x3c3 SetNull
	var_24_object = var_28_object; // 0x3c4 Mov
	return 4; // 0x3c5 Return
	
Label_966:
	GetMap(var_28_object); // 0x3c6 ObjFunc
	var_24_object = var_28_object; // 0x3c8 Mov
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_85_object, var_86_object)
{
	...
	func_889(var_93_object); // 0x52 NEW_2
...
Label_111:
	...
	func_734(var_123_string); // 0x71 NEW_2
...
func_716()
{
	var_141_bool = 0; var_142_bool = 0; // 0x2cc PushV
	var_143_bool = 1; // 0x2cd PushB
	CameraSwitchToNormal(var_143_bool); // 0x2ce Func
	var_144_bool = 0; // 0x2d0 PushV
	func_1030(var_144_bool); // 0x2d1 NEW_2
	if(var_144_bool == 0) goto Label_725; // 0x2d3 JumpB
...
Label_725:
	var_145_string = "head"; // 0x2d5 PushS
	HasAnimationTrack(var_142_bool, var_145_string); // 0x2d6 Func
	var_146_bool = var_142_bool; // 0x2d8 Push
	if(var_146_bool == 0) goto Label_733; // 0x2d9 JumpB
	var_147_string = "head"; // 0x2da PushS
	UnlookAsync(var_147_string); // 0x2db Func
}


func_845()
{
	var_69_object = Obj(); var_70_string = ""; var_71_float = 0; // 0x34e PushV
	var_72_object = Obj(); // 0x34f PushV
	func_955(var_72_object); // 0x350 NEW_2
	var_69_object = var_72_object; // 0x351 Mov
	var_70_string = "pt_d5q01_girl_corpse1"; // 0x353 MovS
	var_71_float = 2; // 0x354 MovI
	func_972(var_69_object, var_70_string, var_71_float); // 0x355 NEW_2
	var_92_object = Obj(); // 0x357 PushV
	func_955(var_92_object); // 0x358 NEW_2
	ShowMap(var_92_object); // 0x35a ObjFunc
...
{
	var_73_cvector = CVector(0,0,0); var_74_cvector = CVector(0,0,0); var_75_object = Obj(); var_76_bool = 0; var_77_cvector = CVector(0,0,0); var_78_cvector = CVector(0,0,0); var_79_object = Obj(); var_80_bool = 0; // 0x3cc PushV
	GetMainOutdoorScene(var_79_object); // 0x3cd Func
	var_81_bool = var_79_object == 0; // 0x3cf NullEq
	if(var_81_bool == 0) goto Label_981; // 0x3d0 JumpB
	var_82_string = "Can't find main outdoor scene"; // 0x3d1 PushS
	Trace(var_82_string); // 0x3d2 Func
	return 8; // 0x3d4 Return
	
Label_981:
	GetLocator(var_70_string, var_80_bool, var_77_cvector, var_78_cvector); // 0x3d5 ObjFunc
	var_83_bool = var_80_bool == 0; // 0x3d7 Not
	if(var_83_bool == 0) goto Label_991; // 0x3d8 JumpB
	var_84_string = "Warning: outdoor scene locator "; // 0x3d9 PushS
	var_85_int = var_84_string + var_70_string; // 0x3da Add
	var_86_string = " doesnt exist"; // 0x3db PushS
	var_87_int = var_85_int + var_86_string; // 0x3dc Add
	Trace(var_87_int); // 0x3dd Func
	
Label_991:
	GetMap(var_69_object); // 0x3df ObjFunc
	var_88_bool = var_69_object == 0; // 0x3e1 NullEq
	if(var_88_bool == 0) goto Label_999; // 0x3e2 JumpB
	var_89_string = "Can't find map"; // 0x3e3 PushS
	Trace(var_89_string); // 0x3e4 Func
	return 8; // 0x3e6 Return
	
Label_999:
	var_90_float = GetByIndex(var_77_cvector, 0); // 0x3e7 PushE
	var_91_float = GetByIndex(var_77_cvector, 2); // 0x3e8 PushE
	SetMapParams(var_90_float, var_91_float, var_71_float); // 0x3e9 ObjFunc
...
func_861()
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x35d PushV
	var_22_string = "d5q02"; // 0x35e PushS
	var_23_int = 4; // 0x35f PushI
	SetVariable(var_22_string, var_23_int); // 0x360 Func
	var_24_object = Obj(); // 0x362 PushV
	func_955(var_24_object); // 0x363 NEW_2
	var_21_object = var_24_object; // 0x364 Mov
	var_31_string = "d5q02NudeMeeting"; // 0x366 PushS
	var_32_string = "pt_d5q01_girl_corpse1"; // 0x367 PushS
	var_33_int = 0; // 0x368 PushI
	var_34_int = 515364; // 0x369 PushI
	var_35_float = 0; // 0x36a PushV
	func_816(var_35_float); // 0x36b NEW_2
	AddMark(var_31_string, var_32_string, var_33_int, var_34_int, var_35_float); // 0x36d ObjFunc
	func_901(); // 0x370 NEW_2
	var_61_bool = 0; var_62_string = ""; var_63_string = ""; // 0x372 PushV
	var_62_string = "quest_d5_02"; // 0x373 MovS
	var_63_string = "remove_girl"; // 0x374 MovS
	func_804(var_61_bool, var_62_string, var_63_string); // 0x375 NEW_2
...
{
	var_124_bool = 0; var_125_float = 0; var_126_float = 0; var_127_bool = 0; var_128_float = 0; var_129_float = 0; // 0x2de PushV
	lshHasAnimation(var_127_bool, var_123_string); // 0x2df Func
	var_130_bool = var_127_bool; // 0x2e1 Push
	if(var_130_bool == 0) goto Label_745; // 0x2e2 JumpB
	lshGetAnimTimes(var_123_string, var_128_float, var_129_float); // 0x2e3 Func
	var_131_bool = 0; // 0x2e5 PushB
	lshPlayAnimation(var_128_float, var_129_float, var_131_bool); // 0x2e6 Func
...
Label_745:
	var_132_string = "Can't find lsh animation : "; // 0x2e9 PushS
	var_133_int = var_132_string + var_123_string; // 0x2ea Add
	Trace(var_133_int); // 0x2eb Func
}


func_1005(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x3ed PushV
	var_79_string = "branch"; // 0x3ee PushS
	GetVariable(var_79_string, var_78_int); // 0x3ef Func
	var_80_int = 0; // 0x3f1 PushI
	var_81_bool = var_78_int == var_80_int; // 0x3f2 Eq
	if(var_81_bool == 0) goto Label_1015; // 0x3f3 JumpB
	var_76_int = 1; // 0x3f4 MovI
	return 2; // 0x3f5 Return
	
Label_1015:
	var_82_int = 1; // 0x3f7 PushI
	var_83_bool = var_78_int == var_82_int; // 0x3f8 Eq
	if(var_83_bool == 0) goto Label_1020; // 0x3f9 JumpB
	var_76_int = 2; // 0x3fa MovI
	return 2; // 0x3fb Return
	
Label_1020:
	var_76_int = 3; // 0x3fc MovI
...
{
	var_108_bool = 0; var_109_float = 0; var_110_float = 0; var_111_bool = 0; var_112_float = 0; var_113_float = 0; // 0x2ee PushV
	lshHasAnimation(var_111_bool, var_104_string); // 0x2ef Func
	var_114_bool = var_111_bool; // 0x2f1 Push
	if(var_114_bool == 0) goto Label_760; // 0x2f2 JumpB
	lshGetAnimTimes(var_104_string, var_112_float, var_113_float); // 0x2f3 Func
	lshPlayAnimation(var_112_float, var_113_float, var_105_bool); // 0x2f5 Func
...
Label_760:
	var_115_string = "Can't find lsh animation : "; // 0x2f8 PushS
	var_116_int = var_115_string + var_104_string; // 0x2f9 Add
	Trace(var_116_int); // 0x2fa Func
}
...
{
	var_94_int = 0; var_95_string = ""; // 0x37a PushV
	var_95_string = "d5q02"; // 0x37b MovS
	func_799(var_94_int, var_95_string); // 0x37c NEW_2
	var_98_int = 3; // 0x37e PushI
	var_99_bool = var_94_int == var_98_int; // 0x37f Eq
	if(var_99_bool == 0) goto Label_899; // 0x380 JumpB
	var_92_bool = 1; // 0x381 MovB
	return 0; // 0x382 Return
	
Label_899:
	var_92_bool = 0; // 0x383 MovB
