...
0x5ec: Push("Can't find lsh animation : ")
...
0x648: Stack[-2] = Stack[-3]
0x649: Stack[-1] = Stack[-5]
0x64a: Call2 0x62e
...
0x6a3: PushEmpty()
0x6a4: Push("money10000 is given")
0x6a5: @ Trace(Stack[-1])
0x6a6: Pop(1)
0x6a7: PushEmpty(object, int)
0x6a8: Stack[-2] = Stack[-4]
...
0x6ad: PushEmpty()
0x6ae: Push("playsound")
0x6af: Push("givemoney")
...
0x6c4: Pop(1)
0x6c5: Push("d5q02GorbunFindTheDaughter")
0x6c6: Push("pt_map_gorbun")
0x6c7: Push((int) 0)
...
0x6cb: Pop(0)
0x6cc: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6cd: Pop(5)
0x6ce: PushEmpty()
0x6cf: Call2 0x777
...
0x6dd: Pop(1)
0x6de: Push("d5q02AnnaGotoGorbun")
0x6df: @@ FindMark(Stack[-2], Stack[-1])
0x6e0: Pop(1)
0x6e1: Push(Stack[-1])
...
0x6e3: @@ Remove()
0x6e4: Pop(0)
0x6e5: Push("d5q02AnnaGotoGorbunSelf")
0x6e6: @@ FindMark(Stack[-2], Stack[-1])
0x6e7: Pop(1)
0x6e8: Push(Stack[-1])
...
0x6ea: @@ Remove()
0x6eb: Pop(0)
0x6ec: Push("d5q02AnnaGotoKabak")
0x6ed: @@ FindMark(Stack[-2], Stack[-1])
0x6ee: Pop(1)
0x6ef: Push(Stack[-1])
...
0x6f1: @@ Remove()
0x6f2: Pop(0)
0x6f3: Push("d5q02GorbunFindTheDaughter")
0x6f4: @@ FindMark(Stack[-2], Stack[-1])
0x6f5: Pop(1)
0x6f6: Push(Stack[-1])
...
0x6f8: @@ Remove()
0x6f9: Pop(0)
0x6fa: Push("d5q02NudeMeeting")
0x6fb: @@ FindMark(Stack[-2], Stack[-1])
0x6fc: Pop(1)
0x6fd: Push(Stack[-1])
...
0x718: PushEmpty()
0x719: Push("money 50000 is given")
0x71a: @ Trace(Stack[-1])
0x71b: Pop(1)
0x71c: PushEmpty(object, int)
0x71d: Stack[-2] = Stack[-4]
...
0x748: Stack[-1] = "d5q02KnowNudeIsDead"
0x749: Call2 0x629
...
0x796: Push("Can't retrieve diary root")
0x797: @ Trace(Stack[-1])
0x798: Pop(1)
...
0x7a2: Pop(1)
0x7a3: @@ Find(Stack[-7], Stack[-2])
0x7a4: Pop(0)
0x7a5: Pop(0); Push((bool) Stack[-2] == 0)
0x7a6: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7a7: Push("Can't find diary parent with id: ")
...
0x7ad: @@ AddChild(Stack[-8])
0x7ae: Pop(0)
0x7af: Push((int) 7)
0x7b0: @ SendWorldWndMessage(Stack[-1])
0x7b1: Pop(1)
0x7b2: @@ GetCategory(Stack[-1])
0x7b3: Pop(0)
...
0x7bc: Pop(0)
0x7bd: Pop(0); Push((bool) Stack[-2] == 0)
0x7be: IF (Stack[-1] == 0) GOTO 0x7c5; Pop(1)

0x7bf: Push("Can't find main outdoor scene")
0x7c0: @ Trace(Stack[-1])
0x7c1: Pop(1)
0x7c2: Stack[-1] = 0
0x7c3: Stack[-5] = Stack[-1]
0x7c4: Return(); Pop(4)

0x7c5: @@ GetMap(Stack[-1])
0x7c6: Pop(0)
...
0x7e0: Stack[-1] = "ui/NPC_Citizen3.png"
0x7e1: Return(); Pop(0)

0x7e2: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x7e3: Return(); Pop(0)
