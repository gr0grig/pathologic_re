...
Label_201:
	...
	var_61_int = 503990; // 0xda PushI
	var_62_int = 4350; // 0xdb PushI
	var_63_int = 4343; // 0xdc PushI
	AddReply(var_61_int, var_62_int, var_63_int); // 0xdd TObjFunc
	return 0; // 0xdf Return
	
Label_224:
	var_64_int = 4350; // 0xe0 PushI
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_86_object, var_87_object)
{
	...
	var_119_int = 503991; // 0x5e PushI
	var_120_int = 38108; // 0x5f PushI
	var_121_int = 4344; // 0x60 PushI
	AddReply(var_119_int, var_120_int, var_121_int); // 0x61 TObjFunc
	
Label_99:
	var_122_int = 536326; // 0x63 PushI
	var_123_int = -1; // 0x64 PushI
	var_124_int = 38107; // 0x65 PushI
...
{
	var_75_string = "ui/NPC_Citizen3.png"; // 0x2a9 MovS
...
{
	var_76_string = "ui/NPC_Citizen3_b.png"; // 0x2ab MovS
...
func_687()
{
	var_18_string = "ood6Boy1"; // 0x2b0 PushS
...
func_693(var_111_bool)
{
	...
	var_114_string = "ood6Boy1"; // 0x2b7 MovS
