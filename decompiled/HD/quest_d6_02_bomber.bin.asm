...
0x68f: Push("GenerateMoney: iMin > iMax")
0x690: @ Trace(Stack[-1])
0x691: Pop(1)
0x692: Return(); Pop(4)
...
0x6ad: Pop(0)
0x6ae: @@ SetItemName(Stack[-7])
0x6af: Pop(0)
0x6b0: Push("Organ")
0x6b1: Push((int) 1)
0x6b2: @@ SetProperty(Stack[-2], Stack[-1])
0x6b3: Pop(2)
0x6b4: @@ GetItemID(Stack[-2])
0x6b5: Pop(0)
0x6b6: Push((int) 0)
0x6b7: Push((int) 1)
...
0x70a: Pop(1)
0x70b: Push("class")
0x70c: @@ GetProperty(Stack[-1], Stack[-2])
0x70d: Pop(1)
...
0x773: Stack[-4] = Stack[-2]
0x774: Pop(2)
0x775: Return(); Pop(0)

0x776: PushEmpty()
0x777: PushEmpty(object)
0x778: Stack[-1] = Stack[-2]
...
0x7ed: Stack[-2] = Stack[-6]
0x7ee: Stack[-1] = "health"
0x7ef: Call2 0x4c4
...
0x7fb: Push("class")
0x7fc: @@ GetProperty(Stack[-1], Stack[-2])
0x7fd: Pop(1)
