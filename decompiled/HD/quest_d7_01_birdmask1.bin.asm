...
0x310: @@ GetItemID(Stack[-3])
0x311: Pop(0)
0x312: Push("Category")
0x313: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x314: Pop(1)
0x315: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x316: Pop(0)
0x317: Pop(0); Push((bool) Stack[-1] == 0)
0x318: IF (Stack[-1] == 0) GOTO 0x31c; Pop(1)

0x319: @@ DropItems(Stack[-8], Stack[-7])
0x31a: Pop(0)
0x31b: GOTO 0x321

0x31c: PushEmpty(int, int)
0x31d: Stack[-2] = Stack[-5]
0x31e: Stack[-1] = Stack[-9]
0x31f: Call2 0x303
...
0x324: Pop(0)
0x325: @@ SetItemName(Stack[-4])
0x326: Pop(0)
0x327: PushEmpty(object, object, int)
0x328: Stack[-3] = Stack[-8]
0x329: Stack[-2] = Stack[-4]
...
0x347: PushEmpty()
0x348: Push("ureport is given")
0x349: @ Trace(Stack[-1])
0x34a: Pop(1)
0x34b: PushEmpty(object, string, int)
0x34c: Stack[-3] = Stack[-5]
0x34d: Stack[-2] = "d7q01_ureport"
0x34e: Stack[-1] = (int) 1
0x34f: Call2 0x322
...
0x354: Stack[-2] = "quest_d7_01"
0x355: Stack[-1] = "kill_player"
0x356: Call2 0x32f
...
0x388: Push((int) 1)
0x389: @@ GetItemCount(Stack[-11], Stack[-1])
0x38a: Pop(1)
0x38b: Push("bird_mask")
0x38c: @ GetInvItemByName(Stack[-10], Stack[-1])
0x38d: Pop(1)
0x38e: Push("bird_balahon")
...
0x396: Push((int) 1)
0x397: @@ GetItem(Stack[-5], Stack[-6], Stack[-1])
0x398: Pop(1)
0x399: @@ GetItemID(Stack[-3])
0x39a: Pop(0)
0x39b: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x39c: IF (Stack[-1] == 0) GOTO 0x3a4; Pop(1)

0x39d: Push((int) 1)
0x39e: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1])
0x39f: Pop(1)
0x3a0: Push(Stack[-2])
...
0x3a6: Push((int) 1)
0x3a7: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1])
0x3a8: Pop(1)
0x3a9: Push(Stack[-1])
...
0x3cc: Stack[-1] = "ui/NPC_bmask.png"
0x3cd: Return(); Pop(0)

0x3ce: Stack[-1] = "ui/NPC_bmask_b.png"
0x3cf: Return(); Pop(0)
