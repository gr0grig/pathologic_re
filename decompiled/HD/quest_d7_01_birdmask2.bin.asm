...
0x386: Pop(0)
0x387: @@ SetItemName(Stack[-4])
0x388: Pop(0)
0x389: PushEmpty(object, object, int)
0x38a: Stack[-3] = Stack[-8]
...
0x3a3: PushEmpty()
0x3a4: Push("dreport is given")
0x3a5: @ Trace(Stack[-1])
0x3a6: Pop(1)
0x3a7: PushEmpty(object, string, int)
0x3a8: Stack[-3] = Stack[-5]
0x3a9: Stack[-2] = "d7q01_dreport"
0x3aa: Stack[-1] = (int) 1
0x3ab: Call2 0x384
...
0x3b6: Stack[-2] = "quest_d7_01"
0x3b7: Stack[-1] = "kill_player"
0x3b8: Call2 0x391
...
0x3ea: Push((int) 1)
0x3eb: @@ GetItemCount(Stack[-11], Stack[-1])
0x3ec: Pop(1)
0x3ed: Push("bird_mask")
0x3ee: @ GetInvItemByName(Stack[-10], Stack[-1])
0x3ef: Pop(1)
0x3f0: Push("bird_balahon")
...
0x3f8: Push((int) 1)
0x3f9: @@ GetItem(Stack[-5], Stack[-6], Stack[-1])
0x3fa: Pop(1)
0x3fb: @@ GetItemID(Stack[-3])
0x3fc: Pop(0)
0x3fd: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x3fe: IF (Stack[-1] == 0) GOTO 0x406; Pop(1)

0x3ff: Push((int) 1)
0x400: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1])
0x401: Pop(1)
0x402: Push(Stack[-2])
...
0x408: Push((int) 1)
0x409: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1])
0x40a: Pop(1)
0x40b: Push(Stack[-1])
...
0x42e: Stack[-1] = "ui/NPC_bmask.png"
0x42f: Return(); Pop(0)

0x430: Stack[-1] = "ui/NPC_bmask_b.png"
0x431: Return(); Pop(0)
