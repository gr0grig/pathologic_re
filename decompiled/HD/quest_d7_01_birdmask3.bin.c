task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int)
{
	...
	func_929(var_12_object); // 0xf0 NEW_2
...
Label_312:
	...
	func_975(var_103_object); // 0x13d NEW_2
...
Label_340:
	...
	func_953(var_137_object); // 0x158 NEW_2
	...
	func_965(var_142_bool, var_143_object); // 0x15d NEW_2
...
Label_379:
	...
	func_953(var_192_object); // 0x17d NEW_2
...
Label_693:
	...
	func_1114(var_325_bool); // 0x2b7 NEW_2
...
{
	var_79_object = Obj(); var_80_object = Obj(); // 0x386 PushV
	FindActor(var_80_object, var_77_string); // 0x387 Func
	var_81_bool = var_80_object == 0; // 0x389 NullEq
	if(var_81_bool == 0) goto Label_909; // 0x38a JumpB
	var_76_bool = 0; // 0x38b MovB
	return 2; // 0x38c Return
	
Label_909:
	Trigger(var_80_object, var_78_string); // 0x38d Func
	var_76_bool = 1; // 0x38f MovB
...
func_1035()
{
	var_51_object = Obj(); var_52_object = Obj(); // 0x40b PushV
	var_53_int = 169; // 0x40c PushI
	var_54_int = 1; // 0x40d PushI
	var_55_int = 515418; // 0x40e PushI
	CreateDiaryEntry(var_52_object, var_53_int, var_54_int, var_55_int); // 0x40f Func
	var_56_bool = 0; var_57_object = Obj(); var_58_int = 0; // 0x411 PushV
	var_57_object = var_52_object; // 0x412 Mov
	var_58_int = 165; // 0x413 MovI
	func_1061(var_56_bool, var_57_object, var_58_int); // 0x414 NEW_2
...
func_914()
{
	var_37_string = "playsound"; // 0x393 PushS
	var_38_string = "giveitem"; // 0x394 PushS
	TriggerWorld(var_37_string, var_38_string); // 0x395 Func
...
func_787()
{
	var_207_bool = 0; var_208_bool = 0; // 0x313 PushV
	var_209_bool = 1; // 0x314 PushB
	CameraSwitchToNormal(var_209_bool); // 0x315 Func
	var_210_bool = 0; // 0x317 PushV
	func_1114(var_210_bool); // 0x318 NEW_2
	if(var_210_bool == 0) goto Label_796; // 0x31a JumpB
	goto Label_804; // 0x31b Jump
	
Label_804:
	return 2; // 0x324 Return
	
Label_796:
	var_211_string = "head"; // 0x31c PushS
	HasAnimationTrack(var_208_bool, var_211_string); // 0x31d Func
	var_212_bool = var_208_bool; // 0x31f Push
	if(var_212_bool == 0) goto Label_804; // 0x320 JumpB
	var_213_string = "head"; // 0x321 PushS
	UnlookAsync(var_213_string); // 0x322 Func
}


func_920()
{
	var_49_string = "d7q01"; // 0x399 PushS
	var_50_int = 3; // 0x39a PushI
	SetVariable(var_49_string, var_50_int); // 0x39b Func
	func_1035(); // 0x39e NEW_2
...
{
	var_66_object = Obj(); var_67_object = Obj(); // 0x418 PushV
	GetDiaryRoot(var_67_object); // 0x419 Func
	var_68_bool = var_67_object == 0; // 0x41b Not
	if(var_68_bool == 0) goto Label_1058; // 0x41c JumpB
	var_69_string = "Can't retrieve diary root"; // 0x41d PushS
	Trace(var_69_string); // 0x41e Func
	var_65_object = 0; // 0x420 MovB
	return 2; // 0x421 Return
	
Label_1058:
	var_65_object = var_67_object; // 0x422 Mov
...
{
	var_13_string = "mreport is given"; // 0x3a2 PushS
	...
	var_15_string = "d7q01_mreport"; // 0x3a7 MovS
	var_16_int = 1; // 0x3a8 MovI
	func_889(var_14_object, var_15_string, var_16_int); // 0x3a9 NEW_2
...
{
	var_121_bool = 0; var_122_float = 0; var_123_float = 0; var_124_bool = 0; var_125_float = 0; var_126_float = 0; // 0x325 PushV
	lshHasAnimation(var_124_bool, var_120_string); // 0x326 Func
	var_127_bool = var_124_bool; // 0x328 Push
	if(var_127_bool == 0) goto Label_816; // 0x329 JumpB
	lshGetAnimTimes(var_120_string, var_125_float, var_126_float); // 0x32a Func
	var_128_bool = 0; // 0x32c PushB
	lshPlayAnimation(var_125_float, var_126_float, var_128_bool); // 0x32d Func
...
Label_816:
	var_129_string = "Can't find lsh animation : "; // 0x330 PushS
	var_130_int = var_129_string + var_120_string; // 0x331 Add
	Trace(var_130_int); // 0x332 Func
}


func_1061(var_56_bool, var_57_object, var_58_int)
{
	var_59_object = Obj(); var_60_object = Obj(); var_61_int = 0; var_62_object = Obj(); var_63_object = Obj(); var_64_int = 0; // 0x425 PushV
	var_65_object = Obj(); // 0x426 PushV
	func_1048(var_65_object); // 0x427 NEW_2
	var_62_object = var_65_object; // 0x428 Mov
	Find(var_58_int, var_63_object); // 0x42a ObjFunc
	var_70_bool = var_63_object == 0; // 0x42c Not
	if(var_70_bool == 0) goto Label_1076; // 0x42d JumpB
	var_71_string = "Can't find diary parent with id: "; // 0x42e PushS
	var_72_int = var_71_string + var_58_int; // 0x42f Add
	Trace(var_72_int); // 0x430 Func
	var_56_bool = 0; // 0x432 MovB
	return 6; // 0x433 Return
	
Label_1076:
	AddChild(var_57_object); // 0x434 ObjFunc
	var_73_int = 7; // 0x436 PushI
	SendWorldWndMessage(var_73_int); // 0x437 Func
	GetCategory(var_64_int); // 0x439 ObjFunc
	SetDiarySection(var_64_int); // 0x43b Func
	var_56_bool = 0; // 0x43d MovB
...
func_940()
{
	var_95_string = "ood7MBirdmask1"; // 0x3ad PushS
	var_96_int = 1; // 0x3ae PushI
	SetVariable(var_95_string, var_96_int); // 0x3af Func
...
func_946()
{
	var_76_bool = 0; var_77_string = ""; var_78_string = ""; // 0x3b3 PushV
	var_77_string = "quest_d7_01"; // 0x3b4 MovS
	var_78_string = "sobor_teleport"; // 0x3b5 MovS
	func_902(var_76_bool, var_77_string, var_78_string); // 0x3b6 NEW_2
...
{
	var_105_bool = 0; var_106_float = 0; var_107_float = 0; var_108_bool = 0; var_109_float = 0; var_110_float = 0; // 0x335 PushV
	lshHasAnimation(var_108_bool, var_101_string); // 0x336 Func
	var_111_bool = var_108_bool; // 0x338 Push
	if(var_111_bool == 0) goto Label_831; // 0x339 JumpB
	lshGetAnimTimes(var_101_string, var_109_float, var_110_float); // 0x33a Func
	lshPlayAnimation(var_109_float, var_110_float, var_102_bool); // 0x33c Func
	goto Label_835; // 0x33e Jump
	
Label_835:
	return 6; // 0x343 Return
	
Label_831:
	var_112_string = "Can't find lsh animation : "; // 0x33f PushS
	var_113_int = var_112_string + var_101_string; // 0x340 Add
	Trace(var_113_int); // 0x341 Func
}


func_953(var_137_bool)
{
	var_139_int = 0; var_140_string = ""; // 0x3ba PushV
	var_140_string = "d7q01"; // 0x3bb MovS
	func_853(var_139_int, var_140_string); // 0x3bc NEW_2
	var_141_int = 2; // 0x3be PushI
	var_142_bool = var_139_int == var_141_int; // 0x3bf Eq
	if(var_142_bool == 0) goto Label_963; // 0x3c0 JumpB
	var_137_bool = 1; // 0x3c1 MovB
	return 0; // 0x3c2 Return
	
Label_963:
	var_137_bool = 0; // 0x3c3 MovB
...
{
	var_70_int = 0; var_71_int = 0; // 0x441 PushV
	var_72_string = "branch"; // 0x442 PushS
	GetVariable(var_72_string, var_71_int); // 0x443 Func
	var_73_int = 0; // 0x445 PushI
	var_74_bool = var_71_int == var_73_int; // 0x446 Eq
	if(var_74_bool == 0) goto Label_1099; // 0x447 JumpB
	var_69_int = 1; // 0x448 MovI
	return 2; // 0x449 Return
	
Label_1099:
	var_75_int = 1; // 0x44b PushI
	var_76_bool = var_71_int == var_75_int; // 0x44c Eq
	if(var_76_bool == 0) goto Label_1104; // 0x44d JumpB
	var_69_int = 2; // 0x44e MovI
	return 2; // 0x44f Return
	
Label_1104:
	var_69_int = 3; // 0x450 MovI
...
func_836()
{
	var_8_bool = 0; // 0x344 PushV
	func_1114(var_8_bool); // 0x345 NEW_2
	if(var_8_bool == 0) goto Label_842; // 0x347 JumpB
	lshStopSpeech(); // 0x348 Func
...
{
	var_145_bool = 0; var_146_object = Obj(); // 0x3c6 PushV
	var_146_object = var_144_object; // 0x3c7 Mov
	func_987(var_146_object); // 0x3c8 NEW_2
	if(var_145_bool == 0) goto Label_973; // 0x3ca JumpB
	var_143_bool = 1; // 0x3cb MovB
	return 0; // 0x3cc Return
	
Label_973:
	var_143_bool = 0; // 0x3cd MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_78_object, var_79_object)
{
	...
	func_206(var_79_object, var_97_string); // 0x5c NEW_2
	var_114_int = 513212; // 0x5e PushI
	SetMessage(var_114_int); // 0x5f TObjFunc
	ClearReplies(); // 0x61 TObjFunc
	var_115_int = 513213; // 0x63 PushI
	var_116_int = 14437; // 0x64 PushI
	var_117_int = 14436; // 0x65 PushI
	AddReply(var_115_int, var_116_int, var_117_int); // 0x66 TObjFunc
	goto Label_176; // 0x68 Jump
	
Label_176:
	var_118_bool = 0; // 0xb0 PushV
	func_1114(var_118_bool); // 0xb1 NEW_2
	if(var_118_bool == 0) goto Label_191; // 0xb3 JumpB
	
Label_180:
	lshWaitForAnimEnd(); // 0xb4 Func
	var_119_string = var_3_string; // 0xb6 PushT
	if(var_119_string == 0) goto Label_185; // 0xb7 JumpB
...
Label_185:
	var_120_string = ""; // 0xb9 PushV
	var_120_string = var_2_object; // 0xba MovT
	func_805(var_120_string); // 0xbb NEW_2
	goto Label_180; // 0xbd Jump
	
Label_191:
	var_131_string = "all"; // 0xbf PushS
	var_132_string = "idle"; // 0xc0 PushS
	PlayAnimation(var_131_string, var_132_string); // 0xc1 Func
	
Label_195:
	WaitForAnimEnd(); // 0xc3 Func
	var_133_string = var_3_string; // 0xc5 PushT
	if(var_133_string == 0) goto Label_200; // 0xc6 JumpB
	goto Label_205; // 0xc7 Jump
	
Label_200:
	var_134_string = "all"; // 0xc8 PushS
	var_135_string = "idle"; // 0xc9 PushS
	PlayAnimation(var_134_string, var_135_string); // 0xca Func
	goto Label_195; // 0xcc Jump
	
Label_105:
	var_136_bool = 0; // 0x69 PushV
	var_136_bool = 0; // 0x6a MovB
	var_137_bool = 0; var_138_object = Obj(); // 0x6b PushV
	var_138_object = var_1_object; // 0x6c MovT
	func_953(var_138_object); // 0x6d NEW_2
	if(var_137_bool == 0) goto Label_118; // 0x6f JumpB
	var_143_bool = 0; var_144_object = Obj(); // 0x70 PushV
	var_144_object = var_1_object; // 0x71 MovT
	func_965(var_143_bool, var_144_object); // 0x72 NEW_2
	if(var_143_bool == 0) goto Label_118; // 0x74 JumpB
	var_136_bool = 1; // 0x75 MovB
	
Label_118:
	if(var_136_bool == 0) goto Label_144; // 0x76 JumpB
	var_181_string = ""; // 0x77 PushV
	var_181_string = "Neutral"; // 0x78 MovS
	func_206(var_79_object, var_181_string); // 0x79 NEW_2
	var_182_int = 513216; // 0x7b PushI
	SetMessage(var_182_int); // 0x7c TObjFunc
	ClearReplies(); // 0x7e TObjFunc
	var_183_int = 513217; // 0x80 PushI
	var_184_int = 14441; // 0x81 PushI
	var_185_int = 14440; // 0x82 PushI
	AddReply(var_183_int, var_184_int, var_185_int); // 0x83 TObjFunc
	var_186_int = 513220; // 0x85 PushI
	var_187_int = 14444; // 0x86 PushI
	var_188_int = 14443; // 0x87 PushI
	AddReply(var_186_int, var_187_int, var_188_int); // 0x88 TObjFunc
	var_189_int = 513224; // 0x8a PushI
	var_190_int = 14441; // 0x8b PushI
	var_191_int = 14447; // 0x8c PushI
	AddReply(var_189_int, var_190_int, var_191_int); // 0x8d TObjFunc
	goto Label_176; // 0x8f Jump
	
Label_144:
	var_192_bool = 0; var_193_object = Obj(); // 0x90 PushV
	var_193_object = var_1_object; // 0x91 MovT
	func_953(var_193_object); // 0x92 NEW_2
	if(var_192_bool == 0) goto Label_174; // 0x94 JumpB
	var_194_string = ""; // 0x95 PushV
	var_194_string = "Neutral"; // 0x96 MovS
	func_206(var_79_object, var_194_string); // 0x97 NEW_2
	var_195_int = 513231; // 0x99 PushI
	SetMessage(var_195_int); // 0x9a TObjFunc
	ClearReplies(); // 0x9c TObjFunc
	var_196_int = 513232; // 0x9e PushI
	var_197_int = 14456; // 0x9f PushI
	var_198_int = 14455; // 0xa0 PushI
	AddReply(var_196_int, var_197_int, var_198_int); // 0xa1 TObjFunc
	var_199_int = 513248; // 0xa3 PushI
	var_200_int = 16562; // 0xa4 PushI
	var_201_int = 14473; // 0xa5 PushI
	AddReply(var_199_int, var_200_int, var_201_int); // 0xa6 TObjFunc
	var_202_int = 513249; // 0xa8 PushI
	var_203_int = -1; // 0xa9 PushI
	var_204_int = 14475; // 0xaa PushI
	AddReply(var_202_int, var_203_int, var_204_int); // 0xab TObjFunc
...
{
	var_47_float = 0; var_48_float = 0; // 0x34b PushV
	var_49_int = var_45_cvector | var_45_cvector; // 0x34c Or
	var_48_float = sqrt(var_49_int); // 0x34d Sqrt2
	var_50_float = 0.0; // 0x34e PushF
	var_51_bool = var_48_float < var_50_float; // 0x34f LT
	if(var_51_bool == 0) goto Label_851; // 0x350 JumpB
	var_44_cvector = CVector(0.0, 0.0, 0.0); // 0x351 MovV
	return 2; // 0x352 Return
	
Label_851:
	var_44_cvector = var_45_cvector / var_45_cvector; // 0x353 Div2
...
func_718(var_17_bool, var_19_float)
{
	...
	func_843(var_44_cvector, var_45_cvector); // 0x2e9 NEW_2
...
Label_759:
	...
	var_57_bool = 1; // 0x2f9 PushB
	CameraTransit(var_35_cvector, var_33_cvector, var_57_bool); // 0x2fa Func
	var_58_float = GetByIndex(var_34_cvector, 0); // 0x2fc PushE
	var_59_float = GetByIndex(var_34_cvector, 2); // 0x2fd PushE
	Rotate(var_58_float, var_59_float); // 0x2fe Func
	var_60_bool = 0; // 0x300 PushV
	func_1114(var_60_bool); // 0x301 NEW_2
	if(var_60_bool == 0) goto Label_773; // 0x303 JumpB
	goto Label_781; // 0x304 Jump
	
Label_781:
	CameraWaitForPlayFinish(); // 0x30d Func
	ResumeWorld(); // 0x30f Func
	var_17_bool = 1; // 0x311 MovB
	return 18; // 0x312 Return
	
Label_773:
	var_61_string = "head"; // 0x305 PushS
	HasAnimationTrack(var_37_bool, var_61_string); // 0x306 Func
	var_62_bool = var_37_bool; // 0x308 Push
	if(var_62_bool == 0) goto Label_781; // 0x309 JumpB
	var_63_string = "head"; // 0x30a PushS
	LookAsyncCamera(var_63_string); // 0x30b Func
}


func_975(var_85_bool)
{
	var_87_int = 0; var_88_string = ""; // 0x3d0 PushV
	var_88_string = "ood7MBirdmask1"; // 0x3d1 MovS
	func_853(var_87_int, var_88_string); // 0x3d2 NEW_2
	var_91_int = 0; // 0x3d4 PushI
	var_92_bool = var_87_int == var_91_int; // 0x3d5 Eq
	if(var_92_bool == 0) goto Label_985; // 0x3d6 JumpB
	var_85_bool = 1; // 0x3d7 MovB
	return 0; // 0x3d8 Return
	
Label_985:
	var_85_bool = 0; // 0x3d9 MovB
...
{
	var_98_bool = 0; // 0xcf PushV
	func_1114(var_98_bool); // 0xd0 NEW_2
	var_99_bool = var_98_bool == 0; // 0xd2 Not
	if(var_99_bool == 0) goto Label_213; // 0xd3 JumpB
	return 0; // 0xd4 Return
	
Label_213:
	var_100_bool = var_97_string == var_2_object; // 0xd5 Eq
	if(var_100_bool == 0) goto Label_216; // 0xd6 JumpB
	return 0; // 0xd7 Return
	
Label_216:
	var_101_string = ""; var_102_bool = 0; // 0xd8 PushV
	var_101_string = var_97_string; // 0xd9 Mov
	var_103_string = ""; // 0xda PushS
	var_104_bool = var_97_string == var_103_string; // 0xdb Eq
	if(var_104_bool == 0) goto Label_223; // 0xdc JumpB
	var_102_bool = 0; // 0xdd MovB
	goto Label_224; // 0xde Jump
	
Label_224:
	func_821(var_101_string, var_102_bool); // 0xe0 NEW_2
	var_2_object = var_97_string; // 0xe2 TMov
	return 0; // 0xe3 Return
	
Label_223:
	var_102_bool = 1; // 0xdf MovB
}


func_1106(var_66_int)
{
	var_66_int = 515571; // 0x452 MovI
...
{
	var_89_int = 0; var_90_int = 0; // 0x355 PushV
	GetVariable(var_88_string, var_90_int); // 0x356 Func
	var_87_int = var_90_int; // 0x358 Mov
...
{
	var_67_string = "ui/NPC_bmask.png"; // 0x456 MovS
...
{
	var_68_string = "ui/NPC_bmask_b.png"; // 0x458 MovS
...
{
	var_32_object = Obj(); var_33_object = Obj(); // 0x35a PushV
	CreateIntVector(var_33_object); // 0x35b Func
	add(var_30_int); // 0x35d ObjFunc
	add(var_31_int); // 0x35f ObjFunc
	var_34_int = 3; // 0x361 PushI
	SendWorldWndMessage(var_34_int, var_33_object); // 0x362 Func
	return 2; // 0x364 Return
}


func_987(var_145_bool)
{
	var_147_int = 0; var_148_int = 0; var_149_int = 0; var_150_bool = 0; var_151_bool = 0; var_152_int = 0; var_153_object = Obj(); var_154_int = 0; var_155_bool = 0; var_156_bool = 0; var_157_int = 0; var_158_int = 0; var_159_int = 0; var_160_bool = 0; var_161_bool = 0; var_162_int = 0; var_163_object = Obj(); var_164_int = 0; var_165_bool = 0; var_166_bool = 0; // 0x3db PushV
	var_167_int = 1; // 0x3dc PushI
	GetItemCount(var_157_int, var_167_int); // 0x3dd ObjFunc
	var_168_string = "bird_mask"; // 0x3df PushS
	GetInvItemByName(var_158_int, var_168_string); // 0x3e0 Func
	var_169_string = "bird_balahon"; // 0x3e2 PushS
	GetInvItemByName(var_159_int, var_169_string); // 0x3e3 Func
	var_160_bool = 0; // 0x3e5 MovB
	var_161_bool = 0; // 0x3e6 MovB
	var_162_int = 0; // 0x3e7 MovI
	
Label_1000:
	var_170_bool = var_162_int < var_157_int; // 0x3e8 LT
	if(var_170_bool == 0) goto Label_1028; // 0x3e9 JumpB
	var_171_int = 1; // 0x3ea PushI
	GetItem(var_163_object, var_162_int, var_171_int); // 0x3eb ObjFunc
	GetItemID(var_164_int); // 0x3ed ObjFunc
	var_172_bool = var_164_int == var_158_int; // 0x3ef Eq
	if(var_172_bool == 0) goto Label_1016; // 0x3f0 JumpB
	var_173_int = 1; // 0x3f1 PushI
	IsItemSelected(var_165_bool, var_162_int, var_173_int); // 0x3f2 ObjFunc
	var_174_bool = var_165_bool; // 0x3f4 Push
	if(var_174_bool == 0) goto Label_1015; // 0x3f5 JumpB
	var_160_bool = 1; // 0x3f6 MovB
	
Label_1015:
	goto Label_1024; // 0x3f7 Jump
	
Label_1024:
	var_163_object = 0; // 0x400 SetNull
	var_175_int = 1; // 0x401 PushI
	var_162_int = var_162_int + var_175_int; // 0x402 Add2
	goto Label_1000; // 0x403 Jump
	
Label_1016:
	var_176_bool = var_164_int == var_159_int; // 0x3f8 Eq
	if(var_176_bool == 0) goto Label_1024; // 0x3f9 JumpB
	var_177_int = 1; // 0x3fa PushI
	IsItemSelected(var_166_bool, var_162_int, var_177_int); // 0x3fb ObjFunc
	var_178_bool = var_166_bool; // 0x3fd Push
	if(var_178_bool == 0) goto Label_1024; // 0x3fe JumpB
	var_161_bool = 1; // 0x3ff MovB
	
Label_1028:
	var_145_bool = 0; // 0x404 MovB
	var_179_bool = var_160_bool; // 0x405 Push
	if(var_179_bool == 0) goto Label_1034; // 0x406 JumpB
	var_180_bool = var_161_bool; // 0x407 Push
	if(var_180_bool == 0) goto Label_1034; // 0x408 JumpB
	var_145_bool = 1; // 0x409 MovB
	
Label_1034:
	return 20; // 0x40a Return
}


func_870(var_20_object, var_21_int)
{
	var_22_int = 0; var_23_int = 0; var_24_bool = 0; var_25_int = 0; var_26_int = 0; var_27_bool = 0; // 0x366 PushV
	GetItemID(var_25_int); // 0x367 ObjFunc
	var_28_string = "Category"; // 0x369 PushS
	GetInvItemProperty(var_26_int, var_25_int, var_28_string); // 0x36a Func
	AddItem(var_27_bool, var_20_object, var_26_int, var_21_int); // 0x36c ObjFunc
	var_29_bool = var_27_bool == 0; // 0x36e Not
	if(var_29_bool == 0) goto Label_883; // 0x36f JumpB
	DropItems(var_20_object, var_21_int); // 0x370 ObjFunc
...
Label_883:
	var_30_int = 0; var_31_int = 0; // 0x373 PushV
	var_30_int = var_25_int; // 0x374 Mov
	var_31_int = var_21_int; // 0x375 Mov
	func_858(var_30_int, var_31_int); // 0x376 NEW_2
}


func_889(var_14_object, var_15_string, var_16_int)
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x379 PushV
	CreateInvItem(var_18_object); // 0x37a Func
	SetItemName(var_15_string); // 0x37c ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x37e PushV
	var_19_object = var_14_object; // 0x37f Mov
	var_20_object = var_18_object; // 0x380 Mov
	var_21_int = var_16_int; // 0x381 Mov
	func_870(var_20_object, var_21_int); // 0x382 NEW_2
