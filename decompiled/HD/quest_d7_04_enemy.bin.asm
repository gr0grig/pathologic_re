...
0xbfb: Stack[-3] = Stack[-2]
0xbfc: GOTO 0xbfe

0xbfd: Stack[-3] = Stack[-1]
0xbfe: Return(); Pop(0)
...
0xcc1: Pop(0)
0xcc2: Push((int) 1)
0xcc3: @@ SetProperty(Stack[-2], Stack[-1])
0xcc4: Pop(2)
0xcc5: PushEmpty(bool, object)
0xcc6: Stack[-1] = Stack[-3]
0xcc7: Call2 0xd3a
...
0xcfa: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5])
0xcfb: Pop(1)
...
0xd04: Push("Pantrol point count: ")
...
0xd1a: Push("changing state to c_iStateWaitForLoad")
0xd1b: @ Trace(Stack[-1])
0xd1c: Pop(1)
0xd1d: GOTO 0xd35
...
0xd21: Push("changing state to c_iStateHeatHands")
0xd22: @ Trace(Stack[-1])
0xd23: Pop(1)
0xd24: GOTO 0xd35
...
0xd28: Push("changing state to c_iStateIdle")
0xd29: @ Trace(Stack[-1])
0xd2a: Pop(1)
0xd2b: GOTO 0xd35
...
0xd2f: Push("changing state to c_iStatePatrol")
0xd30: @ Trace(Stack[-1])
0xd31: Pop(1)
0xd32: GOTO 0xd35
...
0xd44: Push("changing state to c_iStateAware")
0xd45: @ Trace(Stack[-1])
0xd46: Pop(1)
0xd47: Push(GlobalVars[4])
0xd48: Stack[-1] = Stack[-2]
...
0xd56: Push("changing state to c_iStateSearchEnemy")
0xd57: @ Trace(Stack[-1])
0xd58: Pop(1)
...
0xd68: Push("changing state to c_iStateHearEnemy")
0xd69: @ Trace(Stack[-1])
0xd6a: Pop(1)
0xd6b: Push(GlobalVars[6])
0xd6c: Stack[-1] = Stack[-2]
...
0xd7a: Push("changing state to c_iStateAttack")
0xd7b: @ Trace(Stack[-1])
0xd7c: Pop(1)
0xd7d: Push(GlobalVars[7])
0xd7e: Stack[-1] = Stack[-2]
...
0xdc1: Stack[-3] = Stack[-7]
0xdc2: Stack[-2] = Stack[-6]
0xdc3: Stack[-1] = Stack[-5]
0xdc4: Call2 0xb52
...
0xdc9: Stack[-5] = Stack[-11]
0xdca: Stack[-4] = Stack[-10]
0xdcb: Stack[-3] = Stack[-9]
0xdcc: Stack[-2] = Stack[-7]
0xdcd: Stack[-1] = Stack[-6]
0xdce: Call2 0xb96
...
0xde6: Stack[-1] = "pt_d7q04_patrol"
0xde7: Return(); Pop(0)

0xde8: Stack[-1] = "d7q04_helpme"
0xde9: Return(); Pop(0)

0xdea: Stack[-1] = "d7q04_corpse"
0xdeb: Return(); Pop(0)

0xdec: Stack[-1] = "pt_d7q04_bonfire"
0xded: Return(); Pop(0)
...
0xdfa: Pop(2)
0xdfb: Push("grass_combination")
0xdfc: @@ SetItemName(Stack[-1])
0xdfd: Pop(1)
0xdfe: Push("im_inc")
...
0xe07: @@ SetProperty(Stack[-2], Stack[-1])
0xe08: Pop(2)
0xe09: Push((int) 0)
0xe0a: Push((int) 1)
