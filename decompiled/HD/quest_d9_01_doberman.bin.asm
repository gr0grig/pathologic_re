...
0x23a: Push("Can't find lsh animation : ")
...
0x292: Stack[-1] = "ui/NPC_Citizen2.png"
0x293: Return(); Pop(0)

0x294: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x295: Return(); Pop(0)
...
0x29a: Stack[-2] = "quest_d9_01"
0x29b: Stack[-1] = "teleport_to_han"
0x29c: Call2 0x26a
