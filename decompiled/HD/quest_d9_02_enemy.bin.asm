...
0xa9f: @@ HasProperty(Stack[-3], Stack[-1])
0xaa0: Pop(0)
0xaa1: Stack[-5] = Stack[-1]
0xaa2: Return(); Pop(2)

0xaa3: PushEmpty(float, float)
0xaa4: PushEmpty(bool, object, string)
0xaa5: Stack[-2] = Stack[-10]
0xaa6: Stack[-1] = Stack[-9]
0xaa7: Call2 0xa97
...
0xaad: @@ GetProperty(Stack[-6], Stack[-1])
0xaae: Pop(0)
0xaaf: PushEmpty(float, float, float, float)
0xab0: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xab1: Stack[-2] = Stack[-8]
0xab2: Stack[-1] = Stack[-7]
0xab3: Call2 0xc1c

0xab4: Pop(3)
0xab5: @@ SetProperty(Stack[-7], Stack[-1])
0xab6: Pop(1)
...
0xabb: Stack[-2] = Stack[-18]
0xabc: Stack[-1] = "health"
0xabd: Call2 0xa97
...
0xacc: Push("armor")
0xacd: @@ GetProperty(Stack[-1], Stack[-7])
0xace: Pop(1)
0xacf: Push("armor_")
0xad0: PushEmpty(string, int)
0xad1: Stack[-1] = Stack[-16]
0xad2: Call2 0xa76

0xad3: Pop(1)
0xad4: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xad5: PushEmpty(bool, object, string)
0xad6: Stack[-2] = Stack[-18]
0xad7: Stack[-1] = Stack[-8]
0xad8: Call2 0xa97
...
0xade: @@ GetProperty(Stack[-5], Stack[-4])
0xadf: Pop(0)
...
0xae6: Stack[-6] = Stack[-3]
0xae7: Pop(3)
0xae8: Push("health")
0xae9: @@ GetProperty(Stack[-1], Stack[-3])
0xaea: Pop(1)
0xaeb: Push((int) 1)
...
0xaf4: Pop(3)
0xaf5: @@ SetProperty(Stack[-2], Stack[-1])
0xaf6: Pop(2)
0xaf7: PushEmpty(bool, object)
0xaf8: Stack[-1] = Stack[-17]
0xaf9: Call2 0xa92
...
0xaff: Pop(1)
0xb00: Stack[-16] = Stack[-1]
0xb01: Return(); Pop(12)

0xb02: PushEmpty(bool, bool)
0xb03: @@ IsDead(Stack[-1])
0xb04: Pop(0)
0xb05: Stack[-4] = Stack[-1]
0xb06: Return(); Pop(2)

0xb07: PushEmpty(object, object, object, object)
0xb08: Pop(0); Push((bool) Stack[-5] == 0)
...
0xb3d: Push("noaccess")
0xb3e: @@ GetProperty(Stack[-1], Stack[-2])
0xb3f: Pop(1)
0xb40: Push((int) 0)
...
0xb44: Pop(0); Push((bool) Stack[-15] == 0)
...
0xb82: Stack[-1] = Stack[-25]
0xb83: Call2 0xa84

0xb84: Stack[-3] = Stack[-2]
0xb85: Pop(2)
0xb86: Call2 0xc0b

0xb87: Stack[-11] = Stack[-2]
0xb88: Pop(2)
...
0xba1: Pop(0)
0xba2: @@ get(Stack[-1], Stack[-2])
0xba3: Pop(0)
0xba4: PushEmpty(object, int, float, cvector, cvector)
0xba5: Stack[-5] = Stack[-26]
0xba6: Stack[-4] = Stack[-25]
0xba7: Stack[-3] = Stack[-24]
0xba8: Stack[-2] = Stack[-6]
...
0xbce: Pop(0)
0xbcf: Stack[-3] = Stack[-1]
0xbd0: Return(); Pop(2)

0xbd1: PushEmpty(float, cvector, float, cvector)
0xbd2: @@ GetEyesHeight(Stack[-2])
0xbd3: Pop(0)
...
0xc18: Stack[-3] = Stack[-2]
0xc19: GOTO 0xc1b

0xc1a: Stack[-3] = Stack[-1]
0xc1b: Return(); Pop(0)
...
0xc42: Stack[-1] = Stack[-2]
0xc43: Call2 0xc60

0xc44: Pop(1)
0xc45: PushEmpty(bool, object, string, float, float, float)
0xc46: Stack[-5] = Stack[-8]
0xc47: Stack[-4] = "reputation"
0xc48: Stack[-3] = Stack[-7]
0xc49: Stack[-2] = (int) 0
0xc4a: Stack[-1] = (int) 1
0xc4b: Call2 0xaa3
...
0xd0b: Pop(0)
0xd0c: Push((int) 1)
0xd0d: @@ SetProperty(Stack[-2], Stack[-1])
0xd0e: Pop(2)
0xd0f: PushEmpty(bool, object)
0xd10: Stack[-1] = Stack[-3]
0xd11: Call2 0xd84

0xd12: Stack[-4] = Stack[-2]
0xd13: Pop(2)
0xd14: Return(); Pop(0)
...
0xd44: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5])
0xd45: Pop(1)
...
0xd4e: Push("Pantrol point count: ")
...
0xd61: Stack[-2] = Stack[-1]
0xd62: Pop(1)
0xd63: GlobalVars[3] = Stack[-1]; Pop(1)
0xd64: Push("changing state to c_iStateWaitForLoad")
0xd65: @ Trace(Stack[-1])
0xd66: Pop(1)
0xd67: GOTO 0xd7f
...
0xd6b: Push("changing state to c_iStateHeatHands")
0xd6c: @ Trace(Stack[-1])
0xd6d: Pop(1)
0xd6e: GOTO 0xd7f
...
0xd72: Push("changing state to c_iStateIdle")
0xd73: @ Trace(Stack[-1])
0xd74: Pop(1)
0xd75: GOTO 0xd7f
...
0xd79: Push("changing state to c_iStatePatrol")
0xd7a: @ Trace(Stack[-1])
0xd7b: Pop(1)
0xd7c: GOTO 0xd7f
...
0xd8e: Push("changing state to c_iStateAware")
0xd8f: @ Trace(Stack[-1])
0xd90: Pop(1)
...
0xda0: Push("changing state to c_iStateSearchEnemy")
0xda1: @ Trace(Stack[-1])
0xda2: Pop(1)
...
0xdb2: Push("changing state to c_iStateHearEnemy")
0xdb3: @ Trace(Stack[-1])
0xdb4: Pop(1)
0xdb5: Push(GlobalVars[6])
0xdb6: Stack[-1] = Stack[-2]
...
0xdc4: Push("changing state to c_iStateAttack")
0xdc5: @ Trace(Stack[-1])
0xdc6: Pop(1)
0xdc7: Push(GlobalVars[7])
0xdc8: Stack[-1] = Stack[-2]
...
0xe0b: Stack[-3] = Stack[-7]
0xe0c: Stack[-2] = Stack[-6]
...
0xe13: Stack[-5] = Stack[-11]
0xe14: Stack[-4] = Stack[-10]
0xe15: Stack[-3] = Stack[-9]
0xe16: Stack[-2] = Stack[-7]
0xe17: Stack[-1] = Stack[-6]
0xe18: Call2 0xbb3
...
0xe30: Stack[-1] = "pt_d9q02_patrol"
0xe31: Return(); Pop(0)

0xe32: Stack[-1] = "d9q02_helpme"
0xe33: Return(); Pop(0)

0xe34: Stack[-1] = "d9q02_corpse"
0xe35: Return(); Pop(0)

0xe36: Stack[-1] = "pt_d9q02_center"
0xe37: Return(); Pop(0)
...
0xe47: Stack[-3] = Stack[-1]
0xe48: Pop(1)
0xe49: Stack[-1] = (float) -0.03
0xe4a: Call2 0xc2c
