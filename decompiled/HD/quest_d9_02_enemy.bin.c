...
Label_3137:
	...
	func_3168(var_67_float); // 0xc43 NEW_2
...
func_3642()
{
	var_47_bool = 0; var_48_int = 0; var_49_bool = 0; var_50_int = 0; // 0xe3a PushV
	var_51_int = 6; // 0xe3b PushI
	irand(var_50_int, var_51_int); // 0xe3c Func
	var_52_string = "rusk"; // 0xe3e PushS
	var_53_int = 0; // 0xe3f PushI
	var_54_int = 1; // 0xe40 PushI
	var_55_int = var_50_int + var_54_int; // 0xe41 Add
	AddItem(var_49_bool, var_52_string, var_53_int, var_55_int); // 0xe42 Func
	var_56_bool = 0; var_57_object = Obj(); var_58_float = 0; // 0xe44 PushV
	var_59_object = Obj(); // 0xe45 PushV
	func_2699(var_59_object); // 0xe46 NEW_2
	var_57_object = var_59_object; // 0xe47 Mov
	var_58_float = -0.03; // 0xe49 MovF
	func_3116(var_56_bool, var_57_object, var_58_float); // 0xe4a NEW_2
	return 4; // 0xe4c Return
}
...
func_3168(var_67_float)
{
	var_68_object = Obj(); var_69_object = Obj(); // 0xc60 PushV
	CreateFloatVector(var_69_object); // 0xc61 Func
	add(var_67_float); // 0xc63 ObjFunc
	var_70_int = 16; // 0xc65 PushI
	SendWorldWndMessage(var_70_int, var_69_object); // 0xc66 Func
