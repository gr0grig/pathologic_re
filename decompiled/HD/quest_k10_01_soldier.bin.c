task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	...
	func_626(var_35_object); // 0xb3 NEW_2
...
Label_229:
	...
	func_600(var_62_bool); // 0xe7 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_559(var_27_object); // 0x13d NEW_2
...
func_577(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x241 PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x242 Or
	var_56_float = sqrt(var_57_int); // 0x243 Sqrt2
	var_58_float = 0.0; // 0x244 PushF
	var_59_bool = var_56_float < var_58_float; // 0x245 LT
	if(var_59_bool == 0) goto Label_585; // 0x246 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x247 MovV
	return 2; // 0x248 Return
	
Label_585:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x249 Div2
...
func_137(var_2_object, var_93_string)
{
	...
	func_600(var_94_bool); // 0x8b NEW_2
...
Label_155:
	func_544(var_97_string, var_98_bool); // 0x9b NEW_2
...
Label_116:
	...
	func_528(var_127_string); // 0x76 NEW_2
...
func_587(var_113_int, var_114_string)
{
	var_115_int = 0; var_116_int = 0; // 0x24b PushV
	GetVariable(var_114_string, var_116_int); // 0x24c Func
	var_113_int = var_116_int; // 0x24e Mov
...
func_638(var_77_int)
{
	var_78_int = 0; var_79_int = 0; // 0x27e PushV
	var_80_string = "branch"; // 0x27f PushS
	GetVariable(var_80_string, var_79_int); // 0x280 Func
	var_81_int = 0; // 0x282 PushI
	var_82_bool = var_79_int == var_81_int; // 0x283 Eq
	if(var_82_bool == 0) goto Label_648; // 0x284 JumpB
	var_77_int = 1; // 0x285 MovI
	return 2; // 0x286 Return
	
Label_648:
	var_83_int = 1; // 0x288 PushI
	var_84_bool = var_79_int == var_83_int; // 0x289 Eq
	if(var_84_bool == 0) goto Label_653; // 0x28a JumpB
	var_77_int = 2; // 0x28b MovI
	return 2; // 0x28c Return
	
Label_653:
	var_77_int = 3; // 0x28d MovI
	return 2; // 0x28e Return
}


func_528(var_127_string)
{
	var_128_bool = 0; var_129_float = 0; var_130_float = 0; var_131_bool = 0; var_132_float = 0; var_133_float = 0; // 0x210 PushV
	lshHasAnimation(var_131_bool, var_127_string); // 0x211 Func
	var_134_bool = var_131_bool; // 0x213 Push
	if(var_134_bool == 0) goto Label_539; // 0x214 JumpB
	lshGetAnimTimes(var_127_string, var_132_float, var_133_float); // 0x215 Func
	var_135_bool = 0; // 0x217 PushB
	lshPlayAnimation(var_132_float, var_133_float, var_135_bool); // 0x218 Func
	goto Label_543; // 0x21a Jump
	
Label_543:
	return 6; // 0x21f Return
	
Label_539:
	var_136_string = "Can't find lsh animation : "; // 0x21b PushS
	var_137_int = var_136_string + var_127_string; // 0x21c Add
	Trace(var_137_int); // 0x21d Func
}


func_592(var_74_int)
{
	var_74_int = 527721; // 0x250 MovI
...
{
	var_75_string = "ui/NPC_Citizen1.png"; // 0x254 MovS
...
{
	var_76_string = "ui/NPC_Citizen1_b.png"; // 0x256 MovS
...
Label_351:
	...
	func_609(var_35_int); // 0x160 NEW_2
...
Label_366:
	...
	func_602(var_57_string, var_58_int); // 0x17c NEW_2
...
{
	var_43_string = ""; var_44_string = ""; // 0x25a PushV
	var_44_string = "idle"; // 0x25b MovS
	var_45_int = var_42_int; // 0x25c Push
	if(var_45_int == 0) goto Label_607; // 0x25d JumpB
	var_44_string = var_44_string + var_42_int; // 0x25e Add2
	
Label_607:
	var_41_string = var_44_string; // 0x25f Mov
...
{
	var_101_bool = 0; var_102_float = 0; var_103_float = 0; var_104_bool = 0; var_105_float = 0; var_106_float = 0; // 0x220 PushV
	lshHasAnimation(var_104_bool, var_97_string); // 0x221 Func
	var_107_bool = var_104_bool; // 0x223 Push
	if(var_107_bool == 0) goto Label_554; // 0x224 JumpB
	lshGetAnimTimes(var_97_string, var_105_float, var_106_float); // 0x225 Func
	lshPlayAnimation(var_105_float, var_106_float, var_98_bool); // 0x227 Func
...
Label_554:
	var_108_string = "Can't find lsh animation : "; // 0x22a PushS
	var_109_int = var_108_string + var_97_string; // 0x22b Add
	Trace(var_109_int); // 0x22c Func
}


func_609(var_35_int)
{
	var_36_int = 0; var_37_bool = 0; var_38_int = 0; var_39_bool = 0; // 0x261 PushV
	var_38_int = 0; // 0x262 MovI
	
Label_611:
	var_40_string = "all"; // 0x263 PushS
	var_41_string = ""; var_42_int = 0; // 0x264 PushV
	var_42_int = var_38_int; // 0x265 Mov
	func_602(var_41_string, var_42_int); // 0x266 NEW_2
	HasAnimation(var_39_bool, var_40_string, var_41_string); // 0x268 Func
	var_46_bool = var_39_bool == 0; // 0x26a Not
	if(var_46_bool == 0) goto Label_621; // 0x26b JumpB
	goto Label_624; // 0x26c Jump
	
Label_624:
	var_35_int = var_38_int; // 0x270 Mov
	return 4; // 0x271 Return
	
Label_621:
	var_47_int = 1; // 0x26d PushI
	var_38_int = var_38_int + var_47_int; // 0x26e Add2
...
func_559(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x22f PushV
	GetEyesHeight(var_30_float); // 0x230 ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x232 MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x233 PushE
	var_32_float = var_30_float; // 0x234 Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x235 PopE
	var_33_string = "head"; // 0x236 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x237 Func
	return 4; // 0x239 Return
}


func_626(var_111_bool)
{
	var_113_int = 0; var_114_string = ""; // 0x273 PushV
	var_114_string = "k10q01"; // 0x274 MovS
	func_587(var_113_int, var_114_string); // 0x275 NEW_2
	var_117_int = 2; // 0x277 PushI
	var_118_bool = var_113_int == var_117_int; // 0x278 Eq
	if(var_118_bool == 0) goto Label_636; // 0x279 JumpB
	var_111_bool = 1; // 0x27a MovB
	return 0; // 0x27b Return
	
Label_636:
	var_111_bool = 0; // 0x27c MovB
...
func_441(var_25_bool, var_27_float)
{
	...
	func_577(var_52_cvector, var_53_cvector); // 0x1d4 NEW_2
...
Label_482:
	...
	var_65_bool = 1; // 0x1e4 PushB
	CameraTransit(var_43_cvector, var_41_cvector, var_65_bool); // 0x1e5 Func
	var_66_float = GetByIndex(var_42_cvector, 0); // 0x1e7 PushE
	var_67_float = GetByIndex(var_42_cvector, 2); // 0x1e8 PushE
	Rotate(var_66_float, var_67_float); // 0x1e9 Func
	var_68_bool = 0; // 0x1eb PushV
	func_600(var_68_bool); // 0x1ec NEW_2
	if(var_68_bool == 0) goto Label_496; // 0x1ee JumpB
	goto Label_504; // 0x1ef Jump
	
Label_504:
	CameraWaitForPlayFinish(); // 0x1f8 Func
	ResumeWorld(); // 0x1fa Func
	var_25_bool = 1; // 0x1fc MovB
	return 18; // 0x1fd Return
	
Label_496:
	var_69_string = "head"; // 0x1f0 PushS
	HasAnimationTrack(var_45_bool, var_69_string); // 0x1f1 Func
	var_70_bool = var_45_bool; // 0x1f3 Push
	if(var_70_bool == 0) goto Label_504; // 0x1f4 JumpB
	var_71_string = "head"; // 0x1f5 PushS
	LookAsyncCamera(var_71_string); // 0x1f6 Func
}


func_570()
{
	var_13_bool = 0; // 0x23a PushV
	func_600(var_13_bool); // 0x23b NEW_2
	if(var_13_bool == 0) goto Label_576; // 0x23d JumpB
	lshStopSpeech(); // 0x23e Func
...
func_510()
{
	var_145_bool = 0; var_146_bool = 0; // 0x1fe PushV
	var_147_bool = 1; // 0x1ff PushB
	CameraSwitchToNormal(var_147_bool); // 0x200 Func
	var_148_bool = 0; // 0x202 PushV
	func_600(var_148_bool); // 0x203 NEW_2
	if(var_148_bool == 0) goto Label_519; // 0x205 JumpB
...
Label_519:
	...
	HasAnimationTrack(var_146_bool, var_149_string); // 0x208 Func
	var_150_bool = var_146_bool; // 0x20a Push
	if(var_150_bool == 0) goto Label_527; // 0x20b JumpB
	var_151_string = "head"; // 0x20c PushS
	UnlookAsync(var_151_string); // 0x20d Func
}
