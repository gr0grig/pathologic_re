...
0x471: Stack[-1] = "ui/NPC_Citizen3.png"
0x472: Return(); Pop(0)

0x473: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x474: Return(); Pop(0)
...
0x488: Pop(1)
0x489: Push("k10q01WastedGotoBurah")
0x48a: Push("pt_gmap_factory")
0x48b: Push((int) 1)
...
0x496: Stack[-2] = "quest_k10_01"
0x497: Stack[-1] = "init_factory"
0x498: Call2 0x444
...
0x4ac: PushEmpty()
0x4ad: Push((int) 0)
0x4ae: @@ SetReturnValue(Stack[-1])
0x4af: Pop(1)
0x4b0: Return(); Pop(0)

0x4b1: PushEmpty()
0x4b2: PushEmpty(int, string)
0x4b3: Stack[-1] = "k10q01"
0x4b4: Call2 0x43f
...
0x4e8: Push("Can't retrieve diary root")
0x4e9: @ Trace(Stack[-1])
0x4ea: Pop(1)
...
0x4f4: Pop(1)
0x4f5: @@ Find(Stack[-7], Stack[-2])
0x4f6: Pop(0)
0x4f7: Pop(0); Push((bool) Stack[-2] == 0)
0x4f8: IF (Stack[-1] == 0) GOTO 0x4ff; Pop(1)

0x4f9: Push("Can't find diary parent with id: ")
...
0x4ff: @@ AddChild(Stack[-8])
0x500: Pop(0)
0x501: Push((int) 7)
0x502: @ SendWorldWndMessage(Stack[-1])
0x503: Pop(1)
0x504: @@ GetCategory(Stack[-1])
0x505: Pop(0)
...
0x50e: Pop(0)
0x50f: Pop(0); Push((bool) Stack[-2] == 0)
0x510: IF (Stack[-1] == 0) GOTO 0x517; Pop(1)

0x511: Push("Can't find main outdoor scene")
0x512: @ Trace(Stack[-1])
0x513: Pop(1)
0x514: Stack[-1] = 0
...
0x522: Push("Can't find main outdoor scene")
0x523: @ Trace(Stack[-1])
0x524: Pop(1)
0x525: Return(); Pop(8)

0x526: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x527: Pop(0)
0x528: Pop(0); Push((bool) Stack[-1] == 0)
0x529: IF (Stack[-1] == 0) GOTO 0x530; Pop(1)

0x52a: Push("Warning: outdoor scene locator ")
0x52b: Pop(1); Push(Stack[-1] + Stack[-11]);
0x52c: Push(" doesnt exist")
0x52d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x52e: @ Trace(Stack[-1])
0x52f: Pop(1)
0x530: @@ GetMap(Stack[-11])
0x531: Pop(0)
0x532: Pop(0); Push((bool) Stack[-11] == 0)
0x533: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x534: Push("Can't find map")
0x535: @ Trace(Stack[-1])
0x536: Pop(1)
0x537: Return(); Pop(8)
...
0x53a: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x53b: Pop(2)
0x53c: Return(); Pop(8)
...
0x551: Stack[-3] = Stack[-7]
0x552: Stack[-2] = Stack[-6]
0x553: Stack[-1] = Stack[-5]
0x554: Call2 0x348
...
0x559: Stack[-5] = Stack[-11]
0x55a: Stack[-4] = Stack[-10]
0x55b: Stack[-3] = Stack[-9]
