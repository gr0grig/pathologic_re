...
0x31f: Stack[-1] = "ook11KabakSoldier1"
0x320: Call2 0x2ee
...
0x33e: Stack[-1] = "ui/NPC_Citizen2.png"
0x33f: Return(); Pop(0)

0x340: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x341: Return(); Pop(0)
