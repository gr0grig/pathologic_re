task_0_event_9(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_int, var_15_float)
{
	...
	func_1281(var_23_bool); // 0x8a NEW_2
...
Label_162:
	var_153_int = 1; // 0xa2 PushI
	var_154_bool = var_14_int == var_153_int; // 0xa3 Eq
	if(var_154_bool == 0) goto Label_178; // 0xa4 JumpB
	var_155_bool = 0; // 0xa5 PushV
	func_990(var_155_bool); // 0xa6 NEW_2
	if(var_155_bool == 0) goto Label_175; // 0xa8 JumpB
	var_268_bool = 0; var_269_string = ""; var_270_string = ""; var_271_string = ""; // 0xa9 PushV
	var_269_string = "volonteers_klara"; // 0xaa MovS
	var_270_string = "childs_letter"; // 0xab MovS
	var_271_string = ""; // 0xac MovS
	func_620(var_268_bool, var_269_string, var_270_string, var_271_string); // 0xad NEW_2
...
Label_178:
	var_275_int = 2; // 0xb2 PushI
	var_276_bool = var_14_int == var_275_int; // 0xb3 Eq
	if(var_276_bool == 0) goto Label_186; // 0xb4 JumpB
...
Label_223:
	...
	func_1267(var_83_bool); // 0xfe NEW_2
...
Label_265:
	...
	func_1274(var_93_bool); // 0x10a NEW_2
...
{
	var_24_bool = 0; var_25_bool = 0; // 0x501 PushV
	IsOverrideActive(var_25_bool); // 0x502 Func
	var_23_bool = !var_25_bool; // 0x504 Not2
...
func_1286()
{
	var_18_object = Obj(); var_19_object = Obj(); // 0x506 PushV
	var_20_string = "warehouse_rubin"; // 0x507 PushS
	GetSceneByName(var_19_object, var_20_string); // 0x508 Func
	var_21_string = "rubin"; // 0x50a PushS
	Trigger(var_19_object, var_21_string); // 0x50b Func
	var_22_string = ""; var_23_bool = 0; // 0x50d PushV
	var_22_string = "warehouse_rubin@door1"; // 0x50e MovS
	var_23_bool = 0; // 0x50f MovB
	func_603(var_22_string, var_23_bool); // 0x510 NEW_2
	var_32_string = "cot_eva"; // 0x512 PushS
	GetSceneByName(var_19_object, var_32_string); // 0x513 Func
	var_33_string = "danko"; // 0x515 PushS
	Trigger(var_19_object, var_33_string); // 0x516 Func
	var_34_string = ""; var_35_bool = 0; // 0x518 PushV
	var_34_string = "cot_eva@door1"; // 0x519 MovS
	var_35_bool = 0; // 0x51a MovB
	func_603(var_34_string, var_35_bool); // 0x51b NEW_2
...
Label_1179:
	...
	if(var_112_bool == 0) goto Label_1206; // 0x4a3 JumpB
	var_113_string = "fin_termit"; // 0x4a4 PushS
	Trace(var_113_string); // 0x4a5 Func
	var_114_bool = var_47_bool == 0; // 0x4a7 Not
	if(var_114_bool == 0) goto Label_1196; // 0x4a8 JumpB
	var_115_string = "ACHIEVEMENT_HELLO_2"; // 0x4a9 PushS
	UnlockAchievement(var_115_string); // 0x4aa Func
	
Label_1196:
	var_116_bool = var_48_bool; // 0x4ac Push
	if(var_116_bool == 0) goto Label_1202; // 0x4ad JumpB
	var_117_string = "gameover_termit_chudo.xml"; // 0x4ae PushS
	GameOver(var_117_string); // 0x4af Func
	goto Label_1205; // 0x4b1 Jump
	
Label_1205:
	goto Label_1266; // 0x4b5 Jump
	
Label_1266:
	return 18; // 0x4f2 Return
	
Label_1202:
	var_118_string = "gameover_termit.xml"; // 0x4b2 PushS
	GameOver(var_118_string); // 0x4b3 Func
	
Label_1206:
	var_119_int = 0; // 0x4b6 PushV
	func_1037(var_119_int); // 0x4b7 NEW_2
	var_120_int = 2; // 0x4b9 PushI
	var_121_bool = var_119_int == var_120_int; // 0x4ba Eq
	if(var_121_bool == 0) goto Label_1230; // 0x4bb JumpB
	var_122_string = "fin_utop"; // 0x4bc PushS
	Trace(var_122_string); // 0x4bd Func
	var_123_bool = var_47_bool == 0; // 0x4bf Not
	if(var_123_bool == 0) goto Label_1220; // 0x4c0 JumpB
	var_124_string = "ACHIEVEMENT_HELLO_2"; // 0x4c1 PushS
	UnlockAchievement(var_124_string); // 0x4c2 Func
	
Label_1220:
	var_125_bool = var_48_bool; // 0x4c4 Push
	if(var_125_bool == 0) goto Label_1226; // 0x4c5 JumpB
	var_126_string = "gameover_utopist_chudo.xml"; // 0x4c6 PushS
	GameOver(var_126_string); // 0x4c7 Func
	goto Label_1229; // 0x4c9 Jump
	
Label_1229:
	goto Label_1266; // 0x4cd Jump
	
Label_1226:
	var_127_string = "gameover_utopist.xml"; // 0x4ca PushS
	GameOver(var_127_string); // 0x4cb Func
	
Label_1230:
	var_128_int = 0; // 0x4ce PushV
	func_1037(var_128_int); // 0x4cf NEW_2
	var_129_int = 3; // 0x4d1 PushI
	var_130_bool = var_128_int == var_129_int; // 0x4d2 Eq
	if(var_130_bool == 0) goto Label_1254; // 0x4d3 JumpB
	var_131_string = "fin_smiren"; // 0x4d4 PushS
	Trace(var_131_string); // 0x4d5 Func
	var_132_bool = var_47_bool == 0; // 0x4d7 Not
	if(var_132_bool == 0) goto Label_1244; // 0x4d8 JumpB
	var_133_string = "ACHIEVEMENT_HELLO_2"; // 0x4d9 PushS
	UnlockAchievement(var_133_string); // 0x4da Func
	
Label_1244:
	var_134_bool = var_48_bool; // 0x4dc Push
	if(var_134_bool == 0) goto Label_1250; // 0x4dd JumpB
	var_135_string = "gameover_smirennik_chudo.xml"; // 0x4de PushS
	GameOver(var_135_string); // 0x4df Func
	goto Label_1253; // 0x4e1 Jump
	
Label_1253:
	goto Label_1266; // 0x4e5 Jump
	
Label_1250:
	var_136_string = "gameover_smirennik.xml"; // 0x4e2 PushS
	GameOver(var_136_string); // 0x4e3 Func
	
Label_1254:
	var_137_string = "fin_beda"; // 0x4e6 PushS
	Trace(var_137_string); // 0x4e7 Func
	var_138_bool = var_48_bool; // 0x4e9 Push
	if(var_138_bool == 0) goto Label_1263; // 0x4ea JumpB
	var_139_string = "gameover_beda_chudo.xml"; // 0x4eb PushS
	GameOver(var_139_string); // 0x4ec Func
	goto Label_1266; // 0x4ee Jump
	
Label_1263:
	var_140_string = "gameover_beda.xml"; // 0x4ef PushS
	GameOver(var_140_string); // 0x4f0 Func
	
Label_1071:
	var_141_int = 1; // 0x42f PushI
	var_142_bool = var_40_int == var_141_int; // 0x430 Eq
	if(var_142_bool == 0) goto Label_1085; // 0x431 JumpB
	var_143_string = "b12q01ChildsAreVisited"; // 0x432 PushS
	GetVariable(var_143_string, var_45_int); // 0x433 Func
	var_144_int = 0; // 0x435 PushI
	var_42_bool = var_45_int != var_144_int; // 0x436 Neq2
	var_145_string = "b12q01TheaterIsVisited"; // 0x437 PushS
	GetVariable(var_145_string, var_45_int); // 0x438 Func
	var_146_int = 0; // 0x43a PushI
	var_43_bool = var_45_int != var_146_int; // 0x43b Neq2
	goto Label_1098; // 0x43c Jump
	
Label_1085:
	var_147_int = 2; // 0x43d PushI
	var_148_bool = var_40_int == var_147_int; // 0x43e Eq
	if(var_148_bool == 0) goto Label_1098; // 0x43f JumpB
	var_149_string = "k12q01ChildsAreVisited"; // 0x440 PushS
	GetVariable(var_149_string, var_46_int); // 0x441 Func
	var_150_int = 0; // 0x443 PushI
	var_42_bool = var_46_int != var_150_int; // 0x444 Neq2
	var_151_string = "k12q01TheaterIsVisited"; // 0x445 PushS
	GetVariable(var_151_string, var_46_int); // 0x446 Func
	var_152_int = 0; // 0x448 PushI
	var_43_bool = var_46_int != var_152_int; // 0x449 Neq2
}
...
{
	var_84_int = 0; var_85_int = 0; // 0x4f3 PushV
	var_86_string = "k12q01BurahInSobor"; // 0x4f4 PushS
	GetVariable(var_86_string, var_85_int); // 0x4f5 Func
	var_87_int = 0; // 0x4f7 PushI
	var_83_bool = var_85_int != var_87_int; // 0x4f8 Neq2
...
{
	var_94_int = 0; var_95_int = 0; // 0x4fa PushV
	var_96_string = "k12q01DankoInSobor"; // 0x4fb PushS
	GetVariable(var_96_string, var_95_int); // 0x4fc Func
	var_97_int = 0; // 0x4fe PushI
	var_93_bool = var_95_int != var_97_int; // 0x4ff Neq2
