...
Label_305:
	...
	func_949(var_178_object); // 0x133 NEW_2
...
Label_331:
	...
	func_949(var_195_object); // 0x151 NEW_2
...
Label_346:
	...
	func_961(var_199_object); // 0x15d NEW_2
...
func_920()
{
	var_289_string = "ook12BirdmaskT1"; // 0x399 PushS
...
func_926()
{
	...
	var_25_string = "quest_k12_01"; // 0x3a0 MovS
...
func_933()
{
	var_18_string = "ook12BirdmaskT2"; // 0x3a6 PushS
...
func_949(var_260_bool)
{
	var_262_int = 0; var_263_string = ""; // 0x3b6 PushV
	var_263_string = "k12q01ChildsAreVisited"; // 0x3b7 MovS
	func_869(var_262_int, var_263_string); // 0x3b8 NEW_2
	var_264_int = 0; // 0x3ba PushI
	var_265_bool = var_262_int != var_264_int; // 0x3bb Neq
	if(var_265_bool == 0) goto Label_959; // 0x3bc JumpB
	var_260_bool = 1; // 0x3bd MovB
	return 0; // 0x3be Return
	
Label_959:
	var_260_bool = 0; // 0x3bf MovB
...
func_961(var_281_bool)
{
	var_283_int = 0; var_284_string = ""; // 0x3c2 PushV
	var_284_string = "ook12BirdmaskT1"; // 0x3c3 MovS
	func_869(var_283_int, var_284_string); // 0x3c4 NEW_2
	var_285_int = 0; // 0x3c6 PushI
	var_286_bool = var_283_int == var_285_int; // 0x3c7 Eq
	if(var_286_bool == 0) goto Label_971; // 0x3c8 JumpB
	var_281_bool = 1; // 0x3c9 MovB
	return 0; // 0x3ca Return
	
Label_971:
	var_281_bool = 0; // 0x3cb MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_90_object, var_91_object)
{
	...
	var_236_int = 539229; // 0x64 PushI
	var_237_int = 45272; // 0x65 PushI
	var_238_int = 41172; // 0x66 PushI
	AddReply(var_236_int, var_237_int, var_238_int); // 0x67 TObjFunc
	
Label_105:
	var_239_int = 539242; // 0x69 PushI
	var_240_int = -1; // 0x6a PushI
	var_241_int = 41185; // 0x6b PushI
...
Label_111:
	...
	func_949(var_261_object); // 0x71 NEW_2
	...
	var_268_int = 541628; // 0x79 PushI
	SetMessage(var_268_int); // 0x7a TObjFunc
	ClearReplies(); // 0x7c TObjFunc
	var_269_int = 541629; // 0x7e PushI
	var_270_int = 43802; // 0x7f PushI
	var_271_int = 43801; // 0x80 PushI
	AddReply(var_269_int, var_270_int, var_271_int); // 0x81 TObjFunc
	var_272_int = 541633; // 0x83 PushI
	var_273_int = -1; // 0x84 PushI
	var_274_int = 43805; // 0x85 PushI
...
Label_137:
	...
	func_949(var_278_object); // 0x8f NEW_2
...
Label_152:
	...
	func_961(var_282_object); // 0x9b NEW_2
...
Label_159:
	...
	var_292_int = 539243; // 0xa9 PushI
	SetMessage(var_292_int); // 0xaa TObjFunc
	ClearReplies(); // 0xac TObjFunc
	var_293_int = 539244; // 0xae PushI
	var_294_int = -1; // 0xaf PushI
	var_295_int = 41187; // 0xb0 PushI
...
Label_180:
	...
	var_297_int = 539245; // 0xb8 PushI
	SetMessage(var_297_int); // 0xb9 TObjFunc
	ClearReplies(); // 0xbb TObjFunc
	var_298_int = 539246; // 0xbd PushI
	var_299_int = -1; // 0xbe PushI
	var_300_int = 41189; // 0xbf PushI
...
func_973(var_228_bool)
{
	...
	var_231_string = "ook12BirdmaskT2"; // 0x3cf MovS
