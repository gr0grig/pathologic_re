...
0x3a3: @@ HasProperty(Stack[-1], Stack[-4])
0x3a4: Pop(1)
...
0x3b8: @@ GetProperty(Stack[-1], Stack[-2])
0x3b9: Pop(1)
0x3ba: PushEmpty(bool, string)
0x3bb: Stack[-1] = Stack[-3]
0x3bc: Call2 0x40a

0x3bd: Stack[-14] = Stack[-2]
0x3be: Pop(2)
0x3bf: Return(); Pop(10)
...
0x3ce: @@ HasProperty(Stack[-1], Stack[-4])
0x3cf: Pop(1)
...
0x3e3: @@ GetProperty(Stack[-1], Stack[-2])
0x3e4: Pop(1)
0x3e5: PushEmpty(bool, string)
0x3e6: Stack[-1] = Stack[-3]
0x3e7: Call2 0x40a

0x3e8: Stack[-14] = Stack[-2]
0x3e9: Pop(2)
0x3ea: Return(); Pop(10)
...
0x405: Push("Can't find lsh animation : ")
...
0x46a: Stack[-1] = "ook12Klara2Sobor1"
0x46b: Call2 0x430
...
0x476: Stack[-1] = "ook12Klara2Sobor2"
0x477: Call2 0x430
...
0x482: Stack[-1] = "ook12Klara2Sobor3"
0x483: Call2 0x430
...
0x4a1: Stack[-1] = "ui/NPC_Klara.png"
0x4a2: Return(); Pop(0)

0x4a3: Stack[-1] = "ui/NPC_Klara_b.png"
0x4a4: Return(); Pop(0)
