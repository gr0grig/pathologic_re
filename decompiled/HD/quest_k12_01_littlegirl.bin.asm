...
0x340: Stack[-1] = "ook12Littlegirl1"
0x341: Call2 0x333
...
0x35f: Stack[-1] = "ui/NPC_Citizen1.png"
0x360: Return(); Pop(0)

0x361: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x362: Return(); Pop(0)
