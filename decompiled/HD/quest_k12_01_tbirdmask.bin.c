...
Label_206:
	...
	func_1510(var_61_object); // 0xe1 NEW_2
...
Label_625:
	...
	func_1498(var_247_object); // 0x27f NEW_2
...
Label_835:
	...
	func_1534(var_338_object); // 0x351 NEW_2
...
Label_1004:
	...
	func_1571(var_407_bool); // 0x3ee NEW_2
...
Label_1094:
	...
	func_1417(var_19_object); // 0x448 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_1399(var_29_object); // 0x485 NEW_2
...
func_1281(var_27_bool, var_29_float)
{
	...
	func_1423(var_54_cvector, var_55_cvector); // 0x51c NEW_2
...
Label_1322:
	...
	var_67_bool = 1; // 0x52c PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x52d Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x52f PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x530 PushE
	Rotate(var_68_float, var_69_float); // 0x531 Func
	var_70_bool = 0; // 0x533 PushV
	func_1571(var_70_bool); // 0x534 NEW_2
	if(var_70_bool == 0) goto Label_1336; // 0x536 JumpB
	goto Label_1344; // 0x537 Jump
	
Label_1344:
	CameraWaitForPlayFinish(); // 0x540 Func
	ResumeWorld(); // 0x542 Func
	var_27_bool = 1; // 0x544 MovB
	return 18; // 0x545 Return
	
Label_1336:
	var_71_string = "head"; // 0x538 PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x539 Func
	var_72_bool = var_47_bool; // 0x53b Push
	if(var_72_bool == 0) goto Label_1344; // 0x53c JumpB
	var_73_string = "head"; // 0x53d PushS
	LookAsyncCamera(var_73_string); // 0x53e Func
}
...
func_1410()
{
	...
	func_1571(var_15_bool); // 0x583 NEW_2
	if(var_15_bool == 0) goto Label_1416; // 0x585 JumpB
	lshStopSpeech(); // 0x586 Func
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x589 PushV
	self(var_21_object); // 0x58a Func
	var_19_object = var_21_object; // 0x58c Mov
...
{
	var_80_int = 0; var_81_int = 0; // 0x60a PushV
	var_82_string = "branch"; // 0x60b PushS
	GetVariable(var_82_string, var_81_int); // 0x60c Func
	var_83_int = 0; // 0x60e PushI
	var_84_bool = var_81_int == var_83_int; // 0x60f Eq
	if(var_84_bool == 0) goto Label_1556; // 0x610 JumpB
	var_79_int = 1; // 0x611 MovI
	return 2; // 0x612 Return
	
Label_1556:
	var_85_int = 1; // 0x614 PushI
	var_86_bool = var_81_int == var_85_int; // 0x615 Eq
	if(var_86_bool == 0) goto Label_1561; // 0x616 JumpB
	var_79_int = 2; // 0x617 MovI
	return 2; // 0x618 Return
	
Label_1561:
	var_79_int = 3; // 0x619 MovI
...
{
	var_57_float = 0; var_58_float = 0; // 0x58f PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x590 Or
	var_58_float = sqrt(var_59_int); // 0x591 Sqrt2
	var_60_float = 0.0; // 0x592 PushF
	var_61_bool = var_58_float < var_60_float; // 0x593 LT
	if(var_61_bool == 0) goto Label_1431; // 0x594 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x595 MovV
	return 2; // 0x596 Return
	
Label_1431:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x597 Div2
...
{
	var_129_int = 0; var_130_int = 0; // 0x599 PushV
	GetVariable(var_128_string, var_130_int); // 0x59a Func
	var_127_int = var_130_int; // 0x59c Mov
...
Label_1065:
	...
	func_1417(var_21_object); // 0x42b NEW_2
...
{
	var_99_object = Obj(); var_100_object = Obj(); // 0x59e PushV
	FindActor(var_100_object, var_97_string); // 0x59f Func
	var_101_bool = var_100_object == 0; // 0x5a1 Not
	if(var_101_bool == 0) goto Label_1450; // 0x5a2 JumpB
	var_102_string = "Door "; // 0x5a3 PushS
	var_103_int = var_102_string + var_97_string; // 0x5a4 Add
	var_104_string = " not found"; // 0x5a5 PushS
	var_105_int = var_103_int + var_104_string; // 0x5a6 Add
	Trace(var_105_int); // 0x5a7 Func
	goto Label_1453; // 0x5a9 Jump
	
Label_1453:
	return 2; // 0x5ad Return
	
Label_1450:
	var_106_string = "locked"; // 0x5aa PushS
	SetProperty(var_106_string, var_98_bool); // 0x5ab ObjFunc
}
...
Label_1191:
	...
	func_1462(var_46_int); // 0x4a8 NEW_2
...
Label_1206:
	...
	func_1455(var_68_string, var_69_int); // 0x4c4 NEW_2
...
{
	var_77_string = "ui/NPC_bmask.png"; // 0x61f MovS
...
{
	var_78_string = "ui/NPC_bmask_b.png"; // 0x621 MovS
...
func_162(var_2_object, var_107_string)
{
	...
	func_1571(var_108_bool); // 0xa4 NEW_2
...
Label_180:
	func_1384(var_111_string, var_112_bool); // 0xb4 NEW_2
...
{
	var_54_string = ""; var_55_string = ""; // 0x5af PushV
	var_55_string = "idle"; // 0x5b0 MovS
	var_56_int = var_53_int; // 0x5b1 Push
	if(var_56_int == 0) goto Label_1460; // 0x5b2 JumpB
	var_55_string = var_55_string + var_53_int; // 0x5b3 Add2
	
Label_1460:
	var_52_string = var_55_string; // 0x5b4 Mov
...
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x5b6 PushV
	var_49_int = 0; // 0x5b7 MovI
	
Label_1464:
	var_51_string = "all"; // 0x5b8 PushS
	var_52_string = ""; var_53_int = 0; // 0x5b9 PushV
	var_53_int = var_49_int; // 0x5ba Mov
	func_1455(var_52_string, var_53_int); // 0x5bb NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x5bd Func
	var_57_bool = var_50_bool == 0; // 0x5bf Not
	if(var_57_bool == 0) goto Label_1474; // 0x5c0 JumpB
	goto Label_1477; // 0x5c1 Jump
	
Label_1477:
	var_46_int = var_49_int; // 0x5c5 Mov
	return 4; // 0x5c6 Return
	
Label_1474:
	var_58_int = 1; // 0x5c2 PushI
	var_49_int = var_49_int + var_58_int; // 0x5c3 Add2
	goto Label_1464; // 0x5c4 Jump
}


func_1350()
{
	var_172_bool = 0; var_173_bool = 0; // 0x546 PushV
	var_174_bool = 1; // 0x547 PushB
	CameraSwitchToNormal(var_174_bool); // 0x548 Func
	var_175_bool = 0; // 0x54a PushV
	func_1571(var_175_bool); // 0x54b NEW_2
	if(var_175_bool == 0) goto Label_1359; // 0x54d JumpB
...
Label_1359:
	var_176_string = "head"; // 0x54f PushS
	HasAnimationTrack(var_173_bool, var_176_string); // 0x550 Func
	var_177_bool = var_173_bool; // 0x552 Push
	if(var_177_bool == 0) goto Label_1367; // 0x553 JumpB
	var_178_string = "head"; // 0x554 PushS
	UnlookAsync(var_178_string); // 0x555 Func
}


func_1479()
{
	var_97_string = ""; var_98_bool = 0; // 0x5c8 PushV
	var_97_string = "itheater@door1"; // 0x5c9 MovS
	var_98_bool = 0; // 0x5ca MovB
	func_1438(var_97_string, var_98_bool); // 0x5cb NEW_2
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_1479(); // 0x53 NEW_2
	var_107_string = ""; // 0x55 PushV
	var_107_string = "Neutral"; // 0x56 MovS
	func_162(var_89_object, var_107_string); // 0x57 NEW_2
	var_124_int = 541007; // 0x59 PushI
	...
	func_1510(var_126_object); // 0x60 NEW_2
	if(var_125_bool == 0) goto Label_104; // 0x62 JumpB
	var_133_int = 541347; // 0x63 PushI
	var_134_int = 43494; // 0x64 PushI
	var_135_int = 43493; // 0x65 PushI
	AddReply(var_133_int, var_134_int, var_135_int); // 0x66 TObjFunc
	
Label_104:
	var_136_bool = 0; // 0x68 PushV
	var_136_bool = 0; // 0x69 MovB
	var_137_bool = 0; var_138_object = Obj(); // 0x6a PushV
	var_138_object = var_1_object; // 0x6b MovT
	func_1522(var_138_object); // 0x6c NEW_2
	if(var_137_bool == 0) goto Label_118; // 0x6e JumpB
	var_143_bool = 0; var_144_object = Obj(); // 0x6f PushV
	var_144_object = var_1_object; // 0x70 MovT
	func_1510(var_144_object); // 0x71 NEW_2
	var_145_bool = var_143_bool == 0; // 0x73 Not
	if(var_145_bool == 0) goto Label_118; // 0x74 JumpB
	var_136_bool = 1; // 0x75 MovB
	
Label_118:
	if(var_136_bool == 0) goto Label_124; // 0x76 JumpB
	var_146_int = 542740; // 0x77 PushI
	var_147_int = 45157; // 0x78 PushI
	var_148_int = 45156; // 0x79 PushI
	AddReply(var_146_int, var_147_int, var_148_int); // 0x7a TObjFunc
	
Label_124:
	var_149_int = 541034; // 0x7c PushI
	var_150_int = -1; // 0x7d PushI
	var_151_int = 43128; // 0x7e PushI
	AddReply(var_149_int, var_150_int, var_151_int); // 0x7f TObjFunc
	goto Label_132; // 0x81 Jump
	
Label_132:
	var_152_bool = 0; // 0x84 PushV
	func_1571(var_152_bool); // 0x85 NEW_2
	if(var_152_bool == 0) goto Label_147; // 0x87 JumpB
	
Label_136:
	lshWaitForAnimEnd(); // 0x88 Func
	var_153_string = var_3_string; // 0x8a PushT
	if(var_153_string == 0) goto Label_141; // 0x8b JumpB
...
Label_141:
	var_154_string = ""; // 0x8d PushV
	var_154_string = var_2_object; // 0x8e MovT
	func_1368(var_154_string); // 0x8f NEW_2
	goto Label_136; // 0x91 Jump
	
Label_147:
	var_165_string = "all"; // 0x93 PushS
	var_166_string = "idle"; // 0x94 PushS
	PlayAnimation(var_165_string, var_166_string); // 0x95 Func
	
Label_151:
	WaitForAnimEnd(); // 0x97 Func
	var_167_string = var_3_string; // 0x99 PushT
	if(var_167_string == 0) goto Label_156; // 0x9a JumpB
	goto Label_161; // 0x9b Jump
	
Label_156:
	var_168_string = "all"; // 0x9c PushS
	var_169_string = "idle"; // 0x9d PushS
	PlayAnimation(var_168_string, var_169_string); // 0x9e Func
...
func_1486()
{
	var_20_string = "ook12TBirdmask1"; // 0x5cf PushS
	var_21_int = 1; // 0x5d0 PushI
	SetVariable(var_20_string, var_21_int); // 0x5d1 Func
...
func_1492()
{
	var_26_string = "ook12TBirdmask2"; // 0x5d5 PushS
	var_27_int = 1; // 0x5d6 PushI
	SetVariable(var_26_string, var_27_int); // 0x5d7 Func
...
{
	var_155_bool = 0; var_156_float = 0; var_157_float = 0; var_158_bool = 0; var_159_float = 0; var_160_float = 0; // 0x558 PushV
	lshHasAnimation(var_158_bool, var_154_string); // 0x559 Func
	var_161_bool = var_158_bool; // 0x55b Push
	if(var_161_bool == 0) goto Label_1379; // 0x55c JumpB
	lshGetAnimTimes(var_154_string, var_159_float, var_160_float); // 0x55d Func
	var_162_bool = 0; // 0x55f PushB
	lshPlayAnimation(var_159_float, var_160_float, var_162_bool); // 0x560 Func
	goto Label_1383; // 0x562 Jump
	
Label_1383:
	return 6; // 0x567 Return
	
Label_1379:
	var_163_string = "Can't find lsh animation : "; // 0x563 PushS
	var_164_int = var_163_string + var_154_string; // 0x564 Add
	Trace(var_164_int); // 0x565 Func
}


func_1498(var_246_bool)
{
	var_248_int = 0; var_249_string = ""; // 0x5db PushV
	var_249_string = "k12DankoVisit"; // 0x5dc MovS
	func_1433(var_248_int, var_249_string); // 0x5dd NEW_2
	var_250_int = 0; // 0x5df PushI
	var_251_bool = var_248_int != var_250_int; // 0x5e0 Neq
	if(var_251_bool == 0) goto Label_1508; // 0x5e1 JumpB
	var_246_bool = 1; // 0x5e2 MovB
	return 0; // 0x5e3 Return
	
Label_1508:
	var_246_bool = 0; // 0x5e4 MovB
...
{
	var_127_int = 0; var_128_string = ""; // 0x5e7 PushV
	var_128_string = "ook12TBirdmask1"; // 0x5e8 MovS
	func_1433(var_127_int, var_128_string); // 0x5e9 NEW_2
	var_131_int = 0; // 0x5eb PushI
	var_132_bool = var_127_int == var_131_int; // 0x5ec Eq
	if(var_132_bool == 0) goto Label_1520; // 0x5ed JumpB
	var_125_bool = 1; // 0x5ee MovB
	return 0; // 0x5ef Return
	
Label_1520:
	var_125_bool = 0; // 0x5f0 MovB
...
{
	var_115_bool = 0; var_116_float = 0; var_117_float = 0; var_118_bool = 0; var_119_float = 0; var_120_float = 0; // 0x568 PushV
	lshHasAnimation(var_118_bool, var_111_string); // 0x569 Func
	var_121_bool = var_118_bool; // 0x56b Push
	if(var_121_bool == 0) goto Label_1394; // 0x56c JumpB
	lshGetAnimTimes(var_111_string, var_119_float, var_120_float); // 0x56d Func
	lshPlayAnimation(var_119_float, var_120_float, var_112_bool); // 0x56f Func
	goto Label_1398; // 0x571 Jump
	
Label_1398:
	return 6; // 0x576 Return
	
Label_1394:
	var_122_string = "Can't find lsh animation : "; // 0x572 PushS
	var_123_int = var_122_string + var_111_string; // 0x573 Add
	Trace(var_123_int); // 0x574 Func
}
...
{
	var_139_int = 0; var_140_string = ""; // 0x5f3 PushV
	var_140_string = "ook12TBirdmask2"; // 0x5f4 MovS
	func_1433(var_139_int, var_140_string); // 0x5f5 NEW_2
	var_141_int = 0; // 0x5f7 PushI
	var_142_bool = var_139_int == var_141_int; // 0x5f8 Eq
	if(var_142_bool == 0) goto Label_1532; // 0x5f9 JumpB
	var_137_bool = 1; // 0x5fa MovB
	return 0; // 0x5fb Return
	
Label_1532:
	var_137_bool = 0; // 0x5fc MovB
...
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x577 PushV
	GetEyesHeight(var_32_float); // 0x578 ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x57a MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x57b PushE
	var_34_float = var_32_float; // 0x57c Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x57d PopE
	var_35_string = "head"; // 0x57e PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x57f Func
...
{
	var_339_int = 0; var_340_string = ""; // 0x5ff PushV
	var_340_string = "k12BurahVisit"; // 0x600 MovS
	func_1433(var_339_int, var_340_string); // 0x601 NEW_2
	var_341_int = 0; // 0x603 PushI
	var_342_bool = var_339_int != var_341_int; // 0x604 Neq
	if(var_342_bool == 0) goto Label_1544; // 0x605 JumpB
	var_337_bool = 1; // 0x606 MovB
	return 0; // 0x607 Return
	
Label_1544:
	var_337_bool = 0; // 0x608 MovB
