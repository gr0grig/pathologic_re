...
Strings:
	...
	theater
	cs_d12_theater_birdmask
	cs_play_all.bin
	cs_d12_theater_whitemask
	ForceGeometryLoad
	player
	cs_d12_theater.mot
	noaccess
...
0x4: Stack[-2] = "quest_k12_01"
0x5: Stack[-1] = "theater_cutscene_end"
0x6: Call2 0x76
