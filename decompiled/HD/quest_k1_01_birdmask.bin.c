...
Label_477:
	...
	func_859(var_167_bool); // 0x1df NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_int)
{
	...
	func_811(var_28_object); // 0x239 NEW_2
...
{
	var_100_object = Obj(); var_101_object = Obj(); // 0x347 PushV
	FindActor(var_101_object, var_98_string); // 0x348 Func
	var_102_bool = var_101_object == 0; // 0x34a NullEq
	if(var_102_bool == 0) goto Label_846; // 0x34b JumpB
	var_97_bool = 0; // 0x34c MovB
	return 2; // 0x34d Return
	
Label_846:
	Trigger(var_101_object, var_99_string); // 0x34e Func
	var_97_bool = 1; // 0x350 MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_142(var_89_object, var_103_string); // 0x57 NEW_2
	var_120_int = 525968; // 0x59 PushI
	SetMessage(var_120_int); // 0x5a TObjFunc
	ClearReplies(); // 0x5c TObjFunc
	var_121_int = 525969; // 0x5e PushI
	var_122_int = 27254; // 0x5f PushI
	var_123_int = 27253; // 0x60 PushI
	AddReply(var_121_int, var_122_int, var_123_int); // 0x61 TObjFunc
	var_124_int = 525988; // 0x63 PushI
	var_125_int = 27273; // 0x64 PushI
	var_126_int = 27272; // 0x65 PushI
	AddReply(var_124_int, var_125_int, var_126_int); // 0x66 TObjFunc
	var_127_int = 525996; // 0x68 PushI
	var_128_int = 27284; // 0x69 PushI
	var_129_int = 27283; // 0x6a PushI
	AddReply(var_127_int, var_128_int, var_129_int); // 0x6b TObjFunc
	goto Label_112; // 0x6d Jump
	
Label_112:
	var_130_bool = 0; // 0x70 PushV
	func_859(var_130_bool); // 0x71 NEW_2
...
Label_121:
	...
	func_780(var_132_string); // 0x7b NEW_2
...
{
	var_133_bool = 0; var_134_float = 0; var_135_float = 0; var_136_bool = 0; var_137_float = 0; var_138_float = 0; // 0x30c PushV
	lshHasAnimation(var_136_bool, var_132_string); // 0x30d Func
	var_139_bool = var_136_bool; // 0x30f Push
	if(var_139_bool == 0) goto Label_791; // 0x310 JumpB
	lshGetAnimTimes(var_132_string, var_137_float, var_138_float); // 0x311 Func
	var_140_bool = 0; // 0x313 PushB
	lshPlayAnimation(var_137_float, var_138_float, var_140_bool); // 0x314 Func
...
Label_791:
	var_141_string = "Can't find lsh animation : "; // 0x317 PushS
	var_142_int = var_141_string + var_132_string; // 0x318 Add
	Trace(var_142_int); // 0x319 Func
}


func_142(var_2_object, var_103_string)
{
	var_104_bool = 0; // 0x8f PushV
	func_859(var_104_bool); // 0x90 NEW_2
	var_105_bool = var_104_bool == 0; // 0x92 Not
	if(var_105_bool == 0) goto Label_149; // 0x93 JumpB
	return 0; // 0x94 Return
	
Label_149:
	var_106_bool = var_103_string == var_2_object; // 0x95 Eq
	if(var_106_bool == 0) goto Label_152; // 0x96 JumpB
	return 0; // 0x97 Return
	
Label_152:
	var_107_string = ""; var_108_bool = 0; // 0x98 PushV
	var_107_string = var_103_string; // 0x99 Mov
	var_109_string = ""; // 0x9a PushS
	var_110_bool = var_103_string == var_109_string; // 0x9b Eq
	if(var_110_bool == 0) goto Label_159; // 0x9c JumpB
	var_108_bool = 0; // 0x9d MovB
	goto Label_160; // 0x9e Jump
	
Label_160:
	func_796(var_107_string, var_108_bool); // 0xa0 NEW_2
	var_2_object = var_103_string; // 0xa2 TMov
	return 0; // 0xa3 Return
	
Label_159:
	var_108_bool = 1; // 0x9f MovB
}
...
Label_603:
	...
	func_868(var_36_int); // 0x25c NEW_2
...
Label_618:
	...
	func_861(var_58_string, var_59_int); // 0x278 NEW_2
...
{
	var_77_string = "ui/NPC_bmask.png"; // 0x357 MovS
...
{
	var_78_string = "ui/NPC_bmask_b.png"; // 0x359 MovS
...
{
	var_111_bool = 0; var_112_float = 0; var_113_float = 0; var_114_bool = 0; var_115_float = 0; var_116_float = 0; // 0x31c PushV
	lshHasAnimation(var_114_bool, var_107_string); // 0x31d Func
	var_117_bool = var_114_bool; // 0x31f Push
	if(var_117_bool == 0) goto Label_806; // 0x320 JumpB
	lshGetAnimTimes(var_107_string, var_115_float, var_116_float); // 0x321 Func
	lshPlayAnimation(var_115_float, var_116_float, var_108_bool); // 0x323 Func
	goto Label_810; // 0x325 Jump
	
Label_810:
	return 6; // 0x32a Return
	
Label_806:
	var_118_string = "Can't find lsh animation : "; // 0x326 PushS
	var_119_int = var_118_string + var_107_string; // 0x327 Add
	Trace(var_119_int); // 0x328 Func
}


func_861(var_42_string, var_43_int)
{
	var_44_string = ""; var_45_string = ""; // 0x35d PushV
	var_45_string = "idle"; // 0x35e MovS
	var_46_int = var_43_int; // 0x35f Push
	if(var_46_int == 0) goto Label_866; // 0x360 JumpB
	var_45_string = var_45_string + var_43_int; // 0x361 Add2
	
Label_866:
	var_42_string = var_45_string; // 0x362 Mov
...
func_868(var_36_int)
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x364 PushV
	var_39_int = 0; // 0x365 MovI
	
Label_870:
	var_41_string = "all"; // 0x366 PushS
	var_42_string = ""; var_43_int = 0; // 0x367 PushV
	var_43_int = var_39_int; // 0x368 Mov
	func_861(var_42_string, var_43_int); // 0x369 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x36b Func
	var_47_bool = var_40_bool == 0; // 0x36d Not
	if(var_47_bool == 0) goto Label_880; // 0x36e JumpB
	goto Label_883; // 0x36f Jump
	
Label_883:
	var_36_int = var_39_int; // 0x373 Mov
	return 4; // 0x374 Return
	
Label_880:
	var_48_int = 1; // 0x370 PushI
	var_39_int = var_39_int + var_48_int; // 0x371 Add2
	goto Label_870; // 0x372 Jump
}
...
{
	var_29_float = 0; var_30_cvector = CVector(0,0,0); var_31_float = 0; var_32_cvector = CVector(0,0,0); // 0x32b PushV
	GetEyesHeight(var_31_float); // 0x32c ObjFunc
	var_32_cvector = CVector(0.0, 0.0, 0.0); // 0x32e MovV
	var_33_float = GetByIndex(var_32_cvector, 1); // 0x32f PushE
	var_33_float = var_31_float; // 0x330 Mov
	SetByIndex(var_32_cvector, 1) = var_33_float; // 0x331 PopE
	var_34_string = "head"; // 0x332 PushS
	LookAsync(var_28_object, var_34_string, var_32_cvector); // 0x333 Func
...
func_693(var_27_bool, var_29_float)
{
	...
	func_829(var_54_cvector, var_55_cvector); // 0x2d0 NEW_2
...
Label_734:
	...
	var_67_bool = 1; // 0x2e0 PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x2e1 Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x2e3 PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x2e4 PushE
	Rotate(var_68_float, var_69_float); // 0x2e5 Func
	var_70_bool = 0; // 0x2e7 PushV
	func_859(var_70_bool); // 0x2e8 NEW_2
	if(var_70_bool == 0) goto Label_748; // 0x2ea JumpB
	goto Label_756; // 0x2eb Jump
	
Label_756:
	CameraWaitForPlayFinish(); // 0x2f4 Func
	ResumeWorld(); // 0x2f6 Func
	var_27_bool = 1; // 0x2f8 MovB
	return 18; // 0x2f9 Return
	
Label_748:
	var_71_string = "head"; // 0x2ec PushS
	HasAnimationTrack(var_47_bool, var_71_string); // 0x2ed Func
	var_72_bool = var_47_bool; // 0x2ef Push
	if(var_72_bool == 0) goto Label_756; // 0x2f0 JumpB
	var_73_string = "head"; // 0x2f1 PushS
	LookAsyncCamera(var_73_string); // 0x2f2 Func
}


func_822()
{
	var_14_bool = 0; // 0x336 PushV
	func_859(var_14_bool); // 0x337 NEW_2
	if(var_14_bool == 0) goto Label_828; // 0x339 JumpB
...
func_885()
{
	var_97_bool = 0; var_98_string = ""; var_99_string = ""; // 0x376 PushV
	var_98_string = "quest_k1_01"; // 0x377 MovS
	var_99_string = "remove_birdmask"; // 0x378 MovS
	func_839(var_97_bool, var_98_string, var_99_string); // 0x379 NEW_2
...
func_762()
{
	var_150_bool = 0; var_151_bool = 0; // 0x2fa PushV
	var_152_bool = 1; // 0x2fb PushB
	CameraSwitchToNormal(var_152_bool); // 0x2fc Func
	var_153_bool = 0; // 0x2fe PushV
	func_859(var_153_bool); // 0x2ff NEW_2
	if(var_153_bool == 0) goto Label_771; // 0x301 JumpB
...
Label_771:
	var_154_string = "head"; // 0x303 PushS
	HasAnimationTrack(var_151_bool, var_154_string); // 0x304 Func
	var_155_bool = var_151_bool; // 0x306 Push
	if(var_155_bool == 0) goto Label_779; // 0x307 JumpB
	var_156_string = "head"; // 0x308 PushS
	UnlookAsync(var_156_string); // 0x309 Func
}


func_892(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x37c PushV
	var_82_string = "branch"; // 0x37d PushS
	GetVariable(var_82_string, var_81_int); // 0x37e Func
	var_83_int = 0; // 0x380 PushI
	var_84_bool = var_81_int == var_83_int; // 0x381 Eq
	if(var_84_bool == 0) goto Label_902; // 0x382 JumpB
	var_79_int = 1; // 0x383 MovI
	return 2; // 0x384 Return
	
Label_902:
	var_85_int = 1; // 0x386 PushI
	var_86_bool = var_81_int == var_85_int; // 0x387 Eq
	if(var_86_bool == 0) goto Label_907; // 0x388 JumpB
	var_79_int = 2; // 0x389 MovI
	return 2; // 0x38a Return
	
Label_907:
	var_79_int = 3; // 0x38b MovI
...
{
	var_57_float = 0; var_58_float = 0; // 0x33d PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x33e Or
	var_58_float = sqrt(var_59_int); // 0x33f Sqrt2
	var_60_float = 0.0; // 0x340 PushF
	var_61_bool = var_58_float < var_60_float; // 0x341 LT
	if(var_61_bool == 0) goto Label_837; // 0x342 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x343 MovV
	return 2; // 0x344 Return
	
Label_837:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x345 Div2
