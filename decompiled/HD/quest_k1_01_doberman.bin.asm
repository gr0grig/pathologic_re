...
0x45f: Push("Can't find lsh animation : ")
...
0x46e: Push("Can't find lsh animation : ")
...
0x4df: Stack[-5] = Stack[-2]
0x4e0: Return(); Pop(4)

0x4e1: PushEmpty()
0x4e2: Push("ook1Lisa1")
0x4e3: Push((int) 1)
...
0x527: Stack[-1] = "ui/NPC_Citizen2.png"
0x528: Return(); Pop(0)

0x529: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x52a: Return(); Pop(0)
...
0x53f: Stack[-5] = Stack[-11]
0x540: Stack[-4] = Stack[-10]
0x541: Stack[-3] = Stack[-9]
...
0x55a: Stack[-2] = "quest_k1_01"
0x55b: Stack[-1] = "doberman_dead"
0x55c: Call2 0x4bd
