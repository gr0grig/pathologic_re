...
Label_517:
	...
	func_1323(var_178_bool); // 0x207 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_1139(var_27_object); // 0x25d NEW_2
...
task_3_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object)
{
	...
	func_1302(var_14_object); // 0x2ed NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x536 PushV
	var_14_object = var_10_object; // 0x537 Mov
	var_15_int = var_11_int; // 0x538 Mov
	var_16_float = var_12_float; // 0x539 Mov
	func_934(var_14_object, var_15_int, var_16_float); // 0x53a NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x53e PushV
	var_16_object = var_10_object; // 0x53f Mov
	var_17_int = var_11_int; // 0x540 Mov
	var_18_float = var_12_float; // 0x541 Mov
	var_19_cvector = var_14_cvector; // 0x542 Mov
	var_20_cvector = var_15_cvector; // 0x543 Mov
	func_1002(var_18_float, var_19_cvector, var_20_cvector); // 0x544 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x547 PushV
	var_14_string = "health"; // 0x548 PushS
	var_15_bool = var_11_string == var_14_string; // 0x549 Eq
	if(var_15_bool == 0) goto Label_1363; // 0x54a JumpB
	var_16_string = "health"; // 0x54b PushS
	GetProperty(var_16_string, var_13_float); // 0x54c Func
	var_17_int = 0; // 0x54e PushI
	var_18_bool = var_13_float <= var_17_int; // 0x54f LE
	if(var_18_bool == 0) goto Label_1363; // 0x550 JumpB
	SignalDeath(var_10_object); // 0x551 Func
...
{
	var_11_bool = 0; var_12_bool = 0; // 0x554 PushV
	IsPlayerActor(var_10_object, var_12_bool); // 0x555 Func
	var_13_bool = var_12_bool; // 0x557 Push
	if(var_13_bool == 0) goto Label_1374; // 0x558 JumpB
	var_14_bool = 0; var_15_string = ""; var_16_string = ""; // 0x559 PushV
	var_15_string = "quest_k1_01"; // 0x55a MovS
	var_16_string = "doberman_dead"; // 0x55b MovS
	func_1213(var_14_bool, var_15_string, var_16_string); // 0x55c NEW_2
	
Label_1374:
	var_20_object = Obj(); // 0x55e PushV
	var_20_object = var_10_object; // 0x55f Mov
	func_1325(var_20_object); // 0x560 NEW_2
...
Label_56:
	var_159_bool = var_24_bool == 0; // 0x38 Not
	if(var_159_bool == 0) goto Label_63; // 0x39 JumpB
	sync(); // 0x3a Func
	IsDialogEnd(var_24_bool); // 0x3c ObjFunc
	goto Label_56; // 0x3e Jump
	
Label_63:
	var_160_object = Obj(); // 0x3f PushV
	var_160_object = var_15_object; // 0x40 Mov
	func_1090(); // 0x41 NEW_2
...
{
	var_52_bool = 0; var_53_int = 0; var_54_bool = 0; var_55_int = 0; var_56_bool = 0; var_57_float = 0; var_58_cvector = CVector(0,0,0); var_59_cvector = CVector(0,0,0); var_60_bool = 0; var_61_int = 0; var_62_bool = 0; var_63_int = 0; var_64_bool = 0; var_65_float = 0; var_66_cvector = CVector(0,0,0); var_67_cvector = CVector(0,0,0); // 0x485 PushV
	IsExisting3DSound(var_60_bool, var_51_string); // 0x486 Func
	var_68_bool = var_60_bool == 0; // 0x488 Not
	if(var_68_bool == 0) goto Label_1182; // 0x489 JumpB
	var_61_int = 0; // 0x48a MovI
	
Label_1163:
	var_69_int = 1; // 0x48b PushI
	var_70_int = var_61_int + var_69_int; // 0x48c Add
	var_71_int = var_51_string + var_70_int; // 0x48d Add
	IsExisting3DSound(var_62_bool, var_71_int); // 0x48e Func
	var_72_bool = var_62_bool == 0; // 0x490 Not
	if(var_72_bool == 0) goto Label_1171; // 0x491 JumpB
	goto Label_1174; // 0x492 Jump
	
Label_1174:
	var_73_bool = var_61_int == 0; // 0x496 Not
	if(var_73_bool == 0) goto Label_1177; // 0x497 JumpB
	return 16; // 0x498 Return
	
Label_1177:
	irand(var_63_int, var_61_int); // 0x499 Func
	var_74_int = 1; // 0x49b PushI
	var_75_int = var_63_int + var_74_int; // 0x49c Add
	var_51_string = var_51_string + var_75_int; // 0x49d Add2
	
Label_1182:
	Is3DSoundLoaded(var_64_bool, var_51_string); // 0x49e Func
	var_76_bool = var_64_bool; // 0x4a0 Push
	if(var_76_bool == 0) goto Label_1197; // 0x4a1 JumpB
	GetEyesHeight(var_65_float); // 0x4a2 Func
	GetDirection(var_66_cvector); // 0x4a4 Func
	var_77_int = 50; // 0x4a6 PushI
	var_67_cvector = var_66_cvector * var_77_int; // 0x4a7 Mult2
	var_78_float = GetByIndex(var_67_cvector, 1); // 0x4a8 PushE
	var_78_float = var_78_float + var_65_float; // 0x4a9 Add2
	SetByIndex(var_67_cvector, 1) = var_78_float; // 0x4aa PopE
	PlayGlobalSound(var_51_string, var_67_cvector); // 0x4ab Func
	
Label_1197:
	return 16; // 0x4ad Return
	
Label_1171:
	var_79_int = 1; // 0x493 PushI
	var_61_int = var_61_int + var_79_int; // 0x494 Add2
	goto Label_1163; // 0x495 Jump
}


func_1296(var_15_int)
{
	var_16_int = 0; var_17_int = 0; // 0x510 PushV
	var_18_string = "branch"; // 0x511 PushS
	GetVariable(var_18_string, var_17_int); // 0x512 Func
	var_15_int = var_17_int; // 0x514 Mov
...
{
	var_15_int = 0; // 0x517 PushV
	func_1296(var_15_int); // 0x518 NEW_2
	var_19_int = 1; // 0x51a PushI
	var_20_bool = var_15_int == var_19_int; // 0x51b Eq
	if(var_20_bool == 0) goto Label_1312; // 0x51c JumpB
	WorkWithCorpse(var_14_object); // 0x51d Func
	goto Label_1314; // 0x51f Jump
	
Label_1314:
	return 0; // 0x522 Return
	
Label_1312:
	Barter(var_14_object); // 0x520 Func
}


func_1315(var_74_int)
{
	var_74_int = 518097; // 0x523 MovI
...
{
	var_113_bool = 0; // 0xa7 PushV
	func_1323(var_113_bool); // 0xa8 NEW_2
	var_114_bool = var_113_bool == 0; // 0xaa Not
	if(var_114_bool == 0) goto Label_173; // 0xab JumpB
	return 0; // 0xac Return
	
Label_173:
	var_115_bool = var_112_string == var_2_object; // 0xad Eq
	if(var_115_bool == 0) goto Label_176; // 0xae JumpB
	return 0; // 0xaf Return
	
Label_176:
	var_116_string = ""; var_117_bool = 0; // 0xb0 PushV
	var_116_string = var_112_string; // 0xb1 Mov
	var_118_string = ""; // 0xb2 PushS
	var_119_bool = var_112_string == var_118_string; // 0xb3 Eq
	if(var_119_bool == 0) goto Label_183; // 0xb4 JumpB
	var_117_bool = 0; // 0xb5 MovB
	goto Label_184; // 0xb6 Jump
	
Label_184:
	func_1124(var_116_string, var_117_bool); // 0xb8 NEW_2
	var_2_object = var_112_string; // 0xba TMov
	return 0; // 0xbb Return
	
Label_183:
	var_117_bool = 1; // 0xb7 MovB
}


func_1319(var_75_string)
{
	var_75_string = "ui/NPC_Citizen2.png"; // 0x527 MovS
...
{
	var_76_string = "ui/NPC_Citizen2_b.png"; // 0x529 MovS
...
Label_950:
	...
	func_1198(var_42_cvector, var_43_cvector); // 0x3bd NEW_2
...
{
	var_21_object = Obj(); // 0x52e PushV
	var_21_object = var_20_object; // 0x52f Mov
	TaskCall(3); // 0x530 TaskCall
	func_716(var_21_object); // 0x531 NEW_2
...
{
	var_50_float = 0; var_51_float = 0; // 0x4ae PushV
	var_52_int = var_43_cvector | var_43_cvector; // 0x4af Or
	var_51_float = sqrt(var_52_int); // 0x4b0 Sqrt2
	var_53_float = 0.0; // 0x4b1 PushF
	var_54_bool = var_51_float < var_53_float; // 0x4b2 LT
	if(var_54_bool == 0) goto Label_1206; // 0x4b3 JumpB
	var_42_cvector = CVector(0.0, 0.0, 0.0); // 0x4b4 MovV
	return 2; // 0x4b5 Return
	
Label_1206:
	var_42_cvector = var_43_cvector / var_43_cvector; // 0x4b6 Div2
...
{
	var_98_int = 0; var_99_int = 0; // 0x4b8 PushV
	GetVariable(var_97_string, var_99_int); // 0x4b9 Func
	var_96_int = var_99_int; // 0x4bb Mov
...
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x4bd PushV
	FindActor(var_18_object, var_15_string); // 0x4be Func
	var_19_bool = var_18_object == 0; // 0x4c0 NullEq
	if(var_19_bool == 0) goto Label_1220; // 0x4c1 JumpB
	var_14_bool = 0; // 0x4c2 MovB
	return 2; // 0x4c3 Return
	
Label_1220:
	Trigger(var_18_object, var_16_string); // 0x4c4 Func
	var_14_bool = 1; // 0x4c6 MovB
...
func_1090()
{
	var_161_bool = 0; var_162_bool = 0; // 0x442 PushV
	var_163_bool = 1; // 0x443 PushB
	CameraSwitchToNormal(var_163_bool); // 0x444 Func
	var_164_bool = 0; // 0x446 PushV
	func_1323(var_164_bool); // 0x447 NEW_2
	if(var_164_bool == 0) goto Label_1099; // 0x449 JumpB
...
Label_1099:
	var_165_string = "head"; // 0x44b PushS
	HasAnimationTrack(var_162_bool, var_165_string); // 0x44c Func
	var_166_bool = var_162_bool; // 0x44e Push
	if(var_166_bool == 0) goto Label_1107; // 0x44f JumpB
	var_167_string = "head"; // 0x450 PushS
	UnlookAsync(var_167_string); // 0x451 Func
}
...
{
	var_44_string = ""; var_45_string = ""; // 0x4c9 PushV
	var_45_string = "idle"; // 0x4ca MovS
	var_46_int = var_43_int; // 0x4cb Push
	if(var_46_int == 0) goto Label_1230; // 0x4cc JumpB
	var_45_string = var_45_string + var_43_int; // 0x4cd Add2
	
Label_1230:
	var_42_string = var_45_string; // 0x4ce Mov
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_86_object, var_87_object)
{
	...
	if(var_92_int == 0) goto Label_136; // 0x4f JumpB
	...
	func_1255(var_95_object); // 0x54 NEW_2
	...
	func_1267(var_103_object); // 0x59 NEW_2
	if(var_102_bool == 0) goto Label_93; // 0x5b JumpB
	var_93_bool = 1; // 0x5c MovB
	
Label_93:
	if(var_93_bool == 0) goto Label_114; // 0x5d JumpB
	...
	func_1249(); // 0x61 NEW_2
	var_112_string = ""; // 0x63 PushV
	var_112_string = "Neutral"; // 0x64 MovS
	func_166(var_87_object, var_112_string); // 0x65 NEW_2
	var_129_int = 524677; // 0x67 PushI
	SetMessage(var_129_int); // 0x68 TObjFunc
	ClearReplies(); // 0x6a TObjFunc
	var_130_int = 541777; // 0x6c PushI
	var_131_int = 43984; // 0x6d PushI
	var_132_int = 43983; // 0x6e PushI
	AddReply(var_130_int, var_131_int, var_132_int); // 0x6f TObjFunc
	goto Label_136; // 0x71 Jump
	
Label_136:
	var_133_bool = 0; // 0x88 PushV
	func_1323(var_133_bool); // 0x89 NEW_2
	if(var_133_bool == 0) goto Label_151; // 0x8b JumpB
	
Label_140:
	lshWaitForAnimEnd(); // 0x8c Func
	var_134_string = var_3_string; // 0x8e PushT
	if(var_134_string == 0) goto Label_145; // 0x8f JumpB
...
Label_145:
	var_135_string = ""; // 0x91 PushV
	var_135_string = var_2_object; // 0x92 MovT
	func_1108(var_135_string); // 0x93 NEW_2
...
Label_155:
	...
	var_148_string = var_3_string; // 0x9d PushT
	if(var_148_string == 0) goto Label_160; // 0x9e JumpB
	goto Label_165; // 0x9f Jump
	
Label_160:
	var_149_string = "all"; // 0xa0 PushS
	var_150_string = "idle"; // 0xa1 PushS
	PlayAnimation(var_149_string, var_150_string); // 0xa2 Func
	goto Label_155; // 0xa4 Jump
	
Label_114:
	var_151_string = ""; // 0x72 PushV
	var_151_string = "Neutral"; // 0x73 MovS
	func_166(var_87_object, var_151_string); // 0x74 NEW_2
	var_152_int = 524679; // 0x76 PushI
	SetMessage(var_152_int); // 0x77 TObjFunc
	ClearReplies(); // 0x79 TObjFunc
	var_153_int = 524680; // 0x7b PushI
	var_154_int = -1; // 0x7c PushI
	var_155_int = 26019; // 0x7d PushI
	AddReply(var_153_int, var_154_int, var_155_int); // 0x7e TObjFunc
	var_156_int = 526801; // 0x80 PushI
	var_157_int = -1; // 0x81 PushI
	var_158_int = 28081; // 0x82 PushI
	AddReply(var_156_int, var_157_int, var_158_int); // 0x83 TObjFunc
...
func_843(var_50_string)
{
	...
	func_1157(var_51_string); // 0x358 NEW_2
...
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0; // 0x4d0 PushV
	var_39_int = 0; // 0x4d1 MovI
	
Label_1234:
	var_41_string = "all"; // 0x4d2 PushS
	var_42_string = ""; var_43_int = 0; // 0x4d3 PushV
	var_43_int = var_39_int; // 0x4d4 Mov
	func_1225(var_42_string, var_43_int); // 0x4d5 NEW_2
	HasAnimation(var_40_bool, var_41_string, var_42_string); // 0x4d7 Func
	var_47_bool = var_40_bool == 0; // 0x4d9 Not
	if(var_47_bool == 0) goto Label_1244; // 0x4da JumpB
	goto Label_1247; // 0x4db Jump
	
Label_1247:
	var_36_int = var_39_int; // 0x4df Mov
	return 4; // 0x4e0 Return
	
Label_1244:
	var_48_int = 1; // 0x4dc PushI
	var_39_int = var_39_int + var_48_int; // 0x4dd Add2
	goto Label_1234; // 0x4de Jump
}


func_1108(var_135_string)
{
	var_136_bool = 0; var_137_float = 0; var_138_float = 0; var_139_bool = 0; var_140_float = 0; var_141_float = 0; // 0x454 PushV
	lshHasAnimation(var_139_bool, var_135_string); // 0x455 Func
	var_142_bool = var_139_bool; // 0x457 Push
	if(var_142_bool == 0) goto Label_1119; // 0x458 JumpB
	lshGetAnimTimes(var_135_string, var_140_float, var_141_float); // 0x459 Func
	var_143_bool = 0; // 0x45b PushB
	lshPlayAnimation(var_140_float, var_141_float, var_143_bool); // 0x45c Func
	goto Label_1123; // 0x45e Jump
	
Label_1123:
	return 6; // 0x463 Return
	
Label_1119:
	var_144_string = "Can't find lsh animation : "; // 0x45f PushS
	var_145_int = var_144_string + var_135_string; // 0x460 Add
	Trace(var_145_int); // 0x461 Func
}
...
func_1249()
{
	var_110_string = "ook1Lisa1"; // 0x4e2 PushS
	var_111_int = 1; // 0x4e3 PushI
	SetVariable(var_110_string, var_111_int); // 0x4e4 Func
...
{
	var_120_bool = 0; var_121_float = 0; var_122_float = 0; var_123_bool = 0; var_124_float = 0; var_125_float = 0; // 0x464 PushV
	lshHasAnimation(var_123_bool, var_116_string); // 0x465 Func
	var_126_bool = var_123_bool; // 0x467 Push
	if(var_126_bool == 0) goto Label_1134; // 0x468 JumpB
	lshGetAnimTimes(var_116_string, var_124_float, var_125_float); // 0x469 Func
	lshPlayAnimation(var_124_float, var_125_float, var_117_bool); // 0x46b Func
	goto Label_1138; // 0x46d Jump
	
Label_1138:
	return 6; // 0x472 Return
	
Label_1134:
	var_127_string = "Can't find lsh animation : "; // 0x46e PushS
	var_128_int = var_127_string + var_116_string; // 0x46f Add
	Trace(var_128_int); // 0x470 Func
}


func_1255(var_94_bool)
{
	var_96_int = 0; var_97_string = ""; // 0x4e8 PushV
	var_97_string = "k1q01"; // 0x4e9 MovS
	func_1208(var_96_int, var_97_string); // 0x4ea NEW_2
	var_100_int = 4; // 0x4ec PushI
	var_101_bool = var_96_int == var_100_int; // 0x4ed Eq
	if(var_101_bool == 0) goto Label_1265; // 0x4ee JumpB
	var_94_bool = 1; // 0x4ef MovB
	return 0; // 0x4f0 Return
	
Label_1265:
	var_94_bool = 0; // 0x4f1 MovB
...
Label_820:
	...
	func_1157(var_103_string); // 0x336 NEW_2
...
{
	var_104_int = 0; var_105_string = ""; // 0x4f4 PushV
	var_105_string = "ook1Lisa1"; // 0x4f5 MovS
	func_1208(var_104_int, var_105_string); // 0x4f6 NEW_2
	var_106_int = 0; // 0x4f8 PushI
	var_107_bool = var_104_int == var_106_int; // 0x4f9 Eq
	if(var_107_bool == 0) goto Label_1277; // 0x4fa JumpB
	var_102_bool = 1; // 0x4fb MovB
...
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x473 PushV
	GetEyesHeight(var_30_float); // 0x474 ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x476 MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x477 PushE
	var_32_float = var_30_float; // 0x478 Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x479 PopE
	var_33_string = "head"; // 0x47a PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x47b Func
...
Label_639:
	...
	func_1232(var_36_int); // 0x280 NEW_2
...
Label_654:
	...
	func_1225(var_58_string, var_59_int); // 0x29c NEW_2
...
func_1021(var_25_bool, var_27_float)
{
	...
	func_1198(var_52_cvector, var_53_cvector); // 0x418 NEW_2
...
Label_1062:
	...
	var_65_bool = 1; // 0x428 PushB
	CameraTransit(var_43_cvector, var_41_cvector, var_65_bool); // 0x429 Func
	var_66_float = GetByIndex(var_42_cvector, 0); // 0x42b PushE
	var_67_float = GetByIndex(var_42_cvector, 2); // 0x42c PushE
	Rotate(var_66_float, var_67_float); // 0x42d Func
	var_68_bool = 0; // 0x42f PushV
	func_1323(var_68_bool); // 0x430 NEW_2
	if(var_68_bool == 0) goto Label_1076; // 0x432 JumpB
	goto Label_1084; // 0x433 Jump
	
Label_1084:
	CameraWaitForPlayFinish(); // 0x43c Func
	ResumeWorld(); // 0x43e Func
	var_25_bool = 1; // 0x440 MovB
	return 18; // 0x441 Return
	
Label_1076:
	var_69_string = "head"; // 0x434 PushS
	HasAnimationTrack(var_45_bool, var_69_string); // 0x435 Func
	var_70_bool = var_45_bool; // 0x437 Push
	if(var_70_bool == 0) goto Label_1084; // 0x438 JumpB
	var_71_string = "head"; // 0x439 PushS
	LookAsyncCamera(var_71_string); // 0x43a Func
}


func_1150()
{
	var_13_bool = 0; // 0x47e PushV
	func_1323(var_13_bool); // 0x47f NEW_2
	if(var_13_bool == 0) goto Label_1156; // 0x481 JumpB
	lshStopSpeech(); // 0x482 Func
...
{
	var_78_int = 0; var_79_int = 0; // 0x4ff PushV
	var_80_string = "branch"; // 0x500 PushS
	GetVariable(var_80_string, var_79_int); // 0x501 Func
	var_81_int = 0; // 0x503 PushI
	var_82_bool = var_79_int == var_81_int; // 0x504 Eq
	if(var_82_bool == 0) goto Label_1289; // 0x505 JumpB
	var_77_int = 1; // 0x506 MovI
	return 2; // 0x507 Return
	
Label_1289:
	var_83_int = 1; // 0x509 PushI
	var_84_bool = var_79_int == var_83_int; // 0x50a Eq
	if(var_84_bool == 0) goto Label_1294; // 0x50b JumpB
	var_77_int = 2; // 0x50c MovI
	return 2; // 0x50d Return
	
Label_1294:
	var_77_int = 3; // 0x50e MovI
