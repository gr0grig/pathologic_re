...
0x422: Stack[-1] = "k1q01ooStationGotoLaska"
0x423: Call2 0x3f2
...
0x428: Push("k1q01ooStationGotoLaska")
0x429: Push((int) 1)
...
0x42f: Pop(1)
0x430: Push("k1q01StationGotoLaska")
0x431: Push("pt_map_laska")
0x432: Push((int) 1)
...
0x436: Pop(0)
0x437: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x438: Pop(5)
0x439: PushEmpty()
0x43a: Call2 0x489
...
0x440: Stack[-1] = "k1q01ooStationGotoLaska"
0x441: Call2 0x3f2
...
0x446: Push("k1q01ooStationGotoLaska")
0x447: Push((int) 1)
...
0x455: Pop(0)
0x456: @@ ShowMap(Stack[-1])
0x457: Pop(1)
0x458: Return(); Pop(0)

0x459: PushEmpty()
0x45a: PushEmpty(int, string)
0x45b: Stack[-1] = "ook1Dohodyaga1"
0x45c: Call2 0x3f2
...
0x467: Stack[-1] = "k1q01DobermanDead"
0x468: Call2 0x3f2
...
0x4d5: Push("Can't find main outdoor scene")
0x4d6: @ Trace(Stack[-1])
0x4d7: Pop(1)
0x4d8: Return(); Pop(8)

0x4d9: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x4da: Pop(0)
0x4db: Pop(0); Push((bool) Stack[-1] == 0)
0x4dc: IF (Stack[-1] == 0) GOTO 0x4e3; Pop(1)

0x4dd: Push("Warning: outdoor scene locator ")
0x4de: Pop(1); Push(Stack[-1] + Stack[-11]);
0x4df: Push(" doesnt exist")
0x4e0: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4e1: @ Trace(Stack[-1])
0x4e2: Pop(1)
0x4e3: @@ GetMap(Stack[-11])
0x4e4: Pop(0)
0x4e5: Pop(0); Push((bool) Stack[-11] == 0)
0x4e6: IF (Stack[-1] == 0) GOTO 0x4eb; Pop(1)

0x4e7: Push("Can't find map")
0x4e8: @ Trace(Stack[-1])
0x4e9: Pop(1)
0x4ea: Return(); Pop(8)
...
0x4ed: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x4ee: Pop(2)
0x4ef: Return(); Pop(8)
...
0x506: Stack[-1] = "ui/NPC_Citizen3.png"
0x507: Return(); Pop(0)

0x508: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x509: Return(); Pop(0)
