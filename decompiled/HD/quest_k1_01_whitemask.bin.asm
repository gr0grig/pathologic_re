...
0x308: Stack[-1] = "ui/NPC_wmask.png"
0x309: Return(); Pop(0)

0x30a: Stack[-1] = "ui/NPC_wmask_b.png"
0x30b: Return(); Pop(0)
...
0x328: Stack[-2] = "quest_k1_01"
0x329: Stack[-1] = "remove_whitemask"
0x32a: Call2 0x2f8
