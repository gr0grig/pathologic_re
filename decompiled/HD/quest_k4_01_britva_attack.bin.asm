...
0x646: Stack[-2] = Stack[-4]
0x647: Stack[-1] = (float) 0.02
0x648: Call2 0x5ed
...
0x65b: Stack[-5] = Stack[-11]
0x65c: Stack[-4] = Stack[-10]
0x65d: Stack[-3] = Stack[-9]
0x65e: Stack[-2] = Stack[-7]
0x65f: Stack[-1] = Stack[-6]
0x660: Call2 0x57e
