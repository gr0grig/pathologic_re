...
task_1_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1579(var_12_object); // 0x2f3 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x652 PushV
	var_13_object = var_9_object; // 0x653 Mov
	var_14_int = var_10_int; // 0x654 Mov
	var_15_float = var_11_float; // 0x655 Mov
	func_1338(var_13_object, var_14_int, var_15_float); // 0x656 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x65a PushV
	var_15_object = var_9_object; // 0x65b Mov
	var_16_int = var_10_int; // 0x65c Mov
	var_17_float = var_11_float; // 0x65d Mov
	var_18_cvector = var_13_cvector; // 0x65e Mov
	var_19_cvector = var_14_cvector; // 0x65f Mov
	func_1406(var_17_float, var_18_cvector, var_19_cvector); // 0x660 NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x663 PushV
	var_13_string = "health"; // 0x664 PushS
	var_14_bool = var_10_string == var_13_string; // 0x665 Eq
	if(var_14_bool == 0) goto Label_1647; // 0x666 JumpB
	var_15_string = "health"; // 0x667 PushS
	GetProperty(var_15_string, var_12_float); // 0x668 Func
	var_16_int = 0; // 0x66a PushI
	var_17_bool = var_12_float <= var_16_int; // 0x66b LE
	if(var_17_bool == 0) goto Label_1647; // 0x66c JumpB
	SignalDeath(var_9_object); // 0x66d Func
...
{
	var_10_object = Obj(); // 0x671 PushV
	var_10_object = var_9_object; // 0x672 Mov
	func_1599(var_10_object); // 0x673 NEW_2
...
Label_1175:
	var_448_string = "armor"; // 0x497 PushS
	GetProperty(var_448_string, var_397_int); // 0x498 ObjFunc
}
...
func_1552(var_440_float)
{
	...
	var_443_int = 0; // 0x615 PushI
	var_444_bool = var_440_float < var_443_int; // 0x616 LT
	if(var_444_bool == 0) goto Label_1564; // 0x617 JumpB
	var_445_float = 0.7; // 0x618 PushF
	var_446_int = 500; // 0x619 PushI
	RumblePlay(var_445_float, var_446_int); // 0x61a Func
	
Label_1564:
	var_447_int = 15; // 0x61c PushI
	SendWorldWndMessage(var_447_int, var_442_object); // 0x61d Func
...
Label_186:
	...
	var_491_string = "all"; // 0xbc PushS
	var_492_string = "fjump"; // 0xbd PushS
	PlayAnimation(var_491_string, var_492_string); // 0xbe Func
	WaitForAnimEnd(); // 0xc0 Func
	func_672(var_36_float); // 0xc3 NEW_2
	var_493_cvector = CVector(0.0, 0.0, 0.0); // 0xc5 PushVec
	SetSpeed(var_493_cvector); // 0xc6 Func
	Stop(); // 0xc8 Func
	StopAsync(); // 0xca Func
	var_494_bool = 0; // 0xcc PushV
	func_629(var_36_float, var_494_bool); // 0xcd NEW_2
	var_495_bool = var_494_bool == 0; // 0xcf Not
	if(var_495_bool == 0) goto Label_232; // 0xd0 JumpB
	var_496_bool = 0; var_497_object = Obj(); // 0xd1 PushV
	var_497_object = var_0_object; // 0xd2 MovT
	func_1270(var_496_bool, var_497_object); // 0xd3 NEW_2
	var_498_bool = var_496_bool == 0; // 0xd5 Not
	if(var_498_bool == 0) goto Label_216; // 0xd6 JumpB
...
Label_216:
	...
	var_499_float = var_14_float * var_14_float; // 0xde Mult
	var_500_bool = var_33_float < var_499_float; // 0xdf LT
	if(var_500_bool == 0) goto Label_232; // 0xe0 JumpB
	var_501_bool = 0; var_502_float = 0; // 0xe1 PushV
	var_502_float = var_14_float; // 0xe2 Mov
	func_333(var_36_float, var_501_bool, var_502_float); // 0xe3 NEW_2
	var_503_bool = var_501_bool == 0; // 0xe5 Not
	if(var_503_bool == 0) goto Label_232; // 0xe6 JumpB
	goto Label_242; // 0xe7 Jump
	
Label_233:
	var_504_bool = 0; var_505_float = 0; // 0xe9 PushV
	var_505_float = var_14_float; // 0xea Mov
	func_333(var_36_float, var_504_bool, var_505_float); // 0xeb NEW_2
	var_506_bool = var_504_bool == 0; // 0xed Not
	if(var_506_bool == 0) goto Label_240; // 0xee JumpB
...
func_672(var_0_object)
{
	...
	func_1579(var_108_object); // 0x2a2 NEW_2
...
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x621 PushV
	CreateFloatVector(var_24_object); // 0x622 Func
	add(var_22_float); // 0x624 ObjFunc
	var_25_int = 16; // 0x626 PushI
	SendWorldWndMessage(var_25_int, var_24_object); // 0x627 Func
...
func_294(var_0_object, var_370_float, var_371_int)
{
	...
	var_449_int = 0; // 0x141 PushV
	func_677(var_449_int); // 0x142 NEW_2
	ReportHit(var_0_object, var_449_int, var_377_float, var_376_float); // 0x144 Func
	var_450_object = Obj(); var_451_float = 0; // 0x146 PushV
	var_450_object = var_375_object; // 0x147 Mov
	var_451_float = var_377_float; // 0x148 Mov
...
{
	var_109_bool = 0; var_110_bool = 0; // 0x62b PushV
	IsPlayerActor(var_108_object, var_110_bool); // 0x62c Func
	var_111_bool = var_110_bool; // 0x62e Push
	if(var_111_bool == 0) goto Label_1587; // 0x62f JumpB
	var_112_string = "attack"; // 0x630 PushS
	PlayGlobalMusic(var_112_string); // 0x631 Func
...
func_1588()
{
	var_345_object = Obj(); var_346_object = Obj(); // 0x634 PushV
	GetScene(var_346_object); // 0x635 Func
	var_347_string = "battle"; // 0x637 PushS
	var_348_object = Obj(); // 0x638 PushV
	func_1483(var_348_object); // 0x639 NEW_2
	BroadcastMessage(var_347_string, var_348_object, var_346_object); // 0x63b Func
...
func_700(var_2_int, var_115_bool, var_116_object, var_117_float, var_118_float, var_119_bool, var_120_bool)
{
	...
	func_1579(var_128_object); // 0x2bf NEW_2
...
{
	var_11_bool = 0; var_12_object = Obj(); // 0x640 PushV
	var_12_object = var_10_object; // 0x641 Mov
	func_1117(var_11_bool, var_12_object); // 0x642 NEW_2
	if(var_11_bool == 0) goto Label_1610; // 0x644 JumpB
	var_15_bool = 0; var_16_object = Obj(); var_17_float = 0; // 0x645 PushV
	var_16_object = var_10_object; // 0x646 Mov
	var_17_float = 0.02; // 0x647 MovF
	func_1517(var_15_bool, var_16_object, var_17_float); // 0x648 NEW_2
	
Label_1610:
	var_53_object = Obj(); // 0x64a PushV
	var_53_object = var_10_object; // 0x64b Mov
	TaskCall(2); // 0x64c TaskCall
	func_964(var_53_object); // 0x64d NEW_2
	TaskReturn(); // 0x64e TaskReturn
...
Label_369:
	...
	var_452_string = "all"; // 0x176 PushS
	var_453_string = "attack_middle"; // 0x177 PushS
	var_454_int = var_453_string + var_339_int; // 0x178 Add
	HasAnimation(var_340_bool, var_452_string, var_454_int); // 0x179 Func
	var_455_bool = var_340_bool; // 0x17b Push
	if(var_455_bool == 0) goto Label_450; // 0x17c JumpB
	func_1588(); // 0x17e NEW_2
	var_456_string = "all"; // 0x180 PushS
	var_457_string = "attack_middle"; // 0x181 PushS
	var_458_int = var_457_string + var_339_int; // 0x182 Add
	PlayAnimation(var_456_string, var_458_int); // 0x183 Func
	WaitForAnimEnd(); // 0x185 Func
	func_672(var_342_string); // 0x188 NEW_2
	var_459_bool = 0; var_460_object = Obj(); // 0x18a PushV
	var_460_object = var_0_object; // 0x18b MovT
	func_1270(var_459_bool, var_460_object); // 0x18c NEW_2
	var_461_bool = var_459_bool == 0; // 0x18e Not
	if(var_461_bool == 0) goto Label_404; // 0x18f JumpB
	StopAsync(); // 0x190 Func
	var_333_bool = 0; // 0x192 MovB
	return 8; // 0x193 Return
	
Label_404:
	var_462_float = 0; var_463_int = 0; // 0x194 PushV
	var_462_float = var_334_float; // 0x195 Mov
	var_463_int = var_339_int; // 0x196 Mov
	func_294(var_342_string, var_462_float, var_463_int); // 0x197 NEW_2
	var_341_int = 1; // 0x199 MovI
	
Label_410:
	var_464_string = "attack_middle"; // 0x19a PushS
	var_465_int = var_464_string + var_339_int; // 0x19b Add
	var_466_string = "_"; // 0x19c PushS
	var_467_int = var_465_int + var_466_string; // 0x19d Add
	var_342_string = var_467_int + var_341_int; // 0x19e Add2
	var_468_string = "all"; // 0x19f PushS
	HasAnimation(var_340_bool, var_468_string, var_342_string); // 0x1a0 Func
	var_469_bool = var_340_bool == 0; // 0x1a2 Not
	if(var_469_bool == 0) goto Label_421; // 0x1a3 JumpB
	goto Label_450; // 0x1a4 Jump
	
Label_450:
	var_470_bool = 0; // 0x1c2 PushB
	SetAttackState(var_470_bool); // 0x1c3 Func
	var_471_string = "all"; // 0x1c5 PushS
	var_472_string = "attack_end"; // 0x1c6 PushS
	var_473_int = var_472_string + var_339_int; // 0x1c7 Add
	PlayAnimation(var_471_string, var_473_int); // 0x1c8 Func
	var_474_bool = 0; // 0x1ca PushV
	func_686(var_474_bool); // 0x1cb NEW_2
	if(var_474_bool == 0) goto Label_468; // 0x1cd JumpB
	var_475_bool = 0; var_476_float = 0; // 0x1ce PushV
	var_476_float = 0.75; // 0x1cf MovF
	func_470(var_475_bool, var_476_float); // 0x1d0 NEW_2
...
Label_421:
	func_1588(); // 0x1a6 NEW_2
	var_484_string = "all"; // 0x1a8 PushS
	PlayAnimation(var_484_string, var_342_string); // 0x1a9 Func
	WaitForAnimEnd(); // 0x1ab Func
	func_672(var_342_string); // 0x1ae NEW_2
	var_485_bool = 0; var_486_object = Obj(); // 0x1b0 PushV
	var_486_object = var_0_object; // 0x1b1 MovT
	func_1270(var_485_bool, var_486_object); // 0x1b2 NEW_2
	var_487_bool = var_485_bool == 0; // 0x1b4 Not
	if(var_487_bool == 0) goto Label_442; // 0x1b5 JumpB
	StopAsync(); // 0x1b6 Func
	var_333_bool = 0; // 0x1b8 MovB
	return 8; // 0x1b9 Return
	
Label_442:
	var_488_float = 0; var_489_int = 0; // 0x1ba PushV
	var_488_float = var_334_float; // 0x1bb Mov
	var_489_int = var_339_int; // 0x1bc Mov
	func_294(var_342_string, var_488_float, var_489_int); // 0x1bd NEW_2
	var_490_int = 1; // 0x1bf PushI
	var_341_int = var_341_int + var_490_int; // 0x1c0 Add2
...
{
	var_477_float = 0; var_478_bool = 0; var_479_float = 0; var_480_bool = 0; // 0x1d6 PushV
	rand(var_479_float); // 0x1d7 Func
	var_481_bool = var_479_float < var_476_float; // 0x1d9 LT
	if(var_481_bool == 0) goto Label_490; // 0x1da JumpB
	
Label_475:
	IsAnimationPlaying(var_480_bool); // 0x1db Func
	var_482_bool = var_480_bool == 0; // 0x1dd Not
	if(var_482_bool == 0) goto Label_480; // 0x1de JumpB
...
Label_495:
	var_475_bool = 0; // 0x1ef MovB
	return 4; // 0x1f0 Return
	
Label_480:
	var_483_bool = 0; // 0x1e0 PushV
	func_568(var_483_bool); // 0x1e1 NEW_2
	if(var_483_bool == 0) goto Label_486; // 0x1e3 JumpB
	var_475_bool = 1; // 0x1e4 MovB
...
Label_490:
	...
	func_672(var_480_bool); // 0x1ed NEW_2
}
...
Label_1538:
	...
	func_1569(var_22_float); // 0x604 NEW_2
