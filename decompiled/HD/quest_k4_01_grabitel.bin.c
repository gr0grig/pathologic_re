...
task_1_event_0(var_0_object, var_1_bool, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool)
{
	...
	func_2203(var_14_object); // 0xb1 NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2327(var_15_object); // 0x1c9 NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2327(var_15_object); // 0x214 NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool)
{
	...
	func_2327(var_15_object); // 0x4bd NEW_2
...
task_5_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int)
{
	...
	func_2089(var_13_object); // 0x502 NEW_2
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x864 PushV
	var_14_object = var_10_object; // 0x865 Mov
	var_15_int = var_11_int; // 0x866 Mov
	var_16_float = var_12_float; // 0x867 Mov
	func_1795(var_14_object, var_15_int, var_16_float); // 0x868 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; var_19_cvector = CVector(0,0,0); var_20_cvector = CVector(0,0,0); // 0x86c PushV
	var_16_object = var_10_object; // 0x86d Mov
	var_17_int = var_11_int; // 0x86e Mov
	var_18_float = var_12_float; // 0x86f Mov
	var_19_cvector = var_14_cvector; // 0x870 Mov
	var_20_cvector = var_15_cvector; // 0x871 Mov
	func_1863(var_18_float, var_19_cvector, var_20_cvector); // 0x872 NEW_2
...
{
	var_12_float = 0; var_13_float = 0; // 0x875 PushV
	var_14_string = "health"; // 0x876 PushS
	var_15_bool = var_11_string == var_14_string; // 0x877 Eq
	if(var_15_bool == 0) goto Label_2177; // 0x878 JumpB
	var_16_string = "health"; // 0x879 PushS
	GetProperty(var_16_string, var_13_float); // 0x87a Func
	var_17_int = 0; // 0x87c PushI
	var_18_bool = var_13_float <= var_17_int; // 0x87d LE
	if(var_18_bool == 0) goto Label_2177; // 0x87e JumpB
	SignalDeath(var_10_object); // 0x87f Func
...
{
	var_11_object = Obj(); // 0x883 PushV
	var_11_object = var_10_object; // 0x884 Mov
	func_2139(var_11_object); // 0x885 NEW_2
...
func_2062(var_588_float)
{
	...
	var_591_int = 0; // 0x813 PushI
	var_592_bool = var_588_float < var_591_int; // 0x814 LT
	if(var_592_bool == 0) goto Label_2074; // 0x815 JumpB
	var_593_float = 0.7; // 0x816 PushF
	var_594_int = 500; // 0x817 PushI
	RumblePlay(var_593_float, var_594_int); // 0x818 Func
	
Label_2074:
	var_595_int = 15; // 0x81a PushI
	SendWorldWndMessage(var_595_int, var_590_object); // 0x81b Func
	return 2; // 0x81d Return
}
...
Label_1582:
	var_596_string = "armor"; // 0x62e PushS
	GetProperty(var_596_string, var_545_int); // 0x62f ObjFunc
}
...
Label_699:
	...
	var_660_string = "all"; // 0x2bd PushS
	var_661_string = "fjump"; // 0x2be PushS
	PlayAnimation(var_660_string, var_661_string); // 0x2bf Func
	WaitForAnimEnd(); // 0x2c1 Func
	func_1187(var_226_float); // 0x2c4 NEW_2
	var_662_cvector = CVector(0.0, 0.0, 0.0); // 0x2c6 PushVec
	SetSpeed(var_662_cvector); // 0x2c7 Func
	Stop(); // 0x2c9 Func
	StopAsync(); // 0x2cb Func
	var_663_bool = 0; // 0x2cd PushV
	func_1144(var_226_float, var_663_bool); // 0x2ce NEW_2
	var_664_bool = var_663_bool == 0; // 0x2d0 Not
	if(var_664_bool == 0) goto Label_745; // 0x2d1 JumpB
	var_665_bool = 0; var_666_object = Obj(); // 0x2d2 PushV
	var_666_object = var_0_object; // 0x2d3 MovT
	func_1708(var_665_bool, var_666_object); // 0x2d4 NEW_2
	var_667_bool = var_665_bool == 0; // 0x2d6 Not
	if(var_667_bool == 0) goto Label_729; // 0x2d7 JumpB
...
Label_729:
	...
	var_668_float = var_204_float * var_204_float; // 0x2df Mult
	var_669_bool = var_223_float < var_668_float; // 0x2e0 LT
	if(var_669_bool == 0) goto Label_745; // 0x2e1 JumpB
	var_670_bool = 0; var_671_float = 0; // 0x2e2 PushV
	var_671_float = var_204_float; // 0x2e3 Mov
	func_846(var_226_float, var_670_bool, var_671_float); // 0x2e4 NEW_2
	var_672_bool = var_670_bool == 0; // 0x2e6 Not
	if(var_672_bool == 0) goto Label_745; // 0x2e7 JumpB
	goto Label_755; // 0x2e8 Jump
	
Label_746:
	var_673_bool = 0; var_674_float = 0; // 0x2ea PushV
	var_674_float = var_204_float; // 0x2eb Mov
	func_846(var_226_float, var_673_bool, var_674_float); // 0x2ec NEW_2
	var_675_bool = var_673_bool == 0; // 0x2ee Not
	if(var_675_bool == 0) goto Label_753; // 0x2ef JumpB
...
{
	var_69_object = Obj(); var_70_object = Obj(); // 0x81f PushV
	CreateFloatVector(var_70_object); // 0x820 Func
	add(var_68_float); // 0x822 ObjFunc
	var_71_int = 16; // 0x824 PushI
	SendWorldWndMessage(var_71_int, var_70_object); // 0x825 Func
...
{
	var_14_bool = 0; var_15_bool = 0; // 0x829 PushV
	IsPlayerActor(var_13_object, var_15_bool); // 0x82a Func
	var_16_bool = var_15_bool; // 0x82c Push
	if(var_16_bool == 0) goto Label_2097; // 0x82d JumpB
	var_17_string = "attack"; // 0x82e PushS
	PlayGlobalMusic(var_17_string); // 0x82f Func
...
Label_51:
	...
	func_2122(var_29_int); // 0x34 NEW_2
...
Label_66:
	...
	func_2115(var_51_string, var_52_int); // 0x50 NEW_2
...
func_2098()
{
	var_114_object = Obj(); var_115_object = Obj(); // 0x832 PushV
	GetScene(var_115_object); // 0x833 Func
	var_116_string = "battle"; // 0x835 PushS
	var_117_object = Obj(); // 0x836 PushV
	func_1956(var_117_object); // 0x837 NEW_2
	BroadcastMessage(var_116_string, var_117_object, var_115_object); // 0x839 Func
...
{
	var_615_bool = 0; var_616_bool = 0; // 0x83d PushV
	var_617_string = "god_mode"; // 0x83e PushS
	GetVariable(var_617_string, var_616_bool); // 0x83f Func
	var_614_bool = var_616_bool; // 0x841 Mov
...
{
	var_37_string = ""; var_38_string = ""; // 0x843 PushV
	var_38_string = "idle"; // 0x844 MovS
	var_39_int = var_36_int; // 0x845 Push
	if(var_39_int == 0) goto Label_2120; // 0x846 JumpB
	var_38_string = var_38_string + var_36_int; // 0x847 Add2
	
Label_2120:
	var_35_string = var_38_string; // 0x848 Mov
...
{
	var_30_int = 0; var_31_bool = 0; var_32_int = 0; var_33_bool = 0; // 0x84a PushV
	var_32_int = 0; // 0x84b MovI
	
Label_2124:
	var_34_string = "all"; // 0x84c PushS
	var_35_string = ""; var_36_int = 0; // 0x84d PushV
	var_36_int = var_32_int; // 0x84e Mov
	func_2115(var_35_string, var_36_int); // 0x84f NEW_2
	HasAnimation(var_33_bool, var_34_string, var_35_string); // 0x851 Func
	var_40_bool = var_33_bool == 0; // 0x853 Not
	if(var_40_bool == 0) goto Label_2134; // 0x854 JumpB
	goto Label_2137; // 0x855 Jump
	
Label_2137:
	var_29_int = var_32_int; // 0x859 Mov
	return 4; // 0x85a Return
	
Label_2134:
	var_41_int = 1; // 0x856 PushI
	var_32_int = var_32_int + var_41_int; // 0x857 Add2
...
{
	var_12_object = Obj(); // 0x85c PushV
	var_12_object = var_11_object; // 0x85d Mov
	TaskCall(1); // 0x85e TaskCall
	func_128(var_12_object); // 0x85f NEW_2
	TaskReturn(); // 0x860 TaskReturn
...
{
	var_605_float = 0; var_606_float = 0; // 0x664 PushV
	var_607_bool = 0; var_608_object = Obj(); var_609_string = ""; // 0x665 PushV
	var_608_object = var_604_object; // 0x666 Mov
	var_609_string = "health"; // 0x667 MovS
	func_1529(var_607_bool, var_608_object, var_609_string); // 0x668 NEW_2
	var_610_bool = var_607_bool == 0; // 0x66a Not
	if(var_610_bool == 0) goto Label_1646; // 0x66b JumpB
	var_603_bool = 0; // 0x66c MovB
	return 2; // 0x66d Return
	
Label_1646:
	var_611_bool = 0; // 0x66e PushV
	var_611_bool = 0; // 0x66f MovB
	var_612_bool = 0; var_613_object = Obj(); // 0x670 PushV
	var_613_object = var_604_object; // 0x671 Mov
	func_1524(var_612_bool, var_613_object); // 0x672 NEW_2
	if(var_612_bool == 0) goto Label_1658; // 0x674 JumpB
	var_614_bool = 0; // 0x675 PushV
	func_2109(var_614_bool); // 0x676 NEW_2
	if(var_614_bool == 0) goto Label_1658; // 0x678 JumpB
	var_611_bool = 1; // 0x679 MovB
	
Label_1658:
	if(var_611_bool == 0) goto Label_1661; // 0x67a JumpB
	var_603_bool = 0; // 0x67b MovB
	return 2; // 0x67c Return
	
Label_1661:
	var_618_string = "health"; // 0x67d PushS
	GetProperty(var_618_string, var_606_float); // 0x67e ObjFunc
	var_619_float = 0.0; // 0x680 PushF
	var_603_bool = var_606_float <= var_619_float; // 0x681 LE2
...
func_2184(var_15_bool, var_16_object)
{
	...
	func_1708(var_17_bool, var_18_object); // 0x88b NEW_2
...
{
	var_52_object = Obj(); // 0x890 PushV
	var_52_object = var_51_object; // 0x891 Mov
	func_2282(var_52_object); // 0x892 NEW_2
...
{
	var_16_int = 0; var_17_int = 0; // 0x895 PushV
	var_18_string = "branch"; // 0x896 PushS
	GetVariable(var_18_string, var_17_int); // 0x897 Func
	var_15_int = var_17_int; // 0x899 Mov
...
{
	var_15_int = 0; // 0x89c PushV
	func_2197(var_15_int); // 0x89d NEW_2
	var_19_int = 1; // 0x89f PushI
	var_20_bool = var_15_int == var_19_int; // 0x8a0 Eq
	if(var_20_bool == 0) goto Label_2213; // 0x8a1 JumpB
	WorkWithCorpse(var_14_object); // 0x8a2 Func
...
Label_2213:
	Barter(var_14_object); // 0x8a5 Func
}
...
func_1187(var_0_object)
{
	...
	func_2089(var_264_object); // 0x4a5 NEW_2
...
{
	var_22_int = 0; var_23_bool = 0; var_24_int = 0; var_25_bool = 0; // 0x8a8 PushV
	var_26_bool = var_20_int > var_21_int; // 0x8a9 GT
	if(var_26_bool == 0) goto Label_2223; // 0x8aa JumpB
	var_27_string = "GenerateMoney: iMin > iMax"; // 0x8ab PushS
	Trace(var_27_string); // 0x8ac Func
	return 4; // 0x8ae Return
	
Label_2223:
	var_24_int = 0; // 0x8af MovI
	var_28_bool = var_20_int != var_21_int; // 0x8b0 Neq
	if(var_28_bool == 0) goto Label_2230; // 0x8b1 JumpB
	var_29_int = var_21_int - var_20_int; // 0x8b2 Sub
	irand(var_24_int, var_29_int); // 0x8b3 Func
	goto Label_2234; // 0x8b5 Jump
	
Label_2234:
	var_24_int = var_24_int + var_20_int; // 0x8ba Add2
	var_30_int = 0; // 0x8bb PushI
	var_31_bool = var_24_int == var_30_int; // 0x8bc Eq
	if(var_31_bool == 0) goto Label_2239; // 0x8bd JumpB
	return 4; // 0x8be Return
	
Label_2239:
	var_32_int = 0; var_33_string = ""; // 0x8bf PushV
	var_33_string = "Money"; // 0x8c0 MovS
	func_2277(var_32_int, var_33_string); // 0x8c1 NEW_2
	var_36_int = 0; // 0x8c3 PushI
	AddItem(var_25_bool, var_32_int, var_36_int, var_24_int); // 0x8c4 Func
	return 4; // 0x8c6 Return
	
Label_2230:
	var_37_int = 0; // 0x8b6 PushI
	var_38_bool = var_20_int == var_37_int; // 0x8b7 Eq
	if(var_38_bool == 0) goto Label_2234; // 0x8b8 JumpB
...
func_2247()
{
	var_15_int = 0; var_16_bool = 0; var_17_int = 0; var_18_bool = 0; // 0x8c7 PushV
	var_19_int = 0; // 0x8c8 PushI
	ClearSubContainer(var_19_int); // 0x8c9 Func
	var_20_int = 0; var_21_int = 0; // 0x8cb PushV
	var_20_int = 300; // 0x8cc MovI
	var_21_int = 750; // 0x8cd MovI
	func_2216(var_20_int, var_21_int); // 0x8ce NEW_2
	var_39_string = ""; var_40_int = 0; var_41_int = 0; // 0x8d0 PushV
	var_39_string = "Knife"; // 0x8d1 MovS
	var_40_int = 1; // 0x8d2 MovI
	var_41_int = 8; // 0x8d3 MovI
	func_1904(var_39_string, var_40_int, var_41_int); // 0x8d4 NEW_2
	var_50_string = ""; var_51_int = 0; var_52_int = 0; // 0x8d6 PushV
	var_50_string = "lockpick"; // 0x8d7 MovS
	var_51_int = 1; // 0x8d8 MovI
	var_52_int = 6; // 0x8d9 MovI
	func_1904(var_50_string, var_51_int, var_52_int); // 0x8da NEW_2
	var_53_int = 0; var_54_string = ""; // 0x8dc PushV
	var_54_string = "grabitel_mark"; // 0x8dd MovS
	func_2277(var_53_int, var_54_string); // 0x8de NEW_2
	var_55_int = 0; // 0x8e0 PushI
	var_56_int = 1; // 0x8e1 PushI
	AddItem(var_18_bool, var_53_int, var_55_int, var_56_int); // 0x8e2 Func
...
func_1227(var_2_object, var_267_bool, var_268_object, var_269_float, var_270_float, var_271_bool, var_272_bool)
{
	...
	func_2089(var_280_object); // 0x4ce NEW_2
...
{
	var_34_int = 0; var_35_int = 0; // 0x8e5 PushV
	GetInvItemByName(var_35_int, var_33_string); // 0x8e6 Func
	var_32_int = var_35_int; // 0x8e8 Mov
...
{
	var_53_object = Obj(); // 0x8eb PushV
	var_53_object = var_52_object; // 0x8ec Mov
	TaskCall(6); // 0x8ed TaskCall
	func_1483(var_53_object); // 0x8ee NEW_2
...
{
	var_141_cvector = CVector(0,0,0); var_142_float = 0; var_143_float = 0; var_144_float = 0; var_145_float = 0; var_146_float = 0; var_147_cvector = CVector(0,0,0); var_148_float = 0; var_149_float = 0; var_150_float = 0; var_151_float = 0; var_152_float = 0; // 0x8f2 PushV
	var_147_cvector = var_139_cvector - var_138_cvector; // 0x8f3 Sub2
	var_148_float = 250000; // 0x8f4 MovI
	var_153_float = GetByIndex(var_147_cvector, 1); // 0x8f5 PushE
	var_154_int = 1000; // 0x8f6 PushI
	var_155_float = var_153_float * var_154_int; // 0x8f7 Mult
	var_156_float = var_140_float * var_140_float; // 0x8f8 Mult
	var_149_float = var_155_float - var_156_float; // 0x8f9 Sub2
	var_150_float = var_147_cvector | var_147_cvector; // 0x8fa Or2
	var_157_float = 0; var_158_float = 0; var_159_float = 0; var_160_float = 0; // 0x8fb PushV
	var_158_float = var_148_float; // 0x8fc Mov
	var_159_float = var_149_float; // 0x8fd Mov
	var_160_float = var_150_float; // 0x8fe Mov
	func_1979(var_157_float, var_158_float, var_159_float, var_160_float); // 0x8ff NEW_2
	var_151_float = var_157_float; // 0x900 Mov
	var_165_int = 0; // 0x902 PushI
	var_166_bool = var_151_float < var_165_int; // 0x903 LT
	if(var_166_bool == 0) goto Label_2311; // 0x904 JumpB
	var_152_float = 1; // 0x905 MovI
	goto Label_2319; // 0x906 Jump
	
Label_2319:
	var_167_cvector = CVector(0.0, 500.0, 0.0); // 0x90f PushVec
	var_168_float = var_167_cvector * var_152_float; // 0x910 Mult
	var_169_float = var_168_float * var_152_float; // 0x911 Mult
	var_170_int = var_147_cvector + var_169_float; // 0x912 Add
	var_137_cvector = var_170_int / var_170_int; // 0x913 Div2
	return 12; // 0x914 Return
	
Label_2311:
	var_171_float = 0; var_172_float = 0; var_173_float = 0; var_174_float = 0; var_175_float = 0; // 0x907 PushV
	var_172_float = var_148_float; // 0x908 Mov
	var_173_float = var_149_float; // 0x909 Mov
	var_174_float = var_150_float; // 0x90a Mov
	var_175_float = sqrt(var_151_float); // 0x90b Sqrt2
	func_1986(var_172_float, var_173_float, var_174_float, var_175_float); // 0x90c NEW_2
	var_152_float = sqrt(var_171_float); // 0x90e Sqrt2
}
...
func_807(var_0_object, var_518_float, var_519_int)
{
	...
	var_597_int = 0; // 0x342 PushV
	func_500(var_597_int); // 0x343 NEW_2
	ReportHit(var_0_object, var_597_int, var_525_float, var_524_float); // 0x345 Func
	var_598_object = Obj(); var_599_float = 0; // 0x347 PushV
	var_598_object = var_523_object; // 0x348 Mov
	var_599_float = var_525_float; // 0x349 Mov
	func_502(var_598_object, var_599_float); // 0x34a NEW_2
...
Label_332:
	var_682_bool = 0; var_683_object = Obj(); // 0x14c PushV
	var_683_object = var_55_object; // 0x14d Mov
	TaskCall(4); // 0x14e TaskCall
	func_466(var_682_bool, var_683_object); // 0x14f NEW_2
	TaskReturn(); // 0x150 TaskReturn
	var_54_bool = var_684_object; // 0x151 Mov
...
Label_882:
	...
	var_621_string = "all"; // 0x377 PushS
	var_622_string = "attack_middle"; // 0x378 PushS
	var_623_int = var_622_string + var_491_int; // 0x379 Add
	HasAnimation(var_492_bool, var_621_string, var_623_int); // 0x37a Func
	var_624_bool = var_492_bool; // 0x37c Push
	if(var_624_bool == 0) goto Label_963; // 0x37d JumpB
	func_2098(); // 0x37f NEW_2
	var_625_string = "all"; // 0x381 PushS
	var_626_string = "attack_middle"; // 0x382 PushS
	var_627_int = var_626_string + var_491_int; // 0x383 Add
	PlayAnimation(var_625_string, var_627_int); // 0x384 Func
	WaitForAnimEnd(); // 0x386 Func
	func_1187(var_494_string); // 0x389 NEW_2
	var_628_bool = 0; var_629_object = Obj(); // 0x38b PushV
	var_629_object = var_0_object; // 0x38c MovT
	func_1708(var_628_bool, var_629_object); // 0x38d NEW_2
	var_630_bool = var_628_bool == 0; // 0x38f Not
	if(var_630_bool == 0) goto Label_917; // 0x390 JumpB
	StopAsync(); // 0x391 Func
	var_485_bool = 0; // 0x393 MovB
	return 8; // 0x394 Return
	
Label_917:
	var_631_float = 0; var_632_int = 0; // 0x395 PushV
	var_631_float = var_486_float; // 0x396 Mov
	var_632_int = var_491_int; // 0x397 Mov
	func_807(var_494_string, var_631_float, var_632_int); // 0x398 NEW_2
	var_493_int = 1; // 0x39a MovI
	
Label_923:
	var_633_string = "attack_middle"; // 0x39b PushS
	var_634_int = var_633_string + var_491_int; // 0x39c Add
	var_635_string = "_"; // 0x39d PushS
	var_636_int = var_634_int + var_635_string; // 0x39e Add
	var_494_string = var_636_int + var_493_int; // 0x39f Add2
	var_637_string = "all"; // 0x3a0 PushS
	HasAnimation(var_492_bool, var_637_string, var_494_string); // 0x3a1 Func
	var_638_bool = var_492_bool == 0; // 0x3a3 Not
	if(var_638_bool == 0) goto Label_934; // 0x3a4 JumpB
	goto Label_963; // 0x3a5 Jump
	
Label_963:
	var_639_bool = 0; // 0x3c3 PushB
	SetAttackState(var_639_bool); // 0x3c4 Func
	var_640_string = "all"; // 0x3c6 PushS
	var_641_string = "attack_end"; // 0x3c7 PushS
	var_642_int = var_641_string + var_491_int; // 0x3c8 Add
	PlayAnimation(var_640_string, var_642_int); // 0x3c9 Func
	var_643_bool = 0; // 0x3cb PushV
	func_1197(var_643_bool); // 0x3cc NEW_2
	if(var_643_bool == 0) goto Label_981; // 0x3ce JumpB
	var_644_bool = 0; var_645_float = 0; // 0x3cf PushV
	var_645_float = 0.45; // 0x3d0 MovF
	func_985(var_644_bool, var_645_float); // 0x3d1 NEW_2
...
Label_934:
	func_2098(); // 0x3a7 NEW_2
	var_653_string = "all"; // 0x3a9 PushS
	PlayAnimation(var_653_string, var_494_string); // 0x3aa Func
	WaitForAnimEnd(); // 0x3ac Func
	func_1187(var_494_string); // 0x3af NEW_2
	var_654_bool = 0; var_655_object = Obj(); // 0x3b1 PushV
	var_655_object = var_0_object; // 0x3b2 MovT
	func_1708(var_654_bool, var_655_object); // 0x3b3 NEW_2
	var_656_bool = var_654_bool == 0; // 0x3b5 Not
	if(var_656_bool == 0) goto Label_955; // 0x3b6 JumpB
	StopAsync(); // 0x3b7 Func
	var_485_bool = 0; // 0x3b9 MovB
	return 8; // 0x3ba Return
	
Label_955:
	var_657_float = 0; var_658_int = 0; // 0x3bb PushV
	var_657_float = var_486_float; // 0x3bc Mov
	var_658_int = var_491_int; // 0x3bd Mov
	func_807(var_494_string, var_657_float, var_658_int); // 0x3be NEW_2
	var_659_int = 1; // 0x3c0 PushI
	var_493_int = var_493_int + var_659_int; // 0x3c1 Add2
...
func_340(var_0_object, var_75_bool, var_76_object, var_195_object)
{
	...
	func_2089(var_92_object); // 0x157 NEW_2
...
Label_379:
	...
	func_2290(var_137_cvector, var_138_cvector, var_139_cvector, var_140_float); // 0x19f NEW_2
...
Label_1484:
	...
	var_690_int = 1; // 0x5d2 PushI
	Sleep(var_690_int); // 0x5d3 Func
...
func_466(var_193_bool, var_194_object)
{
	...
	var_676_bool = 0; // 0x1dc PushV
	var_676_bool = 0; // 0x1dd MovB
	var_677_bool = GlobalVars[0]; // 0x1de PushGE
	if(var_677_bool == 0) goto Label_483; // 0x1df JumpB
	var_678_int = var_3_int; // 0x1e0 PushT
	if(var_678_int == 0) goto Label_483; // 0x1e1 JumpB
	var_676_bool = 1; // 0x1e2 MovB
	
Label_483:
	if(var_676_bool == 0) goto Label_490; // 0x1e3 JumpB
	var_679_string = "all"; // 0x1e4 PushS
	var_680_string = "attack_off"; // 0x1e5 PushS
	PlayAnimation(var_679_string, var_680_string); // 0x1e6 Func
	WaitForAnimEnd(); // 0x1e8 Func
	
Label_490:
	var_681_bool = GlobalVars[0]; // 0x1ea PushGE
	var_193_bool = var_681_bool; // 0x1eb Mov
...
{
	var_646_float = 0; var_647_bool = 0; var_648_float = 0; var_649_bool = 0; // 0x3d9 PushV
	rand(var_648_float); // 0x3da Func
	var_650_bool = var_648_float < var_645_float; // 0x3dc LT
	if(var_650_bool == 0) goto Label_1005; // 0x3dd JumpB
	
Label_990:
	IsAnimationPlaying(var_649_bool); // 0x3de Func
	var_651_bool = var_649_bool == 0; // 0x3e0 Not
	if(var_651_bool == 0) goto Label_995; // 0x3e1 JumpB
...
Label_1010:
	var_644_bool = 0; // 0x3f2 MovB
	return 4; // 0x3f3 Return
	
Label_995:
	var_652_bool = 0; // 0x3e3 PushV
	func_1083(var_652_bool); // 0x3e4 NEW_2
	if(var_652_bool == 0) goto Label_1001; // 0x3e6 JumpB
	var_644_bool = 1; // 0x3e7 MovB
...
Label_1005:
	...
	func_1187(var_649_bool); // 0x3f0 NEW_2
}
...
Label_2048:
	...
	func_2079(var_68_float); // 0x802 NEW_2
...
{
	var_600_bool = 0; // 0x1f7 PushV
	var_600_bool = 0; // 0x1f8 MovB
	var_601_int = 0; // 0x1f9 PushI
	var_602_bool = var_599_float > var_601_int; // 0x1fa GT
	if(var_602_bool == 0) goto Label_514; // 0x1fb JumpB
	var_603_bool = 0; var_604_object = Obj(); // 0x1fc PushV
	var_604_object = var_598_object; // 0x1fd Mov
	func_1636(var_603_bool, var_604_object); // 0x1fe NEW_2
	if(var_603_bool == 0) goto Label_514; // 0x200 JumpB
	var_600_bool = 1; // 0x201 MovB
	
Label_514:
	if(var_600_bool == 0) goto Label_521; // 0x202 JumpB
	var_620_bool = GlobalVars[0]; // 0x203 PushGE
	var_620_bool = 1; // 0x204 MovB
	GlobalVars[0] = var_620_bool; // 0x205 PopGE
	func_983(var_599_float); // 0x207 NEW_2
