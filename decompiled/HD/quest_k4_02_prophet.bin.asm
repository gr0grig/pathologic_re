...
0x38e: Push("Can't retrieve diary root")
0x38f: @ Trace(Stack[-1])
0x390: Pop(1)
...
0x39a: Pop(1)
0x39b: @@ Find(Stack[-7], Stack[-2])
0x39c: Pop(0)
0x39d: Pop(0); Push((bool) Stack[-2] == 0)
0x39e: IF (Stack[-1] == 0) GOTO 0x3a5; Pop(1)

0x39f: Push("Can't find diary parent with id: ")
...
0x3a5: @@ AddChild(Stack[-8])
0x3a6: Pop(0)
0x3a7: Push((int) 7)
0x3a8: @ SendWorldWndMessage(Stack[-1])
0x3a9: Pop(1)
0x3aa: @@ GetCategory(Stack[-1])
0x3ab: Pop(0)
...
0x3c7: Stack[-1] = "ui/NPC_Prophet.png"
0x3c8: Return(); Pop(0)

0x3c9: Stack[-1] = "ui/NPC_Prophet_b.png"
0x3ca: Return(); Pop(0)
