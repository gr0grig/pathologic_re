...
0x3d9: @@ HasProperty(Stack[-1], Stack[-4])
0x3da: Pop(1)
...
0x3ee: @@ GetProperty(Stack[-1], Stack[-2])
0x3ef: Pop(1)
0x3f0: PushEmpty(bool, string)
0x3f1: Stack[-1] = Stack[-3]
0x3f2: Call2 0x415

0x3f3: Stack[-14] = Stack[-2]
0x3f4: Pop(2)
0x3f5: Return(); Pop(10)
...
0x410: Push("Can't find lsh animation : ")
...
0x47b: Stack[-1] = "ook4BurahIndoor1"
0x47c: Call2 0x43b
...
0x4a4: Push("Can't retrieve diary root")
0x4a5: @ Trace(Stack[-1])
0x4a6: Pop(1)
...
0x4af: Stack[-4] = Stack[-1]
0x4b0: Pop(1)
0x4b1: @@ Find(Stack[-7], Stack[-2])
0x4b2: Pop(0)
0x4b3: Pop(0); Push((bool) Stack[-2] == 0)
0x4b4: IF (Stack[-1] == 0) GOTO 0x4bb; Pop(1)

0x4b5: Push("Can't find diary parent with id: ")
...
0x4bb: @@ AddChild(Stack[-8])
0x4bc: Pop(0)
0x4bd: Push((int) 7)
0x4be: @ SendWorldWndMessage(Stack[-1])
0x4bf: Pop(1)
0x4c0: @@ GetCategory(Stack[-1])
0x4c1: Pop(0)
...
0x4dd: Stack[-1] = "ui/NPC_Burah.png"
0x4de: Return(); Pop(0)

0x4df: Stack[-1] = "ui/NPC_Burah_b.png"
0x4e0: Return(); Pop(0)
