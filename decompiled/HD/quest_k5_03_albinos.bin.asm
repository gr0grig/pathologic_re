...
0x5dc: Push("Can't find lsh animation : ")
...
0x5eb: Push("Can't find lsh animation : ")
...
0x66f: Stack[-5] = Stack[-8]
0x670: Stack[-4] = "reputation"
0x671: Stack[-3] = Stack[-7]
0x672: Stack[-2] = (int) 0
0x673: Stack[-1] = (int) 1
0x674: Call2 0x498
...
0x695: Pop(0)
0x696: Pop(0); Push((bool) Stack[-1] == 0)
...
0x6a3: Stack[-1] = "ui/NPC_Albinos.png"
0x6a4: Return(); Pop(0)

0x6a5: Stack[-1] = "ui/NPC_Albinos_b.png"
0x6a6: Return(); Pop(0)
...
0x6c6: Stack[-2] = "quest_k5_03"
0x6c7: Stack[-1] = "completed"
0x6c8: Call2 0x693
...
0x6dd: Push("Can't retrieve diary root")
0x6de: @ Trace(Stack[-1])
0x6df: Pop(1)
...
0x6e8: Stack[-4] = Stack[-1]
0x6e9: Pop(1)
0x6ea: @@ Find(Stack[-7], Stack[-2])
0x6eb: Pop(0)
0x6ec: Pop(0); Push((bool) Stack[-2] == 0)
0x6ed: IF (Stack[-1] == 0) GOTO 0x6f4; Pop(1)

0x6ee: Push("Can't find diary parent with id: ")
...
0x6f4: @@ AddChild(Stack[-8])
0x6f5: Pop(0)
0x6f6: Push((int) 7)
0x6f7: @ SendWorldWndMessage(Stack[-1])
0x6f8: Pop(1)
0x6f9: @@ GetCategory(Stack[-1])
0x6fa: Pop(0)
...
0x720: Stack[-3] = Stack[-6]
0x721: Stack[-2] = (float) 0.05
0x722: Stack[-1] = (int) 0
0x723: Call2 0x4ae

0x724: Stack[-5] = Stack[-4]
0x725: Pop(4)
0x726: Push((int) 6)
0x727: Push((float)0.05)
...
0x73e: Stack[-5] = Stack[-11]
0x73f: Stack[-4] = Stack[-10]
0x740: Stack[-3] = Stack[-9]
0x741: Stack[-2] = Stack[-7]
...
0x75a: Stack[-2] = Stack[-4]
0x75b: Stack[-1] = (float) -0.1
0x75c: Call2 0x655

0x75d: Pop(3)
0x75e: PushEmpty(object)
0x75f: Stack[-1] = Stack[-2]
0x760: Call2 0x72c
