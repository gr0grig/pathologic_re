...
0x43c: Stack[-5] = Stack[-8]
0x43d: Stack[-4] = "reputation"
0x43e: Stack[-3] = Stack[-7]
0x43f: Stack[-2] = (int) 0
0x440: Stack[-1] = (int) 1
0x441: Call2 0x2be
...
0x47a: Stack[-5] = Stack[-2]
0x47b: Return(); Pop(4)

0x47c: PushEmpty()
0x47d: Push("ook6Danko1")
0x47e: Push((int) 1)
...
0x484: Stack[-2] = "quest_k6_01"
0x485: Stack[-1] = "teleport"
0x486: Call2 0x44f
...
0x48e: Stack[-2] = "quest_k6_01"
0x48f: Stack[-1] = "completed"
0x490: Call2 0x44f
...
0x495: Stack[-2] = Stack[-5]
0x496: Stack[-1] = (float) 0.3
0x497: Call2 0x422
...
0x4b8: Push("Can't retrieve diary root")
0x4b9: @ Trace(Stack[-1])
0x4ba: Pop(1)
...
0x4c3: Stack[-4] = Stack[-1]
0x4c4: Pop(1)
0x4c5: @@ Find(Stack[-7], Stack[-2])
0x4c6: Pop(0)
0x4c7: Pop(0); Push((bool) Stack[-2] == 0)
0x4c8: IF (Stack[-1] == 0) GOTO 0x4cf; Pop(1)

0x4c9: Push("Can't find diary parent with id: ")
...
0x4cf: @@ AddChild(Stack[-8])
0x4d0: Pop(0)
0x4d1: Push((int) 7)
0x4d2: @ SendWorldWndMessage(Stack[-1])
0x4d3: Pop(1)
0x4d4: @@ GetCategory(Stack[-1])
0x4d5: Pop(0)
...
0x4f1: Stack[-1] = "ui/NPC_Bakalavr.png"
0x4f2: Return(); Pop(0)

0x4f3: Stack[-1] = "ui/NPC_Bakalavr_b.png"
0x4f4: Return(); Pop(0)
