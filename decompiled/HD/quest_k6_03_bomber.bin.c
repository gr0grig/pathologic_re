task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_cvector, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_61(); // 0x13 NEW_2
	var_56_object = Obj(); // 0x15 PushV
	var_56_object = var_11_object; // 0x16 Mov
	func_1910(var_56_object); // 0x17 NEW_2
...
task_0_event_3(var_0_bool, var_1_bool, var_2_object, var_3_cvector, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_61(); // 0x21 NEW_2
	var_56_object = Obj(); // 0x23 PushV
	var_56_object = var_11_object; // 0x24 Mov
	func_1895(var_56_object); // 0x25 NEW_2
...
task_2_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	var_56_object = Obj(); // 0x16d PushV
	var_56_object = var_11_object; // 0x16e Mov
	func_1910(var_56_object); // 0x16f NEW_2
...
task_2_event_7(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_int, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	var_57_bool = var_14_bool == 0; // 0x1e9 Not
	if(var_57_bool == 0) goto Label_494; // 0x1ea JumpB
	Stop(); // 0x1eb Func
...
Label_501:
	...
	var_57_bool = var_14_bool == 0; // 0x1fb Not
	if(var_57_bool == 0) goto Label_514; // 0x1fc JumpB
...
Label_522:
	...
	var_59_string = "new hunt point"; // 0x20c PushS
	Trace(var_59_string); // 0x20d Func
	Stop(); // 0x20f Func
	return 0; // 0x211 Return
	
Label_515:
	var_60_bool = 0; var_61_object = Obj(); var_62_object = Obj(); // 0x203 PushV
	var_61_object = var_11_object; // 0x204 Mov
	var_62_object = var_1_bool; // 0x205 MovT
	func_391(var_60_bool, var_61_object, var_62_object); // 0x206 NEW_2
	if(var_60_bool == 0) goto Label_522; // 0x208 JumpB
...
task_3_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	var_55_object = Obj(); // 0x22d PushV
	var_55_object = var_11_object; // 0x22e Mov
	func_1910(var_55_object); // 0x22f NEW_2
...
task_3_event_3(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	var_55_object = Obj(); // 0x23b PushV
	var_55_object = var_11_object; // 0x23c Mov
	func_1895(var_55_object); // 0x23d NEW_2
...
task_6_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_55_object = Obj(); // 0x3ee PushV
	var_55_object = var_11_object; // 0x3ef Mov
	func_1910(var_55_object); // 0x3f0 NEW_2
...
Label_1017:
	...
	func_2029(var_15_bool, var_16_object); // 0x3fb NEW_2
	var_56_bool = var_15_bool == 0; // 0x3fd Not
	if(var_56_bool == 0) goto Label_1024; // 0x3fe JumpB
	return 2; // 0x3ff Return
	
Label_1024:
	IsPlayerActor(var_11_object, var_13_bool); // 0x400 Func
	var_57_bool = var_13_bool; // 0x402 Push
	if(var_57_bool == 0) goto Label_1033; // 0x403 JumpB
...
task_7_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_56_object = Obj(); // 0x442 PushV
	var_56_object = var_11_object; // 0x443 Mov
	func_1910(var_56_object); // 0x444 NEW_2
...
task_7_event_3(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_56_object = Obj(); // 0x450 PushV
	var_56_object = var_11_object; // 0x451 Mov
	func_1895(var_56_object); // 0x452 NEW_2
...
func_1547(var_16_object)
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x60b PushV
	self(var_18_object); // 0x60c Func
	var_16_object = var_18_object; // 0x60e Mov
...
func_1563(var_52_float, var_53_float, var_54_float, var_55_float)
{
	var_56_bool = var_53_float < var_54_float; // 0x61c LT
	if(var_56_bool == 0) goto Label_1568; // 0x61d JumpB
	var_52_float = var_54_float; // 0x61e Mov
	return 0; // 0x61f Return
	
Label_1568:
	var_57_bool = var_53_float > var_55_float; // 0x620 GT
	if(var_57_bool == 0) goto Label_1572; // 0x621 JumpB
	var_52_float = var_55_float; // 0x622 Mov
	return 0; // 0x623 Return
	
Label_1572:
	var_52_float = var_53_float; // 0x624 Mov
	return 0; // 0x625 Return
}


func_1055(var_0_bool, var_90_int)
{
	SetSeeThreshold(var_0_bool); // 0x41f Func
	SetSeeFOV(var_90_int); // 0x421 Func
	Stop(); // 0x423 Func
...
func_1574(var_94_bool, var_95_int, var_96_int)
{
	var_97_int = 0; var_98_int = 0; // 0x626 PushV
	irand(var_98_int, var_96_int); // 0x627 Func
	var_94_bool = var_98_int < var_95_int; // 0x629 LT2
	return 2; // 0x62a Return
}


func_1579(var_23_bool, var_24_object, var_25_float)
{
	var_26_bool = var_24_object == 0; // 0x62c Not
	if(var_26_bool == 0) goto Label_1584; // 0x62d JumpB
	var_23_bool = 0; // 0x62e MovB
	return 0; // 0x62f Return
	
Label_1584:
	var_27_int = 0; // 0x630 PushI
	var_28_bool = var_25_float > var_27_int; // 0x631 GT
	if(var_28_bool == 0) goto Label_1591; // 0x632 JumpB
	var_29_int = 8; // 0x633 PushI
	SendWorldWndMessage(var_29_int); // 0x634 Func
	goto Label_1600; // 0x636 Jump
	
Label_1600:
	var_30_float = 0; // 0x640 PushV
	var_30_float = var_25_float; // 0x641 Mov
	func_1614(var_30_float); // 0x642 NEW_2
	var_34_bool = 0; var_35_object = Obj(); var_36_string = ""; var_37_float = 0; var_38_float = 0; var_39_float = 0; // 0x644 PushV
	var_35_object = var_24_object; // 0x645 Mov
	var_36_string = "reputation"; // 0x646 MovS
	var_37_float = var_25_float; // 0x647 Mov
	var_38_float = 0; // 0x648 MovI
	var_39_float = 1; // 0x649 MovI
	func_1232(var_34_bool, var_35_object, var_36_string, var_37_float, var_38_float, var_39_float); // 0x64a NEW_2
	var_23_bool = 1; // 0x64c MovB
	return 0; // 0x64d Return
	
Label_1591:
	var_58_int = 0; // 0x637 PushI
	var_59_bool = var_25_float < var_58_int; // 0x638 LT
	if(var_59_bool == 0) goto Label_1598; // 0x639 JumpB
	var_60_int = 9; // 0x63a PushI
	SendWorldWndMessage(var_60_int); // 0x63b Func
	goto Label_1600; // 0x63d Jump
	
Label_1598:
	var_23_bool = 0; // 0x63e MovB
...
func_1614(var_30_float)
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x64e PushV
	CreateFloatVector(var_32_object); // 0x64f Func
	add(var_30_float); // 0x651 ObjFunc
	var_33_int = 16; // 0x653 PushI
	SendWorldWndMessage(var_33_int, var_32_object); // 0x654 Func
...
func_1657(var_121_int)
{
	var_122_int = 0; var_123_int = 0; // 0x679 PushV
	var_124_string = "branch"; // 0x67a PushS
	GetVariable(var_124_string, var_123_int); // 0x67b Func
	var_121_int = var_123_int; // 0x67d Mov
...
func_1676(var_70_int, var_71_int)
{
	var_72_int = 0; var_73_bool = 0; var_74_int = 0; var_75_bool = 0; // 0x68c PushV
	var_76_bool = var_70_int > var_71_int; // 0x68d GT
	if(var_76_bool == 0) goto Label_1683; // 0x68e JumpB
	var_77_string = "GenerateMoney: iMin > iMax"; // 0x68f PushS
	Trace(var_77_string); // 0x690 Func
	return 4; // 0x692 Return
	
Label_1683:
	var_74_int = 0; // 0x693 MovI
	var_78_bool = var_70_int != var_71_int; // 0x694 Neq
	if(var_78_bool == 0) goto Label_1690; // 0x695 JumpB
	var_79_int = var_71_int - var_70_int; // 0x696 Sub
	irand(var_74_int, var_79_int); // 0x697 Func
	goto Label_1694; // 0x699 Jump
	
Label_1694:
	var_74_int = var_74_int + var_70_int; // 0x69e Add2
	var_80_int = 0; // 0x69f PushI
	var_81_bool = var_74_int == var_80_int; // 0x6a0 Eq
	if(var_81_bool == 0) goto Label_1699; // 0x6a1 JumpB
	return 4; // 0x6a2 Return
	
Label_1699:
	var_82_int = 0; var_83_string = ""; // 0x6a3 PushV
	var_83_string = "Money"; // 0x6a4 MovS
	func_1785(var_82_int, var_83_string); // 0x6a5 NEW_2
	var_86_int = 0; // 0x6a7 PushI
	AddItem(var_75_bool, var_82_int, var_86_int, var_74_int); // 0x6a8 Func
	return 4; // 0x6aa Return
	
Label_1690:
	var_87_int = 0; // 0x69a PushI
	var_88_bool = var_70_int == var_87_int; // 0x69b Eq
	if(var_88_bool == 0) goto Label_1694; // 0x69c JumpB
...
func_1707(var_127_string)
{
	var_128_object = Obj(); var_129_int = 0; var_130_bool = 0; var_131_object = Obj(); var_132_int = 0; var_133_bool = 0; // 0x6ab PushV
	CreateInvItem(var_131_object); // 0x6ac Func
	SetItemName(var_127_string); // 0x6ae ObjFunc
	var_134_string = "Organ"; // 0x6b0 PushS
	var_135_int = 1; // 0x6b1 PushI
	SetProperty(var_134_string, var_135_int); // 0x6b2 ObjFunc
	GetItemID(var_132_int); // 0x6b4 ObjFunc
	var_136_int = 0; // 0x6b6 PushI
	var_137_int = 1; // 0x6b7 PushI
	AddItem(var_133_bool, var_131_object, var_136_int, var_137_int); // 0x6b8 Func
...
{
	var_62_bool = 0; var_63_bool = 0; // 0xb9 PushV
	IsPlayerActor(var_61_object, var_63_bool); // 0xba Func
	var_64_bool = var_63_bool; // 0xbc Push
	if(var_64_bool == 0) goto Label_193; // 0xbd JumpB
	func_1748(); // 0xbf NEW_2
	
Label_193:
	func_1724(); // 0xc2 NEW_2
	var_141_object = Obj(); // 0xc4 PushV
	var_141_object = var_61_object; // 0xc5 Mov
	func_201(var_141_object); // 0xc6 NEW_2
...
func_1724()
{
	var_121_int = 0; // 0x6bc PushV
	func_1657(var_121_int); // 0x6bd NEW_2
	var_125_int = 1; // 0x6bf PushI
	var_126_bool = var_121_int != var_125_int; // 0x6c0 Neq
	if(var_126_bool == 0) goto Label_1731; // 0x6c1 JumpB
	return 0; // 0x6c2 Return
	
Label_1731:
	var_127_string = ""; // 0x6c3 PushV
	var_127_string = "liver"; // 0x6c4 MovS
	func_1707(var_127_string); // 0x6c5 NEW_2
	var_138_string = ""; // 0x6c7 PushV
	var_138_string = "kidney"; // 0x6c8 MovS
	func_1707(var_138_string); // 0x6c9 NEW_2
	var_139_string = ""; // 0x6cb PushV
	var_139_string = "heart"; // 0x6cc MovS
	func_1707(var_139_string); // 0x6cd NEW_2
	var_140_string = ""; // 0x6cf PushV
	var_140_string = "blood"; // 0x6d0 MovS
	func_1707(var_140_string); // 0x6d1 NEW_2
	return 0; // 0x6d3 Return
}


func_1215(var_19_bool, var_20_object)
{
	var_21_bool = 0; var_22_bool = 0; // 0x4bf PushV
	IsPlayerActor(var_20_object, var_22_bool); // 0x4c0 Func
	var_19_bool = var_22_bool; // 0x4c2 Mov
	return 2; // 0x4c3 Return
}


func_1220(var_42_bool, var_43_object, var_44_string)
{
	var_45_bool = 0; var_46_bool = 0; // 0x4c4 PushV
	var_47_string = "HasProperty"; // 0x4c5 PushS
	var_48_int = 2; // 0x4c6 PushI
	var_49_bool = IsFuncExist(var_43_object, var_47_string, var_48_int); // 0x4c7 FuncExist
	var_50_bool = var_49_bool == 0; // 0x4c8 Not
	if(var_50_bool == 0) goto Label_1228; // 0x4c9 JumpB
	var_42_bool = 0; // 0x4ca MovB
	return 2; // 0x4cb Return
	
Label_1228:
	HasProperty(var_44_string, var_46_bool); // 0x4cc ObjFunc
	var_42_bool = var_46_bool; // 0x4ce Mov
...
func_201(var_141_object)
{
	...
	var_142_object = Obj(); // 0xcb PushV
	var_142_object = var_141_object; // 0xcc Mov
	func_226(var_142_object); // 0xcd NEW_2
	var_222_int = 50; // 0xcf PushI
	var_223_int = 40; // 0xd0 PushI
	SetRTEnvelope(var_222_int, var_223_int); // 0xd1 Func
...
func_1232(var_34_bool, var_35_object, var_36_string, var_37_float, var_38_float, var_39_float)
{
	var_40_float = 0; var_41_float = 0; // 0x4d0 PushV
	var_42_bool = 0; var_43_object = Obj(); var_44_string = ""; // 0x4d1 PushV
	var_43_object = var_35_object; // 0x4d2 Mov
	var_44_string = var_36_string; // 0x4d3 Mov
	func_1220(var_42_bool, var_43_object, var_44_string); // 0x4d4 NEW_2
	var_51_bool = var_42_bool == 0; // 0x4d6 Not
	if(var_51_bool == 0) goto Label_1242; // 0x4d7 JumpB
	var_34_bool = 0; // 0x4d8 MovB
	return 2; // 0x4d9 Return
	
Label_1242:
	GetProperty(var_36_string, var_41_float); // 0x4da ObjFunc
	var_52_float = 0; var_53_float = 0; var_54_float = 0; var_55_float = 0; // 0x4dc PushV
	var_53_float = var_41_float + var_37_float; // 0x4dd Add2
	var_54_float = var_38_float; // 0x4de Mov
	var_55_float = var_39_float; // 0x4df Mov
	func_1563(var_52_float, var_53_float, var_54_float, var_55_float); // 0x4e0 NEW_2
	SetProperty(var_36_string, var_52_float); // 0x4e2 ObjFunc
	var_34_bool = 1; // 0x4e4 MovB
...
func_1748()
{
	var_65_int = 0; var_66_bool = 0; var_67_int = 0; var_68_bool = 0; // 0x6d4 PushV
	var_69_int = 0; // 0x6d5 PushI
	ClearSubContainer(var_69_int); // 0x6d6 Func
	var_70_int = 0; var_71_int = 0; // 0x6d8 PushV
	var_70_int = 600; // 0x6d9 MovI
	var_71_int = 1500; // 0x6da MovI
	func_1676(var_70_int, var_71_int); // 0x6db NEW_2
	var_89_string = ""; var_90_int = 0; var_91_int = 0; // 0x6dd PushV
	var_89_string = "fresh_meat"; // 0x6de MovS
	var_90_int = 1; // 0x6df MovI
	var_91_int = 6; // 0x6e0 MovI
	func_1480(var_89_string, var_90_int, var_91_int); // 0x6e1 NEW_2
	var_100_string = ""; var_101_int = 0; var_102_int = 0; var_103_int = 0; // 0x6e3 PushV
	var_100_string = "rusk"; // 0x6e4 MovS
	var_101_int = 1; // 0x6e5 MovI
	var_102_int = 6; // 0x6e6 MovI
	var_103_int = 2; // 0x6e7 MovI
	func_1491(var_100_string, var_101_int, var_102_int, var_103_int); // 0x6e8 NEW_2
	var_114_string = ""; var_115_int = 0; var_116_int = 0; // 0x6ea PushV
	var_114_string = "gamma_pills"; // 0x6eb MovS
	var_115_int = 1; // 0x6ec MovI
	var_116_int = 3; // 0x6ed MovI
	func_1480(var_114_string, var_115_int, var_116_int); // 0x6ee NEW_2
	var_117_int = 0; var_118_string = ""; // 0x6f0 PushV
	var_118_string = "bomber_mark"; // 0x6f1 MovS
	func_1785(var_117_int, var_118_string); // 0x6f2 NEW_2
	var_119_int = 0; // 0x6f4 PushI
	var_120_int = 1; // 0x6f5 PushI
	AddItem(var_68_bool, var_117_int, var_119_int, var_120_int); // 0x6f6 Func
...
{
	var_143_cvector = CVector(0,0,0); var_144_cvector = CVector(0,0,0); var_145_cvector = CVector(0,0,0); var_146_cvector = CVector(0,0,0); var_147_string = ""; var_148_object = Obj(); var_149_bool = 0; var_150_bool = 0; var_151_float = 0; var_152_cvector = CVector(0,0,0); var_153_cvector = CVector(0,0,0); var_154_cvector = CVector(0,0,0); var_155_cvector = CVector(0,0,0); var_156_cvector = CVector(0,0,0); var_157_string = ""; var_158_object = Obj(); var_159_bool = 0; var_160_bool = 0; var_161_float = 0; var_162_cvector = CVector(0,0,0); // 0xe2 PushV
	var_163_bool = var_142_object == 0; // 0xe3 NullEq
	if(var_163_bool == 0) goto Label_234; // 0xe4 JumpB
	var_164_string = ""; // 0xe5 PushV
	var_164_string = "fdie"; // 0xe6 MovS
	func_317(var_164_string); // 0xe7 NEW_2
...
Label_234:
	GetPosition(var_153_cvector); // 0xea ObjFunc
	GetPosition(var_154_cvector); // 0xec Func
	GetDirection(var_155_cvector); // 0xee Func
	var_156_cvector = var_154_cvector - var_153_cvector; // 0xf0 Sub2
	var_196_float = GetByIndex(var_156_cvector, 0); // 0xf1 PushE
	var_197_float = GetByIndex(var_155_cvector, 0); // 0xf2 PushE
	var_198_float = var_196_float * var_197_float; // 0xf3 Mult
	var_199_float = GetByIndex(var_156_cvector, 2); // 0xf4 PushE
	var_200_float = GetByIndex(var_155_cvector, 2); // 0xf5 PushE
	var_201_float = var_199_float * var_200_float; // 0xf6 Mult
	var_202_int = var_198_float + var_201_float; // 0xf7 Add
	var_203_int = 0; // 0xf8 PushI
	var_204_bool = var_202_int >= var_203_int; // 0xf9 GE
	if(var_204_bool == 0) goto Label_253; // 0xfa JumpB
	var_157_string = "fdie"; // 0xfb MovS
...
Label_254:
	...
	var_158_object = var_142_object; // 0x106 Mov
	var_205_string = "GetScriptProperty"; // 0x107 PushS
	var_206_int = 2; // 0x108 PushI
	var_207_bool = IsFuncExist(var_142_object, var_205_string, var_206_int); // 0x109 FuncExist
	if(var_207_bool == 0) goto Label_278; // 0x10a JumpB
	var_208_string = "Owner"; // 0x10b PushS
	HasScriptProperty(var_159_bool, var_208_string); // 0x10c ObjFunc
	var_209_bool = var_159_bool; // 0x10e Push
	if(var_209_bool == 0) goto Label_278; // 0x10f JumpB
	var_210_string = "Owner"; // 0x110 PushS
	GetScriptProperty(var_158_object, var_210_string); // 0x111 ObjFunc
	var_211_bool = var_158_object == 0; // 0x113 NullEq
	if(var_211_bool == 0) goto Label_278; // 0x114 JumpB
	var_158_object = var_142_object; // 0x115 Mov
	
Label_278:
	var_212_string = "@GetEyesHeight"; // 0x116 PushS
	var_213_int = 1; // 0x117 PushI
	var_214_bool = IsFuncExist(var_158_object, var_212_string, var_213_int); // 0x118 FuncExist
	if(var_214_bool == 0) goto Label_293; // 0x119 JumpB
	GetEyesHeight(var_161_float); // 0x11a ObjFunc
	var_162_cvector = CVector(0.0, 0.0, 0.0); // 0x11c MovV
	var_215_float = GetByIndex(var_162_cvector, 1); // 0x11d PushE
	var_215_float = var_161_float; // 0x11e Mov
	SetByIndex(var_162_cvector, 1) = var_215_float; // 0x11f PopE
	var_216_string = "head"; // 0x120 PushS
	LookAsync(var_142_object, var_216_string, var_162_cvector); // 0x121 Func
	var_160_bool = 1; // 0x123 MovB
	goto Label_294; // 0x124 Jump
	
Label_294:
	var_217_string = ""; // 0x126 PushV
	var_217_string = var_157_string; // 0x127 Mov
	func_1506(var_217_string); // 0x128 NEW_2
	var_218_string = "all"; // 0x12a PushS
	PlayAnimation(var_218_string, var_157_string); // 0x12b Func
	WaitForAnimEnd(); // 0x12d Func
	var_219_bool = var_160_bool; // 0x12f Push
	if(var_219_bool == 0) goto Label_310; // 0x130 JumpB
	StopAsync(); // 0x131 Func
	var_220_string = "head"; // 0x133 PushS
	UnlookAsync(var_220_string); // 0x134 Func
	
Label_310:
	var_221_string = "all"; // 0x136 PushS
	LockAnimationEnd(var_221_string, var_157_string); // 0x137 Func
	RemoveEnvelope(); // 0x139 Func
	var_158_object = 0; // 0x13b SetNull
	
Label_293:
	var_160_bool = 0; // 0x125 MovB
	
Label_253:
	var_157_string = "bdie"; // 0xfd MovS
}
...
func_1785(var_82_int, var_83_string)
{
	var_84_int = 0; var_85_int = 0; // 0x6f9 PushV
	GetInvItemByName(var_85_int, var_83_string); // 0x6fa Func
	var_82_int = var_85_int; // 0x6fc Mov
...
func_317(var_164_string)
{
	...
	var_165_string = ""; // 0x148 PushV
	var_165_string = var_164_string; // 0x149 Mov
	func_1506(var_165_string); // 0x14a NEW_2
	var_194_string = "all"; // 0x14c PushS
	PlayAnimation(var_194_string, var_164_string); // 0x14d Func
	WaitForAnimEnd(); // 0x14f Func
	var_195_string = "all"; // 0x151 PushS
	LockAnimationEnd(var_195_string, var_164_string); // 0x152 Func
...
{
	var_61_object = Obj(); var_62_bool = 0; // 0x15e PushV
	var_61_object = var_57_object; // 0x15f Mov
	var_62_bool = 0; // 0x160 MovB
	func_417(var_58_cvector, var_59_object, var_60_object, var_57_object, var_61_object, var_62_bool); // 0x161 NEW_2
...
func_1888(var_12_bool, var_13_object)
{
	...
	func_2029(var_14_bool, var_15_object); // 0x763 NEW_2
...
func_1895(var_56_object)
{
	var_57_object = Obj(); // 0x768 PushV
	var_57_object = var_56_object; // 0x769 Mov
	TaskCall(2); // 0x76a TaskCall
	func_349(var_57_object); // 0x76b NEW_2
...
func_1903(var_12_bool, var_13_object)
{
	...
	func_2029(var_14_bool, var_15_object); // 0x772 NEW_2
	var_12_bool = var_14_bool; // 0x773 Mov
	return 0; // 0x775 Return
}


func_1910(var_56_object)
{
	var_57_object = Obj(); // 0x777 PushV
	var_57_object = var_56_object; // 0x778 Mov
	TaskCall(4); // 0x779 TaskCall
	func_683(var_56_object, var_58_object, var_59_bool, var_57_object); // 0x77a NEW_2
...
func_391(var_60_bool, var_61_object, var_62_object)
{
	var_63_bool = 0; var_64_bool = 0; // 0x187 PushV
	IsPlayerActor(var_61_object, var_64_bool); // 0x188 Func
	var_65_bool = var_64_bool; // 0x18a Push
	if(var_65_bool == 0) goto Label_398; // 0x18b JumpB
	var_60_bool = 0; // 0x18c MovB
	return 2; // 0x18d Return
	
Label_398:
	var_66_bool = 0; var_67_object = Obj(); // 0x18e PushV
	var_67_object = var_62_object; // 0x18f Mov
	func_2029(var_66_bool, var_67_object); // 0x190 NEW_2
	var_68_bool = var_66_bool == 0; // 0x192 Not
	if(var_68_bool == 0) goto Label_406; // 0x193 JumpB
	var_60_bool = 0; // 0x194 MovB
	return 2; // 0x195 Return
	
Label_406:
	IsPlayerActor(var_62_object, var_64_bool); // 0x196 Func
	var_60_bool = var_64_bool; // 0x198 Mov
...
func_410(var_14_bool, var_15_object)
{
	...
	func_2029(var_16_bool, var_17_object); // 0x19d NEW_2
...
func_927(var_0_bool, var_50_object)
{
	...
	func_2029(var_53_bool, var_54_object); // 0x3a6 NEW_2
...
func_1952(var_12_object)
{
	...
	func_2046(); // 0x7a3 NEW_2
	var_19_bool = 0; var_20_object = Obj(); // 0x7a5 PushV
	var_20_object = var_12_object; // 0x7a6 Mov
	func_1215(var_19_bool, var_20_object); // 0x7a7 NEW_2
	if(var_19_bool == 0) goto Label_1967; // 0x7a9 JumpB
	var_23_bool = 0; var_24_object = Obj(); var_25_float = 0; // 0x7aa PushV
	var_24_object = var_12_object; // 0x7ab Mov
	var_25_float = 0.05; // 0x7ac MovF
	func_1579(var_23_bool, var_24_object, var_25_float); // 0x7ad NEW_2
	
Label_1967:
	var_61_object = Obj(); // 0x7af PushV
	var_61_object = var_12_object; // 0x7b0 Mov
	TaskCall(1); // 0x7b1 TaskCall
	func_185(var_61_object); // 0x7b2 NEW_2
	TaskReturn(); // 0x7b3 TaskReturn
	return 0; // 0x7b5 Return
}


func_417(var_0_bool, var_1_bool, var_2_cvector, var_61_object, var_62_bool, var_84_float)
{
	var_63_bool = 0; var_64_bool = 0; // 0x1a1 PushV
	var_65_bool = 0; var_66_object = Obj(); // 0x1a2 PushV
	var_66_object = var_1_bool; // 0x1a3 MovT
	func_1295(var_65_bool, var_66_object); // 0x1a4 NEW_2
	var_67_bool = var_65_bool == 0; // 0x1a6 Not
	if(var_67_bool == 0) goto Label_425; // 0x1a7 JumpB
	return 2; // 0x1a8 Return
	
Label_425:
	var_1_bool = var_61_object; // 0x1a9 TMov
	var_68_object = Obj(); // 0x1aa PushV
	var_68_object = var_1_bool; // 0x1ab MovT
	func_1624(var_68_object); // 0x1ac NEW_2
	GetPFPosition(var_0_bool); // 0x1ae TObjFunc
	var_73_int = 61; // 0x1b0 PushI
	var_74_float = 0.5; // 0x1b1 PushF
	SetTimer(var_73_int, var_74_float); // 0x1b2 Func
	
Label_436:
	FindPathTo(var_63_bool, var_0_bool); // 0x1b4 Func
	var_75_bool = var_2_cvector == 0; // 0x1b6 NullEq
	if(var_75_bool == 0) goto Label_444; // 0x1b7 JumpB
	var_76_string = "Can't find path to noise source"; // 0x1b8 PushS
	Trace(var_76_string); // 0x1b9 Func
	goto Label_477; // 0x1bb Jump
	
Label_477:
	var_77_int = 61; // 0x1dd PushI
	KillTimer(var_77_int); // 0x1de Func
	return 2; // 0x1e0 Return
	
Label_444:
	FollowPath(var_63_bool, var_62_bool, var_64_bool); // 0x1bc Func
	var_78_bool = var_64_bool == 0; // 0x1be Not
	if(var_78_bool == 0) goto Label_452; // 0x1bf JumpB
	var_79_bool = var_2_cvector == 0; // 0x1c0 NullEq
	if(var_79_bool == 0) goto Label_451; // 0x1c1 JumpB
...
Label_475:
	var_80_bool = var_2_cvector != 0; // 0x1db NullNeq
	if(var_80_bool == 0) goto Label_436; // 0x1dc JumpB
	
Label_452:
	var_81_int = 61; // 0x1c4 PushI
	KillTimer(var_81_int); // 0x1c5 Func
	var_82_object = Obj(); var_83_object = Obj(); // 0x1c7 PushV
	var_83_object = var_1_bool; // 0x1c8 MovT
	TaskCall(6); // 0x1c9 TaskCall
	func_943(var_84_float, var_85_float, var_86_object, var_82_object, var_83_object); // 0x1ca NEW_2
	TaskReturn(); // 0x1cb TaskReturn
	var_1_bool = var_84_float; // 0x1cc TMov
	var_106_int = 61; // 0x1ce PushI
	var_107_float = 0.5; // 0x1cf PushF
	SetTimer(var_106_int, var_107_float); // 0x1d0 Func
	var_108_bool = 0; var_109_object = Obj(); // 0x1d2 PushV
	var_109_object = var_1_bool; // 0x1d3 MovT
	func_1295(var_108_bool, var_109_object); // 0x1d4 NEW_2
	var_110_bool = var_108_bool == 0; // 0x1d6 Not
	if(var_110_bool == 0) goto Label_473; // 0x1d7 JumpB
...
func_943(var_0_bool, var_1_bool, var_2_cvector, var_82_object, var_83_object)
{
	var_87_bool = 0; var_88_int = 0; var_89_bool = 0; var_90_int = 0; // 0x3af PushV
	GetSeeThreshold(var_0_bool); // 0x3b0 Func
	GetSeeFOV(var_90_int); // 0x3b2 Func
	var_91_float = 1.5; // 0x3b4 PushF
	var_92_float = var_0_bool / var_91_float; // 0x3b5 Div
	SetSeeThreshold(var_92_float); // 0x3b6 Func
	var_2_cvector = var_83_object; // 0x3b8 TMov
	var_93_object = Obj(); // 0x3b9 PushV
	var_93_object = var_2_cvector; // 0x3ba MovT
	func_1624(var_93_object); // 0x3bb NEW_2
	var_90_int = 0; // 0x3bd MovI
	
Label_958:
	var_94_int = 3; // 0x3be PushI
	var_95_bool = var_90_int < var_94_int; // 0x3bf LT
	if(var_95_bool == 0) goto Label_989; // 0x3c0 JumpB
	var_96_float = 1.8; // 0x3c1 PushF
	var_97_float = var_1_bool * var_96_float; // 0x3c2 Mult
	SetSeeFOV(var_97_float); // 0x3c3 Func
	var_98_string = "all"; // 0x3c5 PushS
	var_99_string = "hunt"; // 0x3c6 PushS
	PlayAnimation(var_98_string, var_99_string); // 0x3c7 Func
	WaitForAnimEnd(var_89_bool); // 0x3c9 Func
	SetSeeFOV(var_90_int); // 0x3cb Func
	var_100_bool = var_89_bool == 0; // 0x3cd Not
	if(var_100_bool == 0) goto Label_976; // 0x3ce JumpB
	goto Label_989; // 0x3cf Jump
	
Label_989:
	func_1055(var_89_bool, var_90_int); // 0x3de NEW_2
	var_101_bool = var_89_bool; // 0x3e0 Push
	if(var_101_bool == 0) goto Label_995; // 0x3e1 JumpB
	var_2_cvector = 0; // 0x3e2 SetNullT
	
Label_995:
	var_82_object = var_2_cvector; // 0x3e3 MovT
	return 4; // 0x3e4 Return
	
Label_976:
	var_102_int = 2; // 0x3d0 PushI
	Sleep(var_102_int, var_89_bool); // 0x3d1 Func
	var_103_bool = var_89_bool == 0; // 0x3d3 Not
	if(var_103_bool == 0) goto Label_982; // 0x3d4 JumpB
	goto Label_989; // 0x3d5 Jump
	
Label_982:
	var_104_object = Obj(); // 0x3d6 PushV
	var_104_object = var_2_cvector; // 0x3d7 MovT
	func_1624(var_104_object); // 0x3d8 NEW_2
	var_105_int = 1; // 0x3da PushI
	var_90_int = var_90_int + var_105_int; // 0x3db Add2
...
func_1480(var_89_string, var_90_int, var_91_int)
{
	var_92_bool = 0; var_93_bool = 0; // 0x5c8 PushV
	var_94_bool = 0; var_95_int = 0; var_96_int = 0; // 0x5c9 PushV
	var_95_int = var_90_int; // 0x5ca Mov
	var_96_int = var_91_int; // 0x5cb Mov
	func_1574(var_94_bool, var_95_int, var_96_int); // 0x5cc NEW_2
	if(var_94_bool == 0) goto Label_1490; // 0x5ce JumpB
	var_99_int = 0; // 0x5cf PushI
	AddItem(var_93_bool, var_89_string, var_99_int); // 0x5d0 Func
...
func_1491(var_100_string, var_101_int, var_102_int, var_103_int)
{
	var_104_int = 0; var_105_bool = 0; var_106_int = 0; var_107_bool = 0; // 0x5d3 PushV
	var_108_bool = 0; var_109_int = 0; var_110_int = 0; // 0x5d4 PushV
	var_109_int = var_101_int; // 0x5d5 Mov
	var_110_int = var_102_int; // 0x5d6 Mov
	func_1574(var_108_bool, var_109_int, var_110_int); // 0x5d7 NEW_2
	if(var_108_bool == 0) goto Label_1505; // 0x5d9 JumpB
	irand(var_106_int, var_103_int); // 0x5da Func
	var_111_int = 0; // 0x5dc PushI
	var_112_int = 1; // 0x5dd PushI
	var_113_int = var_106_int + var_112_int; // 0x5de Add
	AddItem(var_107_bool, var_100_string, var_111_int, var_113_int); // 0x5df Func
...
func_1506(var_165_string)
{
	var_166_bool = 0; var_167_int = 0; var_168_bool = 0; var_169_int = 0; var_170_bool = 0; var_171_float = 0; var_172_cvector = CVector(0,0,0); var_173_cvector = CVector(0,0,0); var_174_bool = 0; var_175_int = 0; var_176_bool = 0; var_177_int = 0; var_178_bool = 0; var_179_float = 0; var_180_cvector = CVector(0,0,0); var_181_cvector = CVector(0,0,0); // 0x5e2 PushV
	IsExisting3DSound(var_174_bool, var_165_string); // 0x5e3 Func
	var_182_bool = var_174_bool == 0; // 0x5e5 Not
	if(var_182_bool == 0) goto Label_1531; // 0x5e6 JumpB
	var_175_int = 0; // 0x5e7 MovI
	
Label_1512:
	var_183_int = 1; // 0x5e8 PushI
	var_184_int = var_175_int + var_183_int; // 0x5e9 Add
	var_185_int = var_165_string + var_184_int; // 0x5ea Add
	IsExisting3DSound(var_176_bool, var_185_int); // 0x5eb Func
	var_186_bool = var_176_bool == 0; // 0x5ed Not
	if(var_186_bool == 0) goto Label_1520; // 0x5ee JumpB
	goto Label_1523; // 0x5ef Jump
	
Label_1523:
	var_187_bool = var_175_int == 0; // 0x5f3 Not
	if(var_187_bool == 0) goto Label_1526; // 0x5f4 JumpB
	return 16; // 0x5f5 Return
	
Label_1526:
	irand(var_177_int, var_175_int); // 0x5f6 Func
	var_188_int = 1; // 0x5f8 PushI
	var_189_int = var_177_int + var_188_int; // 0x5f9 Add
	var_165_string = var_165_string + var_189_int; // 0x5fa Add2
	
Label_1531:
	Is3DSoundLoaded(var_178_bool, var_165_string); // 0x5fb Func
	var_190_bool = var_178_bool; // 0x5fd Push
	if(var_190_bool == 0) goto Label_1546; // 0x5fe JumpB
	GetEyesHeight(var_179_float); // 0x5ff Func
	GetDirection(var_180_cvector); // 0x601 Func
	var_191_int = 50; // 0x603 PushI
	var_181_cvector = var_180_cvector * var_191_int; // 0x604 Mult2
	var_192_float = GetByIndex(var_181_cvector, 1); // 0x605 PushE
	var_192_float = var_192_float + var_179_float; // 0x606 Add2
	SetByIndex(var_181_cvector, 1) = var_192_float; // 0x607 PopE
	PlayGlobalSound(var_165_string, var_181_cvector); // 0x608 Func
	
Label_1546:
	return 16; // 0x60a Return
	
Label_1520:
	var_193_int = 1; // 0x5f0 PushI
	var_175_int = var_175_int + var_193_int; // 0x5f1 Add2
...
func_2018()
{
	var_14_object = Obj(); var_15_object = Obj(); // 0x7e2 PushV
	GetScene(var_15_object); // 0x7e3 Func
	var_16_object = Obj(); // 0x7e5 PushV
	func_1547(var_16_object); // 0x7e6 NEW_2
	RemoveStationaryActor(var_16_object); // 0x7e8 ObjFunc
...
func_2029(var_14_bool, var_15_object)
{
	var_16_bool = 0; var_17_object = Obj(); // 0x7ee PushV
	var_17_object = var_15_object; // 0x7ef Mov
	func_1295(var_16_bool, var_17_object); // 0x7f0 NEW_2
	var_50_bool = var_16_bool == 0; // 0x7f2 Not
	if(var_50_bool == 0) goto Label_2038; // 0x7f3 JumpB
	var_14_bool = 0; // 0x7f4 MovB
	return 0; // 0x7f5 Return
	
Label_2038:
	var_51_bool = 0; var_52_object = Obj(); // 0x7f6 PushV
	var_52_object = var_15_object; // 0x7f7 Mov
	func_1215(var_51_bool, var_52_object); // 0x7f8 NEW_2
	var_14_bool = var_51_bool; // 0x7f9 Mov
