...
0x357: @@ HasProperty(Stack[-1], Stack[-4])
0x358: Pop(1)
...
0x36c: @@ GetProperty(Stack[-1], Stack[-2])
0x36d: Pop(1)
0x36e: PushEmpty(bool, string)
0x36f: Stack[-1] = Stack[-3]
0x370: Call2 0x3be

0x371: Stack[-14] = Stack[-2]
0x372: Pop(2)
0x373: Return(); Pop(10)
...
0x3b9: Push("Can't find lsh animation : ")
...
0x408: Stack[-5] = Stack[-2]
0x409: Return(); Pop(4)

0x40a: PushEmpty()
0x40b: Push("ook9DankoTermitnik2_1")
0x40c: Push((int) 1)
...
0x43f: Stack[-1] = "ook9DankoTermitnik2_1"
0x440: Call2 0x3e4
...
0x45b: Push("Can't retrieve diary root")
0x45c: @ Trace(Stack[-1])
0x45d: Pop(1)
...
0x467: Pop(1)
0x468: @@ Find(Stack[-7], Stack[-2])
0x469: Pop(0)
0x46a: Pop(0); Push((bool) Stack[-2] == 0)
0x46b: IF (Stack[-1] == 0) GOTO 0x472; Pop(1)

0x46c: Push("Can't find diary parent with id: ")
...
0x472: @@ AddChild(Stack[-8])
0x473: Pop(0)
0x474: Push((int) 7)
0x475: @ SendWorldWndMessage(Stack[-1])
0x476: Pop(1)
0x477: @@ GetCategory(Stack[-1])
0x478: Pop(0)
...
0x494: Stack[-1] = "ui/NPC_Bakalavr.png"
0x495: Return(); Pop(0)

0x496: Stack[-1] = "ui/NPC_Bakalavr_b.png"
0x497: Return(); Pop(0)
