task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	...
	func_831(var_19_object); // 0xc8 NEW_2
...
Label_371:
	...
	func_922(var_143_bool); // 0x175 NEW_2
...
Label_461:
	...
	func_784(var_19_object); // 0x1cf NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_766(var_29_object); // 0x20c NEW_2
...
Label_56:
	var_190_bool = var_26_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_191_object = var_17_object; // 0x40 Mov
	func_717(); // 0x41 NEW_2
...
func_897(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x381 PushV
	var_82_string = "branch"; // 0x382 PushS
	GetVariable(var_82_string, var_81_int); // 0x383 Func
	var_83_int = 0; // 0x385 PushI
	var_84_bool = var_81_int == var_83_int; // 0x386 Eq
	if(var_84_bool == 0) goto Label_907; // 0x387 JumpB
	var_79_int = 1; // 0x388 MovI
	return 2; // 0x389 Return
	
Label_907:
	var_85_int = 1; // 0x38b PushI
	var_86_bool = var_81_int == var_85_int; // 0x38c Eq
	if(var_86_bool == 0) goto Label_912; // 0x38d JumpB
	var_79_int = 2; // 0x38e MovI
	return 2; // 0x38f Return
	
Label_912:
	var_79_int = 3; // 0x390 MovI
...
func_648(var_27_bool, var_29_float)
{
	...
	func_790(var_54_cvector, var_55_cvector); // 0x2a3 NEW_2
...
Label_689:
	...
	var_67_bool = 1; // 0x2b3 PushB
	CameraTransit(var_45_cvector, var_43_cvector, var_67_bool); // 0x2b4 Func
	var_68_float = GetByIndex(var_44_cvector, 0); // 0x2b6 PushE
	var_69_float = GetByIndex(var_44_cvector, 2); // 0x2b7 PushE
	Rotate(var_68_float, var_69_float); // 0x2b8 Func
	var_70_bool = 0; // 0x2ba PushV
	func_922(var_70_bool); // 0x2bb NEW_2
	if(var_70_bool == 0) goto Label_703; // 0x2bd JumpB
...
Label_703:
	...
	HasAnimationTrack(var_47_bool, var_71_string); // 0x2c0 Func
	var_72_bool = var_47_bool; // 0x2c2 Push
	if(var_72_bool == 0) goto Label_711; // 0x2c3 JumpB
	var_73_string = "head"; // 0x2c4 PushS
	LookAsyncCamera(var_73_string); // 0x2c5 Func
}


func_777()
{
	var_15_bool = 0; // 0x309 PushV
	func_922(var_15_bool); // 0x30a NEW_2
	if(var_15_bool == 0) goto Label_783; // 0x30c JumpB
	lshStopSpeech(); // 0x30d Func
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x310 PushV
	self(var_21_object); // 0x311 Func
	var_19_object = var_21_object; // 0x313 Mov
...
{
	var_77_string = "ui/NPC_Citizen1.png"; // 0x396 MovS
...
{
	var_78_string = "ui/NPC_Citizen1_b.png"; // 0x398 MovS
...
{
	var_57_float = 0; var_58_float = 0; // 0x316 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x317 Or
	var_58_float = sqrt(var_59_int); // 0x318 Sqrt2
	var_60_float = 0.0; // 0x319 PushF
	var_61_bool = var_58_float < var_60_float; // 0x31a LT
	if(var_61_bool == 0) goto Label_798; // 0x31b JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x31c MovV
	return 2; // 0x31d Return
	
Label_798:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x31e Div2
...
{
	var_54_string = ""; var_55_string = ""; // 0x39c PushV
	var_55_string = "idle"; // 0x39d MovS
	var_56_int = var_53_int; // 0x39e Push
	if(var_56_int == 0) goto Label_929; // 0x39f JumpB
	var_55_string = var_55_string + var_53_int; // 0x3a0 Add2
	
Label_929:
	var_52_string = var_55_string; // 0x3a1 Mov
...
{
	var_99_int = 0; var_100_int = 0; // 0x320 PushV
	GetVariable(var_98_string, var_100_int); // 0x321 Func
	var_97_int = var_100_int; // 0x323 Mov
...
Label_432:
	...
	func_784(var_21_object); // 0x1b2 NEW_2
...
func_931(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x3a3 PushV
	var_49_int = 0; // 0x3a4 MovI
	
Label_933:
	var_51_string = "all"; // 0x3a5 PushS
	var_52_string = ""; var_53_int = 0; // 0x3a6 PushV
	var_53_int = var_49_int; // 0x3a7 Mov
	func_924(var_52_string, var_53_int); // 0x3a8 NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x3aa Func
	var_57_bool = var_50_bool == 0; // 0x3ac Not
	if(var_57_bool == 0) goto Label_943; // 0x3ad JumpB
	goto Label_946; // 0x3ae Jump
	
Label_946:
	var_46_int = var_49_int; // 0x3b2 Mov
	return 4; // 0x3b3 Return
	
Label_943:
	var_58_int = 1; // 0x3af PushI
	var_49_int = var_49_int + var_58_int; // 0x3b0 Add2
...
func_805()
{
	var_105_string = "ook9Littlegirl1"; // 0x326 PushS
	var_106_int = 1; // 0x327 PushI
	SetVariable(var_105_string, var_106_int); // 0x328 Func
...
Label_558:
	...
	func_931(var_46_int); // 0x22f NEW_2
...
Label_573:
	...
	func_924(var_68_string, var_69_int); // 0x24b NEW_2
...
{
	var_141_bool = 0; // 0xa8 PushV
	func_922(var_141_bool); // 0xa9 NEW_2
	var_142_bool = var_141_bool == 0; // 0xab Not
	if(var_142_bool == 0) goto Label_174; // 0xac JumpB
	return 0; // 0xad Return
	
Label_174:
	var_143_bool = var_140_string == var_2_object; // 0xae Eq
	if(var_143_bool == 0) goto Label_177; // 0xaf JumpB
	return 0; // 0xb0 Return
	
Label_177:
	var_144_string = ""; var_145_bool = 0; // 0xb1 PushV
	var_144_string = var_140_string; // 0xb2 Mov
	var_146_string = ""; // 0xb3 PushS
	var_147_bool = var_140_string == var_146_string; // 0xb4 Eq
	if(var_147_bool == 0) goto Label_184; // 0xb5 JumpB
	var_145_bool = 0; // 0xb6 MovB
	goto Label_185; // 0xb7 Jump
	
Label_185:
	func_751(var_144_string, var_145_bool); // 0xb9 NEW_2
	var_2_object = var_140_string; // 0xbb TMov
	return 0; // 0xbc Return
	
Label_184:
	var_145_bool = 1; // 0xb8 MovB
}


func_811()
{
	var_109_int = 0; var_110_string = ""; // 0x32c PushV
	var_110_string = "k9q01ChildTalk"; // 0x32d MovS
	func_800(var_109_int, var_110_string); // 0x32e NEW_2
	var_111_int = 0; // 0x330 PushI
	var_112_bool = var_109_int == var_111_int; // 0x331 Eq
	if(var_112_bool == 0) goto Label_830; // 0x332 JumpB
	var_113_string = "k9q01ChildTalk"; // 0x333 PushS
	var_114_int = 1; // 0x334 PushI
	SetVariable(var_113_string, var_114_int); // 0x335 Func
	var_115_string = "k9q01"; // 0x337 PushS
	var_116_int = 7; // 0x338 PushI
	SetVariable(var_115_string, var_116_int); // 0x339 Func
	func_843(); // 0x33c NEW_2
...
{
	var_97_int = 0; var_98_string = ""; // 0x340 PushV
	var_98_string = "ook9Littlegirl1"; // 0x341 MovS
	func_800(var_97_int, var_98_string); // 0x342 NEW_2
	var_101_int = 0; // 0x344 PushI
	var_102_bool = var_97_int == var_101_int; // 0x345 Eq
	if(var_102_bool == 0) goto Label_841; // 0x346 JumpB
	var_95_bool = 1; // 0x347 MovB
	return 0; // 0x348 Return
	
Label_841:
	var_95_bool = 0; // 0x349 MovB
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_88_object, var_89_object)
{
	...
	func_831(var_96_object); // 0x52 NEW_2
	...
	func_167(var_89_object, var_140_string); // 0x61 NEW_2
	var_157_int = 529769; // 0x63 PushI
	SetMessage(var_157_int); // 0x64 TObjFunc
	ClearReplies(); // 0x66 TObjFunc
	var_158_int = 529773; // 0x68 PushI
	var_159_int = 31230; // 0x69 PushI
	var_160_int = 31229; // 0x6a PushI
	AddReply(var_158_int, var_159_int, var_160_int); // 0x6b TObjFunc
	var_161_int = 529776; // 0x6d PushI
	var_162_int = 31233; // 0x6e PushI
	var_163_int = 31232; // 0x6f PushI
	AddReply(var_161_int, var_162_int, var_163_int); // 0x70 TObjFunc
	goto Label_137; // 0x72 Jump
	
Label_137:
	var_164_bool = 0; // 0x89 PushV
	func_922(var_164_bool); // 0x8a NEW_2
	if(var_164_bool == 0) goto Label_152; // 0x8c JumpB
	
Label_141:
	lshWaitForAnimEnd(); // 0x8d Func
	var_165_string = var_3_string; // 0x8f PushT
	if(var_165_string == 0) goto Label_146; // 0x90 JumpB
...
Label_146:
	var_166_string = ""; // 0x92 PushV
	var_166_string = var_2_object; // 0x93 MovT
	func_735(var_166_string); // 0x94 NEW_2
	goto Label_141; // 0x96 Jump
	
Label_152:
	var_177_string = "all"; // 0x98 PushS
	var_178_string = "idle"; // 0x99 PushS
	PlayAnimation(var_177_string, var_178_string); // 0x9a Func
	
Label_156:
	WaitForAnimEnd(); // 0x9c Func
	var_179_string = var_3_string; // 0x9e PushT
	if(var_179_string == 0) goto Label_161; // 0x9f JumpB
	goto Label_166; // 0xa0 Jump
	
Label_161:
	var_180_string = "all"; // 0xa1 PushS
	var_181_string = "idle"; // 0xa2 PushS
	PlayAnimation(var_180_string, var_181_string); // 0xa3 Func
	goto Label_156; // 0xa5 Jump
	
Label_115:
	var_182_string = ""; // 0x73 PushV
	var_182_string = "Neutral"; // 0x74 MovS
	func_167(var_89_object, var_182_string); // 0x75 NEW_2
	var_183_int = 529770; // 0x77 PushI
	SetMessage(var_183_int); // 0x78 TObjFunc
	ClearReplies(); // 0x7a TObjFunc
	var_184_int = 529771; // 0x7c PushI
	var_185_int = -1; // 0x7d PushI
	var_186_int = 31227; // 0x7e PushI
	AddReply(var_184_int, var_185_int, var_186_int); // 0x7f TObjFunc
	var_187_int = 529772; // 0x81 PushI
	var_188_int = -1; // 0x82 PushI
	var_189_int = 31228; // 0x83 PushI
	AddReply(var_187_int, var_188_int, var_189_int); // 0x84 TObjFunc
...
func_843()
{
	var_117_object = Obj(); var_118_object = Obj(); // 0x34b PushV
	var_119_int = 524; // 0x34c PushI
	var_120_int = 1; // 0x34d PushI
	var_121_int = 529816; // 0x34e PushI
	CreateDiaryEntry(var_118_object, var_119_int, var_120_int, var_121_int); // 0x34f Func
	var_122_bool = 0; var_123_object = Obj(); var_124_int = 0; // 0x351 PushV
	var_123_object = var_118_object; // 0x352 Mov
	var_124_int = 517; // 0x353 MovI
	func_869(var_122_bool, var_123_object, var_124_int); // 0x354 NEW_2
...
func_717()
{
	var_192_bool = 0; var_193_bool = 0; // 0x2cd PushV
	var_194_bool = 1; // 0x2ce PushB
	CameraSwitchToNormal(var_194_bool); // 0x2cf Func
	var_195_bool = 0; // 0x2d1 PushV
	func_922(var_195_bool); // 0x2d2 NEW_2
	if(var_195_bool == 0) goto Label_726; // 0x2d4 JumpB
	goto Label_734; // 0x2d5 Jump
	
Label_734:
	return 2; // 0x2de Return
	
Label_726:
	var_196_string = "head"; // 0x2d6 PushS
	HasAnimationTrack(var_193_bool, var_196_string); // 0x2d7 Func
	var_197_bool = var_193_bool; // 0x2d9 Push
	if(var_197_bool == 0) goto Label_734; // 0x2da JumpB
	var_198_string = "head"; // 0x2db PushS
	UnlookAsync(var_198_string); // 0x2dc Func
}
...
{
	var_132_object = Obj(); var_133_object = Obj(); // 0x358 PushV
	GetDiaryRoot(var_133_object); // 0x359 Func
	var_134_bool = var_133_object == 0; // 0x35b Not
	if(var_134_bool == 0) goto Label_866; // 0x35c JumpB
	var_135_string = "Can't retrieve diary root"; // 0x35d PushS
	Trace(var_135_string); // 0x35e Func
	var_131_object = 0; // 0x360 MovB
	return 2; // 0x361 Return
	
Label_866:
	var_131_object = var_133_object; // 0x362 Mov
...
{
	var_167_bool = 0; var_168_float = 0; var_169_float = 0; var_170_bool = 0; var_171_float = 0; var_172_float = 0; // 0x2df PushV
	lshHasAnimation(var_170_bool, var_166_string); // 0x2e0 Func
	var_173_bool = var_170_bool; // 0x2e2 Push
	if(var_173_bool == 0) goto Label_746; // 0x2e3 JumpB
	lshGetAnimTimes(var_166_string, var_171_float, var_172_float); // 0x2e4 Func
	var_174_bool = 0; // 0x2e6 PushB
	lshPlayAnimation(var_171_float, var_172_float, var_174_bool); // 0x2e7 Func
...
Label_746:
	var_175_string = "Can't find lsh animation : "; // 0x2ea PushS
	var_176_int = var_175_string + var_166_string; // 0x2eb Add
	Trace(var_176_int); // 0x2ec Func
}


func_869(var_122_bool, var_123_object, var_124_int)
{
	var_125_object = Obj(); var_126_object = Obj(); var_127_int = 0; var_128_object = Obj(); var_129_object = Obj(); var_130_int = 0; // 0x365 PushV
	var_131_object = Obj(); // 0x366 PushV
	func_856(var_131_object); // 0x367 NEW_2
	var_128_object = var_131_object; // 0x368 Mov
	Find(var_124_int, var_129_object); // 0x36a ObjFunc
	var_136_bool = var_129_object == 0; // 0x36c Not
	if(var_136_bool == 0) goto Label_884; // 0x36d JumpB
	var_137_string = "Can't find diary parent with id: "; // 0x36e PushS
	var_138_int = var_137_string + var_124_int; // 0x36f Add
	Trace(var_138_int); // 0x370 Func
	var_122_bool = 0; // 0x372 MovB
	return 6; // 0x373 Return
	
Label_884:
	AddChild(var_123_object); // 0x374 ObjFunc
	var_139_int = 7; // 0x376 PushI
	SendWorldWndMessage(var_139_int); // 0x377 Func
	GetCategory(var_130_int); // 0x379 ObjFunc
	SetDiarySection(var_130_int); // 0x37b Func
	var_122_bool = 0; // 0x37d MovB
...
{
	var_148_bool = 0; var_149_float = 0; var_150_float = 0; var_151_bool = 0; var_152_float = 0; var_153_float = 0; // 0x2ef PushV
	lshHasAnimation(var_151_bool, var_144_string); // 0x2f0 Func
	var_154_bool = var_151_bool; // 0x2f2 Push
	if(var_154_bool == 0) goto Label_761; // 0x2f3 JumpB
	lshGetAnimTimes(var_144_string, var_152_float, var_153_float); // 0x2f4 Func
	lshPlayAnimation(var_152_float, var_153_float, var_145_bool); // 0x2f6 Func
...
Label_761:
	var_155_string = "Can't find lsh animation : "; // 0x2f9 PushS
	var_156_int = var_155_string + var_144_string; // 0x2fa Add
	Trace(var_156_int); // 0x2fb Func
}
...
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x2fe PushV
	GetEyesHeight(var_32_float); // 0x2ff ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x301 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x302 PushE
	var_34_float = var_32_float; // 0x303 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x304 PopE
	var_35_string = "head"; // 0x305 PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x306 Func
