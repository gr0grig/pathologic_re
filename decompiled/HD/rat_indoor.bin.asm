...
0x525: Stack[-3] = Stack[-7]
0x526: Stack[-2] = (float) 0.025
0x527: Stack[-1] = (int) 0
0x528: Call2 0x396

0x529: Stack[-5] = Stack[-4]
0x52a: Pop(4)
0x52b: Push((int) 7)
0x52c: Push((float)0.025)
...
0x539: Pop(2)
0x53a: Push("quality")
0x53b: @@ SetProperty(Stack[-1], Stack[-2])
0x53c: Pop(1)
0x53d: PushEmpty(object, object, int)
0x53e: Stack[-3] = Stack[-8]
0x53f: Stack[-2] = Stack[-5]
0x540: Stack[-1] = (int) 1
0x541: Call2 0x483
