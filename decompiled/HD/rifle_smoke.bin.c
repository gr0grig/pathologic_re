task_0_event_6()
{
	var_0_object = Obj(); // 0x30 PushV
	func_56(var_0_object); // 0x31 NEW_2
...
Label_7:
	...
	var_19_object = Obj(); // 0x28 PushV
	func_56(var_19_object); // 0x29 NEW_2
	RemoveActor(var_19_object); // 0x2b Func
...
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x38 PushV
	self(var_21_object); // 0x39 Func
	var_19_object = var_21_object; // 0x3b Mov
