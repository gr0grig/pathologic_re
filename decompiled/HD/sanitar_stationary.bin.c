...
Label_184:
	...
	func_1770(var_144_bool, var_145_object, var_146_object); // 0xc2 NEW_2
...
Label_207:
	...
	func_1770(var_144_bool, var_145_object, var_146_object); // 0xd9 NEW_2
...
{
	var_9_bool = 0; var_10_object = Obj(); // 0x705 PushV
	var_10_object = var_8_object; // 0x706 Mov
	func_1425(var_9_bool, var_10_object); // 0x707 NEW_2
	var_7_bool = var_9_bool; // 0x708 Mov
...
{
	var_11_bool = 0; var_12_float = 0; var_13_float = 0; var_14_string = ""; var_15_float = 0; var_16_bool = 0; var_17_float = 0; var_18_float = 0; var_19_string = ""; var_20_float = 0; // 0x591 PushV
	var_21_bool = 0; var_22_object = Obj(); // 0x592 PushV
	var_22_object = var_10_object; // 0x593 Mov
	func_634(var_21_bool, var_22_object); // 0x594 NEW_2
	var_55_bool = var_21_bool == 0; // 0x596 Not
	if(var_55_bool == 0) goto Label_1434; // 0x597 JumpB
	var_9_bool = 0; // 0x598 MovB
	return 10; // 0x599 Return
	
Label_1434:
	var_56_object = GlobalVars[4]; // 0x59a PushGE
	in(var_16_bool, var_10_object); // 0x59b ObjFunc
	var_57_bool = var_16_bool; // 0x59d Push
	if(var_57_bool == 0) goto Label_1441; // 0x59e JumpB
	var_9_bool = 1; // 0x59f MovB
	return 10; // 0x5a0 Return
	
Label_1441:
	var_58_bool = 0; var_59_object = Obj(); // 0x5a1 PushV
	var_59_object = var_10_object; // 0x5a2 Mov
	func_503(var_58_bool, var_59_object); // 0x5a3 NEW_2
	if(var_58_bool == 0) goto Label_1460; // 0x5a5 JumpB
	var_62_string = "reputation"; // 0x5a6 PushS
	GetProperty(var_62_string, var_17_float); // 0x5a7 ObjFunc
	var_63_float = 0.33; // 0x5a9 PushF
	var_64_bool = var_17_float < var_63_float; // 0x5aa LT
	if(var_64_bool == 0) goto Label_1454; // 0x5ab JumpB
	var_9_bool = 1; // 0x5ac MovB
	return 10; // 0x5ad Return
	
Label_1454:
	var_65_string = "disease"; // 0x5ae PushS
	GetProperty(var_65_string, var_18_float); // 0x5af ObjFunc
	var_66_float = 0.33; // 0x5b1 PushF
	var_9_bool = var_18_float > var_66_float; // 0x5b2 GT2
	return 10; // 0x5b3 Return
	
Label_1460:
	var_67_bool = 0; var_68_object = Obj(); var_69_string = ""; // 0x5b4 PushV
	var_68_object = var_10_object; // 0x5b5 Mov
	var_69_string = "class"; // 0x5b6 MovS
	func_508(var_67_bool, var_68_object, var_69_string); // 0x5b7 NEW_2
	var_70_bool = var_67_bool == 0; // 0x5b9 Not
	if(var_70_bool == 0) goto Label_1469; // 0x5ba JumpB
	var_9_bool = 0; // 0x5bb MovB
	return 10; // 0x5bc Return
	
Label_1469:
	var_71_string = "class"; // 0x5bd PushS
	GetProperty(var_71_string, var_19_string); // 0x5be ObjFunc
	var_72_bool = 0; // 0x5c0 PushV
	var_72_bool = 1; // 0x5c1 MovB
	var_73_bool = 0; // 0x5c2 PushV
	var_73_bool = 1; // 0x5c3 MovB
	var_74_bool = 0; // 0x5c4 PushV
	var_74_bool = 1; // 0x5c5 MovB
	var_75_string = "bomber"; // 0x5c6 PushS
	var_76_bool = var_19_string == var_75_string; // 0x5c7 Eq
	if(var_76_bool == 0) goto Label_1485; // 0x5c8 JumpB
	var_77_string = "hunter"; // 0x5c9 PushS
	var_78_bool = var_19_string == var_77_string; // 0x5ca Eq
	if(var_78_bool == 0) goto Label_1485; // 0x5cb JumpB
	var_74_bool = 0; // 0x5cc MovB
	
Label_1485:
	if(var_74_bool == 0) goto Label_1490; // 0x5cd JumpB
	var_79_string = "grabitel"; // 0x5ce PushS
	var_80_bool = var_19_string == var_79_string; // 0x5cf Eq
	if(var_80_bool == 0) goto Label_1490; // 0x5d0 JumpB
	var_73_bool = 0; // 0x5d1 MovB
	
Label_1490:
	if(var_73_bool == 0) goto Label_1495; // 0x5d2 JumpB
	var_81_string = "rat_big"; // 0x5d3 PushS
	var_82_bool = var_19_string == var_81_string; // 0x5d4 Eq
	if(var_82_bool == 0) goto Label_1495; // 0x5d5 JumpB
	var_72_bool = 0; // 0x5d6 MovB
	
Label_1495:
	if(var_72_bool == 0) goto Label_1498; // 0x5d7 JumpB
	var_9_bool = 1; // 0x5d8 MovB
	return 10; // 0x5d9 Return
	
Label_1498:
	var_83_bool = 0; var_84_object = Obj(); var_85_string = ""; // 0x5da PushV
	var_84_object = var_10_object; // 0x5db Mov
	var_85_string = "disease"; // 0x5dc MovS
	func_508(var_83_bool, var_84_object, var_85_string); // 0x5dd NEW_2
	var_86_bool = var_83_bool == 0; // 0x5df Not
	if(var_86_bool == 0) goto Label_1507; // 0x5e0 JumpB
	var_9_bool = 0; // 0x5e1 MovB
	return 10; // 0x5e2 Return
	
Label_1507:
	var_87_bool = 0; // 0x5e3 PushV
	var_87_bool = 1; // 0x5e4 MovB
	var_88_bool = 0; var_89_string = ""; // 0x5e5 PushV
	var_89_string = var_19_string; // 0x5e6 Mov
	func_840(var_88_bool, var_89_string); // 0x5e7 NEW_2
	if(var_88_bool == 0) goto Label_1518; // 0x5e9 JumpB
	var_127_string = "dog"; // 0x5ea PushS
	var_128_bool = var_19_string == var_127_string; // 0x5eb Eq
	if(var_128_bool == 0) goto Label_1518; // 0x5ec JumpB
	var_87_bool = 0; // 0x5ed MovB
	
Label_1518:
	if(var_87_bool == 0) goto Label_1525; // 0x5ee JumpB
	var_129_string = "disease"; // 0x5ef PushS
	GetProperty(var_129_string, var_20_float); // 0x5f0 ObjFunc
	var_130_int = 0; // 0x5f2 PushI
	var_9_bool = var_20_float > var_130_int; // 0x5f3 GT2
	return 10; // 0x5f4 Return
	
Label_1525:
	var_9_bool = 0; // 0x5f5 MovB
...
func_1742(var_5_bool, var_6_object)
{
	...
	var_131_bool = 0; var_132_object = Obj(); // 0x6d5 PushV
	var_132_object = var_6_object; // 0x6d6 Mov
	func_1729(var_131_bool, var_132_object); // 0x6d7 NEW_2
	if(var_131_bool == 0) goto Label_1755; // 0x6d9 JumpB
...
func_1756(var_5_bool, var_6_object)
{
	...
	var_131_bool = 0; var_132_object = Obj(); // 0x6e3 PushV
	var_132_object = var_6_object; // 0x6e4 Mov
	func_1729(var_131_bool, var_132_object); // 0x6e5 NEW_2
	if(var_131_bool == 0) goto Label_1769; // 0x6e7 JumpB
...
{
	var_297_cvector = CVector(0,0,0); var_298_float = 0; var_299_cvector = CVector(0,0,0); var_300_float = 0; var_301_bool = 0; var_302_cvector = CVector(0,0,0); var_303_float = 0; var_304_cvector = CVector(0,0,0); var_305_float = 0; var_306_bool = 0; // 0x55f PushV
	GetPosition(var_302_cvector); // 0x560 Func
	GetHeight(var_303_float); // 0x562 Func
	var_307_float = GetByIndex(var_302_cvector, 1); // 0x564 PushE
	var_308_int = 2; // 0x565 PushI
	var_309_float = var_303_float / var_308_int; // 0x566 Div
	var_307_float = var_307_float + var_309_float; // 0x567 Add2
	SetByIndex(var_302_cvector, 1) = var_307_float; // 0x568 PopE
	var_304_cvector = var_296_cvector - var_302_cvector; // 0x569 Sub2
	var_310_int = var_304_cvector | var_304_cvector; // 0x56a Or
	var_305_float = sqrt(var_310_int); // 0x56b Sqrt2
	var_311_int = 50; // 0x56c PushI
	var_312_bool = var_305_float < var_311_int; // 0x56d LT
	if(var_312_bool == 0) goto Label_1393; // 0x56e JumpB
	var_306_bool = 0; // 0x56f MovB
	goto Label_1397; // 0x570 Jump
	
Label_1397:
	var_313_string = "all"; // 0x575 PushS
	var_314_bool = var_306_bool; // 0x576 Push
	if(var_314_bool == 0) goto Label_1402; // 0x577 JumpB
	var_315_string = "cattack"; // 0x578 PushS
	goto Label_1403; // 0x579 Jump
	
Label_1403:
	PlayAnimation(var_313_string, var_315_string); // 0x57b Func
	return 10; // 0x57d Return
	
Label_1402:
	var_316_string = "attack"; // 0x57a PushS
	
Label_1393:
	var_317_float = GetByIndex(var_304_cvector, 1); // 0x571 PushE
	var_318_float = var_317_float / var_305_float; // 0x572 Div
	var_319_float = -0.14286; // 0x573 PushF
	var_306_bool = var_318_float < var_319_float; // 0x574 LT2
}
...
{
	var_147_bool = var_146_object == 0; // 0x6eb NullEq
	if(var_147_bool == 0) goto Label_1775; // 0x6ec JumpB
	var_144_bool = 0; // 0x6ed MovB
	return 0; // 0x6ee Return
	
Label_1775:
	var_144_bool = 1; // 0x6ef MovB
	var_148_bool = 0; var_149_object = Obj(); // 0x6f0 PushV
	var_149_object = var_145_object; // 0x6f1 Mov
	func_1796(var_148_bool, var_149_object); // 0x6f2 NEW_2
	var_150_bool = var_148_bool == 0; // 0x6f4 Not
	if(var_150_bool == 0) goto Label_1795; // 0x6f5 JumpB
	var_151_float = 0; var_152_object = Obj(); // 0x6f6 PushV
	var_152_object = var_146_object; // 0x6f7 Mov
	func_495(var_152_object); // 0x6f8 NEW_2
	var_153_float = 0; var_154_object = Obj(); // 0x6fa PushV
	var_154_object = var_145_object; // 0x6fb Mov
	func_495(var_154_object); // 0x6fc NEW_2
	var_155_int = 25; // 0x6fe PushI
	var_156_int = var_153_float - var_155_int; // 0x6ff Sub
	var_157_bool = var_151_float < var_156_int; // 0x700 LT
	if(var_157_bool == 0) goto Label_1795; // 0x701 JumpB
	var_144_bool = 0; // 0x702 MovB
...
Label_134:
	...
	func_1729(var_272_bool, var_273_object); // 0x91 NEW_2
...
Label_161:
	...
	func_1319(var_281_bool); // 0xa7 NEW_2
	StopAsync(); // 0xa9 Func
...
Label_154:
	...
	func_1406(var_285_object); // 0x9c NEW_2
...
{
	var_286_cvector = CVector(0,0,0); var_287_float = 0; var_288_cvector = CVector(0,0,0); var_289_float = 0; // 0x57e PushV
	GetPosition(var_288_cvector); // 0x57f ObjFunc
	var_290_string = "@GetHeight"; // 0x581 PushS
	var_291_int = 1; // 0x582 PushI
	var_292_bool = IsFuncExist(var_285_object, var_290_string, var_291_int); // 0x583 FuncExist
	if(var_292_bool == 0) goto Label_1420; // 0x584 JumpB
	GetHeight(var_289_float); // 0x585 ObjFunc
	var_293_float = GetByIndex(var_288_cvector, 1); // 0x587 PushE
	var_294_int = 2; // 0x588 PushI
	var_295_float = var_289_float / var_294_int; // 0x589 Div
	var_293_float = var_293_float + var_295_float; // 0x58a Add2
	SetByIndex(var_288_cvector, 1) = var_293_float; // 0x58b PopE
	
Label_1420:
	var_296_cvector = CVector(0,0,0); // 0x58c PushV
	var_296_cvector = var_288_cvector; // 0x58d Mov
	func_1375(var_296_cvector); // 0x58e NEW_2
