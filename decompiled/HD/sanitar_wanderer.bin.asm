...
0x7eb: Push("GenerateMoney: iMin > iMax")
0x7ec: @ Trace(Stack[-1])
0x7ed: Pop(1)
0x7ee: Return(); Pop(4)
...
0x809: Pop(0)
0x80a: @@ SetItemName(Stack[-7])
0x80b: Pop(0)
0x80c: Push("Organ")
0x80d: Push((int) 1)
0x80e: @@ SetProperty(Stack[-2], Stack[-1])
0x80f: Pop(2)
0x810: @@ GetItemID(Stack[-2])
0x811: Pop(0)
0x812: Push((int) 0)
0x813: Push((int) 1)
...
0x88b: IF (Stack[-1] == 0) GOTO 0x890; Pop(1)
...
0x890: IF (Stack[-1] == 0) GOTO 0x895; Pop(1)
...
0x8ae: IF (Stack[-1] == 0) GOTO 0x8b3; Pop(1)

0x8af: Push("dohodyaga")
...
0x8cc: IF (Stack[-1] == 0) GOTO 0x8d1; Pop(1)
...
0x945: Push((int) 2)
0x946: @@ FadeOut(Stack[-1])
0x947: Pop(2)
0x948: Push(GlobalVars[3])
0x949: Stack[-1] = Stack[-12]
...
0x98f: Stack[-1] = Stack[-13]
0x990: Call2 0x591

0x991: Pop(1)
0x992: IF (Stack[-1] == 0) GOTO 0x9a1; Pop(1)

0x993: Push("reputation")
0x994: @@ GetProperty(Stack[-1], Stack[-5])
0x995: Pop(1)
0x996: Push((float)0.33)
...
0x99b: Push("disease")
0x99c: @@ GetProperty(Stack[-1], Stack[-4])
0x99d: Pop(1)
0x99e: Push((float)0.33)
0x99f: Stack[-13] = Stack[-4] > Stack[-1]; Pop(1);
0x9a0: Return(); Pop(10)

0x9a1: PushEmpty(bool, object, string)
0x9a2: Stack[-2] = Stack[-14]
0x9a3: Stack[-1] = "class"
0x9a4: Call2 0x596
...
0x9aa: Push("class")
0x9ab: @@ GetProperty(Stack[-1], Stack[-3])
0x9ac: Pop(1)
...
0x9c8: Stack[-2] = Stack[-14]
0x9c9: Stack[-1] = "disease"
0x9ca: Call2 0x596
...
0x9d3: Stack[-1] = Stack[-5]
0x9d4: Call2 0x714

0x9d5: Pop(1)
0x9d6: IF (Stack[-1] == 0) GOTO 0x9db; Pop(1)
...
0x9dc: Push("disease")
0x9dd: @@ GetProperty(Stack[-1], Stack[-2])
0x9de: Pop(1)
0x9df: Push((int) 0)
...
0xa2f: Stack[-2] = Stack[-7]
0xa30: Stack[-1] = "disease"
0xa31: Call2 0x596
...
0xa39: Push("disease")
0xa3a: @@ GetProperty(Stack[-1], Stack[-2])
0xa3b: Pop(1)
0xa3c: Push((int) 0)
...
0xa7c: Stack[-3] = Stack[-7]
0xa7d: Stack[-2] = Stack[-6]
0xa7e: Stack[-1] = Stack[-5]
0xa7f: Call2 0x67a
...
0xa84: Stack[-5] = Stack[-11]
0xa85: Stack[-4] = Stack[-10]
0xa86: Stack[-3] = Stack[-9]
0xa87: Stack[-2] = Stack[-7]
...
0xaaa: Push(Stack[-2])
0xaab: IF (Stack[-1] == 0) GOTO 0xab4; Pop(1)

0xaac: PushEmpty(float, object)
0xaad: Stack[-1] = Stack[-8]
0xaae: Call2 0x589
...
0xac3: @@ Intersect(Stack[-9], Stack[-8])
0xac4: Pop(1)
...
0xad0: Push((float)0.05)
0xad1: @@ SetLength(Stack[-1])
0xad2: Pop(2)
0xad3: PushEmpty()
0xad4: Call2 0x7b2

0xad5: Pop(0)
0xad6: @@ Next(Stack[-5], Stack[-6])
0xad7: Pop(0)
0xad8: Push(Stack[-5])
...
0xaeb: Push("class")
0xaec: @@ GetProperty(Stack[-1], Stack[-5])
0xaed: Pop(1)
0xaee: Push("sanitar")
...
0xaf2: Stack[-3] = Stack[-10]
0xaf3: Stack[-2] = (float) 0.1
0xaf4: Stack[-1] = (int) 2
0xaf5: Call2 0x5a2

0xaf6: Stack[-7] = Stack[-4]
0xaf7: Pop(4)
0xaf8: PushEmpty(bool, object, string)
0xaf9: Stack[-2] = Stack[-9]
0xafa: Stack[-1] = "disease"
0xafb: Call2 0x596
...
0xafe: Push("disease")
0xaff: @@ GetProperty(Stack[-1], Stack[-3])
0xb00: Pop(1)
0xb01: Push((float)0.1)
...
0xb06: Push((float)0.1)
0xb07: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0xb08: Push("disease")
0xb09: @@ SetProperty(Stack[-1], Stack[-3])
0xb0a: Pop(1)
0xb0b: PushEmpty(bool, object, string)
0xb0c: Stack[-2] = Stack[-9]
0xb0d: Stack[-1] = "fire"
0xb0e: Call2 0x596
...
0xb11: Push("fire")
0xb12: @@ GetProperty(Stack[-1], Stack[-2])
0xb13: Pop(1)
0xb14: Push("fire")
0xb15: Push((float)0.1)
0xb16: Pop(1); Push(Stack[-3] + Stack[-1]);
0xb17: @@ SetProperty(Stack[-2], Stack[-1])
0xb18: Pop(2)
0xb19: GOTO 0xad6
...
0xb1f: Stack[-1] = Stack[-3]
0xb20: Call2 0x97e

0xb21: Stack[-4] = Stack[-2]
0xb22: Pop(2)
0xb23: Return(); Pop(0)
