task_0_event_5(var_0_bool, var_1_object)
{
	...
	var_5_string = "pt_burah"; // 0xc MovS
	var_6_string = "NPC_Burah"; // 0xd MovS
	var_7_string = "NPC_Klara_Burah.xml"; // 0xe MovS
...
{
	var_3_string = "noburah"; // 0x19 PushS
