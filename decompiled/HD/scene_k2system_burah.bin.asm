...
0xaa: Stack[-2] = "NPC_Burah"
0xab: Stack[-1] = "k2system_burah.xml"
0xac: Call2 0x8b
...
0xb0: PushEmpty()
0xb1: Push("pers_butcher")
0xb2: @@ add(Stack[-1])
0xb3: Pop(1)
0xb4: Push("k2system_butcher.xml")
0xb5: @@ add(Stack[-1])
0xb6: Pop(1)
0xb7: Push((bool) 0)
0xb8: @@ add(Stack[-1])
0xb9: Pop(1)
0xba: Push("pers_morlok")
0xbb: @@ add(Stack[-1])
0xbc: Pop(1)
0xbd: Push("k2system_morlok.xml")
0xbe: @@ add(Stack[-1])
0xbf: Pop(1)
0xc0: Push((bool) 0)
0xc1: @@ add(Stack[-1])
0xc2: Pop(1)
0xc3: Push("pers_morlok")
0xc4: @@ add(Stack[-1])
0xc5: Pop(1)
0xc6: Push("k2system_morlok.xml")
0xc7: @@ add(Stack[-1])
0xc8: Pop(1)
0xc9: Push((bool) 0)
0xca: @@ add(Stack[-1])
