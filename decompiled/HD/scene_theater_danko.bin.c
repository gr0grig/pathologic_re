task_0_event_5()
{
	...
	var_112_string = "quest_d12_01"; // 0x4 MovS
...
func_19()
{
	...
	var_41_string = "cs_mask_danko"; // 0x21 PushS
	...
	var_47_string = "cs_mask_danko.xml"; // 0x27 PushS
	...
	var_66_string = "cs_mask_danko"; // 0x34 PushS
