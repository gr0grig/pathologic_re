task_0_event_5(var_0_bool)
{
	...
	func_25(var_11_object); // 0x10 NEW_2
	var_7_object = var_11_object; // 0x11 Mov
	var_8_string = "pt_manager"; // 0x13 MovS
	var_9_string = "pers_doberman"; // 0x14 MovS
	var_10_string = "rats_manager.xml"; // 0x15 MovS
	func_31(var_6_object, var_7_object, var_8_string, var_9_string, var_10_string); // 0x16 NEW_2
