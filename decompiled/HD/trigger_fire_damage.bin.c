...
Label_25:
	...
	var_91_object = Obj(); // 0x24 PushV
	func_242(var_91_object); // 0x25 NEW_2
	var_94_int = 4; // 0x27 PushI
	var_95_float = 0.8; // 0x28 PushF
	ReportHit(var_7_object, var_91_object, var_94_int, var_8_float, var_95_float); // 0x29 Func
	var_96_int = 1; // 0x2b PushI
	var_6_int = var_6_int + var_96_int; // 0x2c Add2
...
Label_188:
	var_90_string = "armor"; // 0xbc PushS
	GetProperty(var_90_string, var_31_int); // 0xbd ObjFunc
}
...
func_272(var_82_float)
{
	...
	var_85_int = 0; // 0x115 PushI
	var_86_bool = var_82_float < var_85_int; // 0x116 LT
	if(var_86_bool == 0) goto Label_284; // 0x117 JumpB
	var_87_float = 0.7; // 0x118 PushF
	var_88_int = 500; // 0x119 PushI
	RumblePlay(var_87_float, var_88_int); // 0x11a Func
	
Label_284:
	var_89_int = 15; // 0x11c PushI
	SendWorldWndMessage(var_89_int, var_84_object); // 0x11d Func
...
{
	var_92_object = Obj(); var_93_object = Obj(); // 0xf2 PushV
	self(var_93_object); // 0xf3 Func
	var_91_object = var_93_object; // 0xf5 Mov
