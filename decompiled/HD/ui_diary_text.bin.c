...
task_0_event_200(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_string, var_9_object)
{
	...
	func_188(var_8_string, var_9_object); // 0x79 NEW_2
	return 0; // 0x7b Return
	
Label_125:
	var_21_string = "diary"; // 0x7d PushS
	var_22_bool = var_8_string == var_21_string; // 0x7e Eq
	if(var_22_bool == 0) goto Label_154; // 0x7f JumpB
	var_23_int = 1000; // 0x80 PushI
	var_24_bool = var_7_int < var_23_int; // 0x81 LT
	if(var_24_bool == 0) goto Label_141; // 0x82 JumpB
	var_5_int = var_7_int; // 0x83 TMov
	var_1_int = 0; // 0x84 TMovI
	var_25_bool = 0; // 0x85 PushV
	var_25_bool = 1; // 0x86 MovB
	func_20(var_6_int, var_7_int, var_8_string, var_9_object, var_25_bool); // 0x87 NEW_2
	func_203(var_8_string, var_9_object); // 0x8a NEW_2
	goto Label_154; // 0x8c Jump
	
Label_154:
	return 0; // 0x9a Return
	
Label_141:
	var_88_int = 1000; // 0x8d PushI
	var_89_bool = var_7_int == var_88_int; // 0x8e Eq
	if(var_89_bool == 0) goto Label_148; // 0x8f JumpB
	func_178(var_9_object); // 0x91 NEW_2
	goto Label_154; // 0x93 Jump
	
Label_148:
	var_92_int = 1001; // 0x94 PushI
	var_93_bool = var_7_int == var_92_int; // 0x95 Eq
	if(var_93_bool == 0) goto Label_154; // 0x96 JumpB
	func_168(var_9_object); // 0x98 NEW_2
}


task_0_event_15(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_int, var_9_float)
{
	var_10_int = 0; var_11_int = 0; // 0x9b PushV
	var_12_int = 15; // 0x9c PushI
	var_13_float = var_9_float * var_12_int; // 0x9d Mult
	var_14_int = 2; // 0x9e PushI
	var_11_int = var_13_float * var_14_int; // 0x9f Mult2
	var_1_int = var_1_int + var_11_int; // 0xa0 Add2
	func_188(var_10_int, var_11_int); // 0xa2 NEW_2
	func_203(var_10_int, var_11_int); // 0xa5 NEW_2
...
main(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int)
{
	...
	func_203(var_5_int, var_6_int); // 0x9 NEW_2
...
func_168(var_1_int)
{
	var_94_int = 0; var_95_int = 0; // 0xa8 PushV
	var_95_int = 60; // 0xa9 MovI
	var_1_int = var_1_int + var_95_int; // 0xaa Add2
	func_188(var_94_int, var_95_int); // 0xac NEW_2
	func_203(var_94_int, var_95_int); // 0xaf NEW_2
...
{
	var_61_int = 0; // 0xcb PushI
	var_62_bool = var_2_int == var_61_int; // 0xcc Eq
	if(var_62_bool == 0) goto Label_211; // 0xcd JumpB
	var_63_int = 16384; // 0xce PushI
	var_64_string = "scrollbar"; // 0xcf PushS
	SendMessage(var_63_int, var_64_string); // 0xd0 Func
	goto Label_218; // 0xd2 Jump
	
Label_218:
	return 0; // 0xda Return
	
Label_211:
	var_65_int = -var_1_int; // 0xd3 Neg
	var_66_int = 100; // 0xd4 PushI
	var_67_float = var_65_int * var_66_int; // 0xd5 Mult
	var_68_float = var_67_float / var_2_int; // 0xd6 Div
	var_69_string = "scrollbar"; // 0xd7 PushS
	SendMessage(var_68_float, var_69_string); // 0xd8 Func
}
...
func_178(var_1_int)
{
	var_90_int = 0; var_91_int = 0; // 0xb2 PushV
	var_91_int = -60; // 0xb3 MovI
	var_1_int = var_1_int + var_91_int; // 0xb4 Add2
	func_188(var_90_int, var_91_int); // 0xb6 NEW_2
	func_203(var_90_int, var_91_int); // 0xb9 NEW_2
...
{
	var_15_int = 0; // 0xbc PushI
	var_16_bool = var_2_int == var_15_int; // 0xbd Eq
	if(var_16_bool == 0) goto Label_193; // 0xbe JumpB
	var_1_int = 0; // 0xbf TMovI
	return 0; // 0xc0 Return
	
Label_193:
	var_17_int = -var_1_int; // 0xc1 Neg
	var_18_bool = var_17_int > var_2_int; // 0xc2 GT
	if(var_18_bool == 0) goto Label_198; // 0xc3 JumpB
	var_1_int = -var_2_int; // 0xc4 Neg2
	goto Label_202; // 0xc5 Jump
	
Label_202:
	return 0; // 0xca Return
	
Label_198:
	var_19_int = 0; // 0xc6 PushI
	var_20_bool = var_1_int > var_19_int; // 0xc7 GT
	if(var_20_bool == 0) goto Label_202; // 0xc8 JumpB
	var_1_int = 0; // 0xc9 TMovI
}
