...
{
	var_1_int = 256; // 0x9d PushI
	var_2_bool = var_0_int == var_1_int; // 0x9e Eq
	if(var_2_bool == 0) goto Label_163; // 0x9f JumpB
	var_3_int = 1; // 0xa0 PushI
	DestroyWindow(var_3_int); // 0xa1 Func
