...
0x896: Pop(0)
0x897: Push("shouse1_kabak@door1")
0x898: @@ add(Stack[-1])
0x899: Pop(1)
0x89a: @@ add(Stack[-1])
0x89b: Pop(0)
...
0x951: Pop(0)
0x952: Push("warehouse_notkin@door1")
0x953: @@ add(Stack[-1])
0x954: Pop(1)
0x955: @@ add(Stack[-1])
0x956: Pop(0)
...
0x962: Pop(0)
0x963: Push("dt_house_1_04@door1")
0x964: @@ add(Stack[-1])
0x965: Pop(1)
0x966: @@ add(Stack[-1])
0x967: Pop(0)
...
0x973: Pop(0)
0x974: Push("house_petr@door1")
0x975: @@ add(Stack[-1])
0x976: Pop(1)
0x977: Push("house_petr@door2")
0x978: @@ add(Stack[-1])
0x979: Pop(1)
0x97a: @@ add(Stack[-1])
0x97b: Pop(0)
...
0x987: Pop(0)
0x988: Push("house_spi4ka@door1")
0x989: @@ add(Stack[-1])
0x98a: Pop(1)
0x98b: Push("house_spi4ka@door2")
0x98c: @@ add(Stack[-1])
0x98d: Pop(1)
0x98e: @@ add(Stack[-1])
0x98f: Pop(0)
...
0x9cb: Pop(0)
0x9cc: Push("termitnik_mat@door1")
0x9cd: @@ add(Stack[-1])
0x9ce: Pop(1)
0x9cf: @@ add(Stack[-1])
0x9d0: Pop(0)
...
0x9ea: Pop(0)
0x9eb: Push("warehouse_grif@door1")
0x9ec: @@ add(Stack[-1])
0x9ed: Pop(1)
0x9ee: @@ add(Stack[-1])
0x9ef: Pop(0)
...
0x9fb: Pop(0)
0x9fc: Push("warehouse_rubin@door1")
0x9fd: @@ add(Stack[-1])
0x9fe: Pop(1)
0x9ff: @@ add(Stack[-1])
0xa00: Pop(0)
...
0xa6c: Push("Can't retrieve diary root")
0xa6d: @ Trace(Stack[-1])
0xa6e: Pop(1)
0xa6f: Stack[-3] = (bool) 0
0xa70: Return(); Pop(2)

0xa71: Stack[-3] = Stack[-1]
0xa72: Return(); Pop(2)
...
0xa77: Stack[-4] = Stack[-1]
0xa78: Pop(1)
0xa79: @@ Find(Stack[-7], Stack[-2])
0xa7a: Pop(0)
0xa7b: Pop(0); Push((bool) Stack[-2] == 0)
0xa7c: IF (Stack[-1] == 0) GOTO 0xa83; Pop(1)

0xa7d: Push("Can't find diary parent with id: ")
...
0xa83: @@ AddChild(Stack[-8])
0xa84: Pop(0)
0xa85: Push((int) 7)
0xa86: @ SendWorldWndMessage(Stack[-1])
0xa87: Pop(1)
0xa88: @@ GetCategory(Stack[-1])
0xa89: Pop(0)
...
0xaa4: Push("dlocked")
0xaa5: @@ SetProperty(Stack[-1], Stack[-4])
0xaa6: Pop(1)
0xaa7: Return(); Pop(2)
...
0xb0a: Pop(1)
0xb0b: IF (Stack[-1] == 0) GOTO 0xb12; Pop(1)
