...
0x529: Push("GenerateMoney: iMin > iMax")
0x52a: @ Trace(Stack[-1])
0x52b: Pop(1)
0x52c: Return(); Pop(8)
...
0x5ee: Stack[-3] = Stack[-7]
0x5ef: Stack[-2] = Stack[-6]
...
0x61d: Push("class")
0x61e: @@ GetProperty(Stack[-1], Stack[-3])
0x61f: Pop(1)
0x620: Push("bomber")
...
0x658: Push("disease")
0x659: @@ GetProperty(Stack[-1], Stack[-3])
0x65a: Pop(1)
