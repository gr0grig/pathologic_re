...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_int, var_12_bool, var_13_object)
{
	...
	func_2179(var_16_bool, var_17_object, var_18_object); // 0xd8 Call
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_int, var_12_bool, var_13_object)
{
	...
	func_2179(var_16_bool, var_17_object, var_18_object); // 0x1f4 Call
...
task_3_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object)
{
	...
	func_2174(var_16_object); // 0x293 Call
...
task_4_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object)
{
	...
	func_2174(var_16_object); // 0x2ed Call
...
func_2064(var_21_object)
{
	...
	func_2158(var_22_object); // 0x813 Call
...
func_2101()
{
	var_15_bool = 0; var_16_int = 0; var_17_bool = 0; var_18_int = 0; // 0x835 PushV
	var_19_int = 0; // 0x836 PushI
	ClearSubContainer(var_19_int); // 0x837 Func
	var_20_int = 0; var_21_int = 0; // 0x839 PushV
	var_20_int = 0; // 0x83a MovI
	var_22_int = 10; // 0x83b PushI
	var_23_int = 0; // 0x83c PushV
	func_1941(var_23_int); // 0x83d Call
	var_29_int = 10; // 0x83f PushI
	var_30_float = var_23_int * var_29_int; // 0x840 Mult
	var_21_int = var_22_int + var_30_float; // 0x841 Add2
	func_2071(var_20_int, var_21_int); // 0x842 Call
	var_49_int = 4; // 0x844 PushI
	irand(var_18_int, var_49_int); // 0x845 Func
	var_50_int = 0; // 0x847 PushI
	var_51_bool = var_18_int == var_50_int; // 0x848 Eq
	if(var_51_bool == 0) goto Label_2130; // 0x849 JumpB
	var_52_int = 0; var_53_string = ""; // 0x84a PushV
	var_53_string = "hook"; // 0x84b MovS
	func_2145(var_52_int, var_53_string); // 0x84c Call
	var_56_int = 0; // 0x84e PushI
	var_57_int = 1; // 0x84f PushI
	AddItem(var_17_bool, var_52_int, var_56_int, var_57_int); // 0x850 Func
	
Label_2130:
	var_58_int = 10; // 0x852 PushI
	irand(var_18_int, var_58_int); // 0x853 Func
	var_59_int = 0; // 0x855 PushI
	var_60_bool = var_18_int == var_59_int; // 0x856 Eq
	if(var_60_bool == 0) goto Label_2144; // 0x857 JumpB
	var_61_int = 0; var_62_string = ""; // 0x858 PushV
	var_62_string = "watch"; // 0x859 MovS
	func_2145(var_61_int, var_62_string); // 0x85a Call
	var_63_int = 0; // 0x85c PushI
	var_64_int = 1; // 0x85d PushI
	AddItem(var_17_bool, var_61_int, var_63_int, var_64_int); // 0x85e Func
...
func_571()
{
	var_92_int = 0; var_93_int = 0; var_94_int = 0; var_95_int = 0; var_96_bool = 0; var_97_float = 0; var_98_bool = 0; var_99_int = 0; var_100_int = 0; var_101_int = 0; var_102_int = 0; var_103_bool = 0; var_104_float = 0; var_105_bool = 0; // 0x23b PushV
	WaitForAnimEnd(); // 0x23c Func
	var_106_bool = 0; // 0x23e PushV
	func_1918(var_106_bool); // 0x23f Call
	var_107_bool = var_106_bool == 0; // 0x241 Not
	if(var_107_bool == 0) goto Label_580; // 0x242 JumpB
	return 14; // 0x243 Return
	
Label_580:
	var_108_int = 0; // 0x244 PushV
	func_1992(var_108_int); // 0x245 Call
	var_99_int = var_108_int; // 0x246 Mov
	var_100_int = 0; // 0x248 MovI
	
Label_585:
	var_121_bool = 0; // 0x249 PushV
	var_121_bool = 0; // 0x24a MovB
	var_122_int = 5; // 0x24b PushI
	var_123_bool = var_100_int < var_122_int; // 0x24c LT
	if(var_123_bool == 0) goto Label_595; // 0x24d JumpB
	var_124_bool = 0; // 0x24e PushV
	func_1918(var_124_bool); // 0x24f Call
	if(var_124_bool == 0) goto Label_595; // 0x251 JumpB
	var_121_bool = 1; // 0x252 MovB
	
Label_595:
	if(var_121_bool == 0) goto Label_639; // 0x253 JumpB
	var_125_int = 3; // 0x254 PushI
	irand(var_101_int, var_125_int); // 0x255 Func
	var_126_int = 0; // 0x257 PushI
	var_127_bool = var_101_int == var_126_int; // 0x258 Eq
	if(var_127_bool == 0) goto Label_619; // 0x259 JumpB
	var_128_int = var_99_int; // 0x25a Push
	if(var_128_int == 0) goto Label_618; // 0x25b JumpB
	irand(var_102_int, var_99_int); // 0x25c Func
	var_129_string = "all"; // 0x25e PushS
	var_130_string = ""; var_131_int = 0; // 0x25f PushV
	var_131_int = var_102_int; // 0x260 Mov
	func_1985(var_130_string, var_131_int); // 0x261 Call
	PlayAnimation(var_129_string, var_130_string); // 0x263 Func
	WaitForAnimEnd(var_103_bool); // 0x265 Func
	var_132_bool = var_103_bool == 0; // 0x267 Not
	if(var_132_bool == 0) goto Label_618; // 0x268 JumpB
...
Label_636:
	var_133_int = 1; // 0x27c PushI
	var_100_int = var_100_int + var_133_int; // 0x27d Add2
	goto Label_585; // 0x27e Jump
	
Label_619:
	var_134_int = 1; // 0x26b PushI
	var_135_bool = var_101_int == var_134_int; // 0x26c Eq
	if(var_135_bool == 0) goto Label_633; // 0x26d JumpB
	var_136_int = 4; // 0x26e PushI
	rand(var_104_float, var_136_int); // 0x26f Func
	var_137_int = 1; // 0x271 PushI
	var_138_int = var_104_float + var_137_int; // 0x272 Add
	Sleep(var_138_int, var_105_bool); // 0x273 Func
	var_139_bool = var_105_bool == 0; // 0x275 Not
	if(var_139_bool == 0) goto Label_632; // 0x276 JumpB
...
Label_633:
	var_140_int = var_100_int; // 0x279 Push
	if(var_140_int == 0) goto Label_636; // 0x27a JumpB
...
{
	var_54_int = 0; var_55_int = 0; // 0x861 PushV
	GetInvItemByName(var_55_int, var_53_string); // 0x862 Func
	var_52_int = var_55_int; // 0x864 Mov
...
func_2150()
{
	var_13_bool = GlobalVars[0]; // 0x866 PushGE
	var_13_bool = 0; // 0x867 MovB
	GlobalVars[0] = var_13_bool; // 0x868 PopGE
	var_14_bool = 0; // 0x869 PushV
	var_14_bool = 1; // 0x86a MovB
	func_2101(); // 0x86b Call
...
{
	var_23_bool = 0; var_24_bool = 0; // 0x86e PushV
	var_25_bool = GlobalVars[0]; // 0x86f PushGE
	if(var_25_bool == 0) goto Label_2168; // 0x870 JumpB
	IsOverrideActive(var_24_bool); // 0x871 Func
	var_26_bool = var_24_bool == 0; // 0x873 Not
	if(var_26_bool == 0) goto Label_2167; // 0x874 JumpB
	WorkWithCorpse(var_22_object); // 0x875 Func
...
{
	var_66_bool = 0; var_67_bool = 0; // 0x879 PushV
	IsPlayerActor(var_65_object, var_67_bool); // 0x87a Func
	var_64_bool = var_67_bool; // 0x87c Mov
...
{
	var_19_string = ""; var_20_bool = 0; var_21_string = ""; var_22_bool = 0; // 0x883 PushV
	var_23_bool = 0; var_24_object = Obj(); var_25_string = ""; // 0x884 PushV
	var_24_object = var_18_object; // 0x885 Mov
	var_25_string = "class"; // 0x886 MovS
	func_1614(var_23_bool, var_24_object, var_25_string); // 0x887 Call
	var_32_bool = var_23_bool == 0; // 0x889 Not
	if(var_32_bool == 0) goto Label_2189; // 0x88a JumpB
	var_16_bool = 0; // 0x88b MovB
	return 4; // 0x88c Return
	
Label_2189:
	var_33_string = "class"; // 0x88d PushS
	GetProperty(var_33_string, var_21_string); // 0x88e ObjFunc
	var_34_string = "rat"; // 0x890 PushS
	var_35_bool = var_21_string == var_34_string; // 0x891 Eq
	if(var_35_bool == 0) goto Label_2198; // 0x892 JumpB
	var_16_bool = 0; // 0x893 MovB
	return 4; // 0x894 Return
	
Label_2198:
	var_36_string = "dog"; // 0x896 PushS
	var_37_bool = var_21_string == var_36_string; // 0x897 Eq
	if(var_37_bool == 0) goto Label_2203; // 0x898 JumpB
	var_16_bool = 0; // 0x899 MovB
	return 4; // 0x89a Return
	
Label_2203:
	CanSee(var_22_bool, var_17_object); // 0x89b Func
	var_38_bool = 0; // 0x89d PushV
	var_38_bool = 1; // 0x89e MovB
	var_39_bool = var_22_bool; // 0x89f Push
	if(var_39_bool == 0) goto Label_2217; // 0x8a0 JumpB
	var_40_float = 0; var_41_object = Obj(); // 0x8a1 PushV
	var_41_object = var_17_object; // 0x8a2 Mov
	func_1606(var_41_object); // 0x8a3 Call
	var_48_float = 250000.0; // 0x8a5 PushF
	var_49_bool = var_40_float <= var_48_float; // 0x8a6 LE
	if(var_49_bool == 0) goto Label_2217; // 0x8a7 JumpB
	var_38_bool = 0; // 0x8a8 MovB
	
Label_2217:
	if(var_38_bool == 0) goto Label_2223; // 0x8a9 JumpB
	var_50_float = -0.3; // 0x8aa PushF
	ReportReputationChange(var_17_object, var_18_object, var_50_float); // 0x8ab Func
	var_16_bool = 1; // 0x8ad MovB
	return 4; // 0x8ae Return
	
Label_2223:
	var_16_bool = 0; // 0x8af MovB
...
func_645(var_63_object)
{
	...
	func_2169(var_64_bool, var_65_object); // 0x288 Call
...
func_163()
{
	var_65_bool = 0; // 0xa3 PushV
	func_1918(var_65_bool); // 0xa4 Call
	var_68_bool = var_65_bool == 0; // 0xa6 Not
	if(var_68_bool == 0) goto Label_171; // 0xa7 JumpB
	func_2070(); // 0xa9 Call
...
func_2225()
{
	var_66_bool = GlobalVars[0]; // 0x8b2 PushGE
	var_66_bool = 1; // 0x8b3 MovB
	GlobalVars[0] = var_66_bool; // 0x8b4 PopGE
	var_67_int = 50; // 0x8b5 PushI
	var_68_int = 40; // 0x8b6 PushI
	SetRTEnvelope(var_67_int, var_68_int); // 0x8b7 Func
...
{
	var_69_float = 0; var_70_cvector = CVector(0,0,0); var_71_cvector = CVector(0,0,0); var_72_float = 0; var_73_bool = 0; var_74_object = Obj(); var_75_bool = 0; var_76_float = 0; var_77_cvector = CVector(0,0,0); var_78_cvector = CVector(0,0,0); var_79_float = 0; var_80_bool = 0; var_81_object = Obj(); var_82_bool = 0; // 0x178 PushV
	var_0_bool = 0; // 0x179 TMovB
	var_1_bool = 0; // 0x17a TMovB
	var_83_float = 0.5; // 0x17b PushF
	rand(var_76_float, var_83_float); // 0x17c Func
	Sleep(var_76_float); // 0x17e Func
	
Label_384:
	var_84_bool = var_0_bool == 0; // 0x180 Not
	if(var_84_bool == 0) goto Label_432; // 0x181 JumpB
	var_85_bool = var_1_bool == 0; // 0x182 Not
	if(var_85_bool == 0) goto Label_404; // 0x183 JumpB
	
Label_388:
	GetPosition(var_78_cvector); // 0x184 Func
	GetCameraFarDistance(var_79_float); // 0x186 Func
	var_86_float = 2.5; // 0x188 PushF
	var_79_float = var_79_float * var_86_float; // 0x189 Mult2
	GetRandomPFPointInCircle(var_77_cvector, var_78_cvector, var_79_float, var_80_bool); // 0x18a Func
	var_87_bool = var_80_bool; // 0x18c Push
	if(var_87_bool == 0) goto Label_399; // 0x18d JumpB
...
Label_405:
	FindShiftedPathTo(var_81_object, var_77_cvector); // 0x195 Func
	var_88_bool = var_81_object != 0; // 0x197 NullNeq
	if(var_88_bool == 0) goto Label_427; // 0x198 JumpB
	RotatePath(var_81_object, var_82_bool); // 0x199 Func
	var_89_bool = var_82_bool; // 0x19b Push
	if(var_89_bool == 0) goto Label_426; // 0x19c JumpB
	var_90_bool = 0; // 0x19d PushV
	func_454(var_90_bool); // 0x19e Call
	FollowPath(var_81_object, var_90_bool, var_82_bool); // 0x1a0 Func
	var_81_object = 0; // 0x1a2 SetNull
	var_91_bool = var_82_bool; // 0x1a3 Push
	if(var_91_bool == 0) goto Label_426; // 0x1a4 JumpB
...
Label_430:
	var_81_object = 0; // 0x1ae SetNull
	goto Label_384; // 0x1af Jump
	
Label_427:
	var_141_int = 1; // 0x1ab PushI
	Sleep(var_141_int); // 0x1ac Func
	
Label_399:
	var_142_int = 1; // 0x18f PushI
	Sleep(var_142_int); // 0x190 Func
...
{
	var_66_bool = 0; var_67_bool = 0; // 0x77e PushV
	IsLoaded(var_67_bool); // 0x77f Func
	var_65_bool = var_67_bool; // 0x781 Mov
...
{
	var_116_string = ""; var_117_string = ""; // 0x7c1 PushV
	var_117_string = "idle"; // 0x7c2 MovS
	var_118_int = var_115_int; // 0x7c3 Push
	if(var_118_int == 0) goto Label_1990; // 0x7c4 JumpB
	var_117_string = var_117_string + var_115_int; // 0x7c5 Add2
	
Label_1990:
	var_114_string = var_117_string; // 0x7c6 Mov
...
{
	var_109_int = 0; var_110_bool = 0; var_111_int = 0; var_112_bool = 0; // 0x7c8 PushV
	var_111_int = 0; // 0x7c9 MovI
	
Label_1994:
	var_113_string = "all"; // 0x7ca PushS
	var_114_string = ""; var_115_int = 0; // 0x7cb PushV
	var_115_int = var_111_int; // 0x7cc Mov
	func_1985(var_114_string, var_115_int); // 0x7cd Call
	HasAnimation(var_112_bool, var_113_string, var_114_string); // 0x7cf Func
	var_119_bool = var_112_bool == 0; // 0x7d1 Not
	if(var_119_bool == 0) goto Label_2004; // 0x7d2 JumpB
	goto Label_2007; // 0x7d3 Jump
	
Label_2007:
	var_108_int = var_111_int; // 0x7d7 Mov
	return 4; // 0x7d8 Return
	
Label_2004:
	var_120_int = 1; // 0x7d4 PushI
	var_111_int = var_111_int + var_120_int; // 0x7d5 Add2
