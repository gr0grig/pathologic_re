...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object)
{
	...
	var_66_int = 0; var_67_object = Obj(); // 0xdb PushV
	var_67_object = var_11_bool; // 0xdc Mov
	func_1949(var_66_int, var_67_object); // 0xdd Call
	var_14_int = var_66_int; // 0xde Mov
	var_98_int = 0; // 0xe0 PushI
	var_99_bool = var_14_int > var_98_int; // 0xe1 GT
	if(var_99_bool == 0) goto Label_237; // 0xe2 JumpB
	var_100_int = 1; // 0xe3 PushI
	var_101_bool = var_14_int > var_100_int; // 0xe4 GT
	if(var_101_bool == 0) goto Label_233; // 0xe5 JumpB
	func_311(var_14_int); // 0xe7 Call
	
Label_233:
	var_103_object = Obj(); // 0xe9 PushV
	var_103_object = var_11_bool; // 0xea Mov
	func_1956(var_103_object); // 0xeb Call
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object)
{
	...
	var_66_int = 0; var_67_object = Obj(); // 0x1f7 PushV
	var_67_object = var_11_bool; // 0x1f8 Mov
	func_1949(var_66_int, var_67_object); // 0x1f9 Call
	var_14_int = var_66_int; // 0x1fa Mov
	var_98_int = 0; // 0x1fc PushI
	var_99_bool = var_14_int > var_98_int; // 0x1fd GT
	if(var_99_bool == 0) goto Label_521; // 0x1fe JumpB
	var_100_int = 1; // 0x1ff PushI
	var_101_bool = var_14_int > var_100_int; // 0x200 GT
	if(var_101_bool == 0) goto Label_517; // 0x201 JumpB
	func_640(); // 0x203 Call
	
Label_517:
	var_102_object = Obj(); // 0x205 PushV
	var_102_object = var_11_bool; // 0x206 Mov
	func_1956(var_102_object); // 0x207 Call
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object)
{
	...
	var_66_int = 0; var_67_object = Obj(); // 0x2ec PushV
	var_67_object = var_11_bool; // 0x2ed Mov
	func_1949(var_66_int, var_67_object); // 0x2ee Call
	var_14_int = var_66_int; // 0x2ef Mov
	var_98_int = 0; // 0x2f1 PushI
	var_99_bool = var_14_int > var_98_int; // 0x2f2 GT
	if(var_99_bool == 0) goto Label_766; // 0x2f3 JumpB
	var_100_int = 1; // 0x2f4 PushI
	var_101_bool = var_14_int > var_100_int; // 0x2f5 GT
	if(var_101_bool == 0) goto Label_762; // 0x2f6 JumpB
	func_809(); // 0x2f8 Call
	
Label_762:
	var_104_object = Obj(); // 0x2fa PushV
	var_104_object = var_11_bool; // 0x2fb Mov
	func_1956(var_104_object); // 0x2fc Call
...
{
	var_340_int = 0; var_341_string = ""; var_342_int = 0; var_343_float = 0; var_344_float = 0; var_345_float = 0; var_346_int = 0; var_347_string = ""; var_348_int = 0; var_349_float = 0; var_350_float = 0; var_351_float = 0; // 0x621 PushV
	var_352_bool = 0; var_353_object = Obj(); var_354_string = ""; // 0x622 PushV
	var_353_object = var_334_object; // 0x623 Mov
	var_354_string = "health"; // 0x624 MovS
	func_1557(var_352_bool, var_353_object, var_354_string); // 0x625 Call
	var_355_bool = var_352_bool == 0; // 0x627 Not
	if(var_355_bool == 0) goto Label_1579; // 0x628 JumpB
	var_333_float = 0.0; // 0x629 MovF
	return 12; // 0x62a Return
	
Label_1579:
	var_356_bool = 0; var_357_object = Obj(); var_358_string = ""; // 0x62b PushV
	var_357_object = var_334_object; // 0x62c Mov
	var_358_string = "armor"; // 0x62d MovS
	func_1557(var_356_bool, var_357_object, var_358_string); // 0x62e Call
	var_359_bool = var_356_bool == 0; // 0x630 Not
	if(var_359_bool == 0) goto Label_1588; // 0x631 JumpB
	var_346_int = 0; // 0x632 MovI
	goto Label_1591; // 0x633 Jump
	
Label_1591:
	var_360_string = "armor_"; // 0x637 PushS
	var_361_string = ""; var_362_int = 0; // 0x638 PushV
	var_362_int = var_336_int; // 0x639 Mov
	func_1534(var_361_string, var_362_int); // 0x63a Call
	var_347_string = var_360_string + var_361_string; // 0x63c Add2
	var_365_bool = 0; var_366_object = Obj(); var_367_string = ""; // 0x63d PushV
	var_366_object = var_334_object; // 0x63e Mov
	var_367_string = var_347_string; // 0x63f Mov
	func_1557(var_365_bool, var_366_object, var_367_string); // 0x640 Call
	var_368_bool = var_365_bool == 0; // 0x642 Not
	if(var_368_bool == 0) goto Label_1606; // 0x643 JumpB
	var_348_int = 0; // 0x644 MovI
	goto Label_1608; // 0x645 Jump
	
Label_1608:
	var_369_float = 0; var_370_float = 0; var_371_float = 0; // 0x648 PushV
	var_372_int = var_346_int + var_348_int; // 0x649 Add
	var_373_float = 100.0; // 0x64a PushF
	var_370_float = var_372_int / var_372_int; // 0x64b Div2
	var_371_float = 1; // 0x64c MovI
	func_1792(var_369_float, var_370_float, var_371_float); // 0x64d Call
	var_349_float = var_369_float; // 0x64e Mov
	var_375_string = "health"; // 0x650 PushS
	GetProperty(var_375_string, var_350_float); // 0x651 ObjFunc
	var_376_int = 1; // 0x653 PushI
	var_377_int = var_376_int - var_349_float; // 0x654 Sub
	var_351_float = var_335_float * var_377_int; // 0x655 Mult2
	var_378_string = "health"; // 0x656 PushS
	var_379_float = 0; var_380_float = 0; var_381_float = 0; var_382_float = 0; // 0x657 PushV
	var_380_float = var_350_float - var_351_float; // 0x658 Sub2
	var_381_float = 0; // 0x659 MovI
	var_382_float = 1; // 0x65a MovI
	func_1799(var_379_float, var_380_float, var_381_float, var_382_float); // 0x65b Call
	SetProperty(var_378_string, var_379_float); // 0x65d ObjFunc
	var_333_float = var_351_float; // 0x65f Mov
	return 12; // 0x660 Return
	
Label_1606:
	GetProperty(var_347_string, var_348_int); // 0x646 ObjFunc
	
Label_1588:
	var_385_string = "armor"; // 0x634 PushS
	GetProperty(var_385_string, var_346_int); // 0x635 ObjFunc
}
...
{
	var_321_object = Obj(); var_322_float = 0; var_323_float = 0; var_324_object = Obj(); var_325_float = 0; var_326_float = 0; // 0x442 PushV
	var_327_float = 0.9; // 0x443 PushF
	var_328_float = var_319_float * var_327_float; // 0x444 Mult
	GetVictim(var_328_float, var_324_object); // 0x445 Func
	ReportAttack(var_0_bool); // 0x447 Func
	var_329_bool = var_324_object == var_0_bool; // 0x449 Eq
	if(var_329_bool == 0) goto Label_1127; // 0x44a JumpB
	var_330_float = 0; var_331_object = Obj(); var_332_int = 0; // 0x44b PushV
	var_331_object = var_324_object; // 0x44c Mov
	var_332_int = var_320_int; // 0x44d Mov
	func_879(var_332_int); // 0x44e Call
	var_325_float = var_330_float; // 0x44f Mov
	var_333_float = 0; var_334_object = Obj(); var_335_float = 0; var_336_int = 0; // 0x451 PushV
	var_334_object = var_324_object; // 0x452 Mov
	var_335_float = var_325_float; // 0x453 Mov
	var_337_int = 0; var_338_object = Obj(); var_339_int = 0; // 0x454 PushV
	var_338_object = var_324_object; // 0x455 Mov
	var_339_int = var_320_int; // 0x456 Mov
	func_882(var_339_int); // 0x457 Call
	var_336_int = var_337_int; // 0x458 Mov
	func_1569(var_333_float, var_334_object, var_335_float, var_336_int); // 0x45a Call
	var_326_float = var_333_float; // 0x45b Mov
	var_386_int = 0; // 0x45d PushV
	func_1368(var_386_int); // 0x45e Call
	ReportHit(var_0_bool, var_386_int, var_326_float, var_325_float); // 0x460 Func
	var_387_object = Obj(); var_388_float = 0; // 0x462 PushV
	var_387_object = var_324_object; // 0x463 Mov
	var_388_float = var_326_float; // 0x464 Mov
...
func_1129(var_0_bool, var_290_bool, var_291_float)
{
	var_292_int = 0; var_293_bool = 0; var_294_int = 0; var_295_bool = 0; // 0x469 PushV
	irand(var_294_int, var_295_bool); // 0x46a Func
	var_296_int = 1; // 0x46c PushI
	var_294_int = var_294_int + var_296_int; // 0x46d Add2
	Face(var_0_bool); // 0x46e Func
	var_297_bool = 1; // 0x470 PushB
	SetAttackState(var_297_bool); // 0x471 Func
	var_298_string = "all"; // 0x473 PushS
	var_299_string = "attack_begin"; // 0x474 PushS
	var_300_int = var_299_string + var_294_int; // 0x475 Add
	PlayAnimation(var_298_string, var_300_int); // 0x476 Func
	WaitForAnimEnd(); // 0x478 Func
	func_1336(var_294_int, var_295_bool); // 0x47b Call
	var_316_bool = 0; var_317_object = Obj(); // 0x47d PushV
	var_317_object = var_0_bool; // 0x47e MovT
	func_1674(var_316_bool, var_317_object); // 0x47f Call
	var_318_bool = var_316_bool == 0; // 0x481 Not
	if(var_318_bool == 0) goto Label_1159; // 0x482 JumpB
	StopAsync(); // 0x483 Func
	var_290_bool = 0; // 0x485 MovB
	return 4; // 0x486 Return
	
Label_1159:
	var_319_float = 0; var_320_int = 0; // 0x487 PushV
	var_319_float = var_291_float; // 0x488 Mov
	var_320_int = var_294_int; // 0x489 Mov
	func_1090(var_295_bool, var_319_float, var_320_int); // 0x48a Call
	var_389_string = "all"; // 0x48c PushS
	var_390_string = "attack_middle"; // 0x48d PushS
	var_391_int = var_390_string + var_294_int; // 0x48e Add
	HasAnimation(var_295_bool, var_389_string, var_391_int); // 0x48f Func
	var_392_bool = var_295_bool; // 0x491 Push
	if(var_392_bool == 0) goto Label_1193; // 0x492 JumpB
	var_393_string = "all"; // 0x493 PushS
	var_394_string = "attack_middle"; // 0x494 PushS
	var_395_int = var_394_string + var_294_int; // 0x495 Add
	PlayAnimation(var_393_string, var_395_int); // 0x496 Func
	WaitForAnimEnd(); // 0x498 Func
	var_396_bool = 0; var_397_object = Obj(); // 0x49a PushV
	var_397_object = var_0_bool; // 0x49b MovT
	func_1674(var_396_bool, var_397_object); // 0x49c Call
	var_398_bool = var_396_bool == 0; // 0x49e Not
	if(var_398_bool == 0) goto Label_1188; // 0x49f JumpB
	StopAsync(); // 0x4a0 Func
	var_290_bool = 0; // 0x4a2 MovB
	return 4; // 0x4a3 Return
	
Label_1188:
	var_399_float = 0; var_400_int = 0; // 0x4a4 PushV
	var_399_float = var_291_float; // 0x4a5 Mov
	var_400_int = var_294_int; // 0x4a6 Mov
	func_1090(var_295_bool, var_399_float, var_400_int); // 0x4a7 Call
	
Label_1193:
	var_401_bool = 0; // 0x4a9 PushB
	SetAttackState(var_401_bool); // 0x4aa Func
	var_402_string = "all"; // 0x4ac PushS
	var_403_string = "attack_end"; // 0x4ad PushS
	var_404_int = var_403_string + var_294_int; // 0x4ae Add
	PlayAnimation(var_402_string, var_404_int); // 0x4af Func
	var_405_bool = 0; var_406_float = 0; // 0x4b1 PushV
	var_406_float = 0.75; // 0x4b2 MovF
	func_1209(var_405_bool, var_406_float); // 0x4b3 Call
	StopAsync(); // 0x4b5 Func
	var_290_bool = 1; // 0x4b7 MovB
...
Label_2223:
	...
	var_33_bool = 0; // 0x8b2 PushV
	var_33_bool = 0; // 0x8b3 MovB
	var_34_bool = 0; // 0x8b4 PushV
	var_34_bool = 0; // 0x8b5 MovB
	var_35_bool = 0; // 0x8b6 PushV
	var_35_bool = 0; // 0x8b7 MovB
	var_36_bool = 0; // 0x8b8 PushV
	var_36_bool = 0; // 0x8b9 MovB
	var_37_bool = 0; // 0x8ba PushV
	var_37_bool = 0; // 0x8bb MovB
	var_38_bool = 0; // 0x8bc PushV
	var_38_bool = 0; // 0x8bd MovB
	var_39_string = "littleboy"; // 0x8be PushS
	var_40_bool = var_20_string != var_39_string; // 0x8bf Neq
	if(var_40_bool == 0) goto Label_2245; // 0x8c0 JumpB
	var_41_string = "littlegirl"; // 0x8c1 PushS
	var_42_bool = var_20_string != var_41_string; // 0x8c2 Neq
	if(var_42_bool == 0) goto Label_2245; // 0x8c3 JumpB
	var_38_bool = 1; // 0x8c4 MovB
	
Label_2245:
	if(var_38_bool == 0) goto Label_2250; // 0x8c5 JumpB
	var_43_string = "boy"; // 0x8c6 PushS
	var_44_bool = var_20_string != var_43_string; // 0x8c7 Neq
	if(var_44_bool == 0) goto Label_2250; // 0x8c8 JumpB
	var_37_bool = 1; // 0x8c9 MovB
	
Label_2250:
	if(var_37_bool == 0) goto Label_2255; // 0x8ca JumpB
	var_45_string = "girl"; // 0x8cb PushS
	var_46_bool = var_20_string != var_45_string; // 0x8cc Neq
	if(var_46_bool == 0) goto Label_2255; // 0x8cd JumpB
	var_36_bool = 1; // 0x8ce MovB
	
Label_2255:
	if(var_36_bool == 0) goto Label_2260; // 0x8cf JumpB
	var_47_string = "wasted_girl"; // 0x8d0 PushS
	var_48_bool = var_20_string != var_47_string; // 0x8d1 Neq
	if(var_48_bool == 0) goto Label_2260; // 0x8d2 JumpB
	var_35_bool = 1; // 0x8d3 MovB
	
Label_2260:
	if(var_35_bool == 0) goto Label_2265; // 0x8d4 JumpB
	var_49_string = "woman"; // 0x8d5 PushS
	var_50_bool = var_20_string != var_49_string; // 0x8d6 Neq
	if(var_50_bool == 0) goto Label_2265; // 0x8d7 JumpB
	var_34_bool = 1; // 0x8d8 MovB
	
Label_2265:
	if(var_34_bool == 0) goto Label_2270; // 0x8d9 JumpB
	var_51_string = "butcher"; // 0x8da PushS
	var_52_bool = var_20_string != var_51_string; // 0x8db Neq
	if(var_52_bool == 0) goto Label_2270; // 0x8dc JumpB
	var_33_bool = 1; // 0x8dd MovB
	
Label_2270:
	if(var_33_bool == 0) goto Label_2273; // 0x8de JumpB
	var_15_bool = 0; // 0x8df MovB
	return 4; // 0x8e0 Return
	
Label_2273:
	CanSee(var_21_bool, var_16_object); // 0x8e1 Func
	var_53_bool = 0; // 0x8e3 PushV
	var_53_bool = 1; // 0x8e4 MovB
	var_54_bool = var_21_bool; // 0x8e5 Push
	if(var_54_bool == 0) goto Label_2287; // 0x8e6 JumpB
	var_55_float = 0; var_56_object = Obj(); // 0x8e7 PushV
	var_56_object = var_16_object; // 0x8e8 Mov
	func_1549(var_56_object); // 0x8e9 Call
	var_63_float = 250000.0; // 0x8eb PushF
	var_64_bool = var_55_float <= var_63_float; // 0x8ec LE
	if(var_64_bool == 0) goto Label_2287; // 0x8ed JumpB
	var_53_bool = 0; // 0x8ee MovB
	
Label_2287:
	if(var_53_bool == 0) goto Label_2293; // 0x8ef JumpB
	var_65_float = -0.3; // 0x8f0 PushF
	ReportReputationChange(var_16_object, var_17_object, var_65_float); // 0x8f1 Func
	var_15_bool = 1; // 0x8f3 MovB
	return 4; // 0x8f4 Return
	
Label_2293:
	var_15_bool = 0; // 0x8f5 MovB
	return 4; // 0x8f6 Return
}
...
{
	var_407_float = 0; var_408_bool = 0; var_409_float = 0; var_410_bool = 0; // 0x4b9 PushV
	rand(var_409_float); // 0x4ba Func
	var_411_bool = var_409_float < var_406_float; // 0x4bc LT
	if(var_411_bool == 0) goto Label_1229; // 0x4bd JumpB
	
Label_1214:
	IsAnimationPlaying(var_410_bool); // 0x4be Func
	var_412_bool = var_410_bool == 0; // 0x4c0 Not
	if(var_412_bool == 0) goto Label_1219; // 0x4c1 JumpB
...
Label_1231:
	var_405_bool = 0; // 0x4cf MovB
	return 4; // 0x4d0 Return
	
Label_1219:
	var_413_bool = 0; // 0x4c3 PushV
	func_1273(var_410_bool, var_413_bool); // 0x4c4 Call
	if(var_413_bool == 0) goto Label_1225; // 0x4c6 JumpB
	var_405_bool = 1; // 0x4c7 MovB
...
{
	var_249_bool = 0; var_250_cvector = CVector(0,0,0); var_251_cvector = CVector(0,0,0); var_252_cvector = CVector(0,0,0); var_253_float = 0; var_254_bool = 0; var_255_cvector = CVector(0,0,0); var_256_cvector = CVector(0,0,0); var_257_cvector = CVector(0,0,0); var_258_float = 0; // 0x4d1 PushV
	
Label_1234:
	IsAnimationPlaying(var_254_bool); // 0x4d2 Func
	var_259_bool = var_254_bool == 0; // 0x4d4 Not
	if(var_259_bool == 0) goto Label_1239; // 0x4d5 JumpB
	goto Label_1271; // 0x4d6 Jump
	
Label_1271:
	var_247_bool = 0; // 0x4f7 MovB
	return 10; // 0x4f8 Return
	
Label_1239:
	var_260_bool = 0; // 0x4d7 PushV
	func_1273(var_258_float, var_260_bool); // 0x4d8 Call
	if(var_260_bool == 0) goto Label_1245; // 0x4da JumpB
	var_247_bool = 1; // 0x4db MovB
	return 10; // 0x4dc Return
	
Label_1245:
	var_285_bool = 0; var_286_object = Obj(); // 0x4dd PushV
	var_286_object = var_0_bool; // 0x4de MovT
	func_1674(var_285_bool, var_286_object); // 0x4df Call
	var_287_bool = var_285_bool == 0; // 0x4e1 Not
	if(var_287_bool == 0) goto Label_1253; // 0x4e2 JumpB
	var_247_bool = 0; // 0x4e3 MovB
	return 10; // 0x4e4 Return
	
Label_1253:
	GetPFPosition(var_255_cvector); // 0x4e5 TObjFunc
	GetPFPosition(var_256_cvector); // 0x4e7 Func
	var_257_cvector = var_255_cvector - var_256_cvector; // 0x4e9 Sub2
	var_258_float = var_257_cvector | var_257_cvector; // 0x4ea Or2
	var_288_float = var_248_float * var_248_float; // 0x4eb Mult
	var_289_bool = var_258_float < var_288_float; // 0x4ec LT
	if(var_289_bool == 0) goto Label_1268; // 0x4ed JumpB
	var_290_bool = 0; var_291_float = 0; // 0x4ee PushV
	var_291_float = var_248_float; // 0x4ef Mov
	func_1129(var_258_float, var_290_bool, var_291_float); // 0x4f0 Call
	var_247_bool = 1; // 0x4f2 MovB
...
func_2295()
{
	var_65_bool = GlobalVars[0]; // 0x8f8 PushGE
	var_65_bool = 1; // 0x8f9 MovB
	GlobalVars[0] = var_65_bool; // 0x8fa PopGE
	var_66_int = 50; // 0x8fb PushI
	var_67_int = 40; // 0x8fc PushI
	SetRTEnvelope(var_66_int, var_67_int); // 0x8fd Func
...
{
	var_261_cvector = CVector(0,0,0); var_262_cvector = CVector(0,0,0); var_263_cvector = CVector(0,0,0); var_264_float = 0; var_265_float = 0; var_266_cvector = CVector(0,0,0); var_267_cvector = CVector(0,0,0); var_268_cvector = CVector(0,0,0); var_269_float = 0; var_270_float = 0; // 0x4f9 PushV
	var_271_bool = 0; var_272_object = Obj(); // 0x4fa PushV
	var_272_object = var_0_bool; // 0x4fb MovT
	func_1674(var_271_bool, var_272_object); // 0x4fc Call
	var_273_bool = var_271_bool == 0; // 0x4fe Not
	if(var_273_bool == 0) goto Label_1282; // 0x4ff JumpB
	var_260_bool = 0; // 0x500 MovB
	return 10; // 0x501 Return
	
Label_1282:
	var_274_bool = 0; // 0x502 PushV
	func_1325(var_270_float, var_274_bool); // 0x503 Call
	if(var_274_bool == 0) goto Label_1304; // 0x505 JumpB
	GetPFPosition(var_266_cvector); // 0x506 TObjFunc
	GetPFPosition(var_267_cvector); // 0x508 Func
	var_268_cvector = var_266_cvector - var_267_cvector; // 0x50a Sub2
	var_269_float = var_268_cvector | var_268_cvector; // 0x50b Or2
	GetAttackDistance(var_270_float); // 0x50c TObjFunc
	var_275_int = 50; // 0x50e PushI
	var_270_float = var_270_float + var_275_int; // 0x50f Add2
	var_276_float = var_270_float * var_270_float; // 0x510 Mult
	var_277_bool = var_269_float <= var_276_float; // 0x511 LE
	if(var_277_bool == 0) goto Label_1304; // 0x512 JumpB
	func_1306(var_270_float); // 0x514 Call
	var_260_bool = 1; // 0x516 MovB
	return 10; // 0x517 Return
	
Label_1304:
	var_260_bool = 0; // 0x518 MovB
...
{
	var_374_bool = var_370_float < var_371_float; // 0x701 LT
	if(var_374_bool == 0) goto Label_1797; // 0x702 JumpB
	var_369_float = var_370_float; // 0x703 Mov
...
Label_1797:
	var_369_float = var_371_float; // 0x705 Mov
}


func_1799(var_379_float, var_380_float, var_381_float, var_382_float)
{
	var_383_bool = var_380_float < var_381_float; // 0x708 LT
	if(var_383_bool == 0) goto Label_1804; // 0x709 JumpB
	var_379_float = var_381_float; // 0x70a Mov
	return 0; // 0x70b Return
	
Label_1804:
	var_384_bool = var_380_float > var_382_float; // 0x70c GT
	if(var_384_bool == 0) goto Label_1808; // 0x70d JumpB
	var_379_float = var_382_float; // 0x70e Mov
	return 0; // 0x70f Return
	
Label_1808:
	var_379_float = var_380_float; // 0x710 Mov
...
{
	var_278_cvector = CVector(0,0,0); var_279_cvector = CVector(0,0,0); var_280_cvector = CVector(0,0,0); var_281_cvector = CVector(0,0,0); // 0x51a PushV
	Face(var_0_bool); // 0x51b Func
	var_282_string = "all"; // 0x51d PushS
	var_283_string = "bjump"; // 0x51e PushS
	PlayAnimation(var_282_string, var_283_string); // 0x51f Func
	GetPFPosition(var_280_cvector); // 0x521 TObjFunc
	GetPFPosition(var_281_cvector); // 0x523 Func
	WaitForAnimEnd(); // 0x525 Func
	StopAsync(); // 0x527 Func
	var_284_cvector = CVector(0.0, 0.0, 0.0); // 0x529 PushVec
	SetSpeed(var_284_cvector); // 0x52a Func
...
{
	var_240_bool = 0; var_241_bool = 0; // 0x52d PushV
	var_242_string = "IsAttacking"; // 0x52e PushS
	var_243_int = 1; // 0x52f PushI
	var_244_bool = IsFuncExist(var_0_bool, var_242_string, var_243_int); // 0x530 FuncExist
	if(var_244_bool == 0) goto Label_1334; // 0x531 JumpB
	IsAttacking(var_241_bool); // 0x532 TObjFunc
	var_239_bool = var_241_bool; // 0x534 Mov
	return 2; // 0x535 Return
	
Label_1334:
	var_239_bool = 0; // 0x536 MovB
...
{
	var_301_float = 0; var_302_int = 0; var_303_float = 0; var_304_int = 0; // 0x538 PushV
	var_305_bool = var_2_bool == 0; // 0x539 Not
	if(var_305_bool == 0) goto Label_1340; // 0x53a JumpB
	return 4; // 0x53b Return
	
Label_1340:
	var_306_object = var_4_object; // 0x53c PushT
	if(var_306_object == 0) goto Label_1348; // 0x53d JumpB
	var_307_int = -1; // 0x53e PushI
	var_4_object = var_4_object + var_307_int; // 0x53f Add2
	var_308_int = 0; // 0x540 PushI
	var_309_bool = var_4_object > var_308_int; // 0x541 GT
	if(var_309_bool == 0) goto Label_1348; // 0x542 JumpB
	return 4; // 0x543 Return
	
Label_1348:
	rand(var_303_float); // 0x544 Func
	var_310_float = 0; // 0x546 PushV
	func_1374(var_310_float); // 0x547 Call
	var_311_bool = var_303_float < var_310_float; // 0x549 LT
	if(var_311_bool == 0) goto Label_1367; // 0x54a JumpB
	irand(var_304_int, var_303_float); // 0x54b Func
	var_312_int = 1; // 0x54d PushI
	var_304_int = var_304_int + var_312_int; // 0x54e Add2
	var_313_string = "attack"; // 0x54f PushS
	var_314_int = var_313_string + var_304_int; // 0x550 Add
	Speak(var_314_int); // 0x551 Func
	var_315_int = 0; // 0x553 PushV
	func_1372(var_315_int); // 0x554 Call
	var_4_object = var_315_int; // 0x555 TMov
...
{
	var_171_bool = 0; var_172_bool = 0; var_173_object = Obj(); var_174_cvector = CVector(0,0,0); var_175_cvector = CVector(0,0,0); var_176_cvector = CVector(0,0,0); var_177_float = 0; var_178_object = Obj(); var_179_bool = 0; var_180_bool = 0; var_181_object = Obj(); var_182_cvector = CVector(0,0,0); var_183_cvector = CVector(0,0,0); var_184_cvector = CVector(0,0,0); var_185_float = 0; var_186_object = Obj(); // 0x567 PushV
	var_0_bool = 0; // 0x568 TMovB
	var_1_bool = var_164_object; // 0x569 TMov
	var_180_bool = var_168_bool; // 0x56a Mov
	
Label_1387:
	var_187_bool = 0; var_188_object = Obj(); // 0x56b PushV
	var_188_object = var_164_object; // 0x56c Mov
	func_1523(var_187_bool, var_188_object); // 0x56d Call
	var_191_bool = var_187_bool == 0; // 0x56f Not
	if(var_191_bool == 0) goto Label_1395; // 0x570 JumpB
	var_163_bool = 0; // 0x571 MovB
	return 16; // 0x572 Return
	
Label_1395:
	GetPosition(var_182_cvector); // 0x573 ObjFunc
	GetPosition(var_183_cvector); // 0x575 Func
	var_184_cvector = var_182_cvector - var_183_cvector; // 0x577 Sub2
	var_185_float = var_184_cvector | var_184_cvector; // 0x578 Or2
	var_192_bool = 0; // 0x579 PushV
	var_192_bool = 0; // 0x57a MovB
	var_193_int = 0; // 0x57b PushI
	var_194_bool = var_166_float > var_193_int; // 0x57c GT
	if(var_194_bool == 0) goto Label_1410; // 0x57d JumpB
	var_195_float = var_166_float * var_166_float; // 0x57e Mult
	var_196_bool = var_185_float > var_195_float; // 0x57f GT
	if(var_196_bool == 0) goto Label_1410; // 0x580 JumpB
	var_192_bool = 1; // 0x581 MovB
	
Label_1410:
	if(var_192_bool == 0) goto Label_1415; // 0x582 JumpB
	Stop(); // 0x583 Func
	var_163_bool = 0; // 0x585 MovB
	return 16; // 0x586 Return
	
Label_1415:
	var_197_float = var_165_float * var_165_float; // 0x587 Mult
	var_198_bool = var_185_float > var_197_float; // 0x588 GT
	if(var_198_bool == 0) goto Label_1477; // 0x589 JumpB
	GetPFPosition(var_182_cvector); // 0x58a ObjFunc
	FindPathTo(var_186_object, var_182_cvector); // 0x58c Func
	var_199_bool = var_186_object != 0; // 0x58e NullNeq
	if(var_199_bool == 0) goto Label_1426; // 0x58f JumpB
	var_181_object = var_186_object; // 0x590 Mov
	var_186_object = 0; // 0x591 SetNull
	
Label_1426:
	var_200_bool = var_181_object != 0; // 0x592 NullNeq
	if(var_200_bool == 0) goto Label_1459; // 0x593 JumpB
	var_201_bool = var_180_bool; // 0x594 Push
	if(var_201_bool == 0) goto Label_1436; // 0x595 JumpB
	var_180_bool = 0; // 0x596 MovB
	RotatePath(var_181_object, var_179_bool); // 0x597 Func
	var_202_bool = var_179_bool == 0; // 0x599 Not
	if(var_202_bool == 0) goto Label_1436; // 0x59a JumpB
	goto Label_1483; // 0x59b Jump
	
Label_1483:
	var_163_bool = !var_0_bool; // 0x5cb Not2
	return 16; // 0x5cc Return
	
Label_1436:
	var_203_int = 0; // 0x59c PushI
	var_204_float = 0.3; // 0x59d PushF
	SetTimer(var_203_int, var_204_float); // 0x59e Func
	var_205_string = ""; // 0x5a0 PushV
	func_1530(var_205_string); // 0x5a1 Call
	var_206_string = ""; // 0x5a3 PushV
	func_1532(var_206_string); // 0x5a4 Call
	FollowPath(var_181_object, var_167_bool, var_179_bool, var_205_string, var_206_string); // 0x5a6 Func
	var_207_bool = var_179_bool == 0; // 0x5a8 Not
	if(var_207_bool == 0) goto Label_1457; // 0x5a9 JumpB
	var_208_bool = var_0_bool; // 0x5aa PushT
	if(var_208_bool == 0) goto Label_1455; // 0x5ab JumpB
	var_181_object = 0; // 0x5ac SetNull
...
Label_1457:
	var_181_object = 0; // 0x5b1 SetNull
	goto Label_1475; // 0x5b2 Jump
	
Label_1475:
	var_186_object = 0; // 0x5c3 SetNull
	goto Label_1481; // 0x5c4 Jump
	
Label_1481:
	var_181_object = 0; // 0x5c9 SetNull
	
Label_1459:
	var_209_int = 0; // 0x5b3 PushI
	KillTimer(var_209_int); // 0x5b4 Func
	var_210_float = 0.5; // 0x5b6 PushF
	Sleep(var_210_float, var_179_bool); // 0x5b7 Func
	var_211_bool = var_179_bool == 0; // 0x5b9 Not
	if(var_211_bool == 0) goto Label_1471; // 0x5ba JumpB
	var_212_bool = var_0_bool; // 0x5bb PushT
	if(var_212_bool == 0) goto Label_1471; // 0x5bc JumpB
	var_181_object = 0; // 0x5bd SetNull
	goto Label_1483; // 0x5be Jump
	
Label_1471:
	var_213_int = 0; // 0x5bf PushI
	var_214_float = 0.3; // 0x5c0 PushF
	SetTimer(var_213_int, var_214_float); // 0x5c1 Func
	
Label_1477:
	var_215_int = 0; // 0x5c5 PushI
	KillTimer(var_215_int); // 0x5c6 Func
...
{
	var_112_object = Obj(); var_113_bool = 0; var_114_float = 0; // 0x368 PushV
	var_112_object = var_106_object; // 0x369 Mov
	var_113_bool = 1; // 0x36a MovB
	var_114_float = 180.0; // 0x36b MovF
	func_885(var_107_object, var_108_int, var_109_int, var_110_bool, var_111_int, var_106_object, var_112_object, var_113_bool, var_114_float); // 0x36c Call
...
{
	var_115_bool = 0; var_116_bool = 0; var_117_float = 0; var_118_cvector = CVector(0,0,0); var_119_cvector = CVector(0,0,0); var_120_bool = 0; var_121_bool = 0; var_122_cvector = CVector(0,0,0); var_123_float = 0; var_124_float = 0; var_125_bool = 0; var_126_bool = 0; var_127_float = 0; var_128_cvector = CVector(0,0,0); var_129_cvector = CVector(0,0,0); var_130_bool = 0; var_131_bool = 0; var_132_cvector = CVector(0,0,0); var_133_float = 0; var_134_float = 0; // 0x375 PushV
	var_1_bool = 0; // 0x376 TMovI
	
Label_887:
	var_135_string = "all"; // 0x377 PushS
	var_136_string = "attack_begin"; // 0x378 PushS
	var_137_int = 1; // 0x379 PushI
	var_138_int = var_1_bool + var_137_int; // 0x37a Add
	var_139_int = var_136_string + var_138_int; // 0x37b Add
	HasAnimation(var_125_bool, var_135_string, var_139_int); // 0x37c Func
	var_140_bool = var_125_bool == 0; // 0x37e Not
	if(var_140_bool == 0) goto Label_897; // 0x37f JumpB
...
Label_901:
	var_141_string = "attack"; // 0x385 PushS
	var_142_int = 1; // 0x386 PushI
	var_143_int = var_2_bool + var_142_int; // 0x387 Add
	var_144_int = var_141_string + var_143_int; // 0x388 Add
	IsExisting3DSound(var_126_bool, var_144_int); // 0x389 Func
	var_145_bool = var_126_bool == 0; // 0x38b Not
	if(var_145_bool == 0) goto Label_910; // 0x38c JumpB
	goto Label_913; // 0x38d Jump
	
Label_913:
	var_4_object = 0; // 0x391 TMovI
	var_146_string = "@GetAttackDistance"; // 0x392 PushS
	var_147_int = 1; // 0x393 PushI
	var_148_bool = IsFuncExist(var_112_object, var_146_string, var_147_int); // 0x394 FuncExist
	if(var_148_bool == 0) goto Label_923; // 0x395 JumpB
	GetAttackDistance(var_127_float); // 0x396 ObjFunc
	var_149_int = 50; // 0x398 PushI
	var_127_float = var_127_float + var_149_int; // 0x399 Add2
	goto Label_924; // 0x39a Jump
	
Label_924:
	var_150_int = 150; // 0x39c PushI
	var_151_bool = var_127_float >= var_150_int; // 0x39d GE
	if(var_151_bool == 0) goto Label_928; // 0x39e JumpB
	var_127_float = 150; // 0x39f MovI
	
Label_928:
	var_3_object = 0; // 0x3a0 TMovB
	var_0_bool = var_112_object; // 0x3a1 TMov
	IsPlayerActor(var_0_bool, var_130_bool); // 0x3a2 Func
	var_152_bool = var_113_bool; // 0x3a4 Push
	if(var_152_bool == 0) goto Label_936; // 0x3a5 JumpB
	var_131_bool = 0; // 0x3a6 MovB
	goto Label_937; // 0x3a7 Jump
	
Label_937:
	var_153_bool = 0; // 0x3a9 PushV
	var_153_bool = 0; // 0x3aa MovB
	var_154_bool = 0; var_155_object = Obj(); // 0x3ab PushV
	var_155_object = var_0_bool; // 0x3ac MovT
	func_1674(var_154_bool, var_155_object); // 0x3ad Call
	if(var_154_bool == 0) goto Label_947; // 0x3af JumpB
	var_156_bool = var_3_object == 0; // 0x3b0 Not
	if(var_156_bool == 0) goto Label_947; // 0x3b1 JumpB
	var_153_bool = 1; // 0x3b2 MovB
	
Label_947:
	if(var_153_bool == 0) goto Label_1073; // 0x3b3 JumpB
	GetPFPosition(var_128_cvector); // 0x3b4 TObjFunc
	GetPFPosition(var_129_cvector); // 0x3b6 Func
	var_132_cvector = var_128_cvector - var_129_cvector; // 0x3b8 Sub2
	var_133_float = var_132_cvector | var_132_cvector; // 0x3b9 Or2
	var_157_float = 400.0; // 0x3ba PushF
	var_158_int = var_157_float + var_127_float; // 0x3bb Add
	var_159_float = 400.0; // 0x3bc PushF
	var_160_int = var_159_float + var_127_float; // 0x3bd Add
	var_161_float = var_158_int * var_160_int; // 0x3be Mult
	var_162_bool = var_133_float >= var_161_float; // 0x3bf GE
	if(var_162_bool == 0) goto Label_976; // 0x3c0 JumpB
	var_163_bool = 0; var_164_object = Obj(); var_165_float = 0; var_166_float = 0; var_167_bool = 0; var_168_bool = 0; // 0x3c1 PushV
	var_164_object = var_0_bool; // 0x3c2 MovT
	var_165_float = var_127_float; // 0x3c3 Mov
	var_166_float = 3000.0; // 0x3c4 MovF
	var_167_bool = 1; // 0x3c5 MovB
	var_168_bool = 0; // 0x3c6 MovB
	TaskCall(5); // 0x3c7 TaskCall
	func_1383(var_169_bool, var_170_object, var_163_bool, var_164_object, var_165_float, var_166_float, var_167_bool, var_168_bool); // 0x3c8 Call
	TaskReturn(); // 0x3c9 TaskReturn
	var_216_bool = var_169_bool == 0; // 0x3cb Not
	if(var_216_bool == 0) goto Label_974; // 0x3cc JumpB
	goto Label_1073; // 0x3cd Jump
	
Label_1073:
	WaitForAnimEnd(); // 0x431 Func
	var_217_object = var_3_object; // 0x433 PushT
	if(var_217_object == 0) goto Label_1078; // 0x434 JumpB
	return 20; // 0x435 Return
	
Label_1078:
	var_218_string = "all"; // 0x436 PushS
	var_219_string = "attack_off"; // 0x437 PushS
	PlayAnimation(var_218_string, var_219_string); // 0x438 Func
	WaitForAnimEnd(); // 0x43a Func
	var_220_bool = var_130_bool; // 0x43c Push
	if(var_220_bool == 0) goto Label_1089; // 0x43d JumpB
	var_221_float = 2.0; // 0x43e PushF
	Sleep(var_221_float); // 0x43f Func
	
Label_1089:
	return 20; // 0x441 Return
	
Label_974:
	var_131_bool = 0; // 0x3ce MovB
...
Label_976:
	var_222_float = var_114_float * var_114_float; // 0x3d0 Mult
	var_223_bool = var_133_float >= var_222_float; // 0x3d1 GE
	if(var_223_bool == 0) goto Label_1064; // 0x3d2 JumpB
	var_224_bool = var_131_bool == 0; // 0x3d3 Not
	if(var_224_bool == 0) goto Label_994; // 0x3d4 JumpB
	var_225_object = Obj(); // 0x3d5 PushV
	var_225_object = var_0_bool; // 0x3d6 MovT
	func_1765(); // 0x3d7 Call
	var_234_string = "all"; // 0x3d9 PushS
	var_235_string = "attack_on"; // 0x3da PushS
	PlayAnimation(var_234_string, var_235_string); // 0x3db Func
	WaitForAnimEnd(); // 0x3dd Func
	StopAsync(); // 0x3df Func
	var_131_bool = 1; // 0x3e1 MovB
	
Label_994:
	rand(var_134_float); // 0x3e2 Func
	var_236_bool = 0; // 0x3e4 PushV
	var_236_bool = 1; // 0x3e5 MovB
	var_237_float = 0.6; // 0x3e6 PushF
	var_238_bool = var_134_float < var_237_float; // 0x3e7 LT
	if(var_238_bool == 0) goto Label_1006; // 0x3e8 JumpB
	var_239_bool = 0; // 0x3e9 PushV
	func_1325(var_236_bool, var_239_bool); // 0x3ea Call
	if(var_239_bool == 0) goto Label_1006; // 0x3ec JumpB
	var_236_bool = 0; // 0x3ed MovB
	
Label_1006:
	if(var_236_bool == 0) goto Label_1020; // 0x3ee JumpB
	Face(var_0_bool); // 0x3ef Func
	var_245_string = "all"; // 0x3f1 PushS
	var_246_string = "attack_stay"; // 0x3f2 PushS
	PlayAnimation(var_245_string, var_246_string); // 0x3f3 Func
	var_247_bool = 0; var_248_float = 0; // 0x3f5 PushV
	var_248_float = var_114_float; // 0x3f6 Mov
	func_1233(var_134_float, var_247_bool, var_248_float); // 0x3f7 Call
...
Label_1020:
	...
	var_414_string = "all"; // 0x3fe PushS
	var_415_string = "fjump"; // 0x3ff PushS
	PlayAnimation(var_414_string, var_415_string); // 0x400 Func
	WaitForAnimEnd(); // 0x402 Func
	var_416_cvector = CVector(0.0, 0.0, 0.0); // 0x404 PushVec
	SetSpeed(var_416_cvector); // 0x405 Func
	Stop(); // 0x407 Func
	StopAsync(); // 0x409 Func
	var_417_bool = 0; // 0x40b PushV
	func_1325(var_134_float, var_417_bool); // 0x40c Call
	var_418_bool = var_417_bool == 0; // 0x40e Not
	if(var_418_bool == 0) goto Label_1063; // 0x40f JumpB
	var_419_bool = 0; var_420_object = Obj(); // 0x410 PushV
	var_420_object = var_0_bool; // 0x411 MovT
	func_1674(var_419_bool, var_420_object); // 0x412 Call
	var_421_bool = var_419_bool == 0; // 0x414 Not
	if(var_421_bool == 0) goto Label_1047; // 0x415 JumpB
	goto Label_1073; // 0x416 Jump
	
Label_1047:
	GetPFPosition(var_128_cvector); // 0x417 TObjFunc
	GetPFPosition(var_129_cvector); // 0x419 Func
	var_132_cvector = var_128_cvector - var_129_cvector; // 0x41b Sub2
	var_133_float = var_132_cvector | var_132_cvector; // 0x41c Or2
	var_422_float = var_114_float * var_114_float; // 0x41d Mult
	var_423_bool = var_133_float < var_422_float; // 0x41e LT
	if(var_423_bool == 0) goto Label_1063; // 0x41f JumpB
	var_424_bool = 0; var_425_float = 0; // 0x420 PushV
	var_425_float = var_114_float; // 0x421 Mov
	func_1129(var_134_float, var_424_bool, var_425_float); // 0x422 Call
	var_426_bool = var_424_bool == 0; // 0x424 Not
	if(var_426_bool == 0) goto Label_1063; // 0x425 JumpB
	goto Label_1073; // 0x426 Jump
	
Label_1064:
	var_427_bool = 0; var_428_float = 0; // 0x428 PushV
	var_428_float = var_114_float; // 0x429 Mov
	func_1129(var_134_float, var_427_bool, var_428_float); // 0x42a Call
	var_429_bool = var_427_bool == 0; // 0x42c Not
	if(var_429_bool == 0) goto Label_1071; // 0x42d JumpB
	goto Label_1073; // 0x42e Jump
	
Label_1071:
	var_131_bool = 1; // 0x42f MovB
	
Label_936:
	var_131_bool = 1; // 0x3a8 MovB
	
Label_923:
	var_127_float = var_114_float; // 0x39b Mov
	
Label_910:
	var_430_int = 1; // 0x38e PushI
	var_2_bool = var_2_bool + var_430_int; // 0x38f Add2
	goto Label_901; // 0x390 Jump
	
Label_897:
	var_431_int = 1; // 0x381 PushI
	var_1_bool = var_1_bool + var_431_int; // 0x382 Add2
...
{
	var_70_bool = 0; var_71_object = Obj(); // 0x78c PushV
	var_71_object = var_69_object; // 0x78d Mov
	func_1674(var_70_bool, var_71_object); // 0x78e Call
	if(var_70_bool == 0) goto Label_1939; // 0x790 JumpB
	var_68_int = 2; // 0x791 MovI
...
Label_1939:
	var_68_int = 0; // 0x793 MovI
}


func_1941(var_105_object)
{
	var_106_object = Obj(); // 0x796 PushV
	var_106_object = var_105_object; // 0x797 Mov
	TaskCall(4); // 0x798 TaskCall
	func_871(var_106_object); // 0x799 Call
...
{
	var_68_int = 0; var_69_object = Obj(); // 0x79e PushV
	var_69_object = var_67_object; // 0x79f Mov
	func_1931(var_68_int, var_69_object); // 0x7a0 Call
	var_66_int = var_68_int; // 0x7a1 Mov
...
{
	var_105_object = Obj(); // 0x7a5 PushV
	var_105_object = var_104_object; // 0x7a6 Mov
	func_1941(var_105_object); // 0x7a7 Call
...
{
	var_205_string = "walk"; // 0x5fa MovS
...
{
	var_363_int = 1; // 0x5ff PushI
	var_364_bool = var_362_int == var_363_int; // 0x600 Eq
	if(var_364_bool == 0) goto Label_1540; // 0x601 JumpB
	var_361_string = "fire"; // 0x602 MovS
	return 0; // 0x603 Return
	
Label_1540:
	var_361_string = "phys"; // 0x604 MovS
