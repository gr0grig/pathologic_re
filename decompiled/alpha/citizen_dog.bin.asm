...
0x753: Stack[-3] = Stack[-7]
0x754: Stack[-2] = Stack[-6]
0x755: Stack[-1] = Stack[-5]
0x756: Call 0x6a2
...
0x7d0: Push("class")
0x7d1: @@ GetProperty(Stack[-1], Stack[-3])
0x7d2: Pop(1)
...
0x806: Push(Stack[-2])
0x807: IF (Stack[-1] == 0) GOTO 0x810; Pop(1)

0x808: PushEmpty(float, object)
0x809: Stack[-1] = Stack[-9]
0x80a: Call 0x60d
