...
0x6eb: Push("armor")
0x6ec: @@ GetProperty(Stack[-1], Stack[-7])
0x6ed: Pop(1)
0x6ee: Push("armor_")
0x6ef: PushEmpty(string, int)
0x6f0: Stack[-1] = Stack[-16]
0x6f1: Call 0x6bd

0x6f2: Pop(1)
0x6f3: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6f4: PushEmpty(bool, object, string)
0x6f5: Stack[-2] = Stack[-18]
0x6f6: Stack[-1] = Stack[-8]
0x6f7: Call 0x6cc
...
0x6fd: @@ GetProperty(Stack[-5], Stack[-4])
0x6fe: Pop(0)
...
0x705: Stack[-6] = Stack[-3]
0x706: Pop(3)
0x707: Push("health")
0x708: @@ GetProperty(Stack[-1], Stack[-3])
0x709: Pop(1)
0x70a: Push((int) 1)
...
0x713: Pop(3)
0x714: @@ SetProperty(Stack[-2], Stack[-1])
0x715: Pop(2)
0x716: Stack[-16] = Stack[-1]
0x717: Return(); Pop(12)

0x718: PushEmpty(bool, bool)
0x719: @@ IsDead(Stack[-1])
0x71a: Pop(0)
0x71b: Stack[-4] = Stack[-1]
0x71c: Return(); Pop(2)

0x71d: PushEmpty(object, object, object, object)
0x71e: Pop(0); Push((bool) Stack[-5] == 0)
...
0x74b: Stack[-2] = Stack[-6]
0x74c: Stack[-1] = "noaccess"
0x74d: Call 0x6cc
...
0x753: Push("noaccess")
0x754: @@ GetProperty(Stack[-1], Stack[-2])
0x755: Pop(1)
0x756: Push((int) 0)
...
0x7ad: @@ GetPosition(Stack[-7])
0x7ae: Pop(0)
0x7af: @@ GetEyesHeight(Stack[-8])
0x7b0: Pop(0)
...
0x7e9: @@ GetPosition(Stack[-7])
0x7ea: Pop(0)
0x7eb: @@ GetEyesHeight(Stack[-8])
0x7ec: Pop(0)
...
0x858: Stack[-4] = Stack[-1]
0x859: Return(); Pop(0)

0x85a: Stack[-4] = Stack[-3]
0x85b: Return(); Pop(0)
...
0x872: Stack[-1] = Stack[-4]
0x873: Call 0x85c

0x874: Pop(2)
0x875: PushEmpty(float, cvector)
0x876: Stack[-1] = Stack[-5]
0x877: Call 0x865

0x878: Pop(1)
0x879: PushEmpty(float, cvector)
0x87a: Stack[-1] = Stack[-5]
0x87b: Call 0x865
...
0x89d: Stack[-3] = Stack[-7]
0x89e: Stack[-2] = Stack[-6]
0x89f: Stack[-1] = Stack[-5]
0x8a0: Call 0x759
