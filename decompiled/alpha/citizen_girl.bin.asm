...
0x8de: Push("GenerateMoney: iMin > iMax")
0x8df: @ Trace(Stack[-1])
0x8e0: Pop(1)
0x8e1: Return(); Pop(8)
...
0x97c: Push("reputation")
0x97d: @@ GetProperty(Stack[-1], Stack[-2])
0x97e: Pop(1)
...
0x9c6: Push("class")
0x9c7: @@ GetProperty(Stack[-1], Stack[-3])
0x9c8: Pop(1)
0x9c9: Push("rat")
...
0x9e6: Push(Stack[-2])
0x9e7: IF (Stack[-1] == 0) GOTO 0x9f0; Pop(1)

0x9e8: PushEmpty(float, object)
0x9e9: Stack[-1] = Stack[-8]
0x9ea: Call 0x6c6
