...
task_1_event_0(var_0_bool, var_1_object, var_2_bool, var_3_bool, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2235(var_20_object); // 0x28 Call
	...
	func_2238(var_23_object); // 0x30 Call
...
task_2_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2235(var_20_object); // 0xc5 Call
...
Label_209:
	...
	func_2238(var_26_object); // 0xd3 Call
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2492(var_20_bool, var_21_object, var_22_object); // 0xee Call
	if(var_20_bool == 0) goto Label_259; // 0xf0 JumpB
	var_59_int = 0; var_60_object = Obj(); // 0xf1 PushV
	var_60_object = var_16_string; // 0xf2 Mov
	func_2207(var_59_int, var_60_object); // 0xf3 Call
	var_19_int = var_59_int; // 0xf4 Mov
	var_89_int = 0; // 0xf6 PushI
	var_90_bool = var_19_int > var_89_int; // 0xf7 GT
	if(var_90_bool == 0) goto Label_259; // 0xf8 JumpB
	var_91_int = 1; // 0xf9 PushI
	var_92_bool = var_19_int > var_91_int; // 0xfa GT
	if(var_92_bool == 0) goto Label_255; // 0xfb JumpB
	func_333(var_19_int); // 0xfd Call
	
Label_255:
	var_94_object = Obj(); // 0xff PushV
	var_94_object = var_16_string; // 0x100 Mov
	func_2217(var_94_object); // 0x101 Call
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2225(var_20_object); // 0x107 Call
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2230(var_22_object); // 0x11c Call
...
task_3_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2235(var_20_object); // 0x1e1 Call
...
Label_493:
	...
	func_2238(var_25_object); // 0x1ef Call
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2492(var_20_bool, var_21_object, var_22_object); // 0x20a Call
	if(var_20_bool == 0) goto Label_543; // 0x20c JumpB
	var_59_int = 0; var_60_object = Obj(); // 0x20d PushV
	var_60_object = var_16_string; // 0x20e Mov
	func_2207(var_59_int, var_60_object); // 0x20f Call
	var_19_int = var_59_int; // 0x210 Mov
	var_89_int = 0; // 0x212 PushI
	var_90_bool = var_19_int > var_89_int; // 0x213 GT
	if(var_90_bool == 0) goto Label_543; // 0x214 JumpB
	var_91_int = 1; // 0x215 PushI
	var_92_bool = var_19_int > var_91_int; // 0x216 GT
	if(var_92_bool == 0) goto Label_539; // 0x217 JumpB
	func_662(); // 0x219 Call
	
Label_539:
	var_93_object = Obj(); // 0x21b PushV
	var_93_object = var_16_string; // 0x21c Mov
	func_2217(var_93_object); // 0x21d Call
...
task_3_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2225(var_20_object); // 0x223 Call
...
task_3_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2230(var_22_object); // 0x238 Call
...
task_4_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2235(var_20_object); // 0x2d6 Call
...
Label_738:
	...
	func_2238(var_27_object); // 0x2e4 Call
...
task_4_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2492(var_20_bool, var_21_object, var_22_object); // 0x2ff Call
	if(var_20_bool == 0) goto Label_788; // 0x301 JumpB
	var_59_int = 0; var_60_object = Obj(); // 0x302 PushV
	var_60_object = var_16_string; // 0x303 Mov
	func_2207(var_59_int, var_60_object); // 0x304 Call
	var_19_int = var_59_int; // 0x305 Mov
	var_89_int = 0; // 0x307 PushI
	var_90_bool = var_19_int > var_89_int; // 0x308 GT
	if(var_90_bool == 0) goto Label_788; // 0x309 JumpB
	var_91_int = 1; // 0x30a PushI
	var_92_bool = var_19_int > var_91_int; // 0x30b GT
	if(var_92_bool == 0) goto Label_784; // 0x30c JumpB
	func_831(); // 0x30e Call
	
Label_784:
	var_95_object = Obj(); // 0x310 PushV
	var_95_object = var_16_string; // 0x311 Mov
	func_2217(var_95_object); // 0x312 Call
...
task_4_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2225(var_20_object); // 0x318 Call
...
task_4_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2230(var_22_object); // 0x32d Call
...
{
	var_100_cvector = CVector(0,0,0); var_101_float = 0; var_102_bool = 0; var_103_cvector = CVector(0,0,0); var_104_float = 0; var_105_cvector = CVector(0,0,0); var_106_float = 0; var_107_bool = 0; var_108_cvector = CVector(0,0,0); var_109_float = 0; // 0x470 PushV
	var_0_bool = var_96_object; // 0x471 TMov
	var_110_cvector = CVector(0,0,0); var_111_float = 0; // 0x472 PushV
	var_111_float = 1.74533; // 0x473 MovF
	func_1106(var_110_cvector, var_111_float); // 0x474 Call
	var_105_cvector = var_110_cvector; // 0x475 Mov
	var_106_float = var_105_cvector | var_105_cvector; // 0x477 Or2
	var_140_float = 10000.0; // 0x478 PushF
	var_141_bool = var_106_float < var_140_float; // 0x479 LT
	if(var_141_bool == 0) goto Label_1156; // 0x47a JumpB
	var_142_string = "Can't retreat, distance: "; // 0x47b PushS
	var_143_float = sqrt(var_106_float); // 0x47c Sqrt
	var_144_int = var_142_string + var_143_float; // 0x47d Add
	Trace(var_144_int); // 0x47e Func
	var_145_float = 0.5; // 0x480 PushF
	Sleep(var_145_float); // 0x481 Func
	return 10; // 0x483 Return
	
Label_1156:
	var_146_float = GetByIndex(var_105_cvector, 0); // 0x484 PushE
	var_147_float = GetByIndex(var_105_cvector, 2); // 0x485 PushE
	Rotate(var_146_float, var_147_float); // 0x486 Func
	var_148_cvector = CVector(0,0,0); // 0x488 PushV
	func_1722(var_148_cvector); // 0x489 Call
	var_1_bool = var_148_cvector + var_105_cvector; // 0x48b Add2
	var_151_int = 120; // 0x48c PushI
	var_152_float = 0.5; // 0x48d PushF
	SetTimer(var_151_int, var_152_float); // 0x48e Func
	var_2_bool = 0; // 0x490 TMovB
	
Label_1169:
	var_153_int = 1; // 0x491 PushI
	MovePoint(var_153_int, var_153_int, var_107_bool); // 0x492 Func
	var_154_bool = var_107_bool; // 0x494 Push
	if(var_154_bool == 0) goto Label_1197; // 0x495 JumpB
	var_155_bool = var_0_bool == 0; // 0x496 NullEq
	if(var_155_bool == 0) goto Label_1178; // 0x497 JumpB
...
Label_1178:
	var_156_cvector = CVector(0,0,0); var_157_float = 0; // 0x49a PushV
	var_157_float = 2.61799; // 0x49b MovF
	func_1106(var_156_cvector, var_157_float); // 0x49c Call
	var_108_cvector = var_156_cvector; // 0x49d Mov
	var_109_float = var_108_cvector | var_108_cvector; // 0x49f Or2
	var_158_float = 10000.0; // 0x4a0 PushF
	var_159_bool = var_109_float >= var_158_float; // 0x4a1 GE
	if(var_159_bool == 0) goto Label_1196; // 0x4a2 JumpB
	var_160_cvector = CVector(0,0,0); // 0x4a3 PushV
	func_1722(var_160_cvector); // 0x4a4 Call
	var_1_bool = var_160_cvector + var_108_cvector; // 0x4a6 Add2
	var_161_int = 120; // 0x4a7 PushI
	var_162_float = 0.5; // 0x4a8 PushF
	SetTimer(var_161_int, var_162_float); // 0x4a9 Func
	goto Label_1197; // 0x4ab Jump
	
Label_1197:
	var_163_bool = var_2_bool == 0; // 0x4ad Not
	if(var_163_bool == 0) goto Label_1169; // 0x4ae JumpB
...
{
	var_77_object = Obj(); // 0x886 PushV
	var_77_object = var_76_object; // 0x887 Mov
	TaskCall(4); // 0x888 TaskCall
	func_667(var_78_object, var_77_object); // 0x889 Call
...
func_2189(var_19_int, var_20_object)
{
	...
	var_22_object = var_20_object; // 0x88f Mov
	func_1795(var_21_bool, var_22_object); // 0x890 Call
	if(var_21_bool == 0) goto Label_2197; // 0x892 JumpB
	var_19_int = 2; // 0x893 MovI
...
{
	var_62_object = Obj(); // 0x898 PushV
	var_62_object = var_61_object; // 0x899 Mov
	TaskCall(5); // 0x89a TaskCall
	func_893(var_62_object); // 0x89b Call
...
func_667(var_0_bool, var_77_object)
{
	...
	func_1727(var_93_object); // 0x2a4 Call
	...
	func_2087(var_98_float, var_99_cvector, var_100_cvector); // 0x2aa Call
...
{
	var_61_bool = 0; var_62_object = Obj(); // 0x8a0 PushV
	var_62_object = var_60_object; // 0x8a1 Mov
	func_1795(var_61_bool, var_62_object); // 0x8a2 Call
	if(var_61_bool == 0) goto Label_2215; // 0x8a4 JumpB
	var_59_int = 2; // 0x8a5 MovI
...
Label_2215:
	var_59_int = 0; // 0x8a7 MovI
}


func_2217(var_95_object)
{
	var_96_object = Obj(); // 0x8aa PushV
	var_96_object = var_95_object; // 0x8ab Mov
	TaskCall(6); // 0x8ac TaskCall
	func_1136(var_97_object, var_98_cvector, var_99_bool, var_96_object); // 0x8ad Call
...
func_2230(var_20_int)
{
	var_20_int = 0; // 0x8b7 MovI
...
func_2235(var_19_int)
{
	var_19_int = 2; // 0x8bc MovI
...
{
	var_28_object = Obj(); // 0x8bf PushV
	var_28_object = var_27_object; // 0x8c0 Mov
	func_2448(var_27_object, var_28_object); // 0x8c1 Call
...
func_2245()
{
	var_24_int = 1000; // 0x8c6 PushI
	SetReturnValue(var_24_int); // 0x8c7 ObjFunc
	return 0; // 0x8c9 Return
}


func_1734(var_42_float)
{
	var_44_cvector = CVector(0,0,0); var_45_cvector = CVector(0,0,0); var_46_cvector = CVector(0,0,0); var_47_cvector = CVector(0,0,0); var_48_cvector = CVector(0,0,0); var_49_cvector = CVector(0,0,0); // 0x6c6 PushV
	GetPosition(var_47_cvector); // 0x6c7 Func
	GetPosition(var_48_cvector); // 0x6c9 ObjFunc
	var_49_cvector = var_48_cvector - var_47_cvector; // 0x6cb Sub2
	var_42_float = var_49_cvector | var_49_cvector; // 0x6cc Or2
...
{
	var_89_int = 0; var_90_int = 0; // 0x8ca PushV
	var_91_string = "player"; // 0x8cb PushS
	GetVariable(var_91_string, var_90_int); // 0x8cc Func
	var_92_int = 0; // 0x8ce PushI
	var_93_bool = var_90_int == var_92_int; // 0x8cf Eq
	if(var_93_bool == 0) goto Label_2260; // 0x8d0 JumpB
	var_88_int = 200001; // 0x8d1 MovI
	return 2; // 0x8d2 Return
	
Label_2260:
	var_94_int = 1; // 0x8d4 PushI
	var_95_bool = var_90_int == var_94_int; // 0x8d5 Eq
	if(var_95_bool == 0) goto Label_2265; // 0x8d6 JumpB
	var_88_int = 200002; // 0x8d7 MovI
	return 2; // 0x8d8 Return
	
Label_2265:
	var_88_int = 200003; // 0x8d9 MovI
...
func_718(var_0_bool)
{
	...
	func_2032(var_85_object); // 0x2d0 Call
...
func_2267(var_79_int, var_80_int)
{
	var_90_int = 0; var_91_int = 0; var_92_int = 0; var_93_bool = 0; var_94_int = 0; var_95_int = 0; var_96_int = 0; var_97_bool = 0; // 0x8db PushV
	var_98_bool = var_79_int > var_80_int; // 0x8dc GT
	if(var_98_bool == 0) goto Label_2274; // 0x8dd JumpB
	var_99_string = "GenerateMoney: iMin > iMax"; // 0x8de PushS
	Trace(var_99_string); // 0x8df Func
	return 8; // 0x8e1 Return
	
Label_2274:
	var_94_int = 0; // 0x8e2 MovI
	var_100_bool = var_79_int != var_80_int; // 0x8e3 Neq
	if(var_100_bool == 0) goto Label_2281; // 0x8e4 JumpB
	var_101_int = var_80_int - var_79_int; // 0x8e5 Sub
	irand(var_95_int, var_101_int); // 0x8e6 Func
	goto Label_2285; // 0x8e8 Jump
	
Label_2285:
	var_94_int = var_94_int + var_79_int; // 0x8ed Add2
	var_102_int = 0; // 0x8ee PushI
	var_103_bool = var_94_int == var_102_int; // 0x8ef Eq
	if(var_103_bool == 0) goto Label_2290; // 0x8f0 JumpB
	return 8; // 0x8f1 Return
	
Label_2290:
	var_104_string = "Money"; // 0x8f2 PushS
	GetInvItemByName(var_96_int, var_104_string); // 0x8f3 Func
	var_105_int = 0; // 0x8f5 PushI
	AddItem(var_97_bool, var_96_int, var_105_int, var_94_int); // 0x8f6 Func
	return 8; // 0x8f8 Return
	
Label_2281:
	var_106_int = 0; // 0x8e9 PushI
	var_107_bool = var_79_int == var_106_int; // 0x8ea Eq
	if(var_107_bool == 0) goto Label_2285; // 0x8eb JumpB
	return 8; // 0x8ec Return
}
...
func_2297()
{
	var_74_bool = 0; var_75_int = 0; var_76_bool = 0; var_77_int = 0; // 0x8f9 PushV
	var_78_int = 0; // 0x8fa PushI
	ClearSubContainer(var_78_int); // 0x8fb Func
	var_79_int = 0; var_80_int = 0; // 0x8fd PushV
	var_79_int = 0; // 0x8fe MovI
	var_81_int = 10; // 0x8ff PushI
	var_82_int = 0; // 0x900 PushV
	func_2104(var_82_int); // 0x901 Call
	var_88_int = 10; // 0x903 PushI
	var_89_float = var_82_int * var_88_int; // 0x904 Mult
	var_80_int = var_81_int + var_89_float; // 0x905 Add2
	func_2267(var_79_int, var_80_int); // 0x906 Call
	var_108_int = 4; // 0x908 PushI
	irand(var_77_int, var_108_int); // 0x909 Func
	var_109_int = 0; // 0x90b PushI
	var_110_bool = var_77_int == var_109_int; // 0x90c Eq
	if(var_110_bool == 0) goto Label_2326; // 0x90d JumpB
	var_111_int = 0; var_112_string = ""; // 0x90e PushV
	var_112_string = "hook"; // 0x90f MovS
	func_2415(var_111_int, var_112_string); // 0x910 Call
	var_115_int = 0; // 0x912 PushI
	var_116_int = 1; // 0x913 PushI
	AddItem(var_76_bool, var_111_int, var_115_int, var_116_int); // 0x914 Func
	
Label_2326:
	var_117_int = 10; // 0x916 PushI
	irand(var_77_int, var_117_int); // 0x917 Func
	var_118_int = 0; // 0x919 PushI
	var_119_bool = var_77_int == var_118_int; // 0x91a Eq
	if(var_119_bool == 0) goto Label_2340; // 0x91b JumpB
	var_120_int = 0; var_121_string = ""; // 0x91c PushV
	var_121_string = "watch"; // 0x91d MovS
	func_2415(var_120_int, var_121_string); // 0x91e Call
	var_122_int = 0; // 0x920 PushI
	var_123_int = 1; // 0x921 PushI
	AddItem(var_76_bool, var_120_int, var_122_int, var_123_int); // 0x922 Func
...
Label_1294:
	...
	func_2250(var_88_int); // 0x51b Call
...
func_2341(var_18_bool)
{
	var_19_int = 0; var_20_bool = 0; var_21_int = 0; var_22_bool = 0; // 0x925 PushV
	var_23_int = 0; // 0x926 PushI
	ClearSubContainer(var_23_int); // 0x927 Func
	var_24_bool = var_18_bool; // 0x929 Push
	if(var_24_bool == 0) goto Label_2374; // 0x92a JumpB
	var_25_int = 3; // 0x92b PushI
	irand(var_21_int, var_25_int); // 0x92c Func
	var_26_int = 0; // 0x92e PushI
	var_27_bool = var_21_int != var_26_int; // 0x92f Neq
	if(var_27_bool == 0) goto Label_2360; // 0x930 JumpB
	var_28_int = 0; var_29_string = ""; // 0x931 PushV
	var_29_string = "alpha_pills"; // 0x932 MovS
	func_2415(var_28_int, var_29_string); // 0x933 Call
	var_32_int = 0; // 0x935 PushI
	AddItem(var_22_bool, var_28_int, var_32_int, var_21_int); // 0x936 Func
	
Label_2360:
	var_33_int = 3; // 0x938 PushI
	irand(var_21_int, var_33_int); // 0x939 Func
	var_34_int = 0; // 0x93b PushI
	var_35_bool = var_21_int != var_34_int; // 0x93c Neq
	if(var_35_bool == 0) goto Label_2373; // 0x93d JumpB
	var_36_int = 0; var_37_string = ""; // 0x93e PushV
	var_37_string = "meradorm"; // 0x93f MovS
	func_2415(var_36_int, var_37_string); // 0x940 Call
	var_38_int = 0; // 0x942 PushI
	AddItem(var_22_bool, var_36_int, var_38_int, var_21_int); // 0x943 Func
	
Label_2373:
	goto Label_2414; // 0x945 Jump
	
Label_2414:
	return 4; // 0x96e Return
	
Label_2374:
	var_39_int = 3; // 0x946 PushI
	irand(var_21_int, var_39_int); // 0x947 Func
	var_40_int = 0; // 0x949 PushI
	var_41_bool = var_21_int == var_40_int; // 0x94a Eq
	if(var_41_bool == 0) goto Label_2388; // 0x94b JumpB
	var_42_int = 0; var_43_string = ""; // 0x94c PushV
	var_43_string = "lockpick"; // 0x94d MovS
	func_2415(var_42_int, var_43_string); // 0x94e Call
	var_44_int = 0; // 0x950 PushI
	var_45_int = 1; // 0x951 PushI
	AddItem(var_22_bool, var_42_int, var_44_int, var_45_int); // 0x952 Func
	
Label_2388:
	var_46_int = 4; // 0x954 PushI
	irand(var_21_int, var_46_int); // 0x955 Func
	var_47_int = 0; // 0x957 PushI
	var_48_bool = var_21_int != var_47_int; // 0x958 Neq
	if(var_48_bool == 0) goto Label_2401; // 0x959 JumpB
	var_49_int = 0; var_50_string = ""; // 0x95a PushV
	var_50_string = "rifle_ammo"; // 0x95b MovS
	func_2415(var_49_int, var_50_string); // 0x95c Call
	var_51_int = 0; // 0x95e PushI
	AddItem(var_22_bool, var_49_int, var_51_int, var_21_int); // 0x95f Func
	
Label_2401:
	var_52_int = 4; // 0x961 PushI
	irand(var_21_int, var_52_int); // 0x962 Func
	var_53_int = 0; // 0x964 PushI
	var_54_bool = var_21_int != var_53_int; // 0x965 Neq
	if(var_54_bool == 0) goto Label_2414; // 0x966 JumpB
	var_55_int = 0; var_56_string = ""; // 0x967 PushV
	var_56_string = "revolver_ammo"; // 0x968 MovS
	func_2415(var_55_int, var_56_string); // 0x969 Call
	var_57_int = 0; // 0x96b PushI
	AddItem(var_22_bool, var_55_int, var_57_int, var_21_int); // 0x96c Func
}
...
Label_388:
	...
	func_2181(var_76_object); // 0x186 Call
...
func_2415(var_28_int, var_29_string)
{
	var_30_int = 0; var_31_int = 0; // 0x96f PushV
	GetInvItemByName(var_31_int, var_29_string); // 0x970 Func
	var_28_int = var_31_int; // 0x972 Mov
...
{
	var_63_object = Obj(); var_64_float = 0; var_65_object = Obj(); var_66_float = 0; // 0x974 PushV
	var_67_string = "player"; // 0x975 PushS
	FindActor(var_65_object, var_67_string); // 0x976 Func
	var_68_bool = var_65_object == 0; // 0x978 Not
	if(var_68_bool == 0) goto Label_2428; // 0x979 JumpB
	var_62_float = 0; // 0x97a MovI
	return 4; // 0x97b Return
	
Label_2428:
	var_69_string = "reputation"; // 0x97c PushS
	GetProperty(var_69_string, var_66_float); // 0x97d ObjFunc
	var_62_float = var_66_float; // 0x97f Mov
...
func_2440()
{
	...
	func_2341(var_18_bool); // 0x98d Call
...
{
	var_62_float = 0; // 0x9b6 PushV
	func_2420(var_62_float); // 0x9b7 Call
	var_70_float = 0.6; // 0x9b9 PushF
	var_61_bool = var_62_float > var_70_float; // 0x9ba GT2
...
{
	var_23_string = ""; var_24_bool = 0; var_25_string = ""; var_26_bool = 0; // 0x9bc PushV
	var_27_bool = 0; var_28_object = Obj(); var_29_string = ""; // 0x9bd PushV
	var_28_object = var_22_object; // 0x9be Mov
	var_29_string = "class"; // 0x9bf MovS
	func_1742(var_27_bool, var_28_object, var_29_string); // 0x9c0 Call
	var_36_bool = var_27_bool == 0; // 0x9c2 Not
	if(var_36_bool == 0) goto Label_2502; // 0x9c3 JumpB
	var_20_bool = 0; // 0x9c4 MovB
	return 4; // 0x9c5 Return
	
Label_2502:
	var_37_string = "class"; // 0x9c6 PushS
	GetProperty(var_37_string, var_25_string); // 0x9c7 ObjFunc
	var_38_string = "rat"; // 0x9c9 PushS
	var_39_bool = var_25_string == var_38_string; // 0x9ca Eq
	if(var_39_bool == 0) goto Label_2510; // 0x9cb JumpB
	var_20_bool = 0; // 0x9cc MovB
	return 4; // 0x9cd Return
	
Label_2510:
	CanSee(var_26_bool, var_21_object); // 0x9ce Func
	var_40_bool = 0; // 0x9d0 PushV
	var_40_bool = 1; // 0x9d1 MovB
	var_41_bool = var_26_bool; // 0x9d2 Push
	if(var_41_bool == 0) goto Label_2524; // 0x9d3 JumpB
	var_42_float = 0; var_43_object = Obj(); // 0x9d4 PushV
	var_43_object = var_21_object; // 0x9d5 Mov
	func_1734(var_43_object); // 0x9d6 Call
	var_50_float = 250000.0; // 0x9d8 PushF
	var_51_bool = var_42_float <= var_50_float; // 0x9d9 LE
	if(var_51_bool == 0) goto Label_2524; // 0x9da JumpB
	var_40_bool = 0; // 0x9db MovB
	
Label_2524:
	if(var_40_bool == 0) goto Label_2530; // 0x9dc JumpB
	var_52_float = -0.3; // 0x9dd PushF
	ReportReputationChange(var_21_object, var_22_object, var_52_float); // 0x9de Func
	var_20_bool = 1; // 0x9e0 MovB
	return 4; // 0x9e1 Return
	
Label_2530:
	CanSee(var_26_bool, var_22_object); // 0x9e2 Func
	var_53_bool = 0; // 0x9e4 PushV
	var_53_bool = 1; // 0x9e5 MovB
	var_54_bool = var_26_bool; // 0x9e6 Push
	if(var_54_bool == 0) goto Label_2544; // 0x9e7 JumpB
	var_55_float = 0; var_56_object = Obj(); // 0x9e8 PushV
	var_56_object = var_22_object; // 0x9e9 Mov
	func_1734(var_56_object); // 0x9ea Call
	var_57_float = 250000.0; // 0x9ec PushF
	var_58_bool = var_55_float <= var_57_float; // 0x9ed LE
	if(var_58_bool == 0) goto Label_2544; // 0x9ee JumpB
	var_53_bool = 0; // 0x9ef MovB
	
Label_2544:
	if(var_53_bool == 0) goto Label_2547; // 0x9f0 JumpB
	var_20_bool = 1; // 0x9f1 MovB
	return 4; // 0x9f2 Return
	
Label_2547:
	var_20_bool = 0; // 0x9f3 MovB
	return 4; // 0x9f4 Return
}
...
Label_978:
	...
	func_1722(var_121_cvector); // 0x3d7 Call
...
Label_1000:
	...
	func_1722(var_133_cvector); // 0x3f2 Call
...
func_2032(var_85_object)
{
	var_86_float = 0; var_87_cvector = CVector(0,0,0); var_88_float = 0; var_89_cvector = CVector(0,0,0); // 0x7f0 PushV
	GetEyesHeight(var_88_float); // 0x7f1 ObjFunc
	var_89_cvector = CVector(0.0, 0.0, 0.0); // 0x7f3 MovV
	var_90_float = GetByIndex(var_89_cvector, 1); // 0x7f4 PushE
	var_90_float = var_88_float; // 0x7f5 Mov
	SetByIndex(var_89_cvector, 1) = var_90_float; // 0x7f6 PopE
	var_91_string = "head"; // 0x7f7 PushS
	LookAsync(var_85_object, var_91_string, var_89_cvector); // 0x7f8 Func
...
func_2549()
{
	var_70_bool = GlobalVars[1]; // 0x9f6 PushGE
	var_70_bool = 1; // 0x9f7 MovB
	GlobalVars[1] = var_70_bool; // 0x9f8 PopGE
	var_71_int = 50; // 0x9f9 PushI
	var_72_int = 40; // 0x9fa PushI
	SetRTEnvelope(var_71_int, var_72_int); // 0x9fb Func
	var_73_bool = 0; // 0x9fd PushV
	var_73_bool = 0; // 0x9fe MovB
	func_2297(); // 0x9ff Call
