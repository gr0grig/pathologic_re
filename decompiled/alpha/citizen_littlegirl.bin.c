...
task_1_event_0(var_0_bool, var_1_object, var_2_bool, var_3_bool, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2184(var_20_object); // 0x28 Call
	...
	func_2187(var_23_object); // 0x30 Call
...
task_2_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2184(var_20_object); // 0xc5 Call
...
Label_209:
	...
	func_2187(var_26_object); // 0xd3 Call
...
Label_255:
	...
	func_2166(var_94_object); // 0x101 Call
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2174(var_20_object); // 0x107 Call
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2179(var_22_object); // 0x11c Call
...
task_3_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2184(var_20_object); // 0x1e1 Call
...
Label_493:
	...
	func_2187(var_25_object); // 0x1ef Call
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2455(var_20_bool, var_21_object, var_22_object); // 0x20a Call
	...
	func_2156(var_59_int, var_60_object); // 0x20f Call
...
Label_539:
	...
	func_2166(var_93_object); // 0x21d Call
...
task_3_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2174(var_20_object); // 0x223 Call
...
task_3_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2179(var_22_object); // 0x238 Call
...
task_4_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2184(var_20_object); // 0x2d6 Call
...
Label_738:
	...
	func_2187(var_27_object); // 0x2e4 Call
...
task_4_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2455(var_20_bool, var_21_object, var_22_object); // 0x2ff Call
	...
	func_2156(var_59_int, var_60_object); // 0x304 Call
...
Label_784:
	...
	func_2166(var_95_object); // 0x312 Call
...
task_4_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_2174(var_20_object); // 0x318 Call
...
task_4_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2179(var_22_object); // 0x32d Call
...
Label_1538:
	...
	var_52_int = 14787; // 0x609 PushI
	SetMessage(var_52_int); // 0x60a TObjFunc
	ClearReplies(); // 0x60c TObjFunc
	var_53_int = 14788; // 0x60e PushI
	var_54_int = 16035; // 0x60f PushI
	var_55_int = 16034; // 0x610 PushI
	AddReply(var_53_int, var_54_int, var_55_int); // 0x611 TObjFunc
	var_56_int = 14792; // 0x613 PushI
	var_57_int = -1; // 0x614 PushI
	var_58_int = 16038; // 0x615 PushI
	AddReply(var_56_int, var_57_int, var_58_int); // 0x616 TObjFunc
	return 0; // 0x618 Return
	
Label_1561:
	var_59_int = 16035; // 0x619 PushI
	var_60_bool = var_16_int == var_59_int; // 0x61a Eq
	if(var_60_bool == 0) goto Label_1584; // 0x61b JumpB
	var_61_string = ""; // 0x61c PushV
	var_61_string = "Neutral"; // 0x61d MovS
	func_1445(var_17_int, var_61_string); // 0x61e Call
	var_62_int = 14789; // 0x620 PushI
	SetMessage(var_62_int); // 0x621 TObjFunc
	ClearReplies(); // 0x623 TObjFunc
	var_63_int = 14790; // 0x625 PushI
	var_64_int = -1; // 0x626 PushI
	var_65_int = 16036; // 0x627 PushI
	AddReply(var_63_int, var_64_int, var_65_int); // 0x628 TObjFunc
	var_66_int = 14791; // 0x62a PushI
	var_67_int = -1; // 0x62b PushI
	var_68_int = 16037; // 0x62c PushI
	AddReply(var_66_int, var_67_int, var_68_int); // 0x62d TObjFunc
	return 0; // 0x62f Return
	
Label_1584:
	var_69_int = 16028; // 0x630 PushI
	var_70_bool = var_16_int == var_69_int; // 0x631 Eq
	if(var_70_bool == 0) goto Label_1612; // 0x632 JumpB
	var_71_string = ""; // 0x633 PushV
	var_71_string = "Neutral"; // 0x634 MovS
	func_1445(var_17_int, var_71_string); // 0x635 Call
	var_72_int = 14782; // 0x637 PushI
	SetMessage(var_72_int); // 0x638 TObjFunc
	ClearReplies(); // 0x63a TObjFunc
	var_73_int = 14783; // 0x63c PushI
	var_74_int = -1; // 0x63d PushI
	var_75_int = 16029; // 0x63e PushI
	AddReply(var_73_int, var_74_int, var_75_int); // 0x63f TObjFunc
	var_76_int = 14784; // 0x641 PushI
	var_77_int = -1; // 0x642 PushI
	var_78_int = 16030; // 0x643 PushI
	AddReply(var_76_int, var_77_int, var_78_int); // 0x644 TObjFunc
	var_79_int = 14785; // 0x646 PushI
	var_80_int = -1; // 0x647 PushI
	var_81_int = 16031; // 0x648 PushI
	AddReply(var_79_int, var_80_int, var_81_int); // 0x649 TObjFunc
	return 0; // 0x64b Return
	
Label_1612:
	var_82_int = 16019; // 0x64c PushI
	...
	var_85_int = 14773; // 0x653 PushI
	SetMessage(var_85_int); // 0x654 TObjFunc
	ClearReplies(); // 0x656 TObjFunc
	var_86_int = 14774; // 0x658 PushI
	var_87_int = 16021; // 0x659 PushI
	var_88_int = 16020; // 0x65a PushI
	AddReply(var_86_int, var_87_int, var_88_int); // 0x65b TObjFunc
	var_89_int = 14778; // 0x65d PushI
	var_90_int = -1; // 0x65e PushI
	var_91_int = 16024; // 0x65f PushI
	AddReply(var_89_int, var_90_int, var_91_int); // 0x660 TObjFunc
	return 0; // 0x662 Return
	
Label_1635:
	var_92_int = 16021; // 0x663 PushI
...
Label_1658:
	...
	func_2401(var_102_bool); // 0x67c Call
...
func_2121(var_59_int)
{
	...
	func_2449(var_61_bool); // 0x84b Call
...
{
	var_77_object = Obj(); // 0x853 PushV
	var_77_object = var_76_object; // 0x854 Mov
	TaskCall(4); // 0x855 TaskCall
	func_667(var_78_object, var_77_object); // 0x856 Call
...
{
	var_61_bool = 0; var_62_object = Obj(); // 0x86d PushV
	var_62_object = var_60_object; // 0x86e Mov
	func_1744(var_61_bool, var_62_object); // 0x86f Call
	if(var_61_bool == 0) goto Label_2164; // 0x871 JumpB
	var_59_int = 2; // 0x872 MovI
...
Label_1156:
	...
	func_1671(var_148_cvector); // 0x489 Call
...
Label_1178:
	...
	func_1671(var_160_cvector); // 0x4a4 Call
...
{
	var_96_object = Obj(); // 0x877 PushV
	var_96_object = var_95_object; // 0x878 Mov
	TaskCall(6); // 0x879 TaskCall
	func_1136(var_97_object, var_98_cvector, var_99_bool, var_96_object); // 0x87a Call
...
{
	var_28_object = Obj(); // 0x88c PushV
	var_28_object = var_27_object; // 0x88d Mov
	func_2411(var_27_object, var_28_object); // 0x88e Call
...
func_1683(var_42_float)
{
	var_44_cvector = CVector(0,0,0); var_45_cvector = CVector(0,0,0); var_46_cvector = CVector(0,0,0); var_47_cvector = CVector(0,0,0); var_48_cvector = CVector(0,0,0); var_49_cvector = CVector(0,0,0); // 0x693 PushV
	GetPosition(var_47_cvector); // 0x694 Func
	GetPosition(var_48_cvector); // 0x696 ObjFunc
	var_49_cvector = var_48_cvector - var_47_cvector; // 0x698 Sub2
	var_42_float = var_49_cvector | var_49_cvector; // 0x699 Or2
...
func_667(var_0_bool, var_77_object)
{
	...
	func_1676(var_93_object); // 0x2a4 Call
	...
	func_2036(var_98_float, var_99_cvector, var_100_cvector); // 0x2aa Call
...
func_718(var_0_bool)
{
	...
	func_1981(var_85_object); // 0x2d0 Call
...
Label_1294:
	...
	func_2397(var_86_int); // 0x511 Call
	SetNPCName(var_86_int); // 0x513 ObjFunc
	var_87_string = ""; // 0x515 PushV
	func_2399(var_87_string); // 0x516 Call
...
{
	var_63_object = Obj(); var_64_float = 0; var_65_object = Obj(); var_66_float = 0; // 0x94f PushV
	var_67_string = "player"; // 0x950 PushS
	FindActor(var_65_object, var_67_string); // 0x951 Func
	var_68_bool = var_65_object == 0; // 0x953 Not
	if(var_68_bool == 0) goto Label_2391; // 0x954 JumpB
	var_62_float = 0; // 0x955 MovI
	return 4; // 0x956 Return
	
Label_2391:
	var_69_string = "reputation"; // 0x957 PushS
	GetProperty(var_69_string, var_66_float); // 0x958 ObjFunc
	var_62_float = var_66_float; // 0x95a Mov
	return 4; // 0x95b Return
}
...
{
	var_87_string = "ui/NPC_None.png"; // 0x95f MovS
...
func_2403()
{
	var_17_bool = GlobalVars[1]; // 0x963 PushGE
	var_17_bool = 0; // 0x964 MovB
	GlobalVars[1] = var_17_bool; // 0x965 PopGE
	var_18_bool = 0; // 0x966 PushV
	var_18_bool = 0; // 0x967 MovB
	func_2290(var_18_bool); // 0x968 Call
...
Label_388:
	...
	func_2130(var_76_object); // 0x186 Call
...
{
	var_29_bool = 0; var_30_bool = 0; // 0x96b PushV
	var_31_bool = GlobalVars[1]; // 0x96c PushGE
	if(var_31_bool == 0) goto Label_2422; // 0x96d JumpB
	IsOverrideActive(var_30_bool); // 0x96e Func
	var_32_bool = var_30_bool == 0; // 0x970 Not
	if(var_32_bool == 0) goto Label_2420; // 0x971 JumpB
	WorkWithCorpse(var_28_object); // 0x972 Func
	
Label_2420:
	return 2; // 0x974 Return
	
Label_2422:
	var_33_int = 1000; // 0x976 PushI
	var_34_int = 0; var_35_object = Obj(); // 0x977 PushV
	var_35_object = var_28_object; // 0x978 Mov
	TaskCall(7); // 0x979 TaskCall
	func_1284(var_36_object, var_34_int, var_35_object); // 0x97a Call
	TaskReturn(); // 0x97b TaskReturn
	var_136_bool = var_33_int == var_36_object; // 0x97d Eq
	if(var_136_bool == 0) goto Label_2448; // 0x97e JumpB
	var_137_bool = 0; var_138_object = Obj(); // 0x97f PushV
	var_138_object = var_28_object; // 0x980 Mov
	func_1911(var_138_object); // 0x981 Call
	var_166_bool = var_137_bool == 0; // 0x983 Not
	if(var_166_bool == 0) goto Label_2438; // 0x984 JumpB
	return 2; // 0x985 Return
	
Label_2438:
	var_167_object = Obj(); // 0x986 PushV
	var_167_object = var_28_object; // 0x987 Mov
	TaskCall(0); // 0x988 TaskCall
	func_0(var_167_object); // 0x989 Call
	TaskReturn(); // 0x98a TaskReturn
	var_172_object = Obj(); // 0x98c PushV
	var_172_object = var_28_object; // 0x98d Mov
	func_1959(); // 0x98e Call
...
{
	var_62_float = 0; // 0x991 PushV
	func_2383(var_62_float); // 0x992 Call
	var_70_float = 0.2; // 0x994 PushF
	var_61_bool = var_62_float > var_70_float; // 0x995 GT2
...
{
	var_23_string = ""; var_24_bool = 0; var_25_string = ""; var_26_bool = 0; // 0x997 PushV
	var_27_bool = 0; var_28_object = Obj(); var_29_string = ""; // 0x998 PushV
	var_28_object = var_22_object; // 0x999 Mov
	var_29_string = "class"; // 0x99a MovS
	func_1691(var_27_bool, var_28_object, var_29_string); // 0x99b Call
	var_36_bool = var_27_bool == 0; // 0x99d Not
	if(var_36_bool == 0) goto Label_2465; // 0x99e JumpB
	var_20_bool = 0; // 0x99f MovB
	return 4; // 0x9a0 Return
	
Label_2465:
	var_37_string = "class"; // 0x9a1 PushS
	GetProperty(var_37_string, var_25_string); // 0x9a2 ObjFunc
	var_38_string = "rat"; // 0x9a4 PushS
	var_39_bool = var_25_string == var_38_string; // 0x9a5 Eq
	if(var_39_bool == 0) goto Label_2473; // 0x9a6 JumpB
	var_20_bool = 0; // 0x9a7 MovB
	return 4; // 0x9a8 Return
	
Label_2473:
	CanSee(var_26_bool, var_21_object); // 0x9a9 Func
	var_40_bool = 0; // 0x9ab PushV
	var_40_bool = 1; // 0x9ac MovB
	var_41_bool = var_26_bool; // 0x9ad Push
	if(var_41_bool == 0) goto Label_2487; // 0x9ae JumpB
	var_42_float = 0; var_43_object = Obj(); // 0x9af PushV
	var_43_object = var_21_object; // 0x9b0 Mov
	func_1683(var_43_object); // 0x9b1 Call
	var_50_float = 250000.0; // 0x9b3 PushF
	var_51_bool = var_42_float <= var_50_float; // 0x9b4 LE
	if(var_51_bool == 0) goto Label_2487; // 0x9b5 JumpB
	var_40_bool = 0; // 0x9b6 MovB
	
Label_2487:
	if(var_40_bool == 0) goto Label_2493; // 0x9b7 JumpB
	var_52_float = -0.3; // 0x9b8 PushF
	ReportReputationChange(var_21_object, var_22_object, var_52_float); // 0x9b9 Func
	var_20_bool = 1; // 0x9bb MovB
	return 4; // 0x9bc Return
	
Label_2493:
	CanSee(var_26_bool, var_22_object); // 0x9bd Func
	var_53_bool = 0; // 0x9bf PushV
	var_53_bool = 1; // 0x9c0 MovB
	var_54_bool = var_26_bool; // 0x9c1 Push
	if(var_54_bool == 0) goto Label_2507; // 0x9c2 JumpB
	var_55_float = 0; var_56_object = Obj(); // 0x9c3 PushV
	var_56_object = var_22_object; // 0x9c4 Mov
	func_1683(var_56_object); // 0x9c5 Call
	var_57_float = 250000.0; // 0x9c7 PushF
	var_58_bool = var_55_float <= var_57_float; // 0x9c8 LE
	if(var_58_bool == 0) goto Label_2507; // 0x9c9 JumpB
	var_53_bool = 0; // 0x9ca MovB
	
Label_2507:
	if(var_53_bool == 0) goto Label_2510; // 0x9cb JumpB
	var_20_bool = 1; // 0x9cc MovB
	return 4; // 0x9cd Return
	
Label_2510:
	var_20_bool = 0; // 0x9ce MovB
	return 4; // 0x9cf Return
}
...
func_1445(var_2_bool, var_27_string)
{
	...
	func_2401(var_28_bool); // 0x5a7 Call
...
{
	var_86_float = 0; var_87_cvector = CVector(0,0,0); var_88_float = 0; var_89_cvector = CVector(0,0,0); // 0x7bd PushV
	GetEyesHeight(var_88_float); // 0x7be ObjFunc
	var_89_cvector = CVector(0.0, 0.0, 0.0); // 0x7c0 MovV
	var_90_float = GetByIndex(var_89_cvector, 1); // 0x7c1 PushE
	var_90_float = var_88_float; // 0x7c2 Mov
	SetByIndex(var_89_cvector, 1) = var_90_float; // 0x7c3 PopE
	var_91_string = "head"; // 0x7c4 PushS
	LookAsync(var_85_object, var_91_string, var_89_cvector); // 0x7c5 Func
...
func_1992()
{
	...
	func_2401(var_19_bool); // 0x7c9 Call
...
func_2512()
{
	var_70_bool = GlobalVars[1]; // 0x9d1 PushGE
	var_70_bool = 1; // 0x9d2 MovB
	GlobalVars[1] = var_70_bool; // 0x9d3 PopGE
	var_71_int = 50; // 0x9d4 PushI
	var_72_int = 40; // 0x9d5 PushI
	SetRTEnvelope(var_71_int, var_72_int); // 0x9d6 Func
	var_73_bool = 0; // 0x9d8 PushV
	var_73_bool = 1; // 0x9d9 MovB
	func_2246(); // 0x9da Call
