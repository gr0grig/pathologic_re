...
0x8a9: Push("reputation")
0x8aa: @@ GetProperty(Stack[-1], Stack[-2])
0x8ab: Pop(1)
0x8ac: Stack[-5] = Stack[-1]
0x8ad: Return(); Pop(4)
...
0x8ed: Push("class")
0x8ee: @@ GetProperty(Stack[-1], Stack[-3])
0x8ef: Pop(1)
0x8f0: Push("rat")
...
0x8ff: Push(Stack[-2])
0x900: IF (Stack[-1] == 0) GOTO 0x909; Pop(1)

0x901: PushEmpty(float, object)
0x902: Stack[-1] = Stack[-9]
0x903: Call 0x5b9
