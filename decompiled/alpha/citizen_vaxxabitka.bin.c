...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2275(var_20_bool, var_21_object, var_22_object); // 0xee Call
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2275(var_20_bool, var_21_object, var_22_object); // 0x20a Call
...
task_4_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2275(var_20_bool, var_21_object, var_22_object); // 0x2ff Call
...
func_667(var_0_bool, var_77_object)
{
	...
	func_1458(var_93_object); // 0x2a4 Call
	...
	func_1818(var_98_float, var_99_cvector, var_100_cvector); // 0x2aa Call
...
{
	var_63_object = Obj(); var_64_float = 0; var_65_object = Obj(); var_66_float = 0; // 0x8a1 PushV
	var_67_string = "player"; // 0x8a2 PushS
	FindActor(var_65_object, var_67_string); // 0x8a3 Func
	var_68_bool = var_65_object == 0; // 0x8a5 Not
	if(var_68_bool == 0) goto Label_2217; // 0x8a6 JumpB
	var_62_float = 0; // 0x8a7 MovI
	return 4; // 0x8a8 Return
	
Label_2217:
	var_69_string = "reputation"; // 0x8a9 PushS
	GetProperty(var_69_string, var_66_float); // 0x8aa ObjFunc
	var_62_float = var_66_float; // 0x8ac Mov
...
func_2223()
{
	var_17_bool = GlobalVars[1]; // 0x8af PushGE
	var_17_bool = 0; // 0x8b0 MovB
	GlobalVars[1] = var_17_bool; // 0x8b1 PopGE
	var_18_bool = 0; // 0x8b2 PushV
	var_18_bool = 0; // 0x8b3 MovB
	func_2023(var_18_bool); // 0x8b4 Call
...
{
	var_29_bool = 0; var_30_bool = 0; // 0x8b7 PushV
	var_31_bool = GlobalVars[1]; // 0x8b8 PushGE
	if(var_31_bool == 0) goto Label_2242; // 0x8b9 JumpB
	IsOverrideActive(var_30_bool); // 0x8ba Func
	var_32_bool = var_30_bool == 0; // 0x8bc Not
	if(var_32_bool == 0) goto Label_2240; // 0x8bd JumpB
	WorkWithCorpse(var_28_object); // 0x8be Func
	
Label_2240:
	return 2; // 0x8c0 Return
	
Label_2242:
	var_33_int = 1000; // 0x8c2 PushI
	var_34_int = 0; var_35_object = Obj(); // 0x8c3 PushV
	var_35_object = var_28_object; // 0x8c4 Mov
	TaskCall(7); // 0x8c5 TaskCall
	func_1284(var_36_object, var_34_int, var_35_object); // 0x8c6 Call
	TaskReturn(); // 0x8c7 TaskReturn
	var_133_bool = var_33_int == var_36_object; // 0x8c9 Eq
	if(var_133_bool == 0) goto Label_2268; // 0x8ca JumpB
	var_134_bool = 0; var_135_object = Obj(); // 0x8cb PushV
	var_135_object = var_28_object; // 0x8cc Mov
	func_1693(var_135_object); // 0x8cd Call
	var_163_bool = var_134_bool == 0; // 0x8cf Not
	if(var_163_bool == 0) goto Label_2258; // 0x8d0 JumpB
	return 2; // 0x8d1 Return
	
Label_2258:
	var_164_object = Obj(); // 0x8d2 PushV
	var_164_object = var_28_object; // 0x8d3 Mov
	TaskCall(0); // 0x8d4 TaskCall
	func_0(var_164_object); // 0x8d5 Call
	TaskReturn(); // 0x8d6 TaskReturn
	var_169_object = Obj(); // 0x8d8 PushV
	var_169_object = var_28_object; // 0x8d9 Mov
	func_1741(); // 0x8da Call
...
func_718(var_0_bool)
{
	...
	func_1763(var_85_object); // 0x2d0 Call
...
{
	var_62_float = 0; // 0x8dd PushV
	func_2209(var_62_float); // 0x8de Call
	var_70_float = 0.9; // 0x8e0 PushF
	var_61_bool = var_62_float > var_70_float; // 0x8e1 GT2
...
{
	var_23_string = ""; var_24_bool = 0; var_25_string = ""; var_26_bool = 0; // 0x8e3 PushV
	var_27_bool = 0; var_28_object = Obj(); var_29_string = ""; // 0x8e4 PushV
	var_28_object = var_22_object; // 0x8e5 Mov
	var_29_string = "class"; // 0x8e6 MovS
	func_1473(var_27_bool, var_28_object, var_29_string); // 0x8e7 Call
	var_36_bool = var_27_bool == 0; // 0x8e9 Not
	if(var_36_bool == 0) goto Label_2285; // 0x8ea JumpB
	var_20_bool = 0; // 0x8eb MovB
	return 4; // 0x8ec Return
	
Label_2285:
	var_37_string = "class"; // 0x8ed PushS
	GetProperty(var_37_string, var_25_string); // 0x8ee ObjFunc
	var_38_string = "rat"; // 0x8f0 PushS
	var_39_bool = var_25_string == var_38_string; // 0x8f1 Eq
	if(var_39_bool == 0) goto Label_2294; // 0x8f2 JumpB
	var_20_bool = 0; // 0x8f3 MovB
	return 4; // 0x8f4 Return
	
Label_2294:
	var_40_string = "dog"; // 0x8f6 PushS
	var_41_bool = var_25_string == var_40_string; // 0x8f7 Eq
	if(var_41_bool == 0) goto Label_2299; // 0x8f8 JumpB
	var_20_bool = 0; // 0x8f9 MovB
	return 4; // 0x8fa Return
	
Label_2299:
	CanSee(var_26_bool, var_21_object); // 0x8fb Func
	var_42_bool = 0; // 0x8fd PushV
	var_42_bool = 1; // 0x8fe MovB
	var_43_bool = var_26_bool; // 0x8ff Push
	if(var_43_bool == 0) goto Label_2313; // 0x900 JumpB
	var_44_float = 0; var_45_object = Obj(); // 0x901 PushV
	var_45_object = var_21_object; // 0x902 Mov
	func_1465(var_45_object); // 0x903 Call
	var_52_float = 250000.0; // 0x905 PushF
	var_53_bool = var_44_float <= var_52_float; // 0x906 LE
	if(var_53_bool == 0) goto Label_2313; // 0x907 JumpB
	var_42_bool = 0; // 0x908 MovB
	
Label_2313:
	if(var_42_bool == 0) goto Label_2319; // 0x909 JumpB
	var_54_float = -0.3; // 0x90a PushF
	ReportReputationChange(var_21_object, var_22_object, var_54_float); // 0x90b Func
	var_20_bool = 1; // 0x90d MovB
	return 4; // 0x90e Return
	
Label_2319:
	var_20_bool = 0; // 0x90f MovB
	return 4; // 0x910 Return
}


func_1763(var_85_object)
{
	var_86_float = 0; var_87_cvector = CVector(0,0,0); var_88_float = 0; var_89_cvector = CVector(0,0,0); // 0x6e3 PushV
	GetEyesHeight(var_88_float); // 0x6e4 ObjFunc
	var_89_cvector = CVector(0.0, 0.0, 0.0); // 0x6e6 MovV
	var_90_float = GetByIndex(var_89_cvector, 1); // 0x6e7 PushE
	var_90_float = var_88_float; // 0x6e8 Mov
	SetByIndex(var_89_cvector, 1) = var_90_float; // 0x6e9 PopE
	var_91_string = "head"; // 0x6ea PushS
	LookAsync(var_85_object, var_91_string, var_89_cvector); // 0x6eb Func
...
func_2321()
{
	var_70_bool = GlobalVars[1]; // 0x912 PushGE
	var_70_bool = 1; // 0x913 MovB
	GlobalVars[1] = var_70_bool; // 0x914 PopGE
	var_71_int = 50; // 0x915 PushI
	var_72_int = 40; // 0x916 PushI
	SetRTEnvelope(var_71_int, var_72_int); // 0x917 Func
...
Label_388:
	...
	func_1912(var_76_object); // 0x186 Call
...
func_1903(var_59_int)
{
	...
	func_2269(var_61_bool); // 0x771 Call
...
{
	var_77_object = Obj(); // 0x779 PushV
	var_77_object = var_76_object; // 0x77a Mov
	TaskCall(4); // 0x77b TaskCall
	func_667(var_78_object, var_77_object); // 0x77c Call
...
func_1969(var_27_object)
{
	...
	func_2231(var_27_object, var_28_object); // 0x7b4 Call
