...
Label_233:
	...
	func_1716(var_85_object); // 0xeb Call
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool)
{
	...
	func_1983(var_15_bool, var_16_object, var_17_object); // 0x1f4 Call
	...
	func_1706(var_50_int, var_51_object); // 0x1f9 Call
...
Label_517:
	...
	func_1716(var_84_object); // 0x207 Call
...
task_3_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool)
{
	...
	func_1978(var_15_object); // 0x293 Call
...
task_4_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool)
{
	...
	func_1978(var_15_object); // 0x2ed Call
...
func_645(var_62_object)
{
	...
	func_1973(var_63_bool, var_64_object); // 0x288 Call
...
{
	var_89_cvector = CVector(0,0,0); var_90_float = 0; var_91_bool = 0; var_92_cvector = CVector(0,0,0); var_93_float = 0; var_94_cvector = CVector(0,0,0); var_95_float = 0; var_96_bool = 0; var_97_cvector = CVector(0,0,0); var_98_float = 0; // 0x49a PushV
	var_0_bool = var_85_object; // 0x49b TMov
	var_99_cvector = CVector(0,0,0); var_100_float = 0; // 0x49c PushV
	var_100_float = 1.74533; // 0x49d MovF
	func_1148(var_99_cvector, var_100_float); // 0x49e Call
	var_94_cvector = var_99_cvector; // 0x49f Mov
	var_95_float = var_94_cvector | var_94_cvector; // 0x4a1 Or2
	var_129_float = 10000.0; // 0x4a2 PushF
	var_130_bool = var_95_float < var_129_float; // 0x4a3 LT
	if(var_130_bool == 0) goto Label_1198; // 0x4a4 JumpB
	var_131_string = "Can't retreat, distance: "; // 0x4a5 PushS
	var_132_float = sqrt(var_95_float); // 0x4a6 Sqrt
	var_133_int = var_131_string + var_132_float; // 0x4a7 Add
	Trace(var_133_int); // 0x4a8 Func
	var_134_float = 0.5; // 0x4aa PushF
	Sleep(var_134_float); // 0x4ab Func
	return 10; // 0x4ad Return
	
Label_1198:
	var_135_float = GetByIndex(var_94_cvector, 0); // 0x4ae PushE
	var_136_float = GetByIndex(var_94_cvector, 2); // 0x4af PushE
	Rotate(var_135_float, var_136_float); // 0x4b0 Func
	var_137_cvector = CVector(0,0,0); // 0x4b2 PushV
	func_1326(var_137_cvector); // 0x4b3 Call
	var_1_bool = var_137_cvector + var_94_cvector; // 0x4b5 Add2
	var_140_int = 120; // 0x4b6 PushI
	var_141_float = 0.5; // 0x4b7 PushF
	SetTimer(var_140_int, var_141_float); // 0x4b8 Func
	var_2_bool = 0; // 0x4ba TMovB
	
Label_1211:
	var_142_int = 1; // 0x4bb PushI
	MovePoint(var_142_int, var_142_int, var_96_bool); // 0x4bc Func
	var_143_bool = var_96_bool; // 0x4be Push
	if(var_143_bool == 0) goto Label_1239; // 0x4bf JumpB
	var_144_bool = var_0_bool == 0; // 0x4c0 NullEq
	if(var_144_bool == 0) goto Label_1220; // 0x4c1 JumpB
...
Label_1220:
	var_145_cvector = CVector(0,0,0); var_146_float = 0; // 0x4c4 PushV
	var_146_float = 2.61799; // 0x4c5 MovF
	func_1148(var_145_cvector, var_146_float); // 0x4c6 Call
	var_97_cvector = var_145_cvector; // 0x4c7 Mov
	var_98_float = var_97_cvector | var_97_cvector; // 0x4c9 Or2
	var_147_float = 10000.0; // 0x4ca PushF
	var_148_bool = var_98_float >= var_147_float; // 0x4cb GE
	if(var_148_bool == 0) goto Label_1238; // 0x4cc JumpB
	var_149_cvector = CVector(0,0,0); // 0x4cd PushV
	func_1326(var_149_cvector); // 0x4ce Call
	var_1_bool = var_149_cvector + var_97_cvector; // 0x4d0 Add2
	var_150_int = 120; // 0x4d1 PushI
	var_151_float = 0.5; // 0x4d2 PushF
	SetTimer(var_150_int, var_151_float); // 0x4d3 Func
	goto Label_1239; // 0x4d5 Jump
	
Label_1239:
	var_152_bool = var_2_bool == 0; // 0x4d7 Not
	if(var_152_bool == 0) goto Label_1211; // 0x4d8 JumpB
...
{
	var_53_int = 0; var_54_int = 0; // 0x79d PushV
	GetInvItemByName(var_54_int, var_52_string); // 0x79e Func
	var_51_int = var_54_int; // 0x7a0 Mov
...
func_1954()
{
	var_12_bool = GlobalVars[0]; // 0x7a2 PushGE
	var_12_bool = 0; // 0x7a3 MovB
	GlobalVars[0] = var_12_bool; // 0x7a4 PopGE
	var_13_bool = 0; // 0x7a5 PushV
	var_13_bool = 0; // 0x7a6 MovB
	func_1774(var_13_bool); // 0x7a7 Call
...
func_163()
{
	...
	func_1575(var_130_bool); // 0xa4 Call
...
{
	var_131_bool = 0; var_132_bool = 0; // 0x627 PushV
	IsLoaded(var_132_bool); // 0x628 Func
	var_130_bool = var_132_bool; // 0x62a Mov
...
{
	var_52_bool = 0; var_53_object = Obj(); // 0x6ab PushV
	var_53_object = var_51_object; // 0x6ac Mov
	func_1484(var_52_bool, var_53_object); // 0x6ad Call
	if(var_52_bool == 0) goto Label_1714; // 0x6af JumpB
	var_50_int = 2; // 0x6b0 MovI
...
{
	var_22_bool = 0; var_23_bool = 0; // 0x7aa PushV
	var_24_bool = GlobalVars[0]; // 0x7ab PushGE
	if(var_24_bool == 0) goto Label_1972; // 0x7ac JumpB
	IsOverrideActive(var_23_bool); // 0x7ad Func
	var_25_bool = var_23_bool == 0; // 0x7af Not
	if(var_25_bool == 0) goto Label_1971; // 0x7b0 JumpB
	WorkWithCorpse(var_21_object); // 0x7b1 Func
...
{
	var_85_object = Obj(); // 0x6b5 PushV
	var_85_object = var_84_object; // 0x6b6 Mov
	TaskCall(6); // 0x6b7 TaskCall
	func_1178(var_86_object, var_87_cvector, var_88_bool, var_85_object); // 0x6b8 Call
...
{
	var_65_bool = 0; var_66_bool = 0; // 0x7b5 PushV
	IsPlayerActor(var_64_object, var_66_bool); // 0x7b6 Func
	var_63_bool = var_66_bool; // 0x7b8 Mov
...
func_571()
{
	...
	func_1575(var_171_bool); // 0x23f Call
...
Label_580:
	...
	func_1660(var_173_int); // 0x245 Call
...
Label_585:
	...
	func_1575(var_189_bool); // 0x24f Call
...
Label_595:
	...
	func_1653(var_195_string, var_196_int); // 0x261 Call
...
func_1338(var_39_float)
{
	var_41_cvector = CVector(0,0,0); var_42_cvector = CVector(0,0,0); var_43_cvector = CVector(0,0,0); var_44_cvector = CVector(0,0,0); var_45_cvector = CVector(0,0,0); var_46_cvector = CVector(0,0,0); // 0x53a PushV
	GetPosition(var_44_cvector); // 0x53b Func
	GetPosition(var_45_cvector); // 0x53d ObjFunc
	var_46_cvector = var_45_cvector - var_44_cvector; // 0x53f Sub2
	var_39_float = var_46_cvector | var_46_cvector; // 0x540 Or2
...
{
	var_18_string = ""; var_19_bool = 0; var_20_string = ""; var_21_bool = 0; // 0x7bf PushV
	var_22_bool = 0; var_23_object = Obj(); var_24_string = ""; // 0x7c0 PushV
	var_23_object = var_17_object; // 0x7c1 Mov
	var_24_string = "class"; // 0x7c2 MovS
	func_1346(var_22_bool, var_23_object, var_24_string); // 0x7c3 Call
	var_31_bool = var_22_bool == 0; // 0x7c5 Not
	if(var_31_bool == 0) goto Label_1993; // 0x7c6 JumpB
	var_15_bool = 0; // 0x7c7 MovB
	return 4; // 0x7c8 Return
	
Label_1993:
	var_32_string = "class"; // 0x7c9 PushS
	GetProperty(var_32_string, var_20_string); // 0x7ca ObjFunc
	var_33_string = "rat"; // 0x7cc PushS
	var_34_bool = var_20_string == var_33_string; // 0x7cd Eq
	if(var_34_bool == 0) goto Label_2002; // 0x7ce JumpB
	var_15_bool = 0; // 0x7cf MovB
	return 4; // 0x7d0 Return
	
Label_2002:
	var_35_string = "dog"; // 0x7d2 PushS
	var_36_bool = var_20_string == var_35_string; // 0x7d3 Eq
	if(var_36_bool == 0) goto Label_2007; // 0x7d4 JumpB
	var_15_bool = 0; // 0x7d5 MovB
	return 4; // 0x7d6 Return
	
Label_2007:
	CanSee(var_21_bool, var_16_object); // 0x7d7 Func
	var_37_bool = 0; // 0x7d9 PushV
	var_37_bool = 1; // 0x7da MovB
	var_38_bool = var_21_bool; // 0x7db Push
	if(var_38_bool == 0) goto Label_2021; // 0x7dc JumpB
	var_39_float = 0; var_40_object = Obj(); // 0x7dd PushV
	var_40_object = var_16_object; // 0x7de Mov
	func_1338(var_40_object); // 0x7df Call
	var_47_float = 250000.0; // 0x7e1 PushF
	var_48_bool = var_39_float <= var_47_float; // 0x7e2 LE
	if(var_48_bool == 0) goto Label_2021; // 0x7e3 JumpB
	var_37_bool = 0; // 0x7e4 MovB
	
Label_2021:
	if(var_37_bool == 0) goto Label_2027; // 0x7e5 JumpB
	var_49_float = -0.3; // 0x7e6 PushF
	ReportReputationChange(var_16_object, var_17_object, var_49_float); // 0x7e7 Func
	var_15_bool = 1; // 0x7e9 MovB
	return 4; // 0x7ea Return
	
Label_2027:
	var_15_bool = 0; // 0x7eb MovB
	return 4; // 0x7ec Return
}
...
func_1737(var_20_object)
{
	...
	func_1962(var_21_object); // 0x6cc Call
...
func_2029()
{
	var_65_bool = GlobalVars[0]; // 0x7ee PushGE
	var_65_bool = 1; // 0x7ef MovB
	GlobalVars[0] = var_65_bool; // 0x7f0 PopGE
	var_66_int = 50; // 0x7f1 PushI
	var_67_int = 40; // 0x7f2 PushI
	SetRTEnvelope(var_66_int, var_67_int); // 0x7f3 Func
...
{
	var_14_int = 0; var_15_bool = 0; var_16_int = 0; var_17_bool = 0; // 0x6ee PushV
	var_18_bool = var_13_bool; // 0x6ef Push
	if(var_18_bool == 0) goto Label_1863; // 0x6f0 JumpB
	var_19_int = 0; var_20_int = 0; // 0x6f1 PushV
	var_19_int = 0; // 0x6f2 MovI
	var_21_int = 100; // 0x6f3 PushI
	var_22_int = 0; // 0x6f4 PushV
	func_1609(var_22_int); // 0x6f5 Call
	var_28_int = 100; // 0x6f7 PushI
	var_29_float = var_22_int * var_28_int; // 0x6f8 Mult
	var_20_int = var_21_int + var_29_float; // 0x6f9 Add2
	func_1744(var_19_int, var_20_int); // 0x6fa Call
	var_48_int = 9; // 0x6fc PushI
	irand(var_16_int, var_48_int); // 0x6fd Func
	var_49_int = 0; // 0x6ff PushI
	var_50_bool = var_16_int == var_49_int; // 0x700 Eq
	if(var_50_bool == 0) goto Label_1803; // 0x701 JumpB
	var_51_int = 0; var_52_string = ""; // 0x702 PushV
	var_52_string = "lemon"; // 0x703 MovS
	func_1949(var_51_int, var_52_string); // 0x704 Call
	var_55_int = 0; // 0x706 PushI
	var_56_int = 1; // 0x707 PushI
	AddItem(var_17_bool, var_51_int, var_55_int, var_56_int); // 0x708 Func
	goto Label_1862; // 0x70a Jump
	
Label_1862:
	goto Label_1948; // 0x746 Jump
	
Label_1948:
	return 4; // 0x79c Return
	
Label_1803:
	var_57_int = 1; // 0x70b PushI
	var_58_bool = var_16_int == var_57_int; // 0x70c Eq
	if(var_58_bool == 0) goto Label_1815; // 0x70d JumpB
	var_59_int = 0; var_60_string = ""; // 0x70e PushV
	var_60_string = "rusk"; // 0x70f MovS
	func_1949(var_59_int, var_60_string); // 0x710 Call
	var_61_int = 0; // 0x712 PushI
	var_62_int = 1; // 0x713 PushI
	AddItem(var_17_bool, var_59_int, var_61_int, var_62_int); // 0x714 Func
	goto Label_1862; // 0x716 Jump
	
Label_1815:
	var_63_int = 2; // 0x717 PushI
	var_64_bool = var_16_int == var_63_int; // 0x718 Eq
	if(var_64_bool == 0) goto Label_1827; // 0x719 JumpB
	var_65_int = 0; var_66_string = ""; // 0x71a PushV
	var_66_string = "hook"; // 0x71b MovS
	func_1949(var_65_int, var_66_string); // 0x71c Call
	var_67_int = 0; // 0x71e PushI
	var_68_int = 1; // 0x71f PushI
	AddItem(var_17_bool, var_65_int, var_67_int, var_68_int); // 0x720 Func
	goto Label_1862; // 0x722 Jump
	
Label_1827:
	var_69_int = 4; // 0x723 PushI
	var_70_bool = var_16_int == var_69_int; // 0x724 Eq
	if(var_70_bool == 0) goto Label_1839; // 0x725 JumpB
	var_71_int = 0; var_72_string = ""; // 0x726 PushV
	var_72_string = "syringe"; // 0x727 MovS
	func_1949(var_71_int, var_72_string); // 0x728 Call
	var_73_int = 0; // 0x72a PushI
	var_74_int = 1; // 0x72b PushI
	AddItem(var_17_bool, var_71_int, var_73_int, var_74_int); // 0x72c Func
	goto Label_1862; // 0x72e Jump
	
Label_1839:
	var_75_int = 5; // 0x72f PushI
	var_76_bool = var_16_int == var_75_int; // 0x730 Eq
	if(var_76_bool == 0) goto Label_1851; // 0x731 JumpB
	var_77_int = 0; var_78_string = ""; // 0x732 PushV
	var_78_string = "watch"; // 0x733 MovS
	func_1949(var_77_int, var_78_string); // 0x734 Call
	var_79_int = 0; // 0x736 PushI
	var_80_int = 1; // 0x737 PushI
	AddItem(var_17_bool, var_77_int, var_79_int, var_80_int); // 0x738 Func
	goto Label_1862; // 0x73a Jump
	
Label_1851:
	var_81_int = 6; // 0x73b PushI
	var_82_bool = var_16_int == var_81_int; // 0x73c Eq
	if(var_82_bool == 0) goto Label_1862; // 0x73d JumpB
	var_83_int = 0; var_84_string = ""; // 0x73e PushV
	var_84_string = "razor"; // 0x73f MovS
	func_1949(var_83_int, var_84_string); // 0x740 Call
	var_85_int = 0; // 0x742 PushI
	var_86_int = 1; // 0x743 PushI
	AddItem(var_17_bool, var_83_int, var_85_int, var_86_int); // 0x744 Func
	
Label_1863:
	var_87_int = 0; var_88_int = 0; // 0x747 PushV
	var_87_int = 0; // 0x748 MovI
	var_89_int = 50; // 0x749 PushI
	var_90_int = 0; // 0x74a PushV
	func_1609(var_90_int); // 0x74b Call
	var_91_int = 50; // 0x74d PushI
	var_92_float = var_90_int * var_91_int; // 0x74e Mult
	var_88_int = var_89_int + var_92_float; // 0x74f Add2
	func_1744(var_87_int, var_88_int); // 0x750 Call
	var_93_int = 8; // 0x752 PushI
	irand(var_16_int, var_93_int); // 0x753 Func
	var_94_int = 0; // 0x755 PushI
	var_95_bool = var_16_int == var_94_int; // 0x756 Eq
	if(var_95_bool == 0) goto Label_1889; // 0x757 JumpB
	var_96_int = 0; var_97_string = ""; // 0x758 PushV
	var_97_string = "beads"; // 0x759 MovS
	func_1949(var_96_int, var_97_string); // 0x75a Call
	var_98_int = 0; // 0x75c PushI
	var_99_int = 1; // 0x75d PushI
	AddItem(var_17_bool, var_96_int, var_98_int, var_99_int); // 0x75e Func
	goto Label_1948; // 0x760 Jump
	
Label_1889:
	var_100_int = 1; // 0x761 PushI
	var_101_bool = var_16_int == var_100_int; // 0x762 Eq
	if(var_101_bool == 0) goto Label_1901; // 0x763 JumpB
	var_102_int = 0; var_103_string = ""; // 0x764 PushV
	var_103_string = "bracelet"; // 0x765 MovS
	func_1949(var_102_int, var_103_string); // 0x766 Call
	var_104_int = 0; // 0x768 PushI
	var_105_int = 1; // 0x769 PushI
	AddItem(var_17_bool, var_102_int, var_104_int, var_105_int); // 0x76a Func
	goto Label_1948; // 0x76c Jump
	
Label_1901:
	var_106_int = 2; // 0x76d PushI
	var_107_bool = var_16_int == var_106_int; // 0x76e Eq
	if(var_107_bool == 0) goto Label_1913; // 0x76f JumpB
	var_108_int = 0; var_109_string = ""; // 0x770 PushV
	var_109_string = "ear_ring"; // 0x771 MovS
	func_1949(var_108_int, var_109_string); // 0x772 Call
	var_110_int = 0; // 0x774 PushI
	var_111_int = 1; // 0x775 PushI
	AddItem(var_17_bool, var_108_int, var_110_int, var_111_int); // 0x776 Func
	goto Label_1948; // 0x778 Jump
	
Label_1913:
	var_112_int = 3; // 0x779 PushI
	var_113_bool = var_16_int == var_112_int; // 0x77a Eq
	if(var_113_bool == 0) goto Label_1925; // 0x77b JumpB
	var_114_int = 0; var_115_string = ""; // 0x77c PushV
	var_115_string = "gold_ring"; // 0x77d MovS
	func_1949(var_114_int, var_115_string); // 0x77e Call
	var_116_int = 0; // 0x780 PushI
	var_117_int = 1; // 0x781 PushI
	AddItem(var_17_bool, var_114_int, var_116_int, var_117_int); // 0x782 Func
	goto Label_1948; // 0x784 Jump
	
Label_1925:
	var_118_int = 4; // 0x785 PushI
	var_119_bool = var_16_int == var_118_int; // 0x786 Eq
	if(var_119_bool == 0) goto Label_1937; // 0x787 JumpB
	var_120_int = 0; var_121_string = ""; // 0x788 PushV
	var_121_string = "silver_ring"; // 0x789 MovS
	func_1949(var_120_int, var_121_string); // 0x78a Call
	var_122_int = 0; // 0x78c PushI
	var_123_int = 1; // 0x78d PushI
	AddItem(var_17_bool, var_120_int, var_122_int, var_123_int); // 0x78e Func
	goto Label_1948; // 0x790 Jump
	
Label_1937:
	var_124_int = 5; // 0x791 PushI
	var_125_bool = var_16_int == var_124_int; // 0x792 Eq
	if(var_125_bool == 0) goto Label_1948; // 0x793 JumpB
	var_126_int = 0; var_127_string = ""; // 0x794 PushV
	var_127_string = "flower"; // 0x795 MovS
	func_1949(var_126_int, var_127_string); // 0x796 Call
	var_128_int = 0; // 0x798 PushI
	var_129_int = 1; // 0x799 PushI
	AddItem(var_17_bool, var_126_int, var_128_int, var_129_int); // 0x79a Func
}


func_1653(var_179_string, var_180_int)
{
	var_181_string = ""; var_182_string = ""; // 0x675 PushV
	var_182_string = "idle"; // 0x676 MovS
	var_183_int = var_180_int; // 0x677 Push
	if(var_183_int == 0) goto Label_1658; // 0x678 JumpB
	var_182_string = var_182_string + var_180_int; // 0x679 Add2
	
Label_1658:
	var_179_string = var_182_string; // 0x67a Mov
...
{
	var_174_int = 0; var_175_bool = 0; var_176_int = 0; var_177_bool = 0; // 0x67c PushV
	var_176_int = 0; // 0x67d MovI
	
Label_1662:
	var_178_string = "all"; // 0x67e PushS
	var_179_string = ""; var_180_int = 0; // 0x67f PushV
	var_180_int = var_176_int; // 0x680 Mov
	func_1653(var_179_string, var_180_int); // 0x681 Call
	HasAnimation(var_177_bool, var_178_string, var_179_string); // 0x683 Func
	var_184_bool = var_177_bool == 0; // 0x685 Not
	if(var_184_bool == 0) goto Label_1672; // 0x686 JumpB
	goto Label_1675; // 0x687 Jump
	
Label_1675:
	var_173_int = var_176_int; // 0x68b Mov
	return 4; // 0x68c Return
	
Label_1672:
	var_185_int = 1; // 0x688 PushI
	var_176_int = var_176_int + var_185_int; // 0x689 Add2
