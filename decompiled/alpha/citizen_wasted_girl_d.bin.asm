...
0x7c9: Push("class")
0x7ca: @@ GetProperty(Stack[-1], Stack[-3])
0x7cb: Pop(1)
0x7cc: Push("rat")
...
0x7db: Push(Stack[-2])
0x7dc: IF (Stack[-1] == 0) GOTO 0x7e5; Pop(1)

0x7dd: PushEmpty(float, object)
0x7de: Stack[-1] = Stack[-9]
0x7df: Call 0x53a
