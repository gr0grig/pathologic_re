...
0x5ab: Stack[-1] = "Neutral"
0x5ac: Call 0x591

0x5ad: Pop(1)
0x5ae: Push((int) 14627)
0x5af: @@ SetMessage(Stack[-1])
0x5b0: Pop(1)
0x5b1: @@ ClearReplies()
0x5b2: Pop(0)
...
0x6a5: Stack[-2] = Stack[-6]
0x6a6: Stack[-1] = "noaccess"
0x6a7: Call 0x666
...
0x6ad: Push("noaccess")
0x6ae: @@ GetProperty(Stack[-1], Stack[-2])
0x6af: Pop(1)
0x6b0: Push((int) 0)
...
0x707: @@ GetPosition(Stack[-7])
0x708: Pop(0)
0x709: @@ GetEyesHeight(Stack[-8])
0x70a: Pop(0)
...
0x7f6: Stack[-3] = Stack[-7]
0x7f7: Stack[-2] = Stack[-6]
0x7f8: Stack[-1] = Stack[-5]
0x7f9: Call 0x6b3
...
0x871: Push("GenerateMoney: iMin > iMax")
0x872: @ Trace(Stack[-1])
0x873: Pop(1)
0x874: Return(); Pop(8)
...
0x948: Push("reputation")
0x949: @@ GetProperty(Stack[-1], Stack[-2])
0x94a: Pop(1)
0x94b: Stack[-5] = Stack[-1]
0x94c: Return(); Pop(4)
...
0x992: Push("class")
0x993: @@ GetProperty(Stack[-1], Stack[-3])
0x994: Pop(1)
0x995: Push("rat")
...
0x9a4: Push(Stack[-2])
0x9a5: IF (Stack[-1] == 0) GOTO 0x9ae; Pop(1)

0x9a6: PushEmpty(float, object)
0x9a7: Stack[-1] = Stack[-9]
0x9a8: Call 0x65e
