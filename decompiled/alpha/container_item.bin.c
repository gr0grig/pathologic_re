...
Label_24:
	...
	func_133(var_49_object, var_50_object, var_51_int); // 0x22 Call
	if(var_48_bool == 0) goto Label_42; // 0x24 JumpB
	var_59_object = Obj(); // 0x25 PushV
	func_121(var_59_object); // 0x26 Call
	RemoveActor(var_59_object); // 0x28 Func
...
func_97(var_6_bool, var_7_object)
{
	...
	func_61(var_10_bool, var_11_object); // 0x64 Call
...
Label_106:
	...
	func_44(var_28_bool, var_29_object, var_30_string); // 0x6d Call
...
func_133(var_48_bool, var_50_object, var_51_int)
{
	var_52_int = 0; var_53_int = 0; var_54_bool = 0; var_55_int = 0; var_56_int = 0; var_57_bool = 0; // 0x85 PushV
	GetItemID(var_55_int); // 0x86 ObjFunc
	var_58_string = "Category"; // 0x88 PushS
	GetInvItemProperty(var_56_int, var_55_int, var_58_string); // 0x89 Func
	AddItem(var_57_bool, var_50_object, var_56_int, var_51_int); // 0x8b ObjFunc
	var_48_bool = var_57_bool; // 0x8d Mov
	return 6; // 0x8e Return
}
...
func_121(var_59_object)
{
	var_60_object = Obj(); var_61_object = Obj(); // 0x79 PushV
	self(var_61_object); // 0x7a Func
	var_59_object = var_61_object; // 0x7c Mov
...
Label_66:
	...
	func_56(var_22_object); // 0x4a Call
