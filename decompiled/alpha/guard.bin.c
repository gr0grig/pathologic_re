...
task_1_event_0(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_int, var_9_bool, var_10_object)
{
	...
	func_1445(var_14_object); // 0x21 Call
...
Label_45:
	...
	func_1448(var_20_object); // 0x2f Call
...
task_1_event_17(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_int, var_9_bool, var_10_object)
{
	...
	func_1408(var_13_int, var_14_object); // 0x35 Call
...
Label_65:
	...
	func_1418(var_54_object); // 0x43 Call
...
Label_91:
	...
	func_1433(var_83_object); // 0x5d Call
...
task_1_event_40(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_int, var_9_bool, var_10_object)
{
	...
	func_1454(var_14_object); // 0x63 Call
...
task_1_event_42(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object)
{
	...
	func_1459(var_16_object); // 0x78 Call
...
task_2_event_0(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_int, var_9_bool, var_10_object)
{
	...
	func_1445(var_14_object); // 0x10f Call
	...
	func_1448(var_17_object); // 0x117 Call
...
{
	var_12_float = 0; var_13_float = 0; // 0x536 PushV
	var_14_string = "health"; // 0x537 PushS
	var_15_bool = var_11_string == var_14_string; // 0x538 Eq
	if(var_15_bool == 0) goto Label_1346; // 0x539 JumpB
	var_16_string = "health"; // 0x53a PushS
	GetProperty(var_16_string, var_13_float); // 0x53b Func
	var_17_int = 0; // 0x53d PushI
	var_18_bool = var_13_float <= var_17_int; // 0x53e LE
	if(var_18_bool == 0) goto Label_1346; // 0x53f JumpB
	SignalDeath(var_10_object); // 0x540 Func
...
{
	var_11_object = Obj(); // 0x544 PushV
	var_11_object = var_10_object; // 0x545 Mov
	func_1326(var_11_object); // 0x546 Call
...
{
	var_14_object = Obj(); var_15_int = 0; var_16_float = 0; // 0x54a PushV
	var_14_object = var_10_object; // 0x54b Mov
	var_15_int = var_11_int; // 0x54c Mov
	var_16_float = var_12_float; // 0x54d Mov
	func_1221(var_15_int, var_16_float); // 0x54e Call
...
func_1408(var_48_int, var_49_object)
{
	var_50_bool = 0; var_51_object = Obj(); // 0x581 PushV
	var_51_object = var_49_object; // 0x582 Mov
	func_1197(var_50_bool, var_51_object); // 0x583 Call
	if(var_50_bool == 0) goto Label_1416; // 0x585 JumpB
	var_48_int = 2; // 0x586 MovI
...
func_1418(var_84_object)
{
	var_85_object = Obj(); // 0x58b PushV
	var_85_object = var_84_object; // 0x58c Mov
	TaskCall(3); // 0x58d TaskCall
	func_401(var_85_object); // 0x58e Call
	TaskReturn(); // 0x58f TaskReturn
...
func_1426(var_46_int, var_47_object)
{
	var_48_int = 0; var_49_object = Obj(); // 0x593 PushV
	var_49_object = var_47_object; // 0x594 Mov
	func_1408(var_48_int, var_49_object); // 0x595 Call
	var_46_int = var_48_int; // 0x596 Mov
	return 0; // 0x598 Return
}


func_1299(var_12_bool)
{
	var_13_bool = 0; var_14_bool = 0; // 0x513 PushV
	IsLoaded(var_14_bool); // 0x514 Func
	var_12_bool = var_14_bool; // 0x516 Mov
...
func_21()
{
	var_12_bool = 0; // 0x15 PushV
	func_1299(var_12_bool); // 0x16 Call
	var_15_bool = var_12_bool == 0; // 0x18 Not
	if(var_15_bool == 0) goto Label_29; // 0x19 JumpB
	func_1439(); // 0x1b Call
...
func_1304(var_49_float, var_50_cvector, var_51_cvector)
{
	var_52_cvector = CVector(0,0,0); var_53_cvector = CVector(0,0,0); // 0x518 PushV
	var_53_cvector = var_51_cvector - var_50_cvector; // 0x519 Sub2
	var_49_float = var_53_cvector | var_53_cvector; // 0x51a Or2
	return 2; // 0x51b Return
}


func_1433(var_83_object)
{
	var_84_object = Obj(); // 0x59a PushV
	var_84_object = var_83_object; // 0x59b Mov
	func_1418(var_84_object); // 0x59c Call
...
func_1439()
{
	TaskCall(0); // 0x5a0 TaskCall
	func_0(); // 0x5a1 Call
	TaskReturn(); // 0x5a2 TaskReturn
...
func_1308(var_348_float, var_349_float, var_350_float)
{
	var_353_bool = var_349_float < var_350_float; // 0x51d LT
	if(var_353_bool == 0) goto Label_1313; // 0x51e JumpB
	var_348_float = var_349_float; // 0x51f Mov
...
Label_1313:
	var_348_float = var_350_float; // 0x521 Mov
}
...
func_1445(var_13_int)
{
	var_13_int = 2; // 0x5a6 MovI
...
func_1448(var_17_object)
{
	var_18_object = Obj(); // 0x5a9 PushV
	var_18_object = var_17_object; // 0x5aa Mov
	func_1468(var_18_object); // 0x5ab Call
...
{
	var_16_int = 0; var_17_bool = 0; var_18_cvector = CVector(0,0,0); var_19_object = Obj(); var_20_int = 0; var_21_bool = 0; var_22_cvector = CVector(0,0,0); var_23_object = Obj(); // 0xaa PushV
	GetPFPosition(var_23_object); // 0xab Func
	GetDirection(var_0_cvector); // 0xad Func
	
Label_175:
	var_24_int = 60; // 0xaf PushI
	irand(var_20_int, var_24_int); // 0xb0 Func
	var_25_int = 30; // 0xb2 PushI
	var_26_int = var_20_int + var_25_int; // 0xb3 Add
	Sleep(var_26_int, var_21_bool); // 0xb4 Func
	var_27_bool = var_21_bool; // 0xb6 Push
	if(var_27_bool == 0) goto Label_188; // 0xb7 JumpB
	func_164(var_23_object); // 0xb9 Call
...
Label_188:
	GetPFPosition(var_22_cvector); // 0xbc Func
	var_49_float = 0; var_50_cvector = CVector(0,0,0); var_51_cvector = CVector(0,0,0); // 0xbe PushV
	var_50_cvector = var_1_cvector; // 0xbf MovT
	var_51_cvector = var_22_cvector; // 0xc0 Mov
	func_1304(var_49_float, var_50_cvector, var_51_cvector); // 0xc1 Call
	var_54_int = 40000; // 0xc3 PushI
	var_55_bool = var_49_float > var_54_int; // 0xc4 GT
	if(var_55_bool == 0) goto Label_232; // 0xc5 JumpB
	FindPathTo(var_23_object, var_23_object); // 0xc6 Func
	var_56_bool = var_23_object != 0; // 0xc8 NullNeq
	if(var_56_bool == 0) goto Label_227; // 0xc9 JumpB
	RotatePath(var_23_object, var_21_bool); // 0xca Func
	var_57_bool = var_21_bool == 0; // 0xcc Not
	if(var_57_bool == 0) goto Label_207; // 0xcd JumpB
...
Label_207:
	var_58_bool = 0; // 0xcf PushB
	FollowPath(var_23_object, var_58_bool, var_21_bool); // 0xd0 Func
	var_59_bool = var_21_bool == 0; // 0xd2 Not
	if(var_59_bool == 0) goto Label_213; // 0xd3 JumpB
	goto Label_245; // 0xd4 Jump
	
Label_213:
	var_60_float = GetByIndex(var_0_cvector, 0); // 0xd5 PushE
	var_61_float = GetByIndex(var_0_cvector, 2); // 0xd6 PushE
	Rotate(var_60_float, var_61_float, var_21_bool); // 0xd7 Func
	var_62_bool = var_21_bool == 0; // 0xd9 Not
	if(var_62_bool == 0) goto Label_220; // 0xda JumpB
	goto Label_245; // 0xdb Jump
	
Label_220:
	WaitForAnimEnd(var_21_bool); // 0xdc Func
	var_63_bool = var_21_bool == 0; // 0xde Not
	if(var_63_bool == 0) goto Label_225; // 0xdf JumpB
...
Label_227:
	var_64_int = 1; // 0xe3 PushI
	Sleep(var_64_int); // 0xe4 Func
	var_23_object = 0; // 0xe6 SetNull
	goto Label_245; // 0xe7 Jump
	
Label_232:
	var_65_float = GetByIndex(var_0_cvector, 0); // 0xe8 PushE
	var_66_float = GetByIndex(var_0_cvector, 2); // 0xe9 PushE
	Rotate(var_65_float, var_66_float, var_21_bool); // 0xea Func
	var_67_bool = var_21_bool == 0; // 0xec Not
	if(var_67_bool == 0) goto Label_239; // 0xed JumpB
	goto Label_245; // 0xee Jump
	
Label_239:
	WaitForAnimEnd(var_21_bool); // 0xef Func
	var_68_bool = var_21_bool == 0; // 0xf1 Not
	if(var_68_bool == 0) goto Label_244; // 0xf2 JumpB
...
func_1315(var_358_float, var_359_float, var_360_float, var_361_float)
{
	var_362_bool = var_359_float < var_360_float; // 0x524 LT
	if(var_362_bool == 0) goto Label_1320; // 0x525 JumpB
	var_358_float = var_360_float; // 0x526 Mov
	return 0; // 0x527 Return
	
Label_1320:
	var_363_bool = var_359_float > var_361_float; // 0x528 GT
	if(var_363_bool == 0) goto Label_1324; // 0x529 JumpB
	var_358_float = var_361_float; // 0x52a Mov
	return 0; // 0x52b Return
	
Label_1324:
	var_358_float = var_359_float; // 0x52c Mov
...
func_1454(var_13_int)
{
	var_13_int = 0; // 0x5af MovI
	return 0; // 0x5b0 Return
}


func_1326(var_11_object)
{
	var_12_object = Obj(); // 0x52f PushV
	var_12_object = var_11_object; // 0x530 Mov
	TaskCall(2); // 0x531 TaskCall
	func_253(var_12_object); // 0x532 Call
	TaskReturn(); // 0x533 TaskReturn
...
func_1459(var_14_int)
{
	var_14_int = 0; // 0x5b4 MovI
...
func_1464()
{
	var_11_bool = GlobalVars[0]; // 0x5b8 PushGE
	var_11_bool = 0; // 0x5b9 MovB
	GlobalVars[0] = var_11_bool; // 0x5ba PopGE
...
func_1468(var_18_object)
{
	var_19_bool = GlobalVars[0]; // 0x5bd PushGE
	if(var_19_bool == 0) goto Label_1474; // 0x5be JumpB
	WorkWithCorpse(var_18_object); // 0x5bf Func
...
func_1475(var_14_bool, var_15_object, var_16_object)
{
	var_17_string = ""; var_18_bool = 0; var_19_string = ""; var_20_bool = 0; // 0x5c3 PushV
	var_21_bool = 0; var_22_object = Obj(); var_23_string = ""; // 0x5c4 PushV
	var_22_object = var_16_object; // 0x5c5 Mov
	var_23_string = "class"; // 0x5c6 MovS
	func_1080(var_21_bool, var_22_object, var_23_string); // 0x5c7 Call
	var_30_bool = var_21_bool == 0; // 0x5c9 Not
	if(var_30_bool == 0) goto Label_1485; // 0x5ca JumpB
	var_14_bool = 0; // 0x5cb MovB
	return 4; // 0x5cc Return
	
Label_1485:
	var_31_string = "class"; // 0x5cd PushS
	GetProperty(var_31_string, var_19_string); // 0x5ce ObjFunc
	var_32_string = "guard"; // 0x5d0 PushS
	var_33_bool = var_19_string != var_32_string; // 0x5d1 Neq
	if(var_33_bool == 0) goto Label_1493; // 0x5d2 JumpB
	var_14_bool = 0; // 0x5d3 MovB
	return 4; // 0x5d4 Return
	
Label_1493:
	CanSee(var_20_bool, var_15_object); // 0x5d5 Func
	var_34_bool = 0; // 0x5d7 PushV
	var_34_bool = 1; // 0x5d8 MovB
	var_35_bool = var_20_bool; // 0x5d9 Push
	if(var_35_bool == 0) goto Label_1507; // 0x5da JumpB
	var_36_float = 0; var_37_object = Obj(); // 0x5db PushV
	var_37_object = var_15_object; // 0x5dc Mov
	func_1072(var_37_object); // 0x5dd Call
	var_44_float = 1000000.0; // 0x5df PushF
	var_45_bool = var_36_float <= var_44_float; // 0x5e0 LE
	if(var_45_bool == 0) goto Label_1507; // 0x5e1 JumpB
	var_34_bool = 0; // 0x5e2 MovB
	
Label_1507:
	if(var_34_bool == 0) goto Label_1510; // 0x5e3 JumpB
	var_14_bool = 1; // 0x5e4 MovB
	return 4; // 0x5e5 Return
	
Label_1510:
	var_14_bool = 0; // 0x5e6 MovB
...
Label_1131:
	...
	func_1308(var_348_float, var_349_float, var_350_float); // 0x470 Call
	...
	func_1315(var_358_float, var_359_float, var_360_float, var_361_float); // 0x47e Call
...
func_1361(var_38_string, var_39_int)
{
	var_40_string = ""; var_41_string = ""; // 0x551 PushV
	var_41_string = "idle"; // 0x552 MovS
	var_42_int = var_39_int; // 0x553 Push
	if(var_42_int == 0) goto Label_1366; // 0x554 JumpB
	var_41_string = var_41_string + var_39_int; // 0x555 Add2
	
Label_1366:
	var_38_string = var_41_string; // 0x556 Mov
...
func_1368(var_32_int)
{
	var_33_int = 0; var_34_bool = 0; var_35_int = 0; var_36_bool = 0; // 0x558 PushV
	var_35_int = 0; // 0x559 MovI
	
Label_1370:
	var_37_string = "all"; // 0x55a PushS
	var_38_string = ""; var_39_int = 0; // 0x55b PushV
	var_39_int = var_35_int; // 0x55c Mov
	func_1361(var_38_string, var_39_int); // 0x55d Call
	HasAnimation(var_36_bool, var_37_string, var_38_string); // 0x55f Func
	var_43_bool = var_36_bool == 0; // 0x561 Not
	if(var_43_bool == 0) goto Label_1380; // 0x562 JumpB
	goto Label_1383; // 0x563 Jump
	
Label_1383:
	var_32_int = var_35_int; // 0x567 Mov
	return 4; // 0x568 Return
	
Label_1380:
	var_44_int = 1; // 0x564 PushI
	var_35_int = var_35_int + var_44_int; // 0x565 Add2
	goto Label_1370; // 0x566 Jump
}
...
func_1512()
{
	var_64_bool = GlobalVars[0]; // 0x5e9 PushGE
	var_64_bool = 1; // 0x5ea MovB
	GlobalVars[0] = var_64_bool; // 0x5eb PopGE
	var_65_int = 50; // 0x5ec PushI
	var_66_int = 40; // 0x5ed PushI
	SetRTEnvelope(var_65_int, var_66_int); // 0x5ee Func
...
func_1388()
{
	var_28_int = 0; var_29_int = 0; var_30_int = 0; var_31_int = 0; // 0x56c PushV
	var_32_int = 0; // 0x56d PushV
	func_1368(var_32_int); // 0x56e Call
	var_30_int = var_32_int; // 0x56f Mov
	var_45_bool = var_30_int == 0; // 0x571 Not
	if(var_45_bool == 0) goto Label_1396; // 0x572 JumpB
	return 4; // 0x573 Return
	
Label_1396:
	irand(var_31_int, var_30_int); // 0x574 Func
	var_46_string = "all"; // 0x576 PushS
	var_47_string = ""; var_48_int = 0; // 0x577 PushV
	var_48_int = var_31_int; // 0x578 Mov
	func_1361(var_47_string, var_48_int); // 0x579 Call
	PlayAnimation(var_46_string, var_47_string); // 0x57b Func
	WaitForAnimEnd(); // 0x57d Func
