...
0xa47: Push("GenerateMoney: iMin > iMax")
0xa48: @ Trace(Stack[-1])
0xa49: Pop(1)
0xa4a: Return(); Pop(8)
...
0xada: Pop(0)
0xadb: Stack[-4] = Stack[-1]
0xadc: Return(); Pop(2)

0xadd: Stack[-1] = (int) 3343
0xade: Return(); Pop(0)

0xadf: Stack[-1] = "ui/NPC_None.png"
0xae0: Return(); Pop(0)
