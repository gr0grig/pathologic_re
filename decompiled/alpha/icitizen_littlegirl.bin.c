...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	var_46_int = 0; var_47_object = Obj(); // 0xf1 PushV
	var_47_object = var_16_string; // 0xf2 Mov
	func_2156(var_46_int, var_47_object); // 0xf3 Call
	var_19_int = var_46_int; // 0xf4 Mov
	var_82_int = 0; // 0xf6 PushI
	var_83_bool = var_19_int > var_82_int; // 0xf7 GT
	if(var_83_bool == 0) goto Label_259; // 0xf8 JumpB
	var_84_int = 1; // 0xf9 PushI
	var_85_bool = var_19_int > var_84_int; // 0xfa GT
	if(var_85_bool == 0) goto Label_255; // 0xfb JumpB
	func_333(var_19_int); // 0xfd Call
	
Label_255:
	var_87_object = Obj(); // 0xff PushV
	var_87_object = var_16_string; // 0x100 Mov
	func_2166(var_87_object); // 0x101 Call
...
task_3_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	var_46_int = 0; var_47_object = Obj(); // 0x20d PushV
	var_47_object = var_16_string; // 0x20e Mov
	func_2156(var_46_int, var_47_object); // 0x20f Call
	var_19_int = var_46_int; // 0x210 Mov
	var_82_int = 0; // 0x212 PushI
	var_83_bool = var_19_int > var_82_int; // 0x213 GT
	if(var_83_bool == 0) goto Label_543; // 0x214 JumpB
	var_84_int = 1; // 0x215 PushI
	var_85_bool = var_19_int > var_84_int; // 0x216 GT
	if(var_85_bool == 0) goto Label_539; // 0x217 JumpB
	func_662(); // 0x219 Call
	
Label_539:
	var_86_object = Obj(); // 0x21b PushV
	var_86_object = var_16_string; // 0x21c Mov
	func_2166(var_86_object); // 0x21d Call
...
task_4_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	var_46_int = 0; var_47_object = Obj(); // 0x302 PushV
	var_47_object = var_16_string; // 0x303 Mov
	func_2156(var_46_int, var_47_object); // 0x304 Call
	var_19_int = var_46_int; // 0x305 Mov
	var_82_int = 0; // 0x307 PushI
	var_83_bool = var_19_int > var_82_int; // 0x308 GT
	if(var_83_bool == 0) goto Label_788; // 0x309 JumpB
	var_84_int = 1; // 0x30a PushI
	var_85_bool = var_19_int > var_84_int; // 0x30b GT
	if(var_85_bool == 0) goto Label_784; // 0x30c JumpB
	func_831(); // 0x30e Call
	
Label_784:
	var_88_object = Obj(); // 0x310 PushV
	var_88_object = var_16_string; // 0x311 Mov
	func_2166(var_88_object); // 0x312 Call
...
{
	var_48_bool = 0; var_49_object = Obj(); // 0x86d PushV
	var_49_object = var_47_object; // 0x86e Mov
	func_1744(var_48_bool, var_49_object); // 0x86f Call
	if(var_48_bool == 0) goto Label_2164; // 0x871 JumpB
	var_46_int = 2; // 0x872 MovI
...
Label_2164:
	var_46_int = 0; // 0x874 MovI
}


func_1136(var_0_bool, var_1_bool, var_2_bool, var_89_object)
{
	var_93_cvector = CVector(0,0,0); var_94_float = 0; var_95_bool = 0; var_96_cvector = CVector(0,0,0); var_97_float = 0; var_98_cvector = CVector(0,0,0); var_99_float = 0; var_100_bool = 0; var_101_cvector = CVector(0,0,0); var_102_float = 0; // 0x470 PushV
	var_0_bool = var_89_object; // 0x471 TMov
	var_103_cvector = CVector(0,0,0); var_104_float = 0; // 0x472 PushV
	var_104_float = 1.74533; // 0x473 MovF
	func_1106(var_103_cvector, var_104_float); // 0x474 Call
	var_98_cvector = var_103_cvector; // 0x475 Mov
	var_99_float = var_98_cvector | var_98_cvector; // 0x477 Or2
	var_133_float = 10000.0; // 0x478 PushF
	var_134_bool = var_99_float < var_133_float; // 0x479 LT
	if(var_134_bool == 0) goto Label_1156; // 0x47a JumpB
	var_135_string = "Can't retreat, distance: "; // 0x47b PushS
	var_136_float = sqrt(var_99_float); // 0x47c Sqrt
	var_137_int = var_135_string + var_136_float; // 0x47d Add
	Trace(var_137_int); // 0x47e Func
	var_138_float = 0.5; // 0x480 PushF
	Sleep(var_138_float); // 0x481 Func
	return 10; // 0x483 Return
	
Label_1156:
	var_139_float = GetByIndex(var_98_cvector, 0); // 0x484 PushE
	var_140_float = GetByIndex(var_98_cvector, 2); // 0x485 PushE
	Rotate(var_139_float, var_140_float); // 0x486 Func
	var_141_cvector = CVector(0,0,0); // 0x488 PushV
	func_1671(var_141_cvector); // 0x489 Call
	var_1_bool = var_141_cvector + var_98_cvector; // 0x48b Add2
	var_144_int = 120; // 0x48c PushI
	var_145_float = 0.5; // 0x48d PushF
	SetTimer(var_144_int, var_145_float); // 0x48e Func
	var_2_bool = 0; // 0x490 TMovB
	
Label_1169:
	var_146_int = 1; // 0x491 PushI
	MovePoint(var_146_int, var_146_int, var_100_bool); // 0x492 Func
	var_147_bool = var_100_bool; // 0x494 Push
	if(var_147_bool == 0) goto Label_1197; // 0x495 JumpB
	var_148_bool = var_0_bool == 0; // 0x496 NullEq
	if(var_148_bool == 0) goto Label_1178; // 0x497 JumpB
...
Label_1178:
	var_149_cvector = CVector(0,0,0); var_150_float = 0; // 0x49a PushV
	var_150_float = 2.61799; // 0x49b MovF
	func_1106(var_149_cvector, var_150_float); // 0x49c Call
	var_101_cvector = var_149_cvector; // 0x49d Mov
	var_102_float = var_101_cvector | var_101_cvector; // 0x49f Or2
	var_151_float = 10000.0; // 0x4a0 PushF
	var_152_bool = var_102_float >= var_151_float; // 0x4a1 GE
	if(var_152_bool == 0) goto Label_1196; // 0x4a2 JumpB
	var_153_cvector = CVector(0,0,0); // 0x4a3 PushV
	func_1671(var_153_cvector); // 0x4a4 Call
	var_1_bool = var_153_cvector + var_101_cvector; // 0x4a6 Add2
	var_154_int = 120; // 0x4a7 PushI
	var_155_float = 0.5; // 0x4a8 PushF
	SetTimer(var_154_int, var_155_float); // 0x4a9 Func
	goto Label_1197; // 0x4ab Jump
	
Label_1197:
	var_156_bool = var_2_bool == 0; // 0x4ad Not
	if(var_156_bool == 0) goto Label_1169; // 0x4ae JumpB
...
{
	var_89_object = Obj(); // 0x877 PushV
	var_89_object = var_88_object; // 0x878 Mov
	TaskCall(6); // 0x879 TaskCall
	func_1136(var_90_object, var_91_cvector, var_92_bool, var_89_object); // 0x87a Call
...
Label_2476:
	if(var_40_bool == 0) goto Label_2479; // 0x9ac JumpB
	var_20_bool = 1; // 0x9ad MovB
	return 2; // 0x9ae Return
	
Label_2479:
	var_20_bool = 0; // 0x9af MovB
...
func_2481()
{
	var_70_bool = GlobalVars[1]; // 0x9b2 PushGE
	var_70_bool = 1; // 0x9b3 MovB
	GlobalVars[1] = var_70_bool; // 0x9b4 PopGE
	var_71_int = 50; // 0x9b5 PushI
	var_72_int = 40; // 0x9b6 PushI
	SetRTEnvelope(var_71_int, var_72_int); // 0x9b7 Func
	var_73_bool = 0; // 0x9b9 PushV
	var_73_bool = 1; // 0x9ba MovB
	func_2246(); // 0x9bb Call
