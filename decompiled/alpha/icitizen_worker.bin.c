...
task_1_event_30(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object)
{
	...
	var_68_int = 0; var_69_object = Obj(); // 0xee PushV
	var_69_object = var_10_bool; // 0xef Mov
	func_1671(var_68_int, var_69_object); // 0xf0 Call
	var_13_int = var_68_int; // 0xf1 Mov
	var_100_int = 0; // 0xf3 PushI
	var_101_bool = var_13_int > var_100_int; // 0xf4 GT
	if(var_101_bool == 0) goto Label_256; // 0xf5 JumpB
	var_102_int = 1; // 0xf6 PushI
	var_103_bool = var_13_int > var_102_int; // 0xf7 GT
	if(var_103_bool == 0) goto Label_252; // 0xf8 JumpB
	func_336(var_13_int); // 0xfa Call
	
Label_252:
	var_106_object = Obj(); // 0xfc PushV
	var_106_object = var_10_bool; // 0xfd Mov
	func_1678(var_106_object); // 0xfe Call
...
task_2_event_30(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object)
{
	...
	var_68_int = 0; var_69_object = Obj(); // 0x1ee PushV
	var_69_object = var_10_bool; // 0x1ef Mov
	func_1671(var_68_int, var_69_object); // 0x1f0 Call
	var_13_int = var_68_int; // 0x1f1 Mov
	var_100_int = 0; // 0x1f3 PushI
	var_101_bool = var_13_int > var_100_int; // 0x1f4 GT
	if(var_101_bool == 0) goto Label_512; // 0x1f5 JumpB
	var_102_int = 1; // 0x1f6 PushI
	var_103_bool = var_13_int > var_102_int; // 0x1f7 GT
	if(var_103_bool == 0) goto Label_508; // 0x1f8 JumpB
	func_555(); // 0x1fa Call
	
Label_508:
	var_106_object = Obj(); // 0x1fc PushV
	var_106_object = var_10_bool; // 0x1fd Mov
	func_1678(var_106_object); // 0x1fe Call
...
{
	var_70_int = 0; var_71_object = Obj(); // 0x688 PushV
	var_71_object = var_69_object; // 0x689 Mov
	func_1653(var_70_int, var_71_object); // 0x68a Call
	var_68_int = var_70_int; // 0x68b Mov
...
{
	var_107_object = Obj(); // 0x68f PushV
	var_107_object = var_106_object; // 0x690 Mov
	func_1663(var_107_object); // 0x691 Call
...
func_1295(var_57_float)
{
	var_59_cvector = CVector(0,0,0); var_60_cvector = CVector(0,0,0); var_61_cvector = CVector(0,0,0); var_62_cvector = CVector(0,0,0); var_63_cvector = CVector(0,0,0); var_64_cvector = CVector(0,0,0); // 0x50f PushV
	GetPosition(var_62_cvector); // 0x510 Func
	GetPosition(var_63_cvector); // 0x512 ObjFunc
	var_64_cvector = var_63_cvector - var_62_cvector; // 0x514 Sub2
	var_57_float = var_64_cvector | var_64_cvector; // 0x515 Or2
...
func_2075()
{
	var_64_bool = GlobalVars[1]; // 0x81c PushGE
	var_64_bool = 1; // 0x81d MovB
	GlobalVars[1] = var_64_bool; // 0x81e PopGE
	var_65_int = 50; // 0x81f PushI
	var_66_int = 40; // 0x820 PushI
	SetRTEnvelope(var_65_int, var_66_int); // 0x821 Func
...
Label_1996:
	...
	var_38_bool = 0; // 0x7db PushV
	var_38_bool = 0; // 0x7dc MovB
	var_39_string = "littleboy"; // 0x7dd PushS
	var_40_bool = var_19_string != var_39_string; // 0x7de Neq
	if(var_40_bool == 0) goto Label_2020; // 0x7df JumpB
	var_41_string = "littlegirl"; // 0x7e0 PushS
	var_42_bool = var_19_string != var_41_string; // 0x7e1 Neq
	if(var_42_bool == 0) goto Label_2020; // 0x7e2 JumpB
	var_38_bool = 1; // 0x7e3 MovB
	
Label_2020:
	if(var_38_bool == 0) goto Label_2025; // 0x7e4 JumpB
	var_43_string = "boy"; // 0x7e5 PushS
	var_44_bool = var_19_string != var_43_string; // 0x7e6 Neq
	if(var_44_bool == 0) goto Label_2025; // 0x7e7 JumpB
	var_37_bool = 1; // 0x7e8 MovB
	
Label_2025:
	if(var_37_bool == 0) goto Label_2030; // 0x7e9 JumpB
	var_45_string = "girl"; // 0x7ea PushS
	var_46_bool = var_19_string != var_45_string; // 0x7eb Neq
	if(var_46_bool == 0) goto Label_2030; // 0x7ec JumpB
	var_36_bool = 1; // 0x7ed MovB
	
Label_2030:
	if(var_36_bool == 0) goto Label_2035; // 0x7ee JumpB
	var_47_string = "wasted_girl"; // 0x7ef PushS
	var_48_bool = var_19_string != var_47_string; // 0x7f0 Neq
	if(var_48_bool == 0) goto Label_2035; // 0x7f1 JumpB
	var_35_bool = 1; // 0x7f2 MovB
	
Label_2035:
	if(var_35_bool == 0) goto Label_2040; // 0x7f3 JumpB
	var_49_string = "woman"; // 0x7f4 PushS
	var_50_bool = var_19_string != var_49_string; // 0x7f5 Neq
	if(var_50_bool == 0) goto Label_2040; // 0x7f6 JumpB
	var_34_bool = 1; // 0x7f7 MovB
	
Label_2040:
	if(var_34_bool == 0) goto Label_2045; // 0x7f8 JumpB
	var_51_string = "worker"; // 0x7f9 PushS
	var_52_bool = var_19_string != var_51_string; // 0x7fa Neq
	if(var_52_bool == 0) goto Label_2045; // 0x7fb JumpB
	var_33_bool = 1; // 0x7fc MovB
	
Label_2045:
	if(var_33_bool == 0) goto Label_2050; // 0x7fd JumpB
	var_53_string = "wasted_male"; // 0x7fe PushS
	var_54_bool = var_19_string != var_53_string; // 0x7ff Neq
	if(var_54_bool == 0) goto Label_2050; // 0x800 JumpB
	var_32_bool = 1; // 0x801 MovB
	
Label_2050:
	if(var_32_bool == 0) goto Label_2053; // 0x802 JumpB
	var_14_bool = 0; // 0x803 MovB
	return 4; // 0x804 Return
	
Label_2053:
	CanSee(var_20_bool, var_15_object); // 0x805 Func
	var_55_bool = 0; // 0x807 PushV
	var_55_bool = 1; // 0x808 MovB
	var_56_bool = var_20_bool; // 0x809 Push
	if(var_56_bool == 0) goto Label_2067; // 0x80a JumpB
	var_57_float = 0; var_58_object = Obj(); // 0x80b PushV
	var_58_object = var_15_object; // 0x80c Mov
	func_1295(var_58_object); // 0x80d Call
	var_65_float = 250000.0; // 0x80f PushF
	var_66_bool = var_57_float <= var_65_float; // 0x810 LE
	if(var_66_bool == 0) goto Label_2067; // 0x811 JumpB
	var_55_bool = 0; // 0x812 MovB
	
Label_2067:
	if(var_55_bool == 0) goto Label_2073; // 0x813 JumpB
	var_67_float = -0.3; // 0x814 PushF
	ReportReputationChange(var_15_object, var_16_object, var_67_float); // 0x815 Func
	var_14_bool = 1; // 0x817 MovB
	return 4; // 0x818 Return
	
Label_2073:
	var_14_bool = 0; // 0x819 MovB
