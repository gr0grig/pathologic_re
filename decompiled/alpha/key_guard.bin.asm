...
0x5c9: Pop(1)
0x5ca: @@ SetItemID(Stack[-2])
0x5cb: Pop(0)
0x5cc: Push("key_scene_name")
0x5cd: @@ SetProperty(Stack[-1], Stack[-5])
0x5ce: Pop(1)
0x5cf: Push((int) 0)
...
0x5e5: Push("class")
0x5e6: @@ GetProperty(Stack[-1], Stack[-3])
0x5e7: Pop(1)
0x5e8: Push("guard")
...
0x60c: Pop(0)
0x60d: @@ RemoveStationaryActor(Stack[-1])
0x60e: Pop(1)
0x60f: Return(); Pop(2)
