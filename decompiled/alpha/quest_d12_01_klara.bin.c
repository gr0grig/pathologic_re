task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int)
{
	...
	if(var_7_int == 0) goto Label_329; // 0x90 JumpB
	func_420(); // 0x92 Call
	var_9_int = 16187; // 0x94 PushI
...
Label_184:
	...
	var_50_int = 14937; // 0xbf PushI
	SetMessage(var_50_int); // 0xc0 TObjFunc
	ClearReplies(); // 0xc2 TObjFunc
	var_51_int = 14938; // 0xc4 PushI
	var_52_int = 16190; // 0xc5 PushI
	var_53_int = 16189; // 0xc6 PushI
	AddReply(var_51_int, var_52_int, var_53_int); // 0xc7 TObjFunc
	var_54_int = 14946; // 0xc9 PushI
	var_55_int = 16198; // 0xca PushI
	var_56_int = 16197; // 0xcb PushI
	AddReply(var_54_int, var_55_int, var_56_int); // 0xcc TObjFunc
	var_57_int = 14950; // 0xce PushI
	var_58_int = 16203; // 0xcf PushI
	var_59_int = 16202; // 0xd0 PushI
	AddReply(var_57_int, var_58_int, var_59_int); // 0xd1 TObjFunc
	return 0; // 0xd3 Return
	
Label_212:
	var_60_int = 16203; // 0xd4 PushI
	...
	var_63_int = 14951; // 0xdb PushI
	SetMessage(var_63_int); // 0xdc TObjFunc
	ClearReplies(); // 0xde TObjFunc
	var_64_int = 14952; // 0xe0 PushI
	var_65_int = 16190; // 0xe1 PushI
	var_66_int = 16204; // 0xe2 PushI
	AddReply(var_64_int, var_65_int, var_66_int); // 0xe3 TObjFunc
	var_67_int = 14953; // 0xe5 PushI
	var_68_int = -1; // 0xe6 PushI
	var_69_int = 16206; // 0xe7 PushI
	AddReply(var_67_int, var_68_int, var_69_int); // 0xe8 TObjFunc
	return 0; // 0xea Return
	
Label_235:
	var_70_int = 16198; // 0xeb PushI
	...
	var_73_int = 14947; // 0xf2 PushI
	SetMessage(var_73_int); // 0xf3 TObjFunc
	ClearReplies(); // 0xf5 TObjFunc
	var_74_int = 14948; // 0xf7 PushI
	var_75_int = 16190; // 0xf8 PushI
	var_76_int = 16199; // 0xf9 PushI
	AddReply(var_74_int, var_75_int, var_76_int); // 0xfa TObjFunc
	var_77_int = 14949; // 0xfc PushI
	var_78_int = -1; // 0xfd PushI
	var_79_int = 16201; // 0xfe PushI
	AddReply(var_77_int, var_78_int, var_79_int); // 0xff TObjFunc
	return 0; // 0x101 Return
	
Label_258:
	var_80_int = 16190; // 0x102 PushI
	var_81_bool = var_5_int == var_80_int; // 0x103 Eq
	if(var_81_bool == 0) goto Label_276; // 0x104 JumpB
	var_82_string = ""; // 0x105 PushV
	var_82_string = "Neutral"; // 0x106 MovS
	func_126(var_6_int, var_82_string); // 0x107 Call
	var_83_int = 14939; // 0x109 PushI
	SetMessage(var_83_int); // 0x10a TObjFunc
	ClearReplies(); // 0x10c TObjFunc
	var_84_int = 14940; // 0x10e PushI
	var_85_int = 16192; // 0x10f PushI
	var_86_int = 16191; // 0x110 PushI
	AddReply(var_84_int, var_85_int, var_86_int); // 0x111 TObjFunc
	return 0; // 0x113 Return
	
Label_276:
	var_87_int = 16192; // 0x114 PushI
...
{
	var_6_int = 0; var_7_object = Obj(); // 0x14f PushV
	var_7_object = var_5_object; // 0x150 Mov
	TaskCall(0); // 0x151 TaskCall
	func_0(var_8_object, var_6_int, var_7_object); // 0x152 Call
...
Label_330:
	Hold(); // 0x14a Func
	goto Label_330; // 0x14c Jump
}


func_448(var_92_bool)
{
	var_94_int = 0; var_95_string = ""; // 0x1c1 PushV
	var_95_string = "ood12Klara1"; // 0x1c2 MovS
	func_437(var_94_int, var_95_string); // 0x1c3 Call
	var_98_int = 0; // 0x1c5 PushI
	var_99_bool = var_94_int == var_98_int; // 0x1c6 Eq
	if(var_99_bool == 0) goto Label_458; // 0x1c7 JumpB
	var_92_bool = 1; // 0x1c8 MovB
	return 0; // 0x1c9 Return
	
Label_458:
	var_92_bool = 0; // 0x1ca MovB
...
func_0(var_0_object, var_6_int, var_7_object)
{
	...
	func_342(var_18_object); // 0x4 Call
...
func_420()
{
	...
	func_481(var_8_bool); // 0x1a5 Call
	if(var_8_bool == 0) goto Label_426; // 0x1a7 JumpB
	lshStopSpeech(); // 0x1a8 Func
...
{
	var_59_string = "ui/NPC_Klara.png"; // 0x1df MovS
...
{
	var_45_float = 0; var_46_float = 0; // 0x1ab PushV
	var_47_int = var_43_cvector | var_43_cvector; // 0x1ac Or
	var_46_float = sqrt(var_47_int); // 0x1ad Sqrt2
	var_48_float = 0.0; // 0x1ae PushF
	var_49_bool = var_46_float < var_48_float; // 0x1af LT
	if(var_49_bool == 0) goto Label_435; // 0x1b0 JumpB
	var_42_cvector = CVector(0.0, 0.0, 0.0); // 0x1b1 MovV
	return 2; // 0x1b2 Return
	
Label_435:
	var_42_cvector = var_43_cvector / var_43_cvector; // 0x1b3 Div2
...
func_460(var_60_int)
{
	var_61_int = 0; var_62_int = 0; // 0x1cc PushV
	var_63_string = "player"; // 0x1cd PushS
	GetVariable(var_63_string, var_62_int); // 0x1ce Func
	var_64_int = 0; // 0x1d0 PushI
	var_65_bool = var_62_int == var_64_int; // 0x1d1 Eq
	if(var_65_bool == 0) goto Label_470; // 0x1d2 JumpB
	var_60_int = 200001; // 0x1d3 MovI
	return 2; // 0x1d4 Return
	
Label_470:
	var_66_int = 1; // 0x1d6 PushI
	var_67_bool = var_62_int == var_66_int; // 0x1d7 Eq
	if(var_67_bool == 0) goto Label_475; // 0x1d8 JumpB
	var_60_int = 200002; // 0x1d9 MovI
	return 2; // 0x1da Return
	
Label_475:
	var_60_int = 200003; // 0x1db MovI
...
func_398()
{
	CameraSwitchToNormal(); // 0x18f Func
...
{
	var_81_float = 0; var_82_float = 0; var_83_float = 0; var_84_float = 0; // 0x192 PushV
	var_85_string = "playing "; // 0x193 PushS
	var_86_int = var_85_string + var_80_string; // 0x194 Add
	Trace(var_86_int); // 0x195 Func
	lshGetAnimTimes(var_80_string, var_83_float, var_84_float); // 0x197 Func
	lshPlayAnimation(var_83_float, var_84_float); // 0x199 Func
	var_87_string = "start: "; // 0x19b PushS
	var_88_int = var_87_string + var_83_float; // 0x19c Add
	Trace(var_88_int); // 0x19d Func
	var_89_string = "end: "; // 0x19f PushS
	var_90_int = var_89_string + var_84_float; // 0x1a0 Add
	Trace(var_90_int); // 0x1a1 Func
	return 4; // 0x1a3 Return
}


func_437(var_94_int, var_95_string)
{
	var_96_int = 0; var_97_int = 0; // 0x1b5 PushV
	GetVariable(var_95_string, var_97_int); // 0x1b6 Func
	var_94_int = var_97_int; // 0x1b8 Mov
	return 2; // 0x1b9 Return
}


func_342(var_17_bool)
{
	...
	GetPosition(var_28_cvector); // 0x157 ObjFunc
	GetEyesHeight(var_27_float); // 0x159 ObjFunc
	var_35_float = GetByIndex(var_28_cvector, 1); // 0x15b PushE
	var_35_float = var_35_float + var_27_float; // 0x15c Add2
	SetByIndex(var_28_cvector, 1) = var_35_float; // 0x15d PopE
	GetPosition(var_29_cvector); // 0x15e Func
	GetEyesHeight(var_27_float); // 0x160 Func
	var_36_float = GetByIndex(var_29_cvector, 1); // 0x162 PushE
	var_36_float = var_36_float + var_27_float; // 0x163 Add2
	SetByIndex(var_29_cvector, 1) = var_36_float; // 0x164 PopE
	var_30_cvector = var_28_cvector - var_29_cvector; // 0x165 Sub2
	var_37_float = GetByIndex(var_30_cvector, 1); // 0x166 PushE
	var_37_float = 0; // 0x167 MovI
	SetByIndex(var_30_cvector, 1) = var_37_float; // 0x168 PopE
	var_38_int = var_30_cvector | var_30_cvector; // 0x169 Or
	var_39_float = sqrt(var_38_int); // 0x16a Sqrt
	var_30_cvector = var_30_cvector / var_30_cvector; // 0x16b Div2
	var_31_cvector = -var_30_cvector; // 0x16c Neg2
	var_40_int = 70; // 0x16d PushI
	var_41_float = var_30_cvector * var_40_int; // 0x16e Mult
	var_42_cvector = CVector(0,0,0); var_43_cvector = CVector(0,0,0); // 0x16f PushV
	var_44_cvector = CVector(0.0, 1.0, 0.0); // 0x170 PushVec
	var_43_cvector = var_31_cvector ^ var_44_cvector; // 0x171 Xor2
	func_427(var_42_cvector, var_43_cvector); // 0x172 Call
	var_50_int = 25; // 0x174 PushI
	var_51_float = var_42_cvector * var_50_int; // 0x175 Mult
	var_52_int = var_41_float + var_51_float; // 0x176 Add
	var_53_cvector = CVector(0.0, 10.0, 0.0); // 0x177 PushVec
	var_32_cvector = var_52_int - var_53_cvector; // 0x178 Sub2
	var_33_cvector = var_29_cvector + var_32_cvector; // 0x179 Add2
	IsOverrideActive(var_34_bool); // 0x17a Func
	var_54_bool = var_34_bool; // 0x17c Push
	if(var_54_bool == 0) goto Label_384; // 0x17d JumpB
	var_17_bool = 0; // 0x17e MovB
	return 16; // 0x17f Return
	
Label_384:
	StopWorld(); // 0x180 Func
	CameraTransit(var_33_cvector, var_31_cvector); // 0x182 Func
	var_55_float = GetByIndex(var_32_cvector, 0); // 0x184 PushE
	var_56_float = GetByIndex(var_32_cvector, 2); // 0x185 PushE
	Rotate(var_55_float, var_56_float); // 0x186 Func
	CameraWaitForPlayFinish(); // 0x188 Func
	ResumeWorld(); // 0x18a Func
	var_17_bool = 1; // 0x18c MovB
	return 16; // 0x18d Return
}


func_442()
{
	var_13_string = "ood12Klara1"; // 0x1bb PushS
	var_14_int = 1; // 0x1bc PushI
	SetVariable(var_13_string, var_14_int); // 0x1bd Func
...
func_126(var_2_object, var_76_string)
{
	...
	func_481(var_77_bool); // 0x80 Call
...
Label_136:
	...
	func_402(var_80_string); // 0x8a Call
...
Label_105:
	...
	func_402(var_108_string); // 0x6b Call
