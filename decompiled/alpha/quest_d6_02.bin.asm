...
0xcb: Push("Can't retrieve diary root")
0xcc: @ Trace(Stack[-1])
0xcd: Pop(1)
0xce: Stack[-3] = (bool) 0
0xcf: Return(); Pop(2)
...
0xd7: Pop(1)
0xd8: @@ Find(Stack[-7], Stack[-2])
0xd9: Pop(0)
0xda: Pop(0); Push((bool) Stack[-2] == 0)
0xdb: IF (Stack[-1] == 0) GOTO 0xe2; Pop(1)

0xdc: Push("Can't find diary parent with id: ")
...
0xe2: @@ AddChild(Stack[-8])
0xe3: Pop(0)
0xe4: Push("player_diary")
0xe5: Push((int) 1)
0xe6: @ SetVariable(Stack[-2], Stack[-1])
0xe7: Pop(2)
0xe8: @@ GetCategory(Stack[-1])
0xe9: Pop(0)
