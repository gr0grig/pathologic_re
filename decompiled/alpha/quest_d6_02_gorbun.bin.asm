...
0x50a: Pop(0)
0x50b: Pop(0); Push((bool) Stack[-1] == 0)
...
0x52f: Push("GenerateMoney: iMin > iMax")
0x530: @ Trace(Stack[-1])
0x531: Pop(1)
0x532: Return(); Pop(8)
...
0x5d7: Stack[-4] = Stack[-2]
0x5d8: Pop(2)
0x5d9: Return(); Pop(0)

0x5da: PushEmpty()
0x5db: PushEmpty(object)
0x5dc: Stack[-1] = Stack[-2]
...
0x5f4: Stack[-3] = Stack[-7]
0x5f5: Stack[-2] = Stack[-6]
0x5f6: Stack[-1] = Stack[-5]
0x5f7: Call 0x4b5
...
0x623: Push("class")
0x624: @@ GetProperty(Stack[-1], Stack[-3])
0x625: Pop(1)
0x626: Push("bomber")
...
0x657: Push("class")
0x658: @@ GetProperty(Stack[-1], Stack[-2])
0x659: Pop(1)
...
0x674: Stack[-2] = "quest_d6_02"
0x675: Stack[-1] = "gorbun_death"
0x676: Call 0x508
