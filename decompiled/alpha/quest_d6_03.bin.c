...
Label_26:
	...
	func_146(var_27_object, var_28_string, var_29_string, var_30_string); // 0x24 Call
...
{
	var_68_object = Obj(); var_69_object = Obj(); // 0xa4 PushV
	GetDiaryRoot(var_69_object); // 0xa5 Func
	var_70_bool = var_69_object == 0; // 0xa7 Not
	if(var_70_bool == 0) goto Label_174; // 0xa8 JumpB
	var_71_string = "Can't retrieve diary root"; // 0xa9 PushS
	Trace(var_71_string); // 0xaa Func
	var_67_object = 0; // 0xac MovB
	return 2; // 0xad Return
	
Label_174:
	var_67_object = var_69_object; // 0xae Mov
...
Label_110:
	...
	func_140(var_10_object); // 0x6f Call
...
func_206()
{
	var_52_object = Obj(); var_53_object = Obj(); // 0xce PushV
	var_54_string = "Adding diary entry"; // 0xcf PushS
	Trace(var_54_string); // 0xd0 Func
	var_55_int = 108; // 0xd2 PushI
	var_56_int = 2; // 0xd3 PushI
	var_57_int = 13731; // 0xd4 PushI
	CreateDiaryEntry(var_53_object, var_55_int, var_56_int, var_57_int); // 0xd5 Func
	var_58_bool = 0; var_59_object = Obj(); var_60_int = 0; // 0xd7 PushV
	var_59_object = var_53_object; // 0xd8 Mov
	var_60_int = 107; // 0xd9 MovI
	func_177(var_58_bool, var_59_object, var_60_int); // 0xda Call
...
{
	var_61_object = Obj(); var_62_object = Obj(); var_63_int = 0; var_64_object = Obj(); var_65_object = Obj(); var_66_int = 0; // 0xb1 PushV
	var_67_object = Obj(); // 0xb2 PushV
	func_164(var_67_object); // 0xb3 Call
	var_64_object = var_67_object; // 0xb4 Mov
	Find(var_60_int, var_65_object); // 0xb6 ObjFunc
	var_72_bool = var_65_object == 0; // 0xb8 Not
	if(var_72_bool == 0) goto Label_192; // 0xb9 JumpB
	var_73_string = "Can't find diary parent with id: "; // 0xba PushS
	var_74_int = var_73_string + var_60_int; // 0xbb Add
	Trace(var_74_int); // 0xbc Func
	var_58_bool = 0; // 0xbe MovB
	return 6; // 0xbf Return
	
Label_192:
	AddChild(var_59_object); // 0xc0 ObjFunc
	var_75_string = "player_diary"; // 0xc2 PushS
	var_76_int = 1; // 0xc3 PushI
	SetVariable(var_75_string, var_76_int); // 0xc4 Func
	GetCategory(var_66_int); // 0xc6 ObjFunc
	SetDiarySection(var_66_int); // 0xc8 Func
	var_58_bool = 0; // 0xca MovB
