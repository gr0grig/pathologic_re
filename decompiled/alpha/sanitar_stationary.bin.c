task_0_event_1(var_0_object, var_1_object, var_2_bool)
{
	...
	var_69_object = Obj(); var_70_bool = 0; // 0x1b PushV
	var_69_object = var_2_bool; // 0x1c Mov
	var_70_bool = 0; // 0x1d MovB
	func_95(var_69_object, var_70_bool); // 0x1e Call
...
task_0_event_3(var_0_object, var_1_object, var_2_bool)
{
	...
	var_69_object = Obj(); var_70_bool = 0; // 0x27 PushV
	var_69_object = var_2_bool; // 0x28 Mov
	var_70_bool = 0; // 0x29 MovB
	func_95(var_69_object, var_70_bool); // 0x2a Call
...
Label_183:
	...
	var_71_bool = 0; var_72_object = Obj(); var_73_object = Obj(); // 0xbe PushV
	var_72_object = var_0_object; // 0xbf MovT
	var_73_object = var_2_object; // 0xc0 Mov
	func_1164(var_71_bool, var_72_object, var_73_object); // 0xc1 Call
	if(var_71_bool == 0) goto Label_197; // 0xc3 JumpB
...
Label_206:
	...
	var_71_bool = 0; var_72_object = Obj(); var_73_object = Obj(); // 0xd5 PushV
	var_72_object = var_0_object; // 0xd6 MovT
	var_73_object = var_2_object; // 0xd7 Mov
	func_1164(var_71_bool, var_72_object, var_73_object); // 0xd8 Call
	if(var_71_bool == 0) goto Label_220; // 0xda JumpB
...
{
	var_156_cvector = CVector(0,0,0); var_157_float = 0; var_158_cvector = CVector(0,0,0); var_159_float = 0; // 0x380 PushV
	GetPosition(var_158_cvector); // 0x381 ObjFunc
	var_160_string = "@GetHeight"; // 0x383 PushS
	var_161_int = 1; // 0x384 PushI
	var_162_bool = IsFuncExist(var_155_object, var_160_string, var_161_int); // 0x385 FuncExist
	if(var_162_bool == 0) goto Label_910; // 0x386 JumpB
	GetHeight(var_159_float); // 0x387 ObjFunc
	var_163_float = GetByIndex(var_158_cvector, 1); // 0x389 PushE
	var_164_int = 2; // 0x38a PushI
	var_165_float = var_159_float / var_164_int; // 0x38b Div
	var_163_float = var_163_float + var_165_float; // 0x38c Add2
	SetByIndex(var_158_cvector, 1) = var_163_float; // 0x38d PopE
	
Label_910:
	var_166_cvector = CVector(0,0,0); // 0x38e PushV
	var_166_cvector = var_158_cvector; // 0x38f Mov
	func_865(var_166_cvector); // 0x390 Call
...
{
	var_74_bool = var_73_object == 0; // 0x48d NullEq
	if(var_74_bool == 0) goto Label_1169; // 0x48e JumpB
	var_71_bool = 0; // 0x48f MovB
	return 0; // 0x490 Return
	
Label_1169:
	var_71_bool = 1; // 0x491 MovB
	var_75_bool = 0; var_76_object = Obj(); // 0x492 PushV
	var_76_object = var_72_object; // 0x493 Mov
	func_1190(var_75_bool, var_76_object); // 0x494 Call
	var_77_bool = var_75_bool == 0; // 0x496 Not
	if(var_77_bool == 0) goto Label_1189; // 0x497 JumpB
	var_78_float = 0; var_79_object = Obj(); // 0x498 PushV
	var_79_object = var_73_object; // 0x499 Mov
	func_450(var_79_object); // 0x49a Call
	var_80_float = 0; var_81_object = Obj(); // 0x49c PushV
	var_81_object = var_72_object; // 0x49d Mov
	func_450(var_81_object); // 0x49e Call
	var_82_int = 25; // 0x4a0 PushI
	var_83_int = var_80_float - var_82_int; // 0x4a1 Sub
	var_84_bool = var_78_float < var_83_int; // 0x4a2 LT
	if(var_84_bool == 0) goto Label_1189; // 0x4a3 JumpB
	var_71_bool = 0; // 0x4a4 MovB
...
{
	var_11_bool = 0; var_12_float = 0; var_13_bool = 0; var_14_float = 0; // 0x393 PushV
	var_15_bool = 0; var_16_object = Obj(); // 0x394 PushV
	var_16_object = var_10_object; // 0x395 Mov
	func_575(var_15_bool, var_16_object); // 0x396 Call
	var_49_bool = var_15_bool == 0; // 0x398 Not
	if(var_49_bool == 0) goto Label_924; // 0x399 JumpB
	var_9_bool = 0; // 0x39a MovB
	return 4; // 0x39b Return
	
Label_924:
	var_50_object = GlobalVars[4]; // 0x39c PushGE
	in(var_13_bool, var_10_object); // 0x39d ObjFunc
	var_51_bool = var_13_bool; // 0x39f Push
	if(var_51_bool == 0) goto Label_931; // 0x3a0 JumpB
	var_9_bool = 1; // 0x3a1 MovB
	return 4; // 0x3a2 Return
	
Label_931:
	var_52_bool = 0; var_53_object = Obj(); var_54_string = ""; // 0x3a3 PushV
	var_53_object = var_10_object; // 0x3a4 Mov
	var_54_string = "disease"; // 0x3a5 MovS
	func_458(var_52_bool, var_53_object, var_54_string); // 0x3a6 Call
	var_55_bool = var_52_bool == 0; // 0x3a8 Not
	if(var_55_bool == 0) goto Label_940; // 0x3a9 JumpB
	var_9_bool = 0; // 0x3aa MovB
	return 4; // 0x3ab Return
	
Label_940:
	var_56_string = "disease"; // 0x3ac PushS
	GetProperty(var_56_string, var_14_float); // 0x3ad ObjFunc
	var_57_int = 0; // 0x3af PushI
	var_9_bool = var_14_float > var_57_int; // 0x3b0 GT2
...
{
	var_9_bool = 0; var_10_object = Obj(); // 0x4a7 PushV
	var_10_object = var_8_object; // 0x4a8 Mov
	func_915(var_9_bool, var_10_object); // 0x4a9 Call
	var_7_bool = var_9_bool; // 0x4aa Mov
...
{
	var_167_cvector = CVector(0,0,0); var_168_float = 0; var_169_cvector = CVector(0,0,0); var_170_float = 0; var_171_bool = 0; var_172_cvector = CVector(0,0,0); var_173_float = 0; var_174_cvector = CVector(0,0,0); var_175_float = 0; var_176_bool = 0; // 0x361 PushV
	GetPosition(var_172_cvector); // 0x362 Func
	GetHeight(var_173_float); // 0x364 Func
	var_177_float = GetByIndex(var_172_cvector, 1); // 0x366 PushE
	var_178_int = 2; // 0x367 PushI
	var_179_float = var_173_float / var_178_int; // 0x368 Div
	var_177_float = var_177_float + var_179_float; // 0x369 Add2
	SetByIndex(var_172_cvector, 1) = var_177_float; // 0x36a PopE
	var_174_cvector = var_166_cvector - var_172_cvector; // 0x36b Sub2
	var_180_int = var_174_cvector | var_174_cvector; // 0x36c Or
	var_175_float = sqrt(var_180_int); // 0x36d Sqrt2
	var_181_int = 50; // 0x36e PushI
	var_182_bool = var_175_float < var_181_int; // 0x36f LT
	if(var_182_bool == 0) goto Label_883; // 0x370 JumpB
	var_176_bool = 0; // 0x371 MovB
	goto Label_887; // 0x372 Jump
	
Label_887:
	var_183_string = "all"; // 0x377 PushS
	var_184_bool = var_176_bool; // 0x378 Push
	if(var_184_bool == 0) goto Label_892; // 0x379 JumpB
	var_185_string = "cattack"; // 0x37a PushS
	goto Label_893; // 0x37b Jump
	
Label_893:
	PlayAnimation(var_183_string, var_185_string); // 0x37d Func
	return 10; // 0x37f Return
	
Label_892:
	var_186_string = "attack"; // 0x37c PushS
	
Label_883:
	var_187_float = GetByIndex(var_174_cvector, 1); // 0x373 PushE
	var_188_float = var_187_float / var_175_float; // 0x374 Div
	var_189_float = -0.14286; // 0x375 PushF
	var_176_bool = var_188_float < var_189_float; // 0x376 LT2
}
...
Label_133:
	...
	var_141_bool = var_122_bool == 0; // 0x8c Not
	if(var_141_bool == 0) goto Label_149; // 0x8d JumpB
	var_142_bool = 0; var_143_object = Obj(); // 0x8e PushV
	var_143_object = var_0_object; // 0x8f MovT
	func_1123(var_142_bool, var_143_object); // 0x90 Call
	var_149_bool = var_142_bool == 0; // 0x92 Not
	if(var_149_bool == 0) goto Label_149; // 0x93 JumpB
...
Label_160:
	...
	var_150_bool = 0; // 0xa1 PushB
	SetAttackState(var_150_bool); // 0xa2 Func
	var_151_bool = 0; // 0xa4 PushV
	var_151_bool = 0; // 0xa5 MovB
	func_809(var_151_bool); // 0xa6 Call
	StopAsync(); // 0xa8 Func
	var_152_string = "all"; // 0xaa PushS
	var_153_string = "attack_off"; // 0xab PushS
	PlayAnimation(var_152_string, var_153_string); // 0xac Func
	WaitForAnimEnd(); // 0xae Func
	var_154_bool = var_0_object != 0; // 0xb0 NullNeq
	if(var_154_bool == 0) goto Label_111; // 0xb1 JumpB
	return 0; // 0xb2 Return
	
Label_153:
	var_155_object = Obj(); // 0x99 PushV
	var_155_object = var_0_object; // 0x9a MovT
	func_896(var_155_object); // 0x9b Call
...
func_1136(var_5_bool, var_6_object)
{
	...
	var_58_bool = 0; var_59_object = Obj(); // 0x477 PushV
	var_59_object = var_6_object; // 0x478 Mov
	func_1123(var_58_bool, var_59_object); // 0x479 Call
	if(var_58_bool == 0) goto Label_1149; // 0x47b JumpB
...
func_1150(var_5_bool, var_6_object)
{
	...
	var_58_bool = 0; var_59_object = Obj(); // 0x485 PushV
	var_59_object = var_6_object; // 0x486 Mov
	func_1123(var_58_bool, var_59_object); // 0x487 Call
	if(var_58_bool == 0) goto Label_1163; // 0x489 JumpB
