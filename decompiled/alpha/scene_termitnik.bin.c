task_0_event_5(var_0_bool)
{
	...
	var_4_string = "quest_d8_01"; // 0x7 MovS
	var_5_string = "termitnik_load"; // 0x8 MovS
	...
	var_14_string = "pt_d11q04_Klara"; // 0x18 MovS
	var_15_string = "NPC_Klara"; // 0x19 MovS
	var_16_string = "d11q04_Klara.xml"; // 0x1a MovS
