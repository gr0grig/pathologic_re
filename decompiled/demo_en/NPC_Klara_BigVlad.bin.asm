...
0x5e6: @ StopWorld()
0x5e7: Pop(0)
0x5e8: @ CameraTransit(Stack[-3], Stack[-5])
0x5e9: Pop(0)
0x5ea: Push(CvectorIndex(Stack[-4], 0))
0x5eb: Push(CvectorIndex(Stack[-5], 2))
0x5ec: @ Rotate(Stack[-2], Stack[-1])
0x5ed: Pop(2)
...
0x5f3: Push("head")
0x5f4: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5f5: Pop(1)
0x5f6: Push(Stack[-1])
0x5f7: IF (Stack[-1] == 0) GOTO 0x5fb; Pop(1)

0x5f8: Push("head")
0x5f9: @ LookAsyncCamera(Stack[-1])
0x5fa: Pop(1)
0x5fb: @ CameraWaitForPlayFinish()
0x5fc: Pop(0)
0x5fd: @ ResumeWorld()
0x5fe: Pop(0)
0x5ff: Stack[-21] = (bool) 1
0x600: Return(); Pop(18)

0x601: PushEmpty(bool, bool)
0x602: @ CameraSwitchToNormal()
0x603: Pop(0)
...
0x609: Push("head")
0x60a: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x60b: Pop(1)
0x60c: Push(Stack[-1])
0x60d: IF (Stack[-1] == 0) GOTO 0x611; Pop(1)

0x60e: Push("head")
0x60f: @ UnlookAsync(Stack[-1])
0x610: Pop(1)
0x611: Return(); Pop(2)

0x612: PushEmpty(int, int, int, int)
0x613: Push("voice_common")
0x614: @ GetVariable(Stack[-1], Stack[-3])
0x615: Pop(1)
0x616: Push(Stack[-2])
0x617: IF (Stack[-1] == 0) GOTO 0x638; Pop(1)

0x618: PushEmpty(bool, object)
0x619: Stack[-1] = Stack[-7]
0x61a: Call2 0x64c
...
0x624: Stack[-6] = (bool) 0
0x625: Return(); Pop(4)

0x626: Push((int) 2)
0x627: @ irand(Stack[-2], Stack[-1])
0x628: Pop(1)
0x629: Push(Stack[-1])
0x62a: IF (Stack[-1] == 0) GOTO 0x633; Pop(1)

0x62b: Push("voice_common")
0x62c: Push((int) 1)
0x62d: Pop(1); Push(Stack[-4] + Stack[-1]);
0x62e: Push((int) 3)
...
0x646: Push("voice_common")
0x647: Push((int) 1)
0x648: @ SetVariable(Stack[-2], Stack[-1])
0x649: Pop(2)
0x64a: Stack[-6] = (bool) 1
0x64b: Return(); Pop(4)

0x64c: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x64d: Stack[-5] = "c"
0x64e: Stack[-4] = (int) 0
0x64f: Push((int) 1)
0x650: IF (Stack[-1] == 0) GOTO 0x65c; Pop(1)

0x651: Push((int) 1)
0x652: Pop(1); Push(Stack[-5] + Stack[-1]);
0x653: Pop(1); Push(Stack[-6] + Stack[-1]);
0x654: @@ HasProperty(Stack[-1], Stack[-4])
0x655: Pop(1)
0x656: Pop(0); Push((bool) Stack[-3] == 0)
0x657: IF (Stack[-1] == 0) GOTO 0x659; Pop(1)

0x658: GOTO 0x65c

0x659: Push((int) 1)
0x65a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x65b: GOTO 0x64f

0x65c: Pop(0); Push((bool) Stack[-4] == 0)
0x65d: IF (Stack[-1] == 0) GOTO 0x660; Pop(1)

0x65e: Stack[-12] = (bool) 0
0x65f: Return(); Pop(10)

0x660: Stack[-2] = (int) 0
0x661: Push((int) 1)
0x662: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x663: IF (Stack[-1] == 0) GOTO 0x666; Pop(1)

0x664: @ irand(Stack[-2], Stack[-4])
0x665: Pop(0)
0x666: Push((int) 1)
0x667: Pop(1); Push(Stack[-3] + Stack[-1]);
0x668: Pop(1); Push(Stack[-6] + Stack[-1]);
0x669: @@ GetProperty(Stack[-1], Stack[-2])
0x66a: Pop(1)
0x66b: PushEmpty(bool, string)
0x66c: Stack[-1] = Stack[-3]
0x66d: Call2 0x6bb

0x66e: Stack[-14] = Stack[-2]
0x66f: Pop(2)
0x670: Return(); Pop(10)

0x671: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x672: Push("d")
0x673: PushEmpty(int)
0x674: Call2 0x73d
...
0x677: Push("m")
0x678: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x679: Stack[-4] = (int) 0
0x67a: Push((int) 1)
0x67b: IF (Stack[-1] == 0) GOTO 0x687; Pop(1)

0x67c: Push((int) 1)
0x67d: Pop(1); Push(Stack[-5] + Stack[-1]);
0x67e: Pop(1); Push(Stack[-6] + Stack[-1]);
0x67f: @@ HasProperty(Stack[-1], Stack[-4])
0x680: Pop(1)
0x681: Pop(0); Push((bool) Stack[-3] == 0)
0x682: IF (Stack[-1] == 0) GOTO 0x684; Pop(1)

0x683: GOTO 0x687

0x684: Push((int) 1)
0x685: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x686: GOTO 0x67a

0x687: Pop(0); Push((bool) Stack[-4] == 0)
0x688: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x689: Stack[-12] = (bool) 0
0x68a: Return(); Pop(10)

0x68b: Stack[-2] = (int) 0
0x68c: Push((int) 1)
0x68d: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x68e: IF (Stack[-1] == 0) GOTO 0x691; Pop(1)

0x68f: @ irand(Stack[-2], Stack[-4])
0x690: Pop(0)
0x691: Push((int) 1)
0x692: Pop(1); Push(Stack[-3] + Stack[-1]);
0x693: Pop(1); Push(Stack[-6] + Stack[-1]);
0x694: @@ GetProperty(Stack[-1], Stack[-2])
0x695: Pop(1)
0x696: PushEmpty(bool, string)
0x697: Stack[-1] = Stack[-3]
0x698: Call2 0x6bb

0x699: Stack[-14] = Stack[-2]
0x69a: Pop(2)
0x69b: Return(); Pop(10)

0x69c: PushEmpty(bool, float, float, bool, float, float)
0x69d: @ lshHasAnimation(Stack[-3], Stack[-7])
0x69e: Pop(0)
0x69f: Push(Stack[-3])
0x6a0: IF (Stack[-1] == 0) GOTO 0x6a7; Pop(1)

0x6a1: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x6a2: Pop(0)
0x6a3: Push((bool) 0)
0x6a4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6a5: Pop(1)
0x6a6: GOTO 0x6ab

0x6a7: Push("Can't find lsh animation : ")
0x6a8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6a9: @ Trace(Stack[-1])
0x6aa: Pop(1)
0x6ab: Return(); Pop(6)

0x6ac: PushEmpty(bool, float, float, bool, float, float)
0x6ad: @ lshHasAnimation(Stack[-3], Stack[-8])
0x6ae: Pop(0)
0x6af: Push(Stack[-3])
0x6b0: IF (Stack[-1] == 0) GOTO 0x6b6; Pop(1)

0x6b1: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x6b2: Pop(0)
0x6b3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x6b4: Pop(0)
0x6b5: GOTO 0x6ba

0x6b6: Push("Can't find lsh animation : ")
0x6b7: Pop(1); Push(Stack[-1] + Stack[-9]);
0x6b8: @ Trace(Stack[-1])
0x6b9: Pop(1)
0x6ba: Return(); Pop(6)
...
0x6be: Pop(0)
0x6bf: IF (Stack[-1] == 0) GOTO 0x6c8; Pop(1)

0x6c0: @ lshHasSpeech(Stack[-1], Stack[-3])
0x6c1: Pop(0)
0x6c2: Push(Stack[-1])
0x6c3: IF (Stack[-1] == 0) GOTO 0x6c8; Pop(1)

0x6c4: @ lshPlaySpeech(Stack[-3])
0x6c5: Pop(0)
0x6c6: Stack[-4] = (bool) 1
0x6c7: Return(); Pop(2)

0x6c8: Stack[-4] = (bool) 0
0x6c9: Return(); Pop(2)
...
0x6d2: @ self(Stack[-1])
0x6d3: Pop(0)
0x6d4: Stack[-3] = Stack[-1]
0x6d5: Return(); Pop(2)

0x6d6: Stack[-1] = 0
0x6d7: PushEmpty(float, float)
0x6d8: Pop(0); Push(Stack[-3] | Stack[-3]);
0x6d9: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x6da: Push((float)0.0)
0x6db: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x6dc: IF (Stack[-1] == 0) GOTO 0x6df; Pop(1)

0x6dd: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x6de: Return(); Pop(2)

0x6df: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x6e0: Return(); Pop(2)

0x6e1: PushEmpty()
0x6e2: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x6e3: IF (Stack[-1] == 0) GOTO 0x6e6; Pop(1)

0x6e4: Stack[-4] = Stack[-2]
0x6e5: Return(); Pop(0)

0x6e6: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x6e7: IF (Stack[-1] == 0) GOTO 0x6ea; Pop(1)

0x6e8: Stack[-4] = Stack[-1]
0x6e9: Return(); Pop(0)

0x6ea: Stack[-4] = Stack[-3]
0x6eb: Return(); Pop(0)

0x6ec: PushEmpty(int, int)
0x6ed: @ GetVariable(Stack[-3], Stack[-1])
0x6ee: Pop(0)
0x6ef: Stack[-4] = Stack[-1]
0x6f0: Return(); Pop(2)

0x6f1: PushEmpty(object, object)
0x6f2: @ CreateIntVector(Stack[-1])
0x6f3: Pop(0)
0x6f4: @@ add(Stack[-4])
0x6f5: Pop(0)
0x6f6: @@ add(Stack[-3])
0x6f7: Pop(0)
0x6f8: Push((int) 3)
0x6f9: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6fa: Pop(1)
0x6fb: Return(); Pop(2)
...
0x700: Stack[-2] = "money"
0x701: Stack[-1] = Stack[-6]
0x702: Call2 0x59e

0x703: Pop(3)
0x704: Push((int) 0)
0x705: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x706: IF (Stack[-1] == 0) GOTO 0x70f; Pop(1)

0x707: Push("Money")
0x708: @ GetInvItemByName(Stack[-2], Stack[-1])
0x709: Pop(1)
0x70a: PushEmpty(int, int)
0x70b: Stack[-2] = Stack[-3]
0x70c: Stack[-1] = Stack[-5]
0x70d: Call2 0x6f1
...
0x710: PushEmpty()
0x711: Pop(0); Push((bool) Stack[-2] == 0)
0x712: IF (Stack[-1] == 0) GOTO 0x715; Pop(1)

0x713: Stack[-3] = (bool) 0
0x714: Return(); Pop(0)
...
0x718: Push((int) 8)
0x719: @ SendWorldWndMessage(Stack[-1])
0x71a: Pop(1)
0x71b: GOTO 0x725
...
0x71f: Push((int) 9)
0x720: @ SendWorldWndMessage(Stack[-1])
0x721: Pop(1)
0x722: GOTO 0x725

0x723: Stack[-3] = (bool) 0
0x724: Return(); Pop(0)

0x725: PushEmpty(float)
0x726: Stack[-1] = Stack[-2]
0x727: Call2 0x733

0x728: Pop(1)
0x729: PushEmpty(bool, object, string, float, float, float)
0x72a: Stack[-5] = Stack[-8]
0x72b: Stack[-4] = "reputation"
0x72c: Stack[-3] = Stack[-7]
0x72d: Stack[-2] = (int) 0
0x72e: Stack[-1] = (int) 1
0x72f: Call2 0x588

0x730: Pop(6)
0x731: Stack[-3] = (bool) 1
0x732: Return(); Pop(0)
...
0x749: Pop(0)
0x74a: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x74b: Return(); Pop(0)

0x74c: PushEmpty(string, string)
0x74d: Stack[-1] = "idle"
0x74e: Push(Stack[-3])
0x74f: IF (Stack[-1] == 0) GOTO 0x751; Pop(1)

0x750: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x751: Stack[-4] = Stack[-1]
0x752: Return(); Pop(2)

0x753: PushEmpty(int, bool, int, bool)
0x754: Stack[-2] = (int) 0
0x755: Push("all")
0x756: PushEmpty(string, int)
0x757: Stack[-1] = Stack[-5]
0x758: Call2 0x74c

0x759: Pop(1)
0x75a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x75b: Pop(2)
0x75c: Pop(0); Push((bool) Stack[-1] == 0)
0x75d: IF (Stack[-1] == 0) GOTO 0x75f; Pop(1)

0x75e: GOTO 0x762

0x75f: Push((int) 1)
0x760: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x761: GOTO 0x755

0x762: Stack[-5] = Stack[-2]
0x763: Return(); Pop(4)

0x764: Stack[-1] = (int) 515531
0x765: Return(); Pop(0)

0x766: Stack[-1] = (int) 502857
0x767: Return(); Pop(0)

0x768: Stack[-1] = "ui/NPC_BigVlad.png"
0x769: Return(); Pop(0)

0x76a: Stack[-1] = "ui/NPC_BigVlad_b.png"
0x76b: Return(); Pop(0)
...
0x76e: PushEmpty()
0x76f: PushEmpty(bool, object, float)
0x770: Stack[-2] = Stack[-5]
0x771: Stack[-1] = (float) 0.02
0x772: Call2 0x710
...
0x776: Push((int) 1000)
0x777: @ irand(Stack[-2], Stack[-1])
0x778: Pop(1)
0x779: PushEmpty(object, int)
0x77a: Stack[-2] = Stack[-6]
0x77b: Push((int) 2000)
0x77c: Stack[-2] = Stack[-4] + Stack[-1]; Pop(1);
0x77d: Call2 0x6fd
...
0x780: PushEmpty()
0x781: Push("ook2BigVlad1")
0x782: Push((int) 1)
0x783: @ SetVariable(Stack[-2], Stack[-1])
0x784: Pop(2)
0x785: Return(); Pop(0)
...
0x7af: PushEmpty()
0x7b0: Push(GlobalVars[1])
0x7b1: Pop(1); Push((bool) Stack[-1] == 0)
0x7b2: IF (Stack[-1] == 0) GOTO 0x7bc; Pop(1)

0x7b3: PushEmpty(int, object)
0x7b4: Stack[-1] = Stack[-3]
0x7b5: Push(-2, 1); TaskCall(2)
0x7b6: Call2 0x1aa

0x7b7: Pop(-2, 1); TaskReturn
0x7b8: Pop(2)
0x7b9: Push(GlobalVars[1])
0x7ba: Stack[-1] = (bool) 1
0x7bb: GlobalVars[1] = Stack[-1]; Pop(1)
0x7bc: PushEmpty(bool, int)
0x7bd: Stack[-1] = (int) 2
0x7be: Call2 0x746

0x7bf: Pop(1)
0x7c0: IF (Stack[-1] == 0) GOTO 0x7c8; Pop(1)

0x7c1: PushEmpty(int, object)
0x7c2: Stack[-1] = Stack[-3]
0x7c3: Push(-2, 1); TaskCall(0)
0x7c4: Call2 0x0

0x7c5: Pop(-2, 1); TaskReturn
0x7c6: Pop(2)
0x7c7: Return(); Pop(0)

0x7c8: PushEmpty(bool, int)
0x7c9: Stack[-1] = (int) 12
0x7ca: Call2 0x746

0x7cb: Pop(1)
0x7cc: IF (Stack[-1] == 0) GOTO 0x7d4; Pop(1)

0x7cd: PushEmpty(int, object)
0x7ce: Stack[-1] = Stack[-3]
0x7cf: Push(-2, 1); TaskCall(4)
0x7d0: Call2 0x2a3

0x7d1: Pop(-2, 1); TaskReturn
0x7d2: Pop(2)
0x7d3: Return(); Pop(0)

0x7d4: PushEmpty(int, object)
0x7d5: Stack[-1] = Stack[-3]
0x7d6: Push(-2, 1); TaskCall(6)
0x7d7: Call2 0x3a6

0x7d8: Pop(-2, 1); TaskReturn
0x7d9: Pop(2)
0x7da: Return(); Pop(0)
