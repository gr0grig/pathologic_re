...
0xc76: Push("head")
0xc77: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xc78: Pop(1)
0xc79: Push(Stack[-1])
0xc7a: IF (Stack[-1] == 0) GOTO 0xc7e; Pop(1)

0xc7b: Push("head")
0xc7c: @ LookAsyncCamera(Stack[-1])
0xc7d: Pop(1)
0xc7e: @ CameraWaitForPlayFinish()
0xc7f: Pop(0)
0xc80: @ ResumeWorld()
0xc81: Pop(0)
0xc82: Stack[-21] = (bool) 1
0xc83: Return(); Pop(18)

0xc84: PushEmpty(bool, bool)
0xc85: @ CameraSwitchToNormal()
0xc86: Pop(0)
0xc87: PushEmpty(bool)
0xc88: Call2 0xe23
...
0xc8c: Push("head")
0xc8d: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xc8e: Pop(1)
0xc8f: Push(Stack[-1])
0xc90: IF (Stack[-1] == 0) GOTO 0xc94; Pop(1)

0xc91: Push("head")
0xc92: @ UnlookAsync(Stack[-1])
0xc93: Pop(1)
0xc94: Return(); Pop(2)

0xc95: PushEmpty(int, int, int, int)
0xc96: Push("voice_common")
0xc97: @ GetVariable(Stack[-1], Stack[-3])
0xc98: Pop(1)
0xc99: Push(Stack[-2])
0xc9a: IF (Stack[-1] == 0) GOTO 0xcbb; Pop(1)

0xc9b: PushEmpty(bool, object)
0xc9c: Stack[-1] = Stack[-7]
0xc9d: Call2 0xccf

0xc9e: Pop(1)
0xc9f: Pop(1); Push((bool) Stack[-1] == 0)
0xca0: IF (Stack[-1] == 0) GOTO 0xca9; Pop(1)

0xca1: PushEmpty(bool, object)
0xca2: Stack[-1] = Stack[-7]
0xca3: Call2 0xcf4

0xca4: Pop(1)
0xca5: Pop(1); Push((bool) Stack[-1] == 0)
0xca6: IF (Stack[-1] == 0) GOTO 0xca9; Pop(1)

0xca7: Stack[-6] = (bool) 0
0xca8: Return(); Pop(4)

0xca9: Push((int) 2)
0xcaa: @ irand(Stack[-2], Stack[-1])
0xcab: Pop(1)
0xcac: Push(Stack[-1])
...
0xcaf: Push((int) 1)
0xcb0: Pop(1); Push(Stack[-4] + Stack[-1]);
0xcb1: Push((int) 3)
0xcb2: Pop(2); Push(Stack[-2] % Stack[-1]);
0xcb3: @ SetVariable(Stack[-2], Stack[-1])
0xcb4: Pop(2)
0xcb5: GOTO 0xcba

0xcb6: Push("voice_common")
0xcb7: Push((int) 0)
0xcb8: @ SetVariable(Stack[-2], Stack[-1])
0xcb9: Pop(2)
0xcba: GOTO 0xccd

0xcbb: PushEmpty(bool, object)
0xcbc: Stack[-1] = Stack[-7]
0xcbd: Call2 0xcf4

0xcbe: Pop(1)
0xcbf: Pop(1); Push((bool) Stack[-1] == 0)
0xcc0: IF (Stack[-1] == 0) GOTO 0xcc9; Pop(1)

0xcc1: PushEmpty(bool, object)
0xcc2: Stack[-1] = Stack[-7]
0xcc3: Call2 0xccf
...
0xcc7: Stack[-6] = (bool) 0
0xcc8: Return(); Pop(4)

0xcc9: Push("voice_common")
0xcca: Push((int) 1)
0xccb: @ SetVariable(Stack[-2], Stack[-1])
0xccc: Pop(2)
0xccd: Stack[-6] = (bool) 1
0xcce: Return(); Pop(4)

0xccf: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xcd0: Stack[-5] = "c"
0xcd1: Stack[-4] = (int) 0
0xcd2: Push((int) 1)
0xcd3: IF (Stack[-1] == 0) GOTO 0xcdf; Pop(1)

0xcd4: Push((int) 1)
0xcd5: Pop(1); Push(Stack[-5] + Stack[-1]);
0xcd6: Pop(1); Push(Stack[-6] + Stack[-1]);
0xcd7: @@ HasProperty(Stack[-1], Stack[-4])
0xcd8: Pop(1)
0xcd9: Pop(0); Push((bool) Stack[-3] == 0)
0xcda: IF (Stack[-1] == 0) GOTO 0xcdc; Pop(1)

0xcdb: GOTO 0xcdf

0xcdc: Push((int) 1)
0xcdd: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xcde: GOTO 0xcd2

0xcdf: Pop(0); Push((bool) Stack[-4] == 0)
0xce0: IF (Stack[-1] == 0) GOTO 0xce3; Pop(1)

0xce1: Stack[-12] = (bool) 0
0xce2: Return(); Pop(10)

0xce3: Stack[-2] = (int) 0
0xce4: Push((int) 1)
0xce5: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0xce6: IF (Stack[-1] == 0) GOTO 0xce9; Pop(1)

0xce7: @ irand(Stack[-2], Stack[-4])
0xce8: Pop(0)
0xce9: Push((int) 1)
0xcea: Pop(1); Push(Stack[-3] + Stack[-1]);
0xceb: Pop(1); Push(Stack[-6] + Stack[-1]);
0xcec: @@ GetProperty(Stack[-1], Stack[-2])
0xced: Pop(1)
0xcee: PushEmpty(bool, string)
0xcef: Stack[-1] = Stack[-3]
0xcf0: Call2 0xd3e

0xcf1: Stack[-14] = Stack[-2]
0xcf2: Pop(2)
0xcf3: Return(); Pop(10)

0xcf4: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xcf5: Push("d")
0xcf6: PushEmpty(int)
0xcf7: Call2 0xdec
...
0xcfa: Push("m")
0xcfb: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xcfc: Stack[-4] = (int) 0
0xcfd: Push((int) 1)
0xcfe: IF (Stack[-1] == 0) GOTO 0xd0a; Pop(1)

0xcff: Push((int) 1)
0xd00: Pop(1); Push(Stack[-5] + Stack[-1]);
0xd01: Pop(1); Push(Stack[-6] + Stack[-1]);
0xd02: @@ HasProperty(Stack[-1], Stack[-4])
0xd03: Pop(1)
0xd04: Pop(0); Push((bool) Stack[-3] == 0)
0xd05: IF (Stack[-1] == 0) GOTO 0xd07; Pop(1)

0xd06: GOTO 0xd0a

0xd07: Push((int) 1)
0xd08: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xd09: GOTO 0xcfd

0xd0a: Pop(0); Push((bool) Stack[-4] == 0)
0xd0b: IF (Stack[-1] == 0) GOTO 0xd0e; Pop(1)

0xd0c: Stack[-12] = (bool) 0
0xd0d: Return(); Pop(10)

0xd0e: Stack[-2] = (int) 0
0xd0f: Push((int) 1)
0xd10: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0xd11: IF (Stack[-1] == 0) GOTO 0xd14; Pop(1)

0xd12: @ irand(Stack[-2], Stack[-4])
0xd13: Pop(0)
0xd14: Push((int) 1)
0xd15: Pop(1); Push(Stack[-3] + Stack[-1]);
0xd16: Pop(1); Push(Stack[-6] + Stack[-1]);
0xd17: @@ GetProperty(Stack[-1], Stack[-2])
0xd18: Pop(1)
0xd19: PushEmpty(bool, string)
0xd1a: Stack[-1] = Stack[-3]
0xd1b: Call2 0xd3e

0xd1c: Stack[-14] = Stack[-2]
0xd1d: Pop(2)
0xd1e: Return(); Pop(10)

0xd1f: PushEmpty(bool, float, float, bool, float, float)
0xd20: @ lshHasAnimation(Stack[-3], Stack[-7])
0xd21: Pop(0)
0xd22: Push(Stack[-3])
0xd23: IF (Stack[-1] == 0) GOTO 0xd2a; Pop(1)

0xd24: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0xd25: Pop(0)
0xd26: Push((bool) 0)
0xd27: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0xd28: Pop(1)
0xd29: GOTO 0xd2e

0xd2a: Push("Can't find lsh animation : ")
0xd2b: Pop(1); Push(Stack[-1] + Stack[-8]);
0xd2c: @ Trace(Stack[-1])
0xd2d: Pop(1)
0xd2e: Return(); Pop(6)

0xd2f: PushEmpty(bool, float, float, bool, float, float)
0xd30: @ lshHasAnimation(Stack[-3], Stack[-8])
0xd31: Pop(0)
0xd32: Push(Stack[-3])
0xd33: IF (Stack[-1] == 0) GOTO 0xd39; Pop(1)

0xd34: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0xd35: Pop(0)
0xd36: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0xd37: Pop(0)
0xd38: GOTO 0xd3d

0xd39: Push("Can't find lsh animation : ")
0xd3a: Pop(1); Push(Stack[-1] + Stack[-9]);
0xd3b: @ Trace(Stack[-1])
0xd3c: Pop(1)
0xd3d: Return(); Pop(6)

0xd3e: PushEmpty(bool, bool)
0xd3f: PushEmpty(bool)
0xd40: Call2 0xe23

0xd41: Pop(0)
0xd42: IF (Stack[-1] == 0) GOTO 0xd4b; Pop(1)

0xd43: @ lshHasSpeech(Stack[-1], Stack[-3])
0xd44: Pop(0)
0xd45: Push(Stack[-1])
0xd46: IF (Stack[-1] == 0) GOTO 0xd4b; Pop(1)

0xd47: @ lshPlaySpeech(Stack[-3])
0xd48: Pop(0)
0xd49: Stack[-4] = (bool) 1
0xd4a: Return(); Pop(2)

0xd4b: Stack[-4] = (bool) 0
0xd4c: Return(); Pop(2)
...
0xd55: @ self(Stack[-1])
0xd56: Pop(0)
0xd57: Stack[-3] = Stack[-1]
0xd58: Return(); Pop(2)

0xd59: Stack[-1] = 0
0xd5a: PushEmpty(float, float)
0xd5b: Pop(0); Push(Stack[-3] | Stack[-3]);
0xd5c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xd5d: Push((float)0.0)
0xd5e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xd5f: IF (Stack[-1] == 0) GOTO 0xd62; Pop(1)

0xd60: Stack[-4] = CVector(0.0, 0.0, 0.0)
0xd61: Return(); Pop(2)

0xd62: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xd63: Return(); Pop(2)

0xd64: PushEmpty()
0xd65: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xd66: IF (Stack[-1] == 0) GOTO 0xd69; Pop(1)

0xd67: Stack[-4] = Stack[-2]
0xd68: Return(); Pop(0)

0xd69: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xd6a: IF (Stack[-1] == 0) GOTO 0xd6d; Pop(1)

0xd6b: Stack[-4] = Stack[-1]
0xd6c: Return(); Pop(0)

0xd6d: Stack[-4] = Stack[-3]
0xd6e: Return(); Pop(0)

0xd6f: PushEmpty(int, int)
0xd70: @ GetVariable(Stack[-3], Stack[-1])
0xd71: Pop(0)
0xd72: Stack[-4] = Stack[-1]
0xd73: Return(); Pop(2)

0xd74: PushEmpty(object, object)
0xd75: @ CreateIntVector(Stack[-1])
0xd76: Pop(0)
0xd77: @@ add(Stack[-4])
0xd78: Pop(0)
0xd79: @@ add(Stack[-3])
0xd7a: Pop(0)
0xd7b: Push((int) 3)
0xd7c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xd7d: Pop(1)
0xd7e: Return(); Pop(2)

0xd7f: Stack[-1] = 0
0xd80: PushEmpty(int, int)
0xd81: PushEmpty(object, string, int)
0xd82: Stack[-3] = Stack[-7]
0xd83: Stack[-2] = "money"
0xd84: Stack[-1] = Stack[-6]
0xd85: Call2 0xc21

0xd86: Pop(3)
0xd87: Push((int) 0)
0xd88: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0xd89: IF (Stack[-1] == 0) GOTO 0xd92; Pop(1)

0xd8a: Push("Money")
0xd8b: @ GetInvItemByName(Stack[-2], Stack[-1])
0xd8c: Pop(1)
0xd8d: PushEmpty(int, int)
0xd8e: Stack[-2] = Stack[-3]
0xd8f: Stack[-1] = Stack[-5]
0xd90: Call2 0xd74

0xd91: Pop(2)
0xd92: Return(); Pop(2)

0xd93: PushEmpty(int, int, bool, int, int, bool)
0xd94: @@ GetItemID(Stack[-3])
0xd95: Pop(0)
0xd96: Push("Category")
0xd97: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xd98: Pop(1)
0xd99: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0xd9a: Pop(0)
0xd9b: Pop(0); Push((bool) Stack[-1] == 0)
0xd9c: IF (Stack[-1] == 0) GOTO 0xda0; Pop(1)

0xd9d: @@ DropItems(Stack[-8], Stack[-7])
0xd9e: Pop(0)
0xd9f: GOTO 0xda5

0xda0: PushEmpty(int, int)
0xda1: Stack[-2] = Stack[-5]
0xda2: Stack[-1] = Stack[-9]
0xda3: Call2 0xd74
...
0xda7: @ CreateInvItem(Stack[-1])
0xda8: Pop(0)
0xda9: @@ SetItemName(Stack[-4])
0xdaa: Pop(0)
0xdab: PushEmpty(object, object, int)
0xdac: Stack[-3] = Stack[-8]
0xdad: Stack[-2] = Stack[-4]
0xdae: Stack[-1] = Stack[-6]
0xdaf: Call2 0xd93
...
0xdb2: Stack[-1] = 0
0xdb3: PushEmpty()
0xdb4: Pop(0); Push((bool) Stack[-2] == 0)
0xdb5: IF (Stack[-1] == 0) GOTO 0xdb8; Pop(1)

0xdb6: Stack[-3] = (bool) 0
0xdb7: Return(); Pop(0)
...
0xdbb: Push((int) 8)
0xdbc: @ SendWorldWndMessage(Stack[-1])
0xdbd: Pop(1)
0xdbe: GOTO 0xdc8

0xdbf: Push((int) 0)
0xdc0: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xdc1: IF (Stack[-1] == 0) GOTO 0xdc6; Pop(1)

0xdc2: Push((int) 9)
0xdc3: @ SendWorldWndMessage(Stack[-1])
0xdc4: Pop(1)
0xdc5: GOTO 0xdc8

0xdc6: Stack[-3] = (bool) 0
0xdc7: Return(); Pop(0)

0xdc8: PushEmpty(float)
0xdc9: Stack[-1] = Stack[-2]
0xdca: Call2 0xdd6

0xdcb: Pop(1)
0xdcc: PushEmpty(bool, object, string, float, float, float)
0xdcd: Stack[-5] = Stack[-8]
0xdce: Stack[-4] = "reputation"
0xdcf: Stack[-3] = Stack[-7]
0xdd0: Stack[-2] = (int) 0
0xdd1: Stack[-1] = (int) 1
0xdd2: Call2 0xc0b

0xdd3: Pop(6)
0xdd4: Stack[-3] = (bool) 1
0xdd5: Return(); Pop(0)

0xdd6: PushEmpty(object, object)
0xdd7: @ CreateFloatVector(Stack[-1])
0xdd8: Pop(0)
0xdd9: @@ add(Stack[-3])
0xdda: Pop(0)
0xddb: Push((int) 16)
0xddc: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xddd: Pop(1)
0xdde: Return(); Pop(2)

0xddf: Stack[-1] = 0
0xde0: PushEmpty(object, object)
0xde1: @ FindActor(Stack[-1], Stack[-4])
0xde2: Pop(0)
0xde3: Pop(0); Push((bool) Stack[-1] == 0)
0xde4: IF (Stack[-1] == 0) GOTO 0xde7; Pop(1)

0xde5: Stack[-5] = (bool) 0
0xde6: Return(); Pop(2)

0xde7: @ Trigger(Stack[-1], Stack[-3])
0xde8: Pop(0)
0xde9: Stack[-5] = (bool) 1
0xdea: Return(); Pop(2)

0xdeb: Stack[-1] = 0
0xdec: PushEmpty(float, float)
0xded: @ GetGameTime(Stack[-1])
0xdee: Pop(0)
0xdef: Push((int) 1)
0xdf0: PushEmpty(int)
0xdf1: Push((int) 24)
0xdf2: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0xdf3: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xdf4: Return(); Pop(2)

0xdf5: PushEmpty(float, float)
0xdf6: @ GetGameTime(Stack[-1])
0xdf7: Pop(0)
0xdf8: PushEmpty(int)
0xdf9: Stack[-1] = Stack[-2]
0xdfa: Push((int) 24)
0xdfb: Stack[-5] = Stack[-2] % Stack[-1]; Pop(2);
0xdfc: Return(); Pop(2)
...
0xe00: Pop(0)
0xe01: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0xe02: Return(); Pop(0)

0xe03: PushEmpty(string, string)
0xe04: Stack[-1] = "idle"
0xe05: Push(Stack[-3])
0xe06: IF (Stack[-1] == 0) GOTO 0xe08; Pop(1)

0xe07: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xe08: Stack[-4] = Stack[-1]
0xe09: Return(); Pop(2)

0xe0a: PushEmpty(int, bool, int, bool)
0xe0b: Stack[-2] = (int) 0
0xe0c: Push("all")
0xe0d: PushEmpty(string, int)
0xe0e: Stack[-1] = Stack[-5]
0xe0f: Call2 0xe03

0xe10: Pop(1)
0xe11: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xe12: Pop(2)
0xe13: Pop(0); Push((bool) Stack[-1] == 0)
0xe14: IF (Stack[-1] == 0) GOTO 0xe16; Pop(1)

0xe15: GOTO 0xe19

0xe16: Push((int) 1)
0xe17: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xe18: GOTO 0xe0c

0xe19: Stack[-5] = Stack[-2]
0xe1a: Return(); Pop(4)

0xe1b: Stack[-1] = (int) 515532
0xe1c: Return(); Pop(0)

0xe1d: Stack[-1] = (int) 514840
0xe1e: Return(); Pop(0)

0xe1f: Stack[-1] = "ui/NPC_Block.png"
0xe20: Return(); Pop(0)

0xe21: Stack[-1] = "ui/NPC_Block_b.png"
0xe22: Return(); Pop(0)
...
0xe25: PushEmpty()
0xe26: PushEmpty(bool, object, float)
0xe27: Stack[-2] = Stack[-5]
0xe28: Stack[-1] = (float) 0.05
0xe29: Call2 0xdb3
...
0xe33: Pop(0)
0xe34: PushEmpty(bool, string, string)
0xe35: Stack[-2] = "quest_k10_01"
0xe36: Stack[-1] = "remove_soldiers"
0xe37: Call2 0xde0

0xe38: Pop(3)
0xe39: PushEmpty(bool, string, string)
0xe3a: Stack[-2] = "quest_k10_01"
0xe3b: Stack[-1] = "init_prison"
0xe3c: Call2 0xde0
...
0xe40: Push("k10q01")
0xe41: Push((int) 5)
0xe42: @ SetVariable(Stack[-2], Stack[-1])
0xe43: Pop(2)
0xe44: PushEmpty()
0xe45: Call2 0xfb6

0xe46: Pop(0)
0xe47: PushEmpty(bool, string, string)
0xe48: Stack[-2] = "quest_k10_01"
0xe49: Stack[-1] = "free_prisoner"
0xe4a: Call2 0xde0
...
0xe4e: Push("k11q01")
0xe4f: Push((int) 2)
0xe50: @ SetVariable(Stack[-2], Stack[-1])
0xe51: Pop(2)
0xe52: PushEmpty()
0xe53: Call2 0xfc3

0xe54: Pop(0)
0xe55: PushEmpty(bool, string, string)
0xe56: Stack[-2] = "quest_k11_01"
0xe57: Stack[-1] = "init_kabak"
0xe58: Call2 0xde0

0xe59: Pop(3)
0xe5a: PushEmpty(bool, string, string)
0xe5b: Stack[-2] = "quest_k11_01"
0xe5c: Stack[-1] = "init_gun"
0xe5d: Call2 0xde0
...
0xe61: Push("k11q01")
0xe62: Push((int) 9)
0xe63: @ SetVariable(Stack[-2], Stack[-1])
0xe64: Pop(2)
0xe65: Push("k11q01SoulCount")
0xe66: Push((int) 1)
0xe67: @ SetVariable(Stack[-2], Stack[-1])
0xe68: Pop(2)
0xe69: PushEmpty()
0xe6a: Call2 0xfd0
...
0xe70: Pop(0)
0xe71: PushEmpty(bool, string, string)
0xe72: Stack[-2] = "quest_k11_01"
0xe73: Stack[-1] = "completed"
0xe74: Call2 0xde0
...
0xe7a: Pop(0)
0xe7b: PushEmpty(bool, string, string)
0xe7c: Stack[-2] = "quest_k9_01"
0xe7d: Stack[-1] = "completed"
0xe7e: Call2 0xde0
...
0xe81: PushEmpty()
0xe82: Push("playsound")
0xe83: Push("giveitem")
0xe84: @ TriggerWorld(Stack[-2], Stack[-1])
0xe85: Pop(2)
0xe86: Return(); Pop(0)
...
0xe8c: PushEmpty()
0xe8d: Push("ook11Block1")
0xe8e: Push((int) 1)
0xe8f: @ SetVariable(Stack[-2], Stack[-1])
0xe90: Pop(2)
0xe91: Return(); Pop(0)

0xe92: PushEmpty()
0xe93: Push("ook11Block2")
0xe94: Push((int) 1)
0xe95: @ SetVariable(Stack[-2], Stack[-1])
0xe96: Pop(2)
0xe97: Return(); Pop(0)

0xe98: PushEmpty()
0xe99: Push("ook11Block3")
0xe9a: Push((int) 1)
0xe9b: @ SetVariable(Stack[-2], Stack[-1])
0xe9c: Pop(2)
0xe9d: Return(); Pop(0)

0xe9e: PushEmpty()
0xe9f: Push("ook9Block1")
0xea0: Push((int) 1)
0xea1: @ SetVariable(Stack[-2], Stack[-1])
0xea2: Pop(2)
0xea3: Return(); Pop(0)

0xea4: PushEmpty()
0xea5: Push("ook12Block1")
0xea6: Push((int) 1)
0xea7: @ SetVariable(Stack[-2], Stack[-1])
0xea8: Pop(2)
0xea9: Return(); Pop(0)

0xeaa: PushEmpty()
0xeab: Push("money 5000 is given")
0xeac: @ Trace(Stack[-1])
0xead: Pop(1)
0xeae: PushEmpty(object, int)
0xeaf: Stack[-2] = Stack[-4]
0xeb0: Stack[-1] = (int) 5000
0xeb1: Call2 0xd80
...
0xeb4: PushEmpty()
0xeb5: Push("delta_pills is given")
0xeb6: @ Trace(Stack[-1])
0xeb7: Pop(1)
0xeb8: PushEmpty(object, string, int)
0xeb9: Stack[-3] = Stack[-5]
0xeba: Stack[-2] = "delta_pills"
0xebb: Stack[-1] = (int) 1
0xebc: Call2 0xda6
...
0xec1: Stack[-1] = Stack[-3]
0xec2: Call2 0xf7f

0xec3: Pop(1)
0xec4: IF (Stack[-1] == 0) GOTO 0xec7; Pop(1)

0xec5: Stack[-2] = (bool) 1
0xec6: Return(); Pop(0)

0xec7: Stack[-2] = (bool) 0
0xec8: Return(); Pop(0)

0xec9: PushEmpty()
0xeca: PushEmpty(int, string)
0xecb: Stack[-1] = "k10q01"
0xecc: Call2 0xd6f

0xecd: Pop(1)
0xece: Push((int) 2)
0xecf: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xed0: IF (Stack[-1] == 0) GOTO 0xed3; Pop(1)

0xed1: Stack[-2] = (bool) 1
0xed2: Return(); Pop(0)

0xed3: Stack[-2] = (bool) 0
0xed4: Return(); Pop(0)

0xed5: PushEmpty()
0xed6: PushEmpty(int, string)
0xed7: Stack[-1] = "k10q01"
0xed8: Call2 0xd6f

0xed9: Pop(1)
0xeda: Push((int) 4)
0xedb: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xedc: IF (Stack[-1] == 0) GOTO 0xedf; Pop(1)

0xedd: Stack[-2] = (bool) 1
0xede: Return(); Pop(0)

0xedf: Stack[-2] = (bool) 0
0xee0: Return(); Pop(0)

0xee1: PushEmpty()
0xee2: PushEmpty(int, string)
0xee3: Stack[-1] = "k11q01"
0xee4: Call2 0xd6f

0xee5: Pop(1)
0xee6: Push((int) 1)
0xee7: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xee8: IF (Stack[-1] == 0) GOTO 0xeeb; Pop(1)

0xee9: Stack[-2] = (bool) 1
0xeea: Return(); Pop(0)

0xeeb: Stack[-2] = (bool) 0
0xeec: Return(); Pop(0)

0xeed: PushEmpty()
0xeee: PushEmpty(int, string)
0xeef: Stack[-1] = "k11q01"
0xef0: Call2 0xd6f

0xef1: Pop(1)
0xef2: Push((int) 8)
0xef3: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xef4: IF (Stack[-1] == 0) GOTO 0xef7; Pop(1)

0xef5: Stack[-2] = (bool) 1
0xef6: Return(); Pop(0)

0xef7: Stack[-2] = (bool) 0
0xef8: Return(); Pop(0)

0xef9: PushEmpty()
0xefa: PushEmpty(int, string)
0xefb: Stack[-1] = "k11q01"
0xefc: Call2 0xd6f

0xefd: Pop(1)
0xefe: Push((int) 9)
0xeff: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xf00: IF (Stack[-1] == 0) GOTO 0xf03; Pop(1)

0xf01: Stack[-2] = (bool) 1
0xf02: Return(); Pop(0)

0xf03: Stack[-2] = (bool) 0
0xf04: Return(); Pop(0)
...
0xf0b: Stack[-2] = (bool) 1
0xf0c: Return(); Pop(0)

0xf0d: Stack[-2] = (bool) 0
0xf0e: Return(); Pop(0)

0xf0f: PushEmpty()
0xf10: PushEmpty(int, string)
0xf11: Stack[-1] = "k9q01"
0xf12: Call2 0xd6f

0xf13: Pop(1)
0xf14: Push((int) 8)
0xf15: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xf16: IF (Stack[-1] == 0) GOTO 0xf19; Pop(1)

0xf17: Stack[-2] = (bool) 1
0xf18: Return(); Pop(0)
...
0xf1b: PushEmpty()
0xf1c: PushEmpty(bool, object)
0xf1d: Stack[-1] = Stack[-3]
0xf1e: Call2 0xf91

0xf1f: Pop(1)
0xf20: IF (Stack[-1] == 0) GOTO 0xf23; Pop(1)

0xf21: Stack[-2] = (bool) 1
0xf22: Return(); Pop(0)

0xf23: Stack[-2] = (bool) 0
0xf24: Return(); Pop(0)

0xf25: PushEmpty()
0xf26: PushEmpty(bool, object)
...
0xf3b: Stack[-1] = Stack[-3]
0xf3c: Call2 0xfa3

0xf3d: Pop(1)
0xf3e: IF (Stack[-1] == 0) GOTO 0xf41; Pop(1)

0xf3f: Stack[-2] = (bool) 1
0xf40: Return(); Pop(0)

0xf41: Stack[-2] = (bool) 0
0xf42: Return(); Pop(0)

0xf43: PushEmpty()
0xf44: PushEmpty(int, string)
0xf45: Stack[-1] = "ook11Block1"
0xf46: Call2 0xd6f

0xf47: Pop(1)
0xf48: Push((int) 0)
0xf49: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xf4a: IF (Stack[-1] == 0) GOTO 0xf4d; Pop(1)

0xf4b: Stack[-2] = (bool) 1
0xf4c: Return(); Pop(0)

0xf4d: Stack[-2] = (bool) 0
0xf4e: Return(); Pop(0)

0xf4f: PushEmpty()
0xf50: PushEmpty(int, string)
0xf51: Stack[-1] = "ook11Block2"
0xf52: Call2 0xd6f

0xf53: Pop(1)
0xf54: Push((int) 0)
0xf55: Pop(2); Push((bool) Stack[-2] == Stack[-1])
...
0xf82: Pop(0)
0xf83: Push((int) 19)
0xf84: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0xf85: IF (Stack[-1] == 0) GOTO 0xf88; Pop(1)

0xf86: Stack[-2] = (bool) 1
0xf87: Return(); Pop(0)

0xf88: Stack[-2] = (bool) 0
0xf89: Return(); Pop(0)

0xf8a: PushEmpty(int, int)
0xf8b: Push("k11q01SoulCount")
0xf8c: @ GetVariable(Stack[-1], Stack[-2])
0xf8d: Pop(1)
0xf8e: Push((int) 7)
0xf8f: Stack[-5] = Stack[-2] >= Stack[-1]; Pop(1);
0xf90: Return(); Pop(2)
...
0xf97: PushEmpty()
0xf98: PushEmpty(bool)
0xf99: Call2 0x1063

0xf9a: Stack[-3] = Stack[-1]
0xf9b: Pop(1)
0xf9c: Return(); Pop(0)
...
0xfa6: Stack[-3] = Stack[-1]
0xfa7: Pop(1)
0xfa8: Return(); Pop(0)

0xfa9: PushEmpty(object, object)
0xfaa: Push((int) 450)
0xfab: Push((int) 1)
0xfac: Push((int) 527008)
0xfad: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfae: Pop(3)
0xfaf: PushEmpty(bool, object, int)
0xfb0: Stack[-2] = Stack[-4]
0xfb1: Stack[-1] = (int) 447
0xfb2: Call2 0x1011
...
0xfb5: Stack[-1] = 0
0xfb6: PushEmpty(object, object)
0xfb7: Push((int) 452)
0xfb8: Push((int) 1)
0xfb9: Push((int) 527010)
0xfba: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfbb: Pop(3)
0xfbc: PushEmpty(bool, object, int)
0xfbd: Stack[-2] = Stack[-4]
0xfbe: Stack[-1] = (int) 447
0xfbf: Call2 0x1011
...
0xfc2: Stack[-1] = 0
0xfc3: PushEmpty(object, object)
0xfc4: Push((int) 483)
0xfc5: Push((int) 1)
0xfc6: Push((int) 528050)
0xfc7: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfc8: Pop(3)
0xfc9: PushEmpty(bool, object, int)
0xfca: Stack[-2] = Stack[-4]
0xfcb: Stack[-1] = (int) 480
0xfcc: Call2 0x1011
...
0xfd1: Push((int) 492)
0xfd2: Push((int) 1)
0xfd3: Push((int) 528059)
0xfd4: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfd5: Pop(3)
0xfd6: PushEmpty(bool, object, int)
0xfd7: Stack[-2] = Stack[-4]
0xfd8: Stack[-1] = (int) 480
0xfd9: Call2 0x1011
...
0xfde: Push((int) 499)
0xfdf: Push((int) 1)
0xfe0: Push((int) 528066)
0xfe1: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfe2: Pop(3)
0xfe3: PushEmpty(bool, object, int)
0xfe4: Stack[-2] = Stack[-4]
0xfe5: Stack[-1] = (int) 480
0xfe6: Call2 0x1011
...
0xfe9: Stack[-1] = 0
0xfea: PushEmpty(object, object)
0xfeb: Push((int) 762)
0xfec: Push((int) 2)
0xfed: Push((int) 539747)
0xfee: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xfef: Pop(3)
0xff0: PushEmpty(bool, object, int)
0xff1: Stack[-2] = Stack[-4]
0xff2: Stack[-1] = (int) 757
0xff3: Call2 0x1011
...
0xff8: Push((int) 526)
0xff9: Push((int) 1)
0xffa: Push((int) 529818)
0xffb: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xffc: Pop(3)
0xffd: PushEmpty(bool, object, int)
0xffe: Stack[-2] = Stack[-4]
0xfff: Stack[-1] = (int) 517
0x1000: Call2 0x1011
...
0x1003: Stack[-1] = 0
0x1004: PushEmpty(object, object)
0x1005: @ GetDiaryRoot(Stack[-1])
0x1006: Pop(0)
0x1007: Pop(0); Push((bool) Stack[-1] == 0)
0x1008: IF (Stack[-1] == 0) GOTO 0x100e; Pop(1)

0x1009: Push("Can't retrieve diary root")
0x100a: @ Trace(Stack[-1])
0x100b: Pop(1)
0x100c: Stack[-3] = (bool) 0
0x100d: Return(); Pop(2)

0x100e: Stack[-3] = Stack[-1]
0x100f: Return(); Pop(2)

0x1010: Stack[-1] = 0
0x1011: PushEmpty(object, object, int, object, object, int)
0x1012: PushEmpty(object)
0x1013: Call2 0x1004

0x1014: Stack[-4] = Stack[-1]
0x1015: Pop(1)
0x1016: @@ Find(Stack[-7], Stack[-2])
0x1017: Pop(0)
0x1018: Pop(0); Push((bool) Stack[-2] == 0)
0x1019: IF (Stack[-1] == 0) GOTO 0x1020; Pop(1)

0x101a: Push("Can't find diary parent with id: ")
0x101b: Pop(1); Push(Stack[-1] + Stack[-8]);
0x101c: @ Trace(Stack[-1])
0x101d: Pop(1)
0x101e: Stack[-9] = (bool) 0
0x101f: Return(); Pop(6)

0x1020: @@ AddChild(Stack[-8])
0x1021: Pop(0)
0x1022: Push((int) 7)
0x1023: @ SendWorldWndMessage(Stack[-1])
0x1024: Pop(1)
0x1025: @@ GetCategory(Stack[-1])
0x1026: Pop(0)
0x1027: @ SetDiarySection(Stack[-1])
0x1028: Pop(0)
0x1029: Stack[-9] = (bool) 0
0x102a: Return(); Pop(6)

0x102b: Stack[-2] = 0
0x102c: Stack[-3] = 0
0x102d: PushEmpty(int, int)
0x102e: Push("branch")
0x102f: @ GetVariable(Stack[-1], Stack[-2])
0x1030: Pop(1)
0x1031: Push((int) 0)
0x1032: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x1033: IF (Stack[-1] == 0) GOTO 0x1037; Pop(1)

0x1034: Stack[-3] = (int) 1
0x1035: Return(); Pop(2)

0x1036: GOTO 0x103c

0x1037: Push((int) 1)
0x1038: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x1039: IF (Stack[-1] == 0) GOTO 0x103c; Pop(1)

0x103a: Stack[-3] = (int) 2
0x103b: Return(); Pop(2)

0x103c: Stack[-3] = (int) 3
0x103d: Return(); Pop(2)

0x103e: PushEmpty(int, int)
0x103f: Push("k2system_danko_day")
0x1040: @ GetVariable(Stack[-1], Stack[-2])
0x1041: Pop(1)
0x1042: Stack[-3] = Stack[-1]
0x1043: Return(); Pop(2)

0x1044: PushEmpty(int, int, int, int)
0x1045: PushEmpty(int)
0x1046: Call2 0x103e

0x1047: Stack[-3] = Stack[-1]
0x1048: Pop(1)
0x1049: Push("k2system_danko_state")
0x104a: Pop(1); Push(Stack[-1] + Stack[-3]);
0x104b: @ GetVariable(Stack[-1], Stack[-2])
0x104c: Pop(1)
0x104d: Stack[-5] = Stack[-1]
0x104e: Return(); Pop(4)
...
0x1051: Pop(0)
0x1052: PushEmpty(int)
0x1053: Call2 0x103e

0x1054: Pop(0)
0x1055: Stack[-3] = Stack[-2] == Stack[-1]; Pop(2);
0x1056: Return(); Pop(0)
...
0x1065: Pop(0)
0x1066: Push((int) 0)
0x1067: Stack[-3] = Stack[-2] == Stack[-1]; Pop(2);
0x1068: Return(); Pop(0)

0x1069: PushEmpty(int, int)
0x106a: Push("mt_block")
0x106b: @ GetVariable(Stack[-1], Stack[-2])
0x106c: Pop(1)
0x106d: Pop(0); Push((bool) Stack[-1] == 0)
0x106e: IF (Stack[-1] == 0) GOTO 0x1079; Pop(1)

0x106f: PushEmpty(int, object)
0x1070: Stack[-1] = Stack[-5]
0x1071: Push(-2, 1); TaskCall(4)
0x1072: Call2 0x5b3

0x1073: Pop(-2, 1); TaskReturn
0x1074: Pop(2)
0x1075: Push("mt_block")
0x1076: Push((int) 1)
0x1077: @ SetVariable(Stack[-2], Stack[-1])
0x1078: Pop(2)
0x1079: PushEmpty(bool, int)
0x107a: Stack[-1] = (int) 10
0x107b: Call2 0xdfd

0x107c: Pop(1)
0x107d: IF (Stack[-1] == 0) GOTO 0x1085; Pop(1)

0x107e: PushEmpty(int, object)
0x107f: Stack[-1] = Stack[-5]
0x1080: Push(-2, 1); TaskCall(0)
0x1081: Call2 0x0

0x1082: Pop(-2, 1); TaskReturn
0x1083: Pop(2)
0x1084: Return(); Pop(2)

0x1085: PushEmpty(bool, int)
0x1086: Stack[-1] = (int) 9
0x1087: Call2 0xdfd

0x1088: Pop(1)
0x1089: IF (Stack[-1] == 0) GOTO 0x1091; Pop(1)

0x108a: PushEmpty(int, object)
0x108b: Stack[-1] = Stack[-5]
0x108c: Push(-2, 1); TaskCall(6)
0x108d: Call2 0x6b9

0x108e: Pop(-2, 1); TaskReturn
0x108f: Pop(2)
0x1090: Return(); Pop(2)

0x1091: PushEmpty(bool, int)
0x1092: Stack[-1] = (int) 11
0x1093: Call2 0xdfd

0x1094: Pop(1)
0x1095: IF (Stack[-1] == 0) GOTO 0x109d; Pop(1)

0x1096: PushEmpty(int, object)
0x1097: Stack[-1] = Stack[-5]
0x1098: Push(-2, 1); TaskCall(2)
0x1099: Call2 0x1b1

0x109a: Pop(-2, 1); TaskReturn
0x109b: Pop(2)
0x109c: Return(); Pop(2)

0x109d: PushEmpty(bool, int)
0x109e: Stack[-1] = (int) 12
0x109f: Call2 0xdfd

0x10a0: Pop(1)
0x10a1: IF (Stack[-1] == 0) GOTO 0x10a9; Pop(1)

0x10a2: PushEmpty(int, object)
0x10a3: Stack[-1] = Stack[-5]
0x10a4: Push(-2, 1); TaskCall(8)
0x10a5: Call2 0x8a8

0x10a6: Pop(-2, 1); TaskReturn
0x10a7: Pop(2)
0x10a8: Return(); Pop(2)

0x10a9: PushEmpty(int, object)
0x10aa: Stack[-1] = Stack[-5]
0x10ab: Push(-2, 1); TaskCall(10)
0x10ac: Call2 0xa2c

0x10ad: Pop(-2, 1); TaskReturn
0x10ae: Pop(2)
0x10af: Return(); Pop(2)
