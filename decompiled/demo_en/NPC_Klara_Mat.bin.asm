...
0x614: @ StopWorld()
0x615: Pop(0)
0x616: @ CameraTransit(Stack[-3], Stack[-5])
0x617: Pop(0)
0x618: Push(CvectorIndex(Stack[-4], 0))
0x619: Push(CvectorIndex(Stack[-5], 2))
0x61a: @ Rotate(Stack[-2], Stack[-1])
0x61b: Pop(2)
...
0x621: Push("head")
0x622: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x623: Pop(1)
0x624: Push(Stack[-1])
0x625: IF (Stack[-1] == 0) GOTO 0x629; Pop(1)

0x626: Push("head")
0x627: @ LookAsyncCamera(Stack[-1])
0x628: Pop(1)
0x629: @ CameraWaitForPlayFinish()
0x62a: Pop(0)
0x62b: @ ResumeWorld()
0x62c: Pop(0)
0x62d: Stack[-21] = (bool) 1
0x62e: Return(); Pop(18)

0x62f: PushEmpty(bool, bool)
0x630: @ CameraSwitchToNormal()
0x631: Pop(0)
0x632: PushEmpty(bool)
0x633: Call2 0x74f

0x634: Pop(0)
0x635: IF (Stack[-1] == 0) GOTO 0x637; Pop(1)

0x636: GOTO 0x63f

0x637: Push("head")
0x638: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x639: Pop(1)
0x63a: Push(Stack[-1])
0x63b: IF (Stack[-1] == 0) GOTO 0x63f; Pop(1)

0x63c: Push("head")
0x63d: @ UnlookAsync(Stack[-1])
0x63e: Pop(1)
0x63f: Return(); Pop(2)

0x640: PushEmpty(int, int, int, int)
0x641: Push("voice_common")
0x642: @ GetVariable(Stack[-1], Stack[-3])
0x643: Pop(1)
0x644: Push(Stack[-2])
0x645: IF (Stack[-1] == 0) GOTO 0x666; Pop(1)

0x646: PushEmpty(bool, object)
0x647: Stack[-1] = Stack[-7]
0x648: Call2 0x67a
...
0x652: Stack[-6] = (bool) 0
0x653: Return(); Pop(4)

0x654: Push((int) 2)
0x655: @ irand(Stack[-2], Stack[-1])
0x656: Pop(1)
0x657: Push(Stack[-1])
0x658: IF (Stack[-1] == 0) GOTO 0x661; Pop(1)

0x659: Push("voice_common")
0x65a: Push((int) 1)
0x65b: Pop(1); Push(Stack[-4] + Stack[-1]);
0x65c: Push((int) 3)
...
0x672: Stack[-6] = (bool) 0
0x673: Return(); Pop(4)

0x674: Push("voice_common")
0x675: Push((int) 1)
0x676: @ SetVariable(Stack[-2], Stack[-1])
0x677: Pop(2)
0x678: Stack[-6] = (bool) 1
0x679: Return(); Pop(4)

0x67a: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x67b: Stack[-5] = "c"
0x67c: Stack[-4] = (int) 0
0x67d: Push((int) 1)
0x67e: IF (Stack[-1] == 0) GOTO 0x68a; Pop(1)

0x67f: Push((int) 1)
0x680: Pop(1); Push(Stack[-5] + Stack[-1]);
0x681: Pop(1); Push(Stack[-6] + Stack[-1]);
0x682: @@ HasProperty(Stack[-1], Stack[-4])
0x683: Pop(1)
0x684: Pop(0); Push((bool) Stack[-3] == 0)
0x685: IF (Stack[-1] == 0) GOTO 0x687; Pop(1)

0x686: GOTO 0x68a

0x687: Push((int) 1)
0x688: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x689: GOTO 0x67d

0x68a: Pop(0); Push((bool) Stack[-4] == 0)
0x68b: IF (Stack[-1] == 0) GOTO 0x68e; Pop(1)

0x68c: Stack[-12] = (bool) 0
0x68d: Return(); Pop(10)
...
0x692: @ irand(Stack[-2], Stack[-4])
0x693: Pop(0)
0x694: Push((int) 1)
0x695: Pop(1); Push(Stack[-3] + Stack[-1]);
0x696: Pop(1); Push(Stack[-6] + Stack[-1]);
0x697: @@ GetProperty(Stack[-1], Stack[-2])
0x698: Pop(1)
0x699: PushEmpty(bool, string)
0x69a: Stack[-1] = Stack[-3]
0x69b: Call2 0x6e9

0x69c: Stack[-14] = Stack[-2]
0x69d: Pop(2)
0x69e: Return(); Pop(10)

0x69f: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x6a0: Push("d")
0x6a1: PushEmpty(int)
0x6a2: Call2 0x720
...
0x6a5: Push("m")
0x6a6: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6a7: Stack[-4] = (int) 0
0x6a8: Push((int) 1)
0x6a9: IF (Stack[-1] == 0) GOTO 0x6b5; Pop(1)

0x6aa: Push((int) 1)
0x6ab: Pop(1); Push(Stack[-5] + Stack[-1]);
0x6ac: Pop(1); Push(Stack[-6] + Stack[-1]);
0x6ad: @@ HasProperty(Stack[-1], Stack[-4])
0x6ae: Pop(1)
0x6af: Pop(0); Push((bool) Stack[-3] == 0)
0x6b0: IF (Stack[-1] == 0) GOTO 0x6b2; Pop(1)

0x6b1: GOTO 0x6b5

0x6b2: Push((int) 1)
0x6b3: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x6b4: GOTO 0x6a8

0x6b5: Pop(0); Push((bool) Stack[-4] == 0)
0x6b6: IF (Stack[-1] == 0) GOTO 0x6b9; Pop(1)

0x6b7: Stack[-12] = (bool) 0
0x6b8: Return(); Pop(10)
...
0x6bd: @ irand(Stack[-2], Stack[-4])
0x6be: Pop(0)
0x6bf: Push((int) 1)
0x6c0: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6c1: Pop(1); Push(Stack[-6] + Stack[-1]);
0x6c2: @@ GetProperty(Stack[-1], Stack[-2])
0x6c3: Pop(1)
0x6c4: PushEmpty(bool, string)
0x6c5: Stack[-1] = Stack[-3]
0x6c6: Call2 0x6e9

0x6c7: Stack[-14] = Stack[-2]
0x6c8: Pop(2)
0x6c9: Return(); Pop(10)

0x6ca: PushEmpty(bool, float, float, bool, float, float)
0x6cb: @ lshHasAnimation(Stack[-3], Stack[-7])
0x6cc: Pop(0)
0x6cd: Push(Stack[-3])
0x6ce: IF (Stack[-1] == 0) GOTO 0x6d5; Pop(1)

0x6cf: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x6d0: Pop(0)
0x6d1: Push((bool) 0)
0x6d2: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6d3: Pop(1)
0x6d4: GOTO 0x6d9

0x6d5: Push("Can't find lsh animation : ")
0x6d6: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6d7: @ Trace(Stack[-1])
0x6d8: Pop(1)
0x6d9: Return(); Pop(6)

0x6da: PushEmpty(bool, float, float, bool, float, float)
0x6db: @ lshHasAnimation(Stack[-3], Stack[-8])
0x6dc: Pop(0)
0x6dd: Push(Stack[-3])
0x6de: IF (Stack[-1] == 0) GOTO 0x6e4; Pop(1)

0x6df: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x6e0: Pop(0)
0x6e1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x6e2: Pop(0)
0x6e3: GOTO 0x6e8

0x6e4: Push("Can't find lsh animation : ")
0x6e5: Pop(1); Push(Stack[-1] + Stack[-9]);
0x6e6: @ Trace(Stack[-1])
0x6e7: Pop(1)
0x6e8: Return(); Pop(6)
...
0x6ee: @ lshHasSpeech(Stack[-1], Stack[-3])
0x6ef: Pop(0)
0x6f0: Push(Stack[-1])
0x6f1: IF (Stack[-1] == 0) GOTO 0x6f6; Pop(1)

0x6f2: @ lshPlaySpeech(Stack[-3])
0x6f3: Pop(0)
0x6f4: Stack[-4] = (bool) 1
0x6f5: Return(); Pop(2)
...
0x704: Stack[-1] = 0
0x705: PushEmpty(float, float)
0x706: Pop(0); Push(Stack[-3] | Stack[-3]);
0x707: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x708: Push((float)0.0)
0x709: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x70a: IF (Stack[-1] == 0) GOTO 0x70d; Pop(1)

0x70b: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x70c: Return(); Pop(2)

0x70d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x70e: Return(); Pop(2)

0x70f: PushEmpty(int, int)
0x710: @ GetVariable(Stack[-3], Stack[-1])
0x711: Pop(0)
0x712: Stack[-4] = Stack[-1]
0x713: Return(); Pop(2)

0x714: PushEmpty(object, object)
0x715: @ FindActor(Stack[-1], Stack[-4])
0x716: Pop(0)
0x717: Pop(0); Push((bool) Stack[-1] == 0)
0x718: IF (Stack[-1] == 0) GOTO 0x71b; Pop(1)

0x719: Stack[-5] = (bool) 0
0x71a: Return(); Pop(2)

0x71b: @ Trigger(Stack[-1], Stack[-3])
0x71c: Pop(0)
0x71d: Stack[-5] = (bool) 1
0x71e: Return(); Pop(2)

0x71f: Stack[-1] = 0
0x720: PushEmpty(float, float)
0x721: @ GetGameTime(Stack[-1])
0x722: Pop(0)
0x723: Push((int) 1)
0x724: PushEmpty(int)
0x725: Push((int) 24)
0x726: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
...
0x72c: Pop(0)
0x72d: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x72e: Return(); Pop(0)

0x72f: PushEmpty(string, string)
0x730: Stack[-1] = "idle"
0x731: Push(Stack[-3])
0x732: IF (Stack[-1] == 0) GOTO 0x734; Pop(1)

0x733: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x734: Stack[-4] = Stack[-1]
0x735: Return(); Pop(2)

0x736: PushEmpty(int, bool, int, bool)
0x737: Stack[-2] = (int) 0
0x738: Push("all")
0x739: PushEmpty(string, int)
0x73a: Stack[-1] = Stack[-5]
0x73b: Call2 0x72f

0x73c: Pop(1)
0x73d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x73e: Pop(2)
0x73f: Pop(0); Push((bool) Stack[-1] == 0)
0x740: IF (Stack[-1] == 0) GOTO 0x742; Pop(1)

0x741: GOTO 0x745

0x742: Push((int) 1)
0x743: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x744: GOTO 0x738

0x745: Stack[-5] = Stack[-2]
0x746: Return(); Pop(4)

0x747: Stack[-1] = (int) 515545
0x748: Return(); Pop(0)

0x749: Stack[-1] = (int) 502870
0x74a: Return(); Pop(0)

0x74b: Stack[-1] = "ui/NPC_Mat.png"
0x74c: Return(); Pop(0)

0x74d: Stack[-1] = "ui/NPC_Mat_b.png"
0x74e: Return(); Pop(0)
...
0x75b: Push("k8q01")
0x75c: Push((int) 4)
0x75d: @ SetVariable(Stack[-2], Stack[-1])
0x75e: Pop(2)
0x75f: PushEmpty()
0x760: Call2 0x7a4

0x761: Pop(0)
0x762: PushEmpty(bool, string, string)
0x763: Stack[-2] = "quest_k8_01"
0x764: Stack[-1] = "unlock_boiny"
0x765: Call2 0x714
...
0x76b: Pop(0)
0x76c: PushEmpty(bool, string, string)
0x76d: Stack[-2] = "quest_k8_01"
0x76e: Stack[-1] = "fail"
0x76f: Call2 0x714
...
0x7b2: @ GetDiaryRoot(Stack[-1])
0x7b3: Pop(0)
0x7b4: Pop(0); Push((bool) Stack[-1] == 0)
0x7b5: IF (Stack[-1] == 0) GOTO 0x7bb; Pop(1)

0x7b6: Push("Can't retrieve diary root")
0x7b7: @ Trace(Stack[-1])
0x7b8: Pop(1)
0x7b9: Stack[-3] = (bool) 0
0x7ba: Return(); Pop(2)
...
0x7bd: Stack[-1] = 0
0x7be: PushEmpty(object, object, int, object, object, int)
0x7bf: PushEmpty(object)
0x7c0: Call2 0x7b1

0x7c1: Stack[-4] = Stack[-1]
0x7c2: Pop(1)
0x7c3: @@ Find(Stack[-7], Stack[-2])
0x7c4: Pop(0)
0x7c5: Pop(0); Push((bool) Stack[-2] == 0)
0x7c6: IF (Stack[-1] == 0) GOTO 0x7cd; Pop(1)

0x7c7: Push("Can't find diary parent with id: ")
0x7c8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7c9: @ Trace(Stack[-1])
0x7ca: Pop(1)
0x7cb: Stack[-9] = (bool) 0
0x7cc: Return(); Pop(6)

0x7cd: @@ AddChild(Stack[-8])
0x7ce: Pop(0)
0x7cf: Push((int) 7)
0x7d0: @ SendWorldWndMessage(Stack[-1])
0x7d1: Pop(1)
0x7d2: @@ GetCategory(Stack[-1])
0x7d3: Pop(0)
0x7d4: @ SetDiarySection(Stack[-1])
0x7d5: Pop(0)
0x7d6: Stack[-9] = (bool) 0
0x7d7: Return(); Pop(6)
...
0x7f4: Pop(2)
0x7f5: Push(GlobalVars[1])
0x7f6: Stack[-1] = (bool) 1
0x7f7: GlobalVars[1] = Stack[-1]; Pop(1)
0x7f8: PushEmpty(bool, int)
0x7f9: Stack[-1] = (int) 8
0x7fa: Call2 0x729

0x7fb: Pop(1)
0x7fc: IF (Stack[-1] == 0) GOTO 0x804; Pop(1)

0x7fd: PushEmpty(int, object)
0x7fe: Stack[-1] = Stack[-3]
0x7ff: Push(-2, 1); TaskCall(2)
0x800: Call2 0xd8

0x801: Pop(-2, 1); TaskReturn
0x802: Pop(2)
0x803: Return(); Pop(0)

0x804: PushEmpty(bool, int)
0x805: Stack[-1] = (int) 12
0x806: Call2 0x729

0x807: Pop(1)
0x808: IF (Stack[-1] == 0) GOTO 0x810; Pop(1)

0x809: PushEmpty(int, object)
0x80a: Stack[-1] = Stack[-3]
0x80b: Push(-2, 1); TaskCall(4)
0x80c: Call2 0x2fa

0x80d: Pop(-2, 1); TaskReturn
0x80e: Pop(2)
0x80f: Return(); Pop(0)

0x810: PushEmpty(int, object)
0x811: Stack[-1] = Stack[-3]
0x812: Push(-2, 1); TaskCall(6)
0x813: Call2 0x3fd

0x814: Pop(-2, 1); TaskReturn
0x815: Pop(2)
0x816: Return(); Pop(0)
