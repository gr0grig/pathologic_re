...
0x9e1: Push("GenerateMoney: iMin > iMax")
0x9e2: @ Trace(Stack[-1])
0x9e3: Pop(1)
0x9e4: Return(); Pop(4)
...
0x9ff: Pop(0)
0xa00: @@ SetItemName(Stack[-7])
0xa01: Pop(0)
0xa02: Push("Organ")
0xa03: Push((int) 1)
0xa04: @@ SetProperty(Stack[-2], Stack[-1])
0xa05: Pop(2)
0xa06: @@ GetItemID(Stack[-2])
0xa07: Pop(0)
0xa08: Push((int) 0)
0xa09: Push((int) 1)
...
0xaa8: Pop(0)
0xaa9: Stack[-4] = Stack[-1]
0xaaa: Return(); Pop(2)

0xaab: PushEmpty()
0xaac: PushEmpty(object)
0xaad: Stack[-1] = Stack[-2]
...
0xac8: Stack[-3] = Stack[-7]
0xac9: Stack[-2] = Stack[-6]
0xaca: Stack[-1] = Stack[-5]
0xacb: Call2 0x8a9
...
0xad0: Stack[-5] = Stack[-11]
0xad1: Stack[-4] = Stack[-10]
0xad2: Stack[-3] = Stack[-9]
0xad3: Stack[-2] = Stack[-7]
0xad4: Stack[-1] = Stack[-6]
0xad5: Call2 0x8ed
...
0xadf: Stack[-5] = Stack[-2]
0xae0: Pop(2)
0xae1: Return(); Pop(0)

0xae2: GOTO 0xaf6

0xae3: Push("player_shot")
...
0xaf1: Stack[-1] = Stack[-4]
0xaf2: Call2 0xbce

0xaf3: Stack[-5] = Stack[-2]
0xaf4: Pop(2)
0xaf5: Return(); Pop(0)
...
0xb20: @@ IsWeaponHolstered(Stack[-1])
0xb21: Pop(0)
...
0xb43: Stack[-1] = Stack[-3]
0xb44: Call2 0xbd3

0xb45: Stack[-6] = Stack[-2]
0xb46: Pop(2)
0xb47: Return(); Pop(2)
...
0xb93: PushEmpty()
0xb94: PushEmpty(int, object)
0xb95: Stack[-1] = Stack[-4]
0xb96: Call2 0xb81

0xb97: Stack[-5] = Stack[-2]
0xb98: Pop(2)
0xb99: Return(); Pop(0)
...
0xbba: @ CanSee(Stack[-1], Stack[-3])
0xbbb: Pop(0)
0xbbc: Stack[-4] = (bool) 1
0xbbd: Push(Stack[-1])
0xbbe: IF (Stack[-1] == 0) GOTO 0xbc7; Pop(1)

0xbbf: PushEmpty(float, object)
0xbc0: Stack[-1] = Stack[-5]
0xbc1: Call2 0x7da

0xbc2: Pop(1)
0xbc3: Push((int) 2250000)
...
0xbd8: Push(GlobalVars[0])
0xbd9: Stack[-1] = (bool) 0
0xbda: GlobalVars[0] = Stack[-1]; Pop(1)
...
0xbe0: PushEmpty(bool, bool)
0xbe1: Push(GlobalVars[0])
0xbe2: IF (Stack[-1] == 0) GOTO 0xbed; Pop(1)

0xbe3: @ IsOverrideActive(Stack[-1])
0xbe4: Pop(0)
0xbe5: Pop(0); Push((bool) Stack[-1] == 0)
0xbe6: IF (Stack[-1] == 0) GOTO 0xbeb; Pop(1)
...
0xbee: Stack[-1] = (bool) 0
0xbef: Return(); Pop(0)

0xbf0: PushEmpty()
0xbf1: Stack[-4] = (bool) 0
0xbf2: Return(); Pop(0)

0xbf3: PushEmpty()
0xbf4: PushEmpty(bool, object)
0xbf5: Stack[-1] = Stack[-3]
0xbf6: Call2 0x7e2

0xbf7: Pop(1)
0xbf8: IF (Stack[-1] == 0) GOTO 0xc04; Pop(1)

0xbf9: PushEmpty(object)
0xbfa: Call2 0x959

0xbfb: Pop(0)
0xbfc: Push((float)-0.1)
0xbfd: Push((bool) 1)
0xbfe: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xbff: Pop(3)
0xc00: PushEmpty(bool)
0xc01: Stack[-1] = (bool) 1
0xc02: Call2 0xa26
...
0xc06: Pop(0)
0xc07: Push(GlobalVars[0])
0xc08: Stack[-1] = (bool) 1
0xc09: GlobalVars[0] = Stack[-1]; Pop(1)
0xc0a: Push((int) 50)
0xc0b: Push((int) 40)
0xc0c: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xc0d: Pop(2)
0xc0e: Return(); Pop(0)
