...
0x878: Push("GenerateMoney: iMin > iMax")
0x879: @ Trace(Stack[-1])
0x87a: Pop(1)
0x87b: Return(); Pop(4)
...
0x965: Stack[-3] = Stack[-7]
0x966: Stack[-2] = Stack[-6]
...
0x96d: Stack[-5] = Stack[-11]
0x96e: Stack[-4] = Stack[-10]
0x96f: Stack[-3] = Stack[-9]
0x970: Stack[-2] = Stack[-7]
...
0x98e: Stack[-1] = Stack[-4]
0x98f: Call2 0xabe

0x990: Stack[-5] = Stack[-2]
0x991: Pop(2)
0x992: Return(); Pop(0)
...
0x9bd: @@ IsWeaponHolstered(Stack[-1])
0x9be: Pop(0)
...
0x9e0: Stack[-1] = Stack[-3]
0x9e1: Call2 0xac3

0x9e2: Stack[-6] = Stack[-2]
0x9e3: Pop(2)
0x9e4: Return(); Pop(2)
...
0xa3b: Pop(1)
0xa3c: Push("class")
0xa3d: @@ GetProperty(Stack[-1], Stack[-2])
0xa3e: Pop(1)
...
0xa7c: Stack[-1] = Stack[-4]
0xa7d: Call2 0xa1d

0xa7e: Stack[-5] = Stack[-2]
0xa7f: Pop(2)
0xa80: Return(); Pop(0)

0xa81: PushEmpty()
0xa82: PushEmpty(object)
0xa83: Stack[-1] = Stack[-2]
0xa84: Call2 0xa27
...
0xa95: Push(Stack[-2])
0xa96: IF (Stack[-1] == 0) GOTO 0xa9f; Pop(1)

0xa97: PushEmpty(float, object)
0xa98: Stack[-1] = Stack[-9]
0xa99: Call2 0x6c7
