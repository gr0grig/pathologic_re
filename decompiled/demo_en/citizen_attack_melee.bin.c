task_0_event_0(var_0_object, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2734(var_16_object); // 0x12 NEW_2
...
task_1_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2734(var_16_object); // 0xb7 NEW_2
...
task_1_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2507(var_15_object); // 0xcb NEW_2
	var_24_int = 0; var_25_object = Obj(); // 0xcd PushV
	var_25_object = var_12_bool; // 0xce Mov
	func_2589(var_24_int, var_25_object); // 0xcf NEW_2
...
Label_219:
	...
	func_2599(var_65_object); // 0xdd NEW_2
...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool)
{
	...
	func_2773(var_17_bool, var_18_object, var_19_object, var_20_bool); // 0xe5 NEW_2
	...
	func_2682(var_80_object, var_81_bool); // 0xeb NEW_2
...
Label_247:
	...
	func_2689(var_117_object); // 0xf9 NEW_2
...
task_1_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2724(var_16_object); // 0xff NEW_2
...
task_1_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool)
{
	...
	func_2421(var_16_bool, var_17_object, var_18_string); // 0x114 NEW_2
	...
	func_2453(var_32_object, var_33_string); // 0x11d NEW_2
...
Label_288:
	...
	func_2729(var_45_object); // 0x123 NEW_2
...
task_1_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2520(var_13_bool, var_14_string); // 0x138 NEW_2
	...
	func_2536(var_23_string); // 0x140 NEW_2
...
task_1_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2478(var_13_bool, var_14_object); // 0x146 NEW_2
	...
	func_2501(var_26_object); // 0x14e NEW_2
...
task_2_event_0(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2734(var_16_object); // 0x210 NEW_2
...
task_2_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2507(var_15_object); // 0x224 NEW_2
	var_24_int = 0; var_25_object = Obj(); // 0x226 PushV
	var_25_object = var_12_bool; // 0x227 Mov
	func_2589(var_24_int, var_25_object); // 0x228 NEW_2
...
Label_564:
	...
	func_2599(var_64_object); // 0x236 NEW_2
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool)
{
	...
	func_2773(var_17_bool, var_18_object, var_19_object, var_20_bool); // 0x23e NEW_2
	...
	func_2682(var_80_object, var_81_bool); // 0x244 NEW_2
...
Label_592:
	...
	func_2689(var_116_object); // 0x252 NEW_2
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2724(var_16_object); // 0x258 NEW_2
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_string, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool)
{
	...
	func_2421(var_16_bool, var_17_object, var_18_string); // 0x26d NEW_2
	...
	func_2453(var_31_object, var_32_string); // 0x276 NEW_2
...
Label_633:
	...
	func_2729(var_44_object); // 0x27c NEW_2
...
task_2_event_26(var_0_bool, var_1_bool, var_2_bool, var_3_string, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2520(var_13_bool, var_14_string); // 0x291 NEW_2
	...
	func_2536(var_22_string); // 0x299 NEW_2
...
task_2_event_1(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool)
{
	...
	func_2478(var_13_bool, var_14_object); // 0x2a6 NEW_2
	...
	func_2501(var_25_object); // 0x2ae NEW_2
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_int, var_5_int, var_6_bool, var_7_float, var_8_int, var_9_bool, var_10_object, var_11_bool, var_12_int)
{
	...
	func_2145(var_15_object); // 0x5e9 NEW_2
...
{
	var_14_float = 0; var_15_float = 0; // 0x950 PushV
	var_16_string = "health"; // 0x951 PushS
	var_17_bool = var_13_string == var_16_string; // 0x952 Eq
	if(var_17_bool == 0) goto Label_2396; // 0x953 JumpB
	var_18_string = "health"; // 0x954 PushS
	GetProperty(var_18_string, var_15_float); // 0x955 Func
	var_19_int = 0; // 0x957 PushI
	var_20_bool = var_15_float <= var_19_int; // 0x958 LE
	if(var_20_bool == 0) goto Label_2396; // 0x959 JumpB
	SignalDeath(var_12_object); // 0x95a Func
...
{
	var_13_object = Obj(); // 0x95e PushV
	var_13_object = var_12_object; // 0x95f Mov
	func_2376(var_13_object); // 0x960 NEW_2
...
{
	var_16_object = Obj(); var_17_int = 0; var_18_float = 0; // 0x964 PushV
	var_16_object = var_12_object; // 0x965 Mov
	var_17_int = var_13_int; // 0x966 Mov
	var_18_float = var_14_float; // 0x967 Mov
	func_1942(var_16_object, var_17_int, var_18_float); // 0x968 NEW_2
...
{
	var_18_object = Obj(); var_19_int = 0; var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_cvector = CVector(0,0,0); // 0x96c PushV
	var_18_object = var_12_object; // 0x96d Mov
	var_19_int = var_13_int; // 0x96e Mov
	var_20_float = var_14_float; // 0x96f Mov
	var_21_cvector = var_16_cvector; // 0x970 Mov
	var_22_cvector = var_17_cvector; // 0x971 Mov
	func_2010(var_20_float, var_21_cvector, var_22_cvector); // 0x972 NEW_2
...
func_0(var_14_object)
{
	...
	func_2783(var_95_object); // 0x8 NEW_2
...
{
	var_57_bool = 0; var_58_object = Obj(); // 0xa0e PushV
	var_58_object = var_56_object; // 0xa0f Mov
	func_2768(var_57_bool, var_58_object); // 0xa10 NEW_2
	if(var_57_bool == 0) goto Label_2581; // 0xa12 JumpB
	var_55_int = 2; // 0xa13 MovI
...
Label_2581:
	var_55_int = 0; // 0xa15 MovI
}


func_2583(var_66_object)
{
	var_67_object = Obj(); // 0xa18 PushV
	var_67_object = var_66_object; // 0xa19 Mov
	func_2599(var_67_object); // 0xa1a NEW_2
...
{
	var_84_bool = 0; var_85_object = Obj(); // 0xa1e PushV
	var_85_object = var_83_object; // 0xa1f Mov
	func_1874(var_84_bool, var_85_object); // 0xa20 NEW_2
	if(var_84_bool == 0) goto Label_2597; // 0xa22 JumpB
	var_82_int = 2; // 0xa23 MovI
	goto Label_2598; // 0xa24 Jump
	
Label_2598:
	return 0; // 0xa26 Return
	
Label_2597:
	var_82_int = 0; // 0xa25 MovI
}
...
func_1053(var_0_bool, var_451_float, var_452_int)
{
	...
	var_526_int = 0; // 0x438 PushV
	func_1436(var_526_int); // 0x439 NEW_2
	ReportHit(var_0_bool, var_526_int, var_458_float, var_457_float); // 0x43b Func
	var_527_object = Obj(); var_528_float = 0; // 0x43d PushV
	var_527_object = var_456_object; // 0x43e Mov
	var_528_float = var_458_float; // 0x43f Mov
...
{
	var_118_object = Obj(); // 0xa28 PushV
	var_118_object = var_117_object; // 0xa29 Mov
	TaskCall(3); // 0xa2a TaskCall
	func_775(var_118_object); // 0xa2b NEW_2
...
func_2607(var_28_bool, var_29_object, var_30_bool)
{
	var_31_string = ""; var_32_string = ""; var_33_string = ""; var_34_string = ""; // 0xa2f PushV
	var_35_bool = 0; var_36_object = Obj(); var_37_string = ""; // 0xa30 PushV
	var_36_object = var_29_object; // 0xa31 Mov
	var_37_string = "class"; // 0xa32 MovS
	func_1748(var_35_bool, var_36_object, var_37_string); // 0xa33 NEW_2
	var_44_bool = var_35_bool == 0; // 0xa35 Not
	if(var_44_bool == 0) goto Label_2617; // 0xa36 JumpB
	var_28_bool = 0; // 0xa37 MovB
	return 4; // 0xa38 Return
	
Label_2617:
	var_45_string = "class"; // 0xa39 PushS
	GetProperty(var_45_string, var_33_string); // 0xa3a Func
	var_46_string = "class"; // 0xa3c PushS
	GetProperty(var_46_string, var_34_string); // 0xa3d ObjFunc
	var_47_bool = 0; // 0xa3f PushV
	var_47_bool = 0; // 0xa40 MovB
	var_48_bool = var_30_bool == 0; // 0xa41 Not
	if(var_48_bool == 0) goto Label_2630; // 0xa42 JumpB
	var_49_bool = var_33_string == var_34_string; // 0xa43 Eq
	if(var_49_bool == 0) goto Label_2630; // 0xa44 JumpB
	var_47_bool = 1; // 0xa45 MovB
	
Label_2630:
	if(var_47_bool == 0) goto Label_2633; // 0xa46 JumpB
	var_28_bool = 1; // 0xa47 MovB
	return 4; // 0xa48 Return
	
Label_2633:
	var_50_string = "rat"; // 0xa49 PushS
	var_51_bool = var_34_string == var_50_string; // 0xa4a Eq
	if(var_51_bool == 0) goto Label_2639; // 0xa4b JumpB
	var_28_bool = 0; // 0xa4c MovB
	return 4; // 0xa4d Return
	
Label_2639:
	var_52_string = "rat_big"; // 0xa4f PushS
	var_53_bool = var_34_string == var_52_string; // 0xa50 Eq
	if(var_53_bool == 0) goto Label_2645; // 0xa51 JumpB
	var_28_bool = 0; // 0xa52 MovB
	return 4; // 0xa53 Return
	
Label_2645:
	var_54_string = "dog"; // 0xa55 PushS
	var_55_bool = var_34_string == var_54_string; // 0xa56 Eq
	if(var_55_bool == 0) goto Label_2651; // 0xa57 JumpB
	var_28_bool = 0; // 0xa58 MovB
	return 4; // 0xa59 Return
	
Label_2651:
	var_56_string = "grabitel"; // 0xa5b PushS
	var_57_bool = var_34_string == var_56_string; // 0xa5c Eq
	if(var_57_bool == 0) goto Label_2657; // 0xa5d JumpB
	var_28_bool = 0; // 0xa5e MovB
	return 4; // 0xa5f Return
	
Label_2657:
	var_58_string = "bomber"; // 0xa61 PushS
	var_59_bool = var_34_string == var_58_string; // 0xa62 Eq
	if(var_59_bool == 0) goto Label_2663; // 0xa63 JumpB
	var_28_bool = 0; // 0xa64 MovB
	return 4; // 0xa65 Return
	
Label_2663:
	var_60_string = "sanitar"; // 0xa67 PushS
	var_61_bool = var_34_string == var_60_string; // 0xa68 Eq
	if(var_61_bool == 0) goto Label_2669; // 0xa69 JumpB
	var_28_bool = 0; // 0xa6a MovB
	return 4; // 0xa6b Return
	
Label_2669:
	var_62_string = "hunter"; // 0xa6d PushS
	var_63_bool = var_34_string == var_62_string; // 0xa6e Eq
	if(var_63_bool == 0) goto Label_2675; // 0xa6f JumpB
	var_28_bool = 0; // 0xa70 MovB
	return 4; // 0xa71 Return
	
Label_2675:
	var_64_string = "soldier"; // 0xa73 PushS
	var_65_bool = var_34_string == var_64_string; // 0xa74 Eq
	if(var_65_bool == 0) goto Label_2680; // 0xa75 JumpB
	var_28_bool = 0; // 0xa76 MovB
	return 4; // 0xa77 Return
	
Label_2680:
	var_28_bool = 1; // 0xa78 MovB
...
Label_1128:
	...
	var_529_string = "all"; // 0x46d PushS
	var_530_string = "attack_middle"; // 0x46e PushS
	var_531_int = var_530_string + var_420_int; // 0x46f Add
	HasAnimation(var_421_bool, var_529_string, var_531_int); // 0x470 Func
	var_532_bool = var_421_bool; // 0x472 Push
	if(var_532_bool == 0) goto Label_1209; // 0x473 JumpB
	func_2154(); // 0x475 NEW_2
	var_533_string = "all"; // 0x477 PushS
	var_534_string = "attack_middle"; // 0x478 PushS
	var_535_int = var_534_string + var_420_int; // 0x479 Add
	PlayAnimation(var_533_string, var_535_int); // 0x47a Func
	WaitForAnimEnd(); // 0x47c Func
	func_1431(var_423_string); // 0x47f NEW_2
	var_536_bool = 0; var_537_object = Obj(); // 0x481 PushV
	var_537_object = var_0_bool; // 0x482 MovT
	func_1874(var_536_bool, var_537_object); // 0x483 NEW_2
	var_538_bool = var_536_bool == 0; // 0x485 Not
	if(var_538_bool == 0) goto Label_1163; // 0x486 JumpB
	StopAsync(); // 0x487 Func
	var_414_bool = 0; // 0x489 MovB
	return 8; // 0x48a Return
	
Label_1163:
	var_539_float = 0; var_540_int = 0; // 0x48b PushV
	var_539_float = var_415_float; // 0x48c Mov
	var_540_int = var_420_int; // 0x48d Mov
	func_1053(var_423_string, var_539_float, var_540_int); // 0x48e NEW_2
	var_422_int = 1; // 0x490 MovI
	
Label_1169:
	var_541_string = "attack_middle"; // 0x491 PushS
	var_542_int = var_541_string + var_420_int; // 0x492 Add
	var_543_string = "_"; // 0x493 PushS
	var_544_int = var_542_int + var_543_string; // 0x494 Add
	var_423_string = var_544_int + var_422_int; // 0x495 Add2
	var_545_string = "all"; // 0x496 PushS
	HasAnimation(var_421_bool, var_545_string, var_423_string); // 0x497 Func
	var_546_bool = var_421_bool == 0; // 0x499 Not
	if(var_546_bool == 0) goto Label_1180; // 0x49a JumpB
	goto Label_1209; // 0x49b Jump
	
Label_1209:
	var_547_bool = 0; // 0x4b9 PushB
	SetAttackState(var_547_bool); // 0x4ba Func
	var_548_string = "all"; // 0x4bc PushS
	var_549_string = "attack_end"; // 0x4bd PushS
	var_550_int = var_549_string + var_420_int; // 0x4be Add
	PlayAnimation(var_548_string, var_550_int); // 0x4bf Func
	var_551_bool = 0; // 0x4c1 PushV
	func_1445(var_551_bool); // 0x4c2 NEW_2
	if(var_551_bool == 0) goto Label_1227; // 0x4c4 JumpB
	var_552_bool = 0; var_553_float = 0; // 0x4c5 PushV
	var_553_float = 0.75; // 0x4c6 MovF
	func_1229(var_552_bool, var_553_float); // 0x4c7 NEW_2
...
Label_1180:
	func_2154(); // 0x49d NEW_2
	var_561_string = "all"; // 0x49f PushS
	PlayAnimation(var_561_string, var_423_string); // 0x4a0 Func
	WaitForAnimEnd(); // 0x4a2 Func
	func_1431(var_423_string); // 0x4a5 NEW_2
	var_562_bool = 0; var_563_object = Obj(); // 0x4a7 PushV
	var_563_object = var_0_bool; // 0x4a8 MovT
	func_1874(var_562_bool, var_563_object); // 0x4a9 NEW_2
	var_564_bool = var_562_bool == 0; // 0x4ab Not
	if(var_564_bool == 0) goto Label_1201; // 0x4ac JumpB
	StopAsync(); // 0x4ad Func
	var_414_bool = 0; // 0x4af MovB
	return 8; // 0x4b0 Return
	
Label_1201:
	var_565_float = 0; var_566_int = 0; // 0x4b1 PushV
	var_565_float = var_415_float; // 0x4b2 Mov
	var_566_int = var_420_int; // 0x4b3 Mov
	func_1053(var_423_string, var_565_float, var_566_int); // 0x4b4 NEW_2
	var_567_int = 1; // 0x4b6 PushI
	var_422_int = var_422_int + var_567_int; // 0x4b7 Add2
...
func_2126(var_521_float)
{
	...
	var_524_int = 15; // 0x853 PushI
	SendWorldWndMessage(var_524_int, var_523_object); // 0x854 Func
...
{
	var_24_float = 0; var_25_float = 0; // 0x858 PushV
	GetGameTime(var_25_float); // 0x859 Func
	var_26_int = 1; // 0x85b PushI
	var_27_int = 0; // 0x85c PushV
	var_28_int = 24; // 0x85d PushI
	var_27_int = var_25_float / var_25_float; // 0x85e Div2
	var_23_int = var_26_int + var_27_int; // 0x85f Add2
	return 2; // 0x860 Return
}


func_2145(var_15_object)
{
	var_16_bool = 0; var_17_bool = 0; // 0x861 PushV
	IsPlayerActor(var_15_object, var_17_bool); // 0x862 Func
	var_18_bool = var_17_bool; // 0x864 Push
	if(var_18_bool == 0) goto Label_2153; // 0x865 JumpB
	var_19_string = "attack"; // 0x866 PushS
	PlayGlobalMusic(var_19_string); // 0x867 Func
...
func_2154()
{
	var_426_object = Obj(); var_427_object = Obj(); // 0x86a PushV
	GetScene(var_427_object); // 0x86b Func
	var_428_string = "battle"; // 0x86d PushS
	var_429_object = Obj(); // 0x86e PushV
	func_2092(var_429_object); // 0x86f NEW_2
	BroadcastMessage(var_428_string, var_429_object, var_427_object); // 0x871 Func
	return 2; // 0x873 Return
}


func_2165(var_20_int, var_21_int)
{
	var_31_int = 0; var_32_bool = 0; var_33_int = 0; var_34_bool = 0; // 0x875 PushV
	var_35_bool = var_20_int > var_21_int; // 0x876 GT
	if(var_35_bool == 0) goto Label_2172; // 0x877 JumpB
	var_36_string = "GenerateMoney: iMin > iMax"; // 0x878 PushS
	Trace(var_36_string); // 0x879 Func
	return 4; // 0x87b Return
	
Label_2172:
	var_33_int = 0; // 0x87c MovI
	var_37_bool = var_20_int != var_21_int; // 0x87d Neq
	if(var_37_bool == 0) goto Label_2179; // 0x87e JumpB
	var_38_int = var_21_int - var_20_int; // 0x87f Sub
	irand(var_33_int, var_38_int); // 0x880 Func
	goto Label_2183; // 0x882 Jump
	
Label_2183:
	var_33_int = var_33_int + var_20_int; // 0x887 Add2
	var_39_int = 0; // 0x888 PushI
	var_40_bool = var_33_int == var_39_int; // 0x889 Eq
	if(var_40_bool == 0) goto Label_2188; // 0x88a JumpB
	return 4; // 0x88b Return
	
Label_2188:
	var_41_int = 0; var_42_string = ""; // 0x88c PushV
	var_42_string = "Money"; // 0x88d MovS
	func_2371(var_41_int, var_42_string); // 0x88e NEW_2
	var_45_int = 0; // 0x890 PushI
	AddItem(var_34_bool, var_41_int, var_45_int, var_33_int); // 0x891 Func
	return 4; // 0x893 Return
	
Label_2179:
	var_46_int = 0; // 0x883 PushI
	var_47_bool = var_20_int == var_46_int; // 0x884 Eq
	if(var_47_bool == 0) goto Label_2183; // 0x885 JumpB
	return 4; // 0x886 Return
}


func_2682(var_79_int, var_80_object)
{
	var_82_int = 0; var_83_object = Obj(); // 0xa7b PushV
	var_83_object = var_80_object; // 0xa7c Mov
	func_2589(var_82_int, var_83_object); // 0xa7d NEW_2
	var_79_int = var_82_int; // 0xa7e Mov
...
{
	var_117_object = Obj(); // 0xa82 PushV
	var_117_object = var_116_object; // 0xa83 Mov
	func_2599(var_117_object); // 0xa84 NEW_2
...
func_2695(var_21_bool, var_22_object, var_23_object, var_24_float, var_25_bool)
{
	var_26_bool = 0; var_27_bool = 0; // 0xa87 PushV
	var_28_bool = 0; var_29_object = Obj(); var_30_bool = 0; // 0xa88 PushV
	var_29_object = var_23_object; // 0xa89 Mov
	var_30_bool = !var_25_bool; // 0xa8a Not2
	func_2607(var_28_bool, var_29_object, var_30_bool); // 0xa8b NEW_2
	var_66_bool = var_28_bool == 0; // 0xa8d Not
	if(var_66_bool == 0) goto Label_2705; // 0xa8e JumpB
	var_21_bool = 0; // 0xa8f MovB
	return 2; // 0xa90 Return
	
Label_2705:
	CanSee(var_27_bool, var_22_object); // 0xa91 Func
	var_67_bool = 0; // 0xa93 PushV
	var_67_bool = 1; // 0xa94 MovB
	var_68_bool = var_27_bool; // 0xa95 Push
	if(var_68_bool == 0) goto Label_2719; // 0xa96 JumpB
	var_69_float = 0; var_70_object = Obj(); // 0xa97 PushV
	var_70_object = var_22_object; // 0xa98 Mov
	func_1735(var_70_object); // 0xa99 NEW_2
	var_77_float = var_24_float * var_24_float; // 0xa9b Mult
	var_78_bool = var_69_float <= var_77_float; // 0xa9c LE
	if(var_78_bool == 0) goto Label_2719; // 0xa9d JumpB
	var_67_bool = 0; // 0xa9e MovB
	
Label_2719:
	if(var_67_bool == 0) goto Label_2722; // 0xa9f JumpB
	var_21_bool = 1; // 0xaa0 MovB
	return 2; // 0xaa1 Return
	
Label_2722:
	var_21_bool = 0; // 0xaa2 MovB
	return 2; // 0xaa3 Return
}


func_2196(var_14_bool)
{
	var_15_int = 0; var_16_bool = 0; var_17_int = 0; var_18_bool = 0; // 0x894 PushV
	var_19_bool = var_14_bool; // 0x895 Push
	if(var_19_bool == 0) goto Label_2285; // 0x896 JumpB
	var_20_int = 0; var_21_int = 0; // 0x897 PushV
	var_20_int = 0; // 0x898 MovI
	var_22_int = 100; // 0x899 PushI
	var_23_int = 0; // 0x89a PushV
	func_2136(var_23_int); // 0x89b NEW_2
	var_29_int = 100; // 0x89d PushI
	var_30_float = var_23_int * var_29_int; // 0x89e Mult
	var_21_int = var_22_int + var_30_float; // 0x89f Add2
	func_2165(var_20_int, var_21_int); // 0x8a0 NEW_2
	var_48_int = 8; // 0x8a2 PushI
	irand(var_17_int, var_48_int); // 0x8a3 Func
	var_49_int = 0; // 0x8a5 PushI
	var_50_bool = var_17_int == var_49_int; // 0x8a6 Eq
	if(var_50_bool == 0) goto Label_2225; // 0x8a7 JumpB
	var_51_int = 0; var_52_string = ""; // 0x8a8 PushV
	var_52_string = "lemon"; // 0x8a9 MovS
	func_2371(var_51_int, var_52_string); // 0x8aa NEW_2
	var_53_int = 0; // 0x8ac PushI
	var_54_int = 1; // 0x8ad PushI
	AddItem(var_18_bool, var_51_int, var_53_int, var_54_int); // 0x8ae Func
	goto Label_2284; // 0x8b0 Jump
	
Label_2284:
	goto Label_2370; // 0x8ec Jump
	
Label_2370:
	return 4; // 0x942 Return
	
Label_2225:
	var_55_int = 1; // 0x8b1 PushI
	var_56_bool = var_17_int == var_55_int; // 0x8b2 Eq
	if(var_56_bool == 0) goto Label_2237; // 0x8b3 JumpB
	var_57_int = 0; var_58_string = ""; // 0x8b4 PushV
	var_58_string = "rusk"; // 0x8b5 MovS
	func_2371(var_57_int, var_58_string); // 0x8b6 NEW_2
	var_59_int = 0; // 0x8b8 PushI
	var_60_int = 1; // 0x8b9 PushI
	AddItem(var_18_bool, var_57_int, var_59_int, var_60_int); // 0x8ba Func
	goto Label_2284; // 0x8bc Jump
	
Label_2237:
	var_61_int = 2; // 0x8bd PushI
	var_62_bool = var_17_int == var_61_int; // 0x8be Eq
	if(var_62_bool == 0) goto Label_2249; // 0x8bf JumpB
	var_63_int = 0; var_64_string = ""; // 0x8c0 PushV
	var_64_string = "hook"; // 0x8c1 MovS
	func_2371(var_63_int, var_64_string); // 0x8c2 NEW_2
	var_65_int = 0; // 0x8c4 PushI
	var_66_int = 1; // 0x8c5 PushI
	AddItem(var_18_bool, var_63_int, var_65_int, var_66_int); // 0x8c6 Func
	goto Label_2284; // 0x8c8 Jump
	
Label_2249:
	var_67_int = 4; // 0x8c9 PushI
	var_68_bool = var_17_int == var_67_int; // 0x8ca Eq
	if(var_68_bool == 0) goto Label_2261; // 0x8cb JumpB
	var_69_int = 0; var_70_string = ""; // 0x8cc PushV
	var_70_string = "syringe"; // 0x8cd MovS
	func_2371(var_69_int, var_70_string); // 0x8ce NEW_2
	var_71_int = 0; // 0x8d0 PushI
	var_72_int = 1; // 0x8d1 PushI
	AddItem(var_18_bool, var_69_int, var_71_int, var_72_int); // 0x8d2 Func
	goto Label_2284; // 0x8d4 Jump
	
Label_2261:
	var_73_int = 5; // 0x8d5 PushI
	var_74_bool = var_17_int == var_73_int; // 0x8d6 Eq
	if(var_74_bool == 0) goto Label_2273; // 0x8d7 JumpB
	var_75_int = 0; var_76_string = ""; // 0x8d8 PushV
	var_76_string = "watch"; // 0x8d9 MovS
	func_2371(var_75_int, var_76_string); // 0x8da NEW_2
	var_77_int = 0; // 0x8dc PushI
	var_78_int = 1; // 0x8dd PushI
	AddItem(var_18_bool, var_75_int, var_77_int, var_78_int); // 0x8de Func
	goto Label_2284; // 0x8e0 Jump
	
Label_2273:
	var_79_int = 6; // 0x8e1 PushI
	var_80_bool = var_17_int == var_79_int; // 0x8e2 Eq
	if(var_80_bool == 0) goto Label_2284; // 0x8e3 JumpB
	var_81_int = 0; var_82_string = ""; // 0x8e4 PushV
	var_82_string = "razor"; // 0x8e5 MovS
	func_2371(var_81_int, var_82_string); // 0x8e6 NEW_2
	var_83_int = 0; // 0x8e8 PushI
	var_84_int = 1; // 0x8e9 PushI
	AddItem(var_18_bool, var_81_int, var_83_int, var_84_int); // 0x8ea Func
	
Label_2285:
	var_85_int = 0; var_86_int = 0; // 0x8ed PushV
	var_85_int = 0; // 0x8ee MovI
	var_87_int = 50; // 0x8ef PushI
	var_88_int = 0; // 0x8f0 PushV
	func_2136(var_88_int); // 0x8f1 NEW_2
	var_89_int = 50; // 0x8f3 PushI
	var_90_float = var_88_int * var_89_int; // 0x8f4 Mult
	var_86_int = var_87_int + var_90_float; // 0x8f5 Add2
	func_2165(var_85_int, var_86_int); // 0x8f6 NEW_2
	var_91_int = 7; // 0x8f8 PushI
	irand(var_17_int, var_91_int); // 0x8f9 Func
	var_92_int = 0; // 0x8fb PushI
	var_93_bool = var_17_int == var_92_int; // 0x8fc Eq
	if(var_93_bool == 0) goto Label_2311; // 0x8fd JumpB
	var_94_int = 0; var_95_string = ""; // 0x8fe PushV
	var_95_string = "beads"; // 0x8ff MovS
	func_2371(var_94_int, var_95_string); // 0x900 NEW_2
	var_96_int = 0; // 0x902 PushI
	var_97_int = 1; // 0x903 PushI
	AddItem(var_18_bool, var_94_int, var_96_int, var_97_int); // 0x904 Func
	goto Label_2370; // 0x906 Jump
	
Label_2311:
	var_98_int = 1; // 0x907 PushI
	var_99_bool = var_17_int == var_98_int; // 0x908 Eq
	if(var_99_bool == 0) goto Label_2323; // 0x909 JumpB
	var_100_int = 0; var_101_string = ""; // 0x90a PushV
	var_101_string = "bracelet"; // 0x90b MovS
	func_2371(var_100_int, var_101_string); // 0x90c NEW_2
	var_102_int = 0; // 0x90e PushI
	var_103_int = 1; // 0x90f PushI
	AddItem(var_18_bool, var_100_int, var_102_int, var_103_int); // 0x910 Func
	goto Label_2370; // 0x912 Jump
	
Label_2323:
	var_104_int = 2; // 0x913 PushI
	var_105_bool = var_17_int == var_104_int; // 0x914 Eq
	if(var_105_bool == 0) goto Label_2335; // 0x915 JumpB
	var_106_int = 0; var_107_string = ""; // 0x916 PushV
	var_107_string = "ear_ring"; // 0x917 MovS
	func_2371(var_106_int, var_107_string); // 0x918 NEW_2
	var_108_int = 0; // 0x91a PushI
	var_109_int = 1; // 0x91b PushI
	AddItem(var_18_bool, var_106_int, var_108_int, var_109_int); // 0x91c Func
	goto Label_2370; // 0x91e Jump
	
Label_2335:
	var_110_int = 3; // 0x91f PushI
	var_111_bool = var_17_int == var_110_int; // 0x920 Eq
	if(var_111_bool == 0) goto Label_2347; // 0x921 JumpB
	var_112_int = 0; var_113_string = ""; // 0x922 PushV
	var_113_string = "gold_ring"; // 0x923 MovS
	func_2371(var_112_int, var_113_string); // 0x924 NEW_2
	var_114_int = 0; // 0x926 PushI
	var_115_int = 1; // 0x927 PushI
	AddItem(var_18_bool, var_112_int, var_114_int, var_115_int); // 0x928 Func
	goto Label_2370; // 0x92a Jump
	
Label_2347:
	var_116_int = 4; // 0x92b PushI
	var_117_bool = var_17_int == var_116_int; // 0x92c Eq
	if(var_117_bool == 0) goto Label_2359; // 0x92d JumpB
	var_118_int = 0; var_119_string = ""; // 0x92e PushV
	var_119_string = "silver_ring"; // 0x92f MovS
	func_2371(var_118_int, var_119_string); // 0x930 NEW_2
	var_120_int = 0; // 0x932 PushI
	var_121_int = 1; // 0x933 PushI
	AddItem(var_18_bool, var_118_int, var_120_int, var_121_int); // 0x934 Func
	goto Label_2370; // 0x936 Jump
	
Label_2359:
	var_122_int = 5; // 0x937 PushI
	var_123_bool = var_17_int == var_122_int; // 0x938 Eq
	if(var_123_bool == 0) goto Label_2370; // 0x939 JumpB
	var_124_int = 0; var_125_string = ""; // 0x93a PushV
	var_125_string = "flower"; // 0x93b MovS
	func_2371(var_124_int, var_125_string); // 0x93c NEW_2
	var_126_int = 0; // 0x93e PushI
	var_127_int = 1; // 0x93f PushI
	AddItem(var_18_bool, var_124_int, var_126_int, var_127_int); // 0x940 Func
}
...
func_2724(var_15_int)
{
	var_15_int = 0; // 0xaa5 MovI
...
func_2729(var_42_int)
{
	var_42_int = 0; // 0xaaa MovI
...
func_2734(var_15_int)
{
	var_15_int = 0; // 0xaaf MovI
...
Label_698:
	...
	func_2556(var_175_int); // 0x2bb NEW_2
...
Label_713:
	...
	func_2549(var_197_string, var_198_int); // 0x2d7 NEW_2
...
func_2740(var_18_bool)
{
	var_18_bool = 0; // 0xab5 MovB
...
func_2745(var_25_bool)
{
	var_25_bool = 0; // 0xaba MovB
...
func_2755(var_20_bool)
{
	var_20_bool = 0; // 0xac4 MovB
...
func_2760()
{
	var_13_bool = GlobalVars[0]; // 0xac8 PushGE
	var_13_bool = 0; // 0xac9 MovB
	GlobalVars[0] = var_13_bool; // 0xaca PopGE
	var_14_bool = 0; // 0xacb PushV
	var_14_bool = 1; // 0xacc MovB
	func_2196(var_14_bool); // 0xacd NEW_2
	return 0; // 0xacf Return
}


func_1229(var_552_bool, var_553_float)
{
	var_554_float = 0; var_555_bool = 0; var_556_float = 0; var_557_bool = 0; // 0x4cd PushV
	rand(var_556_float); // 0x4ce Func
	var_558_bool = var_556_float < var_553_float; // 0x4d0 LT
	if(var_558_bool == 0) goto Label_1249; // 0x4d1 JumpB
	
Label_1234:
	IsAnimationPlaying(var_557_bool); // 0x4d2 Func
	var_559_bool = var_557_bool == 0; // 0x4d4 Not
	if(var_559_bool == 0) goto Label_1239; // 0x4d5 JumpB
...
Label_1254:
	var_552_bool = 0; // 0x4e6 MovB
	return 4; // 0x4e7 Return
	
Label_1239:
	var_560_bool = 0; // 0x4d7 PushV
	func_1327(var_560_bool); // 0x4d8 NEW_2
	if(var_560_bool == 0) goto Label_1245; // 0x4da JumpB
	var_552_bool = 1; // 0x4db MovB
...
Label_1249:
	...
	func_1431(var_557_bool); // 0x4e4 NEW_2
}
...
{
	var_59_bool = 0; var_60_bool = 0; // 0xad0 PushV
	IsPlayerActor(var_58_object, var_60_bool); // 0xad1 Func
	var_57_bool = var_60_bool; // 0xad3 Mov
...
{
	var_21_bool = 0; var_22_object = Obj(); var_23_object = Obj(); var_24_float = 0; var_25_bool = 0; // 0xad6 PushV
	var_22_object = var_18_object; // 0xad7 Mov
	var_23_object = var_19_object; // 0xad8 Mov
	var_24_float = 700.0; // 0xad9 MovF
	var_25_bool = var_20_bool; // 0xada Mov
	func_2695(var_21_bool, var_22_object, var_23_object, var_24_float, var_25_bool); // 0xadb NEW_2
	var_17_bool = var_21_bool; // 0xadc Mov
...
{
	var_96_bool = 0; var_97_object = Obj(); // 0xae0 PushV
	var_97_object = var_95_object; // 0xae1 Mov
	func_1743(var_96_bool, var_97_object); // 0xae2 NEW_2
	if(var_96_bool == 0) goto Label_2796; // 0xae4 JumpB
	var_100_object = Obj(); // 0xae5 PushV
	func_2092(var_100_object); // 0xae6 NEW_2
	var_103_float = -0.05; // 0xae8 PushF
	var_104_bool = 1; // 0xae9 PushB
	ReportReputationChange(var_95_object, var_100_object, var_103_float, var_104_bool); // 0xaea Func
	
Label_2796:
	var_105_bool = GlobalVars[0]; // 0xaec PushGE
	var_105_bool = 1; // 0xaed MovB
	GlobalVars[0] = var_105_bool; // 0xaee PopGE
	var_106_int = 50; // 0xaef PushI
	var_107_int = 40; // 0xaf0 PushI
	SetRTEnvelope(var_106_int, var_107_int); // 0xaf1 Func
...
Label_1779:
	var_525_string = "armor"; // 0x6f3 PushS
	GetProperty(var_525_string, var_478_int); // 0x6f4 ObjFunc
}
...
Label_945:
	...
	var_568_string = "all"; // 0x3b3 PushS
	var_569_string = "fjump"; // 0x3b4 PushS
	PlayAnimation(var_568_string, var_569_string); // 0x3b5 Func
	WaitForAnimEnd(); // 0x3b7 Func
	func_1431(var_149_float); // 0x3ba NEW_2
	var_570_cvector = CVector(0.0, 0.0, 0.0); // 0x3bc PushVec
	SetSpeed(var_570_cvector); // 0x3bd Func
	Stop(); // 0x3bf Func
	StopAsync(); // 0x3c1 Func
	var_571_bool = 0; // 0x3c3 PushV
	func_1388(var_149_float, var_571_bool); // 0x3c4 NEW_2
	var_572_bool = var_571_bool == 0; // 0x3c6 Not
	if(var_572_bool == 0) goto Label_991; // 0x3c7 JumpB
	var_573_bool = 0; var_574_object = Obj(); // 0x3c8 PushV
	var_574_object = var_0_bool; // 0x3c9 MovT
	func_1874(var_573_bool, var_574_object); // 0x3ca NEW_2
	var_575_bool = var_573_bool == 0; // 0x3cc Not
	if(var_575_bool == 0) goto Label_975; // 0x3cd JumpB
...
Label_975:
	...
	var_576_float = var_127_float * var_127_float; // 0x3d5 Mult
	var_577_bool = var_146_float < var_576_float; // 0x3d6 LT
	if(var_577_bool == 0) goto Label_991; // 0x3d7 JumpB
	var_578_bool = 0; var_579_float = 0; // 0x3d8 PushV
	var_579_float = var_127_float; // 0x3d9 Mov
	func_1092(var_149_float, var_578_bool, var_579_float); // 0x3da NEW_2
	var_580_bool = var_578_bool == 0; // 0x3dc Not
	if(var_580_bool == 0) goto Label_991; // 0x3dd JumpB
	goto Label_1001; // 0x3de Jump
	
Label_992:
	var_581_bool = 0; var_582_float = 0; // 0x3e0 PushV
	var_582_float = var_127_float; // 0x3e1 Mov
	func_1092(var_149_float, var_581_bool, var_582_float); // 0x3e2 NEW_2
	var_583_bool = var_581_bool == 0; // 0x3e4 Not
	if(var_583_bool == 0) goto Label_999; // 0x3e5 JumpB
...
func_2371(var_41_int, var_42_string)
{
	var_43_int = 0; var_44_int = 0; // 0x943 PushV
	GetInvItemByName(var_44_int, var_42_string); // 0x944 Func
	var_41_int = var_44_int; // 0x946 Mov
...
{
	var_14_object = Obj(); // 0x949 PushV
	var_14_object = var_13_object; // 0x94a Mov
	TaskCall(0); // 0x94b TaskCall
	func_0(var_14_object); // 0x94c NEW_2
...
{
	var_19_string = "unholster"; // 0x976 PushS
	var_20_bool = var_18_string == var_19_string; // 0x977 Eq
	if(var_20_bool == 0) goto Label_2432; // 0x978 JumpB
	var_21_bool = 0; var_22_object = Obj(); // 0x979 PushV
	var_22_object = var_17_object; // 0x97a Mov
	func_2740(var_22_object); // 0x97b NEW_2
	var_16_bool = var_21_bool; // 0x97c Mov
	return 0; // 0x97e Return
	
Label_2432:
	var_23_string = "player_shot"; // 0x980 PushS
	var_24_bool = var_18_string == var_23_string; // 0x981 Eq
	if(var_24_bool == 0) goto Label_2442; // 0x982 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x983 PushV
	var_26_object = var_17_object; // 0x984 Mov
	func_2745(var_26_object); // 0x985 NEW_2
	var_16_bool = var_25_bool; // 0x986 Mov
	return 0; // 0x988 Return
	
Label_2442:
	var_27_string = "battle"; // 0x98a PushS
	var_28_bool = var_18_string == var_27_string; // 0x98b Eq
	if(var_28_bool == 0) goto Label_2451; // 0x98c JumpB
	var_29_bool = 0; var_30_object = Obj(); // 0x98d PushV
	var_30_object = var_17_object; // 0x98e Mov
	func_2750(var_30_object); // 0x98f NEW_2
	var_16_bool = var_29_bool; // 0x990 Mov
	return 0; // 0x992 Return
	
Label_2451:
	var_16_bool = 0; // 0x993 MovB
...
Label_408:
	...
	func_2573(var_55_int, var_56_object); // 0x19a NEW_2
...
Label_422:
	...
	func_2583(var_66_object); // 0x1a8 NEW_2
	var_2_bool = 1; // 0x1aa TMovB
	var_534_int = 110; // 0x1ab PushI
	var_535_float = 10.0; // 0x1ac PushF
	SetTimer(var_534_int, var_535_float); // 0x1ad Func
...
{
	var_33_string = "unholster"; // 0x996 PushS
	var_34_bool = var_32_string == var_33_string; // 0x997 Eq
	if(var_34_bool == 0) goto Label_2462; // 0x998 JumpB
	var_35_object = Obj(); // 0x999 PushV
	var_35_object = var_31_object; // 0x99a Mov
	func_2743(); // 0x99b NEW_2
	goto Label_2477; // 0x99d Jump
	
Label_2477:
	return 0; // 0x9ad Return
	
Label_2462:
	var_36_string = "player_shot"; // 0x99e PushS
	var_37_bool = var_32_string == var_36_string; // 0x99f Eq
	if(var_37_bool == 0) goto Label_2470; // 0x9a0 JumpB
	var_38_object = Obj(); // 0x9a1 PushV
	var_38_object = var_31_object; // 0x9a2 Mov
	func_2748(); // 0x9a3 NEW_2
	goto Label_2477; // 0x9a5 Jump
	
Label_2470:
	var_39_string = "battle"; // 0x9a6 PushS
	var_40_bool = var_32_string == var_39_string; // 0x9a7 Eq
	if(var_40_bool == 0) goto Label_2477; // 0x9a8 JumpB
	var_41_object = Obj(); // 0x9a9 PushV
	var_41_object = var_31_object; // 0x9aa Mov
	func_2753(); // 0x9ab NEW_2
}
...
func_1431(var_0_bool)
{
	...
	func_2145(var_189_object); // 0x599 NEW_2
...
{
	var_15_bool = 0; var_16_bool = 0; // 0x9ae PushV
	var_17_bool = 0; // 0x9af PushV
	var_17_bool = 0; // 0x9b0 MovB
	var_18_bool = 0; var_19_object = Obj(); // 0x9b1 PushV
	var_19_object = var_14_object; // 0x9b2 Mov
	func_2740(var_19_object); // 0x9b3 NEW_2
	if(var_18_bool == 0) goto Label_2492; // 0x9b5 JumpB
	var_20_bool = 0; var_21_object = Obj(); // 0x9b6 PushV
	var_21_object = var_14_object; // 0x9b7 Mov
	func_1743(var_20_bool, var_21_object); // 0x9b8 NEW_2
	if(var_20_bool == 0) goto Label_2492; // 0x9ba JumpB
	var_17_bool = 1; // 0x9bb MovB
	
Label_2492:
	if(var_17_bool == 0) goto Label_2499; // 0x9bc JumpB
	IsWeaponHolstered(var_16_bool); // 0x9bd ObjFunc
	var_24_bool = var_16_bool == 0; // 0x9bf Not
	if(var_24_bool == 0) goto Label_2499; // 0x9c0 JumpB
	var_13_bool = 1; // 0x9c1 MovB
	return 2; // 0x9c2 Return
	
Label_2499:
	var_13_bool = 0; // 0x9c3 MovB
	return 2; // 0x9c4 Return
}
...
func_1458(var_2_bool, var_196_bool, var_197_object, var_198_float, var_199_float, var_200_bool, var_201_bool)
{
	...
	func_2145(var_209_object); // 0x5b5 NEW_2
...
{
	var_26_object = Obj(); // 0x9c6 PushV
	var_26_object = var_25_object; // 0x9c7 Mov
	func_2743(); // 0x9c8 NEW_2
...
{
	var_16_bool = 0; var_17_object = Obj(); // 0x9cc PushV
	var_17_object = var_15_object; // 0x9cd Mov
	func_1743(var_16_bool, var_17_object); // 0x9ce NEW_2
	if(var_16_bool == 0) goto Label_2519; // 0x9d0 JumpB
	var_20_object = Obj(); // 0x9d1 PushV
	func_2092(var_20_object); // 0x9d2 NEW_2
	var_23_float = -0.05; // 0x9d4 PushF
	ReportReputationChange(var_15_object, var_20_object, var_23_float); // 0x9d5 Func
...
{
	var_15_object = Obj(); var_16_object = Obj(); // 0x9d8 PushV
	var_17_string = "heal"; // 0x9d9 PushS
	var_18_bool = var_14_string == var_17_string; // 0x9da Eq
	if(var_18_bool == 0) goto Label_2534; // 0x9db JumpB
	var_19_string = "player"; // 0x9dc PushS
	FindActor(var_16_object, var_19_string); // 0x9dd Func
	var_20_bool = 0; var_21_object = Obj(); // 0x9df PushV
	var_21_object = var_16_object; // 0x9e0 Mov
	func_2755(var_21_object); // 0x9e1 NEW_2
	var_13_bool = var_20_bool; // 0x9e2 Mov
	return 2; // 0x9e4 Return
	
Label_2534:
	var_13_bool = 0; // 0x9e6 MovB
...
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x9e8 PushV
	var_25_string = "heal"; // 0x9e9 PushS
	var_26_bool = var_22_string == var_25_string; // 0x9ea Eq
	if(var_26_bool == 0) goto Label_2548; // 0x9eb JumpB
	var_27_string = "player"; // 0x9ec PushS
	FindActor(var_24_object, var_27_string); // 0x9ed Func
	var_28_object = Obj(); // 0x9ef PushV
	var_28_object = var_24_object; // 0x9f0 Mov
	func_2758(); // 0x9f1 NEW_2
	var_24_object = 0; // 0x9f3 SetNull
...
{
	var_183_string = ""; var_184_string = ""; // 0x9f5 PushV
	var_184_string = "idle"; // 0x9f6 MovS
	var_185_int = var_182_int; // 0x9f7 Push
	if(var_185_int == 0) goto Label_2554; // 0x9f8 JumpB
	var_184_string = var_184_string + var_182_int; // 0x9f9 Add2
	
Label_2554:
	var_181_string = var_184_string; // 0x9fa Mov
...
{
	var_176_int = 0; var_177_bool = 0; var_178_int = 0; var_179_bool = 0; // 0x9fc PushV
	var_178_int = 0; // 0x9fd MovI
	
Label_2558:
	var_180_string = "all"; // 0x9fe PushS
	var_181_string = ""; var_182_int = 0; // 0x9ff PushV
	var_182_int = var_178_int; // 0xa00 Mov
	func_2549(var_181_string, var_182_int); // 0xa01 NEW_2
	HasAnimation(var_179_bool, var_180_string, var_181_string); // 0xa03 Func
	var_186_bool = var_179_bool == 0; // 0xa05 Not
	if(var_186_bool == 0) goto Label_2568; // 0xa06 JumpB
	goto Label_2571; // 0xa07 Jump
	
Label_2571:
	var_175_int = var_178_int; // 0xa0b Mov
	return 4; // 0xa0c Return
	
Label_2568:
	var_187_int = 1; // 0xa08 PushI
	var_178_int = var_178_int + var_187_int; // 0xa09 Add2
	goto Label_2558; // 0xa0a Jump
}
