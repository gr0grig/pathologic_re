...
0xc35: Push(Stack[-1])
0xc36: IF (Stack[-1] == 0) GOTO 0xc3f; Pop(1)

0xc37: PushEmpty(float, object)
0xc38: Stack[-1] = Stack[-5]
0xc39: Call2 0x7da
...
0xc65: Stack[-4] = Stack[-8]
0xc66: Stack[-3] = Stack[-7]
0xc67: Stack[-2] = (float) 700.0
0xc68: Stack[-1] = Stack[-6]
0xc69: Call2 0xbfb

0xc6a: Stack[-9] = Stack[-5]
0xc6b: Pop(5)
0xc6c: Return(); Pop(0)

0xc6d: PushEmpty()
0xc6e: PushEmpty(bool, object)
0xc6f: Stack[-1] = Stack[-3]
0xc70: Call2 0x7e2
