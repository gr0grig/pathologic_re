...
0xa8f: Stack[-3] = Stack[-7]
0xa90: Stack[-2] = Stack[-6]
...
0xa97: Stack[-5] = Stack[-11]
0xa98: Stack[-4] = Stack[-10]
0xa99: Stack[-3] = Stack[-9]
...
0xae7: @@ IsWeaponHolstered(Stack[-1])
0xae8: Pop(0)
...
0xb0a: Stack[-1] = Stack[-3]
0xb0b: Call2 0xc04

0xb0c: Stack[-6] = Stack[-2]
0xb0d: Pop(2)
0xb0e: Return(); Pop(2)
...
0xb66: Pop(1)
0xb67: Push("class")
0xb68: @@ GetProperty(Stack[-1], Stack[-2])
0xb69: Pop(1)
...
0xba7: Stack[-1] = Stack[-4]
0xba8: Call2 0xb48

0xba9: Stack[-5] = Stack[-2]
0xbaa: Pop(2)
0xbab: Return(); Pop(0)

0xbac: PushEmpty()
0xbad: PushEmpty(object)
0xbae: Stack[-1] = Stack[-2]
0xbaf: Call2 0xb52
...
0xbc0: Push(Stack[-2])
0xbc1: IF (Stack[-1] == 0) GOTO 0xbca; Pop(1)

0xbc2: PushEmpty(float, object)
0xbc3: Stack[-1] = Stack[-9]
0xbc4: Call2 0x8a1
...
0xbec: Push(Stack[-1])
0xbed: IF (Stack[-1] == 0) GOTO 0xbf6; Pop(1)

0xbee: PushEmpty(float, object)
0xbef: Stack[-1] = Stack[-5]
0xbf0: Call2 0x8a1
...
0xc13: Stack[-4] = Stack[-8]
0xc14: Stack[-3] = Stack[-7]
0xc15: Stack[-2] = (float) 500.0
0xc16: Stack[-1] = Stack[-6]
0xc17: Call2 0xbb2

0xc18: Stack[-9] = Stack[-5]
0xc19: Pop(5)
0xc1a: Return(); Pop(0)
