...
0x9c2: Push("GenerateMoney: iMin > iMax")
0x9c3: @ Trace(Stack[-1])
0x9c4: Pop(1)
0x9c5: Return(); Pop(4)
...
0x9e0: Pop(0)
0x9e1: @@ SetItemName(Stack[-7])
0x9e2: Pop(0)
0x9e3: Push("Organ")
0x9e4: Push((int) 1)
0x9e5: @@ SetProperty(Stack[-2], Stack[-1])
0x9e6: Pop(2)
0x9e7: @@ GetItemID(Stack[-2])
0x9e8: Pop(0)
0x9e9: Push((int) 0)
0x9ea: Push((int) 1)
...
0xad8: Stack[-3] = Stack[-7]
0xad9: Stack[-2] = Stack[-6]
...
0xae0: Stack[-5] = Stack[-11]
0xae1: Stack[-4] = Stack[-10]
0xae2: Stack[-3] = Stack[-9]
0xae3: Stack[-2] = Stack[-7]
0xae4: Stack[-1] = Stack[-6]
0xae5: Call2 0x8ed
...
0xaef: Stack[-5] = Stack[-2]
0xaf0: Pop(2)
0xaf1: Return(); Pop(0)

0xaf2: GOTO 0xb06

0xaf3: Push("player_shot")
...
0xb30: @@ IsWeaponHolstered(Stack[-1])
0xb31: Pop(0)
...
0xb53: Stack[-1] = Stack[-3]
0xb54: Call2 0xc74

0xb55: Stack[-6] = Stack[-2]
0xb56: Pop(2)
0xb57: Return(); Pop(2)
...
0xbaf: Pop(1)
0xbb0: Push("class")
0xbb1: @@ GetProperty(Stack[-1], Stack[-2])
0xbb2: Pop(1)
...
0xbf0: Stack[-1] = Stack[-4]
0xbf1: Call2 0xb91

0xbf2: Stack[-5] = Stack[-2]
0xbf3: Pop(2)
0xbf4: Return(); Pop(0)
...
0xc5e: Push(Stack[-1])
0xc5f: IF (Stack[-1] == 0) GOTO 0xc68; Pop(1)

0xc60: PushEmpty(float, object)
0xc61: Stack[-1] = Stack[-5]
0xc62: Call2 0x7da
...
0xc91: Stack[-4] = Stack[-8]
0xc92: Stack[-3] = Stack[-7]
0xc93: Stack[-2] = (float) 700.0
0xc94: Stack[-1] = Stack[-6]
0xc95: Call2 0xbfb

0xc96: Stack[-9] = Stack[-5]
0xc97: Pop(5)
0xc98: Return(); Pop(0)

0xc99: PushEmpty()
0xc9a: PushEmpty(bool, object)
0xc9b: Stack[-1] = Stack[-3]
0xc9c: Call2 0x7e2
