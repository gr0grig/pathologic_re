task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2268(); // 0x9e NEW_2
	var_20_int = 19232; // 0xa0 PushI
...
Label_183:
	...
	func_2884(var_46_bool); // 0xb9 NEW_2
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2847(var_20_object); // 0xd6 NEW_2
	...
	func_2850(var_23_object); // 0xde NEW_2
...
task_3_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2847(var_20_object); // 0x163 NEW_2
...
Label_367:
	...
	func_2850(var_25_object); // 0x171 NEW_2
...
task_3_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2748(var_19_object); // 0x177 NEW_2
	var_28_int = 0; var_29_object = Obj(); // 0x179 PushV
	var_29_object = var_16_bool; // 0x17a Mov
	func_2814(var_28_int, var_29_object); // 0x17b NEW_2
...
Label_391:
	...
	func_2824(var_68_object); // 0x189 NEW_2
...
task_3_event_30(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_object, var_7_bool, var_8_bool, var_9_bool, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2899(var_24_bool); // 0x191 NEW_2
	...
	func_2832(var_27_bool); // 0x197 NEW_2
...
task_3_event_40(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2837(var_20_object); // 0x1ab NEW_2
...
task_3_event_42(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_string, var_7_bool, var_8_bool, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2662(var_20_bool, var_21_object, var_22_string); // 0x1c0 NEW_2
	...
	func_2694(var_35_object, var_36_string); // 0x1c9 NEW_2
...
Label_460:
	...
	func_2842(var_48_object); // 0x1cf NEW_2
...
task_3_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_string, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2761(var_17_bool, var_18_string); // 0x1e4 NEW_2
	...
	func_2777(var_26_string); // 0x1ec NEW_2
...
task_3_event_1(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2719(var_17_bool, var_18_object); // 0x1f9 NEW_2
	...
	func_2742(var_29_object); // 0x201 NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2847(var_20_object); // 0x274 NEW_2
...
Label_640:
	...
	func_2850(var_25_object); // 0x282 NEW_2
...
task_4_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2748(var_19_object); // 0x288 NEW_2
	var_28_int = 0; var_29_object = Obj(); // 0x28a PushV
	var_29_object = var_16_bool; // 0x28b Mov
	func_2814(var_28_int, var_29_object); // 0x28c NEW_2
...
Label_664:
	...
	func_2824(var_68_object); // 0x29a NEW_2
...
task_4_event_30(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_bool, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2899(var_24_bool); // 0x2a2 NEW_2
	...
	func_2832(var_27_bool); // 0x2a8 NEW_2
...
task_4_event_40(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2837(var_20_object); // 0x2bc NEW_2
...
task_4_event_42(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_string, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2662(var_20_bool, var_21_object, var_22_string); // 0x2d1 NEW_2
	...
	func_2694(var_35_object, var_36_string); // 0x2da NEW_2
...
Label_733:
	...
	func_2842(var_48_object); // 0x2e0 NEW_2
...
task_4_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_string, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2761(var_17_bool, var_18_string); // 0x2f5 NEW_2
	...
	func_2777(var_26_string); // 0x2fd NEW_2
...
task_4_event_1(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2719(var_17_bool, var_18_object); // 0x303 NEW_2
	...
	func_2742(var_29_object); // 0x30b NEW_2
...
task_6_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_int)
{
	...
	func_2369(var_19_object); // 0x656 NEW_2
...
Label_1651:
	...
	func_2257(var_20_object); // 0x677 NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0xa41 PushV
	var_20_string = "health"; // 0xa42 PushS
	var_21_bool = var_17_string == var_20_string; // 0xa43 Eq
	if(var_21_bool == 0) goto Label_2637; // 0xa44 JumpB
	var_22_string = "health"; // 0xa45 PushS
	GetProperty(var_22_string, var_19_float); // 0xa46 Func
	var_23_int = 0; // 0xa48 PushI
	var_24_bool = var_19_float <= var_23_int; // 0xa49 LE
	if(var_24_bool == 0) goto Label_2637; // 0xa4a JumpB
	SignalDeath(var_16_object); // 0xa4b Func
...
{
	var_17_object = Obj(); // 0xa4f PushV
	var_17_object = var_16_object; // 0xa50 Mov
	func_2617(var_17_object); // 0xa51 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0xa55 PushV
	var_20_object = var_16_object; // 0xa56 Mov
	var_21_int = var_17_int; // 0xa57 Mov
	var_22_float = var_18_float; // 0xa58 Mov
	func_2043(var_20_object, var_21_int, var_22_float); // 0xa59 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0xa5d PushV
	var_22_object = var_16_object; // 0xa5e Mov
	var_23_int = var_17_int; // 0xa5f Mov
	var_24_float = var_18_float; // 0xa60 Mov
	var_25_cvector = var_20_cvector; // 0xa61 Mov
	var_26_cvector = var_21_cvector; // 0xa62 Mov
	func_2111(var_24_float, var_25_cvector, var_26_cvector); // 0xa63 NEW_2
...
func_0(var_0_object, var_27_int, var_28_object)
{
	...
	var_84_bool = var_38_bool == 0; // 0x7 Not
...
Label_45:
	...
	var_98_object = var_28_object; // 0x30 Mov
	var_99_object = var_34_object; // 0x31 Mov
...
Label_56:
	var_147_bool = var_37_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_148_object = var_28_object; // 0x40 Mov
...
Label_525:
	...
	func_2797(var_181_int); // 0x20e NEW_2
...
Label_540:
	...
	func_2790(var_203_string, var_204_int); // 0x22a NEW_2
...
func_1540(var_0_object)
{
	...
	func_2369(var_138_object); // 0x606 NEW_2
...
func_1547()
{
	...
	func_2275(var_269_string); // 0x60d NEW_2
...
func_1567(var_2_object, var_145_bool, var_146_object, var_147_float, var_148_float, var_149_bool, var_150_bool)
{
	...
	func_2369(var_158_object); // 0x622 NEW_2
	...
	func_2257(var_162_object); // 0x62f NEW_2
...
Label_1587:
	...
	func_2316(var_171_object); // 0x639 NEW_2
...
func_2612(var_44_int, var_45_string)
{
	var_46_int = 0; var_47_int = 0; // 0xa34 PushV
	GetInvItemByName(var_47_int, var_45_string); // 0xa35 Func
	var_44_int = var_47_int; // 0xa37 Mov
	return 2; // 0xa38 Return
}


func_2617(var_17_object)
{
	var_18_object = Obj(); // 0xa3a PushV
	var_18_object = var_17_object; // 0xa3b Mov
	TaskCall(2); // 0xa3c TaskCall
	func_196(var_18_object); // 0xa3d NEW_2
	TaskReturn(); // 0xa3e TaskReturn
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_98_object, var_99_object)
{
	...
	if(var_104_int == 0) goto Label_102; // 0x4f JumpB
	var_105_string = ""; // 0x50 PushV
	var_105_string = "Neutral"; // 0x51 MovS
	func_132(var_99_object, var_105_string); // 0x52 NEW_2
	var_122_int = 518113; // 0x54 PushI
	SetMessage(var_122_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_123_int = 518114; // 0x59 PushI
	var_124_int = -1; // 0x5a PushI
	var_125_int = 19233; // 0x5b PushI
	AddReply(var_123_int, var_124_int, var_125_int); // 0x5c TObjFunc
	var_126_int = 534586; // 0x5e PushI
	var_127_int = -1; // 0x5f PushI
	var_128_int = 36224; // 0x60 PushI
	AddReply(var_126_int, var_127_int, var_128_int); // 0x61 TObjFunc
	goto Label_102; // 0x63 Jump
	
Label_102:
	var_129_bool = 0; // 0x66 PushV
	func_2884(var_129_bool); // 0x67 NEW_2
	if(var_129_bool == 0) goto Label_117; // 0x69 JumpB
	
Label_106:
	lshWaitForAnimEnd(); // 0x6a Func
	var_130_string = var_3_string; // 0x6c PushT
	if(var_130_string == 0) goto Label_111; // 0x6d JumpB
...
Label_111:
	var_131_string = ""; // 0x6f PushV
	var_131_string = var_2_object; // 0x70 MovT
	func_2226(var_131_string); // 0x71 NEW_2
	goto Label_106; // 0x73 Jump
	
Label_117:
	var_142_string = "all"; // 0x75 PushS
	var_143_string = "idle"; // 0x76 PushS
	PlayAnimation(var_142_string, var_143_string); // 0x77 Func
	
Label_121:
	WaitForAnimEnd(); // 0x79 Func
	var_144_string = var_3_string; // 0x7b PushT
	if(var_144_string == 0) goto Label_126; // 0x7c JumpB
	goto Label_131; // 0x7d Jump
	
Label_126:
	var_145_string = "all"; // 0x7e PushS
	var_146_string = "idle"; // 0x7f PushS
	PlayAnimation(var_145_string, var_146_string); // 0x80 Func
...
func_2141(var_38_bool, var_40_float)
{
	...
	func_2322(var_65_cvector, var_66_cvector); // 0x878 NEW_2
...
Label_2182:
	...
	CameraTransit(var_56_cvector, var_54_cvector); // 0x888 Func
	var_78_float = GetByIndex(var_55_cvector, 0); // 0x88a PushE
	var_79_float = GetByIndex(var_55_cvector, 2); // 0x88b PushE
	Rotate(var_78_float, var_79_float); // 0x88c Func
	var_80_bool = 0; // 0x88e PushV
	func_2884(var_80_bool); // 0x88f NEW_2
	if(var_80_bool == 0) goto Label_2195; // 0x891 JumpB
	goto Label_2203; // 0x892 Jump
	
Label_2203:
	CameraWaitForPlayFinish(); // 0x89b Func
	ResumeWorld(); // 0x89d Func
	var_38_bool = 1; // 0x89f MovB
	return 18; // 0x8a0 Return
	
Label_2195:
	var_81_string = "head"; // 0x893 PushS
	HasAnimationTrack(var_58_bool, var_81_string); // 0x894 Func
	var_82_bool = var_58_bool; // 0x896 Push
	if(var_82_bool == 0) goto Label_2203; // 0x897 JumpB
	var_83_string = "head"; // 0x898 PushS
	LookAsyncCamera(var_83_string); // 0x899 Func
}
...
func_2662(var_20_bool, var_21_object, var_22_string)
{
	var_23_string = "unholster"; // 0xa67 PushS
	var_24_bool = var_22_string == var_23_string; // 0xa68 Eq
	if(var_24_bool == 0) goto Label_2673; // 0xa69 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0xa6a PushV
	var_26_object = var_21_object; // 0xa6b Mov
	func_2856(var_26_object); // 0xa6c NEW_2
	var_20_bool = var_25_bool; // 0xa6d Mov
	return 0; // 0xa6f Return
	
Label_2673:
	var_27_string = "player_shot"; // 0xa71 PushS
	var_28_bool = var_22_string == var_27_string; // 0xa72 Eq
	if(var_28_bool == 0) goto Label_2683; // 0xa73 JumpB
	var_29_bool = 0; var_30_object = Obj(); // 0xa74 PushV
	var_30_object = var_21_object; // 0xa75 Mov
	func_2861(var_30_object); // 0xa76 NEW_2
	var_20_bool = var_29_bool; // 0xa77 Mov
	return 0; // 0xa79 Return
	
Label_2683:
	var_31_string = "battle"; // 0xa7b PushS
	var_32_bool = var_22_string == var_31_string; // 0xa7c Eq
	if(var_32_bool == 0) goto Label_2692; // 0xa7d JumpB
	var_33_bool = 0; var_34_object = Obj(); // 0xa7e PushV
	var_34_object = var_21_object; // 0xa7f Mov
	func_2866(var_34_object); // 0xa80 NEW_2
	var_20_bool = var_33_bool; // 0xa81 Mov
	return 0; // 0xa83 Return
	
Label_2692:
	var_20_bool = 0; // 0xa84 MovB
...
func_132(var_2_object, var_105_string)
{
	var_106_bool = 0; // 0x85 PushV
	func_2884(var_106_bool); // 0x86 NEW_2
	var_107_bool = var_106_bool == 0; // 0x88 Not
	if(var_107_bool == 0) goto Label_139; // 0x89 JumpB
	return 0; // 0x8a Return
	
Label_139:
	var_108_bool = var_105_string == var_2_object; // 0x8b Eq
	if(var_108_bool == 0) goto Label_142; // 0x8c JumpB
	return 0; // 0x8d Return
	
Label_142:
	var_109_string = ""; var_110_bool = 0; // 0x8e PushV
	var_109_string = var_105_string; // 0x8f Mov
	var_111_string = ""; // 0x90 PushS
	var_112_bool = var_105_string == var_111_string; // 0x91 Eq
	if(var_112_bool == 0) goto Label_149; // 0x92 JumpB
	var_110_bool = 0; // 0x93 MovB
	goto Label_150; // 0x94 Jump
	
Label_150:
	func_2242(var_109_string, var_110_bool); // 0x96 NEW_2
	var_2_object = var_105_string; // 0x98 TMov
	return 0; // 0x99 Return
	
Label_149:
	var_110_bool = 1; // 0x95 MovB
}


func_2694(var_35_object, var_36_string)
{
	var_37_string = "unholster"; // 0xa87 PushS
	var_38_bool = var_36_string == var_37_string; // 0xa88 Eq
	if(var_38_bool == 0) goto Label_2703; // 0xa89 JumpB
	var_39_object = Obj(); // 0xa8a PushV
	var_39_object = var_35_object; // 0xa8b Mov
	func_2859(); // 0xa8c NEW_2
	goto Label_2718; // 0xa8e Jump
	
Label_2718:
	return 0; // 0xa9e Return
	
Label_2703:
	var_40_string = "player_shot"; // 0xa8f PushS
	var_41_bool = var_36_string == var_40_string; // 0xa90 Eq
	if(var_41_bool == 0) goto Label_2711; // 0xa91 JumpB
	var_42_object = Obj(); // 0xa92 PushV
	var_42_object = var_35_object; // 0xa93 Mov
	func_2864(); // 0xa94 NEW_2
	goto Label_2718; // 0xa96 Jump
	
Label_2711:
	var_43_string = "battle"; // 0xa97 PushS
	var_44_bool = var_36_string == var_43_string; // 0xa98 Eq
	if(var_44_bool == 0) goto Label_2718; // 0xa99 JumpB
	var_45_object = Obj(); // 0xa9a PushV
	var_45_object = var_35_object; // 0xa9b Mov
	func_2869(); // 0xa9c NEW_2
}
...
func_1162(var_0_object, var_398_float, var_399_int)
{
	...
	var_473_int = 0; // 0x4a5 PushV
	func_1545(var_473_int); // 0x4a6 NEW_2
	ReportHit(var_0_object, var_473_int, var_405_float, var_404_float); // 0x4a8 Func
	var_474_object = Obj(); var_475_float = 0; // 0x4aa PushV
	var_474_object = var_403_object; // 0x4ab Mov
	var_475_float = var_405_float; // 0x4ac Mov
...
func_2719(var_17_bool, var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0xa9f PushV
	var_21_bool = 0; // 0xaa0 PushV
	var_21_bool = 0; // 0xaa1 MovB
	var_22_bool = 0; var_23_object = Obj(); // 0xaa2 PushV
	var_23_object = var_18_object; // 0xaa3 Mov
	func_2856(var_23_object); // 0xaa4 NEW_2
	if(var_22_bool == 0) goto Label_2733; // 0xaa6 JumpB
	var_24_bool = 0; var_25_object = Obj(); // 0xaa7 PushV
	var_25_object = var_18_object; // 0xaa8 Mov
	func_1844(var_24_bool, var_25_object); // 0xaa9 NEW_2
	if(var_24_bool == 0) goto Label_2733; // 0xaab JumpB
	var_21_bool = 1; // 0xaac MovB
	
Label_2733:
	if(var_21_bool == 0) goto Label_2740; // 0xaad JumpB
	IsWeaponHolstered(var_20_bool); // 0xaae ObjFunc
	var_28_bool = var_20_bool == 0; // 0xab0 Not
	if(var_28_bool == 0) goto Label_2740; // 0xab1 JumpB
	var_17_bool = 1; // 0xab2 MovB
	return 2; // 0xab3 Return
	
Label_2740:
	var_17_bool = 0; // 0xab4 MovB
...
func_2209()
{
	var_149_bool = 0; var_150_bool = 0; // 0x8a1 PushV
	CameraSwitchToNormal(); // 0x8a2 Func
	var_151_bool = 0; // 0x8a4 PushV
	func_2884(var_151_bool); // 0x8a5 NEW_2
	if(var_151_bool == 0) goto Label_2217; // 0x8a7 JumpB
...
Label_2217:
	var_152_string = "head"; // 0x8a9 PushS
	HasAnimationTrack(var_150_bool, var_152_string); // 0x8aa Func
	var_153_bool = var_150_bool; // 0x8ac Push
	if(var_153_bool == 0) goto Label_2225; // 0x8ad JumpB
	var_154_string = "head"; // 0x8ae PushS
	UnlookAsync(var_154_string); // 0x8af Func
}
...
Label_1237:
	...
	var_476_string = "all"; // 0x4da PushS
	var_477_string = "attack_middle"; // 0x4db PushS
	var_478_int = var_477_string + var_367_int; // 0x4dc Add
	HasAnimation(var_368_bool, var_476_string, var_478_int); // 0x4dd Func
	var_479_bool = var_368_bool; // 0x4df Push
	if(var_479_bool == 0) goto Label_1318; // 0x4e0 JumpB
	func_2378(); // 0x4e2 NEW_2
	var_480_string = "all"; // 0x4e4 PushS
	var_481_string = "attack_middle"; // 0x4e5 PushS
	var_482_int = var_481_string + var_367_int; // 0x4e6 Add
	PlayAnimation(var_480_string, var_482_int); // 0x4e7 Func
	WaitForAnimEnd(); // 0x4e9 Func
	func_1540(var_370_string); // 0x4ec NEW_2
	var_483_bool = 0; var_484_object = Obj(); // 0x4ee PushV
	var_484_object = var_0_object; // 0x4ef MovT
	func_1975(var_483_bool, var_484_object); // 0x4f0 NEW_2
	var_485_bool = var_483_bool == 0; // 0x4f2 Not
	if(var_485_bool == 0) goto Label_1272; // 0x4f3 JumpB
	StopAsync(); // 0x4f4 Func
	var_361_bool = 0; // 0x4f6 MovB
	return 8; // 0x4f7 Return
	
Label_1272:
	var_486_float = 0; var_487_int = 0; // 0x4f8 PushV
	var_486_float = var_362_float; // 0x4f9 Mov
	var_487_int = var_367_int; // 0x4fa Mov
	func_1162(var_370_string, var_486_float, var_487_int); // 0x4fb NEW_2
	var_369_int = 1; // 0x4fd MovI
	
Label_1278:
	var_488_string = "attack_middle"; // 0x4fe PushS
	var_489_int = var_488_string + var_367_int; // 0x4ff Add
	var_490_string = "_"; // 0x500 PushS
	var_491_int = var_489_int + var_490_string; // 0x501 Add
	var_370_string = var_491_int + var_369_int; // 0x502 Add2
	var_492_string = "all"; // 0x503 PushS
	HasAnimation(var_368_bool, var_492_string, var_370_string); // 0x504 Func
	var_493_bool = var_368_bool == 0; // 0x506 Not
	if(var_493_bool == 0) goto Label_1289; // 0x507 JumpB
	goto Label_1318; // 0x508 Jump
	
Label_1318:
	var_494_bool = 0; // 0x526 PushB
	SetAttackState(var_494_bool); // 0x527 Func
	var_495_string = "all"; // 0x529 PushS
	var_496_string = "attack_end"; // 0x52a PushS
	var_497_int = var_496_string + var_367_int; // 0x52b Add
	PlayAnimation(var_495_string, var_497_int); // 0x52c Func
	var_498_bool = 0; // 0x52e PushV
	func_1554(var_498_bool); // 0x52f NEW_2
	if(var_498_bool == 0) goto Label_1336; // 0x531 JumpB
	var_499_bool = 0; var_500_float = 0; // 0x532 PushV
	var_500_float = 0.75; // 0x533 MovF
	func_1338(var_499_bool, var_500_float); // 0x534 NEW_2
...
Label_1289:
	func_2378(); // 0x50a NEW_2
	var_508_string = "all"; // 0x50c PushS
	PlayAnimation(var_508_string, var_370_string); // 0x50d Func
	WaitForAnimEnd(); // 0x50f Func
	func_1540(var_370_string); // 0x512 NEW_2
	var_509_bool = 0; var_510_object = Obj(); // 0x514 PushV
	var_510_object = var_0_object; // 0x515 MovT
	func_1975(var_509_bool, var_510_object); // 0x516 NEW_2
	var_511_bool = var_509_bool == 0; // 0x518 Not
	if(var_511_bool == 0) goto Label_1310; // 0x519 JumpB
	StopAsync(); // 0x51a Func
	var_361_bool = 0; // 0x51c MovB
	return 8; // 0x51d Return
	
Label_1310:
	var_512_float = 0; var_513_int = 0; // 0x51e PushV
	var_512_float = var_362_float; // 0x51f Mov
	var_513_int = var_367_int; // 0x520 Mov
	func_1162(var_370_string, var_512_float, var_513_int); // 0x521 NEW_2
	var_514_int = 1; // 0x523 PushI
	var_369_int = var_369_int + var_514_int; // 0x524 Add2
	goto Label_1278; // 0x525 Jump
}


func_2226(var_131_string)
{
	var_132_bool = 0; var_133_float = 0; var_134_float = 0; var_135_bool = 0; var_136_float = 0; var_137_float = 0; // 0x8b2 PushV
	lshHasAnimation(var_135_bool, var_131_string); // 0x8b3 Func
	var_138_bool = var_135_bool; // 0x8b5 Push
	if(var_138_bool == 0) goto Label_2237; // 0x8b6 JumpB
	lshGetAnimTimes(var_131_string, var_136_float, var_137_float); // 0x8b7 Func
	var_139_bool = 0; // 0x8b9 PushB
	lshPlayAnimation(var_136_float, var_137_float, var_139_bool); // 0x8ba Func
...
Label_2237:
	var_140_string = "Can't find lsh animation : "; // 0x8bd PushS
	var_141_int = var_140_string + var_131_string; // 0x8be Add
	Trace(var_141_int); // 0x8bf Func
}


func_2742(var_29_object)
{
	var_30_object = Obj(); // 0xab7 PushV
	var_30_object = var_29_object; // 0xab8 Mov
	func_2859(); // 0xab9 NEW_2
	return 0; // 0xabb Return
}


func_2748(var_19_object)
{
	var_20_bool = 0; var_21_object = Obj(); // 0xabd PushV
	var_21_object = var_19_object; // 0xabe Mov
	func_1844(var_20_bool, var_21_object); // 0xabf NEW_2
	if(var_20_bool == 0) goto Label_2760; // 0xac1 JumpB
	var_24_object = Obj(); // 0xac2 PushV
	func_2316(var_24_object); // 0xac3 NEW_2
	var_27_float = -0.03; // 0xac5 PushF
	ReportReputationChange(var_19_object, var_24_object, var_27_float); // 0xac6 Func
...
func_2242(var_109_string, var_110_bool)
{
	var_113_bool = 0; var_114_float = 0; var_115_float = 0; var_116_bool = 0; var_117_float = 0; var_118_float = 0; // 0x8c2 PushV
	lshHasAnimation(var_116_bool, var_109_string); // 0x8c3 Func
	var_119_bool = var_116_bool; // 0x8c5 Push
	if(var_119_bool == 0) goto Label_2252; // 0x8c6 JumpB
	lshGetAnimTimes(var_109_string, var_117_float, var_118_float); // 0x8c7 Func
	lshPlayAnimation(var_117_float, var_118_float, var_110_bool); // 0x8c9 Func
...
Label_2252:
	var_120_string = "Can't find lsh animation : "; // 0x8cc PushS
	var_121_int = var_120_string + var_109_string; // 0x8cd Add
	Trace(var_121_int); // 0x8ce Func
}
...
func_2761(var_17_bool, var_18_string)
{
	var_19_object = Obj(); var_20_object = Obj(); // 0xac9 PushV
	var_21_string = "heal"; // 0xaca PushS
	var_22_bool = var_18_string == var_21_string; // 0xacb Eq
	if(var_22_bool == 0) goto Label_2775; // 0xacc JumpB
	var_23_string = "player"; // 0xacd PushS
	FindActor(var_20_object, var_23_string); // 0xace Func
	var_24_bool = 0; var_25_object = Obj(); // 0xad0 PushV
	var_25_object = var_20_object; // 0xad1 Mov
	func_2871(var_25_object); // 0xad2 NEW_2
	var_17_bool = var_24_bool; // 0xad3 Mov
	return 2; // 0xad5 Return
	
Label_2775:
	var_17_bool = 0; // 0xad7 MovB
	return 2; // 0xad8 Return
}


func_2257(var_20_object)
{
	var_21_float = 0; var_22_cvector = CVector(0,0,0); var_23_float = 0; var_24_cvector = CVector(0,0,0); // 0x8d1 PushV
	GetEyesHeight(var_23_float); // 0x8d2 ObjFunc
	var_24_cvector = CVector(0.0, 0.0, 0.0); // 0x8d4 MovV
	var_25_float = GetByIndex(var_24_cvector, 1); // 0x8d5 PushE
	var_25_float = var_23_float; // 0x8d6 Mov
	SetByIndex(var_24_cvector, 1) = var_25_float; // 0x8d7 PopE
	var_26_string = "head"; // 0x8d8 PushS
	LookAsync(var_20_object, var_26_string, var_24_cvector); // 0x8d9 Func
	return 4; // 0x8db Return
}


func_2777(var_26_string)
{
	var_27_object = Obj(); var_28_object = Obj(); // 0xad9 PushV
	var_29_string = "heal"; // 0xada PushS
	var_30_bool = var_26_string == var_29_string; // 0xadb Eq
	if(var_30_bool == 0) goto Label_2789; // 0xadc JumpB
	var_31_string = "player"; // 0xadd PushS
	FindActor(var_28_object, var_31_string); // 0xade Func
	var_32_object = Obj(); // 0xae0 PushV
	var_32_object = var_28_object; // 0xae1 Mov
	func_2874(); // 0xae2 NEW_2
	var_28_object = 0; // 0xae4 SetNull
...
func_2268()
{
	var_19_bool = 0; // 0x8dc PushV
	func_2884(var_19_bool); // 0x8dd NEW_2
	if(var_19_bool == 0) goto Label_2274; // 0x8df JumpB
...
func_2275(var_42_string)
{
	var_43_bool = 0; var_44_int = 0; var_45_bool = 0; var_46_int = 0; var_47_bool = 0; var_48_float = 0; var_49_cvector = CVector(0,0,0); var_50_cvector = CVector(0,0,0); var_51_bool = 0; var_52_int = 0; var_53_bool = 0; var_54_int = 0; var_55_bool = 0; var_56_float = 0; var_57_cvector = CVector(0,0,0); var_58_cvector = CVector(0,0,0); // 0x8e3 PushV
	IsExisting3DSound(var_51_bool, var_42_string); // 0x8e4 Func
	var_59_bool = var_51_bool == 0; // 0x8e6 Not
	if(var_59_bool == 0) goto Label_2300; // 0x8e7 JumpB
	var_52_int = 0; // 0x8e8 MovI
	
Label_2281:
	var_60_int = 1; // 0x8e9 PushI
	var_61_int = var_52_int + var_60_int; // 0x8ea Add
	var_62_int = var_42_string + var_61_int; // 0x8eb Add
	IsExisting3DSound(var_53_bool, var_62_int); // 0x8ec Func
	var_63_bool = var_53_bool == 0; // 0x8ee Not
	if(var_63_bool == 0) goto Label_2289; // 0x8ef JumpB
	goto Label_2292; // 0x8f0 Jump
	
Label_2292:
	var_64_bool = var_52_int == 0; // 0x8f4 Not
	if(var_64_bool == 0) goto Label_2295; // 0x8f5 JumpB
	return 16; // 0x8f6 Return
	
Label_2295:
	irand(var_54_int, var_52_int); // 0x8f7 Func
	var_65_int = 1; // 0x8f9 PushI
	var_66_int = var_54_int + var_65_int; // 0x8fa Add
	var_42_string = var_42_string + var_66_int; // 0x8fb Add2
	
Label_2300:
	Is3DSoundLoaded(var_55_bool, var_42_string); // 0x8fc Func
	var_67_bool = var_55_bool; // 0x8fe Push
	if(var_67_bool == 0) goto Label_2315; // 0x8ff JumpB
	GetEyesHeight(var_56_float); // 0x900 Func
	GetDirection(var_57_cvector); // 0x902 Func
	var_68_int = 50; // 0x904 PushI
	var_58_cvector = var_57_cvector * var_68_int; // 0x905 Mult2
	var_69_float = GetByIndex(var_58_cvector, 1); // 0x906 PushE
	var_69_float = var_69_float + var_56_float; // 0x907 Add2
	SetByIndex(var_58_cvector, 1) = var_69_float; // 0x908 PopE
	PlayGlobalSound(var_42_string, var_58_cvector); // 0x909 Func
	
Label_2315:
	return 16; // 0x90b Return
	
Label_2289:
	var_70_int = 1; // 0x8f1 PushI
	var_52_int = var_52_int + var_70_int; // 0x8f2 Add2
...
Label_297:
	...
	func_2275(var_94_string); // 0x12b NEW_2
...
func_2790(var_187_string, var_188_int)
{
	var_189_string = ""; var_190_string = ""; // 0xae6 PushV
	var_190_string = "idle"; // 0xae7 MovS
	var_191_int = var_188_int; // 0xae8 Push
	if(var_191_int == 0) goto Label_2795; // 0xae9 JumpB
	var_190_string = var_190_string + var_188_int; // 0xaea Add2
	
Label_2795:
	var_187_string = var_190_string; // 0xaeb Mov
	return 2; // 0xaec Return
}


func_2797(var_181_int)
{
	var_182_int = 0; var_183_bool = 0; var_184_int = 0; var_185_bool = 0; // 0xaed PushV
	var_184_int = 0; // 0xaee MovI
	
Label_2799:
	var_186_string = "all"; // 0xaef PushS
	var_187_string = ""; var_188_int = 0; // 0xaf0 PushV
	var_188_int = var_184_int; // 0xaf1 Mov
	func_2790(var_187_string, var_188_int); // 0xaf2 NEW_2
	HasAnimation(var_185_bool, var_186_string, var_187_string); // 0xaf4 Func
	var_192_bool = var_185_bool == 0; // 0xaf6 Not
	if(var_192_bool == 0) goto Label_2809; // 0xaf7 JumpB
	goto Label_2812; // 0xaf8 Jump
	
Label_2812:
	var_181_int = var_184_int; // 0xafc Mov
	return 4; // 0xafd Return
	
Label_2809:
	var_193_int = 1; // 0xaf9 PushI
	var_184_int = var_184_int + var_193_int; // 0xafa Add2
	goto Label_2799; // 0xafb Jump
}
...
func_2814(var_28_int, var_29_object)
{
	var_30_bool = 0; var_31_object = Obj(); // 0xaff PushV
	var_31_object = var_29_object; // 0xb00 Mov
	func_1975(var_30_bool, var_31_object); // 0xb01 NEW_2
	if(var_30_bool == 0) goto Label_2822; // 0xb03 JumpB
	var_28_int = 2; // 0xb04 MovI
	goto Label_2823; // 0xb05 Jump
	
Label_2823:
	return 0; // 0xb07 Return
	
Label_2822:
	var_28_int = 0; // 0xb06 MovI
}
...
func_2824(var_68_object)
{
	var_69_object = Obj(); // 0xb09 PushV
	var_69_object = var_68_object; // 0xb0a Mov
	TaskCall(5); // 0xb0b TaskCall
	func_884(var_69_object); // 0xb0c NEW_2
	TaskReturn(); // 0xb0d TaskReturn
	return 0; // 0xb0f Return
}


func_2316(var_135_object)
{
	var_136_object = Obj(); var_137_object = Obj(); // 0x90c PushV
	self(var_137_object); // 0x90d Func
	var_135_object = var_137_object; // 0x90f Mov
	return 2; // 0x910 Return
}


func_2832(var_25_int)
{
	var_25_int = 0; // 0xb11 MovI
	return 0; // 0xb12 Return
}


func_2322(var_48_cvector, var_49_cvector)
{
	var_56_float = 0; var_57_float = 0; // 0x912 PushV
	var_58_int = var_49_cvector | var_49_cvector; // 0x913 Or
	var_57_float = sqrt(var_58_int); // 0x914 Sqrt2
	var_59_float = 0.0; // 0x915 PushF
	var_60_bool = var_57_float < var_59_float; // 0x916 LT
	if(var_60_bool == 0) goto Label_2330; // 0x917 JumpB
	var_48_cvector = CVector(0.0, 0.0, 0.0); // 0x918 MovV
	return 2; // 0x919 Return
	
Label_2330:
	var_48_cvector = var_49_cvector / var_49_cvector; // 0x91a Div2
...
func_2837(var_19_int)
{
	var_19_int = 0; // 0xb16 MovI
...
func_2842(var_46_int)
{
	var_46_int = 0; // 0xb1b MovI
...
func_2332(var_450_float, var_451_float, var_452_float)
{
	var_455_bool = var_451_float < var_452_float; // 0x91d LT
	if(var_455_bool == 0) goto Label_2337; // 0x91e JumpB
	var_450_float = var_451_float; // 0x91f Mov
...
Label_2337:
	var_450_float = var_452_float; // 0x921 Mov
}
...
func_2847(var_19_int)
{
	var_19_int = 2; // 0xb20 MovI
...
func_2850(var_25_object)
{
	var_26_object = Obj(); // 0xb23 PushV
	var_26_object = var_25_object; // 0xb24 Mov
	func_2891(var_26_object); // 0xb25 NEW_2
	return 0; // 0xb27 Return
}


func_2339(var_460_float, var_461_float, var_462_float, var_463_float)
{
	var_464_bool = var_461_float < var_462_float; // 0x924 LT
	if(var_464_bool == 0) goto Label_2344; // 0x925 JumpB
	var_460_float = var_462_float; // 0x926 Mov
	return 0; // 0x927 Return
	
Label_2344:
	var_465_bool = var_461_float > var_463_float; // 0x928 GT
	if(var_465_bool == 0) goto Label_2348; // 0x929 JumpB
	var_460_float = var_463_float; // 0x92a Mov
	return 0; // 0x92b Return
	
Label_2348:
	var_460_float = var_461_float; // 0x92c Mov
	return 0; // 0x92d Return
}


func_2856(var_22_bool)
{
	var_22_bool = 0; // 0xb29 MovB
...
func_2350(var_468_float)
{
	var_469_object = Obj(); var_470_object = Obj(); // 0x92e PushV
	CreateFloatVector(var_470_object); // 0x92f Func
	add(var_468_float); // 0x931 ObjFunc
	var_471_int = 15; // 0x933 PushI
	SendWorldWndMessage(var_471_int, var_470_object); // 0x934 Func
	return 2; // 0x936 Return
}


func_2861(var_29_bool)
{
	var_29_bool = 0; // 0xb2e MovB
...
func_2866(var_33_bool)
{
	var_33_bool = 0; // 0xb33 MovB
...
func_2871(var_24_bool)
{
	var_24_bool = 0; // 0xb38 MovB
	return 0; // 0xb39 Return
}


func_2360(var_26_int)
{
	var_27_float = 0; var_28_float = 0; // 0x938 PushV
	GetGameTime(var_28_float); // 0x939 Func
	var_29_int = 1; // 0x93b PushI
	var_30_int = 0; // 0x93c PushV
	var_31_int = 24; // 0x93d PushI
	var_30_int = var_28_float / var_28_float; // 0x93e Div2
	var_26_int = var_29_int + var_30_int; // 0x93f Add2
...
func_1338(var_499_bool, var_500_float)
{
	var_501_float = 0; var_502_bool = 0; var_503_float = 0; var_504_bool = 0; // 0x53a PushV
	rand(var_503_float); // 0x53b Func
	var_505_bool = var_503_float < var_500_float; // 0x53d LT
	if(var_505_bool == 0) goto Label_1358; // 0x53e JumpB
	
Label_1343:
	IsAnimationPlaying(var_504_bool); // 0x53f Func
	var_506_bool = var_504_bool == 0; // 0x541 Not
	if(var_506_bool == 0) goto Label_1348; // 0x542 JumpB
...
Label_1363:
	var_499_bool = 0; // 0x553 MovB
	return 4; // 0x554 Return
	
Label_1348:
	var_507_bool = 0; // 0x544 PushV
	func_1436(var_507_bool); // 0x545 NEW_2
	if(var_507_bool == 0) goto Label_1354; // 0x547 JumpB
	var_499_bool = 1; // 0x548 MovB
...
Label_1358:
	...
	func_1540(var_504_bool); // 0x551 NEW_2
}
...
func_2876(var_86_int)
{
	var_86_int = 515568; // 0xb3c MovI
	return 0; // 0xb3d Return
}


func_2878(var_85_int)
{
	var_85_int = 503353; // 0xb3e MovI
	return 0; // 0xb3f Return
}


func_2880(var_87_string)
{
	var_87_string = "ui/NPC_Citizen1.png"; // 0xb40 MovS
...
func_320(var_41_string)
{
	...
	func_2275(var_42_string); // 0x14d NEW_2
...
func_2882(var_88_string)
{
	var_88_string = "ui/NPC_Citizen1_b.png"; // 0xb42 MovS
	return 0; // 0xb43 Return
}


func_2369(var_19_object)
{
	var_20_bool = 0; var_21_bool = 0; // 0x941 PushV
	IsPlayerActor(var_19_object, var_21_bool); // 0x942 Func
	var_22_bool = var_21_bool; // 0x944 Push
	if(var_22_bool == 0) goto Label_2377; // 0x945 JumpB
	var_23_string = "attack"; // 0x946 PushS
	PlayGlobalMusic(var_23_string); // 0x947 Func
...
func_2884(var_80_bool)
{
	var_80_bool = 0; // 0xb44 MovB
...
Label_1900:
	...
	func_2332(var_450_float, var_451_float, var_452_float); // 0x771 NEW_2
	...
	func_2339(var_460_float, var_461_float, var_462_float, var_463_float); // 0x77f NEW_2
	...
	func_2350(var_468_float); // 0x78a NEW_2
...
Label_1880:
	var_472_string = "armor"; // 0x758 PushS
	GetProperty(var_472_string, var_425_int); // 0x759 ObjFunc
}


func_2886()
{
	var_17_bool = 0; // 0xb46 PushV
	var_17_bool = 1; // 0xb47 MovB
	func_2437(var_17_bool); // 0xb48 NEW_2
...
func_2378()
{
	var_373_object = Obj(); var_374_object = Obj(); // 0x94a PushV
	GetScene(var_374_object); // 0x94b Func
	var_375_string = "battle"; // 0x94d PushS
	var_376_object = Obj(); // 0x94e PushV
	func_2316(var_376_object); // 0x94f NEW_2
	BroadcastMessage(var_375_string, var_376_object, var_374_object); // 0x951 Func
	return 2; // 0x953 Return
}


func_2891(var_26_object)
{
	var_27_int = 0; var_28_object = Obj(); // 0xb4c PushV
	var_28_object = var_26_object; // 0xb4d Mov
	TaskCall(0); // 0xb4e TaskCall
	func_0(var_29_object, var_27_int, var_28_object); // 0xb4f NEW_2
	TaskReturn(); // 0xb50 TaskReturn
...
func_2389(var_89_int)
{
	var_90_int = 0; var_91_int = 0; // 0x955 PushV
	var_92_string = "branch"; // 0x956 PushS
	GetVariable(var_92_string, var_91_int); // 0x957 Func
	var_93_int = 0; // 0x959 PushI
	var_94_bool = var_91_int == var_93_int; // 0x95a Eq
	if(var_94_bool == 0) goto Label_2399; // 0x95b JumpB
	var_89_int = 1; // 0x95c MovI
	return 2; // 0x95d Return
	
Label_2399:
	var_95_int = 1; // 0x95f PushI
	var_96_bool = var_91_int == var_95_int; // 0x960 Eq
	if(var_96_bool == 0) goto Label_2404; // 0x961 JumpB
	var_89_int = 2; // 0x962 MovI
	return 2; // 0x963 Return
	
Label_2404:
	var_89_int = 3; // 0x964 MovI
...
func_2902()
{
	var_135_object = Obj(); // 0xb56 PushV
	func_2316(var_135_object); // 0xb57 NEW_2
	RemoveActor(var_135_object); // 0xb59 Func
	Hold(); // 0xb5b Func
	return 0; // 0xb5d Return
}
...
func_2406(var_23_int, var_24_int)
{
	var_34_int = 0; var_35_bool = 0; var_36_int = 0; var_37_bool = 0; // 0x966 PushV
	var_38_bool = var_23_int > var_24_int; // 0x967 GT
	if(var_38_bool == 0) goto Label_2413; // 0x968 JumpB
	var_39_string = "GenerateMoney: iMin > iMax"; // 0x969 PushS
	Trace(var_39_string); // 0x96a Func
	return 4; // 0x96c Return
	
Label_2413:
	var_36_int = 0; // 0x96d MovI
	var_40_bool = var_23_int != var_24_int; // 0x96e Neq
	if(var_40_bool == 0) goto Label_2420; // 0x96f JumpB
	var_41_int = var_24_int - var_23_int; // 0x970 Sub
	irand(var_36_int, var_41_int); // 0x971 Func
	goto Label_2424; // 0x973 Jump
	
Label_2424:
	var_36_int = var_36_int + var_23_int; // 0x978 Add2
	var_42_int = 0; // 0x979 PushI
	var_43_bool = var_36_int == var_42_int; // 0x97a Eq
	if(var_43_bool == 0) goto Label_2429; // 0x97b JumpB
	return 4; // 0x97c Return
	
Label_2429:
	var_44_int = 0; var_45_string = ""; // 0x97d PushV
	var_45_string = "Money"; // 0x97e MovS
	func_2612(var_44_int, var_45_string); // 0x97f NEW_2
	var_48_int = 0; // 0x981 PushI
	AddItem(var_37_bool, var_44_int, var_48_int, var_36_int); // 0x982 Func
	return 4; // 0x984 Return
	
Label_2420:
	var_49_int = 0; // 0x974 PushI
	var_50_bool = var_23_int == var_49_int; // 0x975 Eq
	if(var_50_bool == 0) goto Label_2424; // 0x976 JumpB
	return 4; // 0x977 Return
}
...
Label_917:
	...
	func_2316(var_131_object); // 0x39f NEW_2
...
Label_1054:
	...
	var_515_string = "all"; // 0x420 PushS
	var_516_string = "fjump"; // 0x421 PushS
	PlayAnimation(var_515_string, var_516_string); // 0x422 Func
	WaitForAnimEnd(); // 0x424 Func
	func_1540(var_100_float); // 0x427 NEW_2
	var_517_cvector = CVector(0.0, 0.0, 0.0); // 0x429 PushVec
	SetSpeed(var_517_cvector); // 0x42a Func
	Stop(); // 0x42c Func
	StopAsync(); // 0x42e Func
	var_518_bool = 0; // 0x430 PushV
	func_1497(var_100_float, var_518_bool); // 0x431 NEW_2
	var_519_bool = var_518_bool == 0; // 0x433 Not
	if(var_519_bool == 0) goto Label_1100; // 0x434 JumpB
	var_520_bool = 0; var_521_object = Obj(); // 0x435 PushV
	var_521_object = var_0_object; // 0x436 MovT
	func_1975(var_520_bool, var_521_object); // 0x437 NEW_2
	var_522_bool = var_520_bool == 0; // 0x439 Not
	if(var_522_bool == 0) goto Label_1084; // 0x43a JumpB
...
Label_1084:
	...
	var_523_float = var_78_float * var_78_float; // 0x442 Mult
	var_524_bool = var_97_float < var_523_float; // 0x443 LT
	if(var_524_bool == 0) goto Label_1100; // 0x444 JumpB
	var_525_bool = 0; var_526_float = 0; // 0x445 PushV
	var_526_float = var_78_float; // 0x446 Mov
	func_1201(var_100_float, var_525_bool, var_526_float); // 0x447 NEW_2
	var_527_bool = var_525_bool == 0; // 0x449 Not
	if(var_527_bool == 0) goto Label_1100; // 0x44a JumpB
	goto Label_1110; // 0x44b Jump
	
Label_1101:
	var_528_bool = 0; var_529_float = 0; // 0x44d PushV
	var_529_float = var_78_float; // 0x44e Mov
	func_1201(var_100_float, var_528_bool, var_529_float); // 0x44f NEW_2
	var_530_bool = var_528_bool == 0; // 0x451 Not
	if(var_530_bool == 0) goto Label_1108; // 0x452 JumpB
...
func_2437(var_17_bool)
{
	var_18_int = 0; var_19_bool = 0; var_20_int = 0; var_21_bool = 0; // 0x985 PushV
	var_22_bool = var_17_bool; // 0x986 Push
	if(var_22_bool == 0) goto Label_2526; // 0x987 JumpB
	var_23_int = 0; var_24_int = 0; // 0x988 PushV
	var_23_int = 0; // 0x989 MovI
	var_25_int = 100; // 0x98a PushI
	var_26_int = 0; // 0x98b PushV
	func_2360(var_26_int); // 0x98c NEW_2
	var_32_int = 100; // 0x98e PushI
	var_33_float = var_26_int * var_32_int; // 0x98f Mult
	var_24_int = var_25_int + var_33_float; // 0x990 Add2
	func_2406(var_23_int, var_24_int); // 0x991 NEW_2
	var_51_int = 8; // 0x993 PushI
	irand(var_20_int, var_51_int); // 0x994 Func
	var_52_int = 0; // 0x996 PushI
	var_53_bool = var_20_int == var_52_int; // 0x997 Eq
	if(var_53_bool == 0) goto Label_2466; // 0x998 JumpB
	var_54_int = 0; var_55_string = ""; // 0x999 PushV
	var_55_string = "lemon"; // 0x99a MovS
	func_2612(var_54_int, var_55_string); // 0x99b NEW_2
	var_56_int = 0; // 0x99d PushI
	var_57_int = 1; // 0x99e PushI
	AddItem(var_21_bool, var_54_int, var_56_int, var_57_int); // 0x99f Func
	goto Label_2525; // 0x9a1 Jump
	
Label_2525:
	goto Label_2611; // 0x9dd Jump
	
Label_2611:
	return 4; // 0xa33 Return
	
Label_2466:
	var_58_int = 1; // 0x9a2 PushI
	var_59_bool = var_20_int == var_58_int; // 0x9a3 Eq
	if(var_59_bool == 0) goto Label_2478; // 0x9a4 JumpB
	var_60_int = 0; var_61_string = ""; // 0x9a5 PushV
	var_61_string = "rusk"; // 0x9a6 MovS
	func_2612(var_60_int, var_61_string); // 0x9a7 NEW_2
	var_62_int = 0; // 0x9a9 PushI
	var_63_int = 1; // 0x9aa PushI
	AddItem(var_21_bool, var_60_int, var_62_int, var_63_int); // 0x9ab Func
	goto Label_2525; // 0x9ad Jump
	
Label_2478:
	var_64_int = 2; // 0x9ae PushI
	var_65_bool = var_20_int == var_64_int; // 0x9af Eq
	if(var_65_bool == 0) goto Label_2490; // 0x9b0 JumpB
	var_66_int = 0; var_67_string = ""; // 0x9b1 PushV
	var_67_string = "hook"; // 0x9b2 MovS
	func_2612(var_66_int, var_67_string); // 0x9b3 NEW_2
	var_68_int = 0; // 0x9b5 PushI
	var_69_int = 1; // 0x9b6 PushI
	AddItem(var_21_bool, var_66_int, var_68_int, var_69_int); // 0x9b7 Func
	goto Label_2525; // 0x9b9 Jump
	
Label_2490:
	var_70_int = 4; // 0x9ba PushI
	var_71_bool = var_20_int == var_70_int; // 0x9bb Eq
	if(var_71_bool == 0) goto Label_2502; // 0x9bc JumpB
	var_72_int = 0; var_73_string = ""; // 0x9bd PushV
	var_73_string = "syringe"; // 0x9be MovS
	func_2612(var_72_int, var_73_string); // 0x9bf NEW_2
	var_74_int = 0; // 0x9c1 PushI
	var_75_int = 1; // 0x9c2 PushI
	AddItem(var_21_bool, var_72_int, var_74_int, var_75_int); // 0x9c3 Func
	goto Label_2525; // 0x9c5 Jump
	
Label_2502:
	var_76_int = 5; // 0x9c6 PushI
	var_77_bool = var_20_int == var_76_int; // 0x9c7 Eq
	if(var_77_bool == 0) goto Label_2514; // 0x9c8 JumpB
	var_78_int = 0; var_79_string = ""; // 0x9c9 PushV
	var_79_string = "watch"; // 0x9ca MovS
	func_2612(var_78_int, var_79_string); // 0x9cb NEW_2
	var_80_int = 0; // 0x9cd PushI
	var_81_int = 1; // 0x9ce PushI
	AddItem(var_21_bool, var_78_int, var_80_int, var_81_int); // 0x9cf Func
	goto Label_2525; // 0x9d1 Jump
	
Label_2514:
	var_82_int = 6; // 0x9d2 PushI
	var_83_bool = var_20_int == var_82_int; // 0x9d3 Eq
	if(var_83_bool == 0) goto Label_2525; // 0x9d4 JumpB
	var_84_int = 0; var_85_string = ""; // 0x9d5 PushV
	var_85_string = "razor"; // 0x9d6 MovS
	func_2612(var_84_int, var_85_string); // 0x9d7 NEW_2
	var_86_int = 0; // 0x9d9 PushI
	var_87_int = 1; // 0x9da PushI
	AddItem(var_21_bool, var_84_int, var_86_int, var_87_int); // 0x9db Func
	
Label_2526:
	var_88_int = 0; var_89_int = 0; // 0x9de PushV
	var_88_int = 0; // 0x9df MovI
	var_90_int = 50; // 0x9e0 PushI
	var_91_int = 0; // 0x9e1 PushV
	func_2360(var_91_int); // 0x9e2 NEW_2
	var_92_int = 50; // 0x9e4 PushI
	var_93_float = var_91_int * var_92_int; // 0x9e5 Mult
	var_89_int = var_90_int + var_93_float; // 0x9e6 Add2
	func_2406(var_88_int, var_89_int); // 0x9e7 NEW_2
	var_94_int = 7; // 0x9e9 PushI
	irand(var_20_int, var_94_int); // 0x9ea Func
	var_95_int = 0; // 0x9ec PushI
	var_96_bool = var_20_int == var_95_int; // 0x9ed Eq
	if(var_96_bool == 0) goto Label_2552; // 0x9ee JumpB
	var_97_int = 0; var_98_string = ""; // 0x9ef PushV
	var_98_string = "beads"; // 0x9f0 MovS
	func_2612(var_97_int, var_98_string); // 0x9f1 NEW_2
	var_99_int = 0; // 0x9f3 PushI
	var_100_int = 1; // 0x9f4 PushI
	AddItem(var_21_bool, var_97_int, var_99_int, var_100_int); // 0x9f5 Func
	goto Label_2611; // 0x9f7 Jump
	
Label_2552:
	var_101_int = 1; // 0x9f8 PushI
	var_102_bool = var_20_int == var_101_int; // 0x9f9 Eq
	if(var_102_bool == 0) goto Label_2564; // 0x9fa JumpB
	var_103_int = 0; var_104_string = ""; // 0x9fb PushV
	var_104_string = "bracelet"; // 0x9fc MovS
	func_2612(var_103_int, var_104_string); // 0x9fd NEW_2
	var_105_int = 0; // 0x9ff PushI
	var_106_int = 1; // 0xa00 PushI
	AddItem(var_21_bool, var_103_int, var_105_int, var_106_int); // 0xa01 Func
	goto Label_2611; // 0xa03 Jump
	
Label_2564:
	var_107_int = 2; // 0xa04 PushI
	var_108_bool = var_20_int == var_107_int; // 0xa05 Eq
	if(var_108_bool == 0) goto Label_2576; // 0xa06 JumpB
	var_109_int = 0; var_110_string = ""; // 0xa07 PushV
	var_110_string = "ear_ring"; // 0xa08 MovS
	func_2612(var_109_int, var_110_string); // 0xa09 NEW_2
	var_111_int = 0; // 0xa0b PushI
	var_112_int = 1; // 0xa0c PushI
	AddItem(var_21_bool, var_109_int, var_111_int, var_112_int); // 0xa0d Func
	goto Label_2611; // 0xa0f Jump
	
Label_2576:
	var_113_int = 3; // 0xa10 PushI
	var_114_bool = var_20_int == var_113_int; // 0xa11 Eq
	if(var_114_bool == 0) goto Label_2588; // 0xa12 JumpB
	var_115_int = 0; var_116_string = ""; // 0xa13 PushV
	var_116_string = "gold_ring"; // 0xa14 MovS
	func_2612(var_115_int, var_116_string); // 0xa15 NEW_2
	var_117_int = 0; // 0xa17 PushI
	var_118_int = 1; // 0xa18 PushI
	AddItem(var_21_bool, var_115_int, var_117_int, var_118_int); // 0xa19 Func
	goto Label_2611; // 0xa1b Jump
	
Label_2588:
	var_119_int = 4; // 0xa1c PushI
	var_120_bool = var_20_int == var_119_int; // 0xa1d Eq
	if(var_120_bool == 0) goto Label_2600; // 0xa1e JumpB
	var_121_int = 0; var_122_string = ""; // 0xa1f PushV
	var_122_string = "silver_ring"; // 0xa20 MovS
	func_2612(var_121_int, var_122_string); // 0xa21 NEW_2
	var_123_int = 0; // 0xa23 PushI
	var_124_int = 1; // 0xa24 PushI
	AddItem(var_21_bool, var_121_int, var_123_int, var_124_int); // 0xa25 Func
	goto Label_2611; // 0xa27 Jump
	
Label_2600:
	var_125_int = 5; // 0xa28 PushI
	var_126_bool = var_20_int == var_125_int; // 0xa29 Eq
	if(var_126_bool == 0) goto Label_2611; // 0xa2a JumpB
	var_127_int = 0; var_128_string = ""; // 0xa2b PushV
	var_128_string = "flower"; // 0xa2c MovS
	func_2612(var_127_int, var_128_string); // 0xa2d NEW_2
	var_129_int = 0; // 0xa2f PushI
	var_130_int = 1; // 0xa30 PushI
	AddItem(var_21_bool, var_127_int, var_129_int, var_130_int); // 0xa31 Func
}
...
Label_2059:
	...
	func_2322(var_48_cvector, var_49_cvector); // 0x812 NEW_2
