...
0x838: PushEmpty(int, bool, int, int, bool, int)
0x839: Push((int) 0)
...
0x83e: Stack[-2] = Stack[-1]
0x83f: Pop(1)
0x840: Push(Stack[-7])
0x841: IF (Stack[-1] == 0) GOTO 0x86e; Pop(1)

0x842: PushEmpty(string, int, int, int)
0x843: Stack[-4] = "alpha_pills"
0x844: Stack[-3] = (int) 1
0x845: Stack[-2] = (int) 2
0x846: Stack[-1] = (int) 4
0x847: Call2 0x665
...
0x858: Pop(3)
0x859: Push((int) 8)
0x85a: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x85b: IF (Stack[-1] == 0) GOTO 0x864; Pop(1)

0x85c: PushEmpty(string, int, int, int)
0x85d: Stack[-4] = "monomicin"
0x85e: Stack[-3] = (int) 1
0x85f: Stack[-2] = (int) 2
0x860: Stack[-1] = (int) 2
0x861: Call2 0x665
...
0x879: Pop(3)
0x87a: PushEmpty(string, int, int)
0x87b: Stack[-3] = "revolver_ammo"
0x87c: Stack[-2] = (int) 1
0x87d: Stack[-1] = (int) 2
0x87e: Call2 0x65a

0x87f: Pop(3)
0x880: PushEmpty(string, int, int, int)
0x881: Stack[-4] = "samopal_ammo"
0x882: Stack[-3] = (int) 1
0x883: Stack[-2] = (int) 2
0x884: Stack[-1] = (int) 2
0x885: Call2 0x665
...
0x88a: PushEmpty(string, int, int, int)
0x88b: Stack[-4] = "monomicin"
0x88c: Stack[-3] = (int) 1
0x88d: Stack[-2] = (int) 2
0x88e: Stack[-1] = (int) 2
0x88f: Call2 0x665
...
0x895: PushEmpty(string, int, int)
0x896: Stack[-3] = "monomicin"
0x897: Stack[-2] = (int) 1
0x898: Stack[-1] = (int) 2
0x899: Call2 0x65a
...
0x89c: Push(GlobalVars[0])
0x89d: Stack[-1] = (bool) 0
0x89e: GlobalVars[0] = Stack[-1]; Pop(1)
0x89f: PushEmpty(bool)
0x8a0: Stack[-1] = (bool) 0
0x8a1: Call2 0x838
...
0x8a7: @ IsOverrideActive(Stack[-1])
0x8a8: Pop(0)
0x8a9: Pop(0); Push((bool) Stack[-1] == 0)
0x8aa: IF (Stack[-1] == 0) GOTO 0x8af; Pop(1)

0x8ab: PushEmpty(object)
...
0x8b2: PushEmpty(float)
0x8b3: Call2 0x81d

0x8b4: Pop(0)
0x8b5: Push((float)0.6)
0x8b6: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0x8b7: Return(); Pop(0)

0x8b8: PushEmpty()
0x8b9: PushEmpty(bool, object, object, float)
0x8ba: Stack[-3] = Stack[-7]
0x8bb: Stack[-2] = Stack[-6]
0x8bc: Stack[-1] = (float) 700.0
0x8bd: Call2 0x793

0x8be: Stack[-8] = Stack[-4]
0x8bf: Pop(4)
0x8c0: Return(); Pop(0)
