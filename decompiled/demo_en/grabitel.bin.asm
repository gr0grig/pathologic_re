...
0xaca: Stack[-3] = Stack[-9]
0xacb: Stack[-2] = Stack[-8]
0xacc: Stack[-1] = Stack[-7]
0xacd: Call2 0xa21

0xace: Stack[-6] = Stack[-4]
0xacf: Pop(4)
0xad0: Push((int) 0)
...
0xad6: Stack[-4] = Stack[-10]
0xad7: Stack[-3] = Stack[-9]
0xad8: Stack[-2] = Stack[-8]
0xad9: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0xada: Call2 0xa28

0xadb: Pop(4)
0xadc: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xadd: Push(CVector(0.0, 500.0, 0.0))
...
0xaef: Pop(1)
0xaf0: Push("class")
0xaf1: @@ GetProperty(Stack[-1], Stack[-2])
0xaf2: Pop(1)
...
0xb0d: Stack[-1] = Stack[-9]
0xb0e: Call2 0x7e1

0xb0f: Pop(1)
0xb10: IF (Stack[-1] == 0) GOTO 0xb17; Pop(1)

0xb11: Push("reputation")
0xb12: @@ GetProperty(Stack[-1], Stack[-3])
0xb13: Pop(1)
0xb14: Push((float)0.33)
0xb15: Stack[-9] = Stack[-3] >= Stack[-1]; Pop(1);
0xb16: Return(); Pop(6)

0xb17: PushEmpty(bool, object, string)
0xb18: Stack[-2] = Stack[-10]
0xb19: Stack[-1] = "class"
0xb1a: Call2 0x7e6
...
0xb96: Push(Stack[-4])
0xb97: IF (Stack[-1] == 0) GOTO 0xb9c; Pop(1)
...
0xbaa: Stack[-2] = Stack[-4]
0xbab: Stack[-1] = (float) 0.05
0xbac: Call2 0xa57
...
0xbb7: Stack[-3] = Stack[-7]
0xbb8: Stack[-2] = Stack[-6]
0xbb9: Stack[-1] = Stack[-5]
0xbba: Call2 0x912
...
0xbbf: Stack[-5] = Stack[-11]
0xbc0: Stack[-4] = Stack[-10]
0xbc1: Stack[-3] = Stack[-9]
0xbc2: Stack[-2] = Stack[-7]
...
0xbf0: Push("GenerateMoney: iMin > iMax")
0xbf1: @ Trace(Stack[-1])
0xbf2: Pop(1)
0xbf3: Return(); Pop(4)
...
0xc0e: Pop(0)
0xc0f: @@ SetItemName(Stack[-7])
0xc10: Pop(0)
0xc11: Push("Organ")
0xc12: Push((int) 1)
0xc13: @@ SetProperty(Stack[-2], Stack[-1])
0xc14: Pop(2)
0xc15: @@ GetItemID(Stack[-2])
0xc16: Pop(0)
0xc17: Push((int) 0)
0xc18: Push((int) 1)
