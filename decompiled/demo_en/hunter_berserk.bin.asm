...
Events:
EVENT_22 Op = 0x787 Vars = (object, int, float, float)
EVENT_43 Op = 0x78f Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x799 Vars = (object, string)
EVENT_41 Op = 0x7a6 Vars = (object)
...
0x6b9: @ GetGameTime(Stack[-1])
0x6ba: Pop(0)
0x6bb: Push((int) 1)
0x6bc: PushEmpty(int)
0x6bd: Push((int) 24)
0x6be: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x6bf: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x6c0: Return(); Pop(2)

0x6c1: PushEmpty(bool, bool)
0x6c2: @ IsPlayerActor(Stack[-3], Stack[-1])
0x6c3: Pop(0)
0x6c4: Push(Stack[-1])
0x6c5: IF (Stack[-1] == 0) GOTO 0x6c9; Pop(1)

0x6c6: Push("attack")
0x6c7: @ PlayGlobalMusic(Stack[-1])
0x6c8: Pop(1)
0x6c9: Return(); Pop(2)

0x6ca: PushEmpty(object, object)
0x6cb: @ GetScene(Stack[-1])
0x6cc: Pop(0)
0x6cd: Push("battle")
0x6ce: PushEmpty(object)
0x6cf: Call2 0x655

0x6d0: Pop(0)
0x6d1: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x6d2: Pop(2)
0x6d3: Return(); Pop(2)
...
0x6de: Pop(0)
0x6df: Push((int) 1)
0x6e0: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x6e1: IF (Stack[-1] == 0) GOTO 0x6e5; Pop(1)

0x6e2: @ WorkWithCorpse(Stack[-1])
0x6e3: Pop(0)
0x6e4: GOTO 0x6e7

0x6e5: @ Barter(Stack[-1])
0x6e6: Pop(0)
0x6e7: Return(); Pop(0)

0x6e8: PushEmpty(int, bool, int, bool)
0x6e9: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x6ea: IF (Stack[-1] == 0) GOTO 0x6ef; Pop(1)

0x6eb: Push("GenerateMoney: iMin > iMax")
0x6ec: @ Trace(Stack[-1])
0x6ed: Pop(1)
0x6ee: Return(); Pop(4)
...
0x6f2: Pop(0); Push(Stack[-5] - Stack[-6]);
0x6f3: @ irand(Stack[-3], Stack[-1])
0x6f4: Pop(1)
0x6f5: GOTO 0x6fa

0x6f6: Push((int) 0)
0x6f7: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6f8: IF (Stack[-1] == 0) GOTO 0x6fa; Pop(1)

0x6f9: Return(); Pop(4)

0x6fa: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x6fb: Push((int) 0)
...
0x6ff: PushEmpty(int, string)
0x700: Stack[-1] = "Money"
0x701: Call2 0x75a

0x702: Pop(1)
0x703: Push((int) 0)
0x704: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x705: Pop(2)
0x706: Return(); Pop(4)

0x707: PushEmpty(object, int, bool, object, int, bool)
0x708: @ CreateInvItem(Stack[-3])
0x709: Pop(0)
0x70a: @@ SetItemName(Stack[-7])
0x70b: Pop(0)
0x70c: Push("Organ")
0x70d: Push((int) 1)
0x70e: @@ SetProperty(Stack[-2], Stack[-1])
0x70f: Pop(2)
0x710: @@ GetItemID(Stack[-2])
0x711: Pop(0)
0x712: Push((int) 0)
0x713: Push((int) 1)
0x714: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x715: Pop(2)
0x716: Return(); Pop(6)
...
0x71a: Pop(0)
0x71b: Push((int) 1)
0x71c: Pop(2); Push((bool) Stack[-2] != Stack[-1])
...
0x730: PushEmpty(int, bool, int, bool)
0x731: Push((int) 0)
0x732: @ ClearSubContainer(Stack[-1])
0x733: Pop(1)
0x734: PushEmpty(int, int)
0x735: Stack[-2] = (int) 200
0x736: Stack[-1] = (int) 500
0x737: Call2 0x6e8

0x738: Pop(2)
0x739: PushEmpty(string, int, int)
0x73a: Stack[-3] = "revolver_ammo"
0x73b: Stack[-2] = (int) 1
0x73c: Stack[-1] = (int) 80
0x73d: Call2 0x621

0x73e: Pop(3)
0x73f: PushEmpty(string, int, int)
0x740: Stack[-3] = "samopal_ammo"
0x741: Stack[-2] = (int) 1
0x742: Stack[-1] = (int) 80
0x743: Call2 0x621

0x744: Pop(3)
0x745: PushEmpty(string, int, int)
0x746: Stack[-3] = "rifle_ammo"
0x747: Stack[-2] = (int) 1
0x748: Stack[-1] = (int) 80
0x749: Call2 0x621

0x74a: Pop(3)
0x74b: PushEmpty(string, int, int)
0x74c: Stack[-3] = "lockpick"
0x74d: Stack[-2] = (int) 1
0x74e: Stack[-1] = (int) 80
0x74f: Call2 0x621

0x750: Pop(3)
0x751: PushEmpty(int, string)
0x752: Stack[-1] = "hunter_mark"
0x753: Call2 0x75a

0x754: Pop(1)
0x755: Push((int) 0)
0x756: Push((int) 1)
0x757: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x758: Pop(3)
0x759: Return(); Pop(4)

0x75a: PushEmpty(int, int)
0x75b: @ GetInvItemByName(Stack[-1], Stack[-3])
0x75c: Pop(0)
...
0x763: Pop(1)
0x764: IF (Stack[-1] == 0) GOTO 0x780; Pop(1)
...
0x769: Pop(0)
0x76a: Push((int) 2)
0x76b: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x76c: IF (Stack[-1] == 0) GOTO 0x774; Pop(1)
...
0x775: PushEmpty(bool, object, float)
0x776: Stack[-2] = Stack[-4]
0x777: Stack[-1] = (float) 0.1
0x778: Call2 0x681

0x779: Pop(3)
0x77a: GOTO 0x780

0x77b: PushEmpty(bool, object, float)
0x77c: Stack[-2] = Stack[-4]
0x77d: Stack[-1] = (float) 0.05
0x77e: Call2 0x681

0x77f: Pop(3)
0x780: PushEmpty(object)
0x781: Stack[-1] = Stack[-2]
0x782: Push(-1, 0); TaskCall(0)
0x783: Call2 0x0

0x784: Pop(-1, 0); TaskReturn
0x785: Pop(1)
0x786: Return(); Pop(0)

0x787: PushEmpty()
0x788: PushEmpty(object, int, float)
0x789: Stack[-3] = Stack[-7]
...
0x78f: PushEmpty()
0x790: PushEmpty(object, int, float, cvector, cvector)
0x791: Stack[-5] = Stack[-11]
0x792: Stack[-4] = Stack[-10]
0x793: Stack[-3] = Stack[-9]
0x794: Stack[-2] = Stack[-7]
0x795: Stack[-1] = Stack[-6]
0x796: Call2 0x5fd
...
0x79a: Push("health")
0x79b: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x79c: IF (Stack[-1] == 0) GOTO 0x7a5; Pop(1)

0x79d: Push("health")
0x79e: @ GetProperty(Stack[-1], Stack[-2])
0x79f: Pop(1)
0x7a0: Push((int) 0)
0x7a1: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7a2: IF (Stack[-1] == 0) GOTO 0x7a5; Pop(1)

0x7a3: @ SignalDeath(Stack[-4])
0x7a4: Pop(0)
0x7a5: Return(); Pop(2)
