...
0x804: Pop(0)
0x805: @@ RemoveStationaryActor(Stack[-1])
0x806: Pop(1)
0x807: Return(); Pop(2)
...
0x810: Stack[-2] = Stack[-4]
0x811: Stack[-1] = (float) -0.1
0x812: Call2 0x789
...
0x820: Stack[-3] = Stack[-7]
0x821: Stack[-2] = Stack[-6]
...
0x828: Stack[-5] = Stack[-11]
0x829: Stack[-4] = Stack[-10]
0x82a: Stack[-3] = Stack[-9]
0x82b: Stack[-2] = Stack[-7]
0x82c: Stack[-1] = Stack[-6]
0x82d: Call2 0x70d
...
0x83c: Stack[-4] = Stack[-2]
0x83d: Pop(2)
0x83e: Return(); Pop(0)

0x83f: PushEmpty()
0x840: PushEmpty(object, bool)
0x841: Stack[-2] = Stack[-3]
