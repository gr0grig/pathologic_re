...
Label_252:
	...
	func_2114(var_76_bool); // 0xfe NEW_2
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	var_147_bool = var_18_bool; // 0x113 Push
	if(var_147_bool == 0) goto Label_283; // 0x114 JumpB
	var_148_object = Obj(); // 0x115 PushV
	var_148_object = var_16_bool; // 0x116 Mov
	TaskCall(3); // 0x117 TaskCall
	func_381(var_148_object); // 0x118 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_int)
{
	...
	func_2009(var_19_object); // 0x458 NEW_2
...
Label_1141:
	...
	func_1890(var_20_object); // 0x479 NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_2052(var_20_object); // 0x537 NEW_2
...
event_22(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_int, var_18_float, var_19_float)
{
	...
	func_1681(var_20_object, var_21_int, var_22_float); // 0x861 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0x865 PushV
	var_22_object = var_16_object; // 0x866 Mov
	var_23_int = var_17_int; // 0x867 Mov
	var_24_float = var_18_float; // 0x868 Mov
	var_25_cvector = var_20_cvector; // 0x869 Mov
	var_26_cvector = var_21_cvector; // 0x86a Mov
	func_1749(var_24_float, var_25_cvector, var_26_cvector); // 0x86b NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0x86e PushV
	var_20_string = "health"; // 0x86f PushS
	var_21_bool = var_17_string == var_20_string; // 0x870 Eq
	if(var_21_bool == 0) goto Label_2170; // 0x871 JumpB
	var_22_string = "health"; // 0x872 PushS
	GetProperty(var_22_string, var_19_float); // 0x873 Func
	var_23_int = 0; // 0x875 PushI
	var_24_bool = var_19_float <= var_23_int; // 0x876 LE
	if(var_24_bool == 0) goto Label_2170; // 0x877 JumpB
	SignalDeath(var_16_object); // 0x878 Func
...
{
	var_17_object = Obj(); // 0x87c PushV
	var_17_object = var_16_object; // 0x87d Mov
	func_2116(var_17_object); // 0x87e NEW_2
...
Label_317:
	...
	func_1965(var_28_float, var_29_cvector, var_30_cvector); // 0x145 NEW_2
...
Label_56:
	var_139_bool = var_29_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_140_object = var_20_object; // 0x40 Mov
...
{
	var_21_int = 0; // 0x805 PushV
	func_2046(var_21_int); // 0x806 NEW_2
	var_25_int = 1; // 0x808 PushI
	var_26_bool = var_21_int == var_25_int; // 0x809 Eq
	if(var_26_bool == 0) goto Label_2062; // 0x80a JumpB
	WorkWithCorpse(var_20_object); // 0x80b Func
...
Label_2062:
	Barter(var_20_object); // 0x80e Func
}
...
func_1037(var_0_object)
{
	...
	func_2009(var_123_object); // 0x40f NEW_2
	return 0; // 0x411 Return
}


func_2065(var_32_string)
{
	var_33_object = Obj(); var_34_int = 0; var_35_bool = 0; var_36_object = Obj(); var_37_int = 0; var_38_bool = 0; // 0x811 PushV
	CreateInvItem(var_36_object); // 0x812 Func
	SetItemName(var_32_string); // 0x814 ObjFunc
	var_39_string = "Organ"; // 0x816 PushS
	var_40_int = 1; // 0x817 PushI
	SetProperty(var_39_string, var_40_int); // 0x818 ObjFunc
	GetItemID(var_37_int); // 0x81a ObjFunc
	var_41_int = 0; // 0x81c PushI
	var_42_int = 1; // 0x81d PushI
	AddItem(var_38_bool, var_36_object, var_41_int, var_42_int); // 0x81e Func
...
func_1044()
{
	...
	func_1908(var_256_string); // 0x416 NEW_2
...
func_1057(var_2_object, var_130_bool, var_131_object, var_132_float, var_133_float, var_134_bool, var_135_bool)
{
	...
	func_2009(var_143_object); // 0x424 NEW_2
	...
	func_1890(var_147_object); // 0x431 NEW_2
...
Label_1077:
	...
	func_1949(var_158_object); // 0x43b NEW_2
...
func_2082()
{
	var_26_int = 0; // 0x822 PushV
	func_2046(var_26_int); // 0x823 NEW_2
	var_30_int = 1; // 0x825 PushI
	var_31_bool = var_26_int != var_30_int; // 0x826 Neq
	if(var_31_bool == 0) goto Label_2089; // 0x827 JumpB
	return 0; // 0x828 Return
	
Label_2089:
	var_32_string = ""; // 0x829 PushV
	var_32_string = "liver"; // 0x82a MovS
	func_2065(var_32_string); // 0x82b NEW_2
	var_43_string = ""; // 0x82d PushV
	var_43_string = "kidney"; // 0x82e MovS
	func_2065(var_43_string); // 0x82f NEW_2
	var_44_string = ""; // 0x831 PushV
	var_44_string = "heart"; // 0x832 MovS
	func_2065(var_44_string); // 0x833 NEW_2
	var_45_string = ""; // 0x835 PushV
	var_45_string = "blood"; // 0x836 MovS
	func_2065(var_45_string); // 0x837 NEW_2
...
func_1842()
{
	var_141_bool = 0; var_142_bool = 0; // 0x732 PushV
	CameraSwitchToNormal(); // 0x733 Func
	var_143_bool = 0; // 0x735 PushV
	func_2114(var_143_bool); // 0x736 NEW_2
	if(var_143_bool == 0) goto Label_1850; // 0x738 JumpB
...
Label_1850:
	var_144_string = "head"; // 0x73a PushS
	HasAnimationTrack(var_142_bool, var_144_string); // 0x73b Func
	var_145_bool = var_142_bool; // 0x73d Push
	if(var_145_bool == 0) goto Label_1858; // 0x73e JumpB
	var_146_string = "head"; // 0x73f PushS
	UnlookAsync(var_146_string); // 0x740 Func
}


func_2106(var_78_int)
{
	var_78_int = 515562; // 0x83a MovI
...
Label_1406:
	...
	func_1908(var_125_string); // 0x580 NEW_2
...
func_2108(var_77_int)
{
	var_77_int = 503347; // 0x83c MovI
	return 0; // 0x83d Return
}


func_2110(var_79_string)
{
	var_79_string = "ui/NPC_Citizen1.png"; // 0x83e MovS
	return 0; // 0x83f Return
}


func_2112(var_80_string)
{
	var_80_string = "ui/NPC_Citizen1_b.png"; // 0x840 MovS
	return 0; // 0x841 Return
}


func_2114(var_72_bool)
{
	var_72_bool = 0; // 0x842 MovB
	return 0; // 0x843 Return
}


func_1859(var_123_string)
{
	var_124_bool = 0; var_125_float = 0; var_126_float = 0; var_127_bool = 0; var_128_float = 0; var_129_float = 0; // 0x743 PushV
	lshHasAnimation(var_127_bool, var_123_string); // 0x744 Func
	var_130_bool = var_127_bool; // 0x746 Push
	if(var_130_bool == 0) goto Label_1870; // 0x747 JumpB
	lshGetAnimTimes(var_123_string, var_128_float, var_129_float); // 0x748 Func
	var_131_bool = 0; // 0x74a PushB
	lshPlayAnimation(var_128_float, var_129_float, var_131_bool); // 0x74b Func
...
Label_1870:
	var_132_string = "Can't find lsh animation : "; // 0x74e PushS
	var_133_int = var_132_string + var_123_string; // 0x74f Add
	Trace(var_133_int); // 0x750 Func
}


func_2116(var_17_object)
{
	var_18_object = Obj(); var_19_object = Obj(); // 0x844 PushV
	var_20_bool = 0; var_21_string = ""; var_22_string = ""; // 0x845 PushV
	var_21_string = "quest_b10_01"; // 0x846 MovS
	var_22_string = "butcher_dead"; // 0x847 MovS
	func_1997(var_20_bool, var_21_string, var_22_string); // 0x848 NEW_2
	func_2082(); // 0x84b NEW_2
	GetScene(var_19_object); // 0x84d Func
	var_46_object = Obj(); // 0x84f PushV
	func_1949(var_46_object); // 0x850 NEW_2
	RemoveStationaryActor(var_46_object); // 0x852 ObjFunc
	var_49_object = Obj(); // 0x854 PushV
	var_49_object = var_17_object; // 0x855 Mov
	TaskCall(5); // 0x856 TaskCall
	func_1313(var_49_object); // 0x857 NEW_2
	TaskReturn(); // 0x858 TaskReturn
	return 2; // 0x85a Return
}


func_835(var_486_bool, var_487_float)
{
	var_488_float = 0; var_489_bool = 0; var_490_float = 0; var_491_bool = 0; // 0x343 PushV
	rand(var_490_float); // 0x344 Func
	var_492_bool = var_490_float < var_487_float; // 0x346 LT
	if(var_492_bool == 0) goto Label_855; // 0x347 JumpB
	
Label_840:
	IsAnimationPlaying(var_491_bool); // 0x348 Func
	var_493_bool = var_491_bool == 0; // 0x34a Not
	if(var_493_bool == 0) goto Label_845; // 0x34b JumpB
...
Label_860:
	var_486_bool = 0; // 0x35c MovB
	return 4; // 0x35d Return
	
Label_845:
	var_494_bool = 0; // 0x34d PushV
	func_933(var_494_bool); // 0x34e NEW_2
	if(var_494_bool == 0) goto Label_851; // 0x350 JumpB
	var_486_bool = 1; // 0x351 MovB
...
Label_855:
	...
	func_1037(var_491_bool); // 0x35a NEW_2
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_90_object, var_91_object)
{
	...
	var_114_int = 521881; // 0x54 PushI
	SetMessage(var_114_int); // 0x55 TObjFunc
	ClearReplies(); // 0x57 TObjFunc
	var_115_int = 522417; // 0x59 PushI
	var_116_int = 23585; // 0x5a PushI
	var_117_int = 23584; // 0x5b PushI
	AddReply(var_115_int, var_116_int, var_117_int); // 0x5c TObjFunc
	var_118_int = 521882; // 0x5e PushI
	var_119_int = -1; // 0x5f PushI
	var_120_int = 23054; // 0x60 PushI
	AddReply(var_118_int, var_119_int, var_120_int); // 0x61 TObjFunc
	goto Label_102; // 0x63 Jump
	
Label_102:
	var_121_bool = 0; // 0x66 PushV
	func_2114(var_121_bool); // 0x67 NEW_2
...
Label_111:
	...
	func_1859(var_123_string); // 0x71 NEW_2
...
func_1875(var_101_string, var_102_bool)
{
	var_105_bool = 0; var_106_float = 0; var_107_float = 0; var_108_bool = 0; var_109_float = 0; var_110_float = 0; // 0x753 PushV
	lshHasAnimation(var_108_bool, var_101_string); // 0x754 Func
	var_111_bool = var_108_bool; // 0x756 Push
	if(var_111_bool == 0) goto Label_1885; // 0x757 JumpB
	lshGetAnimTimes(var_101_string, var_109_float, var_110_float); // 0x758 Func
	lshPlayAnimation(var_109_float, var_110_float, var_102_bool); // 0x75a Func
...
Label_1885:
	var_112_string = "Can't find lsh animation : "; // 0x75d PushS
	var_113_int = var_112_string + var_101_string; // 0x75e Add
	Trace(var_113_int); // 0x75f Func
}
...
func_1890(var_20_object)
{
	var_21_float = 0; var_22_cvector = CVector(0,0,0); var_23_float = 0; var_24_cvector = CVector(0,0,0); // 0x762 PushV
	GetEyesHeight(var_23_float); // 0x763 ObjFunc
	var_24_cvector = CVector(0.0, 0.0, 0.0); // 0x765 MovV
	var_25_float = GetByIndex(var_24_cvector, 1); // 0x766 PushE
	var_25_float = var_23_float; // 0x767 Mov
	SetByIndex(var_24_cvector, 1) = var_25_float; // 0x768 PopE
	var_26_string = "head"; // 0x769 PushS
	LookAsync(var_20_object, var_26_string, var_24_cvector); // 0x76a Func
...
func_1901()
{
	...
	func_2114(var_19_bool); // 0x76e NEW_2
...
func_1908(var_73_string)
{
	var_74_bool = 0; var_75_int = 0; var_76_bool = 0; var_77_int = 0; var_78_bool = 0; var_79_float = 0; var_80_cvector = CVector(0,0,0); var_81_cvector = CVector(0,0,0); var_82_bool = 0; var_83_int = 0; var_84_bool = 0; var_85_int = 0; var_86_bool = 0; var_87_float = 0; var_88_cvector = CVector(0,0,0); var_89_cvector = CVector(0,0,0); // 0x774 PushV
	IsExisting3DSound(var_82_bool, var_73_string); // 0x775 Func
	var_90_bool = var_82_bool == 0; // 0x777 Not
	if(var_90_bool == 0) goto Label_1933; // 0x778 JumpB
	var_83_int = 0; // 0x779 MovI
	
Label_1914:
	var_91_int = 1; // 0x77a PushI
	var_92_int = var_83_int + var_91_int; // 0x77b Add
	var_93_int = var_73_string + var_92_int; // 0x77c Add
	IsExisting3DSound(var_84_bool, var_93_int); // 0x77d Func
	var_94_bool = var_84_bool == 0; // 0x77f Not
	if(var_94_bool == 0) goto Label_1922; // 0x780 JumpB
	goto Label_1925; // 0x781 Jump
	
Label_1925:
	var_95_bool = var_83_int == 0; // 0x785 Not
	if(var_95_bool == 0) goto Label_1928; // 0x786 JumpB
	return 16; // 0x787 Return
	
Label_1928:
	irand(var_85_int, var_83_int); // 0x788 Func
	var_96_int = 1; // 0x78a PushI
	var_97_int = var_85_int + var_96_int; // 0x78b Add
	var_73_string = var_73_string + var_97_int; // 0x78c Add2
	
Label_1933:
	Is3DSoundLoaded(var_86_bool, var_73_string); // 0x78d Func
	var_98_bool = var_86_bool; // 0x78f Push
	if(var_98_bool == 0) goto Label_1948; // 0x790 JumpB
	GetEyesHeight(var_87_float); // 0x791 Func
	GetDirection(var_88_cvector); // 0x793 Func
	var_99_int = 50; // 0x795 PushI
	var_89_cvector = var_88_cvector * var_99_int; // 0x796 Mult2
	var_100_float = GetByIndex(var_89_cvector, 1); // 0x797 PushE
	var_100_float = var_100_float + var_87_float; // 0x798 Add2
	SetByIndex(var_89_cvector, 1) = var_100_float; // 0x799 PopE
	PlayGlobalSound(var_73_string, var_89_cvector); // 0x79a Func
	
Label_1948:
	return 16; // 0x79c Return
	
Label_1922:
	var_101_int = 1; // 0x782 PushI
	var_83_int = var_83_int + var_101_int; // 0x783 Add2
...
func_132(var_2_object, var_97_string)
{
	...
	func_2114(var_98_bool); // 0x86 NEW_2
...
Label_150:
	func_1875(var_101_string, var_102_bool); // 0x96 NEW_2
...
Label_414:
	...
	func_1949(var_82_object); // 0x1a8 NEW_2
...
Label_551:
	...
	var_502_string = "all"; // 0x229 PushS
	var_503_string = "fjump"; // 0x22a PushS
	PlayAnimation(var_502_string, var_503_string); // 0x22b Func
	WaitForAnimEnd(); // 0x22d Func
	func_1037(var_51_float); // 0x230 NEW_2
	var_504_cvector = CVector(0.0, 0.0, 0.0); // 0x232 PushVec
	SetSpeed(var_504_cvector); // 0x233 Func
	Stop(); // 0x235 Func
	StopAsync(); // 0x237 Func
	var_505_bool = 0; // 0x239 PushV
	func_994(var_51_float, var_505_bool); // 0x23a NEW_2
	var_506_bool = var_505_bool == 0; // 0x23c Not
	if(var_506_bool == 0) goto Label_597; // 0x23d JumpB
	var_507_bool = 0; var_508_object = Obj(); // 0x23e PushV
	var_508_object = var_0_object; // 0x23f MovT
	func_1613(var_507_bool, var_508_object); // 0x240 NEW_2
	var_509_bool = var_507_bool == 0; // 0x242 Not
	if(var_509_bool == 0) goto Label_581; // 0x243 JumpB
...
Label_581:
	...
	var_510_float = var_29_float * var_29_float; // 0x24b Mult
	var_511_bool = var_48_float < var_510_float; // 0x24c LT
	if(var_511_bool == 0) goto Label_597; // 0x24d JumpB
	var_512_bool = 0; var_513_float = 0; // 0x24e PushV
	var_513_float = var_29_float; // 0x24f Mov
	func_698(var_51_float, var_512_bool, var_513_float); // 0x250 NEW_2
	var_514_bool = var_512_bool == 0; // 0x252 Not
	if(var_514_bool == 0) goto Label_597; // 0x253 JumpB
	goto Label_607; // 0x254 Jump
	
Label_598:
	var_515_bool = 0; var_516_float = 0; // 0x256 PushV
	var_516_float = var_29_float; // 0x257 Mov
	func_698(var_51_float, var_515_bool, var_516_float); // 0x258 NEW_2
	var_517_bool = var_515_bool == 0; // 0x25a Not
	if(var_517_bool == 0) goto Label_605; // 0x25b JumpB
...
func_659(var_0_object, var_385_float, var_386_int)
{
	...
	var_460_int = 0; // 0x2ae PushV
	func_1042(var_460_int); // 0x2af NEW_2
	ReportHit(var_0_object, var_460_int, var_392_float, var_391_float); // 0x2b1 Func
	var_461_object = Obj(); var_462_float = 0; // 0x2b3 PushV
	var_461_object = var_390_object; // 0x2b4 Mov
	var_462_float = var_392_float; // 0x2b5 Mov
...
func_1429(var_72_string)
{
	...
	func_1908(var_73_string); // 0x5a2 NEW_2
...
func_1949(var_46_object)
{
	var_47_object = Obj(); var_48_object = Obj(); // 0x79d PushV
	self(var_48_object); // 0x79e Func
	var_46_object = var_48_object; // 0x7a0 Mov
...
func_1965(var_28_float, var_29_cvector, var_30_cvector)
{
	var_31_cvector = CVector(0,0,0); var_32_cvector = CVector(0,0,0); // 0x7ad PushV
	var_32_cvector = var_30_cvector - var_29_cvector; // 0x7ae Sub2
	var_28_float = var_32_cvector | var_32_cvector; // 0x7af Or2
	return 2; // 0x7b0 Return
}


func_1969(var_437_float, var_438_float, var_439_float)
{
	var_442_bool = var_438_float < var_439_float; // 0x7b2 LT
	if(var_442_bool == 0) goto Label_1974; // 0x7b3 JumpB
	var_437_float = var_438_float; // 0x7b4 Mov
...
Label_1974:
	var_437_float = var_439_float; // 0x7b6 Mov
}
...
func_1976(var_447_float, var_448_float, var_449_float, var_450_float)
{
	var_451_bool = var_448_float < var_449_float; // 0x7b9 LT
	if(var_451_bool == 0) goto Label_1981; // 0x7ba JumpB
	var_447_float = var_449_float; // 0x7bb Mov
	return 0; // 0x7bc Return
	
Label_1981:
	var_452_bool = var_448_float > var_450_float; // 0x7bd GT
	if(var_452_bool == 0) goto Label_1985; // 0x7be JumpB
	var_447_float = var_450_float; // 0x7bf Mov
	return 0; // 0x7c0 Return
	
Label_1985:
	var_447_float = var_448_float; // 0x7c1 Mov
...
Label_734:
	...
	var_463_string = "all"; // 0x2e3 PushS
	var_464_string = "attack_middle"; // 0x2e4 PushS
	var_465_int = var_464_string + var_354_int; // 0x2e5 Add
	HasAnimation(var_355_bool, var_463_string, var_465_int); // 0x2e6 Func
	var_466_bool = var_355_bool; // 0x2e8 Push
	if(var_466_bool == 0) goto Label_815; // 0x2e9 JumpB
	func_2018(); // 0x2eb NEW_2
	var_467_string = "all"; // 0x2ed PushS
	var_468_string = "attack_middle"; // 0x2ee PushS
	var_469_int = var_468_string + var_354_int; // 0x2ef Add
	PlayAnimation(var_467_string, var_469_int); // 0x2f0 Func
	WaitForAnimEnd(); // 0x2f2 Func
	func_1037(var_357_string); // 0x2f5 NEW_2
	var_470_bool = 0; var_471_object = Obj(); // 0x2f7 PushV
	var_471_object = var_0_object; // 0x2f8 MovT
	func_1613(var_470_bool, var_471_object); // 0x2f9 NEW_2
	var_472_bool = var_470_bool == 0; // 0x2fb Not
	if(var_472_bool == 0) goto Label_769; // 0x2fc JumpB
	StopAsync(); // 0x2fd Func
	var_348_bool = 0; // 0x2ff MovB
	return 8; // 0x300 Return
	
Label_769:
	var_473_float = 0; var_474_int = 0; // 0x301 PushV
	var_473_float = var_349_float; // 0x302 Mov
	var_474_int = var_354_int; // 0x303 Mov
	func_659(var_357_string, var_473_float, var_474_int); // 0x304 NEW_2
	var_356_int = 1; // 0x306 MovI
	
Label_775:
	var_475_string = "attack_middle"; // 0x307 PushS
	var_476_int = var_475_string + var_354_int; // 0x308 Add
	var_477_string = "_"; // 0x309 PushS
	var_478_int = var_476_int + var_477_string; // 0x30a Add
	var_357_string = var_478_int + var_356_int; // 0x30b Add2
	var_479_string = "all"; // 0x30c PushS
	HasAnimation(var_355_bool, var_479_string, var_357_string); // 0x30d Func
	var_480_bool = var_355_bool == 0; // 0x30f Not
	if(var_480_bool == 0) goto Label_786; // 0x310 JumpB
	goto Label_815; // 0x311 Jump
	
Label_815:
	var_481_bool = 0; // 0x32f PushB
	SetAttackState(var_481_bool); // 0x330 Func
	var_482_string = "all"; // 0x332 PushS
	var_483_string = "attack_end"; // 0x333 PushS
	var_484_int = var_483_string + var_354_int; // 0x334 Add
	PlayAnimation(var_482_string, var_484_int); // 0x335 Func
	var_485_bool = 0; // 0x337 PushV
	func_1051(var_485_bool); // 0x338 NEW_2
	if(var_485_bool == 0) goto Label_833; // 0x33a JumpB
	var_486_bool = 0; var_487_float = 0; // 0x33b PushV
	var_487_float = 0.75; // 0x33c MovF
	func_835(var_486_bool, var_487_float); // 0x33d NEW_2
...
Label_786:
	func_2018(); // 0x313 NEW_2
	var_495_string = "all"; // 0x315 PushS
	PlayAnimation(var_495_string, var_357_string); // 0x316 Func
	WaitForAnimEnd(); // 0x318 Func
	func_1037(var_357_string); // 0x31b NEW_2
	var_496_bool = 0; var_497_object = Obj(); // 0x31d PushV
	var_497_object = var_0_object; // 0x31e MovT
	func_1613(var_496_bool, var_497_object); // 0x31f NEW_2
	var_498_bool = var_496_bool == 0; // 0x321 Not
	if(var_498_bool == 0) goto Label_807; // 0x322 JumpB
	StopAsync(); // 0x323 Func
	var_348_bool = 0; // 0x325 MovB
	return 8; // 0x326 Return
	
Label_807:
	var_499_float = 0; var_500_int = 0; // 0x327 PushV
	var_499_float = var_349_float; // 0x328 Mov
	var_500_int = var_354_int; // 0x329 Mov
	func_659(var_357_string, var_499_float, var_500_int); // 0x32a NEW_2
	var_501_int = 1; // 0x32c PushI
	var_356_int = var_356_int + var_501_int; // 0x32d Add2
...
func_1987(var_455_float)
{
	var_456_object = Obj(); var_457_object = Obj(); // 0x7c3 PushV
	CreateFloatVector(var_457_object); // 0x7c4 Func
	add(var_455_float); // 0x7c6 ObjFunc
	var_458_int = 15; // 0x7c8 PushI
	SendWorldWndMessage(var_458_int, var_457_object); // 0x7c9 Func
...
func_1997(var_20_bool, var_21_string, var_22_string)
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x7cd PushV
	FindActor(var_24_object, var_21_string); // 0x7ce Func
	var_25_bool = var_24_object == 0; // 0x7d0 NullEq
	if(var_25_bool == 0) goto Label_2004; // 0x7d1 JumpB
	var_20_bool = 0; // 0x7d2 MovB
	return 2; // 0x7d3 Return
	
Label_2004:
	Trigger(var_24_object, var_22_string); // 0x7d4 Func
	var_20_bool = 1; // 0x7d6 MovB
...
func_2009(var_19_object)
{
	var_20_bool = 0; var_21_bool = 0; // 0x7d9 PushV
	IsPlayerActor(var_19_object, var_21_bool); // 0x7da Func
	var_22_bool = var_21_bool; // 0x7dc Push
	if(var_22_bool == 0) goto Label_2017; // 0x7dd JumpB
	var_23_string = "attack"; // 0x7de PushS
	PlayGlobalMusic(var_23_string); // 0x7df Func
...
Label_1538:
	...
	func_1969(var_437_float, var_438_float, var_439_float); // 0x607 NEW_2
	...
	func_1976(var_447_float, var_448_float, var_449_float, var_450_float); // 0x615 NEW_2
	...
	func_1987(var_455_float); // 0x620 NEW_2
...
Label_1518:
	var_459_string = "armor"; // 0x5ee PushS
	GetProperty(var_459_string, var_412_int); // 0x5ef ObjFunc
}
...
func_2018()
{
	var_360_object = Obj(); var_361_object = Obj(); // 0x7e2 PushV
	GetScene(var_361_object); // 0x7e3 Func
	var_362_string = "battle"; // 0x7e5 PushS
	var_363_object = Obj(); // 0x7e6 PushV
	func_1949(var_363_object); // 0x7e7 NEW_2
	BroadcastMessage(var_362_string, var_363_object, var_361_object); // 0x7e9 Func
	return 2; // 0x7eb Return
}


func_2029(var_81_int)
{
	var_82_int = 0; var_83_int = 0; // 0x7ed PushV
	var_84_string = "branch"; // 0x7ee PushS
	GetVariable(var_84_string, var_83_int); // 0x7ef Func
	var_85_int = 0; // 0x7f1 PushI
	var_86_bool = var_83_int == var_85_int; // 0x7f2 Eq
	if(var_86_bool == 0) goto Label_2039; // 0x7f3 JumpB
	var_81_int = 1; // 0x7f4 MovI
	return 2; // 0x7f5 Return
	
Label_2039:
	var_87_int = 1; // 0x7f7 PushI
	var_88_bool = var_83_int == var_87_int; // 0x7f8 Eq
	if(var_88_bool == 0) goto Label_2044; // 0x7f9 JumpB
	var_81_int = 2; // 0x7fa MovI
	return 2; // 0x7fb Return
	
Label_2044:
	var_81_int = 3; // 0x7fc MovI
...
func_1774(var_30_bool, var_32_float)
{
	...
	func_1955(var_57_cvector, var_58_cvector); // 0x709 NEW_2
...
Label_1815:
	...
	CameraTransit(var_48_cvector, var_46_cvector); // 0x719 Func
	var_70_float = GetByIndex(var_47_cvector, 0); // 0x71b PushE
	var_71_float = GetByIndex(var_47_cvector, 2); // 0x71c PushE
	Rotate(var_70_float, var_71_float); // 0x71d Func
	var_72_bool = 0; // 0x71f PushV
	func_2114(var_72_bool); // 0x720 NEW_2
	if(var_72_bool == 0) goto Label_1828; // 0x722 JumpB
	goto Label_1836; // 0x723 Jump
	
Label_1836:
	CameraWaitForPlayFinish(); // 0x72c Func
	ResumeWorld(); // 0x72e Func
	var_30_bool = 1; // 0x730 MovB
	return 18; // 0x731 Return
	
Label_1828:
	var_73_string = "head"; // 0x724 PushS
	HasAnimationTrack(var_50_bool, var_73_string); // 0x725 Func
	var_74_bool = var_50_bool; // 0x727 Push
	if(var_74_bool == 0) goto Label_1836; // 0x728 JumpB
	var_75_string = "head"; // 0x729 PushS
	LookAsyncCamera(var_75_string); // 0x72a Func
}
...
func_2046(var_26_int)
{
	var_27_int = 0; var_28_int = 0; // 0x7fe PushV
	var_29_string = "branch"; // 0x7ff PushS
	GetVariable(var_29_string, var_28_int); // 0x800 Func
	var_26_int = var_28_int; // 0x802 Mov
