task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_bool)
{
	...
	func_980(var_14_object); // 0xcb NEW_2
...
Label_298:
	...
	func_1017(var_78_bool); // 0x12c NEW_2
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_string)
{
	...
	func_920(var_13_object); // 0x14d NEW_2
...
task_2_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool)
{
	...
	func_920(var_8_object); // 0x15a NEW_2
...
Label_447:
	...
	func_920(var_53_object); // 0x1c6 NEW_2
	var_52_object = var_53_object; // 0x1c7 Mov
	func_787(var_52_object); // 0x1c9 NEW_2
...
Label_502:
	...
	func_867(var_14_string); // 0x1f8 NEW_2
}
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_object)
{
	...
	var_270_string = ""; // 0x20d PushV
	var_270_string = "Neutral"; // 0x20e MovS
	func_867(var_270_string); // 0x20f NEW_2
...
Label_45:
	...
	func_920(var_99_object); // 0x31 NEW_2
	var_98_object = var_99_object; // 0x32 Mov
	func_729(var_97_bool, var_98_object); // 0x34 NEW_2
...
func_898(var_131_bool, var_132_string)
{
	var_133_bool = 0; var_134_bool = 0; // 0x382 PushV
	var_135_bool = 0; // 0x383 PushV
	func_1017(var_135_bool); // 0x384 NEW_2
	if(var_135_bool == 0) goto Label_911; // 0x386 JumpB
	lshHasSpeech(var_134_bool, var_132_string); // 0x387 Func
	var_136_bool = var_134_bool; // 0x389 Push
	if(var_136_bool == 0) goto Label_911; // 0x38a JumpB
	lshPlaySpeech(var_132_string); // 0x38b Func
	var_131_bool = 1; // 0x38d MovB
	return 2; // 0x38e Return
	
Label_911:
	var_131_bool = 0; // 0x38f MovB
...
func_644(var_37_bool, var_39_float)
{
	...
	func_926(var_64_cvector, var_65_cvector); // 0x29f NEW_2
...
Label_685:
	...
	CameraTransit(var_55_cvector, var_53_cvector); // 0x2af Func
	var_77_float = GetByIndex(var_54_cvector, 0); // 0x2b1 PushE
	var_78_float = GetByIndex(var_54_cvector, 2); // 0x2b2 PushE
	Rotate(var_77_float, var_78_float); // 0x2b3 Func
	var_79_bool = 0; // 0x2b5 PushV
	func_1017(var_79_bool); // 0x2b6 NEW_2
	if(var_79_bool == 0) goto Label_698; // 0x2b8 JumpB
	goto Label_706; // 0x2b9 Jump
	
Label_706:
	CameraWaitForPlayFinish(); // 0x2c2 Func
	ResumeWorld(); // 0x2c4 Func
	var_37_bool = 1; // 0x2c6 MovB
	return 18; // 0x2c7 Return
	
Label_698:
	var_80_string = "head"; // 0x2ba PushS
	HasAnimationTrack(var_57_bool, var_80_string); // 0x2bb Func
	var_81_bool = var_57_bool; // 0x2bd Push
	if(var_81_bool == 0) goto Label_706; // 0x2be JumpB
	var_82_string = "head"; // 0x2bf PushS
	LookAsyncCamera(var_82_string); // 0x2c0 Func
}
...
func_913()
{
	var_10_bool = 0; // 0x391 PushV
	func_1017(var_10_bool); // 0x392 NEW_2
	if(var_10_bool == 0) goto Label_919; // 0x394 JumpB
	lshStopSpeech(); // 0x395 Func
...
func_787(var_108_bool)
{
	var_110_string = ""; var_111_int = 0; var_112_bool = 0; var_113_int = 0; var_114_string = ""; var_115_string = ""; var_116_int = 0; var_117_bool = 0; var_118_int = 0; var_119_string = ""; // 0x313 PushV
	var_115_string = "c"; // 0x314 MovS
	var_116_int = 0; // 0x315 MovI
	
Label_790:
	var_120_int = 1; // 0x316 PushI
	if(var_120_int == 0) goto Label_803; // 0x317 JumpB
	var_121_int = 1; // 0x318 PushI
	var_122_int = var_116_int + var_121_int; // 0x319 Add
	var_123_int = var_115_string + var_122_int; // 0x31a Add
	HasProperty(var_123_int, var_117_bool); // 0x31b ObjFunc
	var_124_bool = var_117_bool == 0; // 0x31d Not
	if(var_124_bool == 0) goto Label_800; // 0x31e JumpB
	goto Label_803; // 0x31f Jump
	
Label_803:
	var_125_bool = var_116_int == 0; // 0x323 Not
	if(var_125_bool == 0) goto Label_807; // 0x324 JumpB
	var_108_bool = 0; // 0x325 MovB
	return 10; // 0x326 Return
	
Label_807:
	var_118_int = 0; // 0x327 MovI
	var_126_int = 1; // 0x328 PushI
	var_127_bool = var_116_int > var_126_int; // 0x329 GT
	if(var_127_bool == 0) goto Label_813; // 0x32a JumpB
	irand(var_118_int, var_116_int); // 0x32b Func
	
Label_813:
	var_128_int = 1; // 0x32d PushI
	var_129_int = var_118_int + var_128_int; // 0x32e Add
	var_130_int = var_115_string + var_129_int; // 0x32f Add
	GetProperty(var_130_int, var_119_string); // 0x330 ObjFunc
	var_131_bool = 0; var_132_string = ""; // 0x332 PushV
	var_132_string = var_119_string; // 0x333 Mov
	func_898(var_131_bool, var_132_string); // 0x334 NEW_2
	var_108_bool = var_131_bool; // 0x335 Mov
	return 10; // 0x337 Return
	
Label_800:
	var_137_int = 1; // 0x320 PushI
	var_116_int = var_116_int + var_137_int; // 0x321 Add2
...
Label_545:
	...
	func_957(var_25_int); // 0x222 NEW_2
...
Label_579:
	...
	func_950(var_52_string, var_53_int); // 0x246 NEW_2
...
func_920(var_99_object)
{
	var_100_object = Obj(); var_101_object = Obj(); // 0x398 PushV
	self(var_101_object); // 0x399 Func
	var_99_object = var_101_object; // 0x39b Mov
	return 2; // 0x39c Return
}


func_926(var_64_cvector, var_65_cvector)
{
	var_67_float = 0; var_68_float = 0; // 0x39e PushV
	var_69_int = var_65_cvector | var_65_cvector; // 0x39f Or
	var_68_float = sqrt(var_69_int); // 0x3a0 Sqrt2
	var_70_float = 0.0; // 0x3a1 PushF
	var_71_bool = var_68_float < var_70_float; // 0x3a2 LT
	if(var_71_bool == 0) goto Label_934; // 0x3a3 JumpB
	var_64_cvector = CVector(0.0, 0.0, 0.0); // 0x3a4 MovV
	return 2; // 0x3a5 Return
	
Label_934:
	var_64_cvector = var_65_cvector / var_65_cvector; // 0x3a6 Div2
...
func_416()
{
	var_272_float = 0; var_273_float = 0; // 0x1a0 PushV
	var_274_int = 8; // 0x1a1 PushI
	var_275_int = 16; // 0x1a2 PushI
	rand(var_273_float, var_274_int, var_275_int); // 0x1a3 Func
	var_276_int = 10; // 0x1a5 PushI
	SetTimer(var_276_int, var_273_float); // 0x1a6 Func
	return 2; // 0x1a8 Return
}


func_936(var_201_int, var_202_string)
{
	var_203_int = 0; var_204_int = 0; // 0x3a8 PushV
	GetVariable(var_202_string, var_204_int); // 0x3a9 Func
	var_201_int = var_204_int; // 0x3ab Mov
...
func_425()
{
	var_271_int = 10; // 0x1a9 PushI
	KillTimer(var_271_int); // 0x1aa Func
...
func_170(var_2_object, var_212_string)
{
	...
	func_1017(var_213_bool); // 0xac NEW_2
...
Label_188:
	func_883(var_216_string, var_217_bool); // 0xbc NEW_2
...
func_941(var_152_int)
{
	var_153_float = 0; var_154_float = 0; // 0x3ad PushV
	GetGameTime(var_154_float); // 0x3ae Func
	var_155_int = 1; // 0x3b0 PushI
	var_156_int = 0; // 0x3b1 PushV
	var_157_int = 24; // 0x3b2 PushI
	var_156_int = var_154_float / var_154_float; // 0x3b3 Div2
	var_152_int = var_155_int + var_156_int; // 0x3b4 Add2
	return 2; // 0x3b5 Return
}


func_950(var_31_string, var_32_int)
{
	var_33_string = ""; var_34_string = ""; // 0x3b6 PushV
	var_34_string = "idle"; // 0x3b7 MovS
	var_35_int = var_32_int; // 0x3b8 Push
	if(var_35_int == 0) goto Label_955; // 0x3b9 JumpB
	var_34_string = var_34_string + var_32_int; // 0x3ba Add2
	
Label_955:
	var_31_string = var_34_string; // 0x3bb Mov
...
func_824(var_139_bool)
{
	var_141_string = ""; var_142_int = 0; var_143_bool = 0; var_144_int = 0; var_145_string = ""; var_146_string = ""; var_147_int = 0; var_148_bool = 0; var_149_int = 0; var_150_string = ""; // 0x338 PushV
	var_151_string = "d"; // 0x339 PushS
	var_152_int = 0; // 0x33a PushV
	func_941(var_152_int); // 0x33b NEW_2
	var_158_int = var_151_string + var_152_int; // 0x33d Add
	var_159_string = "m"; // 0x33e PushS
	var_146_string = var_158_int + var_159_string; // 0x33f Add2
	var_147_int = 0; // 0x340 MovI
	
Label_833:
	var_160_int = 1; // 0x341 PushI
	if(var_160_int == 0) goto Label_846; // 0x342 JumpB
	var_161_int = 1; // 0x343 PushI
	var_162_int = var_147_int + var_161_int; // 0x344 Add
	var_163_int = var_146_string + var_162_int; // 0x345 Add
	HasProperty(var_163_int, var_148_bool); // 0x346 ObjFunc
	var_164_bool = var_148_bool == 0; // 0x348 Not
	if(var_164_bool == 0) goto Label_843; // 0x349 JumpB
	goto Label_846; // 0x34a Jump
	
Label_846:
	var_165_bool = var_147_int == 0; // 0x34e Not
	if(var_165_bool == 0) goto Label_850; // 0x34f JumpB
	var_139_bool = 0; // 0x350 MovB
	return 10; // 0x351 Return
	
Label_850:
	var_149_int = 0; // 0x352 MovI
	var_166_int = 1; // 0x353 PushI
	var_167_bool = var_147_int > var_166_int; // 0x354 GT
	if(var_167_bool == 0) goto Label_856; // 0x355 JumpB
	irand(var_149_int, var_147_int); // 0x356 Func
	
Label_856:
	var_168_int = 1; // 0x358 PushI
	var_169_int = var_149_int + var_168_int; // 0x359 Add
	var_170_int = var_146_string + var_169_int; // 0x35a Add
	GetProperty(var_170_int, var_150_string); // 0x35b ObjFunc
	var_171_bool = 0; var_172_string = ""; // 0x35d PushV
	var_172_string = var_150_string; // 0x35e Mov
	func_898(var_171_bool, var_172_string); // 0x35f NEW_2
	var_139_bool = var_171_bool; // 0x360 Mov
	return 10; // 0x362 Return
	
Label_843:
	var_173_int = 1; // 0x34b PushI
	var_147_int = var_147_int + var_173_int; // 0x34c Add2
...
func_957(var_25_int)
{
	var_26_int = 0; var_27_bool = 0; var_28_int = 0; var_29_bool = 0; // 0x3bd PushV
	var_28_int = 0; // 0x3be MovI
	
Label_959:
	var_30_string = "all"; // 0x3bf PushS
	var_31_string = ""; var_32_int = 0; // 0x3c0 PushV
	var_32_int = var_28_int; // 0x3c1 Mov
	func_950(var_31_string, var_32_int); // 0x3c2 NEW_2
	HasAnimation(var_29_bool, var_30_string, var_31_string); // 0x3c4 Func
	var_36_bool = var_29_bool == 0; // 0x3c6 Not
	if(var_36_bool == 0) goto Label_969; // 0x3c7 JumpB
	goto Label_972; // 0x3c8 Jump
	
Label_972:
	var_25_int = var_28_int; // 0x3cc Mov
	return 4; // 0x3cd Return
	
Label_969:
	var_37_int = 1; // 0x3c9 PushI
	var_28_int = var_28_int + var_37_int; // 0x3ca Add2
	goto Label_959; // 0x3cb Jump
}


func_712()
{
	var_264_bool = 0; var_265_bool = 0; // 0x2c8 PushV
	CameraSwitchToNormal(); // 0x2c9 Func
	var_266_bool = 0; // 0x2cb PushV
	func_1017(var_266_bool); // 0x2cc NEW_2
	if(var_266_bool == 0) goto Label_720; // 0x2ce JumpB
...
Label_720:
	var_267_string = "head"; // 0x2d0 PushS
	HasAnimationTrack(var_265_bool, var_267_string); // 0x2d1 Func
	var_268_bool = var_265_bool; // 0x2d3 Push
	if(var_268_bool == 0) goto Label_728; // 0x2d4 JumpB
	var_269_string = "head"; // 0x2d5 PushS
	UnlookAsync(var_269_string); // 0x2d6 Func
}


func_974()
{
	var_210_string = "b10q04PlennikTalk"; // 0x3cf PushS
	var_211_int = 1; // 0x3d0 PushI
	SetVariable(var_210_string, var_211_int); // 0x3d1 Func
...
func_81(var_0_object, var_1_object, var_2_object, var_3_string, var_192_object, var_193_object)
{
	...
	func_980(var_200_object); // 0x59 NEW_2
...
Label_149:
	...
	func_867(var_238_string); // 0x97 NEW_2
...
func_980(var_199_bool)
{
	var_201_int = 0; var_202_string = ""; // 0x3d5 PushV
	var_202_string = "b10q04PlennikTalk"; // 0x3d6 MovS
	func_936(var_201_int, var_202_string); // 0x3d7 NEW_2
	var_205_int = 0; // 0x3d9 PushI
	var_206_bool = var_201_int != var_205_int; // 0x3da Neq
	if(var_206_bool == 0) goto Label_990; // 0x3db JumpB
	var_199_bool = 1; // 0x3dc MovB
	return 0; // 0x3dd Return
	
Label_990:
	var_199_bool = 0; // 0x3de MovB
	return 0; // 0x3df Return
}


func_729(var_97_bool, var_98_object)
{
	var_102_int = 0; var_103_int = 0; var_104_int = 0; var_105_int = 0; // 0x2d9 PushV
	var_106_string = "voice_common"; // 0x2da PushS
	GetVariable(var_106_string, var_104_int); // 0x2db Func
	var_107_int = var_104_int; // 0x2dd Push
	if(var_107_int == 0) goto Label_767; // 0x2de JumpB
	var_108_bool = 0; var_109_object = Obj(); // 0x2df PushV
	var_109_object = var_98_object; // 0x2e0 Mov
	func_787(var_109_object); // 0x2e1 NEW_2
	var_138_bool = var_108_bool == 0; // 0x2e3 Not
	if(var_138_bool == 0) goto Label_749; // 0x2e4 JumpB
	var_139_bool = 0; var_140_object = Obj(); // 0x2e5 PushV
	var_140_object = var_98_object; // 0x2e6 Mov
	func_824(var_140_object); // 0x2e7 NEW_2
	var_174_bool = var_139_bool == 0; // 0x2e9 Not
	if(var_174_bool == 0) goto Label_749; // 0x2ea JumpB
	var_97_bool = 0; // 0x2eb MovB
	return 4; // 0x2ec Return
	
Label_749:
	var_175_int = 2; // 0x2ed PushI
	irand(var_105_int, var_175_int); // 0x2ee Func
	var_176_int = var_105_int; // 0x2f0 Push
	if(var_176_int == 0) goto Label_762; // 0x2f1 JumpB
	var_177_string = "voice_common"; // 0x2f2 PushS
	var_178_int = 1; // 0x2f3 PushI
	var_179_int = var_104_int + var_178_int; // 0x2f4 Add
	var_180_int = 3; // 0x2f5 PushI
	var_181_int = var_179_int / var_180_int; // 0x2f6 Mod
	SetVariable(var_177_string, var_181_int); // 0x2f7 Func
	goto Label_766; // 0x2f9 Jump
	
Label_766:
	goto Label_785; // 0x2fe Jump
	
Label_785:
	var_97_bool = 1; // 0x311 MovB
	return 4; // 0x312 Return
	
Label_762:
	var_182_string = "voice_common"; // 0x2fa PushS
	var_183_int = 0; // 0x2fb PushI
	SetVariable(var_182_string, var_183_int); // 0x2fc Func
	
Label_767:
	var_184_bool = 0; var_185_object = Obj(); // 0x2ff PushV
	var_185_object = var_98_object; // 0x300 Mov
	func_824(var_185_object); // 0x301 NEW_2
	var_186_bool = var_184_bool == 0; // 0x303 Not
	if(var_186_bool == 0) goto Label_781; // 0x304 JumpB
	var_187_bool = 0; var_188_object = Obj(); // 0x305 PushV
	var_188_object = var_98_object; // 0x306 Mov
	func_787(var_188_object); // 0x307 NEW_2
	var_189_bool = var_187_bool == 0; // 0x309 Not
	if(var_189_bool == 0) goto Label_781; // 0x30a JumpB
	var_97_bool = 0; // 0x30b MovB
	return 4; // 0x30c Return
	
Label_781:
	var_190_string = "voice_common"; // 0x30d PushS
	var_191_int = 1; // 0x30e PushI
	SetVariable(var_190_string, var_191_int); // 0x30f Func
}
...
func_992(var_88_int)
{
	var_89_int = 0; var_90_int = 0; // 0x3e0 PushV
	var_91_string = "branch"; // 0x3e1 PushS
	GetVariable(var_91_string, var_90_int); // 0x3e2 Func
	var_92_int = 0; // 0x3e4 PushI
	var_93_bool = var_90_int == var_92_int; // 0x3e5 Eq
	if(var_93_bool == 0) goto Label_1002; // 0x3e6 JumpB
	var_88_int = 1; // 0x3e7 MovI
	return 2; // 0x3e8 Return
	
Label_1002:
	var_94_int = 1; // 0x3ea PushI
	var_95_bool = var_90_int == var_94_int; // 0x3eb Eq
	if(var_95_bool == 0) goto Label_1007; // 0x3ec JumpB
	var_88_int = 2; // 0x3ed MovI
	return 2; // 0x3ee Return
	
Label_1007:
	var_88_int = 3; // 0x3ef MovI
...
func_482()
{
	...
	func_867(var_8_string); // 0x1e9 NEW_2
	func_416(); // 0x1ec NEW_2
	return 0; // 0x1ee Return
}


func_867(var_238_string)
{
	var_239_bool = 0; var_240_float = 0; var_241_float = 0; var_242_bool = 0; var_243_float = 0; var_244_float = 0; // 0x363 PushV
	lshHasAnimation(var_242_bool, var_238_string); // 0x364 Func
	var_245_bool = var_242_bool; // 0x366 Push
	if(var_245_bool == 0) goto Label_878; // 0x367 JumpB
	lshGetAnimTimes(var_238_string, var_243_float, var_244_float); // 0x368 Func
	var_246_bool = 0; // 0x36a PushB
	lshPlayAnimation(var_243_float, var_244_float, var_246_bool); // 0x36b Func
...
Label_878:
	var_247_string = "Can't find lsh animation : "; // 0x36e PushS
	var_248_int = var_247_string + var_238_string; // 0x36f Add
	Trace(var_248_int); // 0x370 Func
}
...
func_1009(var_85_int)
{
	var_85_int = 515531; // 0x3f1 MovI
	return 0; // 0x3f2 Return
}


func_1011(var_84_int)
{
	var_84_int = 502857; // 0x3f3 MovI
	return 0; // 0x3f4 Return
}


func_883(var_216_string, var_217_bool)
{
	var_220_bool = 0; var_221_float = 0; var_222_float = 0; var_223_bool = 0; var_224_float = 0; var_225_float = 0; // 0x373 PushV
	lshHasAnimation(var_223_bool, var_216_string); // 0x374 Func
	var_226_bool = var_223_bool; // 0x376 Push
	if(var_226_bool == 0) goto Label_893; // 0x377 JumpB
	lshGetAnimTimes(var_216_string, var_224_float, var_225_float); // 0x378 Func
	lshPlayAnimation(var_224_float, var_225_float, var_217_bool); // 0x37a Func
...
Label_893:
	var_227_string = "Can't find lsh animation : "; // 0x37d PushS
	var_228_int = var_227_string + var_216_string; // 0x37e Add
	Trace(var_228_int); // 0x37f Func
}


func_1013(var_86_string)
{
	var_86_string = "ui/NPC_BigVlad.png"; // 0x3f5 MovS
...
{
	var_87_string = "ui/NPC_BigVlad_b.png"; // 0x3f7 MovS
...
func_1017(var_79_bool)
{
	var_79_bool = 1; // 0x3f9 MovB
