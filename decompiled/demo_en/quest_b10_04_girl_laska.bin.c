...
Label_199:
	...
	func_763(var_97_object); // 0xd5 NEW_2
...
Label_250:
	...
	func_719(var_120_bool); // 0xfc NEW_2
...
Label_340:
	...
	func_661(var_19_object); // 0x156 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_643(var_29_object); // 0x193 NEW_2
...
func_643(var_29_object)
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x283 PushV
	GetEyesHeight(var_32_float); // 0x284 ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x286 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x287 PushE
	var_34_float = var_32_float; // 0x288 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x289 PopE
	var_35_string = "head"; // 0x28a PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x28b Func
	return 4; // 0x28d Return
}


func_775(var_30_object)
{
	var_31_object = Obj(); var_32_object = Obj(); var_33_object = Obj(); var_34_object = Obj(); // 0x307 PushV
	GetMainOutdoorScene(var_33_object); // 0x308 Func
	var_35_bool = var_33_object == 0; // 0x30a NullEq
	if(var_35_bool == 0) goto Label_786; // 0x30b JumpB
	var_36_string = "Can't find main outdoor scene"; // 0x30c PushS
	Trace(var_36_string); // 0x30d Func
	var_34_object = 0; // 0x30f SetNull
	var_30_object = var_34_object; // 0x310 Mov
	return 4; // 0x311 Return
	
Label_786:
	GetMap(var_34_object); // 0x312 ObjFunc
	var_30_object = var_34_object; // 0x314 Mov
...
func_137(var_2_object, var_94_string)
{
	...
	func_719(var_95_bool); // 0x8b NEW_2
...
Label_155:
	func_628(var_98_string, var_99_bool); // 0x9b NEW_2
...
func_654()
{
	var_15_bool = 0; // 0x28e PushV
	func_719(var_15_bool); // 0x28f NEW_2
	if(var_15_bool == 0) goto Label_660; // 0x291 JumpB
...
func_527(var_27_bool, var_29_float)
{
	...
	func_667(var_54_cvector, var_55_cvector); // 0x22a NEW_2
...
Label_568:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x23a Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x23c PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x23d PushE
	Rotate(var_67_float, var_68_float); // 0x23e Func
	var_69_bool = 0; // 0x240 PushV
	func_719(var_69_bool); // 0x241 NEW_2
	if(var_69_bool == 0) goto Label_581; // 0x243 JumpB
	goto Label_589; // 0x244 Jump
	
Label_589:
	CameraWaitForPlayFinish(); // 0x24d Func
	ResumeWorld(); // 0x24f Func
	var_27_bool = 1; // 0x251 MovB
	return 18; // 0x252 Return
	
Label_581:
	var_70_string = "head"; // 0x245 PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x246 Func
	var_71_bool = var_47_bool; // 0x248 Push
	if(var_71_bool == 0) goto Label_589; // 0x249 JumpB
	var_72_string = "head"; // 0x24a PushS
	LookAsyncCamera(var_72_string); // 0x24b Func
}


func_661(var_19_object)
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x295 PushV
	self(var_21_object); // 0x296 Func
	var_19_object = var_21_object; // 0x298 Mov
	return 2; // 0x299 Return
}


func_792(var_46_object, var_47_string, var_48_float)
{
	var_50_cvector = CVector(0,0,0); var_51_cvector = CVector(0,0,0); var_52_object = Obj(); var_53_bool = 0; var_54_cvector = CVector(0,0,0); var_55_cvector = CVector(0,0,0); var_56_object = Obj(); var_57_bool = 0; // 0x318 PushV
	GetMainOutdoorScene(var_56_object); // 0x319 Func
	var_58_bool = var_56_object == 0; // 0x31b NullEq
	if(var_58_bool == 0) goto Label_801; // 0x31c JumpB
	var_59_string = "Can't find main outdoor scene"; // 0x31d PushS
	Trace(var_59_string); // 0x31e Func
	return 8; // 0x320 Return
	
Label_801:
	GetLocator(var_47_string, var_57_bool, var_54_cvector, var_55_cvector); // 0x321 ObjFunc
	var_60_bool = var_57_bool == 0; // 0x323 Not
	if(var_60_bool == 0) goto Label_811; // 0x324 JumpB
	var_61_string = "Warning: outdoor scene locator "; // 0x325 PushS
	var_62_int = var_61_string + var_47_string; // 0x326 Add
	var_63_string = " doesnt exist"; // 0x327 PushS
	var_64_int = var_62_int + var_63_string; // 0x328 Add
	Trace(var_64_int); // 0x329 Func
	
Label_811:
	GetMap(var_46_object); // 0x32b ObjFunc
	var_65_bool = var_46_object == 0; // 0x32d NullEq
	if(var_65_bool == 0) goto Label_819; // 0x32e JumpB
	var_66_string = "Can't find map"; // 0x32f PushS
	Trace(var_66_string); // 0x330 Func
	return 8; // 0x332 Return
	
Label_819:
	var_67_float = GetByIndex(var_54_cvector, 0); // 0x333 PushE
	var_68_float = GetByIndex(var_54_cvector, 2); // 0x334 PushE
	SetMapParams(var_67_float, var_68_float, var_48_float); // 0x335 ObjFunc
	return 8; // 0x337 Return
}
...
func_667(var_54_cvector, var_55_cvector)
{
	var_57_float = 0; var_58_float = 0; // 0x29b PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x29c Or
	var_58_float = sqrt(var_59_int); // 0x29d Sqrt2
	var_60_float = 0.0; // 0x29e PushF
	var_61_bool = var_58_float < var_60_float; // 0x29f LT
	if(var_61_bool == 0) goto Label_675; // 0x2a0 JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x2a1 MovV
	return 2; // 0x2a2 Return
	
Label_675:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x2a3 Div2
...
func_677(var_114_int, var_115_string)
{
	var_116_int = 0; var_117_int = 0; // 0x2a5 PushV
	GetVariable(var_115_string, var_117_int); // 0x2a6 Func
	var_114_int = var_117_int; // 0x2a8 Mov
...
Label_311:
	...
	func_661(var_21_object); // 0x139 NEW_2
...
func_682(var_41_float)
{
	var_42_float = 0; var_43_float = 0; // 0x2aa PushV
	GetGameTime(var_43_float); // 0x2ab Func
	var_41_float = var_43_float; // 0x2ad Mov
...
Label_437:
	...
	func_694(var_46_int); // 0x1b6 NEW_2
...
Label_452:
	...
	func_687(var_68_string, var_69_int); // 0x1d2 NEW_2
...
func_687(var_52_string, var_53_int)
{
	var_54_string = ""; var_55_string = ""; // 0x2af PushV
	var_55_string = "idle"; // 0x2b0 MovS
	var_56_int = var_53_int; // 0x2b1 Push
	if(var_56_int == 0) goto Label_692; // 0x2b2 JumpB
	var_55_string = var_55_string + var_53_int; // 0x2b3 Add2
	
Label_692:
	var_52_string = var_55_string; // 0x2b4 Mov
...
func_694(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x2b6 PushV
	var_49_int = 0; // 0x2b7 MovI
	
Label_696:
	var_51_string = "all"; // 0x2b8 PushS
	var_52_string = ""; var_53_int = 0; // 0x2b9 PushV
	var_53_int = var_49_int; // 0x2ba Mov
	func_687(var_52_string, var_53_int); // 0x2bb NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x2bd Func
	var_57_bool = var_50_bool == 0; // 0x2bf Not
	if(var_57_bool == 0) goto Label_706; // 0x2c0 JumpB
	goto Label_709; // 0x2c1 Jump
	
Label_709:
	var_46_int = var_49_int; // 0x2c5 Mov
	return 4; // 0x2c6 Return
	
Label_706:
	var_58_int = 1; // 0x2c2 PushI
	var_49_int = var_49_int + var_58_int; // 0x2c3 Add2
...
func_825(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x339 PushV
	var_81_string = "branch"; // 0x33a PushS
	GetVariable(var_81_string, var_80_int); // 0x33b Func
	var_82_int = 0; // 0x33d PushI
	var_83_bool = var_80_int == var_82_int; // 0x33e Eq
	if(var_83_bool == 0) goto Label_835; // 0x33f JumpB
	var_78_int = 1; // 0x340 MovI
	return 2; // 0x341 Return
	
Label_835:
	var_84_int = 1; // 0x343 PushI
	var_85_bool = var_80_int == var_84_int; // 0x344 Eq
	if(var_85_bool == 0) goto Label_840; // 0x345 JumpB
	var_78_int = 2; // 0x346 MovI
	return 2; // 0x347 Return
	
Label_840:
	var_78_int = 3; // 0x348 MovI
...
Label_116:
	...
	func_612(var_128_string); // 0x76 NEW_2
...
{
	var_76_string = "ui/NPC_Citizen1.png"; // 0x2cb MovS
...
{
	var_77_string = "ui/NPC_Citizen1_b.png"; // 0x2cd MovS
	return 0; // 0x2ce Return
}


func_719(var_69_bool)
{
	var_69_bool = 0; // 0x2cf MovB
...
func_721()
{
	var_20_string = "oob10GirlLaska1"; // 0x2d2 PushS
	var_21_int = 1; // 0x2d3 PushI
	SetVariable(var_20_string, var_21_int); // 0x2d4 Func
...
func_595()
{
	var_146_bool = 0; var_147_bool = 0; // 0x253 PushV
	CameraSwitchToNormal(); // 0x254 Func
	var_148_bool = 0; // 0x256 PushV
	func_719(var_148_bool); // 0x257 NEW_2
	if(var_148_bool == 0) goto Label_603; // 0x259 JumpB
...
Label_603:
	var_149_string = "head"; // 0x25b PushS
	HasAnimationTrack(var_147_bool, var_149_string); // 0x25c Func
	var_150_bool = var_147_bool; // 0x25e Push
	if(var_150_bool == 0) goto Label_611; // 0x25f JumpB
	var_151_string = "head"; // 0x260 PushS
	UnlookAsync(var_151_string); // 0x261 Func
}


func_727()
{
	var_26_object = Obj(); var_27_object = Obj(); // 0x2d7 PushV
	var_28_string = "b10q04GirlGotoKapella"; // 0x2d8 PushS
	var_29_int = 1; // 0x2d9 PushI
	SetVariable(var_28_string, var_29_int); // 0x2da Func
	var_30_object = Obj(); // 0x2dc PushV
	func_775(var_30_object); // 0x2dd NEW_2
	var_27_object = var_30_object; // 0x2de Mov
	var_37_string = "b10q04GirlGotoKapella"; // 0x2e0 PushS
	var_38_string = "pt_map_kapella"; // 0x2e1 PushS
	var_39_int = 0; // 0x2e2 PushI
	var_40_int = 530490; // 0x2e3 PushI
	var_41_float = 0; // 0x2e4 PushV
	func_682(var_41_float); // 0x2e5 NEW_2
	AddMark(var_37_string, var_38_string, var_39_int, var_40_int, var_41_float); // 0x2e7 ObjFunc
...
func_612(var_128_string)
{
	var_129_bool = 0; var_130_float = 0; var_131_float = 0; var_132_bool = 0; var_133_float = 0; var_134_float = 0; // 0x264 PushV
	lshHasAnimation(var_132_bool, var_128_string); // 0x265 Func
	var_135_bool = var_132_bool; // 0x267 Push
	if(var_135_bool == 0) goto Label_623; // 0x268 JumpB
	lshGetAnimTimes(var_128_string, var_133_float, var_134_float); // 0x269 Func
	var_136_bool = 0; // 0x26b PushB
	lshPlayAnimation(var_133_float, var_134_float, var_136_bool); // 0x26c Func
...
Label_623:
	var_137_string = "Can't find lsh animation : "; // 0x26f PushS
	var_138_int = var_137_string + var_128_string; // 0x270 Add
	Trace(var_138_int); // 0x271 Func
}


func_747()
{
	var_46_object = Obj(); var_47_string = ""; var_48_float = 0; // 0x2ec PushV
	var_49_object = Obj(); // 0x2ed PushV
	func_775(var_49_object); // 0x2ee NEW_2
	var_46_object = var_49_object; // 0x2ef Mov
	var_47_string = "pt_map_kapella"; // 0x2f1 MovS
	var_48_float = 2; // 0x2f2 MovI
	func_792(var_46_object, var_47_string, var_48_float); // 0x2f3 NEW_2
	var_69_object = Obj(); // 0x2f5 PushV
	func_775(var_69_object); // 0x2f6 NEW_2
	ShowMap(var_69_object); // 0x2f8 ObjFunc
	return 0; // 0x2fa Return
}


func_628(var_98_string, var_99_bool)
{
	var_102_bool = 0; var_103_float = 0; var_104_float = 0; var_105_bool = 0; var_106_float = 0; var_107_float = 0; // 0x274 PushV
	lshHasAnimation(var_105_bool, var_98_string); // 0x275 Func
	var_108_bool = var_105_bool; // 0x277 Push
	if(var_108_bool == 0) goto Label_638; // 0x278 JumpB
	lshGetAnimTimes(var_98_string, var_106_float, var_107_float); // 0x279 Func
	lshPlayAnimation(var_106_float, var_107_float, var_99_bool); // 0x27b Func
	goto Label_642; // 0x27d Jump
	
Label_642:
	return 6; // 0x282 Return
	
Label_638:
	var_109_string = "Can't find lsh animation : "; // 0x27e PushS
	var_110_int = var_109_string + var_98_string; // 0x27f Add
	Trace(var_110_int); // 0x280 Func
}
...
func_763(var_112_bool)
{
	var_114_int = 0; var_115_string = ""; // 0x2fc PushV
	var_115_string = "oob10GirlLaska1"; // 0x2fd MovS
	func_677(var_114_int, var_115_string); // 0x2fe NEW_2
	var_118_int = 0; // 0x300 PushI
	var_119_bool = var_114_int == var_118_int; // 0x301 Eq
	if(var_119_bool == 0) goto Label_773; // 0x302 JumpB
	var_112_bool = 1; // 0x303 MovB
	return 0; // 0x304 Return
	
Label_773:
	var_112_bool = 0; // 0x305 MovB
