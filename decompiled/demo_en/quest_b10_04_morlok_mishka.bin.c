...
Label_545:
	...
	func_1048(var_162_object); // 0x223 NEW_2
...
Label_565:
	...
	func_1036(var_183_object); // 0x249 NEW_2
...
Label_590:
	...
	func_1060(var_190_object); // 0x251 NEW_2
...
func_1024(var_176_bool)
{
	...
	var_179_string = "b10q04MishkaTalk"; // 0x402 MovS
...
func_1036(var_182_bool)
{
	var_184_int = 0; var_185_string = ""; // 0x40d PushV
	var_185_string = "b10q04"; // 0x40e MovS
	func_829(var_184_int, var_185_string); // 0x40f NEW_2
	var_186_int = -1; // 0x411 PushI
	var_187_bool = var_184_int == var_186_int; // 0x412 Eq
	if(var_187_bool == 0) goto Label_1046; // 0x413 JumpB
	var_182_bool = 1; // 0x414 MovB
	return 0; // 0x415 Return
	
Label_1046:
	var_182_bool = 0; // 0x416 MovB
...
func_1048(var_161_bool)
{
	var_163_int = 0; var_164_string = ""; // 0x419 PushV
	var_164_string = "b10q04MishkaTalk"; // 0x41a MovS
	func_829(var_163_int, var_164_string); // 0x41b NEW_2
	var_165_int = 0; // 0x41d PushI
	var_166_bool = var_163_int == var_165_int; // 0x41e Eq
	if(var_166_bool == 0) goto Label_1058; // 0x41f JumpB
	var_161_bool = 1; // 0x420 MovB
	return 0; // 0x421 Return
	
Label_1058:
	var_161_bool = 0; // 0x422 MovB
...
func_928()
{
	...
	var_22_string = "b10q04MishkaTalk"; // 0x3a1 PushS
	...
	var_31_string = "b10q04MorlokGotoMishka"; // 0x3a9 PushS
	var_32_string = "pt_map_mishka"; // 0x3aa PushS
	var_33_int = 0; // 0x3ab PushI
	var_34_int = 530550; // 0x3ac PushI
...
func_1060(var_189_bool)
{
	var_191_int = 0; var_192_string = ""; // 0x425 PushV
	var_192_string = "oob10MorlokMishka1"; // 0x426 MovS
	func_829(var_191_int, var_192_string); // 0x427 NEW_2
	var_193_int = 0; // 0x429 PushI
	var_194_bool = var_191_int == var_193_int; // 0x42a Eq
	if(var_194_bool == 0) goto Label_1070; // 0x42b JumpB
	var_189_bool = 1; // 0x42c MovB
	return 0; // 0x42d Return
	
Label_1070:
	var_189_bool = 0; // 0x42e MovB
...
func_951()
{
	var_91_string = "oob10MorlokMishka1"; // 0x3b8 PushS
...
func_1084()
{
	...
	var_40_int = 549; // 0x43d PushI
	var_41_int = 2; // 0x43e PushI
	var_42_int = 530440; // 0x43f PushI
...
func_323(var_0_int, var_1_int, var_2_bool, var_3_bool, var_88_object, var_89_object)
{
	...
	var_121_int = 530543; // 0x153 PushI
	SetMessage(var_121_int); // 0x154 TObjFunc
	ClearReplies(); // 0x156 TObjFunc
	var_122_int = 530544; // 0x158 PushI
	var_123_int = -1; // 0x159 PushI
	var_124_int = 31891; // 0x15a PushI
...
Label_350:
	...
	func_1048(var_144_object); // 0x160 NEW_2
	...
	var_150_int = 530416; // 0x167 PushI
	SetMessage(var_150_int); // 0x168 TObjFunc
	ClearReplies(); // 0x16a TObjFunc
	var_151_int = 530417; // 0x16c PushI
	var_152_int = -1; // 0x16d PushI
	var_153_int = 31789; // 0x16e PushI
...
Label_370:
	...
	var_155_int = 530418; // 0x176 PushI
	...
	if(var_158_bool == 0) goto Label_395; // 0x183 JumpB
	var_164_bool = 0; var_165_object = Obj(); // 0x184 PushV
	var_165_object = var_1_int; // 0x185 MovT
	func_1036(var_165_object); // 0x186 NEW_2
	var_170_bool = var_164_bool == 0; // 0x188 Not
	if(var_170_bool == 0) goto Label_395; // 0x189 JumpB
	var_157_bool = 1; // 0x18a MovB
	
Label_395:
	if(var_157_bool == 0) goto Label_402; // 0x18b JumpB
	var_171_bool = 0; var_172_object = Obj(); // 0x18c PushV
	var_172_object = var_1_int; // 0x18d MovT
	func_1060(var_172_object); // 0x18e NEW_2
	if(var_171_bool == 0) goto Label_402; // 0x190 JumpB
	var_156_bool = 1; // 0x191 MovB
	
Label_402:
	if(var_156_bool == 0) goto Label_408; // 0x192 JumpB
	var_177_int = 530419; // 0x193 PushI
	var_178_int = 31792; // 0x194 PushI
	var_179_int = 31791; // 0x195 PushI
	AddReply(var_177_int, var_178_int, var_179_int); // 0x196 TObjFunc
	
Label_408:
	var_180_int = 530424; // 0x198 PushI
	var_181_int = -1; // 0x199 PushI
	var_182_int = 31796; // 0x19a PushI
...
func_963()
{
	...
	var_64_string = "pt_map_mishka"; // 0x3c9 MovS
