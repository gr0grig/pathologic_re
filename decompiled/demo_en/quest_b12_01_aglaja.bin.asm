...
0x5d7: PushEmpty(bool, float, float, bool, float, float)
0x5d8: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5d9: Pop(0)
0x5da: Push(Stack[-3])
0x5db: IF (Stack[-1] == 0) GOTO 0x5e2; Pop(1)

0x5dc: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5dd: Pop(0)
0x5de: Push((bool) 0)
0x5df: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5e0: Pop(1)
0x5e1: GOTO 0x5e6

0x5e2: Push("Can't find lsh animation : ")
...
0x5e8: @ lshHasAnimation(Stack[-3], Stack[-8])
0x5e9: Pop(0)
0x5ea: Push(Stack[-3])
0x5eb: IF (Stack[-1] == 0) GOTO 0x5f1; Pop(1)

0x5ec: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x5ed: Pop(0)
0x5ee: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x5ef: Pop(0)
0x5f0: GOTO 0x5f5

0x5f1: Push("Can't find lsh animation : ")
0x5f2: Pop(1); Push(Stack[-1] + Stack[-9]);
0x5f3: @ Trace(Stack[-1])
0x5f4: Pop(1)
0x5f5: Return(); Pop(6)
...
0x5f9: Pop(0)
0x5fa: IF (Stack[-1] == 0) GOTO 0x603; Pop(1)

0x5fb: @ lshHasSpeech(Stack[-1], Stack[-3])
0x5fc: Pop(0)
0x5fd: Push(Stack[-1])
0x5fe: IF (Stack[-1] == 0) GOTO 0x603; Pop(1)

0x5ff: @ lshPlaySpeech(Stack[-3])
0x600: Pop(0)
0x601: Stack[-4] = (bool) 1
0x602: Return(); Pop(2)

0x603: Stack[-4] = (bool) 0
0x604: Return(); Pop(2)
...
0x613: Pop(0); Push(Stack[-3] | Stack[-3]);
0x614: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x615: Push((float)0.0)
0x616: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x617: IF (Stack[-1] == 0) GOTO 0x61a; Pop(1)

0x618: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x619: Return(); Pop(2)

0x61a: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x61b: Return(); Pop(2)

0x61c: PushEmpty(int, int)
0x61d: @ GetVariable(Stack[-3], Stack[-1])
0x61e: Pop(0)
0x61f: Stack[-4] = Stack[-1]
0x620: Return(); Pop(2)

0x621: PushEmpty(float, float)
0x622: @ GetGameTime(Stack[-1])
0x623: Pop(0)
0x624: Push((int) 1)
0x625: PushEmpty(int)
0x626: Push((int) 24)
0x627: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x628: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x629: Return(); Pop(2)

0x62a: PushEmpty()
0x62b: Push("oob12AglajaSobor1")
0x62c: Push((int) 1)
...
0x656: Stack[-1] = "b12q01ChildsAreVisited"
0x657: Call2 0x61c
...
0x662: Stack[-1] = "b12q01TheaterIsVisited"
0x663: Call2 0x61c
...
0x66e: Stack[-1] = "oob12AglajaSobor1"
0x66f: Call2 0x61c
...
0x67a: Stack[-1] = "oob12AglajaSobor2"
0x67b: Call2 0x61c
...
0x684: PushEmpty()
0x685: PushEmpty(int, string)
0x686: Stack[-1] = "oob12AglajaSobor3"
0x687: Call2 0x61c

0x688: Pop(1)
0x689: Push((int) 0)
0x68a: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x68b: IF (Stack[-1] == 0) GOTO 0x68e; Pop(1)

0x68c: Stack[-2] = (bool) 1
0x68d: Return(); Pop(0)

0x68e: Stack[-2] = (bool) 0
0x68f: Return(); Pop(0)

0x690: PushEmpty()
0x691: PushEmpty(int, string)
0x692: Stack[-1] = "oob12AglajaSobor4"
0x693: Call2 0x61c
...
0x69c: PushEmpty()
0x69d: PushEmpty(int, string)
0x69e: Stack[-1] = "oob12AglajaSobor5"
0x69f: Call2 0x61c
...
0x6a4: Stack[-2] = (bool) 1
0x6a5: Return(); Pop(0)

0x6a6: Stack[-2] = (bool) 0
0x6a7: Return(); Pop(0)

0x6a8: PushEmpty()
0x6a9: PushEmpty(int, string)
0x6aa: Stack[-1] = "oob12AglajaSobor6"
0x6ab: Call2 0x61c

0x6ac: Pop(1)
0x6ad: Push((int) 0)
0x6ae: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x6af: IF (Stack[-1] == 0) GOTO 0x6b2; Pop(1)

0x6b0: Stack[-2] = (bool) 1
0x6b1: Return(); Pop(0)

0x6b2: Stack[-2] = (bool) 0
0x6b3: Return(); Pop(0)

0x6b4: PushEmpty()
0x6b5: PushEmpty(int, string)
0x6b6: Stack[-1] = "oob12AglajaSobor7"
0x6b7: Call2 0x61c
...
0x6c0: PushEmpty()
0x6c1: PushEmpty(int, string)
0x6c2: Stack[-1] = "game_final"
0x6c3: Call2 0x61c

0x6c4: Pop(1)
0x6c5: Push((int) 0)
0x6c6: Pop(2); Push((bool) Stack[-2] != Stack[-1])
...
0x6dd: Stack[-1] = (int) 515527
0x6de: Return(); Pop(0)

0x6df: Stack[-1] = (int) 513334
0x6e0: Return(); Pop(0)

0x6e1: Stack[-1] = "ui/NPC_Aglaja.png"
0x6e2: Return(); Pop(0)

0x6e3: Stack[-1] = "ui/NPC_Aglaja_b.png"
0x6e4: Return(); Pop(0)
