...
0x333: @@ HasProperty(Stack[-1], Stack[-4])
0x334: Pop(1)
...
0x348: @@ GetProperty(Stack[-1], Stack[-2])
0x349: Pop(1)
0x34a: PushEmpty(bool, string)
0x34b: Stack[-1] = Stack[-3]
0x34c: Call2 0x39a

0x34d: Stack[-14] = Stack[-2]
0x34e: Pop(2)
0x34f: Return(); Pop(10)
...
0x39f: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3a0: Pop(0)
0x3a1: Push(Stack[-1])
0x3a2: IF (Stack[-1] == 0) GOTO 0x3a7; Pop(1)

0x3a3: @ lshPlaySpeech(Stack[-3])
0x3a4: Pop(0)
0x3a5: Stack[-4] = (bool) 1
0x3a6: Return(); Pop(2)

0x3a7: Stack[-4] = (bool) 0
0x3a8: Return(); Pop(2)
...
0x3c9: IF (Stack[-1] == 0) GOTO 0x3d1; Pop(1)

0x3ca: Push("Door ")
0x3cb: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3cc: Push(" not found")
...
0x3d1: Push("locked")
0x3d2: @@ SetProperty(Stack[-1], Stack[-4])
0x3d3: Pop(1)
0x3d4: Return(); Pop(2)

0x3d5: Stack[-1] = 0
0x3d6: PushEmpty(float, float)
0x3d7: @ GetGameTime(Stack[-1])
0x3d8: Pop(0)
0x3d9: Push((int) 1)
0x3da: PushEmpty(int)
0x3db: Push((int) 24)
0x3dc: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x3dd: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x3de: Return(); Pop(2)

0x3df: PushEmpty()
0x3e0: Push("game_final")
0x3e1: Push((int) 1)
...
0x407: PushEmpty()
0x408: Push("game_final")
0x409: Push((int) 4)
0x40a: @ SetVariable(Stack[-2], Stack[-1])
0x40b: Pop(2)
0x40c: Return(); Pop(0)
...
0x41a: Stack[-2] = (bool) 1
0x41b: Return(); Pop(0)

0x41c: Stack[-2] = (bool) 0
0x41d: Return(); Pop(0)

0x41e: PushEmpty()
0x41f: PushEmpty(int, string)
0x420: Stack[-1] = "b12q01DankoInSobor"
0x421: Call2 0x3c0
...
0x426: Stack[-2] = (bool) 1
0x427: Return(); Pop(0)

0x428: Stack[-2] = (bool) 0
0x429: Return(); Pop(0)

0x42a: PushEmpty()
0x42b: PushEmpty(int, string)
0x42c: Stack[-1] = "b12q01KlaraInSobor"
0x42d: Call2 0x3c0
...
0x444: Push((int) 618)
0x445: Push((int) 1)
0x446: Push((int) 532007)
0x447: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x448: Pop(3)
0x449: PushEmpty(bool, object, int)
0x44a: Stack[-2] = Stack[-4]
0x44b: Stack[-1] = (int) 613
0x44c: Call2 0x477
...
0x476: Stack[-1] = 0
0x477: PushEmpty(object, object, int, object, object, int)
0x478: PushEmpty(object)
0x479: Call2 0x46a

0x47a: Stack[-4] = Stack[-1]
0x47b: Pop(1)
0x47c: @@ Find(Stack[-7], Stack[-2])
0x47d: Pop(0)
0x47e: Pop(0); Push((bool) Stack[-2] == 0)
0x47f: IF (Stack[-1] == 0) GOTO 0x486; Pop(1)

0x480: Push("Can't find diary parent with id: ")
0x481: Pop(1); Push(Stack[-1] + Stack[-8]);
0x482: @ Trace(Stack[-1])
0x483: Pop(1)
0x484: Stack[-9] = (bool) 0
0x485: Return(); Pop(6)

0x486: @@ AddChild(Stack[-8])
0x487: Pop(0)
0x488: Push((int) 7)
0x489: @ SendWorldWndMessage(Stack[-1])
0x48a: Pop(1)
0x48b: @@ GetCategory(Stack[-1])
0x48c: Pop(0)
0x48d: @ SetDiarySection(Stack[-1])
0x48e: Pop(0)
...
0x494: Push("branch")
0x495: @ GetVariable(Stack[-1], Stack[-2])
0x496: Pop(1)
0x497: Push((int) 0)
0x498: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x499: IF (Stack[-1] == 0) GOTO 0x49d; Pop(1)
...
0x4a4: Stack[-1] = (int) 515532
0x4a5: Return(); Pop(0)

0x4a6: Stack[-1] = (int) 514840
0x4a7: Return(); Pop(0)

0x4a8: Stack[-1] = "ui/NPC_Block.png"
0x4a9: Return(); Pop(0)

0x4aa: Stack[-1] = "ui/NPC_Block_b.png"
0x4ab: Return(); Pop(0)
