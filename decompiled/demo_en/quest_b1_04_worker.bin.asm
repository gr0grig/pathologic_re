...
0x6ea: Stack[-3] = Stack[-7]
0x6eb: Stack[-2] = Stack[-6]
0x6ec: Stack[-1] = Stack[-5]
0x6ed: Call2 0x5c5
...
0x6f2: Stack[-5] = Stack[-11]
0x6f3: Stack[-4] = Stack[-10]
0x6f4: Stack[-3] = Stack[-9]
0x6f5: Stack[-2] = Stack[-7]
0x6f6: Stack[-1] = Stack[-6]
0x6f7: Call2 0x609
...
0x711: Stack[-4] = Stack[-2]
0x712: Pop(2)
0x713: Return(); Pop(0)

0x714: PushEmpty()
0x715: PushEmpty(object)
0x716: Stack[-1] = Stack[-2]
0x717: Call2 0x756
...
0x72f: Pop(0)
0x730: @@ SetItemName(Stack[-7])
0x731: Pop(0)
0x732: Push("Organ")
0x733: Push((int) 1)
0x734: @@ SetProperty(Stack[-2], Stack[-1])
0x735: Pop(2)
0x736: @@ GetItemID(Stack[-2])
0x737: Pop(0)
0x738: Push((int) 0)
0x739: Push((int) 1)
...
0x75f: Pop(0)
0x760: @@ RemoveStationaryActor(Stack[-1])
0x761: Pop(1)
