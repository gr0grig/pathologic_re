task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1222(var_10_bool, var_11_object); // 0x14 NEW_2
	...
	func_1229(var_53_object); // 0x1c NEW_2
...
task_0_event_16(var_0_bool, var_1_bool, var_2_object, var_3_string, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1256(var_11_bool, var_12_object, var_13_string); // 0x23 NEW_2
...
Label_41:
	...
	func_1283(var_59_object, var_60_string); // 0x2c NEW_2
...
Label_55:
	...
	func_1239(var_45_object); // 0x3c NEW_2
...
task_0_event_0(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_bool, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object)
{
	...
	func_1333(var_10_object); // 0x42 NEW_2
...
task_3_event_16(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1256(var_11_bool, var_12_object, var_13_string); // 0x148 NEW_2
...
Label_334:
	...
	func_1283(var_59_object, var_60_string); // 0x151 NEW_2
...
task_4_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_string, var_7_object, var_8_cvector, var_9_bool, var_10_object)
{
	...
	func_1256(var_11_bool, var_12_object, var_13_string); // 0x197 NEW_2
...
Label_413:
	...
	func_1283(var_61_object, var_62_string); // 0x1a0 NEW_2
...
task_5_event_16(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object, var_10_string)
{
	...
	func_1256(var_11_bool, var_12_object, var_13_string); // 0x297 NEW_2
...
Label_669:
	...
	func_1283(var_61_object, var_62_string); // 0x2a0 NEW_2
...
task_5_event_0(var_0_bool, var_1_bool, var_2_object, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_object)
{
	...
	func_1333(var_10_object); // 0x2b6 NEW_2
...
{
	var_10_object = Obj(); // 0x523 PushV
	var_10_object = var_9_object; // 0x524 Mov
	func_1249(); // 0x525 NEW_2
...
{
	var_9_bool = 0; var_10_object = Obj(); // 0x54f PushV
	var_11_object = Obj(); // 0x550 PushV
	func_1097(var_11_object); // 0x551 NEW_2
	var_10_object = var_11_object; // 0x552 Mov
	func_991(var_10_object); // 0x554 NEW_2
	if(var_9_bool == 0) goto Label_1372; // 0x556 JumpB
	var_16_bool = 0; var_17_string = ""; var_18_string = ""; // 0x557 PushV
	var_17_string = "quest_b1_05"; // 0x558 MovS
	var_18_string = "rat_dead"; // 0x559 MovS
	func_1184(var_16_bool, var_17_string, var_18_string); // 0x55a NEW_2
	
Label_1372:
	var_22_object = Obj(); // 0x55c PushV
	func_1097(var_22_object); // 0x55d NEW_2
	RemoveActor(var_22_object); // 0x55f Func
	Hold(); // 0x561 Func
...
func_1283(var_61_object, var_62_string)
{
	var_63_float = 0; var_64_float = 0; // 0x503 PushV
	var_65_string = "health"; // 0x504 PushS
	var_66_bool = var_62_string == var_65_string; // 0x505 Eq
	if(var_66_bool == 0) goto Label_1313; // 0x506 JumpB
	var_67_string = "health"; // 0x507 PushS
	GetProperty(var_67_string, var_64_float); // 0x508 Func
	var_68_int = 0; // 0x50a PushI
	var_69_bool = var_64_float <= var_68_int; // 0x50b LE
	if(var_69_bool == 0) goto Label_1295; // 0x50c JumpB
	SignalDeath(var_61_object); // 0x50d Func
	
Label_1295:
	var_70_bool = 0; // 0x50f PushV
	var_70_bool = 0; // 0x510 MovB
	var_71_float = GlobalVars[0]; // 0x511 PushGE
	var_72_bool = var_64_float < var_71_float; // 0x512 LT
	if(var_72_bool == 0) goto Label_1306; // 0x513 JumpB
	var_73_bool = 0; var_74_object = Obj(); // 0x514 PushV
	var_74_object = var_61_object; // 0x515 Mov
	func_1032(var_73_bool, var_74_object); // 0x516 NEW_2
	if(var_73_bool == 0) goto Label_1306; // 0x518 JumpB
	var_70_bool = 1; // 0x519 MovB
	
Label_1306:
	if(var_70_bool == 0) goto Label_1313; // 0x51a JumpB
	var_75_object = Obj(); // 0x51b PushV
	var_75_object = var_61_object; // 0x51c Mov
	TaskCall(5); // 0x51d TaskCall
	func_607(var_79_object, var_75_object); // 0x51e NEW_2
...
func_1174(var_153_float)
{
	...
	var_156_int = 15; // 0x49b PushI
	SendWorldWndMessage(var_156_int, var_155_object); // 0x49c Func
...
Label_937:
	var_157_string = "armor"; // 0x3a9 PushS
	GetProperty(var_157_string, var_110_int); // 0x3aa ObjFunc
}
...
func_1184(var_16_bool, var_17_string, var_18_string)
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x4a0 PushV
	FindActor(var_20_object, var_17_string); // 0x4a1 Func
	var_21_bool = var_20_object == 0; // 0x4a3 NullEq
	if(var_21_bool == 0) goto Label_1191; // 0x4a4 JumpB
	var_16_bool = 0; // 0x4a5 MovB
	return 2; // 0x4a6 Return
	
Label_1191:
	Trigger(var_20_object, var_18_string); // 0x4a7 Func
	var_16_bool = 1; // 0x4a9 MovB
...
func_1320(var_97_object)
{
	var_98_float = 0; var_99_float = 0; // 0x528 PushV
	var_100_float = 0; var_101_object = Obj(); var_102_float = 0; var_103_int = 0; // 0x529 PushV
	var_101_object = var_97_object; // 0x52a Mov
	var_102_float = 0.025; // 0x52b MovF
	var_103_int = 0; // 0x52c MovI
	func_918(var_100_float, var_101_object, var_102_float, var_103_int); // 0x52d NEW_2
	var_99_float = var_100_float; // 0x52e Mov
	var_158_int = 7; // 0x530 PushI
	var_159_float = 0.025; // 0x531 PushF
	ReportHit(var_97_object, var_158_int, var_99_float, var_159_float); // 0x532 Func
...
func_1196()
{
	var_84_object = Obj(); var_85_object = Obj(); // 0x4ac PushV
	GetScene(var_85_object); // 0x4ad Func
	var_86_string = "battle"; // 0x4af PushS
	var_87_object = Obj(); // 0x4b0 PushV
	func_1097(var_87_object); // 0x4b1 NEW_2
	BroadcastMessage(var_86_string, var_87_object, var_85_object); // 0x4b3 Func
...
func_1333(var_10_object)
{
	var_11_object = Obj(); var_12_float = 0; var_13_object = Obj(); var_14_float = 0; // 0x535 PushV
	CreateInvItem(var_13_object); // 0x536 Func
	var_15_string = "rat"; // 0x538 PushS
	SetItemName(var_15_string); // 0x539 ObjFunc
	var_16_float = 0.25; // 0x53b PushF
	var_17_float = 0.5; // 0x53c PushF
	rand(var_14_float, var_16_float, var_17_float); // 0x53d Func
	var_18_string = "quality"; // 0x53f PushS
	SetProperty(var_18_string, var_14_float); // 0x540 ObjFunc
	var_19_object = Obj(); var_20_object = Obj(); var_21_int = 0; // 0x542 PushV
	var_19_object = var_10_object; // 0x543 Mov
	var_20_object = var_13_object; // 0x544 Mov
	var_21_int = 1; // 0x545 MovI
	func_1155(var_20_object, var_21_int); // 0x546 NEW_2
	var_35_object = Obj(); // 0x548 PushV
	func_1097(var_35_object); // 0x549 NEW_2
	RemoveActor(var_35_object); // 0x54b Func
	return 4; // 0x54d Return
}


func_1207(var_67_bool, var_68_object)
{
	var_69_bool = 0; var_70_object = Obj(); // 0x4b8 PushV
	var_70_object = var_68_object; // 0x4b9 Mov
	func_1032(var_69_bool, var_70_object); // 0x4ba NEW_2
	var_71_bool = var_69_bool == 0; // 0x4bc Not
	if(var_71_bool == 0) goto Label_1216; // 0x4bd JumpB
	var_67_bool = 0; // 0x4be MovB
	return 0; // 0x4bf Return
	
Label_1216:
	var_72_bool = 0; var_73_object = Obj(); // 0x4c0 PushV
	var_73_object = var_68_object; // 0x4c1 Mov
	func_901(var_72_bool, var_73_object); // 0x4c2 NEW_2
	var_67_bool = var_72_bool; // 0x4c3 Mov
...
func_1222(var_10_bool, var_11_object)
{
	var_12_bool = 0; var_13_object = Obj(); // 0x4c7 PushV
	var_13_object = var_11_object; // 0x4c8 Mov
	func_1207(var_12_bool, var_13_object); // 0x4c9 NEW_2
	var_10_bool = var_12_bool; // 0x4ca Mov
...
func_1229(var_53_object)
{
	var_54_object = Obj(); // 0x4ce PushV
	var_54_object = var_53_object; // 0x4cf Mov
	TaskCall(3); // 0x4d0 TaskCall
	func_228(var_53_object, var_55_object, var_54_object); // 0x4d1 NEW_2
	TaskReturn(); // 0x4d2 TaskReturn
	ResetAAS(); // 0x4d4 Func
...
func_465(var_0_bool, var_1_bool, var_177_bool, var_178_object, var_179_float, var_180_float, var_181_bool, var_182_bool)
{
	var_184_bool = 0; var_185_bool = 0; var_186_object = Obj(); var_187_cvector = CVector(0,0,0); var_188_cvector = CVector(0,0,0); var_189_cvector = CVector(0,0,0); var_190_float = 0; var_191_object = Obj(); var_192_bool = 0; var_193_bool = 0; var_194_object = Obj(); var_195_cvector = CVector(0,0,0); var_196_cvector = CVector(0,0,0); var_197_cvector = CVector(0,0,0); var_198_float = 0; var_199_object = Obj(); // 0x1d1 PushV
	var_0_bool = 0; // 0x1d2 TMovB
	var_1_bool = var_178_object; // 0x1d3 TMov
	var_193_bool = var_182_bool; // 0x1d4 Mov
	
Label_469:
	var_200_bool = 0; var_201_object = Obj(); // 0x1d5 PushV
	var_201_object = var_178_object; // 0x1d6 Mov
	func_596(var_200_bool, var_201_object); // 0x1d7 NEW_2
	var_204_bool = var_200_bool == 0; // 0x1d9 Not
	if(var_204_bool == 0) goto Label_477; // 0x1da JumpB
	var_177_bool = 0; // 0x1db MovB
	return 16; // 0x1dc Return
	
Label_477:
	GetPosition(var_195_cvector); // 0x1dd ObjFunc
	GetPosition(var_196_cvector); // 0x1df Func
	var_197_cvector = var_195_cvector - var_196_cvector; // 0x1e1 Sub2
	var_198_float = var_197_cvector | var_197_cvector; // 0x1e2 Or2
	var_205_bool = 0; // 0x1e3 PushV
	var_205_bool = 0; // 0x1e4 MovB
	var_206_int = 0; // 0x1e5 PushI
	var_207_bool = var_180_float > var_206_int; // 0x1e6 GT
	if(var_207_bool == 0) goto Label_492; // 0x1e7 JumpB
	var_208_float = var_180_float * var_180_float; // 0x1e8 Mult
	var_209_bool = var_198_float > var_208_float; // 0x1e9 GT
	if(var_209_bool == 0) goto Label_492; // 0x1ea JumpB
	var_205_bool = 1; // 0x1eb MovB
	
Label_492:
	if(var_205_bool == 0) goto Label_497; // 0x1ec JumpB
	Stop(); // 0x1ed Func
	var_177_bool = 0; // 0x1ef MovB
	return 16; // 0x1f0 Return
	
Label_497:
	var_210_float = var_179_float * var_179_float; // 0x1f1 Mult
	var_211_bool = var_198_float > var_210_float; // 0x1f2 GT
	if(var_211_bool == 0) goto Label_559; // 0x1f3 JumpB
	GetPFPosition(var_195_cvector); // 0x1f4 ObjFunc
	FindPathTo(var_199_object, var_195_cvector); // 0x1f6 Func
	var_212_bool = var_199_object != 0; // 0x1f8 NullNeq
	if(var_212_bool == 0) goto Label_508; // 0x1f9 JumpB
	var_194_object = var_199_object; // 0x1fa Mov
	var_199_object = 0; // 0x1fb SetNull
	
Label_508:
	var_213_bool = var_194_object != 0; // 0x1fc NullNeq
	if(var_213_bool == 0) goto Label_541; // 0x1fd JumpB
	var_214_bool = var_193_bool; // 0x1fe Push
	if(var_214_bool == 0) goto Label_518; // 0x1ff JumpB
	var_193_bool = 0; // 0x200 MovB
	RotatePath(var_194_object, var_192_bool); // 0x201 Func
	var_215_bool = var_192_bool == 0; // 0x203 Not
	if(var_215_bool == 0) goto Label_518; // 0x204 JumpB
	goto Label_565; // 0x205 Jump
	
Label_565:
	var_177_bool = !var_0_bool; // 0x235 Not2
	return 16; // 0x236 Return
	
Label_518:
	var_216_int = 0; // 0x206 PushI
	var_217_float = 0.3; // 0x207 PushF
	SetTimer(var_216_int, var_217_float); // 0x208 Func
	var_218_string = ""; // 0x20a PushV
	func_603(var_218_string); // 0x20b NEW_2
	var_219_string = ""; // 0x20d PushV
	func_605(var_219_string); // 0x20e NEW_2
	FollowPath(var_194_object, var_181_bool, var_192_bool, var_218_string, var_219_string); // 0x210 Func
	var_220_bool = var_192_bool == 0; // 0x212 Not
	if(var_220_bool == 0) goto Label_539; // 0x213 JumpB
	var_221_bool = var_0_bool; // 0x214 PushT
	if(var_221_bool == 0) goto Label_537; // 0x215 JumpB
	var_194_object = 0; // 0x216 SetNull
...
Label_539:
	var_194_object = 0; // 0x21b SetNull
	goto Label_557; // 0x21c Jump
	
Label_557:
	var_199_object = 0; // 0x22d SetNull
	goto Label_563; // 0x22e Jump
	
Label_563:
	var_194_object = 0; // 0x233 SetNull
	
Label_541:
	var_222_int = 0; // 0x21d PushI
	KillTimer(var_222_int); // 0x21e Func
	var_223_float = 0.5; // 0x220 PushF
	Sleep(var_223_float, var_192_bool); // 0x221 Func
	var_224_bool = var_192_bool == 0; // 0x223 Not
	if(var_224_bool == 0) goto Label_553; // 0x224 JumpB
	var_225_bool = var_0_bool; // 0x225 PushT
	if(var_225_bool == 0) goto Label_553; // 0x226 JumpB
	var_194_object = 0; // 0x227 SetNull
	goto Label_565; // 0x228 Jump
	
Label_553:
	var_226_int = 0; // 0x229 PushI
	var_227_float = 0.3; // 0x22a PushF
	SetTimer(var_226_int, var_227_float); // 0x22b Func
	
Label_559:
	var_228_int = 0; // 0x22f PushI
	KillTimer(var_228_int); // 0x230 Func
...
func_1239(var_45_object)
{
	var_46_object = Obj(); // 0x4d8 PushV
	var_46_object = var_45_object; // 0x4d9 Mov
	TaskCall(3); // 0x4da TaskCall
	func_228(var_45_object, var_47_object, var_46_object); // 0x4db NEW_2
	TaskReturn(); // 0x4dc TaskReturn
	ResetAAS(); // 0x4de Func
...
func_603(var_218_string)
{
	var_218_string = "walk"; // 0x25b MovS
...
func_605(var_219_string)
{
	var_219_string = "run"; // 0x25d MovS
...
func_1249()
{
	TaskCall(2); // 0x4e3 TaskCall
	func_179(); // 0x4e4 NEW_2
	TaskReturn(); // 0x4e5 TaskReturn
...
func_228(var_0_bool, var_46_object, var_167_bool)
{
...
Label_236:
	...
	func_1207(var_67_bool, var_68_object); // 0xee NEW_2
...
Label_277:
	...
	func_1320(var_97_object); // 0x122 NEW_2
	
Label_292:
	var_65_object = 0; // 0x124 SetNull
	
Label_293:
	var_160_bool = 0; // 0x125 PushB
	SetAttackState(var_160_bool); // 0x126 Func
	var_161_string = "all"; // 0x128 PushS
	var_162_string = "attack_end"; // 0x129 PushS
	PlayAnimation(var_161_string, var_162_string); // 0x12a Func
	WaitForAnimEnd(var_59_bool); // 0x12c Func
	var_163_bool = var_59_bool == 0; // 0x12e Not
	if(var_163_bool == 0) goto Label_305; // 0x12f JumpB
...
Label_306:
	...
	var_164_bool = 0; var_165_object = Obj(); var_166_float = 0; // 0x134 PushV
	var_165_object = var_0_bool; // 0x135 MovT
	var_166_float = var_58_float; // 0x136 Mov
	TaskCall(4); // 0x137 TaskCall
	func_370(var_164_bool, var_165_object, var_166_float); // 0x138 NEW_2
	TaskReturn(); // 0x139 TaskReturn
	var_230_bool = var_167_bool == 0; // 0x13b Not
	if(var_230_bool == 0) goto Label_318; // 0x13c JumpB
...
func_1256(var_11_bool, var_12_object, var_13_string)
{
	var_14_float = 0; var_15_bool = 0; var_16_float = 0; var_17_bool = 0; // 0x4e8 PushV
	var_18_string = "health"; // 0x4e9 PushS
	var_19_bool = var_13_string == var_18_string; // 0x4ea Eq
	if(var_19_bool == 0) goto Label_1281; // 0x4eb JumpB
	var_20_string = "health"; // 0x4ec PushS
	GetProperty(var_20_string, var_16_float); // 0x4ed Func
	var_21_float = GlobalVars[0]; // 0x4ef PushGE
	var_17_bool = var_16_float < var_21_float; // 0x4f0 LT2
	var_22_float = GlobalVars[0]; // 0x4f1 PushGE
	var_22_float = var_16_float; // 0x4f2 Mov
	GlobalVars[0] = var_22_float; // 0x4f3 PopGE
	var_23_bool = 0; // 0x4f4 PushV
	var_23_bool = 0; // 0x4f5 MovB
	var_24_bool = var_17_bool; // 0x4f6 Push
	if(var_24_bool == 0) goto Label_1278; // 0x4f7 JumpB
	var_25_bool = 0; var_26_object = Obj(); // 0x4f8 PushV
	var_26_object = var_12_object; // 0x4f9 Mov
	func_1032(var_25_bool, var_26_object); // 0x4fa NEW_2
	if(var_25_bool == 0) goto Label_1278; // 0x4fc JumpB
	var_23_bool = 1; // 0x4fd MovB
	
Label_1278:
	if(var_23_bool == 0) goto Label_1281; // 0x4fe JumpB
	var_11_bool = 1; // 0x4ff MovB
	return 4; // 0x500 Return
	
Label_1281:
	var_11_bool = 0; // 0x501 MovB
...
func_370(var_164_bool, var_165_object, var_166_float)
{
	var_169_bool = 0; var_170_bool = 0; // 0x172 PushV
	func_389(); // 0x174 NEW_2
	var_177_bool = 0; var_178_object = Obj(); var_179_float = 0; var_180_float = 0; var_181_bool = 0; var_182_bool = 0; // 0x176 PushV
	var_178_object = var_165_object; // 0x177 Mov
	var_183_float = 0.9; // 0x178 PushF
	var_179_float = var_166_float * var_183_float; // 0x179 Mult2
	var_180_float = 5000; // 0x17a MovI
	var_181_bool = 1; // 0x17b MovB
	var_182_bool = 1; // 0x17c MovB
	func_465(var_169_bool, var_170_bool, var_177_bool, var_178_object, var_179_float, var_180_float, var_181_bool, var_182_bool); // 0x17d NEW_2
	var_170_bool = var_177_bool; // 0x17e Mov
	func_399(); // 0x181 NEW_2
	var_164_bool = var_170_bool; // 0x183 Mov
