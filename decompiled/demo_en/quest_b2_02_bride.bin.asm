...
0x2fe: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2ff: Pop(0)
0x300: Push(Stack[-3])
0x301: IF (Stack[-1] == 0) GOTO 0x308; Pop(1)

0x302: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x303: Pop(0)
0x304: Push((bool) 0)
0x305: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x306: Pop(1)
0x307: GOTO 0x30c

0x308: Push("Can't find lsh animation : ")
0x309: Pop(1); Push(Stack[-1] + Stack[-8]);
0x30a: @ Trace(Stack[-1])
0x30b: Pop(1)
0x30c: Return(); Pop(6)

0x30d: PushEmpty(bool, float, float, bool, float, float)
0x30e: @ lshHasAnimation(Stack[-3], Stack[-8])
0x30f: Pop(0)
0x310: Push(Stack[-3])
0x311: IF (Stack[-1] == 0) GOTO 0x317; Pop(1)

0x312: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x313: Pop(0)
0x314: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x315: Pop(0)
0x316: GOTO 0x31b

0x317: Push("Can't find lsh animation : ")
0x318: Pop(1); Push(Stack[-1] + Stack[-9]);
0x319: @ Trace(Stack[-1])
0x31a: Pop(1)
0x31b: Return(); Pop(6)

0x31c: PushEmpty(float, cvector, float, cvector)
0x31d: @@ GetEyesHeight(Stack[-2])
0x31e: Pop(0)
0x31f: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x320: Push(CvectorIndex(Stack[-1], 1))
0x321: Stack[-1] = Stack[-3]
0x322: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x323: Push("head")
0x324: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x325: Pop(1)
0x326: Return(); Pop(4)
...
0x32f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x330: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x331: Push((float)0.0)
0x332: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x333: IF (Stack[-1] == 0) GOTO 0x336; Pop(1)

0x334: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x335: Return(); Pop(2)

0x336: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x337: Return(); Pop(2)

0x338: PushEmpty(int, int)
0x339: @ GetVariable(Stack[-3], Stack[-1])
0x33a: Pop(0)
0x33b: Stack[-4] = Stack[-1]
0x33c: Return(); Pop(2)

0x33d: PushEmpty(object, object)
0x33e: @ CreateIntVector(Stack[-1])
0x33f: Pop(0)
0x340: @@ add(Stack[-4])
0x341: Pop(0)
0x342: @@ add(Stack[-3])
0x343: Pop(0)
0x344: Push((int) 3)
0x345: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x346: Pop(1)
0x347: Return(); Pop(2)

0x348: Stack[-1] = 0
0x349: PushEmpty(int, int, bool, int, int, bool)
0x34a: @@ GetItemID(Stack[-3])
0x34b: Pop(0)
0x34c: Push("Category")
0x34d: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x34e: Pop(1)
0x34f: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x350: Pop(0)
0x351: Pop(0); Push((bool) Stack[-1] == 0)
0x352: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x353: @@ DropItems(Stack[-8], Stack[-7])
0x354: Pop(0)
0x355: GOTO 0x35b

0x356: PushEmpty(int, int)
0x357: Stack[-2] = Stack[-5]
0x358: Stack[-1] = Stack[-9]
0x359: Call2 0x33d
...
0x35d: @ CreateInvItem(Stack[-1])
0x35e: Pop(0)
0x35f: @@ SetItemName(Stack[-4])
0x360: Pop(0)
0x361: PushEmpty(object, object, int)
0x362: Stack[-3] = Stack[-8]
0x363: Stack[-2] = Stack[-4]
0x364: Stack[-1] = Stack[-6]
0x365: Call2 0x349
...
0x36a: @ FindActor(Stack[-1], Stack[-4])
0x36b: Pop(0)
0x36c: Pop(0); Push((bool) Stack[-1] == 0)
0x36d: IF (Stack[-1] == 0) GOTO 0x370; Pop(1)

0x36e: Stack[-5] = (bool) 0
0x36f: Return(); Pop(2)

0x370: @ Trigger(Stack[-1], Stack[-3])
0x371: Pop(0)
0x372: Stack[-5] = (bool) 1
0x373: Return(); Pop(2)
...
0x38d: Stack[-1] = (int) 515596
0x38e: Return(); Pop(0)

0x38f: Stack[-1] = (int) 514839
0x390: Return(); Pop(0)

0x391: Stack[-1] = "ui/NPC_Citizen3.png"
0x392: Return(); Pop(0)

0x393: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x394: Return(); Pop(0)
...
0x3a0: Pop(0)
0x3a1: PushEmpty(bool, string, string)
0x3a2: Stack[-2] = "quest_b2_02"
0x3a3: Stack[-1] = "fail"
0x3a4: Call2 0x369
...
0x3ae: Pop(0)
0x3af: PushEmpty(bool, string, string)
0x3b0: Stack[-2] = "quest_b2_02"
0x3b1: Stack[-1] = "move_bride"
0x3b2: Call2 0x369
...
0x3b5: PushEmpty()
0x3b6: Push("white plet 3 is given")
0x3b7: @ Trace(Stack[-1])
0x3b8: Pop(1)
0x3b9: PushEmpty(object, string, int)
0x3ba: Stack[-3] = Stack[-5]
0x3bb: Stack[-2] = "grass_white_plet"
0x3bc: Stack[-1] = (int) 3
0x3bd: Call2 0x35c
...
0x3c0: PushEmpty()
0x3c1: Push("savyur 3 is given")
0x3c2: @ Trace(Stack[-1])
0x3c3: Pop(1)
0x3c4: PushEmpty(object, string, int)
0x3c5: Stack[-3] = Stack[-5]
0x3c6: Stack[-2] = "grass_savyur"
0x3c7: Stack[-1] = (int) 3
0x3c8: Call2 0x35c
...
0x3cb: PushEmpty()
0x3cc: Push("playsound")
0x3cd: Push("giveitem")
0x3ce: @ TriggerWorld(Stack[-2], Stack[-1])
0x3cf: Pop(2)
0x3d0: Return(); Pop(0)
...
0x403: Stack[-1] = "oob2TravnikWife1"
0x404: Call2 0x338
...
0x428: @ GetDiaryRoot(Stack[-1])
0x429: Pop(0)
0x42a: Pop(0); Push((bool) Stack[-1] == 0)
0x42b: IF (Stack[-1] == 0) GOTO 0x431; Pop(1)

0x42c: Push("Can't retrieve diary root")
0x42d: @ Trace(Stack[-1])
0x42e: Pop(1)
0x42f: Stack[-3] = (bool) 0
0x430: Return(); Pop(2)
...
0x433: Stack[-1] = 0
0x434: PushEmpty(object, object, int, object, object, int)
0x435: PushEmpty(object)
0x436: Call2 0x427

0x437: Stack[-4] = Stack[-1]
0x438: Pop(1)
0x439: @@ Find(Stack[-7], Stack[-2])
0x43a: Pop(0)
0x43b: Pop(0); Push((bool) Stack[-2] == 0)
0x43c: IF (Stack[-1] == 0) GOTO 0x443; Pop(1)

0x43d: Push("Can't find diary parent with id: ")
0x43e: Pop(1); Push(Stack[-1] + Stack[-8]);
0x43f: @ Trace(Stack[-1])
0x440: Pop(1)
0x441: Stack[-9] = (bool) 0
0x442: Return(); Pop(6)

0x443: @@ AddChild(Stack[-8])
0x444: Pop(0)
0x445: Push((int) 7)
0x446: @ SendWorldWndMessage(Stack[-1])
0x447: Pop(1)
0x448: @@ GetCategory(Stack[-1])
0x449: Pop(0)
0x44a: @ SetDiarySection(Stack[-1])
0x44b: Pop(0)
...
0x451: Push("branch")
0x452: @ GetVariable(Stack[-1], Stack[-2])
0x453: Pop(1)
0x454: Push((int) 0)
