...
0x347: PushEmpty(bool, float, float, bool, float, float)
0x348: @ lshHasAnimation(Stack[-3], Stack[-7])
0x349: Pop(0)
0x34a: Push(Stack[-3])
0x34b: IF (Stack[-1] == 0) GOTO 0x352; Pop(1)

0x34c: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x34d: Pop(0)
0x34e: Push((bool) 0)
0x34f: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x350: Pop(1)
0x351: GOTO 0x356
...
0x358: @ lshHasAnimation(Stack[-3], Stack[-8])
0x359: Pop(0)
0x35a: Push(Stack[-3])
0x35b: IF (Stack[-1] == 0) GOTO 0x361; Pop(1)

0x35c: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x35d: Pop(0)
0x35e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x35f: Pop(0)
0x360: GOTO 0x365

0x361: Push("Can't find lsh animation : ")
0x362: Pop(1); Push(Stack[-1] + Stack[-9]);
0x363: @ Trace(Stack[-1])
0x364: Pop(1)
0x365: Return(); Pop(6)

0x366: PushEmpty(float, cvector, float, cvector)
0x367: @@ GetEyesHeight(Stack[-2])
0x368: Pop(0)
0x369: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x36a: Push(CvectorIndex(Stack[-1], 1))
0x36b: Stack[-1] = Stack[-3]
0x36c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x36d: Push("head")
0x36e: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x36f: Pop(1)
0x370: Return(); Pop(4)
...
0x38d: Pop(0)
0x38e: Push((int) 3)
0x38f: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x390: Pop(1)
0x391: Return(); Pop(2)

0x392: Stack[-1] = 0
0x393: PushEmpty(int, int, bool, int, int, bool)
0x394: @@ GetItemID(Stack[-3])
0x395: Pop(0)
0x396: Push("Category")
0x397: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x398: Pop(1)
0x399: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x39a: Pop(0)
0x39b: Pop(0); Push((bool) Stack[-1] == 0)
0x39c: IF (Stack[-1] == 0) GOTO 0x3a0; Pop(1)

0x39d: @@ DropItems(Stack[-8], Stack[-7])
0x39e: Pop(0)
0x39f: GOTO 0x3a5

0x3a0: PushEmpty(int, int)
0x3a1: Stack[-2] = Stack[-5]
0x3a2: Stack[-1] = Stack[-9]
0x3a3: Call2 0x387
...
0x3a7: @ CreateInvItem(Stack[-1])
0x3a8: Pop(0)
0x3a9: @@ SetItemName(Stack[-4])
0x3aa: Pop(0)
0x3ab: PushEmpty(object, object, int)
0x3ac: Stack[-3] = Stack[-8]
0x3ad: Stack[-2] = Stack[-4]
0x3ae: Stack[-1] = Stack[-6]
0x3af: Call2 0x393
...
0x3b8: Stack[-5] = (bool) 0
0x3b9: Return(); Pop(2)

0x3ba: @ Trigger(Stack[-1], Stack[-3])
0x3bb: Pop(0)
0x3bc: Stack[-5] = (bool) 1
0x3bd: Return(); Pop(2)

0x3be: Stack[-1] = 0
0x3bf: PushEmpty(string, string)
0x3c0: Stack[-1] = "idle"
0x3c1: Push(Stack[-3])
0x3c2: IF (Stack[-1] == 0) GOTO 0x3c4; Pop(1)

0x3c3: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3c4: Stack[-4] = Stack[-1]
0x3c5: Return(); Pop(2)

0x3c6: PushEmpty(int, bool, int, bool)
0x3c7: Stack[-2] = (int) 0
0x3c8: Push("all")
...
0x3cc: Pop(1)
0x3cd: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3ce: Pop(2)
...
0x3d2: Push((int) 1)
0x3d3: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x3d4: GOTO 0x3c8

0x3d5: Stack[-5] = Stack[-2]
0x3d6: Return(); Pop(4)

0x3d7: Stack[-1] = (int) 521048
0x3d8: Return(); Pop(0)

0x3d9: Stack[-1] = (int) 521047
0x3da: Return(); Pop(0)

0x3db: Stack[-1] = "ui/NPC_Citizen2.png"
0x3dc: Return(); Pop(0)

0x3dd: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x3de: Return(); Pop(0)
...
0x3f8: Stack[-2] = "quest_b2_02"
0x3f9: Stack[-1] = "completed"
0x3fa: Call2 0x3b3
...
0x3fd: PushEmpty()
0x3fe: Push("oob2Gatherer2")
0x3ff: Push((int) 1)
0x400: @ SetVariable(Stack[-2], Stack[-1])
0x401: Pop(2)
0x402: Return(); Pop(0)

0x403: PushEmpty()
0x404: Push("playsound")
0x405: Push("giveitem")
0x406: @ TriggerWorld(Stack[-2], Stack[-1])
0x407: Pop(2)
0x408: Return(); Pop(0)

0x409: PushEmpty()
0x40a: Push("recipe9 is given")
0x40b: @ Trace(Stack[-1])
0x40c: Pop(1)
0x40d: PushEmpty(object, string, int)
0x40e: Stack[-3] = Stack[-5]
0x40f: Stack[-2] = "recipe9"
0x410: Stack[-1] = (int) 1
0x411: Call2 0x3a6
...
0x4a1: Push("branch")
0x4a2: @ GetVariable(Stack[-1], Stack[-2])
0x4a3: Pop(1)
0x4a4: Push((int) 0)
0x4a5: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x4a6: IF (Stack[-1] == 0) GOTO 0x4aa; Pop(1)
