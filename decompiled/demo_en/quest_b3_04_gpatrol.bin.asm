...
Events:
EVENT_22 Op = 0x6d1 Vars = (object, int, float, float)
EVENT_43 Op = 0x6d9 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x6e3 Vars = (object, string)
EVENT_41 Op = 0x6f0 Vars = (object)
...
0x688: Pop(0)
0x689: @@ SetItemName(Stack[-7])
0x68a: Pop(0)
0x68b: Push("Organ")
0x68c: Push((int) 1)
0x68d: @@ SetProperty(Stack[-2], Stack[-1])
0x68e: Pop(2)
0x68f: @@ GetItemID(Stack[-2])
0x690: Pop(0)
0x691: Push((int) 0)
0x692: Push((int) 1)
...
0x6b4: Pop(0)
0x6b5: @@ RemoveStationaryActor(Stack[-1])
0x6b6: Pop(1)
0x6b7: Return(); Pop(2)

0x6b8: Stack[-1] = 0
0x6b9: PushEmpty(bool, bool)
0x6ba: Push("revolver_ammo")
0x6bb: Push((int) 0)
0x6bc: Push((int) 2)
0x6bd: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6be: Pop(3)
0x6bf: Push("alpha_pills")
0x6c0: Push((int) 0)
0x6c1: Push((int) 12)
0x6c2: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6c3: Pop(3)
0x6c4: PushEmpty()
0x6c5: Call2 0x697
...
0x6cc: Push(-1, 0); TaskCall(3)
0x6cd: Call2 0x430

0x6ce: Pop(-1, 0); TaskReturn
0x6cf: Pop(1)
0x6d0: Return(); Pop(2)

0x6d1: PushEmpty()
0x6d2: PushEmpty(object, int, float)
0x6d3: Stack[-3] = Stack[-7]
0x6d4: Stack[-2] = Stack[-6]
0x6d5: Stack[-1] = Stack[-5]
0x6d6: Call2 0x59e
...
0x6d9: PushEmpty()
0x6da: PushEmpty(object, int, float, cvector, cvector)
0x6db: Stack[-5] = Stack[-11]
0x6dc: Stack[-4] = Stack[-10]
0x6dd: Stack[-3] = Stack[-9]
0x6de: Stack[-2] = Stack[-7]
0x6df: Stack[-1] = Stack[-6]
0x6e0: Call2 0x5e2

0x6e1: Pop(5)
0x6e2: Return(); Pop(0)

0x6e3: PushEmpty(float, float)
0x6e4: Push("health")
0x6e5: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6e6: IF (Stack[-1] == 0) GOTO 0x6ef; Pop(1)

0x6e7: Push("health")
0x6e8: @ GetProperty(Stack[-1], Stack[-2])
0x6e9: Pop(1)
0x6ea: Push((int) 0)
0x6eb: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x6ec: IF (Stack[-1] == 0) GOTO 0x6ef; Pop(1)

0x6ed: @ SignalDeath(Stack[-4])
0x6ee: Pop(0)
0x6ef: Return(); Pop(2)

0x6f0: PushEmpty()
0x6f1: PushEmpty(object)
0x6f2: Stack[-1] = Stack[-2]
0x6f3: Call2 0x6b9
