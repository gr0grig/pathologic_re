...
0x386: @ StopWorld()
0x387: Pop(0)
0x388: @ CameraTransit(Stack[-3], Stack[-5])
0x389: Pop(0)
0x38a: Push(CvectorIndex(Stack[-4], 0))
0x38b: Push(CvectorIndex(Stack[-5], 2))
0x38c: @ Rotate(Stack[-2], Stack[-1])
0x38d: Pop(2)
...
0x393: Push("head")
0x394: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x395: Pop(1)
0x396: Push(Stack[-1])
0x397: IF (Stack[-1] == 0) GOTO 0x39b; Pop(1)

0x398: Push("head")
0x399: @ LookAsyncCamera(Stack[-1])
0x39a: Pop(1)
0x39b: @ CameraWaitForPlayFinish()
0x39c: Pop(0)
0x39d: @ ResumeWorld()
0x39e: Pop(0)
0x39f: Stack[-21] = (bool) 1
0x3a0: Return(); Pop(18)

0x3a1: PushEmpty(bool, bool)
0x3a2: @ CameraSwitchToNormal()
0x3a3: Pop(0)
...
0x3a9: Push("head")
0x3aa: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3ab: Pop(1)
0x3ac: Push(Stack[-1])
0x3ad: IF (Stack[-1] == 0) GOTO 0x3b1; Pop(1)
...
0x3b2: PushEmpty(int, int, int, int)
0x3b3: Push("voice_common")
0x3b4: @ GetVariable(Stack[-1], Stack[-3])
0x3b5: Pop(1)
0x3b6: Push(Stack[-2])
0x3b7: IF (Stack[-1] == 0) GOTO 0x3d8; Pop(1)
...
0x3c4: Stack[-6] = (bool) 0
0x3c5: Return(); Pop(4)

0x3c6: Push((int) 2)
0x3c7: @ irand(Stack[-2], Stack[-1])
0x3c8: Pop(1)
0x3c9: Push(Stack[-1])
0x3ca: IF (Stack[-1] == 0) GOTO 0x3d3; Pop(1)

0x3cb: Push("voice_common")
0x3cc: Push((int) 1)
...
0x3d4: Push((int) 0)
0x3d5: @ SetVariable(Stack[-2], Stack[-1])
0x3d6: Pop(2)
0x3d7: GOTO 0x3ea
...
0x3e6: Push("voice_common")
0x3e7: Push((int) 1)
0x3e8: @ SetVariable(Stack[-2], Stack[-1])
0x3e9: Pop(2)
0x3ea: Stack[-6] = (bool) 1
0x3eb: Return(); Pop(4)
...
0x3ee: Stack[-4] = (int) 0
0x3ef: Push((int) 1)
0x3f0: IF (Stack[-1] == 0) GOTO 0x3fc; Pop(1)

0x3f1: Push((int) 1)
0x3f2: Pop(1); Push(Stack[-5] + Stack[-1]);
0x3f3: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3f4: @@ HasProperty(Stack[-1], Stack[-4])
0x3f5: Pop(1)
...
0x3f9: Push((int) 1)
0x3fa: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3fb: GOTO 0x3ef

0x3fc: Pop(0); Push((bool) Stack[-4] == 0)
0x3fd: IF (Stack[-1] == 0) GOTO 0x400; Pop(1)

0x3fe: Stack[-12] = (bool) 0
0x3ff: Return(); Pop(10)

0x400: Stack[-2] = (int) 0
0x401: Push((int) 1)
0x402: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x403: IF (Stack[-1] == 0) GOTO 0x406; Pop(1)

0x404: @ irand(Stack[-2], Stack[-4])
0x405: Pop(0)
0x406: Push((int) 1)
0x407: Pop(1); Push(Stack[-3] + Stack[-1]);
0x408: Pop(1); Push(Stack[-6] + Stack[-1]);
0x409: @@ GetProperty(Stack[-1], Stack[-2])
0x40a: Pop(1)
0x40b: PushEmpty(bool, string)
0x40c: Stack[-1] = Stack[-3]
0x40d: Call2 0x45b

0x40e: Stack[-14] = Stack[-2]
0x40f: Pop(2)
0x410: Return(); Pop(10)

0x411: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x412: Push("d")
0x413: PushEmpty(int)
0x414: Call2 0x486
...
0x417: Push("m")
0x418: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x419: Stack[-4] = (int) 0
0x41a: Push((int) 1)
0x41b: IF (Stack[-1] == 0) GOTO 0x427; Pop(1)

0x41c: Push((int) 1)
0x41d: Pop(1); Push(Stack[-5] + Stack[-1]);
0x41e: Pop(1); Push(Stack[-6] + Stack[-1]);
0x41f: @@ HasProperty(Stack[-1], Stack[-4])
0x420: Pop(1)
...
0x424: Push((int) 1)
0x425: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x426: GOTO 0x41a

0x427: Pop(0); Push((bool) Stack[-4] == 0)
0x428: IF (Stack[-1] == 0) GOTO 0x42b; Pop(1)

0x429: Stack[-12] = (bool) 0
0x42a: Return(); Pop(10)
...
0x42f: @ irand(Stack[-2], Stack[-4])
0x430: Pop(0)
0x431: Push((int) 1)
0x432: Pop(1); Push(Stack[-3] + Stack[-1]);
0x433: Pop(1); Push(Stack[-6] + Stack[-1]);
0x434: @@ GetProperty(Stack[-1], Stack[-2])
0x435: Pop(1)
0x436: PushEmpty(bool, string)
0x437: Stack[-1] = Stack[-3]
0x438: Call2 0x45b

0x439: Stack[-14] = Stack[-2]
0x43a: Pop(2)
0x43b: Return(); Pop(10)

0x43c: PushEmpty(bool, float, float, bool, float, float)
0x43d: @ lshHasAnimation(Stack[-3], Stack[-7])
0x43e: Pop(0)
0x43f: Push(Stack[-3])
0x440: IF (Stack[-1] == 0) GOTO 0x447; Pop(1)

0x441: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x442: Pop(0)
0x443: Push((bool) 0)
0x444: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x445: Pop(1)
0x446: GOTO 0x44b

0x447: Push("Can't find lsh animation : ")
0x448: Pop(1); Push(Stack[-1] + Stack[-8]);
0x449: @ Trace(Stack[-1])
0x44a: Pop(1)
0x44b: Return(); Pop(6)

0x44c: PushEmpty(bool, float, float, bool, float, float)
0x44d: @ lshHasAnimation(Stack[-3], Stack[-8])
0x44e: Pop(0)
0x44f: Push(Stack[-3])
0x450: IF (Stack[-1] == 0) GOTO 0x456; Pop(1)

0x451: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x452: Pop(0)
0x453: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x454: Pop(0)
0x455: GOTO 0x45a

0x456: Push("Can't find lsh animation : ")
0x457: Pop(1); Push(Stack[-1] + Stack[-9]);
0x458: @ Trace(Stack[-1])
0x459: Pop(1)
0x45a: Return(); Pop(6)
...
0x460: @ lshHasSpeech(Stack[-1], Stack[-3])
0x461: Pop(0)
0x462: Push(Stack[-1])
0x463: IF (Stack[-1] == 0) GOTO 0x468; Pop(1)

0x464: @ lshPlaySpeech(Stack[-3])
0x465: Pop(0)
0x466: Stack[-4] = (bool) 1
0x467: Return(); Pop(2)

0x468: Stack[-4] = (bool) 0
0x469: Return(); Pop(2)
...
0x478: Pop(0); Push(Stack[-3] | Stack[-3]);
0x479: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x47a: Push((float)0.0)
0x47b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x47c: IF (Stack[-1] == 0) GOTO 0x47f; Pop(1)

0x47d: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x47e: Return(); Pop(2)

0x47f: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x480: Return(); Pop(2)

0x481: PushEmpty(int, int)
0x482: @ GetVariable(Stack[-3], Stack[-1])
0x483: Pop(0)
0x484: Stack[-4] = Stack[-1]
0x485: Return(); Pop(2)

0x486: PushEmpty(float, float)
0x487: @ GetGameTime(Stack[-1])
0x488: Pop(0)
0x489: Push((int) 1)
0x48a: PushEmpty(int)
0x48b: Push((int) 24)
0x48c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x48d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x48e: Return(); Pop(2)

0x48f: Stack[-1] = (int) 515551
0x490: Return(); Pop(0)

0x491: Stack[-1] = (int) 502876
0x492: Return(); Pop(0)

0x493: Stack[-1] = "ui/NPC_Rubin.png"
0x494: Return(); Pop(0)

0x495: Stack[-1] = "ui/NPC_Rubin_b.png"
0x496: Return(); Pop(0)

0x497: Stack[-1] = (bool) 1
0x498: Return(); Pop(0)

0x499: PushEmpty(string, string)
0x49a: Stack[-1] = "idle"
0x49b: Push(Stack[-3])
0x49c: IF (Stack[-1] == 0) GOTO 0x49e; Pop(1)

0x49d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x49e: Stack[-4] = Stack[-1]
0x49f: Return(); Pop(2)

0x4a0: PushEmpty(int, bool, int, bool)
0x4a1: Stack[-2] = (int) 0
0x4a2: Push("all")
0x4a3: PushEmpty(string, int)
0x4a4: Stack[-1] = Stack[-5]
0x4a5: Call2 0x499

0x4a6: Pop(1)
0x4a7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x4a8: Pop(2)
0x4a9: Pop(0); Push((bool) Stack[-1] == 0)
...
0x4af: Stack[-5] = Stack[-2]
0x4b0: Return(); Pop(4)

0x4b1: PushEmpty()
0x4b2: Push("oob4Rubin1")
0x4b3: Push((int) 1)
...
0x4c0: PushEmpty()
0x4c1: Push("oob4Rubin2")
0x4c2: Push((int) 1)
0x4c3: @ SetVariable(Stack[-2], Stack[-1])
0x4c4: Pop(2)
0x4c5: Return(); Pop(0)

0x4c6: PushEmpty()
0x4c7: PushEmpty(int, string)
0x4c8: Stack[-1] = "oob4Rubin1"
0x4c9: Call2 0x481
...
0x4d2: PushEmpty()
0x4d3: PushEmpty(int, string)
0x4d4: Stack[-1] = "oob4Rubin2"
0x4d5: Call2 0x481

0x4d6: Pop(1)
0x4d7: Push((int) 0)
0x4d8: Pop(2); Push((bool) Stack[-2] == Stack[-1])
...
0x4f0: Push("Can't retrieve diary root")
0x4f1: @ Trace(Stack[-1])
0x4f2: Pop(1)
...
0x4fb: Stack[-4] = Stack[-1]
0x4fc: Pop(1)
0x4fd: @@ Find(Stack[-7], Stack[-2])
0x4fe: Pop(0)
0x4ff: Pop(0); Push((bool) Stack[-2] == 0)
0x500: IF (Stack[-1] == 0) GOTO 0x507; Pop(1)

0x501: Push("Can't find diary parent with id: ")
...
0x507: @@ AddChild(Stack[-8])
0x508: Pop(0)
0x509: Push((int) 7)
0x50a: @ SendWorldWndMessage(Stack[-1])
0x50b: Pop(1)
0x50c: @@ GetCategory(Stack[-1])
0x50d: Pop(0)
...
0x512: Stack[-2] = 0
0x513: Stack[-3] = 0
0x514: PushEmpty(int, int)
0x515: Push("branch")
0x516: @ GetVariable(Stack[-1], Stack[-2])
0x517: Pop(1)
0x518: Push((int) 0)
