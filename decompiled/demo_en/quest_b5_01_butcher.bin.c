...
Label_255:
	...
	func_2492(var_45_object); // 0x106 NEW_2
	...
	func_2504(var_54_object); // 0x10c NEW_2
...
Label_303:
	...
	func_2492(var_91_object); // 0x131 NEW_2
...
Label_329:
	...
	func_2492(var_102_object); // 0x14b NEW_2
...
Label_582:
	...
	func_2584(var_206_bool); // 0x248 NEW_2
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_2447(var_20_bool, var_21_string, var_22_string); // 0x26c NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	func_2339(var_36_object); // 0x2b2 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool, var_19_int)
{
	...
	func_2459(var_22_object); // 0x60c NEW_2
...
Label_1577:
	...
	func_2339(var_23_object); // 0x62d NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_int, var_12_int, var_13_bool, var_14_float, var_15_int, var_16_bool, var_17_object, var_18_bool, var_19_object)
{
	...
	func_2539(var_23_object); // 0x6eb NEW_2
...
{
	var_23_object = Obj(); var_24_int = 0; var_25_float = 0; // 0xa2b PushV
	var_23_object = var_19_object; // 0xa2c Mov
	var_24_int = var_20_int; // 0xa2d Mov
	var_25_float = var_21_float; // 0xa2e Mov
	func_2125(var_23_object, var_24_int, var_25_float); // 0xa2f NEW_2
...
{
	var_25_object = Obj(); var_26_int = 0; var_27_float = 0; var_28_cvector = CVector(0,0,0); var_29_cvector = CVector(0,0,0); // 0xa33 PushV
	var_25_object = var_19_object; // 0xa34 Mov
	var_26_int = var_20_int; // 0xa35 Mov
	var_27_float = var_21_float; // 0xa36 Mov
	var_28_cvector = var_23_cvector; // 0xa37 Mov
	var_29_cvector = var_24_cvector; // 0xa38 Mov
	func_2193(var_27_float, var_28_cvector, var_29_cvector); // 0xa39 NEW_2
...
{
	var_21_float = 0; var_22_float = 0; // 0xa3c PushV
	var_23_string = "health"; // 0xa3d PushS
	var_24_bool = var_20_string == var_23_string; // 0xa3e Eq
	if(var_24_bool == 0) goto Label_2632; // 0xa3f JumpB
	var_25_string = "health"; // 0xa40 PushS
	GetProperty(var_25_string, var_22_float); // 0xa41 Func
	var_26_int = 0; // 0xa43 PushI
	var_27_bool = var_22_float <= var_26_int; // 0xa44 LE
	if(var_27_bool == 0) goto Label_2632; // 0xa45 JumpB
	SignalDeath(var_19_object); // 0xa46 Func
...
{
	var_20_object = Obj(); // 0xa4a PushV
	var_20_object = var_19_object; // 0xa4b Mov
	func_2586(var_20_object); // 0xa4c NEW_2
...
func_0(var_0_object, var_23_int, var_24_object)
{
	...
	var_80_bool = var_34_bool == 0; // 0x7 Not
	if(var_80_bool == 0) goto Label_11; // 0x8 JumpB
	var_23_int = -2; // 0x9 MovI
	return 8; // 0xa Return
	
Label_11:
	CreateDialog(var_30_object); // 0xb Func
	var_81_int = 0; // 0xd PushV
	func_2578(var_81_int); // 0xe NEW_2
	SetNPCName(var_81_int); // 0x10 ObjFunc
	var_82_int = 0; // 0x12 PushV
	func_2576(var_82_int); // 0x13 NEW_2
	SetNPCDescription(var_82_int); // 0x15 ObjFunc
	var_83_string = ""; // 0x17 PushV
	func_2580(var_83_string); // 0x18 NEW_2
	SetPhoto(var_83_string); // 0x1a ObjFunc
	var_84_string = ""; // 0x1c PushV
	func_2582(var_84_string); // 0x1d NEW_2
	SetPhoto2(var_84_string); // 0x1f ObjFunc
	var_85_int = 0; // 0x21 PushV
	func_2516(var_85_int); // 0x22 NEW_2
	SetPlayerName(var_85_int); // 0x24 ObjFunc
	var_32_int = -1; // 0x26 MovI
	IsOverrideActive(var_31_bool); // 0x27 Func
	var_93_bool = var_31_bool; // 0x29 Push
	if(var_93_bool == 0) goto Label_45; // 0x2a JumpB
	var_23_int = -2; // 0x2b MovI
	return 8; // 0x2c Return
	
Label_45:
	DoDialog(var_30_object); // 0x2d Func
	var_94_object = Obj(); var_95_object = Obj(); // 0x2f PushV
	var_94_object = var_24_object; // 0x30 Mov
	var_95_object = var_30_object; // 0x31 Mov
	TaskCall(1); // 0x32 TaskCall
	func_74(var_96_object, var_97_object, var_98_string, var_99_bool, var_94_object, var_95_object); // 0x33 NEW_2
	TaskReturn(); // 0x34 TaskReturn
	IsDialogEnd(var_33_bool); // 0x36 ObjFunc
	
Label_56:
	var_184_bool = var_33_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_185_object = var_24_object; // 0x40 Mov
	func_2291(); // 0x41 NEW_2
...
func_2308(var_150_string)
{
	var_151_bool = 0; var_152_float = 0; var_153_float = 0; var_154_bool = 0; var_155_float = 0; var_156_float = 0; // 0x904 PushV
	lshHasAnimation(var_154_bool, var_150_string); // 0x905 Func
	var_157_bool = var_154_bool; // 0x907 Push
	if(var_157_bool == 0) goto Label_2319; // 0x908 JumpB
	lshGetAnimTimes(var_150_string, var_155_float, var_156_float); // 0x909 Func
	var_158_bool = 0; // 0x90b PushB
	lshPlayAnimation(var_155_float, var_156_float, var_158_bool); // 0x90c Func
	goto Label_2323; // 0x90e Jump
	
Label_2323:
	return 6; // 0x913 Return
	
Label_2319:
	var_159_string = "Can't find lsh animation : "; // 0x90f PushS
	var_160_int = var_159_string + var_150_string; // 0x910 Add
	Trace(var_160_int); // 0x911 Func
}
...
func_2576(var_82_int)
{
	var_82_int = 515562; // 0xa10 MovI
	return 0; // 0xa11 Return
}


func_2578(var_81_int)
{
	var_81_int = 503347; // 0xa12 MovI
...
func_2580(var_83_string)
{
	var_83_string = "ui/NPC_Citizen1.png"; // 0xa14 MovS
...
func_2582(var_84_string)
{
	var_84_string = "ui/NPC_Citizen1_b.png"; // 0xa16 MovS
	return 0; // 0xa17 Return
}


func_2324(var_125_string, var_126_bool)
{
	var_129_bool = 0; var_130_float = 0; var_131_float = 0; var_132_bool = 0; var_133_float = 0; var_134_float = 0; // 0x914 PushV
	lshHasAnimation(var_132_bool, var_125_string); // 0x915 Func
	var_135_bool = var_132_bool; // 0x917 Push
	if(var_135_bool == 0) goto Label_2334; // 0x918 JumpB
	lshGetAnimTimes(var_125_string, var_133_float, var_134_float); // 0x919 Func
	lshPlayAnimation(var_133_float, var_134_float, var_126_bool); // 0x91b Func
	goto Label_2338; // 0x91d Jump
	
Label_2338:
	return 6; // 0x922 Return
	
Label_2334:
	var_136_string = "Can't find lsh animation : "; // 0x91e PushS
	var_137_int = var_136_string + var_125_string; // 0x91f Add
	Trace(var_137_int); // 0x920 Func
}


func_2584(var_76_bool)
{
	var_76_bool = 0; // 0xa18 MovB
	return 0; // 0xa19 Return
}


func_2586(var_20_object)
{
	var_21_object = Obj(); var_22_object = Obj(); // 0xa1a PushV
	GetScene(var_22_object); // 0xa1b Func
	var_23_object = Obj(); // 0xa1d PushV
	func_2398(var_23_object); // 0xa1e NEW_2
	RemoveStationaryActor(var_23_object); // 0xa20 ObjFunc
	var_26_object = Obj(); // 0xa22 PushV
	var_26_object = var_20_object; // 0xa23 Mov
	TaskCall(5); // 0xa24 TaskCall
	func_1749(var_26_object); // 0xa25 NEW_2
	TaskReturn(); // 0xa26 TaskReturn
...
func_801()
{
	...
	func_2398(var_35_object); // 0x325 NEW_2
...
Label_812:
	...
	var_528_int = 1; // 0x332 PushI
	Sleep(var_528_int); // 0x333 Func
	goto Label_812; // 0x335 Jump
}


func_2339(var_23_object)
{
	var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_float = 0; var_27_cvector = CVector(0,0,0); // 0x923 PushV
	GetEyesHeight(var_26_float); // 0x924 ObjFunc
	var_27_cvector = CVector(0.0, 0.0, 0.0); // 0x926 MovV
	var_28_float = GetByIndex(var_27_cvector, 1); // 0x927 PushE
	var_28_float = var_26_float; // 0x928 Mov
	SetByIndex(var_27_cvector, 1) = var_28_float; // 0x929 PopE
	var_29_string = "head"; // 0x92a PushS
	LookAsync(var_23_object, var_29_string, var_27_cvector); // 0x92b Func
...
func_2350()
{
	var_22_bool = 0; // 0x92e PushV
	func_2584(var_22_bool); // 0x92f NEW_2
	if(var_22_bool == 0) goto Label_2356; // 0x931 JumpB
	lshStopSpeech(); // 0x932 Func
...
func_2357(var_50_string)
{
	var_51_bool = 0; var_52_int = 0; var_53_bool = 0; var_54_int = 0; var_55_bool = 0; var_56_float = 0; var_57_cvector = CVector(0,0,0); var_58_cvector = CVector(0,0,0); var_59_bool = 0; var_60_int = 0; var_61_bool = 0; var_62_int = 0; var_63_bool = 0; var_64_float = 0; var_65_cvector = CVector(0,0,0); var_66_cvector = CVector(0,0,0); // 0x935 PushV
	IsExisting3DSound(var_59_bool, var_50_string); // 0x936 Func
	var_67_bool = var_59_bool == 0; // 0x938 Not
	if(var_67_bool == 0) goto Label_2382; // 0x939 JumpB
	var_60_int = 0; // 0x93a MovI
	
Label_2363:
	var_68_int = 1; // 0x93b PushI
	var_69_int = var_60_int + var_68_int; // 0x93c Add
	var_70_int = var_50_string + var_69_int; // 0x93d Add
	IsExisting3DSound(var_61_bool, var_70_int); // 0x93e Func
	var_71_bool = var_61_bool == 0; // 0x940 Not
	if(var_71_bool == 0) goto Label_2371; // 0x941 JumpB
	goto Label_2374; // 0x942 Jump
	
Label_2374:
	var_72_bool = var_60_int == 0; // 0x946 Not
	if(var_72_bool == 0) goto Label_2377; // 0x947 JumpB
	return 16; // 0x948 Return
	
Label_2377:
	irand(var_62_int, var_60_int); // 0x949 Func
	var_73_int = 1; // 0x94b PushI
	var_74_int = var_62_int + var_73_int; // 0x94c Add
	var_50_string = var_50_string + var_74_int; // 0x94d Add2
	
Label_2382:
	Is3DSoundLoaded(var_63_bool, var_50_string); // 0x94e Func
	var_75_bool = var_63_bool; // 0x950 Push
	if(var_75_bool == 0) goto Label_2397; // 0x951 JumpB
	GetEyesHeight(var_64_float); // 0x952 Func
	GetDirection(var_65_cvector); // 0x954 Func
	var_76_int = 50; // 0x956 PushI
	var_66_cvector = var_65_cvector * var_76_int; // 0x957 Mult2
	var_77_float = GetByIndex(var_66_cvector, 1); // 0x958 PushE
	var_77_float = var_77_float + var_64_float; // 0x959 Add2
	SetByIndex(var_66_cvector, 1) = var_77_float; // 0x95a PopE
	PlayGlobalSound(var_50_string, var_66_cvector); // 0x95b Func
	
Label_2397:
	return 16; // 0x95d Return
	
Label_2371:
	var_78_int = 1; // 0x943 PushI
	var_60_int = var_60_int + var_78_int; // 0x944 Add2
	goto Label_2363; // 0x945 Jump
}
...
Label_850:
	...
	func_2398(var_94_object); // 0x35c NEW_2
...
Label_987:
	...
	var_512_string = "all"; // 0x3dd PushS
	var_513_string = "fjump"; // 0x3de PushS
	PlayAnimation(var_512_string, var_513_string); // 0x3df Func
	WaitForAnimEnd(); // 0x3e1 Func
	func_1473(var_63_float); // 0x3e4 NEW_2
	var_514_cvector = CVector(0.0, 0.0, 0.0); // 0x3e6 PushVec
	SetSpeed(var_514_cvector); // 0x3e7 Func
	Stop(); // 0x3e9 Func
	StopAsync(); // 0x3eb Func
	var_515_bool = 0; // 0x3ed PushV
	func_1430(var_63_float, var_515_bool); // 0x3ee NEW_2
	var_516_bool = var_515_bool == 0; // 0x3f0 Not
	if(var_516_bool == 0) goto Label_1033; // 0x3f1 JumpB
	var_517_bool = 0; var_518_object = Obj(); // 0x3f2 PushV
	var_518_object = var_0_object; // 0x3f3 MovT
	func_2057(var_517_bool, var_518_object); // 0x3f4 NEW_2
	var_519_bool = var_517_bool == 0; // 0x3f6 Not
	if(var_519_bool == 0) goto Label_1017; // 0x3f7 JumpB
...
Label_1017:
	...
	var_520_float = var_41_float * var_41_float; // 0x3ff Mult
	var_521_bool = var_60_float < var_520_float; // 0x400 LT
	if(var_521_bool == 0) goto Label_1033; // 0x401 JumpB
	var_522_bool = 0; var_523_float = 0; // 0x402 PushV
	var_523_float = var_41_float; // 0x403 Mov
	func_1134(var_63_float, var_522_bool, var_523_float); // 0x404 NEW_2
	var_524_bool = var_522_bool == 0; // 0x406 Not
	if(var_524_bool == 0) goto Label_1033; // 0x407 JumpB
	goto Label_1043; // 0x408 Jump
	
Label_1034:
	var_525_bool = 0; var_526_float = 0; // 0x40a PushV
	var_526_float = var_41_float; // 0x40b Mov
	func_1134(var_63_float, var_525_bool, var_526_float); // 0x40c NEW_2
	var_527_bool = var_525_bool == 0; // 0x40e Not
	if(var_527_bool == 0) goto Label_1041; // 0x40f JumpB
...
func_1095(var_0_object, var_395_float, var_396_int)
{
	...
	var_470_int = 0; // 0x462 PushV
	func_1478(var_470_int); // 0x463 NEW_2
	ReportHit(var_0_object, var_470_int, var_402_float, var_401_float); // 0x465 Func
	var_471_object = Obj(); var_472_float = 0; // 0x467 PushV
	var_471_object = var_400_object; // 0x468 Mov
	var_472_float = var_402_float; // 0x469 Mov
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_94_object, var_95_object)
{
	var_0_object = var_95_object; // 0x4b TMov
	var_1_object = var_94_object; // 0x4c TMov
	var_3_string = 0; // 0x4d TMovB
	var_100_int = 1; // 0x4e PushI
	if(var_100_int == 0) goto Label_173; // 0x4f JumpB
	var_101_bool = 0; // 0x50 PushV
	var_101_bool = 0; // 0x51 MovB
	var_102_bool = 0; var_103_object = Obj(); // 0x52 PushV
	var_103_object = var_1_object; // 0x53 MovT
	func_2492(var_103_object); // 0x54 NEW_2
	var_110_bool = var_102_bool == 0; // 0x56 Not
	if(var_110_bool == 0) goto Label_94; // 0x57 JumpB
	var_111_bool = 0; var_112_object = Obj(); // 0x58 PushV
	var_112_object = var_1_object; // 0x59 MovT
	func_2504(var_112_object); // 0x5a NEW_2
	if(var_111_bool == 0) goto Label_94; // 0x5c JumpB
	var_101_bool = 1; // 0x5d MovB
	
Label_94:
	if(var_101_bool == 0) goto Label_125; // 0x5e JumpB
	var_117_object = Obj(); var_118_object = Obj(); // 0x5f PushV
	var_117_object = var_1_object; // 0x60 MovT
	var_118_object = var_0_object; // 0x61 MovT
	func_2486(); // 0x62 NEW_2
	var_121_string = ""; // 0x64 PushV
	var_121_string = "Neutral"; // 0x65 MovS
	func_203(var_95_object, var_121_string); // 0x66 NEW_2
	var_138_int = 518663; // 0x68 PushI
	SetMessage(var_138_int); // 0x69 TObjFunc
	ClearReplies(); // 0x6b TObjFunc
	var_139_int = 518671; // 0x6d PushI
	var_140_int = 19764; // 0x6e PushI
	var_141_int = 19763; // 0x6f PushI
	AddReply(var_139_int, var_140_int, var_141_int); // 0x70 TObjFunc
	var_142_int = 518678; // 0x72 PushI
	var_143_int = 19781; // 0x73 PushI
	var_144_int = 19770; // 0x74 PushI
	AddReply(var_142_int, var_143_int, var_144_int); // 0x75 TObjFunc
	var_145_int = 518666; // 0x77 PushI
	var_146_int = -1; // 0x78 PushI
	var_147_int = 19758; // 0x79 PushI
	AddReply(var_145_int, var_146_int, var_147_int); // 0x7a TObjFunc
	goto Label_173; // 0x7c Jump
	
Label_173:
	var_148_bool = 0; // 0xad PushV
	func_2584(var_148_bool); // 0xae NEW_2
	if(var_148_bool == 0) goto Label_188; // 0xb0 JumpB
	
Label_177:
	lshWaitForAnimEnd(); // 0xb1 Func
	var_149_string = var_3_string; // 0xb3 PushT
	if(var_149_string == 0) goto Label_182; // 0xb4 JumpB
...
Label_182:
	var_150_string = ""; // 0xb6 PushV
	var_150_string = var_2_object; // 0xb7 MovT
	func_2308(var_150_string); // 0xb8 NEW_2
	goto Label_177; // 0xba Jump
	
Label_188:
	var_161_string = "all"; // 0xbc PushS
	var_162_string = "idle"; // 0xbd PushS
	PlayAnimation(var_161_string, var_162_string); // 0xbe Func
	
Label_192:
	WaitForAnimEnd(); // 0xc0 Func
	var_163_string = var_3_string; // 0xc2 PushT
	if(var_163_string == 0) goto Label_197; // 0xc3 JumpB
	goto Label_202; // 0xc4 Jump
	
Label_197:
	var_164_string = "all"; // 0xc5 PushS
	var_165_string = "idle"; // 0xc6 PushS
	PlayAnimation(var_164_string, var_165_string); // 0xc7 Func
	goto Label_192; // 0xc9 Jump
	
Label_125:
	var_166_bool = 0; var_167_object = Obj(); // 0x7d PushV
	var_167_object = var_1_object; // 0x7e MovT
	func_2492(var_167_object); // 0x7f NEW_2
	var_168_bool = var_166_bool == 0; // 0x81 Not
	if(var_168_bool == 0) goto Label_151; // 0x82 JumpB
	var_169_string = ""; // 0x83 PushV
	var_169_string = "Neutral"; // 0x84 MovS
	func_203(var_95_object, var_169_string); // 0x85 NEW_2
	var_170_int = 530807; // 0x87 PushI
	SetMessage(var_170_int); // 0x88 TObjFunc
	ClearReplies(); // 0x8a TObjFunc
	var_171_int = 530809; // 0x8c PushI
	var_172_int = -1; // 0x8d PushI
	var_173_int = 32121; // 0x8e PushI
	AddReply(var_171_int, var_172_int, var_173_int); // 0x8f TObjFunc
	var_174_int = 530808; // 0x91 PushI
	var_175_int = -1; // 0x92 PushI
	var_176_int = 32120; // 0x93 PushI
	AddReply(var_174_int, var_175_int, var_176_int); // 0x94 TObjFunc
	goto Label_173; // 0x96 Jump
	
Label_151:
	var_177_bool = 0; var_178_object = Obj(); // 0x97 PushV
	var_178_object = var_1_object; // 0x98 MovT
	func_2492(var_178_object); // 0x99 NEW_2
	if(var_177_bool == 0) goto Label_171; // 0x9b JumpB
	var_179_string = ""; // 0x9c PushV
	var_179_string = "Neutral"; // 0x9d MovS
	func_203(var_95_object, var_179_string); // 0x9e NEW_2
	var_180_int = 524880; // 0xa0 PushI
	SetMessage(var_180_int); // 0xa1 TObjFunc
	ClearReplies(); // 0xa3 TObjFunc
	var_181_int = 524881; // 0xa5 PushI
	var_182_int = -1; // 0xa6 PushI
	var_183_int = 26205; // 0xa7 PushI
	AddReply(var_181_int, var_182_int, var_183_int); // 0xa8 TObjFunc
...
func_1865(var_49_string)
{
	...
	func_2357(var_50_string); // 0x756 NEW_2
...
Label_2141:
	...
	func_2404(var_51_cvector, var_52_cvector); // 0x864 NEW_2
...
func_2398(var_23_object)
{
	var_24_object = Obj(); var_25_object = Obj(); // 0x95e PushV
	self(var_25_object); // 0x95f Func
	var_23_object = var_25_object; // 0x961 Mov
	return 2; // 0x962 Return
}


func_2404(var_51_cvector, var_52_cvector)
{
	var_59_float = 0; var_60_float = 0; // 0x964 PushV
	var_61_int = var_52_cvector | var_52_cvector; // 0x965 Or
	var_60_float = sqrt(var_61_int); // 0x966 Sqrt2
	var_62_float = 0.0; // 0x967 PushF
	var_63_bool = var_60_float < var_62_float; // 0x968 LT
	if(var_63_bool == 0) goto Label_2412; // 0x969 JumpB
	var_51_cvector = CVector(0.0, 0.0, 0.0); // 0x96a MovV
	return 2; // 0x96b Return
	
Label_2412:
	var_51_cvector = var_52_cvector / var_52_cvector; // 0x96c Div2
...
Label_1170:
	...
	var_473_string = "all"; // 0x497 PushS
	var_474_string = "attack_middle"; // 0x498 PushS
	var_475_int = var_474_string + var_364_int; // 0x499 Add
	HasAnimation(var_365_bool, var_473_string, var_475_int); // 0x49a Func
	var_476_bool = var_365_bool; // 0x49c Push
	if(var_476_bool == 0) goto Label_1251; // 0x49d JumpB
	func_2468(); // 0x49f NEW_2
	var_477_string = "all"; // 0x4a1 PushS
	var_478_string = "attack_middle"; // 0x4a2 PushS
	var_479_int = var_478_string + var_364_int; // 0x4a3 Add
	PlayAnimation(var_477_string, var_479_int); // 0x4a4 Func
	WaitForAnimEnd(); // 0x4a6 Func
	func_1473(var_367_string); // 0x4a9 NEW_2
	var_480_bool = 0; var_481_object = Obj(); // 0x4ab PushV
	var_481_object = var_0_object; // 0x4ac MovT
	func_2057(var_480_bool, var_481_object); // 0x4ad NEW_2
	var_482_bool = var_480_bool == 0; // 0x4af Not
	if(var_482_bool == 0) goto Label_1205; // 0x4b0 JumpB
	StopAsync(); // 0x4b1 Func
	var_358_bool = 0; // 0x4b3 MovB
	return 8; // 0x4b4 Return
	
Label_1205:
	var_483_float = 0; var_484_int = 0; // 0x4b5 PushV
	var_483_float = var_359_float; // 0x4b6 Mov
	var_484_int = var_364_int; // 0x4b7 Mov
	func_1095(var_367_string, var_483_float, var_484_int); // 0x4b8 NEW_2
	var_366_int = 1; // 0x4ba MovI
	
Label_1211:
	var_485_string = "attack_middle"; // 0x4bb PushS
	var_486_int = var_485_string + var_364_int; // 0x4bc Add
	var_487_string = "_"; // 0x4bd PushS
	var_488_int = var_486_int + var_487_string; // 0x4be Add
	var_367_string = var_488_int + var_366_int; // 0x4bf Add2
	var_489_string = "all"; // 0x4c0 PushS
	HasAnimation(var_365_bool, var_489_string, var_367_string); // 0x4c1 Func
	var_490_bool = var_365_bool == 0; // 0x4c3 Not
	if(var_490_bool == 0) goto Label_1222; // 0x4c4 JumpB
	goto Label_1251; // 0x4c5 Jump
	
Label_1251:
	var_491_bool = 0; // 0x4e3 PushB
	SetAttackState(var_491_bool); // 0x4e4 Func
	var_492_string = "all"; // 0x4e6 PushS
	var_493_string = "attack_end"; // 0x4e7 PushS
	var_494_int = var_493_string + var_364_int; // 0x4e8 Add
	PlayAnimation(var_492_string, var_494_int); // 0x4e9 Func
	var_495_bool = 0; // 0x4eb PushV
	func_1487(var_495_bool); // 0x4ec NEW_2
	if(var_495_bool == 0) goto Label_1269; // 0x4ee JumpB
	var_496_bool = 0; var_497_float = 0; // 0x4ef PushV
	var_497_float = 0.75; // 0x4f0 MovF
	func_1271(var_496_bool, var_497_float); // 0x4f1 NEW_2
...
Label_1222:
	func_2468(); // 0x4c7 NEW_2
	var_505_string = "all"; // 0x4c9 PushS
	PlayAnimation(var_505_string, var_367_string); // 0x4ca Func
	WaitForAnimEnd(); // 0x4cc Func
	func_1473(var_367_string); // 0x4cf NEW_2
	var_506_bool = 0; var_507_object = Obj(); // 0x4d1 PushV
	var_507_object = var_0_object; // 0x4d2 MovT
	func_2057(var_506_bool, var_507_object); // 0x4d3 NEW_2
	var_508_bool = var_506_bool == 0; // 0x4d5 Not
	if(var_508_bool == 0) goto Label_1243; // 0x4d6 JumpB
	StopAsync(); // 0x4d7 Func
	var_358_bool = 0; // 0x4d9 MovB
	return 8; // 0x4da Return
	
Label_1243:
	var_509_float = 0; var_510_int = 0; // 0x4db PushV
	var_509_float = var_359_float; // 0x4dc Mov
	var_510_int = var_364_int; // 0x4dd Mov
	func_1095(var_367_string, var_509_float, var_510_int); // 0x4de NEW_2
	var_511_int = 1; // 0x4e0 PushI
	var_366_int = var_366_int + var_511_int; // 0x4e1 Add2
	goto Label_1211; // 0x4e2 Jump
}


func_2414(var_447_float, var_448_float, var_449_float)
{
	var_452_bool = var_448_float < var_449_float; // 0x96f LT
	if(var_452_bool == 0) goto Label_2419; // 0x970 JumpB
	var_447_float = var_448_float; // 0x971 Mov
	goto Label_2420; // 0x972 Jump
	
Label_2420:
	return 0; // 0x974 Return
	
Label_2419:
	var_447_float = var_449_float; // 0x973 Mov
}


func_2421(var_457_float, var_458_float, var_459_float, var_460_float)
{
	var_461_bool = var_458_float < var_459_float; // 0x976 LT
	if(var_461_bool == 0) goto Label_2426; // 0x977 JumpB
	var_457_float = var_459_float; // 0x978 Mov
	return 0; // 0x979 Return
	
Label_2426:
	var_462_bool = var_458_float > var_460_float; // 0x97a GT
	if(var_462_bool == 0) goto Label_2430; // 0x97b JumpB
	var_457_float = var_460_float; // 0x97c Mov
	return 0; // 0x97d Return
	
Label_2430:
	var_457_float = var_458_float; // 0x97e Mov
...
func_2432(var_104_int, var_105_string)
{
	var_106_int = 0; var_107_int = 0; // 0x980 PushV
	GetVariable(var_105_string, var_107_int); // 0x981 Func
	var_104_int = var_107_int; // 0x983 Mov
	return 2; // 0x984 Return
}


func_2437(var_465_float)
{
	var_466_object = Obj(); var_467_object = Obj(); // 0x985 PushV
	CreateFloatVector(var_467_object); // 0x986 Func
	add(var_465_float); // 0x988 ObjFunc
	var_468_int = 15; // 0x98a PushI
	SendWorldWndMessage(var_468_int, var_467_object); // 0x98b Func
...
func_2447(var_20_bool, var_21_string, var_22_string)
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x98f PushV
	FindActor(var_24_object, var_21_string); // 0x990 Func
	var_25_bool = var_24_object == 0; // 0x992 NullEq
	if(var_25_bool == 0) goto Label_2454; // 0x993 JumpB
	var_20_bool = 0; // 0x994 MovB
	return 2; // 0x995 Return
	
Label_2454:
	Trigger(var_24_object, var_22_string); // 0x996 Func
	var_20_bool = 1; // 0x998 MovB
...
Label_1982:
	...
	func_2414(var_447_float, var_448_float, var_449_float); // 0x7c3 NEW_2
	...
	func_2421(var_457_float, var_458_float, var_459_float, var_460_float); // 0x7d1 NEW_2
	...
	func_2437(var_465_float); // 0x7dc NEW_2
...
Label_1962:
	var_469_string = "armor"; // 0x7aa PushS
	GetProperty(var_469_string, var_422_int); // 0x7ab ObjFunc
}


func_2459(var_22_object)
{
	var_23_bool = 0; var_24_bool = 0; // 0x99b PushV
	IsPlayerActor(var_22_object, var_24_bool); // 0x99c Func
	var_25_bool = var_24_bool; // 0x99e Push
	if(var_25_bool == 0) goto Label_2467; // 0x99f JumpB
	var_26_string = "attack"; // 0x9a0 PushS
	PlayGlobalMusic(var_26_string); // 0x9a1 Func
...
func_2468()
{
	var_370_object = Obj(); var_371_object = Obj(); // 0x9a4 PushV
	GetScene(var_371_object); // 0x9a5 Func
	var_372_string = "battle"; // 0x9a7 PushS
	var_373_object = Obj(); // 0x9a8 PushV
	func_2398(var_373_object); // 0x9a9 NEW_2
	BroadcastMessage(var_372_string, var_373_object, var_371_object); // 0x9ab Func
	return 2; // 0x9ad Return
}
...
func_2223(var_34_bool, var_36_float)
{
	...
	func_2404(var_61_cvector, var_62_cvector); // 0x8ca NEW_2
...
Label_2264:
	...
	CameraTransit(var_52_cvector, var_50_cvector); // 0x8da Func
	var_74_float = GetByIndex(var_51_cvector, 0); // 0x8dc PushE
	var_75_float = GetByIndex(var_51_cvector, 2); // 0x8dd PushE
	Rotate(var_74_float, var_75_float); // 0x8de Func
	var_76_bool = 0; // 0x8e0 PushV
	func_2584(var_76_bool); // 0x8e1 NEW_2
	if(var_76_bool == 0) goto Label_2277; // 0x8e3 JumpB
	goto Label_2285; // 0x8e4 Jump
	
Label_2285:
	CameraWaitForPlayFinish(); // 0x8ed Func
	ResumeWorld(); // 0x8ef Func
	var_34_bool = 1; // 0x8f1 MovB
	return 18; // 0x8f2 Return
	
Label_2277:
	var_77_string = "head"; // 0x8e5 PushS
	HasAnimationTrack(var_54_bool, var_77_string); // 0x8e6 Func
	var_78_bool = var_54_bool; // 0x8e8 Push
	if(var_78_bool == 0) goto Label_2285; // 0x8e9 JumpB
	var_79_string = "head"; // 0x8ea PushS
	LookAsyncCamera(var_79_string); // 0x8eb Func
}


func_2479()
{
	var_27_bool = 0; var_28_string = ""; var_29_string = ""; // 0x9b0 PushV
	var_28_string = "quest_b5_01"; // 0x9b1 MovS
	var_29_string = "butcher_attack"; // 0x9b2 MovS
	func_2447(var_27_bool, var_28_string, var_29_string); // 0x9b3 NEW_2
...
func_2486()
{
	var_119_string = "oob5Butcher1"; // 0x9b7 PushS
	var_120_int = 1; // 0x9b8 PushI
	SetVariable(var_119_string, var_120_int); // 0x9b9 Func
...
func_2492(var_102_bool)
{
	var_104_int = 0; var_105_string = ""; // 0x9bd PushV
	var_105_string = "b5q01WifeDead"; // 0x9be MovS
	func_2432(var_104_int, var_105_string); // 0x9bf NEW_2
	var_108_int = 0; // 0x9c1 PushI
	var_109_bool = var_104_int != var_108_int; // 0x9c2 Neq
	if(var_109_bool == 0) goto Label_2502; // 0x9c3 JumpB
	var_102_bool = 1; // 0x9c4 MovB
	return 0; // 0x9c5 Return
	
Label_2502:
	var_102_bool = 0; // 0x9c6 MovB
...
func_1473(var_0_object)
{
	...
	func_2459(var_133_object); // 0x5c3 NEW_2
	return 0; // 0x5c5 Return
}


func_1478(var_470_int)
{
	var_470_int = 0; // 0x5c6 MovI
	return 0; // 0x5c7 Return
}


func_2504(var_111_bool)
{
	var_113_int = 0; var_114_string = ""; // 0x9c9 PushV
	var_114_string = "oob5Butcher1"; // 0x9ca MovS
	func_2432(var_113_int, var_114_string); // 0x9cb NEW_2
	var_115_int = 0; // 0x9cd PushI
	var_116_bool = var_113_int == var_115_int; // 0x9ce Eq
	if(var_116_bool == 0) goto Label_2514; // 0x9cf JumpB
	var_111_bool = 1; // 0x9d0 MovB
	return 0; // 0x9d1 Return
	
Label_2514:
	var_111_bool = 0; // 0x9d2 MovB
...
func_1480()
{
	...
	func_2357(var_266_string); // 0x5ca NEW_2
...
func_203(var_2_object, var_121_string)
{
	var_122_bool = 0; // 0xcc PushV
	func_2584(var_122_bool); // 0xcd NEW_2
	var_123_bool = var_122_bool == 0; // 0xcf Not
	if(var_123_bool == 0) goto Label_210; // 0xd0 JumpB
	return 0; // 0xd1 Return
	
Label_210:
	var_124_bool = var_121_string == var_2_object; // 0xd2 Eq
	if(var_124_bool == 0) goto Label_213; // 0xd3 JumpB
	return 0; // 0xd4 Return
	
Label_213:
	var_125_string = ""; var_126_bool = 0; // 0xd5 PushV
	var_125_string = var_121_string; // 0xd6 Mov
	var_127_string = ""; // 0xd7 PushS
	var_128_bool = var_121_string == var_127_string; // 0xd8 Eq
	if(var_128_bool == 0) goto Label_220; // 0xd9 JumpB
	var_126_bool = 0; // 0xda MovB
	goto Label_221; // 0xdb Jump
	
Label_221:
	func_2324(var_125_string, var_126_bool); // 0xdd NEW_2
	var_2_object = var_121_string; // 0xdf TMov
	return 0; // 0xe0 Return
	
Label_220:
	var_126_bool = 1; // 0xdc MovB
}
...
Label_724:
	...
	func_2559(var_45_int); // 0x2d5 NEW_2
...
Label_739:
	...
	func_2552(var_67_string, var_68_int); // 0x2f1 NEW_2
...
func_1487(var_495_bool)
{
	var_495_bool = 1; // 0x5cf MovB
...
func_2516(var_85_int)
{
	var_86_int = 0; var_87_int = 0; // 0x9d4 PushV
	var_88_string = "branch"; // 0x9d5 PushS
	GetVariable(var_88_string, var_87_int); // 0x9d6 Func
	var_89_int = 0; // 0x9d8 PushI
	var_90_bool = var_87_int == var_89_int; // 0x9d9 Eq
	if(var_90_bool == 0) goto Label_2526; // 0x9da JumpB
	var_85_int = 1; // 0x9db MovI
	return 2; // 0x9dc Return
	
Label_2526:
	var_91_int = 1; // 0x9de PushI
	var_92_bool = var_87_int == var_91_int; // 0x9df Eq
	if(var_92_bool == 0) goto Label_2531; // 0x9e0 JumpB
	var_85_int = 2; // 0x9e1 MovI
	return 2; // 0x9e2 Return
	
Label_2531:
	var_85_int = 3; // 0x9e3 MovI
...
func_1493(var_2_object, var_140_bool, var_141_object, var_142_float, var_143_float, var_144_bool, var_145_bool)
{
	...
	func_2459(var_153_object); // 0x5d8 NEW_2
	...
	func_2339(var_157_object); // 0x5e5 NEW_2
...
Label_1513:
	...
	func_2398(var_168_object); // 0x5ef NEW_2
...
func_2533(var_24_int)
{
	var_25_int = 0; var_26_int = 0; // 0x9e5 PushV
	var_27_string = "branch"; // 0x9e6 PushS
	GetVariable(var_27_string, var_26_int); // 0x9e7 Func
	var_24_int = var_26_int; // 0x9e9 Mov
	return 2; // 0x9ea Return
}


func_2539(var_23_object)
{
	var_24_int = 0; // 0x9ec PushV
	func_2533(var_24_int); // 0x9ed NEW_2
	var_28_int = 1; // 0x9ef PushI
	var_29_bool = var_24_int == var_28_int; // 0x9f0 Eq
	if(var_29_bool == 0) goto Label_2549; // 0x9f1 JumpB
	WorkWithCorpse(var_23_object); // 0x9f2 Func
	goto Label_2551; // 0x9f4 Jump
	
Label_2551:
	return 0; // 0x9f7 Return
	
Label_2549:
	Barter(var_23_object); // 0x9f5 Func
}
...
Label_1842:
	...
	func_2357(var_102_string); // 0x734 NEW_2
...
func_2291()
{
	var_186_bool = 0; var_187_bool = 0; // 0x8f3 PushV
	CameraSwitchToNormal(); // 0x8f4 Func
	var_188_bool = 0; // 0x8f6 PushV
	func_2584(var_188_bool); // 0x8f7 NEW_2
	if(var_188_bool == 0) goto Label_2299; // 0x8f9 JumpB
	goto Label_2307; // 0x8fa Jump
	
Label_2307:
	return 2; // 0x903 Return
	
Label_2299:
	var_189_string = "head"; // 0x8fb PushS
	HasAnimationTrack(var_187_bool, var_189_string); // 0x8fc Func
	var_190_bool = var_187_bool; // 0x8fe Push
	if(var_190_bool == 0) goto Label_2307; // 0x8ff JumpB
	var_191_string = "head"; // 0x900 PushS
	UnlookAsync(var_191_string); // 0x901 Func
}


func_1271(var_496_bool, var_497_float)
{
	var_498_float = 0; var_499_bool = 0; var_500_float = 0; var_501_bool = 0; // 0x4f7 PushV
	rand(var_500_float); // 0x4f8 Func
	var_502_bool = var_500_float < var_497_float; // 0x4fa LT
	if(var_502_bool == 0) goto Label_1291; // 0x4fb JumpB
	
Label_1276:
	IsAnimationPlaying(var_501_bool); // 0x4fc Func
	var_503_bool = var_501_bool == 0; // 0x4fe Not
	if(var_503_bool == 0) goto Label_1281; // 0x4ff JumpB
...
Label_1296:
	var_496_bool = 0; // 0x510 MovB
	return 4; // 0x511 Return
	
Label_1281:
	var_504_bool = 0; // 0x501 PushV
	func_1369(var_504_bool); // 0x502 NEW_2
	if(var_504_bool == 0) goto Label_1287; // 0x504 JumpB
	var_496_bool = 1; // 0x505 MovB
...
Label_1291:
	...
	func_1473(var_501_bool); // 0x50e NEW_2
}


func_2552(var_51_string, var_52_int)
{
	var_53_string = ""; var_54_string = ""; // 0x9f8 PushV
	var_54_string = "idle"; // 0x9f9 MovS
	var_55_int = var_52_int; // 0x9fa Push
	if(var_55_int == 0) goto Label_2557; // 0x9fb JumpB
	var_54_string = var_54_string + var_52_int; // 0x9fc Add2
	
Label_2557:
	var_51_string = var_54_string; // 0x9fd Mov
	return 2; // 0x9fe Return
}


func_2559(var_45_int)
{
	var_46_int = 0; var_47_bool = 0; var_48_int = 0; var_49_bool = 0; // 0x9ff PushV
	var_48_int = 0; // 0xa00 MovI
	
Label_2561:
	var_50_string = "all"; // 0xa01 PushS
	var_51_string = ""; var_52_int = 0; // 0xa02 PushV
	var_52_int = var_48_int; // 0xa03 Mov
	func_2552(var_51_string, var_52_int); // 0xa04 NEW_2
	HasAnimation(var_49_bool, var_50_string, var_51_string); // 0xa06 Func
	var_56_bool = var_49_bool == 0; // 0xa08 Not
	if(var_56_bool == 0) goto Label_2571; // 0xa09 JumpB
	goto Label_2574; // 0xa0a Jump
	
Label_2574:
	var_45_int = var_48_int; // 0xa0e Mov
	return 4; // 0xa0f Return
	
Label_2571:
	var_57_int = 1; // 0xa0b PushI
	var_48_int = var_48_int + var_57_int; // 0xa0c Add2
	goto Label_2561; // 0xa0d Jump
}
