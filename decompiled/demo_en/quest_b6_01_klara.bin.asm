...
0x415: @ StopWorld()
0x416: Pop(0)
0x417: @ CameraTransit(Stack[-3], Stack[-5])
0x418: Pop(0)
0x419: Push(CvectorIndex(Stack[-4], 0))
0x41a: Push(CvectorIndex(Stack[-5], 2))
0x41b: @ Rotate(Stack[-2], Stack[-1])
0x41c: Pop(2)
...
0x427: Push("head")
0x428: @ LookAsyncCamera(Stack[-1])
0x429: Pop(1)
0x42a: @ CameraWaitForPlayFinish()
0x42b: Pop(0)
0x42c: @ ResumeWorld()
0x42d: Pop(0)
0x42e: Stack[-21] = (bool) 1
0x42f: Return(); Pop(18)

0x430: PushEmpty(bool, bool)
0x431: @ CameraSwitchToNormal()
0x432: Pop(0)
...
0x438: Push("head")
0x439: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x43a: Pop(1)
0x43b: Push(Stack[-1])
0x43c: IF (Stack[-1] == 0) GOTO 0x440; Pop(1)

0x43d: Push("head")
0x43e: @ UnlookAsync(Stack[-1])
0x43f: Pop(1)
0x440: Return(); Pop(2)

0x441: PushEmpty(int, int, int, int)
0x442: Push("voice_common")
0x443: @ GetVariable(Stack[-1], Stack[-3])
0x444: Pop(1)
0x445: Push(Stack[-2])
0x446: IF (Stack[-1] == 0) GOTO 0x467; Pop(1)
...
0x44c: IF (Stack[-1] == 0) GOTO 0x455; Pop(1)

0x44d: PushEmpty(bool, object)
0x44e: Stack[-1] = Stack[-7]
0x44f: Call2 0x4a0
...
0x453: Stack[-6] = (bool) 0
0x454: Return(); Pop(4)

0x455: Push((int) 2)
0x456: @ irand(Stack[-2], Stack[-1])
0x457: Pop(1)
0x458: Push(Stack[-1])
...
0x45b: Push((int) 1)
0x45c: Pop(1); Push(Stack[-4] + Stack[-1]);
0x45d: Push((int) 3)
...
0x475: Push("voice_common")
0x476: Push((int) 1)
0x477: @ SetVariable(Stack[-2], Stack[-1])
0x478: Pop(2)
0x479: Stack[-6] = (bool) 1
0x47a: Return(); Pop(4)

0x47b: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x47c: Stack[-5] = "c"
0x47d: Stack[-4] = (int) 0
0x47e: Push((int) 1)
0x47f: IF (Stack[-1] == 0) GOTO 0x48b; Pop(1)

0x480: Push((int) 1)
0x481: Pop(1); Push(Stack[-5] + Stack[-1]);
0x482: Pop(1); Push(Stack[-6] + Stack[-1]);
0x483: @@ HasProperty(Stack[-1], Stack[-4])
0x484: Pop(1)
0x485: Pop(0); Push((bool) Stack[-3] == 0)
0x486: IF (Stack[-1] == 0) GOTO 0x488; Pop(1)

0x487: GOTO 0x48b

0x488: Push((int) 1)
0x489: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x48a: GOTO 0x47e

0x48b: Pop(0); Push((bool) Stack[-4] == 0)
...
0x48f: Stack[-2] = (int) 0
0x490: Push((int) 1)
0x491: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x492: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x493: @ irand(Stack[-2], Stack[-4])
0x494: Pop(0)
0x495: Push((int) 1)
0x496: Pop(1); Push(Stack[-3] + Stack[-1]);
0x497: Pop(1); Push(Stack[-6] + Stack[-1]);
0x498: @@ GetProperty(Stack[-1], Stack[-2])
0x499: Pop(1)
0x49a: PushEmpty(bool, string)
0x49b: Stack[-1] = Stack[-3]
0x49c: Call2 0x4ea

0x49d: Stack[-14] = Stack[-2]
0x49e: Pop(2)
0x49f: Return(); Pop(10)

0x4a0: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x4a1: Push("d")
0x4a2: PushEmpty(int)
0x4a3: Call2 0x537

0x4a4: Pop(0)
0x4a5: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4a6: Push("m")
0x4a7: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4a8: Stack[-4] = (int) 0
0x4a9: Push((int) 1)
0x4aa: IF (Stack[-1] == 0) GOTO 0x4b6; Pop(1)

0x4ab: Push((int) 1)
0x4ac: Pop(1); Push(Stack[-5] + Stack[-1]);
0x4ad: Pop(1); Push(Stack[-6] + Stack[-1]);
0x4ae: @@ HasProperty(Stack[-1], Stack[-4])
0x4af: Pop(1)
0x4b0: Pop(0); Push((bool) Stack[-3] == 0)
0x4b1: IF (Stack[-1] == 0) GOTO 0x4b3; Pop(1)

0x4b2: GOTO 0x4b6

0x4b3: Push((int) 1)
0x4b4: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x4b5: GOTO 0x4a9

0x4b6: Pop(0); Push((bool) Stack[-4] == 0)
0x4b7: IF (Stack[-1] == 0) GOTO 0x4ba; Pop(1)

0x4b8: Stack[-12] = (bool) 0
0x4b9: Return(); Pop(10)

0x4ba: Stack[-2] = (int) 0
0x4bb: Push((int) 1)
0x4bc: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x4bd: IF (Stack[-1] == 0) GOTO 0x4c0; Pop(1)

0x4be: @ irand(Stack[-2], Stack[-4])
0x4bf: Pop(0)
0x4c0: Push((int) 1)
0x4c1: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4c2: Pop(1); Push(Stack[-6] + Stack[-1]);
0x4c3: @@ GetProperty(Stack[-1], Stack[-2])
0x4c4: Pop(1)
0x4c5: PushEmpty(bool, string)
0x4c6: Stack[-1] = Stack[-3]
0x4c7: Call2 0x4ea

0x4c8: Stack[-14] = Stack[-2]
0x4c9: Pop(2)
0x4ca: Return(); Pop(10)

0x4cb: PushEmpty(bool, float, float, bool, float, float)
0x4cc: @ lshHasAnimation(Stack[-3], Stack[-7])
0x4cd: Pop(0)
0x4ce: Push(Stack[-3])
0x4cf: IF (Stack[-1] == 0) GOTO 0x4d6; Pop(1)

0x4d0: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x4d1: Pop(0)
0x4d2: Push((bool) 0)
...
0x4d6: Push("Can't find lsh animation : ")
0x4d7: Pop(1); Push(Stack[-1] + Stack[-8]);
0x4d8: @ Trace(Stack[-1])
0x4d9: Pop(1)
0x4da: Return(); Pop(6)

0x4db: PushEmpty(bool, float, float, bool, float, float)
0x4dc: @ lshHasAnimation(Stack[-3], Stack[-8])
0x4dd: Pop(0)
0x4de: Push(Stack[-3])
0x4df: IF (Stack[-1] == 0) GOTO 0x4e5; Pop(1)

0x4e0: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x4e1: Pop(0)
0x4e2: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x4e3: Pop(0)
0x4e4: GOTO 0x4e9

0x4e5: Push("Can't find lsh animation : ")
0x4e6: Pop(1); Push(Stack[-1] + Stack[-9]);
0x4e7: @ Trace(Stack[-1])
0x4e8: Pop(1)
0x4e9: Return(); Pop(6)
...
0x4ef: @ lshHasSpeech(Stack[-1], Stack[-3])
0x4f0: Pop(0)
0x4f1: Push(Stack[-1])
0x4f2: IF (Stack[-1] == 0) GOTO 0x4f7; Pop(1)

0x4f3: @ lshPlaySpeech(Stack[-3])
0x4f4: Pop(0)
0x4f5: Stack[-4] = (bool) 1
0x4f6: Return(); Pop(2)

0x4f7: Stack[-4] = (bool) 0
0x4f8: Return(); Pop(2)
...
0x501: @ self(Stack[-1])
0x502: Pop(0)
0x503: Stack[-3] = Stack[-1]
0x504: Return(); Pop(2)

0x505: Stack[-1] = 0
0x506: PushEmpty(float, float)
0x507: Pop(0); Push(Stack[-3] | Stack[-3]);
0x508: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x509: Push((float)0.0)
0x50a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x50b: IF (Stack[-1] == 0) GOTO 0x50e; Pop(1)

0x50c: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x50d: Return(); Pop(2)

0x50e: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x50f: Return(); Pop(2)

0x510: PushEmpty(int, int)
0x511: @ GetVariable(Stack[-3], Stack[-1])
0x512: Pop(0)
0x513: Stack[-4] = Stack[-1]
0x514: Return(); Pop(2)

0x515: PushEmpty(object, object)
0x516: @ FindActor(Stack[-1], Stack[-4])
0x517: Pop(0)
0x518: Pop(0); Push((bool) Stack[-1] == 0)
0x519: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x51a: Push("Door ")
0x51b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x51c: Push(" not found")
...
0x521: Push("locked")
0x522: @@ SetProperty(Stack[-1], Stack[-4])
0x523: Pop(1)
0x524: Return(); Pop(2)

0x525: Stack[-1] = 0
0x526: PushEmpty(object, object)
0x527: @ FindActor(Stack[-1], Stack[-4])
0x528: Pop(0)
0x529: Pop(0); Push((bool) Stack[-1] == 0)
0x52a: IF (Stack[-1] == 0) GOTO 0x52d; Pop(1)

0x52b: Stack[-5] = (bool) 0
0x52c: Return(); Pop(2)

0x52d: @ Trigger(Stack[-1], Stack[-3])
0x52e: Pop(0)
0x52f: Stack[-5] = (bool) 1
0x530: Return(); Pop(2)

0x531: Stack[-1] = 0
0x532: PushEmpty(float, float)
0x533: @ GetGameTime(Stack[-1])
0x534: Pop(0)
0x535: Stack[-3] = Stack[-1]
0x536: Return(); Pop(2)

0x537: PushEmpty(float, float)
0x538: @ GetGameTime(Stack[-1])
0x539: Pop(0)
0x53a: Push((int) 1)
0x53b: PushEmpty(int)
0x53c: Push((int) 24)
0x53d: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x53e: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x53f: Return(); Pop(2)

0x540: PushEmpty(string, string)
0x541: Stack[-1] = "idle"
0x542: Push(Stack[-3])
0x543: IF (Stack[-1] == 0) GOTO 0x545; Pop(1)

0x544: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x545: Stack[-4] = Stack[-1]
0x546: Return(); Pop(2)

0x547: PushEmpty(int, bool, int, bool)
0x548: Stack[-2] = (int) 0
0x549: Push("all")
0x54a: PushEmpty(string, int)
0x54b: Stack[-1] = Stack[-5]
0x54c: Call2 0x540

0x54d: Pop(1)
0x54e: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x54f: Pop(2)
...
0x553: Push((int) 1)
0x554: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x555: GOTO 0x549
...
0x566: Pop(1)
0x567: Push("b6q01KlaraGotoTermitnik2")
0x568: Push("pt_map_termitnik2")
0x569: Push((int) 1)
0x56a: Push((int) 525668)
0x56b: PushEmpty(float)
0x56c: Call2 0x532

0x56d: Pop(0)
0x56e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x56f: Pop(5)
0x570: PushEmpty()
0x571: Call2 0x5ef

0x572: Pop(0)
0x573: PushEmpty(bool, string, string)
0x574: Stack[-2] = "quest_b6_01"
0x575: Stack[-1] = "remove_klara"
0x576: Call2 0x526

0x577: Pop(3)
0x578: PushEmpty(bool, string, string)
0x579: Stack[-2] = "quest_b6_01"
0x57a: Stack[-1] = "init_termitnik"
0x57b: Call2 0x526
...
0x58b: PushEmpty()
0x58c: PushEmpty(string, bool)
0x58d: Stack[-2] = "termitnik2@door1"
...
0x592: PushEmpty()
0x593: PushEmpty(object, string, float)
0x594: PushEmpty(object)
0x595: Call2 0x625

0x596: Stack[-4] = Stack[-1]
0x597: Pop(1)
0x598: Stack[-2] = "pt_map_termitnik2"
0x599: Stack[-1] = (int) 2
0x59a: Call2 0x636
...
0x59e: Pop(0)
0x59f: @@ ShowMap(Stack[-1])
0x5a0: Pop(1)
0x5a1: Return(); Pop(0)

0x5a2: PushEmpty()
0x5a3: Push("b6q01KlaraVisit")
0x5a4: Push((int) 1)
...
0x5ca: PushEmpty()
0x5cb: PushEmpty(int, string)
0x5cc: Stack[-1] = "oob6Klara2"
0x5cd: Call2 0x510

0x5ce: Pop(1)
0x5cf: Push((int) 0)
0x5d0: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x5d1: IF (Stack[-1] == 0) GOTO 0x5d4; Pop(1)

0x5d2: Stack[-2] = (bool) 1
0x5d3: Return(); Pop(0)

0x5d4: Stack[-2] = (bool) 0
0x5d5: Return(); Pop(0)

0x5d6: PushEmpty()
0x5d7: PushEmpty(int, string)
0x5d8: Stack[-1] = "oob6Klara3"
0x5d9: Call2 0x510

0x5da: Pop(1)
0x5db: Push((int) 0)
0x5dc: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x5dd: IF (Stack[-1] == 0) GOTO 0x5e0; Pop(1)

0x5de: Stack[-2] = (bool) 1
0x5df: Return(); Pop(0)

0x5e0: Stack[-2] = (bool) 0
0x5e1: Return(); Pop(0)

0x5e2: PushEmpty(object, object)
0x5e3: Push((int) 783)
0x5e4: Push((int) 1)
0x5e5: Push((int) 542148)
0x5e6: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5e7: Pop(3)
0x5e8: PushEmpty(bool, object, int)
0x5e9: Stack[-2] = Stack[-4]
0x5ea: Stack[-1] = (int) 265
0x5eb: Call2 0x609
...
0x601: Push("Can't retrieve diary root")
0x602: @ Trace(Stack[-1])
0x603: Pop(1)
...
0x60c: Stack[-4] = Stack[-1]
0x60d: Pop(1)
0x60e: @@ Find(Stack[-7], Stack[-2])
0x60f: Pop(0)
0x610: Pop(0); Push((bool) Stack[-2] == 0)
0x611: IF (Stack[-1] == 0) GOTO 0x618; Pop(1)

0x612: Push("Can't find diary parent with id: ")
...
0x618: @@ AddChild(Stack[-8])
0x619: Pop(0)
0x61a: Push((int) 7)
0x61b: @ SendWorldWndMessage(Stack[-1])
0x61c: Pop(1)
0x61d: @@ GetCategory(Stack[-1])
0x61e: Pop(0)
...
0x626: @ GetMainOutdoorScene(Stack[-2])
0x627: Pop(0)
0x628: Pop(0); Push((bool) Stack[-2] == 0)
0x629: IF (Stack[-1] == 0) GOTO 0x630; Pop(1)

0x62a: Push("Can't find main outdoor scene")
0x62b: @ Trace(Stack[-1])
0x62c: Pop(1)
0x62d: Stack[-1] = 0
...
0x634: Stack[-1] = 0
0x635: Stack[-2] = 0
0x636: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x637: @ GetMainOutdoorScene(Stack[-2])
0x638: Pop(0)
0x639: Pop(0); Push((bool) Stack[-2] == 0)
0x63a: IF (Stack[-1] == 0) GOTO 0x63f; Pop(1)

0x63b: Push("Can't find main outdoor scene")
0x63c: @ Trace(Stack[-1])
0x63d: Pop(1)
0x63e: Return(); Pop(8)

0x63f: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x640: Pop(0)
0x641: Pop(0); Push((bool) Stack[-1] == 0)
0x642: IF (Stack[-1] == 0) GOTO 0x649; Pop(1)

0x643: Push("Warning: outdoor scene locator ")
0x644: Pop(1); Push(Stack[-1] + Stack[-11]);
0x645: Push(" doesnt exist")
0x646: Pop(2); Push(Stack[-2] + Stack[-1]);
0x647: @ Trace(Stack[-1])
0x648: Pop(1)
0x649: @@ GetMap(Stack[-11])
0x64a: Pop(0)
0x64b: Pop(0); Push((bool) Stack[-11] == 0)
0x64c: IF (Stack[-1] == 0) GOTO 0x651; Pop(1)

0x64d: Push("Can't find map")
0x64e: @ Trace(Stack[-1])
0x64f: Pop(1)
0x650: Return(); Pop(8)

0x651: Push(CvectorIndex(Stack[-4], 0))
0x652: Push(CvectorIndex(Stack[-5], 2))
0x653: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x654: Pop(2)
0x655: Return(); Pop(8)

0x656: Stack[-2] = 0
0x657: PushEmpty(int, int)
0x658: Push("branch")
...
0x668: Stack[-1] = (int) 515540
0x669: Return(); Pop(0)

0x66a: Stack[-1] = (int) 502865
0x66b: Return(); Pop(0)

0x66c: Stack[-1] = "ui/NPC_Klara.png"
0x66d: Return(); Pop(0)

0x66e: Stack[-1] = "ui/NPC_Klara_b.png"
0x66f: Return(); Pop(0)

0x670: Stack[-1] = (bool) 1
0x671: Return(); Pop(0)
