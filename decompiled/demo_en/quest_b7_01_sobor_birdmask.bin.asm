...
0x1da: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1db: Pop(0)
0x1dc: Push(Stack[-3])
0x1dd: IF (Stack[-1] == 0) GOTO 0x1e4; Pop(1)

0x1de: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1df: Pop(0)
0x1e0: Push((bool) 0)
0x1e1: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1e2: Pop(1)
0x1e3: GOTO 0x1e8

0x1e4: Push("Can't find lsh animation : ")
0x1e5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1e6: @ Trace(Stack[-1])
0x1e7: Pop(1)
0x1e8: Return(); Pop(6)

0x1e9: PushEmpty(bool, float, float, bool, float, float)
0x1ea: @ lshHasAnimation(Stack[-3], Stack[-8])
0x1eb: Pop(0)
0x1ec: Push(Stack[-3])
0x1ed: IF (Stack[-1] == 0) GOTO 0x1f3; Pop(1)

0x1ee: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x1ef: Pop(0)
0x1f0: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x1f1: Pop(0)
0x1f2: GOTO 0x1f7

0x1f3: Push("Can't find lsh animation : ")
0x1f4: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1f5: @ Trace(Stack[-1])
0x1f6: Pop(1)
0x1f7: Return(); Pop(6)
...
0x206: Pop(0); Push(Stack[-3] | Stack[-3]);
0x207: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x208: Push((float)0.0)
0x209: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x20a: IF (Stack[-1] == 0) GOTO 0x20d; Pop(1)

0x20b: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x20c: Return(); Pop(2)

0x20d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x20e: Return(); Pop(2)

0x20f: PushEmpty(string, string)
0x210: Stack[-1] = "idle"
0x211: Push(Stack[-3])
0x212: IF (Stack[-1] == 0) GOTO 0x214; Pop(1)

0x213: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x214: Stack[-4] = Stack[-1]
0x215: Return(); Pop(2)

0x216: PushEmpty(int, bool, int, bool)
0x217: Stack[-2] = (int) 0
0x218: Push("all")
...
0x21c: Pop(1)
0x21d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x21e: Pop(2)
0x21f: Pop(0); Push((bool) Stack[-1] == 0)
0x220: IF (Stack[-1] == 0) GOTO 0x222; Pop(1)

0x221: GOTO 0x225

0x222: Push((int) 1)
0x223: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x224: GOTO 0x218

0x225: Stack[-5] = Stack[-2]
0x226: Return(); Pop(4)

0x227: PushEmpty(int, int)
0x228: Push("branch")
0x229: @ GetVariable(Stack[-1], Stack[-2])
0x22a: Pop(1)
0x22b: Push((int) 0)
...
0x238: Stack[-1] = (int) 515571
0x239: Return(); Pop(0)

0x23a: Stack[-1] = (int) 504029
0x23b: Return(); Pop(0)

0x23c: Stack[-1] = "ui/NPC_bmask.png"
0x23d: Return(); Pop(0)

0x23e: Stack[-1] = "ui/NPC_bmask_b.png"
0x23f: Return(); Pop(0)
