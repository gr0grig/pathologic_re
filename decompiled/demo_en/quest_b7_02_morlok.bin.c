...
Label_188:
	...
	func_736(var_48_object); // 0xc1 NEW_2
...
Label_349:
	...
	func_827(var_133_bool); // 0x15f NEW_2
...
Label_436:
	...
	func_659(var_9_object); // 0x1b6 NEW_2
...
func_774(var_21_bool, var_22_object, var_23_int)
{
	var_24_object = Obj(); var_25_object = Obj(); var_26_int = 0; var_27_object = Obj(); var_28_object = Obj(); var_29_int = 0; // 0x306 PushV
	var_30_object = Obj(); // 0x307 PushV
	func_761(var_30_object); // 0x308 NEW_2
	var_27_object = var_30_object; // 0x309 Mov
	Find(var_23_int, var_28_object); // 0x30b ObjFunc
	var_35_bool = var_28_object == 0; // 0x30d Not
	if(var_35_bool == 0) goto Label_789; // 0x30e JumpB
	var_36_string = "Can't find diary parent with id: "; // 0x30f PushS
	var_37_int = var_36_string + var_23_int; // 0x310 Add
	Trace(var_37_int); // 0x311 Func
	var_21_bool = 0; // 0x313 MovB
	return 6; // 0x314 Return
	
Label_789:
	AddChild(var_22_object); // 0x315 ObjFunc
	var_38_int = 7; // 0x317 PushI
	SendWorldWndMessage(var_38_int); // 0x318 Func
	GetCategory(var_29_int); // 0x31a ObjFunc
	SetDiarySection(var_29_int); // 0x31c Func
	var_21_bool = 0; // 0x31e MovB
...
Label_407:
	...
	func_659(var_14_object); // 0x199 NEW_2
...
func_652()
{
	var_9_bool = 0; // 0x28c PushV
	func_827(var_9_bool); // 0x28d NEW_2
	if(var_9_bool == 0) goto Label_658; // 0x28f JumpB
	lshStopSpeech(); // 0x290 Func
...
func_659(var_9_object)
{
	var_10_object = Obj(); var_11_object = Obj(); // 0x293 PushV
	self(var_11_object); // 0x294 Func
	var_9_object = var_11_object; // 0x296 Mov
...
func_536(var_18_bool, var_20_float)
{
	...
	func_665(var_45_cvector, var_46_cvector); // 0x233 NEW_2
...
Label_577:
	...
	CameraTransit(var_36_cvector, var_34_cvector); // 0x243 Func
	var_58_float = GetByIndex(var_35_cvector, 0); // 0x245 PushE
	var_59_float = GetByIndex(var_35_cvector, 2); // 0x246 PushE
	Rotate(var_58_float, var_59_float); // 0x247 Func
	var_60_bool = 0; // 0x249 PushV
	func_827(var_60_bool); // 0x24a NEW_2
	if(var_60_bool == 0) goto Label_590; // 0x24c JumpB
	goto Label_598; // 0x24d Jump
	
Label_598:
	CameraWaitForPlayFinish(); // 0x256 Func
	ResumeWorld(); // 0x258 Func
	var_18_bool = 1; // 0x25a MovB
	return 18; // 0x25b Return
	
Label_590:
	var_61_string = "head"; // 0x24e PushS
	HasAnimationTrack(var_38_bool, var_61_string); // 0x24f Func
	var_62_bool = var_38_bool; // 0x251 Push
	if(var_62_bool == 0) goto Label_598; // 0x252 JumpB
	var_63_string = "head"; // 0x253 PushS
	LookAsyncCamera(var_63_string); // 0x254 Func
}


func_665(var_45_cvector, var_46_cvector)
{
	var_48_float = 0; var_49_float = 0; // 0x299 PushV
	var_50_int = var_46_cvector | var_46_cvector; // 0x29a Or
	var_49_float = sqrt(var_50_int); // 0x29b Sqrt2
	var_51_float = 0.0; // 0x29c PushF
	var_52_bool = var_49_float < var_51_float; // 0x29d LT
	if(var_52_bool == 0) goto Label_673; // 0x29e JumpB
	var_45_cvector = CVector(0.0, 0.0, 0.0); // 0x29f MovV
	return 2; // 0x2a0 Return
	
Label_673:
	var_45_cvector = var_46_cvector / var_46_cvector; // 0x2a1 Div2
...
func_152(var_2_object, var_97_string)
{
	...
	func_827(var_98_bool); // 0x9a NEW_2
...
Label_170:
	func_637(var_101_string, var_102_bool); // 0xaa NEW_2
...
func_802(var_69_int)
{
	var_70_int = 0; var_71_int = 0; // 0x322 PushV
	var_72_string = "branch"; // 0x323 PushS
	GetVariable(var_72_string, var_71_int); // 0x324 Func
	var_73_int = 0; // 0x326 PushI
	var_74_bool = var_71_int == var_73_int; // 0x327 Eq
	if(var_74_bool == 0) goto Label_812; // 0x328 JumpB
	var_69_int = 1; // 0x329 MovI
	return 2; // 0x32a Return
	
Label_812:
	var_75_int = 1; // 0x32c PushI
	var_76_bool = var_71_int == var_75_int; // 0x32d Eq
	if(var_76_bool == 0) goto Label_817; // 0x32e JumpB
	var_69_int = 2; // 0x32f MovI
	return 2; // 0x330 Return
	
Label_817:
	var_69_int = 3; // 0x331 MovI
	return 2; // 0x332 Return
}


func_675(var_87_int, var_88_string)
{
	var_89_int = 0; var_90_int = 0; // 0x2a3 PushV
	GetVariable(var_88_string, var_90_int); // 0x2a4 Func
	var_87_int = var_90_int; // 0x2a6 Mov
	return 2; // 0x2a7 Return
}


func_680(var_39_bool, var_40_string, var_41_string)
{
	var_42_object = Obj(); var_43_object = Obj(); // 0x2a8 PushV
	FindActor(var_43_object, var_40_string); // 0x2a9 Func
	var_44_bool = var_43_object == 0; // 0x2ab NullEq
	if(var_44_bool == 0) goto Label_687; // 0x2ac JumpB
	var_39_bool = 0; // 0x2ad MovB
	return 2; // 0x2ae Return
	
Label_687:
	Trigger(var_43_object, var_41_string); // 0x2af Func
	var_39_bool = 1; // 0x2b1 MovB
...
func_819(var_66_int)
{
	var_66_int = 521048; // 0x333 MovI
	return 0; // 0x334 Return
}


func_692(var_37_string, var_38_int)
{
	var_39_string = ""; var_40_string = ""; // 0x2b4 PushV
	var_40_string = "idle"; // 0x2b5 MovS
	var_41_int = var_38_int; // 0x2b6 Push
	if(var_41_int == 0) goto Label_697; // 0x2b7 JumpB
	var_40_string = var_40_string + var_38_int; // 0x2b8 Add2
	
Label_697:
	var_37_string = var_40_string; // 0x2b9 Mov
...
func_821(var_65_int)
{
	var_65_int = 521047; // 0x335 MovI
	return 0; // 0x336 Return
}


func_823(var_67_string)
{
	var_67_string = "ui/NPC_Citizen2.png"; // 0x337 MovS
...
{
	var_68_string = "ui/NPC_Citizen2_b.png"; // 0x339 MovS
	return 0; // 0x33a Return
}


func_827(var_60_bool)
{
	var_60_bool = 0; // 0x33b MovB
...
Label_454:
	...
	func_699(var_31_int); // 0x1c7 NEW_2
...
Label_469:
	...
	func_692(var_53_string, var_54_int); // 0x1e3 NEW_2
...
func_699(var_31_int)
{
	var_32_int = 0; var_33_bool = 0; var_34_int = 0; var_35_bool = 0; // 0x2bb PushV
	var_34_int = 0; // 0x2bc MovI
	
Label_701:
	var_36_string = "all"; // 0x2bd PushS
	var_37_string = ""; var_38_int = 0; // 0x2be PushV
	var_38_int = var_34_int; // 0x2bf Mov
	func_692(var_37_string, var_38_int); // 0x2c0 NEW_2
	HasAnimation(var_35_bool, var_36_string, var_37_string); // 0x2c2 Func
	var_42_bool = var_35_bool == 0; // 0x2c4 Not
	if(var_42_bool == 0) goto Label_711; // 0x2c5 JumpB
	goto Label_714; // 0x2c6 Jump
	
Label_714:
	var_31_int = var_34_int; // 0x2ca Mov
	return 4; // 0x2cb Return
	
Label_711:
	var_43_int = 1; // 0x2c7 PushI
	var_34_int = var_34_int + var_43_int; // 0x2c8 Add2
	goto Label_701; // 0x2c9 Jump
}
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_78_object, var_79_object)
{
	...
	func_736(var_86_object); // 0x52 NEW_2
...
Label_131:
	...
	func_621(var_120_string); // 0x85 NEW_2
...
Label_105:
	...
	var_137_int = 521222; // 0x6d PushI
	SetMessage(var_137_int); // 0x6e TObjFunc
	ClearReplies(); // 0x70 TObjFunc
	var_138_int = 521223; // 0x72 PushI
	var_139_int = -1; // 0x73 PushI
	var_140_int = 22417; // 0x74 PushI
...
func_716()
{
	var_14_string = "b7q02"; // 0x2cd PushS
	var_15_int = 2; // 0x2ce PushI
	SetVariable(var_14_string, var_15_int); // 0x2cf Func
	func_748(); // 0x2d2 NEW_2
	var_39_bool = 0; var_40_string = ""; var_41_string = ""; // 0x2d4 PushV
	var_40_string = "quest_b7_02"; // 0x2d5 MovS
	var_41_string = "place_grabitels"; // 0x2d6 MovS
	func_680(var_39_bool, var_40_string, var_41_string); // 0x2d7 NEW_2
...
func_730()
{
	var_95_string = "oob7Morlok1"; // 0x2db PushS
	var_96_int = 1; // 0x2dc PushI
	SetVariable(var_95_string, var_96_int); // 0x2dd Func
...
func_604()
{
	var_143_bool = 0; var_144_bool = 0; // 0x25c PushV
	CameraSwitchToNormal(); // 0x25d Func
	var_145_bool = 0; // 0x25f PushV
	func_827(var_145_bool); // 0x260 NEW_2
	if(var_145_bool == 0) goto Label_612; // 0x262 JumpB
...
Label_612:
	var_146_string = "head"; // 0x264 PushS
	HasAnimationTrack(var_144_bool, var_146_string); // 0x265 Func
	var_147_bool = var_144_bool; // 0x267 Push
	if(var_147_bool == 0) goto Label_620; // 0x268 JumpB
	var_148_string = "head"; // 0x269 PushS
	UnlookAsync(var_148_string); // 0x26a Func
}


func_736(var_85_bool)
{
	var_87_int = 0; var_88_string = ""; // 0x2e1 PushV
	var_88_string = "oob7Morlok1"; // 0x2e2 MovS
	func_675(var_87_int, var_88_string); // 0x2e3 NEW_2
	var_91_int = 0; // 0x2e5 PushI
	var_92_bool = var_87_int == var_91_int; // 0x2e6 Eq
	if(var_92_bool == 0) goto Label_746; // 0x2e7 JumpB
	var_85_bool = 1; // 0x2e8 MovB
	return 0; // 0x2e9 Return
	
Label_746:
	var_85_bool = 0; // 0x2ea MovB
...
func_748()
{
	var_16_object = Obj(); var_17_object = Obj(); // 0x2ec PushV
	var_18_int = 272; // 0x2ed PushI
	var_19_int = 2; // 0x2ee PushI
	var_20_int = 521226; // 0x2ef PushI
	CreateDiaryEntry(var_17_object, var_18_int, var_19_int, var_20_int); // 0x2f0 Func
	var_21_bool = 0; var_22_object = Obj(); var_23_int = 0; // 0x2f2 PushV
	var_22_object = var_17_object; // 0x2f3 Mov
	var_23_int = 270; // 0x2f4 MovI
	func_774(var_21_bool, var_22_object, var_23_int); // 0x2f5 NEW_2
	return 2; // 0x2f7 Return
}


func_621(var_120_string)
{
	var_121_bool = 0; var_122_float = 0; var_123_float = 0; var_124_bool = 0; var_125_float = 0; var_126_float = 0; // 0x26d PushV
	lshHasAnimation(var_124_bool, var_120_string); // 0x26e Func
	var_127_bool = var_124_bool; // 0x270 Push
	if(var_127_bool == 0) goto Label_632; // 0x271 JumpB
	lshGetAnimTimes(var_120_string, var_125_float, var_126_float); // 0x272 Func
	var_128_bool = 0; // 0x274 PushB
	lshPlayAnimation(var_125_float, var_126_float, var_128_bool); // 0x275 Func
	goto Label_636; // 0x277 Jump
	
Label_636:
	return 6; // 0x27c Return
	
Label_632:
	var_129_string = "Can't find lsh animation : "; // 0x278 PushS
	var_130_int = var_129_string + var_120_string; // 0x279 Add
	Trace(var_130_int); // 0x27a Func
}


func_761(var_30_object)
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x2f9 PushV
	GetDiaryRoot(var_32_object); // 0x2fa Func
	var_33_bool = var_32_object == 0; // 0x2fc Not
	if(var_33_bool == 0) goto Label_771; // 0x2fd JumpB
	var_34_string = "Can't retrieve diary root"; // 0x2fe PushS
	Trace(var_34_string); // 0x2ff Func
	var_30_object = 0; // 0x301 MovB
	return 2; // 0x302 Return
	
Label_771:
	var_30_object = var_32_object; // 0x303 Mov
	return 2; // 0x304 Return
}


func_637(var_101_string, var_102_bool)
{
	var_105_bool = 0; var_106_float = 0; var_107_float = 0; var_108_bool = 0; var_109_float = 0; var_110_float = 0; // 0x27d PushV
	lshHasAnimation(var_108_bool, var_101_string); // 0x27e Func
	var_111_bool = var_108_bool; // 0x280 Push
	if(var_111_bool == 0) goto Label_647; // 0x281 JumpB
	lshGetAnimTimes(var_101_string, var_109_float, var_110_float); // 0x282 Func
	lshPlayAnimation(var_109_float, var_110_float, var_102_bool); // 0x284 Func
...
Label_647:
	var_112_string = "Can't find lsh animation : "; // 0x287 PushS
	var_113_int = var_112_string + var_101_string; // 0x288 Add
	Trace(var_113_int); // 0x289 Func
}
