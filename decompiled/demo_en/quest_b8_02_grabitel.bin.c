task_0_event_17(var_0_bool, var_1_object, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_float, var_7_int, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2926(var_17_object); // 0x6e NEW_2
...
task_0_event_30(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_float, var_9_int, var_10_bool, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0x75 NEW_2
...
task_1_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2926(var_17_object); // 0xb9 NEW_2
...
task_1_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_object, var_8_object, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0xc0 NEW_2
...
task_2_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2926(var_17_object); // 0x362 NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_object, var_11_object, var_12_bool, var_13_bool, var_14_bool, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0x369 NEW_2
...
task_2_event_7(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_int, var_11_bool, var_12_bool, var_13_bool, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2723(var_19_object); // 0x3ae NEW_2
...
task_3_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2902(var_17_bool, var_18_object); // 0x4be NEW_2
	...
	func_2909(var_115_object); // 0x4c6 NEW_2
...
task_3_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2878(var_17_bool, var_18_object); // 0x4cc NEW_2
	...
	func_2885(var_115_object); // 0x4d4 NEW_2
...
Label_1238:
	...
	func_2939(var_61_object); // 0x4dd NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0x4e4 NEW_2
...
task_4_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2902(var_17_bool, var_18_object); // 0x54c NEW_2
	...
	func_2909(var_114_object); // 0x554 NEW_2
...
task_4_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2878(var_17_bool, var_18_object); // 0x55a NEW_2
	...
	func_2885(var_114_object); // 0x562 NEW_2
...
Label_1380:
	...
	func_2939(var_60_object); // 0x56b NEW_2
...
task_4_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0x572 NEW_2
...
task_5_event_1(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2902(var_17_bool, var_18_object); // 0x5e5 NEW_2
	...
	func_2909(var_114_object); // 0x5ed NEW_2
...
task_5_event_3(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2878(var_17_bool, var_18_object); // 0x5f3 NEW_2
	...
	func_2885(var_114_object); // 0x5fb NEW_2
...
Label_1533:
	...
	func_2939(var_60_object); // 0x604 NEW_2
...
task_5_event_30(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_object, var_14_object, var_15_bool, var_16_bool, var_17_object, var_18_bool)
{
	...
	func_2967(var_19_bool, var_20_object, var_21_object); // 0x60b NEW_2
...
task_6_event_17(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_2939(var_19_object); // 0x660 NEW_2
...
task_8_event_0(var_0_bool, var_1_object, var_2_int, var_3_int, var_4_bool, var_5_float, var_6_int, var_7_bool, var_8_object, var_9_bool, var_10_bool, var_11_bool, var_12_bool, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_3061(var_20_object); // 0x74c NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0xbcb PushV
	var_20_object = var_16_object; // 0xbcc Mov
	var_21_int = var_17_int; // 0xbcd Mov
	var_22_float = var_18_float; // 0xbce Mov
	func_2328(var_20_object, var_21_int, var_22_float); // 0xbcf NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0xbd3 PushV
	var_22_object = var_16_object; // 0xbd4 Mov
	var_23_int = var_17_int; // 0xbd5 Mov
	var_24_float = var_18_float; // 0xbd6 Mov
	var_25_cvector = var_20_cvector; // 0xbd7 Mov
	var_26_cvector = var_21_cvector; // 0xbd8 Mov
	func_2396(var_24_float, var_25_cvector, var_26_cvector); // 0xbd9 NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0xbdc PushV
	var_20_string = "health"; // 0xbdd PushS
	var_21_bool = var_17_string == var_20_string; // 0xbde Eq
	if(var_21_bool == 0) goto Label_3048; // 0xbdf JumpB
	var_22_string = "health"; // 0xbe0 PushS
	GetProperty(var_22_string, var_19_float); // 0xbe1 Func
	var_23_int = 0; // 0xbe3 PushI
	var_24_bool = var_19_float <= var_23_int; // 0xbe4 LE
	if(var_24_bool == 0) goto Label_3048; // 0xbe5 JumpB
	SignalDeath(var_16_object); // 0xbe6 Func
	
Label_3048:
	return 2; // 0xbe8 Return
}
...
{
	var_17_object = Obj(); // 0xbea PushV
	var_17_object = var_16_object; // 0xbeb Mov
	func_3000(var_17_object); // 0xbec NEW_2
...
{
	var_16_object = Obj(); // 0xc94 PushV
	func_2591(var_16_object); // 0xc95 NEW_2
	RemoveActor(var_16_object); // 0xc97 Func
	Hold(); // 0xc99 Func
...
func_0(var_0_bool, var_92_bool, var_93_object, var_210_object)
{
	...
	func_2723(var_109_object); // 0x3 NEW_2
...
Label_39:
	...
	func_2773(var_152_cvector, var_153_cvector, var_154_cvector, var_155_float); // 0x4b NEW_2
...
func_3074(var_66_int, var_67_int)
{
	var_68_int = 0; var_69_bool = 0; var_70_int = 0; var_71_bool = 0; // 0xc02 PushV
	var_72_bool = var_66_int > var_67_int; // 0xc03 GT
	if(var_72_bool == 0) goto Label_3081; // 0xc04 JumpB
	var_73_string = "GenerateMoney: iMin > iMax"; // 0xc05 PushS
	Trace(var_73_string); // 0xc06 Func
	return 4; // 0xc08 Return
	
Label_3081:
	var_70_int = 0; // 0xc09 MovI
	var_74_bool = var_66_int != var_67_int; // 0xc0a Neq
	if(var_74_bool == 0) goto Label_3088; // 0xc0b JumpB
	var_75_int = var_67_int - var_66_int; // 0xc0c Sub
	irand(var_70_int, var_75_int); // 0xc0d Func
	goto Label_3092; // 0xc0f Jump
	
Label_3092:
	var_70_int = var_70_int + var_66_int; // 0xc14 Add2
	var_76_int = 0; // 0xc15 PushI
	var_77_bool = var_70_int == var_76_int; // 0xc16 Eq
	if(var_77_bool == 0) goto Label_3097; // 0xc17 JumpB
	return 4; // 0xc18 Return
	
Label_3097:
	var_78_int = 0; var_79_string = ""; // 0xc19 PushV
	var_79_string = "Money"; // 0xc1a MovS
	func_3215(var_78_int, var_79_string); // 0xc1b NEW_2
	var_82_int = 0; // 0xc1d PushI
	AddItem(var_71_bool, var_78_int, var_82_int, var_70_int); // 0xc1e Func
	return 4; // 0xc20 Return
	
Label_3088:
	var_83_int = 0; // 0xc10 PushI
	var_84_bool = var_66_int == var_83_int; // 0xc11 Eq
	if(var_84_bool == 0) goto Label_3092; // 0xc12 JumpB
...
Label_2081:
	var_605_string = "armor"; // 0x821 PushS
	GetProperty(var_605_string, var_558_int); // 0x822 ObjFunc
}
...
func_3105(var_140_string)
{
	var_141_object = Obj(); var_142_int = 0; var_143_bool = 0; var_144_object = Obj(); var_145_int = 0; var_146_bool = 0; // 0xc21 PushV
	CreateInvItem(var_144_object); // 0xc22 Func
	SetItemName(var_140_string); // 0xc24 ObjFunc
	var_147_string = "Organ"; // 0xc26 PushS
	var_148_int = 1; // 0xc27 PushI
	SetProperty(var_147_string, var_148_int); // 0xc28 ObjFunc
	GetItemID(var_145_int); // 0xc2a ObjFunc
	var_149_int = 0; // 0xc2c PushI
	var_150_int = 1; // 0xc2d PushI
	AddItem(var_146_bool, var_144_object, var_149_int, var_150_int); // 0xc2e Func
	return 6; // 0xc30 Return
}
...
func_3122()
{
	var_134_int = 0; // 0xc32 PushV
	func_3055(var_134_int); // 0xc33 NEW_2
	var_138_int = 1; // 0xc35 PushI
	var_139_bool = var_134_int != var_138_int; // 0xc36 Neq
	if(var_139_bool == 0) goto Label_3129; // 0xc37 JumpB
	return 0; // 0xc38 Return
	
Label_3129:
	var_140_string = ""; // 0xc39 PushV
	var_140_string = "liver"; // 0xc3a MovS
	func_3105(var_140_string); // 0xc3b NEW_2
	var_151_string = ""; // 0xc3d PushV
	var_151_string = "kidney"; // 0xc3e MovS
	func_3105(var_151_string); // 0xc3f NEW_2
	var_152_string = ""; // 0xc41 PushV
	var_152_string = "heart"; // 0xc42 MovS
	func_3105(var_152_string); // 0xc43 NEW_2
	var_153_string = ""; // 0xc45 PushV
	var_153_string = "blood"; // 0xc46 MovS
	func_3105(var_153_string); // 0xc47 NEW_2
...
func_3146()
{
	var_61_int = 0; var_62_bool = 0; var_63_int = 0; var_64_bool = 0; // 0xc4a PushV
	var_65_int = 0; // 0xc4b PushI
	ClearSubContainer(var_65_int); // 0xc4c Func
	var_66_int = 0; var_67_int = 0; // 0xc4e PushV
	var_66_int = 1500; // 0xc4f MovI
	var_67_int = 3000; // 0xc50 MovI
	func_3074(var_66_int, var_67_int); // 0xc51 NEW_2
	var_85_string = ""; var_86_int = 0; var_87_int = 0; // 0xc53 PushV
	var_85_string = "Knife"; // 0xc54 MovS
	var_86_int = 1; // 0xc55 MovI
	var_87_int = 4; // 0xc56 MovI
	func_2437(var_85_string, var_86_int, var_87_int); // 0xc57 NEW_2
	var_96_string = ""; var_97_int = 0; var_98_int = 0; // 0xc59 PushV
	var_96_string = "lockpick"; // 0xc5a MovS
	var_97_int = 1; // 0xc5b MovI
	var_98_int = 3; // 0xc5c MovI
	func_2437(var_96_string, var_97_int, var_98_int); // 0xc5d NEW_2
	var_99_string = ""; var_100_int = 0; var_101_int = 0; var_102_int = 0; // 0xc5f PushV
	var_99_string = "rifle_ammo"; // 0xc60 MovS
	var_100_int = 1; // 0xc61 MovI
	var_101_int = 3; // 0xc62 MovI
	var_102_int = 3; // 0xc63 MovI
	func_2448(var_99_string, var_100_int, var_101_int, var_102_int); // 0xc64 NEW_2
	var_113_string = ""; var_114_int = 0; var_115_int = 0; var_116_int = 0; // 0xc66 PushV
	var_113_string = "samopal_ammo"; // 0xc67 MovS
	var_114_int = 1; // 0xc68 MovI
	var_115_int = 3; // 0xc69 MovI
	var_116_int = 3; // 0xc6a MovI
	func_2448(var_113_string, var_114_int, var_115_int, var_116_int); // 0xc6b NEW_2
	var_117_string = ""; var_118_int = 0; var_119_int = 0; var_120_int = 0; // 0xc6d PushV
	var_117_string = "revolver_ammo"; // 0xc6e MovS
	var_118_int = 1; // 0xc6f MovI
	var_119_int = 3; // 0xc70 MovI
	var_120_int = 3; // 0xc71 MovI
	func_2448(var_117_string, var_118_int, var_119_int, var_120_int); // 0xc72 NEW_2
	var_121_string = ""; var_122_int = 0; var_123_int = 0; // 0xc74 PushV
	var_121_string = "Samopal"; // 0xc75 MovS
	var_122_int = 1; // 0xc76 MovI
	var_123_int = 20; // 0xc77 MovI
	func_2437(var_121_string, var_122_int, var_123_int); // 0xc78 NEW_2
	var_124_string = ""; var_125_int = 0; var_126_int = 0; // 0xc7a PushV
	var_124_string = "Revolver"; // 0xc7b MovS
	var_125_int = 1; // 0xc7c MovI
	var_126_int = 20; // 0xc7d MovI
	func_2437(var_124_string, var_125_int, var_126_int); // 0xc7e NEW_2
	var_127_string = ""; var_128_int = 0; var_129_int = 0; // 0xc80 PushV
	var_127_string = "Rifle"; // 0xc81 MovS
	var_128_int = 1; // 0xc82 MovI
	var_129_int = 20; // 0xc83 MovI
	func_2437(var_127_string, var_128_int, var_129_int); // 0xc84 NEW_2
	var_130_int = 0; var_131_string = ""; // 0xc86 PushV
	var_131_string = "grabitel_mark"; // 0xc87 MovS
	func_3215(var_130_int, var_131_string); // 0xc88 NEW_2
	var_132_int = 0; // 0xc8a PushI
	var_133_int = 1; // 0xc8b PushI
	AddItem(var_64_bool, var_130_int, var_132_int, var_133_int); // 0xc8c Func
...
func_2135(var_612_bool, var_613_object)
{
	var_614_float = 0; var_615_float = 0; // 0x857 PushV
	var_616_bool = 0; var_617_object = Obj(); var_618_string = ""; // 0x858 PushV
	var_617_object = var_613_object; // 0x859 Mov
	var_618_string = "health"; // 0x85a MovS
	func_2028(var_616_bool, var_617_object, var_618_string); // 0x85b NEW_2
	var_619_bool = var_616_bool == 0; // 0x85d Not
	if(var_619_bool == 0) goto Label_2145; // 0x85e JumpB
	var_612_bool = 0; // 0x85f MovB
	return 2; // 0x860 Return
	
Label_2145:
	var_620_bool = 0; // 0x861 PushV
	var_620_bool = 0; // 0x862 MovB
	var_621_bool = 0; var_622_object = Obj(); // 0x863 PushV
	var_622_object = var_613_object; // 0x864 Mov
	func_2023(var_621_bool, var_622_object); // 0x865 NEW_2
	if(var_621_bool == 0) goto Label_2157; // 0x867 JumpB
	var_623_bool = 0; // 0x868 PushV
	func_2743(var_623_bool); // 0x869 NEW_2
	if(var_623_bool == 0) goto Label_2157; // 0x86b JumpB
	var_620_bool = 1; // 0x86c MovB
	
Label_2157:
	if(var_620_bool == 0) goto Label_2160; // 0x86d JumpB
	var_612_bool = 0; // 0x86e MovB
	return 2; // 0x86f Return
	
Label_2160:
	var_627_string = "health"; // 0x870 PushS
	GetProperty(var_627_string, var_615_float); // 0x871 ObjFunc
	var_628_float = 0.0; // 0x873 PushF
	var_612_bool = var_615_float <= var_628_float; // 0x874 LE2
...
Label_2689:
	...
	func_2713(var_29_float); // 0xa83 NEW_2
...
func_2703(var_601_float)
{
	...
	var_604_int = 15; // 0xa94 PushI
	SendWorldWndMessage(var_604_int, var_603_object); // 0xa95 Func
	return 2; // 0xa97 Return
}


func_3215(var_78_int, var_79_string)
{
	var_80_int = 0; var_81_int = 0; // 0xc8f PushV
	GetInvItemByName(var_81_int, var_79_string); // 0xc90 Func
	var_78_int = var_81_int; // 0xc92 Mov
	return 2; // 0xc93 Return
}


func_2713(var_29_float)
{
	var_30_object = Obj(); var_31_object = Obj(); // 0xa99 PushV
	CreateFloatVector(var_31_object); // 0xa9a Func
	add(var_29_float); // 0xa9c ObjFunc
	var_32_int = 16; // 0xa9e PushI
	SendWorldWndMessage(var_32_int, var_31_object); // 0xa9f Func
...
func_162(var_607_object, var_608_float)
{
	...
	func_2135(var_612_bool, var_613_object); // 0xaa NEW_2
...
func_2723(var_109_object)
{
	var_110_bool = 0; var_111_bool = 0; // 0xaa3 PushV
	IsPlayerActor(var_109_object, var_111_bool); // 0xaa4 Func
	var_112_bool = var_111_bool; // 0xaa6 Push
	if(var_112_bool == 0) goto Label_2731; // 0xaa7 JumpB
	var_113_string = "attack"; // 0xaa8 PushS
	PlayGlobalMusic(var_113_string); // 0xaa9 Func
...
func_2732()
{
	var_131_object = Obj(); var_132_object = Obj(); // 0xaac PushV
	GetScene(var_132_object); // 0xaad Func
	var_133_string = "battle"; // 0xaaf PushS
	var_134_object = Obj(); // 0xab0 PushV
	func_2591(var_134_object); // 0xab1 NEW_2
	BroadcastMessage(var_133_string, var_134_object, var_132_object); // 0xab3 Func
...
func_2743(var_623_bool)
{
	var_624_bool = 0; var_625_bool = 0; // 0xab7 PushV
	var_626_string = "god_mode"; // 0xab8 PushS
	GetVariable(var_626_string, var_625_bool); // 0xab9 Func
	var_623_bool = var_625_bool; // 0xabb Mov
	return 2; // 0xabc Return
}


func_2749(var_73_string, var_74_int)
{
	var_75_string = ""; var_76_string = ""; // 0xabd PushV
	var_76_string = "idle"; // 0xabe MovS
	var_77_int = var_74_int; // 0xabf Push
	if(var_77_int == 0) goto Label_2754; // 0xac0 JumpB
	var_76_string = var_76_string + var_74_int; // 0xac1 Add2
	
Label_2754:
	var_73_string = var_76_string; // 0xac2 Mov
	return 2; // 0xac3 Return
}


func_2756(var_67_int)
{
	var_68_int = 0; var_69_bool = 0; var_70_int = 0; var_71_bool = 0; // 0xac4 PushV
	var_70_int = 0; // 0xac5 MovI
	
Label_2758:
	var_72_string = "all"; // 0xac6 PushS
	var_73_string = ""; var_74_int = 0; // 0xac7 PushV
	var_74_int = var_70_int; // 0xac8 Mov
	func_2749(var_73_string, var_74_int); // 0xac9 NEW_2
	HasAnimation(var_71_bool, var_72_string, var_73_string); // 0xacb Func
	var_78_bool = var_71_bool == 0; // 0xacd Not
	if(var_78_bool == 0) goto Label_2768; // 0xace JumpB
	goto Label_2771; // 0xacf Jump
	
Label_2771:
	var_67_int = var_70_int; // 0xad3 Mov
	return 4; // 0xad4 Return
	
Label_2768:
	var_79_int = 1; // 0xad0 PushI
	var_70_int = var_70_int + var_79_int; // 0xad1 Add2
	goto Label_2758; // 0xad2 Jump
}
...
Label_359:
	...
	func_2207(var_674_bool, var_675_object); // 0x180 NEW_2
...
func_2773(var_152_cvector, var_153_cvector, var_154_cvector, var_155_float)
{
	var_156_cvector = CVector(0,0,0); var_157_float = 0; var_158_float = 0; var_159_float = 0; var_160_float = 0; var_161_float = 0; var_162_cvector = CVector(0,0,0); var_163_float = 0; var_164_float = 0; var_165_float = 0; var_166_float = 0; var_167_float = 0; // 0xad5 PushV
	var_162_cvector = var_154_cvector - var_153_cvector; // 0xad6 Sub2
	var_163_float = 250000; // 0xad7 MovI
	var_168_float = GetByIndex(var_162_cvector, 1); // 0xad8 PushE
	var_169_int = 1000; // 0xad9 PushI
	var_170_float = var_168_float * var_169_int; // 0xada Mult
	var_171_float = var_155_float * var_155_float; // 0xadb Mult
	var_164_float = var_170_float - var_171_float; // 0xadc Sub2
	var_165_float = var_162_cvector | var_162_cvector; // 0xadd Or2
	var_172_float = 0; var_173_float = 0; var_174_float = 0; var_175_float = 0; // 0xade PushV
	var_173_float = var_163_float; // 0xadf Mov
	var_174_float = var_164_float; // 0xae0 Mov
	var_175_float = var_165_float; // 0xae1 Mov
	func_2614(var_172_float, var_173_float, var_174_float, var_175_float); // 0xae2 NEW_2
	var_166_float = var_172_float; // 0xae3 Mov
	var_180_int = 0; // 0xae5 PushI
	var_181_bool = var_166_float < var_180_int; // 0xae6 LT
	if(var_181_bool == 0) goto Label_2794; // 0xae7 JumpB
	var_167_float = 1; // 0xae8 MovI
	goto Label_2802; // 0xae9 Jump
	
Label_2802:
	var_182_cvector = CVector(0.0, 500.0, 0.0); // 0xaf2 PushVec
	var_183_float = var_182_cvector * var_167_float; // 0xaf3 Mult
	var_184_float = var_183_float * var_167_float; // 0xaf4 Mult
	var_185_int = var_162_cvector + var_184_float; // 0xaf5 Add
	var_152_cvector = var_185_int / var_185_int; // 0xaf6 Div2
	return 12; // 0xaf7 Return
	
Label_2794:
	var_186_float = 0; var_187_float = 0; var_188_float = 0; var_189_float = 0; var_190_float = 0; // 0xaea PushV
	var_187_float = var_163_float; // 0xaeb Mov
	var_188_float = var_164_float; // 0xaec Mov
	var_189_float = var_165_float; // 0xaed Mov
	var_190_float = sqrt(var_166_float); // 0xaee Sqrt2
	func_2621(var_187_float, var_188_float, var_189_float, var_190_float); // 0xaef NEW_2
	var_167_float = sqrt(var_186_float); // 0xaf1 Sqrt2
}
...
func_2808(var_26_bool, var_27_object)
{
	var_28_string = ""; var_29_string = ""; var_30_string = ""; var_31_string = ""; // 0xaf8 PushV
	var_32_bool = 0; var_33_object = Obj(); var_34_string = ""; // 0xaf9 PushV
	var_33_object = var_27_object; // 0xafa Mov
	var_34_string = "class"; // 0xafb MovS
	func_2028(var_32_bool, var_33_object, var_34_string); // 0xafc NEW_2
	var_41_bool = var_32_bool == 0; // 0xafe Not
	if(var_41_bool == 0) goto Label_2818; // 0xaff JumpB
	var_26_bool = 0; // 0xb00 MovB
	return 4; // 0xb01 Return
	
Label_2818:
	var_42_string = "class"; // 0xb02 PushS
	GetProperty(var_42_string, var_30_string); // 0xb03 Func
	var_43_string = "class"; // 0xb05 PushS
	GetProperty(var_43_string, var_31_string); // 0xb06 ObjFunc
	var_26_bool = var_31_string == var_30_string; // 0xb08 Eq2
...
func_2826()
{
	var_16_object = GlobalVars[1]; // 0xb0a PushGE
	var_17_object = Obj(); // 0xb0b PushV
	func_2662(var_17_object); // 0xb0c NEW_2
	var_16_object = var_17_object; // 0xb0d Mov
	GlobalVars[1] = var_16_object; // 0xb0f PopGE
	return 0; // 0xb10 Return
}


func_2833(var_19_bool, var_20_object)
{
	var_21_bool = 0; var_22_float = 0; var_23_string = ""; var_24_bool = 0; var_25_float = 0; var_26_string = ""; // 0xb11 PushV
	var_27_bool = 0; var_28_object = Obj(); // 0xb12 PushV
	var_28_object = var_20_object; // 0xb13 Mov
	func_2207(var_27_bool, var_28_object); // 0xb14 NEW_2
	var_61_bool = var_27_bool == 0; // 0xb16 Not
	if(var_61_bool == 0) goto Label_2842; // 0xb17 JumpB
	var_19_bool = 0; // 0xb18 MovB
	return 6; // 0xb19 Return
	
Label_2842:
	var_62_object = GlobalVars[1]; // 0xb1a PushGE
	in(var_24_bool, var_20_object); // 0xb1b ObjFunc
	var_63_bool = var_24_bool; // 0xb1d Push
	if(var_63_bool == 0) goto Label_2849; // 0xb1e JumpB
	var_19_bool = 1; // 0xb1f MovB
	return 6; // 0xb20 Return
	
Label_2849:
	var_64_bool = 0; var_65_object = Obj(); // 0xb21 PushV
	var_65_object = var_20_object; // 0xb22 Mov
	func_2023(var_64_bool, var_65_object); // 0xb23 NEW_2
	if(var_64_bool == 0) goto Label_2860; // 0xb25 JumpB
	var_68_string = "reputation"; // 0xb26 PushS
	GetProperty(var_68_string, var_25_float); // 0xb27 ObjFunc
	var_69_float = 0.33; // 0xb29 PushF
	var_19_bool = var_25_float >= var_69_float; // 0xb2a GE2
	return 6; // 0xb2b Return
	
Label_2860:
	var_70_bool = 0; var_71_object = Obj(); var_72_string = ""; // 0xb2c PushV
	var_71_object = var_20_object; // 0xb2d Mov
	var_72_string = "class"; // 0xb2e MovS
	func_2028(var_70_bool, var_71_object, var_72_string); // 0xb2f NEW_2
	var_73_bool = var_70_bool == 0; // 0xb31 Not
	if(var_73_bool == 0) goto Label_2869; // 0xb32 JumpB
	var_19_bool = 0; // 0xb33 MovB
	return 6; // 0xb34 Return
	
Label_2869:
	var_74_string = "class"; // 0xb35 PushS
	GetProperty(var_74_string, var_26_string); // 0xb36 ObjFunc
	var_75_bool = 0; var_76_string = ""; // 0xb38 PushV
	var_76_string = var_26_string; // 0xb39 Mov
	func_2504(var_75_bool, var_76_string); // 0xb3a NEW_2
	var_19_bool = var_75_bool; // 0xb3b Mov
...
{
	func_3146(); // 0x722 NEW_2
	func_3122(); // 0x725 NEW_2
...
func_2878(var_17_bool, var_18_object)
{
	var_19_bool = 0; var_20_object = Obj(); // 0xb3f PushV
	var_20_object = var_18_object; // 0xb40 Mov
	func_2833(var_19_bool, var_20_object); // 0xb41 NEW_2
	var_17_bool = var_19_bool; // 0xb42 Mov
...
func_2885(var_114_object)
{
	var_115_bool = 0; var_116_object = Obj(); // 0xb46 PushV
	var_116_object = var_114_object; // 0xb47 Mov
	TaskCall(7); // 0xb48 TaskCall
	func_1770(var_115_bool, var_116_object); // 0xb49 NEW_2
	TaskReturn(); // 0xb4a TaskReturn
	if(var_115_bool == 0) goto Label_2899; // 0xb4c JumpB
	var_750_object = Obj(); // 0xb4d PushV
	var_750_object = var_114_object; // 0xb4e Mov
	TaskCall(6); // 0xb4f TaskCall
	func_1555(var_753_bool, var_750_object); // 0xb50 NEW_2
...
func_847(var_0_bool)
{
	...
	func_2723(var_279_object); // 0x351 NEW_2
...
func_2902(var_17_bool, var_18_object)
{
	var_19_bool = 0; var_20_object = Obj(); // 0xb57 PushV
	var_20_object = var_18_object; // 0xb58 Mov
	func_2833(var_19_bool, var_20_object); // 0xb59 NEW_2
	var_17_bool = var_19_bool; // 0xb5a Mov
...
func_2909(var_114_object)
{
	var_115_bool = 0; var_116_object = Obj(); // 0xb5e PushV
	var_116_object = var_114_object; // 0xb5f Mov
	TaskCall(7); // 0xb60 TaskCall
	func_1770(var_115_bool, var_116_object); // 0xb61 NEW_2
	TaskReturn(); // 0xb62 TaskReturn
	if(var_115_bool == 0) goto Label_2923; // 0xb64 JumpB
	var_750_object = Obj(); // 0xb65 PushV
	var_750_object = var_114_object; // 0xb66 Mov
	TaskCall(6); // 0xb67 TaskCall
	func_1555(var_753_bool, var_750_object); // 0xb68 NEW_2
...
func_2926(var_20_object)
{
	var_21_bool = 0; var_22_bool = 0; // 0xb6e PushV
	var_23_bool = var_20_object == 0; // 0xb6f NullEq
	if(var_23_bool == 0) goto Label_2930; // 0xb70 JumpB
	return 2; // 0xb71 Return
	
Label_2930:
	var_24_object = GlobalVars[1]; // 0xb72 PushGE
	in(var_22_bool, var_20_object); // 0xb73 ObjFunc
	var_25_bool = var_22_bool == 0; // 0xb75 Not
	if(var_25_bool == 0) goto Label_2938; // 0xb76 JumpB
	var_26_object = GlobalVars[1]; // 0xb77 PushGE
	add(var_20_object); // 0xb78 ObjFunc
...
func_887(var_2_int, var_282_bool, var_283_object, var_284_float, var_285_float, var_286_bool, var_287_bool)
{
	...
	func_2723(var_295_object); // 0x37a NEW_2
...
Label_1411:
	...
	func_2756(var_67_int); // 0x584 NEW_2
...
Label_1426:
	...
	func_2749(var_89_string, var_90_int); // 0x5a0 NEW_2
...
func_2939(var_19_object)
{
	var_20_object = Obj(); // 0xb7c PushV
	var_20_object = var_19_object; // 0xb7d Mov
	func_2926(var_20_object); // 0xb7e NEW_2
	var_27_bool = 0; var_28_object = Obj(); // 0xb80 PushV
	var_28_object = var_19_object; // 0xb81 Mov
	func_2207(var_27_bool, var_28_object); // 0xb82 NEW_2
	var_61_bool = var_27_bool == 0; // 0xb84 Not
	if(var_61_bool == 0) goto Label_2951; // 0xb85 JumpB
	return 0; // 0xb86 Return
	
Label_2951:
	var_62_bool = 0; var_63_object = Obj(); // 0xb87 PushV
	var_63_object = var_19_object; // 0xb88 Mov
	TaskCall(7); // 0xb89 TaskCall
	func_1770(var_62_bool, var_63_object); // 0xb8a NEW_2
	TaskReturn(); // 0xb8b TaskReturn
	if(var_62_bool == 0) goto Label_2964; // 0xb8d JumpB
	var_699_object = Obj(); // 0xb8e PushV
	var_699_object = var_19_object; // 0xb8f Mov
	TaskCall(6); // 0xb90 TaskCall
	func_1555(var_702_bool, var_699_object); // 0xb91 NEW_2
...
func_2967(var_19_bool, var_20_object, var_21_object)
{
	var_22_bool = 0; var_23_float = 0; var_24_bool = 0; var_25_float = 0; // 0xb97 PushV
	var_26_bool = 0; var_27_object = Obj(); // 0xb98 PushV
	var_27_object = var_21_object; // 0xb99 Mov
	func_2808(var_26_bool, var_27_object); // 0xb9a NEW_2
	if(var_26_bool == 0) goto Label_2998; // 0xb9c JumpB
	CanSee(var_24_bool, var_20_object); // 0xb9d Func
	var_44_float = 0; var_45_object = Obj(); // 0xb9f PushV
	var_45_object = var_20_object; // 0xba0 Mov
	func_2015(var_45_object); // 0xba1 NEW_2
	var_25_float = var_44_float; // 0xba2 Mov
	var_52_bool = 0; // 0xba4 PushV
	var_52_bool = 0; // 0xba5 MovB
	var_53_float = 1000000.0; // 0xba6 PushF
	var_54_bool = var_25_float <= var_53_float; // 0xba7 LE
	if(var_54_bool == 0) goto Label_2995; // 0xba8 JumpB
	var_55_bool = 0; // 0xba9 PushV
	var_55_bool = 1; // 0xbaa MovB
	var_56_bool = var_24_bool; // 0xbab Push
	if(var_56_bool == 0) goto Label_2993; // 0xbac JumpB
	var_57_float = 490000.0; // 0xbad PushF
	var_58_bool = var_25_float <= var_57_float; // 0xbae LE
	if(var_58_bool == 0) goto Label_2993; // 0xbaf JumpB
	var_55_bool = 0; // 0xbb0 MovB
	
Label_2993:
	if(var_55_bool == 0) goto Label_2995; // 0xbb1 JumpB
	var_52_bool = 1; // 0xbb2 MovB
	
Label_2995:
	if(var_52_bool == 0) goto Label_2998; // 0xbb3 JumpB
	var_19_bool = 1; // 0xbb4 MovB
	return 4; // 0xbb5 Return
	
Label_2998:
	var_19_bool = 0; // 0xbb6 MovB
	return 4; // 0xbb7 Return
}
...
func_3000(var_17_object)
{
	var_18_bool = 0; var_19_object = Obj(); // 0xbb9 PushV
	var_19_object = var_17_object; // 0xbba Mov
	func_2023(var_18_bool, var_19_object); // 0xbbb NEW_2
	if(var_18_bool == 0) goto Label_3011; // 0xbbd JumpB
	var_22_bool = 0; var_23_object = Obj(); var_24_float = 0; // 0xbbe PushV
	var_23_object = var_17_object; // 0xbbf Mov
	var_24_float = 0.05; // 0xbc0 MovF
	func_2668(var_22_bool, var_23_object, var_24_float); // 0xbc1 NEW_2
	
Label_3011:
	var_60_object = Obj(); // 0xbc3 PushV
	var_60_object = var_17_object; // 0xbc4 Mov
	TaskCall(8); // 0xbc5 TaskCall
	func_1824(var_60_object); // 0xbc6 NEW_2
	TaskReturn(); // 0xbc7 TaskReturn
...
func_3055(var_134_int)
{
	var_135_int = 0; var_136_int = 0; // 0xbef PushV
	var_137_string = "branch"; // 0xbf0 PushS
	GetVariable(var_137_string, var_136_int); // 0xbf1 Func
	var_134_int = var_136_int; // 0xbf3 Mov
	return 2; // 0xbf4 Return
}


func_3061(var_20_object)
{
	var_21_int = 0; // 0xbf6 PushV
	func_3055(var_21_int); // 0xbf7 NEW_2
	var_25_int = 1; // 0xbf9 PushI
	var_26_bool = var_21_int == var_25_int; // 0xbfa Eq
	if(var_26_bool == 0) goto Label_3071; // 0xbfb JumpB
	WorkWithCorpse(var_20_object); // 0xbfc Func
...
Label_3071:
	Barter(var_20_object); // 0xbff Func
}
...
Label_542:
	...
	func_2207(var_637_bool, var_638_object); // 0x239 NEW_2
...
Label_594:
	...
	func_2207(var_663_bool, var_664_object); // 0x25f NEW_2
