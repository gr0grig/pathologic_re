...
Events:
EVENT_22 Op = 0x6b6 Vars = (object, int, float, float)
EVENT_43 Op = 0x6be Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x6c8 Vars = (object, string)
EVENT_41 Op = 0x6d5 Vars = (object)
...
0x64a: Pop(0)
0x64b: Push((int) 15)
0x64c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x64d: Pop(1)
0x64e: Return(); Pop(2)

0x64f: Stack[-1] = 0
0x650: PushEmpty(object, object)
0x651: @ CreateFloatVector(Stack[-1])
0x652: Pop(0)
0x653: @@ add(Stack[-3])
0x654: Pop(0)
0x655: Push((int) 16)
0x656: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x657: Pop(1)
0x658: Return(); Pop(2)

0x659: Stack[-1] = 0
0x65a: PushEmpty(object, object)
0x65b: @ FindActor(Stack[-1], Stack[-4])
0x65c: Pop(0)
0x65d: Pop(0); Push((bool) Stack[-1] == 0)
0x65e: IF (Stack[-1] == 0) GOTO 0x661; Pop(1)

0x65f: Stack[-5] = (bool) 0
0x660: Return(); Pop(2)

0x661: @ Trigger(Stack[-1], Stack[-3])
0x662: Pop(0)
0x663: Stack[-5] = (bool) 1
0x664: Return(); Pop(2)
...
0x6b6: PushEmpty()
0x6b7: PushEmpty(object, int, float)
0x6b8: Stack[-3] = Stack[-7]
0x6b9: Stack[-2] = Stack[-6]
0x6ba: Stack[-1] = Stack[-5]
0x6bb: Call2 0x570
...
0x6be: PushEmpty()
0x6bf: PushEmpty(object, int, float, cvector, cvector)
0x6c0: Stack[-5] = Stack[-11]
0x6c1: Stack[-4] = Stack[-10]
0x6c2: Stack[-3] = Stack[-9]
0x6c3: Stack[-2] = Stack[-7]
...
0x6c8: PushEmpty(float, float)
0x6c9: Push("health")
0x6ca: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6cb: IF (Stack[-1] == 0) GOTO 0x6d4; Pop(1)
...
0x6d2: @ SignalDeath(Stack[-4])
0x6d3: Pop(0)
0x6d4: Return(); Pop(2)

0x6d5: PushEmpty()
0x6d6: PushEmpty(object)
0x6d7: Stack[-1] = Stack[-2]
0x6d8: Call2 0x6db
...
0x6de: Push(-1, 0); TaskCall(2)
0x6df: Call2 0x3ab

0x6e0: Pop(-1, 0); TaskReturn
0x6e1: Pop(1)
0x6e2: Return(); Pop(0)
