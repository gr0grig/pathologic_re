...
0x2ea: @ GetVariable(Stack[-3], Stack[-1])
0x2eb: Pop(0)
...
0x306: Stack[-1] = (int) 515559
0x307: Return(); Pop(0)

0x308: Stack[-1] = (int) 503344
0x309: Return(); Pop(0)

0x30a: Stack[-1] = "ui/NPC_Citizen1.png"
0x30b: Return(); Pop(0)

0x30c: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x30d: Return(); Pop(0)
...
0x328: Push((int) 540)
0x329: Push((int) 2)
0x32a: Push((int) 530352)
0x32b: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x32c: Pop(3)
0x32d: PushEmpty(bool, object, int)
0x32e: Stack[-2] = Stack[-4]
0x32f: Stack[-1] = (int) 532
0x330: Call2 0x341
...
0x335: @ GetDiaryRoot(Stack[-1])
0x336: Pop(0)
0x337: Pop(0); Push((bool) Stack[-1] == 0)
0x338: IF (Stack[-1] == 0) GOTO 0x33e; Pop(1)

0x339: Push("Can't retrieve diary root")
0x33a: @ Trace(Stack[-1])
0x33b: Pop(1)
0x33c: Stack[-3] = (bool) 0
0x33d: Return(); Pop(2)
...
0x340: Stack[-1] = 0
0x341: PushEmpty(object, object, int, object, object, int)
0x342: PushEmpty(object)
0x343: Call2 0x334

0x344: Stack[-4] = Stack[-1]
0x345: Pop(1)
0x346: @@ Find(Stack[-7], Stack[-2])
0x347: Pop(0)
0x348: Pop(0); Push((bool) Stack[-2] == 0)
0x349: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x34a: Push("Can't find diary parent with id: ")
0x34b: Pop(1); Push(Stack[-1] + Stack[-8]);
0x34c: @ Trace(Stack[-1])
0x34d: Pop(1)
0x34e: Stack[-9] = (bool) 0
0x34f: Return(); Pop(6)

0x350: @@ AddChild(Stack[-8])
0x351: Pop(0)
0x352: Push((int) 7)
0x353: @ SendWorldWndMessage(Stack[-1])
0x354: Pop(1)
0x355: @@ GetCategory(Stack[-1])
0x356: Pop(0)
0x357: @ SetDiarySection(Stack[-1])
0x358: Pop(0)
0x359: Stack[-9] = (bool) 0
0x35a: Return(); Pop(6)
