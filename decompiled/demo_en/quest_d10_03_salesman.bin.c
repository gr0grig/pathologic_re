...
Label_198:
	...
	func_763(var_48_object); // 0xcb NEW_2
...
Label_292:
	...
	func_854(var_108_bool); // 0x126 NEW_2
...
Label_382:
	...
	func_703(var_19_object); // 0x180 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_685(var_29_object); // 0x1bd NEW_2
...
func_775()
{
	var_22_object = Obj(); var_23_object = Obj(); // 0x307 PushV
	var_24_int = 674; // 0x308 PushI
	var_25_int = 2; // 0x309 PushI
	var_26_int = 534159; // 0x30a PushI
	CreateDiaryEntry(var_23_object, var_24_int, var_25_int, var_26_int); // 0x30b Func
	var_27_bool = 0; var_28_object = Obj(); var_29_int = 0; // 0x30d PushV
	var_28_object = var_23_object; // 0x30e Mov
	var_29_int = 672; // 0x30f MovI
	func_801(var_27_bool, var_28_object, var_29_int); // 0x310 NEW_2
...
func_654(var_132_string)
{
	var_133_bool = 0; var_134_float = 0; var_135_float = 0; var_136_bool = 0; var_137_float = 0; var_138_float = 0; // 0x28e PushV
	lshHasAnimation(var_136_bool, var_132_string); // 0x28f Func
	var_139_bool = var_136_bool; // 0x291 Push
	if(var_139_bool == 0) goto Label_665; // 0x292 JumpB
	lshGetAnimTimes(var_132_string, var_137_float, var_138_float); // 0x293 Func
	var_140_bool = 0; // 0x295 PushB
	lshPlayAnimation(var_137_float, var_138_float, var_140_bool); // 0x296 Func
...
Label_665:
	var_141_string = "Can't find lsh animation : "; // 0x299 PushS
	var_142_int = var_141_string + var_132_string; // 0x29a Add
	Trace(var_142_int); // 0x29b Func
}


func_788(var_36_object)
{
	var_37_object = Obj(); var_38_object = Obj(); // 0x314 PushV
	GetDiaryRoot(var_38_object); // 0x315 Func
	var_39_bool = var_38_object == 0; // 0x317 Not
	if(var_39_bool == 0) goto Label_798; // 0x318 JumpB
	var_40_string = "Can't retrieve diary root"; // 0x319 PushS
	Trace(var_40_string); // 0x31a Func
	var_36_object = 0; // 0x31c MovB
	return 2; // 0x31d Return
	
Label_798:
	var_36_object = var_38_object; // 0x31e Mov
	return 2; // 0x31f Return
}


func_670(var_110_string, var_111_bool)
{
	var_114_bool = 0; var_115_float = 0; var_116_float = 0; var_117_bool = 0; var_118_float = 0; var_119_float = 0; // 0x29e PushV
	lshHasAnimation(var_117_bool, var_110_string); // 0x29f Func
	var_120_bool = var_117_bool; // 0x2a1 Push
	if(var_120_bool == 0) goto Label_680; // 0x2a2 JumpB
	lshGetAnimTimes(var_110_string, var_118_float, var_119_float); // 0x2a3 Func
	lshPlayAnimation(var_118_float, var_119_float, var_111_bool); // 0x2a5 Func
...
Label_680:
	var_121_string = "Can't find lsh animation : "; // 0x2a8 PushS
	var_122_int = var_121_string + var_110_string; // 0x2a9 Add
	Trace(var_122_int); // 0x2aa Func
}


func_801(var_27_bool, var_28_object, var_29_int)
{
	var_30_object = Obj(); var_31_object = Obj(); var_32_int = 0; var_33_object = Obj(); var_34_object = Obj(); var_35_int = 0; // 0x321 PushV
	var_36_object = Obj(); // 0x322 PushV
	func_788(var_36_object); // 0x323 NEW_2
	var_33_object = var_36_object; // 0x324 Mov
	Find(var_29_int, var_34_object); // 0x326 ObjFunc
	var_41_bool = var_34_object == 0; // 0x328 Not
	if(var_41_bool == 0) goto Label_816; // 0x329 JumpB
	var_42_string = "Can't find diary parent with id: "; // 0x32a PushS
	var_43_int = var_42_string + var_29_int; // 0x32b Add
	Trace(var_43_int); // 0x32c Func
	var_27_bool = 0; // 0x32e MovB
	return 6; // 0x32f Return
	
Label_816:
	AddChild(var_28_object); // 0x330 ObjFunc
	var_44_int = 7; // 0x332 PushI
	SendWorldWndMessage(var_44_int); // 0x333 Func
	GetCategory(var_35_int); // 0x335 ObjFunc
	SetDiarySection(var_35_int); // 0x337 Func
	var_27_bool = 0; // 0x339 MovB
...
func_162(var_2_object, var_106_string)
{
	...
	func_854(var_107_bool); // 0xa4 NEW_2
...
Label_180:
	func_670(var_110_string, var_111_bool); // 0xb4 NEW_2
...
func_685(var_29_object)
{
	var_30_float = 0; var_31_cvector = CVector(0,0,0); var_32_float = 0; var_33_cvector = CVector(0,0,0); // 0x2ad PushV
	GetEyesHeight(var_32_float); // 0x2ae ObjFunc
	var_33_cvector = CVector(0.0, 0.0, 0.0); // 0x2b0 MovV
	var_34_float = GetByIndex(var_33_cvector, 1); // 0x2b1 PushE
	var_34_float = var_32_float; // 0x2b2 Mov
	SetByIndex(var_33_cvector, 1) = var_34_float; // 0x2b3 PopE
	var_35_string = "head"; // 0x2b4 PushS
	LookAsync(var_29_object, var_35_string, var_33_cvector); // 0x2b5 Func
...
func_696()
{
	var_15_bool = 0; // 0x2b8 PushV
	func_854(var_15_bool); // 0x2b9 NEW_2
	if(var_15_bool == 0) goto Label_702; // 0x2bb JumpB
	lshStopSpeech(); // 0x2bc Func
...
func_569(var_27_bool, var_29_float)
{
	...
	func_709(var_54_cvector, var_55_cvector); // 0x254 NEW_2
...
Label_610:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x264 Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x266 PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x267 PushE
	Rotate(var_67_float, var_68_float); // 0x268 Func
	var_69_bool = 0; // 0x26a PushV
	func_854(var_69_bool); // 0x26b NEW_2
	if(var_69_bool == 0) goto Label_623; // 0x26d JumpB
	goto Label_631; // 0x26e Jump
	
Label_631:
	CameraWaitForPlayFinish(); // 0x277 Func
	ResumeWorld(); // 0x279 Func
	var_27_bool = 1; // 0x27b MovB
	return 18; // 0x27c Return
	
Label_623:
	var_70_string = "head"; // 0x26f PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x270 Func
	var_71_bool = var_47_bool; // 0x272 Push
	if(var_71_bool == 0) goto Label_631; // 0x273 JumpB
	var_72_string = "head"; // 0x274 PushS
	LookAsyncCamera(var_72_string); // 0x275 Func
}


func_829(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x33d PushV
	var_81_string = "branch"; // 0x33e PushS
	GetVariable(var_81_string, var_80_int); // 0x33f Func
	var_82_int = 0; // 0x341 PushI
	var_83_bool = var_80_int == var_82_int; // 0x342 Eq
	if(var_83_bool == 0) goto Label_839; // 0x343 JumpB
	var_78_int = 1; // 0x344 MovI
	return 2; // 0x345 Return
	
Label_839:
	var_84_int = 1; // 0x347 PushI
	var_85_bool = var_80_int == var_84_int; // 0x348 Eq
	if(var_85_bool == 0) goto Label_844; // 0x349 JumpB
	var_78_int = 2; // 0x34a MovI
	return 2; // 0x34b Return
	
Label_844:
	var_78_int = 3; // 0x34c MovI
	return 2; // 0x34d Return
}


func_703(var_19_object)
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x2bf PushV
	self(var_21_object); // 0x2c0 Func
	var_19_object = var_21_object; // 0x2c2 Mov
...
func_709(var_54_cvector, var_55_cvector)
{
	var_57_float = 0; var_58_float = 0; // 0x2c5 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x2c6 Or
	var_58_float = sqrt(var_59_int); // 0x2c7 Sqrt2
	var_60_float = 0.0; // 0x2c8 PushF
	var_61_bool = var_58_float < var_60_float; // 0x2c9 LT
	if(var_61_bool == 0) goto Label_717; // 0x2ca JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x2cb MovV
	return 2; // 0x2cc Return
	
Label_717:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x2cd Div2
...
func_74(var_0_object, var_1_object, var_2_object, var_3_string, var_87_object, var_88_object)
{
	...
	func_763(var_95_object); // 0x52 NEW_2
	...
	var_123_int = 534142; // 0x5e PushI
	SetMessage(var_123_int); // 0x5f TObjFunc
	ClearReplies(); // 0x61 TObjFunc
	var_124_int = 534435; // 0x63 PushI
	var_125_int = 36067; // 0x64 PushI
	var_126_int = 36066; // 0x65 PushI
	AddReply(var_124_int, var_125_int, var_126_int); // 0x66 TObjFunc
	var_127_int = 534437; // 0x68 PushI
	var_128_int = 36067; // 0x69 PushI
	var_129_int = 36068; // 0x6a PushI
	AddReply(var_127_int, var_128_int, var_129_int); // 0x6b TObjFunc
	goto Label_132; // 0x6d Jump
	
Label_132:
	var_130_bool = 0; // 0x84 PushV
	func_854(var_130_bool); // 0x85 NEW_2
...
Label_141:
	...
	func_654(var_132_string); // 0x8f NEW_2
...
func_846(var_75_int)
{
	var_75_int = 541582; // 0x34e MovI
	return 0; // 0x34f Return
}


func_719(var_96_int, var_97_string)
{
	var_98_int = 0; var_99_int = 0; // 0x2cf PushV
	GetVariable(var_97_string, var_99_int); // 0x2d0 Func
	var_96_int = var_99_int; // 0x2d2 Mov
...
func_848(var_74_int)
{
	var_74_int = 541581; // 0x350 MovI
	return 0; // 0x351 Return
}


func_850(var_76_string)
{
	var_76_string = "ui/NPC_Citizen3.png"; // 0x352 MovS
...
{
	var_77_string = "ui/NPC_Citizen3_b.png"; // 0x354 MovS
...
Label_353:
	...
	func_703(var_21_object); // 0x163 NEW_2
...
func_854(var_69_bool)
{
	var_69_bool = 0; // 0x356 MovB
...
Label_479:
	...
	func_731(var_46_int); // 0x1e0 NEW_2
...
Label_494:
	...
	func_724(var_68_string, var_69_int); // 0x1fc NEW_2
...
func_724(var_52_string, var_53_int)
{
	var_54_string = ""; var_55_string = ""; // 0x2d4 PushV
	var_55_string = "idle"; // 0x2d5 MovS
	var_56_int = var_53_int; // 0x2d6 Push
	if(var_56_int == 0) goto Label_729; // 0x2d7 JumpB
	var_55_string = var_55_string + var_53_int; // 0x2d8 Add2
	
Label_729:
	var_52_string = var_55_string; // 0x2d9 Mov
...
func_731(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x2db PushV
	var_49_int = 0; // 0x2dc MovI
	
Label_733:
	var_51_string = "all"; // 0x2dd PushS
	var_52_string = ""; var_53_int = 0; // 0x2de PushV
	var_53_int = var_49_int; // 0x2df Mov
	func_724(var_52_string, var_53_int); // 0x2e0 NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x2e2 Func
	var_57_bool = var_50_bool == 0; // 0x2e4 Not
	if(var_57_bool == 0) goto Label_743; // 0x2e5 JumpB
	goto Label_746; // 0x2e6 Jump
	
Label_746:
	var_46_int = var_49_int; // 0x2ea Mov
	return 4; // 0x2eb Return
	
Label_743:
	var_58_int = 1; // 0x2e7 PushI
	var_49_int = var_49_int + var_58_int; // 0x2e8 Add2
	goto Label_733; // 0x2e9 Jump
}


func_748()
{
	var_104_string = "ood10Salesman1"; // 0x2ed PushS
	var_105_int = 1; // 0x2ee PushI
	SetVariable(var_104_string, var_105_int); // 0x2ef Func
...
func_754()
{
	var_20_string = "d10q03"; // 0x2f3 PushS
	var_21_int = 2; // 0x2f4 PushI
	SetVariable(var_20_string, var_21_int); // 0x2f5 Func
	func_775(); // 0x2f8 NEW_2
	return 0; // 0x2fa Return
}


func_763(var_94_bool)
{
	var_96_int = 0; var_97_string = ""; // 0x2fc PushV
	var_97_string = "ood10Salesman1"; // 0x2fd MovS
	func_719(var_96_int, var_97_string); // 0x2fe NEW_2
	var_100_int = 0; // 0x300 PushI
	var_101_bool = var_96_int == var_100_int; // 0x301 Eq
	if(var_101_bool == 0) goto Label_773; // 0x302 JumpB
	var_94_bool = 1; // 0x303 MovB
	return 0; // 0x304 Return
	
Label_773:
	var_94_bool = 0; // 0x305 MovB
...
func_637()
{
	var_158_bool = 0; var_159_bool = 0; // 0x27d PushV
	CameraSwitchToNormal(); // 0x27e Func
	var_160_bool = 0; // 0x280 PushV
	func_854(var_160_bool); // 0x281 NEW_2
	if(var_160_bool == 0) goto Label_645; // 0x283 JumpB
...
Label_645:
	var_161_string = "head"; // 0x285 PushS
	HasAnimationTrack(var_159_bool, var_161_string); // 0x286 Func
	var_162_bool = var_159_bool; // 0x288 Push
	if(var_162_bool == 0) goto Label_653; // 0x289 JumpB
	var_163_string = "head"; // 0x28a PushS
	UnlookAsync(var_163_string); // 0x28b Func
}
