...
Events:
EVENT_22 Op = 0x578 Vars = (object, int, float, float)
EVENT_43 Op = 0x580 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x58a Vars = (object, string)
...
0x426: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x427: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x428: Pop(0)
...
0x42b: Stack[-7] = (int) 0
0x42c: Push((int) 1)
0x42d: Pop(1); Push(Stack[-8] + Stack[-1]);
0x42e: Pop(1); Push(Stack[-18] + Stack[-1]);
0x42f: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x430: Pop(1)
0x431: Pop(0); Push((bool) Stack[-6] == 0)
0x432: IF (Stack[-1] == 0) GOTO 0x434; Pop(1)

0x433: GOTO 0x437

0x434: Push((int) 1)
0x435: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x436: GOTO 0x42c

0x437: Pop(0); Push((bool) Stack[-7] == 0)
0x438: IF (Stack[-1] == 0) GOTO 0x43a; Pop(1)

0x439: Return(); Pop(16)

0x43a: @ irand(Stack[-5], Stack[-7])
0x43b: Pop(0)
0x43c: Push((int) 1)
0x43d: Pop(1); Push(Stack[-6] + Stack[-1]);
0x43e: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x43f: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x440: Pop(0)
0x441: Push(Stack[-4])
0x442: IF (Stack[-1] == 0) GOTO 0x44e; Pop(1)

0x443: @ GetEyesHeight(Stack[-3])
0x444: Pop(0)
0x445: @ GetDirection(Stack[-2])
0x446: Pop(0)
0x447: Push((int) 50)
0x448: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x449: Push(CvectorIndex(Stack[-1], 1))
0x44a: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x44b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x44c: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x44d: Pop(0)
0x44e: Return(); Pop(16)
...
0x454: Stack[-1] = 0
0x455: PushEmpty(float, float)
0x456: Pop(0); Push(Stack[-3] | Stack[-3]);
0x457: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x458: Push((float)0.0)
0x459: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x45a: IF (Stack[-1] == 0) GOTO 0x45d; Pop(1)

0x45b: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x45c: Return(); Pop(2)

0x45d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x45e: Return(); Pop(2)

0x45f: PushEmpty(int, int)
0x460: @ GetVariable(Stack[-3], Stack[-1])
0x461: Pop(0)
0x462: Stack[-4] = Stack[-1]
0x463: Return(); Pop(2)

0x464: PushEmpty(int, bool, int, bool)
0x465: @ GetInvItemByName(Stack[-2], Stack[-5])
0x466: Pop(0)
0x467: @@ HasItem(Stack[-2], Stack[-1])
0x468: Pop(0)
...
0x47b: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x47c: Stack[-4] = Stack[-1]
0x47d: Return(); Pop(2)

0x47e: PushEmpty(int, bool, int, bool)
0x47f: Stack[-2] = (int) 0
0x480: Push("all")
0x481: PushEmpty(string, int)
0x482: Stack[-1] = Stack[-5]
0x483: Call2 0x477

0x484: Pop(1)
0x485: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x486: Pop(2)
...
0x48a: Push((int) 1)
0x48b: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x48c: GOTO 0x480

0x48d: Stack[-5] = Stack[-2]
0x48e: Return(); Pop(4)

0x48f: PushEmpty()
0x490: Push("d11q01")
0x491: Push((int) 3)
0x492: @ SetVariable(Stack[-2], Stack[-1])
0x493: Pop(2)
0x494: PushEmpty()
0x495: Call2 0x504

0x496: Pop(0)
0x497: PushEmpty(bool, string, string)
0x498: Stack[-2] = "quest_d11_01"
0x499: Stack[-1] = "restore_andrei"
0x49a: Call2 0x46b

0x49b: Pop(3)
0x49c: Push((int) 0)
0x49d: @@ SetReturnValue(Stack[-1])
0x49e: Pop(1)
0x49f: Return(); Pop(0)

0x4a0: PushEmpty(int, int)
0x4a1: Push("burah_serum")
0x4a2: Push((int) 1)
0x4a3: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1])
0x4a4: Pop(2)
0x4a5: Return(); Pop(2)
...
0x4af: Stack[-2] = "quest_d11_01"
0x4b0: Stack[-1] = "restore_andrei"
0x4b1: Call2 0x46b

0x4b2: Pop(3)
0x4b3: Push((int) 1)
0x4b4: @@ SetReturnValue(Stack[-1])
0x4b5: Pop(1)
0x4b6: Return(); Pop(0)
...
0x4c1: Pop(2)
0x4c2: PushEmpty(bool, string, string)
0x4c3: Stack[-2] = "quest_d11_01"
0x4c4: Stack[-1] = "soldier_attack"
0x4c5: Call2 0x46b

0x4c6: Pop(3)
0x4c7: PushEmpty(bool, string, string)
0x4c8: Stack[-2] = "quest_d11_01"
0x4c9: Stack[-1] = "restore_andrei"
0x4ca: Call2 0x46b
...
0x4cd: PushEmpty()
0x4ce: Push("ood11Officer1")
0x4cf: Push((int) 1)
0x4d0: @ SetVariable(Stack[-2], Stack[-1])
0x4d1: Pop(2)
0x4d2: Return(); Pop(0)

0x4d3: PushEmpty()
0x4d4: PushEmpty(bool, object, string)
0x4d5: Stack[-2] = Stack[-4]
0x4d6: Stack[-1] = "burah_serum"
0x4d7: Call2 0x464
...
0x4f8: Push((int) 769)
0x4f9: Push((int) 1)
0x4fa: Push((int) 540066)
0x4fb: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x4fc: Pop(3)
0x4fd: PushEmpty(bool, object, int)
0x4fe: Stack[-2] = Stack[-4]
0x4ff: Stack[-1] = (int) 192
0x500: Call2 0x51e
...
0x554: Pop(0)
0x555: Push((int) 1)
0x556: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x557: IF (Stack[-1] == 0) GOTO 0x55b; Pop(1)

0x558: @ WorkWithCorpse(Stack[-1])
0x559: Pop(0)
0x55a: GOTO 0x55d

0x55b: @ Barter(Stack[-1])
0x55c: Pop(0)
0x55d: Return(); Pop(0)

0x55e: Stack[-1] = (int) 515572
0x55f: Return(); Pop(0)

0x560: Stack[-1] = (int) 504031
0x561: Return(); Pop(0)

0x562: Stack[-1] = "ui/NPC_Citizen2.png"
0x563: Return(); Pop(0)

0x564: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x565: Return(); Pop(0)
...
0x569: @ GetScene(Stack[-1])
0x56a: Pop(0)
0x56b: PushEmpty(object)
0x56c: Call2 0x44f

0x56d: Pop(0)
0x56e: @@ RemoveStationaryActor(Stack[-1])
0x56f: Pop(1)
0x570: PushEmpty(object)
0x571: Stack[-1] = Stack[-4]
0x572: Push(-1, 0); TaskCall(3)
0x573: Call2 0x27a

0x574: Pop(-1, 0); TaskReturn
0x575: Pop(1)
0x576: Return(); Pop(2)

0x577: Stack[-1] = 0
0x578: PushEmpty()
0x579: PushEmpty(object, int, float)
0x57a: Stack[-3] = Stack[-7]
0x57b: Stack[-2] = Stack[-6]
...
0x580: PushEmpty()
0x581: PushEmpty(object, int, float, cvector, cvector)
0x582: Stack[-5] = Stack[-11]
0x583: Stack[-4] = Stack[-10]
0x584: Stack[-3] = Stack[-9]
0x585: Stack[-2] = Stack[-7]
