task_0_event_26(var_0_object, var_1_object, var_2_object, var_3_object, var_4_object, var_5_bool, var_6_bool, var_7_int, var_8_bool, var_9_string)
{
	...
	func_17(var_19_int, var_20_object, var_21_bool); // 0x31 NEW_2
...
Label_68:
	...
	func_327(var_61_object, var_62_object, var_63_string, var_64_string, var_65_string); // 0x4d NEW_2
...
Label_84:
	...
	func_327(var_68_object, var_69_object, var_70_string, var_71_string, var_72_string); // 0x59 NEW_2
	...
	func_327(var_73_object, var_74_object, var_75_string, var_76_string, var_77_string); // 0x62 NEW_2
	...
	func_327(var_78_object, var_79_object, var_80_string, var_81_string, var_82_string); // 0x6b NEW_2
	...
	func_327(var_83_object, var_84_object, var_85_string, var_86_string, var_87_string); // 0x74 NEW_2
...
Label_122:
	...
	func_366(var_90_object, var_91_string); // 0x80 NEW_2
	var_6_bool = 1; // 0x82 TMovB
	goto Label_220; // 0x83 Jump
	
Label_132:
	var_102_string = "execute"; // 0x84 PushS
	var_103_bool = var_9_string == var_102_string; // 0x85 Eq
	if(var_103_bool == 0) goto Label_145; // 0x86 JumpB
	var_104_object = Obj(); var_105_string = ""; // 0x87 PushV
	var_104_object = var_4_object; // 0x88 MovT
	var_105_string = "execute"; // 0x89 MovS
	func_366(var_104_object, var_105_string); // 0x8a NEW_2
	var_6_bool = 0; // 0x8c TMovB
	func_232(); // 0x8e NEW_2
	goto Label_220; // 0x90 Jump
	
Label_145:
	var_118_string = "soldier_attack"; // 0x91 PushS
	var_119_bool = var_9_string == var_118_string; // 0x92 Eq
	if(var_119_bool == 0) goto Label_154; // 0x93 JumpB
	var_120_object = Obj(); var_121_string = ""; // 0x94 PushV
	var_120_object = var_3_object; // 0x95 MovT
	var_121_string = "attack"; // 0x96 MovS
	func_366(var_120_object, var_121_string); // 0x97 NEW_2
	goto Label_220; // 0x99 Jump
	
Label_154:
	var_122_string = "actor_unload"; // 0x9a PushS
	var_123_bool = var_9_string == var_122_string; // 0x9b Eq
	if(var_123_bool == 0) goto Label_176; // 0x9c JumpB
	var_124_int = var_7_int; // 0x9d PushT
	if(var_124_int == 0) goto Label_166; // 0x9e JumpB
	var_125_int = 1; // 0x9f PushI
	var_126_bool = var_7_int == var_125_int; // 0xa0 Eq
	if(var_126_bool == 0) goto Label_165; // 0xa1 JumpB
	func_248(var_19_int, var_20_object, var_21_bool); // 0xa3 NEW_2
...
Label_166:
	var_141_bool = var_6_bool; // 0xa6 PushT
	if(var_141_bool == 0) goto Label_175; // 0xa7 JumpB
	var_6_bool = 0; // 0xa8 TMovB
	func_232(); // 0xaa NEW_2
	func_248(var_19_int, var_20_object, var_21_bool); // 0xad NEW_2
	
Label_176:
	var_142_string = "soldier_dead"; // 0xb0 PushS
	var_143_bool = var_9_string == var_142_string; // 0xb1 Eq
	if(var_143_bool == 0) goto Label_207; // 0xb2 JumpB
	size(var_18_int); // 0xb3 TObjFunc
	var_19_int = 0; // 0xb5 MovI
	
Label_182:
	var_144_bool = var_19_int < var_18_int; // 0xb6 LT
	if(var_144_bool == 0) goto Label_197; // 0xb7 JumpB
	get(var_20_object, var_19_int); // 0xb8 TObjFunc
	var_145_object = var_20_object; // 0xba Push
	if(var_145_object == 0) goto Label_193; // 0xbb JumpB
	IsDead(var_21_bool); // 0xbc ObjFunc
	var_146_bool = var_21_bool == 0; // 0xbe Not
	if(var_146_bool == 0) goto Label_193; // 0xbf JumpB
	goto Label_197; // 0xc0 Jump
	
Label_197:
	var_147_bool = var_19_int == var_18_int; // 0xc5 Eq
	if(var_147_bool == 0) goto Label_206; // 0xc6 JumpB
	var_148_string = "d11q02"; // 0xc7 PushS
	var_149_int = 2; // 0xc8 PushI
	SetVariable(var_148_string, var_149_int); // 0xc9 Func
	var_150_bool = var_7_int == 0; // 0xcb Not
	if(var_150_bool == 0) goto Label_206; // 0xcc JumpB
...
Label_193:
	...
	var_151_int = 1; // 0xc2 PushI
	var_19_int = var_19_int + var_151_int; // 0xc3 Add2
	goto Label_182; // 0xc4 Jump
	
Label_207:
	var_152_string = "fail"; // 0xcf PushS
	var_153_bool = var_9_string == var_152_string; // 0xd0 Eq
	if(var_153_bool == 0) goto Label_214; // 0xd1 JumpB
	func_232(); // 0xd3 NEW_2
	goto Label_220; // 0xd5 Jump
	
Label_214:
	var_154_string = "completed"; // 0xd6 PushS
	var_155_bool = var_9_string == var_154_string; // 0xd7 Eq
	if(var_155_bool == 0) goto Label_220; // 0xd8 JumpB
	func_240(); // 0xda NEW_2
}
...
main(var_0_object, var_1_object, var_2_object, var_3_object, var_4_object, var_5_bool, var_6_bool, var_7_int, var_8_bool)
{
	...
	func_321(var_9_object); // 0x1 NEW_2
	var_3_object = var_9_object; // 0x2 TMov
	var_12_object = Obj(); // 0x4 PushV
	func_321(var_12_object); // 0x5 NEW_2
...
func_291(var_13_int)
{
	...
	func_265(var_8_bool, var_13_int, var_14_float, var_15_float); // 0x12b NEW_2
...
func_232()
{
	...
	func_265(var_9_int, var_10_float, var_11_int, var_12_int); // 0xed NEW_2
...
Label_279:
	...
	func_315(var_26_object); // 0x11b NEW_2
...
{
	var_92_int = 0; var_93_int = 0; var_94_object = Obj(); var_95_int = 0; var_96_int = 0; var_97_object = Obj(); // 0x16e PushV
	var_98_object = var_90_object; // 0x16f Push
	if(var_98_object == 0) goto Label_384; // 0x170 JumpB
	size(var_95_int); // 0x171 ObjFunc
	var_96_int = 0; // 0x173 MovI
	
Label_372:
	var_99_bool = var_96_int < var_95_int; // 0x174 LT
	if(var_99_bool == 0) goto Label_384; // 0x175 JumpB
	get(var_97_object, var_96_int); // 0x176 ObjFunc
	var_100_object = var_97_object; // 0x178 Push
	if(var_100_object == 0) goto Label_380; // 0x179 JumpB
	Trigger(var_97_object, var_91_string); // 0x17a Func
	
Label_380:
	var_97_object = 0; // 0x17c SetNull
	var_101_int = 1; // 0x17d PushI
	var_96_int = var_96_int + var_101_int; // 0x17e Add2
	goto Label_372; // 0x17f Jump
	
Label_384:
	return 6; // 0x180 Return
}


func_240()
{
	var_156_string = "d11q02"; // 0xf0 PushS
	var_157_int = 1000; // 0xf1 PushI
	SetVariable(var_156_string, var_157_int); // 0xf2 Func
	func_265(var_18_int, var_19_int, var_20_object, var_21_bool); // 0xf5 NEW_2
...
func_17(var_0_object, var_1_object, var_5_bool)
{
	...
	func_327(var_28_object, var_29_object, var_30_string, var_31_string, var_32_string); // 0x1a NEW_2
	...
	func_327(var_46_object, var_47_object, var_48_string, var_49_string, var_50_string); // 0x22 NEW_2
...
func_248(var_3_object, var_4_object, var_7_int)
{
	...
	var_127_object = var_3_object; // 0xf9 MovT
	func_345(var_127_object); // 0xfa NEW_2
	var_138_object = Obj(); // 0xfc PushV
	var_138_object = var_4_object; // 0xfd MovT
	func_345(var_138_object); // 0xfe NEW_2
	var_139_bool = var_8_bool; // 0x100 PushT
	if(var_139_bool == 0) goto Label_263; // 0x101 JumpB
	var_140_object = Obj(); // 0x102 PushV
	func_315(var_140_object); // 0x103 NEW_2
	RemoveActor(var_140_object); // 0x105 Func
...
{
	var_128_int = 0; var_129_int = 0; var_130_object = Obj(); var_131_int = 0; var_132_int = 0; var_133_object = Obj(); // 0x159 PushV
	var_134_object = var_127_object; // 0x15a Push
	if(var_134_object == 0) goto Label_365; // 0x15b JumpB
	size(var_131_int); // 0x15c ObjFunc
	var_132_int = 0; // 0x15e MovI
	
Label_351:
	var_135_bool = var_132_int < var_131_int; // 0x15f LT
	if(var_135_bool == 0) goto Label_363; // 0x160 JumpB
	get(var_133_object, var_132_int); // 0x161 ObjFunc
	var_136_object = var_133_object; // 0x163 Push
	if(var_136_object == 0) goto Label_359; // 0x164 JumpB
	RemoveActor(var_133_object); // 0x165 Func
	
Label_359:
	var_133_object = 0; // 0x167 SetNull
	var_137_int = 1; // 0x168 PushI
	var_132_int = var_132_int + var_137_int; // 0x169 Add2
	goto Label_351; // 0x16a Jump
