...
0x158: @ StopWorld()
0x159: Pop(0)
0x15a: @ CameraTransit(Stack[-3], Stack[-5])
0x15b: Pop(0)
0x15c: Push(CvectorIndex(Stack[-4], 0))
0x15d: Push(CvectorIndex(Stack[-5], 2))
0x15e: @ Rotate(Stack[-2], Stack[-1])
0x15f: Pop(2)
...
0x165: Push("head")
0x166: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x167: Pop(1)
0x168: Push(Stack[-1])
0x169: IF (Stack[-1] == 0) GOTO 0x16d; Pop(1)

0x16a: Push("head")
0x16b: @ LookAsyncCamera(Stack[-1])
0x16c: Pop(1)
0x16d: @ CameraWaitForPlayFinish()
0x16e: Pop(0)
0x16f: @ ResumeWorld()
0x170: Pop(0)
0x171: Stack[-21] = (bool) 1
0x172: Return(); Pop(18)

0x173: PushEmpty(bool, bool)
0x174: @ CameraSwitchToNormal()
0x175: Pop(0)
...
0x17b: Push("head")
0x17c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x17d: Pop(1)
0x17e: Push(Stack[-1])
...
0x184: PushEmpty(bool, float, float, bool, float, float)
0x185: @ lshHasAnimation(Stack[-3], Stack[-7])
0x186: Pop(0)
0x187: Push(Stack[-3])
0x188: IF (Stack[-1] == 0) GOTO 0x18f; Pop(1)

0x189: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x18a: Pop(0)
0x18b: Push((bool) 0)
0x18c: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x18d: Pop(1)
0x18e: GOTO 0x193

0x18f: Push("Can't find lsh animation : ")
0x190: Pop(1); Push(Stack[-1] + Stack[-8]);
0x191: @ Trace(Stack[-1])
0x192: Pop(1)
0x193: Return(); Pop(6)

0x194: PushEmpty(bool, float, float, bool, float, float)
0x195: @ lshHasAnimation(Stack[-3], Stack[-8])
0x196: Pop(0)
0x197: Push(Stack[-3])
0x198: IF (Stack[-1] == 0) GOTO 0x19e; Pop(1)

0x199: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x19a: Pop(0)
0x19b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x19c: Pop(0)
0x19d: GOTO 0x1a2

0x19e: Push("Can't find lsh animation : ")
0x19f: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1a0: @ Trace(Stack[-1])
0x1a1: Pop(1)
0x1a2: Return(); Pop(6)
...
0x1c5: Stack[-1] = 0
0x1c6: PushEmpty(bool, string, string)
0x1c7: Stack[-2] = "quest_d11_02"
0x1c8: Stack[-1] = "actor_unload"
0x1c9: Call2 0x1ba
...
0x1dd: Stack[-1] = (int) 515568
0x1de: Return(); Pop(0)

0x1df: Stack[-1] = (int) 503353
0x1e0: Return(); Pop(0)

0x1e1: Stack[-1] = "ui/NPC_Citizen1.png"
0x1e2: Return(); Pop(0)

0x1e3: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x1e4: Return(); Pop(0)
