...
Label_173:
	...
	func_670(var_69_bool, var_70_object); // 0xbb NEW_2
...
Label_242:
	...
	func_630(var_111_bool); // 0xf4 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_570(var_27_object); // 0x14a NEW_2
...
func_137(var_2_object, var_92_string)
{
	...
	func_630(var_93_bool); // 0x8b NEW_2
...
Label_155:
	func_555(var_96_string, var_97_bool); // 0x9b NEW_2
...
func_522()
{
	var_155_bool = 0; var_156_bool = 0; // 0x20a PushV
	CameraSwitchToNormal(); // 0x20b Func
	var_157_bool = 0; // 0x20d PushV
	func_630(var_157_bool); // 0x20e NEW_2
	if(var_157_bool == 0) goto Label_530; // 0x210 JumpB
	goto Label_538; // 0x211 Jump
	
Label_538:
	return 2; // 0x21a Return
	
Label_530:
	var_158_string = "head"; // 0x212 PushS
	HasAnimationTrack(var_156_bool, var_158_string); // 0x213 Func
	var_159_bool = var_156_bool; // 0x215 Push
	if(var_159_bool == 0) goto Label_538; // 0x216 JumpB
	var_160_string = "head"; // 0x217 PushS
	UnlookAsync(var_160_string); // 0x218 Func
}


func_656()
{
	var_18_string = "d11q06"; // 0x291 PushS
	var_19_int = 3; // 0x292 PushI
	SetVariable(var_18_string, var_19_int); // 0x293 Func
	func_698(); // 0x296 NEW_2
	var_43_bool = 0; var_44_string = ""; var_45_string = ""; // 0x298 PushV
	var_44_string = "quest_d11_06"; // 0x299 MovS
	var_45_string = "place_maria"; // 0x29a MovS
	func_610(var_43_bool, var_44_string, var_45_string); // 0x29b NEW_2
...
func_539(var_137_string)
{
	var_138_bool = 0; var_139_float = 0; var_140_float = 0; var_141_bool = 0; var_142_float = 0; var_143_float = 0; // 0x21b PushV
	lshHasAnimation(var_141_bool, var_137_string); // 0x21c Func
	var_144_bool = var_141_bool; // 0x21e Push
	if(var_144_bool == 0) goto Label_550; // 0x21f JumpB
	lshGetAnimTimes(var_137_string, var_142_float, var_143_float); // 0x220 Func
	var_145_bool = 0; // 0x222 PushB
	lshPlayAnimation(var_142_float, var_143_float, var_145_bool); // 0x223 Func
...
Label_550:
	var_146_string = "Can't find lsh animation : "; // 0x226 PushS
	var_147_int = var_146_string + var_137_string; // 0x227 Add
	Trace(var_147_int); // 0x228 Func
}


func_670(var_110_bool, var_111_object)
{
	var_112_bool = 0; // 0x29f PushV
	var_112_bool = 0; // 0x2a0 MovB
	var_113_bool = 0; var_114_object = Obj(); var_115_string = ""; // 0x2a1 PushV
	var_114_object = var_111_object; // 0x2a2 Mov
	var_115_string = "d11q06KapellaBeads"; // 0x2a3 MovS
	func_603(var_114_object, var_115_string); // 0x2a4 NEW_2
	if(var_113_bool == 0) goto Label_686; // 0x2a6 JumpB
	var_120_bool = 0; var_121_object = Obj(); var_122_string = ""; // 0x2a7 PushV
	var_121_object = var_111_object; // 0x2a8 Mov
	var_122_string = "d11q06KlaraRing"; // 0x2a9 MovS
	func_603(var_121_object, var_122_string); // 0x2aa NEW_2
	if(var_120_bool == 0) goto Label_686; // 0x2ac JumpB
	var_112_bool = 1; // 0x2ad MovB
	
Label_686:
	if(var_112_bool == 0) goto Label_696; // 0x2ae JumpB
	var_123_int = 0; var_124_string = ""; // 0x2af PushV
	var_124_string = "d11q06"; // 0x2b0 MovS
	func_598(var_123_int, var_124_string); // 0x2b1 NEW_2
	var_127_int = 2; // 0x2b3 PushI
	var_128_bool = var_123_int == var_127_int; // 0x2b4 Eq
	if(var_128_bool == 0) goto Label_696; // 0x2b5 JumpB
	var_110_bool = 1; // 0x2b6 MovB
	return 0; // 0x2b7 Return
	
Label_696:
	var_110_bool = 0; // 0x2b8 MovB
	return 0; // 0x2b9 Return
}


func_555(var_96_string, var_97_bool)
{
	var_100_bool = 0; var_101_float = 0; var_102_float = 0; var_103_bool = 0; var_104_float = 0; var_105_float = 0; // 0x22b PushV
	lshHasAnimation(var_103_bool, var_96_string); // 0x22c Func
	var_106_bool = var_103_bool; // 0x22e Push
	if(var_106_bool == 0) goto Label_565; // 0x22f JumpB
	lshGetAnimTimes(var_96_string, var_104_float, var_105_float); // 0x230 Func
	lshPlayAnimation(var_104_float, var_105_float, var_97_bool); // 0x232 Func
...
Label_565:
	var_107_string = "Can't find lsh animation : "; // 0x235 PushS
	var_108_int = var_107_string + var_96_string; // 0x236 Add
	Trace(var_108_int); // 0x237 Func
}
...
func_698()
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x2ba PushV
	var_22_int = 691; // 0x2bb PushI
	var_23_int = 2; // 0x2bc PushI
	var_24_int = 534539; // 0x2bd PushI
	CreateDiaryEntry(var_21_object, var_22_int, var_23_int, var_24_int); // 0x2be Func
	var_25_bool = 0; var_26_object = Obj(); var_27_int = 0; // 0x2c0 PushV
	var_26_object = var_21_object; // 0x2c1 Mov
	var_27_int = 686; // 0x2c2 MovI
	func_724(var_25_bool, var_26_object, var_27_int); // 0x2c3 NEW_2
	return 2; // 0x2c5 Return
}


func_570(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x23a PushV
	GetEyesHeight(var_30_float); // 0x23b ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x23d MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x23e PushE
	var_32_float = var_30_float; // 0x23f Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x240 PopE
	var_33_string = "head"; // 0x241 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x242 Func
...
func_581()
{
	var_13_bool = 0; // 0x245 PushV
	func_630(var_13_bool); // 0x246 NEW_2
	if(var_13_bool == 0) goto Label_587; // 0x248 JumpB
	lshStopSpeech(); // 0x249 Func
...
func_454(var_25_bool, var_27_float)
{
	...
	func_588(var_52_cvector, var_53_cvector); // 0x1e1 NEW_2
...
Label_495:
	...
	CameraTransit(var_43_cvector, var_41_cvector); // 0x1f1 Func
	var_65_float = GetByIndex(var_42_cvector, 0); // 0x1f3 PushE
	var_66_float = GetByIndex(var_42_cvector, 2); // 0x1f4 PushE
	Rotate(var_65_float, var_66_float); // 0x1f5 Func
	var_67_bool = 0; // 0x1f7 PushV
	func_630(var_67_bool); // 0x1f8 NEW_2
	if(var_67_bool == 0) goto Label_508; // 0x1fa JumpB
	goto Label_516; // 0x1fb Jump
	
Label_516:
	CameraWaitForPlayFinish(); // 0x204 Func
	ResumeWorld(); // 0x206 Func
	var_25_bool = 1; // 0x208 MovB
	return 18; // 0x209 Return
	
Label_508:
	var_68_string = "head"; // 0x1fc PushS
	HasAnimationTrack(var_45_bool, var_68_string); // 0x1fd Func
	var_69_bool = var_45_bool; // 0x1ff Push
	if(var_69_bool == 0) goto Label_516; // 0x200 JumpB
	var_70_string = "head"; // 0x201 PushS
	LookAsyncCamera(var_70_string); // 0x202 Func
}


func_711(var_34_object)
{
	var_35_object = Obj(); var_36_object = Obj(); // 0x2c7 PushV
	GetDiaryRoot(var_36_object); // 0x2c8 Func
	var_37_bool = var_36_object == 0; // 0x2ca Not
	if(var_37_bool == 0) goto Label_721; // 0x2cb JumpB
	var_38_string = "Can't retrieve diary root"; // 0x2cc PushS
	Trace(var_38_string); // 0x2cd Func
	var_34_object = 0; // 0x2cf MovB
	return 2; // 0x2d0 Return
	
Label_721:
	var_34_object = var_36_object; // 0x2d1 Mov
...
Label_116:
	...
	func_539(var_137_string); // 0x76 NEW_2
...
func_588(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x24c PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x24d Or
	var_56_float = sqrt(var_57_int); // 0x24e Sqrt2
	var_58_float = 0.0; // 0x24f PushF
	var_59_bool = var_56_float < var_58_float; // 0x250 LT
	if(var_59_bool == 0) goto Label_596; // 0x251 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x252 MovV
	return 2; // 0x253 Return
	
Label_596:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x254 Div2
	return 2; // 0x255 Return
}


func_724(var_25_bool, var_26_object, var_27_int)
{
	var_28_object = Obj(); var_29_object = Obj(); var_30_int = 0; var_31_object = Obj(); var_32_object = Obj(); var_33_int = 0; // 0x2d4 PushV
	var_34_object = Obj(); // 0x2d5 PushV
	func_711(var_34_object); // 0x2d6 NEW_2
	var_31_object = var_34_object; // 0x2d7 Mov
	Find(var_27_int, var_32_object); // 0x2d9 ObjFunc
	var_39_bool = var_32_object == 0; // 0x2db Not
	if(var_39_bool == 0) goto Label_739; // 0x2dc JumpB
	var_40_string = "Can't find diary parent with id: "; // 0x2dd PushS
	var_41_int = var_40_string + var_27_int; // 0x2de Add
	Trace(var_41_int); // 0x2df Func
	var_25_bool = 0; // 0x2e1 MovB
	return 6; // 0x2e2 Return
	
Label_739:
	AddChild(var_26_object); // 0x2e3 ObjFunc
	var_42_int = 7; // 0x2e5 PushI
	SendWorldWndMessage(var_42_int); // 0x2e6 Func
	GetCategory(var_33_int); // 0x2e8 ObjFunc
	SetDiarySection(var_33_int); // 0x2ea Func
	var_25_bool = 0; // 0x2ec MovB
...
func_598(var_123_int, var_124_string)
{
	var_125_int = 0; var_126_int = 0; // 0x256 PushV
	GetVariable(var_124_string, var_126_int); // 0x257 Func
	var_123_int = var_126_int; // 0x259 Mov
	return 2; // 0x25a Return
}


func_603(var_113_bool, var_115_string)
{
	var_116_int = 0; var_117_bool = 0; var_118_int = 0; var_119_bool = 0; // 0x25b PushV
	GetInvItemByName(var_118_int, var_115_string); // 0x25c Func
	HasItem(var_118_int, var_119_bool); // 0x25e ObjFunc
	var_113_bool = var_119_bool; // 0x260 Mov
	return 4; // 0x261 Return
}


func_610(var_43_bool, var_44_string, var_45_string)
{
	var_46_object = Obj(); var_47_object = Obj(); // 0x262 PushV
	FindActor(var_47_object, var_44_string); // 0x263 Func
	var_48_bool = var_47_object == 0; // 0x265 NullEq
	if(var_48_bool == 0) goto Label_617; // 0x266 JumpB
	var_43_bool = 0; // 0x267 MovB
	return 2; // 0x268 Return
	
Label_617:
	Trigger(var_47_object, var_45_string); // 0x269 Func
	var_43_bool = 1; // 0x26b MovB
...
Label_364:
	...
	func_639(var_35_int); // 0x16d NEW_2
...
Label_379:
	...
	func_632(var_57_string, var_58_int); // 0x189 NEW_2
...
func_752(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x2f0 PushV
	var_79_string = "branch"; // 0x2f1 PushS
	GetVariable(var_79_string, var_78_int); // 0x2f2 Func
	var_80_int = 0; // 0x2f4 PushI
	var_81_bool = var_78_int == var_80_int; // 0x2f5 Eq
	if(var_81_bool == 0) goto Label_762; // 0x2f6 JumpB
	var_76_int = 1; // 0x2f7 MovI
	return 2; // 0x2f8 Return
	
Label_762:
	var_82_int = 1; // 0x2fa PushI
	var_83_bool = var_78_int == var_82_int; // 0x2fb Eq
	if(var_83_bool == 0) goto Label_767; // 0x2fc JumpB
	var_76_int = 2; // 0x2fd MovI
	return 2; // 0x2fe Return
	
Label_767:
	var_76_int = 3; // 0x2ff MovI
	return 2; // 0x300 Return
}


func_626(var_74_string)
{
	var_74_string = "ui/NPC_Citizen2.png"; // 0x272 MovS
...
{
	var_75_string = "ui/NPC_Citizen2_b.png"; // 0x274 MovS
	return 0; // 0x275 Return
}


func_630(var_67_bool)
{
	var_67_bool = 0; // 0x276 MovB
	return 0; // 0x277 Return
}


func_632(var_41_string, var_42_int)
{
	var_43_string = ""; var_44_string = ""; // 0x278 PushV
	var_44_string = "idle"; // 0x279 MovS
	var_45_int = var_42_int; // 0x27a Push
	if(var_45_int == 0) goto Label_637; // 0x27b JumpB
	var_44_string = var_44_string + var_42_int; // 0x27c Add2
	
Label_637:
	var_41_string = var_44_string; // 0x27d Mov
...
func_639(var_35_int)
{
	var_36_int = 0; var_37_bool = 0; var_38_int = 0; var_39_bool = 0; // 0x27f PushV
	var_38_int = 0; // 0x280 MovI
	
Label_641:
	var_40_string = "all"; // 0x281 PushS
	var_41_string = ""; var_42_int = 0; // 0x282 PushV
	var_42_int = var_38_int; // 0x283 Mov
	func_632(var_41_string, var_42_int); // 0x284 NEW_2
	HasAnimation(var_39_bool, var_40_string, var_41_string); // 0x286 Func
	var_46_bool = var_39_bool == 0; // 0x288 Not
	if(var_46_bool == 0) goto Label_651; // 0x289 JumpB
	goto Label_654; // 0x28a Jump
	
Label_654:
	var_35_int = var_38_int; // 0x28e Mov
	return 4; // 0x28f Return
	
Label_651:
	var_47_int = 1; // 0x28b PushI
	var_38_int = var_38_int + var_47_int; // 0x28c Add2
