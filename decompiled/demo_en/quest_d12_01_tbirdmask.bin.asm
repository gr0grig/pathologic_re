...
0x2de: @ StopWorld()
0x2df: Pop(0)
0x2e0: @ CameraTransit(Stack[-3], Stack[-5])
0x2e1: Pop(0)
0x2e2: Push(CvectorIndex(Stack[-4], 0))
0x2e3: Push(CvectorIndex(Stack[-5], 2))
...
0x2f0: Push("head")
0x2f1: @ LookAsyncCamera(Stack[-1])
0x2f2: Pop(1)
0x2f3: @ CameraWaitForPlayFinish()
0x2f4: Pop(0)
0x2f5: @ ResumeWorld()
0x2f6: Pop(0)
0x2f7: Stack[-21] = (bool) 1
0x2f8: Return(); Pop(18)

0x2f9: PushEmpty(bool, bool)
0x2fa: @ CameraSwitchToNormal()
0x2fb: Pop(0)
...
0x301: Push("head")
0x302: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x303: Pop(1)
0x304: Push(Stack[-1])
...
0x30b: @ lshHasAnimation(Stack[-3], Stack[-7])
0x30c: Pop(0)
0x30d: Push(Stack[-3])
0x30e: IF (Stack[-1] == 0) GOTO 0x315; Pop(1)

0x30f: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x310: Pop(0)
0x311: Push((bool) 0)
0x312: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x313: Pop(1)
0x314: GOTO 0x319

0x315: Push("Can't find lsh animation : ")
...
0x31b: @ lshHasAnimation(Stack[-3], Stack[-8])
0x31c: Pop(0)
0x31d: Push(Stack[-3])
0x31e: IF (Stack[-1] == 0) GOTO 0x324; Pop(1)

0x31f: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x320: Pop(0)
0x321: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x322: Pop(0)
0x323: GOTO 0x328

0x324: Push("Can't find lsh animation : ")
0x325: Pop(1); Push(Stack[-1] + Stack[-9]);
0x326: @ Trace(Stack[-1])
0x327: Pop(1)
0x328: Return(); Pop(6)

0x329: PushEmpty(float, cvector, float, cvector)
0x32a: @@ GetEyesHeight(Stack[-2])
0x32b: Pop(0)
0x32c: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x32d: Push(CvectorIndex(Stack[-1], 1))
0x32e: Stack[-1] = Stack[-3]
0x32f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x330: Push("head")
0x331: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x332: Pop(1)
0x333: Return(); Pop(4)
...
0x340: Stack[-1] = 0
0x341: PushEmpty(float, float)
0x342: Pop(0); Push(Stack[-3] | Stack[-3]);
0x343: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x344: Push((float)0.0)
0x345: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x346: IF (Stack[-1] == 0) GOTO 0x349; Pop(1)

0x347: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x348: Return(); Pop(2)

0x349: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x34a: Return(); Pop(2)

0x34b: PushEmpty(int, int)
0x34c: @ GetVariable(Stack[-3], Stack[-1])
0x34d: Pop(0)
0x34e: Stack[-4] = Stack[-1]
0x34f: Return(); Pop(2)

0x350: PushEmpty(object, object)
0x351: @ FindActor(Stack[-1], Stack[-4])
0x352: Pop(0)
...
0x35c: Push("locked")
0x35d: @@ SetProperty(Stack[-1], Stack[-4])
0x35e: Pop(1)
0x35f: Return(); Pop(2)

0x360: Stack[-1] = 0
0x361: PushEmpty(string, string)
0x362: Stack[-1] = "idle"
0x363: Push(Stack[-3])
0x364: IF (Stack[-1] == 0) GOTO 0x366; Pop(1)

0x365: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x366: Stack[-4] = Stack[-1]
0x367: Return(); Pop(2)

0x368: PushEmpty(int, bool, int, bool)
0x369: Stack[-2] = (int) 0
0x36a: Push("all")
...
0x36e: Pop(1)
0x36f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x370: Pop(2)
...
0x374: Push((int) 1)
0x375: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x376: GOTO 0x36a

0x377: Stack[-5] = Stack[-2]
0x378: Return(); Pop(4)

0x379: PushEmpty()
0x37a: PushEmpty(string, bool)
0x37b: Stack[-2] = "itheater@door1"
...
0x3a3: Stack[-1] = (int) 515571
0x3a4: Return(); Pop(0)

0x3a5: Stack[-1] = (int) 504029
0x3a6: Return(); Pop(0)

0x3a7: Stack[-1] = "ui/NPC_bmask.png"
0x3a8: Return(); Pop(0)

0x3a9: Stack[-1] = "ui/NPC_bmask_b.png"
0x3aa: Return(); Pop(0)
