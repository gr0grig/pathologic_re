...
0x225: PushEmpty(bool, float, float, bool, float, float)
0x226: @ lshHasAnimation(Stack[-3], Stack[-7])
0x227: Pop(0)
0x228: Push(Stack[-3])
0x229: IF (Stack[-1] == 0) GOTO 0x230; Pop(1)

0x22a: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x22b: Pop(0)
0x22c: Push((bool) 0)
0x22d: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x22e: Pop(1)
0x22f: GOTO 0x234

0x230: Push("Can't find lsh animation : ")
0x231: Pop(1); Push(Stack[-1] + Stack[-8]);
0x232: @ Trace(Stack[-1])
0x233: Pop(1)
0x234: Return(); Pop(6)

0x235: PushEmpty(bool, float, float, bool, float, float)
0x236: @ lshHasAnimation(Stack[-3], Stack[-8])
0x237: Pop(0)
0x238: Push(Stack[-3])
0x239: IF (Stack[-1] == 0) GOTO 0x23f; Pop(1)

0x23a: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x23b: Pop(0)
0x23c: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x23d: Pop(0)
0x23e: GOTO 0x243

0x23f: Push("Can't find lsh animation : ")
0x240: Pop(1); Push(Stack[-1] + Stack[-9]);
0x241: @ Trace(Stack[-1])
0x242: Pop(1)
0x243: Return(); Pop(6)
...
0x260: Stack[-1] = 0
0x261: PushEmpty(string, string)
0x262: Stack[-1] = "idle"
0x263: Push(Stack[-3])
0x264: IF (Stack[-1] == 0) GOTO 0x266; Pop(1)

0x265: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x266: Stack[-4] = Stack[-1]
0x267: Return(); Pop(2)

0x268: PushEmpty(int, bool, int, bool)
0x269: Stack[-2] = (int) 0
0x26a: Push("all")
...
0x26e: Pop(1)
0x26f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x270: Pop(2)
...
0x274: Push((int) 1)
0x275: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x276: GOTO 0x26a

0x277: Stack[-5] = Stack[-2]
0x278: Return(); Pop(4)

0x279: Stack[-1] = (int) 515571
0x27a: Return(); Pop(0)

0x27b: Stack[-1] = (int) 504029
0x27c: Return(); Pop(0)

0x27d: Stack[-1] = "ui/NPC_bmask.png"
0x27e: Return(); Pop(0)

0x27f: Stack[-1] = "ui/NPC_bmask_b.png"
0x280: Return(); Pop(0)
...
0x284: Push("branch")
0x285: @ GetVariable(Stack[-1], Stack[-2])
0x286: Pop(1)
0x287: Push((int) 0)
