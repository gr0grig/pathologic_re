...
0x766: Pop(0)
0x767: @@ SetItemName(Stack[-7])
0x768: Pop(0)
0x769: Push("Organ")
0x76a: Push((int) 1)
0x76b: @@ SetProperty(Stack[-2], Stack[-1])
0x76c: Pop(2)
0x76d: @@ GetItemID(Stack[-2])
0x76e: Pop(0)
0x76f: Push((int) 0)
0x770: Push((int) 1)
...
0x7ad: Stack[-5] = Stack[-11]
0x7ae: Stack[-4] = Stack[-10]
0x7af: Stack[-3] = Stack[-9]
0x7b0: Stack[-2] = Stack[-7]
0x7b1: Stack[-1] = Stack[-6]
0x7b2: Call2 0x6a7
