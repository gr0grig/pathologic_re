...
task_3_event_7(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_1829(var_18_object); // 0x422 NEW_2
...
task_4_event_0(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_object)
{
	...
	func_1879(var_19_object); // 0x501 NEW_2
...
{
	var_15_object = Obj(); // 0x78d PushV
	func_1785(var_15_object); // 0x78e NEW_2
	RemoveActor(var_15_object); // 0x790 Func
	Hold(); // 0x792 Func
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x7a4 PushV
	var_19_object = var_15_object; // 0x7a5 Mov
	var_20_int = var_16_int; // 0x7a6 Mov
	var_21_float = var_17_float; // 0x7a7 Mov
	func_1635(var_19_object, var_20_int, var_21_float); // 0x7a8 NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x7ac PushV
	var_21_object = var_15_object; // 0x7ad Mov
	var_22_int = var_16_int; // 0x7ae Mov
	var_23_float = var_17_float; // 0x7af Mov
	var_24_cvector = var_19_cvector; // 0x7b0 Mov
	var_25_cvector = var_20_cvector; // 0x7b1 Mov
	func_1703(var_23_float, var_24_cvector, var_25_cvector); // 0x7b2 NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x7b5 PushV
	var_19_string = "health"; // 0x7b6 PushS
	var_20_bool = var_16_string == var_19_string; // 0x7b7 Eq
	if(var_20_bool == 0) goto Label_1985; // 0x7b8 JumpB
	var_21_string = "health"; // 0x7b9 PushS
	GetProperty(var_21_string, var_18_float); // 0x7ba Func
	var_22_int = 0; // 0x7bc PushI
	var_23_bool = var_18_float <= var_22_int; // 0x7bd LE
	if(var_23_bool == 0) goto Label_1985; // 0x7be JumpB
	SignalDeath(var_15_object); // 0x7bf Func
...
{
	var_16_object = Obj(); // 0x7c3 PushV
	var_16_object = var_15_object; // 0x7c4 Mov
	func_1941(var_16_object); // 0x7c5 NEW_2
...
Label_680:
	...
	var_459_string = "all"; // 0x2ad PushS
	var_460_string = "attack_middle"; // 0x2ae PushS
	var_461_int = var_460_string + var_350_int; // 0x2af Add
	HasAnimation(var_351_bool, var_459_string, var_461_int); // 0x2b0 Func
	var_462_bool = var_351_bool; // 0x2b2 Push
	if(var_462_bool == 0) goto Label_761; // 0x2b3 JumpB
	func_1838(); // 0x2b5 NEW_2
	var_463_string = "all"; // 0x2b7 PushS
	var_464_string = "attack_middle"; // 0x2b8 PushS
	var_465_int = var_464_string + var_350_int; // 0x2b9 Add
	PlayAnimation(var_463_string, var_465_int); // 0x2ba Func
	WaitForAnimEnd(); // 0x2bc Func
	func_983(var_353_string); // 0x2bf NEW_2
	var_466_bool = 0; var_467_object = Obj(); // 0x2c1 PushV
	var_467_object = var_0_int; // 0x2c2 MovT
	func_1567(var_466_bool, var_467_object); // 0x2c3 NEW_2
	var_468_bool = var_466_bool == 0; // 0x2c5 Not
	if(var_468_bool == 0) goto Label_715; // 0x2c6 JumpB
	StopAsync(); // 0x2c7 Func
	var_344_bool = 0; // 0x2c9 MovB
	return 8; // 0x2ca Return
	
Label_715:
	var_469_float = 0; var_470_int = 0; // 0x2cb PushV
	var_469_float = var_345_float; // 0x2cc Mov
	var_470_int = var_350_int; // 0x2cd Mov
	func_605(var_353_string, var_469_float, var_470_int); // 0x2ce NEW_2
	var_352_int = 1; // 0x2d0 MovI
	
Label_721:
	var_471_string = "attack_middle"; // 0x2d1 PushS
	var_472_int = var_471_string + var_350_int; // 0x2d2 Add
	var_473_string = "_"; // 0x2d3 PushS
	var_474_int = var_472_int + var_473_string; // 0x2d4 Add
	var_353_string = var_474_int + var_352_int; // 0x2d5 Add2
	var_475_string = "all"; // 0x2d6 PushS
	HasAnimation(var_351_bool, var_475_string, var_353_string); // 0x2d7 Func
	var_476_bool = var_351_bool == 0; // 0x2d9 Not
	if(var_476_bool == 0) goto Label_732; // 0x2da JumpB
	goto Label_761; // 0x2db Jump
	
Label_761:
	var_477_bool = 0; // 0x2f9 PushB
	SetAttackState(var_477_bool); // 0x2fa Func
	var_478_string = "all"; // 0x2fc PushS
	var_479_string = "attack_end"; // 0x2fd PushS
	var_480_int = var_479_string + var_350_int; // 0x2fe Add
	PlayAnimation(var_478_string, var_480_int); // 0x2ff Func
	var_481_bool = 0; // 0x301 PushV
	func_997(var_481_bool); // 0x302 NEW_2
	if(var_481_bool == 0) goto Label_779; // 0x304 JumpB
	var_482_bool = 0; var_483_float = 0; // 0x305 PushV
	var_483_float = 0.75; // 0x306 MovF
	func_781(var_482_bool, var_483_float); // 0x307 NEW_2
...
Label_732:
	func_1838(); // 0x2dd NEW_2
	var_491_string = "all"; // 0x2df PushS
	PlayAnimation(var_491_string, var_353_string); // 0x2e0 Func
	WaitForAnimEnd(); // 0x2e2 Func
	func_983(var_353_string); // 0x2e5 NEW_2
	var_492_bool = 0; var_493_object = Obj(); // 0x2e7 PushV
	var_493_object = var_0_int; // 0x2e8 MovT
	func_1567(var_492_bool, var_493_object); // 0x2e9 NEW_2
	var_494_bool = var_492_bool == 0; // 0x2eb Not
	if(var_494_bool == 0) goto Label_753; // 0x2ec JumpB
	StopAsync(); // 0x2ed Func
	var_344_bool = 0; // 0x2ef MovB
	return 8; // 0x2f0 Return
	
Label_753:
	var_495_float = 0; var_496_int = 0; // 0x2f1 PushV
	var_495_float = var_345_float; // 0x2f2 Mov
	var_496_int = var_350_int; // 0x2f3 Mov
	func_605(var_353_string, var_495_float, var_496_int); // 0x2f4 NEW_2
	var_497_int = 1; // 0x2f6 PushI
	var_352_int = var_352_int + var_497_int; // 0x2f7 Add2
...
Label_147:
	...
	func_1856(var_68_int); // 0x94 NEW_2
...
Label_162:
	...
	func_1849(var_90_string, var_91_int); // 0xb0 NEW_2
...
func_781(var_482_bool, var_483_float)
{
	var_484_float = 0; var_485_bool = 0; var_486_float = 0; var_487_bool = 0; // 0x30d PushV
	rand(var_486_float); // 0x30e Func
	var_488_bool = var_486_float < var_483_float; // 0x310 LT
	if(var_488_bool == 0) goto Label_801; // 0x311 JumpB
	
Label_786:
	IsAnimationPlaying(var_487_bool); // 0x312 Func
	var_489_bool = var_487_bool == 0; // 0x314 Not
	if(var_489_bool == 0) goto Label_791; // 0x315 JumpB
...
Label_806:
	var_482_bool = 0; // 0x326 MovB
	return 4; // 0x327 Return
	
Label_791:
	var_490_bool = 0; // 0x317 PushV
	func_879(var_490_bool); // 0x318 NEW_2
	if(var_490_bool == 0) goto Label_797; // 0x31a JumpB
	var_482_bool = 1; // 0x31b MovB
...
Label_801:
	...
	func_983(var_487_bool); // 0x324 NEW_2
}
...
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x795 PushV
	GetScene(var_18_object); // 0x796 Func
	func_1909(); // 0x799 NEW_2
	var_39_object = Obj(); // 0x79b PushV
	var_39_object = var_16_object; // 0x79c Mov
	TaskCall(4); // 0x79d TaskCall
	func_1259(var_39_object); // 0x79e NEW_2
	TaskReturn(); // 0x79f TaskReturn
...
func_1819(var_451_float)
{
	...
	var_454_int = 15; // 0x720 PushI
	SendWorldWndMessage(var_454_int, var_453_object); // 0x721 Func
...
func_1829(var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0x725 PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x726 Func
	var_21_bool = var_20_bool; // 0x728 Push
	if(var_21_bool == 0) goto Label_1837; // 0x729 JumpB
	var_22_string = "attack"; // 0x72a PushS
	PlayGlobalMusic(var_22_string); // 0x72b Func
...
Label_1472:
	var_455_string = "armor"; // 0x5c0 PushS
	GetProperty(var_455_string, var_408_int); // 0x5c1 ObjFunc
}


func_1838()
{
	var_356_object = Obj(); var_357_object = Obj(); // 0x72e PushV
	GetScene(var_357_object); // 0x72f Func
	var_358_string = "battle"; // 0x731 PushS
	var_359_object = Obj(); // 0x732 PushV
	func_1785(var_359_object); // 0x733 NEW_2
	BroadcastMessage(var_358_string, var_359_object, var_357_object); // 0x735 Func
...
{
	var_76_string = ""; var_77_string = ""; // 0x739 PushV
	var_77_string = "idle"; // 0x73a MovS
	var_78_int = var_75_int; // 0x73b Push
	if(var_78_int == 0) goto Label_1854; // 0x73c JumpB
	var_77_string = var_77_string + var_75_int; // 0x73d Add2
	
Label_1854:
	var_74_string = var_77_string; // 0x73e Mov
...
{
	var_69_int = 0; var_70_bool = 0; var_71_int = 0; var_72_bool = 0; // 0x740 PushV
	var_71_int = 0; // 0x741 MovI
	
Label_1858:
	var_73_string = "all"; // 0x742 PushS
	var_74_string = ""; var_75_int = 0; // 0x743 PushV
	var_75_int = var_71_int; // 0x744 Mov
	func_1849(var_74_string, var_75_int); // 0x745 NEW_2
	HasAnimation(var_72_bool, var_73_string, var_74_string); // 0x747 Func
	var_79_bool = var_72_bool == 0; // 0x749 Not
	if(var_79_bool == 0) goto Label_1868; // 0x74a JumpB
	goto Label_1871; // 0x74b Jump
	
Label_1871:
	var_68_int = var_71_int; // 0x74f Mov
	return 4; // 0x750 Return
	
Label_1868:
	var_80_int = 1; // 0x74c PushI
	var_71_int = var_71_int + var_80_int; // 0x74d Add2
	goto Label_1858; // 0x74e Jump
}
...
Label_324:
	...
	var_514_int = 1; // 0x14a PushI
	Sleep(var_514_int); // 0x14b Func
...
Label_497:
	...
	var_498_string = "all"; // 0x1f3 PushS
	var_499_string = "fjump"; // 0x1f4 PushS
	PlayAnimation(var_498_string, var_499_string); // 0x1f5 Func
	WaitForAnimEnd(); // 0x1f7 Func
	func_983(var_47_float); // 0x1fa NEW_2
	var_500_cvector = CVector(0.0, 0.0, 0.0); // 0x1fc PushVec
	SetSpeed(var_500_cvector); // 0x1fd Func
	Stop(); // 0x1ff Func
	StopAsync(); // 0x201 Func
	var_501_bool = 0; // 0x203 PushV
	func_940(var_47_float, var_501_bool); // 0x204 NEW_2
	var_502_bool = var_501_bool == 0; // 0x206 Not
	if(var_502_bool == 0) goto Label_543; // 0x207 JumpB
	var_503_bool = 0; var_504_object = Obj(); // 0x208 PushV
	var_504_object = var_0_int; // 0x209 MovT
	func_1567(var_503_bool, var_504_object); // 0x20a NEW_2
	var_505_bool = var_503_bool == 0; // 0x20c Not
	if(var_505_bool == 0) goto Label_527; // 0x20d JumpB
...
Label_527:
	...
	var_506_float = var_25_float * var_25_float; // 0x215 Mult
	var_507_bool = var_44_float < var_506_float; // 0x216 LT
	if(var_507_bool == 0) goto Label_543; // 0x217 JumpB
	var_508_bool = 0; var_509_float = 0; // 0x218 PushV
	var_509_float = var_25_float; // 0x219 Mov
	func_644(var_47_float, var_508_bool, var_509_float); // 0x21a NEW_2
	var_510_bool = var_508_bool == 0; // 0x21c Not
	if(var_510_bool == 0) goto Label_543; // 0x21d JumpB
	goto Label_553; // 0x21e Jump
	
Label_544:
	var_511_bool = 0; var_512_float = 0; // 0x220 PushV
	var_512_float = var_25_float; // 0x221 Mov
	func_644(var_47_float, var_511_bool, var_512_float); // 0x222 NEW_2
	var_513_bool = var_511_bool == 0; // 0x224 Not
	if(var_513_bool == 0) goto Label_551; // 0x225 JumpB
...
func_983(var_0_int)
{
	...
	func_1829(var_119_object); // 0x3d9 NEW_2
...
{
	var_20_int = 0; // 0x758 PushV
	func_1873(var_20_int); // 0x759 NEW_2
	var_24_int = 1; // 0x75b PushI
	var_25_bool = var_20_int == var_24_int; // 0x75c Eq
	if(var_25_bool == 0) goto Label_1889; // 0x75d JumpB
	WorkWithCorpse(var_19_object); // 0x75e Func
	goto Label_1891; // 0x760 Jump
	
Label_1891:
	return 0; // 0x763 Return
	
Label_1889:
	Barter(var_19_object); // 0x761 Func
}
...
{
	var_20_int = 0; var_21_int = 0; // 0x751 PushV
	var_22_string = "branch"; // 0x752 PushS
	GetVariable(var_22_string, var_21_int); // 0x753 Func
	var_19_int = var_21_int; // 0x755 Mov
...
func_605(var_0_int, var_381_float, var_382_int)
{
	...
	var_456_int = 0; // 0x278 PushV
	func_988(var_456_int); // 0x279 NEW_2
	ReportHit(var_0_int, var_456_int, var_388_float, var_387_float); // 0x27b Func
	var_457_object = Obj(); var_458_float = 0; // 0x27d PushV
	var_457_object = var_386_object; // 0x27e Mov
	var_458_float = var_388_float; // 0x27f Mov
...
func_1892(var_25_string)
{
	var_26_object = Obj(); var_27_int = 0; var_28_bool = 0; var_29_object = Obj(); var_30_int = 0; var_31_bool = 0; // 0x764 PushV
	CreateInvItem(var_29_object); // 0x765 Func
	SetItemName(var_25_string); // 0x767 ObjFunc
	var_32_string = "Organ"; // 0x769 PushS
	var_33_int = 1; // 0x76a PushI
	SetProperty(var_32_string, var_33_int); // 0x76b ObjFunc
	GetItemID(var_30_int); // 0x76d ObjFunc
	var_34_int = 0; // 0x76f PushI
	var_35_int = 1; // 0x770 PushI
	AddItem(var_31_bool, var_29_object, var_34_int, var_35_int); // 0x771 Func
...
func_1003(var_2_bool, var_126_bool, var_127_object, var_128_float, var_129_float, var_130_bool, var_131_bool)
{
	...
	func_1829(var_139_object); // 0x3ee NEW_2
...
func_1909()
{
	var_19_int = 0; // 0x775 PushV
	func_1873(var_19_int); // 0x776 NEW_2
	var_23_int = 1; // 0x778 PushI
	var_24_bool = var_19_int != var_23_int; // 0x779 Neq
	if(var_24_bool == 0) goto Label_1916; // 0x77a JumpB
	return 0; // 0x77b Return
	
Label_1916:
	var_25_string = ""; // 0x77c PushV
	var_25_string = "liver"; // 0x77d MovS
	func_1892(var_25_string); // 0x77e NEW_2
	var_36_string = ""; // 0x780 PushV
	var_36_string = "kidney"; // 0x781 MovS
	func_1892(var_36_string); // 0x782 NEW_2
	var_37_string = ""; // 0x784 PushV
	var_37_string = "heart"; // 0x785 MovS
	func_1892(var_37_string); // 0x786 NEW_2
	var_38_string = ""; // 0x788 PushV
	var_38_string = "blood"; // 0x789 MovS
	func_1892(var_38_string); // 0x78a NEW_2
