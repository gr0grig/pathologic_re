...
Events:
EVENT_22 Op = 0x898 Vars = (object, int, float, float)
EVENT_43 Op = 0x8a0 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8aa Vars = (object, string)
EVENT_41 Op = 0x8b7 Vars = (object)
EVENT_6 Op = 0x8bd Vars = ()
...
0x771: @ StopWorld()
0x772: Pop(0)
0x773: @ CameraTransit(Stack[-3], Stack[-5])
0x774: Pop(0)
0x775: Push(CvectorIndex(Stack[-4], 0))
0x776: Push(CvectorIndex(Stack[-5], 2))
0x777: @ Rotate(Stack[-2], Stack[-1])
0x778: Pop(2)
...
0x77e: Push("head")
0x77f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x780: Pop(1)
0x781: Push(Stack[-1])
0x782: IF (Stack[-1] == 0) GOTO 0x786; Pop(1)

0x783: Push("head")
0x784: @ LookAsyncCamera(Stack[-1])
0x785: Pop(1)
0x786: @ CameraWaitForPlayFinish()
0x787: Pop(0)
0x788: @ ResumeWorld()
0x789: Pop(0)
0x78a: Stack[-21] = (bool) 1
0x78b: Return(); Pop(18)

0x78c: PushEmpty(bool, bool)
0x78d: @ CameraSwitchToNormal()
0x78e: Pop(0)
...
0x794: Push("head")
0x795: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x796: Pop(1)
0x797: Push(Stack[-1])
0x798: IF (Stack[-1] == 0) GOTO 0x79c; Pop(1)

0x799: Push("head")
0x79a: @ UnlookAsync(Stack[-1])
0x79b: Pop(1)
0x79c: Return(); Pop(2)

0x79d: PushEmpty(bool, float, float, bool, float, float)
0x79e: @ lshHasAnimation(Stack[-3], Stack[-7])
0x79f: Pop(0)
0x7a0: Push(Stack[-3])
0x7a1: IF (Stack[-1] == 0) GOTO 0x7a8; Pop(1)

0x7a2: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x7a3: Pop(0)
0x7a4: Push((bool) 0)
...
0x7a8: Push("Can't find lsh animation : ")
0x7a9: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7aa: @ Trace(Stack[-1])
0x7ab: Pop(1)
0x7ac: Return(); Pop(6)

0x7ad: PushEmpty(bool, float, float, bool, float, float)
0x7ae: @ lshHasAnimation(Stack[-3], Stack[-8])
0x7af: Pop(0)
0x7b0: Push(Stack[-3])
0x7b1: IF (Stack[-1] == 0) GOTO 0x7b7; Pop(1)

0x7b2: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x7b3: Pop(0)
0x7b4: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x7b5: Pop(0)
0x7b6: GOTO 0x7bb

0x7b7: Push("Can't find lsh animation : ")
0x7b8: Pop(1); Push(Stack[-1] + Stack[-9]);
0x7b9: @ Trace(Stack[-1])
0x7ba: Pop(1)
0x7bb: Return(); Pop(6)

0x7bc: PushEmpty(float, cvector, float, cvector)
0x7bd: @@ GetEyesHeight(Stack[-2])
0x7be: Pop(0)
0x7bf: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x7c0: Push(CvectorIndex(Stack[-1], 1))
0x7c1: Stack[-1] = Stack[-3]
0x7c2: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7c3: Push("head")
0x7c4: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x7c5: Pop(1)
0x7c6: Return(); Pop(4)
...
0x81a: @ CreateFloatVector(Stack[-1])
0x81b: Pop(0)
0x81c: @@ add(Stack[-3])
0x81d: Pop(0)
0x81e: Push((int) 15)
0x81f: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x820: Pop(1)
0x821: Return(); Pop(2)

0x822: Stack[-1] = 0
0x823: PushEmpty(object, object)
0x824: @ FindActor(Stack[-1], Stack[-4])
0x825: Pop(0)
0x826: Pop(0); Push((bool) Stack[-1] == 0)
0x827: IF (Stack[-1] == 0) GOTO 0x82a; Pop(1)

0x828: Stack[-5] = (bool) 0
0x829: Return(); Pop(2)

0x82a: @ Trigger(Stack[-1], Stack[-3])
0x82b: Pop(0)
0x82c: Stack[-5] = (bool) 1
0x82d: Return(); Pop(2)

0x82e: Stack[-1] = 0
0x82f: PushEmpty(bool, bool)
0x830: @ IsPlayerActor(Stack[-3], Stack[-1])
0x831: Pop(0)
0x832: Push(Stack[-1])
0x833: IF (Stack[-1] == 0) GOTO 0x837; Pop(1)

0x834: Push("attack")
0x835: @ PlayGlobalMusic(Stack[-1])
0x836: Pop(1)
0x837: Return(); Pop(2)

0x838: PushEmpty(object, object)
0x839: @ GetScene(Stack[-1])
0x83a: Pop(0)
0x83b: Push("battle")
...
0x83e: Pop(0)
0x83f: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x840: Pop(2)
0x841: Return(); Pop(2)
...
0x85b: PushEmpty()
0x85c: PushEmpty(bool, string, string)
0x85d: Stack[-2] = "quest_d1_01"
0x85e: Stack[-1] = "attack"
0x85f: Call2 0x823
...
0x863: Push("branch")
0x864: @ GetVariable(Stack[-1], Stack[-2])
0x865: Pop(1)
0x866: Push((int) 0)
0x867: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x886: Stack[-1] = (int) 515568
0x887: Return(); Pop(0)

0x888: Stack[-1] = (int) 503353
0x889: Return(); Pop(0)

0x88a: Stack[-1] = "ui/NPC_Citizen1.png"
0x88b: Return(); Pop(0)

0x88c: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x88d: Return(); Pop(0)
...
0x893: Push(-1, 0); TaskCall(5)
0x894: Call2 0x56f

0x895: Pop(-1, 0); TaskReturn
0x896: Pop(1)
0x897: Return(); Pop(0)

0x898: PushEmpty()
0x899: PushEmpty(object, int, float)
...
0x8a0: PushEmpty()
0x8a1: PushEmpty(object, int, float, cvector, cvector)
0x8a2: Stack[-5] = Stack[-11]
0x8a3: Stack[-4] = Stack[-10]
0x8a4: Stack[-3] = Stack[-9]
0x8a5: Stack[-2] = Stack[-7]
