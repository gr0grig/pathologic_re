...
0x2a9: @ StopWorld()
0x2aa: Pop(0)
0x2ab: @ CameraTransit(Stack[-3], Stack[-5])
0x2ac: Pop(0)
...
0x2cc: Push("head")
0x2cd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2ce: Pop(1)
0x2cf: Push(Stack[-1])
0x2d0: IF (Stack[-1] == 0) GOTO 0x2d4; Pop(1)

0x2d1: Push("head")
0x2d2: @ UnlookAsync(Stack[-1])
0x2d3: Pop(1)
0x2d4: Return(); Pop(2)

0x2d5: PushEmpty(bool, float, float, bool, float, float)
0x2d6: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2d7: Pop(0)
0x2d8: Push(Stack[-3])
0x2d9: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2da: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2db: Pop(0)
0x2dc: Push((bool) 0)
0x2dd: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2de: Pop(1)
0x2df: GOTO 0x2e4

0x2e0: Push("Can't find lsh animation : ")
...
0x2e6: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2e7: Pop(0)
0x2e8: Push(Stack[-3])
0x2e9: IF (Stack[-1] == 0) GOTO 0x2ef; Pop(1)

0x2ea: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2eb: Pop(0)
0x2ec: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2ed: Pop(0)
0x2ee: GOTO 0x2f3

0x2ef: Push("Can't find lsh animation : ")
0x2f0: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2f1: @ Trace(Stack[-1])
0x2f2: Pop(1)
0x2f3: Return(); Pop(6)

0x2f4: PushEmpty(float, cvector, float, cvector)
0x2f5: @@ GetEyesHeight(Stack[-2])
0x2f6: Pop(0)
0x2f7: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x31b: Stack[-1] = (int) 541572
0x31c: Return(); Pop(0)

0x31d: Stack[-1] = (int) 541571
0x31e: Return(); Pop(0)

0x31f: Stack[-1] = "ui/NPC_Citizen1.png"
0x320: Return(); Pop(0)

0x321: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x322: Return(); Pop(0)

0x323: Stack[-1] = (bool) 0
0x324: Return(); Pop(0)

0x325: PushEmpty(string, string)
0x326: Stack[-1] = "idle"
0x327: Push(Stack[-3])
0x328: IF (Stack[-1] == 0) GOTO 0x32a; Pop(1)

0x329: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x32a: Stack[-4] = Stack[-1]
0x32b: Return(); Pop(2)

0x32c: PushEmpty(int, bool, int, bool)
0x32d: Stack[-2] = (int) 0
0x32e: Push("all")
0x32f: PushEmpty(string, int)
0x330: Stack[-1] = Stack[-5]
0x331: Call2 0x325

0x332: Pop(1)
0x333: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x334: Pop(2)
...
0x338: Push((int) 1)
0x339: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x33a: GOTO 0x32e
...
0x351: Stack[-1] = "ood1SalesmanLaska1"
0x352: Call2 0x316
