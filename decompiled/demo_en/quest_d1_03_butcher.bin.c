...
Label_183:
	...
	func_1934(var_45_bool); // 0xb9 NEW_2
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool)
{
	...
	func_1833(var_21_object); // 0xee NEW_2
...
task_2_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool)
{
	...
	func_1833(var_16_object); // 0xf6 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool, var_15_int)
{
	...
	func_1889(var_18_object); // 0x3ee NEW_2
...
Label_1035:
	...
	func_1774(var_19_object); // 0x40f NEW_2
...
task_5_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_float, var_11_int, var_12_bool, var_13_object, var_14_bool)
{
	...
	func_1833(var_15_object); // 0x4b8 NEW_2
...
{
	var_19_object = Obj(); var_20_int = 0; var_21_float = 0; // 0x7a9 PushV
	var_19_object = var_15_object; // 0x7aa Mov
	var_20_int = var_16_int; // 0x7ab Mov
	var_21_float = var_17_float; // 0x7ac Mov
	func_1565(var_19_object, var_20_int, var_21_float); // 0x7ad NEW_2
...
{
	var_21_object = Obj(); var_22_int = 0; var_23_float = 0; var_24_cvector = CVector(0,0,0); var_25_cvector = CVector(0,0,0); // 0x7b1 PushV
	var_21_object = var_15_object; // 0x7b2 Mov
	var_22_int = var_16_int; // 0x7b3 Mov
	var_23_float = var_17_float; // 0x7b4 Mov
	var_24_cvector = var_19_cvector; // 0x7b5 Mov
	var_25_cvector = var_20_cvector; // 0x7b6 Mov
	func_1633(var_23_float, var_24_cvector, var_25_cvector); // 0x7b7 NEW_2
...
{
	var_17_float = 0; var_18_float = 0; // 0x7ba PushV
	var_19_string = "health"; // 0x7bb PushS
	var_20_bool = var_16_string == var_19_string; // 0x7bc Eq
	if(var_20_bool == 0) goto Label_1990; // 0x7bd JumpB
	var_21_string = "health"; // 0x7be PushS
	GetProperty(var_21_string, var_18_float); // 0x7bf Func
	var_22_int = 0; // 0x7c1 PushI
	var_23_bool = var_18_float <= var_22_int; // 0x7c2 LE
	if(var_23_bool == 0) goto Label_1990; // 0x7c3 JumpB
	SignalDeath(var_15_object); // 0x7c4 Func
...
{
	var_16_object = Obj(); // 0x7c8 PushV
	var_16_object = var_15_object; // 0x7c9 Mov
	func_1947(var_16_object); // 0x7ca NEW_2
...
func_1792(var_47_string)
{
	var_48_bool = 0; var_49_int = 0; var_50_bool = 0; var_51_int = 0; var_52_bool = 0; var_53_float = 0; var_54_cvector = CVector(0,0,0); var_55_cvector = CVector(0,0,0); var_56_bool = 0; var_57_int = 0; var_58_bool = 0; var_59_int = 0; var_60_bool = 0; var_61_float = 0; var_62_cvector = CVector(0,0,0); var_63_cvector = CVector(0,0,0); // 0x700 PushV
	IsExisting3DSound(var_56_bool, var_47_string); // 0x701 Func
	var_64_bool = var_56_bool == 0; // 0x703 Not
	if(var_64_bool == 0) goto Label_1817; // 0x704 JumpB
	var_57_int = 0; // 0x705 MovI
	
Label_1798:
	var_65_int = 1; // 0x706 PushI
	var_66_int = var_57_int + var_65_int; // 0x707 Add
	var_67_int = var_47_string + var_66_int; // 0x708 Add
	IsExisting3DSound(var_58_bool, var_67_int); // 0x709 Func
	var_68_bool = var_58_bool == 0; // 0x70b Not
	if(var_68_bool == 0) goto Label_1806; // 0x70c JumpB
	goto Label_1809; // 0x70d Jump
	
Label_1809:
	var_69_bool = var_57_int == 0; // 0x711 Not
	if(var_69_bool == 0) goto Label_1812; // 0x712 JumpB
	return 16; // 0x713 Return
	
Label_1812:
	irand(var_59_int, var_57_int); // 0x714 Func
	var_70_int = 1; // 0x716 PushI
	var_71_int = var_59_int + var_70_int; // 0x717 Add
	var_47_string = var_47_string + var_71_int; // 0x718 Add2
	
Label_1817:
	Is3DSoundLoaded(var_60_bool, var_47_string); // 0x719 Func
	var_72_bool = var_60_bool; // 0x71b Push
	if(var_72_bool == 0) goto Label_1832; // 0x71c JumpB
	GetEyesHeight(var_61_float); // 0x71d Func
	GetDirection(var_62_cvector); // 0x71f Func
	var_73_int = 50; // 0x721 PushI
	var_63_cvector = var_62_cvector * var_73_int; // 0x722 Mult2
	var_74_float = GetByIndex(var_63_cvector, 1); // 0x723 PushE
	var_74_float = var_74_float + var_61_float; // 0x724 Add2
	SetByIndex(var_63_cvector, 1) = var_74_float; // 0x725 PopE
	PlayGlobalSound(var_47_string, var_63_cvector); // 0x726 Func
	
Label_1832:
	return 16; // 0x728 Return
	
Label_1806:
	var_75_int = 1; // 0x70e PushI
	var_57_int = var_57_int + var_75_int; // 0x70f Add2
	goto Label_1798; // 0x710 Jump
}
...
func_132(var_2_object, var_94_string)
{
	...
	func_1934(var_95_bool); // 0x86 NEW_2
...
Label_150:
	func_1759(var_98_string, var_99_bool); // 0x96 NEW_2
...
func_1926(var_75_int)
{
	var_75_int = 515562; // 0x786 MovI
...
func_1928(var_74_int)
{
	var_74_int = 503347; // 0x788 MovI
	return 0; // 0x789 Return
}


func_1930(var_76_string)
{
	var_76_string = "ui/NPC_Citizen1.png"; // 0x78a MovS
	return 0; // 0x78b Return
}


func_1932(var_77_string)
{
	var_77_string = "ui/NPC_Citizen1_b.png"; // 0x78c MovS
	return 0; // 0x78d Return
}


func_1934(var_69_bool)
{
	var_69_bool = 0; // 0x78e MovB
...
func_1936()
{
	var_15_object = Obj(); // 0x790 PushV
	func_1833(var_15_object); // 0x791 NEW_2
	RemoveActor(var_15_object); // 0x793 Func
	var_18_bool = 0; var_19_string = ""; var_20_string = ""; // 0x795 PushV
	var_19_string = "quest_d1_03"; // 0x796 MovS
	var_20_string = "butcher_fail"; // 0x797 MovS
	func_1877(var_18_bool, var_19_string, var_20_string); // 0x798 NEW_2
...
Label_302:
	...
	func_1833(var_89_object); // 0x138 NEW_2
...
Label_439:
	...
	var_509_string = "all"; // 0x1b9 PushS
	var_510_string = "fjump"; // 0x1ba PushS
	PlayAnimation(var_509_string, var_510_string); // 0x1bb Func
	WaitForAnimEnd(); // 0x1bd Func
	func_925(var_58_float); // 0x1c0 NEW_2
	var_511_cvector = CVector(0.0, 0.0, 0.0); // 0x1c2 PushVec
	SetSpeed(var_511_cvector); // 0x1c3 Func
	Stop(); // 0x1c5 Func
	StopAsync(); // 0x1c7 Func
	var_512_bool = 0; // 0x1c9 PushV
	func_882(var_58_float, var_512_bool); // 0x1ca NEW_2
	var_513_bool = var_512_bool == 0; // 0x1cc Not
	if(var_513_bool == 0) goto Label_485; // 0x1cd JumpB
	var_514_bool = 0; var_515_object = Obj(); // 0x1ce PushV
	var_515_object = var_0_object; // 0x1cf MovT
	func_1497(var_514_bool, var_515_object); // 0x1d0 NEW_2
	var_516_bool = var_514_bool == 0; // 0x1d2 Not
	if(var_516_bool == 0) goto Label_469; // 0x1d3 JumpB
...
Label_469:
	...
	var_517_float = var_36_float * var_36_float; // 0x1db Mult
	var_518_bool = var_55_float < var_517_float; // 0x1dc LT
	if(var_518_bool == 0) goto Label_485; // 0x1dd JumpB
	var_519_bool = 0; var_520_float = 0; // 0x1de PushV
	var_520_float = var_36_float; // 0x1df Mov
	func_586(var_58_float, var_519_bool, var_520_float); // 0x1e0 NEW_2
	var_521_bool = var_519_bool == 0; // 0x1e2 Not
	if(var_521_bool == 0) goto Label_485; // 0x1e3 JumpB
	goto Label_495; // 0x1e4 Jump
	
Label_486:
	var_522_bool = 0; var_523_float = 0; // 0x1e6 PushV
	var_523_float = var_36_float; // 0x1e7 Mov
	func_586(var_58_float, var_522_bool, var_523_float); // 0x1e8 NEW_2
	var_524_bool = var_522_bool == 0; // 0x1ea Not
	if(var_524_bool == 0) goto Label_493; // 0x1eb JumpB
...
{
	var_17_bool = 0; var_18_string = ""; var_19_string = ""; // 0x79c PushV
	var_18_string = "quest_d1_03"; // 0x79d MovS
	var_19_string = "butcher_death"; // 0x79e MovS
	func_1877(var_17_bool, var_18_string, var_19_string); // 0x79f NEW_2
	var_23_object = Obj(); // 0x7a1 PushV
	var_23_object = var_16_object; // 0x7a2 Mov
	TaskCall(5); // 0x7a3 TaskCall
	func_1213(var_23_object); // 0x7a4 NEW_2
...
func_925(var_0_object)
{
	...
	func_1889(var_130_object); // 0x39f NEW_2
...
Label_1581:
	...
	func_1839(var_47_cvector, var_48_cvector); // 0x634 NEW_2
...
func_1313(var_46_string)
{
	...
	func_1792(var_47_string); // 0x52e NEW_2
...
func_930(var_467_int)
{
	var_467_int = 0; // 0x3a2 MovI
...
func_547(var_0_object, var_392_float, var_393_int)
{
	...
	var_467_int = 0; // 0x23e PushV
	func_930(var_467_int); // 0x23f NEW_2
	ReportHit(var_0_object, var_467_int, var_399_float, var_398_float); // 0x241 Func
	var_468_object = Obj(); var_469_float = 0; // 0x243 PushV
	var_468_object = var_397_object; // 0x244 Mov
	var_469_float = var_399_float; // 0x245 Mov
...
func_932()
{
	...
	func_1792(var_263_string); // 0x3a6 NEW_2
	return 0; // 0x3a8 Return
}


func_1833(var_15_object)
{
	var_16_object = Obj(); var_17_object = Obj(); // 0x729 PushV
	self(var_17_object); // 0x72a Func
	var_15_object = var_17_object; // 0x72c Mov
...
func_939(var_492_bool)
{
	var_492_bool = 1; // 0x3ab MovB
...
func_1839(var_47_cvector, var_48_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x72f PushV
	var_57_int = var_48_cvector | var_48_cvector; // 0x730 Or
	var_56_float = sqrt(var_57_int); // 0x731 Sqrt2
	var_58_float = 0.0; // 0x732 PushF
	var_59_bool = var_56_float < var_58_float; // 0x733 LT
	if(var_59_bool == 0) goto Label_1847; // 0x734 JumpB
	var_47_cvector = CVector(0.0, 0.0, 0.0); // 0x735 MovV
	return 2; // 0x736 Return
	
Label_1847:
	var_47_cvector = var_48_cvector / var_48_cvector; // 0x737 Div2
...
func_951(var_2_object, var_137_bool, var_138_object, var_139_float, var_140_float, var_141_bool, var_142_bool)
{
	...
	func_1889(var_150_object); // 0x3ba NEW_2
	...
	func_1774(var_154_object); // 0x3c7 NEW_2
...
Label_971:
	...
	func_1833(var_165_object); // 0x3d1 NEW_2
...
func_1849(var_444_float, var_445_float, var_446_float)
{
	var_449_bool = var_445_float < var_446_float; // 0x73a LT
	if(var_449_bool == 0) goto Label_1854; // 0x73b JumpB
	var_444_float = var_445_float; // 0x73c Mov
...
Label_1854:
	var_444_float = var_446_float; // 0x73e Mov
}
...
func_1726()
{
	var_138_bool = 0; var_139_bool = 0; // 0x6be PushV
	CameraSwitchToNormal(); // 0x6bf Func
	var_140_bool = 0; // 0x6c1 PushV
	func_1934(var_140_bool); // 0x6c2 NEW_2
	if(var_140_bool == 0) goto Label_1734; // 0x6c4 JumpB
	goto Label_1742; // 0x6c5 Jump
	
Label_1742:
	return 2; // 0x6ce Return
	
Label_1734:
	var_141_string = "head"; // 0x6c6 PushS
	HasAnimationTrack(var_139_bool, var_141_string); // 0x6c7 Func
	var_142_bool = var_139_bool; // 0x6c9 Push
	if(var_142_bool == 0) goto Label_1742; // 0x6ca JumpB
	var_143_string = "head"; // 0x6cb PushS
	UnlookAsync(var_143_string); // 0x6cc Func
}


func_1856(var_454_float, var_455_float, var_456_float, var_457_float)
{
	var_458_bool = var_455_float < var_456_float; // 0x741 LT
	if(var_458_bool == 0) goto Label_1861; // 0x742 JumpB
	var_454_float = var_456_float; // 0x743 Mov
	return 0; // 0x744 Return
	
Label_1861:
	var_459_bool = var_455_float > var_457_float; // 0x745 GT
	if(var_459_bool == 0) goto Label_1865; // 0x746 JumpB
	var_454_float = var_457_float; // 0x747 Mov
	return 0; // 0x748 Return
	
Label_1865:
	var_454_float = var_455_float; // 0x749 Mov
...
Label_1290:
	...
	func_1792(var_99_string); // 0x50c NEW_2
...
Label_111:
	...
	func_1743(var_120_string); // 0x71 NEW_2
...
Label_622:
	...
	var_470_string = "all"; // 0x273 PushS
	var_471_string = "attack_middle"; // 0x274 PushS
	var_472_int = var_471_string + var_361_int; // 0x275 Add
	HasAnimation(var_362_bool, var_470_string, var_472_int); // 0x276 Func
	var_473_bool = var_362_bool; // 0x278 Push
	if(var_473_bool == 0) goto Label_703; // 0x279 JumpB
	func_1898(); // 0x27b NEW_2
	var_474_string = "all"; // 0x27d PushS
	var_475_string = "attack_middle"; // 0x27e PushS
	var_476_int = var_475_string + var_361_int; // 0x27f Add
	PlayAnimation(var_474_string, var_476_int); // 0x280 Func
	WaitForAnimEnd(); // 0x282 Func
	func_925(var_364_string); // 0x285 NEW_2
	var_477_bool = 0; var_478_object = Obj(); // 0x287 PushV
	var_478_object = var_0_object; // 0x288 MovT
	func_1497(var_477_bool, var_478_object); // 0x289 NEW_2
	var_479_bool = var_477_bool == 0; // 0x28b Not
	if(var_479_bool == 0) goto Label_657; // 0x28c JumpB
	StopAsync(); // 0x28d Func
	var_355_bool = 0; // 0x28f MovB
	return 8; // 0x290 Return
	
Label_657:
	var_480_float = 0; var_481_int = 0; // 0x291 PushV
	var_480_float = var_356_float; // 0x292 Mov
	var_481_int = var_361_int; // 0x293 Mov
	func_547(var_364_string, var_480_float, var_481_int); // 0x294 NEW_2
	var_363_int = 1; // 0x296 MovI
	
Label_663:
	var_482_string = "attack_middle"; // 0x297 PushS
	var_483_int = var_482_string + var_361_int; // 0x298 Add
	var_484_string = "_"; // 0x299 PushS
	var_485_int = var_483_int + var_484_string; // 0x29a Add
	var_364_string = var_485_int + var_363_int; // 0x29b Add2
	var_486_string = "all"; // 0x29c PushS
	HasAnimation(var_362_bool, var_486_string, var_364_string); // 0x29d Func
	var_487_bool = var_362_bool == 0; // 0x29f Not
	if(var_487_bool == 0) goto Label_674; // 0x2a0 JumpB
	goto Label_703; // 0x2a1 Jump
	
Label_703:
	var_488_bool = 0; // 0x2bf PushB
	SetAttackState(var_488_bool); // 0x2c0 Func
	var_489_string = "all"; // 0x2c2 PushS
	var_490_string = "attack_end"; // 0x2c3 PushS
	var_491_int = var_490_string + var_361_int; // 0x2c4 Add
	PlayAnimation(var_489_string, var_491_int); // 0x2c5 Func
	var_492_bool = 0; // 0x2c7 PushV
	func_939(var_492_bool); // 0x2c8 NEW_2
	if(var_492_bool == 0) goto Label_721; // 0x2ca JumpB
	var_493_bool = 0; var_494_float = 0; // 0x2cb PushV
	var_494_float = 0.75; // 0x2cc MovF
	func_723(var_493_bool, var_494_float); // 0x2cd NEW_2
...
Label_674:
	func_1898(); // 0x2a3 NEW_2
	var_502_string = "all"; // 0x2a5 PushS
	PlayAnimation(var_502_string, var_364_string); // 0x2a6 Func
	WaitForAnimEnd(); // 0x2a8 Func
	func_925(var_364_string); // 0x2ab NEW_2
	var_503_bool = 0; var_504_object = Obj(); // 0x2ad PushV
	var_504_object = var_0_object; // 0x2ae MovT
	func_1497(var_503_bool, var_504_object); // 0x2af NEW_2
	var_505_bool = var_503_bool == 0; // 0x2b1 Not
	if(var_505_bool == 0) goto Label_695; // 0x2b2 JumpB
	StopAsync(); // 0x2b3 Func
	var_355_bool = 0; // 0x2b5 MovB
	return 8; // 0x2b6 Return
	
Label_695:
	var_506_float = 0; var_507_int = 0; // 0x2b7 PushV
	var_506_float = var_356_float; // 0x2b8 Mov
	var_507_int = var_361_int; // 0x2b9 Mov
	func_547(var_364_string, var_506_float, var_507_int); // 0x2ba NEW_2
	var_508_int = 1; // 0x2bc PushI
	var_363_int = var_363_int + var_508_int; // 0x2bd Add2
	goto Label_663; // 0x2be Jump
}


func_1867(var_462_float)
{
	var_463_object = Obj(); var_464_object = Obj(); // 0x74b PushV
	CreateFloatVector(var_464_object); // 0x74c Func
	add(var_462_float); // 0x74e ObjFunc
	var_465_int = 15; // 0x750 PushI
	SendWorldWndMessage(var_465_int, var_464_object); // 0x751 Func
	return 2; // 0x753 Return
}


func_1743(var_120_string)
{
	var_121_bool = 0; var_122_float = 0; var_123_float = 0; var_124_bool = 0; var_125_float = 0; var_126_float = 0; // 0x6cf PushV
	lshHasAnimation(var_124_bool, var_120_string); // 0x6d0 Func
	var_127_bool = var_124_bool; // 0x6d2 Push
	if(var_127_bool == 0) goto Label_1754; // 0x6d3 JumpB
	lshGetAnimTimes(var_120_string, var_125_float, var_126_float); // 0x6d4 Func
	var_128_bool = 0; // 0x6d6 PushB
	lshPlayAnimation(var_125_float, var_126_float, var_128_bool); // 0x6d7 Func
	goto Label_1758; // 0x6d9 Jump
	
Label_1758:
	return 6; // 0x6de Return
	
Label_1754:
	var_129_string = "Can't find lsh animation : "; // 0x6da PushS
	var_130_int = var_129_string + var_120_string; // 0x6db Add
	Trace(var_130_int); // 0x6dc Func
}
...
func_723(var_493_bool, var_494_float)
{
	var_495_float = 0; var_496_bool = 0; var_497_float = 0; var_498_bool = 0; // 0x2d3 PushV
	rand(var_497_float); // 0x2d4 Func
	var_499_bool = var_497_float < var_494_float; // 0x2d6 LT
	if(var_499_bool == 0) goto Label_743; // 0x2d7 JumpB
	
Label_728:
	IsAnimationPlaying(var_498_bool); // 0x2d8 Func
	var_500_bool = var_498_bool == 0; // 0x2da Not
	if(var_500_bool == 0) goto Label_733; // 0x2db JumpB
...
Label_748:
	var_493_bool = 0; // 0x2ec MovB
	return 4; // 0x2ed Return
	
Label_733:
	var_501_bool = 0; // 0x2dd PushV
	func_821(var_501_bool); // 0x2de NEW_2
	if(var_501_bool == 0) goto Label_739; // 0x2e0 JumpB
	var_493_bool = 1; // 0x2e1 MovB
...
Label_743:
	...
	func_925(var_498_bool); // 0x2ea NEW_2
}


func_1877(var_17_bool, var_18_string, var_19_string)
{
	var_20_object = Obj(); var_21_object = Obj(); // 0x755 PushV
	FindActor(var_21_object, var_18_string); // 0x756 Func
	var_22_bool = var_21_object == 0; // 0x758 NullEq
	if(var_22_bool == 0) goto Label_1884; // 0x759 JumpB
	var_17_bool = 0; // 0x75a MovB
	return 2; // 0x75b Return
	
Label_1884:
	Trigger(var_21_object, var_19_string); // 0x75c Func
	var_17_bool = 1; // 0x75e MovB
...
func_1759(var_98_string, var_99_bool)
{
	var_102_bool = 0; var_103_float = 0; var_104_float = 0; var_105_bool = 0; var_106_float = 0; var_107_float = 0; // 0x6df PushV
	lshHasAnimation(var_105_bool, var_98_string); // 0x6e0 Func
	var_108_bool = var_105_bool; // 0x6e2 Push
	if(var_108_bool == 0) goto Label_1769; // 0x6e3 JumpB
	lshGetAnimTimes(var_98_string, var_106_float, var_107_float); // 0x6e4 Func
	lshPlayAnimation(var_106_float, var_107_float, var_99_bool); // 0x6e6 Func
...
Label_1769:
	var_109_string = "Can't find lsh animation : "; // 0x6e9 PushS
	var_110_int = var_109_string + var_98_string; // 0x6ea Add
	Trace(var_110_int); // 0x6eb Func
}


func_1889(var_18_object)
{
	var_19_bool = 0; var_20_bool = 0; // 0x761 PushV
	IsPlayerActor(var_18_object, var_20_bool); // 0x762 Func
	var_21_bool = var_20_bool; // 0x764 Push
	if(var_21_bool == 0) goto Label_1897; // 0x765 JumpB
	var_22_string = "attack"; // 0x766 PushS
	PlayGlobalMusic(var_22_string); // 0x767 Func
...
Label_1422:
	...
	func_1849(var_444_float, var_445_float, var_446_float); // 0x593 NEW_2
	...
	func_1856(var_454_float, var_455_float, var_456_float, var_457_float); // 0x5a1 NEW_2
	...
	func_1867(var_462_float); // 0x5ac NEW_2
...
Label_1402:
	var_466_string = "armor"; // 0x57a PushS
	GetProperty(var_466_string, var_419_int); // 0x57b ObjFunc
}


func_1898()
{
	var_367_object = Obj(); var_368_object = Obj(); // 0x76a PushV
	GetScene(var_368_object); // 0x76b Func
	var_369_string = "battle"; // 0x76d PushS
	var_370_object = Obj(); // 0x76e PushV
	func_1833(var_370_object); // 0x76f NEW_2
	BroadcastMessage(var_369_string, var_370_object, var_368_object); // 0x771 Func
...
func_1774(var_19_object)
{
	var_20_float = 0; var_21_cvector = CVector(0,0,0); var_22_float = 0; var_23_cvector = CVector(0,0,0); // 0x6ee PushV
	GetEyesHeight(var_22_float); // 0x6ef ObjFunc
	var_23_cvector = CVector(0.0, 0.0, 0.0); // 0x6f1 MovV
	var_24_float = GetByIndex(var_23_cvector, 1); // 0x6f2 PushE
	var_24_float = var_22_float; // 0x6f3 Mov
	SetByIndex(var_23_cvector, 1) = var_24_float; // 0x6f4 PopE
	var_25_string = "head"; // 0x6f5 PushS
	LookAsync(var_19_object, var_25_string, var_23_cvector); // 0x6f6 Func
...
func_1909(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x775 PushV
	var_81_string = "branch"; // 0x776 PushS
	GetVariable(var_81_string, var_80_int); // 0x777 Func
	var_82_int = 0; // 0x779 PushI
	var_83_bool = var_80_int == var_82_int; // 0x77a Eq
	if(var_83_bool == 0) goto Label_1919; // 0x77b JumpB
	var_78_int = 1; // 0x77c MovI
	return 2; // 0x77d Return
	
Label_1919:
	var_84_int = 1; // 0x77f PushI
	var_85_bool = var_80_int == var_84_int; // 0x780 Eq
	if(var_85_bool == 0) goto Label_1924; // 0x781 JumpB
	var_78_int = 2; // 0x782 MovI
	return 2; // 0x783 Return
	
Label_1924:
	var_78_int = 3; // 0x784 MovI
...
func_1785()
{
	var_18_bool = 0; // 0x6f9 PushV
	func_1934(var_18_bool); // 0x6fa NEW_2
	if(var_18_bool == 0) goto Label_1791; // 0x6fc JumpB
	lshStopSpeech(); // 0x6fd Func
...
func_1658(var_27_bool, var_29_float)
{
	...
	func_1839(var_54_cvector, var_55_cvector); // 0x695 NEW_2
...
Label_1699:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x6a5 Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x6a7 PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x6a8 PushE
	Rotate(var_67_float, var_68_float); // 0x6a9 Func
	var_69_bool = 0; // 0x6ab PushV
	func_1934(var_69_bool); // 0x6ac NEW_2
	if(var_69_bool == 0) goto Label_1712; // 0x6ae JumpB
	goto Label_1720; // 0x6af Jump
	
Label_1720:
	CameraWaitForPlayFinish(); // 0x6b8 Func
	ResumeWorld(); // 0x6ba Func
	var_27_bool = 1; // 0x6bc MovB
	return 18; // 0x6bd Return
	
Label_1712:
	var_70_string = "head"; // 0x6b0 PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x6b1 Func
	var_71_bool = var_47_bool; // 0x6b3 Push
	if(var_71_bool == 0) goto Label_1720; // 0x6b4 JumpB
	var_72_string = "head"; // 0x6b5 PushS
	LookAsyncCamera(var_72_string); // 0x6b6 Func
}
...
func_251()
{
	...
	func_1877(var_27_bool, var_28_string, var_29_string); // 0xff NEW_2
