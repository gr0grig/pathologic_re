...
Label_199:
	...
	func_2264(var_63_bool); // 0xc9 NEW_2
...
task_3_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_int, var_15_cvector, var_16_cvector)
{
	...
	func_2054(var_19_object); // 0x3b6 NEW_2
...
Label_979:
	...
	func_1890(var_20_object); // 0x3d7 NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_cvector)
{
	...
	func_2111(var_20_object); // 0x493 NEW_2
...
{
	var_17_bool = 0; var_18_bool = 0; // 0x875 PushV
	var_19_bool = GlobalVars[0]; // 0x876 PushGE
	if(var_19_bool == 0) goto Label_2169; // 0x877 JumpB
	return 2; // 0x878 Return
	
Label_2169:
	IsPlayerActor(var_16_object, var_18_bool); // 0x879 Func
	var_20_bool = var_18_bool; // 0x87b Push
	if(var_20_bool == 0) goto Label_2181; // 0x87c JumpB
	var_21_bool = GlobalVars[0]; // 0x87d PushGE
	var_21_bool = 1; // 0x87e MovB
	GlobalVars[0] = var_21_bool; // 0x87f PopGE
	var_22_bool = 0; var_23_string = ""; var_24_string = ""; // 0x880 PushV
	var_23_string = "quest_d2_02"; // 0x881 MovS
	var_24_string = "player_attack"; // 0x882 MovS
	func_2042(var_22_bool, var_23_string, var_24_string); // 0x883 NEW_2
...
{
	var_16_bool = 0; var_17_string = ""; var_18_string = ""; // 0x886 PushV
	var_17_string = "quest_d2_02"; // 0x887 MovS
	var_18_string = "mpatrol_unload"; // 0x888 MovS
	func_2042(var_16_bool, var_17_string, var_18_string); // 0x889 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0x8ac PushV
	var_20_object = var_16_object; // 0x8ad Mov
	var_21_int = var_17_int; // 0x8ae Mov
	var_22_float = var_18_float; // 0x8af Mov
	func_1681(var_20_object, var_21_int, var_22_float); // 0x8b0 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0x8b4 PushV
	var_22_object = var_16_object; // 0x8b5 Mov
	var_23_int = var_17_int; // 0x8b6 Mov
	var_24_float = var_18_float; // 0x8b7 Mov
	var_25_cvector = var_20_cvector; // 0x8b8 Mov
	var_26_cvector = var_21_cvector; // 0x8b9 Mov
	func_1749(var_24_float, var_25_cvector, var_26_cvector); // 0x8ba NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0x8bd PushV
	var_20_string = "health"; // 0x8be PushS
	var_21_bool = var_17_string == var_20_string; // 0x8bf Eq
	if(var_21_bool == 0) goto Label_2249; // 0x8c0 JumpB
	var_22_string = "health"; // 0x8c1 PushS
	GetProperty(var_22_string, var_19_float); // 0x8c2 Func
	var_23_int = 0; // 0x8c4 PushI
	var_24_bool = var_19_float <= var_23_int; // 0x8c5 LE
	if(var_24_bool == 0) goto Label_2249; // 0x8c6 JumpB
	SignalDeath(var_16_object); // 0x8c7 Func
...
{
	var_17_object = Obj(); // 0x8cb PushV
	var_17_object = var_16_object; // 0x8cc Mov
	func_2188(var_17_object); // 0x8cd NEW_2
...
func_2054(var_125_object)
{
	var_126_bool = 0; var_127_bool = 0; // 0x806 PushV
	IsPlayerActor(var_125_object, var_127_bool); // 0x807 Func
	var_128_bool = var_127_bool; // 0x809 Push
	if(var_128_bool == 0) goto Label_2062; // 0x80a JumpB
	var_129_string = "attack"; // 0x80b PushS
	PlayGlobalMusic(var_129_string); // 0x80c Func
...
func_2063()
{
	var_362_object = Obj(); var_363_object = Obj(); // 0x80f PushV
	GetScene(var_363_object); // 0x810 Func
	var_364_string = "battle"; // 0x812 PushS
	var_365_object = Obj(); // 0x813 PushV
	func_1949(var_365_object); // 0x814 NEW_2
	BroadcastMessage(var_364_string, var_365_object, var_363_object); // 0x816 Func
...
Label_572:
	...
	var_465_string = "all"; // 0x241 PushS
	var_466_string = "attack_middle"; // 0x242 PushS
	var_467_int = var_466_string + var_356_int; // 0x243 Add
	HasAnimation(var_357_bool, var_465_string, var_467_int); // 0x244 Func
	var_468_bool = var_357_bool; // 0x246 Push
	if(var_468_bool == 0) goto Label_653; // 0x247 JumpB
	func_2063(); // 0x249 NEW_2
	var_469_string = "all"; // 0x24b PushS
	var_470_string = "attack_middle"; // 0x24c PushS
	var_471_int = var_470_string + var_356_int; // 0x24d Add
	PlayAnimation(var_469_string, var_471_int); // 0x24e Func
	WaitForAnimEnd(); // 0x250 Func
	func_875(var_359_string); // 0x253 NEW_2
	var_472_bool = 0; var_473_object = Obj(); // 0x255 PushV
	var_473_object = var_0_object; // 0x256 MovT
	func_1613(var_472_bool, var_473_object); // 0x257 NEW_2
	var_474_bool = var_472_bool == 0; // 0x259 Not
	if(var_474_bool == 0) goto Label_607; // 0x25a JumpB
	StopAsync(); // 0x25b Func
	var_350_bool = 0; // 0x25d MovB
	return 8; // 0x25e Return
	
Label_607:
	var_475_float = 0; var_476_int = 0; // 0x25f PushV
	var_475_float = var_351_float; // 0x260 Mov
	var_476_int = var_356_int; // 0x261 Mov
	func_497(var_359_string, var_475_float, var_476_int); // 0x262 NEW_2
	var_358_int = 1; // 0x264 MovI
	
Label_613:
	var_477_string = "attack_middle"; // 0x265 PushS
	var_478_int = var_477_string + var_356_int; // 0x266 Add
	var_479_string = "_"; // 0x267 PushS
	var_480_int = var_478_int + var_479_string; // 0x268 Add
	var_359_string = var_480_int + var_358_int; // 0x269 Add2
	var_481_string = "all"; // 0x26a PushS
	HasAnimation(var_357_bool, var_481_string, var_359_string); // 0x26b Func
	var_482_bool = var_357_bool == 0; // 0x26d Not
	if(var_482_bool == 0) goto Label_624; // 0x26e JumpB
	goto Label_653; // 0x26f Jump
	
Label_653:
	var_483_bool = 0; // 0x28d PushB
	SetAttackState(var_483_bool); // 0x28e Func
	var_484_string = "all"; // 0x290 PushS
	var_485_string = "attack_end"; // 0x291 PushS
	var_486_int = var_485_string + var_356_int; // 0x292 Add
	PlayAnimation(var_484_string, var_486_int); // 0x293 Func
	var_487_bool = 0; // 0x295 PushV
	func_889(var_487_bool); // 0x296 NEW_2
	if(var_487_bool == 0) goto Label_671; // 0x298 JumpB
	var_488_bool = 0; var_489_float = 0; // 0x299 PushV
	var_489_float = 0.75; // 0x29a MovF
	func_673(var_488_bool, var_489_float); // 0x29b NEW_2
...
Label_624:
	func_2063(); // 0x271 NEW_2
	var_497_string = "all"; // 0x273 PushS
	PlayAnimation(var_497_string, var_359_string); // 0x274 Func
	WaitForAnimEnd(); // 0x276 Func
	func_875(var_359_string); // 0x279 NEW_2
	var_498_bool = 0; var_499_object = Obj(); // 0x27b PushV
	var_499_object = var_0_object; // 0x27c MovT
	func_1613(var_498_bool, var_499_object); // 0x27d NEW_2
	var_500_bool = var_498_bool == 0; // 0x27f Not
	if(var_500_bool == 0) goto Label_645; // 0x280 JumpB
	StopAsync(); // 0x281 Func
	var_350_bool = 0; // 0x283 MovB
	return 8; // 0x284 Return
	
Label_645:
	var_501_float = 0; var_502_int = 0; // 0x285 PushV
	var_501_float = var_351_float; // 0x286 Mov
	var_502_int = var_356_int; // 0x287 Mov
	func_497(var_359_string, var_501_float, var_502_int); // 0x288 NEW_2
	var_503_int = 1; // 0x28a PushI
	var_358_int = var_358_int + var_503_int; // 0x28b Add2
...
func_1304(var_19_object)
{
	...
	var_148_bool = GlobalVars[2]; // 0x51f PushGE
	var_148_bool = 1; // 0x520 MovB
	GlobalVars[2] = var_148_bool; // 0x521 PopGE
...
func_2074()
{
	var_24_bool = 0; var_25_string = ""; var_26_string = ""; // 0x81b PushV
	var_25_string = "quest_d2_02"; // 0x81c MovS
	var_26_string = "player_attack"; // 0x81d MovS
	func_2042(var_24_bool, var_25_string, var_26_string); // 0x81e NEW_2
...
func_2081()
{
	var_34_bool = 0; var_35_string = ""; var_36_string = ""; // 0x822 PushV
	var_35_string = "quest_d2_02"; // 0x823 MovS
	var_36_string = "completed"; // 0x824 MovS
	func_2042(var_34_bool, var_35_string, var_36_string); // 0x825 NEW_2
...
func_2088(var_82_int)
{
	var_83_int = 0; var_84_int = 0; // 0x828 PushV
	var_85_string = "branch"; // 0x829 PushS
	GetVariable(var_85_string, var_84_int); // 0x82a Func
	var_86_int = 0; // 0x82c PushI
	var_87_bool = var_84_int == var_86_int; // 0x82d Eq
	if(var_87_bool == 0) goto Label_2098; // 0x82e JumpB
	var_82_int = 1; // 0x82f MovI
	return 2; // 0x830 Return
	
Label_2098:
	var_88_int = 1; // 0x832 PushI
	var_89_bool = var_84_int == var_88_int; // 0x833 Eq
	if(var_89_bool == 0) goto Label_2103; // 0x834 JumpB
	var_82_int = 2; // 0x835 MovI
	return 2; // 0x836 Return
	
Label_2103:
	var_82_int = 3; // 0x837 MovI
...
func_1842()
{
	var_142_bool = 0; var_143_bool = 0; // 0x732 PushV
	CameraSwitchToNormal(); // 0x733 Func
	var_144_bool = 0; // 0x735 PushV
	func_2264(var_144_bool); // 0x736 NEW_2
	if(var_144_bool == 0) goto Label_1850; // 0x738 JumpB
	goto Label_1858; // 0x739 Jump
	
Label_1858:
	return 2; // 0x742 Return
	
Label_1850:
	var_145_string = "head"; // 0x73a PushS
	HasAnimationTrack(var_143_bool, var_145_string); // 0x73b Func
	var_146_bool = var_143_bool; // 0x73d Push
	if(var_146_bool == 0) goto Label_1858; // 0x73e JumpB
	var_147_string = "head"; // 0x73f PushS
	UnlookAsync(var_147_string); // 0x740 Func
}


func_2105(var_68_int)
{
	var_69_int = 0; var_70_int = 0; // 0x839 PushV
	var_71_string = "branch"; // 0x83a PushS
	GetVariable(var_71_string, var_70_int); // 0x83b Func
	var_68_int = var_70_int; // 0x83d Mov
	return 2; // 0x83e Return
}


func_2111(var_20_object)
{
	var_21_int = 0; // 0x840 PushV
	func_2105(var_21_int); // 0x841 NEW_2
	var_25_int = 1; // 0x843 PushI
	var_26_bool = var_21_int == var_25_int; // 0x844 Eq
	if(var_26_bool == 0) goto Label_2121; // 0x845 JumpB
	WorkWithCorpse(var_20_object); // 0x846 Func
...
Label_2121:
	Barter(var_20_object); // 0x849 Func
}
...
func_1859(var_124_string)
{
	var_125_bool = 0; var_126_float = 0; var_127_float = 0; var_128_bool = 0; var_129_float = 0; var_130_float = 0; // 0x743 PushV
	lshHasAnimation(var_128_bool, var_124_string); // 0x744 Func
	var_131_bool = var_128_bool; // 0x746 Push
	if(var_131_bool == 0) goto Label_1870; // 0x747 JumpB
	lshGetAnimTimes(var_124_string, var_129_float, var_130_float); // 0x748 Func
	var_132_bool = 0; // 0x74a PushB
	lshPlayAnimation(var_129_float, var_130_float, var_132_bool); // 0x74b Func
	goto Label_1874; // 0x74d Jump
	
Label_1874:
	return 6; // 0x752 Return
	
Label_1870:
	var_133_string = "Can't find lsh animation : "; // 0x74e PushS
	var_134_int = var_133_string + var_124_string; // 0x74f Add
	Trace(var_134_int); // 0x750 Func
}
...
Label_1370:
	...
	func_1965(var_30_float, var_31_cvector, var_32_cvector); // 0x562 NEW_2
...
Label_111:
	...
	func_1859(var_124_string); // 0x71 NEW_2
...
func_2124(var_74_string)
{
	var_75_object = Obj(); var_76_int = 0; var_77_bool = 0; var_78_object = Obj(); var_79_int = 0; var_80_bool = 0; // 0x84c PushV
	CreateInvItem(var_78_object); // 0x84d Func
	SetItemName(var_74_string); // 0x84f ObjFunc
	var_81_string = "Organ"; // 0x851 PushS
	var_82_int = 1; // 0x852 PushI
	SetProperty(var_81_string, var_82_int); // 0x853 ObjFunc
	GetItemID(var_79_int); // 0x855 ObjFunc
	var_83_int = 0; // 0x857 PushI
	var_84_int = 1; // 0x858 PushI
	AddItem(var_80_bool, var_78_object, var_83_int, var_84_int); // 0x859 Func
	return 6; // 0x85b Return
}
...
func_1875(var_102_string, var_103_bool)
{
	var_106_bool = 0; var_107_float = 0; var_108_float = 0; var_109_bool = 0; var_110_float = 0; var_111_float = 0; // 0x753 PushV
	lshHasAnimation(var_109_bool, var_102_string); // 0x754 Func
	var_112_bool = var_109_bool; // 0x756 Push
	if(var_112_bool == 0) goto Label_1885; // 0x757 JumpB
	lshGetAnimTimes(var_102_string, var_110_float, var_111_float); // 0x758 Func
	lshPlayAnimation(var_110_float, var_111_float, var_103_bool); // 0x75a Func
	goto Label_1889; // 0x75c Jump
	
Label_1889:
	return 6; // 0x761 Return
	
Label_1885:
	var_113_string = "Can't find lsh animation : "; // 0x75d PushS
	var_114_int = var_113_string + var_102_string; // 0x75e Add
	Trace(var_114_int); // 0x75f Func
}


func_2141()
{
	var_68_int = 0; // 0x85d PushV
	func_2105(var_68_int); // 0x85e NEW_2
	var_72_int = 1; // 0x860 PushI
	var_73_bool = var_68_int != var_72_int; // 0x861 Neq
	if(var_73_bool == 0) goto Label_2148; // 0x862 JumpB
	return 0; // 0x863 Return
	
Label_2148:
	var_74_string = ""; // 0x864 PushV
	var_74_string = "liver"; // 0x865 MovS
	func_2124(var_74_string); // 0x866 NEW_2
	var_85_string = ""; // 0x868 PushV
	var_85_string = "kidney"; // 0x869 MovS
	func_2124(var_85_string); // 0x86a NEW_2
	var_86_string = ""; // 0x86c PushV
	var_86_string = "heart"; // 0x86d MovS
	func_2124(var_86_string); // 0x86e NEW_2
	var_87_string = ""; // 0x870 PushV
	var_87_string = "blood"; // 0x871 MovS
	func_2124(var_87_string); // 0x872 NEW_2
	return 0; // 0x874 Return
}


func_1890(var_149_object)
{
	var_150_float = 0; var_151_cvector = CVector(0,0,0); var_152_float = 0; var_153_cvector = CVector(0,0,0); // 0x762 PushV
	GetEyesHeight(var_152_float); // 0x763 ObjFunc
	var_153_cvector = CVector(0.0, 0.0, 0.0); // 0x765 MovV
	var_154_float = GetByIndex(var_153_cvector, 1); // 0x766 PushE
	var_154_float = var_152_float; // 0x767 Mov
	SetByIndex(var_153_cvector, 1) = var_154_float; // 0x768 PopE
	var_155_string = "head"; // 0x769 PushS
	LookAsync(var_149_object, var_155_string, var_153_cvector); // 0x76a Func
...
func_875(var_0_object)
{
	...
	func_2054(var_125_object); // 0x36d NEW_2
...
func_1901()
{
	var_19_bool = 0; // 0x76d PushV
	func_2264(var_19_bool); // 0x76e NEW_2
	if(var_19_bool == 0) goto Label_1907; // 0x770 JumpB
	lshStopSpeech(); // 0x771 Func
...
func_882()
{
	...
	func_1908(var_258_string); // 0x374 NEW_2
...
func_1908(var_112_string)
{
	var_113_bool = 0; var_114_int = 0; var_115_bool = 0; var_116_int = 0; var_117_bool = 0; var_118_float = 0; var_119_cvector = CVector(0,0,0); var_120_cvector = CVector(0,0,0); var_121_bool = 0; var_122_int = 0; var_123_bool = 0; var_124_int = 0; var_125_bool = 0; var_126_float = 0; var_127_cvector = CVector(0,0,0); var_128_cvector = CVector(0,0,0); // 0x774 PushV
	IsExisting3DSound(var_121_bool, var_112_string); // 0x775 Func
	var_129_bool = var_121_bool == 0; // 0x777 Not
	if(var_129_bool == 0) goto Label_1933; // 0x778 JumpB
	var_122_int = 0; // 0x779 MovI
	
Label_1914:
	var_130_int = 1; // 0x77a PushI
	var_131_int = var_122_int + var_130_int; // 0x77b Add
	var_132_int = var_112_string + var_131_int; // 0x77c Add
	IsExisting3DSound(var_123_bool, var_132_int); // 0x77d Func
	var_133_bool = var_123_bool == 0; // 0x77f Not
	if(var_133_bool == 0) goto Label_1922; // 0x780 JumpB
	goto Label_1925; // 0x781 Jump
	
Label_1925:
	var_134_bool = var_122_int == 0; // 0x785 Not
	if(var_134_bool == 0) goto Label_1928; // 0x786 JumpB
	return 16; // 0x787 Return
	
Label_1928:
	irand(var_124_int, var_122_int); // 0x788 Func
	var_135_int = 1; // 0x78a PushI
	var_136_int = var_124_int + var_135_int; // 0x78b Add
	var_112_string = var_112_string + var_136_int; // 0x78c Add2
	
Label_1933:
	Is3DSoundLoaded(var_125_bool, var_112_string); // 0x78d Func
	var_137_bool = var_125_bool; // 0x78f Push
	if(var_137_bool == 0) goto Label_1948; // 0x790 JumpB
	GetEyesHeight(var_126_float); // 0x791 Func
	GetDirection(var_127_cvector); // 0x793 Func
	var_138_int = 50; // 0x795 PushI
	var_128_cvector = var_127_cvector * var_138_int; // 0x796 Mult2
	var_139_float = GetByIndex(var_128_cvector, 1); // 0x797 PushE
	var_139_float = var_139_float + var_126_float; // 0x798 Add2
	SetByIndex(var_128_cvector, 1) = var_139_float; // 0x799 PopE
	PlayGlobalSound(var_112_string, var_128_cvector); // 0x79a Func
	
Label_1948:
	return 16; // 0x79c Return
	
Label_1922:
	var_140_int = 1; // 0x782 PushI
	var_122_int = var_122_int + var_140_int; // 0x783 Add2
	goto Label_1914; // 0x784 Jump
}
...
func_895(var_2_object, var_132_bool, var_133_object, var_134_float, var_135_float, var_136_bool, var_137_bool)
{
	...
	func_2054(var_145_object); // 0x382 NEW_2
	...
	func_1890(var_149_object); // 0x38f NEW_2
...
Label_915:
	...
	func_1949(var_160_object); // 0x399 NEW_2
...
func_132(var_2_object, var_98_string)
{
	...
	func_2264(var_99_bool); // 0x86 NEW_2
...
Label_150:
	func_1875(var_102_string, var_103_bool); // 0x96 NEW_2
...
{
	var_18_bool = 0; var_19_bool = 0; // 0x88c PushV
	var_20_string = "revolver_ammo"; // 0x88d PushS
	var_21_int = 0; // 0x88e PushI
	var_22_int = 2; // 0x88f PushI
	AddItem(var_19_bool, var_20_string, var_21_int, var_22_int); // 0x890 Func
	var_23_string = "alpha_pills"; // 0x892 PushS
	var_24_int = 0; // 0x893 PushI
	var_25_int = 2; // 0x894 PushI
	AddItem(var_19_bool, var_23_string, var_24_int, var_25_int); // 0x895 Func
	var_26_bool = 0; var_27_object = Obj(); // 0x897 PushV
	var_27_object = var_17_object; // 0x898 Mov
	func_1460(var_26_bool, var_27_object); // 0x899 NEW_2
	if(var_26_bool == 0) goto Label_2209; // 0x89b JumpB
	var_30_bool = 0; var_31_object = Obj(); var_32_float = 0; // 0x89c PushV
	var_31_object = var_17_object; // 0x89d Mov
	var_32_float = -0.15; // 0x89e MovF
	func_1987(var_30_bool, var_31_object, var_32_float); // 0x89f NEW_2
	
Label_2209:
	func_2141(); // 0x8a2 NEW_2
	var_88_object = Obj(); // 0x8a4 PushV
	var_88_object = var_17_object; // 0x8a5 Mov
	TaskCall(4); // 0x8a6 TaskCall
	func_1151(var_88_object); // 0x8a7 NEW_2
...
Label_1697:
	...
	func_1955(var_48_cvector, var_49_cvector); // 0x6a8 NEW_2
...
Label_1242:
	...
	func_1908(var_164_string); // 0x4dc NEW_2
...
func_1949(var_84_object)
{
	var_85_object = Obj(); var_86_object = Obj(); // 0x79d PushV
	self(var_86_object); // 0x79e Func
	var_84_object = var_86_object; // 0x7a0 Mov
...
func_673(var_488_bool, var_489_float)
{
	var_490_float = 0; var_491_bool = 0; var_492_float = 0; var_493_bool = 0; // 0x2a1 PushV
	rand(var_492_float); // 0x2a2 Func
	var_494_bool = var_492_float < var_489_float; // 0x2a4 LT
	if(var_494_bool == 0) goto Label_693; // 0x2a5 JumpB
	
Label_678:
	IsAnimationPlaying(var_493_bool); // 0x2a6 Func
	var_495_bool = var_493_bool == 0; // 0x2a8 Not
	if(var_495_bool == 0) goto Label_683; // 0x2a9 JumpB
...
Label_698:
	var_488_bool = 0; // 0x2ba MovB
	return 4; // 0x2bb Return
	
Label_683:
	var_496_bool = 0; // 0x2ab PushV
	func_771(var_496_bool); // 0x2ac NEW_2
	if(var_496_bool == 0) goto Label_689; // 0x2ae JumpB
	var_488_bool = 1; // 0x2af MovB
...
Label_693:
	...
	func_875(var_493_bool); // 0x2b8 NEW_2
}


func_1955(var_48_cvector, var_49_cvector)
{
	var_56_float = 0; var_57_float = 0; // 0x7a3 PushV
	var_58_int = var_49_cvector | var_49_cvector; // 0x7a4 Or
	var_57_float = sqrt(var_58_int); // 0x7a5 Sqrt2
	var_59_float = 0.0; // 0x7a6 PushF
	var_60_bool = var_57_float < var_59_float; // 0x7a7 LT
	if(var_60_bool == 0) goto Label_1963; // 0x7a8 JumpB
	var_48_cvector = CVector(0.0, 0.0, 0.0); // 0x7a9 MovV
	return 2; // 0x7aa Return
	
Label_1963:
	var_48_cvector = var_49_cvector / var_49_cvector; // 0x7ab Div2
...
func_1965(var_30_float, var_31_cvector, var_32_cvector)
{
	var_33_cvector = CVector(0,0,0); var_34_cvector = CVector(0,0,0); // 0x7ad PushV
	var_34_cvector = var_32_cvector - var_31_cvector; // 0x7ae Sub2
	var_30_float = var_34_cvector | var_34_cvector; // 0x7af Or2
	return 2; // 0x7b0 Return
}


func_1969(var_439_float, var_440_float, var_441_float)
{
	var_444_bool = var_440_float < var_441_float; // 0x7b2 LT
	if(var_444_bool == 0) goto Label_1974; // 0x7b3 JumpB
	var_439_float = var_440_float; // 0x7b4 Mov
	goto Label_1975; // 0x7b5 Jump
	
Label_1975:
	return 0; // 0x7b7 Return
	
Label_1974:
	var_439_float = var_441_float; // 0x7b6 Mov
}
...
func_1976(var_59_float, var_60_float, var_61_float, var_62_float)
{
	var_63_bool = var_60_float < var_61_float; // 0x7b9 LT
	if(var_63_bool == 0) goto Label_1981; // 0x7ba JumpB
	var_59_float = var_61_float; // 0x7bb Mov
	return 0; // 0x7bc Return
	
Label_1981:
	var_64_bool = var_60_float > var_62_float; // 0x7bd GT
	if(var_64_bool == 0) goto Label_1985; // 0x7be JumpB
	var_59_float = var_62_float; // 0x7bf Mov
	return 0; // 0x7c0 Return
	
Label_1985:
	var_59_float = var_60_float; // 0x7c1 Mov
...
func_1987(var_30_bool, var_31_object, var_32_float)
{
	var_33_bool = var_31_object == 0; // 0x7c4 Not
	if(var_33_bool == 0) goto Label_1992; // 0x7c5 JumpB
	var_30_bool = 0; // 0x7c6 MovB
	return 0; // 0x7c7 Return
	
Label_1992:
	var_34_int = 0; // 0x7c8 PushI
	var_35_bool = var_32_float > var_34_int; // 0x7c9 GT
	if(var_35_bool == 0) goto Label_1999; // 0x7ca JumpB
	var_36_int = 8; // 0x7cb PushI
	SendWorldWndMessage(var_36_int); // 0x7cc Func
	goto Label_2008; // 0x7ce Jump
	
Label_2008:
	var_37_float = 0; // 0x7d8 PushV
	var_37_float = var_32_float; // 0x7d9 Mov
	func_2032(var_37_float); // 0x7da NEW_2
	var_41_bool = 0; var_42_object = Obj(); var_43_string = ""; var_44_float = 0; var_45_float = 0; var_46_float = 0; // 0x7dc PushV
	var_42_object = var_31_object; // 0x7dd Mov
	var_43_string = "reputation"; // 0x7de MovS
	var_44_float = var_32_float; // 0x7df Mov
	var_45_float = 0; // 0x7e0 MovI
	var_46_float = 1; // 0x7e1 MovI
	func_1477(var_41_bool, var_42_object, var_43_string, var_44_float, var_45_float, var_46_float); // 0x7e2 NEW_2
	var_30_bool = 1; // 0x7e4 MovB
	return 0; // 0x7e5 Return
	
Label_1999:
	var_65_int = 0; // 0x7cf PushI
	var_66_bool = var_32_float < var_65_int; // 0x7d0 LT
	if(var_66_bool == 0) goto Label_2006; // 0x7d1 JumpB
	var_67_int = 9; // 0x7d2 PushI
	SendWorldWndMessage(var_67_int); // 0x7d3 Func
	goto Label_2008; // 0x7d5 Jump
	
Label_2006:
	var_30_bool = 0; // 0x7d6 MovB
...
Label_1487:
	...
	func_1976(var_59_float, var_60_float, var_61_float, var_62_float); // 0x5d5 NEW_2
...
func_2256(var_79_int)
{
	var_79_int = 515572; // 0x8d0 MovI
	return 0; // 0x8d1 Return
}


func_2258(var_78_int)
{
	var_78_int = 504031; // 0x8d2 MovI
	return 0; // 0x8d3 Return
}


func_2260(var_80_string)
{
	var_80_string = "ui/NPC_Citizen2.png"; // 0x8d4 MovS
...
func_2262(var_81_string)
{
	var_81_string = "ui/NPC_Citizen2_b.png"; // 0x8d6 MovS
...
func_2264(var_73_bool)
{
	var_73_bool = 0; // 0x8d8 MovB
...
Label_1538:
	...
	func_1969(var_439_float, var_440_float, var_441_float); // 0x607 NEW_2
	...
	func_1976(var_449_float, var_450_float, var_451_float, var_452_float); // 0x615 NEW_2
	...
	func_2022(var_457_float); // 0x620 NEW_2
...
Label_1518:
	var_461_string = "armor"; // 0x5ee PushS
	GetProperty(var_461_string, var_414_int); // 0x5ef ObjFunc
}
...
func_2022(var_457_float)
{
	var_458_object = Obj(); var_459_object = Obj(); // 0x7e6 PushV
	CreateFloatVector(var_459_object); // 0x7e7 Func
	add(var_457_float); // 0x7e9 ObjFunc
	var_460_int = 15; // 0x7eb PushI
	SendWorldWndMessage(var_460_int, var_459_object); // 0x7ec Func
...
Label_252:
	...
	func_1949(var_84_object); // 0x106 NEW_2
...
Label_389:
	...
	var_504_string = "all"; // 0x187 PushS
	var_505_string = "fjump"; // 0x188 PushS
	PlayAnimation(var_504_string, var_505_string); // 0x189 Func
	WaitForAnimEnd(); // 0x18b Func
	func_875(var_53_float); // 0x18e NEW_2
	var_506_cvector = CVector(0.0, 0.0, 0.0); // 0x190 PushVec
	SetSpeed(var_506_cvector); // 0x191 Func
	Stop(); // 0x193 Func
	StopAsync(); // 0x195 Func
	var_507_bool = 0; // 0x197 PushV
	func_832(var_53_float, var_507_bool); // 0x198 NEW_2
	var_508_bool = var_507_bool == 0; // 0x19a Not
	if(var_508_bool == 0) goto Label_435; // 0x19b JumpB
	var_509_bool = 0; var_510_object = Obj(); // 0x19c PushV
	var_510_object = var_0_object; // 0x19d MovT
	func_1613(var_509_bool, var_510_object); // 0x19e NEW_2
	var_511_bool = var_509_bool == 0; // 0x1a0 Not
	if(var_511_bool == 0) goto Label_419; // 0x1a1 JumpB
...
Label_419:
	...
	var_512_float = var_31_float * var_31_float; // 0x1a9 Mult
	var_513_bool = var_50_float < var_512_float; // 0x1aa LT
	if(var_513_bool == 0) goto Label_435; // 0x1ab JumpB
	var_514_bool = 0; var_515_float = 0; // 0x1ac PushV
	var_515_float = var_31_float; // 0x1ad Mov
	func_536(var_53_float, var_514_bool, var_515_float); // 0x1ae NEW_2
	var_516_bool = var_514_bool == 0; // 0x1b0 Not
	if(var_516_bool == 0) goto Label_435; // 0x1b1 JumpB
	goto Label_445; // 0x1b2 Jump
	
Label_436:
	var_517_bool = 0; var_518_float = 0; // 0x1b4 PushV
	var_518_float = var_31_float; // 0x1b5 Mov
	func_536(var_53_float, var_517_bool, var_518_float); // 0x1b6 NEW_2
	var_519_bool = var_517_bool == 0; // 0x1b8 Not
	if(var_519_bool == 0) goto Label_443; // 0x1b9 JumpB
...
func_1774(var_31_bool, var_33_float)
{
	...
	func_1955(var_58_cvector, var_59_cvector); // 0x709 NEW_2
...
Label_1815:
	...
	CameraTransit(var_49_cvector, var_47_cvector); // 0x719 Func
	var_71_float = GetByIndex(var_48_cvector, 0); // 0x71b PushE
	var_72_float = GetByIndex(var_48_cvector, 2); // 0x71c PushE
	Rotate(var_71_float, var_72_float); // 0x71d Func
	var_73_bool = 0; // 0x71f PushV
	func_2264(var_73_bool); // 0x720 NEW_2
	if(var_73_bool == 0) goto Label_1828; // 0x722 JumpB
	goto Label_1836; // 0x723 Jump
	
Label_1836:
	CameraWaitForPlayFinish(); // 0x72c Func
	ResumeWorld(); // 0x72e Func
	var_31_bool = 1; // 0x730 MovB
	return 18; // 0x731 Return
	
Label_1828:
	var_74_string = "head"; // 0x724 PushS
	HasAnimationTrack(var_51_bool, var_74_string); // 0x725 Func
	var_75_bool = var_51_bool; // 0x727 Push
	if(var_75_bool == 0) goto Label_1836; // 0x728 JumpB
	var_76_string = "head"; // 0x729 PushS
	LookAsyncCamera(var_76_string); // 0x72a Func
}


func_2032(var_37_float)
{
	var_38_object = Obj(); var_39_object = Obj(); // 0x7f0 PushV
	CreateFloatVector(var_39_object); // 0x7f1 Func
	add(var_37_float); // 0x7f3 ObjFunc
	var_40_int = 16; // 0x7f5 PushI
	SendWorldWndMessage(var_40_int, var_39_object); // 0x7f6 Func
...
func_1265(var_111_string)
{
	...
	func_1908(var_112_string); // 0x4fe NEW_2
...
func_497(var_0_object, var_387_float, var_388_int)
{
	...
	var_462_int = 0; // 0x20c PushV
	func_880(var_462_int); // 0x20d NEW_2
	ReportHit(var_0_object, var_462_int, var_394_float, var_393_float); // 0x20f Func
	var_463_object = Obj(); var_464_float = 0; // 0x211 PushV
	var_463_object = var_392_object; // 0x212 Mov
	var_464_float = var_394_float; // 0x213 Mov
...
func_2042(var_16_bool, var_17_string, var_18_string)
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x7fa PushV
	FindActor(var_20_object, var_17_string); // 0x7fb Func
	var_21_bool = var_20_object == 0; // 0x7fd NullEq
	if(var_21_bool == 0) goto Label_2049; // 0x7fe JumpB
	var_16_bool = 0; // 0x7ff MovB
	return 2; // 0x800 Return
	
Label_2049:
	Trigger(var_20_object, var_18_string); // 0x801 Func
	var_16_bool = 1; // 0x803 MovB
