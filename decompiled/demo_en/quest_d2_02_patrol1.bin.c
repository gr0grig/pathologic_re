...
Label_190:
	...
	func_2392(var_46_bool); // 0xc0 NEW_2
...
task_3_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_int, var_15_cvector, var_16_cvector)
{
	...
	func_2196(var_19_object); // 0x3ad NEW_2
...
Label_970:
	...
	func_2008(var_20_object); // 0x3ce NEW_2
...
task_4_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_cvector, var_16_cvector)
{
	...
	func_2239(var_20_object); // 0x48a NEW_2
...
{
	var_17_bool = 0; var_18_bool = 0; // 0x8f5 PushV
	var_19_bool = GlobalVars[0]; // 0x8f6 PushGE
	if(var_19_bool == 0) goto Label_2297; // 0x8f7 JumpB
	return 2; // 0x8f8 Return
	
Label_2297:
	IsPlayerActor(var_16_object, var_18_bool); // 0x8f9 Func
	var_20_bool = var_18_bool; // 0x8fb Push
	if(var_20_bool == 0) goto Label_2309; // 0x8fc JumpB
	var_21_bool = GlobalVars[0]; // 0x8fd PushGE
	var_21_bool = 1; // 0x8fe MovB
	GlobalVars[0] = var_21_bool; // 0x8ff PopGE
	var_22_bool = 0; var_23_string = ""; var_24_string = ""; // 0x900 PushV
	var_23_string = "quest_d2_02"; // 0x901 MovS
	var_24_string = "player_attack"; // 0x902 MovS
	func_2175(var_22_bool, var_23_string, var_24_string); // 0x903 NEW_2
...
{
	var_16_bool = 0; var_17_string = ""; var_18_string = ""; // 0x906 PushV
	var_17_string = "quest_d2_02"; // 0x907 MovS
	var_18_string = "patrol1_unload"; // 0x908 MovS
	func_2175(var_16_bool, var_17_string, var_18_string); // 0x909 NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0x92c PushV
	var_20_object = var_16_object; // 0x92d Mov
	var_21_int = var_17_int; // 0x92e Mov
	var_22_float = var_18_float; // 0x92f Mov
	func_1661(var_20_object, var_21_int, var_22_float); // 0x930 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0x934 PushV
	var_22_object = var_16_object; // 0x935 Mov
	var_23_int = var_17_int; // 0x936 Mov
	var_24_float = var_18_float; // 0x937 Mov
	var_25_cvector = var_20_cvector; // 0x938 Mov
	var_26_cvector = var_21_cvector; // 0x939 Mov
	func_1729(var_24_float, var_25_cvector, var_26_cvector); // 0x93a NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0x93d PushV
	var_20_string = "health"; // 0x93e PushS
	var_21_bool = var_17_string == var_20_string; // 0x93f Eq
	if(var_21_bool == 0) goto Label_2377; // 0x940 JumpB
	var_22_string = "health"; // 0x941 PushS
	GetProperty(var_22_string, var_19_float); // 0x942 Func
	var_23_int = 0; // 0x944 PushI
	var_24_bool = var_19_float <= var_23_int; // 0x945 LE
	if(var_24_bool == 0) goto Label_2377; // 0x946 JumpB
	SignalDeath(var_16_object); // 0x947 Func
...
{
	var_17_object = Obj(); // 0x94b PushV
	var_17_object = var_16_object; // 0x94c Mov
	func_2316(var_17_object); // 0x94d NEW_2
...
Label_45:
	...
	var_90_bool = 0; var_91_object = Obj(); // 0x2f PushV
	var_92_object = Obj(); // 0x30 PushV
	func_2082(var_92_object); // 0x31 NEW_2
	var_91_object = var_92_object; // 0x32 Mov
	func_1839(var_90_bool, var_91_object); // 0x34 NEW_2
	var_185_object = Obj(); var_186_object = Obj(); // 0x36 PushV
	var_185_object = var_20_object; // 0x37 Mov
	var_186_object = var_26_object; // 0x38 Mov
	TaskCall(1); // 0x39 TaskCall
	func_81(var_187_object, var_188_object, var_189_string, var_190_bool, var_185_object, var_186_object); // 0x3a NEW_2
	TaskReturn(); // 0x3b TaskReturn
	IsDialogEnd(var_29_bool); // 0x3d ObjFunc
	
Label_63:
	var_234_bool = var_29_bool == 0; // 0x3f Not
...
Label_70:
	...
	var_235_object = var_20_object; // 0x47 Mov
	func_1822(); // 0x48 NEW_2
...
func_2316(var_17_object)
{
	var_18_bool = 0; var_19_bool = 0; // 0x90c PushV
	var_20_string = "revolver_ammo"; // 0x90d PushS
	var_21_int = 0; // 0x90e PushI
	var_22_int = 2; // 0x90f PushI
	AddItem(var_19_bool, var_20_string, var_21_int, var_22_int); // 0x910 Func
	var_23_string = "alpha_pills"; // 0x912 PushS
	var_24_int = 0; // 0x913 PushI
	var_25_int = 2; // 0x914 PushI
	AddItem(var_19_bool, var_23_string, var_24_int, var_25_int); // 0x915 Func
	var_26_bool = 0; var_27_object = Obj(); // 0x917 PushV
	var_27_object = var_17_object; // 0x918 Mov
	func_1440(var_26_bool, var_27_object); // 0x919 NEW_2
	if(var_26_bool == 0) goto Label_2337; // 0x91b JumpB
	var_30_bool = 0; var_31_object = Obj(); var_32_float = 0; // 0x91c PushV
	var_31_object = var_17_object; // 0x91d Mov
	var_32_float = -0.15; // 0x91e MovF
	func_2120(var_30_bool, var_31_object, var_32_float); // 0x91f NEW_2
	
Label_2337:
	func_2269(); // 0x922 NEW_2
	var_88_object = Obj(); // 0x924 PushV
	var_88_object = var_17_object; // 0x925 Mov
	TaskCall(4); // 0x926 TaskCall
	func_1142(var_88_object); // 0x927 NEW_2
...
Label_563:
	...
	var_465_string = "all"; // 0x238 PushS
	var_466_string = "attack_middle"; // 0x239 PushS
	var_467_int = var_466_string + var_356_int; // 0x23a Add
	HasAnimation(var_357_bool, var_465_string, var_467_int); // 0x23b Func
	var_468_bool = var_357_bool; // 0x23d Push
	if(var_468_bool == 0) goto Label_644; // 0x23e JumpB
	func_2205(); // 0x240 NEW_2
	var_469_string = "all"; // 0x242 PushS
	var_470_string = "attack_middle"; // 0x243 PushS
	var_471_int = var_470_string + var_356_int; // 0x244 Add
	PlayAnimation(var_469_string, var_471_int); // 0x245 Func
	WaitForAnimEnd(); // 0x247 Func
	func_866(var_359_string); // 0x24a NEW_2
	var_472_bool = 0; var_473_object = Obj(); // 0x24c PushV
	var_473_object = var_0_object; // 0x24d MovT
	func_1593(var_472_bool, var_473_object); // 0x24e NEW_2
	var_474_bool = var_472_bool == 0; // 0x250 Not
	if(var_474_bool == 0) goto Label_598; // 0x251 JumpB
	StopAsync(); // 0x252 Func
	var_350_bool = 0; // 0x254 MovB
	return 8; // 0x255 Return
	
Label_598:
	var_475_float = 0; var_476_int = 0; // 0x256 PushV
	var_475_float = var_351_float; // 0x257 Mov
	var_476_int = var_356_int; // 0x258 Mov
	func_488(var_359_string, var_475_float, var_476_int); // 0x259 NEW_2
	var_358_int = 1; // 0x25b MovI
	
Label_604:
	var_477_string = "attack_middle"; // 0x25c PushS
	var_478_int = var_477_string + var_356_int; // 0x25d Add
	var_479_string = "_"; // 0x25e PushS
	var_480_int = var_478_int + var_479_string; // 0x25f Add
	var_359_string = var_480_int + var_358_int; // 0x260 Add2
	var_481_string = "all"; // 0x261 PushS
	HasAnimation(var_357_bool, var_481_string, var_359_string); // 0x262 Func
	var_482_bool = var_357_bool == 0; // 0x264 Not
	if(var_482_bool == 0) goto Label_615; // 0x265 JumpB
	goto Label_644; // 0x266 Jump
	
Label_644:
	var_483_bool = 0; // 0x284 PushB
	SetAttackState(var_483_bool); // 0x285 Func
	var_484_string = "all"; // 0x287 PushS
	var_485_string = "attack_end"; // 0x288 PushS
	var_486_int = var_485_string + var_356_int; // 0x289 Add
	PlayAnimation(var_484_string, var_486_int); // 0x28a Func
	var_487_bool = 0; // 0x28c PushV
	func_880(var_487_bool); // 0x28d NEW_2
	if(var_487_bool == 0) goto Label_662; // 0x28f JumpB
	var_488_bool = 0; var_489_float = 0; // 0x290 PushV
	var_489_float = 0.75; // 0x291 MovF
	func_664(var_488_bool, var_489_float); // 0x292 NEW_2
...
Label_615:
	func_2205(); // 0x268 NEW_2
	var_497_string = "all"; // 0x26a PushS
	PlayAnimation(var_497_string, var_359_string); // 0x26b Func
	WaitForAnimEnd(); // 0x26d Func
	func_866(var_359_string); // 0x270 NEW_2
	var_498_bool = 0; var_499_object = Obj(); // 0x272 PushV
	var_499_object = var_0_object; // 0x273 MovT
	func_1593(var_498_bool, var_499_object); // 0x274 NEW_2
	var_500_bool = var_498_bool == 0; // 0x276 Not
	if(var_500_bool == 0) goto Label_636; // 0x277 JumpB
	StopAsync(); // 0x278 Func
	var_350_bool = 0; // 0x27a MovB
	return 8; // 0x27b Return
	
Label_636:
	var_501_float = 0; var_502_int = 0; // 0x27c PushV
	var_501_float = var_351_float; // 0x27d Mov
	var_502_int = var_356_int; // 0x27e Mov
	func_488(var_359_string, var_501_float, var_502_int); // 0x27f NEW_2
	var_503_int = 1; // 0x281 PushI
	var_358_int = var_358_int + var_503_int; // 0x282 Add2
...
func_1822()
{
	var_236_bool = 0; var_237_bool = 0; // 0x71e PushV
	CameraSwitchToNormal(); // 0x71f Func
	var_238_bool = 0; // 0x721 PushV
	func_2392(var_238_bool); // 0x722 NEW_2
	if(var_238_bool == 0) goto Label_1830; // 0x724 JumpB
	goto Label_1838; // 0x725 Jump
	
Label_1838:
	return 2; // 0x72e Return
	
Label_1830:
	var_239_string = "head"; // 0x726 PushS
	HasAnimationTrack(var_237_bool, var_239_string); // 0x727 Func
	var_240_bool = var_237_bool; // 0x729 Push
	if(var_240_bool == 0) goto Label_1838; // 0x72a JumpB
	var_241_string = "head"; // 0x72b PushS
	UnlookAsync(var_241_string); // 0x72c Func
}


func_2082(var_84_object)
{
	var_85_object = Obj(); var_86_object = Obj(); // 0x822 PushV
	self(var_86_object); // 0x823 Func
	var_84_object = var_86_object; // 0x825 Mov
	return 2; // 0x826 Return
}


func_2088(var_48_cvector, var_49_cvector)
{
	var_56_float = 0; var_57_float = 0; // 0x828 PushV
	var_58_int = var_49_cvector | var_49_cvector; // 0x829 Or
	var_57_float = sqrt(var_58_int); // 0x82a Sqrt2
	var_59_float = 0.0; // 0x82b PushF
	var_60_bool = var_57_float < var_59_float; // 0x82c LT
	if(var_60_bool == 0) goto Label_2096; // 0x82d JumpB
	var_48_cvector = CVector(0.0, 0.0, 0.0); // 0x82e MovV
	return 2; // 0x82f Return
	
Label_2096:
	var_48_cvector = var_49_cvector / var_49_cvector; // 0x830 Div2
	return 2; // 0x831 Return
}


func_1839(var_90_bool, var_91_object)
{
	var_95_int = 0; var_96_int = 0; var_97_int = 0; var_98_int = 0; // 0x72f PushV
	var_99_string = "voice_common"; // 0x730 PushS
	GetVariable(var_99_string, var_97_int); // 0x731 Func
	var_100_int = var_97_int; // 0x733 Push
	if(var_100_int == 0) goto Label_1877; // 0x734 JumpB
	var_101_bool = 0; var_102_object = Obj(); // 0x735 PushV
	var_102_object = var_91_object; // 0x736 Mov
	func_1897(var_102_object); // 0x737 NEW_2
	var_131_bool = var_101_bool == 0; // 0x739 Not
	if(var_131_bool == 0) goto Label_1859; // 0x73a JumpB
	var_132_bool = 0; var_133_object = Obj(); // 0x73b PushV
	var_133_object = var_91_object; // 0x73c Mov
	func_1934(var_133_object); // 0x73d NEW_2
	var_167_bool = var_132_bool == 0; // 0x73f Not
	if(var_167_bool == 0) goto Label_1859; // 0x740 JumpB
	var_90_bool = 0; // 0x741 MovB
	return 4; // 0x742 Return
	
Label_1859:
	var_168_int = 2; // 0x743 PushI
	irand(var_98_int, var_168_int); // 0x744 Func
	var_169_int = var_98_int; // 0x746 Push
	if(var_169_int == 0) goto Label_1872; // 0x747 JumpB
	var_170_string = "voice_common"; // 0x748 PushS
	var_171_int = 1; // 0x749 PushI
	var_172_int = var_97_int + var_171_int; // 0x74a Add
	var_173_int = 3; // 0x74b PushI
	var_174_int = var_172_int / var_173_int; // 0x74c Mod
	SetVariable(var_170_string, var_174_int); // 0x74d Func
	goto Label_1876; // 0x74f Jump
	
Label_1876:
	goto Label_1895; // 0x754 Jump
	
Label_1895:
	var_90_bool = 1; // 0x767 MovB
	return 4; // 0x768 Return
	
Label_1872:
	var_175_string = "voice_common"; // 0x750 PushS
	var_176_int = 0; // 0x751 PushI
	SetVariable(var_175_string, var_176_int); // 0x752 Func
	
Label_1877:
	var_177_bool = 0; var_178_object = Obj(); // 0x755 PushV
	var_178_object = var_91_object; // 0x756 Mov
	func_1934(var_178_object); // 0x757 NEW_2
	var_179_bool = var_177_bool == 0; // 0x759 Not
	if(var_179_bool == 0) goto Label_1891; // 0x75a JumpB
	var_180_bool = 0; var_181_object = Obj(); // 0x75b PushV
	var_181_object = var_91_object; // 0x75c Mov
	func_1897(var_181_object); // 0x75d NEW_2
	var_182_bool = var_180_bool == 0; // 0x75f Not
	if(var_182_bool == 0) goto Label_1891; // 0x760 JumpB
	var_90_bool = 0; // 0x761 MovB
	return 4; // 0x762 Return
	
Label_1891:
	var_183_string = "voice_common"; // 0x763 PushS
	var_184_int = 1; // 0x764 PushI
	SetVariable(var_183_string, var_184_int); // 0x765 Func
}
...
Label_1350:
	...
	func_2098(var_29_float, var_30_cvector, var_31_cvector); // 0x54e NEW_2
...
func_2098(var_29_float, var_30_cvector, var_31_cvector)
{
	var_32_cvector = CVector(0,0,0); var_33_cvector = CVector(0,0,0); // 0x832 PushV
	var_33_cvector = var_31_cvector - var_30_cvector; // 0x833 Sub2
	var_29_float = var_33_cvector | var_33_cvector; // 0x834 Or2
	return 2; // 0x835 Return
}


func_2102(var_439_float, var_440_float, var_441_float)
{
	var_444_bool = var_440_float < var_441_float; // 0x837 LT
	if(var_444_bool == 0) goto Label_2107; // 0x838 JumpB
	var_439_float = var_440_float; // 0x839 Mov
	goto Label_2108; // 0x83a Jump
	
Label_2108:
	return 0; // 0x83c Return
	
Label_2107:
	var_439_float = var_441_float; // 0x83b Mov
}
...
func_2109(var_59_float, var_60_float, var_61_float, var_62_float)
{
	var_63_bool = var_60_float < var_61_float; // 0x83e LT
	if(var_63_bool == 0) goto Label_2114; // 0x83f JumpB
	var_59_float = var_61_float; // 0x840 Mov
	return 0; // 0x841 Return
	
Label_2114:
	var_64_bool = var_60_float > var_62_float; // 0x842 GT
	if(var_64_bool == 0) goto Label_2118; // 0x843 JumpB
	var_59_float = var_62_float; // 0x844 Mov
	return 0; // 0x845 Return
	
Label_2118:
	var_59_float = var_60_float; // 0x846 Mov
...
func_2120(var_30_bool, var_31_object, var_32_float)
{
	var_33_bool = var_31_object == 0; // 0x849 Not
	if(var_33_bool == 0) goto Label_2125; // 0x84a JumpB
	var_30_bool = 0; // 0x84b MovB
	return 0; // 0x84c Return
	
Label_2125:
	var_34_int = 0; // 0x84d PushI
	var_35_bool = var_32_float > var_34_int; // 0x84e GT
	if(var_35_bool == 0) goto Label_2132; // 0x84f JumpB
	var_36_int = 8; // 0x850 PushI
	SendWorldWndMessage(var_36_int); // 0x851 Func
	goto Label_2141; // 0x853 Jump
	
Label_2141:
	var_37_float = 0; // 0x85d PushV
	var_37_float = var_32_float; // 0x85e Mov
	func_2165(var_37_float); // 0x85f NEW_2
	var_41_bool = 0; var_42_object = Obj(); var_43_string = ""; var_44_float = 0; var_45_float = 0; var_46_float = 0; // 0x861 PushV
	var_42_object = var_31_object; // 0x862 Mov
	var_43_string = "reputation"; // 0x863 MovS
	var_44_float = var_32_float; // 0x864 Mov
	var_45_float = 0; // 0x865 MovI
	var_46_float = 1; // 0x866 MovI
	func_1457(var_41_bool, var_42_object, var_43_string, var_44_float, var_45_float, var_46_float); // 0x867 NEW_2
	var_30_bool = 1; // 0x869 MovB
	return 0; // 0x86a Return
	
Label_2132:
	var_65_int = 0; // 0x854 PushI
	var_66_bool = var_32_float < var_65_int; // 0x855 LT
	if(var_66_bool == 0) goto Label_2139; // 0x856 JumpB
	var_67_int = 9; // 0x857 PushI
	SendWorldWndMessage(var_67_int); // 0x858 Func
	goto Label_2141; // 0x85a Jump
	
Label_2139:
	var_30_bool = 0; // 0x85b MovB
	return 0; // 0x85c Return
}


func_2384(var_78_int)
{
	var_78_int = 515572; // 0x950 MovI
	return 0; // 0x951 Return
}


func_81(var_0_object, var_1_object, var_2_object, var_3_string, var_185_object, var_186_object)
{
	var_0_object = var_186_object; // 0x52 TMov
	var_1_object = var_185_object; // 0x53 TMov
	var_3_string = 0; // 0x54 TMovB
	var_191_int = 1; // 0x55 PushI
	if(var_191_int == 0) goto Label_109; // 0x56 JumpB
	var_192_string = ""; // 0x57 PushV
	var_192_string = "Neutral"; // 0x58 MovS
	func_139(var_186_object, var_192_string); // 0x59 NEW_2
	var_209_int = 507526; // 0x5b PushI
	SetMessage(var_209_int); // 0x5c TObjFunc
	ClearReplies(); // 0x5e TObjFunc
	var_210_int = 507527; // 0x60 PushI
	var_211_int = -1; // 0x61 PushI
	var_212_int = 8309; // 0x62 PushI
	AddReply(var_210_int, var_211_int, var_212_int); // 0x63 TObjFunc
	var_213_int = 533979; // 0x65 PushI
	var_214_int = -1; // 0x66 PushI
	var_215_int = 35550; // 0x67 PushI
	AddReply(var_213_int, var_214_int, var_215_int); // 0x68 TObjFunc
	goto Label_109; // 0x6a Jump
	
Label_109:
	var_216_bool = 0; // 0x6d PushV
	func_2392(var_216_bool); // 0x6e NEW_2
	if(var_216_bool == 0) goto Label_124; // 0x70 JumpB
	
Label_113:
	lshWaitForAnimEnd(); // 0x71 Func
	var_217_string = var_3_string; // 0x73 PushT
	if(var_217_string == 0) goto Label_118; // 0x74 JumpB
...
Label_118:
	var_218_string = ""; // 0x76 PushV
	var_218_string = var_2_object; // 0x77 MovT
	func_1977(var_218_string); // 0x78 NEW_2
	goto Label_113; // 0x7a Jump
	
Label_124:
	var_229_string = "all"; // 0x7c PushS
	var_230_string = "idle"; // 0x7d PushS
	PlayAnimation(var_229_string, var_230_string); // 0x7e Func
	
Label_128:
	WaitForAnimEnd(); // 0x80 Func
	var_231_string = var_3_string; // 0x82 PushT
	if(var_231_string == 0) goto Label_133; // 0x83 JumpB
	goto Label_138; // 0x84 Jump
	
Label_133:
	var_232_string = "all"; // 0x85 PushS
	var_233_string = "idle"; // 0x86 PushS
	PlayAnimation(var_232_string, var_233_string); // 0x87 Func
...
func_2386(var_77_int)
{
	var_77_int = 504031; // 0x952 MovI
	return 0; // 0x953 Return
}


func_2388(var_79_string)
{
	var_79_string = "ui/NPC_Citizen2.png"; // 0x954 MovS
	return 0; // 0x955 Return
}


func_2390(var_80_string)
{
	var_80_string = "ui/NPC_Citizen2_b.png"; // 0x956 MovS
	return 0; // 0x957 Return
}


func_2392(var_72_bool)
{
	var_72_bool = 0; // 0x958 MovB
...
func_866(var_0_object)
{
	...
	func_2196(var_125_object); // 0x364 NEW_2
...
func_873()
{
	...
	func_2041(var_258_string); // 0x36b NEW_2
	return 0; // 0x36d Return
}


func_1897(var_101_bool)
{
	var_103_string = ""; var_104_int = 0; var_105_bool = 0; var_106_int = 0; var_107_string = ""; var_108_string = ""; var_109_int = 0; var_110_bool = 0; var_111_int = 0; var_112_string = ""; // 0x769 PushV
	var_108_string = "c"; // 0x76a MovS
	var_109_int = 0; // 0x76b MovI
	
Label_1900:
	var_113_int = 1; // 0x76c PushI
	if(var_113_int == 0) goto Label_1913; // 0x76d JumpB
	var_114_int = 1; // 0x76e PushI
	var_115_int = var_109_int + var_114_int; // 0x76f Add
	var_116_int = var_108_string + var_115_int; // 0x770 Add
	HasProperty(var_116_int, var_110_bool); // 0x771 ObjFunc
	var_117_bool = var_110_bool == 0; // 0x773 Not
	if(var_117_bool == 0) goto Label_1910; // 0x774 JumpB
	goto Label_1913; // 0x775 Jump
	
Label_1913:
	var_118_bool = var_109_int == 0; // 0x779 Not
	if(var_118_bool == 0) goto Label_1917; // 0x77a JumpB
	var_101_bool = 0; // 0x77b MovB
	return 10; // 0x77c Return
	
Label_1917:
	var_111_int = 0; // 0x77d MovI
	var_119_int = 1; // 0x77e PushI
	var_120_bool = var_109_int > var_119_int; // 0x77f GT
	if(var_120_bool == 0) goto Label_1923; // 0x780 JumpB
	irand(var_111_int, var_109_int); // 0x781 Func
	
Label_1923:
	var_121_int = 1; // 0x783 PushI
	var_122_int = var_111_int + var_121_int; // 0x784 Add
	var_123_int = var_108_string + var_122_int; // 0x785 Add
	GetProperty(var_123_int, var_112_string); // 0x786 ObjFunc
	var_124_bool = 0; var_125_string = ""; // 0x788 PushV
	var_125_string = var_112_string; // 0x789 Mov
	func_2019(var_124_bool, var_125_string); // 0x78a NEW_2
	var_101_bool = var_124_bool; // 0x78b Mov
	return 10; // 0x78d Return
	
Label_1910:
	var_130_int = 1; // 0x776 PushI
	var_109_int = var_109_int + var_130_int; // 0x777 Add2
	goto Label_1900; // 0x778 Jump
}
...
func_2155(var_457_float)
{
	var_458_object = Obj(); var_459_object = Obj(); // 0x86b PushV
	CreateFloatVector(var_459_object); // 0x86c Func
	add(var_457_float); // 0x86e ObjFunc
	var_460_int = 15; // 0x870 PushI
	SendWorldWndMessage(var_460_int, var_459_object); // 0x871 Func
...
func_2165(var_37_float)
{
	var_38_object = Obj(); var_39_object = Obj(); // 0x875 PushV
	CreateFloatVector(var_39_object); // 0x876 Func
	add(var_37_float); // 0x878 ObjFunc
	var_40_int = 16; // 0x87a PushI
	SendWorldWndMessage(var_40_int, var_39_object); // 0x87b Func
...
func_886(var_2_object, var_132_bool, var_133_object, var_134_float, var_135_float, var_136_bool, var_137_bool)
{
	...
	func_2196(var_145_object); // 0x379 NEW_2
	...
	func_2008(var_149_object); // 0x386 NEW_2
...
Label_906:
	...
	func_2082(var_160_object); // 0x390 NEW_2
...
Label_1677:
	...
	func_2088(var_48_cvector, var_49_cvector); // 0x694 NEW_2
...
func_2175(var_16_bool, var_17_string, var_18_string)
{
	var_19_object = Obj(); var_20_object = Obj(); // 0x87f PushV
	FindActor(var_20_object, var_17_string); // 0x880 Func
	var_21_bool = var_20_object == 0; // 0x882 NullEq
	if(var_21_bool == 0) goto Label_2182; // 0x883 JumpB
	var_16_bool = 0; // 0x884 MovB
	return 2; // 0x885 Return
	
Label_2182:
	Trigger(var_20_object, var_18_string); // 0x886 Func
	var_16_bool = 1; // 0x888 MovB
...
func_139(var_2_object, var_192_string)
{
	var_193_bool = 0; // 0x8c PushV
	func_2392(var_193_bool); // 0x8d NEW_2
	var_194_bool = var_193_bool == 0; // 0x8f Not
	if(var_194_bool == 0) goto Label_146; // 0x90 JumpB
	return 0; // 0x91 Return
	
Label_146:
	var_195_bool = var_192_string == var_2_object; // 0x92 Eq
	if(var_195_bool == 0) goto Label_149; // 0x93 JumpB
	return 0; // 0x94 Return
	
Label_149:
	var_196_string = ""; var_197_bool = 0; // 0x95 PushV
	var_196_string = var_192_string; // 0x96 Mov
	var_198_string = ""; // 0x97 PushS
	var_199_bool = var_192_string == var_198_string; // 0x98 Eq
	if(var_199_bool == 0) goto Label_156; // 0x99 JumpB
	var_197_bool = 0; // 0x9a MovB
	goto Label_157; // 0x9b Jump
	
Label_157:
	func_1993(var_196_string, var_197_bool); // 0x9d NEW_2
	var_2_object = var_192_string; // 0x9f TMov
	return 0; // 0xa0 Return
	
Label_156:
	var_197_bool = 1; // 0x9c MovB
}


func_2187(var_145_int)
{
	var_146_float = 0; var_147_float = 0; // 0x88b PushV
	GetGameTime(var_147_float); // 0x88c Func
	var_148_int = 1; // 0x88e PushI
	var_149_int = 0; // 0x88f PushV
	var_150_int = 24; // 0x890 PushI
	var_149_int = var_147_float / var_147_float; // 0x891 Div2
	var_145_int = var_148_int + var_149_int; // 0x892 Add2
...
Label_1233:
	...
	func_2041(var_164_string); // 0x4d3 NEW_2
...
func_1934(var_132_bool)
{
	var_134_string = ""; var_135_int = 0; var_136_bool = 0; var_137_int = 0; var_138_string = ""; var_139_string = ""; var_140_int = 0; var_141_bool = 0; var_142_int = 0; var_143_string = ""; // 0x78e PushV
	var_144_string = "d"; // 0x78f PushS
	var_145_int = 0; // 0x790 PushV
	func_2187(var_145_int); // 0x791 NEW_2
	var_151_int = var_144_string + var_145_int; // 0x793 Add
	var_152_string = "m"; // 0x794 PushS
	var_139_string = var_151_int + var_152_string; // 0x795 Add2
	var_140_int = 0; // 0x796 MovI
	
Label_1943:
	var_153_int = 1; // 0x797 PushI
	if(var_153_int == 0) goto Label_1956; // 0x798 JumpB
	var_154_int = 1; // 0x799 PushI
	var_155_int = var_140_int + var_154_int; // 0x79a Add
	var_156_int = var_139_string + var_155_int; // 0x79b Add
	HasProperty(var_156_int, var_141_bool); // 0x79c ObjFunc
	var_157_bool = var_141_bool == 0; // 0x79e Not
	if(var_157_bool == 0) goto Label_1953; // 0x79f JumpB
	goto Label_1956; // 0x7a0 Jump
	
Label_1956:
	var_158_bool = var_140_int == 0; // 0x7a4 Not
	if(var_158_bool == 0) goto Label_1960; // 0x7a5 JumpB
	var_132_bool = 0; // 0x7a6 MovB
	return 10; // 0x7a7 Return
	
Label_1960:
	var_142_int = 0; // 0x7a8 MovI
	var_159_int = 1; // 0x7a9 PushI
	var_160_bool = var_140_int > var_159_int; // 0x7aa GT
	if(var_160_bool == 0) goto Label_1966; // 0x7ab JumpB
	irand(var_142_int, var_140_int); // 0x7ac Func
	
Label_1966:
	var_161_int = 1; // 0x7ae PushI
	var_162_int = var_142_int + var_161_int; // 0x7af Add
	var_163_int = var_139_string + var_162_int; // 0x7b0 Add
	GetProperty(var_163_int, var_143_string); // 0x7b1 ObjFunc
	var_164_bool = 0; var_165_string = ""; // 0x7b3 PushV
	var_165_string = var_143_string; // 0x7b4 Mov
	func_2019(var_164_bool, var_165_string); // 0x7b5 NEW_2
	var_132_bool = var_164_bool; // 0x7b6 Mov
	return 10; // 0x7b8 Return
	
Label_1953:
	var_166_int = 1; // 0x7a1 PushI
	var_140_int = var_140_int + var_166_int; // 0x7a2 Add2
	goto Label_1943; // 0x7a3 Jump
}


func_2196(var_125_object)
{
	var_126_bool = 0; var_127_bool = 0; // 0x894 PushV
	IsPlayerActor(var_125_object, var_127_bool); // 0x895 Func
	var_128_bool = var_127_bool; // 0x897 Push
	if(var_128_bool == 0) goto Label_2204; // 0x898 JumpB
	var_129_string = "attack"; // 0x899 PushS
	PlayGlobalMusic(var_129_string); // 0x89a Func
...
func_664(var_488_bool, var_489_float)
{
	var_490_float = 0; var_491_bool = 0; var_492_float = 0; var_493_bool = 0; // 0x298 PushV
	rand(var_492_float); // 0x299 Func
	var_494_bool = var_492_float < var_489_float; // 0x29b LT
	if(var_494_bool == 0) goto Label_684; // 0x29c JumpB
	
Label_669:
	IsAnimationPlaying(var_493_bool); // 0x29d Func
	var_495_bool = var_493_bool == 0; // 0x29f Not
	if(var_495_bool == 0) goto Label_674; // 0x2a0 JumpB
...
Label_689:
	var_488_bool = 0; // 0x2b1 MovB
	return 4; // 0x2b2 Return
	
Label_674:
	var_496_bool = 0; // 0x2a2 PushV
	func_762(var_496_bool); // 0x2a3 NEW_2
	if(var_496_bool == 0) goto Label_680; // 0x2a5 JumpB
...
Label_684:
	...
	func_866(var_493_bool); // 0x2af NEW_2
}
...
func_2205()
{
	var_362_object = Obj(); var_363_object = Obj(); // 0x89d PushV
	GetScene(var_363_object); // 0x89e Func
	var_364_string = "battle"; // 0x8a0 PushS
	var_365_object = Obj(); // 0x8a1 PushV
	func_2082(var_365_object); // 0x8a2 NEW_2
	BroadcastMessage(var_364_string, var_365_object, var_363_object); // 0x8a4 Func
...
func_2216(var_81_int)
{
	var_82_int = 0; var_83_int = 0; // 0x8a8 PushV
	var_84_string = "branch"; // 0x8a9 PushS
	GetVariable(var_84_string, var_83_int); // 0x8aa Func
	var_85_int = 0; // 0x8ac PushI
	var_86_bool = var_83_int == var_85_int; // 0x8ad Eq
	if(var_86_bool == 0) goto Label_2226; // 0x8ae JumpB
	var_81_int = 1; // 0x8af MovI
	return 2; // 0x8b0 Return
	
Label_2226:
	var_87_int = 1; // 0x8b2 PushI
	var_88_bool = var_83_int == var_87_int; // 0x8b3 Eq
	if(var_88_bool == 0) goto Label_2231; // 0x8b4 JumpB
	var_81_int = 2; // 0x8b5 MovI
	return 2; // 0x8b6 Return
	
Label_2231:
	var_81_int = 3; // 0x8b7 MovI
...
Label_1467:
	...
	func_2109(var_59_float, var_60_float, var_61_float, var_62_float); // 0x5c1 NEW_2
...
func_2233(var_68_int)
{
	var_69_int = 0; var_70_int = 0; // 0x8b9 PushV
	var_71_string = "branch"; // 0x8ba PushS
	GetVariable(var_71_string, var_70_int); // 0x8bb Func
	var_68_int = var_70_int; // 0x8bd Mov
	return 2; // 0x8be Return
}


func_1977(var_218_string)
{
	var_219_bool = 0; var_220_float = 0; var_221_float = 0; var_222_bool = 0; var_223_float = 0; var_224_float = 0; // 0x7b9 PushV
	lshHasAnimation(var_222_bool, var_218_string); // 0x7ba Func
	var_225_bool = var_222_bool; // 0x7bc Push
	if(var_225_bool == 0) goto Label_1988; // 0x7bd JumpB
	lshGetAnimTimes(var_218_string, var_223_float, var_224_float); // 0x7be Func
	var_226_bool = 0; // 0x7c0 PushB
	lshPlayAnimation(var_223_float, var_224_float, var_226_bool); // 0x7c1 Func
	goto Label_1992; // 0x7c3 Jump
	
Label_1992:
	return 6; // 0x7c8 Return
	
Label_1988:
	var_227_string = "Can't find lsh animation : "; // 0x7c4 PushS
	var_228_int = var_227_string + var_218_string; // 0x7c5 Add
	Trace(var_228_int); // 0x7c6 Func
}


func_2239(var_20_object)
{
	var_21_int = 0; // 0x8c0 PushV
	func_2233(var_21_int); // 0x8c1 NEW_2
	var_25_int = 1; // 0x8c3 PushI
	var_26_bool = var_21_int == var_25_int; // 0x8c4 Eq
	if(var_26_bool == 0) goto Label_2249; // 0x8c5 JumpB
	WorkWithCorpse(var_20_object); // 0x8c6 Func
	goto Label_2251; // 0x8c8 Jump
	
Label_2251:
	return 0; // 0x8cb Return
	
Label_2249:
	Barter(var_20_object); // 0x8c9 Func
}
...
Label_1518:
	...
	func_2102(var_439_float, var_440_float, var_441_float); // 0x5f3 NEW_2
	...
	func_2109(var_449_float, var_450_float, var_451_float, var_452_float); // 0x601 NEW_2
	...
	func_2155(var_457_float); // 0x60c NEW_2
...
Label_1498:
	var_461_string = "armor"; // 0x5da PushS
	GetProperty(var_461_string, var_414_int); // 0x5db ObjFunc
}


func_1993(var_196_string, var_197_bool)
{
	var_200_bool = 0; var_201_float = 0; var_202_float = 0; var_203_bool = 0; var_204_float = 0; var_205_float = 0; // 0x7c9 PushV
	lshHasAnimation(var_203_bool, var_196_string); // 0x7ca Func
	var_206_bool = var_203_bool; // 0x7cc Push
	if(var_206_bool == 0) goto Label_2003; // 0x7cd JumpB
	lshGetAnimTimes(var_196_string, var_204_float, var_205_float); // 0x7ce Func
	lshPlayAnimation(var_204_float, var_205_float, var_197_bool); // 0x7d0 Func
...
Label_2003:
	var_207_string = "Can't find lsh animation : "; // 0x7d3 PushS
	var_208_int = var_207_string + var_196_string; // 0x7d4 Add
	Trace(var_208_int); // 0x7d5 Func
}
...
func_2252(var_74_string)
{
	var_75_object = Obj(); var_76_int = 0; var_77_bool = 0; var_78_object = Obj(); var_79_int = 0; var_80_bool = 0; // 0x8cc PushV
	CreateInvItem(var_78_object); // 0x8cd Func
	SetItemName(var_74_string); // 0x8cf ObjFunc
	var_81_string = "Organ"; // 0x8d1 PushS
	var_82_int = 1; // 0x8d2 PushI
	SetProperty(var_81_string, var_82_int); // 0x8d3 ObjFunc
	GetItemID(var_79_int); // 0x8d5 ObjFunc
	var_83_int = 0; // 0x8d7 PushI
	var_84_int = 1; // 0x8d8 PushI
	AddItem(var_80_bool, var_78_object, var_83_int, var_84_int); // 0x8d9 Func
	return 6; // 0x8db Return
}
...
func_2008(var_149_object)
{
	var_150_float = 0; var_151_cvector = CVector(0,0,0); var_152_float = 0; var_153_cvector = CVector(0,0,0); // 0x7d8 PushV
	GetEyesHeight(var_152_float); // 0x7d9 ObjFunc
	var_153_cvector = CVector(0.0, 0.0, 0.0); // 0x7db MovV
	var_154_float = GetByIndex(var_153_cvector, 1); // 0x7dc PushE
	var_154_float = var_152_float; // 0x7dd Mov
	SetByIndex(var_153_cvector, 1) = var_154_float; // 0x7de PopE
	var_155_string = "head"; // 0x7df PushS
	LookAsync(var_149_object, var_155_string, var_153_cvector); // 0x7e0 Func
...
func_1754(var_30_bool, var_32_float)
{
	...
	func_2088(var_57_cvector, var_58_cvector); // 0x6f5 NEW_2
...
Label_1795:
	...
	CameraTransit(var_48_cvector, var_46_cvector); // 0x705 Func
	var_70_float = GetByIndex(var_47_cvector, 0); // 0x707 PushE
	var_71_float = GetByIndex(var_47_cvector, 2); // 0x708 PushE
	Rotate(var_70_float, var_71_float); // 0x709 Func
	var_72_bool = 0; // 0x70b PushV
	func_2392(var_72_bool); // 0x70c NEW_2
	if(var_72_bool == 0) goto Label_1808; // 0x70e JumpB
	goto Label_1816; // 0x70f Jump
	
Label_1816:
	CameraWaitForPlayFinish(); // 0x718 Func
	ResumeWorld(); // 0x71a Func
	var_30_bool = 1; // 0x71c MovB
	return 18; // 0x71d Return
	
Label_1808:
	var_73_string = "head"; // 0x710 PushS
	HasAnimationTrack(var_50_bool, var_73_string); // 0x711 Func
	var_74_bool = var_50_bool; // 0x713 Push
	if(var_74_bool == 0) goto Label_1816; // 0x714 JumpB
	var_75_string = "head"; // 0x715 PushS
	LookAsyncCamera(var_75_string); // 0x716 Func
}
...
func_2269()
{
	var_68_int = 0; // 0x8dd PushV
	func_2233(var_68_int); // 0x8de NEW_2
	var_72_int = 1; // 0x8e0 PushI
	var_73_bool = var_68_int != var_72_int; // 0x8e1 Neq
	if(var_73_bool == 0) goto Label_2276; // 0x8e2 JumpB
	return 0; // 0x8e3 Return
	
Label_2276:
	var_74_string = ""; // 0x8e4 PushV
	var_74_string = "liver"; // 0x8e5 MovS
	func_2252(var_74_string); // 0x8e6 NEW_2
	var_85_string = ""; // 0x8e8 PushV
	var_85_string = "kidney"; // 0x8e9 MovS
	func_2252(var_85_string); // 0x8ea NEW_2
	var_86_string = ""; // 0x8ec PushV
	var_86_string = "heart"; // 0x8ed MovS
	func_2252(var_86_string); // 0x8ee NEW_2
	var_87_string = ""; // 0x8f0 PushV
	var_87_string = "blood"; // 0x8f1 MovS
	func_2252(var_87_string); // 0x8f2 NEW_2
...
Label_243:
	...
	func_2082(var_84_object); // 0xfd NEW_2
...
Label_380:
	...
	var_504_string = "all"; // 0x17e PushS
	var_505_string = "fjump"; // 0x17f PushS
	PlayAnimation(var_504_string, var_505_string); // 0x180 Func
	WaitForAnimEnd(); // 0x182 Func
	func_866(var_53_float); // 0x185 NEW_2
	var_506_cvector = CVector(0.0, 0.0, 0.0); // 0x187 PushVec
	SetSpeed(var_506_cvector); // 0x188 Func
	Stop(); // 0x18a Func
	StopAsync(); // 0x18c Func
	var_507_bool = 0; // 0x18e PushV
	func_823(var_53_float, var_507_bool); // 0x18f NEW_2
	var_508_bool = var_507_bool == 0; // 0x191 Not
	if(var_508_bool == 0) goto Label_426; // 0x192 JumpB
	var_509_bool = 0; var_510_object = Obj(); // 0x193 PushV
	var_510_object = var_0_object; // 0x194 MovT
	func_1593(var_509_bool, var_510_object); // 0x195 NEW_2
	var_511_bool = var_509_bool == 0; // 0x197 Not
	if(var_511_bool == 0) goto Label_410; // 0x198 JumpB
...
Label_410:
	...
	var_512_float = var_31_float * var_31_float; // 0x1a0 Mult
	var_513_bool = var_50_float < var_512_float; // 0x1a1 LT
	if(var_513_bool == 0) goto Label_426; // 0x1a2 JumpB
	var_514_bool = 0; var_515_float = 0; // 0x1a3 PushV
	var_515_float = var_31_float; // 0x1a4 Mov
	func_527(var_53_float, var_514_bool, var_515_float); // 0x1a5 NEW_2
	var_516_bool = var_514_bool == 0; // 0x1a7 Not
	if(var_516_bool == 0) goto Label_426; // 0x1a8 JumpB
	goto Label_436; // 0x1a9 Jump
	
Label_427:
	var_517_bool = 0; var_518_float = 0; // 0x1ab PushV
	var_518_float = var_31_float; // 0x1ac Mov
	func_527(var_53_float, var_517_bool, var_518_float); // 0x1ad NEW_2
	var_519_bool = var_517_bool == 0; // 0x1af Not
	if(var_519_bool == 0) goto Label_434; // 0x1b0 JumpB
...
func_2019(var_124_bool, var_125_string)
{
	var_126_bool = 0; var_127_bool = 0; // 0x7e3 PushV
	var_128_bool = 0; // 0x7e4 PushV
	func_2392(var_128_bool); // 0x7e5 NEW_2
	if(var_128_bool == 0) goto Label_2032; // 0x7e7 JumpB
	lshHasSpeech(var_127_bool, var_125_string); // 0x7e8 Func
	var_129_bool = var_127_bool; // 0x7ea Push
	if(var_129_bool == 0) goto Label_2032; // 0x7eb JumpB
	lshPlaySpeech(var_125_string); // 0x7ec Func
	var_124_bool = 1; // 0x7ee MovB
	return 2; // 0x7ef Return
	
Label_2032:
	var_124_bool = 0; // 0x7f0 MovB
...
func_1256(var_111_string)
{
	...
	func_2041(var_112_string); // 0x4f5 NEW_2
...
func_488(var_0_object, var_387_float, var_388_int)
{
	...
	var_462_int = 0; // 0x203 PushV
	func_871(var_462_int); // 0x204 NEW_2
	ReportHit(var_0_object, var_462_int, var_394_float, var_393_float); // 0x206 Func
	var_463_object = Obj(); var_464_float = 0; // 0x208 PushV
	var_463_object = var_392_object; // 0x209 Mov
	var_464_float = var_394_float; // 0x20a Mov
...
func_2034()
{
	var_19_bool = 0; // 0x7f2 PushV
	func_2392(var_19_bool); // 0x7f3 NEW_2
	if(var_19_bool == 0) goto Label_2040; // 0x7f5 JumpB
	lshStopSpeech(); // 0x7f6 Func
...
func_2041(var_112_string)
{
	var_113_bool = 0; var_114_int = 0; var_115_bool = 0; var_116_int = 0; var_117_bool = 0; var_118_float = 0; var_119_cvector = CVector(0,0,0); var_120_cvector = CVector(0,0,0); var_121_bool = 0; var_122_int = 0; var_123_bool = 0; var_124_int = 0; var_125_bool = 0; var_126_float = 0; var_127_cvector = CVector(0,0,0); var_128_cvector = CVector(0,0,0); // 0x7f9 PushV
	IsExisting3DSound(var_121_bool, var_112_string); // 0x7fa Func
	var_129_bool = var_121_bool == 0; // 0x7fc Not
	if(var_129_bool == 0) goto Label_2066; // 0x7fd JumpB
	var_122_int = 0; // 0x7fe MovI
	
Label_2047:
	var_130_int = 1; // 0x7ff PushI
	var_131_int = var_122_int + var_130_int; // 0x800 Add
	var_132_int = var_112_string + var_131_int; // 0x801 Add
	IsExisting3DSound(var_123_bool, var_132_int); // 0x802 Func
	var_133_bool = var_123_bool == 0; // 0x804 Not
	if(var_133_bool == 0) goto Label_2055; // 0x805 JumpB
	goto Label_2058; // 0x806 Jump
	
Label_2058:
	var_134_bool = var_122_int == 0; // 0x80a Not
	if(var_134_bool == 0) goto Label_2061; // 0x80b JumpB
	return 16; // 0x80c Return
	
Label_2061:
	irand(var_124_int, var_122_int); // 0x80d Func
	var_135_int = 1; // 0x80f PushI
	var_136_int = var_124_int + var_135_int; // 0x810 Add
	var_112_string = var_112_string + var_136_int; // 0x811 Add2
	
Label_2066:
	Is3DSoundLoaded(var_125_bool, var_112_string); // 0x812 Func
	var_137_bool = var_125_bool; // 0x814 Push
	if(var_137_bool == 0) goto Label_2081; // 0x815 JumpB
	GetEyesHeight(var_126_float); // 0x816 Func
	GetDirection(var_127_cvector); // 0x818 Func
	var_138_int = 50; // 0x81a PushI
	var_128_cvector = var_127_cvector * var_138_int; // 0x81b Mult2
	var_139_float = GetByIndex(var_128_cvector, 1); // 0x81c PushE
	var_139_float = var_139_float + var_126_float; // 0x81d Add2
	SetByIndex(var_128_cvector, 1) = var_139_float; // 0x81e PopE
	PlayGlobalSound(var_112_string, var_128_cvector); // 0x81f Func
	
Label_2081:
	return 16; // 0x821 Return
	
Label_2055:
	var_140_int = 1; // 0x807 PushI
	var_122_int = var_122_int + var_140_int; // 0x808 Add2
	goto Label_2047; // 0x809 Jump
}
