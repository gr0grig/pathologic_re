...
Events:
EVENT_22 Op = 0x97e Vars = (object, int, float, float)
EVENT_43 Op = 0x986 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x990 Vars = (object, string)
EVENT_41 Op = 0x99d Vars = (object)
...
0x7b9: @ StopWorld()
0x7ba: Pop(0)
0x7bb: @ CameraTransit(Stack[-3], Stack[-5])
0x7bc: Pop(0)
0x7bd: Push(CvectorIndex(Stack[-4], 0))
0x7be: Push(CvectorIndex(Stack[-5], 2))
0x7bf: @ Rotate(Stack[-2], Stack[-1])
0x7c0: Pop(2)
...
0x7c6: Push("head")
0x7c7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7c8: Pop(1)
0x7c9: Push(Stack[-1])
0x7ca: IF (Stack[-1] == 0) GOTO 0x7ce; Pop(1)

0x7cb: Push("head")
0x7cc: @ LookAsyncCamera(Stack[-1])
0x7cd: Pop(1)
0x7ce: @ CameraWaitForPlayFinish()
0x7cf: Pop(0)
0x7d0: @ ResumeWorld()
0x7d1: Pop(0)
0x7d2: Stack[-21] = (bool) 1
0x7d3: Return(); Pop(18)

0x7d4: PushEmpty(bool, bool)
0x7d5: @ CameraSwitchToNormal()
0x7d6: Pop(0)
...
0x7dc: Push("head")
0x7dd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7de: Pop(1)
0x7df: Push(Stack[-1])
0x7e0: IF (Stack[-1] == 0) GOTO 0x7e4; Pop(1)

0x7e1: Push("head")
0x7e2: @ UnlookAsync(Stack[-1])
0x7e3: Pop(1)
0x7e4: Return(); Pop(2)

0x7e5: PushEmpty(bool, float, float, bool, float, float)
0x7e6: @ lshHasAnimation(Stack[-3], Stack[-7])
0x7e7: Pop(0)
0x7e8: Push(Stack[-3])
0x7e9: IF (Stack[-1] == 0) GOTO 0x7f0; Pop(1)

0x7ea: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x7eb: Pop(0)
0x7ec: Push((bool) 0)
0x7ed: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7ee: Pop(1)
0x7ef: GOTO 0x7f4

0x7f0: Push("Can't find lsh animation : ")
0x7f1: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7f2: @ Trace(Stack[-1])
0x7f3: Pop(1)
0x7f4: Return(); Pop(6)

0x7f5: PushEmpty(bool, float, float, bool, float, float)
0x7f6: @ lshHasAnimation(Stack[-3], Stack[-8])
0x7f7: Pop(0)
0x7f8: Push(Stack[-3])
0x7f9: IF (Stack[-1] == 0) GOTO 0x7ff; Pop(1)

0x7fa: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x7fb: Pop(0)
0x7fc: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x7fd: Pop(0)
0x7fe: GOTO 0x803

0x7ff: Push("Can't find lsh animation : ")
0x800: Pop(1); Push(Stack[-1] + Stack[-9]);
0x801: @ Trace(Stack[-1])
0x802: Pop(1)
0x803: Return(); Pop(6)

0x804: PushEmpty(float, cvector, float, cvector)
0x805: @@ GetEyesHeight(Stack[-2])
0x806: Pop(0)
0x807: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x808: Push(CvectorIndex(Stack[-1], 1))
0x809: Stack[-1] = Stack[-3]
0x80a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x80b: Push("head")
0x80c: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x80d: Pop(1)
0x80e: Return(); Pop(4)
...
0x816: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x817: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x818: Pop(0)
0x819: Pop(0); Push((bool) Stack[-8] == 0)
0x81a: IF (Stack[-1] == 0) GOTO 0x82f; Pop(1)

0x81b: Stack[-7] = (int) 0
0x81c: Push((int) 1)
0x81d: Pop(1); Push(Stack[-8] + Stack[-1]);
0x81e: Pop(1); Push(Stack[-18] + Stack[-1]);
0x81f: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x820: Pop(1)
...
0x824: Push((int) 1)
0x825: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x826: GOTO 0x81c

0x827: Pop(0); Push((bool) Stack[-7] == 0)
0x828: IF (Stack[-1] == 0) GOTO 0x82a; Pop(1)

0x829: Return(); Pop(16)

0x82a: @ irand(Stack[-5], Stack[-7])
0x82b: Pop(0)
0x82c: Push((int) 1)
0x82d: Pop(1); Push(Stack[-6] + Stack[-1]);
0x82e: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x82f: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x830: Pop(0)
0x831: Push(Stack[-4])
0x832: IF (Stack[-1] == 0) GOTO 0x83e; Pop(1)

0x833: @ GetEyesHeight(Stack[-3])
0x834: Pop(0)
0x835: @ GetDirection(Stack[-2])
0x836: Pop(0)
0x837: Push((int) 50)
0x838: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x839: Push(CvectorIndex(Stack[-1], 1))
0x83a: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x83b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x83c: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x83d: Pop(0)
0x83e: Return(); Pop(16)
...
0x840: @ self(Stack[-1])
0x841: Pop(0)
0x842: Stack[-3] = Stack[-1]
0x843: Return(); Pop(2)

0x844: Stack[-1] = 0
0x845: PushEmpty(float, float)
0x846: Pop(0); Push(Stack[-3] | Stack[-3]);
0x847: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x848: Push((float)0.0)
0x849: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x84a: IF (Stack[-1] == 0) GOTO 0x84d; Pop(1)

0x84b: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x84c: Return(); Pop(2)

0x84d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x84e: Return(); Pop(2)

0x84f: PushEmpty(cvector, cvector)
0x850: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x851: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x852: Return(); Pop(2)

0x853: PushEmpty()
0x854: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x855: IF (Stack[-1] == 0) GOTO 0x858; Pop(1)

0x856: Stack[-3] = Stack[-2]
0x857: GOTO 0x859
...
0x85a: PushEmpty()
0x85b: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x85c: IF (Stack[-1] == 0) GOTO 0x85f; Pop(1)

0x85d: Stack[-4] = Stack[-2]
0x85e: Return(); Pop(0)

0x85f: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x860: IF (Stack[-1] == 0) GOTO 0x863; Pop(1)

0x861: Stack[-4] = Stack[-1]
0x862: Return(); Pop(0)

0x863: Stack[-4] = Stack[-3]
0x864: Return(); Pop(0)

0x865: PushEmpty(object, object)
0x866: @ CreateIntVector(Stack[-1])
0x867: Pop(0)
0x868: @@ add(Stack[-4])
0x869: Pop(0)
0x86a: @@ add(Stack[-3])
0x86b: Pop(0)
0x86c: Push((int) 3)
0x86d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x86e: Pop(1)
0x86f: Return(); Pop(2)

0x870: Stack[-1] = 0
0x871: PushEmpty(int, int)
0x872: PushEmpty(object, string, int)
0x873: Stack[-3] = Stack[-7]
0x874: Stack[-2] = "money"
...
0x87b: Push("Money")
0x87c: @ GetInvItemByName(Stack[-2], Stack[-1])
0x87d: Pop(1)
0x87e: PushEmpty(int, int)
0x87f: Stack[-2] = Stack[-3]
...
0x884: PushEmpty()
0x885: Pop(0); Push((bool) Stack[-2] == 0)
0x886: IF (Stack[-1] == 0) GOTO 0x889; Pop(1)

0x887: Stack[-3] = (bool) 0
0x888: Return(); Pop(0)
...
0x88c: Push((int) 8)
0x88d: @ SendWorldWndMessage(Stack[-1])
0x88e: Pop(1)
0x88f: GOTO 0x899

0x890: Push((int) 0)
0x891: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x892: IF (Stack[-1] == 0) GOTO 0x897; Pop(1)

0x893: Push((int) 9)
0x894: @ SendWorldWndMessage(Stack[-1])
0x895: Pop(1)
0x896: GOTO 0x899

0x897: Stack[-3] = (bool) 0
0x898: Return(); Pop(0)

0x899: PushEmpty(float)
0x89a: Stack[-1] = Stack[-2]
0x89b: Call2 0x8b1

0x89c: Pop(1)
0x89d: PushEmpty(bool, object, string, float, float, float)
0x89e: Stack[-5] = Stack[-8]
0x89f: Stack[-4] = "reputation"
0x8a0: Stack[-3] = Stack[-7]
0x8a1: Stack[-2] = (int) 0
0x8a2: Stack[-1] = (int) 1
0x8a3: Call2 0x660

0x8a4: Pop(6)
0x8a5: Stack[-3] = (bool) 1
0x8a6: Return(); Pop(0)

0x8a7: PushEmpty(object, object)
0x8a8: @ CreateFloatVector(Stack[-1])
0x8a9: Pop(0)
0x8aa: @@ add(Stack[-3])
0x8ab: Pop(0)
0x8ac: Push((int) 15)
0x8ad: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x8ae: Pop(1)
0x8af: Return(); Pop(2)

0x8b0: Stack[-1] = 0
0x8b1: PushEmpty(object, object)
0x8b2: @ CreateFloatVector(Stack[-1])
0x8b3: Pop(0)
0x8b4: @@ add(Stack[-3])
0x8b5: Pop(0)
0x8b6: Push((int) 16)
0x8b7: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x8b8: Pop(1)
0x8b9: Return(); Pop(2)

0x8ba: Stack[-1] = 0
0x8bb: PushEmpty(object, object)
0x8bc: @ FindActor(Stack[-1], Stack[-4])
0x8bd: Pop(0)
0x8be: Pop(0); Push((bool) Stack[-1] == 0)
0x8bf: IF (Stack[-1] == 0) GOTO 0x8c2; Pop(1)

0x8c0: Stack[-5] = (bool) 0
0x8c1: Return(); Pop(2)

0x8c2: @ Trigger(Stack[-1], Stack[-3])
0x8c3: Pop(0)
0x8c4: Stack[-5] = (bool) 1
0x8c5: Return(); Pop(2)

0x8c6: Stack[-1] = 0
0x8c7: PushEmpty(bool, bool)
0x8c8: @ IsPlayerActor(Stack[-3], Stack[-1])
0x8c9: Pop(0)
0x8ca: Push(Stack[-1])
0x8cb: IF (Stack[-1] == 0) GOTO 0x8cf; Pop(1)

0x8cc: Push("attack")
0x8cd: @ PlayGlobalMusic(Stack[-1])
0x8ce: Pop(1)
0x8cf: Return(); Pop(2)

0x8d0: PushEmpty(object, object)
0x8d1: @ GetScene(Stack[-1])
0x8d2: Pop(0)
0x8d3: Push("battle")
...
0x8d6: Pop(0)
0x8d7: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x8d8: Pop(2)
0x8d9: Return(); Pop(2)
...
0x8df: Pop(2)
0x8e0: PushEmpty(bool, string, string)
0x8e1: Stack[-2] = "quest_d3_01"
0x8e2: Stack[-1] = "gpatrol_attack"
0x8e3: Call2 0x8bb
...
0x8e6: PushEmpty()
0x8e7: PushEmpty(object, int)
0x8e8: Stack[-2] = Stack[-4]
0x8e9: Stack[-1] = (int) -10000
0x8ea: Call2 0x871
...
0x8ef: Stack[-2] = "quest_d3_01"
0x8f0: Stack[-1] = "gpatrol_talk"
0x8f1: Call2 0x8bb
...
0x8f4: PushEmpty()
0x8f5: Push("playsound")
0x8f6: Push("givemoney")
0x8f7: @ TriggerWorld(Stack[-2], Stack[-1])
0x8f8: Pop(2)
0x8f9: Return(); Pop(0)

0x8fa: PushEmpty()
0x8fb: PushEmpty(bool, object, float)
0x8fc: Stack[-2] = Stack[-5]
0x8fd: Stack[-1] = (float) -0.3
0x8fe: Call2 0x884
...
0x907: Stack[-2] = (bool) 1
0x908: Return(); Pop(0)

0x909: Stack[-2] = (bool) 0
0x90a: Return(); Pop(0)
...
0x90e: Pop(1)
0x90f: Push((int) 10000)
0x910: Stack[-5] = Stack[-2] >= Stack[-1]; Pop(1);
0x911: Return(); Pop(2)

0x912: PushEmpty(int, int)
0x913: Push("branch")
0x914: @ GetVariable(Stack[-1], Stack[-2])
0x915: Pop(1)
0x916: Push((int) 0)
...
0x930: @ WorkWithCorpse(Stack[-1])
0x931: Pop(0)
0x932: GOTO 0x935

0x933: @ Barter(Stack[-1])
0x934: Pop(0)
0x935: Return(); Pop(0)

0x936: PushEmpty(object, int, bool, object, int, bool)
0x937: @ CreateInvItem(Stack[-3])
0x938: Pop(0)
0x939: @@ SetItemName(Stack[-7])
0x93a: Pop(0)
0x93b: Push("Organ")
0x93c: Push((int) 1)
0x93d: @@ SetProperty(Stack[-2], Stack[-1])
0x93e: Pop(2)
0x93f: @@ GetItemID(Stack[-2])
0x940: Pop(0)
0x941: Push((int) 0)
0x942: Push((int) 1)
0x943: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x944: Pop(2)
0x945: Return(); Pop(6)
...
0x949: Pop(0)
0x94a: Push((int) 1)
0x94b: Pop(2); Push((bool) Stack[-2] != Stack[-1])
...
0x95f: Stack[-1] = (int) 515572
0x960: Return(); Pop(0)

0x961: Stack[-1] = (int) 504031
0x962: Return(); Pop(0)

0x963: Stack[-1] = "ui/NPC_Citizen2.png"
0x964: Return(); Pop(0)

0x965: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x966: Return(); Pop(0)

0x967: Stack[-1] = (bool) 0
0x968: Return(); Pop(0)

0x969: PushEmpty(bool, bool)
0x96a: Push("revolver_ammo")
0x96b: Push((int) 0)
0x96c: Push((int) 2)
0x96d: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x96e: Pop(3)
0x96f: Push("alpha_pills")
0x970: Push((int) 0)
0x971: Push((int) 2)
...
0x979: Push(-1, 0); TaskCall(5)
0x97a: Call2 0x5a8

0x97b: Pop(-1, 0); TaskReturn
0x97c: Pop(1)
0x97d: Return(); Pop(2)

0x97e: PushEmpty()
0x97f: PushEmpty(object, int, float)
0x980: Stack[-3] = Stack[-7]
0x981: Stack[-2] = Stack[-6]
0x982: Stack[-1] = Stack[-5]
0x983: Call2 0x733
...
0x986: PushEmpty()
0x987: PushEmpty(object, int, float, cvector, cvector)
0x988: Stack[-5] = Stack[-11]
0x989: Stack[-4] = Stack[-10]
0x98a: Stack[-3] = Stack[-9]
...
0x990: PushEmpty(float, float)
0x991: Push("health")
0x992: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x993: IF (Stack[-1] == 0) GOTO 0x99c; Pop(1)

0x994: Push("health")
0x995: @ GetProperty(Stack[-1], Stack[-2])
0x996: Pop(1)
0x997: Push((int) 0)
0x998: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x999: IF (Stack[-1] == 0) GOTO 0x99c; Pop(1)

0x99a: @ SignalDeath(Stack[-4])
0x99b: Pop(0)
0x99c: Return(); Pop(2)
