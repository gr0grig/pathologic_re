task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_cvector, var_9_object, var_10_int, var_11_int, var_12_bool, var_13_float, var_14_int, var_15_bool, var_16_object, var_17_bool)
{
	...
	func_2278(var_23_object); // 0xa6 NEW_2
...
Label_209:
	...
	func_2298(var_116_object); // 0xdc NEW_2
...
Label_309:
	...
	func_2305(var_177_bool, var_178_object); // 0x148 NEW_2
...
Label_337:
	...
	func_2305(var_192_bool, var_193_object); // 0x15f NEW_2
...
Label_365:
	...
	func_2407(var_200_bool); // 0x16f NEW_2
...
Label_403:
	var_520_string = "talk_player"; // 0x193 PushS
	var_521_bool = var_16_bool == var_520_string; // 0x194 Eq
	if(var_521_bool == 0) goto Label_407; // 0x195 JumpB
...
task_2_event_17(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_object, var_9_int, var_10_int, var_11_bool, var_12_float, var_13_int, var_14_bool, var_15_object, var_16_bool)
{
	...
	func_2235(var_20_bool, var_21_string, var_22_string); // 0x1a0 NEW_2
...
task_4_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_int)
{
	...
	func_2247(var_19_object); // 0x4df NEW_2
...
Label_1276:
	...
	func_2052(var_20_object); // 0x500 NEW_2
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_cvector, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_object)
{
	...
	func_2345(var_20_object); // 0x5bc NEW_2
...
{
	var_20_object = Obj(); var_21_int = 0; var_22_float = 0; // 0x97f PushV
	var_20_object = var_16_object; // 0x980 Mov
	var_21_int = var_17_int; // 0x981 Mov
	var_22_float = var_18_float; // 0x982 Mov
	func_1843(var_20_object, var_21_int, var_22_float); // 0x983 NEW_2
...
{
	var_22_object = Obj(); var_23_int = 0; var_24_float = 0; var_25_cvector = CVector(0,0,0); var_26_cvector = CVector(0,0,0); // 0x987 PushV
	var_22_object = var_16_object; // 0x988 Mov
	var_23_int = var_17_int; // 0x989 Mov
	var_24_float = var_18_float; // 0x98a Mov
	var_25_cvector = var_20_cvector; // 0x98b Mov
	var_26_cvector = var_21_cvector; // 0x98c Mov
	func_1911(var_24_float, var_25_cvector, var_26_cvector); // 0x98d NEW_2
...
{
	var_18_float = 0; var_19_float = 0; // 0x990 PushV
	var_20_string = "health"; // 0x991 PushS
	var_21_bool = var_17_string == var_20_string; // 0x992 Eq
	if(var_21_bool == 0) goto Label_2460; // 0x993 JumpB
	var_22_string = "health"; // 0x994 PushS
	GetProperty(var_22_string, var_19_float); // 0x995 Func
	var_23_int = 0; // 0x997 PushI
	var_24_bool = var_19_float <= var_23_int; // 0x998 LE
	if(var_24_bool == 0) goto Label_2460; // 0x999 JumpB
	SignalDeath(var_16_object); // 0x99a Func
	
Label_2460:
	return 2; // 0x99c Return
}
...
{
	var_17_object = Obj(); // 0x99e PushV
	var_17_object = var_16_object; // 0x99f Mov
	func_2409(var_17_object); // 0x9a0 NEW_2
...
Label_440:
	...
	func_2127(var_28_float, var_29_cvector, var_30_cvector); // 0x1c0 NEW_2
...
func_2305(var_177_bool, var_178_object)
{
	var_179_bool = 0; var_180_object = Obj(); // 0x902 PushV
	var_180_object = var_178_object; // 0x903 Mov
	func_2315(var_180_object); // 0x904 NEW_2
	if(var_179_bool == 0) goto Label_2313; // 0x906 JumpB
	var_177_bool = 1; // 0x907 MovB
	return 0; // 0x908 Return
	
Label_2313:
	var_177_bool = 0; // 0x909 MovB
	return 0; // 0x90a Return
}


func_2052(var_20_object)
{
	var_21_float = 0; var_22_cvector = CVector(0,0,0); var_23_float = 0; var_24_cvector = CVector(0,0,0); // 0x804 PushV
	GetEyesHeight(var_23_float); // 0x805 ObjFunc
	var_24_cvector = CVector(0.0, 0.0, 0.0); // 0x807 MovV
	var_25_float = GetByIndex(var_24_cvector, 1); // 0x808 PushE
	var_25_float = var_23_float; // 0x809 Mov
	SetByIndex(var_24_cvector, 1) = var_25_float; // 0x80a PopE
	var_26_string = "head"; // 0x80b PushS
	LookAsync(var_20_object, var_26_string, var_24_cvector); // 0x80c Func
	return 4; // 0x80e Return
}
...
func_2315(var_179_bool)
{
	var_181_int = 0; var_182_int = 0; // 0x90b PushV
	var_183_string = "money"; // 0x90c PushS
	GetProperty(var_183_string, var_182_int); // 0x90d ObjFunc
	var_184_int = 10000; // 0x90f PushI
	var_179_bool = var_182_int >= var_184_int; // 0x910 GE2
...
func_2063()
{
	var_19_bool = 0; // 0x80f PushV
	func_2407(var_19_bool); // 0x810 NEW_2
	if(var_19_bool == 0) goto Label_2069; // 0x812 JumpB
	lshStopSpeech(); // 0x813 Func
...
Label_549:
	...
	func_2111(var_84_object); // 0x22f NEW_2
...
Label_686:
	...
	var_504_string = "all"; // 0x2b0 PushS
	var_505_string = "fjump"; // 0x2b1 PushS
	PlayAnimation(var_504_string, var_505_string); // 0x2b2 Func
	WaitForAnimEnd(); // 0x2b4 Func
	func_1172(var_53_float); // 0x2b7 NEW_2
	var_506_cvector = CVector(0.0, 0.0, 0.0); // 0x2b9 PushVec
	SetSpeed(var_506_cvector); // 0x2ba Func
	Stop(); // 0x2bc Func
	StopAsync(); // 0x2be Func
	var_507_bool = 0; // 0x2c0 PushV
	func_1129(var_53_float, var_507_bool); // 0x2c1 NEW_2
	var_508_bool = var_507_bool == 0; // 0x2c3 Not
	if(var_508_bool == 0) goto Label_732; // 0x2c4 JumpB
	var_509_bool = 0; var_510_object = Obj(); // 0x2c5 PushV
	var_510_object = var_0_object; // 0x2c6 MovT
	func_1775(var_509_bool, var_510_object); // 0x2c7 NEW_2
	var_511_bool = var_509_bool == 0; // 0x2c9 Not
	if(var_511_bool == 0) goto Label_716; // 0x2ca JumpB
...
Label_716:
	...
	var_512_float = var_31_float * var_31_float; // 0x2d2 Mult
	var_513_bool = var_50_float < var_512_float; // 0x2d3 LT
	if(var_513_bool == 0) goto Label_732; // 0x2d4 JumpB
	var_514_bool = 0; var_515_float = 0; // 0x2d5 PushV
	var_515_float = var_31_float; // 0x2d6 Mov
	func_833(var_53_float, var_514_bool, var_515_float); // 0x2d7 NEW_2
	var_516_bool = var_514_bool == 0; // 0x2d9 Not
	if(var_516_bool == 0) goto Label_732; // 0x2da JumpB
	goto Label_742; // 0x2db Jump
	
Label_733:
	var_517_bool = 0; var_518_float = 0; // 0x2dd PushV
	var_518_float = var_31_float; // 0x2de Mov
	func_833(var_53_float, var_517_bool, var_518_float); // 0x2df NEW_2
	var_519_bool = var_517_bool == 0; // 0x2e1 Not
	if(var_519_bool == 0) goto Label_740; // 0x2e2 JumpB
...
func_2322(var_79_int)
{
	var_80_int = 0; var_81_int = 0; // 0x912 PushV
	var_82_string = "branch"; // 0x913 PushS
	GetVariable(var_82_string, var_81_int); // 0x914 Func
	var_83_int = 0; // 0x916 PushI
	var_84_bool = var_81_int == var_83_int; // 0x917 Eq
	if(var_84_bool == 0) goto Label_2332; // 0x918 JumpB
	var_79_int = 1; // 0x919 MovI
	return 2; // 0x91a Return
	
Label_2332:
	var_85_int = 1; // 0x91c PushI
	var_86_bool = var_81_int == var_85_int; // 0x91d Eq
	if(var_86_bool == 0) goto Label_2337; // 0x91e JumpB
	var_79_int = 2; // 0x91f MovI
	return 2; // 0x920 Return
	
Label_2337:
	var_79_int = 3; // 0x921 MovI
	return 2; // 0x922 Return
}


func_2070(var_70_string)
{
	var_71_bool = 0; var_72_int = 0; var_73_bool = 0; var_74_int = 0; var_75_bool = 0; var_76_float = 0; var_77_cvector = CVector(0,0,0); var_78_cvector = CVector(0,0,0); var_79_bool = 0; var_80_int = 0; var_81_bool = 0; var_82_int = 0; var_83_bool = 0; var_84_float = 0; var_85_cvector = CVector(0,0,0); var_86_cvector = CVector(0,0,0); // 0x816 PushV
	IsExisting3DSound(var_79_bool, var_70_string); // 0x817 Func
	var_87_bool = var_79_bool == 0; // 0x819 Not
	if(var_87_bool == 0) goto Label_2095; // 0x81a JumpB
	var_80_int = 0; // 0x81b MovI
	
Label_2076:
	var_88_int = 1; // 0x81c PushI
	var_89_int = var_80_int + var_88_int; // 0x81d Add
	var_90_int = var_70_string + var_89_int; // 0x81e Add
	IsExisting3DSound(var_81_bool, var_90_int); // 0x81f Func
	var_91_bool = var_81_bool == 0; // 0x821 Not
	if(var_91_bool == 0) goto Label_2084; // 0x822 JumpB
	goto Label_2087; // 0x823 Jump
	
Label_2087:
	var_92_bool = var_80_int == 0; // 0x827 Not
	if(var_92_bool == 0) goto Label_2090; // 0x828 JumpB
	return 16; // 0x829 Return
	
Label_2090:
	irand(var_82_int, var_80_int); // 0x82a Func
	var_93_int = 1; // 0x82c PushI
	var_94_int = var_82_int + var_93_int; // 0x82d Add
	var_70_string = var_70_string + var_94_int; // 0x82e Add2
	
Label_2095:
	Is3DSoundLoaded(var_83_bool, var_70_string); // 0x82f Func
	var_95_bool = var_83_bool; // 0x831 Push
	if(var_95_bool == 0) goto Label_2110; // 0x832 JumpB
	GetEyesHeight(var_84_float); // 0x833 Func
	GetDirection(var_85_cvector); // 0x835 Func
	var_96_int = 50; // 0x837 PushI
	var_86_cvector = var_85_cvector * var_96_int; // 0x838 Mult2
	var_97_float = GetByIndex(var_86_cvector, 1); // 0x839 PushE
	var_97_float = var_97_float + var_84_float; // 0x83a Add2
	SetByIndex(var_86_cvector, 1) = var_97_float; // 0x83b PopE
	PlayGlobalSound(var_70_string, var_86_cvector); // 0x83c Func
	
Label_2110:
	return 16; // 0x83e Return
	
Label_2084:
	var_98_int = 1; // 0x824 PushI
	var_80_int = var_80_int + var_98_int; // 0x825 Add2
	goto Label_2076; // 0x826 Jump
}
...
func_1562(var_69_string)
{
	...
	func_2070(var_70_string); // 0x627 NEW_2
...
func_794(var_0_object, var_387_float, var_388_int)
{
	...
	var_462_int = 0; // 0x335 PushV
	func_1177(var_462_int); // 0x336 NEW_2
	ReportHit(var_0_object, var_462_int, var_394_float, var_393_float); // 0x338 Func
	var_463_object = Obj(); var_464_float = 0; // 0x33a PushV
	var_463_object = var_392_object; // 0x33b Mov
	var_464_float = var_394_float; // 0x33c Mov
...
func_2339(var_26_int)
{
	var_27_int = 0; var_28_int = 0; // 0x923 PushV
	var_29_string = "branch"; // 0x924 PushS
	GetVariable(var_29_string, var_28_int); // 0x925 Func
	var_26_int = var_28_int; // 0x927 Mov
	return 2; // 0x928 Return
}


func_2345(var_20_object)
{
	var_21_int = 0; // 0x92a PushV
	func_2339(var_21_int); // 0x92b NEW_2
	var_25_int = 1; // 0x92d PushI
	var_26_bool = var_21_int == var_25_int; // 0x92e Eq
	if(var_26_bool == 0) goto Label_2355; // 0x92f JumpB
	WorkWithCorpse(var_20_object); // 0x930 Func
	goto Label_2357; // 0x932 Jump
	
Label_2357:
	return 0; // 0x935 Return
	
Label_2355:
	Barter(var_20_object); // 0x933 Func
}
...
Label_1859:
	...
	func_2117(var_48_cvector, var_49_cvector); // 0x74a NEW_2
...
func_2358(var_32_string)
{
	var_33_object = Obj(); var_34_int = 0; var_35_bool = 0; var_36_object = Obj(); var_37_int = 0; var_38_bool = 0; // 0x936 PushV
	CreateInvItem(var_36_object); // 0x937 Func
	SetItemName(var_32_string); // 0x939 ObjFunc
	var_39_string = "Organ"; // 0x93b PushS
	var_40_int = 1; // 0x93c PushI
	SetProperty(var_39_string, var_40_int); // 0x93d ObjFunc
	GetItemID(var_37_int); // 0x93f ObjFunc
	var_41_int = 0; // 0x941 PushI
	var_42_int = 1; // 0x942 PushI
	AddItem(var_38_bool, var_36_object, var_41_int, var_42_int); // 0x943 Func
	return 6; // 0x945 Return
}
...
func_2111(var_84_object)
{
	var_85_object = Obj(); var_86_object = Obj(); // 0x83f PushV
	self(var_86_object); // 0x840 Func
	var_84_object = var_86_object; // 0x842 Mov
...
Label_869:
	...
	var_465_string = "all"; // 0x36a PushS
	var_466_string = "attack_middle"; // 0x36b PushS
	var_467_int = var_466_string + var_356_int; // 0x36c Add
	HasAnimation(var_357_bool, var_465_string, var_467_int); // 0x36d Func
	var_468_bool = var_357_bool; // 0x36f Push
	if(var_468_bool == 0) goto Label_950; // 0x370 JumpB
	func_2256(); // 0x372 NEW_2
	var_469_string = "all"; // 0x374 PushS
	var_470_string = "attack_middle"; // 0x375 PushS
	var_471_int = var_470_string + var_356_int; // 0x376 Add
	PlayAnimation(var_469_string, var_471_int); // 0x377 Func
	WaitForAnimEnd(); // 0x379 Func
	func_1172(var_359_string); // 0x37c NEW_2
	var_472_bool = 0; var_473_object = Obj(); // 0x37e PushV
	var_473_object = var_0_object; // 0x37f MovT
	func_1775(var_472_bool, var_473_object); // 0x380 NEW_2
	var_474_bool = var_472_bool == 0; // 0x382 Not
	if(var_474_bool == 0) goto Label_904; // 0x383 JumpB
	StopAsync(); // 0x384 Func
	var_350_bool = 0; // 0x386 MovB
	return 8; // 0x387 Return
	
Label_904:
	var_475_float = 0; var_476_int = 0; // 0x388 PushV
	var_475_float = var_351_float; // 0x389 Mov
	var_476_int = var_356_int; // 0x38a Mov
	func_794(var_359_string, var_475_float, var_476_int); // 0x38b NEW_2
	var_358_int = 1; // 0x38d MovI
	
Label_910:
	var_477_string = "attack_middle"; // 0x38e PushS
	var_478_int = var_477_string + var_356_int; // 0x38f Add
	var_479_string = "_"; // 0x390 PushS
	var_480_int = var_478_int + var_479_string; // 0x391 Add
	var_359_string = var_480_int + var_358_int; // 0x392 Add2
	var_481_string = "all"; // 0x393 PushS
	HasAnimation(var_357_bool, var_481_string, var_359_string); // 0x394 Func
	var_482_bool = var_357_bool == 0; // 0x396 Not
	if(var_482_bool == 0) goto Label_921; // 0x397 JumpB
	goto Label_950; // 0x398 Jump
	
Label_950:
	var_483_bool = 0; // 0x3b6 PushB
	SetAttackState(var_483_bool); // 0x3b7 Func
	var_484_string = "all"; // 0x3b9 PushS
	var_485_string = "attack_end"; // 0x3ba PushS
	var_486_int = var_485_string + var_356_int; // 0x3bb Add
	PlayAnimation(var_484_string, var_486_int); // 0x3bc Func
	var_487_bool = 0; // 0x3be PushV
	func_1186(var_487_bool); // 0x3bf NEW_2
	if(var_487_bool == 0) goto Label_968; // 0x3c1 JumpB
	var_488_bool = 0; var_489_float = 0; // 0x3c2 PushV
	var_489_float = 0.75; // 0x3c3 MovF
	func_970(var_488_bool, var_489_float); // 0x3c4 NEW_2
...
Label_921:
	func_2256(); // 0x39a NEW_2
	var_497_string = "all"; // 0x39c PushS
	PlayAnimation(var_497_string, var_359_string); // 0x39d Func
	WaitForAnimEnd(); // 0x39f Func
	func_1172(var_359_string); // 0x3a2 NEW_2
	var_498_bool = 0; var_499_object = Obj(); // 0x3a4 PushV
	var_499_object = var_0_object; // 0x3a5 MovT
	func_1775(var_498_bool, var_499_object); // 0x3a6 NEW_2
	var_500_bool = var_498_bool == 0; // 0x3a8 Not
	if(var_500_bool == 0) goto Label_942; // 0x3a9 JumpB
	StopAsync(); // 0x3aa Func
	var_350_bool = 0; // 0x3ac MovB
	return 8; // 0x3ad Return
	
Label_942:
	var_501_float = 0; var_502_int = 0; // 0x3ae PushV
	var_501_float = var_351_float; // 0x3af Mov
	var_502_int = var_356_int; // 0x3b0 Mov
	func_794(var_359_string, var_501_float, var_502_int); // 0x3b1 NEW_2
	var_503_int = 1; // 0x3b3 PushI
	var_358_int = var_358_int + var_503_int; // 0x3b4 Add2
	goto Label_910; // 0x3b5 Jump
}


func_2117(var_48_cvector, var_49_cvector)
{
	var_56_float = 0; var_57_float = 0; // 0x845 PushV
	var_58_int = var_49_cvector | var_49_cvector; // 0x846 Or
	var_57_float = sqrt(var_58_int); // 0x847 Sqrt2
	var_59_float = 0.0; // 0x848 PushF
	var_60_bool = var_57_float < var_59_float; // 0x849 LT
	if(var_60_bool == 0) goto Label_2125; // 0x84a JumpB
	var_48_cvector = CVector(0.0, 0.0, 0.0); // 0x84b MovV
	return 2; // 0x84c Return
	
Label_2125:
	var_48_cvector = var_49_cvector / var_49_cvector; // 0x84d Div2
...
func_2375()
{
	var_26_int = 0; // 0x947 PushV
	func_2339(var_26_int); // 0x948 NEW_2
	var_30_int = 1; // 0x94a PushI
	var_31_bool = var_26_int != var_30_int; // 0x94b Neq
	if(var_31_bool == 0) goto Label_2382; // 0x94c JumpB
	return 0; // 0x94d Return
	
Label_2382:
	var_32_string = ""; // 0x94e PushV
	var_32_string = "liver"; // 0x94f MovS
	func_2358(var_32_string); // 0x950 NEW_2
	var_43_string = ""; // 0x952 PushV
	var_43_string = "kidney"; // 0x953 MovS
	func_2358(var_43_string); // 0x954 NEW_2
	var_44_string = ""; // 0x956 PushV
	var_44_string = "heart"; // 0x957 MovS
	func_2358(var_44_string); // 0x958 NEW_2
	var_45_string = ""; // 0x95a PushV
	var_45_string = "blood"; // 0x95b MovS
	func_2358(var_45_string); // 0x95c NEW_2
...
Label_111:
	...
	func_2021(var_121_string); // 0x71 NEW_2
...
func_2127(var_28_float, var_29_cvector, var_30_cvector)
{
	var_31_cvector = CVector(0,0,0); var_32_cvector = CVector(0,0,0); // 0x84f PushV
	var_32_cvector = var_30_cvector - var_29_cvector; // 0x850 Sub2
	var_28_float = var_32_cvector | var_32_cvector; // 0x851 Or2
...
func_2131(var_439_float, var_440_float, var_441_float)
{
	var_444_bool = var_440_float < var_441_float; // 0x854 LT
	if(var_444_bool == 0) goto Label_2136; // 0x855 JumpB
	var_439_float = var_440_float; // 0x856 Mov
	goto Label_2137; // 0x857 Jump
	
Label_2137:
	return 0; // 0x859 Return
	
Label_2136:
	var_439_float = var_441_float; // 0x858 Mov
}
...
func_2138(var_449_float, var_450_float, var_451_float, var_452_float)
{
	var_453_bool = var_450_float < var_451_float; // 0x85b LT
	if(var_453_bool == 0) goto Label_2143; // 0x85c JumpB
	var_449_float = var_451_float; // 0x85d Mov
	return 0; // 0x85e Return
	
Label_2143:
	var_454_bool = var_450_float > var_452_float; // 0x85f GT
	if(var_454_bool == 0) goto Label_2147; // 0x860 JumpB
	var_449_float = var_452_float; // 0x861 Mov
	return 0; // 0x862 Return
	
Label_2147:
	var_449_float = var_450_float; // 0x863 Mov
	return 0; // 0x864 Return
}


func_2399(var_76_int)
{
	var_76_int = 515572; // 0x95f MovI
...
Label_1642:
	...
	func_2138(var_102_float, var_103_float, var_104_float, var_105_float); // 0x670 NEW_2
...
func_2401(var_75_int)
{
	var_75_int = 504031; // 0x961 MovI
	return 0; // 0x962 Return
}


func_2403(var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png"; // 0x963 MovS
	return 0; // 0x964 Return
}


func_2149(var_37_int, var_38_int)
{
	var_39_object = Obj(); var_40_object = Obj(); // 0x865 PushV
	CreateIntVector(var_40_object); // 0x866 Func
	add(var_37_int); // 0x868 ObjFunc
	add(var_38_int); // 0x86a ObjFunc
	var_41_int = 3; // 0x86c PushI
	SendWorldWndMessage(var_41_int, var_40_object); // 0x86d Func
	return 2; // 0x86f Return
}


func_2405(var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png"; // 0x965 MovS
	return 0; // 0x966 Return
}


func_2407(var_70_bool)
{
	var_70_bool = 0; // 0x967 MovB
...
func_2409(var_17_object)
{
	var_18_bool = 0; var_19_bool = 0; // 0x969 PushV
	var_20_string = "revolver_ammo"; // 0x96a PushS
	var_21_int = 0; // 0x96b PushI
	var_22_int = 2; // 0x96c PushI
	AddItem(var_19_bool, var_20_string, var_21_int, var_22_int); // 0x96d Func
	var_23_string = "alpha_pills"; // 0x96f PushS
	var_24_int = 0; // 0x970 PushI
	var_25_int = 2; // 0x971 PushI
	AddItem(var_19_bool, var_23_string, var_24_int, var_25_int); // 0x972 Func
	func_2375(); // 0x975 NEW_2
	var_46_object = Obj(); // 0x977 PushV
	var_46_object = var_17_object; // 0x978 Mov
	TaskCall(5); // 0x979 TaskCall
	func_1448(var_46_object); // 0x97a NEW_2
	TaskReturn(); // 0x97b TaskReturn
	return 2; // 0x97d Return
}


func_2161(var_24_object, var_25_int)
{
	var_26_int = 0; var_27_int = 0; // 0x871 PushV
	var_28_object = Obj(); var_29_string = ""; var_30_int = 0; // 0x872 PushV
	var_28_object = var_24_object; // 0x873 Mov
	var_29_string = "money"; // 0x874 MovS
	var_30_int = var_25_int; // 0x875 Mov
	func_1654(var_29_string, var_30_int); // 0x876 NEW_2
	var_34_int = 0; // 0x878 PushI
	var_35_bool = var_25_int > var_34_int; // 0x879 GT
	if(var_35_bool == 0) goto Label_2179; // 0x87a JumpB
	var_36_string = "Money"; // 0x87b PushS
	GetInvItemByName(var_27_int, var_36_string); // 0x87c Func
	var_37_int = 0; var_38_int = 0; // 0x87e PushV
	var_37_int = var_27_int; // 0x87f Mov
	var_38_int = var_25_int; // 0x880 Mov
	func_2149(var_37_int, var_38_int); // 0x881 NEW_2
...
Label_1700:
	...
	func_2131(var_439_float, var_440_float, var_441_float); // 0x6a9 NEW_2
	...
	func_2138(var_449_float, var_450_float, var_451_float, var_452_float); // 0x6b7 NEW_2
	...
	func_2215(var_457_float); // 0x6c2 NEW_2
...
Label_1680:
	var_461_string = "armor"; // 0x690 PushS
	GetProperty(var_461_string, var_414_int); // 0x691 ObjFunc
}
...
func_132(var_2_object, var_95_string)
{
	...
	func_2407(var_96_bool); // 0x86 NEW_2
...
Label_150:
	func_2037(var_99_string, var_100_bool); // 0x96 NEW_2
...
func_2180(var_73_bool, var_74_object, var_75_float)
{
	var_76_bool = var_74_object == 0; // 0x885 Not
	if(var_76_bool == 0) goto Label_2185; // 0x886 JumpB
	var_73_bool = 0; // 0x887 MovB
	return 0; // 0x888 Return
	
Label_2185:
	var_77_int = 0; // 0x889 PushI
	var_78_bool = var_75_float > var_77_int; // 0x88a GT
	if(var_78_bool == 0) goto Label_2192; // 0x88b JumpB
	var_79_int = 8; // 0x88c PushI
	SendWorldWndMessage(var_79_int); // 0x88d Func
	goto Label_2201; // 0x88f Jump
	
Label_2201:
	var_80_float = 0; // 0x899 PushV
	var_80_float = var_75_float; // 0x89a Mov
	func_2225(var_80_float); // 0x89b NEW_2
	var_84_bool = 0; var_85_object = Obj(); var_86_string = ""; var_87_float = 0; var_88_float = 0; var_89_float = 0; // 0x89d PushV
	var_85_object = var_74_object; // 0x89e Mov
	var_86_string = "reputation"; // 0x89f MovS
	var_87_float = var_75_float; // 0x8a0 Mov
	var_88_float = 0; // 0x8a1 MovI
	var_89_float = 1; // 0x8a2 MovI
	func_1632(var_84_bool, var_85_object, var_86_string, var_87_float, var_88_float, var_89_float); // 0x8a3 NEW_2
	var_73_bool = 1; // 0x8a5 MovB
	return 0; // 0x8a6 Return
	
Label_2192:
	var_108_int = 0; // 0x890 PushI
	var_109_bool = var_75_float < var_108_int; // 0x891 LT
	if(var_109_bool == 0) goto Label_2199; // 0x892 JumpB
	var_110_int = 9; // 0x893 PushI
	SendWorldWndMessage(var_110_int); // 0x894 Func
	goto Label_2201; // 0x896 Jump
	
Label_2199:
	var_73_bool = 0; // 0x897 MovB
...
func_1936(var_28_bool, var_30_float)
{
	...
	func_2117(var_55_cvector, var_56_cvector); // 0x7ab NEW_2
...
Label_1977:
	...
	CameraTransit(var_46_cvector, var_44_cvector); // 0x7bb Func
	var_68_float = GetByIndex(var_45_cvector, 0); // 0x7bd PushE
	var_69_float = GetByIndex(var_45_cvector, 2); // 0x7be PushE
	Rotate(var_68_float, var_69_float); // 0x7bf Func
	var_70_bool = 0; // 0x7c1 PushV
	func_2407(var_70_bool); // 0x7c2 NEW_2
	if(var_70_bool == 0) goto Label_1990; // 0x7c4 JumpB
	goto Label_1998; // 0x7c5 Jump
	
Label_1998:
	CameraWaitForPlayFinish(); // 0x7ce Func
	ResumeWorld(); // 0x7d0 Func
	var_28_bool = 1; // 0x7d2 MovB
	return 18; // 0x7d3 Return
	
Label_1990:
	var_71_string = "head"; // 0x7c6 PushS
	HasAnimationTrack(var_48_bool, var_71_string); // 0x7c7 Func
	var_72_bool = var_48_bool; // 0x7c9 Push
	if(var_72_bool == 0) goto Label_1998; // 0x7ca JumpB
	var_73_string = "head"; // 0x7cb PushS
	LookAsyncCamera(var_73_string); // 0x7cc Func
}
...
func_1172(var_0_object)
{
	...
	func_2247(var_125_object); // 0x496 NEW_2
...
func_1179()
{
	...
	func_2070(var_258_string); // 0x49d NEW_2
...
func_2215(var_457_float)
{
	var_458_object = Obj(); var_459_object = Obj(); // 0x8a7 PushV
	CreateFloatVector(var_459_object); // 0x8a8 Func
	add(var_457_float); // 0x8aa ObjFunc
	var_460_int = 15; // 0x8ac PushI
	SendWorldWndMessage(var_460_int, var_459_object); // 0x8ad Func
...
func_1192(var_2_object, var_132_bool, var_133_object, var_134_float, var_135_float, var_136_bool, var_137_bool)
{
	...
	func_2247(var_145_object); // 0x4ab NEW_2
	...
	func_2052(var_149_object); // 0x4b8 NEW_2
...
Label_1212:
	...
	func_2111(var_160_object); // 0x4c2 NEW_2
...
func_2225(var_80_float)
{
	var_81_object = Obj(); var_82_object = Obj(); // 0x8b1 PushV
	CreateFloatVector(var_82_object); // 0x8b2 Func
	add(var_80_float); // 0x8b4 ObjFunc
	var_83_int = 16; // 0x8b6 PushI
	SendWorldWndMessage(var_83_int, var_82_object); // 0x8b7 Func
	return 2; // 0x8b9 Return
}


func_2235(var_20_bool, var_21_string, var_22_string)
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x8bb PushV
	FindActor(var_24_object, var_21_string); // 0x8bc Func
	var_25_bool = var_24_object == 0; // 0x8be NullEq
	if(var_25_bool == 0) goto Label_2242; // 0x8bf JumpB
	var_20_bool = 0; // 0x8c0 MovB
	return 2; // 0x8c1 Return
	
Label_2242:
	Trigger(var_24_object, var_22_string); // 0x8c2 Func
	var_20_bool = 1; // 0x8c4 MovB
...
Label_1539:
	...
	func_2070(var_122_string); // 0x605 NEW_2
...
func_2247(var_19_object)
{
	var_20_bool = 0; var_21_bool = 0; // 0x8c7 PushV
	IsPlayerActor(var_19_object, var_21_bool); // 0x8c8 Func
	var_22_bool = var_21_bool; // 0x8ca Push
	if(var_22_bool == 0) goto Label_2255; // 0x8cb JumpB
	var_23_string = "attack"; // 0x8cc PushS
	PlayGlobalMusic(var_23_string); // 0x8cd Func
...
func_970(var_488_bool, var_489_float)
{
	var_490_float = 0; var_491_bool = 0; var_492_float = 0; var_493_bool = 0; // 0x3ca PushV
	rand(var_492_float); // 0x3cb Func
	var_494_bool = var_492_float < var_489_float; // 0x3cd LT
	if(var_494_bool == 0) goto Label_990; // 0x3ce JumpB
	
Label_975:
	IsAnimationPlaying(var_493_bool); // 0x3cf Func
	var_495_bool = var_493_bool == 0; // 0x3d1 Not
	if(var_495_bool == 0) goto Label_980; // 0x3d2 JumpB
...
Label_995:
	var_488_bool = 0; // 0x3e3 MovB
	return 4; // 0x3e4 Return
	
Label_980:
	var_496_bool = 0; // 0x3d4 PushV
	func_1068(var_496_bool); // 0x3d5 NEW_2
	if(var_496_bool == 0) goto Label_986; // 0x3d7 JumpB
	var_488_bool = 1; // 0x3d8 MovB
...
Label_990:
	...
	func_1172(var_493_bool); // 0x3e1 NEW_2
}
...
func_2256()
{
	var_362_object = Obj(); var_363_object = Obj(); // 0x8d0 PushV
	GetScene(var_363_object); // 0x8d1 Func
	var_364_string = "battle"; // 0x8d3 PushS
	var_365_object = Obj(); // 0x8d4 PushV
	func_2111(var_365_object); // 0x8d5 NEW_2
	BroadcastMessage(var_364_string, var_365_object, var_363_object); // 0x8d7 Func
...
func_2004()
{
	var_139_bool = 0; var_140_bool = 0; // 0x7d4 PushV
	CameraSwitchToNormal(); // 0x7d5 Func
	var_141_bool = 0; // 0x7d7 PushV
	func_2407(var_141_bool); // 0x7d8 NEW_2
	if(var_141_bool == 0) goto Label_2012; // 0x7da JumpB
	goto Label_2020; // 0x7db Jump
	
Label_2020:
	return 2; // 0x7e4 Return
	
Label_2012:
	var_142_string = "head"; // 0x7dc PushS
	HasAnimationTrack(var_140_bool, var_142_string); // 0x7dd Func
	var_143_bool = var_140_bool; // 0x7df Push
	if(var_143_bool == 0) goto Label_2020; // 0x7e0 JumpB
	var_144_string = "head"; // 0x7e1 PushS
	UnlookAsync(var_144_string); // 0x7e2 Func
}


func_2267()
{
	var_66_string = "d3q01"; // 0x8dc PushS
	var_67_int = 8; // 0x8dd PushI
	SetVariable(var_66_string, var_67_int); // 0x8de Func
	var_68_bool = 0; var_69_string = ""; var_70_string = ""; // 0x8e0 PushV
	var_69_string = "quest_d3_01"; // 0x8e1 MovS
	var_70_string = "gpatrol_attack"; // 0x8e2 MovS
	func_2235(var_68_bool, var_69_string, var_70_string); // 0x8e3 NEW_2
...
func_2021(var_121_string)
{
	var_122_bool = 0; var_123_float = 0; var_124_float = 0; var_125_bool = 0; var_126_float = 0; var_127_float = 0; // 0x7e5 PushV
	lshHasAnimation(var_125_bool, var_121_string); // 0x7e6 Func
	var_128_bool = var_125_bool; // 0x7e8 Push
	if(var_128_bool == 0) goto Label_2032; // 0x7e9 JumpB
	lshGetAnimTimes(var_121_string, var_126_float, var_127_float); // 0x7ea Func
	var_129_bool = 0; // 0x7ec PushB
	lshPlayAnimation(var_126_float, var_127_float, var_129_bool); // 0x7ed Func
	goto Label_2036; // 0x7ef Jump
	
Label_2036:
	return 6; // 0x7f4 Return
	
Label_2032:
	var_130_string = "Can't find lsh animation : "; // 0x7f0 PushS
	var_131_int = var_130_string + var_121_string; // 0x7f1 Add
	Trace(var_131_int); // 0x7f2 Func
}


func_2278(var_22_object)
{
	var_24_object = Obj(); var_25_int = 0; // 0x8e7 PushV
	var_24_object = var_22_object; // 0x8e8 Mov
	var_25_int = -10000; // 0x8e9 MovI
	func_2161(var_24_object, var_25_int); // 0x8ea NEW_2
...
func_2285()
{
	var_44_bool = 0; var_45_string = ""; var_46_string = ""; // 0x8ee PushV
	var_45_string = "quest_d3_01"; // 0x8ef MovS
	var_46_string = "gpatrol_talk"; // 0x8f0 MovS
	func_2235(var_44_bool, var_45_string, var_46_string); // 0x8f1 NEW_2
...
func_2292()
{
	var_52_string = "playsound"; // 0x8f5 PushS
	var_53_string = "givemoney"; // 0x8f6 PushS
	TriggerWorld(var_52_string, var_53_string); // 0x8f7 Func
	return 0; // 0x8f9 Return
}


func_2037(var_99_string, var_100_bool)
{
	var_103_bool = 0; var_104_float = 0; var_105_float = 0; var_106_bool = 0; var_107_float = 0; var_108_float = 0; // 0x7f5 PushV
	lshHasAnimation(var_106_bool, var_99_string); // 0x7f6 Func
	var_109_bool = var_106_bool; // 0x7f8 Push
	if(var_109_bool == 0) goto Label_2047; // 0x7f9 JumpB
	lshGetAnimTimes(var_99_string, var_107_float, var_108_float); // 0x7fa Func
	lshPlayAnimation(var_107_float, var_108_float, var_100_bool); // 0x7fc Func
	goto Label_2051; // 0x7fe Jump
	
Label_2051:
	return 6; // 0x803 Return
	
Label_2047:
	var_110_string = "Can't find lsh animation : "; // 0x7ff PushS
	var_111_int = var_110_string + var_99_string; // 0x800 Add
	Trace(var_111_int); // 0x801 Func
}
...
func_2298(var_71_object)
{
	var_73_bool = 0; var_74_object = Obj(); var_75_float = 0; // 0x8fb PushV
	var_74_object = var_71_object; // 0x8fc Mov
	var_75_float = -0.3; // 0x8fd MovF
	func_2180(var_73_bool, var_74_object, var_75_float); // 0x8fe NEW_2
