...
Events:
EVENT_22 Op = 0x744 Vars = (object, int, float, float)
EVENT_43 Op = 0x74c Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x756 Vars = (object, string)
EVENT_41 Op = 0x763 Vars = (object)
...
0x700: @ FindActor(Stack[-1], Stack[-4])
0x701: Pop(0)
0x702: Pop(0); Push((bool) Stack[-1] == 0)
0x703: IF (Stack[-1] == 0) GOTO 0x706; Pop(1)

0x704: Stack[-5] = (bool) 0
0x705: Return(); Pop(2)

0x706: @ Trigger(Stack[-1], Stack[-3])
0x707: Pop(0)
0x708: Stack[-5] = (bool) 1
0x709: Return(); Pop(2)

0x70a: Stack[-1] = 0
0x70b: PushEmpty(bool, bool)
0x70c: @ IsPlayerActor(Stack[-3], Stack[-1])
0x70d: Pop(0)
0x70e: Push(Stack[-1])
0x70f: IF (Stack[-1] == 0) GOTO 0x713; Pop(1)

0x710: Push("attack")
0x711: @ PlayGlobalMusic(Stack[-1])
0x712: Pop(1)
0x713: Return(); Pop(2)

0x714: PushEmpty(object, object)
0x715: @ GetScene(Stack[-1])
0x716: Pop(0)
0x717: Push("battle")
...
0x71a: Pop(0)
0x71b: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x71c: Pop(2)
0x71d: Return(); Pop(2)

0x71e: Stack[-1] = 0
0x71f: PushEmpty(string, string)
0x720: Stack[-1] = "idle"
0x721: Push(Stack[-3])
0x722: IF (Stack[-1] == 0) GOTO 0x724; Pop(1)

0x723: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x724: Stack[-4] = Stack[-1]
0x725: Return(); Pop(2)

0x726: PushEmpty(int, bool, int, bool)
0x727: Stack[-2] = (int) 0
0x728: Push("all")
0x729: PushEmpty(string, int)
0x72a: Stack[-1] = Stack[-5]
0x72b: Call2 0x71f

0x72c: Pop(1)
0x72d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x72e: Pop(2)
...
0x732: Push((int) 1)
0x733: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x734: GOTO 0x728

0x735: Stack[-5] = Stack[-2]
0x736: Return(); Pop(4)

0x737: PushEmpty()
0x738: PushEmpty(bool, string, string)
0x739: Stack[-2] = "quest_d1_03"
0x73a: Stack[-1] = "butcher_death"
0x73b: Call2 0x6ff

0x73c: Pop(3)
0x73d: PushEmpty(object)
0x73e: Stack[-1] = Stack[-2]
0x73f: Push(-1, 0); TaskCall(3)
0x740: Call2 0x4d5

0x741: Pop(-1, 0); TaskReturn
0x742: Pop(1)
0x743: Return(); Pop(0)

0x744: PushEmpty()
0x745: PushEmpty(object, int, float)
0x746: Stack[-3] = Stack[-7]
0x747: Stack[-2] = Stack[-6]
0x748: Stack[-1] = Stack[-5]
0x749: Call2 0x63d
...
0x74c: PushEmpty()
0x74d: PushEmpty(object, int, float, cvector, cvector)
0x74e: Stack[-5] = Stack[-11]
0x74f: Stack[-4] = Stack[-10]
0x750: Stack[-3] = Stack[-9]
0x751: Stack[-2] = Stack[-7]
...
0x756: PushEmpty(float, float)
0x757: Push("health")
0x758: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x759: IF (Stack[-1] == 0) GOTO 0x762; Pop(1)

0x75a: Push("health")
0x75b: @ GetProperty(Stack[-1], Stack[-2])
0x75c: Pop(1)
0x75d: Push((int) 0)
0x75e: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x75f: IF (Stack[-1] == 0) GOTO 0x762; Pop(1)

0x760: @ SignalDeath(Stack[-4])
0x761: Pop(0)
0x762: Return(); Pop(2)
