...
0x32f: Stack[-2] = (bool) 1
0x330: Return(); Pop(0)

0x331: Stack[-2] = (bool) 0
0x332: Return(); Pop(0)

0x333: PushEmpty()
0x334: PushEmpty(int, string)
0x335: Stack[-1] = "ood4TheaterGuard2"
0x336: Call2 0x2e6
...
0x350: Stack[-1] = (int) 515556
0x351: Return(); Pop(0)

0x352: Stack[-1] = (int) 503341
0x353: Return(); Pop(0)
