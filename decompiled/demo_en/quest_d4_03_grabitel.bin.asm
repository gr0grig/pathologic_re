...
0x6fe: Push("GenerateMoney: iMin > iMax")
0x6ff: @ Trace(Stack[-1])
0x700: Pop(1)
0x701: Return(); Pop(4)
...
0x73a: Pop(0)
0x73b: Stack[-4] = Stack[-1]
0x73c: Return(); Pop(2)

0x73d: PushEmpty()
0x73e: PushEmpty(bool, string, string)
0x73f: Stack[-2] = "quest_d4_03"
0x740: Stack[-1] = "death"
0x741: Call2 0x6c8

0x742: Pop(3)
0x743: PushEmpty(bool, object)
0x744: Stack[-1] = Stack[-3]
0x745: Call2 0x4f1
...
0x749: Stack[-2] = Stack[-4]
0x74a: Stack[-1] = (float) 0.03
0x74b: Call2 0x691

0x74c: Pop(3)
0x74d: PushEmpty(object)
0x74e: Stack[-1] = Stack[-2]
...
0x756: Stack[-3] = Stack[-7]
0x757: Stack[-2] = Stack[-6]
0x758: Stack[-1] = Stack[-5]
0x759: Call2 0x5ce
...
0x75e: Stack[-5] = Stack[-11]
0x75f: Stack[-4] = Stack[-10]
0x760: Stack[-3] = Stack[-9]
0x761: Stack[-2] = Stack[-7]
