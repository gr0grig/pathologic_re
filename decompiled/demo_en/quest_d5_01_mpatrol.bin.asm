...
Events:
EVENT_22 Op = 0x8e6 Vars = (object, int, float, float)
EVENT_43 Op = 0x8ee Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8f8 Vars = (object, string)
EVENT_41 Op = 0x905 Vars = (object)
...
0x781: PushEmpty(bool, float, float, bool, float, float)
0x782: @ lshHasAnimation(Stack[-3], Stack[-7])
0x783: Pop(0)
0x784: Push(Stack[-3])
0x785: IF (Stack[-1] == 0) GOTO 0x78c; Pop(1)

0x786: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x787: Pop(0)
0x788: Push((bool) 0)
0x789: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x78a: Pop(1)
0x78b: GOTO 0x790

0x78c: Push("Can't find lsh animation : ")
0x78d: Pop(1); Push(Stack[-1] + Stack[-8]);
0x78e: @ Trace(Stack[-1])
0x78f: Pop(1)
0x790: Return(); Pop(6)

0x791: PushEmpty(bool, float, float, bool, float, float)
0x792: @ lshHasAnimation(Stack[-3], Stack[-8])
0x793: Pop(0)
0x794: Push(Stack[-3])
0x795: IF (Stack[-1] == 0) GOTO 0x79b; Pop(1)

0x796: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x797: Pop(0)
0x798: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x799: Pop(0)
0x79a: GOTO 0x79f

0x79b: Push("Can't find lsh animation : ")
0x79c: Pop(1); Push(Stack[-1] + Stack[-9]);
0x79d: @ Trace(Stack[-1])
0x79e: Pop(1)
0x79f: Return(); Pop(6)

0x7a0: PushEmpty(float, cvector, float, cvector)
0x7a1: @@ GetEyesHeight(Stack[-2])
0x7a2: Pop(0)
0x7a3: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x7a4: Push(CvectorIndex(Stack[-1], 1))
0x7a5: Stack[-1] = Stack[-3]
0x7a6: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7a7: Push("head")
0x7a8: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x7a9: Pop(1)
0x7aa: Return(); Pop(4)
...
0x7b2: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7b3: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7b4: Pop(0)
0x7b5: Pop(0); Push((bool) Stack[-8] == 0)
0x7b6: IF (Stack[-1] == 0) GOTO 0x7cb; Pop(1)

0x7b7: Stack[-7] = (int) 0
0x7b8: Push((int) 1)
0x7b9: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7ba: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7bb: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7bc: Pop(1)
0x7bd: Pop(0); Push((bool) Stack[-6] == 0)
...
0x7c3: Pop(0); Push((bool) Stack[-7] == 0)
0x7c4: IF (Stack[-1] == 0) GOTO 0x7c6; Pop(1)

0x7c5: Return(); Pop(16)

0x7c6: @ irand(Stack[-5], Stack[-7])
0x7c7: Pop(0)
0x7c8: Push((int) 1)
0x7c9: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7ca: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7cb: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7cc: Pop(0)
0x7cd: Push(Stack[-4])
0x7ce: IF (Stack[-1] == 0) GOTO 0x7da; Pop(1)

0x7cf: @ GetEyesHeight(Stack[-3])
0x7d0: Pop(0)
0x7d1: @ GetDirection(Stack[-2])
0x7d2: Pop(0)
0x7d3: Push((int) 50)
0x7d4: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7d5: Push(CvectorIndex(Stack[-1], 1))
0x7d6: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7d7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7d8: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7d9: Pop(0)
0x7da: Return(); Pop(16)
...
0x7e2: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7e3: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7e4: Push((float)0.0)
0x7e5: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7e6: IF (Stack[-1] == 0) GOTO 0x7e9; Pop(1)

0x7e7: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x7e8: Return(); Pop(2)

0x7e9: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x7ea: Return(); Pop(2)

0x7eb: PushEmpty()
0x7ec: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x7ed: IF (Stack[-1] == 0) GOTO 0x7f0; Pop(1)

0x7ee: Stack[-3] = Stack[-2]
0x7ef: GOTO 0x7f1
...
0x7f2: PushEmpty()
0x7f3: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x7f4: IF (Stack[-1] == 0) GOTO 0x7f7; Pop(1)

0x7f5: Stack[-4] = Stack[-2]
0x7f6: Return(); Pop(0)

0x7f7: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7f8: IF (Stack[-1] == 0) GOTO 0x7fb; Pop(1)

0x7f9: Stack[-4] = Stack[-1]
0x7fa: Return(); Pop(0)

0x7fb: Stack[-4] = Stack[-3]
0x7fc: Return(); Pop(0)

0x7fd: PushEmpty(int, int)
0x7fe: @ GetVariable(Stack[-3], Stack[-1])
0x7ff: Pop(0)
0x800: Stack[-4] = Stack[-1]
0x801: Return(); Pop(2)

0x802: PushEmpty(object, object)
0x803: @ CreateFloatVector(Stack[-1])
0x804: Pop(0)
0x805: @@ add(Stack[-3])
0x806: Pop(0)
0x807: Push((int) 15)
0x808: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x809: Pop(1)
0x80a: Return(); Pop(2)

0x80b: Stack[-1] = 0
0x80c: PushEmpty(object, object)
0x80d: @ FindActor(Stack[-1], Stack[-4])
0x80e: Pop(0)
0x80f: Pop(0); Push((bool) Stack[-1] == 0)
0x810: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x811: Stack[-5] = (bool) 0
0x812: Return(); Pop(2)

0x813: @ Trigger(Stack[-1], Stack[-3])
0x814: Pop(0)
0x815: Stack[-5] = (bool) 1
0x816: Return(); Pop(2)

0x817: Stack[-1] = 0
0x818: PushEmpty(float, float)
0x819: @ GetGameTime(Stack[-1])
0x81a: Pop(0)
...
0x830: Stack[-1] = 0
0x831: PushEmpty()
0x832: PushEmpty(object, string, float)
0x833: PushEmpty(object)
0x834: Call2 0x867

0x835: Stack[-4] = Stack[-1]
0x836: Pop(1)
0x837: Stack[-2] = "pt_map_grif"
0x838: Stack[-1] = (int) 2
0x839: Call2 0x878
...
0x83d: Pop(0)
0x83e: @@ ShowMap(Stack[-1])
0x83f: Pop(1)
0x840: Return(); Pop(0)

0x841: PushEmpty()
0x842: Push("ood5PatrolGuard1")
0x843: Push((int) 1)
...
0x84e: Stack[-2] = Stack[-1]
0x84f: Pop(1)
0x850: Push("d5q01PatrolGotoGrif")
0x851: Push("pt_map_grif")
0x852: Push((int) 1)
0x853: Push((int) 515349)
0x854: PushEmpty(float)
0x855: Call2 0x818

0x856: Pop(0)
0x857: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x858: Pop(5)
0x859: Return(); Pop(2)

0x85a: Stack[-1] = 0
0x85b: PushEmpty()
0x85c: PushEmpty(int, string)
0x85d: Stack[-1] = "ood5PatrolGuard1"
0x85e: Call2 0x7fd
...
0x863: Stack[-2] = (bool) 1
0x864: Return(); Pop(0)

0x865: Stack[-2] = (bool) 0
0x866: Return(); Pop(0)

0x867: PushEmpty(object, object, object, object)
0x868: @ GetMainOutdoorScene(Stack[-2])
0x869: Pop(0)
0x86a: Pop(0); Push((bool) Stack[-2] == 0)
0x86b: IF (Stack[-1] == 0) GOTO 0x872; Pop(1)

0x86c: Push("Can't find main outdoor scene")
0x86d: @ Trace(Stack[-1])
0x86e: Pop(1)
0x86f: Stack[-1] = 0
...
0x876: Stack[-1] = 0
0x877: Stack[-2] = 0
0x878: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x879: @ GetMainOutdoorScene(Stack[-2])
0x87a: Pop(0)
0x87b: Pop(0); Push((bool) Stack[-2] == 0)
0x87c: IF (Stack[-1] == 0) GOTO 0x881; Pop(1)

0x87d: Push("Can't find main outdoor scene")
0x87e: @ Trace(Stack[-1])
0x87f: Pop(1)
0x880: Return(); Pop(8)

0x881: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x882: Pop(0)
0x883: Pop(0); Push((bool) Stack[-1] == 0)
0x884: IF (Stack[-1] == 0) GOTO 0x88b; Pop(1)

0x885: Push("Warning: outdoor scene locator ")
0x886: Pop(1); Push(Stack[-1] + Stack[-11]);
0x887: Push(" doesnt exist")
0x888: Pop(2); Push(Stack[-2] + Stack[-1]);
0x889: @ Trace(Stack[-1])
0x88a: Pop(1)
0x88b: @@ GetMap(Stack[-11])
0x88c: Pop(0)
0x88d: Pop(0); Push((bool) Stack[-11] == 0)
0x88e: IF (Stack[-1] == 0) GOTO 0x893; Pop(1)

0x88f: Push("Can't find map")
0x890: @ Trace(Stack[-1])
0x891: Pop(1)
0x892: Return(); Pop(8)

0x893: Push(CvectorIndex(Stack[-4], 0))
0x894: Push(CvectorIndex(Stack[-5], 2))
0x895: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x896: Pop(2)
0x897: Return(); Pop(8)
...
0x89a: Push("branch")
0x89b: @ GetVariable(Stack[-1], Stack[-2])
0x89c: Pop(1)
0x89d: Push((int) 0)
0x89e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x8aa: PushEmpty(int, int)
0x8ab: Push("branch")
0x8ac: @ GetVariable(Stack[-1], Stack[-2])
0x8ad: Pop(1)
...
0x8b3: Pop(0)
0x8b4: Push((int) 1)
0x8b5: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x8b6: IF (Stack[-1] == 0) GOTO 0x8ba; Pop(1)

0x8b7: @ WorkWithCorpse(Stack[-1])
0x8b8: Pop(0)
0x8b9: GOTO 0x8bc

0x8ba: @ Barter(Stack[-1])
0x8bb: Pop(0)
0x8bc: Return(); Pop(0)

0x8bd: PushEmpty(object, int, bool, object, int, bool)
0x8be: @ CreateInvItem(Stack[-3])
0x8bf: Pop(0)
0x8c0: @@ SetItemName(Stack[-7])
0x8c1: Pop(0)
0x8c2: Push("Organ")
0x8c3: Push((int) 1)
0x8c4: @@ SetProperty(Stack[-2], Stack[-1])
0x8c5: Pop(2)
0x8c6: @@ GetItemID(Stack[-2])
0x8c7: Pop(0)
0x8c8: Push((int) 0)
0x8c9: Push((int) 1)
0x8ca: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x8cb: Pop(2)
0x8cc: Return(); Pop(6)
...
0x8d0: Pop(0)
0x8d1: Push((int) 1)
0x8d2: Pop(2); Push((bool) Stack[-2] != Stack[-1])
...
0x8e6: PushEmpty()
0x8e7: PushEmpty(object, int, float)
0x8e8: Stack[-3] = Stack[-7]
0x8e9: Stack[-2] = Stack[-6]
0x8ea: Stack[-1] = Stack[-5]
0x8eb: Call2 0x6cf
...
0x8ee: PushEmpty()
0x8ef: PushEmpty(object, int, float, cvector, cvector)
0x8f0: Stack[-5] = Stack[-11]
0x8f1: Stack[-4] = Stack[-10]
0x8f2: Stack[-3] = Stack[-9]
0x8f3: Stack[-2] = Stack[-7]
0x8f4: Stack[-1] = Stack[-6]
0x8f5: Call2 0x713

0x8f6: Pop(5)
0x8f7: Return(); Pop(0)

0x8f8: PushEmpty(float, float)
0x8f9: Push("health")
0x8fa: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8fb: IF (Stack[-1] == 0) GOTO 0x904; Pop(1)

0x8fc: Push("health")
0x8fd: @ GetProperty(Stack[-1], Stack[-2])
0x8fe: Pop(1)
0x8ff: Push((int) 0)
0x900: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x901: IF (Stack[-1] == 0) GOTO 0x904; Pop(1)

0x902: @ SignalDeath(Stack[-4])
0x903: Pop(0)
0x904: Return(); Pop(2)
...
0x90b: Stack[-1] = (int) 515572
0x90c: Return(); Pop(0)

0x90d: Stack[-1] = (int) 504031
0x90e: Return(); Pop(0)

0x90f: Stack[-1] = "ui/NPC_Citizen2.png"
0x910: Return(); Pop(0)

0x911: Stack[-1] = "ui/NPC_Citizen2_b.png"
0x912: Return(); Pop(0)
...
0x922: Push(-1, 0); TaskCall(4)
0x923: Call2 0x524

0x924: Pop(-1, 0); TaskReturn
0x925: Pop(1)
0x926: Return(); Pop(2)
