...
0x6ef: Push(CvectorIndex(Stack[-1], 1))
0x6f0: Stack[-1] = Stack[-3]
0x6f1: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6f2: Push("head")
...
0x6ff: Pop(0)
0x700: Pop(0); Push((bool) Stack[-8] == 0)
0x701: IF (Stack[-1] == 0) GOTO 0x716; Pop(1)

0x702: Stack[-7] = (int) 0
0x703: Push((int) 1)
0x704: Pop(1); Push(Stack[-8] + Stack[-1]);
0x705: Pop(1); Push(Stack[-18] + Stack[-1]);
...
0x70b: Push((int) 1)
0x70c: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x70d: GOTO 0x703

0x70e: Pop(0); Push((bool) Stack[-7] == 0)
...
0x715: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x71d: Pop(0)
0x71e: Push((int) 50)
0x71f: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x720: Push(CvectorIndex(Stack[-1], 1))
0x721: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x722: CvectorIndex(Stack[-2], 1) = Stack[-1];
...
0x72d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x72e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x734: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x735: Return(); Pop(2)
...
0x7fb: Push(-1, 0); TaskCall(4)
0x7fc: Call2 0x46f

0x7fd: Pop(-1, 0); TaskReturn
0x7fe: Pop(1)
0x7ff: Return(); Pop(2)
