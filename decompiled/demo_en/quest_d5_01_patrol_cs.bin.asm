...
0x625: Pop(0)
0x626: @@ SetItemName(Stack[-7])
0x627: Pop(0)
0x628: Push("Organ")
0x629: Push((int) 1)
0x62a: @@ SetProperty(Stack[-2], Stack[-1])
0x62b: Pop(2)
0x62c: @@ GetItemID(Stack[-2])
0x62d: Pop(0)
0x62e: Push((int) 0)
0x62f: Push((int) 1)
...
0x65e: Stack[-5] = Stack[-11]
0x65f: Stack[-4] = Stack[-10]
0x660: Stack[-3] = Stack[-9]
0x661: Stack[-2] = Stack[-7]
0x662: Stack[-1] = Stack[-6]
0x663: Call2 0x577
