task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1532(var_12_object); // 0x2ec NEW_2
...
task_3_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_object)
{
	...
	func_1558(var_13_object); // 0x3d1 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x655 PushV
	var_13_object = var_9_object; // 0x656 Mov
	var_14_int = var_10_int; // 0x657 Mov
	var_15_float = var_11_float; // 0x658 Mov
	func_1331(var_13_object, var_14_int, var_15_float); // 0x659 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x65d PushV
	var_15_object = var_9_object; // 0x65e Mov
	var_16_int = var_10_int; // 0x65f Mov
	var_17_float = var_11_float; // 0x660 Mov
	var_18_cvector = var_13_cvector; // 0x661 Mov
	var_19_cvector = var_14_cvector; // 0x662 Mov
	func_1399(var_17_float, var_18_cvector, var_19_cvector); // 0x663 NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x666 PushV
	var_13_string = "health"; // 0x667 PushS
	var_14_bool = var_10_string == var_13_string; // 0x668 Eq
	if(var_14_bool == 0) goto Label_1650; // 0x669 JumpB
	var_15_string = "health"; // 0x66a PushS
	GetProperty(var_15_string, var_12_float); // 0x66b Func
	var_16_int = 0; // 0x66d PushI
	var_17_bool = var_12_float <= var_16_int; // 0x66e LE
	if(var_17_bool == 0) goto Label_1650; // 0x66f JumpB
	SignalDeath(var_9_object); // 0x670 Func
...
{
	var_10_object = Obj(); // 0x674 PushV
	var_10_object = var_9_object; // 0x675 Mov
	func_1612(var_10_object); // 0x676 NEW_2
...
Label_0:
	...
	var_510_float = 0.5; // 0x5 PushF
	Sleep(var_510_float); // 0x6 Func
...
func_1541()
{
	var_352_object = Obj(); var_353_object = Obj(); // 0x605 PushV
	GetScene(var_353_object); // 0x606 Func
	var_354_string = "battle"; // 0x608 PushS
	var_355_object = Obj(); // 0x609 PushV
	func_1476(var_355_object); // 0x60a NEW_2
	BroadcastMessage(var_354_string, var_355_object, var_353_object); // 0x60c Func
...
func_1552(var_100_int)
{
	var_101_int = 0; var_102_int = 0; // 0x610 PushV
	var_103_string = "branch"; // 0x611 PushS
	GetVariable(var_103_string, var_102_int); // 0x612 Func
	var_100_int = var_102_int; // 0x614 Mov
	return 2; // 0x615 Return
}


func_1558(var_13_object)
{
	var_14_int = 0; // 0x617 PushV
	func_1552(var_14_int); // 0x618 NEW_2
	var_18_int = 1; // 0x61a PushI
	var_19_bool = var_14_int == var_18_int; // 0x61b Eq
	if(var_19_bool == 0) goto Label_1568; // 0x61c JumpB
	WorkWithCorpse(var_13_object); // 0x61d Func
	goto Label_1570; // 0x61f Jump
	
Label_1570:
	return 0; // 0x622 Return
	
Label_1568:
	Barter(var_13_object); // 0x620 Func
}
...
Label_187:
	...
	var_494_string = "all"; // 0xbd PushS
	var_495_string = "fjump"; // 0xbe PushS
	PlayAnimation(var_494_string, var_495_string); // 0xbf Func
	WaitForAnimEnd(); // 0xc1 Func
	func_673(var_43_float); // 0xc4 NEW_2
	var_496_cvector = CVector(0.0, 0.0, 0.0); // 0xc6 PushVec
	SetSpeed(var_496_cvector); // 0xc7 Func
	Stop(); // 0xc9 Func
	StopAsync(); // 0xcb Func
	var_497_bool = 0; // 0xcd PushV
	func_630(var_43_float, var_497_bool); // 0xce NEW_2
	var_498_bool = var_497_bool == 0; // 0xd0 Not
	if(var_498_bool == 0) goto Label_233; // 0xd1 JumpB
	var_499_bool = 0; var_500_object = Obj(); // 0xd2 PushV
	var_500_object = var_0_object; // 0xd3 MovT
	func_1263(var_499_bool, var_500_object); // 0xd4 NEW_2
	var_501_bool = var_499_bool == 0; // 0xd6 Not
	if(var_501_bool == 0) goto Label_217; // 0xd7 JumpB
...
Label_217:
	...
	var_502_float = var_21_float * var_21_float; // 0xdf Mult
	var_503_bool = var_40_float < var_502_float; // 0xe0 LT
	if(var_503_bool == 0) goto Label_233; // 0xe1 JumpB
	var_504_bool = 0; var_505_float = 0; // 0xe2 PushV
	var_505_float = var_21_float; // 0xe3 Mov
	func_334(var_43_float, var_504_bool, var_505_float); // 0xe4 NEW_2
	var_506_bool = var_504_bool == 0; // 0xe6 Not
	if(var_506_bool == 0) goto Label_233; // 0xe7 JumpB
	goto Label_243; // 0xe8 Jump
	
Label_234:
	var_507_bool = 0; var_508_float = 0; // 0xea PushV
	var_508_float = var_21_float; // 0xeb Mov
	func_334(var_43_float, var_507_bool, var_508_float); // 0xec NEW_2
	var_509_bool = var_507_bool == 0; // 0xee Not
	if(var_509_bool == 0) goto Label_241; // 0xef JumpB
...
func_673(var_0_object)
{
	...
	func_1532(var_115_object); // 0x2a3 NEW_2
	return 0; // 0x2a5 Return
}


func_1571(var_106_string)
{
	var_107_object = Obj(); var_108_int = 0; var_109_bool = 0; var_110_object = Obj(); var_111_int = 0; var_112_bool = 0; // 0x623 PushV
	CreateInvItem(var_110_object); // 0x624 Func
	SetItemName(var_106_string); // 0x626 ObjFunc
	var_113_string = "Organ"; // 0x628 PushS
	var_114_int = 1; // 0x629 PushI
	SetProperty(var_113_string, var_114_int); // 0x62a ObjFunc
	GetItemID(var_111_int); // 0x62c ObjFunc
	var_115_int = 0; // 0x62e PushI
	var_116_int = 1; // 0x62f PushI
	AddItem(var_112_bool, var_110_object, var_115_int, var_116_int); // 0x630 Func
	return 6; // 0x632 Return
}


func_678(var_452_int)
{
	var_452_int = 0; // 0x2a6 MovI
...
func_295(var_0_object, var_377_float, var_378_int)
{
	...
	var_452_int = 0; // 0x142 PushV
	func_678(var_452_int); // 0x143 NEW_2
	ReportHit(var_0_object, var_452_int, var_384_float, var_383_float); // 0x145 Func
	var_453_object = Obj(); var_454_float = 0; // 0x147 PushV
	var_453_object = var_382_object; // 0x148 Mov
	var_454_float = var_384_float; // 0x149 Mov
...
func_687(var_477_bool)
{
	var_477_bool = 1; // 0x2af MovB
...
func_693(var_2_int, var_122_bool, var_123_object, var_124_float, var_125_float, var_126_bool, var_127_bool)
{
	...
	func_1532(var_135_object); // 0x2b8 NEW_2
...
func_1588()
{
	var_100_int = 0; // 0x634 PushV
	func_1552(var_100_int); // 0x635 NEW_2
	var_104_int = 1; // 0x637 PushI
	var_105_bool = var_100_int != var_104_int; // 0x638 Neq
	if(var_105_bool == 0) goto Label_1595; // 0x639 JumpB
	return 0; // 0x63a Return
	
Label_1595:
	var_106_string = ""; // 0x63b PushV
	var_106_string = "liver"; // 0x63c MovS
	func_1571(var_106_string); // 0x63d NEW_2
	var_117_string = ""; // 0x63f PushV
	var_117_string = "kidney"; // 0x640 MovS
	func_1571(var_117_string); // 0x641 NEW_2
	var_118_string = ""; // 0x643 PushV
	var_118_string = "heart"; // 0x644 MovS
	func_1571(var_118_string); // 0x645 NEW_2
	var_119_string = ""; // 0x647 PushV
	var_119_string = "blood"; // 0x648 MovS
	func_1571(var_119_string); // 0x649 NEW_2
...
func_949(var_11_object)
{
	...
	func_1520(var_12_bool, var_13_string, var_14_string); // 0x3b9 NEW_2
...
func_1612(var_10_object)
{
	var_11_object = Obj(); // 0x64d PushV
	var_11_object = var_10_object; // 0x64e Mov
	TaskCall(3); // 0x64f TaskCall
	func_949(var_11_object); // 0x650 NEW_2
	TaskReturn(); // 0x651 TaskReturn
...
Label_370:
	...
	var_455_string = "all"; // 0x177 PushS
	var_456_string = "attack_middle"; // 0x178 PushS
	var_457_int = var_456_string + var_346_int; // 0x179 Add
	HasAnimation(var_347_bool, var_455_string, var_457_int); // 0x17a Func
	var_458_bool = var_347_bool; // 0x17c Push
	if(var_458_bool == 0) goto Label_451; // 0x17d JumpB
	func_1541(); // 0x17f NEW_2
	var_459_string = "all"; // 0x181 PushS
	var_460_string = "attack_middle"; // 0x182 PushS
	var_461_int = var_460_string + var_346_int; // 0x183 Add
	PlayAnimation(var_459_string, var_461_int); // 0x184 Func
	WaitForAnimEnd(); // 0x186 Func
	func_673(var_349_string); // 0x189 NEW_2
	var_462_bool = 0; var_463_object = Obj(); // 0x18b PushV
	var_463_object = var_0_object; // 0x18c MovT
	func_1263(var_462_bool, var_463_object); // 0x18d NEW_2
	var_464_bool = var_462_bool == 0; // 0x18f Not
	if(var_464_bool == 0) goto Label_405; // 0x190 JumpB
	StopAsync(); // 0x191 Func
	var_340_bool = 0; // 0x193 MovB
	return 8; // 0x194 Return
	
Label_405:
	var_465_float = 0; var_466_int = 0; // 0x195 PushV
	var_465_float = var_341_float; // 0x196 Mov
	var_466_int = var_346_int; // 0x197 Mov
	func_295(var_349_string, var_465_float, var_466_int); // 0x198 NEW_2
	var_348_int = 1; // 0x19a MovI
	
Label_411:
	var_467_string = "attack_middle"; // 0x19b PushS
	var_468_int = var_467_string + var_346_int; // 0x19c Add
	var_469_string = "_"; // 0x19d PushS
	var_470_int = var_468_int + var_469_string; // 0x19e Add
	var_349_string = var_470_int + var_348_int; // 0x19f Add2
	var_471_string = "all"; // 0x1a0 PushS
	HasAnimation(var_347_bool, var_471_string, var_349_string); // 0x1a1 Func
	var_472_bool = var_347_bool == 0; // 0x1a3 Not
	if(var_472_bool == 0) goto Label_422; // 0x1a4 JumpB
	goto Label_451; // 0x1a5 Jump
	
Label_451:
	var_473_bool = 0; // 0x1c3 PushB
	SetAttackState(var_473_bool); // 0x1c4 Func
	var_474_string = "all"; // 0x1c6 PushS
	var_475_string = "attack_end"; // 0x1c7 PushS
	var_476_int = var_475_string + var_346_int; // 0x1c8 Add
	PlayAnimation(var_474_string, var_476_int); // 0x1c9 Func
	var_477_bool = 0; // 0x1cb PushV
	func_687(var_477_bool); // 0x1cc NEW_2
	if(var_477_bool == 0) goto Label_469; // 0x1ce JumpB
	var_478_bool = 0; var_479_float = 0; // 0x1cf PushV
	var_479_float = 0.75; // 0x1d0 MovF
	func_471(var_478_bool, var_479_float); // 0x1d1 NEW_2
...
Label_422:
	func_1541(); // 0x1a7 NEW_2
	var_487_string = "all"; // 0x1a9 PushS
	PlayAnimation(var_487_string, var_349_string); // 0x1aa Func
	WaitForAnimEnd(); // 0x1ac Func
	func_673(var_349_string); // 0x1af NEW_2
	var_488_bool = 0; var_489_object = Obj(); // 0x1b1 PushV
	var_489_object = var_0_object; // 0x1b2 MovT
	func_1263(var_488_bool, var_489_object); // 0x1b3 NEW_2
	var_490_bool = var_488_bool == 0; // 0x1b5 Not
	if(var_490_bool == 0) goto Label_443; // 0x1b6 JumpB
	StopAsync(); // 0x1b7 Func
	var_340_bool = 0; // 0x1b9 MovB
	return 8; // 0x1ba Return
	
Label_443:
	var_491_float = 0; var_492_int = 0; // 0x1bb PushV
	var_491_float = var_341_float; // 0x1bc Mov
	var_492_int = var_346_int; // 0x1bd Mov
	func_295(var_349_string, var_491_float, var_492_int); // 0x1be NEW_2
	var_493_int = 1; // 0x1c0 PushI
	var_348_int = var_348_int + var_493_int; // 0x1c1 Add2
...
func_471(var_478_bool, var_479_float)
{
	var_480_float = 0; var_481_bool = 0; var_482_float = 0; var_483_bool = 0; // 0x1d7 PushV
	rand(var_482_float); // 0x1d8 Func
	var_484_bool = var_482_float < var_479_float; // 0x1da LT
	if(var_484_bool == 0) goto Label_491; // 0x1db JumpB
	
Label_476:
	IsAnimationPlaying(var_483_bool); // 0x1dc Func
	var_485_bool = var_483_bool == 0; // 0x1de Not
	if(var_485_bool == 0) goto Label_481; // 0x1df JumpB
...
Label_496:
	var_478_bool = 0; // 0x1f0 MovB
	return 4; // 0x1f1 Return
	
Label_481:
	var_486_bool = 0; // 0x1e1 PushV
	func_569(var_486_bool); // 0x1e2 NEW_2
	if(var_486_bool == 0) goto Label_487; // 0x1e4 JumpB
	var_478_bool = 1; // 0x1e5 MovB
...
Label_491:
	...
	func_673(var_483_bool); // 0x1ee NEW_2
}
...
func_1510(var_447_float)
{
	...
	var_450_int = 15; // 0x5eb PushI
	SendWorldWndMessage(var_450_int, var_449_object); // 0x5ec Func
...
func_1520(var_12_bool, var_13_string, var_14_string)
{
	var_15_object = Obj(); var_16_object = Obj(); // 0x5f0 PushV
	FindActor(var_16_object, var_13_string); // 0x5f1 Func
	var_17_bool = var_16_object == 0; // 0x5f3 NullEq
	if(var_17_bool == 0) goto Label_1527; // 0x5f4 JumpB
	var_12_bool = 0; // 0x5f5 MovB
	return 2; // 0x5f6 Return
	
Label_1527:
	Trigger(var_16_object, var_14_string); // 0x5f7 Func
	var_12_bool = 1; // 0x5f9 MovB
...
func_1532(var_115_object)
{
	var_116_bool = 0; var_117_bool = 0; // 0x5fc PushV
	IsPlayerActor(var_115_object, var_117_bool); // 0x5fd Func
	var_118_bool = var_117_bool; // 0x5ff Push
	if(var_118_bool == 0) goto Label_1540; // 0x600 JumpB
	var_119_string = "attack"; // 0x601 PushS
	PlayGlobalMusic(var_119_string); // 0x602 Func
...
Label_1168:
	var_451_string = "armor"; // 0x490 PushS
	GetProperty(var_451_string, var_404_int); // 0x491 ObjFunc
}
