task_0_event_26(var_0_object, var_1_object, var_2_string)
{
	...
	func_185(var_13_object, var_14_object, var_15_string, var_16_string, var_17_string); // 0x1d NEW_2
...
Label_51:
	...
	var_47_string = "pers_gorbun"; // 0x42 MovS
	var_48_string = "d5q02_gorbun.xml"; // 0x43 MovS
	func_185(var_44_object, var_45_object, var_46_string, var_47_string, var_48_string); // 0x44 NEW_2
...
Label_149:
	...
	func_179(var_14_object); // 0x96 NEW_2
...
Label_129:
	...
	func_138(var_59_int); // 0x87 NEW_2
...
func_155(var_4_int)
{
	...
	func_138(var_6_float); // 0xa3 NEW_2
