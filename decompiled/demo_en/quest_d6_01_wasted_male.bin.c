...
Label_178:
	...
	func_711(var_41_object); // 0xc0 NEW_2
...
Label_308:
	...
	func_703(var_100_bool); // 0x136 NEW_2
...
func_705()
{
	var_18_string = "ood6WastedMale1"; // 0x2c2 PushS
	var_19_int = 1; // 0x2c3 PushI
	SetVariable(var_18_string, var_19_int); // 0x2c4 Func
...
func_711(var_110_bool)
{
	var_112_int = 0; var_113_string = ""; // 0x2c8 PushV
	var_113_string = "ood6WastedMale1"; // 0x2c9 MovS
	func_666(var_112_int, var_113_string); // 0x2ca NEW_2
	var_116_int = 0; // 0x2cc PushI
	var_117_bool = var_112_int == var_116_int; // 0x2cd Eq
	if(var_117_bool == 0) goto Label_721; // 0x2ce JumpB
	var_110_bool = 1; // 0x2cf MovB
	return 0; // 0x2d0 Return
	
Label_721:
	var_110_bool = 0; // 0x2d1 MovB
...
func_649()
{
	...
	func_703(var_13_bool); // 0x28a NEW_2
...
Label_563:
	...
	func_703(var_67_bool); // 0x23c NEW_2
...
Label_121:
	...
	func_607(var_129_string); // 0x7b NEW_2
...
func_142(var_2_object, var_92_string)
{
	...
	func_703(var_93_bool); // 0x90 NEW_2
...
Label_160:
	func_623(var_96_string, var_97_bool); // 0xa0 NEW_2
...
func_590()
{
	var_147_bool = 0; var_148_bool = 0; // 0x24e PushV
	CameraSwitchToNormal(); // 0x24f Func
	var_149_bool = 0; // 0x251 PushV
	func_703(var_149_bool); // 0x252 NEW_2
	if(var_149_bool == 0) goto Label_598; // 0x254 JumpB
...
Label_598:
	var_150_string = "head"; // 0x256 PushS
	HasAnimationTrack(var_148_bool, var_150_string); // 0x257 Func
	var_151_bool = var_148_bool; // 0x259 Push
	if(var_151_bool == 0) goto Label_606; // 0x25a JumpB
	var_152_string = "head"; // 0x25b PushS
	UnlookAsync(var_152_string); // 0x25c Func
}
...
func_723(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x2d3 PushV
	var_79_string = "branch"; // 0x2d4 PushS
	GetVariable(var_79_string, var_78_int); // 0x2d5 Func
	var_80_int = 0; // 0x2d7 PushI
	var_81_bool = var_78_int == var_80_int; // 0x2d8 Eq
	if(var_81_bool == 0) goto Label_733; // 0x2d9 JumpB
	var_76_int = 1; // 0x2da MovI
	return 2; // 0x2db Return
	
Label_733:
	var_82_int = 1; // 0x2dd PushI
	var_83_bool = var_78_int == var_82_int; // 0x2de Eq
	if(var_83_bool == 0) goto Label_738; // 0x2df JumpB
	var_76_int = 2; // 0x2e0 MovI
	return 2; // 0x2e1 Return
	
Label_738:
	var_76_int = 3; // 0x2e2 MovI
...
func_671(var_43_string, var_44_int)
{
	var_45_string = ""; var_46_string = ""; // 0x29f PushV
	var_46_string = "idle"; // 0x2a0 MovS
	var_47_int = var_44_int; // 0x2a1 Push
	if(var_47_int == 0) goto Label_676; // 0x2a2 JumpB
	var_46_string = var_46_string + var_44_int; // 0x2a3 Add2
	
Label_676:
	var_43_string = var_46_string; // 0x2a4 Mov
	return 2; // 0x2a5 Return
}


func_607(var_129_string)
{
	var_130_bool = 0; var_131_float = 0; var_132_float = 0; var_133_bool = 0; var_134_float = 0; var_135_float = 0; // 0x25f PushV
	lshHasAnimation(var_133_bool, var_129_string); // 0x260 Func
	var_136_bool = var_133_bool; // 0x262 Push
	if(var_136_bool == 0) goto Label_618; // 0x263 JumpB
	lshGetAnimTimes(var_129_string, var_134_float, var_135_float); // 0x264 Func
	var_137_bool = 0; // 0x266 PushB
	lshPlayAnimation(var_134_float, var_135_float, var_137_bool); // 0x267 Func
...
Label_618:
	var_138_string = "Can't find lsh animation : "; // 0x26a PushS
	var_139_int = var_138_string + var_129_string; // 0x26b Add
	Trace(var_139_int); // 0x26c Func
}


func_678(var_37_int)
{
	var_38_int = 0; var_39_bool = 0; var_40_int = 0; var_41_bool = 0; // 0x2a6 PushV
	var_40_int = 0; // 0x2a7 MovI
	
Label_680:
	var_42_string = "all"; // 0x2a8 PushS
	var_43_string = ""; var_44_int = 0; // 0x2a9 PushV
	var_44_int = var_40_int; // 0x2aa Mov
	func_671(var_43_string, var_44_int); // 0x2ab NEW_2
	HasAnimation(var_41_bool, var_42_string, var_43_string); // 0x2ad Func
	var_48_bool = var_41_bool == 0; // 0x2af Not
	if(var_48_bool == 0) goto Label_690; // 0x2b0 JumpB
	goto Label_693; // 0x2b1 Jump
	
Label_693:
	var_37_int = var_40_int; // 0x2b5 Mov
	return 4; // 0x2b6 Return
	
Label_690:
	var_49_int = 1; // 0x2b2 PushI
	var_40_int = var_40_int + var_49_int; // 0x2b3 Add2
...
Label_432:
	...
	func_678(var_37_int); // 0x1b1 NEW_2
...
Label_447:
	...
	func_671(var_59_string, var_60_int); // 0x1cd NEW_2
...
func_697(var_72_int)
{
	var_72_int = 503341; // 0x2b9 MovI
	return 0; // 0x2ba Return
}


func_699(var_74_string)
{
	var_74_string = "ui/NPC_Citizen3.png"; // 0x2bb MovS
...
{
	var_75_string = "ui/NPC_Citizen3_b.png"; // 0x2bd MovS
...
func_703(var_67_bool)
{
	var_67_bool = 0; // 0x2bf MovB
