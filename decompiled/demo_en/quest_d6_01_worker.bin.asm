...
0x259: @@ GetEyesHeight(Stack[-2])
0x25a: Pop(0)
0x25b: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x291: Stack[-1] = (int) 515568
0x292: Return(); Pop(0)

0x293: Stack[-1] = (int) 503353
0x294: Return(); Pop(0)

0x295: Stack[-1] = "ui/NPC_Citizen1.png"
0x296: Return(); Pop(0)

0x297: Stack[-1] = "ui/NPC_Citizen1_b.png"
0x298: Return(); Pop(0)
