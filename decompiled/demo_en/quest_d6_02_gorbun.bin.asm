...
0x698: Push("GenerateMoney: iMin > iMax")
0x699: @ Trace(Stack[-1])
0x69a: Pop(1)
0x69b: Return(); Pop(4)
...
0x6b6: Pop(0)
0x6b7: @@ SetItemName(Stack[-7])
0x6b8: Pop(0)
0x6b9: Push("Organ")
0x6ba: Push((int) 1)
0x6bb: @@ SetProperty(Stack[-2], Stack[-1])
0x6bc: Pop(2)
0x6bd: @@ GetItemID(Stack[-2])
0x6be: Pop(0)
0x6bf: Push((int) 0)
0x6c0: Push((int) 1)
...
0x713: Pop(1)
0x714: Push("class")
0x715: @@ GetProperty(Stack[-1], Stack[-2])
0x716: Pop(1)
...
0x76b: Stack[-1] = Stack[-3]
0x76c: Call2 0x7ec

0x76d: Stack[-4] = Stack[-2]
0x76e: Pop(2)
0x76f: Return(); Pop(0)

0x770: PushEmpty()
0x771: PushEmpty(object)
0x772: Stack[-1] = Stack[-2]
...
0x799: Stack[-3] = Stack[-7]
0x79a: Stack[-2] = Stack[-6]
0x79b: Stack[-1] = Stack[-5]
0x79c: Call2 0x563
...
0x7a1: Stack[-5] = Stack[-11]
0x7a2: Stack[-4] = Stack[-10]
0x7a3: Stack[-3] = Stack[-9]
0x7a4: Stack[-2] = Stack[-7]
0x7a5: Stack[-1] = Stack[-6]
0x7a6: Call2 0x5a7
...
0x7f6: Stack[-2] = Stack[-6]
0x7f7: Stack[-1] = "health"
0x7f8: Call2 0x4c1
...
0x804: Push("class")
0x805: @@ GetProperty(Stack[-1], Stack[-2])
0x806: Pop(1)
...
0x80d: IF (Stack[-1] == 0) GOTO 0x812; Pop(1)
...
0x828: Stack[-2] = "quest_d6_02"
0x829: Stack[-1] = "gorbun_death"
0x82a: Call2 0x655
