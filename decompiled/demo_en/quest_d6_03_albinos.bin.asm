...
0x525: Pop(1); Push(Stack[-1] + Stack[-8]);
0x526: @ Trace(Stack[-1])
0x527: Pop(1)
0x528: Return(); Pop(6)
...
0x534: Pop(1); Push(Stack[-1] + Stack[-9]);
0x535: @ Trace(Stack[-1])
0x536: Pop(1)
0x537: Return(); Pop(6)
...
0x550: Pop(0)
0x551: Pop(0); Push((bool) Stack[-8] == 0)
0x552: IF (Stack[-1] == 0) GOTO 0x567; Pop(1)

0x553: Stack[-7] = (int) 0
0x554: Push((int) 1)
0x555: Pop(1); Push(Stack[-8] + Stack[-1]);
0x556: Pop(1); Push(Stack[-18] + Stack[-1]);
0x557: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x558: Pop(1)
0x559: Pop(0); Push((bool) Stack[-6] == 0)
0x55a: IF (Stack[-1] == 0) GOTO 0x55c; Pop(1)

0x55b: GOTO 0x55f

0x55c: Push((int) 1)
0x55d: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x55e: GOTO 0x554

0x55f: Pop(0); Push((bool) Stack[-7] == 0)
...
0x566: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x56e: Pop(0)
0x56f: Push((int) 50)
0x570: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x571: Push(CvectorIndex(Stack[-1], 1))
0x572: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
...
0x57e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x57f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x585: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x586: Return(); Pop(2)
...
0x599: PushEmpty()
0x59a: Pop(0); Push(Stack[-2] | Stack[-1]);
0x59b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x59c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x59d: Pop(2); Push(Stack[-2] * Stack[-1]);
0x59e: Pop(1); Push(Sqrt(Stack[-1]))
0x59f: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x5a0: Return(); Pop(0)
...
0x5c0: PushEmpty(int)
0x5c1: Push((int) 24)
0x5c2: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
...
0x5c9: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x5d8: Push((int) 1)
0x5d9: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x5da: GOTO 0x5ce
...
0x61b: Push(-1, 0); TaskCall(4)
0x61c: Call2 0x2b7

0x61d: Pop(-1, 0); TaskReturn
0x61e: Pop(1)
0x61f: Return(); Pop(0)
