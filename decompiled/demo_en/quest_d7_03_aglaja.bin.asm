...
0x380: @ StopWorld()
0x381: Pop(0)
0x382: @ CameraTransit(Stack[-3], Stack[-5])
0x383: Pop(0)
0x384: Push(CvectorIndex(Stack[-4], 0))
0x385: Push(CvectorIndex(Stack[-5], 2))
0x386: @ Rotate(Stack[-2], Stack[-1])
0x387: Pop(2)
...
0x38d: Push("head")
0x38e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x38f: Pop(1)
0x390: Push(Stack[-1])
0x391: IF (Stack[-1] == 0) GOTO 0x395; Pop(1)

0x392: Push("head")
0x393: @ LookAsyncCamera(Stack[-1])
0x394: Pop(1)
0x395: @ CameraWaitForPlayFinish()
0x396: Pop(0)
0x397: @ ResumeWorld()
0x398: Pop(0)
0x399: Stack[-21] = (bool) 1
0x39a: Return(); Pop(18)

0x39b: PushEmpty(bool, bool)
0x39c: @ CameraSwitchToNormal()
0x39d: Pop(0)
...
0x3a3: Push("head")
0x3a4: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3a5: Pop(1)
0x3a6: Push(Stack[-1])
...
0x3ac: PushEmpty(int, int, int, int)
0x3ad: Push("voice_common")
0x3ae: @ GetVariable(Stack[-1], Stack[-3])
0x3af: Pop(1)
0x3b0: Push(Stack[-2])
0x3b1: IF (Stack[-1] == 0) GOTO 0x3d2; Pop(1)

0x3b2: PushEmpty(bool, object)
0x3b3: Stack[-1] = Stack[-7]
0x3b4: Call2 0x3e6
...
0x3c6: Push((int) 1)
0x3c7: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3c8: Push((int) 3)
...
0x3e6: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3e7: Stack[-5] = "c"
0x3e8: Stack[-4] = (int) 0
0x3e9: Push((int) 1)
...
0x3eb: Push((int) 1)
0x3ec: Pop(1); Push(Stack[-5] + Stack[-1]);
0x3ed: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3ee: @@ HasProperty(Stack[-1], Stack[-4])
0x3ef: Pop(1)
0x3f0: Pop(0); Push((bool) Stack[-3] == 0)
0x3f1: IF (Stack[-1] == 0) GOTO 0x3f3; Pop(1)

0x3f2: GOTO 0x3f6

0x3f3: Push((int) 1)
0x3f4: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3f5: GOTO 0x3e9

0x3f6: Pop(0); Push((bool) Stack[-4] == 0)
0x3f7: IF (Stack[-1] == 0) GOTO 0x3fa; Pop(1)

0x3f8: Stack[-12] = (bool) 0
0x3f9: Return(); Pop(10)

0x3fa: Stack[-2] = (int) 0
0x3fb: Push((int) 1)
0x3fc: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x3fd: IF (Stack[-1] == 0) GOTO 0x400; Pop(1)

0x3fe: @ irand(Stack[-2], Stack[-4])
0x3ff: Pop(0)
0x400: Push((int) 1)
0x401: Pop(1); Push(Stack[-3] + Stack[-1]);
0x402: Pop(1); Push(Stack[-6] + Stack[-1]);
0x403: @@ GetProperty(Stack[-1], Stack[-2])
0x404: Pop(1)
0x405: PushEmpty(bool, string)
0x406: Stack[-1] = Stack[-3]
0x407: Call2 0x455

0x408: Stack[-14] = Stack[-2]
0x409: Pop(2)
0x40a: Return(); Pop(10)

0x40b: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x40c: Push("d")
0x40d: PushEmpty(int)
0x40e: Call2 0x4b8
...
0x411: Push("m")
0x412: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x413: Stack[-4] = (int) 0
0x414: Push((int) 1)
0x415: IF (Stack[-1] == 0) GOTO 0x421; Pop(1)

0x416: Push((int) 1)
0x417: Pop(1); Push(Stack[-5] + Stack[-1]);
0x418: Pop(1); Push(Stack[-6] + Stack[-1]);
0x419: @@ HasProperty(Stack[-1], Stack[-4])
0x41a: Pop(1)
...
0x41e: Push((int) 1)
0x41f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x420: GOTO 0x414

0x421: Pop(0); Push((bool) Stack[-4] == 0)
0x422: IF (Stack[-1] == 0) GOTO 0x425; Pop(1)

0x423: Stack[-12] = (bool) 0
0x424: Return(); Pop(10)

0x425: Stack[-2] = (int) 0
0x426: Push((int) 1)
0x427: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x428: IF (Stack[-1] == 0) GOTO 0x42b; Pop(1)

0x429: @ irand(Stack[-2], Stack[-4])
0x42a: Pop(0)
0x42b: Push((int) 1)
0x42c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x42d: Pop(1); Push(Stack[-6] + Stack[-1]);
0x42e: @@ GetProperty(Stack[-1], Stack[-2])
0x42f: Pop(1)
0x430: PushEmpty(bool, string)
0x431: Stack[-1] = Stack[-3]
0x432: Call2 0x455

0x433: Stack[-14] = Stack[-2]
0x434: Pop(2)
0x435: Return(); Pop(10)

0x436: PushEmpty(bool, float, float, bool, float, float)
0x437: @ lshHasAnimation(Stack[-3], Stack[-7])
0x438: Pop(0)
0x439: Push(Stack[-3])
0x43a: IF (Stack[-1] == 0) GOTO 0x441; Pop(1)

0x43b: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x43c: Pop(0)
0x43d: Push((bool) 0)
0x43e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x43f: Pop(1)
0x440: GOTO 0x445

0x441: Push("Can't find lsh animation : ")
0x442: Pop(1); Push(Stack[-1] + Stack[-8]);
0x443: @ Trace(Stack[-1])
0x444: Pop(1)
0x445: Return(); Pop(6)

0x446: PushEmpty(bool, float, float, bool, float, float)
0x447: @ lshHasAnimation(Stack[-3], Stack[-8])
0x448: Pop(0)
0x449: Push(Stack[-3])
0x44a: IF (Stack[-1] == 0) GOTO 0x450; Pop(1)

0x44b: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x44c: Pop(0)
0x44d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x44e: Pop(0)
0x44f: GOTO 0x454

0x450: Push("Can't find lsh animation : ")
0x451: Pop(1); Push(Stack[-1] + Stack[-9]);
0x452: @ Trace(Stack[-1])
0x453: Pop(1)
0x454: Return(); Pop(6)

0x455: PushEmpty(bool, bool)
...
0x45a: @ lshHasSpeech(Stack[-1], Stack[-3])
0x45b: Pop(0)
0x45c: Push(Stack[-1])
0x45d: IF (Stack[-1] == 0) GOTO 0x462; Pop(1)

0x45e: @ lshPlaySpeech(Stack[-3])
0x45f: Pop(0)
0x460: Stack[-4] = (bool) 1
0x461: Return(); Pop(2)
...
0x474: Push((float)0.0)
0x475: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x476: IF (Stack[-1] == 0) GOTO 0x479; Pop(1)

0x477: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x478: Return(); Pop(2)

0x479: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x47a: Return(); Pop(2)

0x47b: PushEmpty(int, int)
0x47c: @ GetVariable(Stack[-3], Stack[-1])
0x47d: Pop(0)
0x47e: Stack[-4] = Stack[-1]
0x47f: Return(); Pop(2)

0x480: PushEmpty(object, object)
0x481: @ CreateIntVector(Stack[-1])
0x482: Pop(0)
0x483: @@ add(Stack[-4])
0x484: Pop(0)
0x485: @@ add(Stack[-3])
0x486: Pop(0)
0x487: Push((int) 3)
0x488: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x489: Pop(1)
0x48a: Return(); Pop(2)

0x48b: Stack[-1] = 0
0x48c: PushEmpty(int, int, bool, int, int, bool)
0x48d: @@ GetItemID(Stack[-3])
0x48e: Pop(0)
0x48f: Push("Category")
0x490: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x491: Pop(1)
0x492: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x493: Pop(0)
0x494: Pop(0); Push((bool) Stack[-1] == 0)
0x495: IF (Stack[-1] == 0) GOTO 0x499; Pop(1)

0x496: @@ DropItems(Stack[-8], Stack[-7])
0x497: Pop(0)
0x498: GOTO 0x49e

0x499: PushEmpty(int, int)
0x49a: Stack[-2] = Stack[-5]
...
0x4a0: @ CreateInvItem(Stack[-1])
0x4a1: Pop(0)
0x4a2: @@ SetItemName(Stack[-4])
0x4a3: Pop(0)
0x4a4: PushEmpty(object, object, int)
0x4a5: Stack[-3] = Stack[-8]
...
0x4ad: @ FindActor(Stack[-1], Stack[-4])
0x4ae: Pop(0)
0x4af: Pop(0); Push((bool) Stack[-1] == 0)
0x4b0: IF (Stack[-1] == 0) GOTO 0x4b3; Pop(1)

0x4b1: Stack[-5] = (bool) 0
0x4b2: Return(); Pop(2)

0x4b3: @ Trigger(Stack[-1], Stack[-3])
0x4b4: Pop(0)
0x4b5: Stack[-5] = (bool) 1
0x4b6: Return(); Pop(2)

0x4b7: Stack[-1] = 0
0x4b8: PushEmpty(float, float)
0x4b9: @ GetGameTime(Stack[-1])
0x4ba: Pop(0)
0x4bb: Push((int) 1)
0x4bc: PushEmpty(int)
0x4bd: Push((int) 24)
0x4be: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x4bf: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x4c0: Return(); Pop(2)

0x4c1: PushEmpty(string, string)
0x4c2: Stack[-1] = "idle"
0x4c3: Push(Stack[-3])
0x4c4: IF (Stack[-1] == 0) GOTO 0x4c6; Pop(1)

0x4c5: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x4c6: Stack[-4] = Stack[-1]
0x4c7: Return(); Pop(2)

0x4c8: PushEmpty(int, bool, int, bool)
0x4c9: Stack[-2] = (int) 0
0x4ca: Push("all")
0x4cb: PushEmpty(string, int)
...
0x4d4: Push((int) 1)
0x4d5: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x4d6: GOTO 0x4ca

0x4d7: Stack[-5] = Stack[-2]
0x4d8: Return(); Pop(4)

0x4d9: PushEmpty()
0x4da: Push("ood7AglajaPetr1")
0x4db: Push((int) 1)
0x4dc: @ SetVariable(Stack[-2], Stack[-1])
0x4dd: Pop(2)
0x4de: Return(); Pop(0)

0x4df: PushEmpty()
0x4e0: PushEmpty(bool, string, string)
0x4e1: Stack[-2] = "quest_d7_03"
0x4e2: Stack[-1] = "remove_maria"
0x4e3: Call2 0x4ac
...
0x4e9: Pop(0)
0x4ea: PushEmpty(bool, string, string)
0x4eb: Stack[-2] = "quest_d7_03"
0x4ec: Stack[-1] = "completed"
0x4ed: Call2 0x4ac
...
0x4f0: PushEmpty()
0x4f1: Push("samopal is given")
0x4f2: @ Trace(Stack[-1])
0x4f3: Pop(1)
0x4f4: PushEmpty(object, string, int)
0x4f5: Stack[-3] = Stack[-5]
0x4f6: Stack[-2] = "Samopal"
0x4f7: Stack[-1] = (int) 1
0x4f8: Call2 0x49f
...
0x4fb: PushEmpty()
0x4fc: Push("whitevaccine is given")
0x4fd: @ Trace(Stack[-1])
0x4fe: Pop(1)
0x4ff: PushEmpty(object, string, int)
0x500: Stack[-3] = Stack[-5]
0x501: Stack[-2] = "white_vaccine"
0x502: Stack[-1] = (int) 1
0x503: Call2 0x49f
...
0x506: PushEmpty()
0x507: Push("feromicin is given")
0x508: @ Trace(Stack[-1])
0x509: Pop(1)
0x50a: PushEmpty(object, string, int)
0x50b: Stack[-3] = Stack[-5]
0x50c: Stack[-2] = "feromicin"
0x50d: Stack[-1] = (int) 1
0x50e: Call2 0x49f
...
0x511: PushEmpty()
0x512: Push("neomicin is given")
0x513: @ Trace(Stack[-1])
0x514: Pop(1)
0x515: PushEmpty(object, string, int)
0x516: Stack[-3] = Stack[-5]
0x517: Stack[-2] = "neomicin"
0x518: Stack[-1] = (int) 1
0x519: Call2 0x49f
...
0x51c: PushEmpty()
0x51d: Push("samopal ammo5 is given")
0x51e: @ Trace(Stack[-1])
0x51f: Pop(1)
0x520: PushEmpty(object, string, int)
0x521: Stack[-3] = Stack[-5]
0x522: Stack[-2] = "samopal_ammo"
0x523: Stack[-1] = (int) 5
0x524: Call2 0x49f
...
0x527: PushEmpty()
0x528: PushEmpty(int, string)
0x529: Stack[-1] = "ood7AglajaPetr1"
0x52a: Call2 0x47b

0x52b: Pop(1)
0x52c: Push((int) 0)
0x52d: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x52e: IF (Stack[-1] == 0) GOTO 0x531; Pop(1)

0x52f: Stack[-2] = (bool) 1
0x530: Return(); Pop(0)

0x531: Stack[-2] = (bool) 0
0x532: Return(); Pop(0)

0x533: PushEmpty()
0x534: PushEmpty(int, string)
0x535: Stack[-1] = "d7q03"
0x536: Call2 0x47b
...
0x53b: Stack[-2] = (bool) 1
0x53c: Return(); Pop(0)

0x53d: Stack[-2] = (bool) 0
0x53e: Return(); Pop(0)

0x53f: PushEmpty()
0x540: PushEmpty(int, string)
0x541: Stack[-1] = "d7q03"
0x542: Call2 0x47b
...
0x547: Stack[-2] = (bool) 1
0x548: Return(); Pop(0)

0x549: Stack[-2] = (bool) 0
0x54a: Return(); Pop(0)

0x54b: PushEmpty(object, object)
0x54c: Push((int) 645)
0x54d: Push((int) 2)
0x54e: Push((int) 533279)
0x54f: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x550: Pop(3)
0x551: PushEmpty(bool, object, int)
0x552: Stack[-2] = Stack[-4]
0x553: Stack[-1] = (int) 641
0x554: Call2 0x565
...
0x559: @ GetDiaryRoot(Stack[-1])
0x55a: Pop(0)
0x55b: Pop(0); Push((bool) Stack[-1] == 0)
0x55c: IF (Stack[-1] == 0) GOTO 0x562; Pop(1)

0x55d: Push("Can't retrieve diary root")
0x55e: @ Trace(Stack[-1])
0x55f: Pop(1)
0x560: Stack[-3] = (bool) 0
0x561: Return(); Pop(2)
...
0x564: Stack[-1] = 0
0x565: PushEmpty(object, object, int, object, object, int)
0x566: PushEmpty(object)
0x567: Call2 0x558

0x568: Stack[-4] = Stack[-1]
0x569: Pop(1)
0x56a: @@ Find(Stack[-7], Stack[-2])
0x56b: Pop(0)
0x56c: Pop(0); Push((bool) Stack[-2] == 0)
0x56d: IF (Stack[-1] == 0) GOTO 0x574; Pop(1)

0x56e: Push("Can't find diary parent with id: ")
0x56f: Pop(1); Push(Stack[-1] + Stack[-8]);
0x570: @ Trace(Stack[-1])
0x571: Pop(1)
0x572: Stack[-9] = (bool) 0
0x573: Return(); Pop(6)

0x574: @@ AddChild(Stack[-8])
0x575: Pop(0)
0x576: Push((int) 7)
0x577: @ SendWorldWndMessage(Stack[-1])
0x578: Pop(1)
0x579: @@ GetCategory(Stack[-1])
0x57a: Pop(0)
0x57b: @ SetDiarySection(Stack[-1])
0x57c: Pop(0)
0x57d: Stack[-9] = (bool) 0
0x57e: Return(); Pop(6)
...
0x582: Push("branch")
0x583: @ GetVariable(Stack[-1], Stack[-2])
0x584: Pop(1)
0x585: Push((int) 0)
0x586: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x587: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)
...
0x592: Stack[-1] = (int) 515527
0x593: Return(); Pop(0)

0x594: Stack[-1] = (int) 513334
0x595: Return(); Pop(0)

0x596: Stack[-1] = "ui/NPC_Aglaja.png"
0x597: Return(); Pop(0)

0x598: Stack[-1] = "ui/NPC_Aglaja_b.png"
0x599: Return(); Pop(0)
