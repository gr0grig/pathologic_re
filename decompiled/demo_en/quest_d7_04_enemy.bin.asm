...
0xcba: Pop(0)
0xcbb: Push((int) 1)
0xcbc: @@ SetProperty(Stack[-2], Stack[-1])
0xcbd: Pop(2)
...
0xcf3: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5])
0xcf4: Pop(1)
...
0xcfd: Push("Pantrol point count: ")
...
0xd13: Push("changing state to c_iStateWaitForLoad")
0xd14: @ Trace(Stack[-1])
0xd15: Pop(1)
0xd16: GOTO 0xd2e
...
0xd1a: Push("changing state to c_iStateHeatHands")
0xd1b: @ Trace(Stack[-1])
0xd1c: Pop(1)
0xd1d: GOTO 0xd2e
...
0xd21: Push("changing state to c_iStateIdle")
0xd22: @ Trace(Stack[-1])
0xd23: Pop(1)
0xd24: GOTO 0xd2e
...
0xd28: Push("changing state to c_iStatePatrol")
0xd29: @ Trace(Stack[-1])
0xd2a: Pop(1)
0xd2b: GOTO 0xd2e
...
0xd3d: Push("changing state to c_iStateAware")
0xd3e: @ Trace(Stack[-1])
0xd3f: Pop(1)
...
0xd4f: Push("changing state to c_iStateSearchEnemy")
0xd50: @ Trace(Stack[-1])
0xd51: Pop(1)
...
0xd61: Push("changing state to c_iStateHearEnemy")
0xd62: @ Trace(Stack[-1])
0xd63: Pop(1)
0xd64: Push(GlobalVars[6])
0xd65: Stack[-1] = Stack[-2]
...
0xd73: Push("changing state to c_iStateAttack")
0xd74: @ Trace(Stack[-1])
0xd75: Pop(1)
0xd76: Push(GlobalVars[7])
0xd77: Stack[-1] = Stack[-2]
...
0xdba: Stack[-3] = Stack[-7]
0xdbb: Stack[-2] = Stack[-6]
0xdbc: Stack[-1] = Stack[-5]
0xdbd: Call2 0xb52
...
0xdc2: Stack[-5] = Stack[-11]
0xdc3: Stack[-4] = Stack[-10]
0xdc4: Stack[-3] = Stack[-9]
0xdc5: Stack[-2] = Stack[-7]
0xdc6: Stack[-1] = Stack[-6]
0xdc7: Call2 0xb96
...
0xddf: Stack[-1] = "pt_d7q04_patrol"
0xde0: Return(); Pop(0)

0xde1: Stack[-1] = "d7q04_helpme"
0xde2: Return(); Pop(0)

0xde3: Stack[-1] = "d7q04_corpse"
0xde4: Return(); Pop(0)

0xde5: Stack[-1] = "pt_d7q04_bonfire"
0xde6: Return(); Pop(0)
