...
Events:
EVENT_22 Op = 0x96b Vars = (object, int, float, float)
EVENT_43 Op = 0x973 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x97d Vars = (object, string)
EVENT_41 Op = 0x98a Vars = (object)
EVENT_6 Op = 0x995 Vars = ()
...
0x80b: PushEmpty(bool, float, float, bool, float, float)
0x80c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x80d: Pop(0)
0x80e: Push(Stack[-3])
0x80f: IF (Stack[-1] == 0) GOTO 0x816; Pop(1)

0x810: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x811: Pop(0)
0x812: Push((bool) 0)
0x813: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x814: Pop(1)
0x815: GOTO 0x81a

0x816: Push("Can't find lsh animation : ")
0x817: Pop(1); Push(Stack[-1] + Stack[-8]);
0x818: @ Trace(Stack[-1])
0x819: Pop(1)
0x81a: Return(); Pop(6)

0x81b: PushEmpty(bool, float, float, bool, float, float)
0x81c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x81d: Pop(0)
0x81e: Push(Stack[-3])
0x81f: IF (Stack[-1] == 0) GOTO 0x825; Pop(1)

0x820: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x821: Pop(0)
0x822: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x823: Pop(0)
0x824: GOTO 0x829

0x825: Push("Can't find lsh animation : ")
0x826: Pop(1); Push(Stack[-1] + Stack[-9]);
0x827: @ Trace(Stack[-1])
0x828: Pop(1)
0x829: Return(); Pop(6)

0x82a: PushEmpty(float, cvector, float, cvector)
0x82b: @@ GetEyesHeight(Stack[-2])
0x82c: Pop(0)
0x82d: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x82e: Push(CvectorIndex(Stack[-1], 1))
0x82f: Stack[-1] = Stack[-3]
0x830: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x831: Push("head")
0x832: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x833: Pop(1)
0x834: Return(); Pop(4)
...
0x83c: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x83d: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x83e: Pop(0)
0x83f: Pop(0); Push((bool) Stack[-8] == 0)
0x840: IF (Stack[-1] == 0) GOTO 0x855; Pop(1)

0x841: Stack[-7] = (int) 0
0x842: Push((int) 1)
0x843: Pop(1); Push(Stack[-8] + Stack[-1]);
0x844: Pop(1); Push(Stack[-18] + Stack[-1]);
0x845: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x846: Pop(1)
0x847: Pop(0); Push((bool) Stack[-6] == 0)
0x848: IF (Stack[-1] == 0) GOTO 0x84a; Pop(1)

0x849: GOTO 0x84d

0x84a: Push((int) 1)
0x84b: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x84c: GOTO 0x842

0x84d: Pop(0); Push((bool) Stack[-7] == 0)
0x84e: IF (Stack[-1] == 0) GOTO 0x850; Pop(1)

0x84f: Return(); Pop(16)

0x850: @ irand(Stack[-5], Stack[-7])
0x851: Pop(0)
0x852: Push((int) 1)
0x853: Pop(1); Push(Stack[-6] + Stack[-1]);
0x854: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x855: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x856: Pop(0)
0x857: Push(Stack[-4])
0x858: IF (Stack[-1] == 0) GOTO 0x864; Pop(1)

0x859: @ GetEyesHeight(Stack[-3])
0x85a: Pop(0)
0x85b: @ GetDirection(Stack[-2])
0x85c: Pop(0)
0x85d: Push((int) 50)
0x85e: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x85f: Push(CvectorIndex(Stack[-1], 1))
0x860: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x861: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x862: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x863: Pop(0)
0x864: Return(); Pop(16)
...
0x86a: Stack[-1] = 0
0x86b: PushEmpty(float, float)
0x86c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x86d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x86e: Push((float)0.0)
0x86f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x870: IF (Stack[-1] == 0) GOTO 0x873; Pop(1)

0x871: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x872: Return(); Pop(2)

0x873: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x874: Return(); Pop(2)

0x875: PushEmpty()
0x876: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x877: IF (Stack[-1] == 0) GOTO 0x87a; Pop(1)

0x878: Stack[-3] = Stack[-2]
0x879: GOTO 0x87b
...
0x87c: PushEmpty()
0x87d: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x87e: IF (Stack[-1] == 0) GOTO 0x881; Pop(1)

0x87f: Stack[-4] = Stack[-2]
0x880: Return(); Pop(0)

0x881: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x882: IF (Stack[-1] == 0) GOTO 0x885; Pop(1)

0x883: Stack[-4] = Stack[-1]
0x884: Return(); Pop(0)

0x885: Stack[-4] = Stack[-3]
0x886: Return(); Pop(0)
...
0x88d: @ CreateFloatVector(Stack[-1])
0x88e: Pop(0)
0x88f: @@ add(Stack[-3])
0x890: Pop(0)
0x891: Push((int) 15)
0x892: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x893: Pop(1)
0x894: Return(); Pop(2)

0x895: Stack[-1] = 0
0x896: PushEmpty(object, object)
0x897: @ FindActor(Stack[-1], Stack[-4])
0x898: Pop(0)
0x899: Pop(0); Push((bool) Stack[-1] == 0)
0x89a: IF (Stack[-1] == 0) GOTO 0x89d; Pop(1)

0x89b: Stack[-5] = (bool) 0
0x89c: Return(); Pop(2)

0x89d: @ Trigger(Stack[-1], Stack[-3])
0x89e: Pop(0)
0x89f: Stack[-5] = (bool) 1
0x8a0: Return(); Pop(2)

0x8a1: Stack[-1] = 0
0x8a2: PushEmpty(bool, bool)
0x8a3: @ IsPlayerActor(Stack[-3], Stack[-1])
0x8a4: Pop(0)
0x8a5: Push(Stack[-1])
0x8a6: IF (Stack[-1] == 0) GOTO 0x8aa; Pop(1)

0x8a7: Push("attack")
0x8a8: @ PlayGlobalMusic(Stack[-1])
0x8a9: Pop(1)
0x8aa: Return(); Pop(2)

0x8ab: PushEmpty(object, object)
0x8ac: @ GetScene(Stack[-1])
0x8ad: Pop(0)
0x8ae: Push("battle")
...
0x8b1: Pop(0)
0x8b2: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x8b3: Pop(2)
0x8b4: Return(); Pop(2)
...
0x8cc: Stack[-5] = Stack[-2]
0x8cd: Return(); Pop(4)

0x8ce: PushEmpty()
0x8cf: Push((int) 1)
0x8d0: @@ SetReturnValue(Stack[-1])
0x8d1: Pop(1)
0x8d2: Return(); Pop(0)
...
0x8d4: Push("d8q04")
0x8d5: Push((int) 2)
0x8d6: @ SetVariable(Stack[-2], Stack[-1])
0x8d7: Pop(2)
0x8d8: PushEmpty()
0x8d9: Call2 0x8ff
...
0x8ee: Stack[-2] = (bool) 1
0x8ef: Return(); Pop(0)

0x8f0: Stack[-2] = (bool) 0
0x8f1: Return(); Pop(0)

0x8f2: PushEmpty(object, object)
0x8f3: Push((int) 654)
0x8f4: Push((int) 2)
0x8f5: Push((int) 533367)
0x8f6: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8f7: Pop(3)
0x8f8: PushEmpty(bool, object, int)
0x8f9: Stack[-2] = Stack[-4]
0x8fa: Stack[-1] = (int) 649
0x8fb: Call2 0x919
...
0x900: Push((int) 651)
0x901: Push((int) 2)
0x902: Push((int) 533364)
0x903: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x904: Pop(3)
0x905: PushEmpty(bool, object, int)
0x906: Stack[-2] = Stack[-4]
0x907: Stack[-1] = (int) 649
0x908: Call2 0x919
...
0x90d: @ GetDiaryRoot(Stack[-1])
0x90e: Pop(0)
0x90f: Pop(0); Push((bool) Stack[-1] == 0)
0x910: IF (Stack[-1] == 0) GOTO 0x916; Pop(1)

0x911: Push("Can't retrieve diary root")
0x912: @ Trace(Stack[-1])
0x913: Pop(1)
0x914: Stack[-3] = (bool) 0
0x915: Return(); Pop(2)
...
0x918: Stack[-1] = 0
0x919: PushEmpty(object, object, int, object, object, int)
0x91a: PushEmpty(object)
0x91b: Call2 0x90c

0x91c: Stack[-4] = Stack[-1]
0x91d: Pop(1)
0x91e: @@ Find(Stack[-7], Stack[-2])
0x91f: Pop(0)
0x920: Pop(0); Push((bool) Stack[-2] == 0)
0x921: IF (Stack[-1] == 0) GOTO 0x928; Pop(1)

0x922: Push("Can't find diary parent with id: ")
0x923: Pop(1); Push(Stack[-1] + Stack[-8]);
0x924: @ Trace(Stack[-1])
0x925: Pop(1)
0x926: Stack[-9] = (bool) 0
0x927: Return(); Pop(6)

0x928: @@ AddChild(Stack[-8])
0x929: Pop(0)
0x92a: Push((int) 7)
0x92b: @ SendWorldWndMessage(Stack[-1])
0x92c: Pop(1)
0x92d: @@ GetCategory(Stack[-1])
0x92e: Pop(0)
0x92f: @ SetDiarySection(Stack[-1])
0x930: Pop(0)
0x931: Stack[-9] = (bool) 0
0x932: Return(); Pop(6)

0x933: Stack[-2] = 0
0x934: Stack[-3] = 0
0x935: PushEmpty(int, int)
0x936: Push("branch")
0x937: @ GetVariable(Stack[-1], Stack[-2])
0x938: Pop(1)
0x939: Push((int) 0)
...
0x947: Push("branch")
0x948: @ GetVariable(Stack[-1], Stack[-2])
0x949: Pop(1)
...
0x94f: Pop(0)
0x950: Push((int) 1)
0x951: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x952: IF (Stack[-1] == 0) GOTO 0x956; Pop(1)

0x953: @ WorkWithCorpse(Stack[-1])
0x954: Pop(0)
0x955: GOTO 0x958

0x956: @ Barter(Stack[-1])
0x957: Pop(0)
0x958: Return(); Pop(0)

0x959: Stack[-1] = (int) 521048
0x95a: Return(); Pop(0)

0x95b: Stack[-1] = (int) 521047
0x95c: Return(); Pop(0)
...
0x965: Stack[-1] = Stack[-2]
0x966: Push(-1, 0); TaskCall(5)
0x967: Call2 0x5dd

0x968: Pop(-1, 0); TaskReturn
0x969: Pop(1)
0x96a: Return(); Pop(0)

0x96b: PushEmpty()
0x96c: PushEmpty(object, int, float)
0x96d: Stack[-3] = Stack[-7]
0x96e: Stack[-2] = Stack[-6]
0x96f: Stack[-1] = Stack[-5]
0x970: Call2 0x754
...
0x973: PushEmpty()
0x974: PushEmpty(object, int, float, cvector, cvector)
0x975: Stack[-5] = Stack[-11]
0x976: Stack[-4] = Stack[-10]
0x977: Stack[-3] = Stack[-9]
0x978: Stack[-2] = Stack[-7]
0x979: Stack[-1] = Stack[-6]
0x97a: Call2 0x798

0x97b: Pop(5)
0x97c: Return(); Pop(0)

0x97d: PushEmpty(float, float)
0x97e: Push("health")
0x97f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x980: IF (Stack[-1] == 0) GOTO 0x989; Pop(1)

0x981: Push("health")
0x982: @ GetProperty(Stack[-1], Stack[-2])
0x983: Pop(1)
0x984: Push((int) 0)
0x985: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x986: IF (Stack[-1] == 0) GOTO 0x989; Pop(1)

0x987: @ SignalDeath(Stack[-4])
0x988: Pop(0)
0x989: Return(); Pop(2)

0x98a: PushEmpty()
0x98b: PushEmpty(bool, string, string)
0x98c: Stack[-2] = "quest_d8_04"
0x98d: Stack[-1] = "death"
0x98e: Call2 0x896
