...
Label_184:
	...
	func_1763(var_147_bool, var_148_object, var_149_object); // 0xc2 NEW_2
...
Label_207:
	...
	func_1763(var_147_bool, var_148_object, var_149_object); // 0xd9 NEW_2
...
{
	var_14_bool = 0; var_15_float = 0; var_16_float = 0; var_17_string = ""; var_18_float = 0; var_19_bool = 0; var_20_float = 0; var_21_float = 0; var_22_string = ""; var_23_float = 0; // 0x58a PushV
	var_24_bool = 0; var_25_object = Obj(); // 0x58b PushV
	var_25_object = var_13_object; // 0x58c Mov
	func_634(var_24_bool, var_25_object); // 0x58d NEW_2
	var_58_bool = var_24_bool == 0; // 0x58f Not
	if(var_58_bool == 0) goto Label_1427; // 0x590 JumpB
	var_12_bool = 0; // 0x591 MovB
	return 10; // 0x592 Return
	
Label_1427:
	var_59_object = GlobalVars[4]; // 0x593 PushGE
	in(var_19_bool, var_13_object); // 0x594 ObjFunc
	var_60_bool = var_19_bool; // 0x596 Push
	if(var_60_bool == 0) goto Label_1434; // 0x597 JumpB
	var_12_bool = 1; // 0x598 MovB
	return 10; // 0x599 Return
	
Label_1434:
	var_61_bool = 0; var_62_object = Obj(); // 0x59a PushV
	var_62_object = var_13_object; // 0x59b Mov
	func_503(var_61_bool, var_62_object); // 0x59c NEW_2
	if(var_61_bool == 0) goto Label_1453; // 0x59e JumpB
	var_65_string = "reputation"; // 0x59f PushS
	GetProperty(var_65_string, var_20_float); // 0x5a0 ObjFunc
	var_66_float = 0.33; // 0x5a2 PushF
	var_67_bool = var_20_float < var_66_float; // 0x5a3 LT
	if(var_67_bool == 0) goto Label_1447; // 0x5a4 JumpB
	var_12_bool = 1; // 0x5a5 MovB
	return 10; // 0x5a6 Return
	
Label_1447:
	var_68_string = "disease"; // 0x5a7 PushS
	GetProperty(var_68_string, var_21_float); // 0x5a8 ObjFunc
	var_69_float = 0.33; // 0x5aa PushF
	var_12_bool = var_21_float > var_69_float; // 0x5ab GT2
	return 10; // 0x5ac Return
	
Label_1453:
	var_70_bool = 0; var_71_object = Obj(); var_72_string = ""; // 0x5ad PushV
	var_71_object = var_13_object; // 0x5ae Mov
	var_72_string = "class"; // 0x5af MovS
	func_508(var_70_bool, var_71_object, var_72_string); // 0x5b0 NEW_2
	var_73_bool = var_70_bool == 0; // 0x5b2 Not
	if(var_73_bool == 0) goto Label_1462; // 0x5b3 JumpB
	var_12_bool = 0; // 0x5b4 MovB
	return 10; // 0x5b5 Return
	
Label_1462:
	var_74_string = "class"; // 0x5b6 PushS
	GetProperty(var_74_string, var_22_string); // 0x5b7 ObjFunc
	var_75_bool = 0; // 0x5b9 PushV
	var_75_bool = 1; // 0x5ba MovB
	var_76_bool = 0; // 0x5bb PushV
	var_76_bool = 1; // 0x5bc MovB
	var_77_bool = 0; // 0x5bd PushV
	var_77_bool = 1; // 0x5be MovB
	var_78_string = "bomber"; // 0x5bf PushS
	var_79_bool = var_22_string == var_78_string; // 0x5c0 Eq
	if(var_79_bool == 0) goto Label_1478; // 0x5c1 JumpB
	var_80_string = "hunter"; // 0x5c2 PushS
	var_81_bool = var_22_string == var_80_string; // 0x5c3 Eq
	if(var_81_bool == 0) goto Label_1478; // 0x5c4 JumpB
	var_77_bool = 0; // 0x5c5 MovB
	
Label_1478:
	if(var_77_bool == 0) goto Label_1483; // 0x5c6 JumpB
	var_82_string = "grabitel"; // 0x5c7 PushS
	var_83_bool = var_22_string == var_82_string; // 0x5c8 Eq
	if(var_83_bool == 0) goto Label_1483; // 0x5c9 JumpB
	var_76_bool = 0; // 0x5ca MovB
	
Label_1483:
	if(var_76_bool == 0) goto Label_1488; // 0x5cb JumpB
	var_84_string = "rat_big"; // 0x5cc PushS
	var_85_bool = var_22_string == var_84_string; // 0x5cd Eq
	if(var_85_bool == 0) goto Label_1488; // 0x5ce JumpB
	var_75_bool = 0; // 0x5cf MovB
	
Label_1488:
	if(var_75_bool == 0) goto Label_1491; // 0x5d0 JumpB
	var_12_bool = 1; // 0x5d1 MovB
	return 10; // 0x5d2 Return
	
Label_1491:
	var_86_bool = 0; var_87_object = Obj(); var_88_string = ""; // 0x5d3 PushV
	var_87_object = var_13_object; // 0x5d4 Mov
	var_88_string = "disease"; // 0x5d5 MovS
	func_508(var_86_bool, var_87_object, var_88_string); // 0x5d6 NEW_2
	var_89_bool = var_86_bool == 0; // 0x5d8 Not
	if(var_89_bool == 0) goto Label_1500; // 0x5d9 JumpB
	var_12_bool = 0; // 0x5da MovB
	return 10; // 0x5db Return
	
Label_1500:
	var_90_bool = 0; // 0x5dc PushV
	var_90_bool = 1; // 0x5dd MovB
	var_91_bool = 0; var_92_string = ""; // 0x5de PushV
	var_92_string = var_22_string; // 0x5df Mov
	func_840(var_91_bool, var_92_string); // 0x5e0 NEW_2
	if(var_91_bool == 0) goto Label_1511; // 0x5e2 JumpB
	var_130_string = "dog"; // 0x5e3 PushS
	var_131_bool = var_22_string == var_130_string; // 0x5e4 Eq
	if(var_131_bool == 0) goto Label_1511; // 0x5e5 JumpB
	var_90_bool = 0; // 0x5e6 MovB
	
Label_1511:
	if(var_90_bool == 0) goto Label_1518; // 0x5e7 JumpB
	var_132_string = "disease"; // 0x5e8 PushS
	GetProperty(var_132_string, var_23_float); // 0x5e9 ObjFunc
	var_133_int = 0; // 0x5eb PushI
	var_12_bool = var_23_float > var_133_int; // 0x5ec GT2
	return 10; // 0x5ed Return
	
Label_1518:
	var_12_bool = 0; // 0x5ee MovB
...
func_1735(var_5_bool, var_6_object)
{
	...
	var_134_bool = 0; var_135_object = Obj(); // 0x6ce PushV
	var_135_object = var_6_object; // 0x6cf Mov
	func_1722(var_134_bool, var_135_object); // 0x6d0 NEW_2
	if(var_134_bool == 0) goto Label_1748; // 0x6d2 JumpB
...
func_1749(var_5_bool, var_6_object)
{
	...
	var_134_bool = 0; var_135_object = Obj(); // 0x6dc PushV
	var_135_object = var_6_object; // 0x6dd Mov
	func_1722(var_134_bool, var_135_object); // 0x6de NEW_2
	if(var_134_bool == 0) goto Label_1762; // 0x6e0 JumpB
...
{
	var_300_cvector = CVector(0,0,0); var_301_float = 0; var_302_cvector = CVector(0,0,0); var_303_float = 0; var_304_bool = 0; var_305_cvector = CVector(0,0,0); var_306_float = 0; var_307_cvector = CVector(0,0,0); var_308_float = 0; var_309_bool = 0; // 0x558 PushV
	GetPosition(var_305_cvector); // 0x559 Func
	GetHeight(var_306_float); // 0x55b Func
	var_310_float = GetByIndex(var_305_cvector, 1); // 0x55d PushE
	var_311_int = 2; // 0x55e PushI
	var_312_float = var_306_float / var_311_int; // 0x55f Div
	var_310_float = var_310_float + var_312_float; // 0x560 Add2
	SetByIndex(var_305_cvector, 1) = var_310_float; // 0x561 PopE
	var_307_cvector = var_299_cvector - var_305_cvector; // 0x562 Sub2
	var_313_int = var_307_cvector | var_307_cvector; // 0x563 Or
	var_308_float = sqrt(var_313_int); // 0x564 Sqrt2
	var_314_int = 50; // 0x565 PushI
	var_315_bool = var_308_float < var_314_int; // 0x566 LT
	if(var_315_bool == 0) goto Label_1386; // 0x567 JumpB
	var_309_bool = 0; // 0x568 MovB
	goto Label_1390; // 0x569 Jump
	
Label_1390:
	var_316_string = "all"; // 0x56e PushS
	var_317_bool = var_309_bool; // 0x56f Push
	if(var_317_bool == 0) goto Label_1395; // 0x570 JumpB
	var_318_string = "cattack"; // 0x571 PushS
	goto Label_1396; // 0x572 Jump
	
Label_1396:
	PlayAnimation(var_316_string, var_318_string); // 0x574 Func
	return 10; // 0x576 Return
	
Label_1395:
	var_319_string = "attack"; // 0x573 PushS
	
Label_1386:
	var_320_float = GetByIndex(var_307_cvector, 1); // 0x56a PushE
	var_321_float = var_320_float / var_308_float; // 0x56b Div
	var_322_float = -0.14286; // 0x56c PushF
	var_309_bool = var_321_float < var_322_float; // 0x56d LT2
}
...
func_1763(var_147_bool, var_148_object, var_149_object)
{
	var_150_bool = var_149_object == 0; // 0x6e4 NullEq
	if(var_150_bool == 0) goto Label_1768; // 0x6e5 JumpB
	var_147_bool = 0; // 0x6e6 MovB
	return 0; // 0x6e7 Return
	
Label_1768:
	var_147_bool = 1; // 0x6e8 MovB
	var_151_bool = 0; var_152_object = Obj(); // 0x6e9 PushV
	var_152_object = var_148_object; // 0x6ea Mov
	func_1789(var_151_bool, var_152_object); // 0x6eb NEW_2
	var_153_bool = var_151_bool == 0; // 0x6ed Not
	if(var_153_bool == 0) goto Label_1788; // 0x6ee JumpB
	var_154_float = 0; var_155_object = Obj(); // 0x6ef PushV
	var_155_object = var_149_object; // 0x6f0 Mov
	func_495(var_155_object); // 0x6f1 NEW_2
	var_156_float = 0; var_157_object = Obj(); // 0x6f3 PushV
	var_157_object = var_148_object; // 0x6f4 Mov
	func_495(var_157_object); // 0x6f5 NEW_2
	var_158_int = 25; // 0x6f7 PushI
	var_159_int = var_156_float - var_158_int; // 0x6f8 Sub
	var_160_bool = var_154_float < var_159_int; // 0x6f9 LT
	if(var_160_bool == 0) goto Label_1788; // 0x6fa JumpB
	var_147_bool = 0; // 0x6fb MovB
...
Label_134:
	...
	func_1722(var_275_bool, var_276_object); // 0x91 NEW_2
...
Label_161:
	...
	func_1312(var_284_bool); // 0xa7 NEW_2
	StopAsync(); // 0xa9 Func
...
Label_154:
	...
	func_1399(var_288_object); // 0x9c NEW_2
...
{
	var_9_bool = 0; var_10_bool = 0; // 0x6fd PushV
	IsPlayerActor(var_8_object, var_10_bool); // 0x6fe Func
	var_7_bool = 1; // 0x700 MovB
	var_11_bool = var_10_bool; // 0x701 Push
	if(var_11_bool == 0) goto Label_1801; // 0x702 JumpB
	var_12_bool = 0; var_13_object = Obj(); // 0x703 PushV
	var_13_object = var_8_object; // 0x704 Mov
	func_1418(var_12_bool, var_13_object); // 0x705 NEW_2
	if(var_12_bool == 0) goto Label_1801; // 0x707 JumpB
	var_7_bool = 0; // 0x708 MovB
...
func_1399(var_288_object)
{
	var_289_cvector = CVector(0,0,0); var_290_float = 0; var_291_cvector = CVector(0,0,0); var_292_float = 0; // 0x577 PushV
	GetPosition(var_291_cvector); // 0x578 ObjFunc
	var_293_string = "@GetHeight"; // 0x57a PushS
	var_294_int = 1; // 0x57b PushI
	var_295_bool = IsFuncExist(var_288_object, var_293_string, var_294_int); // 0x57c FuncExist
	if(var_295_bool == 0) goto Label_1413; // 0x57d JumpB
	GetHeight(var_292_float); // 0x57e ObjFunc
	var_296_float = GetByIndex(var_291_cvector, 1); // 0x580 PushE
	var_297_int = 2; // 0x581 PushI
	var_298_float = var_292_float / var_297_int; // 0x582 Div
	var_296_float = var_296_float + var_298_float; // 0x583 Add2
	SetByIndex(var_291_cvector, 1) = var_296_float; // 0x584 PopE
	
Label_1413:
	var_299_cvector = CVector(0,0,0); // 0x585 PushV
	var_299_cvector = var_291_cvector; // 0x586 Mov
	func_1368(var_299_cvector); // 0x587 NEW_2
