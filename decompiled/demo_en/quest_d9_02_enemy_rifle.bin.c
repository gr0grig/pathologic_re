...
Label_3137:
	...
	func_3161(var_63_float); // 0xc43 NEW_2
...
func_3635()
{
	var_47_bool = 0; var_48_bool = 0; // 0xe33 PushV
	var_49_string = "Rifle"; // 0xe34 PushS
	var_50_int = 0; // 0xe35 PushI
	var_51_int = 1; // 0xe36 PushI
	AddItem(var_48_bool, var_49_string, var_50_int, var_51_int); // 0xe37 Func
	var_52_bool = 0; var_53_object = Obj(); var_54_float = 0; // 0xe39 PushV
	var_55_object = Obj(); // 0xe3a PushV
	func_2699(var_55_object); // 0xe3b NEW_2
	var_53_object = var_55_object; // 0xe3c Mov
	var_54_float = -0.03; // 0xe3e MovF
	func_3116(var_52_bool, var_53_object, var_54_float); // 0xe3f NEW_2
...
func_3161(var_63_float)
{
	var_64_object = Obj(); var_65_object = Obj(); // 0xc59 PushV
	CreateFloatVector(var_65_object); // 0xc5a Func
	add(var_63_float); // 0xc5c ObjFunc
	var_66_int = 16; // 0xc5e PushI
	SendWorldWndMessage(var_66_int, var_65_object); // 0xc5f Func
