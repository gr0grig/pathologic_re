...
Label_178:
	...
	func_689(var_45_object); // 0xc0 NEW_2
...
Label_275:
	...
	func_656(var_88_bool); // 0x115 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	func_603(var_27_object); // 0x16b NEW_2
...
Label_56:
	var_145_bool = var_24_bool == 0; // 0x38 Not
...
Label_63:
	...
	var_146_object = var_15_object; // 0x40 Mov
	func_555(); // 0x41 NEW_2
...
func_636(var_18_bool, var_19_string, var_20_string)
{
	var_21_object = Obj(); var_22_object = Obj(); // 0x27c PushV
	FindActor(var_22_object, var_19_string); // 0x27d Func
	var_23_bool = var_22_object == 0; // 0x27f NullEq
	if(var_23_bool == 0) goto Label_643; // 0x280 JumpB
	var_18_bool = 0; // 0x281 MovB
	return 2; // 0x282 Return
	
Label_643:
	Trigger(var_22_object, var_20_string); // 0x283 Func
...
Label_397:
	...
	func_665(var_35_int); // 0x18e NEW_2
...
Label_412:
	...
	func_658(var_57_string, var_58_int); // 0x1aa NEW_2
...
Label_121:
	...
	func_572(var_129_string); // 0x7b NEW_2
...
func_652(var_74_string)
{
	var_74_string = "ui/NPC_Prophet.png"; // 0x28c MovS
	return 0; // 0x28d Return
}


func_588(var_96_string, var_97_bool)
{
	var_100_bool = 0; var_101_float = 0; var_102_float = 0; var_103_bool = 0; var_104_float = 0; var_105_float = 0; // 0x24c PushV
	lshHasAnimation(var_103_bool, var_96_string); // 0x24d Func
	var_106_bool = var_103_bool; // 0x24f Push
	if(var_106_bool == 0) goto Label_598; // 0x250 JumpB
	lshGetAnimTimes(var_96_string, var_104_float, var_105_float); // 0x251 Func
	lshPlayAnimation(var_104_float, var_105_float, var_97_bool); // 0x253 Func
...
Label_598:
	var_107_string = "Can't find lsh animation : "; // 0x256 PushS
	var_108_int = var_107_string + var_96_string; // 0x257 Add
	Trace(var_108_int); // 0x258 Func
}


func_654(var_75_string)
{
	var_75_string = "ui/NPC_Prophet_b.png"; // 0x28e MovS
...
func_142(var_2_object, var_92_string)
{
	...
	func_656(var_93_bool); // 0x90 NEW_2
...
Label_160:
	func_588(var_96_string, var_97_bool); // 0xa0 NEW_2
...
func_656(var_67_bool)
{
	var_67_bool = 0; // 0x290 MovB
...
func_658(var_41_string, var_42_int)
{
	var_43_string = ""; var_44_string = ""; // 0x292 PushV
	var_44_string = "idle"; // 0x293 MovS
	var_45_int = var_42_int; // 0x294 Push
	if(var_45_int == 0) goto Label_663; // 0x295 JumpB
	var_44_string = var_44_string + var_42_int; // 0x296 Add2
	
Label_663:
	var_41_string = var_44_string; // 0x297 Mov
...
func_665(var_35_int)
{
	var_36_int = 0; var_37_bool = 0; var_38_int = 0; var_39_bool = 0; // 0x299 PushV
	var_38_int = 0; // 0x29a MovI
	
Label_667:
	var_40_string = "all"; // 0x29b PushS
	var_41_string = ""; var_42_int = 0; // 0x29c PushV
	var_42_int = var_38_int; // 0x29d Mov
	func_658(var_41_string, var_42_int); // 0x29e NEW_2
	HasAnimation(var_39_bool, var_40_string, var_41_string); // 0x2a0 Func
	var_46_bool = var_39_bool == 0; // 0x2a2 Not
	if(var_46_bool == 0) goto Label_677; // 0x2a3 JumpB
	goto Label_680; // 0x2a4 Jump
	
Label_680:
	var_35_int = var_38_int; // 0x2a8 Mov
	return 4; // 0x2a9 Return
	
Label_677:
	var_47_int = 1; // 0x2a5 PushI
	var_38_int = var_38_int + var_47_int; // 0x2a6 Add2
...
func_603(var_27_object)
{
	var_28_float = 0; var_29_cvector = CVector(0,0,0); var_30_float = 0; var_31_cvector = CVector(0,0,0); // 0x25b PushV
	GetEyesHeight(var_30_float); // 0x25c ObjFunc
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x25e MovV
	var_32_float = GetByIndex(var_31_cvector, 1); // 0x25f PushE
	var_32_float = var_30_float; // 0x260 Mov
	SetByIndex(var_31_cvector, 1) = var_32_float; // 0x261 PopE
	var_33_string = "head"; // 0x262 PushS
	LookAsync(var_27_object, var_33_string, var_31_cvector); // 0x263 Func
...
func_614()
{
	var_13_bool = 0; // 0x266 PushV
	func_656(var_13_bool); // 0x267 NEW_2
	if(var_13_bool == 0) goto Label_620; // 0x269 JumpB
...
func_487(var_25_bool, var_27_float)
{
	...
	func_621(var_52_cvector, var_53_cvector); // 0x202 NEW_2
...
Label_528:
	...
	CameraTransit(var_43_cvector, var_41_cvector); // 0x212 Func
	var_65_float = GetByIndex(var_42_cvector, 0); // 0x214 PushE
	var_66_float = GetByIndex(var_42_cvector, 2); // 0x215 PushE
	Rotate(var_65_float, var_66_float); // 0x216 Func
	var_67_bool = 0; // 0x218 PushV
	func_656(var_67_bool); // 0x219 NEW_2
	if(var_67_bool == 0) goto Label_541; // 0x21b JumpB
	goto Label_549; // 0x21c Jump
	
Label_549:
	CameraWaitForPlayFinish(); // 0x225 Func
	ResumeWorld(); // 0x227 Func
	var_25_bool = 1; // 0x229 MovB
	return 18; // 0x22a Return
	
Label_541:
	var_68_string = "head"; // 0x21d PushS
	HasAnimationTrack(var_45_bool, var_68_string); // 0x21e Func
	var_69_bool = var_45_bool; // 0x220 Push
	if(var_69_bool == 0) goto Label_549; // 0x221 JumpB
	var_70_string = "head"; // 0x222 PushS
	LookAsyncCamera(var_70_string); // 0x223 Func
}


func_682()
{
	var_18_bool = 0; var_19_string = ""; var_20_string = ""; // 0x2ab PushV
	var_19_string = "quest_k10_01"; // 0x2ac MovS
	var_20_string = "teleport"; // 0x2ad MovS
	func_636(var_18_bool, var_19_string, var_20_string); // 0x2ae NEW_2
...
func_555()
{
	var_147_bool = 0; var_148_bool = 0; // 0x22b PushV
	CameraSwitchToNormal(); // 0x22c Func
	var_149_bool = 0; // 0x22e PushV
	func_656(var_149_bool); // 0x22f NEW_2
	if(var_149_bool == 0) goto Label_563; // 0x231 JumpB
...
Label_563:
	var_150_string = "head"; // 0x233 PushS
	HasAnimationTrack(var_148_bool, var_150_string); // 0x234 Func
	var_151_bool = var_148_bool; // 0x236 Push
	if(var_151_bool == 0) goto Label_571; // 0x237 JumpB
	var_152_string = "head"; // 0x238 PushS
	UnlookAsync(var_152_string); // 0x239 Func
}


func_621(var_52_cvector, var_53_cvector)
{
	var_55_float = 0; var_56_float = 0; // 0x26d PushV
	var_57_int = var_53_cvector | var_53_cvector; // 0x26e Or
	var_56_float = sqrt(var_57_int); // 0x26f Sqrt2
	var_58_float = 0.0; // 0x270 PushF
	var_59_bool = var_56_float < var_58_float; // 0x271 LT
	if(var_59_bool == 0) goto Label_629; // 0x272 JumpB
	var_52_cvector = CVector(0.0, 0.0, 0.0); // 0x273 MovV
	return 2; // 0x274 Return
	
Label_629:
	var_52_cvector = var_53_cvector / var_53_cvector; // 0x275 Div2
...
func_689(var_110_bool)
{
	...
	var_113_string = "k10q01"; // 0x2b3 MovS
	func_631(var_112_int, var_113_string); // 0x2b4 NEW_2
	var_116_int = 7; // 0x2b6 PushI
...
func_631(var_112_int, var_113_string)
{
	var_114_int = 0; var_115_int = 0; // 0x277 PushV
	GetVariable(var_113_string, var_115_int); // 0x278 Func
	var_112_int = var_115_int; // 0x27a Mov
	return 2; // 0x27b Return
}


func_572(var_129_string)
{
	var_130_bool = 0; var_131_float = 0; var_132_float = 0; var_133_bool = 0; var_134_float = 0; var_135_float = 0; // 0x23c PushV
	lshHasAnimation(var_133_bool, var_129_string); // 0x23d Func
	var_136_bool = var_133_bool; // 0x23f Push
	if(var_136_bool == 0) goto Label_583; // 0x240 JumpB
	lshGetAnimTimes(var_129_string, var_134_float, var_135_float); // 0x241 Func
	var_137_bool = 0; // 0x243 PushB
	lshPlayAnimation(var_134_float, var_135_float, var_137_bool); // 0x244 Func
...
Label_583:
	var_138_string = "Can't find lsh animation : "; // 0x247 PushS
	var_139_int = var_138_string + var_129_string; // 0x248 Add
	Trace(var_139_int); // 0x249 Func
}


func_701(var_76_int)
{
	var_77_int = 0; var_78_int = 0; // 0x2bd PushV
	var_79_string = "branch"; // 0x2be PushS
	GetVariable(var_79_string, var_78_int); // 0x2bf Func
	var_80_int = 0; // 0x2c1 PushI
	var_81_bool = var_78_int == var_80_int; // 0x2c2 Eq
	if(var_81_bool == 0) goto Label_711; // 0x2c3 JumpB
	var_76_int = 1; // 0x2c4 MovI
	return 2; // 0x2c5 Return
	
Label_711:
	var_82_int = 1; // 0x2c7 PushI
	var_83_bool = var_78_int == var_82_int; // 0x2c8 Eq
	if(var_83_bool == 0) goto Label_716; // 0x2c9 JumpB
	var_76_int = 2; // 0x2ca MovI
	return 2; // 0x2cb Return
	
Label_716:
	var_76_int = 3; // 0x2cc MovI
