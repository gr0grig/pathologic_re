...
0x652: Stack[-2] = Stack[-4]
0x653: Stack[-1] = (float) 0.05
0x654: Call2 0x600
...
0x65f: Stack[-3] = Stack[-7]
0x660: Stack[-2] = Stack[-6]
...
0x667: Stack[-5] = Stack[-11]
0x668: Stack[-4] = Stack[-10]
0x669: Stack[-3] = Stack[-9]
0x66a: Stack[-2] = Stack[-7]
0x66b: Stack[-1] = Stack[-6]
0x66c: Call2 0x591
