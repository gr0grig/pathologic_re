...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	func_1591(var_12_object); // 0x308 NEW_2
...
{
	var_13_object = Obj(); var_14_int = 0; var_15_float = 0; // 0x65e PushV
	var_13_object = var_9_object; // 0x65f Mov
	var_14_int = var_10_int; // 0x660 Mov
	var_15_float = var_11_float; // 0x661 Mov
	func_1357(var_13_object, var_14_int, var_15_float); // 0x662 NEW_2
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; var_18_cvector = CVector(0,0,0); var_19_cvector = CVector(0,0,0); // 0x666 PushV
	var_15_object = var_9_object; // 0x667 Mov
	var_16_int = var_10_int; // 0x668 Mov
	var_17_float = var_11_float; // 0x669 Mov
	var_18_cvector = var_13_cvector; // 0x66a Mov
	var_19_cvector = var_14_cvector; // 0x66b Mov
	func_1425(var_17_float, var_18_cvector, var_19_cvector); // 0x66c NEW_2
...
{
	var_11_float = 0; var_12_float = 0; // 0x66f PushV
	var_13_string = "health"; // 0x670 PushS
	var_14_bool = var_10_string == var_13_string; // 0x671 Eq
	if(var_14_bool == 0) goto Label_1659; // 0x672 JumpB
	var_15_string = "health"; // 0x673 PushS
	GetProperty(var_15_string, var_12_float); // 0x674 Func
	var_16_int = 0; // 0x676 PushI
	var_17_bool = var_12_float <= var_16_int; // 0x677 LE
	if(var_17_bool == 0) goto Label_1659; // 0x678 JumpB
	SignalDeath(var_9_object); // 0x679 Func
...
{
	var_10_object = Obj(); // 0x67d PushV
	var_10_object = var_9_object; // 0x67e Mov
	func_1611(var_10_object); // 0x67f NEW_2
...
Label_1557:
	...
	func_1581(var_22_float); // 0x617 NEW_2
...
Label_1194:
	var_451_string = "armor"; // 0x4aa PushS
	GetProperty(var_451_string, var_404_int); // 0x4ab ObjFunc
}
...
func_1571(var_447_float)
{
	...
	var_450_int = 15; // 0x628 PushI
	SendWorldWndMessage(var_450_int, var_449_object); // 0x629 Func
...
{
	var_23_object = Obj(); var_24_object = Obj(); // 0x62d PushV
	CreateFloatVector(var_24_object); // 0x62e Func
	add(var_22_float); // 0x630 ObjFunc
	var_25_int = 16; // 0x632 PushI
	SendWorldWndMessage(var_25_int, var_24_object); // 0x633 Func
...
Label_209:
	...
	var_494_string = "all"; // 0xd3 PushS
	var_495_string = "fjump"; // 0xd4 PushS
	PlayAnimation(var_494_string, var_495_string); // 0xd5 Func
	WaitForAnimEnd(); // 0xd7 Func
	func_695(var_43_float); // 0xda NEW_2
	var_496_cvector = CVector(0.0, 0.0, 0.0); // 0xdc PushVec
	SetSpeed(var_496_cvector); // 0xdd Func
	Stop(); // 0xdf Func
	StopAsync(); // 0xe1 Func
	var_497_bool = 0; // 0xe3 PushV
	func_652(var_43_float, var_497_bool); // 0xe4 NEW_2
	var_498_bool = var_497_bool == 0; // 0xe6 Not
	if(var_498_bool == 0) goto Label_255; // 0xe7 JumpB
	var_499_bool = 0; var_500_object = Obj(); // 0xe8 PushV
	var_500_object = var_0_object; // 0xe9 MovT
	func_1289(var_499_bool, var_500_object); // 0xea NEW_2
	var_501_bool = var_499_bool == 0; // 0xec Not
	if(var_501_bool == 0) goto Label_239; // 0xed JumpB
...
Label_239:
	...
	var_502_float = var_21_float * var_21_float; // 0xf5 Mult
	var_503_bool = var_40_float < var_502_float; // 0xf6 LT
	if(var_503_bool == 0) goto Label_255; // 0xf7 JumpB
	var_504_bool = 0; var_505_float = 0; // 0xf8 PushV
	var_505_float = var_21_float; // 0xf9 Mov
	func_356(var_43_float, var_504_bool, var_505_float); // 0xfa NEW_2
	var_506_bool = var_504_bool == 0; // 0xfc Not
	if(var_506_bool == 0) goto Label_255; // 0xfd JumpB
	goto Label_265; // 0xfe Jump
	
Label_256:
	var_507_bool = 0; var_508_float = 0; // 0x100 PushV
	var_508_float = var_21_float; // 0x101 Mov
	func_356(var_43_float, var_507_bool, var_508_float); // 0x102 NEW_2
	var_509_bool = var_507_bool == 0; // 0x104 Not
	if(var_509_bool == 0) goto Label_263; // 0x105 JumpB
...
func_695(var_0_object)
{
	...
	func_1591(var_115_object); // 0x2b9 NEW_2
	return 0; // 0x2bb Return
}


func_1591(var_115_object)
{
	var_116_bool = 0; var_117_bool = 0; // 0x637 PushV
	IsPlayerActor(var_115_object, var_117_bool); // 0x638 Func
	var_118_bool = var_117_bool; // 0x63a Push
	if(var_118_bool == 0) goto Label_1599; // 0x63b JumpB
	var_119_string = "attack"; // 0x63c PushS
	PlayGlobalMusic(var_119_string); // 0x63d Func
...
func_317(var_0_object, var_377_float, var_378_int)
{
	...
	var_452_int = 0; // 0x158 PushV
	func_700(var_452_int); // 0x159 NEW_2
	ReportHit(var_0_object, var_452_int, var_384_float, var_383_float); // 0x15b Func
	var_453_object = Obj(); var_454_float = 0; // 0x15d PushV
	var_453_object = var_382_object; // 0x15e Mov
	var_454_float = var_384_float; // 0x15f Mov
...
func_1600()
{
	var_352_object = Obj(); var_353_object = Obj(); // 0x640 PushV
	GetScene(var_353_object); // 0x641 Func
	var_354_string = "battle"; // 0x643 PushS
	var_355_object = Obj(); // 0x644 PushV
	func_1502(var_355_object); // 0x645 NEW_2
	BroadcastMessage(var_354_string, var_355_object, var_353_object); // 0x647 Func
...
{
	var_11_bool = 0; var_12_object = Obj(); // 0x64c PushV
	var_12_object = var_10_object; // 0x64d Mov
	func_1136(var_11_bool, var_12_object); // 0x64e NEW_2
	if(var_11_bool == 0) goto Label_1622; // 0x650 JumpB
	var_15_bool = 0; var_16_object = Obj(); var_17_float = 0; // 0x651 PushV
	var_16_object = var_10_object; // 0x652 Mov
	var_17_float = 0.05; // 0x653 MovF
	func_1536(var_15_bool, var_16_object, var_17_float); // 0x654 NEW_2
	
Label_1622:
	var_53_object = Obj(); // 0x656 PushV
	var_53_object = var_10_object; // 0x657 Mov
	TaskCall(3); // 0x658 TaskCall
	func_983(var_53_object); // 0x659 NEW_2
	TaskReturn(); // 0x65a TaskReturn
...
func_721(var_2_int, var_122_bool, var_123_object, var_124_float, var_125_float, var_126_bool, var_127_bool)
{
	...
	func_1591(var_135_object); // 0x2d4 NEW_2
...
Label_392:
	...
	var_455_string = "all"; // 0x18d PushS
	var_456_string = "attack_middle"; // 0x18e PushS
	var_457_int = var_456_string + var_346_int; // 0x18f Add
	HasAnimation(var_347_bool, var_455_string, var_457_int); // 0x190 Func
	var_458_bool = var_347_bool; // 0x192 Push
	if(var_458_bool == 0) goto Label_473; // 0x193 JumpB
	func_1600(); // 0x195 NEW_2
	var_459_string = "all"; // 0x197 PushS
	var_460_string = "attack_middle"; // 0x198 PushS
	var_461_int = var_460_string + var_346_int; // 0x199 Add
	PlayAnimation(var_459_string, var_461_int); // 0x19a Func
	WaitForAnimEnd(); // 0x19c Func
	func_695(var_349_string); // 0x19f NEW_2
	var_462_bool = 0; var_463_object = Obj(); // 0x1a1 PushV
	var_463_object = var_0_object; // 0x1a2 MovT
	func_1289(var_462_bool, var_463_object); // 0x1a3 NEW_2
	var_464_bool = var_462_bool == 0; // 0x1a5 Not
	if(var_464_bool == 0) goto Label_427; // 0x1a6 JumpB
	StopAsync(); // 0x1a7 Func
	var_340_bool = 0; // 0x1a9 MovB
	return 8; // 0x1aa Return
	
Label_427:
	var_465_float = 0; var_466_int = 0; // 0x1ab PushV
	var_465_float = var_341_float; // 0x1ac Mov
	var_466_int = var_346_int; // 0x1ad Mov
	func_317(var_349_string, var_465_float, var_466_int); // 0x1ae NEW_2
	var_348_int = 1; // 0x1b0 MovI
	
Label_433:
	var_467_string = "attack_middle"; // 0x1b1 PushS
	var_468_int = var_467_string + var_346_int; // 0x1b2 Add
	var_469_string = "_"; // 0x1b3 PushS
	var_470_int = var_468_int + var_469_string; // 0x1b4 Add
	var_349_string = var_470_int + var_348_int; // 0x1b5 Add2
	var_471_string = "all"; // 0x1b6 PushS
	HasAnimation(var_347_bool, var_471_string, var_349_string); // 0x1b7 Func
	var_472_bool = var_347_bool == 0; // 0x1b9 Not
	if(var_472_bool == 0) goto Label_444; // 0x1ba JumpB
	goto Label_473; // 0x1bb Jump
	
Label_473:
	var_473_bool = 0; // 0x1d9 PushB
	SetAttackState(var_473_bool); // 0x1da Func
	var_474_string = "all"; // 0x1dc PushS
	var_475_string = "attack_end"; // 0x1dd PushS
	var_476_int = var_475_string + var_346_int; // 0x1de Add
	PlayAnimation(var_474_string, var_476_int); // 0x1df Func
	var_477_bool = 0; // 0x1e1 PushV
	func_709(var_477_bool); // 0x1e2 NEW_2
	if(var_477_bool == 0) goto Label_491; // 0x1e4 JumpB
	var_478_bool = 0; var_479_float = 0; // 0x1e5 PushV
	var_479_float = 0.75; // 0x1e6 MovF
	func_493(var_478_bool, var_479_float); // 0x1e7 NEW_2
...
Label_444:
	func_1600(); // 0x1bd NEW_2
	var_487_string = "all"; // 0x1bf PushS
	PlayAnimation(var_487_string, var_349_string); // 0x1c0 Func
	WaitForAnimEnd(); // 0x1c2 Func
	func_695(var_349_string); // 0x1c5 NEW_2
	var_488_bool = 0; var_489_object = Obj(); // 0x1c7 PushV
	var_489_object = var_0_object; // 0x1c8 MovT
	func_1289(var_488_bool, var_489_object); // 0x1c9 NEW_2
	var_490_bool = var_488_bool == 0; // 0x1cb Not
	if(var_490_bool == 0) goto Label_465; // 0x1cc JumpB
	StopAsync(); // 0x1cd Func
	var_340_bool = 0; // 0x1cf MovB
	return 8; // 0x1d0 Return
	
Label_465:
	var_491_float = 0; var_492_int = 0; // 0x1d1 PushV
	var_491_float = var_341_float; // 0x1d2 Mov
	var_492_int = var_346_int; // 0x1d3 Mov
	func_317(var_349_string, var_491_float, var_492_int); // 0x1d4 NEW_2
	var_493_int = 1; // 0x1d6 PushI
	var_348_int = var_348_int + var_493_int; // 0x1d7 Add2
...
func_493(var_478_bool, var_479_float)
{
	var_480_float = 0; var_481_bool = 0; var_482_float = 0; var_483_bool = 0; // 0x1ed PushV
	rand(var_482_float); // 0x1ee Func
	var_484_bool = var_482_float < var_479_float; // 0x1f0 LT
	if(var_484_bool == 0) goto Label_513; // 0x1f1 JumpB
	
Label_498:
	IsAnimationPlaying(var_483_bool); // 0x1f2 Func
	var_485_bool = var_483_bool == 0; // 0x1f4 Not
	if(var_485_bool == 0) goto Label_503; // 0x1f5 JumpB
...
Label_518:
	var_478_bool = 0; // 0x206 MovB
	return 4; // 0x207 Return
	
Label_503:
	var_486_bool = 0; // 0x1f7 PushV
	func_591(var_486_bool); // 0x1f8 NEW_2
	if(var_486_bool == 0) goto Label_509; // 0x1fa JumpB
	var_478_bool = 1; // 0x1fb MovB
...
Label_513:
	...
	func_695(var_483_bool); // 0x204 NEW_2
}
