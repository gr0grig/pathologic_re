...
0x33a: @ StopWorld()
0x33b: Pop(0)
0x33c: @ CameraTransit(Stack[-3], Stack[-5])
0x33d: Pop(0)
0x33e: Push(CvectorIndex(Stack[-4], 0))
0x33f: Push(CvectorIndex(Stack[-5], 2))
0x340: @ Rotate(Stack[-2], Stack[-1])
0x341: Pop(2)
...
0x347: Push("head")
0x348: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x349: Pop(1)
0x34a: Push(Stack[-1])
0x34b: IF (Stack[-1] == 0) GOTO 0x34f; Pop(1)

0x34c: Push("head")
0x34d: @ LookAsyncCamera(Stack[-1])
0x34e: Pop(1)
0x34f: @ CameraWaitForPlayFinish()
0x350: Pop(0)
0x351: @ ResumeWorld()
0x352: Pop(0)
0x353: Stack[-21] = (bool) 1
0x354: Return(); Pop(18)

0x355: PushEmpty(bool, bool)
0x356: @ CameraSwitchToNormal()
0x357: Pop(0)
...
0x362: Push("head")
0x363: @ UnlookAsync(Stack[-1])
0x364: Pop(1)
0x365: Return(); Pop(2)

0x366: PushEmpty(int, int, int, int)
0x367: Push("voice_common")
0x368: @ GetVariable(Stack[-1], Stack[-3])
0x369: Pop(1)
0x36a: Push(Stack[-2])
0x36b: IF (Stack[-1] == 0) GOTO 0x38c; Pop(1)
...
0x371: IF (Stack[-1] == 0) GOTO 0x37a; Pop(1)

0x372: PushEmpty(bool, object)
0x373: Stack[-1] = Stack[-7]
0x374: Call2 0x3c5
...
0x37a: Push((int) 2)
0x37b: @ irand(Stack[-2], Stack[-1])
0x37c: Pop(1)
0x37d: Push(Stack[-1])
0x37e: IF (Stack[-1] == 0) GOTO 0x387; Pop(1)

0x37f: Push("voice_common")
0x380: Push((int) 1)
0x381: Pop(1); Push(Stack[-4] + Stack[-1]);
0x382: Push((int) 3)
0x383: Pop(2); Push(Stack[-2] % Stack[-1]);
0x384: @ SetVariable(Stack[-2], Stack[-1])
0x385: Pop(2)
0x386: GOTO 0x38b

0x387: Push("voice_common")
0x388: Push((int) 0)
...
0x3a2: Stack[-4] = (int) 0
0x3a3: Push((int) 1)
0x3a4: IF (Stack[-1] == 0) GOTO 0x3b0; Pop(1)

0x3a5: Push((int) 1)
0x3a6: Pop(1); Push(Stack[-5] + Stack[-1]);
0x3a7: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3a8: @@ HasProperty(Stack[-1], Stack[-4])
0x3a9: Pop(1)
...
0x3ad: Push((int) 1)
0x3ae: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3af: GOTO 0x3a3

0x3b0: Pop(0); Push((bool) Stack[-4] == 0)
0x3b1: IF (Stack[-1] == 0) GOTO 0x3b4; Pop(1)

0x3b2: Stack[-12] = (bool) 0
0x3b3: Return(); Pop(10)

0x3b4: Stack[-2] = (int) 0
0x3b5: Push((int) 1)
0x3b6: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x3b7: IF (Stack[-1] == 0) GOTO 0x3ba; Pop(1)

0x3b8: @ irand(Stack[-2], Stack[-4])
0x3b9: Pop(0)
0x3ba: Push((int) 1)
0x3bb: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3bc: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3bd: @@ GetProperty(Stack[-1], Stack[-2])
0x3be: Pop(1)
0x3bf: PushEmpty(bool, string)
0x3c0: Stack[-1] = Stack[-3]
0x3c1: Call2 0x40f

0x3c2: Stack[-14] = Stack[-2]
0x3c3: Pop(2)
0x3c4: Return(); Pop(10)

0x3c5: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3c6: Push("d")
0x3c7: PushEmpty(int)
0x3c8: Call2 0x446
...
0x3cb: Push("m")
0x3cc: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3cd: Stack[-4] = (int) 0
0x3ce: Push((int) 1)
...
0x3f0: PushEmpty(bool, float, float, bool, float, float)
0x3f1: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3f2: Pop(0)
0x3f3: Push(Stack[-3])
0x3f4: IF (Stack[-1] == 0) GOTO 0x3fb; Pop(1)

0x3f5: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3f6: Pop(0)
0x3f7: Push((bool) 0)
...
0x3fc: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3fd: @ Trace(Stack[-1])
0x3fe: Pop(1)
0x3ff: Return(); Pop(6)

0x400: PushEmpty(bool, float, float, bool, float, float)
0x401: @ lshHasAnimation(Stack[-3], Stack[-8])
0x402: Pop(0)
0x403: Push(Stack[-3])
0x404: IF (Stack[-1] == 0) GOTO 0x40a; Pop(1)

0x405: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x406: Pop(0)
0x407: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x408: Pop(0)
0x409: GOTO 0x40e

0x40a: Push("Can't find lsh animation : ")
0x40b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x40c: @ Trace(Stack[-1])
0x40d: Pop(1)
0x40e: Return(); Pop(6)

0x40f: PushEmpty(bool, bool)
...
0x414: @ lshHasSpeech(Stack[-1], Stack[-3])
0x415: Pop(0)
0x416: Push(Stack[-1])
0x417: IF (Stack[-1] == 0) GOTO 0x41c; Pop(1)

0x418: @ lshPlaySpeech(Stack[-3])
0x419: Pop(0)
0x41a: Stack[-4] = (bool) 1
0x41b: Return(); Pop(2)

0x41c: Stack[-4] = (bool) 0
0x41d: Return(); Pop(2)
...
0x435: PushEmpty(int, int)
0x436: @ GetVariable(Stack[-3], Stack[-1])
0x437: Pop(0)
0x438: Stack[-4] = Stack[-1]
0x439: Return(); Pop(2)

0x43a: PushEmpty(object, object)
0x43b: @ FindActor(Stack[-1], Stack[-4])
0x43c: Pop(0)
0x43d: Pop(0); Push((bool) Stack[-1] == 0)
0x43e: IF (Stack[-1] == 0) GOTO 0x441; Pop(1)

0x43f: Stack[-5] = (bool) 0
0x440: Return(); Pop(2)

0x441: @ Trigger(Stack[-1], Stack[-3])
0x442: Pop(0)
0x443: Stack[-5] = (bool) 1
0x444: Return(); Pop(2)

0x445: Stack[-1] = 0
0x446: PushEmpty(float, float)
0x447: @ GetGameTime(Stack[-1])
0x448: Pop(0)
0x449: Push((int) 1)
0x44a: PushEmpty(int)
0x44b: Push((int) 24)
0x44c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x44d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x44e: Return(); Pop(2)

0x44f: PushEmpty(string, string)
0x450: Stack[-1] = "idle"
0x451: Push(Stack[-3])
0x452: IF (Stack[-1] == 0) GOTO 0x454; Pop(1)

0x453: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x454: Stack[-4] = Stack[-1]
0x455: Return(); Pop(2)

0x456: PushEmpty(int, bool, int, bool)
0x457: Stack[-2] = (int) 0
0x458: Push("all")
0x459: PushEmpty(string, int)
0x45a: Stack[-1] = Stack[-5]
0x45b: Call2 0x44f

0x45c: Pop(1)
0x45d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x45e: Pop(2)
...
0x462: Push((int) 1)
0x463: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x464: GOTO 0x458
...
0x473: Pop(0)
0x474: PushEmpty(bool, string, string)
0x475: Stack[-2] = "quest_k11_01"
0x476: Stack[-1] = "fail"
0x477: Call2 0x43a
...
0x487: Push((int) 778)
0x488: Push((int) 1)
0x489: Push((int) 541642)
0x48a: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x48b: Pop(3)
0x48c: PushEmpty(bool, object, int)
0x48d: Stack[-2] = Stack[-4]
0x48e: Stack[-1] = (int) 480
0x48f: Call2 0x4ad
...
0x494: Push((int) 490)
0x495: Push((int) 1)
0x496: Push((int) 528057)
0x497: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x498: Pop(3)
0x499: PushEmpty(bool, object, int)
0x49a: Stack[-2] = Stack[-4]
0x49b: Stack[-1] = (int) 480
0x49c: Call2 0x4ad
...
0x4a1: @ GetDiaryRoot(Stack[-1])
0x4a2: Pop(0)
0x4a3: Pop(0); Push((bool) Stack[-1] == 0)
0x4a4: IF (Stack[-1] == 0) GOTO 0x4aa; Pop(1)

0x4a5: Push("Can't retrieve diary root")
0x4a6: @ Trace(Stack[-1])
0x4a7: Pop(1)
0x4a8: Stack[-3] = (bool) 0
0x4a9: Return(); Pop(2)
...
0x4ac: Stack[-1] = 0
0x4ad: PushEmpty(object, object, int, object, object, int)
0x4ae: PushEmpty(object)
0x4af: Call2 0x4a0

0x4b0: Stack[-4] = Stack[-1]
0x4b1: Pop(1)
0x4b2: @@ Find(Stack[-7], Stack[-2])
0x4b3: Pop(0)
0x4b4: Pop(0); Push((bool) Stack[-2] == 0)
0x4b5: IF (Stack[-1] == 0) GOTO 0x4bc; Pop(1)

0x4b6: Push("Can't find diary parent with id: ")
0x4b7: Pop(1); Push(Stack[-1] + Stack[-8]);
0x4b8: @ Trace(Stack[-1])
0x4b9: Pop(1)
0x4ba: Stack[-9] = (bool) 0
0x4bb: Return(); Pop(6)

0x4bc: @@ AddChild(Stack[-8])
0x4bd: Pop(0)
0x4be: Push((int) 7)
0x4bf: @ SendWorldWndMessage(Stack[-1])
0x4c0: Pop(1)
0x4c1: @@ GetCategory(Stack[-1])
0x4c2: Pop(0)
0x4c3: @ SetDiarySection(Stack[-1])
0x4c4: Pop(0)
0x4c5: Stack[-9] = (bool) 0
0x4c6: Return(); Pop(6)
...
0x4da: Stack[-1] = (int) 515592
0x4db: Return(); Pop(0)

0x4dc: Stack[-1] = (int) 511961
0x4dd: Return(); Pop(0)

0x4de: Stack[-1] = "ui/NPC_Burah.png"
0x4df: Return(); Pop(0)

0x4e0: Stack[-1] = "ui/NPC_Burah_b.png"
0x4e1: Return(); Pop(0)
