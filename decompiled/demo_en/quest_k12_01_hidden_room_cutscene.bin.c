...
main()
{
	...
	var_47_string = "quest_k12_01"; // 0x4 MovS
	var_48_string = "hidden_room_cutscene_end"; // 0x5 MovS
...
func_14()
{
	...
	var_8_string = "hidden_room"; // 0xf PushS
	GetSceneByName(var_4_object, var_8_string); // 0x10 Func
	var_9_string = "cs_d12_littlegirl_big"; // 0x12 PushS
	...
	var_12_string = "cs_d12_littleboy_big"; // 0x17 PushS
	...
	var_32_string = "cs_d12_hidden_room.mot"; // 0x2a PushS
