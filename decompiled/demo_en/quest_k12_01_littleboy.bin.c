...
Label_178:
	...
	func_861(var_43_object); // 0xc0 NEW_2
...
Label_423:
	...
	func_898(var_152_bool); // 0x1a9 NEW_2
...
Label_513:
	...
	func_834(var_19_object); // 0x203 NEW_2
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	func_816(var_29_object); // 0x240 NEW_2
...
{
	var_77_string = "ui/NPC_Citizen3_b.png"; // 0x380 MovS
...
func_768()
{
	var_149_bool = 0; var_150_bool = 0; // 0x300 PushV
	CameraSwitchToNormal(); // 0x301 Func
	var_151_bool = 0; // 0x303 PushV
	func_898(var_151_bool); // 0x304 NEW_2
	if(var_151_bool == 0) goto Label_776; // 0x306 JumpB
...
Label_776:
	var_152_string = "head"; // 0x308 PushS
	HasAnimationTrack(var_150_bool, var_152_string); // 0x309 Func
	var_153_bool = var_150_bool; // 0x30b Push
	if(var_153_bool == 0) goto Label_784; // 0x30c JumpB
	var_154_string = "head"; // 0x30d PushS
	UnlookAsync(var_154_string); // 0x30e Func
}


func_898(var_69_bool)
{
	var_69_bool = 0; // 0x382 MovB
...
func_900(var_52_string, var_53_int)
{
	var_54_string = ""; var_55_string = ""; // 0x384 PushV
	var_55_string = "idle"; // 0x385 MovS
	var_56_int = var_53_int; // 0x386 Push
	if(var_56_int == 0) goto Label_905; // 0x387 JumpB
	var_55_string = var_55_string + var_53_int; // 0x388 Add2
	
Label_905:
	var_52_string = var_55_string; // 0x389 Mov
...
func_907(var_46_int)
{
	var_47_int = 0; var_48_bool = 0; var_49_int = 0; var_50_bool = 0; // 0x38b PushV
	var_49_int = 0; // 0x38c MovI
	
Label_909:
	var_51_string = "all"; // 0x38d PushS
	var_52_string = ""; var_53_int = 0; // 0x38e PushV
	var_53_int = var_49_int; // 0x38f Mov
	func_900(var_52_string, var_53_int); // 0x390 NEW_2
	HasAnimation(var_50_bool, var_51_string, var_52_string); // 0x392 Func
	var_57_bool = var_50_bool == 0; // 0x394 Not
	if(var_57_bool == 0) goto Label_919; // 0x395 JumpB
	goto Label_922; // 0x396 Jump
	
Label_922:
	var_46_int = var_49_int; // 0x39a Mov
	return 4; // 0x39b Return
	
Label_919:
	var_58_int = 1; // 0x397 PushI
	var_49_int = var_49_int + var_58_int; // 0x398 Add2
...
func_142(var_2_object, var_94_string)
{
	...
	func_898(var_95_bool); // 0x90 NEW_2
...
Label_160:
	func_801(var_98_string, var_99_bool); // 0xa0 NEW_2
...
func_785(var_131_string)
{
	var_132_bool = 0; var_133_float = 0; var_134_float = 0; var_135_bool = 0; var_136_float = 0; var_137_float = 0; // 0x311 PushV
	lshHasAnimation(var_135_bool, var_131_string); // 0x312 Func
	var_138_bool = var_135_bool; // 0x314 Push
	if(var_138_bool == 0) goto Label_796; // 0x315 JumpB
	lshGetAnimTimes(var_131_string, var_136_float, var_137_float); // 0x316 Func
	var_139_bool = 0; // 0x318 PushB
	lshPlayAnimation(var_136_float, var_137_float, var_139_bool); // 0x319 Func
...
Label_796:
	var_140_string = "Can't find lsh animation : "; // 0x31c PushS
	var_141_int = var_140_string + var_131_string; // 0x31d Add
	Trace(var_141_int); // 0x31e Func
}


func_801(var_98_string, var_99_bool)
{
	var_102_bool = 0; var_103_float = 0; var_104_float = 0; var_105_bool = 0; var_106_float = 0; var_107_float = 0; // 0x321 PushV
	lshHasAnimation(var_105_bool, var_98_string); // 0x322 Func
	var_108_bool = var_105_bool; // 0x324 Push
	if(var_108_bool == 0) goto Label_811; // 0x325 JumpB
	lshGetAnimTimes(var_98_string, var_106_float, var_107_float); // 0x326 Func
	lshPlayAnimation(var_106_float, var_107_float, var_99_bool); // 0x328 Func
...
Label_811:
	var_109_string = "Can't find lsh animation : "; // 0x32b PushS
	var_110_int = var_109_string + var_98_string; // 0x32c Add
	Trace(var_110_int); // 0x32d Func
}
...
func_827()
{
	...
	func_898(var_15_bool); // 0x33c NEW_2
...
func_700(var_27_bool, var_29_float)
{
	...
	func_840(var_54_cvector, var_55_cvector); // 0x2d7 NEW_2
...
Label_741:
	...
	CameraTransit(var_45_cvector, var_43_cvector); // 0x2e7 Func
	var_67_float = GetByIndex(var_44_cvector, 0); // 0x2e9 PushE
	var_68_float = GetByIndex(var_44_cvector, 2); // 0x2ea PushE
	Rotate(var_67_float, var_68_float); // 0x2eb Func
	var_69_bool = 0; // 0x2ed PushV
	func_898(var_69_bool); // 0x2ee NEW_2
	if(var_69_bool == 0) goto Label_754; // 0x2f0 JumpB
	goto Label_762; // 0x2f1 Jump
	
Label_762:
	CameraWaitForPlayFinish(); // 0x2fa Func
	ResumeWorld(); // 0x2fc Func
	var_27_bool = 1; // 0x2fe MovB
	return 18; // 0x2ff Return
	
Label_754:
	var_70_string = "head"; // 0x2f2 PushS
	HasAnimationTrack(var_47_bool, var_70_string); // 0x2f3 Func
	var_71_bool = var_47_bool; // 0x2f5 Push
	if(var_71_bool == 0) goto Label_762; // 0x2f6 JumpB
	var_72_string = "head"; // 0x2f7 PushS
	LookAsyncCamera(var_72_string); // 0x2f8 Func
}
...
func_840(var_54_cvector, var_55_cvector)
{
	var_57_float = 0; var_58_float = 0; // 0x348 PushV
	var_59_int = var_55_cvector | var_55_cvector; // 0x349 Or
	var_58_float = sqrt(var_59_int); // 0x34a Sqrt2
	var_60_float = 0.0; // 0x34b PushF
	var_61_bool = var_58_float < var_60_float; // 0x34c LT
	if(var_61_bool == 0) goto Label_848; // 0x34d JumpB
	var_54_cvector = CVector(0.0, 0.0, 0.0); // 0x34e MovV
	return 2; // 0x34f Return
	
Label_848:
	var_54_cvector = var_55_cvector / var_55_cvector; // 0x350 Div2
...
Label_121:
	...
	func_785(var_131_string); // 0x7b NEW_2
...
func_850(var_114_int, var_115_string)
{
	var_116_int = 0; var_117_int = 0; // 0x352 PushV
	GetVariable(var_115_string, var_117_int); // 0x353 Func
	var_114_int = var_117_int; // 0x355 Mov
...
func_855()
{
	var_20_string = "ook12Littleboy1"; // 0x358 PushS
	var_21_int = 1; // 0x359 PushI
	SetVariable(var_20_string, var_21_int); // 0x35a Func
...
Label_484:
	...
	func_834(var_21_object); // 0x1e6 NEW_2
...
Label_610:
	...
	func_907(var_46_int); // 0x263 NEW_2
...
Label_625:
	...
	func_900(var_68_string, var_69_int); // 0x27f NEW_2
...
func_861(var_112_bool)
{
	var_114_int = 0; var_115_string = ""; // 0x35e PushV
	var_115_string = "ook12Littleboy1"; // 0x35f MovS
	func_850(var_114_int, var_115_string); // 0x360 NEW_2
	var_118_int = 0; // 0x362 PushI
	var_119_bool = var_114_int == var_118_int; // 0x363 Eq
	if(var_119_bool == 0) goto Label_871; // 0x364 JumpB
	var_112_bool = 1; // 0x365 MovB
	return 0; // 0x366 Return
	
Label_871:
	var_112_bool = 0; // 0x367 MovB
...
func_873(var_78_int)
{
	var_79_int = 0; var_80_int = 0; // 0x369 PushV
	var_81_string = "branch"; // 0x36a PushS
	GetVariable(var_81_string, var_80_int); // 0x36b Func
	var_82_int = 0; // 0x36d PushI
	var_83_bool = var_80_int == var_82_int; // 0x36e Eq
	if(var_83_bool == 0) goto Label_883; // 0x36f JumpB
	var_78_int = 1; // 0x370 MovI
	return 2; // 0x371 Return
	
Label_883:
	var_84_int = 1; // 0x373 PushI
	var_85_bool = var_80_int == var_84_int; // 0x374 Eq
	if(var_85_bool == 0) goto Label_888; // 0x375 JumpB
	var_78_int = 2; // 0x376 MovI
	return 2; // 0x377 Return
	
Label_888:
	var_78_int = 3; // 0x378 MovI
...
func_892(var_74_int)
{
	var_74_int = 503345; // 0x37c MovI
	return 0; // 0x37d Return
}


func_894(var_76_string)
{
	var_76_string = "ui/NPC_Citizen3.png"; // 0x37e MovS
