...
0x33c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x33d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x33e: Push((float)0.0)
0x33f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x340: IF (Stack[-1] == 0) GOTO 0x343; Pop(1)

0x341: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x342: Return(); Pop(2)

0x343: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x344: Return(); Pop(2)
...
0x34c: @ Trigger(Stack[-1], Stack[-3])
0x34d: Pop(0)
0x34e: Stack[-5] = (bool) 1
0x34f: Return(); Pop(2)

0x350: Stack[-1] = 0
0x351: Stack[-1] = (int) 515571
0x352: Return(); Pop(0)

0x353: Stack[-1] = (int) 504029
0x354: Return(); Pop(0)

0x355: Stack[-1] = "ui/NPC_bmask.png"
0x356: Return(); Pop(0)

0x357: Stack[-1] = "ui/NPC_bmask_b.png"
0x358: Return(); Pop(0)

0x359: Stack[-1] = (bool) 0
0x35a: Return(); Pop(0)

0x35b: PushEmpty(string, string)
0x35c: Stack[-1] = "idle"
0x35d: Push(Stack[-3])
0x35e: IF (Stack[-1] == 0) GOTO 0x360; Pop(1)

0x35f: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x368: Pop(1)
0x369: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x36a: Pop(2)
...
0x371: Stack[-5] = Stack[-2]
0x372: Return(); Pop(4)

0x373: PushEmpty()
0x374: PushEmpty(bool, string, string)
0x375: Stack[-2] = "quest_k1_01"
0x376: Stack[-1] = "remove_birdmask"
0x377: Call2 0x345
