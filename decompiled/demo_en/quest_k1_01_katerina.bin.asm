...
0x31a: PushEmpty(int, int, int, int)
0x31b: Push("voice_common")
0x31c: @ GetVariable(Stack[-1], Stack[-3])
0x31d: Pop(1)
0x31e: Push(Stack[-2])
0x31f: IF (Stack[-1] == 0) GOTO 0x340; Pop(1)

0x320: PushEmpty(bool, object)
0x321: Stack[-1] = Stack[-7]
0x322: Call2 0x354
...
0x32e: Push((int) 2)
0x32f: @ irand(Stack[-2], Stack[-1])
0x330: Pop(1)
0x331: Push(Stack[-1])
0x332: IF (Stack[-1] == 0) GOTO 0x33b; Pop(1)

0x333: Push("voice_common")
0x334: Push((int) 1)
0x335: Pop(1); Push(Stack[-4] + Stack[-1]);
0x336: Push((int) 3)
...
0x354: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x355: Stack[-5] = "c"
0x356: Stack[-4] = (int) 0
0x357: Push((int) 1)
0x358: IF (Stack[-1] == 0) GOTO 0x364; Pop(1)

0x359: Push((int) 1)
0x35a: Pop(1); Push(Stack[-5] + Stack[-1]);
0x35b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x35c: @@ HasProperty(Stack[-1], Stack[-4])
0x35d: Pop(1)
0x35e: Pop(0); Push((bool) Stack[-3] == 0)
0x35f: IF (Stack[-1] == 0) GOTO 0x361; Pop(1)

0x360: GOTO 0x364

0x361: Push((int) 1)
0x362: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x363: GOTO 0x357

0x364: Pop(0); Push((bool) Stack[-4] == 0)
0x365: IF (Stack[-1] == 0) GOTO 0x368; Pop(1)

0x366: Stack[-12] = (bool) 0
0x367: Return(); Pop(10)

0x368: Stack[-2] = (int) 0
0x369: Push((int) 1)
0x36a: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x36b: IF (Stack[-1] == 0) GOTO 0x36e; Pop(1)

0x36c: @ irand(Stack[-2], Stack[-4])
0x36d: Pop(0)
0x36e: Push((int) 1)
0x36f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x370: Pop(1); Push(Stack[-6] + Stack[-1]);
0x371: @@ GetProperty(Stack[-1], Stack[-2])
0x372: Pop(1)
0x373: PushEmpty(bool, string)
0x374: Stack[-1] = Stack[-3]
0x375: Call2 0x3c3

0x376: Stack[-14] = Stack[-2]
0x377: Pop(2)
0x378: Return(); Pop(10)

0x379: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x37a: Push("d")
0x37b: PushEmpty(int)
0x37c: Call2 0x3ff
...
0x37f: Push("m")
0x380: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x381: Stack[-4] = (int) 0
0x382: Push((int) 1)
...
0x387: @@ HasProperty(Stack[-1], Stack[-4])
0x388: Pop(1)
...
0x39c: @@ GetProperty(Stack[-1], Stack[-2])
0x39d: Pop(1)
0x39e: PushEmpty(bool, string)
0x39f: Stack[-1] = Stack[-3]
0x3a0: Call2 0x3c3

0x3a1: Stack[-14] = Stack[-2]
0x3a2: Pop(2)
0x3a3: Return(); Pop(10)

0x3a4: PushEmpty(bool, float, float, bool, float, float)
0x3a5: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3a6: Pop(0)
0x3a7: Push(Stack[-3])
0x3a8: IF (Stack[-1] == 0) GOTO 0x3af; Pop(1)

0x3a9: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3aa: Pop(0)
0x3ab: Push((bool) 0)
0x3ac: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3ad: Pop(1)
0x3ae: GOTO 0x3b3

0x3af: Push("Can't find lsh animation : ")
0x3b0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3b1: @ Trace(Stack[-1])
0x3b2: Pop(1)
0x3b3: Return(); Pop(6)

0x3b4: PushEmpty(bool, float, float, bool, float, float)
0x3b5: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3b6: Pop(0)
0x3b7: Push(Stack[-3])
0x3b8: IF (Stack[-1] == 0) GOTO 0x3be; Pop(1)

0x3b9: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3ba: Pop(0)
0x3bb: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3bc: Pop(0)
0x3bd: GOTO 0x3c2

0x3be: Push("Can't find lsh animation : ")
0x3bf: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3c0: @ Trace(Stack[-1])
0x3c1: Pop(1)
0x3c2: Return(); Pop(6)
...
0x3c8: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3c9: Pop(0)
0x3ca: Push(Stack[-1])
0x3cb: IF (Stack[-1] == 0) GOTO 0x3d0; Pop(1)

0x3cc: @ lshPlaySpeech(Stack[-3])
0x3cd: Pop(0)
0x3ce: Stack[-4] = (bool) 1
0x3cf: Return(); Pop(2)

0x3d0: Stack[-4] = (bool) 0
0x3d1: Return(); Pop(2)
...
0x428: Pop(1)
0x429: Push("k1q01KaterinaGotoAlexandr")
0x42a: Push("pt_map_alexandr")
0x42b: Push((int) 1)
0x42c: Push((int) 524727)
0x42d: PushEmpty(float)
0x42e: Call2 0x3fa

0x42f: Pop(0)
0x430: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x431: Pop(5)
0x432: PushEmpty()
0x433: Call2 0x45b
...
0x437: Pop(0)
0x438: PushEmpty(bool, string, string)
0x439: Stack[-2] = "quest_k1_01"
0x43a: Stack[-1] = "remove_katerina"
0x43b: Call2 0x3ee
...
0x43e: Stack[-1] = 0
0x43f: PushEmpty()
0x440: PushEmpty(object, string, float)
0x441: PushEmpty(object)
0x442: Call2 0x49e

0x443: Stack[-4] = Stack[-1]
0x444: Pop(1)
0x445: Stack[-2] = "pt_map_alexandr"
0x446: Stack[-1] = (int) 2
0x447: Call2 0x4af
...
0x45c: Push((int) 318)
0x45d: Push((int) 1)
0x45e: Push((int) 524734)
0x45f: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x460: Pop(3)
0x461: PushEmpty(bool, object, int)
0x462: Stack[-2] = Stack[-4]
0x463: Stack[-1] = (int) -1
0x464: Call2 0x482
...
0x469: Push((int) 319)
0x46a: Push((int) 1)
0x46b: Push((int) 524735)
0x46c: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x46d: Pop(3)
0x46e: PushEmpty(bool, object, int)
0x46f: Stack[-2] = Stack[-4]
0x470: Stack[-1] = (int) 318
0x471: Call2 0x482
...
0x481: Stack[-1] = 0
0x482: PushEmpty(object, object, int, object, object, int)
0x483: PushEmpty(object)
0x484: Call2 0x475

0x485: Stack[-4] = Stack[-1]
0x486: Pop(1)
0x487: @@ Find(Stack[-7], Stack[-2])
0x488: Pop(0)
0x489: Pop(0); Push((bool) Stack[-2] == 0)
0x48a: IF (Stack[-1] == 0) GOTO 0x491; Pop(1)

0x48b: Push("Can't find diary parent with id: ")
0x48c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x48d: @ Trace(Stack[-1])
0x48e: Pop(1)
0x48f: Stack[-9] = (bool) 0
0x490: Return(); Pop(6)

0x491: @@ AddChild(Stack[-8])
0x492: Pop(0)
0x493: Push((int) 7)
0x494: @ SendWorldWndMessage(Stack[-1])
0x495: Pop(1)
0x496: @@ GetCategory(Stack[-1])
0x497: Pop(0)
0x498: @ SetDiarySection(Stack[-1])
0x499: Pop(0)
0x49a: Stack[-9] = (bool) 0
0x49b: Return(); Pop(6)

0x49c: Stack[-2] = 0
0x49d: Stack[-3] = 0
0x49e: PushEmpty(object, object, object, object)
0x49f: @ GetMainOutdoorScene(Stack[-2])
0x4a0: Pop(0)
0x4a1: Pop(0); Push((bool) Stack[-2] == 0)
0x4a2: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a3: Push("Can't find main outdoor scene")
0x4a4: @ Trace(Stack[-1])
0x4a5: Pop(1)
0x4a6: Stack[-1] = 0
...
0x4ad: Stack[-1] = 0
0x4ae: Stack[-2] = 0
0x4af: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x4b0: @ GetMainOutdoorScene(Stack[-2])
0x4b1: Pop(0)
0x4b2: Pop(0); Push((bool) Stack[-2] == 0)
0x4b3: IF (Stack[-1] == 0) GOTO 0x4b8; Pop(1)

0x4b4: Push("Can't find main outdoor scene")
0x4b5: @ Trace(Stack[-1])
0x4b6: Pop(1)
0x4b7: Return(); Pop(8)

0x4b8: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x4b9: Pop(0)
0x4ba: Pop(0); Push((bool) Stack[-1] == 0)
0x4bb: IF (Stack[-1] == 0) GOTO 0x4c2; Pop(1)

0x4bc: Push("Warning: outdoor scene locator ")
0x4bd: Pop(1); Push(Stack[-1] + Stack[-11]);
0x4be: Push(" doesnt exist")
0x4bf: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4c0: @ Trace(Stack[-1])
0x4c1: Pop(1)
0x4c2: @@ GetMap(Stack[-11])
0x4c3: Pop(0)
0x4c4: Pop(0); Push((bool) Stack[-11] == 0)
0x4c5: IF (Stack[-1] == 0) GOTO 0x4ca; Pop(1)

0x4c6: Push("Can't find map")
0x4c7: @ Trace(Stack[-1])
0x4c8: Pop(1)
0x4c9: Return(); Pop(8)

0x4ca: Push(CvectorIndex(Stack[-4], 0))
0x4cb: Push(CvectorIndex(Stack[-5], 2))
0x4cc: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x4cd: Pop(2)
0x4ce: Return(); Pop(8)
...
0x4e1: Stack[-1] = (int) 515539
0x4e2: Return(); Pop(0)

0x4e3: Stack[-1] = (int) 502864
0x4e4: Return(); Pop(0)

0x4e5: Stack[-1] = "ui/NPC_Katerina.png"
0x4e6: Return(); Pop(0)

0x4e7: Stack[-1] = "ui/NPC_Katerina_b.png"
0x4e8: Return(); Pop(0)
