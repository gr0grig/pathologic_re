...
0x257: @ StopWorld()
0x258: Pop(0)
0x259: @ CameraTransit(Stack[-3], Stack[-5])
0x25a: Pop(0)
0x25b: Push(CvectorIndex(Stack[-4], 0))
0x25c: Push(CvectorIndex(Stack[-5], 2))
0x25d: @ Rotate(Stack[-2], Stack[-1])
0x25e: Pop(2)
...
0x269: Push("head")
0x26a: @ LookAsyncCamera(Stack[-1])
0x26b: Pop(1)
0x26c: @ CameraWaitForPlayFinish()
0x26d: Pop(0)
0x26e: @ ResumeWorld()
0x26f: Pop(0)
0x270: Stack[-21] = (bool) 1
0x271: Return(); Pop(18)

0x272: PushEmpty(bool, bool)
0x273: @ CameraSwitchToNormal()
0x274: Pop(0)
...
0x27a: Push("head")
0x27b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x27c: Pop(1)
0x27d: Push(Stack[-1])
0x27e: IF (Stack[-1] == 0) GOTO 0x282; Pop(1)

0x27f: Push("head")
0x280: @ UnlookAsync(Stack[-1])
0x281: Pop(1)
0x282: Return(); Pop(2)

0x283: PushEmpty(bool, float, float, bool, float, float)
0x284: @ lshHasAnimation(Stack[-3], Stack[-7])
0x285: Pop(0)
0x286: Push(Stack[-3])
0x287: IF (Stack[-1] == 0) GOTO 0x28e; Pop(1)

0x288: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x289: Pop(0)
0x28a: Push((bool) 0)
0x28b: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x28c: Pop(1)
0x28d: GOTO 0x292

0x28e: Push("Can't find lsh animation : ")
0x28f: Pop(1); Push(Stack[-1] + Stack[-8]);
0x290: @ Trace(Stack[-1])
0x291: Pop(1)
0x292: Return(); Pop(6)

0x293: PushEmpty(bool, float, float, bool, float, float)
0x294: @ lshHasAnimation(Stack[-3], Stack[-8])
0x295: Pop(0)
0x296: Push(Stack[-3])
0x297: IF (Stack[-1] == 0) GOTO 0x29d; Pop(1)

0x298: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x299: Pop(0)
0x29a: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x29b: Pop(0)
0x29c: GOTO 0x2a1

0x29d: Push("Can't find lsh animation : ")
0x29e: Pop(1); Push(Stack[-1] + Stack[-9]);
0x29f: @ Trace(Stack[-1])
0x2a0: Pop(1)
0x2a1: Return(); Pop(6)

0x2a2: PushEmpty(float, cvector, float, cvector)
0x2a3: @@ GetEyesHeight(Stack[-2])
0x2a4: Pop(0)
0x2a5: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x2c5: @ FindActor(Stack[-1], Stack[-4])
0x2c6: Pop(0)
0x2c7: Pop(0); Push((bool) Stack[-1] == 0)
0x2c8: IF (Stack[-1] == 0) GOTO 0x2cb; Pop(1)

0x2c9: Stack[-5] = (bool) 0
0x2ca: Return(); Pop(2)

0x2cb: @ Trigger(Stack[-1], Stack[-3])
0x2cc: Pop(0)
0x2cd: Stack[-5] = (bool) 1
0x2ce: Return(); Pop(2)

0x2cf: Stack[-1] = 0
0x2d0: PushEmpty(string, string)
0x2d1: Stack[-1] = "idle"
0x2d2: Push(Stack[-3])
0x2d3: IF (Stack[-1] == 0) GOTO 0x2d5; Pop(1)

0x2d4: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2d5: Stack[-4] = Stack[-1]
0x2d6: Return(); Pop(2)

0x2d7: PushEmpty(int, bool, int, bool)
0x2d8: Stack[-2] = (int) 0
0x2d9: Push("all")
...
0x2dd: Pop(1)
0x2de: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2df: Pop(2)
...
0x2e3: Push((int) 1)
0x2e4: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2e5: GOTO 0x2d9
...
0x2ef: Pop(0)
0x2f0: PushEmpty(bool, string, string)
0x2f1: Stack[-2] = "quest_k2_03"
0x2f2: Stack[-1] = "place_danko"
0x2f3: Call2 0x2c4
...
0x308: Push("Can't retrieve diary root")
0x309: @ Trace(Stack[-1])
0x30a: Pop(1)
...
0x314: Pop(1)
0x315: @@ Find(Stack[-7], Stack[-2])
0x316: Pop(0)
0x317: Pop(0); Push((bool) Stack[-2] == 0)
0x318: IF (Stack[-1] == 0) GOTO 0x31f; Pop(1)

0x319: Push("Can't find diary parent with id: ")
...
0x31f: @@ AddChild(Stack[-8])
0x320: Pop(0)
0x321: Push((int) 7)
0x322: @ SendWorldWndMessage(Stack[-1])
0x323: Pop(1)
0x324: @@ GetCategory(Stack[-1])
0x325: Pop(0)
...
0x32d: Push("branch")
0x32e: @ GetVariable(Stack[-1], Stack[-2])
0x32f: Pop(1)
0x330: Push((int) 0)
...
0x33d: Stack[-1] = (int) 515556
0x33e: Return(); Pop(0)

0x33f: Stack[-1] = (int) 503341
0x340: Return(); Pop(0)

0x341: Stack[-1] = "ui/NPC_Citizen3.png"
0x342: Return(); Pop(0)

0x343: Stack[-1] = "ui/NPC_Citizen3_b.png"
0x344: Return(); Pop(0)
