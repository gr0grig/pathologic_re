...
0x427: Pop(0)
0x428: Push(CvectorIndex(Stack[-4], 0))
...
0x46b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x46c: @ Trace(Stack[-1])
0x46d: Pop(1)
0x46e: Return(); Pop(6)
...
0x478: Pop(0)
0x479: Pop(0); Push((bool) Stack[-8] == 0)
0x47a: IF (Stack[-1] == 0) GOTO 0x48f; Pop(1)

0x47b: Stack[-7] = (int) 0
0x47c: Push((int) 1)
0x47d: Pop(1); Push(Stack[-8] + Stack[-1]);
0x47e: Pop(1); Push(Stack[-18] + Stack[-1]);
0x47f: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x480: Pop(1)
0x481: Pop(0); Push((bool) Stack[-6] == 0)
...
0x48e: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x496: Pop(0)
0x497: Push((int) 50)
0x498: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x499: Push(CvectorIndex(Stack[-1], 1))
0x49a: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x49b: CvectorIndex(Stack[-2], 1) = Stack[-1];
...
0x4a6: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4a7: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x4ad: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x4ae: Return(); Pop(2)

0x4af: PushEmpty()
0x4b0: Pop(0); Push(Stack[-2] | Stack[-1]);
0x4b1: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4b2: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4b3: Pop(2); Push(Stack[-2] * Stack[-1]);
0x4b4: Pop(1); Push(Sqrt(Stack[-1]))
0x4b5: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x4b6: Return(); Pop(0)
...
0x4ca: Pop(0)
0x4cb: Pop(0); Push((bool) Stack[-1] == 0)
...
0x4f3: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x4fe: Pop(2)
0x4ff: Pop(0); Push((bool) Stack[-1] == 0)
0x500: IF (Stack[-1] == 0) GOTO 0x502; Pop(1)

0x501: GOTO 0x505

0x502: Push((int) 1)
0x503: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x504: GOTO 0x4f8
...
0x549: Push(-1, 0); TaskCall(6)
0x54a: Call2 0x29b

0x54b: Pop(-1, 0); TaskReturn
0x54c: Pop(1)
0x54d: Return(); Pop(0)
...
0x57d: Push(-1, 3); TaskCall(5)
0x57e: Call2 0x1fe

0x57f: Pop(-1, 3); TaskReturn
0x580: Pop(1)
0x581: Return(); Pop(0)
