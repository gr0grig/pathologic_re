...
0x591: Pop(1); Push(Stack[-1] + Stack[-8]);
0x592: @ Trace(Stack[-1])
0x593: Pop(1)
0x594: Return(); Pop(6)
...
0x5a0: Pop(1); Push(Stack[-1] + Stack[-9]);
0x5a1: @ Trace(Stack[-1])
0x5a2: Pop(1)
0x5a3: Return(); Pop(6)
...
0x5a8: Push(CvectorIndex(Stack[-1], 1))
0x5a9: Stack[-1] = Stack[-3]
0x5aa: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x5ab: Push("head")
...
0x5bb: Stack[-7] = (int) 0
0x5bc: Push((int) 1)
0x5bd: Pop(1); Push(Stack[-8] + Stack[-1]);
0x5be: Pop(1); Push(Stack[-18] + Stack[-1]);
0x5bf: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x5c0: Pop(1)
0x5c1: Pop(0); Push((bool) Stack[-6] == 0)
0x5c2: IF (Stack[-1] == 0) GOTO 0x5c4; Pop(1)

0x5c3: GOTO 0x5c7

0x5c4: Push((int) 1)
0x5c5: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x5c6: GOTO 0x5bc

0x5c7: Pop(0); Push((bool) Stack[-7] == 0)
...
0x5cb: Pop(0)
0x5cc: Push((int) 1)
0x5cd: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5ce: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x5d6: Pop(0)
0x5d7: Push((int) 50)
0x5d8: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x5d9: Push(CvectorIndex(Stack[-1], 1))
0x5da: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x5db: CvectorIndex(Stack[-2], 1) = Stack[-1];
...
0x5e6: Pop(0); Push(Stack[-3] | Stack[-3]);
0x5e7: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
...
0x5ed: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x5ee: Return(); Pop(2)
...
0x601: PushEmpty()
0x602: Pop(0); Push(Stack[-2] | Stack[-1]);
0x603: Pop(0); Push(Stack[-3] | Stack[-3]);
0x604: Pop(0); Push(Stack[-3] | Stack[-3]);
0x605: Pop(2); Push(Stack[-2] * Stack[-1]);
0x606: Pop(1); Push(Sqrt(Stack[-1]))
0x607: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x608: Return(); Pop(0)

0x609: PushEmpty()
0x60a: Pop(0); Push((bool) Stack[-2] == 0)
...
0x65a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
...
0x665: Pop(2)
0x666: Pop(0); Push((bool) Stack[-1] == 0)
0x667: IF (Stack[-1] == 0) GOTO 0x669; Pop(1)

0x668: GOTO 0x66c

0x669: Push((int) 1)
0x66a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x66b: GOTO 0x65f
...
0x69c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x69d: @ Trace(Stack[-1])
0x69e: Pop(1)
