task_0_event_1(var_0_bool, var_1_bool, var_2_object, var_3_cvector, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_1907(var_56_object); // 0x17 NEW_2
...
task_0_event_3(var_0_bool, var_1_bool, var_2_object, var_3_cvector, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_1892(var_56_object); // 0x25 NEW_2
...
task_2_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_1907(var_56_object); // 0x16f NEW_2
...
task_3_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_1907(var_55_object); // 0x22f NEW_2
...
task_3_event_3(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_object, var_7_bool, var_8_object, var_9_float, var_10_float, var_11_object)
{
	...
	func_1892(var_55_object); // 0x23d NEW_2
...
task_6_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_55_object = Obj(); // 0x3eb PushV
	var_55_object = var_11_object; // 0x3ec Mov
	func_1907(var_55_object); // 0x3ed NEW_2
...
Label_1014:
	...
	func_2026(var_15_bool, var_16_object); // 0x3f8 NEW_2
	var_56_bool = var_15_bool == 0; // 0x3fa Not
	if(var_56_bool == 0) goto Label_1021; // 0x3fb JumpB
	return 2; // 0x3fc Return
	
Label_1021:
	IsPlayerActor(var_11_object, var_13_bool); // 0x3fd Func
	var_57_bool = var_13_bool; // 0x3ff Push
	if(var_57_bool == 0) goto Label_1030; // 0x400 JumpB
...
task_7_event_1(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_56_object = Obj(); // 0x43f PushV
	var_56_object = var_11_object; // 0x440 Mov
	func_1907(var_56_object); // 0x441 NEW_2
...
task_7_event_3(var_0_bool, var_1_bool, var_2_cvector, var_3_object, var_4_object, var_5_object, var_6_bool, var_7_object, var_8_float, var_9_float, var_10_object, var_11_object)
{
	...
	var_56_object = Obj(); // 0x44d PushV
	var_56_object = var_11_object; // 0x44e Mov
	func_1892(var_56_object); // 0x44f NEW_2
...
{
	var_17_object = Obj(); var_18_object = Obj(); // 0x608 PushV
	self(var_18_object); // 0x609 Func
	var_16_object = var_18_object; // 0x60b Mov
...
func_1560(var_52_float, var_53_float, var_54_float, var_55_float)
{
	var_56_bool = var_53_float < var_54_float; // 0x619 LT
	if(var_56_bool == 0) goto Label_1565; // 0x61a JumpB
	var_52_float = var_54_float; // 0x61b Mov
	return 0; // 0x61c Return
	
Label_1565:
	var_57_bool = var_53_float > var_55_float; // 0x61d GT
	if(var_57_bool == 0) goto Label_1569; // 0x61e JumpB
	var_52_float = var_55_float; // 0x61f Mov
	return 0; // 0x620 Return
	
Label_1569:
	var_52_float = var_53_float; // 0x621 Mov
	return 0; // 0x622 Return
}


func_1052(var_0_bool, var_90_int)
{
	SetSeeThreshold(var_0_bool); // 0x41c Func
	SetSeeFOV(var_90_int); // 0x41e Func
	Stop(); // 0x420 Func
...
{
	var_97_int = 0; var_98_int = 0; // 0x623 PushV
	irand(var_98_int, var_96_int); // 0x624 Func
	var_94_bool = var_98_int < var_95_int; // 0x626 LT2
	return 2; // 0x627 Return
}


func_1576(var_23_bool, var_24_object, var_25_float)
{
	var_26_bool = var_24_object == 0; // 0x629 Not
	if(var_26_bool == 0) goto Label_1581; // 0x62a JumpB
	var_23_bool = 0; // 0x62b MovB
	return 0; // 0x62c Return
	
Label_1581:
	var_27_int = 0; // 0x62d PushI
	var_28_bool = var_25_float > var_27_int; // 0x62e GT
	if(var_28_bool == 0) goto Label_1588; // 0x62f JumpB
	var_29_int = 8; // 0x630 PushI
	SendWorldWndMessage(var_29_int); // 0x631 Func
	goto Label_1597; // 0x633 Jump
	
Label_1597:
	var_30_float = 0; // 0x63d PushV
	var_30_float = var_25_float; // 0x63e Mov
	func_1611(var_30_float); // 0x63f NEW_2
	var_34_bool = 0; var_35_object = Obj(); var_36_string = ""; var_37_float = 0; var_38_float = 0; var_39_float = 0; // 0x641 PushV
	var_35_object = var_24_object; // 0x642 Mov
	var_36_string = "reputation"; // 0x643 MovS
	var_37_float = var_25_float; // 0x644 Mov
	var_38_float = 0; // 0x645 MovI
	var_39_float = 1; // 0x646 MovI
	func_1229(var_34_bool, var_35_object, var_36_string, var_37_float, var_38_float, var_39_float); // 0x647 NEW_2
	var_23_bool = 1; // 0x649 MovB
	return 0; // 0x64a Return
	
Label_1588:
	var_58_int = 0; // 0x634 PushI
	var_59_bool = var_25_float < var_58_int; // 0x635 LT
	if(var_59_bool == 0) goto Label_1595; // 0x636 JumpB
	var_60_int = 9; // 0x637 PushI
	SendWorldWndMessage(var_60_int); // 0x638 Func
	goto Label_1597; // 0x63a Jump
	
Label_1595:
	var_23_bool = 0; // 0x63b MovB
...
{
	var_31_object = Obj(); var_32_object = Obj(); // 0x64b PushV
	CreateFloatVector(var_32_object); // 0x64c Func
	add(var_30_float); // 0x64e ObjFunc
	var_33_int = 16; // 0x650 PushI
	SendWorldWndMessage(var_33_int, var_32_object); // 0x651 Func
...
{
	var_122_int = 0; var_123_int = 0; // 0x676 PushV
	var_124_string = "branch"; // 0x677 PushS
	GetVariable(var_124_string, var_123_int); // 0x678 Func
	var_121_int = var_123_int; // 0x67a Mov
...
func_1673(var_70_int, var_71_int)
{
	var_72_int = 0; var_73_bool = 0; var_74_int = 0; var_75_bool = 0; // 0x689 PushV
	var_76_bool = var_70_int > var_71_int; // 0x68a GT
	if(var_76_bool == 0) goto Label_1680; // 0x68b JumpB
	var_77_string = "GenerateMoney: iMin > iMax"; // 0x68c PushS
	Trace(var_77_string); // 0x68d Func
	return 4; // 0x68f Return
	
Label_1680:
	var_74_int = 0; // 0x690 MovI
	var_78_bool = var_70_int != var_71_int; // 0x691 Neq
	if(var_78_bool == 0) goto Label_1687; // 0x692 JumpB
	var_79_int = var_71_int - var_70_int; // 0x693 Sub
	irand(var_74_int, var_79_int); // 0x694 Func
	goto Label_1691; // 0x696 Jump
	
Label_1691:
	var_74_int = var_74_int + var_70_int; // 0x69b Add2
	var_80_int = 0; // 0x69c PushI
	var_81_bool = var_74_int == var_80_int; // 0x69d Eq
	if(var_81_bool == 0) goto Label_1696; // 0x69e JumpB
	return 4; // 0x69f Return
	
Label_1696:
	var_82_int = 0; var_83_string = ""; // 0x6a0 PushV
	var_83_string = "Money"; // 0x6a1 MovS
	func_1782(var_82_int, var_83_string); // 0x6a2 NEW_2
	var_86_int = 0; // 0x6a4 PushI
	AddItem(var_75_bool, var_82_int, var_86_int, var_74_int); // 0x6a5 Func
	return 4; // 0x6a7 Return
	
Label_1687:
	var_87_int = 0; // 0x697 PushI
	var_88_bool = var_70_int == var_87_int; // 0x698 Eq
	if(var_88_bool == 0) goto Label_1691; // 0x699 JumpB
...
func_1704(var_127_string)
{
	var_128_object = Obj(); var_129_int = 0; var_130_bool = 0; var_131_object = Obj(); var_132_int = 0; var_133_bool = 0; // 0x6a8 PushV
	CreateInvItem(var_131_object); // 0x6a9 Func
	SetItemName(var_127_string); // 0x6ab ObjFunc
	var_134_string = "Organ"; // 0x6ad PushS
	var_135_int = 1; // 0x6ae PushI
	SetProperty(var_134_string, var_135_int); // 0x6af ObjFunc
	GetItemID(var_132_int); // 0x6b1 ObjFunc
	var_136_int = 0; // 0x6b3 PushI
	var_137_int = 1; // 0x6b4 PushI
	AddItem(var_133_bool, var_131_object, var_136_int, var_137_int); // 0x6b5 Func
...
func_1721()
{
	var_121_int = 0; // 0x6b9 PushV
	func_1654(var_121_int); // 0x6ba NEW_2
	var_125_int = 1; // 0x6bc PushI
	var_126_bool = var_121_int != var_125_int; // 0x6bd Neq
	if(var_126_bool == 0) goto Label_1728; // 0x6be JumpB
	return 0; // 0x6bf Return
	
Label_1728:
	var_127_string = ""; // 0x6c0 PushV
	var_127_string = "liver"; // 0x6c1 MovS
	func_1704(var_127_string); // 0x6c2 NEW_2
	var_138_string = ""; // 0x6c4 PushV
	var_138_string = "kidney"; // 0x6c5 MovS
	func_1704(var_138_string); // 0x6c6 NEW_2
	var_139_string = ""; // 0x6c8 PushV
	var_139_string = "heart"; // 0x6c9 MovS
	func_1704(var_139_string); // 0x6ca NEW_2
	var_140_string = ""; // 0x6cc PushV
	var_140_string = "blood"; // 0x6cd MovS
	func_1704(var_140_string); // 0x6ce NEW_2
...
{
	var_21_bool = 0; var_22_bool = 0; // 0x4bc PushV
	IsPlayerActor(var_20_object, var_22_bool); // 0x4bd Func
	var_19_bool = var_22_bool; // 0x4bf Mov
...
{
	var_45_bool = 0; var_46_bool = 0; // 0x4c1 PushV
	var_47_string = "HasProperty"; // 0x4c2 PushS
	var_48_int = 2; // 0x4c3 PushI
	var_49_bool = IsFuncExist(var_43_object, var_47_string, var_48_int); // 0x4c4 FuncExist
	var_50_bool = var_49_bool == 0; // 0x4c5 Not
	if(var_50_bool == 0) goto Label_1225; // 0x4c6 JumpB
	var_42_bool = 0; // 0x4c7 MovB
	return 2; // 0x4c8 Return
	
Label_1225:
	HasProperty(var_44_string, var_46_bool); // 0x4c9 ObjFunc
	var_42_bool = var_46_bool; // 0x4cb Mov
...
func_1229(var_34_bool, var_35_object, var_36_string, var_37_float, var_38_float, var_39_float)
{
	var_40_float = 0; var_41_float = 0; // 0x4cd PushV
	var_42_bool = 0; var_43_object = Obj(); var_44_string = ""; // 0x4ce PushV
	var_43_object = var_35_object; // 0x4cf Mov
	var_44_string = var_36_string; // 0x4d0 Mov
	func_1217(var_42_bool, var_43_object, var_44_string); // 0x4d1 NEW_2
	var_51_bool = var_42_bool == 0; // 0x4d3 Not
	if(var_51_bool == 0) goto Label_1239; // 0x4d4 JumpB
	var_34_bool = 0; // 0x4d5 MovB
	return 2; // 0x4d6 Return
	
Label_1239:
	GetProperty(var_36_string, var_41_float); // 0x4d7 ObjFunc
	var_52_float = 0; var_53_float = 0; var_54_float = 0; var_55_float = 0; // 0x4d9 PushV
	var_53_float = var_41_float + var_37_float; // 0x4da Add2
	var_54_float = var_38_float; // 0x4db Mov
	var_55_float = var_39_float; // 0x4dc Mov
	func_1560(var_52_float, var_53_float, var_54_float, var_55_float); // 0x4dd NEW_2
	SetProperty(var_36_string, var_52_float); // 0x4df ObjFunc
...
func_1745()
{
	var_65_int = 0; var_66_bool = 0; var_67_int = 0; var_68_bool = 0; // 0x6d1 PushV
	var_69_int = 0; // 0x6d2 PushI
	ClearSubContainer(var_69_int); // 0x6d3 Func
	var_70_int = 0; var_71_int = 0; // 0x6d5 PushV
	var_70_int = 600; // 0x6d6 MovI
	var_71_int = 1500; // 0x6d7 MovI
	func_1673(var_70_int, var_71_int); // 0x6d8 NEW_2
	var_89_string = ""; var_90_int = 0; var_91_int = 0; // 0x6da PushV
	var_89_string = "fresh_meat"; // 0x6db MovS
	var_90_int = 1; // 0x6dc MovI
	var_91_int = 6; // 0x6dd MovI
	func_1477(var_89_string, var_90_int, var_91_int); // 0x6de NEW_2
	var_100_string = ""; var_101_int = 0; var_102_int = 0; var_103_int = 0; // 0x6e0 PushV
	var_100_string = "rusk"; // 0x6e1 MovS
	var_101_int = 1; // 0x6e2 MovI
	var_102_int = 6; // 0x6e3 MovI
	var_103_int = 2; // 0x6e4 MovI
	func_1488(var_100_string, var_101_int, var_102_int, var_103_int); // 0x6e5 NEW_2
	var_114_string = ""; var_115_int = 0; var_116_int = 0; // 0x6e7 PushV
	var_114_string = "gamma_pills"; // 0x6e8 MovS
	var_115_int = 1; // 0x6e9 MovI
	var_116_int = 3; // 0x6ea MovI
	func_1477(var_114_string, var_115_int, var_116_int); // 0x6eb NEW_2
	var_117_int = 0; var_118_string = ""; // 0x6ed PushV
	var_118_string = "bomber_mark"; // 0x6ee MovS
	func_1782(var_117_int, var_118_string); // 0x6ef NEW_2
	var_119_int = 0; // 0x6f1 PushI
	var_120_int = 1; // 0x6f2 PushI
	AddItem(var_68_bool, var_117_int, var_119_int, var_120_int); // 0x6f3 Func
...
Label_294:
	...
	func_1503(var_217_string); // 0x128 NEW_2
...
func_1782(var_82_int, var_83_string)
{
	var_84_int = 0; var_85_int = 0; // 0x6f6 PushV
	GetInvItemByName(var_85_int, var_83_string); // 0x6f7 Func
	var_82_int = var_85_int; // 0x6f9 Mov
...
func_317(var_164_string)
{
	...
	func_1503(var_165_string); // 0x14a NEW_2
...
func_1885(var_12_bool, var_13_object)
{
	...
	func_2026(var_14_bool, var_15_object); // 0x760 NEW_2
...
{
	var_57_object = Obj(); // 0x765 PushV
	var_57_object = var_56_object; // 0x766 Mov
	TaskCall(2); // 0x767 TaskCall
	func_349(var_57_object); // 0x768 NEW_2
...
func_1900(var_12_bool, var_13_object)
{
	...
	func_2026(var_14_bool, var_15_object); // 0x76f NEW_2
...
{
	var_57_object = Obj(); // 0x774 PushV
	var_57_object = var_56_object; // 0x775 Mov
	TaskCall(4); // 0x776 TaskCall
	func_683(var_56_object, var_58_object, var_59_bool, var_57_object); // 0x777 NEW_2
...
Label_398:
	...
	func_2026(var_66_bool, var_67_object); // 0x190 NEW_2
...
func_410(var_14_bool, var_15_object)
{
	...
	func_2026(var_16_bool, var_17_object); // 0x19d NEW_2
...
func_924(var_0_bool, var_50_object)
{
	...
	func_2026(var_53_bool, var_54_object); // 0x3a3 NEW_2
...
func_1949(var_12_object)
{
	...
	func_2043(); // 0x7a0 NEW_2
	var_19_bool = 0; var_20_object = Obj(); // 0x7a2 PushV
	var_20_object = var_12_object; // 0x7a3 Mov
	func_1212(var_19_bool, var_20_object); // 0x7a4 NEW_2
	if(var_19_bool == 0) goto Label_1964; // 0x7a6 JumpB
	var_23_bool = 0; var_24_object = Obj(); var_25_float = 0; // 0x7a7 PushV
	var_24_object = var_12_object; // 0x7a8 Mov
	var_25_float = 0.05; // 0x7a9 MovF
	func_1576(var_23_bool, var_24_object, var_25_float); // 0x7aa NEW_2
	
Label_1964:
	var_61_object = Obj(); // 0x7ac PushV
	var_61_object = var_12_object; // 0x7ad Mov
	TaskCall(1); // 0x7ae TaskCall
	func_185(var_61_object); // 0x7af NEW_2
...
func_417(var_0_bool, var_1_bool, var_2_cvector, var_61_object, var_62_bool, var_84_float)
{
	...
	func_1292(var_65_bool, var_66_object); // 0x1a4 NEW_2
...
Label_425:
	...
	func_1621(var_68_object); // 0x1ac NEW_2
...
Label_452:
	...
	func_940(var_84_float, var_85_float, var_86_object, var_82_object, var_83_object); // 0x1ca NEW_2
	...
	func_1292(var_108_bool, var_109_object); // 0x1d4 NEW_2
...
func_940(var_0_bool, var_1_bool, var_2_cvector, var_82_object, var_83_object)
{
	var_87_bool = 0; var_88_int = 0; var_89_bool = 0; var_90_int = 0; // 0x3ac PushV
	GetSeeThreshold(var_0_bool); // 0x3ad Func
	GetSeeFOV(var_90_int); // 0x3af Func
	var_91_float = 1.5; // 0x3b1 PushF
	var_92_float = var_0_bool / var_91_float; // 0x3b2 Div
	SetSeeThreshold(var_92_float); // 0x3b3 Func
	var_2_cvector = var_83_object; // 0x3b5 TMov
	var_93_object = Obj(); // 0x3b6 PushV
	var_93_object = var_2_cvector; // 0x3b7 MovT
	func_1621(var_93_object); // 0x3b8 NEW_2
	var_90_int = 0; // 0x3ba MovI
	
Label_955:
	var_94_int = 3; // 0x3bb PushI
	var_95_bool = var_90_int < var_94_int; // 0x3bc LT
	if(var_95_bool == 0) goto Label_986; // 0x3bd JumpB
	var_96_float = 1.8; // 0x3be PushF
	var_97_float = var_1_bool * var_96_float; // 0x3bf Mult
	SetSeeFOV(var_97_float); // 0x3c0 Func
	var_98_string = "all"; // 0x3c2 PushS
	var_99_string = "hunt"; // 0x3c3 PushS
	PlayAnimation(var_98_string, var_99_string); // 0x3c4 Func
	WaitForAnimEnd(var_89_bool); // 0x3c6 Func
	SetSeeFOV(var_90_int); // 0x3c8 Func
	var_100_bool = var_89_bool == 0; // 0x3ca Not
	if(var_100_bool == 0) goto Label_973; // 0x3cb JumpB
	goto Label_986; // 0x3cc Jump
	
Label_986:
	func_1052(var_89_bool, var_90_int); // 0x3db NEW_2
	var_101_bool = var_89_bool; // 0x3dd Push
	if(var_101_bool == 0) goto Label_992; // 0x3de JumpB
	var_2_cvector = 0; // 0x3df SetNullT
	
Label_992:
	var_82_object = var_2_cvector; // 0x3e0 MovT
	return 4; // 0x3e1 Return
	
Label_973:
	var_102_int = 2; // 0x3cd PushI
	Sleep(var_102_int, var_89_bool); // 0x3ce Func
	var_103_bool = var_89_bool == 0; // 0x3d0 Not
	if(var_103_bool == 0) goto Label_979; // 0x3d1 JumpB
	goto Label_986; // 0x3d2 Jump
	
Label_979:
	var_104_object = Obj(); // 0x3d3 PushV
	var_104_object = var_2_cvector; // 0x3d4 MovT
	func_1621(var_104_object); // 0x3d5 NEW_2
	var_105_int = 1; // 0x3d7 PushI
	var_90_int = var_90_int + var_105_int; // 0x3d8 Add2
...
func_1477(var_89_string, var_90_int, var_91_int)
{
	var_92_bool = 0; var_93_bool = 0; // 0x5c5 PushV
	var_94_bool = 0; var_95_int = 0; var_96_int = 0; // 0x5c6 PushV
	var_95_int = var_90_int; // 0x5c7 Mov
	var_96_int = var_91_int; // 0x5c8 Mov
	func_1571(var_94_bool, var_95_int, var_96_int); // 0x5c9 NEW_2
	if(var_94_bool == 0) goto Label_1487; // 0x5cb JumpB
	var_99_int = 0; // 0x5cc PushI
	AddItem(var_93_bool, var_89_string, var_99_int); // 0x5cd Func
...
func_1488(var_100_string, var_101_int, var_102_int, var_103_int)
{
	var_104_int = 0; var_105_bool = 0; var_106_int = 0; var_107_bool = 0; // 0x5d0 PushV
	var_108_bool = 0; var_109_int = 0; var_110_int = 0; // 0x5d1 PushV
	var_109_int = var_101_int; // 0x5d2 Mov
	var_110_int = var_102_int; // 0x5d3 Mov
	func_1571(var_108_bool, var_109_int, var_110_int); // 0x5d4 NEW_2
	if(var_108_bool == 0) goto Label_1502; // 0x5d6 JumpB
	irand(var_106_int, var_103_int); // 0x5d7 Func
	var_111_int = 0; // 0x5d9 PushI
	var_112_int = 1; // 0x5da PushI
	var_113_int = var_106_int + var_112_int; // 0x5db Add
	AddItem(var_107_bool, var_100_string, var_111_int, var_113_int); // 0x5dc Func
...
{
	var_166_bool = 0; var_167_int = 0; var_168_bool = 0; var_169_int = 0; var_170_bool = 0; var_171_float = 0; var_172_cvector = CVector(0,0,0); var_173_cvector = CVector(0,0,0); var_174_bool = 0; var_175_int = 0; var_176_bool = 0; var_177_int = 0; var_178_bool = 0; var_179_float = 0; var_180_cvector = CVector(0,0,0); var_181_cvector = CVector(0,0,0); // 0x5df PushV
	IsExisting3DSound(var_174_bool, var_165_string); // 0x5e0 Func
	var_182_bool = var_174_bool == 0; // 0x5e2 Not
	if(var_182_bool == 0) goto Label_1528; // 0x5e3 JumpB
	var_175_int = 0; // 0x5e4 MovI
	
Label_1509:
	var_183_int = 1; // 0x5e5 PushI
	var_184_int = var_175_int + var_183_int; // 0x5e6 Add
	var_185_int = var_165_string + var_184_int; // 0x5e7 Add
	IsExisting3DSound(var_176_bool, var_185_int); // 0x5e8 Func
	var_186_bool = var_176_bool == 0; // 0x5ea Not
	if(var_186_bool == 0) goto Label_1517; // 0x5eb JumpB
	goto Label_1520; // 0x5ec Jump
	
Label_1520:
	var_187_bool = var_175_int == 0; // 0x5f0 Not
	if(var_187_bool == 0) goto Label_1523; // 0x5f1 JumpB
	return 16; // 0x5f2 Return
	
Label_1523:
	irand(var_177_int, var_175_int); // 0x5f3 Func
	var_188_int = 1; // 0x5f5 PushI
	var_189_int = var_177_int + var_188_int; // 0x5f6 Add
	var_165_string = var_165_string + var_189_int; // 0x5f7 Add2
	
Label_1528:
	Is3DSoundLoaded(var_178_bool, var_165_string); // 0x5f8 Func
	var_190_bool = var_178_bool; // 0x5fa Push
	if(var_190_bool == 0) goto Label_1543; // 0x5fb JumpB
	GetEyesHeight(var_179_float); // 0x5fc Func
	GetDirection(var_180_cvector); // 0x5fe Func
	var_191_int = 50; // 0x600 PushI
	var_181_cvector = var_180_cvector * var_191_int; // 0x601 Mult2
	var_192_float = GetByIndex(var_181_cvector, 1); // 0x602 PushE
	var_192_float = var_192_float + var_179_float; // 0x603 Add2
	SetByIndex(var_181_cvector, 1) = var_192_float; // 0x604 PopE
	PlayGlobalSound(var_165_string, var_181_cvector); // 0x605 Func
	
Label_1543:
	return 16; // 0x607 Return
	
Label_1517:
	var_193_int = 1; // 0x5ed PushI
	var_175_int = var_175_int + var_193_int; // 0x5ee Add2
...
func_2015()
{
	var_14_object = Obj(); var_15_object = Obj(); // 0x7df PushV
	GetScene(var_15_object); // 0x7e0 Func
	var_16_object = Obj(); // 0x7e2 PushV
	func_1544(var_16_object); // 0x7e3 NEW_2
	RemoveStationaryActor(var_16_object); // 0x7e5 ObjFunc
...
{
	var_16_bool = 0; var_17_object = Obj(); // 0x7eb PushV
	var_17_object = var_15_object; // 0x7ec Mov
	func_1292(var_16_bool, var_17_object); // 0x7ed NEW_2
	var_50_bool = var_16_bool == 0; // 0x7ef Not
	if(var_50_bool == 0) goto Label_2035; // 0x7f0 JumpB
	var_14_bool = 0; // 0x7f1 MovB
	return 0; // 0x7f2 Return
	
Label_2035:
	var_51_bool = 0; var_52_object = Obj(); // 0x7f3 PushV
	var_52_object = var_15_object; // 0x7f4 Mov
	func_1212(var_51_bool, var_52_object); // 0x7f5 NEW_2
	var_14_bool = var_51_bool; // 0x7f6 Mov
