...
0x4f6: @ StopWorld()
0x4f7: Pop(0)
0x4f8: @ CameraTransit(Stack[-3], Stack[-5])
0x4f9: Pop(0)
0x4fa: Push(CvectorIndex(Stack[-4], 0))
0x4fb: Push(CvectorIndex(Stack[-5], 2))
0x4fc: @ Rotate(Stack[-2], Stack[-1])
0x4fd: Pop(2)
...
0x503: Push("head")
0x504: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x505: Pop(1)
0x506: Push(Stack[-1])
0x507: IF (Stack[-1] == 0) GOTO 0x50b; Pop(1)

0x508: Push("head")
0x509: @ LookAsyncCamera(Stack[-1])
0x50a: Pop(1)
0x50b: @ CameraWaitForPlayFinish()
0x50c: Pop(0)
0x50d: @ ResumeWorld()
0x50e: Pop(0)
0x50f: Stack[-21] = (bool) 1
0x510: Return(); Pop(18)

0x511: PushEmpty(bool, bool)
0x512: @ CameraSwitchToNormal()
0x513: Pop(0)
...
0x519: Push("head")
0x51a: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x51b: Pop(1)
0x51c: Push(Stack[-1])
0x51d: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x51e: Push("head")
0x51f: @ UnlookAsync(Stack[-1])
0x520: Pop(1)
0x521: Return(); Pop(2)

0x522: PushEmpty(int, int, int, int)
0x523: Push("voice_common")
0x524: @ GetVariable(Stack[-1], Stack[-3])
0x525: Pop(1)
0x526: Push(Stack[-2])
0x527: IF (Stack[-1] == 0) GOTO 0x548; Pop(1)

0x528: PushEmpty(bool, object)
0x529: Stack[-1] = Stack[-7]
0x52a: Call2 0x55c
...
0x536: Push((int) 2)
0x537: @ irand(Stack[-2], Stack[-1])
0x538: Pop(1)
0x539: Push(Stack[-1])
0x53a: IF (Stack[-1] == 0) GOTO 0x543; Pop(1)

0x53b: Push("voice_common")
0x53c: Push((int) 1)
0x53d: Pop(1); Push(Stack[-4] + Stack[-1]);
0x53e: Push((int) 3)
0x53f: Pop(2); Push(Stack[-2] % Stack[-1]);
0x540: @ SetVariable(Stack[-2], Stack[-1])
0x541: Pop(2)
0x542: GOTO 0x547

0x543: Push("voice_common")
0x544: Push((int) 0)
...
0x54b: Pop(1)
0x54c: Pop(1); Push((bool) Stack[-1] == 0)
0x54d: IF (Stack[-1] == 0) GOTO 0x556; Pop(1)
...
0x551: Pop(1)
0x552: Pop(1); Push((bool) Stack[-1] == 0)
...
0x559: Pop(2)
0x55a: Stack[-6] = (bool) 1
0x55b: Return(); Pop(4)

0x55c: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x55d: Stack[-5] = "c"
0x55e: Stack[-4] = (int) 0
0x55f: Push((int) 1)
0x560: IF (Stack[-1] == 0) GOTO 0x56c; Pop(1)

0x561: Push((int) 1)
0x562: Pop(1); Push(Stack[-5] + Stack[-1]);
0x563: Pop(1); Push(Stack[-6] + Stack[-1]);
0x564: @@ HasProperty(Stack[-1], Stack[-4])
0x565: Pop(1)
...
0x569: Push((int) 1)
0x56a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x56b: GOTO 0x55f

0x56c: Pop(0); Push((bool) Stack[-4] == 0)
0x56d: IF (Stack[-1] == 0) GOTO 0x570; Pop(1)

0x56e: Stack[-12] = (bool) 0
0x56f: Return(); Pop(10)

0x570: Stack[-2] = (int) 0
0x571: Push((int) 1)
0x572: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x573: IF (Stack[-1] == 0) GOTO 0x576; Pop(1)

0x574: @ irand(Stack[-2], Stack[-4])
0x575: Pop(0)
0x576: Push((int) 1)
0x577: Pop(1); Push(Stack[-3] + Stack[-1]);
0x578: Pop(1); Push(Stack[-6] + Stack[-1]);
0x579: @@ GetProperty(Stack[-1], Stack[-2])
0x57a: Pop(1)
0x57b: PushEmpty(bool, string)
0x57c: Stack[-1] = Stack[-3]
0x57d: Call2 0x5cb

0x57e: Stack[-14] = Stack[-2]
0x57f: Pop(2)
0x580: Return(); Pop(10)

0x581: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x582: Push("d")
0x583: PushEmpty(int)
0x584: Call2 0x683
...
0x587: Push("m")
0x588: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x589: Stack[-4] = (int) 0
0x58a: Push((int) 1)
...
0x58f: @@ HasProperty(Stack[-1], Stack[-4])
0x590: Pop(1)
...
0x5a9: Stack[-14] = Stack[-2]
0x5aa: Pop(2)
0x5ab: Return(); Pop(10)

0x5ac: PushEmpty(bool, float, float, bool, float, float)
0x5ad: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5ae: Pop(0)
0x5af: Push(Stack[-3])
0x5b0: IF (Stack[-1] == 0) GOTO 0x5b7; Pop(1)

0x5b1: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5b2: Pop(0)
0x5b3: Push((bool) 0)
0x5b4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5b5: Pop(1)
0x5b6: GOTO 0x5bb

0x5b7: Push("Can't find lsh animation : ")
0x5b8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x5b9: @ Trace(Stack[-1])
0x5ba: Pop(1)
0x5bb: Return(); Pop(6)

0x5bc: PushEmpty(bool, float, float, bool, float, float)
0x5bd: @ lshHasAnimation(Stack[-3], Stack[-8])
0x5be: Pop(0)
0x5bf: Push(Stack[-3])
0x5c0: IF (Stack[-1] == 0) GOTO 0x5c6; Pop(1)

0x5c1: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x5c2: Pop(0)
0x5c3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x5c4: Pop(0)
0x5c5: GOTO 0x5ca

0x5c6: Push("Can't find lsh animation : ")
0x5c7: Pop(1); Push(Stack[-1] + Stack[-9]);
0x5c8: @ Trace(Stack[-1])
0x5c9: Pop(1)
0x5ca: Return(); Pop(6)
...
0x5d0: @ lshHasSpeech(Stack[-1], Stack[-3])
0x5d1: Pop(0)
0x5d2: Push(Stack[-1])
0x5d3: IF (Stack[-1] == 0) GOTO 0x5d8; Pop(1)

0x5d4: @ lshPlaySpeech(Stack[-3])
0x5d5: Pop(0)
0x5d6: Stack[-4] = (bool) 1
0x5d7: Return(); Pop(2)

0x5d8: Stack[-4] = (bool) 0
0x5d9: Return(); Pop(2)
...
0x5f1: PushEmpty()
0x5f2: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x5f3: IF (Stack[-1] == 0) GOTO 0x5f6; Pop(1)

0x5f4: Stack[-4] = Stack[-2]
0x5f5: Return(); Pop(0)

0x5f6: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x5f7: IF (Stack[-1] == 0) GOTO 0x5fa; Pop(1)

0x5f8: Stack[-4] = Stack[-1]
0x5f9: Return(); Pop(0)

0x5fa: Stack[-4] = Stack[-3]
0x5fb: Return(); Pop(0)

0x5fc: PushEmpty(int, int)
0x5fd: @ GetVariable(Stack[-3], Stack[-1])
0x5fe: Pop(0)
0x5ff: Stack[-4] = Stack[-1]
0x600: Return(); Pop(2)

0x601: PushEmpty(object, object, object, object)
0x602: @ GetMainOutdoorScene(Stack[-2])
0x603: Pop(0)
0x604: Push(".bin")
0x605: Pop(1); Push(Stack[-6] + Stack[-1]);
0x606: @ AddBlankActor(Stack[-2], Stack[-3], Stack[-6], Stack[-1])
0x607: Pop(1)
0x608: Stack[-6] = Stack[-1]
0x609: Return(); Pop(4)

0x60a: Stack[-1] = 0
0x60b: Stack[-2] = 0
0x60c: PushEmpty(object, object)
0x60d: @ CreateIntVector(Stack[-1])
0x60e: Pop(0)
0x60f: @@ add(Stack[-4])
0x610: Pop(0)
0x611: @@ add(Stack[-3])
0x612: Pop(0)
0x613: Push((int) 3)
0x614: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x615: Pop(1)
0x616: Return(); Pop(2)

0x617: Stack[-1] = 0
0x618: PushEmpty(int, int)
0x619: PushEmpty(object, string, int)
0x61a: Stack[-3] = Stack[-7]
0x61b: Stack[-2] = "money"
0x61c: Stack[-1] = Stack[-6]
0x61d: Call2 0x4ae

0x61e: Pop(3)
0x61f: Push((int) 0)
0x620: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x621: IF (Stack[-1] == 0) GOTO 0x62a; Pop(1)

0x622: Push("Money")
0x623: @ GetInvItemByName(Stack[-2], Stack[-1])
0x624: Pop(1)
0x625: PushEmpty(int, int)
0x626: Stack[-2] = Stack[-3]
0x627: Stack[-1] = Stack[-5]
0x628: Call2 0x60c

0x629: Pop(2)
0x62a: Return(); Pop(2)

0x62b: PushEmpty(int, int, bool, int, int, bool)
0x62c: @@ GetItemID(Stack[-3])
0x62d: Pop(0)
0x62e: Push("Category")
0x62f: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x630: Pop(1)
0x631: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7])
0x632: Pop(0)
0x633: Pop(0); Push((bool) Stack[-1] == 0)
0x634: IF (Stack[-1] == 0) GOTO 0x638; Pop(1)

0x635: @@ DropItems(Stack[-8], Stack[-7])
0x636: Pop(0)
0x637: GOTO 0x63d

0x638: PushEmpty(int, int)
0x639: Stack[-2] = Stack[-5]
0x63a: Stack[-1] = Stack[-9]
0x63b: Call2 0x60c
...
0x63f: @ GetInvItemByName(Stack[-2], Stack[-5])
0x640: Pop(0)
0x641: @@ HasItem(Stack[-2], Stack[-1])
0x642: Pop(0)
0x643: Stack[-7] = Stack[-1]
0x644: Return(); Pop(4)

0x645: PushEmpty()
0x646: Pop(0); Push((bool) Stack[-2] == 0)
0x647: IF (Stack[-1] == 0) GOTO 0x64a; Pop(1)

0x648: Stack[-3] = (bool) 0
0x649: Return(); Pop(0)
...
0x64d: Push((int) 8)
0x64e: @ SendWorldWndMessage(Stack[-1])
0x64f: Pop(1)
0x650: GOTO 0x65a
...
0x654: Push((int) 9)
0x655: @ SendWorldWndMessage(Stack[-1])
0x656: Pop(1)
0x657: GOTO 0x65a
...
0x65d: Pop(1)
0x65e: PushEmpty(bool, object, string, float, float, float)
0x65f: Stack[-5] = Stack[-8]
0x660: Stack[-4] = "reputation"
0x661: Stack[-3] = Stack[-7]
0x662: Stack[-2] = (int) 0
0x663: Stack[-1] = (int) 1
0x664: Call2 0x498

0x665: Pop(6)
0x666: Stack[-3] = (bool) 1
0x667: Return(); Pop(0)

0x668: PushEmpty(object, object)
0x669: @ CreateFloatVector(Stack[-1])
0x66a: Pop(0)
0x66b: @@ add(Stack[-3])
0x66c: Pop(0)
0x66d: Push((int) 16)
0x66e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x66f: Pop(1)
0x670: Return(); Pop(2)

0x671: Stack[-1] = 0
0x672: PushEmpty(object, object)
0x673: @ FindActor(Stack[-1], Stack[-4])
0x674: Pop(0)
0x675: Pop(0); Push((bool) Stack[-1] == 0)
0x676: IF (Stack[-1] == 0) GOTO 0x679; Pop(1)

0x677: Stack[-5] = (bool) 0
0x678: Return(); Pop(2)

0x679: @ Trigger(Stack[-1], Stack[-3])
0x67a: Pop(0)
0x67b: Stack[-5] = (bool) 1
0x67c: Return(); Pop(2)
...
0x680: Pop(0)
0x681: Stack[-3] = Stack[-1]
0x682: Return(); Pop(2)

0x683: PushEmpty(float, float)
0x684: @ GetGameTime(Stack[-1])
0x685: Pop(0)
0x686: Push((int) 1)
0x687: PushEmpty(int)
0x688: Push((int) 24)
0x689: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x68a: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x68b: Return(); Pop(2)

0x68c: PushEmpty(string, string)
0x68d: Stack[-1] = "idle"
0x68e: Push(Stack[-3])
0x68f: IF (Stack[-1] == 0) GOTO 0x691; Pop(1)

0x690: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x691: Stack[-4] = Stack[-1]
0x692: Return(); Pop(2)

0x693: PushEmpty(int, bool, int, bool)
0x694: Stack[-2] = (int) 0
0x695: Push("all")
0x696: PushEmpty(string, int)
0x697: Stack[-1] = Stack[-5]
0x698: Call2 0x68c

0x699: Pop(1)
0x69a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x69b: Pop(2)
...
0x69f: Push((int) 1)
0x6a0: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6a1: GOTO 0x695

0x6a2: Stack[-5] = Stack[-2]
0x6a3: Return(); Pop(4)

0x6a4: PushEmpty()
0x6a5: PushEmpty(bool, object, float)
0x6a6: Stack[-2] = Stack[-5]
0x6a7: Stack[-1] = (float) 0.05
0x6a8: Call2 0x645
...
0x6ad: Stack[-1] = "k7q01CorpseMark"
0x6ae: Call2 0x5fc

0x6af: Pop(1)
0x6b0: Push((int) 0)
0x6b1: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x6b2: IF (Stack[-1] == 0) GOTO 0x6ca; Pop(1)

0x6b3: Push("k7q01CorpseMark")
0x6b4: Push((int) 1)
...
0x6ba: Pop(1)
0x6bb: Push("k7q01BirdmaskGotoCorpse")
0x6bc: Push("pt_d7q02_corpse")
0x6bd: Push((int) 3)
0x6be: Push((int) 526214)
0x6bf: PushEmpty(float)
0x6c0: Call2 0x67e

0x6c1: Pop(0)
0x6c2: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6c3: Pop(5)
0x6c4: PushEmpty(bool, string, string)
0x6c5: Stack[-2] = "quest_k7_01"
0x6c6: Stack[-1] = "place_corpse"
0x6c7: Call2 0x672
...
0x6d8: Pop(0)
0x6d9: Push("bird_mask")
0x6da: Push((int) 1)
0x6db: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1])
0x6dc: Pop(2)
0x6dd: Return(); Pop(2)

0x6de: PushEmpty()
0x6df: Push("ook7DankoTheater2")
0x6e0: Push((int) 1)
0x6e1: @ SetVariable(Stack[-2], Stack[-1])
0x6e2: Pop(2)
0x6e3: Return(); Pop(0)
...
0x6e8: Pop(1)
0x6e9: Push("k7q02DankoGotoGatherer")
0x6ea: Push("pt_gatherer3")
0x6eb: Push((int) 0)
0x6ec: Push((int) 526372)
0x6ed: PushEmpty(float)
0x6ee: Call2 0x67e

0x6ef: Pop(0)
0x6f0: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6f1: Pop(5)
0x6f2: PushEmpty()
0x6f3: Call2 0x797
...
0x6f7: Pop(0)
0x6f8: PushEmpty(object, string)
0x6f9: Stack[-1] = "quest_k7_02"
0x6fa: Call2 0x601
...
0x708: PushEmpty()
0x709: PushEmpty(object, string, float)
0x70a: PushEmpty(object)
0x70b: Call2 0x7e7

0x70c: Stack[-4] = Stack[-1]
0x70d: Pop(1)
0x70e: Stack[-2] = "pt_gatherer3"
0x70f: Stack[-1] = (int) 2
0x710: Call2 0x7f8
...
0x714: Pop(0)
0x715: @@ ShowMap(Stack[-1])
0x716: Pop(1)
0x717: Return(); Pop(0)

0x718: PushEmpty()
0x719: Push("playsound")
0x71a: Push("givemoney")
0x71b: @ TriggerWorld(Stack[-2], Stack[-1])
0x71c: Pop(2)
0x71d: Return(); Pop(0)

0x71e: PushEmpty()
0x71f: Push("playsound")
0x720: Push("giveitem")
0x721: @ TriggerWorld(Stack[-2], Stack[-1])
0x722: Pop(2)
0x723: Return(); Pop(0)

0x724: PushEmpty()
0x725: Push("money 5000 is given")
0x726: @ Trace(Stack[-1])
0x727: Pop(1)
0x728: PushEmpty(object, int)
0x729: Stack[-2] = Stack[-4]
0x72a: Stack[-1] = (int) 5000
0x72b: Call2 0x618
...
0x72f: Push("Samopal is given")
0x730: @ Trace(Stack[-1])
0x731: Pop(1)
0x732: @ CreateInvItem(Stack[-1])
0x733: Pop(0)
0x734: Push("Samopal")
0x735: @@ SetItemName(Stack[-1])
0x736: Pop(1)
0x737: Push("durability")
0x738: Push((int) 30)
0x739: @@ SetProperty(Stack[-2], Stack[-1])
0x73a: Pop(2)
0x73b: PushEmpty(object, object, int)
...
0x74b: Stack[-2] = (bool) 1
0x74c: Return(); Pop(0)

0x74d: Stack[-2] = (bool) 0
0x74e: Return(); Pop(0)

0x74f: PushEmpty()
0x750: PushEmpty(bool, object, string)
0x751: Stack[-2] = Stack[-4]
0x752: Stack[-1] = "bird_mask"
0x753: Call2 0x63e

0x754: Pop(2)
0x755: IF (Stack[-1] == 0) GOTO 0x758; Pop(1)

0x756: Stack[-2] = (bool) 1
0x757: Return(); Pop(0)

0x758: Stack[-2] = (bool) 0
0x759: Return(); Pop(0)

0x75a: PushEmpty()
0x75b: PushEmpty(int, string)
0x75c: Stack[-1] = "ook7DankoTheater1"
0x75d: Call2 0x5fc
...
0x762: Stack[-2] = (bool) 1
0x763: Return(); Pop(0)

0x764: Stack[-2] = (bool) 0
0x765: Return(); Pop(0)

0x766: PushEmpty()
0x767: PushEmpty(int, string)
0x768: Stack[-1] = "ook7DankoTheater2"
0x769: Call2 0x5fc

0x76a: Pop(1)
0x76b: Push((int) 0)
0x76c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x76d: IF (Stack[-1] == 0) GOTO 0x770; Pop(1)

0x76e: Stack[-2] = (bool) 1
0x76f: Return(); Pop(0)

0x770: Stack[-2] = (bool) 0
0x771: Return(); Pop(0)
...
0x7a5: Push((int) 433)
0x7a6: Push((int) 2)
0x7a7: Push((int) 526371)
0x7a8: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x7a9: Pop(3)
0x7aa: PushEmpty(bool, object, int)
0x7ab: Stack[-2] = Stack[-4]
0x7ac: Stack[-1] = (int) 430
0x7ad: Call2 0x7cb
...
0x7b2: Push((int) 431)
0x7b3: Push((int) 2)
0x7b4: Push((int) 526369)
0x7b5: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x7b6: Pop(3)
0x7b7: PushEmpty(bool, object, int)
0x7b8: Stack[-2] = Stack[-4]
0x7b9: Stack[-1] = (int) 430
0x7ba: Call2 0x7cb
...
0x7bf: @ GetDiaryRoot(Stack[-1])
0x7c0: Pop(0)
0x7c1: Pop(0); Push((bool) Stack[-1] == 0)
0x7c2: IF (Stack[-1] == 0) GOTO 0x7c8; Pop(1)

0x7c3: Push("Can't retrieve diary root")
0x7c4: @ Trace(Stack[-1])
0x7c5: Pop(1)
...
0x7ca: Stack[-1] = 0
0x7cb: PushEmpty(object, object, int, object, object, int)
0x7cc: PushEmpty(object)
0x7cd: Call2 0x7be

0x7ce: Stack[-4] = Stack[-1]
0x7cf: Pop(1)
0x7d0: @@ Find(Stack[-7], Stack[-2])
0x7d1: Pop(0)
0x7d2: Pop(0); Push((bool) Stack[-2] == 0)
0x7d3: IF (Stack[-1] == 0) GOTO 0x7da; Pop(1)

0x7d4: Push("Can't find diary parent with id: ")
0x7d5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7d6: @ Trace(Stack[-1])
0x7d7: Pop(1)
0x7d8: Stack[-9] = (bool) 0
0x7d9: Return(); Pop(6)

0x7da: @@ AddChild(Stack[-8])
0x7db: Pop(0)
0x7dc: Push((int) 7)
0x7dd: @ SendWorldWndMessage(Stack[-1])
0x7de: Pop(1)
0x7df: @@ GetCategory(Stack[-1])
0x7e0: Pop(0)
0x7e1: @ SetDiarySection(Stack[-1])
0x7e2: Pop(0)
0x7e3: Stack[-9] = (bool) 0
0x7e4: Return(); Pop(6)

0x7e5: Stack[-2] = 0
0x7e6: Stack[-3] = 0
0x7e7: PushEmpty(object, object, object, object)
0x7e8: @ GetMainOutdoorScene(Stack[-2])
0x7e9: Pop(0)
0x7ea: Pop(0); Push((bool) Stack[-2] == 0)
0x7eb: IF (Stack[-1] == 0) GOTO 0x7f2; Pop(1)

0x7ec: Push("Can't find main outdoor scene")
0x7ed: @ Trace(Stack[-1])
0x7ee: Pop(1)
0x7ef: Stack[-1] = 0
...
0x7f2: @@ GetMap(Stack[-1])
0x7f3: Pop(0)
0x7f4: Stack[-5] = Stack[-1]
0x7f5: Return(); Pop(4)

0x7f6: Stack[-1] = 0
0x7f7: Stack[-2] = 0
0x7f8: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x7f9: @ GetMainOutdoorScene(Stack[-2])
0x7fa: Pop(0)
0x7fb: Pop(0); Push((bool) Stack[-2] == 0)
0x7fc: IF (Stack[-1] == 0) GOTO 0x801; Pop(1)

0x7fd: Push("Can't find main outdoor scene")
0x7fe: @ Trace(Stack[-1])
0x7ff: Pop(1)
0x800: Return(); Pop(8)

0x801: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3])
0x802: Pop(0)
0x803: Pop(0); Push((bool) Stack[-1] == 0)
0x804: IF (Stack[-1] == 0) GOTO 0x80b; Pop(1)

0x805: Push("Warning: outdoor scene locator ")
0x806: Pop(1); Push(Stack[-1] + Stack[-11]);
0x807: Push(" doesnt exist")
0x808: Pop(2); Push(Stack[-2] + Stack[-1]);
0x809: @ Trace(Stack[-1])
0x80a: Pop(1)
0x80b: @@ GetMap(Stack[-11])
0x80c: Pop(0)
0x80d: Pop(0); Push((bool) Stack[-11] == 0)
0x80e: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x80f: Push("Can't find map")
0x810: @ Trace(Stack[-1])
0x811: Pop(1)
0x812: Return(); Pop(8)

0x813: Push(CvectorIndex(Stack[-4], 0))
0x814: Push(CvectorIndex(Stack[-5], 2))
0x815: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11])
0x816: Pop(2)
0x817: Return(); Pop(8)

0x818: Stack[-2] = 0
0x819: PushEmpty(int, int)
0x81a: Push("branch")
0x81b: @ GetVariable(Stack[-1], Stack[-2])
0x81c: Pop(1)
0x81d: Push((int) 0)
...
0x82a: Stack[-1] = (int) 515573
0x82b: Return(); Pop(0)

0x82c: Stack[-1] = (int) 504032
0x82d: Return(); Pop(0)

0x82e: Stack[-1] = "ui/NPC_Bakalavr.png"
0x82f: Return(); Pop(0)

0x830: Stack[-1] = "ui/NPC_Bakalavr_b.png"
0x831: Return(); Pop(0)
