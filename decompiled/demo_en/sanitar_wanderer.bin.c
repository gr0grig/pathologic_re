task_0_event_1(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object)
{
	...
	func_2558(var_12_bool, var_13_object); // 0x15 NEW_2
	...
	func_2565(var_139_object); // 0x1d NEW_2
...
task_0_event_3(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object)
{
	...
	func_2571(var_12_bool, var_13_object); // 0x23 NEW_2
	...
	func_2578(var_139_object); // 0x2b NEW_2
...
task_0_event_17(var_0_bool, var_1_object, var_2_object, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object)
{
	...
	func_2626(var_47_object); // 0x37 NEW_2
...
Label_58:
	...
	func_2650(var_63_object); // 0x3f NEW_2
...
task_0_event_7(var_0_bool, var_1_object, var_2_int, var_3_bool, var_4_object, var_5_bool, var_6_object, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object)
{
	...
	func_2738(var_42_int); // 0x49 NEW_2
...
task_1_event_7(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object)
{
	...
	func_2738(var_61_int); // 0xff NEW_2
...
task_2_event_1(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2558(var_12_bool, var_13_object); // 0x20d NEW_2
	...
	func_2565(var_138_object); // 0x215 NEW_2
...
Label_536:
	...
	func_2584(var_476_bool, var_477_object); // 0x21a NEW_2
	...
	func_2616(var_492_object); // 0x222 NEW_2
}
...
task_2_event_3(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2571(var_12_bool, var_13_object); // 0x228 NEW_2
	...
	func_2578(var_138_object); // 0x230 NEW_2
...
Label_562:
	...
	func_2626(var_130_object); // 0x23c NEW_2
...
Label_575:
	...
	func_2650(var_145_object); // 0x244 NEW_2
...
task_2_event_30(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_bool, var_11_object, var_12_object, var_13_object)
{
	...
	func_2712(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0x24c NEW_2
...
task_2_event_7(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_int, var_9_object, var_10_object, var_11_object)
{
	...
	func_2738(var_12_int); // 0x257 NEW_2
...
task_3_event_1(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2558(var_12_bool, var_13_object); // 0x2bc NEW_2
	...
	func_2565(var_138_object); // 0x2c4 NEW_2
...
Label_711:
	...
	func_2584(var_476_bool, var_477_object); // 0x2c9 NEW_2
	...
	func_2616(var_492_object); // 0x2d1 NEW_2
}
...
task_3_event_3(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2571(var_12_bool, var_13_object); // 0x2d7 NEW_2
	...
	func_2578(var_138_object); // 0x2df NEW_2
...
Label_737:
	...
	func_2626(var_130_object); // 0x2eb NEW_2
...
Label_750:
	...
	func_2650(var_145_object); // 0x2f3 NEW_2
...
task_3_event_30(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_bool, var_11_object, var_12_object, var_13_object)
{
	...
	func_2712(var_14_bool, var_15_object, var_16_object, var_17_bool); // 0x2fb NEW_2
...
task_3_event_7(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_int, var_9_object, var_10_object, var_11_object)
{
	...
	func_2738(var_12_int); // 0x306 NEW_2
...
task_4_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2626(var_12_object); // 0x3d9 NEW_2
...
task_4_event_7(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_int, var_10_object, var_11_object)
{
	...
	func_2738(var_12_int); // 0x3e4 NEW_2
...
task_5_event_0(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2004(var_15_object); // 0x417 NEW_2
...
task_6_event_1(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2558(var_12_bool, var_13_object); // 0x538 NEW_2
	...
	func_2565(var_174_object); // 0x540 NEW_2
...
task_6_event_3(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2571(var_12_bool, var_13_object); // 0x546 NEW_2
	...
	func_2578(var_174_object); // 0x54e NEW_2
...
task_6_event_17(var_0_bool, var_1_object, var_2_bool, var_3_object, var_4_bool, var_5_object, var_6_bool, var_7_bool, var_8_object, var_9_object, var_10_object, var_11_object)
{
	...
	func_2626(var_47_object); // 0x55a NEW_2
...
Label_1373:
	...
	func_2650(var_98_object); // 0x562 NEW_2
...
Label_1391:
	...
	func_2738(var_16_int); // 0x571 NEW_2
}
...
{
	var_15_object = Obj(); var_16_int = 0; var_17_float = 0; // 0xa74 PushV
	var_15_object = var_11_object; // 0xa75 Mov
	var_16_int = var_12_int; // 0xa76 Mov
	var_17_float = var_13_float; // 0xa77 Mov
	func_1658(var_15_object, var_16_int, var_17_float); // 0xa78 NEW_2
...
{
	var_17_object = Obj(); var_18_int = 0; var_19_float = 0; var_20_cvector = CVector(0,0,0); var_21_cvector = CVector(0,0,0); // 0xa7c PushV
	var_17_object = var_11_object; // 0xa7d Mov
	var_18_int = var_12_int; // 0xa7e Mov
	var_19_float = var_13_float; // 0xa7f Mov
	var_20_cvector = var_15_cvector; // 0xa80 Mov
	var_21_cvector = var_16_cvector; // 0xa81 Mov
	func_1726(var_19_float, var_20_cvector, var_21_cvector); // 0xa82 NEW_2
...
{
	var_13_float = 0; var_14_float = 0; // 0xa85 PushV
	var_15_string = "health"; // 0xa86 PushS
	var_16_bool = var_12_string == var_15_string; // 0xa87 Eq
	if(var_16_bool == 0) goto Label_2705; // 0xa88 JumpB
	var_17_string = "health"; // 0xa89 PushS
	GetProperty(var_17_string, var_14_float); // 0xa8a Func
	var_18_int = 0; // 0xa8c PushI
	var_19_bool = var_14_float <= var_18_int; // 0xa8d LE
	if(var_19_bool == 0) goto Label_2705; // 0xa8e JumpB
	SignalDeath(var_11_object); // 0xa8f Func
...
{
	var_12_object = Obj(); // 0xa93 PushV
	var_12_object = var_11_object; // 0xa94 Mov
	func_2660(var_12_object); // 0xa95 NEW_2
...
func_2048(var_119_string)
{
	var_120_object = Obj(); var_121_int = 0; var_122_bool = 0; var_123_object = Obj(); var_124_int = 0; var_125_bool = 0; // 0x800 PushV
	CreateInvItem(var_123_object); // 0x801 Func
	SetItemName(var_119_string); // 0x803 ObjFunc
	var_126_string = "Organ"; // 0x805 PushS
	var_127_int = 1; // 0x806 PushI
	SetProperty(var_126_string, var_127_int); // 0x807 ObjFunc
	GetItemID(var_124_int); // 0x809 ObjFunc
	var_128_int = 0; // 0x80b PushI
	var_129_int = 1; // 0x80c PushI
	AddItem(var_125_bool, var_123_object, var_128_int, var_129_int); // 0x80d Func
	return 6; // 0x80f Return
}


func_2565(var_174_object)
{
	var_175_object = Obj(); // 0xa06 PushV
	var_175_object = var_174_object; // 0xa07 Mov
	func_2525(var_174_object, var_175_object); // 0xa08 NEW_2
	return 0; // 0xa0a Return
}


func_2571(var_12_bool, var_13_object)
{
	var_14_bool = 0; var_15_object = Obj(); // 0xa0c PushV
	var_15_object = var_13_object; // 0xa0d Mov
	func_2838(var_14_bool, var_15_object); // 0xa0e NEW_2
	var_12_bool = var_14_bool; // 0xa0f Mov
...
func_2065()
{
	var_113_int = 0; // 0x811 PushV
	func_1998(var_113_int); // 0x812 NEW_2
	var_117_int = 1; // 0x814 PushI
	var_118_bool = var_113_int != var_117_int; // 0x815 Neq
	if(var_118_bool == 0) goto Label_2072; // 0x816 JumpB
	return 0; // 0x817 Return
	
Label_2072:
	var_119_string = ""; // 0x818 PushV
	var_119_string = "liver"; // 0x819 MovS
	func_2048(var_119_string); // 0x81a NEW_2
	var_130_string = ""; // 0x81c PushV
	var_130_string = "kidney"; // 0x81d MovS
	func_2048(var_130_string); // 0x81e NEW_2
	var_131_string = ""; // 0x820 PushV
	var_131_string = "heart"; // 0x821 MovS
	func_2048(var_131_string); // 0x822 NEW_2
	var_132_string = ""; // 0x824 PushV
	var_132_string = "blood"; // 0x825 MovS
	func_2048(var_132_string); // 0x826 NEW_2
	return 0; // 0x828 Return
}


func_2578(var_174_object)
{
	var_175_object = Obj(); // 0xa13 PushV
	var_175_object = var_174_object; // 0xa14 Mov
	func_2525(var_174_object, var_175_object); // 0xa15 NEW_2
...
func_2584(var_476_bool, var_477_object)
{
	var_478_float = 0; var_479_float = 0; // 0xa18 PushV
	var_480_bool = 0; // 0xa19 PushV
	var_480_bool = 1; // 0xa1a MovB
	var_481_bool = 0; // 0xa1b PushV
	var_481_bool = 1; // 0xa1c MovB
	var_482_bool = var_477_object == 0; // 0xa1d NullEq
	if(var_482_bool == 0) goto Label_2598; // 0xa1e JumpB
	var_483_bool = 0; var_484_object = Obj(); // 0xa1f PushV
	var_484_object = var_477_object; // 0xa20 Mov
	func_1515(var_484_object); // 0xa21 NEW_2
	var_485_bool = var_483_bool == 0; // 0xa23 Not
	if(var_485_bool == 0) goto Label_2598; // 0xa24 JumpB
	var_481_bool = 0; // 0xa25 MovB
	
Label_2598:
	if(var_481_bool == 0) goto Label_2607; // 0xa26 JumpB
	var_486_bool = 0; var_487_object = Obj(); var_488_string = ""; // 0xa27 PushV
	var_487_object = var_477_object; // 0xa28 Mov
	var_488_string = "disease"; // 0xa29 MovS
	func_1430(var_486_bool, var_487_object, var_488_string); // 0xa2a NEW_2
	var_489_bool = var_486_bool == 0; // 0xa2c Not
	if(var_489_bool == 0) goto Label_2607; // 0xa2d JumpB
	var_480_bool = 0; // 0xa2e MovB
	
Label_2607:
	if(var_480_bool == 0) goto Label_2610; // 0xa2f JumpB
	var_476_bool = 0; // 0xa30 MovB
	return 2; // 0xa31 Return
	
Label_2610:
	var_490_string = "disease"; // 0xa32 PushS
	GetProperty(var_490_string, var_479_float); // 0xa33 ObjFunc
	var_491_int = 0; // 0xa35 PushI
	var_476_bool = var_479_float > var_491_int; // 0xa36 GT2
...
func_2089()
{
	var_57_int = 0; var_58_bool = 0; var_59_int = 0; var_60_bool = 0; // 0x829 PushV
	var_61_int = 0; // 0x82a PushI
	ClearSubContainer(var_61_int); // 0x82b Func
	var_62_int = 0; var_63_int = 0; // 0x82d PushV
	var_62_int = 600; // 0x82e MovI
	var_63_int = 1500; // 0x82f MovI
	func_2017(var_62_int, var_63_int); // 0x830 NEW_2
	var_81_string = ""; var_82_int = 0; var_83_int = 0; var_84_int = 0; // 0x832 PushV
	var_81_string = "rusk"; // 0x833 MovS
	var_82_int = 1; // 0x834 MovI
	var_83_int = 3; // 0x835 MovI
	var_84_int = 2; // 0x836 MovI
	func_1756(var_81_string, var_82_int, var_83_int, var_84_int); // 0x837 NEW_2
	var_97_string = ""; var_98_int = 0; var_99_int = 0; var_100_int = 0; // 0x839 PushV
	var_97_string = "alpha_pills"; // 0x83a MovS
	var_98_int = 1; // 0x83b MovI
	var_99_int = 3; // 0x83c MovI
	var_100_int = 5; // 0x83d MovI
	func_1756(var_97_string, var_98_int, var_99_int, var_100_int); // 0x83e NEW_2
	var_101_string = ""; var_102_int = 0; var_103_int = 0; var_104_int = 0; // 0x840 PushV
	var_101_string = "beta_pills"; // 0x841 MovS
	var_102_int = 1; // 0x842 MovI
	var_103_int = 6; // 0x843 MovI
	var_104_int = 4; // 0x844 MovI
	func_1756(var_101_string, var_102_int, var_103_int, var_104_int); // 0x845 NEW_2
	var_105_string = ""; var_106_int = 0; var_107_int = 0; var_108_int = 0; // 0x847 PushV
	var_105_string = "gamma_pills"; // 0x848 MovS
	var_106_int = 1; // 0x849 MovI
	var_107_int = 12; // 0x84a MovI
	var_108_int = 3; // 0x84b MovI
	func_1756(var_105_string, var_106_int, var_107_int, var_108_int); // 0x84c NEW_2
	var_109_int = 0; var_110_string = ""; // 0x84e PushV
	var_110_string = "ognemet_ammo"; // 0x84f MovS
	func_2135(var_109_int, var_110_string); // 0x850 NEW_2
	var_111_int = 0; // 0x852 PushI
	var_112_int = 1; // 0x853 PushI
	AddItem(var_60_bool, var_109_int, var_111_int, var_112_int); // 0x854 Func
...
func_2616(var_492_object)
{
	var_493_object = Obj(); // 0xa39 PushV
	var_493_object = var_492_object; // 0xa3a Mov
	TaskCall(6); // 0xa3b TaskCall
	func_1173(var_494_object, var_495_object, var_493_object); // 0xa3c NEW_2
...
func_2626(var_47_object)
{
	var_48_bool = 0; var_49_bool = 0; // 0xa42 PushV
	var_50_bool = var_47_object == 0; // 0xa43 NullEq
	if(var_50_bool == 0) goto Label_2630; // 0xa44 JumpB
	return 2; // 0xa45 Return
	
Label_2630:
	var_51_object = GlobalVars[4]; // 0xa46 PushGE
	in(var_49_bool, var_47_object); // 0xa47 ObjFunc
	var_52_bool = var_49_bool == 0; // 0xa49 Not
	if(var_52_bool == 0) goto Label_2638; // 0xa4a JumpB
	var_53_object = GlobalVars[4]; // 0xa4b PushGE
	add(var_47_object); // 0xa4c ObjFunc
	
Label_2638:
	var_54_bool = 0; var_55_object = Obj(); // 0xa4e PushV
	var_55_object = var_47_object; // 0xa4f Mov
	func_1425(var_54_bool, var_55_object); // 0xa50 NEW_2
	if(var_54_bool == 0) goto Label_2649; // 0xa52 JumpB
	var_58_object = Obj(); // 0xa53 PushV
	func_1899(var_58_object); // 0xa54 NEW_2
	var_61_float = -0.07; // 0xa56 PushF
	ReportReputationChange(var_47_object, var_58_object, var_61_float); // 0xa57 Func
...
func_2558(var_12_bool, var_13_object)
{
	var_14_bool = 0; var_15_object = Obj(); // 0x9ff PushV
	var_15_object = var_13_object; // 0xa00 Mov
	func_2838(var_14_bool, var_15_object); // 0xa01 NEW_2
	var_12_bool = var_14_bool; // 0xa02 Mov
...
func_2135(var_74_int, var_75_string)
{
	var_76_int = 0; var_77_int = 0; // 0x857 PushV
	GetInvItemByName(var_77_int, var_75_string); // 0x858 Func
	var_74_int = var_77_int; // 0x85a Mov
	return 2; // 0x85b Return
}


func_2650(var_98_object)
{
	var_99_object = Obj(); // 0xa5b PushV
	var_99_object = var_98_object; // 0xa5c Mov
	func_2626(var_99_object); // 0xa5d NEW_2
	var_100_object = Obj(); // 0xa5f PushV
	var_100_object = var_98_object; // 0xa60 Mov
	func_2525(var_98_object, var_100_object); // 0xa61 NEW_2
...
func_2140(var_20_bool, var_21_object, var_22_bool)
{
	var_23_string = ""; var_24_string = ""; // 0x85c PushV
	var_25_bool = 0; var_26_object = Obj(); var_27_string = ""; // 0x85d PushV
	var_26_object = var_21_object; // 0x85e Mov
	var_27_string = "class"; // 0x85f MovS
	func_1430(var_25_bool, var_26_object, var_27_string); // 0x860 NEW_2
	var_34_bool = var_25_bool == 0; // 0x862 Not
	if(var_34_bool == 0) goto Label_2150; // 0x863 JumpB
	var_20_bool = 0; // 0x864 MovB
	return 2; // 0x865 Return
	
Label_2150:
	var_35_string = "class"; // 0x866 PushS
	GetProperty(var_35_string, var_24_string); // 0x867 ObjFunc
	var_36_bool = 0; // 0x869 PushV
	var_36_bool = 1; // 0x86a MovB
	var_37_bool = 0; // 0x86b PushV
	var_37_bool = 1; // 0x86c MovB
	var_38_bool = 0; // 0x86d PushV
	var_38_bool = 1; // 0x86e MovB
	var_39_bool = 0; // 0x86f PushV
	var_39_bool = 1; // 0x870 MovB
	var_40_bool = 0; // 0x871 PushV
	var_40_bool = 1; // 0x872 MovB
	var_41_bool = 0; // 0x873 PushV
	var_41_bool = 1; // 0x874 MovB
	var_42_bool = 0; // 0x875 PushV
	var_42_bool = 1; // 0x876 MovB
	var_43_bool = 0; // 0x877 PushV
	var_43_bool = 1; // 0x878 MovB
	var_44_bool = 0; // 0x879 PushV
	var_44_bool = 1; // 0x87a MovB
	var_45_bool = 0; // 0x87b PushV
	var_45_bool = 1; // 0x87c MovB
	var_46_string = "patrol"; // 0x87d PushS
	var_47_bool = var_24_string == var_46_string; // 0x87e Eq
	if(var_47_bool == 0) goto Label_2180; // 0x87f JumpB
	var_48_string = "sanitar"; // 0x880 PushS
	var_49_bool = var_24_string == var_48_string; // 0x881 Eq
	if(var_49_bool == 0) goto Label_2180; // 0x882 JumpB
	var_45_bool = 0; // 0x883 MovB
	
Label_2180:
	if(var_45_bool == 0) goto Label_2185; // 0x884 JumpB
	var_50_string = "soldier"; // 0x885 PushS
	var_51_bool = var_24_string == var_50_string; // 0x886 Eq
	if(var_51_bool == 0) goto Label_2185; // 0x887 JumpB
	var_44_bool = 0; // 0x888 MovB
	
Label_2185:
	if(var_44_bool == 0) goto Label_2190; // 0x889 JumpB
	var_52_string = "woman"; // 0x88a PushS
	var_53_bool = var_24_string == var_52_string; // 0x88b Eq
	if(var_53_bool == 0) goto Label_2190; // 0x88c JumpB
	var_43_bool = 0; // 0x88d MovB
	
Label_2190:
	if(var_43_bool == 0) goto Label_2195; // 0x88e JumpB
	var_54_string = "wasted_girl"; // 0x88f PushS
	var_55_bool = var_24_string == var_54_string; // 0x890 Eq
	if(var_55_bool == 0) goto Label_2195; // 0x891 JumpB
	var_42_bool = 0; // 0x892 MovB
	
Label_2195:
	if(var_42_bool == 0) goto Label_2200; // 0x893 JumpB
	var_56_string = "vaxxabitka"; // 0x894 PushS
	var_57_bool = var_24_string == var_56_string; // 0x895 Eq
	if(var_57_bool == 0) goto Label_2200; // 0x896 JumpB
	var_41_bool = 0; // 0x897 MovB
	
Label_2200:
	if(var_41_bool == 0) goto Label_2205; // 0x898 JumpB
	var_58_string = "vaxxabit"; // 0x899 PushS
	var_59_bool = var_24_string == var_58_string; // 0x89a Eq
	if(var_59_bool == 0) goto Label_2205; // 0x89b JumpB
	var_40_bool = 0; // 0x89c MovB
	
Label_2205:
	if(var_40_bool == 0) goto Label_2210; // 0x89d JumpB
	var_60_string = "little_girl"; // 0x89e PushS
	var_61_bool = var_24_string == var_60_string; // 0x89f Eq
	if(var_61_bool == 0) goto Label_2210; // 0x8a0 JumpB
	var_39_bool = 0; // 0x8a1 MovB
	
Label_2210:
	if(var_39_bool == 0) goto Label_2215; // 0x8a2 JumpB
	var_62_string = "girl"; // 0x8a3 PushS
	var_63_bool = var_24_string == var_62_string; // 0x8a4 Eq
	if(var_63_bool == 0) goto Label_2215; // 0x8a5 JumpB
	var_38_bool = 0; // 0x8a6 MovB
	
Label_2215:
	if(var_38_bool == 0) goto Label_2220; // 0x8a7 JumpB
	var_64_string = "dohodyaga"; // 0x8a8 PushS
	var_65_bool = var_24_string == var_64_string; // 0x8a9 Eq
	if(var_65_bool == 0) goto Label_2220; // 0x8aa JumpB
	var_37_bool = 0; // 0x8ab MovB
	
Label_2220:
	if(var_37_bool == 0) goto Label_2225; // 0x8ac JumpB
	var_66_string = "nudegirl"; // 0x8ad PushS
	var_67_bool = var_24_string == var_66_string; // 0x8ae Eq
	if(var_67_bool == 0) goto Label_2225; // 0x8af JumpB
	var_36_bool = 0; // 0x8b0 MovB
	
Label_2225:
	if(var_36_bool == 0) goto Label_2228; // 0x8b1 JumpB
	var_20_bool = 1; // 0x8b2 MovB
	return 2; // 0x8b3 Return
	
Label_2228:
	var_68_bool = var_22_bool; // 0x8b4 Push
	if(var_68_bool == 0) goto Label_2232; // 0x8b5 JumpB
	var_20_bool = 0; // 0x8b6 MovB
	return 2; // 0x8b7 Return
	
Label_2232:
	var_20_bool = 1; // 0x8b8 MovB
	var_69_bool = 0; // 0x8b9 PushV
	var_69_bool = 1; // 0x8ba MovB
	var_70_bool = 0; // 0x8bb PushV
	var_70_bool = 1; // 0x8bc MovB
	var_71_bool = 0; // 0x8bd PushV
	var_71_bool = 1; // 0x8be MovB
	var_72_bool = 0; // 0x8bf PushV
	var_72_bool = 1; // 0x8c0 MovB
	var_73_bool = 0; // 0x8c1 PushV
	var_73_bool = 1; // 0x8c2 MovB
	var_74_string = "worker"; // 0x8c3 PushS
	var_75_bool = var_24_string == var_74_string; // 0x8c4 Eq
	if(var_75_bool == 0) goto Label_2250; // 0x8c5 JumpB
	var_76_string = "butcher"; // 0x8c6 PushS
	var_77_bool = var_24_string == var_76_string; // 0x8c7 Eq
	if(var_77_bool == 0) goto Label_2250; // 0x8c8 JumpB
	var_73_bool = 0; // 0x8c9 MovB
	
Label_2250:
	if(var_73_bool == 0) goto Label_2255; // 0x8ca JumpB
	var_78_string = "boy"; // 0x8cb PushS
	var_79_bool = var_24_string == var_78_string; // 0x8cc Eq
	if(var_79_bool == 0) goto Label_2255; // 0x8cd JumpB
	var_72_bool = 0; // 0x8ce MovB
	
Label_2255:
	if(var_72_bool == 0) goto Label_2260; // 0x8cf JumpB
	var_80_string = "unosha"; // 0x8d0 PushS
	var_81_bool = var_24_string == var_80_string; // 0x8d1 Eq
	if(var_81_bool == 0) goto Label_2260; // 0x8d2 JumpB
	var_71_bool = 0; // 0x8d3 MovB
	
Label_2260:
	if(var_71_bool == 0) goto Label_2265; // 0x8d4 JumpB
	var_82_string = "wasted_male"; // 0x8d5 PushS
	var_83_bool = var_24_string == var_82_string; // 0x8d6 Eq
	if(var_83_bool == 0) goto Label_2265; // 0x8d7 JumpB
	var_70_bool = 0; // 0x8d8 MovB
	
Label_2265:
	if(var_70_bool == 0) goto Label_2270; // 0x8d9 JumpB
	var_84_string = "alkash"; // 0x8da PushS
	var_85_bool = var_24_string == var_84_string; // 0x8db Eq
	if(var_85_bool == 0) goto Label_2270; // 0x8dc JumpB
	var_69_bool = 0; // 0x8dd MovB
	
Label_2270:
	if(var_69_bool == 0) goto Label_2275; // 0x8de JumpB
	var_86_string = "morlok"; // 0x8df PushS
	var_87_bool = var_24_string == var_86_string; // 0x8e0 Eq
	if(var_87_bool == 0) goto Label_2275; // 0x8e1 JumpB
	var_20_bool = 0; // 0x8e2 MovB
	
Label_2275:
	return 2; // 0x8e3 Return
}


func_2660(var_12_object)
{
	var_13_object = Obj(); // 0xa65 PushV
	func_1899(var_13_object); // 0xa66 NEW_2
	var_16_float = -0.13; // 0xa68 PushF
	var_17_bool = 1; // 0xa69 PushB
	ReportReputationChange(var_12_object, var_13_object, var_16_float, var_17_bool); // 0xa6a Func
	var_18_object = Obj(); // 0xa6c PushV
	var_18_object = var_12_object; // 0xa6d Mov
	TaskCall(5); // 0xa6e TaskCall
	func_999(var_18_object); // 0xa6f NEW_2
	TaskReturn(); // 0xa70 TaskReturn
...
Label_1191:
	...
	func_2317(var_455_bool); // 0x4b7 NEW_2
...
Label_1277:
	...
	func_2317(var_477_bool); // 0x502 NEW_2
...
func_2712(var_14_bool, var_15_object, var_16_object, var_17_bool)
{
	var_18_bool = 0; var_19_bool = 0; // 0xa98 PushV
	var_20_bool = 0; var_21_object = Obj(); var_22_bool = 0; // 0xa99 PushV
	var_21_object = var_16_object; // 0xa9a Mov
	var_22_bool = !var_17_bool; // 0xa9b Not2
	func_2140(var_20_bool, var_21_object, var_22_bool); // 0xa9c NEW_2
	if(var_20_bool == 0) goto Label_2736; // 0xa9e JumpB
	CanSee(var_19_bool, var_15_object); // 0xa9f Func
	var_88_bool = 0; // 0xaa1 PushV
	var_88_bool = 1; // 0xaa2 MovB
	var_89_bool = var_19_bool; // 0xaa3 Push
	if(var_89_bool == 0) goto Label_2733; // 0xaa4 JumpB
	var_90_float = 0; var_91_object = Obj(); // 0xaa5 PushV
	var_91_object = var_15_object; // 0xaa6 Mov
	func_1417(var_91_object); // 0xaa7 NEW_2
	var_98_float = 490000.0; // 0xaa9 PushF
	var_99_bool = var_90_float <= var_98_float; // 0xaaa LE
	if(var_99_bool == 0) goto Label_2733; // 0xaab JumpB
	var_88_bool = 0; // 0xaac MovB
	
Label_2733:
	if(var_88_bool == 0) goto Label_2736; // 0xaad JumpB
	var_14_bool = 1; // 0xaae MovB
	return 2; // 0xaaf Return
	
Label_2736:
	var_14_bool = 0; // 0xab0 MovB
...
func_2738(var_16_int)
{
	var_17_object = Obj(); var_18_float = 0; var_19_object = Obj(); var_20_bool = 0; var_21_string = ""; var_22_float = 0; var_23_float = 0; var_24_float = 0; var_25_object = Obj(); var_26_float = 0; var_27_object = Obj(); var_28_bool = 0; var_29_string = ""; var_30_float = 0; var_31_float = 0; var_32_float = 0; // 0xab2 PushV
	var_33_int = 70; // 0xab3 PushI
	var_34_bool = var_16_int != var_33_int; // 0xab4 Neq
	if(var_34_bool == 0) goto Label_2743; // 0xab5 JumpB
	return 16; // 0xab6 Return
	
Label_2743:
	var_35_object = GlobalVars[0]; // 0xab7 PushGE
	var_36_bool = var_35_object == 0; // 0xab8 NullEq
	if(var_36_bool == 0) goto Label_2747; // 0xab9 JumpB
	return 16; // 0xaba Return
	
Label_2747:
	var_37_object = GlobalVars[0]; // 0xabb PushGE
	Intersect(var_25_object, var_26_float); // 0xabc ObjFunc
	var_38_object = GlobalVars[0]; // 0xabe PushGE
	var_39_bool = GlobalVars[3]; // 0xabf PushGE
	if(var_39_bool == 0) goto Label_2761; // 0xac0 JumpB
	var_40_float = 0; var_41_float = 0; var_42_float = 0; // 0xac1 PushV
	var_41_float = var_26_float; // 0xac2 Mov
	var_43_float = GlobalVars[2]; // 0xac3 PushGE
	var_42_float = var_43_float; // 0xac4 Mov
	func_1915(var_40_float, var_41_float, var_42_float); // 0xac6 NEW_2
	goto Label_2762; // 0xac8 Jump
	
Label_2762:
	SetLength(var_40_float); // 0xaca ObjFunc
	func_1963(); // 0xacd NEW_2
	
Label_2767:
	Next(var_28_bool, var_27_object); // 0xacf ObjFunc
	var_51_bool = var_28_bool; // 0xad1 Push
	if(var_51_bool == 0) goto Label_2835; // 0xad2 JumpB
	var_52_bool = 0; // 0xad3 PushV
	var_52_bool = 0; // 0xad4 MovB
	var_53_bool = var_27_object != 0; // 0xad5 NullNeq
	if(var_53_bool == 0) goto Label_2781; // 0xad6 JumpB
	var_54_object = Obj(); // 0xad7 PushV
	func_1899(var_54_object); // 0xad8 NEW_2
	var_55_bool = var_27_object != var_54_object; // 0xada Neq
	if(var_55_bool == 0) goto Label_2781; // 0xadb JumpB
	var_52_bool = 1; // 0xadc MovB
	
Label_2781:
	if(var_52_bool == 0) goto Label_2834; // 0xadd JumpB
	var_56_bool = 0; var_57_object = Obj(); var_58_string = ""; // 0xade PushV
	var_57_object = var_27_object; // 0xadf Mov
	var_58_string = "class"; // 0xae0 MovS
	func_1430(var_56_bool, var_57_object, var_58_string); // 0xae1 NEW_2
	if(var_56_bool == 0) goto Label_2791; // 0xae3 JumpB
	var_65_string = "class"; // 0xae4 PushS
	GetProperty(var_65_string, var_29_string); // 0xae5 ObjFunc
	
Label_2791:
	var_66_string = "sanitar"; // 0xae7 PushS
	var_67_bool = var_29_string != var_66_string; // 0xae8 Neq
	if(var_67_bool == 0) goto Label_2834; // 0xae9 JumpB
	var_68_float = 0; var_69_object = Obj(); var_70_float = 0; var_71_int = 0; // 0xaea PushV
	var_69_object = var_27_object; // 0xaeb Mov
	var_70_float = 0.1; // 0xaec MovF
	var_71_int = 2; // 0xaed MovI
	func_1442(var_68_float, var_69_object, var_70_float, var_71_int); // 0xaee NEW_2
	var_30_float = var_68_float; // 0xaef Mov
	var_127_bool = 0; var_128_object = Obj(); var_129_string = ""; // 0xaf1 PushV
	var_128_object = var_27_object; // 0xaf2 Mov
	var_129_string = "disease"; // 0xaf3 MovS
	func_1430(var_127_bool, var_128_object, var_129_string); // 0xaf4 NEW_2
	if(var_127_bool == 0) goto Label_2820; // 0xaf6 JumpB
	var_130_string = "disease"; // 0xaf7 PushS
	GetProperty(var_130_string, var_31_float); // 0xaf8 ObjFunc
	var_131_float = 0.1; // 0xafa PushF
	var_132_bool = var_31_float <= var_131_float; // 0xafb LE
	if(var_132_bool == 0) goto Label_2815; // 0xafc JumpB
	var_31_float = 0; // 0xafd MovI
	goto Label_2817; // 0xafe Jump
	
Label_2817:
	var_133_string = "disease"; // 0xb01 PushS
	SetProperty(var_133_string, var_31_float); // 0xb02 ObjFunc
	
Label_2820:
	var_134_bool = 0; var_135_object = Obj(); var_136_string = ""; // 0xb04 PushV
	var_135_object = var_27_object; // 0xb05 Mov
	var_136_string = "fire"; // 0xb06 MovS
	func_1430(var_134_bool, var_135_object, var_136_string); // 0xb07 NEW_2
	if(var_134_bool == 0) goto Label_2834; // 0xb09 JumpB
	var_137_string = "fire"; // 0xb0a PushS
	GetProperty(var_137_string, var_32_float); // 0xb0b ObjFunc
	var_138_string = "fire"; // 0xb0d PushS
	var_139_float = 0.1; // 0xb0e PushF
	var_140_int = var_32_float + var_139_float; // 0xb0f Add
	SetProperty(var_138_string, var_140_int); // 0xb10 ObjFunc
	
Label_2834:
	goto Label_2767; // 0xb12 Jump
	
Label_2815:
	var_141_float = 0.1; // 0xaff PushF
	var_31_float = var_31_float - var_141_float; // 0xb00 Sub2
	
Label_2835:
	return 16; // 0xb13 Return
	
Label_2761:
	var_142_float = 0.05; // 0xac9 PushF
}
...
func_2276()
{
	var_11_float = 0; var_12_object = Obj(); var_13_object = Obj(); var_14_float = 0; var_15_object = Obj(); var_16_object = Obj(); // 0x8e4 PushV
	var_17_object = GlobalVars[4]; // 0x8e5 PushGE
	var_18_object = Obj(); // 0x8e6 PushV
	func_1938(var_18_object); // 0x8e7 NEW_2
	var_17_object = var_18_object; // 0x8e8 Mov
	GlobalVars[4] = var_17_object; // 0x8ea PopGE
	GetAttackDistance(var_14_float); // 0x8eb Func
	var_21_float = GlobalVars[2]; // 0x8ed PushGE
	var_22_float = 600.0; // 0x8ee PushF
	var_21_float = var_14_float / var_14_float; // 0x8ef Div2
	GlobalVars[2] = var_21_float; // 0x8f0 PopGE
	GetScene(var_15_object); // 0x8f1 Func
	var_23_string = "flame"; // 0x8f3 PushS
	var_24_cvector = CVector(0.0, 0.0, 0.0); // 0x8f4 PushVec
	AddActorByType(var_16_object, var_23_string, var_15_object, var_24_cvector); // 0x8f5 Func
	var_25_object = Obj(); // 0x8f7 PushV
	func_1899(var_25_object); // 0x8f8 NEW_2
	var_28_string = "flame"; // 0x8fa PushS
	Attach(var_25_object, var_28_string); // 0x8fb ObjFunc
	var_29_bool = GlobalVars[3]; // 0x8fd PushGE
	var_29_bool = 0; // 0x8fe MovB
	GlobalVars[3] = var_29_bool; // 0x8ff PopGE
	var_30_float = 0.05; // 0x900 PushF
	SetLength(var_30_float); // 0x901 ObjFunc
	var_31_object = GlobalVars[0]; // 0x903 PushGE
	var_31_object = var_16_object; // 0x904 Mov
	GlobalVars[0] = var_31_object; // 0x905 PopGE
	var_32_int = 70; // 0x906 PushI
	var_33_float = 0.1; // 0x907 PushF
	SetTimer(var_32_int, var_33_float); // 0x908 Func
...
func_258(var_2_bool, var_236_bool, var_237_object, var_238_float, var_239_float, var_240_bool, var_241_bool)
{
	...
	func_1954(var_246_object); // 0x105 NEW_2
...
Label_786:
	...
	func_1981(var_79_int); // 0x313 NEW_2
...
Label_801:
	...
	func_1974(var_101_string, var_102_int); // 0x32f NEW_2
...
func_2317(var_22_bool)
{
	var_23_float = 0; var_24_float = 0; var_25_object = Obj(); var_26_cvector = CVector(0,0,0); var_27_float = 0; var_28_float = 0; var_29_float = 0; var_30_object = Obj(); var_31_cvector = CVector(0,0,0); var_32_float = 0; // 0x90d PushV
	var_33_bool = var_22_bool; // 0x90e Push
	if(var_33_bool == 0) goto Label_2324; // 0x90f JumpB
	var_34_float = GlobalVars[2]; // 0x910 PushGE
	var_28_float = var_34_float; // 0x911 Mov
	goto Label_2325; // 0x913 Jump
	
Label_2325:
	var_35_object = GlobalVars[0]; // 0x915 PushGE
	GetLength(var_29_float); // 0x916 ObjFunc
	var_36_bool = var_28_float < var_29_float; // 0x918 LT
	if(var_36_bool == 0) goto Label_2331; // 0x919 JumpB
	var_29_float = var_28_float; // 0x91a Mov
	
Label_2331:
	var_37_object = GlobalVars[0]; // 0x91b PushGE
	SetLength(var_29_float); // 0x91c ObjFunc
	var_38_bool = GlobalVars[3]; // 0x91e PushGE
	var_39_bool = var_38_bool != var_22_bool; // 0x91f Neq
	if(var_39_bool == 0) goto Label_2372; // 0x920 JumpB
	var_40_bool = var_22_bool; // 0x921 Push
	if(var_40_bool == 0) goto Label_2362; // 0x922 JumpB
	var_41_object = GlobalVars[1]; // 0x923 PushGE
	var_42_bool = var_41_object == 0; // 0x924 NullEq
	if(var_42_bool == 0) goto Label_2357; // 0x925 JumpB
	var_31_cvector = CVector(0.0, 0.0, 0.0); // 0x926 MovV
	GetHeight(var_32_float); // 0x927 Func
	var_43_float = GetByIndex(var_31_cvector, 1); // 0x929 PushE
	var_43_float = var_32_float; // 0x92a Mov
	SetByIndex(var_31_cvector, 1) = var_43_float; // 0x92b PopE
	var_44_string = "flame_loop"; // 0x92c PushS
	var_45_int = 0; // 0x92d PushI
	var_46_int = 200; // 0x92e PushI
	PlayLoopedGlobalSound(var_30_object, var_44_string, var_31_cvector, var_45_int, var_46_int); // 0x92f Func
	var_47_object = GlobalVars[1]; // 0x931 PushGE
	var_47_object = var_30_object; // 0x932 Mov
	GlobalVars[1] = var_47_object; // 0x933 PopGE
	var_30_object = 0; // 0x934 SetNull
	
Label_2357:
	var_48_object = GlobalVars[1]; // 0x935 PushGE
	var_49_int = 2; // 0x936 PushI
	FadeIn(var_49_int); // 0x937 ObjFunc
	goto Label_2369; // 0x939 Jump
	
Label_2369:
	var_50_bool = GlobalVars[3]; // 0x941 PushGE
	var_50_bool = var_22_bool; // 0x942 Mov
	GlobalVars[3] = var_50_bool; // 0x943 PopGE
	
Label_2372:
	return 10; // 0x944 Return
	
Label_2362:
	var_51_object = GlobalVars[1]; // 0x93a PushGE
	var_52_bool = var_51_object != 0; // 0x93b NullNeq
	if(var_52_bool == 0) goto Label_2369; // 0x93c JumpB
	var_53_object = GlobalVars[1]; // 0x93d PushGE
	var_54_int = 2; // 0x93e PushI
	FadeOut(var_54_int); // 0x93f ObjFunc
	
Label_2324:
	var_28_float = 0.05; // 0x914 MovF
}
...
func_2838(var_111_bool, var_112_object)
{
	var_113_bool = 0; var_114_object = Obj(); // 0xb17 PushV
	var_114_object = var_112_object; // 0xb18 Mov
	func_2423(var_113_bool, var_114_object); // 0xb19 NEW_2
	var_111_bool = var_113_bool; // 0xb1a Mov
...
Label_1312:
	...
	func_2317(var_65_bool); // 0x525 NEW_2
	Stop(); // 0x527 Func
...
func_307(var_1_object, var_12_int)
{
	...
	func_1954(var_15_object); // 0x139 NEW_2
...
func_2373(var_336_cvector)
{
	var_337_cvector = CVector(0,0,0); var_338_float = 0; var_339_cvector = CVector(0,0,0); var_340_float = 0; var_341_bool = 0; var_342_cvector = CVector(0,0,0); var_343_float = 0; var_344_cvector = CVector(0,0,0); var_345_float = 0; var_346_bool = 0; // 0x945 PushV
	GetPosition(var_342_cvector); // 0x946 Func
	GetHeight(var_343_float); // 0x948 Func
	var_347_float = GetByIndex(var_342_cvector, 1); // 0x94a PushE
	var_348_int = 2; // 0x94b PushI
	var_349_float = var_343_float / var_348_int; // 0x94c Div
	var_347_float = var_347_float + var_349_float; // 0x94d Add2
	SetByIndex(var_342_cvector, 1) = var_347_float; // 0x94e PopE
	var_344_cvector = var_336_cvector - var_342_cvector; // 0x94f Sub2
	var_350_int = var_344_cvector | var_344_cvector; // 0x950 Or
	var_345_float = sqrt(var_350_int); // 0x951 Sqrt2
	var_351_int = 50; // 0x952 PushI
	var_352_bool = var_345_float < var_351_int; // 0x953 LT
	if(var_352_bool == 0) goto Label_2391; // 0x954 JumpB
	var_346_bool = 0; // 0x955 MovB
	goto Label_2395; // 0x956 Jump
	
Label_2395:
	var_353_string = "all"; // 0x95b PushS
	var_354_bool = var_346_bool; // 0x95c Push
	if(var_354_bool == 0) goto Label_2400; // 0x95d JumpB
	var_355_string = "cattack"; // 0x95e PushS
	goto Label_2401; // 0x95f Jump
	
Label_2401:
	PlayAnimation(var_353_string, var_355_string); // 0x961 Func
	return 10; // 0x963 Return
	
Label_2400:
	var_356_string = "attack"; // 0x960 PushS
	
Label_2391:
	var_357_float = GetByIndex(var_344_cvector, 1); // 0x957 PushE
	var_358_float = var_357_float / var_345_float; // 0x958 Div
	var_359_float = -0.14286; // 0x959 PushF
	var_346_bool = var_358_float < var_359_float; // 0x95a LT2
}
...
Label_871:
	...
	func_2317(var_218_bool); // 0x381 NEW_2
...
Label_910:
	...
	func_2317(var_227_bool); // 0x398 NEW_2
...
Label_967:
	...
	func_2317(var_319_bool); // 0x3d0 NEW_2
...
Label_945:
	...
	func_2317(var_322_bool); // 0x3b8 NEW_2
...
Label_960:
	...
	func_2404(var_325_object); // 0x3c2 NEW_2
}


func_2404(var_325_object)
{
	var_326_cvector = CVector(0,0,0); var_327_float = 0; var_328_cvector = CVector(0,0,0); var_329_float = 0; // 0x964 PushV
	GetPosition(var_328_cvector); // 0x965 ObjFunc
	var_330_string = "@GetHeight"; // 0x967 PushS
	var_331_int = 1; // 0x968 PushI
	var_332_bool = IsFuncExist(var_325_object, var_330_string, var_331_int); // 0x969 FuncExist
	if(var_332_bool == 0) goto Label_2418; // 0x96a JumpB
	GetHeight(var_329_float); // 0x96b ObjFunc
	var_333_float = GetByIndex(var_328_cvector, 1); // 0x96d PushE
	var_334_int = 2; // 0x96e PushI
	var_335_float = var_329_float / var_334_int; // 0x96f Div
	var_333_float = var_333_float + var_335_float; // 0x970 Add2
	SetByIndex(var_328_cvector, 1) = var_333_float; // 0x971 PopE
	
Label_2418:
	var_336_cvector = CVector(0,0,0); // 0x972 PushV
	var_336_cvector = var_328_cvector; // 0x973 Mov
	func_2373(var_336_cvector); // 0x974 NEW_2
	return 4; // 0x976 Return
}
...
func_2423(var_113_bool, var_114_object)
{
	var_115_bool = 0; var_116_float = 0; var_117_float = 0; var_118_string = ""; var_119_float = 0; var_120_bool = 0; var_121_float = 0; var_122_float = 0; var_123_string = ""; var_124_float = 0; // 0x977 PushV
	var_125_bool = 0; var_126_object = Obj(); // 0x978 PushV
	var_126_object = var_114_object; // 0x979 Mov
	func_1556(var_125_bool, var_126_object); // 0x97a NEW_2
	var_127_bool = var_125_bool == 0; // 0x97c Not
	if(var_127_bool == 0) goto Label_2432; // 0x97d JumpB
	var_113_bool = 0; // 0x97e MovB
	return 10; // 0x97f Return
	
Label_2432:
	var_128_object = GlobalVars[4]; // 0x980 PushGE
	in(var_120_bool, var_114_object); // 0x981 ObjFunc
	var_129_bool = var_120_bool; // 0x983 Push
	if(var_129_bool == 0) goto Label_2439; // 0x984 JumpB
	var_113_bool = 1; // 0x985 MovB
	return 10; // 0x986 Return
	
Label_2439:
	var_130_bool = 0; var_131_object = Obj(); // 0x987 PushV
	var_131_object = var_114_object; // 0x988 Mov
	func_1425(var_130_bool, var_131_object); // 0x989 NEW_2
	if(var_130_bool == 0) goto Label_2458; // 0x98b JumpB
	var_132_string = "reputation"; // 0x98c PushS
	GetProperty(var_132_string, var_121_float); // 0x98d ObjFunc
	var_133_float = 0.33; // 0x98f PushF
	var_134_bool = var_121_float < var_133_float; // 0x990 LT
	if(var_134_bool == 0) goto Label_2452; // 0x991 JumpB
	var_113_bool = 1; // 0x992 MovB
	return 10; // 0x993 Return
	
Label_2452:
	var_135_string = "disease"; // 0x994 PushS
	GetProperty(var_135_string, var_122_float); // 0x995 ObjFunc
	var_136_float = 0.33; // 0x997 PushF
	var_113_bool = var_122_float > var_136_float; // 0x998 GT2
	return 10; // 0x999 Return
	
Label_2458:
	var_137_bool = 0; var_138_object = Obj(); var_139_string = ""; // 0x99a PushV
	var_138_object = var_114_object; // 0x99b Mov
	var_139_string = "class"; // 0x99c MovS
	func_1430(var_137_bool, var_138_object, var_139_string); // 0x99d NEW_2
	var_140_bool = var_137_bool == 0; // 0x99f Not
	if(var_140_bool == 0) goto Label_2467; // 0x9a0 JumpB
	var_113_bool = 0; // 0x9a1 MovB
	return 10; // 0x9a2 Return
	
Label_2467:
	var_141_string = "class"; // 0x9a3 PushS
	GetProperty(var_141_string, var_123_string); // 0x9a4 ObjFunc
	var_142_bool = 0; // 0x9a6 PushV
	var_142_bool = 1; // 0x9a7 MovB
	var_143_bool = 0; // 0x9a8 PushV
	var_143_bool = 1; // 0x9a9 MovB
	var_144_bool = 0; // 0x9aa PushV
	var_144_bool = 1; // 0x9ab MovB
	var_145_string = "bomber"; // 0x9ac PushS
	var_146_bool = var_123_string == var_145_string; // 0x9ad Eq
	if(var_146_bool == 0) goto Label_2483; // 0x9ae JumpB
	var_147_string = "hunter"; // 0x9af PushS
	var_148_bool = var_123_string == var_147_string; // 0x9b0 Eq
	if(var_148_bool == 0) goto Label_2483; // 0x9b1 JumpB
	var_144_bool = 0; // 0x9b2 MovB
	
Label_2483:
	if(var_144_bool == 0) goto Label_2488; // 0x9b3 JumpB
	var_149_string = "grabitel"; // 0x9b4 PushS
	var_150_bool = var_123_string == var_149_string; // 0x9b5 Eq
	if(var_150_bool == 0) goto Label_2488; // 0x9b6 JumpB
	var_143_bool = 0; // 0x9b7 MovB
	
Label_2488:
	if(var_143_bool == 0) goto Label_2493; // 0x9b8 JumpB
	var_151_string = "rat_big"; // 0x9b9 PushS
	var_152_bool = var_123_string == var_151_string; // 0x9ba Eq
	if(var_152_bool == 0) goto Label_2493; // 0x9bb JumpB
	var_142_bool = 0; // 0x9bc MovB
	
Label_2493:
	if(var_142_bool == 0) goto Label_2496; // 0x9bd JumpB
	var_113_bool = 1; // 0x9be MovB
	return 10; // 0x9bf Return
	
Label_2496:
	var_153_bool = 0; var_154_object = Obj(); var_155_string = ""; // 0x9c0 PushV
	var_154_object = var_114_object; // 0x9c1 Mov
	var_155_string = "disease"; // 0x9c2 MovS
	func_1430(var_153_bool, var_154_object, var_155_string); // 0x9c3 NEW_2
	var_156_bool = var_153_bool == 0; // 0x9c5 Not
	if(var_156_bool == 0) goto Label_2505; // 0x9c6 JumpB
	var_113_bool = 0; // 0x9c7 MovB
	return 10; // 0x9c8 Return
	
Label_2505:
	var_157_bool = 0; // 0x9c9 PushV
	var_157_bool = 1; // 0x9ca MovB
	var_158_bool = 0; var_159_string = ""; // 0x9cb PushV
	var_159_string = var_123_string; // 0x9cc Mov
	func_1812(var_158_bool, var_159_string); // 0x9cd NEW_2
	if(var_158_bool == 0) goto Label_2516; // 0x9cf JumpB
	var_197_string = "dog"; // 0x9d0 PushS
	var_198_bool = var_123_string == var_197_string; // 0x9d1 Eq
	if(var_198_bool == 0) goto Label_2516; // 0x9d2 JumpB
	var_157_bool = 0; // 0x9d3 MovB
	
Label_2516:
	if(var_157_bool == 0) goto Label_2523; // 0x9d4 JumpB
	var_199_string = "disease"; // 0x9d5 PushS
	GetProperty(var_199_string, var_124_float); // 0x9d6 ObjFunc
	var_200_int = 0; // 0x9d8 PushI
	var_113_bool = var_124_float > var_200_int; // 0x9d9 GT2
	return 10; // 0x9da Return
	
Label_2523:
	var_113_bool = 0; // 0x9db MovB
	return 10; // 0x9dc Return
}
...
func_1944(var_122_float)
{
	...
	var_125_int = 15; // 0x79d PushI
	SendWorldWndMessage(var_125_int, var_124_object); // 0x79e Func
	return 2; // 0x7a0 Return
}


func_1954(var_201_object)
{
	var_202_bool = 0; var_203_bool = 0; // 0x7a2 PushV
	IsPlayerActor(var_201_object, var_203_bool); // 0x7a3 Func
	var_204_bool = var_203_bool; // 0x7a5 Push
	if(var_204_bool == 0) goto Label_1962; // 0x7a6 JumpB
	var_205_string = "attack"; // 0x7a7 PushS
	PlayGlobalMusic(var_205_string); // 0x7a8 Func
...
Label_1461:
	var_126_string = "armor"; // 0x5b5 PushS
	GetProperty(var_126_string, var_78_int); // 0x5b6 ObjFunc
}


func_1963()
{
	var_45_object = Obj(); var_46_object = Obj(); // 0x7ab PushV
	GetScene(var_46_object); // 0x7ac Func
	var_47_string = "battle"; // 0x7ae PushS
	var_48_object = Obj(); // 0x7af PushV
	func_1899(var_48_object); // 0x7b0 NEW_2
	BroadcastMessage(var_47_string, var_48_object, var_46_object); // 0x7b2 Func
	return 2; // 0x7b4 Return
}


func_1974(var_85_string, var_86_int)
{
	var_87_string = ""; var_88_string = ""; // 0x7b6 PushV
	var_88_string = "idle"; // 0x7b7 MovS
	var_89_int = var_86_int; // 0x7b8 Push
	if(var_89_int == 0) goto Label_1979; // 0x7b9 JumpB
	var_88_string = var_88_string + var_86_int; // 0x7ba Add2
	
Label_1979:
	var_85_string = var_88_string; // 0x7bb Mov
	return 2; // 0x7bc Return
}


func_1981(var_79_int)
{
	var_80_int = 0; var_81_bool = 0; var_82_int = 0; var_83_bool = 0; // 0x7bd PushV
	var_82_int = 0; // 0x7be MovI
	
Label_1983:
	var_84_string = "all"; // 0x7bf PushS
	var_85_string = ""; var_86_int = 0; // 0x7c0 PushV
	var_86_int = var_82_int; // 0x7c1 Mov
	func_1974(var_85_string, var_86_int); // 0x7c2 NEW_2
	HasAnimation(var_83_bool, var_84_string, var_85_string); // 0x7c4 Func
	var_90_bool = var_83_bool == 0; // 0x7c6 Not
	if(var_90_bool == 0) goto Label_1993; // 0x7c7 JumpB
	goto Label_1996; // 0x7c8 Jump
	
Label_1996:
	var_79_int = var_82_int; // 0x7cc Mov
	return 4; // 0x7cd Return
	
Label_1993:
	var_91_int = 1; // 0x7c9 PushI
	var_82_int = var_82_int + var_91_int; // 0x7ca Add2
	goto Label_1983; // 0x7cb Jump
}


func_1998(var_113_int)
{
	var_114_int = 0; var_115_int = 0; // 0x7ce PushV
	var_116_string = "branch"; // 0x7cf PushS
	GetVariable(var_116_string, var_115_int); // 0x7d0 Func
	var_113_int = var_115_int; // 0x7d2 Mov
...
func_2004(var_15_object)
{
	var_16_int = 0; // 0x7d5 PushV
	func_1998(var_16_int); // 0x7d6 NEW_2
	var_20_int = 1; // 0x7d8 PushI
	var_21_bool = var_16_int == var_20_int; // 0x7d9 Eq
	if(var_21_bool == 0) goto Label_2014; // 0x7da JumpB
	WorkWithCorpse(var_15_object); // 0x7db Func
...
Label_2014:
	Barter(var_15_object); // 0x7de Func
}


func_2525(var_100_object, var_103_object)
{
	var_101_object = Obj(); var_102_object = Obj(); // 0x9de PushV
	var_102_object = var_100_object; // 0x9df Mov
	TaskCall(4); // 0x9e0 TaskCall
	func_863(var_100_object, var_103_object, var_101_object, var_102_object); // 0x9e1 NEW_2
	TaskReturn(); // 0x9e2 TaskReturn
	var_100_object = var_103_object; // 0x9e3 Mov
	ResetAAS(); // 0x9e5 Func
	var_360_bool = 0; // 0x9e7 PushV
	var_360_bool = 0; // 0x9e8 MovB
	var_361_bool = 0; var_362_object = Obj(); // 0x9e9 PushV
	var_362_object = var_100_object; // 0x9ea Mov
	func_1580(var_361_bool, var_362_object); // 0x9eb NEW_2
	if(var_361_bool == 0) goto Label_2548; // 0x9ed JumpB
	var_378_bool = 0; var_379_object = Obj(); // 0x9ee PushV
	var_379_object = var_100_object; // 0x9ef Mov
	func_1515(var_379_object); // 0x9f0 NEW_2
	if(var_378_bool == 0) goto Label_2548; // 0x9f2 JumpB
	var_360_bool = 1; // 0x9f3 MovB
	
Label_2548:
	if(var_360_bool == 0) goto Label_2557; // 0x9f4 JumpB
	var_380_object = Obj(); // 0x9f5 PushV
	var_380_object = var_100_object; // 0x9f6 Mov
	TaskCall(6); // 0x9f7 TaskCall
	func_1173(var_381_object, var_382_object, var_380_object); // 0x9f8 NEW_2
	TaskReturn(); // 0x9f9 TaskReturn
	ResetAAS(); // 0x9fb Func
...
func_2017(var_62_int, var_63_int)
{
	var_64_int = 0; var_65_bool = 0; var_66_int = 0; var_67_bool = 0; // 0x7e1 PushV
	var_68_bool = var_62_int > var_63_int; // 0x7e2 GT
	if(var_68_bool == 0) goto Label_2024; // 0x7e3 JumpB
	var_69_string = "GenerateMoney: iMin > iMax"; // 0x7e4 PushS
	Trace(var_69_string); // 0x7e5 Func
	return 4; // 0x7e7 Return
	
Label_2024:
	var_66_int = 0; // 0x7e8 MovI
	var_70_bool = var_62_int != var_63_int; // 0x7e9 Neq
	if(var_70_bool == 0) goto Label_2031; // 0x7ea JumpB
	var_71_int = var_63_int - var_62_int; // 0x7eb Sub
	irand(var_66_int, var_71_int); // 0x7ec Func
	goto Label_2035; // 0x7ee Jump
	
Label_2035:
	var_66_int = var_66_int + var_62_int; // 0x7f3 Add2
	var_72_int = 0; // 0x7f4 PushI
	var_73_bool = var_66_int == var_72_int; // 0x7f5 Eq
	if(var_73_bool == 0) goto Label_2040; // 0x7f6 JumpB
	return 4; // 0x7f7 Return
	
Label_2040:
	var_74_int = 0; var_75_string = ""; // 0x7f8 PushV
	var_75_string = "Money"; // 0x7f9 MovS
	func_2135(var_74_int, var_75_string); // 0x7fa NEW_2
	var_78_int = 0; // 0x7fc PushI
	AddItem(var_67_bool, var_74_int, var_78_int, var_66_int); // 0x7fd Func
	return 4; // 0x7ff Return
	
Label_2031:
	var_79_int = 0; // 0x7ef PushI
	var_80_bool = var_62_int == var_79_int; // 0x7f0 Eq
	if(var_80_bool == 0) goto Label_2035; // 0x7f1 JumpB
...
func_999(var_18_object)
{
	...
	func_2317(var_22_bool); // 0x3ed NEW_2
	...
	func_2089(); // 0x3f7 NEW_2
	
Label_1017:
	func_2065(); // 0x3fa NEW_2
