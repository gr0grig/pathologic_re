task_0_event_5(var_0_bool, var_1_bool, var_2_object, var_3_object)
{
	...
	var_7_string = "pt_kapella"; // 0xd MovS
	var_8_string = "NPC_Kapella"; // 0xe MovS
	var_9_string = "NPC_Burah_Kapella.xml"; // 0xf MovS
...
Label_19:
	...
	var_29_string = "pt_han"; // 0x1a MovS
	var_30_string = "NPC_Han"; // 0x1b MovS
	var_31_string = "NPC_Burah_Han.xml"; // 0x1c MovS
...
{
	var_5_string = "nokapella"; // 0x2b PushS
...
Label_48:
	var_7_string = "kapella"; // 0x30 PushS
