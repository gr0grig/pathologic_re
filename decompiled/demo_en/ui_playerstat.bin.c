...
Label_379:
	...
	func_1078(var_47_int); // 0x17c NEW_2
...
Label_486:
	...
	func_768(var_144_string, var_145_bool); // 0x1ec NEW_2
...
Label_495:
	...
	func_768(var_181_string, var_182_bool); // 0x1f5 NEW_2
...
Label_504:
	...
	func_768(var_185_string, var_186_bool); // 0x1fe NEW_2
...
Label_513:
	...
	func_768(var_189_string, var_190_bool); // 0x207 NEW_2
...
Label_522:
	...
	func_768(var_193_string, var_194_bool); // 0x210 NEW_2
...
Label_531:
	...
	func_768(var_197_string, var_198_bool); // 0x219 NEW_2
...
Label_540:
	...
	func_768(var_202_string, var_203_bool); // 0x225 NEW_2
}
...
task_0_event_1(var_0_object, var_1_object, var_2_object, var_3_object, var_4_object, var_5_object, var_6_object, var_7_object, var_8_object, var_9_object, var_10_int, var_11_float, var_12_int, var_13_int, var_14_object, var_15_object, var_16_object, var_17_object, var_18_object, var_19_object, var_20_float)
{
	...
	func_825(var_104_float); // 0x23a NEW_2
	var_117_float = 0; // 0x23c PushV
	var_117_float = var_20_float; // 0x23d Mov
	func_675(var_19_object, var_20_float, var_117_float); // 0x23e NEW_2
...
{
	var_20_bool = 0; // 0x411 PushV
	var_20_bool = 0; // 0x412 MovB
	var_21_bool = 0; // 0x413 PushV
	func_1119(var_21_bool); // 0x414 NEW_2
	if(var_21_bool == 0) goto Label_1050; // 0x416 JumpB
	var_28_bool = var_1_object == 0; // 0x417 Not
	if(var_28_bool == 0) goto Label_1050; // 0x418 JumpB
	var_20_bool = 1; // 0x419 MovB
	
Label_1050:
	if(var_20_bool == 0) goto Label_1062; // 0x41a JumpB
	var_29_string = "cross"; // 0x41b PushS
	var_30_int = 2; // 0x41c PushI
	var_31_float = var_12_int / var_30_int; // 0x41d Div
	var_32_int = 1; // 0x41e PushI
	var_33_int = var_31_float - var_32_int; // 0x41f Sub
	var_34_int = 2; // 0x420 PushI
	var_35_float = var_13_int / var_34_int; // 0x421 Div
	var_36_int = 1; // 0x422 PushI
	var_37_int = var_35_float - var_36_int; // 0x423 Sub
	Blit(var_29_string, var_33_int, var_37_int); // 0x424 Func
	
Label_1062:
	func_141(var_19_object); // 0x427 NEW_2
	func_315(var_19_object); // 0x42a NEW_2
	func_886(var_19_object); // 0x42d NEW_2
	func_847(); // 0x430 NEW_2
	func_652(var_17_object, var_18_object, var_19_object); // 0x433 NEW_2
...
main(var_0_object, var_1_object, var_2_object, var_3_object, var_4_object, var_5_object, var_6_object, var_7_object, var_8_object, var_9_object, var_10_int, var_11_float, var_12_int, var_13_int, var_14_object, var_15_object, var_16_object, var_17_object, var_18_object, var_19_object)
{
	...
	func_1092(var_22_bool); // 0x6 NEW_2
	...
	func_1078(var_31_int); // 0xe NEW_2
...
Label_50:
	...
	func_686(var_16_object, var_17_object, var_18_object, var_19_object, var_20_object, var_21_object); // 0x35 NEW_2
...
func_768(var_144_string, var_145_bool)
{
	var_146_object = Obj(); var_147_int = 0; var_148_int = 0; var_149_string = ""; var_150_float = 0; var_151_float = 0; var_152_float = 0; var_153_float = 0; var_154_object = Obj(); var_155_int = 0; var_156_int = 0; var_157_string = ""; var_158_float = 0; var_159_float = 0; var_160_float = 0; var_161_float = 0; // 0x300 PushV
	var_162_string = "player"; // 0x301 PushS
	FindActor(var_154_object, var_162_string); // 0x302 Func
	var_163_bool = var_154_object == 0; // 0x304 Not
	if(var_163_bool == 0) goto Label_775; // 0x305 JumpB
	return 16; // 0x306 Return
	
Label_775:
	size(var_155_int); // 0x307 TObjFunc
	var_156_int = 0; // 0x309 MovI
	
Label_778:
	var_164_bool = var_156_int < var_155_int; // 0x30a LT
	if(var_164_bool == 0) goto Label_823; // 0x30b JumpB
	get(var_157_string, var_156_int); // 0x30c TObjFunc
	var_165_bool = var_157_string == var_144_string; // 0x30e Eq
	if(var_165_bool == 0) goto Label_820; // 0x30f JumpB
	get(var_158_float, var_156_int); // 0x310 TObjFunc
	GetProperty(var_157_string, var_159_float); // 0x312 ObjFunc
	var_166_bool = var_158_float == var_159_float; // 0x314 Eq
	if(var_166_bool == 0) goto Label_791; // 0x315 JumpB
	return 16; // 0x316 Return
	
Label_791:
	set(var_156_int, var_159_float); // 0x317 TObjFunc
	var_167_bool = var_145_bool; // 0x319 Push
	if(var_167_bool == 0) goto Label_819; // 0x31a JumpB
	get(var_160_float, var_156_int); // 0x31b TObjFunc
	var_168_float = 2.0; // 0x31d PushF
	set(var_156_int, var_168_float); // 0x31e TObjFunc
	var_169_float = 10.0; // 0x320 PushF
	var_170_int = var_160_float - var_159_float; // 0x321 Sub
	var_161_float = var_169_float * var_170_int; // 0x322 Mult2
	var_171_int = 0; // 0x323 PushI
	var_172_bool = var_161_float < var_171_int; // 0x324 LT
	if(var_172_bool == 0) goto Label_808; // 0x325 JumpB
	var_173_float = -1.0; // 0x326 PushF
	var_161_float = var_161_float * var_173_float; // 0x327 Mult2
	
Label_808:
	var_174_float = 0.2; // 0x328 PushF
	var_175_bool = var_161_float < var_174_float; // 0x329 LT
	if(var_175_bool == 0) goto Label_813; // 0x32a JumpB
	var_161_float = 0.2; // 0x32b MovF
	goto Label_817; // 0x32c Jump
	
Label_817:
	set(var_156_int, var_161_float); // 0x331 TObjFunc
	
Label_819:
	goto Label_823; // 0x333 Jump
	
Label_823:
	return 16; // 0x337 Return
	
Label_813:
	var_176_float = 1.0; // 0x32d PushF
	var_177_bool = var_161_float > var_176_float; // 0x32e GT
	if(var_177_bool == 0) goto Label_817; // 0x32f JumpB
	var_161_float = 1.0; // 0x330 MovF
	
Label_820:
	var_178_int = 1; // 0x334 PushI
	var_156_int = var_156_int + var_178_int; // 0x335 Add2
	goto Label_778; // 0x336 Jump
}
...
func_577()
{
	...
	func_1105(var_44_int); // 0x243 NEW_2
...
Label_600:
	...
	func_1078(var_62_int); // 0x259 NEW_2
...
func_1092(var_22_bool)
{
	var_23_object = Obj(); var_24_bool = 0; var_25_object = Obj(); var_26_bool = 0; // 0x444 PushV
	var_27_string = "player"; // 0x445 PushS
	FindActor(var_25_object, var_27_string); // 0x446 Func
	var_28_bool = var_25_object == 0; // 0x448 Not
	if(var_28_bool == 0) goto Label_1100; // 0x449 JumpB
	var_22_bool = 0; // 0x44a MovB
	return 4; // 0x44b Return
	
Label_1100:
	IsVisirOn(var_26_bool); // 0x44c ObjFunc
	var_22_bool = var_26_bool; // 0x44e Mov
	return 4; // 0x44f Return
}


func_652(var_10_int, var_11_float, var_14_object)
{
	var_263_string = ""; var_264_float = 0; var_265_string = ""; var_266_float = 0; // 0x28c PushV
	var_267_int = -1; // 0x28d PushI
	var_268_bool = var_10_int == var_267_int; // 0x28e Eq
	if(var_268_bool == 0) goto Label_657; // 0x28f JumpB
	return 4; // 0x290 Return
	
Label_657:
	GetStringByID(var_265_string, var_14_object); // 0x291 Func
	var_269_float = 3.14; // 0x293 PushF
	var_270_float = var_269_float * var_11_float; // 0x294 Mult
	var_271_float = 1.0; // 0x295 PushF
	var_272_float = var_270_float / var_271_float; // 0x296 Div
	var_273_float = 2.0; // 0x297 PushF
	var_274_float = var_272_float / var_273_float; // 0x298 Div
	var_266_float = sin(var_274_float); // 0x299 Sin2
	var_275_string = "help"; // 0x29a PushS
	var_276_int = 10; // 0x29b PushI
	var_277_int = 10; // 0x29c PushI
	var_278_float = 1.0; // 0x29d PushF
	var_279_float = 1.0; // 0x29e PushF
	var_280_float = 1.0; // 0x29f PushF
	Print(var_275_string, var_276_int, var_277_int, var_265_string, var_278_float, var_279_float, var_280_float, var_266_float); // 0x2a0 Func
...
func_847()
{
	var_253_float = 0; var_254_float = 0; var_255_float = 0; var_256_int = 0; var_257_float = 0; var_258_float = 0; var_259_float = 0; var_260_float = 0; var_261_int = 0; var_262_float = 0; // 0x34f PushV
	return 10; // 0x350 Return
}


func_1105(var_44_int)
{
	var_45_object = Obj(); var_46_int = 0; var_47_object = Obj(); var_48_int = 0; // 0x451 PushV
	var_49_string = "player"; // 0x452 PushS
	FindActor(var_47_object, var_49_string); // 0x453 Func
	var_50_bool = var_47_object == 0; // 0x455 Not
	if(var_50_bool == 0) goto Label_1113; // 0x456 JumpB
	var_44_int = 0; // 0x457 MovI
	return 4; // 0x458 Return
	
Label_1113:
	var_51_string = "visir"; // 0x459 PushS
	GetProperty(var_51_string, var_48_int); // 0x45a ObjFunc
	var_44_int = var_48_int; // 0x45c Mov
...
{
	var_118_string = ""; var_119_int = 0; var_120_int = 0; var_121_int = 0; var_122_int = 0; var_123_string = ""; var_124_int = 0; var_125_int = 0; var_126_int = 0; var_127_int = 0; // 0x25f PushV
	GetInvItemSprite(var_123_string, var_114_int); // 0x260 Func
	GetScreenSize(var_124_int, var_125_int); // 0x262 Func
	var_128_int = 40; // 0x264 PushI
	var_129_int = 60; // 0x265 PushI
	var_130_float = var_116_int * var_129_int; // 0x266 Mult
	var_126_int = var_128_int + var_130_float; // 0x267 Add2
	var_127_int = 40; // 0x268 MovI
	
Label_617:
	var_131_int = 40; // 0x269 PushI
	var_132_int = var_124_int - var_131_int; // 0x26a Sub
	var_133_int = 60; // 0x26b PushI
	var_134_int = var_132_int - var_133_int; // 0x26c Sub
	var_135_bool = var_126_int > var_134_int; // 0x26d GT
	if(var_135_bool == 0) goto Label_629; // 0x26e JumpB
	var_136_int = 80; // 0x26f PushI
	var_137_int = var_124_int - var_136_int; // 0x270 Sub
	var_126_int = var_126_int - var_137_int; // 0x271 Sub2
	var_138_int = 60; // 0x272 PushI
	var_127_int = var_127_int + var_138_int; // 0x273 Add2
	goto Label_617; // 0x274 Jump
	
Label_629:
	var_139_string = "slot"; // 0x275 PushS
	Blit(var_139_string, var_126_int, var_127_int, var_117_float); // 0x276 Func
	var_140_int = 1; // 0x278 PushI
	var_141_int = var_126_int + var_140_int; // 0x279 Add
	var_142_int = 1; // 0x27a PushI
	var_143_int = var_127_int + var_142_int; // 0x27b Add
	Blit(var_123_string, var_141_int, var_143_int, var_117_float); // 0x27c Func
	var_144_int = 1; // 0x27e PushI
	var_145_bool = var_115_int > var_144_int; // 0x27f GT
	if(var_145_bool == 0) goto Label_651; // 0x280 JumpB
	var_146_string = "default"; // 0x281 PushS
	var_147_int = 2; // 0x282 PushI
	var_148_int = var_126_int + var_147_int; // 0x283 Add
	var_149_int = 35; // 0x284 PushI
	var_150_int = var_127_int + var_149_int; // 0x285 Add
	var_151_float = 1.0; // 0x286 PushF
	var_152_float = 1.0; // 0x287 PushF
	var_153_float = 1.0; // 0x288 PushF
	Print(var_146_string, var_148_int, var_150_int, var_115_int, var_151_float, var_152_float, var_153_float, var_117_float); // 0x289 Func
...
func_1119(var_21_bool)
{
	var_22_object = Obj(); var_23_bool = 0; var_24_object = Obj(); var_25_bool = 0; // 0x45f PushV
	var_26_string = "player"; // 0x460 PushS
	FindActor(var_24_object, var_26_string); // 0x461 Func
	var_27_bool = var_24_object == 0; // 0x463 Not
	if(var_27_bool == 0) goto Label_1127; // 0x464 JumpB
	var_21_bool = 0; // 0x465 MovB
	return 4; // 0x466 Return
	
Label_1127:
	IsWeaponHolstered(var_25_bool); // 0x467 ObjFunc
	var_21_bool = !var_25_bool; // 0x469 Not2
	return 4; // 0x46a Return
}


func_675(var_10_int, var_11_float, var_117_float)
{
	var_118_int = -1; // 0x2a4 PushI
	var_119_bool = var_10_int == var_118_int; // 0x2a5 Eq
	if(var_119_bool == 0) goto Label_680; // 0x2a6 JumpB
	return 0; // 0x2a7 Return
	
Label_680:
	var_11_float = var_11_float - var_117_float; // 0x2a8 Sub2
	var_120_int = 0; // 0x2a9 PushI
	var_121_bool = var_11_float <= var_120_int; // 0x2aa LE
	if(var_121_bool == 0) goto Label_685; // 0x2ab JumpB
	var_10_int = -1; // 0x2ac TMovI
...
func_1132()
{
0x46c: PushEmpty(object, bool, int, object, bool, int) // 0x46c PushV
0x46d: Push("player") // 0x46d PushS
0x46e: @ FindActor(Stack[-4], Stack[-1]) // 0x46e Func
0x46f: Pop(1) // 0x46f Pop
0x470: Pop(0); Push((bool) Stack[-3] == 0) // 0x470 Not
0x471: IF (Stack[-1] == 0) GOTO 0x474; Pop(1) // 0x471 JumpB
}


func_686(var_13_int, var_14_object, var_15_object, var_16_object, var_17_object, var_18_object)
{
	var_67_object = Obj(); var_68_int = 0; var_69_int = 0; var_70_string = ""; var_71_float = 0; var_72_object = Obj(); var_73_int = 0; var_74_int = 0; var_75_string = ""; var_76_float = 0; // 0x2ae PushV
	CreateStringVector(var_18_object); // 0x2af Func
	CreateFloatVector(var_17_object); // 0x2b1 Func
	CreateFloatVector(var_16_object); // 0x2b3 Func
	CreateFloatVector(var_15_object); // 0x2b5 Func
	CreateFloatVector(var_14_object); // 0x2b7 Func
	CreateBoolVector(var_13_int); // 0x2b9 Func
	var_77_string = "player"; // 0x2bb PushS
	FindActor(var_72_object, var_77_string); // 0x2bc Func
	var_78_object = var_72_object; // 0x2be Push
	if(var_78_object == 0) goto Label_763; // 0x2bf JumpB
	var_79_string = "health"; // 0x2c0 PushS
	add(var_79_string); // 0x2c1 TObjFunc
	var_80_bool = 0; // 0x2c3 PushB
	add(var_80_bool); // 0x2c4 TObjFunc
	var_81_string = "hunger"; // 0x2c6 PushS
	add(var_81_string); // 0x2c7 TObjFunc
	var_82_bool = 1; // 0x2c9 PushB
	add(var_82_bool); // 0x2ca TObjFunc
	var_83_string = "tiredness"; // 0x2cc PushS
	add(var_83_string); // 0x2cd TObjFunc
	var_84_bool = 1; // 0x2cf PushB
	add(var_84_bool); // 0x2d0 TObjFunc
	var_85_string = "immunity"; // 0x2d2 PushS
	add(var_85_string); // 0x2d3 TObjFunc
	var_86_bool = 0; // 0x2d5 PushB
	add(var_86_bool); // 0x2d6 TObjFunc
	var_87_string = "disease"; // 0x2d8 PushS
	add(var_87_string); // 0x2d9 TObjFunc
	var_88_bool = 1; // 0x2db PushB
	add(var_88_bool); // 0x2dc TObjFunc
	var_89_string = "reputation"; // 0x2de PushS
	add(var_89_string); // 0x2df TObjFunc
	var_90_bool = 0; // 0x2e1 PushB
	add(var_90_bool); // 0x2e2 TObjFunc
	size(var_73_int); // 0x2e4 TObjFunc
	var_74_int = 0; // 0x2e6 MovI
	
Label_743:
	var_91_bool = var_74_int < var_73_int; // 0x2e7 LT
	if(var_91_bool == 0) goto Label_762; // 0x2e8 JumpB
	get(var_75_string, var_74_int); // 0x2e9 TObjFunc
	GetProperty(var_75_string, var_76_float); // 0x2eb ObjFunc
	add(var_76_float); // 0x2ed TObjFunc
	add(var_76_float); // 0x2ef TObjFunc
	var_92_int = 0; // 0x2f1 PushI
	add(var_92_int); // 0x2f2 TObjFunc
	var_93_int = 0; // 0x2f4 PushI
	add(var_93_int); // 0x2f5 TObjFunc
	var_94_int = 1; // 0x2f7 PushI
	var_74_int = var_74_int + var_94_int; // 0x2f8 Add2
	goto Label_743; // 0x2f9 Jump
...
Label_763:
	var_95_string = "BAD PLAYER!"; // 0x2fb PushS
	Trace(var_95_string); // 0x2fc Func
}
...
func_1078(var_31_int)
{
	var_32_object = Obj(); var_33_int = 0; var_34_object = Obj(); var_35_int = 0; // 0x436 PushV
	var_36_string = "player"; // 0x437 PushS
	FindActor(var_34_object, var_36_string); // 0x438 Func
	var_37_bool = var_34_object == 0; // 0x43a Not
	if(var_37_bool == 0) goto Label_1086; // 0x43b JumpB
	var_31_int = 0; // 0x43c MovI
	return 4; // 0x43d Return
	
Label_1086:
	var_38_string = "vcharge"; // 0x43e PushS
	GetProperty(var_38_string, var_35_int); // 0x43f ObjFunc
	var_31_int = var_35_int; // 0x441 Mov
	return 4; // 0x442 Return
}


func_886(var_12_int)
{
	var_155_float = 0; var_156_float = 0; var_157_int = 0; var_158_int = 0; var_159_string = ""; var_160_float = 0; var_161_float = 0; var_162_float = 0; var_163_bool = 0; var_164_float = 0; var_165_float = 0; var_166_float = 0; var_167_float = 0; var_168_float = 0; var_169_float = 0; var_170_float = 0; var_171_int = 0; var_172_int = 0; var_173_string = ""; var_174_float = 0; var_175_float = 0; var_176_float = 0; var_177_bool = 0; var_178_float = 0; var_179_float = 0; var_180_float = 0; var_181_float = 0; var_182_float = 0; // 0x376 PushV
	var_169_float = 20; // 0x377 MovI
	var_170_float = 20; // 0x378 MovI
	size(var_171_int); // 0x379 TObjFunc
	var_172_int = 0; // 0x37b MovI
	
Label_892:
	var_183_bool = var_172_int < var_171_int; // 0x37c LT
	if(var_183_bool == 0) goto Label_1040; // 0x37d JumpB
	get(var_173_string, var_172_int); // 0x37e TObjFunc
	get(var_174_float, var_172_int); // 0x380 TObjFunc
	get(var_175_float, var_172_int); // 0x382 TObjFunc
	get(var_176_float, var_172_int); // 0x384 TObjFunc
	get(var_177_bool, var_172_int); // 0x386 TObjFunc
	var_184_string = "health"; // 0x388 PushS
	var_185_bool = var_173_string == var_184_string; // 0x389 Eq
	if(var_185_bool == 0) goto Label_918; // 0x38a JumpB
	var_186_float = 0.33; // 0x38b PushF
	var_187_bool = var_174_float <= var_186_float; // 0x38c LE
	if(var_187_bool == 0) goto Label_912; // 0x38d JumpB
	var_178_float = 1; // 0x38e MovI
	goto Label_917; // 0x38f Jump
	
Label_917:
	goto Label_987; // 0x395 Jump
	
Label_987:
	var_188_int = 0; // 0x3db PushI
	var_189_bool = var_176_float > var_188_int; // 0x3dc GT
	if(var_189_bool == 0) goto Label_998; // 0x3dd JumpB
	var_190_float = 2.0; // 0x3de PushF
	var_191_float = var_176_float / var_190_float; // 0x3df Div
	var_192_float = 3.1415; // 0x3e0 PushF
	var_193_float = var_191_float * var_192_float; // 0x3e1 Mult
	var_194_int = 2; // 0x3e2 PushI
	var_195_float = var_193_float / var_194_int; // 0x3e3 Div
	var_179_float = sin(var_195_float); // 0x3e4 Sin2
	goto Label_999; // 0x3e5 Jump
	
Label_999:
	var_196_int = 1; // 0x3e7 PushI
	var_197_bool = var_179_float > var_196_int; // 0x3e8 GT
	if(var_197_bool == 0) goto Label_1003; // 0x3e9 JumpB
	var_179_float = 1; // 0x3ea MovI
	
Label_1003:
	var_198_int = 0; // 0x3eb PushI
	var_199_bool = var_179_float < var_198_int; // 0x3ec LT
	if(var_199_bool == 0) goto Label_1007; // 0x3ed JumpB
	var_179_float = 0; // 0x3ee MovI
	
Label_1007:
	var_180_float = 256; // 0x3ef MovI
	var_181_float = 64; // 0x3f0 MovI
	var_200_string = "nerv_b"; // 0x3f1 PushS
	var_201_int = var_12_int - var_180_float; // 0x3f2 Sub
	var_202_int = var_201_int - var_170_float; // 0x3f3 Sub
	var_203_int = var_12_int - var_180_float; // 0x3f4 Sub
	var_204_int = var_203_int - var_170_float; // 0x3f5 Sub
	var_205_int = 43; // 0x3f6 PushI
	BlitClipped(var_200_string, var_202_int, var_169_float, var_204_int, var_169_float, var_180_float, var_205_int, var_179_float); // 0x3f7 Func
	var_206_int = var_180_float - var_181_float; // 0x3f9 Sub
	var_207_float = var_206_int * var_174_float; // 0x3fa Mult
	var_182_float = var_207_float + var_181_float; // 0x3fb Add2
	var_208_string = "nerv_r"; // 0x3fc PushS
	var_209_int = var_12_int - var_180_float; // 0x3fd Sub
	var_210_int = var_209_int - var_170_float; // 0x3fe Sub
	var_211_int = var_12_int - var_180_float; // 0x3ff Sub
	var_212_int = var_211_int - var_170_float; // 0x400 Sub
	var_213_int = 43; // 0x401 PushI
	BlitClipped(var_208_string, var_210_int, var_169_float, var_212_int, var_169_float, var_182_float, var_213_int, var_179_float); // 0x402 Func
	var_214_int = var_12_int - var_180_float; // 0x404 Sub
	var_215_int = var_214_int - var_170_float; // 0x405 Sub
	var_216_int = var_12_int - var_180_float; // 0x406 Sub
	var_217_int = var_216_int - var_170_float; // 0x407 Sub
	var_218_int = 43; // 0x408 PushI
	BlitClipped(var_173_string, var_215_int, var_169_float, var_217_int, var_169_float, var_180_float, var_218_int, var_179_float); // 0x409 Func
	var_219_int = 25; // 0x40b PushI
	var_169_float = var_169_float + var_219_int; // 0x40c Add2
	
Label_1037:
	var_220_int = 1; // 0x40d PushI
	var_172_int = var_172_int + var_220_int; // 0x40e Add2
	goto Label_892; // 0x40f Jump
	
Label_998:
	var_179_float = var_178_float; // 0x3e6 Mov
	
Label_912:
	var_221_int = 0; // 0x390 PushI
	var_222_bool = var_176_float == var_221_int; // 0x391 Eq
	if(var_222_bool == 0) goto Label_916; // 0x392 JumpB
	goto Label_1037; // 0x393 Jump
	
Label_916:
	var_178_float = 0.2; // 0x394 MovF
	
Label_918:
	var_223_string = "immunity"; // 0x396 PushS
	var_224_bool = var_173_string == var_223_string; // 0x397 Eq
	if(var_224_bool == 0) goto Label_932; // 0x398 JumpB
	var_225_float = 0.5; // 0x399 PushF
	var_226_bool = var_174_float < var_225_float; // 0x39a LT
	if(var_226_bool == 0) goto Label_926; // 0x39b JumpB
	var_178_float = 1; // 0x39c MovI
	goto Label_931; // 0x39d Jump
	
Label_931:
	goto Label_987; // 0x3a3 Jump
	
Label_926:
	var_227_int = 0; // 0x39e PushI
	var_228_bool = var_176_float == var_227_int; // 0x39f Eq
	if(var_228_bool == 0) goto Label_930; // 0x3a0 JumpB
	goto Label_1037; // 0x3a1 Jump
	
Label_930:
	var_178_float = 0.2; // 0x3a2 MovF
	
Label_932:
	var_229_string = "tiredness"; // 0x3a4 PushS
	var_230_bool = var_173_string == var_229_string; // 0x3a5 Eq
	if(var_230_bool == 0) goto Label_946; // 0x3a6 JumpB
	var_231_float = 0.66; // 0x3a7 PushF
	var_232_bool = var_174_float >= var_231_float; // 0x3a8 GE
	if(var_232_bool == 0) goto Label_940; // 0x3a9 JumpB
	var_178_float = 1; // 0x3aa MovI
	goto Label_945; // 0x3ab Jump
	
Label_945:
	goto Label_987; // 0x3b1 Jump
	
Label_940:
	var_233_int = 0; // 0x3ac PushI
	var_234_bool = var_176_float == var_233_int; // 0x3ad Eq
	if(var_234_bool == 0) goto Label_944; // 0x3ae JumpB
	goto Label_1037; // 0x3af Jump
	
Label_944:
	var_178_float = 0.2; // 0x3b0 MovF
	
Label_946:
	var_235_string = "hunger"; // 0x3b2 PushS
	var_236_bool = var_173_string == var_235_string; // 0x3b3 Eq
	if(var_236_bool == 0) goto Label_960; // 0x3b4 JumpB
	var_237_float = 0.66; // 0x3b5 PushF
	var_238_bool = var_174_float >= var_237_float; // 0x3b6 GE
	if(var_238_bool == 0) goto Label_954; // 0x3b7 JumpB
	var_178_float = 1; // 0x3b8 MovI
	goto Label_959; // 0x3b9 Jump
	
Label_959:
	goto Label_987; // 0x3bf Jump
	
Label_954:
	var_239_int = 0; // 0x3ba PushI
	var_240_bool = var_176_float == var_239_int; // 0x3bb Eq
	if(var_240_bool == 0) goto Label_958; // 0x3bc JumpB
	goto Label_1037; // 0x3bd Jump
	
Label_958:
	var_178_float = 0.2; // 0x3be MovF
	
Label_960:
	var_241_string = "reputation"; // 0x3c0 PushS
	var_242_bool = var_173_string == var_241_string; // 0x3c1 Eq
	if(var_242_bool == 0) goto Label_974; // 0x3c2 JumpB
	var_243_float = 0.66; // 0x3c3 PushF
	var_244_bool = var_174_float <= var_243_float; // 0x3c4 LE
	if(var_244_bool == 0) goto Label_968; // 0x3c5 JumpB
	var_178_float = 1; // 0x3c6 MovI
	goto Label_973; // 0x3c7 Jump
	
Label_973:
	goto Label_987; // 0x3cd Jump
	
Label_968:
	var_245_int = 0; // 0x3c8 PushI
	var_246_bool = var_176_float == var_245_int; // 0x3c9 Eq
	if(var_246_bool == 0) goto Label_972; // 0x3ca JumpB
	goto Label_1037; // 0x3cb Jump
	
Label_972:
	var_178_float = 0.2; // 0x3cc MovF
	
Label_974:
	var_247_string = "disease"; // 0x3ce PushS
	var_248_bool = var_173_string == var_247_string; // 0x3cf Eq
	if(var_248_bool == 0) goto Label_987; // 0x3d0 JumpB
	var_249_float = 0.33; // 0x3d1 PushF
	var_250_bool = var_174_float >= var_249_float; // 0x3d2 GE
	if(var_250_bool == 0) goto Label_982; // 0x3d3 JumpB
	var_178_float = 1; // 0x3d4 MovI
	goto Label_987; // 0x3d5 Jump
	
Label_982:
	var_251_int = 0; // 0x3d6 PushI
	var_252_bool = var_176_float == var_251_int; // 0x3d7 Eq
	if(var_252_bool == 0) goto Label_986; // 0x3d8 JumpB
	goto Label_1037; // 0x3d9 Jump
	
Label_986:
	var_178_float = 0.2; // 0x3da MovF
	
Label_1040:
	return 28; // 0x410 Return
}
...
func_825(var_104_float)
{
	var_105_int = 0; var_106_int = 0; var_107_float = 0; var_108_int = 0; var_109_int = 0; var_110_float = 0; // 0x339 PushV
	size(var_108_int); // 0x33a TObjFunc
	var_109_int = 0; // 0x33c MovI
	
Label_829:
	var_111_bool = var_109_int < var_108_int; // 0x33d LT
	if(var_111_bool == 0) goto Label_846; // 0x33e JumpB
	get(var_110_float, var_109_int); // 0x33f TObjFunc
	var_112_int = 0; // 0x341 PushI
	var_113_bool = var_110_float > var_112_int; // 0x342 GT
	if(var_113_bool == 0) goto Label_837; // 0x343 JumpB
	var_110_float = var_110_float - var_104_float; // 0x344 Sub2
	
Label_837:
	var_114_int = 0; // 0x345 PushI
	var_115_bool = var_110_float < var_114_int; // 0x346 LT
	if(var_115_bool == 0) goto Label_841; // 0x347 JumpB
	var_110_float = 0; // 0x348 MovI
	
Label_841:
	set(var_109_int, var_110_float); // 0x349 TObjFunc
	var_116_int = 1; // 0x34b PushI
	var_109_int = var_109_int + var_116_int; // 0x34c Add2
	goto Label_829; // 0x34d Jump
...
Label_326:
	...
	var_154_int = 1; // 0x158 PushI
	var_103_int = var_103_int + var_154_int; // 0x159 Add2
