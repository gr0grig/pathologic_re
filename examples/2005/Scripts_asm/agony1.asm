...
Strings:
	...
	W:bottle_water
	W:lockpick
// @pool_raw:
...
0x33: Stack[-1] = (float) 0.3333333432674408
0x34: Call2 0x167
...
0x39: Push("agony") // @poff=0
0x3a: Push([0.0, 40.0, 0.0])
0x3b: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x3c: Pop(2)
0x3d: Push("all") // @poff=12
0x3e: Push("agony") // @poff=0
...
0x48: Push("sleep") // @poff=20
0x49: Push([0.0, 40.0, 0.0])
0x4a: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x4b: Pop(2)
0x4c: Push("all") // @poff=12
0x4d: Push("agony_sleep") // @poff=32
0x4e: @ PlayAnimation(Stack[-2], Stack[-1])
0x4f: Pop(2)
0x50: @ WaitForAnimEnd()
0x51: Pop(0)
0x52: Push("all") // @poff=12
0x53: Push("agony_sleep") // @poff=32
...
0xa1: Stack[-8] = Stack[-2]
0xa2: Stack[-1] = (float) -0.30000001192092896
0xa3: Call2 0x171

0xa4: Pop(3)
0xa5: Push("death") // @poff=76
0xa6: Push([0.0, 40.0, 0.0])
0xa7: @ PlayGlobalSound(Stack[-2], Stack[-1])
0xa8: Pop(2)
0xa9: Push("all") // @poff=12
0xaa: Push("agony_die") // @poff=88
0xab: @ PlayAnimation(Stack[-2], Stack[-1])
0xac: Pop(2)
0xad: @ WaitForAnimEnd()
0xae: Pop(0)
0xaf: Push("all") // @poff=12
0xb0: Push("agony_die") // @poff=88
...
0xdc: Push("HasProperty") // @poff=108
0xdd: Push((int) 2)
...
0xe3: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=132
0xe4: Pop(0)
0xe5: Stack[-1] = Stack[-5]
0xe6: Return(); Pop(2)

0xe7: PushEmpty(float, float)
0xe8: PushEmpty(bool, object, string)
0xe9: Stack[-10] = Stack[-2]
0xea: Stack[-9] = Stack[-1]
0xeb: Call2 0xdb
...
0x10c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=168
0x10d: Pop(0)
...
0x11d: Stack[-1] = "fhit" // @poff=180
0x11e: GOTO 0x120

0x11f: Stack[-1] = "bhit" // @poff=190
0x120: Push("hit_react") // @poff=200
0x121: Push("1") // @poff=220
0x122: Pop(1); Push(Stack[-3] + Stack[-1]);
0x123: Push("2") // @poff=224
...
0x12b: Pop(0)
0x12c: Push("scripted") // @poff=228
0x12d: Push("blood_dir.xml") // @poff=246
...
0x139: Pop(0)
0x13a: Stack[-1] = Stack[-3]
0x13b: Return(); Pop(2)

0x13c: PushEmpty(bool, bool)
0x13d: PushEmpty(bool, int, int)
0x13e: Stack[-7] = Stack[-2]
0x13f: Stack[-6] = Stack[-1]
0x140: Call2 0x16c
...
0x18b: Stack[-8] = Stack[-5]
0x18c: Stack[-4] = "reputation" // @poff=274
0x18d: Stack[-7] = Stack[-3]
0x18e: Stack[-2] = (int) 0
0x18f: Stack[-1] = (int) 1
0x190: Call2 0xe7
...
0x196: Pop(0)
0x197: @@ add(Stack[-3]); Obj=1 // @poff=296
0x198: Pop(0)
0x199: Push((int) 16)
...
0x1b6: Stack[-11] = Stack[-5]
0x1b7: Stack[-10] = Stack[-4]
0x1b8: Stack[-9] = Stack[-3]
0x1b9: Stack[-7] = Stack[-2]
0x1ba: Stack[-6] = Stack[-1]
0x1bb: Call2 0x129
...
0x1da: Push("GenerateMoney: iMin > iMax") // @poff=330
0x1db: @ Trace(Stack[-1])
0x1dc: Pop(1)
0x1dd: Return(); Pop(4)
...
0x203: Stack[-4] = "bottle_water" // @poff=396
0x204: Stack[-3] = (int) 1
0x205: Stack[-2] = (int) 4
0x206: Stack[-1] = (int) 4
0x207: Call2 0x147
...
0x20a: Stack[-3] = "lockpick" // @poff=422
0x20b: Stack[-2] = (int) 1
0x20c: Stack[-1] = (int) 6
0x20d: Call2 0x13c
