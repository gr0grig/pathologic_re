...
Strings:
	W:agony
	W:all
// @pool_raw:610067006f006e007900000061006c006c000000
...
0x15: Stack[-1] = (float) 0.3333333432674408
0x16: Call2 0x2f
...
0x1b: Push("agony") // @poff=0
0x1c: Push([0.0, 40.0, 0.0])
0x1d: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x1e: Pop(2)
0x1f: Push("all") // @poff=12
0x20: Push("agony") // @poff=0
