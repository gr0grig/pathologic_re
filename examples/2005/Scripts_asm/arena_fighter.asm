...
Strings:
	...
	W:blood_dir.xml
	W:battle
// @pool_raw:
...
0xa: Pop(0); PushNull((bool) Stack[-21] == 0)
0xb: IF (Stack[-1] == 0) GOTO 0x11; Pop(1)

0xc: PushEmpty(string)
0xd: Stack[-1] = "fdie" // @poff=0
0xe: Call2 0x64

0xf: Pop(1)
0x10: GOTO 0x63

0x11: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x12: Pop(0)
...
0x22: Stack[-6] = "fdie" // @poff=0
0x23: GOTO 0x25

0x24: Stack[-6] = "bdie" // @poff=22
...
0x2b: @ StopAsync()
0x2c: Pop(0)
0x2d: Stack[-21] = Stack[-5]
0x2e: Push("GetScriptProperty") // @poff=32
0x2f: Push((int) 2)
0x30: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x31: IF (Stack[-1] == 0) GOTO 0x3d; Pop(1)

0x32: Push("Owner") // @poff=68
0x33: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x34: Pop(1)
0x35: Push(Stack[-4])
0x36: IF (Stack[-1] == 0) GOTO 0x3d; Pop(1)

0x37: Push("Owner") // @poff=68
0x38: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x39: Pop(1)
0x3a: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3b: IF (Stack[-1] == 0) GOTO 0x3d; Pop(1)

0x3c: Stack[-21] = Stack[-5]
0x3d: Push("@GetEyesHeight") // @poff=116
0x3e: Push((int) 1)
0x3f: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x40: IF (Stack[-1] == 0) GOTO 0x4c; Pop(1)

0x41: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x42: Pop(0)
0x43: Stack[-1] = [0.0, 0.0, 0.0]
0x44: Push(CvectorIndex(Stack[-1], 1))
0x45: Stack[-3] = Stack[-1]
0x46: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x47: Push("head") // @poff=160
...
0x4e: Stack[-7] = Stack[-1]
0x4f: Call2 0x565

0x50: Pop(1)
0x51: Push("all") // @poff=170
...
0x58: @ StopAsync()
0x59: Pop(0)
0x5a: Push("head") // @poff=160
0x5b: @ UnlookAsync(Stack[-1])
0x5c: Pop(1)
0x5d: Push("all") // @poff=170
...
0x72: Pop(1)
0x73: Push("all") // @poff=170
0x74: @ PlayAnimation(Stack[-1], Stack[-2])
0x75: Pop(1)
0x76: @ WaitForAnimEnd()
0x77: Pop(0)
0x78: Push("all") // @poff=170
...
0x95: Stack[-1] = 0
0x96: PushEmpty()
0x97: Stack[-3] = (float) 0.10000000149011612
0x98: Return(); Pop(0)
...
0xb8: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xb9: Pop(0)
0xba: Push(Stack[-8])
0xbb: IF (Stack[-1] == 0) GOTO 0xc4; Pop(1)

0xbc: Push("attack") // @poff=248
...
0xd8: Pop(0)
0xd9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=262
0xda: Pop(0)
...
0xf4: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=262
0xf5: Pop(0)
...
0x10e: Pop(1)
0x10f: Push("all") // @poff=170
0x110: Push("attack_on") // @poff=276
...
0x126: Push((float)0.6000000238418579)
0x127: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x128: IF (Stack[-1] == 1) GOTO 0x12e; Pop(1)
...
0x12f: @ Face(Stack[-0]T)
0x130: Pop(0)
0x131: PushEmpty()
0x132: Call2 0x32c

0x133: Pop(0)
0x134: Push("all") // @poff=170
0x135: Push("attack_stay") // @poff=296
0x136: @ PlayAnimation(Stack[-2], Stack[-1])
0x137: Pop(2)
0x138: PushEmpty(bool, float)
0x139: Stack[-25] = Stack[-1]
0x13a: Call2 0x276
...
0x140: Pop(0)
0x141: Push("all") // @poff=170
0x142: Push("fjump") // @poff=320
...
0x15d: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=262
0x15e: Pop(0)
...
0x17c: Push("all") // @poff=170
0x17d: Push("attack_off") // @poff=332
...
0x18a: Push("all") // @poff=170
0x18b: Push("attack_begin") // @poff=354
0x18c: Push((int) 1)
0x18d: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x198: Push("attack") // @poff=248
0x199: Push((int) 1)
0x19a: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1a4: Push("all") // @poff=170
0x1a5: Push("bjump") // @poff=380
...
0x1ac: Push((float)0.8999999761581421)
0x1ad: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1ae: @ GetVictim(Stack[-1], Stack[-4])
0x1af: Pop(1)
0x1b0: @ ReportAttack(Stack[-0]T)
0x1b1: Pop(0)
...
0x1b5: Stack[-6] = Stack[-2]
0x1b6: Stack[-10] = Stack[-1]
0x1b7: Call2 0x96

0x1b8: Stack[-3] = Stack[-5]
0x1b9: Pop(3)
0x1ba: PushEmpty(float, object, float, int)
0x1bb: Stack[-7] = Stack[-3]
0x1bc: Stack[-6] = Stack[-2]
0x1bd: PushEmpty(int, object, int)
0x1be: Stack[-10] = Stack[-2]
0x1bf: Stack[-14] = Stack[-1]
0x1c0: Call2 0x99

0x1c1: Stack[-3] = Stack[-4]
0x1c2: Pop(3)
0x1c3: Call2 0x45f

0x1c4: Stack[-4] = Stack[-5]
0x1c5: Pop(4)
0x1c6: PushEmpty(int)
0x1c7: Call2 0x32a

0x1c8: Pop(0)
0x1c9: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1ca: Pop(1)
0x1cb: PushEmpty(object, float)
0x1cc: Stack[-5] = Stack[-2]
0x1cd: Stack[-3] = Stack[-1]
0x1ce: Call2 0x331
...
0x1d5: Pop(0)
0x1d6: @ irand(Stack[-4], Stack[-1]T)
0x1d7: Pop(0)
0x1d8: Push((int) 1)
0x1d9: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x1da: @ Face(Stack[-0]T)
0x1db: Pop(0)
0x1dc: Push((bool) 1)
...
0x1e1: Pop(0)
0x1e2: Push("all") // @poff=170
0x1e3: Push("attack_begin") // @poff=354
...
0x1f7: Stack[-11] = Stack[-2]
0x1f8: Stack[-6] = Stack[-1]
0x1f9: Call2 0x1ab

0x1fa: Pop(2)
0x1fb: Push("all") // @poff=170
0x1fc: Push("attack_middle") // @poff=392
...
0x204: Pop(0)
0x205: Push("all") // @poff=170
0x206: Push("attack_middle") // @poff=392
...
0x21a: Stack[-11] = Stack[-2]
0x21b: Stack[-6] = Stack[-1]
0x21c: Call2 0x1ab

0x21d: Pop(2)
0x21e: Stack[-2] = (int) 1
0x21f: Push("attack_middle") // @poff=392
0x220: Pop(1); Push(Stack[-1] + Stack[-5]);
0x221: Push("_") // @poff=420
0x222: Pop(2); Push(Stack[-2] + Stack[-1]);
0x223: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x224: Push("all") // @poff=170
...
0x249: Pop(1)
0x24a: Push("all") // @poff=170
0x24b: Push("attack_end") // @poff=424
...
0x28a: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=262
0x28b: Pop(0)
...
0x2d6: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2d7: Pop(1)
...
0x2dc: Pop(0)
0x2dd: Push("all") // @poff=170
0x2de: Push("bjump") // @poff=380
0x2df: @ PlayAnimation(Stack[-2], Stack[-1])
0x2e0: Pop(2)
0x2e1: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=262
0x2e2: Pop(0)
...
0x318: @ irand(Stack[-1], Stack[-2]T)
0x319: Pop(0)
0x31a: Push((int) 1)
0x31b: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x31c: Push("attack") // @poff=248
...
0x32d: Stack[-1] = "attack_stay" // @poff=296
0x32e: Call2 0x565
...
0x35f: Stack[-15] = Stack[-5]
0x360: Stack[-14] = Stack[-4]
0x361: Stack[-13] = Stack[-3]
0x362: Stack[-12] = Stack[-2]
0x363: Stack[-11] = Stack[-1]
0x364: Call2 0x3a9

0x365: Stack[-6] = Stack[-7]
0x366: Pop(6)
0x367: Push( Stack[2 + Tasks[-1].StackPointer] )
0x368: IF (Stack[-1] == 0) GOTO 0x36c; Pop(1)

0x369: Push("head") // @poff=160
0x36a: @ UnlookAsync(Stack[-1])
0x36b: Pop(1)
0x36c: Push((int) 1)
0x36d: @ KillTimer(Stack[-1])
0x36e: Pop(1)
0x36f: Stack[-1] = Stack[-10]
0x370: Return(); Pop(4)
...
0x3ac: Stack[-17] = Stack[-7]
0x3ad: PushEmpty(bool, object)
0x3ae: Stack[-23] = Stack[-1]
0x3af: Call2 0x339
...
0x3b5: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x3b6: Pop(0)
...
0x3cc: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=262
0x3cd: Pop(0)
...
0x3de: Push((int) 0)
0x3df: Push((float)0.30000001192092896)
...
0x401: Push((int) 0)
0x402: Push((float)0.30000001192092896)
...
0x431: Stack[-2] = Stack[-1]
0x432: Call2 0x5f5

0x433: Pop(1)
0x434: Return(); Pop(0)

0x435: Stack[-1] = "walk" // @poff=482
0x436: Return(); Pop(0)

0x437: Stack[-1] = "run" // @poff=492
0x438: Return(); Pop(0)
...
0x443: Stack[-2] = "bullet" // @poff=510
0x444: Return(); Pop(0)

0x445: Stack[-2] = "phys" // @poff=524
0x446: Return(); Pop(0)

0x447: PushEmpty(cvector, cvector, cvector, cvector)
0x448: @ GetPosition(Stack[-2])
0x449: Pop(0)
0x44a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x44b: Pop(0)
...
0x454: Push("HasProperty") // @poff=534
0x455: Push((int) 2)
...
0x45b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=558
0x45c: Pop(0)
0x45d: Stack[-1] = Stack[-5]
0x45e: Return(); Pop(2)
...
0x46a: Stack[-18] = Stack[-2]
0x46b: Stack[-1] = "armor" // @poff=584
0x46c: Call2 0x453
...
0x472: Push("armor") // @poff=584
0x473: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=596
0x474: Pop(1)
0x475: Push("armor_") // @poff=608
0x476: PushEmpty(string, int)
0x477: Stack[-16] = Stack[-1]
0x478: Call2 0x439

0x479: Pop(1)
0x47a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x47b: PushEmpty(bool, object, string)
0x47c: Stack[-18] = Stack[-2]
...
0x484: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=596
0x485: Pop(0)
...
0x48c: Stack[-3] = Stack[-6]
0x48d: Pop(3)
0x48e: Push("health") // @poff=570
0x48f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=596
0x490: Pop(1)
0x491: Push((int) 1)
0x492: Pop(1); Push(Stack[-1] - Stack[-4]);
0x493: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x494: Push("health") // @poff=570
...
0x49a: Pop(3)
0x49b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=622
0x49c: Pop(2)
0x49d: PushEmpty(bool, object)
0x49e: Stack[-17] = Stack[-1]
0x49f: Call2 0x44e
...
0x4a5: Pop(1)
0x4a6: Stack[-1] = Stack[-16]
0x4a7: Return(); Pop(12)

0x4a8: PushEmpty(bool, bool)
0x4a9: @@ IsDead(Stack[-1]); Obj=3 // @poff=634
0x4aa: Pop(0)
...
0x4c2: Pop(0)
0x4c3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4c4: IF (Stack[-1] == 0) GOTO 0x4c7; Pop(1)

0x4c5: Stack[-6] = (bool) 0
0x4c6: Return(); Pop(4)

0x4c7: @@ GetScene(Stack[-1]); Obj=5 // @poff=655
0x4c8: Pop(0)
...
0x4d2: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x4e0: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x4e1: Pop(0)
...
0x4f1: Stack[-1] = "fhit" // @poff=664
0x4f2: GOTO 0x4f4

0x4f3: Stack[-1] = "bhit" // @poff=674
0x4f4: Push("hit_react") // @poff=684
0x4f5: Push("1") // @poff=704
0x4f6: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4f7: Push("2") // @poff=708
...
0x510: Stack[-25] = Stack[-1]
0x511: Call2 0x447

0x512: Stack[-2] = Stack[-3]
0x513: Pop(2)
0x514: Call2 0x594

0x515: Stack[-2] = Stack[-11]
0x516: Pop(2)
0x517: @ CreateVectorVector(Stack[-8])
0x518: Pop(0)
0x519: Stack[-7] = (int) 1
0x51a: Push("hit") // @poff=666
...
0x52f: Pop(0)
0x530: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=721
0x531: Pop(0)
0x532: PushEmpty(object, int, float, cvector, cvector)
0x533: Stack[-26] = Stack[-5]
0x534: Stack[-25] = Stack[-4]
0x535: Stack[-24] = Stack[-3]
...
0x550: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x551: Pop(0)
...
0x55b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x55c: Pop(0)
0x55d: Stack[-1] = [0.0, 0.0, 0.0]
0x55e: Push(CvectorIndex(Stack[-1], 1))
0x55f: Stack[-3] = Stack[-1]
0x560: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x561: Push("head") // @poff=160
...
0x5a1: Stack[-2] = Stack[-3]
0x5a2: GOTO 0x5a4

0x5a3: Stack[-1] = Stack[-3]
0x5a4: Return(); Pop(0)
...
0x5d8: Stack[-7] = Stack[-3]
0x5d9: Stack[-6] = Stack[-2]
0x5da: Stack[-5] = Stack[-1]
0x5db: Call2 0x4fd
...
0x5e0: Stack[-11] = Stack[-5]
0x5e1: Stack[-10] = Stack[-4]
0x5e2: Stack[-9] = Stack[-3]
0x5e3: Stack[-7] = Stack[-2]
0x5e4: Stack[-6] = Stack[-1]
0x5e5: Call2 0x541
