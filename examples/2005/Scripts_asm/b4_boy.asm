...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x108: Pop(0)
0x109: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=156
0x10a: Pop(1)
...
0x11a: Push("player") // @poff=178
0x11b: @ FindActor(Stack[-4]T, Stack[-1])
0x11c: Pop(1)
...
0x12f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1ba: Pop(0)
0x1bb: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=202
0x1bc: Pop(0)
...
0x1d9: Stack[-1] = (float) 1.7453293800354004
0x1da: Call2 0x1b8

0x1db: Stack[-2] = Stack[-7]
0x1dc: Pop(2)
...
0x1e2: Stack[-1] = (float) 2.6179938316345215
0x1e3: Call2 0x1b8

0x1e4: Stack[-2] = Stack[-7]
0x1e5: Pop(2)
...
0x1ea: Push("Can't retreat, distance: ") // @poff=214
...
0x200: Push((int) 1)
0x201: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x202: Pop(1)
0x203: Push(Stack[-3])
0x204: IF (Stack[-1] == 0) GOTO 0x21c; Pop(1)

0x205: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x21d: IF (Stack[-1] == 1) GOTO 0x200; Pop(1)
...
0x224: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x233: Stack[-1] = (float) 1.7453293800354004
0x234: Call2 0x1b8

0x235: Stack[-2] = Stack[-4]
0x236: Pop(2)
...
0x243: IF (Stack[-1] == 1) GOTO 0x249; Pop(1)

0x244: PushEmpty(bool)
0x245: Call2 0x263

0x246: Pop(0)
0x247: IF (Stack[-1] == 1) GOTO 0x249; Pop(1)
...
0x269: Stack[-2] = Stack[-3]
0x26a: Pop(2)
0x26b: PushEmpty(float, cvector, cvector)
0x26c: Stack[-5] = Stack[-2]
0x26d: Stack[-4] = Stack[-1]
0x26e: Call2 0x310

0x26f: Pop(2)
0x270: Push((float)-0.3420201241970062)
...
0x27a: Pop(0)
0x27b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=202
0x27c: Pop(0)
...
0x281: Pop(0)
0x282: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x283: Pop(0)
...
0x28d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x28e: Pop(0)
0x28f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=266
0x290: Pop(0)
...
0x2ef: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=266
0x2f0: Pop(0)
0x2f1: Stack[-1] = [0.0, 0.0, 0.0]
0x2f2: Push(CvectorIndex(Stack[-1], 1))
0x2f3: Stack[-3] = Stack[-1]
0x2f4: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2f5: Push("head") // @poff=192
...
0x321: Stack[-1] = "ui/NPC_None.png" // @poff=280
0x322: Return(); Pop(0)

0x323: Stack[-1] = "ui/NPC_Black_b.png" // @poff=312
0x324: Return(); Pop(0)
...
0x344: Pop(1)
0x345: Stack[-2] = "pt_map_eva" // @poff=350
0x346: Stack[-1] = (int) 2
0x347: Call2 0x376
...
0x34b: Pop(0)
0x34c: @@ ShowMap(Stack[-1]); Obj=2 // @poff=372
0x34d: Pop(1)
0x34e: Return(); Pop(0)
...
0x353: Pop(1)
0x354: Push("b4q01BoyGotoDanko") // @poff=380
0x355: Push("pt_map_eva") // @poff=350
0x356: Push((int) 3)
...
0x35a: Pop(0)
0x35b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=416
0x35c: Pop(5)
0x35d: Return(); Pop(2)

0x35e: Stack[-1] = 0
0x35f: PushEmpty()
0x360: Push("playsound") // @poff=424
0x361: Push("mapmark") // @poff=444
...
0x367: Pop(0)
0x368: Pop(0); PushNull((bool) Stack[-2] == 0)
0x369: IF (Stack[-1] == 0) GOTO 0x370; Pop(1)

0x36a: Push("Can't find main outdoor scene") // @poff=460
0x36b: @ Trace(Stack[-1])
0x36c: Pop(1)
0x36d: Stack[-1] = 0
...
0x370: @@ GetMap(Stack[-1]); Obj=2 // @poff=520
0x371: Pop(0)
...
0x378: Pop(0)
0x379: Pop(0); PushNull((bool) Stack[-2] == 0)
0x37a: IF (Stack[-1] == 0) GOTO 0x37f; Pop(1)

0x37b: Push("Can't find main outdoor scene") // @poff=460
0x37c: @ Trace(Stack[-1])
0x37d: Pop(1)
0x37e: Return(); Pop(8)

0x37f: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=527
0x380: Pop(0)
0x381: Pop(0); Push((bool) Stack[-1] == 0)
0x382: IF (Stack[-1] == 0) GOTO 0x389; Pop(1)

0x383: Push("Warning: outdoor scene locator ") // @poff=538
0x384: Pop(1); Push(Stack[-1] + Stack[-11]);
0x385: Push(" doesnt exist") // @poff=602
0x386: Pop(2); Push(Stack[-2] + Stack[-1]);
0x387: @ Trace(Stack[-1])
0x388: Pop(1)
0x389: @@ GetMap(Stack[-11]); Obj=2 // @poff=520
0x38a: Pop(0)
0x38b: Pop(0); PushNull((bool) Stack[-11] == 0)
0x38c: IF (Stack[-1] == 0) GOTO 0x391; Pop(1)

0x38d: Push("Can't find map") // @poff=630
0x38e: @ Trace(Stack[-1])
0x38f: Pop(1)
0x390: Return(); Pop(8)
...
0x393: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=660
0x394: Pop(2)
0x395: Return(); Pop(8)

0x396: Stack[-2] = 0
0x397: PushEmpty(int, int)
0x398: Push("branch") // @poff=673
