...
Strings:
	...
	A:AddSource
	A:Fade
// @pool_raw:62006c006f006f0064000000456e61626c6500416464536f75726365004661646500
...
0xc: Push("blood") // @poff=0
0xd: @ FindParticleSystem(Stack[-1], Stack[-5])
0xe: Pop(1)
0xf: @@ Enable(); Obj=4 // @poff=12
0x10: Pop(0)
0x11: Stack[0 + Tasks[-1].StackPointer] = [0.0, 0.0, 0.0]
0x12: Stack[1 + Tasks[-1].StackPointer] = [-100.0, 100.0, 0.0]
0x13: Push((float)0.30000001192092896)
0x14: @@ AddSource(Stack[-0]T, Stack[-1]T, Stack[-1]); Obj=5 // @poff=19
0x15: Pop(1)
0x16: Stack[-3] = (float) 0.4000000059604645
0x17: Push((int) 0)
...
0x1d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 1))
0x1e: Push((int) 150)
...
0x23: @@ AddSource(Stack[-0]T, Stack[-1]T, Stack[-1]); Obj=5 // @poff=19
0x24: Pop(1)
0x25: GOTO 0x17

0x26: Push((bool) 1)
0x27: @@ Fade(Stack[-1]); Obj=5 // @poff=29
0x28: Pop(1)
0x29: Stack[-3] = (float) 0.4000000059604645
0x2a: Push((int) 0)
...
0x30: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 1))
0x31: Push((int) 150)
...
0x35: Push((float)0.30000001192092896)
0x36: @@ AddSource(Stack[-0]T, Stack[-1]T, Stack[-1]); Obj=5 // @poff=19
0x37: Pop(1)
0x38: GOTO 0x2a
