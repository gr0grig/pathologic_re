...
Strings:
	...
	W:health
	A:SetProperty
// @pool_raw:61006300740069007600610074006500000064006500610063007400690076006100740065000000710075006500730074005f006200310031005f00300031000000730068006100660074005f00640072006f00700000006800650061006c0074006800000053657450726f706572747900
...
0x17: Stack[-2] = "quest_b11_01" // @poff=40
0x18: Stack[-1] = "shaft_drop" // @poff=66
0x19: Call2 0x21

0x1a: Pop(3)
0x1b: GOTO 0x20

0x1c: Push("health") // @poff=88
0x1d: Push((int) 0)
0x1e: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=102
0x1f: Pop(2)
0x20: Return(); Pop(2)
...
0x23: Pop(0)
0x24: Pop(0); PushNull((bool) Stack[-1] == 0)
