...
Strings:
	...
	A:AddSource
	A:Enable
// @pool_raw:62006f006e0066006900720065000000430061006e00270074002000660069006e0064002000660069007200650020007000610072007400690063006c0065002000730079007300740065006d00000066006900720065005f006c006f006f0070000000416464536f7572636500456e61626c6500
...
0x27: Push((float)0.0)
0x28: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x29: Pop(3)
0x2a: Push([10.0, 0.0, 0.0])
0x2b: Push([0.0, 1.0, 0.0])
0x2c: Push((float)0.0)
0x2d: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x2e: Pop(3)
0x2f: Push([0.0, 0.0, 10.0])
0x30: Push([0.0, 1.0, 0.0])
0x31: Push((float)0.0)
0x32: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x33: Pop(3)
0x34: Push([-10.0, 0.0, 0.0])
0x35: Push([0.0, 1.0, 0.0])
0x36: Push((float)0.0)
0x37: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x38: Pop(3)
0x39: Push([0.0, 0.0, -10.0])
0x3a: Push([0.0, 1.0, 0.0])
0x3b: Push((float)0.0)
0x3c: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x3d: Pop(3)
0x3e: Push([10.0, 0.0, 10.0])
0x3f: Push([0.0, 1.0, 0.0])
0x40: Push((float)0.0)
0x41: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x42: Pop(3)
0x43: Push([-10.0, 0.0, -10.0])
0x44: Push([0.0, 1.0, 0.0])
0x45: Push((float)0.0)
0x46: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x47: Pop(3)
0x48: Push([-10.0, 0.0, 10.0])
0x49: Push([0.0, 1.0, 0.0])
0x4a: Push((float)0.0)
0x4b: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x4c: Pop(3)
0x4d: Push([10.0, 0.0, -10.0])
0x4e: Push([0.0, 1.0, 0.0])
0x4f: Push((float)0.0)
0x50: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=100
0x51: Pop(3)
0x52: @@ Enable(); Obj=2 // @poff=110
0x53: Pop(0)
0x54: @ Hold()
0x55: Pop(0)
0x56: GOTO 0x54
