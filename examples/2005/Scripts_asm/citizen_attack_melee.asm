...
Strings:
	...
	W:hunter
	W:soldier
// @pool_raw:
...
Events:
EVENT_16 Op = 0x950 Vars = (object, string)
EVENT_41 Op = 0x95d Vars = (object)
EVENT_22 Op = 0x963 Vars = (object, int, float, float)
EVENT_43 Op = 0x96b Vars = (object, int, float, float, cvector, cvector)
...
0x30f: PushEmpty()
0x310: Stack[-3] = (float) 0.05000000074505806
0x311: Return(); Pop(0)
...
0x32a: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x32b: Pop(0)
0x32c: Push(Stack[-8])
0x32d: IF (Stack[-1] == 0) GOTO 0x336; Pop(1)

0x32e: Push("attack") // @poff=234
...
0x34a: Pop(0)
0x34b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x34c: Pop(0)
...
0x366: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=248
0x367: Pop(0)
...
0x380: Pop(1)
0x381: Push("all") // @poff=170
0x382: Push("attack_on") // @poff=262
...
0x39a: IF (Stack[-1] == 1) GOTO 0x3a0; Pop(1)

0x39b: PushEmpty(bool)
0x39c: Call2 0x56c

0x39d: Pop(0)
0x39e: IF (Stack[-1] == 1) GOTO 0x3a0; Pop(1)

0x39f: Stack[-1] = (bool) 0
0x3a0: IF (Stack[-1] == 0) GOTO 0x3b1; Pop(1)

0x3a1: @ Face(Stack[-0]T)
0x3a2: Pop(0)
0x3a3: PushEmpty()
0x3a4: Call2 0x59e

0x3a5: Pop(0)
0x3a6: Push("all") // @poff=170
0x3a7: Push("attack_stay") // @poff=282
0x3a8: @ PlayAnimation(Stack[-2], Stack[-1])
0x3a9: Pop(2)
0x3aa: PushEmpty(bool, float)
0x3ab: Stack[-25] = Stack[-1]
0x3ac: Call2 0x4e8
...
0x3b1: @ Face(Stack[-0]T)
0x3b2: Pop(0)
0x3b3: Push("all") // @poff=170
0x3b4: Push("fjump") // @poff=306
...
0x3cf: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x3d0: Pop(0)
...
0x3ee: Push("all") // @poff=170
0x3ef: Push("attack_off") // @poff=318
...
0x3fc: Push("all") // @poff=170
0x3fd: Push("attack_begin") // @poff=340
0x3fe: Push((int) 1)
0x3ff: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x40a: Push("attack") // @poff=234
0x40b: Push((int) 1)
0x40c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x416: Push("all") // @poff=170
0x417: Push("bjump") // @poff=366
...
0x41e: Push((float)0.8999999761581421)
0x41f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x420: @ GetVictim(Stack[-1], Stack[-4])
0x421: Pop(1)
0x422: @ ReportAttack(Stack[-0]T)
0x423: Pop(0)
...
0x427: Stack[-6] = Stack[-2]
0x428: Stack[-10] = Stack[-1]
0x429: Call2 0x30f

0x42a: Stack[-3] = Stack[-5]
0x42b: Pop(3)
0x42c: PushEmpty(float, object, float, int)
0x42d: Stack[-7] = Stack[-3]
0x42e: Stack[-6] = Stack[-2]
0x42f: PushEmpty(int, object, int)
0x430: Stack[-10] = Stack[-2]
0x431: Stack[-14] = Stack[-1]
0x432: Call2 0x312

0x433: Stack[-3] = Stack[-4]
0x434: Pop(3)
0x435: Call2 0x6e0

0x436: Stack[-4] = Stack[-5]
0x437: Pop(4)
0x438: PushEmpty(int)
0x439: Call2 0x59c

0x43a: Pop(0)
0x43b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x43c: Pop(1)
0x43d: PushEmpty(object, float)
0x43e: Stack[-5] = Stack[-2]
...
0x447: Pop(0)
0x448: @ irand(Stack[-4], Stack[-1]T)
0x449: Pop(0)
0x44a: Push((int) 1)
0x44b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x44c: @ Face(Stack[-0]T)
0x44d: Pop(0)
0x44e: Push((bool) 1)
...
0x453: Pop(0)
0x454: Push("all") // @poff=170
0x455: Push("attack_begin") // @poff=340
...
0x469: Stack[-11] = Stack[-2]
0x46a: Stack[-6] = Stack[-1]
0x46b: Call2 0x41d

0x46c: Pop(2)
0x46d: Push("all") // @poff=170
0x46e: Push("attack_middle") // @poff=378
...
0x476: Pop(0)
0x477: Push("all") // @poff=170
0x478: Push("attack_middle") // @poff=378
...
0x4bb: Pop(1)
0x4bc: Push("all") // @poff=170
0x4bd: Push("attack_end") // @poff=410
...
0x4fc: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=248
0x4fd: Pop(0)
...
0x548: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x549: Pop(1)
...
0x54d: @ Face(Stack[-0]T)
0x54e: Pop(0)
0x54f: Push("all") // @poff=170
0x550: Push("bjump") // @poff=366
0x551: @ PlayAnimation(Stack[-2], Stack[-1])
0x552: Pop(2)
0x553: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=248
0x554: Pop(0)
...
0x58a: @ irand(Stack[-1], Stack[-2]T)
0x58b: Pop(0)
0x58c: Push((int) 1)
0x58d: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x58e: Push("attack") // @poff=234
...
0x59f: Stack[-1] = "attack_stay" // @poff=282
0x5a0: Call2 0x803
...
0x5d1: Stack[-15] = Stack[-5]
0x5d2: Stack[-14] = Stack[-4]
0x5d3: Stack[-13] = Stack[-3]
0x5d4: Stack[-12] = Stack[-2]
0x5d5: Stack[-11] = Stack[-1]
0x5d6: Call2 0x61b

0x5d7: Stack[-6] = Stack[-7]
0x5d8: Pop(6)
0x5d9: Push( Stack[2 + Tasks[-1].StackPointer] )
0x5da: IF (Stack[-1] == 0) GOTO 0x5de; Pop(1)

0x5db: Push("head") // @poff=160
0x5dc: @ UnlookAsync(Stack[-1])
0x5dd: Pop(1)
0x5de: Push((int) 1)
0x5df: @ KillTimer(Stack[-1])
0x5e0: Pop(1)
0x5e1: Stack[-1] = Stack[-10]
0x5e2: Return(); Pop(4)
...
0x61e: Stack[-17] = Stack[-7]
0x61f: PushEmpty(bool, object)
0x620: Stack[-23] = Stack[-1]
0x621: Call2 0x6a7
...
0x627: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x628: Pop(0)
...
0x63e: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=248
0x63f: Pop(0)
...
0x650: Push((int) 0)
0x651: Push((float)0.30000001192092896)
...
0x673: Push((int) 0)
0x674: Push((float)0.30000001192092896)
...
0x6a9: Stack[-3] = Stack[-1]
0x6aa: Call2 0x752

0x6ab: Stack[-2] = Stack[-4]
0x6ac: Pop(2)
0x6ad: Return(); Pop(0)

0x6ae: Stack[-1] = "walk" // @poff=468
0x6af: Return(); Pop(0)

0x6b0: Stack[-1] = "run" // @poff=478
0x6b1: Return(); Pop(0)
...
0x6bc: Stack[-2] = "bullet" // @poff=496
0x6bd: Return(); Pop(0)

0x6be: Stack[-2] = "phys" // @poff=510
0x6bf: Return(); Pop(0)

0x6c0: PushEmpty(cvector, cvector, cvector, cvector)
0x6c1: @ GetPosition(Stack[-2])
0x6c2: Pop(0)
0x6c3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x6c4: Pop(0)
...
0x6c9: Pop(0)
0x6ca: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x6cb: Pop(0)
...
0x6d5: Push("HasProperty") // @poff=520
0x6d6: Push((int) 2)
...
0x6dc: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x6dd: Pop(0)
0x6de: Stack[-1] = Stack[-5]
0x6df: Return(); Pop(2)

0x6e0: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x6e1: PushEmpty(bool, object, string)
0x6e2: Stack[-18] = Stack[-2]
0x6e3: Stack[-1] = "health" // @poff=556
0x6e4: Call2 0x6d4
...
0x6eb: Stack[-18] = Stack[-2]
0x6ec: Stack[-1] = "armor" // @poff=570
0x6ed: Call2 0x6d4
...
0x6f3: Push("armor") // @poff=570
0x6f4: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x6f5: Pop(1)
0x6f6: Push("armor_") // @poff=594
0x6f7: PushEmpty(string, int)
0x6f8: Stack[-16] = Stack[-1]
0x6f9: Call2 0x6b2

0x6fa: Pop(1)
0x6fb: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6fc: PushEmpty(bool, object, string)
0x6fd: Stack[-18] = Stack[-2]
0x6fe: Stack[-8] = Stack[-1]
0x6ff: Call2 0x6d4
...
0x705: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x706: Pop(0)
...
0x70d: Stack[-3] = Stack[-6]
0x70e: Pop(3)
0x70f: Push("health") // @poff=556
0x710: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x711: Pop(1)
0x712: Push((int) 1)
0x713: Pop(1); Push(Stack[-1] - Stack[-4]);
0x714: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x715: Push("health") // @poff=556
...
0x71b: Pop(3)
0x71c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x71d: Pop(2)
0x71e: PushEmpty(bool, object)
0x71f: Stack[-17] = Stack[-1]
0x720: Call2 0x6cf
...
0x726: Pop(1)
0x727: Stack[-1] = Stack[-16]
0x728: Return(); Pop(12)

0x729: PushEmpty(bool, bool)
0x72a: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x72b: Pop(0)
0x72c: Stack[-1] = Stack[-4]
0x72d: Return(); Pop(2)

0x72e: PushEmpty(object, object, object, object)
0x72f: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x743: Pop(0)
0x744: Pop(0); PushNull((bool) Stack[-2] == 0)
0x745: IF (Stack[-1] == 0) GOTO 0x748; Pop(1)

0x746: Stack[-6] = (bool) 0
0x747: Return(); Pop(4)

0x748: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x749: Pop(0)
...
0x75c: Stack[-6] = Stack[-2]
0x75d: Stack[-1] = "noaccess" // @poff=650
0x75e: Call2 0x6d4
...
0x764: Push("noaccess") // @poff=650
0x765: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x766: Pop(1)
0x767: Push((int) 0)
...
0x76b: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x779: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x77a: Pop(0)
...
0x78a: Stack[-1] = "fhit" // @poff=668
0x78b: GOTO 0x78d

0x78c: Stack[-1] = "bhit" // @poff=678
0x78d: Push("hit_react") // @poff=688
0x78e: Push("1") // @poff=708
0x78f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x790: Push("2") // @poff=712
...
0x7ae: Stack[-2] = Stack[-11]
0x7af: Pop(2)
0x7b0: @ CreateVectorVector(Stack[-8])
0x7b1: Pop(0)
0x7b2: Stack[-7] = (int) 1
0x7b3: Push("hit") // @poff=670
...
0x7c8: Pop(0)
0x7c9: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x7ca: Pop(0)
0x7cb: PushEmpty(object, int, float, cvector, cvector)
0x7cc: Stack[-26] = Stack[-5]
0x7cd: Stack[-25] = Stack[-4]
0x7ce: Stack[-24] = Stack[-3]
0x7cf: Stack[-6] = Stack[-2]
...
0x7e9: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x7ea: Pop(0)
...
0x7f9: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x7fa: Pop(0)
0x7fb: Stack[-1] = [0.0, 0.0, 0.0]
0x7fc: Push(CvectorIndex(Stack[-1], 1))
0x7fd: Stack[-3] = Stack[-1]
0x7fe: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7ff: Push("head") // @poff=160
...
0x846: Stack[-2] = Stack[-4]
0x847: Return(); Pop(0)

0x848: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x849: IF (Stack[-1] == 0) GOTO 0x84c; Pop(1)

0x84a: Stack[-1] = Stack[-4]
0x84b: Return(); Pop(0)

0x84c: Stack[-3] = Stack[-4]
0x84d: Return(); Pop(0)

0x84e: PushEmpty(object, object)
0x84f: @ CreateFloatVector(Stack[-1])
0x850: Pop(0)
0x851: @@ add(Stack[-3]); Obj=1 // @poff=716
0x852: Pop(0)
0x853: Push((int) 15)
0x854: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x855: Pop(1)
0x856: Return(); Pop(2)

0x857: Stack[-1] = 0
0x858: PushEmpty(float, float)
0x859: @ GetGameTime(Stack[-1])
0x85a: Pop(0)
0x85b: Push((int) 1)
0x85c: PushEmpty(int)
0x85d: Push((int) 24)
0x85e: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x85f: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x860: Return(); Pop(2)

0x861: PushEmpty(bool, bool)
0x862: @ IsPlayerActor(Stack[-3], Stack[-1])
0x863: Pop(0)
0x864: Push(Stack[-1])
0x865: IF (Stack[-1] == 0) GOTO 0x869; Pop(1)

0x866: Push("attack") // @poff=234
0x867: @ PlayGlobalMusic(Stack[-1])
0x868: Pop(1)
0x869: Return(); Pop(2)

0x86a: PushEmpty(object, object)
0x86b: @ GetScene(Stack[-1])
0x86c: Pop(0)
0x86d: Push("battle") // @poff=775
0x86e: PushEmpty(object)
0x86f: Call2 0x82c

0x870: Pop(0)
0x871: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x872: Pop(2)
0x873: Return(); Pop(2)

0x874: Stack[-1] = 0
0x875: PushEmpty(int, bool, int, bool)
0x876: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x877: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x878: Push("GenerateMoney: iMin > iMax") // @poff=789
0x879: @ Trace(Stack[-1])
0x87a: Pop(1)
0x87b: Return(); Pop(4)
...
0x87f: Pop(0); Push(Stack[-5] - Stack[-6]);
0x880: @ irand(Stack[-3], Stack[-1])
0x881: Pop(1)
0x882: GOTO 0x887

0x883: Push((int) 0)
0x884: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x885: IF (Stack[-1] == 0) GOTO 0x887; Pop(1)

0x886: Return(); Pop(4)

0x887: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x888: Push((int) 0)
...
0x88c: PushEmpty(int, string)
0x88d: Stack[-1] = "Money" // @poff=843
0x88e: Call2 0x943

0x88f: Pop(1)
0x890: Push((int) 0)
0x891: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x892: Pop(2)
0x893: Return(); Pop(4)

0x894: PushEmpty(int, bool, int, bool)
0x895: Push(Stack[-5])
0x896: IF (Stack[-1] == 0) GOTO 0x8ed; Pop(1)
...
0x89c: Pop(0)
0x89d: Push((int) 100)
0x89e: Pop(2); Push(Stack[-2] * Stack[-1]);
0x89f: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x8a0: Call2 0x875

0x8a1: Pop(2)
0x8a2: Push((int) 8)
0x8a3: @ irand(Stack[-3], Stack[-1])
0x8a4: Pop(1)
0x8a5: Push((int) 0)
0x8a6: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8a7: IF (Stack[-1] == 0) GOTO 0x8b1; Pop(1)

0x8a8: PushEmpty(int, string)
0x8a9: Stack[-1] = "lemon" // @poff=855
0x8aa: Call2 0x943

0x8ab: Pop(1)
0x8ac: Push((int) 0)
0x8ad: Push((int) 1)
0x8ae: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8af: Pop(3)
0x8b0: GOTO 0x8ec

0x8b1: Push((int) 1)
0x8b2: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8b3: IF (Stack[-1] == 0) GOTO 0x8bd; Pop(1)

0x8b4: PushEmpty(int, string)
0x8b5: Stack[-1] = "rusk" // @poff=867
0x8b6: Call2 0x943

0x8b7: Pop(1)
0x8b8: Push((int) 0)
0x8b9: Push((int) 1)
0x8ba: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8bb: Pop(3)
0x8bc: GOTO 0x8ec

0x8bd: Push((int) 2)
0x8be: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8bf: IF (Stack[-1] == 0) GOTO 0x8c9; Pop(1)

0x8c0: PushEmpty(int, string)
0x8c1: Stack[-1] = "hook" // @poff=877
0x8c2: Call2 0x943

0x8c3: Pop(1)
0x8c4: Push((int) 0)
0x8c5: Push((int) 1)
0x8c6: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8c7: Pop(3)
0x8c8: GOTO 0x8ec

0x8c9: Push((int) 4)
0x8ca: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8cb: IF (Stack[-1] == 0) GOTO 0x8d5; Pop(1)

0x8cc: PushEmpty(int, string)
0x8cd: Stack[-1] = "syringe" // @poff=887
0x8ce: Call2 0x943
...
0x8d8: PushEmpty(int, string)
0x8d9: Stack[-1] = "watch" // @poff=903
0x8da: Call2 0x943

0x8db: Pop(1)
0x8dc: Push((int) 0)
0x8dd: Push((int) 1)
0x8de: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8df: Pop(3)
0x8e0: GOTO 0x8ec

0x8e1: Push((int) 6)
0x8e2: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8e3: IF (Stack[-1] == 0) GOTO 0x8ec; Pop(1)

0x8e4: PushEmpty(int, string)
0x8e5: Stack[-1] = "razor" // @poff=915
0x8e6: Call2 0x943

0x8e7: Pop(1)
0x8e8: Push((int) 0)
0x8e9: Push((int) 1)
0x8ea: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8eb: Pop(3)
0x8ec: GOTO 0x942

0x8ed: PushEmpty(int, int)
0x8ee: Stack[-2] = (int) 0
0x8ef: Push((int) 50)
0x8f0: PushEmpty(int)
0x8f1: Call2 0x858
...
0x8f2: Pop(0)
0x8f3: Push((int) 50)
0x8f4: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8f5: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x8f6: Call2 0x875
...
0x90b: Stack[-1] = "bracelet" // @poff=939
0x90c: Call2 0x943
...
0x915: IF (Stack[-1] == 0) GOTO 0x91f; Pop(1)

0x916: PushEmpty(int, string)
0x917: Stack[-1] = "ear_ring" // @poff=957
0x918: Call2 0x943
...
0x921: IF (Stack[-1] == 0) GOTO 0x92b; Pop(1)

0x922: PushEmpty(int, string)
0x923: Stack[-1] = "gold_ring" // @poff=975
0x924: Call2 0x943

0x925: Pop(1)
0x926: Push((int) 0)
0x927: Push((int) 1)
0x928: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x929: Pop(3)
0x92a: GOTO 0x942

0x92b: Push((int) 4)
0x92c: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x92d: IF (Stack[-1] == 0) GOTO 0x937; Pop(1)

0x92e: PushEmpty(int, string)
0x92f: Stack[-1] = "silver_ring" // @poff=995
0x930: Call2 0x943

0x931: Pop(1)
0x932: Push((int) 0)
0x933: Push((int) 1)
0x934: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x935: Pop(3)
0x936: GOTO 0x942
...
0x93a: PushEmpty(int, string)
0x93b: Stack[-1] = "flower" // @poff=1019
0x93c: Call2 0x943

0x93d: Pop(1)
0x93e: Push((int) 0)
0x93f: Push((int) 1)
0x940: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x941: Pop(3)
0x942: Return(); Pop(4)
...
0x945: Pop(0)
0x946: Stack[-1] = Stack[-4]
0x947: Return(); Pop(2)

0x948: PushEmpty()
0x949: PushEmpty(object)
0x94a: Stack[-2] = Stack[-1]
0x94b: Push(-1, 0); TaskCall(0)
0x94c: Call2 0x0
...
0x950: PushEmpty(float, float)
0x951: Push("health") // @poff=556
0x952: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x953: IF (Stack[-1] == 0) GOTO 0x95c; Pop(1)

0x954: Push("health") // @poff=556
0x955: @ GetProperty(Stack[-1], Stack[-2])
0x956: Pop(1)
0x957: Push((int) 0)
0x958: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x959: IF (Stack[-1] == 0) GOTO 0x95c; Pop(1)

0x95a: @ SignalDeath(Stack[-4])
0x95b: Pop(0)
0x95c: Return(); Pop(2)

0x95d: PushEmpty()
0x95e: PushEmpty(object)
...
0x963: PushEmpty()
0x964: PushEmpty(object, int, float)
0x965: Stack[-7] = Stack[-3]
0x966: Stack[-6] = Stack[-2]
0x967: Stack[-5] = Stack[-1]
0x968: Call2 0x796
...
0x96b: PushEmpty()
0x96c: PushEmpty(object, int, float, cvector, cvector)
0x96d: Stack[-11] = Stack[-5]
0x96e: Stack[-10] = Stack[-4]
0x96f: Stack[-9] = Stack[-3]
0x970: Stack[-7] = Stack[-2]
0x971: Stack[-6] = Stack[-1]
0x972: Call2 0x7da
...
0x975: PushEmpty()
0x976: Push("unholster") // @poff=1033
0x977: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x978: IF (Stack[-1] == 0) GOTO 0x980; Pop(1)

0x979: PushEmpty(bool, object)
0x97a: Stack[-4] = Stack[-1]
0x97b: Call2 0xab4

0x97c: Stack[-2] = Stack[-5]
0x97d: Pop(2)
0x97e: Return(); Pop(0)

0x97f: GOTO 0x993

0x980: Push("player_shot") // @poff=1053
0x981: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x982: IF (Stack[-1] == 0) GOTO 0x98a; Pop(1)

0x983: PushEmpty(bool, object)
0x984: Stack[-4] = Stack[-1]
0x985: Call2 0xab9

0x986: Stack[-2] = Stack[-5]
0x987: Pop(2)
0x988: Return(); Pop(0)

0x989: GOTO 0x993

0x98a: Push("battle") // @poff=775
0x98b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x993: Stack[-3] = (bool) 0
0x994: Return(); Pop(0)

0x995: PushEmpty()
0x996: Push("unholster") // @poff=1033
0x997: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x9bd: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1077
0x9be: Pop(0)
0x9bf: Pop(0); Push((bool) Stack[-1] == 0)
0x9c0: IF (Stack[-1] == 0) GOTO 0x9c3; Pop(1)

0x9c1: Stack[-4] = (bool) 1
0x9c2: Return(); Pop(2)

0x9c3: Stack[-4] = (bool) 0
0x9c4: Return(); Pop(2)

0x9c5: PushEmpty()
0x9c6: PushEmpty(object)
0x9c7: Stack[-2] = Stack[-1]
0x9c8: Call2 0xab7
...
0x9d3: Pop(0)
0x9d4: Push((float)-0.05000000074505806)
0x9d5: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0x9d6: Pop(2)
0x9d7: Return(); Pop(0)

0x9d8: PushEmpty(object, object)
0x9d9: Push("heal") // @poff=1095
0x9da: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9db: IF (Stack[-1] == 0) GOTO 0x9e6; Pop(1)

0x9dc: Push("player") // @poff=1105
0x9dd: @ FindActor(Stack[-2], Stack[-1])
0x9de: Pop(1)
0x9df: PushEmpty(bool, object)
0x9e0: Stack[-3] = Stack[-1]
0x9e1: Call2 0xac3

0x9e2: Stack[-2] = Stack[-6]
0x9e3: Pop(2)
0x9e4: Return(); Pop(2)
...
0x9e8: PushEmpty(object, object)
0x9e9: Push("heal") // @poff=1095
0x9ea: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9eb: IF (Stack[-1] == 0) GOTO 0x9f4; Pop(1)

0x9ec: Push("player") // @poff=1105
0x9ed: @ FindActor(Stack[-2], Stack[-1])
0x9ee: Pop(1)
0x9ef: PushEmpty(object)
0x9f0: Stack[-2] = Stack[-1]
0x9f1: Call2 0xac6
...
0x9f5: PushEmpty(string, string)
0x9f6: Stack[-1] = "idle" // @poff=1119
0x9f7: Push(Stack[-3])
0x9f8: IF (Stack[-1] == 0) GOTO 0x9fa; Pop(1)

0x9f9: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x9fa: Stack[-1] = Stack[-4]
0x9fb: Return(); Pop(2)

0x9fc: PushEmpty(int, bool, int, bool)
0x9fd: Stack[-2] = (int) 0
0x9fe: Push("all") // @poff=170
0x9ff: PushEmpty(string, int)
0xa00: Stack[-5] = Stack[-1]
0xa01: Call2 0x9f5

0xa02: Pop(1)
0xa03: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xa04: Pop(2)
...
0xa08: Push((int) 1)
0xa09: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xa0a: GOTO 0x9fe
...
0xa29: Stack[-2] = Stack[-1]
0xa2a: Push(-1, 6); TaskCall(3)
0xa2b: Call2 0x307

0xa2c: Pop(-1, 6); TaskReturn
0xa2d: Pop(1)
0xa2e: Return(); Pop(0)

0xa2f: PushEmpty(string, string, string, string)
0xa30: PushEmpty(bool, object, string)
0xa31: Stack[-9] = Stack[-2]
0xa32: Stack[-1] = "class" // @poff=1129
0xa33: Call2 0x6d4
...
0xa37: Stack[-7] = (bool) 0
0xa38: Return(); Pop(4)

0xa39: Push("class") // @poff=1129
0xa3a: @ GetProperty(Stack[-1], Stack[-3])
0xa3b: Pop(1)
0xa3c: Push("class") // @poff=1129
0xa3d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xa3e: Pop(1)
0xa3f: PushEmpty(bool)
0xa40: Stack[-1] = (bool) 0
0xa41: Pop(0); Push((bool) Stack[-6] == 0)
0xa42: IF (Stack[-1] == 0) GOTO 0xa46; Pop(1)

0xa43: Pop(0); Push((bool) Stack[-3] == Stack[-2])
0xa44: IF (Stack[-1] == 0) GOTO 0xa46; Pop(1)

0xa45: Stack[-1] = (bool) 1
0xa46: IF (Stack[-1] == 0) GOTO 0xa49; Pop(1)

0xa47: Stack[-7] = (bool) 1
0xa48: Return(); Pop(4)

0xa49: Push("rat") // @poff=1141
0xa4a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa4b: IF (Stack[-1] == 0) GOTO 0xa4f; Pop(1)

0xa4c: Stack[-7] = (bool) 0
0xa4d: Return(); Pop(4)

0xa4e: GOTO 0xa78

0xa4f: Push("rat_big") // @poff=1149
...
0xa55: Push("dog") // @poff=1165
0xa56: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa57: IF (Stack[-1] == 0) GOTO 0xa5b; Pop(1)

0xa58: Stack[-7] = (bool) 0
0xa59: Return(); Pop(4)

0xa5a: GOTO 0xa78

0xa5b: Push("grabitel") // @poff=1173
0xa5c: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa5d: IF (Stack[-1] == 0) GOTO 0xa61; Pop(1)

0xa5e: Stack[-7] = (bool) 0
0xa5f: Return(); Pop(4)

0xa60: GOTO 0xa78

0xa61: Push("bomber") // @poff=1191
...
0xa83: Stack[-2] = Stack[-1]
0xa84: Call2 0xa27

0xa85: Pop(1)
0xa86: Return(); Pop(0)

0xa87: PushEmpty(bool, bool)
0xa88: PushEmpty(bool, object, bool)
0xa89: Stack[-8] = Stack[-2]
0xa8a: Stack[-1] = !Stack[-6]; Pop(0);
0xa8b: Call2 0xa2f
...
0xa8f: Stack[-7] = (bool) 0
0xa90: Return(); Pop(2)

0xa91: @ CanSee(Stack[-1], Stack[-6])
0xa92: Pop(0)
0xa93: PushEmpty(bool)
0xa94: Stack[-1] = (bool) 1
0xa95: Push(Stack[-2])
0xa96: IF (Stack[-1] == 1) GOTO 0xa9f; Pop(1)

0xa97: PushEmpty(float, object)
0xa98: Stack[-9] = Stack[-1]
0xa99: Call2 0x6c7

0xa9a: Pop(1)
0xa9b: Pop(0); Push(Stack[-6] * Stack[-6]);
0xa9c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xa9d: IF (Stack[-1] == 1) GOTO 0xa9f; Pop(1)

0xa9e: Stack[-1] = (bool) 0
0xa9f: IF (Stack[-1] == 0) GOTO 0xaa2; Pop(1)

0xaa0: Stack[-7] = (bool) 1
0xaa1: Return(); Pop(2)

0xaa2: Stack[-7] = (bool) 0
0xaa3: Return(); Pop(2)
...
0xac3: PushEmpty()
0xac4: Stack[-2] = (bool) 0
0xac5: Return(); Pop(0)

0xac6: PushEmpty()
0xac7: Return(); Pop(0)

0xac8: Push(GlobalVars[0])
0xac9: Stack[-1] = (bool) 0
0xaca: GlobalVars[0] = Stack[-1]; Pop(1)
...
0xad1: @ IsPlayerActor(Stack[-3], Stack[-1])
0xad2: Pop(0)
0xad3: Stack[-1] = Stack[-4]
0xad4: Return(); Pop(2)

0xad5: PushEmpty()
0xad6: PushEmpty(bool, object, object, float, bool)
0xad7: Stack[-8] = Stack[-4]
0xad8: Stack[-7] = Stack[-3]
0xad9: Stack[-2] = (float) 700.0
0xada: Stack[-6] = Stack[-1]
0xadb: Call2 0xa87

0xadc: Stack[-5] = Stack[-9]
0xadd: Pop(5)
0xade: Return(); Pop(0)

0xadf: PushEmpty()
0xae0: PushEmpty(bool, object)
0xae1: Stack[-3] = Stack[-1]
0xae2: Call2 0x6cf

0xae3: Pop(1)
0xae4: IF (Stack[-1] == 0) GOTO 0xaec; Pop(1)

0xae5: PushEmpty(object)
0xae6: Call2 0x82c

0xae7: Pop(0)
0xae8: Push((float)-0.05000000074505806)
0xae9: Push((bool) 1)
0xaea: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xaeb: Pop(3)
0xaec: Push(GlobalVars[0])
0xaed: Stack[-1] = (bool) 1
0xaee: GlobalVars[0] = Stack[-1]; Pop(1)
0xaef: Push((int) 50)
0xaf0: Push((int) 40)
0xaf1: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xaf2: Pop(2)
0xaf3: Return(); Pop(0)
