...
Strings:
	...
	W:hunter
	W:soldier
// @pool_raw:
...
0xc32: @ CanSee(Stack[-1], Stack[-3])
0xc33: Pop(0)
0xc34: Stack[-4] = (bool) 1
0xc35: Push(Stack[-1])
0xc36: IF (Stack[-1] == 1) GOTO 0xc3f; Pop(1)

0xc37: PushEmpty(float, object)
0xc38: Stack[-5] = Stack[-1]
0xc39: Call2 0x7da

0xc3a: Pop(1)
0xc3b: Push((int) 2250000)
0xc3c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc3d: IF (Stack[-1] == 1) GOTO 0xc3f; Pop(1)

0xc3e: Stack[-4] = (bool) 0
0xc3f: Return(); Pop(2)

0xc40: PushEmpty()
0xc41: PushEmpty(object)
...
0xc52: GlobalVars[0] = Stack[-1]; Pop(1)
0xc53: Return(); Pop(0)

0xc54: PushEmpty(bool, bool)
0xc55: Push(GlobalVars[0])
0xc56: IF (Stack[-1] == 0) GOTO 0xc60; Pop(1)

0xc57: @ IsOverrideActive(Stack[-1])
0xc58: Pop(0)
...
0xc63: PushEmpty()
0xc64: PushEmpty(bool, object, object, float, bool)
0xc65: Stack[-8] = Stack[-4]
0xc66: Stack[-7] = Stack[-3]
0xc67: Stack[-2] = (float) 700.0
0xc68: Stack[-6] = Stack[-1]
0xc69: Call2 0xbfb

0xc6a: Stack[-5] = Stack[-9]
0xc6b: Pop(5)
0xc6c: Return(); Pop(0)

0xc6d: PushEmpty()
0xc6e: PushEmpty(bool, object)
0xc6f: Stack[-3] = Stack[-1]
0xc70: Call2 0x7e2

0xc71: Pop(1)
0xc72: IF (Stack[-1] == 0) GOTO 0xc7e; Pop(1)

0xc73: PushEmpty(object)
0xc74: Call2 0x93f

0xc75: Pop(0)
0xc76: Push((float)-0.07000000029802322)
0xc77: Push((bool) 1)
0xc78: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc79: Pop(3)
...
0xc80: Pop(0)
0xc81: Push(GlobalVars[0])
0xc82: Stack[-1] = (bool) 1
0xc83: GlobalVars[0] = Stack[-1]; Pop(1)
0xc84: Push((int) 50)
0xc85: Push((int) 40)
0xc86: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xc87: Pop(2)
0xc88: Return(); Pop(0)
