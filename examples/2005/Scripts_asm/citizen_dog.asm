...
Strings:
	...
	W:hunter
	W:soldier
// @pool_raw:
...
Events:
EVENT_16 Op = 0xa7a Vars = (object, string)
EVENT_41 Op = 0xa87 Vars = (object)
EVENT_22 Op = 0xa8d Vars = (object, int, float, float)
EVENT_43 Op = 0xa95 Vars = (object, int, float, float, cvector, cvector)
...
0x422: PushEmpty()
0x423: Stack[-3] = (float) 0.20000000298023224
0x424: Return(); Pop(0)
...
0x7ce: Pop(0)
0x7cf: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x7d0: Pop(0)
...
0x7ed: Stack[-1] = (float) 1.7453293800354004
0x7ee: Call2 0x7cc

0x7ef: Stack[-2] = Stack[-7]
0x7f0: Pop(2)
...
0x7f6: Stack[-1] = (float) 2.6179938316345215
0x7f7: Call2 0x7cc
...
0x7fe: Push("Can't retreat, distance: ") // @poff=486
...
0x814: Push((int) 1)
0x815: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x816: Pop(1)
0x817: Push(Stack[-3])
0x818: IF (Stack[-1] == 0) GOTO 0x830; Pop(1)

0x819: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x81e: Stack[-1] = (float) 2.6179938316345215
0x81f: Call2 0x7cc
...
0x831: IF (Stack[-1] == 1) GOTO 0x814; Pop(1)
...
0x838: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x847: Stack[-1] = (float) 1.7453293800354004
0x848: Call2 0x7cc

0x849: Stack[-2] = Stack[-4]
0x84a: Pop(2)
...
0x857: IF (Stack[-1] == 1) GOTO 0x85d; Pop(1)

0x858: PushEmpty(bool)
0x859: Call2 0x877

0x85a: Pop(0)
0x85b: IF (Stack[-1] == 1) GOTO 0x85d; Pop(1)
...
0x880: Stack[-5] = Stack[-2]
0x881: Stack[-4] = Stack[-1]
0x882: Call2 0xa28

0x883: Pop(2)
0x884: Push((float)-0.3420201241970062)
...
0x891: Stack[-2] = "bullet" // @poff=548
0x892: Return(); Pop(0)

0x893: Stack[-2] = "phys" // @poff=562
0x894: Return(); Pop(0)
...
0x89c: Pop(0)
0x89d: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x89e: Pop(0)
...
0x8a3: Pop(0)
0x8a4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x8a5: Pop(0)
...
0x8ab: Pop(0)
0x8ac: Stack[-1] = Stack[-4]
0x8ad: Return(); Pop(2)

0x8ae: PushEmpty(bool, bool)
0x8af: Push("HasProperty") // @poff=572
0x8b0: Push((int) 2)
...
0x8b6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=596
0x8b7: Pop(0)
...
0x8bc: Stack[-18] = Stack[-2]
0x8bd: Stack[-1] = "health" // @poff=608
0x8be: Call2 0x8ae
...
0x8c5: Stack[-18] = Stack[-2]
0x8c6: Stack[-1] = "armor" // @poff=622
0x8c7: Call2 0x8ae
...
0x8cd: Push("armor") // @poff=622
0x8ce: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=634
0x8cf: Pop(1)
0x8d0: Push("armor_") // @poff=646
0x8d1: PushEmpty(string, int)
0x8d2: Stack[-16] = Stack[-1]
0x8d3: Call2 0x887

0x8d4: Pop(1)
0x8d5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x8d6: PushEmpty(bool, object, string)
0x8d7: Stack[-18] = Stack[-2]
0x8d8: Stack[-8] = Stack[-1]
0x8d9: Call2 0x8ae
...
0x8df: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=634
0x8e0: Pop(0)
...
0x8e7: Stack[-3] = Stack[-6]
0x8e8: Pop(3)
0x8e9: Push("health") // @poff=608
0x8ea: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=634
0x8eb: Pop(1)
0x8ec: Push((int) 1)
0x8ed: Pop(1); Push(Stack[-1] - Stack[-4]);
0x8ee: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x8ef: Push("health") // @poff=608
...
0x8f5: Pop(3)
0x8f6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=660
0x8f7: Pop(2)
0x8f8: PushEmpty(bool, object)
0x8f9: Stack[-17] = Stack[-1]
0x8fa: Call2 0x8a9
...
0x900: Pop(1)
0x901: Stack[-1] = Stack[-16]
0x902: Return(); Pop(12)

0x903: PushEmpty(bool, bool)
0x904: @@ IsDead(Stack[-1]); Obj=3 // @poff=672
0x905: Pop(0)
0x906: Stack[-1] = Stack[-4]
0x907: Return(); Pop(2)

0x908: PushEmpty(object, object, object, object)
0x909: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x91d: Pop(0)
0x91e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x91f: IF (Stack[-1] == 0) GOTO 0x922; Pop(1)

0x920: Stack[-6] = (bool) 0
0x921: Return(); Pop(4)

0x922: @@ GetScene(Stack[-1]); Obj=5 // @poff=693
0x923: Pop(0)
...
0x936: Stack[-6] = Stack[-2]
0x937: Stack[-1] = "noaccess" // @poff=702
0x938: Call2 0x8ae
...
0x93e: Push("noaccess") // @poff=702
0x93f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=634
0x940: Pop(1)
0x941: Push((int) 0)
...
0x945: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x953: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x954: Pop(0)
...
0x964: Stack[-1] = "fhit" // @poff=720
0x965: GOTO 0x967

0x966: Stack[-1] = "bhit" // @poff=730
0x967: Push("hit_react") // @poff=740
0x968: Push("1") // @poff=760
0x969: Pop(1); Push(Stack[-3] + Stack[-1]);
0x96a: Push("2") // @poff=764
...
0x983: Stack[-25] = Stack[-1]
0x984: Call2 0x89a

0x985: Stack[-2] = Stack[-3]
0x986: Pop(2)
0x987: Call2 0xa0c

0x988: Stack[-2] = Stack[-11]
0x989: Pop(2)
0x98a: @ CreateVectorVector(Stack[-8])
0x98b: Pop(0)
0x98c: Stack[-7] = (int) 1
0x98d: Push("hit") // @poff=722
...
0x9a2: Pop(0)
0x9a3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=777
0x9a4: Pop(0)
0x9a5: PushEmpty(object, int, float, cvector, cvector)
0x9a6: Stack[-26] = Stack[-5]
0x9a7: Stack[-25] = Stack[-4]
0x9a8: Stack[-24] = Stack[-3]
0x9a9: Stack[-6] = Stack[-2]
...
0x9c3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x9c4: Pop(0)
...
0x9d3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x9d4: Pop(0)
0x9d5: Stack[-1] = [0.0, 0.0, 0.0]
0x9d6: Push(CvectorIndex(Stack[-1], 1))
0x9d7: Stack[-3] = Stack[-1]
0x9d8: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x9d9: Push("head") // @poff=160
...
0xa24: Stack[-1] = Stack[-4]
0xa25: Return(); Pop(0)

0xa26: Stack[-3] = Stack[-4]
0xa27: Return(); Pop(0)
...
0xa56: Pop(0)
0xa57: @@ add(Stack[-3]); Obj=1 // @poff=768
0xa58: Pop(0)
0xa59: Push((int) 15)
0xa5a: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa5b: Pop(1)
0xa5c: Return(); Pop(2)

0xa5d: Stack[-1] = 0
0xa5e: PushEmpty(bool, bool)
0xa5f: @ IsPlayerActor(Stack[-3], Stack[-1])
0xa60: Pop(0)
0xa61: Push(Stack[-1])
0xa62: IF (Stack[-1] == 0) GOTO 0xa66; Pop(1)

0xa63: Push("attack") // @poff=234
0xa64: @ PlayGlobalMusic(Stack[-1])
0xa65: Pop(1)
0xa66: Return(); Pop(2)

0xa67: PushEmpty(object, object)
0xa68: @ GetScene(Stack[-1])
0xa69: Pop(0)
0xa6a: Push("battle") // @poff=827
0xa6b: PushEmpty(object)
0xa6c: Call2 0xa06

0xa6d: Pop(0)
0xa6e: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xa6f: Pop(2)
0xa70: Return(); Pop(2)
...
0xa7a: PushEmpty(float, float)
0xa7b: Push("health") // @poff=608
0xa7c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa7d: IF (Stack[-1] == 0) GOTO 0xa86; Pop(1)

0xa7e: Push("health") // @poff=608
0xa7f: @ GetProperty(Stack[-1], Stack[-2])
0xa80: Pop(1)
0xa81: Push((int) 0)
0xa82: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa83: IF (Stack[-1] == 0) GOTO 0xa86; Pop(1)

0xa84: @ SignalDeath(Stack[-4])
0xa85: Pop(0)
0xa86: Return(); Pop(2)

0xa87: PushEmpty()
0xa88: PushEmpty(object)
0xa89: Stack[-2] = Stack[-1]
0xa8a: Call2 0xa72
...
0xa8d: PushEmpty()
0xa8e: PushEmpty(object, int, float)
0xa8f: Stack[-7] = Stack[-3]
0xa90: Stack[-6] = Stack[-2]
0xa91: Stack[-5] = Stack[-1]
0xa92: Call2 0x970
...
0xa95: PushEmpty()
0xa96: PushEmpty(object, int, float, cvector, cvector)
0xa97: Stack[-11] = Stack[-5]
0xa98: Stack[-10] = Stack[-4]
0xa99: Stack[-9] = Stack[-3]
...
0xa9f: PushEmpty()
0xaa0: Push("unholster") // @poff=841
0xaa1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xaa2: IF (Stack[-1] == 0) GOTO 0xaaa; Pop(1)

0xaa3: PushEmpty(bool, object)
0xaa4: Stack[-4] = Stack[-1]
0xaa5: Call2 0xbe3

0xaa6: Stack[-2] = Stack[-5]
0xaa7: Pop(2)
0xaa8: Return(); Pop(0)

0xaa9: GOTO 0xabd

0xaaa: Push("player_shot") // @poff=861
0xaab: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xaac: IF (Stack[-1] == 0) GOTO 0xab4; Pop(1)

0xaad: PushEmpty(bool, object)
0xaae: Stack[-4] = Stack[-1]
0xaaf: Call2 0xbe8

0xab0: Stack[-2] = Stack[-5]
0xab1: Pop(2)
0xab2: Return(); Pop(0)

0xab3: GOTO 0xabd

0xab4: Push("battle") // @poff=827
...
0xaba: Stack[-2] = Stack[-5]
0xabb: Pop(2)
0xabc: Return(); Pop(0)

0xabd: Stack[-3] = (bool) 0
0xabe: Return(); Pop(0)

0xabf: PushEmpty()
0xac0: Push("unholster") // @poff=841
0xac1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xac2: IF (Stack[-1] == 0) GOTO 0xac8; Pop(1)

0xac3: PushEmpty(object)
0xac4: Stack[-3] = Stack[-1]
0xac5: Call2 0xbe6

0xac6: Pop(1)
0xac7: GOTO 0xad7

0xac8: Push("player_shot") // @poff=861
0xac9: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xaca: IF (Stack[-1] == 0) GOTO 0xad0; Pop(1)

0xacb: PushEmpty(object)
0xacc: Stack[-3] = Stack[-1]
0xacd: Call2 0xbf7

0xace: Pop(1)
0xacf: GOTO 0xad7

0xad0: Push("battle") // @poff=827
0xad1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xad2: IF (Stack[-1] == 0) GOTO 0xad7; Pop(1)
...
0xad8: PushEmpty(bool, bool)
0xad9: PushEmpty(bool)
0xada: Stack[-1] = (bool) 0
0xadb: PushEmpty(bool, object)
0xadc: Stack[-6] = Stack[-1]
0xadd: Call2 0xbe3

0xade: Pop(1)
0xadf: IF (Stack[-1] == 0) GOTO 0xae6; Pop(1)

0xae0: PushEmpty(bool, object)
0xae1: Stack[-6] = Stack[-1]
0xae2: Call2 0x8a9
...
0xae7: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=885
0xae8: Pop(0)
0xae9: Pop(0); Push((bool) Stack[-1] == 0)
0xaea: IF (Stack[-1] == 0) GOTO 0xaed; Pop(1)

0xaeb: Stack[-4] = (bool) 1
0xaec: Return(); Pop(2)

0xaed: Stack[-4] = (bool) 0
0xaee: Return(); Pop(2)

0xaef: PushEmpty()
0xaf0: PushEmpty(object)
0xaf1: Stack[-2] = Stack[-1]
0xaf2: Call2 0xbe6
...
0xafd: Pop(0)
0xafe: Push((float)0.0)
0xaff: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0xb00: Pop(2)
0xb01: Return(); Pop(0)

0xb02: PushEmpty(object, object)
0xb03: Push("heal") // @poff=903
0xb04: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb05: IF (Stack[-1] == 0) GOTO 0xb10; Pop(1)

0xb06: Push("player") // @poff=913
0xb07: @ FindActor(Stack[-2], Stack[-1])
0xb08: Pop(1)
0xb09: PushEmpty(bool, object)
0xb0a: Stack[-3] = Stack[-1]
0xb0b: Call2 0xc04

0xb0c: Stack[-2] = Stack[-6]
0xb0d: Pop(2)
0xb0e: Return(); Pop(2)

0xb0f: Stack[-1] = 0
0xb10: Stack[-4] = (bool) 0
0xb11: Return(); Pop(2)

0xb12: PushEmpty(object, object)
0xb13: Push("heal") // @poff=903
0xb14: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb15: IF (Stack[-1] == 0) GOTO 0xb1e; Pop(1)

0xb16: Push("player") // @poff=913
0xb17: @ FindActor(Stack[-2], Stack[-1])
0xb18: Pop(1)
...
0xb1f: PushEmpty(string, string)
0xb20: Stack[-1] = "idle" // @poff=927
0xb21: Push(Stack[-3])
0xb22: IF (Stack[-1] == 0) GOTO 0xb24; Pop(1)

0xb23: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xb24: Stack[-1] = Stack[-4]
0xb25: Return(); Pop(2)

0xb26: PushEmpty(int, bool, int, bool)
0xb27: Stack[-2] = (int) 0
0xb28: Push("all") // @poff=170
0xb29: PushEmpty(string, int)
0xb2a: Stack[-5] = Stack[-1]
0xb2b: Call2 0xb1f

0xb2c: Pop(1)
0xb2d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xb2e: Pop(2)
0xb2f: Pop(0); Push((bool) Stack[-1] == 0)
0xb30: IF (Stack[-1] == 0) GOTO 0xb32; Pop(1)

0xb31: GOTO 0xb35

0xb32: Push((int) 1)
0xb33: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xb34: GOTO 0xb28

0xb35: Stack[-2] = Stack[-5]
0xb36: Return(); Pop(4)
...
0xb3a: Pop(0)
0xb3b: IF (Stack[-1] == 0) GOTO 0xb3e; Pop(1)
...
0xb42: Stack[-2] = Stack[-1]
0xb43: Push(-1, 1); TaskCall(3)
0xb44: Call2 0x307

0xb45: Pop(-1, 1); TaskReturn
0xb46: Pop(1)
0xb47: Return(); Pop(0)
...
0xb52: PushEmpty()
0xb53: PushEmpty(object)
0xb54: Stack[-2] = Stack[-1]
0xb55: Push(-1, 6); TaskCall(4)
0xb56: Call2 0x41a

0xb57: Pop(-1, 6); TaskReturn
0xb58: Pop(1)
0xb59: Return(); Pop(0)

0xb5a: PushEmpty(string, string, string, string)
0xb5b: PushEmpty(bool, object, string)
0xb5c: Stack[-9] = Stack[-2]
0xb5d: Stack[-1] = "class" // @poff=937
0xb5e: Call2 0x8ae
...
0xb62: Stack[-7] = (bool) 0
0xb63: Return(); Pop(4)

0xb64: Push("class") // @poff=937
0xb65: @ GetProperty(Stack[-1], Stack[-3])
0xb66: Pop(1)
0xb67: Push("class") // @poff=937
0xb68: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=634
0xb69: Pop(1)
0xb6a: PushEmpty(bool)
0xb6b: Stack[-1] = (bool) 0
0xb6c: Pop(0); Push((bool) Stack[-6] == 0)
0xb6d: IF (Stack[-1] == 0) GOTO 0xb71; Pop(1)

0xb6e: Pop(0); Push((bool) Stack[-3] == Stack[-2])
0xb6f: IF (Stack[-1] == 0) GOTO 0xb71; Pop(1)

0xb70: Stack[-1] = (bool) 1
0xb71: IF (Stack[-1] == 0) GOTO 0xb74; Pop(1)

0xb72: Stack[-7] = (bool) 1
0xb73: Return(); Pop(4)

0xb74: Push("rat") // @poff=949
0xb75: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb76: IF (Stack[-1] == 0) GOTO 0xb7a; Pop(1)

0xb77: Stack[-7] = (bool) 0
0xb78: Return(); Pop(4)

0xb79: GOTO 0xba3

0xb7a: Push("rat_big") // @poff=957
0xb7b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb7c: IF (Stack[-1] == 0) GOTO 0xb80; Pop(1)

0xb7d: Stack[-7] = (bool) 0
0xb7e: Return(); Pop(4)

0xb7f: GOTO 0xba3

0xb80: Push("dog") // @poff=973
0xb81: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb82: IF (Stack[-1] == 0) GOTO 0xb86; Pop(1)

0xb83: Stack[-7] = (bool) 0
0xb84: Return(); Pop(4)

0xb85: GOTO 0xba3

0xb86: Push("grabitel") // @poff=981
0xb87: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb88: IF (Stack[-1] == 0) GOTO 0xb8c; Pop(1)

0xb89: Stack[-7] = (bool) 0
0xb8a: Return(); Pop(4)

0xb8b: GOTO 0xba3

0xb8c: Push("bomber") // @poff=999
0xb8d: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb8e: IF (Stack[-1] == 0) GOTO 0xb92; Pop(1)

0xb8f: Stack[-7] = (bool) 0
0xb90: Return(); Pop(4)

0xb91: GOTO 0xba3

0xb92: Push("sanitar") // @poff=1013
0xb93: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb94: IF (Stack[-1] == 0) GOTO 0xb98; Pop(1)

0xb95: Stack[-7] = (bool) 0
0xb96: Return(); Pop(4)

0xb97: GOTO 0xba3

0xb98: Push("hunter") // @poff=1029
0xb99: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb9a: IF (Stack[-1] == 0) GOTO 0xb9e; Pop(1)
...
0xb9e: Push("soldier") // @poff=1043
0xb9f: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xba0: IF (Stack[-1] == 0) GOTO 0xba3; Pop(1)

0xba1: Stack[-7] = (bool) 0
0xba2: Return(); Pop(4)

0xba3: Stack[-7] = (bool) 1
0xba4: Return(); Pop(4)

0xba5: PushEmpty()
0xba6: PushEmpty(int, object)
0xba7: Stack[-4] = Stack[-1]
0xba8: Call2 0xb48

0xba9: Stack[-2] = Stack[-5]
0xbaa: Pop(2)
0xbab: Return(); Pop(0)

0xbac: PushEmpty()
0xbad: PushEmpty(object)
0xbae: Stack[-2] = Stack[-1]
0xbaf: Call2 0xb52

0xbb0: Pop(1)
0xbb1: Return(); Pop(0)

0xbb2: PushEmpty(bool, bool)
0xbb3: PushEmpty(bool, object, bool)
0xbb4: Stack[-8] = Stack[-2]
0xbb5: Stack[-1] = !Stack[-6]; Pop(0);
0xbb6: Call2 0xb5a

0xbb7: Pop(2)
0xbb8: Pop(1); Push((bool) Stack[-1] == 0)
0xbb9: IF (Stack[-1] == 0) GOTO 0xbbc; Pop(1)

0xbba: Stack[-7] = (bool) 0
0xbbb: Return(); Pop(2)

0xbbc: @ CanSee(Stack[-1], Stack[-6])
0xbbd: Pop(0)
0xbbe: PushEmpty(bool)
0xbbf: Stack[-1] = (bool) 1
0xbc0: Push(Stack[-2])
0xbc1: IF (Stack[-1] == 1) GOTO 0xbca; Pop(1)

0xbc2: PushEmpty(float, object)
0xbc3: Stack[-9] = Stack[-1]
0xbc4: Call2 0x8a1

0xbc5: Pop(1)
0xbc6: Pop(0); Push(Stack[-6] * Stack[-6]);
0xbc7: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xbc8: IF (Stack[-1] == 1) GOTO 0xbca; Pop(1)

0xbc9: Stack[-1] = (bool) 0
0xbca: IF (Stack[-1] == 0) GOTO 0xbcd; Pop(1)

0xbcb: Stack[-7] = (bool) 1
0xbcc: Return(); Pop(2)
...
0xbe9: @ CanSee(Stack[-1], Stack[-3])
0xbea: Pop(0)
0xbeb: Stack[-4] = (bool) 1
0xbec: Push(Stack[-1])
0xbed: IF (Stack[-1] == 1) GOTO 0xbf6; Pop(1)

0xbee: PushEmpty(float, object)
0xbef: Stack[-5] = Stack[-1]
0xbf0: Call2 0x8a1

0xbf1: Pop(1)
0xbf2: Push((int) 4000000)
0xbf3: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xbf4: IF (Stack[-1] == 1) GOTO 0xbf6; Pop(1)

0xbf5: Stack[-4] = (bool) 0
0xbf6: Return(); Pop(2)

0xbf7: PushEmpty()
0xbf8: PushEmpty(object)
0xbf9: Stack[-2] = Stack[-1]
0xbfa: Push(-1, 3); TaskCall(6)
0xbfb: Call2 0x7ea

0xbfc: Pop(-1, 3); TaskReturn
0xbfd: Pop(1)
0xbfe: Return(); Pop(0)
...
0xc04: PushEmpty()
0xc05: Stack[-2] = (bool) 0
0xc06: Return(); Pop(0)

0xc07: PushEmpty()
0xc08: Return(); Pop(0)

0xc09: Push(GlobalVars[0])
0xc0a: Stack[-1] = (bool) 0
0xc0b: GlobalVars[0] = Stack[-1]; Pop(1)
0xc0c: Return(); Pop(0)
...
0xc11: PushEmpty()
0xc12: PushEmpty(bool, object, object, float, bool)
0xc13: Stack[-8] = Stack[-4]
0xc14: Stack[-7] = Stack[-3]
0xc15: Stack[-2] = (float) 500.0
0xc16: Stack[-6] = Stack[-1]
0xc17: Call2 0xbb2

0xc18: Stack[-5] = Stack[-9]
0xc19: Pop(5)
0xc1a: Return(); Pop(0)

0xc1b: PushEmpty()
0xc1c: PushEmpty(bool, object)
0xc1d: Stack[-3] = Stack[-1]
0xc1e: Call2 0x8a9

0xc1f: Pop(1)
0xc20: IF (Stack[-1] == 0) GOTO 0xc28; Pop(1)

0xc21: PushEmpty(object)
0xc22: Call2 0xa06

0xc23: Pop(0)
0xc24: Push((float)0.0)
0xc25: Push((bool) 1)
0xc26: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc27: Pop(3)
0xc28: Push(GlobalVars[0])
0xc29: Stack[-1] = (bool) 1
0xc2a: GlobalVars[0] = Stack[-1]; Pop(1)
0xc2b: Push((int) 50)
0xc2c: Push((int) 40)
0xc2d: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xc2e: Pop(2)
0xc2f: Return(); Pop(0)
