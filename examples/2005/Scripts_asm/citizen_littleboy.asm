...
// @pool_raw:
...
0x1332: PushEmpty()
0x1333: Stack[-2] = (int) 2
0x1334: Return(); Pop(0)

0x1335: PushEmpty()
0x1336: PushEmpty(object)
0x1337: Stack[-2] = Stack[-1]
0x1338: Call2 0x1502
...
0x1489: PushEmpty(object, float, object, float)
0x148a: Push("player") // @poff=492
0x148b: @ FindActor(Stack[-3], Stack[-1])
0x148c: Pop(1)
0x148d: Pop(0); Push((bool) Stack[-2] == 0)
0x148e: IF (Stack[-1] == 0) GOTO 0x1491; Pop(1)

0x148f: Stack[-5] = (int) 0
0x1490: Return(); Pop(4)

0x1491: Push("reputation") // @poff=579
0x1492: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=380
0x1493: Pop(1)
0x1494: Stack[-1] = Stack[-5]
0x1495: Return(); Pop(4)

0x1496: Stack[-2] = 0
0x1497: PushEmpty()
0x1498: PushEmpty(int)
0x1499: Call2 0x1483

0x149a: Pop(0)
0x149b: Push((int) 1)
0x149c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x149d: IF (Stack[-1] == 0) GOTO 0x14a1; Pop(1)

0x149e: @ WorkWithCorpse(Stack[-1])
0x149f: Pop(0)
0x14a0: GOTO 0x14a3

0x14a1: @ Barter(Stack[-1])
0x14a2: Pop(0)
0x14a3: Return(); Pop(0)

0x14a4: PushEmpty(int, int)
0x14a5: Push((int) 0)
0x14a6: @ ClearSubContainer(Stack[-1])
0x14a7: Pop(1)
0x14a8: Push(Stack[-3])
0x14a9: IF (Stack[-1] == 0) GOTO 0x14c0; Pop(1)

0x14aa: PushEmpty(string, int, int, int)
0x14ab: Stack[-4] = "rifle_ammo" // @poff=601
0x14ac: Stack[-3] = (int) 1
0x14ad: Stack[-2] = (int) 2
0x14ae: Stack[-1] = (int) 2
0x14af: Call2 0x11ab

0x14b0: Pop(4)
0x14b1: PushEmpty(string, int, int, int)
0x14b2: Stack[-4] = "revolver_ammo" // @poff=623
0x14b3: Stack[-3] = (int) 1
0x14b4: Stack[-2] = (int) 2
0x14b5: Stack[-1] = (int) 2
0x14b6: Call2 0x11ab

0x14b7: Pop(4)
0x14b8: PushEmpty(string, int, int, int)
0x14b9: Stack[-4] = "samopal_ammo" // @poff=651
0x14ba: Stack[-3] = (int) 2
0x14bb: Stack[-2] = (int) 2
0x14bc: Stack[-1] = (int) 2
0x14bd: Call2 0x11ab

0x14be: Pop(4)
0x14bf: GOTO 0x14ef

0x14c0: PushEmpty(string, int, int)
0x14c1: Stack[-3] = "lockpick" // @poff=677
0x14c2: Stack[-2] = (int) 1
0x14c3: Stack[-1] = (int) 4
0x14c4: Call2 0x11a0

0x14c5: Pop(3)
0x14c6: PushEmpty(string, int, int, int)
0x14c7: Stack[-4] = "alpha_pills" // @poff=695
0x14c8: Stack[-3] = (int) 1
0x14c9: Stack[-2] = (int) 2
0x14ca: Stack[-1] = (int) 3
0x14cb: Call2 0x11ab

0x14cc: Pop(4)
0x14cd: PushEmpty(string, int, int)
0x14ce: Stack[-3] = "meradorm" // @poff=719
0x14cf: Stack[-2] = (int) 1
0x14d0: Stack[-1] = (int) 2
0x14d1: Call2 0x11a0

0x14d2: Pop(3)
0x14d3: PushEmpty(string, int, int)
0x14d4: Stack[-3] = "powder" // @poff=737
0x14d5: Stack[-2] = (int) 1
0x14d6: Stack[-1] = (int) 15
0x14d7: Call2 0x11a0
...
0x14dc: Pop(1)
0x14dd: Push((int) 4)
0x14de: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x14df: IF (Stack[-1] == 0) GOTO 0x14e6; Pop(1)

0x14e0: PushEmpty(string, int, int)
0x14e1: Stack[-3] = "beta_pills" // @poff=751
0x14e2: Stack[-2] = (int) 1
0x14e3: Stack[-1] = (int) 2
0x14e4: Call2 0x11a0

0x14e5: Pop(3)
0x14e6: Push((int) 6)
0x14e7: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x14e8: IF (Stack[-1] == 0) GOTO 0x14ef; Pop(1)

0x14e9: PushEmpty(string, int, int)
0x14ea: Stack[-3] = "gamma_pills" // @poff=773
0x14eb: Stack[-2] = (int) 1
0x14ec: Stack[-1] = (int) 7
0x14ed: Call2 0x11a0

0x14ee: Pop(3)
0x14ef: Return(); Pop(2)

0x14f0: Stack[-1] = (int) 515560
0x14f1: Return(); Pop(0)

0x14f2: Stack[-1] = (int) 503345
0x14f3: Return(); Pop(0)

0x14f4: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=797
0x14f5: Return(); Pop(0)

0x14f6: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=837
0x14f7: Return(); Pop(0)

0x14f8: Stack[-1] = (bool) 0
0x14f9: Return(); Pop(0)

0x14fa: Push(GlobalVars[0])
0x14fb: Stack[-1] = (bool) 0
0x14fc: GlobalVars[0] = Stack[-1]; Pop(1)
0x14fd: PushEmpty(bool)
0x14fe: Stack[-1] = (bool) 1
0x14ff: Call2 0x14a4

0x1500: Pop(1)
0x1501: Return(); Pop(0)

0x1502: PushEmpty(bool, bool)
0x1503: Push(GlobalVars[0])
0x1504: IF (Stack[-1] == 0) GOTO 0x150f; Pop(1)

0x1505: @ IsOverrideActive(Stack[-1])
0x1506: Pop(0)
0x1507: Pop(0); Push((bool) Stack[-1] == 0)
0x1508: IF (Stack[-1] == 0) GOTO 0x150d; Pop(1)

0x1509: PushEmpty(object)
0x150a: Stack[-4] = Stack[-1]
0x150b: Call2 0x1497
...
0x150f: Push((int) 1000)
0x1510: PushEmpty(int, object)
0x1511: Stack[-6] = Stack[-1]
0x1512: Push(-2, 1); TaskCall(8)
0x1513: Call2 0x6c3

0x1514: Pop(-2, 1); TaskReturn
0x1515: Pop(1)
0x1516: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1517: IF (Stack[-1] == 0) GOTO 0x1529; Pop(1)

0x1518: PushEmpty(bool, object)
0x1519: Stack[-5] = Stack[-1]
0x151a: Call2 0x1146
...
0x151f: PushEmpty(object)
0x1520: Stack[-4] = Stack[-1]
0x1521: Push(-1, 1); TaskCall(0)
0x1522: Call2 0x0

0x1523: Pop(-1, 1); TaskReturn
0x1524: Pop(1)
0x1525: PushEmpty(object)
0x1526: Stack[-4] = Stack[-1]
0x1527: Call2 0x117d

0x1528: Pop(1)
0x1529: Return(); Pop(2)

0x152a: PushEmpty(float)
0x152b: Call2 0x1489

0x152c: Pop(0)
0x152d: Push((float)0.4000000059604645)
0x152e: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0x152f: Return(); Pop(0)

0x1530: PushEmpty()
0x1531: PushEmpty(bool, object, object, float)
0x1532: Stack[-7] = Stack[-3]
0x1533: Stack[-6] = Stack[-2]
0x1534: Stack[-1] = (float) 700.0
0x1535: Call2 0x12e6

0x1536: Stack[-4] = Stack[-8]
0x1537: Pop(4)
0x1538: Return(); Pop(0)
