...
// @pool_raw:
...
0xd62: PushEmpty(object, float, object, float)
0xd63: Push("player") // @poff=492
0xd64: @ FindActor(Stack[-3], Stack[-1])
0xd65: Pop(1)
0xd66: Pop(0); Push((bool) Stack[-2] == 0)
0xd67: IF (Stack[-1] == 0) GOTO 0xd6a; Pop(1)

0xd68: Stack[-5] = (int) 0
0xd69: Return(); Pop(4)

0xd6a: Push("reputation") // @poff=579
0xd6b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=380
0xd6c: Pop(1)
...
0xd77: @ WorkWithCorpse(Stack[-1])
0xd78: Pop(0)
0xd79: GOTO 0xd7c

0xd7a: @ Barter(Stack[-1])
0xd7b: Pop(0)
0xd7c: Return(); Pop(0)

0xd7d: PushEmpty(int, int)
0xd7e: Push((int) 0)
0xd7f: @ ClearSubContainer(Stack[-1])
0xd80: Pop(1)
0xd81: Push(Stack[-3])
0xd82: IF (Stack[-1] == 0) GOTO 0xd99; Pop(1)

0xd83: PushEmpty(string, int, int, int)
0xd84: Stack[-4] = "rifle_ammo" // @poff=601
0xd85: Stack[-3] = (int) 1
0xd86: Stack[-2] = (int) 2
0xd87: Stack[-1] = (int) 2
0xd88: Call2 0xb1d
...
0xd89: Pop(4)
0xd8a: PushEmpty(string, int, int, int)
0xd8b: Stack[-4] = "revolver_ammo" // @poff=623
0xd8c: Stack[-3] = (int) 1
0xd8d: Stack[-2] = (int) 2
0xd8e: Stack[-1] = (int) 2
0xd8f: Call2 0xb1d
...
0xd92: Stack[-4] = "samopal_ammo" // @poff=651
0xd93: Stack[-3] = (int) 2
0xd94: Stack[-2] = (int) 2
0xd95: Stack[-1] = (int) 2
0xd96: Call2 0xb1d
...
0xd99: PushEmpty(string, int, int)
0xd9a: Stack[-3] = "lockpick" // @poff=677
0xd9b: Stack[-2] = (int) 1
0xd9c: Stack[-1] = (int) 4
0xd9d: Call2 0xb12

0xd9e: Pop(3)
0xd9f: PushEmpty(string, int, int, int)
0xda0: Stack[-4] = "alpha_pills" // @poff=695
0xda1: Stack[-3] = (int) 1
0xda2: Stack[-2] = (int) 2
0xda3: Stack[-1] = (int) 3
0xda4: Call2 0xb1d
...
0xda5: Pop(4)
0xda6: PushEmpty(string, int, int)
0xda7: Stack[-3] = "meradorm" // @poff=719
0xda8: Stack[-2] = (int) 1
0xda9: Stack[-1] = (int) 2
0xdaa: Call2 0xb12

0xdab: Pop(3)
0xdac: PushEmpty(string, int, int)
0xdad: Stack[-3] = "powder" // @poff=737
0xdae: Stack[-2] = (int) 1
0xdaf: Stack[-1] = (int) 15
0xdb0: Call2 0xb12
...
0xdb4: Stack[-1] = Stack[-2]
0xdb5: Pop(1)
0xdb6: Push((int) 4)
0xdb7: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0xdb8: IF (Stack[-1] == 0) GOTO 0xdbf; Pop(1)

0xdb9: PushEmpty(string, int, int)
0xdba: Stack[-3] = "beta_pills" // @poff=751
0xdbb: Stack[-2] = (int) 1
0xdbc: Stack[-1] = (int) 2
0xdbd: Call2 0xb12
...
0xdc2: PushEmpty(string, int, int)
0xdc3: Stack[-3] = "gamma_pills" // @poff=773
0xdc4: Stack[-2] = (int) 1
0xdc5: Stack[-1] = (int) 7
0xdc6: Call2 0xb12
...
0xdc9: Stack[-1] = (int) 515561
0xdca: Return(); Pop(0)

0xdcb: Stack[-1] = (int) 503346
0xdcc: Return(); Pop(0)

0xdcd: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=797
0xdce: Return(); Pop(0)

0xdcf: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=837
0xdd0: Return(); Pop(0)

0xdd1: Stack[-1] = (bool) 0
0xdd2: Return(); Pop(0)

0xdd3: Push(GlobalVars[0])
0xdd4: Stack[-1] = (bool) 0
0xdd5: GlobalVars[0] = Stack[-1]; Pop(1)
0xdd6: PushEmpty(bool)
0xdd7: Stack[-1] = (bool) 0
0xdd8: Call2 0xd7d
...
0xddc: Push(GlobalVars[0])
0xddd: IF (Stack[-1] == 0) GOTO 0xde8; Pop(1)

0xdde: @ IsOverrideActive(Stack[-1])
0xddf: Pop(0)
0xde0: Pop(0); Push((bool) Stack[-1] == 0)
0xde1: IF (Stack[-1] == 0) GOTO 0xde6; Pop(1)

0xde2: PushEmpty(object)
0xde3: Stack[-4] = Stack[-1]
0xde4: Call2 0xd70
...
0xde8: Push((int) 1000)
0xde9: PushEmpty(int, object)
0xdea: Stack[-6] = Stack[-1]
0xdeb: Push(-2, 1); TaskCall(8)
0xdec: Call2 0x6c3

0xded: Pop(-2, 1); TaskReturn
0xdee: Pop(1)
0xdef: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xdf0: IF (Stack[-1] == 0) GOTO 0xe02; Pop(1)

0xdf1: PushEmpty(bool, object)
0xdf2: Stack[-5] = Stack[-1]
0xdf3: Call2 0xab8

0xdf4: Pop(1)
0xdf5: Pop(1); Push((bool) Stack[-1] == 0)
0xdf6: IF (Stack[-1] == 0) GOTO 0xdf8; Pop(1)

0xdf7: Return(); Pop(2)

0xdf8: PushEmpty(object)
0xdf9: Stack[-4] = Stack[-1]
0xdfa: Push(-1, 1); TaskCall(0)
0xdfb: Call2 0x0

0xdfc: Pop(-1, 1); TaskReturn
0xdfd: Pop(1)
0xdfe: PushEmpty(object)
0xdff: Stack[-4] = Stack[-1]
0xe00: Call2 0xaef

0xe01: Pop(1)
0xe02: Return(); Pop(2)

0xe03: PushEmpty(float)
0xe04: Call2 0xd62

0xe05: Pop(0)
0xe06: Push((float)0.20000000298023224)
0xe07: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0xe08: Return(); Pop(0)

0xe09: PushEmpty()
0xe0a: PushEmpty(bool, object, object, float)
0xe0b: Stack[-7] = Stack[-3]
0xe0c: Stack[-6] = Stack[-2]
0xe0d: Stack[-1] = (float) 700.0
0xe0e: Call2 0xc58

0xe0f: Stack[-4] = Stack[-8]
0xe10: Pop(4)
0xe11: Return(); Pop(0)
