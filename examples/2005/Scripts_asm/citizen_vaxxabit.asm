...
Strings:
	...
	W:rat_big
	W:dog
// @pool_raw:
...
0x423: Pop(0)
0x424: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x425: Pop(0)
...
0x442: Stack[-1] = (float) 1.7453293800354004
0x443: Call2 0x421

0x444: Stack[-2] = Stack[-7]
0x445: Pop(2)
...
0x44b: Stack[-1] = (float) 2.6179938316345215
0x44c: Call2 0x421

0x44d: Stack[-2] = Stack[-7]
0x44e: Pop(2)
...
0x453: Push("Can't retreat, distance: ") // @poff=178
...
0x469: Push((int) 1)
0x46a: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x46b: Pop(1)
0x46c: Push(Stack[-3])
0x46d: IF (Stack[-1] == 0) GOTO 0x485; Pop(1)

0x46e: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x473: Stack[-1] = (float) 2.6179938316345215
0x474: Call2 0x421

0x475: Stack[-2] = Stack[-4]
0x476: Pop(2)
...
0x486: IF (Stack[-1] == 1) GOTO 0x469; Pop(1)
...
0x48d: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x49c: Stack[-1] = (float) 1.7453293800354004
0x49d: Call2 0x421

0x49e: Stack[-2] = Stack[-4]
0x49f: Pop(2)
...
0x4ac: IF (Stack[-1] == 1) GOTO 0x4b2; Pop(1)
...
0x4d5: Stack[-5] = Stack[-2]
0x4d6: Stack[-4] = Stack[-1]
0x4d7: Call2 0x853

0x4d8: Pop(2)
0x4d9: Push((float)-0.3420201241970062)
...
0x4de: Pop(0)
0x4df: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x4e0: Pop(0)
...
0x4fd: Stack[-1] = (float) 1.7453293800354004
0x4fe: Call2 0x4dc

0x4ff: Stack[-2] = Stack[-7]
0x500: Pop(2)
...
0x506: Stack[-1] = (float) 2.6179938316345215
0x507: Call2 0x4dc

0x508: Stack[-2] = Stack[-7]
0x509: Pop(2)
...
0x50e: Push("Can't retreat, distance: ") // @poff=178
...
0x524: Push((int) 1)
0x525: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x526: Pop(1)
0x527: Push(Stack[-3])
0x528: IF (Stack[-1] == 0) GOTO 0x540; Pop(1)

0x529: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x52e: Stack[-1] = (float) 2.6179938316345215
0x52f: Call2 0x4dc
...
0x541: IF (Stack[-1] == 1) GOTO 0x524; Pop(1)
...
0x548: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x557: Stack[-1] = (float) 1.7453293800354004
0x558: Call2 0x4dc

0x559: Stack[-2] = Stack[-4]
0x55a: Pop(2)
...
0x567: IF (Stack[-1] == 1) GOTO 0x56d; Pop(1)

0x568: PushEmpty(bool)
0x569: Call2 0x587

0x56a: Pop(0)
0x56b: IF (Stack[-1] == 1) GOTO 0x56d; Pop(1)
...
0x58d: Stack[-2] = Stack[-3]
0x58e: Pop(2)
0x58f: PushEmpty(float, cvector, cvector)
0x590: Stack[-5] = Stack[-2]
0x591: Stack[-4] = Stack[-1]
0x592: Call2 0x853

0x593: Pop(2)
0x594: Push((float)-0.3420201241970062)
...
0x5a0: Pop(0)
0x5a1: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x5a2: Pop(0)
...
0x5bf: Stack[-1] = (float) 1.7453293800354004
0x5c0: Call2 0x59e

0x5c1: Stack[-2] = Stack[-7]
0x5c2: Pop(2)
...
0x5c8: Stack[-1] = (float) 2.6179938316345215
0x5c9: Call2 0x59e
...
0x5d0: Push("Can't retreat, distance: ") // @poff=178
...
0x5e6: Push((int) 1)
0x5e7: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x5e8: Pop(1)
0x5e9: Push(Stack[-3])
0x5ea: IF (Stack[-1] == 0) GOTO 0x602; Pop(1)

0x5eb: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x5f0: Stack[-1] = (float) 2.6179938316345215
0x5f1: Call2 0x59e

0x5f2: Stack[-2] = Stack[-4]
0x5f3: Pop(2)
...
0x603: IF (Stack[-1] == 1) GOTO 0x5e6; Pop(1)
...
0x60a: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x619: Stack[-1] = (float) 1.7453293800354004
0x61a: Call2 0x59e
...
0x629: IF (Stack[-1] == 1) GOTO 0x62f; Pop(1)
...
0x652: Stack[-5] = Stack[-2]
0x653: Stack[-4] = Stack[-1]
0x654: Call2 0x853

0x655: Pop(2)
0x656: Push((float)-0.3420201241970062)
...
0x662: Pop(0)
0x663: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x664: Pop(0)
...
0x681: Stack[-1] = (float) 1.7453293800354004
0x682: Call2 0x660
...
0x68a: Stack[-1] = (float) 2.6179938316345215
0x68b: Call2 0x660

0x68c: Stack[-2] = Stack[-7]
0x68d: Pop(2)
...
0x692: Push("Can't retreat, distance: ") // @poff=178
...
0x6a8: Push((int) 1)
0x6a9: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x6aa: Pop(1)
0x6ab: Push(Stack[-3])
0x6ac: IF (Stack[-1] == 0) GOTO 0x6c4; Pop(1)

0x6ad: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x6b2: Stack[-1] = (float) 2.6179938316345215
0x6b3: Call2 0x660
...
0x6c5: IF (Stack[-1] == 1) GOTO 0x6a8; Pop(1)
...
0x6cc: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x6db: Stack[-1] = (float) 1.7453293800354004
0x6dc: Call2 0x660
...
0x6eb: IF (Stack[-1] == 1) GOTO 0x6f1; Pop(1)

0x6ec: PushEmpty(bool)
0x6ed: Call2 0x70b

0x6ee: Pop(0)
0x6ef: IF (Stack[-1] == 1) GOTO 0x6f1; Pop(1)
...
0x717: Pop(2)
0x718: Push((float)-0.3420201241970062)
...
0x722: Pop(0)
0x723: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x724: Pop(0)
...
0x729: Pop(0)
0x72a: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x72b: Pop(0)
...
0x735: Push("HasProperty") // @poff=230
0x736: Push((int) 2)
...
0x73c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=254
0x73d: Pop(0)
0x73e: Stack[-1] = Stack[-5]
0x73f: Return(); Pop(2)

0x740: PushEmpty(bool, bool)
0x741: @@ IsDead(Stack[-1]); Obj=3 // @poff=266
0x742: Pop(0)
0x743: Stack[-1] = Stack[-4]
0x744: Return(); Pop(2)

0x745: PushEmpty(object, object, object, object)
0x746: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x75a: Pop(0)
0x75b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x75c: IF (Stack[-1] == 0) GOTO 0x75f; Pop(1)

0x75d: Stack[-6] = (bool) 0
0x75e: Return(); Pop(4)

0x75f: @@ GetScene(Stack[-1]); Obj=5 // @poff=287
0x760: Pop(0)
...
0x773: Stack[-6] = Stack[-2]
0x774: Stack[-1] = "noaccess" // @poff=296
0x775: Call2 0x734
...
0x77b: Push("noaccess") // @poff=296
0x77c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=314
0x77d: Pop(1)
0x77e: Push((int) 0)
...
0x782: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x790: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x791: Pop(0)
...
0x7a1: Stack[-1] = "fhit" // @poff=326
0x7a2: GOTO 0x7a4

0x7a3: Stack[-1] = "bhit" // @poff=336
0x7a4: Push("hit_react") // @poff=346
0x7a5: Push("1") // @poff=366
0x7a6: Pop(1); Push(Stack[-3] + Stack[-1]);
0x7a7: Push("2") // @poff=370
...
0x7c0: Stack[-25] = Stack[-1]
0x7c1: Call2 0x720

0x7c2: Stack[-2] = Stack[-3]
0x7c3: Pop(2)
0x7c4: Call2 0x849
...
0x7df: Pop(0)
0x7e0: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=383
0x7e1: Pop(0)
0x7e2: PushEmpty(object, int, float, cvector, cvector)
0x7e3: Stack[-26] = Stack[-5]
0x7e4: Stack[-25] = Stack[-4]
0x7e5: Stack[-24] = Stack[-3]
0x7e6: Stack[-6] = Stack[-2]
...
0x800: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x801: Pop(0)
...
0x870: Stack[-5] = Stack[-2]
0x871: Stack[-4] = Stack[-1]
0x872: Call2 0x85b
...
0x89e: Push("GenerateMoney: iMin > iMax") // @poff=447
0x89f: @ Trace(Stack[-1])
0x8a0: Pop(1)
0x8a1: Return(); Pop(4)
...
0x8a5: Pop(0); Push(Stack[-5] - Stack[-6]);
...
0x8ad: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x8ae: Push((int) 0)
...
0x8bc: Pop(0)
0x8bd: @@ SetItemName(Stack[-7]); Obj=3 // @poff=513
0x8be: Pop(0)
0x8bf: Push("Organ") // @poff=525
0x8c0: Push((int) 1)
0x8c1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=537
0x8c2: Pop(2)
0x8c3: @@ GetItemID(Stack[-2]); Obj=3 // @poff=549
0x8c4: Pop(0)
0x8c5: Push((int) 0)
0x8c6: Push((int) 1)
...
0x8d3: Stack[-1] = "liver" // @poff=559
0x8d4: Call2 0x8ba

0x8d5: Pop(1)
0x8d6: PushEmpty(string)
0x8d7: Stack[-1] = "kidney" // @poff=571
0x8d8: Call2 0x8ba

0x8d9: Pop(1)
0x8da: PushEmpty(string)
0x8db: Stack[-1] = "heart" // @poff=585
0x8dc: Call2 0x8ba

0x8dd: Pop(1)
0x8de: PushEmpty(string)
0x8df: Stack[-1] = "blood" // @poff=597
0x8e0: Call2 0x8ba
...
0x8ee: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x8ef: Call2 0x89b
...
0x91c: Stack[-1] = "syringe" // @poff=641
0x91d: Call2 0x992
...
0x944: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x945: Call2 0x89b
...
0x95a: Stack[-1] = "bracelet" // @poff=693
0x95b: Call2 0x992
...
0x966: Stack[-1] = "ear_ring" // @poff=711
0x967: Call2 0x992
...
0x972: Stack[-1] = "gold_ring" // @poff=729
0x973: Call2 0x992
...
0x97e: Stack[-1] = "silver_ring" // @poff=749
0x97f: Call2 0x992
...
0x999: Stack[-2] = Stack[-1]
0x99a: Push(-1, 0); TaskCall(0)
0x99b: Call2 0x0

0x99c: Pop(-1, 0); TaskReturn
0x99d: Pop(1)
0x99e: Return(); Pop(0)

0x99f: PushEmpty(float, float)
0x9a0: Push("health") // @poff=787
0x9a1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9a2: IF (Stack[-1] == 0) GOTO 0x9ab; Pop(1)

0x9a3: Push("health") // @poff=787
...
0x9b4: Stack[-7] = Stack[-3]
0x9b5: Stack[-6] = Stack[-2]
...
0x9bc: Stack[-11] = Stack[-5]
0x9bd: Stack[-10] = Stack[-4]
0x9be: Stack[-9] = Stack[-3]
0x9bf: Stack[-7] = Stack[-2]
0x9c0: Stack[-6] = Stack[-1]
0x9c1: Call2 0x7f1
...
0xa0c: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=859
0xa0d: Pop(0)
0xa0e: Pop(0); Push((bool) Stack[-1] == 0)
...
0xa45: Stack[-1] = "idle" // @poff=901
0xa46: Push(Stack[-3])
0xa47: IF (Stack[-1] == 0) GOTO 0xa49; Pop(1)

0xa48: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xa49: Stack[-1] = Stack[-4]
0xa4a: Return(); Pop(2)

0xa4b: PushEmpty(int, bool, int, bool)
0xa4c: Stack[-2] = (int) 0
0xa4d: Push("all") // @poff=170
...
0xa57: Push((int) 1)
0xa58: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xa59: GOTO 0xa4d

0xa5a: Stack[-2] = Stack[-5]
0xa5b: Return(); Pop(4)
...
0xa68: Push(-1, 1); TaskCall(3)
0xa69: Call2 0x307

0xa6a: Pop(-1, 1); TaskReturn
0xa6b: Pop(1)
0xa6c: Return(); Pop(0)
...
0xa7a: Push(-1, 3); TaskCall(4)
0xa7b: Call2 0x43f

0xa7c: Pop(-1, 3); TaskReturn
0xa7d: Pop(1)
0xa7e: Return(); Pop(0)

0xa7f: PushEmpty()
0xa80: PushEmpty(bool, object)
0xa81: Stack[-4] = Stack[-1]
0xa82: Call2 0x769
...
0xa8b: Stack[-2] = Stack[-1]
0xa8c: Push(-1, 3); TaskCall(5)
0xa8d: Call2 0x4fa

0xa8e: Pop(-1, 3); TaskReturn
0xa8f: Pop(1)
0xa90: Return(); Pop(0)

0xa91: PushEmpty(string, bool, string, bool)
0xa92: PushEmpty(bool, object, string)
0xa93: Stack[-9] = Stack[-2]
0xa94: Stack[-1] = "class" // @poff=911
0xa95: Call2 0x734

0xa96: Pop(2)
0xa97: Pop(1); Push((bool) Stack[-1] == 0)
0xa98: IF (Stack[-1] == 0) GOTO 0xa9b; Pop(1)

0xa99: Stack[-8] = (bool) 0
0xa9a: Return(); Pop(4)

0xa9b: Push("class") // @poff=911
0xa9c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=314
0xa9d: Pop(1)
0xa9e: Push("rat") // @poff=923
...
0xab3: Push(Stack[-2])
0xab4: IF (Stack[-1] == 1) GOTO 0xabd; Pop(1)

0xab5: PushEmpty(float, object)
0xab6: Stack[-10] = Stack[-1]
0xab7: Call2 0x727

0xab8: Pop(1)
0xab9: Pop(0); Push(Stack[-7] * Stack[-7]);
...
0xac4: Push(Stack[-2])
0xac5: IF (Stack[-1] == 1) GOTO 0xace; Pop(1)

0xac6: PushEmpty(float, object)
0xac7: Stack[-9] = Stack[-1]
0xac8: Call2 0x727

0xac9: Pop(1)
0xaca: Pop(0); Push(Stack[-7] * Stack[-7]);
0xacb: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xacc: IF (Stack[-1] == 1) GOTO 0xace; Pop(1)
...
0xaef: Push(-1, 3); TaskCall(6)
0xaf0: Call2 0x5bc

0xaf1: Pop(-1, 3); TaskReturn
0xaf2: Pop(1)
0xaf3: Return(); Pop(0)
...
0xaf8: Push(Stack[-1])
0xaf9: IF (Stack[-1] == 1) GOTO 0xb02; Pop(1)

0xafa: PushEmpty(float, object)
0xafb: Stack[-5] = Stack[-1]
0xafc: Call2 0x727

0xafd: Pop(1)
0xafe: Push((int) 4000000)
0xaff: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xb00: IF (Stack[-1] == 1) GOTO 0xb02; Pop(1)
...
0xb06: Push(-1, 3); TaskCall(7)
0xb07: Call2 0x67e

0xb08: Pop(-1, 3); TaskReturn
0xb09: Pop(1)
0xb0a: Return(); Pop(0)
...
0xb17: GlobalVars[0] = Stack[-1]; Pop(1)
0xb18: Return(); Pop(0)
...
0xb2b: Stack[-7] = Stack[-3]
0xb2c: Stack[-6] = Stack[-2]
0xb2d: Stack[-1] = (float) 700.0
0xb2e: Call2 0xa91

0xb2f: Stack[-4] = Stack[-8]
0xb30: Pop(4)
0xb31: Return(); Pop(0)

0xb32: PushEmpty()
0xb33: PushEmpty(bool, object)
0xb34: Stack[-3] = Stack[-1]
0xb35: Call2 0x72f
...
0xb3a: Pop(0)
0xb3b: Push((float)-0.05000000074505806)
0xb3c: Push((bool) 1)
...
0xb48: GlobalVars[0] = Stack[-1]; Pop(1)
0xb49: Push((int) 50)
0xb4a: Push((int) 40)
