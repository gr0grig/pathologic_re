...
Strings:
	...
	W:rat_big
	W:dog
// @pool_raw:
...
0x896: Push("reputation") // @poff=461
0x897: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=314
0x898: Pop(1)
0x899: Stack[-1] = Stack[-5]
0x89a: Return(); Pop(4)
...
0x8ac: Push("GenerateMoney: iMin > iMax") // @poff=483
0x8ad: @ Trace(Stack[-1])
0x8ae: Pop(1)
0x8af: Return(); Pop(4)
...
0x8ca: Pop(0)
0x8cb: @@ SetItemName(Stack[-7]); Obj=3 // @poff=549
0x8cc: Pop(0)
0x8cd: Push("Organ") // @poff=561
0x8ce: Push((int) 1)
0x8cf: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=573
0x8d0: Pop(2)
0x8d1: @@ GetItemID(Stack[-2]); Obj=3 // @poff=585
0x8d2: Pop(0)
0x8d3: Push((int) 0)
0x8d4: Push((int) 1)
...
0x8e1: Stack[-1] = "liver" // @poff=595
0x8e2: Call2 0x8c8

0x8e3: Pop(1)
0x8e4: PushEmpty(string)
0x8e5: Stack[-1] = "kidney" // @poff=607
0x8e6: Call2 0x8c8

0x8e7: Pop(1)
0x8e8: PushEmpty(string)
0x8e9: Stack[-1] = "heart" // @poff=621
0x8ea: Call2 0x8c8

0x8eb: Pop(1)
0x8ec: PushEmpty(string)
0x8ed: Stack[-1] = "blood" // @poff=633
0x8ee: Call2 0x8c8
...
0x92a: Stack[-1] = "syringe" // @poff=677
0x92b: Call2 0x9a0
...
0x968: Stack[-1] = "bracelet" // @poff=729
0x969: Call2 0x9a0
...
0x974: Stack[-1] = "ear_ring" // @poff=747
0x975: Call2 0x9a0
...
0x980: Stack[-1] = "gold_ring" // @poff=765
0x981: Call2 0x9a0
...
0x98c: Stack[-1] = "silver_ring" // @poff=785
0x98d: Call2 0x9a0
...
0x9c2: Stack[-7] = Stack[-3]
0x9c3: Stack[-6] = Stack[-2]
0x9c4: Stack[-5] = Stack[-1]
0x9c5: Call2 0x7ad
...
0x9ca: Stack[-11] = Stack[-5]
0x9cb: Stack[-10] = Stack[-4]
0x9cc: Stack[-9] = Stack[-3]
0x9cd: Stack[-7] = Stack[-2]
0x9ce: Stack[-6] = Stack[-1]
0x9cf: Call2 0x7f1
...
0xa1a: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=895
0xa1b: Pop(0)
...
0xaa1: Stack[-9] = Stack[-2]
0xaa2: Stack[-1] = "class" // @poff=933
0xaa3: Call2 0x734
...
0xaa9: Push("class") // @poff=933
0xaaa: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=314
0xaab: Pop(1)
0xaac: Push("rat") // @poff=945
...
0xaf7: Pop(0)
0xaf8: Stack[-1] = Stack[-4]
0xaf9: Return(); Pop(2)

0xafa: PushEmpty()
0xafb: PushEmpty(object)
0xafc: Stack[-2] = Stack[-1]
...
0xb06: Push(Stack[-1])
0xb07: IF (Stack[-1] == 1) GOTO 0xb10; Pop(1)

0xb08: PushEmpty(float, object)
0xb09: Stack[-5] = Stack[-1]
0xb0a: Call2 0x727

0xb0b: Pop(1)
0xb0c: Push((int) 4000000)
0xb0d: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xb0e: IF (Stack[-1] == 1) GOTO 0xb10; Pop(1)
...
0xb54: Pop(0)
0xb55: Push((float)-0.05000000074505806)
0xb56: Push((bool) 1)
