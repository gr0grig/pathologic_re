...
Strings:
	...
	W:dog
	W:killme
// @pool_raw:
...
0x41b: @ Face(Stack[-1])
0x41c: Pop(0)
0x41d: Push("all") // @poff=170
0x41e: Push("attack_on") // @poff=178
0x41f: @ PlayAnimation(Stack[-2], Stack[-1])
0x420: Pop(2)
0x421: @ WaitForAnimEnd()
0x422: Pop(0)
0x423: Push("all") // @poff=170
0x424: Push("attack_stay") // @poff=198
0x425: @ PlayAnimation(Stack[-2], Stack[-1])
0x426: Pop(2)
0x427: @ WaitForAnimEnd()
0x428: Pop(0)
0x429: Push("all") // @poff=170
0x42a: Push("attack_off") // @poff=222
...
0x43f: Pop(0)
0x440: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x441: Pop(0)
...
0x45e: Stack[-1] = (float) 1.7453293800354004
0x45f: Call2 0x43d

0x460: Stack[-2] = Stack[-7]
0x461: Pop(2)
...
0x467: Stack[-1] = (float) 2.6179938316345215
0x468: Call2 0x43d

0x469: Stack[-2] = Stack[-7]
0x46a: Pop(2)
...
0x46f: Push("Can't retreat, distance: ") // @poff=244
...
0x485: Push((int) 1)
0x486: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x487: Pop(1)
0x488: Push(Stack[-3])
0x489: IF (Stack[-1] == 0) GOTO 0x4a1; Pop(1)

0x48a: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x48f: Stack[-1] = (float) 2.6179938316345215
0x490: Call2 0x43d

0x491: Stack[-2] = Stack[-4]
0x492: Pop(2)
...
0x4a2: IF (Stack[-1] == 1) GOTO 0x485; Pop(1)
...
0x4a9: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4b8: Stack[-1] = (float) 1.7453293800354004
0x4b9: Call2 0x43d

0x4ba: Stack[-2] = Stack[-4]
0x4bb: Pop(2)
...
0x4c8: IF (Stack[-1] == 1) GOTO 0x4ce; Pop(1)

0x4c9: PushEmpty(bool)
0x4ca: Call2 0x4e8

0x4cb: Pop(0)
0x4cc: IF (Stack[-1] == 1) GOTO 0x4ce; Pop(1)
...
0x4f1: Stack[-5] = Stack[-2]
0x4f2: Stack[-4] = Stack[-1]
0x4f3: Call2 0x7ad

0x4f4: Pop(2)
0x4f5: Push((float)-0.3420201241970062)
...
0x4fa: Pop(0)
0x4fb: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x4fc: Pop(0)
...
0x519: Stack[-1] = (float) 1.7453293800354004
0x51a: Call2 0x4f8

0x51b: Stack[-2] = Stack[-7]
0x51c: Pop(2)
...
0x522: Stack[-1] = (float) 2.6179938316345215
0x523: Call2 0x4f8

0x524: Stack[-2] = Stack[-7]
0x525: Pop(2)
...
0x52a: Push("Can't retreat, distance: ") // @poff=244
...
0x540: Push((int) 1)
0x541: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x542: Pop(1)
0x543: Push(Stack[-3])
0x544: IF (Stack[-1] == 0) GOTO 0x55c; Pop(1)

0x545: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x54a: Stack[-1] = (float) 2.6179938316345215
0x54b: Call2 0x4f8

0x54c: Stack[-2] = Stack[-4]
0x54d: Pop(2)
...
0x55d: IF (Stack[-1] == 1) GOTO 0x540; Pop(1)
...
0x564: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x573: Stack[-1] = (float) 1.7453293800354004
0x574: Call2 0x4f8

0x575: Stack[-2] = Stack[-4]
0x576: Pop(2)
...
0x583: IF (Stack[-1] == 1) GOTO 0x589; Pop(1)
...
0x5ac: Stack[-5] = Stack[-2]
0x5ad: Stack[-4] = Stack[-1]
0x5ae: Call2 0x7ad

0x5af: Pop(2)
0x5b0: Push((float)-0.3420201241970062)
...
0x5bc: Pop(0)
0x5bd: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x5be: Pop(0)
...
0x5db: Stack[-1] = (float) 1.7453293800354004
0x5dc: Call2 0x5ba

0x5dd: Stack[-2] = Stack[-7]
0x5de: Pop(2)
...
0x5e4: Stack[-1] = (float) 2.6179938316345215
0x5e5: Call2 0x5ba

0x5e6: Stack[-2] = Stack[-7]
0x5e7: Pop(2)
...
0x5ec: Push("Can't retreat, distance: ") // @poff=244
...
0x602: Push((int) 1)
0x603: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x604: Pop(1)
0x605: Push(Stack[-3])
0x606: IF (Stack[-1] == 0) GOTO 0x61e; Pop(1)

0x607: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x60c: Stack[-1] = (float) 2.6179938316345215
0x60d: Call2 0x5ba
...
0x61f: IF (Stack[-1] == 1) GOTO 0x602; Pop(1)
...
0x626: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x645: IF (Stack[-1] == 1) GOTO 0x64b; Pop(1)
...
0x66e: Stack[-5] = Stack[-2]
0x66f: Stack[-4] = Stack[-1]
0x670: Call2 0x7ad

0x671: Pop(2)
0x672: Push((float)-0.3420201241970062)
...
0x683: Pop(0)
0x684: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x685: Pop(0)
...
0x68b: Pop(0)
0x68c: Stack[-1] = Stack[-4]
0x68d: Return(); Pop(2)

0x68e: PushEmpty(bool, bool)
0x68f: Push("HasProperty") // @poff=296
0x690: Push((int) 2)
...
0x696: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=320
0x697: Pop(0)
0x698: Stack[-1] = Stack[-5]
0x699: Return(); Pop(2)

0x69a: PushEmpty(bool, bool)
0x69b: @@ IsDead(Stack[-1]); Obj=3 // @poff=332
0x69c: Pop(0)
0x69d: Stack[-1] = Stack[-4]
0x69e: Return(); Pop(2)

0x69f: PushEmpty(object, object, object, object)
0x6a0: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6b4: Pop(0)
0x6b5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6b6: IF (Stack[-1] == 0) GOTO 0x6b9; Pop(1)

0x6b7: Stack[-6] = (bool) 0
0x6b8: Return(); Pop(4)

0x6b9: @@ GetScene(Stack[-1]); Obj=5 // @poff=353
0x6ba: Pop(0)
...
0x6ce: Stack[-1] = "noaccess" // @poff=362
0x6cf: Call2 0x68e
...
0x6d5: Push("noaccess") // @poff=362
0x6d6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=380
0x6d7: Pop(1)
0x6d8: Push((int) 0)
...
0x6dc: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6ea: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x6eb: Pop(0)
...
0x6fb: Stack[-1] = "fhit" // @poff=392
0x6fc: GOTO 0x6fe

0x6fd: Stack[-1] = "bhit" // @poff=402
0x6fe: Push("hit_react") // @poff=412
0x6ff: Push("1") // @poff=432
0x700: Pop(1); Push(Stack[-3] + Stack[-1]);
0x701: Push("2") // @poff=436
...
0x739: Pop(0)
0x73a: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=449
0x73b: Pop(0)
0x73c: PushEmpty(object, int, float, cvector, cvector)
0x73d: Stack[-26] = Stack[-5]
0x73e: Stack[-25] = Stack[-4]
0x73f: Stack[-24] = Stack[-3]
0x740: Stack[-6] = Stack[-2]
...
0x74d: Pop(0)
0x74e: Push("scripted") // @poff=453
0x74f: Push("blood_dir.xml") // @poff=471
...
0x75a: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x75b: Pop(0)
...
0x76a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x76b: Pop(0)
0x76c: Stack[-1] = [0.0, 0.0, 0.0]
0x76d: Push(CvectorIndex(Stack[-1], 1))
0x76e: Stack[-3] = Stack[-1]
0x76f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x770: Push("head") // @poff=160
...
0x7f0: Push("reputation") // @poff=527
0x7f1: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=380
0x7f2: Pop(1)
0x7f3: Stack[-1] = Stack[-5]
0x7f4: Return(); Pop(4)
...
0x806: Push("GenerateMoney: iMin > iMax") // @poff=549
0x807: @ Trace(Stack[-1])
0x808: Pop(1)
0x809: Return(); Pop(4)
...
0x824: Pop(0)
0x825: @@ SetItemName(Stack[-7]); Obj=3 // @poff=615
0x826: Pop(0)
0x827: Push("Organ") // @poff=627
0x828: Push((int) 1)
0x829: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=639
0x82a: Pop(2)
0x82b: @@ GetItemID(Stack[-2]); Obj=3 // @poff=651
0x82c: Pop(0)
0x82d: Push((int) 0)
0x82e: Push((int) 1)
...
0x83b: Stack[-1] = "liver" // @poff=661
0x83c: Call2 0x822

0x83d: Pop(1)
0x83e: PushEmpty(string)
0x83f: Stack[-1] = "kidney" // @poff=673
0x840: Call2 0x822

0x841: Pop(1)
0x842: PushEmpty(string)
0x843: Stack[-1] = "heart" // @poff=687
0x844: Call2 0x822

0x845: Pop(1)
0x846: PushEmpty(string)
0x847: Stack[-1] = "blood" // @poff=699
0x848: Call2 0x822
...
0x884: Stack[-1] = "syringe" // @poff=743
0x885: Call2 0x8fa
...
0x8c2: Stack[-1] = "bracelet" // @poff=795
0x8c3: Call2 0x8fa
...
0x8ce: Stack[-1] = "ear_ring" // @poff=813
0x8cf: Call2 0x8fa
...
0x8da: Stack[-1] = "gold_ring" // @poff=831
0x8db: Call2 0x8fa
...
0x8e6: Stack[-1] = "silver_ring" // @poff=851
0x8e7: Call2 0x8fa
...
0x91c: Stack[-7] = Stack[-3]
0x91d: Stack[-6] = Stack[-2]
0x91e: Stack[-5] = Stack[-1]
0x91f: Call2 0x707
...
0x924: Stack[-11] = Stack[-5]
0x925: Stack[-10] = Stack[-4]
0x926: Stack[-9] = Stack[-3]
0x927: Stack[-7] = Stack[-2]
...
0x933: Stack[-2] = Stack[-5]
0x934: Pop(2)
0x935: Return(); Pop(0)

0x936: GOTO 0x94a

0x937: Push("player_shot") // @poff=923
...
0x974: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=961
0x975: Pop(0)
...
0x9b4: Stack[-2] = (int) 0
0x9b5: Push("all") // @poff=170
0x9b6: PushEmpty(string, int)
0x9b7: Stack[-5] = Stack[-1]
0x9b8: Call2 0x9ac
...
0x9fb: Stack[-9] = Stack[-2]
0x9fc: Stack[-1] = "class" // @poff=999
0x9fd: Call2 0x68e
...
0xa03: Push("class") // @poff=999
0xa04: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=380
0xa05: Pop(1)
0xa06: Push("rat") // @poff=1011
...
0xa58: Push(Stack[-1])
0xa59: IF (Stack[-1] == 1) GOTO 0xa62; Pop(1)

0xa5a: PushEmpty(float, object)
0xa5b: Stack[-5] = Stack[-1]
0xa5c: Call2 0x681

0xa5d: Pop(1)
0xa5e: Push((int) 4000000)
0xa5f: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xa60: IF (Stack[-1] == 1) GOTO 0xa62; Pop(1)
...
0xa6d: Stack[-3] = Stack[-1]
0xa6e: Call2 0xa54

0xa6f: Stack[-2] = Stack[-4]
0xa70: Pop(2)
0xa71: Return(); Pop(0)
...
0xabb: Pop(0)
0xabc: Push((float)-0.10000000149011612)
0xabd: Push((bool) 1)
