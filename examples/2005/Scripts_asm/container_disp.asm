...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:63006c00650061006e0075007000000072006500730074006f0072006500000049734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
...
0x2b: IF (Stack[-1] == 1) GOTO 0x32; Pop(1)
...
0x30: IF (Stack[-1] == 1) GOTO 0x32; Pop(1)
...
0x34: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=32
0x35: Pop(0)
0x36: Push(Stack[-2])
...
0x48: Push("nouse_container") // @poff=43
