...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0x21: Stack[-3] = "halfboot_repel" // @poff=56
0x22: Stack[-2] = (int) 1
0x23: Stack[-1] = (int) 40
0x24: Call2 0xc8
...
0x2d: Stack[-3] = "glove_disp" // @poff=102
0x2e: Stack[-2] = (int) 1
0x2f: Stack[-1] = (int) 40
0x30: Call2 0xc8
...
0x36: Stack[-3] = "cloak_repel" // @poff=124
0x37: Stack[-2] = (int) 1
0x38: Stack[-1] = (int) 40
0x39: Call2 0xc8
...
0x45: Stack[-3] = "boot_repel" // @poff=64
0x46: Stack[-2] = (int) 1
0x47: Stack[-1] = (int) 70
0x48: Call2 0xc8
...
0x4e: Stack[-3] = "raincoat_repel" // @poff=160
0x4f: Stack[-2] = (int) 1
0x50: Stack[-1] = (int) 60
0x51: Call2 0xc8
...
0x63: Stack[-3] = "halfboot_repel" // @poff=56
0x64: Stack[-2] = (int) 1
0x65: Stack[-1] = (int) 60
0x66: Call2 0xc8
...
0x6f: Stack[-3] = "glove_disp" // @poff=102
0x70: Stack[-2] = (int) 1
0x71: Stack[-1] = (int) 60
0x72: Call2 0xc8
...
0x78: Stack[-3] = "cloak_repel" // @poff=124
0x79: Stack[-2] = (int) 1
0x7a: Stack[-1] = (int) 60
0x7b: Call2 0xc8
...
0x87: Stack[-3] = "boot_repel" // @poff=64
0x88: Stack[-2] = (int) 1
0x89: Stack[-1] = (int) 80
0x8a: Call2 0xc8
...
0x90: Stack[-3] = "raincoat_repel" // @poff=160
0x91: Stack[-2] = (int) 1
0x92: Stack[-1] = (int) 80
0x93: Call2 0xc8
...
0xb2: @@ IsOnGround(Stack[-4]); Obj=9 // @poff=202
0xb3: Pop(0)
0xb4: Push(Stack[-4])
...
0xca: Stack[-7] = Stack[-2]
0xcb: Stack[-6] = Stack[-1]
0xcc: Call2 0xe2
...
0xd5: Stack[-10] = Stack[-2]
0xd6: Stack[-9] = Stack[-1]
0xd7: Call2 0xe2
...
0xe8: Push("nouse_container") // @poff=213
