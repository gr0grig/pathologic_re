...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0xd: Stack[-4] = "rifle_ammo" // @poff=12
0xe: Stack[-3] = (int) 1
0xf: Stack[-2] = (int) 20
0x10: Stack[-1] = (int) 2
0x11: Call2 0x88
...
0x14: Stack[-4] = "revolver_ammo" // @poff=34
0x15: Stack[-3] = (int) 1
0x16: Stack[-2] = (int) 20
0x17: Stack[-1] = (int) 2
0x18: Call2 0x88
...
0x22: Stack[-3] = "halfboot_repel" // @poff=62
0x23: Stack[-2] = (int) 1
0x24: Stack[-1] = (int) 30
0x25: Call2 0x7d
...
0x2e: Stack[-3] = "glove_disp" // @poff=108
0x2f: Stack[-2] = (int) 1
0x30: Stack[-1] = (int) 40
0x31: Call2 0x7d
...
0x37: Stack[-3] = "cloak_repel" // @poff=130
0x38: Stack[-2] = (int) 1
0x39: Stack[-1] = (int) 70
0x3a: Call2 0x7d
...
0x46: Stack[-3] = "boot_repel" // @poff=70
0x47: Stack[-2] = (int) 1
0x48: Stack[-1] = (int) 40
0x49: Call2 0x7d
...
0x4f: Stack[-3] = "raincoat_repel" // @poff=166
0x50: Stack[-2] = (int) 1
0x51: Stack[-1] = (int) 80
0x52: Call2 0x7d
...
0x67: IF (Stack[-1] == 1) GOTO 0x6e; Pop(1)
...
0x6c: IF (Stack[-1] == 1) GOTO 0x6e; Pop(1)
...
0x70: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=210
0x71: Pop(0)
0x72: Push(Stack[-2])
...
0x7f: Stack[-7] = Stack[-2]
0x80: Stack[-6] = Stack[-1]
0x81: Call2 0x97
...
0x8a: Stack[-10] = Stack[-2]
0x8b: Stack[-9] = Stack[-1]
0x8c: Call2 0x97
...
0x9d: Push("nouse_container") // @poff=221
