...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_16 Op = 0xa2f Vars = (object, string)
EVENT_41 Op = 0xa3c Vars = (object)
EVENT_22 Op = 0xa42 Vars = (object, int, float, float)
EVENT_43 Op = 0xa4a Vars = (object, int, float, float, cvector, cvector)
...
0x37c: PushEmpty()
0x37d: Stack[-3] = (float) 0.05000000074505806
0x37e: Return(); Pop(0)
...
0x397: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x398: Pop(0)
0x399: Push(Stack[-8])
0x39a: IF (Stack[-1] == 0) GOTO 0x3a3; Pop(1)

0x39b: Push("attack") // @poff=382
...
0x3b7: Pop(0)
0x3b8: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x3b9: Pop(0)
...
0x3d3: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0x3d4: Pop(0)
...
0x3ed: Pop(1)
0x3ee: Push("all") // @poff=138
0x3ef: Push("attack_on") // @poff=410
...
0x407: IF (Stack[-1] == 1) GOTO 0x40d; Pop(1)

0x408: PushEmpty(bool)
0x409: Call2 0x5d9

0x40a: Pop(0)
0x40b: IF (Stack[-1] == 1) GOTO 0x40d; Pop(1)

0x40c: Stack[-1] = (bool) 0
0x40d: IF (Stack[-1] == 0) GOTO 0x41e; Pop(1)

0x40e: @ Face(Stack[-0]T)
0x40f: Pop(0)
0x410: PushEmpty()
0x411: Call2 0x60b
...
0x41e: @ Face(Stack[-0]T)
0x41f: Pop(0)
0x420: Push("all") // @poff=138
0x421: Push("fjump") // @poff=454
...
0x43c: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x43d: Pop(0)
...
0x45b: Push("all") // @poff=138
0x45c: Push("attack_off") // @poff=466
...
0x46a: Push("attack_begin") // @poff=488
0x46b: Push((int) 1)
0x46c: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x477: Push("attack") // @poff=382
0x478: Push((int) 1)
0x479: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x483: Push("all") // @poff=138
0x484: Push("bjump") // @poff=514
...
0x48b: Push((float)0.8999999761581421)
0x48c: Pop(1); Push(Stack[-9] * Stack[-1]);
0x48d: @ GetVictim(Stack[-1], Stack[-4])
0x48e: Pop(1)
0x48f: @ ReportAttack(Stack[-0]T)
0x490: Pop(0)
...
0x494: Stack[-6] = Stack[-2]
0x495: Stack[-10] = Stack[-1]
0x496: Call2 0x37c

0x497: Stack[-3] = Stack[-5]
0x498: Pop(3)
0x499: PushEmpty(float, object, float, int)
0x49a: Stack[-7] = Stack[-3]
0x49b: Stack[-6] = Stack[-2]
0x49c: PushEmpty(int, object, int)
0x49d: Stack[-10] = Stack[-2]
0x49e: Stack[-14] = Stack[-1]
0x49f: Call2 0x37f

0x4a0: Stack[-3] = Stack[-4]
0x4a1: Pop(3)
0x4a2: Call2 0x745

0x4a3: Stack[-4] = Stack[-5]
0x4a4: Pop(4)
0x4a5: PushEmpty(int)
0x4a6: Call2 0x609

0x4a7: Pop(0)
0x4a8: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x4a9: Pop(1)
0x4aa: PushEmpty(object, float)
0x4ab: Stack[-5] = Stack[-2]
...
0x4b4: Pop(0)
0x4b5: @ irand(Stack[-4], Stack[-1]T)
0x4b6: Pop(0)
0x4b7: Push((int) 1)
0x4b8: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x4b9: @ Face(Stack[-0]T)
0x4ba: Pop(0)
0x4bb: Push((bool) 1)
...
0x4c0: Pop(0)
0x4c1: Push("all") // @poff=138
0x4c2: Push("attack_begin") // @poff=488
...
0x4d6: Stack[-11] = Stack[-2]
0x4d7: Stack[-6] = Stack[-1]
0x4d8: Call2 0x48a

0x4d9: Pop(2)
0x4da: Push("all") // @poff=138
0x4db: Push("attack_middle") // @poff=526
...
0x4e3: Pop(0)
0x4e4: Push("all") // @poff=138
0x4e5: Push("attack_middle") // @poff=526
...
0x4f9: Stack[-11] = Stack[-2]
0x4fa: Stack[-6] = Stack[-1]
0x4fb: Call2 0x48a

0x4fc: Pop(2)
0x4fd: Stack[-2] = (int) 1
0x4fe: Push("attack_middle") // @poff=526
0x4ff: Pop(1); Push(Stack[-1] + Stack[-5]);
0x500: Push("_") // @poff=554
...
0x52a: Push("attack_end") // @poff=558
...
0x569: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0x56a: Pop(0)
...
0x5b5: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x5b6: Pop(1)
...
0x5ba: @ Face(Stack[-0]T)
0x5bb: Pop(0)
0x5bc: Push("all") // @poff=138
0x5bd: Push("bjump") // @poff=514
0x5be: @ PlayAnimation(Stack[-2], Stack[-1])
0x5bf: Pop(2)
0x5c0: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0x5c1: Pop(0)
...
0x5f7: @ irand(Stack[-1], Stack[-2]T)
0x5f8: Pop(0)
0x5f9: Push((int) 1)
0x5fa: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x5fb: Push("attack") // @poff=382
...
0x60c: Stack[-1] = "attack_stay" // @poff=430
0x60d: Call2 0x8d1
...
0x63e: Stack[-15] = Stack[-5]
0x63f: Stack[-14] = Stack[-4]
0x640: Stack[-13] = Stack[-3]
0x641: Stack[-12] = Stack[-2]
0x642: Stack[-11] = Stack[-1]
0x643: Call2 0x688

0x644: Stack[-6] = Stack[-7]
0x645: Pop(6)
0x646: Push( Stack[2 + Tasks[-1].StackPointer] )
0x647: IF (Stack[-1] == 0) GOTO 0x64b; Pop(1)

0x648: Push("head") // @poff=316
0x649: @ UnlookAsync(Stack[-1])
0x64a: Pop(1)
0x64b: Push((int) 1)
0x64c: @ KillTimer(Stack[-1])
0x64d: Pop(1)
0x64e: Stack[-1] = Stack[-10]
0x64f: Return(); Pop(4)
...
0x68b: Stack[-17] = Stack[-7]
0x68c: PushEmpty(bool, object)
0x68d: Stack[-23] = Stack[-1]
0x68e: Call2 0x714
...
0x694: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x695: Pop(0)
...
0x6ab: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0x6ac: Pop(0)
...
0x6bd: Push((int) 0)
0x6be: Push((float)0.30000001192092896)
...
0x6e0: Push((int) 0)
0x6e1: Push((float)0.30000001192092896)
...
0x718: Stack[-2] = Stack[-4]
0x719: Pop(2)
0x71a: Return(); Pop(0)

0x71b: Stack[-1] = "walk" // @poff=616
0x71c: Return(); Pop(0)

0x71d: Stack[-1] = "run" // @poff=626
0x71e: Return(); Pop(0)
...
0x729: Stack[-2] = "bullet" // @poff=644
0x72a: Return(); Pop(0)

0x72b: Stack[-2] = "phys" // @poff=658
0x72c: Return(); Pop(0)

0x72d: PushEmpty(cvector, cvector, cvector, cvector)
0x72e: @ GetPosition(Stack[-2])
0x72f: Pop(0)
0x730: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x731: Pop(0)
...
0x73a: Push("HasProperty") // @poff=668
0x73b: Push((int) 2)
...
0x741: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x742: Pop(0)
...
0x747: Stack[-18] = Stack[-2]
0x748: Stack[-1] = "health" // @poff=704
0x749: Call2 0x739
...
0x750: Stack[-18] = Stack[-2]
0x751: Stack[-1] = "armor" // @poff=718
0x752: Call2 0x739
...
0x758: Push("armor") // @poff=718
0x759: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x75a: Pop(1)
0x75b: Push("armor_") // @poff=742
0x75c: PushEmpty(string, int)
0x75d: Stack[-16] = Stack[-1]
0x75e: Call2 0x71f

0x75f: Pop(1)
0x760: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x761: PushEmpty(bool, object, string)
0x762: Stack[-18] = Stack[-2]
0x763: Stack[-8] = Stack[-1]
0x764: Call2 0x739
...
0x76a: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x76b: Pop(0)
...
0x772: Stack[-3] = Stack[-6]
0x773: Pop(3)
0x774: Push("health") // @poff=704
0x775: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x776: Pop(1)
0x777: Push((int) 1)
0x778: Pop(1); Push(Stack[-1] - Stack[-4]);
0x779: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x77a: Push("health") // @poff=704
...
0x780: Pop(3)
0x781: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0x782: Pop(2)
0x783: PushEmpty(bool, object)
0x784: Stack[-17] = Stack[-1]
0x785: Call2 0x734
...
0x78b: Pop(1)
0x78c: Stack[-1] = Stack[-16]
0x78d: Return(); Pop(12)

0x78e: PushEmpty(bool, bool)
0x78f: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0x790: Pop(0)
0x791: Stack[-1] = Stack[-4]
0x792: Return(); Pop(2)

0x793: PushEmpty(object, object, object, object)
0x794: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7a8: Pop(0)
0x7a9: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7aa: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7ab: Stack[-6] = (bool) 0
0x7ac: Return(); Pop(4)

0x7ad: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0x7ae: Pop(0)
...
0x7c1: Stack[-6] = Stack[-2]
0x7c2: Stack[-1] = "noaccess" // @poff=798
0x7c3: Call2 0x739
...
0x7c9: Push("noaccess") // @poff=798
0x7ca: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x7cb: Pop(1)
0x7cc: Push((int) 0)
...
0x7d0: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x7de: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0x7df: Pop(0)
...
0x7ef: Stack[-1] = "fhit" // @poff=816
0x7f0: GOTO 0x7f2

0x7f1: Stack[-1] = "bhit" // @poff=826
0x7f2: Push("hit_react") // @poff=836
0x7f3: Push("1") // @poff=856
0x7f4: Pop(1); Push(Stack[-3] + Stack[-1]);
0x7f5: Push("2") // @poff=860
...
0x813: Stack[-2] = Stack[-11]
0x814: Pop(2)
0x815: @ CreateVectorVector(Stack[-8])
0x816: Pop(0)
0x817: Stack[-7] = (int) 1
0x818: Push("hit") // @poff=818
...
0x82d: Pop(0)
0x82e: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0x82f: Pop(0)
0x830: PushEmpty(object, int, float, cvector, cvector)
0x831: Stack[-26] = Stack[-5]
0x832: Stack[-25] = Stack[-4]
0x833: Stack[-24] = Stack[-3]
0x834: Stack[-6] = Stack[-2]
...
0x84e: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0x84f: Pop(0)
...
0x85e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0x85f: Pop(0)
0x860: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0x861: Pop(0)
...
0x8a9: Push("head") // @poff=316
0x8aa: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8ab: Pop(1)
0x8ac: Push(Stack[-1])
0x8ad: IF (Stack[-1] == 0) GOTO 0x8b1; Pop(1)

0x8ae: Push("head") // @poff=316
0x8af: @ UnlookAsync(Stack[-1])
0x8b0: Pop(1)
0x8b1: Return(); Pop(2)

0x8b2: PushEmpty(float, float, float, float)
0x8b3: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x8b4: Pop(0)
0x8b5: Push((bool) 0)
0x8b6: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8b7: Pop(1)
0x8b8: Return(); Pop(4)

0x8b9: PushEmpty(float, float, float, float)
0x8ba: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x8bb: Pop(0)
0x8bc: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x8bd: Pop(0)
0x8be: Return(); Pop(4)

0x8bf: PushEmpty(float, cvector, float, cvector)
0x8c0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0x8c1: Pop(0)
0x8c2: Stack[-1] = [0.0, 0.0, 0.0]
0x8c3: Push(CvectorIndex(Stack[-1], 1))
0x8c4: Stack[-3] = Stack[-1]
0x8c5: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8c6: Push("head") // @poff=316
0x8c7: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x8c8: Pop(1)
0x8c9: Return(); Pop(4)
...
0x8d1: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x8d2: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x8d3: Pop(0)
0x8d4: Pop(0); Push((bool) Stack[-8] == 0)
0x8d5: IF (Stack[-1] == 0) GOTO 0x8ea; Pop(1)

0x8d6: Stack[-7] = (int) 0
0x8d7: Push((int) 1)
0x8d8: Pop(1); Push(Stack[-8] + Stack[-1]);
0x8d9: Pop(1); Push(Stack[-18] + Stack[-1]);
0x8da: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x8db: Pop(1)
0x8dc: Pop(0); Push((bool) Stack[-6] == 0)
0x8dd: IF (Stack[-1] == 0) GOTO 0x8df; Pop(1)

0x8de: GOTO 0x8e2

0x8df: Push((int) 1)
0x8e0: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x8e1: GOTO 0x8d7

0x8e2: Pop(0); Push((bool) Stack[-7] == 0)
0x8e3: IF (Stack[-1] == 0) GOTO 0x8e5; Pop(1)

0x8e4: Return(); Pop(16)

0x8e5: @ irand(Stack[-5], Stack[-7])
0x8e6: Pop(0)
0x8e7: Push((int) 1)
0x8e8: Pop(1); Push(Stack[-6] + Stack[-1]);
0x8e9: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x8ea: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x8eb: Pop(0)
0x8ec: Push(Stack[-4])
0x8ed: IF (Stack[-1] == 0) GOTO 0x8f9; Pop(1)

0x8ee: @ GetEyesHeight(Stack[-3])
0x8ef: Pop(0)
0x8f0: @ GetDirection(Stack[-2])
0x8f1: Pop(0)
0x8f2: Push((int) 50)
0x8f3: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x8f4: Push(CvectorIndex(Stack[-1], 1))
0x8f5: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x8f6: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8f7: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x8f8: Pop(0)
0x8f9: Return(); Pop(16)
...
0x8ff: Stack[-1] = 0
0x900: PushEmpty(float, float)
0x901: Pop(0); Push(Stack[-3] | Stack[-3]);
0x902: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x903: Push((float)9.999999974752427e-07)
0x904: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x905: IF (Stack[-1] == 0) GOTO 0x908; Pop(1)

0x906: Stack[-4] = [0.0, 0.0, 0.0]
0x907: Return(); Pop(2)

0x908: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x909: Return(); Pop(2)

0x90a: PushEmpty()
0x90b: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x90c: IF (Stack[-1] == 0) GOTO 0x90f; Pop(1)

0x90d: Stack[-2] = Stack[-3]
0x90e: GOTO 0x910
...
0x911: PushEmpty()
0x912: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x913: IF (Stack[-1] == 0) GOTO 0x916; Pop(1)

0x914: Stack[-2] = Stack[-4]
0x915: Return(); Pop(0)

0x916: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x917: IF (Stack[-1] == 0) GOTO 0x91a; Pop(1)

0x918: Stack[-1] = Stack[-4]
0x919: Return(); Pop(0)

0x91a: Stack[-3] = Stack[-4]
0x91b: Return(); Pop(0)

0x91c: PushEmpty(object, object)
0x91d: @ CreateFloatVector(Stack[-1])
0x91e: Pop(0)
0x91f: @@ add(Stack[-3]); Obj=1 // @poff=864
0x920: Pop(0)
0x921: Push((int) 15)
0x922: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x923: Pop(1)
0x924: Return(); Pop(2)

0x925: Stack[-1] = 0
0x926: PushEmpty(float, float)
0x927: @ GetGameTime(Stack[-1])
0x928: Pop(0)
0x929: Push((int) 1)
0x92a: PushEmpty(int)
0x92b: Push((int) 24)
0x92c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x92d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x92e: Return(); Pop(2)

0x92f: PushEmpty(bool, bool)
0x930: @ IsPlayerActor(Stack[-3], Stack[-1])
0x931: Pop(0)
0x932: Push(Stack[-1])
0x933: IF (Stack[-1] == 0) GOTO 0x937; Pop(1)

0x934: Push("attack") // @poff=382
0x935: @ PlayGlobalMusic(Stack[-1])
0x936: Pop(1)
0x937: Return(); Pop(2)

0x938: PushEmpty(object, object)
0x939: @ GetScene(Stack[-1])
0x93a: Pop(0)
0x93b: Push("battle") // @poff=923
0x93c: PushEmpty(object)
0x93d: Call2 0x8fa

0x93e: Pop(0)
0x93f: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x940: Pop(2)
0x941: Return(); Pop(2)

0x942: Stack[-1] = 0
0x943: PushEmpty(int, int)
0x944: Push("branch") // @poff=937
0x945: @ GetVariable(Stack[-1], Stack[-2])
0x946: Pop(1)
0x947: Push((int) 0)
...
0x954: PushEmpty(int, bool, int, bool)
0x955: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x956: IF (Stack[-1] == 0) GOTO 0x95b; Pop(1)

0x957: Push("GenerateMoney: iMin > iMax") // @poff=951
0x958: @ Trace(Stack[-1])
0x959: Pop(1)
0x95a: Return(); Pop(4)

0x95b: Stack[-2] = (int) 0
0x95c: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x95d: IF (Stack[-1] == 0) GOTO 0x962; Pop(1)

0x95e: Pop(0); Push(Stack[-5] - Stack[-6]);
0x95f: @ irand(Stack[-3], Stack[-1])
0x960: Pop(1)
0x961: GOTO 0x966

0x962: Push((int) 0)
0x963: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x964: IF (Stack[-1] == 0) GOTO 0x966; Pop(1)

0x965: Return(); Pop(4)

0x966: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x967: Push((int) 0)
...
0x96b: PushEmpty(int, string)
0x96c: Stack[-1] = "Money" // @poff=1005
0x96d: Call2 0xa22

0x96e: Pop(1)
0x96f: Push((int) 0)
0x970: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x971: Pop(2)
0x972: Return(); Pop(4)

0x973: PushEmpty(int, bool, int, bool)
0x974: Push(Stack[-5])
0x975: IF (Stack[-1] == 0) GOTO 0x9cc; Pop(1)
...
0x97b: Pop(0)
0x97c: Push((int) 100)
0x97d: Pop(2); Push(Stack[-2] * Stack[-1]);
0x97e: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x97f: Call2 0x954

0x980: Pop(2)
0x981: Push((int) 8)
0x982: @ irand(Stack[-3], Stack[-1])
0x983: Pop(1)
0x984: Push((int) 0)
0x985: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x986: IF (Stack[-1] == 0) GOTO 0x990; Pop(1)

0x987: PushEmpty(int, string)
0x988: Stack[-1] = "lemon" // @poff=1017
0x989: Call2 0xa22

0x98a: Pop(1)
0x98b: Push((int) 0)
0x98c: Push((int) 1)
0x98d: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x98e: Pop(3)
0x98f: GOTO 0x9cb

0x990: Push((int) 1)
0x991: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x992: IF (Stack[-1] == 0) GOTO 0x99c; Pop(1)

0x993: PushEmpty(int, string)
0x994: Stack[-1] = "rusk" // @poff=1029
0x995: Call2 0xa22

0x996: Pop(1)
0x997: Push((int) 0)
0x998: Push((int) 1)
0x999: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x99a: Pop(3)
0x99b: GOTO 0x9cb

0x99c: Push((int) 2)
0x99d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x99e: IF (Stack[-1] == 0) GOTO 0x9a8; Pop(1)

0x99f: PushEmpty(int, string)
0x9a0: Stack[-1] = "hook" // @poff=1039
0x9a1: Call2 0xa22

0x9a2: Pop(1)
0x9a3: Push((int) 0)
0x9a4: Push((int) 1)
0x9a5: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9a6: Pop(3)
0x9a7: GOTO 0x9cb

0x9a8: Push((int) 4)
0x9a9: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9aa: IF (Stack[-1] == 0) GOTO 0x9b4; Pop(1)

0x9ab: PushEmpty(int, string)
0x9ac: Stack[-1] = "syringe" // @poff=1049
0x9ad: Call2 0xa22

0x9ae: Pop(1)
0x9af: Push((int) 0)
0x9b0: Push((int) 1)
0x9b1: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9b2: Pop(3)
0x9b3: GOTO 0x9cb

0x9b4: Push((int) 5)
0x9b5: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9b6: IF (Stack[-1] == 0) GOTO 0x9c0; Pop(1)

0x9b7: PushEmpty(int, string)
0x9b8: Stack[-1] = "watch" // @poff=1065
0x9b9: Call2 0xa22

0x9ba: Pop(1)
0x9bb: Push((int) 0)
0x9bc: Push((int) 1)
0x9bd: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9be: Pop(3)
0x9bf: GOTO 0x9cb
...
0x9c4: Stack[-1] = "razor" // @poff=1077
0x9c5: Call2 0xa22

0x9c6: Pop(1)
0x9c7: Push((int) 0)
0x9c8: Push((int) 1)
0x9c9: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9ca: Pop(3)
0x9cb: GOTO 0xa21
...
0x9d1: Pop(0)
0x9d2: Push((int) 50)
0x9d3: Pop(2); Push(Stack[-2] * Stack[-1]);
0x9d4: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x9d5: Call2 0x954

0x9d6: Pop(2)
0x9d7: Push((int) 7)
0x9d8: @ irand(Stack[-3], Stack[-1])
0x9d9: Pop(1)
0x9da: Push((int) 0)
0x9db: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9dc: IF (Stack[-1] == 0) GOTO 0x9e6; Pop(1)

0x9dd: PushEmpty(int, string)
0x9de: Stack[-1] = "beads" // @poff=1089
0x9df: Call2 0xa22

0x9e0: Pop(1)
0x9e1: Push((int) 0)
0x9e2: Push((int) 1)
0x9e3: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9e4: Pop(3)
0x9e5: GOTO 0xa21

0x9e6: Push((int) 1)
0x9e7: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9e8: IF (Stack[-1] == 0) GOTO 0x9f2; Pop(1)

0x9e9: PushEmpty(int, string)
0x9ea: Stack[-1] = "bracelet" // @poff=1101
0x9eb: Call2 0xa22

0x9ec: Pop(1)
0x9ed: Push((int) 0)
0x9ee: Push((int) 1)
0x9ef: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9f0: Pop(3)
0x9f1: GOTO 0xa21

0x9f2: Push((int) 2)
0x9f3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9f4: IF (Stack[-1] == 0) GOTO 0x9fe; Pop(1)

0x9f5: PushEmpty(int, string)
0x9f6: Stack[-1] = "ear_ring" // @poff=1119
0x9f7: Call2 0xa22

0x9f8: Pop(1)
0x9f9: Push((int) 0)
0x9fa: Push((int) 1)
0x9fb: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9fc: Pop(3)
0x9fd: GOTO 0xa21

0x9fe: Push((int) 3)
0x9ff: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xa00: IF (Stack[-1] == 0) GOTO 0xa0a; Pop(1)

0xa01: PushEmpty(int, string)
0xa02: Stack[-1] = "gold_ring" // @poff=1137
0xa03: Call2 0xa22

0xa04: Pop(1)
0xa05: Push((int) 0)
0xa06: Push((int) 1)
0xa07: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa08: Pop(3)
0xa09: GOTO 0xa21

0xa0a: Push((int) 4)
0xa0b: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xa0c: IF (Stack[-1] == 0) GOTO 0xa16; Pop(1)

0xa0d: PushEmpty(int, string)
0xa0e: Stack[-1] = "silver_ring" // @poff=1157
0xa0f: Call2 0xa22

0xa10: Pop(1)
0xa11: Push((int) 0)
0xa12: Push((int) 1)
0xa13: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa14: Pop(3)
0xa15: GOTO 0xa21

0xa16: Push((int) 5)
0xa17: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xa18: IF (Stack[-1] == 0) GOTO 0xa21; Pop(1)

0xa19: PushEmpty(int, string)
0xa1a: Stack[-1] = "flower" // @poff=1181
0xa1b: Call2 0xa22

0xa1c: Pop(1)
0xa1d: Push((int) 0)
0xa1e: Push((int) 1)
0xa1f: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa20: Pop(3)
0xa21: Return(); Pop(4)

0xa22: PushEmpty(int, int)
0xa23: @ GetInvItemByName(Stack[-1], Stack[-3])
0xa24: Pop(0)
0xa25: Stack[-1] = Stack[-4]
0xa26: Return(); Pop(2)

0xa27: PushEmpty()
0xa28: PushEmpty(object)
0xa29: Stack[-2] = Stack[-1]
0xa2a: Push(-1, 0); TaskCall(2)
0xa2b: Call2 0xc4

0xa2c: Pop(-1, 0); TaskReturn
0xa2d: Pop(1)
0xa2e: Return(); Pop(0)

0xa2f: PushEmpty(float, float)
0xa30: Push("health") // @poff=704
0xa31: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa32: IF (Stack[-1] == 0) GOTO 0xa3b; Pop(1)

0xa33: Push("health") // @poff=704
0xa34: @ GetProperty(Stack[-1], Stack[-2])
0xa35: Pop(1)
0xa36: Push((int) 0)
0xa37: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa38: IF (Stack[-1] == 0) GOTO 0xa3b; Pop(1)

0xa39: @ SignalDeath(Stack[-4])
0xa3a: Pop(0)
0xa3b: Return(); Pop(2)
...
0xa42: PushEmpty()
0xa43: PushEmpty(object, int, float)
0xa44: Stack[-7] = Stack[-3]
0xa45: Stack[-6] = Stack[-2]
0xa46: Stack[-5] = Stack[-1]
0xa47: Call2 0x7fb
...
0xa4a: PushEmpty()
0xa4b: PushEmpty(object, int, float, cvector, cvector)
0xa4c: Stack[-11] = Stack[-5]
0xa4d: Stack[-10] = Stack[-4]
0xa4e: Stack[-9] = Stack[-3]
0xa4f: Stack[-7] = Stack[-2]
...
0xa54: PushEmpty()
0xa55: Push("unholster") // @poff=1195
0xa56: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa57: IF (Stack[-1] == 0) GOTO 0xa5f; Pop(1)

0xa58: PushEmpty(bool, object)
0xa59: Stack[-4] = Stack[-1]
0xa5a: Call2 0xb16

0xa5b: Stack[-2] = Stack[-5]
0xa5c: Pop(2)
0xa5d: Return(); Pop(0)

0xa5e: GOTO 0xa72

0xa5f: Push("player_shot") // @poff=1215
0xa60: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa61: IF (Stack[-1] == 0) GOTO 0xa69; Pop(1)

0xa62: PushEmpty(bool, object)
0xa63: Stack[-4] = Stack[-1]
0xa64: Call2 0xb1b

0xa65: Stack[-2] = Stack[-5]
0xa66: Pop(2)
0xa67: Return(); Pop(0)

0xa68: GOTO 0xa72

0xa69: Push("battle") // @poff=923
0xa6a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa6b: IF (Stack[-1] == 0) GOTO 0xa72; Pop(1)

0xa6c: PushEmpty(bool, object)
0xa6d: Stack[-4] = Stack[-1]
0xa6e: Call2 0xb20

0xa6f: Stack[-2] = Stack[-5]
0xa70: Pop(2)
0xa71: Return(); Pop(0)

0xa72: Stack[-3] = (bool) 0
0xa73: Return(); Pop(0)

0xa74: PushEmpty()
0xa75: Push("unholster") // @poff=1195
0xa76: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa77: IF (Stack[-1] == 0) GOTO 0xa7d; Pop(1)
...
0xa7d: Push("player_shot") // @poff=1215
0xa7e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa7f: IF (Stack[-1] == 0) GOTO 0xa85; Pop(1)

0xa80: PushEmpty(object)
...
0xa93: Pop(1)
0xa94: IF (Stack[-1] == 0) GOTO 0xa9b; Pop(1)

0xa95: PushEmpty(bool, object)
0xa96: Stack[-6] = Stack[-1]
0xa97: Call2 0x734

0xa98: Pop(1)
0xa99: IF (Stack[-1] == 0) GOTO 0xa9b; Pop(1)

0xa9a: Stack[-1] = (bool) 1
0xa9b: IF (Stack[-1] == 0) GOTO 0xaa2; Pop(1)

0xa9c: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1239
0xa9d: Pop(0)
0xa9e: Pop(0); Push((bool) Stack[-1] == 0)
0xa9f: IF (Stack[-1] == 0) GOTO 0xaa2; Pop(1)

0xaa0: Stack[-4] = (bool) 1
0xaa1: Return(); Pop(2)

0xaa2: Stack[-4] = (bool) 0
0xaa3: Return(); Pop(2)
...
0xab2: Pop(0)
0xab3: Push((float)-0.029999999329447746)
0xab4: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0xab5: Pop(2)
0xab6: Return(); Pop(0)

0xab7: PushEmpty(object, object)
0xab8: Push("heal") // @poff=1257
0xab9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xaba: IF (Stack[-1] == 0) GOTO 0xac5; Pop(1)

0xabb: Push("player") // @poff=1267
0xabc: @ FindActor(Stack[-2], Stack[-1])
0xabd: Pop(1)
0xabe: PushEmpty(bool, object)
0xabf: Stack[-3] = Stack[-1]
0xac0: Call2 0xb25

0xac1: Stack[-2] = Stack[-6]
0xac2: Pop(2)
0xac3: Return(); Pop(2)

0xac4: Stack[-1] = 0
0xac5: Stack[-4] = (bool) 0
0xac6: Return(); Pop(2)

0xac7: PushEmpty(object, object)
0xac8: Push("heal") // @poff=1257
0xac9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xaca: IF (Stack[-1] == 0) GOTO 0xad3; Pop(1)

0xacb: Push("player") // @poff=1267
0xacc: @ FindActor(Stack[-2], Stack[-1])
0xacd: Pop(1)
0xace: PushEmpty(object)
...
0xad4: PushEmpty(string, string)
0xad5: Stack[-1] = "idle" // @poff=146
0xad6: Push(Stack[-3])
0xad7: IF (Stack[-1] == 0) GOTO 0xad9; Pop(1)

0xad8: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xad9: Stack[-1] = Stack[-4]
0xada: Return(); Pop(2)

0xadb: PushEmpty(int, bool, int, bool)
0xadc: Stack[-2] = (int) 0
0xadd: Push("all") // @poff=138
0xade: PushEmpty(string, int)
0xadf: Stack[-5] = Stack[-1]
0xae0: Call2 0xad4

0xae1: Pop(1)
0xae2: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xae3: Pop(2)
...
0xae7: Push((int) 1)
0xae8: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xae9: GOTO 0xadd
...
0xaf9: Push(-1, 6); TaskCall(5)
0xafa: Call2 0x374

0xafb: Pop(-1, 6); TaskReturn
0xafc: Pop(1)
0xafd: Return(); Pop(0)
...
0xb2a: Stack[-1] = (int) 515568
0xb2b: Return(); Pop(0)

0xb2c: Stack[-1] = (int) 503353
0xb2d: Return(); Pop(0)

0xb2e: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1281
0xb2f: Return(); Pop(0)

0xb30: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1321
0xb31: Return(); Pop(0)

0xb32: Stack[-1] = (bool) 0
0xb33: Return(); Pop(0)
...
0xb39: PushEmpty()
0xb3a: PushEmpty(int, object)
0xb3b: Stack[-3] = Stack[-1]
0xb3c: Push(-2, 1); TaskCall(0)
0xb3d: Call2 0x0

0xb3e: Pop(-2, 1); TaskReturn
0xb3f: Pop(2)
0xb40: Return(); Pop(0)

0xb41: PushEmpty()
0xb42: Stack[-4] = (bool) 0
0xb43: Return(); Pop(0)
