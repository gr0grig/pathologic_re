...
Strings:
	...
	W:all
	W:idle
// @pool_raw:63006c00650061006e0075007000000061006c006c000000690064006c0065000000
...
0x6a: Pop(0)
0x6b: Push("all") // @poff=16
0x6c: PushEmpty(string, int)
0x6d: Stack[-7] = Stack[-1]
0x6e: Call2 0xa4
