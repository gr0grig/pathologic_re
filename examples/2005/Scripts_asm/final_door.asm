...
Strings:
	...
	W:door_closed
	W:Door is locked
// @pool_raw:6f006e00200075007300650000006f00700065006e00000074007200690067006700650072002000000070006c006100790065007200000064006f006f0072005f0063006c006f00730065006400000044006f006f00720020006900730020006c006f0063006b00650064000000
...
0x28: Push("door_closed") // @poff=56
0x29: @ PlaySound(Stack[-1])
0x2a: Pop(1)
0x2b: Push("Door is locked") // @poff=80
0x2c: @ Trace(Stack[-1])
0x2d: Pop(1)
0x2e: Return(); Pop(4)
...
0x50: IF (Stack[-1] == 1) GOTO 0x58; Pop(1)

0x51: PushEmpty(bool, object)
0x52: Stack[-6] = Stack[-1]
0x53: Call2 0x60

0x54: Pop(1)
0x55: Pop(1); Push((bool) Stack[-1] == 0)
0x56: IF (Stack[-1] == 1) GOTO 0x58; Pop(1)
