...
Strings:
	...
	W:voice
	W:whiten
	W:final_theater_cam.mot
	W:exit
// @pool_raw:76006f006900630065007300000076006f006900630065000000770068006900740065006e000000660069006e0061006c005f0074006800650061007400650072005f00630061006d002e006d006f007400000065007800690074000000
...
0x13: Pop(0)
0x14: Push("final_theater_cam.mot") // @poff=40
...
0x28: IF (Stack[-1] == 1) GOTO 0x1a; Pop(1)
...
0x2d: Pop(0)
0x2e: Push("exit") // @poff=84
0x2f: @ TriggerWorld(Stack[-1])
0x30: Pop(1)
0x31: Return(); Pop(4)

0x32: Push((float)0.5)
0x33: Push((float)0.8859999775886536)
