...
Strings:
	...
	W:GetCurrentRegion
	A:GetCurrentRegion
// @pool_raw:
...
0x95: Stack[-7] = Stack[-1]
0x96: Call2 0xd1

0x97: Stack[-2] = Stack[-4]
0x98: Pop(2)
...
0x11e: Stack[-17] = Stack[-7]
0x11f: PushEmpty(bool, object)
0x120: Stack[-23] = Stack[-1]
0x121: Call2 0x114
...
0x127: @@ GetPosition(Stack[-5]); Obj=21 // @poff=42
0x128: Pop(0)
...
0x13e: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=14
0x13f: Pop(0)
...
0x150: Push((int) 0)
0x151: Push((float)0.30000001192092896)
...
0x173: Push((int) 0)
0x174: Push((float)0.30000001192092896)
...
0x1a7: Stack[-1] = "walk" // @poff=54
0x1a8: Return(); Pop(0)

0x1a9: Stack[-1] = "run" // @poff=64
0x1aa: Return(); Pop(0)
...
0x1c9: @@ GetPosition(Stack[-1]); Obj=3 // @poff=42
0x1ca: Pop(0)
0x1cb: Stack[-1] = Stack[-4]
0x1cc: Return(); Pop(2)

0x1cd: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x1ce: @ GetPosition(Stack[-3])
0x1cf: Pop(0)
0x1d0: @@ GetPosition(Stack[-2]); Obj=7 // @poff=42
0x1d1: Pop(0)
...
0x1e2: Push("HasProperty") // @poff=86
0x1e3: Push((int) 2)
...
0x1e9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=110
0x1ea: Pop(0)
0x1eb: Stack[-1] = Stack[-5]
0x1ec: Return(); Pop(2)

0x1ed: PushEmpty(float, float)
0x1ee: PushEmpty(bool, object, string)
0x1ef: Stack[-10] = Stack[-2]
0x1f0: Stack[-9] = Stack[-1]
0x1f1: Call2 0x1e1
...
0x1f7: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=122
0x1f8: Pop(0)
0x1f9: PushEmpty(float, float, float, float)
0x1fa: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x1fb: Stack[-8] = Stack[-2]
0x1fc: Stack[-7] = Stack[-1]
0x1fd: Call2 0x293

0x1fe: Pop(3)
0x1ff: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=134
0x200: Pop(1)
...
0x205: Stack[-9] = Stack[-2]
0x206: Stack[-1] = "disease" // @poff=146
0x207: Call2 0x1e1
...
0x20f: Stack[-9] = Stack[-2]
0x210: Stack[-1] = "armor_disease" // @poff=162
0x211: Call2 0x1e1

0x212: Pop(2)
0x213: IF (Stack[-1] == 0) GOTO 0x219; Pop(1)

0x214: Push("armor_disease") // @poff=162
0x215: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=122
0x216: Pop(1)
0x217: Push((int) 100)
0x218: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x219: PushEmpty(bool, object, string)
0x21a: Stack[-9] = Stack[-2]
0x21b: Stack[-1] = "immunity" // @poff=190
0x21c: Call2 0x1e1

0x21d: Pop(2)
0x21e: IF (Stack[-1] == 0) GOTO 0x22b; Pop(1)

0x21f: Push("immunity") // @poff=190
0x220: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=122
0x221: Pop(1)
0x222: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x223: PushEmpty(bool, object, string, float, float, float)
0x224: Stack[-12] = Stack[-5]
0x225: Stack[-4] = "immunity" // @poff=190
...
0x236: Stack[-12] = Stack[-5]
0x237: Stack[-4] = "disease" // @poff=146
0x238: Stack[-11] = Stack[-3]
0x239: Stack[-2] = (int) 0
0x23a: Stack[-1] = (int) 1
0x23b: Call2 0x1ed
...
0x245: Pop(1)
0x246: Stack[-5] = Stack[-7]
0x247: Return(); Pop(4)

0x248: PushEmpty(bool, bool)
0x249: @@ IsDead(Stack[-1]); Obj=3 // @poff=208
0x24a: Pop(0)
0x24b: Stack[-1] = Stack[-4]
0x24c: Return(); Pop(2)

0x24d: PushEmpty(object, object, object, object)
0x24e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x262: Pop(0)
0x263: Pop(0); PushNull((bool) Stack[-2] == 0)
0x264: IF (Stack[-1] == 0) GOTO 0x267; Pop(1)

0x265: Stack[-6] = (bool) 0
0x266: Return(); Pop(4)

0x267: @@ GetScene(Stack[-1]); Obj=5 // @poff=229
0x268: Pop(0)
...
0x27b: Stack[-6] = Stack[-2]
0x27c: Stack[-1] = "noaccess" // @poff=238
0x27d: Call2 0x1e1
...
0x283: Push("noaccess") // @poff=238
0x284: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=122
0x285: Pop(1)
0x286: Push((int) 0)
...
0x2d3: Push("GetCurrentRegion") // @poff=260
0x2d4: Push((int) 1)
...
0x2d9: @@ GetCurrentRegion(Stack[-1]); Obj=2 // @poff=294
0x2da: Pop(0)
