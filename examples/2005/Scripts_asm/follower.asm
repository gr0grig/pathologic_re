...
Strings:
	...
	W:frun
	W:fwalk
// @pool_raw:
...
0x52: Stack[-17] = Stack[-7]
0x53: PushEmpty(bool, object)
0x54: Stack[-23] = Stack[-1]
0x55: Call2 0xdb
...
0x5b: @@ GetPosition(Stack[-5]); Obj=21 // @poff=34
0x5c: Pop(0)
...
0x72: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=46
0x73: Pop(0)
...
0x84: Push((int) 0)
0x85: Push((float)0.30000001192092896)
...
0xa7: Push((int) 0)
0xa8: Push((float)0.30000001192092896)
...
0xdf: Stack[-2] = Stack[-4]
0xe0: Pop(2)
0xe1: Return(); Pop(0)

0xe2: Stack[-1] = "walk" // @poff=60
0xe3: Return(); Pop(0)

0xe4: Stack[-1] = "run" // @poff=70
0xe5: Return(); Pop(0)

0xe6: Push("Waiting for your orders!") // @poff=78
0xe7: @ Trace(Stack[-1])
0xe8: Pop(1)
0xe9: @ Hold()
0xea: Pop(0)
0xeb: Push("Following you!") // @poff=128
0xec: @ Trace(Stack[-1])
0xed: Pop(1)
0xee: Return(); Pop(0)

0xef: PushEmpty()
0xf0: Push("fgo") // @poff=26
...
0xfd: Push("HasProperty") // @poff=158
0xfe: Push((int) 2)
...
0x104: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=182
0x105: Pop(0)
0x106: Stack[-1] = Stack[-5]
0x107: Return(); Pop(2)

0x108: PushEmpty(bool, bool)
0x109: @@ IsDead(Stack[-1]); Obj=3 // @poff=194
0x10a: Pop(0)
0x10b: Stack[-1] = Stack[-4]
0x10c: Return(); Pop(2)

0x10d: PushEmpty(object, object, object, object)
0x10e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x122: Pop(0)
0x123: Pop(0); PushNull((bool) Stack[-2] == 0)
0x124: IF (Stack[-1] == 0) GOTO 0x127; Pop(1)

0x125: Stack[-6] = (bool) 0
0x126: Return(); Pop(4)

0x127: @@ GetScene(Stack[-1]); Obj=5 // @poff=215
0x128: Pop(0)
...
0x13b: Stack[-6] = Stack[-2]
0x13c: Stack[-1] = "noaccess" // @poff=224
0x13d: Call2 0xfc
...
0x143: Push("noaccess") // @poff=224
0x144: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=242
0x145: Pop(1)
0x146: Push((int) 0)
