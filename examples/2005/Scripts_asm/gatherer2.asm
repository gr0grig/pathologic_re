...
// @pool_raw:
...
0x57f: Stack[-1] = "grass_black_tvir" // @poff=370
0x580: Call2 0x59e
...
0x58b: Stack[-1] = "grass_blood_tvir" // @poff=404
0x58c: Call2 0x59e
...
0x590: Pop(2)
0x591: Push((int) 15)
0x592: @ irand(Stack[-2], Stack[-1])
0x593: Pop(1)
0x594: Push((int) 5)
0x595: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x596: PushEmpty(int, string)
0x597: Stack[-1] = "grass_brown_tvir" // @poff=438
0x598: Call2 0x59e

0x599: Pop(1)
0x59a: Push((int) 0)
0x59b: @ AddItem(Stack[-4], Stack[-2], Stack[-1], Stack[-3])
0x59c: Pop(2)
0x59d: Return(); Pop(4)

0x59e: PushEmpty(int, int)
0x59f: @ GetInvItemByName(Stack[-1], Stack[-3])
0x5a0: Pop(0)
0x5a1: Stack[-1] = Stack[-4]
0x5a2: Return(); Pop(2)

0x5a3: PushEmpty(int, int)
0x5a4: Push("branch") // @poff=472
0x5a5: @ GetVariable(Stack[-1], Stack[-2])
0x5a6: Pop(1)
0x5a7: Push((int) 0)
...
0x5b4: PushEmpty(int, int)
0x5b5: Push("branch") // @poff=472
0x5b6: @ GetVariable(Stack[-1], Stack[-2])
0x5b7: Pop(1)
0x5b8: Stack[-1] = Stack[-3]
0x5b9: Return(); Pop(2)

0x5ba: Stack[-1] = (int) 521048
0x5bb: Return(); Pop(0)

0x5bc: Stack[-1] = (int) 521047
0x5bd: Return(); Pop(0)

0x5be: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=486
0x5bf: Return(); Pop(0)

0x5c0: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=526
0x5c1: Return(); Pop(0)
