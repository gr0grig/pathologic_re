...
Strings:
	...
	W:revolver_ammo
	W:samopal_ammo
// @pool_raw:
...
0x7e6: Pop(0)
0x7e7: Push((float)-0.05000000074505806)
...
0x90d: Stack[-4] = "alpha_pills" // @poff=448
0x90e: Stack[-3] = (int) 1
0x90f: Stack[-2] = (int) 2
0x910: Stack[-1] = (int) 4
0x911: Call2 0x727
...
0x914: Stack[-4] = "meradorm" // @poff=472
0x915: Stack[-3] = (int) 2
0x916: Stack[-2] = (int) 3
0x917: Stack[-1] = (int) 3
0x918: Call2 0x727
...
0x91e: Stack[-3] = "beta_pills" // @poff=490
0x91f: Stack[-2] = (int) 1
0x920: Stack[-1] = (int) 4
0x921: Call2 0x71c
...
0x927: Stack[-4] = "monomicin" // @poff=512
0x928: Stack[-3] = (int) 1
0x929: Stack[-2] = (int) 2
0x92a: Stack[-1] = (int) 2
0x92b: Call2 0x727
...
0x932: Stack[-3] = "monomicin" // @poff=512
0x933: Stack[-2] = (int) 1
0x934: Stack[-1] = (int) 2
0x935: Call2 0x71c
...
0x939: Stack[-3] = "lockpick" // @poff=532
0x93a: Stack[-2] = (int) 1
0x93b: Stack[-1] = (int) 4
0x93c: Call2 0x71c
...
0x93f: Stack[-3] = "rifle_ammo" // @poff=550
0x940: Stack[-2] = (int) 1
0x941: Stack[-1] = (int) 2
0x942: Call2 0x71c
...
0x945: Stack[-3] = "revolver_ammo" // @poff=572
0x946: Stack[-2] = (int) 1
0x947: Stack[-1] = (int) 2
0x948: Call2 0x71c
...
0x94b: Stack[-4] = "samopal_ammo" // @poff=600
0x94c: Stack[-3] = (int) 1
0x94d: Stack[-2] = (int) 2
0x94e: Stack[-1] = (int) 2
0x94f: Call2 0x727
...
0x955: Stack[-4] = "monomicin" // @poff=512
0x956: Stack[-3] = (int) 1
0x957: Stack[-2] = (int) 2
0x958: Stack[-1] = (int) 2
0x959: Call2 0x727
...
0x960: Stack[-3] = "monomicin" // @poff=512
0x961: Stack[-2] = (int) 1
0x962: Stack[-1] = (int) 2
0x963: Call2 0x71c
