...
0x761: Stack[-2] = Stack[-5]
0x762: Pop(2)
0x763: Return(); Pop(0)

0x764: GOTO 0x778

0x765: Push("player_shot") // @poff=809
...
0x76b: Stack[-2] = Stack[-5]
0x76c: Pop(2)
0x76d: Return(); Pop(0)

0x76e: GOTO 0x778

0x76f: Push("battle") // @poff=775
...
0x7a2: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=833
0x7a3: Pop(0)
...
0x7f0: Push("GenerateMoney: iMin > iMax") // @poff=889
0x7f1: @ Trace(Stack[-1])
0x7f2: Pop(1)
0x7f3: Return(); Pop(4)
...
0x80e: Pop(0)
0x80f: @@ SetItemName(Stack[-7]); Obj=3 // @poff=955
0x810: Pop(0)
0x811: Push("Organ") // @poff=967
0x812: Push((int) 1)
0x813: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x814: Pop(2)
0x815: @@ GetItemID(Stack[-2]); Obj=3 // @poff=979
0x816: Pop(0)
0x817: Push((int) 0)
0x818: Push((int) 1)
...
0x825: Stack[-1] = "liver" // @poff=989
0x826: Call2 0x80c

0x827: Pop(1)
0x828: PushEmpty(string)
0x829: Stack[-1] = "kidney" // @poff=1001
0x82a: Call2 0x80c

0x82b: Pop(1)
0x82c: PushEmpty(string)
0x82d: Stack[-1] = "heart" // @poff=1015
0x82e: Call2 0x80c

0x82f: Pop(1)
0x830: PushEmpty(string)
0x831: Stack[-1] = "blood" // @poff=1027
0x832: Call2 0x80c
...
0x845: Stack[-3] = "tourniquet" // @poff=1039
0x846: Stack[-2] = (int) 1
...
0x84b: Stack[-3] = "bandage" // @poff=1061
0x84c: Stack[-2] = (int) 1
...
0x851: Stack[-3] = "bottle_empty" // @poff=1077
0x852: Stack[-2] = (int) 1
0x853: Stack[-1] = (int) 2
0x854: Call2 0x6d4
...
0x857: Stack[-3] = "tvirin" // @poff=1103
0x858: Stack[-2] = (int) 1
0x859: Stack[-1] = (int) 8
0x85a: Call2 0x6d4
...
0x85f: Pop(0)
0x860: Stack[-1] = Stack[-4]
0x861: Return(); Pop(2)

0x862: PushEmpty()
0x863: PushEmpty(object)
0x864: Stack[-2] = Stack[-1]
...
0x887: Stack[-11] = Stack[-5]
0x888: Stack[-10] = Stack[-4]
0x889: Stack[-9] = Stack[-3]
0x88a: Stack[-7] = Stack[-2]
0x88b: Stack[-6] = Stack[-1]
0x88c: Call2 0x6ab
...
0x897: Stack[-2] = (int) 0
0x898: Push("all") // @poff=170
0x899: PushEmpty(string, int)
0x89a: Stack[-5] = Stack[-1]
0x89b: Call2 0x88f
...
0x8a5: Stack[-2] = Stack[-5]
0x8a6: Return(); Pop(4)

0x8a7: Push("head") // @poff=160
...
0x931: Stack[-9] = Stack[-2]
0x932: Stack[-1] = "class" // @poff=1127
0x933: Call2 0x5a5
...
0x939: Push("class") // @poff=1127
0x93a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=582
0x93b: Pop(1)
0x93c: Push("guard") // @poff=1139
...
0x945: Push(Stack[-2])
0x946: IF (Stack[-1] == 1) GOTO 0x94f; Pop(1)

0x947: PushEmpty(float, object)
0x948: Stack[-10] = Stack[-1]
0x949: Call2 0x598

0x94a: Pop(1)
0x94b: Push((float)1000000.0)
0x94c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x94d: IF (Stack[-1] == 1) GOTO 0x94f; Pop(1)
...
0x966: Pop(0)
0x967: Push((float)-0.029999999329447746)
0x968: Push((bool) 1)
