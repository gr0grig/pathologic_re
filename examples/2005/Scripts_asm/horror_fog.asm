...
Strings:
	...
	W:noaccess
	A:add
// @pool_raw:
...
0x127: Push("HasProperty") // @poff=86
0x128: Push((int) 2)
...
0x12e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=110
0x12f: Pop(0)
0x130: Stack[-1] = Stack[-5]
0x131: Return(); Pop(2)

0x132: PushEmpty(float, float)
0x133: PushEmpty(bool, object, string)
0x134: Stack[-10] = Stack[-2]
0x135: Stack[-9] = Stack[-1]
0x136: Call2 0x126
...
0x13c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=122
0x13d: Pop(0)
0x13e: PushEmpty(float, float, float, float)
0x13f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x140: Stack[-8] = Stack[-2]
0x141: Stack[-7] = Stack[-1]
0x142: Call2 0x1d8

0x143: Pop(3)
0x144: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=134
0x145: Pop(1)
...
0x14a: Stack[-9] = Stack[-2]
0x14b: Stack[-1] = "disease" // @poff=146
0x14c: Call2 0x126
...
0x155: Stack[-1] = "armor_disease" // @poff=162
0x156: Call2 0x126

0x157: Pop(2)
0x158: IF (Stack[-1] == 0) GOTO 0x15e; Pop(1)

0x159: Push("armor_disease") // @poff=162
0x15a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=122
0x15b: Pop(1)
0x15c: Push((int) 100)
0x15d: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x15e: PushEmpty(bool, object, string)
0x15f: Stack[-9] = Stack[-2]
0x160: Stack[-1] = "immunity" // @poff=190
0x161: Call2 0x126

0x162: Pop(2)
0x163: IF (Stack[-1] == 0) GOTO 0x170; Pop(1)

0x164: Push("immunity") // @poff=190
0x165: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=122
0x166: Pop(1)
0x167: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x168: PushEmpty(bool, object, string, float, float, float)
0x169: Stack[-12] = Stack[-5]
0x16a: Stack[-4] = "immunity" // @poff=190
...
0x17b: Stack[-12] = Stack[-5]
0x17c: Stack[-4] = "disease" // @poff=146
0x17d: Stack[-11] = Stack[-3]
0x17e: Stack[-2] = (int) 0
0x17f: Stack[-1] = (int) 1
0x180: Call2 0x132
...
0x188: Stack[-6] = Stack[-1]
0x189: Call2 0x1e3

0x18a: Pop(1)
0x18b: Stack[-5] = Stack[-7]
0x18c: Return(); Pop(4)

0x18d: PushEmpty(bool, bool)
0x18e: @@ IsDead(Stack[-1]); Obj=3 // @poff=208
0x18f: Pop(0)
0x190: Stack[-1] = Stack[-4]
0x191: Return(); Pop(2)

0x192: PushEmpty(object, object, object, object)
0x193: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x1a7: Pop(0)
0x1a8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1a9: IF (Stack[-1] == 0) GOTO 0x1ac; Pop(1)

0x1aa: Stack[-6] = (bool) 0
0x1ab: Return(); Pop(4)

0x1ac: @@ GetScene(Stack[-1]); Obj=5 // @poff=229
0x1ad: Pop(0)
...
0x1c0: Stack[-6] = Stack[-2]
0x1c1: Stack[-1] = "noaccess" // @poff=238
0x1c2: Call2 0x126
...
0x1c8: Push("noaccess") // @poff=238
0x1c9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=122
0x1ca: Pop(1)
0x1cb: Push((int) 0)
...
0x1e5: Pop(0)
0x1e6: @@ add(Stack[-3]); Obj=1 // @poff=256
0x1e7: Pop(0)
0x1e8: Push((int) 14)
