...
Strings:
	...
	W:lockpick
	W:hunter_mark
// @pool_raw:
...
EVENT_43 Op = 0x770 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x77a Vars = (object, string)
EVENT_41 Op = 0x787 Vars = (object)
...
0x4d1: Stack[-2] = "bullet" // @poff=544
0x4d2: Return(); Pop(0)

0x4d3: Stack[-2] = "phys" // @poff=558
0x4d4: Return(); Pop(0)

0x4d5: PushEmpty(cvector, cvector, cvector, cvector)
0x4d6: @ GetPosition(Stack[-2])
0x4d7: Pop(0)
0x4d8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x4d9: Pop(0)
...
0x4e2: Push("HasProperty") // @poff=568
0x4e3: Push((int) 2)
...
0x4e9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=592
0x4ea: Pop(0)
0x4eb: Stack[-1] = Stack[-5]
0x4ec: Return(); Pop(2)

0x4ed: PushEmpty(float, float)
0x4ee: PushEmpty(bool, object, string)
0x4ef: Stack[-10] = Stack[-2]
0x4f0: Stack[-9] = Stack[-1]
0x4f1: Call2 0x4e1
...
0x4f7: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=604
0x4f8: Pop(0)
0x4f9: PushEmpty(float, float, float, float)
0x4fa: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4fb: Stack[-8] = Stack[-2]
0x4fc: Stack[-7] = Stack[-1]
0x4fd: Call2 0x66c

0x4fe: Pop(3)
0x4ff: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=616
0x500: Pop(1)
...
0x505: Stack[-18] = Stack[-2]
0x506: Stack[-1] = "health" // @poff=628
0x507: Call2 0x4e1
...
0x50e: Stack[-18] = Stack[-2]
0x50f: Stack[-1] = "armor" // @poff=642
0x510: Call2 0x4e1
...
0x516: Push("armor") // @poff=642
0x517: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=604
0x518: Pop(1)
0x519: Push("armor_") // @poff=654
...
0x520: Stack[-18] = Stack[-2]
0x521: Stack[-8] = Stack[-1]
0x522: Call2 0x4e1
...
0x528: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=604
0x529: Pop(0)
...
0x530: Stack[-3] = Stack[-6]
0x531: Pop(3)
0x532: Push("health") // @poff=628
0x533: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=604
0x534: Pop(1)
0x535: Push((int) 1)
0x536: Pop(1); Push(Stack[-1] - Stack[-4]);
0x537: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x538: Push("health") // @poff=628
...
0x53e: Pop(3)
0x53f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=616
0x540: Pop(2)
0x541: PushEmpty(bool, object)
0x542: Stack[-17] = Stack[-1]
0x543: Call2 0x4dc
...
0x549: Pop(1)
0x54a: Stack[-1] = Stack[-16]
0x54b: Return(); Pop(12)

0x54c: PushEmpty(bool, bool)
0x54d: @@ IsDead(Stack[-1]); Obj=3 // @poff=668
0x54e: Pop(0)
0x54f: Stack[-1] = Stack[-4]
0x550: Return(); Pop(2)

0x551: PushEmpty(object, object, object, object)
0x552: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x566: Pop(0)
0x567: Pop(0); PushNull((bool) Stack[-2] == 0)
0x568: IF (Stack[-1] == 0) GOTO 0x56b; Pop(1)

0x569: Stack[-6] = (bool) 0
0x56a: Return(); Pop(4)

0x56b: @@ GetScene(Stack[-1]); Obj=5 // @poff=689
0x56c: Pop(0)
...
0x57f: Stack[-6] = Stack[-2]
0x580: Stack[-1] = "noaccess" // @poff=698
0x581: Call2 0x4e1
...
0x587: Push("noaccess") // @poff=698
0x588: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=604
0x589: Pop(1)
0x58a: Push((int) 0)
...
0x58e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x59c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x59d: Pop(0)
...
0x5ad: Stack[-1] = "fhit" // @poff=716
0x5ae: GOTO 0x5b0

0x5af: Stack[-1] = "bhit" // @poff=726
0x5b0: Push("hit_react") // @poff=736
0x5b1: Push("1") // @poff=218
0x5b2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5b3: Push("2") // @poff=230
...
0x5cc: Stack[-25] = Stack[-1]
0x5cd: Call2 0x4d5

0x5ce: Stack[-2] = Stack[-3]
0x5cf: Pop(2)
0x5d0: Call2 0x65b

0x5d1: Stack[-2] = Stack[-11]
0x5d2: Pop(2)
0x5d3: @ CreateVectorVector(Stack[-8])
0x5d4: Pop(0)
0x5d5: Stack[-7] = (int) 1
0x5d6: Push("hit") // @poff=718
...
0x5eb: Pop(0)
0x5ec: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=765
0x5ed: Pop(0)
0x5ee: PushEmpty(object, int, float, cvector, cvector)
0x5ef: Stack[-26] = Stack[-5]
0x5f0: Stack[-25] = Stack[-4]
0x5f1: Stack[-24] = Stack[-3]
0x5f2: Stack[-6] = Stack[-2]
...
0x60c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x60d: Pop(0)
...
0x617: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x618: Pop(0)
0x619: Stack[-1] = [0.0, 0.0, 0.0]
0x61a: Push(CvectorIndex(Stack[-1], 1))
0x61b: Stack[-3] = Stack[-1]
0x61c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x61d: Push("head") // @poff=160
...
0x623: Stack[-7] = Stack[-2]
0x624: Stack[-6] = Stack[-1]
0x625: Call2 0x67c
...
0x697: Stack[-2] = Stack[-1]
0x698: Call2 0x6ae

0x699: Pop(1)
0x69a: PushEmpty(bool, object, string, float, float, float)
0x69b: Stack[-8] = Stack[-5]
0x69c: Stack[-4] = "reputation" // @poff=815
0x69d: Stack[-7] = Stack[-3]
0x69e: Stack[-2] = (int) 0
0x69f: Stack[-1] = (int) 1
0x6a0: Call2 0x4ed
...
0x6a6: Pop(0)
0x6a7: @@ add(Stack[-3]); Obj=1 // @poff=756
0x6a8: Pop(0)
0x6a9: Push((int) 15)
0x6aa: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6ab: Pop(1)
0x6ac: Return(); Pop(2)

0x6ad: Stack[-1] = 0
0x6ae: PushEmpty(object, object)
0x6af: @ CreateFloatVector(Stack[-1])
0x6b0: Pop(0)
0x6b1: @@ add(Stack[-3]); Obj=1 // @poff=756
0x6b2: Pop(0)
0x6b3: Push((int) 16)
0x6b4: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6b5: Pop(1)
0x6b6: Return(); Pop(2)

0x6b7: Stack[-1] = 0
0x6b8: PushEmpty(bool, bool)
0x6b9: @ IsPlayerActor(Stack[-3], Stack[-1])
0x6ba: Pop(0)
0x6bb: Push(Stack[-1])
0x6bc: IF (Stack[-1] == 0) GOTO 0x6c0; Pop(1)

0x6bd: Push("attack") // @poff=300
0x6be: @ PlayGlobalMusic(Stack[-1])
0x6bf: Pop(1)
0x6c0: Return(); Pop(2)

0x6c1: PushEmpty(object, object)
0x6c2: @ GetScene(Stack[-1])
0x6c3: Pop(0)
0x6c4: Push("battle") // @poff=837
0x6c5: PushEmpty(object)
0x6c6: Call2 0x655

0x6c7: Pop(0)
0x6c8: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x6c9: Pop(2)
0x6ca: Return(); Pop(2)

0x6cb: Stack[-1] = 0
0x6cc: PushEmpty(int, int)
0x6cd: Push("branch") // @poff=851
0x6ce: @ GetVariable(Stack[-1], Stack[-2])
0x6cf: Pop(1)
0x6d0: Stack[-1] = Stack[-3]
0x6d1: Return(); Pop(2)
...
0x6d9: @ WorkWithCorpse(Stack[-1])
0x6da: Pop(0)
0x6db: GOTO 0x6de

0x6dc: @ Barter(Stack[-1])
0x6dd: Pop(0)
0x6de: Return(); Pop(0)

0x6df: PushEmpty(int, bool, int, bool)
0x6e0: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x6e1: IF (Stack[-1] == 0) GOTO 0x6e6; Pop(1)

0x6e2: Push("GenerateMoney: iMin > iMax") // @poff=865
0x6e3: @ Trace(Stack[-1])
0x6e4: Pop(1)
0x6e5: Return(); Pop(4)
...
0x6e9: Pop(0); Push(Stack[-5] - Stack[-6]);
0x6ea: @ irand(Stack[-3], Stack[-1])
0x6eb: Pop(1)
0x6ec: GOTO 0x6f1

0x6ed: Push((int) 0)
0x6ee: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6ef: IF (Stack[-1] == 0) GOTO 0x6f1; Pop(1)

0x6f0: Return(); Pop(4)

0x6f1: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x6f2: Push((int) 0)
...
0x6f6: PushEmpty(int, string)
0x6f7: Stack[-1] = "Money" // @poff=919
0x6f8: Call2 0x751

0x6f9: Pop(1)
0x6fa: Push((int) 0)
0x6fb: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x6fc: Pop(2)
0x6fd: Return(); Pop(4)

0x6fe: PushEmpty(object, int, bool, object, int, bool)
0x6ff: @ CreateInvItem(Stack[-3])
0x700: Pop(0)
0x701: @@ SetItemName(Stack[-7]); Obj=3 // @poff=931
0x702: Pop(0)
0x703: Push("Organ") // @poff=943
0x704: Push((int) 1)
0x705: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=616
0x706: Pop(2)
0x707: @@ GetItemID(Stack[-2]); Obj=3 // @poff=955
0x708: Pop(0)
0x709: Push((int) 0)
0x70a: Push((int) 1)
0x70b: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x70c: Pop(2)
0x70d: Return(); Pop(6)
...
0x717: Stack[-1] = "liver" // @poff=965
0x718: Call2 0x6fe

0x719: Pop(1)
0x71a: PushEmpty(string)
0x71b: Stack[-1] = "kidney" // @poff=977
0x71c: Call2 0x6fe

0x71d: Pop(1)
0x71e: PushEmpty(string)
0x71f: Stack[-1] = "heart" // @poff=991
0x720: Call2 0x6fe

0x721: Pop(1)
0x722: PushEmpty(string)
0x723: Stack[-1] = "blood" // @poff=1003
0x724: Call2 0x6fe
...
0x728: Push((int) 0)
0x729: @ ClearSubContainer(Stack[-1])
0x72a: Pop(1)
0x72b: PushEmpty(int, int)
0x72c: Stack[-2] = (int) 200
0x72d: Stack[-1] = (int) 500
0x72e: Call2 0x6df

0x72f: Pop(2)
0x730: PushEmpty(string, int, int)
0x731: Stack[-3] = "revolver_ammo" // @poff=1015
0x732: Stack[-2] = (int) 1
0x733: Stack[-1] = (int) 80
0x734: Call2 0x621

0x735: Pop(3)
0x736: PushEmpty(string, int, int)
0x737: Stack[-3] = "samopal_ammo" // @poff=1043
0x738: Stack[-2] = (int) 1
0x739: Stack[-1] = (int) 80
0x73a: Call2 0x621

0x73b: Pop(3)
0x73c: PushEmpty(string, int, int)
0x73d: Stack[-3] = "rifle_ammo" // @poff=1069
0x73e: Stack[-2] = (int) 1
0x73f: Stack[-1] = (int) 80
0x740: Call2 0x621

0x741: Pop(3)
0x742: PushEmpty(string, int, int)
0x743: Stack[-3] = "lockpick" // @poff=1091
0x744: Stack[-2] = (int) 1
0x745: Stack[-1] = (int) 80
0x746: Call2 0x621

0x747: Pop(3)
0x748: PushEmpty(int, string)
0x749: Stack[-1] = "hunter_mark" // @poff=1109
0x74a: Call2 0x751
...
0x751: PushEmpty(int, int)
0x752: @ GetInvItemByName(Stack[-1], Stack[-3])
0x753: Pop(0)
0x754: Stack[-1] = Stack[-4]
0x755: Return(); Pop(2)
...
0x75c: PushEmpty(bool, object, float)
0x75d: Stack[-4] = Stack[-2]
0x75e: Stack[-1] = (float) 0.05000000074505806
0x75f: Call2 0x681

0x760: Pop(3)
0x761: PushEmpty(object)
0x762: Stack[-2] = Stack[-1]
0x763: Push(-1, 0); TaskCall(0)
0x764: Call2 0x0
...
0x76a: Stack[-7] = Stack[-3]
0x76b: Stack[-6] = Stack[-2]
0x76c: Stack[-5] = Stack[-1]
0x76d: Call2 0x5b9
...
0x770: PushEmpty()
0x771: PushEmpty(object, int, float, cvector, cvector)
0x772: Stack[-11] = Stack[-5]
0x773: Stack[-10] = Stack[-4]
0x774: Stack[-9] = Stack[-3]
0x775: Stack[-7] = Stack[-2]
...
0x77a: PushEmpty(float, float)
0x77b: Push("health") // @poff=628
0x77c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x77d: IF (Stack[-1] == 0) GOTO 0x786; Pop(1)

0x77e: Push("health") // @poff=628
0x77f: @ GetProperty(Stack[-1], Stack[-2])
0x780: Pop(1)
0x781: Push((int) 0)
0x782: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x783: IF (Stack[-1] == 0) GOTO 0x786; Pop(1)

0x784: @ SignalDeath(Stack[-4])
0x785: Pop(0)
0x786: Return(); Pop(2)

0x787: PushEmpty()
0x788: PushEmpty(object)
0x789: Stack[-2] = Stack[-1]
0x78a: Call2 0x756
