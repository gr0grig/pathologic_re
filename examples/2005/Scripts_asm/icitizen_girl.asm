...
Strings:
	...
	W:ToDie
// @pool_raw:
...
0x1427: PushEmpty()
0x1428: Stack[-2] = (int) 2
0x1429: Return(); Pop(0)

0x142a: PushEmpty()
0x142b: PushEmpty(object)
0x142c: Stack[-2] = Stack[-1]
0x142d: Call2 0x162d
...
0x1431: PushEmpty(bool, bool)
0x1432: Push("Received steal") // @poff=550
0x1433: @ Trace(Stack[-1])
0x1434: Pop(1)
0x1435: @ CanSee(Stack[-1], Stack[-3])
0x1436: Pop(0)
0x1437: Push(Stack[-1])
0x1438: IF (Stack[-1] == 0) GOTO 0x143f; Pop(1)

0x1439: PushEmpty(int, object)
0x143a: Stack[-5] = Stack[-1]
0x143b: Call2 0x13c1

0x143c: Stack[-2] = Stack[-6]
0x143d: Pop(2)
0x143e: Return(); Pop(2)

0x143f: Stack[-4] = (int) 0
0x1440: Return(); Pop(2)
...
0x144c: PushEmpty(bool, bool)
0x144d: @ CanSee(Stack[-1], Stack[-3])
0x144e: Pop(0)
0x144f: Stack[-1] = Stack[-4]
0x1450: Return(); Pop(2)

0x1451: PushEmpty()
0x1452: PushEmpty(object)
0x1453: Stack[-2] = Stack[-1]
0x1454: Push(-1, 3); TaskCall(6)
0x1455: Call2 0x564

0x1456: Pop(-1, 3); TaskReturn
0x1457: Pop(1)
0x1458: Return(); Pop(0)

0x1459: PushEmpty(bool, bool)
0x145a: @ CanSee(Stack[-1], Stack[-3])
0x145b: Pop(0)
0x145c: Stack[-4] = (bool) 1
0x145d: Push(Stack[-1])
0x145e: IF (Stack[-1] == 1) GOTO 0x1467; Pop(1)

0x145f: PushEmpty(float, object)
0x1460: Stack[-5] = Stack[-1]
0x1461: Call2 0x1186

0x1462: Pop(1)
0x1463: Push((int) 4000000)
0x1464: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x1465: IF (Stack[-1] == 1) GOTO 0x1467; Pop(1)

0x1466: Stack[-4] = (bool) 0
0x1467: Return(); Pop(2)

0x1468: PushEmpty()
0x1469: PushEmpty(object)
0x146a: Stack[-2] = Stack[-1]
0x146b: Push(-1, 3); TaskCall(7)
0x146c: Call2 0x626

0x146d: Pop(-1, 3); TaskReturn
0x146e: Pop(1)
0x146f: Return(); Pop(0)

0x1470: PushEmpty()
0x1471: PushEmpty(bool, object)
0x1472: Stack[-3] = Stack[-1]
0x1473: Call2 0x1459

0x1474: Stack[-2] = Stack[-4]
0x1475: Pop(2)
0x1476: Return(); Pop(0)

0x1477: PushEmpty()
0x1478: PushEmpty(object)
0x1479: Stack[-2] = Stack[-1]
0x147a: Call2 0x1468
...
0x1482: PushEmpty()
0x1483: Push((int) 1000)
0x1484: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=580
0x1485: Pop(1)
0x1486: Return(); Pop(0)

0x1487: PushEmpty()
0x1488: PushEmpty(int, string)
0x1489: Stack[-1] = "branch" // @poff=595
0x148a: Call2 0x12fa

0x148b: Pop(1)
0x148c: Push((int) 0)
0x148d: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x148e: IF (Stack[-1] == 0) GOTO 0x1491; Pop(1)

0x148f: Stack[-2] = (bool) 1
0x1490: Return(); Pop(0)

0x1491: Stack[-2] = (bool) 0
0x1492: Return(); Pop(0)
...
0x1499: Stack[-2] = (bool) 1
0x149a: Return(); Pop(0)

0x149b: Stack[-2] = (bool) 0
0x149c: Return(); Pop(0)
...
0x14a1: Pop(1)
0x14a2: IF (Stack[-1] == 0) GOTO 0x14a5; Pop(1)

0x14a3: Stack[-2] = (bool) 1
0x14a4: Return(); Pop(0)

0x14a5: Stack[-2] = (bool) 0
0x14a6: Return(); Pop(0)

0x14a7: PushEmpty()
0x14a8: PushEmpty(bool, object)
...
0x14b1: PushEmpty()
0x14b2: PushEmpty(bool, object)
0x14b3: Stack[-3] = Stack[-1]
0x14b4: Call2 0x1534
...
0x14c5: PushEmpty()
0x14c6: PushEmpty(bool, object)
0x14c7: Stack[-3] = Stack[-1]
0x14c8: Call2 0x1542
...
0x14d1: Stack[-3] = Stack[-1]
0x14d2: Call2 0x1549

0x14d3: Pop(1)
0x14d4: IF (Stack[-1] == 0) GOTO 0x14d7; Pop(1)

0x14d5: Stack[-2] = (bool) 1
0x14d6: Return(); Pop(0)

0x14d7: Stack[-2] = (bool) 0
0x14d8: Return(); Pop(0)

0x14d9: PushEmpty()
0x14da: PushEmpty(bool, object)
0x14db: Stack[-3] = Stack[-1]
0x14dc: Call2 0x1550

0x14dd: Pop(1)
0x14de: IF (Stack[-1] == 0) GOTO 0x14e1; Pop(1)

0x14df: Stack[-2] = (bool) 1
0x14e0: Return(); Pop(0)

0x14e1: Stack[-2] = (bool) 0
0x14e2: Return(); Pop(0)

0x14e3: PushEmpty()
0x14e4: PushEmpty(bool, object)
0x14e5: Stack[-3] = Stack[-1]
0x14e6: Call2 0x1557
...
0x14ed: PushEmpty()
0x14ee: PushEmpty(bool, object)
0x14ef: Stack[-3] = Stack[-1]
0x14f0: Call2 0x155e

0x14f1: Pop(1)
0x14f2: IF (Stack[-1] == 0) GOTO 0x14f5; Pop(1)

0x14f3: Stack[-2] = (bool) 1
0x14f4: Return(); Pop(0)

0x14f5: Stack[-2] = (bool) 0
0x14f6: Return(); Pop(0)

0x14f7: PushEmpty()
0x14f8: PushEmpty(bool, object)
0x14f9: Stack[-3] = Stack[-1]
0x14fa: Call2 0x1565
...
0x150d: Stack[-3] = Stack[-1]
0x150e: Call2 0x1573

0x150f: Pop(1)
0x1510: IF (Stack[-1] == 0) GOTO 0x1513; Pop(1)

0x1511: Stack[-2] = (bool) 1
0x1512: Return(); Pop(0)

0x1513: Stack[-2] = (bool) 0
0x1514: Return(); Pop(0)

0x1515: PushEmpty()
0x1516: PushEmpty(bool, object)
0x1517: Stack[-3] = Stack[-1]
0x1518: Call2 0x1588

0x1519: Pop(1)
0x151a: IF (Stack[-1] == 0) GOTO 0x151d; Pop(1)

0x151b: Stack[-2] = (bool) 1
0x151c: Return(); Pop(0)

0x151d: Stack[-2] = (bool) 0
0x151e: Return(); Pop(0)
...
0x155a: Pop(0)
0x155b: Push((int) 9)
0x155c: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x155d: Return(); Pop(0)

0x155e: PushEmpty()
0x155f: PushEmpty(int)
0x1560: Call2 0x12ff

0x1561: Pop(0)
0x1562: Push((int) 10)
0x1563: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x1564: Return(); Pop(0)

0x1565: PushEmpty()
0x1566: PushEmpty(int)
0x1567: Call2 0x12ff

0x1568: Pop(0)
0x1569: Push((int) 11)
0x156a: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x156b: Return(); Pop(0)
...
0x156f: Pop(0)
0x1570: Push((int) 12)
0x1571: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x1572: Return(); Pop(0)

0x1573: PushEmpty()
0x1574: PushEmpty(bool)
0x1575: Stack[-1] = (bool) 0
0x1576: PushEmpty(int)
0x1577: Call2 0x1308

0x1578: Pop(0)
0x1579: Push((int) 0)
0x157a: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0x157b: IF (Stack[-1] == 0) GOTO 0x1583; Pop(1)
...
0x1582: Stack[-1] = (bool) 1
0x1583: IF (Stack[-1] == 0) GOTO 0x1586; Pop(1)

0x1584: Stack[-2] = (bool) 1
0x1585: Return(); Pop(0)
...
0x158b: Pop(0)
0x158c: Push((int) 12)
0x158d: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
...
0x1594: Push("branch") // @poff=595
0x1595: @ GetVariable(Stack[-1], Stack[-2])
0x1596: Pop(1)
0x1597: Push((int) 0)
0x1598: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x1599: IF (Stack[-1] == 0) GOTO 0x159d; Pop(1)

0x159a: Stack[-3] = (int) 1
0x159b: Return(); Pop(2)

0x159c: GOTO 0x15a2

0x159d: Push((int) 1)
0x159e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x159f: IF (Stack[-1] == 0) GOTO 0x15a2; Pop(1)

0x15a0: Stack[-3] = (int) 2
0x15a1: Return(); Pop(2)

0x15a2: Stack[-3] = (int) 3
0x15a3: Return(); Pop(2)

0x15a4: PushEmpty(int, int)
0x15a5: Push("branch") // @poff=595
0x15a6: @ GetVariable(Stack[-1], Stack[-2])
0x15a7: Pop(1)
0x15a8: Stack[-1] = Stack[-3]
0x15a9: Return(); Pop(2)

0x15aa: PushEmpty()
0x15ab: PushEmpty(int)
0x15ac: Call2 0x15a4

0x15ad: Pop(0)
0x15ae: Push((int) 1)
0x15af: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x15b0: IF (Stack[-1] == 0) GOTO 0x15b4; Pop(1)

0x15b1: @ WorkWithCorpse(Stack[-1])
0x15b2: Pop(0)
0x15b3: GOTO 0x15b6

0x15b4: @ Barter(Stack[-1])
0x15b5: Pop(0)
0x15b6: Return(); Pop(0)

0x15b7: PushEmpty(int, bool, int, int, bool, int)
0x15b8: Push((int) 0)
0x15b9: @ ClearSubContainer(Stack[-1])
0x15ba: Pop(1)
0x15bb: PushEmpty(int)
0x15bc: Call2 0x12ff

0x15bd: Stack[-1] = Stack[-2]
0x15be: Pop(1)
0x15bf: Push(Stack[-7])
0x15c0: IF (Stack[-1] == 0) GOTO 0x15ed; Pop(1)

0x15c1: PushEmpty(string, int, int, int)
0x15c2: Stack[-4] = "alpha_pills" // @poff=609
0x15c3: Stack[-3] = (int) 1
0x15c4: Stack[-2] = (int) 2
0x15c5: Stack[-1] = (int) 4
0x15c6: Call2 0x12aa

0x15c7: Pop(4)
0x15c8: PushEmpty(string, int, int, int)
0x15c9: Stack[-4] = "meradorm" // @poff=633
0x15ca: Stack[-3] = (int) 2
0x15cb: Stack[-2] = (int) 3
0x15cc: Stack[-1] = (int) 3
0x15cd: Call2 0x12aa

0x15ce: Pop(4)
0x15cf: Push((int) 3)
0x15d0: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x15d1: IF (Stack[-1] == 0) GOTO 0x15d8; Pop(1)

0x15d2: PushEmpty(string, int, int)
0x15d3: Stack[-3] = "beta_pills" // @poff=651
0x15d4: Stack[-2] = (int) 1
0x15d5: Stack[-1] = (int) 4
0x15d6: Call2 0x129f

0x15d7: Pop(3)
0x15d8: Push((int) 8)
0x15d9: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x15da: IF (Stack[-1] == 0) GOTO 0x15e3; Pop(1)

0x15db: PushEmpty(string, int, int, int)
0x15dc: Stack[-4] = "monomicin" // @poff=673
0x15dd: Stack[-3] = (int) 1
0x15de: Stack[-2] = (int) 2
0x15df: Stack[-1] = (int) 2
0x15e0: Call2 0x12aa
...
0x15e5: IF (Stack[-1] == 0) GOTO 0x15ec; Pop(1)

0x15e6: PushEmpty(string, int, int)
0x15e7: Stack[-3] = "monomicin" // @poff=673
0x15e8: Stack[-2] = (int) 1
...
0x15ed: PushEmpty(string, int, int)
0x15ee: Stack[-3] = "lockpick" // @poff=693
0x15ef: Stack[-2] = (int) 1
0x15f0: Stack[-1] = (int) 4
0x15f1: Call2 0x129f

0x15f2: Pop(3)
0x15f3: PushEmpty(string, int, int)
0x15f4: Stack[-3] = "rifle_ammo" // @poff=711
0x15f5: Stack[-2] = (int) 1
0x15f6: Stack[-1] = (int) 2
0x15f7: Call2 0x129f

0x15f8: Pop(3)
0x15f9: PushEmpty(string, int, int)
0x15fa: Stack[-3] = "revolver_ammo" // @poff=733
0x15fb: Stack[-2] = (int) 1
0x15fc: Stack[-1] = (int) 2
0x15fd: Call2 0x129f

0x15fe: Pop(3)
0x15ff: PushEmpty(string, int, int, int)
0x1600: Stack[-4] = "samopal_ammo" // @poff=761
0x1601: Stack[-3] = (int) 1
0x1602: Stack[-2] = (int) 2
0x1603: Stack[-1] = (int) 2
0x1604: Call2 0x12aa

0x1605: Pop(4)
0x1606: Push((int) 8)
0x1607: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x1608: IF (Stack[-1] == 0) GOTO 0x1611; Pop(1)

0x1609: PushEmpty(string, int, int, int)
0x160a: Stack[-4] = "monomicin" // @poff=673
0x160b: Stack[-3] = (int) 1
0x160c: Stack[-2] = (int) 2
0x160d: Stack[-1] = (int) 2
0x160e: Call2 0x12aa
...
0x1611: Push((int) 4)
0x1612: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0x1613: IF (Stack[-1] == 0) GOTO 0x161a; Pop(1)

0x1614: PushEmpty(string, int, int)
0x1615: Stack[-3] = "monomicin" // @poff=673
0x1616: Stack[-2] = (int) 1
0x1617: Stack[-1] = (int) 2
0x1618: Call2 0x129f

0x1619: Pop(3)
0x161a: Return(); Pop(6)

0x161b: Stack[-1] = (int) 515559
0x161c: Return(); Pop(0)

0x161d: Stack[-1] = (int) 503344
0x161e: Return(); Pop(0)

0x161f: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=787
0x1620: Return(); Pop(0)

0x1621: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=827
0x1622: Return(); Pop(0)

0x1623: Stack[-1] = (bool) 0
0x1624: Return(); Pop(0)

0x1625: Push(GlobalVars[0])
0x1626: Stack[-1] = (bool) 0
0x1627: GlobalVars[0] = Stack[-1]; Pop(1)
0x1628: PushEmpty(bool)
0x1629: Stack[-1] = (bool) 0
0x162a: Call2 0x15b7

0x162b: Pop(1)
0x162c: Return(); Pop(0)

0x162d: PushEmpty(bool, bool)
0x162e: Push(GlobalVars[0])
0x162f: IF (Stack[-1] == 0) GOTO 0x163a; Pop(1)

0x1630: @ IsOverrideActive(Stack[-1])
0x1631: Pop(0)
0x1632: Pop(0); Push((bool) Stack[-1] == 0)
0x1633: IF (Stack[-1] == 0) GOTO 0x1638; Pop(1)

0x1634: PushEmpty(object)
0x1635: Stack[-4] = Stack[-1]
0x1636: Call2 0x15aa
...
0x163a: Push((int) 1000)
0x163b: PushEmpty(int, object)
0x163c: Stack[-6] = Stack[-1]
0x163d: Push(-2, 1); TaskCall(8)
0x163e: Call2 0x6c3

0x163f: Pop(-2, 1); TaskReturn
0x1640: Pop(1)
0x1641: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1642: IF (Stack[-1] == 0) GOTO 0x1654; Pop(1)
...
0x1648: IF (Stack[-1] == 0) GOTO 0x164a; Pop(1)

0x1649: Return(); Pop(2)

0x164a: PushEmpty(object)
0x164b: Stack[-4] = Stack[-1]
0x164c: Push(-1, 1); TaskCall(0)
0x164d: Call2 0x0

0x164e: Pop(-1, 1); TaskReturn
0x164f: Pop(1)
0x1650: PushEmpty(object)
0x1651: Stack[-4] = Stack[-1]
0x1652: Call2 0x127c

0x1653: Pop(1)
0x1654: Return(); Pop(2)

0x1655: Stack[-1] = (bool) 1
0x1656: Return(); Pop(0)

0x1657: PushEmpty()
0x1658: PushEmpty(bool, object, object, float)
0x1659: Stack[-7] = Stack[-3]
0x165a: Stack[-6] = Stack[-2]
0x165b: Stack[-1] = (float) 500.0
0x165c: Call2 0x13e5

0x165d: Pop(3)
0x165e: IF (Stack[-1] == 0) GOTO 0x1665; Pop(1)

0x165f: Push("ToDie") // @poff=871
0x1660: Push((bool) 1)
0x1661: @ SetProperty(Stack[-2], Stack[-1])
0x1662: Pop(2)
0x1663: Stack[-4] = (bool) 1
0x1664: Return(); Pop(0)

0x1665: Stack[-4] = (bool) 0
0x1666: Return(); Pop(0)
