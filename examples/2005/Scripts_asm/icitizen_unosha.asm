...
Strings:
	...
	W:Received steal
	W:idle
// @pool_raw:
...
0xf5: Stack[-9] = Stack[-3]
0xf6: Stack[-8] = Stack[-2]
0xf7: Stack[-7] = Stack[-1]
0xf8: Call2 0xb3d
...
0xfc: Stack[-8] = Stack[-2]
0xfd: Stack[-6] = Stack[-1]
0xfe: Call2 0xa8e

0xff: Stack[-3] = Stack[-4]
0x100: Pop(3)
0x101: Push((int) 0)
...
0x125: Stack[-7] = Stack[-2]
0x126: Stack[-6] = Stack[-1]
0x127: Call2 0x9a0
...
0x134: Stack[-6] = Stack[-2]
0x135: Stack[-7] = Stack[-1]
0x136: Call2 0xad8

0x137: Stack[-3] = Stack[-4]
0x138: Pop(3)
0x139: Push((int) 0)
...
0x211: Stack[-5] = Stack[-1]
0x212: Call2 0xa31

0x213: Stack[-2] = Stack[-3]
0x214: Pop(2)
0x215: Push((int) 0)
...
0x225: Stack[-9] = Stack[-3]
0x226: Stack[-8] = Stack[-2]
0x227: Stack[-7] = Stack[-1]
0x228: Call2 0xb3d
...
0x22c: Stack[-8] = Stack[-2]
0x22d: Stack[-6] = Stack[-1]
0x22e: Call2 0xa8e

0x22f: Stack[-3] = Stack[-4]
0x230: Pop(3)
0x231: Push((int) 0)
...
0x241: Stack[-5] = Stack[-1]
0x242: Call2 0xac2

0x243: Stack[-2] = Stack[-3]
0x244: Pop(2)
0x245: Push((int) 0)
...
0x255: Stack[-7] = Stack[-2]
0x256: Stack[-6] = Stack[-1]
0x257: Call2 0x9a0
...
0x2ae: Stack[-2] = Stack[-3]
0x2af: Pop(2)
0x2b0: PushEmpty(float, cvector, cvector)
0x2b1: Stack[-5] = Stack[-2]
0x2b2: Stack[-4] = Stack[-1]
0x2b3: Call2 0x82c

0x2b4: Pop(2)
0x2b5: Push((float)0.4999999701976776)
...
0x2da: PushEmpty()
0x2db: Stack[-3] = (float) 0.05000000074505806
0x2dc: Return(); Pop(0)
...
0x2f5: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x2f6: Pop(0)
0x2f7: Push(Stack[-8])
0x2f8: IF (Stack[-1] == 0) GOTO 0x301; Pop(1)

0x2f9: Push("attack") // @poff=234
...
0x315: Pop(0)
0x316: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x317: Pop(0)
...
0x331: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=248
0x332: Pop(0)
...
0x34b: Pop(1)
0x34c: Push("all") // @poff=170
0x34d: Push("attack_on") // @poff=262
...
0x365: IF (Stack[-1] == 1) GOTO 0x36b; Pop(1)

0x366: PushEmpty(bool)
0x367: Call2 0x537

0x368: Pop(0)
0x369: IF (Stack[-1] == 1) GOTO 0x36b; Pop(1)

0x36a: Stack[-1] = (bool) 0
0x36b: IF (Stack[-1] == 0) GOTO 0x37c; Pop(1)

0x36c: @ Face(Stack[-0]T)
0x36d: Pop(0)
0x36e: PushEmpty()
0x36f: Call2 0x569

0x370: Pop(0)
0x371: Push("all") // @poff=170
0x372: Push("attack_stay") // @poff=282
0x373: @ PlayAnimation(Stack[-2], Stack[-1])
0x374: Pop(2)
0x375: PushEmpty(bool, float)
0x376: Stack[-25] = Stack[-1]
0x377: Call2 0x4b3
...
0x37c: @ Face(Stack[-0]T)
0x37d: Pop(0)
0x37e: Push("all") // @poff=170
0x37f: Push("fjump") // @poff=306
...
0x39a: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x39b: Pop(0)
...
0x3b9: Push("all") // @poff=170
0x3ba: Push("attack_off") // @poff=318
...
0x3c8: Push("attack_begin") // @poff=340
0x3c9: Push((int) 1)
0x3ca: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3d5: Push("attack") // @poff=234
0x3d6: Push((int) 1)
0x3d7: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3e1: Push("all") // @poff=170
0x3e2: Push("bjump") // @poff=366
...
0x3e9: Push((float)0.8999999761581421)
0x3ea: Pop(1); Push(Stack[-9] * Stack[-1]);
0x3eb: @ GetVictim(Stack[-1], Stack[-4])
0x3ec: Pop(1)
0x3ed: @ ReportAttack(Stack[-0]T)
0x3ee: Pop(0)
...
0x3f2: Stack[-6] = Stack[-2]
0x3f3: Stack[-10] = Stack[-1]
0x3f4: Call2 0x2da

0x3f5: Stack[-3] = Stack[-5]
0x3f6: Pop(3)
0x3f7: PushEmpty(float, object, float, int)
0x3f8: Stack[-7] = Stack[-3]
0x3f9: Stack[-6] = Stack[-2]
0x3fa: PushEmpty(int, object, int)
0x3fb: Stack[-10] = Stack[-2]
0x3fc: Stack[-14] = Stack[-1]
0x3fd: Call2 0x2dd

0x3fe: Stack[-3] = Stack[-4]
0x3ff: Pop(3)
0x400: Call2 0x6ab

0x401: Stack[-4] = Stack[-5]
0x402: Pop(4)
0x403: PushEmpty(int)
0x404: Call2 0x567

0x405: Pop(0)
0x406: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x407: Pop(1)
...
0x412: Pop(0)
0x413: @ irand(Stack[-4], Stack[-1]T)
0x414: Pop(0)
0x415: Push((int) 1)
0x416: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x417: @ Face(Stack[-0]T)
0x418: Pop(0)
0x419: Push((bool) 1)
...
0x41e: Pop(0)
0x41f: Push("all") // @poff=170
0x420: Push("attack_begin") // @poff=340
...
0x434: Stack[-11] = Stack[-2]
0x435: Stack[-6] = Stack[-1]
0x436: Call2 0x3e8

0x437: Pop(2)
0x438: Push("all") // @poff=170
0x439: Push("attack_middle") // @poff=378
...
0x441: Pop(0)
0x442: Push("all") // @poff=170
0x443: Push("attack_middle") // @poff=378
...
0x457: Stack[-11] = Stack[-2]
0x458: Stack[-6] = Stack[-1]
0x459: Call2 0x3e8

0x45a: Pop(2)
0x45b: Stack[-2] = (int) 1
0x45c: Push("attack_middle") // @poff=378
0x45d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x45e: Push("_") // @poff=406
0x45f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x460: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x461: Push("all") // @poff=170
...
0x47d: Stack[-11] = Stack[-2]
0x47e: Stack[-6] = Stack[-1]
0x47f: Call2 0x3e8
...
0x488: Push("attack_end") // @poff=410
...
0x4c7: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=248
0x4c8: Pop(0)
...
0x513: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x514: Pop(1)
...
0x518: @ Face(Stack[-0]T)
0x519: Pop(0)
0x51a: Push("all") // @poff=170
0x51b: Push("bjump") // @poff=366
0x51c: @ PlayAnimation(Stack[-2], Stack[-1])
0x51d: Pop(2)
0x51e: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=248
0x51f: Pop(0)
...
0x555: @ irand(Stack[-1], Stack[-2]T)
0x556: Pop(0)
0x557: Push((int) 1)
0x558: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x559: Push("attack") // @poff=234
...
0x56a: Stack[-1] = "attack_stay" // @poff=282
0x56b: Call2 0x7ce
...
0x59c: Stack[-15] = Stack[-5]
0x59d: Stack[-14] = Stack[-4]
0x59e: Stack[-13] = Stack[-3]
0x59f: Stack[-12] = Stack[-2]
0x5a0: Stack[-11] = Stack[-1]
0x5a1: Call2 0x5e6

0x5a2: Stack[-6] = Stack[-7]
0x5a3: Pop(6)
0x5a4: Push( Stack[2 + Tasks[-1].StackPointer] )
0x5a5: IF (Stack[-1] == 0) GOTO 0x5a9; Pop(1)

0x5a6: Push("head") // @poff=160
0x5a7: @ UnlookAsync(Stack[-1])
0x5a8: Pop(1)
0x5a9: Push((int) 1)
0x5aa: @ KillTimer(Stack[-1])
0x5ab: Pop(1)
0x5ac: Stack[-1] = Stack[-10]
0x5ad: Return(); Pop(4)
...
0x5e9: Stack[-17] = Stack[-7]
0x5ea: PushEmpty(bool, object)
0x5eb: Stack[-23] = Stack[-1]
0x5ec: Call2 0x672
...
0x5f2: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x5f3: Pop(0)
...
0x609: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=248
0x60a: Pop(0)
...
0x61b: Push((int) 0)
0x61c: Push((float)0.30000001192092896)
...
0x63e: Push((int) 0)
0x63f: Push((float)0.30000001192092896)
...
0x679: Stack[-1] = "walk" // @poff=468
0x67a: Return(); Pop(0)

0x67b: Stack[-1] = "run" // @poff=478
0x67c: Return(); Pop(0)
...
0x687: Stack[-2] = "bullet" // @poff=496
0x688: Return(); Pop(0)

0x689: Stack[-2] = "phys" // @poff=510
0x68a: Return(); Pop(0)

0x68b: PushEmpty(cvector, cvector, cvector, cvector)
0x68c: @ GetPosition(Stack[-2])
0x68d: Pop(0)
0x68e: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x68f: Pop(0)
...
0x694: Pop(0)
0x695: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x696: Pop(0)
...
0x6a0: Push("HasProperty") // @poff=520
0x6a1: Push((int) 2)
...
0x6a7: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x6a8: Pop(0)
...
0x6ad: Stack[-18] = Stack[-2]
0x6ae: Stack[-1] = "health" // @poff=556
0x6af: Call2 0x69f
...
0x6b6: Stack[-18] = Stack[-2]
0x6b7: Stack[-1] = "armor" // @poff=570
0x6b8: Call2 0x69f
...
0x6be: Push("armor") // @poff=570
0x6bf: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x6c0: Pop(1)
0x6c1: Push("armor_") // @poff=594
0x6c2: PushEmpty(string, int)
0x6c3: Stack[-16] = Stack[-1]
0x6c4: Call2 0x67d

0x6c5: Pop(1)
0x6c6: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6c7: PushEmpty(bool, object, string)
0x6c8: Stack[-18] = Stack[-2]
0x6c9: Stack[-8] = Stack[-1]
0x6ca: Call2 0x69f
...
0x6d0: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x6d1: Pop(0)
...
0x6d8: Stack[-3] = Stack[-6]
0x6d9: Pop(3)
0x6da: Push("health") // @poff=556
0x6db: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x6dc: Pop(1)
0x6dd: Push((int) 1)
0x6de: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6df: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6e0: Push("health") // @poff=556
...
0x6e6: Pop(3)
0x6e7: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x6e8: Pop(2)
0x6e9: PushEmpty(bool, object)
0x6ea: Stack[-17] = Stack[-1]
0x6eb: Call2 0x69a
...
0x6f1: Pop(1)
0x6f2: Stack[-1] = Stack[-16]
0x6f3: Return(); Pop(12)

0x6f4: PushEmpty(bool, bool)
0x6f5: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x6f6: Pop(0)
0x6f7: Stack[-1] = Stack[-4]
0x6f8: Return(); Pop(2)

0x6f9: PushEmpty(object, object, object, object)
0x6fa: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x70e: Pop(0)
0x70f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x710: IF (Stack[-1] == 0) GOTO 0x713; Pop(1)

0x711: Stack[-6] = (bool) 0
0x712: Return(); Pop(4)

0x713: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x714: Pop(0)
...
0x727: Stack[-6] = Stack[-2]
0x728: Stack[-1] = "noaccess" // @poff=650
0x729: Call2 0x69f
...
0x72f: Push("noaccess") // @poff=650
0x730: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x731: Pop(1)
0x732: Push((int) 0)
...
0x736: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x744: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x745: Pop(0)
...
0x755: Stack[-1] = "fhit" // @poff=668
0x756: GOTO 0x758

0x757: Stack[-1] = "bhit" // @poff=678
0x758: Push("hit_react") // @poff=688
0x759: Push("1") // @poff=708
0x75a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x75b: Push("2") // @poff=712
...
0x774: Stack[-25] = Stack[-1]
0x775: Call2 0x68b

0x776: Stack[-2] = Stack[-3]
0x777: Pop(2)
0x778: Call2 0x7fd

0x779: Stack[-2] = Stack[-11]
0x77a: Pop(2)
0x77b: @ CreateVectorVector(Stack[-8])
0x77c: Pop(0)
0x77d: Stack[-7] = (int) 1
0x77e: Push("hit") // @poff=670
...
0x793: Pop(0)
0x794: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x795: Pop(0)
0x796: PushEmpty(object, int, float, cvector, cvector)
0x797: Stack[-26] = Stack[-5]
0x798: Stack[-25] = Stack[-4]
0x799: Stack[-24] = Stack[-3]
...
0x7b4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x7b5: Pop(0)
...
0x7c4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x7c5: Pop(0)
0x7c6: Stack[-1] = [0.0, 0.0, 0.0]
0x7c7: Push(CvectorIndex(Stack[-1], 1))
0x7c8: Stack[-3] = Stack[-1]
0x7c9: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7ca: Push("head") // @poff=160
...
0x82e: Stack[-5] = Stack[-2]
0x82f: Stack[-4] = Stack[-1]
0x830: Call2 0x819
...
0x83f: Pop(0)
0x840: @@ add(Stack[-3]); Obj=1 // @poff=716
0x841: Pop(0)
0x842: Push((int) 15)
...
0x87a: Push("GenerateMoney: iMin > iMax") // @poff=803
0x87b: @ Trace(Stack[-1])
0x87c: Pop(1)
0x87d: Return(); Pop(4)
...
0x898: Pop(0)
0x899: @@ SetItemName(Stack[-7]); Obj=3 // @poff=869
0x89a: Pop(0)
0x89b: Push("Organ") // @poff=881
0x89c: Push((int) 1)
0x89d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x89e: Pop(2)
0x89f: @@ GetItemID(Stack[-2]); Obj=3 // @poff=893
0x8a0: Pop(0)
0x8a1: Push((int) 0)
0x8a2: Push((int) 1)
...
0x8af: Stack[-1] = "liver" // @poff=903
0x8b0: Call2 0x896

0x8b1: Pop(1)
0x8b2: PushEmpty(string)
0x8b3: Stack[-1] = "kidney" // @poff=915
0x8b4: Call2 0x896

0x8b5: Pop(1)
0x8b6: PushEmpty(string)
0x8b7: Stack[-1] = "heart" // @poff=929
0x8b8: Call2 0x896

0x8b9: Pop(1)
0x8ba: PushEmpty(string)
0x8bb: Stack[-1] = "blood" // @poff=941
0x8bc: Call2 0x896
...
0x8f8: Stack[-1] = "syringe" // @poff=985
0x8f9: Call2 0x96e
...
0x936: Stack[-1] = "bracelet" // @poff=1037
0x937: Call2 0x96e
...
0x942: Stack[-1] = "ear_ring" // @poff=1055
0x943: Call2 0x96e
...
0x94e: Stack[-1] = "gold_ring" // @poff=1073
0x94f: Call2 0x96e
...
0x95a: Stack[-1] = "silver_ring" // @poff=1093
0x95b: Call2 0x96e
...
0x966: Stack[-1] = "flower" // @poff=1117
0x967: Call2 0x96e
...
0x990: Stack[-7] = Stack[-3]
0x991: Stack[-6] = Stack[-2]
...
0x998: Stack[-11] = Stack[-5]
0x999: Stack[-10] = Stack[-4]
0x99a: Stack[-9] = Stack[-3]
0x99b: Stack[-7] = Stack[-2]
...
0x9a0: PushEmpty()
0x9a1: Push("unholster") // @poff=1131
...
0x9a7: Stack[-2] = Stack[-5]
0x9a8: Pop(2)
0x9a9: Return(); Pop(0)

0x9aa: GOTO 0x9be

0x9ab: Push("player_shot") // @poff=1151
...
0x9c0: PushEmpty()
0x9c1: Push("unholster") // @poff=1131
...
0x9c9: Push("player_shot") // @poff=1151
...
0x9e8: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1175
0x9e9: Pop(0)
...
0xa45: Stack[-9] = Stack[-2]
0xa46: Stack[-1] = "class" // @poff=1217
0xa47: Call2 0x69f
...
0xa4d: Push("class") // @poff=1217
0xa4e: @ GetProperty(Stack[-1], Stack[-3])
0xa4f: Pop(1)
0xa50: Push("class") // @poff=1217
0xa51: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xa52: Pop(1)
...
0xa92: Stack[-2] = Stack[-5]
0xa93: Pop(2)
0xa94: Return(); Pop(0)

0xa95: PushEmpty()
0xa96: PushEmpty(object)
0xa97: Stack[-2] = Stack[-1]
0xa98: Call2 0xa3b
...
0xac3: Push("Received steal") // @poff=1339
0xac4: @ Trace(Stack[-1])
0xac5: Pop(1)
...
0xacb: Stack[-5] = Stack[-1]
0xacc: Call2 0xa31

0xacd: Stack[-2] = Stack[-6]
0xace: Pop(2)
0xacf: Return(); Pop(2)
...
0xae6: Push(Stack[-1])
0xae7: IF (Stack[-1] == 1) GOTO 0xaf0; Pop(1)

0xae8: PushEmpty(float, object)
0xae9: Stack[-5] = Stack[-1]
0xaea: Call2 0x692

0xaeb: Pop(1)
0xaec: Push((int) 2250000)
0xaed: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xaee: IF (Stack[-1] == 1) GOTO 0xaf0; Pop(1)
...
0xb2d: Pop(0)
0xb2e: Push("all") // @poff=170
0xb2f: PushEmpty(string, int)
0xb30: Stack[-4] = Stack[-1]
0xb31: Call2 0xb01
...
0xb3f: Stack[-8] = Stack[-4]
0xb40: Stack[-7] = Stack[-3]
0xb41: Stack[-2] = (float) 500.0
0xb42: Stack[-6] = Stack[-1]
0xb43: Call2 0xa9b

0xb44: Stack[-5] = Stack[-9]
0xb45: Pop(5)
0xb46: Return(); Pop(0)

0xb47: PushEmpty()
0xb48: PushEmpty(bool, object)
0xb49: Stack[-3] = Stack[-1]
0xb4a: Call2 0x69a
...
0xb4f: Pop(0)
0xb50: Push((float)-0.07000000029802322)
0xb51: Push((bool) 1)
