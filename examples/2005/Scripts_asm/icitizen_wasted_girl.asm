...
Strings:
	...
	W:idle
	W:ToDie
// @pool_raw:
...
0x2d3: @ Face(Stack[-1])
0x2d4: Pop(0)
0x2d5: Push("all") // @poff=170
0x2d6: Push("attack_on") // @poff=178
0x2d7: @ PlayAnimation(Stack[-2], Stack[-1])
0x2d8: Pop(2)
0x2d9: @ WaitForAnimEnd()
0x2da: Pop(0)
0x2db: Push("all") // @poff=170
0x2dc: Push("attack_stay") // @poff=198
0x2dd: @ PlayAnimation(Stack[-2], Stack[-1])
0x2de: Pop(2)
0x2df: @ WaitForAnimEnd()
0x2e0: Pop(0)
0x2e1: Push("all") // @poff=170
0x2e2: Push("attack_off") // @poff=222
...
0x2f7: Pop(0)
0x2f8: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x2f9: Pop(0)
...
0x316: Stack[-1] = (float) 1.7453293800354004
0x317: Call2 0x2f5
...
0x31f: Stack[-1] = (float) 2.6179938316345215
0x320: Call2 0x2f5

0x321: Stack[-2] = Stack[-7]
0x322: Pop(2)
...
0x327: Push("Can't retreat, distance: ") // @poff=244
...
0x33d: Push((int) 1)
0x33e: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x33f: Pop(1)
0x340: Push(Stack[-3])
0x341: IF (Stack[-1] == 0) GOTO 0x359; Pop(1)

0x342: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x347: Stack[-1] = (float) 2.6179938316345215
0x348: Call2 0x2f5
...
0x35a: IF (Stack[-1] == 1) GOTO 0x33d; Pop(1)
...
0x361: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x370: Stack[-1] = (float) 1.7453293800354004
0x371: Call2 0x2f5
...
0x380: IF (Stack[-1] == 1) GOTO 0x386; Pop(1)

0x381: PushEmpty(bool)
0x382: Call2 0x3a0

0x383: Pop(0)
0x384: IF (Stack[-1] == 1) GOTO 0x386; Pop(1)
...
0x3a6: Stack[-2] = Stack[-3]
0x3a7: Pop(2)
0x3a8: PushEmpty(float, cvector, cvector)
0x3a9: Stack[-5] = Stack[-2]
0x3aa: Stack[-4] = Stack[-1]
0x3ab: Call2 0x727

0x3ac: Pop(2)
0x3ad: Push((float)-0.3420201241970062)
...
0x3b2: Pop(0)
0x3b3: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x3b4: Pop(0)
...
0x3d1: Stack[-1] = (float) 1.7453293800354004
0x3d2: Call2 0x3b0

0x3d3: Stack[-2] = Stack[-7]
0x3d4: Pop(2)
...
0x3da: Stack[-1] = (float) 2.6179938316345215
0x3db: Call2 0x3b0

0x3dc: Stack[-2] = Stack[-7]
0x3dd: Pop(2)
...
0x3e2: Push("Can't retreat, distance: ") // @poff=244
...
0x3f8: Push((int) 1)
0x3f9: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3fa: Pop(1)
0x3fb: Push(Stack[-3])
0x3fc: IF (Stack[-1] == 0) GOTO 0x414; Pop(1)

0x3fd: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x402: Stack[-1] = (float) 2.6179938316345215
0x403: Call2 0x3b0

0x404: Stack[-2] = Stack[-4]
0x405: Pop(2)
...
0x415: IF (Stack[-1] == 1) GOTO 0x3f8; Pop(1)
...
0x41c: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x42b: Stack[-1] = (float) 1.7453293800354004
0x42c: Call2 0x3b0

0x42d: Stack[-2] = Stack[-4]
0x42e: Pop(2)
...
0x43b: IF (Stack[-1] == 1) GOTO 0x441; Pop(1)

0x43c: PushEmpty(bool)
0x43d: Call2 0x45b

0x43e: Pop(0)
0x43f: IF (Stack[-1] == 1) GOTO 0x441; Pop(1)
...
0x461: Stack[-2] = Stack[-3]
0x462: Pop(2)
0x463: PushEmpty(float, cvector, cvector)
0x464: Stack[-5] = Stack[-2]
0x465: Stack[-4] = Stack[-1]
0x466: Call2 0x727

0x467: Pop(2)
0x468: Push((float)-0.3420201241970062)
...
0x474: Pop(0)
0x475: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x476: Pop(0)
...
0x493: Stack[-1] = (float) 1.7453293800354004
0x494: Call2 0x472

0x495: Stack[-2] = Stack[-7]
0x496: Pop(2)
...
0x49c: Stack[-1] = (float) 2.6179938316345215
0x49d: Call2 0x472
...
0x4a4: Push("Can't retreat, distance: ") // @poff=244
...
0x4ba: Push((int) 1)
0x4bb: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x4bc: Pop(1)
0x4bd: Push(Stack[-3])
0x4be: IF (Stack[-1] == 0) GOTO 0x4d6; Pop(1)

0x4bf: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4c4: Stack[-1] = (float) 2.6179938316345215
0x4c5: Call2 0x472
...
0x4d7: IF (Stack[-1] == 1) GOTO 0x4ba; Pop(1)
...
0x4de: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4ed: Stack[-1] = (float) 1.7453293800354004
0x4ee: Call2 0x472
...
0x4fd: IF (Stack[-1] == 1) GOTO 0x503; Pop(1)

0x4fe: PushEmpty(bool)
0x4ff: Call2 0x51d

0x500: Pop(0)
0x501: IF (Stack[-1] == 1) GOTO 0x503; Pop(1)
...
0x523: Stack[-2] = Stack[-3]
0x524: Pop(2)
0x525: PushEmpty(float, cvector, cvector)
0x526: Stack[-5] = Stack[-2]
0x527: Stack[-4] = Stack[-1]
0x528: Call2 0x727

0x529: Pop(2)
0x52a: Push((float)-0.3420201241970062)
...
0x536: Pop(0)
0x537: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x538: Pop(0)
...
0x555: Stack[-1] = (float) 1.7453293800354004
0x556: Call2 0x534

0x557: Stack[-2] = Stack[-7]
0x558: Pop(2)
...
0x55e: Stack[-1] = (float) 2.6179938316345215
0x55f: Call2 0x534

0x560: Stack[-2] = Stack[-7]
0x561: Pop(2)
...
0x566: Push("Can't retreat, distance: ") // @poff=244
...
0x57c: Push((int) 1)
0x57d: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x57e: Pop(1)
0x57f: Push(Stack[-3])
0x580: IF (Stack[-1] == 0) GOTO 0x598; Pop(1)

0x581: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x586: Stack[-1] = (float) 2.6179938316345215
0x587: Call2 0x534

0x588: Stack[-2] = Stack[-4]
0x589: Pop(2)
...
0x599: IF (Stack[-1] == 1) GOTO 0x57c; Pop(1)
...
0x5a0: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x5af: Stack[-1] = (float) 1.7453293800354004
0x5b0: Call2 0x534

0x5b1: Stack[-2] = Stack[-4]
0x5b2: Pop(2)
...
0x5bf: IF (Stack[-1] == 1) GOTO 0x5c5; Pop(1)

0x5c0: PushEmpty(bool)
0x5c1: Call2 0x5df

0x5c2: Pop(0)
0x5c3: IF (Stack[-1] == 1) GOTO 0x5c5; Pop(1)
...
0x5eb: Pop(2)
0x5ec: Push((float)-0.3420201241970062)
...
0x5f6: Pop(0)
0x5f7: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x5f8: Pop(0)
...
0x5fd: Pop(0)
0x5fe: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x5ff: Pop(0)
...
0x605: Pop(0)
0x606: Stack[-1] = Stack[-4]
0x607: Return(); Pop(2)

0x608: PushEmpty(bool, bool)
0x609: Push("HasProperty") // @poff=296
0x60a: Push((int) 2)
...
0x610: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=320
0x611: Pop(0)
0x612: Stack[-1] = Stack[-5]
0x613: Return(); Pop(2)

0x614: PushEmpty(bool, bool)
0x615: @@ IsDead(Stack[-1]); Obj=3 // @poff=332
0x616: Pop(0)
0x617: Stack[-1] = Stack[-4]
0x618: Return(); Pop(2)

0x619: PushEmpty(object, object, object, object)
0x61a: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x62e: Pop(0)
0x62f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x630: IF (Stack[-1] == 0) GOTO 0x633; Pop(1)

0x631: Stack[-6] = (bool) 0
0x632: Return(); Pop(4)

0x633: @@ GetScene(Stack[-1]); Obj=5 // @poff=353
0x634: Pop(0)
...
0x647: Stack[-6] = Stack[-2]
0x648: Stack[-1] = "noaccess" // @poff=362
0x649: Call2 0x608
...
0x64f: Push("noaccess") // @poff=362
0x650: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=380
0x651: Pop(1)
0x652: Push((int) 0)
...
0x656: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x664: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x665: Pop(0)
...
0x675: Stack[-1] = "fhit" // @poff=392
0x676: GOTO 0x678

0x677: Stack[-1] = "bhit" // @poff=402
0x678: Push("hit_react") // @poff=412
0x679: Push("1") // @poff=432
0x67a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x67b: Push("2") // @poff=436
...
0x699: Stack[-2] = Stack[-11]
0x69a: Pop(2)
0x69b: @ CreateVectorVector(Stack[-8])
0x69c: Pop(0)
0x69d: Stack[-7] = (int) 1
0x69e: Push("hit") // @poff=394
...
0x6b3: Pop(0)
0x6b4: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=449
0x6b5: Pop(0)
0x6b6: PushEmpty(object, int, float, cvector, cvector)
0x6b7: Stack[-26] = Stack[-5]
0x6b8: Stack[-25] = Stack[-4]
0x6b9: Stack[-24] = Stack[-3]
...
0x6d4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x6d5: Pop(0)
...
0x6e4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x6e5: Pop(0)
0x6e6: Stack[-1] = [0.0, 0.0, 0.0]
0x6e7: Push(CvectorIndex(Stack[-1], 1))
0x6e8: Stack[-3] = Stack[-1]
0x6e9: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6ea: Push("head") // @poff=160
...
0x772: Push("GenerateMoney: iMin > iMax") // @poff=513
0x773: @ Trace(Stack[-1])
0x774: Pop(1)
0x775: Return(); Pop(4)
...
0x790: Pop(0)
0x791: @@ SetItemName(Stack[-7]); Obj=3 // @poff=579
0x792: Pop(0)
0x793: Push("Organ") // @poff=591
0x794: Push((int) 1)
0x795: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=603
0x796: Pop(2)
0x797: @@ GetItemID(Stack[-2]); Obj=3 // @poff=615
0x798: Pop(0)
0x799: Push((int) 0)
0x79a: Push((int) 1)
...
0x7a7: Stack[-1] = "liver" // @poff=625
0x7a8: Call2 0x78e

0x7a9: Pop(1)
0x7aa: PushEmpty(string)
0x7ab: Stack[-1] = "kidney" // @poff=637
0x7ac: Call2 0x78e

0x7ad: Pop(1)
0x7ae: PushEmpty(string)
0x7af: Stack[-1] = "heart" // @poff=651
0x7b0: Call2 0x78e

0x7b1: Pop(1)
0x7b2: PushEmpty(string)
0x7b3: Stack[-1] = "blood" // @poff=663
0x7b4: Call2 0x78e
...
0x7f0: Stack[-1] = "syringe" // @poff=707
0x7f1: Call2 0x866
...
0x82e: Stack[-1] = "bracelet" // @poff=759
0x82f: Call2 0x866
...
0x83a: Stack[-1] = "ear_ring" // @poff=777
0x83b: Call2 0x866
...
0x846: Stack[-1] = "gold_ring" // @poff=795
0x847: Call2 0x866
...
0x852: Stack[-1] = "silver_ring" // @poff=815
0x853: Call2 0x866
...
0x888: Stack[-7] = Stack[-3]
0x889: Stack[-6] = Stack[-2]
...
0x890: Stack[-11] = Stack[-5]
0x891: Stack[-10] = Stack[-4]
0x892: Stack[-9] = Stack[-3]
0x893: Stack[-7] = Stack[-2]
0x894: Stack[-6] = Stack[-1]
0x895: Call2 0x6c5
...
0x898: PushEmpty()
0x899: Push("unholster") // @poff=867
0x89a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x89b: IF (Stack[-1] == 0) GOTO 0x8a3; Pop(1)

0x89c: PushEmpty(bool, object)
0x89d: Stack[-4] = Stack[-1]
0x89e: Call2 0x9b4

0x89f: Stack[-2] = Stack[-5]
0x8a0: Pop(2)
0x8a1: Return(); Pop(0)

0x8a2: GOTO 0x8b6

0x8a3: Push("player_shot") // @poff=887
...
0x8a9: Stack[-2] = Stack[-5]
0x8aa: Pop(2)
0x8ab: Return(); Pop(0)

0x8ac: GOTO 0x8b6

0x8ad: Push("battle") // @poff=911
...
0x8e0: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=925
0x8e1: Pop(0)
...
0x94f: Stack[-9] = Stack[-2]
0x950: Stack[-1] = "class" // @poff=967
0x951: Call2 0x608
...
0x957: Push("class") // @poff=967
0x958: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=380
0x959: Pop(1)
0x95a: Push("rat") // @poff=979
...
0x96f: Push(Stack[-2])
0x970: IF (Stack[-1] == 1) GOTO 0x979; Pop(1)
...
0x977: IF (Stack[-1] == 1) GOTO 0x979; Pop(1)
...
0x99a: Push("Received steal") // @poff=1011
0x99b: @ Trace(Stack[-1])
0x99c: Pop(1)
...
0x9a2: Stack[-5] = Stack[-1]
0x9a3: Call2 0x929

0x9a4: Stack[-2] = Stack[-6]
0x9a5: Pop(2)
0x9a6: Return(); Pop(2)
...
0x9c5: Push(Stack[-1])
0x9c6: IF (Stack[-1] == 1) GOTO 0x9cf; Pop(1)
...
0x9cd: IF (Stack[-1] == 1) GOTO 0x9cf; Pop(1)
...
0xa07: Stack[-3] = (int) 0
0xa08: Push("all") // @poff=170
0xa09: PushEmpty(string, int)
0xa0a: Stack[-6] = Stack[-1]
0xa0b: Call2 0x9ea
...
0xa16: Pop(0)
0xa17: Push("all") // @poff=170
0xa18: PushEmpty(string, int)
0xa19: Stack[-4] = Stack[-1]
0xa1a: Call2 0x9ea
...
0xa28: Stack[-7] = Stack[-3]
0xa29: Stack[-6] = Stack[-2]
...
0xa3e: Pop(0)
0xa3f: Push((float)-0.10000000149011612)
0xa40: Push((bool) 1)
