...
0x840: Pop(0)
0x841: @@ SetItemName(Stack[-7]); Obj=3 // @poff=803
0x842: Pop(0)
0x843: Push("Organ") // @poff=815
0x844: Push((int) 1)
0x845: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x846: Pop(2)
0x847: @@ GetItemID(Stack[-2]); Obj=3 // @poff=827
0x848: Pop(0)
0x849: Push((int) 0)
0x84a: Push((int) 1)
...
0x857: Stack[-1] = "liver" // @poff=837
0x858: Call2 0x83e

0x859: Pop(1)
0x85a: PushEmpty(string)
0x85b: Stack[-1] = "kidney" // @poff=849
0x85c: Call2 0x83e

0x85d: Pop(1)
0x85e: PushEmpty(string)
0x85f: Stack[-1] = "heart" // @poff=863
0x860: Call2 0x83e

0x861: Pop(1)
0x862: PushEmpty(string)
0x863: Stack[-1] = "blood" // @poff=875
0x864: Call2 0x83e
...
0x895: Stack[-7] = Stack[-3]
0x896: Stack[-6] = Stack[-2]
0x897: Stack[-5] = Stack[-1]
0x898: Call2 0x736
...
0x89d: Stack[-11] = Stack[-5]
0x89e: Stack[-10] = Stack[-4]
0x89f: Stack[-9] = Stack[-3]
0x8a0: Stack[-7] = Stack[-2]
...
0x8b0: Push("player_shot") // @poff=931
...
0x8ed: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=955
0x8ee: Pop(0)
...
0x92d: Stack[-2] = (int) 0
0x92e: Push("all") // @poff=170
0x92f: PushEmpty(string, int)
0x930: Stack[-5] = Stack[-1]
0x931: Call2 0x925
...
0x998: Pop(0)
0x999: Push((float)-0.07000000029802322)
0x99a: Push((bool) 1)
