...
Strings:
	...
	W:beta_pills
	W:gamma_pills
// @pool_raw:
...
0x165: Stack[-5] = Stack[-1]
0x166: Call2 0x85a

0x167: Stack[-2] = Stack[-3]
0x168: Pop(2)
0x169: Push((int) 0)
...
0x191: Stack[-9] = Stack[-3]
0x192: Stack[-8] = Stack[-2]
0x193: Stack[-7] = Stack[-1]
0x194: Call2 0x91e
...
0x198: Stack[-8] = Stack[-2]
0x199: Stack[-6] = Stack[-1]
0x19a: Call2 0x7fc

0x19b: Stack[-3] = Stack[-4]
0x19c: Pop(3)
0x19d: Push((int) 0)
...
0x1c1: Stack[-7] = Stack[-2]
0x1c2: Stack[-6] = Stack[-1]
0x1c3: Call2 0x75e
...
0x1ca: Stack[-6] = Stack[-2]
0x1cb: Stack[-5] = Stack[-1]
0x1cc: Call2 0x77e
...
0x1d0: Stack[-6] = Stack[-2]
0x1d1: Stack[-7] = Stack[-1]
0x1d2: Call2 0x855
...
0x21b: Pop(0)
0x21c: Push("all") // @poff=0
0x21d: PushEmpty(string, int)
0x21e: Stack[-7] = Stack[-1]
0x21f: Call2 0x7c1
...
0x289: Stack[-5] = Stack[-1]
0x28a: Call2 0x85a

0x28b: Stack[-2] = Stack[-3]
0x28c: Pop(2)
0x28d: Push((int) 0)
...
0x2b5: Stack[-9] = Stack[-3]
0x2b6: Stack[-8] = Stack[-2]
...
0x2bd: Stack[-6] = Stack[-1]
0x2be: Call2 0x7fc

0x2bf: Stack[-3] = Stack[-4]
0x2c0: Pop(3)
0x2c1: Push((int) 0)
...
0x2ee: Stack[-6] = Stack[-2]
0x2ef: Stack[-5] = Stack[-1]
0x2f0: Call2 0x77e
...
0x330: Stack[-2] = Stack[-3]
0x331: Pop(2)
0x332: PushEmpty(float, cvector, cvector)
0x333: Stack[-5] = Stack[-2]
0x334: Stack[-4] = Stack[-1]
0x335: Call2 0x73c

0x336: Pop(2)
0x337: Push((float)0.4999999701976776)
...
0x355: @ Face(Stack[-1])
0x356: Pop(0)
0x357: Push("all") // @poff=0
0x358: Push("attack_on") // @poff=18
0x359: @ PlayAnimation(Stack[-2], Stack[-1])
0x35a: Pop(2)
0x35b: @ WaitForAnimEnd()
0x35c: Pop(0)
0x35d: Push("all") // @poff=0
0x35e: Push("attack_stay") // @poff=38
0x35f: @ PlayAnimation(Stack[-2], Stack[-1])
0x360: Pop(2)
0x361: @ WaitForAnimEnd()
0x362: Pop(0)
0x363: Push("all") // @poff=0
0x364: Push("attack_off") // @poff=62
...
0x379: Pop(0)
0x37a: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x37b: Pop(0)
...
0x398: Stack[-1] = (float) 1.7453293800354004
0x399: Call2 0x377

0x39a: Stack[-2] = Stack[-7]
0x39b: Pop(2)
...
0x3a1: Stack[-1] = (float) 2.6179938316345215
0x3a2: Call2 0x377

0x3a3: Stack[-2] = Stack[-7]
0x3a4: Pop(2)
...
0x3a9: Push("Can't retreat, distance: ") // @poff=96
...
0x3bf: Push((int) 1)
0x3c0: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3c1: Pop(1)
0x3c2: Push(Stack[-3])
0x3c3: IF (Stack[-1] == 0) GOTO 0x3db; Pop(1)

0x3c4: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3c9: Stack[-1] = (float) 2.6179938316345215
0x3ca: Call2 0x377

0x3cb: Stack[-2] = Stack[-4]
0x3cc: Pop(2)
...
0x3dc: IF (Stack[-1] == 1) GOTO 0x3bf; Pop(1)
...
0x3e3: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3f2: Stack[-1] = (float) 1.7453293800354004
0x3f3: Call2 0x377

0x3f4: Stack[-2] = Stack[-4]
0x3f5: Pop(2)
...
0x402: IF (Stack[-1] == 1) GOTO 0x408; Pop(1)
...
0x428: Stack[-2] = Stack[-3]
0x429: Pop(2)
0x42a: PushEmpty(float, cvector, cvector)
0x42b: Stack[-5] = Stack[-2]
0x42c: Stack[-4] = Stack[-1]
0x42d: Call2 0x721

0x42e: Pop(2)
0x42f: Push((float)-0.3420201241970062)
...
0x434: Pop(0)
0x435: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x436: Pop(0)
...
0x453: Stack[-1] = (float) 1.7453293800354004
0x454: Call2 0x432

0x455: Stack[-2] = Stack[-7]
0x456: Pop(2)
...
0x45c: Stack[-1] = (float) 2.6179938316345215
0x45d: Call2 0x432
...
0x464: Push("Can't retreat, distance: ") // @poff=96
...
0x47a: Push((int) 1)
0x47b: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x47c: Pop(1)
0x47d: Push(Stack[-3])
0x47e: IF (Stack[-1] == 0) GOTO 0x496; Pop(1)

0x47f: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x484: Stack[-1] = (float) 2.6179938316345215
0x485: Call2 0x432

0x486: Stack[-2] = Stack[-4]
0x487: Pop(2)
...
0x497: IF (Stack[-1] == 1) GOTO 0x47a; Pop(1)
...
0x49e: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4ad: Stack[-1] = (float) 1.7453293800354004
0x4ae: Call2 0x432

0x4af: Stack[-2] = Stack[-4]
0x4b0: Pop(2)
...
0x4bd: IF (Stack[-1] == 1) GOTO 0x4c3; Pop(1)

0x4be: PushEmpty(bool)
0x4bf: Call2 0x4dd

0x4c0: Pop(0)
0x4c1: IF (Stack[-1] == 1) GOTO 0x4c3; Pop(1)
...
0x4e6: Stack[-5] = Stack[-2]
0x4e7: Stack[-4] = Stack[-1]
0x4e8: Call2 0x721

0x4e9: Pop(2)
0x4ea: Push((float)-0.3420201241970062)
...
0x4f6: Pop(0)
0x4f7: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x4f8: Pop(0)
...
0x515: Stack[-1] = (float) 1.7453293800354004
0x516: Call2 0x4f4

0x517: Stack[-2] = Stack[-7]
0x518: Pop(2)
...
0x51e: Stack[-1] = (float) 2.6179938316345215
0x51f: Call2 0x4f4

0x520: Stack[-2] = Stack[-7]
0x521: Pop(2)
...
0x526: Push("Can't retreat, distance: ") // @poff=96
...
0x53c: Push((int) 1)
0x53d: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x53e: Pop(1)
0x53f: Push(Stack[-3])
0x540: IF (Stack[-1] == 0) GOTO 0x558; Pop(1)

0x541: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x546: Stack[-1] = (float) 2.6179938316345215
0x547: Call2 0x4f4

0x548: Stack[-2] = Stack[-4]
0x549: Pop(2)
...
0x559: IF (Stack[-1] == 1) GOTO 0x53c; Pop(1)
...
0x560: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x56f: Stack[-1] = (float) 1.7453293800354004
0x570: Call2 0x4f4

0x571: Stack[-2] = Stack[-4]
0x572: Pop(2)
...
0x57f: IF (Stack[-1] == 1) GOTO 0x585; Pop(1)
...
0x5a8: Stack[-5] = Stack[-2]
0x5a9: Stack[-4] = Stack[-1]
0x5aa: Call2 0x721

0x5ab: Pop(2)
0x5ac: Push((float)-0.3420201241970062)
...
0x5b8: Pop(0)
0x5b9: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x5ba: Pop(0)
...
0x5d7: Stack[-1] = (float) 1.7453293800354004
0x5d8: Call2 0x5b6

0x5d9: Stack[-2] = Stack[-7]
0x5da: Pop(2)
...
0x5e0: Stack[-1] = (float) 2.6179938316345215
0x5e1: Call2 0x5b6

0x5e2: Stack[-2] = Stack[-7]
0x5e3: Pop(2)
...
0x5e8: Push("Can't retreat, distance: ") // @poff=96
...
0x5fe: Push((int) 1)
0x5ff: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x600: Pop(1)
0x601: Push(Stack[-3])
0x602: IF (Stack[-1] == 0) GOTO 0x61a; Pop(1)

0x603: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x608: Stack[-1] = (float) 2.6179938316345215
0x609: Call2 0x5b6
...
0x61b: IF (Stack[-1] == 1) GOTO 0x5fe; Pop(1)
...
0x622: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x631: Stack[-1] = (float) 1.7453293800354004
0x632: Call2 0x5b6

0x633: Stack[-2] = Stack[-4]
0x634: Pop(2)
...
0x641: IF (Stack[-1] == 1) GOTO 0x647; Pop(1)
...
0x66a: Stack[-5] = Stack[-2]
0x66b: Stack[-4] = Stack[-1]
0x66c: Call2 0x721

0x66d: Pop(2)
0x66e: Push((float)-0.3420201241970062)
...
0x678: Pop(0)
0x679: @@ GetPosition(Stack[-1]); Obj=5 // @poff=84
0x67a: Pop(0)
...
0x67f: Pop(0)
0x680: @@ GetPosition(Stack[-2]); Obj=7 // @poff=84
0x681: Pop(0)
...
0x68b: Push("HasProperty") // @poff=148
0x68c: Push((int) 2)
...
0x692: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=172
0x693: Pop(0)
0x694: Stack[-1] = Stack[-5]
0x695: Return(); Pop(2)

0x696: PushEmpty(bool, bool)
0x697: @@ IsDead(Stack[-1]); Obj=3 // @poff=184
0x698: Pop(0)
0x699: Stack[-1] = Stack[-4]
0x69a: Return(); Pop(2)

0x69b: PushEmpty(object, object, object, object)
0x69c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6b0: Pop(0)
0x6b1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6b2: IF (Stack[-1] == 0) GOTO 0x6b5; Pop(1)

0x6b3: Stack[-6] = (bool) 0
0x6b4: Return(); Pop(4)

0x6b5: @@ GetScene(Stack[-1]); Obj=5 // @poff=205
0x6b6: Pop(0)
...
0x6ca: Stack[-1] = "noaccess" // @poff=214
0x6cb: Call2 0x68a
...
0x6d1: Push("noaccess") // @poff=214
0x6d2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=232
0x6d3: Pop(1)
0x6d4: Push((int) 0)
...
0x6d8: @@ GetPosition(Stack[-3]); Obj=7 // @poff=84
0x6d9: Pop(0)
...
0x6f4: Stack[-7] = Stack[-2]
0x6f5: Stack[-6] = Stack[-1]
0x6f6: Call2 0x71c
...
0x765: Stack[-2] = Stack[-5]
0x766: Pop(2)
0x767: Return(); Pop(0)

0x768: GOTO 0x77c

0x769: Push("player_shot") // @poff=278
...
0x7a6: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=316
0x7a7: Pop(0)
...
0x810: Stack[-9] = Stack[-2]
0x811: Stack[-1] = "class" // @poff=344
0x812: Call2 0x68a
...
0x818: Push("class") // @poff=344
0x819: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=232
0x81a: Pop(1)
0x81b: Push("rat") // @poff=356
...
0x875: Push(Stack[-1])
0x876: IF (Stack[-1] == 1) GOTO 0x87f; Pop(1)
...
0x87d: IF (Stack[-1] == 1) GOTO 0x87f; Pop(1)
...
0x8a3: Push("reputation") // @poff=416
0x8a4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=232
0x8a5: Pop(1)
...
0x8bd: Stack[-4] = "rifle_ammo" // @poff=438
0x8be: Stack[-3] = (int) 1
0x8bf: Stack[-2] = (int) 2
0x8c0: Stack[-1] = (int) 2
0x8c1: Call2 0x6fd
...
0x8c4: Stack[-4] = "revolver_ammo" // @poff=460
0x8c5: Stack[-3] = (int) 1
0x8c6: Stack[-2] = (int) 2
0x8c7: Stack[-1] = (int) 2
0x8c8: Call2 0x6fd
...
0x8cb: Stack[-4] = "samopal_ammo" // @poff=488
0x8cc: Stack[-3] = (int) 2
0x8cd: Stack[-2] = (int) 2
0x8ce: Stack[-1] = (int) 2
0x8cf: Call2 0x6fd
...
0x8d3: Stack[-3] = "lockpick" // @poff=514
0x8d4: Stack[-2] = (int) 1
0x8d5: Stack[-1] = (int) 4
0x8d6: Call2 0x6f2
...
0x8d9: Stack[-4] = "alpha_pills" // @poff=532
0x8da: Stack[-3] = (int) 1
0x8db: Stack[-2] = (int) 2
0x8dc: Stack[-1] = (int) 3
0x8dd: Call2 0x6fd
...
0x8e0: Stack[-3] = "meradorm" // @poff=556
0x8e1: Stack[-2] = (int) 1
0x8e2: Stack[-1] = (int) 2
0x8e3: Call2 0x6f2
...
0x8f3: Stack[-3] = "beta_pills" // @poff=588
0x8f4: Stack[-2] = (int) 1
0x8f5: Stack[-1] = (int) 2
0x8f6: Call2 0x6f2
...
0x8fc: Stack[-3] = "gamma_pills" // @poff=610
0x8fd: Stack[-2] = (int) 1
0x8fe: Stack[-1] = (int) 7
0x8ff: Call2 0x6f2
