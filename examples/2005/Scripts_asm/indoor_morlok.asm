...
0x82f: Push("branch") // @poff=789
0x830: @ GetVariable(Stack[-1], Stack[-2])
0x831: Pop(1)
0x832: Stack[-1] = Stack[-3]
0x833: Return(); Pop(2)
...
0x843: Pop(0)
0x844: @@ SetItemName(Stack[-7]); Obj=3 // @poff=803
0x845: Pop(0)
0x846: Push("Organ") // @poff=815
0x847: Push((int) 1)
0x848: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x849: Pop(2)
0x84a: @@ GetItemID(Stack[-2]); Obj=3 // @poff=827
0x84b: Pop(0)
0x84c: Push((int) 0)
0x84d: Push((int) 1)
...
0x85a: Stack[-1] = "liver" // @poff=837
0x85b: Call2 0x841

0x85c: Pop(1)
0x85d: PushEmpty(string)
0x85e: Stack[-1] = "kidney" // @poff=849
0x85f: Call2 0x841

0x860: Pop(1)
0x861: PushEmpty(string)
0x862: Stack[-1] = "heart" // @poff=863
0x863: Call2 0x841

0x864: Pop(1)
0x865: PushEmpty(string)
0x866: Stack[-1] = "blood" // @poff=875
0x867: Call2 0x841
...
0x898: Stack[-7] = Stack[-3]
0x899: Stack[-6] = Stack[-2]
...
0x8a0: Stack[-11] = Stack[-5]
0x8a1: Stack[-10] = Stack[-4]
0x8a2: Stack[-9] = Stack[-3]
0x8a3: Stack[-7] = Stack[-2]
0x8a4: Stack[-6] = Stack[-1]
0x8a5: Call2 0x77d
...
0x8f0: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=955
0x8f1: Pop(0)
...
0x9a2: Push("class") // @poff=1007
0x9a3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=582
0x9a4: Pop(1)
0x9a5: Stack[-6] = (bool) 1
0x9a6: Push("butcher") // @poff=1019
0x9a7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9a8: IF (Stack[-1] == 1) GOTO 0x9ad; Pop(1)

0x9a9: Push("morlok") // @poff=1035
0x9aa: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9ab: IF (Stack[-1] == 1) GOTO 0x9ad; Pop(1)
...
0x9b6: Pop(0)
0x9b7: Push((float)-0.07000000029802322)
0x9b8: Push((bool) 1)
