...
Strings:
	...
	A:DropItems
	A:SetItemName
// @pool_raw:
...
0x1: Push("drink") // @poff=0
0x2: @ PlaySound(Stack[-1])
0x3: Pop(1)
0x4: PushEmpty(bool, string, float, float, float)
0x5: Stack[-4] = "hunger" // @poff=12
0x6: Stack[-3] = (float) -0.009999999776482582
0x7: Stack[-2] = (int) 0
0x8: Stack[-1] = (int) 1
0x9: Call2 0x3b
...
0x27: Stack[-4] = "tiredness" // @poff=26
0x28: Stack[-3] = (float) 0.029999999329447746
0x29: Stack[-2] = (int) 0
0x2a: Stack[-1] = (int) 1
0x2b: Call2 0x3b
...
0x2e: Stack[-1] = (float) 0.029999999329447746
0x2f: Call2 0x8b
...
0x35: Pop(1)
0x36: Stack[-2] = "bottle_empty" // @poff=60
0x37: Stack[-1] = (int) 1
0x38: Call2 0x7e
...
0x61: Pop(0)
0x62: @@ add(Stack[-4]); Obj=1 // @poff=86
0x63: Pop(0)
0x64: @@ add(Stack[-3]); Obj=1 // @poff=86
0x65: Pop(0)
0x66: Push((int) 3)
...
0x6c: @@ GetItemID(Stack[-3]); Obj=8 // @poff=90
0x6d: Pop(0)
0x6e: Push("Category") // @poff=100
0x6f: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x70: Pop(1)
0x71: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=118
0x72: Pop(0)
0x73: Pop(0); Push((bool) Stack[-1] == 0)
0x74: IF (Stack[-1] == 0) GOTO 0x78; Pop(1)

0x75: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=126
0x76: Pop(0)
0x77: GOTO 0x7d

0x78: PushEmpty(int, int)
0x79: Stack[-5] = Stack[-2]
0x7a: Stack[-9] = Stack[-1]
0x7b: Call2 0x5f
...
0x80: Pop(0)
0x81: @@ SetItemName(Stack[-4]); Obj=1 // @poff=136
0x82: Pop(0)
0x83: PushEmpty(object, object, int)
0x84: Stack[-8] = Stack[-3]
...
0x8d: Pop(0)
0x8e: @@ add(Stack[-3]); Obj=1 // @poff=86
0x8f: Pop(0)
0x90: Push((int) 11)
...
0x97: Pop(0)
0x98: @@ add(Stack[-3]); Obj=1 // @poff=86
0x99: Pop(0)
0x9a: Push((int) 12)
...
0xa1: Pop(0)
0xa2: @@ add(Stack[-3]); Obj=1 // @poff=86
0xa3: Pop(0)
0xa4: Push((int) 15)
0xa5: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa6: Pop(1)
0xa7: Return(); Pop(2)
