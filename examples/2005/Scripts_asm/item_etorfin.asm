...
0x2: Stack[-3] = (float) 0.3499999940395355
0x3: Stack[-2] = (int) 0
0x4: Stack[-1] = (int) 1
0x5: Call2 0x52
...
0x6: Pop(5)
0x7: PushEmpty(float)
0x8: Stack[-1] = (float) 0.3499999940395355
0x9: Call2 0x87

0xa: Pop(1)
0xb: PushEmpty(bool, string, float, float, float)
0xc: Stack[-4] = "tiredness" // @poff=14
0xd: Stack[-3] = (float) 0.3499999940395355
0xe: Stack[-2] = (int) 0
0xf: Stack[-1] = (int) 1
0x10: Call2 0x52
...
0x13: Stack[-1] = (float) 0.3499999940395355
0x14: Call2 0x7d
...
0x22: Push((float)0.30000001192092896)
...
0x2a: Push((float)-0.30000001192092896)
