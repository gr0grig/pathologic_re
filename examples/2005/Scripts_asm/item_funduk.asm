...
Strings:
	...
	W:hunger
	A:add
// @pool_raw:6500610074000000680075006e00670065007200000061646400
...
0x4: Stack[-4] = "hunger" // @poff=8
0x5: Stack[-3] = (float) -0.009999999776482582
0x6: Stack[-2] = (int) 0
0x7: Stack[-1] = (int) 1
0x8: Call2 0xf
...
0x9: Pop(5)
0xa: PushEmpty(float)
0xb: Stack[-1] = (float) -0.009999999776482582
0xc: Call2 0x2d
...
0x2f: Pop(0)
0x30: @@ add(Stack[-3]); Obj=1 // @poff=22
0x31: Pop(0)
0x32: Push((int) 12)
