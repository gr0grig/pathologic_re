...
Strings:
	...
	W:tiredness
	A:add
// @pool_raw:6800650061006c0074006800000069006d006d0075006e00690074007900000064006900730065006100730065000000680075006e006700650072000000740069007200650064006e00650073007300000061646400
...
0x2: Stack[-3] = (float) -0.014999999664723873
0x3: Stack[-2] = (int) 0
0x4: Stack[-1] = (int) 1
0x5: Call2 0x38
...
0x6: Pop(5)
0x7: PushEmpty(float)
0x8: Stack[-1] = (float) -0.014999999664723873
0x9: Call2 0x7e

0xa: Pop(1)
0xb: PushEmpty(bool, string, float, float, float)
0xc: Stack[-4] = "immunity" // @poff=14
0xd: Stack[-3] = (float) 0.30000001192092896
0xe: Stack[-2] = (int) 0
0xf: Stack[-1] = (int) 1
0x10: Call2 0x38
...
0x13: Stack[-1] = (float) 0.30000001192092896
0x14: Call2 0x6a

0x15: Pop(1)
0x16: PushEmpty(bool, string, float, float, float)
0x17: Stack[-4] = "disease" // @poff=32
...
0x2d: Stack[-4] = "tiredness" // @poff=62
...
0x62: Pop(0)
0x63: @@ add(Stack[-3]); Obj=1 // @poff=82
0x64: Pop(0)
0x65: Push((int) 12)
...
0x6c: Pop(0)
0x6d: @@ add(Stack[-3]); Obj=1 // @poff=82
0x6e: Pop(0)
0x6f: Push((int) 13)
...
0x76: Pop(0)
0x77: @@ add(Stack[-3]); Obj=1 // @poff=82
0x78: Pop(0)
0x79: Push((int) 14)
...
0x80: Pop(0)
0x81: @@ add(Stack[-3]); Obj=1 // @poff=82
0x82: Pop(0)
0x83: Push((int) 15)
0x84: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x85: Pop(1)
0x86: Return(); Pop(2)
