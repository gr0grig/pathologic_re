...
Strings:
	...
	W:hunger
	A:add
// @pool_raw:6400720069006e006b000000680075006e00670065007200000061646400
...
0x4: Stack[-4] = "hunger" // @poff=12
0x5: Stack[-3] = (float) -0.17000000178813934
0x6: Stack[-2] = (int) 0
0x7: Stack[-1] = (int) 1
0x8: Call2 0xf
...
0x9: Pop(5)
0xa: PushEmpty(float)
0xb: Stack[-1] = (float) -0.17000000178813934
0xc: Call2 0x2d
...
0x1a: Stack[-10] = Stack[-2]
0x1b: Stack[-9] = Stack[-1]
0x1c: Call2 0x22
...
0x29: Stack[-1] = Stack[-4]
0x2a: Return(); Pop(0)

0x2b: Stack[-3] = Stack[-4]
0x2c: Return(); Pop(0)

0x2d: PushEmpty(object, object)
0x2e: @ CreateFloatVector(Stack[-1])
0x2f: Pop(0)
0x30: @@ add(Stack[-3]); Obj=1 // @poff=26
0x31: Pop(0)
0x32: Push((int) 12)
