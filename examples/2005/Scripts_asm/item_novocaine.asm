...
Strings:
	...
	W:sleeping
	A:add
// @pool_raw:6800650061006c00740068000000740069007200650064006e00650073007300000073006c0065006500700069006e006700000061646400
...
0x2: Stack[-3] = (float) 0.10000000149011612
0x3: Stack[-2] = (int) 0
0x4: Stack[-1] = (int) 1
0x5: Call2 0x52
...
0x6: Pop(5)
0x7: PushEmpty(float)
0x8: Stack[-1] = (float) 0.10000000149011612
0x9: Call2 0x87

0xa: Pop(1)
0xb: PushEmpty(bool, string, float, float, float)
0xc: Stack[-4] = "tiredness" // @poff=14
0xd: Stack[-3] = (float) 0.10000000149011612
0xe: Stack[-2] = (int) 0
0xf: Stack[-1] = (int) 1
0x10: Call2 0x52
...
0x13: Stack[-1] = (float) 0.10000000149011612
0x14: Call2 0x7d

0x15: Pop(1)
0x16: PushEmpty(float)
0x17: Stack[-1] = (float) 10.0
0x18: Call2 0x32
...
0x21: Stack[-4] = "health" // @poff=0
0x22: Push((float)0.12999999523162842)
...
0x29: Stack[-4] = "tiredness" // @poff=14
0x2a: Push((float)-0.07999999821186066)
...
0x6d: Push("sleeping") // @poff=34
0x6e: @ GetProperty(Stack[-1], Stack[-2])
0x6f: Pop(1)
0x70: Stack[-1] = Stack[-5]
0x71: Return(); Pop(4)
...
0x89: Pop(0)
0x8a: @@ add(Stack[-3]); Obj=1 // @poff=52
0x8b: Pop(0)
0x8c: Push((int) 15)
