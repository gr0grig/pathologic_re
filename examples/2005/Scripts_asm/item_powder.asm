...
Strings:
	...
	W:disease
	A:add
// @pool_raw:6800650061006c007400680000006400690073006500610073006500000061646400
...
0x1e: Pop(0)
0x1f: @@ add(Stack[-3]); Obj=1 // @poff=30
0x20: Pop(0)
0x21: Push((int) 14)
...
0x28: Pop(0)
0x29: @@ add(Stack[-3]); Obj=1 // @poff=30
0x2a: Pop(0)
0x2b: Push((int) 15)
0x2c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x2d: Pop(1)
0x2e: Return(); Pop(2)
