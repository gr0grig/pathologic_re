...
Strings:
	...
	W:armor_bullet
	W:armor_disease
// @pool_raw:
...
0x69: Stack[-2] = "armor_bullet" // @poff=114
...
0x6f: Stack[-2] = "armor_disease" // @poff=140
...
0x81: Pop(1)
0x82: Push("durability") // @poff=0
0x83: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=22
0x84: Pop(1)
...
0x89: @@ SetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=46
0x8a: Pop(1)
0x8b: Push((int) 1)
...
0x90: Push("durability") // @poff=0
0x91: @@ GetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=34
0x92: Pop(1)
0x93: PushEmpty(int)
0x94: Stack[-2] = Stack[-1]
0x95: Call2 0xd4
...
0x9c: Stack[-6] = Stack[-3]
0x9d: Stack[-5] = Stack[-2]
...
0x14e: Pop(1)
0x14f: Push("durability") // @poff=0
0x150: @@ HasProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=22
0x151: Pop(1)
0x152: Push(Stack[-3])
...
0x159: Pop(1)
0x15a: Push("durability") // @poff=0
0x15b: @@ GetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=34
0x15c: Pop(1)
...
0x162: Stack[-4] = Stack[-5]
0x163: Pop(4)
0x164: Push("durability") // @poff=0
0x165: @@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=46
0x166: Pop(1)
0x167: Push((int) 1)
...
0x173: Stack[-10] = Stack[-4]
0x174: Stack[-9] = Stack[-3]
