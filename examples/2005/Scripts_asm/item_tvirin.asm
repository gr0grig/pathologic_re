...
Strings:
	...
	W:sleeping
	A:add
// @pool_raw:6800650061006c0074006800000069006d006d0075006e006900740079000000740069007200650064006e00650073007300000073006c0065006500700069006e006700000061646400
...
0x2: Stack[-3] = (float) 0.05000000074505806
0x3: Stack[-2] = (int) 0
0x4: Stack[-1] = (int) 1
0x5: Call2 0x55
...
0x6: Pop(5)
0x7: PushEmpty(float)
0x8: Stack[-1] = (float) 0.05000000074505806
0x9: Call2 0x94

0xa: Pop(1)
0xb: PushEmpty(bool, string, float, float, float)
0xc: Stack[-4] = "immunity" // @poff=14
0xd: Stack[-3] = (float) 0.05000000074505806
0xe: Stack[-2] = (int) 0
0xf: Stack[-1] = (int) 1
0x10: Call2 0x55
...
0x13: Stack[-1] = (float) 0.05000000074505806
0x14: Call2 0x8a

0x15: Pop(1)
0x16: PushEmpty(bool, string, float, float, float)
0x17: Stack[-4] = "tiredness" // @poff=32
0x18: Stack[-3] = (float) 0.05000000074505806
0x19: Stack[-2] = (int) 0
0x1a: Stack[-1] = (int) 1
0x1b: Call2 0x55
...
0x1e: Stack[-1] = (float) 0.05000000074505806
0x1f: Call2 0x80
...
0x2c: Stack[-4] = "tiredness" // @poff=32
0x2d: Push((float)-0.10000000149011612)
...
0x8c: Pop(0)
0x8d: @@ add(Stack[-3]); Obj=1 // @poff=70
0x8e: Pop(0)
0x8f: Push((int) 13)
...
0x96: Pop(0)
0x97: @@ add(Stack[-3]); Obj=1 // @poff=70
0x98: Pop(0)
0x99: Push((int) 15)
0x9a: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x9b: Pop(1)
0x9c: Return(); Pop(2)
