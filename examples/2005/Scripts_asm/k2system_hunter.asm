...
0x697: Stack[-2] = (int) 0
0x698: Push("all") // @poff=0
0x699: PushEmpty(string, int)
0x69a: Stack[-5] = Stack[-1]
0x69b: Call2 0x68f
...
0x6a5: Stack[-2] = Stack[-5]
0x6a6: Return(); Pop(4)

0x6a7: PushEmpty(int, int)
0x6a8: Push("branch") // @poff=799
...
0x6bc: Pop(0)
0x6bd: @@ SetItemName(Stack[-7]); Obj=3 // @poff=813
0x6be: Pop(0)
0x6bf: Push("Organ") // @poff=825
0x6c0: Push((int) 1)
0x6c1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x6c2: Pop(2)
0x6c3: @@ GetItemID(Stack[-2]); Obj=3 // @poff=837
0x6c4: Pop(0)
0x6c5: Push((int) 0)
0x6c6: Push((int) 1)
...
0x6d3: Stack[-1] = "liver" // @poff=847
0x6d4: Call2 0x6ba

0x6d5: Pop(1)
0x6d6: PushEmpty(string)
0x6d7: Stack[-1] = "kidney" // @poff=859
0x6d8: Call2 0x6ba

0x6d9: Pop(1)
0x6da: PushEmpty(string)
0x6db: Stack[-1] = "heart" // @poff=873
0x6dc: Call2 0x6ba

0x6dd: Pop(1)
0x6de: PushEmpty(string)
0x6df: Stack[-1] = "blood" // @poff=885
0x6e0: Call2 0x6ba
...
0x6ff: Stack[-7] = Stack[-3]
0x700: Stack[-6] = Stack[-2]
0x701: Stack[-5] = Stack[-1]
0x702: Call2 0x5b9
...
0x707: Stack[-11] = Stack[-5]
0x708: Stack[-10] = Stack[-4]
0x709: Stack[-9] = Stack[-3]
0x70a: Stack[-7] = Stack[-2]
0x70b: Stack[-6] = Stack[-1]
0x70c: Call2 0x5fd
