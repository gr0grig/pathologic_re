...
0x51e: Stack[-7] = Stack[-3]
0x51f: Stack[-2] = (float) 0.02500000037252903
0x520: Stack[-1] = (int) 0
0x521: Call2 0x396

0x522: Stack[-4] = Stack[-5]
0x523: Pop(4)
0x524: Push((int) 7)
0x525: Push((float)0.02500000037252903)
...
0x52b: Pop(0)
0x52c: Push("rat") // @poff=472
0x52d: @@ SetItemName(Stack[-1]); Obj=3 // @poff=480
0x52e: Pop(1)
0x52f: Push((float)0.25)
0x530: Push((float)0.5)
0x531: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x532: Pop(2)
0x533: Push("quality") // @poff=492
0x534: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=348
0x535: Pop(1)
