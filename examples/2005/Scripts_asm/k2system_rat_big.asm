...
Strings:
	...
	A:SetItemName
	W:quality
// @pool_raw:
...
0x3a0: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=310
0x3a1: Pop(0)
0x3a2: PushEmpty(float, float, float, float)
0x3a3: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x3a4: Stack[-8] = Stack[-2]
0x3a5: Stack[-7] = Stack[-1]
0x3a6: Call2 0x4bf

0x3a7: Pop(3)
0x3a8: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=322
0x3a9: Pop(1)
...
0x3ae: Stack[-18] = Stack[-2]
0x3af: Stack[-1] = "health" // @poff=0
0x3b0: Call2 0x38a
...
0x3b7: Stack[-18] = Stack[-2]
0x3b8: Stack[-1] = "armor" // @poff=334
0x3b9: Call2 0x38a
...
0x3bf: Push("armor") // @poff=334
0x3c0: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=310
0x3c1: Pop(1)
0x3c2: Push("armor_") // @poff=346
0x3c3: PushEmpty(string, int)
0x3c4: Stack[-16] = Stack[-1]
0x3c5: Call2 0x36b

0x3c6: Pop(1)
0x3c7: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3c8: PushEmpty(bool, object, string)
0x3c9: Stack[-18] = Stack[-2]
0x3ca: Stack[-8] = Stack[-1]
0x3cb: Call2 0x38a
...
0x3d1: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=310
0x3d2: Pop(0)
...
0x3d9: Stack[-3] = Stack[-6]
0x3da: Pop(3)
0x3db: Push("health") // @poff=0
0x3dc: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=310
0x3dd: Pop(1)
0x3de: Push((int) 1)
0x3df: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3e0: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3e1: Push("health") // @poff=0
...
0x3e7: Pop(3)
0x3e8: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=322
0x3e9: Pop(2)
0x3ea: PushEmpty(bool, object)
0x3eb: Stack[-17] = Stack[-1]
0x3ec: Call2 0x385
...
0x3f2: Pop(1)
0x3f3: Stack[-1] = Stack[-16]
0x3f4: Return(); Pop(12)

0x3f5: PushEmpty(float, float, float, float)
0x3f6: PushEmpty(bool, object, string)
0x3f7: Stack[-9] = Stack[-2]
0x3f8: Stack[-1] = "disease" // @poff=360
0x3f9: Call2 0x38a
...
0x401: Stack[-9] = Stack[-2]
0x402: Stack[-1] = "armor_disease" // @poff=376
0x403: Call2 0x38a

0x404: Pop(2)
0x405: IF (Stack[-1] == 0) GOTO 0x40b; Pop(1)

0x406: Push("armor_disease") // @poff=376
0x407: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=310
0x408: Pop(1)
0x409: Push((int) 100)
0x40a: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x40b: PushEmpty(bool, object, string)
0x40c: Stack[-9] = Stack[-2]
0x40d: Stack[-1] = "immunity" // @poff=404
0x40e: Call2 0x38a

0x40f: Pop(2)
0x410: IF (Stack[-1] == 0) GOTO 0x41d; Pop(1)

0x411: Push("immunity") // @poff=404
0x412: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=310
0x413: Pop(1)
0x414: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x415: PushEmpty(bool, object, string, float, float, float)
0x416: Stack[-12] = Stack[-5]
0x417: Stack[-4] = "immunity" // @poff=404
...
0x428: Stack[-12] = Stack[-5]
0x429: Stack[-4] = "disease" // @poff=360
0x42a: Stack[-11] = Stack[-3]
0x42b: Stack[-2] = (int) 0
0x42c: Stack[-1] = (int) 1
0x42d: Call2 0x396
...
0x437: Pop(1)
0x438: Stack[-5] = Stack[-7]
0x439: Return(); Pop(4)

0x43a: PushEmpty(bool, bool)
0x43b: @@ IsDead(Stack[-1]); Obj=3 // @poff=422
0x43c: Pop(0)
0x43d: Stack[-1] = Stack[-4]
0x43e: Return(); Pop(2)

0x43f: PushEmpty(object, object, object, object)
0x440: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x454: Pop(0)
0x455: Pop(0); PushNull((bool) Stack[-2] == 0)
0x456: IF (Stack[-1] == 0) GOTO 0x459; Pop(1)

0x457: Stack[-6] = (bool) 0
0x458: Return(); Pop(4)

0x459: @@ GetScene(Stack[-1]); Obj=5 // @poff=443
0x45a: Pop(0)
...
0x46d: Stack[-6] = Stack[-2]
0x46e: Stack[-1] = "noaccess" // @poff=452
0x46f: Call2 0x38a
...
0x475: Push("noaccess") // @poff=452
0x476: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=310
0x477: Pop(1)
0x478: Push((int) 0)
...
0x4d4: Pop(0)
0x4d5: @@ add(Stack[-4]); Obj=1 // @poff=470
0x4d6: Pop(0)
0x4d7: @@ add(Stack[-3]); Obj=1 // @poff=470
0x4d8: Pop(0)
0x4d9: Push((int) 3)
...
0x4df: @@ GetItemID(Stack[-3]); Obj=8 // @poff=474
0x4e0: Pop(0)
0x4e1: Push("Category") // @poff=484
0x4e2: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x4e3: Pop(1)
0x4e4: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=502
0x4e5: Pop(0)
0x4e6: Pop(0); Push((bool) Stack[-1] == 0)
0x4e7: IF (Stack[-1] == 0) GOTO 0x4eb; Pop(1)

0x4e8: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=510
0x4e9: Pop(0)
0x4ea: GOTO 0x4f0

0x4eb: PushEmpty(int, int)
0x4ec: Stack[-5] = Stack[-2]
0x4ed: Stack[-9] = Stack[-1]
0x4ee: Call2 0x4d2
...
0x4f3: Pop(0)
0x4f4: @@ add(Stack[-3]); Obj=1 // @poff=470
0x4f5: Pop(0)
0x4f6: Push((int) 14)
...
0x4fd: Pop(0)
0x4fe: @@ add(Stack[-3]); Obj=1 // @poff=470
0x4ff: Pop(0)
0x500: Push((int) 15)
...
0x529: Push(-1, 1); TaskCall(3)
0x52a: Call2 0xe4

0x52b: Pop(-1, 1); TaskReturn
0x52c: Pop(1)
0x52d: @ ResetAAS()
0x52e: Pop(0)
0x52f: Return(); Pop(0)
...
0x533: Push(-1, 1); TaskCall(3)
0x534: Call2 0xe4

0x535: Pop(-1, 1); TaskReturn
0x536: Pop(1)
0x537: @ ResetAAS()
0x538: Pop(0)
0x539: Return(); Pop(0)
...
0x576: Push(-1, 4); TaskCall(5)
0x577: Call2 0x25f

0x578: Pop(-1, 4); TaskReturn
0x579: Pop(1)
0x57a: Return(); Pop(2)
...
0x583: Stack[-7] = Stack[-3]
0x584: Stack[-2] = (float) 0.019999999552965164
0x585: Stack[-1] = (int) 0
0x586: Call2 0x3ac

0x587: Stack[-4] = Stack[-5]
0x588: Pop(4)
0x589: Push((int) 7)
0x58a: Push((float)0.019999999552965164)
0x58b: @ ReportHit(Stack[-5], Stack[-2], Stack[-3], Stack[-1])
0x58c: Pop(2)
0x58d: PushEmpty(float, object, float)
0x58e: Stack[-6] = Stack[-2]
0x58f: Stack[-1] = (float) 0.05000000074505806
0x590: Call2 0x3f5

0x591: Stack[-3] = Stack[-4]
0x592: Pop(3)
0x593: Push((int) 5)
0x594: Push((float)0.05000000074505806)
...
0x59a: Pop(0)
0x59b: Push("rat_big") // @poff=534
0x59c: @@ SetItemName(Stack[-1]); Obj=3 // @poff=550
0x59d: Pop(1)
0x59e: Push((float)0.5)
0x59f: Push((int) 1)
0x5a0: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x5a1: Pop(2)
0x5a2: Push("quality") // @poff=562
0x5a3: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=322
0x5a4: Pop(1)
0x5a5: PushEmpty(object, object, int)
0x5a6: Stack[-8] = Stack[-3]
0x5a7: Stack[-5] = Stack[-2]
0x5a8: Stack[-1] = (int) 1
0x5a9: Call2 0x4de
