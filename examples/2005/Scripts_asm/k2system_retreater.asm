...
Strings:
	...
	W:idle
	W:branch
// @pool_raw:
...
Events:
EVENT_22 Op = 0x81e Vars = (object, int, float, float)
EVENT_43 Op = 0x826 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x830 Vars = (object, string)
EVENT_41 Op = 0x832 Vars = (object)
...
0x23: Push("player") // @poff=14
0x24: @ FindActor(Stack[-4]T, Stack[-1])
0x25: Pop(1)
...
0x38: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x7f: Pop(0)
0x80: Push("all") // @poff=38
0x81: PushEmpty(string, int)
0x82: Stack[-7] = Stack[-1]
0x83: Call2 0x7d4
...
0xc7: Pop(0)
0xc8: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=46
0xc9: Pop(0)
...
0xe6: Stack[-1] = (float) 1.7453293800354004
0xe7: Call2 0xc5

0xe8: Stack[-2] = Stack[-7]
0xe9: Pop(2)
...
0xef: Stack[-1] = (float) 2.6179938316345215
0xf0: Call2 0xc5

0xf1: Stack[-2] = Stack[-7]
0xf2: Pop(2)
...
0xf7: Push("Can't retreat, distance: ") // @poff=58
...
0x10d: Push((int) 1)
0x10e: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x10f: Pop(1)
0x110: Push(Stack[-3])
0x111: IF (Stack[-1] == 0) GOTO 0x129; Pop(1)

0x112: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x117: Stack[-1] = (float) 2.6179938316345215
0x118: Call2 0xc5

0x119: Stack[-2] = Stack[-4]
0x11a: Pop(2)
...
0x12a: IF (Stack[-1] == 1) GOTO 0x10d; Pop(1)
...
0x131: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x140: Stack[-1] = (float) 1.7453293800354004
0x141: Call2 0xc5

0x142: Stack[-2] = Stack[-4]
0x143: Pop(2)
...
0x176: Stack[-2] = Stack[-3]
0x177: Pop(2)
0x178: PushEmpty(float, cvector, cvector)
0x179: Stack[-5] = Stack[-2]
0x17a: Stack[-4] = Stack[-1]
0x17b: Call2 0x781

0x17c: Pop(2)
0x17d: Push((float)-0.3420201241970062)
...
0x185: Pop(0)
0x186: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=110
0x187: Pop(1)
0x188: PushEmpty(object, bool, float)
0x189: Stack[-7] = Stack[-3]
0x18a: Stack[-6] = Stack[-2]
...
0x193: Stack[-1] = 0
0x194: PushEmpty()
0x195: Stack[-3] = (float) 0.029999999329447746
0x196: Return(); Pop(0)
...
0x1af: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1b0: Pop(0)
0x1b1: Push(Stack[-8])
0x1b2: IF (Stack[-1] == 0) GOTO 0x1bb; Pop(1)

0x1b3: Push("attack") // @poff=188
...
0x1cf: Pop(0)
0x1d0: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=202
0x1d1: Pop(0)
...
0x1eb: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=202
0x1ec: Pop(0)
...
0x205: Pop(1)
0x206: Push("all") // @poff=38
0x207: Push("attack_on") // @poff=216
...
0x21f: IF (Stack[-1] == 1) GOTO 0x225; Pop(1)

0x220: PushEmpty(bool)
0x221: Call2 0x3f1

0x222: Pop(0)
0x223: IF (Stack[-1] == 1) GOTO 0x225; Pop(1)

0x224: Stack[-1] = (bool) 0
0x225: IF (Stack[-1] == 0) GOTO 0x236; Pop(1)

0x226: @ Face(Stack[-0]T)
0x227: Pop(0)
0x228: PushEmpty()
0x229: Call2 0x423

0x22a: Pop(0)
0x22b: Push("all") // @poff=38
0x22c: Push("attack_stay") // @poff=236
0x22d: @ PlayAnimation(Stack[-2], Stack[-1])
0x22e: Pop(2)
0x22f: PushEmpty(bool, float)
0x230: Stack[-25] = Stack[-1]
0x231: Call2 0x36d
...
0x236: @ Face(Stack[-0]T)
0x237: Pop(0)
0x238: Push("all") // @poff=38
0x239: Push("fjump") // @poff=260
...
0x254: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=202
0x255: Pop(0)
...
0x273: Push("all") // @poff=38
0x274: Push("attack_off") // @poff=272
...
0x281: Push("all") // @poff=38
0x282: Push("attack_begin") // @poff=294
0x283: Push((int) 1)
0x284: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x28f: Push("attack") // @poff=188
0x290: Push((int) 1)
0x291: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x29b: Push("all") // @poff=38
0x29c: Push("bjump") // @poff=320
...
0x2a3: Push((float)0.8999999761581421)
0x2a4: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2a5: @ GetVictim(Stack[-1], Stack[-4])
0x2a6: Pop(1)
0x2a7: @ ReportAttack(Stack[-0]T)
0x2a8: Pop(0)
...
0x2ac: Stack[-6] = Stack[-2]
0x2ad: Stack[-10] = Stack[-1]
0x2ae: Call2 0x194

0x2af: Stack[-3] = Stack[-5]
0x2b0: Pop(3)
0x2b1: PushEmpty(float, object, float, int)
0x2b2: Stack[-7] = Stack[-3]
0x2b3: Stack[-6] = Stack[-2]
0x2b4: PushEmpty(int, object, int)
0x2b5: Stack[-10] = Stack[-2]
0x2b6: Stack[-14] = Stack[-1]
0x2b7: Call2 0x197

0x2b8: Stack[-3] = Stack[-4]
0x2b9: Pop(3)
0x2ba: Call2 0x613

0x2bb: Stack[-4] = Stack[-5]
0x2bc: Pop(4)
0x2bd: PushEmpty(int)
0x2be: Call2 0x421

0x2bf: Pop(0)
0x2c0: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2c1: Pop(1)
...
0x2d8: Pop(0)
0x2d9: Push("all") // @poff=38
0x2da: Push("attack_begin") // @poff=294
...
0x2ee: Stack[-11] = Stack[-2]
0x2ef: Stack[-6] = Stack[-1]
0x2f0: Call2 0x2a2

0x2f1: Pop(2)
0x2f2: Push("all") // @poff=38
0x2f3: Push("attack_middle") // @poff=332
...
0x2fb: Pop(0)
0x2fc: Push("all") // @poff=38
0x2fd: Push("attack_middle") // @poff=332
...
0x340: Pop(1)
0x341: Push("all") // @poff=38
0x342: Push("attack_end") // @poff=364
...
0x381: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=202
0x382: Pop(0)
...
0x3cd: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x3ce: Pop(1)
...
0x3d2: @ Face(Stack[-0]T)
0x3d3: Pop(0)
0x3d4: Push("all") // @poff=38
0x3d5: Push("bjump") // @poff=320
0x3d6: @ PlayAnimation(Stack[-2], Stack[-1])
0x3d7: Pop(2)
0x3d8: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=202
0x3d9: Pop(0)
...
0x40f: @ irand(Stack[-1], Stack[-2]T)
0x410: Pop(0)
0x411: Push((int) 1)
0x412: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x413: Push("attack") // @poff=188
...
0x424: Stack[-1] = "attack_stay" // @poff=236
0x425: Call2 0x736
...
0x44f: Stack[-15] = Stack[-5]
0x450: Stack[-14] = Stack[-4]
0x451: Stack[-13] = Stack[-3]
0x452: Stack[-12] = Stack[-2]
0x453: Stack[-11] = Stack[-1]
0x454: Call2 0x499

0x455: Stack[-6] = Stack[-7]
0x456: Pop(6)
0x457: Push( Stack[2 + Tasks[-1].StackPointer] )
0x458: IF (Stack[-1] == 0) GOTO 0x45c; Pop(1)

0x459: Push("head") // @poff=28
0x45a: @ UnlookAsync(Stack[-1])
0x45b: Pop(1)
0x45c: Push((int) 1)
0x45d: @ KillTimer(Stack[-1])
0x45e: Pop(1)
0x45f: Stack[-1] = Stack[-10]
0x460: Return(); Pop(4)
...
0x49c: Stack[-17] = Stack[-7]
0x49d: PushEmpty(bool, object)
0x49e: Stack[-23] = Stack[-1]
0x49f: Call2 0x525
...
0x4a5: @@ GetPosition(Stack[-5]); Obj=21 // @poff=46
0x4a6: Pop(0)
...
0x4bc: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=202
0x4bd: Pop(0)
...
0x4ce: Push((int) 0)
0x4cf: Push((float)0.30000001192092896)
...
0x4f1: Push((int) 0)
0x4f2: Push((float)0.30000001192092896)
...
0x527: Stack[-3] = Stack[-1]
0x528: Call2 0x685

0x529: Stack[-2] = Stack[-4]
0x52a: Pop(2)
0x52b: Return(); Pop(0)

0x52c: Stack[-1] = "walk" // @poff=422
0x52d: Return(); Pop(0)

0x52e: Stack[-1] = "run" // @poff=432
0x52f: Return(); Pop(0)
...
0x550: Pop(0); PushNull((bool) Stack[-21] == 0)
0x551: IF (Stack[-1] == 0) GOTO 0x557; Pop(1)

0x552: PushEmpty(string)
0x553: Stack[-1] = "fdie" // @poff=440
0x554: Call2 0x5aa

0x555: Pop(1)
0x556: GOTO 0x5a9

0x557: @@ GetPosition(Stack[-10]); Obj=21 // @poff=46
0x558: Pop(0)
...
0x568: Stack[-6] = "fdie" // @poff=440
0x569: GOTO 0x56b

0x56a: Stack[-6] = "bdie" // @poff=450
...
0x571: @ StopAsync()
0x572: Pop(0)
0x573: Stack[-21] = Stack[-5]
0x574: Push("GetScriptProperty") // @poff=460
0x575: Push((int) 2)
0x576: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x577: IF (Stack[-1] == 0) GOTO 0x583; Pop(1)

0x578: Push("Owner") // @poff=496
0x579: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=508
0x57a: Pop(1)
0x57b: Push(Stack[-4])
0x57c: IF (Stack[-1] == 0) GOTO 0x583; Pop(1)

0x57d: Push("Owner") // @poff=496
0x57e: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=526
0x57f: Pop(1)
0x580: Pop(0); PushNull((bool) Stack[-5] == 0)
0x581: IF (Stack[-1] == 0) GOTO 0x583; Pop(1)

0x582: Stack[-21] = Stack[-5]
0x583: Push("@GetEyesHeight") // @poff=544
0x584: Push((int) 1)
0x585: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x586: IF (Stack[-1] == 0) GOTO 0x592; Pop(1)

0x587: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=574
0x588: Pop(0)
0x589: Stack[-1] = [0.0, 0.0, 0.0]
0x58a: Push(CvectorIndex(Stack[-1], 1))
0x58b: Stack[-3] = Stack[-1]
0x58c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x58d: Push("head") // @poff=28
...
0x594: Stack[-7] = Stack[-1]
0x595: Call2 0x736

0x596: Pop(1)
0x597: Push("all") // @poff=38
...
0x59e: @ StopAsync()
0x59f: Pop(0)
0x5a0: Push("head") // @poff=28
0x5a1: @ UnlookAsync(Stack[-1])
0x5a2: Pop(1)
0x5a3: Push("all") // @poff=38
...
0x5d4: Stack[-2] = "bullet" // @poff=598
0x5d5: Return(); Pop(0)

0x5d6: Stack[-2] = "phys" // @poff=612
0x5d7: Return(); Pop(0)
...
0x5df: Pop(0)
0x5e0: @@ GetPosition(Stack[-1]); Obj=5 // @poff=46
0x5e1: Pop(0)
...
0x5e6: Pop(0)
0x5e7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=46
0x5e8: Pop(0)
...
0x5f2: Push("HasProperty") // @poff=622
0x5f3: Push((int) 2)
...
0x5f9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x5fa: Pop(0)
...
0x5ff: Stack[-10] = Stack[-2]
0x600: Stack[-9] = Stack[-1]
0x601: Call2 0x5f1
...
0x607: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=658
0x608: Pop(0)
0x609: PushEmpty(float, float, float, float)
0x60a: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x60b: Stack[-8] = Stack[-2]
0x60c: Stack[-7] = Stack[-1]
0x60d: Call2 0x776

0x60e: Pop(3)
0x60f: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=670
0x610: Pop(1)
...
0x615: Stack[-18] = Stack[-2]
0x616: Stack[-1] = "health" // @poff=682
0x617: Call2 0x5f1
...
0x61e: Stack[-18] = Stack[-2]
0x61f: Stack[-1] = "armor" // @poff=696
0x620: Call2 0x5f1
...
0x626: Push("armor") // @poff=696
0x627: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=658
0x628: Pop(1)
0x629: Push("armor_") // @poff=708
0x62a: PushEmpty(string, int)
0x62b: Stack[-16] = Stack[-1]
0x62c: Call2 0x5ca

0x62d: Pop(1)
0x62e: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x62f: PushEmpty(bool, object, string)
0x630: Stack[-18] = Stack[-2]
...
0x638: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=658
0x639: Pop(0)
...
0x640: Stack[-3] = Stack[-6]
0x641: Pop(3)
0x642: Push("health") // @poff=682
0x643: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=658
0x644: Pop(1)
0x645: Push((int) 1)
0x646: Pop(1); Push(Stack[-1] - Stack[-4]);
0x647: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x648: Push("health") // @poff=682
...
0x64e: Pop(3)
0x64f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=670
0x650: Pop(2)
0x651: PushEmpty(bool, object)
0x652: Stack[-17] = Stack[-1]
0x653: Call2 0x5ec
...
0x659: Pop(1)
0x65a: Stack[-1] = Stack[-16]
0x65b: Return(); Pop(12)

0x65c: PushEmpty(bool, bool)
0x65d: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x65e: Pop(0)
0x65f: Stack[-1] = Stack[-4]
0x660: Return(); Pop(2)

0x661: PushEmpty(object, object, object, object)
0x662: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x676: Pop(0)
0x677: Pop(0); PushNull((bool) Stack[-2] == 0)
0x678: IF (Stack[-1] == 0) GOTO 0x67b; Pop(1)

0x679: Stack[-6] = (bool) 0
0x67a: Return(); Pop(4)

0x67b: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x67c: Pop(0)
...
0x68f: Stack[-6] = Stack[-2]
0x690: Stack[-1] = "noaccess" // @poff=752
0x691: Call2 0x5f1
...
0x697: Push("noaccess") // @poff=752
0x698: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=658
0x699: Pop(1)
0x69a: Push((int) 0)
...
0x69e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6ac: @@ GetPosition(Stack[-5]); Obj=15 // @poff=46
0x6ad: Pop(0)
...
0x6bd: Stack[-1] = "fhit" // @poff=770
0x6be: GOTO 0x6c0

0x6bf: Stack[-1] = "bhit" // @poff=780
0x6c0: Push("hit_react") // @poff=790
0x6c1: Push("1") // @poff=810
0x6c2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6c3: Push("2") // @poff=814
...
0x6dc: Stack[-25] = Stack[-1]
0x6dd: Call2 0x5dd

0x6de: Stack[-2] = Stack[-3]
0x6df: Pop(2)
0x6e0: Call2 0x765
...
0x6fb: Pop(0)
0x6fc: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=827
0x6fd: Pop(0)
0x6fe: PushEmpty(object, int, float, cvector, cvector)
0x6ff: Stack[-26] = Stack[-5]
0x700: Stack[-25] = Stack[-4]
0x701: Stack[-24] = Stack[-3]
0x702: Stack[-6] = Stack[-2]
...
0x71c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=46
0x71d: Pop(0)
...
0x72c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=574
0x72d: Pop(0)
0x72e: Stack[-1] = [0.0, 0.0, 0.0]
0x72f: Push(CvectorIndex(Stack[-1], 1))
0x730: Stack[-3] = Stack[-1]
0x731: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x732: Push("head") // @poff=28
...
0x772: Stack[-2] = Stack[-3]
0x773: GOTO 0x775

0x774: Stack[-1] = Stack[-3]
0x775: Return(); Pop(0)
...
0x7a3: Stack[-8] = Stack[-5]
0x7a4: Stack[-4] = "reputation" // @poff=877
...
0x7ae: Pop(0)
0x7af: @@ add(Stack[-3]); Obj=1 // @poff=818
0x7b0: Pop(0)
0x7b1: Push((int) 15)
0x7b2: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7b3: Pop(1)
0x7b4: Return(); Pop(2)

0x7b5: Stack[-1] = 0
0x7b6: PushEmpty(object, object)
0x7b7: @ CreateFloatVector(Stack[-1])
0x7b8: Pop(0)
0x7b9: @@ add(Stack[-3]); Obj=1 // @poff=818
0x7ba: Pop(0)
0x7bb: Push((int) 16)
0x7bc: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7bd: Pop(1)
0x7be: Return(); Pop(2)

0x7bf: Stack[-1] = 0
0x7c0: PushEmpty(bool, bool)
0x7c1: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7c2: Pop(0)
0x7c3: Push(Stack[-1])
0x7c4: IF (Stack[-1] == 0) GOTO 0x7c8; Pop(1)

0x7c5: Push("attack") // @poff=188
0x7c6: @ PlayGlobalMusic(Stack[-1])
0x7c7: Pop(1)
0x7c8: Return(); Pop(2)

0x7c9: PushEmpty(object, object)
0x7ca: @ GetScene(Stack[-1])
0x7cb: Pop(0)
0x7cc: Push("battle") // @poff=899
0x7cd: PushEmpty(object)
0x7ce: Call2 0x75f

0x7cf: Pop(0)
0x7d0: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x7d1: Pop(2)
0x7d2: Return(); Pop(2)

0x7d3: Stack[-1] = 0
0x7d4: PushEmpty(string, string)
0x7d5: Stack[-1] = "idle" // @poff=913
0x7d6: Push(Stack[-3])
0x7d7: IF (Stack[-1] == 0) GOTO 0x7d9; Pop(1)

0x7d8: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x7d9: Stack[-1] = Stack[-4]
0x7da: Return(); Pop(2)

0x7db: PushEmpty(int, bool, int, bool)
0x7dc: Stack[-2] = (int) 0
0x7dd: Push("all") // @poff=38
0x7de: PushEmpty(string, int)
0x7df: Stack[-5] = Stack[-1]
0x7e0: Call2 0x7d4

0x7e1: Pop(1)
0x7e2: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7e3: Pop(2)
...
0x7e7: Push((int) 1)
0x7e8: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x7e9: GOTO 0x7dd

0x7ea: Stack[-2] = Stack[-5]
0x7eb: Return(); Pop(4)

0x7ec: PushEmpty(int, int)
0x7ed: Push("branch") // @poff=923
...
0x800: @ GetScene(Stack[-1])
0x801: Pop(0)
0x802: PushEmpty(object)
0x803: Call2 0x75f

0x804: Pop(0)
0x805: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=110
0x806: Pop(1)
0x807: Return(); Pop(2)
...
0x810: Stack[-4] = Stack[-2]
0x811: Stack[-1] = (float) -0.10000000149011612
0x812: Call2 0x789
...
0x816: Pop(0)
0x817: PushEmpty(object)
0x818: Stack[-2] = Stack[-1]
0x819: Push(-1, 0); TaskCall(4)
0x81a: Call2 0x530

0x81b: Pop(-1, 0); TaskReturn
0x81c: Pop(1)
0x81d: Return(); Pop(0)

0x81e: PushEmpty()
0x81f: PushEmpty(object, int, float)
0x820: Stack[-7] = Stack[-3]
0x821: Stack[-6] = Stack[-2]
...
0x826: PushEmpty()
0x827: PushEmpty(object, int, float, cvector, cvector)
0x828: Stack[-11] = Stack[-5]
0x829: Stack[-10] = Stack[-4]
0x82a: Stack[-9] = Stack[-3]
0x82b: Stack[-7] = Stack[-2]
0x82c: Stack[-6] = Stack[-1]
0x82d: Call2 0x70d
...
0x83c: Stack[-2] = Stack[-4]
0x83d: Pop(2)
0x83e: Return(); Pop(0)

0x83f: PushEmpty()
0x840: PushEmpty(object, bool)
0x841: Stack[-3] = Stack[-2]
0x842: Stack[-1] = (bool) 1
0x843: Push(-2, 6); TaskCall(2)
0x844: Call2 0x180

0x845: Pop(-2, 6); TaskReturn
0x846: Pop(2)
0x847: Return(); Pop(0)
