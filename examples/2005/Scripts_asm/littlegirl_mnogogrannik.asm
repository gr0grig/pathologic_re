...
Strings:
	...
	W:beta_pills
	W:gamma_pills
// @pool_raw:
...
0x46: Stack[-9] = Stack[-3]
0x47: Stack[-8] = Stack[-2]
0x48: Stack[-7] = Stack[-1]
0x49: Call2 0x96a
...
0x4d: Stack[-8] = Stack[-2]
0x4e: Stack[-6] = Stack[-1]
0x4f: Call2 0x843

0x50: Stack[-3] = Stack[-4]
0x51: Pop(3)
0x52: Push((int) 0)
...
0x76: Stack[-7] = Stack[-2]
0x77: Stack[-6] = Stack[-1]
0x78: Call2 0x788
...
0x85: Stack[-6] = Stack[-2]
0x86: Stack[-7] = Stack[-1]
0x87: Call2 0x89c

0x88: Stack[-3] = Stack[-4]
0x89: Pop(3)
0x8a: Push((int) 0)
...
0xfd: Stack[-7] = Stack[-1]
0xfe: Call2 0x820

0xff: Stack[-2] = Stack[-3]
0x100: Pop(2)
0x101: Push((int) 0)
...
0x19f: Stack[-9] = Stack[-3]
0x1a0: Stack[-8] = Stack[-2]
...
0x1a6: Stack[-8] = Stack[-2]
0x1a7: Stack[-6] = Stack[-1]
0x1a8: Call2 0x843

0x1a9: Stack[-3] = Stack[-4]
0x1aa: Pop(3)
0x1ab: Push((int) 0)
...
0x1cf: Stack[-7] = Stack[-2]
0x1d0: Stack[-6] = Stack[-1]
0x1d1: Call2 0x788
...
0x1de: Stack[-6] = Stack[-2]
0x1df: Stack[-7] = Stack[-1]
0x1e0: Call2 0x89c

0x1e1: Stack[-3] = Stack[-4]
0x1e2: Pop(3)
0x1e3: Push((int) 0)
...
0x237: Pop(0)
0x238: Push("all") // @poff=0
0x239: PushEmpty(string, int)
0x23a: Stack[-7] = Stack[-1]
0x23b: Call2 0x808
...
0x2d1: Stack[-9] = Stack[-3]
0x2d2: Stack[-8] = Stack[-2]
...
0x2d8: Stack[-8] = Stack[-2]
0x2d9: Stack[-6] = Stack[-1]
0x2da: Call2 0x843

0x2db: Stack[-3] = Stack[-4]
0x2dc: Pop(3)
0x2dd: Push((int) 0)
...
0x301: Stack[-7] = Stack[-2]
0x302: Stack[-6] = Stack[-1]
0x303: Call2 0x788
...
0x35a: Stack[-2] = Stack[-3]
0x35b: Pop(2)
0x35c: PushEmpty(float, cvector, cvector)
0x35d: Stack[-5] = Stack[-2]
0x35e: Stack[-4] = Stack[-1]
0x35f: Call2 0x766

0x360: Pop(2)
0x361: Push((float)0.4999999701976776)
...
0x3a3: Pop(0)
0x3a4: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x3a5: Pop(0)
...
0x3c2: Stack[-1] = (float) 1.7453293800354004
0x3c3: Call2 0x3a1

0x3c4: Stack[-2] = Stack[-7]
0x3c5: Pop(2)
...
0x3cb: Stack[-1] = (float) 2.6179938316345215
0x3cc: Call2 0x3a1

0x3cd: Stack[-2] = Stack[-7]
0x3ce: Pop(2)
...
0x3d3: Push("Can't retreat, distance: ") // @poff=96
...
0x3e9: Push((int) 1)
0x3ea: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3eb: Pop(1)
0x3ec: Push(Stack[-3])
0x3ed: IF (Stack[-1] == 0) GOTO 0x405; Pop(1)

0x3ee: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x406: IF (Stack[-1] == 1) GOTO 0x3e9; Pop(1)
...
0x40d: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x41c: Stack[-1] = (float) 1.7453293800354004
0x41d: Call2 0x3a1

0x41e: Stack[-2] = Stack[-4]
0x41f: Pop(2)
...
0x42c: IF (Stack[-1] == 1) GOTO 0x432; Pop(1)

0x42d: PushEmpty(bool)
0x42e: Call2 0x44c

0x42f: Pop(0)
0x430: IF (Stack[-1] == 1) GOTO 0x432; Pop(1)
...
0x452: Stack[-2] = Stack[-3]
0x453: Pop(2)
0x454: PushEmpty(float, cvector, cvector)
0x455: Stack[-5] = Stack[-2]
0x456: Stack[-4] = Stack[-1]
0x457: Call2 0x74b

0x458: Pop(2)
0x459: Push((float)-0.3420201241970062)
...
0x45e: Pop(0)
0x45f: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x460: Pop(0)
...
0x47d: Stack[-1] = (float) 1.7453293800354004
0x47e: Call2 0x45c

0x47f: Stack[-2] = Stack[-7]
0x480: Pop(2)
...
0x486: Stack[-1] = (float) 2.6179938316345215
0x487: Call2 0x45c
...
0x48e: Push("Can't retreat, distance: ") // @poff=96
...
0x4a4: Push((int) 1)
0x4a5: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x4a6: Pop(1)
0x4a7: Push(Stack[-3])
...
0x4c1: IF (Stack[-1] == 1) GOTO 0x4a4; Pop(1)
...
0x4c8: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4d7: Stack[-1] = (float) 1.7453293800354004
0x4d8: Call2 0x45c

0x4d9: Stack[-2] = Stack[-4]
0x4da: Pop(2)
...
0x4e7: IF (Stack[-1] == 1) GOTO 0x4ed; Pop(1)

0x4e8: PushEmpty(bool)
0x4e9: Call2 0x507

0x4ea: Pop(0)
0x4eb: IF (Stack[-1] == 1) GOTO 0x4ed; Pop(1)
...
0x50d: Stack[-2] = Stack[-3]
0x50e: Pop(2)
0x50f: PushEmpty(float, cvector, cvector)
0x510: Stack[-5] = Stack[-2]
0x511: Stack[-4] = Stack[-1]
0x512: Call2 0x74b

0x513: Pop(2)
0x514: Push((float)-0.3420201241970062)
...
0x520: Pop(0)
0x521: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x522: Pop(0)
...
0x53f: Stack[-1] = (float) 1.7453293800354004
0x540: Call2 0x51e

0x541: Stack[-2] = Stack[-7]
0x542: Pop(2)
...
0x548: Stack[-1] = (float) 2.6179938316345215
0x549: Call2 0x51e

0x54a: Stack[-2] = Stack[-7]
0x54b: Pop(2)
...
0x550: Push("Can't retreat, distance: ") // @poff=96
...
0x566: Push((int) 1)
0x567: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x568: Pop(1)
0x569: Push(Stack[-3])
0x56a: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x56b: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x583: IF (Stack[-1] == 1) GOTO 0x566; Pop(1)
...
0x58a: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x599: Stack[-1] = (float) 1.7453293800354004
0x59a: Call2 0x51e

0x59b: Stack[-2] = Stack[-4]
0x59c: Pop(2)
...
0x5a9: IF (Stack[-1] == 1) GOTO 0x5af; Pop(1)

0x5aa: PushEmpty(bool)
0x5ab: Call2 0x5c9

0x5ac: Pop(0)
0x5ad: IF (Stack[-1] == 1) GOTO 0x5af; Pop(1)
...
0x5cf: Stack[-2] = Stack[-3]
0x5d0: Pop(2)
0x5d1: PushEmpty(float, cvector, cvector)
0x5d2: Stack[-5] = Stack[-2]
0x5d3: Stack[-4] = Stack[-1]
0x5d4: Call2 0x74b

0x5d5: Pop(2)
0x5d6: Push((float)-0.3420201241970062)
...
0x5e2: Pop(0)
0x5e3: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=84
0x5e4: Pop(0)
...
0x601: Stack[-1] = (float) 1.7453293800354004
0x602: Call2 0x5e0

0x603: Stack[-2] = Stack[-7]
0x604: Pop(2)
...
0x60a: Stack[-1] = (float) 2.6179938316345215
0x60b: Call2 0x5e0

0x60c: Stack[-2] = Stack[-7]
0x60d: Pop(2)
...
0x612: Push("Can't retreat, distance: ") // @poff=96
...
0x628: Push((int) 1)
0x629: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x62a: Pop(1)
0x62b: Push(Stack[-3])
0x62c: IF (Stack[-1] == 0) GOTO 0x644; Pop(1)

0x62d: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x645: IF (Stack[-1] == 1) GOTO 0x628; Pop(1)
...
0x64c: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x65b: Stack[-1] = (float) 1.7453293800354004
0x65c: Call2 0x5e0

0x65d: Stack[-2] = Stack[-4]
0x65e: Pop(2)
...
0x66b: IF (Stack[-1] == 1) GOTO 0x671; Pop(1)
...
0x694: Stack[-5] = Stack[-2]
0x695: Stack[-4] = Stack[-1]
0x696: Call2 0x74b

0x697: Pop(2)
0x698: Push((float)-0.3420201241970062)
...
0x6a2: Pop(0)
0x6a3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=84
0x6a4: Pop(0)
...
0x6a9: Pop(0)
0x6aa: @@ GetPosition(Stack[-2]); Obj=7 // @poff=84
0x6ab: Pop(0)
...
0x6b5: Push("HasProperty") // @poff=148
0x6b6: Push((int) 2)
...
0x6bc: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=172
0x6bd: Pop(0)
0x6be: Stack[-1] = Stack[-5]
0x6bf: Return(); Pop(2)

0x6c0: PushEmpty(bool, bool)
0x6c1: @@ IsDead(Stack[-1]); Obj=3 // @poff=184
0x6c2: Pop(0)
0x6c3: Stack[-1] = Stack[-4]
0x6c4: Return(); Pop(2)

0x6c5: PushEmpty(object, object, object, object)
0x6c6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6da: Pop(0)
0x6db: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6dc: IF (Stack[-1] == 0) GOTO 0x6df; Pop(1)

0x6dd: Stack[-6] = (bool) 0
0x6de: Return(); Pop(4)

0x6df: @@ GetScene(Stack[-1]); Obj=5 // @poff=205
0x6e0: Pop(0)
...
0x6f3: Stack[-6] = Stack[-2]
0x6f4: Stack[-1] = "noaccess" // @poff=214
0x6f5: Call2 0x6b4
...
0x6fb: Push("noaccess") // @poff=214
0x6fc: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=232
0x6fd: Pop(1)
0x6fe: Push((int) 0)
...
0x702: @@ GetPosition(Stack[-3]); Obj=7 // @poff=84
0x703: Pop(0)
...
0x71e: Stack[-7] = Stack[-2]
0x71f: Stack[-6] = Stack[-1]
0x720: Call2 0x746
...
0x729: Stack[-10] = Stack[-2]
0x72a: Stack[-9] = Stack[-1]
0x72b: Call2 0x746
...
0x7b1: Push("player_shot") // @poff=278
...
0x7d0: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=316
0x7d1: Pop(0)
...
0x857: Stack[-9] = Stack[-2]
0x858: Stack[-1] = "class" // @poff=368
0x859: Call2 0x6b4
...
0x85f: Push("class") // @poff=368
0x860: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=232
0x861: Pop(1)
0x862: Push("rat") // @poff=380
...
0x8bc: Push(Stack[-1])
0x8bd: IF (Stack[-1] == 1) GOTO 0x8c6; Pop(1)

0x8be: PushEmpty(float, object)
0x8bf: Stack[-5] = Stack[-1]
0x8c0: Call2 0x6a7
...
0x8ef: Push("reputation") // @poff=426
0x8f0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=232
0x8f1: Pop(1)
0x8f2: Stack[-1] = Stack[-5]
0x8f3: Return(); Pop(4)
...
0x909: Stack[-4] = "rifle_ammo" // @poff=448
0x90a: Stack[-3] = (int) 1
0x90b: Stack[-2] = (int) 2
0x90c: Stack[-1] = (int) 2
0x90d: Call2 0x727
...
0x910: Stack[-4] = "revolver_ammo" // @poff=470
0x911: Stack[-3] = (int) 1
0x912: Stack[-2] = (int) 2
0x913: Stack[-1] = (int) 2
0x914: Call2 0x727
...
0x917: Stack[-4] = "samopal_ammo" // @poff=498
0x918: Stack[-3] = (int) 2
0x919: Stack[-2] = (int) 2
0x91a: Stack[-1] = (int) 2
0x91b: Call2 0x727
...
0x91f: Stack[-3] = "lockpick" // @poff=524
0x920: Stack[-2] = (int) 1
0x921: Stack[-1] = (int) 4
0x922: Call2 0x71c
...
0x925: Stack[-4] = "alpha_pills" // @poff=542
0x926: Stack[-3] = (int) 1
0x927: Stack[-2] = (int) 2
0x928: Stack[-1] = (int) 3
0x929: Call2 0x727
...
0x92c: Stack[-3] = "meradorm" // @poff=566
0x92d: Stack[-2] = (int) 1
0x92e: Stack[-1] = (int) 2
0x92f: Call2 0x71c
...
0x93f: Stack[-3] = "beta_pills" // @poff=598
0x940: Stack[-2] = (int) 1
0x941: Stack[-1] = (int) 2
0x942: Call2 0x71c
...
0x948: Stack[-3] = "gamma_pills" // @poff=620
0x949: Stack[-2] = (int) 1
0x94a: Stack[-1] = (int) 7
0x94b: Call2 0x71c
...
0x950: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x966: Pop(0)
0x967: Push((float)0.20000000298023224)
0x968: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0x969: Return(); Pop(0)
