...
Strings:
	...
	A:GetEyesHeight
	W:dance
// @pool_raw:70006c006100790065007200000061006c006c00000068006500610064000000476574506f736974696f6e004765744579657348656967687400640061006e00630065000000
...
0x4d: Pop(0)
0x4e: @@ GetPosition(Stack[-2]); Obj=7 // @poff=32
0x4f: Pop(0)
...
0x72: Stack[-2] = Stack[-5]
0x73: Return(); Pop(4)

0x74: PushEmpty(string, string)
0x75: Stack[-1] = "dance" // @poff=58
0x76: Push(Stack[-3])
...
0x7c: Pop(0); PushNull((bool) Stack[-3] == 0)
