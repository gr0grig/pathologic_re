...
Strings:
	...
	W:gameover.xml
	W:player
// @pool_raw:640061006e006b006f005f00640065006100740068002e006d006f0074000000670061006d0065006f007600650072002e0078006d006c00000070006c0061007900650072000000
...
0x0: @ RemoveOverride()
0x1: Pop(0)
0x2: Push((float)0.15000000596046448)
...
0xb: Pop(1)
0xc: Push("danko_death.mot") // @poff=0
0xd: Push((bool) 1)
...
0x1a: Pop(0)
0x1b: Push("gameover.xml") // @poff=32
