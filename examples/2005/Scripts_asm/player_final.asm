...
Strings:
	...
	W:stone
	W:step_
// @pool_raw:
...
0x36: Stack[-2] = "carpet" // @poff=142
0x37: Return(); Pop(0)

0x38: Stack[-2] = "stone" // @poff=156
0x39: Return(); Pop(0)
...
0x5e: Stack[-9] = Stack[-1]
0x5f: Call2 0x1a

0x60: Stack[-2] = Stack[-8]
0x61: Pop(2)
0x62: Stack[-5] = (int) 0
0x63: Push("step_") // @poff=168
...
0x9e: Pop(0)
0x9f: Push((int) 11)
0xa0: Push((float)0.15000000596046448)
...
0xbd: Pop(0)
0xbe: Push((int) 10)
0xbf: Push((float)0.3499999940395355)
...
0xc8: Pop(0)
0xc9: Push((int) 12)
0xca: Push((float)0.6000000238418579)
