...
0x44: Stack[-3] = (int) 0
0x45: Stack[-5] = Stack[-2]
0x46: Stack[-6] = Stack[-1]
0x47: Call2 0x177
...
0x5d: Stack[-5] = Stack[-2]
0x5e: Stack[-6] = Stack[-1]
0x5f: Call2 0x177
...
0x69: Stack[-9] = Stack[-3]
0x6a: Stack[-8] = Stack[-2]
...
0x7f: Stack[-10] = Stack[-4]
0x80: Stack[-9] = Stack[-3]
0x81: Stack[-8] = Stack[-2]
...
0x88: Pop(0)
0x89: @@ GetPosition(Stack[-1]); Obj=5 // @poff=0
0x8a: Pop(0)
...
0xff: Stack[-1] = "hit_physical1" // @poff=48
0x100: Call2 0xd5

0x101: Pop(1)
0x102: PushEmpty(string)
0x103: Stack[-1] = "scream_physical1" // @poff=76
0x104: Call2 0xef
...
0x10b: Stack[-1] = "hit_physical2" // @poff=110
0x10c: Call2 0xd5

0x10d: Pop(1)
0x10e: PushEmpty(string)
0x10f: Stack[-1] = "scream_physical2" // @poff=138
0x110: Call2 0xef
...
0x117: Stack[-1] = "hit_bullet" // @poff=172
0x118: Call2 0xd5

0x119: Pop(1)
0x11a: PushEmpty(string)
0x11b: Stack[-1] = "scream_bullet" // @poff=194
0x11c: Call2 0xef
...
0x123: Stack[-1] = "hit_oscoloc" // @poff=222
0x124: Call2 0xd5

0x125: Pop(1)
0x126: PushEmpty(string)
0x127: Stack[-1] = "scream_oscoloc" // @poff=246
0x128: Call2 0xef
...
0x12f: Stack[-1] = "hit_mental" // @poff=276
0x130: Call2 0xd5

0x131: Pop(1)
0x132: PushEmpty(string)
0x133: Stack[-1] = "scream_mental" // @poff=298
0x134: Call2 0xef
...
0x13b: Stack[-1] = "hit_rat" // @poff=326
0x13c: Call2 0xd5

0x13d: Pop(1)
0x13e: PushEmpty(string)
0x13f: Stack[-1] = "scream_rat" // @poff=342
0x140: Call2 0xef
...
0x15d: Push("GetPosition") // @poff=364
0x15e: Push((int) 1)
...
0x167: Stack[-9] = Stack[-1]
0x168: Call2 0x86

0x169: Stack[-2] = Stack[-3]
0x16a: Pop(2)
0x16b: Call2 0x93
...
0x17e: Push((int) 1)
0x17f: Push((float)0.10000000149011612)
