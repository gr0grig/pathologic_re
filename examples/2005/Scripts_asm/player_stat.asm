...
Strings:
	...
	W:health
	W:sleeping
// @pool_raw:4400690073006500610073006500530070006500650064000000680075006e00670065007200000069006d006d0075006e00690074007900000064006900730065006100730065000000740069007200650064006e0065007300730000006800650061006c0074006800000073006c0065006500700069006e0067000000
...
0x10: Push("DiseaseSpeed") // @poff=0
0x11: @ GetProperty(Stack[-1], Stack[-7])
0x12: Pop(1)
0x13: PushEmpty(bool, string, float, float, float)
0x14: Stack[-4] = "hunger" // @poff=26
0x15: Push((float)0.0416666679084301)
...
0x1a: Pop(5)
0x1b: Push("hunger") // @poff=26
0x1c: @ GetProperty(Stack[-1], Stack[-6])
0x1d: Pop(1)
0x1e: Push("immunity") // @poff=40
...
0x38: Stack[-4] = (int) 0
0x39: Push("immunity") // @poff=40
0x3a: @ SetProperty(Stack[-1], Stack[-5])
0x3b: Pop(1)
0x3c: Push("disease") // @poff=58
0x3d: @ GetProperty(Stack[-1], Stack[-4])
0x3e: Pop(1)
0x3f: Push((float)0.0010000000474974513)
...
0x9c: Push("sleeping") // @poff=108
0x9d: @ GetProperty(Stack[-1], Stack[-2])
0x9e: Pop(1)
0x9f: Stack[-1] = Stack[-5]
0xa0: Return(); Pop(4)
