...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x84a Vars = (object, int, float, float)
EVENT_43 Op = 0x852 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x85c Vars = (object, string)
EVENT_41 Op = 0x869 Vars = (object)
...
0x129: @ GetPFPosition(Stack[-1]T)
0x12a: Pop(0)
0x12b: @ GetDirection(Stack[-0]T)
0x12c: Pop(0)
0x12d: PushEmpty()
0x12e: Call2 0x17c
...
0x14a: @ FindPathTo(Stack[-1], Stack[-1]T)
0x14b: Pop(0)
...
0x159: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x15a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x16c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x16d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x185: PushEmpty()
0x186: Stack[-3] = (float) 0.10000000149011612
0x187: Return(); Pop(0)
...
0x1a0: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1a1: Pop(0)
0x1a2: Push(Stack[-8])
0x1a3: IF (Stack[-1] == 0) GOTO 0x1ac; Pop(1)

0x1a4: Push("attack") // @poff=212
...
0x1c0: Pop(0)
0x1c1: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=226
0x1c2: Pop(0)
...
0x1dc: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=226
0x1dd: Pop(0)
...
0x210: IF (Stack[-1] == 1) GOTO 0x216; Pop(1)

0x211: PushEmpty(bool)
0x212: Call2 0x3e2

0x213: Pop(0)
0x214: IF (Stack[-1] == 1) GOTO 0x216; Pop(1)
...
0x228: Pop(0)
0x229: Push("all") // @poff=138
0x22a: Push("fjump") // @poff=284
...
0x245: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=226
0x246: Pop(0)
...
0x265: Push("attack_off") // @poff=296
...
0x273: Push("attack_begin") // @poff=318
0x274: Push((int) 1)
0x275: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x280: Push("attack") // @poff=212
0x281: Push((int) 1)
0x282: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x294: Push((float)0.8999999761581421)
0x295: Pop(1); Push(Stack[-9] * Stack[-1]);
0x296: @ GetVictim(Stack[-1], Stack[-4])
0x297: Pop(1)
0x298: @ ReportAttack(Stack[-0]T)
0x299: Pop(0)
...
0x29d: Stack[-6] = Stack[-2]
0x29e: Stack[-10] = Stack[-1]
0x29f: Call2 0x185

0x2a0: Stack[-3] = Stack[-5]
0x2a1: Pop(3)
0x2a2: PushEmpty(float, object, float, int)
0x2a3: Stack[-7] = Stack[-3]
0x2a4: Stack[-6] = Stack[-2]
0x2a5: PushEmpty(int, object, int)
0x2a6: Stack[-10] = Stack[-2]
0x2a7: Stack[-14] = Stack[-1]
0x2a8: Call2 0x188
...
0x2ac: Stack[-4] = Stack[-5]
0x2ad: Pop(4)
0x2ae: PushEmpty(int)
0x2af: Call2 0x412

0x2b0: Pop(0)
0x2b1: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2b2: Pop(1)
0x2b3: PushEmpty(object, float)
0x2b4: Stack[-5] = Stack[-2]
...
0x2bd: Pop(0)
0x2be: @ irand(Stack[-4], Stack[-1]T)
0x2bf: Pop(0)
0x2c0: Push((int) 1)
0x2c1: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x2c2: @ Face(Stack[-0]T)
0x2c3: Pop(0)
0x2c4: Push((bool) 1)
...
0x2c9: Pop(0)
0x2ca: Push("all") // @poff=138
0x2cb: Push("attack_begin") // @poff=318
...
0x2df: Stack[-11] = Stack[-2]
0x2e0: Stack[-6] = Stack[-1]
0x2e1: Call2 0x293

0x2e2: Pop(2)
0x2e3: Push("all") // @poff=138
0x2e4: Push("attack_middle") // @poff=356
...
0x2ec: Pop(0)
0x2ed: Push("all") // @poff=138
0x2ee: Push("attack_middle") // @poff=356
...
0x302: Stack[-11] = Stack[-2]
0x303: Stack[-6] = Stack[-1]
0x304: Call2 0x293

0x305: Pop(2)
0x306: Stack[-2] = (int) 1
0x307: Push("attack_middle") // @poff=356
0x308: Pop(1); Push(Stack[-1] + Stack[-5]);
0x309: Push("_") // @poff=384
...
0x328: Stack[-11] = Stack[-2]
0x329: Stack[-6] = Stack[-1]
0x32a: Call2 0x293
...
0x333: Push("attack_end") // @poff=388
...
0x372: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=226
0x373: Pop(0)
...
0x3be: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x3bf: Pop(1)
...
0x3c3: @ Face(Stack[-0]T)
0x3c4: Pop(0)
0x3c5: Push("all") // @poff=138
0x3c6: Push("bjump") // @poff=344
0x3c7: @ PlayAnimation(Stack[-2], Stack[-1])
0x3c8: Pop(2)
0x3c9: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=226
0x3ca: Pop(0)
...
0x400: @ irand(Stack[-1], Stack[-2]T)
0x401: Pop(0)
0x402: Push((int) 1)
0x403: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x404: Push("attack") // @poff=212
...
0x415: Stack[-1] = "attack_stay" // @poff=260
0x416: Call2 0x762
...
0x440: Stack[-15] = Stack[-5]
0x441: Stack[-14] = Stack[-4]
0x442: Stack[-13] = Stack[-3]
0x443: Stack[-12] = Stack[-2]
0x444: Stack[-11] = Stack[-1]
0x445: Call2 0x48a

0x446: Stack[-6] = Stack[-7]
0x447: Pop(6)
0x448: Push( Stack[2 + Tasks[-1].StackPointer] )
0x449: IF (Stack[-1] == 0) GOTO 0x44d; Pop(1)

0x44a: Push("head") // @poff=446
...
0x48d: Stack[-17] = Stack[-7]
0x48e: PushEmpty(bool, object)
0x48f: Stack[-23] = Stack[-1]
0x490: Call2 0x516
...
0x496: @@ GetPosition(Stack[-5]); Obj=21 // @poff=456
0x497: Pop(0)
...
0x4ad: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=226
0x4ae: Pop(0)
...
0x4bf: Push((int) 0)
0x4c0: Push((float)0.30000001192092896)
...
0x4e2: Push((int) 0)
0x4e3: Push((float)0.30000001192092896)
...
0x51a: Stack[-2] = Stack[-4]
0x51b: Pop(2)
0x51c: Return(); Pop(0)

0x51d: Stack[-1] = "walk" // @poff=468
0x51e: Return(); Pop(0)

0x51f: Stack[-1] = "run" // @poff=478
0x520: Return(); Pop(0)
...
0x53b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x53c: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x53d: PushEmpty(string)
0x53e: Stack[-1] = "fdie" // @poff=486
0x53f: Call2 0x595

0x540: Pop(1)
0x541: GOTO 0x594

0x542: @@ GetPosition(Stack[-10]); Obj=21 // @poff=456
0x543: Pop(0)
...
0x553: Stack[-6] = "fdie" // @poff=486
0x554: GOTO 0x556

0x555: Stack[-6] = "bdie" // @poff=496
...
0x55c: @ StopAsync()
0x55d: Pop(0)
0x55e: Stack[-21] = Stack[-5]
0x55f: Push("GetScriptProperty") // @poff=506
0x560: Push((int) 2)
0x561: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x562: IF (Stack[-1] == 0) GOTO 0x56e; Pop(1)

0x563: Push("Owner") // @poff=542
0x564: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=554
0x565: Pop(1)
0x566: Push(Stack[-4])
0x567: IF (Stack[-1] == 0) GOTO 0x56e; Pop(1)

0x568: Push("Owner") // @poff=542
0x569: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=572
0x56a: Pop(1)
0x56b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x56c: IF (Stack[-1] == 0) GOTO 0x56e; Pop(1)

0x56d: Stack[-21] = Stack[-5]
0x56e: Push("@GetEyesHeight") // @poff=590
0x56f: Push((int) 1)
0x570: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x571: IF (Stack[-1] == 0) GOTO 0x57d; Pop(1)

0x572: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=620
0x573: Pop(0)
0x574: Stack[-1] = [0.0, 0.0, 0.0]
0x575: Push(CvectorIndex(Stack[-1], 1))
0x576: Stack[-3] = Stack[-1]
0x577: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x578: Push("head") // @poff=446
...
0x589: @ StopAsync()
0x58a: Pop(0)
0x58b: Push("head") // @poff=446
0x58c: @ UnlookAsync(Stack[-1])
0x58d: Pop(1)
0x58e: Push("all") // @poff=138
...
0x5bf: Stack[-2] = "bullet" // @poff=644
0x5c0: Return(); Pop(0)

0x5c1: Stack[-2] = "phys" // @poff=658
0x5c2: Return(); Pop(0)

0x5c3: PushEmpty(cvector, cvector, cvector, cvector)
0x5c4: @ GetPosition(Stack[-2])
0x5c5: Pop(0)
0x5c6: @@ GetPosition(Stack[-1]); Obj=5 // @poff=456
0x5c7: Pop(0)
...
0x5cc: Pop(0)
0x5cd: Stack[-1] = Stack[-4]
0x5ce: Return(); Pop(2)

0x5cf: PushEmpty(bool, bool)
0x5d0: Push("HasProperty") // @poff=668
0x5d1: Push((int) 2)
...
0x5d7: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x5d8: Pop(0)
...
0x5ee: Push("armor") // @poff=718
0x5ef: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x5f0: Pop(1)
0x5f1: Push("armor_") // @poff=742
...
0x600: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x601: Pop(0)
...
0x609: Pop(3)
0x60a: Push("health") // @poff=704
0x60b: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x60c: Pop(1)
0x60d: Push((int) 1)
0x60e: Pop(1); Push(Stack[-1] - Stack[-4]);
0x60f: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x610: Push("health") // @poff=704
...
0x616: Pop(3)
0x617: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0x618: Pop(2)
...
0x625: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0x626: Pop(0)
...
0x643: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0x644: Pop(0)
...
0x658: Stack[-1] = "noaccess" // @poff=798
0x659: Call2 0x5cf
...
0x65f: Push("noaccess") // @poff=798
0x660: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x661: Pop(1)
0x662: Push((int) 0)
...
0x674: @@ GetPosition(Stack[-5]); Obj=15 // @poff=456
0x675: Pop(0)
...
0x685: Stack[-1] = "fhit" // @poff=816
0x686: GOTO 0x688

0x687: Stack[-1] = "bhit" // @poff=826
0x688: Push("hit_react") // @poff=836
0x689: Push("1") // @poff=856
0x68a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x68b: Push("2") // @poff=860
...
0x6b9: @@ add(Stack[-5]); Obj=8 // @poff=864
0x6ba: Pop(0)
0x6bb: Push((int) 1)
0x6bc: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x6bd: GOTO 0x6ae

0x6be: @@ size(Stack[-3]); Obj=8 // @poff=868
0x6bf: Pop(0)
0x6c0: Push(Stack[-3])
...
0x6c3: Pop(0)
0x6c4: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0x6c5: Pop(0)
...
0x6d7: Pop(0)
0x6d8: Push("scripted") // @poff=877
0x6d9: Push("blood_dir.xml") // @poff=895
...
0x6e4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=456
0x6e5: Pop(0)
...
0x6ef: @@ GetPosition(Stack[-8]); Obj=20 // @poff=456
0x6f0: Pop(0)
0x6f1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=620
0x6f2: Pop(0)
...
0x7b3: Pop(0)
0x7b4: @@ add(Stack[-3]); Obj=1 // @poff=864
0x7b5: Pop(0)
0x7b6: Push((int) 15)
...
0x801: Pop(0)
0x802: @@ SetItemName(Stack[-7]); Obj=3 // @poff=951
0x803: Pop(0)
0x804: Push("Organ") // @poff=963
0x805: Push((int) 1)
0x806: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0x807: Pop(2)
0x808: @@ GetItemID(Stack[-2]); Obj=3 // @poff=975
0x809: Pop(0)
0x80a: Push((int) 0)
0x80b: Push((int) 1)
...
0x818: Stack[-1] = "liver" // @poff=985
0x819: Call2 0x7ff

0x81a: Pop(1)
0x81b: PushEmpty(string)
0x81c: Stack[-1] = "kidney" // @poff=997
0x81d: Call2 0x7ff

0x81e: Pop(1)
0x81f: PushEmpty(string)
0x820: Stack[-1] = "heart" // @poff=1011
0x821: Call2 0x7ff

0x822: Pop(1)
0x823: PushEmpty(string)
0x824: Stack[-1] = "blood" // @poff=1023
0x825: Call2 0x7ff

0x826: Pop(1)
0x827: Return(); Pop(0)

0x828: Stack[-1] = (int) 515562
0x829: Return(); Pop(0)

0x82a: Stack[-1] = (int) 503347
0x82b: Return(); Pop(0)

0x82c: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1035
0x82d: Return(); Pop(0)

0x82e: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1075
0x82f: Return(); Pop(0)

0x830: Stack[-1] = (bool) 0
0x831: Return(); Pop(0)

0x832: PushEmpty(object, object)
0x833: PushEmpty(bool, string, string)
0x834: Stack[-2] = "quest_b10_01" // @poff=1119
0x835: Stack[-1] = "butcher_dead" // @poff=1145
0x836: Call2 0x7bb
...
0x83a: Pop(0)
0x83b: @ GetScene(Stack[-1])
0x83c: Pop(0)
0x83d: PushEmpty(object)
0x83e: Call2 0x78b

0x83f: Pop(0)
0x840: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1171
0x841: Pop(1)
0x842: PushEmpty(object)
0x843: Stack[-4] = Stack[-1]
0x844: Push(-1, 0); TaskCall(5)
0x845: Call2 0x521
...
0x849: Stack[-1] = 0
0x84a: PushEmpty()
0x84b: PushEmpty(object, int, float)
0x84c: Stack[-7] = Stack[-3]
0x84d: Stack[-6] = Stack[-2]
...
0x852: PushEmpty()
0x853: PushEmpty(object, int, float, cvector, cvector)
0x854: Stack[-11] = Stack[-5]
0x855: Stack[-10] = Stack[-4]
0x856: Stack[-9] = Stack[-3]
0x857: Stack[-7] = Stack[-2]
0x858: Stack[-6] = Stack[-1]
0x859: Call2 0x6d5
...
0x85d: Push("health") // @poff=704
0x85e: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x85f: IF (Stack[-1] == 0) GOTO 0x868; Pop(1)

0x860: Push("health") // @poff=704
