...
0x71c: Pop(0)
0x71d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x768: Stack[-7] = Stack[-3]
0x769: Stack[-6] = Stack[-2]
0x76a: Stack[-5] = Stack[-1]
0x76b: Call2 0x604
...
0x770: Stack[-11] = Stack[-5]
0x771: Stack[-10] = Stack[-4]
0x772: Stack[-9] = Stack[-3]
0x773: Stack[-7] = Stack[-2]
0x774: Stack[-6] = Stack[-1]
0x775: Call2 0x648
