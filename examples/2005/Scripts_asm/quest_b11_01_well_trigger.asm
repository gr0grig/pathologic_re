...
Strings:
	W:boiny_well
	W:pt_b11q01_well_return
	A:GetLocator
	W:activate
// @pool_raw:62006f0069006e0079005f00770065006c006c000000700074005f006200310031007100300031005f00770065006c006c005f00720065007400750072006e0000004765744c6f6361746f7200610063007400690076006100740065000000
...
0x12: Pop(0)
0x13: Push("pt_b11q01_well_return") // @poff=22
0x14: @@ GetLocator(Stack[-1], Stack[-4], Stack[-3], Stack[-2]); Obj=5 // @poff=66
0x15: Pop(1)
