...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x28f: Pop(0)
0x290: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2b5: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=206
0x2b6: Return(); Pop(0)

0x2b7: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=246
0x2b8: Return(); Pop(0)
...
0x2bb: PushEmpty()
0x2bc: Push("b11q02") // @poff=290
0x2bd: Push((int) 3)
0x2be: @ SetVariable(Stack[-2], Stack[-1])
0x2bf: Pop(2)
0x2c0: PushEmpty(bool, string, string)
0x2c1: Stack[-2] = "quest_b11_02" // @poff=304
0x2c2: Stack[-1] = "teleport" // @poff=330
0x2c3: Call2 0x28d
...
0x2cb: Stack[-2] = "quest_b11_02" // @poff=304
0x2cc: Stack[-1] = "fail" // @poff=348
0x2cd: Call2 0x28d
...
0x2dd: Push((int) 610)
0x2de: Push((int) 2)
0x2df: Push((int) 531505)
0x2e0: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2e1: Pop(3)
0x2e2: PushEmpty(bool, object, int)
0x2e3: Stack[-4] = Stack[-2]
0x2e4: Stack[-1] = (int) 598
0x2e5: Call2 0x2f6
...
0x2ea: @ GetDiaryRoot(Stack[-1])
0x2eb: Pop(0)
0x2ec: Pop(0); Push((bool) Stack[-1] == 0)
0x2ed: IF (Stack[-1] == 0) GOTO 0x2f3; Pop(1)

0x2ee: Push("Can't retrieve diary root") // @poff=358
0x2ef: @ Trace(Stack[-1])
0x2f0: Pop(1)
0x2f1: Stack[-3] = (bool) 0
0x2f2: Return(); Pop(2)
...
0x2f5: Stack[-1] = 0
0x2f6: PushEmpty(object, object, int, object, object, int)
0x2f7: PushEmpty(object)
0x2f8: Call2 0x2e9

0x2f9: Stack[-1] = Stack[-4]
0x2fa: Pop(1)
0x2fb: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=410
0x2fc: Pop(0)
0x2fd: Pop(0); Push((bool) Stack[-2] == 0)
0x2fe: IF (Stack[-1] == 0) GOTO 0x305; Pop(1)

0x2ff: Push("Can't find diary parent with id: ") // @poff=415
...
0x305: @@ AddChild(Stack[-8]); Obj=2 // @poff=483
0x306: Pop(0)
0x307: Push((int) 7)
0x308: @ SendWorldWndMessage(Stack[-1])
0x309: Pop(1)
0x30a: @@ GetCategory(Stack[-1]); Obj=8 // @poff=492
0x30b: Pop(0)
0x30c: @ SetDiarySection(Stack[-1])
0x30d: Pop(0)
0x30e: Stack[-9] = (bool) 0
0x30f: Return(); Pop(6)

0x310: Stack[-2] = 0
0x311: Stack[-3] = 0
0x312: PushEmpty(int, int)
0x313: Push("branch") // @poff=504
