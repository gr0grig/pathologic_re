...
Strings:
	...
	A:size
	A:get
// @pool_raw:
// @pool_encoding:utf8
...
0x57: IF (Stack[-1] == 1) GOTO 0x5f; Pop(1)
...
0x5d: IF (Stack[-1] == 1) GOTO 0x5f; Pop(1)
...
0x109: IF (Stack[-1] == 1) GOTO 0x111; Pop(1)
...
0x10f: IF (Stack[-1] == 1) GOTO 0x111; Pop(1)
...
0x120: Push((int) 522172)
0x121: Push((int) 23999)
0x122: Push((int) 23339)
0x123: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x124: Pop(3)
0x125: Push((int) 523159)
0x126: Push((int) -1)
0x127: Push((int) 24361)
...
0x348: PushEmpty()
0x349: Push("oob12BirdmaskT1") // @poff=278
0x34a: Push((int) 1)
...
0x350: Stack[-2] = "quest_b12_01" // @poff=310
...
0x355: PushEmpty()
0x356: Push("oob12BirdmaskT2") // @poff=362
0x357: Push((int) 1)
...
0x367: Stack[-1] = "oob12BirdmaskT1" // @poff=278
0x368: Call2 0x315
...
0x373: Stack[-1] = "b12q01ChildsAreVisited" // @poff=394
0x374: Call2 0x315
...
0x37f: Stack[-1] = "oob12BirdmaskT2" // @poff=362
0x380: Call2 0x315
