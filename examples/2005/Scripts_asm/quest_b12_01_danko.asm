...
// @pool_raw:
// @pool_encoding:utf8
...
0x379: @ GetGameTime(Stack[-1])
0x37a: Pop(0)
0x37b: Push((int) 1)
0x37c: PushEmpty(int)
0x37d: Push((int) 24)
0x37e: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x37f: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x380: Return(); Pop(2)

0x381: PushEmpty()
0x382: Push("oob12DankoSobor1") // @poff=282
0x383: Push((int) 1)
...
0x387: PushEmpty()
0x388: Push("oob12DankoSobor2") // @poff=316
0x389: Push((int) 1)
...
0x38d: PushEmpty()
0x38e: Push("oob12DankoSobor3") // @poff=350
0x38f: Push((int) 1)
...
0x393: PushEmpty()
0x394: Push("oob12DankoSobor4") // @poff=384
0x395: Push((int) 1)
...
0x39b: Stack[-1] = "game_final" // @poff=418
0x39c: Call2 0x373
...
0x3a7: Stack[-1] = "oob12DankoSobor1" // @poff=282
0x3a8: Call2 0x373
...
0x3b3: Stack[-1] = "oob12DankoSobor2" // @poff=316
0x3b4: Call2 0x373
...
0x3bf: Stack[-1] = "oob12DankoSobor3" // @poff=350
0x3c0: Call2 0x373
...
0x3cb: Stack[-1] = "oob12DankoSobor4" // @poff=384
0x3cc: Call2 0x373
...
0x3e6: Stack[-1] = (int) 515573
0x3e7: Return(); Pop(0)

0x3e8: Stack[-1] = (int) 504032
0x3e9: Return(); Pop(0)

0x3ea: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=454
0x3eb: Return(); Pop(0)

0x3ec: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=494
0x3ed: Return(); Pop(0)
