...
// @pool_raw:
// @pool_encoding:utf8
...
0x233: @@ GetPosition(Stack[-8]); Obj=20 // @poff=188
0x234: Pop(0)
0x235: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=200
0x236: Pop(0)
...
0x2a8: Push("voice_common") // @poff=224
0x2a9: Push((int) 0)
...
0x2bb: Push("voice_common") // @poff=224
0x2bc: Push((int) 1)
...
0x2c9: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x2ca: Pop(1)
...
0x2f4: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x2f5: Pop(1)
...
0x309: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=266
0x30a: Pop(1)
0x30b: PushEmpty(bool, string)
0x30c: Stack[-3] = Stack[-1]
0x30d: Call2 0x31e

0x30e: Stack[-2] = Stack[-14]
0x30f: Pop(2)
0x310: Return(); Pop(10)
...
0x323: @ lshHasSpeech(Stack[-1], Stack[-3])
0x324: Pop(0)
0x325: Push(Stack[-1])
0x326: IF (Stack[-1] == 0) GOTO 0x32b; Pop(1)

0x327: @ lshPlaySpeech(Stack[-3])
0x328: Pop(0)
0x329: Stack[-4] = (bool) 1
0x32a: Return(); Pop(2)

0x32b: Stack[-4] = (bool) 0
0x32c: Return(); Pop(2)
...
0x33b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x33c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x33d: Push((float)9.999999974752427e-07)
0x33e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x33f: IF (Stack[-1] == 0) GOTO 0x342; Pop(1)

0x340: Stack[-4] = [0.0, 0.0, 0.0]
0x341: Return(); Pop(2)

0x342: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x343: Return(); Pop(2)

0x344: PushEmpty(int, int)
0x345: @ GetVariable(Stack[-3], Stack[-1])
0x346: Pop(0)
0x347: Stack[-1] = Stack[-4]
0x348: Return(); Pop(2)

0x349: PushEmpty(float, float)
0x34a: @ GetGameTime(Stack[-1])
0x34b: Pop(0)
0x34c: Push((int) 1)
0x34d: PushEmpty(int)
0x34e: Push((int) 24)
0x34f: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x350: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x351: Return(); Pop(2)

0x352: PushEmpty()
0x353: Push("oob12KapellaSobor1") // @poff=282
0x354: Push((int) 1)
0x355: @ SetVariable(Stack[-2], Stack[-1])
0x356: Pop(2)
0x357: Return(); Pop(0)

0x358: PushEmpty()
0x359: PushEmpty(int, string)
0x35a: Stack[-1] = "game_final" // @poff=320
0x35b: Call2 0x344
...
0x366: Stack[-1] = "oob12KapellaSobor1" // @poff=282
0x367: Call2 0x344
...
0x381: Stack[-1] = (int) 515538
0x382: Return(); Pop(0)

0x383: Stack[-1] = (int) 502863
0x384: Return(); Pop(0)

0x385: Stack[-1] = "ui/NPC_Kapella.png" // @poff=356
0x386: Return(); Pop(0)

0x387: Stack[-1] = "ui/NPC_Kapella_b.png" // @poff=394
0x388: Return(); Pop(0)
