...
// @pool_raw:
// @pool_encoding:utf8
...
0x210: @@ GetPosition(Stack[-8]); Obj=20 // @poff=188
0x211: Pop(0)
0x212: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=200
0x213: Pop(0)
...
0x265: Push("voice_common") // @poff=224
...
0x27d: Push("voice_common") // @poff=224
0x27e: Push((int) 1)
...
0x285: Push("voice_common") // @poff=224
0x286: Push((int) 0)
...
0x298: Push("voice_common") // @poff=224
0x299: Push((int) 1)
...
0x2a6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x2a7: Pop(1)
...
0x2d1: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x2d2: Pop(1)
...
0x2e6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=266
0x2e7: Pop(1)
0x2e8: PushEmpty(bool, string)
0x2e9: Stack[-3] = Stack[-1]
0x2ea: Call2 0x2fb

0x2eb: Stack[-2] = Stack[-14]
0x2ec: Pop(2)
0x2ed: Return(); Pop(10)

0x2ee: PushEmpty(float, float, float, float)
0x2ef: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2f0: Pop(0)
0x2f1: Push((bool) 0)
0x2f2: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2f3: Pop(1)
0x2f4: Return(); Pop(4)

0x2f5: PushEmpty(float, float, float, float)
0x2f6: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2f7: Pop(0)
0x2f8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2f9: Pop(0)
0x2fa: Return(); Pop(4)
...
0x300: @ lshHasSpeech(Stack[-1], Stack[-3])
0x301: Pop(0)
0x302: Push(Stack[-1])
0x303: IF (Stack[-1] == 0) GOTO 0x308; Pop(1)

0x304: @ lshPlaySpeech(Stack[-3])
0x305: Pop(0)
0x306: Stack[-4] = (bool) 1
0x307: Return(); Pop(2)

0x308: Stack[-4] = (bool) 0
0x309: Return(); Pop(2)
...
0x32a: PushEmpty(int)
0x32b: Push((int) 24)
0x32c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x32d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x32e: Return(); Pop(2)

0x32f: PushEmpty()
0x330: Push("oob12KlaraSobor1") // @poff=282
0x331: Push((int) 1)
...
0x335: PushEmpty()
0x336: Push("oob12KlaraSobor2") // @poff=316
0x337: Push((int) 1)
...
0x33d: Stack[-1] = "game_final" // @poff=350
0x33e: Call2 0x321
...
0x349: Stack[-1] = "oob12KlaraSobor1" // @poff=282
0x34a: Call2 0x321
...
0x353: PushEmpty()
0x354: PushEmpty(int, string)
0x355: Stack[-1] = "oob12KlaraSobor2" // @poff=316
0x356: Call2 0x321
...
0x35b: Stack[-2] = (bool) 1
0x35c: Return(); Pop(0)

0x35d: Stack[-2] = (bool) 0
0x35e: Return(); Pop(0)

0x35f: PushEmpty(int, int)
0x360: Push("branch") // @poff=372
...
0x370: Stack[-1] = (int) 515540
0x371: Return(); Pop(0)

0x372: Stack[-1] = (int) 502865
0x373: Return(); Pop(0)

0x374: Stack[-1] = "ui/NPC_Klara.png" // @poff=386
0x375: Return(); Pop(0)

0x376: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=420
0x377: Return(); Pop(0)
