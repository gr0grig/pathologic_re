...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x323: Pop(0)
0x324: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x325: Pop(0)
...
0x32f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x330: Pop(0)
0x331: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x332: Pop(0)
...
0x357: @ StopWorld()
0x358: Pop(0)
0x359: @ CameraTransit(Stack[-3], Stack[-5])
0x35a: Pop(0)
...
0x37a: Push("head") // @poff=170
0x37b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x37c: Pop(1)
0x37d: Push(Stack[-1])
0x37e: IF (Stack[-1] == 0) GOTO 0x382; Pop(1)

0x37f: Push("head") // @poff=170
0x380: @ UnlookAsync(Stack[-1])
0x381: Pop(1)
0x382: Return(); Pop(2)

0x383: PushEmpty(float, float, float, float)
0x384: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x385: Pop(0)
0x386: Push((bool) 0)
0x387: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x388: Pop(1)
0x389: Return(); Pop(4)

0x38a: PushEmpty(float, float, float, float)
0x38b: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x38c: Pop(0)
0x38d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x38e: Pop(0)
0x38f: Return(); Pop(4)

0x390: PushEmpty(float, cvector, float, cvector)
0x391: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x392: Pop(0)
0x393: Stack[-1] = [0.0, 0.0, 0.0]
0x394: Push(CvectorIndex(Stack[-1], 1))
0x395: Stack[-3] = Stack[-1]
0x396: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x397: Push("head") // @poff=170
0x398: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x399: Pop(1)
0x39a: Return(); Pop(4)
...
0x3a2: PushEmpty(float, float)
0x3a3: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3a4: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3a5: Push((float)9.999999974752427e-07)
0x3a6: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3a7: IF (Stack[-1] == 0) GOTO 0x3aa; Pop(1)

0x3a8: Stack[-4] = [0.0, 0.0, 0.0]
0x3a9: Return(); Pop(2)

0x3aa: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3ab: Return(); Pop(2)

0x3ac: PushEmpty(int, int)
0x3ad: @ GetVariable(Stack[-3], Stack[-1])
0x3ae: Pop(0)
0x3af: Stack[-1] = Stack[-4]
0x3b0: Return(); Pop(2)

0x3b1: PushEmpty(object, object)
0x3b2: @ FindActor(Stack[-1], Stack[-4])
0x3b3: Pop(0)
0x3b4: Pop(0); PushNull((bool) Stack[-1] == 0)
0x3b5: IF (Stack[-1] == 0) GOTO 0x3b8; Pop(1)

0x3b6: Stack[-5] = (bool) 0
0x3b7: Return(); Pop(2)

0x3b8: @ Trigger(Stack[-1], Stack[-3])
0x3b9: Pop(0)
0x3ba: Stack[-5] = (bool) 1
0x3bb: Return(); Pop(2)

0x3bc: Stack[-1] = 0
0x3bd: Stack[-1] = (int) 515571
0x3be: Return(); Pop(0)

0x3bf: Stack[-1] = (int) 504029
0x3c0: Return(); Pop(0)

0x3c1: Stack[-1] = "ui/NPC_bmask.png" // @poff=206
0x3c2: Return(); Pop(0)

0x3c3: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=240
0x3c4: Return(); Pop(0)
...
0x3df: PushEmpty()
0x3e0: Push("oob1Birdmask1_1") // @poff=278
0x3e1: Push((int) 1)
0x3e2: @ SetVariable(Stack[-2], Stack[-1])
0x3e3: Pop(2)
0x3e4: PushEmpty(bool, string, string)
0x3e5: Stack[-2] = "quest_b1_01" // @poff=310
0x3e6: Stack[-1] = "remove1" // @poff=334
0x3e7: Call2 0x3b1
...
0x3ea: PushEmpty()
0x3eb: PushEmpty(object, string, float)
0x3ec: PushEmpty(object)
0x3ed: Call2 0x406

0x3ee: Stack[-1] = Stack[-4]
0x3ef: Pop(1)
0x3f0: Stack[-2] = "pt_map_bigvlad" // @poff=350
0x3f1: Stack[-1] = (int) 2
0x3f2: Call2 0x417
...
0x3f6: Pop(0)
0x3f7: @@ ShowMap(Stack[-1]); Obj=2 // @poff=380
0x3f8: Pop(1)
0x3f9: Return(); Pop(0)

0x3fa: PushEmpty()
0x3fb: PushEmpty(int, string)
0x3fc: Stack[-1] = "oob1Birdmask1_1" // @poff=278
0x3fd: Call2 0x3ac
...
0x402: Stack[-2] = (bool) 1
0x403: Return(); Pop(0)

0x404: Stack[-2] = (bool) 0
0x405: Return(); Pop(0)

0x406: PushEmpty(object, object, object, object)
0x407: @ GetMainOutdoorScene(Stack[-2])
0x408: Pop(0)
0x409: Pop(0); PushNull((bool) Stack[-2] == 0)
0x40a: IF (Stack[-1] == 0) GOTO 0x411; Pop(1)

0x40b: Push("Can't find main outdoor scene") // @poff=388
0x40c: @ Trace(Stack[-1])
0x40d: Pop(1)
0x40e: Stack[-1] = 0
0x40f: Stack[-1] = Stack[-5]
0x410: Return(); Pop(4)

0x411: @@ GetMap(Stack[-1]); Obj=2 // @poff=448
0x412: Pop(0)
...
0x415: Stack[-1] = 0
0x416: Stack[-2] = 0
0x417: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x418: @ GetMainOutdoorScene(Stack[-2])
0x419: Pop(0)
0x41a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x41b: IF (Stack[-1] == 0) GOTO 0x420; Pop(1)

0x41c: Push("Can't find main outdoor scene") // @poff=388
0x41d: @ Trace(Stack[-1])
0x41e: Pop(1)
0x41f: Return(); Pop(8)

0x420: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=455
0x421: Pop(0)
0x422: Pop(0); Push((bool) Stack[-1] == 0)
0x423: IF (Stack[-1] == 0) GOTO 0x42a; Pop(1)

0x424: Push("Warning: outdoor scene locator ") // @poff=466
0x425: Pop(1); Push(Stack[-1] + Stack[-11]);
0x426: Push(" doesnt exist") // @poff=530
0x427: Pop(2); Push(Stack[-2] + Stack[-1]);
0x428: @ Trace(Stack[-1])
0x429: Pop(1)
0x42a: @@ GetMap(Stack[-11]); Obj=2 // @poff=448
0x42b: Pop(0)
0x42c: Pop(0); PushNull((bool) Stack[-11] == 0)
0x42d: IF (Stack[-1] == 0) GOTO 0x432; Pop(1)

0x42e: Push("Can't find map") // @poff=558
0x42f: @ Trace(Stack[-1])
0x430: Pop(1)
0x431: Return(); Pop(8)

0x432: Push(CvectorIndex(Stack[-4], 0))
0x433: Push(CvectorIndex(Stack[-5], 2))
0x434: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=588
0x435: Pop(2)
0x436: Return(); Pop(8)

0x437: Stack[-2] = 0
0x438: PushEmpty(int, int)
0x439: Push("branch") // @poff=601
0x43a: @ GetVariable(Stack[-1], Stack[-2])
0x43b: Pop(1)
0x43c: Push((int) 0)
