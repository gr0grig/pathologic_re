...
Strings:
	...
	W:remove2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x296: Push("head") // @poff=170
0x297: @ UnlookAsync(Stack[-1])
0x298: Pop(1)
0x299: Return(); Pop(2)

0x29a: PushEmpty(float, float, float, float)
0x29b: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x29c: Pop(0)
0x29d: Push((bool) 0)
0x29e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x29f: Pop(1)
0x2a0: Return(); Pop(4)

0x2a1: PushEmpty(float, float, float, float)
0x2a2: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2a3: Pop(0)
0x2a4: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2a5: Pop(0)
0x2a6: Return(); Pop(4)

0x2a7: PushEmpty(float, cvector, float, cvector)
0x2a8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2a9: Pop(0)
0x2aa: Stack[-1] = [0.0, 0.0, 0.0]
0x2ab: Push(CvectorIndex(Stack[-1], 1))
0x2ac: Stack[-3] = Stack[-1]
0x2ad: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2ae: Push("head") // @poff=170
0x2af: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2b0: Pop(1)
0x2b1: Return(); Pop(4)
...
0x2c9: @ FindActor(Stack[-1], Stack[-4])
0x2ca: Pop(0)
0x2cb: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2cc: IF (Stack[-1] == 0) GOTO 0x2cf; Pop(1)

0x2cd: Stack[-5] = (bool) 0
0x2ce: Return(); Pop(2)

0x2cf: @ Trigger(Stack[-1], Stack[-3])
0x2d0: Pop(0)
0x2d1: Stack[-5] = (bool) 1
0x2d2: Return(); Pop(2)

0x2d3: Stack[-1] = 0
0x2d4: Stack[-1] = (int) 515571
0x2d5: Return(); Pop(0)

0x2d6: Stack[-1] = (int) 504029
0x2d7: Return(); Pop(0)

0x2d8: Stack[-1] = "ui/NPC_bmask.png" // @poff=206
0x2d9: Return(); Pop(0)

0x2da: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=240
0x2db: Return(); Pop(0)

0x2dc: Stack[-1] = (bool) 0
0x2dd: Return(); Pop(0)

0x2de: PushEmpty(string, string)
0x2df: Stack[-1] = "idle" // @poff=146
0x2e0: Push(Stack[-3])
0x2e1: IF (Stack[-1] == 0) GOTO 0x2e3; Pop(1)

0x2e2: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2e3: Stack[-1] = Stack[-4]
0x2e4: Return(); Pop(2)

0x2e5: PushEmpty(int, bool, int, bool)
0x2e6: Stack[-2] = (int) 0
...
0x2eb: Pop(1)
0x2ec: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ed: Pop(2)
...
0x2f1: Push((int) 1)
0x2f2: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2f3: GOTO 0x2e7

0x2f4: Stack[-2] = Stack[-5]
0x2f5: Return(); Pop(4)

0x2f6: PushEmpty()
0x2f7: Push("oob1Birdmask2_1") // @poff=278
0x2f8: Push((int) 1)
0x2f9: @ SetVariable(Stack[-2], Stack[-1])
0x2fa: Pop(2)
0x2fb: PushEmpty(bool, string, string)
0x2fc: Stack[-2] = "quest_b1_01" // @poff=310
0x2fd: Stack[-1] = "remove2" // @poff=334
0x2fe: Call2 0x2c8
...
0x301: PushEmpty()
0x302: PushEmpty(int, string)
0x303: Stack[-1] = "oob1Birdmask2_1" // @poff=278
0x304: Call2 0x2c3
...
0x309: Stack[-2] = (bool) 1
0x30a: Return(); Pop(0)

0x30b: Stack[-2] = (bool) 0
0x30c: Return(); Pop(0)

0x30d: PushEmpty(int, int)
0x30e: Push("branch") // @poff=350
0x30f: @ GetVariable(Stack[-1], Stack[-2])
0x310: Pop(1)
0x311: Push((int) 0)
