...
0x2d: IF (Stack[-1] == 1) GOTO 0x34; Pop(1)
...
0x32: IF (Stack[-1] == 1) GOTO 0x34; Pop(1)
...
0x36: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=0
0x37: Pop(0)
0x38: Push(Stack[-2])
...
0x4f: Push("nouse_container") // @poff=11
...
0x5c: Pop(0)
0x5d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=57
0x5e: Pop(0)
0x5f: Push("Organ") // @poff=69
0x60: Push((int) 1)
0x61: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=81
0x62: Pop(2)
0x63: @@ GetItemID(Stack[-2]); Obj=3 // @poff=93
0x64: Pop(0)
0x65: Push((int) 0)
0x66: Push((int) 1)
...
0x73: Stack[-1] = "liver" // @poff=103
0x74: Call2 0x5a

0x75: Pop(1)
0x76: PushEmpty(string)
0x77: Stack[-1] = "kidney" // @poff=115
0x78: Call2 0x5a

0x79: Pop(1)
0x7a: PushEmpty(string)
0x7b: Stack[-1] = "heart" // @poff=129
0x7c: Call2 0x5a

0x7d: Pop(1)
0x7e: PushEmpty(string)
0x7f: Stack[-1] = "blood" // @poff=141
0x80: Call2 0x5a
