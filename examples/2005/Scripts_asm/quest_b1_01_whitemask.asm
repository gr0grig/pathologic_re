...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1a7: Push("player") // @poff=156
0x1a8: @ FindActor(Stack[-4]T, Stack[-1])
0x1a9: Pop(1)
...
0x1bc: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x211: Pop(0)
0x212: Push("all") // @poff=138
0x213: PushEmpty(string, int)
0x214: Stack[-7] = Stack[-1]
0x215: Call2 0x2ec
...
0x247: Pop(0)
0x248: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x249: Pop(0)
...
0x253: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x254: Pop(0)
0x255: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x256: Pop(0)
...
0x27b: @ StopWorld()
0x27c: Pop(0)
0x27d: @ CameraTransit(Stack[-3], Stack[-5])
0x27e: Pop(0)
...
0x29e: Push("head") // @poff=170
0x29f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2a0: Pop(1)
0x2a1: Push(Stack[-1])
0x2a2: IF (Stack[-1] == 0) GOTO 0x2a6; Pop(1)

0x2a3: Push("head") // @poff=170
0x2a4: @ UnlookAsync(Stack[-1])
0x2a5: Pop(1)
0x2a6: Return(); Pop(2)

0x2a7: PushEmpty(float, float, float, float)
0x2a8: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2a9: Pop(0)
0x2aa: Push((bool) 0)
0x2ab: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ac: Pop(1)
0x2ad: Return(); Pop(4)

0x2ae: PushEmpty(float, float, float, float)
0x2af: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2b0: Pop(0)
0x2b1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2b2: Pop(0)
0x2b3: Return(); Pop(4)

0x2b4: PushEmpty(float, cvector, float, cvector)
0x2b5: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2b6: Pop(0)
0x2b7: Stack[-1] = [0.0, 0.0, 0.0]
0x2b8: Push(CvectorIndex(Stack[-1], 1))
0x2b9: Stack[-3] = Stack[-1]
0x2ba: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2bb: Push("head") // @poff=170
...
0x2db: @ GetGameTime(Stack[-1])
0x2dc: Pop(0)
0x2dd: PushEmpty(int)
0x2de: Stack[-2] = Stack[-1]
0x2df: Push((int) 24)
0x2e0: Stack[-5] = Stack[-2] % Stack[-1]; Pop(2);
0x2e1: Return(); Pop(2)

0x2e2: Stack[-1] = (int) 515569
0x2e3: Return(); Pop(0)

0x2e4: Stack[-1] = (int) 503354
0x2e5: Return(); Pop(0)

0x2e6: Stack[-1] = "ui/NPC_wmask.png" // @poff=206
0x2e7: Return(); Pop(0)

0x2e8: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=240
0x2e9: Return(); Pop(0)

0x2ea: Stack[-1] = (bool) 0
0x2eb: Return(); Pop(0)

0x2ec: PushEmpty(string, string)
0x2ed: Stack[-1] = "idle" // @poff=146
0x2ee: Push(Stack[-3])
0x2ef: IF (Stack[-1] == 0) GOTO 0x2f1; Pop(1)

0x2f0: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2f1: Stack[-1] = Stack[-4]
0x2f2: Return(); Pop(2)

0x2f3: PushEmpty(int, bool, int, bool)
0x2f4: Stack[-2] = (int) 0
0x2f5: Push("all") // @poff=138
0x2f6: PushEmpty(string, int)
0x2f7: Stack[-5] = Stack[-1]
0x2f8: Call2 0x2ec

0x2f9: Pop(1)
0x2fa: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2fb: Pop(2)
...
0x2ff: Push((int) 1)
0x300: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x301: GOTO 0x2f5
...
0x304: PushEmpty()
0x305: Push("oob1WhiteMask1") // @poff=278
0x306: Push((int) 1)
...
0x30d: Stack[-1] = Stack[-2]
0x30e: Pop(1)
0x30f: Push("b1BigVlad11Hours") // @poff=308
0x310: Push("pt_map_bigvlad") // @poff=342
0x311: Push((int) 3)
0x312: Push((int) 524625)
0x313: PushEmpty(float)
0x314: Call2 0x2d5

0x315: Pop(0)
0x316: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=372
0x317: Pop(5)
0x318: Return(); Pop(2)
...
0x326: Stack[-1] = "oob1WhiteMask1" // @poff=278
0x327: Call2 0x2d0
...
0x340: Push("Can't find main outdoor scene") // @poff=380
0x341: @ Trace(Stack[-1])
0x342: Pop(1)
0x343: Stack[-1] = 0
...
0x346: @@ GetMap(Stack[-1]); Obj=2 // @poff=440
0x347: Pop(0)
...
0x34d: Push("branch") // @poff=447
0x34e: @ GetVariable(Stack[-1], Stack[-2])
0x34f: Pop(1)
0x350: Push((int) 0)
