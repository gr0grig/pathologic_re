...
Strings:
	...
	W:oob1Worker1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1ca: Stack[-1] = "cleanup" // @poff=156
0x1cb: Call2 0x210
...
0x1e3: Stack[-1] = "cleanup" // @poff=156
0x1e4: Call2 0x210
...
0x28b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x28c: Pop(0)
0x28d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x28e: Pop(0)
...
0x30a: Pop(0)
0x30b: @@ add(Stack[-4]); Obj=1 // @poff=208
0x30c: Pop(0)
0x30d: @@ add(Stack[-3]); Obj=1 // @poff=208
0x30e: Pop(0)
0x30f: Push((int) 3)
0x310: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x311: Pop(1)
0x312: Return(); Pop(2)

0x313: Stack[-1] = 0
0x314: PushEmpty(int, int, bool, int, int, bool)
0x315: @@ GetItemID(Stack[-3]); Obj=8 // @poff=212
0x316: Pop(0)
0x317: Push("Category") // @poff=222
0x318: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x319: Pop(1)
0x31a: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=240
0x31b: Pop(0)
0x31c: Pop(0); Push((bool) Stack[-1] == 0)
0x31d: IF (Stack[-1] == 0) GOTO 0x321; Pop(1)

0x31e: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=248
0x31f: Pop(0)
0x320: GOTO 0x326

0x321: PushEmpty(int, int)
0x322: Stack[-5] = Stack[-2]
0x323: Stack[-9] = Stack[-1]
0x324: Call2 0x308
...
0x33f: Stack[-1] = (int) 515568
0x340: Return(); Pop(0)

0x341: Stack[-1] = (int) 503353
0x342: Return(); Pop(0)

0x343: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=258
0x344: Return(); Pop(0)

0x345: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=298
0x346: Return(); Pop(0)
...
0x349: PushEmpty()
0x34a: Push("playsound") // @poff=342
0x34b: Push("giveitem") // @poff=362
0x34c: @ TriggerWorld(Stack[-2], Stack[-1])
0x34d: Pop(2)
0x34e: Return(); Pop(0)

0x34f: PushEmpty()
0x350: Push("oob1Worker2") // @poff=380
0x351: Push((int) 1)
...
0x355: PushEmpty()
0x356: Push("oob1Worker3") // @poff=404
0x357: Push((int) 1)
...
0x35c: Push("Knife is given") // @poff=428
0x35d: @ Trace(Stack[-1])
0x35e: Pop(1)
0x35f: @ CreateInvItem(Stack[-1])
0x360: Pop(0)
0x361: Push("Knife") // @poff=458
0x362: @@ SetItemName(Stack[-1]); Obj=2 // @poff=470
0x363: Pop(1)
0x364: Push("durability") // @poff=482
0x365: Push((int) 70)
0x366: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=504
0x367: Pop(2)
0x368: PushEmpty(object, object, int)
0x369: Stack[-7] = Stack[-3]
...
0x36f: Stack[-1] = 0
0x370: PushEmpty()
0x371: Push("oob1Worker1") // @poff=516
0x372: Push((int) 1)
...
0x378: Stack[-1] = "oob1Worker2" // @poff=380
0x379: Call2 0x303
...
0x384: Stack[-1] = "oob1Worker3" // @poff=404
0x385: Call2 0x303
...
0x390: Stack[-1] = "oob1Worker1" // @poff=516
0x391: Call2 0x303
...
0x39b: Push("branch") // @poff=540
0x39c: @ GetVariable(Stack[-1], Stack[-2])
0x39d: Pop(1)
0x39e: Push((int) 0)
