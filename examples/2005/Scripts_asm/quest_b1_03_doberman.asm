...
Strings:
	...
	W:quest_b1_03
	W:doberman_dead
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0xa21 Vars = (object, int, float, float)
EVENT_43 Op = 0xa29 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xa33 Vars = (object, string)
EVENT_41 Op = 0xa40 Vars = (object)
...
0x8d7: Push("head") // @poff=532
0x8d8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8d9: Pop(1)
0x8da: Push(Stack[-1])
0x8db: IF (Stack[-1] == 0) GOTO 0x8df; Pop(1)

0x8dc: Push("head") // @poff=532
0x8dd: @ UnlookAsync(Stack[-1])
0x8de: Pop(1)
0x8df: Return(); Pop(2)

0x8e0: PushEmpty(float, float, float, float)
0x8e1: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x8e2: Pop(0)
0x8e3: Push((bool) 0)
0x8e4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8e5: Pop(1)
0x8e6: Return(); Pop(4)

0x8e7: PushEmpty(float, float, float, float)
0x8e8: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x8e9: Pop(0)
0x8ea: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x8eb: Pop(0)
0x8ec: Return(); Pop(4)

0x8ed: PushEmpty(float, cvector, float, cvector)
0x8ee: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=708
0x8ef: Pop(0)
0x8f0: Stack[-1] = [0.0, 0.0, 0.0]
0x8f1: Push(CvectorIndex(Stack[-1], 1))
0x8f2: Stack[-3] = Stack[-1]
0x8f3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8f4: Push("head") // @poff=532
0x8f5: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x8f6: Pop(1)
0x8f7: Return(); Pop(4)
...
0x8ff: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x900: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x901: Pop(0)
0x902: Pop(0); Push((bool) Stack[-8] == 0)
0x903: IF (Stack[-1] == 0) GOTO 0x918; Pop(1)

0x904: Stack[-7] = (int) 0
0x905: Push((int) 1)
0x906: Pop(1); Push(Stack[-8] + Stack[-1]);
0x907: Pop(1); Push(Stack[-18] + Stack[-1]);
0x908: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x909: Pop(1)
0x90a: Pop(0); Push((bool) Stack[-6] == 0)
0x90b: IF (Stack[-1] == 0) GOTO 0x90d; Pop(1)

0x90c: GOTO 0x910

0x90d: Push((int) 1)
0x90e: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x90f: GOTO 0x905

0x910: Pop(0); Push((bool) Stack[-7] == 0)
0x911: IF (Stack[-1] == 0) GOTO 0x913; Pop(1)

0x912: Return(); Pop(16)

0x913: @ irand(Stack[-5], Stack[-7])
0x914: Pop(0)
0x915: Push((int) 1)
0x916: Pop(1); Push(Stack[-6] + Stack[-1]);
0x917: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x918: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x919: Pop(0)
0x91a: Push(Stack[-4])
0x91b: IF (Stack[-1] == 0) GOTO 0x927; Pop(1)

0x91c: @ GetEyesHeight(Stack[-3])
0x91d: Pop(0)
0x91e: @ GetDirection(Stack[-2])
0x91f: Pop(0)
0x920: Push((int) 50)
0x921: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x922: Push(CvectorIndex(Stack[-1], 1))
0x923: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x924: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x925: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x926: Pop(0)
0x927: Return(); Pop(16)
...
0x92d: Stack[-1] = 0
0x92e: PushEmpty(float, float)
0x92f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x930: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x931: Push((float)9.999999974752427e-07)
0x932: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x933: IF (Stack[-1] == 0) GOTO 0x936; Pop(1)

0x934: Stack[-4] = [0.0, 0.0, 0.0]
0x935: Return(); Pop(2)

0x936: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x937: Return(); Pop(2)

0x938: PushEmpty()
0x939: Pop(0); Push((bool) Stack[-2] < Stack[-1])
...
0x93f: PushEmpty()
0x940: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x941: IF (Stack[-1] == 0) GOTO 0x944; Pop(1)

0x942: Stack[-2] = Stack[-4]
0x943: Return(); Pop(0)

0x944: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x945: IF (Stack[-1] == 0) GOTO 0x948; Pop(1)

0x946: Stack[-1] = Stack[-4]
0x947: Return(); Pop(0)

0x948: Stack[-3] = Stack[-4]
0x949: Return(); Pop(0)

0x94a: PushEmpty()
0x94b: Pop(0); Push(Stack[-2] | Stack[-1]);
0x94c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x94d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x94e: Pop(2); Push(Stack[-2] * Stack[-1]);
0x94f: Pop(1); Push(Sqrt(Stack[-1]))
0x950: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x951: Return(); Pop(0)
...
0x95a: Push((int) 8)
0x95b: @ SendWorldWndMessage(Stack[-1])
0x95c: Pop(1)
0x95d: GOTO 0x967
...
0x961: Push((int) 9)
0x962: @ SendWorldWndMessage(Stack[-1])
0x963: Pop(1)
0x964: GOTO 0x967

0x965: Stack[-3] = (bool) 0
0x966: Return(); Pop(0)

0x967: PushEmpty(float)
0x968: Stack[-2] = Stack[-1]
0x969: Call2 0x97f

0x96a: Pop(1)
0x96b: PushEmpty(bool, object, string, float, float, float)
0x96c: Stack[-8] = Stack[-5]
0x96d: Stack[-4] = "reputation" // @poff=1011
0x96e: Stack[-7] = Stack[-3]
0x96f: Stack[-2] = (int) 0
0x970: Stack[-1] = (int) 1
0x971: Call2 0x75d

0x972: Pop(6)
0x973: Stack[-3] = (bool) 1
0x974: Return(); Pop(0)

0x975: PushEmpty(object, object)
0x976: @ CreateFloatVector(Stack[-1])
0x977: Pop(0)
0x978: @@ add(Stack[-3]); Obj=1 // @poff=952
0x979: Pop(0)
0x97a: Push((int) 15)
0x97b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x97c: Pop(1)
0x97d: Return(); Pop(2)

0x97e: Stack[-1] = 0
0x97f: PushEmpty(object, object)
0x980: @ CreateFloatVector(Stack[-1])
0x981: Pop(0)
0x982: @@ add(Stack[-3]); Obj=1 // @poff=952
0x983: Pop(0)
0x984: Push((int) 16)
0x985: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x986: Pop(1)
0x987: Return(); Pop(2)

0x988: Stack[-1] = 0
0x989: PushEmpty(object, object)
0x98a: @ FindActor(Stack[-1], Stack[-4])
0x98b: Pop(0)
0x98c: Pop(0); PushNull((bool) Stack[-1] == 0)
0x98d: IF (Stack[-1] == 0) GOTO 0x990; Pop(1)

0x98e: Stack[-5] = (bool) 0
0x98f: Return(); Pop(2)

0x990: @ Trigger(Stack[-1], Stack[-3])
0x991: Pop(0)
0x992: Stack[-5] = (bool) 1
0x993: Return(); Pop(2)

0x994: Stack[-1] = 0
0x995: PushEmpty(bool, bool)
0x996: @ IsPlayerActor(Stack[-3], Stack[-1])
0x997: Pop(0)
0x998: Push(Stack[-1])
0x999: IF (Stack[-1] == 0) GOTO 0x99d; Pop(1)

0x99a: Push("attack") // @poff=298
0x99b: @ PlayGlobalMusic(Stack[-1])
0x99c: Pop(1)
0x99d: Return(); Pop(2)

0x99e: PushEmpty(object, object)
0x99f: @ GetScene(Stack[-1])
0x9a0: Pop(0)
0x9a1: Push("battle") // @poff=1033
0x9a2: PushEmpty(object)
0x9a3: Call2 0x928

0x9a4: Pop(0)
0x9a5: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x9a6: Pop(2)
0x9a7: Return(); Pop(2)

0x9a8: Stack[-1] = 0
0x9a9: PushEmpty(string, string)
0x9aa: Stack[-1] = "idle" // @poff=146
0x9ab: Push(Stack[-3])
0x9ac: IF (Stack[-1] == 0) GOTO 0x9ae; Pop(1)

0x9ad: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x9ae: Stack[-1] = Stack[-4]
0x9af: Return(); Pop(2)

0x9b0: PushEmpty(int, bool, int, bool)
0x9b1: Stack[-2] = (int) 0
0x9b2: Push("all") // @poff=138
0x9b3: PushEmpty(string, int)
0x9b4: Stack[-5] = Stack[-1]
0x9b5: Call2 0x9a9

0x9b6: Pop(1)
0x9b7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x9b8: Pop(2)
...
0x9bc: Push((int) 1)
0x9bd: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x9be: GOTO 0x9b2

0x9bf: Stack[-2] = Stack[-5]
0x9c0: Return(); Pop(4)

0x9c1: PushEmpty()
0x9c2: Push((int) 1)
0x9c3: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1047
0x9c4: Pop(1)
0x9c5: Return(); Pop(0)

0x9c6: PushEmpty()
0x9c7: Push("b1q03_retreat") // @poff=1062
0x9c8: Push((int) 1)
0x9c9: @ SetVariable(Stack[-2], Stack[-1])
0x9ca: Pop(2)
0x9cb: Push((int) 0)
0x9cc: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1047
0x9cd: Pop(1)
0x9ce: Return(); Pop(0)

0x9cf: PushEmpty(int, int)
0x9d0: Push("branch") // @poff=1090
0x9d1: @ GetVariable(Stack[-1], Stack[-2])
0x9d2: Pop(1)
0x9d3: Push((int) 0)
0x9d4: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9d5: IF (Stack[-1] == 0) GOTO 0x9d9; Pop(1)
...
0x9e1: Push("branch") // @poff=1090
0x9e2: @ GetVariable(Stack[-1], Stack[-2])
0x9e3: Pop(1)
...
0x9ed: @ WorkWithCorpse(Stack[-1])
0x9ee: Pop(0)
0x9ef: GOTO 0x9f2

0x9f0: @ Barter(Stack[-1])
0x9f1: Pop(0)
0x9f2: Return(); Pop(0)

0x9f3: Stack[-1] = (int) 518097
0x9f4: Return(); Pop(0)

0x9f5: Stack[-1] = (int) 518096
0x9f6: Return(); Pop(0)

0x9f7: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1104
0x9f8: Return(); Pop(0)

0x9f9: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1144
0x9fa: Return(); Pop(0)

0x9fb: Stack[-1] = (bool) 0
0x9fc: Return(); Pop(0)

0x9fd: PushEmpty(object, object)
0x9fe: @ GetScene(Stack[-1])
0x9ff: Pop(0)
0xa00: PushEmpty(object)
0xa01: Call2 0x928

0xa02: Pop(0)
0xa03: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=220
0xa04: Pop(1)
0xa05: Return(); Pop(2)
...
0xa0b: Pop(1)
0xa0c: IF (Stack[-1] == 0) GOTO 0xa17; Pop(1)

0xa0d: PushEmpty(bool, object, float)
0xa0e: Stack[-4] = Stack[-2]
0xa0f: Stack[-1] = (float) -0.10000000149011612
0xa10: Call2 0x952

0xa11: Pop(3)
0xa12: PushEmpty(bool, string, string)
0xa13: Stack[-2] = "quest_b1_03" // @poff=1188
0xa14: Stack[-1] = "doberman_dead" // @poff=1212
0xa15: Call2 0x989
...
0xa1c: Push(-1, 0); TaskCall(6)
0xa1d: Call2 0x693

0xa1e: Pop(-1, 0); TaskReturn
0xa1f: Pop(1)
0xa20: Return(); Pop(0)

0xa21: PushEmpty()
0xa22: PushEmpty(object, int, float)
0xa23: Stack[-7] = Stack[-3]
0xa24: Stack[-6] = Stack[-2]
...
0xa29: PushEmpty()
0xa2a: PushEmpty(object, int, float, cvector, cvector)
0xa2b: Stack[-11] = Stack[-5]
0xa2c: Stack[-10] = Stack[-4]
0xa2d: Stack[-9] = Stack[-3]
0xa2e: Stack[-7] = Stack[-2]
0xa2f: Stack[-6] = Stack[-1]
0xa30: Call2 0x86d
...
0xa34: Push("health") // @poff=816
0xa35: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa36: IF (Stack[-1] == 0) GOTO 0xa3f; Pop(1)

0xa37: Push("health") // @poff=816
0xa38: @ GetProperty(Stack[-1], Stack[-2])
0xa39: Pop(1)
0xa3a: Push((int) 0)
0xa3b: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa3c: IF (Stack[-1] == 0) GOTO 0xa3f; Pop(1)

0xa3d: @ SignalDeath(Stack[-4])
0xa3e: Pop(0)
0xa3f: Return(); Pop(2)

0xa40: PushEmpty()
0xa41: PushEmpty(object)
0xa42: Stack[-2] = Stack[-1]
0xa43: Call2 0xa07
...
0xa48: Stack[-3] = Stack[-1]
0xa49: Call2 0x7e5

0xa4a: Stack[-2] = Stack[-4]
0xa4b: Pop(2)
0xa4c: Return(); Pop(0)

0xa4d: PushEmpty()
0xa4e: PushEmpty(object, bool)
0xa4f: Stack[-3] = Stack[-2]
0xa50: Stack[-1] = (bool) 1
0xa51: Push(-2, 6); TaskCall(4)
0xa52: Call2 0x2e3

0xa53: Pop(-2, 6); TaskReturn
0xa54: Pop(2)
0xa55: Return(); Pop(0)
