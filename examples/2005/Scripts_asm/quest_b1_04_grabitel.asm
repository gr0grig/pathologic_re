...
0x806: Pop(0)
0x807: @@ add(Stack[-3]); Obj=1 // @poff=930
0x808: Pop(0)
0x809: Push((int) 16)
...
0x84a: Stack[-7] = Stack[-3]
0x84b: Stack[-6] = Stack[-2]
...
0x852: Stack[-11] = Stack[-5]
0x853: Stack[-10] = Stack[-4]
0x854: Stack[-9] = Stack[-3]
0x855: Stack[-7] = Stack[-2]
0x856: Stack[-6] = Stack[-1]
0x857: Call2 0x743
...
0x88f: Pop(0)
0x890: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1049
0x891: Pop(0)
0x892: Push("Organ") // @poff=1061
0x893: Push((int) 1)
0x894: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=786
0x895: Pop(2)
0x896: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1073
0x897: Pop(0)
0x898: Push((int) 0)
0x899: Push((int) 1)
...
0x8a6: Stack[-1] = "liver" // @poff=1083
0x8a7: Call2 0x88d

0x8a8: Pop(1)
0x8a9: PushEmpty(string)
0x8aa: Stack[-1] = "kidney" // @poff=1095
0x8ab: Call2 0x88d

0x8ac: Pop(1)
0x8ad: PushEmpty(string)
0x8ae: Stack[-1] = "heart" // @poff=1109
0x8af: Call2 0x88d

0x8b0: Pop(1)
0x8b1: PushEmpty(string)
0x8b2: Stack[-1] = "blood" // @poff=1121
0x8b3: Call2 0x88d
...
0x8b7: Push("b1q04_attack") // @poff=1133
0x8b8: Push((int) 1)
...
0x8bf: Pop(0)
0x8c0: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1159
0x8c1: Pop(1)
0x8c2: PushEmpty(object)
0x8c3: Stack[-4] = Stack[-1]
...
0x8d4: Stack[-9] = Stack[-3]
0x8d5: Stack[-8] = Stack[-2]
0x8d6: Stack[-7] = Stack[-1]
0x8d7: Call2 0x7ac

0x8d8: Stack[-4] = Stack[-6]
0x8d9: Pop(4)
0x8da: Push((int) 0)
