...
// @pool_raw:
...
Events:
EVENT_22 Op = 0x6e8 Vars = (object, int, float, float)
EVENT_43 Op = 0x6f0 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x6fa Vars = (object, string)
EVENT_41 Op = 0x707 Vars = (object)
...
0x137: PushEmpty()
0x138: Stack[-3] = (float) 0.029999999329447746
0x139: Return(); Pop(0)
...
0x152: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x153: Pop(0)
0x154: Push(Stack[-8])
0x155: IF (Stack[-1] == 0) GOTO 0x15e; Pop(1)

0x156: Push("attack") // @poff=256
...
0x172: Pop(0)
0x173: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=270
0x174: Pop(0)
...
0x18e: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=270
0x18f: Pop(0)
...
0x1a8: Pop(1)
0x1a9: Push("all") // @poff=0
0x1aa: Push("attack_on") // @poff=284
...
0x1c2: IF (Stack[-1] == 1) GOTO 0x1c8; Pop(1)
...
0x1cf: Push("attack_stay") // @poff=304
...
0x1d9: @ Face(Stack[-0]T)
0x1da: Pop(0)
0x1db: Push("all") // @poff=0
0x1dc: Push("fjump") // @poff=328
...
0x1f7: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=270
0x1f8: Pop(0)
...
0x216: Push("all") // @poff=0
0x217: Push("attack_off") // @poff=340
...
0x224: Push("all") // @poff=0
0x225: Push("attack_begin") // @poff=362
0x226: Push((int) 1)
0x227: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x232: Push("attack") // @poff=256
0x233: Push((int) 1)
0x234: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x23e: Push("all") // @poff=0
0x23f: Push("bjump") // @poff=388
...
0x246: Push((float)0.8999999761581421)
0x247: Pop(1); Push(Stack[-9] * Stack[-1]);
0x248: @ GetVictim(Stack[-1], Stack[-4])
0x249: Pop(1)
0x24a: @ ReportAttack(Stack[-0]T)
0x24b: Pop(0)
...
0x25e: Stack[-4] = Stack[-5]
0x25f: Pop(4)
0x260: PushEmpty(int)
0x261: Call2 0x3c4

0x262: Pop(0)
0x263: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x264: Pop(1)
0x265: PushEmpty(object, float)
0x266: Stack[-5] = Stack[-2]
...
0x26f: Pop(0)
0x270: @ irand(Stack[-4], Stack[-1]T)
0x271: Pop(0)
0x272: Push((int) 1)
0x273: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x274: @ Face(Stack[-0]T)
0x275: Pop(0)
0x276: Push((bool) 1)
...
0x27b: Pop(0)
0x27c: Push("all") // @poff=0
0x27d: Push("attack_begin") // @poff=362
...
0x291: Stack[-11] = Stack[-2]
0x292: Stack[-6] = Stack[-1]
0x293: Call2 0x245

0x294: Pop(2)
0x295: Push("all") // @poff=0
0x296: Push("attack_middle") // @poff=400
...
0x29e: Pop(0)
0x29f: Push("all") // @poff=0
0x2a0: Push("attack_middle") // @poff=400
...
0x2da: Stack[-11] = Stack[-2]
0x2db: Stack[-6] = Stack[-1]
0x2dc: Call2 0x245
...
0x2e3: Pop(1)
0x2e4: Push("all") // @poff=0
0x2e5: Push("attack_end") // @poff=432
...
0x324: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=270
0x325: Pop(0)
...
0x370: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x371: Pop(1)
...
0x375: @ Face(Stack[-0]T)
0x376: Pop(0)
0x377: Push("all") // @poff=0
0x378: Push("bjump") // @poff=388
0x379: @ PlayAnimation(Stack[-2], Stack[-1])
0x37a: Pop(2)
0x37b: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=270
0x37c: Pop(0)
...
0x3b2: @ irand(Stack[-1], Stack[-2]T)
0x3b3: Pop(0)
0x3b4: Push((int) 1)
0x3b5: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3b6: Push("attack") // @poff=256
...
0x3c7: Stack[-1] = "attack_stay" // @poff=304
0x3c8: Call2 0x632
...
0x3f2: Stack[-15] = Stack[-5]
0x3f3: Stack[-14] = Stack[-4]
0x3f4: Stack[-13] = Stack[-3]
0x3f5: Stack[-12] = Stack[-2]
0x3f6: Stack[-11] = Stack[-1]
0x3f7: Call2 0x43c

0x3f8: Stack[-6] = Stack[-7]
0x3f9: Pop(6)
0x3fa: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3fb: IF (Stack[-1] == 0) GOTO 0x3ff; Pop(1)

0x3fc: Push("head") // @poff=190
...
0x43f: Stack[-17] = Stack[-7]
0x440: PushEmpty(bool, object)
0x441: Stack[-23] = Stack[-1]
0x442: Call2 0x4c8
...
0x448: @@ GetPosition(Stack[-5]); Obj=21 // @poff=40
0x449: Pop(0)
...
0x45f: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=270
0x460: Pop(0)
...
0x471: Push((int) 0)
0x472: Push((float)0.30000001192092896)
...
0x494: Push((int) 0)
0x495: Push((float)0.30000001192092896)
...
0x4cc: Stack[-2] = Stack[-4]
0x4cd: Pop(2)
0x4ce: Return(); Pop(0)

0x4cf: Stack[-1] = "walk" // @poff=490
0x4d0: Return(); Pop(0)

0x4d1: Stack[-1] = "run" // @poff=500
0x4d2: Return(); Pop(0)
...
0x4dd: Stack[-2] = "bullet" // @poff=518
0x4de: Return(); Pop(0)

0x4df: Stack[-2] = "phys" // @poff=532
0x4e0: Return(); Pop(0)

0x4e1: PushEmpty(cvector, cvector, cvector, cvector)
0x4e2: @ GetPosition(Stack[-2])
0x4e3: Pop(0)
0x4e4: @@ GetPosition(Stack[-1]); Obj=5 // @poff=40
0x4e5: Pop(0)
...
0x4ee: Push("HasProperty") // @poff=542
0x4ef: Push((int) 2)
...
0x4f5: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=566
0x4f6: Pop(0)
0x4f7: Stack[-1] = Stack[-5]
0x4f8: Return(); Pop(2)

0x4f9: PushEmpty(float, float)
0x4fa: PushEmpty(bool, object, string)
0x4fb: Stack[-10] = Stack[-2]
0x4fc: Stack[-9] = Stack[-1]
0x4fd: Call2 0x4ed
...
0x503: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=578
0x504: Pop(0)
0x505: PushEmpty(float, float, float, float)
0x506: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x507: Stack[-8] = Stack[-2]
0x508: Stack[-7] = Stack[-1]
0x509: Call2 0x672

0x50a: Pop(3)
0x50b: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=590
0x50c: Pop(1)
...
0x511: Stack[-18] = Stack[-2]
0x512: Stack[-1] = "health" // @poff=602
0x513: Call2 0x4ed
...
0x522: Push("armor") // @poff=616
0x523: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=578
0x524: Pop(1)
0x525: Push("armor_") // @poff=628
0x526: PushEmpty(string, int)
0x527: Stack[-16] = Stack[-1]
0x528: Call2 0x4d3

0x529: Pop(1)
0x52a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x52b: PushEmpty(bool, object, string)
0x52c: Stack[-18] = Stack[-2]
0x52d: Stack[-8] = Stack[-1]
0x52e: Call2 0x4ed
...
0x534: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=578
0x535: Pop(0)
...
0x53c: Stack[-3] = Stack[-6]
0x53d: Pop(3)
0x53e: Push("health") // @poff=602
0x53f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=578
0x540: Pop(1)
0x541: Push((int) 1)
0x542: Pop(1); Push(Stack[-1] - Stack[-4]);
0x543: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x544: Push("health") // @poff=602
...
0x54a: Pop(3)
0x54b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=590
0x54c: Pop(2)
0x54d: PushEmpty(bool, object)
0x54e: Stack[-17] = Stack[-1]
0x54f: Call2 0x4e8
...
0x559: @@ IsDead(Stack[-1]); Obj=3 // @poff=642
0x55a: Pop(0)
0x55b: Stack[-1] = Stack[-4]
0x55c: Return(); Pop(2)

0x55d: PushEmpty(object, object, object, object)
0x55e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x572: Pop(0)
0x573: Pop(0); PushNull((bool) Stack[-2] == 0)
0x574: IF (Stack[-1] == 0) GOTO 0x577; Pop(1)

0x575: Stack[-6] = (bool) 0
0x576: Return(); Pop(4)

0x577: @@ GetScene(Stack[-1]); Obj=5 // @poff=663
0x578: Pop(0)
...
0x58b: Stack[-6] = Stack[-2]
0x58c: Stack[-1] = "noaccess" // @poff=672
0x58d: Call2 0x4ed
...
0x593: Push("noaccess") // @poff=672
0x594: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=578
0x595: Pop(1)
0x596: Push((int) 0)
...
0x59a: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x5a8: @@ GetPosition(Stack[-5]); Obj=15 // @poff=40
0x5a9: Pop(0)
...
0x5b9: Stack[-1] = "fhit" // @poff=690
0x5ba: GOTO 0x5bc

0x5bb: Stack[-1] = "bhit" // @poff=700
0x5bc: Push("hit_react") // @poff=710
0x5bd: Push("1") // @poff=730
0x5be: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5bf: Push("2") // @poff=734
...
0x5d8: Stack[-25] = Stack[-1]
0x5d9: Call2 0x4e1

0x5da: Stack[-2] = Stack[-3]
0x5db: Pop(2)
0x5dc: Call2 0x661
...
0x5f7: Pop(0)
0x5f8: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=747
0x5f9: Pop(0)
0x5fa: PushEmpty(object, int, float, cvector, cvector)
0x5fb: Stack[-26] = Stack[-5]
0x5fc: Stack[-25] = Stack[-4]
0x5fd: Stack[-24] = Stack[-3]
0x5fe: Stack[-6] = Stack[-2]
...
0x60b: Pop(0)
0x60c: Push("scripted") // @poff=751
0x60d: Push("blood_dir.xml") // @poff=769
...
0x618: @@ GetPosition(Stack[-3]); Obj=7 // @poff=40
0x619: Pop(0)
...
0x628: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=176
0x629: Pop(0)
0x62a: Stack[-1] = [0.0, 0.0, 0.0]
0x62b: Push(CvectorIndex(Stack[-1], 1))
0x62c: Stack[-3] = Stack[-1]
0x62d: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x62e: Push("head") // @poff=190
...
0x697: Stack[-8] = Stack[-5]
0x698: Stack[-4] = "reputation" // @poff=797
0x699: Stack[-7] = Stack[-3]
0x69a: Stack[-2] = (int) 0
0x69b: Stack[-1] = (int) 1
0x69c: Call2 0x4f9
...
0x6a2: Pop(0)
0x6a3: @@ add(Stack[-3]); Obj=1 // @poff=738
0x6a4: Pop(0)
0x6a5: Push((int) 15)
0x6a6: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6a7: Pop(1)
0x6a8: Return(); Pop(2)

0x6a9: Stack[-1] = 0
0x6aa: PushEmpty(object, object)
0x6ab: @ CreateFloatVector(Stack[-1])
0x6ac: Pop(0)
0x6ad: @@ add(Stack[-3]); Obj=1 // @poff=738
0x6ae: Pop(0)
0x6af: Push((int) 16)
0x6b0: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6b1: Pop(1)
0x6b2: Return(); Pop(2)

0x6b3: Stack[-1] = 0
0x6b4: PushEmpty(bool, bool)
0x6b5: @ IsPlayerActor(Stack[-3], Stack[-1])
0x6b6: Pop(0)
0x6b7: Push(Stack[-1])
0x6b8: IF (Stack[-1] == 0) GOTO 0x6bc; Pop(1)

0x6b9: Push("attack") // @poff=256
0x6ba: @ PlayGlobalMusic(Stack[-1])
0x6bb: Pop(1)
0x6bc: Return(); Pop(2)

0x6bd: PushEmpty(object, object)
0x6be: @ GetScene(Stack[-1])
0x6bf: Pop(0)
0x6c0: Push("battle") // @poff=819
0x6c1: PushEmpty(object)
0x6c2: Call2 0x65b

0x6c3: Pop(0)
0x6c4: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x6c5: Pop(2)
0x6c6: Return(); Pop(2)

0x6c7: Stack[-1] = 0
0x6c8: PushEmpty(string, string)
0x6c9: Stack[-1] = "idle" // @poff=833
0x6ca: Push(Stack[-3])
0x6cb: IF (Stack[-1] == 0) GOTO 0x6cd; Pop(1)

0x6cc: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x6cd: Stack[-1] = Stack[-4]
0x6ce: Return(); Pop(2)

0x6cf: PushEmpty(int, bool, int, bool)
0x6d0: Stack[-2] = (int) 0
0x6d1: Push("all") // @poff=0
0x6d2: PushEmpty(string, int)
0x6d3: Stack[-5] = Stack[-1]
0x6d4: Call2 0x6c8

0x6d5: Pop(1)
0x6d6: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6d7: Pop(2)
...
0x6db: Push((int) 1)
0x6dc: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6dd: GOTO 0x6d1

0x6de: Stack[-2] = Stack[-5]
0x6df: Return(); Pop(4)

0x6e0: PushEmpty()
0x6e1: PushEmpty(object)
0x6e2: Stack[-2] = Stack[-1]
0x6e3: Push(-1, 0); TaskCall(1)
0x6e4: Call2 0x80

0x6e5: Pop(-1, 0); TaskReturn
0x6e6: Pop(1)
0x6e7: Return(); Pop(0)

0x6e8: PushEmpty()
0x6e9: PushEmpty(object, int, float)
0x6ea: Stack[-7] = Stack[-3]
0x6eb: Stack[-6] = Stack[-2]
0x6ec: Stack[-5] = Stack[-1]
0x6ed: Call2 0x5c5
...
0x6f0: PushEmpty()
0x6f1: PushEmpty(object, int, float, cvector, cvector)
0x6f2: Stack[-11] = Stack[-5]
0x6f3: Stack[-10] = Stack[-4]
0x6f4: Stack[-9] = Stack[-3]
0x6f5: Stack[-7] = Stack[-2]
0x6f6: Stack[-6] = Stack[-1]
0x6f7: Call2 0x609

0x6f8: Pop(5)
0x6f9: Return(); Pop(0)

0x6fa: PushEmpty(float, float)
0x6fb: Push("health") // @poff=602
0x6fc: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6fd: IF (Stack[-1] == 0) GOTO 0x706; Pop(1)

0x6fe: Push("health") // @poff=602
...
0x704: @ SignalDeath(Stack[-4])
0x705: Pop(0)
0x706: Return(); Pop(2)

0x707: PushEmpty()
0x708: PushEmpty(object)
0x709: Stack[-2] = Stack[-1]
0x70a: Call2 0x6e0
...
0x711: Stack[-2] = Stack[-4]
0x712: Pop(2)
0x713: Return(); Pop(0)

0x714: PushEmpty()
0x715: PushEmpty(object)
...
0x72d: PushEmpty(object, int, bool, object, int, bool)
0x72e: @ CreateInvItem(Stack[-3])
0x72f: Pop(0)
0x730: @@ SetItemName(Stack[-7]); Obj=3 // @poff=857
0x731: Pop(0)
0x732: Push("Organ") // @poff=869
0x733: Push((int) 1)
0x734: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=590
0x735: Pop(2)
0x736: @@ GetItemID(Stack[-2]); Obj=3 // @poff=881
0x737: Pop(0)
0x738: Push((int) 0)
0x739: Push((int) 1)
0x73a: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x73b: Pop(2)
0x73c: Return(); Pop(6)
...
0x740: Pop(0)
0x741: Push((int) 1)
0x742: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x743: IF (Stack[-1] == 0) GOTO 0x745; Pop(1)

0x744: Return(); Pop(0)

0x745: PushEmpty(string)
0x746: Stack[-1] = "liver" // @poff=891
0x747: Call2 0x72d

0x748: Pop(1)
0x749: PushEmpty(string)
0x74a: Stack[-1] = "kidney" // @poff=903
0x74b: Call2 0x72d

0x74c: Pop(1)
0x74d: PushEmpty(string)
0x74e: Stack[-1] = "heart" // @poff=917
0x74f: Call2 0x72d

0x750: Pop(1)
0x751: PushEmpty(string)
0x752: Stack[-1] = "blood" // @poff=929
0x753: Call2 0x72d
...
0x757: Push("b1q04_attack") // @poff=941
0x758: Push((int) 1)
0x759: @ SetVariable(Stack[-2], Stack[-1])
0x75a: Pop(2)
0x75b: @ GetScene(Stack[-1])
0x75c: Pop(0)
0x75d: PushEmpty(object)
0x75e: Call2 0x65b

0x75f: Pop(0)
0x760: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=967
0x761: Pop(1)
0x762: PushEmpty(object)
0x763: Stack[-4] = Stack[-1]
0x764: Push(-1, 6); TaskCall(2)
0x765: Call2 0x12b

0x766: Pop(-1, 6); TaskReturn
0x767: Pop(1)
0x768: Return(); Pop(2)
