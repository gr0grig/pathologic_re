...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x9e3 Vars = (object, int, float, float)
EVENT_43 Op = 0x9eb Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x9f5 Vars = (object, string)
EVENT_41 Op = 0xa02 Vars = (object)
...
0xf1: Stack[-1] = "Neutral" // @poff=89
0xf2: Call2 0x89

0xf3: Pop(1)
0xf4: Push((int) 530944)
0xf5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xf6: Pop(1)
0xf7: @@@ ClearReplies(); Obj=0 // @poff=116
0xf8: Pop(0)
...
0x1b8: Push("player") // @poff=156
0x1b9: @ FindActor(Stack[-4]T, Stack[-1])
0x1ba: Pop(1)
...
0x1cd: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x222: Pop(0)
0x223: Push("all") // @poff=138
0x224: PushEmpty(string, int)
0x225: Stack[-7] = Stack[-1]
0x226: Call2 0x8ba
...
0x262: PushEmpty()
0x263: Stack[-3] = (float) 0.10000000149011612
0x264: Return(); Pop(0)
...
0x27d: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x27e: Pop(0)
0x27f: Push(Stack[-8])
0x280: IF (Stack[-1] == 0) GOTO 0x289; Pop(1)

0x281: Push("attack") // @poff=236
...
0x29d: Pop(0)
0x29e: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=250
0x29f: Pop(0)
...
0x2b9: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=250
0x2ba: Pop(0)
...
0x2d3: Pop(1)
0x2d4: Push("all") // @poff=138
0x2d5: Push("attack_on") // @poff=264
...
0x2ed: IF (Stack[-1] == 1) GOTO 0x2f3; Pop(1)
...
0x2f8: Pop(0)
0x2f9: Push("all") // @poff=138
0x2fa: Push("attack_stay") // @poff=284
0x2fb: @ PlayAnimation(Stack[-2], Stack[-1])
0x2fc: Pop(2)
0x2fd: PushEmpty(bool, float)
0x2fe: Stack[-25] = Stack[-1]
0x2ff: Call2 0x43b
...
0x304: @ Face(Stack[-0]T)
0x305: Pop(0)
0x306: Push("all") // @poff=138
0x307: Push("fjump") // @poff=308
...
0x322: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=250
0x323: Pop(0)
...
0x342: Push("attack_off") // @poff=320
...
0x350: Push("attack_begin") // @poff=342
0x351: Push((int) 1)
0x352: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x35d: Push("attack") // @poff=236
0x35e: Push((int) 1)
0x35f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x369: Push("all") // @poff=138
0x36a: Push("bjump") // @poff=368
...
0x371: Push((float)0.8999999761581421)
0x372: Pop(1); Push(Stack[-9] * Stack[-1]);
0x373: @ GetVictim(Stack[-1], Stack[-4])
0x374: Pop(1)
0x375: @ ReportAttack(Stack[-0]T)
0x376: Pop(0)
...
0x37a: Stack[-6] = Stack[-2]
0x37b: Stack[-10] = Stack[-1]
0x37c: Call2 0x262

0x37d: Stack[-3] = Stack[-5]
0x37e: Pop(3)
...
0x384: Stack[-14] = Stack[-1]
0x385: Call2 0x265

0x386: Stack[-3] = Stack[-4]
0x387: Pop(3)
0x388: Call2 0x6c0

0x389: Stack[-4] = Stack[-5]
0x38a: Pop(4)
0x38b: PushEmpty(int)
0x38c: Call2 0x4ef

0x38d: Pop(0)
0x38e: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x38f: Pop(1)
0x390: PushEmpty(object, float)
0x391: Stack[-5] = Stack[-2]
0x392: Stack[-3] = Stack[-1]
0x393: Call2 0x4f6
...
0x39a: Pop(0)
0x39b: @ irand(Stack[-4], Stack[-1]T)
0x39c: Pop(0)
0x39d: Push((int) 1)
0x39e: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x39f: @ Face(Stack[-0]T)
0x3a0: Pop(0)
0x3a1: Push((bool) 1)
...
0x3a6: Pop(0)
0x3a7: Push("all") // @poff=138
0x3a8: Push("attack_begin") // @poff=342
...
0x3bd: Stack[-6] = Stack[-1]
0x3be: Call2 0x370

0x3bf: Pop(2)
0x3c0: Push("all") // @poff=138
0x3c1: Push("attack_middle") // @poff=380
...
0x3c9: Pop(0)
0x3ca: Push("all") // @poff=138
0x3cb: Push("attack_middle") // @poff=380
...
0x3df: Stack[-11] = Stack[-2]
0x3e0: Stack[-6] = Stack[-1]
0x3e1: Call2 0x370

0x3e2: Pop(2)
0x3e3: Stack[-2] = (int) 1
0x3e4: Push("attack_middle") // @poff=380
0x3e5: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3e6: Push("_") // @poff=408
0x3e7: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3e8: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x3e9: Push("all") // @poff=138
...
0x405: Stack[-11] = Stack[-2]
0x406: Stack[-6] = Stack[-1]
0x407: Call2 0x370
...
0x410: Push("attack_end") // @poff=412
...
0x44f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=250
0x450: Pop(0)
...
0x49b: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x49c: Pop(1)
...
0x4a0: @ Face(Stack[-0]T)
0x4a1: Pop(0)
0x4a2: Push("all") // @poff=138
0x4a3: Push("bjump") // @poff=368
0x4a4: @ PlayAnimation(Stack[-2], Stack[-1])
0x4a5: Pop(2)
0x4a6: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=250
0x4a7: Pop(0)
...
0x4dd: @ irand(Stack[-1], Stack[-2]T)
0x4de: Pop(0)
0x4df: Push((int) 1)
0x4e0: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x4e1: Push("attack") // @poff=236
...
0x4f2: Stack[-1] = "attack_stay" // @poff=284
0x4f3: Call2 0x84c
...
0x51d: Stack[-15] = Stack[-5]
0x51e: Stack[-14] = Stack[-4]
0x51f: Stack[-13] = Stack[-3]
0x520: Stack[-12] = Stack[-2]
0x521: Stack[-11] = Stack[-1]
0x522: Call2 0x567

0x523: Stack[-6] = Stack[-7]
0x524: Pop(6)
0x525: Push( Stack[2 + Tasks[-1].StackPointer] )
0x526: IF (Stack[-1] == 0) GOTO 0x52a; Pop(1)

0x527: Push("head") // @poff=170
...
0x56a: Stack[-17] = Stack[-7]
0x56b: PushEmpty(bool, object)
0x56c: Stack[-23] = Stack[-1]
0x56d: Call2 0x5f3
...
0x573: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x574: Pop(0)
...
0x58a: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=250
0x58b: Pop(0)
...
0x59c: Push((int) 0)
0x59d: Push((float)0.30000001192092896)
...
0x5bf: Push((int) 0)
0x5c0: Push((float)0.30000001192092896)
...
0x5fa: Stack[-1] = "walk" // @poff=482
0x5fb: Return(); Pop(0)

0x5fc: Stack[-1] = "run" // @poff=492
0x5fd: Return(); Pop(0)

0x5fe: PushEmpty()
0x5ff: EventDisable(0)
0x600: PushEmpty(object)
0x601: Stack[-2] = Stack[-1]
0x602: Call2 0x617
...
0x618: Pop(0); PushNull((bool) Stack[-21] == 0)
0x619: IF (Stack[-1] == 0) GOTO 0x61f; Pop(1)

0x61a: PushEmpty(string)
0x61b: Stack[-1] = "fdie" // @poff=500
0x61c: Call2 0x672

0x61d: Pop(1)
0x61e: GOTO 0x671

0x61f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x620: Pop(0)
...
0x630: Stack[-6] = "fdie" // @poff=500
0x631: GOTO 0x633

0x632: Stack[-6] = "bdie" // @poff=510
...
0x639: @ StopAsync()
0x63a: Pop(0)
0x63b: Stack[-21] = Stack[-5]
0x63c: Push("GetScriptProperty") // @poff=520
0x63d: Push((int) 2)
0x63e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x63f: IF (Stack[-1] == 0) GOTO 0x64b; Pop(1)

0x640: Push("Owner") // @poff=556
0x641: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=568
0x642: Pop(1)
0x643: Push(Stack[-4])
0x644: IF (Stack[-1] == 0) GOTO 0x64b; Pop(1)

0x645: Push("Owner") // @poff=556
0x646: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=586
0x647: Pop(1)
0x648: Pop(0); PushNull((bool) Stack[-5] == 0)
0x649: IF (Stack[-1] == 0) GOTO 0x64b; Pop(1)

0x64a: Stack[-21] = Stack[-5]
0x64b: Push("@GetEyesHeight") // @poff=604
0x64c: Push((int) 1)
0x64d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x64e: IF (Stack[-1] == 0) GOTO 0x65a; Pop(1)

0x64f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x650: Pop(0)
0x651: Stack[-1] = [0.0, 0.0, 0.0]
0x652: Push(CvectorIndex(Stack[-1], 1))
0x653: Stack[-3] = Stack[-1]
0x654: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x655: Push("head") // @poff=170
...
0x65c: Stack[-7] = Stack[-1]
0x65d: Call2 0x84c

0x65e: Pop(1)
0x65f: Push("all") // @poff=138
...
0x69c: Stack[-2] = "bullet" // @poff=658
0x69d: Return(); Pop(0)

0x69e: Stack[-2] = "phys" // @poff=672
0x69f: Return(); Pop(0)

0x6a0: PushEmpty(cvector, cvector, cvector, cvector)
0x6a1: @ GetPosition(Stack[-2])
0x6a2: Pop(0)
0x6a3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x6a4: Pop(0)
...
0x6a9: Pop(0)
0x6aa: @@ GetPosition(Stack[-2]); Obj=7 // @poff=470
0x6ab: Pop(0)
...
0x6b5: Push("HasProperty") // @poff=682
0x6b6: Push((int) 2)
...
0x6bc: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=706
0x6bd: Pop(0)
...
0x6c2: Stack[-18] = Stack[-2]
0x6c3: Stack[-1] = "health" // @poff=718
0x6c4: Call2 0x6b4
...
0x6cb: Stack[-18] = Stack[-2]
0x6cc: Stack[-1] = "armor" // @poff=732
0x6cd: Call2 0x6b4
...
0x6d3: Push("armor") // @poff=732
0x6d4: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=744
0x6d5: Pop(1)
0x6d6: Push("armor_") // @poff=756
0x6d7: PushEmpty(string, int)
0x6d8: Stack[-16] = Stack[-1]
0x6d9: Call2 0x692

0x6da: Pop(1)
0x6db: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6dc: PushEmpty(bool, object, string)
0x6dd: Stack[-18] = Stack[-2]
0x6de: Stack[-8] = Stack[-1]
0x6df: Call2 0x6b4
...
0x6e5: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=744
0x6e6: Pop(0)
...
0x6ed: Stack[-3] = Stack[-6]
0x6ee: Pop(3)
0x6ef: Push("health") // @poff=718
0x6f0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=744
0x6f1: Pop(1)
0x6f2: Push((int) 1)
0x6f3: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6f4: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6f5: Push("health") // @poff=718
...
0x6fb: Pop(3)
0x6fc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=770
0x6fd: Pop(2)
0x6fe: PushEmpty(bool, object)
0x6ff: Stack[-17] = Stack[-1]
0x700: Call2 0x6af
...
0x706: Pop(1)
0x707: Stack[-1] = Stack[-16]
0x708: Return(); Pop(12)

0x709: PushEmpty(bool, bool)
0x70a: @@ IsDead(Stack[-1]); Obj=3 // @poff=782
0x70b: Pop(0)
0x70c: Stack[-1] = Stack[-4]
0x70d: Return(); Pop(2)

0x70e: PushEmpty(object, object, object, object)
0x70f: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x723: Pop(0)
0x724: Pop(0); PushNull((bool) Stack[-2] == 0)
0x725: IF (Stack[-1] == 0) GOTO 0x728; Pop(1)

0x726: Stack[-6] = (bool) 0
0x727: Return(); Pop(4)

0x728: @@ GetScene(Stack[-1]); Obj=5 // @poff=803
0x729: Pop(0)
...
0x73d: Stack[-1] = "noaccess" // @poff=812
0x73e: Call2 0x6b4
...
0x744: Push("noaccess") // @poff=812
0x745: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=744
0x746: Pop(1)
0x747: Push((int) 0)
...
0x74b: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x759: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x75a: Pop(0)
...
0x76a: Stack[-1] = "fhit" // @poff=830
0x76b: GOTO 0x76d

0x76c: Stack[-1] = "bhit" // @poff=840
0x76d: Push("hit_react") // @poff=850
0x76e: Push("1") // @poff=870
0x76f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x770: Push("2") // @poff=874
...
0x789: Stack[-25] = Stack[-1]
0x78a: Call2 0x6a0

0x78b: Stack[-2] = Stack[-3]
0x78c: Pop(2)
0x78d: Call2 0x87b

0x78e: Stack[-2] = Stack[-11]
0x78f: Pop(2)
0x790: @ CreateVectorVector(Stack[-8])
0x791: Pop(0)
0x792: Stack[-7] = (int) 1
0x793: Push("hit") // @poff=832
...
0x7a8: Pop(0)
0x7a9: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=887
0x7aa: Pop(0)
0x7ab: PushEmpty(object, int, float, cvector, cvector)
0x7ac: Stack[-26] = Stack[-5]
0x7ad: Stack[-25] = Stack[-4]
0x7ae: Stack[-24] = Stack[-3]
0x7af: Stack[-6] = Stack[-2]
...
0x7c9: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x7ca: Pop(0)
...
0x7d9: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x7da: Pop(0)
0x7db: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=634
0x7dc: Pop(0)
...
0x801: @ StopWorld()
0x802: Pop(0)
0x803: @ CameraTransit(Stack[-3], Stack[-5])
0x804: Pop(0)
0x805: Push(CvectorIndex(Stack[-4], 0))
0x806: Push(CvectorIndex(Stack[-5], 2))
0x807: @ Rotate(Stack[-2], Stack[-1])
0x808: Pop(2)
...
0x80e: Push("head") // @poff=170
0x80f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x810: Pop(1)
0x811: Push(Stack[-1])
0x812: IF (Stack[-1] == 0) GOTO 0x816; Pop(1)

0x813: Push("head") // @poff=170
0x814: @ LookAsyncCamera(Stack[-1])
0x815: Pop(1)
0x816: @ CameraWaitForPlayFinish()
0x817: Pop(0)
0x818: @ ResumeWorld()
0x819: Pop(0)
0x81a: Stack[-21] = (bool) 1
0x81b: Return(); Pop(18)

0x81c: PushEmpty(bool, bool)
0x81d: @ CameraSwitchToNormal()
0x81e: Pop(0)
...
0x824: Push("head") // @poff=170
0x825: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x826: Pop(1)
0x827: Push(Stack[-1])
0x828: IF (Stack[-1] == 0) GOTO 0x82c; Pop(1)

0x829: Push("head") // @poff=170
0x82a: @ UnlookAsync(Stack[-1])
0x82b: Pop(1)
0x82c: Return(); Pop(2)

0x82d: PushEmpty(float, float, float, float)
0x82e: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x82f: Pop(0)
0x830: Push((bool) 0)
0x831: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x832: Pop(1)
0x833: Return(); Pop(4)

0x834: PushEmpty(float, float, float, float)
0x835: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x836: Pop(0)
0x837: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x838: Pop(0)
0x839: Return(); Pop(4)

0x83a: PushEmpty(float, cvector, float, cvector)
0x83b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x83c: Pop(0)
0x83d: Stack[-1] = [0.0, 0.0, 0.0]
0x83e: Push(CvectorIndex(Stack[-1], 1))
0x83f: Stack[-3] = Stack[-1]
0x840: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x841: Push("head") // @poff=170
0x842: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x843: Pop(1)
0x844: Return(); Pop(4)
...
0x84c: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x84d: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x84e: Pop(0)
0x84f: Pop(0); Push((bool) Stack[-8] == 0)
0x850: IF (Stack[-1] == 0) GOTO 0x865; Pop(1)

0x851: Stack[-7] = (int) 0
0x852: Push((int) 1)
0x853: Pop(1); Push(Stack[-8] + Stack[-1]);
0x854: Pop(1); Push(Stack[-18] + Stack[-1]);
0x855: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x856: Pop(1)
0x857: Pop(0); Push((bool) Stack[-6] == 0)
0x858: IF (Stack[-1] == 0) GOTO 0x85a; Pop(1)

0x859: GOTO 0x85d

0x85a: Push((int) 1)
0x85b: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x85c: GOTO 0x852

0x85d: Pop(0); Push((bool) Stack[-7] == 0)
0x85e: IF (Stack[-1] == 0) GOTO 0x860; Pop(1)

0x85f: Return(); Pop(16)

0x860: @ irand(Stack[-5], Stack[-7])
0x861: Pop(0)
0x862: Push((int) 1)
0x863: Pop(1); Push(Stack[-6] + Stack[-1]);
0x864: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x865: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x866: Pop(0)
0x867: Push(Stack[-4])
0x868: IF (Stack[-1] == 0) GOTO 0x874; Pop(1)

0x869: @ GetEyesHeight(Stack[-3])
0x86a: Pop(0)
0x86b: @ GetDirection(Stack[-2])
0x86c: Pop(0)
0x86d: Push((int) 50)
0x86e: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x86f: Push(CvectorIndex(Stack[-1], 1))
0x870: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x871: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x872: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x873: Pop(0)
0x874: Return(); Pop(16)
...
0x876: @ self(Stack[-1])
0x877: Pop(0)
0x878: Stack[-1] = Stack[-3]
0x879: Return(); Pop(2)

0x87a: Stack[-1] = 0
0x87b: PushEmpty(float, float)
0x87c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x87d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x87e: Push((float)9.999999974752427e-07)
0x87f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x880: IF (Stack[-1] == 0) GOTO 0x883; Pop(1)

0x881: Stack[-4] = [0.0, 0.0, 0.0]
0x882: Return(); Pop(2)

0x883: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x884: Return(); Pop(2)

0x885: PushEmpty()
0x886: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x887: IF (Stack[-1] == 0) GOTO 0x88a; Pop(1)

0x888: Stack[-2] = Stack[-3]
0x889: GOTO 0x88b
...
0x88c: PushEmpty()
0x88d: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x88e: IF (Stack[-1] == 0) GOTO 0x891; Pop(1)

0x88f: Stack[-2] = Stack[-4]
0x890: Return(); Pop(0)

0x891: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x892: IF (Stack[-1] == 0) GOTO 0x895; Pop(1)

0x893: Stack[-1] = Stack[-4]
0x894: Return(); Pop(0)

0x895: Stack[-3] = Stack[-4]
0x896: Return(); Pop(0)

0x897: PushEmpty(object, object)
0x898: @ CreateFloatVector(Stack[-1])
0x899: Pop(0)
0x89a: @@ add(Stack[-3]); Obj=1 // @poff=878
0x89b: Pop(0)
0x89c: Push((int) 15)
0x89d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x89e: Pop(1)
0x89f: Return(); Pop(2)

0x8a0: Stack[-1] = 0
0x8a1: PushEmpty(float, float)
0x8a2: @ GetGameTime(Stack[-1])
0x8a3: Pop(0)
0x8a4: Stack[-1] = Stack[-3]
0x8a5: Return(); Pop(2)

0x8a6: PushEmpty(bool, bool)
0x8a7: @ IsPlayerActor(Stack[-3], Stack[-1])
0x8a8: Pop(0)
0x8a9: Push(Stack[-1])
0x8aa: IF (Stack[-1] == 0) GOTO 0x8ae; Pop(1)

0x8ab: Push("attack") // @poff=236
0x8ac: @ PlayGlobalMusic(Stack[-1])
0x8ad: Pop(1)
0x8ae: Return(); Pop(2)

0x8af: PushEmpty(object, object)
0x8b0: @ GetScene(Stack[-1])
0x8b1: Pop(0)
0x8b2: Push("battle") // @poff=937
0x8b3: PushEmpty(object)
0x8b4: Call2 0x875

0x8b5: Pop(0)
0x8b6: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x8b7: Pop(2)
0x8b8: Return(); Pop(2)

0x8b9: Stack[-1] = 0
0x8ba: PushEmpty(string, string)
0x8bb: Stack[-1] = "idle" // @poff=146
0x8bc: Push(Stack[-3])
0x8bd: IF (Stack[-1] == 0) GOTO 0x8bf; Pop(1)

0x8be: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x8bf: Stack[-1] = Stack[-4]
0x8c0: Return(); Pop(2)

0x8c1: PushEmpty(int, bool, int, bool)
0x8c2: Stack[-2] = (int) 0
0x8c3: Push("all") // @poff=138
0x8c4: PushEmpty(string, int)
0x8c5: Stack[-5] = Stack[-1]
0x8c6: Call2 0x8ba

0x8c7: Pop(1)
0x8c8: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8c9: Pop(2)
0x8ca: Pop(0); Push((bool) Stack[-1] == 0)
0x8cb: IF (Stack[-1] == 0) GOTO 0x8cd; Pop(1)

0x8cc: GOTO 0x8d0

0x8cd: Push((int) 1)
0x8ce: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x8cf: GOTO 0x8c3

0x8d0: Stack[-2] = Stack[-5]
0x8d1: Return(); Pop(4)
...
0x8d6: Pop(1)
0x8d7: Push("b1q05PatrolGroup") // @poff=951
0x8d8: Push("pt_b1q05_patrol1") // @poff=985
0x8d9: Push((int) 0)
0x8da: Push((int) 530956)
0x8db: PushEmpty(float)
0x8dc: Call2 0x8a1

0x8dd: Pop(0)
0x8de: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1019
0x8df: Pop(5)
0x8e0: PushEmpty()
0x8e1: Call2 0x8f8
...
0x8e7: Stack[-1] = 0
0x8e8: PushEmpty()
0x8e9: PushEmpty(object, string, float)
0x8ea: PushEmpty(object)
0x8eb: Call2 0x93b

0x8ec: Stack[-1] = Stack[-4]
0x8ed: Pop(1)
0x8ee: Stack[-2] = "pt_b1q05_patrol1" // @poff=985
0x8ef: Stack[-1] = (int) 2
0x8f0: Call2 0x94c
...
0x8f4: Pop(0)
0x8f5: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1027
0x8f6: Pop(1)
0x8f7: Return(); Pop(0)
...
0x8f9: Push((int) 582)
0x8fa: Push((int) 2)
0x8fb: Push((int) 530951)
0x8fc: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8fd: Pop(3)
0x8fe: PushEmpty(bool, object, int)
0x8ff: Stack[-4] = Stack[-2]
0x900: Stack[-1] = (int) -1
0x901: Call2 0x91f
...
0x906: Push((int) 583)
0x907: Push((int) 2)
0x908: Push((int) 530952)
0x909: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x90a: Pop(3)
0x90b: PushEmpty(bool, object, int)
0x90c: Stack[-4] = Stack[-2]
0x90d: Stack[-1] = (int) 582
0x90e: Call2 0x91f
...
0x913: @ GetDiaryRoot(Stack[-1])
0x914: Pop(0)
0x915: Pop(0); Push((bool) Stack[-1] == 0)
0x916: IF (Stack[-1] == 0) GOTO 0x91c; Pop(1)

0x917: Push("Can't retrieve diary root") // @poff=1035
0x918: @ Trace(Stack[-1])
0x919: Pop(1)
0x91a: Stack[-3] = (bool) 0
0x91b: Return(); Pop(2)

0x91c: Stack[-1] = Stack[-3]
0x91d: Return(); Pop(2)

0x91e: Stack[-1] = 0
0x91f: PushEmpty(object, object, int, object, object, int)
0x920: PushEmpty(object)
0x921: Call2 0x912

0x922: Stack[-1] = Stack[-4]
0x923: Pop(1)
0x924: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1087
0x925: Pop(0)
0x926: Pop(0); Push((bool) Stack[-2] == 0)
0x927: IF (Stack[-1] == 0) GOTO 0x92e; Pop(1)

0x928: Push("Can't find diary parent with id: ") // @poff=1092
0x929: Pop(1); Push(Stack[-1] + Stack[-8]);
0x92a: @ Trace(Stack[-1])
0x92b: Pop(1)
0x92c: Stack[-9] = (bool) 0
0x92d: Return(); Pop(6)

0x92e: @@ AddChild(Stack[-8]); Obj=2 // @poff=1160
0x92f: Pop(0)
0x930: Push((int) 7)
0x931: @ SendWorldWndMessage(Stack[-1])
0x932: Pop(1)
0x933: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1169
0x934: Pop(0)
0x935: @ SetDiarySection(Stack[-1])
0x936: Pop(0)
0x937: Stack[-9] = (bool) 0
0x938: Return(); Pop(6)

0x939: Stack[-2] = 0
0x93a: Stack[-3] = 0
0x93b: PushEmpty(object, object, object, object)
0x93c: @ GetMainOutdoorScene(Stack[-2])
0x93d: Pop(0)
0x93e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x93f: IF (Stack[-1] == 0) GOTO 0x946; Pop(1)

0x940: Push("Can't find main outdoor scene") // @poff=1181
0x941: @ Trace(Stack[-1])
0x942: Pop(1)
0x943: Stack[-1] = 0
0x944: Stack[-1] = Stack[-5]
0x945: Return(); Pop(4)

0x946: @@ GetMap(Stack[-1]); Obj=2 // @poff=1241
0x947: Pop(0)
...
0x94a: Stack[-1] = 0
0x94b: Stack[-2] = 0
0x94c: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x94d: @ GetMainOutdoorScene(Stack[-2])
0x94e: Pop(0)
0x94f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x950: IF (Stack[-1] == 0) GOTO 0x955; Pop(1)

0x951: Push("Can't find main outdoor scene") // @poff=1181
0x952: @ Trace(Stack[-1])
0x953: Pop(1)
0x954: Return(); Pop(8)

0x955: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1248
0x956: Pop(0)
0x957: Pop(0); Push((bool) Stack[-1] == 0)
0x958: IF (Stack[-1] == 0) GOTO 0x95f; Pop(1)

0x959: Push("Warning: outdoor scene locator ") // @poff=1259
0x95a: Pop(1); Push(Stack[-1] + Stack[-11]);
0x95b: Push(" doesnt exist") // @poff=1323
0x95c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x95d: @ Trace(Stack[-1])
0x95e: Pop(1)
0x95f: @@ GetMap(Stack[-11]); Obj=2 // @poff=1241
0x960: Pop(0)
0x961: Pop(0); PushNull((bool) Stack[-11] == 0)
0x962: IF (Stack[-1] == 0) GOTO 0x967; Pop(1)

0x963: Push("Can't find map") // @poff=1351
0x964: @ Trace(Stack[-1])
0x965: Pop(1)
0x966: Return(); Pop(8)

0x967: Push(CvectorIndex(Stack[-4], 0))
0x968: Push(CvectorIndex(Stack[-5], 2))
0x969: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1381
0x96a: Pop(2)
0x96b: Return(); Pop(8)

0x96c: Stack[-2] = 0
0x96d: PushEmpty(int, int)
0x96e: Push("branch") // @poff=1394
...
0x97e: PushEmpty(int, int)
0x97f: Push("branch") // @poff=1394
0x980: @ GetVariable(Stack[-1], Stack[-2])
0x981: Pop(1)
...
0x987: Pop(0)
0x988: Push((int) 1)
0x989: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x98a: IF (Stack[-1] == 0) GOTO 0x98e; Pop(1)

0x98b: @ WorkWithCorpse(Stack[-1])
0x98c: Pop(0)
0x98d: GOTO 0x990

0x98e: @ Barter(Stack[-1])
0x98f: Pop(0)
0x990: Return(); Pop(0)

0x991: PushEmpty(object, int, bool, object, int, bool)
0x992: @ CreateInvItem(Stack[-3])
0x993: Pop(0)
0x994: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1408
0x995: Pop(0)
0x996: Push("Organ") // @poff=1420
0x997: Push((int) 1)
0x998: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=770
0x999: Pop(2)
0x99a: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1432
0x99b: Pop(0)
0x99c: Push((int) 0)
0x99d: Push((int) 1)
0x99e: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x99f: Pop(2)
0x9a0: Return(); Pop(6)
...
0x9aa: Stack[-1] = "liver" // @poff=1442
0x9ab: Call2 0x991

0x9ac: Pop(1)
0x9ad: PushEmpty(string)
0x9ae: Stack[-1] = "kidney" // @poff=1454
0x9af: Call2 0x991

0x9b0: Pop(1)
0x9b1: PushEmpty(string)
0x9b2: Stack[-1] = "heart" // @poff=1468
0x9b3: Call2 0x991

0x9b4: Pop(1)
0x9b5: PushEmpty(string)
0x9b6: Stack[-1] = "blood" // @poff=1480
0x9b7: Call2 0x991

0x9b8: Pop(1)
0x9b9: Return(); Pop(0)

0x9ba: Stack[-1] = (int) 515572
0x9bb: Return(); Pop(0)

0x9bc: Stack[-1] = (int) 504031
0x9bd: Return(); Pop(0)

0x9be: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1492
0x9bf: Return(); Pop(0)

0x9c0: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1532
0x9c1: Return(); Pop(0)

0x9c2: Stack[-1] = (bool) 0
0x9c3: Return(); Pop(0)

0x9c4: PushEmpty(int, int)
0x9c5: Push("b1q05ToAttack") // @poff=1576
0x9c6: @ GetVariable(Stack[-1], Stack[-2])
0x9c7: Pop(1)
0x9c8: Push((int) 0)
0x9c9: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x9ca: Return(); Pop(2)

0x9cb: Push("b1q05ToAttack") // @poff=1576
0x9cc: Push((int) 1)
0x9cd: @ SetVariable(Stack[-2], Stack[-1])
0x9ce: Pop(2)
0x9cf: Return(); Pop(0)

0x9d0: PushEmpty(object, object)
0x9d1: @ GetScene(Stack[-1])
0x9d2: Pop(0)
0x9d3: PushEmpty(object)
0x9d4: Call2 0x875

0x9d5: Pop(0)
0x9d6: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1604
0x9d7: Pop(1)
0x9d8: PushEmpty()
0x9d9: Call2 0x9a2
...
0x9dd: Push(-1, 0); TaskCall(5)
0x9de: Call2 0x5fe

0x9df: Pop(-1, 0); TaskReturn
0x9e0: Pop(1)
0x9e1: Return(); Pop(2)

0x9e2: Stack[-1] = 0
0x9e3: PushEmpty()
0x9e4: PushEmpty(object, int, float)
0x9e5: Stack[-7] = Stack[-3]
...
0x9eb: PushEmpty()
0x9ec: PushEmpty(object, int, float, cvector, cvector)
0x9ed: Stack[-11] = Stack[-5]
0x9ee: Stack[-10] = Stack[-4]
0x9ef: Stack[-9] = Stack[-3]
0x9f0: Stack[-7] = Stack[-2]
0x9f1: Stack[-6] = Stack[-1]
0x9f2: Call2 0x7ba

0x9f3: Pop(5)
0x9f4: Return(); Pop(0)

0x9f5: PushEmpty(float, float)
0x9f6: Push("health") // @poff=718
0x9f7: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9f8: IF (Stack[-1] == 0) GOTO 0xa01; Pop(1)

0x9f9: Push("health") // @poff=718
0x9fa: @ GetProperty(Stack[-1], Stack[-2])
0x9fb: Pop(1)
0x9fc: Push((int) 0)
0x9fd: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x9fe: IF (Stack[-1] == 0) GOTO 0xa01; Pop(1)

0x9ff: @ SignalDeath(Stack[-4])
0xa00: Pop(0)
0xa01: Return(); Pop(2)
