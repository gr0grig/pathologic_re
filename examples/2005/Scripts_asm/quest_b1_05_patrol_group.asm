...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x8ce Vars = (object, int, float, float)
EVENT_43 Op = 0x8d6 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8e0 Vars = (object, string)
EVENT_41 Op = 0x8ed Vars = (object)
...
0xe2: Stack[-2] = "quest_b1_05" // @poff=156
0xe3: Stack[-1] = "attack" // @poff=180
0xe4: Call2 0x820
...
0xf6: Stack[-2] = "quest_b1_05" // @poff=156
0xf7: Stack[-1] = "attack" // @poff=180
0xf8: Call2 0x820
...
0x10a: Stack[-2] = "quest_b1_05" // @poff=156
0x10b: Stack[-1] = "attack" // @poff=180
0x10c: Call2 0x820
...
0x111: Stack[-2] = "quest_b1_05" // @poff=156
0x112: Stack[-1] = "attack" // @poff=180
0x113: Call2 0x820
...
0x137: Push("player") // @poff=194
0x138: @ FindActor(Stack[-4]T, Stack[-1])
0x139: Pop(1)
...
0x14c: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1e1: PushEmpty()
0x1e2: Stack[-3] = (float) 0.10000000149011612
0x1e3: Return(); Pop(0)
...
0x1fc: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1fd: Pop(0)
0x1fe: Push(Stack[-8])
0x1ff: IF (Stack[-1] == 0) GOTO 0x208; Pop(1)

0x200: Push("attack") // @poff=180
...
0x21c: Pop(0)
0x21d: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=274
0x21e: Pop(0)
...
0x238: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=274
0x239: Pop(0)
...
0x26c: IF (Stack[-1] == 1) GOTO 0x272; Pop(1)

0x26d: PushEmpty(bool)
0x26e: Call2 0x43e

0x26f: Pop(0)
0x270: IF (Stack[-1] == 1) GOTO 0x272; Pop(1)

0x271: Stack[-1] = (bool) 0
0x272: IF (Stack[-1] == 0) GOTO 0x283; Pop(1)

0x273: @ Face(Stack[-0]T)
0x274: Pop(0)
0x275: PushEmpty()
0x276: Call2 0x470
...
0x283: @ Face(Stack[-0]T)
0x284: Pop(0)
0x285: Push("all") // @poff=138
0x286: Push("fjump") // @poff=332
...
0x2a1: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=274
0x2a2: Pop(0)
...
0x2c1: Push("attack_off") // @poff=344
...
0x2cf: Push("attack_begin") // @poff=366
0x2d0: Push((int) 1)
0x2d1: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2dc: Push("attack") // @poff=180
0x2dd: Push((int) 1)
0x2de: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2f0: Push((float)0.8999999761581421)
0x2f1: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2f2: @ GetVictim(Stack[-1], Stack[-4])
0x2f3: Pop(1)
0x2f4: @ ReportAttack(Stack[-0]T)
0x2f5: Pop(0)
...
0x2fa: Stack[-10] = Stack[-1]
0x2fb: Call2 0x1e1

0x2fc: Stack[-3] = Stack[-5]
0x2fd: Pop(3)
0x2fe: PushEmpty(float, object, float, int)
0x2ff: Stack[-7] = Stack[-3]
0x300: Stack[-6] = Stack[-2]
0x301: PushEmpty(int, object, int)
0x302: Stack[-10] = Stack[-2]
0x303: Stack[-14] = Stack[-1]
0x304: Call2 0x1e4

0x305: Stack[-3] = Stack[-4]
0x306: Pop(3)
0x307: Call2 0x63f

0x308: Stack[-4] = Stack[-5]
0x309: Pop(4)
0x30a: PushEmpty(int)
0x30b: Call2 0x46e

0x30c: Pop(0)
0x30d: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x30e: Pop(1)
0x30f: PushEmpty(object, float)
0x310: Stack[-5] = Stack[-2]
...
0x319: Pop(0)
0x31a: @ irand(Stack[-4], Stack[-1]T)
0x31b: Pop(0)
0x31c: Push((int) 1)
0x31d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x31e: @ Face(Stack[-0]T)
0x31f: Pop(0)
0x320: Push((bool) 1)
...
0x327: Push("attack_begin") // @poff=366
...
0x33b: Stack[-11] = Stack[-2]
0x33c: Stack[-6] = Stack[-1]
0x33d: Call2 0x2ef

0x33e: Pop(2)
0x33f: Push("all") // @poff=138
0x340: Push("attack_middle") // @poff=404
...
0x348: Pop(0)
0x349: Push("all") // @poff=138
0x34a: Push("attack_middle") // @poff=404
...
0x35e: Stack[-11] = Stack[-2]
0x35f: Stack[-6] = Stack[-1]
0x360: Call2 0x2ef

0x361: Pop(2)
0x362: Stack[-2] = (int) 1
0x363: Push("attack_middle") // @poff=404
0x364: Pop(1); Push(Stack[-1] + Stack[-5]);
0x365: Push("_") // @poff=432
0x366: Pop(2); Push(Stack[-2] + Stack[-1]);
0x367: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x368: Push("all") // @poff=138
...
0x38f: Push("attack_end") // @poff=436
...
0x3ce: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=274
0x3cf: Pop(0)
...
0x41a: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x41b: Pop(1)
...
0x41f: @ Face(Stack[-0]T)
0x420: Pop(0)
0x421: Push("all") // @poff=138
0x422: Push("bjump") // @poff=392
0x423: @ PlayAnimation(Stack[-2], Stack[-1])
0x424: Pop(2)
0x425: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=274
0x426: Pop(0)
...
0x45c: @ irand(Stack[-1], Stack[-2]T)
0x45d: Pop(0)
0x45e: Push((int) 1)
0x45f: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x460: Push("attack") // @poff=180
...
0x471: Stack[-1] = "attack_stay" // @poff=308
0x472: Call2 0x7cb
...
0x49c: Stack[-15] = Stack[-5]
0x49d: Stack[-14] = Stack[-4]
0x49e: Stack[-13] = Stack[-3]
0x49f: Stack[-12] = Stack[-2]
0x4a0: Stack[-11] = Stack[-1]
0x4a1: Call2 0x4e6

0x4a2: Stack[-6] = Stack[-7]
0x4a3: Pop(6)
0x4a4: Push( Stack[2 + Tasks[-1].StackPointer] )
0x4a5: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a6: Push("head") // @poff=208
0x4a7: @ UnlookAsync(Stack[-1])
0x4a8: Pop(1)
0x4a9: Push((int) 1)
0x4aa: @ KillTimer(Stack[-1])
0x4ab: Pop(1)
0x4ac: Stack[-1] = Stack[-10]
0x4ad: Return(); Pop(4)
...
0x4e9: Stack[-17] = Stack[-7]
0x4ea: PushEmpty(bool, object)
0x4eb: Stack[-23] = Stack[-1]
0x4ec: Call2 0x572
...
0x4f2: @@ GetPosition(Stack[-5]); Obj=21 // @poff=494
0x4f3: Pop(0)
...
0x509: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=274
0x50a: Pop(0)
...
0x51b: Push((int) 0)
0x51c: Push((float)0.30000001192092896)
...
0x53e: Push((int) 0)
0x53f: Push((float)0.30000001192092896)
...
0x576: Stack[-2] = Stack[-4]
0x577: Pop(2)
0x578: Return(); Pop(0)

0x579: Stack[-1] = "walk" // @poff=506
0x57a: Return(); Pop(0)

0x57b: Stack[-1] = "run" // @poff=516
0x57c: Return(); Pop(0)

0x57d: PushEmpty()
0x57e: EventDisable(0)
0x57f: PushEmpty(object)
0x580: Stack[-2] = Stack[-1]
0x581: Call2 0x596
...
0x597: Pop(0); PushNull((bool) Stack[-21] == 0)
0x598: IF (Stack[-1] == 0) GOTO 0x59e; Pop(1)

0x599: PushEmpty(string)
0x59a: Stack[-1] = "fdie" // @poff=524
0x59b: Call2 0x5f1

0x59c: Pop(1)
0x59d: GOTO 0x5f0

0x59e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=494
0x59f: Pop(0)
...
0x5af: Stack[-6] = "fdie" // @poff=524
0x5b0: GOTO 0x5b2

0x5b1: Stack[-6] = "bdie" // @poff=534
...
0x5b8: @ StopAsync()
0x5b9: Pop(0)
0x5ba: Stack[-21] = Stack[-5]
0x5bb: Push("GetScriptProperty") // @poff=544
0x5bc: Push((int) 2)
0x5bd: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x5be: IF (Stack[-1] == 0) GOTO 0x5ca; Pop(1)

0x5bf: Push("Owner") // @poff=580
0x5c0: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=592
0x5c1: Pop(1)
0x5c2: Push(Stack[-4])
0x5c3: IF (Stack[-1] == 0) GOTO 0x5ca; Pop(1)

0x5c4: Push("Owner") // @poff=580
0x5c5: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=610
0x5c6: Pop(1)
0x5c7: Pop(0); PushNull((bool) Stack[-5] == 0)
0x5c8: IF (Stack[-1] == 0) GOTO 0x5ca; Pop(1)

0x5c9: Stack[-21] = Stack[-5]
0x5ca: Push("@GetEyesHeight") // @poff=628
0x5cb: Push((int) 1)
0x5cc: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x5cd: IF (Stack[-1] == 0) GOTO 0x5d9; Pop(1)

0x5ce: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=658
0x5cf: Pop(0)
0x5d0: Stack[-1] = [0.0, 0.0, 0.0]
0x5d1: Push(CvectorIndex(Stack[-1], 1))
0x5d2: Stack[-3] = Stack[-1]
0x5d3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x5d4: Push("head") // @poff=208
...
0x61b: Stack[-2] = "bullet" // @poff=682
0x61c: Return(); Pop(0)

0x61d: Stack[-2] = "phys" // @poff=696
0x61e: Return(); Pop(0)

0x61f: PushEmpty(cvector, cvector, cvector, cvector)
0x620: @ GetPosition(Stack[-2])
0x621: Pop(0)
0x622: @@ GetPosition(Stack[-1]); Obj=5 // @poff=494
0x623: Pop(0)
...
0x628: Pop(0)
0x629: @@ GetPosition(Stack[-2]); Obj=7 // @poff=494
0x62a: Pop(0)
...
0x630: Pop(0)
0x631: Stack[-1] = Stack[-4]
0x632: Return(); Pop(2)

0x633: PushEmpty(bool, bool)
0x634: Push("HasProperty") // @poff=706
0x635: Push((int) 2)
...
0x63b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=730
0x63c: Pop(0)
0x63d: Stack[-1] = Stack[-5]
0x63e: Return(); Pop(2)

0x63f: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x640: PushEmpty(bool, object, string)
0x641: Stack[-18] = Stack[-2]
0x642: Stack[-1] = "health" // @poff=742
0x643: Call2 0x633
...
0x64a: Stack[-18] = Stack[-2]
0x64b: Stack[-1] = "armor" // @poff=756
0x64c: Call2 0x633
...
0x652: Push("armor") // @poff=756
0x653: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=768
0x654: Pop(1)
0x655: Push("armor_") // @poff=780
...
0x65c: Stack[-18] = Stack[-2]
0x65d: Stack[-8] = Stack[-1]
0x65e: Call2 0x633
...
0x664: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=768
0x665: Pop(0)
...
0x66c: Stack[-3] = Stack[-6]
0x66d: Pop(3)
0x66e: Push("health") // @poff=742
0x66f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=768
0x670: Pop(1)
0x671: Push((int) 1)
0x672: Pop(1); Push(Stack[-1] - Stack[-4]);
0x673: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x674: Push("health") // @poff=742
...
0x67a: Pop(3)
0x67b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=794
0x67c: Pop(2)
0x67d: PushEmpty(bool, object)
0x67e: Stack[-17] = Stack[-1]
0x67f: Call2 0x62e
...
0x685: Pop(1)
0x686: Stack[-1] = Stack[-16]
0x687: Return(); Pop(12)

0x688: PushEmpty(bool, bool)
0x689: @@ IsDead(Stack[-1]); Obj=3 // @poff=806
0x68a: Pop(0)
0x68b: Stack[-1] = Stack[-4]
0x68c: Return(); Pop(2)

0x68d: PushEmpty(object, object, object, object)
0x68e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6a2: Pop(0)
0x6a3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6a4: IF (Stack[-1] == 0) GOTO 0x6a7; Pop(1)

0x6a5: Stack[-6] = (bool) 0
0x6a6: Return(); Pop(4)

0x6a7: @@ GetScene(Stack[-1]); Obj=5 // @poff=827
0x6a8: Pop(0)
...
0x6bb: Stack[-6] = Stack[-2]
0x6bc: Stack[-1] = "noaccess" // @poff=836
0x6bd: Call2 0x633
...
0x6c3: Push("noaccess") // @poff=836
0x6c4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=768
0x6c5: Pop(1)
0x6c6: Push((int) 0)
...
0x6ca: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6d8: @@ GetPosition(Stack[-5]); Obj=15 // @poff=494
0x6d9: Pop(0)
...
0x6e9: Stack[-1] = "fhit" // @poff=854
0x6ea: GOTO 0x6ec

0x6eb: Stack[-1] = "bhit" // @poff=864
0x6ec: Push("hit_react") // @poff=874
0x6ed: Push("1") // @poff=894
0x6ee: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6ef: Push("2") // @poff=898
...
0x708: Stack[-25] = Stack[-1]
0x709: Call2 0x61f

0x70a: Stack[-2] = Stack[-3]
0x70b: Pop(2)
0x70c: Call2 0x7fa

0x70d: Stack[-2] = Stack[-11]
0x70e: Pop(2)
0x70f: @ CreateVectorVector(Stack[-8])
0x710: Pop(0)
0x711: Stack[-7] = (int) 1
0x712: Push("hit") // @poff=856
...
0x727: Pop(0)
0x728: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=911
0x729: Pop(0)
0x72a: PushEmpty(object, int, float, cvector, cvector)
0x72b: Stack[-26] = Stack[-5]
0x72c: Stack[-25] = Stack[-4]
0x72d: Stack[-24] = Stack[-3]
0x72e: Stack[-6] = Stack[-2]
...
0x748: @@ GetPosition(Stack[-3]); Obj=7 // @poff=494
0x749: Pop(0)
...
0x758: @@ GetPosition(Stack[-8]); Obj=20 // @poff=494
0x759: Pop(0)
0x75a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=658
0x75b: Pop(0)
...
0x780: @ StopWorld()
0x781: Pop(0)
0x782: @ CameraTransit(Stack[-3], Stack[-5])
0x783: Pop(0)
0x784: Push(CvectorIndex(Stack[-4], 0))
0x785: Push(CvectorIndex(Stack[-5], 2))
0x786: @ Rotate(Stack[-2], Stack[-1])
0x787: Pop(2)
...
0x78d: Push("head") // @poff=208
0x78e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x78f: Pop(1)
0x790: Push(Stack[-1])
0x791: IF (Stack[-1] == 0) GOTO 0x795; Pop(1)

0x792: Push("head") // @poff=208
0x793: @ LookAsyncCamera(Stack[-1])
0x794: Pop(1)
0x795: @ CameraWaitForPlayFinish()
0x796: Pop(0)
0x797: @ ResumeWorld()
0x798: Pop(0)
0x799: Stack[-21] = (bool) 1
0x79a: Return(); Pop(18)

0x79b: PushEmpty(bool, bool)
0x79c: @ CameraSwitchToNormal()
0x79d: Pop(0)
...
0x7a3: Push("head") // @poff=208
0x7a4: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7a5: Pop(1)
0x7a6: Push(Stack[-1])
0x7a7: IF (Stack[-1] == 0) GOTO 0x7ab; Pop(1)

0x7a8: Push("head") // @poff=208
0x7a9: @ UnlookAsync(Stack[-1])
0x7aa: Pop(1)
0x7ab: Return(); Pop(2)

0x7ac: PushEmpty(float, float, float, float)
0x7ad: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x7ae: Pop(0)
0x7af: Push((bool) 0)
0x7b0: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7b1: Pop(1)
0x7b2: Return(); Pop(4)

0x7b3: PushEmpty(float, float, float, float)
0x7b4: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x7b5: Pop(0)
0x7b6: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x7b7: Pop(0)
0x7b8: Return(); Pop(4)

0x7b9: PushEmpty(float, cvector, float, cvector)
0x7ba: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=658
0x7bb: Pop(0)
0x7bc: Stack[-1] = [0.0, 0.0, 0.0]
0x7bd: Push(CvectorIndex(Stack[-1], 1))
0x7be: Stack[-3] = Stack[-1]
0x7bf: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7c0: Push("head") // @poff=208
0x7c1: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x7c2: Pop(1)
0x7c3: Return(); Pop(4)
...
0x7cb: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7cc: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7cd: Pop(0)
0x7ce: Pop(0); Push((bool) Stack[-8] == 0)
0x7cf: IF (Stack[-1] == 0) GOTO 0x7e4; Pop(1)

0x7d0: Stack[-7] = (int) 0
0x7d1: Push((int) 1)
0x7d2: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7d3: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7d4: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7d5: Pop(1)
0x7d6: Pop(0); Push((bool) Stack[-6] == 0)
0x7d7: IF (Stack[-1] == 0) GOTO 0x7d9; Pop(1)

0x7d8: GOTO 0x7dc

0x7d9: Push((int) 1)
0x7da: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7db: GOTO 0x7d1

0x7dc: Pop(0); Push((bool) Stack[-7] == 0)
0x7dd: IF (Stack[-1] == 0) GOTO 0x7df; Pop(1)

0x7de: Return(); Pop(16)

0x7df: @ irand(Stack[-5], Stack[-7])
0x7e0: Pop(0)
0x7e1: Push((int) 1)
0x7e2: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7e3: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7e4: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7e5: Pop(0)
0x7e6: Push(Stack[-4])
0x7e7: IF (Stack[-1] == 0) GOTO 0x7f3; Pop(1)

0x7e8: @ GetEyesHeight(Stack[-3])
0x7e9: Pop(0)
0x7ea: @ GetDirection(Stack[-2])
0x7eb: Pop(0)
0x7ec: Push((int) 50)
0x7ed: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7ee: Push(CvectorIndex(Stack[-1], 1))
0x7ef: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7f0: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7f1: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7f2: Pop(0)
0x7f3: Return(); Pop(16)
...
0x7f9: Stack[-1] = 0
0x7fa: PushEmpty(float, float)
0x7fb: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7fc: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7fd: Push((float)9.999999974752427e-07)
0x7fe: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7ff: IF (Stack[-1] == 0) GOTO 0x802; Pop(1)

0x800: Stack[-4] = [0.0, 0.0, 0.0]
0x801: Return(); Pop(2)

0x802: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x803: Return(); Pop(2)

0x804: PushEmpty()
0x805: Pop(0); Push((bool) Stack[-2] < Stack[-1])
...
0x80b: PushEmpty()
0x80c: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x80d: IF (Stack[-1] == 0) GOTO 0x810; Pop(1)

0x80e: Stack[-2] = Stack[-4]
0x80f: Return(); Pop(0)

0x810: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x811: IF (Stack[-1] == 0) GOTO 0x814; Pop(1)

0x812: Stack[-1] = Stack[-4]
0x813: Return(); Pop(0)

0x814: Stack[-3] = Stack[-4]
0x815: Return(); Pop(0)

0x816: PushEmpty(object, object)
0x817: @ CreateFloatVector(Stack[-1])
0x818: Pop(0)
0x819: @@ add(Stack[-3]); Obj=1 // @poff=902
0x81a: Pop(0)
0x81b: Push((int) 15)
0x81c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x81d: Pop(1)
0x81e: Return(); Pop(2)

0x81f: Stack[-1] = 0
0x820: PushEmpty(object, object)
0x821: @ FindActor(Stack[-1], Stack[-4])
0x822: Pop(0)
0x823: Pop(0); PushNull((bool) Stack[-1] == 0)
0x824: IF (Stack[-1] == 0) GOTO 0x827; Pop(1)

0x825: Stack[-5] = (bool) 0
0x826: Return(); Pop(2)

0x827: @ Trigger(Stack[-1], Stack[-3])
0x828: Pop(0)
0x829: Stack[-5] = (bool) 1
0x82a: Return(); Pop(2)

0x82b: Stack[-1] = 0
0x82c: PushEmpty(bool, bool)
0x82d: @ IsPlayerActor(Stack[-3], Stack[-1])
0x82e: Pop(0)
0x82f: Push(Stack[-1])
0x830: IF (Stack[-1] == 0) GOTO 0x834; Pop(1)

0x831: Push("attack") // @poff=180
0x832: @ PlayGlobalMusic(Stack[-1])
0x833: Pop(1)
0x834: Return(); Pop(2)

0x835: PushEmpty(object, object)
0x836: @ GetScene(Stack[-1])
0x837: Pop(0)
0x838: Push("battle") // @poff=961
0x839: PushEmpty(object)
0x83a: Call2 0x7f4

0x83b: Pop(0)
0x83c: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x83d: Pop(2)
0x83e: Return(); Pop(2)

0x83f: Stack[-1] = 0
0x840: PushEmpty(string, string)
0x841: Stack[-1] = "idle" // @poff=146
0x842: Push(Stack[-3])
0x843: IF (Stack[-1] == 0) GOTO 0x845; Pop(1)

0x844: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x845: Stack[-1] = Stack[-4]
0x846: Return(); Pop(2)

0x847: PushEmpty(int, bool, int, bool)
0x848: Stack[-2] = (int) 0
0x849: Push("all") // @poff=138
0x84a: PushEmpty(string, int)
0x84b: Stack[-5] = Stack[-1]
0x84c: Call2 0x840

0x84d: Pop(1)
0x84e: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x84f: Pop(2)
0x850: Pop(0); Push((bool) Stack[-1] == 0)
0x851: IF (Stack[-1] == 0) GOTO 0x853; Pop(1)

0x852: GOTO 0x856

0x853: Push((int) 1)
0x854: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x855: GOTO 0x849

0x856: Stack[-2] = Stack[-5]
0x857: Return(); Pop(4)

0x858: PushEmpty(int, int)
0x859: Push("branch") // @poff=975
0x85a: @ GetVariable(Stack[-1], Stack[-2])
0x85b: Pop(1)
0x85c: Push((int) 0)
...
0x872: Pop(0)
0x873: Push((int) 1)
0x874: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x875: IF (Stack[-1] == 0) GOTO 0x879; Pop(1)

0x876: @ WorkWithCorpse(Stack[-1])
0x877: Pop(0)
0x878: GOTO 0x87b

0x879: @ Barter(Stack[-1])
0x87a: Pop(0)
0x87b: Return(); Pop(0)

0x87c: PushEmpty(object, int, bool, object, int, bool)
0x87d: @ CreateInvItem(Stack[-3])
0x87e: Pop(0)
0x87f: @@ SetItemName(Stack[-7]); Obj=3 // @poff=989
0x880: Pop(0)
0x881: Push("Organ") // @poff=1001
0x882: Push((int) 1)
0x883: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=794
0x884: Pop(2)
0x885: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1013
0x886: Pop(0)
0x887: Push((int) 0)
0x888: Push((int) 1)
0x889: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x88a: Pop(2)
0x88b: Return(); Pop(6)
...
0x88f: Pop(0)
0x890: Push((int) 1)
0x891: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x892: IF (Stack[-1] == 0) GOTO 0x894; Pop(1)

0x893: Return(); Pop(0)

0x894: PushEmpty(string)
0x895: Stack[-1] = "liver" // @poff=1023
0x896: Call2 0x87c

0x897: Pop(1)
0x898: PushEmpty(string)
0x899: Stack[-1] = "kidney" // @poff=1035
0x89a: Call2 0x87c

0x89b: Pop(1)
0x89c: PushEmpty(string)
0x89d: Stack[-1] = "heart" // @poff=1049
0x89e: Call2 0x87c

0x89f: Pop(1)
0x8a0: PushEmpty(string)
0x8a1: Stack[-1] = "blood" // @poff=1061
0x8a2: Call2 0x87c

0x8a3: Pop(1)
0x8a4: Return(); Pop(0)

0x8a5: Stack[-1] = (int) 515572
0x8a6: Return(); Pop(0)

0x8a7: Stack[-1] = (int) 504031
0x8a8: Return(); Pop(0)

0x8a9: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1073
0x8aa: Return(); Pop(0)

0x8ab: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1113
0x8ac: Return(); Pop(0)

0x8ad: Stack[-1] = (bool) 0
0x8ae: Return(); Pop(0)

0x8af: PushEmpty(int, int)
0x8b0: Push("b1q05ToAttack1") // @poff=1157
0x8b1: @ GetVariable(Stack[-1], Stack[-2])
0x8b2: Pop(1)
0x8b3: Push((int) 0)
0x8b4: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0x8b5: Return(); Pop(2)

0x8b6: Push("b1q05ToAttack1") // @poff=1157
0x8b7: Push((int) 1)
0x8b8: @ SetVariable(Stack[-2], Stack[-1])
0x8b9: Pop(2)
0x8ba: Return(); Pop(0)

0x8bb: PushEmpty(object, object)
0x8bc: @ GetScene(Stack[-1])
0x8bd: Pop(0)
0x8be: PushEmpty(object)
0x8bf: Call2 0x7f4

0x8c0: Pop(0)
0x8c1: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1187
0x8c2: Pop(1)
0x8c3: PushEmpty()
0x8c4: Call2 0x88d
...
0x8c7: Stack[-4] = Stack[-1]
0x8c8: Push(-1, 0); TaskCall(5)
0x8c9: Call2 0x57d

0x8ca: Pop(-1, 0); TaskReturn
0x8cb: Pop(1)
0x8cc: Return(); Pop(2)

0x8cd: Stack[-1] = 0
0x8ce: PushEmpty()
0x8cf: PushEmpty(object, int, float)
0x8d0: Stack[-7] = Stack[-3]
...
0x8d6: PushEmpty()
0x8d7: PushEmpty(object, int, float, cvector, cvector)
0x8d8: Stack[-11] = Stack[-5]
0x8d9: Stack[-10] = Stack[-4]
0x8da: Stack[-9] = Stack[-3]
0x8db: Stack[-7] = Stack[-2]
0x8dc: Stack[-6] = Stack[-1]
0x8dd: Call2 0x739

0x8de: Pop(5)
0x8df: Return(); Pop(0)

0x8e0: PushEmpty(float, float)
0x8e1: Push("health") // @poff=742
0x8e2: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8e3: IF (Stack[-1] == 0) GOTO 0x8ec; Pop(1)

0x8e4: Push("health") // @poff=742
0x8e5: @ GetProperty(Stack[-1], Stack[-2])
0x8e6: Pop(1)
0x8e7: Push((int) 0)
0x8e8: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x8e9: IF (Stack[-1] == 0) GOTO 0x8ec; Pop(1)

0x8ea: @ SignalDeath(Stack[-4])
0x8eb: Pop(0)
0x8ec: Return(); Pop(2)
