...
0x4a1: @ FindActor(Stack[-1], Stack[-4])
0x4a2: Pop(0)
0x4a3: Pop(0); PushNull((bool) Stack[-1] == 0)
0x4a4: IF (Stack[-1] == 0) GOTO 0x4a7; Pop(1)

0x4a5: Stack[-5] = (bool) 0
0x4a6: Return(); Pop(2)

0x4a7: @ Trigger(Stack[-1], Stack[-3])
0x4a8: Pop(0)
0x4a9: Stack[-5] = (bool) 1
0x4aa: Return(); Pop(2)

0x4ab: Stack[-1] = 0
0x4ac: PushEmpty(object, object)
0x4ad: @ GetScene(Stack[-1])
0x4ae: Pop(0)
0x4af: Push("battle") // @poff=458
0x4b0: PushEmpty(object)
0x4b1: Call2 0x449

0x4b2: Pop(0)
0x4b3: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x4b4: Pop(2)
0x4b5: Return(); Pop(2)
...
0x4bb: Pop(1)
0x4bc: Pop(1); Push((bool) Stack[-1] == 0)
0x4bd: IF (Stack[-1] == 0) GOTO 0x4c0; Pop(1)

0x4be: Stack[-2] = (bool) 0
0x4bf: Return(); Pop(0)
...
0x4cf: Stack[-2] = Stack[-1]
0x4d0: Push(-1, 1); TaskCall(3)
0x4d1: Call2 0xe4

0x4d2: Pop(-1, 1); TaskReturn
0x4d3: Pop(1)
0x4d4: @ ResetAAS()
0x4d5: Pop(0)
0x4d6: Return(); Pop(0)
...
0x4da: Push(-1, 1); TaskCall(3)
0x4db: Call2 0xe4

0x4dc: Pop(-1, 1); TaskReturn
0x4dd: Pop(1)
0x4de: @ ResetAAS()
0x4df: Pop(0)
0x4e0: Return(); Pop(0)
...
0x4e1: PushEmpty()
0x4e2: PushEmpty()
0x4e3: Push(-0, 0); TaskCall(2)
0x4e4: Call2 0xb3

0x4e5: Pop(-0, 0); TaskReturn
0x4e6: Pop(0)
0x4e7: Return(); Pop(0)

0x4e8: PushEmpty(float, bool, float, bool)
0x4e9: Push("health") // @poff=0
0x4ea: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x4eb: IF (Stack[-1] == 0) GOTO 0x501; Pop(1)

0x4ec: Push("health") // @poff=0
0x4ed: @ GetProperty(Stack[-1], Stack[-3])
0x4ee: Pop(1)
0x4ef: Push(GlobalVars[0])
0x4f0: Stack[-2] = Stack[-3] < Stack[-1]; Pop(1);
0x4f1: Push(GlobalVars[0])
0x4f2: Stack[-3] = Stack[-1]
0x4f3: GlobalVars[0] = Stack[-1]; Pop(1)
0x4f4: PushEmpty(bool)
0x4f5: Stack[-1] = (bool) 0
0x4f6: Push(Stack[-2])
0x4f7: IF (Stack[-1] == 0) GOTO 0x4fe; Pop(1)

0x4f8: PushEmpty(bool, object)
0x4f9: Stack[-9] = Stack[-1]
0x4fa: Call2 0x408
...
0x4ff: Stack[-7] = (bool) 1
0x500: Return(); Pop(4)

0x501: Stack[-7] = (bool) 0
0x502: Return(); Pop(4)

0x503: PushEmpty(float, float)
0x504: Push("health") // @poff=0
0x505: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x506: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x507: Push("health") // @poff=0
0x508: @ GetProperty(Stack[-1], Stack[-2])
0x509: Pop(1)
0x50a: Push((int) 0)
0x50b: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x50c: IF (Stack[-1] == 0) GOTO 0x50f; Pop(1)

0x50d: @ SignalDeath(Stack[-4])
0x50e: Pop(0)
0x50f: PushEmpty(bool)
0x510: Stack[-1] = (bool) 0
0x511: Push(GlobalVars[0])
0x512: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x513: IF (Stack[-1] == 0) GOTO 0x51a; Pop(1)

0x514: PushEmpty(bool, object)
0x515: Stack[-7] = Stack[-1]
0x516: Call2 0x408
...
0x51c: Stack[-5] = Stack[-1]
0x51d: Push(-1, 4); TaskCall(5)
0x51e: Call2 0x25f

0x51f: Pop(-1, 4); TaskReturn
0x520: Pop(1)
0x521: Return(); Pop(2)
...
0x529: PushEmpty(float, object, float, int)
0x52a: Stack[-7] = Stack[-3]
0x52b: Stack[-2] = (float) 0.02500000037252903
0x52c: Stack[-1] = (int) 0
0x52d: Call2 0x396

0x52e: Stack[-4] = Stack[-5]
0x52f: Pop(4)
0x530: Push((int) 7)
0x531: Push((float)0.02500000037252903)
0x532: @ ReportHit(Stack[-5], Stack[-2], Stack[-3], Stack[-1])
0x533: Pop(2)
0x534: Return(); Pop(2)

0x535: PushEmpty(object, float, object, float)
0x536: @ CreateInvItem(Stack[-2])
0x537: Pop(0)
0x538: Push("rat") // @poff=472
0x539: @@ SetItemName(Stack[-1]); Obj=3 // @poff=480
0x53a: Pop(1)
0x53b: Push((float)0.25)
0x53c: Push((float)0.5)
0x53d: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x53e: Pop(2)
0x53f: Push("quality") // @poff=492
0x540: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=348
0x541: Pop(1)
0x542: PushEmpty(object, object, int)
0x543: Stack[-8] = Stack[-3]
...
0x558: Stack[-2] = "quest_b1_05" // @poff=508
0x559: Stack[-1] = "rat_dead" // @poff=532
0x55a: Call2 0x4a0
