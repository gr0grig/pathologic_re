...
Strings:
	...
	A:GetEyesHeight
	W:idle
// @pool_raw:70006c00610079006500720000006800650061006400000061006c006c000000476574506f736974696f6e004765744579657348656967687400690064006c0065000000
...
0xc8: Push((int) 1)
0xc9: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xca: GOTO 0xbe

0xcb: Stack[-2] = Stack[-5]
0xcc: Return(); Pop(4)
