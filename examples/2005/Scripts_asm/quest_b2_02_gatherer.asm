...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x247: Push("player") // @poff=156
0x248: @ FindActor(Stack[-4]T, Stack[-1])
0x249: Pop(1)
...
0x25c: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2e7: Pop(0)
0x2e8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x2e9: Pop(0)
...
0x2f3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x2f4: Pop(0)
0x2f5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x2f6: Pop(0)
...
0x31b: @ StopWorld()
0x31c: Pop(0)
0x31d: @ CameraTransit(Stack[-3], Stack[-5])
0x31e: Pop(0)
0x31f: Push(CvectorIndex(Stack[-4], 0))
0x320: Push(CvectorIndex(Stack[-5], 2))
0x321: @ Rotate(Stack[-2], Stack[-1])
0x322: Pop(2)
...
0x328: Push("head") // @poff=170
0x329: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x32a: Pop(1)
0x32b: Push(Stack[-1])
0x32c: IF (Stack[-1] == 0) GOTO 0x330; Pop(1)

0x32d: Push("head") // @poff=170
0x32e: @ LookAsyncCamera(Stack[-1])
0x32f: Pop(1)
0x330: @ CameraWaitForPlayFinish()
0x331: Pop(0)
0x332: @ ResumeWorld()
0x333: Pop(0)
0x334: Stack[-21] = (bool) 1
0x335: Return(); Pop(18)

0x336: PushEmpty(bool, bool)
0x337: @ CameraSwitchToNormal()
0x338: Pop(0)
...
0x33e: Push("head") // @poff=170
0x33f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x340: Pop(1)
0x341: Push(Stack[-1])
0x342: IF (Stack[-1] == 0) GOTO 0x346; Pop(1)

0x343: Push("head") // @poff=170
0x344: @ UnlookAsync(Stack[-1])
0x345: Pop(1)
0x346: Return(); Pop(2)

0x347: PushEmpty(float, float, float, float)
0x348: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x349: Pop(0)
0x34a: Push((bool) 0)
0x34b: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x34c: Pop(1)
0x34d: Return(); Pop(4)

0x34e: PushEmpty(float, float, float, float)
0x34f: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x350: Pop(0)
0x351: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x352: Pop(0)
0x353: Return(); Pop(4)

0x354: PushEmpty(float, cvector, float, cvector)
0x355: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x356: Pop(0)
0x357: Stack[-1] = [0.0, 0.0, 0.0]
0x358: Push(CvectorIndex(Stack[-1], 1))
0x359: Stack[-3] = Stack[-1]
0x35a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x35b: Push("head") // @poff=170
0x35c: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x35d: Pop(1)
0x35e: Return(); Pop(4)
...
0x366: PushEmpty(float, float)
0x367: Pop(0); Push(Stack[-3] | Stack[-3]);
0x368: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x369: Push((float)9.999999974752427e-07)
0x36a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x36b: IF (Stack[-1] == 0) GOTO 0x36e; Pop(1)

0x36c: Stack[-4] = [0.0, 0.0, 0.0]
0x36d: Return(); Pop(2)

0x36e: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x36f: Return(); Pop(2)

0x370: PushEmpty(int, int)
0x371: @ GetVariable(Stack[-3], Stack[-1])
0x372: Pop(0)
0x373: Stack[-1] = Stack[-4]
0x374: Return(); Pop(2)

0x375: PushEmpty(object, object)
0x376: @ CreateIntVector(Stack[-1])
0x377: Pop(0)
0x378: @@ add(Stack[-4]); Obj=1 // @poff=206
0x379: Pop(0)
0x37a: @@ add(Stack[-3]); Obj=1 // @poff=206
0x37b: Pop(0)
0x37c: Push((int) 3)
0x37d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x37e: Pop(1)
0x37f: Return(); Pop(2)

0x380: Stack[-1] = 0
0x381: PushEmpty(int, int, bool, int, int, bool)
0x382: @@ GetItemID(Stack[-3]); Obj=8 // @poff=210
0x383: Pop(0)
0x384: Push("Category") // @poff=220
0x385: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x386: Pop(1)
0x387: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=238
0x388: Pop(0)
0x389: Pop(0); Push((bool) Stack[-1] == 0)
0x38a: IF (Stack[-1] == 0) GOTO 0x38e; Pop(1)

0x38b: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=246
0x38c: Pop(0)
0x38d: GOTO 0x393

0x38e: PushEmpty(int, int)
0x38f: Stack[-5] = Stack[-2]
0x390: Stack[-9] = Stack[-1]
0x391: Call2 0x375
...
0x395: @ CreateInvItem(Stack[-1])
0x396: Pop(0)
0x397: @@ SetItemName(Stack[-4]); Obj=1 // @poff=256
0x398: Pop(0)
0x399: PushEmpty(object, object, int)
0x39a: Stack[-8] = Stack[-3]
...
0x3c5: Stack[-1] = (int) 521048
0x3c6: Return(); Pop(0)

0x3c7: Stack[-1] = (int) 521047
0x3c8: Return(); Pop(0)

0x3c9: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=268
0x3ca: Return(); Pop(0)

0x3cb: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=308
0x3cc: Return(); Pop(0)
...
0x3cf: PushEmpty()
0x3d0: Push("oob2Gatherer1") // @poff=352
0x3d1: Push((int) 1)
...
0x3e4: Pop(0)
0x3e5: PushEmpty(bool, string, string)
0x3e6: Stack[-2] = "quest_b2_02" // @poff=392
0x3e7: Stack[-1] = "completed" // @poff=416
0x3e8: Call2 0x3a1
...
0x3eb: PushEmpty()
0x3ec: Push("oob2Gatherer2") // @poff=436
0x3ed: Push((int) 1)
...
0x3f1: PushEmpty()
0x3f2: Push("playsound") // @poff=464
0x3f3: Push("giveitem") // @poff=484
0x3f4: @ TriggerWorld(Stack[-2], Stack[-1])
0x3f5: Pop(2)
0x3f6: Return(); Pop(0)

0x3f7: PushEmpty()
0x3f8: Push("recipe9 is given") // @poff=502
0x3f9: @ Trace(Stack[-1])
0x3fa: Pop(1)
0x3fb: PushEmpty(object, string, int)
0x3fc: Stack[-5] = Stack[-3]
0x3fd: Stack[-2] = "recipe9" // @poff=536
0x3fe: Stack[-1] = (int) 1
0x3ff: Call2 0x394
...
0x404: Stack[-1] = "oob2Gatherer1" // @poff=352
0x405: Call2 0x370
...
0x434: Stack[-1] = "oob2Gatherer2" // @poff=436
0x435: Call2 0x370
...
0x466: @ GetDiaryRoot(Stack[-1])
0x467: Pop(0)
0x468: Pop(0); Push((bool) Stack[-1] == 0)
0x469: IF (Stack[-1] == 0) GOTO 0x46f; Pop(1)

0x46a: Push("Can't retrieve diary root") // @poff=552
0x46b: @ Trace(Stack[-1])
0x46c: Pop(1)
...
0x471: Stack[-1] = 0
0x472: PushEmpty(object, object, int, object, object, int)
0x473: PushEmpty(object)
0x474: Call2 0x465

0x475: Stack[-1] = Stack[-4]
0x476: Pop(1)
0x477: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=604
0x478: Pop(0)
0x479: Pop(0); Push((bool) Stack[-2] == 0)
0x47a: IF (Stack[-1] == 0) GOTO 0x481; Pop(1)

0x47b: Push("Can't find diary parent with id: ") // @poff=609
0x47c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x47d: @ Trace(Stack[-1])
0x47e: Pop(1)
0x47f: Stack[-9] = (bool) 0
0x480: Return(); Pop(6)

0x481: @@ AddChild(Stack[-8]); Obj=2 // @poff=677
0x482: Pop(0)
0x483: Push((int) 7)
0x484: @ SendWorldWndMessage(Stack[-1])
0x485: Pop(1)
0x486: @@ GetCategory(Stack[-1]); Obj=8 // @poff=686
0x487: Pop(0)
0x488: @ SetDiarySection(Stack[-1])
0x489: Pop(0)
...
0x48f: Push("branch") // @poff=698
0x490: @ GetVariable(Stack[-1], Stack[-2])
0x491: Pop(1)
0x492: Push((int) 0)
