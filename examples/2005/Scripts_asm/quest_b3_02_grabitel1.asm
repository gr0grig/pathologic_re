...
Strings:
	...
	W:grabitel_dead
// @pool_raw:
...
Events:
EVENT_22 Op = 0xb62 Vars = (object, int, float, float)
EVENT_43 Op = 0xb6a Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xb74 Vars = (object, string)
EVENT_41 Op = 0xb81 Vars = (object)
...
0x94f: Push("head") // @poff=532
0x950: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x951: Pop(1)
0x952: Push(Stack[-1])
0x953: IF (Stack[-1] == 0) GOTO 0x957; Pop(1)

0x954: Push("head") // @poff=532
0x955: @ UnlookAsync(Stack[-1])
0x956: Pop(1)
0x957: Return(); Pop(2)

0x958: PushEmpty(float, float, float, float)
0x959: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x95a: Pop(0)
0x95b: Push((bool) 0)
0x95c: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x95d: Pop(1)
0x95e: Return(); Pop(4)

0x95f: PushEmpty(float, float, float, float)
0x960: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x961: Pop(0)
0x962: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x963: Pop(0)
0x964: Return(); Pop(4)

0x965: PushEmpty(float, cvector, float, cvector)
0x966: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x967: Pop(0)
0x968: Stack[-1] = [0.0, 0.0, 0.0]
0x969: Push(CvectorIndex(Stack[-1], 1))
0x96a: Stack[-3] = Stack[-1]
0x96b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x96c: Push("head") // @poff=532
0x96d: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x96e: Pop(1)
0x96f: Return(); Pop(4)
...
0x977: PushEmpty(bool, bool)
0x978: PushEmpty(bool, int, int)
0x979: Stack[-7] = Stack[-2]
0x97a: Stack[-6] = Stack[-1]
0x97b: Call2 0x9ed
...
0x97e: Push((int) 0)
0x97f: @ AddItem(Stack[-2], Stack[-6], Stack[-1])
0x980: Pop(1)
0x981: Return(); Pop(2)

0x982: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x983: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x984: Pop(0)
0x985: Pop(0); Push((bool) Stack[-8] == 0)
0x986: IF (Stack[-1] == 0) GOTO 0x99b; Pop(1)

0x987: Stack[-7] = (int) 0
0x988: Push((int) 1)
0x989: Pop(1); Push(Stack[-8] + Stack[-1]);
0x98a: Pop(1); Push(Stack[-18] + Stack[-1]);
0x98b: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x98c: Pop(1)
0x98d: Pop(0); Push((bool) Stack[-6] == 0)
0x98e: IF (Stack[-1] == 0) GOTO 0x990; Pop(1)

0x98f: GOTO 0x993

0x990: Push((int) 1)
0x991: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x992: GOTO 0x988

0x993: Pop(0); Push((bool) Stack[-7] == 0)
0x994: IF (Stack[-1] == 0) GOTO 0x996; Pop(1)

0x995: Return(); Pop(16)

0x996: @ irand(Stack[-5], Stack[-7])
0x997: Pop(0)
0x998: Push((int) 1)
0x999: Pop(1); Push(Stack[-6] + Stack[-1]);
0x99a: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x99b: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x99c: Pop(0)
0x99d: Push(Stack[-4])
0x99e: IF (Stack[-1] == 0) GOTO 0x9aa; Pop(1)

0x99f: @ GetEyesHeight(Stack[-3])
0x9a0: Pop(0)
0x9a1: @ GetDirection(Stack[-2])
0x9a2: Pop(0)
0x9a3: Push((int) 50)
0x9a4: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x9a5: Push(CvectorIndex(Stack[-1], 1))
0x9a6: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x9a7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x9a8: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x9a9: Pop(0)
0x9aa: Return(); Pop(16)

0x9ab: PushEmpty(object, object)
0x9ac: @ self(Stack[-1])
0x9ad: Pop(0)
...
0x9b0: Stack[-1] = 0
0x9b1: PushEmpty(float, float)
0x9b2: Pop(0); Push(Stack[-3] | Stack[-3]);
0x9b3: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x9b4: Push((float)9.999999974752427e-07)
0x9b5: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x9b6: IF (Stack[-1] == 0) GOTO 0x9b9; Pop(1)

0x9b7: Stack[-4] = [0.0, 0.0, 0.0]
0x9b8: Return(); Pop(2)

0x9b9: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x9ba: Return(); Pop(2)

0x9bb: PushEmpty()
0x9bc: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x9bd: IF (Stack[-1] == 0) GOTO 0x9c0; Pop(1)

0x9be: Stack[-2] = Stack[-3]
0x9bf: GOTO 0x9c1

0x9c0: Stack[-1] = Stack[-3]
0x9c1: Return(); Pop(0)

0x9c2: PushEmpty()
0x9c3: Pop(0); Push(Stack[-2] * Stack[-2]);
0x9c4: Push((int) 4)
0x9c5: Pop(1); Push(Stack[-1] * Stack[-5]);
0x9c6: Pop(1); Push(Stack[-1] * Stack[-3]);
0x9c7: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x9c8: Return(); Pop(0)

0x9c9: PushEmpty(float, float)
0x9ca: Pop(0); Push(( -Stack[-5])
0x9cb: Pop(1); Push(Stack[-1] - Stack[-4]);
0x9cc: Push((int) 2)
0x9cd: Pop(1); Push(Stack[-1] * Stack[-8]);
0x9ce: Stack[-3] = Stack[-2] / Stack[-1]; Pop(2);
0x9cf: Push((int) 0)
...
0x9d4: Pop(0); Push(( -Stack[-5])
0x9d5: Pop(1); Push(Stack[-1] + Stack[-4]);
0x9d6: Push((int) 2)
0x9d7: Pop(1); Push(Stack[-1] * Stack[-8]);
0x9d8: Stack[-9] = Stack[-2] / Stack[-1]; Pop(2);
0x9d9: Return(); Pop(2)

0x9da: PushEmpty()
0x9db: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x9dc: IF (Stack[-1] == 0) GOTO 0x9df; Pop(1)

0x9dd: Stack[-2] = Stack[-4]
0x9de: Return(); Pop(0)

0x9df: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x9e0: IF (Stack[-1] == 0) GOTO 0x9e3; Pop(1)

0x9e1: Stack[-1] = Stack[-4]
0x9e2: Return(); Pop(0)

0x9e3: Stack[-3] = Stack[-4]
0x9e4: Return(); Pop(0)

0x9e5: PushEmpty()
0x9e6: Stack[-4] = (bool) 0
0x9e7: Pop(0); Push((bool) Stack[-3] >= Stack[-2])
0x9e8: IF (Stack[-1] == 0) GOTO 0x9ec; Pop(1)

0x9e9: Pop(0); Push((bool) Stack[-3] <= Stack[-1])
0x9ea: IF (Stack[-1] == 0) GOTO 0x9ec; Pop(1)

0x9eb: Stack[-4] = (bool) 1
0x9ec: Return(); Pop(0)

0x9ed: PushEmpty(int, int)
0x9ee: @ irand(Stack[-1], Stack[-3])
0x9ef: Pop(0)
0x9f0: Stack[-5] = Stack[-1] < Stack[-4]; Pop(0);
0x9f1: Return(); Pop(2)

0x9f2: PushEmpty(int, int)
0x9f3: @ GetVariable(Stack[-3], Stack[-1])
0x9f4: Pop(0)
0x9f5: Stack[-1] = Stack[-4]
0x9f6: Return(); Pop(2)

0x9f7: PushEmpty()
0x9f8: Pop(0); Push((bool) Stack[-2] == 0)
0x9f9: IF (Stack[-1] == 0) GOTO 0x9fc; Pop(1)

0x9fa: Stack[-3] = (bool) 0
0x9fb: Return(); Pop(0)
...
0x9ff: Push((int) 8)
0xa00: @ SendWorldWndMessage(Stack[-1])
0xa01: Pop(1)
0xa02: GOTO 0xa0c
...
0xa06: Push((int) 9)
0xa07: @ SendWorldWndMessage(Stack[-1])
0xa08: Pop(1)
0xa09: GOTO 0xa0c

0xa0a: Stack[-3] = (bool) 0
0xa0b: Return(); Pop(0)

0xa0c: PushEmpty(float)
0xa0d: Stack[-2] = Stack[-1]
0xa0e: Call2 0xa24

0xa0f: Pop(1)
0xa10: PushEmpty(bool, object, string, float, float, float)
0xa11: Stack[-8] = Stack[-5]
0xa12: Stack[-4] = "reputation" // @poff=1163
0xa13: Stack[-7] = Stack[-3]
0xa14: Stack[-2] = (int) 0
0xa15: Stack[-1] = (int) 1
0xa16: Call2 0x7a3

0xa17: Pop(6)
0xa18: Stack[-3] = (bool) 1
0xa19: Return(); Pop(0)

0xa1a: PushEmpty(object, object)
0xa1b: @ CreateFloatVector(Stack[-1])
0xa1c: Pop(0)
0xa1d: @@ add(Stack[-3]); Obj=1 // @poff=1122
0xa1e: Pop(0)
0xa1f: Push((int) 15)
0xa20: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa21: Pop(1)
0xa22: Return(); Pop(2)

0xa23: Stack[-1] = 0
0xa24: PushEmpty(object, object)
0xa25: @ CreateFloatVector(Stack[-1])
0xa26: Pop(0)
0xa27: @@ add(Stack[-3]); Obj=1 // @poff=1122
0xa28: Pop(0)
0xa29: Push((int) 16)
0xa2a: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa2b: Pop(1)
0xa2c: Return(); Pop(2)

0xa2d: Stack[-1] = 0
0xa2e: PushEmpty(object, object)
0xa2f: @ FindActor(Stack[-1], Stack[-4])
0xa30: Pop(0)
0xa31: Pop(0); PushNull((bool) Stack[-1] == 0)
0xa32: IF (Stack[-1] == 0) GOTO 0xa35; Pop(1)

0xa33: Stack[-5] = (bool) 0
0xa34: Return(); Pop(2)

0xa35: @ Trigger(Stack[-1], Stack[-3])
0xa36: Pop(0)
0xa37: Stack[-5] = (bool) 1
0xa38: Return(); Pop(2)

0xa39: Stack[-1] = 0
0xa3a: PushEmpty(bool, bool)
0xa3b: @ IsPlayerActor(Stack[-3], Stack[-1])
0xa3c: Pop(0)
0xa3d: Push(Stack[-1])
0xa3e: IF (Stack[-1] == 0) GOTO 0xa42; Pop(1)

0xa3f: Push("attack") // @poff=320
0xa40: @ PlayGlobalMusic(Stack[-1])
0xa41: Pop(1)
0xa42: Return(); Pop(2)

0xa43: PushEmpty(object, object)
0xa44: @ GetScene(Stack[-1])
0xa45: Pop(0)
0xa46: Push("battle") // @poff=1185
0xa47: PushEmpty(object)
0xa48: Call2 0x9ab

0xa49: Pop(0)
0xa4a: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xa4b: Pop(2)
0xa4c: Return(); Pop(2)

0xa4d: Stack[-1] = 0
0xa4e: PushEmpty(bool, bool)
0xa4f: Push("god_mode") // @poff=1199
0xa50: @ GetVariable(Stack[-1], Stack[-2])
0xa51: Pop(1)
0xa52: Stack[-1] = Stack[-3]
0xa53: Return(); Pop(2)

0xa54: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0xa55: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0xa56: Stack[-5] = (int) 250000
0xa57: Push(CvectorIndex(Stack[-6], 1))
0xa58: Push((int) 1000)
0xa59: Pop(2); Push(Stack[-2] * Stack[-1]);
0xa5a: Pop(0); Push(Stack[-14] * Stack[-14]);
0xa5b: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0xa5c: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0xa5d: PushEmpty(float, float, float, float)
0xa5e: Stack[-9] = Stack[-3]
0xa5f: Stack[-8] = Stack[-2]
0xa60: Stack[-7] = Stack[-1]
0xa61: Call2 0x9c2

0xa62: Stack[-4] = Stack[-6]
0xa63: Pop(4)
0xa64: Push((int) 0)
...
0xa69: PushEmpty(float, float, float, float, float)
0xa6a: Stack[-10] = Stack[-4]
0xa6b: Stack[-9] = Stack[-3]
0xa6c: Stack[-8] = Stack[-2]
0xa6d: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0xa6e: Call2 0x9c9

0xa6f: Pop(4)
0xa70: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xa71: Push([0.0, 500.0, 0.0])
0xa72: Pop(1); Push(Stack[-1] * Stack[-2]);
0xa73: Pop(1); Push(Stack[-1] * Stack[-2]);
0xa74: Pop(1); Push(Stack[-7] + Stack[-1]);
0xa75: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0xa76: Return(); Pop(12)

0xa77: Stack[-1] = (int) 518411
0xa78: Return(); Pop(0)

0xa79: Stack[-1] = (int) 518410
0xa7a: Return(); Pop(0)

0xa7b: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1217
0xa7c: Return(); Pop(0)

0xa7d: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1257
0xa7e: Return(); Pop(0)

0xa7f: Stack[-1] = (bool) 0
0xa80: Return(); Pop(0)

0xa81: PushEmpty(string, string)
0xa82: Stack[-1] = "idle" // @poff=698
0xa83: Push(Stack[-3])
0xa84: IF (Stack[-1] == 0) GOTO 0xa86; Pop(1)

0xa85: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xa86: Stack[-1] = Stack[-4]
0xa87: Return(); Pop(2)

0xa88: PushEmpty(int, bool, int, bool)
0xa89: Stack[-2] = (int) 0
0xa8a: Push("all") // @poff=0
0xa8b: PushEmpty(string, int)
0xa8c: Stack[-5] = Stack[-1]
0xa8d: Call2 0xa81

0xa8e: Pop(1)
0xa8f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xa90: Pop(2)
0xa91: Pop(0); Push((bool) Stack[-1] == 0)
0xa92: IF (Stack[-1] == 0) GOTO 0xa94; Pop(1)

0xa93: GOTO 0xa97

0xa94: Push((int) 1)
0xa95: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xa96: GOTO 0xa8a

0xa97: Stack[-2] = Stack[-5]
0xa98: Return(); Pop(4)

0xa99: PushEmpty()
0xa9a: Push("b3q02GrabitelTalk") // @poff=1301
0xa9b: Push((int) 1)
0xa9c: @ SetVariable(Stack[-2], Stack[-1])
0xa9d: Pop(2)
0xa9e: Return(); Pop(0)

0xa9f: PushEmpty()
0xaa0: PushEmpty(bool, string, string)
0xaa1: Stack[-2] = "quest_b3_02" // @poff=708
0xaa2: Stack[-1] = "grabitel_attack" // @poff=732
0xaa3: Call2 0xa2e
...
0xaa8: Stack[-1] = "b3q02" // @poff=1337
0xaa9: Call2 0x9f2

0xaaa: Pop(1)
0xaab: Push((int) 3)
0xaac: Pop(2); Push((bool) Stack[-2] > Stack[-1])
0xaad: IF (Stack[-1] == 0) GOTO 0xab0; Pop(1)

0xaae: Stack[-2] = (bool) 1
0xaaf: Return(); Pop(0)

0xab0: Stack[-2] = (bool) 0
0xab1: Return(); Pop(0)

0xab2: PushEmpty(int, int)
0xab3: Push("branch") // @poff=1349
0xab4: @ GetVariable(Stack[-1], Stack[-2])
0xab5: Pop(1)
0xab6: Push((int) 0)
0xab7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xab8: IF (Stack[-1] == 0) GOTO 0xabc; Pop(1)
...
0xac3: PushEmpty(int, int)
0xac4: Push("branch") // @poff=1349
0xac5: @ GetVariable(Stack[-1], Stack[-2])
0xac6: Pop(1)
...
0xacc: Pop(0)
0xacd: Push((int) 1)
0xace: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xacf: IF (Stack[-1] == 0) GOTO 0xad3; Pop(1)

0xad0: @ WorkWithCorpse(Stack[-1])
0xad1: Pop(0)
0xad2: GOTO 0xad5

0xad3: @ Barter(Stack[-1])
0xad4: Pop(0)
0xad5: Return(); Pop(0)

0xad6: PushEmpty(int, bool, int, bool)
0xad7: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0xad8: IF (Stack[-1] == 0) GOTO 0xadd; Pop(1)

0xad9: Push("GenerateMoney: iMin > iMax") // @poff=1363
0xada: @ Trace(Stack[-1])
0xadb: Pop(1)
0xadc: Return(); Pop(4)

0xadd: Stack[-2] = (int) 0
0xade: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0xadf: IF (Stack[-1] == 0) GOTO 0xae4; Pop(1)

0xae0: Pop(0); Push(Stack[-5] - Stack[-6]);
0xae1: @ irand(Stack[-3], Stack[-1])
0xae2: Pop(1)
0xae3: GOTO 0xae8

0xae4: Push((int) 0)
0xae5: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xae6: IF (Stack[-1] == 0) GOTO 0xae8; Pop(1)

0xae7: Return(); Pop(4)

0xae8: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0xae9: Push((int) 0)
...
0xaed: PushEmpty(int, string)
0xaee: Stack[-1] = "Money" // @poff=1417
0xaef: Call2 0xb3c

0xaf0: Pop(1)
0xaf1: Push((int) 0)
0xaf2: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xaf3: Pop(2)
0xaf4: Return(); Pop(4)

0xaf5: PushEmpty(object, int, bool, object, int, bool)
0xaf6: @ CreateInvItem(Stack[-3])
0xaf7: Pop(0)
0xaf8: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1429
0xaf9: Pop(0)
0xafa: Push("Organ") // @poff=1441
0xafb: Push((int) 1)
0xafc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=982
0xafd: Pop(2)
0xafe: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1453
0xaff: Pop(0)
0xb00: Push((int) 0)
0xb01: Push((int) 1)
0xb02: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xb03: Pop(2)
0xb04: Return(); Pop(6)
...
0xb0e: Stack[-1] = "liver" // @poff=1463
0xb0f: Call2 0xaf5

0xb10: Pop(1)
0xb11: PushEmpty(string)
0xb12: Stack[-1] = "kidney" // @poff=1475
0xb13: Call2 0xaf5

0xb14: Pop(1)
0xb15: PushEmpty(string)
0xb16: Stack[-1] = "heart" // @poff=1489
0xb17: Call2 0xaf5

0xb18: Pop(1)
0xb19: PushEmpty(string)
0xb1a: Stack[-1] = "blood" // @poff=1501
0xb1b: Call2 0xaf5

0xb1c: Pop(1)
0xb1d: Return(); Pop(0)

0xb1e: PushEmpty(int, bool, int, bool)
0xb1f: Push((int) 0)
0xb20: @ ClearSubContainer(Stack[-1])
0xb21: Pop(1)
0xb22: PushEmpty(int, int)
0xb23: Stack[-2] = (int) 300
0xb24: Stack[-1] = (int) 750
0xb25: Call2 0xad6

0xb26: Pop(2)
0xb27: PushEmpty(string, int, int)
0xb28: Stack[-3] = "Knife" // @poff=1513
0xb29: Stack[-2] = (int) 1
0xb2a: Stack[-1] = (int) 8
0xb2b: Call2 0x977

0xb2c: Pop(3)
0xb2d: PushEmpty(string, int, int)
0xb2e: Stack[-3] = "lockpick" // @poff=1525
0xb2f: Stack[-2] = (int) 1
0xb30: Stack[-1] = (int) 6
0xb31: Call2 0x977

0xb32: Pop(3)
0xb33: PushEmpty(int, string)
0xb34: Stack[-1] = "grabitel_mark" // @poff=1543
0xb35: Call2 0xb3c

0xb36: Pop(1)
0xb37: Push((int) 0)
0xb38: Push((int) 1)
0xb39: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb3a: Pop(3)
0xb3b: Return(); Pop(4)

0xb3c: PushEmpty(int, int)
0xb3d: @ GetInvItemByName(Stack[-1], Stack[-3])
0xb3e: Pop(0)
0xb3f: Stack[-1] = Stack[-4]
0xb40: Return(); Pop(2)

0xb41: PushEmpty(object, object)
0xb42: @ GetScene(Stack[-1])
0xb43: Pop(0)
0xb44: PushEmpty(object)
0xb45: Call2 0x9ab

0xb46: Pop(0)
0xb47: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1571
0xb48: Pop(1)
0xb49: Push(GlobalVars[2])
0xb4a: IF (Stack[-1] == 0) GOTO 0xb50; Pop(1)

0xb4b: PushEmpty(bool, string, string)
0xb4c: Stack[-2] = "quest_b3_02" // @poff=708
0xb4d: Stack[-1] = "grabitel_dead" // @poff=1593
0xb4e: Call2 0xa2e

0xb4f: Pop(3)
0xb50: PushEmpty(bool, object)
0xb51: Stack[-5] = Stack[-1]
0xb52: Call2 0x792
...
0xb56: Stack[-6] = Stack[-2]
0xb57: Stack[-1] = (float) 0.029999999329447746
0xb58: Call2 0x9f7

0xb59: Pop(3)
0xb5a: PushEmpty(object)
0xb5b: Stack[-4] = Stack[-1]
0xb5c: Push(-1, 0); TaskCall(7)
0xb5d: Call2 0x6ce

0xb5e: Pop(-1, 0); TaskReturn
0xb5f: Pop(1)
0xb60: Return(); Pop(2)

0xb61: Stack[-1] = 0
0xb62: PushEmpty()
0xb63: PushEmpty(object, int, float)
0xb64: Stack[-7] = Stack[-3]
0xb65: Stack[-6] = Stack[-2]
...
0xb6a: PushEmpty()
0xb6b: PushEmpty(object, int, float, cvector, cvector)
0xb6c: Stack[-11] = Stack[-5]
0xb6d: Stack[-10] = Stack[-4]
0xb6e: Stack[-9] = Stack[-3]
0xb6f: Stack[-7] = Stack[-2]
...
0xb74: PushEmpty(float, float)
0xb75: Push("health") // @poff=994
0xb76: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb77: IF (Stack[-1] == 0) GOTO 0xb80; Pop(1)

0xb78: Push("health") // @poff=994
0xb79: @ GetProperty(Stack[-1], Stack[-2])
0xb7a: Pop(1)
0xb7b: Push((int) 0)
0xb7c: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xb7d: IF (Stack[-1] == 0) GOTO 0xb80; Pop(1)

0xb7e: @ SignalDeath(Stack[-4])
0xb7f: Pop(0)
0xb80: Return(); Pop(2)

0xb81: PushEmpty()
0xb82: PushEmpty(object)
0xb83: Stack[-2] = Stack[-1]
0xb84: Call2 0xb41
...
0xb88: Push(GlobalVars[2])
0xb89: IF (Stack[-1] == 0) GOTO 0xb97; Pop(1)

0xb8a: @ GetScene(Stack[-1])
0xb8b: Pop(0)
0xb8c: PushEmpty(object)
0xb8d: Call2 0x9ab

0xb8e: Pop(0)
0xb8f: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1571
0xb90: Pop(1)
0xb91: PushEmpty(bool, string, string)
0xb92: Stack[-2] = "quest_b3_02" // @poff=708
0xb93: Stack[-1] = "grabitel_dead" // @poff=1593
0xb94: Call2 0xa2e
