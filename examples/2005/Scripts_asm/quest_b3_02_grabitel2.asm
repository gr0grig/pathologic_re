...
0x843: Stack[-9] = Stack[-3]
0x844: Stack[-8] = Stack[-2]
0x845: Stack[-7] = Stack[-1]
0x846: Call2 0x7a0

0x847: Stack[-4] = Stack[-6]
0x848: Pop(4)
0x849: Push((int) 0)
...
0x84f: Stack[-10] = Stack[-4]
0x850: Stack[-9] = Stack[-3]
0x851: Stack[-8] = Stack[-2]
0x852: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x853: Call2 0x7a7

0x854: Pop(4)
0x855: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x856: Push([0.0, 500.0, 0.0])
...
0x85d: Push("branch") // @poff=1013
0x85e: @ GetVariable(Stack[-1], Stack[-2])
0x85f: Pop(1)
0x860: Stack[-1] = Stack[-3]
0x861: Return(); Pop(2)
...
0x872: Push("GenerateMoney: iMin > iMax") // @poff=1027
0x873: @ Trace(Stack[-1])
0x874: Pop(1)
0x875: Return(); Pop(4)
...
0x890: Pop(0)
0x891: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1093
0x892: Pop(0)
0x893: Push("Organ") // @poff=1105
0x894: Push((int) 1)
0x895: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=764
0x896: Pop(2)
0x897: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1117
0x898: Pop(0)
0x899: Push((int) 0)
0x89a: Push((int) 1)
...
0x8a7: Stack[-1] = "liver" // @poff=1127
0x8a8: Call2 0x88e

0x8a9: Pop(1)
0x8aa: PushEmpty(string)
0x8ab: Stack[-1] = "kidney" // @poff=1139
0x8ac: Call2 0x88e

0x8ad: Pop(1)
0x8ae: PushEmpty(string)
0x8af: Stack[-1] = "heart" // @poff=1153
0x8b0: Call2 0x88e

0x8b1: Pop(1)
0x8b2: PushEmpty(string)
0x8b3: Stack[-1] = "blood" // @poff=1165
0x8b4: Call2 0x88e
...
0x8c7: Stack[-3] = "lockpick" // @poff=1189
0x8c8: Stack[-2] = (int) 1
0x8c9: Stack[-1] = (int) 6
0x8ca: Call2 0x755
...
0x8cd: Stack[-1] = "grabitel_mark" // @poff=1207
0x8ce: Call2 0x8d5
...
0x8df: Pop(0)
0x8e0: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x8e1: Pop(1)
0x8e2: PushEmpty(bool, object)
0x8e3: Stack[-5] = Stack[-1]
0x8e4: Call2 0x5d9
...
0x8e8: Stack[-6] = Stack[-2]
0x8e9: Stack[-1] = (float) 0.019999999552965164
0x8ea: Call2 0x7d0

0x8eb: Pop(3)
0x8ec: PushEmpty(object)
0x8ed: Stack[-4] = Stack[-1]
...
0x8f6: Stack[-7] = Stack[-3]
0x8f7: Stack[-6] = Stack[-2]
0x8f8: Stack[-5] = Stack[-1]
0x8f9: Call2 0x6e8
...
0x8fe: Stack[-11] = Stack[-5]
0x8ff: Stack[-10] = Stack[-4]
0x900: Stack[-9] = Stack[-3]
0x901: Stack[-7] = Stack[-2]
0x902: Stack[-6] = Stack[-1]
0x903: Call2 0x72c
...
0x930: Pop(0)
0x931: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x932: Pop(1)
0x933: PushEmpty(bool, object)
0x934: Stack[-5] = Stack[-1]
