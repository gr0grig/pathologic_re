...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
...
Events:
EVENT_22 Op = 0x6c4 Vars = (object, int, float, float)
EVENT_43 Op = 0x6cc Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x6d6 Vars = (object, string)
EVENT_41 Op = 0x6e3 Vars = (object)
...
0x2c: @ GetPFPosition(Stack[-1]T)
0x2d: Pop(0)
0x2e: @ GetDirection(Stack[-0]T)
0x2f: Pop(0)
0x30: PushEmpty()
0x31: Call2 0x84
...
0x4d: @ FindPathTo(Stack[-1], Stack[-1]T)
0x4e: Pop(0)
...
0x5c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x5d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x6f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x70: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x93: Stack[-1] = 0
0x94: PushEmpty()
0x95: Stack[-3] = (float) 0.15000000596046448
0x96: Return(); Pop(0)
...
0xaf: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xb0: Pop(0)
0xb1: Push(Stack[-8])
0xb2: IF (Stack[-1] == 0) GOTO 0xbb; Pop(1)

0xb3: Push("attack") // @poff=70
...
0xcf: Pop(0)
0xd0: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0xd1: Pop(0)
...
0xeb: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=84
0xec: Pop(0)
...
0x105: Pop(1)
0x106: Push("all") // @poff=98
0x107: Push("attack_on") // @poff=106
...
0x11f: IF (Stack[-1] == 1) GOTO 0x125; Pop(1)

0x120: PushEmpty(bool)
0x121: Call2 0x2f1

0x122: Pop(0)
0x123: IF (Stack[-1] == 1) GOTO 0x125; Pop(1)

0x124: Stack[-1] = (bool) 0
0x125: IF (Stack[-1] == 0) GOTO 0x136; Pop(1)

0x126: @ Face(Stack[-0]T)
0x127: Pop(0)
0x128: PushEmpty()
0x129: Call2 0x323

0x12a: Pop(0)
0x12b: Push("all") // @poff=98
0x12c: Push("attack_stay") // @poff=126
0x12d: @ PlayAnimation(Stack[-2], Stack[-1])
0x12e: Pop(2)
0x12f: PushEmpty(bool, float)
0x130: Stack[-25] = Stack[-1]
0x131: Call2 0x26d
...
0x136: @ Face(Stack[-0]T)
0x137: Pop(0)
0x138: Push("all") // @poff=98
0x139: Push("fjump") // @poff=150
...
0x154: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0x155: Pop(0)
...
0x173: Push("all") // @poff=98
0x174: Push("attack_off") // @poff=162
...
0x181: Push("all") // @poff=98
0x182: Push("attack_begin") // @poff=184
0x183: Push((int) 1)
0x184: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x18f: Push("attack") // @poff=70
0x190: Push((int) 1)
0x191: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x19b: Push("all") // @poff=98
0x19c: Push("bjump") // @poff=210
...
0x1a3: Push((float)0.8999999761581421)
0x1a4: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1a5: @ GetVictim(Stack[-1], Stack[-4])
0x1a6: Pop(1)
0x1a7: @ ReportAttack(Stack[-0]T)
0x1a8: Pop(0)
...
0x1ad: Stack[-10] = Stack[-1]
0x1ae: Call2 0x94

0x1af: Stack[-3] = Stack[-5]
0x1b0: Pop(3)
0x1b1: PushEmpty(float, object, float, int)
0x1b2: Stack[-7] = Stack[-3]
0x1b3: Stack[-6] = Stack[-2]
0x1b4: PushEmpty(int, object, int)
0x1b5: Stack[-10] = Stack[-2]
0x1b6: Stack[-14] = Stack[-1]
0x1b7: Call2 0x97

0x1b8: Stack[-3] = Stack[-4]
0x1b9: Pop(3)
0x1ba: Call2 0x4e8

0x1bb: Stack[-4] = Stack[-5]
0x1bc: Pop(4)
0x1bd: PushEmpty(int)
0x1be: Call2 0x321

0x1bf: Pop(0)
0x1c0: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1c1: Pop(1)
0x1c2: PushEmpty(object, float)
0x1c3: Stack[-5] = Stack[-2]
...
0x1cc: Pop(0)
0x1cd: @ irand(Stack[-4], Stack[-1]T)
0x1ce: Pop(0)
0x1cf: Push((int) 1)
0x1d0: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x1d1: @ Face(Stack[-0]T)
0x1d2: Pop(0)
0x1d3: Push((bool) 1)
...
0x1d8: Pop(0)
0x1d9: Push("all") // @poff=98
0x1da: Push("attack_begin") // @poff=184
...
0x1ee: Stack[-11] = Stack[-2]
0x1ef: Stack[-6] = Stack[-1]
0x1f0: Call2 0x1a2

0x1f1: Pop(2)
0x1f2: Push("all") // @poff=98
0x1f3: Push("attack_middle") // @poff=222
...
0x1fb: Pop(0)
0x1fc: Push("all") // @poff=98
0x1fd: Push("attack_middle") // @poff=222
...
0x211: Stack[-11] = Stack[-2]
0x212: Stack[-6] = Stack[-1]
0x213: Call2 0x1a2

0x214: Pop(2)
0x215: Stack[-2] = (int) 1
0x216: Push("attack_middle") // @poff=222
0x217: Pop(1); Push(Stack[-1] + Stack[-5]);
0x218: Push("_") // @poff=250
0x219: Pop(2); Push(Stack[-2] + Stack[-1]);
0x21a: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x21b: Push("all") // @poff=98
...
0x240: Pop(1)
0x241: Push("all") // @poff=98
0x242: Push("attack_end") // @poff=254
...
0x281: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=84
0x282: Pop(0)
...
0x2cd: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2ce: Pop(1)
...
0x2d2: @ Face(Stack[-0]T)
0x2d3: Pop(0)
0x2d4: Push("all") // @poff=98
0x2d5: Push("bjump") // @poff=210
0x2d6: @ PlayAnimation(Stack[-2], Stack[-1])
0x2d7: Pop(2)
0x2d8: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=84
0x2d9: Pop(0)
...
0x30f: @ irand(Stack[-1], Stack[-2]T)
0x310: Pop(0)
0x311: Push((int) 1)
0x312: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x313: Push("attack") // @poff=70
...
0x324: Stack[-1] = "attack_stay" // @poff=126
0x325: Call2 0x606
...
0x34f: Stack[-15] = Stack[-5]
0x350: Stack[-14] = Stack[-4]
0x351: Stack[-13] = Stack[-3]
0x352: Stack[-12] = Stack[-2]
0x353: Stack[-11] = Stack[-1]
0x354: Call2 0x399

0x355: Stack[-6] = Stack[-7]
0x356: Pop(6)
0x357: Push( Stack[2 + Tasks[-1].StackPointer] )
0x358: IF (Stack[-1] == 0) GOTO 0x35c; Pop(1)

0x359: Push("head") // @poff=312
...
0x3a5: @@ GetPosition(Stack[-5]); Obj=21 // @poff=322
0x3a6: Pop(0)
...
0x3bc: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=84
0x3bd: Pop(0)
...
0x3ce: Push((int) 0)
0x3cf: Push((float)0.30000001192092896)
...
0x3f1: Push((int) 0)
0x3f2: Push((float)0.30000001192092896)
...
0x42c: Stack[-1] = "walk" // @poff=334
0x42d: Return(); Pop(0)

0x42e: Stack[-1] = "run" // @poff=344
0x42f: Return(); Pop(0)
...
0x448: Pop(0); PushNull((bool) Stack[-21] == 0)
0x449: IF (Stack[-1] == 0) GOTO 0x44f; Pop(1)

0x44a: PushEmpty(string)
0x44b: Stack[-1] = "fdie" // @poff=352
0x44c: Call2 0x4a2

0x44d: Pop(1)
0x44e: GOTO 0x4a1

0x44f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=322
0x450: Pop(0)
...
0x460: Stack[-6] = "fdie" // @poff=352
0x461: GOTO 0x463

0x462: Stack[-6] = "bdie" // @poff=362
...
0x469: @ StopAsync()
0x46a: Pop(0)
0x46b: Stack[-21] = Stack[-5]
0x46c: Push("GetScriptProperty") // @poff=372
0x46d: Push((int) 2)
0x46e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x46f: IF (Stack[-1] == 0) GOTO 0x47b; Pop(1)

0x470: Push("Owner") // @poff=408
0x471: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=420
0x472: Pop(1)
0x473: Push(Stack[-4])
0x474: IF (Stack[-1] == 0) GOTO 0x47b; Pop(1)

0x475: Push("Owner") // @poff=408
0x476: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=438
0x477: Pop(1)
0x478: Pop(0); PushNull((bool) Stack[-5] == 0)
0x479: IF (Stack[-1] == 0) GOTO 0x47b; Pop(1)

0x47a: Stack[-21] = Stack[-5]
0x47b: Push("@GetEyesHeight") // @poff=456
0x47c: Push((int) 1)
0x47d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x47e: IF (Stack[-1] == 0) GOTO 0x48a; Pop(1)

0x47f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x480: Pop(0)
0x481: Stack[-1] = [0.0, 0.0, 0.0]
0x482: Push(CvectorIndex(Stack[-1], 1))
0x483: Stack[-3] = Stack[-1]
0x484: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x485: Push("head") // @poff=312
...
0x48c: Stack[-7] = Stack[-1]
0x48d: Call2 0x606

0x48e: Pop(1)
0x48f: Push("all") // @poff=98
...
0x496: @ StopAsync()
0x497: Pop(0)
0x498: Push("head") // @poff=312
0x499: @ UnlookAsync(Stack[-1])
0x49a: Pop(1)
0x49b: Push("all") // @poff=98
...
0x4cc: Stack[-2] = "bullet" // @poff=510
0x4cd: Return(); Pop(0)

0x4ce: Stack[-2] = "phys" // @poff=524
0x4cf: Return(); Pop(0)

0x4d0: PushEmpty(cvector, cvector, cvector, cvector)
0x4d1: @ GetPosition(Stack[-2])
0x4d2: Pop(0)
0x4d3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=322
0x4d4: Pop(0)
...
0x4dd: Push("HasProperty") // @poff=534
0x4de: Push((int) 2)
...
0x4e4: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=558
0x4e5: Pop(0)
...
0x4ea: Stack[-18] = Stack[-2]
0x4eb: Stack[-1] = "health" // @poff=570
0x4ec: Call2 0x4dc
...
0x4f3: Stack[-18] = Stack[-2]
0x4f4: Stack[-1] = "armor" // @poff=584
0x4f5: Call2 0x4dc
...
0x4fb: Push("armor") // @poff=584
0x4fc: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=596
0x4fd: Pop(1)
0x4fe: Push("armor_") // @poff=608
0x4ff: PushEmpty(string, int)
0x500: Stack[-16] = Stack[-1]
0x501: Call2 0x4c2
...
0x50d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=596
0x50e: Pop(0)
...
0x515: Stack[-3] = Stack[-6]
0x516: Pop(3)
0x517: Push("health") // @poff=570
0x518: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=596
0x519: Pop(1)
0x51a: Push((int) 1)
0x51b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x51c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x51d: Push("health") // @poff=570
...
0x523: Pop(3)
0x524: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=622
0x525: Pop(2)
0x526: PushEmpty(bool, object)
0x527: Stack[-17] = Stack[-1]
0x528: Call2 0x4d7
...
0x52e: Pop(1)
0x52f: Stack[-1] = Stack[-16]
0x530: Return(); Pop(12)

0x531: PushEmpty(bool, bool)
0x532: @@ IsDead(Stack[-1]); Obj=3 // @poff=634
0x533: Pop(0)
0x534: Stack[-1] = Stack[-4]
0x535: Return(); Pop(2)

0x536: PushEmpty(object, object, object, object)
0x537: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x54b: Pop(0)
0x54c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x54d: IF (Stack[-1] == 0) GOTO 0x550; Pop(1)

0x54e: Stack[-6] = (bool) 0
0x54f: Return(); Pop(4)

0x550: @@ GetScene(Stack[-1]); Obj=5 // @poff=655
0x551: Pop(0)
...
0x564: Stack[-6] = Stack[-2]
0x565: Stack[-1] = "noaccess" // @poff=664
0x566: Call2 0x4dc
...
0x56c: Push("noaccess") // @poff=664
0x56d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=596
0x56e: Pop(1)
0x56f: Push((int) 0)
...
0x573: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x581: @@ GetPosition(Stack[-5]); Obj=15 // @poff=322
0x582: Pop(0)
...
0x592: Stack[-1] = "fhit" // @poff=682
0x593: GOTO 0x595

0x594: Stack[-1] = "bhit" // @poff=692
0x595: Push("hit_react") // @poff=702
0x596: Push("1") // @poff=722
0x597: Pop(1); Push(Stack[-3] + Stack[-1]);
0x598: Push("2") // @poff=726
...
0x5b1: Stack[-25] = Stack[-1]
0x5b2: Call2 0x4d0

0x5b3: Stack[-2] = Stack[-3]
0x5b4: Pop(2)
0x5b5: Call2 0x635

0x5b6: Stack[-2] = Stack[-11]
0x5b7: Pop(2)
0x5b8: @ CreateVectorVector(Stack[-8])
0x5b9: Pop(0)
0x5ba: Stack[-7] = (int) 1
0x5bb: Push("hit") // @poff=684
...
0x5d0: Pop(0)
0x5d1: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=739
0x5d2: Pop(0)
0x5d3: PushEmpty(object, int, float, cvector, cvector)
0x5d4: Stack[-26] = Stack[-5]
0x5d5: Stack[-25] = Stack[-4]
0x5d6: Stack[-24] = Stack[-3]
0x5d7: Stack[-6] = Stack[-2]
...
0x5f1: @@ GetPosition(Stack[-3]); Obj=7 // @poff=322
0x5f2: Pop(0)
...
0x5fc: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x5fd: Pop(0)
0x5fe: Stack[-1] = [0.0, 0.0, 0.0]
0x5ff: Push(CvectorIndex(Stack[-1], 1))
0x600: Stack[-3] = Stack[-1]
0x601: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x602: Push("head") // @poff=312
...
0x653: Stack[-3] = Stack[-4]
0x654: Return(); Pop(0)

0x655: PushEmpty(object, object)
0x656: @ CreateFloatVector(Stack[-1])
0x657: Pop(0)
0x658: @@ add(Stack[-3]); Obj=1 // @poff=730
0x659: Pop(0)
0x65a: Push((int) 15)
0x65b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x65c: Pop(1)
0x65d: Return(); Pop(2)

0x65e: Stack[-1] = 0
0x65f: PushEmpty(bool, bool)
0x660: @ IsPlayerActor(Stack[-3], Stack[-1])
0x661: Pop(0)
0x662: Push(Stack[-1])
0x663: IF (Stack[-1] == 0) GOTO 0x667; Pop(1)

0x664: Push("attack") // @poff=70
0x665: @ PlayGlobalMusic(Stack[-1])
0x666: Pop(1)
0x667: Return(); Pop(2)

0x668: PushEmpty(object, object)
0x669: @ GetScene(Stack[-1])
0x66a: Pop(0)
0x66b: Push("battle") // @poff=789
0x66c: PushEmpty(object)
0x66d: Call2 0x62f

0x66e: Pop(0)
0x66f: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x670: Pop(2)
0x671: Return(); Pop(2)

0x672: Stack[-1] = 0
0x673: PushEmpty(int, int)
0x674: Push("branch") // @poff=803
0x675: @ GetVariable(Stack[-1], Stack[-2])
0x676: Pop(1)
...
0x680: @ WorkWithCorpse(Stack[-1])
0x681: Pop(0)
0x682: GOTO 0x685

0x683: @ Barter(Stack[-1])
0x684: Pop(0)
0x685: Return(); Pop(0)

0x686: PushEmpty(object, int, bool, object, int, bool)
0x687: @ CreateInvItem(Stack[-3])
0x688: Pop(0)
0x689: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x68a: Pop(0)
0x68b: Push("Organ") // @poff=829
0x68c: Push((int) 1)
0x68d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=622
0x68e: Pop(2)
0x68f: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x690: Pop(0)
0x691: Push((int) 0)
0x692: Push((int) 1)
0x693: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x694: Pop(2)
0x695: Return(); Pop(6)
...
0x69f: Stack[-1] = "liver" // @poff=851
0x6a0: Call2 0x686

0x6a1: Pop(1)
0x6a2: PushEmpty(string)
0x6a3: Stack[-1] = "kidney" // @poff=863
0x6a4: Call2 0x686

0x6a5: Pop(1)
0x6a6: PushEmpty(string)
0x6a7: Stack[-1] = "heart" // @poff=877
0x6a8: Call2 0x686

0x6a9: Pop(1)
0x6aa: PushEmpty(string)
0x6ab: Stack[-1] = "blood" // @poff=889
0x6ac: Call2 0x686
...
0x6b0: Push("revolver_ammo") // @poff=901
0x6b1: Push((int) 0)
0x6b2: Push((int) 2)
0x6b3: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6b4: Pop(3)
0x6b5: Push("alpha_pills") // @poff=929
0x6b6: Push((int) 0)
0x6b7: Push((int) 12)
0x6b8: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6b9: Pop(3)
0x6ba: PushEmpty()
0x6bb: Call2 0x697
...
0x6bf: Push(-1, 0); TaskCall(3)
0x6c0: Call2 0x430

0x6c1: Pop(-1, 0); TaskReturn
0x6c2: Pop(1)
0x6c3: Return(); Pop(2)

0x6c4: PushEmpty()
0x6c5: PushEmpty(object, int, float)
0x6c6: Stack[-7] = Stack[-3]
0x6c7: Stack[-6] = Stack[-2]
...
0x6cc: PushEmpty()
0x6cd: PushEmpty(object, int, float, cvector, cvector)
0x6ce: Stack[-11] = Stack[-5]
0x6cf: Stack[-10] = Stack[-4]
0x6d0: Stack[-9] = Stack[-3]
0x6d1: Stack[-7] = Stack[-2]
0x6d2: Stack[-6] = Stack[-1]
0x6d3: Call2 0x5e2

0x6d4: Pop(5)
0x6d5: Return(); Pop(0)

0x6d6: PushEmpty(float, float)
0x6d7: Push("health") // @poff=570
0x6d8: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6d9: IF (Stack[-1] == 0) GOTO 0x6e2; Pop(1)

0x6da: Push("health") // @poff=570
...
0x6e0: @ SignalDeath(Stack[-4])
0x6e1: Pop(0)
0x6e2: Return(); Pop(2)

0x6e3: PushEmpty()
0x6e4: PushEmpty(object)
