...
Strings:
	...
	W:alpha_pills
	W:beta_pills
// @pool_raw:
...
0x19: Stack[-1] = "path" // @poff=0
0x1a: Call2 0x507

0x1b: Stack[-2] = Stack[-4]
0x1c: Pop(2)
0x1d: Stack[-1] = (int) 1
0x1e: Call2 0x39
...
0x34: Stack[-2] = "quest_b4_01" // @poff=24
0x35: Stack[-1] = "patrol_attack" // @poff=48
0x36: Call2 0x6a2
...
0x3d: Push((int) 1)
0x3e: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
0x3f: Pop(1); Push(Stack[-23] + Stack[-1]);
0x40: @@ GetLocator(Stack[-1], Stack[-10]); Obj=11 // @poff=76
0x41: Pop(1)
...
0x51: @@ GetLocator(Stack[-1], Stack[-9], Stack[-8], Stack[-7]); Obj=11 // @poff=76
0x52: Pop(1)
0x53: PushEmpty(bool, cvector)
0x54: Stack[-9] = Stack[-1]
0x55: Call2 0x596
...
0x62: Stack[-24] = Stack[-3]
0x63: Stack[-10] = Stack[-2]
...
0x77: @@ GetLocator(Stack[-1], Stack[-5], Stack[-4], Stack[-3]); Obj=11 // @poff=76
0x78: Pop(1)
...
0x88: Stack[-24] = Stack[-3]
0x89: Stack[-6] = Stack[-2]
...
0xb2: Stack[-1] = 0
0xb3: PushEmpty()
0xb4: Stack[-3] = (float) 0.20000000298023224
0xb5: Return(); Pop(0)
...
0xce: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xcf: Pop(0)
0xd0: Push(Stack[-8])
0xd1: IF (Stack[-1] == 0) GOTO 0xda; Pop(1)

0xd2: Push("attack") // @poff=10
...
0xee: Pop(0)
0xef: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=157
0xf0: Pop(0)
...
0x10a: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=157
0x10b: Pop(0)
...
0x124: Pop(1)
0x125: Push("all") // @poff=171
0x126: Push("attack_on") // @poff=179
...
0x13e: IF (Stack[-1] == 1) GOTO 0x144; Pop(1)
...
0x145: @ Face(Stack[-0]T)
0x146: Pop(0)
0x147: PushEmpty()
0x148: Call2 0x342

0x149: Pop(0)
0x14a: Push("all") // @poff=171
0x14b: Push("attack_stay") // @poff=199
0x14c: @ PlayAnimation(Stack[-2], Stack[-1])
0x14d: Pop(2)
0x14e: PushEmpty(bool, float)
0x14f: Stack[-25] = Stack[-1]
0x150: Call2 0x28c
...
0x155: @ Face(Stack[-0]T)
0x156: Pop(0)
0x157: Push("all") // @poff=171
0x158: Push("fjump") // @poff=223
...
0x173: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=157
0x174: Pop(0)
...
0x192: Push("all") // @poff=171
0x193: Push("attack_off") // @poff=235
...
0x1a0: Push("all") // @poff=171
0x1a1: Push("attack_begin") // @poff=257
0x1a2: Push((int) 1)
0x1a3: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1ae: Push("attack") // @poff=10
0x1af: Push((int) 1)
0x1b0: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1ba: Push("all") // @poff=171
0x1bb: Push("bjump") // @poff=283
...
0x1c2: Push((float)0.8999999761581421)
0x1c3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1c4: @ GetVictim(Stack[-1], Stack[-4])
0x1c5: Pop(1)
0x1c6: @ ReportAttack(Stack[-0]T)
0x1c7: Pop(0)
...
0x1da: Stack[-4] = Stack[-5]
0x1db: Pop(4)
0x1dc: PushEmpty(int)
0x1dd: Call2 0x340

0x1de: Pop(0)
0x1df: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1e0: Pop(1)
0x1e1: PushEmpty(object, float)
0x1e2: Stack[-5] = Stack[-2]
...
0x1eb: Pop(0)
0x1ec: @ irand(Stack[-4], Stack[-1]T)
0x1ed: Pop(0)
0x1ee: Push((int) 1)
0x1ef: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x1f0: @ Face(Stack[-0]T)
0x1f1: Pop(0)
0x1f2: Push((bool) 1)
...
0x1f7: Pop(0)
0x1f8: Push("all") // @poff=171
0x1f9: Push("attack_begin") // @poff=257
...
0x20d: Stack[-11] = Stack[-2]
0x20e: Stack[-6] = Stack[-1]
0x20f: Call2 0x1c1

0x210: Pop(2)
0x211: Push("all") // @poff=171
0x212: Push("attack_middle") // @poff=295
...
0x21a: Pop(0)
0x21b: Push("all") // @poff=171
0x21c: Push("attack_middle") // @poff=295
...
0x256: Stack[-11] = Stack[-2]
0x257: Stack[-6] = Stack[-1]
0x258: Call2 0x1c1
...
0x25f: Pop(1)
0x260: Push("all") // @poff=171
0x261: Push("attack_end") // @poff=327
...
0x2a0: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=157
0x2a1: Pop(0)
...
0x2ec: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2ed: Pop(1)
...
0x2f1: @ Face(Stack[-0]T)
0x2f2: Pop(0)
0x2f3: Push("all") // @poff=171
0x2f4: Push("bjump") // @poff=283
0x2f5: @ PlayAnimation(Stack[-2], Stack[-1])
0x2f6: Pop(2)
0x2f7: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=157
0x2f8: Pop(0)
...
0x32e: @ irand(Stack[-1], Stack[-2]T)
0x32f: Pop(0)
0x330: Push((int) 1)
0x331: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x332: Push("attack") // @poff=10
...
0x343: Stack[-1] = "attack_stay" // @poff=199
0x344: Call2 0x648
...
0x36e: Stack[-15] = Stack[-5]
0x36f: Stack[-14] = Stack[-4]
0x370: Stack[-13] = Stack[-3]
0x371: Stack[-12] = Stack[-2]
0x372: Stack[-11] = Stack[-1]
0x373: Call2 0x3b8

0x374: Stack[-6] = Stack[-7]
0x375: Pop(6)
0x376: Push( Stack[2 + Tasks[-1].StackPointer] )
0x377: IF (Stack[-1] == 0) GOTO 0x37b; Pop(1)

0x378: Push("head") // @poff=385
...
0x3c4: @@ GetPosition(Stack[-5]); Obj=21 // @poff=395
0x3c5: Pop(0)
...
0x3db: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=157
0x3dc: Pop(0)
...
0x44b: Stack[-1] = "walk" // @poff=407
0x44c: Return(); Pop(0)

0x44d: Stack[-1] = "run" // @poff=417
0x44e: Return(); Pop(0)
...
0x467: Pop(0); PushNull((bool) Stack[-21] == 0)
0x468: IF (Stack[-1] == 0) GOTO 0x46e; Pop(1)

0x469: PushEmpty(string)
0x46a: Stack[-1] = "fdie" // @poff=425
0x46b: Call2 0x4c1

0x46c: Pop(1)
0x46d: GOTO 0x4c0

0x46e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=395
0x46f: Pop(0)
...
0x47f: Stack[-6] = "fdie" // @poff=425
0x480: GOTO 0x482

0x481: Stack[-6] = "bdie" // @poff=435
...
0x488: @ StopAsync()
0x489: Pop(0)
0x48a: Stack[-21] = Stack[-5]
0x48b: Push("GetScriptProperty") // @poff=445
0x48c: Push((int) 2)
0x48d: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x48e: IF (Stack[-1] == 0) GOTO 0x49a; Pop(1)

0x48f: Push("Owner") // @poff=481
0x490: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=493
0x491: Pop(1)
0x492: Push(Stack[-4])
0x493: IF (Stack[-1] == 0) GOTO 0x49a; Pop(1)

0x494: Push("Owner") // @poff=481
0x495: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=511
0x496: Pop(1)
0x497: Pop(0); PushNull((bool) Stack[-5] == 0)
0x498: IF (Stack[-1] == 0) GOTO 0x49a; Pop(1)

0x499: Stack[-21] = Stack[-5]
0x49a: Push("@GetEyesHeight") // @poff=529
0x49b: Push((int) 1)
0x49c: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x49d: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x49e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=559
0x49f: Pop(0)
0x4a0: Stack[-1] = [0.0, 0.0, 0.0]
0x4a1: Push(CvectorIndex(Stack[-1], 1))
0x4a2: Stack[-3] = Stack[-1]
0x4a3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4a4: Push("head") // @poff=385
...
0x4ab: Stack[-7] = Stack[-1]
0x4ac: Call2 0x648

0x4ad: Pop(1)
0x4ae: Push("all") // @poff=171
...
0x4b5: @ StopAsync()
0x4b6: Pop(0)
0x4b7: Push("head") // @poff=385
0x4b8: @ UnlookAsync(Stack[-1])
0x4b9: Pop(1)
0x4ba: Push("all") // @poff=171
...
0x4eb: Stack[-2] = "bullet" // @poff=583
0x4ec: Return(); Pop(0)

0x4ed: Stack[-2] = "phys" // @poff=597
0x4ee: Return(); Pop(0)

0x4ef: PushEmpty(cvector, cvector, cvector, cvector)
0x4f0: @ GetPosition(Stack[-2])
0x4f1: Pop(0)
0x4f2: @@ GetPosition(Stack[-1]); Obj=5 // @poff=395
0x4f3: Pop(0)
...
0x4fc: Push("HasProperty") // @poff=607
0x4fd: Push((int) 2)
...
0x503: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=631
0x504: Pop(0)
...
0x517: Stack[-18] = Stack[-2]
0x518: Stack[-1] = "armor" // @poff=657
0x519: Call2 0x4fb
...
0x51f: Push("armor") // @poff=657
0x520: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=669
0x521: Pop(1)
0x522: Push("armor_") // @poff=681
0x523: PushEmpty(string, int)
0x524: Stack[-16] = Stack[-1]
0x525: Call2 0x4e1
...
0x531: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=669
0x532: Pop(0)
...
0x539: Stack[-3] = Stack[-6]
0x53a: Pop(3)
0x53b: Push("health") // @poff=643
0x53c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=669
0x53d: Pop(1)
0x53e: Push((int) 1)
0x53f: Pop(1); Push(Stack[-1] - Stack[-4]);
0x540: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x541: Push("health") // @poff=643
...
0x547: Pop(3)
0x548: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=695
0x549: Pop(2)
0x54a: PushEmpty(bool, object)
0x54b: Stack[-17] = Stack[-1]
0x54c: Call2 0x4f6
...
0x552: Pop(1)
0x553: Stack[-1] = Stack[-16]
0x554: Return(); Pop(12)

0x555: PushEmpty(bool, bool)
0x556: @@ IsDead(Stack[-1]); Obj=3 // @poff=707
0x557: Pop(0)
0x558: Stack[-1] = Stack[-4]
0x559: Return(); Pop(2)

0x55a: PushEmpty(object, object, object, object)
0x55b: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x56f: Pop(0)
0x570: Pop(0); PushNull((bool) Stack[-2] == 0)
0x571: IF (Stack[-1] == 0) GOTO 0x574; Pop(1)

0x572: Stack[-6] = (bool) 0
0x573: Return(); Pop(4)

0x574: @@ GetScene(Stack[-1]); Obj=5 // @poff=728
0x575: Pop(0)
...
0x589: Stack[-1] = "noaccess" // @poff=737
0x58a: Call2 0x4fb
...
0x590: Push("noaccess") // @poff=737
0x591: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=669
0x592: Pop(1)
0x593: Push((int) 0)
...
0x5af: @@ GetPosition(Stack[-5]); Obj=15 // @poff=395
0x5b0: Pop(0)
...
0x5c0: Stack[-1] = "fhit" // @poff=755
0x5c1: GOTO 0x5c3

0x5c2: Stack[-1] = "bhit" // @poff=765
0x5c3: Push("hit_react") // @poff=775
0x5c4: Push("1") // @poff=44
0x5c5: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5c6: Push("2") // @poff=795
...
0x5df: Stack[-25] = Stack[-1]
0x5e0: Call2 0x4ef

0x5e1: Stack[-2] = Stack[-3]
0x5e2: Pop(2)
0x5e3: Call2 0x677

0x5e4: Stack[-2] = Stack[-11]
0x5e5: Pop(2)
0x5e6: @ CreateVectorVector(Stack[-8])
0x5e7: Pop(0)
0x5e8: Stack[-7] = (int) 1
0x5e9: Push("hit") // @poff=757
...
0x5fe: Pop(0)
0x5ff: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=808
0x600: Pop(0)
0x601: PushEmpty(object, int, float, cvector, cvector)
0x602: Stack[-26] = Stack[-5]
0x603: Stack[-25] = Stack[-4]
0x604: Stack[-24] = Stack[-3]
...
0x61f: @@ GetPosition(Stack[-3]); Obj=7 // @poff=395
0x620: Pop(0)
...
0x62f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=559
0x630: Pop(0)
0x631: Stack[-1] = [0.0, 0.0, 0.0]
0x632: Push(CvectorIndex(Stack[-1], 1))
0x633: Stack[-3] = Stack[-1]
0x634: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x635: Push("head") // @poff=385
...
0x68f: Stack[-1] = Stack[-4]
0x690: Return(); Pop(0)

0x691: Stack[-3] = Stack[-4]
0x692: Return(); Pop(0)
...
0x69a: Pop(0)
0x69b: @@ add(Stack[-3]); Obj=1 // @poff=799
0x69c: Pop(0)
0x69d: Push((int) 15)
...
0x6a4: Pop(0)
0x6a5: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6d7: Pop(0)
0x6d8: @@ SetItemName(Stack[-7]); Obj=3 // @poff=886
0x6d9: Pop(0)
0x6da: Push("Organ") // @poff=898
0x6db: Push((int) 1)
0x6dc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=695
0x6dd: Pop(2)
0x6de: @@ GetItemID(Stack[-2]); Obj=3 // @poff=910
0x6df: Pop(0)
0x6e0: Push((int) 0)
0x6e1: Push((int) 1)
...
0x6ee: Stack[-1] = "liver" // @poff=920
0x6ef: Call2 0x6d5

0x6f0: Pop(1)
0x6f1: PushEmpty(string)
0x6f2: Stack[-1] = "kidney" // @poff=932
0x6f3: Call2 0x6d5

0x6f4: Pop(1)
0x6f5: PushEmpty(string)
0x6f6: Stack[-1] = "heart" // @poff=946
0x6f7: Call2 0x6d5

0x6f8: Pop(1)
0x6f9: PushEmpty(string)
0x6fa: Stack[-1] = "blood" // @poff=958
0x6fb: Call2 0x6d5
...
0x708: Stack[-2] = "quest_b4_01" // @poff=24
0x709: Stack[-1] = "patrol_dead" // @poff=970
0x70a: Call2 0x6a2

0x70b: Pop(3)
0x70c: Push("revolver_ammo") // @poff=994
0x70d: Push((int) 0)
0x70e: Push((int) 4)
0x70f: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x710: Pop(3)
0x711: Push("meradorm") // @poff=1022
0x712: Push((int) 0)
0x713: Push((int) 1)
0x714: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x715: Pop(3)
0x716: Push("morfin") // @poff=1040
0x717: Push((int) 0)
0x718: Push((int) 1)
0x719: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x71a: Pop(3)
0x71b: PushEmpty(string, int, int, int)
0x71c: Stack[-4] = "alpha_pills" // @poff=1054
0x71d: Stack[-3] = (int) 2
0x71e: Stack[-2] = (int) 3
0x71f: Stack[-1] = (int) 5
0x720: Call2 0x639
...
0x723: Stack[-4] = "beta_pills" // @poff=1078
0x724: Stack[-3] = (int) 2
0x725: Stack[-2] = (int) 3
0x726: Stack[-1] = (int) 4
0x727: Call2 0x639
...
0x72d: Stack[-4] = Stack[-1]
0x72e: Push(-1, 0); TaskCall(4)
0x72f: Call2 0x44f

0x730: Pop(-1, 0); TaskReturn
0x731: Pop(1)
0x732: Return(); Pop(2)

0x733: PushEmpty()
0x734: PushEmpty(object, int, float)
0x735: Stack[-7] = Stack[-3]
0x736: Stack[-6] = Stack[-2]
...
0x73d: Stack[-11] = Stack[-5]
0x73e: Stack[-10] = Stack[-4]
0x73f: Stack[-9] = Stack[-3]
0x740: Stack[-7] = Stack[-2]
0x741: Stack[-6] = Stack[-1]
0x742: Call2 0x610
