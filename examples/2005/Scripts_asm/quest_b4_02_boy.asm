...
Strings:
	...
	W:oob4boy2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
EVENT_16 Op = 0x9cc Vars = (object, string)
EVENT_41 Op = 0x9d9 Vars = (object)
...
0x872: Push("head") // @poff=523
0x873: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x874: Pop(1)
0x875: Push(Stack[-1])
0x876: IF (Stack[-1] == 0) GOTO 0x87a; Pop(1)

0x877: Push("head") // @poff=523
0x878: @ UnlookAsync(Stack[-1])
0x879: Pop(1)
0x87a: Return(); Pop(2)

0x87b: PushEmpty(float, float, float, float)
0x87c: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x87d: Pop(0)
0x87e: Push((bool) 0)
0x87f: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x880: Pop(1)
0x881: Return(); Pop(4)

0x882: PushEmpty(float, float, float, float)
0x883: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x884: Pop(0)
0x885: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x886: Pop(0)
0x887: Return(); Pop(4)

0x888: PushEmpty(float, cvector, float, cvector)
0x889: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=689
0x88a: Pop(0)
0x88b: Stack[-1] = [0.0, 0.0, 0.0]
0x88c: Push(CvectorIndex(Stack[-1], 1))
0x88d: Stack[-3] = Stack[-1]
0x88e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x88f: Push("head") // @poff=523
0x890: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x891: Pop(1)
0x892: Return(); Pop(4)
...
0x89a: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x89b: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x89c: Pop(0)
0x89d: Pop(0); Push((bool) Stack[-8] == 0)
0x89e: IF (Stack[-1] == 0) GOTO 0x8b3; Pop(1)

0x89f: Stack[-7] = (int) 0
0x8a0: Push((int) 1)
0x8a1: Pop(1); Push(Stack[-8] + Stack[-1]);
0x8a2: Pop(1); Push(Stack[-18] + Stack[-1]);
0x8a3: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x8a4: Pop(1)
0x8a5: Pop(0); Push((bool) Stack[-6] == 0)
0x8a6: IF (Stack[-1] == 0) GOTO 0x8a8; Pop(1)

0x8a7: GOTO 0x8ab

0x8a8: Push((int) 1)
0x8a9: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x8aa: GOTO 0x8a0

0x8ab: Pop(0); Push((bool) Stack[-7] == 0)
0x8ac: IF (Stack[-1] == 0) GOTO 0x8ae; Pop(1)

0x8ad: Return(); Pop(16)

0x8ae: @ irand(Stack[-5], Stack[-7])
0x8af: Pop(0)
0x8b0: Push((int) 1)
0x8b1: Pop(1); Push(Stack[-6] + Stack[-1]);
0x8b2: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x8b3: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x8b4: Pop(0)
0x8b5: Push(Stack[-4])
0x8b6: IF (Stack[-1] == 0) GOTO 0x8c2; Pop(1)

0x8b7: @ GetEyesHeight(Stack[-3])
0x8b8: Pop(0)
0x8b9: @ GetDirection(Stack[-2])
0x8ba: Pop(0)
0x8bb: Push((int) 50)
0x8bc: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x8bd: Push(CvectorIndex(Stack[-1], 1))
0x8be: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x8bf: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8c0: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x8c1: Pop(0)
0x8c2: Return(); Pop(16)
...
0x8c4: @ self(Stack[-1])
0x8c5: Pop(0)
0x8c6: Stack[-1] = Stack[-3]
0x8c7: Return(); Pop(2)

0x8c8: Stack[-1] = 0
0x8c9: PushEmpty(float, float)
0x8ca: Pop(0); Push(Stack[-3] | Stack[-3]);
0x8cb: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x8cc: Push((float)9.999999974752427e-07)
0x8cd: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x8ce: IF (Stack[-1] == 0) GOTO 0x8d1; Pop(1)

0x8cf: Stack[-4] = [0.0, 0.0, 0.0]
0x8d0: Return(); Pop(2)

0x8d1: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x8d2: Return(); Pop(2)

0x8d3: PushEmpty()
0x8d4: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x8d5: IF (Stack[-1] == 0) GOTO 0x8d8; Pop(1)

0x8d6: Stack[-2] = Stack[-3]
0x8d7: GOTO 0x8d9
...
0x8ed: Stack[-3] = (bool) 0
0x8ee: Return(); Pop(0)

0x8ef: Push((int) 0)
0x8f0: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x8f1: IF (Stack[-1] == 0) GOTO 0x8f6; Pop(1)

0x8f2: Push((int) 8)
0x8f3: @ SendWorldWndMessage(Stack[-1])
0x8f4: Pop(1)
0x8f5: GOTO 0x8ff

0x8f6: Push((int) 0)
0x8f7: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x8f8: IF (Stack[-1] == 0) GOTO 0x8fd; Pop(1)

0x8f9: Push((int) 9)
0x8fa: @ SendWorldWndMessage(Stack[-1])
0x8fb: Pop(1)
0x8fc: GOTO 0x8ff

0x8fd: Stack[-3] = (bool) 0
0x8fe: Return(); Pop(0)

0x8ff: PushEmpty(float)
0x900: Stack[-2] = Stack[-1]
0x901: Call2 0x917

0x902: Pop(1)
0x903: PushEmpty(bool, object, string, float, float, float)
0x904: Stack[-8] = Stack[-5]
0x905: Stack[-4] = "reputation" // @poff=992
0x906: Stack[-7] = Stack[-3]
0x907: Stack[-2] = (int) 0
0x908: Stack[-1] = (int) 1
0x909: Call2 0x6f8

0x90a: Pop(6)
0x90b: Stack[-3] = (bool) 1
0x90c: Return(); Pop(0)

0x90d: PushEmpty(object, object)
0x90e: @ CreateFloatVector(Stack[-1])
0x90f: Pop(0)
0x910: @@ add(Stack[-3]); Obj=1 // @poff=933
0x911: Pop(0)
0x912: Push((int) 15)
0x913: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x914: Pop(1)
0x915: Return(); Pop(2)

0x916: Stack[-1] = 0
0x917: PushEmpty(object, object)
0x918: @ CreateFloatVector(Stack[-1])
0x919: Pop(0)
0x91a: @@ add(Stack[-3]); Obj=1 // @poff=933
0x91b: Pop(0)
0x91c: Push((int) 16)
0x91d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x91e: Pop(1)
0x91f: Return(); Pop(2)

0x920: Stack[-1] = 0
0x921: PushEmpty(object, object)
0x922: @ FindActor(Stack[-1], Stack[-4])
0x923: Pop(0)
0x924: Pop(0); PushNull((bool) Stack[-1] == 0)
0x925: IF (Stack[-1] == 0) GOTO 0x928; Pop(1)

0x926: Stack[-5] = (bool) 0
0x927: Return(); Pop(2)

0x928: @ Trigger(Stack[-1], Stack[-3])
0x929: Pop(0)
0x92a: Stack[-5] = (bool) 1
0x92b: Return(); Pop(2)

0x92c: Stack[-1] = 0
0x92d: PushEmpty(bool, bool)
0x92e: @ IsPlayerActor(Stack[-3], Stack[-1])
0x92f: Pop(0)
0x930: Push(Stack[-1])
0x931: IF (Stack[-1] == 0) GOTO 0x935; Pop(1)

0x932: Push("attack") // @poff=289
0x933: @ PlayGlobalMusic(Stack[-1])
0x934: Pop(1)
0x935: Return(); Pop(2)

0x936: PushEmpty(object, object)
0x937: @ GetScene(Stack[-1])
0x938: Pop(0)
0x939: Push("battle") // @poff=1014
0x93a: PushEmpty(object)
0x93b: Call2 0x8c3

0x93c: Pop(0)
0x93d: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x93e: Pop(2)
0x93f: Return(); Pop(2)

0x940: Stack[-1] = 0
0x941: Stack[-1] = (int) 515558
0x942: Return(); Pop(0)

0x943: Stack[-1] = (int) 503343
0x944: Return(); Pop(0)

0x945: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1028
0x946: Return(); Pop(0)

0x947: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1068
0x948: Return(); Pop(0)

0x949: Stack[-1] = (bool) 0
0x94a: Return(); Pop(0)

0x94b: PushEmpty(string, string)
0x94c: Stack[-1] = "idle" // @poff=146
0x94d: Push(Stack[-3])
0x94e: IF (Stack[-1] == 0) GOTO 0x950; Pop(1)

0x94f: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x950: Stack[-1] = Stack[-4]
0x951: Return(); Pop(2)

0x952: PushEmpty(int, bool, int, bool)
0x953: Stack[-2] = (int) 0
0x954: Push("all") // @poff=138
0x955: PushEmpty(string, int)
0x956: Stack[-5] = Stack[-1]
0x957: Call2 0x94b

0x958: Pop(1)
0x959: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x95a: Pop(2)
0x95b: Pop(0); Push((bool) Stack[-1] == 0)
0x95c: IF (Stack[-1] == 0) GOTO 0x95e; Pop(1)

0x95d: GOTO 0x961

0x95e: Push((int) 1)
0x95f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x960: GOTO 0x954

0x961: Stack[-2] = Stack[-5]
0x962: Return(); Pop(4)

0x963: PushEmpty()
0x964: Push("oob4boy1") // @poff=1112
0x965: Push((int) 1)
0x966: @ SetVariable(Stack[-2], Stack[-1])
0x967: Pop(2)
0x968: Return(); Pop(0)

0x969: PushEmpty()
0x96a: PushEmpty(bool, string, string)
0x96b: Stack[-2] = "quest_b4_02" // @poff=1130
0x96c: Stack[-1] = "boy_run" // @poff=1154
0x96d: Call2 0x921
...
0x976: PushEmpty()
0x977: PushEmpty(int, string)
0x978: Stack[-1] = "oob4boy1" // @poff=1112
0x979: Call2 0x8e5

0x97a: Pop(1)
0x97b: Push((int) 0)
0x97c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x97d: IF (Stack[-1] == 0) GOTO 0x980; Pop(1)

0x97e: Stack[-2] = (bool) 1
0x97f: Return(); Pop(0)
...
0x982: PushEmpty()
0x983: PushEmpty(int, string)
0x984: Stack[-1] = "oob4boy2" // @poff=1170
0x985: Call2 0x8e5

0x986: Pop(1)
0x987: Push((int) 0)
0x988: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x989: IF (Stack[-1] == 0) GOTO 0x98c; Pop(1)

0x98a: Stack[-2] = (bool) 1
0x98b: Return(); Pop(0)

0x98c: Stack[-2] = (bool) 0
0x98d: Return(); Pop(0)

0x98e: PushEmpty(int, int)
0x98f: Push("branch") // @poff=1188
0x990: @ GetVariable(Stack[-1], Stack[-2])
0x991: Pop(1)
0x992: Push((int) 0)
0x993: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x994: IF (Stack[-1] == 0) GOTO 0x998; Pop(1)
...
0x9a0: Push("branch") // @poff=1188
0x9a1: @ GetVariable(Stack[-1], Stack[-2])
0x9a2: Pop(1)
0x9a3: Stack[-1] = Stack[-3]
0x9a4: Return(); Pop(2)
...
0x9a8: Pop(0)
0x9a9: Push((int) 1)
0x9aa: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9ab: IF (Stack[-1] == 0) GOTO 0x9af; Pop(1)

0x9ac: @ WorkWithCorpse(Stack[-1])
0x9ad: Pop(0)
0x9ae: GOTO 0x9b1

0x9af: @ Barter(Stack[-1])
0x9b0: Pop(0)
0x9b1: Return(); Pop(0)
...
0x9b5: Push(-1, 0); TaskCall(6)
0x9b6: Call2 0x63e

0x9b7: Pop(-1, 0); TaskReturn
0x9b8: Pop(1)
0x9b9: Return(); Pop(0)

0x9ba: PushEmpty()
0x9bb: PushEmpty(object, int, float)
0x9bc: Stack[-7] = Stack[-3]
0x9bd: Stack[-6] = Stack[-2]
...
0x9c4: Stack[-11] = Stack[-5]
0x9c5: Stack[-10] = Stack[-4]
0x9c6: Stack[-9] = Stack[-3]
0x9c7: Stack[-7] = Stack[-2]
...
0x9cc: PushEmpty(float, float)
0x9cd: Push("health") // @poff=797
0x9ce: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9cf: IF (Stack[-1] == 0) GOTO 0x9d8; Pop(1)

0x9d0: Push("health") // @poff=797
0x9d1: @ GetProperty(Stack[-1], Stack[-2])
0x9d2: Pop(1)
0x9d3: Push((int) 0)
0x9d4: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x9d5: IF (Stack[-1] == 0) GOTO 0x9d8; Pop(1)

0x9d6: @ SignalDeath(Stack[-4])
0x9d7: Pop(0)
0x9d8: Return(); Pop(2)
...
0x9df: PushEmpty(bool, object, float)
0x9e0: Stack[-4] = Stack[-2]
0x9e1: Stack[-1] = (float) -0.10000000149011612
0x9e2: Call2 0x8ea

0x9e3: Pop(3)
0x9e4: PushEmpty(object)
0x9e5: Stack[-2] = Stack[-1]
0x9e6: Call2 0x9b2
