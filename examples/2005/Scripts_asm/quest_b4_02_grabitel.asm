...
0x815: Pop(0)
0x816: @@ add(Stack[-3]); Obj=1 // @poff=908
0x817: Pop(0)
0x818: Push((int) 16)
...
0x832: Push("god_mode") // @poff=985
0x833: @ GetVariable(Stack[-1], Stack[-2])
0x834: Pop(1)
0x835: Stack[-1] = Stack[-3]
0x836: Return(); Pop(2)

0x837: PushEmpty(string, string)
0x838: Stack[-1] = "idle" // @poff=1003
0x839: Push(Stack[-3])
...
0x83f: Stack[-2] = (int) 0
0x840: Push("all") // @poff=0
0x841: PushEmpty(string, int)
0x842: Stack[-5] = Stack[-1]
0x843: Call2 0x837
...
0x84d: Stack[-2] = Stack[-5]
0x84e: Return(); Pop(4)

0x84f: PushEmpty()
0x850: PushEmpty(object)
0x851: Stack[-2] = Stack[-1]
...
0x859: Stack[-7] = Stack[-3]
0x85a: Stack[-6] = Stack[-2]
...
0x861: Stack[-11] = Stack[-5]
0x862: Stack[-10] = Stack[-4]
0x863: Stack[-9] = Stack[-3]
0x864: Stack[-7] = Stack[-2]
0x865: Stack[-6] = Stack[-1]
0x866: Call2 0x742
...
0x880: Stack[-2] = Stack[-4]
0x881: Pop(2)
0x882: Return(); Pop(0)

0x883: PushEmpty()
0x884: PushEmpty(object)
0x885: Stack[-2] = Stack[-1]
0x886: Call2 0x92a
...
0x88a: Push("branch") // @poff=1013
0x88b: @ GetVariable(Stack[-1], Stack[-2])
0x88c: Pop(1)
0x88d: Stack[-1] = Stack[-3]
0x88e: Return(); Pop(2)
...
0x89f: Push("GenerateMoney: iMin > iMax") // @poff=1027
0x8a0: @ Trace(Stack[-1])
0x8a1: Pop(1)
0x8a2: Return(); Pop(4)
...
0x8bd: Pop(0)
0x8be: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1093
0x8bf: Pop(0)
0x8c0: Push("Organ") // @poff=1105
0x8c1: Push((int) 1)
0x8c2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=764
0x8c3: Pop(2)
0x8c4: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1117
0x8c5: Pop(0)
0x8c6: Push((int) 0)
0x8c7: Push((int) 1)
...
0x8d4: Stack[-1] = "liver" // @poff=1127
0x8d5: Call2 0x8bb

0x8d6: Pop(1)
0x8d7: PushEmpty(string)
0x8d8: Stack[-1] = "kidney" // @poff=1139
0x8d9: Call2 0x8bb

0x8da: Pop(1)
0x8db: PushEmpty(string)
0x8dc: Stack[-1] = "heart" // @poff=1153
0x8dd: Call2 0x8bb

0x8de: Pop(1)
0x8df: PushEmpty(string)
0x8e0: Stack[-1] = "blood" // @poff=1165
0x8e1: Call2 0x8bb
...
0x8f4: Stack[-3] = "lockpick" // @poff=1189
0x8f5: Stack[-2] = (int) 1
0x8f6: Stack[-1] = (int) 6
0x8f7: Call2 0x76b
...
0x8fa: Stack[-1] = "grabitel_mark" // @poff=1207
0x8fb: Call2 0x902
...
0x911: Stack[-9] = Stack[-3]
0x912: Stack[-8] = Stack[-2]
0x913: Stack[-7] = Stack[-1]
0x914: Call2 0x7b6

0x915: Stack[-4] = Stack[-6]
0x916: Pop(4)
0x917: Push((int) 0)
...
0x91d: Stack[-10] = Stack[-4]
0x91e: Stack[-9] = Stack[-3]
0x91f: Stack[-8] = Stack[-2]
0x920: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x921: Call2 0x7bd

0x922: Pop(4)
0x923: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x924: Push([0.0, 500.0, 0.0])
...
0x92f: Pop(0)
0x930: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x931: Pop(1)
