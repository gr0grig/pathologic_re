...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0xa18 Vars = (object, int, float, float)
EVENT_43 Op = 0xa20 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xa2a Vars = (object, string)
EVENT_41 Op = 0xa37 Vars = (object)
...
0x8fb: Push("head") // @poff=224
0x8fc: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8fd: Pop(1)
0x8fe: Push(Stack[-1])
0x8ff: IF (Stack[-1] == 0) GOTO 0x903; Pop(1)

0x900: Push("head") // @poff=224
0x901: @ UnlookAsync(Stack[-1])
0x902: Pop(1)
0x903: Return(); Pop(2)

0x904: PushEmpty(float, float, float, float)
0x905: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x906: Pop(0)
0x907: Push((bool) 0)
0x908: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x909: Pop(1)
0x90a: Return(); Pop(4)

0x90b: PushEmpty(float, float, float, float)
0x90c: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x90d: Pop(0)
0x90e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x90f: Pop(0)
0x910: Return(); Pop(4)

0x911: PushEmpty(float, cvector, float, cvector)
0x912: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=696
0x913: Pop(0)
0x914: Stack[-1] = [0.0, 0.0, 0.0]
0x915: Push(CvectorIndex(Stack[-1], 1))
0x916: Stack[-3] = Stack[-1]
0x917: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x918: Push("head") // @poff=224
0x919: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x91a: Pop(1)
0x91b: Return(); Pop(4)
...
0x923: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x924: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x925: Pop(0)
0x926: Pop(0); Push((bool) Stack[-8] == 0)
0x927: IF (Stack[-1] == 0) GOTO 0x93c; Pop(1)

0x928: Stack[-7] = (int) 0
0x929: Push((int) 1)
0x92a: Pop(1); Push(Stack[-8] + Stack[-1]);
0x92b: Pop(1); Push(Stack[-18] + Stack[-1]);
0x92c: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x92d: Pop(1)
0x92e: Pop(0); Push((bool) Stack[-6] == 0)
0x92f: IF (Stack[-1] == 0) GOTO 0x931; Pop(1)

0x930: GOTO 0x934

0x931: Push((int) 1)
0x932: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x933: GOTO 0x929

0x934: Pop(0); Push((bool) Stack[-7] == 0)
0x935: IF (Stack[-1] == 0) GOTO 0x937; Pop(1)

0x936: Return(); Pop(16)

0x937: @ irand(Stack[-5], Stack[-7])
0x938: Pop(0)
0x939: Push((int) 1)
0x93a: Pop(1); Push(Stack[-6] + Stack[-1]);
0x93b: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x93c: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x93d: Pop(0)
0x93e: Push(Stack[-4])
0x93f: IF (Stack[-1] == 0) GOTO 0x94b; Pop(1)

0x940: @ GetEyesHeight(Stack[-3])
0x941: Pop(0)
0x942: @ GetDirection(Stack[-2])
0x943: Pop(0)
0x944: Push((int) 50)
0x945: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x946: Push(CvectorIndex(Stack[-1], 1))
0x947: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x948: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x949: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x94a: Pop(0)
0x94b: Return(); Pop(16)
...
0x94d: @ self(Stack[-1])
0x94e: Pop(0)
0x94f: Stack[-1] = Stack[-3]
0x950: Return(); Pop(2)

0x951: Stack[-1] = 0
0x952: PushEmpty(float, float)
0x953: Pop(0); Push(Stack[-3] | Stack[-3]);
0x954: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x955: Push((float)9.999999974752427e-07)
0x956: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x957: IF (Stack[-1] == 0) GOTO 0x95a; Pop(1)

0x958: Stack[-4] = [0.0, 0.0, 0.0]
0x959: Return(); Pop(2)

0x95a: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x95b: Return(); Pop(2)

0x95c: PushEmpty()
0x95d: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x95e: IF (Stack[-1] == 0) GOTO 0x961; Pop(1)

0x95f: Stack[-2] = Stack[-3]
0x960: GOTO 0x962
...
0x963: PushEmpty()
0x964: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x965: IF (Stack[-1] == 0) GOTO 0x968; Pop(1)

0x966: Stack[-2] = Stack[-4]
0x967: Return(); Pop(0)

0x968: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x969: IF (Stack[-1] == 0) GOTO 0x96c; Pop(1)

0x96a: Stack[-1] = Stack[-4]
0x96b: Return(); Pop(0)
...
0x96f: @ GetVariable(Stack[-3], Stack[-1])
0x970: Pop(0)
0x971: Stack[-1] = Stack[-4]
0x972: Return(); Pop(2)

0x973: PushEmpty(object, object)
0x974: @ CreateFloatVector(Stack[-1])
0x975: Pop(0)
0x976: @@ add(Stack[-3]); Obj=1 // @poff=936
0x977: Pop(0)
0x978: Push((int) 15)
0x979: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x97a: Pop(1)
0x97b: Return(); Pop(2)

0x97c: Stack[-1] = 0
0x97d: PushEmpty(object, object)
0x97e: @ FindActor(Stack[-1], Stack[-4])
0x97f: Pop(0)
0x980: Pop(0); PushNull((bool) Stack[-1] == 0)
0x981: IF (Stack[-1] == 0) GOTO 0x984; Pop(1)

0x982: Stack[-5] = (bool) 0
0x983: Return(); Pop(2)

0x984: @ Trigger(Stack[-1], Stack[-3])
0x985: Pop(0)
0x986: Stack[-5] = (bool) 1
0x987: Return(); Pop(2)

0x988: Stack[-1] = 0
0x989: PushEmpty(bool, bool)
0x98a: @ IsPlayerActor(Stack[-3], Stack[-1])
0x98b: Pop(0)
0x98c: Push(Stack[-1])
0x98d: IF (Stack[-1] == 0) GOTO 0x991; Pop(1)

0x98e: Push("attack") // @poff=196
0x98f: @ PlayGlobalMusic(Stack[-1])
0x990: Pop(1)
0x991: Return(); Pop(2)

0x992: PushEmpty(object, object)
0x993: @ GetScene(Stack[-1])
0x994: Pop(0)
0x995: Push("battle") // @poff=995
0x996: PushEmpty(object)
0x997: Call2 0x94c

0x998: Pop(0)
0x999: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x99a: Pop(2)
0x99b: Return(); Pop(2)

0x99c: Stack[-1] = 0
0x99d: PushEmpty()
0x99e: PushEmpty(bool, string, string)
0x99f: Stack[-2] = "quest_b5_01" // @poff=156
0x9a0: Stack[-1] = "butcher_attack" // @poff=180
0x9a1: Call2 0x97d
...
0x9a4: PushEmpty()
0x9a5: Push("oob5Butcher1") // @poff=1009
0x9a6: Push((int) 1)
0x9a7: @ SetVariable(Stack[-2], Stack[-1])
0x9a8: Pop(2)
0x9a9: Return(); Pop(0)

0x9aa: PushEmpty()
0x9ab: PushEmpty(int, string)
0x9ac: Stack[-1] = "b5q01WifeDead" // @poff=1035
0x9ad: Call2 0x96e
...
0x9b8: Stack[-1] = "oob5Butcher1" // @poff=1009
0x9b9: Call2 0x96e
...
0x9c2: PushEmpty(int, int)
0x9c3: Push("branch") // @poff=1063
0x9c4: @ GetVariable(Stack[-1], Stack[-2])
0x9c5: Pop(1)
0x9c6: Push((int) 0)
0x9c7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9c8: IF (Stack[-1] == 0) GOTO 0x9cc; Pop(1)
...
0x9ce: IF (Stack[-1] == 0) GOTO 0x9d1; Pop(1)
...
0x9d4: Push("branch") // @poff=1063
0x9d5: @ GetVariable(Stack[-1], Stack[-2])
0x9d6: Pop(1)
...
0x9e0: @ WorkWithCorpse(Stack[-1])
0x9e1: Pop(0)
0x9e2: GOTO 0x9e5

0x9e3: @ Barter(Stack[-1])
0x9e4: Pop(0)
0x9e5: Return(); Pop(0)

0x9e6: PushEmpty(string, string)
0x9e7: Stack[-1] = "idle" // @poff=146
0x9e8: Push(Stack[-3])
0x9e9: IF (Stack[-1] == 0) GOTO 0x9eb; Pop(1)

0x9ea: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x9eb: Stack[-1] = Stack[-4]
0x9ec: Return(); Pop(2)

0x9ed: PushEmpty(int, bool, int, bool)
0x9ee: Stack[-2] = (int) 0
0x9ef: Push("all") // @poff=138
0x9f0: PushEmpty(string, int)
0x9f1: Stack[-5] = Stack[-1]
0x9f2: Call2 0x9e6

0x9f3: Pop(1)
0x9f4: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x9f5: Pop(2)
...
0x9f9: Push((int) 1)
0x9fa: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x9fb: GOTO 0x9ef

0x9fc: Stack[-2] = Stack[-5]
0x9fd: Return(); Pop(4)

0x9fe: Stack[-1] = (int) 515562
0x9ff: Return(); Pop(0)

0xa00: Stack[-1] = (int) 503347
0xa01: Return(); Pop(0)

0xa02: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1077
0xa03: Return(); Pop(0)

0xa04: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1117
0xa05: Return(); Pop(0)
...
0xa09: @ GetScene(Stack[-1])
0xa0a: Pop(0)
0xa0b: PushEmpty(object)
0xa0c: Call2 0x94c

0xa0d: Pop(0)
0xa0e: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=234
0xa0f: Pop(1)
0xa10: PushEmpty(object)
0xa11: Stack[-4] = Stack[-1]
0xa12: Push(-1, 0); TaskCall(5)
0xa13: Call2 0x6d5

0xa14: Pop(-1, 0); TaskReturn
0xa15: Pop(1)
0xa16: Return(); Pop(2)

0xa17: Stack[-1] = 0
0xa18: PushEmpty()
0xa19: PushEmpty(object, int, float)
0xa1a: Stack[-7] = Stack[-3]
0xa1b: Stack[-6] = Stack[-2]
...
0xa20: PushEmpty()
0xa21: PushEmpty(object, int, float, cvector, cvector)
0xa22: Stack[-11] = Stack[-5]
0xa23: Stack[-10] = Stack[-4]
0xa24: Stack[-9] = Stack[-3]
0xa25: Stack[-7] = Stack[-2]
0xa26: Stack[-6] = Stack[-1]
0xa27: Call2 0x891

0xa28: Pop(5)
0xa29: Return(); Pop(0)

0xa2a: PushEmpty(float, float)
0xa2b: Push("health") // @poff=780
0xa2c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa2d: IF (Stack[-1] == 0) GOTO 0xa36; Pop(1)

0xa2e: Push("health") // @poff=780
0xa2f: @ GetProperty(Stack[-1], Stack[-2])
0xa30: Pop(1)
0xa31: Push((int) 0)
0xa32: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa33: IF (Stack[-1] == 0) GOTO 0xa36; Pop(1)

0xa34: @ SignalDeath(Stack[-4])
0xa35: Pop(0)
0xa36: Return(); Pop(2)

0xa37: PushEmpty()
0xa38: PushEmpty(object)
0xa39: Stack[-2] = Stack[-1]
0xa3a: Call2 0xa08
