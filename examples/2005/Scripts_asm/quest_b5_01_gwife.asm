...
Strings:
	...
	W:quest_b5_01
	W:gwife_dead
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x576 Vars = (object, int, float, float)
EVENT_43 Op = 0x57e Vars = (object, int, float, float, cvector, cvector)
EVENT_41 Op = 0x588 Vars = (object)
...
0x494: PushEmpty(float, float, float, float)
0x495: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x496: Pop(0)
0x497: Push((bool) 0)
0x498: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x499: Pop(1)
0x49a: Return(); Pop(4)

0x49b: PushEmpty(float, float, float, float)
0x49c: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x49d: Pop(0)
0x49e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x49f: Pop(0)
0x4a0: Return(); Pop(4)

0x4a1: PushEmpty(float, cvector, float, cvector)
0x4a2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x4a3: Pop(0)
0x4a4: Stack[-1] = [0.0, 0.0, 0.0]
0x4a5: Push(CvectorIndex(Stack[-1], 1))
0x4a6: Stack[-3] = Stack[-1]
0x4a7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4a8: Push("head") // @poff=186
0x4a9: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x4aa: Pop(1)
0x4ab: Return(); Pop(4)
...
0x4b3: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x4b4: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x4b5: Pop(0)
0x4b6: Pop(0); Push((bool) Stack[-8] == 0)
0x4b7: IF (Stack[-1] == 0) GOTO 0x4cc; Pop(1)

0x4b8: Stack[-7] = (int) 0
0x4b9: Push((int) 1)
0x4ba: Pop(1); Push(Stack[-8] + Stack[-1]);
0x4bb: Pop(1); Push(Stack[-18] + Stack[-1]);
0x4bc: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x4bd: Pop(1)
...
0x4c1: Push((int) 1)
0x4c2: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x4c3: GOTO 0x4b9

0x4c4: Pop(0); Push((bool) Stack[-7] == 0)
0x4c5: IF (Stack[-1] == 0) GOTO 0x4c7; Pop(1)

0x4c6: Return(); Pop(16)

0x4c7: @ irand(Stack[-5], Stack[-7])
0x4c8: Pop(0)
0x4c9: Push((int) 1)
0x4ca: Pop(1); Push(Stack[-6] + Stack[-1]);
0x4cb: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x4cc: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x4cd: Pop(0)
0x4ce: Push(Stack[-4])
0x4cf: IF (Stack[-1] == 0) GOTO 0x4db; Pop(1)

0x4d0: @ GetEyesHeight(Stack[-3])
0x4d1: Pop(0)
0x4d2: @ GetDirection(Stack[-2])
0x4d3: Pop(0)
0x4d4: Push((int) 50)
0x4d5: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x4d6: Push(CvectorIndex(Stack[-1], 1))
0x4d7: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x4d8: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4d9: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x4da: Pop(0)
0x4db: Return(); Pop(16)
...
0x4e1: Stack[-1] = 0
0x4e2: PushEmpty(float, float)
0x4e3: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4e4: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x4e5: Push((float)9.999999974752427e-07)
0x4e6: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x4e7: IF (Stack[-1] == 0) GOTO 0x4ea; Pop(1)

0x4e8: Stack[-4] = [0.0, 0.0, 0.0]
0x4e9: Return(); Pop(2)

0x4ea: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x4eb: Return(); Pop(2)

0x4ec: PushEmpty()
0x4ed: Pop(0); Push(Stack[-2] | Stack[-1]);
0x4ee: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4ef: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4f0: Pop(2); Push(Stack[-2] * Stack[-1]);
0x4f1: Pop(1); Push(Sqrt(Stack[-1]))
0x4f2: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x4f3: Return(); Pop(0)

0x4f4: PushEmpty(int, int)
0x4f5: @ GetVariable(Stack[-3], Stack[-1])
0x4f6: Pop(0)
0x4f7: Stack[-1] = Stack[-4]
0x4f8: Return(); Pop(2)

0x4f9: PushEmpty(object, object)
0x4fa: @ FindActor(Stack[-1], Stack[-4])
0x4fb: Pop(0)
0x4fc: Pop(0); PushNull((bool) Stack[-1] == 0)
0x4fd: IF (Stack[-1] == 0) GOTO 0x500; Pop(1)

0x4fe: Stack[-5] = (bool) 0
0x4ff: Return(); Pop(2)

0x500: @ Trigger(Stack[-1], Stack[-3])
0x501: Pop(0)
0x502: Stack[-5] = (bool) 1
0x503: Return(); Pop(2)

0x504: Stack[-1] = 0
0x505: PushEmpty(string, string)
0x506: Stack[-1] = "idle" // @poff=146
0x507: Push(Stack[-3])
0x508: IF (Stack[-1] == 0) GOTO 0x50a; Pop(1)

0x509: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x50a: Stack[-1] = Stack[-4]
0x50b: Return(); Pop(2)

0x50c: PushEmpty(int, bool, int, bool)
0x50d: Stack[-2] = (int) 0
0x50e: Push("all") // @poff=138
0x50f: PushEmpty(string, int)
0x510: Stack[-5] = Stack[-1]
0x511: Call2 0x505

0x512: Pop(1)
0x513: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x514: Pop(2)
...
0x51b: Stack[-2] = Stack[-5]
0x51c: Return(); Pop(4)

0x51d: PushEmpty()
0x51e: Push("oob5GathererWife1") // @poff=537
0x51f: Push((int) 1)
0x520: @ SetVariable(Stack[-2], Stack[-1])
0x521: Pop(2)
0x522: Return(); Pop(0)

0x523: PushEmpty()
0x524: PushEmpty(int, string)
0x525: Stack[-1] = "oob5GathererWife1" // @poff=537
0x526: Call2 0x4f4
...
0x52b: Stack[-2] = (bool) 1
0x52c: Return(); Pop(0)

0x52d: Stack[-2] = (bool) 0
0x52e: Return(); Pop(0)

0x52f: PushEmpty(int, int)
0x530: Push("branch") // @poff=573
...
0x541: Push("branch") // @poff=573
0x542: @ GetVariable(Stack[-1], Stack[-2])
0x543: Pop(1)
0x544: Stack[-1] = Stack[-3]
0x545: Return(); Pop(2)
...
0x54d: @ WorkWithCorpse(Stack[-1])
0x54e: Pop(0)
0x54f: GOTO 0x552

0x550: @ Barter(Stack[-1])
0x551: Pop(0)
0x552: Return(); Pop(0)

0x553: Stack[-1] = (int) 518607
0x554: Return(); Pop(0)

0x555: Stack[-1] = (int) 518606
0x556: Return(); Pop(0)

0x557: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=587
0x558: Return(); Pop(0)

0x559: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=627
0x55a: Return(); Pop(0)
...
0x55e: @ GetScene(Stack[-1])
0x55f: Pop(0)
0x560: PushEmpty(object)
0x561: Call2 0x4dc

0x562: Pop(0)
0x563: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x564: Pop(1)
0x565: Push("b5q01NudeDead") // @poff=671
0x566: Push((bool) 1)
0x567: @ SetVariable(Stack[-2], Stack[-1])
0x568: Pop(2)
0x569: PushEmpty(bool, string, string)
0x56a: Stack[-2] = "quest_b5_01" // @poff=699
0x56b: Stack[-1] = "gwife_dead" // @poff=723
0x56c: Call2 0x4f9

0x56d: Pop(3)
0x56e: PushEmpty(object)
0x56f: Stack[-4] = Stack[-1]
0x570: Push(-1, 0); TaskCall(4)
0x571: Call2 0x30d

0x572: Pop(-1, 0); TaskReturn
0x573: Pop(1)
0x574: Return(); Pop(2)

0x575: Stack[-1] = 0
0x576: PushEmpty()
0x577: PushEmpty(object, int, float)
0x578: Stack[-7] = Stack[-3]
0x579: Stack[-6] = Stack[-2]
0x57a: Stack[-5] = Stack[-1]
0x57b: Call2 0x3e8
...
0x57e: PushEmpty()
0x57f: PushEmpty(object, int, float, cvector, cvector)
0x580: Stack[-11] = Stack[-5]
0x581: Stack[-10] = Stack[-4]
0x582: Stack[-9] = Stack[-3]
0x583: Stack[-7] = Stack[-2]
0x584: Stack[-6] = Stack[-1]
0x585: Call2 0x42c
