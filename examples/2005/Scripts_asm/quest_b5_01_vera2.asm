...
Strings:
	...
	W:b5q01VeraDead
	W:health
// @pool_raw:
// @pool_encoding:utf8
...
EVENT_43 Op = 0x613 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x61d Vars = (object, string)
...
0x1c9: Push("player") // @poff=172
0x1ca: @ FindActor(Stack[-4]T, Stack[-1])
0x1cb: Pop(1)
...
0x1de: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x233: Pop(0)
0x234: Push("all") // @poff=138
0x235: PushEmpty(string, int)
0x236: Stack[-7] = Stack[-1]
0x237: Call2 0x58e
...
0x26c: Pop(0)
0x26d: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x26e: Pop(1)
...
0x27e: Pop(0)
0x27f: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=218
0x280: Pop(0)
...
0x29d: Stack[-1] = (float) 1.7453293800354004
0x29e: Call2 0x27c

0x29f: Stack[-2] = Stack[-7]
0x2a0: Pop(2)
...
0x2a6: Stack[-1] = (float) 2.6179938316345215
0x2a7: Call2 0x27c
...
0x2ae: Push("Can't retreat, distance: ") // @poff=230
...
0x2c4: Push((int) 1)
0x2c5: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x2c6: Pop(1)
0x2c7: Push(Stack[-3])
0x2c8: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2c9: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2ce: Stack[-1] = (float) 2.6179938316345215
0x2cf: Call2 0x27c
...
0x2e1: IF (Stack[-1] == 1) GOTO 0x2c4; Pop(1)
...
0x2e8: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2f7: Stack[-1] = (float) 1.7453293800354004
0x2f8: Call2 0x27c
...
0x307: IF (Stack[-1] == 1) GOTO 0x30d; Pop(1)

0x308: PushEmpty(bool)
0x309: Call2 0x327

0x30a: Pop(0)
0x30b: IF (Stack[-1] == 1) GOTO 0x30d; Pop(1)
...
0x333: Pop(2)
0x334: Push((float)-0.3420201241970062)
...
0x351: Pop(0); PushNull((bool) Stack[-21] == 0)
0x352: IF (Stack[-1] == 0) GOTO 0x358; Pop(1)

0x353: PushEmpty(string)
0x354: Stack[-1] = "fdie" // @poff=282
0x355: Call2 0x3ab

0x356: Pop(1)
0x357: GOTO 0x3aa

0x358: @@ GetPosition(Stack[-10]); Obj=21 // @poff=218
0x359: Pop(0)
...
0x369: Stack[-6] = "fdie" // @poff=282
0x36a: GOTO 0x36c

0x36b: Stack[-6] = "bdie" // @poff=292
...
0x372: @ StopAsync()
0x373: Pop(0)
0x374: Stack[-21] = Stack[-5]
0x375: Push("GetScriptProperty") // @poff=302
0x376: Push((int) 2)
0x377: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x378: IF (Stack[-1] == 0) GOTO 0x384; Pop(1)

0x379: Push("Owner") // @poff=338
0x37a: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=350
0x37b: Pop(1)
0x37c: Push(Stack[-4])
0x37d: IF (Stack[-1] == 0) GOTO 0x384; Pop(1)

0x37e: Push("Owner") // @poff=338
0x37f: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=368
0x380: Pop(1)
0x381: Pop(0); PushNull((bool) Stack[-5] == 0)
0x382: IF (Stack[-1] == 0) GOTO 0x384; Pop(1)

0x383: Stack[-21] = Stack[-5]
0x384: Push("@GetEyesHeight") // @poff=386
0x385: Push((int) 1)
0x386: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x387: IF (Stack[-1] == 0) GOTO 0x393; Pop(1)

0x388: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x389: Pop(0)
0x38a: Stack[-1] = [0.0, 0.0, 0.0]
0x38b: Push(CvectorIndex(Stack[-1], 1))
0x38c: Stack[-3] = Stack[-1]
0x38d: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x38e: Push("head") // @poff=186
...
0x39f: @ StopAsync()
0x3a0: Pop(0)
0x3a1: Push("head") // @poff=186
0x3a2: @ UnlookAsync(Stack[-1])
0x3a3: Pop(1)
0x3a4: Push("all") // @poff=138
...
0x3b7: Stack[-2] = Stack[-1]
0x3b8: Call2 0x504

0x3b9: Pop(1)
0x3ba: Push("all") // @poff=138
...
0x3d9: Pop(0)
0x3da: @@ GetPosition(Stack[-2]); Obj=7 // @poff=218
0x3db: Pop(0)
...
0x3e8: Pop(0)
0x3e9: Stack[-1] = Stack[-4]
0x3ea: Return(); Pop(2)

0x3eb: PushEmpty(bool, bool)
0x3ec: Push("HasProperty") // @poff=430
0x3ed: Push((int) 2)
...
0x3f3: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=454
0x3f4: Pop(0)
...
0x3f9: Stack[-10] = Stack[-2]
0x3fa: Stack[-9] = Stack[-1]
0x3fb: Call2 0x3eb
...
0x401: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=466
0x402: Pop(0)
0x403: PushEmpty(float, float, float, float)
0x404: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x405: Stack[-8] = Stack[-2]
0x406: Stack[-7] = Stack[-1]
0x407: Call2 0x53d

0x408: Pop(3)
0x409: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=478
0x40a: Pop(1)
...
0x40e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x41c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=218
0x41d: Pop(0)
...
0x42d: Stack[-1] = "fhit" // @poff=490
0x42e: GOTO 0x430

0x42f: Stack[-1] = "bhit" // @poff=500
0x430: Push("hit_react") // @poff=510
0x431: Push("1") // @poff=530
0x432: Pop(1); Push(Stack[-3] + Stack[-1]);
0x433: Push("2") // @poff=534
...
0x44c: Stack[-25] = Stack[-1]
0x44d: Call2 0x3d0

0x44e: Stack[-2] = Stack[-3]
0x44f: Pop(2)
0x450: Call2 0x533
...
0x46b: Pop(0)
0x46c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=547
0x46d: Pop(0)
0x46e: PushEmpty(object, int, float, cvector, cvector)
0x46f: Stack[-26] = Stack[-5]
0x470: Stack[-25] = Stack[-4]
0x471: Stack[-24] = Stack[-3]
0x472: Stack[-6] = Stack[-2]
...
0x47f: Pop(0)
0x480: Push("scripted") // @poff=551
0x481: Push("blood_dir.xml") // @poff=569
...
0x491: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x492: Pop(0)
0x493: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=416
0x494: Pop(0)
...
0x4b9: @ StopWorld()
0x4ba: Pop(0)
0x4bb: @ CameraTransit(Stack[-3], Stack[-5])
0x4bc: Pop(0)
0x4bd: Push(CvectorIndex(Stack[-4], 0))
0x4be: Push(CvectorIndex(Stack[-5], 2))
0x4bf: @ Rotate(Stack[-2], Stack[-1])
0x4c0: Pop(2)
...
0x4c6: Push("head") // @poff=186
0x4c7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4c8: Pop(1)
0x4c9: Push(Stack[-1])
0x4ca: IF (Stack[-1] == 0) GOTO 0x4ce; Pop(1)

0x4cb: Push("head") // @poff=186
0x4cc: @ LookAsyncCamera(Stack[-1])
0x4cd: Pop(1)
0x4ce: @ CameraWaitForPlayFinish()
0x4cf: Pop(0)
0x4d0: @ ResumeWorld()
0x4d1: Pop(0)
0x4d2: Stack[-21] = (bool) 1
0x4d3: Return(); Pop(18)

0x4d4: PushEmpty(bool, bool)
0x4d5: @ CameraSwitchToNormal()
0x4d6: Pop(0)
...
0x4dc: Push("head") // @poff=186
0x4dd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4de: Pop(1)
0x4df: Push(Stack[-1])
0x4e0: IF (Stack[-1] == 0) GOTO 0x4e4; Pop(1)

0x4e1: Push("head") // @poff=186
0x4e2: @ UnlookAsync(Stack[-1])
0x4e3: Pop(1)
0x4e4: Return(); Pop(2)

0x4e5: PushEmpty(float, float, float, float)
0x4e6: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x4e7: Pop(0)
0x4e8: Push((bool) 0)
0x4e9: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x4ea: Pop(1)
0x4eb: Return(); Pop(4)

0x4ec: PushEmpty(float, float, float, float)
0x4ed: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x4ee: Pop(0)
0x4ef: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x4f0: Pop(0)
0x4f1: Return(); Pop(4)

0x4f2: PushEmpty(float, cvector, float, cvector)
0x4f3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x4f4: Pop(0)
0x4f5: Stack[-1] = [0.0, 0.0, 0.0]
0x4f6: Push(CvectorIndex(Stack[-1], 1))
0x4f7: Stack[-3] = Stack[-1]
0x4f8: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4f9: Push("head") // @poff=186
0x4fa: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x4fb: Pop(1)
0x4fc: Return(); Pop(4)
...
0x504: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x505: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x506: Pop(0)
0x507: Pop(0); Push((bool) Stack[-8] == 0)
0x508: IF (Stack[-1] == 0) GOTO 0x51d; Pop(1)

0x509: Stack[-7] = (int) 0
0x50a: Push((int) 1)
0x50b: Pop(1); Push(Stack[-8] + Stack[-1]);
0x50c: Pop(1); Push(Stack[-18] + Stack[-1]);
0x50d: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x50e: Pop(1)
0x50f: Pop(0); Push((bool) Stack[-6] == 0)
0x510: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x511: GOTO 0x515

0x512: Push((int) 1)
0x513: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x514: GOTO 0x50a

0x515: Pop(0); Push((bool) Stack[-7] == 0)
0x516: IF (Stack[-1] == 0) GOTO 0x518; Pop(1)

0x517: Return(); Pop(16)

0x518: @ irand(Stack[-5], Stack[-7])
0x519: Pop(0)
0x51a: Push((int) 1)
0x51b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x51c: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x51d: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x51e: Pop(0)
0x51f: Push(Stack[-4])
0x520: IF (Stack[-1] == 0) GOTO 0x52c; Pop(1)

0x521: @ GetEyesHeight(Stack[-3])
0x522: Pop(0)
0x523: @ GetDirection(Stack[-2])
0x524: Pop(0)
0x525: Push((int) 50)
0x526: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x527: Push(CvectorIndex(Stack[-1], 1))
0x528: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x529: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x52a: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x52b: Pop(0)
0x52c: Return(); Pop(16)
...
0x534: Pop(0); Push(Stack[-3] | Stack[-3]);
0x535: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x536: Push((float)9.999999974752427e-07)
0x537: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x538: IF (Stack[-1] == 0) GOTO 0x53b; Pop(1)

0x539: Stack[-4] = [0.0, 0.0, 0.0]
0x53a: Return(); Pop(2)

0x53b: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x53c: Return(); Pop(2)

0x53d: PushEmpty()
0x53e: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x53f: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x540: Stack[-2] = Stack[-4]
0x541: Return(); Pop(0)

0x542: Pop(0); Push((bool) Stack[-3] > Stack[-1])
...
0x548: PushEmpty()
0x549: Pop(0); Push(Stack[-2] | Stack[-1]);
0x54a: Pop(0); Push(Stack[-3] | Stack[-3]);
0x54b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x54c: Pop(2); Push(Stack[-2] * Stack[-1]);
0x54d: Pop(1); Push(Sqrt(Stack[-1]))
0x54e: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x54f: Return(); Pop(0)

0x550: PushEmpty(int, int)
0x551: @ GetVariable(Stack[-3], Stack[-1])
0x552: Pop(0)
0x553: Stack[-1] = Stack[-4]
0x554: Return(); Pop(2)

0x555: PushEmpty()
0x556: Pop(0); Push((bool) Stack[-2] == 0)
0x557: IF (Stack[-1] == 0) GOTO 0x55a; Pop(1)

0x558: Stack[-3] = (bool) 0
0x559: Return(); Pop(0)
...
0x55d: Push((int) 8)
0x55e: @ SendWorldWndMessage(Stack[-1])
0x55f: Pop(1)
0x560: GOTO 0x56a
...
0x564: Push((int) 9)
0x565: @ SendWorldWndMessage(Stack[-1])
0x566: Pop(1)
0x567: GOTO 0x56a

0x568: Stack[-3] = (bool) 0
0x569: Return(); Pop(0)

0x56a: PushEmpty(float)
0x56b: Stack[-2] = Stack[-1]
0x56c: Call2 0x578

0x56d: Pop(1)
0x56e: PushEmpty(bool, object, string, float, float, float)
0x56f: Stack[-8] = Stack[-5]
0x570: Stack[-4] = "reputation" // @poff=597
0x571: Stack[-7] = Stack[-3]
0x572: Stack[-2] = (int) 0
0x573: Stack[-1] = (int) 1
0x574: Call2 0x3f7

0x575: Pop(6)
0x576: Stack[-3] = (bool) 1
0x577: Return(); Pop(0)

0x578: PushEmpty(object, object)
0x579: @ CreateFloatVector(Stack[-1])
0x57a: Pop(0)
0x57b: @@ add(Stack[-3]); Obj=1 // @poff=538
0x57c: Pop(0)
0x57d: Push((int) 16)
0x57e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x57f: Pop(1)
0x580: Return(); Pop(2)

0x581: Stack[-1] = 0
0x582: PushEmpty(object, object)
0x583: @ FindActor(Stack[-1], Stack[-4])
0x584: Pop(0)
0x585: Pop(0); PushNull((bool) Stack[-1] == 0)
0x586: IF (Stack[-1] == 0) GOTO 0x589; Pop(1)

0x587: Stack[-5] = (bool) 0
0x588: Return(); Pop(2)

0x589: @ Trigger(Stack[-1], Stack[-3])
0x58a: Pop(0)
0x58b: Stack[-5] = (bool) 1
0x58c: Return(); Pop(2)

0x58d: Stack[-1] = 0
0x58e: PushEmpty(string, string)
0x58f: Stack[-1] = "idle" // @poff=146
0x590: Push(Stack[-3])
0x591: IF (Stack[-1] == 0) GOTO 0x593; Pop(1)

0x592: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x593: Stack[-1] = Stack[-4]
0x594: Return(); Pop(2)

0x595: PushEmpty(int, bool, int, bool)
0x596: Stack[-2] = (int) 0
0x597: Push("all") // @poff=138
...
0x5a4: Stack[-2] = Stack[-5]
0x5a5: Return(); Pop(4)

0x5a6: PushEmpty()
0x5a7: PushEmpty(bool, string, string)
0x5a8: Stack[-2] = "quest_b5_01" // @poff=619
0x5a9: Stack[-1] = "vera_retreat" // @poff=643
0x5aa: Call2 0x582
...
0x5ad: PushEmpty()
0x5ae: Push("oob5Vera2_1") // @poff=669
0x5af: Push((int) 1)
...
0x5b3: PushEmpty()
0x5b4: PushEmpty(int, string)
0x5b5: Stack[-1] = "oob5Vera2_1" // @poff=669
0x5b6: Call2 0x550

0x5b7: Pop(1)
0x5b8: Push((int) 0)
0x5b9: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x5ba: IF (Stack[-1] == 0) GOTO 0x5bd; Pop(1)

0x5bb: Stack[-2] = (bool) 1
0x5bc: Return(); Pop(0)

0x5bd: Stack[-2] = (bool) 0
0x5be: Return(); Pop(0)

0x5bf: PushEmpty(int, int)
0x5c0: Push("branch") // @poff=693
0x5c1: @ GetVariable(Stack[-1], Stack[-2])
0x5c2: Pop(1)
0x5c3: Push((int) 0)
...
0x5d1: Push("branch") // @poff=693
0x5d2: @ GetVariable(Stack[-1], Stack[-2])
0x5d3: Pop(1)
...
0x5dd: @ WorkWithCorpse(Stack[-1])
0x5de: Pop(0)
0x5df: GOTO 0x5e2

0x5e0: @ Barter(Stack[-1])
0x5e1: Pop(0)
0x5e2: Return(); Pop(0)

0x5e3: Stack[-1] = (int) 515593
0x5e4: Return(); Pop(0)

0x5e5: Stack[-1] = (int) 512582
0x5e6: Return(); Pop(0)

0x5e7: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=707
0x5e8: Return(); Pop(0)

0x5e9: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=747
0x5ea: Return(); Pop(0)
...
0x5ee: @ GetScene(Stack[-1])
0x5ef: Pop(0)
0x5f0: PushEmpty(object)
0x5f1: Call2 0x52d

0x5f2: Pop(0)
0x5f3: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x5f4: Pop(1)
...
0x5fa: PushEmpty(bool, object, float)
0x5fb: Stack[-6] = Stack[-2]
0x5fc: Stack[-1] = (float) -0.10000000149011612
0x5fd: Call2 0x555

0x5fe: Pop(3)
0x5ff: Push("b5q01VeraDead") // @poff=791
0x600: Push((bool) 1)
0x601: @ SetVariable(Stack[-2], Stack[-1])
0x602: Pop(2)
0x603: PushEmpty(object)
0x604: Stack[-4] = Stack[-1]
0x605: Push(-1, 0); TaskCall(4)
0x606: Call2 0x337

0x607: Pop(-1, 0); TaskReturn
0x608: Pop(1)
0x609: Return(); Pop(2)
...
0x613: PushEmpty()
0x614: PushEmpty(object, int, float, cvector, cvector)
0x615: Stack[-11] = Stack[-5]
0x616: Stack[-10] = Stack[-4]
0x617: Stack[-9] = Stack[-3]
0x618: Stack[-7] = Stack[-2]
0x619: Stack[-6] = Stack[-1]
0x61a: Call2 0x47d

0x61b: Pop(5)
0x61c: Return(); Pop(0)

0x61d: PushEmpty(float, float)
0x61e: Push("health") // @poff=819
0x61f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x620: IF (Stack[-1] == 0) GOTO 0x629; Pop(1)

0x621: Push("health") // @poff=819
0x622: @ GetProperty(Stack[-1], Stack[-2])
0x623: Pop(1)
0x624: Push((int) 0)
0x625: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x626: IF (Stack[-1] == 0) GOTO 0x629; Pop(1)

0x627: @ SignalDeath(Stack[-4])
0x628: Pop(0)
0x629: Return(); Pop(2)
