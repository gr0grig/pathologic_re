...
// @pool_raw:
// @pool_encoding:utf8
...
0x32a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=375
0x32b: Pop(0)
0x32c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=387
0x32d: Pop(0)
...
0x3af: Pop(0)
0x3b0: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3cf: Stack[-2] = Stack[-5]
0x3d0: Return(); Pop(4)

0x3d1: PushEmpty()
0x3d2: Push("oob6Morlok1") // @poff=411
0x3d3: Push((int) 1)
...
0x3d7: PushEmpty()
0x3d8: Push((int) 1)
0x3d9: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=435
0x3da: Pop(1)
0x3db: Return(); Pop(0)
...
0x3ed: Stack[-1] = "oob6Morlok1" // @poff=411
0x3ee: Call2 0x3a8
...
0x404: Push((int) 4)
0x405: @@ GetItemCount(Stack[-7], Stack[-1]); Obj=14 // @poff=156
0x406: Pop(1)
0x407: Stack[-5] = (int) 0
...
0x40a: Push((int) 4)
0x40b: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=14 // @poff=169
0x40c: Pop(1)
0x40d: @@ GetItemID(Stack[-3]); Obj=4 // @poff=177
0x40e: Pop(0)
0x40f: Push("Microscope") // @poff=187
...
0x415: Push("Microscope") // @poff=187
...
0x442: Push("Can't retrieve diary root") // @poff=450
0x443: @ Trace(Stack[-1])
0x444: Pop(1)
0x445: Stack[-3] = (bool) 0
0x446: Return(); Pop(2)

0x447: Stack[-1] = Stack[-3]
0x448: Return(); Pop(2)
...
0x44e: Pop(1)
0x44f: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=502
0x450: Pop(0)
0x451: Pop(0); Push((bool) Stack[-2] == 0)
0x452: IF (Stack[-1] == 0) GOTO 0x459; Pop(1)

0x453: Push("Can't find diary parent with id: ") // @poff=507
...
0x459: @@ AddChild(Stack[-8]); Obj=2 // @poff=575
0x45a: Pop(0)
0x45b: Push((int) 7)
0x45c: @ SendWorldWndMessage(Stack[-1])
0x45d: Pop(1)
0x45e: @@ GetCategory(Stack[-1]); Obj=8 // @poff=584
0x45f: Pop(0)
...
0x47b: Stack[-1] = "ui/NPC_Black.png" // @poff=610
0x47c: Return(); Pop(0)

0x47d: Stack[-1] = "ui/NPC_Black_b.png" // @poff=644
0x47e: Return(); Pop(0)
