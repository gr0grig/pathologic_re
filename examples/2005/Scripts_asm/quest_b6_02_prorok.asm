...
// @pool_raw:
// @pool_encoding:utf8
...
0x1e4: Pop(0)
0x1e5: Push("all") // @poff=138
0x1e6: PushEmpty(string, int)
0x1e7: Stack[-7] = Stack[-1]
0x1e8: Call2 0x29b
...
0x21e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x21f: Pop(0)
0x220: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x221: Pop(0)
...
0x246: @ StopWorld()
0x247: Pop(0)
0x248: @ CameraTransit(Stack[-3], Stack[-5])
0x249: Pop(0)
0x24a: Push(CvectorIndex(Stack[-4], 0))
0x24b: Push(CvectorIndex(Stack[-5], 2))
0x24c: @ Rotate(Stack[-2], Stack[-1])
0x24d: Pop(2)
...
0x254: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x255: Pop(1)
0x256: Push(Stack[-1])
0x257: IF (Stack[-1] == 0) GOTO 0x25b; Pop(1)

0x258: Push("head") // @poff=198
0x259: @ LookAsyncCamera(Stack[-1])
0x25a: Pop(1)
0x25b: @ CameraWaitForPlayFinish()
0x25c: Pop(0)
0x25d: @ ResumeWorld()
0x25e: Pop(0)
0x25f: Stack[-21] = (bool) 1
0x260: Return(); Pop(18)

0x261: PushEmpty(bool, bool)
0x262: @ CameraSwitchToNormal()
0x263: Pop(0)
...
0x28d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x28e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x28f: Push((float)9.999999974752427e-07)
0x290: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x291: IF (Stack[-1] == 0) GOTO 0x294; Pop(1)

0x292: Stack[-4] = [0.0, 0.0, 0.0]
0x293: Return(); Pop(2)

0x294: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x295: Return(); Pop(2)

0x296: PushEmpty(int, int)
0x297: @ GetVariable(Stack[-3], Stack[-1])
0x298: Pop(0)
0x299: Stack[-1] = Stack[-4]
0x29a: Return(); Pop(2)

0x29b: PushEmpty(string, string)
0x29c: Stack[-1] = "idle" // @poff=146
0x29d: Push(Stack[-3])
0x29e: IF (Stack[-1] == 0) GOTO 0x2a0; Pop(1)

0x29f: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2a0: Stack[-1] = Stack[-4]
0x2a1: Return(); Pop(2)

0x2a2: PushEmpty(int, bool, int, bool)
0x2a3: Stack[-2] = (int) 0
0x2a4: Push("all") // @poff=138
0x2a5: PushEmpty(string, int)
0x2a6: Stack[-5] = Stack[-1]
0x2a7: Call2 0x29b

0x2a8: Pop(1)
0x2a9: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2aa: Pop(2)
...
0x2ae: Push((int) 1)
0x2af: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2b0: GOTO 0x2a4
...
0x2bc: PushEmpty()
0x2bd: Push("oob6Prophet1") // @poff=220
0x2be: Push((int) 1)
...
0x2c4: Stack[-1] = "oob6Prophet1" // @poff=220
0x2c5: Call2 0x296
...
0x2cf: Push((int) 268)
0x2d0: Push((int) 2)
0x2d1: Push((int) 521195)
0x2d2: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2d3: Pop(3)
0x2d4: PushEmpty(bool, object, int)
0x2d5: Stack[-4] = Stack[-2]
0x2d6: Stack[-1] = (int) 266
0x2d7: Call2 0x2e8
...
0x2dc: @ GetDiaryRoot(Stack[-1])
0x2dd: Pop(0)
0x2de: Pop(0); Push((bool) Stack[-1] == 0)
0x2df: IF (Stack[-1] == 0) GOTO 0x2e5; Pop(1)

0x2e0: Push("Can't retrieve diary root") // @poff=246
0x2e1: @ Trace(Stack[-1])
0x2e2: Pop(1)
0x2e3: Stack[-3] = (bool) 0
0x2e4: Return(); Pop(2)
...
0x2e7: Stack[-1] = 0
0x2e8: PushEmpty(object, object, int, object, object, int)
0x2e9: PushEmpty(object)
0x2ea: Call2 0x2db

0x2eb: Stack[-1] = Stack[-4]
0x2ec: Pop(1)
0x2ed: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=298
0x2ee: Pop(0)
0x2ef: Pop(0); Push((bool) Stack[-2] == 0)
0x2f0: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f1: Push("Can't find diary parent with id: ") // @poff=303
0x2f2: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2f3: @ Trace(Stack[-1])
0x2f4: Pop(1)
0x2f5: Stack[-9] = (bool) 0
0x2f6: Return(); Pop(6)

0x2f7: @@ AddChild(Stack[-8]); Obj=2 // @poff=371
0x2f8: Pop(0)
0x2f9: Push((int) 7)
0x2fa: @ SendWorldWndMessage(Stack[-1])
0x2fb: Pop(1)
0x2fc: @@ GetCategory(Stack[-1]); Obj=8 // @poff=380
0x2fd: Pop(0)
0x2fe: @ SetDiarySection(Stack[-1])
0x2ff: Pop(0)
0x300: Stack[-9] = (bool) 0
0x301: Return(); Pop(6)

0x302: Stack[-2] = 0
0x303: Stack[-3] = 0
0x304: PushEmpty(int, int)
0x305: Push("branch") // @poff=392
...
0x315: Stack[-1] = (int) 518716
0x316: Return(); Pop(0)

0x317: Stack[-1] = (int) 518715
0x318: Return(); Pop(0)

0x319: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=406
0x31a: Return(); Pop(0)

0x31b: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=446
0x31c: Return(); Pop(0)
