...
Strings:
	...
	W:all
	A:GetPFPosition
	W:Can't find path to noise source
	W:new hunt point
	W:attack_begin
	W:attack_end
	W:attack
	...
	A:in
	W:disease
// @pool_raw:
...
Events:
EVENT_22 Op = 0x7e8 Vars = (object, int, float, float)
EVENT_43 Op = 0x7f0 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x810 Vars = (object, string)
EVENT_41 Op = 0x81d Vars = (object)
EVENT_6 Op = 0x88a Vars = ()
...
0x56: Pop(0)
0x57: Push((float)0.10000000149011612)
...
0x80: Stack[-7] = Stack[-1]
0x81: Call2 0xb3

0x82: Stack[-2] = Stack[-4]
0x83: Pop(2)
...
0xe3: Pop(0); PushNull((bool) Stack[-21] == 0)
0xe4: IF (Stack[-1] == 0) GOTO 0xea; Pop(1)

0xe5: PushEmpty(string)
0xe6: Stack[-1] = "fdie" // @poff=0
0xe7: Call2 0x13d

0xe8: Pop(1)
0xe9: GOTO 0x13c

0xea: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0xeb: Pop(0)
...
0xfb: Stack[-6] = "fdie" // @poff=0
0xfc: GOTO 0xfe

0xfd: Stack[-6] = "bdie" // @poff=22
...
0x104: @ StopAsync()
0x105: Pop(0)
0x106: Stack[-21] = Stack[-5]
0x107: Push("GetScriptProperty") // @poff=32
0x108: Push((int) 2)
0x109: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x10a: IF (Stack[-1] == 0) GOTO 0x116; Pop(1)

0x10b: Push("Owner") // @poff=68
0x10c: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x10d: Pop(1)
0x10e: Push(Stack[-4])
0x10f: IF (Stack[-1] == 0) GOTO 0x116; Pop(1)

0x110: Push("Owner") // @poff=68
0x111: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x112: Pop(1)
0x113: Pop(0); PushNull((bool) Stack[-5] == 0)
0x114: IF (Stack[-1] == 0) GOTO 0x116; Pop(1)

0x115: Stack[-21] = Stack[-5]
0x116: Push("@GetEyesHeight") // @poff=116
0x117: Push((int) 1)
0x118: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x119: IF (Stack[-1] == 0) GOTO 0x125; Pop(1)

0x11a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x11b: Pop(0)
0x11c: Stack[-1] = [0.0, 0.0, 0.0]
0x11d: Push(CvectorIndex(Stack[-1], 1))
0x11e: Stack[-3] = Stack[-1]
0x11f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x120: Push("head") // @poff=160
...
0x127: Stack[-7] = Stack[-1]
0x128: Call2 0x5df

0x129: Pop(1)
0x12a: Push("all") // @poff=170
...
0x131: @ StopAsync()
0x132: Pop(0)
0x133: Push("head") // @poff=160
0x134: @ UnlookAsync(Stack[-1])
0x135: Pop(1)
0x136: Push("all") // @poff=170
...
0x17d: Stack[-6] = Stack[-2]
0x17e: Stack[-5] = Stack[-1]
0x17f: Call2 0x823
...
0x1ad: Pop(1)
0x1ae: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x1af: Pop(0)
0x1b0: Push((int) 61)
0x1b1: Push((float)0.5)
0x1b2: @ SetTimer(Stack[-2], Stack[-1])
0x1b3: Pop(2)
0x1b4: @ FindPathTo(Stack[-2]T, Stack[-0]T)
0x1b5: Pop(0)
0x1b6: Pop(0); PushNull((bool) Stack[2 + Tasks[-1].StackPointer] == 0)
0x1b7: IF (Stack[-1] == 0) GOTO 0x1bc; Pop(1)

0x1b8: Push("Can't find path to noise source") // @poff=192
0x1b9: @ Trace(Stack[-1])
0x1ba: Pop(1)
0x1bb: GOTO 0x1dd

0x1bc: @ FollowPath(Stack[-2]T, Stack[-3], Stack[-1])
0x1bd: Pop(0)
0x1be: Pop(0); Push((bool) Stack[-1] == 0)
0x1bf: IF (Stack[-1] == 0) GOTO 0x1c4; Pop(1)

0x1c0: Pop(0); PushNull((bool) Stack[2 + Tasks[-1].StackPointer] == 0)
...
0x1d9: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x1da: Pop(0)
0x1db: Pop(0); Push(( Stack[2 + Tasks[-1].StackPointer] != 0 )
0x1dc: IF (Stack[-1] == 1) GOTO 0x1b4; Pop(1)
...
0x20a: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x20b: Pop(0)
0x20c: Push("new hunt point") // @poff=256
0x20d: @ Trace(Stack[-1])
0x20e: Pop(1)
0x20f: @ Stop()
0x210: Pop(0)
...
0x2ad: @ CanSee(Stack[-1]T, Stack[-23])
0x2ae: Pop(0)
0x2af: PushEmpty(bool, object)
0x2b0: Stack[-25] = Stack[-1]
0x2b1: Call2 0x52e

0x2b2: Pop(2)
0x2b3: PushEmpty(bool, object)
0x2b4: Stack[-25] = Stack[-1]
0x2b5: Call2 0x50c
...
0x2ca: Pop(1)
0x2cb: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x2cc: IF (Stack[-1] == 0) GOTO 0x2ce; Pop(1)

0x2cd: GOTO 0x366

0x2ce: @ CanSee(Stack[-1]T, Stack[-0]T)
0x2cf: Pop(0)
0x2d0: @ Face(Stack[-0]T)
0x2d1: Pop(0)
...
0x2d5: Pop(1)
0x2d6: @ ReportAttack(Stack[-0]T)
0x2d7: Pop(0)
0x2d8: @ GetPosition(Stack[-11])
0x2d9: Pop(0)
0x2da: @@@ GetPosition(Stack[-10]); Obj=0 // @poff=10
0x2db: Pop(0)
...
0x2e1: Stack[-2] = Stack[-10]
0x2e2: Pop(2)
0x2e3: Push("all") // @poff=170
0x2e4: Push("attack_begin") // @poff=286
0x2e5: Pop(1); Push(Stack[-1] + Stack[-10]);
0x2e6: @ PlayAnimation(Stack[-2], Stack[-1])
0x2e7: Pop(2)
0x2e8: @ WaitForAnimEnd()
0x2e9: Pop(0)
0x2ea: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x2eb: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)

0x2ec: GOTO 0x366

0x2ed: Push("all") // @poff=170
0x2ee: Push("attack_end") // @poff=312
0x2ef: Pop(1); Push(Stack[-1] + Stack[-10]);
0x2f0: @ PlayAnimation(Stack[-2], Stack[-1])
0x2f1: Pop(2)
0x2f2: @ GetScene(Stack[-7])
0x2f3: Pop(0)
0x2f4: Push("attack") // @poff=334
0x2f5: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2f6: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-12], Stack[-7])
0x2f7: Pop(1)
0x2f8: Push("scripted") // @poff=348
0x2f9: Push([0.0, 0.0, 1.0])
0x2fa: Push("grenade.xml") // @poff=366
0x2fb: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-14], Stack[-2], Stack[-1])
0x2fc: Pop(3)
0x2fd: Push("Owner") // @poff=68
0x2fe: PushEmpty(object)
0x2ff: Call2 0x65f

0x300: Pop(0)
0x301: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x302: Pop(2)
0x303: Push((int) 1)
0x304: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x305: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x306: Push("StartVelocity") // @poff=408
0x307: Push([0.0, -500.0, 0.0])
0x308: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x309: Pop(2)
0x30a: GOTO 0x33d
...
0x321: @@@ GetPosition(Stack[-10]); Obj=0 // @poff=10
0x322: Pop(0)
0x323: PushEmpty(float, cvector, cvector, cvector)
0x324: Stack[-15] = Stack[-3]
0x325: Stack[-14] = Stack[-2]
0x326: Stack[-10] = Stack[-1]
0x327: Call2 0x76a

0x328: Stack[-4] = Stack[-6]
0x329: Pop(4)
0x32a: Push((int) 0)
...
0x334: Stack[-11] = Stack[-2]
0x335: Stack[-5] = Stack[-1]
0x336: Call2 0x7ac

0x337: Stack[-3] = Stack[-5]
0x338: Pop(3)
0x339: Push("StartVelocity") // @poff=408
0x33a: Pop(0); Push(Stack[-7] * Stack[-3]);
0x33b: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x33c: Pop(2)
0x33d: Push("DamageAmount") // @poff=436
0x33e: Push((float)0.800000011920929)
0x33f: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x340: Pop(2)
0x341: Push("DamageType") // @poff=462
0x342: Push((int) 2)
0x343: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x344: Pop(2)
...
0x356: Pop(1)
0x357: Push("all") // @poff=170
0x358: Push("scream") // @poff=484
0x359: Push((int) 1)
...
0x39f: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3ad: @ GetSeeThreshold(Stack[-0]T)
0x3ae: Pop(0)
0x3af: @ GetSeeFOV(Stack[-1]T)
0x3b0: Pop(0)
0x3b1: Push((float)1.5)
0x3b2: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x3be: Push((float)1.7999999523162842)
0x3bf: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[-1]);
0x3c0: @ SetSeeFOV(Stack[-1])
0x3c1: Pop(1)
0x3c2: Push("all") // @poff=170
0x3c3: Push("hunt") // @poff=498
0x3c4: @ PlayAnimation(Stack[-2], Stack[-1])
0x3c5: Pop(2)
0x3c6: @ WaitForAnimEnd(Stack[-2])
0x3c7: Pop(0)
0x3c8: @ SetSeeFOV(Stack[-1]T)
0x3c9: Pop(0)
...
0x3f1: @ IsPlayerActor(Stack[-2]T, Stack[-1])
0x3f2: Pop(0)
0x3f3: Push(Stack[-1])
...
0x41c: @ SetSeeThreshold(Stack[-0]T)
0x41d: Pop(0)
0x41e: @ SetSeeFOV(Stack[-1]T)
0x41f: Pop(0)
0x420: @ Stop()
0x421: Pop(0)
0x422: @ StopGroup0()
...
0x45d: Stack[-6] = Stack[-2]
0x45e: Stack[-5] = Stack[-1]
0x45f: Call2 0x823
...
0x482: @ rand(Stack[-2])
0x483: Pop(0)
0x484: Push((float)0.30000001192092896)
0x485: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x486: IF (Stack[-1] == 0) GOTO 0x491; Pop(1)

0x487: Push("all") // @poff=170
0x488: Push("hunt") // @poff=498
...
0x4af: Pop(0)
0x4b0: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x4b1: Pop(0)
...
0x4b6: Pop(0)
0x4b7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x4b8: Pop(0)
...
0x4c2: Push("HasProperty") // @poff=508
0x4c3: Push((int) 2)
...
0x4c9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=532
0x4ca: Pop(0)
0x4cb: Stack[-1] = Stack[-5]
0x4cc: Return(); Pop(2)

0x4cd: PushEmpty(float, float)
0x4ce: PushEmpty(bool, object, string)
0x4cf: Stack[-10] = Stack[-2]
0x4d0: Stack[-9] = Stack[-1]
0x4d1: Call2 0x4c1
...
0x4d7: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=544
0x4d8: Pop(0)
0x4d9: PushEmpty(float, float, float, float)
0x4da: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4db: Stack[-8] = Stack[-2]
0x4dc: Stack[-7] = Stack[-1]
0x4dd: Call2 0x66f

0x4de: Pop(3)
0x4df: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=556
0x4e0: Pop(1)
0x4e1: Stack[-8] = (bool) 1
0x4e2: Return(); Pop(2)

0x4e3: PushEmpty(bool, bool)
0x4e4: @@ IsDead(Stack[-1]); Obj=3 // @poff=568
0x4e5: Pop(0)
0x4e6: Stack[-1] = Stack[-4]
0x4e7: Return(); Pop(2)

0x4e8: PushEmpty(object, object, object, object)
0x4e9: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4fd: Pop(0)
0x4fe: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4ff: IF (Stack[-1] == 0) GOTO 0x502; Pop(1)

0x500: Stack[-6] = (bool) 0
0x501: Return(); Pop(4)

0x502: @@ GetScene(Stack[-1]); Obj=5 // @poff=589
0x503: Pop(0)
...
0x516: Stack[-6] = Stack[-2]
0x517: Stack[-1] = "noaccess" // @poff=598
0x518: Call2 0x4c1
...
0x51e: Push("noaccess") // @poff=598
0x51f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x520: Pop(1)
0x521: Push((int) 0)
...
0x52f: @@ GetPosition(Stack[-1]); Obj=3 // @poff=10
0x530: Pop(0)
...
0x538: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x546: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x547: Pop(0)
...
0x557: Stack[-1] = "fhit" // @poff=616
0x558: GOTO 0x55a

0x559: Stack[-1] = "bhit" // @poff=626
0x55a: Push("hit_react") // @poff=636
0x55b: Push("1") // @poff=656
0x55c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x55d: Push("2") // @poff=660
...
0x57b: Stack[-2] = Stack[-11]
0x57c: Pop(2)
0x57d: @ CreateVectorVector(Stack[-8])
0x57e: Pop(0)
0x57f: Stack[-7] = (int) 1
0x580: Push("hit") // @poff=618
...
0x595: Pop(0)
0x596: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=673
0x597: Pop(0)
0x598: PushEmpty(object, int, float, cvector, cvector)
0x599: Stack[-26] = Stack[-5]
0x59a: Stack[-25] = Stack[-4]
0x59b: Stack[-24] = Stack[-3]
0x59c: Stack[-6] = Stack[-2]
...
0x5bb: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x5bc: Pop(0)
0x5bd: Stack[-1] = [0.0, 0.0, 0.0]
0x5be: Push(CvectorIndex(Stack[-1], 1))
0x5bf: Stack[-3] = Stack[-1]
0x5c0: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x5c1: Push("head") // @poff=160
...
0x5c7: Stack[-7] = Stack[-2]
0x5c8: Stack[-6] = Stack[-1]
0x5c9: Call2 0x67a
...
0x619: Stack[-1] = (bool) 1
0x61a: PushEmpty(bool)
0x61b: Stack[-1] = (bool) 1
0x61c: PushEmpty(bool)
0x61d: Stack[-1] = (bool) 1
0x61e: PushEmpty(bool)
0x61f: Stack[-1] = (bool) 1
0x620: Push("woman") // @poff=705
0x621: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x622: IF (Stack[-1] == 1) GOTO 0x627; Pop(1)

0x623: Push("worker") // @poff=717
0x624: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x625: IF (Stack[-1] == 1) GOTO 0x627; Pop(1)

0x626: Stack[-1] = (bool) 0
0x627: IF (Stack[-1] == 1) GOTO 0x62c; Pop(1)

0x628: Push("butcher") // @poff=731
0x629: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x62a: IF (Stack[-1] == 1) GOTO 0x62c; Pop(1)

0x62b: Stack[-1] = (bool) 0
0x62c: IF (Stack[-1] == 1) GOTO 0x631; Pop(1)

0x62d: Push("wasted_girl") // @poff=747
0x62e: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x62f: IF (Stack[-1] == 1) GOTO 0x631; Pop(1)

0x630: Stack[-1] = (bool) 0
0x631: IF (Stack[-1] == 1) GOTO 0x636; Pop(1)

0x632: Push("boy") // @poff=771
0x633: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x634: IF (Stack[-1] == 1) GOTO 0x636; Pop(1)

0x635: Stack[-1] = (bool) 0
0x636: IF (Stack[-1] == 1) GOTO 0x63b; Pop(1)

0x637: Push("vaxxabitka") // @poff=779
0x638: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x639: IF (Stack[-1] == 1) GOTO 0x63b; Pop(1)

0x63a: Stack[-1] = (bool) 0
0x63b: IF (Stack[-1] == 1) GOTO 0x640; Pop(1)

0x63c: Push("unosha") // @poff=801
0x63d: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x63e: IF (Stack[-1] == 1) GOTO 0x640; Pop(1)

0x63f: Stack[-1] = (bool) 0
0x640: IF (Stack[-1] == 1) GOTO 0x645; Pop(1)

0x641: Push("wasted_male") // @poff=815
0x642: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x643: IF (Stack[-1] == 1) GOTO 0x645; Pop(1)

0x644: Stack[-1] = (bool) 0
0x645: IF (Stack[-1] == 1) GOTO 0x64a; Pop(1)

0x646: Push("alkash") // @poff=839
0x647: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x648: IF (Stack[-1] == 1) GOTO 0x64a; Pop(1)

0x649: Stack[-1] = (bool) 0
0x64a: IF (Stack[-1] == 1) GOTO 0x64f; Pop(1)

0x64b: Push("dohodyaga") // @poff=853
0x64c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x64d: IF (Stack[-1] == 1) GOTO 0x64f; Pop(1)

0x64e: Stack[-1] = (bool) 0
0x64f: IF (Stack[-1] == 1) GOTO 0x654; Pop(1)

0x650: Push("vaxxabit") // @poff=873
0x651: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x652: IF (Stack[-1] == 1) GOTO 0x654; Pop(1)

0x653: Stack[-1] = (bool) 0
0x654: IF (Stack[-1] == 1) GOTO 0x659; Pop(1)

0x655: Push("nudegirl") // @poff=891
0x656: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x657: IF (Stack[-1] == 1) GOTO 0x659; Pop(1)

0x658: Stack[-1] = (bool) 0
0x659: IF (Stack[-1] == 1) GOTO 0x65e; Pop(1)

0x65a: Push("morlok") // @poff=909
0x65b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x65c: IF (Stack[-1] == 1) GOTO 0x65e; Pop(1)
...
0x660: @ self(Stack[-1])
0x661: Pop(0)
0x662: Stack[-1] = Stack[-3]
0x663: Return(); Pop(2)

0x664: Stack[-1] = 0
0x665: PushEmpty(float, float)
0x666: Pop(0); Push(Stack[-3] | Stack[-3]);
0x667: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x668: Push((float)9.999999974752427e-07)
0x669: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x66a: IF (Stack[-1] == 0) GOTO 0x66d; Pop(1)

0x66b: Stack[-4] = [0.0, 0.0, 0.0]
0x66c: Return(); Pop(2)

0x66d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x66e: Return(); Pop(2)

0x66f: PushEmpty()
0x670: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x671: IF (Stack[-1] == 0) GOTO 0x674; Pop(1)

0x672: Stack[-2] = Stack[-4]
0x673: Return(); Pop(0)

0x674: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x675: IF (Stack[-1] == 0) GOTO 0x678; Pop(1)

0x676: Stack[-1] = Stack[-4]
0x677: Return(); Pop(0)

0x678: Stack[-3] = Stack[-4]
0x679: Return(); Pop(0)

0x67a: PushEmpty(int, int)
0x67b: @ irand(Stack[-1], Stack[-3])
0x67c: Pop(0)
0x67d: Stack[-5] = Stack[-1] < Stack[-4]; Pop(0);
0x67e: Return(); Pop(2)

0x67f: PushEmpty(object, object)
0x680: @ CreateObjectSet(Stack[-1])
0x681: Pop(0)
0x682: Stack[-1] = Stack[-3]
0x683: Return(); Pop(2)

0x684: Stack[-1] = 0
0x685: PushEmpty()
0x686: Pop(0); Push((bool) Stack[-2] == 0)
...
0x68d: Push((int) 8)
0x68e: @ SendWorldWndMessage(Stack[-1])
0x68f: Pop(1)
0x690: GOTO 0x69a
...
0x694: Push((int) 9)
0x695: @ SendWorldWndMessage(Stack[-1])
0x696: Pop(1)
0x697: GOTO 0x69a

0x698: Stack[-3] = (bool) 0
0x699: Return(); Pop(0)

0x69a: PushEmpty(float)
0x69b: Stack[-2] = Stack[-1]
0x69c: Call2 0x6a8

0x69d: Pop(1)
0x69e: PushEmpty(bool, object, string, float, float, float)
0x69f: Stack[-8] = Stack[-5]
0x6a0: Stack[-4] = "reputation" // @poff=923
0x6a1: Stack[-7] = Stack[-3]
0x6a2: Stack[-2] = (int) 0
0x6a3: Stack[-1] = (int) 1
0x6a4: Call2 0x4cd

0x6a5: Pop(6)
0x6a6: Stack[-3] = (bool) 1
0x6a7: Return(); Pop(0)

0x6a8: PushEmpty(object, object)
0x6a9: @ CreateFloatVector(Stack[-1])
0x6aa: Pop(0)
0x6ab: @@ add(Stack[-3]); Obj=1 // @poff=664
0x6ac: Pop(0)
0x6ad: Push((int) 16)
0x6ae: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6af: Pop(1)
0x6b0: Return(); Pop(2)

0x6b1: Stack[-1] = 0
0x6b2: PushEmpty(bool, bool)
0x6b3: @ IsPlayerActor(Stack[-3], Stack[-1])
0x6b4: Pop(0)
0x6b5: Push(Stack[-1])
0x6b6: IF (Stack[-1] == 0) GOTO 0x6ba; Pop(1)

0x6b7: Push("attack") // @poff=334
0x6b8: @ PlayGlobalMusic(Stack[-1])
0x6b9: Pop(1)
0x6ba: Return(); Pop(2)

0x6bb: PushEmpty(string, string)
0x6bc: Stack[-1] = "idle" // @poff=945
0x6bd: Push(Stack[-3])
0x6be: IF (Stack[-1] == 0) GOTO 0x6c0; Pop(1)

0x6bf: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x6c0: Stack[-1] = Stack[-4]
0x6c1: Return(); Pop(2)

0x6c2: PushEmpty(int, bool, int, bool)
0x6c3: Stack[-2] = (int) 0
0x6c4: Push("all") // @poff=170
0x6c5: PushEmpty(string, int)
0x6c6: Stack[-5] = Stack[-1]
0x6c7: Call2 0x6bb

0x6c8: Pop(1)
0x6c9: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6ca: Pop(2)
0x6cb: Pop(0); Push((bool) Stack[-1] == 0)
0x6cc: IF (Stack[-1] == 0) GOTO 0x6ce; Pop(1)

0x6cd: GOTO 0x6d1

0x6ce: Push((int) 1)
0x6cf: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6d0: GOTO 0x6c4

0x6d1: Stack[-2] = Stack[-5]
0x6d2: Return(); Pop(4)

0x6d3: PushEmpty(int, int)
0x6d4: Push("branch") // @poff=955
0x6d5: @ GetVariable(Stack[-1], Stack[-2])
0x6d6: Pop(1)
0x6d7: Stack[-1] = Stack[-3]
0x6d8: Return(); Pop(2)
...
0x6dc: Pop(0)
0x6dd: Push((int) 1)
0x6de: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x6df: IF (Stack[-1] == 0) GOTO 0x6e3; Pop(1)

0x6e0: @ WorkWithCorpse(Stack[-1])
0x6e1: Pop(0)
0x6e2: GOTO 0x6e5

0x6e3: @ Barter(Stack[-1])
0x6e4: Pop(0)
0x6e5: Return(); Pop(0)

0x6e6: PushEmpty(int, bool, int, bool)
0x6e7: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x6e8: IF (Stack[-1] == 0) GOTO 0x6ed; Pop(1)

0x6e9: Push("GenerateMoney: iMin > iMax") // @poff=969
0x6ea: @ Trace(Stack[-1])
0x6eb: Pop(1)
0x6ec: Return(); Pop(4)

0x6ed: Stack[-2] = (int) 0
0x6ee: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x6ef: IF (Stack[-1] == 0) GOTO 0x6f4; Pop(1)

0x6f0: Pop(0); Push(Stack[-5] - Stack[-6]);
0x6f1: @ irand(Stack[-3], Stack[-1])
0x6f2: Pop(1)
0x6f3: GOTO 0x6f8

0x6f4: Push((int) 0)
0x6f5: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6f6: IF (Stack[-1] == 0) GOTO 0x6f8; Pop(1)

0x6f7: Return(); Pop(4)

0x6f8: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x6f9: Push((int) 0)
...
0x6fe: Stack[-1] = "Money" // @poff=1023
0x6ff: Call2 0x753

0x700: Pop(1)
0x701: Push((int) 0)
0x702: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x703: Pop(2)
0x704: Return(); Pop(4)

0x705: PushEmpty(object, int, bool, object, int, bool)
0x706: @ CreateInvItem(Stack[-3])
0x707: Pop(0)
0x708: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1035
0x709: Pop(0)
0x70a: Push("Organ") // @poff=1047
0x70b: Push((int) 1)
0x70c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x70d: Pop(2)
0x70e: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1059
0x70f: Pop(0)
0x710: Push((int) 0)
0x711: Push((int) 1)
0x712: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x713: Pop(2)
0x714: Return(); Pop(6)
...
0x71e: Stack[-1] = "liver" // @poff=1069
0x71f: Call2 0x705

0x720: Pop(1)
0x721: PushEmpty(string)
0x722: Stack[-1] = "kidney" // @poff=1081
0x723: Call2 0x705

0x724: Pop(1)
0x725: PushEmpty(string)
0x726: Stack[-1] = "heart" // @poff=1095
0x727: Call2 0x705

0x728: Pop(1)
0x729: PushEmpty(string)
0x72a: Stack[-1] = "blood" // @poff=1107
0x72b: Call2 0x705

0x72c: Pop(1)
0x72d: Return(); Pop(0)

0x72e: PushEmpty(int, bool, int, bool)
0x72f: Push((int) 0)
0x730: @ ClearSubContainer(Stack[-1])
0x731: Pop(1)
0x732: PushEmpty(int, int)
0x733: Stack[-2] = (int) 600
0x734: Stack[-1] = (int) 1500
0x735: Call2 0x6e6

0x736: Pop(2)
0x737: PushEmpty(string, int, int)
0x738: Stack[-3] = "fresh_meat" // @poff=1119
0x739: Stack[-2] = (int) 1
0x73a: Stack[-1] = (int) 6
0x73b: Call2 0x5c5

0x73c: Pop(3)
0x73d: PushEmpty(string, int, int, int)
0x73e: Stack[-4] = "rusk" // @poff=1141
0x73f: Stack[-3] = (int) 1
0x740: Stack[-2] = (int) 6
0x741: Stack[-1] = (int) 2
0x742: Call2 0x5d0
...
0x743: Pop(4)
0x744: PushEmpty(string, int, int)
0x745: Stack[-3] = "gamma_pills" // @poff=1151
0x746: Stack[-2] = (int) 1
0x747: Stack[-1] = (int) 3
0x748: Call2 0x5c5
...
0x74b: Stack[-1] = "bomber_mark" // @poff=1175
0x74c: Call2 0x753
...
0x753: PushEmpty(int, int)
0x754: @ GetInvItemByName(Stack[-1], Stack[-3])
0x755: Pop(0)
0x756: Stack[-1] = Stack[-4]
0x757: Return(); Pop(2)

0x758: PushEmpty(string, string, string, string)
0x759: PushEmpty(bool, object, string)
0x75a: Stack[-8] = Stack[-2]
0x75b: Stack[-1] = "class" // @poff=1199
0x75c: Call2 0x4c1
...
0x760: Stack[-6] = (bool) 0
0x761: Return(); Pop(4)

0x762: Push("class") // @poff=1199
0x763: @ GetProperty(Stack[-1], Stack[-3])
0x764: Pop(1)
0x765: Push("class") // @poff=1199
0x766: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x767: Pop(1)
0x768: Stack[-6] = Stack[-1] == Stack[-2]; Pop(0);
0x769: Return(); Pop(4)

0x76a: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x76b: Push(CvectorIndex(Stack[-11], 0))
0x76c: Push(CvectorIndex(Stack[-12], 0))
0x76d: Pop(2); Push(Stack[-2] * Stack[-1]);
0x76e: Push(CvectorIndex(Stack[-12], 2))
0x76f: Push(CvectorIndex(Stack[-13], 2))
0x770: Pop(2); Push(Stack[-2] * Stack[-1]);
0x771: Pop(2); Push(Stack[-2] + Stack[-1]);
0x772: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x773: Push(CvectorIndex(Stack[-11], 1))
0x774: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x775: Push(CvectorIndex(Stack[-13], 0))
0x776: Push(CvectorIndex(Stack[-13], 0))
0x777: Pop(2); Push(Stack[-2] - Stack[-1]);
0x778: Push(CvectorIndex(Stack[-14], 0))
0x779: Push(CvectorIndex(Stack[-14], 0))
0x77a: Pop(2); Push(Stack[-2] - Stack[-1]);
0x77b: Pop(2); Push(Stack[-2] * Stack[-1]);
0x77c: Push(CvectorIndex(Stack[-14], 2))
0x77d: Push(CvectorIndex(Stack[-14], 2))
0x77e: Pop(2); Push(Stack[-2] - Stack[-1]);
0x77f: Push(CvectorIndex(Stack[-15], 2))
0x780: Push(CvectorIndex(Stack[-15], 2))
0x781: Pop(2); Push(Stack[-2] - Stack[-1]);
0x782: Pop(2); Push(Stack[-2] * Stack[-1]);
0x783: Pop(2); Push(Stack[-2] + Stack[-1]);
0x784: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x785: Push((float)500.0)
0x786: Pop(0); Push(Stack[-4] * Stack[-5]);
0x787: Push(CvectorIndex(Stack[-14], 1))
0x788: Push(CvectorIndex(Stack[-16], 1))
0x789: Pop(2); Push(Stack[-2] - Stack[-1]);
0x78a: Pop(2); Push(Stack[-2] - Stack[-1]);
0x78b: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x78c: Push((int) 0)
0x78d: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x78e: IF (Stack[-1] == 0) GOTO 0x791; Pop(1)

0x78f: Stack[-14] = (int) -1
0x790: Return(); Pop(10)

0x791: Pop(0); Push(Stack[-3] / Stack[-5]);
0x792: Pop(0); Push(Sqrt(Stack[-3]))
0x793: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x794: Stack[-1] = Stack[-14]
0x795: Return(); Pop(10)

0x796: PushEmpty()
0x797: Push((int) 200)
0x798: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x799: IF (Stack[-1] == 0) GOTO 0x79d; Pop(1)
...
0x7a8: Stack[-2] = (int) 30
0x7a9: Return(); Pop(0)

0x7aa: Stack[-2] = (int) 700
0x7ab: Return(); Pop(0)

0x7ac: PushEmpty()
0x7ad: Push((int) 10)
0x7ae: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7af: IF (Stack[-1] == 0) GOTO 0x7b3; Pop(1)

0x7b0: Stack[-3] = (int) 10
0x7b1: Return(); Pop(0)
...
0x7c3: Stack[-2] = Stack[-1]
0x7c4: Push(-1, 3); TaskCall(2)
0x7c5: Call2 0x15d

0x7c6: Pop(-1, 3); TaskReturn
0x7c7: Pop(1)
0x7c8: Return(); Pop(0)
...
0x7cd: Stack[-2] = Stack[-4]
0x7ce: Pop(2)
0x7cf: Return(); Pop(0)

0x7d0: PushEmpty()
0x7d1: PushEmpty(object)
0x7d2: Stack[-2] = Stack[-1]
0x7d3: Push(-1, 2); TaskCall(4)
0x7d4: Call2 0x2ab

0x7d5: Pop(-1, 2); TaskReturn
0x7d6: Pop(1)
0x7d7: @ ResetAAS()
0x7d8: Pop(0)
0x7d9: Return(); Pop(0)
...
0x7e0: Stack[-2] = Stack[-1]
0x7e1: Push(-1, 2); TaskCall(4)
0x7e2: Call2 0x2ab

0x7e3: Pop(-1, 2); TaskReturn
0x7e4: Pop(1)
0x7e5: @ ResetAAS()
0x7e6: Pop(0)
0x7e7: Return(); Pop(0)
...
0x7e8: PushEmpty()
0x7e9: PushEmpty(object, int, float)
0x7ea: Stack[-7] = Stack[-3]
0x7eb: Stack[-6] = Stack[-2]
0x7ec: Stack[-5] = Stack[-1]
0x7ed: Call2 0x563
...
0x7f0: PushEmpty()
0x7f1: PushEmpty(object, int, float, cvector, cvector)
0x7f2: Stack[-11] = Stack[-5]
0x7f3: Stack[-10] = Stack[-4]
0x7f4: Stack[-9] = Stack[-3]
0x7f5: Stack[-7] = Stack[-2]
...
0x7fa: PushEmpty()
0x7fb: PushEmpty(object)
0x7fc: Stack[-2] = Stack[-1]
0x7fd: Call2 0x888

0x7fe: Pop(1)
0x7ff: PushEmpty(bool, object)
0x800: Stack[-3] = Stack[-1]
0x801: Call2 0x4bc
...
0x805: Stack[-4] = Stack[-2]
0x806: Stack[-1] = (float) 0.05000000074505806
0x807: Call2 0x685

0x808: Pop(3)
0x809: PushEmpty(object)
0x80a: Stack[-2] = Stack[-1]
0x80b: Push(-1, 0); TaskCall(1)
0x80c: Call2 0xb9

0x80d: Pop(-1, 0); TaskReturn
0x80e: Pop(1)
0x80f: Return(); Pop(0)

0x810: PushEmpty(float, float)
0x811: Push("health") // @poff=1211
0x812: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x813: IF (Stack[-1] == 0) GOTO 0x81c; Pop(1)

0x814: Push("health") // @poff=1211
0x815: @ GetProperty(Stack[-1], Stack[-2])
0x816: Pop(1)
0x817: Push((int) 0)
0x818: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x819: IF (Stack[-1] == 0) GOTO 0x81c; Pop(1)

0x81a: @ SignalDeath(Stack[-4])
0x81b: Pop(0)
0x81c: Return(); Pop(2)
...
0x825: Stack[-5] = Stack[-1]
0x826: Call2 0x758

0x827: Pop(1)
0x828: IF (Stack[-1] == 0) GOTO 0x83a; Pop(1)

0x829: @ CanSee(Stack[-1], Stack[-4])
0x82a: Pop(0)
0x82b: PushEmpty(bool)
0x82c: Stack[-1] = (bool) 1
0x82d: Push(Stack[-2])
0x82e: IF (Stack[-1] == 1) GOTO 0x837; Pop(1)

0x82f: PushEmpty(float, object)
0x830: Stack[-7] = Stack[-1]
0x831: Call2 0x4b4

0x832: Pop(1)
0x833: Push((float)490000.0)
0x834: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x835: IF (Stack[-1] == 1) GOTO 0x837; Pop(1)

0x836: Stack[-1] = (bool) 0
0x837: IF (Stack[-1] == 0) GOTO 0x83a; Pop(1)

0x838: Stack[-5] = (bool) 1
0x839: Return(); Pop(2)

0x83a: Stack[-5] = (bool) 0
0x83b: Return(); Pop(2)

0x83c: Push(GlobalVars[0])
0x83d: PushEmpty(object)
0x83e: Call2 0x67f

0x83f: Stack[-1] = Stack[-2]
0x840: Pop(1)
0x841: GlobalVars[0] = Stack[-1]; Pop(1)
0x842: Return(); Pop(0)

0x843: PushEmpty(bool, float, bool, string, bool, float, bool, string)
0x844: PushEmpty(bool, object)
0x845: Stack[-11] = Stack[-1]
0x846: Call2 0x50c
...
0x84a: Stack[-10] = (bool) 0
0x84b: Return(); Pop(8)

0x84c: Push(GlobalVars[0])
0x84d: @@ in(Stack[-5], Stack[-10]); Obj=1 // @poff=1225
0x84e: Pop(1)
0x84f: Push(Stack[-4])
0x850: IF (Stack[-1] == 0) GOTO 0x853; Pop(1)

0x851: Stack[-10] = (bool) 1
0x852: Return(); Pop(8)

0x853: PushEmpty(bool, object, string)
0x854: Stack[-12] = Stack[-2]
0x855: Stack[-1] = "disease" // @poff=1228
0x856: Call2 0x4c1
...
0x85a: Stack[-10] = (bool) 0
0x85b: Return(); Pop(8)

0x85c: Push("disease") // @poff=1228
0x85d: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=544
0x85e: Pop(1)
0x85f: @ IsPlayerActor(Stack[-9], Stack[-2])
0x860: Pop(0)
0x861: Push(Stack[-2])
0x862: IF (Stack[-1] == 0) GOTO 0x867; Pop(1)

0x863: Push((float)0.0)
0x864: Stack[-11] = Stack[-4] > Stack[-1]; Pop(1);
0x865: Return(); Pop(8)

0x866: GOTO 0x879

0x867: Push((float)0.009999999776482582)
0x868: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x869: IF (Stack[-1] == 0) GOTO 0x879; Pop(1)

0x86a: PushEmpty(bool, object, string)
0x86b: Stack[-12] = Stack[-2]
0x86c: Stack[-1] = "class" // @poff=1199
0x86d: Call2 0x4c1

0x86e: Pop(2)
0x86f: IF (Stack[-1] == 0) GOTO 0x879; Pop(1)

0x870: Push("class") // @poff=1199
0x871: @@ GetProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=544
0x872: Pop(1)
0x873: PushEmpty(bool, string)
0x874: Stack[-3] = Stack[-1]
0x875: Call2 0x608

0x876: Stack[-2] = Stack[-12]
0x877: Pop(2)
0x878: Return(); Pop(8)

0x879: Stack[-10] = (bool) 0
0x87a: Return(); Pop(8)

0x87b: PushEmpty(bool, bool)
0x87c: Pop(0); PushNull((bool) Stack[-3] == 0)
0x87d: IF (Stack[-1] == 0) GOTO 0x87f; Pop(1)

0x87e: Return(); Pop(2)

0x87f: Push(GlobalVars[0])
0x880: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=1225
0x881: Pop(1)
0x882: Pop(0); Push((bool) Stack[-1] == 0)
0x883: IF (Stack[-1] == 0) GOTO 0x887; Pop(1)

0x884: Push(GlobalVars[0])
0x885: @@ add(Stack[-4]); Obj=1 // @poff=664
0x886: Pop(1)
0x887: Return(); Pop(2)
