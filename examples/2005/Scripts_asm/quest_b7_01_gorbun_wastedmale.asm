...
// @pool_raw:
// @pool_encoding:utf8
...
0x1be: Push("head") // @poff=198
0x1bf: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1c0: Pop(1)
0x1c1: Push(Stack[-1])
0x1c2: IF (Stack[-1] == 0) GOTO 0x1c6; Pop(1)

0x1c3: Push("head") // @poff=198
0x1c4: @ UnlookAsync(Stack[-1])
0x1c5: Pop(1)
0x1c6: Return(); Pop(2)

0x1c7: PushEmpty(float, float, float, float)
0x1c8: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x1c9: Pop(0)
0x1ca: Push((bool) 0)
0x1cb: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1cc: Pop(1)
0x1cd: Return(); Pop(4)

0x1ce: PushEmpty(float, float, float, float)
0x1cf: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x1d0: Pop(0)
0x1d1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x1d2: Pop(0)
0x1d3: Return(); Pop(4)
...
0x1e2: Pop(0); Push(Stack[-3] | Stack[-3]);
0x1e3: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x1e4: Push((float)9.999999974752427e-07)
0x1e5: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x1e6: IF (Stack[-1] == 0) GOTO 0x1e9; Pop(1)

0x1e7: Stack[-4] = [0.0, 0.0, 0.0]
0x1e8: Return(); Pop(2)

0x1e9: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x1ea: Return(); Pop(2)

0x1eb: PushEmpty(string, string)
0x1ec: Stack[-1] = "idle" // @poff=146
0x1ed: Push(Stack[-3])
0x1ee: IF (Stack[-1] == 0) GOTO 0x1f0; Pop(1)

0x1ef: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x1f0: Stack[-1] = Stack[-4]
0x1f1: Return(); Pop(2)

0x1f2: PushEmpty(int, bool, int, bool)
0x1f3: Stack[-2] = (int) 0
0x1f4: Push("all") // @poff=138
0x1f5: PushEmpty(string, int)
0x1f6: Stack[-5] = Stack[-1]
0x1f7: Call2 0x1eb

0x1f8: Pop(1)
0x1f9: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1fa: Pop(2)
0x1fb: Pop(0); Push((bool) Stack[-1] == 0)
0x1fc: IF (Stack[-1] == 0) GOTO 0x1fe; Pop(1)

0x1fd: GOTO 0x201

0x1fe: Push((int) 1)
0x1ff: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x200: GOTO 0x1f4

0x201: Stack[-2] = Stack[-5]
0x202: Return(); Pop(4)

0x203: PushEmpty(int, int)
0x204: Push("branch") // @poff=208
0x205: @ GetVariable(Stack[-1], Stack[-2])
0x206: Pop(1)
0x207: Push((int) 0)
...
0x214: Stack[-1] = (int) 515556
0x215: Return(); Pop(0)

0x216: Stack[-1] = (int) 503341
0x217: Return(); Pop(0)

0x218: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=222
0x219: Return(); Pop(0)

0x21a: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=262
0x21b: Return(); Pop(0)
