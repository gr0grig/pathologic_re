...
// @pool_raw:
// @pool_encoding:utf8
...
0x185: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x186: Pop(0)
0x187: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x188: Pop(0)
...
0x1ad: @ StopWorld()
0x1ae: Pop(0)
0x1af: @ CameraTransit(Stack[-3], Stack[-5])
0x1b0: Pop(0)
0x1b1: Push(CvectorIndex(Stack[-4], 0))
0x1b2: Push(CvectorIndex(Stack[-5], 2))
0x1b3: @ Rotate(Stack[-2], Stack[-1])
0x1b4: Pop(2)
...
0x1ba: Push("head") // @poff=198
0x1bb: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1bc: Pop(1)
0x1bd: Push(Stack[-1])
0x1be: IF (Stack[-1] == 0) GOTO 0x1c2; Pop(1)

0x1bf: Push("head") // @poff=198
0x1c0: @ LookAsyncCamera(Stack[-1])
0x1c1: Pop(1)
0x1c2: @ CameraWaitForPlayFinish()
0x1c3: Pop(0)
0x1c4: @ ResumeWorld()
0x1c5: Pop(0)
0x1c6: Stack[-21] = (bool) 1
0x1c7: Return(); Pop(18)

0x1c8: PushEmpty(bool, bool)
0x1c9: @ CameraSwitchToNormal()
0x1ca: Pop(0)
...
0x1d0: Push("head") // @poff=198
0x1d1: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1d2: Pop(1)
0x1d3: Push(Stack[-1])
0x1d4: IF (Stack[-1] == 0) GOTO 0x1d8; Pop(1)

0x1d5: Push("head") // @poff=198
0x1d6: @ UnlookAsync(Stack[-1])
0x1d7: Pop(1)
0x1d8: Return(); Pop(2)

0x1d9: PushEmpty(float, float, float, float)
0x1da: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x1db: Pop(0)
0x1dc: Push((bool) 0)
0x1dd: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1de: Pop(1)
0x1df: Return(); Pop(4)

0x1e0: PushEmpty(float, float, float, float)
0x1e1: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x1e2: Pop(0)
0x1e3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x1e4: Pop(0)
0x1e5: Return(); Pop(4)
...
0x213: Stack[-2] = Stack[-5]
0x214: Return(); Pop(4)

0x215: PushEmpty(int, int)
0x216: Push("branch") // @poff=208
...
0x226: Stack[-1] = (int) 515571
0x227: Return(); Pop(0)

0x228: Stack[-1] = (int) 504029
0x229: Return(); Pop(0)

0x22a: Stack[-1] = "ui/NPC_bmask.png" // @poff=222
0x22b: Return(); Pop(0)

0x22c: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=256
0x22d: Return(); Pop(0)
