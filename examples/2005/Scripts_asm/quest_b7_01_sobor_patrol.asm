...
// @pool_raw:
// @pool_encoding:utf8
...
0x19c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x19d: Pop(0)
0x19e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x19f: Pop(0)
...
0x1c4: @ StopWorld()
0x1c5: Pop(0)
0x1c6: @ CameraTransit(Stack[-3], Stack[-5])
0x1c7: Pop(0)
0x1c8: Push(CvectorIndex(Stack[-4], 0))
0x1c9: Push(CvectorIndex(Stack[-5], 2))
0x1ca: @ Rotate(Stack[-2], Stack[-1])
0x1cb: Pop(2)
...
0x1d1: Push("head") // @poff=198
0x1d2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1d3: Pop(1)
0x1d4: Push(Stack[-1])
0x1d5: IF (Stack[-1] == 0) GOTO 0x1d9; Pop(1)

0x1d6: Push("head") // @poff=198
0x1d7: @ LookAsyncCamera(Stack[-1])
0x1d8: Pop(1)
0x1d9: @ CameraWaitForPlayFinish()
0x1da: Pop(0)
0x1db: @ ResumeWorld()
0x1dc: Pop(0)
0x1dd: Stack[-21] = (bool) 1
0x1de: Return(); Pop(18)

0x1df: PushEmpty(bool, bool)
0x1e0: @ CameraSwitchToNormal()
0x1e1: Pop(0)
...
0x1e7: Push("head") // @poff=198
0x1e8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1e9: Pop(1)
0x1ea: Push(Stack[-1])
0x1eb: IF (Stack[-1] == 0) GOTO 0x1ef; Pop(1)

0x1ec: Push("head") // @poff=198
0x1ed: @ UnlookAsync(Stack[-1])
0x1ee: Pop(1)
0x1ef: Return(); Pop(2)

0x1f0: PushEmpty(float, float, float, float)
0x1f1: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x1f2: Pop(0)
0x1f3: Push((bool) 0)
0x1f4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1f5: Pop(1)
0x1f6: Return(); Pop(4)

0x1f7: PushEmpty(float, float, float, float)
0x1f8: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x1f9: Pop(0)
0x1fa: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x1fb: Pop(0)
0x1fc: Return(); Pop(4)
...
0x20b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x20c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x20d: Push((float)9.999999974752427e-07)
0x20e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x20f: IF (Stack[-1] == 0) GOTO 0x212; Pop(1)

0x210: Stack[-4] = [0.0, 0.0, 0.0]
0x211: Return(); Pop(2)

0x212: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x213: Return(); Pop(2)

0x214: PushEmpty(string, string)
0x215: Stack[-1] = "idle" // @poff=146
0x216: Push(Stack[-3])
0x217: IF (Stack[-1] == 0) GOTO 0x219; Pop(1)

0x218: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x219: Stack[-1] = Stack[-4]
0x21a: Return(); Pop(2)

0x21b: PushEmpty(int, bool, int, bool)
0x21c: Stack[-2] = (int) 0
...
0x221: Pop(1)
0x222: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x223: Pop(2)
...
0x227: Push((int) 1)
0x228: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x229: GOTO 0x21d
...
0x22d: Push("branch") // @poff=208
0x22e: @ GetVariable(Stack[-1], Stack[-2])
0x22f: Pop(1)
0x230: Push((int) 0)
...
0x23d: Stack[-1] = (int) 515572
0x23e: Return(); Pop(0)

0x23f: Stack[-1] = (int) 504031
0x240: Return(); Pop(0)

0x241: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=222
0x242: Return(); Pop(0)

0x243: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=262
0x244: Return(); Pop(0)
