...
0x792: Pop(0)
0x793: @@ add(Stack[-3]); Obj=1 // @poff=938
0x794: Pop(0)
0x795: Push((int) 16)
...
0x7be: Stack[-9] = Stack[-3]
0x7bf: Stack[-8] = Stack[-2]
0x7c0: Stack[-7] = Stack[-1]
0x7c1: Call2 0x733

0x7c2: Stack[-4] = Stack[-6]
0x7c3: Pop(4)
0x7c4: Push((int) 0)
...
0x7ca: Stack[-10] = Stack[-4]
0x7cb: Stack[-9] = Stack[-3]
0x7cc: Stack[-8] = Stack[-2]
0x7cd: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x7ce: Call2 0x73a

0x7cf: Pop(4)
0x7d0: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7d1: Push([0.0, 500.0, 0.0])
...
0x7ed: Push("GenerateMoney: iMin > iMax") // @poff=1047
0x7ee: @ Trace(Stack[-1])
0x7ef: Pop(1)
0x7f0: Return(); Pop(4)
...
0x80b: Pop(0)
0x80c: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1113
0x80d: Pop(0)
0x80e: Push("Organ") // @poff=1125
0x80f: Push((int) 1)
0x810: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=794
0x811: Pop(2)
0x812: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1137
0x813: Pop(0)
0x814: Push((int) 0)
0x815: Push((int) 1)
...
0x822: Stack[-1] = "liver" // @poff=1147
0x823: Call2 0x809

0x824: Pop(1)
0x825: PushEmpty(string)
0x826: Stack[-1] = "kidney" // @poff=1159
0x827: Call2 0x809

0x828: Pop(1)
0x829: PushEmpty(string)
0x82a: Stack[-1] = "heart" // @poff=1173
0x82b: Call2 0x809

0x82c: Pop(1)
0x82d: PushEmpty(string)
0x82e: Stack[-1] = "blood" // @poff=1185
0x82f: Call2 0x809
...
0x842: Stack[-3] = "lockpick" // @poff=1209
0x843: Stack[-2] = (int) 1
0x844: Stack[-1] = (int) 6
0x845: Call2 0x6e8
...
0x848: Stack[-1] = "grabitel_mark" // @poff=1227
0x849: Call2 0x850
...
0x867: Stack[-4] = Stack[-2]
0x868: Stack[-1] = (float) 0.029999999329447746
0x869: Call2 0x763
...
0x87c: Stack[-7] = Stack[-3]
0x87d: Stack[-6] = Stack[-2]
...
0x884: Stack[-11] = Stack[-5]
0x885: Stack[-10] = Stack[-4]
0x886: Stack[-9] = Stack[-3]
0x887: Stack[-7] = Stack[-2]
