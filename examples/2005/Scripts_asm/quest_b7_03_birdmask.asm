...
// @pool_raw:
// @pool_encoding:utf8
...
0x252: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x253: Pop(0)
0x254: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x255: Pop(0)
...
0x2c1: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2c2: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2c3: Push((float)9.999999974752427e-07)
0x2c4: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2c5: IF (Stack[-1] == 0) GOTO 0x2c8; Pop(1)

0x2c6: Stack[-4] = [0.0, 0.0, 0.0]
0x2c7: Return(); Pop(2)

0x2c8: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2c9: Return(); Pop(2)

0x2ca: PushEmpty(int, int)
0x2cb: @ GetVariable(Stack[-3], Stack[-1])
0x2cc: Pop(0)
...
0x2d1: Pop(0)
0x2d2: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2da: Stack[-1] = 0
0x2db: PushEmpty(string, string)
0x2dc: Stack[-1] = "idle" // @poff=146
0x2dd: Push(Stack[-3])
0x2de: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2df: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2e0: Stack[-1] = Stack[-4]
0x2e1: Return(); Pop(2)

0x2e2: PushEmpty(int, bool, int, bool)
0x2e3: Stack[-2] = (int) 0
0x2e4: Push("all") // @poff=138
0x2e5: PushEmpty(string, int)
0x2e6: Stack[-5] = Stack[-1]
0x2e7: Call2 0x2db

0x2e8: Pop(1)
0x2e9: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ea: Pop(2)
...
0x2ee: Push((int) 1)
0x2ef: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2f0: GOTO 0x2e4

0x2f1: Stack[-2] = Stack[-5]
0x2f2: Return(); Pop(4)

0x2f3: PushEmpty(float, float)
0x2f4: Push("b7q03") // @poff=208
0x2f5: Push((int) 2)
0x2f6: @ SetVariable(Stack[-2], Stack[-1])
0x2f7: Pop(2)
0x2f8: PushEmpty()
0x2f9: Call2 0x32e

0x2fa: Pop(0)
0x2fb: Push("disease") // @poff=220
0x2fc: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=236
0x2fd: Pop(1)
0x2fe: Push((float)0.5)
0x2ff: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x300: IF (Stack[-1] == 0) GOTO 0x305; Pop(1)

0x301: Push("disease") // @poff=220
0x302: Push((float)0.5)
0x303: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=248
0x304: Pop(2)
0x305: PushEmpty(bool, string, string)
0x306: Stack[-2] = "quest_b7_03" // @poff=260
0x307: Stack[-1] = "remove_birdmask" // @poff=284
0x308: Call2 0x2cf
...
0x30b: PushEmpty()
0x30c: Push("b7q03SerumWorks") // @poff=316
0x30d: Push((int) 1)
...
0x328: Push("disease") // @poff=220
0x329: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=236
0x32a: Pop(1)
0x32b: Push((int) 0)
0x32c: Stack[-5] = Stack[-2] == Stack[-1]; Pop(1);
0x32d: Return(); Pop(2)

0x32e: PushEmpty(object, object)
0x32f: Push((int) 282)
0x330: Push((int) 2)
0x331: Push((int) 521365)
0x332: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x333: Pop(3)
0x334: PushEmpty(bool, object, int)
0x335: Stack[-4] = Stack[-2]
0x336: Stack[-1] = (int) 280
0x337: Call2 0x348
...
0x33c: @ GetDiaryRoot(Stack[-1])
0x33d: Pop(0)
0x33e: Pop(0); Push((bool) Stack[-1] == 0)
0x33f: IF (Stack[-1] == 0) GOTO 0x345; Pop(1)

0x340: Push("Can't retrieve diary root") // @poff=348
0x341: @ Trace(Stack[-1])
0x342: Pop(1)
0x343: Stack[-3] = (bool) 0
0x344: Return(); Pop(2)
...
0x347: Stack[-1] = 0
0x348: PushEmpty(object, object, int, object, object, int)
0x349: PushEmpty(object)
0x34a: Call2 0x33b

0x34b: Stack[-1] = Stack[-4]
0x34c: Pop(1)
0x34d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=400
0x34e: Pop(0)
0x34f: Pop(0); Push((bool) Stack[-2] == 0)
0x350: IF (Stack[-1] == 0) GOTO 0x357; Pop(1)

0x351: Push("Can't find diary parent with id: ") // @poff=405
...
0x357: @@ AddChild(Stack[-8]); Obj=2 // @poff=473
0x358: Pop(0)
0x359: Push((int) 7)
0x35a: @ SendWorldWndMessage(Stack[-1])
0x35b: Pop(1)
0x35c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=482
0x35d: Pop(0)
0x35e: @ SetDiarySection(Stack[-1])
0x35f: Pop(0)
0x360: Stack[-9] = (bool) 0
0x361: Return(); Pop(6)

0x362: Stack[-2] = 0
0x363: Stack[-3] = 0
0x364: PushEmpty(int, int)
0x365: Push("branch") // @poff=494
...
0x375: Stack[-1] = (int) 515571
0x376: Return(); Pop(0)

0x377: Stack[-1] = (int) 504029
0x378: Return(); Pop(0)

0x379: Stack[-1] = "ui/NPC_bmask.png" // @poff=508
0x37a: Return(); Pop(0)

0x37b: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=542
0x37c: Return(); Pop(0)
