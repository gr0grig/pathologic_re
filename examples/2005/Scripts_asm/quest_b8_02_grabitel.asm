...
0xa9b: Pop(0)
0xa9c: @@ add(Stack[-3]); Obj=1 // @poff=918
0xa9d: Pop(0)
0xa9e: Push((int) 16)
...
0xae0: Stack[-8] = Stack[-2]
0xae1: Stack[-7] = Stack[-1]
0xae2: Call2 0xa36

0xae3: Stack[-4] = Stack[-6]
0xae4: Pop(4)
0xae5: Push((int) 0)
...
0xaeb: Stack[-10] = Stack[-4]
0xaec: Stack[-9] = Stack[-3]
0xaed: Stack[-8] = Stack[-2]
0xaee: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0xaef: Call2 0xa3d

0xaf0: Pop(4)
0xaf1: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xaf2: Push([0.0, 500.0, 0.0])
...
0xafa: Stack[-8] = Stack[-2]
0xafb: Stack[-1] = "class" // @poff=1241
0xafc: Call2 0x7ec
...
0xb02: Push("class") // @poff=1241
0xb03: @ GetProperty(Stack[-1], Stack[-3])
0xb04: Pop(1)
0xb05: Push("class") // @poff=1241
0xb06: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=762
0xb07: Pop(1)
...
0xb1b: @@ in(Stack[-4], Stack[-8]); Obj=1 // @poff=1253
0xb1c: Pop(1)
0xb1d: Push(Stack[-3])
...
0xb22: Stack[-9] = Stack[-1]
0xb23: Call2 0x7e7

0xb24: Pop(1)
0xb25: IF (Stack[-1] == 0) GOTO 0xb2c; Pop(1)

0xb26: Push("reputation") // @poff=1177
0xb27: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=762
0xb28: Pop(1)
0xb29: Push((float)0.33000001311302185)
0xb2a: Stack[-9] = Stack[-3] >= Stack[-1]; Pop(1);
0xb2b: Return(); Pop(6)

0xb2c: PushEmpty(bool, object, string)
0xb2d: Stack[-10] = Stack[-2]
0xb2e: Stack[-1] = "class" // @poff=1241
0xb2f: Call2 0x7ec
...
0xb35: Push("class") // @poff=1241
0xb36: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=762
0xb37: Pop(1)
0xb38: PushEmpty(bool, string)
0xb39: Stack[-3] = Stack[-1]
0xb3a: Call2 0x9c8

0xb3b: Stack[-2] = Stack[-10]
0xb3c: Pop(2)
0xb3d: Return(); Pop(6)
...
0xb58: Stack[-3] = Stack[-1]
0xb59: Call2 0xb11

0xb5a: Stack[-2] = Stack[-4]
0xb5b: Pop(2)
0xb5c: Return(); Pop(0)
...
0xba0: Stack[-8] = Stack[-1]
0xba1: Call2 0x7df

0xba2: Stack[-2] = Stack[-3]
0xba3: Pop(2)
...
0xbab: Push(Stack[-4])
0xbac: IF (Stack[-1] == 1) GOTO 0xbb1; Pop(1)

0xbad: Push((float)490000.0)
0xbae: Pop(1); Push((bool) Stack[-4] <= Stack[-1])
0xbaf: IF (Stack[-1] == 1) GOTO 0xbb1; Pop(1)
...
0xbbf: Stack[-4] = Stack[-2]
0xbc0: Stack[-1] = (float) 0.05000000074505806
0xbc1: Call2 0xa6c
...
0xbcc: Stack[-7] = Stack[-3]
0xbcd: Stack[-6] = Stack[-2]
0xbce: Stack[-5] = Stack[-1]
0xbcf: Call2 0x918
...
0xbd4: Stack[-11] = Stack[-5]
0xbd5: Stack[-10] = Stack[-4]
0xbd6: Stack[-9] = Stack[-3]
0xbd7: Stack[-7] = Stack[-2]
...
0xbf0: Push("branch") // @poff=1256
0xbf1: @ GetVariable(Stack[-1], Stack[-2])
0xbf2: Pop(1)
0xbf3: Stack[-1] = Stack[-3]
0xbf4: Return(); Pop(2)
...
0xc05: Push("GenerateMoney: iMin > iMax") // @poff=1270
0xc06: @ Trace(Stack[-1])
0xc07: Pop(1)
0xc08: Return(); Pop(4)
...
0xc23: Pop(0)
0xc24: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1336
0xc25: Pop(0)
0xc26: Push("Organ") // @poff=1348
0xc27: Push((int) 1)
0xc28: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=774
0xc29: Pop(2)
0xc2a: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1360
0xc2b: Pop(0)
0xc2c: Push((int) 0)
0xc2d: Push((int) 1)
...
0xc3a: Stack[-1] = "liver" // @poff=1370
0xc3b: Call2 0xc21

0xc3c: Pop(1)
0xc3d: PushEmpty(string)
0xc3e: Stack[-1] = "kidney" // @poff=1382
0xc3f: Call2 0xc21

0xc40: Pop(1)
0xc41: PushEmpty(string)
0xc42: Stack[-1] = "heart" // @poff=1396
0xc43: Call2 0xc21

0xc44: Pop(1)
0xc45: PushEmpty(string)
0xc46: Stack[-1] = "blood" // @poff=1408
0xc47: Call2 0xc21
...
0xc5a: Stack[-3] = "lockpick" // @poff=1432
0xc5b: Stack[-2] = (int) 1
0xc5c: Stack[-1] = (int) 3
0xc5d: Call2 0x985
...
0xc60: Stack[-4] = "rifle_ammo" // @poff=1450
0xc61: Stack[-3] = (int) 1
0xc62: Stack[-2] = (int) 3
0xc63: Stack[-1] = (int) 3
0xc64: Call2 0x990
...
0xc67: Stack[-4] = "samopal_ammo" // @poff=1472
0xc68: Stack[-3] = (int) 1
0xc69: Stack[-2] = (int) 3
0xc6a: Stack[-1] = (int) 3
0xc6b: Call2 0x990
...
0xc6e: Stack[-4] = "revolver_ammo" // @poff=1498
0xc6f: Stack[-3] = (int) 1
0xc70: Stack[-2] = (int) 3
0xc71: Stack[-1] = (int) 3
0xc72: Call2 0x990
...
0xc75: Stack[-3] = "Samopal" // @poff=1526
0xc76: Stack[-2] = (int) 1
...
0xc7b: Stack[-3] = "Revolver" // @poff=1542
0xc7c: Stack[-2] = (int) 1
...
0xc87: Stack[-1] = "grabitel_mark" // @poff=1572
0xc88: Call2 0xc8f
