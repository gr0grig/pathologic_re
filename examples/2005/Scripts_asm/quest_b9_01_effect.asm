...
Strings:
	...
	W:b9q01_stop
	A:add
// @pool_raw:740069007200650064006e006500730073000000620039007100300031005f00730074006f007000000061646400
...
0x57: Stack[-1] = Stack[-4]
0x58: Return(); Pop(0)

0x59: Stack[-3] = Stack[-4]
0x5a: Return(); Pop(0)

0x5b: PushEmpty(object, object)
0x5c: @ CreateFloatVector(Stack[-1])
0x5d: Pop(0)
0x5e: @@ add(Stack[-3]); Obj=1 // @poff=42
0x5f: Pop(0)
0x60: Push((int) 11)
