...
Strings:
	...
	W:Category
	A:AddItem
// @pool_raw:
...
0x2c: Push("object") // @poff=70
0x2d: @ FindGeometry(Stack[-1], Stack[-2])
0x2e: Pop(1)
0x2f: Push((bool) 1)
0x30: @@ Enable(Stack[-1]); Obj=2 // @poff=84
0x31: Pop(1)
0x32: @ Hold()
0x33: Pop(0)
0x34: GOTO 0x32
...
0x61: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=115
0x62: Pop(0)
0x63: Stack[-1] = Stack[-5]
0x64: Return(); Pop(2)

0x65: PushEmpty(bool, bool)
0x66: @@ IsDead(Stack[-1]); Obj=3 // @poff=127
0x67: Pop(0)
...
0x84: @@ GetScene(Stack[-1]); Obj=5 // @poff=148
0x85: Pop(0)
...
0x99: Stack[-1] = "noaccess" // @poff=157
0x9a: Call2 0x59
...
0xa0: Push("noaccess") // @poff=157
0xa1: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=175
0xa2: Pop(1)
0xa3: Push((int) 0)
...
0xae: Pop(0)
0xaf: @@ add(Stack[-4]); Obj=1 // @poff=187
0xb0: Pop(0)
0xb1: @@ add(Stack[-3]); Obj=1 // @poff=187
0xb2: Pop(0)
0xb3: Push((int) 3)
...
0xb9: @@ GetItemID(Stack[-3]); Obj=8 // @poff=191
0xba: Pop(0)
0xbb: Push("Category") // @poff=201
0xbc: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xbd: Pop(1)
0xbe: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=219
0xbf: Pop(0)
0xc0: Push(Stack[-1])
