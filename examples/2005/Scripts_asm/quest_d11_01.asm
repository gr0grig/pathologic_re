...
Strings:
	...
	A:SetProperty
	A:clear
// @pool_raw:
...
0x2: Pop(0)
0x3: Push("d3q01_graveyard_fire") // @poff=0
0x4: Push([0.0, 0.0, 0.0])
0x5: Push([0.0, 0.0, 1.0])
0x6: Push("d3q01_graveyard_fire.xml") // @poff=42
0x7: @ AddActor(Stack[-3]T, Stack[-4], Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0x8: Pop(4)
0x9: Return(); Pop(2)
...
0x38: Stack[-2] = "cot_maria@door1" // @poff=92
0x39: Stack[-1] = (bool) 1
0x3a: Call2 0x21a
...
0x41: @ Trace(Stack[-35])
0x42: Pop(0)
0x43: Push("init_soldiers") // @poff=124
...
0x4d: Stack[-22] = Stack[-4]
0x4e: Push("pt_d11q01_soldier") // @poff=152
0x4f: Stack[-4] = Stack[-1] + Stack[-22]; Pop(1);
0x50: Stack[-2] = "pers_soldat" // @poff=188
0x51: Stack[-1] = "d11q01_soldier.xml" // @poff=212
0x52: Call2 0x1f5

0x53: Pop(4)
0x54: @@@ add(Stack[-1]); Obj=1 // @poff=250
0x55: Pop(1)
0x56: Push((int) 1)
...
0x5a: Stack[-22] = Stack[-4]
0x5b: Stack[-3] = "pt_d11q01_msoldier" // @poff=254
0x5c: Stack[-2] = "pers_soldat_hand" // @poff=292
0x5d: Stack[-1] = "d11q01_msoldier.xml" // @poff=326
0x5e: Call2 0x1f5
...
0x63: Push("init_girl") // @poff=366
0x64: Pop(1); Push((bool) Stack[-36] == Stack[-1])
0x65: IF (Stack[-1] == 0) GOTO 0x73; Pop(1)

0x66: Push("shouse1_kabak") // @poff=386
0x67: @ GetSceneByName(Stack[-16], Stack[-1])
0x68: Pop(1)
0x69: PushEmpty(object, object, string, string, string)
0x6a: Stack[-20] = Stack[-4]
0x6b: Stack[-3] = "pt_d11q01_girl" // @poff=414
0x6c: Stack[-2] = "pers_nudegirl" // @poff=444
0x6d: Stack[-1] = "d11q01_girl.xml" // @poff=472
0x6e: Call2 0x1e3
...
0xe7: @@ RemoveAllItems(Stack[-6]); Obj=7 // @poff=683
0xe8: Pop(0)
0xe9: Push((int) 1)
0xea: Stack[-7] = Stack[-7] + Stack[-1]; Pop(1);
0xeb: GOTO 0xe4

0xec: @@ SelectWeapon(); Obj=7 // @poff=698
0xed: Pop(0)
0xee: PushEmpty()
0xef: Call2 0x0
...
0xf2: Stack[-1] = "quest_d11_01_teleport" // @poff=711
0xf3: Call2 0x1d8
...
0xf8: Stack[-10] = Stack[-4]
0xf9: Stack[-3] = "pt_d11q01_guard1" // @poff=755
0xfa: Stack[-2] = "pers_soldat" // @poff=188
0xfb: Stack[-1] = "d11q01_guard1.xml" // @poff=789
0xfc: Call2 0x207

0xfd: Stack[4 + Tasks[-1].StackPointer] = Stack[-5]
0xfe: Pop(5)
0xff: PushEmpty(object, object, string, string, string)
0x100: Stack[-10] = Stack[-4]
0x101: Stack[-3] = "pt_d11q01_guard2" // @poff=825
0x102: Stack[-2] = "pers_soldat" // @poff=188
0x103: Stack[-1] = "d11q01_guard2.xml" // @poff=859
0x104: Call2 0x207

0x105: Stack[5 + Tasks[-1].StackPointer] = Stack[-5]
0x106: Pop(5)
0x107: @@@ Remove(); Obj=2 // @poff=644
0x108: Pop(0)
0x109: PushEmpty(object, object, string, string, string)
0x10a: Stack[-10] = Stack[-4]
0x10b: Stack[-3] = "pt_d11q01_msoldier" // @poff=254
0x10c: Stack[-2] = "pers_soldat" // @poff=188
0x10d: Stack[-1] = "d11q01_soldier.xml" // @poff=212
0x10e: Call2 0x1f5
...
0x114: Push("soldier_death") // @poff=895
...
0x11f: @@@ GetActor(Stack[-4]); Obj=2 // @poff=635
0x120: Pop(0)
0x121: @@ IsDead(Stack[-3]); Obj=4 // @poff=923
0x122: Pop(0)
0x123: Push(Stack[-3])
0x124: IF (Stack[-1] == 0) GOTO 0x14c; Pop(1)

0x125: PushEmpty(object, object, object)
0x126: Stack[-7] = Stack[-3]
...
0x144: Stack[-1] = "burah_serum" // @poff=930
0x145: Call2 0x24c

0x146: Pop(1)
0x147: Push((int) 0)
0x148: Push((int) 1)
0x149: @@ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1]); Obj=7 // @poff=954
0x14a: Pop(3)
0x14b: Stack[17 + Tasks[-1].StackPointer] = (bool)1
0x14c: Stack[-4] = 0
0x14d: GOTO 0x16f

0x14e: Push("cleanup") // @poff=580
0x14f: Pop(1); Push((bool) Stack[-36] == Stack[-1])
0x150: IF (Stack[-1] == 0) GOTO 0x162; Pop(1)

0x151: Push("d11q01") // @poff=962
...
0x171: Stack[-3] = "volonteers_danko" // @poff=1006
0x172: Stack[-2] = "disease" // @poff=1040
0x173: Stack[-1] = "andrei" // @poff=518
0x174: Call2 0x22b

0x175: Pop(4)
0x176: Push("d11q01") // @poff=962
0x177: Push((int) -1)
...
0x1a0: @@@ Remove(); Obj=2 // @poff=644
0x1a1: Pop(0)
0x1a2: PushEmpty(string, bool)
0x1a3: Stack[-2] = "cot_maria@door1" // @poff=92
...
0x1b0: Stack[-1] = Stack[-6]
0x1b1: Pop(1)
0x1b2: @@ GetItemCount(Stack[-4], Stack[-12]); Obj=13 // @poff=1056
0x1b3: Pop(0)
0x1b4: Stack[-3] = (int) 0
0x1b5: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x1b6: IF (Stack[-1] == 0) GOTO 0x1c3; Pop(1)

0x1b7: @@ GetItem(Stack[-2], Stack[-3], Stack[-12]); Obj=13 // @poff=1069
0x1b8: Pop(0)
0x1b9: @@ add(Stack[-2]); Obj=5 // @poff=250
0x1ba: Pop(0)
0x1bb: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12]); Obj=13 // @poff=1077
0x1bc: Pop(0)
0x1bd: @@ add(Stack[-1]); Obj=11 // @poff=250
0x1be: Pop(0)
0x1bf: Stack[-2] = 0
0x1c0: Push((int) 1)
...
0x202: @@ AddStationaryActor(Stack[-1], Stack[-3], Stack[-2], Stack[-10], Stack[-9]); Obj=12 // @poff=1160
0x203: Pop(0)
0x204: Stack[-1] = Stack[-13]
0x205: Return(); Pop(8)

0x206: Stack[-1] = 0
0x207: PushEmpty(bool, cvector, cvector, object, bool, cvector, cvector, object)
0x208: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=1101
0x209: Pop(0)
0x20a: Pop(0); Push((bool) Stack[-4] == 0)
0x20b: IF (Stack[-1] == 0) GOTO 0x214; Pop(1)

0x20c: Push("Locator ") // @poff=1112
0x20d: Pop(1); Push(Stack[-1] + Stack[-12]);
0x20e: Push(" doesn't exist") // @poff=1130
...
0x214: Push((bool) 1)
0x215: @@ AddStationaryActor(Stack[-2], Stack[-4], Stack[-3], Stack[-11], Stack[-10], Stack[-1]); Obj=13 // @poff=1160
0x216: Pop(1)
0x217: Stack[-1] = Stack[-13]
0x218: Return(); Pop(8)
...
0x21f: Push("Door ") // @poff=1179
0x220: Pop(1); Push(Stack[-1] + Stack[-5]);
0x221: Push(" not found") // @poff=1191
0x222: Pop(2); Push(Stack[-2] + Stack[-1]);
0x223: @ Trace(Stack[-1])
0x224: Pop(1)
0x225: GOTO 0x229

0x226: Push("locked") // @poff=1213
0x227: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=1227
0x228: Pop(1)
0x229: Return(); Pop(2)
...
0x22d: Pop(0)
0x22e: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x252: @@ size(Stack[-5]); Obj=12 // @poff=626
0x253: Pop(0)
0x254: Stack[-4] = (int) 0
0x255: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x256: IF (Stack[-1] == 0) GOTO 0x262; Pop(1)

0x257: @@ get(Stack[-3], Stack[-4]); Obj=12 // @poff=631
0x258: Pop(0)
0x259: @@ get(Stack[-2], Stack[-4]); Obj=11 // @poff=631
0x25a: Pop(0)
0x25b: Push((int) 0)
0x25c: @@ AddItem(Stack[-2], Stack[-4], Stack[-1], Stack[-3]); Obj=14 // @poff=954
0x25d: Pop(1)
0x25e: Stack[-3] = 0
0x25f: Push((int) 1)
