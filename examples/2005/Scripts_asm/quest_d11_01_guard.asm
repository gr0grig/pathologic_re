...
0x2c1: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=346
0x2c2: Pop(1)
...
0x2e6: Stack[-7] = Stack[-3]
0x2e7: Stack[-6] = Stack[-2]
0x2e8: Stack[-5] = Stack[-1]
0x2e9: Call2 0x7b3
...
0x300: @ GetPFPosition(Stack[-1]T)
0x301: Pop(0)
0x302: @ GetDirection(Stack[-0]T)
0x303: Pop(0)
0x304: PushEmpty()
0x305: Call2 0x358
...
0x321: @ FindPathTo(Stack[-1], Stack[-1]T)
0x322: Pop(0)
...
0x330: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x331: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x343: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x344: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x379: Pop(0); PushNull((bool) Stack[-21] == 0)
0x37a: IF (Stack[-1] == 0) GOTO 0x380; Pop(1)

0x37b: PushEmpty(string)
0x37c: Stack[-1] = "fdie" // @poff=349
0x37d: Call2 0x3d3

0x37e: Pop(1)
0x37f: GOTO 0x3d2

0x380: @@ GetPosition(Stack[-10]); Obj=21 // @poff=359
0x381: Pop(0)
...
0x391: Stack[-6] = "fdie" // @poff=349
0x392: GOTO 0x394

0x393: Stack[-6] = "bdie" // @poff=371
...
0x39a: @ StopAsync()
0x39b: Pop(0)
0x39c: Stack[-21] = Stack[-5]
0x39d: Push("GetScriptProperty") // @poff=381
0x39e: Push((int) 2)
0x39f: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3a0: IF (Stack[-1] == 0) GOTO 0x3ac; Pop(1)

0x3a1: Push("Owner") // @poff=417
0x3a2: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=429
0x3a3: Pop(1)
0x3a4: Push(Stack[-4])
0x3a5: IF (Stack[-1] == 0) GOTO 0x3ac; Pop(1)

0x3a6: Push("Owner") // @poff=417
0x3a7: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=447
0x3a8: Pop(1)
0x3a9: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3aa: IF (Stack[-1] == 0) GOTO 0x3ac; Pop(1)

0x3ab: Stack[-21] = Stack[-5]
0x3ac: Push("@GetEyesHeight") // @poff=465
0x3ad: Push((int) 1)
0x3ae: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x3af: IF (Stack[-1] == 0) GOTO 0x3bb; Pop(1)

0x3b0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=495
0x3b1: Pop(0)
0x3b2: Stack[-1] = [0.0, 0.0, 0.0]
0x3b3: Push(CvectorIndex(Stack[-1], 1))
0x3b4: Stack[-3] = Stack[-1]
0x3b5: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x3b6: Push("head") // @poff=509
...
0x3bd: Stack[-7] = Stack[-1]
0x3be: Call2 0x53b

0x3bf: Pop(1)
0x3c0: Push("all") // @poff=0
...
0x3c7: @ StopAsync()
0x3c8: Pop(0)
0x3c9: Push("head") // @poff=509
0x3ca: @ UnlookAsync(Stack[-1])
0x3cb: Pop(1)
0x3cc: Push("all") // @poff=0
...
0x3fd: Stack[-2] = "bullet" // @poff=529
0x3fe: Return(); Pop(0)

0x3ff: Stack[-2] = "phys" // @poff=543
0x400: Return(); Pop(0)

0x401: PushEmpty(cvector, cvector, cvector, cvector)
0x402: @ GetPosition(Stack[-2])
0x403: Pop(0)
0x404: @@ GetPosition(Stack[-1]); Obj=5 // @poff=359
0x405: Pop(0)
...
0x40a: Pop(0)
0x40b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=359
0x40c: Pop(0)
...
0x416: Push("HasProperty") // @poff=553
0x417: Push((int) 2)
...
0x41d: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=577
0x41e: Pop(0)
...
0x423: Stack[-18] = Stack[-2]
0x424: Stack[-1] = "health" // @poff=589
0x425: Call2 0x415
...
0x42c: Stack[-18] = Stack[-2]
0x42d: Stack[-1] = "armor" // @poff=603
0x42e: Call2 0x415
...
0x434: Push("armor") // @poff=603
0x435: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=615
0x436: Pop(1)
0x437: Push("armor_") // @poff=627
0x438: PushEmpty(string, int)
0x439: Stack[-16] = Stack[-1]
0x43a: Call2 0x3f3

0x43b: Pop(1)
0x43c: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x43d: PushEmpty(bool, object, string)
0x43e: Stack[-18] = Stack[-2]
0x43f: Stack[-8] = Stack[-1]
0x440: Call2 0x415
...
0x446: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=615
0x447: Pop(0)
...
0x44e: Stack[-3] = Stack[-6]
0x44f: Pop(3)
0x450: Push("health") // @poff=589
0x451: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=615
0x452: Pop(1)
0x453: Push((int) 1)
...
0x45c: Pop(3)
0x45d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=641
0x45e: Pop(2)
0x45f: PushEmpty(bool, object)
0x460: Stack[-17] = Stack[-1]
0x461: Call2 0x410
...
0x467: Pop(1)
0x468: Stack[-1] = Stack[-16]
0x469: Return(); Pop(12)

0x46a: PushEmpty(bool, bool)
0x46b: @@ IsDead(Stack[-1]); Obj=3 // @poff=653
0x46c: Pop(0)
0x46d: Stack[-1] = Stack[-4]
0x46e: Return(); Pop(2)

0x46f: PushEmpty(object, object, object, object)
0x470: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x484: Pop(0)
0x485: Pop(0); PushNull((bool) Stack[-2] == 0)
0x486: IF (Stack[-1] == 0) GOTO 0x489; Pop(1)

0x487: Stack[-6] = (bool) 0
0x488: Return(); Pop(4)

0x489: @@ GetScene(Stack[-1]); Obj=5 // @poff=674
0x48a: Pop(0)
...
0x49d: Stack[-6] = Stack[-2]
0x49e: Stack[-1] = "noaccess" // @poff=683
0x49f: Call2 0x415
...
0x4a5: Push("noaccess") // @poff=683
0x4a6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=615
0x4a7: Pop(1)
0x4a8: Push((int) 0)
...
0x4ac: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x4ba: @@ GetPosition(Stack[-5]); Obj=15 // @poff=359
0x4bb: Pop(0)
...
0x4cb: Stack[-1] = "fhit" // @poff=701
0x4cc: GOTO 0x4ce

0x4cd: Stack[-1] = "bhit" // @poff=711
0x4ce: Push("hit_react") // @poff=721
0x4cf: Push("1") // @poff=160
0x4d0: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4d1: Push("2") // @poff=741
...
0x4ef: Stack[-2] = Stack[-11]
0x4f0: Pop(2)
0x4f1: @ CreateVectorVector(Stack[-8])
0x4f2: Pop(0)
0x4f3: Stack[-7] = (int) 1
0x4f4: Push("hit") // @poff=703
...
0x509: Pop(0)
0x50a: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=754
0x50b: Pop(0)
0x50c: PushEmpty(object, int, float, cvector, cvector)
0x50d: Stack[-26] = Stack[-5]
0x50e: Stack[-25] = Stack[-4]
0x50f: Stack[-24] = Stack[-3]
0x510: Stack[-6] = Stack[-2]
...
0x52a: @@ GetPosition(Stack[-3]); Obj=7 // @poff=359
0x52b: Pop(0)
...
0x536: Pop(0)
0x537: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=495
0x538: Pop(0)
...
0x57c: Push("woman") // @poff=786
0x57d: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x57e: IF (Stack[-1] == 1) GOTO 0x583; Pop(1)

0x57f: Push("worker") // @poff=798
0x580: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x581: IF (Stack[-1] == 1) GOTO 0x583; Pop(1)

0x582: Stack[-1] = (bool) 0
0x583: IF (Stack[-1] == 1) GOTO 0x588; Pop(1)

0x584: Push("butcher") // @poff=812
0x585: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x586: IF (Stack[-1] == 1) GOTO 0x588; Pop(1)

0x587: Stack[-1] = (bool) 0
0x588: IF (Stack[-1] == 1) GOTO 0x58d; Pop(1)

0x589: Push("wasted_girl") // @poff=828
0x58a: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x58b: IF (Stack[-1] == 1) GOTO 0x58d; Pop(1)

0x58c: Stack[-1] = (bool) 0
0x58d: IF (Stack[-1] == 1) GOTO 0x592; Pop(1)

0x58e: Push("boy") // @poff=852
0x58f: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x590: IF (Stack[-1] == 1) GOTO 0x592; Pop(1)

0x591: Stack[-1] = (bool) 0
0x592: IF (Stack[-1] == 1) GOTO 0x597; Pop(1)

0x593: Push("vaxxabitka") // @poff=860
0x594: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x595: IF (Stack[-1] == 1) GOTO 0x597; Pop(1)

0x596: Stack[-1] = (bool) 0
0x597: IF (Stack[-1] == 1) GOTO 0x59c; Pop(1)

0x598: Push("unosha") // @poff=882
0x599: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x59a: IF (Stack[-1] == 1) GOTO 0x59c; Pop(1)

0x59b: Stack[-1] = (bool) 0
0x59c: IF (Stack[-1] == 1) GOTO 0x5a1; Pop(1)

0x59d: Push("wasted_male") // @poff=896
0x59e: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x59f: IF (Stack[-1] == 1) GOTO 0x5a1; Pop(1)

0x5a0: Stack[-1] = (bool) 0
0x5a1: IF (Stack[-1] == 1) GOTO 0x5a6; Pop(1)

0x5a2: Push("alkash") // @poff=920
0x5a3: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x5a4: IF (Stack[-1] == 1) GOTO 0x5a6; Pop(1)

0x5a5: Stack[-1] = (bool) 0
0x5a6: IF (Stack[-1] == 1) GOTO 0x5ab; Pop(1)

0x5a7: Push("dohodyaga") // @poff=934
0x5a8: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x5a9: IF (Stack[-1] == 1) GOTO 0x5ab; Pop(1)

0x5aa: Stack[-1] = (bool) 0
0x5ab: IF (Stack[-1] == 1) GOTO 0x5b0; Pop(1)

0x5ac: Push("vaxxabit") // @poff=954
0x5ad: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x5ae: IF (Stack[-1] == 1) GOTO 0x5b0; Pop(1)

0x5af: Stack[-1] = (bool) 0
0x5b0: IF (Stack[-1] == 1) GOTO 0x5b5; Pop(1)

0x5b1: Push("nudegirl") // @poff=972
0x5b2: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5b3: IF (Stack[-1] == 1) GOTO 0x5b5; Pop(1)

0x5b4: Stack[-1] = (bool) 0
0x5b5: IF (Stack[-1] == 1) GOTO 0x5ba; Pop(1)

0x5b6: Push("morlok") // @poff=990
0x5b7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x5b8: IF (Stack[-1] == 1) GOTO 0x5ba; Pop(1)
...
0x60d: Pop(0)
0x60e: @@ add(Stack[-3]); Obj=1 // @poff=745
0x60f: Pop(0)
0x610: Push((int) 15)
...
0x63e: Stack[-7] = Stack[-3]
0x63f: Stack[-6] = Stack[-2]
0x640: Stack[-5] = Stack[-1]
0x641: Call2 0x4d7
...
0x646: Stack[-11] = Stack[-5]
0x647: Stack[-10] = Stack[-4]
0x648: Stack[-9] = Stack[-3]
0x649: Stack[-7] = Stack[-2]
0x64a: Stack[-6] = Stack[-1]
0x64b: Call2 0x51b
...
0x663: Pop(0)
0x664: Push((float)0.05000000074505806)
0x665: Push((bool) 1)
...
0x66f: Stack[-7] = Stack[-2]
0x670: Stack[-1] = "class" // @poff=1032
0x671: Call2 0x415
...
0x677: Push("class") // @poff=1032
0x678: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=615
0x679: Pop(1)
...
0x68e: Push("patrol") // @poff=1044
0x68f: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x690: IF (Stack[-1] == 1) GOTO 0x695; Pop(1)

0x691: Push("sanitar") // @poff=1058
0x692: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x693: IF (Stack[-1] == 1) GOTO 0x695; Pop(1)

0x694: Stack[-1] = (bool) 0
0x695: IF (Stack[-1] == 1) GOTO 0x69a; Pop(1)

0x696: Push("soldier") // @poff=1074
0x697: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x698: IF (Stack[-1] == 1) GOTO 0x69a; Pop(1)

0x699: Stack[-1] = (bool) 0
0x69a: IF (Stack[-1] == 1) GOTO 0x69f; Pop(1)

0x69b: Push("woman") // @poff=786
0x69c: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x69d: IF (Stack[-1] == 1) GOTO 0x69f; Pop(1)

0x69e: Stack[-1] = (bool) 0
0x69f: IF (Stack[-1] == 1) GOTO 0x6a4; Pop(1)

0x6a0: Push("wasted_girl") // @poff=828
0x6a1: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x6a2: IF (Stack[-1] == 1) GOTO 0x6a4; Pop(1)

0x6a3: Stack[-1] = (bool) 0
0x6a4: IF (Stack[-1] == 1) GOTO 0x6a9; Pop(1)

0x6a5: Push("vaxxabitka") // @poff=860
...
0x6af: Push("little_girl") // @poff=1090
...
0x6d4: Push("worker") // @poff=798
0x6d5: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6d6: IF (Stack[-1] == 1) GOTO 0x6db; Pop(1)

0x6d7: Push("butcher") // @poff=812
0x6d8: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6d9: IF (Stack[-1] == 1) GOTO 0x6db; Pop(1)

0x6da: Stack[-1] = (bool) 0
0x6db: IF (Stack[-1] == 1) GOTO 0x6e0; Pop(1)

0x6dc: Push("boy") // @poff=852
0x6dd: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x6de: IF (Stack[-1] == 1) GOTO 0x6e0; Pop(1)

0x6df: Stack[-1] = (bool) 0
0x6e0: IF (Stack[-1] == 1) GOTO 0x6e5; Pop(1)

0x6e1: Push("unosha") // @poff=882
0x6e2: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x6e3: IF (Stack[-1] == 1) GOTO 0x6e5; Pop(1)

0x6e4: Stack[-1] = (bool) 0
0x6e5: IF (Stack[-1] == 1) GOTO 0x6ea; Pop(1)

0x6e6: Push("wasted_male") // @poff=896
0x6e7: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6e8: IF (Stack[-1] == 1) GOTO 0x6ea; Pop(1)

0x6e9: Stack[-1] = (bool) 0
0x6ea: IF (Stack[-1] == 1) GOTO 0x6ef; Pop(1)

0x6eb: Push("alkash") // @poff=920
...
0x751: Stack[-9] = Stack[-1]
0x752: Call2 0x410

0x753: Pop(1)
0x754: IF (Stack[-1] == 0) GOTO 0x75b; Pop(1)

0x755: Push("reputation") // @poff=1114
0x756: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=615
0x757: Pop(1)
0x758: Push((float)0.33000001311302185)
0x759: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x75a: Return(); Pop(6)

0x75b: PushEmpty(bool, object, string)
0x75c: Stack[-10] = Stack[-2]
0x75d: Stack[-1] = "class" // @poff=1032
0x75e: Call2 0x415
...
0x764: Push("class") // @poff=1032
0x765: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=615
0x766: Pop(1)
0x767: PushEmpty(bool)
0x768: Stack[-1] = (bool) 1
0x769: PushEmpty(bool)
0x76a: Stack[-1] = (bool) 1
0x76b: Push("bomber") // @poff=1136
0x76c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x76d: IF (Stack[-1] == 1) GOTO 0x772; Pop(1)

0x76e: Push("hunter") // @poff=1150
0x76f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x770: IF (Stack[-1] == 1) GOTO 0x772; Pop(1)

0x771: Stack[-1] = (bool) 0
0x772: IF (Stack[-1] == 1) GOTO 0x777; Pop(1)

0x773: Push("grabitel") // @poff=1164
0x774: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x775: IF (Stack[-1] == 1) GOTO 0x777; Pop(1)
...
0x77b: Stack[-10] = Stack[-2]
0x77c: Stack[-1] = "disease" // @poff=1182
0x77d: Call2 0x415
...
0x788: Pop(1)
0x789: IF (Stack[-1] == 1) GOTO 0x78e; Pop(1)

0x78a: Push("dog") // @poff=1198
0x78b: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x78c: IF (Stack[-1] == 1) GOTO 0x78e; Pop(1)

0x78d: Stack[-1] = (bool) 0
0x78e: IF (Stack[-1] == 0) GOTO 0x795; Pop(1)

0x78f: Push("disease") // @poff=1182
0x790: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=615
0x791: Pop(1)
0x792: Push((int) 0)
...
0x7a1: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=346
0x7a2: Pop(1)
0x7a3: Push(Stack[-1])
...
0x7be: Push(Stack[-2])
0x7bf: IF (Stack[-1] == 1) GOTO 0x7c8; Pop(1)

0x7c0: PushEmpty(float, object)
0x7c1: Stack[-8] = Stack[-1]
0x7c2: Call2 0x408
...
0x7d8: Pop(0)
0x7d9: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1206
0x7da: Pop(1)
0x7db: PushEmpty(object)
0x7dc: Stack[-4] = Stack[-1]
