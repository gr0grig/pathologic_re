...
Strings:
	...
	W:soldier_death
// @pool_raw:
...
0xa: IF (Stack[-1] == 1) GOTO 0x12; Pop(1)
...
0x10: IF (Stack[-1] == 1) GOTO 0x12; Pop(1)
...
0x54: Stack[-7] = Stack[-3]
0x55: Stack[-6] = Stack[-2]
...
0x7d: Pop(1)
0x7e: @ CanSee(Stack[-1]T, Stack[-0]T)
0x7f: Pop(0)
...
0x91: Pop(0)
0x92: Push("all") // @poff=0
0x93: Push("shoot_begin") // @poff=8
...
0x9d: Push("shot") // @poff=32
0x9e: @ Speak(Stack[-1])
0x9f: Pop(1)
0xa0: Push("all") // @poff=0
0xa1: Push("shoot_end") // @poff=42
...
0xbe: @ CanSee(Stack[-1]T, Stack[-0]T)
0xbf: Pop(0)
...
0xdb: Push("all") // @poff=0
0xdc: Push("attack_off") // @poff=62
...
0x104: Stack[-7] = Stack[-3]
0x105: Stack[-6] = Stack[-2]
...
0x127: Pop(0)
0x128: @ Face(Stack[-0]T)
0x129: Pop(0)
0x12a: Push(Stack[-5])
0x12b: IF (Stack[-1] == 0) GOTO 0x132; Pop(1)

0x12c: Push("all") // @poff=0
0x12d: Push("attack_on") // @poff=84
0x12e: @ PlayAnimation(Stack[-2], Stack[-1])
0x12f: Pop(2)
0x130: @ WaitForAnimEnd()
0x131: Pop(0)
0x132: Push("all") // @poff=0
0x133: Push("attack_on") // @poff=84
...
0x13e: @ CanSee(Stack[-1], Stack[-0]T)
0x13f: Pop(0)
0x140: Push(Stack[-1])
...
0x14f: Push("all") // @poff=0
0x150: Push("hunt") // @poff=104
...
0x173: Push("all") // @poff=0
0x174: Push("attack_on") // @poff=84
...
0x180: Pop(0)
0x181: Push("all") // @poff=0
0x182: Push("attack_on") // @poff=84
...
0x18e: @ CanSee(Stack[-1], Stack[-0]T)
0x18f: Pop(0)
0x190: Push(Stack[-1])
0x191: IF (Stack[-1] == 0) GOTO 0x198; Pop(1)

0x192: @ Face(Stack[-0]T)
0x193: Pop(0)
0x194: PushEmpty()
0x195: Call2 0x1d3
...
0x1a6: @ StopAsync()
0x1a7: Pop(0)
0x1a8: Push("all") // @poff=0
0x1a9: Push("attack_off") // @poff=62
...
0x1e1: Pop(0)
0x1e2: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x1e3: Pop(1)
...
0x1e9: Stack[-2] = Stack[-15]
0x1ea: Pop(2)
0x1eb: PushEmpty(float, cvector, cvector)
0x1ec: Stack[-17] = Stack[-2]
0x1ed: Stack[-16] = Stack[-1]
0x1ee: Call2 0x6b8

0x1ef: Pop(2)
0x1f0: Push((float)0.9993908405303955)
...
0x1f6: Pop(0)
0x1f7: Push("all") // @poff=0
0x1f8: Push("attack_begin1") // @poff=136
0x1f9: @ PlayAnimation(Stack[-2], Stack[-1])
0x1fa: Pop(2)
0x1fb: Push("attack") // @poff=164
...
0x201: Pop(0)
0x202: Push("light-dynamic") // @poff=178
0x203: Push("soldier_fire.xml") // @poff=206
...
0x21c: Push((float)0.03490658476948738)
...
0x22a: Stack[-4] = Stack[-7]
0x22b: Pop(4)
0x22c: Push((int) 2)
0x22d: Push((float)1.5)
0x22e: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x22f: Pop(2)
0x230: GOTO 0x240
...
0x235: Pop(0)
0x236: Push("scripted") // @poff=240
0x237: Push([0.0, 0.0, 1.0])
0x238: Push("richochet.xml") // @poff=258
0x239: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x23a: Pop(3)
0x23b: Push("Material") // @poff=286
0x23c: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=304
0x23d: Pop(1)
0x23e: Stack[-1] = 0
0x23f: Stack[-2] = 0
0x240: Push("all") // @poff=0
0x241: Push("attack_end1") // @poff=322
0x242: @ PlayAnimation(Stack[-2], Stack[-1])
0x243: Pop(2)
0x244: @ WaitForAnimEnd()
0x245: Pop(0)
0x246: Push("all") // @poff=0
0x247: Push("attack_on") // @poff=84
...
0x266: Stack[-7] = Stack[-3]
0x267: Stack[-6] = Stack[-2]
...
0x27f: Stack[-2] = "quest_d11_01" // @poff=346
0x280: Stack[-1] = "soldier_attack" // @poff=372
0x281: Call2 0x6d3
...
0x28d: Stack[-2] = "quest_d11_01" // @poff=346
0x28e: Stack[-1] = "soldier_attack" // @poff=372
0x28f: Call2 0x6d3
...
0x2a9: Stack[-2] = Stack[-1]
0x2aa: Call2 0x2d2

0x2ab: Pop(1)
0x2ac: Push("all") // @poff=0
0x2ad: Push("attack_off") // @poff=62
...
0x2ba: Stack[-2] = "quest_d11_01" // @poff=346
0x2bb: Stack[-1] = "soldier_attack" // @poff=372
0x2bc: Call2 0x6d3
...
0x2cd: Push("all") // @poff=0
0x2ce: Push("attack_on") // @poff=84
...
0x2dd: Stack[-2] = Stack[-3]
0x2de: Pop(2)
0x2df: PushEmpty(float, cvector, cvector)
0x2e0: Stack[-5] = Stack[-2]
0x2e1: Stack[-4] = Stack[-1]
0x2e2: Call2 0x6b8

0x2e3: Pop(2)
0x2e4: Push((float)0.7071067690849304)
...
0x2e9: Stack[-1] = (float) 4.71238899230957
0x2ea: Call2 0x5e7
...
0x2fc: IF (Stack[-1] == 1) GOTO 0x2d8; Pop(1)

0x2fd: @ StopAsync()
0x2fe: Pop(0)
0x2ff: Push("spine") // @poff=402
...
0x305: Pop(0)
0x306: @@@ GetEyesHeight(Stack[-2]); Obj=0 // @poff=414
0x307: Pop(0)
...
0x30c: Push("spine") // @poff=402
0x30d: @ DirLookAsyncRel(Stack[-0]T, Stack[-1], Stack[-2])
0x30e: Pop(1)
0x30f: Return(); Pop(6)
...
0x324: Push("all") // @poff=0
0x325: Push("attack_on") // @poff=84
...
0x335: Stack[-2] = "quest_d11_01" // @poff=346
0x336: Stack[-1] = "soldier_attack" // @poff=372
0x337: Call2 0x6d3
...
0x36d: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=428
0x36e: Pop(1)
...
0x392: Stack[-7] = Stack[-3]
0x393: Stack[-6] = Stack[-2]
...
0x3ac: @ GetPFPosition(Stack[-1]T)
0x3ad: Pop(0)
0x3ae: @ GetDirection(Stack[-0]T)
0x3af: Pop(0)
0x3b0: PushEmpty()
0x3b1: Call2 0x404
...
0x3cd: @ FindPathTo(Stack[-1], Stack[-1]T)
0x3ce: Pop(0)
...
0x3dc: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3dd: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3ef: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3f0: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x425: Pop(0); PushNull((bool) Stack[-21] == 0)
0x426: IF (Stack[-1] == 0) GOTO 0x42c; Pop(1)

0x427: PushEmpty(string)
0x428: Stack[-1] = "fdie" // @poff=431
0x429: Call2 0x47f

0x42a: Pop(1)
0x42b: GOTO 0x47e

0x42c: @@ GetPosition(Stack[-10]); Obj=21 // @poff=441
0x42d: Pop(0)
...
0x43d: Stack[-6] = "fdie" // @poff=431
0x43e: GOTO 0x440

0x43f: Stack[-6] = "bdie" // @poff=453
...
0x446: @ StopAsync()
0x447: Pop(0)
0x448: Stack[-21] = Stack[-5]
0x449: Push("GetScriptProperty") // @poff=463
0x44a: Push((int) 2)
0x44b: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x44c: IF (Stack[-1] == 0) GOTO 0x458; Pop(1)

0x44d: Push("Owner") // @poff=499
0x44e: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=511
0x44f: Pop(1)
0x450: Push(Stack[-4])
0x451: IF (Stack[-1] == 0) GOTO 0x458; Pop(1)

0x452: Push("Owner") // @poff=499
0x453: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=529
0x454: Pop(1)
0x455: Pop(0); PushNull((bool) Stack[-5] == 0)
0x456: IF (Stack[-1] == 0) GOTO 0x458; Pop(1)

0x457: Stack[-21] = Stack[-5]
0x458: Push("@GetEyesHeight") // @poff=547
0x459: Push((int) 1)
0x45a: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x45b: IF (Stack[-1] == 0) GOTO 0x467; Pop(1)

0x45c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=414
0x45d: Pop(0)
0x45e: Stack[-1] = [0.0, 0.0, 0.0]
0x45f: Push(CvectorIndex(Stack[-1], 1))
0x460: Stack[-3] = Stack[-1]
0x461: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x462: Push("head") // @poff=577
...
0x469: Stack[-7] = Stack[-1]
0x46a: Call2 0x5f9

0x46b: Pop(1)
0x46c: Push("all") // @poff=0
...
0x473: @ StopAsync()
0x474: Pop(0)
0x475: Push("head") // @poff=577
0x476: @ UnlookAsync(Stack[-1])
0x477: Pop(1)
0x478: Push("all") // @poff=0
...
0x4a9: Stack[-2] = "bullet" // @poff=597
0x4aa: Return(); Pop(0)

0x4ab: Stack[-2] = "phys" // @poff=611
0x4ac: Return(); Pop(0)

0x4ad: PushEmpty(cvector, cvector, cvector, cvector)
0x4ae: @ GetPosition(Stack[-2])
0x4af: Pop(0)
0x4b0: @@ GetPosition(Stack[-1]); Obj=5 // @poff=441
0x4b1: Pop(0)
...
0x4b6: Pop(0)
0x4b7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=441
0x4b8: Pop(0)
...
0x4c9: Push("HasProperty") // @poff=635
0x4ca: Push((int) 2)
...
0x4d0: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=659
0x4d1: Pop(0)
...
0x4d6: Stack[-18] = Stack[-2]
0x4d7: Stack[-1] = "health" // @poff=671
0x4d8: Call2 0x4c8
...
0x4df: Stack[-18] = Stack[-2]
0x4e0: Stack[-1] = "armor" // @poff=685
0x4e1: Call2 0x4c8
...
0x4e7: Push("armor") // @poff=685
0x4e8: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=697
0x4e9: Pop(1)
0x4ea: Push("armor_") // @poff=709
0x4eb: PushEmpty(string, int)
0x4ec: Stack[-16] = Stack[-1]
0x4ed: Call2 0x49f

0x4ee: Pop(1)
0x4ef: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4f0: PushEmpty(bool, object, string)
0x4f1: Stack[-18] = Stack[-2]
0x4f2: Stack[-8] = Stack[-1]
0x4f3: Call2 0x4c8
...
0x4f9: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=697
0x4fa: Pop(0)
...
0x501: Stack[-3] = Stack[-6]
0x502: Pop(3)
0x503: Push("health") // @poff=671
0x504: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=697
0x505: Pop(1)
0x506: Push((int) 1)
0x507: Pop(1); Push(Stack[-1] - Stack[-4]);
0x508: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x509: Push("health") // @poff=671
...
0x50f: Pop(3)
0x510: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=723
0x511: Pop(2)
0x512: PushEmpty(bool, object)
0x513: Stack[-17] = Stack[-1]
0x514: Call2 0x4c3
...
0x51e: @@ IsDead(Stack[-1]); Obj=3 // @poff=735
0x51f: Pop(0)
0x520: Stack[-1] = Stack[-4]
0x521: Return(); Pop(2)

0x522: PushEmpty(object, object, object, object)
0x523: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x537: Pop(0)
0x538: Pop(0); PushNull((bool) Stack[-2] == 0)
0x539: IF (Stack[-1] == 0) GOTO 0x53c; Pop(1)

0x53a: Stack[-6] = (bool) 0
0x53b: Return(); Pop(4)

0x53c: @@ GetScene(Stack[-1]); Obj=5 // @poff=756
0x53d: Pop(0)
...
0x550: Stack[-6] = Stack[-2]
0x551: Stack[-1] = "noaccess" // @poff=765
0x552: Call2 0x4c8
...
0x558: Push("noaccess") // @poff=765
0x559: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=697
0x55a: Pop(1)
0x55b: Push((int) 0)
...
0x55f: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x56d: @@ GetPosition(Stack[-5]); Obj=15 // @poff=441
0x56e: Pop(0)
...
0x57e: Stack[-1] = "fhit" // @poff=783
0x57f: GOTO 0x581

0x580: Stack[-1] = "bhit" // @poff=793
0x581: Push("hit_react") // @poff=803
0x582: Push("1") // @poff=160
0x583: Pop(1); Push(Stack[-3] + Stack[-1]);
0x584: Push("2") // @poff=823
...
0x5bc: Pop(0)
0x5bd: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=836
0x5be: Pop(0)
0x5bf: PushEmpty(object, int, float, cvector, cvector)
0x5c0: Stack[-26] = Stack[-5]
0x5c1: Stack[-25] = Stack[-4]
0x5c2: Stack[-24] = Stack[-3]
0x5c3: Stack[-6] = Stack[-2]
...
0x5dd: @@ GetPosition(Stack[-3]); Obj=7 // @poff=441
0x5de: Pop(0)
...
0x5e8: @@ GetPosition(Stack[-3]); Obj=8 // @poff=441
0x5e9: Pop(0)
...
0x5f4: Pop(0)
0x5f5: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=414
0x5f6: Pop(0)
...
0x63a: Push("woman") // @poff=868
0x63b: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x63c: IF (Stack[-1] == 1) GOTO 0x641; Pop(1)

0x63d: Push("worker") // @poff=880
0x63e: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x63f: IF (Stack[-1] == 1) GOTO 0x641; Pop(1)

0x640: Stack[-1] = (bool) 0
0x641: IF (Stack[-1] == 1) GOTO 0x646; Pop(1)

0x642: Push("butcher") // @poff=894
0x643: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x644: IF (Stack[-1] == 1) GOTO 0x646; Pop(1)

0x645: Stack[-1] = (bool) 0
0x646: IF (Stack[-1] == 1) GOTO 0x64b; Pop(1)

0x647: Push("wasted_girl") // @poff=910
0x648: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x649: IF (Stack[-1] == 1) GOTO 0x64b; Pop(1)

0x64a: Stack[-1] = (bool) 0
0x64b: IF (Stack[-1] == 1) GOTO 0x650; Pop(1)

0x64c: Push("boy") // @poff=934
0x64d: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x64e: IF (Stack[-1] == 1) GOTO 0x650; Pop(1)

0x64f: Stack[-1] = (bool) 0
0x650: IF (Stack[-1] == 1) GOTO 0x655; Pop(1)

0x651: Push("vaxxabitka") // @poff=942
0x652: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x653: IF (Stack[-1] == 1) GOTO 0x655; Pop(1)

0x654: Stack[-1] = (bool) 0
0x655: IF (Stack[-1] == 1) GOTO 0x65a; Pop(1)

0x656: Push("unosha") // @poff=964
0x657: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x658: IF (Stack[-1] == 1) GOTO 0x65a; Pop(1)

0x659: Stack[-1] = (bool) 0
0x65a: IF (Stack[-1] == 1) GOTO 0x65f; Pop(1)

0x65b: Push("wasted_male") // @poff=978
0x65c: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x65d: IF (Stack[-1] == 1) GOTO 0x65f; Pop(1)

0x65e: Stack[-1] = (bool) 0
0x65f: IF (Stack[-1] == 1) GOTO 0x664; Pop(1)

0x660: Push("alkash") // @poff=1002
0x661: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x662: IF (Stack[-1] == 1) GOTO 0x664; Pop(1)

0x663: Stack[-1] = (bool) 0
0x664: IF (Stack[-1] == 1) GOTO 0x669; Pop(1)

0x665: Push("dohodyaga") // @poff=1016
0x666: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x667: IF (Stack[-1] == 1) GOTO 0x669; Pop(1)

0x668: Stack[-1] = (bool) 0
0x669: IF (Stack[-1] == 1) GOTO 0x66e; Pop(1)

0x66a: Push("vaxxabit") // @poff=1036
0x66b: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x66c: IF (Stack[-1] == 1) GOTO 0x66e; Pop(1)

0x66d: Stack[-1] = (bool) 0
0x66e: IF (Stack[-1] == 1) GOTO 0x673; Pop(1)

0x66f: Push("nudegirl") // @poff=1054
0x670: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x671: IF (Stack[-1] == 1) GOTO 0x673; Pop(1)

0x672: Stack[-1] = (bool) 0
0x673: IF (Stack[-1] == 1) GOTO 0x678; Pop(1)

0x674: Push("morlok") // @poff=1072
0x675: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x676: IF (Stack[-1] == 1) GOTO 0x678; Pop(1)
...
0x690: Stack[-2] = Stack[-3]
0x691: GOTO 0x693

0x692: Stack[-1] = Stack[-3]
0x693: Return(); Pop(0)
...
0x69b: Stack[-1] = Stack[-4]
0x69c: Return(); Pop(0)

0x69d: Stack[-3] = Stack[-4]
0x69e: Return(); Pop(0)
...
0x6ba: Stack[-5] = Stack[-2]
0x6bb: Stack[-4] = Stack[-1]
0x6bc: Call2 0x6a5
...
0x6cb: Pop(0)
0x6cc: @@ add(Stack[-3]); Obj=1 // @poff=827
0x6cd: Pop(0)
0x6ce: Push((int) 15)
...
0x6d5: Pop(0)
0x6d6: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x708: Stack[-7] = Stack[-3]
0x709: Stack[-6] = Stack[-2]
0x70a: Stack[-5] = Stack[-1]
0x70b: Call2 0x58a
...
0x710: Stack[-11] = Stack[-5]
0x711: Stack[-10] = Stack[-4]
0x712: Stack[-9] = Stack[-3]
0x713: Stack[-7] = Stack[-2]
...
0x72d: Pop(0)
0x72e: Push((float)0.05000000074505806)
0x72f: Push((bool) 1)
...
0x739: Stack[-7] = Stack[-2]
0x73a: Stack[-1] = "class" // @poff=1114
0x73b: Call2 0x4c8
...
0x741: Push("class") // @poff=1114
0x742: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=697
0x743: Pop(1)
...
0x758: Push("patrol") // @poff=1126
0x759: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x75a: IF (Stack[-1] == 1) GOTO 0x75f; Pop(1)

0x75b: Push("sanitar") // @poff=1140
0x75c: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x75d: IF (Stack[-1] == 1) GOTO 0x75f; Pop(1)

0x75e: Stack[-1] = (bool) 0
0x75f: IF (Stack[-1] == 1) GOTO 0x764; Pop(1)

0x760: Push("soldier") // @poff=1156
0x761: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x762: IF (Stack[-1] == 1) GOTO 0x764; Pop(1)

0x763: Stack[-1] = (bool) 0
0x764: IF (Stack[-1] == 1) GOTO 0x769; Pop(1)

0x765: Push("woman") // @poff=868
0x766: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x767: IF (Stack[-1] == 1) GOTO 0x769; Pop(1)

0x768: Stack[-1] = (bool) 0
0x769: IF (Stack[-1] == 1) GOTO 0x76e; Pop(1)

0x76a: Push("wasted_girl") // @poff=910
0x76b: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x76c: IF (Stack[-1] == 1) GOTO 0x76e; Pop(1)

0x76d: Stack[-1] = (bool) 0
0x76e: IF (Stack[-1] == 1) GOTO 0x773; Pop(1)

0x76f: Push("vaxxabitka") // @poff=942
0x770: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x771: IF (Stack[-1] == 1) GOTO 0x773; Pop(1)

0x772: Stack[-1] = (bool) 0
0x773: IF (Stack[-1] == 1) GOTO 0x778; Pop(1)

0x774: Push("vaxxabit") // @poff=1036
0x775: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x776: IF (Stack[-1] == 1) GOTO 0x778; Pop(1)

0x777: Stack[-1] = (bool) 0
0x778: IF (Stack[-1] == 1) GOTO 0x77d; Pop(1)

0x779: Push("little_girl") // @poff=1172
0x77a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x77b: IF (Stack[-1] == 1) GOTO 0x77d; Pop(1)

0x77c: Stack[-1] = (bool) 0
0x77d: IF (Stack[-1] == 1) GOTO 0x782; Pop(1)

0x77e: Push("girl") // @poff=924
0x77f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x780: IF (Stack[-1] == 1) GOTO 0x782; Pop(1)

0x781: Stack[-1] = (bool) 0
0x782: IF (Stack[-1] == 1) GOTO 0x787; Pop(1)

0x783: Push("dohodyaga") // @poff=1016
0x784: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x785: IF (Stack[-1] == 1) GOTO 0x787; Pop(1)

0x786: Stack[-1] = (bool) 0
0x787: IF (Stack[-1] == 1) GOTO 0x78c; Pop(1)

0x788: Push("nudegirl") // @poff=1054
...
0x79e: Push("worker") // @poff=880
0x79f: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7a0: IF (Stack[-1] == 1) GOTO 0x7a5; Pop(1)

0x7a1: Push("butcher") // @poff=894
0x7a2: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7a3: IF (Stack[-1] == 1) GOTO 0x7a5; Pop(1)

0x7a4: Stack[-1] = (bool) 0
0x7a5: IF (Stack[-1] == 1) GOTO 0x7aa; Pop(1)

0x7a6: Push("boy") // @poff=934
0x7a7: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x7a8: IF (Stack[-1] == 1) GOTO 0x7aa; Pop(1)

0x7a9: Stack[-1] = (bool) 0
0x7aa: IF (Stack[-1] == 1) GOTO 0x7af; Pop(1)

0x7ab: Push("unosha") // @poff=964
0x7ac: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7ad: IF (Stack[-1] == 1) GOTO 0x7af; Pop(1)

0x7ae: Stack[-1] = (bool) 0
0x7af: IF (Stack[-1] == 1) GOTO 0x7b4; Pop(1)

0x7b0: Push("wasted_male") // @poff=978
0x7b1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7b2: IF (Stack[-1] == 1) GOTO 0x7b4; Pop(1)

0x7b3: Stack[-1] = (bool) 0
0x7b4: IF (Stack[-1] == 1) GOTO 0x7b9; Pop(1)

0x7b5: Push("alkash") // @poff=1002
0x7b6: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x7b7: IF (Stack[-1] == 1) GOTO 0x7b9; Pop(1)

0x7b8: Stack[-1] = (bool) 0
0x7b9: IF (Stack[-1] == 1) GOTO 0x7be; Pop(1)

0x7ba: Push("morlok") // @poff=1072
...
0x7eb: Stack[-2] = Stack[-1]
0x7ec: Call2 0x7d1

0x7ed: Pop(1)
0x7ee: PushEmpty(object, bool)
0x7ef: Stack[-3] = Stack[-2]
...
0x81b: Stack[-9] = Stack[-1]
0x81c: Call2 0x4c3

0x81d: Pop(1)
0x81e: IF (Stack[-1] == 0) GOTO 0x825; Pop(1)

0x81f: Push("reputation") // @poff=1196
0x820: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=697
0x821: Pop(1)
0x822: Push((float)0.33000001311302185)
0x823: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x824: Return(); Pop(6)

0x825: PushEmpty(bool, object, string)
0x826: Stack[-10] = Stack[-2]
0x827: Stack[-1] = "class" // @poff=1114
0x828: Call2 0x4c8
...
0x845: Stack[-10] = Stack[-2]
0x846: Stack[-1] = "disease" // @poff=1264
0x847: Call2 0x4c8
...
0x850: Stack[-5] = Stack[-1]
0x851: Call2 0x622

0x852: Pop(1)
0x853: IF (Stack[-1] == 1) GOTO 0x858; Pop(1)

0x854: Push("dog") // @poff=1280
...
0x859: Push("disease") // @poff=1264
0x85a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=697
0x85b: Pop(1)
0x85c: Push((int) 0)
...
0x86b: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=428
0x86c: Pop(1)
0x86d: Push(Stack[-1])
...
0x888: Push(Stack[-2])
0x889: IF (Stack[-1] == 1) GOTO 0x892; Pop(1)

0x88a: PushEmpty(float, object)
0x88b: Stack[-8] = Stack[-1]
0x88c: Call2 0x4b4

0x88d: Pop(1)
0x88e: Push((float)490000.0)
0x88f: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x890: IF (Stack[-1] == 1) GOTO 0x892; Pop(1)
...
0x898: Push("d11q01SoldierAttack") // @poff=1288
...
0x8a9: Pop(0)
0x8aa: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1328
0x8ab: Pop(1)
0x8ac: PushEmpty(bool, string, string)
0x8ad: Stack[-2] = "quest_d11_01" // @poff=346
0x8ae: Stack[-1] = "soldier_death" // @poff=1350
0x8af: Call2 0x6d3

0x8b0: Pop(3)
0x8b1: PushEmpty(object)
0x8b2: Stack[-4] = Stack[-1]
