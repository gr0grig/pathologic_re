...
Strings:
	...
	W:actor_unload
	W:soldier_dead
// @pool_raw:
...
0x143: @ Speak(Stack[-1])
0x144: Pop(1)
0x145: Push("all") // @poff=170
0x146: Push("shoot_end") // @poff=212
...
0x150: Push("all") // @poff=170
0x151: Push("shoot_end") // @poff=212
...
0x163: @ CanSee(Stack[-1]T, Stack[-0]T)
0x164: Pop(0)
...
0x180: Push("all") // @poff=170
0x181: Push("attack_off") // @poff=232
...
0x1a9: Stack[-7] = Stack[-3]
0x1aa: Stack[-6] = Stack[-2]
...
0x1cc: Pop(0)
0x1cd: @ Face(Stack[-0]T)
0x1ce: Pop(0)
0x1cf: Push(Stack[-5])
0x1d0: IF (Stack[-1] == 0) GOTO 0x1d7; Pop(1)

0x1d1: Push("all") // @poff=170
0x1d2: Push("attack_on") // @poff=254
0x1d3: @ PlayAnimation(Stack[-2], Stack[-1])
0x1d4: Pop(2)
0x1d5: @ WaitForAnimEnd()
0x1d6: Pop(0)
0x1d7: Push("all") // @poff=170
0x1d8: Push("attack_on") // @poff=254
...
0x1e3: @ CanSee(Stack[-1], Stack[-0]T)
0x1e4: Pop(0)
0x1e5: Push(Stack[-1])
...
0x1f4: Push("all") // @poff=170
0x1f5: Push("hunt") // @poff=274
...
0x200: Pop(0)
0x201: Push("all") // @poff=170
0x202: Push("attack_on") // @poff=254
...
0x218: Push("all") // @poff=170
0x219: Push("attack_on") // @poff=254
...
0x225: Pop(0)
0x226: Push("all") // @poff=170
0x227: Push("attack_on") // @poff=254
...
0x233: @ CanSee(Stack[-1], Stack[-0]T)
0x234: Pop(0)
0x235: Push(Stack[-1])
0x236: IF (Stack[-1] == 0) GOTO 0x23d; Pop(1)

0x237: @ Face(Stack[-0]T)
0x238: Pop(0)
0x239: PushEmpty()
0x23a: Call2 0x278
...
0x24b: @ StopAsync()
0x24c: Pop(0)
0x24d: Push("all") // @poff=170
0x24e: Push("attack_off") // @poff=232
...
0x286: Pop(0)
0x287: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x288: Pop(1)
...
0x28e: Stack[-2] = Stack[-15]
0x28f: Pop(2)
0x290: PushEmpty(float, cvector, cvector)
0x291: Stack[-17] = Stack[-2]
0x292: Stack[-16] = Stack[-1]
0x293: Call2 0x6b2

0x294: Pop(2)
0x295: Push((float)0.9993908405303955)
...
0x29b: Pop(0)
0x29c: Push("all") // @poff=170
0x29d: Push("attack_begin1") // @poff=306
0x29e: @ PlayAnimation(Stack[-2], Stack[-1])
0x29f: Pop(2)
0x2a0: Push("attack") // @poff=334
...
0x2a6: Pop(0)
0x2a7: Push("light-dynamic") // @poff=348
0x2a8: Push("soldier_fire.xml") // @poff=376
...
0x2c1: Push((float)0.03490658476948738)
...
0x2cf: Stack[-4] = Stack[-7]
0x2d0: Pop(4)
0x2d1: Push((int) 2)
0x2d2: Push((float)1.5)
0x2d3: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x2d4: Pop(2)
0x2d5: GOTO 0x2e5
...
0x2da: Pop(0)
0x2db: Push("scripted") // @poff=410
0x2dc: Push([0.0, 0.0, 1.0])
0x2dd: Push("richochet.xml") // @poff=428
0x2de: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x2df: Pop(3)
0x2e0: Push("Material") // @poff=456
0x2e1: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=474
0x2e2: Pop(1)
0x2e3: Stack[-1] = 0
0x2e4: Stack[-2] = 0
0x2e5: Push("all") // @poff=170
0x2e6: Push("attack_end1") // @poff=492
0x2e7: @ PlayAnimation(Stack[-2], Stack[-1])
0x2e8: Pop(2)
0x2e9: @ WaitForAnimEnd()
0x2ea: Pop(0)
0x2eb: Push("all") // @poff=170
0x2ec: Push("attack_on") // @poff=254
...
0x30b: Stack[-7] = Stack[-3]
0x30c: Stack[-6] = Stack[-2]
0x30d: Stack[-5] = Stack[-1]
0x30e: Call2 0x91d
...
0x334: Stack[-2] = "quest_d11_02" // @poff=532
0x335: Stack[-1] = "soldier_attack" // @poff=558
0x336: Call2 0x6fa
...
0x390: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=620
0x391: Pop(1)
...
0x3b5: Stack[-7] = Stack[-3]
0x3b6: Stack[-6] = Stack[-2]
0x3b7: Stack[-5] = Stack[-1]
0x3b8: Call2 0x91d
...
0x3cf: @ GetPFPosition(Stack[-1]T)
0x3d0: Pop(0)
0x3d1: @ GetDirection(Stack[-0]T)
0x3d2: Pop(0)
0x3d3: PushEmpty()
0x3d4: Call2 0x427
...
0x3f0: @ FindPathTo(Stack[-1], Stack[-1]T)
0x3f1: Pop(0)
...
0x3ff: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x400: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x412: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x413: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x429: Push("all") // @poff=170
0x42a: Push("attack_on") // @poff=254
...
0x431: Push("all") // @poff=170
0x432: Push("attack_on") // @poff=254
...
0x43a: Push("all") // @poff=170
0x43b: Push("attack_begin1") // @poff=306
0x43c: @ PlayAnimation(Stack[-2], Stack[-1])
0x43d: Pop(2)
0x43e: @ WaitForAnimEnd()
0x43f: Pop(0)
0x440: PushEmpty(bool, string, string)
0x441: Stack[-2] = "quest_d11_02" // @poff=532
0x442: Stack[-1] = "execute" // @poff=516
0x443: Call2 0x6fa

0x444: Pop(3)
0x445: Push("shot") // @poff=202
0x446: @ Speak(Stack[-1])
0x447: Pop(1)
0x448: Push("all") // @poff=170
0x449: Push("attack_begin2") // @poff=623
0x44a: @ PlayAnimation(Stack[-2], Stack[-1])
0x44b: Pop(2)
0x44c: @ WaitForAnimEnd()
0x44d: Pop(0)
0x44e: Push("all") // @poff=170
0x44f: Push("attack_off") // @poff=232
...
0x462: Stack[-2] = "quest_d11_02" // @poff=532
0x463: Stack[-1] = "soldier_attack" // @poff=558
0x464: Call2 0x6fa
...
0x479: Stack[-2] = "bullet" // @poff=661
0x47a: Return(); Pop(0)

0x47b: Stack[-2] = "phys" // @poff=675
0x47c: Return(); Pop(0)

0x47d: PushEmpty(cvector, cvector, cvector, cvector)
0x47e: @ GetPosition(Stack[-2])
0x47f: Pop(0)
0x480: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x481: Pop(0)
...
0x486: Pop(0)
0x487: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x488: Pop(0)
...
0x48d: Push("player") // @poff=685
0x48e: @ FindActor(Stack[-2], Stack[-1])
0x48f: Pop(1)
0x490: Stack[-1] = Stack[-3]
0x491: Return(); Pop(2)
...
0x499: Push("HasProperty") // @poff=699
0x49a: Push((int) 2)
...
0x4a0: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=723
0x4a1: Pop(0)
...
0x4a6: Stack[-10] = Stack[-2]
0x4a7: Stack[-9] = Stack[-1]
0x4a8: Call2 0x498
...
0x4ae: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=735
0x4af: Pop(0)
0x4b0: PushEmpty(float, float, float, float)
0x4b1: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4b2: Stack[-8] = Stack[-2]
0x4b3: Stack[-7] = Stack[-1]
0x4b4: Call2 0x689

0x4b5: Pop(3)
0x4b6: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=747
0x4b7: Pop(1)
...
0x4bc: Stack[-18] = Stack[-2]
0x4bd: Stack[-1] = "health" // @poff=759
0x4be: Call2 0x498
...
0x4cd: Push("armor") // @poff=773
0x4ce: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=735
0x4cf: Pop(1)
0x4d0: Push("armor_") // @poff=785
0x4d1: PushEmpty(string, int)
0x4d2: Stack[-16] = Stack[-1]
0x4d3: Call2 0x46f

0x4d4: Pop(1)
0x4d5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4d6: PushEmpty(bool, object, string)
0x4d7: Stack[-18] = Stack[-2]
0x4d8: Stack[-8] = Stack[-1]
0x4d9: Call2 0x498
...
0x4df: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=735
0x4e0: Pop(0)
...
0x4e7: Stack[-3] = Stack[-6]
0x4e8: Pop(3)
0x4e9: Push("health") // @poff=759
0x4ea: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=735
0x4eb: Pop(1)
0x4ec: Push((int) 1)
0x4ed: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4ee: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4ef: Push("health") // @poff=759
...
0x4f5: Pop(3)
0x4f6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=747
0x4f7: Pop(2)
0x4f8: PushEmpty(bool, object)
0x4f9: Stack[-17] = Stack[-1]
0x4fa: Call2 0x493
...
0x500: Pop(1)
0x501: Stack[-1] = Stack[-16]
0x502: Return(); Pop(12)

0x503: PushEmpty(bool, bool)
0x504: @@ IsDead(Stack[-1]); Obj=3 // @poff=799
0x505: Pop(0)
0x506: Stack[-1] = Stack[-4]
0x507: Return(); Pop(2)

0x508: PushEmpty(object, object, object, object)
0x509: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x51d: Pop(0)
0x51e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x51f: IF (Stack[-1] == 0) GOTO 0x522; Pop(1)

0x520: Stack[-6] = (bool) 0
0x521: Return(); Pop(4)

0x522: @@ GetScene(Stack[-1]); Obj=5 // @poff=820
0x523: Pop(0)
...
0x536: Stack[-6] = Stack[-2]
0x537: Stack[-1] = "noaccess" // @poff=829
0x538: Call2 0x498
...
0x53e: Push("noaccess") // @poff=829
0x53f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=735
0x540: Pop(1)
0x541: Push((int) 0)
...
0x545: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x553: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x554: Pop(0)
...
0x564: Stack[-1] = "fhit" // @poff=847
0x565: GOTO 0x567

0x566: Stack[-1] = "bhit" // @poff=857
0x567: Push("hit_react") // @poff=867
0x568: Push("1") // @poff=330
0x569: Pop(1); Push(Stack[-3] + Stack[-1]);
0x56a: Push("2") // @poff=554
...
0x583: Stack[-25] = Stack[-1]
0x584: Call2 0x47d

0x585: Stack[-2] = Stack[-3]
0x586: Pop(2)
0x587: Call2 0x674

0x588: Stack[-2] = Stack[-11]
0x589: Pop(2)
0x58a: @ CreateVectorVector(Stack[-8])
0x58b: Pop(0)
0x58c: Stack[-7] = (int) 1
0x58d: Push("hit") // @poff=849
...
0x5a2: Pop(0)
0x5a3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=896
0x5a4: Pop(0)
0x5a5: PushEmpty(object, int, float, cvector, cvector)
0x5a6: Stack[-26] = Stack[-5]
0x5a7: Stack[-25] = Stack[-4]
0x5a8: Stack[-24] = Stack[-3]
0x5a9: Stack[-6] = Stack[-2]
...
0x5b6: Pop(0)
0x5b7: Push("scripted") // @poff=410
0x5b8: Push("blood_dir.xml") // @poff=900
...
0x5c3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x5c4: Pop(0)
...
0x5cf: Pop(0)
0x5d0: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x5d1: Pop(0)
...
0x5d6: Stack[-7] = Stack[-2]
0x5d7: Stack[-6] = Stack[-1]
0x5d8: Call2 0x694
...
0x63c: Push("wasted_girl") // @poff=970
...
0x646: Push("vaxxabitka") // @poff=1002
...
0x650: Push("wasted_male") // @poff=1038
...
0x65a: Push("dohodyaga") // @poff=1076
0x65b: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x65c: IF (Stack[-1] == 1) GOTO 0x65e; Pop(1)

0x65d: Stack[-1] = (bool) 0
0x65e: IF (Stack[-1] == 1) GOTO 0x663; Pop(1)

0x65f: Push("vaxxabit") // @poff=1096
0x660: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x661: IF (Stack[-1] == 1) GOTO 0x663; Pop(1)

0x662: Stack[-1] = (bool) 0
0x663: IF (Stack[-1] == 1) GOTO 0x668; Pop(1)

0x664: Push("nudegirl") // @poff=1114
0x665: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x666: IF (Stack[-1] == 1) GOTO 0x668; Pop(1)

0x667: Stack[-1] = (bool) 0
0x668: IF (Stack[-1] == 1) GOTO 0x66d; Pop(1)

0x669: Push("morlok") // @poff=1132
0x66a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x66b: IF (Stack[-1] == 1) GOTO 0x66d; Pop(1)
...
0x690: Stack[-1] = Stack[-4]
0x691: Return(); Pop(0)

0x692: Stack[-3] = Stack[-4]
0x693: Return(); Pop(0)
...
0x6b4: Stack[-5] = Stack[-2]
0x6b5: Stack[-4] = Stack[-1]
0x6b6: Call2 0x69f
...
0x6dd: Stack[-8] = Stack[-5]
0x6de: Stack[-4] = "reputation" // @poff=1146
0x6df: Stack[-7] = Stack[-3]
0x6e0: Stack[-2] = (int) 0
0x6e1: Stack[-1] = (int) 1
0x6e2: Call2 0x4a4
...
0x6e8: Pop(0)
0x6e9: @@ add(Stack[-3]); Obj=1 // @poff=887
0x6ea: Pop(0)
0x6eb: Push((int) 15)
...
0x6f2: Pop(0)
0x6f3: @@ add(Stack[-3]); Obj=1 // @poff=887
0x6f4: Pop(0)
0x6f5: Push((int) 16)
...
0x6fc: Pop(0)
0x6fd: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x730: Push("GenerateMoney: iMin > iMax") // @poff=1196
0x731: @ Trace(Stack[-1])
0x732: Pop(1)
0x733: Return(); Pop(4)
...
0x74e: Pop(0)
0x74f: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1262
0x750: Pop(0)
0x751: Push("Organ") // @poff=1274
0x752: Push((int) 1)
0x753: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=747
0x754: Pop(2)
0x755: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1286
0x756: Pop(0)
0x757: Push((int) 0)
0x758: Push((int) 1)
...
0x765: Stack[-1] = "liver" // @poff=1296
0x766: Call2 0x74c

0x767: Pop(1)
0x768: PushEmpty(string)
0x769: Stack[-1] = "kidney" // @poff=1308
0x76a: Call2 0x74c

0x76b: Pop(1)
0x76c: PushEmpty(string)
0x76d: Stack[-1] = "heart" // @poff=1322
0x76e: Call2 0x74c

0x76f: Pop(1)
0x770: PushEmpty(string)
0x771: Stack[-1] = "blood" // @poff=1334
0x772: Call2 0x74c
...
0x77f: Stack[-4] = "rifle_ammo" // @poff=1346
0x780: Stack[-3] = (int) 1
0x781: Stack[-2] = (int) 3
0x782: Stack[-1] = (int) 3
0x783: Call2 0x5df
...
0x78d: Stack[-3] = "bandage" // @poff=1378
0x78e: Stack[-2] = (int) 1
0x78f: Stack[-1] = (int) 6
0x790: Call2 0x5d4
...
0x793: Stack[-3] = "tourniquet" // @poff=1394
0x794: Stack[-2] = (int) 1
0x795: Stack[-1] = (int) 6
0x796: Call2 0x5d4
...
0x7a8: Stack[-7] = Stack[-3]
0x7a9: Stack[-6] = Stack[-2]
0x7aa: Stack[-5] = Stack[-1]
0x7ab: Call2 0x570
...
0x7b0: Stack[-11] = Stack[-5]
0x7b1: Stack[-10] = Stack[-4]
0x7b2: Stack[-9] = Stack[-3]
0x7b3: Stack[-7] = Stack[-2]
...
0x7d9: Stack[-7] = Stack[-2]
0x7da: Stack[-1] = "class" // @poff=1416
0x7db: Call2 0x498
...
0x7e1: Push("class") // @poff=1416
0x7e2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=735
0x7e3: Pop(1)
...
0x7f8: Push("patrol") // @poff=1428
0x7f9: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x7fa: IF (Stack[-1] == 1) GOTO 0x7ff; Pop(1)

0x7fb: Push("sanitar") // @poff=1442
0x7fc: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x7fd: IF (Stack[-1] == 1) GOTO 0x7ff; Pop(1)

0x7fe: Stack[-1] = (bool) 0
0x7ff: IF (Stack[-1] == 1) GOTO 0x804; Pop(1)

0x800: Push("soldier") // @poff=1458
0x801: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x802: IF (Stack[-1] == 1) GOTO 0x804; Pop(1)

0x803: Stack[-1] = (bool) 0
0x804: IF (Stack[-1] == 1) GOTO 0x809; Pop(1)

0x805: Push("woman") // @poff=928
0x806: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x807: IF (Stack[-1] == 1) GOTO 0x809; Pop(1)

0x808: Stack[-1] = (bool) 0
0x809: IF (Stack[-1] == 1) GOTO 0x80e; Pop(1)

0x80a: Push("wasted_girl") // @poff=970
0x80b: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x80c: IF (Stack[-1] == 1) GOTO 0x80e; Pop(1)

0x80d: Stack[-1] = (bool) 0
0x80e: IF (Stack[-1] == 1) GOTO 0x813; Pop(1)

0x80f: Push("vaxxabitka") // @poff=1002
0x810: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x811: IF (Stack[-1] == 1) GOTO 0x813; Pop(1)

0x812: Stack[-1] = (bool) 0
0x813: IF (Stack[-1] == 1) GOTO 0x818; Pop(1)

0x814: Push("vaxxabit") // @poff=1096
0x815: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x816: IF (Stack[-1] == 1) GOTO 0x818; Pop(1)

0x817: Stack[-1] = (bool) 0
0x818: IF (Stack[-1] == 1) GOTO 0x81d; Pop(1)

0x819: Push("little_girl") // @poff=1474
0x81a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x81b: IF (Stack[-1] == 1) GOTO 0x81d; Pop(1)

0x81c: Stack[-1] = (bool) 0
0x81d: IF (Stack[-1] == 1) GOTO 0x822; Pop(1)

0x81e: Push("girl") // @poff=984
0x81f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x820: IF (Stack[-1] == 1) GOTO 0x822; Pop(1)

0x821: Stack[-1] = (bool) 0
0x822: IF (Stack[-1] == 1) GOTO 0x827; Pop(1)

0x823: Push("dohodyaga") // @poff=1076
0x824: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x825: IF (Stack[-1] == 1) GOTO 0x827; Pop(1)

0x826: Stack[-1] = (bool) 0
0x827: IF (Stack[-1] == 1) GOTO 0x82c; Pop(1)

0x828: Push("nudegirl") // @poff=1114
...
0x83e: Push("worker") // @poff=940
0x83f: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x840: IF (Stack[-1] == 1) GOTO 0x845; Pop(1)

0x841: Push("butcher") // @poff=954
0x842: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x843: IF (Stack[-1] == 1) GOTO 0x845; Pop(1)

0x844: Stack[-1] = (bool) 0
0x845: IF (Stack[-1] == 1) GOTO 0x84a; Pop(1)

0x846: Push("boy") // @poff=994
0x847: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x848: IF (Stack[-1] == 1) GOTO 0x84a; Pop(1)

0x849: Stack[-1] = (bool) 0
0x84a: IF (Stack[-1] == 1) GOTO 0x84f; Pop(1)

0x84b: Push("unosha") // @poff=1024
0x84c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x84d: IF (Stack[-1] == 1) GOTO 0x84f; Pop(1)

0x84e: Stack[-1] = (bool) 0
0x84f: IF (Stack[-1] == 1) GOTO 0x854; Pop(1)

0x850: Push("wasted_male") // @poff=1038
0x851: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x852: IF (Stack[-1] == 1) GOTO 0x854; Pop(1)

0x853: Stack[-1] = (bool) 0
0x854: IF (Stack[-1] == 1) GOTO 0x859; Pop(1)

0x855: Push("alkash") // @poff=1062
0x856: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x857: IF (Stack[-1] == 1) GOTO 0x859; Pop(1)

0x858: Stack[-1] = (bool) 0
0x859: IF (Stack[-1] == 1) GOTO 0x85e; Pop(1)

0x85a: Push("morlok") // @poff=1132
0x85b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x85c: IF (Stack[-1] == 1) GOTO 0x85e; Pop(1)
...
0x868: Stack[-4] = Stack[-2]
0x869: Stack[-3] = Stack[-1]
...
0x8bb: Stack[-9] = Stack[-1]
0x8bc: Call2 0x493

0x8bd: Pop(1)
0x8be: IF (Stack[-1] == 0) GOTO 0x8c5; Pop(1)

0x8bf: Push("reputation") // @poff=1146
0x8c0: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=735
0x8c1: Pop(1)
0x8c2: Push((float)0.33000001311302185)
0x8c3: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x8c4: Return(); Pop(6)

0x8c5: PushEmpty(bool, object, string)
0x8c6: Stack[-10] = Stack[-2]
0x8c7: Stack[-1] = "class" // @poff=1416
0x8c8: Call2 0x498
...
0x8ce: Push("class") // @poff=1416
0x8cf: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=735
0x8d0: Pop(1)
0x8d1: PushEmpty(bool)
0x8d2: Stack[-1] = (bool) 1
0x8d3: PushEmpty(bool)
0x8d4: Stack[-1] = (bool) 1
0x8d5: Push("bomber") // @poff=1498
0x8d6: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8d7: IF (Stack[-1] == 1) GOTO 0x8dc; Pop(1)

0x8d8: Push("hunter") // @poff=1512
0x8d9: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8da: IF (Stack[-1] == 1) GOTO 0x8dc; Pop(1)

0x8db: Stack[-1] = (bool) 0
0x8dc: IF (Stack[-1] == 1) GOTO 0x8e1; Pop(1)

0x8dd: Push("grabitel") // @poff=1526
0x8de: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8df: IF (Stack[-1] == 1) GOTO 0x8e1; Pop(1)
...
0x8e5: Stack[-10] = Stack[-2]
0x8e6: Stack[-1] = "disease" // @poff=1544
0x8e7: Call2 0x498
...
0x8f0: Stack[-5] = Stack[-1]
0x8f1: Call2 0x617

0x8f2: Pop(1)
0x8f3: IF (Stack[-1] == 1) GOTO 0x8f8; Pop(1)

0x8f4: Push("dog") // @poff=1560
0x8f5: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8f6: IF (Stack[-1] == 1) GOTO 0x8f8; Pop(1)

0x8f7: Stack[-1] = (bool) 0
0x8f8: IF (Stack[-1] == 0) GOTO 0x8ff; Pop(1)

0x8f9: Push("disease") // @poff=1544
0x8fa: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=735
0x8fb: Pop(1)
0x8fc: Push((int) 0)
...
0x90b: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=620
0x90c: Pop(1)
0x90d: Push(Stack[-1])
...
0x912: Stack[-5] = Stack[-1]
0x913: Call2 0x8b1

0x914: Stack[-2] = Stack[-6]
0x915: Pop(2)
0x916: Return(); Pop(2)
...
0x928: Push(Stack[-2])
0x929: IF (Stack[-1] == 1) GOTO 0x932; Pop(1)

0x92a: PushEmpty(float, object)
0x92b: Stack[-8] = Stack[-1]
0x92c: Call2 0x484

0x92d: Pop(1)
0x92e: Push((float)490000.0)
0x92f: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x930: IF (Stack[-1] == 1) GOTO 0x932; Pop(1)
...
0x938: Stack[-2] = "quest_d11_02" // @poff=532
0x939: Stack[-1] = "actor_unload" // @poff=1568
0x93a: Call2 0x6fa
...
0x94c: Stack[-2] = "quest_d11_02" // @poff=532
0x94d: Stack[-1] = "soldier_dead" // @poff=1594
0x94e: Call2 0x6fa
...
0x956: Stack[-4] = Stack[-2]
0x957: Stack[-1] = (float) 0.029999999329447746
0x958: Call2 0x6c3
