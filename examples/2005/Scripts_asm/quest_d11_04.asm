...
Strings:
	...
	W:completed
	W:cleanup
// @pool_raw:64003100310071003000340000006600610069006c00000063006f006d0070006c006500740065006400000063006c00650061006e00750070000000
...
0x38: Push("cleanup") // @poff=44
0x39: @ Trigger(Stack[-0]T, Stack[-1])
0x3a: Pop(1)
