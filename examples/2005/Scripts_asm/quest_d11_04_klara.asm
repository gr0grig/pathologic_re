...
0x3b2: Stack[-1] = 0
0x3b3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3b4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x3b5: @ RotateAsync(Stack[-2], Stack[-1])
0x3b6: Pop(2)
0x3b7: Return(); Pop(0)

0x3b8: PushEmpty(object, bool, object, bool)
0x3b9: Push("player") // @poff=188
...
0x46f: Stack[-3] = (int) 0
0x470: Push("all") // @poff=138
0x471: PushEmpty(string, int)
0x472: Stack[-6] = Stack[-1]
0x473: Call2 0x5fd
...
0x493: Pop(0)
0x494: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x495: Pop(0)
...
0x4a0: Pop(2)
0x4a1: Stack[-1] = Stack[-8]
0x4a2: Return(); Pop(6)

0x4a3: PushEmpty(cvector, cvector)
0x4a4: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x4a5: Pop(0)
...
0x4b2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x4b3: Pop(0)
0x4b4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=214
0x4b5: Pop(0)
...
0x51f: Push("voice_common") // @poff=238
0x520: Push((int) 1)
...
0x527: Push("voice_common") // @poff=238
0x528: Push((int) 0)
...
0x53a: Push("voice_common") // @poff=238
0x53b: Push((int) 1)
...
0x548: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x549: Pop(1)
...
0x55d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x55e: Pop(1)
0x55f: PushEmpty(bool, string)
0x560: Stack[-3] = Stack[-1]
0x561: Call2 0x59d

0x562: Stack[-2] = Stack[-14]
0x563: Pop(2)
0x564: Return(); Pop(10)

0x565: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x566: Push("d") // @poff=234
0x567: PushEmpty(int)
0x568: Call2 0x5f4

0x569: Pop(0)
0x56a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x56b: Push("m") // @poff=292
...
0x573: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x574: Pop(1)
...
0x588: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x589: Pop(1)
0x58a: PushEmpty(bool, string)
0x58b: Stack[-3] = Stack[-1]
0x58c: Call2 0x59d

0x58d: Stack[-2] = Stack[-14]
0x58e: Pop(2)
0x58f: Return(); Pop(10)
...
0x5ca: Pop(0)
0x5cb: @@ add(Stack[-4]); Obj=1 // @poff=296
0x5cc: Pop(0)
0x5cd: @@ add(Stack[-3]); Obj=1 // @poff=296
0x5ce: Pop(0)
0x5cf: Push((int) 3)
...
0x5d5: @@ GetItemID(Stack[-3]); Obj=8 // @poff=300
0x5d6: Pop(0)
0x5d7: Push("Category") // @poff=310
0x5d8: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5d9: Pop(1)
0x5da: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=328
0x5db: Pop(0)
0x5dc: Pop(0); Push((bool) Stack[-1] == 0)
0x5dd: IF (Stack[-1] == 0) GOTO 0x5e1; Pop(1)

0x5de: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=336
0x5df: Pop(0)
0x5e0: GOTO 0x5e6

0x5e1: PushEmpty(int, int)
0x5e2: Stack[-5] = Stack[-2]
0x5e3: Stack[-9] = Stack[-1]
0x5e4: Call2 0x5c8
...
0x5e9: Pop(0)
0x5ea: @@ SetItemName(Stack[-4]); Obj=1 // @poff=346
0x5eb: Pop(0)
0x5ec: PushEmpty(object, object, int)
0x5ed: Stack[-8] = Stack[-3]
0x5ee: Stack[-4] = Stack[-2]
0x5ef: Stack[-6] = Stack[-1]
0x5f0: Call2 0x5d4
...
0x605: Stack[-2] = (int) 0
0x606: Push("all") // @poff=138
0x607: PushEmpty(string, int)
0x608: Stack[-5] = Stack[-1]
0x609: Call2 0x5fd
...
0x613: Stack[-2] = Stack[-5]
0x614: Return(); Pop(4)

0x615: PushEmpty()
0x616: Push("d11q06KlaraRing") // @poff=358
0x617: Push((int) 1)
...
0x61c: Pop(0)
0x61d: Push("d11q06KlaraRing is given") // @poff=390
0x61e: @ Trace(Stack[-1])
0x61f: Pop(1)
0x620: PushEmpty(object, string, int)
0x621: Stack[-5] = Stack[-3]
0x622: Stack[-2] = "d11q06KlaraRing" // @poff=358
0x623: Stack[-1] = (int) 1
0x624: Call2 0x5e7
...
0x62b: Stack[-1] = "d11q06KapellaRing" // @poff=440
0x62c: Call2 0x5c3
...
0x632: Stack[-1] = "d11q06KlaraRing" // @poff=358
0x633: Call2 0x5c3
...
0x642: PushEmpty()
0x643: Push("ood11Klara2") // @poff=490
0x644: Push((int) 1)
...
0x648: PushEmpty()
0x649: Push("ood11Klara3") // @poff=514
0x64a: Push((int) 1)
...
0x64e: PushEmpty()
0x64f: Push("ood11Klara1") // @poff=538
0x650: Push((int) 1)
...
0x662: Stack[-1] = "ood11Klara2" // @poff=490
0x663: Call2 0x5c3
...
0x66e: Stack[-1] = "ood11Klara3" // @poff=514
0x66f: Call2 0x5c3
...
0x67a: Stack[-1] = "ood11Klara1" // @poff=538
0x67b: Call2 0x5c3
...
0x6a3: Push("Can't retrieve diary root") // @poff=562
0x6a4: @ Trace(Stack[-1])
0x6a5: Pop(1)
...
0x6af: Pop(1)
0x6b0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=614
0x6b1: Pop(0)
0x6b2: Pop(0); Push((bool) Stack[-2] == 0)
0x6b3: IF (Stack[-1] == 0) GOTO 0x6ba; Pop(1)

0x6b4: Push("Can't find diary parent with id: ") // @poff=619
...
0x6ba: @@ AddChild(Stack[-8]); Obj=2 // @poff=687
0x6bb: Pop(0)
0x6bc: Push((int) 7)
0x6bd: @ SendWorldWndMessage(Stack[-1])
0x6be: Pop(1)
0x6bf: @@ GetCategory(Stack[-1]); Obj=8 // @poff=696
0x6c0: Pop(0)
...
0x6dc: Stack[-1] = "ui/NPC_Klara.png" // @poff=722
0x6dd: Return(); Pop(0)

0x6de: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=756
0x6df: Return(); Pop(0)
