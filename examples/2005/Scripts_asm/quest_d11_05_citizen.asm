...
0x6a5: Pop(0)
0x6a6: @@ add(Stack[-3]); Obj=1 // @poff=716
0x6a7: Pop(0)
0x6a8: Push((int) 16)
...
0x6e3: Stack[-7] = Stack[-3]
0x6e4: Stack[-6] = Stack[-2]
...
0x6eb: Stack[-11] = Stack[-5]
0x6ec: Stack[-10] = Stack[-4]
0x6ed: Stack[-9] = Stack[-3]
0x6ee: Stack[-7] = Stack[-2]
0x6ef: Stack[-6] = Stack[-1]
0x6f0: Call2 0x602
...
0x72b: Pop(0)
0x72c: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=835
0x72d: Pop(1)
