...
Strings:
	...
	W:teleport
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xe7: Push("player") // @poff=156
0xe8: @ FindActor(Stack[-4]T, Stack[-1])
0xe9: Pop(1)
...
0xfc: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x151: Pop(0)
0x152: Push("all") // @poff=138
0x153: PushEmpty(string, int)
0x154: Stack[-7] = Stack[-1]
0x155: Call2 0x21c
...
0x187: Pop(0)
0x188: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x189: Pop(0)
...
0x193: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x194: Pop(0)
0x195: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x196: Pop(0)
...
0x1bb: @ StopWorld()
0x1bc: Pop(0)
0x1bd: @ CameraTransit(Stack[-3], Stack[-5])
0x1be: Pop(0)
0x1bf: Push(CvectorIndex(Stack[-4], 0))
0x1c0: Push(CvectorIndex(Stack[-5], 2))
0x1c1: @ Rotate(Stack[-2], Stack[-1])
0x1c2: Pop(2)
...
0x1c8: Push("head") // @poff=170
0x1c9: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1ca: Pop(1)
0x1cb: Push(Stack[-1])
0x1cc: IF (Stack[-1] == 0) GOTO 0x1d0; Pop(1)

0x1cd: Push("head") // @poff=170
0x1ce: @ LookAsyncCamera(Stack[-1])
0x1cf: Pop(1)
0x1d0: @ CameraWaitForPlayFinish()
0x1d1: Pop(0)
0x1d2: @ ResumeWorld()
0x1d3: Pop(0)
0x1d4: Stack[-21] = (bool) 1
0x1d5: Return(); Pop(18)

0x1d6: PushEmpty(bool, bool)
...
0x1de: Push("head") // @poff=170
0x1df: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1e0: Pop(1)
0x1e1: Push(Stack[-1])
0x1e2: IF (Stack[-1] == 0) GOTO 0x1e6; Pop(1)

0x1e3: Push("head") // @poff=170
0x1e4: @ UnlookAsync(Stack[-1])
0x1e5: Pop(1)
0x1e6: Return(); Pop(2)

0x1e7: PushEmpty(float, float, float, float)
0x1e8: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x1e9: Pop(0)
0x1ea: Push((bool) 0)
0x1eb: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1ec: Pop(1)
0x1ed: Return(); Pop(4)

0x1ee: PushEmpty(float, float, float, float)
0x1ef: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x1f0: Pop(0)
0x1f1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x1f2: Pop(0)
0x1f3: Return(); Pop(4)

0x1f4: PushEmpty(float, cvector, float, cvector)
0x1f5: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x1f6: Pop(0)
0x1f7: Stack[-1] = [0.0, 0.0, 0.0]
0x1f8: Push(CvectorIndex(Stack[-1], 1))
0x1f9: Stack[-3] = Stack[-1]
0x1fa: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x1fb: Push("head") // @poff=170
0x1fc: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x1fd: Pop(1)
0x1fe: Return(); Pop(4)
...
0x207: Pop(0); Push(Stack[-3] | Stack[-3]);
0x208: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x209: Push((float)9.999999974752427e-07)
0x20a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x20b: IF (Stack[-1] == 0) GOTO 0x20e; Pop(1)

0x20c: Stack[-4] = [0.0, 0.0, 0.0]
0x20d: Return(); Pop(2)

0x20e: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x20f: Return(); Pop(2)

0x210: PushEmpty(object, object)
0x211: @ FindActor(Stack[-1], Stack[-4])
0x212: Pop(0)
0x213: Pop(0); PushNull((bool) Stack[-1] == 0)
0x214: IF (Stack[-1] == 0) GOTO 0x217; Pop(1)

0x215: Stack[-5] = (bool) 0
0x216: Return(); Pop(2)

0x217: @ Trigger(Stack[-1], Stack[-3])
0x218: Pop(0)
0x219: Stack[-5] = (bool) 1
0x21a: Return(); Pop(2)

0x21b: Stack[-1] = 0
0x21c: PushEmpty(string, string)
0x21d: Stack[-1] = "idle" // @poff=146
0x21e: Push(Stack[-3])
0x21f: IF (Stack[-1] == 0) GOTO 0x221; Pop(1)

0x220: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x221: Stack[-1] = Stack[-4]
0x222: Return(); Pop(2)

0x223: PushEmpty(int, bool, int, bool)
0x224: Stack[-2] = (int) 0
...
0x229: Pop(1)
0x22a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x22b: Pop(2)
...
0x22f: Push((int) 1)
0x230: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x231: GOTO 0x225

0x232: Stack[-2] = Stack[-5]
0x233: Return(); Pop(4)

0x234: Stack[-1] = (int) 518097
0x235: Return(); Pop(0)

0x236: Stack[-1] = (int) 518096
0x237: Return(); Pop(0)

0x238: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=206
0x239: Return(); Pop(0)

0x23a: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=246
0x23b: Return(); Pop(0)
...
0x23e: PushEmpty()
0x23f: PushEmpty(bool, string, string)
0x240: Stack[-2] = "quest_d11_05" // @poff=290
0x241: Stack[-1] = "teleport" // @poff=316
0x242: Call2 0x210
...
0x246: Push("branch") // @poff=334
0x247: @ GetVariable(Stack[-1], Stack[-2])
0x248: Pop(1)
0x249: Push((int) 0)
