...
0x16: Push("player") // @poff=0
0x17: @ FindActor(Stack[-4]T, Stack[-1])
0x18: Pop(1)
...
0x2b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0xb6: Pop(0)
0xb7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=32
0xb8: Pop(0)
