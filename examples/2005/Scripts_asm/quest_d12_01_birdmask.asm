...
// @pool_raw:
// @pool_encoding:utf8
...
0x24a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x24b: Pop(0)
0x24c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=168
0x24d: Pop(0)
...
0x2c1: Push("Door ") // @poff=192
0x2c2: Pop(1); Push(Stack[-1] + Stack[-5]);
0x2c3: Push(" not found") // @poff=204
0x2c4: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2c5: @ Trace(Stack[-1])
0x2c6: Pop(1)
0x2c7: GOTO 0x2cb

0x2c8: Push("locked") // @poff=226
0x2c9: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=240
0x2ca: Pop(1)
0x2cb: Return(); Pop(2)
...
0x2cf: Pop(0)
0x2d0: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2e3: Stack[-2] = "sobor@door1" // @poff=252
...
0x2ea: Stack[-2] = "quest_d12_01" // @poff=276
0x2eb: Stack[-1] = "init_sobor" // @poff=302
0x2ec: Call2 0x2cd
...
0x326: Stack[-1] = "ui/NPC_Black.png" // @poff=338
0x327: Return(); Pop(0)

0x328: Stack[-1] = "ui/NPC_Black_b.png" // @poff=372
0x329: Return(); Pop(0)
