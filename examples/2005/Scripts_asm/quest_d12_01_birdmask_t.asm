...
Strings:
	...
	A:size
	A:get
// @pool_raw:
// @pool_encoding:utf8
...
0x120: Push((int) 535491)
0x121: Push((int) 37174)
0x122: Push((int) 37173)
0x123: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x124: Pop(3)
0x125: Push((int) 535504)
0x126: Push((int) -1)
0x127: Push((int) 37186)
...
0x348: PushEmpty()
0x349: Push("ood12BirdmaskT") // @poff=278
0x34a: Push((int) 1)
...
0x34e: PushEmpty()
0x34f: Push("ood12BirdmaskT2") // @poff=308
0x350: Push((int) 1)
...
0x354: PushEmpty()
0x355: PushEmpty(bool, string, string)
0x356: Stack[-2] = "quest_d12_01" // @poff=340
0x357: Stack[-1] = "init_theater" // @poff=366
0x358: Call2 0x31a
...
0x367: Stack[-1] = "ood12BirdmaskT" // @poff=278
0x368: Call2 0x315
...
0x373: Stack[-1] = "ood12BirdmaskT2" // @poff=308
0x374: Call2 0x315
...
0x37f: Stack[-1] = "d12q01ChildsAreVisited" // @poff=392
0x380: Call2 0x315
...
0x3a0: PushEmpty()
0x3a1: Push((int) 18)
0x3a2: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3a3: Pop(1)
0x3a4: Push((int) 24)
0x3a5: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3a6: Pop(1)
0x3a7: Push((int) 20)
0x3a8: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3a9: Pop(1)
0x3aa: Push((int) 14)
0x3ab: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3ac: Pop(1)
0x3ad: Push((bool) 0)
...
0x3b0: Push((int) 10)
0x3b1: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3b2: Pop(1)
0x3b3: Push((int) 17)
0x3b4: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3b5: Pop(1)
0x3b6: Push((int) 8)
0x3b7: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3b8: Pop(1)
0x3b9: GOTO 0x3c0
...
0x3bd: Push((int) 10)
0x3be: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3bf: Pop(1)
0x3c0: Return(); Pop(0)

0x3c1: PushEmpty()
0x3c2: Push((int) 6)
0x3c3: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3c4: Pop(1)
0x3c5: Push((int) 26)
0x3c6: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3c7: Pop(1)
0x3c8: Push((int) 2)
0x3c9: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3ca: Pop(1)
0x3cb: Push((int) 22)
0x3cc: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3cd: Pop(1)
0x3ce: Push((bool) 0)
...
0x3d1: Push((int) 15)
0x3d2: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3d3: Pop(1)
0x3d4: Push((int) 5)
0x3d5: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3d6: Pop(1)
0x3d7: Push((int) 16)
0x3d8: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3d9: Pop(1)
0x3da: Push((int) 19)
0x3db: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3dc: Pop(1)
0x3dd: GOTO 0x3e4
...
0x3e1: Push((int) 15)
0x3e2: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3e3: Pop(1)
0x3e4: Return(); Pop(0)

0x3e5: PushEmpty()
0x3e6: Push((int) 7)
0x3e7: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3e8: Pop(1)
0x3e9: Push((int) 23)
0x3ea: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3eb: Pop(1)
0x3ec: Push((int) 21)
0x3ed: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3ee: Pop(1)
0x3ef: Push((int) 9)
0x3f0: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3f1: Pop(1)
0x3f2: Push((int) 3)
0x3f3: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3f4: Pop(1)
0x3f5: Push((int) 1)
0x3f6: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3f7: Pop(1)
0x3f8: Push((int) 11)
0x3f9: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3fa: Pop(1)
0x3fb: Push((int) 13)
0x3fc: @@ add(Stack[-1]); Obj=4 // @poff=452
0x3fd: Pop(1)
0x3fe: Push((bool) 0)
...
0x401: Push((int) 25)
0x402: @@ add(Stack[-1]); Obj=4 // @poff=452
0x403: Pop(1)
0x404: Return(); Pop(0)

0x405: PushEmpty(int, int)
0x406: Push("vol_") // @poff=456
...
0x421: Pop(3)
0x422: @@ size(Stack[-3]); Obj=4 // @poff=466
0x423: Pop(0)
0x424: Stack[-2] = (int) 0
0x425: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x426: IF (Stack[-1] == 0) GOTO 0x43c; Pop(1)

0x427: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=471
0x428: Pop(0)
...
0x447: Pop(3)
0x448: @@ size(Stack[-3]); Obj=4 // @poff=466
0x449: Pop(0)
0x44a: Stack[-2] = (int) 0
0x44b: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x44c: IF (Stack[-1] == 0) GOTO 0x462; Pop(1)

0x44d: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=471
0x44e: Pop(0)
...
0x46d: Pop(3)
0x46e: @@ size(Stack[-3]); Obj=4 // @poff=466
0x46f: Pop(0)
0x470: Stack[-2] = (int) 0
0x471: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x472: IF (Stack[-1] == 0) GOTO 0x488; Pop(1)

0x473: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=471
0x474: Pop(0)
