...
// @pool_raw:
// @pool_encoding:utf8
...
0x1b3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=188
0x1b4: Pop(0)
0x1b5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=200
0x1b6: Pop(0)
...
0x220: Push("voice_common") // @poff=224
0x221: Push((int) 1)
...
0x228: Push("voice_common") // @poff=224
0x229: Push((int) 0)
...
0x23b: Push("voice_common") // @poff=224
0x23c: Push((int) 1)
...
0x249: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x24a: Pop(1)
...
0x274: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x275: Pop(1)
...
0x289: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=266
0x28a: Pop(1)
0x28b: PushEmpty(bool, string)
0x28c: Stack[-3] = Stack[-1]
0x28d: Call2 0x29e

0x28e: Stack[-2] = Stack[-14]
0x28f: Pop(2)
0x290: Return(); Pop(10)

0x291: PushEmpty(float, float, float, float)
0x292: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x293: Pop(0)
0x294: Push((bool) 0)
...
0x299: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x29a: Pop(0)
0x29b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x29c: Pop(0)
0x29d: Return(); Pop(4)
...
0x2a3: @ lshHasSpeech(Stack[-1], Stack[-3])
0x2a4: Pop(0)
0x2a5: Push(Stack[-1])
0x2a6: IF (Stack[-1] == 0) GOTO 0x2ab; Pop(1)

0x2a7: @ lshPlaySpeech(Stack[-3])
0x2a8: Pop(0)
0x2a9: Stack[-4] = (bool) 1
0x2aa: Return(); Pop(2)
...
0x2cd: PushEmpty(int)
0x2ce: Push((int) 24)
0x2cf: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x2d0: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x2d1: Return(); Pop(2)

0x2d2: PushEmpty()
0x2d3: Push("ood12MariaSobor1") // @poff=282
0x2d4: Push((int) 1)
...
0x2da: Stack[-1] = "ood12MariaSobor1" // @poff=282
0x2db: Call2 0x2c4
...
0x2f5: Stack[-1] = (int) 515543
0x2f6: Return(); Pop(0)

0x2f7: Stack[-1] = (int) 502868
0x2f8: Return(); Pop(0)

0x2f9: Stack[-1] = "ui/NPC_Maria.png" // @poff=330
0x2fa: Return(); Pop(0)

0x2fb: Stack[-1] = "ui/NPC_Maria_b.png" // @poff=364
0x2fc: Return(); Pop(0)
