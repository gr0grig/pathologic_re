...
Strings:
	A:IsOnGround
	W:nouse_container
// @pool_raw:49734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
// @pool_encoding:utf8
...
0x2a: IF (Stack[-1] == 1) GOTO 0x31; Pop(1)
...
0x2f: IF (Stack[-1] == 1) GOTO 0x31; Pop(1)
...
0x33: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=0
0x34: Pop(0)
0x35: Push(Stack[-2])
...
0x4c: Push("nouse_container") // @poff=11
