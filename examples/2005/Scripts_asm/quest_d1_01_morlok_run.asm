...
Strings:
	...
	A:GetLocator
	W:Can't find path to point 
	W:Error rotating path
	W:@GetAttackDistance
	A:GetAttackDistance
	W:attack
	A:GetPFPosition
	...
	W:heart
	W:blood
// @pool_raw:
...
Events:
EVENT_6 Op = 0x78d Vars = ()
EVENT_22 Op = 0x7a3 Vars = (object, int, float, float)
EVENT_43 Op = 0x7ab Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x7b5 Vars = (object, string)
...
0x42: Push("player") // @poff=0
0x43: @ FindActor(Stack[-4]T, Stack[-1])
0x44: Pop(1)
...
0x57: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0xac: Pop(0)
0xad: Push("all") // @poff=24
0xae: PushEmpty(string, int)
0xaf: Stack[-7] = Stack[-1]
0xb0: Call2 0x739
...
0xed: Push("pt_d1q01_morlok_run_path") // @poff=32
0xee: Pop(1); Push(Stack[-1] + Stack[-7]);
0xef: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=82
0xf0: Pop(1)
...
0xf4: Push("pt_d1q01_morlok_run_path") // @poff=32
...
0x111: Push("Error rotating path") // @poff=145
...
0x14f: PushEmpty()
0x150: Stack[-3] = (float) 0.20000000298023224
0x151: Return(); Pop(0)
...
0x16a: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x16b: Pop(0)
0x16c: Push(Stack[-8])
0x16d: IF (Stack[-1] == 0) GOTO 0x176; Pop(1)

0x16e: Push("attack") // @poff=241
...
0x18a: Pop(0)
0x18b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=255
0x18c: Pop(0)
...
0x1a6: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=255
0x1a7: Pop(0)
...
0x1c0: Pop(1)
0x1c1: Push("all") // @poff=24
0x1c2: Push("attack_on") // @poff=269
...
0x1da: IF (Stack[-1] == 1) GOTO 0x1e0; Pop(1)

0x1db: PushEmpty(bool)
0x1dc: Call2 0x3ac

0x1dd: Pop(0)
0x1de: IF (Stack[-1] == 1) GOTO 0x1e0; Pop(1)

0x1df: Stack[-1] = (bool) 0
0x1e0: IF (Stack[-1] == 0) GOTO 0x1f1; Pop(1)

0x1e1: @ Face(Stack[-0]T)
0x1e2: Pop(0)
0x1e3: PushEmpty()
0x1e4: Call2 0x3de

0x1e5: Pop(0)
0x1e6: Push("all") // @poff=24
0x1e7: Push("attack_stay") // @poff=289
0x1e8: @ PlayAnimation(Stack[-2], Stack[-1])
0x1e9: Pop(2)
0x1ea: PushEmpty(bool, float)
0x1eb: Stack[-25] = Stack[-1]
0x1ec: Call2 0x328
...
0x1f1: @ Face(Stack[-0]T)
0x1f2: Pop(0)
0x1f3: Push("all") // @poff=24
0x1f4: Push("fjump") // @poff=313
...
0x20f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=255
0x210: Pop(0)
...
0x22e: Push("all") // @poff=24
0x22f: Push("attack_off") // @poff=325
...
0x23c: Push("all") // @poff=24
0x23d: Push("attack_begin") // @poff=347
0x23e: Push((int) 1)
0x23f: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x24a: Push("attack") // @poff=241
0x24b: Push((int) 1)
0x24c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x256: Push("all") // @poff=24
0x257: Push("bjump") // @poff=373
...
0x25e: Push((float)0.8999999761581421)
0x25f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x260: @ GetVictim(Stack[-1], Stack[-4])
0x261: Pop(1)
0x262: @ ReportAttack(Stack[-0]T)
0x263: Pop(0)
...
0x268: Stack[-10] = Stack[-1]
0x269: Call2 0x14f

0x26a: Stack[-3] = Stack[-5]
0x26b: Pop(3)
0x26c: PushEmpty(float, object, float, int)
0x26d: Stack[-7] = Stack[-3]
0x26e: Stack[-6] = Stack[-2]
0x26f: PushEmpty(int, object, int)
0x270: Stack[-10] = Stack[-2]
0x271: Stack[-14] = Stack[-1]
0x272: Call2 0x152

0x273: Stack[-3] = Stack[-4]
0x274: Pop(3)
0x275: Call2 0x5ad

0x276: Stack[-4] = Stack[-5]
0x277: Pop(4)
0x278: PushEmpty(int)
0x279: Call2 0x3dc

0x27a: Pop(0)
0x27b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x27c: Pop(1)
0x27d: PushEmpty(object, float)
0x27e: Stack[-5] = Stack[-2]
...
0x287: Pop(0)
0x288: @ irand(Stack[-4], Stack[-1]T)
0x289: Pop(0)
0x28a: Push((int) 1)
0x28b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x28c: @ Face(Stack[-0]T)
0x28d: Pop(0)
0x28e: Push((bool) 1)
...
0x293: Pop(0)
0x294: Push("all") // @poff=24
0x295: Push("attack_begin") // @poff=347
...
0x2ac: Pop(2)
0x2ad: Push("all") // @poff=24
0x2ae: Push("attack_middle") // @poff=385
...
0x2b6: Pop(0)
0x2b7: Push("all") // @poff=24
0x2b8: Push("attack_middle") // @poff=385
...
0x2cc: Stack[-11] = Stack[-2]
0x2cd: Stack[-6] = Stack[-1]
0x2ce: Call2 0x25d

0x2cf: Pop(2)
0x2d0: Stack[-2] = (int) 1
0x2d1: Push("attack_middle") // @poff=385
0x2d2: Pop(1); Push(Stack[-1] + Stack[-5]);
0x2d3: Push("_") // @poff=413
0x2d4: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2d5: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x2d6: Push("all") // @poff=24
...
0x2fb: Pop(1)
0x2fc: Push("all") // @poff=24
0x2fd: Push("attack_end") // @poff=417
...
0x33c: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=255
0x33d: Pop(0)
...
0x388: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x389: Pop(1)
...
0x38d: @ Face(Stack[-0]T)
0x38e: Pop(0)
0x38f: Push("all") // @poff=24
0x390: Push("bjump") // @poff=373
0x391: @ PlayAnimation(Stack[-2], Stack[-1])
0x392: Pop(2)
0x393: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=255
0x394: Pop(0)
...
0x3ca: @ irand(Stack[-1], Stack[-2]T)
0x3cb: Pop(0)
0x3cc: Push((int) 1)
0x3cd: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3ce: Push("attack") // @poff=241
...
0x3df: Stack[-1] = "attack_stay" // @poff=289
0x3e0: Call2 0x6d0
...
0x40a: Stack[-15] = Stack[-5]
0x40b: Stack[-14] = Stack[-4]
0x40c: Stack[-13] = Stack[-3]
0x40d: Stack[-12] = Stack[-2]
0x40e: Stack[-11] = Stack[-1]
0x40f: Call2 0x454

0x410: Stack[-6] = Stack[-7]
0x411: Pop(6)
0x412: Push( Stack[2 + Tasks[-1].StackPointer] )
0x413: IF (Stack[-1] == 0) GOTO 0x417; Pop(1)

0x414: Push("head") // @poff=14
0x415: @ UnlookAsync(Stack[-1])
0x416: Pop(1)
0x417: Push((int) 1)
0x418: @ KillTimer(Stack[-1])
0x419: Pop(1)
0x41a: Stack[-1] = Stack[-10]
0x41b: Return(); Pop(4)
...
0x457: Stack[-17] = Stack[-7]
0x458: PushEmpty(bool, object)
0x459: Stack[-23] = Stack[-1]
0x45a: Call2 0x4e0
...
0x460: @@ GetPosition(Stack[-5]); Obj=21 // @poff=475
0x461: Pop(0)
...
0x477: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=255
0x478: Pop(0)
...
0x489: Push((int) 0)
0x48a: Push((float)0.30000001192092896)
...
0x4ac: Push((int) 0)
0x4ad: Push((float)0.30000001192092896)
...
0x4e4: Stack[-2] = Stack[-4]
0x4e5: Pop(2)
0x4e6: Return(); Pop(0)

0x4e7: Stack[-1] = "walk" // @poff=487
0x4e8: Return(); Pop(0)

0x4e9: Stack[-1] = "run" // @poff=497
0x4ea: Return(); Pop(0)
...
0x505: Pop(0); PushNull((bool) Stack[-21] == 0)
0x506: IF (Stack[-1] == 0) GOTO 0x50c; Pop(1)

0x507: PushEmpty(string)
0x508: Stack[-1] = "fdie" // @poff=505
0x509: Call2 0x55f

0x50a: Pop(1)
0x50b: GOTO 0x55e

0x50c: @@ GetPosition(Stack[-10]); Obj=21 // @poff=475
0x50d: Pop(0)
...
0x51d: Stack[-6] = "fdie" // @poff=505
0x51e: GOTO 0x520

0x51f: Stack[-6] = "bdie" // @poff=515
...
0x526: @ StopAsync()
0x527: Pop(0)
0x528: Stack[-21] = Stack[-5]
0x529: Push("GetScriptProperty") // @poff=525
0x52a: Push((int) 2)
0x52b: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x52c: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x52d: Push("Owner") // @poff=561
0x52e: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=573
0x52f: Pop(1)
0x530: Push(Stack[-4])
0x531: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x532: Push("Owner") // @poff=561
0x533: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=591
0x534: Pop(1)
0x535: Pop(0); PushNull((bool) Stack[-5] == 0)
0x536: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x537: Stack[-21] = Stack[-5]
0x538: Push("@GetEyesHeight") // @poff=609
0x539: Push((int) 1)
0x53a: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x53b: IF (Stack[-1] == 0) GOTO 0x547; Pop(1)

0x53c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=639
0x53d: Pop(0)
0x53e: Stack[-1] = [0.0, 0.0, 0.0]
0x53f: Push(CvectorIndex(Stack[-1], 1))
0x540: Stack[-3] = Stack[-1]
0x541: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x542: Push("head") // @poff=14
...
0x549: Stack[-7] = Stack[-1]
0x54a: Call2 0x6d0

0x54b: Pop(1)
0x54c: Push("all") // @poff=24
...
0x553: @ StopAsync()
0x554: Pop(0)
0x555: Push("head") // @poff=14
0x556: @ UnlookAsync(Stack[-1])
0x557: Pop(1)
0x558: Push("all") // @poff=24
...
0x589: Stack[-2] = "bullet" // @poff=663
0x58a: Return(); Pop(0)

0x58b: Stack[-2] = "phys" // @poff=677
0x58c: Return(); Pop(0)

0x58d: PushEmpty(cvector, cvector, cvector, cvector)
0x58e: @ GetPosition(Stack[-2])
0x58f: Pop(0)
0x590: @@ GetPosition(Stack[-1]); Obj=5 // @poff=475
0x591: Pop(0)
...
0x596: Pop(0)
0x597: @@ GetPosition(Stack[-2]); Obj=7 // @poff=475
0x598: Pop(0)
...
0x5a2: Push("HasProperty") // @poff=687
0x5a3: Push((int) 2)
...
0x5a9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=711
0x5aa: Pop(0)
...
0x5b8: Stack[-18] = Stack[-2]
0x5b9: Stack[-1] = "armor" // @poff=737
0x5ba: Call2 0x5a1
...
0x5c0: Push("armor") // @poff=737
0x5c1: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=749
0x5c2: Pop(1)
0x5c3: Push("armor_") // @poff=761
0x5c4: PushEmpty(string, int)
0x5c5: Stack[-16] = Stack[-1]
0x5c6: Call2 0x57f

0x5c7: Pop(1)
0x5c8: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5c9: PushEmpty(bool, object, string)
0x5ca: Stack[-18] = Stack[-2]
0x5cb: Stack[-8] = Stack[-1]
0x5cc: Call2 0x5a1
...
0x5d2: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=749
0x5d3: Pop(0)
...
0x5da: Stack[-3] = Stack[-6]
0x5db: Pop(3)
0x5dc: Push("health") // @poff=723
0x5dd: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=749
0x5de: Pop(1)
0x5df: Push((int) 1)
0x5e0: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5e1: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5e2: Push("health") // @poff=723
...
0x5e8: Pop(3)
0x5e9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=775
0x5ea: Pop(2)
0x5eb: PushEmpty(bool, object)
0x5ec: Stack[-17] = Stack[-1]
0x5ed: Call2 0x59c
...
0x5f3: Pop(1)
0x5f4: Stack[-1] = Stack[-16]
0x5f5: Return(); Pop(12)

0x5f6: PushEmpty(bool, bool)
0x5f7: @@ IsDead(Stack[-1]); Obj=3 // @poff=787
0x5f8: Pop(0)
0x5f9: Stack[-1] = Stack[-4]
0x5fa: Return(); Pop(2)

0x5fb: PushEmpty(object, object, object, object)
0x5fc: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x610: Pop(0)
0x611: Pop(0); PushNull((bool) Stack[-2] == 0)
0x612: IF (Stack[-1] == 0) GOTO 0x615; Pop(1)

0x613: Stack[-6] = (bool) 0
0x614: Return(); Pop(4)

0x615: @@ GetScene(Stack[-1]); Obj=5 // @poff=808
0x616: Pop(0)
...
0x629: Stack[-6] = Stack[-2]
0x62a: Stack[-1] = "noaccess" // @poff=817
0x62b: Call2 0x5a1
...
0x631: Push("noaccess") // @poff=817
0x632: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=749
0x633: Pop(1)
0x634: Push((int) 0)
...
0x638: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x646: @@ GetPosition(Stack[-5]); Obj=15 // @poff=475
0x647: Pop(0)
...
0x657: Stack[-1] = "fhit" // @poff=835
0x658: GOTO 0x65a

0x659: Stack[-1] = "bhit" // @poff=845
0x65a: Push("hit_react") // @poff=855
0x65b: Push("1") // @poff=875
0x65c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x65d: Push("2") // @poff=879
...
0x676: Stack[-25] = Stack[-1]
0x677: Call2 0x58d

0x678: Stack[-2] = Stack[-3]
0x679: Pop(2)
0x67a: Call2 0x6ff

0x67b: Stack[-2] = Stack[-11]
0x67c: Pop(2)
0x67d: @ CreateVectorVector(Stack[-8])
0x67e: Pop(0)
0x67f: Stack[-7] = (int) 1
0x680: Push("hit") // @poff=837
...
0x695: Pop(0)
0x696: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=892
0x697: Pop(0)
0x698: PushEmpty(object, int, float, cvector, cvector)
0x699: Stack[-26] = Stack[-5]
0x69a: Stack[-25] = Stack[-4]
0x69b: Stack[-24] = Stack[-3]
0x69c: Stack[-6] = Stack[-2]
...
0x6b6: @@ GetPosition(Stack[-3]); Obj=7 // @poff=475
0x6b7: Pop(0)
...
0x6c6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=639
0x6c7: Pop(0)
0x6c8: Stack[-1] = [0.0, 0.0, 0.0]
0x6c9: Push(CvectorIndex(Stack[-1], 1))
0x6ca: Stack[-3] = Stack[-1]
0x6cb: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6cc: Push("head") // @poff=14
...
0x70c: Stack[-2] = Stack[-3]
0x70d: GOTO 0x70f

0x70e: Stack[-1] = Stack[-3]
0x70f: Return(); Pop(0)
...
0x719: Stack[-3] = Stack[-4]
0x71a: Return(); Pop(0)

0x71b: PushEmpty(object, object)
0x71c: @ CreateFloatVector(Stack[-1])
0x71d: Pop(0)
0x71e: @@ add(Stack[-3]); Obj=1 // @poff=883
0x71f: Pop(0)
0x720: Push((int) 15)
0x721: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x722: Pop(1)
0x723: Return(); Pop(2)

0x724: Stack[-1] = 0
0x725: PushEmpty(bool, bool)
0x726: @ IsPlayerActor(Stack[-3], Stack[-1])
0x727: Pop(0)
0x728: Push(Stack[-1])
0x729: IF (Stack[-1] == 0) GOTO 0x72d; Pop(1)

0x72a: Push("attack") // @poff=241
0x72b: @ PlayGlobalMusic(Stack[-1])
0x72c: Pop(1)
0x72d: Return(); Pop(2)

0x72e: PushEmpty(object, object)
0x72f: @ GetScene(Stack[-1])
0x730: Pop(0)
0x731: Push("battle") // @poff=942
0x732: PushEmpty(object)
0x733: Call2 0x6f9

0x734: Pop(0)
0x735: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x736: Pop(2)
0x737: Return(); Pop(2)

0x738: Stack[-1] = 0
0x739: PushEmpty(string, string)
0x73a: Stack[-1] = "idle" // @poff=956
0x73b: Push(Stack[-3])
0x73c: IF (Stack[-1] == 0) GOTO 0x73e; Pop(1)

0x73d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x73e: Stack[-1] = Stack[-4]
0x73f: Return(); Pop(2)

0x740: PushEmpty(int, bool, int, bool)
0x741: Stack[-2] = (int) 0
0x742: Push("all") // @poff=24
0x743: PushEmpty(string, int)
0x744: Stack[-5] = Stack[-1]
0x745: Call2 0x739

0x746: Pop(1)
0x747: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x748: Pop(2)
...
0x74c: Push((int) 1)
0x74d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x74e: GOTO 0x742

0x74f: Stack[-2] = Stack[-5]
0x750: Return(); Pop(4)

0x751: PushEmpty(int, int)
0x752: Push("branch") // @poff=966
0x753: @ GetVariable(Stack[-1], Stack[-2])
0x754: Pop(1)
...
0x75d: IF (Stack[-1] == 0) GOTO 0x761; Pop(1)

0x75e: @ WorkWithCorpse(Stack[-1])
0x75f: Pop(0)
0x760: GOTO 0x763

0x761: @ Barter(Stack[-1])
0x762: Pop(0)
0x763: Return(); Pop(0)

0x764: PushEmpty(object, int, bool, object, int, bool)
0x765: @ CreateInvItem(Stack[-3])
0x766: Pop(0)
0x767: @@ SetItemName(Stack[-7]); Obj=3 // @poff=980
0x768: Pop(0)
0x769: Push("Organ") // @poff=992
0x76a: Push((int) 1)
0x76b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=775
0x76c: Pop(2)
0x76d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1004
0x76e: Pop(0)
0x76f: Push((int) 0)
0x770: Push((int) 1)
0x771: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x772: Pop(2)
0x773: Return(); Pop(6)
...
0x777: Pop(0)
0x778: Push((int) 1)
0x779: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x77a: IF (Stack[-1] == 0) GOTO 0x77c; Pop(1)

0x77b: Return(); Pop(0)

0x77c: PushEmpty(string)
0x77d: Stack[-1] = "liver" // @poff=1014
0x77e: Call2 0x764

0x77f: Pop(1)
0x780: PushEmpty(string)
0x781: Stack[-1] = "kidney" // @poff=1026
0x782: Call2 0x764

0x783: Pop(1)
0x784: PushEmpty(string)
0x785: Stack[-1] = "heart" // @poff=1040
0x786: Call2 0x764

0x787: Pop(1)
0x788: PushEmpty(string)
0x789: Stack[-1] = "blood" // @poff=1052
0x78a: Call2 0x764
...
0x79d: Push(-1, 0); TaskCall(4)
0x79e: Call2 0x4eb

0x79f: Pop(-1, 0); TaskReturn
0x7a0: Pop(1)
0x7a1: Return(); Pop(2)

0x7a2: Stack[-1] = 0
0x7a3: PushEmpty()
0x7a4: PushEmpty(object, int, float)
0x7a5: Stack[-7] = Stack[-3]
0x7a6: Stack[-6] = Stack[-2]
...
0x7ab: PushEmpty()
0x7ac: PushEmpty(object, int, float, cvector, cvector)
0x7ad: Stack[-11] = Stack[-5]
0x7ae: Stack[-10] = Stack[-4]
0x7af: Stack[-9] = Stack[-3]
0x7b0: Stack[-7] = Stack[-2]
0x7b1: Stack[-6] = Stack[-1]
0x7b2: Call2 0x6a7

0x7b3: Pop(5)
0x7b4: Return(); Pop(0)

0x7b5: PushEmpty(float, float)
0x7b6: Push("health") // @poff=723
0x7b7: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7b8: IF (Stack[-1] == 0) GOTO 0x7c1; Pop(1)

0x7b9: Push("health") // @poff=723
0x7ba: @ GetProperty(Stack[-1], Stack[-2])
0x7bb: Pop(1)
0x7bc: Push((int) 0)
0x7bd: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7be: IF (Stack[-1] == 0) GOTO 0x7c1; Pop(1)

0x7bf: @ SignalDeath(Stack[-4])
0x7c0: Pop(0)
0x7c1: Return(); Pop(2)

0x7c2: PushEmpty()
0x7c3: PushEmpty(object)
