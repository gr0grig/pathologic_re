...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x12d: Push("d1q01bmask") // @poff=156
0x12e: @ GetVariable(Stack[-1], Stack[-2])
0x12f: Pop(1)
0x130: Push("d1q01wmask") // @poff=178
0x131: Push((int) 1)
...
0x137: Stack[-2] = "quest_d1_01" // @poff=200
0x138: Stack[-1] = "remove_masks" // @poff=224
0x139: Call2 0x212
...
0x166: Pop(0)
0x167: Push("all") // @poff=138
0x168: PushEmpty(string, int)
0x169: Stack[-7] = Stack[-1]
0x16a: Call2 0x21e
...
0x1a0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=250
0x1a1: Pop(0)
0x1a2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=262
0x1a3: Pop(0)
...
0x1c8: @ StopWorld()
0x1c9: Pop(0)
0x1ca: @ CameraTransit(Stack[-3], Stack[-5])
0x1cb: Pop(0)
0x1cc: Push(CvectorIndex(Stack[-4], 0))
0x1cd: Push(CvectorIndex(Stack[-5], 2))
...
0x1d5: Push("head") // @poff=276
0x1d6: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1d7: Pop(1)
0x1d8: Push(Stack[-1])
0x1d9: IF (Stack[-1] == 0) GOTO 0x1dd; Pop(1)

0x1da: Push("head") // @poff=276
0x1db: @ LookAsyncCamera(Stack[-1])
0x1dc: Pop(1)
0x1dd: @ CameraWaitForPlayFinish()
0x1de: Pop(0)
0x1df: @ ResumeWorld()
0x1e0: Pop(0)
0x1e1: Stack[-21] = (bool) 1
0x1e2: Return(); Pop(18)

0x1e3: PushEmpty(bool, bool)
0x1e4: @ CameraSwitchToNormal()
0x1e5: Pop(0)
...
0x1eb: Push("head") // @poff=276
0x1ec: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1ed: Pop(1)
0x1ee: Push(Stack[-1])
0x1ef: IF (Stack[-1] == 0) GOTO 0x1f3; Pop(1)

0x1f0: Push("head") // @poff=276
0x1f1: @ UnlookAsync(Stack[-1])
0x1f2: Pop(1)
0x1f3: Return(); Pop(2)

0x1f4: PushEmpty(float, float, float, float)
0x1f5: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x1f6: Pop(0)
0x1f7: Push((bool) 0)
0x1f8: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1f9: Pop(1)
0x1fa: Return(); Pop(4)

0x1fb: PushEmpty(float, float, float, float)
0x1fc: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x1fd: Pop(0)
0x1fe: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x1ff: Pop(0)
0x200: Return(); Pop(4)
...
0x208: PushEmpty(float, float)
0x209: Pop(0); Push(Stack[-3] | Stack[-3]);
0x20a: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x20b: Push((float)9.999999974752427e-07)
0x20c: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x20d: IF (Stack[-1] == 0) GOTO 0x210; Pop(1)

0x20e: Stack[-4] = [0.0, 0.0, 0.0]
0x20f: Return(); Pop(2)

0x210: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x211: Return(); Pop(2)

0x212: PushEmpty(object, object)
0x213: @ FindActor(Stack[-1], Stack[-4])
0x214: Pop(0)
0x215: Pop(0); PushNull((bool) Stack[-1] == 0)
0x216: IF (Stack[-1] == 0) GOTO 0x219; Pop(1)

0x217: Stack[-5] = (bool) 0
0x218: Return(); Pop(2)

0x219: @ Trigger(Stack[-1], Stack[-3])
0x21a: Pop(0)
0x21b: Stack[-5] = (bool) 1
0x21c: Return(); Pop(2)

0x21d: Stack[-1] = 0
0x21e: PushEmpty(string, string)
0x21f: Stack[-1] = "idle" // @poff=146
0x220: Push(Stack[-3])
0x221: IF (Stack[-1] == 0) GOTO 0x223; Pop(1)

0x222: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x223: Stack[-1] = Stack[-4]
0x224: Return(); Pop(2)

0x225: PushEmpty(int, bool, int, bool)
0x226: Stack[-2] = (int) 0
0x227: Push("all") // @poff=138
0x228: PushEmpty(string, int)
0x229: Stack[-5] = Stack[-1]
0x22a: Call2 0x21e

0x22b: Pop(1)
0x22c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x22d: Pop(2)
...
0x231: Push((int) 1)
0x232: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x233: GOTO 0x227

0x234: Stack[-2] = Stack[-5]
0x235: Return(); Pop(4)

0x236: Stack[-1] = (int) 515569
0x237: Return(); Pop(0)

0x238: Stack[-1] = (int) 503354
0x239: Return(); Pop(0)

0x23a: Stack[-1] = "ui/NPC_wmask.png" // @poff=286
0x23b: Return(); Pop(0)

0x23c: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=320
0x23d: Return(); Pop(0)
