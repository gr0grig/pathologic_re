...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0xc: Pop(3)
0xd: Push("storojka") // @poff=92
0xe: @ GetSceneByName(Stack[-2], Stack[-1])
0xf: Pop(1)
0x10: Push("nolaska") // @poff=110
...
0x2c: Stack[-3] = "pt_d1q02_gorbun" // @poff=256
0x2d: Stack[-2] = "pers_gorbun" // @poff=288
0x2e: Stack[-1] = "d1q02_gorbun.xml" // @poff=312
0x2f: Call2 0x9e
...
0x9f: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=392
0xa0: Pop(0)
0xa1: Pop(0); Push((bool) Stack[-4] == 0)
0xa2: IF (Stack[-1] == 0) GOTO 0xab; Pop(1)

0xa3: Push("Locator ") // @poff=403
0xa4: Pop(1); Push(Stack[-1] + Stack[-12]);
0xa5: Push(" doesn't exist") // @poff=421
