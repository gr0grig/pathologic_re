...
Strings:
	...
	W:butcher_fail
	W:butcher_death
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x796 Vars = (object, int, float, float)
EVENT_43 Op = 0x79e Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x7a8 Vars = (object, string)
EVENT_41 Op = 0x7b5 Vars = (object)
...
0x6c6: Push("head") // @poff=530
0x6c7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6c8: Pop(1)
0x6c9: Push(Stack[-1])
0x6ca: IF (Stack[-1] == 0) GOTO 0x6ce; Pop(1)

0x6cb: Push("head") // @poff=530
0x6cc: @ UnlookAsync(Stack[-1])
0x6cd: Pop(1)
0x6ce: Return(); Pop(2)

0x6cf: PushEmpty(float, float, float, float)
0x6d0: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x6d1: Pop(0)
0x6d2: Push((bool) 0)
0x6d3: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6d4: Pop(1)
0x6d5: Return(); Pop(4)

0x6d6: PushEmpty(float, float, float, float)
0x6d7: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x6d8: Pop(0)
0x6d9: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x6da: Pop(0)
0x6db: Return(); Pop(4)

0x6dc: PushEmpty(float, cvector, float, cvector)
0x6dd: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=704
0x6de: Pop(0)
0x6df: Stack[-1] = [0.0, 0.0, 0.0]
0x6e0: Push(CvectorIndex(Stack[-1], 1))
0x6e1: Stack[-3] = Stack[-1]
0x6e2: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6e3: Push("head") // @poff=530
0x6e4: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x6e5: Pop(1)
0x6e6: Return(); Pop(4)
...
0x727: PushEmpty()
0x728: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x729: IF (Stack[-1] == 0) GOTO 0x72c; Pop(1)

0x72a: Stack[-2] = Stack[-3]
0x72b: GOTO 0x72d

0x72c: Stack[-1] = Stack[-3]
0x72d: Return(); Pop(0)

0x72e: PushEmpty()
0x72f: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x730: IF (Stack[-1] == 0) GOTO 0x733; Pop(1)

0x731: Stack[-2] = Stack[-4]
0x732: Return(); Pop(0)

0x733: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x734: IF (Stack[-1] == 0) GOTO 0x737; Pop(1)

0x735: Stack[-1] = Stack[-4]
0x736: Return(); Pop(0)

0x737: Stack[-3] = Stack[-4]
0x738: Return(); Pop(0)

0x739: PushEmpty(object, object)
0x73a: @ CreateFloatVector(Stack[-1])
0x73b: Pop(0)
0x73c: @@ add(Stack[-3]); Obj=1 // @poff=948
0x73d: Pop(0)
0x73e: Push((int) 15)
0x73f: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x740: Pop(1)
0x741: Return(); Pop(2)

0x742: Stack[-1] = 0
0x743: PushEmpty(object, object)
0x744: @ FindActor(Stack[-1], Stack[-4])
0x745: Pop(0)
0x746: Pop(0); PushNull((bool) Stack[-1] == 0)
0x747: IF (Stack[-1] == 0) GOTO 0x74a; Pop(1)

0x748: Stack[-5] = (bool) 0
0x749: Return(); Pop(2)

0x74a: @ Trigger(Stack[-1], Stack[-3])
0x74b: Pop(0)
0x74c: Stack[-5] = (bool) 1
0x74d: Return(); Pop(2)

0x74e: Stack[-1] = 0
0x74f: PushEmpty(bool, bool)
0x750: @ IsPlayerActor(Stack[-3], Stack[-1])
0x751: Pop(0)
0x752: Push(Stack[-1])
0x753: IF (Stack[-1] == 0) GOTO 0x757; Pop(1)

0x754: Push("attack") // @poff=296
0x755: @ PlayGlobalMusic(Stack[-1])
0x756: Pop(1)
0x757: Return(); Pop(2)

0x758: PushEmpty(object, object)
0x759: @ GetScene(Stack[-1])
0x75a: Pop(0)
0x75b: Push("battle") // @poff=212
0x75c: PushEmpty(object)
0x75d: Call2 0x717

0x75e: Pop(0)
0x75f: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x760: Pop(2)
0x761: Return(); Pop(2)

0x762: Stack[-1] = 0
0x763: PushEmpty(int, int)
0x764: Push("branch") // @poff=1007
0x765: @ GetVariable(Stack[-1], Stack[-2])
0x766: Pop(1)
0x767: Push((int) 0)
...
0x774: Stack[-1] = (int) 515562
0x775: Return(); Pop(0)

0x776: Stack[-1] = (int) 503347
0x777: Return(); Pop(0)

0x778: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1021
0x779: Return(); Pop(0)

0x77a: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1061
0x77b: Return(); Pop(0)
...
0x780: Pop(0)
0x781: @ RemoveActor(Stack[-1])
0x782: Pop(1)
0x783: PushEmpty(bool, string, string)
0x784: Stack[-2] = "quest_d1_03" // @poff=172
0x785: Stack[-1] = "butcher_fail" // @poff=1105
0x786: Call2 0x743
...
0x789: PushEmpty()
0x78a: PushEmpty(bool, string, string)
0x78b: Stack[-2] = "quest_d1_03" // @poff=172
0x78c: Stack[-1] = "butcher_death" // @poff=1131
0x78d: Call2 0x743

0x78e: Pop(3)
0x78f: PushEmpty(object)
0x790: Stack[-2] = Stack[-1]
0x791: Push(-1, 0); TaskCall(5)
0x792: Call2 0x4bd

0x793: Pop(-1, 0); TaskReturn
0x794: Pop(1)
0x795: Return(); Pop(0)

0x796: PushEmpty()
0x797: PushEmpty(object, int, float)
0x798: Stack[-7] = Stack[-3]
0x799: Stack[-6] = Stack[-2]
...
0x79e: PushEmpty()
0x79f: PushEmpty(object, int, float, cvector, cvector)
0x7a0: Stack[-11] = Stack[-5]
0x7a1: Stack[-10] = Stack[-4]
0x7a2: Stack[-9] = Stack[-3]
0x7a3: Stack[-7] = Stack[-2]
...
0x7a8: PushEmpty(float, float)
0x7a9: Push("health") // @poff=788
0x7aa: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7ab: IF (Stack[-1] == 0) GOTO 0x7b4; Pop(1)

0x7ac: Push("health") // @poff=788
0x7ad: @ GetProperty(Stack[-1], Stack[-2])
0x7ae: Pop(1)
0x7af: Push((int) 0)
0x7b0: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7b1: IF (Stack[-1] == 0) GOTO 0x7b4; Pop(1)

0x7b2: @ SignalDeath(Stack[-4])
0x7b3: Pop(0)
0x7b4: Return(); Pop(2)
