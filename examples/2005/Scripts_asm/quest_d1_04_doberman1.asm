...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_16 Op = 0xd20 Vars = (object, string)
EVENT_41 Op = 0xd2d Vars = (object)
EVENT_22 Op = 0xd33 Vars = (object, int, float, float)
EVENT_43 Op = 0xd3b Vars = (object, int, float, float, cvector, cvector)
...
0x1a5: Stack[-1] = "Neutral" // @poff=89
0x1a6: Call2 0xa2

0x1a7: Pop(1)
0x1a8: Push((int) 532744)
0x1a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x1aa: Pop(1)
0x1ab: @@@ ClearReplies(); Obj=0 // @poff=116
0x1ac: Pop(0)
...
0x1fe: Pop(0); PushNull((bool) Stack[-21] == 0)
0x1ff: IF (Stack[-1] == 0) GOTO 0x205; Pop(1)

0x200: PushEmpty(string)
0x201: Stack[-1] = "fdie" // @poff=156
0x202: Call2 0x258

0x203: Pop(1)
0x204: GOTO 0x257

0x205: @@ GetPosition(Stack[-10]); Obj=21 // @poff=166
0x206: Pop(0)
...
0x216: Stack[-6] = "fdie" // @poff=156
0x217: GOTO 0x219

0x218: Stack[-6] = "bdie" // @poff=178
...
0x21f: @ StopAsync()
0x220: Pop(0)
0x221: Stack[-21] = Stack[-5]
0x222: Push("GetScriptProperty") // @poff=188
0x223: Push((int) 2)
0x224: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x225: IF (Stack[-1] == 0) GOTO 0x231; Pop(1)

0x226: Push("Owner") // @poff=224
0x227: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=236
0x228: Pop(1)
0x229: Push(Stack[-4])
0x22a: IF (Stack[-1] == 0) GOTO 0x231; Pop(1)

0x22b: Push("Owner") // @poff=224
0x22c: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=254
0x22d: Pop(1)
0x22e: Pop(0); PushNull((bool) Stack[-5] == 0)
0x22f: IF (Stack[-1] == 0) GOTO 0x231; Pop(1)

0x230: Stack[-21] = Stack[-5]
0x231: Push("@GetEyesHeight") // @poff=272
0x232: Push((int) 1)
0x233: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x234: IF (Stack[-1] == 0) GOTO 0x240; Pop(1)

0x235: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0x236: Pop(0)
0x237: Stack[-1] = [0.0, 0.0, 0.0]
0x238: Push(CvectorIndex(Stack[-1], 1))
0x239: Stack[-3] = Stack[-1]
0x23a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x23b: Push("head") // @poff=316
...
0x2be: Stack[-9] = Stack[-3]
0x2bf: Stack[-8] = Stack[-2]
0x2c0: Stack[-7] = Stack[-1]
0x2c1: Call2 0xe6b
...
0x2c5: Stack[-8] = Stack[-2]
0x2c6: Stack[-6] = Stack[-1]
0x2c7: Call2 0xe00

0x2c8: Stack[-3] = Stack[-4]
0x2c9: Pop(3)
0x2ca: Push((int) 0)
...
0x2da: Stack[-5] = Stack[-1]
0x2db: Call2 0xe3b

0x2dc: Stack[-2] = Stack[-3]
0x2dd: Pop(2)
0x2de: Push((int) 0)
...
0x2ee: Stack[-7] = Stack[-2]
0x2ef: Stack[-6] = Stack[-1]
0x2f0: Call2 0xd45
...
0x2fd: Stack[-6] = Stack[-2]
0x2fe: Stack[-7] = Stack[-1]
0x2ff: Call2 0xe17

0x300: Stack[-3] = Stack[-4]
0x301: Pop(3)
0x302: Push((int) 0)
...
0x30c: Stack[-5] = Stack[-2]
0x30d: Stack[-6] = Stack[-1]
0x30e: Call2 0xe1a
...
0x3a9: Stack[-7] = Stack[-1]
0x3aa: Call2 0x3e3

0x3ab: Stack[-2] = Stack[-4]
0x3ac: Pop(2)
...
0x417: Stack[-9] = Stack[-3]
0x418: Stack[-8] = Stack[-2]
0x419: Stack[-7] = Stack[-1]
0x41a: Call2 0xe6b
...
0x41e: Stack[-8] = Stack[-2]
0x41f: Stack[-6] = Stack[-1]
0x420: Call2 0xe00

0x421: Stack[-3] = Stack[-4]
0x422: Pop(3)
0x423: Push((int) 0)
...
0x450: Stack[-6] = Stack[-2]
0x451: Stack[-5] = Stack[-1]
0x452: Call2 0xd65
...
0x456: Stack[-6] = Stack[-2]
0x457: Stack[-7] = Stack[-1]
0x458: Call2 0xe17

0x459: Stack[-3] = Stack[-4]
0x45a: Pop(3)
0x45b: Push((int) 0)
...
0x4af: Pop(0)
0x4b0: Push("all") // @poff=138
0x4b1: PushEmpty(string, int)
0x4b2: Stack[-7] = Stack[-1]
0x4b3: Call2 0xdc5
...
0x4f0: Stack[-6] = Stack[-2]
0x4f1: Stack[-5] = Stack[-1]
0x4f2: Call2 0xbd8
...
0x51d: Stack[-5] = Stack[-1]
0x51e: Call2 0xe0d

0x51f: Stack[-2] = Stack[-3]
0x520: Pop(2)
0x521: Push((int) 0)
...
0x549: Stack[-9] = Stack[-3]
0x54a: Stack[-8] = Stack[-2]
0x54b: Stack[-7] = Stack[-1]
0x54c: Call2 0xe6b
...
0x550: Stack[-8] = Stack[-2]
0x551: Stack[-6] = Stack[-1]
0x552: Call2 0xe00

0x553: Stack[-3] = Stack[-4]
0x554: Pop(3)
0x555: Push((int) 0)
...
0x579: Stack[-7] = Stack[-2]
0x57a: Stack[-6] = Stack[-1]
0x57b: Call2 0xd45
...
0x588: Stack[-6] = Stack[-2]
0x589: Stack[-7] = Stack[-1]
0x58a: Call2 0xe17

0x58b: Stack[-3] = Stack[-4]
0x58c: Pop(3)
0x58d: Push((int) 0)
...
0x597: Stack[-5] = Stack[-2]
0x598: Stack[-6] = Stack[-1]
0x599: Call2 0xe1a
...
0x5d2: Stack[-2] = Stack[-3]
0x5d3: Pop(2)
0x5d4: PushEmpty(float, cvector, cvector)
0x5d5: Stack[-5] = Stack[-2]
0x5d6: Stack[-4] = Stack[-1]
0x5d7: Call2 0xbd8

0x5d8: Pop(2)
0x5d9: Push((float)0.4999999701976776)
...
0x5fe: PushEmpty()
0x5ff: Stack[-3] = (float) 0.029999999329447746
0x600: Return(); Pop(0)
...
0x619: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x61a: Pop(0)
0x61b: Push(Stack[-8])
0x61c: IF (Stack[-1] == 0) GOTO 0x625; Pop(1)

0x61d: Push("attack") // @poff=382
...
0x639: Pop(0)
0x63a: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x63b: Pop(0)
...
0x655: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0x656: Pop(0)
...
0x66f: Pop(1)
0x670: Push("all") // @poff=138
0x671: Push("attack_on") // @poff=410
...
0x689: IF (Stack[-1] == 1) GOTO 0x68f; Pop(1)

0x68a: PushEmpty(bool)
0x68b: Call2 0x85b

0x68c: Pop(0)
0x68d: IF (Stack[-1] == 1) GOTO 0x68f; Pop(1)

0x68e: Stack[-1] = (bool) 0
0x68f: IF (Stack[-1] == 0) GOTO 0x6a0; Pop(1)

0x690: @ Face(Stack[-0]T)
0x691: Pop(0)
0x692: PushEmpty()
0x693: Call2 0x88d

0x694: Pop(0)
0x695: Push("all") // @poff=138
0x696: Push("attack_stay") // @poff=430
0x697: @ PlayAnimation(Stack[-2], Stack[-1])
0x698: Pop(2)
0x699: PushEmpty(bool, float)
0x69a: Stack[-25] = Stack[-1]
0x69b: Call2 0x7d7
...
0x6a0: @ Face(Stack[-0]T)
0x6a1: Pop(0)
0x6a2: Push("all") // @poff=138
0x6a3: Push("fjump") // @poff=454
...
0x6be: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x6bf: Pop(0)
...
0x6dd: Push("all") // @poff=138
0x6de: Push("attack_off") // @poff=466
...
0x6eb: Push("all") // @poff=138
0x6ec: Push("attack_begin") // @poff=488
0x6ed: Push((int) 1)
0x6ee: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x6f9: Push("attack") // @poff=382
0x6fa: Push((int) 1)
0x6fb: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x705: Push("all") // @poff=138
0x706: Push("bjump") // @poff=514
...
0x70d: Push((float)0.8999999761581421)
0x70e: Pop(1); Push(Stack[-9] * Stack[-1]);
0x70f: @ GetVictim(Stack[-1], Stack[-4])
0x710: Pop(1)
0x711: @ ReportAttack(Stack[-0]T)
0x712: Pop(0)
...
0x716: Stack[-6] = Stack[-2]
0x717: Stack[-10] = Stack[-1]
0x718: Call2 0x5fe

0x719: Stack[-3] = Stack[-5]
0x71a: Pop(3)
0x71b: PushEmpty(float, object, float, int)
0x71c: Stack[-7] = Stack[-3]
0x71d: Stack[-6] = Stack[-2]
0x71e: PushEmpty(int, object, int)
0x71f: Stack[-10] = Stack[-2]
0x720: Stack[-14] = Stack[-1]
0x721: Call2 0x601

0x722: Stack[-3] = Stack[-4]
0x723: Pop(3)
0x724: Call2 0x9cf

0x725: Stack[-4] = Stack[-5]
0x726: Pop(4)
0x727: PushEmpty(int)
0x728: Call2 0x88b

0x729: Pop(0)
0x72a: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x72b: Pop(1)
0x72c: PushEmpty(object, float)
0x72d: Stack[-5] = Stack[-2]
...
0x736: Pop(0)
0x737: @ irand(Stack[-4], Stack[-1]T)
0x738: Pop(0)
0x739: Push((int) 1)
0x73a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x73b: @ Face(Stack[-0]T)
0x73c: Pop(0)
0x73d: Push((bool) 1)
...
0x744: Push("attack_begin") // @poff=488
...
0x758: Stack[-11] = Stack[-2]
0x759: Stack[-6] = Stack[-1]
0x75a: Call2 0x70c

0x75b: Pop(2)
0x75c: Push("all") // @poff=138
0x75d: Push("attack_middle") // @poff=526
...
0x765: Pop(0)
0x766: Push("all") // @poff=138
0x767: Push("attack_middle") // @poff=526
...
0x77b: Stack[-11] = Stack[-2]
0x77c: Stack[-6] = Stack[-1]
0x77d: Call2 0x70c

0x77e: Pop(2)
0x77f: Stack[-2] = (int) 1
0x780: Push("attack_middle") // @poff=526
0x781: Pop(1); Push(Stack[-1] + Stack[-5]);
0x782: Push("_") // @poff=554
0x783: Pop(2); Push(Stack[-2] + Stack[-1]);
0x784: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x785: Push("all") // @poff=138
...
0x7a1: Stack[-11] = Stack[-2]
0x7a2: Stack[-6] = Stack[-1]
0x7a3: Call2 0x70c
...
0x7aa: Pop(1)
0x7ab: Push("all") // @poff=138
0x7ac: Push("attack_end") // @poff=558
...
0x7eb: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0x7ec: Pop(0)
...
0x837: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x838: Pop(1)
...
0x83c: @ Face(Stack[-0]T)
0x83d: Pop(0)
0x83e: Push("all") // @poff=138
0x83f: Push("bjump") // @poff=514
0x840: @ PlayAnimation(Stack[-2], Stack[-1])
0x841: Pop(2)
0x842: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0x843: Pop(0)
...
0x879: @ irand(Stack[-1], Stack[-2]T)
0x87a: Pop(0)
0x87b: Push((int) 1)
0x87c: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x87d: Push("attack") // @poff=382
...
0x88e: Stack[-1] = "attack_stay" // @poff=430
0x88f: Call2 0xb75
...
0x8c0: Stack[-15] = Stack[-5]
0x8c1: Stack[-14] = Stack[-4]
0x8c2: Stack[-13] = Stack[-3]
0x8c3: Stack[-12] = Stack[-2]
0x8c4: Stack[-11] = Stack[-1]
0x8c5: Call2 0x90a

0x8c6: Stack[-6] = Stack[-7]
0x8c7: Pop(6)
0x8c8: Push( Stack[2 + Tasks[-1].StackPointer] )
0x8c9: IF (Stack[-1] == 0) GOTO 0x8cd; Pop(1)

0x8ca: Push("head") // @poff=316
0x8cb: @ UnlookAsync(Stack[-1])
0x8cc: Pop(1)
0x8cd: Push((int) 1)
0x8ce: @ KillTimer(Stack[-1])
0x8cf: Pop(1)
0x8d0: Stack[-1] = Stack[-10]
0x8d1: Return(); Pop(4)
...
0x90d: Stack[-17] = Stack[-7]
0x90e: PushEmpty(bool, object)
0x90f: Stack[-23] = Stack[-1]
0x910: Call2 0x996
...
0x916: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x917: Pop(0)
...
0x92d: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0x92e: Pop(0)
...
0x93f: Push((int) 0)
0x940: Push((float)0.30000001192092896)
...
0x962: Push((int) 0)
0x963: Push((float)0.30000001192092896)
...
0x998: Stack[-3] = Stack[-1]
0x999: Call2 0xa41

0x99a: Stack[-2] = Stack[-4]
0x99b: Pop(2)
0x99c: Return(); Pop(0)

0x99d: Stack[-1] = "walk" // @poff=616
0x99e: Return(); Pop(0)

0x99f: Stack[-1] = "run" // @poff=626
0x9a0: Return(); Pop(0)
...
0x9ab: Stack[-2] = "bullet" // @poff=644
0x9ac: Return(); Pop(0)

0x9ad: Stack[-2] = "phys" // @poff=658
0x9ae: Return(); Pop(0)

0x9af: PushEmpty(cvector, cvector, cvector, cvector)
0x9b0: @ GetPosition(Stack[-2])
0x9b1: Pop(0)
0x9b2: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x9b3: Pop(0)
...
0x9b8: Pop(0)
0x9b9: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0x9ba: Pop(0)
...
0x9c0: Pop(0)
0x9c1: Stack[-1] = Stack[-4]
0x9c2: Return(); Pop(2)

0x9c3: PushEmpty(bool, bool)
0x9c4: Push("HasProperty") // @poff=668
0x9c5: Push((int) 2)
...
0x9cb: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x9cc: Pop(0)
0x9cd: Stack[-1] = Stack[-5]
0x9ce: Return(); Pop(2)

0x9cf: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x9d0: PushEmpty(bool, object, string)
0x9d1: Stack[-18] = Stack[-2]
0x9d2: Stack[-1] = "health" // @poff=704
0x9d3: Call2 0x9c3
...
0x9da: Stack[-18] = Stack[-2]
0x9db: Stack[-1] = "armor" // @poff=718
0x9dc: Call2 0x9c3
...
0x9e2: Push("armor") // @poff=718
0x9e3: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x9e4: Pop(1)
0x9e5: Push("armor_") // @poff=742
0x9e6: PushEmpty(string, int)
0x9e7: Stack[-16] = Stack[-1]
0x9e8: Call2 0x9a1

0x9e9: Pop(1)
0x9ea: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x9eb: PushEmpty(bool, object, string)
0x9ec: Stack[-18] = Stack[-2]
0x9ed: Stack[-8] = Stack[-1]
0x9ee: Call2 0x9c3
...
0x9f4: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x9f5: Pop(0)
...
0x9fc: Stack[-3] = Stack[-6]
0x9fd: Pop(3)
0x9fe: Push("health") // @poff=704
0x9ff: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0xa00: Pop(1)
0xa01: Push((int) 1)
0xa02: Pop(1); Push(Stack[-1] - Stack[-4]);
0xa03: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0xa04: Push("health") // @poff=704
...
0xa0a: Pop(3)
0xa0b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0xa0c: Pop(2)
0xa0d: PushEmpty(bool, object)
0xa0e: Stack[-17] = Stack[-1]
0xa0f: Call2 0x9be
...
0xa15: Pop(1)
0xa16: Stack[-1] = Stack[-16]
0xa17: Return(); Pop(12)

0xa18: PushEmpty(bool, bool)
0xa19: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0xa1a: Pop(0)
0xa1b: Stack[-1] = Stack[-4]
0xa1c: Return(); Pop(2)

0xa1d: PushEmpty(object, object, object, object)
0xa1e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0xa32: Pop(0)
0xa33: Pop(0); PushNull((bool) Stack[-2] == 0)
0xa34: IF (Stack[-1] == 0) GOTO 0xa37; Pop(1)

0xa35: Stack[-6] = (bool) 0
0xa36: Return(); Pop(4)

0xa37: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0xa38: Pop(0)
...
0xa4b: Stack[-6] = Stack[-2]
0xa4c: Stack[-1] = "noaccess" // @poff=798
0xa4d: Call2 0x9c3
...
0xa53: Push("noaccess") // @poff=798
0xa54: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0xa55: Pop(1)
0xa56: Push((int) 0)
...
0xa5a: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0xa68: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0xa69: Pop(0)
...
0xa79: Stack[-1] = "fhit" // @poff=816
0xa7a: GOTO 0xa7c

0xa7b: Stack[-1] = "bhit" // @poff=826
0xa7c: Push("hit_react") // @poff=836
0xa7d: Push("1") // @poff=856
0xa7e: Pop(1); Push(Stack[-3] + Stack[-1]);
0xa7f: Push("2") // @poff=860
...
0xa98: Stack[-25] = Stack[-1]
0xa99: Call2 0x9af

0xa9a: Stack[-2] = Stack[-3]
0xa9b: Pop(2)
0xa9c: Call2 0xba4

0xa9d: Stack[-2] = Stack[-11]
0xa9e: Pop(2)
0xa9f: @ CreateVectorVector(Stack[-8])
0xaa0: Pop(0)
0xaa1: Stack[-7] = (int) 1
0xaa2: Push("hit") // @poff=818
...
0xab7: Pop(0)
0xab8: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0xab9: Pop(0)
0xaba: PushEmpty(object, int, float, cvector, cvector)
0xabb: Stack[-26] = Stack[-5]
0xabc: Stack[-25] = Stack[-4]
0xabd: Stack[-24] = Stack[-3]
0xabe: Stack[-6] = Stack[-2]
...
0xad8: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0xad9: Pop(0)
...
0xae8: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0xae9: Pop(0)
0xaea: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0xaeb: Pop(0)
...
0xb33: Push("head") // @poff=316
0xb34: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xb35: Pop(1)
0xb36: Push(Stack[-1])
0xb37: IF (Stack[-1] == 0) GOTO 0xb3b; Pop(1)

0xb38: Push("head") // @poff=316
0xb39: @ UnlookAsync(Stack[-1])
0xb3a: Pop(1)
0xb3b: Return(); Pop(2)

0xb3c: PushEmpty(float, float, float, float)
0xb3d: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0xb3e: Pop(0)
0xb3f: Push((bool) 0)
0xb40: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0xb41: Pop(1)
0xb42: Return(); Pop(4)

0xb43: PushEmpty(float, float, float, float)
0xb44: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0xb45: Pop(0)
0xb46: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0xb47: Pop(0)
0xb48: Return(); Pop(4)

0xb49: PushEmpty(float, cvector, float, cvector)
0xb4a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0xb4b: Pop(0)
0xb4c: Stack[-1] = [0.0, 0.0, 0.0]
0xb4d: Push(CvectorIndex(Stack[-1], 1))
0xb4e: Stack[-3] = Stack[-1]
0xb4f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xb50: Push("head") // @poff=316
0xb51: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0xb52: Pop(1)
0xb53: Return(); Pop(4)
...
0xb56: Pop(0)
0xb57: IF (Stack[-1] == 0) GOTO 0xb5a; Pop(1)

0xb58: @ lshStopSpeech()
0xb59: Pop(0)
0xb5a: Return(); Pop(0)

0xb5b: PushEmpty(bool, bool)
0xb5c: PushEmpty(bool, int, int)
0xb5d: Stack[-7] = Stack[-2]
0xb5e: Stack[-6] = Stack[-1]
0xb5f: Call2 0xbc0
...
0xb62: Push((int) 0)
0xb63: @ AddItem(Stack[-2], Stack[-6], Stack[-1])
0xb64: Pop(1)
0xb65: Return(); Pop(2)

0xb66: PushEmpty(int, bool, int, bool)
0xb67: PushEmpty(bool, int, int)
0xb68: Stack[-10] = Stack[-2]
0xb69: Stack[-9] = Stack[-1]
0xb6a: Call2 0xbc0

0xb6b: Pop(2)
0xb6c: IF (Stack[-1] == 0) GOTO 0xb74; Pop(1)

0xb6d: @ irand(Stack[-2], Stack[-5])
0xb6e: Pop(0)
0xb6f: Push((int) 0)
0xb70: Push((int) 1)
0xb71: Pop(1); Push(Stack[-4] + Stack[-1]);
0xb72: @ AddItem(Stack[-3], Stack[-10], Stack[-2], Stack[-1])
0xb73: Pop(2)
0xb74: Return(); Pop(4)

0xb75: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0xb76: @ IsExisting3DSound(Stack[-8], Stack[-17])
0xb77: Pop(0)
0xb78: Pop(0); Push((bool) Stack[-8] == 0)
0xb79: IF (Stack[-1] == 0) GOTO 0xb8e; Pop(1)

0xb7a: Stack[-7] = (int) 0
0xb7b: Push((int) 1)
0xb7c: Pop(1); Push(Stack[-8] + Stack[-1]);
0xb7d: Pop(1); Push(Stack[-18] + Stack[-1]);
0xb7e: @ IsExisting3DSound(Stack[-7], Stack[-1])
0xb7f: Pop(1)
0xb80: Pop(0); Push((bool) Stack[-6] == 0)
0xb81: IF (Stack[-1] == 0) GOTO 0xb83; Pop(1)

0xb82: GOTO 0xb86

0xb83: Push((int) 1)
0xb84: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0xb85: GOTO 0xb7b

0xb86: Pop(0); Push((bool) Stack[-7] == 0)
0xb87: IF (Stack[-1] == 0) GOTO 0xb89; Pop(1)

0xb88: Return(); Pop(16)

0xb89: @ irand(Stack[-5], Stack[-7])
0xb8a: Pop(0)
0xb8b: Push((int) 1)
0xb8c: Pop(1); Push(Stack[-6] + Stack[-1]);
0xb8d: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0xb8e: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0xb8f: Pop(0)
0xb90: Push(Stack[-4])
0xb91: IF (Stack[-1] == 0) GOTO 0xb9d; Pop(1)

0xb92: @ GetEyesHeight(Stack[-3])
0xb93: Pop(0)
0xb94: @ GetDirection(Stack[-2])
0xb95: Pop(0)
0xb96: Push((int) 50)
0xb97: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0xb98: Push(CvectorIndex(Stack[-1], 1))
0xb99: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0xb9a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xb9b: @ PlayGlobalSound(Stack[-17], Stack[-1])
0xb9c: Pop(0)
0xb9d: Return(); Pop(16)

0xb9e: PushEmpty(object, object)
0xb9f: @ self(Stack[-1])
0xba0: Pop(0)
0xba1: Stack[-1] = Stack[-3]
0xba2: Return(); Pop(2)

0xba3: Stack[-1] = 0
0xba4: PushEmpty(float, float)
0xba5: Pop(0); Push(Stack[-3] | Stack[-3]);
0xba6: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xba7: Push((float)9.999999974752427e-07)
0xba8: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xba9: IF (Stack[-1] == 0) GOTO 0xbac; Pop(1)

0xbaa: Stack[-4] = [0.0, 0.0, 0.0]
0xbab: Return(); Pop(2)

0xbac: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xbad: Return(); Pop(2)

0xbae: PushEmpty()
0xbaf: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0xbb0: IF (Stack[-1] == 0) GOTO 0xbb3; Pop(1)

0xbb1: Stack[-2] = Stack[-3]
0xbb2: GOTO 0xbb4
...
0xbb5: PushEmpty()
0xbb6: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xbb7: IF (Stack[-1] == 0) GOTO 0xbba; Pop(1)

0xbb8: Stack[-2] = Stack[-4]
0xbb9: Return(); Pop(0)

0xbba: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xbbb: IF (Stack[-1] == 0) GOTO 0xbbe; Pop(1)

0xbbc: Stack[-1] = Stack[-4]
0xbbd: Return(); Pop(0)

0xbbe: Stack[-3] = Stack[-4]
0xbbf: Return(); Pop(0)

0xbc0: PushEmpty(int, int)
0xbc1: @ irand(Stack[-1], Stack[-3])
0xbc2: Pop(0)
0xbc3: Stack[-5] = Stack[-1] < Stack[-4]; Pop(0);
0xbc4: Return(); Pop(2)

0xbc5: PushEmpty()
0xbc6: Push(CvectorIndex(Stack[-2], 0))
0xbc7: Push(CvectorIndex(Stack[-2], 0))
0xbc8: Pop(2); Push(Stack[-2] * Stack[-1]);
0xbc9: Push(CvectorIndex(Stack[-3], 2))
0xbca: Push(CvectorIndex(Stack[-3], 2))
0xbcb: Pop(2); Push(Stack[-2] * Stack[-1]);
0xbcc: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xbcd: Return(); Pop(0)

0xbce: PushEmpty()
0xbcf: Push(CvectorIndex(Stack[-1], 0))
0xbd0: Push(CvectorIndex(Stack[-2], 0))
0xbd1: Pop(2); Push(Stack[-2] * Stack[-1]);
0xbd2: Push(CvectorIndex(Stack[-2], 2))
0xbd3: Push(CvectorIndex(Stack[-3], 2))
0xbd4: Pop(2); Push(Stack[-2] * Stack[-1]);
0xbd5: Pop(2); Push(Stack[-2] + Stack[-1]);
0xbd6: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0xbd7: Return(); Pop(0)

0xbd8: PushEmpty()
0xbd9: PushEmpty(float, cvector, cvector)
0xbda: Stack[-5] = Stack[-2]
0xbdb: Stack[-4] = Stack[-1]
0xbdc: Call2 0xbc5

0xbdd: Pop(2)
0xbde: PushEmpty(float, cvector)
0xbdf: Stack[-5] = Stack[-1]
0xbe0: Call2 0xbce

0xbe1: Pop(1)
0xbe2: PushEmpty(float, cvector)
0xbe3: Stack[-5] = Stack[-1]
0xbe4: Call2 0xbce

0xbe5: Pop(1)
0xbe6: Pop(2); Push(Stack[-2] * Stack[-1]);
0xbe7: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0xbe8: Return(); Pop(0)

0xbe9: PushEmpty(int, int)
0xbea: @ GetVariable(Stack[-3], Stack[-1])
0xbeb: Pop(0)
0xbec: Stack[-1] = Stack[-4]
0xbed: Return(); Pop(2)

0xbee: PushEmpty(object, object)
0xbef: @ CreateFloatVector(Stack[-1])
0xbf0: Pop(0)
0xbf1: @@ add(Stack[-3]); Obj=1 // @poff=864
0xbf2: Pop(0)
0xbf3: Push((int) 15)
0xbf4: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xbf5: Pop(1)
0xbf6: Return(); Pop(2)

0xbf7: Stack[-1] = 0
0xbf8: PushEmpty(float, float)
0xbf9: @ GetGameTime(Stack[-1])
0xbfa: Pop(0)
0xbfb: Push((int) 1)
0xbfc: PushEmpty(int)
0xbfd: Push((int) 24)
0xbfe: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0xbff: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xc00: Return(); Pop(2)

0xc01: PushEmpty(bool, bool)
0xc02: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc03: Pop(0)
0xc04: Push(Stack[-1])
0xc05: IF (Stack[-1] == 0) GOTO 0xc09; Pop(1)

0xc06: Push("attack") // @poff=382
0xc07: @ PlayGlobalMusic(Stack[-1])
0xc08: Pop(1)
0xc09: Return(); Pop(2)

0xc0a: PushEmpty(object, object)
0xc0b: @ GetScene(Stack[-1])
0xc0c: Pop(0)
0xc0d: Push("battle") // @poff=923
0xc0e: PushEmpty(object)
0xc0f: Call2 0xb9e

0xc10: Pop(0)
0xc11: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xc12: Pop(2)
0xc13: Return(); Pop(2)

0xc14: Stack[-1] = 0
0xc15: PushEmpty()
0xc16: Push("ood1Doberman1_1") // @poff=937
0xc17: Push((int) 1)
0xc18: @ SetVariable(Stack[-2], Stack[-1])
0xc19: Pop(2)
0xc1a: Return(); Pop(0)

0xc1b: PushEmpty()
0xc1c: PushEmpty(int, string)
0xc1d: Stack[-1] = "ood1Doberman1_1" // @poff=937
0xc1e: Call2 0xbe9
...
0xc27: PushEmpty(int, int)
0xc28: Push("branch") // @poff=969
0xc29: @ GetVariable(Stack[-1], Stack[-2])
0xc2a: Pop(1)
0xc2b: Push((int) 0)
0xc2c: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc2d: IF (Stack[-1] == 0) GOTO 0xc31; Pop(1)
...
0xc38: PushEmpty(int, int)
0xc39: Push("branch") // @poff=969
0xc3a: @ GetVariable(Stack[-1], Stack[-2])
0xc3b: Pop(1)
...
0xc45: @ WorkWithCorpse(Stack[-1])
0xc46: Pop(0)
0xc47: GOTO 0xc4a

0xc48: @ Barter(Stack[-1])
0xc49: Pop(0)
0xc4a: Return(); Pop(0)

0xc4b: PushEmpty(int, bool, int, bool)
0xc4c: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0xc4d: IF (Stack[-1] == 0) GOTO 0xc52; Pop(1)

0xc4e: Push("GenerateMoney: iMin > iMax") // @poff=983
0xc4f: @ Trace(Stack[-1])
0xc50: Pop(1)
0xc51: Return(); Pop(4)

0xc52: Stack[-2] = (int) 0
0xc53: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0xc54: IF (Stack[-1] == 0) GOTO 0xc59; Pop(1)

0xc55: Pop(0); Push(Stack[-5] - Stack[-6]);
0xc56: @ irand(Stack[-3], Stack[-1])
0xc57: Pop(1)
0xc58: GOTO 0xc5d

0xc59: Push((int) 0)
0xc5a: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xc5b: IF (Stack[-1] == 0) GOTO 0xc5d; Pop(1)

0xc5c: Return(); Pop(4)

0xc5d: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0xc5e: Push((int) 0)
...
0xc63: Stack[-1] = "Money" // @poff=1037
0xc64: Call2 0xd13

0xc65: Pop(1)
0xc66: Push((int) 0)
0xc67: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xc68: Pop(2)
0xc69: Return(); Pop(4)

0xc6a: PushEmpty(object, int, bool, object, int, bool)
0xc6b: @ CreateInvItem(Stack[-3])
0xc6c: Pop(0)
0xc6d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1049
0xc6e: Pop(0)
0xc6f: Push("Organ") // @poff=1061
0xc70: Push((int) 1)
0xc71: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0xc72: Pop(2)
0xc73: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1073
0xc74: Pop(0)
0xc75: Push((int) 0)
0xc76: Push((int) 1)
0xc77: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xc78: Pop(2)
0xc79: Return(); Pop(6)
...
0xc83: Stack[-1] = "liver" // @poff=1083
0xc84: Call2 0xc6a

0xc85: Pop(1)
0xc86: PushEmpty(string)
0xc87: Stack[-1] = "kidney" // @poff=1095
0xc88: Call2 0xc6a

0xc89: Pop(1)
0xc8a: PushEmpty(string)
0xc8b: Stack[-1] = "heart" // @poff=1109
0xc8c: Call2 0xc6a

0xc8d: Pop(1)
0xc8e: PushEmpty(string)
0xc8f: Stack[-1] = "blood" // @poff=1121
0xc90: Call2 0xc6a

0xc91: Pop(1)
0xc92: Return(); Pop(0)

0xc93: PushEmpty(bool, bool)
0xc94: Push((int) 0)
0xc95: @ ClearSubContainer(Stack[-1])
0xc96: Pop(1)
0xc97: PushEmpty(int, int)
0xc98: Stack[-2] = (int) 0
0xc99: Push((int) 10)
0xc9a: PushEmpty(int)
0xc9b: Call2 0xbf8
...
0xc9c: Pop(0)
0xc9d: Push((int) 10)
0xc9e: Pop(2); Push(Stack[-2] * Stack[-1]);
0xc9f: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xca0: Call2 0xc4b

0xca1: Pop(2)
0xca2: PushEmpty(string, int, int)
0xca3: Stack[-3] = "hook" // @poff=1133
0xca4: Stack[-2] = (int) 1
0xca5: Stack[-1] = (int) 4
0xca6: Call2 0xb5b

0xca7: Pop(3)
0xca8: PushEmpty(string, int, int)
0xca9: Stack[-3] = "watch" // @poff=1143
0xcaa: Stack[-2] = (int) 1
0xcab: Stack[-1] = (int) 10
0xcac: Call2 0xb5b

0xcad: Pop(3)
0xcae: Return(); Pop(2)

0xcaf: PushEmpty(int, bool, int, int, bool, int)
0xcb0: Push((int) 0)
0xcb1: @ ClearSubContainer(Stack[-1])
0xcb2: Pop(1)
0xcb3: PushEmpty(int)
0xcb4: Call2 0xbf8

0xcb5: Stack[-1] = Stack[-2]
0xcb6: Pop(1)
0xcb7: Push(Stack[-7])
0xcb8: IF (Stack[-1] == 0) GOTO 0xce5; Pop(1)

0xcb9: PushEmpty(string, int, int, int)
0xcba: Stack[-4] = "alpha_pills" // @poff=1155
0xcbb: Stack[-3] = (int) 1
0xcbc: Stack[-2] = (int) 2
0xcbd: Stack[-1] = (int) 4
0xcbe: Call2 0xb66
...
0xcbf: Pop(4)
0xcc0: PushEmpty(string, int, int, int)
0xcc1: Stack[-4] = "meradorm" // @poff=1179
0xcc2: Stack[-3] = (int) 2
0xcc3: Stack[-2] = (int) 3
0xcc4: Stack[-1] = (int) 3
0xcc5: Call2 0xb66
...
0xcc6: Pop(4)
0xcc7: Push((int) 3)
0xcc8: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0xcc9: IF (Stack[-1] == 0) GOTO 0xcd0; Pop(1)

0xcca: PushEmpty(string, int, int)
0xccb: Stack[-3] = "beta_pills" // @poff=1197
0xccc: Stack[-2] = (int) 1
0xccd: Stack[-1] = (int) 4
0xcce: Call2 0xb5b
...
0xccf: Pop(3)
0xcd0: Push((int) 8)
0xcd1: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0xcd2: IF (Stack[-1] == 0) GOTO 0xcdb; Pop(1)

0xcd3: PushEmpty(string, int, int, int)
0xcd4: Stack[-4] = "monomicin" // @poff=1219
0xcd5: Stack[-3] = (int) 1
0xcd6: Stack[-2] = (int) 2
0xcd7: Stack[-1] = (int) 2
0xcd8: Call2 0xb66
...
0xcde: PushEmpty(string, int, int)
0xcdf: Stack[-3] = "monomicin" // @poff=1219
0xce0: Stack[-2] = (int) 1
0xce1: Stack[-1] = (int) 2
0xce2: Call2 0xb5b
...
0xce6: Stack[-3] = "lockpick" // @poff=1239
0xce7: Stack[-2] = (int) 1
0xce8: Stack[-1] = (int) 4
0xce9: Call2 0xb5b

0xcea: Pop(3)
0xceb: PushEmpty(string, int, int)
0xcec: Stack[-3] = "rifle_ammo" // @poff=1257
0xced: Stack[-2] = (int) 1
0xcee: Stack[-1] = (int) 2
0xcef: Call2 0xb5b

0xcf0: Pop(3)
0xcf1: PushEmpty(string, int, int)
0xcf2: Stack[-3] = "revolver_ammo" // @poff=1279
0xcf3: Stack[-2] = (int) 1
0xcf4: Stack[-1] = (int) 2
0xcf5: Call2 0xb5b

0xcf6: Pop(3)
0xcf7: PushEmpty(string, int, int, int)
0xcf8: Stack[-4] = "samopal_ammo" // @poff=1307
0xcf9: Stack[-3] = (int) 1
0xcfa: Stack[-2] = (int) 2
0xcfb: Stack[-1] = (int) 2
0xcfc: Call2 0xb66
...
0xd00: IF (Stack[-1] == 0) GOTO 0xd09; Pop(1)

0xd01: PushEmpty(string, int, int, int)
0xd02: Stack[-4] = "monomicin" // @poff=1219
0xd03: Stack[-3] = (int) 1
0xd04: Stack[-2] = (int) 2
0xd05: Stack[-1] = (int) 2
0xd06: Call2 0xb66
...
0xd0b: IF (Stack[-1] == 0) GOTO 0xd12; Pop(1)

0xd0c: PushEmpty(string, int, int)
0xd0d: Stack[-3] = "monomicin" // @poff=1219
0xd0e: Stack[-2] = (int) 1
0xd0f: Stack[-1] = (int) 2
0xd10: Call2 0xb5b
...
0xd13: PushEmpty(int, int)
0xd14: @ GetInvItemByName(Stack[-1], Stack[-3])
0xd15: Pop(0)
0xd16: Stack[-1] = Stack[-4]
0xd17: Return(); Pop(2)

0xd18: PushEmpty()
0xd19: PushEmpty(object)
0xd1a: Stack[-2] = Stack[-1]
0xd1b: Push(-1, 0); TaskCall(2)
0xd1c: Call2 0x1dc

0xd1d: Pop(-1, 0); TaskReturn
0xd1e: Pop(1)
0xd1f: Return(); Pop(0)

0xd20: PushEmpty(float, float)
0xd21: Push("health") // @poff=704
0xd22: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xd23: IF (Stack[-1] == 0) GOTO 0xd2c; Pop(1)

0xd24: Push("health") // @poff=704
0xd25: @ GetProperty(Stack[-1], Stack[-2])
0xd26: Pop(1)
0xd27: Push((int) 0)
0xd28: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xd29: IF (Stack[-1] == 0) GOTO 0xd2c; Pop(1)

0xd2a: @ SignalDeath(Stack[-4])
0xd2b: Pop(0)
0xd2c: Return(); Pop(2)

0xd2d: PushEmpty()
0xd2e: PushEmpty(object)
0xd2f: Stack[-2] = Stack[-1]
0xd30: Call2 0xd18
...
0xd33: PushEmpty()
0xd34: PushEmpty(object, int, float)
0xd35: Stack[-7] = Stack[-3]
0xd36: Stack[-6] = Stack[-2]
0xd37: Stack[-5] = Stack[-1]
0xd38: Call2 0xa85
...
0xd3b: PushEmpty()
0xd3c: PushEmpty(object, int, float, cvector, cvector)
0xd3d: Stack[-11] = Stack[-5]
0xd3e: Stack[-10] = Stack[-4]
0xd3f: Stack[-9] = Stack[-3]
0xd40: Stack[-7] = Stack[-2]
0xd41: Stack[-6] = Stack[-1]
0xd42: Call2 0xac9
...
0xd45: PushEmpty()
0xd46: Push("unholster") // @poff=1333
0xd47: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd48: IF (Stack[-1] == 0) GOTO 0xd50; Pop(1)

0xd49: PushEmpty(bool, object)
0xd4a: Stack[-4] = Stack[-1]
0xd4b: Call2 0xe1c

0xd4c: Stack[-2] = Stack[-5]
0xd4d: Pop(2)
0xd4e: Return(); Pop(0)

0xd4f: GOTO 0xd63

0xd50: Push("player_shot") // @poff=1353
0xd51: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd52: IF (Stack[-1] == 0) GOTO 0xd5a; Pop(1)

0xd53: PushEmpty(bool, object)
0xd54: Stack[-4] = Stack[-1]
0xd55: Call2 0xe21
...
0xd8c: IF (Stack[-1] == 0) GOTO 0xd93; Pop(1)

0xd8d: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1377
0xd8e: Pop(0)
0xd8f: Pop(0); Push((bool) Stack[-1] == 0)
0xd90: IF (Stack[-1] == 0) GOTO 0xd93; Pop(1)

0xd91: Stack[-4] = (bool) 1
0xd92: Return(); Pop(2)

0xd93: Stack[-4] = (bool) 0
0xd94: Return(); Pop(2)

0xd95: PushEmpty()
0xd96: PushEmpty(object)
0xd97: Stack[-2] = Stack[-1]
0xd98: Call2 0xe1f
...
0xda3: Pop(0)
0xda4: Push((float)-0.05000000074505806)
0xda5: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0xda6: Pop(2)
0xda7: Return(); Pop(0)

0xda8: PushEmpty(object, object)
0xda9: Push("heal") // @poff=1395
0xdaa: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xdab: IF (Stack[-1] == 0) GOTO 0xdb6; Pop(1)

0xdac: Push("player") // @poff=1405
0xdad: @ FindActor(Stack[-2], Stack[-1])
0xdae: Pop(1)
0xdaf: PushEmpty(bool, object)
0xdb0: Stack[-3] = Stack[-1]
0xdb1: Call2 0xe40

0xdb2: Stack[-2] = Stack[-6]
0xdb3: Pop(2)
0xdb4: Return(); Pop(2)

0xdb5: Stack[-1] = 0
0xdb6: Stack[-4] = (bool) 0
0xdb7: Return(); Pop(2)

0xdb8: PushEmpty(object, object)
0xdb9: Push("heal") // @poff=1395
0xdba: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xdbb: IF (Stack[-1] == 0) GOTO 0xdc4; Pop(1)

0xdbc: Push("player") // @poff=1405
0xdbd: @ FindActor(Stack[-2], Stack[-1])
0xdbe: Pop(1)
0xdbf: PushEmpty(object)
0xdc0: Stack[-2] = Stack[-1]
0xdc1: Call2 0xe43
...
0xdc5: PushEmpty(string, string)
0xdc6: Stack[-1] = "idle" // @poff=146
0xdc7: Push(Stack[-3])
0xdc8: IF (Stack[-1] == 0) GOTO 0xdca; Pop(1)

0xdc9: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xdca: Stack[-1] = Stack[-4]
0xdcb: Return(); Pop(2)

0xdcc: PushEmpty(int, bool, int, bool)
0xdcd: Stack[-2] = (int) 0
0xdce: Push("all") // @poff=138
0xdcf: PushEmpty(string, int)
0xdd0: Stack[-5] = Stack[-1]
0xdd1: Call2 0xdc5

0xdd2: Pop(1)
0xdd3: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xdd4: Pop(2)
0xdd5: Pop(0); Push((bool) Stack[-1] == 0)
0xdd6: IF (Stack[-1] == 0) GOTO 0xdd8; Pop(1)

0xdd7: GOTO 0xddb

0xdd8: Push((int) 1)
0xdd9: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xdda: GOTO 0xdce

0xddb: Stack[-2] = Stack[-5]
0xddc: Return(); Pop(4)

0xddd: PushEmpty()
0xdde: PushEmpty(bool)
0xddf: Call2 0xe69

0xde0: Pop(0)
0xde1: IF (Stack[-1] == 0) GOTO 0xde4; Pop(1)
...
0xde6: PushEmpty()
0xde7: PushEmpty(object)
0xde8: Stack[-2] = Stack[-1]
0xde9: Push(-1, 1); TaskCall(5)
0xdea: Call2 0x4e3

0xdeb: Pop(-1, 1); TaskReturn
0xdec: Pop(1)
0xded: Return(); Pop(0)

0xdee: PushEmpty()
0xdef: PushEmpty(bool, object)
0xdf0: Stack[-3] = Stack[-1]
0xdf1: Call2 0xa41
...
0xdfb: Push(-1, 6); TaskCall(6)
0xdfc: Call2 0x5f6

0xdfd: Pop(-1, 6); TaskReturn
0xdfe: Pop(1)
0xdff: Return(); Pop(0)

0xe00: PushEmpty()
0xe01: PushEmpty(int, object)
0xe02: Stack[-4] = Stack[-1]
0xe03: Call2 0xdee

0xe04: Stack[-2] = Stack[-5]
0xe05: Pop(2)
0xe06: Return(); Pop(0)

0xe07: PushEmpty()
0xe08: PushEmpty(object)
...
0xe10: PushEmpty()
0xe11: PushEmpty(object)
0xe12: Stack[-2] = Stack[-1]
0xe13: Call2 0xe57
...
0xe1c: PushEmpty()
0xe1d: Stack[-2] = (bool) 0
0xe1e: Return(); Pop(0)

0xe1f: PushEmpty()
0xe20: Return(); Pop(0)

0xe21: PushEmpty(bool, bool)
0xe22: @ CanSee(Stack[-1], Stack[-3])
0xe23: Pop(0)
0xe24: Stack[-4] = (bool) 1
0xe25: Push(Stack[-1])
0xe26: IF (Stack[-1] == 1) GOTO 0xe2f; Pop(1)

0xe27: PushEmpty(float, object)
0xe28: Stack[-5] = Stack[-1]
0xe29: Call2 0x9b6

0xe2a: Pop(1)
0xe2b: Push((int) 2250000)
0xe2c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xe2d: IF (Stack[-1] == 1) GOTO 0xe2f; Pop(1)

0xe2e: Stack[-4] = (bool) 0
0xe2f: Return(); Pop(2)
...
0xe45: Stack[-1] = (int) 518097
0xe46: Return(); Pop(0)

0xe47: Stack[-1] = (int) 518096
0xe48: Return(); Pop(0)

0xe49: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1419
0xe4a: Return(); Pop(0)

0xe4b: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1459
0xe4c: Return(); Pop(0)

0xe4d: Stack[-1] = (bool) 0
0xe4e: Return(); Pop(0)

0xe4f: Push(GlobalVars[0])
0xe50: Stack[-1] = (bool) 0
0xe51: GlobalVars[0] = Stack[-1]; Pop(1)
0xe52: PushEmpty(bool)
0xe53: Stack[-1] = (bool) 1
0xe54: Call2 0xcaf

0xe55: Pop(1)
0xe56: Return(); Pop(0)

0xe57: PushEmpty(bool, bool)
0xe58: Push(GlobalVars[0])
0xe59: IF (Stack[-1] == 0) GOTO 0xe64; Pop(1)

0xe5a: @ IsOverrideActive(Stack[-1])
0xe5b: Pop(0)
0xe5c: Pop(0); Push((bool) Stack[-1] == 0)
0xe5d: IF (Stack[-1] == 0) GOTO 0xe62; Pop(1)

0xe5e: PushEmpty(object)
0xe5f: Stack[-4] = Stack[-1]
0xe60: Call2 0xc3e
...
0xe70: Stack[-3] = Stack[-1]
0xe71: Call2 0x9be

0xe72: Pop(1)
0xe73: IF (Stack[-1] == 0) GOTO 0xe7f; Pop(1)

0xe74: PushEmpty(object)
0xe75: Call2 0xb9e

0xe76: Pop(0)
0xe77: Push((float)-0.10000000149011612)
0xe78: Push((bool) 1)
0xe79: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xe7a: Pop(3)
0xe7b: PushEmpty(bool)
0xe7c: Stack[-1] = (bool) 1
0xe7d: Call2 0xc93
...
0xe81: Pop(0)
0xe82: Push(GlobalVars[0])
0xe83: Stack[-1] = (bool) 1
0xe84: GlobalVars[0] = Stack[-1]; Pop(1)
0xe85: Push((int) 50)
0xe86: Push((int) 40)
0xe87: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xe88: Pop(2)
0xe89: Return(); Pop(0)

0xe8a: PushEmpty()
0xe8b: PushEmpty(int, object)
0xe8c: Stack[-3] = Stack[-1]
0xe8d: Push(-2, 1); TaskCall(0)
0xe8e: Call2 0x0

0xe8f: Pop(-2, 1); TaskReturn
0xe90: Pop(2)
0xe91: Return(); Pop(0)
