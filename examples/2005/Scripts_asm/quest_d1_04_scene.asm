...
Strings:
	W:pt_child
	W:not enough locators for quest b4q01
	A:add
	W:pers_doberman
	W:d1q04_doberman1.xml
	W:d1q04_doberman2.xml
	W:nailed
	W:pt_item_food
	W:pt_item_pfood
	W:pt_item_knife
	...
	W: doesn't exist
	A:clear
// @pool_raw:
...
0xb: Push("not enough locators for quest b4q01") // @poff=18
0xc: @ Trace(Stack[-1])
0xd: Pop(1)
0xe: GOTO 0x1b

0xf: Push((int) 0)
0x10: @@ add(Stack[-1]); Obj=12 // @poff=90
0x11: Pop(1)
0x12: @@ add(Stack[-5]); Obj=11 // @poff=90
0x13: Pop(0)
0x14: Push((int) 1)
0x15: Stack[-2] = Stack[-6] - Stack[-1]; Pop(1);
0x16: @@ add(Stack[-1]); Obj=11 // @poff=90
0x17: Pop(0)
0x18: Push((int) 1)
...
0x20: Push("pt_child") // @poff=0
0x21: Stack[-4] = Stack[-1] + Stack[-2]; Pop(1);
0x22: Return(); Pop(0)

0x23: Stack[-3] = "" // @poff=15
0x24: Return(); Pop(0)

0x25: PushEmpty()
0x26: Stack[-3] = "pers_doberman" // @poff=94
0x27: Return(); Pop(0)
...
0x2f: Stack[-3] = "d1q04_doberman1.xml" // @poff=122
0x30: Return(); Pop(0)
...
0x35: Stack[-3] = "d1q04_doberman2.xml" // @poff=162
0x36: Return(); Pop(0)

0x37: Stack[-3] = "" // @poff=15
0x38: Return(); Pop(0)
...
0x56: Stack[-4] = (int) 1
0x57: Push("pt_item_food") // @poff=216
...
0x5f: Stack[-5] = Stack[-3]
0x60: Stack[-4] = Stack[-2]
0x61: Stack[-12] = Stack[-1]
0x62: Call2 0xa1
...
0x69: Stack[-4] = (int) 1
0x6a: Push("pt_item_pfood") // @poff=242
...
0x72: Stack[-5] = Stack[-3]
0x73: Stack[-4] = Stack[-2]
0x74: Stack[-12] = Stack[-1]
0x75: Call2 0xdc
...
0x7c: Stack[-4] = (int) 1
0x7d: Push("pt_item_knife") // @poff=270
...
0x85: Stack[-5] = Stack[-3]
0x86: Stack[-4] = Stack[-2]
0x87: Stack[-12] = Stack[-1]
0x88: Call2 0x12f
...
0x8f: Stack[-4] = (int) 1
0x90: Push("pt_item_bottle") // @poff=298
...
0xa5: Stack[-1] = (float) 0.05000000074505806
0xa6: GOTO 0xa8

0xa7: Stack[-1] = (float) 0.20000000298023224
0xa8: Call2 0x1f7
...
0xae: Push((int) 2)
0xaf: Push((int) 3)
0xb0: Push("bread") // @poff=328
0xb1: Push("bottle_water") // @poff=340
0xb2: Push("milk") // @poff=366
0xb3: Push("vegetables") // @poff=376
0xb4: Push("lemon") // @poff=398
0xb5: @ RandOneOf(Stack[-16], Stack[-10], Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb6: Pop(10)
0xb7: Push("scripted_container") // @poff=410
0xb8: PushEmpty(object)
0xb9: Call2 0x1f1

0xba: Pop(0)
0xbb: Push("item_") // @poff=448
0xbc: Pop(1); Push(Stack[-1] + Stack[-9]);
0xbd: Push("_steal.xml") // @poff=460
...
0xd3: Push("scripted_container") // @poff=410
0xd4: PushEmpty(object)
0xd5: Call2 0x1f1

0xd6: Pop(0)
0xd7: Push("item_plate.xml") // @poff=482
...
0xe0: Stack[-1] = (float) 0.05000000074505806
0xe1: GOTO 0xe3

0xe2: Stack[-1] = (float) 0.20000000298023224
0xe3: Call2 0x1f7
...
0xeb: Push((int) 2)
0xec: Push((int) 1)
0xed: Push("rusk") // @poff=512
0xee: Push("dried_fish") // @poff=522
0xef: Push("dried_meat") // @poff=544
0xf0: Push("smoked_meat") // @poff=566
0xf1: Push("fresh_fish") // @poff=590
0xf2: Push("fresh_meat") // @poff=612
0xf3: Push("tvirin") // @poff=634
...
0x126: Push("scripted_container") // @poff=410
0x127: PushEmpty(object)
0x128: Call2 0x1f1

0x129: Pop(0)
0x12a: Push("item_plate.xml") // @poff=482
...
0x133: Stack[-1] = (float) 0.05000000074505806
0x134: GOTO 0x136

0x135: Stack[-1] = (float) 0.05000000074505806
0x136: Call2 0x1f7

0x137: Pop(1)
0x138: IF (Stack[-1] == 0) GOTO 0x141; Pop(1)

0x139: Push("scripted_container") // @poff=410
0x13a: PushEmpty(object)
0x13b: Call2 0x1f1

0x13c: Pop(0)
0x13d: Push("item_knife_steal.xml") // @poff=648
...
0x146: Stack[-1] = (float) 0.20000000298023224
0x147: GOTO 0x149

0x148: Stack[-1] = (float) 0.4000000059604645
0x149: Call2 0x1f7
...
0x150: Push((int) 3)
0x151: Push((int) 1)
0x152: Push("bottle_water") // @poff=340
0x153: Push("bottle_empty") // @poff=690
0x154: Push("vegetables") // @poff=376
0x155: Push("milk") // @poff=366
0x156: Push("egg") // @poff=716
0x157: Push("tvirin") // @poff=634
...
0x159: Pop(12)
0x15a: Push("scripted_container") // @poff=410
0x15b: PushEmpty(object)
0x15c: Call2 0x1f1

0x15d: Pop(0)
0x15e: Push("item_") // @poff=448
0x15f: Pop(1); Push(Stack[-1] + Stack[-5]);
0x160: Push("_steal.xml") // @poff=460
...
0x16e: @ CreateIntVector(Stack[-0]T)
0x16f: Pop(0)
...
0x181: @ CreateIntVector(Stack[-0]T)
0x182: Pop(0)
...
0x1ac: Pop(1)
0x1ad: Stack[-8] = Stack[-3]
0x1ae: Stack[-7] = Stack[-2]
0x1af: Stack[-6] = Stack[-1]
0x1b0: Call2 0x202

0x1b1: Pop(4)
0x1b2: @@@ add(Stack[-1]); Obj=1 // @poff=90
0x1b3: Pop(1)
0x1b4: Push((int) 3)
...
0x1d1: Pop(0)
0x1d2: @@@ remove(Stack[-3]); Obj=1 // @poff=752
0x1d3: Pop(0)
0x1d4: Push((int) 3)
...
0x1da: @@@ remove(Stack[-2], Stack[-1]); Obj=0 // @poff=752
0x1db: Pop(2)
0x1dc: Push((int) -1)
...
0x1e6: Push("HasProperty") // @poff=759
0x1e7: Push((int) 2)
...
0x1ed: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=783
0x1ee: Pop(0)
0x1ef: Stack[-1] = Stack[-5]
0x1f0: Return(); Pop(2)
...
0x217: @@ size(Stack[-3]); Obj=7 // @poff=724
0x218: Pop(0)
0x219: Stack[-2] = (int) 0
0x21a: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x21b: IF (Stack[-1] == 0) GOTO 0x226; Pop(1)

0x21c: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=729
0x21d: Pop(0)
0x21e: Push(Stack[-1])
