...
Strings:
	...
	W:player
	W:idle
// @pool_raw:
...
0x44f: Pop(0)
0x450: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x451: Pop(0)
...
0x462: Push("HasProperty") // @poff=264
0x463: Push((int) 2)
...
0x469: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=288
0x46a: Pop(0)
...
0x46f: Stack[-10] = Stack[-2]
0x470: Stack[-9] = Stack[-1]
0x471: Call2 0x461
...
0x477: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=300
0x478: Pop(0)
0x479: PushEmpty(float, float, float, float)
0x47a: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x47b: Stack[-8] = Stack[-2]
0x47c: Stack[-7] = Stack[-1]
0x47d: Call2 0x5c5

0x47e: Pop(3)
0x47f: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=312
0x480: Pop(1)
...
0x485: Stack[-9] = Stack[-2]
0x486: Stack[-1] = "disease" // @poff=324
0x487: Call2 0x461
...
0x48f: Stack[-9] = Stack[-2]
0x490: Stack[-1] = "armor_disease" // @poff=340
0x491: Call2 0x461

0x492: Pop(2)
0x493: IF (Stack[-1] == 0) GOTO 0x499; Pop(1)

0x494: Push("armor_disease") // @poff=340
0x495: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=300
0x496: Pop(1)
0x497: Push((int) 100)
0x498: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x499: PushEmpty(bool, object, string)
0x49a: Stack[-9] = Stack[-2]
0x49b: Stack[-1] = "immunity" // @poff=368
0x49c: Call2 0x461

0x49d: Pop(2)
0x49e: IF (Stack[-1] == 0) GOTO 0x4ab; Pop(1)

0x49f: Push("immunity") // @poff=368
0x4a0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=300
0x4a1: Pop(1)
0x4a2: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x4a3: PushEmpty(bool, object, string, float, float, float)
0x4a4: Stack[-12] = Stack[-5]
0x4a5: Stack[-4] = "immunity" // @poff=368
...
0x4b6: Stack[-12] = Stack[-5]
0x4b7: Stack[-4] = "disease" // @poff=324
0x4b8: Stack[-11] = Stack[-3]
0x4b9: Stack[-2] = (int) 0
0x4ba: Stack[-1] = (int) 1
0x4bb: Call2 0x46d
...
0x4c3: Stack[-6] = Stack[-1]
0x4c4: Call2 0x5f3

0x4c5: Pop(1)
0x4c6: Stack[-5] = Stack[-7]
0x4c7: Return(); Pop(4)

0x4c8: PushEmpty(bool, bool)
0x4c9: @@ IsDead(Stack[-1]); Obj=3 // @poff=386
0x4ca: Pop(0)
0x4cb: Stack[-1] = Stack[-4]
0x4cc: Return(); Pop(2)

0x4cd: PushEmpty(object, object, object, object)
0x4ce: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4e2: Pop(0)
0x4e3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4e4: IF (Stack[-1] == 0) GOTO 0x4e7; Pop(1)

0x4e5: Stack[-6] = (bool) 0
0x4e6: Return(); Pop(4)

0x4e7: @@ GetScene(Stack[-1]); Obj=5 // @poff=407
0x4e8: Pop(0)
...
0x4fb: Stack[-6] = Stack[-2]
0x4fc: Stack[-1] = "noaccess" // @poff=416
0x4fd: Call2 0x461
...
0x503: Push("noaccess") // @poff=416
0x504: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=300
0x505: Pop(1)
0x506: Push((int) 0)
...
0x50a: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x518: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x519: Pop(0)
...
0x529: Stack[-1] = "fhit" // @poff=434
0x52a: GOTO 0x52c

0x52b: Stack[-1] = "bhit" // @poff=444
0x52c: Push("hit_react") // @poff=454
0x52d: Push("1") // @poff=474
0x52e: Pop(1); Push(Stack[-3] + Stack[-1]);
0x52f: Push("2") // @poff=478
...
0x548: Stack[-25] = Stack[-1]
0x549: Call2 0x44d

0x54a: Stack[-2] = Stack[-3]
0x54b: Pop(2)
0x54c: Call2 0x5bb

0x54d: Stack[-2] = Stack[-11]
0x54e: Pop(2)
0x54f: @ CreateVectorVector(Stack[-8])
0x550: Pop(0)
0x551: Stack[-7] = (int) 1
0x552: Push("hit") // @poff=436
...
0x567: Pop(0)
0x568: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=491
0x569: Pop(0)
0x56a: PushEmpty(object, int, float, cvector, cvector)
0x56b: Stack[-26] = Stack[-5]
0x56c: Stack[-25] = Stack[-4]
0x56d: Stack[-24] = Stack[-3]
0x56e: Stack[-6] = Stack[-2]
...
0x5cc: Stack[-1] = Stack[-4]
0x5cd: Return(); Pop(0)

0x5ce: Stack[-3] = Stack[-4]
0x5cf: Return(); Pop(0)
...
0x5ea: Stack[-8] = Stack[-5]
0x5eb: Stack[-4] = "reputation" // @poff=541
0x5ec: Stack[-7] = Stack[-3]
0x5ed: Stack[-2] = (int) 0
0x5ee: Stack[-1] = (int) 1
0x5ef: Call2 0x46d
...
0x5f5: Pop(0)
0x5f6: @@ add(Stack[-3]); Obj=1 // @poff=482
0x5f7: Pop(0)
0x5f8: Push((int) 14)
...
0x5ff: Pop(0)
0x600: @@ add(Stack[-3]); Obj=1 // @poff=482
0x601: Pop(0)
0x602: Push((int) 16)
...
0x624: Stack[-7] = Stack[-3]
0x625: Stack[-6] = Stack[-2]
...
0x62c: Stack[-11] = Stack[-5]
0x62d: Stack[-10] = Stack[-4]
0x62e: Stack[-9] = Stack[-3]
0x62f: Stack[-7] = Stack[-2]
...
0x67c: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=635
0x67d: Pop(0)
...
0x71c: Stack[-4] = Stack[-2]
0x71d: Stack[-1] = (float) -0.05000000074505806
0x71e: Call2 0x5d0
