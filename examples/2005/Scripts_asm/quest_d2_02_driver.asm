...
Strings:
	...
	W:quest_d2_02
	W:driver_unload
// @pool_raw:70006c00610079006500720000006800650061006400000061006c006c000000476574506f736974696f6e004765744579657348656967687400690064006c0065000000710075006500730074005f00640032005f003000320000006400720069007600650072005f0075006e006c006f00610064000000
...
0x12: Push("player") // @poff=0
0x13: @ FindActor(Stack[-4]T, Stack[-1])
0x14: Pop(1)
...
0x27: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x6e: Pop(0)
0x6f: Push("all") // @poff=24
0x70: PushEmpty(string, int)
0x71: Stack[-7] = Stack[-1]
0x72: Call2 0xc1
...
0x9f: Pop(0)
0xa0: @@ GetPosition(Stack[-2]); Obj=7 // @poff=32
0xa1: Pop(0)
...
0xda: Stack[-2] = "quest_d2_02" // @poff=68
0xdb: Stack[-1] = "driver_unload" // @poff=92
0xdc: Call2 0xb5
