...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_17 Op = 0x863 Vars = (object)
EVENT_6 Op = 0x874 Vars = ()
EVENT_22 Op = 0x899 Vars = (object, int, float, float)
EVENT_43 Op = 0x8a1 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8ab Vars = (object, string)
EVENT_41 Op = 0x8b8 Vars = (object)
...
0xb4: Stack[-1] = "Neutral" // @poff=89
0xb5: Call2 0x84

0xb6: Pop(1)
0xb7: Push((int) 507522)
0xb8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xb9: Pop(1)
0xba: @@@ ClearReplies(); Obj=0 // @poff=116
0xbb: Pop(0)
0xbc: Push((int) 507523)
0xbd: Push((int) -1)
0xbe: Push((int) 8305)
0xbf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xc0: Pop(3)
...
0xe2: Stack[-1] = 0
0xe3: PushEmpty()
0xe4: Stack[-3] = (float) 0.30000001192092896
0xe5: Return(); Pop(0)
...
0xfe: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xff: Pop(0)
0x100: Push(Stack[-8])
0x101: IF (Stack[-1] == 0) GOTO 0x10a; Pop(1)

0x102: Push("attack") // @poff=226
...
0x11e: Pop(0)
0x11f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x120: Pop(0)
...
0x13a: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x13b: Pop(0)
...
0x154: Pop(1)
0x155: Push("all") // @poff=138
0x156: Push("attack_on") // @poff=254
...
0x16e: IF (Stack[-1] == 1) GOTO 0x174; Pop(1)
...
0x175: @ Face(Stack[-0]T)
0x176: Pop(0)
0x177: PushEmpty()
0x178: Call2 0x372

0x179: Pop(0)
0x17a: Push("all") // @poff=138
0x17b: Push("attack_stay") // @poff=274
0x17c: @ PlayAnimation(Stack[-2], Stack[-1])
0x17d: Pop(2)
0x17e: PushEmpty(bool, float)
0x17f: Stack[-25] = Stack[-1]
0x180: Call2 0x2bc
...
0x185: @ Face(Stack[-0]T)
0x186: Pop(0)
0x187: Push("all") // @poff=138
0x188: Push("fjump") // @poff=298
...
0x1a3: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x1a4: Pop(0)
...
0x1c2: Push("all") // @poff=138
0x1c3: Push("attack_off") // @poff=310
...
0x1d1: Push("attack_begin") // @poff=332
0x1d2: Push((int) 1)
0x1d3: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1de: Push("attack") // @poff=226
0x1df: Push((int) 1)
0x1e0: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1ea: Push("all") // @poff=138
0x1eb: Push("bjump") // @poff=358
...
0x1f2: Push((float)0.8999999761581421)
0x1f3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1f4: @ GetVictim(Stack[-1], Stack[-4])
0x1f5: Pop(1)
0x1f6: @ ReportAttack(Stack[-0]T)
0x1f7: Pop(0)
...
0x1fb: Stack[-6] = Stack[-2]
0x1fc: Stack[-10] = Stack[-1]
0x1fd: Call2 0xe3

0x1fe: Stack[-3] = Stack[-5]
0x1ff: Pop(3)
0x200: PushEmpty(float, object, float, int)
0x201: Stack[-7] = Stack[-3]
0x202: Stack[-6] = Stack[-2]
0x203: PushEmpty(int, object, int)
0x204: Stack[-10] = Stack[-2]
0x205: Stack[-14] = Stack[-1]
0x206: Call2 0xe6

0x207: Stack[-3] = Stack[-4]
0x208: Pop(3)
0x209: Call2 0x5db

0x20a: Stack[-4] = Stack[-5]
0x20b: Pop(4)
0x20c: PushEmpty(int)
0x20d: Call2 0x370

0x20e: Pop(0)
0x20f: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x210: Pop(1)
...
0x21b: Pop(0)
0x21c: @ irand(Stack[-4], Stack[-1]T)
0x21d: Pop(0)
0x21e: Push((int) 1)
0x21f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x220: @ Face(Stack[-0]T)
0x221: Pop(0)
0x222: Push((bool) 1)
...
0x229: Push("attack_begin") // @poff=332
...
0x23d: Stack[-11] = Stack[-2]
0x23e: Stack[-6] = Stack[-1]
0x23f: Call2 0x1f1

0x240: Pop(2)
0x241: Push("all") // @poff=138
0x242: Push("attack_middle") // @poff=370
...
0x24a: Pop(0)
0x24b: Push("all") // @poff=138
0x24c: Push("attack_middle") // @poff=370
...
0x260: Stack[-11] = Stack[-2]
0x261: Stack[-6] = Stack[-1]
0x262: Call2 0x1f1

0x263: Pop(2)
0x264: Stack[-2] = (int) 1
0x265: Push("attack_middle") // @poff=370
0x266: Pop(1); Push(Stack[-1] + Stack[-5]);
0x267: Push("_") // @poff=398
...
0x291: Push("attack_end") // @poff=402
...
0x2d0: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x2d1: Pop(0)
...
0x31c: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x31d: Pop(1)
...
0x321: @ Face(Stack[-0]T)
0x322: Pop(0)
0x323: Push("all") // @poff=138
0x324: Push("bjump") // @poff=358
0x325: @ PlayAnimation(Stack[-2], Stack[-1])
0x326: Pop(2)
0x327: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x328: Pop(0)
...
0x35e: @ irand(Stack[-1], Stack[-2]T)
0x35f: Pop(0)
0x360: Push((int) 1)
0x361: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x362: Push("attack") // @poff=226
...
0x373: Stack[-1] = "attack_stay" // @poff=274
0x374: Call2 0x762
...
0x39e: Stack[-15] = Stack[-5]
0x39f: Stack[-14] = Stack[-4]
0x3a0: Stack[-13] = Stack[-3]
0x3a1: Stack[-12] = Stack[-2]
0x3a2: Stack[-11] = Stack[-1]
0x3a3: Call2 0x3e8

0x3a4: Stack[-6] = Stack[-7]
0x3a5: Pop(6)
0x3a6: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3a7: IF (Stack[-1] == 0) GOTO 0x3ab; Pop(1)

0x3a8: Push("head") // @poff=460
0x3a9: @ UnlookAsync(Stack[-1])
0x3aa: Pop(1)
0x3ab: Push((int) 1)
0x3ac: @ KillTimer(Stack[-1])
0x3ad: Pop(1)
0x3ae: Stack[-1] = Stack[-10]
0x3af: Return(); Pop(4)
...
0x3eb: Stack[-17] = Stack[-7]
0x3ec: PushEmpty(bool, object)
0x3ed: Stack[-23] = Stack[-1]
0x3ee: Call2 0x474
...
0x3f4: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x3f5: Pop(0)
...
0x40b: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x40c: Pop(0)
...
0x41d: Push((int) 0)
0x41e: Push((float)0.30000001192092896)
...
0x440: Push((int) 0)
0x441: Push((float)0.30000001192092896)
...
0x47b: Stack[-1] = "walk" // @poff=482
0x47c: Return(); Pop(0)

0x47d: Stack[-1] = "run" // @poff=492
0x47e: Return(); Pop(0)
...
0x497: Pop(0); PushNull((bool) Stack[-21] == 0)
0x498: IF (Stack[-1] == 0) GOTO 0x49e; Pop(1)

0x499: PushEmpty(string)
0x49a: Stack[-1] = "fdie" // @poff=500
0x49b: Call2 0x4f1

0x49c: Pop(1)
0x49d: GOTO 0x4f0

0x49e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x49f: Pop(0)
...
0x4af: Stack[-6] = "fdie" // @poff=500
0x4b0: GOTO 0x4b2

0x4b1: Stack[-6] = "bdie" // @poff=510
...
0x4b8: @ StopAsync()
0x4b9: Pop(0)
0x4ba: Stack[-21] = Stack[-5]
0x4bb: Push("GetScriptProperty") // @poff=520
0x4bc: Push((int) 2)
0x4bd: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4be: IF (Stack[-1] == 0) GOTO 0x4ca; Pop(1)

0x4bf: Push("Owner") // @poff=556
0x4c0: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=568
0x4c1: Pop(1)
0x4c2: Push(Stack[-4])
0x4c3: IF (Stack[-1] == 0) GOTO 0x4ca; Pop(1)

0x4c4: Push("Owner") // @poff=556
0x4c5: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=586
0x4c6: Pop(1)
0x4c7: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4c8: IF (Stack[-1] == 0) GOTO 0x4ca; Pop(1)

0x4c9: Stack[-21] = Stack[-5]
0x4ca: Push("@GetEyesHeight") // @poff=604
0x4cb: Push((int) 1)
0x4cc: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4cd: IF (Stack[-1] == 0) GOTO 0x4d9; Pop(1)

0x4ce: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x4cf: Pop(0)
0x4d0: Stack[-1] = [0.0, 0.0, 0.0]
0x4d1: Push(CvectorIndex(Stack[-1], 1))
0x4d2: Stack[-3] = Stack[-1]
0x4d3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4d4: Push("head") // @poff=460
...
0x4db: Stack[-7] = Stack[-1]
0x4dc: Call2 0x762

0x4dd: Pop(1)
0x4de: Push("all") // @poff=138
...
0x4e5: @ StopAsync()
0x4e6: Pop(0)
0x4e7: Push("head") // @poff=460
0x4e8: @ UnlookAsync(Stack[-1])
0x4e9: Pop(1)
0x4ea: Push("all") // @poff=138
...
0x53b: PushEmpty()
0x53c: Push("kill_player") // @poff=648
...
0x546: @ GetPFPosition(Stack[-1]T)
0x547: Pop(0)
0x548: @ GetDirection(Stack[-0]T)
0x549: Pop(0)
0x54a: PushEmpty()
0x54b: Call2 0x59e
...
0x567: @ FindPathTo(Stack[-1], Stack[-1]T)
0x568: Pop(0)
...
0x576: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x577: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x589: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x58a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x5a9: Stack[-2] = "bullet" // @poff=682
0x5aa: Return(); Pop(0)

0x5ab: Stack[-2] = "phys" // @poff=696
0x5ac: Return(); Pop(0)

0x5ad: PushEmpty(cvector, cvector, cvector, cvector)
0x5ae: @ GetPosition(Stack[-2])
0x5af: Pop(0)
0x5b0: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x5b1: Pop(0)
...
0x5ba: Push("HasProperty") // @poff=706
0x5bb: Push((int) 2)
...
0x5c1: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=730
0x5c2: Pop(0)
...
0x5c7: Stack[-10] = Stack[-2]
0x5c8: Stack[-9] = Stack[-1]
0x5c9: Call2 0x5b9
...
0x5cf: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=742
0x5d0: Pop(0)
0x5d1: PushEmpty(float, float, float, float)
0x5d2: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x5d3: Stack[-8] = Stack[-2]
0x5d4: Stack[-7] = Stack[-1]
0x5d5: Call2 0x7a6

0x5d6: Pop(3)
0x5d7: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=754
0x5d8: Pop(1)
...
0x5dd: Stack[-18] = Stack[-2]
0x5de: Stack[-1] = "health" // @poff=766
0x5df: Call2 0x5b9
...
0x5e6: Stack[-18] = Stack[-2]
0x5e7: Stack[-1] = "armor" // @poff=780
0x5e8: Call2 0x5b9
...
0x5ee: Push("armor") // @poff=780
0x5ef: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=742
0x5f0: Pop(1)
0x5f1: Push("armor_") // @poff=792
0x5f2: PushEmpty(string, int)
0x5f3: Stack[-16] = Stack[-1]
0x5f4: Call2 0x59f

0x5f5: Pop(1)
0x5f6: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5f7: PushEmpty(bool, object, string)
0x5f8: Stack[-18] = Stack[-2]
0x5f9: Stack[-8] = Stack[-1]
0x5fa: Call2 0x5b9
...
0x600: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=742
0x601: Pop(0)
...
0x608: Stack[-3] = Stack[-6]
0x609: Pop(3)
0x60a: Push("health") // @poff=766
0x60b: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=742
0x60c: Pop(1)
0x60d: Push((int) 1)
0x60e: Pop(1); Push(Stack[-1] - Stack[-4]);
0x60f: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x610: Push("health") // @poff=766
...
0x616: Pop(3)
0x617: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=754
0x618: Pop(2)
0x619: PushEmpty(bool, object)
0x61a: Stack[-17] = Stack[-1]
0x61b: Call2 0x5b4
...
0x621: Pop(1)
0x622: Stack[-1] = Stack[-16]
0x623: Return(); Pop(12)

0x624: PushEmpty(bool, bool)
0x625: @@ IsDead(Stack[-1]); Obj=3 // @poff=806
0x626: Pop(0)
0x627: Stack[-1] = Stack[-4]
0x628: Return(); Pop(2)

0x629: PushEmpty(object, object, object, object)
0x62a: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x63e: Pop(0)
0x63f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x640: IF (Stack[-1] == 0) GOTO 0x643; Pop(1)

0x641: Stack[-6] = (bool) 0
0x642: Return(); Pop(4)

0x643: @@ GetScene(Stack[-1]); Obj=5 // @poff=827
0x644: Pop(0)
...
0x657: Stack[-6] = Stack[-2]
0x658: Stack[-1] = "noaccess" // @poff=836
0x659: Call2 0x5b9
...
0x65f: Push("noaccess") // @poff=836
0x660: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=742
0x661: Pop(1)
0x662: Push((int) 0)
...
0x666: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x674: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x675: Pop(0)
...
0x685: Stack[-1] = "fhit" // @poff=854
0x686: GOTO 0x688

0x687: Stack[-1] = "bhit" // @poff=864
0x688: Push("hit_react") // @poff=874
0x689: Push("1") // @poff=894
0x68a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x68b: Push("2") // @poff=898
...
0x6a4: Stack[-25] = Stack[-1]
0x6a5: Call2 0x5ad

0x6a6: Stack[-2] = Stack[-3]
0x6a7: Pop(2)
0x6a8: Call2 0x791

0x6a9: Stack[-2] = Stack[-11]
0x6aa: Pop(2)
0x6ab: @ CreateVectorVector(Stack[-8])
0x6ac: Pop(0)
0x6ad: Stack[-7] = (int) 1
0x6ae: Push("hit") // @poff=856
...
0x6c3: Pop(0)
0x6c4: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=911
0x6c5: Pop(0)
0x6c6: PushEmpty(object, int, float, cvector, cvector)
0x6c7: Stack[-26] = Stack[-5]
0x6c8: Stack[-25] = Stack[-4]
0x6c9: Stack[-24] = Stack[-3]
...
0x6d7: Pop(0)
0x6d8: Push("scripted") // @poff=915
0x6d9: Push("blood_dir.xml") // @poff=933
...
0x6e4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x6e5: Pop(0)
...
0x6ef: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x6f0: Pop(0)
0x6f1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=634
0x6f2: Pop(0)
...
0x73a: Push("head") // @poff=460
0x73b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x73c: Pop(1)
0x73d: Push(Stack[-1])
0x73e: IF (Stack[-1] == 0) GOTO 0x742; Pop(1)

0x73f: Push("head") // @poff=460
0x740: @ UnlookAsync(Stack[-1])
0x741: Pop(1)
0x742: Return(); Pop(2)

0x743: PushEmpty(float, float, float, float)
0x744: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x745: Pop(0)
0x746: Push((bool) 0)
0x747: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x748: Pop(1)
0x749: Return(); Pop(4)

0x74a: PushEmpty(float, float, float, float)
0x74b: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x74c: Pop(0)
0x74d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x74e: Pop(0)
0x74f: Return(); Pop(4)

0x750: PushEmpty(float, cvector, float, cvector)
0x751: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x752: Pop(0)
0x753: Stack[-1] = [0.0, 0.0, 0.0]
0x754: Push(CvectorIndex(Stack[-1], 1))
0x755: Stack[-3] = Stack[-1]
0x756: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x757: Push("head") // @poff=460
0x758: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x759: Pop(1)
0x75a: Return(); Pop(4)
...
0x762: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x763: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x764: Pop(0)
0x765: Pop(0); Push((bool) Stack[-8] == 0)
0x766: IF (Stack[-1] == 0) GOTO 0x77b; Pop(1)

0x767: Stack[-7] = (int) 0
0x768: Push((int) 1)
0x769: Pop(1); Push(Stack[-8] + Stack[-1]);
0x76a: Pop(1); Push(Stack[-18] + Stack[-1]);
0x76b: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x76c: Pop(1)
0x76d: Pop(0); Push((bool) Stack[-6] == 0)
0x76e: IF (Stack[-1] == 0) GOTO 0x770; Pop(1)

0x76f: GOTO 0x773

0x770: Push((int) 1)
0x771: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x772: GOTO 0x768

0x773: Pop(0); Push((bool) Stack[-7] == 0)
0x774: IF (Stack[-1] == 0) GOTO 0x776; Pop(1)

0x775: Return(); Pop(16)

0x776: @ irand(Stack[-5], Stack[-7])
0x777: Pop(0)
0x778: Push((int) 1)
0x779: Pop(1); Push(Stack[-6] + Stack[-1]);
0x77a: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x77b: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x77c: Pop(0)
0x77d: Push(Stack[-4])
0x77e: IF (Stack[-1] == 0) GOTO 0x78a; Pop(1)

0x77f: @ GetEyesHeight(Stack[-3])
0x780: Pop(0)
0x781: @ GetDirection(Stack[-2])
0x782: Pop(0)
0x783: Push((int) 50)
0x784: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x785: Push(CvectorIndex(Stack[-1], 1))
0x786: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x787: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x788: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x789: Pop(0)
0x78a: Return(); Pop(16)
...
0x790: Stack[-1] = 0
0x791: PushEmpty(float, float)
0x792: Pop(0); Push(Stack[-3] | Stack[-3]);
0x793: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x794: Push((float)9.999999974752427e-07)
0x795: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x796: IF (Stack[-1] == 0) GOTO 0x799; Pop(1)

0x797: Stack[-4] = [0.0, 0.0, 0.0]
0x798: Return(); Pop(2)

0x799: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x79a: Return(); Pop(2)

0x79b: PushEmpty(cvector, cvector)
0x79c: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x79d: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x79e: Return(); Pop(2)
...
0x7a6: PushEmpty()
0x7a7: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x7a8: IF (Stack[-1] == 0) GOTO 0x7ab; Pop(1)

0x7a9: Stack[-2] = Stack[-4]
0x7aa: Return(); Pop(0)

0x7ab: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7ac: IF (Stack[-1] == 0) GOTO 0x7af; Pop(1)

0x7ad: Stack[-1] = Stack[-4]
0x7ae: Return(); Pop(0)

0x7af: Stack[-3] = Stack[-4]
0x7b0: Return(); Pop(0)

0x7b1: PushEmpty()
0x7b2: Pop(0); Push((bool) Stack[-2] == 0)
0x7b3: IF (Stack[-1] == 0) GOTO 0x7b6; Pop(1)

0x7b4: Stack[-3] = (bool) 0
0x7b5: Return(); Pop(0)
...
0x7b9: Push((int) 8)
0x7ba: @ SendWorldWndMessage(Stack[-1])
0x7bb: Pop(1)
0x7bc: GOTO 0x7c6

0x7bd: Push((int) 0)
0x7be: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7bf: IF (Stack[-1] == 0) GOTO 0x7c4; Pop(1)

0x7c0: Push((int) 9)
0x7c1: @ SendWorldWndMessage(Stack[-1])
0x7c2: Pop(1)
0x7c3: GOTO 0x7c6

0x7c4: Stack[-3] = (bool) 0
0x7c5: Return(); Pop(0)

0x7c6: PushEmpty(float)
0x7c7: Stack[-2] = Stack[-1]
0x7c8: Call2 0x7de

0x7c9: Pop(1)
0x7ca: PushEmpty(bool, object, string, float, float, float)
0x7cb: Stack[-8] = Stack[-5]
0x7cc: Stack[-4] = "reputation" // @poff=961
0x7cd: Stack[-7] = Stack[-3]
0x7ce: Stack[-2] = (int) 0
0x7cf: Stack[-1] = (int) 1
0x7d0: Call2 0x5c5

0x7d1: Pop(6)
0x7d2: Stack[-3] = (bool) 1
0x7d3: Return(); Pop(0)

0x7d4: PushEmpty(object, object)
0x7d5: @ CreateFloatVector(Stack[-1])
0x7d6: Pop(0)
0x7d7: @@ add(Stack[-3]); Obj=1 // @poff=902
0x7d8: Pop(0)
0x7d9: Push((int) 15)
0x7da: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7db: Pop(1)
0x7dc: Return(); Pop(2)

0x7dd: Stack[-1] = 0
0x7de: PushEmpty(object, object)
0x7df: @ CreateFloatVector(Stack[-1])
0x7e0: Pop(0)
0x7e1: @@ add(Stack[-3]); Obj=1 // @poff=902
0x7e2: Pop(0)
0x7e3: Push((int) 16)
0x7e4: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7e5: Pop(1)
0x7e6: Return(); Pop(2)

0x7e7: Stack[-1] = 0
0x7e8: PushEmpty(object, object)
0x7e9: @ FindActor(Stack[-1], Stack[-4])
0x7ea: Pop(0)
0x7eb: Pop(0); PushNull((bool) Stack[-1] == 0)
0x7ec: IF (Stack[-1] == 0) GOTO 0x7ef; Pop(1)

0x7ed: Stack[-5] = (bool) 0
0x7ee: Return(); Pop(2)

0x7ef: @ Trigger(Stack[-1], Stack[-3])
0x7f0: Pop(0)
0x7f1: Stack[-5] = (bool) 1
0x7f2: Return(); Pop(2)

0x7f3: Stack[-1] = 0
0x7f4: PushEmpty(bool, bool)
0x7f5: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7f6: Pop(0)
0x7f7: Push(Stack[-1])
0x7f8: IF (Stack[-1] == 0) GOTO 0x7fc; Pop(1)

0x7f9: Push("attack") // @poff=226
0x7fa: @ PlayGlobalMusic(Stack[-1])
0x7fb: Pop(1)
0x7fc: Return(); Pop(2)

0x7fd: PushEmpty(object, object)
0x7fe: @ GetScene(Stack[-1])
0x7ff: Pop(0)
0x800: Push("battle") // @poff=983
0x801: PushEmpty(object)
0x802: Call2 0x78b

0x803: Pop(0)
0x804: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x805: Pop(2)
0x806: Return(); Pop(2)

0x807: Stack[-1] = 0
0x808: PushEmpty()
0x809: PushEmpty(bool, string, string)
0x80a: Stack[-2] = "quest_d2_02" // @poff=997
0x80b: Stack[-1] = "player_attack" // @poff=1021
0x80c: Call2 0x7e8
...
0x80f: PushEmpty()
0x810: PushEmpty(bool, string, string)
0x811: Stack[-2] = "quest_d2_02" // @poff=997
0x812: Stack[-1] = "completed" // @poff=1049
0x813: Call2 0x7e8
...
0x817: Push("branch") // @poff=1069
0x818: @ GetVariable(Stack[-1], Stack[-2])
0x819: Pop(1)
0x81a: Push((int) 0)
...
0x827: PushEmpty(int, int)
0x828: Push("branch") // @poff=1069
0x829: @ GetVariable(Stack[-1], Stack[-2])
0x82a: Pop(1)
0x82b: Stack[-1] = Stack[-3]
0x82c: Return(); Pop(2)
...
0x830: Pop(0)
0x831: Push((int) 1)
0x832: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x833: IF (Stack[-1] == 0) GOTO 0x837; Pop(1)

0x834: @ WorkWithCorpse(Stack[-1])
0x835: Pop(0)
0x836: GOTO 0x839

0x837: @ Barter(Stack[-1])
0x838: Pop(0)
0x839: Return(); Pop(0)

0x83a: PushEmpty(object, int, bool, object, int, bool)
0x83b: @ CreateInvItem(Stack[-3])
0x83c: Pop(0)
0x83d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1083
0x83e: Pop(0)
0x83f: Push("Organ") // @poff=1095
0x840: Push((int) 1)
0x841: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=754
0x842: Pop(2)
0x843: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1107
0x844: Pop(0)
0x845: Push((int) 0)
0x846: Push((int) 1)
0x847: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x848: Pop(2)
0x849: Return(); Pop(6)
...
0x853: Stack[-1] = "liver" // @poff=1117
0x854: Call2 0x83a

0x855: Pop(1)
0x856: PushEmpty(string)
0x857: Stack[-1] = "kidney" // @poff=1129
0x858: Call2 0x83a

0x859: Pop(1)
0x85a: PushEmpty(string)
0x85b: Stack[-1] = "heart" // @poff=1143
0x85c: Call2 0x83a

0x85d: Pop(1)
0x85e: PushEmpty(string)
0x85f: Stack[-1] = "blood" // @poff=1155
0x860: Call2 0x83a

0x861: Pop(1)
0x862: Return(); Pop(0)

0x863: PushEmpty(bool, bool)
0x864: Push(GlobalVars[0])
0x865: IF (Stack[-1] == 0) GOTO 0x867; Pop(1)

0x866: Return(); Pop(2)

0x867: @ IsPlayerActor(Stack[-3], Stack[-1])
0x868: Pop(0)
0x869: Push(Stack[-1])
0x86a: IF (Stack[-1] == 0) GOTO 0x873; Pop(1)

0x86b: Push(GlobalVars[0])
0x86c: Stack[-1] = (bool) 1
0x86d: GlobalVars[0] = Stack[-1]; Pop(1)
0x86e: PushEmpty(bool, string, string)
0x86f: Stack[-2] = "quest_d2_02" // @poff=997
0x870: Stack[-1] = "player_attack" // @poff=1021
0x871: Call2 0x7e8

0x872: Pop(3)
0x873: Return(); Pop(2)

0x874: PushEmpty(bool, string, string)
0x875: Stack[-2] = "quest_d2_02" // @poff=997
0x876: Stack[-1] = "mpatrol_unload" // @poff=1167
0x877: Call2 0x7e8

0x878: Pop(3)
0x879: Return(); Pop(0)

0x87a: PushEmpty(bool, bool)
0x87b: Push("revolver_ammo") // @poff=1197
0x87c: Push((int) 0)
0x87d: Push((int) 2)
0x87e: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x87f: Pop(3)
0x880: Push("alpha_pills") // @poff=1225
0x881: Push((int) 0)
0x882: Push((int) 2)
0x883: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x884: Pop(3)
0x885: PushEmpty(bool, object)
0x886: Stack[-5] = Stack[-1]
0x887: Call2 0x5b4

0x888: Pop(1)
0x889: IF (Stack[-1] == 0) GOTO 0x88f; Pop(1)

0x88a: PushEmpty(bool, object, float)
0x88b: Stack[-6] = Stack[-2]
0x88c: Stack[-1] = (float) -0.15000000596046448
0x88d: Call2 0x7b1
...
0x893: Stack[-4] = Stack[-1]
0x894: Push(-1, 0); TaskCall(4)
0x895: Call2 0x47f

0x896: Pop(-1, 0); TaskReturn
0x897: Pop(1)
0x898: Return(); Pop(2)

0x899: PushEmpty()
0x89a: PushEmpty(object, int, float)
0x89b: Stack[-7] = Stack[-3]
0x89c: Stack[-6] = Stack[-2]
...
0x8a1: PushEmpty()
0x8a2: PushEmpty(object, int, float, cvector, cvector)
0x8a3: Stack[-11] = Stack[-5]
0x8a4: Stack[-10] = Stack[-4]
0x8a5: Stack[-9] = Stack[-3]
0x8a6: Stack[-7] = Stack[-2]
0x8a7: Stack[-6] = Stack[-1]
0x8a8: Call2 0x6d5
...
0x8ac: Push("health") // @poff=766
0x8ad: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8ae: IF (Stack[-1] == 0) GOTO 0x8b7; Pop(1)

0x8af: Push("health") // @poff=766
0x8b0: @ GetProperty(Stack[-1], Stack[-2])
0x8b1: Pop(1)
0x8b2: Push((int) 0)
0x8b3: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x8b4: IF (Stack[-1] == 0) GOTO 0x8b7; Pop(1)

0x8b5: @ SignalDeath(Stack[-4])
0x8b6: Pop(0)
0x8b7: Return(); Pop(2)

0x8b8: PushEmpty()
0x8b9: PushEmpty(object)
0x8ba: Stack[-2] = Stack[-1]
0x8bb: Call2 0x87a

0x8bc: Pop(1)
0x8bd: Return(); Pop(0)

0x8be: Stack[-1] = (int) 515572
0x8bf: Return(); Pop(0)

0x8c0: Stack[-1] = (int) 504031
0x8c1: Return(); Pop(0)

0x8c2: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1249
0x8c3: Return(); Pop(0)

0x8c4: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1289
0x8c5: Return(); Pop(0)
