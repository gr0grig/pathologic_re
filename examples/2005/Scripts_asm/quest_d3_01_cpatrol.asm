...
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x8d5 Vars = (object, int, float, float)
EVENT_43 Op = 0x8dd Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8e7 Vars = (object, string)
EVENT_41 Op = 0x8f4 Vars = (object)
...
0xb7: Stack[-1] = "Neutral" // @poff=89
0xb8: Call2 0x7f

0xb9: Pop(1)
0xba: Push((int) 509122)
0xbb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xbc: Pop(1)
0xbd: @@@ ClearReplies(); Obj=0 // @poff=116
0xbe: Pop(0)
...
0x10e: Stack[-1] = 0
0x10f: PushEmpty()
0x110: Stack[-3] = (float) 0.30000001192092896
0x111: Return(); Pop(0)
...
0x12a: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x12b: Pop(0)
0x12c: Push(Stack[-8])
0x12d: IF (Stack[-1] == 0) GOTO 0x136; Pop(1)

0x12e: Push("attack") // @poff=226
...
0x14a: Pop(0)
0x14b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x14c: Pop(0)
...
0x166: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x167: Pop(0)
...
0x180: Pop(1)
0x181: Push("all") // @poff=138
0x182: Push("attack_on") // @poff=254
...
0x19a: IF (Stack[-1] == 1) GOTO 0x1a0; Pop(1)

0x19b: PushEmpty(bool)
0x19c: Call2 0x36c

0x19d: Pop(0)
0x19e: IF (Stack[-1] == 1) GOTO 0x1a0; Pop(1)

0x19f: Stack[-1] = (bool) 0
0x1a0: IF (Stack[-1] == 0) GOTO 0x1b1; Pop(1)

0x1a1: @ Face(Stack[-0]T)
0x1a2: Pop(0)
0x1a3: PushEmpty()
0x1a4: Call2 0x39e

0x1a5: Pop(0)
0x1a6: Push("all") // @poff=138
0x1a7: Push("attack_stay") // @poff=274
0x1a8: @ PlayAnimation(Stack[-2], Stack[-1])
0x1a9: Pop(2)
0x1aa: PushEmpty(bool, float)
0x1ab: Stack[-25] = Stack[-1]
0x1ac: Call2 0x2e8
...
0x1b1: @ Face(Stack[-0]T)
0x1b2: Pop(0)
0x1b3: Push("all") // @poff=138
0x1b4: Push("fjump") // @poff=298
...
0x1cf: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x1d0: Pop(0)
...
0x1ef: Push("attack_off") // @poff=310
...
0x1fc: Push("all") // @poff=138
0x1fd: Push("attack_begin") // @poff=332
0x1fe: Push((int) 1)
0x1ff: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x20a: Push("attack") // @poff=226
0x20b: Push((int) 1)
0x20c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x21e: Push((float)0.8999999761581421)
0x21f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x220: @ GetVictim(Stack[-1], Stack[-4])
0x221: Pop(1)
0x222: @ ReportAttack(Stack[-0]T)
0x223: Pop(0)
...
0x227: Stack[-6] = Stack[-2]
0x228: Stack[-10] = Stack[-1]
0x229: Call2 0x10f

0x22a: Stack[-3] = Stack[-5]
0x22b: Pop(3)
0x22c: PushEmpty(float, object, float, int)
0x22d: Stack[-7] = Stack[-3]
0x22e: Stack[-6] = Stack[-2]
0x22f: PushEmpty(int, object, int)
0x230: Stack[-10] = Stack[-2]
0x231: Stack[-14] = Stack[-1]
0x232: Call2 0x112

0x233: Stack[-3] = Stack[-4]
0x234: Pop(3)
0x235: Call2 0x5fc

0x236: Stack[-4] = Stack[-5]
0x237: Pop(4)
0x238: PushEmpty(int)
0x239: Call2 0x39c

0x23a: Pop(0)
0x23b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x23c: Pop(1)
...
0x247: Pop(0)
0x248: @ irand(Stack[-4], Stack[-1]T)
0x249: Pop(0)
0x24a: Push((int) 1)
0x24b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x24c: @ Face(Stack[-0]T)
0x24d: Pop(0)
0x24e: Push((bool) 1)
...
0x255: Push("attack_begin") // @poff=332
...
0x269: Stack[-11] = Stack[-2]
0x26a: Stack[-6] = Stack[-1]
0x26b: Call2 0x21d

0x26c: Pop(2)
0x26d: Push("all") // @poff=138
0x26e: Push("attack_middle") // @poff=370
...
0x278: Push("attack_middle") // @poff=370
...
0x28f: Pop(2)
0x290: Stack[-2] = (int) 1
0x291: Push("attack_middle") // @poff=370
0x292: Pop(1); Push(Stack[-1] + Stack[-5]);
0x293: Push("_") // @poff=398
...
0x2b2: Stack[-11] = Stack[-2]
0x2b3: Stack[-6] = Stack[-1]
0x2b4: Call2 0x21d
...
0x2bd: Push("attack_end") // @poff=402
...
0x2fc: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x2fd: Pop(0)
...
0x348: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x349: Pop(1)
...
0x350: Push("bjump") // @poff=358
0x351: @ PlayAnimation(Stack[-2], Stack[-1])
0x352: Pop(2)
0x353: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x354: Pop(0)
...
0x38a: @ irand(Stack[-1], Stack[-2]T)
0x38b: Pop(0)
0x38c: Push((int) 1)
0x38d: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x38e: Push("attack") // @poff=226
...
0x39f: Stack[-1] = "attack_stay" // @poff=274
0x3a0: Call2 0x783
...
0x3ca: Stack[-15] = Stack[-5]
0x3cb: Stack[-14] = Stack[-4]
0x3cc: Stack[-13] = Stack[-3]
0x3cd: Stack[-12] = Stack[-2]
0x3ce: Stack[-11] = Stack[-1]
0x3cf: Call2 0x414

0x3d0: Stack[-6] = Stack[-7]
0x3d1: Pop(6)
0x3d2: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3d3: IF (Stack[-1] == 0) GOTO 0x3d7; Pop(1)

0x3d4: Push("head") // @poff=460
...
0x417: Stack[-17] = Stack[-7]
0x418: PushEmpty(bool, object)
0x419: Stack[-23] = Stack[-1]
0x41a: Call2 0x4a0
...
0x420: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x421: Pop(0)
...
0x437: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x438: Pop(0)
...
0x449: Push((int) 0)
0x44a: Push((float)0.30000001192092896)
...
0x46c: Push((int) 0)
0x46d: Push((float)0.30000001192092896)
...
0x4a7: Stack[-1] = "walk" // @poff=482
0x4a8: Return(); Pop(0)

0x4a9: Stack[-1] = "run" // @poff=492
0x4aa: Return(); Pop(0)
...
0x4c3: Pop(0); PushNull((bool) Stack[-21] == 0)
0x4c4: IF (Stack[-1] == 0) GOTO 0x4ca; Pop(1)

0x4c5: PushEmpty(string)
0x4c6: Stack[-1] = "fdie" // @poff=500
0x4c7: Call2 0x51d

0x4c8: Pop(1)
0x4c9: GOTO 0x51c

0x4ca: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x4cb: Pop(0)
...
0x4db: Stack[-6] = "fdie" // @poff=500
0x4dc: GOTO 0x4de

0x4dd: Stack[-6] = "bdie" // @poff=510
...
0x4e4: @ StopAsync()
0x4e5: Pop(0)
0x4e6: Stack[-21] = Stack[-5]
0x4e7: Push("GetScriptProperty") // @poff=520
0x4e8: Push((int) 2)
0x4e9: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4ea: IF (Stack[-1] == 0) GOTO 0x4f6; Pop(1)

0x4eb: Push("Owner") // @poff=556
0x4ec: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=568
0x4ed: Pop(1)
0x4ee: Push(Stack[-4])
0x4ef: IF (Stack[-1] == 0) GOTO 0x4f6; Pop(1)

0x4f0: Push("Owner") // @poff=556
0x4f1: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=586
0x4f2: Pop(1)
0x4f3: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4f4: IF (Stack[-1] == 0) GOTO 0x4f6; Pop(1)

0x4f5: Stack[-21] = Stack[-5]
0x4f6: Push("@GetEyesHeight") // @poff=604
0x4f7: Push((int) 1)
0x4f8: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4f9: IF (Stack[-1] == 0) GOTO 0x505; Pop(1)

0x4fa: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x4fb: Pop(0)
0x4fc: Stack[-1] = [0.0, 0.0, 0.0]
0x4fd: Push(CvectorIndex(Stack[-1], 1))
0x4fe: Stack[-3] = Stack[-1]
0x4ff: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x500: Push("head") // @poff=460
...
0x567: @ GetPFPosition(Stack[-1]T)
0x568: Pop(0)
0x569: @ GetDirection(Stack[-0]T)
0x56a: Pop(0)
0x56b: PushEmpty()
0x56c: Call2 0x5bf
...
0x588: @ FindPathTo(Stack[-1], Stack[-1]T)
0x589: Pop(0)
...
0x597: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x598: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x5aa: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x5ab: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x5ca: Stack[-2] = "bullet" // @poff=658
0x5cb: Return(); Pop(0)

0x5cc: Stack[-2] = "phys" // @poff=672
0x5cd: Return(); Pop(0)

0x5ce: PushEmpty(cvector, cvector, cvector, cvector)
0x5cf: @ GetPosition(Stack[-2])
0x5d0: Pop(0)
0x5d1: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x5d2: Pop(0)
...
0x5db: Push("HasProperty") // @poff=682
0x5dc: Push((int) 2)
...
0x5e2: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=706
0x5e3: Pop(0)
0x5e4: Stack[-1] = Stack[-5]
0x5e5: Return(); Pop(2)

0x5e6: PushEmpty(float, float)
0x5e7: PushEmpty(bool, object, string)
0x5e8: Stack[-10] = Stack[-2]
0x5e9: Stack[-9] = Stack[-1]
0x5ea: Call2 0x5da
...
0x5f0: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=718
0x5f1: Pop(0)
0x5f2: PushEmpty(float, float, float, float)
0x5f3: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x5f4: Stack[-8] = Stack[-2]
0x5f5: Stack[-7] = Stack[-1]
0x5f6: Call2 0x7c7

0x5f7: Pop(3)
0x5f8: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=730
0x5f9: Pop(1)
...
0x5fe: Stack[-18] = Stack[-2]
0x5ff: Stack[-1] = "health" // @poff=742
0x600: Call2 0x5da
...
0x607: Stack[-18] = Stack[-2]
0x608: Stack[-1] = "armor" // @poff=756
0x609: Call2 0x5da
...
0x60f: Push("armor") // @poff=756
0x610: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=718
0x611: Pop(1)
0x612: Push("armor_") // @poff=768
0x613: PushEmpty(string, int)
0x614: Stack[-16] = Stack[-1]
0x615: Call2 0x5c0

0x616: Pop(1)
0x617: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x618: PushEmpty(bool, object, string)
0x619: Stack[-18] = Stack[-2]
...
0x621: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=718
0x622: Pop(0)
...
0x629: Stack[-3] = Stack[-6]
0x62a: Pop(3)
0x62b: Push("health") // @poff=742
0x62c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=718
0x62d: Pop(1)
0x62e: Push((int) 1)
0x62f: Pop(1); Push(Stack[-1] - Stack[-4]);
0x630: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x631: Push("health") // @poff=742
...
0x637: Pop(3)
0x638: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=730
0x639: Pop(2)
0x63a: PushEmpty(bool, object)
0x63b: Stack[-17] = Stack[-1]
0x63c: Call2 0x5d5
...
0x642: Pop(1)
0x643: Stack[-1] = Stack[-16]
0x644: Return(); Pop(12)

0x645: PushEmpty(bool, bool)
0x646: @@ IsDead(Stack[-1]); Obj=3 // @poff=782
0x647: Pop(0)
0x648: Stack[-1] = Stack[-4]
0x649: Return(); Pop(2)

0x64a: PushEmpty(object, object, object, object)
0x64b: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x65f: Pop(0)
0x660: Pop(0); PushNull((bool) Stack[-2] == 0)
0x661: IF (Stack[-1] == 0) GOTO 0x664; Pop(1)

0x662: Stack[-6] = (bool) 0
0x663: Return(); Pop(4)

0x664: @@ GetScene(Stack[-1]); Obj=5 // @poff=803
0x665: Pop(0)
...
0x679: Stack[-1] = "noaccess" // @poff=812
0x67a: Call2 0x5da
...
0x680: Push("noaccess") // @poff=812
0x681: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=718
0x682: Pop(1)
0x683: Push((int) 0)
...
0x687: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x695: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x696: Pop(0)
...
0x6a6: Stack[-1] = "fhit" // @poff=830
0x6a7: GOTO 0x6a9

0x6a8: Stack[-1] = "bhit" // @poff=840
0x6a9: Push("hit_react") // @poff=850
0x6aa: Push("1") // @poff=870
0x6ab: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6ac: Push("2") // @poff=874
...
0x6c5: Stack[-25] = Stack[-1]
0x6c6: Call2 0x5ce

0x6c7: Stack[-2] = Stack[-3]
0x6c8: Pop(2)
0x6c9: Call2 0x7b2

0x6ca: Stack[-2] = Stack[-11]
0x6cb: Pop(2)
0x6cc: @ CreateVectorVector(Stack[-8])
0x6cd: Pop(0)
0x6ce: Stack[-7] = (int) 1
0x6cf: Push("hit") // @poff=832
...
0x6e4: Pop(0)
0x6e5: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=887
0x6e6: Pop(0)
0x6e7: PushEmpty(object, int, float, cvector, cvector)
0x6e8: Stack[-26] = Stack[-5]
0x6e9: Stack[-25] = Stack[-4]
0x6ea: Stack[-24] = Stack[-3]
0x6eb: Stack[-6] = Stack[-2]
...
0x705: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x706: Pop(0)
...
0x710: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x711: Pop(0)
0x712: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=634
0x713: Pop(0)
...
0x75b: Push("head") // @poff=460
0x75c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x75d: Pop(1)
0x75e: Push(Stack[-1])
0x75f: IF (Stack[-1] == 0) GOTO 0x763; Pop(1)

0x760: Push("head") // @poff=460
0x761: @ UnlookAsync(Stack[-1])
0x762: Pop(1)
0x763: Return(); Pop(2)

0x764: PushEmpty(float, float, float, float)
0x765: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x766: Pop(0)
0x767: Push((bool) 0)
0x768: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x769: Pop(1)
0x76a: Return(); Pop(4)

0x76b: PushEmpty(float, float, float, float)
0x76c: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x76d: Pop(0)
0x76e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x76f: Pop(0)
0x770: Return(); Pop(4)

0x771: PushEmpty(float, cvector, float, cvector)
0x772: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x773: Pop(0)
0x774: Stack[-1] = [0.0, 0.0, 0.0]
0x775: Push(CvectorIndex(Stack[-1], 1))
0x776: Stack[-3] = Stack[-1]
0x777: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x778: Push("head") // @poff=460
0x779: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x77a: Pop(1)
0x77b: Return(); Pop(4)
...
0x783: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x784: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x785: Pop(0)
0x786: Pop(0); Push((bool) Stack[-8] == 0)
0x787: IF (Stack[-1] == 0) GOTO 0x79c; Pop(1)

0x788: Stack[-7] = (int) 0
0x789: Push((int) 1)
0x78a: Pop(1); Push(Stack[-8] + Stack[-1]);
0x78b: Pop(1); Push(Stack[-18] + Stack[-1]);
0x78c: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x78d: Pop(1)
0x78e: Pop(0); Push((bool) Stack[-6] == 0)
0x78f: IF (Stack[-1] == 0) GOTO 0x791; Pop(1)

0x790: GOTO 0x794

0x791: Push((int) 1)
0x792: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x793: GOTO 0x789

0x794: Pop(0); Push((bool) Stack[-7] == 0)
0x795: IF (Stack[-1] == 0) GOTO 0x797; Pop(1)

0x796: Return(); Pop(16)

0x797: @ irand(Stack[-5], Stack[-7])
0x798: Pop(0)
0x799: Push((int) 1)
0x79a: Pop(1); Push(Stack[-6] + Stack[-1]);
0x79b: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x79c: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x79d: Pop(0)
0x79e: Push(Stack[-4])
0x79f: IF (Stack[-1] == 0) GOTO 0x7ab; Pop(1)

0x7a0: @ GetEyesHeight(Stack[-3])
0x7a1: Pop(0)
0x7a2: @ GetDirection(Stack[-2])
0x7a3: Pop(0)
0x7a4: Push((int) 50)
0x7a5: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7a6: Push(CvectorIndex(Stack[-1], 1))
0x7a7: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7a8: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7a9: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7aa: Pop(0)
0x7ab: Return(); Pop(16)
...
0x7ad: @ self(Stack[-1])
0x7ae: Pop(0)
0x7af: Stack[-1] = Stack[-3]
0x7b0: Return(); Pop(2)

0x7b1: Stack[-1] = 0
0x7b2: PushEmpty(float, float)
0x7b3: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7b4: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7b5: Push((float)9.999999974752427e-07)
0x7b6: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7b7: IF (Stack[-1] == 0) GOTO 0x7ba; Pop(1)

0x7b8: Stack[-4] = [0.0, 0.0, 0.0]
0x7b9: Return(); Pop(2)

0x7ba: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x7bb: Return(); Pop(2)

0x7bc: PushEmpty(cvector, cvector)
0x7bd: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x7be: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x7bf: Return(); Pop(2)

0x7c0: PushEmpty()
0x7c1: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x7c2: IF (Stack[-1] == 0) GOTO 0x7c5; Pop(1)

0x7c3: Stack[-2] = Stack[-3]
0x7c4: GOTO 0x7c6
...
0x7c7: PushEmpty()
0x7c8: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x7c9: IF (Stack[-1] == 0) GOTO 0x7cc; Pop(1)

0x7ca: Stack[-2] = Stack[-4]
0x7cb: Return(); Pop(0)

0x7cc: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7cd: IF (Stack[-1] == 0) GOTO 0x7d0; Pop(1)

0x7ce: Stack[-1] = Stack[-4]
0x7cf: Return(); Pop(0)

0x7d0: Stack[-3] = Stack[-4]
0x7d1: Return(); Pop(0)

0x7d2: PushEmpty()
0x7d3: Pop(0); Push((bool) Stack[-2] == 0)
...
0x7da: Push((int) 8)
0x7db: @ SendWorldWndMessage(Stack[-1])
0x7dc: Pop(1)
0x7dd: GOTO 0x7e7

0x7de: Push((int) 0)
0x7df: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x7e0: IF (Stack[-1] == 0) GOTO 0x7e5; Pop(1)

0x7e1: Push((int) 9)
0x7e2: @ SendWorldWndMessage(Stack[-1])
0x7e3: Pop(1)
0x7e4: GOTO 0x7e7

0x7e5: Stack[-3] = (bool) 0
0x7e6: Return(); Pop(0)

0x7e7: PushEmpty(float)
0x7e8: Stack[-2] = Stack[-1]
0x7e9: Call2 0x7ff

0x7ea: Pop(1)
0x7eb: PushEmpty(bool, object, string, float, float, float)
0x7ec: Stack[-8] = Stack[-5]
0x7ed: Stack[-4] = "reputation" // @poff=937
0x7ee: Stack[-7] = Stack[-3]
0x7ef: Stack[-2] = (int) 0
0x7f0: Stack[-1] = (int) 1
0x7f1: Call2 0x5e6

0x7f2: Pop(6)
0x7f3: Stack[-3] = (bool) 1
0x7f4: Return(); Pop(0)

0x7f5: PushEmpty(object, object)
0x7f6: @ CreateFloatVector(Stack[-1])
0x7f7: Pop(0)
0x7f8: @@ add(Stack[-3]); Obj=1 // @poff=878
0x7f9: Pop(0)
0x7fa: Push((int) 15)
0x7fb: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7fc: Pop(1)
0x7fd: Return(); Pop(2)

0x7fe: Stack[-1] = 0
0x7ff: PushEmpty(object, object)
0x800: @ CreateFloatVector(Stack[-1])
0x801: Pop(0)
0x802: @@ add(Stack[-3]); Obj=1 // @poff=878
0x803: Pop(0)
0x804: Push((int) 16)
0x805: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x806: Pop(1)
0x807: Return(); Pop(2)

0x808: Stack[-1] = 0
0x809: PushEmpty(object, object)
0x80a: @ FindActor(Stack[-1], Stack[-4])
0x80b: Pop(0)
0x80c: Pop(0); PushNull((bool) Stack[-1] == 0)
0x80d: IF (Stack[-1] == 0) GOTO 0x810; Pop(1)

0x80e: Stack[-5] = (bool) 0
0x80f: Return(); Pop(2)

0x810: @ Trigger(Stack[-1], Stack[-3])
0x811: Pop(0)
0x812: Stack[-5] = (bool) 1
0x813: Return(); Pop(2)

0x814: Stack[-1] = 0
0x815: PushEmpty(bool, bool)
0x816: @ IsPlayerActor(Stack[-3], Stack[-1])
0x817: Pop(0)
0x818: Push(Stack[-1])
0x819: IF (Stack[-1] == 0) GOTO 0x81d; Pop(1)

0x81a: Push("attack") // @poff=226
0x81b: @ PlayGlobalMusic(Stack[-1])
0x81c: Pop(1)
0x81d: Return(); Pop(2)

0x81e: PushEmpty(object, object)
0x81f: @ GetScene(Stack[-1])
0x820: Pop(0)
0x821: Push("battle") // @poff=959
0x822: PushEmpty(object)
0x823: Call2 0x7ac

0x824: Pop(0)
0x825: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x826: Pop(2)
0x827: Return(); Pop(2)
...
0x82c: Pop(0)
0x82d: PushEmpty(bool, string, string)
0x82e: Stack[-2] = "quest_d3_01" // @poff=973
0x82f: Stack[-1] = "patrol_talk" // @poff=997
0x830: Call2 0x809
...
0x834: Push((int) 72)
0x835: Push((int) 1)
0x836: Push((int) 512154)
0x837: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x838: Pop(3)
0x839: PushEmpty(bool, object, int)
0x83a: Stack[-4] = Stack[-2]
0x83b: Stack[-1] = (int) 25
0x83c: Call2 0x84d
...
0x841: @ GetDiaryRoot(Stack[-1])
0x842: Pop(0)
0x843: Pop(0); Push((bool) Stack[-1] == 0)
0x844: IF (Stack[-1] == 0) GOTO 0x84a; Pop(1)

0x845: Push("Can't retrieve diary root") // @poff=1021
0x846: @ Trace(Stack[-1])
0x847: Pop(1)
0x848: Stack[-3] = (bool) 0
0x849: Return(); Pop(2)
...
0x84c: Stack[-1] = 0
0x84d: PushEmpty(object, object, int, object, object, int)
0x84e: PushEmpty(object)
0x84f: Call2 0x840

0x850: Stack[-1] = Stack[-4]
0x851: Pop(1)
0x852: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1073
0x853: Pop(0)
0x854: Pop(0); Push((bool) Stack[-2] == 0)
0x855: IF (Stack[-1] == 0) GOTO 0x85c; Pop(1)

0x856: Push("Can't find diary parent with id: ") // @poff=1078
0x857: Pop(1); Push(Stack[-1] + Stack[-8]);
0x858: @ Trace(Stack[-1])
0x859: Pop(1)
0x85a: Stack[-9] = (bool) 0
0x85b: Return(); Pop(6)

0x85c: @@ AddChild(Stack[-8]); Obj=2 // @poff=1146
0x85d: Pop(0)
0x85e: Push((int) 7)
0x85f: @ SendWorldWndMessage(Stack[-1])
0x860: Pop(1)
0x861: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1155
0x862: Pop(0)
0x863: @ SetDiarySection(Stack[-1])
0x864: Pop(0)
0x865: Stack[-9] = (bool) 0
0x866: Return(); Pop(6)

0x867: Stack[-2] = 0
0x868: Stack[-3] = 0
0x869: PushEmpty(int, int)
0x86a: Push("branch") // @poff=1167
0x86b: @ GetVariable(Stack[-1], Stack[-2])
0x86c: Pop(1)
0x86d: Push((int) 0)
...
0x88f: Pop(0)
0x890: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1181
0x891: Pop(0)
0x892: Push("Organ") // @poff=1193
0x893: Push((int) 1)
0x894: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=730
0x895: Pop(2)
0x896: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1205
0x897: Pop(0)
0x898: Push((int) 0)
0x899: Push((int) 1)
...
0x8a6: Stack[-1] = "liver" // @poff=1215
0x8a7: Call2 0x88d

0x8a8: Pop(1)
0x8a9: PushEmpty(string)
0x8aa: Stack[-1] = "kidney" // @poff=1227
0x8ab: Call2 0x88d

0x8ac: Pop(1)
0x8ad: PushEmpty(string)
0x8ae: Stack[-1] = "heart" // @poff=1241
0x8af: Call2 0x88d

0x8b0: Pop(1)
0x8b1: PushEmpty(string)
0x8b2: Stack[-1] = "blood" // @poff=1253
0x8b3: Call2 0x88d
...
0x8b7: Push("revolver_ammo") // @poff=1265
0x8b8: Push((int) 0)
0x8b9: Push((int) 2)
0x8ba: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8bb: Pop(3)
0x8bc: Push("alpha_pills") // @poff=1293
0x8bd: Push((int) 0)
0x8be: Push((int) 2)
0x8bf: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8c0: Pop(3)
0x8c1: PushEmpty()
0x8c2: Call2 0x89e
...
0x8c9: PushEmpty(bool, object, float)
0x8ca: Stack[-6] = Stack[-2]
0x8cb: Stack[-1] = (float) -0.20000000298023224
0x8cc: Call2 0x7d2

0x8cd: Pop(3)
0x8ce: PushEmpty(object)
0x8cf: Stack[-4] = Stack[-1]
0x8d0: Push(-1, 0); TaskCall(4)
0x8d1: Call2 0x4ab

0x8d2: Pop(-1, 0); TaskReturn
0x8d3: Pop(1)
0x8d4: Return(); Pop(2)

0x8d5: PushEmpty()
0x8d6: PushEmpty(object, int, float)
0x8d7: Stack[-7] = Stack[-3]
0x8d8: Stack[-6] = Stack[-2]
0x8d9: Stack[-5] = Stack[-1]
0x8da: Call2 0x6b2
...
0x8df: Stack[-11] = Stack[-5]
0x8e0: Stack[-10] = Stack[-4]
0x8e1: Stack[-9] = Stack[-3]
0x8e2: Stack[-7] = Stack[-2]
...
0x8e7: PushEmpty(float, float)
0x8e8: Push("health") // @poff=742
0x8e9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8ea: IF (Stack[-1] == 0) GOTO 0x8f3; Pop(1)

0x8eb: Push("health") // @poff=742
0x8ec: @ GetProperty(Stack[-1], Stack[-2])
0x8ed: Pop(1)
0x8ee: Push((int) 0)
0x8ef: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x8f0: IF (Stack[-1] == 0) GOTO 0x8f3; Pop(1)

0x8f1: @ SignalDeath(Stack[-4])
0x8f2: Pop(0)
0x8f3: Return(); Pop(2)

0x8f4: PushEmpty()
0x8f5: PushEmpty(object)
...
0x8fa: Stack[-1] = (int) 515572
0x8fb: Return(); Pop(0)

0x8fc: Stack[-1] = (int) 504031
0x8fd: Return(); Pop(0)

0x8fe: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1317
0x8ff: Return(); Pop(0)

0x900: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1357
0x901: Return(); Pop(0)
