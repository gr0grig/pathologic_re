...
0x9f: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=176
0xa0: Pop(0)
0xa1: Pop(0); Push((bool) Stack[-4] == 0)
0xa2: IF (Stack[-1] == 0) GOTO 0xab; Pop(1)

0xa3: Push("Locator ") // @poff=187
0xa4: Pop(1); Push(Stack[-1] + Stack[-12]);
0xa5: Push(" doesn't exist") // @poff=205
...
0xb1: Push("nouse_container") // @poff=235
