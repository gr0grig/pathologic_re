...
// @pool_raw:
// @pool_encoding:utf8
...
0x15a: Stack[-1] = 0
0x15b: PushEmpty()
0x15c: Stack[-3] = (float) 0.30000001192092896
0x15d: Return(); Pop(0)
...
0x176: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x177: Pop(0)
0x178: Push(Stack[-8])
0x179: IF (Stack[-1] == 0) GOTO 0x182; Pop(1)

0x17a: Push("attack") // @poff=226
...
0x196: Pop(0)
0x197: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x198: Pop(0)
...
0x1b2: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x1b3: Pop(0)
...
0x1cc: Pop(1)
0x1cd: Push("all") // @poff=138
0x1ce: Push("attack_on") // @poff=254
...
0x1e6: IF (Stack[-1] == 1) GOTO 0x1ec; Pop(1)

0x1e7: PushEmpty(bool)
0x1e8: Call2 0x3b8

0x1e9: Pop(0)
0x1ea: IF (Stack[-1] == 1) GOTO 0x1ec; Pop(1)

0x1eb: Stack[-1] = (bool) 0
0x1ec: IF (Stack[-1] == 0) GOTO 0x1fd; Pop(1)

0x1ed: @ Face(Stack[-0]T)
0x1ee: Pop(0)
0x1ef: PushEmpty()
0x1f0: Call2 0x3ea
...
0x1fd: @ Face(Stack[-0]T)
0x1fe: Pop(0)
0x1ff: Push("all") // @poff=138
0x200: Push("fjump") // @poff=298
...
0x21b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x21c: Pop(0)
...
0x23a: Push("all") // @poff=138
0x23b: Push("attack_off") // @poff=310
...
0x249: Push("attack_begin") // @poff=332
0x24a: Push((int) 1)
0x24b: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x256: Push("attack") // @poff=226
0x257: Push((int) 1)
0x258: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x262: Push("all") // @poff=138
0x263: Push("bjump") // @poff=358
...
0x26a: Push((float)0.8999999761581421)
0x26b: Pop(1); Push(Stack[-9] * Stack[-1]);
0x26c: @ GetVictim(Stack[-1], Stack[-4])
0x26d: Pop(1)
0x26e: @ ReportAttack(Stack[-0]T)
0x26f: Pop(0)
...
0x273: Stack[-6] = Stack[-2]
0x274: Stack[-10] = Stack[-1]
0x275: Call2 0x15b

0x276: Stack[-3] = Stack[-5]
0x277: Pop(3)
0x278: PushEmpty(float, object, float, int)
0x279: Stack[-7] = Stack[-3]
0x27a: Stack[-6] = Stack[-2]
0x27b: PushEmpty(int, object, int)
0x27c: Stack[-10] = Stack[-2]
0x27d: Stack[-14] = Stack[-1]
0x27e: Call2 0x15e

0x27f: Stack[-3] = Stack[-4]
0x280: Pop(3)
0x281: Call2 0x648

0x282: Stack[-4] = Stack[-5]
0x283: Pop(4)
0x284: PushEmpty(int)
0x285: Call2 0x3e8

0x286: Pop(0)
0x287: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x288: Pop(1)
...
0x29f: Pop(0)
0x2a0: Push("all") // @poff=138
0x2a1: Push("attack_begin") // @poff=332
...
0x2ba: Push("attack_middle") // @poff=370
...
0x2c2: Pop(0)
0x2c3: Push("all") // @poff=138
0x2c4: Push("attack_middle") // @poff=370
...
0x2d8: Stack[-11] = Stack[-2]
0x2d9: Stack[-6] = Stack[-1]
0x2da: Call2 0x269

0x2db: Pop(2)
0x2dc: Stack[-2] = (int) 1
0x2dd: Push("attack_middle") // @poff=370
0x2de: Pop(1); Push(Stack[-1] + Stack[-5]);
0x2df: Push("_") // @poff=398
...
0x309: Push("attack_end") // @poff=402
...
0x348: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x349: Pop(0)
...
0x394: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x395: Pop(1)
...
0x39c: Push("bjump") // @poff=358
0x39d: @ PlayAnimation(Stack[-2], Stack[-1])
0x39e: Pop(2)
0x39f: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x3a0: Pop(0)
...
0x3d6: @ irand(Stack[-1], Stack[-2]T)
0x3d7: Pop(0)
0x3d8: Push((int) 1)
0x3d9: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3da: Push("attack") // @poff=226
...
0x3eb: Stack[-1] = "attack_stay" // @poff=274
0x3ec: Call2 0x7cf
...
0x416: Stack[-15] = Stack[-5]
0x417: Stack[-14] = Stack[-4]
0x418: Stack[-13] = Stack[-3]
0x419: Stack[-12] = Stack[-2]
0x41a: Stack[-11] = Stack[-1]
0x41b: Call2 0x460

0x41c: Stack[-6] = Stack[-7]
0x41d: Pop(6)
0x41e: Push( Stack[2 + Tasks[-1].StackPointer] )
0x41f: IF (Stack[-1] == 0) GOTO 0x423; Pop(1)

0x420: Push("head") // @poff=460
...
0x463: Stack[-17] = Stack[-7]
0x464: PushEmpty(bool, object)
0x465: Stack[-23] = Stack[-1]
0x466: Call2 0x4ec
...
0x46c: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x46d: Pop(0)
...
0x483: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x484: Pop(0)
...
0x495: Push((int) 0)
0x496: Push((float)0.30000001192092896)
...
0x4b8: Push((int) 0)
0x4b9: Push((float)0.30000001192092896)
...
0x4f0: Stack[-2] = Stack[-4]
0x4f1: Pop(2)
0x4f2: Return(); Pop(0)

0x4f3: Stack[-1] = "walk" // @poff=482
0x4f4: Return(); Pop(0)

0x4f5: Stack[-1] = "run" // @poff=492
0x4f6: Return(); Pop(0)
...
0x50f: Pop(0); PushNull((bool) Stack[-21] == 0)
0x510: IF (Stack[-1] == 0) GOTO 0x516; Pop(1)

0x511: PushEmpty(string)
0x512: Stack[-1] = "fdie" // @poff=500
0x513: Call2 0x569

0x514: Pop(1)
0x515: GOTO 0x568

0x516: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x517: Pop(0)
...
0x527: Stack[-6] = "fdie" // @poff=500
0x528: GOTO 0x52a

0x529: Stack[-6] = "bdie" // @poff=510
...
0x530: @ StopAsync()
0x531: Pop(0)
0x532: Stack[-21] = Stack[-5]
0x533: Push("GetScriptProperty") // @poff=520
0x534: Push((int) 2)
0x535: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x536: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x537: Push("Owner") // @poff=556
0x538: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=568
0x539: Pop(1)
0x53a: Push(Stack[-4])
0x53b: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x53c: Push("Owner") // @poff=556
0x53d: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=586
0x53e: Pop(1)
0x53f: Pop(0); PushNull((bool) Stack[-5] == 0)
0x540: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x541: Stack[-21] = Stack[-5]
0x542: Push("@GetEyesHeight") // @poff=604
0x543: Push((int) 1)
0x544: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x545: IF (Stack[-1] == 0) GOTO 0x551; Pop(1)

0x546: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x547: Pop(0)
0x548: Stack[-1] = [0.0, 0.0, 0.0]
0x549: Push(CvectorIndex(Stack[-1], 1))
0x54a: Stack[-3] = Stack[-1]
0x54b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x54c: Push("head") // @poff=460
...
0x55d: @ StopAsync()
0x55e: Pop(0)
0x55f: Push("head") // @poff=460
0x560: @ UnlookAsync(Stack[-1])
0x561: Pop(1)
0x562: Push("all") // @poff=138
...
0x5b3: @ GetPFPosition(Stack[-1]T)
0x5b4: Pop(0)
0x5b5: @ GetDirection(Stack[-0]T)
0x5b6: Pop(0)
0x5b7: PushEmpty()
0x5b8: Call2 0x60b
...
0x5d4: @ FindPathTo(Stack[-1], Stack[-1]T)
0x5d5: Pop(0)
...
0x5e3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x5e4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x5f6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x5f7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x616: Stack[-2] = "bullet" // @poff=658
0x617: Return(); Pop(0)

0x618: Stack[-2] = "phys" // @poff=672
0x619: Return(); Pop(0)

0x61a: PushEmpty(cvector, cvector, cvector, cvector)
0x61b: @ GetPosition(Stack[-2])
0x61c: Pop(0)
0x61d: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x61e: Pop(0)
...
0x623: Pop(0)
0x624: Stack[-1] = Stack[-4]
0x625: Return(); Pop(2)

0x626: PushEmpty(bool, bool)
0x627: Push("HasProperty") // @poff=682
0x628: Push((int) 2)
...
0x62e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=706
0x62f: Pop(0)
...
0x634: Stack[-10] = Stack[-2]
0x635: Stack[-9] = Stack[-1]
0x636: Call2 0x626
...
0x63c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=718
0x63d: Pop(0)
0x63e: PushEmpty(float, float, float, float)
0x63f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x640: Stack[-8] = Stack[-2]
0x641: Stack[-7] = Stack[-1]
0x642: Call2 0x813

0x643: Pop(3)
0x644: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=730
0x645: Pop(1)
...
0x653: Stack[-18] = Stack[-2]
0x654: Stack[-1] = "armor" // @poff=756
0x655: Call2 0x626
...
0x65b: Push("armor") // @poff=756
0x65c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=718
0x65d: Pop(1)
0x65e: Push("armor_") // @poff=768
...
0x665: Stack[-18] = Stack[-2]
0x666: Stack[-8] = Stack[-1]
0x667: Call2 0x626
...
0x66d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=718
0x66e: Pop(0)
...
0x675: Stack[-3] = Stack[-6]
0x676: Pop(3)
0x677: Push("health") // @poff=742
0x678: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=718
0x679: Pop(1)
0x67a: Push((int) 1)
0x67b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x67c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x67d: Push("health") // @poff=742
...
0x683: Pop(3)
0x684: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=730
0x685: Pop(2)
0x686: PushEmpty(bool, object)
0x687: Stack[-17] = Stack[-1]
0x688: Call2 0x621
...
0x68e: Pop(1)
0x68f: Stack[-1] = Stack[-16]
0x690: Return(); Pop(12)

0x691: PushEmpty(bool, bool)
0x692: @@ IsDead(Stack[-1]); Obj=3 // @poff=782
0x693: Pop(0)
0x694: Stack[-1] = Stack[-4]
0x695: Return(); Pop(2)

0x696: PushEmpty(object, object, object, object)
0x697: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6ab: Pop(0)
0x6ac: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6ad: IF (Stack[-1] == 0) GOTO 0x6b0; Pop(1)

0x6ae: Stack[-6] = (bool) 0
0x6af: Return(); Pop(4)

0x6b0: @@ GetScene(Stack[-1]); Obj=5 // @poff=803
0x6b1: Pop(0)
...
0x6c4: Stack[-6] = Stack[-2]
0x6c5: Stack[-1] = "noaccess" // @poff=812
0x6c6: Call2 0x626
...
0x6cc: Push("noaccess") // @poff=812
0x6cd: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=718
0x6ce: Pop(1)
0x6cf: Push((int) 0)
...
0x6e1: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x6e2: Pop(0)
...
0x6f2: Stack[-1] = "fhit" // @poff=830
0x6f3: GOTO 0x6f5

0x6f4: Stack[-1] = "bhit" // @poff=840
0x6f5: Push("hit_react") // @poff=850
0x6f6: Push("1") // @poff=870
0x6f7: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6f8: Push("2") // @poff=874
...
0x726: @@ add(Stack[-5]); Obj=8 // @poff=878
0x727: Pop(0)
0x728: Push((int) 1)
0x729: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x72a: GOTO 0x71b

0x72b: @@ size(Stack[-3]); Obj=8 // @poff=882
0x72c: Pop(0)
0x72d: Push(Stack[-3])
...
0x730: Pop(0)
0x731: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=887
0x732: Pop(0)
...
0x744: Pop(0)
0x745: Push("scripted") // @poff=891
0x746: Push("blood_dir.xml") // @poff=909
...
0x751: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x752: Pop(0)
...
0x75c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x75d: Pop(0)
0x75e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=634
0x75f: Pop(0)
...
0x7a7: Push("head") // @poff=460
0x7a8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7a9: Pop(1)
0x7aa: Push(Stack[-1])
0x7ab: IF (Stack[-1] == 0) GOTO 0x7af; Pop(1)

0x7ac: Push("head") // @poff=460
0x7ad: @ UnlookAsync(Stack[-1])
0x7ae: Pop(1)
0x7af: Return(); Pop(2)

0x7b0: PushEmpty(float, float, float, float)
0x7b1: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x7b2: Pop(0)
0x7b3: Push((bool) 0)
0x7b4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7b5: Pop(1)
0x7b6: Return(); Pop(4)

0x7b7: PushEmpty(float, float, float, float)
0x7b8: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x7b9: Pop(0)
0x7ba: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x7bb: Pop(0)
0x7bc: Return(); Pop(4)

0x7bd: PushEmpty(float, cvector, float, cvector)
0x7be: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x7bf: Pop(0)
0x7c0: Stack[-1] = [0.0, 0.0, 0.0]
0x7c1: Push(CvectorIndex(Stack[-1], 1))
0x7c2: Stack[-3] = Stack[-1]
0x7c3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7c4: Push("head") // @poff=460
...
0x7cf: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7d0: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7d1: Pop(0)
0x7d2: Pop(0); Push((bool) Stack[-8] == 0)
0x7d3: IF (Stack[-1] == 0) GOTO 0x7e8; Pop(1)

0x7d4: Stack[-7] = (int) 0
0x7d5: Push((int) 1)
0x7d6: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7d7: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7d8: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7d9: Pop(1)
0x7da: Pop(0); Push((bool) Stack[-6] == 0)
0x7db: IF (Stack[-1] == 0) GOTO 0x7dd; Pop(1)

0x7dc: GOTO 0x7e0

0x7dd: Push((int) 1)
0x7de: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7df: GOTO 0x7d5

0x7e0: Pop(0); Push((bool) Stack[-7] == 0)
0x7e1: IF (Stack[-1] == 0) GOTO 0x7e3; Pop(1)

0x7e2: Return(); Pop(16)

0x7e3: @ irand(Stack[-5], Stack[-7])
0x7e4: Pop(0)
0x7e5: Push((int) 1)
0x7e6: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7e7: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7e8: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7e9: Pop(0)
0x7ea: Push(Stack[-4])
0x7eb: IF (Stack[-1] == 0) GOTO 0x7f7; Pop(1)

0x7ec: @ GetEyesHeight(Stack[-3])
0x7ed: Pop(0)
0x7ee: @ GetDirection(Stack[-2])
0x7ef: Pop(0)
0x7f0: Push((int) 50)
0x7f1: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7f2: Push(CvectorIndex(Stack[-1], 1))
0x7f3: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7f4: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7f5: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7f6: Pop(0)
0x7f7: Return(); Pop(16)
...
0x7f9: @ self(Stack[-1])
0x7fa: Pop(0)
0x7fb: Stack[-1] = Stack[-3]
0x7fc: Return(); Pop(2)

0x7fd: Stack[-1] = 0
0x7fe: PushEmpty(float, float)
0x7ff: Pop(0); Push(Stack[-3] | Stack[-3]);
0x800: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x801: Push((float)9.999999974752427e-07)
0x802: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x803: IF (Stack[-1] == 0) GOTO 0x806; Pop(1)

0x804: Stack[-4] = [0.0, 0.0, 0.0]
0x805: Return(); Pop(2)

0x806: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x807: Return(); Pop(2)

0x808: PushEmpty(cvector, cvector)
0x809: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x80a: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x80b: Return(); Pop(2)

0x80c: PushEmpty()
0x80d: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x80e: IF (Stack[-1] == 0) GOTO 0x811; Pop(1)

0x80f: Stack[-2] = Stack[-3]
0x810: GOTO 0x812

0x811: Stack[-1] = Stack[-3]
0x812: Return(); Pop(0)

0x813: PushEmpty()
0x814: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x815: IF (Stack[-1] == 0) GOTO 0x818; Pop(1)

0x816: Stack[-2] = Stack[-4]
0x817: Return(); Pop(0)

0x818: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x819: IF (Stack[-1] == 0) GOTO 0x81c; Pop(1)

0x81a: Stack[-1] = Stack[-4]
0x81b: Return(); Pop(0)

0x81c: Stack[-3] = Stack[-4]
0x81d: Return(); Pop(0)

0x81e: PushEmpty()
0x81f: Pop(0); Push((bool) Stack[-2] == 0)
0x820: IF (Stack[-1] == 0) GOTO 0x823; Pop(1)

0x821: Stack[-3] = (bool) 0
0x822: Return(); Pop(0)
...
0x826: Push((int) 8)
0x827: @ SendWorldWndMessage(Stack[-1])
0x828: Pop(1)
0x829: GOTO 0x833

0x82a: Push((int) 0)
0x82b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x82c: IF (Stack[-1] == 0) GOTO 0x831; Pop(1)

0x82d: Push((int) 9)
0x82e: @ SendWorldWndMessage(Stack[-1])
0x82f: Pop(1)
0x830: GOTO 0x833

0x831: Stack[-3] = (bool) 0
0x832: Return(); Pop(0)
...
0x836: Pop(1)
0x837: PushEmpty(bool, object, string, float, float, float)
0x838: Stack[-8] = Stack[-5]
0x839: Stack[-4] = "reputation" // @poff=937
0x83a: Stack[-7] = Stack[-3]
0x83b: Stack[-2] = (int) 0
0x83c: Stack[-1] = (int) 1
0x83d: Call2 0x632

0x83e: Pop(6)
0x83f: Stack[-3] = (bool) 1
0x840: Return(); Pop(0)

0x841: PushEmpty(object, object)
0x842: @ CreateFloatVector(Stack[-1])
0x843: Pop(0)
0x844: @@ add(Stack[-3]); Obj=1 // @poff=878
0x845: Pop(0)
0x846: Push((int) 15)
0x847: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x848: Pop(1)
0x849: Return(); Pop(2)

0x84a: Stack[-1] = 0
0x84b: PushEmpty(object, object)
0x84c: @ CreateFloatVector(Stack[-1])
0x84d: Pop(0)
0x84e: @@ add(Stack[-3]); Obj=1 // @poff=878
0x84f: Pop(0)
0x850: Push((int) 16)
0x851: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x852: Pop(1)
0x853: Return(); Pop(2)

0x854: Stack[-1] = 0
0x855: PushEmpty(bool, bool)
0x856: @ IsPlayerActor(Stack[-3], Stack[-1])
0x857: Pop(0)
0x858: Push(Stack[-1])
0x859: IF (Stack[-1] == 0) GOTO 0x85d; Pop(1)

0x85a: Push("attack") // @poff=226
0x85b: @ PlayGlobalMusic(Stack[-1])
0x85c: Pop(1)
0x85d: Return(); Pop(2)

0x85e: PushEmpty(object, object)
0x85f: @ GetScene(Stack[-1])
0x860: Pop(0)
0x861: Push("battle") // @poff=959
0x862: PushEmpty(object)
0x863: Call2 0x7f8

0x864: Pop(0)
0x865: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x866: Pop(2)
0x867: Return(); Pop(2)

0x868: Stack[-1] = 0
0x869: PushEmpty(int, int)
0x86a: Push("branch") // @poff=973
...
0x88f: Pop(0)
0x890: @@ SetItemName(Stack[-7]); Obj=3 // @poff=987
0x891: Pop(0)
0x892: Push("Organ") // @poff=999
0x893: Push((int) 1)
0x894: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=730
0x895: Pop(2)
0x896: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1011
0x897: Pop(0)
0x898: Push((int) 0)
0x899: Push((int) 1)
...
0x8a6: Stack[-1] = "liver" // @poff=1021
0x8a7: Call2 0x88d

0x8a8: Pop(1)
0x8a9: PushEmpty(string)
0x8aa: Stack[-1] = "kidney" // @poff=1033
0x8ab: Call2 0x88d

0x8ac: Pop(1)
0x8ad: PushEmpty(string)
0x8ae: Stack[-1] = "heart" // @poff=1047
0x8af: Call2 0x88d

0x8b0: Pop(1)
0x8b1: PushEmpty(string)
0x8b2: Stack[-1] = "blood" // @poff=1059
0x8b3: Call2 0x88d
...
0x8b7: Push("revolver_ammo") // @poff=1071
0x8b8: Push((int) 0)
0x8b9: Push((int) 2)
0x8ba: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8bb: Pop(3)
0x8bc: Push("alpha_pills") // @poff=1099
0x8bd: Push((int) 0)
0x8be: Push((int) 2)
...
0x8fe: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1123
0x8ff: Return(); Pop(0)

0x900: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1163
0x901: Return(); Pop(0)
