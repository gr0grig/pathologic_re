...
Strings:
	...
	W:cleanup
	W:restore
// @pool_raw:710075006500730074005f00640033005f0030003200000062007500740063006800650072005f007400720069006700670065007200000063006c00650061006e0075007000000072006500730074006f00720065000000
...
0x7: Stack[-2] = "quest_d3_02" // @poff=0
0x8: Stack[-1] = "butcher_trigger" // @poff=24
0x9: Call2 0x49
...
0x4b: Pop(0)
0x4c: Pop(0); PushNull((bool) Stack[-1] == 0)
