...
Strings:
	...
	W:health
	W:boy_attacked
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x639 Vars = (object, int, float, float)
EVENT_43 Op = 0x641 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x64b Vars = (object, string)
EVENT_41 Op = 0x658 Vars = (object)
EVENT_17 Op = 0x66d Vars = (object)
...
0x51a: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x51b: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x51c: Pop(0)
...
0x51f: Stack[-7] = (int) 0
0x520: Push((int) 1)
0x521: Pop(1); Push(Stack[-8] + Stack[-1]);
0x522: Pop(1); Push(Stack[-18] + Stack[-1]);
0x523: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x524: Pop(1)
0x525: Pop(0); Push((bool) Stack[-6] == 0)
0x526: IF (Stack[-1] == 0) GOTO 0x528; Pop(1)

0x527: GOTO 0x52b

0x528: Push((int) 1)
0x529: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x52a: GOTO 0x520

0x52b: Pop(0); Push((bool) Stack[-7] == 0)
0x52c: IF (Stack[-1] == 0) GOTO 0x52e; Pop(1)

0x52d: Return(); Pop(16)

0x52e: @ irand(Stack[-5], Stack[-7])
0x52f: Pop(0)
0x530: Push((int) 1)
0x531: Pop(1); Push(Stack[-6] + Stack[-1]);
0x532: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x533: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x534: Pop(0)
0x535: Push(Stack[-4])
0x536: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x537: @ GetEyesHeight(Stack[-3])
0x538: Pop(0)
0x539: @ GetDirection(Stack[-2])
0x53a: Pop(0)
0x53b: Push((int) 50)
0x53c: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x53d: Push(CvectorIndex(Stack[-1], 1))
0x53e: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x53f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x540: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x541: Pop(0)
0x542: Return(); Pop(16)
...
0x54d: PushEmpty()
0x54e: Pop(0); Push(Stack[-2] | Stack[-1]);
0x54f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x550: Pop(0); Push(Stack[-3] | Stack[-3]);
0x551: Pop(2); Push(Stack[-2] * Stack[-1]);
0x552: Pop(1); Push(Sqrt(Stack[-1]))
0x553: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x554: Return(); Pop(0)

0x555: PushEmpty(object, object)
0x556: @ CreateIntVector(Stack[-1])
0x557: Pop(0)
0x558: @@ add(Stack[-4]); Obj=1 // @poff=564
0x559: Pop(0)
0x55a: @@ add(Stack[-3]); Obj=1 // @poff=564
0x55b: Pop(0)
0x55c: Push((int) 3)
0x55d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x55e: Pop(1)
0x55f: Return(); Pop(2)

0x560: Stack[-1] = 0
0x561: PushEmpty(int, int, bool, int, int, bool)
0x562: @@ GetItemID(Stack[-3]); Obj=8 // @poff=623
0x563: Pop(0)
0x564: Push("Category") // @poff=633
0x565: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x566: Pop(1)
0x567: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=651
0x568: Pop(0)
0x569: Pop(0); Push((bool) Stack[-1] == 0)
0x56a: IF (Stack[-1] == 0) GOTO 0x56e; Pop(1)

0x56b: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=659
0x56c: Pop(0)
0x56d: GOTO 0x573

0x56e: PushEmpty(int, int)
0x56f: Stack[-5] = Stack[-2]
0x570: Stack[-9] = Stack[-1]
0x571: Call2 0x555
...
0x575: @ CreateInvItem(Stack[-1])
0x576: Pop(0)
0x577: @@ SetItemName(Stack[-4]); Obj=1 // @poff=669
0x578: Pop(0)
0x579: PushEmpty(object, object, int)
0x57a: Stack[-8] = Stack[-3]
0x57b: Stack[-4] = Stack[-2]
...
0x582: @ FindActor(Stack[-1], Stack[-4])
0x583: Pop(0)
0x584: Pop(0); PushNull((bool) Stack[-1] == 0)
0x585: IF (Stack[-1] == 0) GOTO 0x588; Pop(1)

0x586: Stack[-5] = (bool) 0
0x587: Return(); Pop(2)

0x588: @ Trigger(Stack[-1], Stack[-3])
0x589: Pop(0)
0x58a: Stack[-5] = (bool) 1
0x58b: Return(); Pop(2)

0x58c: Stack[-1] = 0
0x58d: PushEmpty(string, string)
0x58e: Stack[-1] = "idle" // @poff=146
0x58f: Push(Stack[-3])
0x590: IF (Stack[-1] == 0) GOTO 0x592; Pop(1)

0x591: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x592: Stack[-1] = Stack[-4]
0x593: Return(); Pop(2)

0x594: PushEmpty(int, bool, int, bool)
0x595: Stack[-2] = (int) 0
0x596: Push("all") // @poff=138
0x597: PushEmpty(string, int)
0x598: Stack[-5] = Stack[-1]
0x599: Call2 0x58d

0x59a: Pop(1)
0x59b: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x59c: Pop(2)
...
0x5a0: Push((int) 1)
0x5a1: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x5a2: GOTO 0x596

0x5a3: Stack[-2] = Stack[-5]
0x5a4: Return(); Pop(4)

0x5a5: PushEmpty()
0x5a6: Push("playsound") // @poff=681
0x5a7: Push("giveitem") // @poff=701
0x5a8: @ TriggerWorld(Stack[-2], Stack[-1])
0x5a9: Pop(2)
0x5aa: Return(); Pop(0)

0x5ab: PushEmpty(float, float)
0x5ac: Push("d3q03") // @poff=719
0x5ad: Push((int) 2)
...
0x5b2: Pop(0)
0x5b3: Push("disease") // @poff=731
0x5b4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=504
0x5b5: Pop(1)
0x5b6: Push((float)0.5)
0x5b7: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x5b8: IF (Stack[-1] == 0) GOTO 0x5bd; Pop(1)

0x5b9: Push("disease") // @poff=731
0x5ba: Push((float)0.5)
0x5bb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=747
0x5bc: Pop(2)
0x5bd: Return(); Pop(2)

0x5be: PushEmpty()
0x5bf: Push("powder is given") // @poff=759
0x5c0: @ Trace(Stack[-1])
0x5c1: Pop(1)
0x5c2: PushEmpty(object, string, int)
0x5c3: Stack[-5] = Stack[-3]
0x5c4: Stack[-2] = "powder" // @poff=791
0x5c5: Stack[-1] = (int) 1
0x5c6: Call2 0x574
...
0x5cc: Pop(0)
0x5cd: PushEmpty(bool, string, string)
0x5ce: Stack[-2] = "quest_d3_03" // @poff=156
0x5cf: Stack[-1] = "fail" // @poff=805
0x5d0: Call2 0x581
...
0x5d4: Push((int) 84)
0x5d5: Push((int) 2)
0x5d6: Push((int) 512166)
0x5d7: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5d8: Pop(3)
0x5d9: PushEmpty(bool, object, int)
0x5da: Stack[-4] = Stack[-2]
0x5db: Stack[-1] = (int) 27
0x5dc: Call2 0x5fa
...
0x5e1: Push((int) 86)
0x5e2: Push((int) 2)
0x5e3: Push((int) 512168)
0x5e4: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5e5: Pop(3)
0x5e6: PushEmpty(bool, object, int)
0x5e7: Stack[-4] = Stack[-2]
0x5e8: Stack[-1] = (int) 27
0x5e9: Call2 0x5fa
...
0x5ee: @ GetDiaryRoot(Stack[-1])
0x5ef: Pop(0)
0x5f0: Pop(0); Push((bool) Stack[-1] == 0)
0x5f1: IF (Stack[-1] == 0) GOTO 0x5f7; Pop(1)

0x5f2: Push("Can't retrieve diary root") // @poff=815
0x5f3: @ Trace(Stack[-1])
0x5f4: Pop(1)
0x5f5: Stack[-3] = (bool) 0
0x5f6: Return(); Pop(2)
...
0x5f9: Stack[-1] = 0
0x5fa: PushEmpty(object, object, int, object, object, int)
0x5fb: PushEmpty(object)
0x5fc: Call2 0x5ed

0x5fd: Stack[-1] = Stack[-4]
0x5fe: Pop(1)
0x5ff: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=867
0x600: Pop(0)
0x601: Pop(0); Push((bool) Stack[-2] == 0)
0x602: IF (Stack[-1] == 0) GOTO 0x609; Pop(1)

0x603: Push("Can't find diary parent with id: ") // @poff=872
0x604: Pop(1); Push(Stack[-1] + Stack[-8]);
0x605: @ Trace(Stack[-1])
0x606: Pop(1)
0x607: Stack[-9] = (bool) 0
0x608: Return(); Pop(6)

0x609: @@ AddChild(Stack[-8]); Obj=2 // @poff=940
0x60a: Pop(0)
0x60b: Push((int) 7)
0x60c: @ SendWorldWndMessage(Stack[-1])
0x60d: Pop(1)
0x60e: @@ GetCategory(Stack[-1]); Obj=8 // @poff=949
0x60f: Pop(0)
0x610: @ SetDiarySection(Stack[-1])
0x611: Pop(0)
0x612: Stack[-9] = (bool) 0
0x613: Return(); Pop(6)

0x614: Stack[-2] = 0
0x615: Stack[-3] = 0
0x616: PushEmpty(int, int)
0x617: Push("branch") // @poff=961
0x618: @ GetVariable(Stack[-1], Stack[-2])
0x619: Pop(1)
0x61a: Push((int) 0)
...
0x627: Stack[-1] = (int) 515560
0x628: Return(); Pop(0)

0x629: Stack[-1] = (int) 503345
0x62a: Return(); Pop(0)

0x62b: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=975
0x62c: Return(); Pop(0)

0x62d: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1015
0x62e: Return(); Pop(0)
...
0x634: Push(-1, 0); TaskCall(6)
0x635: Call2 0x351

0x636: Pop(-1, 0); TaskReturn
0x637: Pop(1)
0x638: Return(); Pop(0)

0x639: PushEmpty()
0x63a: PushEmpty(object, int, float)
0x63b: Stack[-7] = Stack[-3]
0x63c: Stack[-6] = Stack[-2]
...
0x641: PushEmpty()
0x642: PushEmpty(object, int, float, cvector, cvector)
0x643: Stack[-11] = Stack[-5]
0x644: Stack[-10] = Stack[-4]
0x645: Stack[-9] = Stack[-3]
0x646: Stack[-7] = Stack[-2]
0x647: Stack[-6] = Stack[-1]
0x648: Call2 0x49e

0x649: Pop(5)
0x64a: Return(); Pop(0)

0x64b: PushEmpty(float, float)
0x64c: Push("health") // @poff=1059
0x64d: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x64e: IF (Stack[-1] == 0) GOTO 0x657; Pop(1)

0x64f: Push("health") // @poff=1059
...
0x660: Stack[-3] = Stack[-1]
0x661: Call2 0x416

0x662: Stack[-2] = Stack[-4]
0x663: Pop(2)
0x664: Return(); Pop(0)

0x665: PushEmpty()
0x666: PushEmpty(object)
0x667: Stack[-2] = Stack[-1]
0x668: Push(-1, 3); TaskCall(5)
0x669: Call2 0x2b4

0x66a: Pop(-1, 3); TaskReturn
0x66b: Pop(1)
0x66c: Return(); Pop(0)
...
0x673: Stack[-2] = "quest_d3_03" // @poff=156
0x674: Stack[-1] = "boy_attacked" // @poff=1073
0x675: Call2 0x581
