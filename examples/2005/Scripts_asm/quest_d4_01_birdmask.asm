...
// @pool_raw:
// @pool_encoding:utf8
...
0x15b: Stack[-2] = "quest_d4_01" // @poff=156
0x15c: Stack[-1] = "birdmask_done" // @poff=180
0x15d: Call2 0x22e
...
0x1bc: @@ GetPosition(Stack[-8]); Obj=20 // @poff=208
0x1bd: Pop(0)
0x1be: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=220
0x1bf: Pop(0)
...
0x1e4: @ StopWorld()
0x1e5: Pop(0)
0x1e6: @ CameraTransit(Stack[-3], Stack[-5])
0x1e7: Pop(0)
0x1e8: Push(CvectorIndex(Stack[-4], 0))
0x1e9: Push(CvectorIndex(Stack[-5], 2))
0x1ea: @ Rotate(Stack[-2], Stack[-1])
0x1eb: Pop(2)
...
0x1f1: Push("head") // @poff=234
0x1f2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1f3: Pop(1)
0x1f4: Push(Stack[-1])
0x1f5: IF (Stack[-1] == 0) GOTO 0x1f9; Pop(1)

0x1f6: Push("head") // @poff=234
0x1f7: @ LookAsyncCamera(Stack[-1])
0x1f8: Pop(1)
0x1f9: @ CameraWaitForPlayFinish()
0x1fa: Pop(0)
0x1fb: @ ResumeWorld()
0x1fc: Pop(0)
0x1fd: Stack[-21] = (bool) 1
0x1fe: Return(); Pop(18)

0x1ff: PushEmpty(bool, bool)
0x200: @ CameraSwitchToNormal()
0x201: Pop(0)
...
0x207: Push("head") // @poff=234
0x208: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x209: Pop(1)
0x20a: Push(Stack[-1])
0x20b: IF (Stack[-1] == 0) GOTO 0x20f; Pop(1)

0x20c: Push("head") // @poff=234
0x20d: @ UnlookAsync(Stack[-1])
0x20e: Pop(1)
0x20f: Return(); Pop(2)

0x210: PushEmpty(float, float, float, float)
0x211: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x212: Pop(0)
0x213: Push((bool) 0)
0x214: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x215: Pop(1)
0x216: Return(); Pop(4)

0x217: PushEmpty(float, float, float, float)
0x218: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x219: Pop(0)
0x21a: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x21b: Pop(0)
0x21c: Return(); Pop(4)
...
0x224: PushEmpty(float, float)
0x225: Pop(0); Push(Stack[-3] | Stack[-3]);
0x226: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x227: Push((float)9.999999974752427e-07)
0x228: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x229: IF (Stack[-1] == 0) GOTO 0x22c; Pop(1)

0x22a: Stack[-4] = [0.0, 0.0, 0.0]
0x22b: Return(); Pop(2)

0x22c: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x22d: Return(); Pop(2)

0x22e: PushEmpty(object, object)
0x22f: @ FindActor(Stack[-1], Stack[-4])
0x230: Pop(0)
0x231: Pop(0); PushNull((bool) Stack[-1] == 0)
0x232: IF (Stack[-1] == 0) GOTO 0x235; Pop(1)

0x233: Stack[-5] = (bool) 0
0x234: Return(); Pop(2)

0x235: @ Trigger(Stack[-1], Stack[-3])
0x236: Pop(0)
0x237: Stack[-5] = (bool) 1
0x238: Return(); Pop(2)

0x239: Stack[-1] = 0
0x23a: PushEmpty(float, float)
0x23b: @ GetGameTime(Stack[-1])
0x23c: Pop(0)
0x23d: Stack[-1] = Stack[-3]
0x23e: Return(); Pop(2)

0x23f: PushEmpty(string, string)
0x240: Stack[-1] = "idle" // @poff=146
0x241: Push(Stack[-3])
0x242: IF (Stack[-1] == 0) GOTO 0x244; Pop(1)

0x243: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x244: Stack[-1] = Stack[-4]
0x245: Return(); Pop(2)

0x246: PushEmpty(int, bool, int, bool)
0x247: Stack[-2] = (int) 0
0x248: Push("all") // @poff=138
0x249: PushEmpty(string, int)
0x24a: Stack[-5] = Stack[-1]
0x24b: Call2 0x23f

0x24c: Pop(1)
0x24d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x24e: Pop(2)
...
0x252: Push((int) 1)
0x253: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x254: GOTO 0x248

0x255: Stack[-2] = Stack[-5]
0x256: Return(); Pop(4)
...
0x25b: Pop(1)
0x25c: Push("d4q01Whitemask") // @poff=244
0x25d: Push("pt_d4q01_key1_region") // @poff=274
0x25e: Push((int) 1)
0x25f: Push((int) 511523)
0x260: PushEmpty(float)
0x261: Call2 0x23a

0x262: Pop(0)
0x263: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=316
0x264: Pop(5)
0x265: Return(); Pop(2)

0x266: Stack[-1] = 0
0x267: PushEmpty()
0x268: PushEmpty(object, string, float)
0x269: PushEmpty(object)
0x26a: Call2 0x277

0x26b: Stack[-1] = Stack[-4]
0x26c: Pop(1)
0x26d: Stack[-2] = "pt_d4q01_key1_region" // @poff=274
0x26e: Stack[-1] = (int) 2
0x26f: Call2 0x288
...
0x273: Pop(0)
0x274: @@ ShowMap(Stack[-1]); Obj=2 // @poff=324
0x275: Pop(1)
0x276: Return(); Pop(0)

0x277: PushEmpty(object, object, object, object)
0x278: @ GetMainOutdoorScene(Stack[-2])
0x279: Pop(0)
0x27a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x27b: IF (Stack[-1] == 0) GOTO 0x282; Pop(1)

0x27c: Push("Can't find main outdoor scene") // @poff=332
0x27d: @ Trace(Stack[-1])
0x27e: Pop(1)
0x27f: Stack[-1] = 0
0x280: Stack[-1] = Stack[-5]
0x281: Return(); Pop(4)

0x282: @@ GetMap(Stack[-1]); Obj=2 // @poff=392
0x283: Pop(0)
0x284: Stack[-1] = Stack[-5]
0x285: Return(); Pop(4)

0x286: Stack[-1] = 0
0x287: Stack[-2] = 0
0x288: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x289: @ GetMainOutdoorScene(Stack[-2])
0x28a: Pop(0)
0x28b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x28c: IF (Stack[-1] == 0) GOTO 0x291; Pop(1)

0x28d: Push("Can't find main outdoor scene") // @poff=332
0x28e: @ Trace(Stack[-1])
0x28f: Pop(1)
0x290: Return(); Pop(8)

0x291: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=399
0x292: Pop(0)
0x293: Pop(0); Push((bool) Stack[-1] == 0)
0x294: IF (Stack[-1] == 0) GOTO 0x29b; Pop(1)

0x295: Push("Warning: outdoor scene locator ") // @poff=410
0x296: Pop(1); Push(Stack[-1] + Stack[-11]);
0x297: Push(" doesnt exist") // @poff=474
0x298: Pop(2); Push(Stack[-2] + Stack[-1]);
0x299: @ Trace(Stack[-1])
0x29a: Pop(1)
0x29b: @@ GetMap(Stack[-11]); Obj=2 // @poff=392
0x29c: Pop(0)
0x29d: Pop(0); PushNull((bool) Stack[-11] == 0)
0x29e: IF (Stack[-1] == 0) GOTO 0x2a3; Pop(1)

0x29f: Push("Can't find map") // @poff=502
0x2a0: @ Trace(Stack[-1])
0x2a1: Pop(1)
0x2a2: Return(); Pop(8)
...
0x2a5: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=532
0x2a6: Pop(2)
0x2a7: Return(); Pop(8)

0x2a8: Stack[-2] = 0
0x2a9: PushEmpty(int, int)
0x2aa: Push("branch") // @poff=545
0x2ab: @ GetVariable(Stack[-1], Stack[-2])
0x2ac: Pop(1)
0x2ad: Push((int) 0)
...
0x2ba: Stack[-1] = (int) 515571
0x2bb: Return(); Pop(0)

0x2bc: Stack[-1] = (int) 504029
0x2bd: Return(); Pop(0)

0x2be: Stack[-1] = "ui/NPC_bmask.png" // @poff=559
0x2bf: Return(); Pop(0)

0x2c0: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=593
0x2c1: Return(); Pop(0)
