...
// @pool_raw:
// @pool_encoding:utf8
...
0x294: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x295: Pop(3)
0x296: Push((int) 509724)
0x297: Push((int) -1)
0x298: Push((int) 10707)
0x299: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x29a: Pop(3)
0x29b: GOTO 0x29e
...
0x2ad: Push("all") // @poff=44
0x2ae: Push("idle") // @poff=190
...
0x2b6: Push("all") // @poff=44
0x2b7: Push("idle") // @poff=190
...
0x315: Stack[-1] = "Neutral" // @poff=141
0x316: Call2 0x2bc

0x317: Pop(1)
0x318: Push((int) 509701)
0x319: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x31a: Pop(1)
0x31b: @@@ ClearReplies(); Obj=0 // @poff=168
0x31c: Pop(0)
0x31d: Push((int) 509702)
0x31e: Push((int) 10682)
0x31f: Push((int) 10681)
0x320: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x321: Pop(3)
0x322: Push((int) 509711)
0x323: Push((int) 10682)
0x324: Push((int) 10691)
0x325: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x326: Pop(3)
0x327: Return(); Pop(0)

0x328: PushEmpty(string)
0x329: Stack[-1] = "Neutral" // @poff=141
0x32a: Call2 0x2bc

0x32b: Pop(1)
0x32c: Push((int) 509712)
0x32d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x32e: Pop(1)
0x32f: @@@ ClearReplies(); Obj=0 // @poff=168
0x330: Pop(0)
0x331: Push((int) 509713)
0x332: Push((int) 10695)
0x333: Push((int) 10694)
0x334: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x335: Pop(3)
0x336: Push((int) 509720)
0x337: Push((int) 10702)
0x338: Push((int) 10701)
0x339: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x33a: Pop(3)
0x33b: Push((int) 509723)
0x33c: Push((int) 10695)
0x33d: Push((int) 10705)
0x33e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x33f: Pop(3)
0x340: Push((int) 509724)
0x341: Push((int) -1)
0x342: Push((int) 10707)
0x343: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x344: Pop(3)
0x345: Return(); Pop(0)
...
0x34a: Stack[-1] = "Neutral" // @poff=141
0x34b: Call2 0x2bc

0x34c: Pop(1)
0x34d: Push((int) 509721)
0x34e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x34f: Pop(1)
0x350: @@@ ClearReplies(); Obj=0 // @poff=168
0x351: Pop(0)
0x352: Push((int) 509722)
0x353: Push((int) 10697)
0x354: Push((int) 10703)
0x355: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x356: Pop(3)
0x357: Return(); Pop(0)
...
0x35c: Stack[-1] = "Neutral" // @poff=141
0x35d: Call2 0x2bc

0x35e: Pop(1)
0x35f: Push((int) 509714)
0x360: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x361: Pop(1)
0x362: @@@ ClearReplies(); Obj=0 // @poff=168
0x363: Pop(0)
0x364: Push((int) 509715)
0x365: Push((int) 10697)
0x366: Push((int) 10696)
0x367: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x368: Pop(3)
0x369: Push((int) 509719)
0x36a: Push((int) -1)
0x36b: Push((int) 10700)
0x36c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x36d: Pop(3)
0x36e: Return(); Pop(0)
...
0x373: Stack[-1] = "Neutral" // @poff=141
0x374: Call2 0x2bc

0x375: Pop(1)
0x376: Push((int) 509716)
0x377: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x378: Pop(1)
0x379: @@@ ClearReplies(); Obj=0 // @poff=168
0x37a: Pop(0)
0x37b: Push((int) 509717)
0x37c: Push((int) -1)
0x37d: Push((int) 10698)
0x37e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x37f: Pop(3)
0x380: Push((int) 509718)
0x381: Push((int) -1)
0x382: Push((int) 10699)
0x383: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x384: Pop(3)
0x385: Return(); Pop(0)
...
0x38a: Stack[-1] = "Neutral" // @poff=141
0x38b: Call2 0x2bc

0x38c: Pop(1)
0x38d: Push((int) 509703)
0x38e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x38f: Pop(1)
0x390: @@@ ClearReplies(); Obj=0 // @poff=168
0x391: Pop(0)
0x392: Push((int) 509704)
0x393: Push((int) 10684)
0x394: Push((int) 10683)
0x395: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x396: Pop(3)
0x397: Push((int) 509710)
0x398: Push((int) 10684)
0x399: Push((int) 10689)
0x39a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=181
0x39b: Pop(3)
0x39c: Return(); Pop(0)
...
0x3a1: Stack[-1] = "Neutral" // @poff=141
0x3a2: Call2 0x2bc

0x3a3: Pop(1)
0x3a4: Push((int) 509705)
0x3a5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=157
0x3a6: Pop(1)
0x3a7: @@@ ClearReplies(); Obj=0 // @poff=168
0x3a8: Pop(0)
...
0x3f7: Stack[-2] = "quest_d4_01" // @poff=200
0x3f8: Stack[-1] = "key2_done" // @poff=224
0x3f9: Call2 0x593
...
0x417: Stack[-2] = "quest_d4_01" // @poff=200
0x418: Stack[-1] = "key2_done" // @poff=224
0x419: Call2 0x593
...
0x497: Pop(0)
0x498: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=244
0x499: Pop(1)
...
0x49e: Push("HasProperty") // @poff=258
0x49f: Push((int) 2)
...
0x4a5: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=282
0x4a6: Pop(0)
0x4a7: Stack[-1] = Stack[-5]
0x4a8: Return(); Pop(2)

0x4a9: PushEmpty(bool, bool)
0x4aa: @@ IsDead(Stack[-1]); Obj=3 // @poff=294
0x4ab: Pop(0)
...
0x4c8: @@ GetScene(Stack[-1]); Obj=5 // @poff=315
0x4c9: Pop(0)
...
0x4dd: Stack[-1] = "noaccess" // @poff=324
0x4de: Call2 0x49d
...
0x4e4: Push("noaccess") // @poff=324
0x4e5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=342
0x4e6: Pop(1)
0x4e7: Push((int) 0)
...
0x4f0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=0
0x4f1: Pop(0)
0x4f2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=354
0x4f3: Pop(0)
...
0x53b: Push("head") // @poff=368
0x53c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x53d: Pop(1)
0x53e: Push(Stack[-1])
0x53f: IF (Stack[-1] == 0) GOTO 0x543; Pop(1)

0x540: Push("head") // @poff=368
0x541: @ UnlookAsync(Stack[-1])
0x542: Pop(1)
0x543: Return(); Pop(2)

0x544: PushEmpty(float, float, float, float)
0x545: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x546: Pop(0)
0x547: Push((bool) 0)
0x548: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x549: Pop(1)
0x54a: Return(); Pop(4)

0x54b: PushEmpty(float, float, float, float)
0x54c: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x54d: Pop(0)
0x54e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x54f: Pop(0)
0x550: Return(); Pop(4)
...
0x558: PushEmpty(float, float)
0x559: Pop(0); Push(Stack[-3] | Stack[-3]);
0x55a: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x55b: Push((float)9.999999974752427e-07)
0x55c: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x55d: IF (Stack[-1] == 0) GOTO 0x560; Pop(1)

0x55e: Stack[-4] = [0.0, 0.0, 0.0]
0x55f: Return(); Pop(2)

0x560: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x561: Return(); Pop(2)

0x562: PushEmpty(int, int)
0x563: @ GetVariable(Stack[-3], Stack[-1])
0x564: Pop(0)
...
0x569: Pop(0)
0x56a: @@ add(Stack[-4]); Obj=1 // @poff=378
0x56b: Pop(0)
0x56c: @@ add(Stack[-3]); Obj=1 // @poff=378
0x56d: Pop(0)
0x56e: Push((int) 3)
...
0x574: @@ GetItemID(Stack[-3]); Obj=8 // @poff=382
0x575: Pop(0)
0x576: Push("Category") // @poff=392
0x577: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x578: Pop(1)
0x579: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=410
0x57a: Pop(0)
0x57b: Pop(0); Push((bool) Stack[-1] == 0)
0x57c: IF (Stack[-1] == 0) GOTO 0x580; Pop(1)

0x57d: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=418
0x57e: Pop(0)
0x57f: GOTO 0x585

0x580: PushEmpty(int, int)
0x581: Stack[-5] = Stack[-2]
0x582: Stack[-9] = Stack[-1]
0x583: Call2 0x567
...
0x588: Pop(0)
0x589: @@ SetItemName(Stack[-4]); Obj=1 // @poff=428
0x58a: Pop(0)
0x58b: PushEmpty(object, object, int)
0x58c: Stack[-8] = Stack[-3]
...
0x595: Pop(0)
0x596: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5a7: Stack[-2] = (int) 0
0x5a8: Push("all") // @poff=44
0x5a9: PushEmpty(string, int)
0x5aa: Stack[-5] = Stack[-1]
0x5ab: Call2 0x59f
...
0x5b9: PushEmpty()
0x5ba: Push("playsound") // @poff=440
0x5bb: Push("giveitem") // @poff=460
0x5bc: @ TriggerWorld(Stack[-2], Stack[-1])
0x5bd: Pop(2)
0x5be: Return(); Pop(0)

0x5bf: PushEmpty()
0x5c0: Push("d4q01KeyWasted") // @poff=478
0x5c1: Push((int) 1)
0x5c2: @ SetVariable(Stack[-2], Stack[-1])
0x5c3: Pop(2)
0x5c4: Push("soborkey is given") // @poff=508
0x5c5: @ Trace(Stack[-1])
0x5c6: Pop(1)
0x5c7: PushEmpty(object, string, int)
0x5c8: Stack[-5] = Stack[-3]
0x5c9: Stack[-2] = "d4q01_sobor_key" // @poff=544
0x5ca: Stack[-1] = (int) 1
0x5cb: Call2 0x586

0x5cc: Pop(3)
0x5cd: PushEmpty(bool, string, string)
0x5ce: Stack[-2] = "quest_d4_01" // @poff=200
0x5cf: Stack[-1] = "init_sobor" // @poff=576
0x5d0: Call2 0x593
...
0x5d3: PushEmpty()
0x5d4: Push("ood4WastedMale1") // @poff=598
0x5d5: Push((int) 1)
0x5d6: @ SetVariable(Stack[-2], Stack[-1])
0x5d7: Pop(2)
0x5d8: Return(); Pop(0)

0x5d9: PushEmpty()
0x5da: Push("tvirin is given") // @poff=630
0x5db: @ Trace(Stack[-1])
0x5dc: Pop(1)
0x5dd: PushEmpty(object, string, int)
0x5de: Stack[-5] = Stack[-3]
0x5df: Stack[-2] = "tvirin" // @poff=662
0x5e0: Stack[-1] = (int) 1
0x5e1: Call2 0x586
...
0x5e4: PushEmpty()
0x5e5: Push((int) 0)
0x5e6: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=676
0x5e7: Pop(1)
0x5e8: Return(); Pop(0)

0x5e9: PushEmpty()
0x5ea: Push((int) 1)
0x5eb: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=676
0x5ec: Pop(1)
0x5ed: Return(); Pop(0)

0x5ee: PushEmpty()
0x5ef: PushEmpty(int, string)
0x5f0: Stack[-1] = "ood4WastedMale1" // @poff=598
0x5f1: Call2 0x562
...
0x5f6: Stack[-2] = (bool) 1
0x5f7: Return(); Pop(0)

0x5f8: Stack[-2] = (bool) 0
0x5f9: Return(); Pop(0)

0x5fa: PushEmpty(int, int)
0x5fb: Push("branch") // @poff=691
0x5fc: @ GetVariable(Stack[-1], Stack[-2])
0x5fd: Pop(1)
0x5fe: Push((int) 0)
...
0x60b: Stack[-1] = (int) 515556
0x60c: Return(); Pop(0)

0x60d: Stack[-1] = (int) 503341
0x60e: Return(); Pop(0)

0x60f: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=705
0x610: Return(); Pop(0)

0x611: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=745
0x612: Return(); Pop(0)
