...
// @pool_raw:
// @pool_encoding:utf8
...
0x1ab: Push("player") // @poff=156
0x1ac: @ FindActor(Stack[-4]T, Stack[-1])
0x1ad: Pop(1)
...
0x1c0: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x24b: Pop(0)
0x24c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x24d: Pop(0)
...
0x257: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x258: Pop(0)
0x259: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x25a: Pop(0)
...
0x2a7: Push("head") // @poff=170
0x2a8: @ UnlookAsync(Stack[-1])
0x2a9: Pop(1)
0x2aa: Return(); Pop(2)

0x2ab: PushEmpty(float, float, float, float)
0x2ac: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2ad: Pop(0)
0x2ae: Push((bool) 0)
0x2af: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2b0: Pop(1)
0x2b1: Return(); Pop(4)

0x2b2: PushEmpty(float, float, float, float)
0x2b3: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2b4: Pop(0)
0x2b5: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2b6: Pop(0)
0x2b7: Return(); Pop(4)

0x2b8: PushEmpty(float, cvector, float, cvector)
0x2b9: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2ba: Pop(0)
0x2bb: Stack[-1] = [0.0, 0.0, 0.0]
0x2bc: Push(CvectorIndex(Stack[-1], 1))
0x2bd: Stack[-3] = Stack[-1]
0x2be: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2bf: Push("head") // @poff=170
0x2c0: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2c1: Pop(1)
0x2c2: Return(); Pop(4)
...
0x2ca: PushEmpty(float, float)
0x2cb: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2cc: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2cd: Push((float)9.999999974752427e-07)
0x2ce: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2cf: IF (Stack[-1] == 0) GOTO 0x2d2; Pop(1)

0x2d0: Stack[-4] = [0.0, 0.0, 0.0]
0x2d1: Return(); Pop(2)

0x2d2: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2d3: Return(); Pop(2)

0x2d4: PushEmpty(int, int)
0x2d5: @ GetVariable(Stack[-3], Stack[-1])
0x2d6: Pop(0)
...
0x2f1: PushEmpty()
0x2f2: Push("ood4SoborGuard1") // @poff=206
0x2f3: Push((int) 1)
...
0x2f7: PushEmpty()
0x2f8: Push("ood4TheaterGuard2") // @poff=238
0x2f9: Push((int) 1)
...
0x2ff: Stack[-1] = "d4q01KeyWasted" // @poff=274
0x300: Call2 0x2d4
...
0x317: Stack[-1] = "ood4SoborGuard1" // @poff=206
0x318: Call2 0x2d4
...
0x323: Stack[-1] = "ood4TheaterGuard2" // @poff=238
0x324: Call2 0x2d4
...
0x33e: Stack[-1] = (int) 515556
0x33f: Return(); Pop(0)

0x340: Stack[-1] = (int) 503341
0x341: Return(); Pop(0)

0x342: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=330
0x343: Return(); Pop(0)

0x344: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=370
0x345: Return(); Pop(0)
