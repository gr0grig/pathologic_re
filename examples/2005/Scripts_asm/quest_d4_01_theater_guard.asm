...
// @pool_raw:
// @pool_encoding:utf8
...
0x1a6: Push("player") // @poff=156
0x1a7: @ FindActor(Stack[-4]T, Stack[-1])
0x1a8: Pop(1)
...
0x1bb: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x210: Pop(0)
0x211: Push("all") // @poff=138
0x212: PushEmpty(string, int)
0x213: Stack[-7] = Stack[-1]
0x214: Call2 0x2d4
...
0x246: Pop(0)
0x247: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x248: Pop(0)
...
0x252: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x253: Pop(0)
0x254: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x255: Pop(0)
...
0x2b3: PushEmpty(float, cvector, float, cvector)
0x2b4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2b5: Pop(0)
0x2b6: Stack[-1] = [0.0, 0.0, 0.0]
0x2b7: Push(CvectorIndex(Stack[-1], 1))
0x2b8: Stack[-3] = Stack[-1]
0x2b9: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2ba: Push("head") // @poff=170
0x2bb: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2bc: Pop(1)
0x2bd: Return(); Pop(4)
...
0x2ea: Stack[-2] = Stack[-5]
0x2eb: Return(); Pop(4)

0x2ec: PushEmpty()
0x2ed: Push("ood4TheaterGuard1") // @poff=206
0x2ee: Push((int) 1)
...
0x2f2: PushEmpty()
0x2f3: Push("ood4TheaterGuard2") // @poff=242
0x2f4: Push((int) 1)
...
0x2f8: PushEmpty()
0x2f9: PushEmpty(int, string)
0x2fa: Stack[-1] = "d4q01KeyWhite" // @poff=278
0x2fb: Call2 0x2cf

0x2fc: Pop(1)
0x2fd: Push((int) 0)
0x2fe: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x2ff: IF (Stack[-1] == 0) GOTO 0x302; Pop(1)

0x300: Stack[-2] = (bool) 1
0x301: Return(); Pop(0)

0x302: Stack[-2] = (bool) 0
0x303: Return(); Pop(0)

0x304: PushEmpty()
0x305: PushEmpty(int, string)
0x306: Stack[-1] = "d4q01" // @poff=306
0x307: Call2 0x2cf

0x308: Pop(1)
0x309: Push((int) 1000)
0x30a: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x30b: IF (Stack[-1] == 0) GOTO 0x30e; Pop(1)

0x30c: Stack[-2] = (bool) 1
0x30d: Return(); Pop(0)

0x30e: Stack[-2] = (bool) 0
0x30f: Return(); Pop(0)

0x310: PushEmpty()
0x311: PushEmpty(int, string)
0x312: Stack[-1] = "ood4TheaterGuard1" // @poff=206
0x313: Call2 0x2cf
...
0x31c: PushEmpty()
0x31d: PushEmpty(int, string)
0x31e: Stack[-1] = "ood4TheaterGuard2" // @poff=242
0x31f: Call2 0x2cf

0x320: Pop(1)
0x321: Push((int) 0)
0x322: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x323: IF (Stack[-1] == 0) GOTO 0x326; Pop(1)

0x324: Stack[-2] = (bool) 1
0x325: Return(); Pop(0)

0x326: Stack[-2] = (bool) 0
0x327: Return(); Pop(0)

0x328: PushEmpty(int, int)
0x329: Push("branch") // @poff=318
0x32a: @ GetVariable(Stack[-1], Stack[-2])
0x32b: Pop(1)
0x32c: Push((int) 0)
...
0x339: Stack[-1] = (int) 515571
0x33a: Return(); Pop(0)

0x33b: Stack[-1] = (int) 504029
0x33c: Return(); Pop(0)

0x33d: Stack[-1] = "ui/NPC_bmask.png" // @poff=332
0x33e: Return(); Pop(0)

0x33f: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=366
0x340: Return(); Pop(0)
