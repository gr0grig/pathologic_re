...
// @pool_raw:
// @pool_encoding:utf8
...
0x182: Stack[-2] = "quest_d4_01" // @poff=156
0x183: Stack[-1] = "wastedwoman_done" // @poff=180
0x184: Call2 0x255
...
0x1e3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=214
0x1e4: Pop(0)
0x1e5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=226
0x1e6: Pop(0)
...
0x22e: Push("head") // @poff=240
0x22f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x230: Pop(1)
0x231: Push(Stack[-1])
0x232: IF (Stack[-1] == 0) GOTO 0x236; Pop(1)

0x233: Push("head") // @poff=240
0x234: @ UnlookAsync(Stack[-1])
0x235: Pop(1)
0x236: Return(); Pop(2)

0x237: PushEmpty(float, float, float, float)
0x238: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x239: Pop(0)
0x23a: Push((bool) 0)
0x23b: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x23c: Pop(1)
0x23d: Return(); Pop(4)

0x23e: PushEmpty(float, float, float, float)
0x23f: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x240: Pop(0)
0x241: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x242: Pop(0)
0x243: Return(); Pop(4)
...
0x256: @ FindActor(Stack[-1], Stack[-4])
0x257: Pop(0)
0x258: Pop(0); PushNull((bool) Stack[-1] == 0)
0x259: IF (Stack[-1] == 0) GOTO 0x25c; Pop(1)

0x25a: Stack[-5] = (bool) 0
0x25b: Return(); Pop(2)

0x25c: @ Trigger(Stack[-1], Stack[-3])
0x25d: Pop(0)
0x25e: Stack[-5] = (bool) 1
0x25f: Return(); Pop(2)

0x260: Stack[-1] = 0
0x261: PushEmpty(float, float)
0x262: @ GetGameTime(Stack[-1])
0x263: Pop(0)
0x264: Stack[-1] = Stack[-3]
0x265: Return(); Pop(2)

0x266: PushEmpty(string, string)
0x267: Stack[-1] = "idle" // @poff=146
0x268: Push(Stack[-3])
0x269: IF (Stack[-1] == 0) GOTO 0x26b; Pop(1)

0x26a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x26b: Stack[-1] = Stack[-4]
0x26c: Return(); Pop(2)

0x26d: PushEmpty(int, bool, int, bool)
0x26e: Stack[-2] = (int) 0
0x26f: Push("all") // @poff=138
0x270: PushEmpty(string, int)
0x271: Stack[-5] = Stack[-1]
0x272: Call2 0x266

0x273: Pop(1)
0x274: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x275: Pop(2)
...
0x279: Push((int) 1)
0x27a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x27b: GOTO 0x26f

0x27c: Stack[-2] = Stack[-5]
0x27d: Return(); Pop(4)
...
0x282: Pop(1)
0x283: Push("d4q01WastedMale") // @poff=250
0x284: Push("pt_d4q01_key2_region") // @poff=282
0x285: Push((int) 1)
0x286: Push((int) 511522)
0x287: PushEmpty(float)
0x288: Call2 0x261

0x289: Pop(0)
0x28a: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=324
0x28b: Pop(5)
0x28c: Return(); Pop(2)

0x28d: Stack[-1] = 0
0x28e: PushEmpty()
0x28f: PushEmpty(object, string, float)
0x290: PushEmpty(object)
0x291: Call2 0x29e

0x292: Stack[-1] = Stack[-4]
0x293: Pop(1)
0x294: Stack[-2] = "pt_d4q01_key2_region" // @poff=282
0x295: Stack[-1] = (int) 2
0x296: Call2 0x2af
...
0x29a: Pop(0)
0x29b: @@ ShowMap(Stack[-1]); Obj=2 // @poff=332
0x29c: Pop(1)
0x29d: Return(); Pop(0)

0x29e: PushEmpty(object, object, object, object)
0x29f: @ GetMainOutdoorScene(Stack[-2])
0x2a0: Pop(0)
0x2a1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2a2: IF (Stack[-1] == 0) GOTO 0x2a9; Pop(1)

0x2a3: Push("Can't find main outdoor scene") // @poff=340
0x2a4: @ Trace(Stack[-1])
0x2a5: Pop(1)
0x2a6: Stack[-1] = 0
0x2a7: Stack[-1] = Stack[-5]
0x2a8: Return(); Pop(4)

0x2a9: @@ GetMap(Stack[-1]); Obj=2 // @poff=400
0x2aa: Pop(0)
...
0x2ad: Stack[-1] = 0
0x2ae: Stack[-2] = 0
0x2af: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x2b0: @ GetMainOutdoorScene(Stack[-2])
0x2b1: Pop(0)
0x2b2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2b3: IF (Stack[-1] == 0) GOTO 0x2b8; Pop(1)

0x2b4: Push("Can't find main outdoor scene") // @poff=340
0x2b5: @ Trace(Stack[-1])
0x2b6: Pop(1)
0x2b7: Return(); Pop(8)

0x2b8: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=407
0x2b9: Pop(0)
0x2ba: Pop(0); Push((bool) Stack[-1] == 0)
0x2bb: IF (Stack[-1] == 0) GOTO 0x2c2; Pop(1)

0x2bc: Push("Warning: outdoor scene locator ") // @poff=418
0x2bd: Pop(1); Push(Stack[-1] + Stack[-11]);
0x2be: Push(" doesnt exist") // @poff=482
0x2bf: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2c0: @ Trace(Stack[-1])
0x2c1: Pop(1)
0x2c2: @@ GetMap(Stack[-11]); Obj=2 // @poff=400
0x2c3: Pop(0)
0x2c4: Pop(0); PushNull((bool) Stack[-11] == 0)
0x2c5: IF (Stack[-1] == 0) GOTO 0x2ca; Pop(1)

0x2c6: Push("Can't find map") // @poff=510
0x2c7: @ Trace(Stack[-1])
0x2c8: Pop(1)
0x2c9: Return(); Pop(8)
...
0x2cc: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=540
0x2cd: Pop(2)
0x2ce: Return(); Pop(8)

0x2cf: Stack[-2] = 0
0x2d0: PushEmpty(int, int)
0x2d1: Push("branch") // @poff=553
0x2d2: @ GetVariable(Stack[-1], Stack[-2])
0x2d3: Pop(1)
0x2d4: Push((int) 0)
...
0x2e1: Stack[-1] = (int) 515555
0x2e2: Return(); Pop(0)

0x2e3: Stack[-1] = (int) 503340
0x2e4: Return(); Pop(0)

0x2e5: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=567
0x2e6: Return(); Pop(0)

0x2e7: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=607
0x2e8: Return(); Pop(0)
