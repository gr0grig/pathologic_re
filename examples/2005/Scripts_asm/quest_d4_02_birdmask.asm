...
// @pool_raw:
// @pool_encoding:utf8
...
0x252: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x253: Pop(0)
0x254: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=168
0x255: Pop(0)
...
0x29d: Push("head") // @poff=182
0x29e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x29f: Pop(1)
0x2a0: Push(Stack[-1])
0x2a1: IF (Stack[-1] == 0) GOTO 0x2a5; Pop(1)

0x2a2: Push("head") // @poff=182
0x2a3: @ UnlookAsync(Stack[-1])
0x2a4: Pop(1)
0x2a5: Return(); Pop(2)

0x2a6: PushEmpty(float, float, float, float)
0x2a7: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2a8: Pop(0)
0x2a9: Push((bool) 0)
...
0x2ad: PushEmpty(float, float, float, float)
0x2ae: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2af: Pop(0)
0x2b0: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2b1: Pop(0)
0x2b2: Return(); Pop(4)
...
0x2ca: @ CreateIntVector(Stack[-1])
0x2cb: Pop(0)
0x2cc: @@ add(Stack[-4]); Obj=1 // @poff=192
0x2cd: Pop(0)
0x2ce: @@ add(Stack[-3]); Obj=1 // @poff=192
0x2cf: Pop(0)
0x2d0: Push((int) 3)
0x2d1: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x2d2: Pop(1)
0x2d3: Return(); Pop(2)

0x2d4: Stack[-1] = 0
0x2d5: PushEmpty(int, int, bool, int, int, bool)
0x2d6: @@ GetItemID(Stack[-3]); Obj=8 // @poff=196
0x2d7: Pop(0)
0x2d8: Push("Category") // @poff=206
0x2d9: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2da: Pop(1)
0x2db: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=224
0x2dc: Pop(0)
0x2dd: Pop(0); Push((bool) Stack[-1] == 0)
0x2de: IF (Stack[-1] == 0) GOTO 0x2e2; Pop(1)

0x2df: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=232
0x2e0: Pop(0)
0x2e1: GOTO 0x2e7

0x2e2: PushEmpty(int, int)
0x2e3: Stack[-5] = Stack[-2]
0x2e4: Stack[-9] = Stack[-1]
0x2e5: Call2 0x2c9
...
0x2e9: @ CreateInvItem(Stack[-1])
0x2ea: Pop(0)
0x2eb: @@ SetItemName(Stack[-4]); Obj=1 // @poff=242
0x2ec: Pop(0)
0x2ed: PushEmpty(object, object, int)
0x2ee: Stack[-8] = Stack[-3]
0x2ef: Stack[-4] = Stack[-2]
0x2f0: Stack[-6] = Stack[-1]
0x2f1: Call2 0x2d5
...
0x2f6: @ FindActor(Stack[-1], Stack[-4])
0x2f7: Pop(0)
0x2f8: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2f9: IF (Stack[-1] == 0) GOTO 0x2fc; Pop(1)

0x2fa: Stack[-5] = (bool) 0
0x2fb: Return(); Pop(2)

0x2fc: @ Trigger(Stack[-1], Stack[-3])
0x2fd: Pop(0)
0x2fe: Stack[-5] = (bool) 1
0x2ff: Return(); Pop(2)

0x300: Stack[-1] = 0
0x301: PushEmpty(string, string)
0x302: Stack[-1] = "idle" // @poff=146
0x303: Push(Stack[-3])
0x304: IF (Stack[-1] == 0) GOTO 0x306; Pop(1)

0x305: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x306: Stack[-1] = Stack[-4]
0x307: Return(); Pop(2)

0x308: PushEmpty(int, bool, int, bool)
0x309: Stack[-2] = (int) 0
...
0x30e: Pop(1)
0x30f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x310: Pop(2)
0x311: Pop(0); Push((bool) Stack[-1] == 0)
0x312: IF (Stack[-1] == 0) GOTO 0x314; Pop(1)

0x313: GOTO 0x317

0x314: Push((int) 1)
0x315: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x316: GOTO 0x30a

0x317: Stack[-2] = Stack[-5]
0x318: Return(); Pop(4)

0x319: PushEmpty()
0x31a: Push("playsound") // @poff=254
0x31b: Push("giveitem") // @poff=274
0x31c: @ TriggerWorld(Stack[-2], Stack[-1])
0x31d: Pop(2)
0x31e: Return(); Pop(0)

0x31f: PushEmpty()
0x320: Push("powder is given") // @poff=292
0x321: @ Trace(Stack[-1])
0x322: Pop(1)
0x323: PushEmpty(object, string, int)
0x324: Stack[-5] = Stack[-3]
0x325: Stack[-2] = "powder" // @poff=324
0x326: Stack[-1] = (int) 1
0x327: Call2 0x2e8
...
0x32a: PushEmpty()
0x32b: Push("ood4BirdmaskHome1") // @poff=338
0x32c: Push((int) 1)
...
0x330: PushEmpty()
0x331: Push("ood4BirdmaskHome2") // @poff=374
0x332: Push((int) 1)
0x333: @ SetVariable(Stack[-2], Stack[-1])
0x334: Pop(2)
0x335: Return(); Pop(0)

0x336: PushEmpty(object, object, object, object)
0x337: PushEmpty(object)
0x338: Call2 0x3da

0x339: Stack[-1] = Stack[-3]
0x33a: Pop(1)
0x33b: Push("d4q02BirdmaskNearHome") // @poff=410
0x33c: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=454
0x33d: Pop(1)
0x33e: Push(Stack[-1])
0x33f: IF (Stack[-1] == 0) GOTO 0x342; Pop(1)

0x340: @@ Remove(); Obj=1 // @poff=463
0x341: Pop(0)
0x342: Push("d4q02MladVladGotoAJLSelf") // @poff=470
0x343: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=454
0x344: Pop(1)
0x345: Push(Stack[-1])
0x346: IF (Stack[-1] == 0) GOTO 0x349; Pop(1)

0x347: @@ Remove(); Obj=1 // @poff=463
0x348: Pop(0)
0x349: Push("d4q02MladVladGotoAnna") // @poff=520
0x34a: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=454
0x34b: Pop(1)
0x34c: Push(Stack[-1])
0x34d: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x34e: @@ Remove(); Obj=1 // @poff=463
0x34f: Pop(0)
0x350: Push("d4q02MladVladGotoJulia") // @poff=564
0x351: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=454
0x352: Pop(1)
0x353: Push(Stack[-1])
0x354: IF (Stack[-1] == 0) GOTO 0x357; Pop(1)

0x355: @@ Remove(); Obj=1 // @poff=463
0x356: Pop(0)
0x357: Push("d4q02MladVladGotoLara") // @poff=610
0x358: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=454
0x359: Pop(1)
0x35a: Push(Stack[-1])
0x35b: IF (Stack[-1] == 0) GOTO 0x35e; Pop(1)

0x35c: @@ Remove(); Obj=1 // @poff=463
0x35d: Pop(0)
0x35e: PushEmpty()
0x35f: Call2 0x3a4

0x360: Pop(0)
0x361: PushEmpty(bool, string, string)
0x362: Stack[-2] = "quest_d4_02" // @poff=654
0x363: Stack[-1] = "completed" // @poff=678
0x364: Call2 0x2f5
...
0x36e: Stack[-2] = "quest_d4_02" // @poff=654
0x36f: Stack[-1] = "birdmask_talk" // @poff=698
0x370: Call2 0x2f5
...
0x375: Stack[-1] = "ood4BirdmaskHome1" // @poff=338
0x376: Call2 0x2c4
...
0x381: Stack[-1] = "ood4BirdmaskHome2" // @poff=374
0x382: Call2 0x2c4
...
0x38d: Stack[-1] = "d4q02_survived" // @poff=726
0x38e: Call2 0x2c4
...
0x3b6: Push("Can't retrieve diary root") // @poff=756
0x3b7: @ Trace(Stack[-1])
0x3b8: Pop(1)
...
0x3c2: Pop(1)
0x3c3: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=808
0x3c4: Pop(0)
0x3c5: Pop(0); Push((bool) Stack[-2] == 0)
0x3c6: IF (Stack[-1] == 0) GOTO 0x3cd; Pop(1)

0x3c7: Push("Can't find diary parent with id: ") // @poff=813
...
0x3cd: @@ AddChild(Stack[-8]); Obj=2 // @poff=881
0x3ce: Pop(0)
0x3cf: Push((int) 7)
0x3d0: @ SendWorldWndMessage(Stack[-1])
0x3d1: Pop(1)
0x3d2: @@ GetCategory(Stack[-1]); Obj=8 // @poff=890
0x3d3: Pop(0)
...
0x3df: Push("Can't find main outdoor scene") // @poff=902
0x3e0: @ Trace(Stack[-1])
0x3e1: Pop(1)
0x3e2: Stack[-1] = 0
...
0x3e5: @@ GetMap(Stack[-1]); Obj=2 // @poff=962
0x3e6: Pop(0)
...
0x3fc: Stack[-1] = (int) 515571
0x3fd: Return(); Pop(0)

0x3fe: Stack[-1] = (int) 504029
0x3ff: Return(); Pop(0)

0x400: Stack[-1] = "ui/NPC_bmask.png" // @poff=983
0x401: Return(); Pop(0)

0x402: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=1017
0x403: Return(); Pop(0)
