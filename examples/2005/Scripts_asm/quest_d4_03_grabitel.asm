...
Strings:
	...
	W:grabitel_mark
	W:death
// @pool_raw:
...
Events:
EVENT_22 Op = 0x754 Vars = (object, int, float, float)
EVENT_43 Op = 0x75c Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x766 Vars = (object, string)
EVENT_41 Op = 0x773 Vars = (object)
...
0x14: Stack[-2] = "quest_d4_03" // @poff=0
0x15: Stack[-1] = "gang_attack" // @poff=24
0x16: Call2 0x6c8
...
0x24: Stack[-2] = "quest_d4_03" // @poff=0
0x25: Stack[-1] = "gang_attack" // @poff=24
0x26: Call2 0x6c8
...
0x34: Stack[-2] = "quest_d4_03" // @poff=0
0x35: Stack[-1] = "gang_attack" // @poff=24
0x36: Call2 0x6c8
...
0x8a: Stack[-1] = 0
0x8b: PushEmpty()
0x8c: Stack[-3] = (float) 0.10000000149011612
0x8d: Return(); Pop(0)
...
0xae: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xaf: Pop(0)
0xb0: Push(Stack[-8])
0xb1: IF (Stack[-1] == 0) GOTO 0xba; Pop(1)

0xb2: Push("attack") // @poff=34
...
0xce: Pop(0)
0xcf: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=150
0xd0: Pop(0)
...
0xea: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=150
0xeb: Pop(0)
...
0x104: Pop(1)
0x105: Push("all") // @poff=164
0x106: Push("attack_on") // @poff=172
...
0x11e: IF (Stack[-1] == 1) GOTO 0x124; Pop(1)

0x11f: PushEmpty(bool)
0x120: Call2 0x2f0

0x121: Pop(0)
0x122: IF (Stack[-1] == 1) GOTO 0x124; Pop(1)

0x123: Stack[-1] = (bool) 0
0x124: IF (Stack[-1] == 0) GOTO 0x135; Pop(1)

0x125: @ Face(Stack[-0]T)
0x126: Pop(0)
0x127: PushEmpty()
0x128: Call2 0x322

0x129: Pop(0)
0x12a: Push("all") // @poff=164
0x12b: Push("attack_stay") // @poff=192
0x12c: @ PlayAnimation(Stack[-2], Stack[-1])
0x12d: Pop(2)
0x12e: PushEmpty(bool, float)
0x12f: Stack[-25] = Stack[-1]
0x130: Call2 0x26c
...
0x135: @ Face(Stack[-0]T)
0x136: Pop(0)
0x137: Push("all") // @poff=164
0x138: Push("fjump") // @poff=216
...
0x153: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=150
0x154: Pop(0)
...
0x172: Push("all") // @poff=164
0x173: Push("attack_off") // @poff=228
...
0x180: Push("all") // @poff=164
0x181: Push("attack_begin") // @poff=250
0x182: Push((int) 1)
0x183: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x18e: Push("attack") // @poff=34
0x18f: Push((int) 1)
0x190: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x19a: Push("all") // @poff=164
0x19b: Push("bjump") // @poff=276
...
0x1a2: Push((float)0.8999999761581421)
0x1a3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1a4: @ GetVictim(Stack[-1], Stack[-4])
0x1a5: Pop(1)
0x1a6: @ ReportAttack(Stack[-0]T)
0x1a7: Pop(0)
...
0x1ab: Stack[-6] = Stack[-2]
0x1ac: Stack[-10] = Stack[-1]
0x1ad: Call2 0x8b

0x1ae: Stack[-3] = Stack[-5]
0x1af: Pop(3)
0x1b0: PushEmpty(float, object, float, int)
0x1b1: Stack[-7] = Stack[-3]
0x1b2: Stack[-6] = Stack[-2]
0x1b3: PushEmpty(int, object, int)
0x1b4: Stack[-10] = Stack[-2]
0x1b5: Stack[-14] = Stack[-1]
0x1b6: Call2 0x8e

0x1b7: Stack[-3] = Stack[-4]
0x1b8: Pop(3)
0x1b9: Call2 0x518

0x1ba: Stack[-4] = Stack[-5]
0x1bb: Pop(4)
0x1bc: PushEmpty(int)
0x1bd: Call2 0x320

0x1be: Pop(0)
0x1bf: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1c0: Pop(1)
...
0x1d7: Pop(0)
0x1d8: Push("all") // @poff=164
0x1d9: Push("attack_begin") // @poff=250
...
0x1ed: Stack[-11] = Stack[-2]
0x1ee: Stack[-6] = Stack[-1]
0x1ef: Call2 0x1a1

0x1f0: Pop(2)
0x1f1: Push("all") // @poff=164
0x1f2: Push("attack_middle") // @poff=288
...
0x1fa: Pop(0)
0x1fb: Push("all") // @poff=164
0x1fc: Push("attack_middle") // @poff=288
...
0x236: Stack[-11] = Stack[-2]
0x237: Stack[-6] = Stack[-1]
0x238: Call2 0x1a1
...
0x23f: Pop(1)
0x240: Push("all") // @poff=164
0x241: Push("attack_end") // @poff=320
...
0x280: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=150
0x281: Pop(0)
...
0x2cc: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2cd: Pop(1)
...
0x2d1: @ Face(Stack[-0]T)
0x2d2: Pop(0)
0x2d3: Push("all") // @poff=164
0x2d4: Push("bjump") // @poff=276
0x2d5: @ PlayAnimation(Stack[-2], Stack[-1])
0x2d6: Pop(2)
0x2d7: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=150
0x2d8: Pop(0)
...
0x30e: @ irand(Stack[-1], Stack[-2]T)
0x30f: Pop(0)
0x310: Push((int) 1)
0x311: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x312: Push("attack") // @poff=34
...
0x323: Stack[-1] = "attack_stay" // @poff=192
0x324: Call2 0x641
...
0x356: Stack[-15] = Stack[-5]
0x357: Stack[-14] = Stack[-4]
0x358: Stack[-13] = Stack[-3]
0x359: Stack[-12] = Stack[-2]
0x35a: Stack[-11] = Stack[-1]
0x35b: Call2 0x3a0

0x35c: Stack[-6] = Stack[-7]
0x35d: Pop(6)
0x35e: Push( Stack[2 + Tasks[-1].StackPointer] )
0x35f: IF (Stack[-1] == 0) GOTO 0x363; Pop(1)

0x360: Push("head") // @poff=378
0x361: @ UnlookAsync(Stack[-1])
0x362: Pop(1)
0x363: Push((int) 1)
0x364: @ KillTimer(Stack[-1])
0x365: Pop(1)
0x366: Stack[-1] = Stack[-10]
0x367: Return(); Pop(4)
...
0x3a3: Stack[-17] = Stack[-7]
0x3a4: PushEmpty(bool, object)
0x3a5: Stack[-23] = Stack[-1]
0x3a6: Call2 0x42c
...
0x3ac: @@ GetPosition(Stack[-5]); Obj=21 // @poff=388
0x3ad: Pop(0)
...
0x3c3: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=150
0x3c4: Pop(0)
...
0x3d5: Push((int) 0)
0x3d6: Push((float)0.30000001192092896)
...
0x3f8: Push((int) 0)
0x3f9: Push((float)0.30000001192092896)
...
0x433: Stack[-1] = "walk" // @poff=400
0x434: Return(); Pop(0)

0x435: Stack[-1] = "run" // @poff=410
0x436: Return(); Pop(0)
...
0x462: Pop(0); PushNull((bool) Stack[-21] == 0)
0x463: IF (Stack[-1] == 0) GOTO 0x469; Pop(1)

0x464: PushEmpty(string)
0x465: Stack[-1] = "fdie" // @poff=418
0x466: Call2 0x4bc

0x467: Pop(1)
0x468: GOTO 0x4bb

0x469: @@ GetPosition(Stack[-10]); Obj=21 // @poff=388
0x46a: Pop(0)
...
0x47a: Stack[-6] = "fdie" // @poff=418
0x47b: GOTO 0x47d

0x47c: Stack[-6] = "bdie" // @poff=428
...
0x483: @ StopAsync()
0x484: Pop(0)
0x485: Stack[-21] = Stack[-5]
0x486: Push("GetScriptProperty") // @poff=438
0x487: Push((int) 2)
0x488: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x489: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x48a: Push("Owner") // @poff=474
0x48b: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=486
0x48c: Pop(1)
0x48d: Push(Stack[-4])
0x48e: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x48f: Push("Owner") // @poff=474
0x490: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=504
0x491: Pop(1)
0x492: Pop(0); PushNull((bool) Stack[-5] == 0)
0x493: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x494: Stack[-21] = Stack[-5]
0x495: Push("@GetEyesHeight") // @poff=522
0x496: Push((int) 1)
0x497: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x498: IF (Stack[-1] == 0) GOTO 0x4a4; Pop(1)

0x499: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=552
0x49a: Pop(0)
0x49b: Stack[-1] = [0.0, 0.0, 0.0]
0x49c: Push(CvectorIndex(Stack[-1], 1))
0x49d: Stack[-3] = Stack[-1]
0x49e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x49f: Push("head") // @poff=378
...
0x4a6: Stack[-7] = Stack[-1]
0x4a7: Call2 0x641

0x4a8: Pop(1)
0x4a9: Push("all") // @poff=164
...
0x4b0: @ StopAsync()
0x4b1: Pop(0)
0x4b2: Push("head") // @poff=378
0x4b3: @ UnlookAsync(Stack[-1])
0x4b4: Pop(1)
0x4b5: Push("all") // @poff=164
...
0x4e6: Stack[-2] = "bullet" // @poff=576
0x4e7: Return(); Pop(0)

0x4e8: Stack[-2] = "phys" // @poff=590
0x4e9: Return(); Pop(0)

0x4ea: PushEmpty(cvector, cvector, cvector, cvector)
0x4eb: @ GetPosition(Stack[-2])
0x4ec: Pop(0)
0x4ed: @@ GetPosition(Stack[-1]); Obj=5 // @poff=388
0x4ee: Pop(0)
...
0x4f7: Push("HasProperty") // @poff=600
0x4f8: Push((int) 2)
...
0x4fe: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=624
0x4ff: Pop(0)
...
0x504: Stack[-10] = Stack[-2]
0x505: Stack[-9] = Stack[-1]
0x506: Call2 0x4f6
...
0x50c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=636
0x50d: Pop(0)
0x50e: PushEmpty(float, float, float, float)
0x50f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x510: Stack[-8] = Stack[-2]
0x511: Stack[-7] = Stack[-1]
0x512: Call2 0x681

0x513: Pop(3)
0x514: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=648
0x515: Pop(1)
...
0x51a: Stack[-18] = Stack[-2]
0x51b: Stack[-1] = "health" // @poff=660
0x51c: Call2 0x4f6
...
0x523: Stack[-18] = Stack[-2]
0x524: Stack[-1] = "armor" // @poff=674
0x525: Call2 0x4f6
...
0x52b: Push("armor") // @poff=674
0x52c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=636
0x52d: Pop(1)
0x52e: Push("armor_") // @poff=686
0x52f: PushEmpty(string, int)
0x530: Stack[-16] = Stack[-1]
0x531: Call2 0x4dc

0x532: Pop(1)
0x533: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x534: PushEmpty(bool, object, string)
0x535: Stack[-18] = Stack[-2]
0x536: Stack[-8] = Stack[-1]
0x537: Call2 0x4f6
...
0x53d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=636
0x53e: Pop(0)
...
0x545: Stack[-3] = Stack[-6]
0x546: Pop(3)
0x547: Push("health") // @poff=660
0x548: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=636
0x549: Pop(1)
0x54a: Push((int) 1)
0x54b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x54c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x54d: Push("health") // @poff=660
...
0x553: Pop(3)
0x554: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=648
0x555: Pop(2)
0x556: PushEmpty(bool, object)
0x557: Stack[-17] = Stack[-1]
0x558: Call2 0x4f1
...
0x55e: Pop(1)
0x55f: Stack[-1] = Stack[-16]
0x560: Return(); Pop(12)

0x561: PushEmpty(bool, bool)
0x562: @@ IsDead(Stack[-1]); Obj=3 // @poff=700
0x563: Pop(0)
0x564: Stack[-1] = Stack[-4]
0x565: Return(); Pop(2)
...
0x57b: Pop(0)
0x57c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x57d: IF (Stack[-1] == 0) GOTO 0x580; Pop(1)

0x57e: Stack[-6] = (bool) 0
0x57f: Return(); Pop(4)

0x580: @@ GetScene(Stack[-1]); Obj=5 // @poff=721
0x581: Pop(0)
...
0x594: Stack[-6] = Stack[-2]
0x595: Stack[-1] = "noaccess" // @poff=730
0x596: Call2 0x4f6
...
0x59c: Push("noaccess") // @poff=730
0x59d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=636
0x59e: Pop(1)
0x59f: Push((int) 0)
...
0x5a3: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x5b1: @@ GetPosition(Stack[-5]); Obj=15 // @poff=388
0x5b2: Pop(0)
...
0x5c2: Stack[-1] = "fhit" // @poff=748
0x5c3: GOTO 0x5c5

0x5c4: Stack[-1] = "bhit" // @poff=758
0x5c5: Push("hit_react") // @poff=768
0x5c6: Push("1") // @poff=788
0x5c7: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5c8: Push("2") // @poff=792
...
0x5e1: Stack[-25] = Stack[-1]
0x5e2: Call2 0x4ea

0x5e3: Stack[-2] = Stack[-3]
0x5e4: Pop(2)
0x5e5: Call2 0x670

0x5e6: Stack[-2] = Stack[-11]
0x5e7: Pop(2)
0x5e8: @ CreateVectorVector(Stack[-8])
0x5e9: Pop(0)
0x5ea: Stack[-7] = (int) 1
0x5eb: Push("hit") // @poff=750
...
0x600: Pop(0)
0x601: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=805
0x602: Pop(0)
0x603: PushEmpty(object, int, float, cvector, cvector)
0x604: Stack[-26] = Stack[-5]
0x605: Stack[-25] = Stack[-4]
0x606: Stack[-24] = Stack[-3]
...
0x614: Pop(0)
0x615: Push("scripted") // @poff=809
0x616: Push("blood_dir.xml") // @poff=827
...
0x621: @@ GetPosition(Stack[-3]); Obj=7 // @poff=388
0x622: Pop(0)
...
0x62c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=552
0x62d: Pop(0)
0x62e: Stack[-1] = [0.0, 0.0, 0.0]
0x62f: Push(CvectorIndex(Stack[-1], 1))
0x630: Stack[-3] = Stack[-1]
0x631: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x632: Push("head") // @poff=378
...
0x6a7: Stack[-2] = Stack[-1]
0x6a8: Call2 0x6be

0x6a9: Pop(1)
0x6aa: PushEmpty(bool, object, string, float, float, float)
0x6ab: Stack[-8] = Stack[-5]
0x6ac: Stack[-4] = "reputation" // @poff=855
0x6ad: Stack[-7] = Stack[-3]
0x6ae: Stack[-2] = (int) 0
0x6af: Stack[-1] = (int) 1
0x6b0: Call2 0x502
...
0x6b6: Pop(0)
0x6b7: @@ add(Stack[-3]); Obj=1 // @poff=796
0x6b8: Pop(0)
0x6b9: Push((int) 15)
0x6ba: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6bb: Pop(1)
0x6bc: Return(); Pop(2)

0x6bd: Stack[-1] = 0
0x6be: PushEmpty(object, object)
0x6bf: @ CreateFloatVector(Stack[-1])
0x6c0: Pop(0)
0x6c1: @@ add(Stack[-3]); Obj=1 // @poff=796
0x6c2: Pop(0)
0x6c3: Push((int) 16)
0x6c4: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x6c5: Pop(1)
0x6c6: Return(); Pop(2)

0x6c7: Stack[-1] = 0
0x6c8: PushEmpty(object, object)
0x6c9: @ FindActor(Stack[-1], Stack[-4])
0x6ca: Pop(0)
0x6cb: Pop(0); PushNull((bool) Stack[-1] == 0)
0x6cc: IF (Stack[-1] == 0) GOTO 0x6cf; Pop(1)

0x6cd: Stack[-5] = (bool) 0
0x6ce: Return(); Pop(2)

0x6cf: @ Trigger(Stack[-1], Stack[-3])
0x6d0: Pop(0)
0x6d1: Stack[-5] = (bool) 1
0x6d2: Return(); Pop(2)

0x6d3: Stack[-1] = 0
0x6d4: PushEmpty(bool, bool)
0x6d5: @ IsPlayerActor(Stack[-3], Stack[-1])
0x6d6: Pop(0)
0x6d7: Push(Stack[-1])
0x6d8: IF (Stack[-1] == 0) GOTO 0x6dc; Pop(1)

0x6d9: Push("attack") // @poff=34
0x6da: @ PlayGlobalMusic(Stack[-1])
0x6db: Pop(1)
0x6dc: Return(); Pop(2)

0x6dd: PushEmpty(object, object)
0x6de: @ GetScene(Stack[-1])
0x6df: Pop(0)
0x6e0: Push("battle") // @poff=877
0x6e1: PushEmpty(object)
0x6e2: Call2 0x66a

0x6e3: Pop(0)
0x6e4: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x6e5: Pop(2)
0x6e6: Return(); Pop(2)

0x6e7: Stack[-1] = 0
0x6e8: PushEmpty(int, int)
0x6e9: Push("branch") // @poff=891
0x6ea: @ GetVariable(Stack[-1], Stack[-2])
0x6eb: Pop(1)
...
0x6f5: @ WorkWithCorpse(Stack[-1])
0x6f6: Pop(0)
0x6f7: GOTO 0x6fa

0x6f8: @ Barter(Stack[-1])
0x6f9: Pop(0)
0x6fa: Return(); Pop(0)

0x6fb: PushEmpty(int, bool, int, bool)
0x6fc: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x6fd: IF (Stack[-1] == 0) GOTO 0x702; Pop(1)

0x6fe: Push("GenerateMoney: iMin > iMax") // @poff=905
0x6ff: @ Trace(Stack[-1])
0x700: Pop(1)
0x701: Return(); Pop(4)
...
0x705: Pop(0); Push(Stack[-5] - Stack[-6]);
0x706: @ irand(Stack[-3], Stack[-1])
0x707: Pop(1)
0x708: GOTO 0x70d

0x709: Push((int) 0)
0x70a: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x70b: IF (Stack[-1] == 0) GOTO 0x70d; Pop(1)

0x70c: Return(); Pop(4)

0x70d: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x70e: Push((int) 0)
...
0x713: Stack[-1] = "Money" // @poff=959
0x714: Call2 0x738

0x715: Pop(1)
0x716: Push((int) 0)
0x717: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x718: Pop(2)
0x719: Return(); Pop(4)

0x71a: PushEmpty(int, bool, int, bool)
0x71b: Push((int) 0)
0x71c: @ ClearSubContainer(Stack[-1])
0x71d: Pop(1)
0x71e: PushEmpty(int, int)
0x71f: Stack[-2] = (int) 300
0x720: Stack[-1] = (int) 750
0x721: Call2 0x6fb

0x722: Pop(2)
0x723: PushEmpty(string, int, int)
0x724: Stack[-3] = "Knife" // @poff=971
0x725: Stack[-2] = (int) 1
0x726: Stack[-1] = (int) 8
0x727: Call2 0x636

0x728: Pop(3)
0x729: PushEmpty(string, int, int)
0x72a: Stack[-3] = "lockpick" // @poff=983
0x72b: Stack[-2] = (int) 1
0x72c: Stack[-1] = (int) 6
0x72d: Call2 0x636
...
0x730: Stack[-1] = "grabitel_mark" // @poff=1001
0x731: Call2 0x738

0x732: Pop(1)
0x733: Push((int) 0)
0x734: Push((int) 1)
0x735: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x736: Pop(3)
0x737: Return(); Pop(4)

0x738: PushEmpty(int, int)
0x739: @ GetInvItemByName(Stack[-1], Stack[-3])
0x73a: Pop(0)
0x73b: Stack[-1] = Stack[-4]
0x73c: Return(); Pop(2)

0x73d: PushEmpty()
0x73e: PushEmpty(bool, string, string)
0x73f: Stack[-2] = "quest_d4_03" // @poff=0
0x740: Stack[-1] = "death" // @poff=1029
0x741: Call2 0x6c8

0x742: Pop(3)
0x743: PushEmpty(bool, object)
0x744: Stack[-3] = Stack[-1]
0x745: Call2 0x4f1

0x746: Pop(1)
0x747: IF (Stack[-1] == 0) GOTO 0x74d; Pop(1)

0x748: PushEmpty(bool, object, float)
0x749: Stack[-4] = Stack[-2]
0x74a: Stack[-1] = (float) 0.029999999329447746
0x74b: Call2 0x691

0x74c: Pop(3)
0x74d: PushEmpty(object)
0x74e: Stack[-2] = Stack[-1]
0x74f: Push(-1, 0); TaskCall(3)
0x750: Call2 0x437

0x751: Pop(-1, 0); TaskReturn
0x752: Pop(1)
0x753: Return(); Pop(0)

0x754: PushEmpty()
0x755: PushEmpty(object, int, float)
0x756: Stack[-7] = Stack[-3]
0x757: Stack[-6] = Stack[-2]
0x758: Stack[-5] = Stack[-1]
0x759: Call2 0x5ce
...
0x75c: PushEmpty()
0x75d: PushEmpty(object, int, float, cvector, cvector)
0x75e: Stack[-11] = Stack[-5]
0x75f: Stack[-10] = Stack[-4]
0x760: Stack[-9] = Stack[-3]
0x761: Stack[-7] = Stack[-2]
...
0x767: Push("health") // @poff=660
0x768: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x769: IF (Stack[-1] == 0) GOTO 0x772; Pop(1)

0x76a: Push("health") // @poff=660
0x76b: @ GetProperty(Stack[-1], Stack[-2])
0x76c: Pop(1)
0x76d: Push((int) 0)
0x76e: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x76f: IF (Stack[-1] == 0) GOTO 0x772; Pop(1)

0x770: @ SignalDeath(Stack[-4])
0x771: Pop(0)
0x772: Return(); Pop(2)
