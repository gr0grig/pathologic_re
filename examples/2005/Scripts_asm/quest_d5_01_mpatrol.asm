...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x8d4 Vars = (object, int, float, float)
EVENT_43 Op = 0x8dc Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x8e6 Vars = (object, string)
EVENT_41 Op = 0x8f3 Vars = (object)
...
0x187: Stack[-1] = 0
0x188: PushEmpty()
0x189: Stack[-3] = (float) 0.30000001192092896
0x18a: Return(); Pop(0)
...
0x1a3: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1a4: Pop(0)
0x1a5: Push(Stack[-8])
0x1a6: IF (Stack[-1] == 0) GOTO 0x1af; Pop(1)

0x1a7: Push("attack") // @poff=226
...
0x1c3: Pop(0)
0x1c4: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x1c5: Pop(0)
...
0x1df: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x1e0: Pop(0)
...
0x1f9: Pop(1)
0x1fa: Push("all") // @poff=138
0x1fb: Push("attack_on") // @poff=254
...
0x213: IF (Stack[-1] == 1) GOTO 0x219; Pop(1)

0x214: PushEmpty(bool)
0x215: Call2 0x3e5

0x216: Pop(0)
0x217: IF (Stack[-1] == 1) GOTO 0x219; Pop(1)

0x218: Stack[-1] = (bool) 0
0x219: IF (Stack[-1] == 0) GOTO 0x22a; Pop(1)

0x21a: @ Face(Stack[-0]T)
0x21b: Pop(0)
0x21c: PushEmpty()
0x21d: Call2 0x417
...
0x22a: @ Face(Stack[-0]T)
0x22b: Pop(0)
0x22c: Push("all") // @poff=138
0x22d: Push("fjump") // @poff=298
...
0x248: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x249: Pop(0)
...
0x268: Push("attack_off") // @poff=310
...
0x275: Push("all") // @poff=138
0x276: Push("attack_begin") // @poff=332
0x277: Push((int) 1)
0x278: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x283: Push("attack") // @poff=226
0x284: Push((int) 1)
0x285: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x28f: Push("all") // @poff=138
0x290: Push("bjump") // @poff=358
...
0x297: Push((float)0.8999999761581421)
0x298: Pop(1); Push(Stack[-9] * Stack[-1]);
0x299: @ GetVictim(Stack[-1], Stack[-4])
0x29a: Pop(1)
0x29b: @ ReportAttack(Stack[-0]T)
0x29c: Pop(0)
...
0x2a1: Stack[-10] = Stack[-1]
0x2a2: Call2 0x188

0x2a3: Stack[-3] = Stack[-5]
0x2a4: Pop(3)
0x2a5: PushEmpty(float, object, float, int)
0x2a6: Stack[-7] = Stack[-3]
0x2a7: Stack[-6] = Stack[-2]
0x2a8: PushEmpty(int, object, int)
0x2a9: Stack[-10] = Stack[-2]
0x2aa: Stack[-14] = Stack[-1]
0x2ab: Call2 0x18b
...
0x2af: Stack[-4] = Stack[-5]
0x2b0: Pop(4)
0x2b1: PushEmpty(int)
0x2b2: Call2 0x415

0x2b3: Pop(0)
0x2b4: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2b5: Pop(1)
0x2b6: PushEmpty(object, float)
0x2b7: Stack[-5] = Stack[-2]
...
0x2c0: Pop(0)
0x2c1: @ irand(Stack[-4], Stack[-1]T)
0x2c2: Pop(0)
0x2c3: Push((int) 1)
0x2c4: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x2c5: @ Face(Stack[-0]T)
0x2c6: Pop(0)
0x2c7: Push((bool) 1)
...
0x2ce: Push("attack_begin") // @poff=332
...
0x2e2: Stack[-11] = Stack[-2]
0x2e3: Stack[-6] = Stack[-1]
0x2e4: Call2 0x296

0x2e5: Pop(2)
0x2e6: Push("all") // @poff=138
0x2e7: Push("attack_middle") // @poff=370
...
0x2ef: Pop(0)
0x2f0: Push("all") // @poff=138
0x2f1: Push("attack_middle") // @poff=370
...
0x305: Stack[-11] = Stack[-2]
0x306: Stack[-6] = Stack[-1]
0x307: Call2 0x296

0x308: Pop(2)
0x309: Stack[-2] = (int) 1
0x30a: Push("attack_middle") // @poff=370
0x30b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x30c: Push("_") // @poff=398
0x30d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x30e: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x30f: Push("all") // @poff=138
...
0x32b: Stack[-11] = Stack[-2]
0x32c: Stack[-6] = Stack[-1]
0x32d: Call2 0x296
...
0x336: Push("attack_end") // @poff=402
...
0x375: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x376: Pop(0)
...
0x3c1: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x3c2: Pop(1)
...
0x3c6: @ Face(Stack[-0]T)
0x3c7: Pop(0)
0x3c8: Push("all") // @poff=138
0x3c9: Push("bjump") // @poff=358
0x3ca: @ PlayAnimation(Stack[-2], Stack[-1])
0x3cb: Pop(2)
0x3cc: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x3cd: Pop(0)
...
0x403: @ irand(Stack[-1], Stack[-2]T)
0x404: Pop(0)
0x405: Push((int) 1)
0x406: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x407: Push("attack") // @poff=226
...
0x418: Stack[-1] = "attack_stay" // @poff=274
0x419: Call2 0x7a0
...
0x443: Stack[-15] = Stack[-5]
0x444: Stack[-14] = Stack[-4]
0x445: Stack[-13] = Stack[-3]
0x446: Stack[-12] = Stack[-2]
0x447: Stack[-11] = Stack[-1]
0x448: Call2 0x48d

0x449: Stack[-6] = Stack[-7]
0x44a: Pop(6)
0x44b: Push( Stack[2 + Tasks[-1].StackPointer] )
0x44c: IF (Stack[-1] == 0) GOTO 0x450; Pop(1)

0x44d: Push("head") // @poff=460
0x44e: @ UnlookAsync(Stack[-1])
0x44f: Pop(1)
0x450: Push((int) 1)
0x451: @ KillTimer(Stack[-1])
0x452: Pop(1)
0x453: Stack[-1] = Stack[-10]
0x454: Return(); Pop(4)
...
0x490: Stack[-17] = Stack[-7]
0x491: PushEmpty(bool, object)
0x492: Stack[-23] = Stack[-1]
0x493: Call2 0x519
...
0x499: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x49a: Pop(0)
...
0x4b0: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x4b1: Pop(0)
...
0x4c2: Push((int) 0)
0x4c3: Push((float)0.30000001192092896)
...
0x4e5: Push((int) 0)
0x4e6: Push((float)0.30000001192092896)
...
0x51d: Stack[-2] = Stack[-4]
0x51e: Pop(2)
0x51f: Return(); Pop(0)

0x520: Stack[-1] = "walk" // @poff=482
0x521: Return(); Pop(0)

0x522: Stack[-1] = "run" // @poff=492
0x523: Return(); Pop(0)

0x524: PushEmpty()
0x525: PushEmpty(bool, string, string)
0x526: Stack[-2] = "quest_d5_01" // @poff=500
0x527: Stack[-1] = "dead" // @poff=524
0x528: Call2 0x7fa
...
0x54c: Pop(0); PushNull((bool) Stack[-21] == 0)
0x54d: IF (Stack[-1] == 0) GOTO 0x553; Pop(1)

0x54e: PushEmpty(string)
0x54f: Stack[-1] = "fdie" // @poff=534
0x550: Call2 0x5a6

0x551: Pop(1)
0x552: GOTO 0x5a5

0x553: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x554: Pop(0)
...
0x564: Stack[-6] = "fdie" // @poff=534
0x565: GOTO 0x567

0x566: Stack[-6] = "bdie" // @poff=544
...
0x56d: @ StopAsync()
0x56e: Pop(0)
0x56f: Stack[-21] = Stack[-5]
0x570: Push("GetScriptProperty") // @poff=554
0x571: Push((int) 2)
0x572: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x573: IF (Stack[-1] == 0) GOTO 0x57f; Pop(1)

0x574: Push("Owner") // @poff=590
0x575: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=602
0x576: Pop(1)
0x577: Push(Stack[-4])
0x578: IF (Stack[-1] == 0) GOTO 0x57f; Pop(1)

0x579: Push("Owner") // @poff=590
0x57a: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=620
0x57b: Pop(1)
0x57c: Pop(0); PushNull((bool) Stack[-5] == 0)
0x57d: IF (Stack[-1] == 0) GOTO 0x57f; Pop(1)

0x57e: Stack[-21] = Stack[-5]
0x57f: Push("@GetEyesHeight") // @poff=638
0x580: Push((int) 1)
0x581: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x582: IF (Stack[-1] == 0) GOTO 0x58e; Pop(1)

0x583: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=668
0x584: Pop(0)
0x585: Stack[-1] = [0.0, 0.0, 0.0]
0x586: Push(CvectorIndex(Stack[-1], 1))
0x587: Stack[-3] = Stack[-1]
0x588: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x589: Push("head") // @poff=460
...
0x59a: @ StopAsync()
0x59b: Pop(0)
0x59c: Push("head") // @poff=460
0x59d: @ UnlookAsync(Stack[-1])
0x59e: Pop(1)
0x59f: Push("all") // @poff=138
...
0x5e4: Stack[-2] = "quest_d5_01" // @poff=500
0x5e5: Stack[-1] = "factory_fight" // @poff=682
0x5e6: Call2 0x7fa
...
0x5fd: Stack[-2] = "bullet" // @poff=720
0x5fe: Return(); Pop(0)

0x5ff: Stack[-2] = "phys" // @poff=734
0x600: Return(); Pop(0)

0x601: PushEmpty(cvector, cvector, cvector, cvector)
0x602: @ GetPosition(Stack[-2])
0x603: Pop(0)
0x604: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x605: Pop(0)
...
0x60a: Pop(0)
0x60b: Stack[-1] = Stack[-4]
0x60c: Return(); Pop(2)

0x60d: PushEmpty(bool, bool)
0x60e: Push("HasProperty") // @poff=744
0x60f: Push((int) 2)
...
0x615: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=768
0x616: Pop(0)
0x617: Stack[-1] = Stack[-5]
0x618: Return(); Pop(2)
...
0x624: Stack[-18] = Stack[-2]
0x625: Stack[-1] = "armor" // @poff=794
0x626: Call2 0x60d
...
0x62c: Push("armor") // @poff=794
0x62d: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=806
0x62e: Pop(1)
0x62f: Push("armor_") // @poff=818
0x630: PushEmpty(string, int)
0x631: Stack[-16] = Stack[-1]
0x632: Call2 0x5f3

0x633: Pop(1)
0x634: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x635: PushEmpty(bool, object, string)
0x636: Stack[-18] = Stack[-2]
0x637: Stack[-8] = Stack[-1]
0x638: Call2 0x60d
...
0x63e: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=806
0x63f: Pop(0)
...
0x646: Stack[-3] = Stack[-6]
0x647: Pop(3)
0x648: Push("health") // @poff=780
0x649: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=806
0x64a: Pop(1)
0x64b: Push((int) 1)
0x64c: Pop(1); Push(Stack[-1] - Stack[-4]);
0x64d: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x64e: Push("health") // @poff=780
...
0x654: Pop(3)
0x655: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=832
0x656: Pop(2)
0x657: PushEmpty(bool, object)
0x658: Stack[-17] = Stack[-1]
0x659: Call2 0x608
...
0x663: @@ IsDead(Stack[-1]); Obj=3 // @poff=844
0x664: Pop(0)
0x665: Stack[-1] = Stack[-4]
0x666: Return(); Pop(2)

0x667: PushEmpty(object, object, object, object)
0x668: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x67c: Pop(0)
0x67d: Pop(0); PushNull((bool) Stack[-2] == 0)
0x67e: IF (Stack[-1] == 0) GOTO 0x681; Pop(1)

0x67f: Stack[-6] = (bool) 0
0x680: Return(); Pop(4)

0x681: @@ GetScene(Stack[-1]); Obj=5 // @poff=865
0x682: Pop(0)
...
0x695: Stack[-6] = Stack[-2]
0x696: Stack[-1] = "noaccess" // @poff=874
0x697: Call2 0x60d
...
0x69d: Push("noaccess") // @poff=874
0x69e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=806
0x69f: Pop(1)
0x6a0: Push((int) 0)
...
0x6a4: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6b2: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x6b3: Pop(0)
...
0x6c3: Stack[-1] = "fhit" // @poff=892
0x6c4: GOTO 0x6c6

0x6c5: Stack[-1] = "bhit" // @poff=902
0x6c6: Push("hit_react") // @poff=912
0x6c7: Push("1") // @poff=520
0x6c8: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6c9: Push("2") // @poff=932
...
0x6e2: Stack[-25] = Stack[-1]
0x6e3: Call2 0x601

0x6e4: Stack[-2] = Stack[-3]
0x6e5: Pop(2)
0x6e6: Call2 0x7cf

0x6e7: Stack[-2] = Stack[-11]
0x6e8: Pop(2)
0x6e9: @ CreateVectorVector(Stack[-8])
0x6ea: Pop(0)
0x6eb: Stack[-7] = (int) 1
0x6ec: Push("hit") // @poff=894
...
0x701: Pop(0)
0x702: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=945
0x703: Pop(0)
0x704: PushEmpty(object, int, float, cvector, cvector)
0x705: Stack[-26] = Stack[-5]
0x706: Stack[-25] = Stack[-4]
0x707: Stack[-24] = Stack[-3]
0x708: Stack[-6] = Stack[-2]
...
0x722: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x723: Pop(0)
...
0x72d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x72e: Pop(0)
0x72f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=668
0x730: Pop(0)
...
0x755: @ StopWorld()
0x756: Pop(0)
0x757: @ CameraTransit(Stack[-3], Stack[-5])
0x758: Pop(0)
0x759: Push(CvectorIndex(Stack[-4], 0))
0x75a: Push(CvectorIndex(Stack[-5], 2))
0x75b: @ Rotate(Stack[-2], Stack[-1])
0x75c: Pop(2)
...
0x762: Push("head") // @poff=460
0x763: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x764: Pop(1)
0x765: Push(Stack[-1])
0x766: IF (Stack[-1] == 0) GOTO 0x76a; Pop(1)

0x767: Push("head") // @poff=460
0x768: @ LookAsyncCamera(Stack[-1])
0x769: Pop(1)
0x76a: @ CameraWaitForPlayFinish()
0x76b: Pop(0)
0x76c: @ ResumeWorld()
0x76d: Pop(0)
0x76e: Stack[-21] = (bool) 1
0x76f: Return(); Pop(18)

0x770: PushEmpty(bool, bool)
0x771: @ CameraSwitchToNormal()
0x772: Pop(0)
...
0x778: Push("head") // @poff=460
0x779: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x77a: Pop(1)
0x77b: Push(Stack[-1])
0x77c: IF (Stack[-1] == 0) GOTO 0x780; Pop(1)

0x77d: Push("head") // @poff=460
0x77e: @ UnlookAsync(Stack[-1])
0x77f: Pop(1)
0x780: Return(); Pop(2)

0x781: PushEmpty(float, float, float, float)
0x782: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x783: Pop(0)
0x784: Push((bool) 0)
0x785: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x786: Pop(1)
0x787: Return(); Pop(4)

0x788: PushEmpty(float, float, float, float)
0x789: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x78a: Pop(0)
0x78b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x78c: Pop(0)
0x78d: Return(); Pop(4)

0x78e: PushEmpty(float, cvector, float, cvector)
0x78f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=668
0x790: Pop(0)
0x791: Stack[-1] = [0.0, 0.0, 0.0]
0x792: Push(CvectorIndex(Stack[-1], 1))
0x793: Stack[-3] = Stack[-1]
0x794: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x795: Push("head") // @poff=460
0x796: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x797: Pop(1)
0x798: Return(); Pop(4)
...
0x7a0: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7a1: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7a2: Pop(0)
0x7a3: Pop(0); Push((bool) Stack[-8] == 0)
0x7a4: IF (Stack[-1] == 0) GOTO 0x7b9; Pop(1)

0x7a5: Stack[-7] = (int) 0
0x7a6: Push((int) 1)
0x7a7: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7a8: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7a9: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7aa: Pop(1)
0x7ab: Pop(0); Push((bool) Stack[-6] == 0)
0x7ac: IF (Stack[-1] == 0) GOTO 0x7ae; Pop(1)

0x7ad: GOTO 0x7b1

0x7ae: Push((int) 1)
0x7af: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7b0: GOTO 0x7a6

0x7b1: Pop(0); Push((bool) Stack[-7] == 0)
0x7b2: IF (Stack[-1] == 0) GOTO 0x7b4; Pop(1)

0x7b3: Return(); Pop(16)

0x7b4: @ irand(Stack[-5], Stack[-7])
0x7b5: Pop(0)
0x7b6: Push((int) 1)
0x7b7: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7b8: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7b9: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7ba: Pop(0)
0x7bb: Push(Stack[-4])
0x7bc: IF (Stack[-1] == 0) GOTO 0x7c8; Pop(1)

0x7bd: @ GetEyesHeight(Stack[-3])
0x7be: Pop(0)
0x7bf: @ GetDirection(Stack[-2])
0x7c0: Pop(0)
0x7c1: Push((int) 50)
0x7c2: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7c3: Push(CvectorIndex(Stack[-1], 1))
0x7c4: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7c5: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7c6: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7c7: Pop(0)
0x7c8: Return(); Pop(16)

0x7c9: PushEmpty(object, object)
0x7ca: @ self(Stack[-1])
0x7cb: Pop(0)
...
0x7d9: PushEmpty()
0x7da: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x7db: IF (Stack[-1] == 0) GOTO 0x7de; Pop(1)

0x7dc: Stack[-2] = Stack[-3]
0x7dd: GOTO 0x7df
...
0x7e0: PushEmpty()
0x7e1: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x7e2: IF (Stack[-1] == 0) GOTO 0x7e5; Pop(1)

0x7e3: Stack[-2] = Stack[-4]
0x7e4: Return(); Pop(0)

0x7e5: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7e6: IF (Stack[-1] == 0) GOTO 0x7e9; Pop(1)

0x7e7: Stack[-1] = Stack[-4]
0x7e8: Return(); Pop(0)

0x7e9: Stack[-3] = Stack[-4]
0x7ea: Return(); Pop(0)

0x7eb: PushEmpty(int, int)
0x7ec: @ GetVariable(Stack[-3], Stack[-1])
0x7ed: Pop(0)
0x7ee: Stack[-1] = Stack[-4]
0x7ef: Return(); Pop(2)

0x7f0: PushEmpty(object, object)
0x7f1: @ CreateFloatVector(Stack[-1])
0x7f2: Pop(0)
0x7f3: @@ add(Stack[-3]); Obj=1 // @poff=936
0x7f4: Pop(0)
0x7f5: Push((int) 15)
...
0x7fc: Pop(0)
0x7fd: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x805: Stack[-1] = 0
0x806: PushEmpty(float, float)
0x807: @ GetGameTime(Stack[-1])
0x808: Pop(0)
0x809: Stack[-1] = Stack[-3]
0x80a: Return(); Pop(2)

0x80b: PushEmpty(bool, bool)
0x80c: @ IsPlayerActor(Stack[-3], Stack[-1])
0x80d: Pop(0)
0x80e: Push(Stack[-1])
0x80f: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x810: Push("attack") // @poff=226
0x811: @ PlayGlobalMusic(Stack[-1])
0x812: Pop(1)
0x813: Return(); Pop(2)

0x814: PushEmpty(object, object)
0x815: @ GetScene(Stack[-1])
0x816: Pop(0)
0x817: Push("battle") // @poff=995
0x818: PushEmpty(object)
0x819: Call2 0x7c9

0x81a: Pop(0)
0x81b: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x81c: Pop(2)
0x81d: Return(); Pop(2)

0x81e: Stack[-1] = 0
0x81f: PushEmpty()
0x820: PushEmpty(object, string, float)
0x821: PushEmpty(object)
0x822: Call2 0x855

0x823: Stack[-1] = Stack[-4]
0x824: Pop(1)
0x825: Stack[-2] = "pt_map_grif" // @poff=1009
0x826: Stack[-1] = (int) 2
0x827: Call2 0x866

0x828: Pop(3)
0x829: PushEmpty(object)
0x82a: Call2 0x855

0x82b: Pop(0)
0x82c: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1033
0x82d: Pop(1)
0x82e: Return(); Pop(0)

0x82f: PushEmpty()
0x830: Push("ood5PatrolGuard1") // @poff=1041
0x831: Push((int) 1)
0x832: @ SetVariable(Stack[-2], Stack[-1])
0x833: Pop(2)
0x834: Return(); Pop(0)

0x835: PushEmpty(object, object)
0x836: Push("d5q01") // @poff=1075
0x837: Push((int) 6)
...
0x83c: Stack[-1] = Stack[-2]
0x83d: Pop(1)
0x83e: Push("d5q01PatrolGotoGrif") // @poff=1087
0x83f: Push("pt_map_grif") // @poff=1009
0x840: Push((int) 1)
0x841: Push((int) 515349)
0x842: PushEmpty(float)
0x843: Call2 0x806

0x844: Pop(0)
0x845: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1127
0x846: Pop(5)
0x847: Return(); Pop(2)

0x848: Stack[-1] = 0
0x849: PushEmpty()
0x84a: PushEmpty(int, string)
0x84b: Stack[-1] = "ood5PatrolGuard1" // @poff=1041
0x84c: Call2 0x7eb
...
0x851: Stack[-2] = (bool) 1
0x852: Return(); Pop(0)

0x853: Stack[-2] = (bool) 0
0x854: Return(); Pop(0)

0x855: PushEmpty(object, object, object, object)
0x856: @ GetMainOutdoorScene(Stack[-2])
0x857: Pop(0)
0x858: Pop(0); PushNull((bool) Stack[-2] == 0)
0x859: IF (Stack[-1] == 0) GOTO 0x860; Pop(1)

0x85a: Push("Can't find main outdoor scene") // @poff=1135
0x85b: @ Trace(Stack[-1])
0x85c: Pop(1)
0x85d: Stack[-1] = 0
...
0x860: @@ GetMap(Stack[-1]); Obj=2 // @poff=1195
0x861: Pop(0)
0x862: Stack[-1] = Stack[-5]
0x863: Return(); Pop(4)

0x864: Stack[-1] = 0
0x865: Stack[-2] = 0
0x866: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x867: @ GetMainOutdoorScene(Stack[-2])
0x868: Pop(0)
0x869: Pop(0); PushNull((bool) Stack[-2] == 0)
0x86a: IF (Stack[-1] == 0) GOTO 0x86f; Pop(1)

0x86b: Push("Can't find main outdoor scene") // @poff=1135
0x86c: @ Trace(Stack[-1])
0x86d: Pop(1)
0x86e: Return(); Pop(8)

0x86f: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1202
0x870: Pop(0)
0x871: Pop(0); Push((bool) Stack[-1] == 0)
0x872: IF (Stack[-1] == 0) GOTO 0x879; Pop(1)

0x873: Push("Warning: outdoor scene locator ") // @poff=1213
0x874: Pop(1); Push(Stack[-1] + Stack[-11]);
0x875: Push(" doesnt exist") // @poff=1277
0x876: Pop(2); Push(Stack[-2] + Stack[-1]);
0x877: @ Trace(Stack[-1])
0x878: Pop(1)
0x879: @@ GetMap(Stack[-11]); Obj=2 // @poff=1195
0x87a: Pop(0)
0x87b: Pop(0); PushNull((bool) Stack[-11] == 0)
0x87c: IF (Stack[-1] == 0) GOTO 0x881; Pop(1)

0x87d: Push("Can't find map") // @poff=1305
0x87e: @ Trace(Stack[-1])
0x87f: Pop(1)
0x880: Return(); Pop(8)

0x881: Push(CvectorIndex(Stack[-4], 0))
0x882: Push(CvectorIndex(Stack[-5], 2))
0x883: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1335
0x884: Pop(2)
0x885: Return(); Pop(8)

0x886: Stack[-2] = 0
0x887: PushEmpty(int, int)
0x888: Push("branch") // @poff=1348
0x889: @ GetVariable(Stack[-1], Stack[-2])
0x88a: Pop(1)
0x88b: Push((int) 0)
...
0x899: Push("branch") // @poff=1348
0x89a: @ GetVariable(Stack[-1], Stack[-2])
0x89b: Pop(1)
0x89c: Stack[-1] = Stack[-3]
0x89d: Return(); Pop(2)
...
0x8a4: IF (Stack[-1] == 0) GOTO 0x8a8; Pop(1)

0x8a5: @ WorkWithCorpse(Stack[-1])
0x8a6: Pop(0)
0x8a7: GOTO 0x8aa

0x8a8: @ Barter(Stack[-1])
0x8a9: Pop(0)
0x8aa: Return(); Pop(0)

0x8ab: PushEmpty(object, int, bool, object, int, bool)
0x8ac: @ CreateInvItem(Stack[-3])
0x8ad: Pop(0)
0x8ae: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1362
0x8af: Pop(0)
0x8b0: Push("Organ") // @poff=1374
0x8b1: Push((int) 1)
0x8b2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=832
0x8b3: Pop(2)
0x8b4: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1386
0x8b5: Pop(0)
0x8b6: Push((int) 0)
0x8b7: Push((int) 1)
0x8b8: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x8b9: Pop(2)
0x8ba: Return(); Pop(6)
...
0x8be: Pop(0)
0x8bf: Push((int) 1)
0x8c0: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x8c1: IF (Stack[-1] == 0) GOTO 0x8c3; Pop(1)

0x8c2: Return(); Pop(0)

0x8c3: PushEmpty(string)
0x8c4: Stack[-1] = "liver" // @poff=1396
0x8c5: Call2 0x8ab

0x8c6: Pop(1)
0x8c7: PushEmpty(string)
0x8c8: Stack[-1] = "kidney" // @poff=1408
0x8c9: Call2 0x8ab

0x8ca: Pop(1)
0x8cb: PushEmpty(string)
0x8cc: Stack[-1] = "heart" // @poff=1422
0x8cd: Call2 0x8ab

0x8ce: Pop(1)
0x8cf: PushEmpty(string)
0x8d0: Stack[-1] = "blood" // @poff=1434
0x8d1: Call2 0x8ab
...
0x8d4: PushEmpty()
0x8d5: PushEmpty(object, int, float)
0x8d6: Stack[-7] = Stack[-3]
...
0x8dc: PushEmpty()
0x8dd: PushEmpty(object, int, float, cvector, cvector)
0x8de: Stack[-11] = Stack[-5]
0x8df: Stack[-10] = Stack[-4]
0x8e0: Stack[-9] = Stack[-3]
0x8e1: Stack[-7] = Stack[-2]
0x8e2: Stack[-6] = Stack[-1]
0x8e3: Call2 0x713

0x8e4: Pop(5)
0x8e5: Return(); Pop(0)

0x8e6: PushEmpty(float, float)
0x8e7: Push("health") // @poff=780
0x8e8: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8e9: IF (Stack[-1] == 0) GOTO 0x8f2; Pop(1)

0x8ea: Push("health") // @poff=780
0x8eb: @ GetProperty(Stack[-1], Stack[-2])
0x8ec: Pop(1)
0x8ed: Push((int) 0)
0x8ee: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x8ef: IF (Stack[-1] == 0) GOTO 0x8f2; Pop(1)

0x8f0: @ SignalDeath(Stack[-4])
0x8f1: Pop(0)
0x8f2: Return(); Pop(2)
...
0x8f9: Stack[-1] = (int) 515572
0x8fa: Return(); Pop(0)

0x8fb: Stack[-1] = (int) 504031
0x8fc: Return(); Pop(0)

0x8fd: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1446
0x8fe: Return(); Pop(0)

0x8ff: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1486
0x900: Return(); Pop(0)
...
0x904: Push("revolver_ammo") // @poff=1530
0x905: Push((int) 0)
0x906: Push((int) 2)
0x907: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x908: Pop(3)
0x909: Push("alpha_pills") // @poff=1558
0x90a: Push((int) 0)
0x90b: Push((int) 2)
...
0x910: Push(-1, 0); TaskCall(4)
0x911: Call2 0x524

0x912: Pop(-1, 0); TaskReturn
0x913: Pop(1)
0x914: Return(); Pop(2)
