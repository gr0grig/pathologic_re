...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x7ad Vars = (object, int, float, float)
EVENT_43 Op = 0x7b5 Vars = (object, int, float, float, cvector, cvector)
...
0xd2: Stack[-1] = 0
0xd3: PushEmpty()
0xd4: Stack[-3] = (float) 0.30000001192092896
0xd5: Return(); Pop(0)
...
0xee: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xef: Pop(0)
0xf0: Push(Stack[-8])
0xf1: IF (Stack[-1] == 0) GOTO 0xfa; Pop(1)

0xf2: Push("attack") // @poff=226
...
0x10e: Pop(0)
0x10f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x110: Pop(0)
...
0x12a: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x12b: Pop(0)
...
0x144: Pop(1)
0x145: Push("all") // @poff=138
0x146: Push("attack_on") // @poff=254
...
0x15e: IF (Stack[-1] == 1) GOTO 0x164; Pop(1)
...
0x176: Pop(0)
0x177: Push("all") // @poff=138
0x178: Push("fjump") // @poff=298
...
0x193: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x194: Pop(0)
...
0x1b3: Push("attack_off") // @poff=310
...
0x1c0: Push("all") // @poff=138
0x1c1: Push("attack_begin") // @poff=332
0x1c2: Push((int) 1)
0x1c3: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1ce: Push("attack") // @poff=226
0x1cf: Push((int) 1)
0x1d0: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1e2: Push((float)0.8999999761581421)
0x1e3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1e4: @ GetVictim(Stack[-1], Stack[-4])
0x1e5: Pop(1)
0x1e6: @ ReportAttack(Stack[-0]T)
0x1e7: Pop(0)
...
0x1eb: Stack[-6] = Stack[-2]
0x1ec: Stack[-10] = Stack[-1]
0x1ed: Call2 0xd3

0x1ee: Stack[-3] = Stack[-5]
0x1ef: Pop(3)
0x1f0: PushEmpty(float, object, float, int)
0x1f1: Stack[-7] = Stack[-3]
0x1f2: Stack[-6] = Stack[-2]
0x1f3: PushEmpty(int, object, int)
0x1f4: Stack[-10] = Stack[-2]
0x1f5: Stack[-14] = Stack[-1]
0x1f6: Call2 0xd6

0x1f7: Stack[-3] = Stack[-4]
0x1f8: Pop(3)
0x1f9: Call2 0x564

0x1fa: Stack[-4] = Stack[-5]
0x1fb: Pop(4)
0x1fc: PushEmpty(int)
0x1fd: Call2 0x360

0x1fe: Pop(0)
0x1ff: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x200: Pop(1)
0x201: PushEmpty(object, float)
0x202: Stack[-5] = Stack[-2]
...
0x20b: Pop(0)
0x20c: @ irand(Stack[-4], Stack[-1]T)
0x20d: Pop(0)
0x20e: Push((int) 1)
0x20f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x210: @ Face(Stack[-0]T)
0x211: Pop(0)
0x212: Push((bool) 1)
...
0x219: Push("attack_begin") // @poff=332
...
0x22d: Stack[-11] = Stack[-2]
0x22e: Stack[-6] = Stack[-1]
0x22f: Call2 0x1e1

0x230: Pop(2)
0x231: Push("all") // @poff=138
0x232: Push("attack_middle") // @poff=370
...
0x23a: Pop(0)
0x23b: Push("all") // @poff=138
0x23c: Push("attack_middle") // @poff=370
...
0x250: Stack[-11] = Stack[-2]
0x251: Stack[-6] = Stack[-1]
0x252: Call2 0x1e1

0x253: Pop(2)
0x254: Stack[-2] = (int) 1
0x255: Push("attack_middle") // @poff=370
0x256: Pop(1); Push(Stack[-1] + Stack[-5]);
0x257: Push("_") // @poff=398
...
0x276: Stack[-11] = Stack[-2]
0x277: Stack[-6] = Stack[-1]
0x278: Call2 0x1e1
...
0x281: Push("attack_end") // @poff=402
...
0x2c0: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x2c1: Pop(0)
...
0x30c: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x30d: Pop(1)
...
0x311: @ Face(Stack[-0]T)
0x312: Pop(0)
0x313: Push("all") // @poff=138
0x314: Push("bjump") // @poff=358
0x315: @ PlayAnimation(Stack[-2], Stack[-1])
0x316: Pop(2)
0x317: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x318: Pop(0)
...
0x34e: @ irand(Stack[-1], Stack[-2]T)
0x34f: Pop(0)
0x350: Push((int) 1)
0x351: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x352: Push("attack") // @poff=226
...
0x363: Stack[-1] = "attack_stay" // @poff=274
0x364: Call2 0x6eb
...
0x38e: Stack[-15] = Stack[-5]
0x38f: Stack[-14] = Stack[-4]
0x390: Stack[-13] = Stack[-3]
0x391: Stack[-12] = Stack[-2]
0x392: Stack[-11] = Stack[-1]
0x393: Call2 0x3d8

0x394: Stack[-6] = Stack[-7]
0x395: Pop(6)
0x396: Push( Stack[2 + Tasks[-1].StackPointer] )
0x397: IF (Stack[-1] == 0) GOTO 0x39b; Pop(1)

0x398: Push("head") // @poff=460
...
0x3db: Stack[-17] = Stack[-7]
0x3dc: PushEmpty(bool, object)
0x3dd: Stack[-23] = Stack[-1]
0x3de: Call2 0x464
...
0x3e4: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x3e5: Pop(0)
...
0x3fb: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x3fc: Pop(0)
...
0x40d: Push((int) 0)
0x40e: Push((float)0.30000001192092896)
...
0x430: Push((int) 0)
0x431: Push((float)0.30000001192092896)
...
0x468: Stack[-2] = Stack[-4]
0x469: Pop(2)
0x46a: Return(); Pop(0)

0x46b: Stack[-1] = "walk" // @poff=482
0x46c: Return(); Pop(0)

0x46d: Stack[-1] = "run" // @poff=492
0x46e: Return(); Pop(0)

0x46f: PushEmpty()
0x470: PushEmpty(bool, string, string)
0x471: Stack[-2] = "quest_d5_01" // @poff=500
0x472: Stack[-1] = "dead" // @poff=524
0x473: Call2 0x740
...
0x4af: Stack[-6] = "fdie" // @poff=534
0x4b0: GOTO 0x4b2

0x4b1: Stack[-6] = "bdie" // @poff=544
...
0x52f: Stack[-2] = "quest_d5_01" // @poff=500
0x530: Stack[-1] = "factory_fight" // @poff=682
0x531: Call2 0x740
...
0x548: Stack[-2] = "bullet" // @poff=720
0x549: Return(); Pop(0)

0x54a: Stack[-2] = "phys" // @poff=734
0x54b: Return(); Pop(0)

0x54c: PushEmpty(cvector, cvector, cvector, cvector)
0x54d: @ GetPosition(Stack[-2])
0x54e: Pop(0)
0x54f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x550: Pop(0)
...
0x559: Push("HasProperty") // @poff=744
0x55a: Push((int) 2)
...
0x560: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=768
0x561: Pop(0)
...
0x566: Stack[-18] = Stack[-2]
0x567: Stack[-1] = "health" // @poff=780
0x568: Call2 0x558
...
0x56f: Stack[-18] = Stack[-2]
0x570: Stack[-1] = "armor" // @poff=794
0x571: Call2 0x558
...
0x577: Push("armor") // @poff=794
0x578: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=806
0x579: Pop(1)
0x57a: Push("armor_") // @poff=818
...
0x581: Stack[-18] = Stack[-2]
0x582: Stack[-8] = Stack[-1]
0x583: Call2 0x558
...
0x589: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=806
0x58a: Pop(0)
...
0x591: Stack[-3] = Stack[-6]
0x592: Pop(3)
0x593: Push("health") // @poff=780
0x594: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=806
0x595: Pop(1)
0x596: Push((int) 1)
0x597: Pop(1); Push(Stack[-1] - Stack[-4]);
0x598: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x599: Push("health") // @poff=780
...
0x59f: Pop(3)
0x5a0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=832
0x5a1: Pop(2)
0x5a2: PushEmpty(bool, object)
0x5a3: Stack[-17] = Stack[-1]
0x5a4: Call2 0x553
...
0x5aa: Pop(1)
0x5ab: Stack[-1] = Stack[-16]
0x5ac: Return(); Pop(12)

0x5ad: PushEmpty(bool, bool)
0x5ae: @@ IsDead(Stack[-1]); Obj=3 // @poff=844
0x5af: Pop(0)
0x5b0: Stack[-1] = Stack[-4]
0x5b1: Return(); Pop(2)

0x5b2: PushEmpty(object, object, object, object)
0x5b3: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5c7: Pop(0)
0x5c8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5c9: IF (Stack[-1] == 0) GOTO 0x5cc; Pop(1)

0x5ca: Stack[-6] = (bool) 0
0x5cb: Return(); Pop(4)

0x5cc: @@ GetScene(Stack[-1]); Obj=5 // @poff=865
0x5cd: Pop(0)
...
0x5e0: Stack[-6] = Stack[-2]
0x5e1: Stack[-1] = "noaccess" // @poff=874
0x5e2: Call2 0x558
...
0x5e8: Push("noaccess") // @poff=874
0x5e9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=806
0x5ea: Pop(1)
0x5eb: Push((int) 0)
...
0x5ef: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x5fd: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x5fe: Pop(0)
...
0x60e: Stack[-1] = "fhit" // @poff=892
0x60f: GOTO 0x611

0x610: Stack[-1] = "bhit" // @poff=902
0x611: Push("hit_react") // @poff=912
0x612: Push("1") // @poff=520
0x613: Pop(1); Push(Stack[-3] + Stack[-1]);
0x614: Push("2") // @poff=932
...
0x62d: Stack[-25] = Stack[-1]
0x62e: Call2 0x54c

0x62f: Stack[-2] = Stack[-3]
0x630: Pop(2)
0x631: Call2 0x71a
...
0x64c: Pop(0)
0x64d: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=945
0x64e: Pop(0)
0x64f: PushEmpty(object, int, float, cvector, cvector)
0x650: Stack[-26] = Stack[-5]
0x651: Stack[-25] = Stack[-4]
0x652: Stack[-24] = Stack[-3]
...
0x66d: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x66e: Pop(0)
...
0x678: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x679: Pop(0)
0x67a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=668
0x67b: Pop(0)
...
0x6a3: Pop(0)
0x6a4: Push(CvectorIndex(Stack[-4], 0))
0x6a5: Push(CvectorIndex(Stack[-5], 2))
...
0x6c3: Push("head") // @poff=460
0x6c4: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6c5: Pop(1)
0x6c6: Push(Stack[-1])
0x6c7: IF (Stack[-1] == 0) GOTO 0x6cb; Pop(1)

0x6c8: Push("head") // @poff=460
0x6c9: @ UnlookAsync(Stack[-1])
0x6ca: Pop(1)
0x6cb: Return(); Pop(2)

0x6cc: PushEmpty(float, float, float, float)
0x6cd: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x6ce: Pop(0)
0x6cf: Push((bool) 0)
0x6d0: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6d1: Pop(1)
0x6d2: Return(); Pop(4)

0x6d3: PushEmpty(float, float, float, float)
0x6d4: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x6d5: Pop(0)
0x6d6: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x6d7: Pop(0)
0x6d8: Return(); Pop(4)

0x6d9: PushEmpty(float, cvector, float, cvector)
0x6da: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=668
0x6db: Pop(0)
0x6dc: Stack[-1] = [0.0, 0.0, 0.0]
0x6dd: Push(CvectorIndex(Stack[-1], 1))
0x6de: Stack[-3] = Stack[-1]
0x6df: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6e0: Push("head") // @poff=460
0x6e1: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x6e2: Pop(1)
0x6e3: Return(); Pop(4)
...
0x719: Stack[-1] = 0
0x71a: PushEmpty(float, float)
0x71b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x71c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x71d: Push((float)9.999999974752427e-07)
0x71e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x71f: IF (Stack[-1] == 0) GOTO 0x722; Pop(1)

0x720: Stack[-4] = [0.0, 0.0, 0.0]
0x721: Return(); Pop(2)

0x722: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x723: Return(); Pop(2)

0x724: PushEmpty()
0x725: Pop(0); Push((bool) Stack[-2] < Stack[-1])
...
0x72b: PushEmpty()
0x72c: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x72d: IF (Stack[-1] == 0) GOTO 0x730; Pop(1)

0x72e: Stack[-2] = Stack[-4]
0x72f: Return(); Pop(0)

0x730: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x731: IF (Stack[-1] == 0) GOTO 0x734; Pop(1)

0x732: Stack[-1] = Stack[-4]
0x733: Return(); Pop(0)

0x734: Stack[-3] = Stack[-4]
0x735: Return(); Pop(0)

0x736: PushEmpty(object, object)
0x737: @ CreateFloatVector(Stack[-1])
0x738: Pop(0)
0x739: @@ add(Stack[-3]); Obj=1 // @poff=936
0x73a: Pop(0)
0x73b: Push((int) 15)
0x73c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x73d: Pop(1)
0x73e: Return(); Pop(2)

0x73f: Stack[-1] = 0
0x740: PushEmpty(object, object)
0x741: @ FindActor(Stack[-1], Stack[-4])
0x742: Pop(0)
0x743: Pop(0); PushNull((bool) Stack[-1] == 0)
0x744: IF (Stack[-1] == 0) GOTO 0x747; Pop(1)

0x745: Stack[-5] = (bool) 0
0x746: Return(); Pop(2)

0x747: @ Trigger(Stack[-1], Stack[-3])
0x748: Pop(0)
0x749: Stack[-5] = (bool) 1
0x74a: Return(); Pop(2)
...
0x751: Push("attack") // @poff=226
0x752: @ PlayGlobalMusic(Stack[-1])
0x753: Pop(1)
0x754: Return(); Pop(2)

0x755: PushEmpty(object, object)
0x756: @ GetScene(Stack[-1])
0x757: Pop(0)
0x758: Push("battle") // @poff=995
0x759: PushEmpty(object)
0x75a: Call2 0x714

0x75b: Pop(0)
0x75c: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x75d: Pop(2)
0x75e: Return(); Pop(2)

0x75f: Stack[-1] = 0
0x760: PushEmpty(int, int)
0x761: Push("branch") // @poff=1009
0x762: @ GetVariable(Stack[-1], Stack[-2])
0x763: Pop(1)
0x764: Push((int) 0)
...
0x772: Push("branch") // @poff=1009
0x773: @ GetVariable(Stack[-1], Stack[-2])
0x774: Pop(1)
0x775: Stack[-1] = Stack[-3]
0x776: Return(); Pop(2)
...
0x77a: Pop(0)
0x77b: Push((int) 1)
0x77c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x77d: IF (Stack[-1] == 0) GOTO 0x781; Pop(1)

0x77e: @ WorkWithCorpse(Stack[-1])
0x77f: Pop(0)
0x780: GOTO 0x783

0x781: @ Barter(Stack[-1])
0x782: Pop(0)
0x783: Return(); Pop(0)

0x784: PushEmpty(object, int, bool, object, int, bool)
0x785: @ CreateInvItem(Stack[-3])
0x786: Pop(0)
0x787: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1023
0x788: Pop(0)
0x789: Push("Organ") // @poff=1035
0x78a: Push((int) 1)
0x78b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=832
0x78c: Pop(2)
0x78d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1047
0x78e: Pop(0)
0x78f: Push((int) 0)
0x790: Push((int) 1)
0x791: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x792: Pop(2)
0x793: Return(); Pop(6)
...
0x797: Pop(0)
0x798: Push((int) 1)
0x799: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x79a: IF (Stack[-1] == 0) GOTO 0x79c; Pop(1)

0x79b: Return(); Pop(0)

0x79c: PushEmpty(string)
0x79d: Stack[-1] = "liver" // @poff=1057
0x79e: Call2 0x784

0x79f: Pop(1)
0x7a0: PushEmpty(string)
0x7a1: Stack[-1] = "kidney" // @poff=1069
0x7a2: Call2 0x784

0x7a3: Pop(1)
0x7a4: PushEmpty(string)
0x7a5: Stack[-1] = "heart" // @poff=1083
0x7a6: Call2 0x784

0x7a7: Pop(1)
0x7a8: PushEmpty(string)
0x7a9: Stack[-1] = "blood" // @poff=1095
0x7aa: Call2 0x784
...
0x7ad: PushEmpty()
0x7ae: PushEmpty(object, int, float)
0x7af: Stack[-7] = Stack[-3]
0x7b0: Stack[-6] = Stack[-2]
0x7b1: Stack[-5] = Stack[-1]
0x7b2: Call2 0x61a
...
0x7b5: PushEmpty()
0x7b6: PushEmpty(object, int, float, cvector, cvector)
0x7b7: Stack[-11] = Stack[-5]
0x7b8: Stack[-10] = Stack[-4]
0x7b9: Stack[-9] = Stack[-3]
0x7ba: Stack[-7] = Stack[-2]
0x7bb: Stack[-6] = Stack[-1]
0x7bc: Call2 0x65e
...
0x7d2: Stack[-1] = (int) 515572
0x7d3: Return(); Pop(0)

0x7d4: Stack[-1] = (int) 504031
0x7d5: Return(); Pop(0)

0x7d6: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1107
0x7d7: Return(); Pop(0)

0x7d8: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1147
0x7d9: Return(); Pop(0)

0x7da: Stack[-1] = (bool) 0
0x7db: Return(); Pop(0)

0x7dc: PushEmpty(bool, bool)
0x7dd: Push("revolver_ammo") // @poff=1191
0x7de: Push((int) 0)
0x7df: Push((int) 2)
0x7e0: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x7e1: Pop(3)
0x7e2: Push("alpha_pills") // @poff=1219
0x7e3: Push((int) 0)
0x7e4: Push((int) 2)
0x7e5: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x7e6: Pop(3)
0x7e7: PushEmpty(object)
0x7e8: Stack[-4] = Stack[-1]
0x7e9: Push(-1, 0); TaskCall(4)
0x7ea: Call2 0x46f

0x7eb: Pop(-1, 0); TaskReturn
0x7ec: Pop(1)
0x7ed: Return(); Pop(2)
