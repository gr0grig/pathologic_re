...
Strings:
	...
	W:heart
	W:blood
// @pool_raw:
...
Events:
EVENT_22 Op = 0x654 Vars = (object, int, float, float)
EVENT_43 Op = 0x65c Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x666 Vars = (object, string)
EVENT_41 Op = 0x673 Vars = (object)
...
0x18: Stack[-1] = 0
0x19: PushEmpty()
0x1a: Stack[-3] = (float) 0.30000001192092896
0x1b: Return(); Pop(0)
...
0x34: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x35: Pop(0)
0x36: Push(Stack[-8])
0x37: IF (Stack[-1] == 0) GOTO 0x40; Pop(1)

0x38: Push("attack") // @poff=70
...
0x54: Pop(0)
0x55: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0x56: Pop(0)
...
0x70: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=84
0x71: Pop(0)
...
0x8a: Pop(1)
0x8b: Push("all") // @poff=98
0x8c: Push("attack_on") // @poff=106
...
0xa4: IF (Stack[-1] == 1) GOTO 0xaa; Pop(1)
...
0xaf: Pop(0)
0xb0: Push("all") // @poff=98
0xb1: Push("attack_stay") // @poff=126
0xb2: @ PlayAnimation(Stack[-2], Stack[-1])
0xb3: Pop(2)
0xb4: PushEmpty(bool, float)
0xb5: Stack[-25] = Stack[-1]
0xb6: Call2 0x1f2
...
0xbb: @ Face(Stack[-0]T)
0xbc: Pop(0)
0xbd: Push("all") // @poff=98
0xbe: Push("fjump") // @poff=150
...
0xd9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0xda: Pop(0)
...
0xf8: Push("all") // @poff=98
0xf9: Push("attack_off") // @poff=162
...
0x107: Push("attack_begin") // @poff=184
0x108: Push((int) 1)
0x109: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x114: Push("attack") // @poff=70
0x115: Push((int) 1)
0x116: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x120: Push("all") // @poff=98
0x121: Push("bjump") // @poff=210
...
0x128: Push((float)0.8999999761581421)
0x129: Pop(1); Push(Stack[-9] * Stack[-1]);
0x12a: @ GetVictim(Stack[-1], Stack[-4])
0x12b: Pop(1)
0x12c: @ ReportAttack(Stack[-0]T)
0x12d: Pop(0)
...
0x131: Stack[-6] = Stack[-2]
0x132: Stack[-10] = Stack[-1]
0x133: Call2 0x19

0x134: Stack[-3] = Stack[-5]
0x135: Pop(3)
0x136: PushEmpty(float, object, float, int)
0x137: Stack[-7] = Stack[-3]
0x138: Stack[-6] = Stack[-2]
0x139: PushEmpty(int, object, int)
0x13a: Stack[-10] = Stack[-2]
0x13b: Stack[-14] = Stack[-1]
0x13c: Call2 0x1c

0x13d: Stack[-3] = Stack[-4]
0x13e: Pop(3)
0x13f: Call2 0x47d

0x140: Stack[-4] = Stack[-5]
0x141: Pop(4)
0x142: PushEmpty(int)
0x143: Call2 0x2a6

0x144: Pop(0)
0x145: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x146: Pop(1)
0x147: PushEmpty(object, float)
0x148: Stack[-5] = Stack[-2]
...
0x151: Pop(0)
0x152: @ irand(Stack[-4], Stack[-1]T)
0x153: Pop(0)
0x154: Push((int) 1)
0x155: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x156: @ Face(Stack[-0]T)
0x157: Pop(0)
0x158: Push((bool) 1)
...
0x15d: Pop(0)
0x15e: Push("all") // @poff=98
0x15f: Push("attack_begin") // @poff=184
...
0x173: Stack[-11] = Stack[-2]
0x174: Stack[-6] = Stack[-1]
0x175: Call2 0x127

0x176: Pop(2)
0x177: Push("all") // @poff=98
0x178: Push("attack_middle") // @poff=222
...
0x182: Push("attack_middle") // @poff=222
...
0x1c5: Pop(1)
0x1c6: Push("all") // @poff=98
0x1c7: Push("attack_end") // @poff=254
...
0x206: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=84
0x207: Pop(0)
...
0x252: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x253: Pop(1)
...
0x257: @ Face(Stack[-0]T)
0x258: Pop(0)
0x259: Push("all") // @poff=98
0x25a: Push("bjump") // @poff=210
0x25b: @ PlayAnimation(Stack[-2], Stack[-1])
0x25c: Pop(2)
0x25d: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=84
0x25e: Pop(0)
...
0x294: @ irand(Stack[-1], Stack[-2]T)
0x295: Pop(0)
0x296: Push((int) 1)
0x297: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x298: Push("attack") // @poff=70
...
0x2a9: Stack[-1] = "attack_stay" // @poff=126
0x2aa: Call2 0x59b
...
0x2d4: Stack[-15] = Stack[-5]
0x2d5: Stack[-14] = Stack[-4]
0x2d6: Stack[-13] = Stack[-3]
0x2d7: Stack[-12] = Stack[-2]
0x2d8: Stack[-11] = Stack[-1]
0x2d9: Call2 0x31e

0x2da: Stack[-6] = Stack[-7]
0x2db: Pop(6)
0x2dc: Push( Stack[2 + Tasks[-1].StackPointer] )
0x2dd: IF (Stack[-1] == 0) GOTO 0x2e1; Pop(1)

0x2de: Push("head") // @poff=312
0x2df: @ UnlookAsync(Stack[-1])
0x2e0: Pop(1)
0x2e1: Push((int) 1)
0x2e2: @ KillTimer(Stack[-1])
0x2e3: Pop(1)
0x2e4: Stack[-1] = Stack[-10]
0x2e5: Return(); Pop(4)
...
0x321: Stack[-17] = Stack[-7]
0x322: PushEmpty(bool, object)
0x323: Stack[-23] = Stack[-1]
0x324: Call2 0x3aa
...
0x32a: @@ GetPosition(Stack[-5]); Obj=21 // @poff=322
0x32b: Pop(0)
...
0x341: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=84
0x342: Pop(0)
...
0x353: Push((int) 0)
0x354: Push((float)0.30000001192092896)
...
0x376: Push((int) 0)
0x377: Push((float)0.30000001192092896)
...
0x3b1: Stack[-1] = "walk" // @poff=334
0x3b2: Return(); Pop(0)

0x3b3: Stack[-1] = "run" // @poff=344
0x3b4: Return(); Pop(0)

0x3b5: PushEmpty()
0x3b6: PushEmpty(bool, string, string)
0x3b7: Stack[-2] = "quest_d5_01" // @poff=352
0x3b8: Stack[-1] = "dead" // @poff=376
0x3b9: Call2 0x5f0

0x3ba: Pop(3)
0x3bb: PushEmpty(object)
0x3bc: Stack[-2] = Stack[-1]
0x3bd: Call2 0x3dc
...
0x3dd: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3de: IF (Stack[-1] == 0) GOTO 0x3e4; Pop(1)

0x3df: PushEmpty(string)
0x3e0: Stack[-1] = "fdie" // @poff=386
0x3e1: Call2 0x437

0x3e2: Pop(1)
0x3e3: GOTO 0x436

0x3e4: @@ GetPosition(Stack[-10]); Obj=21 // @poff=322
0x3e5: Pop(0)
...
0x3f5: Stack[-6] = "fdie" // @poff=386
0x3f6: GOTO 0x3f8

0x3f7: Stack[-6] = "bdie" // @poff=396
...
0x3fe: @ StopAsync()
0x3ff: Pop(0)
0x400: Stack[-21] = Stack[-5]
0x401: Push("GetScriptProperty") // @poff=406
0x402: Push((int) 2)
0x403: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x404: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x405: Push("Owner") // @poff=442
0x406: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=454
0x407: Pop(1)
0x408: Push(Stack[-4])
0x409: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x40a: Push("Owner") // @poff=442
0x40b: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=472
0x40c: Pop(1)
0x40d: Pop(0); PushNull((bool) Stack[-5] == 0)
0x40e: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x40f: Stack[-21] = Stack[-5]
0x410: Push("@GetEyesHeight") // @poff=490
0x411: Push((int) 1)
0x412: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x413: IF (Stack[-1] == 0) GOTO 0x41f; Pop(1)

0x414: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=520
0x415: Pop(0)
0x416: Stack[-1] = [0.0, 0.0, 0.0]
0x417: Push(CvectorIndex(Stack[-1], 1))
0x418: Stack[-3] = Stack[-1]
0x419: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x41a: Push("head") // @poff=312
...
0x421: Stack[-7] = Stack[-1]
0x422: Call2 0x59b

0x423: Pop(1)
0x424: Push("all") // @poff=98
...
0x42b: @ StopAsync()
0x42c: Pop(0)
0x42d: Push("head") // @poff=312
0x42e: @ UnlookAsync(Stack[-1])
0x42f: Pop(1)
0x430: Push("all") // @poff=98
...
0x461: Stack[-2] = "bullet" // @poff=544
0x462: Return(); Pop(0)

0x463: Stack[-2] = "phys" // @poff=558
0x464: Return(); Pop(0)

0x465: PushEmpty(cvector, cvector, cvector, cvector)
0x466: @ GetPosition(Stack[-2])
0x467: Pop(0)
0x468: @@ GetPosition(Stack[-1]); Obj=5 // @poff=322
0x469: Pop(0)
...
0x46e: Pop(0)
0x46f: Stack[-1] = Stack[-4]
0x470: Return(); Pop(2)

0x471: PushEmpty(bool, bool)
0x472: Push("HasProperty") // @poff=568
0x473: Push((int) 2)
...
0x479: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=592
0x47a: Pop(0)
0x47b: Stack[-1] = Stack[-5]
0x47c: Return(); Pop(2)

0x47d: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x47e: PushEmpty(bool, object, string)
0x47f: Stack[-18] = Stack[-2]
0x480: Stack[-1] = "health" // @poff=604
0x481: Call2 0x471
...
0x488: Stack[-18] = Stack[-2]
0x489: Stack[-1] = "armor" // @poff=618
0x48a: Call2 0x471
...
0x490: Push("armor") // @poff=618
0x491: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=630
0x492: Pop(1)
0x493: Push("armor_") // @poff=642
0x494: PushEmpty(string, int)
0x495: Stack[-16] = Stack[-1]
0x496: Call2 0x457

0x497: Pop(1)
0x498: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x499: PushEmpty(bool, object, string)
0x49a: Stack[-18] = Stack[-2]
0x49b: Stack[-8] = Stack[-1]
0x49c: Call2 0x471
...
0x4a2: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=630
0x4a3: Pop(0)
...
0x4aa: Stack[-3] = Stack[-6]
0x4ab: Pop(3)
0x4ac: Push("health") // @poff=604
0x4ad: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=630
0x4ae: Pop(1)
0x4af: Push((int) 1)
0x4b0: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4b1: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4b2: Push("health") // @poff=604
...
0x4b8: Pop(3)
0x4b9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=656
0x4ba: Pop(2)
0x4bb: PushEmpty(bool, object)
0x4bc: Stack[-17] = Stack[-1]
0x4bd: Call2 0x46c
...
0x4c3: Pop(1)
0x4c4: Stack[-1] = Stack[-16]
0x4c5: Return(); Pop(12)

0x4c6: PushEmpty(bool, bool)
0x4c7: @@ IsDead(Stack[-1]); Obj=3 // @poff=668
0x4c8: Pop(0)
0x4c9: Stack[-1] = Stack[-4]
0x4ca: Return(); Pop(2)

0x4cb: PushEmpty(object, object, object, object)
0x4cc: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4e0: Pop(0)
0x4e1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4e2: IF (Stack[-1] == 0) GOTO 0x4e5; Pop(1)

0x4e3: Stack[-6] = (bool) 0
0x4e4: Return(); Pop(4)

0x4e5: @@ GetScene(Stack[-1]); Obj=5 // @poff=689
0x4e6: Pop(0)
...
0x4f9: Stack[-6] = Stack[-2]
0x4fa: Stack[-1] = "noaccess" // @poff=698
0x4fb: Call2 0x471
...
0x501: Push("noaccess") // @poff=698
0x502: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=630
0x503: Pop(1)
0x504: Push((int) 0)
...
0x508: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x516: @@ GetPosition(Stack[-5]); Obj=15 // @poff=322
0x517: Pop(0)
...
0x527: Stack[-1] = "fhit" // @poff=716
0x528: GOTO 0x52a

0x529: Stack[-1] = "bhit" // @poff=726
0x52a: Push("hit_react") // @poff=736
0x52b: Push("1") // @poff=372
0x52c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x52d: Push("2") // @poff=756
...
0x546: Stack[-25] = Stack[-1]
0x547: Call2 0x465

0x548: Stack[-2] = Stack[-3]
0x549: Pop(2)
0x54a: Call2 0x5ca

0x54b: Stack[-2] = Stack[-11]
0x54c: Pop(2)
0x54d: @ CreateVectorVector(Stack[-8])
0x54e: Pop(0)
0x54f: Stack[-7] = (int) 1
0x550: Push("hit") // @poff=718
...
0x565: Pop(0)
0x566: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=769
0x567: Pop(0)
0x568: PushEmpty(object, int, float, cvector, cvector)
0x569: Stack[-26] = Stack[-5]
0x56a: Stack[-25] = Stack[-4]
0x56b: Stack[-24] = Stack[-3]
0x56c: Stack[-6] = Stack[-2]
...
0x579: Pop(0)
0x57a: Push("scripted") // @poff=773
0x57b: Push("blood_dir.xml") // @poff=791
...
0x586: @@ GetPosition(Stack[-3]); Obj=7 // @poff=322
0x587: Pop(0)
...
0x591: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=520
0x592: Pop(0)
0x593: Stack[-1] = [0.0, 0.0, 0.0]
0x594: Push(CvectorIndex(Stack[-1], 1))
0x595: Stack[-3] = Stack[-1]
0x596: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x597: Push("head") // @poff=312
...
0x5e2: Stack[-1] = Stack[-4]
0x5e3: Return(); Pop(0)

0x5e4: Stack[-3] = Stack[-4]
0x5e5: Return(); Pop(0)

0x5e6: PushEmpty(object, object)
0x5e7: @ CreateFloatVector(Stack[-1])
0x5e8: Pop(0)
0x5e9: @@ add(Stack[-3]); Obj=1 // @poff=760
0x5ea: Pop(0)
0x5eb: Push((int) 15)
0x5ec: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x5ed: Pop(1)
0x5ee: Return(); Pop(2)

0x5ef: Stack[-1] = 0
0x5f0: PushEmpty(object, object)
0x5f1: @ FindActor(Stack[-1], Stack[-4])
0x5f2: Pop(0)
0x5f3: Pop(0); PushNull((bool) Stack[-1] == 0)
0x5f4: IF (Stack[-1] == 0) GOTO 0x5f7; Pop(1)

0x5f5: Stack[-5] = (bool) 0
0x5f6: Return(); Pop(2)

0x5f7: @ Trigger(Stack[-1], Stack[-3])
0x5f8: Pop(0)
0x5f9: Stack[-5] = (bool) 1
0x5fa: Return(); Pop(2)

0x5fb: Stack[-1] = 0
0x5fc: PushEmpty(bool, bool)
0x5fd: @ IsPlayerActor(Stack[-3], Stack[-1])
0x5fe: Pop(0)
0x5ff: Push(Stack[-1])
0x600: IF (Stack[-1] == 0) GOTO 0x604; Pop(1)

0x601: Push("attack") // @poff=70
0x602: @ PlayGlobalMusic(Stack[-1])
0x603: Pop(1)
0x604: Return(); Pop(2)

0x605: PushEmpty(object, object)
0x606: @ GetScene(Stack[-1])
0x607: Pop(0)
0x608: Push("battle") // @poff=819
0x609: PushEmpty(object)
0x60a: Call2 0x5c4

0x60b: Pop(0)
0x60c: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x60d: Pop(2)
0x60e: Return(); Pop(2)

0x60f: Stack[-1] = 0
0x610: PushEmpty(int, int)
0x611: Push("branch") // @poff=833
0x612: @ GetVariable(Stack[-1], Stack[-2])
0x613: Pop(1)
...
0x619: Pop(0)
0x61a: Push((int) 1)
0x61b: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x61c: IF (Stack[-1] == 0) GOTO 0x620; Pop(1)

0x61d: @ WorkWithCorpse(Stack[-1])
0x61e: Pop(0)
0x61f: GOTO 0x622

0x620: @ Barter(Stack[-1])
0x621: Pop(0)
0x622: Return(); Pop(0)

0x623: PushEmpty(object, int, bool, object, int, bool)
0x624: @ CreateInvItem(Stack[-3])
0x625: Pop(0)
0x626: @@ SetItemName(Stack[-7]); Obj=3 // @poff=847
0x627: Pop(0)
0x628: Push("Organ") // @poff=859
0x629: Push((int) 1)
0x62a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=656
0x62b: Pop(2)
0x62c: @@ GetItemID(Stack[-2]); Obj=3 // @poff=871
0x62d: Pop(0)
0x62e: Push((int) 0)
0x62f: Push((int) 1)
0x630: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x631: Pop(2)
0x632: Return(); Pop(6)
...
0x63c: Stack[-1] = "liver" // @poff=881
0x63d: Call2 0x623

0x63e: Pop(1)
0x63f: PushEmpty(string)
0x640: Stack[-1] = "kidney" // @poff=893
0x641: Call2 0x623

0x642: Pop(1)
0x643: PushEmpty(string)
0x644: Stack[-1] = "heart" // @poff=907
0x645: Call2 0x623

0x646: Pop(1)
0x647: PushEmpty(string)
0x648: Stack[-1] = "blood" // @poff=919
0x649: Call2 0x623
...
0x64f: Push(-1, 0); TaskCall(3)
0x650: Call2 0x3b5

0x651: Pop(-1, 0); TaskReturn
0x652: Pop(1)
0x653: Return(); Pop(0)

0x654: PushEmpty()
0x655: PushEmpty(object, int, float)
0x656: Stack[-7] = Stack[-3]
...
0x65c: PushEmpty()
0x65d: PushEmpty(object, int, float, cvector, cvector)
0x65e: Stack[-11] = Stack[-5]
0x65f: Stack[-10] = Stack[-4]
0x660: Stack[-9] = Stack[-3]
0x661: Stack[-7] = Stack[-2]
0x662: Stack[-6] = Stack[-1]
0x663: Call2 0x577
...
0x667: Push("health") // @poff=604
0x668: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x669: IF (Stack[-1] == 0) GOTO 0x672; Pop(1)

0x66a: Push("health") // @poff=604
0x66b: @ GetProperty(Stack[-1], Stack[-2])
0x66c: Pop(1)
0x66d: Push((int) 0)
0x66e: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x66f: IF (Stack[-1] == 0) GOTO 0x672; Pop(1)

0x670: @ SignalDeath(Stack[-4])
0x671: Pop(0)
0x672: Return(); Pop(2)

0x673: PushEmpty()
0x674: PushEmpty(object)
