...
0x118: Push("player") // @poff=156
0x119: @ FindActor(Stack[-4]T, Stack[-1])
0x11a: Pop(1)
...
0x12d: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1b8: Pop(0)
0x1b9: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1ba: Pop(0)
...
0x1c4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1c5: Pop(0)
0x1c6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1c7: Pop(0)
...
0x225: PushEmpty(float, cvector, float, cvector)
0x226: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x227: Pop(0)
0x228: Stack[-1] = [0.0, 0.0, 0.0]
0x229: Push(CvectorIndex(Stack[-1], 1))
0x22a: Stack[-3] = Stack[-1]
0x22b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x22c: Push("head") // @poff=170
0x22d: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x22e: Pop(1)
0x22f: Return(); Pop(4)
...
0x23d: Stack[-4] = [0.0, 0.0, 0.0]
0x23e: Return(); Pop(2)

0x23f: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x240: Return(); Pop(2)

0x241: PushEmpty(string, string)
0x242: Stack[-1] = "idle" // @poff=146
0x243: Push(Stack[-3])
0x244: IF (Stack[-1] == 0) GOTO 0x246; Pop(1)

0x245: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x246: Stack[-1] = Stack[-4]
0x247: Return(); Pop(2)

0x248: PushEmpty(int, bool, int, bool)
0x249: Stack[-2] = (int) 0
...
0x24e: Pop(1)
0x24f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x250: Pop(2)
...
0x257: Stack[-2] = Stack[-5]
0x258: Return(); Pop(4)

0x259: PushEmpty(int, int)
0x25a: Push("branch") // @poff=206
...
0x26a: Stack[-1] = (int) 515556
0x26b: Return(); Pop(0)

0x26c: Stack[-1] = (int) 503341
0x26d: Return(); Pop(0)

0x26e: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=220
0x26f: Return(); Pop(0)

0x270: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=260
0x271: Return(); Pop(0)
