...
0x22a: PushEmpty(float, float, float, float)
0x22b: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x22c: Pop(0)
0x22d: Push((bool) 0)
0x22e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x22f: Pop(1)
0x230: Return(); Pop(4)

0x231: PushEmpty(float, float, float, float)
0x232: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x233: Pop(0)
0x234: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x235: Pop(0)
0x236: Return(); Pop(4)
...
0x280: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=220
0x281: Return(); Pop(0)

0x282: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=260
0x283: Return(); Pop(0)
