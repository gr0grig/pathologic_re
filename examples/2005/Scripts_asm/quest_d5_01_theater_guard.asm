...
// @pool_raw:
// @pool_encoding:utf8
...
0x1d8: Push("player") // @poff=156
0x1d9: @ FindActor(Stack[-4]T, Stack[-1])
0x1da: Pop(1)
...
0x1ed: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x242: Pop(0)
0x243: Push("all") // @poff=138
0x244: PushEmpty(string, int)
0x245: Stack[-7] = Stack[-1]
0x246: Call2 0x306
...
0x278: Pop(0)
0x279: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x27a: Pop(0)
...
0x284: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x285: Pop(0)
0x286: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x287: Pop(0)
...
0x2d4: Push("head") // @poff=170
0x2d5: @ UnlookAsync(Stack[-1])
0x2d6: Pop(1)
0x2d7: Return(); Pop(2)

0x2d8: PushEmpty(float, float, float, float)
0x2d9: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2da: Pop(0)
0x2db: Push((bool) 0)
0x2dc: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2dd: Pop(1)
0x2de: Return(); Pop(4)

0x2df: PushEmpty(float, float, float, float)
0x2e0: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2e1: Pop(0)
0x2e2: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2e3: Pop(0)
0x2e4: Return(); Pop(4)

0x2e5: PushEmpty(float, cvector, float, cvector)
0x2e6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2e7: Pop(0)
0x2e8: Stack[-1] = [0.0, 0.0, 0.0]
0x2e9: Push(CvectorIndex(Stack[-1], 1))
0x2ea: Stack[-3] = Stack[-1]
0x2eb: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2ec: Push("head") // @poff=170
0x2ed: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2ee: Pop(1)
0x2ef: Return(); Pop(4)
...
0x2f7: PushEmpty(float, float)
0x2f8: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2f9: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2fa: Push((float)9.999999974752427e-07)
0x2fb: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2fc: IF (Stack[-1] == 0) GOTO 0x2ff; Pop(1)

0x2fd: Stack[-4] = [0.0, 0.0, 0.0]
0x2fe: Return(); Pop(2)

0x2ff: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x300: Return(); Pop(2)

0x301: PushEmpty(int, int)
0x302: @ GetVariable(Stack[-3], Stack[-1])
0x303: Pop(0)
0x304: Stack[-1] = Stack[-4]
0x305: Return(); Pop(2)

0x306: PushEmpty(string, string)
0x307: Stack[-1] = "idle" // @poff=146
0x308: Push(Stack[-3])
0x309: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x30a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x30b: Stack[-1] = Stack[-4]
0x30c: Return(); Pop(2)

0x30d: PushEmpty(int, bool, int, bool)
0x30e: Stack[-2] = (int) 0
...
0x313: Pop(1)
0x314: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x315: Pop(2)
...
0x319: Push((int) 1)
0x31a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x31b: GOTO 0x30f

0x31c: Stack[-2] = Stack[-5]
0x31d: Return(); Pop(4)

0x31e: PushEmpty()
0x31f: Push("ood5Whitemask1") // @poff=206
0x320: Push((int) 1)
0x321: @ SetVariable(Stack[-2], Stack[-1])
0x322: Pop(2)
0x323: Return(); Pop(0)

0x324: PushEmpty()
0x325: Push("ood5Whitemask2") // @poff=236
0x326: Push((int) 1)
...
0x32a: PushEmpty()
0x32b: PushEmpty(int, string)
0x32c: Stack[-1] = "ood5Whitemask1" // @poff=206
0x32d: Call2 0x301

0x32e: Pop(1)
0x32f: Push((int) 0)
0x330: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x331: IF (Stack[-1] == 0) GOTO 0x334; Pop(1)

0x332: Stack[-2] = (bool) 1
0x333: Return(); Pop(0)

0x334: Stack[-2] = (bool) 0
0x335: Return(); Pop(0)

0x336: PushEmpty()
0x337: PushEmpty(int, string)
0x338: Stack[-1] = "ood5Whitemask2" // @poff=236
0x339: Call2 0x301

0x33a: Pop(1)
0x33b: Push((int) 0)
0x33c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x33d: IF (Stack[-1] == 0) GOTO 0x340; Pop(1)

0x33e: Stack[-2] = (bool) 1
0x33f: Return(); Pop(0)

0x340: Stack[-2] = (bool) 0
0x341: Return(); Pop(0)

0x342: PushEmpty(int, int)
0x343: Push("branch") // @poff=266
0x344: @ GetVariable(Stack[-1], Stack[-2])
0x345: Pop(1)
0x346: Push((int) 0)
...
0x353: Stack[-1] = (int) 515569
0x354: Return(); Pop(0)

0x355: Stack[-1] = (int) 503354
0x356: Return(); Pop(0)

0x357: Stack[-1] = "ui/NPC_wmask.png" // @poff=280
0x358: Return(); Pop(0)

0x359: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=314
0x35a: Return(); Pop(0)
