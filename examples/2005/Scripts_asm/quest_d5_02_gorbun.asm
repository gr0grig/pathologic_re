...
// @pool_raw:
...
Events:
EVENT_26 Op = 0x663 Vars = (string)
EVENT_6 Op = 0x67b Vars = ()
...
0x5d6: Push("head") // @poff=287
0x5d7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5d8: Pop(1)
0x5d9: Push(Stack[-1])
0x5da: IF (Stack[-1] == 0) GOTO 0x5de; Pop(1)

0x5db: Push("head") // @poff=287
0x5dc: @ UnlookAsync(Stack[-1])
0x5dd: Pop(1)
0x5de: Return(); Pop(2)

0x5df: PushEmpty(float, float, float, float)
0x5e0: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x5e1: Pop(0)
0x5e2: Push((bool) 0)
0x5e3: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5e4: Pop(1)
0x5e5: Return(); Pop(4)

0x5e6: PushEmpty(float, float, float, float)
0x5e7: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x5e8: Pop(0)
0x5e9: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x5ea: Pop(0)
0x5eb: Return(); Pop(4)
...
0x5f4: @ self(Stack[-1])
0x5f5: Pop(0)
0x5f6: Stack[-1] = Stack[-3]
0x5f7: Return(); Pop(2)

0x5f8: Stack[-1] = 0
0x5f9: PushEmpty(float, float)
0x5fa: Pop(0); Push(Stack[-3] | Stack[-3]);
0x5fb: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x5fc: Push((float)9.999999974752427e-07)
0x5fd: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x5fe: IF (Stack[-1] == 0) GOTO 0x601; Pop(1)

0x5ff: Stack[-4] = [0.0, 0.0, 0.0]
0x600: Return(); Pop(2)

0x601: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x602: Return(); Pop(2)
...
0x60b: PushEmpty()
0x60c: Push(CvectorIndex(Stack[-1], 0))
0x60d: Push(CvectorIndex(Stack[-2], 0))
0x60e: Pop(2); Push(Stack[-2] * Stack[-1]);
0x60f: Push(CvectorIndex(Stack[-2], 2))
0x610: Push(CvectorIndex(Stack[-3], 2))
0x611: Pop(2); Push(Stack[-2] * Stack[-1]);
0x612: Pop(2); Push(Stack[-2] + Stack[-1]);
0x613: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x614: Return(); Pop(0)

0x615: PushEmpty(int, int)
0x616: @ GetVariable(Stack[-3], Stack[-1])
0x617: Pop(0)
0x618: Stack[-1] = Stack[-4]
0x619: Return(); Pop(2)

0x61a: PushEmpty(object, object)
0x61b: @ CreateIntVector(Stack[-1])
0x61c: Pop(0)
0x61d: @@ add(Stack[-4]); Obj=1 // @poff=297
0x61e: Pop(0)
0x61f: @@ add(Stack[-3]); Obj=1 // @poff=297
0x620: Pop(0)
0x621: Push((int) 3)
0x622: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x623: Pop(1)
0x624: Return(); Pop(2)

0x625: Stack[-1] = 0
0x626: PushEmpty(int, int)
0x627: PushEmpty(object, string, int)
0x628: Stack[-7] = Stack[-3]
0x629: Stack[-2] = "money" // @poff=301
0x62a: Stack[-6] = Stack[-1]
0x62b: Call2 0x560

0x62c: Pop(3)
0x62d: Push((int) 0)
0x62e: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x62f: IF (Stack[-1] == 0) GOTO 0x638; Pop(1)

0x630: Push("Money") // @poff=313
0x631: @ GetInvItemByName(Stack[-2], Stack[-1])
0x632: Pop(1)
0x633: PushEmpty(int, int)
0x634: Stack[-3] = Stack[-2]
0x635: Stack[-5] = Stack[-1]
0x636: Call2 0x61a

0x637: Pop(2)
0x638: Return(); Pop(2)

0x639: PushEmpty(float, float)
0x63a: @ GetGameTime(Stack[-1])
0x63b: Pop(0)
0x63c: Stack[-1] = Stack[-3]
0x63d: Return(); Pop(2)

0x63e: PushEmpty(string, string)
0x63f: Stack[-1] = "idle" // @poff=18
0x640: Push(Stack[-3])
0x641: IF (Stack[-1] == 0) GOTO 0x643; Pop(1)

0x642: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x643: Stack[-1] = Stack[-4]
0x644: Return(); Pop(2)

0x645: PushEmpty(int, bool, int, bool)
0x646: Stack[-2] = (int) 0
0x647: Push("all") // @poff=28
0x648: PushEmpty(string, int)
0x649: Stack[-5] = Stack[-1]
0x64a: Call2 0x63e

0x64b: Pop(1)
0x64c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x64d: Pop(2)
...
0x651: Push((int) 1)
0x652: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x653: GOTO 0x647

0x654: Stack[-2] = Stack[-5]
0x655: Return(); Pop(4)
...
0x65a: Push("pt_") // @poff=325
0x65b: Push(GlobalVars[0])
0x65c: Stack[-4] = Stack[-2] + Stack[-1]; Pop(2);
0x65d: GOTO 0x662

0x65e: Push("pt_") // @poff=325
0x65f: Push(GlobalVars[0])
0x660: Pop(2); Push(Stack[-2] + Stack[-1]);
0x661: Stack[-3] = Stack[-1] + Stack[-2]; Pop(1);
0x662: Return(); Pop(0)

0x663: PushEmpty(bool, bool)
0x664: Push("cleanup") // @poff=333
0x665: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x666: IF (Stack[-1] == 0) GOTO 0x674; Pop(1)

0x667: Push(GlobalVars[1])
0x668: Stack[-1] = (bool) 1
0x669: GlobalVars[1] = Stack[-1]; Pop(1)
0x66a: @ IsLoaded(Stack[-1])
0x66b: Pop(0)
...
0x670: Pop(0)
0x671: @ RemoveActor(Stack[-1])
0x672: Pop(1)
0x673: GOTO 0x67a

0x674: Push("restore") // @poff=349
0x675: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x676: IF (Stack[-1] == 0) GOTO 0x67a; Pop(1)

0x677: Push(GlobalVars[1])
0x678: Stack[-1] = (bool) 0
0x679: GlobalVars[1] = Stack[-1]; Pop(1)
0x67a: Return(); Pop(2)
...
0x67f: Pop(0)
0x680: @ RemoveActor(Stack[-1])
0x681: Pop(1)
0x682: Return(); Pop(0)

0x683: PushEmpty()
0x684: Push("money10000 is given") // @poff=365
0x685: @ Trace(Stack[-1])
0x686: Pop(1)
0x687: PushEmpty(object, int)
0x688: Stack[-4] = Stack[-2]
0x689: Stack[-1] = (int) 10000
0x68a: Call2 0x626
...
0x68d: PushEmpty()
0x68e: Push("playsound") // @poff=405
0x68f: Push("givemoney") // @poff=425
0x690: @ TriggerWorld(Stack[-2], Stack[-1])
0x691: Pop(2)
0x692: Return(); Pop(0)

0x693: PushEmpty()
0x694: Push("d5q02") // @poff=445
0x695: Push((int) -1)
...
0x6a4: Pop(1)
0x6a5: Push("d5q02GorbunFindTheDaughter") // @poff=457
0x6a6: Push("pt_map_gorbun") // @poff=511
0x6a7: Push((int) 0)
0x6a8: Push((int) 515362)
0x6a9: PushEmpty(float)
0x6aa: Call2 0x639

0x6ab: Pop(0)
0x6ac: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=539
0x6ad: Pop(5)
0x6ae: PushEmpty()
0x6af: Call2 0x756
...
0x6b2: Stack[-1] = 0
0x6b3: PushEmpty()
0x6b4: Push("ood5Gorbun1") // @poff=547
0x6b5: Push((int) 1)
0x6b6: @ SetVariable(Stack[-2], Stack[-1])
0x6b7: Pop(2)
0x6b8: Return(); Pop(0)

0x6b9: PushEmpty(object, object, object, object)
0x6ba: Push("d5q02") // @poff=445
0x6bb: Push((int) 1000)
...
0x6c1: Pop(1)
0x6c2: Push("d5q02AnnaGotoGorbun") // @poff=571
0x6c3: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=611
0x6c4: Pop(1)
0x6c5: Push(Stack[-1])
0x6c6: IF (Stack[-1] == 0) GOTO 0x6c9; Pop(1)

0x6c7: @@ Remove(); Obj=1 // @poff=620
0x6c8: Pop(0)
0x6c9: Push("d5q02AnnaGotoGorbunSelf") // @poff=627
0x6ca: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=611
0x6cb: Pop(1)
0x6cc: Push(Stack[-1])
0x6cd: IF (Stack[-1] == 0) GOTO 0x6d0; Pop(1)

0x6ce: @@ Remove(); Obj=1 // @poff=620
0x6cf: Pop(0)
0x6d0: Push("d5q02AnnaGotoKabak") // @poff=675
0x6d1: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=611
0x6d2: Pop(1)
0x6d3: Push(Stack[-1])
0x6d4: IF (Stack[-1] == 0) GOTO 0x6d7; Pop(1)

0x6d5: @@ Remove(); Obj=1 // @poff=620
0x6d6: Pop(0)
0x6d7: Push("d5q02GorbunFindTheDaughter") // @poff=457
0x6d8: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=611
0x6d9: Pop(1)
0x6da: Push(Stack[-1])
0x6db: IF (Stack[-1] == 0) GOTO 0x6de; Pop(1)

0x6dc: @@ Remove(); Obj=1 // @poff=620
0x6dd: Pop(0)
0x6de: Push("d5q02NudeMeeting") // @poff=713
0x6df: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=611
0x6e0: Pop(1)
0x6e1: Push(Stack[-1])
0x6e2: IF (Stack[-1] == 0) GOTO 0x6e5; Pop(1)

0x6e3: @@ Remove(); Obj=1 // @poff=620
0x6e4: Pop(0)
0x6e5: PushEmpty()
0x6e6: Call2 0x763
...
0x6ea: Stack[-2] = 0
0x6eb: PushEmpty()
0x6ec: Push("ood5Gorbun2") // @poff=747
0x6ed: Push((int) 1)
0x6ee: @ SetVariable(Stack[-2], Stack[-1])
0x6ef: Pop(2)
0x6f0: Return(); Pop(0)

0x6f1: PushEmpty()
0x6f2: Push("ood5Gorbun3") // @poff=771
0x6f3: Push((int) 1)
0x6f4: @ SetVariable(Stack[-2], Stack[-1])
0x6f5: Pop(2)
0x6f6: Return(); Pop(0)

0x6f7: PushEmpty()
0x6f8: Push("money 50000 is given") // @poff=795
0x6f9: @ Trace(Stack[-1])
0x6fa: Pop(1)
0x6fb: PushEmpty(object, int)
0x6fc: Stack[-4] = Stack[-2]
0x6fd: Stack[-1] = (int) 50000
0x6fe: Call2 0x626
...
0x701: PushEmpty()
0x702: PushEmpty(int, string)
0x703: Stack[-1] = "d5q02" // @poff=445
0x704: Call2 0x615

0x705: Pop(1)
0x706: Push((int) 1)
0x707: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x708: IF (Stack[-1] == 0) GOTO 0x70b; Pop(1)

0x709: Stack[-2] = (bool) 1
0x70a: Return(); Pop(0)

0x70b: Stack[-2] = (bool) 0
0x70c: Return(); Pop(0)

0x70d: PushEmpty()
0x70e: PushEmpty(int, string)
0x70f: Stack[-1] = "ood5Gorbun1" // @poff=547
0x710: Call2 0x615

0x711: Pop(1)
0x712: Push((int) 0)
0x713: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x714: IF (Stack[-1] == 0) GOTO 0x717; Pop(1)

0x715: Stack[-2] = (bool) 1
0x716: Return(); Pop(0)

0x717: Stack[-2] = (bool) 0
0x718: Return(); Pop(0)

0x719: PushEmpty()
0x71a: PushEmpty(int, string)
0x71b: Stack[-1] = "d5q02" // @poff=445
0x71c: Call2 0x615
...
0x721: Stack[-2] = (bool) 1
0x722: Return(); Pop(0)

0x723: Stack[-2] = (bool) 0
0x724: Return(); Pop(0)

0x725: PushEmpty()
0x726: PushEmpty(int, string)
0x727: Stack[-1] = "d5q02KnowNudeIsDead" // @poff=837
0x728: Call2 0x615
...
0x72d: Stack[-2] = (bool) 1
0x72e: Return(); Pop(0)

0x72f: Stack[-2] = (bool) 0
0x730: Return(); Pop(0)

0x731: PushEmpty()
0x732: PushEmpty(int, string)
0x733: Stack[-1] = "ood5Gorbun2" // @poff=747
0x734: Call2 0x615

0x735: Pop(1)
0x736: Push((int) 0)
0x737: Pop(2); Push((bool) Stack[-2] == Stack[-1])
...
0x73f: Stack[-1] = "ood5Gorbun3" // @poff=771
0x740: Call2 0x615
...
0x74a: Push((int) 715)
0x74b: Push((int) 2)
0x74c: Push((int) 536323)
0x74d: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x74e: Pop(3)
0x74f: PushEmpty(bool, object, int)
0x750: Stack[-4] = Stack[-2]
0x751: Stack[-1] = (int) 148
0x752: Call2 0x77d
...
0x757: Push((int) 150)
0x758: Push((int) 2)
0x759: Push((int) 515356)
0x75a: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x75b: Pop(3)
0x75c: PushEmpty(bool, object, int)
0x75d: Stack[-4] = Stack[-2]
0x75e: Stack[-1] = (int) 148
0x75f: Call2 0x77d
...
0x764: Push((int) 153)
0x765: Push((int) 2)
0x766: Push((int) 515359)
0x767: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x768: Pop(3)
0x769: PushEmpty(bool, object, int)
0x76a: Stack[-4] = Stack[-2]
0x76b: Stack[-1] = (int) 148
0x76c: Call2 0x77d
...
0x771: @ GetDiaryRoot(Stack[-1])
0x772: Pop(0)
0x773: Pop(0); Push((bool) Stack[-1] == 0)
0x774: IF (Stack[-1] == 0) GOTO 0x77a; Pop(1)

0x775: Push("Can't retrieve diary root") // @poff=877
0x776: @ Trace(Stack[-1])
0x777: Pop(1)
0x778: Stack[-3] = (bool) 0
0x779: Return(); Pop(2)

0x77a: Stack[-1] = Stack[-3]
0x77b: Return(); Pop(2)

0x77c: Stack[-1] = 0
0x77d: PushEmpty(object, object, int, object, object, int)
0x77e: PushEmpty(object)
0x77f: Call2 0x770

0x780: Stack[-1] = Stack[-4]
0x781: Pop(1)
0x782: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=929
0x783: Pop(0)
0x784: Pop(0); Push((bool) Stack[-2] == 0)
0x785: IF (Stack[-1] == 0) GOTO 0x78c; Pop(1)

0x786: Push("Can't find diary parent with id: ") // @poff=934
0x787: Pop(1); Push(Stack[-1] + Stack[-8]);
0x788: @ Trace(Stack[-1])
0x789: Pop(1)
0x78a: Stack[-9] = (bool) 0
0x78b: Return(); Pop(6)

0x78c: @@ AddChild(Stack[-8]); Obj=2 // @poff=1002
0x78d: Pop(0)
0x78e: Push((int) 7)
0x78f: @ SendWorldWndMessage(Stack[-1])
0x790: Pop(1)
0x791: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1011
0x792: Pop(0)
0x793: @ SetDiarySection(Stack[-1])
0x794: Pop(0)
0x795: Stack[-9] = (bool) 0
0x796: Return(); Pop(6)

0x797: Stack[-2] = 0
0x798: Stack[-3] = 0
0x799: PushEmpty(object, object, object, object)
0x79a: @ GetMainOutdoorScene(Stack[-2])
0x79b: Pop(0)
0x79c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x79d: IF (Stack[-1] == 0) GOTO 0x7a4; Pop(1)

0x79e: Push("Can't find main outdoor scene") // @poff=1023
0x79f: @ Trace(Stack[-1])
0x7a0: Pop(1)
0x7a1: Stack[-1] = 0
...
0x7a4: @@ GetMap(Stack[-1]); Obj=2 // @poff=1083
0x7a5: Pop(0)
...
0x7a8: Stack[-1] = 0
0x7a9: Stack[-2] = 0
0x7aa: PushEmpty(int, int)
0x7ab: Push("branch") // @poff=1090
0x7ac: @ GetVariable(Stack[-1], Stack[-2])
0x7ad: Pop(1)
0x7ae: Push((int) 0)
...
0x7b4: Push((int) 1)
0x7b5: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x7bb: Stack[-1] = (int) 515594
0x7bc: Return(); Pop(0)

0x7bd: Stack[-1] = (int) 512583
0x7be: Return(); Pop(0)

0x7bf: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1104
0x7c0: Return(); Pop(0)

0x7c1: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1144
0x7c2: Return(); Pop(0)
...
0x7c5: PushEmpty()
0x7c6: PushEmpty(int, object)
0x7c7: Stack[-3] = Stack[-1]
0x7c8: Push(-2, 1); TaskCall(4)
0x7c9: Call2 0x11a

0x7ca: Pop(-2, 1); TaskReturn
0x7cb: Pop(2)
0x7cc: Return(); Pop(0)
