...
// @pool_raw:
// @pool_encoding:utf8
...
0x1e0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x1e1: Pop(0)
0x1e2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x1e3: Pop(0)
...
0x208: @ StopWorld()
0x209: Pop(0)
0x20a: @ CameraTransit(Stack[-3], Stack[-5])
0x20b: Pop(0)
0x20c: Push(CvectorIndex(Stack[-4], 0))
0x20d: Push(CvectorIndex(Stack[-5], 2))
0x20e: @ Rotate(Stack[-2], Stack[-1])
0x20f: Pop(2)
...
0x215: Push("head") // @poff=198
0x216: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x217: Pop(1)
0x218: Push(Stack[-1])
0x219: IF (Stack[-1] == 0) GOTO 0x21d; Pop(1)

0x21a: Push("head") // @poff=198
0x21b: @ LookAsyncCamera(Stack[-1])
0x21c: Pop(1)
0x21d: @ CameraWaitForPlayFinish()
0x21e: Pop(0)
0x21f: @ ResumeWorld()
0x220: Pop(0)
0x221: Stack[-21] = (bool) 1
0x222: Return(); Pop(18)
...
0x22b: Push("head") // @poff=198
0x22c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x22d: Pop(1)
0x22e: Push(Stack[-1])
0x22f: IF (Stack[-1] == 0) GOTO 0x233; Pop(1)

0x230: Push("head") // @poff=198
0x231: @ UnlookAsync(Stack[-1])
0x232: Pop(1)
0x233: Return(); Pop(2)

0x234: PushEmpty(float, float, float, float)
0x235: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x236: Pop(0)
0x237: Push((bool) 0)
0x238: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x239: Pop(1)
0x23a: Return(); Pop(4)

0x23b: PushEmpty(float, float, float, float)
0x23c: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x23d: Pop(0)
0x23e: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x23f: Pop(0)
0x240: Return(); Pop(4)
...
0x25d: PushEmpty(string, string)
0x25e: Stack[-1] = "idle" // @poff=146
0x25f: Push(Stack[-3])
0x260: IF (Stack[-1] == 0) GOTO 0x262; Pop(1)

0x261: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x262: Stack[-1] = Stack[-4]
0x263: Return(); Pop(2)

0x264: PushEmpty(int, bool, int, bool)
0x265: Stack[-2] = (int) 0
0x266: Push("all") // @poff=138
0x267: PushEmpty(string, int)
0x268: Stack[-5] = Stack[-1]
0x269: Call2 0x25d

0x26a: Pop(1)
0x26b: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x26c: Pop(2)
...
0x275: PushEmpty()
0x276: Push("ood5Prisoner1") // @poff=208
0x277: Push((int) 1)
...
0x27b: PushEmpty()
0x27c: PushEmpty(int, string)
0x27d: Stack[-1] = "ood5Prisoner1" // @poff=208
0x27e: Call2 0x258

0x27f: Pop(1)
0x280: Push((int) 0)
0x281: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x282: IF (Stack[-1] == 0) GOTO 0x285; Pop(1)

0x283: Stack[-2] = (bool) 1
0x284: Return(); Pop(0)

0x285: Stack[-2] = (bool) 0
0x286: Return(); Pop(0)

0x287: PushEmpty(int, int)
0x288: Push("branch") // @poff=236
0x289: @ GetVariable(Stack[-1], Stack[-2])
0x28a: Pop(1)
0x28b: Push((int) 0)
...
0x298: Stack[-1] = (int) 515564
0x299: Return(); Pop(0)

0x29a: Stack[-1] = (int) 503349
0x29b: Return(); Pop(0)

0x29c: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=250
0x29d: Return(); Pop(0)

0x29e: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=290
0x29f: Return(); Pop(0)
