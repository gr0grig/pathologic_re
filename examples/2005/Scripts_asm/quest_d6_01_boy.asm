...
Strings:
	...
	W:ood6Boy1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x291: Stack[-1] = (int) 515558
0x292: Return(); Pop(0)

0x293: Stack[-1] = (int) 503343
0x294: Return(); Pop(0)

0x295: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=206
0x296: Return(); Pop(0)

0x297: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=246
0x298: Return(); Pop(0)
...
0x2a3: Stack[-1] = "ood6Boy1" // @poff=290
0x2a4: Call2 0x274
