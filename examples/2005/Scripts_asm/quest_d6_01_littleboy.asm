...
Strings:
	...
	W:ood6Littleboy1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x10b: Push("player") // @poff=156
0x10c: @ FindActor(Stack[-4]T, Stack[-1])
0x10d: Pop(1)
...
0x120: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1ab: Pop(0)
0x1ac: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1ad: Pop(0)
...
0x1b7: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1b8: Pop(0)
0x1b9: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1ba: Pop(0)
...
0x1df: @ StopWorld()
0x1e0: Pop(0)
0x1e1: @ CameraTransit(Stack[-3], Stack[-5])
0x1e2: Pop(0)
0x1e3: Push(CvectorIndex(Stack[-4], 0))
0x1e4: Push(CvectorIndex(Stack[-5], 2))
0x1e5: @ Rotate(Stack[-2], Stack[-1])
0x1e6: Pop(2)
...
0x1ec: Push("head") // @poff=170
0x1ed: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1ee: Pop(1)
0x1ef: Push(Stack[-1])
0x1f0: IF (Stack[-1] == 0) GOTO 0x1f4; Pop(1)

0x1f1: Push("head") // @poff=170
0x1f2: @ LookAsyncCamera(Stack[-1])
0x1f3: Pop(1)
0x1f4: @ CameraWaitForPlayFinish()
0x1f5: Pop(0)
0x1f6: @ ResumeWorld()
0x1f7: Pop(0)
0x1f8: Stack[-21] = (bool) 1
0x1f9: Return(); Pop(18)

0x1fa: PushEmpty(bool, bool)
0x1fb: @ CameraSwitchToNormal()
0x1fc: Pop(0)
...
0x207: Push("head") // @poff=170
0x208: @ UnlookAsync(Stack[-1])
0x209: Pop(1)
0x20a: Return(); Pop(2)
...
0x213: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x214: Pop(0)
0x215: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x216: Pop(0)
0x217: Return(); Pop(4)

0x218: PushEmpty(float, cvector, float, cvector)
0x219: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x21a: Pop(0)
0x21b: Stack[-1] = [0.0, 0.0, 0.0]
0x21c: Push(CvectorIndex(Stack[-1], 1))
0x21d: Stack[-3] = Stack[-1]
0x21e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x21f: Push("head") // @poff=170
0x220: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x221: Pop(1)
0x222: Return(); Pop(4)
...
0x22a: PushEmpty(float, float)
0x22b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x22c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x22d: Push((float)9.999999974752427e-07)
0x22e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x22f: IF (Stack[-1] == 0) GOTO 0x232; Pop(1)

0x230: Stack[-4] = [0.0, 0.0, 0.0]
0x231: Return(); Pop(2)

0x232: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x233: Return(); Pop(2)

0x234: PushEmpty(int, int)
0x235: @ GetVariable(Stack[-3], Stack[-1])
0x236: Pop(0)
0x237: Stack[-1] = Stack[-4]
0x238: Return(); Pop(2)

0x239: PushEmpty(string, string)
0x23a: Stack[-1] = "idle" // @poff=146
0x23b: Push(Stack[-3])
0x23c: IF (Stack[-1] == 0) GOTO 0x23e; Pop(1)

0x23d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x23e: Stack[-1] = Stack[-4]
0x23f: Return(); Pop(2)

0x240: PushEmpty(int, bool, int, bool)
0x241: Stack[-2] = (int) 0
0x242: Push("all") // @poff=138
0x243: PushEmpty(string, int)
0x244: Stack[-5] = Stack[-1]
0x245: Call2 0x239

0x246: Pop(1)
0x247: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x248: Pop(2)
...
0x24c: Push((int) 1)
0x24d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x24e: GOTO 0x242

0x24f: Stack[-2] = Stack[-5]
0x250: Return(); Pop(4)

0x251: Stack[-1] = (int) 515560
0x252: Return(); Pop(0)

0x253: Stack[-1] = (int) 503345
0x254: Return(); Pop(0)

0x255: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=206
0x256: Return(); Pop(0)

0x257: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=246
0x258: Return(); Pop(0)
...
0x25b: PushEmpty()
0x25c: Push("ood6Littleboy1") // @poff=290
0x25d: Push((int) 1)
...
0x261: PushEmpty()
0x262: PushEmpty(int, string)
0x263: Stack[-1] = "ood6Littleboy1" // @poff=290
0x264: Call2 0x234

0x265: Pop(1)
0x266: Push((int) 0)
0x267: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x268: IF (Stack[-1] == 0) GOTO 0x26b; Pop(1)

0x269: Stack[-2] = (bool) 1
0x26a: Return(); Pop(0)

0x26b: Stack[-2] = (bool) 0
0x26c: Return(); Pop(0)

0x26d: PushEmpty(int, int)
0x26e: Push("branch") // @poff=320
