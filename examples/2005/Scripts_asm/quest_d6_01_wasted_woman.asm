...
Strings:
	...
	W:ood6WastedWoman1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x155: Push("player") // @poff=156
0x156: @ FindActor(Stack[-4]T, Stack[-1])
0x157: Pop(1)
...
0x16a: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1f5: Pop(0)
0x1f6: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1f7: Pop(0)
...
0x201: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x202: Pop(0)
0x203: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x204: Pop(0)
...
0x229: @ StopWorld()
0x22a: Pop(0)
0x22b: @ CameraTransit(Stack[-3], Stack[-5])
0x22c: Pop(0)
...
0x256: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x257: Pop(0)
0x258: Push((bool) 0)
...
0x25c: PushEmpty(float, float, float, float)
0x25d: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x25e: Pop(0)
0x25f: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x260: Pop(0)
0x261: Return(); Pop(4)

0x262: PushEmpty(float, cvector, float, cvector)
0x263: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x264: Pop(0)
0x265: Stack[-1] = [0.0, 0.0, 0.0]
0x266: Push(CvectorIndex(Stack[-1], 1))
0x267: Stack[-3] = Stack[-1]
0x268: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x269: Push("head") // @poff=170
...
0x299: Stack[-2] = Stack[-5]
0x29a: Return(); Pop(4)

0x29b: Stack[-1] = (int) 515555
0x29c: Return(); Pop(0)

0x29d: Stack[-1] = (int) 503340
0x29e: Return(); Pop(0)

0x29f: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=206
0x2a0: Return(); Pop(0)

0x2a1: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=246
0x2a2: Return(); Pop(0)
...
0x2a5: PushEmpty()
0x2a6: Push("ood6WastedWoman1") // @poff=290
0x2a7: Push((int) 1)
...
0x2ad: Stack[-1] = "ood6WastedWoman1" // @poff=290
0x2ae: Call2 0x27e
