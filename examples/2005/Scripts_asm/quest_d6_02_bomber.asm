...
0x68c: Push("GenerateMoney: iMin > iMax") // @poff=751
0x68d: @ Trace(Stack[-1])
0x68e: Pop(1)
0x68f: Return(); Pop(4)
...
0x6aa: Pop(0)
0x6ab: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x6ac: Pop(0)
0x6ad: Push("Organ") // @poff=829
0x6ae: Push((int) 1)
0x6af: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x6b0: Pop(2)
0x6b1: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x6b2: Pop(0)
0x6b3: Push((int) 0)
0x6b4: Push((int) 1)
...
0x6c1: Stack[-1] = "liver" // @poff=851
0x6c2: Call2 0x6a8

0x6c3: Pop(1)
0x6c4: PushEmpty(string)
0x6c5: Stack[-1] = "kidney" // @poff=863
0x6c6: Call2 0x6a8

0x6c7: Pop(1)
0x6c8: PushEmpty(string)
0x6c9: Stack[-1] = "heart" // @poff=877
0x6ca: Call2 0x6a8

0x6cb: Pop(1)
0x6cc: PushEmpty(string)
0x6cd: Stack[-1] = "blood" // @poff=889
0x6ce: Call2 0x6a8
...
0x6db: Stack[-3] = "fresh_meat" // @poff=901
0x6dc: Stack[-2] = (int) 1
0x6dd: Stack[-1] = (int) 6
0x6de: Call2 0x5c5
...
0x6e8: Stack[-3] = "gamma_pills" // @poff=933
0x6e9: Stack[-2] = (int) 1
0x6ea: Stack[-1] = (int) 3
0x6eb: Call2 0x5c5
...
0x6ee: Stack[-1] = "bomber_mark" // @poff=957
0x6ef: Call2 0x6f6
...
0x705: Push("class") // @poff=981
0x706: @ GetProperty(Stack[-1], Stack[-3])
0x707: Pop(1)
0x708: Push("class") // @poff=981
0x709: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x70a: Pop(1)
...
0x761: Stack[-2] = Stack[-4]
0x762: Pop(2)
0x763: Return(); Pop(0)

0x764: PushEmpty()
0x765: PushEmpty(object)
0x766: Stack[-2] = Stack[-1]
...
0x77f: Stack[-2] = Stack[-1]
0x780: Call2 0x810

0x781: Pop(1)
0x782: PushEmpty(object)
0x783: Stack[-2] = Stack[-1]
...
0x78d: Stack[-7] = Stack[-3]
0x78e: Stack[-6] = Stack[-2]
...
0x795: Stack[-11] = Stack[-5]
0x796: Stack[-10] = Stack[-4]
0x797: Stack[-9] = Stack[-3]
0x798: Stack[-7] = Stack[-2]
...
0x7a8: Stack[-4] = Stack[-2]
0x7a9: Stack[-1] = (float) 0.05000000074505806
0x7aa: Call2 0x628
...
0x7d0: Push(Stack[-2])
0x7d1: IF (Stack[-1] == 1) GOTO 0x7da; Pop(1)

0x7d2: PushEmpty(float, object)
0x7d3: Stack[-7] = Stack[-1]
0x7d4: Call2 0x4b4

0x7d5: Pop(1)
0x7d6: Push((float)490000.0)
0x7d7: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x7d8: IF (Stack[-1] == 1) GOTO 0x7da; Pop(1)
...
0x7e0: PushEmpty(string, string)
0x7e1: PushEmpty(bool, object)
0x7e2: Stack[-5] = Stack[-1]
0x7e3: Call2 0x50c
...
0x7e7: Stack[-4] = (bool) 0
0x7e8: Return(); Pop(2)

0x7e9: PushEmpty(bool, object, string)
0x7ea: Stack[-6] = Stack[-2]
0x7eb: Stack[-1] = "health" // @poff=993
0x7ec: Call2 0x4c1

0x7ed: Pop(2)
0x7ee: Pop(1); Push((bool) Stack[-1] == 0)
...
0x7f3: Stack[-6] = Stack[-2]
0x7f4: Stack[-1] = "class" // @poff=981
0x7f5: Call2 0x4c1

0x7f6: Pop(2)
0x7f7: IF (Stack[-1] == 0) GOTO 0x80e; Pop(1)

0x7f8: Push("class") // @poff=981
0x7f9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x7fa: Pop(1)
0x7fb: PushEmpty(bool)
0x7fc: Stack[-1] = (bool) 1
0x7fd: PushEmpty(bool)
0x7fe: Stack[-1] = (bool) 1
0x7ff: Push("rat") // @poff=1007
0x800: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x801: IF (Stack[-1] == 1) GOTO 0x806; Pop(1)

0x802: Push("rat_big") // @poff=1015
0x803: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x804: IF (Stack[-1] == 1) GOTO 0x806; Pop(1)

0x805: Stack[-1] = (bool) 0
0x806: IF (Stack[-1] == 1) GOTO 0x80b; Pop(1)

0x807: Push("bomber") // @poff=1031
0x808: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x809: IF (Stack[-1] == 1) GOTO 0x80b; Pop(1)

0x80a: Stack[-1] = (bool) 0
0x80b: IF (Stack[-1] == 0) GOTO 0x80e; Pop(1)

0x80c: Stack[-4] = (bool) 0
0x80d: Return(); Pop(2)

0x80e: Stack[-4] = (bool) 1
0x80f: Return(); Pop(2)
