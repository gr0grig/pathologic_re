...
Strings:
	...
	W:quest_d6_02
	W:gorbun_death
// @pool_raw:
...
Events:
EVENT_22 Op = 0x797 Vars = (object, int, float, float)
EVENT_43 Op = 0x79f Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x7bf Vars = (object, string)
EVENT_41 Op = 0x7cc Vars = (object)
EVENT_6 Op = 0x81e Vars = ()
...
0x642: Stack[-8] = Stack[-5]
0x643: Stack[-4] = "reputation" // @poff=705
0x644: Stack[-7] = Stack[-3]
0x645: Stack[-2] = (int) 0
0x646: Stack[-1] = (int) 1
0x647: Call2 0x4cd
...
0x64d: Pop(0)
0x64e: @@ add(Stack[-3]); Obj=1 // @poff=664
0x64f: Pop(0)
0x650: Push((int) 16)
...
0x657: Pop(0)
0x658: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x662: @ IsPlayerActor(Stack[-3], Stack[-1])
0x663: Pop(0)
0x664: Push(Stack[-1])
0x665: IF (Stack[-1] == 0) GOTO 0x669; Pop(1)

0x666: Push("attack") // @poff=334
0x667: @ PlayGlobalMusic(Stack[-1])
0x668: Pop(1)
0x669: Return(); Pop(2)

0x66a: PushEmpty(string, string)
0x66b: Stack[-1] = "idle" // @poff=727
0x66c: Push(Stack[-3])
0x66d: IF (Stack[-1] == 0) GOTO 0x66f; Pop(1)

0x66e: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x66f: Stack[-1] = Stack[-4]
0x670: Return(); Pop(2)

0x671: PushEmpty(int, bool, int, bool)
0x672: Stack[-2] = (int) 0
0x673: Push("all") // @poff=170
0x674: PushEmpty(string, int)
0x675: Stack[-5] = Stack[-1]
0x676: Call2 0x66a

0x677: Pop(1)
0x678: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x679: Pop(2)
...
0x67d: Push((int) 1)
0x67e: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x67f: GOTO 0x673

0x680: Stack[-2] = Stack[-5]
0x681: Return(); Pop(4)

0x682: PushEmpty(int, int)
0x683: Push("branch") // @poff=737
0x684: @ GetVariable(Stack[-1], Stack[-2])
0x685: Pop(1)
...
0x68f: @ WorkWithCorpse(Stack[-1])
0x690: Pop(0)
0x691: GOTO 0x694

0x692: @ Barter(Stack[-1])
0x693: Pop(0)
0x694: Return(); Pop(0)

0x695: PushEmpty(int, bool, int, bool)
0x696: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x697: IF (Stack[-1] == 0) GOTO 0x69c; Pop(1)

0x698: Push("GenerateMoney: iMin > iMax") // @poff=751
0x699: @ Trace(Stack[-1])
0x69a: Pop(1)
0x69b: Return(); Pop(4)

0x69c: Stack[-2] = (int) 0
0x69d: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x69e: IF (Stack[-1] == 0) GOTO 0x6a3; Pop(1)

0x69f: Pop(0); Push(Stack[-5] - Stack[-6]);
0x6a0: @ irand(Stack[-3], Stack[-1])
0x6a1: Pop(1)
0x6a2: GOTO 0x6a7

0x6a3: Push((int) 0)
0x6a4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6a5: IF (Stack[-1] == 0) GOTO 0x6a7; Pop(1)

0x6a6: Return(); Pop(4)

0x6a7: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x6a8: Push((int) 0)
...
0x6ad: Stack[-1] = "Money" // @poff=805
0x6ae: Call2 0x702

0x6af: Pop(1)
0x6b0: Push((int) 0)
0x6b1: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x6b2: Pop(2)
0x6b3: Return(); Pop(4)

0x6b4: PushEmpty(object, int, bool, object, int, bool)
0x6b5: @ CreateInvItem(Stack[-3])
0x6b6: Pop(0)
0x6b7: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x6b8: Pop(0)
0x6b9: Push("Organ") // @poff=829
0x6ba: Push((int) 1)
0x6bb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x6bc: Pop(2)
0x6bd: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x6be: Pop(0)
0x6bf: Push((int) 0)
0x6c0: Push((int) 1)
0x6c1: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x6c2: Pop(2)
0x6c3: Return(); Pop(6)
...
0x6c7: Pop(0)
0x6c8: Push((int) 1)
0x6c9: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x6ca: IF (Stack[-1] == 0) GOTO 0x6cc; Pop(1)

0x6cb: Return(); Pop(0)

0x6cc: PushEmpty(string)
0x6cd: Stack[-1] = "liver" // @poff=851
0x6ce: Call2 0x6b4

0x6cf: Pop(1)
0x6d0: PushEmpty(string)
0x6d1: Stack[-1] = "kidney" // @poff=863
0x6d2: Call2 0x6b4

0x6d3: Pop(1)
0x6d4: PushEmpty(string)
0x6d5: Stack[-1] = "heart" // @poff=877
0x6d6: Call2 0x6b4

0x6d7: Pop(1)
0x6d8: PushEmpty(string)
0x6d9: Stack[-1] = "blood" // @poff=889
0x6da: Call2 0x6b4

0x6db: Pop(1)
0x6dc: Return(); Pop(0)

0x6dd: PushEmpty(int, bool, int, bool)
0x6de: Push((int) 0)
0x6df: @ ClearSubContainer(Stack[-1])
0x6e0: Pop(1)
0x6e1: PushEmpty(int, int)
0x6e2: Stack[-2] = (int) 600
0x6e3: Stack[-1] = (int) 1500
0x6e4: Call2 0x695

0x6e5: Pop(2)
0x6e6: PushEmpty(string, int, int)
0x6e7: Stack[-3] = "fresh_meat" // @poff=901
0x6e8: Stack[-2] = (int) 1
0x6e9: Stack[-1] = (int) 6
0x6ea: Call2 0x5c5

0x6eb: Pop(3)
0x6ec: PushEmpty(string, int, int, int)
0x6ed: Stack[-4] = "rusk" // @poff=923
0x6ee: Stack[-3] = (int) 1
0x6ef: Stack[-2] = (int) 6
0x6f0: Stack[-1] = (int) 2
0x6f1: Call2 0x5d0
...
0x6f2: Pop(4)
0x6f3: PushEmpty(string, int, int)
0x6f4: Stack[-3] = "gamma_pills" // @poff=933
0x6f5: Stack[-2] = (int) 1
0x6f6: Stack[-1] = (int) 3
0x6f7: Call2 0x5c5

0x6f8: Pop(3)
0x6f9: PushEmpty(int, string)
0x6fa: Stack[-1] = "bomber_mark" // @poff=957
0x6fb: Call2 0x702

0x6fc: Pop(1)
0x6fd: Push((int) 0)
0x6fe: Push((int) 1)
0x6ff: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x700: Pop(3)
0x701: Return(); Pop(4)

0x702: PushEmpty(int, int)
0x703: @ GetInvItemByName(Stack[-1], Stack[-3])
0x704: Pop(0)
0x705: Stack[-1] = Stack[-4]
0x706: Return(); Pop(2)

0x707: PushEmpty(string, string, string, string)
0x708: PushEmpty(bool, object, string)
0x709: Stack[-8] = Stack[-2]
0x70a: Stack[-1] = "class" // @poff=981
0x70b: Call2 0x4c1
...
0x70f: Stack[-6] = (bool) 0
0x710: Return(); Pop(4)

0x711: Push("class") // @poff=981
0x712: @ GetProperty(Stack[-1], Stack[-3])
0x713: Pop(1)
0x714: Push("class") // @poff=981
0x715: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x716: Pop(1)
0x717: Stack[-6] = Stack[-1] == Stack[-2]; Pop(0);
0x718: Return(); Pop(4)

0x719: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x71a: Push(CvectorIndex(Stack[-11], 0))
0x71b: Push(CvectorIndex(Stack[-12], 0))
0x71c: Pop(2); Push(Stack[-2] * Stack[-1]);
0x71d: Push(CvectorIndex(Stack[-12], 2))
0x71e: Push(CvectorIndex(Stack[-13], 2))
0x71f: Pop(2); Push(Stack[-2] * Stack[-1]);
0x720: Pop(2); Push(Stack[-2] + Stack[-1]);
0x721: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x722: Push(CvectorIndex(Stack[-11], 1))
0x723: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x724: Push(CvectorIndex(Stack[-13], 0))
0x725: Push(CvectorIndex(Stack[-13], 0))
0x726: Pop(2); Push(Stack[-2] - Stack[-1]);
0x727: Push(CvectorIndex(Stack[-14], 0))
0x728: Push(CvectorIndex(Stack[-14], 0))
0x729: Pop(2); Push(Stack[-2] - Stack[-1]);
0x72a: Pop(2); Push(Stack[-2] * Stack[-1]);
0x72b: Push(CvectorIndex(Stack[-14], 2))
0x72c: Push(CvectorIndex(Stack[-14], 2))
0x72d: Pop(2); Push(Stack[-2] - Stack[-1]);
0x72e: Push(CvectorIndex(Stack[-15], 2))
0x72f: Push(CvectorIndex(Stack[-15], 2))
0x730: Pop(2); Push(Stack[-2] - Stack[-1]);
0x731: Pop(2); Push(Stack[-2] * Stack[-1]);
0x732: Pop(2); Push(Stack[-2] + Stack[-1]);
0x733: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x734: Push((float)500.0)
0x735: Pop(0); Push(Stack[-4] * Stack[-5]);
0x736: Push(CvectorIndex(Stack[-14], 1))
0x737: Push(CvectorIndex(Stack[-16], 1))
0x738: Pop(2); Push(Stack[-2] - Stack[-1]);
0x739: Pop(2); Push(Stack[-2] - Stack[-1]);
0x73a: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x73b: Push((int) 0)
0x73c: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x73d: IF (Stack[-1] == 0) GOTO 0x740; Pop(1)

0x73e: Stack[-14] = (int) -1
0x73f: Return(); Pop(10)

0x740: Pop(0); Push(Stack[-3] / Stack[-5]);
0x741: Pop(0); Push(Sqrt(Stack[-3]))
0x742: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x743: Stack[-1] = Stack[-14]
0x744: Return(); Pop(10)

0x745: PushEmpty()
0x746: Push((int) 200)
0x747: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x748: IF (Stack[-1] == 0) GOTO 0x74c; Pop(1)
...
0x757: Stack[-2] = (int) 30
0x758: Return(); Pop(0)

0x759: Stack[-2] = (int) 700
0x75a: Return(); Pop(0)
...
0x76b: Stack[-3] = Stack[-1]
0x76c: Call2 0x7ec

0x76d: Stack[-2] = Stack[-4]
0x76e: Pop(2)
0x76f: Return(); Pop(0)

0x770: PushEmpty()
0x771: PushEmpty(object)
0x772: Stack[-2] = Stack[-1]
0x773: Push(-1, 3); TaskCall(2)
0x774: Call2 0x15d

0x775: Pop(-1, 3); TaskReturn
0x776: Pop(1)
0x777: Return(); Pop(0)
...
0x77f: PushEmpty()
0x780: PushEmpty(object)
0x781: Stack[-2] = Stack[-1]
0x782: Push(-1, 2); TaskCall(4)
0x783: Call2 0x2ab

0x784: Pop(-1, 2); TaskReturn
0x785: Pop(1)
0x786: @ ResetAAS()
0x787: Pop(0)
0x788: Return(); Pop(0)
...
0x78b: Stack[-2] = Stack[-1]
0x78c: Call2 0x81c

0x78d: Pop(1)
0x78e: PushEmpty(object)
0x78f: Stack[-2] = Stack[-1]
0x790: Push(-1, 2); TaskCall(4)
0x791: Call2 0x2ab

0x792: Pop(-1, 2); TaskReturn
0x793: Pop(1)
0x794: @ ResetAAS()
0x795: Pop(0)
0x796: Return(); Pop(0)
...
0x797: PushEmpty()
0x798: PushEmpty(object, int, float)
0x799: Stack[-7] = Stack[-3]
0x79a: Stack[-6] = Stack[-2]
0x79b: Stack[-5] = Stack[-1]
0x79c: Call2 0x563
...
0x79f: PushEmpty()
0x7a0: PushEmpty(object, int, float, cvector, cvector)
0x7a1: Stack[-11] = Stack[-5]
0x7a2: Stack[-10] = Stack[-4]
0x7a3: Stack[-9] = Stack[-3]
0x7a4: Stack[-7] = Stack[-2]
0x7a5: Stack[-6] = Stack[-1]
0x7a6: Call2 0x5a7
...
0x7b3: PushEmpty(bool, object, float)
0x7b4: Stack[-4] = Stack[-2]
0x7b5: Stack[-1] = (float) 0.05000000074505806
0x7b6: Call2 0x628

0x7b7: Pop(3)
0x7b8: PushEmpty(object)
0x7b9: Stack[-2] = Stack[-1]
0x7ba: Push(-1, 0); TaskCall(1)
0x7bb: Call2 0xb9

0x7bc: Pop(-1, 0); TaskReturn
0x7bd: Pop(1)
0x7be: Return(); Pop(0)

0x7bf: PushEmpty(float, float)
0x7c0: Push("health") // @poff=993
0x7c1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7c2: IF (Stack[-1] == 0) GOTO 0x7cb; Pop(1)

0x7c3: Push("health") // @poff=993
0x7c4: @ GetProperty(Stack[-1], Stack[-2])
0x7c5: Pop(1)
0x7c6: Push((int) 0)
0x7c7: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7c8: IF (Stack[-1] == 0) GOTO 0x7cb; Pop(1)

0x7c9: @ SignalDeath(Stack[-4])
0x7ca: Pop(0)
0x7cb: Return(); Pop(2)

0x7cc: PushEmpty()
0x7cd: PushEmpty(object)
0x7ce: Stack[-2] = Stack[-1]
0x7cf: Call2 0x7a9

0x7d0: Pop(1)
0x7d1: Return(); Pop(0)

0x7d2: PushEmpty(bool, bool)
0x7d3: PushEmpty(bool, object)
0x7d4: Stack[-5] = Stack[-1]
0x7d5: Call2 0x707

0x7d6: Pop(1)
0x7d7: IF (Stack[-1] == 0) GOTO 0x7e9; Pop(1)

0x7d8: @ CanSee(Stack[-1], Stack[-4])
0x7d9: Pop(0)
0x7da: PushEmpty(bool)
0x7db: Stack[-1] = (bool) 1
0x7dc: Push(Stack[-2])
0x7dd: IF (Stack[-1] == 1) GOTO 0x7e6; Pop(1)

0x7de: PushEmpty(float, object)
0x7df: Stack[-7] = Stack[-1]
0x7e0: Call2 0x4b4

0x7e1: Pop(1)
0x7e2: Push((float)490000.0)
0x7e3: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x7e4: IF (Stack[-1] == 1) GOTO 0x7e6; Pop(1)

0x7e5: Stack[-1] = (bool) 0
0x7e6: IF (Stack[-1] == 0) GOTO 0x7e9; Pop(1)

0x7e7: Stack[-5] = (bool) 1
0x7e8: Return(); Pop(2)
...
0x7ec: PushEmpty(string, string)
0x7ed: PushEmpty(bool, object)
0x7ee: Stack[-5] = Stack[-1]
0x7ef: Call2 0x50c

0x7f0: Pop(1)
0x7f1: Pop(1); Push((bool) Stack[-1] == 0)
0x7f2: IF (Stack[-1] == 0) GOTO 0x7f5; Pop(1)

0x7f3: Stack[-4] = (bool) 0
0x7f4: Return(); Pop(2)

0x7f5: PushEmpty(bool, object, string)
0x7f6: Stack[-6] = Stack[-2]
0x7f7: Stack[-1] = "health" // @poff=993
0x7f8: Call2 0x4c1
...
0x7fc: Stack[-4] = (bool) 0
0x7fd: Return(); Pop(2)

0x7fe: PushEmpty(bool, object, string)
0x7ff: Stack[-6] = Stack[-2]
0x800: Stack[-1] = "class" // @poff=981
0x801: Call2 0x4c1

0x802: Pop(2)
0x803: IF (Stack[-1] == 0) GOTO 0x81a; Pop(1)

0x804: Push("class") // @poff=981
0x805: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x806: Pop(1)
0x807: PushEmpty(bool)
0x808: Stack[-1] = (bool) 1
0x809: PushEmpty(bool)
0x80a: Stack[-1] = (bool) 1
0x80b: Push("rat") // @poff=1007
0x80c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x80d: IF (Stack[-1] == 1) GOTO 0x812; Pop(1)

0x80e: Push("rat_big") // @poff=1015
0x80f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x810: IF (Stack[-1] == 1) GOTO 0x812; Pop(1)

0x811: Stack[-1] = (bool) 0
0x812: IF (Stack[-1] == 1) GOTO 0x817; Pop(1)

0x813: Push("bomber") // @poff=1031
...
0x818: Stack[-4] = (bool) 0
0x819: Return(); Pop(2)

0x81a: Stack[-4] = (bool) 1
0x81b: Return(); Pop(2)
...
0x826: PushEmpty()
0x827: PushEmpty(bool, string, string)
0x828: Stack[-2] = "quest_d6_02" // @poff=1045
0x829: Stack[-1] = "gorbun_death" // @poff=1069
0x82a: Call2 0x655
