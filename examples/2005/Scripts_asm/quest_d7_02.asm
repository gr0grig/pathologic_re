...
Strings:
	...
	W:d7q02_corpse.xml
	W:cleanup
// @pool_raw:
...
0x1a: Push("place_corpse") // @poff=42
0x1b: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x1c: IF (Stack[-1] == 0) GOTO 0x26; Pop(1)

0x1d: @ GetMainOutdoorScene(Stack[-1])
0x1e: Pop(0)
0x1f: Push("d7q02_corpse") // @poff=68
0x20: Push([0.0, 0.0, 0.0])
0x21: Push([0.0, 0.0, 1.0])
0x22: Push("d7q02_corpse.xml") // @poff=94
0x23: @ AddActor(Stack[-0]T, Stack[-4], Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0x24: Pop(4)
0x25: Stack[-1] = 0
0x26: Return(); Pop(2)

0x27: PushEmpty(int, int)
0x28: Push("d7q02") // @poff=0
...
0x53: Push("cleanup") // @poff=128
0x54: @ Trigger(Stack[-0]T, Stack[-1])
0x55: Pop(1)
