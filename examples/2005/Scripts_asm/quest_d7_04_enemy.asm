...
Events:
EVENT_26 Op = 0xc4d Vars = (string)
EVENT_22 Op = 0xdb8 Vars = (object, int, float, float)
EVENT_43 Op = 0xdc0 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xdca Vars = (object, string)
EVENT_41 Op = 0xdd7 Vars = (object)
...
0xc13: Pop(0)
0xc14: Push((int) 15)
0xc15: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc16: Pop(1)
0xc17: Return(); Pop(2)

0xc18: Stack[-1] = 0
0xc19: PushEmpty(bool, bool)
0xc1a: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc1b: Pop(0)
0xc1c: Push(Stack[-1])
0xc1d: IF (Stack[-1] == 0) GOTO 0xc21; Pop(1)

0xc1e: Push("attack") // @poff=186
0xc1f: @ PlayGlobalMusic(Stack[-1])
0xc20: Pop(1)
0xc21: Return(); Pop(2)

0xc22: PushEmpty(string, string)
0xc23: Stack[-1] = "idle" // @poff=919
0xc24: Push(Stack[-3])
0xc25: IF (Stack[-1] == 0) GOTO 0xc27; Pop(1)

0xc26: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xc27: Stack[-1] = Stack[-4]
0xc28: Return(); Pop(2)

0xc29: PushEmpty(int, bool, int, bool)
0xc2a: Stack[-2] = (int) 0
0xc2b: Push("all") // @poff=214
0xc2c: PushEmpty(string, int)
0xc2d: Stack[-5] = Stack[-1]
0xc2e: Call2 0xc22

0xc2f: Pop(1)
0xc30: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xc31: Pop(2)
0xc32: Pop(0); Push((bool) Stack[-1] == 0)
0xc33: IF (Stack[-1] == 0) GOTO 0xc35; Pop(1)

0xc34: GOTO 0xc38

0xc35: Push((int) 1)
0xc36: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xc37: GOTO 0xc2b

0xc38: Stack[-2] = Stack[-5]
0xc39: Return(); Pop(4)

0xc3a: PushEmpty(int, int)
0xc3b: Push("branch") // @poff=929
0xc3c: @ GetVariable(Stack[-1], Stack[-2])
0xc3d: Pop(1)
0xc3e: Stack[-1] = Stack[-3]
0xc3f: Return(); Pop(2)
...
0xc47: @ WorkWithCorpse(Stack[-1])
0xc48: Pop(0)
0xc49: GOTO 0xc4c

0xc4a: @ Barter(Stack[-1])
0xc4b: Pop(0)
0xc4c: Return(); Pop(0)

0xc4d: PushEmpty()
0xc4e: Push("cleanup") // @poff=614
0xc4f: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc50: IF (Stack[-1] == 0) GOTO 0xc54; Pop(1)

0xc51: Push(GlobalVars[0])
0xc52: Stack[-1] = (bool) 1
0xc53: GlobalVars[0] = Stack[-1]; Pop(1)
0xc54: Return(); Pop(0)

0xc55: PushEmpty(cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float)
0xc56: PushEmpty(object)
0xc57: Call2 0xbe8

0xc58: Pop(0)
0xc59: Pop(1); Push((bool) Stack[-19] == Stack[-1])
0xc5a: IF (Stack[-1] == 0) GOTO 0xc5d; Pop(1)

0xc5b: Stack[-19] = (bool) 0
0xc5c: Return(); Pop(16)
...
0xc5f: Pop(0)
0xc60: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc61: IF (Stack[-1] == 0) GOTO 0xc6a; Pop(1)

0xc62: PushEmpty(bool, object)
0xc63: Stack[-20] = Stack[-1]
0xc64: Call2 0xd45

0xc65: Pop(1)
0xc66: IF (Stack[-1] == 0) GOTO 0xc69; Pop(1)

0xc67: Stack[-19] = (bool) 1
0xc68: Return(); Pop(16)
...
0xc6c: Pop(0)
0xc6d: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc6e: IF (Stack[-1] == 0) GOTO 0xc80; Pop(1)

0xc6f: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xc70: Pop(0)
0xc71: @ GetPosition(Stack[-7])
0xc72: Pop(0)
0xc73: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0xc74: Stack[-5] = Stack[-6] | Stack[-6]; Pop(0);
0xc75: Push((float)4000000.0)
0xc76: Pop(1); Push((bool) Stack[-6] < Stack[-1])
0xc77: IF (Stack[-1] == 0) GOTO 0xc7f; Pop(1)

0xc78: PushEmpty(bool, object)
0xc79: Stack[-20] = Stack[-1]
0xc7a: Call2 0xd69

0xc7b: Pop(1)
0xc7c: IF (Stack[-1] == 0) GOTO 0xc7f; Pop(1)

0xc7d: Stack[-19] = (bool) 1
0xc7e: Return(); Pop(16)

0xc7f: GOTO 0xc9d

0xc80: Push("player_shot") // @poff=943
0xc81: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc82: IF (Stack[-1] == 0) GOTO 0xc9d; Pop(1)

0xc83: @@ GetPosition(Stack[-4]); Obj=18 // @poff=43
0xc84: Pop(0)
0xc85: @ GetPosition(Stack[-3])
0xc86: Pop(0)
0xc87: Stack[-2] = Stack[-4] - Stack[-3]; Pop(0);
0xc88: Stack[-1] = Stack[-2] | Stack[-2]; Pop(0);
0xc89: Push((float)360000.0)
0xc8a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc8b: IF (Stack[-1] == 0) GOTO 0xc93; Pop(1)

0xc8c: PushEmpty(bool, object)
0xc8d: Stack[-20] = Stack[-1]
0xc8e: Call2 0xd69

0xc8f: Pop(1)
0xc90: IF (Stack[-1] == 0) GOTO 0xc93; Pop(1)

0xc91: Stack[-19] = (bool) 1
0xc92: Return(); Pop(16)

0xc93: Push((float)12250000.0)
0xc94: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc95: IF (Stack[-1] == 0) GOTO 0xc9d; Pop(1)

0xc96: PushEmpty(bool, object)
0xc97: Stack[-20] = Stack[-1]
0xc98: Call2 0xd45

0xc99: Pop(1)
0xc9a: IF (Stack[-1] == 0) GOTO 0xc9d; Pop(1)

0xc9b: Stack[-19] = (bool) 1
0xc9c: Return(); Pop(16)

0xc9d: Stack[-19] = (bool) 0
0xc9e: Return(); Pop(16)

0xc9f: PushEmpty()
0xca0: PushEmpty(bool)
0xca1: Stack[-1] = (bool) 0
0xca2: Push("IsDead") // @poff=771
0xca3: Push((int) 1)
0xca4: Pop(2); Push(IsFuncExist(Stack[-4], Stack[-2], Stack[-1]))
0xca5: IF (Stack[-1] == 0) GOTO 0xcac; Pop(1)

0xca6: PushEmpty(bool, object)
0xca7: Stack[-4] = Stack[-1]
0xca8: Call2 0xae5
...
0xcad: PushEmpty(bool, object, string)
0xcae: Stack[-4] = Stack[-2]
0xcaf: PushEmpty(string)
0xcb0: Call2 0xde3

0xcb1: Stack[-1] = Stack[-2]
0xcb2: Pop(1)
0xcb3: Call2 0xa90
...
0xcba: Pop(0)
0xcbb: Push((int) 1)
0xcbc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=752
0xcbd: Pop(2)
0xcbe: PushEmpty(bool, object)
0xcbf: Stack[-3] = Stack[-1]
0xcc0: Call2 0xd33
...
0xcd9: Stack[-3] = Stack[-1]
0xcda: Call2 0xd57

0xcdb: Stack[-2] = Stack[-4]
0xcdc: Pop(2)
0xcdd: Return(); Pop(0)

0xcde: Stack[-2] = (bool) 0
0xcdf: Return(); Pop(0)

0xce0: PushEmpty(object, cvector, cvector, cvector, bool, float, int, object, cvector, cvector, cvector, bool, float, int)
0xce1: @ GetMainOutdoorScene(Stack[-7])
0xce2: Pop(0)
0xce3: @ GetPosition(Stack[-6])
0xce4: Pop(0)
0xce5: Stack[-2] = (int) 4000000
0xce6: Stack[-1] = (int) 0
0xce7: Push(GlobalVars[1])
0xce8: Stack[-1] = (int) 0
0xce9: GlobalVars[1] = Stack[-1]; Pop(1)
0xcea: Push((bool) 1)
0xceb: IF (Stack[-1] == 0) GOTO 0xcfd; Pop(1)

0xcec: PushEmpty(string)
0xced: Call2 0xddf

0xcee: Pop(0)
0xcef: Push(GlobalVars[1])
0xcf0: Push((int) 1)
0xcf1: Pop(2); Push(Stack[-2] + Stack[-1]);
0xcf2: Pop(2); Push(Stack[-2] + Stack[-1]);
0xcf3: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xcf4: Pop(1)
0xcf5: Pop(0); Push((bool) Stack[-3] == 0)
0xcf6: IF (Stack[-1] == 0) GOTO 0xcf8; Pop(1)

0xcf7: GOTO 0xcfd

0xcf8: Push(GlobalVars[1])
0xcf9: Push((int) 1)
0xcfa: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xcfb: GlobalVars[1] = Stack[-1]; Pop(1)
0xcfc: GOTO 0xcea

0xcfd: Push("Pantrol point count: ") // @poff=967
0xcfe: Push(GlobalVars[1])
0xcff: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd00: @ Trace(Stack[-1])
0xd01: Pop(1)
0xd02: Stack[-15] = (bool) 1
0xd03: Return(); Pop(14)

0xd04: Stack[-7] = 0
0xd05: PushEmpty()
0xd06: Push(GlobalVars[2])
0xd07: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd08: IF (Stack[-1] == 0) GOTO 0xd0b; Pop(1)

0xd09: Stack[-2] = (bool) 0
0xd0a: Return(); Pop(0)

0xd0b: Push((int) 0)
0xd0c: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd0d: IF (Stack[-1] == 0) GOTO 0xd17; Pop(1)

0xd0e: Push(GlobalVars[3])
0xd0f: Push(GlobalVars[2])
0xd10: Stack[-1] = Stack[-2]
0xd11: Pop(1)
0xd12: GlobalVars[3] = Stack[-1]; Pop(1)
0xd13: Push("changing state to c_iStateWaitForLoad") // @poff=1011
0xd14: @ Trace(Stack[-1])
0xd15: Pop(1)
0xd16: GOTO 0xd2e
...
0xd19: IF (Stack[-1] == 0) GOTO 0xd1e; Pop(1)

0xd1a: Push("changing state to c_iStateHeatHands") // @poff=1087
0xd1b: @ Trace(Stack[-1])
0xd1c: Pop(1)
0xd1d: GOTO 0xd2e
...
0xd21: Push("changing state to c_iStateIdle") // @poff=1159
0xd22: @ Trace(Stack[-1])
0xd23: Pop(1)
0xd24: GOTO 0xd2e
...
0xd28: Push("changing state to c_iStatePatrol") // @poff=1221
0xd29: @ Trace(Stack[-1])
0xd2a: Pop(1)
0xd2b: GOTO 0xd2e
...
0xd2e: Push(GlobalVars[2])
0xd2f: Stack[-2] = Stack[-1]
0xd30: GlobalVars[2] = Stack[-1]; Pop(1)
0xd31: Stack[-2] = (bool) 1
0xd32: Return(); Pop(0)

0xd33: PushEmpty()
0xd34: Push(GlobalVars[2])
0xd35: Push((int) 4)
0xd36: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd37: IF (Stack[-1] == 0) GOTO 0xd3a; Pop(1)

0xd38: Stack[-2] = (bool) 0
0xd39: Return(); Pop(0)

0xd3a: Push(GlobalVars[2])
0xd3b: Stack[-1] = (int) 4
0xd3c: GlobalVars[2] = Stack[-1]; Pop(1)
0xd3d: Push("changing state to c_iStateAware") // @poff=1287
0xd3e: @ Trace(Stack[-1])
0xd3f: Pop(1)
0xd40: Push(GlobalVars[4])
0xd41: Stack[-2] = Stack[-1]
0xd42: GlobalVars[4] = Stack[-1]; Pop(1)
0xd43: Stack[-2] = (bool) 1
0xd44: Return(); Pop(0)

0xd45: PushEmpty()
0xd46: Push(GlobalVars[2])
0xd47: Push((int) 5)
0xd48: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd49: IF (Stack[-1] == 0) GOTO 0xd4c; Pop(1)

0xd4a: Stack[-2] = (bool) 0
0xd4b: Return(); Pop(0)

0xd4c: Push(GlobalVars[2])
0xd4d: Stack[-1] = (int) 5
0xd4e: GlobalVars[2] = Stack[-1]; Pop(1)
0xd4f: Push("changing state to c_iStateSearchEnemy") // @poff=1351
0xd50: @ Trace(Stack[-1])
0xd51: Pop(1)
0xd52: Push(GlobalVars[5])
0xd53: Stack[-2] = Stack[-1]
0xd54: GlobalVars[5] = Stack[-1]; Pop(1)
0xd55: Stack[-2] = (bool) 1
0xd56: Return(); Pop(0)

0xd57: PushEmpty()
0xd58: Push(GlobalVars[2])
0xd59: Push((int) 6)
0xd5a: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd5b: IF (Stack[-1] == 0) GOTO 0xd5e; Pop(1)

0xd5c: Stack[-2] = (bool) 0
0xd5d: Return(); Pop(0)

0xd5e: Push(GlobalVars[2])
0xd5f: Stack[-1] = (int) 6
0xd60: GlobalVars[2] = Stack[-1]; Pop(1)
0xd61: Push("changing state to c_iStateHearEnemy") // @poff=1427
0xd62: @ Trace(Stack[-1])
0xd63: Pop(1)
0xd64: Push(GlobalVars[6])
0xd65: Stack[-2] = Stack[-1]
0xd66: GlobalVars[6] = Stack[-1]; Pop(1)
0xd67: Stack[-2] = (bool) 1
0xd68: Return(); Pop(0)

0xd69: PushEmpty()
0xd6a: Push(GlobalVars[2])
0xd6b: Push((int) 7)
...
0xd70: Push(GlobalVars[2])
0xd71: Stack[-1] = (int) 7
0xd72: GlobalVars[2] = Stack[-1]; Pop(1)
0xd73: Push("changing state to c_iStateAttack") // @poff=1499
0xd74: @ Trace(Stack[-1])
0xd75: Pop(1)
0xd76: Push(GlobalVars[7])
0xd77: Stack[-2] = Stack[-1]
0xd78: GlobalVars[7] = Stack[-1]; Pop(1)
0xd79: Stack[-2] = (bool) 1
0xd7a: Return(); Pop(0)

0xd7b: PushEmpty(int, int)
0xd7c: PushEmpty(string)
0xd7d: Call2 0xde5

0xd7e: Pop(0)
0xd7f: Push("_locked") // @poff=1565
0xd80: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd81: @ GetVariable(Stack[-1], Stack[-2])
0xd82: Pop(1)
0xd83: Push((int) 0)
0xd84: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0xd85: Return(); Pop(2)
...
0xd89: Pop(0)
0xd8a: Push("_locked") // @poff=1565
0xd8b: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd8c: Push(Stack[-2])
...
0xd97: Pop(0)
0xd98: Push("_locked") // @poff=1565
0xd99: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd9a: @ GetVariable(Stack[-1], Stack[-2])
0xd9b: Pop(1)
0xd9c: PushEmpty(int)
0xd9d: Call2 0xde7
...
0xda1: PushEmpty(int, int)
0xda2: PushEmpty(string)
0xda3: Call2 0xddf

0xda4: Pop(0)
0xda5: Push("_locked") // @poff=1565
0xda6: Pop(2); Push(Stack[-2] + Stack[-1]);
0xda7: @ GetVariable(Stack[-1], Stack[-2])
0xda8: Pop(1)
0xda9: Push(Stack[-3])
0xdaa: IF (Stack[-1] == 0) GOTO 0xdae; Pop(1)

0xdab: Push((int) 1)
0xdac: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdad: GOTO 0xdb0

0xdae: Push((int) -1)
0xdaf: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdb0: PushEmpty(string)
0xdb1: Call2 0xddf

0xdb2: Pop(0)
0xdb3: Push("_locked") // @poff=1565
0xdb4: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdb5: @ SetVariable(Stack[-1], Stack[-2])
0xdb6: Pop(1)
0xdb7: Return(); Pop(2)

0xdb8: PushEmpty()
0xdb9: PushEmpty(object, int, float)
0xdba: Stack[-7] = Stack[-3]
0xdbb: Stack[-6] = Stack[-2]
0xdbc: Stack[-5] = Stack[-1]
0xdbd: Call2 0xb52
...
0xdc0: PushEmpty()
0xdc1: PushEmpty(object, int, float, cvector, cvector)
0xdc2: Stack[-11] = Stack[-5]
0xdc3: Stack[-10] = Stack[-4]
0xdc4: Stack[-9] = Stack[-3]
0xdc5: Stack[-7] = Stack[-2]
...
0xdca: PushEmpty(float, float)
0xdcb: Push("health") // @poff=700
0xdcc: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xdcd: IF (Stack[-1] == 0) GOTO 0xdd6; Pop(1)

0xdce: Push("health") // @poff=700
0xdcf: @ GetProperty(Stack[-1], Stack[-2])
0xdd0: Pop(1)
0xdd1: Push((int) 0)
0xdd2: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xdd3: IF (Stack[-1] == 0) GOTO 0xdd6; Pop(1)

0xdd4: @ SignalDeath(Stack[-4])
0xdd5: Pop(0)
0xdd6: Return(); Pop(2)

0xdd7: PushEmpty()
0xdd8: PushEmpty(object)
0xdd9: Stack[-2] = Stack[-1]
0xdda: Push(-1, 0); TaskCall(8)
0xddb: Call2 0x99e

0xddc: Pop(-1, 0); TaskReturn
0xddd: Pop(1)
0xdde: Return(); Pop(0)

0xddf: Stack[-1] = "pt_d7q04_patrol" // @poff=1581
0xde0: Return(); Pop(0)

0xde1: Stack[-1] = "d7q04_helpme" // @poff=1613
0xde2: Return(); Pop(0)

0xde3: Stack[-1] = "d7q04_corpse" // @poff=1639
0xde4: Return(); Pop(0)

0xde5: Stack[-1] = "pt_d7q04_bonfire" // @poff=1665
0xde6: Return(); Pop(0)

0xde7: Stack[-1] = (int) 3
0xde8: Return(); Pop(0)

0xde9: PushEmpty(object, float, float, bool, object, float, float, bool)
0xdea: @ CreateInvItem(Stack[-4])
0xdeb: Pop(0)
0xdec: Push((int) 40)
0xded: Push((int) 80)
0xdee: @ rand(Stack[-5], Stack[-2], Stack[-1])
0xdef: Pop(2)
0xdf0: Push((int) 5)
0xdf1: Push((int) 20)
0xdf2: @ rand(Stack[-4], Stack[-2], Stack[-1])
0xdf3: Pop(2)
0xdf4: Push("grass_combination") // @poff=1699
0xdf5: @@ SetItemName(Stack[-1]); Obj=5 // @poff=1735
0xdf6: Pop(1)
0xdf7: Push("im_inc") // @poff=1747
0xdf8: Push((float)100.0)
0xdf9: Pop(1); Push(Stack[-5] / Stack[-1]);
0xdfa: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=752
0xdfb: Pop(2)
0xdfc: Push("hl_inc") // @poff=1761
0xdfd: Push((float)100.0)
0xdfe: Pop(1); Push(Stack[-4] / Stack[-1]);
0xdff: Pop(1); Push(( -Stack[-1])
0xe00: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=752
0xe01: Pop(2)
0xe02: Push((int) 0)
0xe03: Push((int) 1)
0xe04: @ AddItem(Stack[-3], Stack[-6], Stack[-2], Stack[-1])
0xe05: Pop(2)
0xe06: Return(); Pop(8)
