...
// @pool_raw:
// @pool_encoding:utf8
...
0x1bd: Stack[-1] = "Neutral" // @poff=89
0x1be: Call2 0xad

0x1bf: Pop(1)
0x1c0: Push((int) 513445)
0x1c1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x1c2: Pop(1)
0x1c3: @@@ ClearReplies(); Obj=0 // @poff=116
0x1c4: Pop(0)
...
0x2bf: @@ GetPosition(Stack[-8]); Obj=20 // @poff=188
0x2c0: Pop(0)
0x2c1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=200
0x2c2: Pop(0)
...
0x32c: Push("voice_common") // @poff=224
0x32d: Push((int) 1)
...
0x334: Push("voice_common") // @poff=224
0x335: Push((int) 0)
...
0x347: Push("voice_common") // @poff=224
0x348: Push((int) 1)
...
0x355: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x356: Pop(1)
...
0x380: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x381: Pop(1)
...
0x395: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=266
0x396: Pop(1)
0x397: PushEmpty(bool, string)
0x398: Stack[-3] = Stack[-1]
0x399: Call2 0x3aa

0x39a: Stack[-2] = Stack[-14]
0x39b: Pop(2)
0x39c: Return(); Pop(10)
...
0x3d7: Pop(0)
0x3d8: @@ add(Stack[-4]); Obj=1 // @poff=282
0x3d9: Pop(0)
0x3da: @@ add(Stack[-3]); Obj=1 // @poff=282
0x3db: Pop(0)
0x3dc: Push((int) 3)
...
0x3e2: @@ GetItemID(Stack[-3]); Obj=8 // @poff=286
0x3e3: Pop(0)
0x3e4: Push("Category") // @poff=296
0x3e5: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x3e6: Pop(1)
0x3e7: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=314
0x3e8: Pop(0)
0x3e9: Pop(0); Push((bool) Stack[-1] == 0)
0x3ea: IF (Stack[-1] == 0) GOTO 0x3ee; Pop(1)

0x3eb: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=322
0x3ec: Pop(0)
0x3ed: GOTO 0x3f3

0x3ee: PushEmpty(int, int)
0x3ef: Stack[-5] = Stack[-2]
0x3f0: Stack[-9] = Stack[-1]
0x3f1: Call2 0x3d5
...
0x3f6: Pop(0)
0x3f7: @@ SetItemName(Stack[-4]); Obj=1 // @poff=332
0x3f8: Pop(0)
0x3f9: PushEmpty(object, object, int)
0x3fa: Stack[-8] = Stack[-3]
0x3fb: Stack[-4] = Stack[-2]
0x3fc: Stack[-6] = Stack[-1]
0x3fd: Call2 0x3e1
...
0x40a: PushEmpty()
0x40b: Push("playsound") // @poff=344
0x40c: Push("giveitem") // @poff=364
0x40d: @ TriggerWorld(Stack[-2], Stack[-1])
0x40e: Pop(2)
0x40f: Return(); Pop(0)

0x410: PushEmpty()
0x411: Push("d8q03") // @poff=382
0x412: Push((int) 1)
...
0x422: PushEmpty()
0x423: Push("burah gives blood") // @poff=394
0x424: @ Trace(Stack[-1])
0x425: Pop(1)
0x426: PushEmpty(object, string, int)
0x427: Stack[-5] = Stack[-3]
0x428: Stack[-2] = "d8q03_blood" // @poff=430
0x429: Stack[-1] = (int) 1
0x42a: Call2 0x3f4
...
0x436: PushEmpty()
0x437: Push("burah gives serum") // @poff=454
0x438: @ Trace(Stack[-1])
0x439: Pop(1)
0x43a: PushEmpty(object, string, int)
0x43b: Stack[-5] = Stack[-3]
0x43c: Stack[-2] = "burah_serum" // @poff=490
0x43d: Stack[-1] = (int) 1
0x43e: Call2 0x3f4
...
0x441: PushEmpty()
0x442: Push("ood8Burah1") // @poff=514
0x443: Push((int) 1)
...
0x455: Stack[-1] = "microscope_d8q03_blood" // @poff=536
0x456: Call2 0x3d0
...
0x46d: Stack[-1] = "ood8Burah1" // @poff=514
0x46e: Call2 0x3d0
...
0x4a3: Push("Can't retrieve diary root") // @poff=582
0x4a4: @ Trace(Stack[-1])
0x4a5: Pop(1)
...
0x4af: Pop(1)
0x4b0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=634
0x4b1: Pop(0)
0x4b2: Pop(0); Push((bool) Stack[-2] == 0)
0x4b3: IF (Stack[-1] == 0) GOTO 0x4ba; Pop(1)

0x4b4: Push("Can't find diary parent with id: ") // @poff=639
...
0x4ba: @@ AddChild(Stack[-8]); Obj=2 // @poff=707
0x4bb: Pop(0)
0x4bc: Push((int) 7)
0x4bd: @ SendWorldWndMessage(Stack[-1])
0x4be: Pop(1)
0x4bf: @@ GetCategory(Stack[-1]); Obj=8 // @poff=716
0x4c0: Pop(0)
...
0x4dc: Stack[-1] = "ui/NPC_Burah.png" // @poff=742
0x4dd: Return(); Pop(0)

0x4de: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=776
0x4df: Return(); Pop(0)
