...
Strings:
	...
	W:death
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x959 Vars = (object, int, float, float)
EVENT_43 Op = 0x961 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x96b Vars = (object, string)
EVENT_41 Op = 0x978 Vars = (object)
EVENT_6 Op = 0x983 Vars = ()
...
0x192: Stack[-2] = "quest_d8_04" // @poff=156
0x193: Stack[-1] = "attack" // @poff=180
0x194: Call2 0x884
...
0x19d: Stack[-2] = "quest_d8_04" // @poff=156
0x19e: Stack[-1] = "attack" // @poff=180
0x19f: Call2 0x884
...
0x241: PushEmpty()
0x242: Stack[-3] = (float) 0.10000000149011612
0x243: Return(); Pop(0)
...
0x25c: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x25d: Pop(0)
0x25e: Push(Stack[-8])
0x25f: IF (Stack[-1] == 0) GOTO 0x268; Pop(1)

0x260: Push("attack") // @poff=180
...
0x27c: Pop(0)
0x27d: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=250
0x27e: Pop(0)
...
0x298: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=250
0x299: Pop(0)
...
0x2cc: IF (Stack[-1] == 1) GOTO 0x2d2; Pop(1)
...
0x2d3: @ Face(Stack[-0]T)
0x2d4: Pop(0)
0x2d5: PushEmpty()
0x2d6: Call2 0x4d0

0x2d7: Pop(0)
0x2d8: Push("all") // @poff=138
0x2d9: Push("attack_stay") // @poff=284
...
0x2e3: @ Face(Stack[-0]T)
0x2e4: Pop(0)
0x2e5: Push("all") // @poff=138
0x2e6: Push("fjump") // @poff=308
...
0x301: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=250
0x302: Pop(0)
...
0x320: Push("all") // @poff=138
0x321: Push("attack_off") // @poff=320
...
0x32f: Push("attack_begin") // @poff=342
0x330: Push((int) 1)
0x331: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x33c: Push("attack") // @poff=180
0x33d: Push((int) 1)
0x33e: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x348: Push("all") // @poff=138
0x349: Push("bjump") // @poff=368
...
0x350: Push((float)0.8999999761581421)
0x351: Pop(1); Push(Stack[-9] * Stack[-1]);
0x352: @ GetVictim(Stack[-1], Stack[-4])
0x353: Pop(1)
0x354: @ ReportAttack(Stack[-0]T)
0x355: Pop(0)
...
0x35a: Stack[-10] = Stack[-1]
0x35b: Call2 0x241

0x35c: Stack[-3] = Stack[-5]
0x35d: Pop(3)
0x35e: PushEmpty(float, object, float, int)
0x35f: Stack[-7] = Stack[-3]
0x360: Stack[-6] = Stack[-2]
0x361: PushEmpty(int, object, int)
0x362: Stack[-10] = Stack[-2]
0x363: Stack[-14] = Stack[-1]
0x364: Call2 0x244

0x365: Stack[-3] = Stack[-4]
0x366: Pop(3)
0x367: Call2 0x69e

0x368: Stack[-4] = Stack[-5]
0x369: Pop(4)
0x36a: PushEmpty(int)
0x36b: Call2 0x4ce

0x36c: Pop(0)
0x36d: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x36e: Pop(1)
0x36f: PushEmpty(object, float)
0x370: Stack[-5] = Stack[-2]
...
0x379: Pop(0)
0x37a: @ irand(Stack[-4], Stack[-1]T)
0x37b: Pop(0)
0x37c: Push((int) 1)
0x37d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x37e: @ Face(Stack[-0]T)
0x37f: Pop(0)
0x380: Push((bool) 1)
...
0x385: Pop(0)
0x386: Push("all") // @poff=138
0x387: Push("attack_begin") // @poff=342
...
0x39b: Stack[-11] = Stack[-2]
0x39c: Stack[-6] = Stack[-1]
0x39d: Call2 0x34f

0x39e: Pop(2)
0x39f: Push("all") // @poff=138
0x3a0: Push("attack_middle") // @poff=380
...
0x3aa: Push("attack_middle") // @poff=380
...
0x3bf: Stack[-6] = Stack[-1]
0x3c0: Call2 0x34f

0x3c1: Pop(2)
0x3c2: Stack[-2] = (int) 1
0x3c3: Push("attack_middle") // @poff=380
0x3c4: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3c5: Push("_") // @poff=408
...
0x3e4: Stack[-11] = Stack[-2]
0x3e5: Stack[-6] = Stack[-1]
0x3e6: Call2 0x34f
...
0x3ef: Push("attack_end") // @poff=412
...
0x42e: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=250
0x42f: Pop(0)
...
0x47a: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x47b: Pop(1)
...
0x47f: @ Face(Stack[-0]T)
0x480: Pop(0)
0x481: Push("all") // @poff=138
0x482: Push("bjump") // @poff=368
0x483: @ PlayAnimation(Stack[-2], Stack[-1])
0x484: Pop(2)
0x485: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=250
0x486: Pop(0)
...
0x4bc: @ irand(Stack[-1], Stack[-2]T)
0x4bd: Pop(0)
0x4be: Push((int) 1)
0x4bf: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x4c0: Push("attack") // @poff=180
...
0x4d1: Stack[-1] = "attack_stay" // @poff=284
0x4d2: Call2 0x82a
...
0x4fc: Stack[-15] = Stack[-5]
0x4fd: Stack[-14] = Stack[-4]
0x4fe: Stack[-13] = Stack[-3]
0x4ff: Stack[-12] = Stack[-2]
0x500: Stack[-11] = Stack[-1]
0x501: Call2 0x546

0x502: Stack[-6] = Stack[-7]
0x503: Pop(6)
0x504: Push( Stack[2 + Tasks[-1].StackPointer] )
0x505: IF (Stack[-1] == 0) GOTO 0x509; Pop(1)

0x506: Push("head") // @poff=470
...
0x549: Stack[-17] = Stack[-7]
0x54a: PushEmpty(bool, object)
0x54b: Stack[-23] = Stack[-1]
0x54c: Call2 0x5d2
...
0x552: @@ GetPosition(Stack[-5]); Obj=21 // @poff=480
0x553: Pop(0)
...
0x569: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=250
0x56a: Pop(0)
...
0x57b: Push((int) 0)
0x57c: Push((float)0.30000001192092896)
...
0x5d6: Stack[-2] = Stack[-4]
0x5d7: Pop(2)
0x5d8: Return(); Pop(0)

0x5d9: Stack[-1] = "walk" // @poff=492
0x5da: Return(); Pop(0)

0x5db: Stack[-1] = "run" // @poff=502
0x5dc: Return(); Pop(0)
...
0x5f7: Pop(0); PushNull((bool) Stack[-21] == 0)
0x5f8: IF (Stack[-1] == 0) GOTO 0x5fe; Pop(1)

0x5f9: PushEmpty(string)
0x5fa: Stack[-1] = "fdie" // @poff=510
0x5fb: Call2 0x651

0x5fc: Pop(1)
0x5fd: GOTO 0x650

0x5fe: @@ GetPosition(Stack[-10]); Obj=21 // @poff=480
0x5ff: Pop(0)
...
0x60f: Stack[-6] = "fdie" // @poff=510
0x610: GOTO 0x612

0x611: Stack[-6] = "bdie" // @poff=520
...
0x618: @ StopAsync()
0x619: Pop(0)
0x61a: Stack[-21] = Stack[-5]
0x61b: Push("GetScriptProperty") // @poff=530
0x61c: Push((int) 2)
0x61d: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x61e: IF (Stack[-1] == 0) GOTO 0x62a; Pop(1)

0x61f: Push("Owner") // @poff=566
0x620: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=578
0x621: Pop(1)
0x622: Push(Stack[-4])
0x623: IF (Stack[-1] == 0) GOTO 0x62a; Pop(1)

0x624: Push("Owner") // @poff=566
0x625: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=596
0x626: Pop(1)
0x627: Pop(0); PushNull((bool) Stack[-5] == 0)
0x628: IF (Stack[-1] == 0) GOTO 0x62a; Pop(1)

0x629: Stack[-21] = Stack[-5]
0x62a: Push("@GetEyesHeight") // @poff=614
0x62b: Push((int) 1)
0x62c: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x62d: IF (Stack[-1] == 0) GOTO 0x639; Pop(1)

0x62e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=644
0x62f: Pop(0)
0x630: Stack[-1] = [0.0, 0.0, 0.0]
0x631: Push(CvectorIndex(Stack[-1], 1))
0x632: Stack[-3] = Stack[-1]
0x633: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x634: Push("head") // @poff=470
...
0x63b: Stack[-7] = Stack[-1]
0x63c: Call2 0x82a

0x63d: Pop(1)
0x63e: Push("all") // @poff=138
...
0x645: @ StopAsync()
0x646: Pop(0)
0x647: Push("head") // @poff=470
0x648: @ UnlookAsync(Stack[-1])
0x649: Pop(1)
0x64a: Push("all") // @poff=138
...
0x65d: Stack[-2] = Stack[-1]
0x65e: Call2 0x82a

0x65f: Pop(1)
0x660: Push("all") // @poff=138
0x661: @ PlayAnimation(Stack[-1], Stack[-2])
0x662: Pop(1)
0x663: @ WaitForAnimEnd()
0x664: Pop(0)
0x665: Push("all") // @poff=138
...
0x693: Push("HasProperty") // @poff=706
0x694: Push((int) 2)
...
0x69a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=730
0x69b: Pop(0)
0x69c: Stack[-1] = Stack[-5]
0x69d: Return(); Pop(2)

0x69e: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x69f: PushEmpty(bool, object, string)
0x6a0: Stack[-18] = Stack[-2]
0x6a1: Stack[-1] = "health" // @poff=742
0x6a2: Call2 0x692
...
0x6a9: Stack[-18] = Stack[-2]
0x6aa: Stack[-1] = "armor" // @poff=756
0x6ab: Call2 0x692
...
0x6b1: Push("armor") // @poff=756
0x6b2: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=768
0x6b3: Pop(1)
0x6b4: Push("armor_") // @poff=780
0x6b5: PushEmpty(string, int)
0x6b6: Stack[-16] = Stack[-1]
0x6b7: Call2 0x671

0x6b8: Pop(1)
0x6b9: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6ba: PushEmpty(bool, object, string)
0x6bb: Stack[-18] = Stack[-2]
0x6bc: Stack[-8] = Stack[-1]
0x6bd: Call2 0x692
...
0x6c3: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=768
0x6c4: Pop(0)
...
0x6cb: Stack[-3] = Stack[-6]
0x6cc: Pop(3)
0x6cd: Push("health") // @poff=742
0x6ce: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=768
0x6cf: Pop(1)
0x6d0: Push((int) 1)
0x6d1: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6d2: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6d3: Push("health") // @poff=742
...
0x6d9: Pop(3)
0x6da: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=794
0x6db: Pop(2)
0x6dc: PushEmpty(bool, object)
0x6dd: Stack[-17] = Stack[-1]
0x6de: Call2 0x68d
...
0x6e4: Pop(1)
0x6e5: Stack[-1] = Stack[-16]
0x6e6: Return(); Pop(12)

0x6e7: PushEmpty(bool, bool)
0x6e8: @@ IsDead(Stack[-1]); Obj=3 // @poff=806
0x6e9: Pop(0)
0x6ea: Stack[-1] = Stack[-4]
0x6eb: Return(); Pop(2)

0x6ec: PushEmpty(object, object, object, object)
0x6ed: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x701: Pop(0)
0x702: Pop(0); PushNull((bool) Stack[-2] == 0)
0x703: IF (Stack[-1] == 0) GOTO 0x706; Pop(1)

0x704: Stack[-6] = (bool) 0
0x705: Return(); Pop(4)

0x706: @@ GetScene(Stack[-1]); Obj=5 // @poff=827
0x707: Pop(0)
...
0x71a: Stack[-6] = Stack[-2]
0x71b: Stack[-1] = "noaccess" // @poff=836
0x71c: Call2 0x692
...
0x722: Push("noaccess") // @poff=836
0x723: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=768
0x724: Pop(1)
0x725: Push((int) 0)
...
0x729: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x737: @@ GetPosition(Stack[-5]); Obj=15 // @poff=480
0x738: Pop(0)
...
0x748: Stack[-1] = "fhit" // @poff=854
0x749: GOTO 0x74b

0x74a: Stack[-1] = "bhit" // @poff=864
0x74b: Push("hit_react") // @poff=874
0x74c: Push("1") // @poff=894
0x74d: Pop(1); Push(Stack[-3] + Stack[-1]);
0x74e: Push("2") // @poff=898
...
0x767: Stack[-25] = Stack[-1]
0x768: Call2 0x67f

0x769: Stack[-2] = Stack[-3]
0x76a: Pop(2)
0x76b: Call2 0x859
...
0x786: Pop(0)
0x787: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=911
0x788: Pop(0)
0x789: PushEmpty(object, int, float, cvector, cvector)
0x78a: Stack[-26] = Stack[-5]
0x78b: Stack[-25] = Stack[-4]
0x78c: Stack[-24] = Stack[-3]
0x78d: Stack[-6] = Stack[-2]
...
0x7a7: @@ GetPosition(Stack[-3]); Obj=7 // @poff=480
0x7a8: Pop(0)
...
0x7b7: @@ GetPosition(Stack[-8]); Obj=20 // @poff=480
0x7b8: Pop(0)
0x7b9: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=644
0x7ba: Pop(0)
...
0x7df: @ StopWorld()
0x7e0: Pop(0)
0x7e1: @ CameraTransit(Stack[-3], Stack[-5])
0x7e2: Pop(0)
0x7e3: Push(CvectorIndex(Stack[-4], 0))
0x7e4: Push(CvectorIndex(Stack[-5], 2))
0x7e5: @ Rotate(Stack[-2], Stack[-1])
0x7e6: Pop(2)
...
0x7ec: Push("head") // @poff=470
0x7ed: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7ee: Pop(1)
0x7ef: Push(Stack[-1])
0x7f0: IF (Stack[-1] == 0) GOTO 0x7f4; Pop(1)

0x7f1: Push("head") // @poff=470
0x7f2: @ LookAsyncCamera(Stack[-1])
0x7f3: Pop(1)
0x7f4: @ CameraWaitForPlayFinish()
0x7f5: Pop(0)
0x7f6: @ ResumeWorld()
0x7f7: Pop(0)
0x7f8: Stack[-21] = (bool) 1
0x7f9: Return(); Pop(18)

0x7fa: PushEmpty(bool, bool)
0x7fb: @ CameraSwitchToNormal()
0x7fc: Pop(0)
...
0x802: Push("head") // @poff=470
0x803: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x804: Pop(1)
0x805: Push(Stack[-1])
0x806: IF (Stack[-1] == 0) GOTO 0x80a; Pop(1)

0x807: Push("head") // @poff=470
0x808: @ UnlookAsync(Stack[-1])
0x809: Pop(1)
0x80a: Return(); Pop(2)

0x80b: PushEmpty(float, float, float, float)
0x80c: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x80d: Pop(0)
0x80e: Push((bool) 0)
0x80f: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x810: Pop(1)
0x811: Return(); Pop(4)

0x812: PushEmpty(float, float, float, float)
0x813: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x814: Pop(0)
0x815: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x816: Pop(0)
0x817: Return(); Pop(4)

0x818: PushEmpty(float, cvector, float, cvector)
0x819: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=644
0x81a: Pop(0)
0x81b: Stack[-1] = [0.0, 0.0, 0.0]
0x81c: Push(CvectorIndex(Stack[-1], 1))
0x81d: Stack[-3] = Stack[-1]
0x81e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x81f: Push("head") // @poff=470
0x820: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x821: Pop(1)
0x822: Return(); Pop(4)
...
0x82a: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x82b: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x82c: Pop(0)
0x82d: Pop(0); Push((bool) Stack[-8] == 0)
0x82e: IF (Stack[-1] == 0) GOTO 0x843; Pop(1)

0x82f: Stack[-7] = (int) 0
0x830: Push((int) 1)
0x831: Pop(1); Push(Stack[-8] + Stack[-1]);
0x832: Pop(1); Push(Stack[-18] + Stack[-1]);
0x833: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x834: Pop(1)
0x835: Pop(0); Push((bool) Stack[-6] == 0)
0x836: IF (Stack[-1] == 0) GOTO 0x838; Pop(1)

0x837: GOTO 0x83b

0x838: Push((int) 1)
0x839: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x83a: GOTO 0x830

0x83b: Pop(0); Push((bool) Stack[-7] == 0)
0x83c: IF (Stack[-1] == 0) GOTO 0x83e; Pop(1)

0x83d: Return(); Pop(16)

0x83e: @ irand(Stack[-5], Stack[-7])
0x83f: Pop(0)
0x840: Push((int) 1)
0x841: Pop(1); Push(Stack[-6] + Stack[-1]);
0x842: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x843: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x844: Pop(0)
0x845: Push(Stack[-4])
0x846: IF (Stack[-1] == 0) GOTO 0x852; Pop(1)

0x847: @ GetEyesHeight(Stack[-3])
0x848: Pop(0)
0x849: @ GetDirection(Stack[-2])
0x84a: Pop(0)
0x84b: Push((int) 50)
0x84c: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x84d: Push(CvectorIndex(Stack[-1], 1))
0x84e: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x84f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x850: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x851: Pop(0)
0x852: Return(); Pop(16)
...
0x854: @ self(Stack[-1])
0x855: Pop(0)
0x856: Stack[-1] = Stack[-3]
0x857: Return(); Pop(2)

0x858: Stack[-1] = 0
0x859: PushEmpty(float, float)
0x85a: Pop(0); Push(Stack[-3] | Stack[-3]);
0x85b: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x85c: Push((float)9.999999974752427e-07)
0x85d: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x85e: IF (Stack[-1] == 0) GOTO 0x861; Pop(1)

0x85f: Stack[-4] = [0.0, 0.0, 0.0]
0x860: Return(); Pop(2)

0x861: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x862: Return(); Pop(2)

0x863: PushEmpty()
0x864: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x865: IF (Stack[-1] == 0) GOTO 0x868; Pop(1)

0x866: Stack[-2] = Stack[-3]
0x867: GOTO 0x869

0x868: Stack[-1] = Stack[-3]
0x869: Return(); Pop(0)

0x86a: PushEmpty()
0x86b: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x86c: IF (Stack[-1] == 0) GOTO 0x86f; Pop(1)

0x86d: Stack[-2] = Stack[-4]
0x86e: Return(); Pop(0)

0x86f: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x870: IF (Stack[-1] == 0) GOTO 0x873; Pop(1)

0x871: Stack[-1] = Stack[-4]
0x872: Return(); Pop(0)

0x873: Stack[-3] = Stack[-4]
0x874: Return(); Pop(0)

0x875: PushEmpty(int, int)
0x876: @ GetVariable(Stack[-3], Stack[-1])
0x877: Pop(0)
0x878: Stack[-1] = Stack[-4]
0x879: Return(); Pop(2)

0x87a: PushEmpty(object, object)
0x87b: @ CreateFloatVector(Stack[-1])
0x87c: Pop(0)
0x87d: @@ add(Stack[-3]); Obj=1 // @poff=902
0x87e: Pop(0)
0x87f: Push((int) 15)
...
0x885: @ FindActor(Stack[-1], Stack[-4])
0x886: Pop(0)
0x887: Pop(0); PushNull((bool) Stack[-1] == 0)
0x888: IF (Stack[-1] == 0) GOTO 0x88b; Pop(1)

0x889: Stack[-5] = (bool) 0
0x88a: Return(); Pop(2)

0x88b: @ Trigger(Stack[-1], Stack[-3])
0x88c: Pop(0)
0x88d: Stack[-5] = (bool) 1
0x88e: Return(); Pop(2)

0x88f: Stack[-1] = 0
0x890: PushEmpty(bool, bool)
0x891: @ IsPlayerActor(Stack[-3], Stack[-1])
0x892: Pop(0)
0x893: Push(Stack[-1])
0x894: IF (Stack[-1] == 0) GOTO 0x898; Pop(1)

0x895: Push("attack") // @poff=180
0x896: @ PlayGlobalMusic(Stack[-1])
0x897: Pop(1)
0x898: Return(); Pop(2)

0x899: PushEmpty(object, object)
0x89a: @ GetScene(Stack[-1])
0x89b: Pop(0)
0x89c: Push("battle") // @poff=961
0x89d: PushEmpty(object)
0x89e: Call2 0x853

0x89f: Pop(0)
0x8a0: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x8a1: Pop(2)
0x8a2: Return(); Pop(2)

0x8a3: Stack[-1] = 0
0x8a4: PushEmpty(string, string)
0x8a5: Stack[-1] = "idle" // @poff=146
0x8a6: Push(Stack[-3])
0x8a7: IF (Stack[-1] == 0) GOTO 0x8a9; Pop(1)

0x8a8: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x8a9: Stack[-1] = Stack[-4]
0x8aa: Return(); Pop(2)

0x8ab: PushEmpty(int, bool, int, bool)
0x8ac: Stack[-2] = (int) 0
0x8ad: Push("all") // @poff=138
0x8ae: PushEmpty(string, int)
0x8af: Stack[-5] = Stack[-1]
0x8b0: Call2 0x8a4

0x8b1: Pop(1)
0x8b2: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8b3: Pop(2)
...
0x8b7: Push((int) 1)
0x8b8: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x8b9: GOTO 0x8ad

0x8ba: Stack[-2] = Stack[-5]
0x8bb: Return(); Pop(4)

0x8bc: PushEmpty()
0x8bd: Push((int) 1)
0x8be: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=975
0x8bf: Pop(1)
0x8c0: Return(); Pop(0)

0x8c1: PushEmpty()
0x8c2: Push("d8q04") // @poff=990
0x8c3: Push((int) 2)
0x8c4: @ SetVariable(Stack[-2], Stack[-1])
0x8c5: Pop(2)
0x8c6: PushEmpty()
0x8c7: Call2 0x8ed
...
0x8cd: Pop(0)
0x8ce: PushEmpty(bool, string, string)
0x8cf: Stack[-2] = "quest_d8_04" // @poff=156
0x8d0: Stack[-1] = "fail" // @poff=1002
0x8d1: Call2 0x884
...
0x8d6: Stack[-1] = "d8q04" // @poff=990
0x8d7: Call2 0x875

0x8d8: Pop(1)
0x8d9: Push((int) 1)
0x8da: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x8db: IF (Stack[-1] == 0) GOTO 0x8de; Pop(1)

0x8dc: Stack[-2] = (bool) 1
0x8dd: Return(); Pop(0)

0x8de: Stack[-2] = (bool) 0
0x8df: Return(); Pop(0)

0x8e0: PushEmpty(object, object)
0x8e1: Push((int) 654)
0x8e2: Push((int) 2)
0x8e3: Push((int) 533367)
0x8e4: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8e5: Pop(3)
0x8e6: PushEmpty(bool, object, int)
0x8e7: Stack[-4] = Stack[-2]
0x8e8: Stack[-1] = (int) 649
0x8e9: Call2 0x907
...
0x8ee: Push((int) 651)
0x8ef: Push((int) 2)
0x8f0: Push((int) 533364)
0x8f1: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8f2: Pop(3)
0x8f3: PushEmpty(bool, object, int)
0x8f4: Stack[-4] = Stack[-2]
0x8f5: Stack[-1] = (int) 649
0x8f6: Call2 0x907
...
0x8fb: @ GetDiaryRoot(Stack[-1])
0x8fc: Pop(0)
0x8fd: Pop(0); Push((bool) Stack[-1] == 0)
0x8fe: IF (Stack[-1] == 0) GOTO 0x904; Pop(1)

0x8ff: Push("Can't retrieve diary root") // @poff=1012
0x900: @ Trace(Stack[-1])
0x901: Pop(1)
0x902: Stack[-3] = (bool) 0
0x903: Return(); Pop(2)
...
0x906: Stack[-1] = 0
0x907: PushEmpty(object, object, int, object, object, int)
0x908: PushEmpty(object)
0x909: Call2 0x8fa

0x90a: Stack[-1] = Stack[-4]
0x90b: Pop(1)
0x90c: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1064
0x90d: Pop(0)
0x90e: Pop(0); Push((bool) Stack[-2] == 0)
0x90f: IF (Stack[-1] == 0) GOTO 0x916; Pop(1)

0x910: Push("Can't find diary parent with id: ") // @poff=1069
0x911: Pop(1); Push(Stack[-1] + Stack[-8]);
0x912: @ Trace(Stack[-1])
0x913: Pop(1)
0x914: Stack[-9] = (bool) 0
0x915: Return(); Pop(6)

0x916: @@ AddChild(Stack[-8]); Obj=2 // @poff=1137
0x917: Pop(0)
0x918: Push((int) 7)
0x919: @ SendWorldWndMessage(Stack[-1])
0x91a: Pop(1)
0x91b: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1146
0x91c: Pop(0)
0x91d: @ SetDiarySection(Stack[-1])
0x91e: Pop(0)
0x91f: Stack[-9] = (bool) 0
0x920: Return(); Pop(6)

0x921: Stack[-2] = 0
0x922: Stack[-3] = 0
0x923: PushEmpty(int, int)
0x924: Push("branch") // @poff=1158
0x925: @ GetVariable(Stack[-1], Stack[-2])
0x926: Pop(1)
0x927: Push((int) 0)
...
0x934: PushEmpty(int, int)
0x935: Push("branch") // @poff=1158
0x936: @ GetVariable(Stack[-1], Stack[-2])
0x937: Pop(1)
0x938: Stack[-1] = Stack[-3]
0x939: Return(); Pop(2)
...
0x941: @ WorkWithCorpse(Stack[-1])
0x942: Pop(0)
0x943: GOTO 0x946

0x944: @ Barter(Stack[-1])
0x945: Pop(0)
0x946: Return(); Pop(0)

0x947: Stack[-1] = (int) 521048
0x948: Return(); Pop(0)

0x949: Stack[-1] = (int) 521047
0x94a: Return(); Pop(0)

0x94b: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1172
0x94c: Return(); Pop(0)

0x94d: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1212
0x94e: Return(); Pop(0)
...
0x951: PushEmpty()
0x952: PushEmpty(object)
0x953: Stack[-2] = Stack[-1]
0x954: Push(-1, 0); TaskCall(5)
0x955: Call2 0x5dd

0x956: Pop(-1, 0); TaskReturn
0x957: Pop(1)
0x958: Return(); Pop(0)

0x959: PushEmpty()
0x95a: PushEmpty(object, int, float)
0x95b: Stack[-7] = Stack[-3]
0x95c: Stack[-6] = Stack[-2]
0x95d: Stack[-5] = Stack[-1]
0x95e: Call2 0x754
...
0x961: PushEmpty()
0x962: PushEmpty(object, int, float, cvector, cvector)
0x963: Stack[-11] = Stack[-5]
0x964: Stack[-10] = Stack[-4]
0x965: Stack[-9] = Stack[-3]
0x966: Stack[-7] = Stack[-2]
0x967: Stack[-6] = Stack[-1]
0x968: Call2 0x798
...
0x96c: Push("health") // @poff=742
0x96d: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x96e: IF (Stack[-1] == 0) GOTO 0x977; Pop(1)

0x96f: Push("health") // @poff=742
0x970: @ GetProperty(Stack[-1], Stack[-2])
0x971: Pop(1)
0x972: Push((int) 0)
0x973: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x974: IF (Stack[-1] == 0) GOTO 0x977; Pop(1)

0x975: @ SignalDeath(Stack[-4])
0x976: Pop(0)
0x977: Return(); Pop(2)

0x978: PushEmpty()
0x979: PushEmpty(bool, string, string)
0x97a: Stack[-2] = "quest_d8_04" // @poff=156
0x97b: Stack[-1] = "death" // @poff=1256
0x97c: Call2 0x884

0x97d: Pop(3)
0x97e: PushEmpty(object)
0x97f: Stack[-2] = Stack[-1]
0x980: Call2 0x951
