...
Events:
EVENT_26 Op = 0xc97 Vars = (string)
EVENT_22 Op = 0xe02 Vars = (object, int, float, float)
EVENT_43 Op = 0xe0a Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xe14 Vars = (object, string)
EVENT_41 Op = 0xe21 Vars = (object)
...
0xc53: Pop(0)
0xc54: Push((int) 15)
0xc55: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc56: Pop(1)
0xc57: Return(); Pop(2)

0xc58: Stack[-1] = 0
0xc59: PushEmpty(object, object)
0xc5a: @ CreateFloatVector(Stack[-1])
0xc5b: Pop(0)
0xc5c: @@ add(Stack[-3]); Obj=1 // @poff=874
0xc5d: Pop(0)
0xc5e: Push((int) 16)
0xc5f: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc60: Pop(1)
0xc61: Return(); Pop(2)

0xc62: Stack[-1] = 0
0xc63: PushEmpty(bool, bool)
0xc64: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc65: Pop(0)
0xc66: Push(Stack[-1])
0xc67: IF (Stack[-1] == 0) GOTO 0xc6b; Pop(1)

0xc68: Push("attack") // @poff=186
0xc69: @ PlayGlobalMusic(Stack[-1])
0xc6a: Pop(1)
0xc6b: Return(); Pop(2)

0xc6c: PushEmpty(string, string)
0xc6d: Stack[-1] = "idle" // @poff=955
0xc6e: Push(Stack[-3])
0xc6f: IF (Stack[-1] == 0) GOTO 0xc71; Pop(1)

0xc70: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xc71: Stack[-1] = Stack[-4]
0xc72: Return(); Pop(2)

0xc73: PushEmpty(int, bool, int, bool)
0xc74: Stack[-2] = (int) 0
0xc75: Push("all") // @poff=214
0xc76: PushEmpty(string, int)
0xc77: Stack[-5] = Stack[-1]
0xc78: Call2 0xc6c

0xc79: Pop(1)
0xc7a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xc7b: Pop(2)
0xc7c: Pop(0); Push((bool) Stack[-1] == 0)
0xc7d: IF (Stack[-1] == 0) GOTO 0xc7f; Pop(1)

0xc7e: GOTO 0xc82

0xc7f: Push((int) 1)
0xc80: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xc81: GOTO 0xc75

0xc82: Stack[-2] = Stack[-5]
0xc83: Return(); Pop(4)

0xc84: PushEmpty(int, int)
0xc85: Push("branch") // @poff=965
0xc86: @ GetVariable(Stack[-1], Stack[-2])
0xc87: Pop(1)
0xc88: Stack[-1] = Stack[-3]
0xc89: Return(); Pop(2)
...
0xc8d: Pop(0)
0xc8e: Push((int) 1)
0xc8f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xc90: IF (Stack[-1] == 0) GOTO 0xc94; Pop(1)

0xc91: @ WorkWithCorpse(Stack[-1])
0xc92: Pop(0)
0xc93: GOTO 0xc96

0xc94: @ Barter(Stack[-1])
0xc95: Pop(0)
0xc96: Return(); Pop(0)

0xc97: PushEmpty()
0xc98: Push("cleanup") // @poff=614
0xc99: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc9a: IF (Stack[-1] == 0) GOTO 0xc9e; Pop(1)

0xc9b: Push(GlobalVars[0])
0xc9c: Stack[-1] = (bool) 1
0xc9d: GlobalVars[0] = Stack[-1]; Pop(1)
0xc9e: Return(); Pop(0)

0xc9f: PushEmpty(cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float)
0xca0: PushEmpty(object)
0xca1: Call2 0xc05

0xca2: Pop(0)
0xca3: Pop(1); Push((bool) Stack[-19] == Stack[-1])
0xca4: IF (Stack[-1] == 0) GOTO 0xca7; Pop(1)

0xca5: Stack[-19] = (bool) 0
0xca6: Return(); Pop(16)
...
0xca9: Pop(0)
0xcaa: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xcab: IF (Stack[-1] == 0) GOTO 0xcb4; Pop(1)

0xcac: PushEmpty(bool, object)
0xcad: Stack[-20] = Stack[-1]
0xcae: Call2 0xd8f

0xcaf: Pop(1)
0xcb0: IF (Stack[-1] == 0) GOTO 0xcb3; Pop(1)

0xcb1: Stack[-19] = (bool) 1
0xcb2: Return(); Pop(16)
...
0xcb6: Pop(0)
0xcb7: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xcb8: IF (Stack[-1] == 0) GOTO 0xcca; Pop(1)

0xcb9: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xcba: Pop(0)
0xcbb: @ GetPosition(Stack[-7])
0xcbc: Pop(0)
0xcbd: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0xcbe: Stack[-5] = Stack[-6] | Stack[-6]; Pop(0);
0xcbf: Push((float)4000000.0)
0xcc0: Pop(1); Push((bool) Stack[-6] < Stack[-1])
0xcc1: IF (Stack[-1] == 0) GOTO 0xcc9; Pop(1)

0xcc2: PushEmpty(bool, object)
0xcc3: Stack[-20] = Stack[-1]
0xcc4: Call2 0xdb3

0xcc5: Pop(1)
0xcc6: IF (Stack[-1] == 0) GOTO 0xcc9; Pop(1)

0xcc7: Stack[-19] = (bool) 1
0xcc8: Return(); Pop(16)

0xcc9: GOTO 0xce7

0xcca: Push("player_shot") // @poff=979
0xccb: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xccc: IF (Stack[-1] == 0) GOTO 0xce7; Pop(1)

0xccd: @@ GetPosition(Stack[-4]); Obj=18 // @poff=43
0xcce: Pop(0)
0xccf: @ GetPosition(Stack[-3])
0xcd0: Pop(0)
0xcd1: Stack[-2] = Stack[-4] - Stack[-3]; Pop(0);
0xcd2: Stack[-1] = Stack[-2] | Stack[-2]; Pop(0);
0xcd3: Push((float)360000.0)
0xcd4: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xcd5: IF (Stack[-1] == 0) GOTO 0xcdd; Pop(1)

0xcd6: PushEmpty(bool, object)
0xcd7: Stack[-20] = Stack[-1]
0xcd8: Call2 0xdb3

0xcd9: Pop(1)
0xcda: IF (Stack[-1] == 0) GOTO 0xcdd; Pop(1)

0xcdb: Stack[-19] = (bool) 1
0xcdc: Return(); Pop(16)

0xcdd: Push((float)12250000.0)
0xcde: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xcdf: IF (Stack[-1] == 0) GOTO 0xce7; Pop(1)

0xce0: PushEmpty(bool, object)
0xce1: Stack[-20] = Stack[-1]
0xce2: Call2 0xd8f

0xce3: Pop(1)
0xce4: IF (Stack[-1] == 0) GOTO 0xce7; Pop(1)

0xce5: Stack[-19] = (bool) 1
0xce6: Return(); Pop(16)

0xce7: Stack[-19] = (bool) 0
0xce8: Return(); Pop(16)

0xce9: PushEmpty()
0xcea: PushEmpty(bool)
0xceb: Stack[-1] = (bool) 0
0xcec: Push("IsDead") // @poff=785
0xced: Push((int) 1)
0xcee: Pop(2); Push(IsFuncExist(Stack[-4], Stack[-2], Stack[-1]))
...
0xcf3: Pop(1)
0xcf4: IF (Stack[-1] == 0) GOTO 0xcf6; Pop(1)

0xcf5: Stack[-1] = (bool) 1
0xcf6: IF (Stack[-1] == 0) GOTO 0xd0f; Pop(1)

0xcf7: PushEmpty(bool, object, string)
0xcf8: Stack[-4] = Stack[-2]
...
0xd04: Pop(0)
0xd05: Push((int) 1)
0xd06: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=726
0xd07: Pop(2)
...
0xd17: Stack[-2] = Stack[-4]
0xd18: Pop(2)
0xd19: Return(); Pop(0)

0xd1a: Stack[-2] = (bool) 0
0xd1b: Return(); Pop(0)

0xd1c: PushEmpty()
0xd1d: PushEmpty(bool, object)
0xd1e: Stack[-3] = Stack[-1]
0xd1f: Call2 0xa92
...
0xd25: Stack[-2] = Stack[-4]
0xd26: Pop(2)
0xd27: Return(); Pop(0)

0xd28: Stack[-2] = (bool) 0
0xd29: Return(); Pop(0)

0xd2a: PushEmpty(object, cvector, cvector, cvector, bool, float, int, object, cvector, cvector, cvector, bool, float, int)
0xd2b: @ GetMainOutdoorScene(Stack[-7])
0xd2c: Pop(0)
0xd2d: @ GetPosition(Stack[-6])
0xd2e: Pop(0)
0xd2f: Stack[-2] = (int) 4000000
0xd30: Stack[-1] = (int) 0
0xd31: Push(GlobalVars[1])
0xd32: Stack[-1] = (int) 0
0xd33: GlobalVars[1] = Stack[-1]; Pop(1)
0xd34: Push((bool) 1)
0xd35: IF (Stack[-1] == 0) GOTO 0xd47; Pop(1)

0xd36: PushEmpty(string)
0xd37: Call2 0xe29

0xd38: Pop(0)
0xd39: Push(GlobalVars[1])
0xd3a: Push((int) 1)
0xd3b: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd3c: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd3d: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xd3e: Pop(1)
0xd3f: Pop(0); Push((bool) Stack[-3] == 0)
0xd40: IF (Stack[-1] == 0) GOTO 0xd42; Pop(1)

0xd41: GOTO 0xd47

0xd42: Push(GlobalVars[1])
0xd43: Push((int) 1)
0xd44: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xd45: GlobalVars[1] = Stack[-1]; Pop(1)
0xd46: GOTO 0xd34

0xd47: Push("Pantrol point count: ") // @poff=1003
0xd48: Push(GlobalVars[1])
0xd49: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd4a: @ Trace(Stack[-1])
0xd4b: Pop(1)
0xd4c: Stack[-15] = (bool) 1
0xd4d: Return(); Pop(14)

0xd4e: Stack[-7] = 0
0xd4f: PushEmpty()
0xd50: Push(GlobalVars[2])
...
0xd57: IF (Stack[-1] == 0) GOTO 0xd61; Pop(1)

0xd58: Push(GlobalVars[3])
0xd59: Push(GlobalVars[2])
0xd5a: Stack[-1] = Stack[-2]
0xd5b: Pop(1)
0xd5c: GlobalVars[3] = Stack[-1]; Pop(1)
0xd5d: Push("changing state to c_iStateWaitForLoad") // @poff=1047
0xd5e: @ Trace(Stack[-1])
0xd5f: Pop(1)
0xd60: GOTO 0xd78
...
0xd64: Push("changing state to c_iStateHeatHands") // @poff=1123
0xd65: @ Trace(Stack[-1])
0xd66: Pop(1)
0xd67: GOTO 0xd78
...
0xd6b: Push("changing state to c_iStateIdle") // @poff=1195
0xd6c: @ Trace(Stack[-1])
0xd6d: Pop(1)
0xd6e: GOTO 0xd78
...
0xd72: Push("changing state to c_iStatePatrol") // @poff=1257
0xd73: @ Trace(Stack[-1])
0xd74: Pop(1)
0xd75: GOTO 0xd78
...
0xd78: Push(GlobalVars[2])
0xd79: Stack[-2] = Stack[-1]
0xd7a: GlobalVars[2] = Stack[-1]; Pop(1)
0xd7b: Stack[-2] = (bool) 1
0xd7c: Return(); Pop(0)

0xd7d: PushEmpty()
0xd7e: Push(GlobalVars[2])
0xd7f: Push((int) 4)
0xd80: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd81: IF (Stack[-1] == 0) GOTO 0xd84; Pop(1)

0xd82: Stack[-2] = (bool) 0
0xd83: Return(); Pop(0)

0xd84: Push(GlobalVars[2])
0xd85: Stack[-1] = (int) 4
0xd86: GlobalVars[2] = Stack[-1]; Pop(1)
0xd87: Push("changing state to c_iStateAware") // @poff=1323
0xd88: @ Trace(Stack[-1])
0xd89: Pop(1)
0xd8a: Push(GlobalVars[4])
0xd8b: Stack[-2] = Stack[-1]
0xd8c: GlobalVars[4] = Stack[-1]; Pop(1)
0xd8d: Stack[-2] = (bool) 1
0xd8e: Return(); Pop(0)

0xd8f: PushEmpty()
0xd90: Push(GlobalVars[2])
0xd91: Push((int) 5)
0xd92: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd93: IF (Stack[-1] == 0) GOTO 0xd96; Pop(1)

0xd94: Stack[-2] = (bool) 0
0xd95: Return(); Pop(0)

0xd96: Push(GlobalVars[2])
0xd97: Stack[-1] = (int) 5
0xd98: GlobalVars[2] = Stack[-1]; Pop(1)
0xd99: Push("changing state to c_iStateSearchEnemy") // @poff=1387
0xd9a: @ Trace(Stack[-1])
0xd9b: Pop(1)
0xd9c: Push(GlobalVars[5])
0xd9d: Stack[-2] = Stack[-1]
0xd9e: GlobalVars[5] = Stack[-1]; Pop(1)
0xd9f: Stack[-2] = (bool) 1
0xda0: Return(); Pop(0)

0xda1: PushEmpty()
0xda2: Push(GlobalVars[2])
0xda3: Push((int) 6)
0xda4: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xda5: IF (Stack[-1] == 0) GOTO 0xda8; Pop(1)

0xda6: Stack[-2] = (bool) 0
0xda7: Return(); Pop(0)

0xda8: Push(GlobalVars[2])
0xda9: Stack[-1] = (int) 6
0xdaa: GlobalVars[2] = Stack[-1]; Pop(1)
0xdab: Push("changing state to c_iStateHearEnemy") // @poff=1463
0xdac: @ Trace(Stack[-1])
0xdad: Pop(1)
0xdae: Push(GlobalVars[6])
0xdaf: Stack[-2] = Stack[-1]
0xdb0: GlobalVars[6] = Stack[-1]; Pop(1)
0xdb1: Stack[-2] = (bool) 1
0xdb2: Return(); Pop(0)

0xdb3: PushEmpty()
0xdb4: Push(GlobalVars[2])
0xdb5: Push((int) 7)
0xdb6: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xdb7: IF (Stack[-1] == 0) GOTO 0xdba; Pop(1)

0xdb8: Stack[-2] = (bool) 0
0xdb9: Return(); Pop(0)

0xdba: Push(GlobalVars[2])
0xdbb: Stack[-1] = (int) 7
0xdbc: GlobalVars[2] = Stack[-1]; Pop(1)
0xdbd: Push("changing state to c_iStateAttack") // @poff=1535
0xdbe: @ Trace(Stack[-1])
0xdbf: Pop(1)
0xdc0: Push(GlobalVars[7])
0xdc1: Stack[-2] = Stack[-1]
0xdc2: GlobalVars[7] = Stack[-1]; Pop(1)
0xdc3: Stack[-2] = (bool) 1
0xdc4: Return(); Pop(0)

0xdc5: PushEmpty(int, int)
0xdc6: PushEmpty(string)
0xdc7: Call2 0xe2f

0xdc8: Pop(0)
0xdc9: Push("_locked") // @poff=1601
0xdca: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdcb: @ GetVariable(Stack[-1], Stack[-2])
0xdcc: Pop(1)
0xdcd: Push((int) 0)
0xdce: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0xdcf: Return(); Pop(2)
...
0xdd3: Pop(0)
0xdd4: Push("_locked") // @poff=1601
0xdd5: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdd6: Push(Stack[-2])
0xdd7: IF (Stack[-1] == 0) GOTO 0xdda; Pop(1)
...
0xde1: Pop(0)
0xde2: Push("_locked") // @poff=1601
0xde3: Pop(2); Push(Stack[-2] + Stack[-1]);
0xde4: @ GetVariable(Stack[-1], Stack[-2])
0xde5: Pop(1)
0xde6: PushEmpty(int)
0xde7: Call2 0xe31

0xde8: Pop(0)
0xde9: Stack[-4] = Stack[-2] >= Stack[-1]; Pop(1);
0xdea: Return(); Pop(2)
...
0xdee: Pop(0)
0xdef: Push("_locked") // @poff=1601
0xdf0: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdf1: @ GetVariable(Stack[-1], Stack[-2])
0xdf2: Pop(1)
0xdf3: Push(Stack[-3])
0xdf4: IF (Stack[-1] == 0) GOTO 0xdf8; Pop(1)

0xdf5: Push((int) 1)
0xdf6: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdf7: GOTO 0xdfa

0xdf8: Push((int) -1)
0xdf9: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdfa: PushEmpty(string)
0xdfb: Call2 0xe29

0xdfc: Pop(0)
0xdfd: Push("_locked") // @poff=1601
0xdfe: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdff: @ SetVariable(Stack[-1], Stack[-2])
0xe00: Pop(1)
0xe01: Return(); Pop(2)

0xe02: PushEmpty()
0xe03: PushEmpty(object, int, float)
0xe04: Stack[-7] = Stack[-3]
0xe05: Stack[-6] = Stack[-2]
0xe06: Stack[-5] = Stack[-1]
0xe07: Call2 0xb6f
...
0xe0a: PushEmpty()
0xe0b: PushEmpty(object, int, float, cvector, cvector)
0xe0c: Stack[-11] = Stack[-5]
0xe0d: Stack[-10] = Stack[-4]
0xe0e: Stack[-9] = Stack[-3]
0xe0f: Stack[-7] = Stack[-2]
0xe10: Stack[-6] = Stack[-1]
0xe11: Call2 0xbb3

0xe12: Pop(5)
0xe13: Return(); Pop(0)

0xe14: PushEmpty(float, float)
0xe15: Push("health") // @poff=738
0xe16: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xe17: IF (Stack[-1] == 0) GOTO 0xe20; Pop(1)

0xe18: Push("health") // @poff=738
0xe19: @ GetProperty(Stack[-1], Stack[-2])
0xe1a: Pop(1)
0xe1b: Push((int) 0)
0xe1c: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xe1d: IF (Stack[-1] == 0) GOTO 0xe20; Pop(1)

0xe1e: @ SignalDeath(Stack[-4])
0xe1f: Pop(0)
0xe20: Return(); Pop(2)

0xe21: PushEmpty()
0xe22: PushEmpty(object)
0xe23: Stack[-2] = Stack[-1]
0xe24: Push(-1, 0); TaskCall(8)
0xe25: Call2 0x99e

0xe26: Pop(-1, 0); TaskReturn
0xe27: Pop(1)
0xe28: Return(); Pop(0)

0xe29: Stack[-1] = "pt_d9q02_patrol" // @poff=1617
0xe2a: Return(); Pop(0)

0xe2b: Stack[-1] = "d9q02_helpme" // @poff=1649
0xe2c: Return(); Pop(0)

0xe2d: Stack[-1] = "d9q02_corpse" // @poff=1675
0xe2e: Return(); Pop(0)

0xe2f: Stack[-1] = "pt_d9q02_center" // @poff=1701
0xe30: Return(); Pop(0)

0xe31: Stack[-1] = (int) 2
0xe32: Return(); Pop(0)

0xe33: PushEmpty(bool, int, bool, int)
0xe34: Push((int) 6)
0xe35: @ irand(Stack[-2], Stack[-1])
0xe36: Pop(1)
0xe37: Push("rusk") // @poff=1733
0xe38: Push((int) 0)
0xe39: Push((int) 1)
0xe3a: Pop(1); Push(Stack[-4] + Stack[-1]);
0xe3b: @ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0xe3c: Pop(3)
0xe3d: PushEmpty(bool, object, float)
0xe3e: PushEmpty(object)
0xe3f: Call2 0xa8b

0xe40: Stack[-1] = Stack[-3]
0xe41: Pop(1)
0xe42: Stack[-1] = (float) -0.029999999329447746
0xe43: Call2 0xc2c
