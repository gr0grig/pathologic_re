...
Strings:
	...
	W:k10q01
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x13c: Push("player") // @poff=156
0x13d: @ FindActor(Stack[-4]T, Stack[-1])
0x13e: Pop(1)
...
0x151: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1a6: Pop(0)
0x1a7: Push("all") // @poff=138
0x1a8: PushEmpty(string, int)
0x1a9: Stack[-7] = Stack[-1]
0x1aa: Call2 0x280
...
0x1dc: Pop(0)
0x1dd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1de: Pop(0)
...
0x1e8: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1e9: Pop(0)
0x1ea: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1eb: Pop(0)
...
0x210: @ StopWorld()
0x211: Pop(0)
0x212: @ CameraTransit(Stack[-3], Stack[-5])
0x213: Pop(0)
0x214: Push(CvectorIndex(Stack[-4], 0))
0x215: Push(CvectorIndex(Stack[-5], 2))
0x216: @ Rotate(Stack[-2], Stack[-1])
0x217: Pop(2)
...
0x223: @ LookAsyncCamera(Stack[-1])
0x224: Pop(1)
0x225: @ CameraWaitForPlayFinish()
0x226: Pop(0)
0x227: @ ResumeWorld()
0x228: Pop(0)
0x229: Stack[-21] = (bool) 1
0x22a: Return(); Pop(18)

0x22b: PushEmpty(bool, bool)
0x22c: @ CameraSwitchToNormal()
0x22d: Pop(0)
...
0x23c: PushEmpty(float, float, float, float)
0x23d: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x23e: Pop(0)
0x23f: Push((bool) 0)
0x240: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x241: Pop(1)
0x242: Return(); Pop(4)

0x243: PushEmpty(float, float, float, float)
0x244: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x245: Pop(0)
0x246: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x247: Pop(0)
0x248: Return(); Pop(4)

0x249: PushEmpty(float, cvector, float, cvector)
0x24a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x24b: Pop(0)
0x24c: Stack[-1] = [0.0, 0.0, 0.0]
0x24d: Push(CvectorIndex(Stack[-1], 1))
0x24e: Stack[-3] = Stack[-1]
0x24f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x250: Push("head") // @poff=170
...
0x266: @ GetVariable(Stack[-3], Stack[-1])
0x267: Pop(0)
0x268: Stack[-1] = Stack[-4]
0x269: Return(); Pop(2)
...
0x275: Stack[-1] = 0
0x276: Stack[-1] = (int) 518716
0x277: Return(); Pop(0)

0x278: Stack[-1] = (int) 518715
0x279: Return(); Pop(0)

0x27a: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=206
0x27b: Return(); Pop(0)

0x27c: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=246
0x27d: Return(); Pop(0)

0x27e: Stack[-1] = (bool) 0
0x27f: Return(); Pop(0)

0x280: PushEmpty(string, string)
0x281: Stack[-1] = "idle" // @poff=146
0x282: Push(Stack[-3])
0x283: IF (Stack[-1] == 0) GOTO 0x285; Pop(1)

0x284: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x285: Stack[-1] = Stack[-4]
0x286: Return(); Pop(2)

0x287: PushEmpty(int, bool, int, bool)
0x288: Stack[-2] = (int) 0
...
0x28d: Pop(1)
0x28e: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x28f: Pop(2)
...
0x293: Push((int) 1)
0x294: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x295: GOTO 0x289

0x296: Stack[-2] = Stack[-5]
0x297: Return(); Pop(4)

0x298: PushEmpty()
0x299: PushEmpty(bool, string, string)
0x29a: Stack[-2] = "quest_k10_01" // @poff=290
0x29b: Stack[-1] = "teleport" // @poff=316
0x29c: Call2 0x26a
