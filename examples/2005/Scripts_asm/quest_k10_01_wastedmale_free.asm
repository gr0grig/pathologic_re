...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
EVENT_43 Op = 0x543 Vars = (object, int, float, float, cvector, cvector)
EVENT_41 Op = 0x54d Vars = (object)
...
0x3eb: Push("head") // @poff=192
0x3ec: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3ed: Pop(1)
0x3ee: Push(Stack[-1])
0x3ef: IF (Stack[-1] == 0) GOTO 0x3f3; Pop(1)

0x3f0: Push("head") // @poff=192
0x3f1: @ UnlookAsync(Stack[-1])
0x3f2: Pop(1)
0x3f3: Return(); Pop(2)

0x3f4: PushEmpty(float, float, float, float)
0x3f5: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x3f6: Pop(0)
0x3f7: Push((bool) 0)
0x3f8: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3f9: Pop(1)
0x3fa: Return(); Pop(4)

0x3fb: PushEmpty(float, float, float, float)
0x3fc: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x3fd: Pop(0)
0x3fe: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x3ff: Pop(0)
0x400: Return(); Pop(4)

0x401: PushEmpty(float, cvector, float, cvector)
0x402: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=373
0x403: Pop(0)
0x404: Stack[-1] = [0.0, 0.0, 0.0]
0x405: Push(CvectorIndex(Stack[-1], 1))
0x406: Stack[-3] = Stack[-1]
0x407: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x408: Push("head") // @poff=192
0x409: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x40a: Pop(1)
0x40b: Return(); Pop(4)
...
0x41a: Pop(0); Push(Stack[-3] | Stack[-3]);
0x41b: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x41c: Push((float)9.999999974752427e-07)
0x41d: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x41e: IF (Stack[-1] == 0) GOTO 0x421; Pop(1)

0x41f: Stack[-4] = [0.0, 0.0, 0.0]
0x420: Return(); Pop(2)

0x421: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x422: Return(); Pop(2)

0x423: PushEmpty()
0x424: Pop(0); Push(Stack[-2] | Stack[-1]);
0x425: Pop(0); Push(Stack[-3] | Stack[-3]);
0x426: Pop(0); Push(Stack[-3] | Stack[-3]);
0x427: Pop(2); Push(Stack[-2] * Stack[-1]);
0x428: Pop(1); Push(Sqrt(Stack[-1]))
0x429: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x42a: Return(); Pop(0)
...
0x431: @ FindActor(Stack[-1], Stack[-4])
0x432: Pop(0)
0x433: Pop(0); PushNull((bool) Stack[-1] == 0)
0x434: IF (Stack[-1] == 0) GOTO 0x437; Pop(1)

0x435: Stack[-5] = (bool) 0
0x436: Return(); Pop(2)

0x437: @ Trigger(Stack[-1], Stack[-3])
0x438: Pop(0)
0x439: Stack[-5] = (bool) 1
0x43a: Return(); Pop(2)

0x43b: Stack[-1] = 0
0x43c: PushEmpty(float, float)
0x43d: @ GetGameTime(Stack[-1])
0x43e: Pop(0)
0x43f: Stack[-1] = Stack[-3]
0x440: Return(); Pop(2)

0x441: PushEmpty(string, string)
0x442: Stack[-1] = "idle" // @poff=146
0x443: Push(Stack[-3])
0x444: IF (Stack[-1] == 0) GOTO 0x446; Pop(1)

0x445: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x446: Stack[-1] = Stack[-4]
0x447: Return(); Pop(2)

0x448: PushEmpty(int, bool, int, bool)
0x449: Stack[-2] = (int) 0
0x44a: Push("all") // @poff=138
0x44b: PushEmpty(string, int)
0x44c: Stack[-5] = Stack[-1]
0x44d: Call2 0x441

0x44e: Pop(1)
0x44f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x450: Pop(2)
...
0x454: Push((int) 1)
0x455: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x456: GOTO 0x44a

0x457: Stack[-2] = Stack[-5]
0x458: Return(); Pop(4)

0x459: Stack[-1] = (int) 515556
0x45a: Return(); Pop(0)

0x45b: Stack[-1] = (int) 503341
0x45c: Return(); Pop(0)

0x45d: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=387
0x45e: Return(); Pop(0)

0x45f: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=427
0x460: Return(); Pop(0)
...
0x474: Pop(1)
0x475: Push("k10q01WastedGotoBurah") // @poff=485
0x476: Push("pt_gmap_factory") // @poff=529
0x477: Push((int) 1)
0x478: Push((int) 530196)
0x479: PushEmpty(float)
0x47a: Call2 0x43c

0x47b: Pop(0)
0x47c: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=561
0x47d: Pop(5)
0x47e: PushEmpty()
0x47f: Call2 0x4c2
...
0x482: Stack[-2] = "quest_k10_01" // @poff=569
0x483: Stack[-1] = "init_factory" // @poff=595
0x484: Call2 0x430
...
0x487: Stack[-1] = 0
0x488: PushEmpty()
0x489: PushEmpty(object, string, float)
0x48a: PushEmpty(object)
0x48b: Call2 0x4f8

0x48c: Stack[-1] = Stack[-4]
0x48d: Pop(1)
0x48e: Stack[-2] = "pt_gmap_factory" // @poff=529
0x48f: Stack[-1] = (int) 2
0x490: Call2 0x509
...
0x494: Pop(0)
0x495: @@ ShowMap(Stack[-1]); Obj=2 // @poff=621
0x496: Pop(1)
0x497: Return(); Pop(0)

0x498: PushEmpty()
0x499: Push((int) 0)
0x49a: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=629
0x49b: Pop(1)
0x49c: Return(); Pop(0)

0x49d: PushEmpty()
0x49e: PushEmpty(int, string)
0x49f: Stack[-1] = "k10q01" // @poff=471
0x4a0: Call2 0x42b
...
0x4d4: Push("Can't retrieve diary root") // @poff=644
0x4d5: @ Trace(Stack[-1])
0x4d6: Pop(1)
...
0x4e0: Pop(1)
0x4e1: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=696
0x4e2: Pop(0)
0x4e3: Pop(0); Push((bool) Stack[-2] == 0)
0x4e4: IF (Stack[-1] == 0) GOTO 0x4eb; Pop(1)

0x4e5: Push("Can't find diary parent with id: ") // @poff=701
...
0x4eb: @@ AddChild(Stack[-8]); Obj=2 // @poff=769
0x4ec: Pop(0)
0x4ed: Push((int) 7)
0x4ee: @ SendWorldWndMessage(Stack[-1])
0x4ef: Pop(1)
0x4f0: @@ GetCategory(Stack[-1]); Obj=8 // @poff=778
0x4f1: Pop(0)
...
0x503: @@ GetMap(Stack[-1]); Obj=2 // @poff=850
0x504: Pop(0)
...
0x507: Stack[-1] = 0
0x508: Stack[-2] = 0
0x509: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x50a: @ GetMainOutdoorScene(Stack[-2])
0x50b: Pop(0)
0x50c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x50d: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x50e: Push("Can't find main outdoor scene") // @poff=790
0x50f: @ Trace(Stack[-1])
0x510: Pop(1)
0x511: Return(); Pop(8)

0x512: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=857
0x513: Pop(0)
0x514: Pop(0); Push((bool) Stack[-1] == 0)
0x515: IF (Stack[-1] == 0) GOTO 0x51c; Pop(1)

0x516: Push("Warning: outdoor scene locator ") // @poff=868
0x517: Pop(1); Push(Stack[-1] + Stack[-11]);
0x518: Push(" doesnt exist") // @poff=932
0x519: Pop(2); Push(Stack[-2] + Stack[-1]);
0x51a: @ Trace(Stack[-1])
0x51b: Pop(1)
0x51c: @@ GetMap(Stack[-11]); Obj=2 // @poff=850
0x51d: Pop(0)
0x51e: Pop(0); PushNull((bool) Stack[-11] == 0)
0x51f: IF (Stack[-1] == 0) GOTO 0x524; Pop(1)

0x520: Push("Can't find map") // @poff=960
0x521: @ Trace(Stack[-1])
0x522: Pop(1)
0x523: Return(); Pop(8)

0x524: Push(CvectorIndex(Stack[-4], 0))
0x525: Push(CvectorIndex(Stack[-5], 2))
0x526: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=990
0x527: Pop(2)
0x528: Return(); Pop(8)

0x529: Stack[-2] = 0
0x52a: PushEmpty(int, int)
0x52b: Push("branch") // @poff=1003
...
0x53b: PushEmpty()
0x53c: PushEmpty(object, int, float)
0x53d: Stack[-7] = Stack[-3]
0x53e: Stack[-6] = Stack[-2]
...
0x543: PushEmpty()
0x544: PushEmpty(object, int, float, cvector, cvector)
0x545: Stack[-11] = Stack[-5]
0x546: Stack[-10] = Stack[-4]
0x547: Stack[-9] = Stack[-3]
0x548: Stack[-7] = Stack[-2]
0x549: Stack[-6] = Stack[-1]
0x54a: Call2 0x38c
