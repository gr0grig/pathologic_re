...
Strings:
	...
	W:reputation
	W:battle
// @pool_raw:
...
Events:
EVENT_22 Op = 0x65d Vars = (object, int, float, float)
EVENT_43 Op = 0x665 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x66f Vars = (object, string)
EVENT_41 Op = 0x67c Vars = (object)
...
0x28: Stack[-1] = 0
0x29: PushEmpty()
0x2a: Stack[-3] = (float) 0.10000000149011612
0x2b: Return(); Pop(0)
...
0x4a: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x4b: Pop(0)
0x4c: Push(Stack[-8])
0x4d: IF (Stack[-1] == 0) GOTO 0x56; Pop(1)

0x4e: Push("attack") // @poff=70
...
0x6a: Pop(0)
0x6b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0x6c: Pop(0)
...
0x86: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=84
0x87: Pop(0)
...
0xa0: Pop(1)
0xa1: Push("all") // @poff=98
0xa2: Push("attack_on") // @poff=106
...
0xba: IF (Stack[-1] == 1) GOTO 0xc0; Pop(1)

0xbb: PushEmpty(bool)
0xbc: Call2 0x28c

0xbd: Pop(0)
0xbe: IF (Stack[-1] == 1) GOTO 0xc0; Pop(1)
...
0xc5: Pop(0)
0xc6: Push("all") // @poff=98
0xc7: Push("attack_stay") // @poff=126
0xc8: @ PlayAnimation(Stack[-2], Stack[-1])
0xc9: Pop(2)
0xca: PushEmpty(bool, float)
0xcb: Stack[-25] = Stack[-1]
0xcc: Call2 0x208
...
0xd1: @ Face(Stack[-0]T)
0xd2: Pop(0)
0xd3: Push("all") // @poff=98
0xd4: Push("fjump") // @poff=150
...
0xef: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0xf0: Pop(0)
...
0x10e: Push("all") // @poff=98
0x10f: Push("attack_off") // @poff=162
...
0x11c: Push("all") // @poff=98
0x11d: Push("attack_begin") // @poff=184
0x11e: Push((int) 1)
0x11f: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x12a: Push("attack") // @poff=70
0x12b: Push((int) 1)
0x12c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x136: Push("all") // @poff=98
0x137: Push("bjump") // @poff=210
...
0x13e: Push((float)0.8999999761581421)
0x13f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x140: @ GetVictim(Stack[-1], Stack[-4])
0x141: Pop(1)
0x142: @ ReportAttack(Stack[-0]T)
0x143: Pop(0)
...
0x147: Stack[-6] = Stack[-2]
0x148: Stack[-10] = Stack[-1]
0x149: Call2 0x29

0x14a: Stack[-3] = Stack[-5]
0x14b: Pop(3)
0x14c: PushEmpty(float, object, float, int)
0x14d: Stack[-7] = Stack[-3]
0x14e: Stack[-6] = Stack[-2]
0x14f: PushEmpty(int, object, int)
0x150: Stack[-10] = Stack[-2]
0x151: Stack[-14] = Stack[-1]
0x152: Call2 0x2c

0x153: Stack[-3] = Stack[-4]
0x154: Pop(3)
0x155: Call2 0x497

0x156: Stack[-4] = Stack[-5]
0x157: Pop(4)
0x158: PushEmpty(int)
0x159: Call2 0x2bc

0x15a: Pop(0)
0x15b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x15c: Pop(1)
0x15d: PushEmpty(object, float)
0x15e: Stack[-5] = Stack[-2]
0x15f: Stack[-3] = Stack[-1]
0x160: Call2 0x2c3
...
0x173: Pop(0)
0x174: Push("all") // @poff=98
0x175: Push("attack_begin") // @poff=184
...
0x18c: Pop(2)
0x18d: Push("all") // @poff=98
0x18e: Push("attack_middle") // @poff=222
...
0x196: Pop(0)
0x197: Push("all") // @poff=98
0x198: Push("attack_middle") // @poff=222
...
0x1ac: Stack[-11] = Stack[-2]
0x1ad: Stack[-6] = Stack[-1]
0x1ae: Call2 0x13d

0x1af: Pop(2)
0x1b0: Stack[-2] = (int) 1
0x1b1: Push("attack_middle") // @poff=222
0x1b2: Pop(1); Push(Stack[-1] + Stack[-5]);
0x1b3: Push("_") // @poff=250
0x1b4: Pop(2); Push(Stack[-2] + Stack[-1]);
0x1b5: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x1b6: Push("all") // @poff=98
...
0x1d2: Stack[-11] = Stack[-2]
0x1d3: Stack[-6] = Stack[-1]
0x1d4: Call2 0x13d
...
0x1db: Pop(1)
0x1dc: Push("all") // @poff=98
0x1dd: Push("attack_end") // @poff=254
...
0x21c: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=84
0x21d: Pop(0)
...
0x268: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x269: Pop(1)
...
0x26e: Pop(0)
0x26f: Push("all") // @poff=98
0x270: Push("bjump") // @poff=210
0x271: @ PlayAnimation(Stack[-2], Stack[-1])
0x272: Pop(2)
0x273: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=84
0x274: Pop(0)
...
0x2aa: @ irand(Stack[-1], Stack[-2]T)
0x2ab: Pop(0)
0x2ac: Push((int) 1)
0x2ad: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x2ae: Push("attack") // @poff=70
...
0x2bf: Stack[-1] = "attack_stay" // @poff=126
0x2c0: Call2 0x5b5
...
0x2f0: Stack[-15] = Stack[-5]
0x2f1: Stack[-14] = Stack[-4]
0x2f2: Stack[-13] = Stack[-3]
0x2f3: Stack[-12] = Stack[-2]
0x2f4: Stack[-11] = Stack[-1]
0x2f5: Call2 0x33a

0x2f6: Stack[-6] = Stack[-7]
0x2f7: Pop(6)
...
0x33d: Stack[-17] = Stack[-7]
0x33e: PushEmpty(bool, object)
0x33f: Stack[-23] = Stack[-1]
0x340: Call2 0x3c6
...
0x346: @@ GetPosition(Stack[-5]); Obj=21 // @poff=322
0x347: Pop(0)
...
0x35d: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=84
0x35e: Pop(0)
...
0x36f: Push((int) 0)
0x370: Push((float)0.30000001192092896)
...
0x392: Push((int) 0)
0x393: Push((float)0.30000001192092896)
...
0x3cd: Stack[-1] = "walk" // @poff=334
0x3ce: Return(); Pop(0)

0x3cf: Stack[-1] = "run" // @poff=344
0x3d0: Return(); Pop(0)
...
0x3e1: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3e2: IF (Stack[-1] == 0) GOTO 0x3e8; Pop(1)

0x3e3: PushEmpty(string)
0x3e4: Stack[-1] = "fdie" // @poff=352
0x3e5: Call2 0x43b

0x3e6: Pop(1)
0x3e7: GOTO 0x43a

0x3e8: @@ GetPosition(Stack[-10]); Obj=21 // @poff=322
0x3e9: Pop(0)
...
0x3f9: Stack[-6] = "fdie" // @poff=352
0x3fa: GOTO 0x3fc

0x3fb: Stack[-6] = "bdie" // @poff=362
...
0x402: @ StopAsync()
0x403: Pop(0)
0x404: Stack[-21] = Stack[-5]
0x405: Push("GetScriptProperty") // @poff=372
0x406: Push((int) 2)
0x407: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x408: IF (Stack[-1] == 0) GOTO 0x414; Pop(1)

0x409: Push("Owner") // @poff=408
0x40a: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=420
0x40b: Pop(1)
0x40c: Push(Stack[-4])
0x40d: IF (Stack[-1] == 0) GOTO 0x414; Pop(1)

0x40e: Push("Owner") // @poff=408
0x40f: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=438
0x410: Pop(1)
0x411: Pop(0); PushNull((bool) Stack[-5] == 0)
0x412: IF (Stack[-1] == 0) GOTO 0x414; Pop(1)

0x413: Stack[-21] = Stack[-5]
0x414: Push("@GetEyesHeight") // @poff=456
0x415: Push((int) 1)
0x416: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x417: IF (Stack[-1] == 0) GOTO 0x423; Pop(1)

0x418: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x419: Pop(0)
0x41a: Stack[-1] = [0.0, 0.0, 0.0]
0x41b: Push(CvectorIndex(Stack[-1], 1))
0x41c: Stack[-3] = Stack[-1]
0x41d: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x41e: Push("head") // @poff=312
...
0x425: Stack[-7] = Stack[-1]
0x426: Call2 0x5b5

0x427: Pop(1)
0x428: Push("all") // @poff=98
...
0x42f: @ StopAsync()
0x430: Pop(0)
0x431: Push("head") // @poff=312
0x432: @ UnlookAsync(Stack[-1])
0x433: Pop(1)
0x434: Push("all") // @poff=98
...
0x465: Stack[-2] = "bullet" // @poff=510
0x466: Return(); Pop(0)

0x467: Stack[-2] = "phys" // @poff=524
0x468: Return(); Pop(0)

0x469: PushEmpty(cvector, cvector, cvector, cvector)
0x46a: @ GetPosition(Stack[-2])
0x46b: Pop(0)
0x46c: @@ GetPosition(Stack[-1]); Obj=5 // @poff=322
0x46d: Pop(0)
...
0x476: Push("HasProperty") // @poff=534
0x477: Push((int) 2)
...
0x47d: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=558
0x47e: Pop(0)
...
0x48b: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=570
0x48c: Pop(0)
0x48d: PushEmpty(float, float, float, float)
0x48e: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x48f: Stack[-8] = Stack[-2]
0x490: Stack[-7] = Stack[-1]
0x491: Call2 0x5f5

0x492: Pop(3)
0x493: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=582
0x494: Pop(1)
...
0x499: Stack[-18] = Stack[-2]
0x49a: Stack[-1] = "health" // @poff=594
0x49b: Call2 0x475
...
0x4a2: Stack[-18] = Stack[-2]
0x4a3: Stack[-1] = "armor" // @poff=608
0x4a4: Call2 0x475
...
0x4aa: Push("armor") // @poff=608
0x4ab: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=570
0x4ac: Pop(1)
0x4ad: Push("armor_") // @poff=620
0x4ae: PushEmpty(string, int)
0x4af: Stack[-16] = Stack[-1]
0x4b0: Call2 0x45b

0x4b1: Pop(1)
0x4b2: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4b3: PushEmpty(bool, object, string)
0x4b4: Stack[-18] = Stack[-2]
0x4b5: Stack[-8] = Stack[-1]
0x4b6: Call2 0x475
...
0x4bc: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=570
0x4bd: Pop(0)
...
0x4c4: Stack[-3] = Stack[-6]
0x4c5: Pop(3)
0x4c6: Push("health") // @poff=594
0x4c7: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=570
0x4c8: Pop(1)
0x4c9: Push((int) 1)
0x4ca: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4cb: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4cc: Push("health") // @poff=594
...
0x4d2: Pop(3)
0x4d3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=582
0x4d4: Pop(2)
0x4d5: PushEmpty(bool, object)
0x4d6: Stack[-17] = Stack[-1]
0x4d7: Call2 0x470
...
0x4e1: @@ IsDead(Stack[-1]); Obj=3 // @poff=634
0x4e2: Pop(0)
0x4e3: Stack[-1] = Stack[-4]
0x4e4: Return(); Pop(2)

0x4e5: PushEmpty(object, object, object, object)
0x4e6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4fa: Pop(0)
0x4fb: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4fc: IF (Stack[-1] == 0) GOTO 0x4ff; Pop(1)

0x4fd: Stack[-6] = (bool) 0
0x4fe: Return(); Pop(4)

0x4ff: @@ GetScene(Stack[-1]); Obj=5 // @poff=655
0x500: Pop(0)
...
0x513: Stack[-6] = Stack[-2]
0x514: Stack[-1] = "noaccess" // @poff=664
0x515: Call2 0x475
...
0x51b: Push("noaccess") // @poff=664
0x51c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=570
0x51d: Pop(1)
0x51e: Push((int) 0)
...
0x522: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x530: @@ GetPosition(Stack[-5]); Obj=15 // @poff=322
0x531: Pop(0)
...
0x541: Stack[-1] = "fhit" // @poff=682
0x542: GOTO 0x544

0x543: Stack[-1] = "bhit" // @poff=692
0x544: Push("hit_react") // @poff=702
0x545: Push("1") // @poff=722
0x546: Pop(1); Push(Stack[-3] + Stack[-1]);
0x547: Push("2") // @poff=726
...
0x57f: Pop(0)
0x580: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=739
0x581: Pop(0)
0x582: PushEmpty(object, int, float, cvector, cvector)
0x583: Stack[-26] = Stack[-5]
0x584: Stack[-25] = Stack[-4]
0x585: Stack[-24] = Stack[-3]
0x586: Stack[-6] = Stack[-2]
...
0x5a0: @@ GetPosition(Stack[-3]); Obj=7 // @poff=322
0x5a1: Pop(0)
...
0x5ab: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x5ac: Pop(0)
0x5ad: Stack[-1] = [0.0, 0.0, 0.0]
0x5ae: Push(CvectorIndex(Stack[-1], 1))
0x5af: Stack[-3] = Stack[-1]
0x5b0: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x5b1: Push("head") // @poff=312
...
0x5fc: Stack[-1] = Stack[-4]
0x5fd: Return(); Pop(0)

0x5fe: Stack[-3] = Stack[-4]
0x5ff: Return(); Pop(0)
...
0x61a: Stack[-8] = Stack[-5]
0x61b: Stack[-4] = "reputation" // @poff=789
...
0x625: Pop(0)
0x626: @@ add(Stack[-3]); Obj=1 // @poff=730
0x627: Pop(0)
0x628: Push((int) 15)
0x629: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x62a: Pop(1)
0x62b: Return(); Pop(2)

0x62c: Stack[-1] = 0
0x62d: PushEmpty(object, object)
0x62e: @ CreateFloatVector(Stack[-1])
0x62f: Pop(0)
0x630: @@ add(Stack[-3]); Obj=1 // @poff=730
0x631: Pop(0)
0x632: Push((int) 16)
0x633: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x634: Pop(1)
0x635: Return(); Pop(2)

0x636: Stack[-1] = 0
0x637: PushEmpty(bool, bool)
0x638: @ IsPlayerActor(Stack[-3], Stack[-1])
0x639: Pop(0)
0x63a: Push(Stack[-1])
0x63b: IF (Stack[-1] == 0) GOTO 0x63f; Pop(1)

0x63c: Push("attack") // @poff=70
0x63d: @ PlayGlobalMusic(Stack[-1])
0x63e: Pop(1)
0x63f: Return(); Pop(2)

0x640: PushEmpty(object, object)
0x641: @ GetScene(Stack[-1])
0x642: Pop(0)
0x643: Push("battle") // @poff=811
0x644: PushEmpty(object)
0x645: Call2 0x5de

0x646: Pop(0)
0x647: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x648: Pop(2)
0x649: Return(); Pop(2)
...
0x651: PushEmpty(bool, object, float)
0x652: Stack[-4] = Stack[-2]
0x653: Stack[-1] = (float) 0.05000000074505806
0x654: Call2 0x600

0x655: Pop(3)
0x656: PushEmpty(object)
0x657: Stack[-2] = Stack[-1]
0x658: Push(-1, 0); TaskCall(3)
0x659: Call2 0x3d7

0x65a: Pop(-1, 0); TaskReturn
0x65b: Pop(1)
0x65c: Return(); Pop(0)

0x65d: PushEmpty()
0x65e: PushEmpty(object, int, float)
0x65f: Stack[-7] = Stack[-3]
0x660: Stack[-6] = Stack[-2]
...
0x665: PushEmpty()
0x666: PushEmpty(object, int, float, cvector, cvector)
0x667: Stack[-11] = Stack[-5]
0x668: Stack[-10] = Stack[-4]
0x669: Stack[-9] = Stack[-3]
0x66a: Stack[-7] = Stack[-2]
0x66b: Stack[-6] = Stack[-1]
0x66c: Call2 0x591

0x66d: Pop(5)
0x66e: Return(); Pop(0)

0x66f: PushEmpty(float, float)
0x670: Push("health") // @poff=594
0x671: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x672: IF (Stack[-1] == 0) GOTO 0x67b; Pop(1)

0x673: Push("health") // @poff=594
