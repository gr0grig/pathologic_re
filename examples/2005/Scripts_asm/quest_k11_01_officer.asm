...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x195: Push("player") // @poff=156
0x196: @ FindActor(Stack[-4]T, Stack[-1])
0x197: Pop(1)
...
0x1aa: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1ff: Pop(0)
0x200: Push("all") // @poff=138
0x201: PushEmpty(string, int)
0x202: Stack[-7] = Stack[-1]
0x203: Call2 0x2d9
...
0x235: Pop(0)
0x236: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x237: Pop(0)
...
0x241: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x242: Pop(0)
0x243: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x244: Pop(0)
...
0x28c: Push("head") // @poff=170
0x28d: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x28e: Pop(1)
0x28f: Push(Stack[-1])
0x290: IF (Stack[-1] == 0) GOTO 0x294; Pop(1)

0x291: Push("head") // @poff=170
0x292: @ UnlookAsync(Stack[-1])
0x293: Pop(1)
0x294: Return(); Pop(2)

0x295: PushEmpty(float, float, float, float)
0x296: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x297: Pop(0)
0x298: Push((bool) 0)
...
0x29c: PushEmpty(float, float, float, float)
0x29d: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x29e: Pop(0)
0x29f: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2a0: Pop(0)
0x2a1: Return(); Pop(4)

0x2a2: PushEmpty(float, cvector, float, cvector)
0x2a3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2a4: Pop(0)
0x2a5: Stack[-1] = [0.0, 0.0, 0.0]
0x2a6: Push(CvectorIndex(Stack[-1], 1))
0x2a7: Stack[-3] = Stack[-1]
0x2a8: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2a9: Push("head") // @poff=170
0x2aa: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2ab: Pop(1)
0x2ac: Return(); Pop(4)
...
0x2b4: PushEmpty(float, float)
0x2b5: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2b6: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2b7: Push((float)9.999999974752427e-07)
0x2b8: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2b9: IF (Stack[-1] == 0) GOTO 0x2bc; Pop(1)

0x2ba: Stack[-4] = [0.0, 0.0, 0.0]
0x2bb: Return(); Pop(2)

0x2bc: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2bd: Return(); Pop(2)

0x2be: PushEmpty(int, int)
0x2bf: @ GetVariable(Stack[-3], Stack[-1])
0x2c0: Pop(0)
0x2c1: Stack[-1] = Stack[-4]
0x2c2: Return(); Pop(2)

0x2c3: PushEmpty(object, object)
0x2c4: @ FindActor(Stack[-1], Stack[-4])
0x2c5: Pop(0)
0x2c6: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2c7: IF (Stack[-1] == 0) GOTO 0x2ca; Pop(1)

0x2c8: Stack[-5] = (bool) 0
0x2c9: Return(); Pop(2)

0x2ca: @ Trigger(Stack[-1], Stack[-3])
0x2cb: Pop(0)
0x2cc: Stack[-5] = (bool) 1
0x2cd: Return(); Pop(2)

0x2ce: Stack[-1] = 0
0x2cf: Stack[-1] = (int) 515597
0x2d0: Return(); Pop(0)

0x2d1: Stack[-1] = (int) 514841
0x2d2: Return(); Pop(0)

0x2d3: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=206
0x2d4: Return(); Pop(0)

0x2d5: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=246
0x2d6: Return(); Pop(0)

0x2d7: Stack[-1] = (bool) 0
0x2d8: Return(); Pop(0)

0x2d9: PushEmpty(string, string)
0x2da: Stack[-1] = "idle" // @poff=146
0x2db: Push(Stack[-3])
0x2dc: IF (Stack[-1] == 0) GOTO 0x2de; Pop(1)

0x2dd: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2de: Stack[-1] = Stack[-4]
0x2df: Return(); Pop(2)

0x2e0: PushEmpty(int, bool, int, bool)
0x2e1: Stack[-2] = (int) 0
0x2e2: Push("all") // @poff=138
0x2e3: PushEmpty(string, int)
0x2e4: Stack[-5] = Stack[-1]
0x2e5: Call2 0x2d9

0x2e6: Pop(1)
0x2e7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2e8: Pop(2)
...
0x2ec: Push((int) 1)
0x2ed: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2ee: GOTO 0x2e2

0x2ef: Stack[-2] = Stack[-5]
0x2f0: Return(); Pop(4)

0x2f1: PushEmpty()
0x2f2: Push("ook11Officer1") // @poff=290
0x2f3: Push((int) 1)
...
0x2f7: PushEmpty()
0x2f8: Push("k11q01") // @poff=318
0x2f9: Push((int) 3)
0x2fa: @ SetVariable(Stack[-2], Stack[-1])
0x2fb: Pop(2)
0x2fc: PushEmpty()
0x2fd: Call2 0x311

0x2fe: Pop(0)
0x2ff: PushEmpty(bool, string, string)
0x300: Stack[-2] = "quest_k11_01" // @poff=332
0x301: Stack[-1] = "init_house_petr" // @poff=358
0x302: Call2 0x2c3
...
0x307: Stack[-1] = "ook11Officer1" // @poff=290
0x308: Call2 0x2be
...
0x312: Push((int) 486)
0x313: Push((int) 1)
0x314: Push((int) 528053)
0x315: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x316: Pop(3)
0x317: PushEmpty(bool, object, int)
0x318: Stack[-4] = Stack[-2]
0x319: Stack[-1] = (int) 480
0x31a: Call2 0x32b
...
0x31f: @ GetDiaryRoot(Stack[-1])
0x320: Pop(0)
0x321: Pop(0); Push((bool) Stack[-1] == 0)
0x322: IF (Stack[-1] == 0) GOTO 0x328; Pop(1)

0x323: Push("Can't retrieve diary root") // @poff=390
0x324: @ Trace(Stack[-1])
0x325: Pop(1)
0x326: Stack[-3] = (bool) 0
0x327: Return(); Pop(2)
...
0x32a: Stack[-1] = 0
0x32b: PushEmpty(object, object, int, object, object, int)
0x32c: PushEmpty(object)
0x32d: Call2 0x31e

0x32e: Stack[-1] = Stack[-4]
0x32f: Pop(1)
0x330: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=442
0x331: Pop(0)
0x332: Pop(0); Push((bool) Stack[-2] == 0)
0x333: IF (Stack[-1] == 0) GOTO 0x33a; Pop(1)

0x334: Push("Can't find diary parent with id: ") // @poff=447
0x335: Pop(1); Push(Stack[-1] + Stack[-8]);
0x336: @ Trace(Stack[-1])
0x337: Pop(1)
0x338: Stack[-9] = (bool) 0
0x339: Return(); Pop(6)

0x33a: @@ AddChild(Stack[-8]); Obj=2 // @poff=515
0x33b: Pop(0)
0x33c: Push((int) 7)
0x33d: @ SendWorldWndMessage(Stack[-1])
0x33e: Pop(1)
0x33f: @@ GetCategory(Stack[-1]); Obj=8 // @poff=524
0x340: Pop(0)
0x341: @ SetDiarySection(Stack[-1])
0x342: Pop(0)
