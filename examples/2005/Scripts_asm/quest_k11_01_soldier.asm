...
Strings:
	...
	W:k11q01Cured
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xb2: Stack[-1] = "Neutral" // @poff=89
0xb3: Call2 0xe5

0xb4: Pop(1)
0xb5: Push((int) 528022)
0xb6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xb7: Pop(1)
0xb8: @@@ ClearReplies(); Obj=0 // @poff=116
0xb9: Pop(0)
...
0x1d0: Push("player") // @poff=156
0x1d1: @ FindActor(Stack[-4]T, Stack[-1])
0x1d2: Pop(1)
...
0x1e5: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x270: Pop(0)
0x271: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x272: Pop(0)
...
0x27c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x27d: Pop(0)
0x27e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x27f: Pop(0)
...
0x2d8: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2d9: Pop(0)
0x2da: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2db: Pop(0)
0x2dc: Return(); Pop(4)

0x2dd: PushEmpty(float, cvector, float, cvector)
0x2de: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2df: Pop(0)
0x2e0: Stack[-1] = [0.0, 0.0, 0.0]
0x2e1: Push(CvectorIndex(Stack[-1], 1))
0x2e2: Stack[-3] = Stack[-1]
0x2e3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2e4: Push("head") // @poff=170
0x2e5: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2e6: Pop(1)
0x2e7: Return(); Pop(4)
...
0x2f0: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2f1: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2f2: Push((float)9.999999974752427e-07)
0x2f3: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2f4: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f5: Stack[-4] = [0.0, 0.0, 0.0]
0x2f6: Return(); Pop(2)

0x2f7: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2f8: Return(); Pop(2)

0x2f9: PushEmpty(int, int)
0x2fa: @ GetVariable(Stack[-3], Stack[-1])
0x2fb: Pop(0)
0x2fc: Stack[-1] = Stack[-4]
0x2fd: Return(); Pop(2)

0x2fe: Stack[-1] = (int) 527721
0x2ff: Return(); Pop(0)

0x300: Stack[-1] = (int) 527720
0x301: Return(); Pop(0)

0x302: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=206
0x303: Return(); Pop(0)

0x304: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=246
0x305: Return(); Pop(0)
...
0x31e: Stack[-2] = Stack[-5]
0x31f: Return(); Pop(4)

0x320: PushEmpty()
0x321: Push("ook11Soldier1") // @poff=290
0x322: Push((int) 1)
...
0x326: PushEmpty()
0x327: Push("ook11Soldier2") // @poff=318
0x328: Push((int) 1)
...
0x32c: PushEmpty()
0x32d: PushEmpty(int, string)
0x32e: Stack[-1] = "k11q01" // @poff=346
0x32f: Call2 0x2f9
...
0x33a: Stack[-1] = "ook11Soldier1" // @poff=290
0x33b: Call2 0x2f9
...
0x344: PushEmpty()
0x345: PushEmpty(int, string)
0x346: Stack[-1] = "k11q01Cured" // @poff=360
0x347: Call2 0x2f9
...
0x352: Stack[-1] = "ook11Soldier2" // @poff=318
0x353: Call2 0x2f9
