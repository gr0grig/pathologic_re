...
Strings:
	...
	W:health
	W:cleanup
// @pool_raw:
...
0x12: Stack[-2] = "quest_k1_01" // @poff=10
0x13: Stack[-1] = "cure_worker" // @poff=34
0x14: Call2 0x155
...
0x34: Stack[-1] = (float) 0.3333333432674408
0x35: Call2 0x123
...
0x3a: Push("agony") // @poff=58
0x3b: Push([0.0, 40.0, 0.0])
0x3c: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x3d: Pop(2)
0x3e: Push("all") // @poff=70
0x3f: Push("agony") // @poff=58
...
0x49: Push("sleep") // @poff=78
0x4a: Push([0.0, 40.0, 0.0])
0x4b: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x4c: Pop(2)
0x4d: Push("all") // @poff=70
0x4e: Push("agony_sleep") // @poff=90
0x4f: @ PlayAnimation(Stack[-2], Stack[-1])
0x50: Pop(2)
0x51: @ WaitForAnimEnd()
0x52: Pop(0)
0x53: Push("all") // @poff=70
0x54: Push("agony_sleep") // @poff=90
...
0x77: Stack[-8] = Stack[-2]
0x78: Stack[-1] = (float) -0.30000001192092896
0x79: Call2 0x128

0x7a: Pop(3)
0x7b: Push("death") // @poff=114
0x7c: Push([0.0, 40.0, 0.0])
0x7d: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x7e: Pop(2)
0x7f: Push("all") // @poff=70
0x80: Push("agony_die") // @poff=126
0x81: @ PlayAnimation(Stack[-2], Stack[-1])
0x82: Pop(2)
0x83: @ WaitForAnimEnd()
0x84: Pop(0)
0x85: Push("all") // @poff=70
0x86: Push("agony_die") // @poff=126
...
0xa9: Stack[-6] = Stack[-2]
0xaa: Stack[-5] = Stack[-1]
0xab: Call2 0x161
...
0xb2: Push("HasProperty") // @poff=146
0xb3: Push((int) 2)
...
0xb9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=170
0xba: Pop(0)
0xbb: Stack[-1] = Stack[-5]
0xbc: Return(); Pop(2)

0xbd: PushEmpty(float, float)
0xbe: PushEmpty(bool, object, string)
0xbf: Stack[-10] = Stack[-2]
0xc0: Stack[-9] = Stack[-1]
0xc1: Call2 0xb1
...
0xc7: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=182
0xc8: Pop(0)
...
0xe2: @@ GetPosition(Stack[-5]); Obj=15 // @poff=206
0xe3: Pop(0)
...
0xf3: Stack[-1] = "fhit" // @poff=218
0xf4: GOTO 0xf6

0xf5: Stack[-1] = "bhit" // @poff=228
0xf6: Push("hit_react") // @poff=238
0xf7: Push("1") // @poff=30
0xf8: Pop(1); Push(Stack[-3] + Stack[-1]);
0xf9: Push("2") // @poff=258
...
0x13e: Stack[-2] = Stack[-1]
0x13f: Call2 0x14b

0x140: Pop(1)
0x141: PushEmpty(bool, object, string, float, float, float)
0x142: Stack[-8] = Stack[-5]
0x143: Stack[-4] = "reputation" // @poff=308
...
0x14d: Pop(0)
0x14e: @@ add(Stack[-3]); Obj=1 // @poff=330
0x14f: Pop(0)
0x150: Push((int) 16)
...
0x157: Pop(0)
0x158: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x170: Stack[-11] = Stack[-5]
0x171: Stack[-10] = Stack[-4]
0x172: Stack[-9] = Stack[-3]
0x173: Stack[-7] = Stack[-2]
