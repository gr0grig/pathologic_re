...
0x800: Pop(0)
0x801: @@ add(Stack[-3]); Obj=1 // @poff=940
0x802: Pop(0)
0x803: Push((int) 16)
...
0x82c: Stack[-7] = Stack[-3]
0x82d: Stack[-6] = Stack[-2]
...
0x834: Stack[-11] = Stack[-5]
0x835: Stack[-10] = Stack[-4]
0x836: Stack[-9] = Stack[-3]
0x837: Stack[-7] = Stack[-2]
0x838: Stack[-6] = Stack[-1]
0x839: Call2 0x73d
...
0x851: Stack[-3] = Stack[-1]
0x852: Call2 0x6a2

0x853: Stack[-2] = Stack[-4]
0x854: Pop(2)
0x855: Return(); Pop(0)
...
0x898: Push("b1q04_attack") // @poff=1049
0x899: Push((int) 1)
...
0x8a0: Pop(0)
0x8a1: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1075
0x8a2: Pop(1)
0x8a3: PushEmpty(object)
0x8a4: Stack[-4] = Stack[-1]
