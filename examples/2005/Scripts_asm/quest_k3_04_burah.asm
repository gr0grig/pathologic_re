...
// @pool_raw:
// @pool_encoding:utf8
...
0xfc: Pop(1)
0xfd: Push((int) 525635)
0xfe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xff: Pop(1)
0x100: @@@ ClearReplies(); Obj=0 // @poff=116
0x101: Pop(0)
0x102: Push((int) 529332)
0x103: Push((int) 30788)
0x104: Push((int) 30787)
0x105: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x106: Pop(3)
0x107: Push((int) 540664)
0x108: Push((int) 42695)
0x109: Push((int) 42694)
...
0x3eb: @ CreateIntVector(Stack[-1])
0x3ec: Pop(0)
0x3ed: @@ add(Stack[-4]); Obj=1 // @poff=296
0x3ee: Pop(0)
0x3ef: @@ add(Stack[-3]); Obj=1 // @poff=296
0x3f0: Pop(0)
0x3f1: Push((int) 3)
0x3f2: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x3f3: Pop(1)
0x3f4: Return(); Pop(2)

0x3f5: Stack[-1] = 0
0x3f6: PushEmpty(int, int, bool, int, int, bool)
0x3f7: @@ GetItemID(Stack[-3]); Obj=8 // @poff=300
0x3f8: Pop(0)
0x3f9: Push("Category") // @poff=310
0x3fa: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x3fb: Pop(1)
0x3fc: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=328
0x3fd: Pop(0)
0x3fe: Pop(0); Push((bool) Stack[-1] == 0)
0x3ff: IF (Stack[-1] == 0) GOTO 0x403; Pop(1)

0x400: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=336
0x401: Pop(0)
0x402: GOTO 0x408

0x403: PushEmpty(int, int)
0x404: Stack[-5] = Stack[-2]
0x405: Stack[-9] = Stack[-1]
0x406: Call2 0x3ea
...
0x40a: @ GetGameTime(Stack[-1])
0x40b: Pop(0)
0x40c: Push((int) 1)
0x40d: PushEmpty(int)
0x40e: Push((int) 24)
0x40f: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
...
0x42a: PushEmpty()
0x42b: Push("ook3BurahIndoor1") // @poff=346
0x42c: Push((int) 1)
...
0x439: PushEmpty()
0x43a: Push("k3q04") // @poff=380
0x43b: Push((int) 3)
0x43c: @ SetVariable(Stack[-2], Stack[-1])
0x43d: Pop(2)
0x43e: Push("k3q04Promise") // @poff=392
0x43f: Push((int) 1)
...
0x447: Push("grass combination (good) is given") // @poff=418
0x448: @ Trace(Stack[-1])
0x449: Pop(1)
0x44a: @ CreateInvItem(Stack[-1])
0x44b: Pop(0)
0x44c: Push("grass_combination") // @poff=486
0x44d: @@ SetItemName(Stack[-1]); Obj=2 // @poff=522
0x44e: Pop(1)
0x44f: Push("im_inc") // @poff=534
0x450: Push((float)0.4000000059604645)
0x451: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x452: Pop(2)
0x453: Push("hl_inc") // @poff=560
0x454: Push((float)-0.009999999776482582)
0x455: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x456: Pop(2)
0x457: Push("tr_inc") // @poff=574
0x458: Push((float)0.029999999329447746)
0x459: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x45a: Pop(2)
0x45b: PushEmpty(object, object, int)
0x45c: Stack[-7] = Stack[-3]
0x45d: Stack[-4] = Stack[-2]
0x45e: Stack[-1] = (int) 1
0x45f: Call2 0x3f6
...
0x464: Push("grass combination (bad) is given") // @poff=588
0x465: @ Trace(Stack[-1])
0x466: Pop(1)
0x467: @ CreateInvItem(Stack[-1])
0x468: Pop(0)
0x469: Push("grass_combination") // @poff=486
0x46a: @@ SetItemName(Stack[-1]); Obj=2 // @poff=522
0x46b: Pop(1)
0x46c: Push("im_inc") // @poff=534
0x46d: Push((float)0.20000000298023224)
0x46e: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x46f: Pop(2)
0x470: Push("hl_inc") // @poff=560
0x471: Push((float)-0.07999999821186066)
0x472: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x473: Pop(2)
0x474: Push("tr_inc") // @poff=574
0x475: Push((float)0.11999999731779099)
0x476: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=548
0x477: Pop(2)
0x478: PushEmpty(object, object, int)
0x479: Stack[-7] = Stack[-3]
0x47a: Stack[-4] = Stack[-2]
0x47b: Stack[-1] = (int) 1
0x47c: Call2 0x3f6
...
0x47f: Stack[-1] = 0
0x480: PushEmpty()
0x481: PushEmpty(int, string)
0x482: Stack[-1] = "ook3BurahIndoor1" // @poff=346
0x483: Call2 0x3e5
...
0x48d: Push((int) 357)
0x48e: Push((int) 2)
0x48f: Push((int) 525657)
0x490: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x491: Pop(3)
0x492: PushEmpty(bool, object, int)
0x493: Stack[-4] = Stack[-2]
0x494: Stack[-1] = (int) 354
0x495: Call2 0x4a6
...
0x49a: @ GetDiaryRoot(Stack[-1])
0x49b: Pop(0)
0x49c: Pop(0); Push((bool) Stack[-1] == 0)
0x49d: IF (Stack[-1] == 0) GOTO 0x4a3; Pop(1)

0x49e: Push("Can't retrieve diary root") // @poff=654
0x49f: @ Trace(Stack[-1])
0x4a0: Pop(1)
0x4a1: Stack[-3] = (bool) 0
0x4a2: Return(); Pop(2)

0x4a3: Stack[-1] = Stack[-3]
0x4a4: Return(); Pop(2)

0x4a5: Stack[-1] = 0
0x4a6: PushEmpty(object, object, int, object, object, int)
0x4a7: PushEmpty(object)
0x4a8: Call2 0x499

0x4a9: Stack[-1] = Stack[-4]
0x4aa: Pop(1)
0x4ab: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=706
0x4ac: Pop(0)
0x4ad: Pop(0); Push((bool) Stack[-2] == 0)
0x4ae: IF (Stack[-1] == 0) GOTO 0x4b5; Pop(1)

0x4af: Push("Can't find diary parent with id: ") // @poff=711
...
0x4b5: @@ AddChild(Stack[-8]); Obj=2 // @poff=779
0x4b6: Pop(0)
0x4b7: Push((int) 7)
0x4b8: @ SendWorldWndMessage(Stack[-1])
0x4b9: Pop(1)
0x4ba: @@ GetCategory(Stack[-1]); Obj=8 // @poff=788
0x4bb: Pop(0)
0x4bc: @ SetDiarySection(Stack[-1])
0x4bd: Pop(0)
0x4be: Stack[-9] = (bool) 0
0x4bf: Return(); Pop(6)

0x4c0: Stack[-2] = 0
0x4c1: Stack[-3] = 0
0x4c2: PushEmpty(int, int)
0x4c3: Push("branch") // @poff=800
...
0x4d3: Stack[-1] = (int) 515592
0x4d4: Return(); Pop(0)

0x4d5: Stack[-1] = (int) 511961
0x4d6: Return(); Pop(0)

0x4d7: Stack[-1] = "ui/NPC_Burah.png" // @poff=814
0x4d8: Return(); Pop(0)

0x4d9: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=848
0x4da: Return(); Pop(0)
