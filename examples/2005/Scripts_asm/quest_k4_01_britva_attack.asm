...
0x61c: Pop(0)
0x61d: @@ add(Stack[-3]); Obj=1 // @poff=730
0x61e: Pop(0)
0x61f: Push((int) 16)
...
0x63f: Stack[-4] = Stack[-2]
0x640: Stack[-1] = (float) 0.019999999552965164
0x641: Call2 0x5ed
...
0x64c: Stack[-7] = Stack[-3]
0x64d: Stack[-6] = Stack[-2]
...
0x654: Stack[-11] = Stack[-5]
0x655: Stack[-10] = Stack[-4]
0x656: Stack[-9] = Stack[-3]
0x657: Stack[-7] = Stack[-2]
