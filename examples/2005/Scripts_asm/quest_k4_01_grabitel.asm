...
0x81a: Pop(0)
0x81b: @@ add(Stack[-3]); Obj=1 // @poff=930
0x81c: Pop(0)
0x81d: Push((int) 16)
...
0x866: Stack[-11] = Stack[-5]
0x867: Stack[-10] = Stack[-4]
0x868: Stack[-9] = Stack[-3]
0x869: Stack[-7] = Stack[-2]
0x86a: Stack[-6] = Stack[-1]
0x86b: Call2 0x747
...
0x88f: Push("branch") // @poff=1035
0x890: @ GetVariable(Stack[-1], Stack[-2])
0x891: Pop(1)
0x892: Stack[-1] = Stack[-3]
0x893: Return(); Pop(2)
...
0x8a4: Push("GenerateMoney: iMin > iMax") // @poff=1049
0x8a5: @ Trace(Stack[-1])
0x8a6: Pop(1)
0x8a7: Return(); Pop(4)
...
0x8d0: Stack[-3] = "lockpick" // @poff=1127
0x8d1: Stack[-2] = (int) 1
0x8d2: Stack[-1] = (int) 6
0x8d3: Call2 0x770
...
0x8d6: Stack[-1] = "grabitel_mark" // @poff=1145
0x8d7: Call2 0x8de
...
0x8f5: Stack[-9] = Stack[-3]
0x8f6: Stack[-8] = Stack[-2]
0x8f7: Stack[-7] = Stack[-1]
0x8f8: Call2 0x7bb

0x8f9: Stack[-4] = Stack[-6]
0x8fa: Pop(4)
0x8fb: Push((int) 0)
...
0x901: Stack[-10] = Stack[-4]
0x902: Stack[-9] = Stack[-3]
0x903: Stack[-8] = Stack[-2]
0x904: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x905: Call2 0x7c2

0x906: Pop(4)
0x907: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x908: Push([0.0, 500.0, 0.0])
