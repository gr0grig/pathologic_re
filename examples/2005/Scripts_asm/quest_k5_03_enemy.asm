...
Strings:
	...
	W:beads
	W:bracelet
// @pool_raw:
...
Events:
EVENT_26 Op = 0xc61 Vars = (string)
EVENT_22 Op = 0xdcc Vars = (object, int, float, float)
EVENT_43 Op = 0xdd4 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xdde Vars = (object, string)
EVENT_41 Op = 0xdeb Vars = (object)
...
0xbc1: Stack[-10] = Stack[-2]
0xbc2: Stack[-9] = Stack[-1]
0xbc3: Call2 0xc1e
...
0xc25: Pop(0)
0xc26: @@ add(Stack[-3]); Obj=1 // @poff=860
0xc27: Pop(0)
0xc28: Push((int) 15)
0xc29: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc2a: Pop(1)
0xc2b: Return(); Pop(2)

0xc2c: Stack[-1] = 0
0xc2d: PushEmpty(bool, bool)
0xc2e: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc2f: Pop(0)
0xc30: Push(Stack[-1])
0xc31: IF (Stack[-1] == 0) GOTO 0xc35; Pop(1)

0xc32: Push("attack") // @poff=186
0xc33: @ PlayGlobalMusic(Stack[-1])
0xc34: Pop(1)
0xc35: Return(); Pop(2)

0xc36: PushEmpty(string, string)
0xc37: Stack[-1] = "idle" // @poff=919
0xc38: Push(Stack[-3])
0xc39: IF (Stack[-1] == 0) GOTO 0xc3b; Pop(1)

0xc3a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xc3b: Stack[-1] = Stack[-4]
0xc3c: Return(); Pop(2)

0xc3d: PushEmpty(int, bool, int, bool)
0xc3e: Stack[-2] = (int) 0
0xc3f: Push("all") // @poff=214
0xc40: PushEmpty(string, int)
0xc41: Stack[-5] = Stack[-1]
0xc42: Call2 0xc36

0xc43: Pop(1)
0xc44: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xc45: Pop(2)
0xc46: Pop(0); Push((bool) Stack[-1] == 0)
0xc47: IF (Stack[-1] == 0) GOTO 0xc49; Pop(1)

0xc48: GOTO 0xc4c

0xc49: Push((int) 1)
0xc4a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xc4b: GOTO 0xc3f

0xc4c: Stack[-2] = Stack[-5]
0xc4d: Return(); Pop(4)

0xc4e: PushEmpty(int, int)
0xc4f: Push("branch") // @poff=929
0xc50: @ GetVariable(Stack[-1], Stack[-2])
0xc51: Pop(1)
0xc52: Stack[-1] = Stack[-3]
0xc53: Return(); Pop(2)
...
0xc61: PushEmpty()
0xc62: Push("cleanup") // @poff=614
0xc63: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc64: IF (Stack[-1] == 0) GOTO 0xc68; Pop(1)

0xc65: Push(GlobalVars[0])
0xc66: Stack[-1] = (bool) 1
0xc67: GlobalVars[0] = Stack[-1]; Pop(1)
0xc68: Return(); Pop(0)

0xc69: PushEmpty(cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float)
0xc6a: PushEmpty(object)
0xc6b: Call2 0xbf7

0xc6c: Pop(0)
0xc6d: Pop(1); Push((bool) Stack[-19] == Stack[-1])
0xc6e: IF (Stack[-1] == 0) GOTO 0xc71; Pop(1)

0xc6f: Stack[-19] = (bool) 0
0xc70: Return(); Pop(16)
...
0xc77: Stack[-20] = Stack[-1]
0xc78: Call2 0xd59

0xc79: Pop(1)
0xc7a: IF (Stack[-1] == 0) GOTO 0xc7d; Pop(1)

0xc7b: Stack[-19] = (bool) 1
0xc7c: Return(); Pop(16)
...
0xc82: IF (Stack[-1] == 0) GOTO 0xc94; Pop(1)

0xc83: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xc84: Pop(0)
0xc85: @ GetPosition(Stack[-7])
0xc86: Pop(0)
0xc87: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0xc88: Stack[-5] = Stack[-6] | Stack[-6]; Pop(0);
0xc89: Push((float)4000000.0)
0xc8a: Pop(1); Push((bool) Stack[-6] < Stack[-1])
...
0xc94: Push("player_shot") // @poff=943
0xc95: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc96: IF (Stack[-1] == 0) GOTO 0xcb1; Pop(1)

0xc97: @@ GetPosition(Stack[-4]); Obj=18 // @poff=43
0xc98: Pop(0)
0xc99: @ GetPosition(Stack[-3])
0xc9a: Pop(0)
0xc9b: Stack[-2] = Stack[-4] - Stack[-3]; Pop(0);
0xc9c: Stack[-1] = Stack[-2] | Stack[-2]; Pop(0);
0xc9d: Push((float)360000.0)
0xc9e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc9f: IF (Stack[-1] == 0) GOTO 0xca7; Pop(1)

0xca0: PushEmpty(bool, object)
0xca1: Stack[-20] = Stack[-1]
0xca2: Call2 0xd7d

0xca3: Pop(1)
0xca4: IF (Stack[-1] == 0) GOTO 0xca7; Pop(1)

0xca5: Stack[-19] = (bool) 1
0xca6: Return(); Pop(16)

0xca7: Push((float)12250000.0)
0xca8: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xca9: IF (Stack[-1] == 0) GOTO 0xcb1; Pop(1)

0xcaa: PushEmpty(bool, object)
0xcab: Stack[-20] = Stack[-1]
0xcac: Call2 0xd59

0xcad: Pop(1)
0xcae: IF (Stack[-1] == 0) GOTO 0xcb1; Pop(1)

0xcaf: Stack[-19] = (bool) 1
0xcb0: Return(); Pop(16)

0xcb1: Stack[-19] = (bool) 0
0xcb2: Return(); Pop(16)

0xcb3: PushEmpty()
0xcb4: PushEmpty(bool)
0xcb5: Stack[-1] = (bool) 0
0xcb6: Push("IsDead") // @poff=771
0xcb7: Push((int) 1)
0xcb8: Pop(2); Push(IsFuncExist(Stack[-4], Stack[-2], Stack[-1]))
0xcb9: IF (Stack[-1] == 0) GOTO 0xcc0; Pop(1)

0xcba: PushEmpty(bool, object)
0xcbb: Stack[-4] = Stack[-1]
0xcbc: Call2 0xae5
...
0xcc0: IF (Stack[-1] == 0) GOTO 0xcd9; Pop(1)

0xcc1: PushEmpty(bool, object, string)
0xcc2: Stack[-4] = Stack[-2]
0xcc3: PushEmpty(string)
0xcc4: Call2 0xdf7

0xcc5: Stack[-1] = Stack[-2]
0xcc6: Pop(1)
0xcc7: Call2 0xa90

0xcc8: Pop(2)
0xcc9: IF (Stack[-1] == 0) GOTO 0xccc; Pop(1)

0xcca: Stack[-2] = (bool) 0
0xccb: Return(); Pop(0)
...
0xcce: Pop(0)
0xccf: Push((int) 1)
0xcd0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=752
0xcd1: Pop(2)
...
0xcdf: Stack[-3] = Stack[-1]
0xce0: Call2 0xd7d

0xce1: Stack[-2] = Stack[-4]
0xce2: Pop(2)
0xce3: Return(); Pop(0)

0xce4: Stack[-2] = (bool) 0
0xce5: Return(); Pop(0)
...
0xcea: Pop(1)
0xceb: IF (Stack[-1] == 0) GOTO 0xcf2; Pop(1)

0xcec: PushEmpty(bool, object)
0xced: Stack[-3] = Stack[-1]
0xcee: Call2 0xd6b

0xcef: Stack[-2] = Stack[-4]
0xcf0: Pop(2)
0xcf1: Return(); Pop(0)

0xcf2: Stack[-2] = (bool) 0
0xcf3: Return(); Pop(0)

0xcf4: PushEmpty(object, cvector, cvector, cvector, bool, float, int, object, cvector, cvector, cvector, bool, float, int)
0xcf5: @ GetMainOutdoorScene(Stack[-7])
0xcf6: Pop(0)
0xcf7: @ GetPosition(Stack[-6])
0xcf8: Pop(0)
0xcf9: Stack[-2] = (int) 4000000
0xcfa: Stack[-1] = (int) 0
0xcfb: Push(GlobalVars[1])
0xcfc: Stack[-1] = (int) 0
0xcfd: GlobalVars[1] = Stack[-1]; Pop(1)
0xcfe: Push((bool) 1)
0xcff: IF (Stack[-1] == 0) GOTO 0xd11; Pop(1)

0xd00: PushEmpty(string)
0xd01: Call2 0xdf3

0xd02: Pop(0)
0xd03: Push(GlobalVars[1])
0xd04: Push((int) 1)
0xd05: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd06: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd07: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xd08: Pop(1)
0xd09: Pop(0); Push((bool) Stack[-3] == 0)
0xd0a: IF (Stack[-1] == 0) GOTO 0xd0c; Pop(1)

0xd0b: GOTO 0xd11

0xd0c: Push(GlobalVars[1])
0xd0d: Push((int) 1)
0xd0e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xd0f: GlobalVars[1] = Stack[-1]; Pop(1)
0xd10: GOTO 0xcfe

0xd11: Push("Pantrol point count: ") // @poff=967
0xd12: Push(GlobalVars[1])
0xd13: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd14: @ Trace(Stack[-1])
0xd15: Pop(1)
0xd16: Stack[-15] = (bool) 1
0xd17: Return(); Pop(14)

0xd18: Stack[-7] = 0
0xd19: PushEmpty()
0xd1a: Push(GlobalVars[2])
0xd1b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd1c: IF (Stack[-1] == 0) GOTO 0xd1f; Pop(1)

0xd1d: Stack[-2] = (bool) 0
0xd1e: Return(); Pop(0)

0xd1f: Push((int) 0)
0xd20: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd21: IF (Stack[-1] == 0) GOTO 0xd2b; Pop(1)

0xd22: Push(GlobalVars[3])
0xd23: Push(GlobalVars[2])
0xd24: Stack[-1] = Stack[-2]
0xd25: Pop(1)
0xd26: GlobalVars[3] = Stack[-1]; Pop(1)
0xd27: Push("changing state to c_iStateWaitForLoad") // @poff=1011
0xd28: @ Trace(Stack[-1])
0xd29: Pop(1)
0xd2a: GOTO 0xd42
...
0xd2e: Push("changing state to c_iStateHeatHands") // @poff=1087
0xd2f: @ Trace(Stack[-1])
0xd30: Pop(1)
0xd31: GOTO 0xd42
...
0xd35: Push("changing state to c_iStateIdle") // @poff=1159
0xd36: @ Trace(Stack[-1])
0xd37: Pop(1)
0xd38: GOTO 0xd42
...
0xd3c: Push("changing state to c_iStatePatrol") // @poff=1221
0xd3d: @ Trace(Stack[-1])
0xd3e: Pop(1)
0xd3f: GOTO 0xd42
...
0xd42: Push(GlobalVars[2])
0xd43: Stack[-2] = Stack[-1]
0xd44: GlobalVars[2] = Stack[-1]; Pop(1)
0xd45: Stack[-2] = (bool) 1
0xd46: Return(); Pop(0)

0xd47: PushEmpty()
0xd48: Push(GlobalVars[2])
0xd49: Push((int) 4)
...
0xd4e: Push(GlobalVars[2])
0xd4f: Stack[-1] = (int) 4
0xd50: GlobalVars[2] = Stack[-1]; Pop(1)
0xd51: Push("changing state to c_iStateAware") // @poff=1287
0xd52: @ Trace(Stack[-1])
0xd53: Pop(1)
0xd54: Push(GlobalVars[4])
0xd55: Stack[-2] = Stack[-1]
0xd56: GlobalVars[4] = Stack[-1]; Pop(1)
0xd57: Stack[-2] = (bool) 1
0xd58: Return(); Pop(0)

0xd59: PushEmpty()
0xd5a: Push(GlobalVars[2])
0xd5b: Push((int) 5)
0xd5c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd5d: IF (Stack[-1] == 0) GOTO 0xd60; Pop(1)

0xd5e: Stack[-2] = (bool) 0
0xd5f: Return(); Pop(0)

0xd60: Push(GlobalVars[2])
0xd61: Stack[-1] = (int) 5
0xd62: GlobalVars[2] = Stack[-1]; Pop(1)
0xd63: Push("changing state to c_iStateSearchEnemy") // @poff=1351
0xd64: @ Trace(Stack[-1])
0xd65: Pop(1)
0xd66: Push(GlobalVars[5])
0xd67: Stack[-2] = Stack[-1]
0xd68: GlobalVars[5] = Stack[-1]; Pop(1)
0xd69: Stack[-2] = (bool) 1
0xd6a: Return(); Pop(0)

0xd6b: PushEmpty()
0xd6c: Push(GlobalVars[2])
0xd6d: Push((int) 6)
...
0xd72: Push(GlobalVars[2])
0xd73: Stack[-1] = (int) 6
0xd74: GlobalVars[2] = Stack[-1]; Pop(1)
0xd75: Push("changing state to c_iStateHearEnemy") // @poff=1427
0xd76: @ Trace(Stack[-1])
0xd77: Pop(1)
0xd78: Push(GlobalVars[6])
0xd79: Stack[-2] = Stack[-1]
0xd7a: GlobalVars[6] = Stack[-1]; Pop(1)
...
0xd87: Push("changing state to c_iStateAttack") // @poff=1499
0xd88: @ Trace(Stack[-1])
0xd89: Pop(1)
0xd8a: Push(GlobalVars[7])
0xd8b: Stack[-2] = Stack[-1]
0xd8c: GlobalVars[7] = Stack[-1]; Pop(1)
...
0xd92: Pop(0)
0xd93: Push("_locked") // @poff=1565
0xd94: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd95: @ GetVariable(Stack[-1], Stack[-2])
0xd96: Pop(1)
0xd97: Push((int) 0)
0xd98: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0xd99: Return(); Pop(2)
...
0xda4: Push((int) 0)
0xda5: @ SetVariable(Stack[-2], Stack[-1])
0xda6: Pop(2)
0xda7: Return(); Pop(0)
...
0xdb2: Pop(0)
0xdb3: Stack[-4] = Stack[-2] >= Stack[-1]; Pop(1);
0xdb4: Return(); Pop(2)

0xdb5: PushEmpty(int, int)
0xdb6: PushEmpty(string)
0xdb7: Call2 0xdf3

0xdb8: Pop(0)
0xdb9: Push("_locked") // @poff=1565
0xdba: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdbb: @ GetVariable(Stack[-1], Stack[-2])
0xdbc: Pop(1)
0xdbd: Push(Stack[-3])
0xdbe: IF (Stack[-1] == 0) GOTO 0xdc2; Pop(1)

0xdbf: Push((int) 1)
0xdc0: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdc1: GOTO 0xdc4

0xdc2: Push((int) -1)
0xdc3: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdc4: PushEmpty(string)
0xdc5: Call2 0xdf3

0xdc6: Pop(0)
0xdc7: Push("_locked") // @poff=1565
0xdc8: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdc9: @ SetVariable(Stack[-1], Stack[-2])
0xdca: Pop(1)
0xdcb: Return(); Pop(2)

0xdcc: PushEmpty()
0xdcd: PushEmpty(object, int, float)
0xdce: Stack[-7] = Stack[-3]
0xdcf: Stack[-6] = Stack[-2]
...
0xdd4: PushEmpty()
0xdd5: PushEmpty(object, int, float, cvector, cvector)
0xdd6: Stack[-11] = Stack[-5]
0xdd7: Stack[-10] = Stack[-4]
0xdd8: Stack[-9] = Stack[-3]
0xdd9: Stack[-7] = Stack[-2]
...
0xdde: PushEmpty(float, float)
0xddf: Push("health") // @poff=700
0xde0: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xde1: IF (Stack[-1] == 0) GOTO 0xdea; Pop(1)

0xde2: Push("health") // @poff=700
0xde3: @ GetProperty(Stack[-1], Stack[-2])
0xde4: Pop(1)
0xde5: Push((int) 0)
0xde6: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xde7: IF (Stack[-1] == 0) GOTO 0xdea; Pop(1)

0xde8: @ SignalDeath(Stack[-4])
0xde9: Pop(0)
0xdea: Return(); Pop(2)

0xdeb: PushEmpty()
0xdec: PushEmpty(object)
0xded: Stack[-2] = Stack[-1]
0xdee: Push(-1, 0); TaskCall(8)
0xdef: Call2 0x99e

0xdf0: Pop(-1, 0); TaskReturn
0xdf1: Pop(1)
0xdf2: Return(); Pop(0)

0xdf3: Stack[-1] = "pt_k5q03_patrol" // @poff=1581
0xdf4: Return(); Pop(0)

0xdf5: Stack[-1] = "k5q03_helpme" // @poff=1613
0xdf6: Return(); Pop(0)

0xdf7: Stack[-1] = "k5q03_corpse" // @poff=1639
0xdf8: Return(); Pop(0)

0xdf9: Stack[-1] = "pt_k5q03_center" // @poff=1665
0xdfa: Return(); Pop(0)

0xdfb: Stack[-1] = (int) 3
0xdfc: Return(); Pop(0)

0xdfd: PushEmpty(string, int, int, int)
0xdfe: Stack[-4] = "gold_ring" // @poff=1697
0xdff: Stack[-3] = (int) 1
0xe00: Stack[-2] = (int) 2
0xe01: Stack[-1] = (int) 2
0xe02: Call2 0xbbf
...
0xe05: Stack[-4] = "silver_ring" // @poff=1717
0xe06: Stack[-3] = (int) 1
0xe07: Stack[-2] = (int) 2
0xe08: Stack[-1] = (int) 3
0xe09: Call2 0xbbf
...
0xe13: Stack[-4] = "bracelet" // @poff=1753
0xe14: Stack[-3] = (int) 1
0xe15: Stack[-2] = (int) 2
0xe16: Stack[-1] = (int) 2
0xe17: Call2 0xbbf
