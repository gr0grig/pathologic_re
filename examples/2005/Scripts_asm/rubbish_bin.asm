...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:62006f00740074006c0065005f0065006d007000740079000000770061007400630068000000720061007a006f00720000006e006500650064006c006500000067006f006c0064005f00720069006e006700000049734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
...
0x1d: Stack[-4] = "bottle_empty" // @poff=0
0x1e: Stack[-3] = (int) 1
0x1f: Stack[-2] = (int) 2
0x20: Stack[-1] = (int) 1
0x21: Call2 0x5b
...
0x36: Stack[-3] = "gold_ring" // @poff=64
0x37: Stack[-2] = (int) 1
0x38: Stack[-1] = (int) 60
0x39: Call2 0x50
...
0x43: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=84
0x44: Pop(0)
0x45: Push(Stack[-2])
...
0x52: Stack[-7] = Stack[-2]
0x53: Stack[-6] = Stack[-1]
0x54: Call2 0x6a
...
0x70: Push("nouse_container") // @poff=95
