...
0x4ee: Pop(1)
0x4ef: Push((float)0.03999999910593033)
...
0x4f8: Push((float)0.03999999910593033)
...
0x7cc: Stack[-2] = Stack[-5]
0x7cd: Return(); Pop(4)

0x7ce: PushEmpty(int, int)
0x7cf: Push("branch") // @poff=910
...
0x7e4: Push("GenerateMoney: iMin > iMax") // @poff=924
0x7e5: @ Trace(Stack[-1])
0x7e6: Pop(1)
0x7e7: Return(); Pop(4)
...
0x802: Pop(0)
0x803: @@ SetItemName(Stack[-7]); Obj=3 // @poff=990
0x804: Pop(0)
0x805: Push("Organ") // @poff=1002
0x806: Push((int) 1)
0x807: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=298
0x808: Pop(2)
0x809: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1014
0x80a: Pop(0)
0x80b: Push((int) 0)
0x80c: Push((int) 1)
...
0x819: Stack[-1] = "liver" // @poff=1024
0x81a: Call2 0x800

0x81b: Pop(1)
0x81c: PushEmpty(string)
0x81d: Stack[-1] = "kidney" // @poff=1036
0x81e: Call2 0x800

0x81f: Pop(1)
0x820: PushEmpty(string)
0x821: Stack[-1] = "heart" // @poff=1050
0x822: Call2 0x800

0x823: Pop(1)
0x824: PushEmpty(string)
0x825: Stack[-1] = "blood" // @poff=1062
0x826: Call2 0x800
...
0x83a: Stack[-4] = "alpha_pills" // @poff=1084
0x83b: Stack[-3] = (int) 1
0x83c: Stack[-2] = (int) 3
0x83d: Stack[-1] = (int) 5
0x83e: Call2 0x6dc
...
0x841: Stack[-4] = "beta_pills" // @poff=1108
0x842: Stack[-3] = (int) 1
0x843: Stack[-2] = (int) 6
0x844: Stack[-1] = (int) 4
0x845: Call2 0x6dc
...
0x848: Stack[-4] = "gamma_pills" // @poff=1130
0x849: Stack[-3] = (int) 1
...
0x84f: Stack[-1] = "ognemet_ammo" // @poff=1154
0x850: Call2 0x857
...
0x85e: Stack[-7] = Stack[-2]
0x85f: Stack[-1] = "class" // @poff=1180
0x860: Call2 0x596
...
0x866: Push("class") // @poff=1180
0x867: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=376
0x868: Pop(1)
...
0x87d: Push("patrol") // @poff=1192
0x87e: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x87f: IF (Stack[-1] == 1) GOTO 0x884; Pop(1)

0x880: Push("sanitar") // @poff=1206
0x881: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x882: IF (Stack[-1] == 1) GOTO 0x884; Pop(1)

0x883: Stack[-1] = (bool) 0
0x884: IF (Stack[-1] == 1) GOTO 0x889; Pop(1)

0x885: Push("soldier") // @poff=1222
0x886: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x887: IF (Stack[-1] == 1) GOTO 0x889; Pop(1)

0x888: Stack[-1] = (bool) 0
0x889: IF (Stack[-1] == 1) GOTO 0x88e; Pop(1)

0x88a: Push("woman") // @poff=668
0x88b: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x88c: IF (Stack[-1] == 1) GOTO 0x88e; Pop(1)

0x88d: Stack[-1] = (bool) 0
0x88e: IF (Stack[-1] == 1) GOTO 0x893; Pop(1)

0x88f: Push("wasted_girl") // @poff=710
0x890: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x891: IF (Stack[-1] == 1) GOTO 0x893; Pop(1)

0x892: Stack[-1] = (bool) 0
0x893: IF (Stack[-1] == 1) GOTO 0x898; Pop(1)

0x894: Push("vaxxabitka") // @poff=742
0x895: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x896: IF (Stack[-1] == 1) GOTO 0x898; Pop(1)

0x897: Stack[-1] = (bool) 0
0x898: IF (Stack[-1] == 1) GOTO 0x89d; Pop(1)

0x899: Push("vaxxabit") // @poff=836
0x89a: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x89b: IF (Stack[-1] == 1) GOTO 0x89d; Pop(1)

0x89c: Stack[-1] = (bool) 0
0x89d: IF (Stack[-1] == 1) GOTO 0x8a2; Pop(1)

0x89e: Push("little_girl") // @poff=1238
0x89f: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x8a0: IF (Stack[-1] == 1) GOTO 0x8a2; Pop(1)

0x8a1: Stack[-1] = (bool) 0
0x8a2: IF (Stack[-1] == 1) GOTO 0x8a7; Pop(1)

0x8a3: Push("girl") // @poff=724
0x8a4: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8a5: IF (Stack[-1] == 1) GOTO 0x8a7; Pop(1)

0x8a6: Stack[-1] = (bool) 0
0x8a7: IF (Stack[-1] == 1) GOTO 0x8ac; Pop(1)

0x8a8: Push("dohodyaga") // @poff=816
0x8a9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8aa: IF (Stack[-1] == 1) GOTO 0x8ac; Pop(1)

0x8ab: Stack[-1] = (bool) 0
0x8ac: IF (Stack[-1] == 1) GOTO 0x8b1; Pop(1)

0x8ad: Push("nudegirl") // @poff=854
...
0x8c3: Push("worker") // @poff=680
0x8c4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8c5: IF (Stack[-1] == 1) GOTO 0x8ca; Pop(1)

0x8c6: Push("butcher") // @poff=694
0x8c7: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8c8: IF (Stack[-1] == 1) GOTO 0x8ca; Pop(1)

0x8c9: Stack[-1] = (bool) 0
0x8ca: IF (Stack[-1] == 1) GOTO 0x8cf; Pop(1)

0x8cb: Push("boy") // @poff=734
0x8cc: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x8cd: IF (Stack[-1] == 1) GOTO 0x8cf; Pop(1)

0x8ce: Stack[-1] = (bool) 0
0x8cf: IF (Stack[-1] == 1) GOTO 0x8d4; Pop(1)

0x8d0: Push("unosha") // @poff=764
0x8d1: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8d2: IF (Stack[-1] == 1) GOTO 0x8d4; Pop(1)

0x8d3: Stack[-1] = (bool) 0
0x8d4: IF (Stack[-1] == 1) GOTO 0x8d9; Pop(1)

0x8d5: Push("wasted_male") // @poff=778
0x8d6: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8d7: IF (Stack[-1] == 1) GOTO 0x8d9; Pop(1)

0x8d8: Stack[-1] = (bool) 0
0x8d9: IF (Stack[-1] == 1) GOTO 0x8de; Pop(1)

0x8da: Push("alkash") // @poff=802
0x8db: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8dc: IF (Stack[-1] == 1) GOTO 0x8de; Pop(1)

0x8dd: Stack[-1] = (bool) 0
0x8de: IF (Stack[-1] == 1) GOTO 0x8e3; Pop(1)

0x8df: Push("morlok") // @poff=872
0x8e0: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x8e1: IF (Stack[-1] == 1) GOTO 0x8e3; Pop(1)
...
0x8f2: Pop(0)
0x8f3: Push("flame") // @poff=1262
0x8f4: Push([0.0, 0.0, 0.0])
...
0x8fb: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=1274
0x8fc: Pop(2)
0x8fd: Push(GlobalVars[3])
0x8fe: Stack[-1] = (bool) 0
0x8ff: GlobalVars[3] = Stack[-1]; Pop(1)
0x900: Push((float)0.05000000074505806)
0x901: @@ SetLength(Stack[-1]); Obj=2 // @poff=1281
0x902: Pop(1)
0x903: Push(GlobalVars[0])
0x904: Stack[-2] = Stack[-1]
0x905: GlobalVars[0] = Stack[-1]; Pop(1)
0x906: Push((int) 70)
0x907: Push((float)0.10000000149011612)
...
0x911: Stack[-1] = Stack[-6]
0x912: Pop(1)
0x913: GOTO 0x915

0x914: Stack[-5] = (float) 0.05000000074505806
0x915: Push(GlobalVars[0])
0x916: @@ GetLength(Stack[-5]); Obj=1 // @poff=1291
0x917: Pop(1)
0x918: Pop(0); Push((bool) Stack[-5] < Stack[-4])
0x919: IF (Stack[-1] == 0) GOTO 0x91b; Pop(1)

0x91a: Stack[-5] = Stack[-4]
0x91b: Push(GlobalVars[0])
0x91c: @@ SetLength(Stack[-5]); Obj=1 // @poff=1281
0x91d: Pop(1)
...
0x93e: Push((int) 2)
0x93f: @@ FadeOut(Stack[-1]); Obj=2 // @poff=1330
0x940: Pop(2)
0x941: Push(GlobalVars[3])
0x942: Stack[-12] = Stack[-1]
...
0x981: @@ in(Stack[-6], Stack[-12]); Obj=1 // @poff=1370
0x982: Pop(1)
0x983: Push(Stack[-5])
...
0x988: Stack[-13] = Stack[-1]
0x989: Call2 0x591

0x98a: Pop(1)
0x98b: IF (Stack[-1] == 0) GOTO 0x99a; Pop(1)

0x98c: Push("reputation") // @poff=1373
0x98d: @@ GetProperty(Stack[-1], Stack[-5]); Obj=12 // @poff=376
0x98e: Pop(1)
0x98f: Push((float)0.33000001311302185)
...
0x994: Push("disease") // @poff=264
0x995: @@ GetProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=376
0x996: Pop(1)
0x997: Push((float)0.33000001311302185)
0x998: Stack[-13] = Stack[-4] > Stack[-1]; Pop(1);
0x999: Return(); Pop(10)

0x99a: PushEmpty(bool, object, string)
0x99b: Stack[-14] = Stack[-2]
0x99c: Stack[-1] = "class" // @poff=1180
0x99d: Call2 0x596
...
0x9a3: Push("class") // @poff=1180
0x9a4: @@ GetProperty(Stack[-1], Stack[-3]); Obj=12 // @poff=376
0x9a5: Pop(1)
...
0x9ac: Push("bomber") // @poff=1395
0x9ad: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x9ae: IF (Stack[-1] == 1) GOTO 0x9b3; Pop(1)

0x9af: Push("hunter") // @poff=1409
0x9b0: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x9b1: IF (Stack[-1] == 1) GOTO 0x9b3; Pop(1)

0x9b2: Stack[-1] = (bool) 0
0x9b3: IF (Stack[-1] == 1) GOTO 0x9b8; Pop(1)

0x9b4: Push("grabitel") // @poff=1423
0x9b5: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x9b6: IF (Stack[-1] == 1) GOTO 0x9b8; Pop(1)

0x9b7: Stack[-1] = (bool) 0
0x9b8: IF (Stack[-1] == 1) GOTO 0x9bd; Pop(1)

0x9b9: Push("rat_big") // @poff=1441
...
0x9c1: Stack[-14] = Stack[-2]
0x9c2: Stack[-1] = "disease" // @poff=264
0x9c3: Call2 0x596
...
0x9cc: Stack[-5] = Stack[-1]
0x9cd: Call2 0x714

0x9ce: Pop(1)
0x9cf: IF (Stack[-1] == 1) GOTO 0x9d4; Pop(1)

0x9d0: Push("dog") // @poff=1457
0x9d1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9d2: IF (Stack[-1] == 1) GOTO 0x9d4; Pop(1)

0x9d3: Stack[-1] = (bool) 0
0x9d4: IF (Stack[-1] == 0) GOTO 0x9db; Pop(1)

0x9d5: Push("disease") // @poff=264
0x9d6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=376
0x9d7: Pop(1)
0x9d8: Push((int) 0)
...
0xa02: Stack[-2] = Stack[-4]
0xa03: Pop(2)
0xa04: Return(); Pop(0)

0xa05: PushEmpty()
0xa06: PushEmpty(object)
0xa07: Stack[-2] = Stack[-1]
0xa08: Call2 0x9dd
...
0xa1d: Pop(0); PushNull((bool) Stack[-5] == 0)
0xa1e: IF (Stack[-1] == 1) GOTO 0xa26; Pop(1)

0xa1f: PushEmpty(bool, object)
0xa20: Stack[-7] = Stack[-1]
0xa21: Call2 0x5eb
...
0xa26: IF (Stack[-1] == 1) GOTO 0xa2f; Pop(1)

0xa27: PushEmpty(bool, object, string)
0xa28: Stack[-7] = Stack[-2]
0xa29: Stack[-1] = "disease" // @poff=264
0xa2a: Call2 0x596

0xa2b: Pop(2)
0xa2c: Pop(1); Push((bool) Stack[-1] == 0)
0xa2d: IF (Stack[-1] == 1) GOTO 0xa2f; Pop(1)
...
0xa32: Push("disease") // @poff=264
0xa33: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=376
0xa34: Pop(1)
0xa35: Push((int) 0)
...
0xa55: Pop(0)
0xa56: Push((float)-0.07000000029802322)
...
0xa67: Pop(0)
0xa68: Push((float)-0.12999999523162842)
0xa69: Push((bool) 1)
...
0xa75: Stack[-7] = Stack[-3]
0xa76: Stack[-6] = Stack[-2]
0xa77: Stack[-5] = Stack[-1]
0xa78: Call2 0x67a
...
0xa7d: Stack[-11] = Stack[-5]
0xa7e: Stack[-10] = Stack[-4]
0xa7f: Stack[-9] = Stack[-3]
0xa80: Stack[-7] = Stack[-2]
0xa81: Stack[-6] = Stack[-1]
0xa82: Call2 0x6be
...
0xaa3: Push(Stack[-2])
0xaa4: IF (Stack[-1] == 1) GOTO 0xaad; Pop(1)
...
0xab2: PushEmpty(object, float, object, bool, float, float, float, object, float, object, bool, float, float, float)
0xab3: Push((int) 70)
0xab4: Pop(1); Push((bool) Stack[-16] != Stack[-1])
0xab5: IF (Stack[-1] == 0) GOTO 0xab7; Pop(1)

0xab6: Return(); Pop(14)

0xab7: Push(GlobalVars[0])
0xab8: Pop(1); PushNull((bool) Stack[-1] == 0)
0xab9: IF (Stack[-1] == 0) GOTO 0xabb; Pop(1)

0xaba: Return(); Pop(14)

0xabb: Push(GlobalVars[0])
0xabc: @@ Intersect(Stack[-8], Stack[-7]); Obj=1 // @poff=1465
0xabd: Pop(1)
...
0xac9: Push((float)0.05000000074505806)
0xaca: @@ SetLength(Stack[-1]); Obj=2 // @poff=1281
0xacb: Pop(2)
0xacc: PushEmpty()
0xacd: Call2 0x7ab

0xace: Pop(0)
0xacf: @@ Next(Stack[-4], Stack[-5]); Obj=7 // @poff=1475
0xad0: Pop(0)
0xad1: Push(Stack[-4])
0xad2: IF (Stack[-1] == 0) GOTO 0xb07; Pop(1)

0xad3: PushEmpty(bool)
0xad4: Stack[-1] = (bool) 0
0xad5: Pop(0); Push(( Stack[-6] != 0 )
...
0xad9: Pop(0)
0xada: Pop(1); Push((bool) Stack[-7] != Stack[-1])
0xadb: IF (Stack[-1] == 0) GOTO 0xadd; Pop(1)

0xadc: Stack[-1] = (bool) 1
0xadd: IF (Stack[-1] == 0) GOTO 0xb06; Pop(1)

0xade: PushEmpty(float, object, float, int)
0xadf: Stack[-9] = Stack[-3]
0xae0: Stack[-2] = (float) 0.10000000149011612
0xae1: Stack[-1] = (int) 2
0xae2: Call2 0x5a2

0xae3: Stack[-4] = Stack[-7]
0xae4: Pop(4)
0xae5: PushEmpty(bool, object, string)
0xae6: Stack[-8] = Stack[-2]
0xae7: Stack[-1] = "disease" // @poff=264
0xae8: Call2 0x596

0xae9: Pop(2)
0xaea: IF (Stack[-1] == 0) GOTO 0xaf8; Pop(1)

0xaeb: Push("disease") // @poff=264
0xaec: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=376
0xaed: Pop(1)
0xaee: Push((float)0.03999999910593033)
...
0xaf3: Push((float)0.03999999910593033)
0xaf4: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0xaf5: Push("disease") // @poff=264
0xaf6: @@ SetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=298
0xaf7: Pop(1)
0xaf8: PushEmpty(bool, object, string)
0xaf9: Stack[-8] = Stack[-2]
0xafa: Stack[-1] = "fire" // @poff=421
0xafb: Call2 0x596

0xafc: Pop(2)
0xafd: IF (Stack[-1] == 0) GOTO 0xb06; Pop(1)

0xafe: Push("fire") // @poff=421
0xaff: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=376
0xb00: Pop(1)
0xb01: Push("fire") // @poff=421
0xb02: Push((float)0.10000000149011612)
0xb03: Pop(1); Push(Stack[-3] + Stack[-1]);
0xb04: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=298
0xb05: Pop(2)
0xb06: GOTO 0xacf
...
0xb09: Stack[-7] = 0
0xb0a: PushEmpty()
0xb0b: PushEmpty(bool, object)
0xb0c: Stack[-3] = Stack[-1]
0xb0d: Call2 0x977

0xb0e: Stack[-2] = Stack[-4]
0xb0f: Pop(2)
0xb10: Return(); Pop(0)
