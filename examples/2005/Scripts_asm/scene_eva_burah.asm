...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0xf: Stack[-1] = "NPC_Burah_Danko.xml" // @poff=44
0x10: Call2 0x45
...
0x1c: Stack[-1] = "NPC_Burah_Eva.xml" // @poff=114
0x1d: Call2 0x45
...
0x46: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=178
0x47: Pop(0)
0x48: Pop(0); Push((bool) Stack[-4] == 0)
0x49: IF (Stack[-1] == 0) GOTO 0x52; Pop(1)

0x4a: Push("Locator ") // @poff=189
0x4b: Pop(1); Push(Stack[-1] + Stack[-12]);
0x4c: Push(" doesn't exist") // @poff=207
