...
Strings:
	W:pt_burah
	W:NPC_Burah
	W:NPC_Klara_Burah.xml
	W:noburah
	A:GetLocator
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0xa: Stack[-1] = Stack[-5]
0xb: Pop(1)
0xc: Stack[-3] = "pt_burah" // @poff=0
0xd: Stack[-2] = "NPC_Burah" // @poff=18
0xe: Stack[-1] = "NPC_Klara_Burah.xml" // @poff=38
0xf: Call2 0x29
