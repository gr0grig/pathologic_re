...
Strings:
	...
	W:pt_fog
	W:fog_stat.xml
// @pool_raw:
...
0x1: Stack[-2] = "woman" // @poff=0
0x2: Stack[-1] = "woman" // @poff=0
0x3: Call2 0x14

0x4: Pop(2)
0x5: PushEmpty(string, string)
0x6: Stack[-2] = "worker" // @poff=12
0x7: Stack[-1] = "man" // @poff=4
0x8: Call2 0x14
...
0x1f: Stack[-14] = Stack[-4]
0x20: Stack[-13] = Stack[-3]
0x21: Stack[-6] = Stack[-2]
...
0x59: Push("New fog at ") // @poff=84
0x5a: Pop(1); Push(Stack[-1] + Stack[-4]);
0x5b: @ Trace(Stack[-1])
0x5c: Pop(1)
0x5d: Push("fog") // @poff=108
0x5e: PushEmpty(object)
0x5f: Call2 0x88

0x60: Pop(0)
0x61: Push([0.0, 0.0, 1.0])
0x62: Push("horror_fog.xml") // @poff=116
...
0x7f: Push("fog") // @poff=108
0x80: PushEmpty(object)
0x81: Call2 0x88

0x82: Pop(0)
0x83: Push("fog_stat.xml") // @poff=160
