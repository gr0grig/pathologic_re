...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0xb: Stack[-1] = Stack[-5]
0xc: Pop(1)
0xd: Stack[-3] = "pt_kapella" // @poff=0
0xe: Stack[-2] = "NPC_Kapella" // @poff=22
0xf: Stack[-1] = "NPC_Burah_Kapella.xml" // @poff=46
0x10: Call2 0x45
...
0x19: Pop(1)
0x1a: Stack[-3] = "pt_han" // @poff=90
0x1b: Stack[-2] = "NPC_Han" // @poff=104
0x1c: Stack[-1] = "NPC_Burah_Han.xml" // @poff=120
0x1d: Call2 0x45
...
0x23: @ RemoveActor(Stack[-2]T)
0x24: Pop(0)
0x25: Push( Stack[3 + Tasks[-1].StackPointer] )
0x26: IF (Stack[-1] == 0) GOTO 0x29; Pop(1)

0x27: @ RemoveActor(Stack[-3]T)
0x28: Pop(0)
0x29: Return(); Pop(0)

0x2a: PushEmpty()
0x2b: Push("nokapella") // @poff=156
...
0x46: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=188
0x47: Pop(0)
0x48: Pop(0); Push((bool) Stack[-4] == 0)
0x49: IF (Stack[-1] == 0) GOTO 0x52; Pop(1)

0x4a: Push("Locator ") // @poff=199
0x4b: Pop(1); Push(Stack[-1] + Stack[-12]);
0x4c: Push(" doesn't exist") // @poff=217
