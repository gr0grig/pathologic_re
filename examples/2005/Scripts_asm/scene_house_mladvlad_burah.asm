...
Strings:
	...
	A:get
	A:clear
// @pool_raw:640038007100300031005f00770065006c006c005f0062006c006f0063006b00000073697a650067657400636c65617200
...
0x9: Push("d8q01_well_block") // @poff=0
0xa: PushEmpty(object)
0xb: Call2 0x2c

0xc: Pop(0)
0xd: Push([0.0, 0.0, 0.0])
...
0x3b: @@ size(Stack[-3]); Obj=7 // @poff=34
0x3c: Pop(0)
0x3d: Stack[-2] = (int) 0
0x3e: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x3f: IF (Stack[-1] == 0) GOTO 0x4a; Pop(1)

0x40: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=39
0x41: Pop(0)
0x42: Push(Stack[-1])
