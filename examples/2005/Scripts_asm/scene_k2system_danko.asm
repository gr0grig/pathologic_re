...
// @pool_raw:
...
0x94: Stack[-2] = "NPC_Bakalavr" // @poff=192
0x95: Stack[-1] = "k2system_danko.xml" // @poff=218
0x96: Call2 0x75
...
0x9a: PushEmpty()
0x9b: Push("pers_wasted_male") // @poff=256
0x9c: @@ add(Stack[-1]); Obj=4 // @poff=81
0x9d: Pop(1)
0x9e: Push("k2system_wasted_male.xml") // @poff=290
0x9f: @@ add(Stack[-1]); Obj=3 // @poff=81
0xa0: Pop(1)
0xa1: Push((bool) 0)
0xa2: @@ add(Stack[-1]); Obj=2 // @poff=81
0xa3: Pop(1)
0xa4: Push("pers_wasted_male") // @poff=256
0xa5: @@ add(Stack[-1]); Obj=4 // @poff=81
0xa6: Pop(1)
0xa7: Push("k2system_wasted_male.xml") // @poff=290
0xa8: @@ add(Stack[-1]); Obj=3 // @poff=81
0xa9: Pop(1)
0xaa: Push((bool) 0)
0xab: @@ add(Stack[-1]); Obj=2 // @poff=81
0xac: Pop(1)
0xad: Push("pers_patrool") // @poff=340
0xae: @@ add(Stack[-1]); Obj=4 // @poff=81
0xaf: Pop(1)
0xb0: Push("k2system_patrol.xml") // @poff=366
