...
Strings:
// @pool_raw:
// @pool_encoding:utf8
...
0x28: Stack[-4] = (int) 1
0x29: Push("pt_item_food") // @poff=16
...
0x31: Stack[-5] = Stack[-3]
0x32: Stack[-4] = Stack[-2]
0x33: Stack[-12] = Stack[-1]
0x34: Call2 0x73
...
0x3b: Stack[-4] = (int) 1
0x3c: Push("pt_item_pfood") // @poff=42
...
0x44: Stack[-5] = Stack[-3]
0x45: Stack[-4] = Stack[-2]
0x46: Stack[-12] = Stack[-1]
0x47: Call2 0xae
...
0x4e: Stack[-4] = (int) 1
0x4f: Push("pt_item_knife") // @poff=70
...
0x57: Stack[-5] = Stack[-3]
0x58: Stack[-4] = Stack[-2]
0x59: Stack[-12] = Stack[-1]
0x5a: Call2 0x101
...
0x61: Stack[-4] = (int) 1
0x62: Push("pt_item_bottle") // @poff=98
...
0x6a: Stack[-5] = Stack[-3]
0x6b: Stack[-4] = Stack[-2]
0x6c: Stack[-12] = Stack[-1]
0x6d: Call2 0x114
...
0x77: Stack[-1] = (float) 0.05000000074505806
0x78: GOTO 0x7a

0x79: Stack[-1] = (float) 0.20000000298023224
0x7a: Call2 0x1c9
...
0x80: Push((int) 2)
0x81: Push((int) 3)
0x82: Push("bread") // @poff=128
0x83: Push("bottle_water") // @poff=140
0x84: Push("milk") // @poff=166
0x85: Push("vegetables") // @poff=176
0x86: Push("lemon") // @poff=198
0x87: @ RandOneOf(Stack[-16], Stack[-10], Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x88: Pop(10)
0x89: Push("scripted_container") // @poff=210
0x8a: PushEmpty(object)
0x8b: Call2 0x1c3

0x8c: Pop(0)
0x8d: Push("item_") // @poff=248
0x8e: Pop(1); Push(Stack[-1] + Stack[-9]);
0x8f: Push("_steal.xml") // @poff=260
...
0xa5: Push("scripted_container") // @poff=210
0xa6: PushEmpty(object)
0xa7: Call2 0x1c3

0xa8: Pop(0)
0xa9: Push("item_plate.xml") // @poff=282
...
0xb2: Stack[-1] = (float) 0.05000000074505806
0xb3: GOTO 0xb5

0xb4: Stack[-1] = (float) 0.20000000298023224
0xb5: Call2 0x1c9
...
0xbd: Push((int) 2)
0xbe: Push((int) 1)
0xbf: Push("rusk") // @poff=312
0xc0: Push("dried_fish") // @poff=322
0xc1: Push("dried_meat") // @poff=344
0xc2: Push("smoked_meat") // @poff=366
0xc3: Push("fresh_fish") // @poff=390
0xc4: Push("fresh_meat") // @poff=412
0xc5: Push("tvirin") // @poff=434
...
0xf8: Push("scripted_container") // @poff=210
0xf9: PushEmpty(object)
0xfa: Call2 0x1c3

0xfb: Pop(0)
0xfc: Push("item_plate.xml") // @poff=282
...
0x105: Stack[-1] = (float) 0.05000000074505806
0x106: GOTO 0x108

0x107: Stack[-1] = (float) 0.05000000074505806
0x108: Call2 0x1c9

0x109: Pop(1)
0x10a: IF (Stack[-1] == 0) GOTO 0x113; Pop(1)

0x10b: Push("scripted_container") // @poff=210
0x10c: PushEmpty(object)
0x10d: Call2 0x1c3

0x10e: Pop(0)
0x10f: Push("item_knife_steal.xml") // @poff=448
...
0x118: Stack[-1] = (float) 0.20000000298023224
0x119: GOTO 0x11b

0x11a: Stack[-1] = (float) 0.4000000059604645
0x11b: Call2 0x1c9
...
0x122: Push((int) 3)
0x123: Push((int) 1)
0x124: Push("bottle_water") // @poff=140
0x125: Push("bottle_empty") // @poff=490
0x126: Push("vegetables") // @poff=176
0x127: Push("milk") // @poff=166
0x128: Push("egg") // @poff=516
0x129: Push("tvirin") // @poff=434
...
0x12b: Pop(12)
0x12c: Push("scripted_container") // @poff=210
0x12d: PushEmpty(object)
0x12e: Call2 0x1c3

0x12f: Pop(0)
0x130: Push("item_") // @poff=248
0x131: Pop(1); Push(Stack[-1] + Stack[-5]);
0x132: Push("_steal.xml") // @poff=260
...
0x140: @ CreateIntVector(Stack[-0]T)
0x141: Pop(0)
...
0x153: @ CreateIntVector(Stack[-0]T)
0x154: Pop(0)
...
0x158: Pop(1)
0x159: @@@ size(Stack[-8]); Obj=0 // @poff=524
0x15a: Pop(0)
0x15b: Stack[-7] = (int) 0
0x15c: Pop(0); Push((bool) Stack[-7] < Stack[-8])
0x15d: IF (Stack[-1] == 0) GOTO 0x189; Pop(1)

0x15e: @@@ get(Stack[-6], Stack[-7]); Obj=0 // @poff=529
0x15f: Pop(0)
0x160: Push((int) 1)
0x161: Pop(1); Push(Stack[-8] + Stack[-1]);
0x162: @@@ get(Stack[-6], Stack[-1]); Obj=0 // @poff=529
0x163: Pop(1)
0x164: Push((int) 2)
0x165: Pop(1); Push(Stack[-8] + Stack[-1]);
0x166: @@@ get(Stack[-5], Stack[-1]); Obj=0 // @poff=529
0x167: Pop(1)
0x168: PushEmpty(string, int, int)
0x169: Stack[-9] = Stack[-2]
0x16a: Stack[-8] = Stack[-1]
0x16b: Call2 0x2

0x16c: Stack[-3] = Stack[-6]
0x16d: Pop(3)
0x16e: PushEmpty(string, int, int)
0x16f: Stack[-9] = Stack[-2]
0x170: Stack[-7] = Stack[-1]
0x171: Call2 0x5

0x172: Stack[-3] = Stack[-5]
0x173: Pop(3)
0x174: PushEmpty(string, int, int)
0x175: Stack[-9] = Stack[-2]
0x176: Stack[-7] = Stack[-1]
0x177: Call2 0x8

0x178: Stack[-3] = Stack[-4]
0x179: Pop(3)
...
0x17e: Pop(1)
0x17f: Stack[-8] = Stack[-3]
0x180: Stack[-7] = Stack[-2]
0x181: Stack[-6] = Stack[-1]
0x182: Call2 0x1d4

0x183: Pop(4)
0x184: @@@ add(Stack[-1]); Obj=1 // @poff=533
0x185: Pop(1)
0x186: Push((int) 3)
...
0x1a3: Pop(0)
0x1a4: @@@ remove(Stack[-3]); Obj=1 // @poff=556
0x1a5: Pop(0)
0x1a6: Push((int) 3)
...
0x1ac: @@@ remove(Stack[-2], Stack[-1]); Obj=0 // @poff=556
0x1ad: Pop(2)
0x1ae: Push((int) -1)
...
0x1b8: Push("HasProperty") // @poff=563
0x1b9: Push((int) 2)
...
0x1bf: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=587
0x1c0: Pop(0)
...
0x1e9: @@ size(Stack[-3]); Obj=7 // @poff=524
0x1ea: Pop(0)
0x1eb: Stack[-2] = (int) 0
0x1ec: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x1ed: IF (Stack[-1] == 0) GOTO 0x1f8; Pop(1)

0x1ee: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=529
0x1ef: Pop(0)
0x1f0: Push(Stack[-1])
