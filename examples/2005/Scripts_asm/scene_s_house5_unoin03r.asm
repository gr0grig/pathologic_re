...
Strings:
	...
	W:pt_fog
	W:fog_stat.xml
// @pool_raw:
...
0x1: Stack[-2] = "quest_b4_02" // @poff=0
0x2: Stack[-1] = "house_load" // @poff=24
0x3: Call2 0x9c
...
0xa: Stack[-2] = "woman" // @poff=46
0xb: Stack[-1] = "woman" // @poff=46
0xc: Call2 0x1d

0xd: Pop(2)
0xe: PushEmpty(string, string)
0xf: Stack[-2] = "worker" // @poff=58
0x10: Stack[-1] = "man" // @poff=50
0x11: Call2 0x1d
...
0x28: Stack[-14] = Stack[-4]
0x29: Stack[-13] = Stack[-3]
0x2a: Stack[-6] = Stack[-2]
0x2b: Stack[-5] = Stack[-1]
0x2c: Call2 0x32
...
0x62: Push("New fog at ") // @poff=130
0x63: Pop(1); Push(Stack[-1] + Stack[-4]);
0x64: @ Trace(Stack[-1])
0x65: Pop(1)
0x66: Push("fog") // @poff=154
0x67: PushEmpty(object)
0x68: Call2 0x91

0x69: Pop(0)
0x6a: Push([0.0, 0.0, 1.0])
0x6b: Push("horror_fog.xml") // @poff=162
...
0x88: Push("fog") // @poff=154
0x89: PushEmpty(object)
0x8a: Call2 0x91

0x8b: Pop(0)
0x8c: Push("fog_stat.xml") // @poff=206
...
0x9e: Pop(0)
0x9f: Pop(0); PushNull((bool) Stack[-1] == 0)
