...
Strings:
	...
	A:size
	A:clear
// @pool_raw:
...
0x22: @@ add(Stack[-4]); Obj=5 // @poff=66
0x23: Pop(0)
0x24: Push((int) 1)
...
0x2c: Pop(0)
0x2d: @@ get(Stack[-1], Stack[-2]); Obj=5 // @poff=70
0x2e: Pop(0)
0x2f: @@ remove(Stack[-2]); Obj=5 // @poff=74
0x30: Pop(0)
0x31: Push((int) -1)
...
0x3b: Stack[-1] = "termitnik_butcher.xml" // @poff=107
0x3c: Call2 0x56
...
0x57: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=151
0x58: Pop(0)
0x59: Pop(0); Push((bool) Stack[-4] == 0)
0x5a: IF (Stack[-1] == 0) GOTO 0x63; Pop(1)

0x5b: Push("Locator ") // @poff=162
0x5c: Pop(1); Push(Stack[-1] + Stack[-12]);
0x5d: Push(" doesn't exist") // @poff=180
...
0x6b: @@ size(Stack[-3]); Obj=7 // @poff=210
0x6c: Pop(0)
0x6d: Stack[-2] = (int) 0
0x6e: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x6f: IF (Stack[-1] == 0) GOTO 0x7a; Pop(1)

0x70: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=70
0x71: Pop(0)
0x72: Push(Stack[-1])
