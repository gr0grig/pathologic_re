...
Strings:
	...
	A:SetProperty
	A:RemoveProperty
// @pool_raw:
...
0x6c: Push("noaccess") // @poff=298
0x6d: @@ HasProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=316
0x6e: Pop(1)
0x6f: Push(Stack[-2])
0x70: IF (Stack[-1] == 0) GOTO 0x7a; Pop(1)

0x71: Push("noaccess") // @poff=298
0x72: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=328
0x73: Pop(1)
0x74: Push("noaccess") // @poff=298
0x75: Push((int) 1)
0x76: Pop(1); Push(Stack[-3] + Stack[-1]);
0x77: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=340
0x78: Pop(2)
0x79: GOTO 0x7e

0x7a: Push("noaccess") // @poff=298
0x7b: Push((int) 1)
0x7c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=340
0x7d: Pop(2)
0x7e: Return(); Pop(4)
...
0x83: Push("noaccess") // @poff=298
0x84: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=328
0x85: Pop(1)
0x86: Push((int) 1)
0x87: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x88: IF (Stack[-1] == 0) GOTO 0x8f; Pop(1)

0x89: Push("noaccess") // @poff=298
0x8a: Push((int) 1)
0x8b: Pop(1); Push(Stack[-3] - Stack[-1]);
0x8c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=340
0x8d: Pop(2)
0x8e: GOTO 0x92

0x8f: Push("noaccess") // @poff=298
0x90: @@ RemoveProperty(Stack[-1]); Obj=4 // @poff=352
0x91: Pop(1)
0x92: Return(); Pop(2)
...
0xc5: Push("Performance") // @poff=106
