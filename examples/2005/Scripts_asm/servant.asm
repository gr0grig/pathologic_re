...
0x11: Push("player") // @poff=0
0x12: @ FindActor(Stack[-4]T, Stack[-1])
0x13: Pop(1)
...
0x26: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x9e: Pop(0)
0x9f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=32
0xa0: Pop(0)
