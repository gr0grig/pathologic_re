...
Strings:
	W:Unloaded dynamic light
// @pool_raw:55006e006c006f0061006400650064002000640079006e0061006d006900630020006c0069006700680074000000
...
0xa: Push("Unloaded dynamic light") // @poff=0
0xb: @ Trace(Stack[-1])
0xc: Pop(1)
