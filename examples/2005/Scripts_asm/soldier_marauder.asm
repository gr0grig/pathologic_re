...
Strings:
	...
	W:tourniquet
	W:health
// @pool_raw:
...
0xa5: Push((int) 110)
0xa6: Push((float)0.30000001192092896)
...
0x120: Stack[-7] = Stack[-1]
0x121: Call2 0x151

0x122: Stack[-2] = Stack[-4]
0x123: Pop(2)
...
0x15a: Pop(0)
0x15b: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x15c: Pop(0)
...
0x179: Stack[-1] = (float) 1.7453293800354004
0x17a: Call2 0x158

0x17b: Stack[-2] = Stack[-7]
0x17c: Pop(2)
...
0x182: Stack[-1] = (float) 2.6179938316345215
0x183: Call2 0x158
...
0x18a: Push("Can't retreat, distance: ") // @poff=178
...
0x1a0: Push((int) 1)
0x1a1: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x1a2: Pop(1)
0x1a3: Push(Stack[-3])
0x1a4: IF (Stack[-1] == 0) GOTO 0x1bc; Pop(1)

0x1a5: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x1aa: Stack[-1] = (float) 2.6179938316345215
0x1ab: Call2 0x158

0x1ac: Stack[-2] = Stack[-4]
0x1ad: Pop(2)
...
0x1bd: IF (Stack[-1] == 1) GOTO 0x1a0; Pop(1)
...
0x1c4: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x1d3: Stack[-1] = (float) 1.7453293800354004
0x1d4: Call2 0x158

0x1d5: Stack[-2] = Stack[-4]
0x1d6: Pop(2)
...
0x1e3: IF (Stack[-1] == 1) GOTO 0x1e9; Pop(1)
...
0x20f: Pop(2)
0x210: Push((float)-0.3420201241970062)
...
0x21a: Pop(0)
0x21b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x21c: Pop(0)
...
0x221: Pop(0)
0x222: Stack[-1] = Stack[-4]
0x223: Return(); Pop(2)

0x224: PushEmpty(bool, bool)
0x225: Push("HasProperty") // @poff=230
0x226: Push((int) 2)
...
0x22c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=254
0x22d: Pop(0)
0x22e: Stack[-1] = Stack[-5]
0x22f: Return(); Pop(2)

0x230: PushEmpty(bool, bool)
0x231: @@ IsDead(Stack[-1]); Obj=3 // @poff=266
0x232: Pop(0)
0x233: Stack[-1] = Stack[-4]
0x234: Return(); Pop(2)

0x235: PushEmpty(object, object, object, object)
0x236: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x24a: Pop(0)
0x24b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x24c: IF (Stack[-1] == 0) GOTO 0x24f; Pop(1)

0x24d: Stack[-6] = (bool) 0
0x24e: Return(); Pop(4)

0x24f: @@ GetScene(Stack[-1]); Obj=5 // @poff=287
0x250: Pop(0)
...
0x264: Stack[-1] = "noaccess" // @poff=296
0x265: Call2 0x224
...
0x26b: Push("noaccess") // @poff=296
0x26c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=314
0x26d: Pop(1)
0x26e: Push((int) 0)
...
0x272: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x280: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x281: Pop(0)
...
0x291: Stack[-1] = "fhit" // @poff=326
0x292: GOTO 0x294

0x293: Stack[-1] = "bhit" // @poff=336
0x294: Push("hit_react") // @poff=346
0x295: Push("1") // @poff=366
0x296: Pop(1); Push(Stack[-3] + Stack[-1]);
0x297: Push("2") // @poff=370
...
0x2cf: Pop(0)
0x2d0: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=383
0x2d1: Pop(0)
0x2d2: PushEmpty(object, int, float, cvector, cvector)
0x2d3: Stack[-26] = Stack[-5]
0x2d4: Stack[-25] = Stack[-4]
0x2d5: Stack[-24] = Stack[-3]
...
0x2e3: Pop(0)
0x2e4: Push("scripted") // @poff=387
0x2e5: Push("blood_dir.xml") // @poff=405
...
0x2f1: Stack[-7] = Stack[-2]
0x2f2: Stack[-6] = Stack[-1]
0x2f3: Call2 0x342
...
0x2fc: Stack[-10] = Stack[-2]
0x2fd: Stack[-9] = Stack[-1]
0x2fe: Call2 0x342
...
0x365: Push("GenerateMoney: iMin > iMax") // @poff=447
0x366: @ Trace(Stack[-1])
0x367: Pop(1)
0x368: Return(); Pop(4)
...
0x383: Pop(0)
0x384: @@ SetItemName(Stack[-7]); Obj=3 // @poff=513
0x385: Pop(0)
0x386: Push("Organ") // @poff=525
0x387: Push((int) 1)
0x388: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=537
0x389: Pop(2)
0x38a: @@ GetItemID(Stack[-2]); Obj=3 // @poff=549
0x38b: Pop(0)
0x38c: Push((int) 0)
0x38d: Push((int) 1)
...
0x39a: Stack[-1] = "liver" // @poff=559
0x39b: Call2 0x381

0x39c: Pop(1)
0x39d: PushEmpty(string)
0x39e: Stack[-1] = "kidney" // @poff=571
0x39f: Call2 0x381

0x3a0: Pop(1)
0x3a1: PushEmpty(string)
0x3a2: Stack[-1] = "heart" // @poff=585
0x3a3: Call2 0x381

0x3a4: Pop(1)
0x3a5: PushEmpty(string)
0x3a6: Stack[-1] = "blood" // @poff=597
0x3a7: Call2 0x381
...
0x3b4: Stack[-4] = "rifle_ammo" // @poff=609
0x3b5: Stack[-3] = (int) 1
0x3b6: Stack[-2] = (int) 3
0x3b7: Stack[-1] = (int) 3
0x3b8: Call2 0x2fa
...
0x3c2: Stack[-3] = "bandage" // @poff=641
0x3c3: Stack[-2] = (int) 1
0x3c4: Stack[-1] = (int) 6
0x3c5: Call2 0x2ef
...
0x3c8: Stack[-3] = "tourniquet" // @poff=657
0x3c9: Stack[-2] = (int) 1
0x3ca: Stack[-1] = (int) 6
0x3cb: Call2 0x2ef
...
0x3e5: Stack[-11] = Stack[-5]
0x3e6: Stack[-10] = Stack[-4]
0x3e7: Stack[-9] = Stack[-3]
0x3e8: Stack[-7] = Stack[-2]
0x3e9: Stack[-6] = Stack[-1]
0x3ea: Call2 0x2e1
...
0x402: Pop(0)
0x403: Push((float)0.05000000074505806)
0x404: Push((bool) 1)
