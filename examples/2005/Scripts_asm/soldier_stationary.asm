...
// @pool_raw:
...
0x32e: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x32f: Pop(1)
...
0x36d: @ GetPFPosition(Stack[-1]T)
0x36e: Pop(0)
0x36f: @ GetDirection(Stack[-0]T)
0x370: Pop(0)
0x371: PushEmpty()
0x372: Call2 0x3c5
...
0x38e: @ FindPathTo(Stack[-1], Stack[-1]T)
0x38f: Pop(0)
...
0x39d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x39e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3b0: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3b1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3d0: Stack[-2] = "bullet" // @poff=529
0x3d1: Return(); Pop(0)

0x3d2: Stack[-2] = "phys" // @poff=543
0x3d3: Return(); Pop(0)

0x3d4: PushEmpty(cvector, cvector, cvector, cvector)
0x3d5: @ GetPosition(Stack[-2])
0x3d6: Pop(0)
0x3d7: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x3d8: Pop(0)
...
0x3dd: Pop(0)
0x3de: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x3df: Pop(0)
...
0x3e9: Push("HasProperty") // @poff=553
0x3ea: Push((int) 2)
...
0x3f0: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=577
0x3f1: Pop(0)
0x3f2: Stack[-1] = Stack[-5]
0x3f3: Return(); Pop(2)

0x3f4: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x3f5: PushEmpty(bool, object, string)
0x3f6: Stack[-18] = Stack[-2]
0x3f7: Stack[-1] = "health" // @poff=589
0x3f8: Call2 0x3e8
...
0x3ff: Stack[-18] = Stack[-2]
0x400: Stack[-1] = "armor" // @poff=603
0x401: Call2 0x3e8
...
0x407: Push("armor") // @poff=603
0x408: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=615
0x409: Pop(1)
0x40a: Push("armor_") // @poff=627
0x40b: PushEmpty(string, int)
0x40c: Stack[-16] = Stack[-1]
0x40d: Call2 0x3c6

0x40e: Pop(1)
0x40f: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x410: PushEmpty(bool, object, string)
0x411: Stack[-18] = Stack[-2]
0x412: Stack[-8] = Stack[-1]
0x413: Call2 0x3e8
...
0x419: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=615
0x41a: Pop(0)
...
0x421: Stack[-3] = Stack[-6]
0x422: Pop(3)
0x423: Push("health") // @poff=589
0x424: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=615
0x425: Pop(1)
0x426: Push((int) 1)
0x427: Pop(1); Push(Stack[-1] - Stack[-4]);
0x428: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x429: Push("health") // @poff=589
...
0x42f: Pop(3)
0x430: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=641
0x431: Pop(2)
0x432: PushEmpty(bool, object)
0x433: Stack[-17] = Stack[-1]
0x434: Call2 0x3e3
...
0x43a: Pop(1)
0x43b: Stack[-1] = Stack[-16]
0x43c: Return(); Pop(12)

0x43d: PushEmpty(bool, bool)
0x43e: @@ IsDead(Stack[-1]); Obj=3 // @poff=653
0x43f: Pop(0)
0x440: Stack[-1] = Stack[-4]
0x441: Return(); Pop(2)

0x442: PushEmpty(object, object, object, object)
0x443: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x457: Pop(0)
0x458: Pop(0); PushNull((bool) Stack[-2] == 0)
0x459: IF (Stack[-1] == 0) GOTO 0x45c; Pop(1)

0x45a: Stack[-6] = (bool) 0
0x45b: Return(); Pop(4)

0x45c: @@ GetScene(Stack[-1]); Obj=5 // @poff=674
0x45d: Pop(0)
...
0x470: Stack[-6] = Stack[-2]
0x471: Stack[-1] = "noaccess" // @poff=683
0x472: Call2 0x3e8
...
0x478: Push("noaccess") // @poff=683
0x479: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=615
0x47a: Pop(1)
0x47b: Push((int) 0)
...
0x47f: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x48d: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x48e: Pop(0)
...
0x49e: Stack[-1] = "fhit" // @poff=701
0x49f: GOTO 0x4a1

0x4a0: Stack[-1] = "bhit" // @poff=711
0x4a1: Push("hit_react") // @poff=721
0x4a2: Push("1") // @poff=330
0x4a3: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4a4: Push("2") // @poff=741
...
0x4c2: Stack[-2] = Stack[-11]
0x4c3: Pop(2)
0x4c4: @ CreateVectorVector(Stack[-8])
0x4c5: Pop(0)
0x4c6: Stack[-7] = (int) 1
0x4c7: Push("hit") // @poff=703
...
0x4dc: Pop(0)
0x4dd: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=754
0x4de: Pop(0)
0x4df: PushEmpty(object, int, float, cvector, cvector)
0x4e0: Stack[-26] = Stack[-5]
0x4e1: Stack[-25] = Stack[-4]
0x4e2: Stack[-24] = Stack[-3]
0x4e3: Stack[-6] = Stack[-2]
...
0x4f0: Pop(0)
0x4f1: Push("scripted") // @poff=410
0x4f2: Push("blood_dir.xml") // @poff=758
...
0x4fd: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x4fe: Pop(0)
...
0x509: Pop(0)
0x50a: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x50b: Pop(0)
...
0x569: Push("woman") // @poff=786
0x56a: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x56b: IF (Stack[-1] == 1) GOTO 0x570; Pop(1)

0x56c: Push("worker") // @poff=798
0x56d: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x56e: IF (Stack[-1] == 1) GOTO 0x570; Pop(1)

0x56f: Stack[-1] = (bool) 0
0x570: IF (Stack[-1] == 1) GOTO 0x575; Pop(1)

0x571: Push("butcher") // @poff=812
0x572: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x573: IF (Stack[-1] == 1) GOTO 0x575; Pop(1)

0x574: Stack[-1] = (bool) 0
0x575: IF (Stack[-1] == 1) GOTO 0x57a; Pop(1)

0x576: Push("wasted_girl") // @poff=828
0x577: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x578: IF (Stack[-1] == 1) GOTO 0x57a; Pop(1)

0x579: Stack[-1] = (bool) 0
0x57a: IF (Stack[-1] == 1) GOTO 0x57f; Pop(1)

0x57b: Push("boy") // @poff=852
0x57c: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x57d: IF (Stack[-1] == 1) GOTO 0x57f; Pop(1)

0x57e: Stack[-1] = (bool) 0
0x57f: IF (Stack[-1] == 1) GOTO 0x584; Pop(1)

0x580: Push("vaxxabitka") // @poff=860
0x581: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x582: IF (Stack[-1] == 1) GOTO 0x584; Pop(1)

0x583: Stack[-1] = (bool) 0
0x584: IF (Stack[-1] == 1) GOTO 0x589; Pop(1)

0x585: Push("unosha") // @poff=882
0x586: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x587: IF (Stack[-1] == 1) GOTO 0x589; Pop(1)

0x588: Stack[-1] = (bool) 0
0x589: IF (Stack[-1] == 1) GOTO 0x58e; Pop(1)

0x58a: Push("wasted_male") // @poff=896
0x58b: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x58c: IF (Stack[-1] == 1) GOTO 0x58e; Pop(1)

0x58d: Stack[-1] = (bool) 0
0x58e: IF (Stack[-1] == 1) GOTO 0x593; Pop(1)

0x58f: Push("alkash") // @poff=920
0x590: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x591: IF (Stack[-1] == 1) GOTO 0x593; Pop(1)

0x592: Stack[-1] = (bool) 0
0x593: IF (Stack[-1] == 1) GOTO 0x598; Pop(1)

0x594: Push("dohodyaga") // @poff=934
0x595: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x596: IF (Stack[-1] == 1) GOTO 0x598; Pop(1)

0x597: Stack[-1] = (bool) 0
0x598: IF (Stack[-1] == 1) GOTO 0x59d; Pop(1)

0x599: Push("vaxxabit") // @poff=954
0x59a: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x59b: IF (Stack[-1] == 1) GOTO 0x59d; Pop(1)

0x59c: Stack[-1] = (bool) 0
0x59d: IF (Stack[-1] == 1) GOTO 0x5a2; Pop(1)

0x59e: Push("nudegirl") // @poff=972
0x59f: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5a0: IF (Stack[-1] == 1) GOTO 0x5a2; Pop(1)

0x5a1: Stack[-1] = (bool) 0
0x5a2: IF (Stack[-1] == 1) GOTO 0x5a7; Pop(1)

0x5a3: Push("morlok") // @poff=990
0x5a4: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x5a5: IF (Stack[-1] == 1) GOTO 0x5a7; Pop(1)
...
0x5ff: Pop(0)
0x600: @@ add(Stack[-3]); Obj=1 // @poff=745
0x601: Pop(0)
0x602: Push((int) 15)
...
0x631: Push("GenerateMoney: iMin > iMax") // @poff=1032
0x632: @ Trace(Stack[-1])
0x633: Pop(1)
0x634: Return(); Pop(4)
...
0x64f: Pop(0)
0x650: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1098
0x651: Pop(0)
0x652: Push("Organ") // @poff=1110
0x653: Push((int) 1)
0x654: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=641
0x655: Pop(2)
0x656: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1122
0x657: Pop(0)
0x658: Push((int) 0)
0x659: Push((int) 1)
...
0x666: Stack[-1] = "liver" // @poff=1132
0x667: Call2 0x64d

0x668: Pop(1)
0x669: PushEmpty(string)
0x66a: Stack[-1] = "kidney" // @poff=1144
0x66b: Call2 0x64d

0x66c: Pop(1)
0x66d: PushEmpty(string)
0x66e: Stack[-1] = "heart" // @poff=1158
0x66f: Call2 0x64d

0x670: Pop(1)
0x671: PushEmpty(string)
0x672: Stack[-1] = "blood" // @poff=1170
0x673: Call2 0x64d
...
0x680: Stack[-4] = "rifle_ammo" // @poff=1182
0x681: Stack[-3] = (int) 1
0x682: Stack[-2] = (int) 3
0x683: Stack[-1] = (int) 3
0x684: Call2 0x519
...
0x68e: Stack[-3] = "bandage" // @poff=1214
0x68f: Stack[-2] = (int) 1
0x690: Stack[-1] = (int) 6
0x691: Call2 0x50e
...
0x694: Stack[-3] = "tourniquet" // @poff=1230
0x695: Stack[-2] = (int) 1
0x696: Stack[-1] = (int) 6
0x697: Call2 0x50e
...
0x6a9: Stack[-7] = Stack[-3]
0x6aa: Stack[-6] = Stack[-2]
...
0x6b1: Stack[-11] = Stack[-5]
0x6b2: Stack[-10] = Stack[-4]
0x6b3: Stack[-9] = Stack[-3]
0x6b4: Stack[-7] = Stack[-2]
0x6b5: Stack[-6] = Stack[-1]
0x6b6: Call2 0x4ee
...
0x6ce: Pop(0)
0x6cf: Push((float)-0.12999999523162842)
0x6d0: Push((bool) 1)
...
0x6da: Stack[-7] = Stack[-2]
0x6db: Stack[-1] = "class" // @poff=1252
0x6dc: Call2 0x3e8
...
0x6e2: Push("class") // @poff=1252
0x6e3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=615
0x6e4: Pop(1)
...
0x6f9: Push("patrol") // @poff=1264
0x6fa: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x6fb: IF (Stack[-1] == 1) GOTO 0x700; Pop(1)

0x6fc: Push("sanitar") // @poff=1278
0x6fd: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x6fe: IF (Stack[-1] == 1) GOTO 0x700; Pop(1)

0x6ff: Stack[-1] = (bool) 0
0x700: IF (Stack[-1] == 1) GOTO 0x705; Pop(1)

0x701: Push("soldier") // @poff=1294
0x702: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x703: IF (Stack[-1] == 1) GOTO 0x705; Pop(1)

0x704: Stack[-1] = (bool) 0
0x705: IF (Stack[-1] == 1) GOTO 0x70a; Pop(1)

0x706: Push("woman") // @poff=786
0x707: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x708: IF (Stack[-1] == 1) GOTO 0x70a; Pop(1)

0x709: Stack[-1] = (bool) 0
0x70a: IF (Stack[-1] == 1) GOTO 0x70f; Pop(1)

0x70b: Push("wasted_girl") // @poff=828
0x70c: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x70d: IF (Stack[-1] == 1) GOTO 0x70f; Pop(1)

0x70e: Stack[-1] = (bool) 0
0x70f: IF (Stack[-1] == 1) GOTO 0x714; Pop(1)

0x710: Push("vaxxabitka") // @poff=860
0x711: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x712: IF (Stack[-1] == 1) GOTO 0x714; Pop(1)

0x713: Stack[-1] = (bool) 0
0x714: IF (Stack[-1] == 1) GOTO 0x719; Pop(1)

0x715: Push("vaxxabit") // @poff=954
0x716: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x717: IF (Stack[-1] == 1) GOTO 0x719; Pop(1)

0x718: Stack[-1] = (bool) 0
0x719: IF (Stack[-1] == 1) GOTO 0x71e; Pop(1)

0x71a: Push("little_girl") // @poff=1310
0x71b: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x71c: IF (Stack[-1] == 1) GOTO 0x71e; Pop(1)

0x71d: Stack[-1] = (bool) 0
0x71e: IF (Stack[-1] == 1) GOTO 0x723; Pop(1)

0x71f: Push("girl") // @poff=842
0x720: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x721: IF (Stack[-1] == 1) GOTO 0x723; Pop(1)

0x722: Stack[-1] = (bool) 0
0x723: IF (Stack[-1] == 1) GOTO 0x728; Pop(1)

0x724: Push("dohodyaga") // @poff=934
0x725: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x726: IF (Stack[-1] == 1) GOTO 0x728; Pop(1)

0x727: Stack[-1] = (bool) 0
0x728: IF (Stack[-1] == 1) GOTO 0x72d; Pop(1)

0x729: Push("nudegirl") // @poff=972
0x72a: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x72b: IF (Stack[-1] == 1) GOTO 0x72d; Pop(1)
...
0x73f: Push("worker") // @poff=798
0x740: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x741: IF (Stack[-1] == 1) GOTO 0x746; Pop(1)

0x742: Push("butcher") // @poff=812
0x743: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x744: IF (Stack[-1] == 1) GOTO 0x746; Pop(1)

0x745: Stack[-1] = (bool) 0
0x746: IF (Stack[-1] == 1) GOTO 0x74b; Pop(1)

0x747: Push("boy") // @poff=852
0x748: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x749: IF (Stack[-1] == 1) GOTO 0x74b; Pop(1)

0x74a: Stack[-1] = (bool) 0
0x74b: IF (Stack[-1] == 1) GOTO 0x750; Pop(1)

0x74c: Push("unosha") // @poff=882
0x74d: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x74e: IF (Stack[-1] == 1) GOTO 0x750; Pop(1)

0x74f: Stack[-1] = (bool) 0
0x750: IF (Stack[-1] == 1) GOTO 0x755; Pop(1)

0x751: Push("wasted_male") // @poff=896
0x752: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x753: IF (Stack[-1] == 1) GOTO 0x755; Pop(1)

0x754: Stack[-1] = (bool) 0
0x755: IF (Stack[-1] == 1) GOTO 0x75a; Pop(1)

0x756: Push("alkash") // @poff=920
0x757: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x758: IF (Stack[-1] == 1) GOTO 0x75a; Pop(1)

0x759: Stack[-1] = (bool) 0
0x75a: IF (Stack[-1] == 1) GOTO 0x75f; Pop(1)

0x75b: Push("morlok") // @poff=990
...
0x785: Pop(0)
0x786: Push((float)-0.07000000029802322)
...
0x7bc: Stack[-9] = Stack[-1]
0x7bd: Call2 0x3e3

0x7be: Pop(1)
0x7bf: IF (Stack[-1] == 0) GOTO 0x7c6; Pop(1)

0x7c0: Push("reputation") // @poff=1334
0x7c1: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=615
0x7c2: Pop(1)
0x7c3: Push((float)0.33000001311302185)
0x7c4: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x7c5: Return(); Pop(6)

0x7c6: PushEmpty(bool, object, string)
0x7c7: Stack[-10] = Stack[-2]
0x7c8: Stack[-1] = "class" // @poff=1252
0x7c9: Call2 0x3e8
...
0x7cf: Push("class") // @poff=1252
0x7d0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=615
0x7d1: Pop(1)
0x7d2: PushEmpty(bool)
0x7d3: Stack[-1] = (bool) 1
0x7d4: PushEmpty(bool)
0x7d5: Stack[-1] = (bool) 1
0x7d6: Push("bomber") // @poff=1356
0x7d7: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7d8: IF (Stack[-1] == 1) GOTO 0x7dd; Pop(1)

0x7d9: Push("hunter") // @poff=1370
0x7da: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7db: IF (Stack[-1] == 1) GOTO 0x7dd; Pop(1)

0x7dc: Stack[-1] = (bool) 0
0x7dd: IF (Stack[-1] == 1) GOTO 0x7e2; Pop(1)

0x7de: Push("grabitel") // @poff=1384
0x7df: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7e0: IF (Stack[-1] == 1) GOTO 0x7e2; Pop(1)
...
0x7e6: Stack[-10] = Stack[-2]
0x7e7: Stack[-1] = "disease" // @poff=1402
0x7e8: Call2 0x3e8
...
0x7f3: Pop(1)
0x7f4: IF (Stack[-1] == 1) GOTO 0x7f9; Pop(1)

0x7f5: Push("dog") // @poff=1418
0x7f6: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7f7: IF (Stack[-1] == 1) GOTO 0x7f9; Pop(1)

0x7f8: Stack[-1] = (bool) 0
0x7f9: IF (Stack[-1] == 0) GOTO 0x800; Pop(1)

0x7fa: Push("disease") // @poff=1402
0x7fb: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=615
0x7fc: Pop(1)
0x7fd: Push((int) 0)
...
0x80c: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x80d: Pop(1)
0x80e: Push(Stack[-1])
...
0x848: Pop(0)
0x849: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1426
0x84a: Pop(1)
0x84b: Stack[-1] = 0
0x84c: PushEmpty(object)
0x84d: Stack[-4] = Stack[-1]
0x84e: Call2 0x69f
