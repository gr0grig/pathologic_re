...
Strings:
	W:sound1
	W:sound2
// @pool_raw:73006f0075006e0064003100000073006f0075006e00640032000000
...
0x17: Push("sound1") // @poff=0
0x18: GOTO 0x1a

0x19: Push("sound2") // @poff=14
...
0x26: IF (Stack[-1] == 1) GOTO 0x2a; Pop(1)

0x27: Pop(0); Push((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x28: IF (Stack[-1] == 1) GOTO 0x2a; Pop(1)
