...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2b5: Push("head") // @poff=239
0x2b6: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2b7: Pop(1)
0x2b8: Push(Stack[-1])
0x2b9: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2ba: Push("head") // @poff=239
0x2bb: @ UnlookAsync(Stack[-1])
0x2bc: Pop(1)
0x2bd: Return(); Pop(2)

0x2be: PushEmpty(float, float, float, float)
0x2bf: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x2c0: Pop(0)
0x2c1: Push((bool) 0)
0x2c2: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2c3: Pop(1)
0x2c4: Return(); Pop(4)

0x2c5: PushEmpty(float, float, float, float)
0x2c6: @ lshGetAnimTimes(Stack[-6], Stack[-2], Stack[-1])
0x2c7: Pop(0)
0x2c8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-5])
0x2c9: Pop(0)
0x2ca: Return(); Pop(4)
...
0x2d7: Stack[-1] = 0
0x2d8: PushEmpty(float, float)
0x2d9: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2da: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2db: Push((float)9.999999974752427e-07)
0x2dc: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2dd: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2de: Stack[-4] = [0.0, 0.0, 0.0]
0x2df: Return(); Pop(2)

0x2e0: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2e1: Return(); Pop(2)

0x2e2: PushEmpty(string, string)
0x2e3: Stack[-1] = "idle" // @poff=146
0x2e4: Push(Stack[-3])
0x2e5: IF (Stack[-1] == 0) GOTO 0x2e7; Pop(1)

0x2e6: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2e7: Stack[-1] = Stack[-4]
0x2e8: Return(); Pop(2)

0x2e9: PushEmpty(int, bool, int, bool)
0x2ea: Stack[-2] = (int) 0
...
0x2ef: Pop(1)
0x2f0: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2f1: Pop(2)
...
0x2f5: Push((int) 1)
0x2f6: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2f7: GOTO 0x2eb

0x2f8: Stack[-2] = Stack[-5]
0x2f9: Return(); Pop(4)

0x2fa: Stack[-1] = (int) 515571
0x2fb: Return(); Pop(0)

0x2fc: Stack[-1] = (int) 504029
0x2fd: Return(); Pop(0)

0x2fe: Stack[-1] = "ui/NPC_bmask.png" // @poff=249
0x2ff: Return(); Pop(0)

0x300: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=283
0x301: Return(); Pop(0)
