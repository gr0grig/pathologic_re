...
Strings:
	...
	W:slot
	A:GetItemID
// @pool_raw:
...
0x11: Push("agony") // @poff=16
0x12: @@@ GetProperty(Stack[-1], Stack[-6]T); Obj=5 // @poff=28
0x13: Pop(1)
0x14: PushEmpty()
0x15: Call2 0x39
...
0x24: @@@ size(Stack[-3]); Obj=0 // @poff=40
0x25: Pop(0)
0x26: Stack[-2] = (int) 0
0x27: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x28: IF (Stack[-1] == 0) GOTO 0x37; Pop(1)

0x29: @@@ get(Stack[-1], Stack[-2]); Obj=0 // @poff=45
0x2a: Pop(0)
...
0x3a: @ CreateObjectVector(Stack[-0]T)
0x3b: Pop(0)
0x3c: @ CreateFloatVector(Stack[-1]T)
0x3d: Pop(0)
0x3e: @ CreateIntVector(Stack[-3]T)
0x3f: Pop(0)
0x40: @ CreateIntVector(Stack[-4]T)
0x41: Pop(0)
0x42: Push("player") // @poff=49
0x43: @ FindActor(Stack[-2]T, Stack[-1])
0x44: Pop(1)
...
0x4a: Push((int) 2)
0x4b: @@@ GetItemCount(Stack[-8], Stack[-1]); Obj=2 // @poff=63
0x4c: Pop(1)
0x4d: Stack[-6] = (int) 0
...
0x50: Push((int) 2)
0x51: @@@ GetItem(Stack[-6], Stack[-7], Stack[-1]); Obj=2 // @poff=76
0x52: Pop(1)
0x53: PushEmpty(int, object)
0x54: Stack[-7] = Stack[-1]
0x55: Call2 0x203

0x56: Stack[-2] = Stack[-6]
0x57: Pop(2)
0x58: Push("Agony") // @poff=84
...
0x64: Push("Agony") // @poff=84
0x65: @ GetInvItemProperty(Stack[-3], Stack[-5], Stack[-1])
0x66: Pop(1)
0x67: @@@ GetItemCountOfType(Stack[-1], Stack[-4]); Obj=2 // @poff=96
0x68: Pop(0)
0x69: @@@ add(Stack[-5]); Obj=0 // @poff=115
0x6a: Pop(0)
0x6b: @@@ add(Stack[-2]); Obj=1 // @poff=115
0x6c: Pop(0)
0x6d: @@@ add(Stack[-1]); Obj=4 // @poff=115
0x6e: Pop(0)
0x6f: Push((int) 0)
0x70: @@@ add(Stack[-1]); Obj=3 // @poff=115
0x71: Pop(1)
0x72: Stack[-5] = 0
0x73: Push((int) 1)
...
0x8a: @@@ size(Stack[-5]); Obj=0 // @poff=40
0x8b: Pop(0)
0x8c: Stack[-4] = (int) 0
0x8d: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x8e: IF (Stack[-1] == 0) GOTO 0x9b; Pop(1)

0x8f: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=45
0x90: Pop(0)
0x91: @@@ get(Stack[-2], Stack[-4]); Obj=1 // @poff=45
0x92: Pop(0)
0x93: @@@ get(Stack[-1], Stack[-4]); Obj=3 // @poff=45
0x94: Pop(0)
...
0xcd: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=45
0xce: Pop(0)
0xcf: @@@ get(Stack[-2], Stack[-4]); Obj=3 // @poff=45
0xd0: Pop(0)
0xd1: @@@ get(Stack[-1], Stack[-4]); Obj=4 // @poff=45
0xd2: Pop(0)
0xd3: Push(Stack[-2])
...
0x108: Push("scrollbar") // @poff=131
0x109: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x10a: IF (Stack[-1] == 0) GOTO 0x11f; Pop(1)

0x10b: @@@ size(Stack[-2]); Obj=0 // @poff=40
0x10c: Pop(0)
0x10d: Push((float)0.009999999776482582)
0x10e: Push((int) 4)
...
0x120: Stack[-10] = Stack[-2]
0x121: Stack[-9] = Stack[-1]
0x122: Call2 0x208

0x123: Stack[-3] = Stack[-4]
0x124: Pop(3)
0x125: Push((int) -1)
...
0x139: Push((int) 2)
0x13a: @@@ GetItemCount(Stack[-9], Stack[-1]); Obj=2 // @poff=63
0x13b: Pop(1)
0x13c: Stack[-7] = (int) -1
0x13d: Stack[-5] = (int) 0
...
0x140: Push((int) 2)
0x141: @@@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=2 // @poff=76
0x142: Pop(1)
...
0x14a: Push("disease") // @poff=171
0x14b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=5 // @poff=187
0x14c: Pop(1)
...
0x153: IF (Stack[-1] == 1) GOTO 0x158; Pop(1)

0x154: Push((int) 0)
0x155: Pop(1); Push((bool) Stack[-8] > Stack[-1])
0x156: IF (Stack[-1] == 1) GOTO 0x158; Pop(1)

0x157: Stack[-1] = (bool) 0
0x158: IF (Stack[-1] == 0) GOTO 0x15b; Pop(1)

0x159: Stack[-5] = Stack[-7]
0x15a: Stack[-6] = (int) 0
0x15b: GOTO 0x16a

0x15c: Push("disease") // @poff=171
0x15d: @@ GetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=28
0x15e: Pop(1)
0x15f: PushEmpty(bool)
0x160: Stack[-1] = (bool) 1
0x161: Push((int) -1)
0x162: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x163: IF (Stack[-1] == 1) GOTO 0x167; Pop(1)
...
0x198: Stack[-1] = Stack[-2]
0x199: Pop(1)
0x19a: Push((float)0.0010000000474974513)
0x19b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x19c: IF (Stack[-1] == 0) GOTO 0x19e; Pop(1)

0x19d: Stack[-1] = (int) 0
0x19e: Push("Do ") // @poff=210
0x19f: Pop(1); Push(Stack[-1] + Stack[-2]);
0x1a0: @ Trace(Stack[-1])
0x1a1: Pop(1)
0x1a2: Push("agony") // @poff=16
0x1a3: @@@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=218
0x1a4: Pop(1)
0x1a5: PushEmpty()
0x1a6: Call2 0x176
...
0x1ac: @@@ size(Stack[-2]); Obj=3 // @poff=40
0x1ad: Pop(0)
0x1ae: Stack[-1] = (int) 0
...
0x1b1: Push((int) 0)
0x1b2: @@@ set(Stack[-2], Stack[-1]); Obj=3 // @poff=230
0x1b3: Pop(1)
0x1b4: Push((int) 1)
...
0x1bf: @@@ size(Stack[-4]); Obj=3 // @poff=40
0x1c0: Pop(0)
...
0x1c4: @@@ get(Stack[-3], Stack[-9]); Obj=0 // @poff=45
0x1c5: Pop(0)
0x1c6: @@@ get(Stack[-2], Stack[-9]); Obj=4 // @poff=45
0x1c7: Pop(0)
0x1c8: @@@ get(Stack[-1], Stack[-9]); Obj=3 // @poff=45
0x1c9: Pop(0)
...
0x1cf: @@@ set(Stack[-9], Stack[-1]); Obj=3 // @poff=230
0x1d0: Pop(0)
0x1d1: PushEmpty()
0x1d2: Call2 0xc3
...
0x1da: @@@ size(Stack[-3]); Obj=3 // @poff=40
0x1db: Pop(0)
...
0x1df: @@@ get(Stack[-2], Stack[-7]); Obj=0 // @poff=45
0x1e0: Pop(0)
0x1e1: @@@ get(Stack[-1], Stack[-7]); Obj=3 // @poff=45
0x1e2: Pop(0)
0x1e3: Push((int) 0)
...
0x1e9: @@@ set(Stack[-7], Stack[-1]); Obj=3 // @poff=230
0x1ea: Pop(0)
0x1eb: PushEmpty()
0x1ec: Call2 0xc3
...
0x204: @@ GetItemID(Stack[-1]); Obj=3 // @poff=256
0x205: Pop(0)
