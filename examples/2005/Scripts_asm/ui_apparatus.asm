...
0x27e: Push("button_weapon") // @poff=329
...
0x287: Push("button_clothes") // @poff=357
...
0x290: Push("button_medcine") // @poff=387
...
0x299: Push("button_food") // @poff=417
...
0x2a2: Push("button_other") // @poff=441
...
0x2b6: Push("noinv_drop") // @poff=535
...
0x2c8: Stack[-1] = Stack[-4]
0x2c9: Pop(1)
0x2ca: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=130
0x2cb: Pop(0)
0x2cc: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x2cd: IF (Stack[-1] == 0) GOTO 0x2de; Pop(1)

0x2ce: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=157
0x2cf: Pop(0)
...
0x2d7: Stack[-7] = Stack[-2]
0x2d8: Push((int) 0)
0x2d9: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x2da: Call2 0x9a

0x2db: Stack[-3] = Stack[-9]
0x2dc: Pop(3)
0x2dd: Stack[-1] = 0
0x2de: GOTO 0x2e3
...
0x2e6: Stack[-19] = Stack[-3]
0x2e7: Stack[-18] = Stack[-2]
0x2e8: Stack[-17] = Stack[-1]
0x2e9: Call2 0x61

0x2ea: Stack[-4] = Stack[-10]
0x2eb: Pop(4)
0x2ec: Push(Stack[-6])
...
0x301: Pop(1)
0x302: Push("money") // @poff=557
0x303: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=569
0x304: Pop(1)
...
0x313: Push((int) 0)
0x314: Push("button_weapon") // @poff=329
0x315: @ SendMessage(Stack[-2], Stack[-1])
0x316: Pop(2)
0x317: GOTO 0x31c

0x318: Push((int) 1)
0x319: Push("button_weapon") // @poff=329
...
0x31f: Push((int) 0)
0x320: Push("button_clothes") // @poff=357
0x321: @ SendMessage(Stack[-2], Stack[-1])
0x322: Pop(2)
0x323: GOTO 0x328

0x324: Push((int) 1)
0x325: Push("button_clothes") // @poff=357
...
0x32b: Push((int) 0)
0x32c: Push("button_medcine") // @poff=387
0x32d: @ SendMessage(Stack[-2], Stack[-1])
0x32e: Pop(2)
0x32f: GOTO 0x334

0x330: Push((int) 1)
0x331: Push("button_medcine") // @poff=387
...
0x337: Push((int) 0)
0x338: Push("button_food") // @poff=417
0x339: @ SendMessage(Stack[-2], Stack[-1])
0x33a: Pop(2)
0x33b: GOTO 0x340

0x33c: Push((int) 1)
0x33d: Push("button_food") // @poff=417
...
0x343: Push((int) 0)
0x344: Push("button_other") // @poff=441
0x345: @ SendMessage(Stack[-2], Stack[-1])
0x346: Pop(2)
0x347: GOTO 0x34c

0x348: Push((int) 1)
0x349: Push("button_other") // @poff=441
...
0x350: Stack[-1] = Stack[-8]
0x351: Pop(1)
0x352: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=130
0x353: Pop(0)
0x354: Stack[-5] = (int) 0
0x355: Push((int) 12)
...
0x35a: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=157
0x35b: Pop(0)
0x35c: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=143
0x35d: Pop(0)
0x35e: PushEmpty(bool, int, int)
0x35f: Stack[-8] = Stack[-2]
0x360: Stack[-18] = Stack[-1]
0x361: Call2 0x96

0x362: Stack[-3] = Stack[-5]
0x363: Pop(3)
...
0x3b5: @@ GetItemID(Stack[-1]); Obj=3 // @poff=165
0x3b6: Pop(0)
0x3b7: Stack[-1] = Stack[-4]
0x3b8: Return(); Pop(2)
