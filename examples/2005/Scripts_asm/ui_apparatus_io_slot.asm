...
0xd: Push((int) 1)
0xe: Push((int) 1)
0xf: @ Blit(Stack[-2]T, Stack[-2], Stack[-1])
0x10: Pop(2)
0x11: Return(); Pop(0)
...
0x26: Push("selected") // @poff=16
0x27: @ SetBackground(Stack[-1])
0x28: Pop(1)
0x29: GOTO 0x2d

0x2a: Push("default") // @poff=0
...
0x39: @@@ GetItemID(Stack[-1]); Obj=1 // @poff=34
0x3a: Pop(0)
0x3b: @ GetInvItemSprite(Stack[-2]T, Stack[-1])
0x3c: Pop(0)
0x3d: @ LoadImage(Stack[-2]T)
0x3e: Pop(0)
0x3f: @ GetInvItemMaxStackSize(Stack[-0]T, Stack[-1])
0x40: Pop(0)
0x41: Push((int) 1)
0x42: Push("") // @poff=13
0x43: @ SetTooltip(Stack[-2], Stack[-1], Stack[-1]T)
0x44: Pop(2)
0x45: GOTO 0x4a
