...
Strings:
	...
	W:cslot
	W:Money
// @pool_raw:
...
0x28: Push("scrollbar") // @poff=38
0x29: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x2a: IF (Stack[-1] == 0) GOTO 0x40; Pop(1)

0x2b: @ GetContainer(Stack[-2])
0x2c: Pop(0)
0x2d: @@ GetItemCount(Stack[-1]); Obj=2 // @poff=58
0x2e: Pop(0)
0x2f: Push((float)0.009999999776482582)
0x30: Push((int) 4)
...
0x76: Pop(0)
0x77: @@ GetItemCount(Stack[-3]); Obj=4 // @poff=58
0x78: Pop(0)
0x79: Push((int) 4)
...
0x9f: Pop(0)
0xa0: @@ GetItemCount(Stack[-5]); Obj=6 // @poff=58
0xa1: Pop(0)
0xa2: Stack[-4] = Stack[2 + Tasks[-1].StackPointer]
0xa3: Push((int) 4)
0xa4: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xa9: @@ GetItem(Stack[-3], Stack[-4]); Obj=6 // @poff=71
0xaa: Pop(0)
0xab: @@ GetItemID(Stack[-2]); Obj=3 // @poff=79
0xac: Pop(0)
0xad: @@ GetItemAmount(Stack[-1], Stack[-4]); Obj=6 // @poff=89
0xae: Pop(0)
0xaf: Push((int) 0)
...
0xff: Pop(1)
0x100: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=119
0x101: Pop(1)
0x102: Stack[-1] = Stack[-5]
0x103: Return(); Pop(2)
...
0x112: Push("button_weapon") // @poff=134
...
0x11b: Push("button_clothes") // @poff=162
...
0x124: Push("button_medcine") // @poff=192
...
0x12d: Push("button_food") // @poff=222
...
0x136: Push("button_other") // @poff=246
...
0x14a: Push("noinv_drop") // @poff=340
...
0x15d: Pop(1)
0x15e: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=58
0x15f: Pop(0)
0x160: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x161: IF (Stack[-1] == 0) GOTO 0x172; Pop(1)

0x162: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=71
0x163: Pop(0)
...
0x16b: Stack[-7] = Stack[-2]
0x16c: Push((int) 0)
0x16d: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x16e: Call2 0x67

0x16f: Stack[-3] = Stack[-9]
0x170: Pop(3)
0x171: Stack[-1] = 0
0x172: GOTO 0x177
...
0x17a: Stack[-19] = Stack[-3]
0x17b: Stack[-18] = Stack[-2]
0x17c: Stack[-17] = Stack[-1]
0x17d: Call2 0x12

0x17e: Stack[-4] = Stack[-10]
0x17f: Pop(4)
0x180: Push(Stack[-6])
...
0x195: Pop(1)
0x196: Push("money") // @poff=362
0x197: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=374
0x198: Pop(1)
0x199: Stack[-1] = Stack[-5]
0x19a: Return(); Pop(4)
...
0x1a0: Pop(1)
0x1a1: Push("money") // @poff=362
0x1a2: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=386
0x1a3: Pop(1)
0x1a4: Return(); Pop(2)
...
0x1b1: Push((int) 0)
0x1b2: Push("button_weapon") // @poff=134
0x1b3: @ SendMessage(Stack[-2], Stack[-1])
0x1b4: Pop(2)
0x1b5: GOTO 0x1ba

0x1b6: Push((int) 1)
0x1b7: Push("button_weapon") // @poff=134
...
0x1bd: Push((int) 0)
0x1be: Push("button_clothes") // @poff=162
0x1bf: @ SendMessage(Stack[-2], Stack[-1])
0x1c0: Pop(2)
0x1c1: GOTO 0x1c6

0x1c2: Push((int) 1)
0x1c3: Push("button_clothes") // @poff=162
...
0x1c9: Push((int) 0)
0x1ca: Push("button_medcine") // @poff=192
0x1cb: @ SendMessage(Stack[-2], Stack[-1])
0x1cc: Pop(2)
0x1cd: GOTO 0x1d2

0x1ce: Push((int) 1)
0x1cf: Push("button_medcine") // @poff=192
...
0x1d5: Push((int) 0)
0x1d6: Push("button_food") // @poff=222
0x1d7: @ SendMessage(Stack[-2], Stack[-1])
0x1d8: Pop(2)
0x1d9: GOTO 0x1de

0x1da: Push((int) 1)
0x1db: Push("button_food") // @poff=222
...
0x1e1: Push((int) 0)
0x1e2: Push("button_other") // @poff=246
0x1e3: @ SendMessage(Stack[-2], Stack[-1])
0x1e4: Pop(2)
0x1e5: GOTO 0x1ea

0x1e6: Push((int) 1)
0x1e7: Push("button_other") // @poff=246
...
0x1f4: Stack[-1] = Stack[-11]
0x1f5: Pop(1)
0x1f6: @ GetContainer(Stack[-11])
0x1f7: Pop(0)
0x1f8: @@ GetItemCount(Stack[-8]); Obj=11 // @poff=58
0x1f9: Pop(0)
...
0x1fe: @@ GetItemAmount(Stack[-7], Stack[-23]); Obj=11 // @poff=89
0x1ff: Pop(0)
0x200: Push((int) 0)
...
0x205: @@ GetItem(Stack[-9], Stack[-23]); Obj=11 // @poff=71
0x206: Pop(0)
0x207: @@ GetItemID(Stack[-6]); Obj=9 // @poff=79
0x208: Pop(0)
0x209: Stack[-5] = (bool) 0
0x20a: Push("Organ") // @poff=398
0x20b: @@ HasProperty(Stack[-6], Stack[-1]); Obj=10 // @poff=410
0x20c: Pop(1)
0x20d: Push(Stack[-5])
0x20e: IF (Stack[-1] == 0) GOTO 0x212; Pop(1)

0x20f: Push("Organ") // @poff=398
0x210: @@ RemoveProperty(Stack[-1]); Obj=10 // @poff=422
0x211: Pop(1)
0x212: Push("Category") // @poff=437
...
0x222: Pop(1)
0x223: @@ RemoveItem(Stack[-23], Stack[-7]); Obj=11 // @poff=455
0x224: Pop(0)
0x225: PushEmpty()
0x226: Call2 0x1a6
...
0x22b: Push((int) 1)
0x22c: @@ AddItem(Stack[-2], Stack[-10], Stack[-5], Stack[-1]); Obj=11 // @poff=466
0x22d: Pop(1)
0x22e: Pop(0); Push((bool) Stack[-1] == 0)
0x22f: IF (Stack[-1] == 0) GOTO 0x232; Pop(1)

0x230: Stack[-4] = Stack[-25]
0x231: Return(); Pop(22)

0x232: Stack[-24] = (bool) 1
0x233: Push((int) 1)
0x234: @@ RemoveItem(Stack[-24], Stack[-1]); Obj=12 // @poff=455
0x235: Pop(1)
0x236: Stack[-4] = Stack[-25]
0x237: Return(); Pop(22)
...
0x241: Pop(0)
0x242: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=58
0x243: Pop(0)
...
0x248: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=89
0x249: Pop(0)
0x24a: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=71
0x24b: Pop(0)
0x24c: Push((int) 0)
0x24d: Push((int) 1)
0x24e: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=466
0x24f: Pop(2)
...
0x257: @@ GetItemID(Stack[-3]); Obj=7 // @poff=79
0x258: Pop(0)
0x259: Push("Weapon") // @poff=474
0x25a: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x25b: Pop(1)
0x25c: Push(Stack[-2])
0x25d: IF (Stack[-1] == 0) GOTO 0x265; Pop(1)

0x25e: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=119
0x25f: Pop(0)
0x260: Push(Stack[-1])
...
0x264: Pop(1)
0x265: Push((int) 1)
0x266: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=455
0x267: Pop(1)
...
0x270: Stack[-1] = Stack[-8]
0x271: Pop(1)
0x272: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=58
0x273: Pop(0)
0x274: Stack[-5] = (int) 0
0x275: Push((int) 12)
...
0x27a: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=71
0x27b: Pop(0)
0x27c: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=89
0x27d: Pop(0)
0x27e: PushEmpty(bool, int, int)
0x27f: Stack[-8] = Stack[-2]
0x280: Stack[-18] = Stack[-1]
0x281: Call2 0xf3

0x282: Stack[-3] = Stack[-5]
0x283: Pop(3)
0x284: PushEmpty(bool, object)
0x285: Stack[-6] = Stack[-1]
0x286: Call2 0xf0
