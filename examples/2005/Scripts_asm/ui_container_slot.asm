...
Strings:
	W:default
	A:GetItemID
// @pool_raw:640065006600610075006c00740000004765744974656d494400
...
0x12: Push((int) 1)
0x13: Push((int) 1)
0x14: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x15: Pop(2)
0x16: Push((int) 1)
...
0x39: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=16
0x3a: Pop(0)
0x3b: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x3c: Pop(0)
0x3d: @ LoadImage(Stack[-3]T)
0x3e: Pop(0)
0x3f: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x40: Pop(0)
0x41: Push((int) 1)
0x42: Push("") // @poff=13
0x43: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x44: Pop(2)
0x45: GOTO 0x4a
