...
Strings:
	...
	W:ccslot
	W:Money
// @pool_raw:
...
0x0: Push("inventory_base.xml") // @poff=0
0x1: Push((bool) 0)
0x2: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x3: Pop(2)
0x4: PushEmpty()
0x5: Call2 0xa0
...
0x1f: Stack[-8] = Stack[-2]
0x20: Stack[-1] = (bool) 1
0x21: Call2 0x143

0x22: Stack[-3] = Stack[-5]
0x23: Pop(3)
0x24: Stack[-1] = (bool) 1
0x25: Call2 0x73
...
0x38: Stack[-7] = Stack[-2]
0x39: Stack[-1] = (bool) 0
0x3a: Call2 0x143

0x3b: Stack[-3] = Stack[-5]
0x3c: Pop(3)
0x3d: Stack[-1] = (bool) 1
0x3e: Call2 0x83
...
0x4b: Pop(1)
0x4c: Push((float)0.009999999776482582)
0x4d: Push((int) 4)
...
0x74: Push("take_organ") // @poff=58
0x75: @ PlaySound(Stack[-1])
0x76: Pop(1)
0x77: PushEmpty(int)
0x78: PushEmpty(int, bool, int)
0x79: Stack[-5] = Stack[-2]
0x7a: Stack[-8] = Stack[-1]
0x7b: Call2 0x2b6

0x7c: Stack[-3] = Stack[-4]
0x7d: Pop(3)
0x7e: Call2 0x24e
...
0xca: Pop(0)
0xcb: @@ GetItemCount(Stack[-14]); Obj=15 // @poff=80
0xcc: Pop(0)
0xcd: Stack[-13] = (int) 0
0xce: Stack[-12] = (int) 0
...
0xd1: @@ GetItem(Stack[-11], Stack[-12]); Obj=15 // @poff=93
0xd2: Pop(0)
0xd3: @@ GetItemID(Stack[-10]); Obj=11 // @poff=101
0xd4: Pop(0)
0xd5: @@ GetItemAmount(Stack[-9], Stack[-12]); Obj=15 // @poff=111
0xd6: Pop(0)
0xd7: Stack[-8] = (bool) 0
0xd8: Push("Organ") // @poff=125
0xd9: @@ HasProperty(Stack[-9], Stack[-1]); Obj=12 // @poff=137
0xda: Pop(1)
0xdb: Push(Stack[-8])
...
0xf1: Push((int) 4)
0xf2: Pop(1); Push(Stack[-1] + Stack[2 + Tasks[-1].StackPointer]);
...
0xfb: Push((int) 4)
0xfc: Pop(1); Push(Stack[-1] + Stack[2 + Tasks[-1].StackPointer]);
...
0x10d: @@ GetItem(Stack[-5], Stack[-6]); Obj=15 // @poff=93
0x10e: Pop(0)
0x10f: @@ GetItemID(Stack[-4]); Obj=5 // @poff=101
0x110: Pop(0)
0x111: @@ GetItemAmount(Stack[-3], Stack[-6]); Obj=15 // @poff=111
0x112: Pop(0)
0x113: Stack[-2] = (bool) 0
0x114: Push("Organ") // @poff=125
0x115: @@ HasProperty(Stack[-3], Stack[-1]); Obj=6 // @poff=137
0x116: Pop(1)
...
0x145: Pop(0)
0x146: @@ GetItemCount(Stack[-8]); Obj=9 // @poff=80
0x147: Pop(0)
0x148: Stack[-7] = (int) 0
0x149: Stack[-6] = (int) 0
0x14a: Stack[-5] = (int) 0
...
0x14d: @@ GetItem(Stack[-4], Stack[-5]); Obj=9 // @poff=93
0x14e: Pop(0)
0x14f: @@ GetItemID(Stack[-3]); Obj=4 // @poff=101
0x150: Pop(0)
0x151: @@ GetItemAmount(Stack[-2], Stack[-5]); Obj=9 // @poff=111
0x152: Pop(0)
0x153: Stack[-1] = (bool) 0
0x154: Push("Organ") // @poff=125
0x155: @@ HasProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=137
0x156: Pop(1)
0x157: Push(Stack[-1])
...
0x17b: Pop(0)
0x17c: @@ GetItemCount(Stack[-7]); Obj=8 // @poff=80
0x17d: Pop(0)
0x17e: Stack[-6] = (int) 0
0x17f: Stack[-5] = (int) 0
...
0x182: @@ GetItem(Stack[-4], Stack[-5]); Obj=8 // @poff=93
0x183: Pop(0)
0x184: @@ GetItemID(Stack[-3]); Obj=4 // @poff=101
0x185: Pop(0)
0x186: @@ GetItemAmount(Stack[-2], Stack[-5]); Obj=8 // @poff=111
0x187: Pop(0)
0x188: Stack[-1] = (bool) 0
0x189: Push("Organ") // @poff=125
0x18a: @@ HasProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=137
0x18b: Pop(1)
...
0x1ca: Pop(1)
0x1cb: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=165
0x1cc: Pop(1)
...
0x1dd: Push("button_weapon") // @poff=180
...
0x1e6: Push("button_clothes") // @poff=208
...
0x1ef: Push("button_medcine") // @poff=238
...
0x1f8: Push("button_food") // @poff=268
...
0x201: Push("button_other") // @poff=292
...
0x215: Push("noinv_drop") // @poff=386
...
0x228: Pop(1)
0x229: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=80
0x22a: Pop(0)
0x22b: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x22c: IF (Stack[-1] == 0) GOTO 0x23d; Pop(1)

0x22d: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=93
0x22e: Pop(0)
...
0x236: Stack[-7] = Stack[-2]
0x237: Push((int) 0)
0x238: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x239: Call2 0x93

0x23a: Stack[-3] = Stack[-9]
0x23b: Pop(3)
0x23c: Stack[-1] = 0
0x23d: GOTO 0x242
...
0x245: Stack[-19] = Stack[-3]
0x246: Stack[-18] = Stack[-2]
0x247: Stack[-17] = Stack[-1]
0x248: Call2 0x12

0x249: Stack[-4] = Stack[-10]
0x24a: Pop(4)
0x24b: Push(Stack[-6])
...
0x260: Pop(1)
0x261: Push("money") // @poff=408
0x262: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=420
0x263: Pop(1)
...
0x26a: Stack[-1] = Stack[-2]
0x26b: Pop(1)
0x26c: Push("money") // @poff=408
0x26d: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=432
0x26e: Pop(1)
0x26f: Return(); Pop(2)
...
0x27c: Push((int) 0)
0x27d: Push("button_weapon") // @poff=180
0x27e: @ SendMessage(Stack[-2], Stack[-1])
0x27f: Pop(2)
0x280: GOTO 0x285

0x281: Push((int) 1)
0x282: Push("button_weapon") // @poff=180
...
0x288: Push((int) 0)
0x289: Push("button_clothes") // @poff=208
0x28a: @ SendMessage(Stack[-2], Stack[-1])
0x28b: Pop(2)
0x28c: GOTO 0x291

0x28d: Push((int) 1)
0x28e: Push("button_clothes") // @poff=208
...
0x294: Push((int) 0)
0x295: Push("button_medcine") // @poff=238
0x296: @ SendMessage(Stack[-2], Stack[-1])
0x297: Pop(2)
0x298: GOTO 0x29d

0x299: Push((int) 1)
0x29a: Push("button_medcine") // @poff=238
...
0x2a0: Push((int) 0)
0x2a1: Push("button_food") // @poff=268
0x2a2: @ SendMessage(Stack[-2], Stack[-1])
0x2a3: Pop(2)
0x2a4: GOTO 0x2a9

0x2a5: Push((int) 1)
0x2a6: Push("button_food") // @poff=268
...
0x2ac: Push((int) 0)
0x2ad: Push("button_other") // @poff=292
0x2ae: @ SendMessage(Stack[-2], Stack[-1])
0x2af: Pop(2)
0x2b0: GOTO 0x2b5

0x2b1: Push((int) 1)
0x2b2: Push("button_other") // @poff=292
...
0x2bf: Stack[-1] = Stack[-11]
0x2c0: Pop(1)
0x2c1: @ GetContainer(Stack[-11])
0x2c2: Pop(0)
0x2c3: @@ GetItemCount(Stack[-8]); Obj=11 // @poff=80
0x2c4: Pop(0)
...
0x2c9: @@ GetItemAmount(Stack[-7], Stack[-23]); Obj=11 // @poff=111
0x2ca: Pop(0)
0x2cb: Push((int) 0)
...
0x2d0: @@ GetItem(Stack[-9], Stack[-23]); Obj=11 // @poff=93
0x2d1: Pop(0)
0x2d2: @@ GetItemID(Stack[-6]); Obj=9 // @poff=101
0x2d3: Pop(0)
0x2d4: Stack[-5] = (bool) 0
0x2d5: Push("Organ") // @poff=125
0x2d6: @@ HasProperty(Stack[-6], Stack[-1]); Obj=10 // @poff=137
0x2d7: Pop(1)
0x2d8: Push(Stack[-5])
0x2d9: IF (Stack[-1] == 0) GOTO 0x2dd; Pop(1)

0x2da: Push("Organ") // @poff=125
0x2db: @@ RemoveProperty(Stack[-1]); Obj=10 // @poff=444
0x2dc: Pop(1)
0x2dd: Push("Category") // @poff=459
...
0x2ed: Pop(1)
0x2ee: @@ RemoveItem(Stack[-23], Stack[-7]); Obj=11 // @poff=477
0x2ef: Pop(0)
0x2f0: PushEmpty()
0x2f1: Call2 0x271
...
0x2f6: Push((int) 1)
0x2f7: @@ AddItem(Stack[-2], Stack[-10], Stack[-5], Stack[-1]); Obj=11 // @poff=488
0x2f8: Pop(1)
0x2f9: Pop(0); Push((bool) Stack[-1] == 0)
0x2fa: IF (Stack[-1] == 0) GOTO 0x2fd; Pop(1)

0x2fb: Stack[-4] = Stack[-25]
0x2fc: Return(); Pop(22)

0x2fd: Stack[-24] = (bool) 1
0x2fe: Push((int) 1)
0x2ff: @@ RemoveItem(Stack[-24], Stack[-1]); Obj=12 // @poff=477
0x300: Pop(1)
0x301: Stack[-4] = Stack[-25]
0x302: Return(); Pop(22)
...
0x309: Stack[-1] = Stack[-9]
0x30a: Pop(1)
0x30b: @ GetContainer(Stack[-9])
0x30c: Pop(0)
0x30d: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=80
0x30e: Pop(0)
...
0x313: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=111
0x314: Pop(0)
0x315: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=93
0x316: Pop(0)
0x317: Push((int) 0)
0x318: Push((int) 1)
0x319: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=488
0x31a: Pop(2)
...
0x322: @@ GetItemID(Stack[-3]); Obj=7 // @poff=101
0x323: Pop(0)
0x324: Push("Weapon") // @poff=496
0x325: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x326: Pop(1)
0x327: Push(Stack[-2])
0x328: IF (Stack[-1] == 0) GOTO 0x330; Pop(1)

0x329: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=165
0x32a: Pop(0)
0x32b: Push(Stack[-1])
...
0x32f: Pop(1)
0x330: Push((int) 1)
0x331: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=477
0x332: Pop(1)
...
0x33b: Stack[-1] = Stack[-8]
0x33c: Pop(1)
0x33d: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=80
0x33e: Pop(0)
0x33f: Stack[-5] = (int) 0
0x340: Push((int) 12)
...
0x345: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=93
0x346: Pop(0)
0x347: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=111
0x348: Pop(0)
0x349: PushEmpty(bool, int, int)
0x34a: Stack[-8] = Stack[-2]
0x34b: Stack[-18] = Stack[-1]
0x34c: Call2 0x1be

0x34d: Stack[-3] = Stack[-5]
0x34e: Pop(3)
0x34f: PushEmpty(bool, object)
0x350: Stack[-6] = Stack[-1]
0x351: Call2 0x1bb

0x352: Stack[-2] = Stack[-3]
0x353: Pop(2)
0x354: Push(Stack[-2])
