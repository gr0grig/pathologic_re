...
Strings:
	...
	W:scalpel
	A:GetItemID
// @pool_raw:640065006600610075006c00740000007300630061006c00700065006c0000004765744974656d494400
...
0x13: Push((int) 1)
0x14: Push((int) 1)
0x15: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x16: Pop(2)
0x17: Push((int) 1)
0x18: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] > Stack[-1])
0x19: IF (Stack[-1] == 0) GOTO 0x1f; Pop(1)

0x1a: Push("default") // @poff=0
0x1b: Push((int) 2)
0x1c: Push((int) 35)
0x1d: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x1e: Pop(3)
0x1f: Return(); Pop(0)
...
0x3a: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=32
0x3b: Pop(0)
0x3c: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x3d: Pop(0)
0x3e: @ LoadImage(Stack[-3]T)
0x3f: Pop(0)
0x40: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x41: Pop(0)
0x42: Push((int) 1)
0x43: Push("") // @poff=13
0x44: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x45: Pop(2)
0x46: GOTO 0x4b
