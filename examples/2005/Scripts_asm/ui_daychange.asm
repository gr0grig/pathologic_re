...
Strings:
// @pool_raw:0000640065006600610075006c00740000006200720061006e00630068000000700073005f0064006500610064005f0063006f0075006e0074000000
// @pool_encoding:utf8
...
0x3d: @ GetWindowSize(Stack[-0]T, Stack[-1]T)
0x3e: Pop(0)
0x3f: Push((bool) 1)
...
0x53: Stack[-2] = (int) 1
0x54: Push("default") // @poff=2
0x55: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-0]T, Stack[-3]T)
0x56: Pop(1)
0x57: Push("default") // @poff=2
0x58: Push((int) 0)
0x59: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] - Stack[-3]);
0x5a: Push((int) 2)
0x5b: Pop(2); Push(Stack[-2] / Stack[-1]);
0x5c: Push((float)1.0)
0x5d: Push((float)1.0)
0x5e: Push((float)1.0)
0x5f: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-0]T, Stack[-3]T, Stack[-3], Stack[-2], Stack[-1], Stack[-8])
0x60: Pop(6)
0x61: Return(); Pop(4)
...
0x8d: IF (Stack[-1] == 1) GOTO 0x92; Pop(1)

0x8e: Push((int) 12)
0x8f: Pop(1); Push((bool) Stack[-15] > Stack[-1])
0x90: IF (Stack[-1] == 1) GOTO 0x92; Pop(1)

0x91: Stack[-1] = (bool) 0
0x92: IF (Stack[-1] == 0) GOTO 0x95; Pop(1)

0x93: Stack[-14] = "" // @poff=0
0x94: Return(); Pop(12)

0x95: PushEmpty(int, int)
0x96: Stack[-15] = Stack[-1]
0x97: Call2 0xc8

0x98: Stack[-2] = Stack[-8]
0x99: Pop(2)
0x9a: PushEmpty(int, int)
0x9b: Stack[-15] = Stack[-1]
0x9c: Call2 0x112

0x9d: Stack[-2] = Stack[-7]
0x9e: Pop(2)
0x9f: PushEmpty(int, int)
0xa0: Stack[-15] = Stack[-1]
0xa1: Call2 0x161

0xa2: Stack[-2] = Stack[-6]
0xa3: Pop(2)
0xa4: PushEmpty(int, int)
0xa5: Stack[-15] = Stack[-1]
0xa6: Call2 0x1ab

0xa7: Stack[-2] = Stack[-5]
0xa8: Pop(2)
0xa9: PushEmpty(int, int)
0xaa: Stack[-15] = Stack[-1]
0xab: Call2 0xb9
...
0xbe: Push("ps_dead_count") // @poff=32
...
0x159: Pop(1)
0x15a: Push("ps_dead_count") // @poff=32
