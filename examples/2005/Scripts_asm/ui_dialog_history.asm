...
Strings:
	...
	W:dialog_text
	A:add
// @pool_raw:
...
0x3: @ GetWindowSize(Stack[-6]T, Stack[-7]T)
0x4: Pop(0)
0x5: Push(GlobalVars[0])
0x6: Push((float)4.800000190734863)
0x7: Stack[-2] = Stack[6 + Tasks[-1].StackPointer] / Stack[-1]; Pop(1);
0x8: GlobalVars[0] = Stack[-1]; Pop(1)
0x9: @ CreateStringVector(Stack[-8]T)
0xa: Pop(0)
0xb: @ CreateStringVector(Stack[-9]T)
0xc: Pop(0)
0xd: @ GetConversation(Stack[-1])
0xe: Pop(0)
0xf: Pop(0); PushNull((bool) Stack[-1] == 0)
0x10: IF (Stack[-1] == 0) GOTO 0x15; Pop(1)

0x11: Push("null conversation") // @poff=0
0x12: @ UITrace(Stack[-1])
0x13: Pop(1)
0x14: Return(); Pop(2)

0x15: @@ GetNPCName(Stack[-10]T); Obj=1 // @poff=36
0x16: Pop(0)
0x17: @ _strupr(Stack[-10]T)
0x18: Pop(0)
0x19: @@ GetPlayerName(Stack[-11]T); Obj=1 // @poff=47
0x1a: Pop(0)
0x1b: @ _strupr(Stack[-11]T)
0x1c: Pop(0)
0x1d: PushEmpty()
0x1e: Call2 0x2b
...
0x34: Push((int) 16484)
0x35: Push("h_scrollbar") // @poff=61
0x36: @ SendMessage(Stack[-2], Stack[-1])
0x37: Pop(2)
0x38: GOTO 0x3d

0x39: Push((int) 100)
0x3a: Push("h_scrollbar") // @poff=61
...
0x5c: Pop(1); Push(Stack[-1] / Stack[2 + Tasks[-1].StackPointer]);
0x5d: Push("h_scrollbar") // @poff=61
...
0x62: Stack[-4] = (int) 0
0x63: @@@ size(Stack[-6]); Obj=8 // @poff=85
0x64: Pop(0)
0x65: Stack[-3] = (int) 0
0x66: Pop(0); Push((bool) Stack[-3] < Stack[-6])
0x67: IF (Stack[-1] == 0) GOTO 0x83; Pop(1)

0x68: @@@ get(Stack[-2], Stack[-3]); Obj=8 // @poff=90
0x69: Pop(0)
0x6a: @@@ get(Stack[-1], Stack[-3]); Obj=9 // @poff=90
0x6b: Pop(0)
0x6c: Push("default") // @poff=94
0x6d: Push(GlobalVars[0])
0x6e: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x74: Push("default") // @poff=94
0x75: Push(GlobalVars[0])
0x76: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x83: Stack[-4] = Stack[-13]
0x84: Return(); Pop(12)

0x85: PushEmpty(int, int, int, string, string, int, int, int, int, string, string, int)
0x86: Stack[-6] = Stack[1 + Tasks[-1].StackPointer]
0x87: @@@ size(Stack[-5]); Obj=8 // @poff=85
0x88: Pop(0)
0x89: Stack[-4] = (int) 0
0x8a: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x8b: IF (Stack[-1] == 0) GOTO 0xb9; Pop(1)

0x8c: @@@ get(Stack[-3], Stack[-4]); Obj=8 // @poff=90
0x8d: Pop(0)
0x8e: @@@ get(Stack[-2], Stack[-4]); Obj=9 // @poff=90
0x8f: Pop(0)
0x90: Push("default") // @poff=94
0x91: Push(GlobalVars[0])
0x92: Push(GlobalVars[0])
0x93: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
0x94: Push((float)0.8040000200271606)
0x95: Push((float)0.8040000200271606)
0x96: Push((float)0.8040000200271606)
0x97: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x98: Pop(6)
0x99: Push("default") // @poff=94
0x9a: Push((int) 0)
0x9b: Push((float)0.8040000200271606)
0x9c: Push((float)0.8040000200271606)
0x9d: Push((float)0.8040000200271606)
0x9e: @ Print(Stack[-5], Stack[-4], Stack[-11], Stack[-10]T, Stack[-3], Stack[-2], Stack[-1])
0x9f: Pop(5)
0xa0: Stack[-6] = Stack[-6] + Stack[-1]; Pop(0);
0xa1: Push((int) 10)
0xa2: Stack[-7] = Stack[-7] + Stack[-1]; Pop(1);
0xa3: Push("default") // @poff=94
0xa4: Push(GlobalVars[0])
0xa5: Push(GlobalVars[0])
0xa6: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
0xa7: Push((float)0.6980000138282776)
0xa8: Push((float)0.6589999794960022)
0xa9: Push((float)0.6470000147819519)
0xaa: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-8], Stack[-3], Stack[-2], Stack[-1])
0xab: Pop(6)
0xac: Push("default") // @poff=94
0xad: Push((int) 0)
0xae: Push((float)0.6980000138282776)
0xaf: Push((float)0.6589999794960022)
0xb0: Push((float)0.6470000147819519)
0xb1: @ Print(Stack[-5], Stack[-4], Stack[-11], Stack[-11]T, Stack[-3], Stack[-2], Stack[-1])
0xb2: Pop(5)
...
0xc3: Push("dialog_text") // @poff=110
0xc4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xc5: IF (Stack[-1] == 0) GOTO 0xd3; Pop(1)

0xc6: Push((int) 0)
0xc7: @@ get(Stack[-3], Stack[-1]); Obj=6 // @poff=90
0xc8: Pop(1)
0xc9: Push((int) 1)
0xca: @@ get(Stack[-2], Stack[-1]); Obj=6 // @poff=90
0xcb: Pop(1)
0xcc: @@@ add(Stack[-2]); Obj=8 // @poff=134
0xcd: Pop(0)
0xce: @@@ add(Stack[-1]); Obj=9 // @poff=134
0xcf: Pop(0)
0xd0: PushEmpty()
0xd1: Call2 0x2b
