...
0x2d: Pop(1); Push(Stack[-1] / Stack[1 + Tasks[-1].StackPointer]);
0x2e: Push("p_scrollbar") // @poff=0
...
0x36: Pop(1)
0x37: Push("default") // @poff=24
0x38: Push((int) 5)
0x39: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x3a: @ GetTextHeightInWidth(Stack[-9], Stack[-2], Stack[-1], Stack[-7])
0x3b: Pop(2)
0x3c: Stack[-7] = Stack[-6]
0x3d: Push((int) 10)
...
0x4f: Stack[-2] = Stack[-3]
0x50: Pop(2)
0x51: Push("default") // @poff=24
0x52: Push((int) 15)
0x53: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x54: Push((int) 5)
...
0x66: Pop(1)
0x67: Push("default") // @poff=24
0x68: Push((int) 0)
0x69: Push((int) 5)
0x6a: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x6b: Push((float)0.8040000200271606)
0x6c: Push((float)0.8040000200271606)
0x6d: Push((float)0.8040000200271606)
0x6e: @ PrintInWidth(Stack[-2]T, Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-11], Stack[-3], Stack[-2], Stack[-1])
0x6f: Pop(6)
...
0x7b: Stack[-2] = Stack[-3]
0x7c: Pop(2)
0x7d: Pop(0); Push((bool) Stack[-2] == Stack[3 + Tasks[-1].StackPointer])
0x7e: IF (Stack[-1] == 0) GOTO 0x8b; Pop(1)

0x7f: Push("default") // @poff=24
0x80: Push((int) 15)
0x81: Push((int) 15)
0x82: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x83: Push((int) 5)
...
0x8b: Push("default") // @poff=24
0x8c: Push((int) 15)
0x8d: Push((int) 15)
0x8e: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x8f: Push((int) 5)
0x90: Pop(2); Push(Stack[-2] - Stack[-1]);
0x91: Push((float)0.6980000138282776)
0x92: Push((float)0.6589999794960022)
0x93: Push((float)0.6470000147819519)
...
0x9e: Pop(0); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[2 + Tasks[-1].StackPointer]);
0x9f: Push((int) 10)
...
0xaa: Stack[-2] = Stack[-4]
0xab: Pop(2)
0xac: PushEmpty(int, int)
0xad: Stack[-5] = Stack[-1]
0xae: Call2 0x11d

0xaf: Stack[-2] = Stack[-3]
0xb0: Pop(2)
0xb1: Push("default") // @poff=24
0xb2: Push((int) 15)
0xb3: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0xb4: Push((int) 5)
...
0x111: Stack[-1] = "Error: missing replic" // @poff=70
...
0x11a: Stack[-1] = "ERROR: missing answer" // @poff=114
