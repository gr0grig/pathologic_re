...
0x23: Push("button_daytasks") // @poff=46
...
0x2c: Push("button_othertasks") // @poff=78
...
0x39: Push((int) 0)
0x3a: Push("button_mission") // @poff=16
0x3b: @ SendMessage(Stack[-2], Stack[-1])
0x3c: Pop(2)
0x3d: GOTO 0x42

0x3e: Push((int) 1)
0x3f: Push("button_mission") // @poff=16
...
0x45: Push((int) 0)
0x46: Push("button_daytasks") // @poff=46
0x47: @ SendMessage(Stack[-2], Stack[-1])
0x48: Pop(2)
0x49: GOTO 0x4e

0x4a: Push((int) 1)
0x4b: Push("button_daytasks") // @poff=46
...
0x51: Push((int) 0)
0x52: Push("button_othertasks") // @poff=78
0x53: @ SendMessage(Stack[-2], Stack[-1])
0x54: Pop(2)
0x55: GOTO 0x5a

0x56: Push((int) 1)
0x57: Push("button_othertasks") // @poff=78
0x58: @ SendMessage(Stack[-2], Stack[-1])
0x59: Pop(2)
0x5a: Push("text") // @poff=114
