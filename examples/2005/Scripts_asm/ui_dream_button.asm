...
Strings:
	...
	W:start
	W:stop
// @pool_raw:640065006600610075006c007400000070007200650073007300650064000000730074006100720074000000730074006f0070000000
...
0xa: PushEmpty()
0xb: Push("pressed") // @poff=16
0xc: @ SetBackground(Stack[-1])
0xd: Pop(1)
0xe: Return(); Pop(0)

0xf: PushEmpty()
0x10: Push("default") // @poff=0
