...
Strings:
	W:white
	W:default
// @pool_raw:770068006900740065000000640065006600610075006c0074000000
...
0x1: @ GetWindowSize(Stack[-1]T, Stack[-2]T)
0x2: Pop(0)
0x3: Push((bool) 1)
...
0x10: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[0 + Tasks[-1].StackPointer]);
0x11: Push((int) 100)
...
0x16: Push("white") // @poff=0
0x17: Push((int) 0)
0x18: Push((int) 0)
0x19: @ StretchBlit(Stack[-3], Stack[-2], Stack[-1], Stack[-6], Stack[-2]T)
0x1a: Pop(3)
0x1b: Push((float)6.0)
0x1c: Push((int) 1)
0x1d: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x25: Pop(1); Push(Stack[-1] * Stack[1 + Tasks[-1].StackPointer]);
0x26: Push((float)6.0)
0x27: Stack[-3] = Stack[-2] / Stack[-1]; Pop(2);
0x28: Push("default") // @poff=12
0x29: Push((int) 5)
