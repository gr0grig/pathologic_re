...
Strings:
	...
	W:text_cursor
	A:add
// @pool_raw:640065006600610075006c007400000074006500780074005f0063007500720073006f007200000061646400
...
0x0: @ GetWindowSize(Stack[-2]T, Stack[-3]T)
0x1: Pop(0)
...
0x14: @ _strlen(Stack[-1]T, Stack[-0]T)
0x15: Pop(0)
0x16: Return(); Pop(0)
...
0x23: @ _strlen(Stack[-1], Stack[-0]T)
0x24: Pop(0)
...
0x30: Stack[-3] = CString2(Stack[-7]); Pop(0)
0x31: Push((int) 0)
0x32: @ _strsub(Stack[-3], Stack[-0]T, Stack[-1], Stack[-1]T)
0x33: Pop(1)
0x34: @ _strsub(Stack[-1], Stack[-0]T, Stack[-1]T)
0x35: Pop(0)
...
0x40: Push((int) 0)
0x41: Push((int) 1)
0x42: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] - Stack[-1]);
0x43: @ _strsub(Stack[-4], Stack[-0]T, Stack[-2], Stack[-1])
0x44: Pop(2)
0x45: @ _strsub(Stack[-1], Stack[-0]T, Stack[-1]T)
0x46: Pop(0)
...
0x4c: Push("default") // @poff=0
0x4d: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-0]T, Stack[-1]T)
0x4e: Pop(1)
0x4f: Push((int) 1)
0x50: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x51: Pop(1); Push((bool) Stack[-3] > Stack[-1])
0x52: IF (Stack[-1] == 0) GOTO 0x57; Pop(1)

0x53: Pop(0); Push(Stack[-2] - Stack[2 + Tasks[-1].StackPointer]);
0x54: Push((int) 1)
0x55: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x56: GOTO 0x58

0x57: Stack[-1] = (int) 0
0x58: Push("default") // @poff=0
0x59: Pop(0); Push(( -Stack[-2])
0x5a: Push((int) 0)
0x5b: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x5c: Pop(3)
0x5d: PushEmpty(bool)
0x5e: Stack[-1] = (bool) 0
...
0x80: Pop(0)
0x81: @@ add(Stack[-0]T); Obj=1 // @poff=40
0x82: Pop(0)
0x83: Push((int) 0)
