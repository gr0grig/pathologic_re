...
0x5c: Stack[-2] = "death_fail.wmv" // @poff=93
0x5d: Stack[-1] = (bool) 1
...
0x68: Push("game_buttons.xml") // @poff=123
0x69: Push((bool) 0)
...
0x70: Push("game_logo.xml") // @poff=157
0x71: Push((bool) 0)
...
0x7c: Pop(0)
0x7d: Push("default") // @poff=185
0x7e: @ SetCursor(Stack[-1])
0x7f: Pop(1)
0x80: Push("default") // @poff=185
0x81: @ SetBackground(Stack[-1])
0x82: Pop(1)
0x83: Push("menumusic") // @poff=201
...
0x8b: Push("game_choose_pers.xml") // @poff=221
0x8c: Push((bool) 0)
...
0xad: Stack[-2] = "intro_danko.wmv" // @poff=263
0xae: Stack[-1] = (bool) 1
...
0xb7: @ DestroyWindow()
0xb8: Pop(0)
0xb9: Push("world_danko.xml") // @poff=295
0xba: Push("player_danko.xml") // @poff=327
...
0xcb: Stack[-2] = "intro_burah.wmv" // @poff=361
0xcc: Stack[-1] = (bool) 1
...
0xd5: @ DestroyWindow()
0xd6: Pop(0)
0xd7: Push("world_burah.xml") // @poff=393
0xd8: Push("player_burah.xml") // @poff=425
...
0xe9: Stack[-2] = "intro_klara.wmv" // @poff=459
0xea: Stack[-1] = (bool) 1
...
0xf3: @ DestroyWindow()
0xf4: Pop(0)
0xf5: Push("world_klara.xml") // @poff=491
0xf6: Push("player_klara.xml") // @poff=523
...
0xfd: Push("menumusic") // @poff=201
0xfe: @ PauseSound(Stack[-1])
0xff: Pop(1)
0x100: Push("Loading : ") // @poff=557
...
0x117: @ DestroyWindow()
0x118: Pop(0)
0x119: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=579
0x11a: Pop(0)
...
0x125: @ DestroyWindow()
0x126: Pop(0)
0x127: Push("world_intro.xml") // @poff=591
0x128: Push("player_intro.xml") // @poff=623
...
0x15e: Push("gameoptions") // @poff=783
...
0x163: Pop(0)
0x164: Push("options.xml") // @poff=807
0x165: Push((bool) 0)
...
0x197: Push((int) 202)
0x198: Push("player_name") // @poff=877
0x199: @ SendMessage(Stack[-2], Stack[-1])
0x19a: Pop(2)
0x19b: Push((int) 203)
0x19c: Push("player_desc") // @poff=901
...
0x1a3: Push((int) -1)
0x1a4: Push("player_name") // @poff=877
0x1a5: @ SendMessage(Stack[-2], Stack[-1])
0x1a6: Pop(2)
0x1a7: Push((int) -1)
0x1a8: Push("player_desc") // @poff=901
...
0x1ba: Push((int) 205)
0x1bb: Push("player_name") // @poff=877
0x1bc: @ SendMessage(Stack[-2], Stack[-1])
0x1bd: Pop(2)
0x1be: Push((int) 206)
0x1bf: Push("player_desc") // @poff=901
...
0x1c6: Push((int) -1)
0x1c7: Push("player_name") // @poff=877
0x1c8: @ SendMessage(Stack[-2], Stack[-1])
0x1c9: Pop(2)
0x1ca: Push((int) -1)
0x1cb: Push("player_desc") // @poff=901
...
0x1ec: Push((int) 208)
0x1ed: Push("player_name") // @poff=877
0x1ee: @ SendMessage(Stack[-2], Stack[-1])
0x1ef: Pop(2)
0x1f0: Push((int) 209)
0x1f1: Push("player_desc") // @poff=901
...
0x1f8: Push((int) -1)
0x1f9: Push("player_name") // @poff=877
0x1fa: @ SendMessage(Stack[-2], Stack[-1])
0x1fb: Pop(2)
0x1fc: Push((int) -1)
0x1fd: Push("player_desc") // @poff=901
...
0x209: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=579
0x20a: Pop(0)
...
0x253: Push("BurahCompleted") // @poff=969
0x254: Push((int) 0)
...
0x25b: Push("DankoCompleted") // @poff=999
0x25c: Push((int) 0)
