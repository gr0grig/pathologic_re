...
0x5c: Stack[-2] = "fin_smiren.wmv" // @poff=93
0x5d: Stack[-1] = (bool) 0
...
0x71: Push("game_buttons.xml") // @poff=143
0x72: Push((bool) 0)
...
0x79: Push("game_logo.xml") // @poff=177
0x7a: Push((bool) 0)
...
0x85: Pop(0)
0x86: Push("default") // @poff=205
0x87: @ SetCursor(Stack[-1])
0x88: Pop(1)
0x89: Push("default") // @poff=205
0x8a: @ SetBackground(Stack[-1])
0x8b: Pop(1)
0x8c: Push("menumusic") // @poff=123
...
0x94: Push("game_choose_pers.xml") // @poff=221
0x95: Push((bool) 0)
...
0xb6: Stack[-2] = "intro_danko.wmv" // @poff=263
0xb7: Stack[-1] = (bool) 1
...
0xc0: @ DestroyWindow()
0xc1: Pop(0)
0xc2: Push("world_danko.xml") // @poff=295
0xc3: Push("player_danko.xml") // @poff=327
...
0xd4: Stack[-2] = "intro_burah.wmv" // @poff=361
0xd5: Stack[-1] = (bool) 1
...
0xde: @ DestroyWindow()
0xdf: Pop(0)
0xe0: Push("world_burah.xml") // @poff=393
0xe1: Push("player_burah.xml") // @poff=425
...
0xf2: Stack[-2] = "intro_klara.wmv" // @poff=459
0xf3: Stack[-1] = (bool) 1
...
0xfc: @ DestroyWindow()
0xfd: Pop(0)
0xfe: Push("world_klara.xml") // @poff=491
0xff: Push("player_klara.xml") // @poff=523
...
0x106: Push("menumusic") // @poff=123
0x107: @ PauseSound(Stack[-1])
0x108: Pop(1)
0x109: Push("Loading : ") // @poff=557
...
0x120: @ DestroyWindow()
0x121: Pop(0)
0x122: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=579
0x123: Pop(0)
...
0x12e: @ DestroyWindow()
0x12f: Pop(0)
0x130: Push("world_intro.xml") // @poff=591
0x131: Push("player_intro.xml") // @poff=623
...
0x167: Push("gameoptions") // @poff=783
...
0x16c: Pop(0)
0x16d: Push("options.xml") // @poff=807
0x16e: Push((bool) 0)
...
0x1a0: Push((int) 202)
0x1a1: Push("player_name") // @poff=877
0x1a2: @ SendMessage(Stack[-2], Stack[-1])
0x1a3: Pop(2)
0x1a4: Push((int) 203)
0x1a5: Push("player_desc") // @poff=901
...
0x1ac: Push((int) -1)
0x1ad: Push("player_name") // @poff=877
0x1ae: @ SendMessage(Stack[-2], Stack[-1])
0x1af: Pop(2)
0x1b0: Push((int) -1)
0x1b1: Push("player_desc") // @poff=901
...
0x1c3: Push((int) 205)
0x1c4: Push("player_name") // @poff=877
0x1c5: @ SendMessage(Stack[-2], Stack[-1])
0x1c6: Pop(2)
0x1c7: Push((int) 206)
0x1c8: Push("player_desc") // @poff=901
...
0x1cf: Push((int) -1)
0x1d0: Push("player_name") // @poff=877
0x1d1: @ SendMessage(Stack[-2], Stack[-1])
0x1d2: Pop(2)
0x1d3: Push((int) -1)
0x1d4: Push("player_desc") // @poff=901
...
0x1f5: Push((int) 208)
0x1f6: Push("player_name") // @poff=877
0x1f7: @ SendMessage(Stack[-2], Stack[-1])
0x1f8: Pop(2)
0x1f9: Push((int) 209)
0x1fa: Push("player_desc") // @poff=901
...
0x201: Push((int) -1)
0x202: Push("player_name") // @poff=877
0x203: @ SendMessage(Stack[-2], Stack[-1])
0x204: Pop(2)
0x205: Push((int) -1)
0x206: Push("player_desc") // @poff=901
...
0x212: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=579
0x213: Pop(0)
...
0x25c: Push("BurahCompleted") // @poff=969
0x25d: Push((int) 0)
...
0x264: Push("DankoCompleted") // @poff=999
0x265: Push((int) 0)
