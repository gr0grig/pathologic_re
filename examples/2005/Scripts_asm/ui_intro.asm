...
0x6: @ GetWindowSize(Stack[-2]T, Stack[-3]T)
0x7: Pop(0)
0x8: Push((bool) 1)
...
0x46: Push((int) 204)
0x47: @ GetStringByID(Stack[-9]T, Stack[-1])
0x48: Pop(1)
...
0x50: Push((int) 207)
0x51: @ GetStringByID(Stack[-9]T, Stack[-1])
0x52: Pop(1)
...
0x5a: Push((int) 210)
0x5b: @ GetStringByID(Stack[-9]T, Stack[-1])
0x5c: Pop(1)
...
0x70: Push((int) 212)
0x71: @ GetStringByID(Stack[-9]T, Stack[-1])
0x72: Pop(1)
...
0x77: Push((int) 600)
0x78: @ GetStringByID(Stack[-9]T, Stack[-1])
0x79: Pop(1)
0x7a: Push("intro_font") // @poff=100
0x7b: Push((int) 2)
0x7c: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] * Stack[-1]);
0x7d: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x7e: Push((int) 8)
0x7f: Pop(2); Push(Stack[-2] - Stack[-1]);
0x80: @ GetTextHeightInWidth(Stack[-4]T, Stack[-2], Stack[-1], Stack[-9]T)
0x81: Pop(2)
...
0xb9: Push("intro1") // @poff=72
0xba: @ PauseSound(Stack[-1])
0xbb: Pop(1)
0xbc: GOTO 0xc0

0xbd: Push("intro2") // @poff=86
...
0xdf: PushEmpty(bool)
0xe0: Stack[-1] = (bool) 0
0xe1: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[4 + Tasks[-1].StackPointer]);
...
0xf4: PushEmpty(bool)
0xf5: Stack[-1] = (bool) 1
0xf6: Push("ul") // @poff=122
0xf7: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0xf8: IF (Stack[-1] == 1) GOTO 0xfd; Pop(1)

0xf9: Push("bl") // @poff=128
0xfa: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0xfb: IF (Stack[-1] == 1) GOTO 0xfd; Pop(1)

0xfc: Stack[-1] = (bool) 0
0xfd: IF (Stack[-1] == 1) GOTO 0x102; Pop(1)

0xfe: Push("br") // @poff=134
0xff: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x100: IF (Stack[-1] == 1) GOTO 0x102; Pop(1)

0x101: Stack[-1] = (bool) 0
0x102: IF (Stack[-1] == 1) GOTO 0x107; Pop(1)

0x103: Push("ur") // @poff=140
...
0x119: Push("intro_font") // @poff=100
0x11a: Push((int) 4)
0x11b: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] + Stack[-1]);
0x11c: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] - Stack[-5]);
0x11d: Push((int) 2)
0x11e: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] * Stack[-1]);
0x11f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x120: Push((int) 8)
0x121: Pop(2); Push(Stack[-2] - Stack[-1]);
0x122: Push((float)0.24313725531101227)
0x123: Push((float)0.12156862765550613)
0x124: Push((float)0.11764705926179886)
0x125: Push((int) 1)
0x126: Pop(1); Push(Stack[-1] - Stack[-10]);
0x127: @ PrintInWidth(Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-9]T, Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x128: Pop(8)
0x129: Push("intro_font") // @poff=100
0x12a: Push((int) 4)
0x12b: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] + Stack[-1]);
0x12c: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] - Stack[-5]);
0x12d: Push((int) 1)
0x12e: Pop(2); Push(Stack[-2] - Stack[-1]);
0x12f: Push((int) 2)
0x130: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] * Stack[-1]);
0x131: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x132: Push((int) 8)
0x133: Pop(2); Push(Stack[-2] - Stack[-1]);
0x134: Push((float)0.24313725531101227)
0x135: Push((float)0.12156862765550613)
0x136: Push((float)0.11764705926179886)
0x137: @ PrintInWidth(Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-9]T, Stack[-3], Stack[-2], Stack[-1], Stack[-9])
0x138: Pop(7)
0x139: Return(); Pop(6)

0x13a: Stack[8 + Tasks[-1].StackPointer] = (int)0
0x13b: @ CreateStringVector(Stack[-13]T)
0x13c: Pop(0)
0x13d: Push("ul") // @poff=122
0x13e: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x13f: Pop(1)
0x140: Push("ur") // @poff=140
0x141: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x142: Pop(1)
0x143: Push("br") // @poff=134
0x144: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x145: Pop(1)
0x146: Push("ul") // @poff=122
0x147: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x148: Pop(1)
0x149: Push("br") // @poff=134
0x14a: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x14b: Pop(1)
0x14c: Push("ul") // @poff=122
0x14d: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x14e: Pop(1)
0x14f: Push("bl") // @poff=128
0x150: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x151: Pop(1)
0x152: Push("ul") // @poff=122
0x153: @@@ add(Stack[-1]); Obj=13 // @poff=146
0x154: Pop(1)
0x155: Return(); Pop(0)

0x156: PushEmpty(string, int, string, int)
0x157: @@@ get(Stack[-2], Stack[-8]T); Obj=13 // @poff=150
0x158: Pop(0)
0x159: Push((int) 0)
...
0x15e: @@@ size(Stack[-1]); Obj=13 // @poff=154
0x15f: Pop(0)
