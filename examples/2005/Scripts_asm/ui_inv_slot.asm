...
0x58: Pop(0)
0x59: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x5a: Pop(0)
0x5b: @ LoadImage(Stack[-3]T)
0x5c: Pop(0)
0x5d: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x5e: Pop(0)
