...
Strings:
	...
	W:slot0
	W:slot
// @pool_raw:
...
0xd0: Pop(1)
0xd1: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=83
0xd2: Pop(1)
0xd3: Stack[-1] = Stack[-5]
0xd4: Return(); Pop(2)
...
0xe2: Stack[-6] = (bool) 0
0xe3: Push("button_weapon") // @poff=176
...
0xec: Push("button_clothes") // @poff=204
...
0xf5: Push("button_medcine") // @poff=234
...
0xfe: Push("button_food") // @poff=264
...
0x107: Push("button_other") // @poff=288
...
0x11b: Push("noinv_drop") // @poff=382
...
0x12e: Pop(1)
0x12f: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=38
0x130: Pop(0)
0x131: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x132: IF (Stack[-1] == 0) GOTO 0x143; Pop(1)

0x133: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=51
0x134: Pop(0)
...
0x13c: Stack[-7] = Stack[-2]
0x13d: Push((int) 0)
0x13e: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x13f: Call2 0x14

0x140: Stack[-3] = Stack[-9]
0x141: Pop(3)
0x142: Stack[-1] = 0
0x143: GOTO 0x148
...
0x14b: Stack[-19] = Stack[-3]
0x14c: Stack[-18] = Stack[-2]
0x14d: Stack[-17] = Stack[-1]
0x14e: Call2 0xf

0x14f: Stack[-4] = Stack[-10]
0x150: Pop(4)
0x151: Push(Stack[-6])
...
0x166: Pop(1)
0x167: Push("money") // @poff=404
0x168: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=416
0x169: Pop(1)
0x16a: Stack[-1] = Stack[-5]
0x16b: Return(); Pop(4)
...
0x178: Push((int) 0)
0x179: Push("button_weapon") // @poff=176
0x17a: @ SendMessage(Stack[-2], Stack[-1])
0x17b: Pop(2)
0x17c: GOTO 0x181

0x17d: Push((int) 1)
0x17e: Push("button_weapon") // @poff=176
...
0x184: Push((int) 0)
0x185: Push("button_clothes") // @poff=204
0x186: @ SendMessage(Stack[-2], Stack[-1])
0x187: Pop(2)
0x188: GOTO 0x18d

0x189: Push((int) 1)
0x18a: Push("button_clothes") // @poff=204
...
0x190: Push((int) 0)
0x191: Push("button_medcine") // @poff=234
0x192: @ SendMessage(Stack[-2], Stack[-1])
0x193: Pop(2)
0x194: GOTO 0x199

0x195: Push((int) 1)
0x196: Push("button_medcine") // @poff=234
...
0x19c: Push((int) 0)
0x19d: Push("button_food") // @poff=264
0x19e: @ SendMessage(Stack[-2], Stack[-1])
0x19f: Pop(2)
0x1a0: GOTO 0x1a5

0x1a1: Push((int) 1)
0x1a2: Push("button_food") // @poff=264
...
0x1a8: Push((int) 0)
0x1a9: Push("button_other") // @poff=288
0x1aa: @ SendMessage(Stack[-2], Stack[-1])
0x1ab: Pop(2)
0x1ac: GOTO 0x1b1

0x1ad: Push((int) 1)
0x1ae: Push("button_other") // @poff=288
...
0x1b5: Stack[-1] = Stack[-9]
0x1b6: Pop(1)
0x1b7: @ GetContainer(Stack[-9])
0x1b8: Pop(0)
0x1b9: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=38
0x1ba: Pop(0)
...
0x1bf: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=69
0x1c0: Pop(0)
0x1c1: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=51
0x1c2: Pop(0)
0x1c3: Push((int) 0)
0x1c4: Push((int) 1)
0x1c5: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=428
0x1c6: Pop(2)
...
0x1ce: @@ GetItemID(Stack[-3]); Obj=7 // @poff=59
0x1cf: Pop(0)
0x1d0: Push("Weapon") // @poff=98
0x1d1: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x1d2: Pop(1)
0x1d3: Push(Stack[-2])
0x1d4: IF (Stack[-1] == 0) GOTO 0x1dc; Pop(1)

0x1d5: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=83
0x1d6: Pop(0)
0x1d7: Push(Stack[-1])
...
0x1db: Pop(1)
0x1dc: Push((int) 1)
0x1dd: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=135
0x1de: Pop(1)
...
0x1e8: Pop(1)
0x1e9: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=38
0x1ea: Pop(0)
0x1eb: Stack[-5] = (int) 0
0x1ec: Push((int) 12)
...
0x1f1: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=51
0x1f2: Pop(0)
0x1f3: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=69
0x1f4: Pop(0)
0x1f5: PushEmpty(bool, int, int)
0x1f6: Stack[-8] = Stack[-2]
0x1f7: Stack[-18] = Stack[-1]
0x1f8: Call2 0xc4

0x1f9: Stack[-3] = Stack[-5]
0x1fa: Pop(3)
0x1fb: PushEmpty(bool, object)
0x1fc: Stack[-6] = Stack[-1]
0x1fd: Call2 0xc1

0x1fe: Stack[-2] = Stack[-3]
0x1ff: Pop(2)
0x200: Push(Stack[-2])
