...
Strings:
	...
	A:GetGameTime
	A:GetSaveTime
// @pool_raw:
...
0x15: @@ GetFileName(Stack[-1]); Obj=3 // @poff=24
0x16: Pop(0)
...
0x25: @ CreateSaveEnumerator(Stack[-8]T)
0x26: Pop(0)
...
0x2a: @ CreateObjectVector(Stack[-9]T)
0x2b: Pop(0)
0x2c: Push(Stack[-7])
0x2d: IF (Stack[-1] == 0) GOTO 0x32; Pop(1)

0x2e: Stack[-3] = 0
0x2f: @@@ add(Stack[-3]); Obj=9 // @poff=36
0x30: Pop(0)
0x31: Stack[-3] = 0
0x32: Push((int) 1)
0x33: IF (Stack[-1] == 0) GOTO 0x44; Pop(1)

0x34: @@@ Next(Stack[-2]); Obj=8 // @poff=40
0x35: Pop(0)
...
0x3b: @@ IsQuickSave(Stack[-1]); Obj=2 // @poff=45
0x3c: Pop(0)
0x3d: Push(Stack[-1])
...
0x40: @@@ add(Stack[-2]); Obj=9 // @poff=36
0x41: Pop(0)
0x42: Stack[-2] = 0
0x43: GOTO 0x32

0x44: @ GetWindowSize(Stack[-4]T, Stack[-5]T)
0x45: Pop(0)
0x46: Stack[6 + Tasks[-1].StackPointer] = (int)0
0x47: Stack[7 + Tasks[-1].StackPointer] = (int)0
0x48: @ ClientToScreen(Stack[-6]T, Stack[-7]T)
0x49: Pop(0)
...
0x50: Pop(1)
0x51: Push("sys_border.xml") // @poff=57
0x52: Push((bool) 0)
0x53: @ CreateWindow(Stack[-2], Stack[-1], Stack[-10]T)
0x54: Pop(2)
0x55: PushEmpty()
0x56: Call2 0x1e4
...
0x68: @@@ size(Stack[-10]); Obj=9 // @poff=87
0x69: Pop(0)
0x6a: Stack[-9] = (int) 0
0x6b: Pop(0); Push((bool) Stack[-9] < Stack[-10])
0x6c: IF (Stack[-1] == 0) GOTO 0x10b; Pop(1)

0x6d: @@@ get(Stack[-8], Stack[-9]); Obj=9 // @poff=92
0x6e: Pop(0)
0x6f: Stack[-7] = (int) 0
0x70: Stack[-21] = Stack[-6]
0x71: @ ClientToScreen(Stack[-7], Stack[-6])
0x72: Pop(0)
0x73: Push(Stack[-8])
0x74: IF (Stack[-1] == 0) GOTO 0xd3; Pop(1)

0x75: @@ BlitClipped(Stack[-7], Stack[-6], Stack[-6]T, Stack[-7]T, Stack[-4]T, Stack[-5]T); Obj=8 // @poff=96
0x76: Pop(0)
0x77: PushEmpty(int, int, bool)
0x78: Stack[-3] = (int) 0
0x79: Stack[-24] = Stack[-2]
0x7a: Stack[-1] = (bool) 0
0x7b: Call2 0x10c

0x7c: Pop(3)
0x7d: @@ IsQuickSave(Stack[-5]); Obj=8 // @poff=45
0x7e: Pop(0)
0x7f: Push(Stack[-5])
0x80: IF (Stack[-1] == 0) GOTO 0x8f; Pop(1)

0x81: Push("default") // @poff=108
0x82: Push((int) 129)
0x83: Push((int) 7)
...
0x88: Pop(1)
0x89: Push((float)0.5568627715110779)
0x8a: Push((float)0.5568627715110779)
0x8b: Push((float)0.5568627715110779)
0x8c: @ Print(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8d: Pop(7)
0x8e: GOTO 0xa5

0x8f: Push((int) 0)
0x90: @@ GetProperty(Stack[-1], Stack[-4], Stack[-3]); Obj=9 // @poff=124
0x91: Pop(1)
0x92: Push(Stack[-3])
...
0x9b: Stack[-4] = "????" // @poff=136
0x9c: Push("default") // @poff=108
0x9d: Push((int) 129)
0x9e: Push((int) 7)
0x9f: Pop(1); Push(Stack[-1] + Stack[-24]);
0xa0: Push((float)0.5568627715110779)
0xa1: Push((float)0.5568627715110779)
0xa2: Push((float)0.5568627715110779)
...
0xb4: Stack[-10] = Stack[-1]
0xb5: Call2 0x223

0xb6: Stack[-2] = Stack[-3]
0xb7: Pop(2)
0xb8: Push("default") // @poff=108
0xb9: Push((int) 129)
0xba: Push((int) 47)
0xbb: Pop(1); Push(Stack[-1] + Stack[-24]);
0xbc: Push((float)0.5568627715110779)
0xbd: Push((float)0.5568627715110779)
0xbe: Push((float)0.5568627715110779)
...
0xc5: Push("button_x_pressed") // @poff=154
0xc6: Push((int) 248)
0xc7: Push((int) 68)
...
0xd4: Stack[-3] = (int) 0
0xd5: Stack[-24] = Stack[-2]
0xd6: Stack[-1] = (bool) 1
0xd7: Call2 0x10c

0xd8: Pop(3)
0xd9: Push("default") // @poff=108
0xda: Push((int) 129)
0xdb: Push((int) 47)
...
0xe0: Pop(1)
0xe1: Push((float)0.5568627715110779)
0xe2: Push((float)0.5568627715110779)
0xe3: Push((float)0.5568627715110779)
...
0xe8: Push("button_pressed") // @poff=206
0xe9: Push((int) 129)
0xea: Push((int) 67)
...
0xfe: Push("separator") // @poff=250
0xff: Push((int) 0)
0x100: Push((int) 15)
0x101: Pop(1); Push(Stack[-24] + Stack[-1]);
0x102: Push((int) 1)
0x103: @ StretchBlit(Stack[-4], Stack[-3], Stack[-2], Stack[-4]T, Stack[-1])
0x104: Pop(4)
0x105: Push((int) 31)
...
0x121: Pop(4)
0x122: Push("shot_border") // @poff=292
0x123: Push((int) 1)
0x124: Push((int) 90)
0x125: @ StretchBlit(Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x126: Pop(3)
0x127: Push("shot_border") // @poff=292
0x128: Push((int) 120)
...
0x138: Pop(0)
0x139: Pop(1); Push(Stack[-1] - Stack[5 + Tasks[-1].StackPointer]);
...
0x168: @@@ get(Stack[-2], Stack[-2]T); Obj=9 // @poff=92
0x169: Pop(0)
...
0x17a: Stack[-9] = Stack[-2]
0x17b: Stack[-8] = Stack[-1]
0x17c: Call2 0x1b3
...
0x182: @@@ get(Stack[-1], Stack[-3]T); Obj=9 // @poff=92
0x183: Pop(0)
0x184: Push(Stack[-1])
0x185: IF (Stack[-1] == 0) GOTO 0x18a; Pop(1)

0x186: PushEmpty(object)
0x187: Stack[-2] = Stack[-1]
0x188: Call2 0x14
...
0x19f: @@@ size(Stack[-1]); Obj=9 // @poff=87
0x1a0: Pop(0)
...
0x1c6: @@@ size(Stack[-1]); Obj=9 // @poff=87
0x1c7: Pop(0)
...
0x1dd: @@@ size(Stack[-1]); Obj=9 // @poff=87
0x1de: Pop(0)
0x1df: PushEmpty(int)
0x1e0: Call2 0x1da
...
0x220: Pop(2)
0x221: Stack[-5] = Stack[-12]
0x222: Return(); Pop(10)

0x223: PushEmpty(string, int, int, int, int, int, string, int, int, int, int, int)
0x224: @@ GetSaveTime(Stack[-5], Stack[-4], Stack[-3], Stack[-1], Stack[-2]); Obj=13 // @poff=348
0x225: Pop(0)
