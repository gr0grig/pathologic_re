...
Strings:
	...
	W:to_map
	W:to_quest
// @pool_raw:6d0061007000000074006f005f006d00610070005f006800000074006f005f00710075006500730074005f006800000074006f005f006d0061007000000074006f005f00710075006500730074000000
...
0x2b: Push("to_map_h") // @poff=8
0x2c: @ SetBackground(Stack[-1])
0x2d: Pop(1)
0x2e: GOTO 0x32

0x2f: Push("to_quest_h") // @poff=26
...
0x35: Push("to_map") // @poff=48
0x36: @ SetBackground(Stack[-1])
0x37: Pop(1)
0x38: GOTO 0x3c

0x39: Push("to_quest") // @poff=62
