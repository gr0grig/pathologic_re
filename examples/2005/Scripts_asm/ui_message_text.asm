...
0x8c: Pop(1); Push(Stack[-1] / Stack[1 + Tasks[-1].StackPointer]);
0x8d: Push("scrollbar") // @poff=8
...
0x92: Stack[-10] = (int) 0
0x93: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0x94: Pop(0)
0x95: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0x96: Pop(0)
0x97: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0x98: Pop(0)
0x99: @@ size(Stack[-6]); Obj=9 // @poff=28
0x9a: Pop(0)
0x9b: Stack[-5] = (int) 0
0x9c: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x9d: IF (Stack[-1] == 0) GOTO 0xba; Pop(1)

0x9e: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0x9f: Pop(0)
0xa0: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0xa1: Pop(0)
0xa2: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0xa3: Pop(0)
0xa4: Push("default") // @poff=33
0xa5: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0xa6: Pop(1)
...
0xac: Push("default") // @poff=33
0xad: Push((int) 15)
0xae: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0xc1: @@@ get(Stack[-10], Stack[-4]T); Obj=7 // @poff=4
0xc2: Pop(0)
0xc3: @@@ get(Stack[-9], Stack[-4]T); Obj=8 // @poff=4
0xc4: Pop(0)
0xc5: @@@ get(Stack[-8], Stack[-4]T); Obj=9 // @poff=4
0xc6: Pop(0)
0xc7: @@ size(Stack[-7]); Obj=10 // @poff=28
0xc8: Pop(0)
0xc9: Stack[-6] = (int) 0
0xca: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0xcb: IF (Stack[-1] == 0) GOTO 0xf3; Pop(1)

0xcc: Stack[-11] = Stack[-5]
0xcd: @@ get(Stack[-4], Stack[-6]); Obj=10 // @poff=4
0xce: Pop(0)
0xcf: @@ get(Stack[-3], Stack[-6]); Obj=9 // @poff=4
0xd0: Pop(0)
0xd1: @@ get(Stack[-2], Stack[-6]); Obj=8 // @poff=4
0xd2: Pop(0)
0xd3: Push("default") // @poff=33
0xd4: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0xd5: Pop(1)
...
0xdb: Push("default") // @poff=33
0xdc: Push((int) 15)
0xdd: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0xfa: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0xfb: Pop(0)
0xfc: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0xfd: Pop(0)
0xfe: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0xff: Pop(0)
0x100: @@ size(Stack[-6]); Obj=9 // @poff=28
0x101: Pop(0)
0x102: Stack[-5] = (int) 0
0x103: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x104: IF (Stack[-1] == 0) GOTO 0x13f; Pop(1)

0x105: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0x106: Pop(0)
0x107: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0x108: Pop(0)
0x109: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0x10a: Pop(0)
0x10b: Pop(0); Push((bool) Stack[-2] == Stack[6 + Tasks[-1].StackPointer])
0x10c: IF (Stack[-1] == 0) GOTO 0x115; Pop(1)

0x10d: Push("default") // @poff=33
0x10e: Push((int) 0)
0x10f: Push((float)1.0)
0x110: Push((float)1.0)
0x111: Push((float)1.0)
0x112: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x113: Pop(5)
0x114: GOTO 0x11c

0x115: Push("default") // @poff=33
0x116: Push((int) 0)
0x117: Push((float)0.8040000200271606)
0x118: Push((float)0.8040000200271606)
0x119: Push((float)0.8040000200271606)
0x11a: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x11b: Pop(5)
...
0x123: Push("default") // @poff=33
0x124: Push((int) 15)
0x125: Push((int) 15)
0x126: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x127: Push((float)0.8040000200271606)
0x128: Push((float)0.8040000200271606)
0x129: Push((float)0.8040000200271606)
0x12a: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-16], Stack[-4], Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x12b: Pop(6)
0x12c: GOTO 0x136

0x12d: Push("default") // @poff=33
0x12e: Push((int) 15)
0x12f: Push((int) 15)
0x130: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x131: Push((float)0.6980000138282776)
0x132: Push((float)0.6589999794960022)
0x133: Push((float)0.6470000147819519)
