...
Strings:
	...
	W:slot
	A:Compare
// @pool_raw:
...
0x9f: Stack[-6] = (bool) 0
0xa0: Push("button_weapon") // @poff=144
...
0xa9: Push("button_clothes") // @poff=172
...
0xb2: Push("button_medcine") // @poff=202
...
0xbb: Push("button_food") // @poff=232
...
0xc4: Push("button_other") // @poff=256
...
0xcd: Push("button_detector") // @poff=282
0xce: Pop(1); Push((bool) Stack[-15] == Stack[-1])
0xcf: IF (Stack[-1] == 0) GOTO 0xd1; Pop(1)

0xd0: GOTO 0x105

0xd1: Push("button_anticeptic") // @poff=314
...
0xeb: Pop(1)
0xec: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=372
0xed: Pop(0)
0xee: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0xef: IF (Stack[-1] == 0) GOTO 0x100; Pop(1)

0xf0: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=84
0xf1: Pop(0)
...
0xf9: Stack[-7] = Stack[-2]
0xfa: Push((int) 0)
0xfb: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0xfc: Call2 0x37

0xfd: Stack[-3] = Stack[-9]
0xfe: Pop(3)
0xff: Stack[-1] = 0
0x100: GOTO 0x105
...
0x108: Stack[-19] = Stack[-3]
0x109: Stack[-18] = Stack[-2]
0x10a: Stack[-17] = Stack[-1]
0x10b: Call2 0x13

0x10c: Stack[-4] = Stack[-10]
0x10d: Pop(4)
0x10e: Push(Stack[-6])
...
0x123: Pop(1)
0x124: Push("money") // @poff=385
0x125: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=397
0x126: Pop(1)
...
0x135: Push((int) 0)
0x136: Push("button_weapon") // @poff=144
0x137: @ SendMessage(Stack[-2], Stack[-1])
0x138: Pop(2)
0x139: GOTO 0x13e

0x13a: Push((int) 1)
0x13b: Push("button_weapon") // @poff=144
...
0x141: Push((int) 0)
0x142: Push("button_clothes") // @poff=172
0x143: @ SendMessage(Stack[-2], Stack[-1])
0x144: Pop(2)
0x145: GOTO 0x14a

0x146: Push((int) 1)
0x147: Push("button_clothes") // @poff=172
...
0x14d: Push((int) 0)
0x14e: Push("button_medcine") // @poff=202
0x14f: @ SendMessage(Stack[-2], Stack[-1])
0x150: Pop(2)
0x151: GOTO 0x156

0x152: Push((int) 1)
0x153: Push("button_medcine") // @poff=202
...
0x159: Push((int) 0)
0x15a: Push("button_food") // @poff=232
0x15b: @ SendMessage(Stack[-2], Stack[-1])
0x15c: Pop(2)
0x15d: GOTO 0x162

0x15e: Push((int) 1)
0x15f: Push("button_food") // @poff=232
...
0x165: Push((int) 0)
0x166: Push("button_other") // @poff=256
0x167: @ SendMessage(Stack[-2], Stack[-1])
0x168: Pop(2)
0x169: GOTO 0x16e

0x16a: Push((int) 1)
0x16b: Push("button_other") // @poff=256
...
0x172: Stack[-1] = Stack[-8]
0x173: Pop(1)
0x174: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=372
0x175: Pop(0)
0x176: Stack[-5] = (int) 0
0x177: Push((int) 12)
...
0x17c: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=84
0x17d: Pop(0)
0x17e: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=409
0x17f: Pop(0)
0x180: PushEmpty(bool, int, int)
0x181: Stack[-8] = Stack[-2]
0x182: Stack[-18] = Stack[-1]
0x183: Call2 0x1f

0x184: Stack[-3] = Stack[-5]
0x185: Pop(3)
...
0x1d7: @@ GetItemID(Stack[-1]); Obj=3 // @poff=52
0x1d8: Pop(0)
...
0x1df: Stack[-2] = Stack[-4]
0x1e0: Pop(2)
0x1e1: @ GetInvItemName(Stack[-1], Stack[-2])
0x1e2: Pop(0)
0x1e3: Stack[-1] = Stack[-6]
0x1e4: Return(); Pop(4)
...
0x1e9: IF (Stack[-1] == 1) GOTO 0x1ed; Pop(1)

0x1ea: Pop(0); Push((bool) Stack[-4] == 0)
0x1eb: IF (Stack[-1] == 1) GOTO 0x1ed; Pop(1)
...
0x1f0: @@ Compare(Stack[-1], Stack[-3]); Obj=4 // @poff=445
0x1f1: Pop(0)
