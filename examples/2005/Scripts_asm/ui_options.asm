...
Strings:
	...
	W:audio_page.xml
	W:control_page.xml
// @pool_raw:
...
0x29: PushEmpty()
0x2a: Push((int) 100)
0x2b: Push((float)0.10000000149011612)
0x2c: Pop(1); Push(Stack[-3] - Stack[-1]);
0x2d: Pop(2); Push(Stack[-2] * Stack[-1]);
0x2e: Push((float)4.900000095367432)
0x2f: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x30: Return(); Pop(0)

0x31: PushEmpty()
0x32: Push((float)0.10000000149011612)
0x33: Push((float)4.900000095367432)
...
0x67: @ SetGammaCorrection(Stack[-9]T)
0x68: Pop(0)
0x69: @ EnableShadows(Stack[-17]T)
0x6a: Pop(0)
0x6b: @ SetVolMaster(Stack[-10]T)
0x6c: Pop(0)
0x6d: @ SetVolMusic(Stack[-11]T)
0x6e: Pop(0)
0x6f: @ SetVolVoice(Stack[-12]T)
0x70: Pop(0)
0x71: @ SetVolSounds(Stack[-13]T)
0x72: Pop(0)
0x73: @ SetMouseSensivity(Stack[-14]T)
0x74: Pop(0)
0x75: @ InvertMouse(Stack[-18]T)
0x76: Pop(0)
0x77: Return(); Pop(0)
...
0x7f: Pop(1)
0x80: Push("gamma_scrollbar") // @poff=38
...
0x87: Push((int) 0)
0x88: Push("shadow_check") // @poff=70
...
0x8f: Push((int) 100)
0x90: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0x91: Push("master_scrollbar") // @poff=96
0x92: @ SendMessage(Stack[-2], Stack[-1])
0x93: Pop(2)
0x94: Push((int) 100)
0x95: Pop(1); Push(Stack[-1] * Stack[5 + Tasks[-1].StackPointer]);
0x96: Push("music_scrollbar") // @poff=130
0x97: @ SendMessage(Stack[-2], Stack[-1])
0x98: Pop(2)
0x99: Push((int) 100)
0x9a: Pop(1); Push(Stack[-1] * Stack[6 + Tasks[-1].StackPointer]);
0x9b: Push("voice_scrollbar") // @poff=162
0x9c: @ SendMessage(Stack[-2], Stack[-1])
0x9d: Pop(2)
0x9e: Push((int) 100)
0x9f: Pop(1); Push(Stack[-1] * Stack[7 + Tasks[-1].StackPointer]);
0xa0: Push("sounds_scrollbar") // @poff=194
...
0xaa: Pop(1)
0xab: Push("sensivity_scrollbar") // @poff=228
...
0xb2: Push((int) 0)
0xb3: Push("invert_mouse_check") // @poff=268
0xb4: @ SendMessage(Stack[-2], Stack[-1])
0xb5: Pop(2)
0xb6: Return(); Pop(0)

0xb7: PushEmpty()
0xb8: Push("key_form") // @poff=306
...
0xe6: Push("gamma_scrollbar") // @poff=38
...
0xed: Pop(2)
0xee: @ SetGammaCorrection(Stack[-3]T)
0xef: Pop(0)
0xf0: GOTO 0xf6

0xf1: Push("shadow_check") // @poff=70
...
0xfa: Push("master_scrollbar") // @poff=96
...
0xff: @ SetVolMaster(Stack[-4]T)
0x100: Pop(0)
0x101: GOTO 0x119

0x102: Push("music_scrollbar") // @poff=130
...
0x107: @ SetVolMusic(Stack[-5]T)
0x108: Pop(0)
0x109: GOTO 0x119

0x10a: Push("voice_scrollbar") // @poff=162
...
0x10f: @ SetVolVoice(Stack[-6]T)
0x110: Pop(0)
0x111: GOTO 0x119

0x112: Push("sounds_scrollbar") // @poff=194
...
0x11d: Push("sensivity_scrollbar") // @poff=228
...
0x126: Push("invert_mouse_check") // @poff=268
...
0x133: @@@ DestroyWindow(); Obj=1 // @poff=378
0x134: Pop(0)
0x135: Push((int) 0)
0x136: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x137: IF (Stack[-1] == 0) GOTO 0x149; Pop(1)

0x138: Push("video_page.xml") // @poff=392
0x139: Push((bool) 0)
0x13a: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x13b: Pop(2)
0x13c: Push((int) 1)
0x13d: Push("video") // @poff=336
0x13e: @ SendMessage(Stack[-2], Stack[-1])
0x13f: Pop(2)
0x140: Push((int) 0)
0x141: Push("audio") // @poff=348
0x142: @ SendMessage(Stack[-2], Stack[-1])
0x143: Pop(2)
0x144: Push((int) 0)
0x145: Push("controls") // @poff=360
...
0x14c: Push("audio_page.xml") // @poff=422
0x14d: Push((bool) 0)
0x14e: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x14f: Pop(2)
0x150: Push((int) 0)
0x151: Push("video") // @poff=336
0x152: @ SendMessage(Stack[-2], Stack[-1])
0x153: Pop(2)
0x154: Push((int) 1)
0x155: Push("audio") // @poff=348
0x156: @ SendMessage(Stack[-2], Stack[-1])
0x157: Pop(2)
0x158: Push((int) 0)
0x159: Push("controls") // @poff=360
...
0x160: Push((int) 0)
0x161: Push("video") // @poff=336
0x162: @ SendMessage(Stack[-2], Stack[-1])
0x163: Pop(2)
0x164: Push((int) 0)
0x165: Push("audio") // @poff=348
0x166: @ SendMessage(Stack[-2], Stack[-1])
0x167: Pop(2)
0x168: Push((int) 1)
0x169: Push("controls") // @poff=360
0x16a: @ SendMessage(Stack[-2], Stack[-1])
0x16b: Pop(2)
0x16c: Push("control_page.xml") // @poff=452
0x16d: Push((bool) 0)
0x16e: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x16f: Pop(2)
0x170: PushEmpty(int)
