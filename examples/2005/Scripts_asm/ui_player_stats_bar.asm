...
Strings:
	...
	W:r3
	W:default
// @pool_raw:720031000000720032000000720033000000640065006600610075006c0074000000
...
0x1e: Stack[-5] = "r2" // @poff=6
0x1f: GOTO 0x21

0x20: Stack[-5] = "r3" // @poff=12
...
0x29: Pop(0); Push(Stack[-4] * Stack[0 + Tasks[-1].StackPointer]);
0x2a: Push((int) 100)
0x2b: Stack[-3] = Stack[-2] / Stack[-1]; Pop(2);
0x2c: Push("default") // @poff=18
0x2d: Push((int) 0)
0x2e: Push((int) 0)
