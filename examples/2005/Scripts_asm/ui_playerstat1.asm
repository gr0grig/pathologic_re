...
Strings:
	...
	W:visir
	A:IsWeaponHolstered
// @pool_raw:
...
0x5: Push("visir.xml") // @poff=0
0x6: Push((bool) 0)
0x7: @ CreateWindow(Stack[-2], Stack[-1], Stack[-0]T)
0x8: Pop(2)
0x9: PushEmpty(int)
0xa: Call2 0x243

0xb: Pop(0)
0xc: Push("charge") // @poff=20
...
0x11: Pop(0)
0x12: @ CreateIntVector(Stack[-5]T)
0x13: Pop(0)
0x14: @ CreateStringVector(Stack[-2]T)
0x15: Pop(0)
0x16: @ CreateIntVector(Stack[-3]T)
0x17: Pop(0)
0x18: @ CreateFloatVector(Stack[-4]T)
0x19: Pop(0)
0x1a: @ CreateIntVector(Stack[-6]T)
0x1b: Pop(0)
0x1c: @ CreateIntVector(Stack[-7]T)
0x1d: Pop(0)
0x1e: @ CreateFloatVector(Stack[-8]T)
0x1f: Pop(0)
0x20: Push((bool) 1)
...
0x2a: @@@ add(Stack[-7]); Obj=5 // @poff=34
0x2b: Pop(0)
0x2c: @@@ size(Stack[-3]); Obj=5 // @poff=38
0x2d: Pop(0)
0x2e: Stack[-2] = (int) 0
0x2f: Push((int) 1)
...
0x33: @@@ get(Stack[-1], Stack[-2]); Obj=5 // @poff=43
0x34: Pop(0)
0x35: Pop(0); Push((bool) Stack[-1] == Stack[-7])
0x36: IF (Stack[-1] == 0) GOTO 0x3a; Pop(1)

0x37: @@@ remove(Stack[-2]); Obj=5 // @poff=47
0x38: Pop(0)
0x39: Return(); Pop(6)
...
0x53: @@@ add(Stack[-7]); Obj=3 // @poff=34
0x54: Pop(0)
0x55: Push((float)4.0)
0x56: @@@ add(Stack[-1]); Obj=4 // @poff=34
0x57: Pop(1)
0x58: Return(); Pop(6)

0x59: Push((int) 0)
0x5a: @@@ remove(Stack[-1]); Obj=3 // @poff=47
0x5b: Pop(1)
0x5c: Push((int) 0)
0x5d: @@@ remove(Stack[-1]); Obj=4 // @poff=47
0x5e: Pop(1)
0x5f: Return(); Pop(0)

0x60: PushEmpty(int, float, int, float)
0x61: @@@ size(Stack[-2]); Obj=3 // @poff=38
0x62: Pop(0)
...
0x66: Push((int) 0)
0x67: @@@ get(Stack[-2], Stack[-1]); Obj=4 // @poff=43
0x68: Pop(1)
...
0x6d: Push((int) 0)
0x6e: @@@ set(Stack[-1], Stack[-2]); Obj=4 // @poff=54
0x6f: Pop(1)
0x70: GOTO 0x74
...
0x76: @@@ size(Stack[-4]); Obj=3 // @poff=38
0x77: Pop(0)
...
0x7b: Push((int) 0)
0x7c: @@@ get(Stack[-4], Stack[-1]); Obj=3 // @poff=43
0x7d: Pop(1)
0x7e: Push((int) 0)
0x7f: @@@ get(Stack[-3], Stack[-1]); Obj=4 // @poff=43
0x80: Pop(1)
0x81: Push((float)6.2829999923706055)
...
0xbe: @@@ add(Stack[-4]); Obj=6 // @poff=34
0xbf: Pop(0)
0xc0: @@@ add(Stack[-3]); Obj=7 // @poff=34
0xc1: Pop(0)
0xc2: Push((float)4.0)
0xc3: @@@ add(Stack[-1]); Obj=8 // @poff=34
0xc4: Pop(1)
0xc5: @ GetInvItemSprite(Stack[-1], Stack[-4])
0xc6: Pop(0)
0xc7: @ LoadImage(Stack[-1])
0xc8: Pop(0)
0xc9: @@@ add(Stack[-1]); Obj=2 // @poff=34
0xca: Pop(0)
0xcb: Return(); Pop(2)

0xcc: PushEmpty()
0xcd: @@@ remove(Stack[-1]); Obj=6 // @poff=47
0xce: Pop(0)
0xcf: @@@ remove(Stack[-1]); Obj=8 // @poff=47
0xd0: Pop(0)
0xd1: @@@ remove(Stack[-1]); Obj=7 // @poff=47
0xd2: Pop(0)
0xd3: Return(); Pop(0)

0xd4: PushEmpty(int, int, float, int, int, string, int, int, float, int, int, string)
0xd5: @@@ size(Stack[-6]); Obj=6 // @poff=38
0xd6: Pop(0)
...
0xdd: @@@ get(Stack[-4], Stack[-5]); Obj=8 // @poff=43
0xde: Pop(0)
...
0xe3: @@@ set(Stack[-5], Stack[-4]); Obj=8 // @poff=54
0xe4: Pop(0)
0xe5: GOTO 0xee

0xe6: PushEmpty(int)
0xe7: Stack[-6] = Stack[-1]
0xe8: Call2 0xcc
...
0x100: @@@ clear(); Obj=2 // @poff=112
0x101: Pop(0)
0x102: Return(); Pop(12)

0x103: PushEmpty(int, int, int, int)
0x104: @@@ size(Stack[-2]); Obj=5 // @poff=38
0x105: Pop(0)
...
0x10c: Push((int) 0)
0x10d: @@@ get(Stack[-2], Stack[-1]); Obj=5 // @poff=43
0x10e: Pop(1)
0x10f: Push((int) 100)
0x110: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x111: IF (Stack[-1] == 0) GOTO 0x117; Pop(1)

0x112: Push("daychange.xml") // @poff=118
0x113: Push((bool) 0)
0x114: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x115: Pop(2)
0x116: GOTO 0x11b

0x117: Push("daychangereal.xml") // @poff=146
0x118: Push((bool) 0)
0x119: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x11a: Pop(2)
0x11b: PushEmpty()
0x11c: Call2 0x3e
...
0x120: @@@ size(Stack[-6]); Obj=6 // @poff=38
0x121: Pop(0)
...
0x128: @@@ get(Stack[-4], Stack[-5]); Obj=6 // @poff=43
0x129: Pop(0)
0x12a: @@@ get(Stack[-3], Stack[-5]); Obj=7 // @poff=43
0x12b: Pop(0)
0x12c: @@@ get(Stack[-2], Stack[-5]); Obj=8 // @poff=43
0x12d: Pop(0)
0x12e: Push((float)4.0)
0x12f: Pop(1); Push(Stack[-3] / Stack[-1]);
0x130: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x131: PushEmpty(int, int, int, float)
0x132: Stack[-8] = Stack[-4]
0x133: Stack[-7] = Stack[-3]
...
0x142: @@ size(Stack[-5]); Obj=11 // @poff=38
0x143: Pop(0)
0x144: Push((int) 1)
...
0x147: Push((int) 0)
0x148: @@ get(Stack[-10]T, Stack[-1]); Obj=12 // @poff=43
0x149: Pop(1)
...
0x151: Push("visir.xml") // @poff=0
0x152: Push((bool) 0)
0x153: @ CreateWindow(Stack[-2], Stack[-1], Stack[-0]T)
0x154: Pop(2)
0x155: PushEmpty(int)
0x156: Call2 0x243

0x157: Pop(0)
0x158: Push("charge") // @poff=20
...
0x164: @@@ DestroyWindow(); Obj=0 // @poff=182
0x165: Pop(0)
0x166: GOTO 0x1c1
...
0x16a: Push((int) 0)
0x16b: @@ get(Stack[-5], Stack[-1]); Obj=12 // @poff=43
0x16c: Pop(1)
0x16d: Push((int) 1)
0x16e: @@ get(Stack[-4], Stack[-1]); Obj=12 // @poff=43
0x16f: Pop(1)
0x170: PushEmpty(int, int)
0x171: Stack[-6] = Stack[-2]
0x172: Stack[-5] = Stack[-1]
0x173: Call2 0xbd
...
0x179: Push((int) 0)
0x17a: @@ get(Stack[-3], Stack[-1]); Obj=12 // @poff=43
0x17b: Pop(1)
0x17c: Push((int) 1)
0x17d: @@ get(Stack[-2], Stack[-1]); Obj=12 // @poff=43
0x17e: Pop(1)
0x17f: GOTO 0x1c1
...
0x196: Pop(1)
0x197: Push("mail") // @poff=58
0x198: @ PlaySound(Stack[-1])
0x199: Pop(1)
0x19a: Push("HasMail") // @poff=196
0x19b: @ Trace(Stack[-1])
0x19c: Pop(1)
0x19d: GOTO 0x1c1
...
0x1a4: Pop(1)
0x1a5: Push("diary") // @poff=68
0x1a6: @ PlaySound(Stack[-1])
0x1a7: Pop(1)
0x1a8: Push("HasDiary") // @poff=212
0x1a9: @ Trace(Stack[-1])
0x1aa: Pop(1)
0x1ab: GOTO 0x1c1
...
0x1b2: Pop(1)
0x1b3: Push("ReputationUP") // @poff=230
0x1b4: @ Trace(Stack[-1])
0x1b5: Pop(1)
0x1b6: GOTO 0x1c1
...
0x1bd: Pop(1)
0x1be: Push("ReputationDown") // @poff=256
0x1bf: @ Trace(Stack[-1])
0x1c0: Pop(1)
0x1c1: Return(); Pop(10)
...
0x213: @ GetStringByID(Stack[-2], Stack[-10]T)
0x214: Pop(0)
0x215: Push((float)3.140000104904175)
0x216: Pop(1); Push(Stack[-1] * Stack[11 + Tasks[-1].StackPointer]);
...
0x24b: Push("vcharge") // @poff=362
0x24c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=378
0x24d: Pop(1)
...
0x259: @@ IsVisirOn(Stack[-1]); Obj=2 // @poff=390
0x25a: Pop(0)
...
0x266: Push("visir") // @poff=400
0x267: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=378
0x268: Pop(1)
...
0x274: @@ IsWeaponHolstered(Stack[-1]); Obj=2 // @poff=412
0x275: Pop(0)
