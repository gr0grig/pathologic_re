...
0x1: @ GetWindowSize(Stack[-2]T, Stack[-3]T)
0x2: Pop(0)
...
0x20: @ GetStringByID(Stack[-2], Stack[-0]T)
0x21: Pop(0)
0x22: Push((float)3.140000104904175)
0x23: Pop(1); Push(Stack[-1] * Stack[1 + Tasks[-1].StackPointer]);
0x24: Push((float)1.0)
0x25: Pop(2); Push(Stack[-2] / Stack[-1]);
0x26: Push((float)2.0)
0x27: Pop(2); Push(Stack[-2] / Stack[-1]);
0x28: Stack[-2] = Sin(Stack[-1]); Pop(1);
0x29: Push("help") // @poff=0
0x2a: Push((int) 10)
0x2b: Push((int) 10)
0x2c: Push((float)1.0)
0x2d: Push((float)1.0)
