...
Strings:
	...
	W:cancel
	A:clear
// @pool_raw:640065006600610075006c00740000006d006f006e00650079005f0073006c006f007400000073697a650067657400630073006c006f007400300000006f006b000000630061006e00630065006c000000636c65617200
...
0x0: @ GetPlayerMoneyCount(Stack[-0]T)
0x1: Pop(0)
...
0xd: @ ShowCursor()
0xe: Pop(0)
0xf: @ GetChooseItems(Stack[-1]T)
0x10: Pop(0)
0x11: @ GetAdditionalData(Stack[-2]T)
0x12: Pop(0)
0x13: @ GetReturnValue(Stack[-3]T)
0x14: Pop(0)
0x15: PushEmpty()
0x16: Call2 0x1b
...
0x1c: Push("money_slot") // @poff=16
0x1d: @ SendMessage(Stack[-0]T, Stack[-1])
0x1e: Pop(1)
0x1f: @@@ size(Stack[-4]); Obj=1 // @poff=38
0x20: Pop(0)
0x21: Stack[-3] = (int) 0
...
0x28: @@@ get(Stack[-2], Stack[-3]); Obj=1 // @poff=43
0x29: Pop(0)
0x2a: Push((int) 0)
0x2b: Push("cslot0") // @poff=47
0x2c: Push((int) 1)
