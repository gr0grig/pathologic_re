...
Strings:
	...
	W:selected
	A:GetItemID
// @pool_raw:640065006600610075006c0074000000730065006c006500630074006500640000004765744974656d494400
...
0xe: Push((int) 1)
0xf: Push((int) 1)
0x10: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x11: Pop(2)
0x12: Push((int) 1)
0x13: Pop(1); Push((bool) Stack[0 + Tasks[-1].StackPointer] > Stack[-1])
0x14: IF (Stack[-1] == 0) GOTO 0x1a; Pop(1)

0x15: Push("default") // @poff=0
0x16: Push((int) 2)
0x17: Push((int) 35)
0x18: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x19: Pop(3)
0x1a: Return(); Pop(0)
...
0x3a: Push("selected") // @poff=16
0x3b: @ SetBackground(Stack[-1])
0x3c: Pop(1)
0x3d: GOTO 0x41

0x3e: Push("default") // @poff=0
...
0x53: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=34
0x54: Pop(0)
0x55: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x56: Pop(0)
0x57: @ LoadImage(Stack[-3]T)
0x58: Pop(0)
0x59: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x5a: Pop(0)
0x5b: Push((int) 1)
0x5c: @ SetTooltip(Stack[-1], Stack[-3], Stack[-2]T)
0x5d: Pop(1)
0x5e: GOTO 0x63
