...
Strings:
	...
	A:GetGameTime
	A:GetSaveTime
// @pool_raw:
...
0xa: PushEmpty()
0xb: Pop(0); PushNull((bool) Stack[-3] == 0)
0xc: IF (Stack[-1] == 0) GOTO 0x11; Pop(1)

0xd: Push("button_save") // @poff=0
0xe: @ Blit(Stack[-1], Stack[-3], Stack[-2])
0xf: Pop(1)
0x10: GOTO 0x14

0x11: Push("button_overwrite") // @poff=24
...
0x1b: @@ GetFileName(Stack[-1]); Obj=3 // @poff=58
0x1c: Pop(0)
...
0x2b: @ CreateSaveEnumerator(Stack[-8]T)
0x2c: Pop(0)
...
0x30: @ CreateObjectVector(Stack[-9]T)
0x31: Pop(0)
0x32: Push(Stack[-7])
0x33: IF (Stack[-1] == 0) GOTO 0x38; Pop(1)

0x34: Stack[-3] = 0
0x35: @@@ add(Stack[-3]); Obj=9 // @poff=70
0x36: Pop(0)
0x37: Stack[-3] = 0
0x38: Push((int) 1)
0x39: IF (Stack[-1] == 0) GOTO 0x4a; Pop(1)

0x3a: @@@ Next(Stack[-2]); Obj=8 // @poff=74
0x3b: Pop(0)
...
0x41: @@ IsQuickSave(Stack[-1]); Obj=2 // @poff=79
0x42: Pop(0)
0x43: Push(Stack[-1])
...
0x46: @@@ add(Stack[-2]); Obj=9 // @poff=70
0x47: Pop(0)
0x48: Stack[-2] = 0
0x49: GOTO 0x38

0x4a: @ GetWindowSize(Stack[-4]T, Stack[-5]T)
0x4b: Pop(0)
0x4c: Stack[6 + Tasks[-1].StackPointer] = (int)0
0x4d: Stack[7 + Tasks[-1].StackPointer] = (int)0
0x4e: @ ClientToScreen(Stack[-6]T, Stack[-7]T)
0x4f: Pop(0)
...
0x56: Pop(1)
0x57: Push("sys_border.xml") // @poff=91
0x58: Push((bool) 0)
0x59: @ CreateWindow(Stack[-2], Stack[-1], Stack[-10]T)
0x5a: Pop(2)
0x5b: PushEmpty()
0x5c: Call2 0x1ea
...
0x8e: Pop(1)
0x8f: Push((float)0.5568627715110779)
0x90: Push((float)0.5568627715110779)
0x91: Push((float)0.5568627715110779)
0x92: @ Print(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x93: Pop(7)
0x94: GOTO 0xab

0x95: Push((int) 0)
0x96: @@ GetProperty(Stack[-1], Stack[-4], Stack[-3]); Obj=9 // @poff=158
0x97: Pop(1)
0x98: Push(Stack[-3])
...
0x9e: Stack[-2] = Stack[-6]
0x9f: Pop(2)
0xa0: GOTO 0xa2

0xa1: Stack[-4] = "????" // @poff=170
0xa2: Push("default") // @poff=142
0xa3: Push((int) 129)
0xa4: Push((int) 7)
0xa5: Pop(1); Push(Stack[-1] + Stack[-24]);
0xa6: Push((float)0.5568627715110779)
0xa7: Push((float)0.5568627715110779)
0xa8: Push((float)0.5568627715110779)
0xa9: @ Print(Stack[-6], Stack[-5], Stack[-4], Stack[-10], Stack[-3], Stack[-2], Stack[-1])
0xaa: Pop(6)
0xab: PushEmpty(string, object)
0xac: Stack[-10] = Stack[-1]
0xad: Call2 0x211

0xae: Stack[-2] = Stack[-3]
0xaf: Pop(2)
0xb0: Push("big") // @poff=180
0xb1: Push((int) 129)
0xb2: Push((int) 28)
...
0xba: Stack[-10] = Stack[-1]
0xbb: Call2 0x229

0xbc: Stack[-2] = Stack[-3]
0xbd: Pop(2)
0xbe: Push("default") // @poff=142
0xbf: Push((int) 129)
0xc0: Push((int) 47)
0xc1: Pop(1); Push(Stack[-1] + Stack[-24]);
0xc2: Push((float)0.5568627715110779)
0xc3: Push((float)0.5568627715110779)
0xc4: Push((float)0.5568627715110779)
...
0xcb: Push("button_x_pressed") // @poff=188
0xcc: Push((int) 248)
0xcd: Push((int) 68)
...
0xda: Stack[-3] = (int) 0
0xdb: Stack[-24] = Stack[-2]
0xdc: Stack[-1] = (bool) 1
0xdd: Call2 0x112

0xde: Pop(3)
0xdf: Push("default") // @poff=142
0xe0: Push((int) 129)
0xe1: Push((int) 47)
...
0xe6: Pop(1)
0xe7: Push((float)0.5568627715110779)
0xe8: Push((float)0.5568627715110779)
0xe9: Push((float)0.5568627715110779)
...
0xee: Push("button_pressed") // @poff=240
0xef: Push((int) 129)
0xf0: Push((int) 67)
...
0x104: Push("separator") // @poff=284
0x105: Push((int) 0)
0x106: Push((int) 15)
0x107: Pop(1); Push(Stack[-24] + Stack[-1]);
0x108: Push((int) 1)
0x109: @ StretchBlit(Stack[-4], Stack[-3], Stack[-2], Stack[-4]T, Stack[-1])
0x10a: Pop(4)
0x10b: Push((int) 31)
...
0x127: Pop(4)
0x128: Push("shot_border") // @poff=326
0x129: Push((int) 1)
0x12a: Push((int) 90)
0x12b: @ StretchBlit(Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x12c: Pop(3)
0x12d: Push("shot_border") // @poff=326
0x12e: Push((int) 120)
...
0x13e: Pop(0)
0x13f: Pop(1); Push(Stack[-1] - Stack[5 + Tasks[-1].StackPointer]);
...
0x166: Stack[-9] = Stack[-2]
0x167: Stack[-8] = Stack[-1]
0x168: Call2 0x192
...
0x16e: @@@ get(Stack[-2], Stack[-2]T); Obj=9 // @poff=126
0x16f: Pop(0)
0x170: PushEmpty(object)
0x171: Stack[-3] = Stack[-1]
0x172: Call2 0x15
...
0x188: @@@ get(Stack[-1], Stack[-3]T); Obj=9 // @poff=126
0x189: Pop(0)
0x18a: Push(Stack[-1])
0x18b: IF (Stack[-1] == 0) GOTO 0x190; Pop(1)

0x18c: PushEmpty(object)
0x18d: Stack[-2] = Stack[-1]
0x18e: Call2 0x1a
...
0x1a5: @@@ size(Stack[-1]); Obj=9 // @poff=121
0x1a6: Pop(0)
...
0x1cc: @@@ size(Stack[-1]); Obj=9 // @poff=121
0x1cd: Pop(0)
...
0x1e3: @@@ size(Stack[-1]); Obj=9 // @poff=121
0x1e4: Pop(0)
0x1e5: PushEmpty(int)
0x1e6: Call2 0x1e0
...
0x226: Pop(2)
0x227: Stack[-5] = Stack[-12]
0x228: Return(); Pop(10)

0x229: PushEmpty(string, int, int, int, int, int, string, int, int, int, int, int)
0x22a: @@ GetSaveTime(Stack[-5], Stack[-4], Stack[-3], Stack[-1], Stack[-2]); Obj=13 // @poff=382
0x22b: Pop(0)
