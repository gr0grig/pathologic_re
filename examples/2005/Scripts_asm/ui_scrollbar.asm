...
// @pool_raw:73006c0069006400650072005f007000720065007300730065006400000073006c00690064006500720000007300630072006f006c006c005f0062007500740074006f006e005f007500700000007300630072006f006c006c005f0062007500740074006f006e005f0064006f0077006e000000
...
0x22: Push("slider_pressed") // @poff=0
...
0x3f: Push((int) 100)
0x40: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] * Stack[-1]);
...
0x4a: Stack[-11] = Stack[-2]
0x4b: Stack[-10] = Stack[-1]
0x4c: Call2 0xcf
...
0x55: Stack[-7] = Stack[-3]
0x56: GOTO 0x58

0x57: Stack[-8] = Stack[-3]
0x58: Push((int) 0)
...
0x6b: Push((int) 27)
0x6c: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0x6d: Push((int) 100)
...
0x7a: Push((int) 27)
0x7b: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0x7c: Push((int) 100)
...
0x8b: PushEmpty()
0x8c: Push("scroll_button_up") // @poff=44
...
0x9c: Push("scroll_button_down") // @poff=78
0x9d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9e: IF (Stack[-1] == 0) GOTO 0xab; Pop(1)

0x9f: Push((int) 27)
0xa0: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0xa1: Push((int) 100)
...
0xb3: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0xb4: Push((int) 100)
...
0xd6: Push((int) 14)
0xd7: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xe4: Push((int) 14)
0xe5: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-1]);
