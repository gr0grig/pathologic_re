...
Strings:
	...
	A:RemoveItem
	A:AddItem
// @pool_raw:
// @pool_encoding:utf8
...
0x2c: @@@ add(Stack[-7]); Obj=21 // @poff=16
0x2d: Pop(0)
0x2e: Return(); Pop(6)

0x2f: Stack[-2] = 0
0x30: PushEmpty(float, float)
0x31: @ GetContainer(Stack[-26]T)
0x32: Pop(0)
0x33: @ CreateObjectVector(Stack[-20]T)
0x34: Pop(0)
0x35: @ CreateObjectVector(Stack[-21]T)
0x36: Pop(0)
0x37: @ CreateObjectVector(Stack[-4]T)
0x38: Pop(0)
0x39: @ CreateIntVector(Stack[-5]T)
0x3a: Pop(0)
0x3b: @ CreateIntVector(Stack[-6]T)
0x3c: Pop(0)
0x3d: @ CreateObjectVector(Stack[-7]T)
0x3e: Pop(0)
0x3f: @ CreateIntVector(Stack[-8]T)
0x40: Pop(0)
0x41: @ CreateIntVector(Stack[-9]T)
0x42: Pop(0)
0x43: @ CreateObjectVector(Stack[-10]T)
0x44: Pop(0)
0x45: @ CreateIntVector(Stack[-11]T)
0x46: Pop(0)
0x47: @ CreateObjectVector(Stack[-12]T)
0x48: Pop(0)
0x49: @ CreateIntVector(Stack[-13]T)
0x4a: Pop(0)
0x4b: @ CreateObjectVector(Stack[-14]T)
0x4c: Pop(0)
0x4d: @ CreateIntVector(Stack[-15]T)
0x4e: Pop(0)
0x4f: @ CreateObjectVector(Stack[-16]T)
0x50: Pop(0)
0x51: @ CreateIntVector(Stack[-17]T)
0x52: Pop(0)
0x53: @ CreateObjectVector(Stack[-18]T)
0x54: Pop(0)
0x55: @ CreateIntVector(Stack[-19]T)
0x56: Pop(0)
0x57: PushEmpty(int)
0x58: Call2 0x616
...
0x8a: Stack[-8] = Stack[-2]
0x8b: Stack[-7] = Stack[-1]
0x8c: Call2 0x5d0
...
0x9a: PushEmpty(int)
0x9b: Stack[-2] = Stack[-1]
0x9c: Call2 0x52c

0x9d: Pop(1)
0x9e: Return(); Pop(2)

0x9f: Push("cancel_button") // @poff=36
...
0xbf: Pop(0)
0xc0: Push("l_scroll_button_top") // @poff=130
...
0xc9: Push("l_scroll_button_bottom") // @poff=170
...
0xd2: Push("r_scroll_button_top") // @poff=216
...
0xdb: Push("r_scroll_button_bottom") // @poff=256
...
0xe4: Push("l_scrollbar") // @poff=302
...
0xf5: Push("r_scrollbar") // @poff=326
...
0x115: @ GetPlayerMoneyCount(Stack[-2]T)
0x116: Pop(0)
0x117: GOTO 0x119

0x118: Stack[2 + Tasks[-1].StackPointer] = (int)0
0x119: @@@ clear(); Obj=20 // @poff=370
0x11a: Pop(0)
0x11b: @@@ clear(); Obj=21 // @poff=370
0x11c: Pop(0)
0x11d: @@@ clear(); Obj=4 // @poff=370
0x11e: Pop(0)
0x11f: @@@ clear(); Obj=5 // @poff=370
0x120: Pop(0)
0x121: @@@ clear(); Obj=6 // @poff=370
0x122: Pop(0)
0x123: @@@ clear(); Obj=7 // @poff=370
0x124: Pop(0)
0x125: @@@ clear(); Obj=8 // @poff=370
0x126: Pop(0)
0x127: @@@ clear(); Obj=9 // @poff=370
0x128: Pop(0)
0x129: @@@ clear(); Obj=10 // @poff=370
0x12a: Pop(0)
0x12b: @@@ clear(); Obj=11 // @poff=370
0x12c: Pop(0)
0x12d: @@@ clear(); Obj=12 // @poff=370
0x12e: Pop(0)
0x12f: @@@ clear(); Obj=13 // @poff=370
0x130: Pop(0)
0x131: @@@ clear(); Obj=14 // @poff=370
0x132: Pop(0)
0x133: @@@ clear(); Obj=15 // @poff=370
0x134: Pop(0)
0x135: @@@ clear(); Obj=16 // @poff=370
0x136: Pop(0)
0x137: @@@ clear(); Obj=17 // @poff=370
0x138: Pop(0)
0x139: @@@ clear(); Obj=18 // @poff=370
0x13a: Pop(0)
0x13b: @@@ clear(); Obj=19 // @poff=370
0x13c: Pop(0)
0x13d: PushEmpty()
0x13e: Call2 0x1ed
...
0x151: Pop(0)
0x152: @@@ size(Stack[-1]); Obj=7 // @poff=0
0x153: Pop(0)
0x154: Push((int) 18)
...
0x158: Push("l_scrollbar") // @poff=302
0x159: @ SendMessage(Stack[-2], Stack[-1])
0x15a: Pop(2)
0x15b: GOTO 0x160

0x15c: Push((int) 0)
0x15d: Push("l_scrollbar") // @poff=302
0x15e: @ SendMessage(Stack[-2], Stack[-1])
0x15f: Pop(2)
0x160: @@@ size(Stack[-1]); Obj=4 // @poff=0
0x161: Pop(0)
0x162: Push((int) 18)
...
0x166: Push("r_scrollbar") // @poff=326
0x167: @ SendMessage(Stack[-2], Stack[-1])
0x168: Pop(2)
0x169: GOTO 0x16e

0x16a: Push((int) 0)
0x16b: Push("r_scrollbar") // @poff=326
...
0x1ac: Stack[-13] = Stack[-2]
0x1ad: Stack[-4] = Stack[-1]
0x1ae: Call2 0x6ae
...
0x1b3: Stack[-13] = Stack[-2]
0x1b4: Stack[-4] = Stack[-1]
0x1b5: Call2 0x6a6

0x1b6: Stack[-3] = Stack[-5]
0x1b7: Pop(3)
0x1b8: PushEmpty(object, int, int)
0x1b9: Stack[-13] = Stack[-2]
0x1ba: Stack[-4] = Stack[-1]
0x1bb: Call2 0x69d

0x1bc: Stack[-3] = Stack[-7]
0x1bd: Pop(3)
...
0x1cb: @@@ add(Stack[-4]); Obj=4 // @poff=16
0x1cc: Pop(0)
0x1cd: @@@ add(Stack[-2]); Obj=5 // @poff=16
0x1ce: Pop(0)
0x1cf: Push((int) 0)
0x1d0: @@@ add(Stack[-1]); Obj=6 // @poff=16
0x1d1: Pop(1)
0x1d2: GOTO 0x1e8
...
0x1e1: @@@ add(Stack[-4]); Obj=4 // @poff=16
0x1e2: Pop(0)
0x1e3: @@@ add(Stack[-2]); Obj=5 // @poff=16
0x1e4: Pop(0)
0x1e5: Push((int) 0)
0x1e6: @@@ add(Stack[-1]); Obj=6 // @poff=16
0x1e7: Pop(1)
0x1e8: Push((int) 1)
...
0x1f6: Stack[-3] = Stack[-1]
0x1f7: Call2 0x6bf

0x1f8: Stack[-2] = Stack[-6]
0x1f9: Pop(2)
0x1fa: PushEmpty(object, int)
0x1fb: Stack[-3] = Stack[-1]
0x1fc: Call2 0x6b6

0x1fd: Stack[-2] = Stack[-4]
0x1fe: Pop(2)
0x1ff: @@@ add(Stack[-2]); Obj=7 // @poff=16
0x200: Pop(0)
0x201: @@@ add(Stack[-4]); Obj=8 // @poff=16
0x202: Pop(0)
0x203: Push((int) 0)
0x204: @@@ add(Stack[-1]); Obj=9 // @poff=16
0x205: Pop(1)
0x206: Push((int) 1)
...
0x23c: Stack[-14] = Stack[-2]
0x23d: Stack[-4] = Stack[-1]
0x23e: Call2 0x6a6

0x23f: Stack[-3] = Stack[-5]
0x240: Pop(3)
...
0x245: Stack[-3] = Stack[-7]
0x246: Pop(3)
0x247: @@ add(Stack[-4]); Obj=10 // @poff=16
0x248: Pop(0)
0x249: @@ add(Stack[-2]); Obj=9 // @poff=16
0x24a: Pop(0)
0x24b: Push((int) 1)
...
0x251: @@@ size(Stack[-2]); Obj=7 // @poff=0
0x252: Pop(0)
0x253: Push((int) 2)
...
0x263: @@@ size(Stack[-2]); Obj=4 // @poff=0
0x264: Pop(0)
0x265: Push((int) 2)
...
0x272: Stack[-1] = Stack[-5]
0x273: Return(); Pop(4)

0x274: PushEmpty(int, int, int, object, int, int, object, int, int, int, object, int, int, object)
0x275: @@@ size(Stack[-7]); Obj=7 // @poff=0
0x276: Pop(0)
0x277: Push((int) 18)
0x278: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x290: Push((int) 18)
0x291: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x296: @@@ get(Stack[-4], Stack[-5]); Obj=7 // @poff=5
0x297: Pop(0)
0x298: @@@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=5
0x299: Pop(0)
0x29a: Stack[-6] = (int) 0
...
0x2af: Pop(0)
0x2b0: @@ add(Stack[-2]); Obj=1 // @poff=16
0x2b1: Pop(0)
0x2b2: @@ add(Stack[-3]); Obj=1 // @poff=16
0x2b3: Pop(0)
...
0x2d0: @@@ size(Stack[-7]); Obj=4 // @poff=0
0x2d1: Pop(0)
0x2d2: Push((int) 18)
0x2d3: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2eb: Push((int) 18)
0x2ec: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2f1: @@@ get(Stack[-6], Stack[-3]); Obj=4 // @poff=5
0x2f2: Pop(0)
0x2f3: @@@ get(Stack[-4], Stack[-3]); Obj=5 // @poff=5
0x2f4: Pop(0)
0x2f5: Stack[-5] = (int) 0
...
0x30a: Pop(0)
0x30b: @@ add(Stack[-2]); Obj=1 // @poff=16
0x30c: Pop(0)
0x30d: @@ add(Stack[-4]); Obj=1 // @poff=16
0x30e: Pop(0)
...
0x329: Stack[-6] = 0
0x32a: Push("r_money_slot") // @poff=376
0x32b: @ SendMessage(Stack[-2]T, Stack[-1])
0x32c: Pop(1)
0x32d: Return(); Pop(0)

0x32e: Push("l_money_slot") // @poff=402
0x32f: @ SendMessage(Stack[-3]T, Stack[-1])
0x330: Pop(1)
0x331: Return(); Pop(0)
...
0x336: Pop(0)
0x337: @@@ size(Stack[-7]); Obj=21 // @poff=0
0x338: Pop(0)
0x339: Stack[-2] = (int) 0
0x33a: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x33b: IF (Stack[-1] == 0) GOTO 0x35d; Pop(1)

0x33c: @@@ get(Stack[-5], Stack[-2]); Obj=21 // @poff=5
0x33d: Pop(0)
0x33e: PushEmpty(bool, object, object, int)
0x33f: Stack[-7] = Stack[-3]
0x340: Stack[-9] = Stack[-2]
0x341: PushEmpty(int, object)
0x342: Stack[-11] = Stack[-1]
0x343: Call2 0x67a

0x344: Stack[-2] = Stack[-3]
0x345: Pop(2)
0x346: Call2 0x706

0x347: Stack[-4] = Stack[-10]
0x348: Pop(4)
0x349: Pop(0); Push((bool) Stack[-6] == 0)
0x34a: IF (Stack[-1] == 0) GOTO 0x34e; Pop(1)

0x34b: Push("Error: failed to remove item") // @poff=428
0x34c: @ Trace(Stack[-1])
0x34d: Pop(1)
0x34e: PushEmpty(bool, object, object, int)
0x34f: Stack[-8] = Stack[-3]
0x350: Stack[-9] = Stack[-2]
0x351: Stack[-1] = (int) 0
0x352: Call2 0x71f

0x353: Stack[-4] = Stack[-10]
0x354: Pop(4)
0x355: Pop(0); Push((bool) Stack[-6] == 0)
0x356: IF (Stack[-1] == 0) GOTO 0x35a; Pop(1)

0x357: Push("Error: failed to add item") // @poff=486
0x358: @ Trace(Stack[-1])
0x359: Pop(1)
0x35a: Push((int) 1)
...
0x379: Stack[-4] = Stack[-10]
0x37a: Pop(4)
0x37b: Pop(0); Push((bool) Stack[-6] == 0)
0x37c: IF (Stack[-1] == 0) GOTO 0x380; Pop(1)

0x37d: Push("Error: failed to add item") // @poff=486
0x37e: @ Trace(Stack[-1])
0x37f: Pop(1)
0x380: Push((int) 1)
...
0x386: @ SetPlayerMoneyCount(Stack[-2]T)
0x387: Pop(0)
...
0x417: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=5
0x418: Pop(0)
0x419: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=5
0x41a: Pop(0)
0x41b: PushEmpty(bool, object, object)
0x41c: Stack[-14] = Stack[-2]
...
0x429: @@ set(Stack[-3], Stack[-1]); Obj=10 // @poff=538
0x42a: Pop(1)
...
0x433: @@ add(Stack[-11]); Obj=10 // @poff=16
0x434: Pop(0)
0x435: Push((int) 1)
0x436: @@ add(Stack[-1]); Obj=10 // @poff=16
0x437: Pop(1)
...
0x43e: @@ size(Stack[-4]); Obj=10 // @poff=0
0x43f: Pop(0)
0x440: Stack[-2] = (int) 0
0x441: Pop(0); Push((bool) Stack[-2] < Stack[-4])
0x442: IF (Stack[-1] == 0) GOTO 0x45e; Pop(1)

0x443: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=5
0x444: Pop(0)
0x445: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=5
0x446: Pop(0)
0x447: PushEmpty(bool, object, object)
0x448: Stack[-14] = Stack[-2]
...
0x452: @@ remove(Stack[-2]); Obj=10 // @poff=9
0x453: Pop(0)
0x454: @@ remove(Stack[-2]); Obj=9 // @poff=9
0x455: Pop(0)
0x456: GOTO 0x459

0x457: @@ set(Stack[-2], Stack[-1]); Obj=9 // @poff=538
0x458: Pop(0)
...
0x46c: @@@ size(Stack[-5]); Obj=9 // @poff=0
0x46d: Pop(0)
0x46e: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x46f: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x470: IF (Stack[-1] == 0) GOTO 0x472; Pop(1)

0x471: Return(); Pop(10)

0x472: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x473: @@@ get(Stack[-5], Stack[-1]); Obj=7 // @poff=5
0x474: Pop(1)
0x475: PushEmpty(bool, object, int, bool)
0x476: Stack[-8] = Stack[-3]
...
0x47d: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x47e: @@@ get(Stack[-4], Stack[-1]); Obj=9 // @poff=5
0x47f: Pop(1)
0x480: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x481: @@@ get(Stack[-3], Stack[-1]); Obj=8 // @poff=5
0x482: Pop(1)
0x483: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x484: IF (Stack[-1] == 0) GOTO 0x4a5; Pop(1)

0x485: PushEmpty(int, object, int)
0x486: Stack[-7] = Stack[-2]
...
0x49a: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x49b: @@@ set(Stack[-1], Stack[-4]); Obj=9 // @poff=538
0x49c: Pop(1)
0x49d: PushEmpty(object)
0x49e: Stack[-5] = Stack[-1]
0x49f: Call2 0x0
...
0x4ae: @@@ size(Stack[-5]); Obj=9 // @poff=0
0x4af: Pop(0)
0x4b0: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x4b1: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x4b2: IF (Stack[-1] == 0) GOTO 0x4b4; Pop(1)

0x4b3: Return(); Pop(10)

0x4b4: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x4b5: @@@ get(Stack[-5], Stack[-1]); Obj=7 // @poff=5
0x4b6: Pop(1)
0x4b7: PushEmpty(bool, object, int, bool)
0x4b8: Stack[-8] = Stack[-3]
...
0x4bf: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x4c0: @@@ get(Stack[-4], Stack[-1]); Obj=9 // @poff=5
0x4c1: Pop(1)
0x4c2: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x4c3: @@@ get(Stack[-3], Stack[-1]); Obj=8 // @poff=5
0x4c4: Pop(1)
0x4c5: Push((int) 0)
...
0x4d2: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x4d3: @@@ set(Stack[-1], Stack[-4]); Obj=9 // @poff=538
0x4d4: Pop(1)
0x4d5: PushEmpty(int, object, int)
0x4d6: Stack[-7] = Stack[-2]
...
0x4ee: @@@ size(Stack[-5]); Obj=6 // @poff=0
0x4ef: Pop(0)
0x4f0: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4f1: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x4f2: IF (Stack[-1] == 0) GOTO 0x4f4; Pop(1)

0x4f3: Return(); Pop(10)

0x4f4: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4f5: @@@ get(Stack[-5], Stack[-1]); Obj=4 // @poff=5
0x4f6: Pop(1)
0x4f7: PushEmpty(bool, object, int, bool)
0x4f8: Stack[-8] = Stack[-3]
...
0x4ff: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x500: @@@ get(Stack[-4], Stack[-1]); Obj=6 // @poff=5
0x501: Pop(1)
0x502: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x503: @@@ get(Stack[-3], Stack[-1]); Obj=5 // @poff=5
0x504: Pop(1)
0x505: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x506: IF (Stack[-1] == 0) GOTO 0x524; Pop(1)

0x507: PushEmpty(bool, object)
0x508: Stack[-6] = Stack[-1]
0x509: Call2 0x3cd
...
0x511: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x512: @@@ set(Stack[-1], Stack[-4]); Obj=6 // @poff=538
0x513: Pop(1)
0x514: PushEmpty(int, object, int)
0x515: Stack[-7] = Stack[-2]
...
0x52d: @@@ size(Stack[-5]); Obj=6 // @poff=0
0x52e: Pop(0)
0x52f: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x530: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x531: IF (Stack[-1] == 0) GOTO 0x533; Pop(1)

0x532: Return(); Pop(10)

0x533: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x534: @@@ get(Stack[-5], Stack[-1]); Obj=4 // @poff=5
0x535: Pop(1)
0x536: PushEmpty(bool, object, int, bool)
0x537: Stack[-8] = Stack[-3]
...
0x53e: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x53f: @@@ get(Stack[-4], Stack[-1]); Obj=6 // @poff=5
0x540: Pop(1)
0x541: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x542: @@@ get(Stack[-3], Stack[-1]); Obj=5 // @poff=5
0x543: Pop(1)
0x544: Push((int) 0)
...
0x55d: Stack[-5] = Stack[-1]
0x55e: Call2 0x0

0x55f: Pop(1)
0x560: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x561: @@@ set(Stack[-1], Stack[-4]); Obj=6 // @poff=538
0x562: Pop(1)
0x563: PushEmpty(int)
0x564: PushEmpty(int, object, int)
0x565: Stack[-8] = Stack[-2]
...
0x57c: @@@ size(Stack[-2]); Obj=9 // @poff=0
0x57d: Pop(0)
0x57e: Pop(0); Push(Stack[-5] + Stack[0 + Tasks[-1].StackPointer]);
...
0x583: Pop(0); Push(Stack[-5] + Stack[0 + Tasks[-1].StackPointer]);
0x584: @@@ get(Stack[-2], Stack[-1]); Obj=9 // @poff=5
0x585: Pop(1)
0x586: Stack[-1] = Stack[-6]
0x587: Return(); Pop(4)

0x588: PushEmpty(int, int, int, int)
0x589: @@@ size(Stack[-2]); Obj=6 // @poff=0
0x58a: Pop(0)
0x58b: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
...
0x590: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
0x591: @@@ get(Stack[-2], Stack[-1]); Obj=6 // @poff=5
0x592: Pop(1)
...
0x5ec: Push("sellf") // @poff=602
0x5ed: Pop(1); Push(Stack[-1] + Stack[-3]);
0x5ee: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=614
0x5ef: Pop(1)
0x5f0: Push(Stack[-1])
0x5f1: IF (Stack[-1] == 0) GOTO 0x5f6; Pop(1)

0x5f2: Push("sellf") // @poff=602
0x5f3: Pop(1); Push(Stack[-1] + Stack[-3]);
0x5f4: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=626
0x5f5: Pop(1)
0x5f6: Push((int) 1)
...
0x606: Push("buyf") // @poff=638
0x607: Pop(1); Push(Stack[-1] + Stack[-3]);
0x608: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=614
0x609: Pop(1)
0x60a: Push(Stack[-1])
0x60b: IF (Stack[-1] == 0) GOTO 0x610; Pop(1)

0x60c: Push("buyf") // @poff=638
0x60d: Pop(1); Push(Stack[-1] + Stack[-3]);
0x60e: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=626
0x60f: Pop(1)
0x610: Push((int) 1)
...
0x618: Pop(0)
0x619: Push("barter") // @poff=648
0x61a: @@ HasProperty(Stack[-1], Stack[-3]); Obj=4 // @poff=614
0x61b: Pop(1)
...
0x620: Push("barter") // @poff=648
0x621: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=626
0x622: Pop(1)
...
0x627: @@ GetItemID(Stack[-1]); Obj=3 // @poff=662
0x628: Pop(0)
0x629: Stack[-1] = Stack[-4]
0x62a: Return(); Pop(2)
...
0x64e: Push("durability") // @poff=684
0x64f: @@ HasProperty(Stack[-5], Stack[-1]); Obj=21 // @poff=614
0x650: Pop(1)
0x651: Push(Stack[-4])
0x652: IF (Stack[-1] == 0) GOTO 0x65d; Pop(1)

0x653: Push("durability") // @poff=684
0x654: @@ GetProperty(Stack[-4], Stack[-1]); Obj=21 // @poff=626
0x655: Pop(1)
...
0x65d: Stack[-8] = Stack[-21]
0x65e: Return(); Pop(18)

0x65f: PushEmpty(int, object)
0x660: Stack[-22] = Stack[-1]
0x661: Call2 0x626

0x662: Pop(1)
0x663: Push("BarterPrice") // @poff=706
...
0x66c: Stack[-22] = Stack[-1]
0x66d: Call2 0x626

0x66e: Pop(1)
0x66f: Push("BarterPrice") // @poff=706
...
0x67c: Stack[-5] = Stack[-1]
0x67d: Call2 0x626

0x67e: Pop(1)
0x67f: Push("Category") // @poff=730
...
0x68f: Pop(0)
0x690: @@ GetItemCount(Stack[-2]); Obj=1 // @poff=748
0x691: Pop(0)
0x692: Stack[-2] = Stack[-5]
0x693: Return(); Pop(4)
...
0x697: Pop(0)
0x698: @@ GetItemCount(Stack[-2], Stack[-5]); Obj=1 // @poff=748
0x699: Pop(0)
0x69a: Stack[-2] = Stack[-6]
0x69b: Return(); Pop(4)
...
0x69f: Pop(0)
0x6a0: @@ GetItem(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=761
0x6a1: Pop(0)
0x6a2: Stack[-1] = Stack[-7]
0x6a3: Return(); Pop(4)
...
0x6a8: Pop(0)
0x6a9: @@ GetItemAmount(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=769
0x6aa: Pop(0)
...
0x6b0: Pop(0)
0x6b1: @@ IsItemSelected(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=783
0x6b2: Pop(0)
0x6b3: Stack[-1] = Stack[-7]
0x6b4: Return(); Pop(4)
...
0x6b8: Pop(0)
0x6b9: @@ GetItem(Stack[-1], Stack[-5]); Obj=2 // @poff=761
0x6ba: Pop(0)
0x6bb: Stack[-1] = Stack[-6]
0x6bc: Return(); Pop(4)
...
0x6c1: Pop(0)
0x6c2: @@ GetItemAmount(Stack[-1], Stack[-5]); Obj=2 // @poff=769
0x6c3: Pop(0)
0x6c4: Stack[-1] = Stack[-6]
0x6c5: Return(); Pop(4)

0x6c6: Stack[-2] = 0
0x6c7: PushEmpty(bool, bool)
0x6c8: @@ Compare(Stack[-1], Stack[-3]); Obj=4 // @poff=798
0x6c9: Pop(0)
0x6ca: Stack[-1] = Stack[-5]
0x6cb: Return(); Pop(2)
...
0x6db: Stack[-9] = Stack[-1]
0x6dc: Call2 0x626

0x6dd: Pop(1)
0x6de: Push("BarterPrice") // @poff=706
...
0x6e7: Stack[-9] = Stack[-1]
0x6e8: Call2 0x626

0x6e9: Pop(1)
0x6ea: Push("BarterPrice") // @poff=706
...
0x714: Push((int) 1)
0x715: @@ RemoveItem(Stack[-2], Stack[-1], Stack[-8]); Obj=10 // @poff=806
0x716: Pop(1)
...
0x720: Push((int) 1)
0x721: @@ AddItem(Stack[-2], Stack[-5], Stack[-4], Stack[-1]); Obj=6 // @poff=817
0x722: Pop(1)
0x723: Stack[-1] = Stack[-6]
0x724: Return(); Pop(2)
