...
0x44: Push((int) 0)
0x45: @@ get(Stack[-0]T, Stack[-1]); Obj=4 // @poff=38
0x46: Pop(1)
0x47: Push((int) 1)
0x48: @@ get(Stack[-1]T, Stack[-1]); Obj=4 // @poff=38
0x49: Pop(1)
0x4a: Return(); Pop(2)
...
0x4e: Push("selected") // @poff=42
0x4f: @ SetBackground(Stack[-1])
0x50: Pop(1)
0x51: GOTO 0x55

0x52: Push("default") // @poff=0
...
0x67: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=60
0x68: Pop(0)
0x69: @ GetItemImage(Stack[-1], Stack[-4]T)
0x6a: Pop(0)
0x6b: @ LoadImage(Stack[-4]T)
0x6c: Pop(0)
...
0x74: Push((int) 4)
0x75: Push("") // @poff=13
0x76: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x77: Pop(2)
0x78: GOTO 0x7d
