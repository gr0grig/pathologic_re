...
Strings:
	...
	W:selected
	A:GetItemID
// @pool_raw:640065006600610075006c00740000002f000000640069007300610062006c0065006400000067657400730065006c006500630074006500640000004765744974656d494400
...
0x15: Push((int) 1)
0x16: Push((int) 1)
0x17: @ Blit(Stack[-4]T, Stack[-2], Stack[-1])
0x18: Pop(2)
0x19: PushEmpty(bool)
0x1a: Stack[-1] = (bool) 0
0x1b: Push((int) 1)
...
0x22: Push("/") // @poff=16
0x23: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
0x24: Stack[-4] = Stack[-1] + Stack[1 + Tasks[-1].StackPointer]; Pop(1);
0x25: Push("default") // @poff=0
...
0x4c: Push((int) 0)
0x4d: @@ get(Stack[-0]T, Stack[-1]); Obj=4 // @poff=38
0x4e: Pop(1)
0x4f: Push((int) 1)
0x50: @@ get(Stack[-1]T, Stack[-1]); Obj=4 // @poff=38
0x51: Pop(1)
0x52: Return(); Pop(2)
...
0x6f: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=60
0x70: Pop(0)
0x71: @ GetItemImage(Stack[-1], Stack[-4]T)
0x72: Pop(0)
0x73: @ LoadImage(Stack[-4]T)
0x74: Pop(0)
...
0x7c: Push((int) 3)
0x7d: Push("") // @poff=13
0x7e: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x7f: Pop(2)
0x80: GOTO 0x85
