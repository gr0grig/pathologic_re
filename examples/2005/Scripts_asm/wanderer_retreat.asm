...
Strings:
	...
	W:player
	W:idle
// @pool_raw:
...
0x2f: Pop(0); PushNull((bool) Stack[-21] == 0)
0x30: IF (Stack[-1] == 0) GOTO 0x36; Pop(1)

0x31: PushEmpty(string)
0x32: Stack[-1] = "fdie" // @poff=0
0x33: Call2 0x89

0x34: Pop(1)
0x35: GOTO 0x88

0x36: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x37: Pop(0)
...
0x47: Stack[-6] = "fdie" // @poff=0
0x48: GOTO 0x4a

0x49: Stack[-6] = "bdie" // @poff=22
...
0x50: @ StopAsync()
0x51: Pop(0)
0x52: Stack[-21] = Stack[-5]
0x53: Push("GetScriptProperty") // @poff=32
0x54: Push((int) 2)
0x55: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x56: IF (Stack[-1] == 0) GOTO 0x62; Pop(1)

0x57: Push("Owner") // @poff=68
0x58: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x59: Pop(1)
0x5a: Push(Stack[-4])
0x5b: IF (Stack[-1] == 0) GOTO 0x62; Pop(1)

0x5c: Push("Owner") // @poff=68
0x5d: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x5e: Pop(1)
0x5f: Pop(0); PushNull((bool) Stack[-5] == 0)
0x60: IF (Stack[-1] == 0) GOTO 0x62; Pop(1)

0x61: Stack[-21] = Stack[-5]
0x62: Push("@GetEyesHeight") // @poff=116
0x63: Push((int) 1)
0x64: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x65: IF (Stack[-1] == 0) GOTO 0x71; Pop(1)

0x66: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x67: Pop(0)
0x68: Stack[-1] = [0.0, 0.0, 0.0]
0x69: Push(CvectorIndex(Stack[-1], 1))
0x6a: Stack[-3] = Stack[-1]
0x6b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6c: Push("head") // @poff=160
...
0x95: Stack[-2] = Stack[-1]
0x96: Call2 0x51b

0x97: Pop(1)
0x98: Push("all") // @poff=170
0x99: @ PlayAnimation(Stack[-1], Stack[-2])
0x9a: Pop(1)
0x9b: @ WaitForAnimEnd()
0x9c: Pop(0)
0x9d: Push("all") // @poff=170
...
0xc3: Stack[-5] = Stack[-1]
0xc4: Call2 0x621

0xc5: Stack[-2] = Stack[-3]
0xc6: Pop(2)
0xc7: Push((int) 0)
...
0xd7: Stack[-9] = Stack[-3]
0xd8: Stack[-8] = Stack[-2]
0xd9: Stack[-7] = Stack[-1]
0xda: Call2 0x671
...
0xde: Stack[-8] = Stack[-2]
0xdf: Stack[-6] = Stack[-1]
0xe0: Call2 0x633

0xe1: Stack[-3] = Stack[-4]
0xe2: Pop(3)
0xe3: Push((int) 0)
...
0x116: Stack[-6] = Stack[-2]
0x117: Stack[-7] = Stack[-1]
0x118: Call2 0x657

0x119: Stack[-3] = Stack[-4]
0x11a: Pop(3)
0x11b: Push((int) 0)
...
0x16f: Pop(0)
0x170: Push("all") // @poff=170
0x171: PushEmpty(string, int)
0x172: Stack[-7] = Stack[-1]
0x173: Call2 0x609
...
0x1e8: Stack[-9] = Stack[-3]
0x1e9: Stack[-8] = Stack[-2]
...
0x1ef: Stack[-8] = Stack[-2]
0x1f0: Stack[-6] = Stack[-1]
0x1f1: Call2 0x633

0x1f2: Stack[-3] = Stack[-4]
0x1f3: Pop(3)
0x1f4: Push((int) 0)
...
0x218: Stack[-7] = Stack[-2]
0x219: Stack[-6] = Stack[-1]
0x21a: Call2 0x589
...
0x228: Stack[-7] = Stack[-1]
0x229: Call2 0x657

0x22a: Stack[-3] = Stack[-4]
0x22b: Pop(3)
0x22c: Push((int) 0)
...
0x2c6: Pop(0)
0x2c7: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x2c8: Pop(0)
...
0x2e5: Stack[-1] = (float) 1.7453293800354004
0x2e6: Call2 0x2c4
...
0x2ee: Stack[-1] = (float) 2.6179938316345215
0x2ef: Call2 0x2c4

0x2f0: Stack[-2] = Stack[-7]
0x2f1: Pop(2)
...
0x2f6: Push("Can't retreat, distance: ") // @poff=178
...
0x30c: Push((int) 1)
0x30d: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x30e: Pop(1)
0x30f: Push(Stack[-3])
0x310: IF (Stack[-1] == 0) GOTO 0x328; Pop(1)

0x311: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x316: Stack[-1] = (float) 2.6179938316345215
0x317: Call2 0x2c4

0x318: Stack[-2] = Stack[-4]
0x319: Pop(2)
...
0x329: IF (Stack[-1] == 1) GOTO 0x30c; Pop(1)
...
0x330: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x33f: Stack[-1] = (float) 1.7453293800354004
0x340: Call2 0x2c4

0x341: Stack[-2] = Stack[-4]
0x342: Pop(2)
...
0x34f: IF (Stack[-1] == 1) GOTO 0x355; Pop(1)

0x350: PushEmpty(bool)
0x351: Call2 0x36f

0x352: Pop(0)
0x353: IF (Stack[-1] == 1) GOTO 0x355; Pop(1)
...
0x375: Stack[-2] = Stack[-3]
0x376: Pop(2)
0x377: PushEmpty(float, cvector, cvector)
0x378: Stack[-5] = Stack[-2]
0x379: Stack[-4] = Stack[-1]
0x37a: Call2 0x554

0x37b: Pop(2)
0x37c: Push((float)-0.3420201241970062)
...
0x381: Pop(0)
0x382: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x383: Pop(0)
...
0x3a0: Stack[-1] = (float) 1.7453293800354004
0x3a1: Call2 0x37f

0x3a2: Stack[-2] = Stack[-7]
0x3a3: Pop(2)
...
0x3a9: Stack[-1] = (float) 2.6179938316345215
0x3aa: Call2 0x37f

0x3ab: Stack[-2] = Stack[-7]
0x3ac: Pop(2)
...
0x3b1: Push("Can't retreat, distance: ") // @poff=178
...
0x3c7: Push((int) 1)
0x3c8: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3c9: Pop(1)
0x3ca: Push(Stack[-3])
0x3cb: IF (Stack[-1] == 0) GOTO 0x3e3; Pop(1)

0x3cc: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3d1: Stack[-1] = (float) 2.6179938316345215
0x3d2: Call2 0x37f
...
0x3e4: IF (Stack[-1] == 1) GOTO 0x3c7; Pop(1)
...
0x3eb: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3fa: Stack[-1] = (float) 1.7453293800354004
0x3fb: Call2 0x37f
...
0x40a: IF (Stack[-1] == 1) GOTO 0x410; Pop(1)

0x40b: PushEmpty(bool)
0x40c: Call2 0x42a

0x40d: Pop(0)
0x40e: IF (Stack[-1] == 1) GOTO 0x410; Pop(1)
...
0x436: Pop(2)
0x437: Push((float)-0.3420201241970062)
...
0x441: Pop(0)
0x442: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x443: Pop(0)
...
0x448: Pop(0)
0x449: Stack[-1] = Stack[-4]
0x44a: Return(); Pop(2)

0x44b: PushEmpty(bool, bool)
0x44c: Push("HasProperty") // @poff=230
0x44d: Push((int) 2)
...
0x453: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=254
0x454: Pop(0)
0x455: Stack[-1] = Stack[-5]
0x456: Return(); Pop(2)

0x457: PushEmpty(bool, bool)
0x458: @@ IsDead(Stack[-1]); Obj=3 // @poff=266
0x459: Pop(0)
0x45a: Stack[-1] = Stack[-4]
0x45b: Return(); Pop(2)

0x45c: PushEmpty(object, object, object, object)
0x45d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x471: Pop(0)
0x472: Pop(0); PushNull((bool) Stack[-2] == 0)
0x473: IF (Stack[-1] == 0) GOTO 0x476; Pop(1)

0x474: Stack[-6] = (bool) 0
0x475: Return(); Pop(4)

0x476: @@ GetScene(Stack[-1]); Obj=5 // @poff=287
0x477: Pop(0)
...
0x48a: Stack[-6] = Stack[-2]
0x48b: Stack[-1] = "noaccess" // @poff=296
0x48c: Call2 0x44b
...
0x492: Push("noaccess") // @poff=296
0x493: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=314
0x494: Pop(1)
0x495: Push((int) 0)
...
0x499: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x4a7: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x4a8: Pop(0)
...
0x4b8: Stack[-1] = "fhit" // @poff=326
0x4b9: GOTO 0x4bb

0x4ba: Stack[-1] = "bhit" // @poff=336
0x4bb: Push("hit_react") // @poff=346
0x4bc: Push("1") // @poff=366
0x4bd: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4be: Push("2") // @poff=370
...
0x4d7: Stack[-25] = Stack[-1]
0x4d8: Call2 0x43f

0x4d9: Stack[-2] = Stack[-3]
0x4da: Pop(2)
0x4db: Call2 0x54a
...
0x4f6: Pop(0)
0x4f7: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=383
0x4f8: Pop(0)
0x4f9: PushEmpty(object, int, float, cvector, cvector)
0x4fa: Stack[-26] = Stack[-5]
0x4fb: Stack[-25] = Stack[-4]
0x4fc: Stack[-24] = Stack[-3]
0x4fd: Stack[-6] = Stack[-2]
...
0x581: Stack[-11] = Stack[-5]
0x582: Stack[-10] = Stack[-4]
0x583: Stack[-9] = Stack[-3]
0x584: Stack[-7] = Stack[-2]
...
0x594: Push("player_shot") // @poff=467
...
0x5b2: Push("player_shot") // @poff=467
...
0x5d1: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=505
0x5d2: Pop(0)
...
0x611: Stack[-2] = (int) 0
0x612: Push("all") // @poff=170
0x613: PushEmpty(string, int)
0x614: Stack[-5] = Stack[-1]
0x615: Call2 0x609
...
0x61f: Stack[-2] = Stack[-5]
0x620: Return(); Pop(4)

0x621: PushEmpty()
0x622: PushEmpty(bool, object)
0x623: Stack[-3] = Stack[-1]
0x624: Call2 0x480
