...
Strings:
	...
	W:_blast
	W:_blast.tex
// @pool_raw:730068006f0074000000730061006d006f00700061006c0000007200690066006c00650000007200650076006f006c0076006500720000005f0062006c0061007300740000005f0062006c006100730074002e007400650078000000
...
0x12: Pop(0)
0x13: Push("samopal") // @poff=10
0x14: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x15: IF (Stack[-1] == 0) GOTO 0x19; Pop(1)

0x16: Stack[-4] = (int) 18
0x17: Stack[-3] = (float) 0.03333333507180214
0x18: GOTO 0x26

0x19: Push("rifle") // @poff=26
0x1a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x1b: IF (Stack[-1] == 0) GOTO 0x1f; Pop(1)

0x1c: Stack[-4] = (int) 18
0x1d: Stack[-3] = (float) 0.07500000298023224
0x1e: GOTO 0x26

0x1f: Push("revolver") // @poff=38
0x20: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x21: IF (Stack[-1] == 0) GOTO 0x25; Pop(1)

0x22: Stack[-4] = (int) 15
0x23: Stack[-3] = (float) 0.07500000298023224
0x24: GOTO 0x26

0x25: Return(); Pop(10)

0x26: Push("_blast") // @poff=56
...
0x2d: Push([0.4960784614086151, 0.4176470935344696, 0.16862745583057404])
0x2e: @ SetLitColor(Stack[-1])
0x2f: Pop(1)
0x30: Push("blast") // @poff=58
0x31: Push("_blast.tex") // @poff=70
0x32: Pop(1); Push(Stack[-7] + Stack[-1]);
0x33: @ MakeBillboard(Stack[-2], Stack[-1], Stack[-3], Stack[-6])
0x34: Pop(2)
0x35: @ Sleep(Stack[-3])
0x36: Pop(0)
0x37: Push([0.0, 0.0, 0.0])
0x38: @ SetLitColor(Stack[-1])
0x39: Pop(1)
0x3a: Push("blast") // @poff=58
