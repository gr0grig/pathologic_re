maintask task_0
{
	...
	void OnUse(bool var_0_bool, object var_1_object)
	{
		...
		func_173(var_43_bool, var_44_object, var_45_object, var_46_int);
		if(var_43_bool != 0) {
...
void func_161(int var_55_int, int var_56_int)
{
...
void func_131(bool var_6_bool, object var_7_object)
{
	...
	func_78(var_28_bool, var_29_object, "noaccess");
	if(!var_28_bool) { //@nz
		var_6_bool = true;
		return 2;
	}
...
void func_71(void)
{
	...
	@RemoveActor(var_61_object);
}


void func_173(bool var_43_bool, object var_44_object, object var_45_object, int var_46_int)
{
	int var_50_int;
...
void func_78(bool var_28_bool, object var_29_object, string var_30_string)
{
...
void func_90(bool var_21_bool, object var_22_object)
{
	bool var_24_bool;
...
void func_155(object var_61_object)
{
...
void func_95(bool var_10_bool, object var_11_object)
{
	...
	if(var_20_bool != 0) {
		...
		func_90(var_21_bool, var_22_object);
		if(var_21_bool != 0)
			var_17_bool = true;
	}
	if(var_17_bool != 0) {
