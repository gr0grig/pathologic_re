...
void func_0(object var_59_object)
{
...
void func_71(bool var_20_bool, object var_21_object)
{
	bool var_23_bool;
...
void func_136(object var_64_object)
{
...
void func_76(bool var_9_bool, object var_10_object)
{
...
void func_142(int var_54_int, int var_55_int)
{
	object var_57_object;
	@CreateIntVector(var_57_object);
	var_57_object->add(var_54_int);
	var_57_object->add(var_55_int);
	@SendWorldWndMessage(3, var_57_object);
}
EMIT "Stack[-1] = 0";


void func_112(bool var_5_bool, object var_6_object)
{
...
void func_154(bool var_42_bool, object var_43_object, object var_44_object, int var_45_int)
{
	int var_49_int;
...
void func_59(bool var_27_bool, object var_28_object, string var_29_string)
{
