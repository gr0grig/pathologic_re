...
void func_38(bool var_6_bool)
{
	...
	if(var_9_int != -1) {
		...
		if(var_6_bool != 0) {
			@Trace("Blocking polygons: " + (var_9_int & 1016));
			var_10_object->BlockPolygons(var_9_int, 1016);
		} else {
			var_10_object->UnblockPolygons(var_9_int, 1016);
		}
		var_10_object = null;
	}
...
void func_122(cvector var_30_cvector)
{
