...
maintask task_1
{
	...
	void OnPlayerDamage(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, object var_4_object, bool var_5_bool, object var_6_object, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool)
	{
		...
		bool var_18_bool;
		func_3171(var_18_bool, var_19_object, var_20_object, var_21_bool);
		if(var_18_bool != 0) {
...
// @pe
void func_3101(int var_123_int)
{
	var_123_int = 0;
}
...
// @pe
void func_3109(object var_24_object)
{
	object var_25_object;
	var_24_object = var_25_object;
	func_3156(var_25_object);
}
...
// @pe
void func_3116(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_3121(bool var_26_bool, object var_27_object)
{
	bool var_29_bool;
...
// @pe
void func_3136(object var_54_object)
{
...
// @pe
void func_3142(bool var_43_bool)
{
	var_43_bool = false;
}
...
// @pe
void func_3147(bool var_21_bool)
{
	var_21_bool = false;
}
...
void func_3156(object var_25_object)
{
	bool var_27_bool;
...
void func_3169(bool var_58_bool)
{
	var_58_bool = false;
}
...
// @pe
void func_3171(bool var_18_bool, object var_19_object, object var_20_object, bool var_21_bool)
{
	object var_23_object;
...
// @pe
void func_3181(object var_96_object)
{
...
void func_2792(bool var_17_bool, object var_18_object, string var_19_string)
{
	...
	if(var_19_string == "player_shot") {
		...
		func_3121(var_26_bool, var_27_object);
...
// @pe
void func_2383(float var_506_float, float var_507_float, float var_508_float)
{
...
// @pe
void func_2390(float var_516_float, float var_517_float, float var_518_float, float var_519_float)
{
...
void func_2437(float var_524_float)
{
...
// @pe
void func_2971(object var_120_object)
{
...
void func_2035(float var_468_float, object var_469_object, float var_470_float, int var_471_int)
{
	...
	float var_506_float;
	func_2383(var_506_float, ((var_481_int + var_483_int) / 100.0), (float)1);
	float var_484_float;
	...
	float var_516_float;
	func_2390(var_516_float, (var_485_float - var_486_float), (float)0, (float)1);
