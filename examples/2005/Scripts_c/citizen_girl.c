	...
	void event_11(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, cvector var_12_cvector, bool var_13_bool, object var_14_object, cvector var_15_cvector, bool var_16_bool, object var_17_object, object var_18_object, object var_19_object, string var_20_string, bool var_21_bool, int var_22_int, int var_23_int)
	{
		if(1 != 0) {
			...
			if(var_22_int == 39083) {
				...
				bool var_50_bool;
				func_5238(var_1_bool);
				if(var_50_bool != 0) {
					bool var_58_bool;
					func_5250(var_58_bool, var_1_bool);
					if(var_58_bool != 0)
						var_49_bool = true;
				}
				if(var_49_bool != 0)
				...
				if(var_73_bool != 0) {
					bool var_75_bool;
					func_5250(var_75_bool, var_1_bool);
					if(var_75_bool != 0)
						var_72_bool = true;
				}
				if(var_72_bool != 0)
				...
				if(var_81_bool != 0) {
					bool var_83_bool;
					func_5260(var_83_bool, var_1_bool);
					if(var_83_bool != 0)
						var_80_bool = true;
				}
				if(var_80_bool != 0)
				...
				if(var_94_bool != 0) {
					bool var_96_bool;
					func_5270(var_96_bool, var_1_bool);
					if(var_96_bool != 0)
						var_93_bool = true;
				}
				if(var_93_bool != 0) {
					bool var_102_bool;
					func_5370(var_102_bool, var_1_bool);
					if(var_102_bool != 0)
						var_92_bool = true;
				}
				if(var_92_bool != 0)
				...
				if(var_122_bool != 0) {
					bool var_124_bool;
					func_5270(var_124_bool, var_1_bool);
					if(var_124_bool != 0)
						var_121_bool = true;
				}
				if(var_121_bool != 0) {
					bool var_126_bool;
					func_5380(var_126_bool, var_1_bool);
					if(var_126_bool != 0)
						var_120_bool = true;
				}
				if(var_120_bool != 0)
				...
				if(var_138_bool != 0) {
					bool var_140_bool;
					func_5280(var_140_bool, var_1_bool);
					if(var_140_bool != 0)
						var_137_bool = true;
				}
				if(var_137_bool != 0) {
					bool var_146_bool;
					func_5370(var_146_bool, var_1_bool);
					if(var_146_bool != 0)
						var_136_bool = true;
				}
				if(var_136_bool != 0)
				...
				if(var_153_bool != 0) {
					bool var_155_bool;
					func_5280(var_155_bool, var_1_bool);
					if(var_155_bool != 0)
						var_152_bool = true;
				}
				if(var_152_bool != 0) {
					bool var_157_bool;
					func_5380(var_157_bool, var_1_bool);
					if(var_157_bool != 0)
						var_151_bool = true;
				}
				if(var_151_bool != 0)
				...
				if(var_163_bool != 0) {
					bool var_165_bool;
					func_5290(var_165_bool, var_1_bool);
					if(var_165_bool != 0)
						var_162_bool = true;
				}
				if(var_162_bool != 0)
				...
				if(var_175_bool != 0) {
					bool var_177_bool;
					func_5300(var_177_bool, var_1_bool);
					if(var_177_bool != 0)
						var_174_bool = true;
				}
				if(var_174_bool != 0)
				...
				if(var_187_bool != 0) {
					bool var_189_bool;
					func_5310(var_189_bool, var_1_bool);
					if(var_189_bool != 0)
						var_186_bool = true;
				}
				if(var_186_bool != 0)
				...
				if(var_199_bool != 0) {
					bool var_201_bool;
					func_5320(var_201_bool, var_1_bool);
					if(var_201_bool != 0)
						var_198_bool = true;
				}
				if(var_198_bool != 0)
				...
				if(var_211_bool != 0) {
					bool var_213_bool;
					func_5330(var_213_bool, var_1_bool);
					if(var_213_bool != 0)
						var_210_bool = true;
				}
				if(var_210_bool != 0)
				...
				if(var_223_bool != 0) {
					bool var_225_bool;
					func_5340(var_225_bool, var_1_bool);
					if(var_225_bool != 0)
						var_222_bool = true;
				}
				if(var_222_bool != 0)
				...
				if(var_235_bool != 0) {
					bool var_237_bool;
					func_5350(var_237_bool, var_1_bool);
					if(var_237_bool != 0)
						var_234_bool = true;
				}
				if(var_234_bool != 0)
				...
				if(var_247_bool != 0) {
					bool var_249_bool;
					func_5360(var_249_bool, var_1_bool);
					if(var_249_bool != 0)
						var_246_bool = true;
				}
				if(var_246_bool != 0)
...
void func_5656(int var_106_int)
{
	var_106_int = 515559;
}


void func_5658(int var_105_int)
{
	var_105_int = 503344;
}


void func_5660(string var_107_string)
{
	var_107_string = "ui/NPC_Citizen1.png";
}


void func_5662(string var_108_string)
{
	var_108_string = "ui/NPC_Citizen1_b.png";
}


void func_5664(bool var_25_bool)
{
	var_25_bool = false;
}
...
void func_5674(object var_34_object, object var_49_object)
{
	bool var_36_bool;
...
// @pe
void func_5164(int var_209_int)
{
	var_209_int = 0;
}
...
// @pe
void func_5172(object var_33_object)
{
	object var_34_object;
	func_5674(var_34_object, var_34_object);
}
...
void func_5179(bool var_28_bool, object var_29_object)
{
	bool var_31_bool;
...
// @pe
void func_5184(object var_40_object)
{
...
void func_5192(bool var_37_bool, object var_38_object)
{
	bool var_40_bool;
...
void func_5714(bool var_67_bool)
{
	float var_68_float;
	func_5529(var_68_float);
	var_67_bool = var_68_float > 0.6;
}


// @pe
void func_5207(object var_139_object)
{
...
// @pe
void func_5720(bool var_27_bool, object var_28_object, object var_29_object)
{
	object var_32_object;
	...
	bool var_31_bool;
	func_5093(var_31_bool, var_32_object, var_33_object, 700.0);
	var_31_bool = var_27_bool;
}


// @pe
void func_5215(bool var_54_bool, object var_55_object)
{
	object var_57_object;
	var_55_object = var_57_object;
	bool var_56_bool;
	func_5192(var_56_bool, var_57_object);
...
// @pe
void func_5222(object var_207_object)
{
	object var_208_object;
	var_207_object = var_208_object;
	func_5207(var_208_object);
}


// @pe
void func_5228(bool var_30_bool)
{
	var_30_bool = false;
}
...
// @pe
void func_5233(object var_29_object)
{
...
// @pe
void func_5238(bool var_50_bool)
{
	int var_52_int;
...
// @pe
void func_5250(bool var_58_bool, object var_59_object)
{
	object var_61_object;
	var_59_object = var_61_object;
	func_5390(var_61_object);
	bool var_60_bool;
	if(var_60_bool != 0) {
		var_58_bool = true;
		return 0;
...
void func_4749(object var_91_object)
{
	float var_94_float;
...
// @pe
void func_5260(bool var_83_bool, object var_84_object)
{
	object var_86_object;
	var_84_object = var_86_object;
	func_5397(var_86_object);
	bool var_85_bool;
	if(var_85_bool != 0) {
		var_83_bool = true;
		return 0;
...
void func_659(bool var_0_bool, object var_83_object)
{
	...
	func_4479(var_98_cvector, var_0_bool);
	...
	func_4841(var_104_float, var_105_cvector, var_106_cvector);
	if(var_104_float < 0) {
		func_4576(var_0_bool);
		var_90_bool = true;
	} else {
...
// @pe
void func_5270(bool var_96_bool, object var_97_object)
{
	object var_99_object;
	var_97_object = var_99_object;
	func_5404(var_99_object);
	bool var_98_bool;
	if(var_98_bool != 0) {
		var_96_bool = true;
		return 0;
...
// @pe
void func_5280(bool var_140_bool, object var_141_object)
{
	object var_143_object;
	var_141_object = var_143_object;
	func_5411(var_143_object);
	bool var_142_bool;
	if(var_142_bool != 0) {
		var_140_bool = true;
		return 0;
...
// @pe
void func_5290(bool var_165_bool, object var_166_object)
{
	object var_168_object;
	var_166_object = var_168_object;
	func_5418(var_168_object);
	bool var_167_bool;
	if(var_167_bool != 0) {
		var_165_bool = true;
		return 0;
...
// @pe
void func_5300(bool var_177_bool, object var_178_object)
{
	object var_180_object;
	var_178_object = var_180_object;
	func_5425(var_180_object);
	bool var_179_bool;
	if(var_179_bool != 0) {
		var_177_bool = true;
		return 0;
...
// @pe
void func_5310(bool var_189_bool, object var_190_object)
{
	object var_192_object;
	var_190_object = var_192_object;
	func_5432(var_192_object);
	bool var_191_bool;
	if(var_191_bool != 0) {
		var_189_bool = true;
		return 0;
...
// @pe
void func_5320(bool var_201_bool, object var_202_object)
{
	object var_204_object;
	var_202_object = var_204_object;
	func_5439(var_204_object);
	bool var_203_bool;
	if(var_203_bool != 0) {
		var_201_bool = true;
		return 0;
...
// @pe
void func_5330(bool var_213_bool, object var_214_object)
{
	object var_216_object;
	var_214_object = var_216_object;
	func_5446(var_216_object);
	bool var_215_bool;
	if(var_215_bool != 0) {
		var_213_bool = true;
		return 0;
...
// @pe
void func_5340(bool var_225_bool, object var_226_object)
{
	object var_228_object;
	var_226_object = var_228_object;
	func_5453(var_228_object);
	bool var_227_bool;
	if(var_227_bool != 0) {
		var_225_bool = true;
		return 0;
...
// @pe
void func_5350(bool var_237_bool, object var_238_object)
{
	object var_240_object;
	var_238_object = var_240_object;
	func_5460(var_240_object);
	bool var_239_bool;
	if(var_239_bool != 0) {
		var_237_bool = true;
		return 0;
...
// @pe
void func_5360(bool var_249_bool, object var_250_object)
{
	object var_252_object;
	var_250_object = var_252_object;
	func_5467(var_252_object);
	bool var_251_bool;
	if(var_251_bool != 0) {
		var_249_bool = true;
		return 0;
...
// @pe
void func_5370(bool var_102_bool, object var_103_object)
{
	object var_105_object;
	var_103_object = var_105_object;
	func_5474(var_105_object);
	bool var_104_bool;
	if(var_104_bool != 0) {
		var_102_bool = true;
		return 0;
...
// @pe
void func_5380(bool var_126_bool, object var_127_object)
{
	object var_129_object;
	var_127_object = var_129_object;
	func_5495(var_129_object);
	bool var_128_bool;
	if(var_128_bool != 0) {
		var_126_bool = true;
		return 0;
...
void func_1805(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_118_object, object var_119_object)
{
	...
	if(1 != 0) {
		...
		if(var_142_bool != 0) {
			bool var_150_bool;
			func_5250(var_150_bool, var_1_bool);
			if(var_150_bool != 0)
				var_141_bool = true;
		}
		if(var_141_bool != 0)
		...
		if(var_165_bool != 0) {
			bool var_167_bool;
			func_5250(var_167_bool, var_1_bool);
			if(var_167_bool != 0)
				var_164_bool = true;
		}
		if(var_164_bool != 0)
		...
		if(var_173_bool != 0) {
			bool var_175_bool;
			func_5260(var_175_bool, var_1_bool);
			if(var_175_bool != 0)
				var_172_bool = true;
		}
		if(var_172_bool != 0)
		...
		if(var_186_bool != 0) {
			bool var_188_bool;
			func_5270(var_188_bool, var_1_bool);
			if(var_188_bool != 0)
				var_185_bool = true;
		}
		if(var_185_bool != 0) {
			bool var_194_bool;
			func_5370(var_194_bool, var_1_bool);
			if(var_194_bool != 0)
				var_184_bool = true;
		}
		if(var_184_bool != 0)
		...
		if(var_214_bool != 0) {
			bool var_216_bool;
			func_5270(var_216_bool, var_1_bool);
			if(var_216_bool != 0)
				var_213_bool = true;
		}
		if(var_213_bool != 0) {
			bool var_218_bool;
			func_5380(var_218_bool, var_1_bool);
			if(var_218_bool != 0)
				var_212_bool = true;
		}
		if(var_212_bool != 0)
		...
		if(var_230_bool != 0) {
			bool var_232_bool;
			func_5280(var_232_bool, var_1_bool);
			if(var_232_bool != 0)
				var_229_bool = true;
		}
		if(var_229_bool != 0) {
			bool var_238_bool;
			func_5370(var_238_bool, var_1_bool);
			if(var_238_bool != 0)
				var_228_bool = true;
		}
		if(var_228_bool != 0)
		...
		if(var_245_bool != 0) {
			bool var_247_bool;
			func_5280(var_247_bool, var_1_bool);
			if(var_247_bool != 0)
				var_244_bool = true;
		}
		if(var_244_bool != 0) {
			bool var_249_bool;
			func_5380(var_249_bool, var_1_bool);
			if(var_249_bool != 0)
				var_243_bool = true;
		}
		if(var_243_bool != 0)
		...
		if(var_255_bool != 0) {
			bool var_257_bool;
			func_5290(var_257_bool, var_1_bool);
			if(var_257_bool != 0)
				var_254_bool = true;
		}
		if(var_254_bool != 0)
		...
		if(var_267_bool != 0) {
			bool var_269_bool;
			func_5300(var_269_bool, var_1_bool);
			if(var_269_bool != 0)
				var_266_bool = true;
		}
		if(var_266_bool != 0)
		...
		if(var_279_bool != 0) {
			bool var_281_bool;
			func_5310(var_281_bool, var_1_bool);
			if(var_281_bool != 0)
				var_278_bool = true;
		}
		if(var_278_bool != 0)
		...
		if(var_291_bool != 0) {
			bool var_293_bool;
			func_5320(var_293_bool, var_1_bool);
			if(var_293_bool != 0)
				var_290_bool = true;
		}
		if(var_290_bool != 0)
		...
		if(var_303_bool != 0) {
			bool var_305_bool;
			func_5330(var_305_bool, var_1_bool);
			if(var_305_bool != 0)
				var_302_bool = true;
		}
		if(var_302_bool != 0)
		...
		if(var_315_bool != 0) {
			bool var_317_bool;
			func_5340(var_317_bool, var_1_bool);
			if(var_317_bool != 0)
				var_314_bool = true;
		}
		if(var_314_bool != 0)
		...
		if(var_327_bool != 0) {
			bool var_329_bool;
			func_5350(var_329_bool, var_1_bool);
			if(var_329_bool != 0)
				var_326_bool = true;
		}
		if(var_326_bool != 0)
		...
		if(var_339_bool != 0) {
			bool var_341_bool;
			func_5360(var_341_bool, var_1_bool);
			if(var_341_bool != 0)
				var_338_bool = true;
		}
		if(var_338_bool != 0)
...
// @pe
void func_5390(bool var_60_bool)
{
	int var_62_int;
...
// @pe
void func_5397(bool var_85_bool)
{
	int var_87_int;
...
void func_4888(bool var_26_bool, object var_27_object, string var_28_string)
{
	if(var_28_string == "unholster") {
		...
		func_5179(var_31_bool, var_32_object);
	...
	if(var_28_string == "player_shot") {
		...
		func_5192(var_37_bool, var_38_object);
	...
	if(var_28_string == "battle") {
		...
		func_5215(var_54_bool, var_55_object);
...
// @pe
void func_5404(bool var_98_bool)
{
	int var_100_int;
...
// @pe
void func_5411(bool var_142_bool)
{
	int var_144_int;
...
// @pe
void func_5418(bool var_167_bool)
{
	int var_169_int;
...
// @pe
void func_5425(bool var_179_bool)
{
	int var_181_int;
...
Label_4944:
	...
	func_5222(var_207_object);
}


// @pe
void func_5432(bool var_191_bool)
{
	int var_193_int;
...
// @pe
void func_5439(bool var_203_bool)
{
	int var_205_int;
...
// @pe
void func_5446(bool var_215_bool)
{
	int var_217_int;
...
// @pe
void func_5453(bool var_227_bool)
{
	int var_229_int;
...
void func_4945(bool var_23_bool, object var_24_object)
{
	...
	func_5179(var_28_bool, var_29_object);
	if(var_28_bool != 0) {
...
// @pe
void func_5460(bool var_239_bool)
{
	int var_241_int;
...
// @pe
void func_5467(bool var_251_bool)
{
	int var_253_int;
...
// @pe
void func_5474(bool var_104_bool)
{
...
// @pe
void func_5495(bool var_128_bool)
{
	int var_130_int;
...
void func_5506(int var_109_int)
{
	int var_111_int;
...
void func_5529(float var_68_float)
{
...
// @pe
void func_5543(object var_39_object)
{
	int var_40_int;
	func_5523(var_40_int);
	if(var_40_int == 1)
...
void func_5556(bool var_24_bool)
{
	@ClearSubContainer(0);
	int var_32_int;
...
// @pe
void func_5049(object var_82_object)
{
...
// @pe
void func_5057(int var_34_int, object var_35_object)
{
	object var_37_object;
	var_35_object = var_37_object;
	bool var_36_bool;
	func_4552(var_36_bool, var_37_object);
	if(var_36_bool != 0)
		var_34_int = 2;
	else
		var_34_int = 0;
...
// @pe
void func_5067(object var_76_object)
{
...
// @pe
void func_5075(int var_74_int, object var_75_object)
{
	object var_78_object;
	var_75_object = var_78_object;
	bool var_77_bool;
	func_4552(var_77_bool, var_78_object);
	if(var_77_bool != 0)
		var_74_int = 2;
	else
		var_74_int = 0;
...
// @pe
void func_5085(object var_111_object)
{
	object var_112_object;
