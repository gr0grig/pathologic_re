...
void func_3587(bool var_67_bool)
{
	float var_68_float;
	func_3426(var_68_float);
...
// @pe
void func_3593(bool var_27_bool, object var_28_object, object var_29_object)
{
	object var_32_object;
	...
	bool var_31_bool;
	func_3160(var_31_bool, var_32_object, var_33_object, 700.0);
...
// @pe
void func_3116(object var_82_object)
{
...
// @pe
void func_3142(int var_74_int, object var_75_object)
{
	object var_78_object;
	var_75_object = var_78_object;
	bool var_77_bool;
	func_2619(var_77_bool, var_78_object);
	if(var_77_bool != 0)
		var_74_int = 2;
	else
		var_74_int = 0;
...
// @pe
void func_3152(object var_111_object)
{
	object var_112_object;
...
void func_659(bool var_0_bool, object var_83_object)
{
	...
	func_2546(var_98_cvector, var_0_bool);
	...
	func_2908(var_104_float, var_105_cvector, var_106_cvector);
	if(var_104_float < 0) {
		func_2643(var_0_bool);
		var_90_bool = true;
	} else {
...
// @pe
void func_3231(int var_209_int)
{
	var_209_int = 0;
}
...
// @pe
void func_3239(object var_33_object)
{
	object var_34_object;
	func_3547(var_34_object, var_34_object);
}
...
void func_2816(object var_91_object)
{
	float var_94_float;
...
void func_3426(float var_68_float)
{
...
// @pe
void func_3440(object var_39_object)
{
	int var_40_int;
...
void func_3453(bool var_24_bool)
{
	int var_26_int;
	@ClearSubContainer(0);
	if(var_24_bool != 0) {
		...
		if(!(var_26_int >= 6)) goto Label_3528;
...
void func_3529(int var_106_int)
{
	var_106_int = 515561;
}


void func_3531(int var_105_int)
{
	var_105_int = 503346;
}


void func_3533(string var_107_string)
{
	var_107_string = "ui/NPC_Citizen1.png";
}


void func_3535(string var_108_string)
{
	var_108_string = "ui/NPC_Citizen1_b.png";
}


void func_3537(bool var_25_bool)
{
	var_25_bool = false;
}
...
void func_3547(object var_34_object, object var_49_object)
{
	bool var_36_bool;
