...
maintask task_1
{
	...
	void OnAttacked(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, object var_4_object, object var_5_object, int var_6_int, int var_7_int, bool var_8_bool, float var_9_float, int var_10_int, bool var_11_bool, object var_12_object, bool var_13_bool)
	{
		...
		func_2961(var_25_int, var_26_object);
		int var_15_int;
	...
	void OnPlayerDamage(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, object var_4_object, bool var_5_bool, object var_6_object, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool)
	{
		...
		if(var_18_bool != 0) {
			...
			func_3054(var_81_object, var_82_bool);
	...
	void OnMessage(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, string var_4_string, object var_5_object, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool)
	{
		...
		if(var_17_bool != 0) {
			...
			func_3113(var_170_string, var_171_object);
		}
	Label_308:
...
task task_2
{
	...
	void OnMessage(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, string var_4_string, object var_5_object, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool)
	{
		...
		if(var_17_bool != 0) {
			...
			func_3113(var_169_string, var_170_object);
		}
	Label_653:
...
void func_2567(bool var_106_bool)
{
	int var_109_int; bool var_110_bool;
	if(var_106_bool != 0) {
		int var_115_int;
		func_2447(var_115_int);
		func_2495(0, (100 + (var_115_int * 100)));
		@irand(var_109_int, 8);
		if(var_109_int == 0) {
			int var_143_int;
			func_2742(var_143_int, "lemon");
			@AddItem(var_110_bool, var_143_int, 0, 1);
		} else {
				if(var_109_int == 1) {
					int var_149_int;
					func_2742(var_149_int, "rusk");
...
// @pe
void func_3101(int var_123_int, string var_124_string, object var_125_object)
{
		...
		if(var_244_bool != 0) {
			...
			if(var_205_float >= (var_186_float * var_186_float)) {
				...
				if(var_358_bool != 0) {
					...
					@StopAsync();
					bool var_612_bool;
					func_1663(var_208_float, var_612_bool);
					var_613_bool = !var_612_bool; //@nz
					if(var_613_bool == 0) goto Label_1266;
					bool var_614_bool;
					func_2149(var_614_bool, var_0_bool);
					if(!var_614_bool) { //@nz
						goto Label_1276;
					}
					var_0_bool->GetPFPosition(var_199_cvector); //@t
					...
					bool var_619_bool; float var_620_float;
					var_186_float = var_620_float;
					func_1367(var_207_bool, var_208_float, var_619_bool, var_620_float);
					var_621_bool = !var_619_bool; //@nz
					if(var_621_bool == 0) goto Label_1266;
					goto Label_1276;
			}
				bool var_622_bool; float var_623_float;
				var_186_float = var_623_float;
				func_1367(var_207_bool, var_208_float, var_622_bool, var_623_float);
				if(!var_622_bool) { //@nz
					goto Label_1276;
				}
				var_202_bool = true;
...
// @pe
void func_3113(string var_171_string, object var_172_object)
{
...
// @pe
void func_3123(int var_128_int, object var_129_object)
{
...
// @pe
void func_3141(object var_175_object)
{
...
void func_3067(bool var_22_bool, object var_23_object, object var_24_object, float var_25_float, bool var_26_bool)
{
	object var_30_object;
	var_24_object = var_30_object;
	bool var_29_bool;
	func_2979(var_29_bool, var_30_object, !var_26_bool);
	if(!var_29_bool) { //@nz
		var_22_bool = false;
		return 2;
	}
...
// @pe
void func_3150(object var_24_object)
{
...
// @pe
void func_3157(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_3162(bool var_26_bool, object var_27_object)
{
	bool var_29_bool;
...
// @pe
void func_3177(object var_54_object)
{
...
// @pe
void func_3183(bool var_43_bool)
{
	var_43_bool = false;
}
...
// @pe
void func_3188(bool var_21_bool)
{
	var_21_bool = false;
}
...
void func_3197(object var_25_object)
{
	bool var_27_bool;
...
void func_3210(bool var_58_bool)
{
	var_58_bool = false;
}
...
// @pe
void func_3212(bool var_165_bool)
{
	var_165_bool = true;
}
...
// @pe
void func_3215(bool var_18_bool, object var_19_object, object var_20_object, bool var_21_bool)
{
	object var_23_object;
	...
	bool var_22_bool;
	func_3067(var_22_bool, var_23_object, var_24_object, 700.0, var_26_bool);
	var_22_bool = var_18_bool;
}


// @pe
void func_3225(object var_96_object)
{
...
void func_1711(int var_567_int)
{
	var_567_int = 0;
}
	...
	for(;;) {
		...
		if(var_75_bool != 0) {
			...
			if(var_55_int == 0) {
				...
				func_2920(var_84_string, var_85_int);
...
void func_2742(int var_133_int, string var_134_string)
{
	int var_136_int;
...
void func_1720(bool var_592_bool)
{
	var_592_bool = true;
}
...
// @pe
void func_2747(object var_14_object)
{
	object var_15_object;
...
// @pe
void func_2792(bool var_17_bool, object var_18_object, string var_19_string)
{
...
// @pe
void func_2824(object var_47_object, string var_48_string)
{
...
Label_2848:
	...
	if(!(var_48_string == "battle")) goto Label_2848;
...
void func_2849(bool var_14_bool, object var_15_object)
{
	bool var_17_bool;
...
void func_1328(bool var_0_bool, float var_492_float, int var_493_int)
{
	...
	if(var_497_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_567_int, var_499_float, var_508_float);
		object var_568_object; float var_569_float;
		var_497_object = var_568_object;
		var_499_float = var_569_float;
		func_1718();
	}
}
EMIT "Stack[-3] = 0";
...
// @pe
void func_2872(object var_28_object)
{
	object var_29_object;
...
// @pe
void func_2878(object var_16_object)
{
...
void func_2891(bool var_14_bool, string var_15_string)
{
	object var_17_object;
...
void func_1367(bool var_0_bool, bool var_1_bool, bool var_455_bool, float var_456_float)
{
	...
	if(var_462_bool != 0) {
		...
		func_1706(var_464_string);
		bool var_577_bool;
		func_2149(var_577_bool, var_0_bool);
		if(!var_577_bool) { //@nz
			@StopAsync();
			var_455_bool = false;
			return 8;
		}
		float var_580_float; int var_581_int;
		var_456_float = var_580_float;
		func_1328(var_464_string, var_580_float, var_581_int);
		var_463_int = 1;

		for(;;) {
			var_464_string = (("attack_middle" + var_581_int) + "_") + var_463_int;
			...
			if(!var_462_bool) { //@nz
				...
				func_1706(var_464_string);
				bool var_603_bool;
				func_2149(var_603_bool, var_0_bool);
				if(!var_603_bool) { //@nz
					@StopAsync();
					var_455_bool = false;
					return 8;
				}
				float var_606_float; int var_607_int;
				var_456_float = var_606_float;
				var_461_int = var_607_int;
				func_1328(var_464_string, var_606_float, var_607_int);
				var_463_int += 1;
			}
	}
...
void func_2907(string var_25_string)
{
	object var_27_object;
...
void func_2920(string var_68_string, int var_69_int)
{
...
// @pe
void func_2953(object var_55_object)
{
...
void func_2447(int var_115_int)
{
	float var_117_float;
...
// @pe
void func_2961(int var_83_int, object var_84_object)
{
...
void func_2456(object var_16_object)
{
	bool var_18_bool;
...
// @pe
void func_2971(object var_176_object)
{
...
void func_2979(bool var_29_bool, object var_30_object, bool var_31_bool)
{
...
void func_2476(int var_220_int)
{
	int var_222_int;
...
// @pe
void func_2482(object var_30_object)
{
	int var_31_int;
	func_2476(var_31_int);
	if(var_31_int == 1)
...
void func_2495(int var_112_int, int var_113_int)
{
...
void func_2526(string var_226_string)
{
...
void func_1504(bool var_593_bool, float var_594_float)
{
	float var_597_float; bool var_598_bool;
	@rand(var_597_float);
	if(var_597_float < var_594_float) {

		for(;;) {
			@IsAnimationPlaying(var_598_bool);
			if(!var_598_bool) { //@nz
			} else {
				bool var_601_bool;
				func_1602(var_601_bool);
				if(var_601_bool != 0) {
					var_593_bool = true;
					return 4;
				}
...
// @pe
void func_3054(int var_80_int, object var_81_object)
{
...
// @pe
void func_3061(object var_119_object)
{
	object var_120_object;
	var_119_object = var_120_object;
	func_2971(var_120_object);
}
