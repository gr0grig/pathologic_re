...
maintask task_1
{
	...
	void OnSee(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_3_object, bool var_4_bool, object var_5_object, object var_6_object, cvector var_7_cvector, bool var_8_bool, object var_9_object, cvector var_10_cvector, bool var_11_bool, object var_12_object, cvector var_13_cvector, bool var_14_bool)
	{
		...
		func_2528(var_15_bool, var_16_object);
		if(var_15_bool != 0) {
...
task task_6
{
	...
	void OnTimer(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, int var_11_int, object var_12_object, cvector var_13_cvector, bool var_14_bool)
	{
		...
		if(var_0_bool == null) {
			...
			@FindDirLength(var_20_float, var_19_cvector, 7000.0);
			cvector var_28_cvector;
			func_1335(var_22_float, var_28_cvector, 1.7453294);
			var_28_cvector = var_21_cvector;
			var_22_float = var_21_cvector | var_21_cvector;
			bool var_58_bool = false;
			if(var_22_float >= 2500.0) {
			...
			if(var_58_bool == 0) goto Label_1489;
			@Stop();
			cvector var_86_cvector;
			func_1716(var_86_cvector);
			var_1_bool = var_86_cvector + var_21_cvector;
...
task task_7
{
	...
	void OnTimer(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, cvector var_12_cvector, bool var_13_bool, int var_14_int)
	{
		...
		if(var_0_bool == null) {
			...
			@FindDirLength(var_20_float, var_19_cvector, 7000.0);
			cvector var_28_cvector;
			func_1529(var_22_float, var_28_cvector, 1.7453294);
			var_28_cvector = var_21_cvector;
			var_22_float = var_21_cvector | var_21_cvector;
			bool var_58_bool = false;
			if(var_22_float >= 2500.0) {
			...
			if(var_58_bool == 0) goto Label_1683;
			@Stop();
			cvector var_86_cvector;
			func_1716(var_86_cvector);
			var_1_bool = var_86_cvector + var_21_cvector;
...
void OnHit(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, cvector var_12_cvector, bool var_13_bool, object var_14_object, int var_15_int, float var_16_float, float var_17_float)
{
	...
	func_1953(var_18_object, var_19_int, var_20_float);
}
...
void OnHit2(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, cvector var_12_cvector, bool var_13_bool, object var_14_object, int var_15_int, float var_16_float, float var_17_float, cvector var_18_cvector, cvector var_19_cvector)
{
	...
	func_2021(var_22_float, var_23_cvector, var_24_cvector);
}
...
void func_2570(bool var_15_bool, string var_16_string)
{
	object var_18_object;
	if(var_16_string == "heal") {
		...
		func_2694(var_22_bool, var_23_object);
...
Label_1601:
	...
	if(var_78_bool != 0) {
		...
		Label_1631:
			...
			func_1529(var_80_float, var_131_cvector, 2.6179938);
			var_131_cvector = var_79_cvector;
			if((var_79_cvector | var_79_cvector) >= 2500.0) {
				cvector var_135_cvector;
				func_1716(var_135_cvector);
				var_1_bool = var_135_cvector + var_79_cvector;
				@SetTimer(120, 0.5);
			} else {
			}
	}
		if(!false) goto Label_1601; //@nz

	}
}


void func_2586(string var_59_string)
{
...
void func_2081(object var_20_object)
{
...
// @pe
void func_2551(object var_27_object)
{
	object var_28_object;
...
void func_2599(string var_72_string, int var_73_int)
{
...
void func_2087(cvector var_46_cvector, cvector var_47_cvector)
{
...
void func_2606(int var_66_int)
{
	...
	for(;;) {
		...
		func_2599(var_72_string, var_73_int);
...
// @pe
void func_2097(float var_88_float, float var_89_float, float var_90_float, float var_91_float)
{
...
// @pe
void func_2108(float var_77_float, cvector var_78_cvector, cvector var_79_cvector)
{
...
// @pe
void func_2626(object var_64_object)
{
	object var_65_object;
...
void func_1092(bool var_17_bool, object var_18_object)
{
	...
	bool var_19_bool;
	func_1885(var_19_bool, var_20_object);
	var_19_bool = var_17_bool;
}


void func_2116(float var_196_float)
{
...
// @pe
void func_2634(int var_23_int, object var_24_object)
{
	object var_27_object;
	var_24_object = var_27_object;
	bool var_26_bool;
	func_1885(var_26_bool, var_27_object);
	if(var_26_bool != 0)
		var_23_int = 2;
	else
		var_23_int = 0;
...
void func_1101(bool var_0_bool, cvector var_28_cvector, float var_29_float)
{
	...
	func_2087(var_44_cvector, (var_36_cvector - var_37_cvector));
	func_2087(var_42_cvector, (var_44_cvector + (var_38_cvector * 0.75)));
...
void func_2126(float var_94_float)
{
...
// @pe
void func_2644(object var_64_object)
{
	object var_65_object;
	var_64_object = var_65_object;
	TaskCall(5);
...
void func_2136(float var_72_float)
{
	object var_74_object;
	@CreateFloatVector(var_74_object);
	var_74_object->add(var_72_float);
	@SendWorldWndMessage(16, var_74_object);
}
EMIT "Stack[-1] = 0";


// @pe
void func_2652(int var_17_int)
{
	var_17_int = 0;
}
...
// @pe
void func_2657(int var_44_int)
{
	var_44_int = 0;
}


void func_2146(int var_115_int)
{
	float var_117_float;
...
// @pe
void func_2665(object var_23_object)
{
	object var_24_object;
	var_23_object = var_24_object;
	func_2713(var_24_object);
}


void func_2155(int var_220_int)
{
	int var_222_int;
...
// @pe
void func_2161(object var_29_object)
{
	int var_30_int;
...
// @pe
void func_2679(bool var_20_bool)
{
	var_20_bool = false;
}
...
// @pe
void func_2684(bool var_27_bool)
{
	var_27_bool = false;
}


void func_2174(int var_112_int, int var_113_int)
{
...
// @pe
void func_2689(bool var_31_bool)
{
	var_31_bool = false;
}
...
// @pe
void func_2694(bool var_22_bool, object var_23_object)
{
	object var_25_object;
	var_23_object = var_25_object;
	bool var_24_bool;
	func_1885(var_24_bool, var_25_object);
	var_24_bool = var_22_bool;
}


// @pe
void func_2701(object var_65_object)
{
	object var_66_object;
...
void func_1684(bool var_2_bool)
{
	@Stop();
	@KillTimer(120);
	var_2_bool = true;
...
void func_2713(object var_24_object)
{
	bool var_26_bool;
...
void func_2205(string var_226_string)
{
...
void func_1700(bool var_0_bool, bool var_66_bool)
{
	cvector var_69_cvector;
	@GetDirection(var_69_cvector);
	cvector var_71_cvector;
	func_1721(var_71_cvector, var_0_bool);
	...
	func_2108(var_77_float, var_78_cvector, var_79_cvector);
	var_66_bool = var_77_float >= -0.34202012;
}


void func_2726(bool var_66_bool, object var_67_object)
{
	bool var_69_bool;
...
{
	int var_220_int;
	func_2155(var_220_int);
	if(var_220_int != 1) {
	}
	func_2205("diseased_liver");
	func_2205("diseased_kidney");
	func_2205("diseased_heart");
	func_2205("diseased_blood");
}


// @pe
void func_2736(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_689(void)
{
	...
	@WaitForAnimEnd();
	bool var_64_bool;
	func_2035(var_64_bool);
	if(!var_64_bool) //@nz
		return 14;
	int var_66_int;
	func_2606(var_66_int);
	int var_57_int;
	...
	for(;;) {
		...
		if(var_79_bool != 0) {
			...
			if(var_59_int == 0) {
				...
				func_2599(var_88_string, var_89_int);
...
// @pe
void func_2739(object var_97_object)
{
	bool var_98_bool; object var_99_object;
	func_1736(var_98_bool, var_99_object);
	if(var_98_bool != 0) {
		object var_102_object;
		func_2081(var_102_object);
...
void func_1716(cvector var_86_cvector)
{
...
void func_1721(cvector var_48_cvector, object var_49_object)
{
...
void func_1728(float var_132_float, object var_133_object)
{
...
void func_2246(bool var_106_bool)
{
	int var_109_int; bool var_110_bool;
	if(var_106_bool != 0) {
		int var_115_int;
		func_2146(var_115_int);
		func_2174(0, (100 + (var_115_int * 100)));
		@irand(var_109_int, 8);
		if(var_109_int == 0) {
			int var_143_int;
			func_2421(var_143_int, "lemon");
			@AddItem(var_110_bool, var_143_int, 0, 1);
		} else {
				if(var_109_int == 1) {
					int var_149_int;
					func_2421(var_149_int, "rusk");
...
void func_1736(bool var_98_bool, object var_99_object)
{
	bool var_101_bool;
...
void func_1741(bool var_41_bool, object var_42_object, string var_43_string)
{
...
// @pe
void func_2766(int var_26_int, object var_27_object)
{
	object var_29_object;
	var_27_object = var_29_object;
	bool var_28_bool;
	func_1885(var_28_bool, var_29_object);
	if(var_28_bool != 0)
		var_26_int = 2;
	else
		var_26_int = 0;
...
// @pe
void func_2776(object var_66_object)
{
	object var_67_object;
	var_66_object = var_67_object;
	TaskCall(7);
	func_1559(var_68_object, var_69_cvector, var_70_bool, var_67_object);
	TaskReturn();
}


void func_1753(bool var_76_bool, object var_77_object, string var_78_string, float var_79_float, float var_80_float, float var_81_float)
{
	object var_85_object;
	var_77_object = var_85_object;
	string var_86_string;
	var_78_string = var_86_string;
	bool var_84_bool;
	func_1741(var_84_bool, var_85_object, var_86_string);
	if(!var_84_bool) //@nz
		var_76_bool = false;
	float var_83_float;
	var_77_object->GetProperty(var_78_string, var_83_float);
	float var_88_float; float var_90_float; float var_91_float;
	var_80_float = var_90_float;
	var_81_float = var_91_float;
	func_2097(var_88_float, (var_83_float + var_79_float), var_90_float, var_91_float);
	var_77_object->SetProperty(var_78_string, var_88_float);
	var_76_bool = true;
}
...
void func_1775(float var_142_float, object var_143_object, float var_144_float)
{
	float var_148_float;
	object var_150_object;
	var_143_object = var_150_object;
	bool var_149_bool;
	func_1741(var_149_bool, var_150_object, "disease");
	if(!var_149_bool) { //@nz
		var_142_float = 0;
		return 4;
	}
	...
	func_1741(var_153_bool, var_154_object, "armor_disease");
	if(var_153_bool != 0) {
		var_154_object->GetProperty("armor_disease", var_147_float);
		var_147_float /= 100;
	}
	bool var_158_bool; object var_159_object;
	func_1741(var_158_bool, var_159_object, "immunity");
	if(var_158_bool != 0) {
		...
		func_1753(var_162_bool, var_163_object, "immunity", var_165_float, (float)0, (float)1);
	}
	if(var_147_float >= 1) {
		var_142_float = 0.0;
		return 4;
	...
	func_1753(var_186_bool, var_187_object, "disease", var_189_float, (float)0, (float)1);
	bool var_192_bool; object var_193_object;
	var_143_object = var_193_object;
	func_1736(var_192_bool, var_193_object);
	if(var_192_bool != 0) {
		float var_196_float;
		var_144_float = var_196_float;
		func_2116(var_196_float);
	}
...
void func_775(object var_65_object)
{
	...
	bool var_66_bool;
	func_2726(var_66_bool, var_67_object);
	if(var_66_bool != 0) {
...
void func_1288(object var_66_object)
{
	...
	func_1753(var_76_bool, var_77_object, "reputation", 0.1, (float)0, (float)1);
	func_2126(0.06);
	bool var_98_bool; object var_99_object;
	var_66_object = var_99_object;
	func_1753(var_98_bool, var_99_object, "health", 0.06, (float)0, (float)1);
	object var_104_object;
	func_1365(var_68_cvector, var_69_bool, var_104_object, var_104_object);
}


void func_1844(bool var_34_bool, object var_35_object)
{
	bool var_37_bool;
...
void func_1335(bool var_0_bool, cvector var_28_cvector, float var_29_float)
{
	cvector var_36_cvector;
	@GetPosition(var_36_cvector);
	cvector var_37_cvector;
...
void func_1849(bool var_23_bool, object var_24_object)
{
	...
	if(var_33_bool != 0) {
		...
		func_1844(var_34_bool, var_35_object);
		if(var_34_bool != 0)
			var_30_bool = true;
	}
	if(var_30_bool != 0) {
...
void func_1365(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_104_object)
{
	float var_111_float; cvector var_113_cvector; float var_114_float;
	cvector var_115_cvector;
	func_1335(var_114_float, var_115_cvector, 1.7453294);
	cvector var_110_cvector;
	var_115_cvector = var_110_cvector;
	if((var_110_cvector | var_110_cvector) < 2500.0) {
		cvector var_147_cvector;
		func_1335(var_114_float, var_147_cvector, 2.6179938);
		var_147_cvector = var_110_cvector;
		var_111_float = var_110_cvector | var_110_cvector;
		if(var_111_float < 2500.0) {
			var_152_float = sqrt(var_111_float);
			@Trace("Can't retreat, distance: " + var_152_float);
			@Sleep(0.5);
			return 10;
		}
	}
	var_155_float = GetByIndex(var_110_cvector, 0);
	var_156_float = GetByIndex(var_110_cvector, 2);
	@Rotate(var_155_float, var_156_float);
	cvector var_157_cvector;
	func_1716(var_157_cvector);
	@SetTimer(120, 0.5);
	
Label_1407:
	bool var_112_bool;
	@MovePoint((var_157_cvector + var_110_cvector), 1, var_112_bool);
	if(var_112_bool != 0) {
		...
		Label_1437:
			...
			func_1335(var_114_float, var_165_cvector, 2.6179938);
			var_165_cvector = var_113_cvector;
			if((var_113_cvector | var_113_cvector) >= 2500.0) {
				cvector var_169_cvector;
				func_1716(var_169_cvector);
				var_1_bool = var_169_cvector + var_113_cvector;
				@SetTimer(120, 0.5);
			} else {
			}
	}
		if(!false) goto Label_1407; //@nz

	}
}


void func_1885(bool var_19_bool, object var_20_object)
{
	object var_24_object;
	var_20_object = var_24_object;
	bool var_23_bool;
	func_1849(var_23_bool, var_24_object);
	if(!var_23_bool) { //@nz
		var_19_bool = false;
		return 2;
	}
	bool var_41_bool; object var_42_object;
	func_1741(var_41_bool, var_42_object, "noaccess");
	if(!var_41_bool) { //@nz
		var_19_bool = true;
		return 2;
	}
...
void func_1909(object var_31_object)
{
...
void func_2421(int var_133_int, string var_134_string)
{
	int var_136_int;
...
// @pe
void func_2426(object var_15_object)
{
	object var_16_object;
...
void func_392(bool var_2_bool, object var_15_object)
{
	...
	func_1885(var_20_bool, var_21_object);
	if(!var_20_bool) //@nz
		return 4;
	if(var_2_bool != 0)
		return 4;
...
void func_1953(object var_18_object, int var_19_int, float var_20_float)
{
	...
	if(var_39_bool != 0) {
		...
		func_1721(var_48_cvector, var_49_object);
		var_48_cvector = var_47_cvector;
		func_2087(var_46_cvector, var_47_cvector);
	...
	if(var_36_int == 0) goto Label_2015;
	int var_37_int;
	...
	func_2021(var_65_float, var_66_cvector, var_67_cvector);
}


// @pe
void func_2471(bool var_18_bool, object var_19_object, string var_20_string)
{
	if(var_20_string == "unholster") {
		bool var_23_bool; object var_24_object;
		var_19_object = var_24_object;
		func_2679(var_24_object);
...
// @pe
void func_2503(object var_33_object, string var_34_string)
{
...
Label_2527:
	...
	if(!(var_34_string == "battle")) goto Label_2527;
...
void func_1490(bool var_2_bool)
{
	@Stop();
	@KillTimer(120);
	var_2_bool = true;
...
void func_2528(bool var_15_bool, object var_16_object)
{
	bool var_18_bool;
	bool var_19_bool = false;
	bool var_20_bool; object var_21_object;
	var_16_object = var_21_object;
	func_2679(var_21_object);
	if(var_20_bool != 0) {
		bool var_22_bool; object var_23_object;
		func_1736(var_22_bool, var_23_object);
		if(var_22_bool != 0)
			var_19_bool = true;
	}
	if(var_19_bool != 0) {
...
void func_1506(bool var_0_bool, bool var_66_bool)
{
	cvector var_69_cvector;
	@GetDirection(var_69_cvector);
	cvector var_71_cvector;
...
void func_2021(object var_20_object, cvector var_23_cvector, cvector var_24_cvector)
{
	object var_27_object;
	@GetScene(var_27_object);
	object var_28_object;
...
void func_2035(bool var_16_bool)
{
	bool var_18_bool;
...
void func_2040(string var_40_string)
{
	...
	if(var_62_bool == 0) goto Label_2060;
}


void func_1529(bool var_0_bool, cvector var_28_cvector, float var_29_float)
{
	cvector var_36_cvector;
	@GetPosition(var_36_cvector);
	cvector var_37_cvector;
...
// @pe
void func_2557(object var_17_object)
{
	bool var_18_bool; object var_19_object;
	func_1736(var_18_bool, var_19_object);
	if(var_18_bool != 0) {
		object var_22_object;
		func_2081(var_22_object);
