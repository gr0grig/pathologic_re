...
void func_130(int var_8_int, string var_9_string)
{
	int var_11_int;
...
void func_135(bool var_0_bool, string var_1_string, int var_2_int, int var_3_int)
{
	string var_9_string;
...
{
	bool var_0_bool;
	func_135(var_0_bool, "blooddiseased", 1, 0);
	if(!var_0_bool) //@nz
