...
task task_0
{
	...
	void OnTimer(object var_0_object, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, int var_4_int, bool var_5_bool, bool var_6_bool, bool var_7_bool, object var_8_object)
	{
		if(21 == var_8_object) {
			...
			float var_13_float;
			func_858(var_13_float, var_2_cvector, var_3_cvector);
...
maintask task_1
{
	void init(object var_0_object, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, bool var_4_bool, bool var_5_bool, bool var_6_bool, object var_7_object)
	{
		...
		for(;;) {
			TaskCall(2);
			func_280(var_11_bool, var_12_bool);
			TaskReturn();
			TaskCall(3);
			func_375();
			TaskReturn();
...
task task_2
{
	...
	void OnTimer(object var_0_object, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, bool var_4_bool, bool var_5_bool, int var_6_int, bool var_7_bool, object var_8_object)
	{
		...
		if(var_8_object == 20) {
			...
			func_937(var_14_bool, var_15_object);
			if(var_14_bool != 0)
				func_351(var_7_bool, var_8_object);
		}
	}
	...
	void OnSee(object actor, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, bool var_4_bool, bool var_5_bool, object var_6_object, bool var_7_bool, object var_8_object)
	{
		...
		func_888(var_9_bool, var_10_object);
		if(var_9_bool != 0) {
			func_351(var_7_bool, var_10_object);
			object var_48_object;
			var_8_object = var_48_object;
			func_914(var_48_object);
		}
	}
	...
	{
		bool var_9_bool; object var_10_object;
		func_901(var_9_bool, var_10_object);
		if(var_9_bool != 0) {
			func_351(var_7_bool, var_10_object);
			object var_48_object;
			var_8_object = var_48_object;
			func_922(var_48_object);
		}
	}
...
task task_3
{
	...
	void OnTimer(object var_0_object, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, bool var_4_bool, bool var_5_bool, bool var_6_bool, object var_7_object, int var_8_int)
	{
		...
		func_562(var_7_object, var_8_int, var_12_int);
		if(var_8_int == 20) {
			bool var_79_bool; object var_80_object;
			object var_81_object;
			func_662(var_81_object);
			var_81_object = var_80_object;
			func_937(var_79_bool, var_80_object);
			if(!var_79_bool) //@nz
				func_584(var_8_int);
		}
	}
	...
	void OnSee(object actor, bool var_1_bool, cvector var_2_cvector, cvector var_3_cvector, bool var_4_bool, bool var_5_bool, bool var_6_bool, object var_7_object, object var_8_object)
	{
		...
		func_888(var_9_bool, var_10_object);
		if(var_9_bool != 0) {
			func_584(var_10_object);
			object var_49_object;
			var_8_object = var_49_object;
			func_914(var_49_object);
		}
	}
...
void func_0(object var_0_object, cvector var_2_cvector, object var_50_object)
{
	...
	for(;;) {
		if(true != 0) {
			...
			func_863(var_88_float, var_89_cvector, var_90_cvector);
			var_88_float = var_75_float;
			if(var_75_float > 160000.0) {
				cvector var_95_cvector;
				func_848(var_95_cvector, (var_90_cvector - var_74_cvector));
			...
			var_132_float = GetByIndex(var_80_cvector, 1);
			var_79_float = var_132_float;
			SetByIndex(var_80_cvector, 1) = var_132_float;
			...
			var_50_object = var_136_object;
			func_818(var_135_bool, var_136_object);
			if(var_135_bool != 0) {
				float var_137_float; cvector var_138_cvector; cvector var_139_cvector;
				cvector var_140_cvector;
				func_644(var_140_cvector);
				var_140_cvector = var_138_cvector;
				cvector var_143_cvector; object var_144_object;
				var_50_object = var_144_object;
				func_649(var_143_cvector, var_144_object);
				var_143_cvector = var_139_cvector;
				func_863(var_137_float, var_138_cvector, var_139_cvector);
				if(var_137_float <= 90000.0) {
					@PlaySound("attack");
					float var_150_float; object var_151_object;
					func_708(var_150_float, var_151_object, 0.2);
					var_150_float = var_82_float;
					@ReportHit(var_151_object, 5, var_82_float, 0.2);
				}
			}
			...
			func_842(var_214_object);
			@RemoveActor(var_214_object);
			return 28;
		}
		bool var_108_bool; object var_109_object;
		func_818(var_108_bool, var_109_object);
		if(!var_108_bool) { //@nz
			if(!var_73_bool) //@nz
				@KillTimer(21);
			@FogLinear(0, 0.5);
		...
		if(var_1_bool != 0) {
			...
			if((var_71_float + var_72_float) >= 20.0) {
				@Trace("Leaving");
				@KillTimer(21);
				@FogLinear(0, 1.0);
...
void func_644(cvector var_140_cvector)
{
	cvector var_142_cvector;
	@GetPosition(var_142_cvector);
	var_142_cvector = var_140_cvector;
}


void func_901(bool var_9_bool, object var_10_object)
{
	bool var_12_bool;
	...
	if(var_12_bool != 0) {
		...
		func_818(var_14_bool, var_15_object);
		if(var_14_bool != 0)
			var_9_bool = true;
	}
}
...
void func_649(cvector var_143_cvector, object var_144_object)
{
	cvector var_146_cvector;
	var_144_object->GetPosition(var_146_cvector);
	var_146_cvector = var_143_cvector;
}


void func_777(bool var_91_bool, object var_92_object)
{
	bool var_94_bool;
...
void func_782(bool var_80_bool, object var_81_object)
{
	...
	if(var_90_bool != 0) {
		...
		func_777(var_91_bool, var_92_object);
		if(var_91_bool != 0)
			var_87_bool = true;
	}
	if(var_87_bool != 0) {
...
void func_654(float var_118_float, object var_119_object)
{
...
// @pe
void func_914(object var_49_object)
{
...
void func_662(object var_66_object)
{
...
void func_280(object var_0_object, bool var_1_bool)
{
...
// @pe
void func_922(object var_49_object)
{
	object var_50_object;
	var_49_object = var_50_object;
	TaskCall(0);
...
void func_669(bool var_200_bool, object var_201_object)
{
	bool var_203_bool;
...
void func_674(bool var_98_bool, object var_99_object, string var_100_string)
{
...
void func_937(bool var_70_bool, object var_71_object)
{
	int var_75_int;
	object var_77_object;
	var_71_object = var_77_object;
	bool var_76_bool;
	func_818(var_76_bool, var_77_object);
	if(!var_76_bool) { //@nz
		var_70_bool = false;
		return 4;
	}
	...
	if(var_111_bool != 0) {
		...
		if(var_75_int == var_116_int) {
			...
			func_654(var_118_float, var_119_object);
...
void func_686(bool var_170_bool, object var_171_object, string var_172_string, float var_173_float, float var_174_float, float var_175_float)
{
	...
	bool var_178_bool;
	func_674(var_178_bool, var_179_object, var_180_string);
	if(!var_178_bool) //@nz
		var_170_bool = false;
	float var_177_float;
	...
	func_867(var_182_float, (var_177_float + var_173_float), var_184_float, var_185_float);
	var_171_object->SetProperty(var_172_string, var_182_float);
	var_170_bool = true;
}


void func_818(bool var_76_bool, object var_77_object)
{
	object var_81_object;
	var_77_object = var_81_object;
	bool var_80_bool;
	func_782(var_80_bool, var_81_object);
	if(!var_80_bool) { //@nz
		var_76_bool = false;
		return 2;
	}
	bool var_98_bool; object var_99_object;
	func_674(var_98_bool, var_99_object, "noaccess");
	if(!var_98_bool) { //@nz
		var_76_bool = true;
		return 2;
	}
...
// @pe
void func_562(object var_0_object, bool var_1_bool, int var_12_int)
{
	if(var_12_int != 0)
		return 0;
	bool var_15_bool;
	func_453(var_15_bool, var_1_bool);
	if(!var_15_bool) //@nz
		var_0_object = true;
	@KillTimer(0);
	@Stop();
...
void func_708(float var_150_float, object var_151_object, float var_152_float)
{
	float var_156_float;
	object var_158_object;
	var_151_object = var_158_object;
	bool var_157_bool;
	func_674(var_157_bool, var_158_object, "disease");
	if(!var_157_bool) { //@nz
		var_150_float = 0;
		return 4;
	}
	float var_155_float = 0;
	bool var_161_bool; object var_162_object;
	func_674(var_161_bool, var_162_object, "armor_disease");
	if(var_161_bool != 0) {
		var_162_object->GetProperty("armor_disease", var_155_float);
		var_155_float /= 100;
	}
	bool var_166_bool; object var_167_object;
	func_674(var_166_bool, var_167_object, "immunity");
	if(var_166_bool != 0) {
		var_167_object->GetProperty("immunity", var_156_float);
		var_155_float += var_156_float;
		bool var_170_bool; object var_171_object; float var_173_float;
		var_151_object = var_171_object;
		var_173_float = -var_152_float;
		func_686(var_170_bool, var_171_object, "immunity", var_173_float, (float)0, (float)1);
	}
	if(var_155_float >= 1) {
		var_150_float = 0.0;
		return 4;
	}
	var_152_float *= ((1 - var_155_float) / 2);
	bool var_194_bool; object var_195_object; float var_197_float;
	var_151_object = var_195_object;
	var_152_float = var_197_float;
	func_686(var_194_bool, var_195_object, "disease", var_197_float, (float)0, (float)1);
	bool var_200_bool; object var_201_object;
	var_151_object = var_201_object;
	func_669(var_200_bool, var_201_object);
	if(var_200_bool != 0) {
		float var_204_float;
		var_152_float = var_204_float;
		func_878(var_204_float);
	}
...
// @pe
void func_453(bool var_151_bool, object var_152_object)
{
	object var_154_object;
	var_152_object = var_154_object;
	bool var_153_bool;
	func_937(var_153_bool, var_154_object);
...
void func_842(object var_214_object)
{
	object var_216_object;
	@self(var_216_object);
	var_216_object = var_214_object;
}
EMIT "Stack[-1] = 0";


void func_460(object var_0_object, bool var_1_bool, bool var_129_bool, object var_130_object, float var_131_float, float var_132_float, bool var_133_bool, bool var_134_bool)
{
	...
	for(;;) {
		...
		func_453(var_151_bool, var_152_object);
		if(!var_151_bool) { //@nz
			var_129_bool = false;
			return 16;
		}
		...
		if(var_149_float > (var_131_float * var_131_float)) {
			...
			if(var_145_object != null) {
				if(var_144_bool == 0) goto Label_513;
				var_144_bool = false;
...
void func_848(cvector var_95_cvector, cvector var_96_cvector)
{
...
void func_339(float var_28_float)
{
	float var_30_float;
...
void func_600(string var_169_string)
{
	var_169_string = "walk";
}


void func_858(float var_13_float, cvector var_14_cvector, cvector var_15_cvector)
{
	var_13_float = sqrt((var_15_cvector - var_14_cvector) | (var_15_cvector - var_14_cvector));
}


void func_602(string var_170_string)
{
	var_170_string = "run";
}
...
void func_351(object var_0_object, bool var_1_bool)
{
	var_0_object = true;
	var_1_bool = false;
	@Stop();
...
void func_863(float var_88_float, cvector var_89_cvector, cvector var_90_cvector)
{
...
// @pe
void func_867(float var_182_float, float var_183_float, float var_184_float, float var_185_float)
{
	if(var_183_float < var_184_float) {
		var_184_float = var_182_float;
		return 0;
	}
	if(var_183_float > var_185_float) {
		var_185_float = var_182_float;
		return 0;
	}
	var_183_float = var_182_float;
}


void func_878(float var_204_float)
{
	object var_206_object;
	@CreateFloatVector(var_206_object);
	var_206_object->add(var_204_float);
	@SendWorldWndMessage(14, var_206_object);
}
EMIT "Stack[-1] = 0";


void func_367(bool var_38_bool)
{
	var_38_bool = false;
}


void func_369(object var_32_object, cvector var_33_cvector)
{
...
void func_375(void)
{
	...
	func_662(var_66_object);
	object var_64_object;
	var_66_object = var_64_object;
	bool var_70_bool; object var_71_object;
	var_64_object = var_71_object;
	func_937(var_70_bool, var_71_object);
	if(!var_70_bool) { //@nz
	}
	bool var_129_bool; object var_130_object;
	object var_63_object;
	func_460(var_63_object, var_130_object, var_129_bool, var_130_object, (float)100, (float)0, false, false);
}
EMIT "Stack[-1] = 0";


void func_888(bool var_9_bool, object var_10_object)
{
	bool var_12_bool;
	@IsPlayerActor(var_10_object, var_12_bool);
	var_9_bool = false;
