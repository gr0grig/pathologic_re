...
maintask task_5
{
	...
	void OnLoad(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, string var_4_string, bool var_5_bool, object var_6_object, object var_7_object, object var_8_object, string var_9_string, bool var_10_bool, int var_11_int, int var_12_int, bool var_13_bool, bool var_14_bool, object var_15_object, bool var_16_bool, int var_17_int)
	{
		...
		if(var_6_object != var_18_int) {
			func_1397();
			int var_42_int;
			func_1287(var_42_int);
			var_6_object = var_42_int;
		}
		func_888();
	}
...
void func_1296(string var_81_string, int var_82_int)
{
...
// @pe
void func_914(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, string var_4_string, float var_52_float, float var_53_float)
{
	bool var_54_bool;
	func_1087(var_54_bool);
	if(!var_54_bool) //@nz
		return 0;
	@FindActor(var_4_string, "player");
	var_2_object = false;
	var_0_bool = var_52_float;
	var_1_object = var_53_float;
	@SetTimer(10, 1.0);
	func_993();
	if(!false) //@nz
		@KillTimer(10);
...
void func_1426(int var_31_int, string var_32_string)
{
	int var_34_int;
...
void func_1303(int var_75_int)
{
	...
	for(;;) {
		...
		func_1296(var_81_string, var_82_int);
...
void func_1454(int var_89_int)
{
	var_89_int = 521048;
}


void func_1456(int var_88_int)
{
	var_88_int = 521047;
}


void func_1072(bool var_100_bool)
{
	var_100_bool = true;
}


void func_1458(string var_90_string)
{
...
void func_1460(string var_91_string)
{
	var_91_string = "ui/NPC_Citizen2_b.png";
}


void func_1462(bool var_83_bool)
{
	var_83_bool = false;
}
...
void func_1087(bool var_45_bool)
{
	bool var_47_bool;
...
void func_835(float var_41_float, float var_42_float)
{
	
Label_836:
	for(;;) {
		bool var_45_bool;
		func_1087(var_45_bool);
		var_48_bool = !var_45_bool; //@nz
		if(var_48_bool == 0) goto Label_844;
		@Hold();
	}
...
Label_844:
	float var_44_float;
	@rand(var_44_float, 3);
	@Sleep(var_44_float + 3);
	float var_52_float; float var_53_float;
	float var_43_float;
	func_914(var_17_int, var_52_float, var_53_float, var_43_float, var_44_float, var_52_float, var_53_float);
	@sync();
	goto Label_836;
}
EMIT "Return(); Pop(2)";
...
void func_993(void)
{
	int var_68_int; int var_69_int; bool var_70_bool; float var_71_float; bool var_72_bool;
	@WaitForAnimEnd();
	bool var_73_bool;
	func_1087(var_73_bool);
	if(!var_73_bool) //@nz
		return 14;
	int var_75_int;
	func_1303(var_75_int);
	int var_66_int;
	var_75_int = var_66_int;
	int var_67_int = 0;
	...
	for(;;) {
		...
		if(var_88_bool != 0) {
			@irand(var_68_int, 3);
			if(var_68_int == 0) {
				if(var_66_int == 0) goto Label_1040;
				@irand(var_69_int, var_66_int);
				string var_97_string; int var_98_int;
				var_69_int = var_98_int;
				func_1296(var_97_string, var_98_int);
			...
			if(var_68_int == 1) {
				@rand(var_71_float, 4);
				@Sleep((var_71_float + 1), var_72_bool);
				if(!var_72_bool) { //@nz
					goto Label_1069;
				}
			} else if(var_67_int != 0) {
				goto Label_1069;
			}
			}
					bool var_100_bool;
					func_1072(var_100_bool);
					var_101_bool = !var_100_bool; //@nz
					if(var_101_bool == 0) goto Label_1064;
			}
		}
	Label_1069:
		for(;;) {
...
void func_1397(void)
{
	...
	var_27_int += 3;
	int var_31_int;
	func_1426(var_31_int, "grass_savyur");
	bool var_26_bool;
	@AddItem(var_26_bool, var_31_int, 0, var_27_int);
	@irand(var_27_int, 10);
	int var_38_int;
	func_1426(var_38_int, "grass_white_plet");
	@AddItem(var_26_bool, var_38_int, 0, (var_27_int + 3));
}
