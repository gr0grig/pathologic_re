...
void func_0(bool var_0_bool, bool var_92_bool, object var_93_object, object var_210_object)
{
	...
	func_2752(var_152_cvector, var_153_cvector, var_154_cvector, 2000.0);
...
void func_2056(float var_545_float, object var_546_object, float var_547_float, int var_548_int)
{
	...
	float var_583_float;
	func_2586(var_583_float, ((var_558_int + var_560_int) / 100.0), (float)1);
	float var_561_float;
	...
	float var_593_float;
	func_2617(var_593_float, (var_562_float - var_563_float), (float)0, (float)1);
...
void func_2570(object var_68_object)
{
...
void func_3084(string var_112_string)
{
	object var_116_object;
	@CreateInvItem(var_116_object);
	var_116_object->SetItemName(var_112_string);
	var_116_object->SetProperty("Organ", 1);
	int var_117_int;
	var_116_object->GetItemID(var_117_int);
	bool var_118_bool;
	@AddItem(var_118_bool, var_116_object, 0, 1);
}
EMIT "Stack[-3] = 0";


void func_2576(cvector var_48_cvector, cvector var_49_cvector)
{
...
void func_1555(int var_2_int, object var_699_object)
{
	var_2_int = false;
	bool var_704_bool;
	@Sleep(1, var_704_bool);
	if(!var_704_bool) //@nz
		return 2;
	var_2_int = true;
	bool var_707_bool; object var_708_object;
	bool var_703_bool;
	func_1635(var_703_bool, var_704_bool, var_707_bool, var_708_object, (float)200, (float)2000, true, true);
	if(!var_707_bool) //@nz
		return 2;
	var_2_int = false;
	@Face(var_708_object);
	@WaitForAnimEnd(var_704_bool);
	if(!var_704_bool) { //@nz
		@StopAsync();
		return 2;
	}
...
// @pe
void func_2586(float var_583_float, float var_584_float, float var_585_float)
{
...
// @pe
void func_2593(float var_172_float, float var_173_float, float var_174_float, float var_175_float)
{
	var_172_float = (var_174_float * var_174_float) - ((4 * var_173_float) * var_175_float);
}


void func_2600(float var_186_float, float var_187_float, float var_188_float, float var_190_float)
{
	float var_192_float;
...
void func_3125(void)
{
	...
	int var_102_int;
	func_3155(var_102_int, "grabitel_mark");
	bool var_67_bool;
	@AddItem(var_67_bool, var_102_int, 0, 1);
}


// @pe
void func_2617(float var_51_float, float var_52_float, float var_53_float, float var_54_float)
{
...
// @pe
void func_2628(bool var_86_bool, float var_87_float, float var_88_float, float var_89_float)
{
	var_86_bool = false;
...
void func_2636(bool var_93_bool, int var_94_int, int var_95_int)
{
	int var_97_int;
...
void func_2129(bool var_612_bool, object var_613_object)
{
	object var_617_object;
	var_613_object = var_617_object;
	bool var_616_bool;
	func_2022(var_616_bool, var_617_object, "health");
	if(!var_616_bool) { //@nz
		var_612_bool = false;
		return 2;
	}
	bool var_620_bool = false;
	bool var_621_bool; object var_622_object;
	func_2017(var_621_bool, var_622_object);
	if(var_621_bool != 0) {
		bool var_623_bool;
	...
	float var_615_float;
	var_622_object->GetProperty("health", var_615_float);
	var_612_bool = var_615_float <= 0.0;
}


void func_2641(object var_17_object)
{
	object var_19_object;
...
void func_3155(int var_81_int, string var_82_string)
{
	int var_84_int;
...
// @pe
void func_2647(bool var_22_bool, object var_23_object, float var_24_float)
{
	if(!var_23_object) { //@nz
		var_22_bool = false;
		return 0;
...
void func_1635(bool var_0_bool, object var_1_object, bool var_707_bool, object var_708_object, float var_709_float, float var_710_float, bool var_711_bool, bool var_712_bool)
{
	bool var_721_bool; object var_723_object; cvector var_724_cvector; cvector var_725_cvector; float var_727_float; object var_728_object;
	var_0_bool = false;
	var_1_object = var_708_object;
	bool var_722_bool;
	var_712_bool = var_722_bool;
	
	for(;;) {
		bool var_729_bool; object var_730_object;
		var_708_object = var_730_object;
		func_1597(var_729_bool, var_730_object);
		if(!var_729_bool) { //@nz
			var_707_bool = false;
			return 16;
		}
		var_708_object->GetPosition(var_724_cvector);
		@GetPosition(var_725_cvector);
		var_727_float = (var_724_cvector - var_725_cvector) | (var_724_cvector - var_725_cvector);
		bool var_749_bool = false;
		if(var_710_float > 0) {
			if(var_727_float > (var_710_float * var_710_float))
				var_749_bool = true;
		}
		if(var_749_bool != 0) {
			@Stop();
		...
		if(var_727_float > (var_709_float * var_709_float)) {
			var_708_object->GetPFPosition(var_724_cvector);
			@FindPathTo(var_728_object, var_724_cvector);
			if(var_728_object != null) {
				var_728_object = var_723_object;
				var_728_object = null;
			}
			if(var_723_object != null) {
				if(var_722_bool == 0) goto Label_1688;
				var_722_bool = false;
				@RotatePath(var_723_object, var_721_bool);
				if(!var_721_bool) { //@nz
				} else {
						@SetTimer(0, 0.3);
						...
						@FollowPath(var_723_object, var_711_bool, var_721_bool, var_762_string, var_763_string);
						if(!var_721_bool) { //@nz
...
void func_2160(bool var_42_bool, object var_43_object)
{
	bool var_45_bool;
...
void func_2165(bool var_31_bool, object var_32_object)
{
...
void func_2682(float var_601_float)
{
...
void func_645(bool var_653_bool, float var_654_float)
{
	float var_657_float; bool var_658_bool;
	@rand(var_657_float);
	if(var_657_float < var_654_float) {

		for(;;) {
			@IsAnimationPlaying(var_658_bool);
			if(!var_658_bool) { //@nz
			} else {
				bool var_661_bool;
				func_743(var_661_bool);
				if(var_661_bool != 0) {
					var_653_bool = true;
					return 4;
				}
	...
	@WaitForAnimEnd();
	func_847(var_658_bool);
}


void func_2692(float var_29_float)
{
...
void func_2702(object var_109_object)
{
	bool var_111_bool;
...
void func_2201(bool var_27_bool, object var_28_object)
{
...
void func_672(bool var_0_bool, bool var_437_bool, float var_438_float)
{
	...
	for(;;) {
		...
		bool var_493_bool;
		func_2201(var_493_bool, var_0_bool);
		if(!var_493_bool) { //@nz
			var_437_bool = false;
			return 10;
		}
...
// @pe
void func_162(object var_607_object, float var_608_float)
{
	bool var_609_bool = false;
	if(var_608_float > 0) {
		bool var_612_bool; object var_613_object;
		var_607_object = var_613_object;
		func_2129(var_612_bool, var_613_object);
		if(var_612_bool != 0)
			var_609_bool = true;
	}
	if(var_609_bool != 0) {
		var_629_bool = GlobalVars[0];
		GlobalVars[0] = true;
		func_643(var_608_float);
	}
}


void func_2722(bool var_623_bool)
{
	bool var_625_bool;
	@GetVariable("god_mode", var_625_bool);
	var_625_bool = var_623_bool;
}


void func_2728(string var_73_string, int var_74_int)
{
...
void func_2225(bool var_21_bool, object var_22_object)
{
...
void func_2752(cvector var_152_cvector, cvector var_153_cvector, cvector var_154_cvector, float var_155_float)
{
...
Label_243:
	for(;;) {
		...
		bool var_276_bool;
		func_2201(var_276_bool, var_0_bool);
		if(var_276_bool != 0) {
			if(!var_3_int) //@nz
				var_275_bool = true;
		}
		if(var_275_bool != 0) {
			...
			if(var_238_float >= (var_219_float * var_219_float)) {
				...
				if(!var_235_bool) { //@nz
					...
					var_235_bool = true;
					bool var_394_bool;
					func_2201(var_394_bool, var_0_bool);
					if(!var_394_bool) { //@nz
						goto Label_415;
					}
				}
				...
				if(var_397_bool != 0) {
					...
					@StopAsync();
					bool var_672_bool;
					func_804(var_241_float, var_672_bool);
					var_673_bool = !var_672_bool; //@nz
					if(var_673_bool == 0) goto Label_405;
					bool var_674_bool;
					func_2201(var_674_bool, var_0_bool);
					if(!var_674_bool) { //@nz
						goto Label_415;
					}
					var_0_bool->GetPFPosition(var_232_cvector); //@t
					...
					bool var_679_bool; float var_680_float;
					var_219_float = var_680_float;
					func_506(var_240_bool, var_241_float, var_679_bool, var_680_float);
					var_681_bool = !var_679_bool; //@nz
					if(var_681_bool == 0) goto Label_405;
					goto Label_415;
			}
				bool var_682_bool; float var_683_float;
				var_219_float = var_683_float;
				func_506(var_240_bool, var_241_float, var_682_bool, var_683_float);
				if(!var_682_bool) { //@nz
					goto Label_415;
				}
				var_235_bool = true;
...
void func_715(bool var_0_bool, bool var_452_bool)
{
	...
	bool var_463_bool;
	func_2201(var_463_bool, var_0_bool);
	if(!var_463_bool) { //@nz
		var_452_bool = false;
		return 10;
	}
...
void func_2259(bool var_118_bool, cvector var_119_cvector)
{
...
void func_2269(bool var_114_bool, object var_115_object)
{
...
void func_2787(bool var_26_bool, object var_27_object)
{
	bool var_32_bool; object var_33_object;
...
void func_1766(string var_762_string)
{
	var_762_string = "walk";
}
...
void func_1768(string var_763_string)
{
	var_763_string = "run";
}


void func_2278(object var_33_object)
{
...
void func_759(bool var_0_bool, bool var_4_bool, bool var_469_bool)
{
	...
	for(;;) {
		...
		func_2002(var_480_cvector, var_0_bool);
...
void func_1787(bool var_71_bool, object var_72_object, bool var_94_bool, object var_693_object)
{
	...
	func_2628(var_86_bool, var_87_float, 250000.0, 3240000.0);
	if(var_86_bool != 0) {
	...
	var_72_object = var_692_object;
	TaskCall(1);
	func_126(var_691_bool, var_692_object);
	TaskReturn();
	var_693_object = var_71_bool;
}


void func_2812(bool var_19_bool, object var_20_object)
{
	float var_25_float;
...
void func_2322(object var_20_object, int var_21_int, float var_22_float)
{
...
// @pe
void func_2857(bool var_17_bool, object var_18_object)
{
	object var_20_object;
...
// @pe
void func_2864(object var_114_object)
{
	object var_116_object;
	...
	if(var_115_bool != 0) {
		...
		var_114_object = var_750_object;
		TaskCall(6);
		func_1555(var_753_bool, var_750_object);
		TaskReturn();
	}
	@ResetAAS();
}
...
// @pe
void func_1840(object var_126_object)
{
...
// @pe
void func_2881(bool var_17_bool, object var_18_object)
{
	object var_20_object;
	var_18_object = var_20_object;
	bool var_19_bool;
...
// @pe
void func_2888(object var_114_object)
{
	object var_116_object;
	var_114_object = var_116_object;
	TaskCall(7);
...
void func_1865(object var_127_object)
{
	cvector var_138_cvector; cvector var_139_cvector; cvector var_140_cvector; cvector var_141_cvector; string var_142_string; object var_143_object; bool var_144_bool; bool var_145_bool; float var_146_float; cvector var_147_cvector;
	if(var_127_object == null) {
		...
		var_192_bool = IsFuncExist(var_127_object, "GetScriptProperty", 2);
		if(var_192_bool != 0) {
		...
		var_199_bool = IsFuncExist(var_143_object, "@GetEyesHeight", 1);
		if(var_199_bool != 0) {
			var_143_object->GetEyesHeight(var_146_float);
			var_147_cvector = [0.0, 0.0, 0.0];
...
void func_2390(object var_22_object, cvector var_25_cvector, cvector var_26_cvector)
{
...
void func_2905(object var_20_object)
{
...
void func_857(bool var_652_bool)
{
	var_652_bool = true;
}
...
void func_2404(object var_383_object)
{
...
// @pe
void func_2918(object var_19_object)
{
	object var_20_object;
	...
	if(var_62_bool != 0) {
		...
		var_19_object = var_699_object;
		TaskCall(6);
		func_1555(var_702_bool, var_699_object);
		TaskReturn();
	}
	@ResetAAS();
}
...
void func_2415(bool var_63_bool)
{
	bool var_65_bool;
...
void func_2420(object var_299_object)
{
	float var_302_float;
	...
	for(;;) {
		...
		if(var_80_bool != 0) {
			...
			if(var_58_int == 0) {
				...
				func_2728(var_89_string, var_90_int);
...
void func_2946(bool var_19_bool, object var_20_object, object var_21_object)
{
...
void func_2442(string var_150_string)
{
...
// @pe
void func_2979(object var_17_object)
{
	object var_19_object;
	...
	if(var_18_bool != 0) {
		...
		func_2647(var_22_bool, var_23_object, 0.05);
	}
	object var_60_object;
...
// @pe
void func_1956(string var_149_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
// @pe
void func_2483(bool var_75_bool, string var_76_string)
{
	var_75_bool = true;
...
void func_2002(cvector var_50_cvector, object var_51_object)
{
...
void func_467(bool var_0_bool, float var_531_float, int var_532_int)
{
	...
	if(var_536_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_606_int, var_538_float, var_547_float);
		object var_607_object; float var_608_float;
		var_536_object = var_607_object;
		var_538_float = var_608_float;
...
void func_2009(float var_78_float, object var_79_object)
{
...
void func_3034(int var_106_int)
{
	int var_108_int;
...
void func_2017(bool var_18_bool, object var_19_object)
{
	bool var_21_bool;
...
// @pe
void func_3040(object var_20_object)
{
	int var_21_int;
	func_3034(var_21_int);
	if(var_21_int == 1)
...
void func_2022(bool var_41_bool, object var_42_object, string var_43_string)
{
...
void func_3053(int var_69_int, int var_70_int)
{
	if(var_69_int > var_70_int) {
		@Trace("GenerateMoney: iMin > iMax");
		return 4;
	}
	int var_73_int = 0;
	if(var_69_int != var_70_int) {
		@irand(var_73_int, (var_70_int - var_69_int));
	} else if(var_69_int == 0) {
		return 4;
	}
	var_73_int += var_69_int;
	if(var_73_int == 0)
		return 4;
	int var_81_int;
	func_3155(var_81_int, "Money");
	bool var_74_bool;
	@AddItem(var_74_bool, var_81_int, 0, var_73_int);
	
}


void func_2034(bool var_33_bool, object var_34_object, string var_35_string, float var_36_float, float var_37_float, float var_38_float)
{
	...
	func_2617(var_51_float, (var_40_float + var_36_float), var_53_float, var_54_float);
...
void func_506(bool var_0_bool, object var_1_object, bool var_498_bool, float var_499_float)
{
	...
	bool var_528_bool;
	func_2201(var_528_bool, var_0_bool);
	if(!var_528_bool) { //@nz
		@StopAsync();
		var_498_bool = false;
		return 8;
	...
	if(var_505_bool != 0) {
		...
		func_847(var_507_string);
		bool var_637_bool;
		func_2201(var_637_bool, var_0_bool);
		if(!var_637_bool) { //@nz
			@StopAsync();
			var_498_bool = false;
			return 8;
		}
		float var_640_float; int var_641_int;
		var_499_float = var_640_float;
		func_467(var_507_string, var_640_float, var_641_int);
		var_506_int = 1;

		for(;;) {
			var_507_string = (("attack_middle" + var_641_int) + "_") + var_506_int;
			...
			if(!var_505_bool) { //@nz
				...
				func_847(var_507_string);
				bool var_663_bool;
				func_2201(var_663_bool, var_0_bool);
				if(!var_663_bool) { //@nz
					@StopAsync();
					var_498_bool = false;
					return 8;
				}
				float var_666_float; int var_667_int;
				var_499_float = var_666_float;
				var_504_int = var_667_int;
				func_467(var_507_string, var_666_float, var_667_int);
				var_506_int += 1;
			}
	}
