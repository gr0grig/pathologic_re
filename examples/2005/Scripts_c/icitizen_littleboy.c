...
// @pe
void func_5257(object var_39_object)
{
	int var_40_int;
...
void func_659(bool var_0_bool, object var_74_object)
{
	...
	func_4224(var_89_cvector, var_0_bool);
	...
	func_4586(var_95_float, var_96_cvector, var_97_cvector);
	if(var_95_float < 0) {
		func_4321(var_0_bool);
		var_81_bool = true;
	} else {
...
void func_5270(bool var_24_bool)
{
	int var_26_int;
	@ClearSubContainer(0);
	if(var_24_bool != 0) {
		...
		if(!(var_26_int >= 6)) goto Label_5345;
...
// @pe
void func_4794(object var_73_object)
{
	object var_74_object;
...
// @pe
void func_4820(int var_76_int, object var_77_object)
{
	object var_80_object;
	var_77_object = var_80_object;
	bool var_79_bool;
	func_4297(var_79_bool, var_80_object);
	if(var_79_bool != 0)
		var_76_int = 2;
	else
		var_76_int = 0;
...
// @pe
void func_4830(object var_113_object)
{
...
void func_5346(int var_106_int)
{
	var_106_int = 515560;
}


void func_5348(int var_105_int)
{
	var_105_int = 503345;
}


void func_5350(string var_107_string)
{
...
void func_5352(string var_108_string)
{
	var_108_string = "ui/NPC_Citizen3_b.png";
}


void func_5354(bool var_25_bool)
{
	var_25_bool = false;
}
...
void func_5364(object var_34_object, object var_49_object)
{
	bool var_36_bool;
...
void func_5404(bool var_67_bool)
{
	var_67_bool = true;
}
...
// @pe
void func_5406(bool var_27_bool, object var_28_object, object var_29_object)
{
	object var_32_object;
	...
	bool var_31_bool;
	func_4838(var_31_bool, var_32_object, var_33_object, 500.0);
	if(var_31_bool != 0) {
...
// @pe
void func_4907(object var_33_object)
{
	object var_34_object;
	func_5364(var_34_object, var_34_object);
}
...
// @pe
void func_4919(int var_209_int)
{
	var_209_int = 0;
}
...
void func_4494(object var_82_object)
{
	float var_85_float;
