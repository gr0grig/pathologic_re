...
void func_212(int var_42_int)
{
	...
	func_274(var_44_int, "armor", var_46_int, var_47_int, 30);
	...
	func_274(var_61_int, "armor_fire", var_63_int, var_64_int, 10);
	...
	func_274(var_82_int, "armor_disease", var_84_int, var_85_int, 20);
