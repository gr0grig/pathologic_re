maintask task_0
{
	void init(bool var_0_bool)
	{
		...
		func_135(0.35);
		bool var_21_bool;
		func_82(var_21_bool, "tiredness", 0.35, (float)0, (float)1);
		func_125(0.35);
		func_50(10.0);
	}
...
void func_27(bool var_42_bool, float var_43_float)
{
	...
	if(var_44_bool != 0) {
		bool var_52_bool;
		func_82(var_52_bool, "health", (var_43_float * 0.3), (float)0, (float)1);
		bool var_58_bool;
		func_82(var_58_bool, "tiredness", (var_43_float * -0.3), (float)0, (float)1);
	}
	var_42_bool = false;
}
