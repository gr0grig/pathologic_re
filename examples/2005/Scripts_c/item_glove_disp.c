...
maintask task_0
{
	void init(bool var_0_bool)
	{
		...
		for(;;) {
			...
			var_12_int = var_11_float / 0.24;
			if(var_12_int > 0) {
				var_93_int = var_11_float % 0.24;
...
void func_212(int var_42_int)
{
	...
	func_274(var_44_int, "armor", var_46_int, var_47_int, 5);
	...
	func_274(var_82_int, "armor_disease", var_84_int, var_85_int, 5);
