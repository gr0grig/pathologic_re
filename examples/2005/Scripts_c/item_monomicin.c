maintask task_0
{
	void init(void)
	{
		...
		@SetProperty("disease", (var_1_float * 0.4));
		func_78(var_1_float - (var_1_float * 0.4));
		bool var_12_bool;
		func_38(var_12_bool, "tiredness", 0.25, (float)0, (float)1);
		func_68(0.25);
		bool var_32_bool;
		func_38(var_32_bool, "health", -0.25, (float)0, (float)1);
		func_88(-0.25);
	}
