...
void func_1679(string var_35_string, int var_36_int)
{
...
// @pe
void func_1709(object var_13_object)
{
	int var_14_int;
	func_1703(var_14_int);
	if(var_14_int == 1)
		...
		if(var_77_bool != 0) {
			...
			if(var_38_float >= (var_19_float * var_19_float)) {
				...
				if(var_237_bool != 0) {
					...
					@StopAsync();
					bool var_495_bool;
					func_778(var_41_float, var_495_bool);
					var_496_bool = !var_495_bool; //@nz
					if(var_496_bool == 0) goto Label_381;
					bool var_497_bool;
					func_1397(var_497_bool, var_0_object);
					if(!var_497_bool) { //@nz
						goto Label_391;
					}
					var_0_object->GetPFPosition(var_32_cvector); //@t
					...
					bool var_502_bool; float var_503_float;
					var_19_float = var_503_float;
					func_482(var_40_bool, var_41_float, var_502_bool, var_503_float);
					var_504_bool = !var_502_bool; //@nz
					if(var_504_bool == 0) goto Label_381;
					goto Label_391;
			}
				bool var_505_bool; float var_506_float;
				var_19_float = var_506_float;
				func_482(var_40_bool, var_41_float, var_505_bool, var_506_float);
				if(!var_505_bool) { //@nz
					goto Label_391;
				}
				var_35_bool = true;
...
void func_443(object var_0_object, float var_375_float, int var_376_int)
{
	...
	if(var_380_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_450_int, var_382_float, var_391_float);
		object var_451_object; float var_452_float;
		var_380_object = var_451_object;
		var_382_float = var_452_float;
		func_833();
	}
}
EMIT "Stack[-3] = 0";
...
void func_1722(string var_19_string)
{
	object var_23_object;
...
void func_835(bool var_475_bool)
{
	var_475_bool = true;
}
	...
	for(;;) {
		...
		if(var_42_bool != 0) {
			...
			if(var_20_int == 0) {
				...
				func_1679(var_51_string, var_52_int);
...
void func_482(object var_0_object, object var_1_object, bool var_338_bool, float var_339_float)
{
	...
	if(var_345_bool != 0) {
		...
		func_821(var_347_string);
		bool var_460_bool;
		func_1397(var_460_bool, var_0_object);
		if(!var_460_bool) { //@nz
			@StopAsync();
			var_338_bool = false;
			return 8;
		}
		float var_463_float; int var_464_int;
		var_339_float = var_463_float;
		func_443(var_347_string, var_463_float, var_464_int);
		var_346_int = 1;

		for(;;) {
			var_347_string = (("attack_middle" + var_464_int) + "_") + var_346_int;
			...
			if(!var_345_bool) { //@nz
				...
				func_821(var_347_string);
				bool var_486_bool;
				func_1397(var_486_bool, var_0_object);
				if(!var_486_bool) { //@nz
					@StopAsync();
					var_338_bool = false;
					return 8;
				...
				var_339_float = var_489_float;
				var_344_int = var_490_int;
				func_443(var_347_string, var_489_float, var_490_int);
				var_346_int += 1;
			}
	}
...
void func_619(bool var_476_bool, float var_477_float)
{
	float var_480_float; bool var_481_bool;
	@rand(var_480_float);
	if(var_480_float < var_477_float) {

		for(;;) {
			@IsAnimationPlaying(var_481_bool);
			if(!var_481_bool) { //@nz
			} else {
				bool var_484_bool;
				func_717(var_484_bool);
				if(var_484_bool != 0) {
					var_476_bool = true;
					return 4;
				}
...
void func_1771(object var_10_object)
{
...
void func_1659(object var_12_object)
{
	bool var_14_bool;
