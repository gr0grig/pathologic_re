...
maintask task_0
{
	...
	void OnPropertyChange(bool var_0_bool, bool var_1_bool, object var_2_object, string var_3_string, object var_4_object, bool var_5_bool, object var_6_object, object var_7_object, cvector var_8_cvector, bool var_9_bool, object var_10_object)
	{
		...
		func_1372(var_59_object, var_60_string);
	}
...
task task_5
{
	void OnTimer(bool var_0_bool, bool var_1_bool, object var_2_object, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, int var_9_int)
	{
		...
		if(var_9_int == 110) {
			bool var_16_bool;
			func_1123(var_16_bool, var_3_bool);
			if(!var_16_bool) { //@nz
				func_675();
			} else {
...
void OnUnload(bool var_0_bool, bool var_1_bool, object var_2_object, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object)
{
	object var_9_object;
...
void func_1409(object var_97_object)
{
	float var_100_float; object var_101_object;
	func_940(var_100_float, var_101_object, 0.02, 0);
	float var_99_float;
	var_100_float = var_99_float;
	@ReportHit(var_101_object, 7, var_99_float, 0.02);
	float var_160_float; object var_161_object;
	func_1013(var_160_float, var_161_object, 0.05);
	var_160_float = var_99_float;
	@ReportHit(var_161_object, 5, var_99_float, 0.05);
}
...
void func_1147(string var_14_string)
{
	...
	if(var_36_bool == 0) goto Label_1167;
}
...
// @pe
void func_1296(bool var_67_bool, object var_68_object)
{
...
void func_918(bool var_180_bool, object var_181_object, string var_182_string, float var_183_float, float var_184_float, float var_185_float)
{
	object var_189_object;
	var_181_object = var_189_object;
	string var_190_string;
	var_182_string = var_190_string;
	bool var_188_bool;
	func_906(var_188_bool, var_189_object, var_190_string);
	if(!var_188_bool) //@nz
		var_180_bool = false;
	float var_187_float;
	var_181_object->GetProperty(var_182_string, var_187_float);
	float var_192_float; float var_194_float; float var_195_float;
	var_184_float = var_194_float;
	var_185_float = var_195_float;
	func_1215(var_192_float, (var_187_float + var_183_float), var_194_float, var_195_float);
	var_181_object->SetProperty(var_182_string, var_192_float);
	var_180_bool = true;
}


void func_1432(object var_10_object)
{
	object var_13_object;
	@CreateInvItem(var_13_object);
	var_13_object->SetItemName("rat_big");
	float var_14_float;
	@rand(var_14_float, 0.5, 1);
	...
	func_1246(var_19_object, var_20_object, 1);
...
// @pe
void func_1311(bool var_10_bool, object var_11_object)
{
	object var_13_object;
	var_11_object = var_13_object;
	bool var_12_bool;
	func_1296(var_12_bool, var_13_object);
...
void func_1188(object var_9_object)
{
...
// @pe
void func_1318(object var_53_object)
{
	TaskCall(3);
...
void func_1194(cvector var_110_cvector, cvector var_111_cvector)
{
...
void func_940(float var_100_float, object var_101_object, float var_102_float, int var_103_int)
{
	...
	float var_135_float;
	func_1208(var_135_float, ((var_110_int + var_112_int) / 100.0), (float)1);
	float var_113_float;
	...
	float var_145_float;
	func_1215(var_145_float, (var_114_float - var_115_float), (float)0, (float)1);
...
// @pe
void func_1328(object var_45_object)
{
	TaskCall(3);
...
void func_1204(float var_53_float, cvector var_54_cvector, cvector var_55_cvector)
{
...
// @pe
void func_1208(float var_135_float, float var_136_float, float var_137_float)
{
...
void func_697(bool var_0_bool, cvector var_94_cvector, float var_95_float)
{
	...
	func_1194(var_110_cvector, (var_102_cvector - var_103_cvector));
	func_1194(var_108_cvector, (var_110_cvector + (var_104_cvector * 0.75)));
...
void func_1082(bool var_40_bool, object var_41_object)
{
	bool var_43_bool;
...
// @pe
void func_1215(float var_145_float, float var_146_float, float var_147_float, float var_148_float)
{
...
void func_1087(bool var_29_bool, object var_30_object)
{
...
void func_1345(bool var_11_bool, object var_12_object, string var_13_string)
{
...
// @pe
void func_1226(float var_123_float, cvector var_124_cvector, cvector var_125_cvector)
{
...
void func_465(bool var_0_bool, bool var_1_bool, bool var_233_bool, object var_234_object, float var_235_float, float var_236_float, bool var_237_bool, bool var_238_bool)
{
	...
	var_0_bool = false;
	var_1_bool = var_234_object;
	bool var_249_bool;
	var_238_bool = var_249_bool;
	
	for(;;) {
		bool var_256_bool; object var_257_object;
		var_234_object = var_257_object;
		func_596(var_256_bool, var_257_object);
		if(!var_256_bool) { //@nz
			var_233_bool = false;
			return 16;
		}
		var_234_object->GetPosition(var_251_cvector);
		...
		if(var_254_float > (var_235_float * var_235_float)) {
			var_234_object->GetPFPosition(var_251_cvector);
			...
			if(var_250_object != null) {
				if(var_249_bool == 0) goto Label_518;
				var_249_bool = false;
				...
				if(!var_248_bool) { //@nz
						...
						@FollowPath(var_250_object, var_237_bool, var_248_bool, var_274_string, var_275_string);
						if(!var_248_bool) { //@nz
...
void func_1234(int var_30_int, int var_31_int)
{
	object var_33_object;
...
void func_603(string var_274_string)
{
	var_274_string = "walk";
}


void func_1372(object var_61_object, string var_62_string)
{
	float var_64_float;
...
void func_605(string var_275_string)
{
	var_275_string = "run";
}
...
void func_1246(object var_19_object, object var_20_object, int var_21_int)
{
	int var_25_int;
...
void func_1123(bool var_25_bool, object var_26_object)
{
...
void func_228(bool var_0_bool, object var_46_object, bool var_223_bool)
{
	...
	for(;;) {
		bool var_67_bool;
		func_1296(var_67_bool, var_0_bool);
		if(var_67_bool != 0) {
			...
			if(((var_60_cvector - var_61_cvector) | (var_60_cvector - var_61_cvector)) < ((var_57_float + 10) * (var_57_float + 10))) {
				...
				if(!var_59_bool) { //@nz
					@SetAttackState(false);
						...
						bool var_94_bool;
						func_1123(var_94_bool, var_0_bool);
						if(var_94_bool != 0) {
							@GetVictim(var_57_float, var_65_object);
							@ReportAttack(var_0_bool);
							if(var_65_object == var_0_bool)
								func_1409(var_0_bool);
							var_65_object = null;
						}
						@SetAttackState(false);
						@PlayAnimation("all", "attack_end");
						@WaitForAnimEnd(var_59_bool);
						var_219_bool = !var_59_bool; //@nz
						if(var_219_bool == 0) goto Label_305;
				}
		}
		Label_321:
			for(;;) {
		...
		var_58_float = var_222_float;
		TaskCall(4);
		func_370(var_220_bool, var_0_bool, var_222_float);
		TaskReturn();
		if(!var_223_bool) { //@nz
			goto Label_321;
		}
...
void func_1265(float var_210_float)
{
	object var_212_object;
	@CreateFloatVector(var_212_object);
	var_212_object->add(var_210_float);
	@SendWorldWndMessage(14, var_212_object);
}
EMIT "Stack[-1] = 0";


void func_370(bool var_220_bool, object var_221_object, float var_222_float)
{
	func_389();
	bool var_233_bool; object var_234_object;
	var_221_object = var_234_object;
	bool var_225_bool;
	bool var_226_bool;
	func_465(var_225_bool, var_226_bool, var_233_bool, var_234_object, (var_222_float * 0.9), (float)5000, true, true);
	var_233_bool = var_226_bool;
	func_399();
	var_226_bool = var_220_bool;
}


void func_1013(float var_160_float, object var_161_object, float var_162_float)
{
	float var_166_float;
	object var_168_object;
	var_161_object = var_168_object;
	bool var_167_bool;
	func_906(var_167_bool, var_168_object, "disease");
	if(!var_167_bool) { //@nz
		var_160_float = 0;
		return 4;
	}
	float var_165_float = 0;
	bool var_171_bool; object var_172_object;
	func_906(var_171_bool, var_172_object, "armor_disease");
	if(var_171_bool != 0) {
		var_172_object->GetProperty("armor_disease", var_165_float);
		var_165_float /= 100;
	}
	bool var_176_bool; object var_177_object;
	func_906(var_176_bool, var_177_object, "immunity");
	if(var_176_bool != 0) {
		var_177_object->GetProperty("immunity", var_166_float);
		var_165_float += var_166_float;
		bool var_180_bool; object var_181_object; float var_183_float;
		var_161_object = var_181_object;
		var_183_float = -var_162_float;
		func_918(var_180_bool, var_181_object, "immunity", var_183_float, (float)0, (float)1);
	}
	if(var_165_float >= 1) {
		var_160_float = 0.0;
		return 4;
	}
	var_162_float *= ((1 - var_165_float) / 2);
	bool var_202_bool; object var_203_object; float var_205_float;
	var_161_object = var_203_object;
	var_162_float = var_205_float;
	func_918(var_202_bool, var_203_object, "disease", var_205_float, (float)0, (float)1);
	bool var_208_bool; object var_209_object;
	var_161_object = var_209_object;
	func_901(var_208_bool, var_209_object);
	if(var_208_bool != 0) {
		float var_210_float;
		var_162_float = var_210_float;
		func_1265(var_210_float);
	}
	var_162_float = var_160_float;
}
...
void func_1275(float var_153_float)
{
