...
void func_2056(string var_135_string, int var_136_int)
{
...
void func_2063(int var_129_int)
{
...
void func_533(void)
{
	...
	for(;;) {
		...
		if(var_142_bool != 0) {
			@irand(var_122_int, 3);
			if(var_122_int == 0) {
				if(var_120_int == 0) goto Label_580;
			...
			if(var_122_int == 1) {
				...
				goto Label_609;
					...
					if(var_155_bool == 0) goto Label_604;
			}
		}
	Label_609:
		for(;;) {
...
void func_612(bool var_154_bool)
{
	var_154_bool = true;
}
...
void func_2306(bool var_18_bool)
{
	...
	@ClearSubContainer(0);
	if(var_18_bool != 0) {
		func_1831("rifle_ammo", 1, 2, 2);
		func_1831("revolver_ammo", 1, 2, 2);
		func_1831("samopal_ammo", 2, 2, 2);
	} else {
		func_1820("lockpick", 1, 4);
		func_1831("alpha_pills", 1, 2, 3);
		func_1820("meradorm", 1, 2);
		func_1820("powder", 1, 15);
		int var_66_int;
		func_1911(var_66_int);
		var_66_int = var_20_int;
		if(var_20_int >= 4)
			func_1820("beta_pills", 1, 2);
		if(!(var_20_int >= 6)) goto Label_2381;
		func_1820("gamma_pills", 1, 7);
	}
Label_2381:
...
void func_1804(bool var_82_bool)
{
	bool var_84_bool;
...
void func_1820(string var_47_string, int var_48_int, int var_49_int)
{
	bool var_51_bool;
	int var_53_int;
...
void func_1831(string var_23_string, int var_24_int, int var_25_int, int var_26_int)
{
...
void func_1862(bool var_31_bool, int var_32_int, int var_33_int)
{
	int var_35_int;
...
void func_335(float var_101_float)
{
	float var_103_float;
...
void func_2390(object var_28_object)
{
	bool var_30_bool;
...
void func_2404(bool var_61_bool)
{
	float var_62_float;
...
void func_361(bool var_111_bool)
{
	var_111_bool = false;
}
...
// @pe
void func_2410(bool var_21_bool, object var_22_object, object var_23_object)
{
	object var_26_object;
...
void func_363(object var_105_object, cvector var_106_cvector)
{
