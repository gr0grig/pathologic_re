...
maintask task_0
{
	...
	void OnUse(bool var_0_bool, object var_1_object)
	{
		...
		func_57(var_6_bool, var_7_object, var_8_object, 1);
		if(var_6_bool != 0) {
			func_74();
...
void func_100(bool var_28_bool, object var_29_object, int var_30_int)
{
...
void func_39(object var_48_object)
{
...
void func_74(void)
{
	...
	func_100(var_28_bool, var_29_object, 594);
}
EMIT "Stack[-1] = 0";


void func_45(int var_18_int, int var_19_int)
{
...
void func_87(object var_37_object)
{
...
void func_57(bool var_6_bool, object var_7_object, object var_8_object, int var_9_int)
{
	int var_13_int;
