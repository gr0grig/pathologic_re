...
{
	int var_173_int;
	func_841(var_173_int, "b10q04MishkaTalk");
	if(var_173_int == 9)
		var_171_bool = true;
	var_171_bool = false;
}
...
// @pe
void func_1048(bool var_177_bool)
{
	int var_179_int;
	func_841(var_179_int, "b10q04");
	if(var_179_int == 1000)
		var_177_bool = true;
	var_177_bool = false;
}
...
// @pe
void func_1060(bool var_184_bool)
{
	int var_186_int;
	func_841(var_186_int, "b10q04");
	if(var_186_int == -1)
		var_184_bool = true;
	var_184_bool = false;
}
...
void func_940(void)
{
	...
	var_20_object->AddMark("b10q04MorlokGotoMishka", "pt_map_mishka", 0, 530550, var_34_float);
	func_1108();
}
EMIT "Stack[-1] = 0";
...
// @pe
void func_1072(bool var_155_bool)
{
	int var_157_int;
	func_841(var_157_int, "b10q04MishkaTalk");
	if(var_157_int == 0) {
		var_155_bool = true;
		return 0;
	}
...
// @pe
void func_1084(bool var_191_bool)
{
	int var_193_int;
	func_841(var_193_int, "oob10MorlokMishka1");
	if(var_193_int == 0) {
		var_191_bool = true;
		return 0;
	}
...
void func_975(object var_61_object)
{
	...
	func_1179(var_62_object, "pt_map_mishka", (float)2);
...
void func_1108(void)
{
	...
	@CreateDiaryEntry(var_38_object, 549, 2, 530440);
