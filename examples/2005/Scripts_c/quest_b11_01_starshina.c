...
void func_1818(bool var_185_bool, string var_186_string, string var_187_string)
{
		...
		if(var_170_bool != 0) {
			...
			if(var_131_float >= (var_112_float * var_112_float)) {
				...
				if(var_330_bool != 0) {
					...
					@StopAsync();
					bool var_588_bool;
					func_764(var_134_float, var_588_bool);
					var_589_bool = !var_588_bool; //@nz
					if(var_589_bool == 0) goto Label_367;
					bool var_590_bool;
					func_1472(var_590_bool, var_0_object);
					if(!var_590_bool) { //@nz
						goto Label_377;
					}
					var_0_object->GetPFPosition(var_125_cvector); //@t
					...
					var_112_float = var_596_float;
					func_468(var_133_bool, var_134_float, var_595_bool, var_596_float);
					var_597_bool = !var_595_bool; //@nz
					if(var_597_bool == 0) goto Label_367;
					goto Label_377;
			}
				bool var_598_bool; float var_599_float;
				var_112_float = var_599_float;
				func_468(var_133_bool, var_134_float, var_598_bool, var_599_float);
				if(!var_598_bool) { //@nz
					goto Label_377;
				}
				var_128_bool = true;
...
void func_1830(object var_165_object, string var_166_string, string var_167_string)
{
...
void func_429(object var_0_object, float var_468_float, int var_469_int)
{
	...
	if(var_473_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_543_int, var_475_float, var_484_float);
		object var_544_object; float var_545_float;
		var_473_object = var_544_object;
		var_475_float = var_545_float;
		func_819();
	}
}
EMIT "Stack[-3] = 0";
...
void func_821(bool var_568_bool)
{
	var_568_bool = true;
}
...
void func_1854(bool var_97_bool, string var_98_string)
{
...
void func_1083(object var_11_object)
{
	...
	bool var_97_bool;
	func_1854(var_97_bool, "NPC_Starshina");
	...
	func_1830(var_165_object, "boiny", "pt_Starshina");
	bool var_185_bool;
	func_1818(var_185_bool, "quest_b11_01", "fight_win");
...
void func_1866(object var_206_object)
{
	bool var_208_bool;
...
void func_468(object var_0_object, int var_1_int, bool var_431_bool, float var_432_float)
{
	...
	if(var_438_bool != 0) {
		...
		func_807(var_440_string);
		bool var_553_bool;
		func_1472(var_553_bool, var_0_object);
		if(!var_553_bool) { //@nz
			@StopAsync();
			var_431_bool = false;
			return 8;
		}
		float var_556_float; int var_557_int;
		var_432_float = var_556_float;
		func_429(var_440_string, var_556_float, var_557_int);
		var_439_int = 1;

		for(;;) {
			var_440_string = (("attack_middle" + var_557_int) + "_") + var_439_int;
			...
			if(!var_438_bool) { //@nz
				...
				func_807(var_440_string);
				bool var_579_bool;
				func_1472(var_579_bool, var_0_object);
				if(!var_579_bool) { //@nz
					@StopAsync();
					var_431_bool = false;
					return 8;
				...
				var_432_float = var_582_float;
				var_437_int = var_583_int;
				func_429(var_440_string, var_582_float, var_583_int);
				var_439_int += 1;
			}
	}
...
void func_605(bool var_569_bool, float var_570_float)
{
	...
	@WaitForAnimEnd();
	func_807(var_574_bool);
}


// @pe
void func_1886(object var_10_object)
{
	object var_11_object;
