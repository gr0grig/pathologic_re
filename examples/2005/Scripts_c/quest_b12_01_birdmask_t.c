	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 23338) {
				...
				var_146_bool = !var_33_bool; //@nz
				if(var_146_bool != 1) {
					bool var_147_bool;
					func_881(var_1_object);
					var_155_bool = !var_147_bool; //@nz
					if(var_155_bool != 1)
						var_32_bool = false;
				}
				if(var_32_bool != 0) {
				...
				bool var_183_bool;
				func_859(var_183_bool, var_1_object);
				if(var_183_bool != 0) {
					bool var_185_bool;
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_85_object, object var_86_object)
{
	...
	if(1 != 0) {
		...
		var_206_bool = !var_93_bool; //@nz
		if(var_206_bool != 1) {
			bool var_207_bool;
			func_881(var_1_object);
			var_215_bool = !var_207_bool; //@nz
			if(var_215_bool != 1)
				var_92_bool = false;
		}
		if(var_92_bool != 0) {
			...
			var_0_object->AddReply(523159, -1, 24361); //@t
					...
					bool var_256_bool;
					func_859(var_256_bool, var_1_object);
					if(var_256_bool != 0) {
						bool var_258_bool;
						func_869(var_1_object);
						if(var_258_bool != 0)
...
{
	bool var_24_bool;
	func_794(var_24_bool, "quest_b12_01", "init_theater");
}
...
// @pe
void func_869(bool var_258_bool)
{
	int var_260_int;
	func_789(var_260_int, "oob12BirdmaskT1");
	if(var_260_int == 0) {
		var_258_bool = true;
		return 0;
	}
...
// @pe
void func_881(bool var_207_bool)
{
	int var_209_int;
	func_789(var_209_int, "b12q01ChildsAreVisited");
	if(var_209_int != 0) {
		var_207_bool = true;
		return 0;
	}
...
// @pe
void func_893(bool var_229_bool)
{
	int var_231_int;
	func_789(var_231_int, "oob12BirdmaskT2");
	if(var_231_int == 0) {
		var_229_bool = true;
		return 0;
	}
