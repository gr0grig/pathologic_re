...
// @pe
void func_898(bool var_137_bool)
{
	int var_139_int;
	func_771(var_139_int, "oob1Worker3");
	if(var_139_int == 0) {
		var_137_bool = true;
		return 0;
	}
...
void func_771(int var_87_int, string var_88_string)
{
	int var_90_int;
...
void func_776(int var_35_int, int var_36_int)
{
...
void func_650(bool var_18_bool, object var_19_object, float var_20_float)
{
	...
	func_761(var_45_cvector, (var_34_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_60_bool;
	func_839(var_60_bool);
	if(var_60_bool != 0) {
	} else {
		@HasAnimationTrack(var_38_bool, "head");
		if(var_38_bool == 0) goto Label_712;
...
// @pe
void func_910(bool var_85_bool)
{
	int var_87_int;
	func_771(var_87_int, "oob1Worker1");
	if(var_87_int == 0) {
		var_85_bool = true;
		return 0;
	}
...
void func_788(object var_24_object, object var_25_object, int var_26_int)
{
	int var_30_int;
	...
	if(!var_32_bool) { //@nz
		...
		func_776(var_35_int, var_36_int);
	}
	
}


void func_922(int var_69_int)
{
	int var_71_int;
...
// @pe
void func_172(object var_2_object, string var_97_string)
{
	bool var_98_bool;
	...
	if(var_97_string == "")
		...
		var_102_bool = true;
	func_742(var_101_string, var_102_bool);
...
void func_831(int var_66_int)
{
	var_66_int = 515568;
}


void func_833(int var_65_int)
{
	var_65_int = 503353;
}


void func_835(string var_67_string)
{
	var_67_string = "ui/NPC_Citizen1.png";
}


void func_837(string var_68_string)
{
	var_68_string = "ui/NPC_Citizen1_b.png";
}


void func_839(bool var_60_bool)
{
	var_60_bool = false;
}
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_78_object, object var_79_object)
{
	...
	if(1 != 0) {
		...
		if(var_85_bool != 0) {
			...
			func_880();
			func_172(var_79_object, "Neutral");
			var_0_object->SetMessage(517930); //@t
			var_0_object->ClearReplies(); //@t
			var_0_object->AddReply(519691, 20850, 20849); //@t
		} else {
...
void func_718(void)
{
	...
	bool var_153_bool;
	func_839(var_153_bool);
	if(var_153_bool != 0) {
	} else {
		@HasAnimationTrack(var_152_bool, "head");
		if(var_152_bool == 0) goto Label_734;
		@UnlookAsync("head");
	}
Label_734:
...
void func_859(object var_16_object)
{
	...
	func_788(var_24_object, var_25_object, 1);
}
EMIT "Stack[-1] = 0";


void func_735(string var_115_string)
{
...
void func_742(string var_101_string, bool var_102_bool)
{
...
void func_755(object var_18_object)
{
...
// @pe
void func_886(bool var_128_bool)
{
	int var_130_int;
	func_771(var_130_int, "oob1Worker2");
	if(var_130_int == 0) {
		var_128_bool = true;
		return 0;
	}
...
void func_761(cvector var_45_cvector, cvector var_46_cvector)
{
