...
// @pe
void func_1805(bool var_14_bool, object var_15_object)
{
...
// @pe
void func_1812(object var_50_object)
{
...
// @pe
void func_1824(object var_13_object)
{
	int var_14_int;
...
void func_1837(string var_60_string)
{
		...
		if(var_124_bool != 0) {
			...
			if(var_87_float >= (var_68_float * var_68_float)) {
				...
				if(var_252_bool != 0) {
					...
					@StopAsync();
					bool var_510_bool;
					func_916(var_90_float, var_510_bool);
					var_511_bool = !var_510_bool; //@nz
					if(var_511_bool == 0) goto Label_519;
					bool var_512_bool;
					func_1409(var_512_bool, var_0_object);
					if(!var_512_bool) { //@nz
						goto Label_529;
					}
					var_0_object->GetPFPosition(var_81_cvector); //@t
					...
					var_68_float = var_518_float;
					func_620(var_89_bool, var_90_float, var_517_bool, var_518_float);
					var_519_bool = !var_517_bool; //@nz
					if(var_519_bool == 0) goto Label_519;
					goto Label_529;
			}
				bool var_520_bool; float var_521_float;
				var_68_float = var_521_float;
				func_620(var_89_bool, var_90_float, var_520_bool, var_521_float);
				if(!var_520_bool) { //@nz
					goto Label_529;
				}
				var_84_bool = true;
...
void func_1878(object var_51_object)
{
...
void func_620(object var_0_object, object var_1_object, bool var_353_bool, float var_354_float)
{
	...
	if(var_360_bool != 0) {
		...
		func_959(var_362_string);
		bool var_475_bool;
		func_1409(var_475_bool, var_0_object);
		if(!var_475_bool) { //@nz
			@StopAsync();
			var_353_bool = false;
			return 8;
		...
		func_581(var_362_string, var_478_float, var_479_int);
		var_361_int = 1;
		...
		for(;;) {
			...
			if(!var_360_bool) { //@nz
				...
				func_959(var_362_string);
				bool var_501_bool;
				func_1409(var_501_bool, var_0_object);
				if(!var_501_bool) { //@nz
					@StopAsync();
					var_353_bool = false;
					return 8;
				...
				func_581(var_362_string, var_504_float, var_505_int);
				var_361_int += 1;
			}
	}
...
void func_1706(float var_23_float)
{
...
void func_1716(object var_12_object)
{
	bool var_14_bool;
...
{
	func_1716(var_0_object);
}


void func_964(int var_465_int)
{
	var_465_int = 0;
}
...
void func_1736(string var_34_string, int var_35_int)
{
...
void func_973(bool var_490_bool)
{
	var_490_bool = true;
}


void func_1743(int var_28_int)
{
...
// @pe
void func_1760(object var_10_object)
{
...
void func_757(bool var_491_bool, float var_492_float)
{
