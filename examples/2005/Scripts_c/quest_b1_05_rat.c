...
maintask task_0
{
	...
	void OnPropertyChange(bool var_0_bool, bool var_1_bool, object var_2_object, string var_3_string, object var_4_object, bool var_5_bool, object var_6_object, object var_7_object, cvector var_8_cvector, bool var_9_bool, object var_10_object)
	{
		...
		func_1283(var_59_object, var_60_string);
	}
...
void OnUnload(bool var_0_bool, bool var_1_bool, object var_2_object, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object)
{
	...
	if(var_9_bool != 0) {
		bool var_16_bool;
		func_1184(var_16_bool, "quest_b1_05", "rat_dead");
	}
...
void func_1283(object var_61_object, string var_62_string)
{
	float var_64_float;
...
void func_1184(bool var_16_bool, string var_17_string, string var_18_string)
{
...
void func_1320(object var_97_object)
{
...
void func_1333(object var_10_object)
{
	object var_13_object;
...
// @pe
void func_1207(bool var_67_bool, object var_68_object)
{
...
// @pe
void func_1222(bool var_10_bool, object var_11_object)
{
	object var_13_object;
	var_11_object = var_13_object;
	bool var_12_bool;
	func_1207(var_12_bool, var_13_object);
	var_12_bool = var_10_bool;
}


void func_1097(object var_11_object)
{
	object var_13_object;
	@self(var_13_object);
...
// @pe
void func_1229(object var_53_object)
{
	TaskCall(3);
...
void func_465(bool var_0_bool, bool var_1_bool, bool var_177_bool, object var_178_object, float var_179_float, float var_180_float, bool var_181_bool, bool var_182_bool)
{
	bool var_192_bool; object var_194_object; cvector var_195_cvector; cvector var_196_cvector; float var_198_float; object var_199_object;
	var_0_bool = false;
	var_1_bool = var_178_object;
	bool var_193_bool;
	var_182_bool = var_193_bool;
	
	for(;;) {
		bool var_200_bool; object var_201_object;
		var_178_object = var_201_object;
		func_596(var_200_bool, var_201_object);
		if(!var_200_bool) { //@nz
			var_177_bool = false;
			return 16;
		}
		var_178_object->GetPosition(var_195_cvector);
		@GetPosition(var_196_cvector);
		var_198_float = (var_195_cvector - var_196_cvector) | (var_195_cvector - var_196_cvector);
		bool var_205_bool = false;
		if(var_180_float > 0) {
			if(var_198_float > (var_180_float * var_180_float))
				var_205_bool = true;
		}
		if(var_205_bool != 0) {
			@Stop();
		...
		if(var_198_float > (var_179_float * var_179_float)) {
			var_178_object->GetPFPosition(var_195_cvector);
			@FindPathTo(var_199_object, var_195_cvector);
			if(var_199_object != null) {
				var_199_object = var_194_object;
				var_199_object = null;
			}
			if(var_194_object != null) {
				if(var_193_bool == 0) goto Label_518;
				var_193_bool = false;
				@RotatePath(var_194_object, var_192_bool);
				if(!var_192_bool) { //@nz
				} else {
						@SetTimer(0, 0.3);
						...
						@FollowPath(var_194_object, var_181_bool, var_192_bool, var_218_string, var_219_string);
						if(!var_192_bool) { //@nz
...
// @pe
void func_1239(object var_45_object)
{
	TaskCall(3);
...
void func_603(string var_218_string)
{
	var_218_string = "walk";
}
...
void func_605(string var_219_string)
{
	var_219_string = "run";
}
...
void func_991(bool var_9_bool, object var_10_object)
{
	bool var_15_bool;
...
void func_228(bool var_0_bool, object var_46_object, bool var_167_bool)
{
	...
	for(;;) {
		bool var_67_bool;
		func_1207(var_67_bool, var_0_bool);
		if(var_67_bool != 0) {
			...
			if(((var_60_cvector - var_61_cvector) | (var_60_cvector - var_61_cvector)) < ((var_57_float + 10) * (var_57_float + 10))) {
				...
				if(!var_59_bool) { //@nz
					@SetAttackState(false);
						...
						@WaitForAnimEnd(var_59_bool);
						var_163_bool = !var_59_bool; //@nz
						if(var_163_bool == 0) goto Label_305;
				}
		}
		Label_321:
			for(;;) {
		...
		@StopAsync();
		bool var_164_bool; float var_166_float;
		var_58_float = var_166_float;
		TaskCall(4);
		func_370(var_164_bool, var_0_bool, var_166_float);
		TaskReturn();
		if(!var_167_bool) { //@nz
			goto Label_321;
		}
...
void func_1256(bool var_11_bool, object var_12_object, string var_13_string)
{
...
void func_370(bool var_164_bool, object var_165_object, float var_166_float)
{
	func_389();
	bool var_177_bool; object var_178_object;
	var_165_object = var_178_object;
	bool var_169_bool;
	bool var_170_bool;
	func_465(var_169_bool, var_170_bool, var_177_bool, var_178_object, (var_166_float * 0.9), (float)5000, true, true);
	var_177_bool = var_170_bool;
	func_399();
	var_170_bool = var_164_bool;
}
