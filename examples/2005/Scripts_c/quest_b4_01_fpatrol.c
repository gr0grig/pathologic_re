...
maintask task_1
{
	...
	void OnAttacked(int var_0_int, bool var_1_bool, object var_2_object, object var_3_object, int var_4_int, int var_5_int, bool var_6_bool, float var_7_float, int var_8_int, bool var_9_bool, object var_10_object, bool var_11_bool)
	{
		...
		if(var_13_bool != 0) {
			bool var_15_bool;
			func_1698(var_15_bool, "quest_b4_01", "patrol_attack");
		}
	}
...
void func_1798(object var_12_object)
{
	bool var_15_bool;
	func_1698(var_15_bool, "quest_b4_01", "patrol_dead");
	bool var_14_bool;
...
void func_1698(bool var_15_bool, string var_16_string, string var_17_string)
{
...
void func_1710(object var_14_object)
{
	bool var_16_bool;
		...
		if(var_84_bool != 0) {
			...
			if(var_45_float >= (var_26_float * var_26_float)) {
				...
				if(var_244_bool != 0) {
					...
					@StopAsync();
					bool var_502_bool;
					func_784(var_48_float, var_502_bool);
					var_503_bool = !var_502_bool; //@nz
					if(var_503_bool == 0) goto Label_387;
					bool var_504_bool;
					func_1406(var_504_bool, var_0_int);
					if(!var_504_bool) { //@nz
						goto Label_397;
					}
					var_0_int->GetPFPosition(var_39_cvector); //@t
					...
					var_26_float = var_510_float;
					func_488(var_47_bool, var_48_float, var_509_bool, var_510_float);
					var_511_bool = !var_509_bool; //@nz
					if(var_511_bool == 0) goto Label_387;
					goto Label_397;
			}
				bool var_512_bool; float var_513_float;
				var_26_float = var_513_float;
				func_488(var_47_bool, var_48_float, var_512_bool, var_513_float);
				if(!var_512_bool) { //@nz
					goto Label_397;
				}
				var_42_bool = true;
...
void func_449(int var_0_int, float var_382_float, int var_383_int)
{
	...
	if(var_387_object == var_0_int) {
		...
		@ReportHit(var_0_int, var_457_int, var_389_float, var_398_float);
		object var_458_object; float var_459_float;
		var_387_object = var_458_object;
		var_389_float = var_459_float;
		func_839();
	}
}
EMIT "Stack[-3] = 0";
...
void func_841(bool var_482_bool)
{
	var_482_bool = true;
}
...
// @pe
void func_1736(object var_15_object)
{
	int var_16_int;
	func_1730(var_16_int);
	if(var_16_int == 1)
...
void func_1749(string var_56_string)
{
...
void func_488(int var_0_int, bool var_1_bool, bool var_345_bool, float var_346_float)
{
	...
	if(var_352_bool != 0) {
		...
		func_827(var_354_string);
		bool var_467_bool;
		func_1406(var_467_bool, var_0_int);
		if(!var_467_bool) { //@nz
			@StopAsync();
			var_345_bool = false;
			return 8;
		...
		var_346_float = var_470_float;
		func_449(var_354_string, var_470_float, var_471_int);
		var_353_int = 1;

		for(;;) {
			var_354_string = (("attack_middle" + var_471_int) + "_") + var_353_int;
			...
			if(!var_352_bool) { //@nz
				...
				func_827(var_354_string);
				bool var_493_bool;
				func_1406(var_493_bool, var_0_int);
				if(!var_493_bool) { //@nz
					@StopAsync();
					var_345_bool = false;
					return 8;
				...
				var_346_float = var_496_float;
				var_351_int = var_497_int;
				func_449(var_354_string, var_496_float, var_497_int);
				var_353_int += 1;
			}
	}
...
void func_625(bool var_483_bool, float var_484_float)
{
