...
maintask task_0
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, object var_3_object, string var_4_string)
	{
		...
		if(var_4_string == "place_boy") {
			...
			func_216(var_21_object, var_22_object, "pt_b4q02_boy", "pers_boy", "b4q02_boy.xml");
			...
			func_198(var_40_object, var_41_object, "pt_b4q02_samopal", "scripted_container", "b4q02_samopal.xml");
			var_1_object = var_40_object;
			object var_58_object; object var_59_object;
			var_12_object = var_59_object;
			func_198(var_58_object, var_59_object, "pt_b4q02_samopal_ammo", "scripted_container", "b4q02_samopal_ammo.xml");
...
void func_192(object var_6_object)
{
	object var_8_object;
...
void func_129(void)
{
	...
	func_137(var_15_int, var_16_bool, var_17_cvector, var_18_cvector);
}


void func_162(int var_9_int)
{
	float var_10_float; float var_11_float;
	@GetGameTime(var_11_float);
	if(var_11_float >= (var_9_int * 24)) {
		func_137(var_3_object, var_9_int, var_10_float, var_11_float);
	} else {
...
void func_198(object var_40_object, object var_41_object, string var_42_string, string var_43_string, string var_44_string)
{
...
void func_281(bool var_81_bool, object var_82_object, int var_83_int)
{
...
void func_137(object var_0_object, object var_1_object, object var_2_object, object var_3_object)
{
	if(var_0_object != 0)
		var_0_object->Remove(); //@t
	if(var_1_object != 0)
...
void func_234(object var_20_object)
{
...
void func_268(object var_90_object)
{
...
void func_216(object var_21_object, object var_22_object, string var_23_string, string var_24_string, string var_25_string)
{
...
{
	@SetVariable("b4q02", -1);
	func_137(var_4_int, var_5_float, var_6_int, var_7_int);
}


void func_186(object var_31_object)
{
...
void func_255(void)
{
	...
	func_281(var_81_bool, var_82_object, 213);
}
EMIT "Stack[-1] = 0";
