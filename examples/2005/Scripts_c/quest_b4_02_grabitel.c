...
void func_0(bool var_59_bool, object var_60_object, bool var_82_bool, object var_683_object)
{
	...
	TaskCall(2);
	func_163(var_681_bool, var_682_object);
	TaskReturn();
...
void func_2067(float var_86_float)
{
...
void func_543(bool var_0_bool, object var_1_object, bool var_488_bool, float var_489_float)
{
	...
	if(var_495_bool != 0) {
		...
		func_884(var_497_string);
		bool var_627_bool;
		func_1703(var_627_bool, var_0_bool);
		if(!var_627_bool) { //@nz
			@StopAsync();
			var_488_bool = false;
			return 8;
		...
		func_504(var_497_string, var_630_float, var_631_int);
		var_496_int = 1;
		...
		for(;;) {
			...
			if(!var_495_bool) { //@nz
				...
				func_884(var_497_string);
				bool var_653_bool;
				func_1703(var_653_bool, var_0_bool);
				if(!var_653_bool) { //@nz
					@StopAsync();
					var_488_bool = false;
					return 8;
				...
				func_504(var_497_string, var_656_float, var_657_int);
				var_496_int += 1;
			}
	}
...
void func_37(bool var_0_bool, bool var_80_bool, object var_81_object, object var_198_object)
{
	...
	func_2311(var_140_cvector, var_141_cvector, var_142_cvector, 2000.0);
...
void func_2097(bool var_613_bool)
{
	bool var_615_bool;
...
void func_2103(string var_35_string, int var_36_int)
{
...
// @pe
void func_2127(object var_11_object)
{
...
void func_1631(bool var_602_bool, object var_603_object)
{
	object var_607_object;
	var_603_object = var_607_object;
	bool var_606_bool;
	func_1524(var_606_bool, var_607_object, "health");
	if(!var_606_bool) { //@nz
		var_602_bool = false;
		return 2;
	}
	...
	func_1519(var_611_bool, var_612_object);
	if(var_611_bool != 0) {
		bool var_613_bool;
...
// @pe
void func_2172(bool var_15_bool, object var_16_object)
{
...
// @pe
void func_2179(object var_51_object)
{
...
// @pe
void func_2191(object var_14_object)
{
	int var_15_int;
	func_2185(var_15_int);
	if(var_15_int == 1)
...
void func_2204(int var_18_int, int var_19_int)
{
...
void func_682(bool var_643_bool, float var_644_float)
{
	...
	@WaitForAnimEnd();
	func_884(var_648_bool);
}


void func_2235(string var_61_string)
{
...
// @pe
void func_199(object var_597_object, float var_598_float)
{
	...
	for(;;) {
		...
		if(var_42_bool != 0) {
			...
			if(var_20_int == 0) {
				...
				func_2103(var_51_string, var_52_int);
...
void func_2276(void)
{
	...
	int var_51_int;
	func_2306(var_51_int, "grabitel_mark");
	bool var_16_bool;
		...
		if(var_263_bool != 0) {
			...
			if(var_226_float >= (var_207_float * var_207_float)) {
				...
				if(var_387_bool != 0) {
					...
					@StopAsync();
					bool var_662_bool;
					func_841(var_229_float, var_662_bool);
					var_663_bool = !var_662_bool; //@nz
					if(var_663_bool == 0) goto Label_442;
					bool var_664_bool;
					func_1703(var_664_bool, var_0_bool);
					if(!var_664_bool) { //@nz
						goto Label_452;
					}
					var_0_bool->GetPFPosition(var_220_cvector); //@t
					...
					func_543(var_228_bool, var_229_float, var_669_bool, var_670_float);
					var_671_bool = !var_669_bool; //@nz
					if(var_671_bool == 0) goto Label_442;
					goto Label_452;
			}
				bool var_672_bool; float var_673_float;
				var_207_float = var_673_float;
				func_543(var_228_bool, var_229_float, var_672_bool, var_673_float);
				if(!var_672_bool) { //@nz
					goto Label_452;
				}
				var_223_bool = true;
...
void func_2306(int var_30_int, string var_31_string)
{
	int var_33_int;
...
void func_2311(cvector var_140_cvector, cvector var_141_cvector, cvector var_142_cvector, float var_143_float)
{
...
void func_2346(object var_52_object)
{
...
// @pe
void func_2364(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_894(bool var_642_bool)
{
	var_642_bool = true;
}
...
void func_504(bool var_0_bool, float var_521_float, int var_522_int)
{
	...
	if(var_526_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_596_int, var_528_float, var_537_float);
