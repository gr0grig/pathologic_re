...
void func_1155(void)
{
	...
	bool var_151_bool;
	func_1371(var_151_bool);
	if(var_151_bool != 0) {
	} else {
		@HasAnimationTrack(var_150_bool, "head");
		if(var_150_bool == 0) goto Label_1171;
		@UnlookAsync("head");
	}
Label_1171:
...
void func_1285(string var_44_string, int var_45_int)
{
...
void func_1292(int var_38_int)
{
	...
	for(;;) {
		...
		func_1285(var_44_string, var_45_int);
...
void func_1172(string var_128_string)
{
...
void func_1179(string var_111_string, bool var_112_bool)
{
...
void func_1185(object var_30_object)
{
	float var_33_float;
...
void func_162(object var_2_object, string var_107_string)
{
	...
	if(var_107_string == "")
		...
		var_112_bool = true;
	func_1179(var_111_string, var_112_bool);
...
// @pe
void func_1315(bool var_95_bool)
{
	int var_97_int;
	func_1268(var_97_int, "oob5GathererWife1");
	if(var_97_int == 0) {
		var_95_bool = true;
		return 0;
	}
...
void func_1203(string var_52_string)
{
	...
	if(var_74_bool == 0) goto Label_1223;
}
...
void func_1087(bool var_28_bool, object var_29_object, float var_30_float)
{
	...
	func_1250(var_55_cvector, (var_44_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_70_bool;
	func_1371(var_70_bool);
	if(var_70_bool != 0) {
	} else {
		@HasAnimationTrack(var_48_bool, "head");
		if(var_48_bool == 0) goto Label_1149;
...
// @pe
void func_1350(object var_17_object)
{
	int var_18_int;
	func_1344(var_18_int);
	if(var_18_int == 1)
...
void func_594(object var_0_object, cvector var_27_cvector, float var_28_float)
{
	...
	func_1250(var_43_cvector, (var_35_cvector - var_36_cvector));
	func_1250(var_41_cvector, (var_43_cvector + (var_37_cvector * 0.75)));
...
void func_1363(int var_76_int)
{
	var_76_int = 518607;
}


void func_1365(int var_75_int)
{
	var_75_int = 518606;
}
...
void func_1367(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png";
}


void func_1369(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_1371(bool var_70_bool)
{
	var_70_bool = false;
}


void func_1244(object var_17_object)
{
	object var_19_object;
	@self(var_19_object);
...
void func_1250(cvector var_45_cvector, cvector var_46_cvector)
{
	...
	for(;;) {
		...
		if(var_51_bool != 0) {
			...
			if(var_31_int == 0) {
				...
				func_1285(var_60_string, var_61_int);
...
void func_1000(object var_17_object, int var_18_int, float var_19_float)
{
	...
	if(var_38_bool != 0) {
		...
		func_1250(var_45_cvector, var_46_cvector);
...
// @pe
void func_1260(float var_76_float, cvector var_77_cvector, cvector var_78_cvector)
{
...
void func_1268(int var_97_int, string var_98_string)
{
	int var_100_int;
...
void func_1273(bool var_22_bool, string var_23_string, string var_24_string)
{
	object var_26_object;
...
void func_765(object var_0_object, bool var_65_bool)
{
	...
	func_1260(var_76_float, var_77_cvector, var_78_cvector);
