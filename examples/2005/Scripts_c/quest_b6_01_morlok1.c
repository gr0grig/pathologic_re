	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool)
	{
		if(1 != 0) {
			...
			if(var_6_int == 21840) {
				...
				if(var_59_bool != 0) {
					bool var_67_bool;
					func_993(var_67_bool, var_1_object);
					if(var_67_bool != 0)
						var_58_bool = true;
				}
				if(var_58_bool != 0) {
				...
				if(var_112_bool != 0) {
					bool var_114_bool;
					func_993(var_114_bool, var_1_object);
					if(!var_114_bool) //@nz
						var_111_bool = true;
				}
				if(var_111_bool != 0) {
...
maintask task_2
{
	...
	Label_647:
		for(;;) {
			...
			if(var_11_bool == 0) goto Label_655;
			@Hold();
		}
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object)
	{
		...
		if(var_33_object == 1) {
			...
			for(;;) {
				...
				bool var_232_bool;
				func_941(var_232_bool, "quest_b6_01", "sacrifice");
				@SetVariable("b6q01", 5);
				func_1072();
				var_29_object = null;
				var_20_object = null;
...
void func_0(object var_0_object, int var_31_int, object var_32_object)
{
	...
	func_809(var_42_bool, var_43_object, 110.0);
	if(!var_42_bool) { //@nz
		var_31_int = -2;
		return 8;
	}
...
void func_1027(bool var_120_bool, object var_121_object)
{
...
void func_901(string var_147_string, bool var_148_bool)
{
...
{
	bool var_9_bool;
	func_1151(var_9_bool);
	if(var_9_bool != 0)
		@lshStopSpeech();
}


void func_914(object var_9_object)
{
...
void func_920(cvector var_69_cvector, cvector var_70_cvector)
{
...
void func_667(object var_0_object)
{
	var_0_object = true;
	bool var_10_bool;
	...
	if(var_11_bool != 0) {
		...
		func_914(var_14_object);
		@RemoveActor(var_14_object);
	}
}


void func_797(bool var_56_bool)
{
	var_56_bool = true;
}
...
void func_930(object var_213_object)
{
...
void func_1059(void)
{
	...
	func_1098(var_34_bool, var_35_object, 265);
}
EMIT "Stack[-1] = 0";


void func_804(bool var_8_bool)
{
	bool var_10_bool;
	@IsLoaded(var_10_bool);
...
void func_936(int var_112_int, string var_113_string)
{
	int var_115_int;
...
void func_809(bool var_42_bool, object var_43_object, float var_44_float)
{
	...
	func_920(var_69_cvector, (var_58_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_84_bool != 0) {
		...
		if(var_62_bool == 0) goto Label_871;
...
void func_941(bool var_232_bool, string var_233_string, string var_234_string)
{
...
void func_1072(void)
{
	...
	@CreateDiaryEntry(var_241_object, 367, 1, 525667);
	bool var_245_bool; object var_246_object;
	var_241_object = var_246_object;
	func_1098(var_245_bool, var_246_object, 265);
}
EMIT "Stack[-1] = 0";


void func_953(string var_37_string, int var_38_int)
{
...
void func_1085(object var_254_object)
{
	object var_256_object;
	@GetDiaryRoot(var_256_object);
	if(!var_256_object) { //@nz
		@Trace("Can't retrieve diary root");
		var_254_object = false;
	}
	var_256_object = var_254_object;
}
EMIT "Stack[-1] = 0";


void func_960(int var_31_int)
{
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_102_object, object var_103_object)
{
	...
	if(1 != 0) {
		...
		if(var_110_bool != 0) {
			bool var_118_bool;
			func_993(var_118_bool, var_1_object);
			if(var_118_bool != 0)
				var_109_bool = true;
		}
		if(var_109_bool != 0) {
			...
			var_0_object->AddReply(520635, -1, 21844); //@t
					...
					if(var_176_bool != 0) {
						bool var_178_bool;
						func_993(var_178_bool, var_1_object);
						if(!var_178_bool) //@nz
							var_175_bool = true;
					}
...
void func_1098(bool var_245_bool, object var_246_object, int var_247_int)
{
	object var_254_object;
	func_1085(var_254_object);
	object var_251_object;
	var_254_object = var_251_object;
	object var_252_object;
	var_251_object->Find(var_247_int, var_252_object);
	if(!var_252_object) { //@nz
		@Trace("Can't find diary parent with id: " + var_247_int);
		var_245_bool = false;
	}
	var_252_object->AddChild(var_246_object);
	@SendWorldWndMessage(7);
	int var_253_int;
	var_246_object->GetCategory(var_253_int);
	@SetDiarySection(var_253_int);
	var_245_bool = false;
}
EMIT "Stack[-2] = 0";
EMIT "Stack[-3] = 0";
		...
		if(var_44_bool != 0) {
			...
			if(var_24_int == 1) {
				...
				goto Label_794;
					...
					if(var_57_bool == 0) goto Label_789;
			}
		}
	Label_794:
		for(;;) {
...
// @pe
void func_983(object var_13_object)
{
...
// @pe
void func_993(bool var_118_bool, object var_119_object)
{
	object var_121_object;
	var_119_object = var_121_object;
	bool var_120_bool;
	func_1027(var_120_bool, var_121_object);
	if(var_120_bool != 0) {
		var_118_bool = true;
		return 0;
	}
...
// @pe
void func_1003(bool var_183_bool)
{
	int var_185_int;
	func_936(var_185_int, "oob6Morlok1");
	if(var_185_int == 0) {
		var_183_bool = true;
		return 0;
	}
...
void func_877(void)
{
	...
	bool var_207_bool;
	func_1151(var_207_bool);
	if(var_207_bool != 0) {
	} else {
		@HasAnimationTrack(var_206_bool, "head");
		if(var_206_bool == 0) goto Label_893;
		@UnlookAsync("head");
	}
Label_893:
...
// @pe
void func_1015(bool var_110_bool)
{
	int var_112_int;
	func_936(var_112_int, "b6q01");
	if(var_112_int == 4)
		var_110_bool = true;
	var_110_bool = false;
}
...
void func_1143(int var_90_int)
{
	var_90_int = 521048;
}


void func_1145(int var_89_int)
{
	var_89_int = 521047;
}


void func_1147(string var_91_string)
{
	var_91_string = "ui/NPC_Black.png";
}


void func_1149(string var_92_string)
{
	var_92_string = "ui/NPC_Black_b.png";
}


void func_894(string var_164_string)
{
...
void func_1151(bool var_84_bool)
{
	var_84_bool = false;
}
