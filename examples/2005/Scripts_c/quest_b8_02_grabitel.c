...
void func_0(bool var_0_bool, bool var_92_bool, object var_93_object, object var_210_object)
{
	...
	func_2773(var_152_cvector, var_153_cvector, var_154_cvector, 2000.0);
...
void func_3074(int var_66_int, int var_67_int)
{
...
void func_3105(string var_140_string)
{
...
void func_3146(void)
{
	...
	int var_130_int;
	func_3215(var_130_int, "grabitel_mark");
	bool var_64_bool;
...
void func_2135(bool var_612_bool, object var_613_object)
{
	object var_617_object;
	var_613_object = var_617_object;
	bool var_616_bool;
	func_2028(var_616_bool, var_617_object, "health");
	if(!var_616_bool) { //@nz
		var_612_bool = false;
		return 2;
	}
	...
	func_2023(var_621_bool, var_622_object);
	if(var_621_bool != 0) {
		bool var_623_bool;
...
void func_3215(int var_78_int, string var_79_string)
{
	int var_81_int;
...
void func_2713(float var_29_float)
{
...
void func_2723(object var_109_object)
{
	bool var_111_bool;
...
void func_2743(bool var_623_bool)
{
	bool var_625_bool;
...
void func_2749(string var_73_string, int var_74_int)
{
		...
		if(var_275_bool != 0) {
			...
			if(var_238_float >= (var_219_float * var_219_float)) {
				...
				if(var_397_bool != 0) {
					...
					bool var_674_bool;
					func_2207(var_674_bool, var_0_bool);
					if(!var_674_bool) { //@nz
						goto Label_415;
					}
					var_0_bool->GetPFPosition(var_232_cvector); //@t
...
void func_2773(cvector var_152_cvector, cvector var_153_cvector, cvector var_154_cvector, float var_155_float)
{
...
void func_2808(bool var_26_bool, object var_27_object)
{
	bool var_32_bool; object var_33_object;
...
void func_2833(bool var_19_bool, object var_20_object)
{
	float var_25_float;
...
// @pe
void func_2878(bool var_17_bool, object var_18_object)
{
	object var_20_object;
...
// @pe
void func_2885(object var_114_object)
{
...
// @pe
void func_2902(bool var_17_bool, object var_18_object)
{
	object var_20_object;
	var_18_object = var_20_object;
	bool var_19_bool;
...
// @pe
void func_2909(object var_114_object)
{
	object var_116_object;
	var_114_object = var_116_object;
	TaskCall(7);
...
void func_2926(object var_20_object)
{
	...
	for(;;) {
		...
		if(var_80_bool != 0) {
			...
			if(var_58_int == 0) {
				...
				func_2749(var_89_string, var_90_int);
...
// @pe
void func_2939(object var_19_object)
{
	object var_20_object;
...
void func_2967(bool var_19_bool, object var_20_object, object var_21_object)
{
...
// @pe
void func_3000(object var_17_object)
{
	object var_19_object;
...
void func_3055(int var_134_int)
{
	int var_136_int;
...
// @pe
void func_3061(object var_20_object)
{
	int var_21_int;
	func_3055(var_21_int);
	if(var_21_int == 1)
...
void func_506(bool var_0_bool, object var_1_object, bool var_498_bool, float var_499_float)
{
	...
	if(var_505_bool != 0) {
		...
		func_847(var_507_string);
		bool var_637_bool;
		func_2207(var_637_bool, var_0_bool);
		if(!var_637_bool) { //@nz
			@StopAsync();
			var_498_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_505_bool) { //@nz
				...
				func_847(var_507_string);
				bool var_663_bool;
				func_2207(var_663_bool, var_0_bool);
				if(!var_663_bool) { //@nz
					@StopAsync();
					var_498_bool = false;
					return 8;
