	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool)
	{
		if(1 != 0) {
			...
			if(var_14_object == 22725) {
				...
				if(var_132_bool != 0) {
					bool var_134_bool;
					func_2479(var_134_bool, var_1_object);
					if(var_134_bool != 0)
						var_131_bool = true;
				}
				if(var_131_bool != 0) {
...
maintask task_5
{
	...
	void OnAttacked(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, object var_5_object, int var_6_int, int var_7_int, bool var_8_bool, float var_9_float, int var_10_int, bool var_11_bool, object var_12_object, bool var_13_bool, object var_14_object)
	{
		...
		if(var_16_bool != 0) {
			bool var_18_bool;
			func_2392(var_18_bool, "quest_b9_01", "factory_fight");
		}
	}
...
void func_2048(object var_18_object, int var_19_int, float var_20_float)
{
	...
	if(var_39_bool != 0) {
		...
		func_2304(var_46_cvector, var_47_cvector);
...
void func_2304(cvector var_46_cvector, cvector var_47_cvector)
{
...
void func_2570(object var_42_object)
{
...
// @pe
void func_2314(float var_437_float, float var_438_float, float var_439_float)
{
...
// @pe
void func_2321(float var_158_float, float var_159_float, float var_160_float, float var_161_float)
{
...
void func_2583(bool var_33_bool, object var_34_object, int var_35_int)
{
	object var_42_object;
	func_2570(var_42_object);
...
void func_2332(int var_111_int, string var_112_string)
{
	int var_114_int;
...
{
	func_2404(var_0_object);
}


// @pe
void func_2337(bool var_129_bool, object var_130_object, float var_131_float)
{
...
void func_1318(int var_460_int)
{
	var_460_int = 0;
}
...
void func_1327(bool var_485_bool)
{
	var_485_bool = true;
}
...
{
	bool var_17_bool;
	func_2392(var_17_bool, "quest_b9_01", "doberman_dead");
	...
	if(var_125_bool != 0) {
		...
		func_2337(var_129_bool, var_130_object, -0.03);
	}
	for(;;) {
		@Hold();
	}
...
void func_1844(bool var_140_bool, object var_141_object, string var_142_string, float var_143_float, float var_144_float, float var_145_float)
{
	...
	func_2321(var_158_float, (var_147_float + var_143_float), var_160_float, var_161_float);
...
void func_2628(int var_105_int)
{
	int var_107_int;
...
void func_2372(float var_455_float)
{
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_88_object, object var_89_object)
{
	...
	var_3_string = false;
	if(1 != 0) {
		func_194(var_89_object, "Neutral");
		var_0_object->SetMessage(521564); //@t
		var_0_object->ClearReplies(); //@t
		...
		if(var_130_bool != 0) {
			bool var_132_bool;
			func_2479(var_132_bool, var_1_object);
			if(var_132_bool != 0)
				var_129_bool = true;
		}
		if(var_129_bool != 0) {
...
// @pe
void func_2634(object var_18_object)
{
	int var_19_int;
	func_2628(var_19_int);
	if(var_19_int == 1)
...
void func_1866(float var_399_float, object var_400_object, float var_401_float, int var_402_int)
{
	...
	float var_437_float;
	func_2314(var_437_float, ((var_412_int + var_414_int) / 100.0), (float)1);
	float var_415_float;
	...
	float var_447_float;
	func_2321(var_447_float, (var_416_float - var_417_float), (float)0, (float)1);
...
void func_2382(float var_136_float)
{
...
void func_2647(string var_111_string)
{
...
void func_1111(bool var_486_bool, float var_487_float)
{
	...
	@WaitForAnimEnd();
	func_1313(var_491_bool);
}


void func_2392(bool var_17_bool, string var_18_string, string var_19_string)
{
...
void func_2141(bool var_28_bool, object var_29_object, float var_30_float)
{
	...
	func_2304(var_55_cvector, (var_44_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_70_bool;
	func_2733(var_70_bool);
	if(var_70_bool != 0) {
	} else {
		@HasAnimationTrack(var_48_bool, "head");
		if(var_48_bool == 0) goto Label_2203;
...
void func_2404(object var_123_object)
{
	bool var_125_bool;
...
void func_2424(object var_83_object)
{
	int var_86_int;
...
void func_2447(void)
{
	...
	func_2557();
	bool var_69_bool;
	func_2392(var_69_bool, "quest_b9_01", "danko_free");
}
		...
		if(var_87_bool != 0) {
			...
			if(var_48_float >= (var_29_float * var_29_float)) {
				...
				if(var_247_bool != 0) {
					...
					@StopAsync();
					bool var_505_bool;
					func_1270(var_51_float, var_505_bool);
					var_506_bool = !var_505_bool; //@nz
					if(var_506_bool == 0) goto Label_873;
					bool var_507_bool;
					func_1980(var_507_bool, var_0_object);
					if(!var_507_bool) { //@nz
						goto Label_883;
					}
					var_0_object->GetPFPosition(var_42_cvector); //@t
					...
					func_974(var_50_bool, var_51_float, var_512_bool, var_513_float);
					var_514_bool = !var_512_bool; //@nz
					if(var_514_bool == 0) goto Label_873;
					goto Label_883;
			}
				bool var_515_bool; float var_516_float;
				var_29_float = var_516_float;
				func_974(var_50_bool, var_51_float, var_515_bool, var_516_float);
				if(!var_515_bool) { //@nz
					goto Label_883;
				}
				var_45_bool = true;
...
void func_2209(void)
{
	...
	bool var_179_bool;
	func_2733(var_179_bool);
	if(var_179_bool != 0) {
	} else {
		@HasAnimationTrack(var_178_bool, "head");
		if(var_178_bool == 0) goto Label_2225;
		@UnlookAsync("head");
	}
Label_2225:
...
// @pe
void func_2467(bool var_117_bool)
{
	int var_119_int;
	func_2332(var_119_int, "b9q01");
	if(var_119_int == 2)
		var_117_bool = true;
	var_117_bool = false;
}
...
void func_2725(int var_76_int)
{
	var_76_int = 518097;
}


void func_2727(int var_75_int)
{
	var_75_int = 518096;
}
...
void func_2729(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png";
}


void func_2731(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_2733(bool var_70_bool)
{
	var_70_bool = false;
}
...
// @pe
void func_2735(object var_15_object)
{
	object var_16_object;
...
// @pe
void func_2479(bool var_132_bool, object var_133_object)
{
	object var_135_object;
	var_133_object = var_135_object;
	bool var_134_bool;
	func_2537(var_134_bool, var_135_object);
	if(var_134_bool != 0) {
		var_132_bool = true;
		return 0;
	}
...
void func_2226(string var_164_string)
{
...
void func_2233(string var_99_string, bool var_100_bool)
{
...
// @pe
void func_2489(bool var_109_bool)
{
	int var_111_int;
	func_2332(var_111_int, "oob9Doberman1");
	if(var_111_int == 0) {
		var_109_bool = true;
		return 0;
	}
...
void func_2239(object var_147_object)
{
	float var_150_float;
...
// @pe
void func_194(object var_2_object, string var_95_string)
{
	bool var_96_bool;
	func_2733(var_96_bool);
	if(!var_96_bool) //@nz
		return 0;
	...
	if(var_95_string == "")
		...
		var_100_bool = true;
	func_2233(var_99_string, var_100_bool);
...
// @pe
void func_2501(bool var_140_bool)
{
	int var_142_int;
	func_2332(var_142_int, "oob9Doberman2");
	if(var_142_int == 0) {
		var_140_bool = true;
		return 0;
	}
...
void func_974(object var_0_object, object var_1_object, bool var_348_bool, float var_349_float)
{
	...
	if(var_355_bool != 0) {
		...
		func_1313(var_357_string);
		bool var_470_bool;
		func_1980(var_470_bool, var_0_object);
		if(!var_470_bool) { //@nz
			@StopAsync();
			var_348_bool = false;
			return 8;
		...
		func_935(var_357_string, var_473_float, var_474_int);
		var_356_int = 1;
		...
		for(;;) {
			...
			if(!var_355_bool) { //@nz
				...
				func_1313(var_357_string);
				bool var_496_bool;
				func_1980(var_496_bool, var_0_object);
				if(!var_496_bool) { //@nz
					@StopAsync();
					var_348_bool = false;
					return 8;
				...
				func_935(var_357_string, var_499_float, var_500_int);
				var_356_int += 1;
			}
	}
...
void func_2257(string var_46_string)
{
	...
	if(var_68_bool == 0) goto Label_2277;
}


// @pe
void func_2513(bool var_183_bool)
{
	int var_185_int;
	func_2332(var_185_int, "b1q03_retreat");
	if(var_185_int != 0) {
		var_183_bool = true;
		return 0;
	}
...
// @pe
void func_2525(bool var_149_bool)
{
	int var_151_int;
	func_2332(var_151_int, "b9q01DankoFree");
	if(var_151_int != 0) {
		var_149_bool = true;
		return 0;
	}
...
void func_2537(bool var_134_bool, object var_135_object)
{
	int var_137_int;
	var_135_object->GetItemCountOfType(var_137_int, "rifle_ammo");
	var_134_bool = var_137_int >= 30;
}
...
void func_2544(void)
{
	...
	func_2583(var_33_bool, var_34_object, 297);
}
EMIT "Stack[-1] = 0";
...
void func_2298(object var_82_object)
{
...
void func_2557(void)
{
	...
	func_2583(var_66_bool, var_67_object, 297);
}
EMIT "Stack[-1] = 0";
