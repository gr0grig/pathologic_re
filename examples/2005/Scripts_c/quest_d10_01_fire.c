		...
		while(var_11_float < var_10_float) {
			...
			for(;;) {
				if(var_12_float < var_10_float) {
					...
					var_35_float = GetByIndex(var_13_cvector, 0);
					var_11_float = var_35_float;
					SetByIndex(var_13_cvector, 0) = var_35_float;
					var_36_float = GetByIndex(var_13_cvector, 1);
					SetByIndex(var_13_cvector, 1) = (float)0;
					var_37_float = GetByIndex(var_13_cvector, 2);
					var_12_float = var_37_float;
					SetByIndex(var_13_cvector, 2) = var_37_float;
...
Label_0:
	@Hold();
	bool var_21_bool;
	func_124(var_21_bool);
	if(!var_21_bool) goto Label_0; //@nz
}


void func_129(object var_10_object)
{
...
void func_122(bool var_9_bool)
{
	var_9_bool = true;
}


void func_124(bool var_17_bool)
{
	bool var_19_bool;
