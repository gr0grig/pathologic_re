...
maintask task_0
{
	...
	{
		object var_6_object;
		func_250(var_6_object);
		var_0_object = var_6_object;
		object var_9_object;
		func_250(var_9_object);
		...
		if(var_4_string == "place_sanitars") {
			...
			for(;;) {
				...
				if(!var_12_bool) { //@nz
					...
					func_292(var_52_object, var_53_object, ("pt_b11q04_sanitar" + var_11_int), "pers_sanitar", "b11q04_sanitar.xml");
					var_2_object->add(var_52_object); //@t
					var_11_int += 1;
				}
				object var_34_object; object var_35_object;
				var_10_object = var_35_object;
				func_274(var_34_object, var_35_object, "pt_b11q04_corpse", "scripted", "b11q04_corpse.xml");
...
void func_256(object var_10_object, object var_11_object, string var_12_string, string var_13_string, string var_14_string)
{
...
void func_160(void)
{
	...
	if(var_7_int != 1000)
		func_174();
	int var_6_int;
	func_201(var_6_int, var_7_int);
}


void func_292(object var_52_object, object var_53_object, string var_54_string, string var_55_string, string var_56_string)
{
...
void func_201(object var_1_object, object var_2_object)
{
	func_190(var_69_float, var_70_float);
	func_310(var_2_object);
	if(var_1_object != 0)
		@Trigger(var_1_object, "cleanup");
	object var_101_object;
	func_244(var_101_object);
	@RemoveActor(var_101_object);
}


void func_331(object var_74_object, string var_75_string)
{
	...
	if(var_74_object != 0) {
		...
		for(;;) {
			if(!(var_80_int < var_79_int)) goto Label_349;
...
void func_274(object var_34_object, object var_35_object, string var_36_string, string var_37_string, string var_38_string)
{
...
void func_244(object var_101_object)
{
...
void func_310(object var_88_object)
{
...
void func_250(object var_6_object)
{
	object var_8_object;
