...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object, bool var_12_bool)
	{
		if(1 != 0) {
			func_579();
			if(var_11_object == 35721) {
				func_132(var_12_bool, "Neutral");
				var_0_object->SetMessage(534134); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(534135, -1, 35722); //@t
				var_0_object->AddReply(534444, -1, 36077); //@t
				return 0;
			}
			var_3_string = true;
			bool var_36_bool;
			func_651(var_36_bool);
			if(var_36_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	{
		func_357(var_10_bool, var_11_object);
	...
	{
		func_357(var_9_object, var_10_bool);
		bool var_14_bool = false;
		if(var_5_int != 0) {
			bool var_16_bool;
			func_290(var_16_bool);
			if(var_16_bool != 0)
				var_14_bool = true;
		}
		if(var_14_bool != 0) {
			object var_17_object;
			func_586(var_17_object);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, int var_11_int)
	{
		if(var_11_int == 10) {
			bool var_14_bool;
			func_319(var_9_object, var_10_bool, var_11_int, var_14_bool);
			if(var_14_bool != 0) {
				if(!var_2_object) { //@nz
					func_568(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_15_int, object var_16_object)
{
	...
	func_470(var_26_bool, var_27_object, 110.0);
	if(!var_26_bool) { //@nz
		var_15_int = -2;
		return 8;
	}
	...
	func_647(var_75_string);
	var_22_object->SetPhoto(var_75_string);
	string var_76_string;
	func_649(var_76_string);
...
void func_132(object var_2_object, string var_93_string)
{
	...
	if(var_93_string == "")
		...
		var_98_bool = true;
	func_562(var_97_string, var_98_bool);
...
void func_647(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen2.png";
}


void func_649(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen2_b.png";
}


void func_651(bool var_68_bool)
{
	var_68_bool = false;
}
...
void func_538(void)
{
	...
	bool var_129_bool;
	func_651(var_129_bool);
	if(var_129_bool != 0) {
	} else {
		@HasAnimationTrack(var_128_bool, "head");
		if(var_128_bool == 0) goto Label_554;
		@UnlookAsync("head");
	}
Label_554:
...
void func_290(bool var_16_bool)
{
	var_16_bool = true;
}
...
// @pe
void func_292(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_22_float, float var_23_float)
{
	bool var_24_bool;
	func_465(var_24_bool);
	if(!var_24_bool) //@nz
		return 0;
...
void func_555(string var_114_string)
{
...
void func_562(string var_97_string, bool var_98_bool)
{
...
void func_568(object var_28_object)
{
	float var_31_float;
...
void func_319(object var_0_object, object var_1_object, bool var_4_bool, bool var_14_bool)
{
	if(var_4_bool == null)
		var_14_bool = false;
	float var_18_float;
	func_457(var_18_float, var_4_bool);
...
void func_450(bool var_70_bool)
{
	var_70_bool = true;
}
...
void func_457(float var_18_float, object var_19_object)
{
...
void func_586(object var_17_object)
{
...
void func_592(cvector var_53_cvector, cvector var_54_cvector)
{
...
void func_465(bool var_15_bool)
{
	bool var_17_bool;
...
void func_213(float var_11_float, float var_12_float)
{
	
Label_214:
	for(;;) {
		bool var_15_bool;
		func_465(var_15_bool);
		var_18_bool = !var_15_bool; //@nz
		if(var_18_bool == 0) goto Label_222;
		@Hold();
	}
...
Label_222:
	...
	float var_13_float;
	func_292(var_10_bool, var_22_float, var_23_float, var_13_float, var_14_float, var_22_float, var_23_float);
	@sync();
	goto Label_214;
}
EMIT "Return(); Pop(2)";
...
void func_470(bool var_26_bool, object var_27_object, float var_28_float)
{
	...
	func_592(var_53_cvector, (var_42_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_68_bool;
	func_651(var_68_bool);
	if(var_68_bool != 0) {
	} else {
		@HasAnimationTrack(var_46_bool, "head");
		if(var_46_bool == 0) goto Label_532;
...
void func_602(string var_51_string, int var_52_int)
{
...
void func_609(int var_45_int)
{
	...
	for(;;) {
		...
		func_602(var_51_string, var_52_int);
...
// @pe
void func_357(object var_2_object, string var_3_string)
{
	func_452();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_238(int var_5_int)
{
	...
	if(!var_15_bool) { //@nz
		bool var_18_bool;
		func_290(var_18_bool);
		if(var_18_bool != 0)
			var_16_bool = true;
	}
	if(var_16_bool != 0) {
		object var_19_object;
		func_586(var_19_object);
		@RemoveActor(var_19_object);
	}
}


void func_626(int var_77_int)
{
	int var_79_int;
		...
		if(var_58_bool != 0) {
			...
			if(var_38_int == 1) {
				...
				goto Label_447;
					...
					bool var_70_bool;
					func_450(var_70_bool);
					var_71_bool = !var_70_bool; //@nz
					if(var_71_bool == 0) goto Label_442;
			}
		}
	Label_447:
		for(;;) {
