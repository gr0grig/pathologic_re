		...
		if(1 != 0) {
			...
			if(var_11_object == 35729) {
				...
				if(var_46_bool != 0) {
					...
					var_0_object->SetMessage(534142); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(534435, 36067, 36066); //@t
					var_0_object->AddReply(534437, 36067, 36068); //@t
					return 0;
				}
				func_162(var_12_bool, "Neutral");
				var_0_object->SetMessage(534144); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(534145, -1, 35732); //@t
				var_0_object->AddReply(534443, -1, 36076); //@t
				return 0;
			}
			if(var_11_object == 36067) {
				func_162(var_12_bool, "Neutral");
				var_0_object->SetMessage(534436); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(534438, 36070, 36069); //@t
				var_0_object->AddReply(534442, 36070, 36074); //@t
				return 0;
			}
			if(var_11_object == 36070) {
				func_162(var_12_bool, "Neutral");
				var_0_object->SetMessage(534439); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(534143, -1, 35730); //@t
				return 0;
			}
			var_3_string = true;
			bool var_102_bool;
			func_846(var_102_bool);
			if(var_102_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	{
		func_466(var_10_bool, var_11_object);
	...
	{
		func_466(var_9_object, var_10_bool);
		bool var_14_bool = false;
		if(var_5_int != 0) {
			bool var_16_bool;
			func_399(var_16_bool);
			if(var_16_bool != 0)
				var_14_bool = true;
		}
		if(var_14_bool != 0) {
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, int var_11_int)
	{
		if(var_11_int == 10) {
			bool var_14_bool;
			func_428(var_9_object, var_10_bool, var_11_int, var_14_bool);
			if(var_14_bool != 0) {
				if(!var_2_object) { //@nz
					func_677(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_15_int, object var_16_object)
{
	...
	func_579(var_26_bool, var_27_object, 70.0);
	if(!var_26_bool) { //@nz
		var_15_int = -2;
		return 8;
	}
	...
	func_842(var_75_string);
	var_22_object->SetPhoto(var_75_string);
	string var_76_string;
	func_844(var_76_string);
...
void func_647(void)
{
	...
	bool var_149_bool;
	func_846(var_149_bool);
	if(var_149_bool != 0) {
	} else {
		@HasAnimationTrack(var_148_bool, "head");
		if(var_148_bool == 0) goto Label_663;
		@UnlookAsync("head");
	}
Label_663:
...
void func_780(object var_35_object)
{
...
void func_399(bool var_16_bool)
{
	var_16_bool = true;
}
...
// @pe
void func_401(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_22_float, float var_23_float)
{
	bool var_24_bool;
	func_574(var_24_bool);
	if(!var_24_bool) //@nz
		return 0;
...
void func_664(string var_126_string)
{
...
void func_793(bool var_26_bool, object var_27_object, int var_28_int)
{
	object var_35_object;
	func_780(var_35_object);
...
void func_671(string var_109_string, bool var_110_bool)
{
...
void func_162(object var_2_object, string var_105_string)
{
	...
	if(var_105_string == "")
		...
		var_110_bool = true;
	func_671(var_109_string, var_110_bool);
	var_2_object = var_105_string;
	
}


void func_677(object var_28_object)
{
	float var_31_float;
...
void func_428(object var_0_object, object var_1_object, bool var_4_bool, bool var_14_bool)
{
	if(var_4_bool == null)
		var_14_bool = false;
	float var_18_float;
	func_566(var_18_float, var_4_bool);
...
void func_559(bool var_70_bool)
{
	var_70_bool = true;
}
...
void func_566(float var_18_float, object var_19_object)
{
...
void func_701(cvector var_53_cvector, cvector var_54_cvector)
{
...
void func_322(float var_11_float, float var_12_float)
{
...
Label_323:
	for(;;) {
		...
		if(var_18_bool == 0) goto Label_331;
		@Hold();
	}
...
Label_331:
	...
	float var_13_float;
	func_401(var_10_bool, var_22_float, var_23_float, var_13_float, var_14_float, var_22_float, var_23_float);
	@sync();
	goto Label_323;
}
EMIT "Return(); Pop(2)";
...
void func_579(bool var_26_bool, object var_27_object, float var_28_float)
{
	...
	func_701(var_53_cvector, (var_42_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_68_bool;
	func_846(var_68_bool);
	if(var_68_bool != 0) {
	} else {
		@HasAnimationTrack(var_46_bool, "head");
		if(var_46_bool == 0) goto Label_641;
...
void func_838(int var_74_int)
{
	var_74_int = 531557;
}


void func_711(int var_95_int, string var_96_string)
{
	int var_98_int;
...
void func_840(int var_73_int)
{
	var_73_int = 531556;
}


void func_842(string var_75_string)
{
...
void func_844(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen1_b.png";
}


void func_716(string var_51_string, int var_52_int)
{
...
void func_846(bool var_68_bool)
{
	var_68_bool = false;
}
...
// @pe
void func_466(object var_2_object, string var_3_string)
{
	func_561();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_723(int var_45_int)
{
	...
	for(;;) {
		...
		func_716(var_51_string, var_52_int);
...
void func_347(int var_5_int)
{
	...
	if(!var_15_bool) { //@nz
		bool var_18_bool;
		func_399(var_18_bool);
		if(var_18_bool != 0)
			var_16_bool = true;
	}
	if(var_16_bool != 0) {
		object var_19_object;
		func_695(var_19_object);
		...
		if(var_58_bool != 0) {
			...
			if(var_38_int == 1) {
				...
				goto Label_556;
					...
					bool var_70_bool;
					func_559(var_70_bool);
					var_71_bool = !var_70_bool; //@nz
					if(var_71_bool == 0) goto Label_551;
			}
		}
	Label_556:
		for(;;) {
...
void func_746(void)
{
	@SetVariable("d10q03", 2);
	func_767();
}


// @pe
void func_755(bool var_93_bool)
{
	int var_95_int;
	func_711(var_95_int, "ood10Salesman1");
	if(var_95_int == 0) {
		var_93_bool = true;
		return 0;
	}
...
{
	object var_22_object;
	@CreateDiaryEntry(var_22_object, 674, 2, 534159);
	bool var_26_bool; object var_27_object;
	var_22_object = var_27_object;
	func_793(var_26_bool, var_27_object, 672);
}
EMIT "Stack[-1] = 0";
