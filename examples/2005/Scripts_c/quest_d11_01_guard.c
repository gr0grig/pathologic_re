...
task task_0
{
	...
	// @pe
		...
		var_97_object = var_99_object;
			bool var_98_bool;
		func_1171(var_98_bool, var_99_object);
		if(!var_98_bool) { //@nz
...
task task_4
{
	void OnHear(object actor, object var_1_object, bool var_2_bool, object var_3_object, object var_4_object, bool var_5_bool, cvector var_6_cvector, cvector var_7_cvector, object var_8_object)
	{
		...
		func_1863(var_46_bool, var_47_object);
		if(!var_46_bool) { //@nz
...
void OnHit2(object actor, object var_1_object, bool var_2_bool, object var_3_object, object var_4_object, bool var_5_bool, cvector var_6_cvector, cvector var_7_cvector, object var_8_object, int var_9_int, float var_10_float, float var_11_float, cvector var_12_cvector, cvector var_13_cvector)
{
	...
	func_1307(var_16_float, var_17_cvector, var_18_cvector);
}
...
void func_0(object var_0_object, object var_127_object)
{
	...
	for(;;) {
		...
		if(var_133_bool != 1) {
			bool var_134_bool;
			func_1171(var_134_bool, var_127_object);
...
void func_1025(cvector var_42_cvector, object var_43_object)
{
...
void func_1799(object var_127_object)
{
	...
	func_1040(var_134_bool, var_135_object);
	if(var_134_bool != 0) {
		object var_138_object;
		func_1467(var_138_object);
		@ReportReputationChange(var_135_object, var_138_object, 0.0);
	}
}


void func_1032(float var_367_float, object var_368_object)
{
...
void func_1547(float var_302_float)
{
...
void func_1040(bool var_9_bool, object var_10_object)
{
	bool var_12_bool;
...
void func_1171(bool var_13_bool, object var_14_object)
{
	object var_18_object;
	...
	func_1045(var_35_bool, var_36_object, "noaccess");
	if(!var_35_bool) { //@nz
		var_13_bool = true;
		return 2;
	}
...
void func_1557(object var_145_object)
{
	bool var_147_bool;
...
void func_1045(bool var_35_bool, object var_36_object, string var_37_string)
{
...
void func_1943(bool var_9_bool, object var_10_object)
{
...
void func_1307(object var_14_object, cvector var_17_cvector, cvector var_18_cvector)
{
...
// @pe
void func_668(object var_9_object)
{
	func_1781();
...
// @pe
void func_1823(object var_142_object)
{
	object var_143_object;
	var_142_object = var_143_object;
	func_1799(var_143_object);
	object var_144_object;
	var_142_object = var_144_object;
	func_1788(var_144_object, true);
}


void func_287(object var_0_object, object var_1_object, bool var_2_bool, object var_136_object, bool var_137_bool)
{
...
Label_313:
	for(;;) {
		bool var_162_bool;
		func_1171(var_162_bool, var_0_object);
		if(var_162_bool != 0) {
			@CanSee(var_144_bool, var_0_object);
			if(var_144_bool != 0) {
				func_1557(var_0_object);
				func_467(var_144_bool);
			} else {
				func_1321(var_0_object);
				var_2_bool = true;
				@PlayAnimation("all", "hunt");
				@WaitForAnimEnd(var_143_bool);
				if(!var_143_bool) { //@nz
					if(var_1_object != null)
						func_462(var_143_bool, var_144_bool);
					@LockAnimationEnd("all", "attack_on");
					goto Label_313;
				}
				bool var_336_bool;
				func_1171(var_336_bool, var_0_object);
				if(!var_336_bool) { //@nz
				} else {
						@CanSee(var_144_bool, var_0_object);
						if(var_144_bool != 0) {
						...
						bool var_350_bool;
						func_1171(var_350_bool, var_0_object);
						var_352_bool = !var_350_bool; //@nz
						if(var_352_bool == 0) goto Label_397;
				}
		}
		Label_419:
			for(;;) {
...
void func_1057(float var_249_float, object var_250_object, float var_251_float, int var_252_int)
{
	int var_259_int; int var_261_int;
	object var_266_object;
	var_250_object = var_266_object;
	bool var_265_bool;
	func_1045(var_265_bool, var_266_object, "health");
	if(!var_265_bool) //@nz
		var_249_float = 0.0;
	bool var_269_bool; object var_270_object;
	func_1045(var_269_bool, var_270_object, "armor");
	if(!var_269_bool) //@nz
		var_259_int = 0;
	else
	...
	func_1045(var_280_bool, var_281_object, var_282_string);
	if(!var_280_bool) //@nz
		var_261_int = 0;
	else
	...
	float var_284_float;
	func_1487(var_284_float, ((var_259_int + var_261_int) / 100.0), (float)1);
	float var_262_float;
...
void func_1321(object var_321_object)
{
...
void func_681(void)
{
	...
	for(;;) {
		func_767(var_11_cvector, var_9_object);
	}
}
EMIT "Return(); Pop(0)";


void func_1195(object var_25_object)
{
...
// @pe
void func_1965(object var_129_object)
{
	object var_130_object;
	var_129_object = var_130_object;
	func_1997(var_130_object);
}


void func_1834(object var_129_object)
{
	...
	if(var_131_bool != 0) {
		...
		func_1788(var_134_object, true);
	} else {
		object var_354_object;
		var_129_object = var_354_object;
		TaskCall(1);
		func_120(var_355_object, var_356_bool, var_354_object);
		TaskReturn();
		@ResetAAS();
	}
...
// @pe
void func_1583(object var_12_object)
{
	int var_13_int;
...
void func_1971(bool var_11_bool, object var_12_object, object var_13_object, bool var_14_bool)
{
	bool var_16_bool;
	object var_18_object;
	var_13_object = var_18_object;
	bool var_17_bool;
	func_1645(var_17_bool, var_18_object, !var_14_bool);
	if(var_17_bool != 0) {
		...
		if(var_16_bool != 1) {
			...
			func_1032(var_87_float, var_88_object);
...
void func_1332(float var_240_float, object var_241_object)
{
	float var_244_float;
...
void func_1467(object var_13_object)
{
...
void func_1339(string var_47_string)
{
	...
	if(var_69_bool == 0) goto Label_1359;
}


// @pe
void func_1855(bool var_365_bool, object var_366_object)
{
	object var_368_object;
	var_366_object = var_368_object;
	float var_367_float;
	func_1032(var_367_float, var_368_object);
	var_365_bool = var_367_float <= 40000.0;
}


void func_1473(cvector var_40_cvector, cvector var_41_cvector)
{
...
void func_1863(bool var_50_bool, object var_51_object)
{
	float var_55_float; float var_57_float;
	object var_59_object;
	var_51_object = var_59_object;
	bool var_58_bool;
	func_1171(var_58_bool, var_59_object);
	if(!var_58_bool) { //@nz
		var_50_bool = false;
		return 6;
	}
	bool var_61_bool; object var_62_object;
	func_1040(var_61_bool, var_62_object);
	if(var_61_bool != 0) {
	...
	func_1045(var_67_bool, var_68_object, "class");
	if(!var_67_bool) { //@nz
		var_50_bool = false;
		return 6;
	}
	...
	func_1045(var_80_bool, var_81_object, "disease");
	if(!var_80_bool) { //@nz
		var_50_bool = false;
		return 6;
	}
...
void func_1483(float var_299_float, cvector var_300_cvector, cvector var_301_cvector)
{
	var_299_float = (var_301_cvector - var_300_cvector) | (var_301_cvector - var_300_cvector);
}


// @pe
void func_1997(object var_128_object)
{
	object var_129_object;
...
// @pe
void func_1487(float var_284_float, float var_285_float, float var_286_float)
{
...
void func_467(object var_0_object)
{
	...
	func_1025(var_237_cvector, var_0_object);
	var_237_cvector = var_181_cvector;
	var_239_float = GetByIndex(var_181_cvector, 1);
	float var_240_float;
	func_1332(var_240_float, var_0_object);
	...
	if(var_188_object != null) {
		if(var_188_object == var_0_object) {
			float var_249_float;
			func_1057(var_249_float, var_0_object, 1.5, 1);
...
// @pe
void func_979(string var_46_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
// @pe
void func_1494(float var_294_float, float var_295_float, float var_296_float, float var_297_float)
{
...
void func_1239(object var_12_object, int var_13_int, float var_14_float)
{
	...
	if(var_33_bool != 0) {
		...
		func_1025(var_42_cvector, var_43_object);
	...
	if(var_30_int == 0) goto Label_1301;
	int var_31_int;
	...
	func_1307(var_59_float, var_60_cvector, var_61_cvector);
}
...
void func_2003(object var_18_object)
{
	object var_20_object;
	@GetScene(var_20_object);
	object var_21_object;
	func_1467(var_21_object);
...
// @pe
void func_857(object var_22_object)
{
...
void func_120(object var_0_object, object var_1_object, object var_354_object)
{
	...
	if(var_1_object != 0) {
		bool var_365_bool;
		func_1855(var_365_bool, var_0_object);
		if(var_365_bool != 0) {
			func_1788(var_0_object, true);
			return 6;
		}
		@Face(var_0_object);
	}
	...
	for(;;) {
		if(var_362_int < 20) {
			...
			if(var_1_object != 0) {
				var_361_int = 0;
				bool var_393_bool;
				func_1855(var_393_bool, var_0_object);
				if(var_393_bool != 0) {
					func_271();
					func_1788(var_0_object, false);
					return 6;
				}
				@Face(var_0_object);
			} else {
			@StopAsync();
			if(!((var_361_int + 1) == 4)) goto Label_226;
			@PlayAnimation("all", "attack_off");
			@WaitForAnimEnd();
			return 6;
		}
		...
		func_1788(var_403_object, false);
		return 6;
		}
	Label_226:
		var_362_int += 1;
...
// @pe
void func_863(object var_23_object)
{
...
void func_1505(object var_13_object)
{
	object var_15_object;
...
// @pe
void func_1380(bool var_85_bool, string var_86_string)
{
	var_85_bool = true;
...
// @pe
void func_1511(float var_207_float, cvector var_208_cvector, cvector var_209_cvector)
{
...
void func_1130(bool var_28_bool, object var_29_object)
{
	bool var_31_bool;
...
void func_1645(bool var_17_bool, object var_18_object, bool var_19_bool)
{
	bool var_22_bool; object var_23_object;
	func_1045(var_22_bool, var_23_object, "class");
	if(!var_22_bool) { //@nz
		var_17_bool = false;
		return 2;
	}
...
void func_1135(bool var_17_bool, object var_18_object)
{
	...
	if(var_27_bool != 0) {
		...
		func_1130(var_28_bool, var_29_object);
		if(var_28_bool != 0)
			var_24_bool = true;
	}
	if(var_24_bool != 0) {
...
// @pe
void func_1520(float var_216_float, cvector var_217_cvector)
{
...
// @pe
void func_1011(string var_274_string, int var_275_int)
{
	if(var_275_int == 2) {
		var_274_string = "fire";
		return 0;
...
void func_888(object var_24_object)
{
...
// @pe
void func_1530(float var_204_float, cvector var_205_cvector, cvector var_206_cvector)
{
	...
	func_1520(var_225_float, var_226_cvector);
	var_204_float = var_207_float / (var_216_float * var_225_float);
}


// @pe
void func_1788(object var_134_object, bool var_135_bool)
{
	...
	TaskCall(2);
	func_287(var_138_object, var_139_object, var_140_bool, var_136_object, var_137_bool);
	TaskReturn();
	@ResetAAS();
}
...
{
	int var_291_int; bool var_292_bool; cvector var_293_cvector; object var_294_object;
	@GetPFPosition(var_1_object);
	@GetDirection(var_0_object);
	
	for(;;) {
		func_856();
		@irand(var_291_int, 10);
		@Sleep((var_291_int + 5), var_292_bool);
		if(var_292_bool != 0) {
			func_689();
		} else {
		for(;;) {
			...
			float var_299_float; cvector var_301_cvector;
			var_293_cvector = var_301_cvector;
			func_1483(var_299_float, var_1_object, var_301_cvector);
			if(var_299_float > 40000) {
				@FindPathTo(var_294_object, var_1_object);
				if(var_294_object != null) {
					@RotatePath(var_294_object, var_292_bool);
					if(!var_292_bool) { //@nz
					} else {
					@FollowPath(var_294_object, false, var_292_bool);
					if(!var_292_bool) { //@nz
						goto Label_848;
					}
					var_310_float = GetByIndex(var_0_object, 0);
					var_311_float = GetByIndex(var_0_object, 2);
					@Rotate(var_310_float, var_311_float, var_292_bool);
					if(!var_292_bool) { //@nz
						goto Label_848;
					}
					@WaitForAnimEnd(var_292_bool);
					if(!var_292_bool) { //@nz
						goto Label_848;
					}
					goto Label_849;
			...
			var_315_float = GetByIndex(var_0_object, 0);
			var_316_float = GetByIndex(var_0_object, 2);
			@Rotate(var_315_float, var_316_float, var_292_bool);
			if(!var_292_bool) { //@nz
				goto Label_848;
			}
			@WaitForAnimEnd(var_292_bool);
