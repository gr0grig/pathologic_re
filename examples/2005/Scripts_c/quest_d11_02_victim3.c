	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool)
	{
		if(1 != 0) {
			...
			if(var_7_bool == 15392) {
				...
				var_0_object->SetMessage(514178); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(514179, 41568, 15393); //@t
				var_0_object->AddReply(539618, 41566, 41565); //@t
				return 0;
			}
			if(var_7_bool == 41566) {
				func_132(var_8_bool, "Neutral");
				var_0_object->SetMessage(539619); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539620, -1, 41567); //@t
				return 0;
			}
			if(var_7_bool == 41568) {
				func_132(var_8_bool, "Neutral");
				var_0_object->SetMessage(539621); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539622, -1, 41569); //@t
				return 0;
			}
			var_3_string = true;
			bool var_46_bool;
			func_497(var_46_bool);
			if(var_46_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, bool var_6_bool, string var_7_string)
	{
		...
		if(var_7_string == "execute") {
			...
			func_287(var_9_bool, var_17_string);
		}
...
{
	bool var_7_bool;
	func_454(var_7_bool, "quest_d11_02", "actor_unload");
}
...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_333(var_25_bool, var_26_object, 70.0);
	if(!var_25_bool) { //@nz
		var_14_int = -2;
		return 8;
	}
	...
	func_493(var_74_string);
	var_21_object->SetPhoto(var_74_string);
	string var_75_string;
	func_495(var_75_string);
...
void func_132(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_425(var_96_string, var_97_bool);
...
void func_401(void)
{
	...
	bool var_128_bool;
	func_497(var_128_bool);
	if(var_128_bool != 0) {
	} else {
		@HasAnimationTrack(var_127_bool, "head");
		if(var_127_bool == 0) goto Label_417;
		@UnlookAsync("head");
	}
Label_417:
...
void func_287(object var_0_object, string var_17_string)
{
	bool var_19_bool;
	if(var_17_string == "cleanup") {
		...
		if(!var_19_bool) { //@nz
			bool var_24_bool;
			func_331(var_24_bool);
			if(var_24_bool != 0)
				var_22_bool = true;
		}
		if(var_22_bool != 0) {
			object var_25_object;
			func_438(var_25_object);
...
void func_418(string var_113_string)
{
...
void func_425(string var_96_string, bool var_97_bool)
{
...
{
	bool var_10_bool;
	func_497(var_10_bool);
	if(var_10_bool != 0)
		@lshStopSpeech();
}


void func_438(object var_10_object)
{
...
void func_444(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_454(bool var_7_bool, string var_8_string, string var_9_string)
{
...
void func_331(bool var_9_bool)
{
	var_9_bool = true;
}


void func_333(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_444(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_67_bool;
	func_497(var_67_bool);
	if(var_67_bool != 0) {
	} else {
		@HasAnimationTrack(var_45_bool, "head");
		if(var_45_bool == 0) goto Label_395;
...
// @pe
void func_232(object var_13_object)
{
...
void func_489(int var_73_int)
{
	var_73_int = 515564;
}


void func_491(int var_72_int)
{
	var_72_int = 503349;
}


void func_493(string var_74_string)
{
	var_74_string = "ui/NPC_Citizen2.png";
}


void func_495(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen2_b.png";
}


void func_497(bool var_67_bool)
{
	var_67_bool = false;
}
