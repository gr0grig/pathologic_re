	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool)
	{
		if(1 != 0) {
			...
			if(var_7_bool == 15395) {
				...
				var_0_object->SetMessage(514181); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(514182, 15397, 15396); //@t
				var_0_object->AddReply(539616, -1, 41563); //@t
				return 0;
			}
			if(var_7_bool == 15397) {
				func_132(var_8_bool, "Neutral");
				var_0_object->SetMessage(514183); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(514184, -1, 15398); //@t
				var_0_object->AddReply(539617, -1, 41564); //@t
				return 0;
			}
			var_3_string = true;
			bool var_42_bool;
			func_484(var_42_bool);
			if(var_42_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, bool var_6_bool, string var_7_string)
	{
		...
		if(var_7_string == "execute") {
			...
			func_274(var_9_bool, var_17_string);
		}
...
{
	bool var_7_bool;
	func_441(var_7_bool, "quest_d11_02", "actor_unload");
}
...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_320(var_25_bool, var_26_object, 70.0);
	if(!var_25_bool) { //@nz
		var_14_int = -2;
		return 8;
	}
	...
	func_480(var_74_string);
	var_21_object->SetPhoto(var_74_string);
	string var_75_string;
	func_482(var_75_string);
...
void func_388(void)
{
	...
	bool var_128_bool;
	func_484(var_128_bool);
	if(var_128_bool != 0) {
	} else {
		@HasAnimationTrack(var_127_bool, "head");
		if(var_127_bool == 0) goto Label_404;
		@UnlookAsync("head");
	}
Label_404:
...
void func_132(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_412(var_96_string, var_97_bool);
	var_2_object = var_92_string;
	
}


void func_274(object var_0_object, string var_17_string)
{
	bool var_19_bool;
	if(var_17_string == "cleanup") {
		...
		if(!var_19_bool) { //@nz
			bool var_24_bool;
			func_318(var_24_bool);
			if(var_24_bool != 0)
				var_22_bool = true;
		}
		if(var_22_bool != 0) {
			object var_25_object;
			func_425(var_25_object);
...
void func_405(string var_113_string)
{
...
void func_412(string var_96_string, bool var_97_bool)
{
...
{
	bool var_10_bool;
	func_484(var_10_bool);
	if(var_10_bool != 0)
		@lshStopSpeech();
}


void func_425(object var_10_object)
{
...
void func_431(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_441(bool var_7_bool, string var_8_string, string var_9_string)
{
...
void func_318(bool var_9_bool)
{
	var_9_bool = true;
}


void func_320(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_431(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_67_bool;
	func_484(var_67_bool);
	if(var_67_bool != 0) {
	} else {
		@HasAnimationTrack(var_45_bool, "head");
		if(var_45_bool == 0) goto Label_382;
...
// @pe
void func_219(object var_13_object)
{
...
void func_476(int var_73_int)
{
	var_73_int = 515564;
}


void func_478(int var_72_int)
{
	var_72_int = 503349;
}


void func_480(string var_74_string)
{
	var_74_string = "ui/NPC_Citizen2.png";
}


void func_482(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen2_b.png";
}


void func_484(bool var_67_bool)
{
	var_67_bool = false;
}
