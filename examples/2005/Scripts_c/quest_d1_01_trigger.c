maintask task_0
{
	void init(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_4_object, bool var_5_bool)
	{
		...
		func_210(var_14_object, var_15_object, "d1q01_light", "light_fire.xml");
		var_3_object = var_14_object;
		object var_22_object; object var_23_object;
		var_7_object = var_23_object;
		func_218(var_22_object, var_23_object, "pt_d1q01_fire", "scripted", "fire.xml");
	...
	void OnIntersection(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_4_object, bool var_5_bool, object var_6_object)
	{
		...
		func_184(var_35_object);
		func_253();
		@RemoveActor(var_1_object);
		@RemoveActor(var_2_object);
		@CameraSwitchToNormal();
		bool var_48_bool;
		func_236(var_48_bool, "quest_d1_01", "cutscene_end");
	}
	EMIT "Stack[-1] = 0";
	...
	void OnTrigger(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_4_object, bool var_5_bool, string var_6_string)
	{
		...
		if(var_6_string == "cleanup") {
			...
			if(!var_8_bool) { //@nz
				bool var_13_bool;
				func_159(var_13_bool);
				if(var_13_bool != 0)
					var_11_bool = true;
			}
			if(var_11_bool != 0) {
				object var_14_object;
				func_204(var_14_object);
...
void func_161(object var_18_object)
{
	int var_22_int;
	if(!var_18_object) { //@nz
	}
...
void func_204(object var_9_object)
{
...
void func_236(bool var_48_bool, string var_49_string, string var_50_string)
{
...
void func_210(object var_14_object, object var_15_object, string var_16_string, string var_17_string)
{
...
void func_218(object var_22_object, object var_23_object, string var_24_string, string var_25_string, string var_26_string)
{
...
void func_184(object var_35_object)
{
	if(!var_35_object) { //@nz
	}
	int var_37_int;
