...
maintask task_2
{
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object)
	{
		...
		if(!actor) { //@nz
			...
			if(var_8_int != 0) {
				bool var_132_bool;
				func_530(var_132_bool, "quest_d1_01", "remove_masks");
			}
		}
	}
...
void func_132(object var_2_object, string var_88_string)
{
	...
	if(var_88_string == "")
		...
		var_93_bool = true;
	func_507(var_92_string, var_93_bool);
	...
	for(;;) {
		...
		if(var_37_bool != 0) {
			...
			if(var_15_int == 0) {
				...
				func_542(var_46_string, var_47_int);
...
void func_520(cvector var_48_cvector, cvector var_49_cvector)
{
...
void func_530(bool var_132_bool, string var_133_string, string var_134_string)
{
...
void func_542(string var_30_string, int var_31_int)
{
...
void func_415(bool var_21_bool, object var_22_object, float var_23_float)
{
	...
	func_520(var_48_cvector, (var_37_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_63_bool;
	func_574(var_63_bool);
	if(var_63_bool != 0) {
	} else {
		@HasAnimationTrack(var_41_bool, "head");
		if(var_41_bool == 0) goto Label_477;
...
void func_483(void)
{
	...
	bool var_124_bool;
	func_574(var_124_bool);
	if(var_124_bool != 0) {
	} else {
		@HasAnimationTrack(var_123_bool, "head");
		if(var_123_bool == 0) goto Label_499;
		@UnlookAsync("head");
	}
Label_499:
...
void func_549(int var_24_int)
{
	...
	for(;;) {
		...
		func_542(var_30_string, var_31_int);
...
void func_500(string var_109_string)
{
...
void func_568(int var_68_int)
{
	var_68_int = 503354;
}


void func_570(string var_70_string)
{
	var_70_string = "ui/NPC_wmask.png";
}


void func_507(string var_92_string, bool var_93_bool)
{
...
void func_572(string var_71_string)
{
	var_71_string = "ui/NPC_wmask_b.png";
}


void func_574(bool var_63_bool)
{
	var_63_bool = false;
}
