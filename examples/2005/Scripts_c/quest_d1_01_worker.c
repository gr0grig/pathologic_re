...
maintask task_2
{
	...
	Label_293:
		for(;;) {
			bool var_17_bool;
			func_1846(var_17_bool);
			var_20_bool = !var_17_bool; //@nz
			if(var_20_bool == 0) goto Label_301;
			@Hold();
		}
	...
	void OnAttacked(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool)
	{
		...
		if(var_17_bool != 0) {
			bool var_19_bool;
			func_2052(var_19_bool, "quest_d1_01", "attack");
		}
	}
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, string var_6_string, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool)
	{
		if(var_15_bool == "attack") {
			func_437();
			func_313(var_15_bool);
			object var_26_object;
			object var_27_object;
			func_1547(var_27_object);
			var_27_object = var_26_object;
			TaskCall(3);
			func_442(var_26_object);
			TaskReturn();
		}
	}
	...
	void OnUnload(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool)
	{
		...
		if(var_0_object != 0) {
			bool var_17_bool;
			func_354(var_17_bool);
			if(var_17_bool != 0)
				var_15_bool = true;
		}
		if(var_15_bool != 0) {
			object var_18_object;
			func_2008(var_18_object);
...
task task_4
{
	...
	{
		if(var_15_int == 1) {
			func_2064(var_1_object);
		} else {
			int var_23_int;
			func_1329(var_14_bool, var_23_int, var_23_int);
		}
...
void OnHit(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool, object var_15_object, int var_16_int, float var_17_float, float var_18_float)
{
	...
	func_1753(var_19_object, var_20_int, var_21_float);
}
...
void OnHit2(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool, object var_15_object, int var_16_int, float var_17_float, float var_18_float, cvector var_19_cvector, cvector var_20_cvector)
{
	...
	func_1821(var_23_float, var_24_cvector, var_25_cvector);
}
...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_1851(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_2052(bool var_19_bool, string var_20_string, string var_21_string)
{
	object var_23_object;
...
void func_1540(cvector var_49_cvector, object var_50_object)
{
...
void func_1547(object var_27_object)
{
...
void func_2064(object var_18_object)
{
	bool var_20_bool;
...
void func_1554(bool var_162_bool, object var_163_object)
{
	bool var_165_bool;
...
void func_1559(bool var_50_bool, object var_51_object, string var_52_string)
{
...
void func_2073(void)
{
	...
	func_2008(var_371_object);
	@BroadcastMessage("battle", var_371_object, var_369_object);
}
EMIT "Stack[-1] = 0";


void func_1059(object var_0_object, bool var_258_bool)
{
	bool var_260_bool;
...
void func_2084(string var_46_string, int var_47_int)
{
...
void func_1571(float var_407_float, object var_408_object, float var_409_float, int var_410_int)
{
	int var_420_int; int var_422_int;
	object var_427_object;
	var_408_object = var_427_object;
	bool var_426_bool;
	func_1559(var_426_bool, var_427_object, "health");
	if(!var_426_bool) //@nz
		var_407_float = 0.0;
	bool var_430_bool; object var_431_object;
	func_1559(var_430_bool, var_431_object, "armor");
	if(!var_430_bool) //@nz
		var_420_int = 0;
	else
	...
	func_1526(var_435_string, var_436_int);
	...
	func_1559(var_441_bool, var_442_object, var_443_string);
	if(!var_441_bool) //@nz
		var_422_int = 0;
	else
	...
	float var_445_float;
	func_2024(var_445_float, ((var_420_int + var_422_int) / 100.0), (float)1);
	float var_423_float;
...
void func_2091(int var_40_int)
{
	...
	for(;;) {
		...
		func_2084(var_46_string, var_47_int);
...
void func_1070(object var_2_object, bool var_5_bool)
{
	int var_378_int;
	if(!var_2_object) //@nz
		return 4;
...
{
	bool var_23_bool;
	func_2052(var_23_bool, "quest_d1_01", "attack");
}


void func_2115(int var_78_int)
{
	int var_80_int;
...
void func_1102(object var_0_object)
{
	func_2064(var_0_object);
}


void func_1107(int var_468_int)
{
	var_468_int = 0;
}


void func_2132(int var_20_int)
{
	int var_22_int;
...
// @pe
void func_2138(object var_19_object)
{
	int var_20_int;
	func_2132(var_20_int);
	if(var_20_int == 1)
...
void func_1116(bool var_493_bool)
{
	var_493_bool = true;
}


void func_1118(int var_389_int)
{
	var_389_int = 1;
}
...
void func_1122(object var_2_object, bool var_138_bool, object var_139_object, float var_140_float, float var_141_float, bool var_142_bool, bool var_143_bool)
{
	object var_151_object;
	func_2064(var_151_object);
	@SetTimer(1, 5);
	bool var_149_bool;
	...
	if(var_149_bool != 0) {
		...
		func_1949(var_155_object);
	} else {
		var_2_object = false;
	}
	bool var_162_bool; object var_163_object;
	func_1554(var_162_bool, var_163_object);
	if(var_162_bool != 0) {
		object var_166_object;
		func_2008(var_166_object);
	...
	bool var_150_bool;
	func_1227(var_149_bool, var_150_bool, var_167_bool, var_168_object, var_169_float, var_170_float, var_171_bool, var_172_bool);
...
void func_2151(int var_75_int)
{
	var_75_int = 515568;
}


void func_2153(int var_74_int)
{
	var_74_int = 503353;
}


void func_2155(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen1.png";
}


void func_1644(bool var_43_bool, object var_44_object)
{
	bool var_46_bool;
...
void func_2157(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen1_b.png";
}


void func_2159(bool var_69_bool)
{
	var_69_bool = false;
}


void func_1649(bool var_32_bool, object var_33_object)
{
	...
	if(var_42_bool != 0) {
		...
		func_1644(var_43_bool, var_44_object);
		if(var_43_bool != 0)
			var_39_bool = true;
	}
	if(var_39_bool != 0) {
...
// @pe
void func_2161(object var_16_object)
{
	object var_17_object;
	var_16_object = var_17_object;
	TaskCall(5);
	func_1378(var_17_object);
	TaskReturn();
}
...
void func_132(object var_2_object, string var_94_string)
{
	...
	if(var_94_string == "")
		...
		var_99_bool = true;
	func_1943(var_98_string, var_99_bool);
	var_2_object = var_94_string;
	
}


void func_1685(bool var_28_bool, object var_29_object)
{
	object var_33_object;
	var_29_object = var_33_object;
	bool var_32_bool;
	func_1649(var_32_bool, var_33_object);
	if(!var_32_bool) { //@nz
		var_28_bool = false;
		return 2;
	}
	bool var_50_bool; object var_51_object;
	func_1559(var_50_bool, var_51_object, "noaccess");
	if(!var_50_bool) { //@nz
		var_28_bool = true;
		return 2;
	}
...
void func_1185(object var_2_object)
{
	@KillTimer(1);
	if(var_2_object != 0) {
		var_2_object = false;
	...
	func_1351(var_15_object);
}


void func_1709(object var_32_object)
{
...
void func_689(object var_1_object, object var_2_object, bool var_4_bool)
{
...
void func_1227(object var_0_object, object var_1_object, bool var_167_bool, object var_168_object, float var_169_float, float var_170_float, bool var_171_bool, bool var_172_bool)
{
	...
	for(;;) {
		...
		func_1367(var_189_bool, var_190_object);
		if(!var_189_bool) { //@nz
			var_167_bool = false;
			return 16;
		}
		...
		if(var_187_float > (var_169_float * var_169_float)) {
			...
			if(var_183_object != null) {
				if(var_182_bool == 0) goto Label_1280;
				var_182_bool = false;
...
void func_724(object var_0_object, float var_393_float, int var_394_int)
{
	...
	if(var_398_object == var_0_object) {
		...
		func_457(var_413_int);
		var_411_int = var_410_int;
		func_1571(var_407_float, var_408_object, var_409_float, var_410_int);
		var_407_float = var_400_float;
		int var_468_int;
		func_1107(var_468_int);
...
void func_1753(object var_19_object, int var_20_int, float var_21_float)
{
	...
	if(var_40_bool != 0) {
		...
		func_1540(var_49_cvector, var_50_object);
		var_49_cvector = var_48_cvector;
		func_2014(var_47_cvector, var_48_cvector);
	...
	if(var_37_int == 0) goto Label_1815;
	int var_38_int;
	...
	func_1821(var_66_float, var_67_cvector, var_68_cvector);
}


void func_763(object var_0_object, object var_1_object, bool var_356_bool, float var_357_float)
{
	string var_365_string;
	func_1102(var_365_string);
	int var_362_int;
	...
	@WaitForAnimEnd();
	int var_364_int;
	func_1070(var_364_int, var_365_string);
	bool var_390_bool;
	func_1685(var_390_bool, var_0_object);
	if(!var_390_bool) { //@nz
		@StopAsync();
		var_356_bool = false;
		return 8;
	...
	func_724(var_365_string, var_393_float, var_394_int);
	bool var_363_bool;
	...
	if(var_363_bool != 0) {
		...
		func_1102(var_365_string);
		bool var_478_bool;
		func_1685(var_478_bool, var_0_object);
		if(!var_478_bool) { //@nz
			@StopAsync();
			var_356_bool = false;
			return 8;
		...
		func_724(var_365_string, var_481_float, var_482_int);
		var_364_int = 1;
		...
		for(;;) {
			...
			if(!var_363_bool) { //@nz
				...
				func_1102(var_365_string);
				bool var_504_bool;
				func_1685(var_504_bool, var_0_object);
				if(!var_504_bool) { //@nz
					@StopAsync();
					var_356_bool = false;
					return 8;
				...
				func_724(var_365_string, var_507_float, var_508_int);
				var_364_int += 1;
			}
	}
		...
		bool var_493_bool;
		func_1116(var_493_bool);
		if(var_493_bool != 0) {
			bool var_494_bool;
			func_900(var_494_bool, 0.75);
			@StopAsync();
		}
		var_356_bool = true;
		return 8;
...
void func_1821(object var_21_object, cvector var_24_cvector, cvector var_25_cvector)
{
	...
	func_1709(var_32_object);
}
EMIT "Stack[-1] = 0";
EMIT "Stack[-2] = 0";


void func_1835(object var_241_object)
{
...
// @pe
void func_1329(object var_0_object, object var_1_object, int var_23_int)
{
	if(var_23_int != 0)
		return 0;
	bool var_26_bool;
	func_1367(var_26_bool, var_1_object);
	if(!var_26_bool) //@nz
		var_0_object = true;
	@KillTimer(0);
	@Stop();
...
void func_1846(bool var_17_bool)
{
	bool var_19_bool;
...
void func_313(object var_0_object)
{
	var_0_object = true;
	bool var_19_bool;
	@IsLoaded(var_19_bool);
	...
	if(!var_19_bool) { //@nz
		bool var_22_bool;
		func_354(var_22_bool);
		if(var_22_bool != 0)
			var_20_bool = true;
	}
	if(var_20_bool != 0) {
		object var_23_object;
		func_2008(var_23_object);
		@RemoveActor(var_23_object);
	}
}


void func_1851(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	cvector var_54_cvector;
	func_2014(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_69_bool;
	func_2159(var_69_bool);
	if(var_69_bool != 0) {
	} else {
		@HasAnimationTrack(var_47_bool, "head");
		if(var_47_bool == 0) goto Label_1913;
...
void func_1351(object var_0_object)
{
	var_0_object = true;
	@KillTimer(0);
	@Stop();
...
// @pe
void func_1367(bool var_26_bool, object var_27_object)
{
	object var_29_object;
	var_27_object = var_29_object;
	bool var_28_bool;
	func_1685(var_28_bool, var_29_object);
	var_28_bool = var_26_bool;
}


void func_1374(string var_207_string)
{
	var_207_string = "walk";
}


void func_1376(string var_208_string)
{
	var_208_string = "run";
}


void func_354(bool var_17_bool)
{
	var_17_bool = true;
}
...
// @pe
void func_1378(object var_17_object)
{
	object var_18_object;
	var_17_object = var_18_object;
	func_1403(var_18_object);
	@SetRTEnvelope(50, 40);
	disable OnUse;
	enable OnUse;
...
void func_356(void)
{
	...
	@WaitForAnimEnd();
	bool var_38_bool;
	func_1846(var_38_bool);
	if(!var_38_bool) //@nz
		return 14;
	int var_40_int;
	func_2091(var_40_int);
	int var_31_int;
		...
		if(var_53_bool != 0) {
			...
			if(var_33_int == 1) {
				...
				goto Label_432;
					...
					bool var_65_bool;
					func_435(var_65_bool);
					var_66_bool = !var_65_bool; //@nz
					if(var_66_bool == 0) goto Label_427;
			}
		}
	Label_432:
		for(;;) {
...
void func_1403(object var_18_object)
{
...
void func_1919(void)
{
	...
	bool var_130_bool;
	func_2159(var_130_bool);
	if(var_130_bool != 0) {
	} else {
		@HasAnimationTrack(var_129_bool, "head");
		if(var_129_bool == 0) goto Label_1935;
		@UnlookAsync("head");
	}
Label_1935:
...
void func_900(bool var_494_bool, float var_495_float)
{
	...
	@WaitForAnimEnd();
	func_1102(var_499_bool);
}


void func_1936(string var_115_string)
{
...
void func_1943(string var_98_string, bool var_99_bool)
{
...
void func_1949(object var_19_object)
{
	float var_22_float;
...
void func_927(object var_0_object, bool var_295_bool, float var_296_float)
{
	...
	for(;;) {
		...
		if(!var_302_bool) //@nz
			break;
		bool var_308_bool;
		func_998(var_308_bool);
		if(var_308_bool != 0) {
			var_295_bool = true;
			return 10;
		}
		bool var_351_bool;
		func_1685(var_351_bool, var_0_object);
		if(!var_351_bool) { //@nz
			var_295_bool = false;
			return 10;
		}
		...
		if(var_306_float < (var_296_float * var_296_float)) {
			...
			func_763(var_305_cvector, var_306_float, var_356_bool, var_357_float);
			var_295_bool = true;
			return 10;
		}
		@sync();
	}
	func_1102(var_306_float);
	var_295_bool = false;
}
...
{
	bool var_18_bool;
	func_2159(var_18_bool);
	if(var_18_bool != 0)
		@lshStopSpeech();
}


void func_1967(string var_41_string)
{
	...
	if(var_63_bool == 0) goto Label_1987;
}


void func_435(bool var_65_bool)
{
	var_65_bool = true;
}
...
// @pe
void func_442(object var_26_object)
{
	
	for(;;) {
		object var_37_object;
		func_460(var_33_int, var_34_bool, var_35_float, var_36_int, var_37_object, var_37_object, true, 180.0);
		@Sleep(1);
	}
}
EMIT "Return(); Pop(0)";
...
// @pe
void func_454(float var_404_float)
{
	var_404_float = 0.1;
}
...
// @pe
void func_457(int var_411_int)
{
	var_411_int = 0;
}


void func_970(object var_0_object, bool var_310_bool)
{
	cvector var_316_cvector; cvector var_317_cvector;
	bool var_321_bool;
	func_1685(var_321_bool, var_0_object);
	if(!var_321_bool) { //@nz
		var_310_bool = false;
		return 10;
	}
	bool var_324_bool;
	float var_320_float;
	func_1059(var_320_float, var_324_bool);
	if(var_324_bool != 0) {
...
void func_460(object var_0_object, string var_3_string, bool var_5_bool, object var_37_object, bool var_38_bool, float var_39_float, bool var_144_bool, bool var_236_bool)
{
	...
	func_689(var_59_cvector, var_60_bool, var_61_float);
	var_5_bool = 0;
...
Label_500:
	for(;;) {
		...
		bool var_96_bool;
		func_1685(var_96_bool, var_0_object);
		if(var_96_bool != 0) {
			if(!var_3_string) //@nz
				var_95_bool = true;
		}
		if(var_95_bool != 0) {
			func_1102(var_61_float);
			...
			if(var_58_float >= ((400.0 + var_51_float) * (400.0 + var_51_float))) {
				...
				TaskCall(4);
				func_1122(var_146_bool, var_138_bool, var_0_object, var_140_float, 10000.0, true, false);
				TaskReturn();
				if(!var_144_bool) { //@nz
				} else {
					var_55_bool = false;
			...
			if(var_58_float >= (var_39_float * var_39_float)) {
				...
				if(!var_60_bool) { //@nz
					...
					TaskCall(4);
					func_1122(var_238_bool, var_230_bool, var_0_object, var_232_float, 10000.0, true, false);
					TaskReturn();
					if(!var_236_bool) { //@nz
						goto Label_672;
					}
				...
				if(!var_55_bool) { //@nz
					...
					var_55_bool = true;
					bool var_252_bool;
					func_1685(var_252_bool, var_0_object);
					if(!var_252_bool) { //@nz
						goto Label_672;
					}
				}
				...
				if(var_255_bool != 0) {
					...
					func_927(var_61_float, var_295_bool, var_296_float);
					@StopAsync();
				} else {
					@Face(var_0_object);
					...
					@StopAsync();
					bool var_513_bool;
					func_1059(var_61_float, var_513_bool);
					var_514_bool = !var_513_bool; //@nz
					if(var_514_bool == 0) goto Label_662;
					bool var_515_bool;
					func_1685(var_515_bool, var_0_object);
					if(!var_515_bool) { //@nz
						goto Label_672;
					}
					var_0_object->GetPFPosition(var_52_cvector); //@t
					@GetPFPosition(var_53_cvector);
					if(!(((var_52_cvector - var_53_cvector) | (var_52_cvector - var_53_cvector)) < (var_296_float * var_296_float))) goto Label_662;
					bool var_520_bool; float var_521_float;
					var_39_float = var_521_float;
					func_763(var_60_bool, var_61_float, var_520_bool, var_521_float);
					var_522_bool = !var_520_bool; //@nz
					if(var_522_bool == 0) goto Label_662;
					goto Label_672;
			}
				bool var_523_bool; float var_524_float;
				var_39_float = var_524_float;
				func_763(var_60_bool, var_61_float, var_523_bool, var_524_float);
				if(!var_523_bool) { //@nz
					goto Label_672;
				}
				var_55_bool = true;
...
// @pe
void func_1494(string var_40_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_2008(object var_15_object)
{
	object var_17_object;
	@self(var_17_object);
...
void func_2014(cvector var_47_cvector, cvector var_48_cvector)
{
...
void func_998(bool var_308_bool)
{
	bool var_309_bool = false;
	bool var_310_bool;
	func_970(var_309_bool, var_310_bool);
	if(var_310_bool != 0) {
		bool var_327_bool;
		func_1014(var_308_bool, var_309_bool, var_327_bool);
		if(var_327_bool != 0)
			var_309_bool = true;
	}
	if(var_309_bool != 0) {
...
// @pe
void func_2024(float var_445_float, float var_446_float, float var_447_float)
{
...
// @pe
void func_2031(float var_455_float, float var_456_float, float var_457_float, float var_458_float)
{
...
void func_1014(object var_0_object, bool var_4_bool, bool var_327_bool)
{
	...
	for(;;) {
		...
		func_1540(var_338_cvector, var_0_object);
		...
		if(var_335_float < var_4_bool) {
				...
				@WaitForAnimEnd();
				func_1102(var_337_cvector);
				@StopAsync();
				@SetSpeed([0.0, 0.0, 0.0]);
				var_334_bool = true;
				bool var_349_bool;
				func_970(var_337_cvector, var_349_bool);
				var_350_bool = !var_349_bool; //@nz
				if(var_350_bool == 0) goto Label_1055;
		}
		for(;;) {
...
// @pe
void func_1526(string var_435_string, int var_436_int)
{
	if(var_436_int == 2) {
		var_435_string = "fire";
		return 0;
...
void func_2042(float var_463_float)
{
