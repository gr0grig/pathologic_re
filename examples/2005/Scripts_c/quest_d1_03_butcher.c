...
void func_132(object var_2_object, string var_94_string)
{
	...
	if(var_94_string == "")
		...
		var_99_bool = true;
	func_1750(var_98_string, var_99_bool);
...
// @pe
void func_1929(object var_16_object)
{
	bool var_17_bool;
	func_1859(var_17_bool, "quest_d1_03", "butcher_death");
	object var_23_object;
...
void func_1815(object var_15_object)
{
	object var_17_object;
	@self(var_17_object);
		...
		if(var_94_bool != 0) {
			...
			if(var_55_float >= (var_36_float * var_36_float)) {
				...
				if(var_254_bool != 0) {
					...
					@StopAsync();
					bool var_512_bool;
					func_882(var_58_float, var_512_bool);
					var_513_bool = !var_512_bool; //@nz
					if(var_513_bool == 0) goto Label_485;
					bool var_514_bool;
					func_1497(var_514_bool, var_0_object);
					if(!var_514_bool) { //@nz
						goto Label_495;
					}
					var_0_object->GetPFPosition(var_49_cvector); //@t
					...
					var_36_float = var_520_float;
					func_586(var_57_bool, var_58_float, var_519_bool, var_520_float);
					var_521_bool = !var_519_bool; //@nz
					if(var_521_bool == 0) goto Label_485;
					goto Label_495;
			}
				bool var_522_bool; float var_523_float;
				var_36_float = var_523_float;
				func_586(var_57_bool, var_58_float, var_522_bool, var_523_float);
				if(!var_522_bool) { //@nz
					goto Label_495;
				}
				var_52_bool = true;
...
void func_547(object var_0_object, float var_392_float, int var_393_int)
{
	...
	if(var_397_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_467_int, var_399_float, var_408_float);
...
void func_932(void)
{
	func_1774("attack_stay");
}


void func_1914(string var_77_string)
{
...
// @pe
void func_1831(float var_444_float, float var_445_float, float var_446_float)
{
...
void func_939(bool var_492_bool)
{
	var_492_bool = true;
}
...
// @pe
void func_1838(float var_454_float, float var_455_float, float var_456_float, float var_457_float)
{
...
void func_1849(float var_462_float)
{
...
void func_1726(void)
{
	...
	bool var_130_bool;
	func_1916(var_130_bool);
	if(var_130_bool != 0) {
	} else {
		@HasAnimationTrack(var_129_bool, "head");
		if(var_129_bool == 0) goto Label_1742;
		@UnlookAsync("head");
	}
Label_1742:
...
void func_1859(bool var_17_bool, string var_18_string, string var_19_string)
{
	object var_21_object;
...
void func_586(object var_0_object, object var_1_object, bool var_355_bool, float var_356_float)
{
	...
	if(var_362_bool != 0) {
		...
		func_925(var_364_string);
		bool var_477_bool;
		func_1497(var_477_bool, var_0_object);
		if(!var_477_bool) { //@nz
			@StopAsync();
			var_355_bool = false;
			return 8;
		...
		func_547(var_364_string, var_480_float, var_481_int);
		var_363_int = 1;
		...
		for(;;) {
			...
			if(!var_362_bool) { //@nz
				...
				func_925(var_364_string);
				bool var_503_bool;
				func_1497(var_503_bool, var_0_object);
				if(!var_503_bool) { //@nz
					@StopAsync();
					var_355_bool = false;
					return 8;
				}
				float var_506_float; int var_507_int;
				var_356_float = var_506_float;
				var_361_int = var_507_int;
				func_547(var_364_string, var_506_float, var_507_int);
				var_363_int += 1;
			}
	}
...
void func_1743(string var_115_string)
{
...
void func_1871(object var_18_object)
{
	bool var_20_bool;
...
void func_723(bool var_493_bool, float var_494_float)
{
	...
	@WaitForAnimEnd();
	func_925(var_498_bool);
}


void func_1750(string var_98_string, bool var_99_bool)
{
...
void func_1756(object var_19_object)
{
	float var_22_float;
...
void func_1383(float var_406_float, object var_407_object, float var_408_float, int var_409_int)
{
	...
	float var_444_float;
	func_1831(var_444_float, ((var_419_int + var_421_int) / 100.0), (float)1);
	float var_422_float;
	...
	float var_454_float;
	func_1838(var_454_float, (var_423_float - var_424_float), (float)0, (float)1);
...
void func_1774(string var_47_string)
{
	...
	if(var_69_bool == 0) goto Label_1794;
}
...
void func_1908(int var_75_int)
{
	var_75_int = 515562;
}


void func_1910(int var_74_int)
{
	var_74_int = 503347;
}
...
void func_1912(string var_76_string)
{
...
void func_1658(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	cvector var_54_cvector;
	func_1821(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_69_bool;
	func_1916(var_69_bool);
	if(var_69_bool != 0) {
	} else {
		@HasAnimationTrack(var_47_bool, "head");
		if(var_47_bool == 0) goto Label_1720;
...
{
	bool var_27_bool;
	func_1859(var_27_bool, "quest_d1_03", "butcher_battle");
...
void func_1916(bool var_69_bool)
{
	var_69_bool = false;
}
...
void func_1918(void)
{
	...
	@RemoveActor(var_15_object);
	bool var_18_bool;
	func_1859(var_18_bool, "quest_d1_03", "butcher_fail");
}
