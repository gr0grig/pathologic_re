...
maintask task_3
{
	...
	void OnSee(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, bool var_6_bool, bool var_7_bool, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int, bool var_13_bool, float var_14_float, int var_15_int, bool var_16_bool, object var_17_object, bool var_18_bool)
	{
		...
		func_3449(var_19_bool, var_20_object);
		if(var_19_bool != 0) {
			func_838(var_20_object);
			object var_32_object;
			var_18_bool = var_32_object;
			func_3472(var_32_object);
		} else {
...
task task_5
{
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, bool var_6_bool, bool var_7_bool, object var_8_object, int var_9_int, object var_10_object, int var_11_int, int var_12_int, bool var_13_bool, float var_14_float, int var_15_int, bool var_16_bool, object var_17_object, bool var_18_bool)
	{
		...
		func_3027(var_68_float, var_69_cvector, var_70_cvector);
...
// @pe
void func_3586(object var_72_object)
{
	object var_73_object;
	var_72_object = var_73_object;
	func_3571(var_73_object);
}
...
// @pe
void func_3595(object var_29_object)
{
	object var_30_object;
	var_29_object = var_30_object;
	func_3666(var_30_object);
}
...
// @pe
void func_3602(int var_128_int)
{
	var_128_int = 0;
}
...
// @pe
void func_3094(bool var_121_bool)
{
	int var_123_int;
	func_3044(var_123_int, "ood1Doberman2_1");
	if(var_123_int == 0) {
		var_121_bool = true;
		return 0;
	}
...
// @pe
void func_3607(bool var_24_bool)
{
	var_24_bool = false;
}
...
void func_3612(bool var_31_bool, object var_32_object)
{
	bool var_34_bool;
...
void func_3106(int var_105_int)
{
	int var_107_int;
...
// @pe
void func_3627(object var_59_object)
{
	object var_60_object;
	var_59_object = var_60_object;
	func_3553(var_60_object);
}


// @pe
void func_3633(bool var_48_bool)
{
	var_48_bool = false;
}


void func_3123(int var_157_int)
{
	int var_159_int;
...
// @pe
void func_3129(object var_35_object)
{
	int var_36_int;
	func_3123(var_36_int);
	if(var_36_int == 1)
...
// @pe
void func_3643(bool var_26_bool)
{
	var_26_bool = false;
}
...
void func_3648(int var_102_int)
{
	var_102_int = 518097;
}


void func_3650(int var_101_int)
{
	var_101_int = 518096;
}


void func_3652(string var_103_string)
{
	var_103_string = "ui/NPC_Citizen2.png";
}


void func_3654(string var_104_string)
{
	var_104_string = "ui/NPC_Citizen2_b.png";
}


void func_3142(int var_115_int, int var_116_int)
{
...
void func_3656(bool var_96_bool)
{
	var_96_bool = false;
}
...
void func_3068(object var_21_object)
{
	bool var_23_bool;
...
void func_3666(object var_30_object)
{
	bool var_32_bool;
	...
	if(var_33_bool != 0) {
		...
		if(!var_32_bool) { //@nz
			...
			func_3129(var_35_object);
		}
	EMIT "GOTO 0xe63";
	}
	object var_42_object;
	var_30_object = var_42_object;
	func_3717(var_42_object);
}
...
void func_3684(bool var_63_bool)
{
	var_63_bool = false;
}


void func_3173(string var_163_string)
{
...
// @pe
void func_3686(bool var_23_bool)
{
	var_23_bool = true;
}
...
void func_2688(object var_22_object, int var_23_int, float var_24_float)
{
	...
	if(var_43_bool != 0) {
		...
		func_2975(var_50_cvector, var_51_cvector);
...
// @pe
void func_3717(object var_42_object)
{
...
void func_2182(int var_482_int)
{
	var_482_int = 0;
}
	...
	for(;;) {
		...
		if(var_161_bool != 0) {
			...
			if(var_141_int == 0) {
				...
				func_3520(var_170_string, var_171_int);
...
void func_3214(void)
{
	@ClearSubContainer(0);
	int var_118_int;
	func_3059(var_118_int);
	func_3142(0, (10 + (var_118_int * 10)));
	func_2902("hook", 1, 4);
	func_2902("watch", 1, 10);
}


void func_2191(bool var_507_bool)
{
	var_507_bool = true;
}
...
void func_162(object var_2_object, string var_133_string)
{
	...
	if(var_133_string == "")
		...
		var_138_bool = true;
	func_2878(var_137_string, var_138_bool);
	var_2_object = var_133_string;
	
}


void func_3242(bool var_20_bool)
{
	@ClearSubContainer(0);
	int var_28_int;
	func_3059(var_28_int);
	int var_26_int;
	var_28_int = var_26_int;
	if(var_20_bool != 0) {
		func_2913("alpha_pills", 1, 2, 4);
		func_2913("meradorm", 2, 3, 3);
		if(var_26_int >= 3)
			func_2902("beta_pills", 1, 4);
		if(var_26_int >= 8) {
			func_2913("monomicin", 1, 2, 2);
		} else {
				if(var_26_int >= 4)
					func_2902("monomicin", 1, 2);
				func_2902("lockpick", 1, 4);
				func_2902("rifle_ammo", 1, 2);
				func_2902("revolver_ammo", 1, 2);
				func_2913("samopal_ammo", 1, 2, 2);
				if(var_26_int >= 8)
					func_2913("monomicin", 1, 2, 2);
			}
...
void func_1246(object var_0_object, object var_61_object)
{
	...
	func_3027(var_82_float, var_83_cvector, var_84_cvector);
	if(var_82_float < 0) {
		func_2770(var_0_object);
		var_68_bool = true;
	} else {
...
void func_2786(bool var_54_bool, object var_55_object, float var_56_float)
{
	...
	func_2975(var_81_cvector, (var_70_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_96_bool;
	func_3656(var_96_bool);
	if(var_96_bool != 0) {
	} else {
		@HasAnimationTrack(var_74_bool, "head");
		if(var_74_bool == 0) goto Label_2848;
...
void func_3342(int var_136_int, string var_137_string)
{
	int var_139_int;
...
{
	func_2884(var_0_object);
}


// @pe
void func_3347(object var_19_object)
{
	object var_20_object;
...
void func_2854(void)
{
	...
	bool var_177_bool;
	func_3656(var_177_bool);
	if(var_177_bool != 0) {
	} else {
		@HasAnimationTrack(var_176_bool, "head");
		if(var_176_bool == 0) goto Label_2870;
		@UnlookAsync("head");
	}
Label_2870:
...
void func_1838(object var_0_object, object var_1_object, bool var_370_bool, float var_371_float)
{
	...
	if(var_377_bool != 0) {
		...
		func_2177(var_379_string);
		bool var_492_bool;
		func_2620(var_492_bool, var_0_object);
		if(!var_492_bool) { //@nz
			@StopAsync();
			var_370_bool = false;
			return 8;
		...
		func_1799(var_379_string, var_495_float, var_496_int);
		var_378_int = 1;
		...
		for(;;) {
			...
			if(!var_377_bool) { //@nz
				...
				func_2177(var_379_string);
				bool var_518_bool;
				func_2620(var_518_bool, var_0_object);
				if(!var_518_bool) { //@nz
					@StopAsync();
					var_370_bool = false;
					return 8;
				...
				func_1799(var_379_string, var_521_float, var_522_int);
				var_378_int += 1;
			}
	}
		...
		bool var_507_bool;
		func_2191(var_507_bool);
		if(var_507_bool != 0) {
			bool var_508_bool;
			func_1975(var_508_bool, 0.75);
			@StopAsync();
		}
		var_370_bool = true;
		return 8;
...
void func_2871(string var_154_string)
{
...
void func_2878(string var_137_string, bool var_138_bool)
{
...
// @pe
void func_3392(bool var_22_bool, object var_23_object, string var_24_string)
{
	if(var_24_string == "unholster") {
		bool var_27_bool; object var_28_object;
		var_23_object = var_28_object;
		func_3607(var_28_object);
	...
	if(var_24_string == "player_shot") {
		...
		func_3612(var_31_bool, var_32_object);
...
void func_2884(object var_22_object)
{
	float var_25_float;
...
{
	bool var_21_bool;
	func_3656(var_21_bool);
	if(var_21_bool != 0)
		@lshStopSpeech();
}


void func_2902(string var_57_string, int var_58_int, int var_59_int)
{
	bool var_61_bool;
	int var_63_int;
	...
	bool var_62_bool;
	func_3003(var_62_bool, var_63_int, var_64_int);
	if(var_62_bool != 0)
...
// @pe
void func_3424(object var_52_object, string var_53_string)
{
...
Label_3448:
	...
	if(!(var_53_string == "battle")) goto Label_3448;
...
void func_2913(string var_35_string, int var_36_int, int var_37_int, int var_38_int)
{
	...
	bool var_43_bool;
	func_3003(var_43_bool, var_44_int, var_45_int);
	if(var_43_bool != 0) {
...
void func_2928(string var_44_string)
{
	...
	if(var_66_bool == 0) goto Label_2948;
}


void func_3449(bool var_19_bool, object var_20_object)
{
	bool var_22_bool;
	bool var_23_bool = false;
	bool var_24_bool; object var_25_object;
	var_20_object = var_25_object;
	func_3607(var_25_object);
	if(var_24_bool != 0) {
...
// @pe
void func_3472(object var_33_object)
{
	object var_34_object;
...
// @pe
void func_3478(object var_21_object)
{
	bool var_22_bool; object var_23_object;
	func_2489(var_22_bool, var_23_object);
	if(var_22_bool != 0) {
		object var_26_object;
		func_2969(var_26_object);
...
void func_2969(object var_106_object)
{
...
void func_2975(cvector var_50_cvector, cvector var_51_cvector)
{
...
void func_3491(bool var_19_bool, string var_20_string)
{
	object var_22_object;
...
// @pe
void func_2985(float var_459_float, float var_460_float, float var_461_float)
{
...
// @pe
void func_2992(float var_469_float, float var_470_float, float var_471_float, float var_472_float)
{
...
void func_3507(string var_30_string)
{
	object var_32_object;
...
void func_1975(bool var_508_bool, float var_509_float)
{
...
void func_3003(bool var_43_bool, int var_44_int, int var_45_int)
{
	int var_47_int;
...
void func_3520(string var_154_string, int var_155_int)
{
...
// @pe
void func_3008(float var_71_float, cvector var_72_cvector, cvector var_73_cvector)
{
...
void func_3527(int var_148_int)
{
	...
	for(;;) {
		...
		func_3520(var_154_string, var_155_int);
...
// @pe
void func_3017(float var_80_float, cvector var_81_cvector)
{
...
void func_2506(float var_421_float, object var_422_object, float var_423_float, int var_424_int)
{
	...
	float var_459_float;
	func_2985(var_459_float, ((var_434_int + var_436_int) / 100.0), (float)1);
	float var_437_float;
	...
	float var_469_float;
	func_2992(var_469_float, (var_438_float - var_439_float), (float)0, (float)1);
...
// @pe
void func_3027(float var_68_float, cvector var_69_cvector, cvector var_70_cvector)
{
...
// @pe
void func_3544(int var_61_int)
{
	bool var_63_bool;
	func_3684(var_63_bool);
	if(var_63_bool != 0)
		var_61_int = 2;
	else
		var_61_int = 0;
...
// @pe
void func_3553(object var_60_object)
{
...
void func_3044(int var_123_int, string var_124_string)
{
	int var_126_int;
...
// @pe
void func_3561(int var_30_int, object var_31_object)
{
	object var_33_object;
...
void func_3049(float var_477_float)
{
...
// @pe
void func_3571(object var_73_object)
{
...
// @pe
void func_3579(int var_27_int, object var_28_object)
{
	object var_31_object;
		...
		if(var_141_bool != 0) {
			...
			if(var_102_float >= (var_83_float * var_83_float)) {
				...
				if(var_269_bool != 0) {
					...
					@StopAsync();
					bool var_527_bool;
					func_2134(var_105_float, var_527_bool);
					var_528_bool = !var_527_bool; //@nz
					if(var_528_bool == 0) goto Label_1737;
					bool var_529_bool;
					func_2620(var_529_bool, var_0_object);
					if(!var_529_bool) { //@nz
						goto Label_1747;
					}
					var_0_object->GetPFPosition(var_96_cvector); //@t
					...
					func_1838(var_104_bool, var_105_float, var_534_bool, var_535_float);
					var_536_bool = !var_534_bool; //@nz
					if(var_536_bool == 0) goto Label_1737;
					goto Label_1747;
			}
				bool var_537_bool; float var_538_float;
				var_83_float = var_538_float;
				func_1838(var_104_bool, var_105_float, var_537_bool, var_538_float);
				if(!var_537_bool) { //@nz
					goto Label_1747;
				}
				var_99_bool = true;
