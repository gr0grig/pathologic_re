...
void func_364(object var_27_object)
{
...
void func_338(void)
{
	...
	@CreateDiaryEntry(var_66_object, 61, 2, 512143);
	bool var_70_bool; object var_71_object;
	var_66_object = var_71_object;
	func_377(var_70_bool, var_71_object, 11);
}
EMIT "Stack[-1] = 0";
...
void func_377(bool var_18_bool, object var_19_object, int var_20_int)
{
	...
	if(!var_25_object) { //@nz
		@Trace("Can't find diary parent with id: " + var_20_int);
		var_18_bool = false;
	}
...
void func_351(void)
{
	...
	@CreateDiaryEntry(var_14_object, 62, 2, 512144);
	bool var_18_bool; object var_19_object;
	var_14_object = var_19_object;
	func_377(var_18_bool, var_19_object, 11);
}
EMIT "Stack[-1] = 0";
