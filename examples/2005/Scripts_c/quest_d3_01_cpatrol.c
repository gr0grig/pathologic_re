...
void func_2057(bool var_48_bool, string var_49_string, string var_50_string)
{
...
void func_1807(bool var_31_bool, object var_32_object, float var_33_float)
{
	...
	func_1970(var_58_cvector, (var_47_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_73_bool != 0) {
		...
		if(var_51_bool == 0) goto Label_1869;
...
void func_2069(object var_127_object)
{
	bool var_129_bool;
		...
		if(var_91_bool != 0) {
			...
			if(var_52_float >= (var_33_float * var_33_float)) {
				...
				if(var_251_bool != 0) {
					...
					@StopAsync();
					bool var_509_bool;
					func_876(var_55_float, var_509_bool);
					var_510_bool = !var_509_bool; //@nz
					if(var_510_bool == 0) goto Label_479;
					bool var_511_bool;
					func_1646(var_511_bool, var_0_object);
					if(!var_511_bool) { //@nz
						goto Label_489;
					}
					var_0_object->GetPFPosition(var_46_cvector); //@t
					...
					func_580(var_54_bool, var_55_float, var_516_bool, var_517_float);
					var_518_bool = !var_516_bool; //@nz
					if(var_518_bool == 0) goto Label_479;
					goto Label_489;
			}
				bool var_519_bool; float var_520_float;
				var_33_float = var_520_float;
				func_580(var_54_bool, var_55_float, var_519_bool, var_520_float);
				if(!var_519_bool) { //@nz
					goto Label_489;
				}
				var_49_bool = true;
...
void func_1532(float var_403_float, object var_404_object, float var_405_float, int var_406_int)
{
	...
	float var_441_float;
	func_1984(var_441_float, ((var_416_int + var_418_int) / 100.0), (float)1);
	float var_419_float;
	...
	float var_451_float;
	func_1991(var_451_float, (var_420_float - var_421_float), (float)0, (float)1);
...
void func_2089(void)
{
	func_2099();
	bool var_48_bool;
	func_2057(var_48_bool, "quest_d3_01", "patrol_talk");
}
...
void func_2099(void)
{
	...
	func_2125(var_30_bool, var_31_object, 25);
}
EMIT "Stack[-1] = 0";
...
void func_2112(object var_39_object)
{
...
void func_580(object var_0_object, object var_1_object, bool var_352_bool, float var_353_float)
{
	...
	if(var_359_bool != 0) {
		...
		func_919(var_361_string);
		bool var_474_bool;
		func_1646(var_474_bool, var_0_object);
		if(!var_474_bool) { //@nz
			@StopAsync();
			var_352_bool = false;
			return 8;
		...
		func_541(var_361_string, var_477_float, var_478_int);
		var_360_int = 1;
		...
		for(;;) {
			...
			if(!var_359_bool) { //@nz
				...
				func_919(var_361_string);
				bool var_500_bool;
				func_1646(var_500_bool, var_0_object);
				if(!var_500_bool) { //@nz
					@StopAsync();
					var_352_bool = false;
					return 8;
				...
				func_541(var_361_string, var_503_float, var_504_int);
				var_360_int += 1;
			}
	}
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_91_object, object var_92_object)
{
	...
	var_3_string = false;
	if(1 != 0) {
		func_127(var_92_object, "Neutral");
		var_0_object->SetMessage(509122); //@t
		var_0_object->ClearReplies(); //@t
		var_0_object->AddReply(509123, 10004, 10003); //@t
		goto Label_97;
...
void func_2125(bool var_30_bool, object var_31_object, int var_32_int)
{
	object var_39_object;
	func_2112(var_39_object);
...
void func_1875(void)
{
	...
	bool var_131_bool;
	func_2306(var_131_bool);
	if(var_131_bool != 0) {
	} else {
		@HasAnimationTrack(var_130_bool, "head");
		if(var_130_bool == 0) goto Label_1891;
		@UnlookAsync("head");
	}
Label_1891:
...
void func_1892(string var_116_string)
{
...
void func_1382(object var_0_object, object var_1_object)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			func_1980(var_29_float, var_1_object, var_31_cvector);
...
void func_1899(string var_102_string, bool var_103_bool)
{
...
void func_1905(object var_151_object)
{
	float var_154_float;
...
// @pe
void func_127(object var_2_object, string var_98_string)
{
	bool var_99_bool;
	...
	if(var_98_string == "")
		...
		var_103_bool = true;
	func_1899(var_102_string, var_103_bool);
...
void func_1923(string var_113_string)
{
	...
	if(var_135_bool == 0) goto Label_1943;
}
...
{
	func_2069(var_0_object);
}


void func_924(int var_464_int)
{
	var_464_int = 0;
}
...
void func_933(bool var_489_bool)
{
	var_489_bool = true;
}
...
void func_1964(object var_86_object)
{
...
void func_1714(object var_21_object, int var_22_int, float var_23_float)
{
	...
	if(var_42_bool != 0) {
		...
		func_1970(var_49_cvector, var_50_cvector);
...
void func_1970(cvector var_49_cvector, cvector var_50_cvector)
{
...
void func_2230(object var_18_object)
{
	...
	if(var_47_bool != 0) {
		...
		func_2002(var_51_bool, var_52_object, -0.2);
	}
...
void func_1980(float var_29_float, cvector var_30_cvector, cvector var_31_cvector)
{
...
// @pe
void func_1984(float var_441_float, float var_442_float, float var_443_float)
{
...
// @pe
void func_1991(float var_80_float, float var_81_float, float var_82_float, float var_83_float)
{
...
void func_717(bool var_490_bool, float var_491_float)
{
...
// @pe
void func_2002(bool var_51_bool, object var_52_object, float var_53_float)
{
	if(!var_52_object) { //@nz
		var_51_bool = false;
		return 0;
...
void func_1510(bool var_62_bool, object var_63_object, string var_64_string, float var_65_float, float var_66_float, float var_67_float)
{
	...
	func_1991(var_80_float, (var_69_float + var_65_float), var_82_float, var_83_float);
...
void func_2037(float var_459_float)
{
...
void func_2047(float var_58_float)
{
