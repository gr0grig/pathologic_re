...
void func_108(bool var_0_bool, string var_12_string)
{
	bool var_14_bool;
...
// @pe
void func_182(bool var_14_bool, int var_15_int)
{
	var_14_bool = false;
	if(var_15_int >= 1) {
		if(var_15_int < 1000)
...
void func_152(object var_20_object)
{
...
void func_158(object var_14_object, object var_15_object, string var_16_string, string var_17_string, string var_18_string)
{
