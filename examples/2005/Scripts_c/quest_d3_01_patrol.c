...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, object var_7_object, int var_8_int, int var_9_int, bool var_10_bool, float var_11_float, int var_12_int, bool var_13_bool, object var_14_object, bool var_15_bool, cvector var_16_cvector, cvector var_17_cvector, bool var_18_bool)
	{
		if(1 != 0) {
			func_1992();
			if(var_17_cvector == 9981) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509102); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509103, 9989, 9982); //@t
				var_0_object->AddReply(509104, 9985, 9983); //@t
				return 0;
			}
			if(var_17_cvector == 9985) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509106); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509107, 9984, 9986); //@t
				return 0;
			}
			if(var_17_cvector == 9984) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509105); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509108, 9988, 9987); //@t
				return 0;
			}
			if(var_17_cvector == 9988) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509109); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509112, 9992, 9991); //@t
				return 0;
			}
			if(var_17_cvector == 9989) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509110); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509111, 9992, 9990); //@t
				return 0;
			}
			if(var_17_cvector == 9992) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509113); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509114, 9994, 9993); //@t
				var_0_object->AddReply(509116, -1, 9995); //@t
				return 0;
			}
			if(var_17_cvector == 9994) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509115); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509117, -1, 9997); //@t
				var_0_object->AddReply(509118, 9999, 9998); //@t
				return 0;
			}
			if(var_17_cvector == 9999) {
				func_132(var_18_bool, "Neutral");
				var_0_object->SetMessage(509119); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(509120, -1, 10000); //@t
				return 0;
			}
			var_3_string = true;
			bool var_97_bool;
			func_2306(var_97_bool);
			if(var_97_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
task task_3
{
	...
	{
		if(var_17_bool == 1) {
			func_2133(var_1_object);
		} else {
			int var_25_int;
			func_1222(var_16_cvector, var_25_int, var_25_int);
		}
...
maintask task_5
{
	...
	{
		var_2_object = true;
		func_1458(var_15_cvector, var_16_bool);
	}
	...
	{
		bool var_18_bool;
		func_1422(var_17_object, var_18_bool);
		if(var_18_bool != 0) {
			func_1542();
			object var_19_object;
			func_1424(var_19_object, var_19_object);
		}
	}
...
void OnHit2(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, object var_5_object, int var_6_int, int var_7_int, bool var_8_bool, float var_9_float, int var_10_int, bool var_11_bool, object var_12_object, bool var_13_bool, cvector var_14_cvector, cvector var_15_cvector, bool var_16_bool, object var_17_object, int var_18_int, float var_19_float, float var_20_float, cvector var_21_cvector, cvector var_22_cvector)
{
	...
	func_1858(var_25_float, var_26_cvector, var_27_cvector);
}
...
void func_0(object var_0_object, int var_20_int, object var_21_object)
{
	...
	func_1883(var_31_bool, var_32_object, 70.0);
	if(!var_31_bool) { //@nz
		var_20_int = -2;
		return 8;
	}
...
void func_2304(string var_81_string)
{
	var_81_string = "ui/NPC_Citizen2_b.png";
}


void func_2306(bool var_73_bool)
{
	var_73_bool = false;
}
...
void func_2056(float var_29_float, cvector var_30_cvector, cvector var_31_cvector)
{
...
// @pe
void func_1548(string var_431_string, int var_432_int)
{
	if(var_432_int == 2) {
		var_431_string = "fire";
		return 0;
...
// @pe
void func_2060(float var_441_float, float var_442_float, float var_443_float)
{
...
void func_1294(object var_90_object)
{
...
// @pe
void func_2067(float var_80_float, float var_81_float, float var_82_float, float var_83_float)
{
...
void func_2040(object var_86_object)
{
...
void func_793(bool var_490_bool, float var_491_float)
{
	...
	@WaitForAnimEnd();
	func_995(var_495_bool);
}


void func_1562(cvector var_51_cvector, object var_52_object)
{
...
// @pe
void func_2078(bool var_51_bool, object var_52_object, float var_53_float)
{
	if(!var_52_object) { //@nz
		var_51_bool = false;
		return 0;
...
void func_1569(bool var_47_bool, object var_48_object)
{
	bool var_50_bool;
...
void func_1574(bool var_70_bool, object var_71_object, string var_72_string)
{
...
void func_1586(bool var_62_bool, object var_63_object, string var_64_string, float var_65_float, float var_66_float, float var_67_float)
{
	...
	func_2067(var_80_float, (var_69_float + var_65_float), var_82_float, var_83_float);
	var_63_object->SetProperty(var_64_string, var_80_float);
	var_62_bool = true;
}


void func_820(object var_0_object, bool var_291_bool, float var_292_float)
{
	...
	for(;;) {
		...
		bool var_347_bool;
		func_1722(var_347_bool, var_0_object);
		if(!var_347_bool) { //@nz
			var_291_bool = false;
			return 10;
		}
		...
		if(var_302_float < (var_292_float * var_292_float)) {
			...
			func_656(var_301_cvector, var_302_float, var_352_bool, var_353_float);
			var_291_bool = true;
			return 10;
		}
		@sync();
	}
	func_995(var_302_float);
	var_291_bool = false;
}


void func_1078(object var_2_object)
{
	@KillTimer(1);
	if(var_2_object != 0) {
		var_2_object = false;
	...
	func_1244(var_17_bool);
}


void func_2046(cvector var_49_cvector, cvector var_50_cvector)
{
...
void func_2302(string var_80_string)
{
	var_80_string = "ui/NPC_Citizen2.png";
}


void func_2113(float var_459_float)
{
...
void func_1858(object var_23_object, cvector var_26_cvector, cvector var_27_cvector)
{
...
void func_582(object var_1_object, object var_2_object, bool var_4_bool)
{
...
void func_1608(float var_403_float, object var_404_object, float var_405_float, int var_406_int)
{
	int var_416_int; int var_418_int;
	object var_423_object;
	var_404_object = var_423_object;
	bool var_422_bool;
	func_1574(var_422_bool, var_423_object, "health");
	if(!var_422_bool) //@nz
		var_403_float = 0.0;
	bool var_426_bool; object var_427_object;
	func_1574(var_426_bool, var_427_object, "armor");
	if(!var_426_bool) //@nz
		var_416_int = 0;
	else
	...
	func_1574(var_437_bool, var_438_object, var_439_string);
	if(!var_437_bool) //@nz
		var_418_int = 0;
	else
	...
	float var_441_float;
	func_2060(var_441_float, ((var_416_int + var_418_int) / 100.0), (float)1);
	float var_419_float;
...
void func_2123(float var_58_float)
{
...
void func_332(void)
{
	...
	object var_31_object;
	object var_27_object;
	func_353(var_24_bool, var_25_float, var_26_int, var_27_object, var_31_object, var_31_object, true, 180.0);
}
EMIT "Stack[-1] = 0";


void func_1872(object var_237_object)
{
...
void func_2133(object var_127_object)
{
	bool var_129_bool;
...
void func_1883(bool var_31_bool, object var_32_object, float var_33_float)
{
	...
	func_2046(var_58_cvector, (var_47_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_73_bool;
	func_2306(var_73_bool);
	if(var_73_bool != 0) {
	} else {
		@HasAnimationTrack(var_51_bool, "head");
		if(var_51_bool == 0) goto Label_1945;
...
// @pe
void func_347(float var_400_float)
{
	var_400_float = 0.3;
}
...
// @pe
void func_350(int var_407_int)
{
	var_407_int = 0;
}


void func_1120(object var_0_object, object var_1_object, bool var_163_bool, object var_164_object, float var_165_float, float var_166_float, bool var_167_bool, bool var_168_bool)
{
	...
	for(;;) {
		...
		if(var_183_float > (var_165_float * var_165_float)) {
			...
			if(var_179_object != null) {
				if(var_178_bool == 0) goto Label_1173;
				var_178_bool = false;
				...
				if(!var_177_bool) { //@nz
						...
						if(!var_177_bool) { //@nz
							if(var_0_object == 0) goto Label_1192;
							var_179_object = null;
						}
					EMIT "GOTO 0x4a9";
...
void func_863(object var_0_object, bool var_306_bool)
{
	cvector var_312_cvector; cvector var_313_cvector;
	bool var_317_bool;
	func_1722(var_317_bool, var_0_object);
	if(!var_317_bool) { //@nz
		var_306_bool = false;
		return 10;
	}
	bool var_320_bool;
	float var_316_float;
	func_952(var_316_float, var_320_bool);
	if(var_320_bool != 0) {
...
void func_353(object var_0_object, string var_3_string, object var_5_object, object var_31_object, bool var_32_bool, float var_33_float, bool var_140_bool, bool var_232_bool)
{
	...
	func_582(var_53_cvector, var_54_bool, var_55_float);
	var_5_object = 0;
...
Label_393:
	for(;;) {
		...
		bool var_92_bool;
		func_1722(var_92_bool, var_0_object);
		if(var_92_bool != 0) {
			if(!var_3_string) //@nz
				var_91_bool = true;
		}
		if(var_91_bool != 0) {
			func_995(var_55_float);
			...
			if(var_52_float >= ((400.0 + var_45_float) * (400.0 + var_45_float))) {
				...
				TaskCall(3);
				func_1015(var_142_bool, var_134_bool, var_0_object, var_136_float, 10000.0, true, false);
				TaskReturn();
				if(!var_140_bool) { //@nz
				} else {
					var_49_bool = false;
			...
			if(var_52_float >= (var_33_float * var_33_float)) {
				...
				if(!var_54_bool) { //@nz
					...
					TaskCall(3);
					func_1015(var_234_bool, var_226_bool, var_0_object, var_228_float, 10000.0, true, false);
					TaskReturn();
					if(!var_232_bool) { //@nz
						goto Label_565;
					}
				...
				if(!var_49_bool) { //@nz
					...
					var_49_bool = true;
					bool var_248_bool;
					func_1722(var_248_bool, var_0_object);
					if(!var_248_bool) { //@nz
						goto Label_565;
					}
				}
				...
				if(var_251_bool != 0) {
					...
					func_820(var_55_float, var_291_bool, var_292_float);
					@StopAsync();
				} else {
					@Face(var_0_object);
					...
					@StopAsync();
					bool var_509_bool;
					func_952(var_55_float, var_509_bool);
					var_510_bool = !var_509_bool; //@nz
					if(var_510_bool == 0) goto Label_555;
					bool var_511_bool;
					func_1722(var_511_bool, var_0_object);
					if(!var_511_bool) { //@nz
						goto Label_565;
					}
					var_0_object->GetPFPosition(var_46_cvector); //@t
					@GetPFPosition(var_47_cvector);
					if(!(((var_46_cvector - var_47_cvector) | (var_46_cvector - var_47_cvector)) < (var_292_float * var_292_float))) goto Label_555;
					bool var_516_bool; float var_517_float;
					var_33_float = var_517_float;
					func_656(var_54_bool, var_55_float, var_516_bool, var_517_float);
					var_518_bool = !var_516_bool; //@nz
					if(var_518_bool == 0) goto Label_555;
					goto Label_565;
			}
				bool var_519_bool; float var_520_float;
				var_33_float = var_520_float;
				func_656(var_54_bool, var_55_float, var_519_bool, var_520_float);
				if(!var_519_bool) { //@nz
					goto Label_565;
				}
				var_49_bool = true;
...
void func_617(object var_0_object, float var_389_float, int var_390_int)
{
	...
	if(var_394_object == var_0_object) {
		...
		func_350(var_409_int);
		var_407_int = var_406_int;
		func_1608(var_403_float, var_404_object, var_405_float, var_406_int);
		var_403_float = var_396_float;
		int var_464_int;
		func_1000(var_464_int);
		@ReportHit(var_0_object, var_464_int, var_396_float, var_405_float);
		object var_465_object; float var_466_float;
		var_394_object = var_465_object;
		var_396_float = var_466_float;
		func_1007();
	}
}
EMIT "Stack[-3] = 0";
...
// @pe
void func_1385(string var_112_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_891(bool var_304_bool)
{
	bool var_305_bool = false;
	bool var_306_bool;
	func_863(var_305_bool, var_306_bool);
	if(var_306_bool != 0) {
		bool var_323_bool;
		func_907(var_304_bool, var_305_bool, var_323_bool);
		if(var_323_bool != 0)
			var_305_bool = true;
	}
	if(var_305_bool != 0) {
...
// @pe
void func_2176(object var_21_object)
{
	int var_22_int;
	func_2170(var_22_int);
	if(var_22_int == 1)
...
void func_132(object var_2_object, string var_98_string)
{
	...
	if(var_98_string == "")
		...
		var_103_bool = true;
	func_1975(var_102_string, var_103_bool);
	var_2_object = var_98_string;
	
}


void func_907(object var_0_object, bool var_4_bool, bool var_323_bool)
{
	...
	for(;;) {
		...
		func_1562(var_334_cvector, var_0_object);
		...
		if(var_331_float < var_4_bool) {
				...
				@WaitForAnimEnd();
				func_995(var_333_cvector);
				@StopAsync();
				@SetSpeed([0.0, 0.0, 0.0]);
				var_330_bool = true;
				bool var_345_bool;
				func_863(var_333_cvector, var_345_bool);
				var_346_bool = !var_345_bool; //@nz
				if(var_346_bool == 0) goto Label_948;
		}
		for(;;) {
...
void func_2189(string var_33_string)
{
...
void func_1422(object var_2_object, bool var_18_bool)
{
	var_18_bool = var_2_object;
}


void func_656(object var_0_object, object var_1_object, bool var_352_bool, float var_353_float)
{
	string var_361_string;
	func_995(var_361_string);
	int var_358_int;
	...
	@WaitForAnimEnd();
	int var_360_int;
	func_963(var_360_int, var_361_string);
	bool var_386_bool;
	func_1722(var_386_bool, var_0_object);
	if(!var_386_bool) { //@nz
		@StopAsync();
		var_352_bool = false;
		return 8;
	...
	func_617(var_361_string, var_389_float, var_390_int);
	bool var_359_bool;
	...
	if(var_359_bool != 0) {
		...
		func_995(var_361_string);
		bool var_474_bool;
		func_1722(var_474_bool, var_0_object);
		if(!var_474_bool) { //@nz
			@StopAsync();
			var_352_bool = false;
			return 8;
		...
		var_353_float = var_477_float;
		func_617(var_361_string, var_477_float, var_478_int);
		var_360_int = 1;

		for(;;) {
			var_361_string = (("attack_middle" + var_478_int) + "_") + var_360_int;
			...
			if(!var_359_bool) { //@nz
				...
				func_995(var_361_string);
				bool var_500_bool;
				func_1722(var_500_bool, var_0_object);
				if(!var_500_bool) { //@nz
					@StopAsync();
					var_352_bool = false;
					return 8;
				...
				var_353_float = var_503_float;
				var_358_int = var_504_int;
				func_617(var_361_string, var_503_float, var_504_int);
				var_360_int += 1;
			}
	}
		...
		bool var_489_bool;
		func_1009(var_489_bool);
		if(var_489_bool != 0) {
			bool var_490_bool;
			func_793(var_490_bool, 0.75);
			@StopAsync();
		}
		var_352_bool = true;
		return 8;
...
void func_1681(bool var_107_bool, object var_108_object)
{
	bool var_110_bool;
...
// @pe
void func_1424(object var_2_object, object var_19_object)
{
	object var_21_object;
...
void func_1686(bool var_96_bool, object var_97_object)
{
	...
	if(var_106_bool != 0) {
		...
		func_1681(var_107_bool, var_108_object);
		if(var_107_bool != 0)
			var_103_bool = true;
	}
	if(var_103_bool != 0) {
...
void func_1951(void)
{
	...
	bool var_134_bool;
	func_2306(var_134_bool);
	if(var_134_bool != 0) {
	} else {
		@HasAnimationTrack(var_133_bool, "head");
		if(var_133_bool == 0) goto Label_1967;
		@UnlookAsync("head");
	}
Label_1967:
...
void func_1968(string var_119_string)
{
...
void func_1458(object var_0_object, object var_1_object)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			func_2056(var_29_float, var_1_object, var_31_cvector);
...
void func_2230(object var_18_object)
{
	bool var_20_bool;
	...
	if(var_47_bool != 0) {
		...
		func_2078(var_51_bool, var_52_object, -0.2);
	}
...
void func_1975(string var_102_string, bool var_103_bool)
{
...
void func_952(object var_0_object, bool var_254_bool)
{
	bool var_256_bool;
...
void func_1722(bool var_92_bool, object var_93_object)
{
	...
	func_1574(var_114_bool, var_115_object, "noaccess");
	if(!var_114_bool) { //@nz
		var_92_bool = true;
		return 2;
	}
...
void func_1981(object var_151_object)
{
	float var_154_float;
...
void func_963(object var_2_object, object var_5_object)
{
	int var_374_int;
	if(!var_2_object) //@nz
		return 4;
...
// @pe
void func_1222(object var_0_object, object var_1_object, int var_25_int)
{
	if(var_25_int != 0)
		return 0;
	bool var_28_bool;
	func_1260(var_28_bool, var_1_object);
	if(!var_28_bool) //@nz
		var_0_object = true;
	@KillTimer(0);
	@Stop();
...
{
	bool var_20_bool;
	func_2306(var_20_bool);
	if(var_20_bool != 0)
		@lshStopSpeech();
}


void func_1999(string var_113_string)
{
	...
	if(var_135_bool == 0) goto Label_2019;
}


void func_1746(object var_34_object)
{
...
void func_1244(object var_0_object)
{
	var_0_object = true;
	@KillTimer(0);
	@Stop();
...
void func_995(object var_0_object)
{
	func_2133(var_0_object);
}


void func_1000(int var_464_int)
{
	var_464_int = 0;
}
...
void func_1002(void)
{
	func_1999("attack_stay");
}


// @pe
void func_1260(bool var_185_bool, object var_186_object)
{
	object var_188_object;
	var_186_object = var_188_object;
	bool var_187_bool;
	func_1722(var_187_bool, var_188_object);
...
void func_1009(bool var_489_bool)
{
	var_489_bool = true;
}


void func_1267(string var_203_string)
{
	var_203_string = "walk";
}


void func_1269(string var_204_string)
{
	var_204_string = "run";
}


void func_1011(int var_385_int)
{
	var_385_int = 1;
}
...
// @pe
void func_1271(object var_89_object)
{
...
void func_1013(float var_380_float)
{
	var_380_float = 0.5;
}


void func_1015(object var_2_object, bool var_134_bool, object var_135_object, float var_136_float, float var_137_float, bool var_138_bool, bool var_139_bool)
{
	object var_147_object;
	func_2133(var_147_object);
	@SetTimer(1, 5);
	bool var_145_bool;
	...
	if(var_145_bool != 0) {
		...
		func_1981(var_151_object);
	} else {
		var_2_object = false;
	}
	bool var_158_bool; object var_159_object;
	func_1569(var_158_bool, var_159_object);
	if(var_158_bool != 0) {
		object var_162_object;
		func_2040(var_162_object);
	...
	bool var_146_bool;
	func_1120(var_145_bool, var_146_bool, var_163_bool, var_164_object, var_165_float, var_166_float, var_167_bool, var_168_bool);
...
void func_2298(int var_79_int)
{
	var_79_int = 515572;
}


void func_2300(int var_78_int)
{
	var_78_int = 504031;
}


void func_1790(object var_21_object, int var_22_int, float var_23_float)
{
	...
	if(var_42_bool != 0) {
		...
		func_1562(var_51_cvector, var_52_object);
		var_51_cvector = var_50_cvector;
		func_2046(var_49_cvector, var_50_cvector);
	...
	if(var_39_int == 0) goto Label_1852;
	int var_40_int;
	...
	func_1858(var_68_float, var_69_cvector, var_70_cvector);
}
