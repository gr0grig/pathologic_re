...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object, bool var_12_bool)
	{
		if(1 != 0) {
			func_615();
			if(var_12_bool == 37103) {
				object var_17_object; object var_18_object;
				var_17_object = var_1_object;
				var_18_object = var_0_object;
				func_689();
			}
			if(var_11_object == 37100) {
				func_137(var_12_bool, "Neutral");
				var_0_object->SetMessage(535420); //@t
				var_0_object->ClearReplies(); //@t
				bool var_40_bool;
				func_696(var_1_object);
				if(var_40_bool != 0)
					var_0_object->AddReply(535421, 37102, 37101); //@t
				var_0_object->AddReply(535424, -1, 37104); //@t
				return 0;
			}
			if(var_11_object == 37102) {
				func_137(var_12_bool, "Neutral");
				var_0_object->SetMessage(535422); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(535423, -1, 37103); //@t
				return 0;
			}
			var_3_string = true;
			bool var_61_bool;
			func_687(var_61_bool);
			if(var_61_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	{
		func_393(var_10_bool, var_11_object);
	...
	{
		func_393(var_9_object, var_10_bool);
		bool var_14_bool = false;
		if(var_5_int != 0) {
			bool var_16_bool;
			func_326(var_16_bool);
			if(var_16_bool != 0)
				var_14_bool = true;
		}
		if(var_14_bool != 0) {
			object var_17_object;
			func_622(var_17_object);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, int var_11_int)
	{
		if(var_11_int == 10) {
			bool var_14_bool;
			func_355(var_9_object, var_10_bool, var_11_int, var_14_bool);
			if(var_14_bool != 0) {
				if(!var_2_object) { //@nz
					func_604(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_15_int, object var_16_object)
{
	...
	func_506(var_26_bool, var_27_object, 70.0);
	if(!var_26_bool) { //@nz
		var_15_int = -2;
		return 8;
	}
	...
	func_683(var_75_string);
	var_22_object->SetPhoto(var_75_string);
	string var_76_string;
	func_685(var_76_string);
...
void func_643(bool var_19_bool, string var_20_string, string var_21_string)
{
...
void func_137(object var_2_object, string var_93_string)
{
	...
	if(var_93_string == "")
		...
		var_98_bool = true;
	func_598(var_97_string, var_98_bool);
...
// @pe
void func_393(object var_2_object, string var_3_string)
{
	func_488();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_655(string var_51_string, int var_52_int)
{
...
void func_274(int var_5_int)
{
	...
	if(!var_15_bool) { //@nz
		bool var_18_bool;
		func_326(var_18_bool);
		if(var_18_bool != 0)
			var_16_bool = true;
	}
	if(var_16_bool != 0) {
		object var_19_object;
		func_622(var_19_object);
		@RemoveActor(var_19_object);
	}
}


void func_662(int var_45_int)
{
	...
	for(;;) {
		...
		func_655(var_51_string, var_52_int);
		...
		if(var_58_bool != 0) {
			...
			if(var_38_int == 1) {
				...
				goto Label_483;
					...
					bool var_70_bool;
					func_486(var_70_bool);
					var_71_bool = !var_70_bool; //@nz
					if(var_71_bool == 0) goto Label_478;
			}
		}
	Label_483:
		for(;;) {
...
void func_679(int var_74_int)
{
	var_74_int = 518097;
}


void func_681(int var_73_int)
{
	var_73_int = 518096;
}


void func_683(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen2.png";
}


void func_685(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen2_b.png";
}


void func_687(bool var_68_bool)
{
	var_68_bool = false;
}
...
{
	bool var_19_bool;
	func_643(var_19_bool, "quest_d3_02", "teleport");
}


// @pe
void func_696(bool var_106_bool)
{
	int var_108_int;
	func_638(var_108_int, "d3q02");
	if(var_108_int == 3)
		var_106_bool = true;
	var_106_bool = false;
}
...
void func_574(void)
{
	...
	bool var_137_bool;
	func_687(var_137_bool);
	if(var_137_bool != 0) {
	} else {
		@HasAnimationTrack(var_136_bool, "head");
		if(var_136_bool == 0) goto Label_590;
		@UnlookAsync("head");
	}
Label_590:
...
void func_326(bool var_16_bool)
{
	var_16_bool = true;
}
...
// @pe
void func_328(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_22_float, float var_23_float)
{
	bool var_24_bool;
	func_501(var_24_bool);
	if(!var_24_bool) //@nz
		return 0;
...
void func_591(string var_122_string)
{
...
void func_598(string var_97_string, bool var_98_bool)
{
...
void func_604(object var_28_object)
{
	float var_31_float;
...
void func_355(object var_0_object, object var_1_object, bool var_4_bool, bool var_14_bool)
{
	if(var_4_bool == null)
		var_14_bool = false;
	float var_18_float;
	func_493(var_18_float, var_4_bool);
...
void func_486(bool var_70_bool)
{
	var_70_bool = true;
}
...
void func_493(float var_18_float, object var_19_object)
{
...
void func_622(object var_17_object)
{
	object var_19_object;
	@self(var_19_object);
...
void func_628(cvector var_53_cvector, cvector var_54_cvector)
{
...
void func_501(bool var_15_bool)
{
	bool var_17_bool;
...
void func_249(float var_11_float, float var_12_float)
{
	
Label_250:
	for(;;) {
		bool var_15_bool;
		func_501(var_15_bool);
		var_18_bool = !var_15_bool; //@nz
		if(var_18_bool == 0) goto Label_258;
		@Hold();
	}
...
Label_258:
	...
	float var_13_float;
	func_328(var_10_bool, var_22_float, var_23_float, var_13_float, var_14_float, var_22_float, var_23_float);
	@sync();
	goto Label_250;
}
EMIT "Return(); Pop(2)";
...
void func_506(bool var_26_bool, object var_27_object, float var_28_float)
{
	...
	func_628(var_53_cvector, (var_42_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_68_bool;
	func_687(var_68_bool);
	if(var_68_bool != 0) {
	} else {
		@HasAnimationTrack(var_46_bool, "head");
		if(var_46_bool == 0) goto Label_568;
...
void func_638(int var_108_int, string var_109_string)
{
	int var_111_int;
