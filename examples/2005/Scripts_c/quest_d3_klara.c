...
void func_0(object var_0_object, int var_7_int, object var_8_object)
{
	...
	func_616(var_20_object);
	var_20_object = var_19_object;
	func_443(var_18_bool, var_19_object);
	bool var_113_bool; object var_114_object;
	var_8_object = var_114_object;
	func_358(var_113_bool, var_114_object, 70.0);
	if(!var_113_bool) { //@nz
		var_7_int = -2;
		return 8;
	}
...
void func_581(string var_212_string)
{
...
// @pe
void func_652(bool var_193_bool)
{
	int var_195_int;
	func_632(var_195_int, "ood3Klara1");
	if(var_195_int == 0) {
		var_193_bool = true;
		return 0;
	}
...
void func_588(string var_184_string, bool var_185_bool)
{
...
void func_81(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_173_object, object var_174_object)
{
	...
	var_3_string = false;
	if(1 != 0) {
		func_149(var_174_object, "Neutral");
		var_0_object->SetMessage(510202); //@t
		var_0_object->ClearReplies(); //@t
		bool var_193_bool;
		func_652(var_173_object);
		if(var_193_bool != 0)
			var_0_object->AddReply(534060, 11250, 35646); //@t
		var_0_object->AddReply(510203, -1, 11249); //@t
		var_0_object->AddReply(536145, -1, 37905); //@t
...
void func_594(bool var_52_bool, string var_53_string)
{
	bool var_55_bool;
	bool var_56_bool;
	func_689(var_56_bool);
	if(var_56_bool != 0) {
...
// @pe
void func_149(object var_2_object, string var_180_string)
{
	bool var_181_bool;
	func_689(var_181_bool);
	if(!var_181_bool) //@nz
		return 0;
	...
	if(var_180_string == "")
		...
		var_185_bool = true;
	func_588(var_184_string, var_185_bool);
	var_2_object = var_180_string;
	
}


void func_664(int var_164_int)
{
	int var_166_int;
...
void func_538(bool var_60_bool, object var_61_object)
{
	...
	for(;;) {
		...
		func_594(var_92_bool, var_93_string);
...
void func_358(bool var_113_bool, object var_114_object, float var_115_float)
{
	...
	func_622(var_140_cvector, (var_129_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_155_bool;
	func_689(var_155_bool);
	if(var_155_bool != 0) {
	} else {
		@HasAnimationTrack(var_133_bool, "head");
		if(var_133_bool == 0) goto Label_420;
...
void func_426(void)
{
	...
	bool var_227_bool;
	func_689(var_227_bool);
	if(var_227_bool != 0) {
	} else {
		@HasAnimationTrack(var_226_bool, "head");
		if(var_226_bool == 0) goto Label_442;
		@UnlookAsync("head");
	}
Label_442:
...
void func_683(int var_160_int)
{
	var_160_int = 502865;
}


void func_685(string var_162_string)
{
	var_162_string = "ui/NPC_Klara.png";
}


void func_622(cvector var_140_cvector, cvector var_141_cvector)
{
...
void func_687(string var_163_string)
{
	var_163_string = "ui/NPC_Klara_b.png";
}


void func_689(bool var_56_bool)
{
	var_56_bool = true;
}


void func_501(bool var_29_bool, object var_30_object)
{
	...
	for(;;) {
		...
		func_594(var_52_bool, var_53_string);
...
void func_632(int var_195_int, string var_196_string)
{
	int var_198_int;
...
void func_443(bool var_18_bool, object var_19_object)
{
	...
	if(var_25_int != 0) {
		...
		func_501(var_29_bool, var_30_object);
		if(!var_29_bool) { //@nz
			bool var_60_bool; object var_61_object;
			var_19_object = var_61_object;
			func_538(var_60_bool, var_61_object);
			if(!var_60_bool) { //@nz
				var_18_bool = false;
				return 4;
			}
		...
		func_538(var_105_bool, var_106_object);
		if(!var_105_bool) { //@nz
			bool var_108_bool; object var_109_object;
			var_19_object = var_109_object;
			func_501(var_108_bool, var_109_object);
			if(!var_108_bool) { //@nz
				var_18_bool = false;
				return 4;
			}
