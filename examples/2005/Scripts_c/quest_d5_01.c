maintask task_0
{
	void init(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object)
	{
		...
		func_504(var_8_object, var_9_object, "pt_d5q01_sobor_guard1", "pers_wasted_male", "d5q01_sobor_guard1.xml");
		var_5_object->add(var_8_object); //@t
		object var_26_object; object var_27_object;
		var_7_object = var_27_object;
		func_504(var_26_object, var_27_object, "pt_d5q01_sobor_guard2", "pers_wasted_male", "d5q01_sobor_guard2.xml");
		var_5_object->add(var_26_object); //@t
		object var_31_object; object var_32_object;
		var_7_object = var_32_object;
		func_504(var_31_object, var_32_object, "pt_d5q01_sobor_guard3", "pers_wasted_male", "d5q01_sobor_guard3.xml");
		var_5_object->add(var_31_object); //@t
		object var_36_object; object var_37_object;
		var_7_object = var_37_object;
		func_504(var_36_object, var_37_object, "pt_d5q01_theater_guard", "pers_whitemask", "d5q01_theater_guard.xml");
		...
		if(var_6_string == "factory") {
			...
			var_17_object = null;
				...
				if(var_18_int != 0) {
					...
					func_666(var_89_bool, var_90_int);
					if(var_89_bool != 0) {
						func_522("ifactory@door1", true);
						@SetVariable("d5q01PlayCutscene", 0);
						func_605(var_1_object);
						object var_110_object;
						func_475(var_110_object, "quest_d5_01_cutscene");
					}
				}
		}
	Label_309:
		...
		if(var_6_string == "cutscene_end") {
			...
			func_486(var_121_object, var_122_object, "pt_d5q01_patrol_corpse1", "pers_patrool", "dummy_dead_b.xml");
			var_1_object->add(var_121_object); //@t
			object var_126_object; object var_127_object;
			var_20_object = var_127_object;
			func_486(var_126_object, var_127_object, "pt_d5q01_patrol_corpse2", "pers_patrool", "dummy_dead_b.xml");
			var_1_object->add(var_126_object); //@t
			object var_131_object; object var_132_object;
			var_20_object = var_132_object;
			func_486(var_131_object, var_132_object, "pt_d5q01_grabitel_corpse1", "pers_grabitel", "dummy_dead_b.xml");
			var_1_object->add(var_131_object); //@t
			object var_136_object; object var_137_object;
			var_20_object = var_137_object;
			func_486(var_136_object, var_137_object, "pt_d5q01_grabitel_corpse2", "pers_grabitel", "dummy_dead_b.xml");
			var_1_object->add(var_136_object); //@t
			object var_141_object; object var_142_object;
			var_20_object = var_142_object;
			func_486(var_141_object, var_142_object, "pt_d5q01_patrol_survived", "pers_patrool", "d5q01_PatrolCS.xml");
...
void func_647(object var_173_object, string var_174_string)
{
	...
	if(var_173_object != 0) {
		...
		for(;;) {
			if(!(var_179_int < var_178_int)) goto Label_665;
...
void func_522(string var_29_string, bool var_30_bool)
{
...
void func_458(object var_275_object)
{
...
// @pe
void func_464(float var_219_float, float var_220_float, float var_221_float, float var_222_float)
{
...
void func_595(float var_197_float)
{
...
{
	func_626(var_5_object);
	object var_275_object;
	func_458(var_275_object);
	@RemoveActor(var_275_object);
}


// @pe
void func_666(bool var_89_bool, int var_90_int)
{
	var_89_bool = false;
	if(var_90_int >= 1) {
		if(var_90_int < 1000)
...
void func_539(string var_39_string, bool var_40_bool)
{
...
void func_475(object var_110_object, string var_111_string)
{
...
void func_605(object var_99_object)
{
...
void func_417(object var_189_object)
{
...
void func_486(object var_51_object, object var_52_object, string var_53_string, string var_54_string, string var_55_string)
{
...
void func_424(bool var_209_bool, object var_210_object, string var_211_string)
{
...
void func_361(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object)
{
	...
	func_539("ifactory_grid_door", false);
	func_647(var_1_object, "cleanup");
	var_1_object = null;
	func_522("factory@door1", true);
	@SetVariable("d5q01PlayCutscene", 0);
	@ReleaseTimeEvent(0);
...
// @pe
void func_560(bool var_186_bool, object var_187_object, float var_188_float)
{
...
void func_626(object var_264_object)
{
...
void func_436(bool var_201_bool, object var_202_object, string var_203_string, float var_204_float, float var_205_float, float var_206_float)
{
	...
	bool var_209_bool;
	func_424(var_209_bool, var_210_object, var_211_string);
	if(!var_209_bool) //@nz
		var_201_bool = false;
	float var_208_float;
	...
	func_464(var_219_float, (var_208_float + var_204_float), var_221_float, var_222_float);
...
void func_504(object var_8_object, object var_9_object, string var_10_string, string var_11_string, string var_12_string)
{
