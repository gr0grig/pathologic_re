...
maintask task_5
{
	...
	void OnAttacked(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, object var_5_object, int var_6_int, int var_7_int, bool var_8_bool, float var_9_float, int var_10_int, bool var_11_bool, object var_12_object, bool var_13_bool, object var_14_object)
	{
		...
		if(var_16_bool != 0) {
			bool var_18_bool;
			func_1856(var_18_bool, "quest_d5_01", "factory_fight");
		}
	}
...
void func_132(object var_2_object, string var_95_string)
{
	...
	if(var_95_string == "")
		...
		var_100_bool = true;
	func_1747(var_99_string, var_100_bool);
	var_2_object = var_95_string;
	
}


void func_1924(string var_119_string)
{
...
void func_520(object var_0_object, object var_1_object, bool var_348_bool, float var_349_float)
{
	...
	if(var_355_bool != 0) {
		...
		func_859(var_357_string);
		bool var_470_bool;
		func_1494(var_470_bool, var_0_object);
		if(!var_470_bool) { //@nz
			@StopAsync();
			var_348_bool = false;
			return 8;
		...
		func_481(var_357_string, var_473_float, var_474_int);
		var_356_int = 1;
		...
		for(;;) {
			...
			if(!var_355_bool) { //@nz
				...
				func_859(var_357_string);
				bool var_496_bool;
				func_1494(var_496_bool, var_0_object);
				if(!var_496_bool) { //@nz
					@StopAsync();
					var_348_bool = false;
					return 8;
				...
				func_481(var_357_string, var_499_float, var_500_int);
				var_356_int += 1;
			}
	}
...
// @pe
void func_1911(object var_18_object)
{
	int var_19_int;
	func_1905(var_19_int);
	if(var_19_int == 1)
...
void func_657(bool var_486_bool, float var_487_float)
{
...
void func_1812(object var_82_object)
{
...
void func_1562(object var_18_object, int var_19_int, float var_20_float)
{
	...
	if(var_39_bool != 0) {
		...
		func_1818(var_46_cvector, var_47_cvector);
...
void func_1818(cvector var_46_cvector, cvector var_47_cvector)
{
...
// @pe
void func_1828(float var_437_float, float var_438_float, float var_439_float)
{
...
// @pe
void func_1835(float var_447_float, float var_448_float, float var_449_float, float var_450_float)
{
...
void func_1846(float var_455_float)
{
...
void func_1723(void)
{
	...
	bool var_131_bool;
	func_2010(var_131_bool);
	if(var_131_bool != 0) {
	} else {
		@HasAnimationTrack(var_130_bool, "head");
		if(var_130_bool == 0) goto Label_1739;
		@UnlookAsync("head");
	}
Label_1739:
...
void func_1856(bool var_25_bool, string var_26_string, string var_27_string)
{
...
void func_1740(string var_116_string)
{
...
void func_1868(object var_123_object)
{
	bool var_125_bool;
...
void func_1747(string var_99_string, bool var_100_bool)
{
...
void func_2006(string var_77_string)
{
...
void func_2008(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_2012(object var_15_object)
{
	bool var_17_bool;
		...
		if(var_87_bool != 0) {
			...
			if(var_48_float >= (var_29_float * var_29_float)) {
				...
				if(var_247_bool != 0) {
					...
					@StopAsync();
					bool var_505_bool;
					func_816(var_51_float, var_505_bool);
					var_506_bool = !var_505_bool; //@nz
					if(var_506_bool == 0) goto Label_419;
					bool var_507_bool;
					func_1494(var_507_bool, var_0_object);
					if(!var_507_bool) { //@nz
						goto Label_429;
					}
					var_0_object->GetPFPosition(var_42_cvector); //@t
					...
					func_520(var_50_bool, var_51_float, var_512_bool, var_513_float);
					var_514_bool = !var_512_bool; //@nz
					if(var_514_bool == 0) goto Label_419;
					goto Label_429;
			}
				bool var_515_bool; float var_516_float;
				var_29_float = var_516_float;
				func_520(var_50_bool, var_51_float, var_515_bool, var_516_float);
				if(!var_515_bool) { //@nz
					goto Label_429;
				}
				var_45_bool = true;
...
void func_2010(bool var_70_bool)
{
	var_70_bool = false;
}
...
{
	func_1868(var_0_object);
}


void func_1888(int var_79_int)
{
	int var_81_int;
...
void func_1380(float var_399_float, object var_400_object, float var_401_float, int var_402_int)
{
	...
	float var_437_float;
	func_1828(var_437_float, ((var_412_int + var_414_int) / 100.0), (float)1);
	float var_415_float;
	...
	float var_447_float;
	func_1835(var_447_float, (var_416_float - var_417_float), (float)0, (float)1);
...
void func_873(bool var_485_bool)
{
	var_485_bool = true;
}
...
{
	bool var_25_bool;
	func_1856(var_25_bool, "quest_d5_01", "dead");
	object var_31_object;
...
void func_1771(string var_54_string)
{
	...
	if(var_76_bool == 0) goto Label_1791;
}
...
void func_1753(object var_147_object)
{
	float var_150_float;
...
void func_1655(bool var_28_bool, object var_29_object, float var_30_float)
{
	...
	func_1818(var_55_cvector, (var_44_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_70_bool;
	func_2010(var_70_bool);
	if(var_70_bool != 0) {
	} else {
		@HasAnimationTrack(var_48_bool, "head");
		if(var_48_bool == 0) goto Label_1717;
...
void func_1905(int var_113_int)
{
	int var_115_int;
