...
void func_1552(int var_100_int)
{
	int var_102_int;
...
// @pe
void func_1558(object var_13_object)
{
	int var_14_int;
	func_1552(var_14_int);
	if(var_14_int == 1)
		...
		if(var_79_bool != 0) {
			...
			if(var_40_float >= (var_21_float * var_21_float)) {
				...
				if(var_239_bool != 0) {
					...
					@StopAsync();
					bool var_497_bool;
					func_630(var_43_float, var_497_bool);
					var_498_bool = !var_497_bool; //@nz
					if(var_498_bool == 0) goto Label_233;
					bool var_499_bool;
					func_1263(var_499_bool, var_0_object);
					if(!var_499_bool) { //@nz
						goto Label_243;
					}
					var_0_object->GetPFPosition(var_34_cvector); //@t
					...
					func_334(var_42_bool, var_43_float, var_504_bool, var_505_float);
					var_506_bool = !var_504_bool; //@nz
					if(var_506_bool == 0) goto Label_233;
					goto Label_243;
			}
				bool var_507_bool; float var_508_float;
				var_21_float = var_508_float;
				func_334(var_42_bool, var_43_float, var_507_bool, var_508_float);
				if(!var_507_bool) { //@nz
					goto Label_243;
				}
				var_37_bool = true;
...
{
	func_1532(var_0_object);
}


void func_1571(string var_106_string)
{
...
void func_687(bool var_477_bool)
{
	var_477_bool = true;
}
...
{
	bool var_12_bool;
	func_1520(var_12_bool, "quest_d5_01", "dead");
...
// @pe
void func_1612(object var_10_object)
{
...
void func_334(object var_0_object, int var_1_int, bool var_340_bool, float var_341_float)
{
	...
	if(var_347_bool != 0) {
		...
		func_673(var_349_string);
		bool var_462_bool;
		func_1263(var_462_bool, var_0_object);
		if(!var_462_bool) { //@nz
			@StopAsync();
			var_340_bool = false;
			return 8;
		...
		func_295(var_349_string, var_465_float, var_466_int);
		var_348_int = 1;
		...
		for(;;) {
			...
			if(!var_347_bool) { //@nz
				...
				func_673(var_349_string);
				bool var_488_bool;
				func_1263(var_488_bool, var_0_object);
				if(!var_488_bool) { //@nz
					@StopAsync();
					var_340_bool = false;
					return 8;
				...
				func_295(var_349_string, var_491_float, var_492_int);
				var_348_int += 1;
			}
	}
...
void func_471(bool var_478_bool, float var_479_float)
{
...
void func_1520(bool var_12_bool, string var_13_string, string var_14_string)
{
	object var_16_object;
...
void func_1532(object var_115_object)
{
	bool var_117_bool;
