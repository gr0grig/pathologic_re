...
void func_640(string var_74_string)
{
...
void func_132(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_561(var_96_string, var_97_bool);
	var_2_object = var_92_string;
	
}


void func_644(bool var_67_bool)
{
	var_67_bool = false;
}
...
void func_595(string var_42_string, int var_43_int)
{
...
void func_469(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	if(var_67_bool != 0) {
		...
		if(var_45_bool == 0) goto Label_531;
...
void func_537(void)
{
	...
	bool var_128_bool;
	func_644(var_128_bool);
	if(var_128_bool != 0) {
	} else {
		@HasAnimationTrack(var_127_bool, "head");
		if(var_127_bool == 0) goto Label_553;
		@UnlookAsync("head");
	}
Label_553:
...
void func_554(string var_113_string)
{
...
void func_561(string var_96_string, bool var_97_bool)
{
	...
	for(;;) {
		...
		if(var_49_bool != 0) {
			...
			if(var_29_int == 0) {
				...
				func_595(var_58_string, var_59_int);
