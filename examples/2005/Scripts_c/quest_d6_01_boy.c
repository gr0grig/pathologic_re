	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 4342) {
				...
				var_0_object->SetMessage(503989); //@t
				var_0_object->ClearReplies(); //@t
				bool var_35_bool;
				func_673(var_1_object);
				if(var_35_bool != 0)
					var_0_object->AddReply(503991, 38108, 4344); //@t
				var_0_object->AddReply(536326, -1, 38107); //@t
				return 0;
			}
			if(var_10_bool == 38108) {
				func_137(var_11_object, "Neutral");
				var_0_object->SetMessage(536327); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(536328, 4345, 38109); //@t
				var_0_object->AddReply(503990, 4350, 4343); //@t
				return 0;
			}
			if(var_10_bool == 4350) {
				func_137(var_11_object, "Neutral");
				var_0_object->SetMessage(503997); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(503998, 4345, 4351); //@t
				var_0_object->AddReply(503999, 4347, 4353); //@t
				return 0;
			}
			if(var_10_bool == 4345) {
				func_137(var_11_object, "Neutral");
				var_0_object->SetMessage(503992); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(503993, 4347, 4346); //@t
				return 0;
			}
			if(var_10_bool == 4347) {
				func_137(var_11_object, "Neutral");
				var_0_object->SetMessage(503994); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(503995, -1, 4348); //@t
				var_0_object->AddReply(503996, -1, 4349); //@t
				return 0;
			}
			var_3_string = true;
			bool var_86_bool;
			func_665(var_86_bool);
			if(var_86_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
void func_587(string var_121_string)
{
...
// @pe
void func_673(bool var_105_bool)
{
	int var_107_int;
	func_628(var_107_int, "ood6Boy1");
	if(var_107_int == 0) {
		var_105_bool = true;
		return 0;
	}
...
void func_570(void)
{
	...
	bool var_136_bool;
	func_665(var_136_bool);
	if(var_136_bool != 0) {
	} else {
		@HasAnimationTrack(var_135_bool, "head");
		if(var_135_bool == 0) goto Label_586;
		@UnlookAsync("head");
	}
Label_586:
