	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 4366) {
				...
				var_0_object->SetMessage(504011); //@t
				var_0_object->ClearReplies(); //@t
				bool var_35_bool;
				func_609(var_1_object);
				if(var_35_bool != 0)
					var_0_object->AddReply(504012, 4369, 4367); //@t
				var_0_object->AddReply(504013, -1, 4368); //@t
				return 0;
			}
			if(var_10_bool == 4369) {
				func_137(var_11_object, "Neutral");
				var_0_object->SetMessage(504014); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(504015, -1, 4370); //@t
				var_0_object->AddReply(504016, -1, 4371); //@t
				return 0;
			}
			var_3_string = true;
			bool var_59_bool;
			func_601(var_59_bool);
			if(var_59_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	void init(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object)
	{
		...
		while(true != 0) {
			@Sleep(1);
			func_260(var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, (float)300, (float)100);
		}
	...
	{
		func_325(var_9_object, var_10_object);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, int var_10_int)
	{
		if(var_10_int == 10) {
			bool var_13_bool;
			func_287(var_8_bool, var_9_object, var_10_int, var_13_bool);
			if(var_13_bool != 0) {
				if(!var_2_object) { //@nz
					func_536(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_438(var_25_bool, var_26_object, 70.0);
	if(!var_25_bool) { //@nz
		var_14_int = -2;
		return 8;
	}
	...
	func_597(var_74_string);
	var_21_object->SetPhoto(var_74_string);
	string var_75_string;
	func_599(var_75_string);
...
void func_576(int var_37_int)
{
	...
	for(;;) {
		...
		func_569(var_43_string, var_44_int);
...
// @pe
void func_260(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_12_float, float var_13_float)
{
	bool var_14_bool;
...
// @pe
void func_325(object var_2_object, string var_3_string)
{
	func_420();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_137(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_530(var_96_string, var_97_bool);
...
void func_523(string var_121_string)
{
...
void func_593(int var_73_int)
{
	var_73_int = 515560;
}


void func_530(string var_96_string, bool var_97_bool)
{
		...
		if(var_50_bool != 0) {
			...
			if(var_30_int == 1) {
				...
				goto Label_415;
					...
					if(var_63_bool == 0) goto Label_410;
			}
		}
	Label_415:
		for(;;) {
...
void func_597(string var_74_string)
{
	var_74_string = "ui/NPC_Citizen3.png";
}


void func_599(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen3_b.png";
}


void func_536(object var_27_object)
{
	float var_30_float;
...
void func_601(bool var_67_bool)
{
	var_67_bool = false;
}
...
void func_603(void)
{
	@SetVariable("ood6Littleboy1", 1);
}


void func_287(object var_0_object, object var_1_object, bool var_4_bool, bool var_13_bool)
{
	if(var_4_bool == null)
		var_13_bool = false;
	float var_17_float;
	func_425(var_17_float, var_4_bool);
...
// @pe
void func_609(bool var_105_bool)
{
	int var_107_int;
	func_564(var_107_int, "ood6Littleboy1");
	if(var_107_int == 0) {
		var_105_bool = true;
		return 0;
	}
...
void func_418(bool var_62_bool)
{
	var_62_bool = true;
}
...
void func_425(float var_17_float, object var_18_object)
{
...
void func_554(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_433(bool var_14_bool)
{
	bool var_16_bool;
...
void func_564(int var_107_int, string var_108_string)
{
	int var_110_int;
...
void func_438(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_554(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_67_bool;
	func_601(var_67_bool);
	if(var_67_bool != 0) {
	} else {
		@HasAnimationTrack(var_45_bool, "head");
		if(var_45_bool == 0) goto Label_500;
...
void func_569(string var_43_string, int var_44_int)
{
...
void func_506(void)
{
	...
	bool var_136_bool;
	func_601(var_136_bool);
	if(var_136_bool != 0) {
	} else {
		@HasAnimationTrack(var_135_bool, "head");
		if(var_135_bool == 0) goto Label_522;
		@UnlookAsync("head");
	}
Label_522:
