...
void func_590(void)
{
	...
	bool var_139_bool;
	func_685(var_139_bool);
	if(var_139_bool != 0) {
	} else {
		@HasAnimationTrack(var_138_bool, "head");
		if(var_138_bool == 0) goto Label_606;
		@UnlookAsync("head");
	}
Label_606:
...
void func_607(string var_124_string)
{
...
void func_681(string var_74_string)
{
...
void func_685(bool var_67_bool)
{
	var_67_bool = false;
}
...
// @pe
void func_693(bool var_105_bool)
{
	int var_107_int;
	func_648(var_107_int, "ood6WastedMale1");
	if(var_107_int == 0) {
		var_105_bool = true;
		return 0;
	}
