...
void func_512(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_628(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_67_bool != 0) {
		...
		if(var_45_bool == 0) goto Label_574;
...
void func_643(string var_43_string, int var_44_int)
{
...
void func_580(void)
{
	...
	bool var_136_bool;
	func_675(var_136_bool);
	if(var_136_bool != 0) {
	} else {
		@HasAnimationTrack(var_135_bool, "head");
		if(var_135_bool == 0) goto Label_596;
		@UnlookAsync("head");
	}
Label_596:
...
void func_137(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_604(var_96_string, var_97_bool);
	var_2_object = var_92_string;
	
}


void func_650(int var_37_int)
{
...
void func_597(string var_121_string)
{
...
void func_667(int var_73_int)
{
	var_73_int = 515555;
}


void func_604(string var_96_string, bool var_97_bool)
{
	...
	for(;;) {
		...
		if(var_50_bool != 0) {
			...
			if(var_30_int == 0) {
				...
				func_643(var_59_string, var_60_int);
...
void func_671(string var_74_string)
{
...
void func_610(object var_27_object)
{
	float var_30_float;
...
void func_675(bool var_67_bool)
{
	var_67_bool = false;
}
...
// @pe
void func_683(bool var_105_bool)
{
	int var_107_int;
	func_638(var_107_int, "ood6WastedWoman1");
	if(var_107_int == 0) {
		var_105_bool = true;
		return 0;
	}
...
void func_628(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_638(int var_107_int, string var_108_string)
{
	int var_110_int;
