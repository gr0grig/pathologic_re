...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_620(var_74_string);
	var_21_object->SetPhoto(var_74_string);
	string var_75_string;
	func_622(var_75_string);
...
void func_137(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_553(var_96_string, var_97_bool);
...
void func_587(int var_107_int, string var_108_string)
{
	int var_110_int;
...
void func_461(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	bool var_67_bool;
	func_624(var_67_bool);
	if(var_67_bool != 0) {
	} else {
		@HasAnimationTrack(var_45_bool, "head");
		if(var_45_bool == 0) goto Label_523;
...
void func_592(string var_43_string, int var_44_int)
{
...
void func_529(void)
{
	...
	bool var_136_bool;
	func_624(var_136_bool);
	if(var_136_bool != 0) {
	} else {
		@HasAnimationTrack(var_135_bool, "head");
		if(var_135_bool == 0) goto Label_545;
		@UnlookAsync("head");
	}
Label_545:
...
void func_599(int var_37_int)
{
	...
	for(;;) {
		...
		func_592(var_43_string, var_44_int);
...
void func_546(string var_121_string)
{
...
void func_616(int var_73_int)
{
	var_73_int = 515567;
}


void func_553(string var_96_string, bool var_97_bool)
{
	...
	for(;;) {
		...
		if(var_50_bool != 0) {
			...
			if(var_30_int == 0) {
				...
				func_592(var_59_string, var_60_int);
...
void func_620(string var_74_string)
{
	var_74_string = "ui/NPC_Citizen3.png";
}


void func_622(string var_75_string)
{
...
void func_624(bool var_67_bool)
{
	var_67_bool = false;
}
...
// @pe
void func_632(bool var_105_bool)
{
	int var_107_int;
	func_587(var_107_int, "ood6Woman1");
	if(var_107_int == 0) {
		var_105_bool = true;
		return 0;
	}
