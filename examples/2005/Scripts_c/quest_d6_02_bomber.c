...
task task_6
{
	...
	void OnHear(bool var_0_bool, bool var_1_bool, cvector var_2_cvector, object var_3_object, object var_4_object, object var_5_object, bool var_6_bool, object var_7_object, float var_8_float, float var_9_float, object var_10_object, object var_11_object)
	{
		...
		func_2016(var_15_bool, var_16_object);
		if(!var_15_bool) //@nz
			return 2;
...
// @pe
void func_1560(float var_47_float, float var_48_float, float var_49_float, float var_50_float)
{
...
void func_1571(bool var_89_bool, int var_90_int, int var_91_int)
{
	int var_93_int;
...
// @pe
void func_1576(bool var_18_bool, object var_19_object, float var_20_float)
{
	if(!var_19_object) { //@nz
		var_18_bool = false;
		return 0;
...
void func_1611(float var_25_float)
{
...
void func_1654(int var_116_int)
{
	int var_118_int;
...
void func_1673(int var_65_int, int var_66_int)
{
...
void func_1704(string var_122_string)
{
...
void func_1229(bool var_29_bool, object var_30_object, string var_31_string, float var_32_float, float var_33_float, float var_34_float)
{
	...
	func_1560(var_47_float, (var_36_float + var_32_float), var_49_float, var_50_float);
...
void func_1745(void)
{
	...
	int var_112_int;
	func_1782(var_112_int, "bomber_mark");
	bool var_63_bool;
...
void func_1782(int var_77_int, string var_78_string)
{
	int var_80_int;
...
// @pe
void func_1892(object var_70_object)
{
...
void func_391(bool var_74_bool, object var_75_object, object var_76_object)
{
	...
	func_2016(var_80_bool, var_81_object);
	if(!var_80_bool) { //@nz
		var_74_bool = false;
		return 2;
	}
...
void func_410(bool var_14_bool, object var_15_object)
{
	...
	bool var_16_bool;
	func_2016(var_16_bool, var_17_object);
...
void func_924(bool var_0_bool, object var_50_object)
{
	...
	if(var_0_bool == null) {
		...
		func_2016(var_53_bool, var_54_object);
		if(var_53_bool != 0)
			var_51_bool = true;
	}
	if(var_51_bool != 0) {
...
void func_1949(object var_12_object)
{
	...
	if(var_14_bool != 0) {
		...
		func_1576(var_18_bool, var_19_object, 0.05);
	}
...
void func_1488(string var_95_string, int var_96_int, int var_97_int, int var_98_int)
{
	...
	bool var_103_bool;
	func_1571(var_103_bool, var_104_int, var_105_int);
	if(var_103_bool != 0) {
...
void func_2016(bool var_14_bool, object var_15_object)
{
