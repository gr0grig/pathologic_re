				...
				if(2 == var_955_int) {
					...
					if(2 == var_972_int) {
						...
						if(2 == var_975_int) {
							...
							if(!var_977_bool) { //@nz
								bool var_985_bool;
								func_3407(var_985_bool, 3);
							} else {
								bool var_987_bool;
								func_3111(var_987_bool, 0.5);
...
task task_1
{
	...
	void OnSee(cvector var_0_cvector, cvector var_1_cvector, object var_2_object, int var_3_int, int var_4_int, bool var_5_bool, bool var_6_bool, float var_7_float, int var_8_int, object var_9_object, object var_10_object, bool var_11_bool, object var_12_object, bool var_13_bool, object var_14_object, bool var_15_bool, object var_16_object, bool var_17_bool, bool var_18_bool, bool var_19_bool, bool var_20_bool)
	{
		...
		if(var_21_bool != 0) {
			...
			func_3507(var_28_bool, var_29_object);
		}
	}
...
void func_3111(bool var_987_bool, float var_988_float)
{
	float var_990_float;
	@rand(var_990_float);
...
void func_3625(string var_59_string)
{
	var_59_string = "pt_d9q02_patrol";
}


void func_3627(string var_55_string)
{
...
// @pe
void func_3116(bool var_56_bool, object var_57_object, float var_58_float)
{
	if(!var_57_object) { //@nz
		var_56_bool = false;
		return 0;
	...
	} else if(var_58_float < 0) {
			@SendWorldWndMessage(9);
	}
	for(;;) {
		float var_67_float;
		var_58_float = var_67_float;
		func_3161(var_67_float);
		bool var_71_bool; object var_72_object; float var_74_float;
		var_57_object = var_72_object;
		var_58_float = var_74_float;
		func_2723(var_71_bool, var_72_object, "reputation", var_74_float, (float)0, (float)1);
		var_56_bool = true;
		return 0;
...
void func_3629(string var_1077_string)
{
	var_1077_string = "d9q02_corpse";
}


void func_3631(string var_756_string)
{
	var_756_string = "pt_d9q02_center";
}


void func_3633(int var_983_int)
{
	var_983_int = 2;
}
...
void func_3635(void)
{
	...
	@irand(var_50_int, 6);
	bool var_49_bool;
	@AddItem(var_49_bool, "rusk", 0, (var_50_int + 1));
	bool var_56_bool; object var_57_object;
	object var_59_object;
	func_2699(var_59_object);
	var_59_object = var_57_object;
	func_3116(var_56_bool, var_57_object, -0.03);
}


// @pe
void func_2611(string var_121_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_3161(float var_67_float)
{
	object var_69_object;
	@CreateFloatVector(var_69_object);
	var_69_object->add(var_67_float);
	@SendWorldWndMessage(16, var_69_object);
}
EMIT "Stack[-1] = 0";
...
void func_3171(object var_216_object)
{
	bool var_218_bool;
...
void func_3180(string var_857_string, int var_858_int)
{
...
void func_3187(int var_851_int)
{
...
// @pe
void func_3210(object var_24_object)
{
	int var_25_int;
...
void func_2699(object var_59_object)
{
...
void func_3231(bool var_22_bool, object var_23_object, string var_24_string)
{
	...
	if(var_24_string == var_45_string) {
		...
		if(var_47_bool != 0) {
			...
			if(!(var_24_string == var_55_string)) goto Label_3274;
			...
			if(((var_33_cvector - var_34_cvector) | (var_33_cvector - var_34_cvector)) < 4000000.0) {
				...
				func_3507(var_59_bool, var_60_object);
				if(var_59_bool != 0) {
					var_22_bool = true;
					return 16;
				}
...
Label_3274:
	if(!(var_24_string == "player_shot")) goto Label_3303;
	...
	if(var_40_float < 360000.0) {
		...
		func_3507(var_71_bool, var_72_object);
		if(var_71_bool != 0) {
			var_22_bool = true;
			return 16;
		}
	}
	if(!(var_40_float < 12250000.0)) goto Label_3303;
	bool var_75_bool; object var_76_object;
	var_23_object = var_76_object;
	func_3471(var_75_bool, var_76_object);
	if(var_75_bool == 0) goto Label_3303;
	var_22_bool = true;
}


void func_2723(bool var_71_bool, object var_72_object, string var_73_string, float var_74_float, float var_75_float, float var_76_float)
{
	object var_80_object;
	var_72_object = var_80_object;
	string var_81_string;
	var_73_string = var_81_string;
	bool var_79_bool;
	func_2711(var_79_bool, var_80_object, var_81_string);
	if(!var_79_bool) //@nz
		var_71_bool = false;
	float var_78_float;
	var_72_object->GetProperty(var_73_string, var_78_float);
	float var_89_float; float var_91_float; float var_92_float;
	var_75_float = var_91_float;
	var_76_float = var_92_float;
	func_3100(var_89_float, (var_78_float + var_74_float), var_91_float, var_92_float);
	var_72_object->SetProperty(var_73_string, var_89_float);
	var_71_bool = true;
}
...
void func_1767(bool var_706_bool, object var_707_object)
{
	...
	bool var_708_bool;
	func_2859(var_708_bool, var_709_object);
	var_708_bool = var_706_bool;
}


// @pe
void func_3305(bool var_21_bool, object var_22_object)
{
	...
	if(var_51_bool != 0) {
		...
		func_3507(var_55_bool, var_56_object);
...
// @pe
void func_3356(bool var_21_bool, object var_22_object)
{
	object var_24_object;
	...
	for(;;) {
		...
		if(var_864_bool != 0) {
			...
			if(var_844_int == 0) {
				...
				func_3180(var_873_string, var_874_int);
...
void func_3370(bool var_42_bool)
{
...
void func_836(cvector var_0_cvector, cvector var_1_cvector, bool var_462_bool, float var_463_float)
{
	...
	if(var_469_bool != 0) {
		...
		bool var_583_bool;
		func_2859(var_583_bool, var_0_cvector);
		...
		for(;;) {
			...
			if(!var_469_bool) { //@nz
				...
				bool var_611_bool;
				func_2859(var_611_bool, var_0_cvector);
...
// @pe
void func_3407(bool var_87_bool, int var_88_int)
{
...
// @pe
void func_3453(bool var_43_bool, object var_44_object)
{
...
// @pe
void func_3471(bool var_47_bool, object var_48_object)
{
...
void func_2462(object var_21_object)
{
	...
	var_21_object = var_98_object;
	func_2495(var_98_object);
}


// @pe
void func_3489(bool var_27_bool, object var_28_object)
{
...
// @pe
void func_3507(bool var_21_bool, object var_22_object)
{
	var_23_int = GlobalVars[2];
	if(var_23_int == 7)
		var_21_bool = false;
...
// @pe
void func_2495(object var_98_object)
{
...
void func_3525(bool var_991_bool)
{
	string var_994_string;
	func_3631(var_994_string);
	int var_993_int;
...
// @pe
void func_3536(bool var_755_bool)
{
...
void func_2520(object var_99_object)
{
...
void func_3550(bool var_977_bool)
{
	string var_980_string;
	func_3625(var_980_string);
	int var_979_int;
...
void func_3563(bool var_1004_bool)
{
	string var_1007_string;
	func_3625(var_1007_string);
	int var_1006_int;
...
void func_1519(object var_670_object, float var_671_float)
{
	...
	bool var_676_bool;
	func_2859(var_676_bool, var_677_object);
	if(!var_676_bool) { //@nz
		bool var_679_bool;
		func_3407(var_679_bool, 2);
		return 0;
	}
	if(var_671_float > 0) {
		...
		if(var_178_bool != 0) {
			...
			if(var_142_float >= (var_123_float * var_123_float)) {
				...
				if(var_357_bool != 0) {
					...
					bool var_624_bool;
					func_2859(var_624_bool, var_0_cvector);
