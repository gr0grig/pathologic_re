...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_634(var_74_string);
	var_21_object->SetPhoto(var_74_string);
	string var_75_string;
	func_636(var_75_string);
...
void func_640(string var_41_string, int var_42_int)
{
...
void func_636(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen3_b.png";
}


void func_579(string var_96_string, bool var_97_bool)
{
	...
	for(;;) {
		...
		if(var_48_bool != 0) {
			...
			if(var_28_int == 0) {
				...
				func_640(var_57_string, var_58_int);
...
void func_647(int var_35_int)
{
	...
	for(;;) {
		...
		func_640(var_41_string, var_42_int);
...
void func_585(object var_27_object)
{
	float var_30_float;
...
void func_142(object var_2_object, string var_92_string)
{
	...
	if(var_92_string == "")
		...
		var_97_bool = true;
	func_579(var_96_string, var_97_bool);
...
{
	bool var_18_bool;
	func_618(var_18_bool, "quest_k10_01", "teleport");
}
...
void func_603(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_613(int var_107_int, string var_108_string)
{
	int var_110_int;
...
void func_487(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_603(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_67_bool;
	func_638(var_67_bool);
	if(var_67_bool != 0) {
	} else {
		@HasAnimationTrack(var_45_bool, "head");
		if(var_45_bool == 0) goto Label_549;
...
void func_555(void)
{
	...
	bool var_139_bool;
	func_638(var_139_bool);
	if(var_139_bool != 0) {
	} else {
		@HasAnimationTrack(var_138_bool, "head");
		if(var_138_bool == 0) goto Label_571;
		@UnlookAsync("head");
	}
Label_571:
...
void func_632(int var_72_int)
{
	var_72_int = 518715;
}


void func_634(string var_74_string)
{
	var_74_string = "ui/NPC_Citizen3.png";
}


void func_572(string var_124_string)
{
...
void func_638(bool var_67_bool)
{
	var_67_bool = false;
}
