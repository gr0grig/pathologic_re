...
maintask task_2
{
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, object var_10_object, object var_11_object, cvector var_12_cvector, bool var_13_bool)
	{
		...
		if(var_16_int == 0) {
			...
			func_1043(var_160_object);
			var_17_object->RemoveStationaryActor(var_160_object);
			object var_163_object;
			var_13_bool = var_163_object;
			TaskCall(3);
			func_619(var_164_object, var_165_cvector, var_166_bool, var_163_object);
			TaskReturn();
			var_17_object = null;
		}
	}
...
void func_0(object var_0_object, int var_21_int, object var_22_object)
{
	...
	int var_79_int;
	func_1115(var_79_int);
	var_28_object->SetNPCName(var_79_int);
	int var_80_int;
	func_1113(var_80_int);
	var_28_object->SetNPCDescription(var_80_int);
	string var_81_string;
	func_1117(var_81_string);
	var_28_object->SetPhoto(var_81_string);
	string var_82_string;
	func_1119(var_82_string);
	var_28_object->SetPhoto2(var_82_string);
	int var_83_int;
	func_1322(var_83_int);
	var_28_object->SetPlayerName(var_83_int);
	bool var_29_bool;
...
void func_1025(object var_30_object)
{
	float var_33_float;
...
// @pe
void func_1160(object var_86_object)
{
	object var_90_object;
	func_1272(var_90_object);
	object var_87_object;
	var_90_object = var_87_object;
	func_1289(var_87_object, "pt_gmap_factory", (float)2);
	object var_110_object;
	func_1272(var_110_object);
...
void func_1289(object var_87_object, string var_88_string, float var_89_float)
{
...
void func_1043(object var_160_object)
{
...
// @pe
void func_1176(object var_83_object)
{
	var_83_object->SetReturnValue(0);
}


void func_1049(cvector var_45_cvector, cvector var_46_cvector)
{
...
// @pe
void func_1181(bool var_99_bool)
{
	int var_101_int;
	func_1067(var_101_int, "k10q01");
	if(var_101_int == 3)
		var_99_bool = true;
	var_99_bool = false;
}
...
void func_157(object var_2_object, string var_107_string)
{
	...
	if(var_107_string == "")
		...
		var_112_bool = true;
	func_1019(var_111_string, var_112_bool);
...
void func_927(bool var_32_bool, object var_33_object, float var_34_float)
{
	...
	func_1049(var_59_cvector, (var_48_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_51_bool != 0)
		var_32_bool = false;
	@StopWorld();
	@CameraTransit((var_46_cvector + var_49_cvector), var_48_cvector);
	var_72_float = GetByIndex(var_49_cvector, 0);
	var_73_float = GetByIndex(var_49_cvector, 2);
	@Rotate(var_72_float, var_73_float);
	bool var_74_bool;
	func_1121(var_74_bool);
	if(var_74_bool != 0) {
	} else {
		@HasAnimationTrack(var_52_bool, "head");
		if(var_52_bool == 0) goto Label_989;
...
// @pe
void func_1059(float var_76_float, cvector var_77_cvector, cvector var_78_cvector)
{
...
// @pe
void func_1193(bool var_138_bool)
{
	int var_140_int;
	func_1067(var_140_int, "k10q01");
	if(var_140_int == 5)
		var_138_bool = true;
	var_138_bool = false;
}
...
void func_1067(int var_101_int, string var_102_string)
{
	int var_104_int;
...
void func_1072(bool var_76_bool, string var_77_string, string var_78_string)
{
...
void func_1205(void)
{
	...
	func_1244(var_28_bool, var_29_object, 447);
}
EMIT "Stack[-1] = 0";


void func_1084(float var_65_float)
{
	float var_67_float;
...
void func_1089(string var_45_string, int var_46_int)
{
...
void func_1218(void)
{
	...
	func_1244(var_73_bool, var_74_object, 447);
}
EMIT "Stack[-1] = 0";
...
void func_1096(int var_39_int)
{
	...
	for(;;) {
		...
		func_1089(var_45_string, var_46_int);
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_92_object, object var_93_object)
{
	...
	if(1 != 0) {
		...
		func_1181(var_1_object);
		if(var_99_bool != 0) {
			func_157(var_93_object, "Neutral");
			var_0_object->SetMessage(526972); //@t
			var_0_object->ClearReplies(); //@t
			var_0_object->AddReply(528069, 29412, 29411); //@t
		} else {
...
void func_840(object var_17_object, int var_18_int, float var_19_float)
{
	...
	if(var_38_bool != 0) {
		...
		func_1049(var_45_cvector, var_46_cvector);
...
void func_589(object var_0_object, cvector var_27_cvector, float var_28_float)
{
	...
	func_1049(var_43_cvector, (var_35_cvector - var_36_cvector));
	func_1049(var_41_cvector, (var_43_cvector + (var_37_cvector * 0.75)));
...
void func_1231(object var_37_object)
{
...
void func_1113(int var_80_int)
{
	var_80_int = 515556;
}


void func_1115(int var_79_int)
{
	var_79_int = 503341;
}


void func_1244(bool var_28_bool, object var_29_object, int var_30_int)
{
	object var_37_object;
	func_1231(var_37_object);
...
void func_1117(string var_81_string)
{
	var_81_string = "ui/NPC_Citizen3.png";
}


void func_1119(string var_82_string)
{
	var_82_string = "ui/NPC_Citizen3_b.png";
}


void func_1121(bool var_74_bool)
{
	var_74_bool = false;
}
...
void func_995(void)
{
	...
	bool var_154_bool;
	func_1121(var_154_bool);
	if(var_154_bool != 0) {
	} else {
		@HasAnimationTrack(var_153_bool, "head");
		if(var_153_bool == 0) goto Label_1011;
		@UnlookAsync("head");
	}
Label_1011:
...
void func_619(object var_0_object, object var_1_object, object var_2_object, object var_163_object)
{
	float var_173_float; cvector var_175_cvector; float var_176_float;
	cvector var_177_cvector;
	func_589(var_176_float, var_177_cvector, 1.7453294);
	cvector var_172_cvector;
	var_177_cvector = var_172_cvector;
	if((var_172_cvector | var_172_cvector) < 2500.0) {
		cvector var_204_cvector;
		func_589(var_176_float, var_204_cvector, 2.6179938);
		var_204_cvector = var_172_cvector;
		var_173_float = var_172_cvector | var_172_cvector;
		if(var_173_float < 2500.0) {
			var_209_float = sqrt(var_173_float);
			@Trace("Can't retreat, distance: " + var_209_float);
			@Sleep(0.5);
			return 10;
		}
	}
	var_212_float = GetByIndex(var_172_cvector, 0);
	var_213_float = GetByIndex(var_172_cvector, 2);
	@Rotate(var_212_float, var_213_float);
	cvector var_214_cvector;
	func_776(var_214_cvector);
	@SetTimer(120, 0.5);
	
Label_661:
	bool var_174_bool;
	@MovePoint((var_214_cvector + var_172_cvector), 1, var_174_bool);
	if(var_174_bool != 0) {
		...
		Label_691:
			...
			func_589(var_176_float, var_222_cvector, 2.6179938);
			var_222_cvector = var_175_cvector;
			if((var_175_cvector | var_175_cvector) >= 2500.0) {
				cvector var_226_cvector;
				func_776(var_226_cvector);
				var_1_object = var_226_cvector + var_175_cvector;
				@SetTimer(120, 0.5);
			} else {
			}
	}
...
void func_760(object var_0_object, bool var_65_bool)
{
	...
	func_1059(var_76_float, var_77_cvector, var_78_cvector);
	var_65_bool = var_76_float >= -0.34202012;
}


void func_1012(string var_125_string)
{
	...
	for(;;) {
		...
		if(var_52_bool != 0) {
			...
			if(var_32_int == 0) {
				...
				func_1089(var_61_string, var_62_int);
...
void func_1272(object var_54_object)
{
...
void func_1019(string var_111_string, bool var_112_bool)
{
