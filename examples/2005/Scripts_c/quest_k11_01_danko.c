...
task task_2
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, cvector var_7_cvector, bool var_8_bool)
	{
		if(1 != 0) {
			...
			if(var_7_cvector == 28506) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527198); //@t
				var_0_object->ClearReplies(); //@t
				bool var_63_bool;
				func_1253(var_1_object);
				if(var_63_bool != 0)
					var_0_object->AddReply(527199, 28789, 28507); //@t
				var_0_object->AddReply(527202, -1, 28510); //@t
				var_0_object->AddReply(527506, -1, 28838); //@t
				return 0;
			}
			if(var_7_cvector == 28789) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527465); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527466, 28792, 28791); //@t
				var_0_object->AddReply(527468, 28792, 28793); //@t
				return 0;
			}
			if(var_7_cvector == 28792) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527467); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527469, 28796, 28795); //@t
				return 0;
			}
			if(var_7_cvector == 28796) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527470); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527477, 28804, 28803); //@t
				var_0_object->AddReply(527471, 28798, 28797); //@t
				return 0;
			}
			if(var_7_cvector == 28798) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527472); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527473, 28800, 28799); //@t
				return 0;
			}
			if(var_7_cvector == 28800) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527474); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527475, 28802, 28801); //@t
				return 0;
			}
			if(var_7_cvector == 28802) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527476); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527491, 28804, 28818); //@t
				return 0;
			}
			if(var_7_cvector == 28804) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527478); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527479, 28806, 28805); //@t
				var_0_object->AddReply(527493, 28806, 28822); //@t
				return 0;
			}
			if(var_7_cvector == 28806) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527480); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527481, 28808, 28807); //@t
				var_0_object->AddReply(527494, 28808, 28824); //@t
				return 0;
			}
			if(var_7_cvector == 28808) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527482); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527483, 28810, 28809); //@t
				var_0_object->AddReply(527492, 28810, 28820); //@t
				return 0;
			}
			if(var_7_cvector == 28810) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527484); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527485, 28813, 28811); //@t
				var_0_object->AddReply(527486, 28813, 28812); //@t
				return 0;
			}
			if(var_7_cvector == 28813) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527487); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527488, 28816, 28815); //@t
				return 0;
			}
			if(var_7_cvector == 28816) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527489); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527490, 28827, 28817); //@t
				var_0_object->AddReply(527495, 28827, 28826); //@t
				return 0;
			}
			if(var_7_cvector == 28827) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527496); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527497, 28829, 28828); //@t
				return 0;
			}
			if(var_7_cvector == 28829) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527498); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527499, 28832, 28831); //@t
				return 0;
			}
			if(var_7_cvector == 28832) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527500); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527501, -1, 28833); //@t
				var_0_object->AddReply(527502, 28835, 28834); //@t
				return 0;
			}
			if(var_7_cvector == 28835) {
				func_162(var_8_bool, "Neutral");
				var_0_object->SetMessage(527503); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(527504, -1, 28836); //@t
				var_0_object->AddReply(527505, -1, 28837); //@t
				return 0;
			}
			var_3_string = true;
			bool var_219_bool;
			func_1344(var_219_bool);
			if(var_219_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_3
{
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, cvector var_5_cvector, bool var_6_bool, int var_7_int)
	{
		if(var_7_int == 10) {
			...
			bool var_12_bool;
			func_927(var_12_bool);
			if(var_12_bool != 0) {
				bool var_15_bool;
				func_682(var_15_bool);
				if(var_15_bool != 0)
					var_11_bool = true;
			}
			if(var_11_bool != 0) {
				bool var_32_bool;
				func_662(var_32_bool);
				if(var_32_bool != 0) {
					bool var_51_bool; object var_52_object;
					object var_53_object;
					func_1190(var_53_object);
					var_53_object = var_52_object;
					func_1075(var_51_bool, var_52_object);
				}
			} else {
				func_677(var_7_int);
				func_704();
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, cvector var_5_cvector, bool var_6_bool, object var_7_object)
	{
		...
		if(!var_9_bool) { //@nz
			...
			func_918(var_11_bool, var_12_object);
			enable OnUse;
			object var_25_object;
			var_7_object = var_25_object;
			func_593(var_25_object);
			func_1155("Neutral");
			func_713();
			func_704();
		}
...
void func_642(object var_0_object)
{
	bool var_7_bool;
	func_927(var_7_bool);
	if(!var_7_bool) { //@nz
...
void func_1155(string var_14_string)
{
...
void func_900(float var_22_float, object var_23_object)
{
...
void func_1162(string var_203_string, bool var_204_bool)
{
...
void func_1291(bool var_22_bool, object var_23_object, int var_24_int)
{
	object var_31_object;
	func_1278(var_31_object);
...
void func_908(bool var_15_bool, cvector var_16_cvector)
{
...
void func_13(object var_0_object, int var_26_int, object var_27_object)
{
	...
	func_1190(var_39_object);
	var_39_object = var_38_object;
	func_1017(var_37_bool, var_38_object);
	bool var_132_bool; object var_133_object;
	var_27_object = var_133_object;
	func_932(var_132_bool, var_133_object, 70.0);
	if(!var_132_bool) { //@nz
		var_26_int = -2;
		return 8;
	}
...
void func_1168(bool var_71_bool, string var_72_string)
{
	bool var_74_bool;
	bool var_75_bool;
	func_1344(var_75_bool);
	if(var_75_bool != 0) {
...
void func_918(bool var_11_bool, object var_12_object)
{
	cvector var_14_cvector;
	var_12_object->GetPosition(var_14_cvector);
	bool var_15_bool; cvector var_16_cvector;
	var_14_cvector = var_16_cvector;
	func_908(var_15_bool, var_16_cvector);
	var_15_bool = var_11_bool;
}


void func_662(bool var_32_bool)
{
	...
	func_918(var_37_bool, var_38_object);
	var_37_bool = var_32_bool;
}
EMIT "Stack[-1] = 0";


void func_927(bool var_7_bool)
{
	bool var_9_bool;
	@IsLoaded(var_9_bool);
...
void func_162(object var_2_object, string var_199_string)
{
	...
	if(var_199_string == "")
		...
		var_204_bool = true;
	func_1162(var_203_string, var_204_bool);
	var_2_object = var_199_string;
	
}


void func_932(bool var_132_bool, object var_133_object, float var_134_float)
{
	...
	func_1196(var_159_cvector, (var_148_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_174_bool;
	func_1344(var_174_bool);
	if(var_174_bool != 0) {
	} else {
		@HasAnimationTrack(var_152_bool, "head");
		if(var_152_bool == 0) goto Label_994;
...
void func_677(object var_0_object)
{
...
void func_1190(object var_39_object)
{
...
void func_1319(int var_183_int)
{
	int var_185_int;
...
void func_682(bool var_15_bool)
{
	...
	func_900(var_22_float, var_23_object);
...
void func_1196(cvector var_159_cvector, cvector var_160_cvector)
{
...
void func_1075(bool var_48_bool, object var_49_object)
{
	...
	for(;;) {
		...
		func_1168(var_71_bool, var_72_string);
...
void func_1206(int var_214_int, string var_215_string)
{
	int var_217_int;
...
void func_1336(int var_180_int)
{
	var_180_int = 515573;
}
...
void func_824(void)
{
	...
	@WaitForAnimEnd();
	bool var_37_bool;
	func_927(var_37_bool);
	if(!var_37_bool) //@nz
		return 12;
	int var_39_int;
	func_1227(var_39_int);
	int var_31_int;
	...
	for(;;) {
		...
		if(var_52_bool != 0) {
			...
			func_1220(var_66_string, var_67_int);
			@PlayAnimation("all", var_66_string);
			@WaitForAnimEnd(var_36_bool);
			var_68_bool = !var_36_bool; //@nz
			if(var_68_bool == 0) goto Label_879;
			goto Label_890;
			}
				Label_879:
					bool var_59_bool;
					func_893(var_59_bool);
					var_60_bool = !var_59_bool; //@nz
					if(var_60_bool == 0) goto Label_885;
			}
		}
	Label_890:
		for(;;) {
...
void func_1338(int var_179_int)
{
	var_179_int = 504032;
}


void func_1211(int var_92_int)
{
	float var_94_float;
...
void func_1340(string var_181_string)
{
	var_181_string = "ui/NPC_Bakalavr.png";
}


void func_1342(string var_182_string)
{
	var_182_string = "ui/NPC_Bakalavr_b.png";
}


void func_1344(bool var_75_bool)
{
	var_75_bool = true;
}
...
void func_1220(string var_45_string, int var_46_int)
{
...
void func_1227(int var_39_int)
{
	...
	for(;;) {
		...
		func_1220(var_45_string, var_46_int);
...
// @pe
void func_593(object var_25_object)
{
...
void func_1112(bool var_79_bool, object var_80_object)
{
	bool var_88_bool; int var_89_int; string var_90_string;
	int var_92_int;
	func_1211(var_92_int);
	...
	for(;;) {
		...
		func_1168(var_111_bool, var_112_string);
...
// @pe
void func_1253(bool var_212_bool)
{
	int var_214_int;
	func_1206(var_214_int, "k11q01");
	if(var_214_int == 3)
		var_212_bool = true;
	var_212_bool = false;
}
...
void func_1000(void)
{
	...
	bool var_246_bool;
	func_1344(var_246_bool);
	if(var_246_bool != 0) {
	} else {
		@HasAnimationTrack(var_245_bool, "head");
		if(var_245_bool == 0) goto Label_1016;
		@UnlookAsync("head");
	}
Label_1016:
...
{
	object var_18_object;
	@CreateDiaryEntry(var_18_object, 487, 1, 528054);
	bool var_22_bool; object var_23_object;
	var_18_object = var_23_object;
	func_1291(var_22_bool, var_23_object, 480);
}
EMIT "Stack[-1] = 0";
...
void func_1017(bool var_37_bool, object var_38_object)
{
	...
	if(var_44_int != 0) {
		...
		func_1075(var_48_bool, var_49_object);
		if(!var_48_bool) { //@nz
			bool var_79_bool; object var_80_object;
			var_38_object = var_80_object;
			func_1112(var_79_bool, var_80_object);
			if(!var_79_bool) { //@nz
				var_37_bool = false;
				return 4;
			}
		...
		func_1112(var_124_bool, var_125_object);
		if(!var_124_bool) { //@nz
			bool var_127_bool; object var_128_object;
			var_38_object = var_128_object;
			func_1075(var_127_bool, var_128_object);
			if(!var_127_bool) { //@nz
				var_37_bool = false;
				return 4;
			}
...
void func_893(bool var_59_bool)
{
	var_59_bool = true;
}


void func_1278(object var_31_object)
{
	object var_33_object;
