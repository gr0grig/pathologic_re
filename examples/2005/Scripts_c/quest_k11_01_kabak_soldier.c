	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object, bool var_12_bool)
	{
		if(1 != 0) {
			...
			if(var_11_object == 29376) {
				...
				if(var_37_bool != 0) {
					bool var_45_bool;
					func_775(var_1_object);
					if(var_45_bool != 0)
						var_36_bool = true;
				}
				if(var_36_bool != 0)
					var_0_object->AddReply(528015, 31621, 29377); //@t
				var_0_object->AddReply(528016, -1, 29378); //@t
				var_0_object->AddReply(530232, -1, 31620); //@t
				return 0;
			}
			if(var_11_object == 31621) {
				func_151(var_12_bool, "Neutral");
				var_0_object->SetMessage(530233); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(530234, 29379, 31622); //@t
				var_0_object->AddReply(530235, -1, 31623); //@t
				return 0;
			}
			if(var_11_object == 29379) {
				func_151(var_12_bool, "Neutral");
				var_0_object->SetMessage(528017); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(528018, 31625, 29380); //@t
				var_0_object->AddReply(530236, -1, 31624); //@t
				return 0;
			}
			if(var_11_object == 31625) {
				func_151(var_12_bool, "Neutral");
				var_0_object->SetMessage(530237); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(530238, 31628, 31626); //@t
				var_0_object->AddReply(530239, -1, 31627); //@t
				return 0;
			}
			if(var_11_object == 31628) {
				func_151(var_12_bool, "Neutral");
				var_0_object->SetMessage(530240); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(530241, -1, 31629); //@t
				var_0_object->AddReply(530242, -1, 31630); //@t
				return 0;
			}
			var_3_string = true;
			bool var_100_bool;
			func_824(var_100_bool);
			if(var_100_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	{
		func_495(var_10_bool, var_11_object);
	...
	{
		func_495(var_9_object, var_10_bool);
		bool var_14_bool = false;
		if(var_5_int != 0) {
			bool var_16_bool;
			func_428(var_16_bool);
			if(var_16_bool != 0)
				var_14_bool = true;
		}
		if(var_14_bool != 0) {
			object var_17_object;
			func_724(var_17_object);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, int var_11_int)
	{
		if(var_11_int == 10) {
			bool var_14_bool;
			func_457(var_9_object, var_10_bool, var_11_int, var_14_bool);
			if(var_14_bool != 0) {
				if(!var_2_object) { //@nz
					func_706(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_15_int, object var_16_object)
{
	...
	func_608(var_26_bool, var_27_object, 70.0);
	if(!var_26_bool) { //@nz
		var_15_int = -2;
		return 8;
	}
	...
	func_820(var_75_string);
	var_22_object->SetPhoto(var_75_string);
	string var_76_string;
	func_822(var_76_string);
...
void func_769(void)
{
	@SetVariable("ook11KabakSoldier1", 1);
}


// @pe
void func_775(bool var_115_bool)
{
	int var_117_int;
	func_740(var_117_int, "k11q01");
	if(var_117_int == 2)
		var_115_bool = true;
	var_115_bool = false;
}
...
// @pe
void func_787(bool var_107_bool)
{
	int var_109_int;
	func_740(var_109_int, "ook11KabakSoldier1");
	if(var_109_int == 0) {
		var_107_bool = true;
		return 0;
	}
...
void func_151(object var_2_object, string var_93_string)
{
	...
	if(var_93_string == "")
		...
		var_98_bool = true;
	func_700(var_97_string, var_98_bool);
...
void func_676(void)
{
	...
	bool var_147_bool;
	func_824(var_147_bool);
	if(var_147_bool != 0) {
	} else {
		@HasAnimationTrack(var_146_bool, "head");
		if(var_146_bool == 0) goto Label_692;
		@UnlookAsync("head");
	}
Label_692:
...
void func_428(bool var_16_bool)
{
	var_16_bool = true;
}
...
// @pe
void func_430(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_22_float, float var_23_float)
{
	bool var_24_bool;
	func_603(var_24_bool);
	if(!var_24_bool) //@nz
		return 0;
...
void func_816(int var_74_int)
{
	var_74_int = 527721;
}


void func_818(int var_73_int)
{
	var_73_int = 527720;
}


void func_820(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen1.png";
}


void func_693(string var_132_string)
{
...
void func_822(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen1_b.png";
}


void func_824(bool var_68_bool)
{
	var_68_bool = false;
}


void func_700(string var_97_string, bool var_98_bool)
{
...
void func_706(object var_28_object)
{
	float var_31_float;
...
void func_457(object var_0_object, object var_1_object, bool var_4_bool, bool var_14_bool)
{
	if(var_4_bool == null)
		var_14_bool = false;
	float var_18_float;
	func_595(var_18_float, var_4_bool);
...
void func_588(bool var_70_bool)
{
	var_70_bool = true;
}
...
void func_595(float var_18_float, object var_19_object)
{
...
void func_724(object var_17_object)
{
...
void func_730(cvector var_53_cvector, cvector var_54_cvector)
{
...
void func_603(bool var_15_bool)
{
	bool var_17_bool;
...
void func_351(float var_11_float, float var_12_float)
{
	
Label_352:
	for(;;) {
		bool var_15_bool;
		func_603(var_15_bool);
		var_18_bool = !var_15_bool; //@nz
		if(var_18_bool == 0) goto Label_360;
		@Hold();
	}
...
Label_360:
	...
	float var_13_float;
	func_430(var_10_bool, var_22_float, var_23_float, var_13_float, var_14_float, var_22_float, var_23_float);
	@sync();
	goto Label_352;
}
EMIT "Return(); Pop(2)";
...
void func_608(bool var_26_bool, object var_27_object, float var_28_float)
{
	...
	func_730(var_53_cvector, (var_42_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_68_bool;
	func_824(var_68_bool);
	if(var_68_bool != 0) {
	} else {
		@HasAnimationTrack(var_46_bool, "head");
		if(var_46_bool == 0) goto Label_670;
...
void func_740(int var_109_int, string var_110_string)
{
	int var_112_int;
...
void func_745(string var_51_string, int var_52_int)
{
...
// @pe
void func_495(object var_2_object, string var_3_string)
{
	func_590();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_752(int var_45_int)
{
	...
	for(;;) {
		...
		func_745(var_51_string, var_52_int);
		...
		if(var_58_bool != 0) {
			...
			if(var_38_int == 1) {
				...
				goto Label_585;
					...
					bool var_70_bool;
					func_588(var_70_bool);
					var_71_bool = !var_70_bool; //@nz
					if(var_71_bool == 0) goto Label_580;
			}
		}
	Label_585:
		for(;;) {
