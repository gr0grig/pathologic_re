...
maintask task_1
{
	void init(int var_0_int)
	{
		...
		for(;;) {
			...
			if(var_2_bool != 0) {
				bool var_14_bool;
				func_332(var_14_bool, 0.33333334);
				if(var_14_bool != 0)
					var_12_bool = true;
			}
			if(var_12_bool != 0)
	...
	{
		if(var_1_string == "heal") {
			bool var_4_bool;
			func_382(var_4_bool, "quest_k11_01", "cure_officer");
		}
	}
	...
	void OnUse(int var_0_int, object var_1_object)
	{
		...
		if(var_7_bool != 0) {
			...
			if(var_17_bool == 0) goto Label_143;
			object var_21_object;
			func_315(var_21_object);
			@ShowWindow("agony.xml", true, false, var_21_object);
			@GetProperty("agony", var_11_float);
			if(!(var_11_float < 0.001)) goto Label_143;
			bool var_27_bool; object var_28_object;
			var_1_object = var_28_object;
			func_337(var_27_bool, var_28_object, 0.2);
		}
	Label_143:
	...
	void OnDeath(int var_0_int, object var_1_object)
	{
		...
		if(var_4_bool != 0) {
			...
			if(!var_5_bool) { //@nz
				...
				func_337(var_9_bool, var_10_object, -0.3);
...
void OnHit2(int var_0_int, object var_1_object, int var_2_int, float var_3_float, float var_4_float, cvector var_5_cvector, cvector var_6_cvector)
{
	...
	func_296(var_9_float, var_10_cvector, var_11_cvector);
}
...
// @pe
void func_321(float var_38_float, float var_39_float, float var_40_float, float var_41_float)
{
...
void func_230(bool var_20_bool, object var_21_object, string var_22_string, float var_23_float, float var_24_float, float var_25_float)
{
	...
	bool var_28_bool;
	func_218(var_28_bool, var_29_object, var_30_string);
	if(!var_28_bool) //@nz
		var_20_bool = false;
	float var_27_float;
	...
	func_321(var_38_float, (var_27_float + var_23_float), var_40_float, var_41_float);
	var_21_object->SetProperty(var_22_string, var_38_float);
	var_20_bool = true;
}


void func_296(object var_7_object, cvector var_10_cvector, cvector var_11_cvector)
{
	...
	func_252(var_18_object);
}
EMIT "Stack[-1] = 0";
EMIT "Stack[-2] = 0";


void func_332(bool var_14_bool, float var_15_float)
{
	float var_17_float;
	@rand(var_17_float);
...
// @pe
void func_337(bool var_9_bool, object var_10_object, float var_11_float)
{
	if(!var_10_object) { //@nz
		var_9_bool = false;
		return 0;
...
void func_372(float var_16_float)
{
	object var_18_object;
...
void func_218(bool var_28_bool, object var_29_object, string var_30_string)
{
...
void func_315(object var_2_object)
{
	object var_4_object;
	@self(var_4_object);
...
void func_252(object var_18_object)
{
...
void func_382(bool var_4_bool, string var_5_string, string var_6_string)
{
	object var_8_object;
