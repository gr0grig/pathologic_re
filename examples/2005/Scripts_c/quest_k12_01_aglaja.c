...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool)
	{
		if(1 != 0) {
			...
			if(var_6_int == 41142) {
				bool var_12_bool;
				func_601(var_1_object);
				if(!var_12_bool) { //@nz
					func_165(var_7_bool, "Neutral");
					var_0_object->SetMessage(539199); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(539200, -1, 41143); //@t
					var_0_object->AddReply(540975, -1, 43065); //@t
					return 0;
				}
				func_165(var_7_bool, "Neutral");
...
maintask task_2
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, string var_6_string)
	{
		...
		if(var_6_string == "cleanup") {
			...
			if(!var_8_bool) { //@nz
				bool var_13_bool;
				func_311(var_13_bool);
				if(var_13_bool != 0)
					var_11_bool = true;
			}
			if(var_11_bool != 0) {
				object var_14_object;
				func_571(var_14_object);
...
void func_0(object var_0_object, int var_7_int, object var_8_object)
{
	...
	func_571(var_20_object);
	var_20_object = var_19_object;
	func_398(var_18_bool, var_19_object);
	bool var_113_bool; object var_114_object;
	var_8_object = var_114_object;
	func_313(var_113_bool, var_114_object, 70.0);
	if(!var_113_bool) { //@nz
		var_7_int = -2;
		return 8;
	}
...
void func_577(cvector var_140_cvector, cvector var_141_cvector)
{
...
void func_456(bool var_29_bool, object var_30_object)
{
	...
	for(;;) {
		...
		func_549(var_52_bool, var_53_string);
...
void func_587(int var_182_int, string var_183_string)
{
	int var_185_int;
...
void func_398(bool var_18_bool, object var_19_object)
{
	...
	if(var_25_int != 0) {
		...
		func_456(var_29_bool, var_30_object);
		if(!var_29_bool) { //@nz
			bool var_60_bool; object var_61_object;
			var_19_object = var_61_object;
			func_493(var_60_bool, var_61_object);
			if(!var_60_bool) { //@nz
				var_18_bool = false;
				return 4;
			}
		...
		func_493(var_105_bool, var_106_object);
		if(!var_105_bool) { //@nz
			bool var_108_bool; object var_109_object;
			var_19_object = var_109_object;
			func_456(var_108_bool, var_109_object);
			if(!var_108_bool) { //@nz
				var_18_bool = false;
				return 4;
			}
...
void func_536(string var_210_string)
{
	float var_213_float; float var_214_float;
	@lshGetAnimTimes(var_210_string, var_213_float, var_214_float);
	@lshPlayAnimation(var_213_float, var_214_float, false);
}


// @pe
void func_601(bool var_180_bool)
{
	int var_182_int;
	func_587(var_182_int, "game_final");
	if(var_182_int != 0) {
		var_180_bool = true;
		return 0;
	}
...
void func_543(string var_193_string, bool var_194_bool)
{
...
void func_165(object var_2_object, string var_189_string)
{
	...
	if(var_189_string == "")
		...
		var_194_bool = true;
	func_543(var_193_string, var_194_bool);
	var_2_object = var_189_string;
	
}


void func_549(bool var_52_bool, string var_53_string)
{
	bool var_55_bool;
	bool var_56_bool;
	func_638(var_56_bool);
	if(var_56_bool != 0) {
...
void func_493(bool var_60_bool, object var_61_object)
{
	...
	for(;;) {
		...
		func_549(var_92_bool, var_93_string);
...
void func_630(int var_161_int)
{
	var_161_int = 515527;
}


void func_311(bool var_8_bool)
{
	var_8_bool = true;
}


void func_632(int var_160_int)
{
	var_160_int = 513334;
}


void func_313(bool var_113_bool, object var_114_object, float var_115_float)
{
	...
	func_577(var_140_cvector, (var_129_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_155_bool;
	func_638(var_155_bool);
	if(var_155_bool != 0) {
	} else {
		@HasAnimationTrack(var_133_bool, "head");
		if(var_133_bool == 0) goto Label_375;
...
void func_634(string var_162_string)
{
	var_162_string = "ui/NPC_Aglaja.png";
}


void func_571(object var_9_object)
{
...
void func_636(string var_163_string)
{
...
void func_381(void)
{
	...
	bool var_233_bool;
	func_638(var_233_bool);
	if(var_233_bool != 0) {
	} else {
		@HasAnimationTrack(var_232_bool, "head");
		if(var_232_bool == 0) goto Label_397;
		@UnlookAsync("head");
	}
Label_397:
...
void func_638(bool var_56_bool)
{
	var_56_bool = true;
}
