		...
		if(1 != 0) {
			...
			if(var_10_bool == 41171) {
				...
				if(var_32_bool != 0) {
					...
					if(var_169_bool != 0)
						var_0_object->AddReply(539229, 41173, 41172); //@t
			...
			if(var_10_bool == 41173) {
				func_211(var_11_object, "Neutral");
				var_0_object->SetMessage(539230); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539231, 41175, 41174); //@t
				var_0_object->AddReply(539235, 41179, 41178); //@t
				return 0;
			}
			if(var_10_bool == 41179) {
				func_211(var_11_object, "Neutral");
				var_0_object->SetMessage(539236); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539237, 41181, 41180); //@t
				var_0_object->AddReply(539241, -1, 41184); //@t
				return 0;
			}
			if(var_10_bool == 41181) {
				func_211(var_11_object, "Neutral");
				var_0_object->SetMessage(539238); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539239, -1, 41182); //@t
				var_0_object->AddReply(539240, -1, 41183); //@t
				return 0;
			}
			if(var_10_bool == 41175) {
				func_211(var_11_object, "Neutral");
				var_0_object->SetMessage(539232); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539233, -1, 41176); //@t
				var_0_object->AddReply(539234, -1, 41177); //@t
				return 0;
			}
			var_3_string = true;
			bool var_247_bool;
...
{
	bool var_24_bool;
	func_794(var_24_bool, "quest_k12_01", "init_theater");
}
...
// @pe
void func_869(bool var_207_bool)
{
	int var_209_int;
	func_789(var_209_int, "k12q01ChildsAreVisited");
	if(var_209_int != 0) {
		var_207_bool = true;
		return 0;
	}
...
// @pe
void func_881(bool var_260_bool)
{
	int var_262_int;
	func_789(var_262_int, "ook12BirdmaskT1");
	if(var_262_int == 0) {
		var_260_bool = true;
		return 0;
	}
...
{
	int var_231_int;
	func_789(var_231_int, "ook12BirdmaskT2");
	if(var_231_int == 0) {
		var_229_bool = true;
		return 0;
	}
