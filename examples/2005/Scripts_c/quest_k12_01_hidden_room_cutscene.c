...
void func_14(void)
{
	...
	object var_5_object;
	@AddScriptedActor(var_5_object, "cs_d12_littlegirl_big", "cs_play_all.bin", var_4_object, [0.0, 0.0, 0.0]);
	object var_6_object;
	@AddScriptedActor(var_6_object, "cs_d12_littleboy_big", "cs_play_all.bin", var_4_object, [0.0, 0.0, 0.0]);
