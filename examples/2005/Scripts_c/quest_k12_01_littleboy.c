...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object, bool var_12_bool)
	{
		if(1 != 0) {
			func_569();
			if(var_11_object == 41222) {
				func_127(var_12_bool, "Neutral");
				var_0_object->SetMessage(539279); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(539280, -1, 41223); //@t
				return 0;
			}
			var_3_string = true;
			bool var_33_bool;
			func_617(var_33_bool);
			if(var_33_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
	...
	{
		func_347(var_10_bool, var_11_object);
	...
	{
		func_347(var_9_object, var_10_bool);
		bool var_14_bool = false;
		if(var_5_int != 0) {
			bool var_16_bool;
			func_280(var_16_bool);
			if(var_16_bool != 0)
				var_14_bool = true;
		}
		if(var_14_bool != 0) {
			object var_17_object;
			func_576(var_17_object);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, int var_11_int)
	{
		if(var_11_int == 10) {
			bool var_14_bool;
			func_309(var_9_object, var_10_bool, var_11_int, var_14_bool);
			if(var_14_bool != 0) {
				if(!var_2_object) { //@nz
					func_558(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_15_int, object var_16_object)
{
	...
	func_460(var_26_bool, var_27_object, 70.0);
	if(!var_26_bool) { //@nz
		var_15_int = -2;
		return 8;
	}
	...
	func_613(var_75_string);
	var_22_object->SetPhoto(var_75_string);
	string var_76_string;
	func_615(var_76_string);
...
void func_528(void)
{
	...
	bool var_126_bool;
	func_617(var_126_bool);
	if(var_126_bool != 0) {
	} else {
		@HasAnimationTrack(var_125_bool, "head");
		if(var_125_bool == 0) goto Label_544;
		@UnlookAsync("head");
	}
Label_544:
...
void func_280(bool var_16_bool)
{
	var_16_bool = true;
}
...
// @pe
void func_282(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_22_float, float var_23_float)
{
	bool var_24_bool;
	func_455(var_24_bool);
	if(!var_24_bool) //@nz
		return 0;
...
void func_545(string var_111_string)
{
...
void func_558(object var_28_object)
{
	float var_31_float;
...
void func_309(object var_0_object, object var_1_object, bool var_4_bool, bool var_14_bool)
{
	if(var_4_bool == null)
		var_14_bool = false;
	float var_18_float;
	func_447(var_18_float, var_4_bool);
...
void func_440(bool var_70_bool)
{
	var_70_bool = true;
}
...
void func_447(float var_18_float, object var_19_object)
{
...
void func_576(object var_17_object)
{
...
void func_582(cvector var_53_cvector, cvector var_54_cvector)
{
...
void func_455(bool var_15_bool)
{
	bool var_17_bool;
...
void func_74(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_86_object, object var_87_object)
{
	...
	var_3_string = false;
	if(1 != 0) {
		func_127(var_87_object, "Neutral");
		var_0_object->SetMessage(539279); //@t
		var_0_object->ClearReplies(); //@t
		var_0_object->AddReply(539280, -1, 41223); //@t
		goto Label_97;
...
void func_203(float var_11_float, float var_12_float)
{
	
Label_204:
	for(;;) {
		bool var_15_bool;
		func_455(var_15_bool);
		var_18_bool = !var_15_bool; //@nz
		if(var_18_bool == 0) goto Label_212;
		@Hold();
	}
...
Label_212:
	...
	float var_13_float;
	func_282(var_10_bool, var_22_float, var_23_float, var_13_float, var_14_float, var_22_float, var_23_float);
	@sync();
	goto Label_204;
}
EMIT "Return(); Pop(2)";
...
void func_460(bool var_26_bool, object var_27_object, float var_28_float)
{
	...
	func_582(var_53_cvector, (var_42_cvector ^ [0.0, 1.0, 0.0]));
	...
	bool var_68_bool;
	func_617(var_68_bool);
	if(var_68_bool != 0) {
	} else {
		@HasAnimationTrack(var_46_bool, "head");
		if(var_46_bool == 0) goto Label_522;
...
// @pe
void func_347(object var_2_object, string var_3_string)
{
	func_442();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_609(int var_74_int)
{
	var_74_int = 515560;
}


void func_611(int var_73_int)
{
	var_73_int = 503345;
}


void func_228(int var_5_int)
{
	var_5_int = true;
	bool var_15_bool;
	...
	if(var_16_bool != 0) {
		object var_19_object;
		func_576(var_19_object);
		@RemoveActor(var_19_object);
	}
}


void func_613(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen3.png";
}


void func_615(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen3_b.png";
}


void func_617(bool var_68_bool)
{
	var_68_bool = false;
}
		...
		if(var_58_bool != 0) {
			...
			if(var_38_int == 1) {
				...
				goto Label_437;
					...
					bool var_70_bool;
					func_440(var_70_bool);
					var_71_bool = !var_70_bool; //@nz
					if(var_71_bool == 0) goto Label_432;
			}
		}
	Label_437:
		for(;;) {
...
void func_619(string var_51_string, int var_52_int)
{
...
void func_626(int var_45_int)
{
	...
	for(;;) {
		...
		func_619(var_51_string, var_52_int);
...
// @pe
void func_127(object var_2_object, string var_93_string)
{
	bool var_94_bool;
	func_617(var_94_bool);
	if(!var_94_bool) //@nz
		return 0;
