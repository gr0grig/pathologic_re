...
maintask task_1
{
	void init(int var_0_int)
	{
		...
		for(;;) {
			...
			if(var_2_bool != 0) {
				bool var_14_bool;
				func_291(var_14_bool, 0.33333334);
				if(var_14_bool != 0)
					var_12_bool = true;
			}
			if(var_12_bool != 0)
	...
	void OnTrigger(int var_0_int, string var_1_string)
	{
		if(var_1_string == "heal") {
			bool var_4_bool;
			func_341(var_4_bool, "quest_k1_01", "cure_worker");
		}
	}
	...
	void OnDeath(int var_0_int, object var_1_object)
	{
		...
		if(var_4_bool != 0) {
			...
			if(!var_5_bool) { //@nz
				...
				func_296(var_9_bool, var_10_object, -0.3);
...
void OnHit2(int var_0_int, object var_1_object, int var_2_int, float var_3_float, float var_4_float, cvector var_5_cvector, cvector var_6_cvector)
{
	...
	func_255(var_9_float, var_10_cvector, var_11_cvector);
}
...
void func_291(bool var_14_bool, float var_15_float)
{
	float var_17_float;
	@rand(var_17_float);
...
// @pe
void func_296(bool var_9_bool, object var_10_object, float var_11_float)
{
	if(!var_10_object) { //@nz
		var_9_bool = false;
		return 0;
	...
	for(;;) {
		...
		func_189(var_20_bool, var_21_object, "reputation", var_23_float, (float)0, (float)1);
		var_9_bool = true;
		return 0;
...
void func_331(float var_16_float)
{
...
void func_177(bool var_28_bool, object var_29_object, string var_30_string)
{
...
void func_274(object var_2_object)
{
	object var_4_object;
	@self(var_4_object);
...
void func_211(object var_18_object)
{
...
void func_341(bool var_4_bool, string var_5_string, string var_6_string)
{
	object var_8_object;
...
// @pe
void func_280(float var_38_float, float var_39_float, float var_40_float, float var_41_float)
{
...
void func_189(bool var_20_bool, object var_21_object, string var_22_string, float var_23_float, float var_24_float, float var_25_float)
{
	...
	func_280(var_38_float, (var_27_float + var_23_float), var_40_float, var_41_float);
	var_21_object->SetProperty(var_22_string, var_38_float);
	var_20_bool = true;
}


void func_255(object var_7_object, cvector var_10_cvector, cvector var_11_cvector)
{
