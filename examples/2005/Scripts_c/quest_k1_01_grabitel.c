...
void func_0(bool var_61_bool, object var_62_object, bool var_84_bool, object var_685_object)
{
	...
	TaskCall(2);
	func_163(var_683_bool, var_684_object);
	TaskReturn();
...
void func_2056(object var_99_object)
{
	bool var_101_bool;
...
void func_2076(bool var_615_bool)
{
	bool var_617_bool;
...
void func_543(bool var_0_bool, object var_1_object, bool var_490_bool, float var_491_float)
{
	...
	if(var_497_bool != 0) {
		...
		func_884(var_499_string);
		bool var_629_bool;
		func_1698(var_629_bool, var_0_bool);
		if(!var_629_bool) { //@nz
			@StopAsync();
			var_490_bool = false;
			return 8;
		...
		func_504(var_499_string, var_632_float, var_633_int);
		var_498_int = 1;
		...
		for(;;) {
			...
			if(!var_497_bool) { //@nz
				...
				func_884(var_499_string);
				bool var_655_bool;
				func_1698(var_655_bool, var_0_bool);
				if(!var_655_bool) { //@nz
					@StopAsync();
					var_490_bool = false;
					return 8;
				...
				func_504(var_499_string, var_658_float, var_659_int);
				var_498_int += 1;
			}
	}
...
// @pe
void func_2082(object var_11_object)
{
...
void func_37(bool var_0_bool, bool var_82_bool, object var_83_object, object var_200_object)
{
	...
	func_2159(var_142_cvector, var_143_cvector, var_144_cvector, 2000.0);
...
// @pe
void func_2127(bool var_15_bool, object var_16_object)
{
...
// @pe
void func_2134(object var_51_object)
{
...
void func_1626(bool var_604_bool, object var_605_object)
{
	object var_609_object;
	var_605_object = var_609_object;
	bool var_608_bool;
	func_1519(var_608_bool, var_609_object, "health");
	if(!var_608_bool) { //@nz
		var_604_bool = false;
		return 2;
	}
	...
	func_1514(var_613_bool, var_614_object);
	if(var_613_bool != 0) {
		bool var_615_bool;
...
void func_2159(cvector var_142_cvector, cvector var_143_cvector, cvector var_144_cvector, float var_145_float)
{
...
// @pe
void func_2196(bool var_13_bool)
{
	var_13_bool = false;
}


void func_2199(object var_52_object)
{
...
void func_682(bool var_645_bool, float var_646_float)
{
...
// @pe
void func_199(object var_599_object, float var_600_float)
{
		...
		if(var_265_bool != 0) {
			...
			if(var_228_float >= (var_209_float * var_209_float)) {
				...
				if(var_389_bool != 0) {
					...
					@StopAsync();
					bool var_664_bool;
					func_841(var_231_float, var_664_bool);
					var_665_bool = !var_664_bool; //@nz
					if(var_665_bool == 0) goto Label_442;
					bool var_666_bool;
					func_1698(var_666_bool, var_0_bool);
					if(!var_666_bool) { //@nz
						goto Label_452;
					}
					var_0_bool->GetPFPosition(var_222_cvector); //@t
					...
					func_543(var_230_bool, var_231_float, var_671_bool, var_672_float);
					var_673_bool = !var_671_bool; //@nz
					if(var_673_bool == 0) goto Label_442;
					goto Label_452;
			}
				bool var_674_bool; float var_675_float;
				var_209_float = var_675_float;
				func_543(var_230_bool, var_231_float, var_674_bool, var_675_float);
				if(!var_674_bool) { //@nz
					goto Label_452;
				}
				var_225_bool = true;
...
void func_894(bool var_644_bool)
{
	var_644_bool = true;
}
...
void func_504(bool var_0_bool, float var_523_float, int var_524_int)
{
	...
	if(var_528_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_598_int, var_530_float, var_539_float);
...
void func_2046(float var_26_float)
{
