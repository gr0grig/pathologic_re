...
void func_1562(float var_22_float)
{
		...
		if(var_72_bool != 0) {
			...
			if(var_33_float >= (var_14_float * var_14_float)) {
				...
				if(var_232_bool != 0) {
					...
					@StopAsync();
					bool var_490_bool;
					func_629(var_36_float, var_490_bool);
					var_491_bool = !var_490_bool; //@nz
					if(var_491_bool == 0) goto Label_232;
					bool var_492_bool;
					func_1270(var_492_bool, var_0_object);
					if(!var_492_bool) { //@nz
						goto Label_242;
					}
					var_0_object->GetPFPosition(var_27_cvector); //@t
					...
					bool var_497_bool; float var_498_float;
					var_14_float = var_498_float;
					func_333(var_35_bool, var_36_float, var_497_bool, var_498_float);
					var_499_bool = !var_497_bool; //@nz
					if(var_499_bool == 0) goto Label_232;
					goto Label_242;
			}
				bool var_500_bool; float var_501_float;
				var_14_float = var_501_float;
				func_333(var_35_bool, var_36_float, var_500_bool, var_501_float);
				if(!var_500_bool) { //@nz
					goto Label_242;
				}
				var_30_bool = true;
...
void func_1572(object var_108_object)
{
	bool var_110_bool;
...
void func_294(object var_0_object, float var_370_float, int var_371_int)
{
	...
	if(var_375_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_445_int, var_377_float, var_386_float);
		object var_446_object; float var_447_float;
		var_375_object = var_446_object;
		var_377_float = var_447_float;
		func_684();
	}
}
EMIT "Stack[-3] = 0";
...
void func_686(bool var_470_bool)
{
	var_470_bool = true;
}
...
// @pe
void func_1592(object var_10_object)
{
	object var_12_object;
...
void func_333(object var_0_object, int var_1_int, bool var_333_bool, float var_334_float)
{
	...
	if(var_340_bool != 0) {
		...
		func_672(var_342_string);
		bool var_455_bool;
		func_1270(var_455_bool, var_0_object);
		if(!var_455_bool) { //@nz
			@StopAsync();
			var_333_bool = false;
			return 8;
		}
		float var_458_float; int var_459_int;
		var_334_float = var_458_float;
		func_294(var_342_string, var_458_float, var_459_int);
		var_341_int = 1;

		for(;;) {
			var_342_string = (("attack_middle" + var_459_int) + "_") + var_341_int;
			...
			if(!var_340_bool) { //@nz
				...
				func_672(var_342_string);
				bool var_481_bool;
				func_1270(var_481_bool, var_0_object);
				if(!var_481_bool) { //@nz
					@StopAsync();
					var_333_bool = false;
					return 8;
				...
				var_334_float = var_484_float;
				var_339_int = var_485_int;
				func_294(var_342_string, var_484_float, var_485_int);
				var_341_int += 1;
			}
	}
...
void func_470(bool var_471_bool, float var_472_float)
{
	float var_475_float; bool var_476_bool;
	@rand(var_475_float);
	if(var_475_float < var_472_float) {

		for(;;) {
			@IsAnimationPlaying(var_476_bool);
			if(!var_476_bool) { //@nz
			} else {
				bool var_479_bool;
				func_568(var_479_bool);
				if(var_479_bool != 0) {
					var_471_bool = true;
					return 4;
				}
