...
void func_2072(float var_68_float)
{
		...
		if(var_260_bool != 0) {
			...
			if(var_223_float >= (var_204_float * var_204_float)) {
				...
				if(var_384_bool != 0) {
					...
					@StopAsync();
					bool var_659_bool;
					func_1144(var_226_float, var_659_bool);
					var_660_bool = !var_659_bool; //@nz
					if(var_660_bool == 0) goto Label_745;
					bool var_661_bool;
					func_1708(var_661_bool, var_0_object);
					if(!var_661_bool) { //@nz
						goto Label_755;
					}
					var_0_object->GetPFPosition(var_217_cvector); //@t
					...
					bool var_666_bool; float var_667_float;
					var_204_float = var_667_float;
					func_846(var_225_bool, var_226_float, var_666_bool, var_667_float);
					var_668_bool = !var_666_bool; //@nz
					if(var_668_bool == 0) goto Label_745;
					goto Label_755;
			}
				bool var_669_bool; float var_670_float;
				var_204_float = var_670_float;
				func_846(var_225_bool, var_226_float, var_669_bool, var_670_float);
				if(!var_669_bool) { //@nz
					goto Label_755;
				}
				var_220_bool = true;
...
void func_2082(object var_13_object)
{
	bool var_15_bool;
	...
	for(;;) {
		...
		if(var_42_bool != 0) {
			...
			if(var_20_int == 0) {
				...
				func_2108(var_51_string, var_52_int);
...
void func_2102(bool var_610_bool)
{
	bool var_612_bool;
	@GetVariable("god_mode", var_612_bool);
	var_612_bool = var_610_bool;
}
...
void func_2108(string var_35_string, int var_36_int)
{
...
// @pe
void func_2132(object var_11_object)
{
...
void func_1636(bool var_599_bool, object var_600_object)
{
	object var_604_object;
	var_600_object = var_604_object;
	bool var_603_bool;
	func_1529(var_603_bool, var_604_object, "health");
	if(!var_603_bool) { //@nz
		var_599_bool = false;
		return 2;
	}
	bool var_607_bool = false;
	bool var_608_bool; object var_609_object;
	func_1524(var_608_bool, var_609_object);
	if(var_608_bool != 0) {
		bool var_610_bool;
	...
	float var_602_float;
	var_609_object->GetProperty("health", var_602_float);
	var_599_bool = var_602_float <= 0.0;
}
...
// @pe
void func_2177(bool var_15_bool, object var_16_object)
{
...
// @pe
void func_2184(object var_51_object)
{
...
// @pe
void func_2196(object var_14_object)
{
	int var_15_int;
...
void func_2209(int var_20_int, int var_21_int)
{
...
void func_1197(bool var_639_bool)
{
	var_639_bool = true;
}
...
void func_2240(void)
{
	...
	int var_53_int;
	func_2270(var_53_int, "grabitel_mark");
	bool var_18_bool;
...
void func_2270(int var_32_int, string var_33_string)
{
	int var_35_int;
...
// @pe
void func_2275(object var_52_object)
{
...
void func_2283(cvector var_137_cvector, cvector var_138_cvector, cvector var_139_cvector, float var_140_float)
{
...
// @pe
void func_2320(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_807(object var_0_object, float var_518_float, int var_519_int)
{
	...
	if(var_523_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_593_int, var_525_float, var_534_float);
		object var_594_object; float var_595_float;
		var_523_object = var_594_object;
		var_525_float = var_595_float;
...
void func_303(bool var_54_bool, object var_55_object, bool var_77_bool, object var_680_object)
{
	...
	var_55_object = var_679_object;
	TaskCall(4);
	func_466(var_678_bool, var_679_object);
	TaskReturn();
	var_680_object = var_54_bool;
}
...
void func_846(object var_0_object, bool var_1_bool, bool var_485_bool, float var_486_float)
{
	...
	if(var_492_bool != 0) {
		...
		func_1187(var_494_string);
		bool var_624_bool;
		func_1708(var_624_bool, var_0_object);
		if(!var_624_bool) { //@nz
			@StopAsync();
			var_485_bool = false;
			return 8;
		}
		float var_627_float; int var_628_int;
		var_486_float = var_627_float;
		func_807(var_494_string, var_627_float, var_628_int);
		var_493_int = 1;

		for(;;) {
			var_494_string = (("attack_middle" + var_628_int) + "_") + var_493_int;
			...
			if(!var_492_bool) { //@nz
				...
				func_1187(var_494_string);
				bool var_650_bool;
				func_1708(var_650_bool, var_0_object);
				if(!var_650_bool) { //@nz
					@StopAsync();
					var_485_bool = false;
					return 8;
				}
				float var_653_float; int var_654_int;
				var_486_float = var_653_float;
				var_491_int = var_654_int;
				func_807(var_494_string, var_653_float, var_654_int);
				var_493_int += 1;
			}
	}
...
void func_340(object var_0_object, bool var_75_bool, object var_76_object, object var_195_object)
{
	...
	func_2283(var_137_cvector, var_138_cvector, var_139_cvector, 2000.0);
...
void func_985(bool var_640_bool, float var_641_float)
{
	float var_644_float; bool var_645_bool;
	@rand(var_644_float);
	if(var_644_float < var_641_float) {

		for(;;) {
			@IsAnimationPlaying(var_645_bool);
			if(!var_645_bool) { //@nz
			} else {
				bool var_648_bool;
				func_1083(var_648_bool);
				if(var_648_bool != 0) {
					var_640_bool = true;
					return 4;
				}
...
// @pe
void func_502(object var_594_object, float var_595_float)
{
	bool var_596_bool = false;
	if(var_595_float > 0) {
		bool var_599_bool; object var_600_object;
		var_594_object = var_600_object;
		func_1636(var_599_bool, var_600_object);
		if(var_599_bool != 0)
			var_596_bool = true;
	}
	if(var_596_bool != 0) {
		var_616_bool = GlobalVars[0];
		GlobalVars[0] = true;
		func_983(var_595_float);
	}
}
