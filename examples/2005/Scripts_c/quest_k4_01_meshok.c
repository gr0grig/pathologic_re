maintask task_0
{
	...
	void OnUse(bool var_0_bool, object var_1_object)
	{
		...
		func_178(var_43_bool, var_44_object, var_45_object, var_46_int);
		if(var_43_bool != 0) {
...
void func_160(object var_67_object)
{
...
{
	bool var_61_bool;
	func_195(var_61_bool, "quest_k4_01", "meshok_taken");
...
void func_195(bool var_61_bool, string var_62_string, string var_63_string)
{
...
void func_100(bool var_10_bool, object var_11_object)
{
	...
	if(var_20_bool != 0) {
		...
		func_95(var_21_bool, var_22_object);
		if(var_21_bool != 0)
			var_17_bool = true;
	}
	if(var_17_bool != 0) {
...
void func_166(int var_55_int, int var_56_int)
{
...
void func_136(bool var_6_bool, object var_7_object)
{
	...
	func_83(var_28_bool, var_29_object, "noaccess");
	if(!var_28_bool) { //@nz
		var_6_bool = true;
		return 2;
	}
...
void func_17(void)
{
	if(var_0_bool != 0) {
		object var_2_object;
		func_160(var_2_object);
		@RemoveActor(var_2_object);
	}
}


void func_178(bool var_43_bool, object var_44_object, object var_45_object, int var_46_int)
{
	int var_50_int;
...
void func_83(bool var_28_bool, object var_29_object, string var_30_string)
{
...
void func_95(bool var_21_bool, object var_22_object)
{
	bool var_24_bool;
