				...
				if(2 == var_955_int) {
					...
					if(2 == var_972_int) {
						...
						if(2 == var_975_int) {
							...
							if(!var_977_bool) { //@nz
								bool var_985_bool;
								func_3353(var_985_bool, 3);
							} else {
								bool var_987_bool;
								func_3097(var_987_bool, 0.5);
...
task task_1
{
	...
	void OnSee(cvector var_0_cvector, cvector var_1_cvector, object var_2_object, int var_3_int, int var_4_int, bool var_5_bool, bool var_6_bool, float var_7_float, int var_8_int, object var_9_object, object var_10_object, bool var_11_bool, object var_12_object, bool var_13_bool, object var_14_object, bool var_15_bool, object var_16_object, bool var_17_bool, bool var_18_bool, bool var_19_bool, bool var_20_bool)
	{
		...
		if(var_21_bool != 0) {
			...
			func_3453(var_28_bool, var_29_object);
		}
	}
...
task task_3
{
	...
	void OnAttacked(cvector var_0_cvector, cvector var_1_cvector, object var_2_object, int var_3_int, int var_4_int, bool var_5_bool, bool var_6_bool, float var_7_float, int var_8_int, object var_9_object, bool var_10_bool, object var_11_object, bool var_12_bool, object var_13_object, bool var_14_bool, object var_15_object, bool var_16_bool, object var_17_object, bool var_18_bool, bool var_19_bool, bool var_20_bool)
	{
		...
		bool var_22_bool; object var_23_object;
		var_20_bool = var_23_object;
		func_3453(var_22_bool, var_23_object);
	}
...
void func_3097(bool var_987_bool, float var_988_float)
{
	float var_990_float;
	@rand(var_990_float);
...
void func_3117(object var_216_object)
{
	bool var_218_bool;
...
void func_3126(string var_857_string, int var_858_int)
{
...
void func_3133(int var_851_int)
{
...
void func_3575(string var_1077_string)
{
	var_1077_string = "k5q03_corpse";
}
...
// @pe
void func_3156(object var_24_object)
{
	int var_25_int;
...
void func_3177(bool var_22_bool, object var_23_object, string var_24_string)
{
	...
	if(var_24_string == var_45_string) {
		...
		if(var_47_bool != 0) {
			...
			if(!(var_24_string == var_55_string)) goto Label_3220;
			...
			if(((var_33_cvector - var_34_cvector) | (var_33_cvector - var_34_cvector)) < 4000000.0) {
				...
				func_3453(var_59_bool, var_60_object);
				if(var_59_bool != 0) {
					var_22_bool = true;
					return 16;
				}
...
Label_3220:
	if(!(var_24_string == "player_shot")) goto Label_3249;
	...
	if(var_40_float < 360000.0) {
		...
		func_3453(var_71_bool, var_72_object);
		if(var_71_bool != 0) {
			var_22_bool = true;
			return 16;
		}
	}
	if(!(var_40_float < 12250000.0)) goto Label_3249;
	bool var_75_bool; object var_76_object;
	var_23_object = var_76_object;
	func_3417(var_75_bool, var_76_object);
	if(var_75_bool == 0) goto Label_3249;
	var_22_bool = true;
}
...
// @pe
void func_3251(bool var_21_bool, object var_22_object)
{
	...
	if(var_51_bool != 0) {
		...
		func_3453(var_55_bool, var_56_object);
...
// @pe
void func_3302(bool var_21_bool, object var_22_object)
{
	object var_24_object;
...
void func_3316(bool var_42_bool)
{
...
// @pe
void func_3353(bool var_87_bool, int var_88_int)
{
	...
	for(;;) {
		...
		if(var_864_bool != 0) {
			...
			if(var_844_int == 0) {
				...
				func_3126(var_873_string, var_874_int);
...
// @pe
void func_3399(bool var_43_bool, object var_44_object)
{
...
// @pe
void func_3417(bool var_47_bool, object var_48_object)
{
...
// @pe
void func_3435(bool var_27_bool, object var_28_object)
{
...
// @pe
void func_3453(bool var_21_bool, object var_22_object)
{
...
void func_3471(bool var_991_bool)
{
	string var_994_string;
	func_3577(var_994_string);
	int var_993_int;
...
// @pe
void func_3482(bool var_755_bool)
{
...
void func_3496(bool var_977_bool)
{
	string var_980_string;
	func_3571(var_980_string);
	int var_979_int;
...
void func_3509(bool var_1004_bool)
{
	string var_1007_string;
	func_3571(var_1007_string);
	int var_1006_int;
...
void func_3571(string var_59_string)
{
	var_59_string = "pt_k5q03_patrol";
}


void func_3573(string var_55_string)
{
...
void func_3577(string var_756_string)
{
	var_756_string = "pt_k5q03_center";
}


void func_3579(int var_983_int)
{
	var_983_int = 3;
}
