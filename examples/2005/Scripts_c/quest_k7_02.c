...
maintask task_0
{
	void init(object var_0_object)
	{
		@SetVariable("k7q02", 1);
		bool var_5_bool;
		func_126(var_5_bool, "gatherer3");
		object var_2_object;
		@GetMainOutdoorScene(var_2_object);
		object var_10_object; object var_11_object;
		var_2_object = var_11_object;
		func_108(var_10_object, var_11_object, "pt_gatherer3", "pers_morlok", "k7q02_gatherer.xml");
...
void func_66(object var_0_object)
{
	...
	func_102(var_36_object);
	@RemoveActor(var_36_object);
}


void func_102(object var_36_object)
{
...
void func_108(object var_10_object, object var_11_object, string var_12_string, string var_13_string, string var_14_string)
{
...
void func_126(bool var_5_bool, string var_6_string)
{
	object var_8_object;
