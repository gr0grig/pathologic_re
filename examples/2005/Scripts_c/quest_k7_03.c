...
maintask task_0
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string)
	{
		...
		if(var_3_string == "place_family") {
			...
			func_130(var_9_object, var_10_object, "pt_k7q03_father", "pers_unosha", "k7q03_father.xml");
			var_0_object = var_9_object;
			object var_27_object; object var_28_object;
			var_5_object = var_28_object;
			func_130(var_27_object, var_28_object, "pt_k7q03_daughter", "pers_littlegirl", "k7q03_daughter.xml");
			var_1_object = var_27_object;
			object var_32_object; object var_33_object;
			var_5_object = var_33_object;
			func_130(var_32_object, var_33_object, "pt_k7q03_son", "pers_littleboy", "k7q03_son.xml");
...
void func_130(object var_9_object, object var_10_object, string var_11_string, string var_12_string, string var_13_string)
{
...
void func_70(void)
{
	...
	func_78(var_3_string, var_4_object, var_5_object);
}


void func_78(object var_0_object, object var_1_object, object var_2_object)
{
	if(var_0_object != 0)
...
void func_124(object var_17_object)
{
...
{
	@SetVariable("k7q03", -1);
	func_78(var_4_float, var_5_int, var_6_int);
}
