...
task task_1
{
	...
	void OnSee(object actor, bool var_1_bool, object var_2_object)
	{
		...
		if(var_5_bool != 0) {
			...
			func_1751(var_144_bool, actor, var_146_object);
			if(var_144_bool != 0)
				var_4_bool = true;
		}
		if(var_4_bool != 0) {
...
void func_1418(bool var_9_bool, object var_10_object)
{
...
void func_1723(bool var_5_bool, object var_6_object)
{
	...
	if(var_7_bool != 0) {
		...
		func_1710(var_131_bool, var_132_object);
		if(var_131_bool != 0)
			var_5_bool = true;
	}
}
...
// @pe
void func_1751(bool var_144_bool, object var_145_object, object var_146_object)
{
	...
	func_1777(var_148_bool, var_149_object);
...
void func_1368(cvector var_296_cvector)
{
...
Label_112:
	...
	for(;;) {
		...
		if(var_177_bool != 0) {
			...
			if(var_271_bool != 1) {
				bool var_272_bool;
				func_1710(var_272_bool, var_0_object);
...
void func_1399(object var_285_object)
{
