...
void func_2048(string var_119_string)
{
...
// @pe
void func_2565(object var_174_object)
{
	object var_175_object;
	func_2525(var_175_object, var_175_object);
}


// @pe
void func_2571(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
	func_2826(var_14_bool, var_15_object);
...
// @pe
void func_2578(object var_174_object)
{
	object var_175_object;
	func_2525(var_175_object, var_175_object);
}
...
void func_2584(bool var_476_bool, object var_477_object)
{
...
void func_2089(void)
{
	...
	int var_109_int;
	func_2135(var_109_int, "ognemet_ammo");
	bool var_60_bool;
...
// @pe
void func_2616(object var_492_object)
{
	TaskCall(6);
...
void func_2626(object var_47_object)
{
...
// @pe
void func_2558(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
...
void func_2135(int var_74_int, string var_75_string)
{
	int var_77_int;
...
// @pe
void func_2650(object var_98_object)
{
	object var_99_object;
	var_98_object = var_99_object;
	func_2626(var_99_object);
	object var_100_object;
	func_2525(var_100_object, var_100_object);
}
...
void func_2140(bool var_20_bool, object var_21_object, bool var_22_bool)
{
...
// @pe
void func_2660(object var_12_object)
{
	object var_13_object;
...
void func_1173(bool var_0_bool, object var_1_object, object var_380_object, bool var_397_bool)
{
		...
		if(var_387_bool != 0) {
			...
			for(;;) {
				...
				if(var_471_bool != 0) {
						...
						if(!(var_390_float <= 0.04)) goto Label_1271;
	...
	Label_1271:
		var_380_object->SetProperty("disease", (var_390_float - 0.04));
	}
}


void func_2712(bool var_14_bool, object var_15_object, object var_16_object, bool var_17_bool)
{
	bool var_19_bool;
	object var_21_object;
	var_16_object = var_21_object;
	bool var_20_bool;
	func_2140(var_20_bool, var_21_object, !var_17_bool);
	if(var_20_bool != 0) {
...
void func_2738(int var_16_int)
{
	object var_26_object; bool var_27_bool; float var_28_float; float var_29_float; float var_30_float;
	if(var_16_int != 70)
		return 14;
	var_33_object = GlobalVars[0];
	if(var_33_object == null)
		return 14;
	var_35_object = GlobalVars[0];
	object var_24_object;
	float var_25_float;
	var_35_object->Intersect(var_24_object, var_25_float);
	var_36_object = GlobalVars[0];
	var_37_bool = GlobalVars[3];
	if(var_37_bool != 0) {
		float var_38_float; float var_39_float; float var_40_float;
		var_25_float = var_39_float;
		var_41_float = GlobalVars[2];
		var_41_float = var_40_float;
		func_1915(var_38_float, var_39_float, var_40_float);
	} else {
					var_134_float = 0.05;
	}
	var_36_object->SetLength(var_38_float);
	func_1963();
	
	for(;;) {
		var_24_object->Next(var_27_bool, var_26_object);
		if(var_27_bool != 0) {
			bool var_50_bool = false;
			if(var_26_object != null) {
				object var_52_object;
				func_1899(var_52_object);
				if(var_26_object != var_52_object)
					var_50_bool = true;
			}
			if(var_50_bool != 0) {
				float var_54_float; object var_55_object;
				var_26_object = var_55_object;
				func_1442(var_54_float, var_55_object, 0.1, 2);
				var_54_float = var_28_float;
				bool var_119_bool; object var_120_object;
				var_26_object = var_120_object;
				func_1430(var_119_bool, var_120_object, "disease");
				if(var_119_bool != 0) {
					var_26_object->GetProperty("disease", var_29_float);
					if(var_29_float <= 0.04)
						var_29_float = 0;
					else
						var_29_float -= 0.04;
				return 14;
				...
				var_26_object->SetProperty("disease", var_29_float);
			}
			bool var_126_bool; object var_127_object;
			var_26_object = var_127_object;
			func_1430(var_126_bool, var_127_object, "fire");
			if(var_126_bool != 0) {
				var_26_object->GetProperty("fire", var_30_float);
				var_26_object->SetProperty("fire", (var_30_float + 0.1));
			}
		}
	}
	...
	for(;;) {
		...
		if(var_92_bool != 0) {
			...
			if(var_70_int == 0) {
				...
				func_1974(var_101_string, var_102_int);
...
// @pe
void func_2826(bool var_111_bool, object var_112_object)
{
...
void func_2317(bool var_22_bool)
{
	...
	if(var_38_bool != var_22_bool) {
		if(var_22_bool != 0) {
			...
			if(!(var_51_object != null)) goto Label_2369;
...
void func_2373(cvector var_336_cvector)
{
...
void func_863(bool var_0_bool, object var_101_object, object var_102_object, bool var_232_bool)
{
	...
	for(;;) {
		bool var_111_bool;
		func_2826(var_111_bool, var_0_bool);
		if(var_111_bool != 0) {
			func_1954(var_0_bool);
...
void func_2404(object var_325_object)
{
...
// @pe
void func_1396(string var_85_string, int var_86_int)
{
	if(var_86_int == 2) {
		var_85_string = "fire";
		return 0;
...
void func_2423(bool var_113_bool, object var_114_object)
{
...
// @pe
void func_1915(float var_38_float, float var_39_float, float var_40_float)
{
...
// @pe
void func_1922(float var_104_float, float var_105_float, float var_106_float, float var_107_float)
{
...
void func_1425(bool var_110_bool, object var_111_object)
{
	bool var_113_bool;
	@IsPlayerActor(var_111_object, var_113_bool);
...
void func_1430(bool var_70_bool, object var_71_object, string var_72_string)
{
...
void func_1944(float var_114_float)
{
	object var_116_object;
	@CreateFloatVector(var_116_object);
	var_116_object->add(var_114_float);
	@SendWorldWndMessage(15, var_116_object);
}
EMIT "Stack[-1] = 0";


void func_1954(object var_201_object)
{
	bool var_203_bool;
...
void func_1442(float var_54_float, object var_55_object, float var_56_float, int var_57_int)
{
	int var_64_int; int var_66_int;
	object var_71_object;
	var_55_object = var_71_object;
	bool var_70_bool;
	func_1430(var_70_bool, var_71_object, "health");
	if(!var_70_bool) //@nz
		var_54_float = 0.0;
	bool var_80_bool; object var_81_object;
	func_1430(var_80_bool, var_81_object, "armor");
	if(!var_80_bool) //@nz
		var_64_int = 0;
	else
		var_81_object->GetProperty("armor", var_64_int);
	string var_85_string; int var_86_int;
	var_57_int = var_86_int;
	func_1396(var_85_string, var_86_int);
	string var_65_string = "armor_" + var_85_string;
	bool var_91_bool; object var_92_object; string var_93_string;
	var_55_object = var_92_object;
	func_1430(var_91_bool, var_92_object, var_93_string);
	if(!var_91_bool) //@nz
		var_66_int = 0;
	else
		var_55_object->GetProperty(var_93_string, var_66_int);

	float var_95_float;
	func_1915(var_95_float, ((var_64_int + var_66_int) / 100.0), (float)1);
	float var_67_float;
	var_95_float = var_67_float;
	float var_68_float;
	var_55_object->GetProperty("health", var_68_float);
	float var_69_float = var_56_float * (1 - var_67_float);
	float var_104_float;
	func_1922(var_104_float, (var_68_float - var_69_float), (float)0, (float)1);
	var_55_object->SetProperty("health", var_104_float);
	bool var_110_bool; object var_111_object;
	var_55_object = var_111_object;
	func_1425(var_110_bool, var_111_object);
	if(var_110_bool != 0) {
		float var_114_float = -var_69_float;
		func_1944(var_114_float);
	}
	var_69_float = var_54_float;
...
void func_1963(void)
{
	...
	@GetScene(var_44_object);
	object var_46_object;
	func_1899(var_46_object);
	@BroadcastMessage("battle", var_46_object, var_44_object);
}
EMIT "Stack[-1] = 0";


void func_1974(string var_85_string, int var_86_int)
{
...
void func_1998(int var_113_int)
{
	int var_115_int;
...
// @pe
void func_2004(object var_15_object)
{
	int var_16_int;
	func_1998(var_16_int);
	if(var_16_int == 1)
...
// @pe
void func_2525(object var_100_object, object var_103_object)
{
	object var_102_object;
	var_100_object = var_102_object;
	TaskCall(4);
...
void func_2017(int var_62_int, int var_63_int)
{
