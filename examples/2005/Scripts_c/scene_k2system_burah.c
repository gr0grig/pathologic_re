...
void func_144(object var_31_object, object var_32_object)
{
	...
	func_117(var_36_object, var_37_object, "pt_k2s_npc", "NPC_Burah", "k2system_burah.xml");
...
{
	var_13_object->add("pers_butcher");
	var_14_object->add("k2system_butcher.xml");
	var_15_object->add(false);
	var_13_object->add("pers_morlok");
	var_14_object->add("k2system_morlok.xml");
	var_15_object->add(false);
	var_13_object->add("pers_morlok");
	var_14_object->add("k2system_morlok.xml");
	var_15_object->add(false);
