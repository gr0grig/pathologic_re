maintask task_0
{
	...
	void OnLoad(object var_0_object, object var_1_object, object var_2_object)
	{
		...
		if(var_4_int != 0) {
			...
			func_94(var_12_object);
			var_12_object = var_8_object;
			func_100(var_7_object, var_8_object, "pt_Aglaja", "NPC_Aglaja", "NPC_Klara_Aglaja.xml");
			var_0_object = var_7_object;
			object var_28_object; object var_29_object;
			object var_33_object;
			func_94(var_33_object);
			var_33_object = var_29_object;
			func_100(var_28_object, var_29_object, "pt_sobor_mask1", "pers_whitemask", "sobor_whitemask.xml");
			var_1_object = var_28_object;
			object var_34_object; object var_35_object;
			object var_39_object;
			func_94(var_39_object);
			var_39_object = var_35_object;
			func_100(var_34_object, var_35_object, "pt_sobor_mask2", "pers_whitemask", "sobor_whitemask.xml");
			var_2_object = var_34_object;
		}
		bool var_40_bool;
		func_118(var_40_bool, "quest_k12_01", "sobor_load");
		bool var_46_bool;
		func_118(var_46_bool, "quest_k5_04", "sobor_load");
	}
	...
	void OnUnload(object var_0_object, object var_1_object, object var_2_object)
	{
		...
		bool var_6_bool;
		func_118(var_6_bool, "quest_k12_01", "sobor_unload");
		bool var_12_bool;
		func_118(var_12_bool, "quest_k5_04", "sobor_unload");
	}
...
void func_118(bool var_6_bool, string var_7_string, string var_8_string)
{
...
void func_100(object var_7_object, object var_8_object, string var_9_string, string var_10_string, string var_11_string)
{
...
void func_94(object var_12_object)
{
