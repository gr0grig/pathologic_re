...
// @pe
void func_0(object var_25_object)
{
	object var_27_object;
	var_25_object = var_27_object;
	bool var_26_bool;
	func_995(var_26_bool, var_27_object);
	if(var_26_bool != 0)
		func_1654();
	func_1630();
...
// @pe
void func_133(string var_127_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_1294(string var_72_string, int var_73_int, int var_74_int)
{
	bool var_76_bool;
	int var_78_int;
	...
	bool var_77_bool;
	func_1486(var_77_bool, var_78_int, var_79_int);
	if(var_77_bool != 0)
		@AddItem(var_76_bool, var_72_string, 0);
}
...
// @pe
void func_17(object var_104_object)
{
...
void func_1305(string var_52_string, int var_53_int, int var_54_int, int var_55_int)
{
	...
	if(var_60_bool != 0) {
		...
		@AddItem(var_59_bool, var_52_string, 0, (var_58_int + 1));
	}
}


void func_1690(int var_45_int, string var_46_string)
{
	int var_48_int;
...
// @pe
void func_1695(object var_24_object)
{
...
void func_1320(string var_128_string)
{
	bool var_137_bool; int var_138_int; bool var_139_bool; int var_140_int; bool var_141_bool; float var_142_float; cvector var_143_cvector; cvector var_144_cvector;
	@IsExisting3DSound(var_137_bool, var_128_string);
	if(!var_137_bool) { //@nz
		var_138_int = 0;

		for(;;) {
			@IsExisting3DSound(var_139_bool, (var_128_string + (var_138_int + 1)));
			if(!var_139_bool) { //@nz
				break;
			Label_1340:
				@irand(var_140_int, var_138_int);
				var_128_string += (var_140_int + 1);
	}
			@Is3DSoundLoaded(var_141_bool, var_128_string);
			if(var_141_bool != 0) {
				@GetEyesHeight(var_142_float);
				@GetDirection(var_143_cvector);
				var_144_cvector = var_143_cvector * 50;
				var_155_float = GetByIndex(var_144_cvector, 1);
				SetByIndex(var_144_cvector, 1) = (var_155_float + var_142_float);
				@PlayGlobalSound(var_128_string, var_144_cvector);
			}
		}
		var_138_int += 1;
	}
	var_150_bool = !var_138_int; //@nz
	if(var_150_bool == 0) goto Label_1340;
}
...
void func_42(object var_105_object)
{
	cvector var_116_cvector; cvector var_117_cvector; cvector var_118_cvector; cvector var_119_cvector; string var_120_string; object var_121_object; bool var_122_bool; bool var_123_bool; float var_124_float; cvector var_125_cvector;
	if(var_105_object == null) {
		...
		if(((var_159_float * var_160_float) + (var_162_float * var_163_float)) >= 0)
			var_120_string = "fdie";
		else
			var_120_string = "bdie";
		@RemoveRTEnvelope();
		...
		var_170_bool = IsFuncExist(var_105_object, "GetScriptProperty", 2);
		if(var_170_bool != 0) {
		...
		var_177_bool = IsFuncExist(var_121_object, "@GetEyesHeight", 1);
		if(var_177_bool != 0) {
			var_121_object->GetEyesHeight(var_124_float);
			var_125_cvector = [0.0, 0.0, 0.0];
...
void func_1582(int var_33_int, int var_34_int)
{
	if(var_33_int > var_34_int) {
		@Trace("GenerateMoney: iMin > iMax");
		return 4;
	}
	int var_37_int = 0;
	if(var_33_int != var_34_int) {
		@irand(var_37_int, (var_34_int - var_33_int));
	} else if(var_33_int == 0) {
		return 4;
	}
	var_37_int += var_33_int;
	if(var_37_int == 0)
		return 4;
	int var_45_int;
	func_1690(var_45_int, "Money");
	bool var_38_bool;
...
void func_1613(string var_90_string)
{
	object var_94_object;
	@CreateInvItem(var_94_object);
	var_94_object->SetItemName(var_90_string);
	var_94_object->SetProperty("Organ", 1);
	int var_95_int;
	var_94_object->GetItemID(var_95_int);
	bool var_96_bool;
	@AddItem(var_96_bool, var_94_object, 0, 1);
}
EMIT "Stack[-3] = 0";


void func_1486(bool var_60_bool, int var_61_int, int var_62_int)
{
	int var_64_int;
