maintask task_0
{
	...
	// @pe
	void OnPlayerHolsterWeapon(int var_0_int, int var_1_int, object var_2_object, string var_3_string, int var_4_int, int var_5_int, float var_6_float)
	{
		@SendToParent();
	}
	...
	void event_200(int var_0_int, int var_1_int, object var_2_object, string var_3_string, int var_4_int, string var_5_string, object var_6_object)
	{
		...
		if((var_4_int & 32768) != 0) {
			...
			@SetTooltip(-1, "");
				...
				if(var_2_object == 0) goto Label_70;
