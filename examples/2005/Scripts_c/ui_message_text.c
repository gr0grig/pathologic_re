maintask task_0
{
	void init(int var_0_int, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, object var_7_object, object var_8_object, object var_9_object)
	{
		...
		func_108(var_31_object, var_32_object, var_33_object);
		func_129(var_32_object, var_33_object);
		@ProcessEvents();
	}
	...
	void OnPlayerHolsterWeapon(int var_0_int, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, object var_7_object, object var_8_object, object var_9_object, int var_10_int, int var_11_int, float var_12_float)
	{
		...
		int var_13_int;
		func_108(var_12_float, var_13_int, var_14_int);
		func_129(var_13_int, var_14_int);
	}
	...
	void OnHear(int var_0_int, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, object var_7_object, object var_8_object, object var_9_object, int var_10_int, int var_11_int)
	{
		...
		int var_13_int;
		int var_14_int;
		func_191(var_7_object, var_8_object, var_9_object, var_10_int, var_11_int, var_12_int, var_13_int, var_14_int, var_15_int);
		...
		func_108(var_11_int, var_12_int, var_13_int);
		func_129(var_12_int, var_13_int);
	...
	void OnRegionChange(int var_0_int, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, object var_7_object, object var_8_object, object var_9_object, int var_10_int, int var_11_int)
	{
		...
		func_191(var_5_int, var_6_int, var_7_object, var_8_object, var_9_object, var_10_int, var_13_int, var_12_int, var_13_int);
	...
	void event_200(int var_0_int, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, object var_7_object, object var_8_object, object var_9_object, int var_10_int, string var_11_string, object var_12_object)
	{
		if(var_11_string == "scrollbar") {
			...
			func_108(var_10_int, var_11_string, var_12_object);
			return 0;
		EMIT "GOTO 0x17f";
		}
		if(var_11_string == "message") {
			if((var_10_int & 32768) != 0) {
				...
				func_108(var_10_int, var_11_string, var_12_object);
				func_129(var_11_string, var_12_object);
			}
		}
...
void func_129(int var_0_int, int var_1_int)
{
	if(var_1_int == 0) {
...
void func_145(int var_2_int, int var_4_int, int var_5_int, object var_7_object, object var_8_object, object var_9_object, int var_54_int)
{
...
void func_108(int var_0_int, int var_1_int, int var_3_int)
{
	int var_54_int;
	func_145(var_28_string, var_29_int, var_30_int, var_31_object, var_32_object, var_33_object, var_54_int);
...
Label_128:
	...
	if(!(var_0_int > 0)) goto Label_128;
	var_0_int = 0;
}


void func_191(int var_0_int, int var_2_int, int var_4_int, int var_5_int, object var_7_object, object var_8_object, object var_9_object, int var_12_int, int var_13_int)
{
