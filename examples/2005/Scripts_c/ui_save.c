maintask task_0
{
	void init(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object)
	{
		...
		while(true != 0) {
			func_39(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, true);
		}
	...
	{
		int var_12_int;
		func_106(var_12_int, var_1_int);
		int var_11_int;
		var_12_int = var_11_int;
		func_109(var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_int);
	}
	...
	void event_200(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, string var_12_string, object var_13_object)
	{
		if(var_12_string == "scrollbar") {
			...
			int var_17_int;
			func_482(var_16_int, var_17_int);
			var_1_int = (var_16_int * (var_17_int - var_5_int)) / 100;
			func_490(var_12_string, var_13_object);
		}
	}
	...
	void OnPlayerHolsterWeapon(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int, float var_13_float)
	{
		...
		int var_14_int;
		func_490(var_14_int, var_15_int);
	}
	...
	void OnStopSee(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int)
	{
		...
		func_402(var_14_int, var_15_int, var_13_int, var_14_int, var_15_int);
		var_2_int = var_13_int;
		int var_36_int; int var_37_int; int var_38_int;
		func_441(var_37_int, var_38_int, var_36_int, var_37_int, var_38_int);
	...
	void OnHear(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int)
	{
		...
		if(var_2_int != -1) {
			...
			func_402(var_15_object, var_16_object, var_19_int, var_20_int, var_21_int);
...
void func_480(int var_32_int)
{
	var_32_int = 121;
}


void func_482(object var_9_object, int var_29_int)
{
	int var_31_int;
...
void func_39(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, bool var_12_bool)
{
	...
	for(;;) {
		if(1 != 0) {
			...
			if(!var_17_object) { //@nz
				...
				if(var_12_bool == 0) goto Label_70;
				var_17_object->IsQuickSave(var_18_bool);
				if(var_18_bool == 0) goto Label_70;
			}
		}
		...
		func_490(var_17_object, var_18_bool);
		@ProcessEvents();
		return 6;
...
void func_553(string var_106_string, object var_107_object)
{
	...
	func_524(var_120_string, 19);
	string var_122_string;
	func_524(var_122_string, (20 + var_119_int));
...
void func_490(int var_1_int, int var_5_int)
{
	int var_28_int;
	int var_29_int;
	func_482(var_28_int, var_29_int);
...
// @pe
void func_106(int var_12_int, int var_13_int)
{
	var_13_int = var_12_int;
}


void func_524(string var_68_string, int var_69_int)
{
...
void func_109(int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_9_object, int var_11_int)
{
	...
	for(;;) {
				...
				if(var_29_bool != 0) {
					...
					@Print("default", 129, (7 + var_37_int), var_68_string, 0.5568628, 0.5568628, 0.5568628);
							...
							if(var_31_bool != 0) {
								...
								func_524(var_168_string, (500 + var_32_int));
							...
							func_274(0, var_179_int, true);
							string var_185_string;
							func_524(var_185_string, 32);
		...
		func_529(var_75_string, var_76_object);
		...
		func_553(var_106_string, var_107_object);
	...
	Label_236:
		...
		func_10(var_143_object, 129, (67 + var_11_int));
		var_11_int += 90;
...
// @pe
void func_10(object var_143_object, int var_144_int, int var_145_int)
{
...
void func_529(string var_75_string, object var_76_object)
{
	float var_83_float;
	var_76_object->GetGameTime(var_83_float);
	string var_95_string;
	func_524(var_95_string, 18);
...
// @pe
void func_274(int var_36_int, int var_37_int, bool var_38_bool)
{
	if(var_38_bool != 0)
...
void func_402(int var_1_int, object var_9_object, int var_19_int, int var_20_int, int var_21_int)
{
	if(var_20_int < 129) {
		var_19_int = -1;
		return 8;
...
// @pe
void func_21(object var_44_object)
{
	@SendMessageToParent(0, var_44_object);
}


void func_441(int var_1_int, object var_9_object, int var_50_int, int var_51_int, int var_52_int)
{
	if(var_51_int < 248) {
		var_50_int = -1;
		return 8;
...
void func_26(object var_76_object)
{
