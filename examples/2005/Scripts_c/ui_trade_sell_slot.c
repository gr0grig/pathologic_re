maintask task_0
{
	...
	{
		string var_8_string; int var_9_int; int var_10_int;
		if(!var_2_object) { //@nz
		}
		...
		if(var_14_bool != 0) {
			var_8_string = (var_0_int + "/") + var_1_int;
			@GetTextWidth(var_9_int, "default", var_8_string);
			if((48 - var_9_int) < 2)
				var_10_int = 2;
			@Print("default", var_10_int, 35, var_8_string);
		}
		if(var_3_bool != 0)
