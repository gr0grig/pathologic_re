...
void func_56(string var_3_string, int var_4_int, int var_5_int, int var_6_int)
{
...
{
	@RemoveAllItems();
	func_56("bottle_empty", 1, 2, 2);
}


void func_76(bool var_5_bool)
{
	int var_7_int;
...
void func_71(bool var_11_bool, int var_12_int, int var_13_int)
{
	int var_15_int;
