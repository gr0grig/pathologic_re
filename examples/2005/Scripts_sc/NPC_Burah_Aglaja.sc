...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_10ee_a1_b(f_119b_a0_o());
		if (!f_1099_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1220_a0_i());
		L0->SetNPCDescription(f_121e_a0_i());
		L0->SetPhoto(f_1222_a0_s());
		L0->SetPhoto2(f_1224_a0_s());
		L0->SetPlayerName(f_14c8_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_13ad_a1_b(tv1) && !f_13a1_a1_b(tv1) && f_13b9_a1_b(tv1)) {
				tv0->AddReply(530358, 32319, 31732);
			}
			if (f_13ad_a1_b(tv1) && f_13a1_a1_b(tv1) && f_13c5_a1_b(tv1)) {
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_12ef_a1_b(tv1) && f_12fb_a1_b(tv1) && f_13e7_a1_b(tv1)) {
				f_1273_a2_v(tv1, tv0);
				f_58c_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_13e7_a1_b(tv1) && f_13f2_a1_b(tv1)) {
				tv0->AddReply(521043, 22240, 22239);
			}
			if (f_1307_a1_b(tv1) && f_13d1_a1_b(tv1) && !f_131f_a1_b(tv1) || f_1313_a1_b(tv1) && !f_131f_a1_b(tv1)) {
				tv0->AddReply(521348, 22536, 22535);
			}
			if (f_1307_a1_b(tv1) && !f_13d1_a1_b(tv1)) {
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_134f_a1_b(tv1) && f_1371_a1_b(tv1)) {
...
maintask t15
{
	...
	bool f_f8b_a0_b(void)
	{
		...
		return f_108b_a1_b(L0);
	}

	void f_f9a_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_f9f_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_fbe_a0_v();
			if (f_1094_a0_b() && f_f9f_a0_b()) {
				if (f_f8b_a0_b()) {
					f_1128_a1_b(f_119b_a0_o());
				}
			} else {
				f_f9a_a0_v();
				f_fb5_a0_v();
...
void f_102d_a0_v(void)
{
	...
	L0 = f_120d_a0_i();
	for (L1 = 0; L1 < 5 && f_1094_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1206_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_1072_a0_b(void)
{
	return true;
}

void f_1074_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1079_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_108b_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1081_a1_b(L0);
}

bool f_1094_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1099_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_11a1_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_117f_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_11bb_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
bool f_11cc_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_11ed_a1_b(int a0)
{
	return f_11e4_a0_i() == a0;
}

bool f_11f3_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_120d_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1206_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_1222_a0_s(void)
{
	return "ui/NPC_Aglaja.png";
}

string f_1224_a0_s(void)
{
	return "ui/NPC_Aglaja_b.png";
}

bool f_1226_a0_b(void)
{
	return true;
}

void f_1228_a2_v(object a0, object a1)
{
	f_11bb_a2_v("boiny@door1", false);
}

void f_122f_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b7q01", 7);
	L0 = f_1496_a0_o();
	L0->AddMark("b7q01AglajaGotoStarshina", "pt_map_starshina", 1, 521027, f_11df_a0_f());
	f_1405_a0_v();
}

void f_1246_a2_v(object a0, object a1)
{
	f_1412_a0_v();
	f_11d3_a2_b("quest_b7_01", "completed");
}
...
void f_1250_a2_v(object a0, object a1)
{
	...
	@SetVariable("b7q03", 1);
	L0 = f_1496_a0_o();
	L0->AddMark("b7q03AglajaGotoTheater", "pt_map_theater", 0, 521367, f_11df_a0_f());
	f_141f_a0_v();
	f_142c_a0_v();
	f_11b0_a1_o("quest_b7_03");
	f_11d3_a2_b("quest_b7_03", "place_birdmask");
}
...
{
	f_1439_a0_v();
	f_11d3_a2_b("quest_b7_03", "completed");
}
...
void f_128f_a2_v(object a0, object a1)
{
	@SetVariable("oob8Aglaja1", 1);
}

void f_1295_a2_v(object a0, object a1)
{
	f_1460_a0_v();
	f_11d3_a2_b("quest_b8_01", "completed");
}
...
void f_12b1_a2_v(object a0, object a1)
{
	@SetVariable("oob9Aglaja1", 1);
}

void f_12b7_a2_v(object a0, object a1)
{
	@SetVariable("oob9Aglaja2", 1);
}

void f_12bd_a2_v(object a0, object a1)
{
	if (f_11ab_a1_i("map_chertez_state") <= 1) {
		@SetVariable("map_chertez_state", 1);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_12ce_a2_v(object a0, object a1)
{
	if (f_11ab_a1_i("map_chertez_state") <= 2) {
		@SetVariable("map_chertez_state", 2);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_12df_a2_v(object a0, object a1)
{
	f_14a7_a3_v(f_1496_a0_o(), "pt_map_aglaja", -1);
	a1->ShowMap(f_1496_a0_o());
}

bool f_12ef_a1_b(object a0)
{
	if (f_11ab_a1_i("b7q01") == 1000) {
		return true;
	}
	return false;
}

bool f_12fb_a1_b(object a0)
{
	if (f_11ab_a1_i("oob7Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_1307_a1_b(object a0)
{
	if (f_11ab_a1_i("b7q03") == 2) {
		return true;
	}
	return false;
}
...
{
	if (f_11ab_a1_i("b7q03SerumWorks") != 0) {
		return true;
	}
	return false;
}

bool f_131f_a1_b(object a0)
{
	if (f_11ab_a1_i("b7q03") == 1000) {
		return true;
	}
	return false;
}

bool f_132b_a1_b(object a0)
{
	if (f_11ab_a1_i("oob8Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_1337_a1_b(object a0)
{
	if (f_11ab_a1_i("b8q01") == 0) {
		return true;
	}
	return false;
}

bool f_1343_a1_b(object a0)
{
	if (f_11ab_a1_i("b8q01") == 7) {
		return true;
	}
	return false;
}

bool f_134f_a1_b(object a0)
{
	if (f_11ab_a1_i("b8q03") != 0 && f_11ab_a1_i("b8q03") != 1000 && f_11ab_a1_i("b8q03") != -1) {
		return true;
	}
	return false;
}
...
{
	if (f_11ab_a1_i("oob8Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_137d_a1_b(object a0)
{
	if (f_11ab_a1_i("b11q01") == 1000) {
		return true;
	}
	return false;
}

bool f_1389_a1_b(object a0)
{
	if (f_11ab_a1_i("oob11Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_1395_a1_b(object a0)
{
	if (f_11ab_a1_i("oob11Aglaja2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_11ab_a1_i("b9q03BonefiresCount") == 4) {
		return true;
	}
	return false;
}
...
{
	if (f_11ab_a1_i("oob9Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_13c5_a1_b(object a0)
{
	if (f_11ab_a1_i("oob9Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_13d1_a1_b(object a0)
{
	if (f_13fe_a1_b(a0)) {
		return true;
	}
...
bool f_147a_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_14a7_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
