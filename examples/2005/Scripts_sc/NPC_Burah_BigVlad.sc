...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_107c_a1_b(f_1129_a0_o());
		if (!f_1027_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_11e7_a0_i());
		L0->SetNPCDescription(f_11e5_a0_i());
		L0->SetPhoto(f_11e9_a0_s());
		L0->SetPhoto2(f_11eb_a0_s());
		L0->SetPlayerName(f_14ac_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1340_a1_b(tv1) && f_134c_a1_b(tv1)) {
				tv0->AddReply(523467, 24695, 24693);
			}
			if (f_1340_a1_b(tv1) && f_1358_a1_b(tv1)) {
				tv0->AddReply(523468, 24699, 24694);
			}
			if (f_1340_a1_b(tv1) && f_1364_a1_b(tv1)) {
				tv0->AddReply(523479, 24706, 24705);
			}
			if (f_1340_a1_b(tv1) && f_1370_a1_b(tv1)) {
...
bool f_fe6_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_ff2_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_fe6_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_1139_a3_f(L0 + a2, a3, a4));
	return true;
}

void f_1008_a3_v(object a0, string a1, int a2)
{
	int L0;
	a0->GetProperty(a1, L0);
...
bool f_1019_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_100f_a1_b(L0);
}

bool f_1022_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1027_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_112f_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_10b6_a1_b(object a0)
{
	...
	return f_1113_a1_b(L4);
}

bool f_10db_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_11c3_a0_i() + "m";
	int L1;
...
void f_110d_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_1139_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_1166_a2_v(object a0, int a1)
{
	f_1008_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_1179_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_119c_a1_v(a1);
	f_ff2_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_119c_a1_v(float a0)
{
	object L0;
...
bool f_11a6_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_11b2_a3_b(string a0, string a1, string a2)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_11cc_a1_b(int a0)
{
	return f_11c3_a0_i() == a0;
}

bool f_11d2_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_11e7_a0_i(void)
{
	return 502857;
}

string f_11e9_a0_s(void)
{
	return "ui/NPC_BigVlad.png";
}

string f_11eb_a0_s(void)
{
...
void f_11ef_a2_v(object a0, object a1)
{
	...
	@SetVariable("b3q01", 1);
	L0 = f_147a_a0_o();
	L0->AddMark("b3q01BigVladGotoOspina", "pt_map_ospina", 1, 519627, f_11be_a0_f());
	f_141d_a0_v();
	f_142a_a0_v();
}

void f_1209_a2_v(object a0, object a1)
{
...
{
	f_1437_a0_v();
	f_11a6_a2_b("quest_b3_01", "completed");
}

void f_1219_a2_v(object a0, object a1)
{
	f_1444_a0_v();
	f_11a6_a2_b("quest_b3_01", "completed");
}

void f_1223_a2_v(object a0, object a1)
{
...
void f_1235_a2_v(object a0, object a1)
{
...
void f_123b_a2_v(object a0, object a1)
{
	...
	@SetVariable("b1q01", 1);
	L0 = f_147a_a0_o();
	L0->AddMark("b1q01BigVladGotoKapella", "pt_map_kapella", 3, 518128, f_11be_a0_f());
	L0->AddMark("b1q01BigVladGotoMladVlad", "pt_map_mladvlad", 3, 520041, f_11be_a0_f());
	f_13e9_a0_v();
	f_13f6_a0_v();
}
...
{
	f_1149_a2_v("cot_alexandr@door1", false);
}

void f_1265_a2_v(object a0, object a1)
{
	f_1149_a2_v("cot_katerina@door1", false);
}

void f_126c_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b2q01", 1);
	L0 = f_147a_a0_o();
	L0->AddMark("b2q01BigVladGotoAlexandr", "pt_map_alexandr", 1, 519625, f_11be_a0_f());
	L0->AddMark("b2q01BigVladGotoKaterina", "pt_map_katerina", 1, 519626, f_11be_a0_f());
	L0->AddMark("b2q01BigVladGotoMladVlad", "pt_map_mladvlad", 3, 519624, f_11be_a0_f());
	L0->AddMark("b2q01BigVladGotoDanko", "pt_map_eva", 3, 530806, f_11be_a0_f());
	f_1403_a0_v();
	f_1410_a0_v();
}

void f_12a1_a2_v(object a0, object a1)
{
	@SetVariable("b11q01KnowWhoKilled", 1);
	f_13dc_a0_v();
}

void f_12aa_a2_v(object a0, object a1)
{
...
{
	f_11b2_a3_b("volonteers_burah", "kill", "bigvlad");
}
...
void f_12c4_a2_v(object a0, object a1)
{
...
{
	f_1179_a2_b(a0, 0.019999999552965164);
}
...
void f_12dd_a2_v(object a0, object a1)
{
	int L0;
	@irand(L0, 30);
	f_1166_a2_v(a0, L0 + 20);
}

void f_12e8_a2_v(object a0, object a1)
{
	f_148b_a3_v(f_147a_a0_o(), "pt_map_ospina", 2);
	a1->ShowMap(f_147a_a0_o());
}

void f_12f8_a2_v(object a0, object a1)
{
	f_148b_a3_v(f_147a_a0_o(), "pt_map_alexandr", 2);
	a1->ShowMap(f_147a_a0_o());
}

void f_1308_a2_v(object a0, object a1)
{
	f_148b_a3_v(f_147a_a0_o(), "pt_map_mladvlad", 2);
	a1->ShowMap(f_147a_a0_o());
}

void f_1318_a2_v(object a0, object a1)
{
	f_148b_a3_v(f_147a_a0_o(), "pt_map_kapella", 2);
	a1->ShowMap(f_147a_a0_o());
}

bool f_1328_a1_b(object a0)
{
	if (f_1144_a1_i("b11q01") == 1000) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob11BigVlad1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("b11KnowBigVladKill") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob11BigVlad2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob11BigVlad3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob11BigVlad4") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob11BigVlad5") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob1BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_13ac_a1_b(object a0)
{
	if (f_1144_a1_i("oob1BigVlad2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1144_a1_i("oob1BigVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_13c4_a1_b(object a0)
{
	if (f_1144_a1_i("oob1BigVlad4") == 0) {
		return true;
	}
	return false;
}

bool f_13d0_a1_b(object a0)
{
	if (f_1144_a1_i("b2q01") == 0) {
		return true;
	}
	return false;
}

void f_13dc_a0_v(void)
{
	object L0;
...
bool f_145e_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_148b_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
