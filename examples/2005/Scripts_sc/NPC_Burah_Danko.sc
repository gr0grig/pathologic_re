...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_2fab_a1_b(f_3058_a0_o());
		if (!f_2f56_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_315e_a0_i());
		L0->SetNPCDescription(f_315c_a0_i());
		L0->SetPhoto(f_3160_a0_s());
		L0->SetPhoto2(f_3162_a0_s());
		L0->SetPlayerName(f_3a1b_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_36bd_a1_b(tv1) && f_367e_a1_b(tv1)) {
				tv0->AddReply(518358, 19472, 19471);
			}
			if (f_36eb_a1_b(tv1) && f_37b3_a1_b(tv1)) {
				tv0->AddReply(518361, 19475, 19474);
			}
			if (f_37a7_a1_b(tv1)) {
				tv0->AddReply(519361, 20523, 20522);
			}
			if (f_3643_a1_b(tv1) && f_3666_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_371b_a1_b(tv1) && f_3726_a1_b(tv1) && !f_370f_a1_b(tv1)) {
				tv0->AddReply(518540, 19651, 19650);
			}
			if (f_370f_a1_b(tv1) && f_371b_a1_b(tv1) && f_3726_a1_b(tv1)) {
				tv0->AddReply(518543, 19654, 19653);
			}
			if (f_3643_a1_b(tv1) && f_3732_a1_b(tv1)) {
...
task t16
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_3756_a1_b(tv1) && !f_3762_a1_b(tv1) && f_378f_a1_b(tv1) && f_379b_a1_b(tv1)) {
				tv0->AddReply(518633, 20000, 19725);
			}
			if (f_376e_a1_b(tv1) && f_378f_a1_b(tv1) && !f_35ef_a1_b(tv1)) {
				tv0->AddReply(518636, 19729, 19728);
			}
			if (f_3779_a1_b(tv1) && f_378f_a1_b(tv1) && !f_35ef_a1_b(tv1)) {
				tv0->AddReply(518639, 19732, 19731);
			}
			if (f_3784_a1_b(tv1) && f_378f_a1_b(tv1) && !f_35ef_a1_b(tv1)) {
				tv0->AddReply(518642, 19735, 19734);
			}
			if (f_35ef_a1_b(tv1) && !f_35fb_a1_b(tv1)) {
...
task t18
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_37cb_a1_b(tv1) && !f_37bf_a1_b(tv1)) {
				f_138f_a1_v("Neutral");
...
task t20
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_3807_a1_b(tv1) && f_361f_a1_b(tv1)) {
				f_3214_a2_v(tv1, tv0);
				f_1572_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_381f_a1_b(tv1) && f_3834_a1_b(tv1) && f_362b_a1_b(tv1)) {
				tv0->AddReply(520370, -1, 21574);
			}
			if (f_3637_a1_b(tv1) && !f_37fb_a1_b(tv1)) {
...
task t22
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_35cc_a1_b(tv1) && f_35d7_a1_b(tv1)) {
				tv0->AddReply(522217, 23367, 23366);
			}
			if (!f_35e3_a1_b(tv1) && f_364e_a1_b(tv1)) {
...
task t28
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (!f_34ea_a1_b(tv1) && f_34f6_a1_b(tv1) && f_3502_a1_b(tv1)) {
				tv0->AddReply(521451, 22630, 22629);
			}
			if (f_36c9_a1_b(tv1) && f_36d5_a1_b(tv1)) {
...
task t30
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_3532_a1_b(tv1) && f_354a_a1_b(tv1) && !f_353e_a1_b(tv1)) {
				tv0->AddReply(521935, 32896, 23109);
			}
			if (f_3532_a1_b(tv1) && f_353e_a1_b(tv1) && !f_354a_a1_b(tv1)) {
				tv0->AddReply(521936, 23113, 23110);
			}
			if (f_354a_a1_b(tv1) && f_353e_a1_b(tv1) && f_3532_a1_b(tv1)) {
...
task t34
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_356e_a1_b(tv1) && !f_3592_a1_b(tv1)) {
				f_32bd_a2_v(tv1, tv0);
				f_32cc_a2_v(tv1, tv0);
				f_2a65_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_35b6_a1_b(tv1) && !f_3672_a1_b(tv1) && !f_3592_a1_b(tv1)) {
				tv0->AddReply(540259, 42243, 42242);
			}
			if (f_359e_a1_b(tv1) && f_35aa_a1_b(tv1)) {
				tv0->AddReply(522987, 24179, 24178);
			}
			if (f_357a_a1_b(tv1) && f_3586_a1_b(tv1)) {
...
maintask t37
{
	...
	bool f_2e26_a0_b(void)
	{
		...
		return f_2f48_a1_b(L0);
	}

	void f_2e35_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_2e3a_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_2e59_a0_v();
			if (f_2f51_a0_b() && f_2e3a_a0_b()) {
				if (f_2e26_a0_b()) {
					f_2fe5_a1_b(f_3058_a0_o());
				}
			} else {
				f_2e35_a0_v();
				f_2e50_a0_v();
...
void f_2ec8_a0_v(void)
{
	...
	L0 = f_314b_a0_i();
	for (L1 = 0; L1 < 5 && f_2f51_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_3144_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_2f0d_a0_b(void)
{
	return true;
}

void f_2f0f_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_2f14_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_2f1c_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_2f28_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	...
	a0->SetProperty(a1, f_3068_a3_f(L0 + a2, a3, a4));
	return true;
}

bool f_2f3e_a1_b(Vector a0)
{
	Vector L0;
	Vector L1;
	bool L2;
...
bool f_2f48_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_2f3e_a1_b(L0);
}

bool f_2f51_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_2f56_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_305e_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_2fe5_a1_b(object a0)
{
	...
	return f_3042_a1_b(L4);
}

bool f_300a_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_3122_a0_i() + "m";
	int L1;
...
void f_303c_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_3068_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_3083_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_3094_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_30a0_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_30ac_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_30bf_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_30ac_a3_v(a0, L0, a2);
}

bool f_30cc_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_30d3_a2_b(object a0, string a1)
{
	int L0;
	int L1;
	bool L2;
...
bool f_30e4_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_3107_a1_v(a1);
	f_2f28_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_3107_a1_v(float a0)
{
	object L0;
...
bool f_3111_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_312b_a1_b(int a0)
{
	return f_3122_a0_i() == a0;
}

bool f_3131_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_314b_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_3144_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_315c_a0_i(void)
{
	return 515573;
}

int f_315e_a0_i(void)
{
	return 504032;
}

string f_3160_a0_s(void)
{
	return "ui/NPC_Bakalavr.png";
}

string f_3162_a0_s(void)
{
	return "ui/NPC_Bakalavr_b.png";
}

bool f_3164_a0_b(void)
{
	return true;
}

void f_3166_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b4q01", 1);
	L0 = f_39e9_a0_o();
	L0->AddMark("b4q01DankoGotoLaraSelf", "pt_map_eva", 1, 518592, f_311d_a0_f());
	L0->AddMark("b4q01DankoGotoLara", "pt_map_lara", 1, 518591, f_311d_a0_f());
	f_3931_a0_v();
	f_393e_a0_v();
	f_3111_a2_b("quest_b4_01", "rubin_unlock");
}

void f_318e_a2_v(object a0, object a1)
{
	@SetVariable("oob4Danko1", 1);
}

void f_3194_a2_v(object a0, object a1)
{
	@SetVariable("oob4Danko2", 1);
}

void f_319a_a2_v(object a0, object a1)
{
	@SetVariable("oob4Danko3", 1);
}

void f_31a0_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b5q01", 1);
	L0 = f_39e9_a0_o();
	L0->AddMark("b5q01DankoGotoAndrei", "pt_map_andrei", 1, 519742, f_311d_a0_f());
	L0->AddMark("b5q01DankoGotoOspina", "pt_map_ospina", 1, 519741, f_311d_a0_f());
	f_3958_a0_v();
	f_3972_a0_v();
	f_3111_a2_b("quest_b5_01", "vera_kabak");
}

void f_31c8_a2_v(object a0, object a1)
{
	@SetVariable("oob5Danko1", 1);
}

void f_31ce_a2_v(object a0, object a1)
{
	f_3965_a0_v();
	f_3111_a2_b("quest_b5_01", "completed");
}

void f_31d8_a2_v(object a0, object a1)
{
	@SetVariable("oob5Danko2", 1);
}

void f_31de_a2_v(object a0, object a1)
{
	@SetVariable("oob3Danko1", 1);
}

void f_31e4_a2_v(object a0, object a1)
{
	@SetVariable("oob3Danko2", 1);
}

void f_31ea_a2_v(object a0, object a1)
{
	@SetVariable("b1q01", 1000);
	f_38e3_a0_v();
}

void f_31f3_a2_v(object a0, object a1)
{
	f_38f0_a0_v();
	f_3111_a2_b("quest_b2_01", "completed");
}

void f_31fd_a2_v(object a0, object a1)
{
	@SetVariable("oob6Danko1", 1);
}

void f_3203_a2_v(object a0, object a1)
{
	@SetVariable("b6q01", 1);
	f_397f_a0_v();
	f_3999_a0_v();
	f_3111_a2_b("quest_b6_01", "place_klara");
}

void f_3214_a2_v(object a0, object a1)
{
	@SetVariable("oob2Danko1", 1);
}

void f_321a_a2_v(object a0, object a1)
{
	@SetVariable("oob2Danko2", 1);
}

void f_3220_a2_v(object a0, object a1)
{
	@SetVariable("oob2Danko3", 1);
}

void f_3226_a2_v(object a0, object a1)
{
	@SetVariable("b2DankoTalk", 1);
}

void f_322c_a2_v(object a0, object a1)
{
	@SetVariable("oob2Danko4", 1);
}

void f_3232_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_39e9_a0_o();
	L0->AddMark("b2DankoGotoMladVlad", "pt_map_mladvlad", 3, 520955, f_311d_a0_f());
}

void f_3242_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b7q01", 1);
	L0 = f_39e9_a0_o();
	L0->AddMark("b7q01DankoGotoSobor", "pt_map_aglaja", 1, 521021, f_311d_a0_f());
	f_39a6_a0_v();
	f_39b3_a0_v();
	f_3111_a2_b("quest_b7_01", "init_sobor");
}

void f_3261_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_aglaja", 2);
	a1->ShowMap(f_39e9_a0_o());
}
...
void f_328f_a2_v(object a0, object a1)
{
	f_387b_a0_v();
	f_3111_a2_b("quest_b10_01", "completed");
}
...
void f_329f_a2_v(object a0, object a1)
{
	@SetVariable("b10q01", 4);
	f_386e_a0_v();
}

void f_32a8_a2_v(object a0, object a1)
{
	@SetVariable("b10q01DankoTalk", 1);
}

void f_32ae_a2_v(object a0, object a1)
{
	@SetVariable("b11q01KnowWhoKilled", 1);
	f_3895_a0_v();
}

void f_32b7_a2_v(object a0, object a1)
{
	@SetVariable("oob11Danko1", 1);
}

void f_32bd_a2_v(object a0, object a1)
{
	@SetVariable("oob12Danko1", 1);
}

void f_32c3_a2_v(object a0, object a1)
{
	@SetVariable("b12q01DankoInSobor", 1);
	f_38c9_a0_v();
}

void f_32cc_a2_v(object a0, object a1)
{
	@SetVariable("b12q01DankoVisit", 1);
}

void f_32d2_a2_v(object a0, object a1)
{
	@SetVariable("oob12Danko2", 1);
}

void f_32d8_a2_v(object a0, object a1)
{
	@SetVariable("oob12Danko3", 1);
}

void f_32de_a2_v(object a0, object a1)
{
	@SetVariable("oob11Danko2", 1);
}

void f_32e4_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "b5q01_heart_vera", 1);
}

void f_32ea_a2_v(object a0, object a1)
{
	int L0;
...
void f_32f6_a2_v(object a0, object a1)
{
	...
	f_30bf_a3_v(a0, "beta_pills", 5);
}

void f_3301_a2_v(object a0, object a1)
{
	f_398c_a0_v();
	f_3111_a2_b("quest_b6_01", "completed");
}

void f_330b_a2_v(object a0, object a1)
{
	@SetVariable("oob6Danko2", 1);
}

void f_3311_a2_v(object a0, object a1)
{
	f_3111_a2_b("quest_b5_01", "cutscene");
}

void f_3318_a2_v(object a0, object a1)
{
	f_38bc_a0_v();
	f_3111_a2_b("quest_b11_04", "completed");
}

void f_3322_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_3328_a2_v(object a0, object a1)
{
	@SetVariable("b2q01", 4);
	f_38fd_a0_v();
}

void f_3331_a2_v(object a0, object a1)
{
	f_3111_a2_b("quest_b2_01", "cutscene");
}

void f_3338_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "b6q01_bull_blood", 1);
	f_3111_a2_b("quest_b6_01", "cutscene");
}

void f_3343_a2_v(object a0, object a1)
{
	@SetVariable("b11q02", 2);
	f_38af_a0_v();
}

void f_334c_a2_v(object a0, object a1)
{
	f_38a2_a0_v();
	f_3111_a2_b("quest_b11_02", "fail");
}

void f_3356_a2_v(object a0, object a1)
{
	@SetVariable("oob3Danko3", 1);
}

void f_335c_a2_v(object a0, object a1)
{
	@SetVariable("b3q04", 1);
	f_3917_a0_v();
	f_3924_a0_v();
	f_3078_a1_o("quest_b3_04");
}

void f_336c_a2_v(object a0, object a1)
{
	@SetVariable("b3q04", 1000);
	f_394b_a0_v();
}

void f_3375_a2_v(object a0, object a1)
{
	if (f_30cc_a2_b(a0, "diseased_blood")) {
		f_30d3_a2_b(a0, "diseased_blood");
	} else {
		if (f_30cc_a2_b(a0, "diseased_heart")) {
			f_30d3_a2_b(a0, "diseased_heart");
		} else {
			if (f_30cc_a2_b(a0, "diseased_liver")) {
				f_30d3_a2_b(a0, "diseased_liver");
			} else {
				if (f_30cc_a2_b(a0, "diseased_kidney")) {
					f_30d3_a2_b(a0, "diseased_kidney");
				} else {
					if (f_30cc_a2_b(a0, "b3q01_blood")) {
						f_30d3_a2_b(a0, "b3q01_blood");
					}
				}
			}
		}
...
void f_33b2_a2_v(object a0, object a1)
{
	@Trace("packet is given");
	f_30bf_a3_v(a0, "packet", 2);
}

void f_33bd_a2_v(object a0, object a1)
{
	@SetVariable("b3q04", 1000);
}
...
void f_33c9_a2_v(object a0, object a1)
{
	if (f_3073_a1_i("b12q01_Danko") == 0) {
		@SetVariable("b12q01_Danko", 1);
		f_38d6_a0_v();
	}
}

void f_33d9_a2_v(object a0, object a1)
{
	@SetVariable("oob8Danko3", 1);
}

void f_33df_a2_v(object a0, object a1)
{
	@SetVariable("b8DankoVisit", 1);
}

void f_33e5_a2_v(object a0, object a1)
{
	if (f_3073_a1_i("map_chertez_state") <= 5) {
		@SetVariable("map_chertez_state", 5);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_33f6_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_aglaja", -1);
	a1->ShowMap(f_39e9_a0_o());
}

void f_3406_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_340c_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_ospina", 2);
	a1->ShowMap(f_39e9_a0_o());
}

void f_341c_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_mladvlad", 2);
	a1->ShowMap(f_39e9_a0_o());
}

void f_342c_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_lara", 2);
	a1->ShowMap(f_39e9_a0_o());
}

void f_343c_a2_v(object a0, object a1)
{
	f_30e4_a2_b(a0, 0.30000001192092896);
}

void f_3443_a2_v(object a0, object a1)
{
	@Trace("feromicin is given");
	f_30bf_a3_v(a0, "feromicin", 1);
}

void f_344e_a2_v(object a0, object a1)
{
	f_39fa_a3_v(f_39e9_a0_o(), "pt_map_andrei", 2);
	a1->ShowMap(f_39e9_a0_o());
}

void f_345e_a2_v(object a0, object a1)
{
	@Trace("morfin is given");
	f_30bf_a3_v(a0, "morfin", 1);
}

void f_3469_a2_v(object a0, object a1)
{
	@Trace("etorfin is given");
	f_30bf_a3_v(a0, "etorfin", 1);
}

void f_3474_a2_v(object a0, object a1)
{
	@Trace("novocaine is given");
	f_30bf_a3_v(a0, "novocaine", 1);
}

void f_347f_a2_v(object a0, object a1)
{
	@Trace("delta_pills is given");
	f_30bf_a3_v(a0, "delta_pills", 1);
}

void f_348a_a2_v(object a0, object a1)
{
	@Trace("neomicin is given");
	f_30bf_a3_v(a0, "neomicin", 1);
}

void f_3495_a2_v(object a0, object a1)
{
	@Trace("monomicin is given");
	f_30bf_a3_v(a0, "monomicin", 1);
}

void f_34a0_a2_v(object a0, object a1)
{
	f_3083_a2_v("sobor@door1", false);
}

void f_34a7_a2_v(object a0, object a1)
{
	@SetVariable("b3q02", 3);
	f_390a_a0_v();
}

bool f_34b0_a1_b(object a0)
{
	if (f_3073_a1_i("b8q01") == 0) {
		return true;
	}
	return false;
}

bool f_34bc_a1_b(object a0)
{
	if (f_3073_a1_i("oob8Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_34c8_a1_b(object a0)
{
	if (f_3073_a1_i("b8q01") != 0 && f_3073_a1_i("b8q01") != 1000 && f_3073_a1_i("b8q01") != -1) {
		return true;
	}
	return false;
}

bool f_34ea_a1_b(object a0)
{
	if (f_3073_a1_i("oob8DankoStop") != 0) {
		return true;
	}
	return false;
}

bool f_34f6_a1_b(object a0)
{
	if (f_3073_a1_i("oob8Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_3502_a1_b(object a0)
{
	if (f_3073_a1_i("b8q01KnowSgustki") != 0) {
		return true;
	}
	return false;
}

bool f_350e_a1_b(object a0)
{
	if (f_3073_a1_i("b10q01") == 0) {
		return true;
	}
	return false;
}

bool f_351a_a1_b(object a0)
{
	if (f_3073_a1_i("oob10Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_3526_a1_b(object a0)
{
	if (f_3073_a1_i("b10q01") == 3) {
		return true;
	}
	return false;
}

bool f_3532_a1_b(object a0)
{
	if (f_3073_a1_i("b10q01") == 4) {
		return true;
	}
	return false;
}

bool f_353e_a1_b(object a0)
{
	if (f_3073_a1_i("b10q01TalkKaterina") == 1) {
		return true;
	}
	return false;
}

bool f_354a_a1_b(object a0)
{
	if (f_3073_a1_i("b10q01TalkKapella") == 1) {
		return true;
	}
	return false;
}

bool f_3556_a1_b(object a0)
{
	if (f_3073_a1_i("b11q01") == 1000) {
		return true;
	}
	return false;
}

bool f_3562_a1_b(object a0)
{
	if (f_3073_a1_i("oob11Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_356e_a1_b(object a0)
{
	if (f_3073_a1_i("oob12Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_357a_a1_b(object a0)
{
	if (f_3073_a1_i("b12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}

bool f_3586_a1_b(object a0)
{
	if (f_3073_a1_i("oob12Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_3592_a1_b(object a0)
{
	if (f_3073_a1_i("game_final") != 0) {
		return true;
	}
	return false;
}

bool f_359e_a1_b(object a0)
{
	if (f_3073_a1_i("b12q01MariaFinalTalk") != 0) {
		return true;
	}
	return false;
}

bool f_35aa_a1_b(object a0)
{
	if (f_3073_a1_i("oob12Danko3") == 0) {
		return true;
	}
	return false;
}

bool f_35b6_a1_b(object a0)
{
	if (f_3858_a1_b(a0)) {
		return true;
	}
...
bool f_35c0_a1_b(object a0)
{
	if (f_3073_a1_i("oob11Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_35cc_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "b6q01_bull_blood")) {
		return true;
	}
	return false;
}

bool f_35d7_a1_b(object a0)
{
	if (f_3073_a1_i("oob6Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_35e3_a1_b(object a0)
{
	if (f_3073_a1_i("b6q01") == 1000) {
		return true;
	}
	return false;
}

bool f_35ef_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01MicroscopeCS") != 0) {
		return true;
	}
	return false;
}

bool f_35fb_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01") == 1000) {
		return true;
	}
	return false;
}

bool f_3607_a1_b(object a0)
{
	if (f_3073_a1_i("b11q04") == 3) {
		return true;
	}
	return false;
}

bool f_3613_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01") < 3) {
		return true;
	}
	return false;
}

bool f_361f_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01") == 3) {
		return true;
	}
...
bool f_362b_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01") == 4) {
		return true;
	}
	return false;
}

bool f_3637_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01MicroscopeCS") != 0) {
		return true;
	}
	return false;
}

bool f_3643_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "organ_combination")) {
		return true;
	}
	return false;
}

bool f_364e_a1_b(object a0)
{
	if (f_3073_a1_i("b6q01MicroscopeCS") != 0) {
		return true;
	}
	return false;
}

bool f_365a_a1_b(object a0)
{
	if (f_3073_a1_i("b11q02") == 1) {
		return true;
	}
	return false;
}

bool f_3666_a1_b(object a0)
{
	if (f_3073_a1_i("oob3Danko3") == 0) {
		return true;
	}
	return false;
}

bool f_3672_a1_b(object a0)
{
	if (f_3073_a1_i("b12q01DankoInSobor") != 0) {
		return true;
	}
	return false;
}

bool f_367e_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "diseased_blood") || f_30cc_a2_b(a0, "diseased_heart") || f_30cc_a2_b(a0, "diseased_kidney") || f_30cc_a2_b(a0, "diseased_liver") || f_30cc_a2_b(a0, "d3q01_blood")) {
		return true;
	}
	return false;
}

bool f_36b1_a1_b(object a0)
{
	if (f_3073_a1_i("b3q04") == 0) {
		return true;
	}
	return false;
}

bool f_36bd_a1_b(object a0)
{
	if (f_3073_a1_i("b3q04") == 1) {
		return true;
	}
	return false;
}

bool f_36c9_a1_b(object a0)
{
	if (f_3073_a1_i("b8DankoLetter2") != 0) {
		return true;
	}
	return false;
}

bool f_36d5_a1_b(object a0)
{
	if (f_3073_a1_i("oob8Danko3") == 0) {
		return true;
	}
	return false;
}
...
bool f_36eb_a1_b(object a0)
{
	if (f_3073_a1_i("b3q02") == 2) {
		return true;
	}
	return false;
}

bool f_36f7_a1_b(object a0)
{
	if (f_3073_a1_i("b4q01") == 0) {
		return true;
	}
	return false;
}

bool f_3703_a1_b(object a0)
{
	if (f_3073_a1_i("oob4Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_370f_a1_b(object a0)
{
	if (f_3073_a1_i("microscope_b4q01_sample") != 0) {
		return true;
	}
	return false;
}

bool f_371b_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "b4q01_sample")) {
		return true;
	}
	return false;
}

bool f_3726_a1_b(object a0)
{
	if (f_3073_a1_i("oob4Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_3732_a1_b(object a0)
{
	if (f_3073_a1_i("oob4Danko3") == 0) {
		return true;
	}
	return false;
}

bool f_373e_a1_b(object a0)
{
	if (f_3073_a1_i("oob5Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_374a_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01") == 0) {
		return true;
	}
	return false;
}

bool f_3756_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01TalkToVera") == 1) {
		return true;
	}
	return false;
}

bool f_3762_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01VeraDead") != 0) {
		return true;
	}
	return false;
}

bool f_376e_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "b5q01_heart_vera")) {
		return true;
	}
	return false;
}

bool f_3779_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "b5q01_heart_nude")) {
		return true;
	}
	return false;
}

bool f_3784_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "b5q01_heart_butcher")) {
		return true;
	}
	return false;
}

bool f_378f_a1_b(object a0)
{
	if (f_3073_a1_i("b5q01") == 1) {
		return true;
	}
	return false;
}

bool f_379b_a1_b(object a0)
{
	if (f_3073_a1_i("oob5Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_37a7_a1_b(object a0)
{
	if (f_3073_a1_i("oob3Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_37b3_a1_b(object a0)
{
	if (f_3073_a1_i("oob3Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_37bf_a1_b(object a0)
{
	if (f_3073_a1_i("b1q01") == 0) {
		return true;
	}
	return false;
}

bool f_37cb_a1_b(object a0)
{
	if (f_3073_a1_i("b1q01") == 1000) {
		return true;
	}
	return false;
}

bool f_37d7_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01") == 0) {
		return true;
	}
	return false;
}

bool f_37e3_a1_b(object a0)
{
	if (f_3073_a1_i("b2MladVladBurahHomeTalk") == 1) {
		return true;
	}
	return false;
}

bool f_37ef_a1_b(object a0)
{
	if (f_3073_a1_i("oob6Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_37fb_a1_b(object a0)
{
	if (f_3073_a1_i("b2q01") == 1000) {
		return true;
	}
	return false;
}

bool f_3807_a1_b(object a0)
{
	if (f_3073_a1_i("oob2Danko1") == 0) {
		return true;
	}
	return false;
}

bool f_3813_a1_b(object a0)
{
	if (f_3073_a1_i("oob2Danko2") == 0) {
		return true;
	}
	return false;
}

bool f_381f_a1_b(object a0)
{
	if (f_30cc_a2_b(a0, "grass_combination") || f_30cc_a2_b(a0, "organ_combination")) {
		return true;
	}
	return false;
}

bool f_3834_a1_b(object a0)
{
	if (f_3073_a1_i("oob2Danko3") == 0) {
		return true;
	}
	return false;
}

bool f_3840_a1_b(object a0)
{
	if (f_3073_a1_i("oob2Danko4") == 0) {
		return true;
	}
	return false;
}

bool f_384c_a1_b(object a0)
{
	if (f_3073_a1_i("b7q01") == 0) {
		return true;
	}
	return false;
}

bool f_3858_a1_b(object a0)
{
	return f_3a64_a0_b();
}
...
bool f_39cd_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_39fa_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
void f_3a2c_a3_v(object a0, bool a1, int a2)
{
	a0->add(6);
	a0->add(26);
	a0->add(2);
...
bool f_3a64_a0_b(void)
{
	object L0;
	int L1;
	int L2;
	@CreateIntVector(L0);
	f_3a2c_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2 = L2 + 1) {
		int L3;
		L0->get(L3, L2);
		if (f_3a5a_a1_b(L3) || f_3a50_a1_b(L3)) {
			return false;
		}
	}
	return true;
