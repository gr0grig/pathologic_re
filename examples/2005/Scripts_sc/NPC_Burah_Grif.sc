...
task t2
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_14fc_a1_b(f_1600_a0_o());
		if (!f_14a7_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_16d4_a0_i());
		L0->SetNPCDescription(f_16d2_a0_i());
		L0->SetPhoto(f_16d6_a0_s());
		L0->SetPhoto2(f_16d8_a0_s());
		L0->SetPlayerName(f_1ab6_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_18b8_a1_b(tv1) && !f_18a0_a1_b(tv1) && !f_18ac_a1_b(tv1)) {
				tv0->AddReply(517957, 19090, 19089);
			}
			if (f_18c4_a1_b(tv1) && f_18ac_a1_b(tv1) && !f_18a0_a1_b(tv1)) {
				tv0->AddReply(517960, 28332, 19092);
			}
			if (f_18c4_a1_b(tv1) && f_18a0_a1_b(tv1)) {
				tv0->AddReply(517982, 19116, 19115);
			}
			if (f_1894_a1_b(tv1) && f_18dc_a1_b(tv1)) {
				tv0->AddReply(517973, 28323, 19106);
			}
			if (f_193c_a1_b(tv1) && !f_1948_a1_b(tv1) && f_187c_a1_b(tv1)) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 28322) {
				...
				tv0->ClearReplies();
				if (!f_18a0_a1_b(tv1) && !f_18ac_a1_b(tv1)) {
					tv0->AddReply(517947, 19081, 19078);
				}
				if (!f_18b8_a1_b(tv1) && !f_18ac_a1_b(tv1) && !f_18a0_a1_b(tv1)) {
					tv0->AddReply(517946, 19079, 19077);
				}
				if (f_18a0_a1_b(tv1)) {
					tv0->AddReply(518086, 19219, 19218);
				}
				if (f_18ac_a1_b(tv1) && !f_18a0_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_18e8_a1_b(tv1) && f_190c_a1_b(tv1) && !f_1900_a1_b(tv1) && f_1930_a1_b(tv1)) {
				tv0->AddReply(518387, 20347, 19500);
			}
			if (f_18f4_a1_b(tv1) && f_1918_a1_b(tv1) && !f_1900_a1_b(tv1)) {
				tv0->AddReply(518391, 20339, 19504);
			}
			if (f_1900_a1_b(tv1) && f_1924_a1_b(tv1)) {
...
task t19
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_184c_a1_b(tv1) && f_1858_a1_b(tv1)) {
				tv0->AddReply(521395, 25305, 22573);
			}
			if (f_1870_a1_b(tv1) && f_1864_a1_b(tv1)) {
...
maintask t28
{
	...
	bool f_1377_a0_b(void)
	{
		...
		return f_1499_a1_b(L0);
	}

	void f_1386_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_138b_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_13aa_a0_v();
			if (f_14a2_a0_b() && f_138b_a0_b()) {
				if (f_1377_a0_b()) {
					f_1536_a1_b(f_1600_a0_o());
				}
			} else {
				f_1386_a0_v();
				f_13a1_a0_v();
...
void f_1419_a0_v(void)
{
	...
	L0 = f_16c1_a0_i();
	for (L1 = 0; L1 < 5 && f_14a2_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_16ba_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_145e_a0_b(void)
{
	return true;
}

void f_1460_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1465_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_146d_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_1479_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_146d_a2_b(a0, a1)) {
		return false;
	}
	a0->GetProperty(a1, L0);
	a0->SetProperty(a1, f_1610_a3_f(L0 + a2, a3, a4));
	return true;
}

bool f_148f_a1_b(Vector a0)
{
	Vector L0;
	Vector L1;
	bool L2;
...
bool f_1499_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_148f_a1_b(L0);
}

bool f_14a2_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_14a7_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1606_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	return f_158e_a2_b(a0, 70);
}

bool f_158e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_15c8_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_15e4_a3_v(string a0, int a1, int a2)
{
	if (f_161b_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
	}
}

void f_15ef_a5_v(string a0, int a1, int a2, int a3, int a4)
{
	if (f_161b_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
float f_1610_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_161b_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
void f_1630_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_1641_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_164d_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_1660_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_164d_a3_v(a0, L0, a2);
}

bool f_166d_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_1690_a1_v(a1);
	f_1479_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_1690_a1_v(float a0)
{
	object L0;
...
bool f_169a_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_16b4_a1_b(int a0)
{
	return f_16ab_a0_i() == a0;
}

string f_16ba_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_16c1_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_16ba_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_16d6_a0_s(void)
{
	return "ui/NPC_Grif.png";
}

string f_16d8_a0_s(void)
{
	return "ui/NPC_Grif_b.png";
}

bool f_16da_a0_b(void)
{
	return true;
}
...
void f_16e2_a2_v(object a0, object a1)
{
	@SetVariable("oob3Grif2", 1);
}

void f_16e8_a2_v(object a0, object a1)
{
	@SetVariable("oob3Grif3", 1);
}

void f_16ee_a2_v(object a0, object a1)
{
	f_19f4_a3_v(f_19e3_a0_o(), "pt_map_notkin", 2);
	a1->ShowMap(f_19e3_a0_o());
}

void f_16fe_a2_v(object a0, object a1)
{
	@SetVariable("oob1Grif3", 1);
}

void f_1704_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b1q01GrifToldAboutDanko", 1);
	L0 = f_19e3_a0_o();
	L0->AddMark("b1q01GrifGotoDanko", "pt_map_eva", 1, 520048, f_16a6_a0_f());
}

void f_1718_a2_v(object a0, object a1)
{
	f_19f4_a3_v(f_19e3_a0_o(), "pt_map_eva", 2);
	a1->ShowMap(f_19e3_a0_o());
}

void f_1728_a2_v(object a0, object a1)
{
	@SetVariable("oob2Grif1", 1);
}

void f_172e_a2_v(object a0, object a1)
{
	@SetVariable("oob1Grif4", 1);
}

void f_1734_a2_v(object a0, object a1)
{
	f_1625_a1_o("quest_b1_04");
}

void f_173a_a2_v(object a0, object a1)
{
	@SetVariable("oob8Grif1", 1);
}

void f_1740_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_19e3_a0_o();
	L0->AddMark("b8q01GrifGotoKlara", "pt_map_mishka", 3, 521464, f_16a6_a0_f());
}

void f_1750_a2_v(object a0, object a1)
{
...
void f_175c_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_19e3_a0_o();
	L0->AddMark("b1GrifGotoNotkin", "pt_map_notkin", 3, 530364, f_16a6_a0_f());
}

void f_176c_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1772_a2_v(object a0, object a1)
{
	f_166d_a2_b(a0, -0.019999999552965164);
}
...
void f_1780_a2_v(object a0, object a1)
{
...
{
	f_166d_a2_b(a0, 0.10000000149011612);
}
...
void f_1792_a2_v(object a0, object a1)
{
	...
	L0 = f_19e3_a0_o();
	L0->AddMark("b1q03GrifGotoDoberman", "pt_b1q03_doberman", 0, 518099, f_16a6_a0_f());
	f_1993_a0_v();
	f_1986_a0_v();
	...
	f_1625_a1_o("quest_b1_03");
	f_169a_a2_b("quest_b1_03", "place_doberman");
}
...
void f_17d4_a2_v(object a0, object a1)
{
	@SetVariable("oob1Grif2", 1);
}

void f_17da_a2_v(object a0, object a1)
{
	f_19f4_a3_v(f_19e3_a0_o(), "pt_b1q03_doberman", 2);
	a1->ShowMap(f_19e3_a0_o());
}

void f_17ea_a2_v(object a0, object a1)
{
	@Trace("samopal ammo5 is given");
	f_1660_a3_v(a0, "samopal_ammo", 5);
}
...
void f_17f5_a2_v(object a0, object a1)
{
	...
	f_169a_a2_b("quest_b1_03", "cleanup");
...
void f_1807_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_19e3_a0_o();
	L0->AddMark("b1q02GrifGotoLaska", "pt_map_laska", 3, 518143, f_16a6_a0_f());
}
...
void f_1817_a2_v(object a0, object a1)
{
	...
	@SetVariable("b3q02", 2);
	L0 = f_19e3_a0_o();
	L0->AddMark("b3q02GrifGotoDanko", "pt_map_eva", 0, 519653, f_16a6_a0_f());
	f_19a0_a0_v();
}
...
void f_182e_a2_v(object a0, object a1)
{
	...
	@SetVariable("b3q02", 4);
	L0 = f_19e3_a0_o();
	L0->AddMark("b3q02GrifGotoNotkin", "pt_map_notkin", 0, 519662, f_16a6_a0_f());
	f_19ad_a0_v();
}

void f_1845_a2_v(object a0, object a1)
{
	f_1630_a2_v("warehouse_notkin@door1", false);
}

bool f_184c_a1_b(object a0)
{
	if (f_1620_a1_i("b8q01") == 2) {
		return true;
	}
	return false;
}

bool f_1858_a1_b(object a0)
{
	if (f_1620_a1_i("oob8Grif1") == 0) {
		return true;
	}
	return false;
}

bool f_1864_a1_b(object a0)
{
	if (f_1620_a1_i("b8q02") == 1) {
		return true;
	}
	return false;
}
...
bool f_187c_a1_b(object a0)
{
	if (f_1620_a1_i("b1q01NotkinGotoGrif") != 0) {
		return true;
	}
	return false;
}

bool f_1888_a1_b(object a0)
{
	if (f_1620_a1_i("oob1Grif5") == 0) {
		return true;
	}
	return false;
}

bool f_1894_a1_b(object a0)
{
	if (f_1620_a1_i("b1q02") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1620_a1_i("b1q03_dead") != 0) {
		return true;
	}
	return false;
}

bool f_18ac_a1_b(object a0)
{
	if (f_1620_a1_i("b1q03_retreat") != 0) {
		return true;
	}
	return false;
}

bool f_18b8_a1_b(object a0)
{
	if (f_1620_a1_i("b1q03_2") == 0) {
		return true;
	}
	return false;
}

bool f_18c4_a1_b(object a0)
{
	if (f_1620_a1_i("b1q03_2") == 1) {
		return true;
	}
	return false;
}

bool f_18d0_a1_b(object a0)
{
	if (f_1620_a1_i("oob1Grif1") == 0) {
		return true;
	}
	return false;
}

bool f_18dc_a1_b(object a0)
{
	if (f_1620_a1_i("oob1Grif2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1620_a1_i("b3q02") == 1) {
		return true;
	}
	return false;
}

bool f_18f4_a1_b(object a0)
{
	if (f_1620_a1_i("b3q02") == 3) {
		return true;
	}
	return false;
}

bool f_1900_a1_b(object a0)
{
	if (f_1620_a1_i("b3q02Dead") != 0) {
		return true;
	}
	return false;
}

bool f_190c_a1_b(object a0)
{
	if (f_1620_a1_i("oob3Grif1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1620_a1_i("oob3Grif2") == 0) {
		return true;
	}
	return false;
}

bool f_1924_a1_b(object a0)
{
	if (f_1620_a1_i("oob3Grif3") == 0) {
		return true;
	}
	return false;
}

bool f_1930_a1_b(object a0)
{
	if (f_1620_a1_i("b3q02GrabitelTalk") == 1) {
		return true;
	}
	return false;
}

bool f_193c_a1_b(object a0)
{
	if (f_1620_a1_i("oob1Grif3") == 0) {
		return true;
	}
	return false;
}

bool f_1948_a1_b(object a0)
{
	if (f_1620_a1_i("b1q01") == 1000) {
		return true;
	}
	return false;
}

bool f_1954_a1_b(object a0)
{
	if (f_1620_a1_i("oob2Grif1") == 0) {
		return true;
	}
	return false;
}

bool f_1960_a1_b(object a0)
{
	if (f_1620_a1_i("oob1Grif4") == 0) {
		return true;
	}
	return false;
}

void f_196c_a0_v(void)
{
	object L0;
...
bool f_19c7_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_19f4_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
void f_1a15_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_16ab_a0_i();
	@AddItem(L0, f_1ab1_a1_i("Rifle"), 0, 1);
	@AddItem(L0, f_1ab1_a1_i("Revolver"), 0, 1);
	@AddItem(L0, f_1ab1_a1_i("Knife"), 0, 1);
	if (L2 != 10) {
		@AddItem(L0, f_1ab1_a1_i("tvirin"), 0, 1);
	} else {
		@AddItem(L0, f_1ab1_a1_i("tvirin"), 0, 4);
	}
	@AddItem(L0, f_1ab1_a1_i("lockpick"), 0, 3);
	f_15e4_a3_v("Scalpel", 1, 2);
	f_15ef_a5_v("revolver_ammo", 1, 1, 5, 10);
	f_15ef_a5_v("rifle_ammo", 1, 1, 5, 20);
	@irand(L1, 100);
	if (L1 != 0) {
		@AddItem(L0, f_1ab1_a1_i("kerosene"), 0, L1);
	}
	if (L2 >= 3) {
		@AddItem(L0, f_1ab1_a1_i("halfboot_repel"), 0, 1);
		@AddItem(L0, f_1ab1_a1_i("boot_repel"), 0, 1);
	}
	if (L2 >= 9) {
		@AddItem(L0, f_1ab1_a1_i("boot_army"), 0, 1);
		@AddItem(L0, f_1ab1_a1_i("balahon"), 0, 1);
		@AddItem(L0, f_1ab1_a1_i("glove_army"), 0, 1);
	}
	if (f_1ac7_a0_i() == 0) {
		@AddItem(L0, f_1ab1_a1_i("Gun_danko"), 0, 1);
	}
}

int f_1ab1_a1_i(string a0)
{
	int L0;
