...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_945_a1_b(f_9f2_a0_o());
		if (!f_8f0_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_a35_a0_i());
		L0->SetNPCDescription(f_a33_a0_i());
		L0->SetPhoto(f_a37_a0_s());
		L0->SetPhoto2(f_a39_a0_s());
		L0->SetPlayerName(f_b07_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_a90_a1_b(tv1) && f_a9c_a1_b(tv1)) {
				f_a3d_a2_v(tv1, tv0);
				f_2ac_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (!f_a9c_a1_b(tv1) && f_aa8_a1_b(tv1)) {
				tv0->AddReply(520269, 21462, 21461);
			}
			if (!f_a9c_a1_b(tv1) && f_ab4_a1_b(tv1)) {
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_a78_a1_b(tv1) && !f_a84_a1_b(tv1)) {
...
maintask t13
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_815_a0_v();
			if (f_8eb_a0_b() && f_7f6_a0_b()) {
				if (f_7e2_a0_b()) {
					f_97f_a1_b(f_9f2_a0_o());
				}
			} else {
				f_7f1_a0_v();
				f_80c_a0_v();
...
void f_884_a0_v(void)
{
	...
	L0 = f_a22_a0_i();
	for (L1 = 0; L1 < 5 && f_8eb_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_a1b_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_8e2_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_8d8_a1_b(L0);
}

bool f_8eb_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_8f0_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_9d6_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
bool f_a15_a1_b(int a0)
{
	return f_a0c_a0_i() == a0;
}

string f_a1b_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_a22_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_a1b_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_a37_a0_s(void)
{
	return "ui/NPC_Katerina.png";
}

string f_a39_a0_s(void)
{
...
void f_a43_a2_v(object a0, object a1)
{
	@SetVariable("oob2Katerina2", 1);
}

void f_a49_a2_v(object a0, object a1)
{
	@SetVariable("oob2Katerina3", 1);
}

void f_a4f_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b8q03", 2);
	L0 = f_af6_a0_o();
	L0->AddMark("b8q03KaterinaGotoMat", "pt_map_mat", 0, 530664, f_a07_a0_f());
	f_ac0_a0_v();
}

void f_a66_a2_v(object a0, object a1)
{
...
{
	if (f_a02_a1_i("b10q01") == 4) {
		return true;
	}
	return false;
}

bool f_a84_a1_b(object a0)
{
	if (f_a02_a1_i("b10q01TalkKaterina") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_a02_a1_i("b2q01") == 0) {
		return true;
	}
	return false;
}

bool f_a9c_a1_b(object a0)
{
	if (f_a02_a1_i("oob2Katerina1") == 0) {
		return true;
	}
	return false;
}
...
bool f_ada_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
