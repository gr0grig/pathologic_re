...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_839_a1_b(f_8e6_a0_o());
		if (!f_7e4_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_966_a0_i());
		L0->SetNPCDescription(f_964_a0_i());
		L0->SetPhoto(f_968_a0_s());
		L0->SetPhoto2(f_96a_a0_s());
		L0->SetPlayerName(f_abe_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_a01_a1_b(tv1) && f_9dd_a1_b(tv1)) {
...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_a0c_a1_b(tv1) && f_a24_a1_b(tv1)) {
				tv0->AddReply(523178, 24382, 24381);
			}
			if (!f_a0c_a1_b(tv1) && !f_a18_a1_b(tv1) && f_a30_a1_b(tv1)) {
...
maintask t11
{
	...
	bool f_6cf_a0_b(void)
	{
		...
		return f_7d6_a1_b(L0);
	}

	void f_6de_a0_v(void)
	{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_702_a0_v();
			if (f_7df_a0_b() && f_6e3_a0_b()) {
				if (f_6cf_a0_b()) {
					f_873_a1_b(f_8e6_a0_o());
				}
			} else {
				f_6de_a0_v();
				f_6f9_a0_v();
...
void f_771_a0_v(void)
{
	...
	L0 = f_953_a0_i();
	for (L1 = 0; L1 < 5 && f_7df_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_94c_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_7c5_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_7d6_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_7cc_a1_b(L0);
}

bool f_7df_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_7e4_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_8ec_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_873_a1_b(object a0)
{
	...
	return f_8d0_a1_b(L4);
}

bool f_898_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_93d_a0_i() + "m";
	int L1;
...
void f_8ca_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_912_a2_v(object a0, int a1)
{
	f_7c5_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_925_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_92c_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_946_a1_b(int a0)
{
	return f_93d_a0_i() == a0;
}

string f_94c_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_953_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_94c_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_96a_a0_s(void)
{
	return "ui/NPC_Maria_b.png";
}

bool f_96c_a0_b(void)
{
	return true;
}

void f_96e_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b6q03", 1);
	L0 = f_a8c_a0_o();
	L0->AddMark("b6q03MariaGotoNina", "pt_map_nina", 0, 521342, f_938_a0_f());
	f_a3c_a0_v();
	f_a56_a0_v();
	f_8fb_a1_o("quest_b6_03");
	f_92c_a2_b("quest_b6_03", "init_grave");
}

void f_991_a2_v(object a0, object a1)
{
	@SetVariable("oob6Maria1", 1);
}

void f_997_a2_v(object a0, object a1)
{
...
void f_99d_a2_v(object a0, object a1)
{
	int L0;
	f_a49_a0_v();
	f_92c_a2_b("quest_b6_03", "completed");
	a0->RemoveItemByType(L0, "b6q03_diary", 1);
}

void f_9ab_a2_v(object a0, object a1)
{
	f_a9d_a3_v(f_a8c_a0_o(), "pt_map_nina", 2);
	a1->ShowMap(f_a8c_a0_o());
}
...
void f_9c7_a2_v(object a0, object a1)
{
	@SetVariable("b12q01MariaFinalTalk", 1);
}

void f_9cd_a2_v(object a0, object a1)
{
...
{
	if (f_8f6_a1_i("game_final") == 0) {
		return true;
	}
	return false;
}

bool f_a24_a1_b(object a0)
{
	if (f_8f6_a1_i("oob12Maria1") == 0) {
		return true;
	}
	return false;
}

bool f_a30_a1_b(object a0)
{
	if (f_8f6_a1_i("oob12Maria2") == 0) {
		return true;
	}
	return false;
}
...
bool f_a70_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_a9d_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
