	...
	void init(int a0)
	{
		...
		if (L1) {
			...
			if (L5) {
				int L6;
				@irand(L6, L5);
				@PlayAnimation("all", f_1414_a1_s(L6));
				@WaitForAnimEnd();
			}
		}
	}
...
task t4
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_129b_a1_b(f_1348_a0_o());
		if (!f_1246_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_143c_a0_i());
		L0->SetNPCDescription(f_143a_a0_i());
		L0->SetPhoto(f_143e_a0_s());
		L0->SetPhoto2(f_1440_a0_s());
		L0->SetPlayerName(f_16e7_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1601_a1_b(tv1) && f_15f5_a1_b(tv1)) {
...
task t17
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (!f_1596_a1_b(tv1) && f_15a2_a1_b(tv1)) {
...
maintask t22
{
	...
	void f_1179_a0_v(void)
	{
		...
		for (tv2 = 0; ; tv2++) {
			bool L1;
			L0->GetLocator(f_142c_a1_s(tv2), L1);
			if (!L1) {
				break;
			}
		}
		...
		for (; ; ) {
			...
			Vector L6;
			@irand(L2, tv2);
			L0->GetLocator(f_142c_a1_s(L2), L3, L4, L5);
			L6 = L4 - f_1208_a0_V();
			if (f_1360_a1_f(L6) > tv1) {
				float L7;
				Vector L8;
				bool L9;
				@GetHeight(L7);
...
void f_121c_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_122d_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1223_a1_b(L0);
}

void f_1236_a1_v(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_1246_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_134e_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_12d5_a1_b(object a0)
{
	...
	return f_1332_a1_b(L4);
}

bool f_12fa_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1405_a0_i() + "m";
	int L1;
...
void f_132c_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_1358_a1_f(float a0)
{
	return a0 < 0 ? -a0 : a0;
}

float f_1360_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

int f_136a_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_1385_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_1396_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_13a2_a2_v(object a0, int a1)
{
	f_121c_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_13b5_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_13c8_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_13b5_a3_v(a0, L0, a2);
}

bool f_13d5_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_13dc_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_13e8_a3_v(object a0, string a1, string a2)
{
	object L0;
	bool L1;
	Vector L2;
...
bool f_140e_a1_b(int a0)
{
	return f_1405_a0_i() == a0;
}

string f_1414_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_141b_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1414_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_143c_a0_i(void)
{
	return 502872;
}

string f_143e_a0_s(void)
{
	return "ui/NPC_MladVlad.png";
}

string f_1440_a0_s(void)
{
	return "ui/NPC_MladVlad_b.png";
}

bool f_1442_a0_b(void)
{
	return true;
}

void f_1444_a2_v(object a0, object a1)
{
	f_16c6_a3_v(f_16b5_a0_o(), "pt_map_burah_home", 2);
	a1->ShowMap(f_16b5_a0_o());
}
...
void f_145a_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_16b5_a0_o();
	L0->AddMark("b1MladVladGotoGrif", "pt_map_grif", 3, 520047, f_1400_a0_f());
}
...
void f_1470_a2_v(object a0, object a1)
{
	...
	L0 = f_16b5_a0_o();
	L0->AddMark("b2BurahHome", "pt_map_burah_home", 3, 520460, f_1400_a0_f());
}

void f_1484_a2_v(object a0, object a1)
{
	f_1385_a2_v("burah_home@door1", false);
}
...
{
	if (f_136a_a1_i("b2TravnikMark") == 0) {
		object L0;
		@SetVariable("b2TravnikMark", 1);
		L0 = f_16b5_a0_o();
		L0->AddMark("b2Travnik1", "pt_map_gatherer1", 3, 520463, f_1400_a0_f());
		L0->AddMark("b2Travnik2", "pt_map_gatherer2", 3, 520464, f_1400_a0_f());
		L0->AddMark("b2Travnik3", "pt_map_gatherer3", 3, 520465, f_1400_a0_f());
	}
}

void f_14be_a2_v(object a0, object a1)
{
	@SetVariable("oob5MladVlad1", 1);
}

void f_14c4_a2_v(object a0, object a1)
{
	@SetVariable("b5q02", 1);
	f_163e_a0_v();
	f_1658_a0_v();
	f_136f_a1_o("quest_b5_02");
	f_13dc_a2_b("quest_b5_02", "place_prophet");
	f_13dc_a2_b("quest_b5_02", "maze_start");
}

void f_14de_a2_v(object a0, object a1)
{
	f_164b_a0_v();
	f_13dc_a2_b("quest_b5_02", "completed");
}

void f_14e8_a2_v(object a0, object a1)
{
...
void f_14f2_a2_v(object a0, object a1)
{
	...
	f_13c8_a3_v(a0, "kerosene", 50);
}

void f_14fd_a2_v(object a0, object a1)
{
	f_13e8_a3_v(f_1215_a0_o(), "house_vlad", "pt_maze_start");
}
...
void f_1508_a2_v(object a0, object a1)
{
	...
	f_1665_a0_v();
	f_167f_a0_v();
	f_137a_a1_o("quest_b8_02");
}

void f_1518_a2_v(object a0, object a1)
{
	int L0;
	f_1672_a0_v();
	f_13dc_a2_b("quest_b8_02", "completed");
	a0->RemoveItemByType(L0, "b8q02_book", 1);
}

void f_1526_a2_v(object a0, object a1)
{
	@SetVariable("oob8MladVlad1", 1);
}

void f_152c_a2_v(object a0, object a1)
{
	@SetVariable("b11q01KnowWhoKilled", 1);
	f_1631_a0_v();
}

void f_1535_a2_v(object a0, object a1)
{
	@SetVariable("oob11MladVlad1", 1);
}

void f_153b_a2_v(object a0, object a1)
{
	f_13dc_a2_b("quest_b2_01", "place_mladvlad");
}

void f_1542_a2_v(object a0, object a1)
{
	@Trace("money10000 is given");
	f_13a2_a2_v(a0, 10000);
}
...
void f_1552_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1558_a2_v(object a0, object a1)
{
	@SetVariable("b5MladVladVisit", 1);
}

void f_155e_a2_v(object a0, object a1)
{
	@Trace("money 7000 is given");
	f_13a2_a2_v(a0, 7000);
}

void f_1568_a2_v(object a0, object a1)
{
	@Trace("recipe2 is given");
	f_13c8_a3_v(a0, "recipe2", 1);
}

void f_1573_a2_v(object a0, object a1)
{
	@Trace("recipe3 is given");
	f_13c8_a3_v(a0, "recipe3", 1);
}

void f_157e_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1584_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "mapmark");
}

bool f_158a_a1_b(object a0)
{
	if (f_136a_a1_i("oob8MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_1596_a1_b(object a0)
{
	if (f_136a_a1_i("b8q02") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_13d5_a2_b(a0, "b8q02_book")) {
		return true;
	}
	return false;
}

bool f_15ad_a1_b(object a0)
{
	if (f_136a_a1_i("b11q01") == 1000) {
		return true;
	}
	return false;
}

bool f_15b9_a1_b(object a0)
{
	if (f_136a_a1_i("oob11MladVlad1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_136a_a1_i("oob1MladVlad1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_136a_a1_i("oob1MladVlad2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_136a_a1_i("b2MladVladBurahHomeTalk") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_136a_a1_i("oob2MladVlad1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_136a_a1_i("oob5MladVlad1") == 0) {
		return true;
	}
	return false;
}
...
bool f_1699_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_16c6_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
