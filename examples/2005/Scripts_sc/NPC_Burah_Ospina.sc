...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_11a0_a1_b(f_124d_a0_o());
		if (!f_114b_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_12d3_a0_i());
		L0->SetNPCDescription(f_12d1_a0_i());
		L0->SetPhoto(f_12d5_a0_s());
		L0->SetPhoto2(f_12d7_a0_s());
		L0->SetPlayerName(f_1519_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_141e_a1_b(tv1) && f_142a_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_13e9_a1_b(tv1) && f_13f5_a1_b(tv1) || f_13dd_a1_b(tv1) && f_13f5_a1_b(tv1)) {
...
maintask t19
{
	...
	bool f_103d_a0_b(void)
	{
		...
		return f_113d_a1_b(L0);
	}

	void f_104c_a0_v(void)
	{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_1070_a0_v();
			if (f_1146_a0_b() && f_1051_a0_b()) {
				if (f_103d_a0_b()) {
					f_11da_a1_b(f_124d_a0_o());
				}
			} else {
				f_104c_a0_v();
				f_1067_a0_v();
...
void f_10df_a0_v(void)
{
	...
	L0 = f_12c0_a0_i();
	for (L1 = 0; L1 < 5 && f_1146_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_12b9_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_1124_a0_b(void)
{
	return true;
}

void f_1126_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_112b_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_113d_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1133_a1_b(L0);
}

bool f_1146_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_114b_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1253_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_1231_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_126d_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1279_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_128c_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1279_a3_v(a0, L0, a2);
}

bool f_1299_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_12b3_a1_b(int a0)
{
	return f_12aa_a0_i() == a0;
}

string f_12b9_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_12c0_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_12b9_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_12d1_a0_i(void)
{
	return 515549;
}

int f_12d3_a0_i(void)
{
	return 502874;
}

string f_12d5_a0_s(void)
{
	return "ui/NPC_Ospina.png";
}

string f_12d7_a0_s(void)
{
	return "ui/NPC_Ospina_b.png";
}

bool f_12d9_a0_b(void)
{
	return true;
}

void f_12db_a2_v(object a0, object a1)
{
...
{
	if (f_125d_a1_i("b5q01PlaceButchers") == 0) {
		object L0;
		@SetVariable("b5q01PlaceButchers", 1);
		L0 = f_14e7_a0_o();
		L0->AddMark("b5q01GathererWife", "pt_gatherer3", 1, 530181, f_12a5_a0_f());
		f_1299_a2_b("quest_b5_01", "place_butchers");
	}
}

void f_1301_a2_v(object a0, object a1)
{
...
void f_1307_a2_v(object a0, object a1)
{
	...
	@SetVariable("b3q01", 2);
	L0 = f_14e7_a0_o();
	L0->AddMark("b3q01OspinaGotoButcher", "pt_gmap_house5_07", 1, 519635, f_12a5_a0_f());
	f_1497_a0_v();
	f_1299_a2_b("quest_b3_01", "place_butcher");
}

void f_1323_a2_v(object a0, object a1)
{
	f_14f8_a3_v(f_14e7_a0_o(), "pt_gmap_house5_07", 2);
	a1->ShowMap(f_14e7_a0_o());
}

void f_1333_a2_v(object a0, object a1)
{
...
void f_133f_a2_v(object a0, object a1)
{
...
void f_134b_a2_v(object a0, object a1)
{
	if (f_125d_a1_i("b2TravnikMark") == 0) {
		object L0;
		@SetVariable("b2TravnikMark", 1);
		L0 = f_14e7_a0_o();
		L0->AddMark("b2Travnik1", "pt_map_gatherer1", 3, 520463, f_12a5_a0_f());
		L0->AddMark("b2Travnik2", "pt_map_gatherer2", 3, 520464, f_12a5_a0_f());
		L0->AddMark("b2Travnik3", "pt_map_gatherer3", 3, 520465, f_12a5_a0_f());
	}
}
...
void f_1387_a2_v(object a0, object a1)
{
...
{
	f_14f8_a3_v(f_14e7_a0_o(), "pt_gatherer3", 2);
	a1->ShowMap(f_14e7_a0_o());
}
...
{
	@SetVariable("b2q01", 3);
	f_1299_a2_b("quest_b2_01", "place_box");
	f_1262_a1_o("quest_b2_02");
}

void f_13c0_a2_v(object a0, object a1)
{
...
void f_13c6_a2_v(object a0, object a1)
{
	...
	f_128c_a3_v(a0, "b8q01_bone", 1);
}

bool f_13d1_a1_b(object a0)
{
	if (f_125d_a1_i("b8q01") == 5) {
		return true;
	}
	return false;
}
...
{
	if (f_125d_a1_i("b11q01") == 1000) {
		return true;
	}
	return false;
}

bool f_1406_a1_b(object a0)
{
	if (f_125d_a1_i("oob11Ospina1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_125d_a1_i("oob8Ospina1") == 0) {
		return true;
	}
	return false;
}

bool f_141e_a1_b(object a0)
{
	if (f_125d_a1_i("b5q01") == 1) {
		return true;
	}
	return false;
}

bool f_142a_a1_b(object a0)
{
	if (f_125d_a1_i("oob5Ospina1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_125d_a1_i("oob3Ospina1") == 0) {
		return true;
	}
	return false;
}

bool f_1442_a1_b(object a0)
{
	if (f_125d_a1_i("b3q01") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_125d_a1_i("oob2Ospina1") == 0) {
		return true;
	}
	return false;
}

bool f_1466_a1_b(object a0)
{
	if (f_125d_a1_i("oob2Ospina2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_125d_a1_i("oob2Ospina3") == 0) {
		return true;
	}
	return false;
}

bool f_147e_a1_b(object a0)
{
	if (f_125d_a1_i("oob2Ospina4") == 0) {
		return true;
	}
	return false;
}
...
bool f_14cb_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_14f8_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
