...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_11f9_a1_b(f_12a6_a0_o());
		if (!f_11a4_a2_b(a0, 130.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1350_a0_i());
		L0->SetNPCDescription(f_134e_a0_i());
		L0->SetPhoto(f_1352_a0_s());
		L0->SetPhoto2(f_1354_a0_s());
		L0->SetPlayerName(f_1678_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1481_a1_b(tv1) && f_1540_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_14c9_a1_b(tv1) && f_14f8_a1_b(tv1)) {
				f_13b6_a2_v(tv1, tv0);
				f_a4f_a1_v("Neutral");
			...
			if (f_14d5_a1_b(tv1) && f_1534_a1_b(tv1)) {
...
maintask t19
{
	...
	bool f_1096_a0_b(void)
	{
		...
		return f_1196_a1_b(L0);
	}

	void f_10a5_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_10aa_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_10c9_a0_v();
			if (f_119f_a0_b() && f_10aa_a0_b()) {
				if (f_1096_a0_b()) {
					f_1233_a1_b(f_12a6_a0_o());
				}
			} else {
				f_10a5_a0_v();
				f_10c0_a0_v();
...
void f_1138_a0_v(void)
{
	...
	L0 = f_133d_a0_i();
	for (L1 = 0; L1 < 5 && f_119f_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1336_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_117d_a0_b(void)
{
	return true;
}

void f_117f_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1184_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_1196_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_118c_a1_b(L0);
}

bool f_119f_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_11a4_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_12ac_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_128a_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_12bb_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_12d0_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_12dc_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_12ef_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_12dc_a3_v(a0, L0, a2);
}
...
int f_133d_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1336_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_134e_a0_i(void)
{
	return 515553;
}

int f_1350_a0_i(void)
{
	return 502878;
}

string f_1352_a0_s(void)
{
	return "ui/NPC_Starshina.png";
}

string f_1354_a0_s(void)
{
	return "ui/NPC_Starshina_b.png";
}

bool f_1356_a0_b(void)
{
	return true;
}

void f_1358_a2_v(object a0, object a1)
{
	f_12bb_a2_v("icot_eva_door", true);
}

void f_135f_a2_v(object a0, object a1)
{
	@SetVariable("b7q01", 8);
	f_15be_a0_v();
}
...
void f_1389_a2_v(object a0, object a1)
{
	...
	f_1303_a2_b("quest_b9_01", "remove_danko");
}

void f_139d_a2_v(object a0, object a1)
{
	f_15f2_a0_v();
	f_1303_a2_b("quest_b9_01", "completed");
	@Trigger(a0, "b9q01_stop");
}

void f_13aa_a2_v(object a0, object a1)
{
	@SetVariable("oob9Starshina1", 1);
}

void f_13b0_a2_v(object a0, object a1)
{
	@SetVariable("oob9Starshina2", 1);
}

void f_13b6_a2_v(object a0, object a1)
{
...
void f_13bc_a2_v(object a0, object a1)
{
	...
	L0 = f_1646_a0_o();
	L0->AddMark("b10q01StarshinaGotoKurgan", "pt_map_kurgan", 1, 531553, f_130f_a0_f());
	f_158a_a0_v();
	f_1303_a2_b("quest_b10_01", "usable_stone");
...
void f_13e4_a2_v(object a0, object a1)
{
	@SetVariable("oob11Starshina1", 1);
}

void f_13ea_a2_v(object a0, object a1)
{
	@SetVariable("b11q01", 1);
	f_1597_a0_v();
	f_15a4_a0_v();
	f_1303_a2_b("quest_b11_01", "open_shaft");
}

void f_13fb_a2_v(object a0, object a1)
{
	f_15b1_a0_v();
	f_1303_a2_b("quest_b11_01", "starshina_fight");
}
...
void f_143f_a2_v(object a0, object a1)
{
	f_1657_a3_v(f_1646_a0_o(), "pt_map_kurgan", 2);
	a1->ShowMap(f_1646_a0_o());
}

void f_144f_a2_v(object a0, object a1)
{
	if (f_12b6_a1_i("map_chertez_state") <= 3) {
		@SetVariable("map_chertez_state", 3);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_1460_a2_v(object a0, object a1)
{
	if (f_12b6_a1_i("map_chertez_state") <= 6) {
...
{
	f_1657_a3_v(f_1646_a0_o(), "pt_map_aglaja", -1);
	a1->ShowMap(f_1646_a0_o());
}

bool f_1481_a1_b(object a0)
{
	if (f_12b6_a1_i("b8q01") == 6) {
		return true;
	}
	return false;
}

bool f_148d_a1_b(object a0)
{
	if (f_12b6_a1_i("b8q01") == 4) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("b9q01") == 0) {
		return true;
	}
	return false;
}

bool f_14a5_a1_b(object a0)
{
	if (f_12b6_a1_i("oob9Starshina1") == 0) {
		return true;
	}
	return false;
}

bool f_14b1_a1_b(object a0)
{
	if (f_12b6_a1_i("b9q01") == 3) {
		return true;
	}
	return false;
}

bool f_14bd_a1_b(object a0)
{
	if (f_12b6_a1_i("oob9Starshina2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("oob10Starshina1") == 0) {
		return true;
	}
	return false;
}

bool f_14d5_a1_b(object a0)
{
	if (f_12b6_a1_i("b10q01Butchers") == 3) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("b10q01Butchers") == 1 || f_12b6_a1_i("b10q01Butchers") == 2) {
		return true;
	}
	return false;
}

bool f_14f8_a1_b(object a0)
{
	if (f_12b6_a1_i("b10q01") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("oob11Starshina1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("b11q01KnowWhoKilled") == 1) {
		return true;
	}
	return false;
}

bool f_1528_a1_b(object a0)
{
	if (f_12b6_a1_i("b11q01") == 2) {
		return true;
	}
	return false;
}

bool f_1534_a1_b(object a0)
{
	if (f_12b6_a1_i("b10q01") == 2) {
		return true;
	}
	return false;
}

bool f_1540_a1_b(object a0)
{
	if (f_12fc_a2_b(a0, "b8q01_bone")) {
		return true;
	}
	return false;
}

bool f_154b_a1_b(object a0)
{
	if (f_12b6_a1_i("b10q03") == 1000) {
		return true;
	}
	return false;
}
...
{
	if (f_12b6_a1_i("b7q01") == 7) {
		return true;
	}
	return false;
}

void f_1563_a0_v(void)
{
	object L0;
...
bool f_1619_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1657_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
