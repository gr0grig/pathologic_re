...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_717_a1_b(f_7c4_a0_o());
		if (!f_6c2_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_80c_a0_i());
		L0->SetNPCDescription(f_80a_a0_i());
		L0->SetPhoto(f_80e_a0_s());
		L0->SetPhoto2(f_810_a0_s());
		L0->SetPlayerName(f_8c4_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_859_a1_b(tv1) && f_865_a1_b(tv1)) {
				f_830_a2_v(tv1, tv0);
				f_84d_a2_v(tv1, tv0);
				f_482_a1_v("Neutral");
...
bool f_6c2_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_7ca_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_7a8_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_7d9_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
bool f_7ea_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_804_a1_b(int a0)
{
	return f_7fb_a0_i() == a0;
}
...
string f_80e_a0_s(void)
{
	return "ui/NPC_Viktor.png";
}

string f_810_a0_s(void)
{
	return "ui/NPC_Viktor_b.png";
}

bool f_812_a0_b(void)
{
	return true;
}

void f_814_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b7q01", 6);
	L0 = f_8b3_a0_o();
	L0->AddMark("b7q01DankoGotoSobor", "pt_map_aglaja", 1, 521021, f_7f6_a0_f());
	f_87d_a0_v();
	f_7ea_a2_b("quest_b7_01", "place_aglaja");
}

void f_830_a2_v(object a0, object a1)
{
...
void f_836_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_8b3_a0_o();
	L0->AddMark("b6q03ViktorGotoMaria", "pt_map_maria", 3, 521341, f_7f6_a0_f());
}

void f_846_a2_v(object a0, object a1)
{
	f_7d9_a2_v("cot_maria@door1", false);
}

void f_84d_a2_v(object a0, object a1)
{
...
bool f_897_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
