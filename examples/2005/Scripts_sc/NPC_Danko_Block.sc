...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_c94_a1_b(f_d41_a0_o());
		if (!f_c3f_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_dbf_a0_i());
		L0->SetNPCDescription(f_dbd_a0_i());
		L0->SetPhoto(f_dc1_a0_s());
		L0->SetPhoto2(f_dc3_a0_s());
		L0->SetPlayerName(f_f40_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_e7a_a1_b(tv1) && !f_e40_a1_b(tv1)) {
				f_df6_a2_v(tv1, tv0);
				f_267_a1_v("Neutral");
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_e4a_a1_b(tv1) && f_e56_a1_b(tv1)) {
				tv0->AddReply(513883, 15111, 15110);
			}
			if (f_e86_a1_b(tv1) && f_e92_a1_b(tv1)) {
...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_eaa_a1_b(tv1) && f_eb6_a1_b(tv1)) {
				tv0->AddReply(514281, 15502, 15501);
			}
			if (f_ec2_a1_b(tv1) && f_ece_a1_b(tv1)) {
				tv0->AddReply(514306, 15529, 15528);
			}
			if (f_e9e_a1_b(tv1) && f_eda_a1_b(tv1)) {
...
maintask t11
{
	...
	bool f_b31_a0_b(void)
	{
		...
		return f_c31_a1_b(L0);
	}

	void f_b40_a0_v(void)
	{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_b64_a0_v();
			if (f_c3a_a0_b() && f_b45_a0_b()) {
				if (f_b31_a0_b()) {
					f_cce_a1_b(f_d41_a0_o());
				}
			} else {
				f_b40_a0_v();
				f_b5b_a0_v();
...
void f_bd3_a0_v(void)
{
	...
	L0 = f_dac_a0_i();
	for (L1 = 0; L1 < 5 && f_c3a_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_da5_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_c1a_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_c1f_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_c31_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_c27_a1_b(L0);
}

bool f_c3a_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_c3f_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_d47_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_d25_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_d62_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_d75_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_d82_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_d9f_a1_b(int a0)
{
	return f_d8e_a0_i() == a0;
}

string f_da5_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_dac_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_da5_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_dcd_a2_v(object a0, object a1)
{
...
void f_dd3_a2_v(object a0, object a1)
{
	@SetVariable("d9q02", 2);
	f_f0a_a0_v();
	f_d82_a2_b("quest_d9_02", "init_soldiers");
}

void f_de1_a2_v(object a0, object a1)
{
...
{
	f_efd_a0_v();
	f_d82_a2_b("quest_d10_03", "place_sanitars");
	f_d82_a2_b("quest_d10_03", "completed");
}
...
void f_e08_a2_v(object a0, object a1)
{
	object L0;
...
void f_e1d_a2_v(object a0, object a1)
{
	@SetVariable("ood11Block1", 1);
}

void f_e23_a2_v(object a0, object a1)
{
...
bool f_e4a_a1_b(object a0)
{
	if (f_d51_a1_i("d8q01") == 1000) {
		return true;
	}
	return false;
}
...
{
	if (f_d51_a1_i("d9q02") == 1) {
		return true;
	}
	return false;
}

bool f_e6e_a1_b(object a0)
{
	if (f_d51_a1_i("d10q03") == 3) {
		return true;
	}
	return false;
}

bool f_e7a_a1_b(object a0)
{
	if (f_d51_a1_i("ood12Block1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_d51_a1_i("d9q01") == 2) {
		return true;
	}
	return false;
}

bool f_e92_a1_b(object a0)
{
	if (f_d51_a1_i("ood9Block1") == 0) {
		return true;
	}
	return false;
}

bool f_e9e_a1_b(object a0)
{
	if (f_d51_a1_i("d11q02") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_d51_a1_i("ood11Block1") == 0) {
		return true;
	}
	return false;
}

bool f_ec2_a1_b(object a0)
{
	if (f_d51_a1_i("d11q01") >= 3) {
		return true;
	}
	return false;
}
...
{
	if (f_d51_a1_i("ood11Block2") == 0) {
		return true;
	}
	return false;
}

bool f_eda_a1_b(object a0)
{
	if (f_d51_a1_i("ood11Block3") == 0) {
		return true;
	}
	return false;
}
...
bool f_f24_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
