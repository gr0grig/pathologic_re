...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_11b7_a1_b(f_1264_a0_o());
		if (!f_1162_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_12ef_a0_i());
		L0->SetNPCDescription(f_12ed_a0_i());
		L0->SetPhoto(f_12f1_a0_s());
		L0->SetPhoto2(f_12f3_a0_s());
		L0->SetPlayerName(f_1674_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1459_a1_b(tv1) && f_1471_a1_b(tv1)) {
				f_140b_a2_v(tv1, tv0);
				f_30e_a1_v("Modesty");
			...
			if (f_15d9_a1_b(tv1) && f_14c5_a1_b(tv1) && f_1471_a1_b(tv1) || f_15d9_a1_b(tv1) && f_14a1_a1_b(tv1) && f_1471_a1_b(tv1)) {
				f_12f7_a2_v(tv1, tv0);
				f_30e_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_1561_a1_b(tv1) && f_14dd_a1_b(tv1)) {
				tv0->AddReply(535143, 36805, 36804);
			}
			if (f_14d1_a1_b(tv1)) {
				tv0->AddReply(535107, 36764, 36763);
			}
			if (f_14ad_a1_b(tv1) && f_1501_a1_b(tv1) && f_147d_a1_b(tv1)) {
				tv0->AddReply(531940, 33345, 33344);
			}
			if (f_1489_a1_b(tv1) && f_14b9_a1_b(tv1) && f_147d_a1_b(tv1)) {
				tv0->AddReply(532458, 33900, 33899);
			}
			if (f_14e9_a1_b(tv1) && f_1495_a1_b(tv1)) {
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1519_a1_b(tv1) && f_1549_a1_b(tv1)) {
				tv0->AddReply(506856, 7563, 7562);
			}
			if (f_1525_a1_b(tv1) && f_1555_a1_b(tv1)) {
				tv0->AddReply(506859, 7566, 7565);
			}
			if (f_1531_a1_b(tv1) && f_153d_a1_b(tv1)) {
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_15cd_a1_b(tv1) && f_1585_a1_b(tv1) || f_159d_a1_b(tv1) && f_15cd_a1_b(tv1) || f_1591_a1_b(tv1) && f_15cd_a1_b(tv1)) {
...
maintask t13
{
	...
	bool f_1054_a0_b(void)
	{
		...
		return f_1154_a1_b(L0);
	}

	void f_1063_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_1068_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_1087_a0_v();
			if (f_115d_a0_b() && f_1068_a0_b()) {
				if (f_1054_a0_b()) {
					f_11f1_a1_b(f_1264_a0_o());
				}
			} else {
				f_1063_a0_v();
				f_107e_a0_v();
...
void f_10f6_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_115d_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_12d5_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_1154_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_114a_a1_b(L0);
}

bool f_115d_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1162_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_126a_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_11f1_a1_b(object a0)
{
	...
	return f_124e_a1_b(L4);
}

bool f_1216_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_12c6_a0_i() + "m";
	int L1;
...
void f_1248_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_1284_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_1295_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_12a1_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_12b4_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_12a1_a3_v(a0, L0, a2);
}

float f_12c1_a0_f(void)
{
	float L0;
	@GetGameTime(L0);
	return L0;
...
bool f_12cf_a1_b(int a0)
{
	return f_12c6_a0_i() == a0;
}

string f_12d5_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_12dc_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_12d5_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_12ed_a0_i(void)
{
	return 515533;
}

int f_12ef_a0_i(void)
{
	return 502858;
}

string f_12f1_a0_s(void)
{
	return "ui/NPC_Eva.png";
}

string f_12f3_a0_s(void)
{
	return "ui/NPC_Eva_b.png";
}

bool f_12f5_a0_b(void)
{
	return true;
}
...
void f_12fd_a2_v(object a0, object a1)
{
	...
	L0 = f_1642_a0_o();
	L0->AddMark("d1q03KapellaGotoOspina", "pt_map_ospina", 0, 508641, f_12c1_a0_f());
	f_15e5_a0_v();
	f_15f2_a0_v();
	f_1279_a1_o("quest_d1_03");
}
...
void f_132c_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1642_a0_o();
	L0->AddMark("d1q01EvaMapMarkMladVlad", "pt_map_station", 3, 518108, f_12c1_a0_f());
}

void f_133c_a2_v(object a0, object a1)
{
	f_1653_a3_v(f_1642_a0_o(), "pt_map_station", 2);
	a1->ShowMap(f_1642_a0_o());
}
...
void f_1352_a2_v(object a0, object a1)
{
	...
	f_12b4_a3_v(a0, "bracelet", 1);
}

void f_135d_a2_v(object a0, object a1)
{
	@Trace("ear_ring is given");
	f_12b4_a3_v(a0, "ear_ring", 1);
}
...
void f_136e_a2_v(object a0, object a1)
{
	f_1653_a3_v(f_1642_a0_o(), "pt_map_georg", 2);
	a1->ShowMap(f_1642_a0_o());
}
...
void f_1390_a2_v(object a0, object a1)
{
	@SetVariable("KnowUzly", 1);
}

void f_1396_a2_v(object a0, object a1)
{
...
void f_13a2_a2_v(object a0, object a1)
{
	@SetVariable("ood2Eva3", 1);
}

void f_13a8_a2_v(object a0, object a1)
{
	@SetVariable("ood2Eva4", 1);
}

void f_13ae_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d2q02", 1);
	L0 = f_1642_a0_o();
	L0->AddMark("d2q02EvaGotoAndrei", "pt_map_andrei", 0, 515272, f_12c1_a0_f());
	f_15ff_a0_v();
	f_160c_a0_v();
	f_1279_a1_o("quest_d2_02");
}

void f_13cc_a2_v(object a0, object a1)
{
	f_1284_a2_v("icot_eva@door1", false);
}

void f_13d3_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1642_a0_o();
	L0->AddMark("d1q01EvaGotoSimon", "pt_map_georg", 1, 507778, f_12c1_a0_f());
	L0->AddMark("d1EvaGotoMaria", "pt_map_maria", 3, 508628, f_12c1_a0_f());
	L0->AddMark("d1EvaInfo", "pt_map_eva", 3, 508630, f_12c1_a0_f());
}
...
{
	f_1653_a3_v(f_1642_a0_o(), "pt_map_ospina", 2);
	a1->ShowMap(f_1642_a0_o());
}
...
{
	f_1653_a3_v(f_1642_a0_o(), "pt_map_andrei", 2);
	a1->ShowMap(f_1642_a0_o());
}

void f_142d_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1642_a0_o();
	L0->AddMark("d2q02EvaGotoMaria", "pt_map_maria", 0, 515274, f_12c1_a0_f());
}

void f_143d_a2_v(object a0, object a1)
{
	f_1653_a3_v(f_1642_a0_o(), "pt_map_maria", 2);
	a1->ShowMap(f_1642_a0_o());
}
...
void f_1453_a2_v(object a0, object a1)
{
...
{
	if (f_1274_a1_i("ood1EvaIntro1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("d1q01FirstGeorgVisit") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("d1q03IsKapella") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("ood1EvaIntro2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("d4q02LaraGivesMedcine") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("d4q02JuliaGivesMedcine") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1274_a1_i("ood1EvaIntro3") == 0) {
		return true;
	}
	return false;
}

void f_15e5_a0_v(void)
{
	object L0;
...
bool f_1626_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1653_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
