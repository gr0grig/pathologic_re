...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_1975_a1_b(f_1a22_a0_o());
		if (!f_1920_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1a9b_a0_i());
		L0->SetNPCDescription(f_1a99_a0_i());
		L0->SetPhoto(f_1a9d_a0_s());
		L0->SetPhoto2(f_1a9f_a0_s());
		L0->SetPlayerName(f_1e9c_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1d90_a1_b(tv1) && f_1d9c_a1_b(tv1)) {
				tv0->AddReply(512010, 13230, 13228);
			}
			if (!f_1d54_a1_b(tv1) && !f_1d60_a1_b(tv1) && !f_1d6c_a1_b(tv1) && f_1d78_a1_b(tv1)) {
...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1cdc_a1_b(tv1) && !f_1c0f_a1_b(tv1) && !f_1c1b_a1_b(tv1)) {
				tv0->AddReply(507629, 5329, 8418);
			}
			if (f_1ce8_a1_b(tv1) && !f_1c0f_a1_b(tv1) && !f_1c1b_a1_b(tv1)) {
				tv0->AddReply(507632, 5334, 8421);
			}
			if (f_1cb8_a1_b(tv1) && !f_1c1b_a1_b(tv1) && !f_1c0f_a1_b(tv1)) {
				tv0->AddReply(531620, 32993, 32992);
			}
			if (f_1c33_a1_b(tv1) && f_1cc4_a1_b(tv1)) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 34319) {
				...
				tv0->AddReply(532841, 34315, 34323);
				return;
			}
			if (a0 == 34321) {
				f_66a_a1_v("Neutral");
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1c7c_a1_b(tv1) && f_1ca0_a1_b(tv1)) {
				f_dd1_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_1c88_a1_b(tv1) && f_1c94_a1_b(tv1)) {
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1cf4_a1_b(tv1) && f_1c4b_a1_b(tv1)) {
				tv0->AddReply(509042, 9941, 9918);
			}
			if (f_1d24_a1_b(tv1) && f_1d30_a1_b(tv1)) {
				tv0->AddReply(510442, 11512, 11511);
			}
			if (f_1d0c_a1_b(tv1) && f_1c57_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1d48_a1_b(tv1) && f_1d3c_a1_b(tv1)) {
...
task t16
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1da8_a1_b(tv1) && f_1db4_a1_b(tv1)) {
				f_1c03_a2_v(tv1, tv0);
				f_164a_a1_v("Neutral");
...
maintask t19
{
	...
	bool f_180b_a0_b(void)
	{
		...
		return f_1912_a1_b(L0);
	}

	void f_181a_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_181f_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_183e_a0_v();
			if (f_191b_a0_b() && f_181f_a0_b()) {
				if (f_180b_a0_b()) {
					f_19af_a1_b(f_1a22_a0_o());
				}
			} else {
				f_181a_a0_v();
				f_1835_a0_v();
...
void f_18ad_a0_v(void)
{
	...
	L0 = f_1a88_a0_i();
	for (L1 = 0; L1 < 5 && f_191b_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1a81_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_18f2_a0_b(void)
{
	return true;
}

void f_18f4_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_18f9_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_1901_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_1912_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1908_a1_b(L0);
}

bool f_191b_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1920_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1a28_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_19af_a1_b(object a0)
{
	...
	return f_1a0c_a1_b(L4);
}

bool f_19d4_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1a72_a0_i() + "m";
	int L1;
...
void f_1a06_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_1a42_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1a4e_a2_v(object a0, int a1)
{
	f_1901_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_1a61_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1a7b_a1_b(int a0)
{
	return f_1a72_a0_i() == a0;
}

string f_1a81_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_1a88_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1a81_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1a99_a0_i(void)
{
	return 515534;
}

int f_1a9b_a0_i(void)
{
	return 502859;
}

string f_1a9d_a0_s(void)
{
	return "ui/NPC_Georg.png";
}

string f_1a9f_a0_s(void)
{
	return "ui/NPC_Georg_b.png";
}

bool f_1aa1_a0_b(void)
{
	return true;
}
...
void f_1aad_a2_v(object a0, object a1)
{
	f_1e7b_a3_v(f_1e6a_a0_o(), "pt_map_aglaja", 2);
	a1->ShowMap(f_1e6a_a0_o());
}

void f_1abd_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d1q01", 1);
	L0 = f_1e6a_a0_o();
	L0->AddMark("d1GeorgInfo", "pt_map_georg", 3, 508631, f_1a6d_a0_f());
	L0->AddMark("d1q01GeorgGotoViktor", "pt_map_viktor", 1, 508629, f_1a6d_a0_f());
	f_1dd9_a0_v();
	f_1df3_a0_v();
}

void f_1ae0_a2_v(object a0, object a1)
{
	f_1de6_a0_v();
	f_1a61_a2_b("quest_d1_01", "completed");
}

void f_1aea_a2_v(object a0, object a1)
{
	@SetVariable("d1q01TeloNedostupno", 1);
}

void f_1af0_a2_v(object a0, object a1)
{
	@SetVariable("d1q01FirstGeorgVisit", 1);
	f_1a61_a2_b("quest_d1_01", "remove_cutscene");
}

void f_1afb_a2_v(object a0, object a1)
{
	if (f_1a32_a1_i("d2q01BigVladVisit") != 0 && f_1a32_a1_i("d2q01GeorgVisit") != 0) {
		f_1e00_a0_v();
	}
}

void f_1b12_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_1b18_a2_v(object a0, object a1)
{
	@SetVariable("ood1Georg5", 1);
}

void f_1b1e_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d10q02", 4);
	L0 = f_1e6a_a0_o();
	L0->AddMark("d10q02GeorgGotoAglaja", "pt_map_aglaja", 0, 515299, f_1a6d_a0_f());
	f_1dcc_a0_v();
}

void f_1b35_a2_v(object a0, object a1)
{
	@SetVariable("ood2Georg1", 1);
}

void f_1b3b_a2_v(object a0, object a1)
{
	@SetVariable("ood2Georg2", 1);
}

void f_1b41_a2_v(object a0, object a1)
{
	@SetVariable("d2q01GeorgVisit", 1);
	f_1e0d_a0_v();
}

void f_1b4a_a2_v(object a0, object a1)
{
	@SetVariable("ood1Georg4", 1);
}

void f_1b50_a2_v(object a0, object a1)
{
	@Trace("money 5000 is given");
	f_1a4e_a2_v(a0, 5000);
}

void f_1b5a_a2_v(object a0, object a1)
{
	int L0;
	@GetVariable("d3q02", L0);
	if (L0) {
		f_1a61_a2_b("quest_d3_02", "completed");
	} else {
...
void f_1b71_a2_v(object a0, object a1)
{
	@SetVariable("ood3Georg2", 1);
}

void f_1b77_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d3q02", 1);
	L0 = f_1e6a_a0_o();
	L0->AddMark("d3q02GeorgGotoViktor", "pt_map_viktor", 0, 511379, f_1a6d_a0_f());
	f_1e1a_a0_v();
	f_1e27_a0_v();
	f_1a37_a1_o("quest_d3_02");
}

void f_1b95_a2_v(object a0, object a1)
{
	f_1e34_a0_v();
	f_1a61_a2_b("quest_d3_02", "completed");
}

void f_1b9f_a2_v(object a0, object a1)
{
	f_1e7b_a3_v(f_1e6a_a0_o(), "pt_map_viktor", 2);
	a1->ShowMap(f_1e6a_a0_o());
}
...
void f_1bd3_a2_v(object a0, object a1)
{
	@SetVariable("KnowOlgimskiClan", 1);
}

void f_1bd9_a2_v(object a0, object a1)
{
	@SetVariable("KnowKainClan", 1);
}

void f_1bdf_a2_v(object a0, object a1)
{
...
void f_1beb_a2_v(object a0, object a1)
{
	@SetVariable("KnowBigVlad", 1);
}

void f_1bf1_a2_v(object a0, object a1)
{
...
void f_1bfd_a2_v(object a0, object a1)
{
	@SetVariable("ood6Georg3", 1);
}

void f_1c03_a2_v(object a0, object a1)
{
	@SetVariable("ood8Georg1", 1);
}

void f_1c09_a2_v(object a0, object a1)
{
...
{
	if (f_1a32_a1_i("d1q01") == 8) {
		return true;
	}
	return false;
}

bool f_1c33_a1_b(object a0)
{
	if (f_1a32_a1_i("ood1Georg5") == 0) {
		return true;
	}
	return false;
}

bool f_1c3f_a1_b(object a0)
{
	if (f_1a32_a1_i("d10q02") == 3) {
		return true;
	}
	return false;
}
...
{
	if (f_1a32_a1_i("d3q01HelpBurah") != 0) {
		return true;
	}
	return false;
}

bool f_1c57_a1_b(object a0)
{
	if (!(f_1a32_a1_i("d3q02") == 1000) && !(f_1a32_a1_i("d3q02") == 0) && !(f_1a32_a1_i("d3q02") == -1)) {
		return true;
	}
	return false;
}

bool f_1c7c_a1_b(object a0)
{
	if (f_1a32_a1_i("ood2Georg1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1a32_a1_i("ood2Georg2") == 0) {
		return true;
	}
	return false;
}

bool f_1c94_a1_b(object a0)
{
	if (f_1a32_a1_i("d2q01") == 0) {
		return true;
	}
	return false;
}

bool f_1ca0_a1_b(object a0)
{
	if (f_1a32_a1_i("d2q01") == 6) {
		return true;
	}
	return false;
}

bool f_1cac_a1_b(object a0)
{
	if (f_1a32_a1_i("KnowBurahDead") == 1) {
		return true;
	}
	return false;
}

bool f_1cb8_a1_b(object a0)
{
	if (f_1a32_a1_i("ood1Georg4") == 0) {
		return true;
	}
	return false;
}

bool f_1cc4_a1_b(object a0)
{
	if (f_1a32_a1_i("d1q01") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1a32_a1_i("ood1Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_1cdc_a1_b(object a0)
{
	if (f_1a32_a1_i("ood1Georg2") == 0) {
		return true;
	}
	return false;
}

bool f_1ce8_a1_b(object a0)
{
	if (f_1a32_a1_i("ood1Georg3") == 0) {
		return true;
	}
	return false;
}

bool f_1cf4_a1_b(object a0)
{
	if (f_1a32_a1_i("ood3Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_1d00_a1_b(object a0)
{
	if (f_1a32_a1_i("ood3Georg2") == 0) {
		return true;
	}
	return false;
}

bool f_1d0c_a1_b(object a0)
{
	if (f_1a32_a1_i("d3RubinToldWhereIsSimon") == 1) {
		return true;
	}
	return false;
}

bool f_1d18_a1_b(object a0)
{
	if (f_1a32_a1_i("d3q02") == 0) {
		return true;
	}
	return false;
}

bool f_1d24_a1_b(object a0)
{
	if (f_1a32_a1_i("ood3Georg3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1a32_a1_i("d3q02SeeCorpse") == 1) {
		return true;
	}
	return false;
}

bool f_1d3c_a1_b(object a0)
{
	if (f_1a32_a1_i("d5q03") == 1000) {
		return true;
	}
	return false;
}

bool f_1d48_a1_b(object a0)
{
	if (f_1a32_a1_i("ood5Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_1d54_a1_b(object a0)
{
	if (f_1a32_a1_i("d6q01") == 0) {
		return true;
	}
	return false;
}

bool f_1d60_a1_b(object a0)
{
	if (f_1a32_a1_i("d6q01") == 1000) {
		return true;
	}
	return false;
}

bool f_1d6c_a1_b(object a0)
{
	if (f_1a32_a1_i("d6q01") == -1) {
		return true;
	}
	return false;
}

bool f_1d78_a1_b(object a0)
{
	if (f_1a32_a1_i("ood6Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_1d84_a1_b(object a0)
{
	if (f_1a32_a1_i("ood6Georg2") == 0) {
		return true;
	}
	return false;
}

bool f_1d90_a1_b(object a0)
{
	if (f_1a32_a1_i("d6RubinGoesToGeorg") != 0) {
		return true;
	}
	return false;
}

bool f_1d9c_a1_b(object a0)
{
	if (f_1a32_a1_i("ood6Georg3") == 0) {
		return true;
	}
	return false;
}

bool f_1da8_a1_b(object a0)
{
	if (f_1a32_a1_i("d8KainIsReason") == 1) {
		return true;
	}
	return false;
}

bool f_1db4_a1_b(object a0)
{
	if (f_1a32_a1_i("ood8Georg1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1a32_a1_i("ood5Georg2") == 0) {
		return true;
	}
	return false;
}

void f_1dcc_a0_v(void)
{
	object L0;
...
bool f_1e4e_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1e7b_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
