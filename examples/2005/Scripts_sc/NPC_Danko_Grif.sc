...
task t2
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_1510_a1_b(f_1614_a0_o());
		if (!f_14bb_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_169b_a0_i());
		L0->SetNPCDescription(f_1699_a0_i());
		L0->SetPhoto(f_169d_a0_s());
		L0->SetPhoto2(f_169f_a0_s());
		L0->SetPlayerName(f_19ab_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_187c_a1_b(tv1) && f_178e_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_17be_a1_b(tv1) && f_17e2_a1_b(tv1)) {
...
task t11
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1812_a1_b(tv1) && f_181e_a1_b(tv1)) {
				tv0->AddReply(510970, 12133, 12132);
			}
			if (f_1864_a1_b(tv1) && f_17a6_a1_b(tv1)) {
...
task t13
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_179a_a1_b(tv1) && !f_17ee_a1_b(tv1)) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 10848) {
				...
				tv0->AddReply(509857, 10858, 10857);
				return;
			}
			if (a0 == 10858) {
				f_a87_a1_v("Neutral");
				tv0->SetMessage(509858);
				tv0->ClearReplies();
				tv0->AddReply(509859, 10860, 10859);
				tv0->AddReply(509863, -1, 10863);
				return;
			}
			if (a0 == 10860) {
				f_a87_a1_v("Neutral");
				tv0->SetMessage(509860);
				tv0->ClearReplies();
				tv0->AddReply(509861, -1, 10861);
				tv0->AddReply(509862, -1, 10862);
				return;
			}
			if (a0 == 10850) {
				f_a87_a1_v("Neutral");
...
task t15
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1858_a1_b(tv1) && f_1870_a1_b(tv1)) {
				f_177c_a2_v(tv1, tv0);
				f_c52_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_182a_a1_b(tv1) && f_1836_a1_b(tv1)) {
				tv0->AddReply(511705, 12910, 12909);
			}
			if (f_182a_a1_b(tv1) && !f_184c_a1_b(tv1) && !f_1836_a1_b(tv1) && f_1842_a1_b(tv1)) {
...
task t25
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			f_1263_a1_v("Neutral");
			tv0->SetMessage(514138);
			tv0->ClearReplies();
			tv0->AddReply(514139, -1, 15353);
			tv0->AddReply(514140, -1, 15354);
			break;
			return;
		}
		if (f_16a1_a0_b()) {
...
maintask t28
{
	...
	bool f_13a6_a0_b(void)
	{
		...
		return f_14ad_a1_b(L0);
	}

	void f_13b5_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_13ba_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_13d9_a0_v();
			if (f_14b6_a0_b() && f_13ba_a0_b()) {
				if (f_13a6_a0_b()) {
					f_154a_a1_b(f_1614_a0_o());
				}
			} else {
				f_13b5_a0_v();
				f_13d0_a0_v();
...
void f_1448_a0_v(void)
{
	...
	L0 = f_1688_a0_i();
	for (L1 = 0; L1 < 5 && f_14b6_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1681_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_148d_a0_b(void)
{
	return true;
}

void f_148f_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1494_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_149c_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_14ad_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_14a3_a1_b(L0);
}

bool f_14b6_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_14bb_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_161a_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_154a_a1_b(object a0)
{
	...
	return f_15e2_a1_b(L4);
}

bool f_156f_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1672_a0_i() + "m";
	int L1;
...
{
	return f_15a2_a2_b(a0, 70);
}

bool f_15a2_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_15d1_a1_v(object a0)
{
	@CameraSwitchToNormal();
}

void f_15d5_a1_v(string a0)
{
	float L0;
	float L1;
...
void f_15dc_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_15f8_a3_v(string a0, int a1, int a2)
{
	if (f_1624_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
	}
}

void f_1603_a5_v(string a0, int a1, int a2, int a3, int a4)
{
	if (f_1624_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
bool f_1624_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
void f_162e_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_163a_a2_v(object a0, int a1)
{
	f_149c_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_167b_a1_b(int a0)
{
	return f_1672_a0_i() == a0;
}

string f_1681_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_1688_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1681_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1699_a0_i(void)
{
	return 515535;
}

int f_169b_a0_i(void)
{
	return 502860;
}

string f_169d_a0_s(void)
{
	return "ui/NPC_Grif.png";
}

string f_169f_a0_s(void)
{
	return "ui/NPC_Grif_b.png";
}

bool f_16a1_a0_b(void)
{
	return true;
}
...
void f_16a3_a2_v(object a0, object a1)
{
	...
	f_163a_a2_v(a0, 10000);
}

void f_16ad_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_16b3_a2_v(object a0, object a1)
{
...
void f_16b9_a2_v(object a0, object a1)
{
	...
	f_1660_a3_v(a0, "revolver_ammo", 15);
}
...
void f_16e6_a2_v(object a0, object a1)
{
...
void f_16f8_a2_v(object a0, object a1)
{
...
void f_1707_a2_v(object a0, object a1)
{
	object L0;
...
void f_171c_a2_v(object a0, object a1)
{
	@SetVariable("ood4Grif1", 1);
}

void f_1722_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d4q03", 2);
	L0 = f_18f9_a0_o();
	L0->AddMark("d4q03GrifGotoAlexandr", "pt_map_alexandr", 0, 515331, f_166d_a0_f());
	L0->AddMark("d4q03GrifGotoAlexandrSelf", "pt_map_grif", 0, 515332, f_166d_a0_f());
	f_18b6_a0_v();
}

void f_1742_a2_v(object a0, object a1)
{
	@SetVariable("ood4Grif2", 1);
}

void f_1748_a2_v(object a0, object a1)
{
	@SetVariable("ood5Grif1", 1);
}

void f_174e_a2_v(object a0, object a1)
{
...
void f_175b_a2_v(object a0, object a1)
{
	a1->SetReturnValue(1000);
}

void f_1760_a2_v(object a0, object a1)
{
	@SetVariable("KnowGrif", 1);
}

void f_1766_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_18f9_a0_o();
	L0->AddMark("d5q01GrifWantsMoney", "pt_map_grif", 1, 515350, f_166d_a0_f());
}
...
{
	if (f_1629_a1_i("d4q03_alldead") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1629_a1_i("d5q01") == 6) {
		return true;
	}
	return false;
}

bool f_1836_a1_b(object a0)
{
	if (f_1629_a1_i("ood5Grif1") == 0) {
		return true;
	}
	return false;
}

bool f_1842_a1_b(object a0)
{
	if (f_189e_a1_b(a0)) {
		return true;
	}
...
{
	if (f_1629_a1_i("d5q01ThiefsWillHelp") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1629_a1_i("d1q01") != 0 || f_1629_a1_i("d1q01") != 1000 || f_1629_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}
...
bool f_18dd_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_190a_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_1672_a0_i();
	@AddItem(L0, f_19a6_a1_i("Rifle"), 0, 1);
	@AddItem(L0, f_19a6_a1_i("Revolver"), 0, 1);
	@AddItem(L0, f_19a6_a1_i("Knife"), 0, 1);
	if (L2 != 10) {
		@AddItem(L0, f_19a6_a1_i("tvirin"), 0, 1);
	} else {
		@AddItem(L0, f_19a6_a1_i("tvirin"), 0, 4);
	}
	@AddItem(L0, f_19a6_a1_i("lockpick"), 0, 3);
	f_15f8_a3_v("Scalpel", 1, 2);
	f_1603_a5_v("revolver_ammo", 1, 1, 5, 10);
	f_1603_a5_v("rifle_ammo", 1, 1, 5, 20);
	@irand(L1, 100);
	if (L1 != 0) {
		@AddItem(L0, f_19a6_a1_i("kerosene"), 0, L1);
	}
	if (L2 >= 3) {
		@AddItem(L0, f_19a6_a1_i("halfboot_repel"), 0, 1);
		@AddItem(L0, f_19a6_a1_i("boot_repel"), 0, 1);
	}
	if (L2 >= 9) {
		@AddItem(L0, f_19a6_a1_i("boot_army"), 0, 1);
		@AddItem(L0, f_19a6_a1_i("balahon"), 0, 1);
		@AddItem(L0, f_19a6_a1_i("glove_army"), 0, 1);
	}
	if (f_19bc_a0_i() == 0) {
		@AddItem(L0, f_19a6_a1_i("Gun_danko"), 0, 1);
	}
}

int f_19a6_a1_i(string a0)
{
	int L0;
