...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_18b3_a0_i());
		L0->SetNPCDescription(f_18b1_a0_i());
		L0->SetPhoto(f_18b5_a0_s());
		L0->SetPhoto2(f_18b7_a0_s());
		L0->SetPlayerName(f_1c92_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1ab9_a1_b(tv1) && f_1ba0_a1_b(tv1)) {
				tv0->AddReply(533163, 34683, 34682);
			}
			if (f_1a65_a1_b(tv1) && f_1ba0_a1_b(tv1)) {
				tv0->AddReply(531692, 32998, 33076);
			}
			if (f_1a71_a1_b(tv1) && !f_1ab9_a1_b(tv1)) {
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1a89_a1_b(tv1) && f_1a7d_a1_b(tv1)) {
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1b53_a1_b(tv1) && f_1b5f_a1_b(tv1)) {
				tv0->AddReply(503641, 3945, 3943);
			}
			if (f_1b47_a1_b(tv1) && f_1b6b_a1_b(tv1)) {
				tv0->AddReply(512733, 11803, 13927);
			}
			if (f_1b77_a1_b(tv1) && f_1b83_a1_b(tv1) && !f_1b88_a1_b(tv1) && !f_1b94_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1af3_a1_b(tv1) && f_1aff_a1_b(tv1)) {
				tv0->AddReply(506915, 7622, 7621);
			}
			if (f_1ac5_a1_b(tv1) && f_1ae7_a1_b(tv1)) {
...
task t16
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1b0b_a1_b(tv1) && !f_1b23_a1_b(tv1)) {
				tv0->AddReply(511469, 12676, 12675);
			}
			if (f_1b3b_a1_b(tv1) && f_1b2f_a1_b(tv1)) {
...
maintask t19
{
	...
	void f_1612_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_1617_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
...
void f_16a5_a0_v(void)
{
	...
	L0 = f_18a0_a0_i();
	for (L1 = 0; L1 < 5 && f_1713_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1899_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_16ea_a0_b(void)
{
	return true;
}

void f_16ec_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_16f1_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_183a_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1846_a2_v(object a0, int a1)
{
...
void f_1859_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_186c_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1859_a3_v(a0, L0, a2);
}

bool f_1879_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1893_a1_b(int a0)
{
	return f_188a_a0_i() == a0;
}

string f_1899_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_18a0_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1899_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_18b1_a0_i(void)
{
	return 515537;
}

int f_18b3_a0_i(void)
{
	return 502862;
}

string f_18b5_a0_s(void)
{
	return "ui/NPC_Julia.png";
}

string f_18b7_a0_s(void)
{
	return "ui/NPC_Julia_b.png";
}

bool f_18b9_a0_b(void)
{
	return true;
}

void f_18bb_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1c60_a0_o();
	L0->AddMark("d1q02JuliaGotoAnna", "pt_map_anna", 0, 508634, f_1885_a0_f());
	f_1bcf_a0_v();
	f_1bdc_a0_v();
	f_182f_a1_o("quest_d1_02");
}
...
void f_18e1_a2_v(object a0, object a1)
{
	...
	@SetVariable("d1q01", 5);
	L0 = f_1c60_a0_o();
	L0->AddMark("d1q01JuliaGotoBigVlad", "pt_map_bigvlad", 3, 508633, f_1885_a0_f());
	f_1bc2_a0_v();
}

void f_18f8_a2_v(object a0, object a1)
{
...
void f_1941_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1c60_a0_o();
	L0->AddMark("d1JuliaMapMarkEva", "pt_map_eva", 1, 508639, f_1885_a0_f());
	L0->AddMark("d1JuliaMapMarkLara", "pt_map_lara", 1, 508646, f_1885_a0_f());
}
...
void f_1960_a2_v(object a0, object a1)
{
	...
	f_186c_a3_v(a0, "raincoat_repel", 1);
}
...
void f_1976_a2_v(object a0, object a1)
{
...
{
	f_1c71_a3_v(f_1c60_a0_o(), "pt_map_anna", 2);
	a1->ShowMap(f_1c60_a0_o());
}
...
{
	f_1c71_a3_v(f_1c60_a0_o(), "pt_map_bigvlad", 2);
	a1->ShowMap(f_1c60_a0_o());
}

void f_19a8_a2_v(object a0, object a1)
{
...
{
	if (f_182a_a1_i("d4q02AnnaGivesMedcine") == 1 && f_182a_a1_i("d4q02JuliaGivesMedcine") == 1 && f_182a_a1_i("d4q02LaraGivesMedcine") == 1) {
		object L0;
		@SetVariable("d4q02", 2);
		L0 = f_1c60_a0_o();
		L0->AddMark("d4q02BirdmaskNearHome", "pt_d4q02_birdmask", 0, 511842, f_1885_a0_f());
		f_1879_a2_b("quest_d4_02", "birdmask");
		f_1c71_a3_v(f_1c60_a0_o(), "pt_d4q02_birdmask", 2);
		a1->ShowMap(f_1c60_a0_o());
	}
}
...
void f_1a14_a2_v(object a0, object a1)
{
	...
	f_186c_a3_v(a0, "d6q01_julia_blood", 1);
}
...
void f_1a28_a2_v(object a0, object a1)
{
	...
	f_1bf6_a0_v();
	f_1879_a2_b("quest_d6_01", "completed");
}

void f_1a36_a2_v(object a0, object a1)
{
}
...
void f_1a38_a2_v(object a0, object a1)
{
	...
	f_186c_a3_v(a0, "feromicin", 1);
}

void f_1a43_a2_v(object a0, object a1)
{
	@Trace("neomicin is given");
	f_186c_a3_v(a0, "neomicin", 1);
}

void f_1a4e_a2_v(object a0, object a1)
{
	@Trace("monomicin is given");
	f_186c_a3_v(a0, "monomicin", 1);
}

bool f_1a59_a1_b(object a0)
{
	if (f_182a_a1_i("d1q01") == 4) {
		return true;
	}
	return false;
}

bool f_1a65_a1_b(object a0)
{
	if (f_182a_a1_i("ood1Julia1") == 0) {
		return true;
	}
	return false;
}

bool f_1a71_a1_b(object a0)
{
	if (f_182a_a1_i("ood1Julia2") == 0) {
		return true;
	}
	return false;
}

bool f_1a7d_a1_b(object a0)
{
	if (f_182a_a1_i("d8q04") == 1000) {
		return true;
	}
	return false;
}

bool f_1a89_a1_b(object a0)
{
	if (f_182a_a1_i("ood8Julia1") == 0) {
		return true;
	}
	return false;
}

bool f_1a95_a1_b(object a0)
{
	if (f_182a_a1_i("ood9Julia1") == 0) {
		return true;
	}
	return false;
}

bool f_1aa1_a1_b(object a0)
{
	if (f_182a_a1_i("d9q02") == 2) {
		return true;
	}
	return false;
}

bool f_1aad_a1_b(object a0)
{
	if (f_182a_a1_i("ood1Julia3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_182a_a1_i("d2q01") != 0 && f_182a_a1_i("d2q01") != 1000 && f_182a_a1_i("d2q01") != -1) {
		return true;
	}
	return false;
}
...
{
	if (f_182a_a1_i("d4q02JuliaGivesMedcine") == 1) {
		return true;
	}
	return false;
}

bool f_1b2f_a1_b(object a0)
{
	if (f_182a_a1_i("d4q02") == 1000) {
		return true;
	}
	return false;
}

bool f_1b3b_a1_b(object a0)
{
	if (f_182a_a1_i("ood4Julia2") == 0) {
		return true;
	}
	return false;
}

bool f_1b47_a1_b(object a0)
{
	if (f_182a_a1_i("d6q01") == 1) {
		return true;
	}
	return false;
}

bool f_1b53_a1_b(object a0)
{
	if (f_182a_a1_i("d5q01") == 1000) {
		return true;
	}
	return false;
}
...
{
	if (f_182a_a1_i("microscope_d6q01_julia_blood") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_182a_a1_i("d6q01") == 1000) {
		return true;
	}
	return false;
}

bool f_1b94_a1_b(object a0)
{
	if (f_182a_a1_i("d6q01") == -1) {
		return true;
	}
...
bool f_1ba0_a1_b(object a0)
{
	if (f_182a_a1_i("d1q01") != 0 || f_182a_a1_i("d1q01") != 1000 || f_182a_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}

void f_1bc2_a0_v(void)
{
	object L0;
...
bool f_1c44_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1c71_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
