...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_134a_a1_b(f_13f7_a0_o());
		if (!f_12f5_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_147d_a0_i());
		L0->SetNPCDescription(f_147b_a0_i());
		L0->SetPhoto(f_147f_a0_s());
		L0->SetPhoto2(f_1481_a0_s());
		L0->SetPlayerName(f_1715_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1574_a1_b(tv1) && f_1671_a1_b(tv1)) {
				f_1497_a2_v(tv1, tv0);
				f_14f6_a2_v(tv1, tv0);
				f_f1_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_1671_a1_b(tv1) && f_15bd_a1_b(tv1)) {
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_15f9_a1_b(tv1) && f_15e1_a1_b(tv1)) {
				tv0->AddReply(512771, 3726, 13970);
			}
			if (f_1605_a1_b(tv1) && f_15ed_a1_b(tv1)) {
				tv0->AddReply(512772, 13972, 13971);
			}
			if (f_1611_a1_b(tv1) && f_1629_a1_b(tv1) || f_161d_a1_b(tv1) && f_1629_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1635_a1_b(tv1) && f_158c_a1_b(tv1)) {
				f_1533_a2_v(tv1, tv0);
				f_be4_a1_v("Neutral");
...
task t18
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_15c9_a1_b(tv1) && f_1665_a1_b(tv1) || f_15d5_a1_b(tv1) && f_1665_a1_b(tv1)) {
...
maintask t21
{
	...
	bool f_11e7_a0_b(void)
	{
		...
		return f_12e7_a1_b(L0);
	}

	void f_11f6_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_11fb_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_121a_a0_v();
			if (f_12f0_a0_b() && f_11fb_a0_b()) {
				if (f_11e7_a0_b()) {
					f_1384_a1_b(f_13f7_a0_o());
				}
			} else {
				f_11f6_a0_v();
				f_1211_a0_v();
...
void f_1289_a0_v(void)
{
	...
	L0 = f_146a_a0_i();
	for (L1 = 0; L1 < 5 && f_12f0_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_1463_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_12ce_a0_b(void)
{
	return true;
}

void f_12d0_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_12d5_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_12e7_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_12dd_a1_b(L0);
}

bool f_12f0_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_12f5_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_13fd_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1384_a1_b(object a0)
{
	...
	return f_13e1_a1_b(L4);
}

bool f_13a9_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1454_a0_i() + "m";
	int L1;
...
void f_13db_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_1417_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1423_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_1436_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1423_a3_v(a0, L0, a2);
}

bool f_1443_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_145d_a1_b(int a0)
{
	return f_1454_a0_i() == a0;
}

string f_1463_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_146a_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_1463_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_147b_a0_i(void)
{
	return 515539;
}

int f_147d_a0_i(void)
{
	return 502864;
}

string f_147f_a0_s(void)
{
	return "ui/NPC_Katerina.png";
}

string f_1481_a0_s(void)
{
	return "ui/NPC_Katerina_b.png";
}

bool f_1483_a0_b(void)
{
	return true;
}
...
void f_149d_a2_v(object a0, object a1)
{
	...
	L0 = f_16e3_a0_o();
	L0->AddMark("d10q02KaterinaGotoRubin", "pt_region01_center01", 0, 515467, f_144f_a0_f());
	f_1693_a0_v();
	f_16a0_a0_v();
	f_140c_a1_o("quest_d10_02");
}

void f_14bb_a2_v(object a0, object a1)
{
...
{
	f_16f4_a3_v(f_16e3_a0_o(), "pt_region01_center01", 2);
	a1->ShowMap(f_16e3_a0_o());
}

void f_14e9_a2_v(object a0, object a1)
{
	if (f_1407_a1_i("d5q01") != 4) {
		@SetVariable("d5q01", 4);
	}
}
...
void f_1508_a2_v(object a0, object a1)
{
	...
	@SetVariable("d6q01", 2);
	L0 = f_16e3_a0_o();
	L0->AddMark("d6q01KaterinaGotoLaska", "pt_map_laska", 1, 515398, f_144f_a0_f());
	L0->AddMark("d6q01KaterinagotoLaskaSelf", "pt_map_katerina", 1, 515399, f_144f_a0_f());
	f_16ad_a0_v();
	f_1443_a2_b("quest_d6_01", "saburov_klara_remove");
}
...
bool f_155c_a1_b(object a0)
{
	if (f_1407_a1_i("d1q01FirstGeorgVisit") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1407_a1_i("ood1Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_1574_a1_b(object a0)
{
	if (f_1407_a1_i("ood1Katerina2") == 0) {
		return true;
	}
	return false;
}

bool f_1580_a1_b(object a0)
{
	if (f_1407_a1_i("ood10Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_158c_a1_b(object a0)
{
	if (!(f_1407_a1_i("d3q01") == 0) && !(f_1407_a1_i("d3q01") == 1000) && !(f_1407_a1_i("d3q01") == -1)) {
		return true;
	}
	return false;
}

bool f_15b1_a1_b(object a0)
{
	if (f_1407_a1_i("ood3Katerina2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1407_a1_i("ood1Katerina3") == 0) {
		return true;
	}
	return false;
}

bool f_15c9_a1_b(object a0)
{
	if (f_1407_a1_i("d5q01") == 3) {
		return true;
	}
	return false;
}

bool f_15d5_a1_b(object a0)
{
	if (f_1407_a1_i("d5q01") == 4) {
		return true;
	}
...
bool f_15e1_a1_b(object a0)
{
	if (f_1407_a1_i("d6q01") == 1) {
		return true;
	}
	return false;
}

bool f_15ed_a1_b(object a0)
{
	if (f_1407_a1_i("d6q01KnowKillerIsKlara") == 1) {
		return true;
	}
	return false;
}

bool f_15f9_a1_b(object a0)
{
	if (f_1407_a1_i("ood6Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_1605_a1_b(object a0)
{
	if (f_1407_a1_i("ood6Katerina2") == 0) {
		return true;
	}
	return false;
}

bool f_1611_a1_b(object a0)
{
	if (f_1407_a1_i("d6q01") == 4) {
		return true;
	}
	return false;
}

bool f_161d_a1_b(object a0)
{
	if (f_1407_a1_i("d6q01") == 3) {
		return true;
	}
	return false;
}

bool f_1629_a1_b(object a0)
{
	if (f_1407_a1_i("ood6Katerina3") == 0) {
		return true;
	}
	return false;
}

bool f_1635_a1_b(object a0)
{
	if (f_1407_a1_i("ood3Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_1641_a1_b(object a0)
{
	if (f_1407_a1_i("ood4Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_164d_a1_b(object a0)
{
	if (f_1407_a1_i("ood2Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_1659_a1_b(object a0)
{
	if (f_1407_a1_i("ood2Katerina2") == 0) {
		return true;
	}
	return false;
}

bool f_1665_a1_b(object a0)
{
	if (f_1407_a1_i("ood5Katerina1") == 0) {
		return true;
	}
	return false;
}

bool f_1671_a1_b(object a0)
{
	if (f_1407_a1_i("d1q01") != 0 || f_1407_a1_i("d1q01") != 1000 || f_1407_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}

void f_1693_a0_v(void)
{
	object L0;
...
bool f_16c7_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_16f4_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
