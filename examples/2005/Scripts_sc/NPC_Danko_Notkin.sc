...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_9ca_a1_b(f_a77_a0_o());
		if (!f_975_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_b62_a0_i());
		L0->SetNPCDescription(f_b60_a0_i());
		L0->SetPhoto(f_b64_a0_s());
		L0->SetPhoto2(f_b66_a0_s());
		L0->SetPlayerName(f_b4f_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_b13_a1_b(tv1) && f_b43_a1_b(tv1) && !f_b1f_a1_b(tv1) || f_b37_a1_b(tv1) && f_b43_a1_b(tv1) && !f_b1f_a1_b(tv1)) {
...
maintask t11
{
	...
	bool f_867_a0_b(void)
	{
		...
		return f_967_a1_b(L0);
	}

	void f_876_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_87b_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_89a_a0_v();
			if (f_970_a0_b() && f_87b_a0_b()) {
				if (f_867_a0_b()) {
					f_a04_a1_b(f_a77_a0_o());
				}
			} else {
				f_876_a0_v();
				f_891_a0_v();
...
void f_909_a0_v(void)
{
	...
	L0 = f_aa2_a0_i();
	for (L1 = 0; L1 < 5 && f_970_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_a9b_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_975_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_a7d_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_a04_a1_b(object a0)
{
	...
	return f_a61_a1_b(L4);
}

bool f_a29_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_a8c_a0_i() + "m";
	int L1;
...
void f_a5b_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
bool f_a95_a1_b(int a0)
{
	return f_a8c_a0_i() == a0;
}

string f_a9b_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_aa2_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_a9b_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_ab3_a2_v(object a0, object a1)
{
	@SetVariable("ood3Notkin2", 1);
}

void f_ab9_a2_v(object a0, object a1)
{
	@SetVariable("ood3Notkin3", 1);
}

void f_abf_a2_v(object a0, object a1)
{
...
void f_ad7_a2_v(object a0, object a1)
{
	@SetVariable("ood3Notkin1", 1);
}

void f_add_a2_v(object a0, object a1)
{
...
{
	if (f_a87_a1_i("ood3Notkin3") == 0) {
		return true;
	}
	return false;
}

bool f_afb_a1_b(object a0)
{
	if (f_a87_a1_i("ood4Notkin2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_a87_a1_i("d4q03") == 2) {
		return true;
	}
	return false;
}

bool f_b1f_a1_b(object a0)
{
	if (f_a87_a1_i("d4q03_alldead") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_a87_a1_i("d4q03") == 3) {
		return true;
	}
	return false;
}

bool f_b43_a1_b(object a0)
{
	if (f_a87_a1_i("ood4Notkin1") == 0) {
		return true;
	}
	return false;
}
