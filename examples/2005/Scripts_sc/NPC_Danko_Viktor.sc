...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_213c_a1_b(f_21e9_a0_o());
		if (!f_20e7_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_2289_a0_i());
		L0->SetNPCDescription(f_2287_a0_i());
		L0->SetPhoto(f_228b_a0_s());
		L0->SetPhoto2(f_228d_a0_s());
		L0->SetPlayerName(f_27e8_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_24ba_a1_b(tv1) && f_248a_a1_b(tv1)) {
				tv0->AddReply(505107, 9234, 5620);
			}
			if (f_24ae_a1_b(tv1) && f_2681_a1_b(tv1) && f_2496_a1_b(tv1)) {
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2525_a1_b(tv1) && f_2549_a1_b(tv1) && f_253d_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2561_a1_b(tv1) && f_256d_a1_b(tv1)) {
				tv0->AddReply(510236, 11288, 11286);
			}
			if (f_2585_a1_b(tv1) && f_2579_a1_b(tv1)) {
...
task t16
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_250e_a1_b(tv1) && f_251a_a1_b(tv1)) {
...
task t18
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_25d9_a1_b(tv1) && !f_259d_a1_b(tv1) && !f_25a9_a1_b(tv1)) {
				f_23f6_a2_v(tv1, tv0);
				f_13cd_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_25b5_a1_b(tv1) && f_25c1_a1_b(tv1)) {
				tv0->AddReply(511767, 12977, 12975);
			}
			if (f_259d_a1_b(tv1) && f_25cd_a1_b(tv1)) {
...
task t22
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_25fd_a1_b(tv1) && f_25f1_a1_b(tv1)) {
				f_2431_a2_v(tv1, tv0);
				f_17dc_a1_v("Neutral");
...
task t24
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_2615_a1_b(tv1) && f_2621_a1_b(tv1)) {
...
task t26
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2645_a1_b(tv1) && f_2639_a1_b(tv1)) {
				tv0->AddReply(538451, 15592, 40333);
			}
			if (!f_2645_a1_b(tv1) && f_2651_a1_b(tv1) && f_265d_a1_b(tv1)) {
...
bool f_20a6_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_20b2_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_20a6_a2_b(a0, a1)) {
		return false;
	}
	a0->GetProperty(a1, L0);
	a0->SetProperty(a1, f_21f9_a3_f(L0 + a2, a3, a4));
	return true;
}

void f_20c8_a3_v(object a0, string a1, int a2)
{
	int L0;
	a0->GetProperty(a1, L0);
...
bool f_20d9_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_20cf_a1_b(L0);
}

bool f_20e2_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_20e7_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_21ef_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_2176_a1_b(object a0)
{
	...
	return f_21d3_a1_b(L4);
}

bool f_219b_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_2278_a0_i() + "m";
	int L1;
...
void f_21cd_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_21f9_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_2214_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_2220_a2_v(object a0, int a1)
{
	f_20c8_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_2233_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_223a_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_225d_a1_v(a1);
	f_20b2_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_225d_a1_v(float a0)
{
	object L0;
...
bool f_2267_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_2281_a1_b(int a0)
{
	return f_2278_a0_i() == a0;
}

int f_2287_a0_i(void)
{
	return 515554;
}

int f_2289_a0_i(void)
{
	return 502879;
}

string f_228b_a0_s(void)
{
	return "ui/NPC_Viktor.png";
}

string f_228d_a0_s(void)
{
	return "ui/NPC_Viktor_b.png";
}

bool f_228f_a0_b(void)
{
	return true;
}

void f_2291_a2_v(object a0, object a1)
{
	f_26d7_a0_v();
	f_2267_a2_b("quest_d1_02", "fail");
}

void f_229b_a2_v(object a0, object a1)
{
	@SetVariable("ood1Viktor1", 1);
}

void f_22a1_a2_v(object a0, object a1)
{
	@SetVariable("ood1Viktor2", 1);
}

void f_22a7_a2_v(object a0, object a1)
{
	@SetVariable("ood1Viktor3", 1);
}

void f_22ad_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_22b3_a2_v(object a0, object a1)
{
	f_27c7_a3_v(f_27b6_a0_o(), "pt_b1q05_patrol_house", 2);
	a1->ShowMap(f_27b6_a0_o());
}

void f_22c3_a2_v(object a0, object a1)
{
	@Trace("money 7000 is given");
	f_2220_a2_v(a0, 7000);
}

void f_22cd_a2_v(object a0, object a1)
{
	@SetVariable("d7q03", 3);
	f_2766_a0_v();
}

void f_22d6_a2_v(object a0, object a1)
{
	@SetVariable("d10q02", 3);
	f_26a3_a0_v();
}

void f_22df_a2_v(object a0, object a1)
{
	f_2267_a2_b("quest_d10_02", "unlock_georg");
}

void f_22e6_a2_v(object a0, object a1)
{
}

void f_22e8_a2_v(object a0, object a1)
{
	@SetVariable("ood11Viktor4", 1);
}

void f_22ee_a2_v(object a0, object a1)
{
	@SetVariable("d11q06", 1);
	f_26b0_a0_v();
	f_26bd_a0_v();
	f_2209_a1_o("quest_d11_06");
}

void f_22fe_a2_v(object a0, object a1)
{
	@SetVariable("ood3Viktor3", 1);
}

void f_2304_a2_v(object a0, object a1)
{
	@SetVariable("ood4Viktor1", 1);
}

void f_230a_a2_v(object a0, object a1)
{
	@SetVariable("d4q04", 1000);
	f_270b_a0_v();
}

void f_2313_a2_v(object a0, object a1)
{
...
void f_231f_a2_v(object a0, object a1)
{
	@Trace("money25000 is given");
	f_2220_a2_v(a0, 25000);
}

void f_2329_a2_v(object a0, object a1)
{
	@SetVariable("d9ViktorVisit", 1);
}

void f_232f_a2_v(object a0, object a1)
{
	@SetVariable("ood2Viktor1", 1);
}

void f_2335_a2_v(object a0, object a1)
{
	@SetVariable("KnowRavell", 1);
}

void f_233b_a2_v(object a0, object a1)
{
	@Trace("money 5000 is given");
	f_2220_a2_v(a0, 5000);
}

void f_2345_a2_v(object a0, object a1)
{
	@SetVariable("d4q04", 1);
	f_26fe_a0_v();
	f_2718_a0_v();
...
void f_2351_a2_v(object a0, object a1)
{
	@SetVariable("KnowViktor", 1);
}

void f_2357_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_27b6_a0_o();
	L0->AddMark("d3q02ViktorGotoMladVlad", "pt_map_mladvlad", 0, 511380, f_2273_a0_f());
	f_26f1_a0_v();
}

void f_236a_a2_v(object a0, object a1)
{
	@SetVariable("ood3Viktor1", 1);
}

void f_2370_a2_v(object a0, object a1)
{
	f_27c7_a3_v(f_27b6_a0_o(), "pt_map_mladvlad", 2);
	a1->ShowMap(f_27b6_a0_o());
}

void f_2380_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d3q02", 3);
	L0 = f_27b6_a0_o();
	L0->AddMark("d3q02ViktorGotoHan", "pt_map_han", 0, 511385, f_2273_a0_f());
	f_26e4_a0_v();
}
...
void f_239d_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d1q01", 2);
	L0 = f_27b6_a0_o();
	L0->AddMark("d1q01ViktorGotoIsidor", "pt_map_burah_father", 1, 508637, f_2273_a0_f());
	f_26ca_a0_v();
	f_2267_a2_b("quest_d1_01", "place_patrol");
}

void f_23b9_a2_v(object a0, object a1)
{
	if (f_2204_a1_i("d5q03") == 0) {
		object L0;
		@SetVariable("d5q03", 1);
		L0 = f_27b6_a0_o();
		L0->AddMark("d5q03SavePrisoners", "pt_map_uprava_prison", 0, 515370, f_2273_a0_f());
		f_2725_a0_v();
		f_2732_a0_v();
		f_2209_a1_o("quest_d5_03");
		f_2267_a2_b("quest_d5_03", "place_prisoners");
	}
}

void f_23e3_a2_v(object a0, object a1)
{
...
{
	f_223a_a2_b(a0, 0.30000001192092896);
}

void f_23f6_a2_v(object a0, object a1)
{
	@SetVariable("ood5Viktor3", 1);
}

void f_23fc_a2_v(object a0, object a1)
{
	@SetVariable("ood6Viktor1", 1);
}

void f_2402_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d6q01", 1);
	L0 = f_27b6_a0_o();
	L0->AddMark("d6q01ViktorGotoAlexandr", "pt_map_alexandr", 1, 515383, f_2273_a0_f());
	L0->AddMark("d6q01ViktorGotoBigVlad", "pt_map_bigvlad", 1, 515384, f_2273_a0_f());
	L0->AddMark("d6q01ViktorGotoAlxBigSelf", "pt_map_viktor", 1, 515385, f_2273_a0_f());
	f_273f_a0_v();
	f_2759_a0_v();
	f_274c_a0_v();
}

void f_2431_a2_v(object a0, object a1)
{
	@SetVariable("ood8Viktor1", 1);
}

void f_2437_a2_v(object a0, object a1)
{
	@SetVariable("ood9Viktor1", 1);
}

void f_243d_a2_v(object a0, object a1)
{
	@SetVariable("d9q01", 1);
	f_2773_a0_v();
	f_2780_a0_v();
	f_2267_a2_b("quest_d9_01", "place_rifles");
}
...
void f_245a_a2_v(object a0, object a1)
{
	@SetVariable("ood11Viktor2", 1);
}

void f_2460_a2_v(object a0, object a1)
{
	@SetVariable("KnowMyth", 1);
}

void f_2466_a2_v(object a0, object a1)
{
	@SetVariable("d6ViktorVisit", 1);
}

void f_246c_a2_v(object a0, object a1)
{
	@SetVariable("ood9Viktor3", 1);
}

bool f_2472_a1_b(object a0)
{
	if (f_2204_a1_i("d1q02") == 3) {
		return true;
	}
	return false;
}

bool f_247e_a1_b(object a0)
{
	if (f_2204_a1_i("ood1Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_248a_a1_b(object a0)
{
	if (f_2204_a1_i("ood1Viktor2") == 0) {
		return true;
	}
	return false;
}

bool f_2496_a1_b(object a0)
{
	if (f_2204_a1_i("ood1Viktor3") == 0) {
		return true;
	}
	return false;
}

bool f_24a2_a1_b(object a0)
{
	if (f_2204_a1_i("d1q01") == 0) {
		return true;
	}
	return false;
}

bool f_24ae_a1_b(object a0)
{
	if (f_2204_a1_i("d1q01TeloNedostupno") == 1) {
		return true;
	}
	return false;
}

bool f_24ba_a1_b(object a0)
{
	if (f_2204_a1_i("d1q01FirstGeorgVisit") == 1) {
		return true;
	}
	return false;
}

bool f_24c6_a1_b(object a0)
{
	if (f_2204_a1_i("d7q03") == 2) {
		return true;
	}
	return false;
}

bool f_24d2_a1_b(object a0)
{
	if (f_2204_a1_i("d10q02") == 2) {
		return true;
	}
	return false;
}

bool f_24de_a1_b(object a0)
{
	if (f_2204_a1_i("ood11Viktor4") == 0) {
		return true;
	}
	return false;
}

bool f_24ea_a1_b(object a0)
{
	if (f_2204_a1_i("ood3Viktor3") == 0) {
		return true;
	}
	return false;
}

bool f_24f6_a1_b(object a0)
{
	if (f_2204_a1_i("ood4Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_2502_a1_b(object a0)
{
	if (f_2204_a1_i("d4q04") == 0) {
		return true;
	}
	return false;
}

bool f_250e_a1_b(object a0)
{
	if (f_2204_a1_i("d4q04") == 1) {
		return true;
	}
	return false;
}

bool f_251a_a1_b(object a0)
{
	if (f_2233_a2_b(a0, "hunter_mark")) {
		return true;
	}
	return false;
}

bool f_2525_a1_b(object a0)
{
	if (f_2204_a1_i("ood2Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_2531_a1_b(object a0)
{
	if (f_2204_a1_i("KnowRavell") == 1) {
		return true;
	}
	return false;
}

bool f_253d_a1_b(object a0)
{
	if (f_2204_a1_i("d2q03") == 1) {
		return true;
	}
	return false;
}

bool f_2549_a1_b(object a0)
{
	if (f_2204_a1_i("d2q03MariaGotoViktor") == 1) {
		return true;
	}
	return false;
}

bool f_2555_a1_b(object a0)
{
	if (f_2204_a1_i("d1q01") == 1) {
		return true;
	}
	return false;
}

bool f_2561_a1_b(object a0)
{
	if (f_2204_a1_i("d3q02") == 1) {
		return true;
	}
	return false;
}

bool f_256d_a1_b(object a0)
{
	if (f_2204_a1_i("ood3Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_2579_a1_b(object a0)
{
	if (f_2204_a1_i("d3q02") == 2) {
		return true;
	}
	return false;
}

bool f_2585_a1_b(object a0)
{
	if (f_2204_a1_i("ood3Viktor2") == 0) {
		return true;
	}
	return false;
}

bool f_2591_a1_b(object a0)
{
	if (f_2204_a1_i("d5q03") == 0) {
		return true;
	}
...
bool f_259d_a1_b(object a0)
{
	if (f_2204_a1_i("d5q03") == 1000) {
		return true;
	}
	return false;
}

bool f_25a9_a1_b(object a0)
{
	if (f_2204_a1_i("d5q03") == -1) {
		return true;
	}
	return false;
}

bool f_25b5_a1_b(object a0)
{
	if (f_2204_a1_i("d5q03") == 2) {
		return true;
	}
	return false;
}

bool f_25c1_a1_b(object a0)
{
	if (f_2204_a1_i("ood5Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_25cd_a1_b(object a0)
{
	if (f_2204_a1_i("ood5Viktor2") == 0) {
		return true;
	}
	return false;
}

bool f_25d9_a1_b(object a0)
{
	if (f_2204_a1_i("ood5Viktor3") == 0) {
		return true;
	}
	return false;
}

bool f_25e5_a1_b(object a0)
{
	if (f_2204_a1_i("ood6Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_25f1_a1_b(object a0)
{
	if (f_2204_a1_i("ood8Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_25fd_a1_b(object a0)
{
	if (f_2204_a1_i("d8KainIsReason") == 1) {
		return true;
	}
	return false;
}

bool f_2609_a1_b(object a0)
{
	if (f_2204_a1_i("ood9Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_2615_a1_b(object a0)
{
	if (f_2204_a1_i("d9q01") == 2) {
		return true;
	}
	return false;
}

bool f_2621_a1_b(object a0)
{
	if (f_2204_a1_i("ood9Viktor2") == 0) {
		return true;
	}
	return false;
}

bool f_262d_a1_b(object a0)
{
	if (f_2204_a1_i("d9TalkToPolkovodec") != 0) {
		return true;
	}
	return false;
}

bool f_2639_a1_b(object a0)
{
	if (f_2204_a1_i("d11q01") == 1) {
		return true;
	}
	return false;
}

bool f_2645_a1_b(object a0)
{
	if (f_2204_a1_i("ood11Viktor1") == 0) {
		return true;
	}
	return false;
}

bool f_2651_a1_b(object a0)
{
	if (f_2204_a1_i("ood11Viktor2") == 0) {
		return true;
	}
	return false;
}

bool f_265d_a1_b(object a0)
{
	if (f_2204_a1_i("d11q01") >= 4) {
		return true;
	}
	return false;
}

bool f_2669_a1_b(object a0)
{
	if (f_2204_a1_i("d11q01") == 1000) {
		return true;
	}
	return false;
}

bool f_2675_a1_b(object a0)
{
	if (f_2204_a1_i("ood9Viktor3") == 0) {
		return true;
	}
	return false;
}

bool f_2681_a1_b(object a0)
{
	if (f_2204_a1_i("d1q01") != 0 || f_2204_a1_i("d1q01") != 1000 || f_2204_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}

void f_26a3_a0_v(void)
{
	object L0;
...
bool f_279a_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_27c7_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
