...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_e3a_a1_b(f_ee7_a0_o());
		if (!f_de5_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_f9a_a0_i());
		L0->SetNPCDescription(f_f98_a0_i());
		L0->SetPhoto(f_f9c_a0_s());
		L0->SetPhoto2(f_f9e_a0_s());
		L0->SetPlayerName(f_1153_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_103e_a1_b(tv1) && f_104a_a1_b(tv1)) {
...
task t10
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1062_a1_b(tv1) && f_107a_a1_b(tv1) || f_106e_a1_b(tv1) && f_107a_a1_b(tv1)) {
...
task t14
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1026_a1_b(tv1) && f_109e_a1_b(tv1)) {
				f_ff9_a2_v(tv1, tv0);
				f_973_a1_v("Neutral");
...
maintask t17
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_ce8_a0_v();
			if (f_de0_a0_b() && f_cc9_a0_b()) {
				if (f_cb5_a0_b()) {
					f_e74_a1_b(f_ee7_a0_o());
				}
			} else {
				f_cc4_a0_v();
				f_cdf_a0_v();
...
void f_d57_a0_v(void)
{
	...
	L0 = f_f87_a0_i();
	for (L1 = 0; L1 < 5 && f_de0_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_f80_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_d9c_a0_b(void)
{
	return true;
}

void f_d9e_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_da3_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_dab_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_db7_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_dab_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_ef7_a3_f(L0 + a2, a3, a4));
	return true;
}

bool f_dcd_a1_b(Vector a0)
{
	Vector L0;
	Vector L1;
	bool L2;
...
bool f_dd7_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_dcd_a1_b(L0);
}

bool f_de0_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_de5_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_eed_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_e74_a1_b(object a0)
{
	...
	return f_ed1_a1_b(L4);
}

bool f_e99_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_f71_a0_i() + "m";
	int L1;
...
void f_ecb_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_ef7_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_f13_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_f26_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_f33_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_f56_a1_v(a1);
	f_db7_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_f56_a1_v(float a0)
{
	object L0;
...
bool f_f60_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_f7a_a1_b(int a0)
{
	return f_f71_a0_i() == a0;
}

string f_f80_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_f87_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_f80_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_f9c_a0_s(void)
{
	return "ui/NPC_Georg.png";
}

string f_f9e_a0_s(void)
{
	return "ui/NPC_Georg_b.png";
}

bool f_fa0_a0_b(void)
{
	return true;
}

void f_fa2_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("k1q02", 3);
	L0 = f_1121_a0_o();
	L0->AddMark("k1q02GeorgGotoMaria", "pt_map_maria", 0, 524779, f_f6c_a0_f());
	f_10b7_a0_v();
}

void f_fb9_a2_v(object a0, object a1)
{
	@SetVariable("k1q02", 5);
	f_10aa_a0_v();
}

void f_fc2_a2_v(object a0, object a1)
{
	@Trace("beta_pills 5 is given");
	f_f26_a3_v(a0, "beta_pills", 5);
}

void f_fcd_a2_v(object a0, object a1)
{
	@SetVariable("ook3Georg1", 1);
}

void f_fd3_a2_v(object a0, object a1)
{
	@SetVariable("k5q01", 3);
	f_10d1_a0_v();
}

void f_fdc_a2_v(object a0, object a1)
{
...
void f_fe2_a2_v(object a0, object a1)
{
	@SetVariable("k9q01", 2);
	f_10de_a0_v();
	f_f60_a2_b("quest_k9_01", "init_termitnik2");
}
...
void f_ff9_a2_v(object a0, object a1)
{
	@SetVariable("ook1Georg1", 1);
}

void f_fff_a2_v(object a0, object a1)
{
	@SetVariable("k1q02", -1);
	f_10c4_a0_v();
}
...
{
	f_f33_a2_b(a0, -0.30000001192092896);
}

void f_100f_a2_v(object a0, object a1)
{
	f_f33_a2_b(a0, -0.5);
}
...
{
	f_1132_a3_v(f_1121_a0_o(), "pt_map_maria", 2);
	a1->ShowMap(f_1121_a0_o());
}

bool f_1026_a1_b(object a0)
{
	if (f_f02_a1_i("k1q02") == 2) {
		return true;
	}
	return false;
}
...
{
	if (f_f02_a1_i("k10q01") == 1) {
		return true;
	}
	return false;
}

bool f_106e_a1_b(object a0)
{
	if (f_f02_a1_i("k10q01") == 2) {
		return true;
	}
	return false;
}

bool f_107a_a1_b(object a0)
{
	if (f_f02_a1_i("ook10Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_1086_a1_b(object a0)
{
	if (f_f02_a1_i("k9q01") == 1) {
		return true;
	}
	return false;
}

bool f_1092_a1_b(object a0)
{
	if (f_f02_a1_i("k9q01") == 3) {
		return true;
	}
	return false;
}
...
{
	if (f_f02_a1_i("ook1Georg1") == 0) {
		return true;
	}
	return false;
}

void f_10aa_a0_v(void)
{
	object L0;
...
bool f_1105_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1132_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
