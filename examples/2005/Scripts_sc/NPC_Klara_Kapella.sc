...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_c0c_a1_b(f_cb9_a0_o());
		if (!f_bb7_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_d6a_a0_i());
		L0->SetNPCDescription(f_d68_a0_i());
		L0->SetPhoto(f_d6c_a0_s());
		L0->SetPhoto2(f_d6e_a0_s());
		L0->SetPlayerName(f_f4c_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_e29_a1_b(tv1) && f_e4d_a1_b(tv1)) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 42603) {
				...
				tv0->ClearReplies();
				tv0->AddReply(540590, 42616, 42604);
...
task t12
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_e71_a1_b(tv1) && !f_e7d_a1_b(tv1)) {
...
maintask t15
{
	...
	bool f_a80_a0_b(void)
	{
		...
		return f_ba9_a1_b(L0);
	}

	void f_a8f_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_a94_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_ab3_a0_v();
			if (f_bb2_a0_b() && f_a94_a0_b()) {
				if (f_a80_a0_b()) {
					f_c46_a1_b(f_cb9_a0_o());
				}
			} else {
				f_a8f_a0_v();
				f_aaa_a0_v();
...
void f_b22_a0_v(void)
{
	...
	L0 = f_d57_a0_i();
	for (L1 = 0; L1 < 5 && f_bb2_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_d50_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_b67_a0_b(void)
{
	return true;
}

void f_b69_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_b6e_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_b76_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_b82_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_b76_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_cc9_a3_f(L0 + a2, a3, a4));
	return true;
}

void f_b98_a3_v(object a0, string a1, int a2)
{
	int L0;
	a0->GetProperty(a1, L0);
...
bool f_ba9_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_b9f_a1_b(L0);
}

bool f_bb2_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_bb7_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_cbf_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_c46_a1_b(object a0)
{
	...
	return f_ca3_a1_b(L4);
}

bool f_c6b_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_d41_a0_i() + "m";
	int L1;
...
void f_c9d_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_cc9_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_cf0_a2_v(object a0, int a1)
{
	f_b98_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_d03_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_d26_a1_v(a1);
	f_b82_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_d26_a1_v(float a0)
{
	object L0;
...
bool f_d30_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_d4a_a1_b(int a0)
{
	return f_d41_a0_i() == a0;
}

string f_d50_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_d57_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_d50_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_d6c_a0_s(void)
{
	return "ui/NPC_Kapella.png";
}

string f_d6e_a0_s(void)
{
...
void f_d72_a2_v(object a0, object a1)
{
	@Trace("money 4000 is given");
	f_cf0_a2_v(a0, 4000);
}

void f_d7c_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("k3q01KapellaAboutHan", 1);
	L0 = f_f1a_a0_o();
	L0->AddMark("k3q01KapellaGotoAnna", "pt_map_anna", 1, 525456, f_d3c_a0_f());
	f_e89_a0_v();
}

void f_d93_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_f1a_a0_o();
	L0->AddMark("k3q04KapellaGotoDanko", "pt_gmap_dt_house2_08", 0, 529819, f_d3c_a0_f());
	f_e96_a0_v();
	f_ea3_a0_v();
	f_cd9_a1_o("quest_k3_04");
}

void f_dad_a2_v(object a0, object a1)
{
	@SetVariable("k7q01", 8);
	f_ee4_a0_v();
}
...
void f_dbf_a2_v(object a0, object a1)
{
	@SetVariable("ook3Kapella1", 1);
}

void f_dc5_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_dcb_a2_v(object a0, object a1)
{
	@SetVariable("ook5Kapella1", 1);
}

void f_dd1_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("k5q04", 1);
	L0 = f_f1a_a0_o();
	L0->AddMark("k5q04KapellaGotoMaria", "pt_map_maria", 0, 515282, f_d3c_a0_f());
	f_eb0_a0_v();
	f_ebd_a0_v();
}
...
{
	f_eca_a0_v();
	f_d30_a2_b("quest_k5_04", "completed");
}

void f_df5_a2_v(object a0, object a1)
{
	@SetVariable("k5Kapellavisit", 1);
}

void f_dfb_a2_v(object a0, object a1)
{
	f_d03_a2_b(a0, 0.019999999552965164);
}

void f_e02_a2_v(object a0, object a1)
{
	@Trace("money 5000 is given");
	f_cf0_a2_v(a0, 5000);
}

void f_e0c_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "mapmark");
}

void f_e12_a2_v(object a0, object a1)
{
	f_d03_a2_b(a0, 0.10000000149011612);
}

void f_e19_a2_v(object a0, object a1)
{
	f_f2b_a3_v(f_f1a_a0_o(), "pt_map_maria", 2);
	a1->ShowMap(f_f1a_a0_o());
}

bool f_e29_a1_b(object a0)
{
	if (f_cd4_a1_i("k3q01") == 2) {
		return true;
	}
	return false;
}

bool f_e35_a1_b(object a0)
{
	if (f_cd4_a1_i("k7q01") == 7) {
		return true;
	}
	return false;
}
...
{
	if (f_cd4_a1_i("k6q02") == 1) {
		return true;
	}
	return false;
}

bool f_e4d_a1_b(object a0)
{
	if (f_cd4_a1_i("ook3Kapella1") == 0) {
		return true;
	}
	return false;
}

bool f_e59_a1_b(object a0)
{
	if (f_cd4_a1_i("k3q04") == 0) {
		return true;
	}
	return false;
}

bool f_e65_a1_b(object a0)
{
	if (f_cd4_a1_i("ook5Kapella1") == 0) {
		return true;
	}
	return false;
}

bool f_e71_a1_b(object a0)
{
	if (f_cd4_a1_i("k5q04SoborVisit") != 0) {
		return true;
	}
	return false;
}

bool f_e7d_a1_b(object a0)
{
	if (f_cd4_a1_i("k5q04") == 1000) {
		return true;
	}
	return false;
}
...
bool f_efe_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_f2b_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
