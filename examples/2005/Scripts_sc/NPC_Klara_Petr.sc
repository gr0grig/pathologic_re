...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_826_a1_b(f_8d3_a0_o());
		if (!f_7d1_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_94e_a0_i());
		L0->SetNPCDescription(f_94c_a0_i());
		L0->SetPhoto(f_950_a0_s());
		L0->SetPhoto2(f_952_a0_s());
		L0->SetPlayerName(f_a46_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t11
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_6f6_a0_v();
			if (f_7cc_a0_b() && f_6d7_a0_b()) {
				if (f_6c3_a0_b()) {
					f_860_a1_b(f_8d3_a0_o());
				}
			} else {
				f_6d2_a0_v();
				f_6ed_a0_v();
...
void f_765_a0_v(void)
{
	...
	L0 = f_93b_a0_i();
	for (L1 = 0; L1 < 5 && f_7cc_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_934_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_7c3_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_7b9_a1_b(L0);
}

bool f_7cc_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_7d1_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_8d9_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_8b7_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_8f4_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_907_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_914_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_92e_a1_b(int a0)
{
	return f_925_a0_i() == a0;
}

string f_934_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_93b_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_934_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_952_a0_s(void)
{
	return "ui/NPC_Petr_b.png";
}

bool f_954_a0_b(void)
{
	return true;
}

void f_956_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("k5q02", 2);
	L0 = f_a14_a0_o();
	L0->AddMark("k5q02PetrGotoAndrei", "pt_map_andrei", 0, 515295, f_920_a0_f());
	f_9d1_a0_v();
	f_914_a2_b("quest_k5_02", "init_kabak");
}

void f_972_a2_v(object a0, object a1)
{
	@SetVariable("k5q02", 6);
	f_9de_a0_v();
}

void f_97b_a2_v(object a0, object a1)
{
	@Trace("tvirin 5 is given");
	f_907_a3_v(a0, "tvirin", 5);
}
...
void f_992_a2_v(object a0, object a1)
{
	...
	f_907_a3_v(a0, "tvirin", 1);
}

void f_99d_a2_v(object a0, object a1)
{
	f_a25_a3_v(f_a14_a0_o(), "pt_map_andrei", 2);
	a1->ShowMap(f_a14_a0_o());
}

bool f_9ad_a1_b(object a0)
{
	if (f_8e3_a1_i("k5q02") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_8e3_a1_i("ook11Petr1") == 0) {
		return true;
	}
	return false;
}

void f_9d1_a0_v(void)
{
	object L0;
...
bool f_9f8_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_a25_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
