...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_614_a0_i());
		L0->SetNPCDescription(f_612_a0_i());
		L0->SetPhoto(f_616_a0_s());
		L0->SetPhoto2(f_618_a0_s());
		L0->SetPlayerName(f_644_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t4
{
	...
	void f_298_a0_v(void)
	{
		...
		if (L0) {
			int L1;
			@irand(L1, L0);
			@PlayAnimation("all", f_5fa_a1_s(L1));
			@WaitForAnimEnd();
		}
		tv2 = false;
	}
...
task t5
{
	...
	void init(object a0)
	{
		...
		@CreateIntVector(tv7);
		@CreateIntVector(tv9);
		tv0 = f_523_a3_o(a0, 0, tv1);
		tv2 = f_523_a3_o(a0, 1, tv3);
		tv4 = f_523_a3_o(a0, 2, tv5);
		tv6 = f_523_a3_o(a0, 3, tv7);
		tv8 = f_523_a3_o(a0, 4, tv9);
		tv10 = f_53c_a2_o(a0, 0);
		tv11 = f_53c_a2_o(a0, 1);
		tv12 = f_53c_a2_o(a0, 2);
		tv13 = f_53c_a2_o(a0, 3);
		tv14 = f_53c_a2_o(a0, 4);
		f_438_a1_v(a0);
		for (L1 = 1; L1 < 5; L1++) {
		...
		@RemoveActor(L8);
		f_476_a0_v();
		f_550_a5_v(a0, 0, tv0, tv1, tv10);
		f_550_a5_v(a0, 1, tv2, tv3, tv11);
		f_550_a5_v(a0, 2, tv4, tv5, tv12);
		f_550_a5_v(a0, 3, tv6, tv7, tv13);
		f_550_a5_v(a0, 4, tv8, tv9, tv14);
		a0->SelectWeapon();
...
bool f_496_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_582_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_51d_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
object f_523_a3_o(object a0, int a1, object a2)
{
	object L0;
	int L1;
	int L2;
...
object f_53c_a2_o(object a0, int a1)
{
	object L0;
	int L1;
	int L2;
...
void f_550_a5_v(object a0, int a1, object a2, object a3, object a4)
{
...
float f_58c_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
void f_59b_a2_v(string a0, int a1)
{
	int L0;
	@GetVariable(a0, L0);
...
void f_5c6_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_5d9_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
void f_5e6_a3_v(float a0, float a1, float a2)
{
	bool L0;
	float L1;
	L0 = a1 > a0;
...
int f_601_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_5fa_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_618_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_61a_a0_b(void)
{
	return false;
}

void f_61c_a2_v(object a0, object a1)
{
...
bool f_638_a1_b(object a0)
{
	if (f_596_a1_i("ooArenaManager1") == 0) {
		return true;
	}
	return false;
}
