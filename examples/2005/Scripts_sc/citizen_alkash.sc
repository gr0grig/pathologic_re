...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_11d1_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_168a_a0_i());
		L0->SetNPCDescription(f_1688_a0_i());
		L0->SetPhoto(f_168c_a0_s());
		L0->SetPhoto2(f_168e_a0_s());
		L0->SetPlayerName(f_1420_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1330_a1_b(tv1) && f_1354_a1_b(tv1)) {
				tv0->AddReply(536638, -1, 38466);
			}
			if (f_1330_a1_b(tv1) && !f_1354_a1_b(tv1)) {
				tv0->AddReply(536644, -1, 38472);
			}
			if (f_133c_a1_b(tv1) && f_1354_a1_b(tv1)) {
			...
			if (f_135e_a1_b(tv1) && f_1330_a1_b(tv1)) {
...
maintask t4
{
	...
	{
		if (f_16c6_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_15fd_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_a35_a0_v();
				}
	...
	{
		if (f_14f7_a2_b(a0, a1)) {
			f_a35_a0_v();
			f_1517_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_162c_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_a35_a0_v();
				}
		...
		while (!tv0) {
			...
			if (!tv1) {
				for (; ; ) {
					...
					bool L3;
					@GetPosition(L2);
					@GetRandomPFPointInCircle(L1, L2, f_ab1_a0_f(), L3);
					if (L3) {
						break;
					}
					@Sleep(1);
	...
	bool f_acb_a0_b(void)
	{
		return false;
	}

	object f_acd_a1_o(Vector a0)
	{
		object L0;
		...
		for (L1 = 0; L1 < 5 && f_11cc_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_1577_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t6
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_1099_a1_V(tv0);
		if (f_12ee_a2_f(L0, L1) < 0.4999999701976776) {
			f_11c1_a1_v(tv0);
		}
	}
...
task t7
{
	...
	void init(object a0)
	{
		f_cee_a3_v(a0, true, 180.0);
	}

	float f_ce8_a2_f(object a0, int a1)
	{
		return 0.05000000074505806;
	}

	int f_ceb_a2_i(object a0, int a1)
	{
		return 0;
	}

	void f_cee_a3_v(object a0, bool a1, float a2)
	{
		float L0;
		Vector L1;
		Vector L2;
		...
		if (L3) {
			...
			@SendPlayerEnemy(a0, f_12b4_a0_o());
		}
		if (a1) {
			L4 = false;
		} else {
	...
	void f_df6_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_ce8_a2_f(L0, a1);
			L2 = f_10b9_a3_f(L0, L1, f_ceb_a2_i(L0, a1));
			@ReportHit(tv0, f_f75_a0_i(), L2, L1);
			f_f7c_a2_v(L0, L2);
		}
	}

	bool f_e1d_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_f70_a0_v();
	...
	bool f_f08_a0_b(void)
	{
		if (f_eec_a0_b() && f_f18_a0_b()) {
			return true;
		}
		return false;
	}

	bool f_f18_a0_b(void)
	{
		object L0;
		bool L1;
		@GetScene(L0);
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_1099_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	{
		f_128b_a1_v("attack_stay");
	}

	void f_f7c_a2_v(object a0, float a1)
	{
	}
...
task t8
{
	...
	bool f_ff4_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_1087_a0_s(), f_1089_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
...
{
	return f_112b_a1_b(a0);
}

string f_1087_a0_s(void)
{
	return "walk";
}

string f_1089_a0_s(void)
{
	return "run";
}

string f_108b_a1_s(int a0)
{
	if (a0 == 2) {
		return "fire";
	} else {
...
bool f_10ad_a2_b(object a0, string a1)
{
	bool L0;
...
float f_10b9_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_10ad_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_10ad_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_108b_a1_s(a2);
	if (!f_10ad_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_12c4_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_12cb_a3_f(L4 - L5, 0, 1));
	if (f_10a8_a1_b(a0)) {
		f_1304_a1_v(-L5);
	}
	return L5;
...
bool f_1107_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_1102_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_112b_a1_b(object a0)
{
	int L0;
	if (!f_1107_a1_b(a0)) {
		return false;
	}
	if (!f_10ad_a2_b(a0, "noaccess")) {
		return true;
	}
...
void f_116f_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_12ba_a1_V(f_1099_a1_V(a0));
		object L1;
...
void f_11b3_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
bool f_11d1_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_12ba_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1226_a1_b(object a0)
{
	return f_122e_a2_b(a0, 70);
}

bool f_122e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_125d_a1_v(object a0)
{
	@CameraSwitchToNormal();
}

void f_1261_a1_v(string a0)
{
	float L0;
	float L1;
...
void f_1268_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_1280_a3_v(string a0, int a1, int a2)
{
	if (f_12d6_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
	}
}

void f_128b_a1_v(string a0)
{
	bool L0;
...
float f_12c4_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_12cb_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_12d6_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
float f_12db_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_12e4_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_12ee_a2_f(Vector a0, Vector a1)
{
	return f_12db_a2_f(a0, a1) / (f_12e4_a1_f(a0) * f_12e4_a1_f(a1));
}

int f_12ff_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_1320_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_12b4_a0_o(), L0);
}
...
{
	return f_130e_a0_i() <= 6;
}

bool f_13d3_a1_b(object a0)
{
	return f_130e_a0_i() == 1;
}

bool f_13da_a1_b(object a0)
{
	return f_130e_a0_i() == 2;
}

bool f_13e1_a1_b(object a0)
{
	return f_130e_a0_i() == 3;
}

bool f_13e8_a1_b(object a0)
{
	return f_130e_a0_i() == 4;
}

bool f_13ef_a1_b(object a0)
{
	return f_130e_a0_i() == 5;
}
...
{
	return f_130e_a0_i() == 7;
}

bool f_1404_a1_b(object a0)
{
	return f_130e_a0_i() == 8;
}

bool f_140b_a1_b(object a0)
{
	return f_130e_a0_i() == 9;
}

bool f_1412_a1_b(object a0)
{
	return f_130e_a0_i() == 10;
}

bool f_1419_a1_b(object a0)
{
	return f_130e_a0_i() == 11;
}

int f_1420_a0_i(void)
{
	int L0;
...
void f_1444_a2_v(int a0, int a1)
{
	int L0;
	bool L1;
	if (a0 > a1) {
	...
	@AddItem(L1, f_14c5_a1_i("Money"), 0, L0);
}

void f_1463_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_148c_a0_v(void)
{
	bool L0;
	@ClearSubContainer(0);
	f_1444_a2_v(30, 50 + f_130e_a0_i() * 40);
	f_1280_a3_v("tourniquet", 1, 10);
	f_1280_a3_v("bandage", 1, 10);
	f_1280_a3_v("bottle_empty", 1, 2);
	f_1280_a3_v("tvirin", 1, 8);
}

void f_14b4_a0_v(void)
{
	bool L0;
	@ClearSubContainer(0);
	f_1280_a3_v("tourniquet", 1, 4);
	f_1280_a3_v("bandage", 1, 2);
}

int f_14c5_a1_i(string a0)
{
	int L0;
...
void OnHit(object a0, int a1, float a2, float a3)
{
	f_116f_a3_v(a0, a1, a2);
}

void OnHit2(object a0, int a1, float a2, float a3, Vector a4, Vector a5)
{
	f_11b3_a5_v(a0, a1, a2, a4, a5);
}

bool f_14f7_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_1664_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1669_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_167e_a1_b(a0);
			}
		}
	}
	return false;
...
void f_1517_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_1667_a1_v(a0);
	} else {
...
{
	if (f_1664_a1_b(a0) && f_10a8_a1_b(a0)) {
		bool L0;
...
void f_1547_a1_v(object a0)
{
	f_1667_a1_v(a0);
}

void f_154d_a1_v(object a0)
{
	if (f_10a8_a1_b(a0)) {
		@ReportReputationChange(a0, f_12b4_a0_o(), -0.019999999552965164);
	}
}

bool f_155a_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_157e_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1577_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_158f_a1_i(object a0)
{
	return f_16c1_a0_b() ? 2 : 0;
}

void f_1598_a1_v(object a0)
{
	t6{a0};
}

int f_15a0_a1_i(object a0)
{
	return f_112b_a1_b(a0) ? 2 : 0;
}

void f_15aa_a1_v(object a0)
{
	t7{a0};
}

bool f_15b2_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
	if (!f_10ad_a2_b(a0, "class")) {
		return false;
	}
...
int f_15fd_a2_i(object a0, bool a1)
{
	return f_15a0_a1_i(a0);
}

void f_1604_a1_v(object a0)
{
	f_15aa_a1_v(a0);
}

bool f_160a_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_15b2_a2_b(a1, !a3)) {
		return false;
	}
	@CanSee(L0, a0);
	if (L0 || f_10a0_a1_f(a0) <= a2 * a2) {
		return true;
	}
	return false;
}

int f_1627_a1_i(object a0)
{
	return 0;
}
...
int f_162c_a2_i(string a0, object a1)
{
	if (a0 == "killme") {
		return f_1642_a1_i(a1);
	}
	return 0;
}

void f_1638_a2_v(string a0, object a1)
{
	if (a0 == "killme") {
		f_1654_a1_v(a1);
		return;
...
int f_1642_a1_i(object a0)
{
	if (!f_112b_a1_b(a0)) {
		return 0;
	}
	return f_16c3_a1_b(a0) ? 2 : 0;
}

void f_1654_a1_v(object a0)
{
	f_15aa_a1_v(a0);
}

int f_165a_a1_i(object a0)
{
	return 2;
}

void f_165d_a1_v(object a0)
{
	f_1699_a1_v(a0);
}
...
bool f_1664_a1_b(object a0)
{
	return false;
}

void f_1667_a1_v(object a0)
{
}
...
bool f_1669_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
	return L0 || f_10a0_a1_f(a0) <= 2250000;
}
...
bool f_167e_a1_b(object a0)
{
	return false;
}

void f_1681_a1_v(object a0)
{
}
...
int f_1688_a0_i(void)
{
	return 515557;
}

int f_168a_a0_i(void)
{
	return 503342;
}

string f_168c_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_168e_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_1690_a0_b(void)
{
	return false;
}

void f_1692_a0_v(void)
{
	g0 = false;
	f_14b4_a0_v();
}

void f_1699_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_16c6_a3_b(object a0, object a1, bool a2)
{
	return f_160a_a4_b(a0, a1, 700.0, a2);
}

void f_16d0_a1_v(object a0)
{
	if (f_10a8_a1_b(a0)) {
		@ReportReputationChange(a0, f_12b4_a0_o(), -0.029999999329447746, true);
		f_148c_a0_v();
	}
	f_1474_a0_v();
	g0 = true;
