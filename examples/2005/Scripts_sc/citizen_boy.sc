...
{
	if (a1 == "unholster") {
		return f_1645_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_164a_a1_b(a0);
		} else {
			if (a1 == "battle") {
...
{
	if (f_1645_a1_b(a0) && f_10a7_a1_b(a0)) {
		bool L0;
...
int f_1636_a2_i(string a0, object a1)
{
	return 0;
}

void f_1639_a2_v(string a0, object a1)
{
}
...
void f_163e_a1_v(object a0)
{
	f_167b_a1_v(a0);
}

void f_1644_a0_v(void)
{
}
...
void f_1648_a1_v(object a0)
{
}

bool f_164a_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
...
void f_1673_a0_v(void)
{
	g0 = false;
	f_146b_a1_v(true);
}

void f_167b_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_16a3_a0_b(void)
{
	return false;
}

bool f_16a5_a3_b(object a0, object a1, bool a2)
{
	return f_1614_a4_b(a0, a1, 700.0, a2);
}

void f_16af_a1_v(object a0)
{
	if (f_10a7_a1_b(a0)) {
