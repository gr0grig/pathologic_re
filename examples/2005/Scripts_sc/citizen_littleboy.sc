...
maintask t1
{
	...
	{
		if (f_1530_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_12d4_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_fb_a0_v();
				}
	...
	{
		if (f_1219_a2_b(a0, a1)) {
			f_fb_a0_v();
			f_1239_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_132d_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_fb_a0_v();
				}
		...
		for (L1 = 0; L1 < 5 && f_10ec_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_1299_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t3
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_1080_a1_V(tv0);
		if (f_11ea_a2_f(L0, L1) < 0.4999999701976776) {
			f_10e1_a1_v(tv0);
		}
	}
...
task t4
{
	...
	Vector f_3c9_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_11c0_a1_V(f_11c0_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_474_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_1080_a1_V(tv0);
		return f_11cf_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
task t8
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_10f1_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_14f2_a0_i());
		L0->SetNPCDescription(f_14f0_a0_i());
		L0->SetPhoto(f_14f4_a0_s());
		L0->SetPhoto2(f_14f6_a0_s());
		L0->SetPlayerName(f_1472_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1377_a1_b(tv1) && f_1383_a1_b(tv1) && f_13f1_a1_b(tv1)) {
				tv0->AddReply(537508, 39356, 39355);
			}
			if (f_1377_a1_b(tv1) && f_1383_a1_b(tv1) && f_13fb_a1_b(tv1)) {
				tv0->AddReply(537524, 39372, 39371);
			}
			if (f_1377_a1_b(tv1) && f_138d_a1_b(tv1)) {
				tv0->AddReply(537534, 39382, 39381);
			}
			if (f_1377_a1_b(tv1) && f_1397_a1_b(tv1)) {
				tv0->AddReply(537549, 39397, 39396);
			}
			if (f_1377_a1_b(tv1) && f_13a1_a1_b(tv1)) {
				tv0->AddReply(537559, 39407, 39406);
			}
			if (f_1377_a1_b(tv1) && f_13ab_a1_b(tv1)) {
				tv0->AddReply(537571, 39419, 39418);
			}
			if (f_1377_a1_b(tv1) && f_13b5_a1_b(tv1)) {
				tv0->AddReply(537593, 39442, 39441);
			}
			if (f_1377_a1_b(tv1) && f_13bf_a1_b(tv1)) {
				tv0->AddReply(537603, 39452, 39451);
			}
			if (f_1377_a1_b(tv1) && f_13c9_a1_b(tv1)) {
				tv0->AddReply(537621, 39470, 39469);
			}
			if (f_1377_a1_b(tv1) && f_13d3_a1_b(tv1)) {
				tv0->AddReply(537633, 39482, 39481);
			}
			if (f_1377_a1_b(tv1) && f_13dd_a1_b(tv1)) {
				tv0->AddReply(537640, 39489, 39488);
			}
			if (f_1377_a1_b(tv1) && f_13e7_a1_b(tv1)) {
				tv0->AddReply(537647, 39496, 39495);
			}
			if (f_1377_a1_b(tv1) && f_13fb_a1_b(tv1) && f_1383_a1_b(tv1)) {
				tv0->AddReply(537659, 39508, 39507);
			}
			if (f_1377_a1_b(tv1) && f_1383_a1_b(tv1)) {
...
bool f_1094_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_10a5_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_10a0_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_10c9_a1_b(object a0)
{
	int L0;
	if (!f_10a5_a1_b(a0)) {
		return false;
	}
	if (!f_1094_a2_b(a0, "noaccess")) {
		return true;
	}
...
bool f_10f1_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_11c0_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1146_a1_b(object a0)
{
	return f_114e_a2_b(a0, 70);
}

bool f_114e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_1188_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_11a0_a3_v(string a0, int a1, int a2)
{
	if (f_11ca_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
	}
}

void f_11ab_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_11ca_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
bool f_11ca_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
float f_11cf_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

float f_11d7_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_11e0_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_11ea_a2_f(Vector a0, Vector a1)
{
	return f_11d7_a2_f(a0, a1) / (f_11e0_a1_f(a0) * f_11e0_a1_f(a1));
}

int f_11fb_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
bool f_1219_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_133c_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1349_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_1360_a1_b(a0);
			}
		}
	}
	return false;
...
void f_1239_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_1341_a1_v(a0);
	} else {
...
{
	if (f_133c_a1_b(a0) && f_108f_a1_b(a0)) {
		bool L0;
...
void f_1269_a1_v(object a0)
{
	f_1341_a1_v(a0);
}

void f_126f_a1_v(object a0)
{
	if (f_108f_a1_b(a0)) {
		@ReportReputationChange(a0, f_11ba_a0_o(), -0.029999999329447746);
	}
}

bool f_127c_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_136d_a1_b(L0);
	}
	return false;
}

void f_128c_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_12a0_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1299_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_12b1_a1_i(object a0)
{
	return f_152a_a0_b() ? 2 : 0;
}

void f_12ba_a1_v(object a0)
{
	t3{a0};
}

int f_12c2_a1_i(object a0)
{
	return f_10c9_a1_b(a0) ? 2 : 0;
}

void f_12cc_a1_v(object a0)
{
	t4{a0};
}

int f_12d4_a2_i(object a0, bool a1)
{
	return f_10c9_a1_b(a0) ? 2 : 0;
}

void f_12de_a1_v(object a0)
{
	t5{a0};
}

bool f_12e6_a3_b(object a0, object a1, float a2)
{
	string L0;
	bool L1;
	if (!f_1094_a2_b(a1, "class")) {
		return false;
	}
	...
	@CanSee(L1, a0);
	if (L1 || f_1087_a1_f(a0) <= a2 * a2) {
		return true;
	}
	@CanSee(L1, a1);
	if (L1 || f_1087_a1_f(a1) <= a2 * a2) {
		return true;
	}
	return false;
}

int f_1328_a1_i(object a0)
{
	return 0;
}

void f_132b_a1_v(object a0)
{
}

int f_132d_a2_i(string a0, object a1)
{
	return 0;
}

void f_1330_a2_v(string a0, object a1)
{
}

int f_1332_a1_i(object a0)
{
	return 2;
}
...
bool f_1349_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
	return L0 || f_1087_a1_f(a0) <= 4000000;
}
...
{
	return f_1200_a0_i() == 1;
}

bool f_140c_a1_b(object a0)
{
	return f_1200_a0_i() == 2;
}

bool f_1413_a1_b(object a0)
{
	return f_1200_a0_i() == 3;
}

bool f_141a_a1_b(object a0)
{
	return f_1200_a0_i() == 4;
}

bool f_1421_a1_b(object a0)
{
	return f_1200_a0_i() == 5;
}

bool f_1428_a1_b(object a0)
{
	return f_1200_a0_i() == 6;
}

bool f_142f_a1_b(object a0)
{
	return f_1200_a0_i() == 7;
}

bool f_1436_a1_b(object a0)
{
	return f_1200_a0_i() == 8;
}

bool f_143d_a1_b(object a0)
{
	return f_1200_a0_i() == 9;
}

bool f_1444_a1_b(object a0)
{
	return f_1200_a0_i() == 10;
}

bool f_144b_a1_b(object a0)
{
	return f_1200_a0_i() == 11;
}

bool f_1452_a1_b(object a0)
{
	if (f_1209_a0_i() >= 0 && f_1209_a0_i() < 12) {
		return true;
	}
	return false;
}
...
void f_14a4_a1_v(bool a0)
{
	@ClearSubContainer(0);
	if (a0) {
		f_11ab_a4_v("rifle_ammo", 1, 2, 2);
		f_11ab_a4_v("revolver_ammo", 1, 2, 2);
		f_11ab_a4_v("samopal_ammo", 2, 2, 2);
	} else {
		int L0;
		f_11a0_a3_v("lockpick", 1, 4);
		f_11ab_a4_v("alpha_pills", 1, 2, 3);
		f_11a0_a3_v("meradorm", 1, 2);
		f_11a0_a3_v("powder", 1, 15);
		L0 = f_1200_a0_i();
		if (L0 >= 4) {
			f_11a0_a3_v("beta_pills", 1, 2);
		}
		if (L0 >= 6) {
			f_11a0_a3_v("gamma_pills", 1, 7);
		}
	}
}

int f_14f0_a0_i(void)
{
	return 515560;
}

int f_14f2_a0_i(void)
{
	return 503345;
}

string f_14f4_a0_s(void)
{
	return "ui/NPC_Citizen3.png";
}

string f_14f6_a0_s(void)
{
	return "ui/NPC_Citizen3_b.png";
}

bool f_14f8_a0_b(void)
{
	return false;
}

void f_14fa_a0_v(void)
{
	g0 = false;
	f_14a4_a1_v(true);
}
...
bool f_152a_a0_b(void)
{
	return f_1489_a0_f() > 0.4000000059604645;
}

bool f_1530_a3_b(object a0, object a1, bool a2)
{
	return f_12e6_a3_b(a0, a1, 700.0);
}
