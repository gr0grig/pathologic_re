...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1001_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_14a6_a0_i());
		L0->SetNPCDescription(f_14a4_a0_i());
		L0->SetPhoto(f_14a8_a0_s());
		L0->SetPhoto2(f_14aa_a0_s());
		L0->SetPlayerName(f_11c6_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_115f_a1_b(tv1) && f_1153_a1_b(tv1)) {
			...
			if (f_115f_a1_b(tv1) && f_1187_a1_b(tv1) && f_1153_a1_b(tv1)) {
				tv0->AddReply(538017, 39883, 39882);
			}
			if (f_1169_a1_b(tv1) && f_117d_a1_b(tv1) && f_1153_a1_b(tv1)) {
				tv0->AddReply(538043, 39911, 39910);
			}
			if (f_1173_a1_b(tv1) && f_117d_a1_b(tv1) && f_1153_a1_b(tv1)) {
				tv0->AddReply(538083, 39952, 39951);
			}
			if (f_1173_a1_b(tv1) && f_1187_a1_b(tv1) && f_1153_a1_b(tv1)) {
...
maintask t4
{
	...
	{
		if (f_14df_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_1419_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_865_a0_v();
				}
	...
	{
		if (f_1313_a2_b(a0, a1)) {
			f_865_a0_v();
			f_1333_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_1448_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_865_a0_v();
				}
		...
		for (L1 = 0; L1 < 5 && f_ffc_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_1393_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t6
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_ec9_a1_V(tv0);
		if (f_110e_a2_f(L0, L1) < 0.4999999701976776) {
			f_ff1_a1_v(tv0);
		}
	}
...
task t7
{
	...
	void init(object a0)
	{
		f_b1e_a3_v(a0, true, 180.0);
	}

	float f_b18_a2_f(object a0, int a1)
	{
		return 0.05000000074505806;
	}

	int f_b1b_a2_i(object a0, int a1)
	{
		return 0;
	}

	void f_b1e_a3_v(object a0, bool a1, float a2)
	{
		float L0;
		Vector L1;
		Vector L2;
		...
		if (L3) {
			...
			@SendPlayerEnemy(a0, f_10d9_a0_o());
		}
		if (a1) {
			L4 = false;
		} else {
	...
	void f_c26_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_b18_a2_f(L0, a1);
			L2 = f_ee9_a3_f(L0, L1, f_b1b_a2_i(L0, a1));
			@ReportHit(tv0, f_da5_a0_i(), L2, L1);
			f_dac_a2_v(L0, L2);
		}
	}

	bool f_c4d_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_da0_a0_v();
	...
	{
		if (f_d1c_a0_b() && f_d48_a0_b()) {
			return true;
		}
		return false;
	}

	bool f_d48_a0_b(void)
	{
		object L0;
		bool L1;
		@GetScene(L0);
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_ec9_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	void f_da7_a0_v(void)
	{
		f_10b0_a1_v("attack_stay");
	}

	void f_dac_a2_v(object a0, float a1)
	{
	}

	bool f_dae_a0_b(void)
	{
		return true;
	}
...
task t8
{
	...
	bool f_e24_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_eb7_a0_s(), f_eb9_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
...
string f_eb9_a0_s(void)
{
	return "run";
}

string f_ebb_a1_s(int a0)
{
	if (a0 == 2) {
		return "fire";
	} else {
...
bool f_edd_a2_b(object a0, string a1)
{
	bool L0;
...
float f_ee9_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_edd_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_edd_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_ebb_a1_s(a2);
	if (!f_edd_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_10e9_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_10f0_a3_f(L4 - L5, 0, 1));
	if (f_ed8_a1_b(a0)) {
		f_1124_a1_v(-L5);
	}
	return L5;
...
bool f_f37_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_f32_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_f9f_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_10df_a1_V(f_ec9_a1_V(a0));
		object L1;
...
void f_fe3_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
bool f_1001_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_10df_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1056_a1_b(object a0)
{
	return f_105e_a2_b(a0, 70);
}

bool f_105e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_108d_a1_v(object a0)
{
	@CameraSwitchToNormal();
}

void f_1091_a1_v(string a0)
{
	float L0;
	float L1;
...
void f_1098_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_10e9_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_10f0_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_10fb_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_1104_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_110e_a2_f(Vector a0, Vector a1)
{
	return f_10fb_a2_f(a0, a1) / (f_1104_a1_f(a0) * f_1104_a1_f(a1));
}

int f_111f_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_1148_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_10d9_a0_o(), L0);
}

bool f_1153_a1_b(object a0)
{
	if (f_111f_a1_i("branch") == 0) {
		return true;
	}
	return false;
}

bool f_115f_a1_b(object a0)
{
	if (f_1191_a1_b(a0)) {
		return true;
	}
...
bool f_1191_a1_b(object a0)
{
	return f_112e_a0_i() == 1;
}

bool f_1198_a1_b(object a0)
{
	return f_112e_a0_i() == 2;
}

bool f_119f_a1_b(object a0)
{
	return f_112e_a0_i() == 5;
}

bool f_11a6_a1_b(object a0)
{
	if (f_1137_a0_i() >= 0 && f_1137_a0_i() < 12) {
		return true;
	}
	return false;
}

bool f_11bb_a1_b(object a0)
{
	if (f_1137_a0_i() >= 12) {
		return true;
	}
...
void f_11ea_a2_v(int a0, int a1)
{
	int L0;
	bool L1;
	if (a0 > a1) {
	...
	@AddItem(L1, f_12e1_a1_i("Money"), 0, L0);
}

void f_1209_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_1232_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_11ea_a2_v(0, 100 + f_112e_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_12e1_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_12e1_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_12e1_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_12e1_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_12e1_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_12e1_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_11ea_a2_v(0, 50 + f_112e_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_12e1_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_12e1_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_12e1_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_12e1_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_12e1_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_12e1_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
{
	f_fe3_a5_v(a0, a1, a2, a4, a5);
}

bool f_1313_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_1480_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1485_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_149a_a1_b(a0);
			}
		}
	}
	return false;
...
void f_1333_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_1483_a1_v(a0);
	} else {
...
{
	if (f_1480_a1_b(a0) && f_ed8_a1_b(a0)) {
		bool L0;
...
{
	if (f_ed8_a1_b(a0)) {
		@ReportReputationChange(a0, f_10d9_a0_o(), -0.029999999329447746);
	}
}

bool f_1376_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_149f_a1_b(L0);
	}
	return false;
}

void f_1386_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_139a_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1393_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_13ab_a1_i(object a0)
{
	return f_14da_a0_b() ? 2 : 0;
}

void f_13b4_a1_v(object a0)
{
	t6{a0};
}

int f_13bc_a1_i(object a0)
{
	return f_f5b_a1_b(a0) ? 2 : 0;
}

void f_13c6_a1_v(object a0)
{
	t7{a0};
}

bool f_13ce_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
	if (!f_edd_a2_b(a0, "class")) {
		return false;
	}
...
int f_1419_a2_i(object a0, bool a1)
{
	return f_13bc_a1_i(a0);
}

void f_1420_a1_v(object a0)
{
	f_13c6_a1_v(a0);
}

bool f_1426_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_13ce_a2_b(a1, !a3)) {
		return false;
	}
	@CanSee(L0, a0);
	if (L0 || f_ed0_a1_f(a0) <= a2 * a2) {
		return true;
	}
	return false;
}

int f_1443_a1_i(object a0)
{
	return 0;
}

void f_1446_a1_v(object a0)
{
}

int f_1448_a2_i(string a0, object a1)
{
	if (a0 == "killme") {
		return f_145e_a1_i(a1);
	}
	return 0;
}

void f_1454_a2_v(string a0, object a1)
{
	if (a0 == "killme") {
		f_1470_a1_v(a1);
		return;
...
int f_145e_a1_i(object a0)
{
	if (!f_f5b_a1_b(a0)) {
		return 0;
	}
	return f_14dc_a1_b(a0) ? 2 : 0;
}
...
int f_1476_a1_i(object a0)
{
	return 2;
}

void f_1479_a1_v(object a0)
{
	f_14b2_a1_v(a0);
}
...
bool f_1480_a1_b(object a0)
{
	return false;
}

void f_1483_a1_v(object a0)
{
}

bool f_1485_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
	return L0 || f_ed0_a1_f(a0) <= 2250000;
}

void f_1494_a1_v(object a0)
{
	f_13b4_a1_v(a0);
}
...
void f_14a2_a1_v(object a0)
{
}

int f_14a4_a0_i(void)
{
	return 515564;
}

int f_14a6_a0_i(void)
{
	return 503349;
}

string f_14a8_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_14aa_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_14ac_a0_b(void)
{
	return false;
}

void f_14ae_a0_v(void)
{
	g0 = false;
}

void f_14b2_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_14df_a3_b(object a0, object a1, bool a2)
{
	return f_1426_a4_b(a0, a1, 700.0, a2);
}

void f_14e9_a1_v(object a0)
{
	if (f_ed8_a1_b(a0)) {
		@ReportReputationChange(a0, f_10d9_a0_o(), -0.07000000029802322, true);
		f_1232_a1_v(true);
	}
	f_121a_a0_v();
	g0 = true;
