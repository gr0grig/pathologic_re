...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1139_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_16fd_a0_i());
		L0->SetNPCDescription(f_16fb_a0_i());
		L0->SetPhoto(f_16ff_a0_s());
		L0->SetPhoto2(f_1701_a0_s());
		L0->SetPlayerName(f_132e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t3
{
	...
	{
		if (f_1720_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_15c6_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_99d_a0_v();
				}
	...
	{
		if (f_14c0_a2_b(a0, a1)) {
			f_99d_a0_v();
			f_14e0_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_15f5_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_99d_a0_v();
				}
		...
		for (L1 = 0; L1 < 5 && f_1134_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_1540_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t5
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_1001_a1_V(tv0);
		if (f_1211_a2_f(L0, L1) < 0.4999999701976776) {
			f_1129_a1_v(tv0);
		}
	}
...
task t6
{
	...
	void init(object a0)
	{
		f_c56_a3_v(a0, true, 180.0);
	}

	float f_c50_a2_f(object a0, int a1)
	{
		return 0.05000000074505806;
	}

	int f_c53_a2_i(object a0, int a1)
	{
		return 0;
	}

	void f_c56_a3_v(object a0, bool a1, float a2)
	{
		float L0;
		Vector L1;
		Vector L2;
		...
		if (L3) {
			...
			@SendPlayerEnemy(a0, f_11d6_a0_o());
		}
		if (a1) {
			L4 = false;
		} else {
	...
	void f_d5e_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_c50_a2_f(L0, a1);
			L2 = f_1021_a3_f(L0, L1, f_c53_a2_i(L0, a1));
			@ReportHit(tv0, f_edd_a0_i(), L2, L1);
			f_ee4_a2_v(L0, L2);
		}
	}

	bool f_d85_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_ed8_a0_v();
	...
	bool f_e70_a0_b(void)
	{
		if (f_e54_a0_b() && f_e80_a0_b()) {
			return true;
		}
		return false;
	}

	bool f_e80_a0_b(void)
	{
		object L0;
		bool L1;
		@GetScene(L0);
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_1001_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	void f_edf_a0_v(void)
	{
		f_11ad_a1_v("attack_stay");
	}

	void f_ee4_a2_v(object a0, float a1)
	{
	}

	bool f_ee6_a0_b(void)
	{
		return true;
	}
...
task t7
{
	...
	bool f_f5c_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_fef_a0_s(), f_ff1_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
...
{
	return f_1093_a1_b(a0);
}

string f_fef_a0_s(void)
{
	return "walk";
}

string f_ff1_a0_s(void)
{
	return "run";
}

string f_ff3_a1_s(int a0)
{
	if (a0 == 2) {
		return "fire";
	} else {
...
bool f_1015_a2_b(object a0, string a1)
{
	bool L0;
...
float f_1021_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_1015_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_1015_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_ff3_a1_s(a2);
	if (!f_1015_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_11e6_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_11ed_a3_f(L4 - L5, 0, 1));
	if (f_1010_a1_b(a0)) {
		f_1227_a1_v(-L5);
	}
	return L5;
...
bool f_106f_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_106a_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_10d7_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_11dc_a1_V(f_1001_a1_V(a0));
		object L1;
...
void f_111b_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
bool f_1139_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_11dc_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_1195_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_11e6_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_11ed_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_11fe_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_1207_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_1211_a2_f(Vector a0, Vector a1)
{
	return f_11fe_a2_f(a0, a1) / (f_1207_a1_f(a0) * f_1207_a1_f(a1));
}

int f_1222_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_1243_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_11d6_a0_o(), L0);
}

void f_124e_a2_v(object a0, object a1)
{
	a1->SetReturnValue(100);
}

bool f_1253_a1_b(object a0)
{
	if (f_1222_a1_i("branch") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1222_a1_i("branch") == 1) {
		return true;
	}
	return false;
}

bool f_126b_a1_b(object a0)
{
	if (f_1222_a1_i("branch") == 2) {
		return true;
	}
	return false;
}

bool f_1277_a1_b(object a0)
{
	if (f_12e5_a1_b(a0)) {
		return true;
	}
...
{
	return f_1231_a0_i() == 1;
}

bool f_12ef_a1_b(object a0)
{
	return f_1231_a0_i() == 2;
}

bool f_12f6_a1_b(object a0)
{
	return f_1231_a0_i() == 3;
}

bool f_12fd_a1_b(object a0)
{
	return f_1231_a0_i() == 5;
}

bool f_1304_a1_b(object a0)
{
	return f_1231_a0_i() == 6;
}

bool f_130b_a1_b(object a0)
{
	return f_1231_a0_i() == 7;
}

bool f_1312_a1_b(object a0)
{
	return f_1231_a0_i() == 8;
}

bool f_1319_a1_b(object a0)
{
	return f_1231_a0_i() == 9;
}

bool f_1320_a1_b(object a0)
{
	return f_1231_a0_i() == 10;
}

bool f_1327_a1_b(object a0)
{
	return f_1231_a0_i() == 11;
}

int f_132e_a0_i(void)
{
	int L0;
...
int f_134a_a2_i(object a0, int a1)
{
	if (a1 == 0) {
		int L0;
		L0 = f_1231_a0_i();
		...
		for (; L2 <= L0; L2++) {
			...
			@HasInvItemProperty(L4, f_1345_a1_i(a0), L3);
			if (!L4) {
				continue;
			}
			@GetInvItemProperty(L1, f_1345_a1_i(a0), L3);
		}
		return L1;
	}
	bool L5;
	@HasInvItemProperty(L5, f_1345_a1_i(a0), "BarterPrice" + a1);
	if (!L5) {
		return 0;
	}
	int L6;
	@GetInvItemProperty(L6, f_1345_a1_i(a0), "BarterPrice" + a1);
	if (L6 > 0) {
		return L6;
	}
	return -L6;
...
void f_1397_a2_v(int a0, int a1)
{
	int L0;
	bool L1;
	if (a0 > a1) {
	...
	@AddItem(L1, f_148e_a1_i("Money"), 0, L0);
}

void f_13b6_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_13df_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_1397_a2_v(0, 100 + f_1231_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_148e_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_148e_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_148e_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_148e_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_148e_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_148e_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_1397_a2_v(0, 50 + f_1231_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_148e_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_148e_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_148e_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_148e_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_148e_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_148e_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
void OnHit(object a0, int a1, float a2, float a3)
{
	f_10d7_a3_v(a0, a1, a2);
}

void OnHit2(object a0, int a1, float a2, float a3, Vector a4, Vector a5)
{
	f_111b_a5_v(a0, a1, a2, a4, a5);
}

bool f_14c0_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_162d_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1632_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_1647_a1_b(a0);
			}
		}
	}
	return false;
...
void f_14e0_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_1630_a1_v(a0);
	} else {
...
bool f_14f9_a1_b(object a0)
{
	if (f_162d_a1_b(a0) && f_1010_a1_b(a0)) {
		bool L0;
...
void f_1510_a1_v(object a0)
{
	f_1630_a1_v(a0);
}

void f_1516_a1_v(object a0)
{
	if (f_1010_a1_b(a0)) {
		@ReportReputationChange(a0, f_11d6_a0_o(), -0.029999999329447746);
	}
}

bool f_1523_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_164c_a1_b(L0);
	}
	return false;
}

void f_1533_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_1547_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1540_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1558_a1_i(object a0)
{
	return f_171b_a0_b() ? 2 : 0;
}

void f_1561_a1_v(object a0)
{
	t5{a0};
}

int f_1569_a1_i(object a0)
{
	return f_1093_a1_b(a0) ? 2 : 0;
}

void f_1573_a1_v(object a0)
{
	t6{a0};
}

bool f_157b_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
	if (!f_1015_a2_b(a0, "class")) {
		return false;
	}
...
int f_15c6_a2_i(object a0, bool a1)
{
	return f_1569_a1_i(a0);
}
...
bool f_15d3_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_157b_a2_b(a1, !a3)) {
		return false;
	}
	@CanSee(L0, a0);
	if (L0 || f_1008_a1_f(a0) <= a2 * a2) {
		return true;
	}
	return false;
}

int f_15f0_a1_i(object a0)
{
	return 0;
}

void f_15f3_a1_v(object a0)
{
}

int f_15f5_a2_i(string a0, object a1)
{
	if (a0 == "killme") {
		return f_160b_a1_i(a1);
	}
	return 0;
}

void f_1601_a2_v(string a0, object a1)
{
	if (a0 == "killme") {
		f_161d_a1_v(a1);
		return;
...
int f_160b_a1_i(object a0)
{
	if (!f_1093_a1_b(a0)) {
		return 0;
	}
	return f_171d_a1_b(a0) ? 2 : 0;
}

void f_161d_a1_v(object a0)
{
	f_1573_a1_v(a0);
}

int f_1623_a1_i(object a0)
{
	return 2;
}

void f_1626_a1_v(object a0)
{
	f_1709_a1_v(a0);
}

void f_162c_a0_v(void)
{
}
...
bool f_1632_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
	return L0 || f_1008_a1_f(a0) <= 2250000;
}
...
bool f_164c_a1_b(object a0)
{
	return false;
}

void f_164f_a1_v(object a0)
{
}

void f_1651_a1_v(object a0)
{
	object L0;
	L0 = f_11f8_a0_o();
	object L1;
		...
		for (L7 = 0; L7 < L6; L7++) {
			...
			if (L10) {
				...
				if (L10) {
					...
					if (L11 < 100 && f_16e4_a1_b(L8)) {
						float L12;
						int L13;
						L0->add(L8);
						L1->add(L5);
						L2->add(L7);
						L12 = f_134a_a2_i(L8, 0);
...
int f_16fb_a0_i(void)
{
	return 515568;
}

int f_16fd_a0_i(void)
{
	return 503353;
}

string f_16ff_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_1701_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_1703_a0_b(void)
{
	return false;
}

void f_1705_a0_v(void)
{
	g0 = false;
}

void f_1709_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_1720_a3_b(object a0, object a1, bool a2)
{
	return f_15d3_a4_b(a0, a1, 700.0, a2);
}

void f_172a_a1_v(object a0)
{
	if (f_1010_a1_b(a0)) {
		@ReportReputationChange(a0, f_11d6_a0_o(), -0.07000000029802322, true);
		f_13df_a1_v(true);
	}
	f_13c7_a0_v();
	g0 = true;
