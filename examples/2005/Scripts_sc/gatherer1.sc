...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_529_a2_b(a0, 110.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_71e_a0_i());
		L0->SetNPCDescription(f_71c_a0_i());
		L0->SetPhoto(f_720_a0_s());
		L0->SetPhoto2(f_722_a0_s());
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_64b_a1_b(tv1) && f_657_a1_b(tv1)) {
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_67a_a1_b(tv1) && !f_66f_a1_b(tv1)) {
				f_2a1_a1_v("Neutral");
			...
			if (f_66f_a1_b(tv1) && !f_67a_a1_b(tv1)) {
				f_2a1_a1_v("Neutral");
...
maintask t5
{
	...
	void f_477_a2_v(float a0, float a1)
	{
		if (!f_524_a0_b()) {
			return;
		}
...
void f_4c6_a0_v(void)
{
	...
	L0 = f_601_a0_i();
	for (L1 = 0; L1 < 5 && f_524_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_5fa_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_529_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_5d6_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_57e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
bool f_5e5_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
void f_612_a2_v(object a0, object a1)
{
	int L0;
	int L1;
	L0 = f_5f1_a0_i();
...
void f_621_a2_v(object a0, object a1)
{
...
void f_627_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_6c6_a0_o();
	L0->AddMark("k2q04MorlokGotoAndrei", "pt_map_andrei", 0, 539378, f_5ec_a0_f());
	f_690_a0_v();
}
...
void f_640_a2_v(object a0, object a1)
{
...
{
	if (f_5e0_a1_i("oobSysGatherer1_1") == 0) {
		return true;
	}
	return false;
}
...
bool f_6aa_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_6d7_a0_v(void)
{
	...
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_700_a1_i("grass_black_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_700_a1_i("grass_blood_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_700_a1_i("grass_brown_tvir"), 0, L1);
}

int f_700_a1_i(string a0)
{
	int L0;
...
string f_720_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_722_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_724_a0_b(void)
{
	return false;
}
