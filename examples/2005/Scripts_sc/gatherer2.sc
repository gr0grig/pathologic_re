...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_5bc_a0_i());
		L0->SetNPCDescription(f_5ba_a0_i());
		L0->SetPhoto(f_5be_a0_s());
		L0->SetPhoto2(f_5c0_a0_s());
		L0->SetPlayerName(f_5a3_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
void f_3e1_a0_v(void)
{
	...
	L0 = f_517_a0_i();
	for (L1 = 0; L1 < 5 && f_43f_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
...
void f_575_a0_v(void)
{
	...
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_59e_a1_i("grass_black_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_59e_a1_i("grass_blood_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_59e_a1_i("grass_brown_tvir"), 0, L1);
}

int f_59e_a1_i(string a0)
{
	int L0;
...
string f_5c0_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_5c2_a0_b(void)
{
	return false;
}
