...
task t8
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_161d_a0_i());
		L0->SetNPCDescription(f_161b_a0_i());
		L0->SetPhoto(f_161f_a0_s());
		L0->SetPhoto2(f_1621_a0_s());
		L0->SetPlayerName(f_1593_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_1487_a1_b(tv1) && f_1493_a1_b(tv1)) {
				tv0->AddReply(537242, 39086, 39085);
			}
			if (f_1487_a1_b(tv1) && f_1493_a1_b(tv1)) {
				tv0->AddReply(537277, 39122, 39121);
			}
			if (f_1487_a1_b(tv1) && f_149d_a1_b(tv1)) {
				tv0->AddReply(537329, 39176, 39175);
			}
			if (f_1487_a1_b(tv1) && f_14a7_a1_b(tv1) && f_150b_a1_b(tv1)) {
				tv0->AddReply(537352, 39199, 39198);
			}
			if (f_1487_a1_b(tv1) && f_14a7_a1_b(tv1) && f_1515_a1_b(tv1)) {
				tv0->AddReply(537359, 39206, 39205);
			}
			if (f_1487_a1_b(tv1) && f_14b1_a1_b(tv1) && f_150b_a1_b(tv1)) {
				tv0->AddReply(537380, 39227, 39226);
			}
			if (f_1487_a1_b(tv1) && f_14b1_a1_b(tv1) && f_1515_a1_b(tv1)) {
				tv0->AddReply(537390, 39237, 39236);
			}
			if (f_1487_a1_b(tv1) && f_14bb_a1_b(tv1)) {
				tv0->AddReply(537400, 39247, 39246);
			}
			if (f_1487_a1_b(tv1) && f_14c5_a1_b(tv1)) {
				tv0->AddReply(537423, 39270, 39269);
			}
			if (f_1487_a1_b(tv1) && f_14cf_a1_b(tv1)) {
				tv0->AddReply(537433, 39280, 39279);
			}
			if (f_1487_a1_b(tv1) && f_14d9_a1_b(tv1)) {
				tv0->AddReply(537451, 39299, 39298);
			}
			if (f_1487_a1_b(tv1) && f_14e3_a1_b(tv1)) {
				tv0->AddReply(537460, 39308, 39307);
			}
			if (f_1487_a1_b(tv1) && f_14ed_a1_b(tv1)) {
				tv0->AddReply(537473, 39321, 39320);
			}
			if (f_1487_a1_b(tv1) && f_14f7_a1_b(tv1)) {
				tv0->AddReply(537483, 39331, 39330);
			}
			if (f_1487_a1_b(tv1) && f_1501_a1_b(tv1)) {
...
{
	if (a1 == "unholster") {
		return f_144c_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1459_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_1470_a1_b(a0);
			}
		}
	}
	return false;
...
{
	if (f_144c_a1_b(a0) && f_118e_a1_b(a0)) {
		bool L0;
...
int f_1431_a1_i(object a0)
{
	...
	@CanSee(L0, a0);
	if (L0) {
		return f_13c1_a1_i(a0);
	}
	return 0;
}

void f_1441_a1_v(object a0)
{
	f_13cb_a1_v(a0);
}

int f_1447_a2_i(string a0, object a1)
{
	return 0;
}

void f_144a_a2_v(string a0, object a1)
{
}
...
bool f_155e_a1_b(object a0)
{
	return f_12ff_a0_i() == 10;
}

bool f_1565_a1_b(object a0)
{
...
int f_161b_a0_i(void)
{
	return 515559;
}

int f_161d_a0_i(void)
{
	return 503344;
}

string f_161f_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_1621_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_1623_a0_b(void)
{
	return false;
}

void f_1625_a0_v(void)
{
	g0 = false;
	f_15b7_a1_v(false);
}

void f_162d_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_1655_a0_b(void)
{
	return true;
}

bool f_1657_a3_b(object a0, object a1, bool a2)
{
	if (f_13e5_a3_b(a0, a1, 500.0)) {
