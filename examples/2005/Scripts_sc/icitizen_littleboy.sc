...
task t8
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_14e4_a0_i());
		L0->SetNPCDescription(f_14e2_a0_i());
		L0->SetPhoto(f_14e6_a0_s());
		L0->SetPhoto2(f_14e8_a0_s());
...
int f_1337_a2_i(string a0, object a1)
{
	return 0;
}

void f_133a_a2_v(string a0, object a1)
{
}
...
int f_14e2_a0_i(void)
{
	return 515560;
}

int f_14e4_a0_i(void)
{
	return 503345;
}

string f_14e6_a0_s(void)
{
	return "ui/NPC_Citizen3.png";
}

string f_14e8_a0_s(void)
{
	return "ui/NPC_Citizen3_b.png";
}

bool f_14ea_a0_b(void)
{
	return false;
}

void f_14ec_a0_v(void)
{
	g0 = false;
	f_1496_a1_v(true);
}

void f_14f4_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_151c_a0_b(void)
{
	return true;
}

bool f_151e_a3_b(object a0, object a1, bool a2)
{
	if (f_12e6_a3_b(a0, a1, 500.0)) {
