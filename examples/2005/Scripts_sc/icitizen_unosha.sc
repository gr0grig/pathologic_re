...
void f_877_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_96e_a1_i("Money"), 0, L0);
}

void f_896_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_8bf_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_877_a2_v(0, 100 + f_847_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_96e_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_96e_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_96e_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_96e_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_96e_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_96e_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_877_a2_v(0, 50 + f_847_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_96e_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_96e_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_96e_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_96e_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_96e_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_96e_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
bool f_9a0_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_add_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_ae2_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_af7_a1_b(a0);
			}
		}
	}
	return false;
...
void f_9c0_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_ae0_a1_v(a0);
	} else {
...
bool f_9d9_a1_b(object a0)
{
	if (f_add_a1_b(a0) && f_69a_a1_b(a0)) {
		bool L0;
...
void f_9f0_a1_v(object a0)
{
	f_ae0_a1_v(a0);
}

void f_9f6_a1_v(object a0)
{
	if (f_69a_a1_b(a0)) {
...
bool f_a03_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_afc_a1_b(L0);
	}
	return false;
}

void f_a13_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_a20_a1_i(object a0)
{
	return f_b3b_a0_b() ? 2 : 0;
}
...
int f_a31_a1_i(object a0)
{
	return f_71d_a1_b(a0) ? 2 : 0;
}

void f_a3b_a1_v(object a0)
{
	t3{a0};
}

bool f_a43_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
...
int f_a8e_a2_i(object a0, bool a1)
{
	return f_a31_a1_i(a0);
}
...
bool f_a9b_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_a43_a2_b(a1, !a3)) {
		return false;
...
void f_af1_a1_v(object a0)
{
	f_a29_a1_v(a0);
}

bool f_af7_a1_b(object a0)
{
	return false;
}
...
void f_aff_a1_v(object a0)
{
}

string f_b01_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
void f_b1d_a0_v(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_b01_a1_s(L0));
		if (!L1) {
			break;
		}
	}
	int L2;
	@irand(L2, L0);
	@PlayAnimation("all", f_b01_a1_s(L2));
	@WaitForAnimEnd();
}

void f_b38_a0_v(void)
{
	@StopAnimation();
}

bool f_b3b_a0_b(void)
{
	return true;
}

bool f_b3d_a3_b(object a0, object a1, bool a2)
{
	return f_a9b_a4_b(a0, a1, 500.0, a2);
}
