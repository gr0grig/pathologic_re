...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_ff1_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_158c_a0_i());
		L0->SetNPCDescription(f_158a_a0_i());
		L0->SetPhoto(f_158e_a0_s());
		L0->SetPhoto2(f_1590_a0_s());
		L0->SetPlayerName(f_11e6_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t3
{
	...
	{
		if (f_15ce_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_1466_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_9b6_a0_v();
				}
	...
	{
		if (f_1378_a2_b(a0, a1)) {
			f_9b6_a0_v();
			f_1398_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_14b0_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_9b6_a0_v();
				}
...
task t4
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_eb9_a1_V(tv0);
		if (f_10c9_a2_f(L0, L1) < 0.4999999701976776) {
			f_fe1_a1_v(tv0);
		}
	}
...
task t5
{
	...
	void init(object a0)
	{
		f_b0e_a3_v(a0, true, 180.0);
	}

	float f_b08_a2_f(object a0, int a1)
	{
		return 0.05000000074505806;
	}

	int f_b0b_a2_i(object a0, int a1)
	{
		return 0;
	}

	void f_b0e_a3_v(object a0, bool a1, float a2)
	{
		float L0;
		Vector L1;
		Vector L2;
		...
		if (L3) {
			...
			@SendPlayerEnemy(a0, f_108e_a0_o());
		}
		if (a1) {
			L4 = false;
		} else {
	...
	void f_c16_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_b08_a2_f(L0, a1);
			L2 = f_ed9_a3_f(L0, L1, f_b0b_a2_i(L0, a1));
			@ReportHit(tv0, f_d95_a0_i(), L2, L1);
			f_d9c_a2_v(L0, L2);
		}
	}

	bool f_c3d_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_d90_a0_v();
	...
	bool f_d28_a0_b(void)
	{
		if (f_d0c_a0_b() && f_d38_a0_b()) {
			return true;
		}
		return false;
	}

	bool f_d38_a0_b(void)
	{
		object L0;
		bool L1;
		@GetScene(L0);
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_eb9_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	void f_d97_a0_v(void)
	{
		f_1065_a1_v("attack_stay");
	}

	void f_d9c_a2_v(object a0, float a1)
	{
	}

	bool f_d9e_a0_b(void)
	{
		return true;
	}
...
task t6
{
	...
	bool f_e14_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_ea7_a0_s(), f_ea9_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
...
{
	return f_f4b_a1_b(a0);
}

string f_ea7_a0_s(void)
{
	return "walk";
}

string f_ea9_a0_s(void)
{
	return "run";
}

string f_eab_a1_s(int a0)
{
	if (a0 == 2) {
		return "fire";
	} else {
...
bool f_ecd_a2_b(object a0, string a1)
{
	bool L0;
...
float f_ed9_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_ecd_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_ecd_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_eab_a1_s(a2);
	if (!f_ecd_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_109e_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_10a5_a3_f(L4 - L5, 0, 1));
	if (f_ec8_a1_b(a0)) {
		f_10df_a1_v(-L5);
	}
	return L5;
...
bool f_f27_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_f22_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_f4b_a1_b(object a0)
{
	int L0;
	if (!f_f27_a1_b(a0)) {
		return false;
	}
	if (!f_ecd_a2_b(a0, "noaccess")) {
		return true;
	}
...
void f_f8f_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_1094_a1_V(f_eb9_a1_V(a0));
		object L1;
...
void f_fd3_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
bool f_ff1_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1094_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_104d_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_109e_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_10a5_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_10b6_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_10bf_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_10c9_a2_f(Vector a0, Vector a1)
{
	return f_10b6_a2_f(a0, a1) / (f_10bf_a1_f(a0) * f_10bf_a1_f(a1));
}

int f_10da_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_10fb_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_108e_a0_o(), L0);
}

void f_1106_a2_v(object a0, object a1)
{
	a1->SetReturnValue(100);
}

bool f_110b_a1_b(object a0)
{
	if (f_10da_a1_i("branch") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_10da_a1_i("branch") == 1) {
		return true;
	}
	return false;
}

bool f_1123_a1_b(object a0)
{
	if (f_10da_a1_i("branch") == 2) {
		return true;
	}
	return false;
}

bool f_112f_a1_b(object a0)
{
	if (f_119d_a1_b(a0)) {
		return true;
	}
...
{
	return f_10e9_a0_i() == 1;
}

bool f_11a7_a1_b(object a0)
{
	return f_10e9_a0_i() == 2;
}

bool f_11ae_a1_b(object a0)
{
	return f_10e9_a0_i() == 3;
}

bool f_11b5_a1_b(object a0)
{
	return f_10e9_a0_i() == 5;
}

bool f_11bc_a1_b(object a0)
{
	return f_10e9_a0_i() == 6;
}

bool f_11c3_a1_b(object a0)
{
	return f_10e9_a0_i() == 7;
}

bool f_11ca_a1_b(object a0)
{
	return f_10e9_a0_i() == 8;
}

bool f_11d1_a1_b(object a0)
{
	return f_10e9_a0_i() == 9;
}

bool f_11d8_a1_b(object a0)
{
	return f_10e9_a0_i() == 10;
}

bool f_11df_a1_b(object a0)
{
	return f_10e9_a0_i() == 11;
}

int f_11e6_a0_i(void)
{
	int L0;
...
int f_1202_a2_i(object a0, int a1)
{
	if (a1 == 0) {
		int L0;
		L0 = f_10e9_a0_i();
		...
		for (; L2 <= L0; L2++) {
			...
			@HasInvItemProperty(L4, f_11fd_a1_i(a0), L3);
			if (!L4) {
				continue;
			}
			@GetInvItemProperty(L1, f_11fd_a1_i(a0), L3);
		}
		return L1;
	}
	bool L5;
	@HasInvItemProperty(L5, f_11fd_a1_i(a0), "BarterPrice" + a1);
	if (!L5) {
		return 0;
	}
	int L6;
	@GetInvItemProperty(L6, f_11fd_a1_i(a0), "BarterPrice" + a1);
	if (L6 > 0) {
		return L6;
	}
	return -L6;
...
void f_124f_a2_v(int a0, int a1)
{
	int L0;
	bool L1;
	if (a0 > a1) {
	...
	@AddItem(L1, f_1346_a1_i("Money"), 0, L0);
}

void f_126e_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_1297_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_124f_a2_v(0, 100 + f_10e9_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_1346_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_1346_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_1346_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_1346_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_1346_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_1346_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_124f_a2_v(0, 50 + f_10e9_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_1346_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_1346_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_1346_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_1346_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_1346_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_1346_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
{
	f_fd3_a5_v(a0, a1, a2, a4, a5);
}

bool f_1378_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_14b5_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_14ba_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_14cf_a1_b(a0);
			}
		}
	}
	return false;
...
void f_1398_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_14b8_a1_v(a0);
	} else {
...
bool f_13b1_a1_b(object a0)
{
	if (f_14b5_a1_b(a0) && f_ec8_a1_b(a0)) {
		bool L0;
...
void f_13c8_a1_v(object a0)
{
	f_14b8_a1_v(a0);
}

void f_13ce_a1_v(object a0)
{
	if (f_ec8_a1_b(a0)) {
		@ReportReputationChange(a0, f_108e_a0_o(), -0.029999999329447746);
	}
}

bool f_13db_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_14d4_a1_b(L0);
	}
	return false;
}

void f_13eb_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_13f8_a1_i(object a0)
{
	return f_15cc_a0_b() ? 2 : 0;
}

void f_1401_a1_v(object a0)
{
	t4{a0};
}

int f_1409_a1_i(object a0)
{
	return f_f4b_a1_b(a0) ? 2 : 0;
}

void f_1413_a1_v(object a0)
{
	t5{a0};
}

bool f_141b_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
	if (!f_ecd_a2_b(a0, "class")) {
		return false;
	}
...
int f_1466_a2_i(object a0, bool a1)
{
	return f_1409_a1_i(a0);
}

void f_146d_a1_v(object a0)
{
	f_1413_a1_v(a0);
}

bool f_1473_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_141b_a2_b(a1, !a3)) {
		return false;
	}
	@CanSee(L0, a0);
	if (L0 || f_ec0_a1_f(a0) <= a2 * a2) {
		return true;
	}
	return false;
}
...
void f_1493_a1_v(object a0)
{
	f_159c_a1_v(a0);
}

void f_1499_a0_v(void)
{
}

int f_149a_a1_i(object a0)
{
	bool L0;
...
void f_14aa_a1_v(object a0)
{
	f_1413_a1_v(a0);
}

int f_14b0_a2_i(string a0, object a1)
{
	return 0;
}

void f_14b3_a2_v(string a0, object a1)
{
}

bool f_14b5_a1_b(object a0)
{
	return false;
}

void f_14b8_a1_v(object a0)
{
}

bool f_14ba_a1_b(object a0)
{
	bool L0;
	@CanSee(L0, a0);
	return L0 || f_ec0_a1_f(a0) <= 2250000;
}

void f_14c9_a1_v(object a0)
{
	f_1401_a1_v(a0);
}
...
void f_14d2_a1_v(object a0)
{
}

bool f_14d4_a1_b(object a0)
{
	return false;
}

void f_14d7_a1_v(object a0)
{
}

string f_14d9_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
		...
		for (L7 = 0; L7 < L6; L7++) {
			...
			if (L10) {
				...
				if (L10) {
					...
					if (L11 < 100 && f_1573_a1_b(L8)) {
						float L12;
						int L13;
						L0->add(L8);
						L1->add(L5);
						L2->add(L7);
						L12 = f_1202_a2_i(L8, 0);
...
int f_158a_a0_i(void)
{
	return 515568;
}

int f_158c_a0_i(void)
{
	return 503353;
}

string f_158e_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_1590_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_1592_a0_b(void)
{
	return false;
}

void f_1594_a0_v(void)
{
	g0 = false;
	f_1297_a1_v(true);
}

void f_159c_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
void f_15ae_a0_v(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_14d9_a1_s(L0));
		if (!L1) {
			break;
		}
	}
	int L2;
	@irand(L2, L0);
	@PlayAnimation("all", f_14d9_a1_s(L2));
	@WaitForAnimEnd();
}
...
bool f_15cc_a0_b(void)
{
	return true;
}

bool f_15ce_a3_b(object a0, object a1, bool a2)
{
	return f_1473_a4_b(a0, a1, 500.0, a2);
}

void f_15d8_a1_v(object a0)
{
	if (f_ec8_a1_b(a0)) {
		@ReportReputationChange(a0, f_108e_a0_o(), -0.07000000029802322, true);
		f_1297_a1_v(true);
	}
	f_127f_a0_v();
	g0 = true;
