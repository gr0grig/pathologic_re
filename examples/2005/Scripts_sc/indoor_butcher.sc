		...
		for (L1 = 0; L1 < 5 && f_793_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_925_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
bool f_8a5_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_968_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_96d_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_972_a1_b(a0);
			}
		}
	}
	return false;
...
void f_8c5_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_96b_a1_v(a0);
	} else {
...
bool f_8de_a1_b(object a0)
{
	if (f_968_a1_b(a0) && f_66f_a1_b(a0)) {
		bool L0;
...
bool f_908_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_977_a1_b(L0);
	}
	return false;
}

void f_918_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_92c_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_925_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_94f_a2_i(object a0, bool a1)
{
	return 0;
}

void f_952_a1_v(object a0)
{
}

int f_954_a1_i(object a0)
{
	return 0;
}
...
int f_959_a2_i(string a0, object a1)
{
	return 0;
}

void f_95c_a2_v(string a0, object a1)
{
}

int f_95e_a1_i(object a0)
{
	return 2;
}

void f_961_a1_v(object a0)
{
	f_97c_a1_v(a0);
}
...
bool f_972_a1_b(object a0)
{
	return false;
}

void f_975_a1_v(object a0)
{
}
...
void f_989_a0_v(void)
{
	g0 = false;
}

bool f_98d_a3_b(object a0, object a1, bool a2)
{
	return false;
}
