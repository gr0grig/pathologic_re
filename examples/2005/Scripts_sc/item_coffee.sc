maintask t0
{
	...
	{
		@PlaySound("drink");
		f_3b_a4_b("health", -0.05000000074505806, 0, 1);
		f_81_a1_v(-0.05000000074505806);
		f_3b_a4_b("immunity", 0.0, 0, 1);
		f_6d_a1_v(0.0);
		f_3b_a4_b("disease", 0.0, 0, 1);
		f_77_a1_v(0.0);
		f_3b_a4_b("hunger", 0.0, 0, 1);
		f_63_a1_v(0.0);
		f_3b_a4_b("tiredness", -0.20000000298023224, 0, 1);
		f_59_a1_v(-0.20000000298023224);
	}
}
