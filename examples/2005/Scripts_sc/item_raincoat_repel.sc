...
maintask t0
{
	...
	void init(void)
	{
		...
		for (; ; ) {
			...
			@GetGameTime(L1);
			L2 = L1 - L0;
			L3 = L2 / 0.47999998927116394;
			if (L3 > 0) {
				int L4;
				L0 = L1 - L2 % 0.47999998927116394;
	...
	{
		f_c2_a2_v("armor", -g3);
		f_c2_a2_v("armor_fire", -g4);
		f_c2_a2_v("armor_phys", -g5);
		f_c2_a2_v("armor_bullet", -g6);
		f_c2_a2_v("armor_disease", -g7);
		tv0 = true;
	}
	...
	void f_ac_a3_v(int a0, int a1, int a2)
	{
...
void f_c2_a2_v(string a0, int a1)
{
	int L0;
	@GetProperty(a0, L0);
...
int f_c9_a3_i(int a0, int a1, int a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_d4_a1_v(int a0)
{
	g3 = f_112_a4_i("armor", g3, a0, 15);
	g4 = f_112_a4_i("armor_fire", g4, a0, 10);
	g5 = f_112_a4_i("armor_phys", g5, a0, 0);
	g6 = f_112_a4_i("armor_bullet", g6, a0, 0);
	g7 = f_112_a4_i("armor_disease", g7, a0, 35);
}

int f_112_a4_i(string a0, int a1, int a2, int a3)
{
	int L0;
	L0 = a3 * (a2 / 100.0);
	if (L0 != a1) {
