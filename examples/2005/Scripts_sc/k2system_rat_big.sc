...
task t5
{
	...
	Vector f_2b9_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_4aa_a1_V(f_4aa_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_35b_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_37e_a1_V(tv0);
		return f_4ca_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
bool f_396_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_38a_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_4bf_a3_f(L0 + a2, a3, a4));
	return true;
}

float f_3ac_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	L3 = f_4b8_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_4bf_a3_f(L4 - L5, 0, 1));
	if (f_385_a1_b(a0)) {
		f_4fb_a1_v(-L5);
	}
	return L5;
...
float f_3f5_a2_f(object a0, float a1)
{
	float L0;
	if (!f_38a_a2_b(a0, "disease")) {
		return 0;
	}
	L0 = 0;
	if (f_38a_a2_b(a0, "armor_disease")) {
		a0->GetProperty("armor_disease", L0);
		L0 = L0 / 100;
	}
	if (f_38a_a2_b(a0, "immunity")) {
		float L1;
		a0->GetProperty("immunity", L1);
		L0 = L0 + L1;
		f_396_a5_b(a0, "immunity", -a1, 0, 1);
	}
	if (L0 >= 1) {
		return 0.0;
	}
	a1 = a1 * ((1 - L0) / 2);
	f_396_a5_b(a0, "disease", a1, 0, 1);
	if (f_385_a1_b(a0)) {
		f_4f1_a1_v(a1);
	}
	return a1;
...
bool f_43f_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_43a_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
float f_4b4_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_4b8_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_4bf_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_4ca_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

void f_4d2_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_4de_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_505_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_4a4_a0_o(), L0);
}

bool f_510_a1_b(object a0)
{
	if (!f_463_a1_b(a0)) {
		return false;
	}
...
bool f_541_a2_b(object a0, string a1)
{
	if (a1 == "health") {
		float L0;
		bool L1;
...
void f_55c_a2_v(object a0, string a1)
{
	if (a1 == "health") {
		float L0;
		@GetProperty("health", L0);
...
void f_581_a1_v(object a0)
{
	float L0;
	L0 = f_3ac_a3_f(a0, 0.019999999552965164, 0);
	@ReportHit(a0, 7, L0, 0.019999999552965164);
	L0 = f_3f5_a2_f(a0, 0.05000000074505806);
	@ReportHit(a0, 5, L0, 0.05000000074505806);
}
...
void f_598_a1_v(object a0)
{
	...
	float L1;
	@CreateInvItem(L0);
	L0->SetItemName("rat_big");
	@rand(L1, 0.5, 1);
	L0->SetProperty("quality", L1);
	f_4de_a3_v(a0, L0, 1);
	@RemoveActor(f_4a4_a0_o());
}
