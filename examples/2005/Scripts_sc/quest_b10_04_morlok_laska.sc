...
maintask t0
{
	...
	void f_ad_a0_v(void)
	{
		...
		L0 = f_392_a0_i();
		for (L1 = 0; L1 < 5 && f_2c0_a0_b(); L1 = L1 + 1) {
			int L2;
			@irand(L2, 3);
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_38b_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_44d_a1_b(tv1) && f_41d_a1_b(tv1) && !f_435_a1_b(tv1) && !f_429_a1_b(tv1)) {
...
bool f_37a_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_392_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_38b_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_3b8_a2_v(object a0, object a1)
{
	...
	L0 = f_49b_a0_o();
	L0->AddMark("b10q04MorlokGotoLaska", "pt_map_laska", 0, 530551, f_386_a0_f());
	f_465_a0_v();
	f_37a_a2_b("quest_b10_04", "init_storojka");
}
...
void f_3da_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_3e0_a2_v(object a0, object a1)
{
	f_4ac_a3_v(f_49b_a0_o(), "pt_map_laska", 2);
	a1->ShowMap(f_49b_a0_o());
}
...
{
	if (f_349_a1_i("b10q04LaskaTalk") == 9) {
		return true;
	}
	return false;
}

bool f_429_a1_b(object a0)
{
...
bool f_441_a1_b(object a0)
{
	if (f_349_a1_i("b10q04LaskaTalk") == 0) {
		return true;
	}
	return false;
}

bool f_44d_a1_b(object a0)
{
	if (f_349_a1_i("oob10MorlokLaska1") == 0) {
		return true;
	}
	return false;
}
...
bool f_47f_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_4ac_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
