...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_40c_a1_b(tv1) && f_430_a1_b(tv1) && !f_424_a1_b(tv1) && !f_418_a1_b(tv1)) {
...
void f_3ac_a2_v(object a0, object a1)
{
	...
	L0 = f_48a_a0_o();
	L0->AddMark("b10q04MorlokGotoSpi4ka", "pt_map_spi4ka", 0, 530552, f_37a_a0_f());
	f_454_a0_v();
}
...
{
	f_49b_a3_v(f_48a_a0_o(), "pt_map_spi4ka", 2);
...
{
	if (f_349_a1_i("b10q04Spi4kaTalk") == 9) {
		return true;
	}
	return false;
}
...
{
	if (f_349_a1_i("oob10MorlokSpi4ka1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_349_a1_i("b10q04Spi4kaTalk") == 0) {
		return true;
	}
	return false;
}
