...
task t2
{
	void init(object a0)
	{
		...
		L1->SelectWeapon();
		f_726_a3_v(L1, "boiny", "pt_Starshina");
		f_71a_a2_b("quest_b11_01", "fight_win");
		for (; ; ) {
			@Hold();
		}
	}
...
bool f_71a_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_726_a3_v(object a0, string a1, string a2)
{
	object L0;
	bool L1;
	Vector L2;
