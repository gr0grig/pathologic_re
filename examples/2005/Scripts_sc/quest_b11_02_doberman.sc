...
void f_1a7_a0_v(void)
{
	...
	L0 = f_2a0_a0_i();
	for (L1 = 0; L1 < 5 && f_205_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
...
void f_2bb_a2_v(object a0, object a1)
{
	...
	f_28d_a2_b("quest_b11_02", "teleport");
}

void f_2c6_a2_v(object a0, object a1)
{
	f_2dc_a0_v();
	f_28d_a2_b("quest_b11_02", "fail");
}

bool f_2d0_a1_b(object a0)
{
	if (f_288_a1_i("b11q02") == 2) {
		return true;
	}
	return false;
}
...
bool f_2f6_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
