...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_54d_a1_b(f_5fa_a0_o());
		if (!f_4f8_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_6cd_a0_i());
		L0->SetNPCDescription(f_6cb_a0_i());
		L0->SetPhoto(f_6cf_a0_s());
		L0->SetPhoto2(f_6d1_a0_s());
		L0->SetPlayerName(f_6ba_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			if (!f_6ae_a1_b(tv1)) {
				...
				if (!f_642_a1_b(tv1) && !f_64e_a1_b(tv1) && f_67e_a1_b(tv1)) {
					tv0->AddReply(522728, 23910, 23909);
				}
				if (f_68a_a1_b(tv1)) {
					tv0->AddReply(522735, 23921, 23916);
				}
				if (f_642_a1_b(tv1) && f_696_a1_b(tv1)) {
					tv0->AddReply(522774, 23968, 23957);
				}
				if (f_64e_a1_b(tv1) && f_6a2_a1_b(tv1)) {
...
bool f_4f8_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_600_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_5de_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_61e_a2_v(object a0, object a1)
{
...
{
	if (f_60a_a1_i("b12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("b12q01TheaterIsVisited") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor4") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor5") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor6") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_60a_a1_i("oob12AglajaSobor7") == 0) {
		return true;
	}
	return false;
}
