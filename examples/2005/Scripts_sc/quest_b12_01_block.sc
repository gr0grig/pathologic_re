...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_2f1_a1_b(f_39e_a0_o());
		if (!f_29c_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_497_a0_i());
		L0->SetNPCDescription(f_495_a0_i());
		L0->SetPhoto(f_499_a0_s());
		L0->SetPhoto2(f_49b_a0_s());
		L0->SetPlayerName(f_484_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_29c_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_3a4_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_3d3_a2_v(object a0, object a1)
{
...
{
	@SetVariable("game_final", f_3ae_a1_i("c_iFinalEmpty"));
}
...
{
	if (f_3ae_a1_i("b12q01DankoInSobor") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_3ae_a1_i("b12q01KlaraInSobor") != 0) {
		return true;
	}
	return false;
}
...
bool f_468_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
