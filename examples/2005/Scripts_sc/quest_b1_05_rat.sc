...
bool f_4a0_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_4d7_a1_v(object a0)
{
	t3{a0};
	@ResetAAS();
}

void f_4e1_a1_v(object a0)
{
	t2{};
}

bool f_4e8_a2_b(object a0, string a1)
{
	if (a1 == "health") {
		float L0;
		bool L1;
...
void f_503_a2_v(object a0, string a1)
{
	if (a1 == "health") {
		float L0;
		@GetProperty("health", L0);
...
void OnUnload(void)
{
	if (f_3df_a1_b(f_449_a0_o())) {
		f_4a0_a2_b("quest_b1_05", "rat_dead");
	}
	@RemoveActor(f_449_a0_o());
	@Hold();
}
