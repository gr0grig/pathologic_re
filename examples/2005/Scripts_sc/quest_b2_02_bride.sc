...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_37d_a0_i());
		L0->SetNPCDescription(f_37b_a0_i());
		L0->SetPhoto(f_37f_a0_s());
		L0->SetPhoto2(f_381_a0_s());
		L0->SetPlayerName(f_43e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_3ef_a1_b(tv1) && !f_3d7_a1_b(tv1) && !f_3cb_a1_b(tv1) && f_3e3_a1_b(tv1)) {
...
void f_245_a0_v(void)
{
	...
	L0 = f_36a_a0_i();
	for (L1 = 0; L1 < 5 && f_2a3_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_363_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
void f_337_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_34a_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_357_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_36a_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_363_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
{
	f_408_a0_v();
	f_357_a2_b("quest_b2_02", "fail");
}

void f_395_a2_v(object a0, object a1)
{
	@SetVariable("b2q02", 2);
	f_3fb_a0_v();
	f_357_a2_b("quest_b2_02", "move_bride");
}

void f_3a3_a2_v(object a0, object a1)
{
	@Trace("white plet 3 is given");
	f_34a_a3_v(a0, "grass_white_plet", 3);
}

void f_3ae_a2_v(object a0, object a1)
{
	@Trace("savyur 3 is given");
	f_34a_a3_v(a0, "grass_savyur", 3);
}
...
{
	if (f_326_a1_i("b2q02") == 1000) {
		return true;
	}
	return false;
}

bool f_3ef_a1_b(object a0)
{
	if (f_326_a1_i("oob2TravnikWife1") == 0) {
		return true;
	}
	return false;
}
...
bool f_422_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
