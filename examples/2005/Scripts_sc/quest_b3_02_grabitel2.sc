...
Vector f_839_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
...
void f_86f_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_8d5_a1_i("Money"), 0, L0);
}

void f_88e_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_8b7_a0_v(void)
{
	...
	@AddItem(L1, f_8d5_a1_i("grabitel_mark"), 0, 1);
}

int f_8d5_a1_i(string a0)
{
	int L0;
...
bool f_928_a2_b(object a0, object a1)
{
	return false;
}

void f_92b_a1_v(object a0)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_789_a0_o());
