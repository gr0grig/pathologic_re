...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_943_a0_i());
		L0->SetNPCDescription(f_941_a0_i());
		L0->SetPhoto(f_945_a0_s());
		L0->SetPhoto2(f_947_a0_s());
		L0->SetPlayerName(f_98e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
		...
		for (L1 = 0; L1 < 5 && f_821_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_94b_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t3
{
	...
	void init(void)
	{
		object L0;
		@GetScene(L0);
		L0->RemoveStationaryActor(f_8c3_a0_o());
...
bool f_6f8_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_8da_a3_f(L0 + a2, a3, a4));
	return true;
}
...
float f_70e_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_8d3_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_8da_a3_f(L4 - L5, 0, 1));
	if (f_6e7_a1_b(a0)) {
		f_90d_a1_v(-L5);
	}
	return L5;
...
bool f_826_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_8c9_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_882_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_8d3_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_8da_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_8ea_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_921_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_936_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_8c3_a0_o(), L0);
}
...
string f_945_a0_s(void)
{
	return "ui/NPC_Citizen3.png";
}

string f_947_a0_s(void)
{
	return "ui/NPC_Citizen3_b.png";
}

bool f_949_a0_b(void)
{
	return false;
}

string f_94b_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_952_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_94b_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_963_a2_v(object a0, object a1)
{
	@SetVariable("oob4boy1", 1);
}

void f_969_a2_v(object a0, object a1)
{
	f_921_a2_b("quest_b4_02", "boy_run");
}

void f_970_a2_v(object a0, object a1)
{
	@SetVariable("oob4boy2", 1);
}

bool f_976_a1_b(object a0)
{
	if (f_8e5_a1_i("oob4boy1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_6e7_a1_b(a0)) {
		f_8ea_a2_b(a0, -0.10000000149011612);
	}
	f_9b2_a1_v(a0);
}
