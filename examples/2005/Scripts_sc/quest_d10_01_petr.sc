...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_49d_a1_b(f_54a_a0_o());
		if (!f_448_a2_b(a0, 130.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_6d5_a0_i());
		L0->SetNPCDescription(f_6d3_a0_i());
		L0->SetPhoto(f_6d7_a0_s());
		L0->SetPhoto2(f_6d9_a0_s());
		L0->SetPlayerName(f_6c2_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_5f0_a1_b(tv1) && f_608_a1_b(tv1)) {
				tv0->AddReply(512854, 14056, 14055);
			}
			if (f_614_a1_b(tv1) && f_620_a1_b(tv1)) {
				tv0->AddReply(515468, 16586, 16585);
			}
			if (f_62a_a1_b(tv1) && f_636_a1_b(tv1)) {
...
bool f_448_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_550_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_4d7_a1_b(object a0)
{
	...
	return f_534_a1_b(L4);
}

bool f_4fc_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_597_a0_i() + "m";
	int L1;
...
void f_52e_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
void f_56b_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_57e_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_58b_a3_b(string a0, string a1, string a2)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
{
	f_6a1_a3_v(f_690_a0_o(), "pt_map_aglaja", 2);
	a1->ShowMap(f_690_a0_o());
}

void f_5b0_a2_v(object a0, object a1)
{
	f_58b_a3_b("volonteers_danko", "disease", "petr");
}

void f_5b8_a2_v(object a0, object a1)
{
	if (f_55a_a1_i("map_chertez_state") <= 4) {
		@SetVariable("map_chertez_state", 4);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_5c9_a2_v(object a0, object a1)
{
	@SetVariable("ood10Petr1", 1);
}

void f_5cf_a2_v(object a0, object a1)
{
...
void f_5d8_a2_v(object a0, object a1)
{
	...
	f_57e_a3_v(a0, "d10q01_blueprint", 1);
}

void f_5ea_a2_v(object a0, object a1)
{
...
{
	if (f_55a_a1_i("d10q01MariaSavePetr") == 1) {
		return true;
	}
	return false;
}
...
bool f_674_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_6a1_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
string f_6d7_a0_s(void)
{
	return "ui/NPC_Petr.png";
}

string f_6d9_a0_s(void)
{
	return "ui/NPC_Petr_b.png";
}

bool f_6db_a0_b(void)
{
	return false;
}
