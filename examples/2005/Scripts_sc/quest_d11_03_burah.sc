...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_3e6_a1_b(f_493_a0_o());
		if (!f_391_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_541_a0_i());
		L0->SetNPCDescription(f_53f_a0_i());
		L0->SetPhoto(f_543_a0_s());
		L0->SetPhoto2(f_545_a0_s());
		L0->SetPlayerName(f_52e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t3
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_2b6_a0_v();
			if (f_38c_a0_b() && f_297_a0_b()) {
				if (f_283_a0_b()) {
					f_420_a1_b(f_493_a0_o());
				}
			} else {
				f_292_a0_v();
				f_2ad_a0_v();
...
void f_325_a0_v(void)
{
	...
	L0 = f_4b8_a0_i();
	for (L1 = 0; L1 < 5 && f_38c_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_4b1_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_391_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_499_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_477_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
int f_4b8_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_4b1_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_4c9_a2_v(object a0, object a1)
{
	if (f_4a3_a1_i("map_chertez_state") <= 5) {
...
{
	f_50d_a3_v(f_4fc_a0_o(), "pt_map_aglaja", -1);
	a1->ShowMap(f_4fc_a0_o());
}

void f_4ea_a2_v(object a0, object a1)
{
	@SetVariable("ood11Burah1", 1);
}

bool f_4f0_a1_b(object a0)
{
	if (f_4a3_a1_i("ood11Burah1") == 0) {
		return true;
	}
	return false;
}

object f_4fc_a0_o(void)
{
	object L0;
	object L1;
...
void f_50d_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
string f_543_a0_s(void)
{
	return "ui/NPC_Burah.png";
}

string f_545_a0_s(void)
{
	return "ui/NPC_Burah_b.png";
}

bool f_547_a0_b(void)
{
	return true;
}
