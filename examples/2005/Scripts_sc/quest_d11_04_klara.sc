...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_6da_a0_i());
		L0->SetNPCDescription(f_6d8_a0_i());
		L0->SetPhoto(f_6dc_a0_s());
		L0->SetPhoto2(f_6de_a0_s());
		L0->SetPlayerName(f_6c7_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
void f_445_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_4ac_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_5fd_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_5d4_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_5e7_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
int f_604_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_5fd_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_615_a2_v(object a0, object a1)
{
	@SetVariable("d11q06KlaraRing", 1);
	f_691_a0_v();
	@Trace("d11q06KlaraRing is given");
	f_5e7_a3_v(a0, "d11q06KlaraRing", 1);
}

void f_627_a2_v(object a0, object a1)
{
	if (f_5c3_a1_i("d11q06KapellaRing") != 0 && f_5c3_a1_i("d11q06KlaraRing") != 0) {
...
void f_64e_a2_v(object a0, object a1)
{
...
bool f_6ab_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_6dc_a0_s(void)
{
	return "ui/NPC_Klara.png";
}

string f_6de_a0_s(void)
{
	return "ui/NPC_Klara_b.png";
}

bool f_6e0_a0_b(void)
{
	return true;
}
