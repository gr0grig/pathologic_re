...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_256_a1_b(f_303_a0_o());
		if (!f_201_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_32f_a0_i());
		L0->SetNPCDescription(f_32d_a0_i());
		L0->SetPhoto(f_331_a0_s());
		L0->SetPhoto2(f_333_a0_s());
...
bool f_201_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_309_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
string f_331_a0_s(void)
{
	return "ui/NPC_Aglaja.png";
}

string f_333_a0_s(void)
{
