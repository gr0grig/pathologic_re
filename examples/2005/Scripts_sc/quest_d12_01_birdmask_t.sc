...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_35b_a1_b(tv1) && !f_37d_a1_b(tv1)) {
				f_d3_a1_v("Neutral");
			...
			if (f_37d_a1_b(tv1) && f_35b_a1_b(tv1) && f_365_a1_b(tv1)) {
				f_348_a2_v(tv1, tv0);
				f_d3_a1_v("Neutral");
...
{
	f_31a_a2_b("quest_d12_01", "init_theater");
}
...
{
	if (f_315_a1_i("ood12BirdmaskT") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_315_a1_i("ood12BirdmaskT2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_315_a1_i("d12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}
