...
maintask t0
{
	...
	void init(void)
	{
		...
		tv3 = f_d2_a3_o(L0, "d1q01_light", "light_fire.xml");
		tv4 = f_da_a4_o(L0, "pt_d1q01_fire", "scripted", "fire.xml");
		f_6f_a0_v();
	}
	...
	void OnIntersection(object a0)
	{
		...
		@RemoveActor(tv2);
		@CameraSwitchToNormal();
		f_ec_a2_b("quest_d1_01", "cutscene_end");
	}
...
object f_d2_a3_o(object a0, string a1, string a2)
{
	object L0;
...
bool f_ec_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
