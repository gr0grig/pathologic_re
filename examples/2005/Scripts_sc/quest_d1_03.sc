...
maintask t0
{
	...
	void init(void)
	{
		...
		tv0 = f_a2_a4_o(L0, "pt_d1q04_butcher", "pers_butcher", "d1q03_butcher.xml");
		f_b4_a2_v("ospina_kabak@door1", true);
		f_84_a1_v(1);
	}
	...
	void OnTrigger(string a0)
	{
		...
		if (a0 == "unlock_butcher") {
			f_b4_a2_v("ospina_kabak@door1", false);
		} else {
			if (a0 == "butcher_fail") {
				f_df_a0_v();
				f_60_a0_v();
...
object f_a2_a4_o(object a0, string a1, string a2, string a3)
{
	bool L0;
	Vector L1;
	Vector L2;
...
bool f_f9_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
