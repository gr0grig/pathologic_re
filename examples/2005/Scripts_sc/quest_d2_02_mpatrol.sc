...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_8c0_a0_i());
		L0->SetNPCDescription(f_8be_a0_i());
		L0->SetPhoto(f_8c2_a0_s());
		L0->SetPhoto2(f_8c4_a0_s());
		L0->SetPlayerName(f_816_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_5c5_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_7a6_a3_f(L0 + a2, a3, a4));
	return true;
}
...
bool f_7b1_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_7e8_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_808_a2_v(object a0, object a1)
{
	f_7e8_a2_b("quest_d2_02", "player_attack");
}

void f_80f_a2_v(object a0, object a1)
{
	f_7e8_a2_b("quest_d2_02", "completed");
}
...
void OnUnload(void)
{
	f_7e8_a2_b("quest_d2_02", "mpatrol_unload");
}
...
void f_87a_a1_v(object a0)
{
	...
	if (f_5b4_a1_b(a0)) {
		f_7b1_a2_b(a0, -0.15000000596046448);
	}
	f_84b_a0_v();
	t4{a0};
}
