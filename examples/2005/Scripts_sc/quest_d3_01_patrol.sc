...
bool f_632_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_813_a3_f(L0 + a2, a3, a4));
	return true;
}
...
float f_648_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_80c_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_813_a3_f(L4 - L5, 0, 1));
	if (f_621_a1_b(a0)) {
		f_841_a1_v(-L5);
	}
	return L5;
...
bool f_75b_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_7fe_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_7b7_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_808_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_80c_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_813_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_81e_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
void f_85e_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_7f8_a0_o(), L0);
}
...
void f_8b6_a1_v(object a0)
{
	...
	f_89e_a0_v();
	if (f_621_a1_b(a0)) {
		f_81e_a2_b(a0, -0.20000000298023224);
	}
	t4{a0};
}
