...
task t3
{
	...
	void init(void)
	{
		f_581_a2_b("quest_d3_03", "boy_free");
		...
		for (L1 = 0; L1 < 5 && f_4ac_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_58d_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t5
{
	...
	Vector f_296_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_543_a1_V(f_543_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_341_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_3da_a1_V(tv0);
		return f_54d_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
bool f_4b1_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_543_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
float f_54d_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

void f_555_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_561_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_574_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_581_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_594_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_58d_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_5a5_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_5ab_a2_v(object a0, object a1)
{
	float L0;
	@SetVariable("d3q03", 2);
	f_5d3_a0_v();
...
void f_5be_a2_v(object a0, object a1)
{
	...
	f_574_a3_v(a0, "powder", 1);
}

void f_5c9_a2_v(object a0, object a1)
{
	f_5e0_a0_v();
	f_581_a2_b("quest_d3_03", "fail");
}
...
bool f_5fa_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void OnAttacked(object a0)
{
	...
	@IsPlayerActor(a0, L0);
	if (L0) {
		f_581_a2_b("quest_d3_03", "boy_attacked");
	}
}
