...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_2e3_a0_i());
		L0->SetNPCDescription(f_2e1_a0_i());
		L0->SetPhoto(f_2e5_a0_s());
		L0->SetPhoto2(f_2e7_a0_s());
		L0->SetPlayerName(f_2d0_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t2
{
	...
	void OnUse(object a0)
	{
		if (!tv0) {
			...
			f_1d8_a0_v();
			t0{a0};
			f_255_a2_b("quest_d4_01", "wastedwoman_done");
		}
	}
}
...
void f_187_a0_v(void)
{
	...
	L0 = f_26d_a0_i();
	for (L1 = 0; L1 < 5 && f_1dd_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_266_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
void f_23e_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
bool f_255_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_26d_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_266_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_27e_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_29e_a0_o();
	L0->AddMark("d4q01WastedMale", "pt_d4q01_key2_region", 1, 511522, f_261_a0_f());
}

void f_28e_a2_v(object a0, object a1)
{
	f_2af_a3_v(f_29e_a0_o(), "pt_d4q01_key2_region", 2);
	a1->ShowMap(f_29e_a0_o());
}

object f_29e_a0_o(void)
{
	object L0;
	object L1;
...
void f_2af_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
