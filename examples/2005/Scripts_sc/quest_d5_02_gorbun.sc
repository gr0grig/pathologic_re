	...
	void init(int a0)
	{
		...
		if (L1) {
			...
			if (L5) {
				int L6;
				@irand(L6, L5);
				@PlayAnimation("all", f_63e_a1_s(L6));
				@WaitForAnimEnd();
			}
		}
	}
...
task t4
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_7bd_a0_i());
		L0->SetNPCDescription(f_7bb_a0_i());
		L0->SetPhoto(f_7bf_a0_s());
		L0->SetPhoto2(f_7c1_a0_s());
		L0->SetPlayerName(f_7aa_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_701_a1_b(tv1) && f_70d_a1_b(tv1)) {
				f_6b3_a2_v(tv1, tv0);
				f_1fa_a1_v("Neutral");
			...
			if (f_719_a1_b(tv1) && !f_725_a1_b(tv1) && f_73d_a1_b(tv1)) {
				tv0->AddReply(511936, 13155, 13153);
			}
			if (f_725_a1_b(tv1) && f_731_a1_b(tv1)) {
...
maintask t6
{
	...
	void init(void)
	{
		...
		for (tv2 = 0; ; tv2++) {
			bool L1;
			L0->GetLocator(f_656_a1_s(tv2), L1);
			if (!L1) {
				break;
			}
		}
		...
		for (; ; ) {
			...
			Vector L6;
			@irand(L2, tv2);
			L0->GetLocator(f_656_a1_s(L2), L3, L4, L5);
			L6 = L4 - f_553_a0_V();
			if (f_60b_a1_f(L6) > tv1) {
				float L7;
				Vector L8;
				bool L9;
				@GetHeight(L7);
...
bool f_58a_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_5f9_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_5e6_a2_v(string a0, bool a1)
{
	float L0;
	float L1;
	@lshGetAnimTimes(a0, L0, L1);
...
float f_603_a1_f(float a0)
{
	return a0 < 0 ? -a0 : a0;
}

float f_60b_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

int f_615_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_626_a2_v(object a0, int a1)
{
...
int f_645_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_63e_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_683_a2_v(object a0, object a1)
{
	@Trace("money10000 is given");
	f_626_a2_v(a0, 10000);
}

void f_68d_a2_v(object a0, object a1)
{
...
void f_69c_a2_v(object a0, object a1)
{
	...
	@SetVariable("d5q02", 2);
	L0 = f_799_a0_o();
	L0->AddMark("d5q02GorbunFindTheDaughter", "pt_map_gorbun", 0, 515362, f_639_a0_f());
	f_756_a0_v();
}
...
void f_6eb_a2_v(object a0, object a1)
{
	@SetVariable("ood5Gorbun2", 1);
}

void f_6f1_a2_v(object a0, object a1)
{
	@SetVariable("ood5Gorbun3", 1);
}

void f_6f7_a2_v(object a0, object a1)
{
...
{
	if (f_615_a1_i("d5q02") == 4) {
		return true;
	}
	return false;
}

bool f_725_a1_b(object a0)
{
	if (f_615_a1_i("d5q02KnowNudeIsDead") == 1) {
		return true;
	}
	return false;
}
...
bool f_77d_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
bool f_7c3_a0_b(void)
{
	return false;
}

void f_7c5_a1_v(object a0)
{
	t4{a0};
}
