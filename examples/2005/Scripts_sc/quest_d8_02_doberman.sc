...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_420_a0_i());
		L0->SetNPCDescription(f_41e_a0_i());
		L0->SetPhoto(f_422_a0_s());
		L0->SetPhoto2(f_424_a0_s());
...
void f_259_a0_v(void)
{
	...
	L0 = f_40d_a0_i();
	for (L1 = 0; L1 < 5 && f_2b7_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_406_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
{
	f_3d4_a3_v(f_3c3_a0_o(), "pt_map_kapella", 2);
	a1->ShowMap(f_3c3_a0_o());
}
...
void f_35a_a2_v(object a0, object a1)
{
	...
	@SetVariable("d8q02", 1);
	L0 = f_3c3_a0_o();
	L0->AddMark("d8q02GotoKapella", "pt_map_kapella", 0, 540068, f_345_a0_f());
	f_380_a0_v();
	f_38d_a0_v();
}
...
bool f_3a7_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_3d4_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
int f_40d_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_406_a1_s(L0));
		if (!L1) {
			break;
		}
	}
