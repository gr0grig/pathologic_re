...
task t1
{
	...
	void init(object a0, bool a1)
	{
		...
		do {
			...
			@WaitForAnimEnd();
			for (; ; ) {
				if ((tv0 == null || !tv1) && (!f_6f1_a1_b(tv0) || !f_6ae_a1_b(tv0))) {
					break;
				}
				f_577_a1_v(tv0);
				@WaitForAnimEnd();
	...
	void OnSee(object a0)
	{
		...
		if (f_6bb_a1_b(a0) && f_6d7_a2_b(tv0, a0)) {
			tv0 = a0;
			@Face(a0);
		}
	}
	...
	void OnHear(object a0)
	{
		...
		if (f_6c9_a1_b(a0) && f_6d7_a2_b(tv0, a0)) {
			tv0 = a0;
			@Face(a0);
		}
	}
	...
	{
		f_5f0_a1_v(a0);
		if (!f_27a_a1_b(a0) || !f_6ae_a1_b(a0)) {
			return;
		}
		tv0 = a0;
		tv1 = true;
...
void f_3f4_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_46a_a1_i("Money"), 0, L0);
}

void f_413_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_43c_a0_v(void)
{
	...
	@AddItem(L1, f_46a_a1_i("ognemet_ammo"), 0, 1);
}

int f_46a_a1_i(string a0)
{
	int L0;
...
bool f_46f_a2_b(object a0, bool a1)
{
	string L0;
...
bool f_63c_a3_b(object a0, object a1, bool a2)
{
	if (f_46f_a2_b(a1, !a2)) {
		bool L0;
		@CanSee(L0, a0);
...
void f_656_a1_v(int a0)
{
	...
	while (L0->Next(L3, L2), L3) {
		if (L2 != null && L2 != f_39f_a0_o()) {
			float L4;
			L4 = f_208_a3_f(L2, 0.10000000149011612, 2);
...
{
	return f_6f1_a1_b(a0) && f_6ae_a1_b(a0);
}
...
bool f_6d7_a2_b(object a0, object a1)
{
	if (a1 == null) {
		return false;
	}
	return !f_6f1_a1_b(a0) || f_1ef_a1_f(a1) < f_1ef_a1_f(a0) - 25;
}
