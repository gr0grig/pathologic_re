...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_395_a1_b(f_442_a0_o());
		if (!f_340_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_47a_a0_i());
		L0->SetNPCDescription(f_478_a0_i());
		L0->SetPhoto(f_47c_a0_s());
		L0->SetPhoto2(f_47e_a0_s());
		L0->SetPlayerName(f_4df_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t3
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_265_a0_v();
			if (f_33b_a0_b() && f_246_a0_b()) {
				if (f_232_a0_b()) {
					f_3cf_a1_b(f_442_a0_o());
				}
			} else {
				f_241_a0_v();
				f_25c_a0_v();
...
void f_2d4_a0_v(void)
{
	...
	L0 = f_467_a0_i();
	for (L1 = 0; L1 < 5 && f_33b_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
...
bool f_340_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
string f_47c_a0_s(void)
{
	return "ui/NPC_Burah.png";
}

string f_47e_a0_s(void)
{
...
bool f_4c3_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
