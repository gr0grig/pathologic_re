...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_294_a2_b(a0, 130.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_320_a0_i());
		L0->SetNPCDescription(f_31e_a0_i());
		L0->SetPhoto(f_322_a0_s());
		L0->SetPhoto2(f_324_a0_s());
...
maintask t2
{
	...
	void f_1e2_a2_v(float a0, float a1)
	{
		if (!f_28f_a0_b()) {
			return;
		}
...
void f_231_a0_v(void)
{
	...
	L0 = f_32f_a0_i();
	for (L1 = 0; L1 < 5 && f_28f_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_328_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_294_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_308_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
string f_322_a0_s(void)
{
	return "ui/NPC_bmask.png";
}

string f_324_a0_s(void)
{
	return "ui/NPC_bmask_b.png";
}

bool f_326_a0_b(void)
{
	return false;
}

string f_328_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_32f_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_328_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_340_a2_v(object a0, object a1)
{
	f_312_a2_b("quest_k1_01", "remove_birdmask");
}
