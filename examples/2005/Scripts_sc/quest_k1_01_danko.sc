...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		f_29f_a1_b(f_34c_a0_o());
		if (!f_24a_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_376_a1_b(tv1) && !f_382_a1_b(tv1) && f_38e_a1_b(tv1)) {
				f_36a_a2_v(tv1, tv0);
				f_de_a1_v("Neutral");
			...
			if (f_382_a1_b(tv1) && f_39a_a1_b(tv1)) {
				f_370_a2_v(tv1, tv0);
				f_de_a1_v("Neutral");
...
bool f_24a_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_352_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_370_a2_v(object a0, object a1)
{
