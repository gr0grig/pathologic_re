...
task t0
{
	bool init(object a0)
	{
		...
		L0 = f_5e2_a1_f(a0);
		if (f_7c9_a3_b(L0, 250000.0, 3240000.0)) {
			return t1{a0};
		}
		return t2{a0};
	}
...
task t1
{
	...
	bool init(object a0)
	{
		...
		L3->SetScriptProperty("Owner", f_78f_a0_o());
		L3->SetScriptProperty("Target", a0);
		a0->GetPosition(L4);
		a0->GetEyesHeight(L5);
		L4.y += L5 - 10;
		L6 = f_86f_a3_V(L1, L4, 2000.0);
...
task t2
{
	...
	void f_1f8_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_bf_a2_f(L0, a1);
			L2 = f_611_a3_f(L0, L1, f_c2_a2_i(L0, a1));
	...
	bool f_31c_a0_b(void)
	{
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_5db_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
...
task t6
{
	void init(object a0)
	{
		...
		if (f_5ea_a1_b(a0)) {
			f_7d1_a2_b(a0, 0.029999999329447746);
		}
		f_539_a1_v(a0);
	}

	void f_539_a1_v(object a0)
	{
		disable OnUse;
		f_552_a1_v(a0);
		@SetRTEnvelope(50, 40);
...
bool f_5ef_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_5fb_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_5ef_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_7be_a3_f(L0 + a2, a3, a4));
	return true;
}

float f_611_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_5ef_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_5ef_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_5cd_a1_s(a2);
	if (!f_5ef_a2_b(a0, L1)) {
		L2 = 0;
	} else {
	...
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_7be_a3_f(L4 - L5, 0, 1));
	if (f_5ea_a1_b(a0)) {
		f_7f4_a1_v(-L5);
	}
	return L5;
...
bool f_65a_a1_b(object a0)
{
	float L0;
	if (!f_5ef_a2_b(a0, "health")) {
		return false;
	}
	if (f_5ea_a1_b(a0) && f_81c_a0_b()) {
		return false;
	}
...
bool f_6c4_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_6ba_a1_b(L0);
}
...
void f_6f9_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_795_a1_V(f_5db_a1_V(a0));
		object L1;
...
void f_73d_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
float f_7ad_a4_f(float a0, float a1, float a2, float a3)
{
	float L0;
	L0 = (-a1 - a3) / (2 * a0);
	if (L0 > 0) {
...
float f_7be_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_7c9_a3_b(float a0, float a1, float a2)
{
	return a0 >= a1 && a0 <= a2;
}

bool f_7d1_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_7fe_a1_v(a1);
	f_5fb_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_7f4_a1_v(float a0)
{
	object L0;
...
void f_811_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_78f_a0_o(), L0);
}

bool f_81c_a0_b(void)
{
	bool L0;
...
Vector f_86f_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
	...
	L2 = L0.y * 1000 - a2 * a2;
	L3 = L0 | L0;
	L4 = f_7a6_a3_f(L1, L2, L3);
	if (L4 < 0) {
		L5 = 1;
	} else {
		L5 = sqrt(f_7ad_a4_f(L1, L2, L3, sqrt(L4)));
	}
...
bool f_894_a2_b(object a0, object a1)
{
	return false;
}
...
void f_897_a1_v(object a0)
{
	...
	@GetScene(L0);
	L0->RemoveStationaryActor(f_78f_a0_o());
	t4{a0};
}
