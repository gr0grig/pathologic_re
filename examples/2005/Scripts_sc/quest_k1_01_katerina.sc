...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_4df_a0_i());
		L0->SetNPCDescription(f_4dd_a0_i());
		L0->SetPhoto(f_4e1_a0_s());
		L0->SetPhoto2(f_4e3_a0_s());
		L0->SetPlayerName(f_4cc_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
void f_267_a0_v(void)
{
	...
	L0 = f_40b_a0_i();
	for (L1 = 0; L1 < 5 && f_2ce_a0_b(); L1 = L1 + 1) {
		if (!L0) {
			bool L2;
			@Sleep(3, L2);
			if (!L2) {
			...
			@PlayAnimation("all", f_404_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_3ea_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_40b_a0_i(void)
{
	...
	for (L0 = 0; ; L0 = L0 + 1) {
		bool L1;
		@HasAnimation(L1, "all", f_404_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_41c_a2_v(object a0, object a1)
{
	...
	@SetVariable("k1q01", 1);
	L0 = f_49a_a0_o();
	L0->AddMark("k1q01KaterinaGotoAlexandr", "pt_map_alexandr", 1, 524727, f_3f6_a0_f());
	f_457_a0_v();
	f_464_a0_v();
	f_3ea_a2_b("quest_k1_01", "remove_katerina");
}

void f_43b_a2_v(object a0, object a1)
{
	f_4ab_a3_v(f_49a_a0_o(), "pt_map_alexandr", 2);
	a1->ShowMap(f_49a_a0_o());
}

bool f_44b_a1_b(object a0)
{
	if (f_3e5_a1_i("k1q01") == 0) {
		return true;
	}
	return false;
}
...
bool f_47e_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_4ab_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
string f_4e1_a0_s(void)
{
	return "ui/NPC_Katerina.png";
}

string f_4e3_a0_s(void)
{
	return "ui/NPC_Katerina_b.png";
}

bool f_4e5_a0_b(void)
{
	return true;
}
