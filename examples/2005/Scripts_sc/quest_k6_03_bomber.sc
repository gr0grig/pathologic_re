		...
		for (L1 = 0; L1 < 5 && f_5b5_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_65e_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
void f_689_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_6f6_a1_i("Money"), 0, L0);
}
...
void f_6d1_a0_v(void)
{
	...
	@AddItem(L1, f_6f6_a1_i("bomber_mark"), 0, 1);
}

int f_6f6_a1_i(string a0)
{
	int L0;
...
float f_70d_a3_f(Vector a0, Vector a1, Vector a2)
{
	float L0;
	float L1;
	float L2;
...
float f_74f_a2_f(int a0, float a1)
{
	if (a1 < 10) {
		return 10;
	} else {
...
void f_7df_a0_v(void)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_608_a0_o());
}

void f_7e9_a0_v(void)
{
}

bool f_7ea_a1_b(object a0)
{
	if (!f_50c_a1_b(a0)) {
		return false;
	}
	return f_4bc_a1_b(a0);
}
