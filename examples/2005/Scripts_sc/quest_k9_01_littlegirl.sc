...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_38a_a0_i());
		L0->SetNPCDescription(f_388_a0_i());
		L0->SetPhoto(f_38c_a0_s());
		L0->SetPhoto2(f_38e_a0_s());
...
void f_22f_a0_v(void)
{
	...
	L0 = f_399_a0_i();
	for (L1 = 0; L1 < 5 && f_28d_a0_b(); L1 = L1 + 1) {
		int L2;
		@irand(L2, 3);
		if (L2 == 0) {
			if (L0) {
...
bool f_292_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_30c_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	if (f_316_a1_i("k9q01ChildTalk") == 0) {
...
{
	if (f_316_a1_i("ook9Littlegirl1") == 0) {
		return true;
	}
	return false;
}
