...
maintask t0
{
	...
	void f_9d_a0_v(void)
	{
		@SendMessage(100 * f_88_a0_f(), "level");
	}
	...
	void f_c3_a0_v(void)
	{
		...
		for (; L1 < 4 + tv7; L1++) {
			if (L1 < L0) {
				...
				tv4->get(L4, L1);
				if (L3) {
					@SendMessage(16384, f_1f3_a1_s(L1 - tv7), L2);
				} else {
					@SendMessage(0, f_1f3_a1_s(L1 - tv7), L2);
				}
				@SendMessage(L3 | 65536, f_1f3_a1_s(L1 - tv7));
			} else {
				@SendMessage(32768, f_1f3_a1_s(L1 - tv7));
			}
		}
	}
		...
		if (a1 == "ok") {
			...
			if (a1 == "cancel") {
				...
				if (a1 == "scrollbar") {
					int L0;
					tv0->size(L0);
					tv7 = 0.009999999776482582 * (L0 - 4) * a0 + 0.5;
					if (tv7 < 0) {
						tv7 = 0;
					}
					f_a6_a0_v();
...
int f_208_a2_i(int a0, string a1)
{
	int L0;
	for (L0 = 0; L0 < 4; L0++) {
		if (a1 == f_1f3_a1_s(L0)) {
