...
void f_d2_a6_v(int a0, string a1, object a2, int a3, int a4, float a5)
{
	if (a0 == 1) {
		...
		if (a0 == 2) {
			f_3c7_a4_v(a3, a4, a2, a5);
		} else {
			if (a0 == 3) {
				f_278_a5_v(a3, a4, a2, true, a5);
			} else {
				if (a0 == 4) {
					f_278_a5_v(a3, a4, a2, false, a5);
				} else {
					if (a0 == 5) {
						f_442_a5_v(a3, a4, a1, a2, a5);
					}
				}
			}
		}
...
void f_155_a5_v(int a0, int a1, object a2, string a3, float a4)
{
	...
	f_10e_a5_v(L35, L36, 250, L6, a4);
	f_129_a4_v(L35 + 16, L36 + 16, a2, a4);
	L36 = L36 + 250;
...
void f_278_a5_v(int a0, int a1, object a2, bool a3, float a4)
{
	object L0;
	float L1;
	int L2;
...
void f_3c7_a4_v(int a0, int a1, object a2, float a3)
{
	if (!a2) {
		return;
	}
