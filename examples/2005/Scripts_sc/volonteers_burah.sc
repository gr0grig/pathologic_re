...
maintask t0
{
	...
	void f_66_a0_v(void)
	{
		if (!tv8 && f_47d_a1_b(12) && f_aee_a0_b() && f_475_a0_i() >= 8) {
			f_6_a1_v(f_467_a0_f());
			tv8 = true;
		}
		if (!tv9 && f_47d_a1_b(12) && f_aa2_a0_b()) {
			tv9 = true;
			f_15_a0_v();
		}
		if (!tv10 && f_47d_a1_b(12) && f_a7c_a0_b()) {
			tv10 = true;
			f_19_a0_v();
		}
		if (!tv11 && f_47d_a1_b(12) && f_ac8_a0_b()) {
			tv11 = true;
			f_11_a0_v();
		}
	}
...
void f_7ef_a3_v(object a0, bool a1, int a2)
{
	a0->add(18);
	a0->add(24);
	a0->add(20);
...
void f_810_a3_v(object a0, bool a1, int a2)
{
	a0->add(6);
	a0->add(26);
	a0->add(2);
...
void f_834_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
void f_854_a3_v(object a0, object a1, object a2)
{
	object L0;
	a0->add(1);
	if (a1) {
...
int f_a0e_a1_i(float a0)
{
	return f_a63_a3_i(522709, 522708, a0);
}

int f_a17_a1_i(float a0)
{
	return f_a63_a3_i(522711, 522710, a0);
}
...
bool f_a47_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
int f_a63_a3_i(int a0, int a1, float a2)
{
	int L0;
...
void f_a6b_a2_v(string a0, int a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
