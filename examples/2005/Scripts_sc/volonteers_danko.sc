...
maintask t0
{
	...
	{
		f_a13_a1_i(a0);
		f_45b_a2_b("quest_d12_01", "init_hidden_room");
	}
	...
	void f_21_a2_v(object a0, object a1)
	{
		...
		int L2;
		@CreateIntVector(L0);
		f_815_a3_v(L0, true, 0);
		@CreateIntVector(L1);
		f_7c9_a3_v(L1, true, 0);
		f_839_a3_v(L1, true, 0);
		for (L2 = 0; L2 < 12; L2++) {
			a0->add(L0);
			a1->add(L1);
		}
	...
	void f_66_a0_v(void)
	{
		if (!tv8 && f_47d_a1_b(12) && f_af3_a0_b() && f_475_a0_i() >= 8) {
			f_6_a1_v(f_467_a0_f());
			tv8 = true;
		}
		if (!tv9 && f_47d_a1_b(12) && f_aa7_a0_b()) {
			tv9 = true;
			f_15_a0_v();
		}
		if (!tv10 && f_47d_a1_b(12) && f_a81_a0_b()) {
			tv10 = true;
			f_16_a0_v();
		}
		if (!tv11 && f_47d_a1_b(12) && f_acd_a0_b()) {
			tv11 = true;
			f_11_a0_v();
		}
	}
...
void f_815_a3_v(object a0, bool a1, int a2)
{
	a0->add(6);
	a0->add(26);
	a0->add(2);
...
void f_839_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
void f_859_a3_v(object a0, object a1, object a2)
{
	object L0;
	a0->add(1);
	if (a1) {
...
int f_a13_a1_i(float a0)
{
	return f_a68_a3_i(515489, 515488, a0);
}

int f_a1c_a1_i(float a0)
{
	return f_a68_a3_i(515491, 515490, a0);
}

void f_a25_a0_v(void)
{
	object L0;
	@CreateDiaryEntry(L0, 708, 1, 535691);
	f_a4c_a2_b(L0, 706);
}

void f_a32_a0_v(void)
{
	object L0;
	@CreateDiaryEntry(L0, 709, 1, 535692);
	f_a4c_a2_b(L0, 707);
}

object f_a3f_a0_o(void)
{
	object L0;
	@GetDiaryRoot(L0);
	if (!L0) {
...
bool f_a4c_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
int f_a68_a3_i(int a0, int a1, float a2)
{
	int L0;
...
void f_a70_a2_v(string a0, int a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
bool f_a81_a0_b(void)
{
	...
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_a09_a1_b(L3) || f_9ff_a1_b(L3)) {
			return false;
		}
	}
	return true;
