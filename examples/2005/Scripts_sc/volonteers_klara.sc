...
maintask t0
{
	...
	{
		f_a18_a1_i(a0);
		f_45b_a2_b("quest_k12_01", "init_hidden_room");
	}
	...
	void f_21_a2_v(object a0, object a1)
	{
		...
		int L2;
		@CreateIntVector(L0);
		f_83e_a3_v(L0, true, 2);
		@CreateIntVector(L1);
		f_7c9_a3_v(L1, true, 2);
	...
	void f_66_a0_v(void)
	{
		if (!tv8 && f_47d_a1_b(12) && f_af8_a0_b() && f_475_a0_i() >= 8) {
			f_6_a1_v(f_467_a0_f());
			tv8 = true;
		}
		if (!tv9 && f_47d_a1_b(12) && f_aac_a0_b()) {
			tv9 = true;
			f_12_a0_v();
		}
		if (!tv10 && f_47d_a1_b(12) && f_a86_a0_b()) {
			tv10 = true;
			f_16_a0_v();
		}
		if (!tv11 && f_47d_a1_b(12) && f_ad2_a0_b()) {
			tv11 = true;
			f_11_a0_v();
		}
	}
	...
	void f_1b1_a0_v(void)
	{
		...
		for (L10 = 0; L10 < f_2d9_a0_i(); L10++) {
			...
			if (f_31f_a1_b(L10)) {
				@Trace(21);
				L9 = L9 + 1;
				@Trace("Diseased volonteer : " + f_627_a1_s(L11));
			}
		}
		@Trace(22);
...
void f_7c9_a3_v(object a0, bool a1, int a2)
{
	a0->add(18);
	a0->add(24);
	a0->add(20);
...
void f_83e_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
void f_85e_a3_v(object a0, object a1, object a2)
{
	object L0;
	a0->add(1);
	if (a1) {
...
int f_a18_a1_i(float a0)
{
	return f_a6d_a3_i(539371, 539370, a0);
}

int f_a21_a1_i(float a0)
{
	return f_a6d_a3_i(539373, 539372, a0);
}
...
bool f_a51_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
int f_a6d_a3_i(int a0, int a1, float a2)
{
	int L0;
...
void f_a75_a2_v(string a0, int a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
bool f_a86_a0_b(void)
{
	object L0;
	int L1;
	int L2;
	@CreateIntVector(L0);
	f_7c9_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_a0e_a1_b(L3) || f_a04_a1_b(L3)) {
			return false;
		}
	}
	return true;
...
bool f_ad2_a0_b(void)
{
	object L0;
	int L1;
	int L2;
	@CreateIntVector(L0);
	f_83e_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
