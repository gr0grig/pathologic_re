...
maintask TSobor
{
	...
	void OnLoad(void) {
		...
		if (iAglaja) {
			m_Aglaja = SpawnActor(self(), "pt_Aglaja", "NPC_Aglaja", "NPC_Klara_Aglaja.xml");
		...
		TriggerActor("quest_k12_01", "sobor_load");
		TriggerActor("quest_k5_04", "sobor_load");
	}
	...
	void OnUnload(void) {
		...
		TriggerActor("quest_k12_01", "sobor_unload");
		TriggerActor("quest_k5_04", "sobor_unload");
	}
