...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xad: Push("all") // @poff=138
0xae: Push("idle") // @poff=146
...
0x27d: Pop(0)
0x27e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x27f: Pop(1)
0x280: PushEmpty(int)
0x281: Call2 0x7ad

0x282: Pop(0)
0x283: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x284: Pop(1)
0x285: PushEmpty(string)
0x286: Call2 0x7b1

0x287: Pop(0)
0x288: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x289: Pop(1)
0x28a: PushEmpty(string)
0x28b: Call2 0x7b3

0x28c: Pop(0)
0x28d: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x28e: Pop(1)
0x28f: PushEmpty(int)
0x290: Call2 0x881

0x291: Pop(0)
0x292: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x293: Pop(1)
0x294: Stack[-2] = (int) -1
...
0x2a5: Stack[-11] = Stack[-2]
0x2a6: Stack[-6] = Stack[-1]
...
0x2af: @ sync()
0x2b0: Pop(0)
0x2b1: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2b2: Pop(0)
0x2b3: GOTO 0x2ad

0x2b4: PushEmpty(object)
0x2b5: Stack[-10] = Stack[-1]
0x2b6: Call2 0x66f

0x2b7: Pop(1)
0x2b8: @ StopDialog(Stack[-4])
0x2b9: Pop(0)
0x2ba: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2bb: Pop(0)
0x2bc: Stack[-2] = Stack[-10]
0x2bd: Return(); Pop(8)
...
0x2ea: Push("all") // @poff=138
0x2eb: Push("idle") // @poff=146
...
0x2f3: Push("all") // @poff=138
0x2f4: Push("idle") // @poff=146
...
0x348: Pop(0)
0x349: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x34a: Pop(1)
0x34b: PushEmpty(int)
0x34c: Call2 0x7ad

0x34d: Pop(0)
0x34e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x34f: Pop(1)
0x350: PushEmpty(string)
0x351: Call2 0x7b1

0x352: Pop(0)
0x353: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x354: Pop(1)
0x355: PushEmpty(string)
0x356: Call2 0x7b3

0x357: Pop(0)
0x358: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x359: Pop(1)
0x35a: PushEmpty(int)
0x35b: Call2 0x881

0x35c: Pop(0)
0x35d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x35e: Pop(1)
0x35f: Stack[-2] = (int) -1
...
0x375: Pop(2)
0x376: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x377: Pop(0)
...
0x37a: @ sync()
0x37b: Pop(0)
0x37c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x37d: Pop(0)
0x37e: GOTO 0x378

0x37f: PushEmpty(object)
0x380: Stack[-10] = Stack[-1]
0x381: Call2 0x66f

0x382: Pop(1)
0x383: @ StopDialog(Stack[-4])
0x384: Pop(0)
0x385: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x386: Pop(0)
0x387: Stack[-2] = Stack[-10]
0x388: Return(); Pop(8)
...
0x44b: Pop(0)
0x44c: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x44d: Pop(1)
0x44e: PushEmpty(int)
0x44f: Call2 0x7ad

0x450: Pop(0)
0x451: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x452: Pop(1)
0x453: PushEmpty(string)
0x454: Call2 0x7b1

0x455: Pop(0)
0x456: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x457: Pop(1)
0x458: PushEmpty(string)
0x459: Call2 0x7b3

0x45a: Pop(0)
0x45b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x45c: Pop(1)
0x45d: PushEmpty(int)
0x45e: Call2 0x881

0x45f: Pop(0)
0x460: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x461: Pop(1)
0x462: Stack[-2] = (int) -1
...
0x46e: Stack[-1] = Stack[-2]
0x46f: Pop(1)
0x470: Call2 0x681

0x471: Pop(2)
0x472: PushEmpty(object, object)
0x473: Stack[-11] = Stack[-2]
0x474: Stack[-6] = Stack[-1]
...
0x47d: @ sync()
0x47e: Pop(0)
0x47f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x480: Pop(0)
0x481: GOTO 0x47b

0x482: PushEmpty(object)
0x483: Stack[-10] = Stack[-1]
0x484: Call2 0x66f

0x485: Pop(1)
0x486: @ StopDialog(Stack[-4])
0x487: Pop(0)
0x488: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x489: Pop(0)
0x48a: Stack[-2] = Stack[-10]
0x48b: Return(); Pop(8)
...
0x4b8: Push("all") // @poff=138
0x4b9: Push("idle") // @poff=146
...
0x52a: Stack[-1] = 0
0x52b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x52c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x52d: @ RotateAsync(Stack[-2], Stack[-1])
0x52e: Pop(2)
0x52f: Return(); Pop(0)

0x530: PushEmpty(object, bool, object, bool)
0x531: Push("player") // @poff=170
...
0x60c: Pop(0)
0x60d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=184
0x60e: Pop(0)
...
0x61d: @@ GetPosition(Stack[-1]); Obj=3 // @poff=184
0x61e: Pop(0)
...
0x62b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=184
0x62c: Pop(0)
0x62d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=196
0x62e: Pop(0)
...
0x69a: Push("voice_common") // @poff=220
0x69b: Push((int) 1)
...
0x6a2: Push("voice_common") // @poff=220
0x6a3: Push((int) 0)
...
0x6b5: Push("voice_common") // @poff=220
0x6b6: Push((int) 1)
...
0x6c3: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=250
0x6c4: Pop(1)
...
0x6d8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=262
0x6d9: Pop(1)
0x6da: PushEmpty(bool, string)
0x6db: Stack[-3] = Stack[-1]
0x6dc: Call2 0x72a

0x6dd: Stack[-2] = Stack[-14]
0x6de: Pop(2)
0x6df: Return(); Pop(10)

0x6e0: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x6e1: Push("d") // @poff=216
0x6e2: PushEmpty(int)
0x6e3: Call2 0x786

0x6e4: Pop(0)
0x6e5: Pop(2); Push(Stack[-2] + Stack[-1]);
0x6e6: Push("m") // @poff=274
...
0x6ee: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=250
0x6ef: Pop(1)
...
0x703: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=262
0x704: Pop(1)
0x705: PushEmpty(bool, string)
0x706: Stack[-3] = Stack[-1]
0x707: Call2 0x72a

0x708: Stack[-2] = Stack[-14]
0x709: Pop(2)
0x70a: Return(); Pop(10)
...
0x716: Push("Can't find lsh animation : ") // @poff=278
...
0x725: Push("Can't find lsh animation : ") // @poff=278
...
0x749: Push((float)9.999999974752427e-07)
...
0x752: Pop(0)
0x753: Stack[-1] = Stack[-4]
0x754: Return(); Pop(2)

0x755: PushEmpty(object, object)
0x756: @ CreateIntVector(Stack[-1])
0x757: Pop(0)
0x758: @@ add(Stack[-4]); Obj=1 // @poff=334
0x759: Pop(0)
0x75a: @@ add(Stack[-3]); Obj=1 // @poff=334
0x75b: Pop(0)
0x75c: Push((int) 3)
...
0x762: @@ GetItemID(Stack[-3]); Obj=8 // @poff=338
0x763: Pop(0)
0x764: Push("Category") // @poff=348
0x765: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x766: Pop(1)
0x767: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=366
0x768: Pop(0)
0x769: Pop(0); Push((bool) Stack[-1] == 0)
0x76a: IF (Stack[-1] == 0) GOTO 0x76e; Pop(1)

0x76b: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=374
0x76c: Pop(0)
0x76d: GOTO 0x773

0x76e: PushEmpty(int, int)
0x76f: Stack[-5] = Stack[-2]
0x770: Stack[-9] = Stack[-1]
0x771: Call2 0x755
...
0x776: Pop(0)
0x777: @@ SetItemName(Stack[-4]); Obj=1 // @poff=384
0x778: Pop(0)
0x779: PushEmpty(object, object, int)
0x77a: Stack[-8] = Stack[-3]
0x77b: Stack[-4] = Stack[-2]
...
0x79d: Stack[-2] = (int) 0
0x79e: Push("all") // @poff=138
0x79f: PushEmpty(string, int)
0x7a0: Stack[-5] = Stack[-1]
0x7a1: Call2 0x795
...
0x7b1: Stack[-1] = "ui/NPC_Alexandr.png" // @poff=396
0x7b2: Return(); Pop(0)

0x7b3: Stack[-1] = "ui/NPC_Alexandr_b.png" // @poff=436
0x7b4: Return(); Pop(0)
...
0x7bf: Pop(1)
0x7c0: Push("b2q01AlexandrGotoOspina") // @poff=492
0x7c1: Push("pt_map_ospina") // @poff=540
0x7c2: Push((int) 1)
...
0x7c6: Pop(0)
0x7c7: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=568
0x7c8: Pop(5)
0x7c9: PushEmpty()
0x7ca: Call2 0x819
...
0x7cd: Stack[-1] = 0
0x7ce: PushEmpty()
0x7cf: Push("oob2Alexandr1") // @poff=576
0x7d0: Push((int) 1)
...
0x7d4: PushEmpty()
0x7d5: Push("oob2Alexandr2") // @poff=604
0x7d6: Push((int) 1)
...
0x7da: PushEmpty()
0x7db: Push("key is given") // @poff=632
0x7dc: @ Trace(Stack[-1])
0x7dd: Pop(1)
0x7de: PushEmpty(object, string, int)
0x7df: Stack[-5] = Stack[-3]
0x7e0: Stack[-2] = "b2q01_key" // @poff=658
0x7e1: Stack[-1] = (int) 1
0x7e2: Call2 0x774
...
0x7ea: Pop(1)
0x7eb: Stack[-2] = "pt_map_ospina" // @poff=540
0x7ec: Stack[-1] = (int) 2
0x7ed: Call2 0x860
...
0x7f1: Pop(0)
0x7f2: @@ ShowMap(Stack[-1]); Obj=2 // @poff=678
0x7f3: Pop(1)
0x7f4: Return(); Pop(0)

0x7f5: PushEmpty()
0x7f6: PushEmpty(int, string)
0x7f7: Stack[-1] = "b2q01" // @poff=480
0x7f8: Call2 0x750
...
0x803: Stack[-1] = "oob2Alexandr1" // @poff=576
0x804: Call2 0x750
...
0x80f: Stack[-1] = "oob2Alexandr2" // @poff=604
0x810: Call2 0x750
...
0x82b: Push("Can't retrieve diary root") // @poff=686
0x82c: @ Trace(Stack[-1])
0x82d: Pop(1)
0x82e: Stack[-3] = (bool) 0
0x82f: Return(); Pop(2)

0x830: Stack[-1] = Stack[-3]
0x831: Return(); Pop(2)
...
0x837: Pop(1)
0x838: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=738
0x839: Pop(0)
0x83a: Pop(0); Push((bool) Stack[-2] == 0)
0x83b: IF (Stack[-1] == 0) GOTO 0x842; Pop(1)

0x83c: Push("Can't find diary parent with id: ") // @poff=743
...
0x842: @@ AddChild(Stack[-8]); Obj=2 // @poff=811
0x843: Pop(0)
0x844: Push((int) 7)
0x845: @ SendWorldWndMessage(Stack[-1])
0x846: Pop(1)
0x847: @@ GetCategory(Stack[-1]); Obj=8 // @poff=820
0x848: Pop(0)
...
0x851: Pop(0)
0x852: Pop(0); PushNull((bool) Stack[-2] == 0)
0x853: IF (Stack[-1] == 0) GOTO 0x85a; Pop(1)

0x854: Push("Can't find main outdoor scene") // @poff=832
0x855: @ Trace(Stack[-1])
0x856: Pop(1)
0x857: Stack[-1] = 0
0x858: Stack[-1] = Stack[-5]
0x859: Return(); Pop(4)

0x85a: @@ GetMap(Stack[-1]); Obj=2 // @poff=892
0x85b: Pop(0)
0x85c: Stack[-1] = Stack[-5]
0x85d: Return(); Pop(4)
...
0x862: Pop(0)
0x863: Pop(0); PushNull((bool) Stack[-2] == 0)
0x864: IF (Stack[-1] == 0) GOTO 0x869; Pop(1)

0x865: Push("Can't find main outdoor scene") // @poff=832
0x866: @ Trace(Stack[-1])
0x867: Pop(1)
0x868: Return(); Pop(8)

0x869: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=899
0x86a: Pop(0)
0x86b: Pop(0); Push((bool) Stack[-1] == 0)
0x86c: IF (Stack[-1] == 0) GOTO 0x873; Pop(1)

0x86d: Push("Warning: outdoor scene locator ") // @poff=910
0x86e: Pop(1); Push(Stack[-1] + Stack[-11]);
0x86f: Push(" doesnt exist") // @poff=974
0x870: Pop(2); Push(Stack[-2] + Stack[-1]);
0x871: @ Trace(Stack[-1])
0x872: Pop(1)
0x873: @@ GetMap(Stack[-11]); Obj=2 // @poff=892
0x874: Pop(0)
0x875: Pop(0); PushNull((bool) Stack[-11] == 0)
0x876: IF (Stack[-1] == 0) GOTO 0x87b; Pop(1)

0x877: Push("Can't find map") // @poff=1002
0x878: @ Trace(Stack[-1])
0x879: Pop(1)
0x87a: Return(); Pop(8)
...
0x87d: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1032
0x87e: Pop(2)
0x87f: Return(); Pop(8)

0x880: Stack[-2] = 0
0x881: PushEmpty(int, int)
0x882: Push("branch") // @poff=1045
