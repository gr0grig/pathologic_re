...
Strings:
	...
	W:b5q01VeraDead
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x245: Stack[-1] = "Adoration" // @poff=176
0x246: Call2 0x18e
...
0x257: Stack[-1] = "Adoration" // @poff=176
0x258: Call2 0x18e
...
0x2f3: Stack[-1] = "Adoration" // @poff=176
0x2f4: Call2 0x18e
...
0x322: Pop(0)
0x323: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x324: Pop(1)
0x325: PushEmpty(int)
0x326: Call2 0x8b5

0x327: Pop(0)
0x328: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x329: Pop(1)
0x32a: PushEmpty(string)
0x32b: Call2 0x8b9

0x32c: Pop(0)
0x32d: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x32e: Pop(1)
0x32f: PushEmpty(string)
0x330: Call2 0x8bb

0x331: Pop(0)
0x332: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x333: Pop(1)
0x334: PushEmpty(int)
0x335: Call2 0x927

0x336: Pop(0)
0x337: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x338: Pop(1)
0x339: Stack[-2] = (int) -1
...
0x34a: Stack[-11] = Stack[-2]
0x34b: Stack[-6] = Stack[-1]
0x34c: Push(-2, 4); TaskCall(5)
0x34d: Call2 0x364

0x34e: Pop(-2, 4); TaskReturn
0x34f: Pop(2)
0x350: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x351: Pop(0)
...
0x354: @ sync()
0x355: Pop(0)
0x356: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x357: Pop(0)
0x358: GOTO 0x352
...
0x35e: Pop(0)
0x35f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x360: Pop(0)
0x361: Stack[-2] = Stack[-10]
0x362: Return(); Pop(8)
...
0x394: Push("all") // @poff=138
0x395: Push("idle") // @poff=146
...
0x39d: Push("all") // @poff=138
0x39e: Push("idle") // @poff=146
...
0x3fe: Stack[-1] = "Fear" // @poff=156
0x3ff: Call2 0x3a3

0x400: Pop(1)
0x401: Push((int) 530863)
0x402: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x403: Pop(1)
0x404: @@@ ClearReplies(); Obj=0 // @poff=116
0x405: Pop(0)
...
0x45b: Pop(0)
0x45c: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x45d: Pop(1)
0x45e: PushEmpty(int)
0x45f: Call2 0x8b5

0x460: Pop(0)
0x461: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x462: Pop(1)
0x463: PushEmpty(string)
0x464: Call2 0x8b9

0x465: Pop(0)
0x466: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x467: Pop(1)
0x468: PushEmpty(string)
0x469: Call2 0x8bb

0x46a: Pop(0)
0x46b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x46c: Pop(1)
0x46d: PushEmpty(int)
0x46e: Call2 0x927

0x46f: Pop(0)
0x470: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x471: Pop(1)
0x472: Stack[-2] = (int) -1
...
0x47e: Stack[-1] = Stack[-2]
0x47f: Pop(1)
0x480: Call2 0x79b

0x481: Pop(2)
0x482: PushEmpty(object, object)
0x483: Stack[-11] = Stack[-2]
0x484: Stack[-6] = Stack[-1]
0x485: Push(-2, 4); TaskCall(7)
0x486: Call2 0x49d

0x487: Pop(-2, 4); TaskReturn
0x488: Pop(2)
0x489: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x48a: Pop(0)
...
0x48d: @ sync()
0x48e: Pop(0)
0x48f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x490: Pop(0)
0x491: GOTO 0x48b

0x492: PushEmpty(object)
0x493: Stack[-10] = Stack[-1]
0x494: Call2 0x789

0x495: Pop(1)
0x496: @ StopDialog(Stack[-4])
0x497: Pop(0)
0x498: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x499: Pop(0)
...
0x4d6: Push("all") // @poff=138
0x4d7: Push("idle") // @poff=146
...
0x52f: Stack[-1] = "Neutral" // @poff=89
0x530: Call2 0x4dc

0x531: Pop(1)
0x532: Push((int) 535298)
0x533: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x534: Pop(1)
0x535: @@@ ClearReplies(); Obj=0 // @poff=116
0x536: Pop(0)
...
0x55e: Pop(0)
0x55f: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x560: Pop(1)
0x561: PushEmpty(int)
0x562: Call2 0x8b5

0x563: Pop(0)
0x564: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x565: Pop(1)
0x566: PushEmpty(string)
0x567: Call2 0x8b9

0x568: Pop(0)
0x569: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x56a: Pop(1)
0x56b: PushEmpty(string)
0x56c: Call2 0x8bb

0x56d: Pop(0)
0x56e: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x56f: Pop(1)
0x570: PushEmpty(int)
0x571: Call2 0x927

0x572: Pop(0)
0x573: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x574: Pop(1)
0x575: Stack[-2] = (int) -1
...
0x581: Stack[-1] = Stack[-2]
0x582: Pop(1)
0x583: Call2 0x79b

0x584: Pop(2)
0x585: PushEmpty(object, object)
0x586: Stack[-11] = Stack[-2]
0x587: Stack[-6] = Stack[-1]
0x588: Push(-2, 4); TaskCall(9)
0x589: Call2 0x5a0

0x58a: Pop(-2, 4); TaskReturn
0x58b: Pop(2)
0x58c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x58d: Pop(0)
...
0x596: Stack[-10] = Stack[-1]
0x597: Call2 0x789

0x598: Pop(1)
0x599: @ StopDialog(Stack[-4])
0x59a: Pop(0)
0x59b: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x59c: Pop(0)
0x59d: Stack[-2] = Stack[-10]
0x59e: Return(); Pop(8)
...
0x5cb: Push("all") // @poff=138
0x5cc: Push("idle") // @poff=146
...
0x5d4: Push("all") // @poff=138
0x5d5: Push("idle") // @poff=146
...
0x63d: Stack[-1] = 0
0x63e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x63f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x640: @ RotateAsync(Stack[-2], Stack[-1])
0x641: Pop(2)
0x642: Return(); Pop(0)

0x643: PushEmpty(object, bool, object, bool)
0x644: Push("player") // @poff=208
...
0x71f: Pop(0)
0x720: @@ GetPosition(Stack[-2]); Obj=7 // @poff=222
0x721: Pop(0)
...
0x726: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=234
0x727: Pop(0)
0x728: Pop(0); Push(Stack[-1] + Stack[-3]);
0x729: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=246
0x72a: Pop(1)
0x72b: Return(); Pop(2)
...
0x737: @@ GetPosition(Stack[-1]); Obj=3 // @poff=222
0x738: Pop(0)
0x739: PushEmpty(bool, cvector)
0x73a: Stack[-3] = Stack[-1]
0x73b: Call2 0x72c
...
0x745: @@ GetPosition(Stack[-8]); Obj=20 // @poff=222
0x746: Pop(0)
0x747: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=258
0x748: Pop(0)
...
0x7b4: Push("voice_common") // @poff=282
0x7b5: Push((int) 1)
...
0x7bc: Push("voice_common") // @poff=282
0x7bd: Push((int) 0)
...
0x7cf: Push("voice_common") // @poff=282
0x7d0: Push((int) 1)
...
0x7dd: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x7de: Pop(1)
...
0x808: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x809: Pop(1)
...
0x81d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=234
0x81e: Pop(1)
0x81f: PushEmpty(bool, string)
0x820: Stack[-3] = Stack[-1]
0x821: Call2 0x844

0x822: Stack[-2] = Stack[-14]
0x823: Pop(2)
0x824: Return(); Pop(10)
...
0x830: Push("Can't find lsh animation : ") // @poff=324
...
0x83f: Push("Can't find lsh animation : ") // @poff=324
...
0x863: Push((float)9.999999974752427e-07)
...
0x86c: Pop(0)
0x86d: Stack[-1] = Stack[-4]
0x86e: Return(); Pop(2)

0x86f: PushEmpty(object, object)
0x870: @ CreateIntVector(Stack[-1])
0x871: Pop(0)
0x872: @@ add(Stack[-4]); Obj=1 // @poff=380
0x873: Pop(0)
0x874: @@ add(Stack[-3]); Obj=1 // @poff=380
0x875: Pop(0)
0x876: Push((int) 3)
...
0x87d: Stack[-7] = Stack[-3]
0x87e: Stack[-2] = "money" // @poff=384
...
0x8b9: Stack[-1] = "ui/NPC_Anna.png" // @poff=408
0x8ba: Return(); Pop(0)

0x8bb: Stack[-1] = "ui/NPC_Anna_b.png" // @poff=440
0x8bc: Return(); Pop(0)
...
0x8cb: PushEmpty()
0x8cc: Push("money10000 is given") // @poff=492
0x8cd: @ Trace(Stack[-1])
0x8ce: Pop(1)
...
0x8d5: PushEmpty()
0x8d6: Push("playsound") // @poff=532
0x8d7: Push("givemoney") // @poff=552
0x8d8: @ TriggerWorld(Stack[-2], Stack[-1])
0x8d9: Pop(2)
0x8da: Return(); Pop(0)

0x8db: PushEmpty()
0x8dc: Push("oob6Anna1") // @poff=572
0x8dd: Push((int) 1)
...
0x8e1: PushEmpty()
0x8e2: Push("money3000 is given") // @poff=592
0x8e3: @ Trace(Stack[-1])
0x8e4: Pop(1)
0x8e5: PushEmpty(object, int)
0x8e6: Stack[-4] = Stack[-2]
...
0x8ed: Stack[-1] = "oob6Anna1" // @poff=572
0x8ee: Call2 0x86a
...
0x8f9: Stack[-1] = "b5q01TalkToVera" // @poff=630
0x8fa: Call2 0x86a
...
0x905: Stack[-1] = "b5q01VeraDead" // @poff=662
0x906: Call2 0x86a
...
0x911: Stack[-1] = "b5q01_1" // @poff=476
0x912: Call2 0x86a
...
0x91d: Stack[-1] = "b5q01_1" // @poff=476
0x91e: Call2 0x86a
