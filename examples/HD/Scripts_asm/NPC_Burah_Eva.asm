...
Strings:
	...
	W:init_factory
	W:oob1Eva2
	W:b1q01BakWillBeAt18
	W:pt_map_eva
	A:AddMark
	W:playsound
	W:giveitem
	W:rifle ammo30 is given
	W:rifle_ammo
	W:mapmark
	W:b9q01DankoAmmo
	...
	W:branch
	W:mt_eva
// @pool_raw:
// @pool_encoding:utf8
...
0x58: Stack[-1] = "Fear" // @poff=89
0x59: Call2 0x90

0x5a: Pop(1)
0x5b: Push((int) 518278)
0x5c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x5d: Pop(1)
0x5e: @@@ ClearReplies(); Obj=0 // @poff=110
0x5f: Pop(0)
...
0x66: Push((int) 20613)
0x67: Push((int) 20612)
0x68: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x69: Pop(3)
0x6a: Push((int) 518279)
0x6b: Push((int) -1)
0x6c: Push((int) 19388)
0x6d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x6e: Pop(3)
0x6f: GOTO 0x72
...
0x81: Push("all") // @poff=132
0x82: Push("idle") // @poff=140
...
0x8a: Push("all") // @poff=132
0x8b: Push("idle") // @poff=140
...
0xb8: Stack[-1] = "Fear" // @poff=89
0xb9: Call2 0x90

0xba: Pop(1)
0xbb: Push((int) 518278)
0xbc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xbd: Pop(1)
0xbe: @@@ ClearReplies(); Obj=0 // @poff=110
0xbf: Pop(0)
...
0xc6: Push((int) 20613)
0xc7: Push((int) 20612)
0xc8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xc9: Pop(3)
0xca: Push((int) 518279)
0xcb: Push((int) -1)
0xcc: Push((int) 19388)
0xcd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xce: Pop(3)
0xcf: Return(); Pop(0)
...
0xd4: Stack[-1] = "Love" // @poff=150
0xd5: Call2 0x90

0xd6: Pop(1)
0xd7: Push((int) 519445)
0xd8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xd9: Pop(1)
0xda: @@@ ClearReplies(); Obj=0 // @poff=110
0xdb: Pop(0)
0xdc: Push((int) 519446)
0xdd: Push((int) 20615)
0xde: Push((int) 20614)
0xdf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xe0: Pop(3)
0xe1: Push((int) 519450)
0xe2: Push((int) 20620)
0xe3: Push((int) 20618)
0xe4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xe5: Pop(3)
0xe6: Return(); Pop(0)
...
0xeb: Stack[-1] = "Love" // @poff=150
0xec: Call2 0x90

0xed: Pop(1)
0xee: Push((int) 519447)
0xef: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xf0: Pop(1)
0xf1: @@@ ClearReplies(); Obj=0 // @poff=110
0xf2: Pop(0)
0xf3: Push((int) 519451)
0xf4: Push((int) 20620)
0xf5: Push((int) 20619)
0xf6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xf7: Pop(3)
0xf8: Push((int) 519453)
0xf9: Push((int) 20620)
0xfa: Push((int) 20622)
0xfb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xfc: Pop(3)
0xfd: Return(); Pop(0)
...
0x102: Stack[-1] = "Fear" // @poff=89
0x103: Call2 0x90

0x104: Pop(1)
0x105: Push((int) 519452)
0x106: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x107: Pop(1)
0x108: @@@ ClearReplies(); Obj=0 // @poff=110
0x109: Pop(0)
0x10a: Push((int) 519448)
0x10b: Push((int) -1)
0x10c: Push((int) 20616)
0x10d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x10e: Pop(3)
0x10f: Push((int) 519449)
0x110: Push((int) -1)
0x111: Push((int) 20617)
0x112: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x113: Pop(3)
0x114: Return(); Pop(0)
...
0x131: Pop(0)
0x132: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x133: Pop(1)
0x134: PushEmpty(int)
0x135: Call2 0x982

0x136: Pop(0)
0x137: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x138: Pop(1)
0x139: PushEmpty(string)
0x13a: Call2 0x986

0x13b: Pop(0)
0x13c: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x13d: Pop(1)
0x13e: PushEmpty(string)
0x13f: Call2 0x988

0x140: Pop(0)
0x141: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x142: Pop(1)
0x143: PushEmpty(int)
0x144: Call2 0xac5

0x145: Pop(0)
0x146: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x147: Pop(1)
0x148: Stack[-2] = (int) -1
...
0x159: Stack[-11] = Stack[-2]
0x15a: Stack[-6] = Stack[-1]
0x15b: Push(-2, 4); TaskCall(3)
0x15c: Call2 0x173

0x15d: Pop(-2, 4); TaskReturn
0x15e: Pop(2)
0x15f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x160: Pop(0)
...
0x163: @ sync()
0x164: Pop(0)
0x165: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x166: Pop(0)
0x167: GOTO 0x161

0x168: PushEmpty(object)
0x169: Stack[-10] = Stack[-1]
0x16a: Call2 0x7f8

0x16b: Pop(1)
0x16c: @ StopDialog(Stack[-4])
0x16d: Pop(0)
0x16e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x16f: Pop(0)
0x170: Stack[-2] = Stack[-10]
0x171: Return(); Pop(8)
...
0x17a: Stack[-1] = "Fear" // @poff=89
0x17b: Call2 0x1e9

0x17c: Pop(1)
0x17d: Push((int) 520203)
0x17e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x17f: Pop(1)
0x180: @@@ ClearReplies(); Obj=0 // @poff=110
0x181: Pop(0)
...
0x18a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x18b: Pop(3)
...
0x1a4: IF (Stack[-1] == 1) GOTO 0x1bd; Pop(1)
...
0x1bb: IF (Stack[-1] == 1) GOTO 0x1bd; Pop(1)
...
0x1c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1c2: Pop(3)
0x1c3: Push((int) 520215)
0x1c4: Push((int) -1)
0x1c5: Push((int) 21407)
0x1c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1c7: Pop(3)
0x1c8: GOTO 0x1cb
...
0x1da: Push("all") // @poff=132
0x1db: Push("idle") // @poff=140
...
0x1e3: Push("all") // @poff=132
0x1e4: Push("idle") // @poff=140
...
0x240: Stack[-1] = "Fear" // @poff=89
0x241: Call2 0x1e9

0x242: Pop(1)
0x243: Push((int) 520203)
0x244: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x245: Pop(1)
0x246: @@@ ClearReplies(); Obj=0 // @poff=110
0x247: Pop(0)
...
0x250: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x251: Pop(3)
...
0x26a: IF (Stack[-1] == 1) GOTO 0x283; Pop(1)
...
0x281: IF (Stack[-1] == 1) GOTO 0x283; Pop(1)
...
0x287: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x288: Pop(3)
0x289: Push((int) 520215)
0x28a: Push((int) -1)
0x28b: Push((int) 21407)
0x28c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x28d: Pop(3)
0x28e: Return(); Pop(0)
...
0x293: Stack[-1] = "Fear" // @poff=89
0x294: Call2 0x1e9

0x295: Pop(1)
0x296: Push((int) 520212)
0x297: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x298: Pop(1)
0x299: @@@ ClearReplies(); Obj=0 // @poff=110
0x29a: Pop(0)
0x29b: Push((int) 520213)
0x29c: Push((int) 26114)
0x29d: Push((int) 21405)
0x29e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x29f: Pop(3)
...
0x2aa: Stack[-1] = "Fear" // @poff=89
0x2ab: Call2 0x1e9

0x2ac: Pop(1)
0x2ad: Push((int) 524804)
0x2ae: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2af: Pop(1)
0x2b0: @@@ ClearReplies(); Obj=0 // @poff=110
0x2b1: Pop(0)
0x2b2: Push((int) 524805)
0x2b3: Push((int) -1)
0x2b4: Push((int) 26115)
0x2b5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2b6: Pop(3)
0x2b7: Return(); Pop(0)
...
0x2bc: Stack[-1] = "Fear" // @poff=89
0x2bd: Call2 0x1e9

0x2be: Pop(1)
0x2bf: Push((int) 520205)
0x2c0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2c1: Pop(1)
0x2c2: @@@ ClearReplies(); Obj=0 // @poff=110
0x2c3: Pop(0)
0x2c4: Push((int) 520206)
0x2c5: Push((int) 21399)
0x2c6: Push((int) 21398)
0x2c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2c8: Pop(3)
0x2c9: Push((int) 520210)
0x2ca: Push((int) -1)
0x2cb: Push((int) 21402)
0x2cc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2cd: Pop(3)
0x2ce: Return(); Pop(0)
...
0x2d3: Stack[-1] = "Fear" // @poff=89
0x2d4: Call2 0x1e9

0x2d5: Pop(1)
0x2d6: Push((int) 520207)
0x2d7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2d8: Pop(1)
0x2d9: @@@ ClearReplies(); Obj=0 // @poff=110
0x2da: Pop(0)
0x2db: Push((int) 520208)
0x2dc: Push((int) -1)
0x2dd: Push((int) 21400)
0x2de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2df: Pop(3)
0x2e0: Push((int) 520209)
0x2e1: Push((int) -1)
0x2e2: Push((int) 21401)
0x2e3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2e4: Pop(3)
0x2e5: Return(); Pop(0)
...
0x302: Pop(0)
0x303: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x304: Pop(1)
0x305: PushEmpty(int)
0x306: Call2 0x982

0x307: Pop(0)
0x308: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x309: Pop(1)
0x30a: PushEmpty(string)
0x30b: Call2 0x986

0x30c: Pop(0)
0x30d: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x30e: Pop(1)
0x30f: PushEmpty(string)
0x310: Call2 0x988

0x311: Pop(0)
0x312: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x313: Pop(1)
0x314: PushEmpty(int)
0x315: Call2 0xac5

0x316: Pop(0)
0x317: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x318: Pop(1)
0x319: Stack[-2] = (int) -1
...
0x32f: Pop(2)
0x330: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x331: Pop(0)
...
0x334: @ sync()
0x335: Pop(0)
0x336: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x337: Pop(0)
0x338: GOTO 0x332

0x339: PushEmpty(object)
0x33a: Stack[-10] = Stack[-1]
0x33b: Call2 0x7f8

0x33c: Pop(1)
0x33d: @ StopDialog(Stack[-4])
0x33e: Pop(0)
0x33f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x340: Pop(0)
0x341: Stack[-2] = Stack[-10]
0x342: Return(); Pop(8)
...
0x34b: Stack[-1] = "Fear" // @poff=89
0x34c: Call2 0x37e

0x34d: Pop(1)
0x34e: Push((int) 520716)
0x34f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x350: Pop(1)
0x351: @@@ ClearReplies(); Obj=0 // @poff=110
0x352: Pop(0)
0x353: Push((int) 520717)
0x354: Push((int) 21929)
0x355: Push((int) 21928)
0x356: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x357: Pop(3)
0x358: Push((int) 520721)
0x359: Push((int) 21933)
0x35a: Push((int) 21932)
0x35b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x35c: Pop(3)
0x35d: GOTO 0x360
...
0x36f: Push("all") // @poff=132
0x370: Push("idle") // @poff=140
...
0x378: Push("all") // @poff=132
0x379: Push("idle") // @poff=140
...
0x39e: Stack[-1] = "Fear" // @poff=89
0x39f: Call2 0x37e

0x3a0: Pop(1)
0x3a1: Push((int) 520716)
0x3a2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3a3: Pop(1)
0x3a4: @@@ ClearReplies(); Obj=0 // @poff=110
0x3a5: Pop(0)
0x3a6: Push((int) 520717)
0x3a7: Push((int) 21929)
0x3a8: Push((int) 21928)
0x3a9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3aa: Pop(3)
0x3ab: Push((int) 520721)
0x3ac: Push((int) 21933)
0x3ad: Push((int) 21932)
0x3ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3af: Pop(3)
0x3b0: Return(); Pop(0)
...
0x3b5: Stack[-1] = "Fear" // @poff=89
0x3b6: Call2 0x37e

0x3b7: Pop(1)
0x3b8: Push((int) 520722)
0x3b9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3ba: Pop(1)
0x3bb: @@@ ClearReplies(); Obj=0 // @poff=110
0x3bc: Pop(0)
0x3bd: Push((int) 520723)
0x3be: Push((int) -1)
0x3bf: Push((int) 21934)
0x3c0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3c1: Pop(3)
0x3c2: Push((int) 520724)
0x3c3: Push((int) -1)
0x3c4: Push((int) 21935)
0x3c5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3c6: Pop(3)
0x3c7: Return(); Pop(0)
...
0x3cc: Stack[-1] = "Fear" // @poff=89
0x3cd: Call2 0x37e

0x3ce: Pop(1)
0x3cf: Push((int) 520718)
0x3d0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3d1: Pop(1)
0x3d2: @@@ ClearReplies(); Obj=0 // @poff=110
0x3d3: Pop(0)
0x3d4: Push((int) 520719)
0x3d5: Push((int) -1)
0x3d6: Push((int) 21930)
0x3d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3d8: Pop(3)
0x3d9: Push((int) 520720)
0x3da: Push((int) -1)
0x3db: Push((int) 21931)
0x3dc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3dd: Pop(3)
0x3de: Return(); Pop(0)
...
0x3fb: Pop(0)
0x3fc: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x3fd: Pop(1)
0x3fe: PushEmpty(int)
0x3ff: Call2 0x982

0x400: Pop(0)
0x401: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x402: Pop(1)
0x403: PushEmpty(string)
0x404: Call2 0x986

0x405: Pop(0)
0x406: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x407: Pop(1)
0x408: PushEmpty(string)
0x409: Call2 0x988

0x40a: Pop(0)
0x40b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x40c: Pop(1)
0x40d: PushEmpty(int)
0x40e: Call2 0xac5

0x40f: Pop(0)
0x410: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x411: Pop(1)
0x412: Stack[-2] = (int) -1
...
0x423: Stack[-11] = Stack[-2]
0x424: Stack[-6] = Stack[-1]
0x425: Push(-2, 4); TaskCall(7)
0x426: Call2 0x43d

0x427: Pop(-2, 4); TaskReturn
0x428: Pop(2)
0x429: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x42a: Pop(0)
...
0x42d: @ sync()
0x42e: Pop(0)
0x42f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x430: Pop(0)
0x431: GOTO 0x42b
...
0x437: Pop(0)
0x438: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x439: Pop(0)
0x43a: Stack[-2] = Stack[-10]
0x43b: Return(); Pop(8)
...
0x444: Stack[-1] = "Neutral" // @poff=160
0x445: Call2 0x48f

0x446: Pop(1)
0x447: Push((int) 521552)
0x448: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x449: Pop(1)
0x44a: @@@ ClearReplies(); Obj=0 // @poff=110
0x44b: Pop(0)
...
0x454: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x455: Pop(3)
...
0x46c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x46d: Pop(3)
0x46e: GOTO 0x471
...
0x480: Push("all") // @poff=132
0x481: Push("idle") // @poff=140
...
0x489: Push("all") // @poff=132
0x48a: Push("idle") // @poff=140
...
0x4dc: Stack[-1] = "Neutral" // @poff=160
0x4dd: Call2 0x48f

0x4de: Pop(1)
0x4df: Push((int) 521552)
0x4e0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x4e1: Pop(1)
0x4e2: @@@ ClearReplies(); Obj=0 // @poff=110
0x4e3: Pop(0)
...
0x4ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4ed: Pop(3)
...
0x4ff: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x500: Pop(3)
0x501: Push((int) 521556)
0x502: Push((int) -1)
0x503: Push((int) 22717)
0x504: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x505: Pop(3)
0x506: Return(); Pop(0)
...
0x50b: Stack[-1] = "Fear" // @poff=89
0x50c: Call2 0x48f

0x50d: Pop(1)
0x50e: Push((int) 521610)
0x50f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x510: Pop(1)
0x511: @@@ ClearReplies(); Obj=0 // @poff=110
0x512: Pop(0)
...
0x51d: Stack[-1] = "Fear" // @poff=89
0x51e: Call2 0x48f

0x51f: Pop(1)
0x520: Push((int) 522262)
0x521: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x522: Pop(1)
0x523: @@@ ClearReplies(); Obj=0 // @poff=110
0x524: Pop(0)
0x525: Push((int) 522263)
0x526: Push((int) 23418)
0x527: Push((int) 23415)
0x528: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x529: Pop(3)
...
0x534: Stack[-1] = "Love" // @poff=150
0x535: Call2 0x48f

0x536: Pop(1)
0x537: Push((int) 522265)
0x538: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x539: Pop(1)
0x53a: @@@ ClearReplies(); Obj=0 // @poff=110
0x53b: Pop(0)
0x53c: Push((int) 522269)
0x53d: Push((int) 23418)
0x53e: Push((int) 23421)
0x53f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x540: Pop(3)
...
0x54b: Stack[-1] = "Love" // @poff=150
0x54c: Call2 0x48f

0x54d: Pop(1)
0x54e: Push((int) 522266)
0x54f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x550: Pop(1)
0x551: @@@ ClearReplies(); Obj=0 // @poff=110
0x552: Pop(0)
0x553: Push((int) 522267)
0x554: Push((int) 23420)
0x555: Push((int) 23419)
0x556: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x557: Pop(3)
0x558: Return(); Pop(0)
...
0x55d: Stack[-1] = "Love" // @poff=150
0x55e: Call2 0x48f

0x55f: Pop(1)
0x560: Push((int) 522268)
0x561: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x562: Pop(1)
0x563: @@@ ClearReplies(); Obj=0 // @poff=110
0x564: Pop(0)
0x565: Push((int) 521611)
0x566: Push((int) -1)
0x567: Push((int) 22778)
0x568: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x569: Pop(3)
0x56a: Return(); Pop(0)
...
0x56f: Stack[-1] = "Fear" // @poff=89
0x570: Call2 0x48f

0x571: Pop(1)
0x572: Push((int) 521554)
0x573: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x574: Pop(1)
0x575: @@@ ClearReplies(); Obj=0 // @poff=110
0x576: Pop(0)
0x577: Push((int) 522257)
0x578: Push((int) 23410)
0x579: Push((int) 23409)
0x57a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x57b: Pop(3)
0x57c: Push((int) 521555)
0x57d: Push((int) -1)
0x57e: Push((int) 22716)
0x57f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x580: Pop(3)
0x581: Return(); Pop(0)
...
0x586: Stack[-1] = "Fear" // @poff=89
0x587: Call2 0x48f

0x588: Pop(1)
0x589: Push((int) 522258)
0x58a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x58b: Pop(1)
0x58c: @@@ ClearReplies(); Obj=0 // @poff=110
0x58d: Pop(0)
0x58e: Push((int) 522259)
0x58f: Push((int) -1)
0x590: Push((int) 23411)
0x591: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x592: Pop(3)
0x593: Push((int) 522260)
0x594: Push((int) -1)
0x595: Push((int) 23412)
0x596: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x597: Pop(3)
0x598: Return(); Pop(0)
...
0x5b5: Pop(0)
0x5b6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x5b7: Pop(1)
0x5b8: PushEmpty(int)
0x5b9: Call2 0x982

0x5ba: Pop(0)
0x5bb: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x5bc: Pop(1)
0x5bd: PushEmpty(string)
0x5be: Call2 0x986

0x5bf: Pop(0)
0x5c0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x5c1: Pop(1)
0x5c2: PushEmpty(string)
0x5c3: Call2 0x988

0x5c4: Pop(0)
0x5c5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x5c6: Pop(1)
0x5c7: PushEmpty(int)
0x5c8: Call2 0xac5

0x5c9: Pop(0)
0x5ca: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x5cb: Pop(1)
0x5cc: Stack[-2] = (int) -1
...
0x5de: Stack[-6] = Stack[-1]
0x5df: Push(-2, 4); TaskCall(9)
0x5e0: Call2 0x5f7

0x5e1: Pop(-2, 4); TaskReturn
0x5e2: Pop(2)
0x5e3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5e4: Pop(0)
...
0x5e7: @ sync()
0x5e8: Pop(0)
0x5e9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5ea: Pop(0)
0x5eb: GOTO 0x5e5

0x5ec: PushEmpty(object)
0x5ed: Stack[-10] = Stack[-1]
0x5ee: Call2 0x7f8

0x5ef: Pop(1)
0x5f0: @ StopDialog(Stack[-4])
0x5f1: Pop(0)
0x5f2: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x5f3: Pop(0)
0x5f4: Stack[-2] = Stack[-10]
0x5f5: Return(); Pop(8)
...
0x5fe: Stack[-1] = "Neutral" // @poff=160
0x5ff: Call2 0x631

0x600: Pop(1)
0x601: Push((int) 540551)
0x602: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x603: Pop(1)
0x604: @@@ ClearReplies(); Obj=0 // @poff=110
0x605: Pop(0)
0x606: Push((int) 540552)
0x607: Push((int) -1)
0x608: Push((int) 42561)
0x609: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x60a: Pop(3)
0x60b: Push((int) 540795)
0x60c: Push((int) -1)
0x60d: Push((int) 42844)
0x60e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x60f: Pop(3)
0x610: GOTO 0x613
...
0x622: Push("all") // @poff=132
0x623: Push("idle") // @poff=140
...
0x62b: Push("all") // @poff=132
0x62c: Push("idle") // @poff=140
...
0x651: Stack[-1] = "Neutral" // @poff=160
0x652: Call2 0x631

0x653: Pop(1)
0x654: Push((int) 540551)
0x655: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x656: Pop(1)
0x657: @@@ ClearReplies(); Obj=0 // @poff=110
0x658: Pop(0)
0x659: Push((int) 540552)
0x65a: Push((int) -1)
0x65b: Push((int) 42561)
0x65c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x65d: Pop(3)
0x65e: Push((int) 540795)
0x65f: Push((int) -1)
0x660: Push((int) 42844)
0x661: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x662: Pop(3)
0x663: Return(); Pop(0)
...
0x68e: Stack[-2] = Stack[-5]
0x68f: Pop(2)
0x690: Return(); Pop(2)

0x691: Stack[-1] = 0
0x692: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x693: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x694: @ RotateAsync(Stack[-2], Stack[-1])
0x695: Pop(2)
0x696: Return(); Pop(0)

0x697: PushEmpty(object, bool, object, bool)
0x698: Push("player") // @poff=176
...
0x6f5: Stack[-1] = "Neutral" // @poff=160
0x6f6: Call2 0x894
...
0x704: Stack[-1] = "Neutral" // @poff=160
0x705: Call2 0x894
...
0x71b: Stack[-1] = "Neutral" // @poff=160
0x71c: Call2 0x894
...
0x74f: Stack[-3] = (int) 0
0x750: Push("all") // @poff=132
0x751: PushEmpty(string, int)
0x752: Stack[-6] = Stack[-1]
0x753: Call2 0x96a
...
0x773: Pop(0)
0x774: @@ GetPosition(Stack[-2]); Obj=7 // @poff=190
0x775: Pop(0)
...
0x77a: Push("HasProperty") // @poff=202
0x77b: Push((int) 2)
...
0x781: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=226
0x782: Pop(0)
0x783: Stack[-1] = Stack[-5]
0x784: Return(); Pop(2)

0x785: PushEmpty(float, float)
0x786: PushEmpty(bool, object, string)
0x787: Stack[-10] = Stack[-2]
0x788: Stack[-9] = Stack[-1]
0x789: Call2 0x779
...
0x78f: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=238
0x790: Pop(0)
0x791: PushEmpty(float, float, float, float)
0x792: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x793: Stack[-8] = Stack[-2]
0x794: Stack[-7] = Stack[-1]
0x795: Call2 0x8d9

0x796: Pop(3)
0x797: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=250
0x798: Pop(1)
...
0x7a2: Pop(2)
0x7a3: Stack[-1] = Stack[-8]
0x7a4: Return(); Pop(6)

0x7a5: PushEmpty(cvector, cvector)
0x7a6: @@ GetPosition(Stack[-1]); Obj=3 // @poff=190
0x7a7: Pop(0)
...
0x7b4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=190
0x7b5: Pop(0)
0x7b6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=262
0x7b7: Pop(0)
...
0x823: Push("voice_common") // @poff=286
0x824: Push((int) 1)
...
0x82b: Push("voice_common") // @poff=286
0x82c: Push((int) 0)
...
0x83e: Push("voice_common") // @poff=286
0x83f: Push((int) 1)
...
0x84c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=226
0x84d: Pop(1)
...
0x877: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=226
0x878: Pop(1)
...
0x88c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=238
0x88d: Pop(1)
0x88e: PushEmpty(bool, string)
0x88f: Stack[-3] = Stack[-1]
0x890: Call2 0x8b3

0x891: Stack[-2] = Stack[-14]
0x892: Pop(2)
0x893: Return(); Pop(10)
...
0x89f: Push("Can't find lsh animation : ") // @poff=320
...
0x8ae: Push("Can't find lsh animation : ") // @poff=320
...
0x8d2: Push((float)9.999999974752427e-07)
...
0x8f6: @@ GetItemID(Stack[-3]); Obj=8 // @poff=380
0x8f7: Pop(0)
0x8f8: Push("Category") // @poff=390
0x8f9: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x8fa: Pop(1)
0x8fb: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=408
0x8fc: Pop(0)
0x8fd: Pop(0); Push((bool) Stack[-1] == 0)
0x8fe: IF (Stack[-1] == 0) GOTO 0x902; Pop(1)

0x8ff: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=416
0x900: Pop(0)
0x901: GOTO 0x907

0x902: PushEmpty(int, int)
0x903: Stack[-5] = Stack[-2]
0x904: Stack[-9] = Stack[-1]
0x905: Call2 0x8e9
...
0x90a: Pop(0)
0x90b: @@ SetItemName(Stack[-4]); Obj=1 // @poff=426
0x90c: Pop(0)
0x90d: PushEmpty(object, object, int)
0x90e: Stack[-8] = Stack[-3]
0x90f: Stack[-4] = Stack[-2]
0x910: Stack[-6] = Stack[-1]
0x911: Call2 0x8f5
...
0x92b: Stack[-2] = Stack[-1]
0x92c: Call2 0x938

0x92d: Pop(1)
0x92e: PushEmpty(bool, object, string, float, float, float)
0x92f: Stack[-8] = Stack[-5]
0x930: Stack[-4] = "reputation" // @poff=438
0x931: Stack[-7] = Stack[-3]
0x932: Stack[-2] = (int) 0
0x933: Stack[-1] = (int) 1
0x934: Call2 0x785
...
0x93a: Pop(0)
0x93b: @@ add(Stack[-3]); Obj=1 // @poff=376
0x93c: Pop(0)
0x93d: Push((int) 16)
...
0x944: Pop(0)
0x945: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x986: Stack[-1] = "ui/NPC_Eva.png" // @poff=460
0x987: Return(); Pop(0)

0x988: Stack[-1] = "ui/NPC_Eva_b.png" // @poff=490
0x989: Return(); Pop(0)
...
0x9a7: Stack[-2] = "quest_b9_01" // @poff=590
0x9a8: Stack[-1] = "place_mdoberman" // @poff=614
0x9a9: Call2 0x942

0x9aa: Pop(3)
0x9ab: PushEmpty(bool, string, string)
0x9ac: Stack[-2] = "quest_b9_01" // @poff=590
0x9ad: Stack[-1] = "init_factory" // @poff=646
0x9ae: Call2 0x942
...
0x9b3: Stack[-5] = Stack[-2]
0x9b4: Stack[-1] = (float) -0.05000000074505806
0x9b5: Call2 0x915
...
0x9c2: Pop(1)
0x9c3: Push("b1q01BakWillBeAt18") // @poff=690
0x9c4: Push("pt_map_eva") // @poff=728
0x9c5: Push((int) 3)
...
0x9c9: Pop(0)
0x9ca: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=750
0x9cb: Pop(5)
0x9cc: Return(); Pop(2)

0x9cd: Stack[-1] = 0
0x9ce: PushEmpty()
0x9cf: Push("playsound") // @poff=758
0x9d0: Push("giveitem") // @poff=778
0x9d1: @ TriggerWorld(Stack[-2], Stack[-1])
0x9d2: Pop(2)
0x9d3: Return(); Pop(0)

0x9d4: PushEmpty()
0x9d5: Push("rifle ammo30 is given") // @poff=796
0x9d6: @ Trace(Stack[-1])
0x9d7: Pop(1)
0x9d8: PushEmpty(object, string, int)
0x9d9: Stack[-5] = Stack[-3]
0x9da: Stack[-2] = "rifle_ammo" // @poff=840
...
0x9e1: Stack[-5] = Stack[-2]
0x9e2: Stack[-1] = (float) -0.019999999552965164
0x9e3: Call2 0x915
...
0x9e6: PushEmpty()
0x9e7: Push("playsound") // @poff=758
0x9e8: Push("mapmark") // @poff=862
...
0x9fa: Stack[-1] = "oob9Eva1" // @poff=560
0x9fb: Call2 0x8e4
...
0xa06: Stack[-1] = "b9q01DankoAmmo" // @poff=878
0xa07: Call2 0x8e4
...
0xa12: Stack[-1] = "oob1Eva2" // @poff=672
0xa13: Call2 0x8e4
...
0xa1e: Stack[-1] = "b1q01GrifToldAboutDanko" // @poff=908
0xa1f: Call2 0x8e4
...
0xa3e: Stack[-1] = "oob1Eva1" // @poff=524
0xa3f: Call2 0x8e4
...
0xa4a: Stack[-1] = "oob2Eva1" // @poff=542
0xa4b: Call2 0x8e4
...
0xa90: Push("Can't retrieve diary root") // @poff=956
0xa91: @ Trace(Stack[-1])
0xa92: Pop(1)
0xa93: Stack[-3] = (bool) 0
0xa94: Return(); Pop(2)

0xa95: Stack[-1] = Stack[-3]
0xa96: Return(); Pop(2)
...
0xa9c: Pop(1)
0xa9d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1008
0xa9e: Pop(0)
0xa9f: Pop(0); Push((bool) Stack[-2] == 0)
0xaa0: IF (Stack[-1] == 0) GOTO 0xaa7; Pop(1)

0xaa1: Push("Can't find diary parent with id: ") // @poff=1013
...
0xaa7: @@ AddChild(Stack[-8]); Obj=2 // @poff=1081
0xaa8: Pop(0)
0xaa9: Push((int) 7)
0xaaa: @ SendWorldWndMessage(Stack[-1])
0xaab: Pop(1)
0xaac: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1090
0xaad: Pop(0)
...
0xab6: Pop(0)
0xab7: Pop(0); PushNull((bool) Stack[-2] == 0)
0xab8: IF (Stack[-1] == 0) GOTO 0xabf; Pop(1)

0xab9: Push("Can't find main outdoor scene") // @poff=1102
0xaba: @ Trace(Stack[-1])
0xabb: Pop(1)
0xabc: Stack[-1] = 0
0xabd: Stack[-1] = Stack[-5]
0xabe: Return(); Pop(4)

0xabf: @@ GetMap(Stack[-1]); Obj=2 // @poff=1162
0xac0: Pop(0)
0xac1: Stack[-1] = Stack[-5]
0xac2: Return(); Pop(4)

0xac3: Stack[-1] = 0
0xac4: Stack[-2] = 0
0xac5: PushEmpty(int, int)
0xac6: Push("branch") // @poff=1169
