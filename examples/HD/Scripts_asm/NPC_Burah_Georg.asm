...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1b5: Push("all") // @poff=138
0x1b6: Push("idle") // @poff=146
...
0x398: Stack[-1] = "Neutral" // @poff=89
0x399: Call2 0x1bb

0x39a: Pop(1)
0x39b: Push((int) 523958)
0x39c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x39d: Pop(1)
0x39e: @@@ ClearReplies(); Obj=0 // @poff=116
0x39f: Pop(0)
...
0x40e: Stack[-1] = "Jeer" // @poff=178
0x40f: Call2 0x1bb

0x410: Pop(1)
0x411: Push((int) 523974)
0x412: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x413: Pop(1)
0x414: @@@ ClearReplies(); Obj=0 // @poff=116
0x415: Pop(0)
...
0x449: Stack[-1] = "Grin" // @poff=156
0x44a: Call2 0x1bb

0x44b: Pop(1)
0x44c: Push((int) 523972)
0x44d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x44e: Pop(1)
0x44f: @@@ ClearReplies(); Obj=0 // @poff=116
0x450: Pop(0)
...
0x478: Pop(0)
0x479: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x47a: Pop(1)
0x47b: PushEmpty(int)
0x47c: Call2 0x8d7

0x47d: Pop(0)
0x47e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x47f: Pop(1)
0x480: PushEmpty(string)
0x481: Call2 0x8db

0x482: Pop(0)
0x483: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x484: Pop(1)
0x485: PushEmpty(string)
0x486: Call2 0x8dd

0x487: Pop(0)
0x488: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x489: Pop(1)
0x48a: PushEmpty(int)
0x48b: Call2 0x9ef

0x48c: Pop(0)
0x48d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x48e: Pop(1)
0x48f: Stack[-2] = (int) -1
...
0x4a5: Pop(2)
0x4a6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4a7: Pop(0)
...
0x4aa: @ sync()
0x4ab: Pop(0)
0x4ac: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4ad: Pop(0)
0x4ae: GOTO 0x4a8

0x4af: PushEmpty(object)
0x4b0: Stack[-10] = Stack[-1]
0x4b1: Call2 0x7a6

0x4b2: Pop(1)
0x4b3: @ StopDialog(Stack[-4])
0x4b4: Pop(0)
0x4b5: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4b6: Pop(0)
0x4b7: Stack[-2] = Stack[-10]
0x4b8: Return(); Pop(8)
...
0x4c1: Stack[-1] = "Neutral" // @poff=89
0x4c2: Call2 0x4f9

0x4c3: Pop(1)
0x4c4: Push((int) 535231)
0x4c5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x4c6: Pop(1)
0x4c7: @@@ ClearReplies(); Obj=0 // @poff=116
0x4c8: Pop(0)
...
0x4f3: Push("all") // @poff=138
0x4f4: Push("idle") // @poff=146
...
0x535: Stack[-1] = "Neutral" // @poff=89
0x536: Call2 0x4f9

0x537: Pop(1)
0x538: Push((int) 535277)
0x539: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x53a: Pop(1)
0x53b: @@@ ClearReplies(); Obj=0 // @poff=116
0x53c: Pop(0)
...
0x57b: Pop(0)
0x57c: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x57d: Pop(1)
0x57e: PushEmpty(int)
0x57f: Call2 0x8d7

0x580: Pop(0)
0x581: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x582: Pop(1)
0x583: PushEmpty(string)
0x584: Call2 0x8db

0x585: Pop(0)
0x586: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x587: Pop(1)
0x588: PushEmpty(string)
0x589: Call2 0x8dd

0x58a: Pop(0)
0x58b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x58c: Pop(1)
0x58d: PushEmpty(int)
0x58e: Call2 0x9ef

0x58f: Pop(0)
0x590: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x591: Pop(1)
0x592: Stack[-2] = (int) -1
...
0x5a8: Pop(2)
0x5a9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5aa: Pop(0)
...
0x5ad: @ sync()
0x5ae: Pop(0)
0x5af: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5b0: Pop(0)
0x5b1: GOTO 0x5ab

0x5b2: PushEmpty(object)
0x5b3: Stack[-10] = Stack[-1]
0x5b4: Call2 0x7a6

0x5b5: Pop(1)
0x5b6: @ StopDialog(Stack[-4])
0x5b7: Pop(0)
0x5b8: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x5b9: Pop(0)
0x5ba: Stack[-2] = Stack[-10]
0x5bb: Return(); Pop(8)
...
0x617: Stack[-1] = "Neutral" // @poff=89
0x618: Call2 0x5f7

0x619: Pop(1)
0x61a: Push((int) 540554)
0x61b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x61c: Pop(1)
0x61d: @@@ ClearReplies(); Obj=0 // @poff=116
0x61e: Pop(0)
...
0x657: Stack[-2] = Stack[-5]
0x658: Pop(2)
0x659: Return(); Pop(2)

0x65a: Stack[-1] = 0
0x65b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x65c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x65d: @ RotateAsync(Stack[-2], Stack[-1])
0x65e: Pop(2)
0x65f: Return(); Pop(0)

0x660: PushEmpty(object, bool, object, bool)
0x661: Push("player") // @poff=188
...
0x73c: Pop(0)
0x73d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x73e: Pop(0)
...
0x743: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=214
0x744: Pop(0)
0x745: Pop(0); Push(Stack[-1] + Stack[-3]);
0x746: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=226
0x747: Pop(1)
0x748: Return(); Pop(2)
...
0x754: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x755: Pop(0)
0x756: PushEmpty(bool, cvector)
0x757: Stack[-3] = Stack[-1]
0x758: Call2 0x749

0x759: Stack[-2] = Stack[-6]
0x75a: Pop(2)
0x75b: Return(); Pop(2)
...
0x762: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x763: Pop(0)
0x764: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x765: Pop(0)
...
0x7d1: Push("voice_common") // @poff=262
0x7d2: Push((int) 1)
...
0x7d9: Push("voice_common") // @poff=262
0x7da: Push((int) 0)
...
0x7ec: Push("voice_common") // @poff=262
0x7ed: Push((int) 1)
...
0x7fa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x7fb: Pop(1)
...
0x825: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x826: Pop(1)
...
0x83a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=214
0x83b: Pop(1)
0x83c: PushEmpty(bool, string)
0x83d: Stack[-3] = Stack[-1]
0x83e: Call2 0x861

0x83f: Stack[-2] = Stack[-14]
0x840: Pop(2)
0x841: Return(); Pop(10)
...
0x84d: Push("Can't find lsh animation : ") // @poff=308
...
0x85c: Push("Can't find lsh animation : ") // @poff=308
...
0x880: Push((float)9.999999974752427e-07)
...
0x889: Pop(0)
0x88a: Stack[-1] = Stack[-4]
0x88b: Return(); Pop(2)

0x88c: PushEmpty(object, object)
0x88d: @ CreateIntVector(Stack[-1])
0x88e: Pop(0)
0x88f: @@ add(Stack[-4]); Obj=1 // @poff=364
0x890: Pop(0)
0x891: @@ add(Stack[-3]); Obj=1 // @poff=364
0x892: Pop(0)
0x893: Push((int) 3)
...
0x89a: Stack[-7] = Stack[-3]
0x89b: Stack[-2] = "money" // @poff=368
0x89c: Stack[-6] = Stack[-1]
0x89d: Call2 0x742
...
0x8a2: Push("Money") // @poff=380
0x8a3: @ GetInvItemByName(Stack[-2], Stack[-1])
0x8a4: Pop(1)
0x8a5: PushEmpty(int, int)
0x8a6: Stack[-3] = Stack[-2]
0x8a7: Stack[-5] = Stack[-1]
0x8a8: Call2 0x88c
...
0x8db: Stack[-1] = "ui/NPC_Georg.png" // @poff=392
0x8dc: Return(); Pop(0)

0x8dd: Stack[-1] = "ui/NPC_Georg_b.png" // @poff=426
0x8de: Return(); Pop(0)
...
0x8e9: Pop(1)
0x8ea: Push("b8q03GeorgGotoKaterina") // @poff=476
0x8eb: Push("pt_map_katerina") // @poff=522
0x8ec: Push((int) 0)
...
0x8f0: Pop(0)
0x8f1: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=554
0x8f2: Pop(5)
0x8f3: PushEmpty()
0x8f4: Call2 0x981
...
0x8fa: Stack[-1] = 0
0x8fb: PushEmpty()
0x8fc: Push("oob8Georg1") // @poff=562
0x8fd: Push((int) 1)
...
0x901: PushEmpty()
0x902: Push("oob8Georg2") // @poff=584
0x903: Push((int) 1)
...
0x907: PushEmpty()
0x908: Push("playsound") // @poff=606
0x909: Push("givemoney") // @poff=626
0x90a: @ TriggerWorld(Stack[-2], Stack[-1])
0x90b: Pop(2)
0x90c: Return(); Pop(0)

0x90d: PushEmpty()
0x90e: Push("b8GeorgVisit") // @poff=646
0x90f: Push((int) 1)
...
0x925: PushEmpty()
0x926: Push("money3000 is given") // @poff=672
0x927: @ Trace(Stack[-1])
0x928: Pop(1)
...
0x931: Stack[-1] = "oob8Georg1" // @poff=562
0x932: Call2 0x887
...
0x952: Stack[-1] = "b8q03MladVladIsVictim" // @poff=710
0x953: Call2 0x887
...
0x969: Stack[-1] = "b8q03MladVladIsVictim" // @poff=710
0x96a: Call2 0x887
...
0x977: Stack[-1] = "oob8Georg2" // @poff=584
0x978: Call2 0x887
...
0x9ba: Push("Can't retrieve diary root") // @poff=754
0x9bb: @ Trace(Stack[-1])
0x9bc: Pop(1)
0x9bd: Stack[-3] = (bool) 0
0x9be: Return(); Pop(2)

0x9bf: Stack[-1] = Stack[-3]
0x9c0: Return(); Pop(2)
...
0x9c6: Pop(1)
0x9c7: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=806
0x9c8: Pop(0)
0x9c9: Pop(0); Push((bool) Stack[-2] == 0)
0x9ca: IF (Stack[-1] == 0) GOTO 0x9d1; Pop(1)

0x9cb: Push("Can't find diary parent with id: ") // @poff=811
...
0x9d1: @@ AddChild(Stack[-8]); Obj=2 // @poff=879
0x9d2: Pop(0)
0x9d3: Push((int) 7)
0x9d4: @ SendWorldWndMessage(Stack[-1])
0x9d5: Pop(1)
0x9d6: @@ GetCategory(Stack[-1]); Obj=8 // @poff=888
0x9d7: Pop(0)
...
0x9e0: Pop(0)
0x9e1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x9e2: IF (Stack[-1] == 0) GOTO 0x9e9; Pop(1)

0x9e3: Push("Can't find main outdoor scene") // @poff=900
0x9e4: @ Trace(Stack[-1])
0x9e5: Pop(1)
0x9e6: Stack[-1] = 0
0x9e7: Stack[-1] = Stack[-5]
0x9e8: Return(); Pop(4)

0x9e9: @@ GetMap(Stack[-1]); Obj=2 // @poff=960
0x9ea: Pop(0)
0x9eb: Stack[-1] = Stack[-5]
0x9ec: Return(); Pop(4)

0x9ed: Stack[-1] = 0
0x9ee: Stack[-2] = 0
0x9ef: PushEmpty(int, int)
0x9f0: Push("branch") // @poff=967
