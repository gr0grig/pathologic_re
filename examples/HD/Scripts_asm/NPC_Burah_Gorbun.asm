...
Strings:
	...
	W:branch
	W:mt_gorbun
// @pool_raw:
...
0xf1: Push("ptidle") // @poff=48
0xf2: Stack[-8] = Stack[-1] + Stack[-16]; Pop(1);
0xf3: GOTO 0xf5

0xf4: Stack[-7] = "ptidle" // @poff=48
...
0xfc: Stack[-7] = Stack[-1]
0xfd: Call2 0x130

0xfe: Stack[-2] = Stack[-6]
0xff: Pop(2)
0x100: @ irand(Stack[-3], Stack[-4])
0x101: Pop(0)
0x102: Push("all") // @poff=16
0x103: PushEmpty(string, string, int)
0x104: Stack[-9] = Stack[-2]
0x105: Stack[-7] = Stack[-1]
0x106: Call2 0x128
...
0x131: Stack[-2] = (int) 0
0x132: Push("all") // @poff=16
0x133: PushEmpty(string, string, int)
0x134: Stack[-9] = Stack[-2]
...
0x151: Pop(0)
0x152: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=62
0x153: Pop(1)
0x154: PushEmpty(int)
0x155: Call2 0x7df

0x156: Pop(0)
0x157: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=73
0x158: Pop(1)
0x159: PushEmpty(string)
0x15a: Call2 0x7e3

0x15b: Pop(0)
0x15c: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=91
0x15d: Pop(1)
0x15e: PushEmpty(string)
0x15f: Call2 0x7e5

0x160: Pop(0)
0x161: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=100
0x162: Pop(1)
0x163: PushEmpty(int)
0x164: Call2 0x89c

0x165: Pop(0)
0x166: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=110
0x167: Pop(1)
0x168: Stack[-2] = (int) -1
...
0x172: Stack[-11] = Stack[-2]
0x173: Stack[-6] = Stack[-1]
0x174: Push(-2, 4); TaskCall(6)
0x175: Call2 0x18c

0x176: Pop(-2, 4); TaskReturn
0x177: Pop(2)
0x178: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x179: Pop(0)
...
0x17c: @ sync()
0x17d: Pop(0)
0x17e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x17f: Pop(0)
0x180: GOTO 0x17a

0x181: PushEmpty(object)
0x182: Stack[-10] = Stack[-1]
0x183: Call2 0x6b7

0x184: Pop(1)
0x185: @ StopDialog(Stack[-4])
0x186: Pop(0)
0x187: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=136
0x188: Pop(0)
0x189: Stack[-2] = Stack[-10]
0x18a: Return(); Pop(8)
...
0x1b3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x1b4: Pop(1)
0x1b5: @@@ ClearReplies(); Obj=0 // @poff=162
0x1b6: Pop(0)
0x1b7: Push((int) 520406)
0x1b8: Push((int) 21615)
0x1b9: Push((int) 21614)
0x1ba: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x1bb: Pop(3)
0x1bc: Push((int) 517911)
0x1bd: Push((int) 19050)
0x1be: Push((int) 19049)
0x1bf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x1c0: Pop(3)
0x1c1: GOTO 0x237
...
0x1e0: Stack[-1] = "Neutral" // @poff=0
0x1e1: Call2 0x255

0x1e2: Pop(1)
0x1e3: Push((int) 517915)
0x1e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x1e5: Pop(1)
0x1e6: @@@ ClearReplies(); Obj=0 // @poff=162
0x1e7: Pop(0)
0x1e8: Push((int) 517916)
0x1e9: Push((int) 19055)
0x1ea: Push((int) 19054)
0x1eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x1ec: Pop(3)
0x1ed: Push((int) 520410)
0x1ee: Push((int) 21620)
0x1ef: Push((int) 21619)
0x1f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x1f1: Pop(3)
0x1f2: GOTO 0x237
...
0x1f9: Stack[-1] = "Neutral" // @poff=0
0x1fa: Call2 0x255

0x1fb: Pop(1)
0x1fc: Push((int) 517919)
0x1fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x1fe: Pop(1)
0x1ff: @@@ ClearReplies(); Obj=0 // @poff=162
0x200: Pop(0)
...
0x209: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x20a: Pop(3)
...
0x214: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x215: Pop(3)
0x216: Push((int) 541718)
0x217: Push((int) -1)
0x218: Push((int) 43908)
0x219: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x21a: Pop(3)
0x21b: Push((int) 517922)
0x21c: Push((int) -1)
0x21d: Push((int) 19060)
0x21e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x21f: Pop(3)
0x220: GOTO 0x237
...
0x226: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x227: Pop(1)
0x228: @@@ ClearReplies(); Obj=0 // @poff=162
0x229: Pop(0)
0x22a: Push((int) 518197)
0x22b: Push((int) -1)
0x22c: Push((int) 19310)
0x22d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x22e: Pop(3)
0x22f: Push((int) 517928)
0x230: Push((int) -1)
0x231: Push((int) 19066)
0x232: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x233: Pop(3)
0x234: GOTO 0x237
...
0x246: Push("all") // @poff=16
0x247: Push("idle") // @poff=24
...
0x24f: Push("all") // @poff=16
0x250: Push("idle") // @poff=24
...
0x2b6: Stack[-1] = "Neutral" // @poff=0
0x2b7: Call2 0x255

0x2b8: Pop(1)
0x2b9: Push((int) 517910)
0x2ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x2bb: Pop(1)
0x2bc: @@@ ClearReplies(); Obj=0 // @poff=162
0x2bd: Pop(0)
0x2be: Push((int) 520406)
0x2bf: Push((int) 21615)
0x2c0: Push((int) 21614)
0x2c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x2c2: Pop(3)
0x2c3: Push((int) 517911)
0x2c4: Push((int) 19050)
0x2c5: Push((int) 19049)
0x2c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x2c7: Pop(3)
0x2c8: Return(); Pop(0)
...
0x2eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x2ec: Pop(1)
0x2ed: @@@ ClearReplies(); Obj=0 // @poff=162
0x2ee: Pop(0)
0x2ef: Push((int) 517916)
0x2f0: Push((int) 19055)
0x2f1: Push((int) 19054)
0x2f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x2f3: Pop(3)
0x2f4: Push((int) 520410)
0x2f5: Push((int) 21620)
0x2f6: Push((int) 21619)
0x2f7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x2f8: Pop(3)
0x2f9: Return(); Pop(0)
...
0x300: Stack[-1] = "Neutral" // @poff=0
0x301: Call2 0x255

0x302: Pop(1)
0x303: Push((int) 517919)
0x304: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x305: Pop(1)
0x306: @@@ ClearReplies(); Obj=0 // @poff=162
0x307: Pop(0)
...
0x310: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x311: Pop(3)
...
0x31b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x31c: Pop(3)
0x31d: Push((int) 541718)
0x31e: Push((int) -1)
0x31f: Push((int) 43908)
0x320: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x321: Pop(3)
0x322: Push((int) 517922)
0x323: Push((int) -1)
0x324: Push((int) 19060)
0x325: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x326: Pop(3)
0x327: Return(); Pop(0)
...
0x32d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x32e: Pop(1)
0x32f: @@@ ClearReplies(); Obj=0 // @poff=162
0x330: Pop(0)
0x331: Push((int) 518197)
0x332: Push((int) -1)
0x333: Push((int) 19310)
0x334: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x335: Pop(3)
0x336: Push((int) 517928)
0x337: Push((int) -1)
0x338: Push((int) 19066)
0x339: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x33a: Pop(3)
0x33b: Return(); Pop(0)
...
0x344: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x345: Pop(1)
0x346: @@@ ClearReplies(); Obj=0 // @poff=162
0x347: Pop(0)
0x348: Push((int) 517926)
0x349: Push((int) -1)
0x34a: Push((int) 19064)
0x34b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x34c: Pop(3)
0x34d: Return(); Pop(0)
...
0x356: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x357: Pop(1)
0x358: @@@ ClearReplies(); Obj=0 // @poff=162
0x359: Pop(0)
0x35a: Push((int) 517924)
0x35b: Push((int) -1)
0x35c: Push((int) 19062)
0x35d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x35e: Pop(3)
0x35f: Return(); Pop(0)
...
0x368: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x369: Pop(1)
0x36a: @@@ ClearReplies(); Obj=0 // @poff=162
0x36b: Pop(0)
0x36c: Push((int) 520412)
0x36d: Push((int) 19055)
0x36e: Push((int) 21621)
0x36f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x370: Pop(3)
0x371: Return(); Pop(0)
...
0x37a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x37b: Pop(1)
0x37c: @@@ ClearReplies(); Obj=0 // @poff=162
0x37d: Pop(0)
0x37e: Push((int) 517918)
0x37f: Push((int) 21618)
0x380: Push((int) 19056)
0x381: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x382: Pop(3)
0x383: Return(); Pop(0)
...
0x38c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x38d: Pop(1)
0x38e: @@@ ClearReplies(); Obj=0 // @poff=162
0x38f: Pop(0)
0x390: Push((int) 520413)
0x391: Push((int) 21624)
0x392: Push((int) 21623)
0x393: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x394: Pop(3)
0x395: Push((int) 520418)
0x396: Push((int) -1)
0x397: Push((int) 21628)
0x398: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x399: Pop(3)
0x39a: Return(); Pop(0)
...
0x39f: Stack[-1] = "Neutral" // @poff=0
0x3a0: Call2 0x255

0x3a1: Pop(1)
0x3a2: Push((int) 520414)
0x3a3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x3a4: Pop(1)
0x3a5: @@@ ClearReplies(); Obj=0 // @poff=162
0x3a6: Pop(0)
0x3a7: Push((int) 520415)
0x3a8: Push((int) 21626)
0x3a9: Push((int) 21625)
0x3aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3ab: Pop(3)
0x3ac: Push((int) 520419)
0x3ad: Push((int) -1)
0x3ae: Push((int) 21629)
0x3af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3b0: Pop(3)
0x3b1: Return(); Pop(0)
...
0x3b6: Stack[-1] = "Neutral" // @poff=0
0x3b7: Call2 0x255

0x3b8: Pop(1)
0x3b9: Push((int) 520416)
0x3ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x3bb: Pop(1)
0x3bc: @@@ ClearReplies(); Obj=0 // @poff=162
0x3bd: Pop(0)
0x3be: Push((int) 520417)
0x3bf: Push((int) -1)
0x3c0: Push((int) 21627)
0x3c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3c2: Pop(3)
0x3c3: Return(); Pop(0)
...
0x3c8: Stack[-1] = "Neutral" // @poff=0
0x3c9: Call2 0x255

0x3ca: Pop(1)
0x3cb: Push((int) 517912)
0x3cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x3cd: Pop(1)
0x3ce: @@@ ClearReplies(); Obj=0 // @poff=162
0x3cf: Pop(0)
0x3d0: Push((int) 517913)
0x3d1: Push((int) -1)
0x3d2: Push((int) 19051)
0x3d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3d4: Pop(3)
0x3d5: Push((int) 517914)
0x3d6: Push((int) -1)
0x3d7: Push((int) 19052)
0x3d8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3d9: Pop(3)
0x3da: Return(); Pop(0)
...
0x3df: Stack[-1] = "Neutral" // @poff=0
0x3e0: Call2 0x255

0x3e1: Pop(1)
0x3e2: Push((int) 520407)
0x3e3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x3e4: Pop(1)
0x3e5: @@@ ClearReplies(); Obj=0 // @poff=162
0x3e6: Pop(0)
0x3e7: Push((int) 520408)
0x3e8: Push((int) 19050)
0x3e9: Push((int) 21616)
0x3ea: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x3eb: Pop(3)
0x3ec: Return(); Pop(0)
...
0x409: Pop(0)
0x40a: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=62
0x40b: Pop(1)
0x40c: PushEmpty(int)
0x40d: Call2 0x7df

0x40e: Pop(0)
0x40f: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=73
0x410: Pop(1)
0x411: PushEmpty(string)
0x412: Call2 0x7e3

0x413: Pop(0)
0x414: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=91
0x415: Pop(1)
0x416: PushEmpty(string)
0x417: Call2 0x7e5

0x418: Pop(0)
0x419: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=100
0x41a: Pop(1)
0x41b: PushEmpty(int)
0x41c: Call2 0x89c

0x41d: Pop(0)
0x41e: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=110
0x41f: Pop(1)
0x420: Stack[-2] = (int) -1
...
0x42f: Pop(2)
0x430: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x431: Pop(0)
...
0x434: @ sync()
0x435: Pop(0)
0x436: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x437: Pop(0)
0x438: GOTO 0x432

0x439: PushEmpty(object)
0x43a: Stack[-10] = Stack[-1]
0x43b: Call2 0x6b7

0x43c: Pop(1)
0x43d: @ StopDialog(Stack[-4])
0x43e: Pop(0)
0x43f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=136
0x440: Pop(0)
0x441: Stack[-2] = Stack[-10]
0x442: Return(); Pop(8)
...
0x44f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x450: Pop(1)
0x451: @@@ ClearReplies(); Obj=0 // @poff=162
0x452: Pop(0)
0x453: Push((int) 520727)
0x454: Push((int) -1)
0x455: Push((int) 21938)
0x456: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x457: Pop(3)
0x458: Push((int) 520728)
0x459: Push((int) -1)
0x45a: Push((int) 21939)
0x45b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x45c: Pop(3)
0x45d: GOTO 0x460
...
0x46f: Push("all") // @poff=16
0x470: Push("idle") // @poff=24
...
0x4a2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x4a3: Pop(1)
0x4a4: @@@ ClearReplies(); Obj=0 // @poff=162
0x4a5: Pop(0)
0x4a6: Push((int) 520727)
0x4a7: Push((int) -1)
0x4a8: Push((int) 21938)
0x4a9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x4aa: Pop(3)
0x4ab: Push((int) 520728)
0x4ac: Push((int) -1)
0x4ad: Push((int) 21939)
0x4ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x4af: Pop(3)
0x4b0: Return(); Pop(0)
...
0x4cd: Pop(0)
0x4ce: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=62
0x4cf: Pop(1)
0x4d0: PushEmpty(int)
0x4d1: Call2 0x7df

0x4d2: Pop(0)
0x4d3: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=73
0x4d4: Pop(1)
0x4d5: PushEmpty(string)
0x4d6: Call2 0x7e3

0x4d7: Pop(0)
0x4d8: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=91
0x4d9: Pop(1)
0x4da: PushEmpty(string)
0x4db: Call2 0x7e5

0x4dc: Pop(0)
0x4dd: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=100
0x4de: Pop(1)
0x4df: PushEmpty(int)
0x4e0: Call2 0x89c

0x4e1: Pop(0)
0x4e2: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=110
0x4e3: Pop(1)
0x4e4: Stack[-2] = (int) -1
...
0x4f3: Pop(2)
0x4f4: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x4f5: Pop(0)
...
0x4f8: @ sync()
0x4f9: Pop(0)
0x4fa: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=124
0x4fb: Pop(0)
0x4fc: GOTO 0x4f6
...
0x502: Pop(0)
0x503: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=136
0x504: Pop(0)
0x505: Stack[-2] = Stack[-10]
0x506: Return(); Pop(8)
...
0x513: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x514: Pop(1)
0x515: @@@ ClearReplies(); Obj=0 // @poff=162
0x516: Pop(0)
0x517: Push((int) 541716)
0x518: Push((int) -1)
0x519: Push((int) 43906)
0x51a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x51b: Pop(3)
0x51c: Push((int) 541717)
0x51d: Push((int) -1)
0x51e: Push((int) 43907)
0x51f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x520: Pop(3)
0x521: Push((int) 541742)
0x522: Push((int) -1)
0x523: Push((int) 43939)
0x524: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x525: Pop(3)
0x526: GOTO 0x529
...
0x538: Push("all") // @poff=16
0x539: Push("idle") // @poff=24
...
0x541: Push("all") // @poff=16
0x542: Push("idle") // @poff=24
...
0x573: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=151
0x574: Pop(1)
0x575: @@@ ClearReplies(); Obj=0 // @poff=162
0x576: Pop(0)
0x577: Push((int) 541716)
0x578: Push((int) -1)
0x579: Push((int) 43906)
0x57a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x57b: Pop(3)
0x57c: Push((int) 541717)
0x57d: Push((int) -1)
0x57e: Push((int) 43907)
0x57f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x580: Pop(3)
0x581: Push((int) 541742)
0x582: Push((int) -1)
0x583: Push((int) 43939)
0x584: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=175
0x585: Pop(3)
0x586: Return(); Pop(0)
...
0x5c0: Pop(1)
0x5c1: @@ GetLocator(Stack[-1], Stack[-11]); Obj=12 // @poff=184
0x5c2: Pop(1)
...
0x5d5: Pop(0)
0x5d6: @ irand(Stack[-9], Stack[-2]T)
0x5d7: Pop(0)
0x5d8: PushEmpty(string, int)
0x5d9: Stack[-11] = Stack[-1]
0x5da: Call2 0x7b2

0x5db: Pop(1)
0x5dc: @@ GetLocator(Stack[-1], Stack[-9], Stack[-8], Stack[-7]); Obj=12 // @poff=184
0x5dd: Pop(1)
...
0x5f4: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x614: Push("all") // @poff=16
0x615: Push("walk_stopl") // @poff=203
0x616: @ GetAnimationOffset(Stack[-4], Stack[-2], Stack[-1])
0x617: Pop(2)
0x618: Push("all") // @poff=16
0x619: Push("walk_stopr") // @poff=225
...
0x649: Pop(0)
0x64a: @@ GetPosition(Stack[-2]); Obj=7 // @poff=247
0x64b: Pop(0)
...
0x656: Pop(2)
0x657: Stack[-1] = Stack[-8]
0x658: Return(); Pop(6)

0x659: PushEmpty(cvector, cvector)
0x65a: @@ GetPosition(Stack[-1]); Obj=3 // @poff=247
0x65b: Pop(0)
...
0x663: @@ GetPosition(Stack[-3]); Obj=7 // @poff=247
0x664: Pop(0)
...
0x673: @@ GetPosition(Stack[-8]); Obj=20 // @poff=247
0x674: Pop(0)
0x675: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=259
0x676: Pop(0)
...
0x6ca: @@ GetPosition(Stack[-7]); Obj=18 // @poff=247
0x6cb: Pop(0)
0x6cc: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=259
0x6cd: Pop(0)
...
0x709: Push("Can't find lsh animation : ") // @poff=283
...
0x718: Push("Can't find lsh animation : ") // @poff=283
...
0x726: Stack[-10] = Stack[-2]
0x727: Stack[-9] = Stack[-1]
0x728: Call2 0x74b
...
0x73c: Push((float)9.999999974752427e-07)
...
0x75c: Pop(0)
0x75d: Stack[-1] = Stack[-4]
0x75e: Return(); Pop(2)

0x75f: PushEmpty(object, object)
0x760: @ CreateIntVector(Stack[-1])
0x761: Pop(0)
0x762: @@ add(Stack[-4]); Obj=1 // @poff=339
0x763: Pop(0)
0x764: @@ add(Stack[-3]); Obj=1 // @poff=339
0x765: Pop(0)
0x766: Push((int) 3)
...
0x76c: @@ GetItemID(Stack[-3]); Obj=8 // @poff=343
0x76d: Pop(0)
0x76e: Push("Category") // @poff=353
0x76f: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x770: Pop(1)
0x771: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=371
0x772: Pop(0)
0x773: Pop(0); Push((bool) Stack[-1] == 0)
0x774: IF (Stack[-1] == 0) GOTO 0x778; Pop(1)

0x775: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=379
0x776: Pop(0)
0x777: GOTO 0x77d

0x778: PushEmpty(int, int)
0x779: Stack[-5] = Stack[-2]
0x77a: Stack[-9] = Stack[-1]
0x77b: Call2 0x75f
...
0x780: Pop(0)
0x781: @@ SetItemName(Stack[-4]); Obj=1 // @poff=389
0x782: Pop(0)
0x783: PushEmpty(object, object, int)
0x784: Stack[-8] = Stack[-3]
...
0x7e3: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=441
0x7e4: Return(); Pop(0)

0x7e5: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=481
0x7e6: Return(); Pop(0)
...
0x7e9: PushEmpty()
0x7ea: Push("playsound") // @poff=525
0x7eb: Push("giveitem") // @poff=545
...
0x7ef: PushEmpty()
0x7f0: Push((int) 1000)
0x7f1: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=563
0x7f2: Pop(1)
0x7f3: Return(); Pop(0)

0x7f4: PushEmpty()
0x7f5: Push("oob1Gorbun1") // @poff=578
0x7f6: Push((int) 1)
...
0x7fa: PushEmpty()
0x7fb: Push("oob1Gorbun2") // @poff=602
0x7fc: Push((int) 1)
...
0x807: Pop(0)
0x808: Push("health") // @poff=638
0x809: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=652
0x80a: Pop(1)
0x80b: Push((float)0.30000001192092896)
0x80c: Stack[-2] = Stack[-2] - Stack[-1]; Pop(1);
0x80d: Push("health") // @poff=638
0x80e: @@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=664
0x80f: Pop(1)
0x810: Push("blood is given") // @poff=676
0x811: @ Trace(Stack[-1])
0x812: Pop(1)
0x813: PushEmpty(object, string, int)
0x814: Stack[-7] = Stack[-3]
0x815: Stack[-2] = "b1q02_blood" // @poff=706
0x816: Stack[-1] = (int) 1
0x817: Call2 0x77e
...
0x832: Stack[-1] = "oob1Gorbun1" // @poff=578
0x833: Call2 0x75a
...
0x83e: Stack[-1] = "oob1Gorbun2" // @poff=602
0x83f: Call2 0x75a
...
0x849: Push("health") // @poff=638
0x84a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=652
0x84b: Pop(1)
0x84c: Push((float)0.4000000059604645)
...
0x861: Push("Can't retrieve diary root") // @poff=730
0x862: @ Trace(Stack[-1])
0x863: Pop(1)
...
0x86d: Pop(1)
0x86e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=782
0x86f: Pop(0)
0x870: Pop(0); Push((bool) Stack[-2] == 0)
0x871: IF (Stack[-1] == 0) GOTO 0x878; Pop(1)

0x872: Push("Can't find diary parent with id: ") // @poff=787
...
0x878: @@ AddChild(Stack[-8]); Obj=2 // @poff=855
0x879: Pop(0)
0x87a: Push((int) 7)
0x87b: @ SendWorldWndMessage(Stack[-1])
0x87c: Pop(1)
0x87d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=864
0x87e: Pop(0)
...
0x88e: Stack[-4] = "tourniquet" // @poff=876
0x88f: Stack[-3] = (int) 1
0x890: Stack[-2] = (int) 1
0x891: Stack[-1] = (int) 5
0x892: Call2 0x724
...
0x895: Stack[-4] = "bandage" // @poff=898
0x896: Stack[-3] = (int) 1
0x897: Stack[-2] = (int) 1
0x898: Stack[-1] = (int) 5
0x899: Call2 0x724
...
0x8b2: Stack[-1] = "cleanup" // @poff=409
0x8b3: Call2 0x7bf
...
0x8c4: Stack[-5] = Stack[-1]
0x8c5: Push(-2, 1); TaskCall(7)
0x8c6: Call2 0x3fa

0x8c7: Pop(-2, 1); TaskReturn
0x8c8: Pop(2)
0x8c9: Push("mt_gorbun") // @poff=928
0x8ca: Push((int) 1)
