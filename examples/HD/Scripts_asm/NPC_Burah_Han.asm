...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x117: Pop(2)
0x118: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x119: Pop(0)
...
0x11c: @ sync()
0x11d: Pop(0)
0x11e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x11f: Pop(0)
0x120: GOTO 0x11a

0x121: PushEmpty(object)
0x122: Stack[-10] = Stack[-1]
0x123: Call2 0x636

0x124: Pop(1)
0x125: @ StopDialog(Stack[-4])
0x126: Pop(0)
0x127: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x128: Pop(0)
0x129: Stack[-2] = Stack[-10]
0x12a: Return(); Pop(8)
...
0x138: Stack[-1] = "Questioning" // @poff=156
0x139: Call2 0x17f
...
0x1bc: Stack[-1] = "Questioning" // @poff=156
0x1bd: Call2 0x17f
...
0x1fe: Stack[-1] = "Suspicion" // @poff=190
0x1ff: Call2 0x17f
...
0x210: Stack[-1] = "Suspicion" // @poff=190
0x211: Call2 0x17f
...
0x227: Stack[-1] = "Questioning" // @poff=156
0x228: Call2 0x17f
...
0x2b5: Pop(0)
0x2b6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2b7: Pop(1)
0x2b8: PushEmpty(int)
0x2b9: Call2 0x74f

0x2ba: Pop(0)
0x2bb: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2bc: Pop(1)
0x2bd: PushEmpty(string)
0x2be: Call2 0x753

0x2bf: Pop(0)
0x2c0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2c1: Pop(1)
0x2c2: PushEmpty(string)
0x2c3: Call2 0x755

0x2c4: Pop(0)
0x2c5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2c6: Pop(1)
0x2c7: PushEmpty(int)
0x2c8: Call2 0x7cd

0x2c9: Pop(0)
0x2ca: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2cb: Pop(1)
0x2cc: Stack[-2] = (int) -1
...
0x2dd: Stack[-11] = Stack[-2]
0x2de: Stack[-6] = Stack[-1]
0x2df: Push(-2, 4); TaskCall(5)
0x2e0: Call2 0x2f7

0x2e1: Pop(-2, 4); TaskReturn
0x2e2: Pop(2)
0x2e3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2e4: Pop(0)
...
0x2e7: @ sync()
0x2e8: Pop(0)
0x2e9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2ea: Pop(0)
0x2eb: GOTO 0x2e5

0x2ec: PushEmpty(object)
0x2ed: Stack[-10] = Stack[-1]
0x2ee: Call2 0x636

0x2ef: Pop(1)
0x2f0: @ StopDialog(Stack[-4])
0x2f1: Pop(0)
0x2f2: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2f3: Pop(0)
...
0x2fe: Stack[-1] = "Doubt" // @poff=210
0x2ff: Call2 0x336

0x300: Pop(1)
0x301: Push((int) 535268)
0x302: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x303: Pop(1)
0x304: @@@ ClearReplies(); Obj=0 // @poff=116
0x305: Pop(0)
...
0x327: Push("all") // @poff=138
0x328: Push("idle") // @poff=146
...
0x3d1: Stack[-1] = "Questioning" // @poff=156
0x3d2: Call2 0x336
...
0x3e3: Stack[-1] = "Questioning" // @poff=156
0x3e4: Call2 0x336

0x3e5: Pop(1)
0x3e6: Push((int) 535333)
0x3e7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3e8: Pop(1)
0x3e9: @@@ ClearReplies(); Obj=0 // @poff=116
0x3ea: Pop(0)
0x3eb: Push((int) 535337)
0x3ec: Push((int) -1)
0x3ed: Push((int) 37019)
0x3ee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x3ef: Pop(3)
...
0x412: Pop(0)
0x413: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x414: Pop(1)
0x415: PushEmpty(int)
0x416: Call2 0x74f

0x417: Pop(0)
0x418: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x419: Pop(1)
0x41a: PushEmpty(string)
0x41b: Call2 0x753

0x41c: Pop(0)
0x41d: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x41e: Pop(1)
0x41f: PushEmpty(string)
0x420: Call2 0x755

0x421: Pop(0)
0x422: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x423: Pop(1)
0x424: PushEmpty(int)
0x425: Call2 0x7cd

0x426: Pop(0)
0x427: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x428: Pop(1)
0x429: Stack[-2] = (int) -1
...
0x44a: Stack[-10] = Stack[-1]
0x44b: Call2 0x636

0x44c: Pop(1)
0x44d: @ StopDialog(Stack[-4])
0x44e: Pop(0)
0x44f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x450: Pop(0)
0x451: Stack[-2] = Stack[-10]
0x452: Return(); Pop(8)
...
0x47f: Push("all") // @poff=138
0x480: Push("idle") // @poff=146
...
0x4ec: Stack[-3] = Stack[-1]
0x4ed: Call2 0x5e3

0x4ee: Stack[-2] = Stack[-5]
0x4ef: Pop(2)
0x4f0: Return(); Pop(2)

0x4f1: Stack[-1] = 0
0x4f2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4f3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x4f4: @ RotateAsync(Stack[-2], Stack[-1])
0x4f5: Pop(2)
0x4f6: Return(); Pop(0)

0x4f7: PushEmpty(object, bool, object, bool)
0x4f8: Push("player") // @poff=222
...
0x5af: Stack[-3] = (int) 0
0x5b0: Push("all") // @poff=138
0x5b1: PushEmpty(string, int)
0x5b2: Stack[-6] = Stack[-1]
0x5b3: Call2 0x737
...
0x5d3: Pop(0)
0x5d4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=236
0x5d5: Pop(0)
...
0x5e4: @@ GetPosition(Stack[-1]); Obj=3 // @poff=236
0x5e5: Pop(0)
0x5e6: PushEmpty(bool, cvector)
0x5e7: Stack[-3] = Stack[-1]
0x5e8: Call2 0x5d9
...
0x5f2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=236
0x5f3: Pop(0)
0x5f4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=248
0x5f5: Pop(0)
...
0x661: Push("voice_common") // @poff=272
0x662: Push((int) 1)
...
0x669: Push("voice_common") // @poff=272
0x66a: Push((int) 0)
...
0x67c: Push("voice_common") // @poff=272
0x67d: Push((int) 1)
...
0x68a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=302
0x68b: Pop(1)
...
0x6b5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=302
0x6b6: Pop(1)
...
0x6ca: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=314
0x6cb: Pop(1)
0x6cc: PushEmpty(bool, string)
0x6cd: Stack[-3] = Stack[-1]
0x6ce: Call2 0x6f1

0x6cf: Stack[-2] = Stack[-14]
0x6d0: Pop(2)
0x6d1: Return(); Pop(10)
...
0x6dd: Push("Can't find lsh animation : ") // @poff=330
...
0x6ec: Push("Can't find lsh animation : ") // @poff=330
...
0x710: Push((float)9.999999974752427e-07)
...
0x753: Stack[-1] = "ui/NPC_Han.png" // @poff=386
0x754: Return(); Pop(0)

0x755: Stack[-1] = "ui/NPC_Han_b.png" // @poff=416
0x756: Return(); Pop(0)
...
0x767: Stack[-2] = "quest_b11_02" // @poff=464
0x768: Stack[-1] = "fail" // @poff=490
0x769: Call2 0x71c
...
0x780: Stack[-1] = "oob12Han1" // @poff=500
0x781: Call2 0x717
...
0x7a9: Push("Can't retrieve diary root") // @poff=520
0x7aa: @ Trace(Stack[-1])
0x7ab: Pop(1)
...
0x7b4: Stack[-1] = Stack[-4]
0x7b5: Pop(1)
0x7b6: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=572
0x7b7: Pop(0)
0x7b8: Pop(0); Push((bool) Stack[-2] == 0)
0x7b9: IF (Stack[-1] == 0) GOTO 0x7c0; Pop(1)

0x7ba: Push("Can't find diary parent with id: ") // @poff=577
...
0x7c0: @@ AddChild(Stack[-8]); Obj=2 // @poff=645
0x7c1: Pop(0)
0x7c2: Push((int) 7)
0x7c3: @ SendWorldWndMessage(Stack[-1])
0x7c4: Pop(1)
0x7c5: @@ GetCategory(Stack[-1]); Obj=8 // @poff=654
0x7c6: Pop(0)
