...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xd4: Stack[-1] = "Independence" // @poff=166
0xd5: Call2 0x8b
...
0x2e5: Stack[-1] = 0
0x2e6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2e7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2e8: @ RotateAsync(Stack[-2], Stack[-1])
0x2e9: Pop(2)
0x2ea: Return(); Pop(0)

0x2eb: PushEmpty(object, bool, object, bool)
0x2ec: Push("player") // @poff=192
...
0x3c7: Pop(0)
0x3c8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=206
0x3c9: Pop(0)
...
0x3d4: Pop(2)
0x3d5: Stack[-1] = Stack[-8]
0x3d6: Return(); Pop(6)

0x3d7: PushEmpty(cvector, cvector)
0x3d8: @@ GetPosition(Stack[-1]); Obj=3 // @poff=206
0x3d9: Pop(0)
...
0x3e6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=206
0x3e7: Pop(0)
0x3e8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=218
0x3e9: Pop(0)
...
0x455: Push("voice_common") // @poff=242
0x456: Push((int) 1)
...
0x45d: Push("voice_common") // @poff=242
0x45e: Push((int) 0)
...
0x470: Push("voice_common") // @poff=242
0x471: Push((int) 1)
...
0x47e: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=272
0x47f: Pop(1)
...
0x4a9: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=272
0x4aa: Pop(1)
...
0x4be: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=284
0x4bf: Pop(1)
0x4c0: PushEmpty(bool, string)
0x4c1: Stack[-3] = Stack[-1]
0x4c2: Call2 0x4e5

0x4c3: Stack[-2] = Stack[-14]
0x4c4: Pop(2)
0x4c5: Return(); Pop(10)
...
0x4d1: Push("Can't find lsh animation : ") // @poff=300
...
0x4e0: Push("Can't find lsh animation : ") // @poff=300
...
0x504: Push((float)9.999999974752427e-07)
...
0x536: Stack[-1] = "ui/NPC_Julia.png" // @poff=356
0x537: Return(); Pop(0)

0x538: Stack[-1] = "ui/NPC_Julia_b.png" // @poff=390
0x539: Return(); Pop(0)
