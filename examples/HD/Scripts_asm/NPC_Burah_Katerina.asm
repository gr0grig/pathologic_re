...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x137: Stack[-1] = "Suffering" // @poff=156
0x138: Call2 0x19c
...
0x18d: Push("all") // @poff=138
0x18e: Push("idle") // @poff=146
...
0x1e0: Stack[-1] = "Suffering" // @poff=156
0x1e1: Call2 0x19c

0x1e2: Pop(1)
0x1e3: Push((int) 520248)
0x1e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x1e5: Pop(1)
0x1e6: @@@ ClearReplies(); Obj=0 // @poff=116
0x1e7: Pop(0)
...
0x229: Stack[-1] = "Penetrating" // @poff=176
0x22a: Call2 0x19c
...
0x23b: Stack[-1] = "Penetrating" // @poff=176
0x23c: Call2 0x19c
...
0x264: Stack[-1] = "Suffering" // @poff=156
0x265: Call2 0x19c
...
0x280: Stack[-1] = "Suffering" // @poff=156
0x281: Call2 0x19c
...
0x2ae: Stack[-1] = "Suffering" // @poff=156
0x2af: Call2 0x19c
...
0x2c0: Stack[-1] = "Suffering" // @poff=156
0x2c1: Call2 0x19c

0x2c2: Pop(1)
0x2c3: Push((int) 520252)
0x2c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2c5: Pop(1)
0x2c6: @@@ ClearReplies(); Obj=0 // @poff=116
0x2c7: Pop(0)
...
0x2d7: Stack[-1] = "Neutral" // @poff=89
0x2d8: Call2 0x19c

0x2d9: Pop(1)
0x2da: Push((int) 520257)
0x2db: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2dc: Pop(1)
0x2dd: @@@ ClearReplies(); Obj=0 // @poff=116
0x2de: Pop(0)
...
0x2e9: Stack[-1] = "Penetrating" // @poff=176
0x2ea: Call2 0x19c
...
0x313: Pop(0)
0x314: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x315: Pop(1)
0x316: PushEmpty(int)
0x317: Call2 0xa34

0x318: Pop(0)
0x319: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x31a: Pop(1)
0x31b: PushEmpty(string)
0x31c: Call2 0xa38

0x31d: Pop(0)
0x31e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x31f: Pop(1)
0x320: PushEmpty(string)
0x321: Call2 0xa3a

0x322: Pop(0)
0x323: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x324: Pop(1)
0x325: PushEmpty(int)
0x326: Call2 0xb08

0x327: Pop(0)
0x328: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x329: Pop(1)
0x32a: Stack[-2] = (int) -1
...
0x340: Pop(2)
0x341: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x342: Pop(0)
...
0x345: @ sync()
0x346: Pop(0)
0x347: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x348: Pop(0)
0x349: GOTO 0x343

0x34a: PushEmpty(object)
0x34b: Stack[-10] = Stack[-1]
0x34c: Call2 0x922

0x34d: Pop(1)
0x34e: @ StopDialog(Stack[-4])
0x34f: Pop(0)
0x350: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x351: Pop(0)
0x352: Stack[-2] = Stack[-10]
0x353: Return(); Pop(8)
...
0x36c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x36d: Pop(3)
...
0x3f9: Stack[-1] = "Suffering" // @poff=156
0x3fa: Call2 0x399
...
0x40b: Stack[-1] = "Penetrating" // @poff=176
0x40c: Call2 0x399
...
0x41d: Stack[-1] = "Penetrating" // @poff=176
0x41e: Call2 0x399
...
0x446: Stack[-1] = "Grin" // @poff=200
0x447: Call2 0x399

0x448: Pop(1)
0x449: Push((int) 523987)
0x44a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x44b: Pop(1)
0x44c: @@@ ClearReplies(); Obj=0 // @poff=116
0x44d: Pop(0)
...
0x470: Pop(0)
0x471: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x472: Pop(1)
0x473: PushEmpty(int)
0x474: Call2 0xa34

0x475: Pop(0)
0x476: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x477: Pop(1)
0x478: PushEmpty(string)
0x479: Call2 0xa38

0x47a: Pop(0)
0x47b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x47c: Pop(1)
0x47d: PushEmpty(string)
0x47e: Call2 0xa3a

0x47f: Pop(0)
0x480: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x481: Pop(1)
0x482: PushEmpty(int)
0x483: Call2 0xb08

0x484: Pop(0)
0x485: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x486: Pop(1)
0x487: Stack[-2] = (int) -1
...
0x493: Stack[-1] = Stack[-2]
0x494: Pop(1)
0x495: Call2 0x934

0x496: Pop(2)
0x497: PushEmpty(object, object)
0x498: Stack[-11] = Stack[-2]
0x499: Stack[-6] = Stack[-1]
...
0x4a8: Stack[-10] = Stack[-1]
0x4a9: Call2 0x922

0x4aa: Pop(1)
0x4ab: @ StopDialog(Stack[-4])
0x4ac: Pop(0)
0x4ad: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4ae: Pop(0)
...
0x4ec: Push("all") // @poff=138
0x4ed: Push("idle") // @poff=146
...
0x4f5: Push("all") // @poff=138
0x4f6: Push("idle") // @poff=146
...
0x551: Stack[-1] = "Penetrating" // @poff=176
0x552: Call2 0x4fb
...
0x568: Stack[-1] = "Penetrating" // @poff=176
0x569: Call2 0x4fb
...
0x57a: Stack[-1] = "Penetrating" // @poff=176
0x57b: Call2 0x4fb
...
0x58c: Stack[-1] = "Penetrating" // @poff=176
0x58d: Call2 0x4fb
...
0x5fb: Pop(0)
0x5fc: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x5fd: Pop(1)
0x5fe: PushEmpty(int)
0x5ff: Call2 0xa34

0x600: Pop(0)
0x601: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x602: Pop(1)
0x603: PushEmpty(string)
0x604: Call2 0xa38

0x605: Pop(0)
0x606: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x607: Pop(1)
0x608: PushEmpty(string)
0x609: Call2 0xa3a

0x60a: Pop(0)
0x60b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x60c: Pop(1)
0x60d: PushEmpty(int)
0x60e: Call2 0xb08

0x60f: Pop(0)
0x610: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x611: Pop(1)
0x612: Stack[-2] = (int) -1
...
0x628: Pop(2)
0x629: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x62a: Pop(0)
...
0x62d: @ sync()
0x62e: Pop(0)
0x62f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x630: Pop(0)
0x631: GOTO 0x62b

0x632: PushEmpty(object)
0x633: Stack[-10] = Stack[-1]
0x634: Call2 0x922

0x635: Pop(1)
0x636: @ StopDialog(Stack[-4])
0x637: Pop(0)
0x638: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x639: Pop(0)
0x63a: Stack[-2] = Stack[-10]
0x63b: Return(); Pop(8)
...
0x66d: Push("all") // @poff=138
0x66e: Push("idle") // @poff=146
...
0x676: Push("all") // @poff=138
0x677: Push("idle") // @poff=146
...
0x747: Stack[-1] = "Neutral" // @poff=89
0x748: Call2 0x77a

0x749: Pop(1)
0x74a: Push((int) 540551)
0x74b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x74c: Pop(1)
0x74d: @@@ ClearReplies(); Obj=0 // @poff=116
0x74e: Pop(0)
...
0x76b: Push("all") // @poff=138
0x76c: Push("idle") // @poff=146
...
0x774: Push("all") // @poff=138
0x775: Push("idle") // @poff=146
...
0x79a: Stack[-1] = "Neutral" // @poff=89
0x79b: Call2 0x77a

0x79c: Pop(1)
0x79d: Push((int) 540551)
0x79e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x79f: Pop(1)
0x7a0: @@@ ClearReplies(); Obj=0 // @poff=116
0x7a1: Pop(0)
...
0x7d8: Stack[-3] = Stack[-1]
0x7d9: Call2 0x8cf

0x7da: Stack[-2] = Stack[-5]
0x7db: Pop(2)
0x7dc: Return(); Pop(2)

0x7dd: Stack[-1] = 0
0x7de: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x7df: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x7e0: @ RotateAsync(Stack[-2], Stack[-1])
0x7e1: Pop(2)
0x7e2: Return(); Pop(0)

0x7e3: PushEmpty(object, bool, object, bool)
0x7e4: Push("player") // @poff=220
...
0x8bf: Pop(0)
0x8c0: @@ GetPosition(Stack[-2]); Obj=7 // @poff=234
0x8c1: Pop(0)
...
0x8cc: Pop(2)
0x8cd: Stack[-1] = Stack[-8]
0x8ce: Return(); Pop(6)

0x8cf: PushEmpty(cvector, cvector)
0x8d0: @@ GetPosition(Stack[-1]); Obj=3 // @poff=234
0x8d1: Pop(0)
0x8d2: PushEmpty(bool, cvector)
0x8d3: Stack[-3] = Stack[-1]
0x8d4: Call2 0x8c5

0x8d5: Stack[-2] = Stack[-6]
0x8d6: Pop(2)
0x8d7: Return(); Pop(2)
...
0x8de: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0x8df: Pop(0)
0x8e0: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=246
0x8e1: Pop(0)
...
0x94d: Push("voice_common") // @poff=270
0x94e: Push((int) 1)
...
0x955: Push("voice_common") // @poff=270
0x956: Push((int) 0)
...
0x968: Push("voice_common") // @poff=270
0x969: Push((int) 1)
...
0x976: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x977: Pop(1)
...
0x9a1: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x9a2: Pop(1)
...
0x9b6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x9b7: Pop(1)
0x9b8: PushEmpty(bool, string)
0x9b9: Stack[-3] = Stack[-1]
0x9ba: Call2 0x9dd

0x9bb: Stack[-2] = Stack[-14]
0x9bc: Pop(2)
0x9bd: Return(); Pop(10)
...
0x9c9: Push("Can't find lsh animation : ") // @poff=328
...
0x9d8: Push("Can't find lsh animation : ") // @poff=328
...
0x9fc: Push((float)9.999999974752427e-07)
...
0xa38: Stack[-1] = "ui/NPC_Katerina.png" // @poff=384
0xa39: Return(); Pop(0)

0xa3a: Stack[-1] = "ui/NPC_Katerina_b.png" // @poff=424
0xa3b: Return(); Pop(0)
...
0xa3e: PushEmpty()
0xa3f: Push("oob2Katerina1") // @poff=468
0xa40: Push((int) 1)
...
0xa44: PushEmpty()
0xa45: Push("oob2Katerina2") // @poff=496
0xa46: Push((int) 1)
...
0xa4a: PushEmpty()
0xa4b: Push("oob2Katerina3") // @poff=524
0xa4c: Push((int) 1)
...
0xa58: Pop(1)
0xa59: Push("b8q03KaterinaGotoMat") // @poff=564
0xa5a: Push("pt_map_mat") // @poff=606
0xa5b: Push((int) 0)
...
0xa5f: Pop(0)
0xa60: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=628
0xa61: Pop(5)
0xa62: PushEmpty()
0xa63: Call2 0xac1
...
0xa66: Stack[-1] = 0
0xa67: PushEmpty()
0xa68: Push("b10q01TalkKaterina") // @poff=636
0xa69: Push((int) 1)
...
0xa87: Stack[-1] = "b10q01TalkKaterina" // @poff=636
0xa88: Call2 0xa03
...
0xa9f: Stack[-1] = "oob2Katerina1" // @poff=468
0xaa0: Call2 0xa03
...
0xaab: Stack[-1] = "oob2Katerina2" // @poff=496
0xaac: Call2 0xa03
...
0xab7: Stack[-1] = "oob2Katerina3" // @poff=524
0xab8: Call2 0xa03
...
0xad3: Push("Can't retrieve diary root") // @poff=700
0xad4: @ Trace(Stack[-1])
0xad5: Pop(1)
0xad6: Stack[-3] = (bool) 0
0xad7: Return(); Pop(2)

0xad8: Stack[-1] = Stack[-3]
0xad9: Return(); Pop(2)
...
0xadf: Pop(1)
0xae0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=752
0xae1: Pop(0)
0xae2: Pop(0); Push((bool) Stack[-2] == 0)
0xae3: IF (Stack[-1] == 0) GOTO 0xaea; Pop(1)

0xae4: Push("Can't find diary parent with id: ") // @poff=757
...
0xaea: @@ AddChild(Stack[-8]); Obj=2 // @poff=825
0xaeb: Pop(0)
0xaec: Push((int) 7)
0xaed: @ SendWorldWndMessage(Stack[-1])
0xaee: Pop(1)
0xaef: @@ GetCategory(Stack[-1]); Obj=8 // @poff=834
0xaf0: Pop(0)
...
0xaf9: Pop(0)
0xafa: Pop(0); PushNull((bool) Stack[-2] == 0)
0xafb: IF (Stack[-1] == 0) GOTO 0xb02; Pop(1)

0xafc: Push("Can't find main outdoor scene") // @poff=846
0xafd: @ Trace(Stack[-1])
0xafe: Pop(1)
0xaff: Stack[-1] = 0
0xb00: Stack[-1] = Stack[-5]
0xb01: Return(); Pop(4)

0xb02: @@ GetMap(Stack[-1]); Obj=2 // @poff=906
0xb03: Pop(0)
