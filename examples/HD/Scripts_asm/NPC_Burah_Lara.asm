...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xda: Pop(0)
0xdb: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xdc: Pop(1)
0xdd: PushEmpty(int)
0xde: Call2 0xa06

0xdf: Pop(0)
0xe0: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xe1: Pop(1)
0xe2: PushEmpty(string)
0xe3: Call2 0xa0a

0xe4: Pop(0)
0xe5: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xe6: Pop(1)
0xe7: PushEmpty(string)
0xe8: Call2 0xa0c

0xe9: Pop(0)
0xea: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xeb: Pop(1)
0xec: PushEmpty(int)
0xed: Call2 0xb03

0xee: Pop(0)
0xef: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xf0: Pop(1)
0xf1: Stack[-2] = (int) -1
...
0x102: Stack[-11] = Stack[-2]
0x103: Stack[-6] = Stack[-1]
0x104: Push(-2, 4); TaskCall(3)
0x105: Call2 0x11c

0x106: Pop(-2, 4); TaskReturn
0x107: Pop(2)
0x108: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x109: Pop(0)
...
0x10c: @ sync()
0x10d: Pop(0)
0x10e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x10f: Pop(0)
0x110: GOTO 0x10a

0x111: PushEmpty(object)
0x112: Stack[-10] = Stack[-1]
0x113: Call2 0x8e8

0x114: Pop(1)
0x115: @ StopDialog(Stack[-4])
0x116: Pop(0)
0x117: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x118: Pop(0)
0x119: Stack[-2] = Stack[-10]
0x11a: Return(); Pop(8)
...
0x142: Stack[-1] = "Sympathy" // @poff=166
0x143: Call2 0x18d
...
0x1e1: Stack[-1] = "Sympathy" // @poff=166
0x1e2: Call2 0x18d
...
0x210: Stack[-1] = "Confusion" // @poff=184
0x211: Call2 0x18d
...
0x227: Stack[-1] = "Confusion" // @poff=184
0x228: Call2 0x18d
...
0x23e: Stack[-1] = "Confusion" // @poff=184
0x23f: Call2 0x18d
...
0x255: Stack[-1] = "Confusion" // @poff=184
0x256: Call2 0x18d
...
0x26c: Stack[-1] = "Confusion" // @poff=184
0x26d: Call2 0x18d
...
0x283: Stack[-1] = "Confusion" // @poff=184
0x284: Call2 0x18d
...
0x2ac: Stack[-1] = "Confusion" // @poff=184
0x2ad: Call2 0x18d
...
0x327: Stack[-1] = "Sympathy" // @poff=166
0x328: Call2 0x18d

0x329: Pop(1)
0x32a: Push((int) 519014)
0x32b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x32c: Pop(1)
0x32d: @@@ ClearReplies(); Obj=0 // @poff=116
0x32e: Pop(0)
...
0x33e: Stack[-1] = "Fear" // @poff=156
0x33f: Call2 0x18d

0x340: Pop(1)
0x341: Push((int) 519017)
0x342: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x343: Pop(1)
0x344: @@@ ClearReplies(); Obj=0 // @poff=116
0x345: Pop(0)
...
0x355: Stack[-1] = "Confusion" // @poff=184
0x356: Call2 0x18d
...
0x379: Stack[-1] = "Tiredness" // @poff=204
0x37a: Call2 0x18d

0x37b: Pop(1)
0x37c: Push((int) 527913)
0x37d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x37e: Pop(1)
0x37f: @@@ ClearReplies(); Obj=0 // @poff=116
0x380: Pop(0)
...
0x423: Push("all") // @poff=138
0x424: Push("idle") // @poff=146
...
0x42c: Push("all") // @poff=138
0x42d: Push("idle") // @poff=146
...
0x47f: Stack[-1] = "Confusion" // @poff=184
0x480: Call2 0x432
...
0x496: Stack[-1] = "Confusion" // @poff=184
0x497: Call2 0x432
...
0x4a8: Stack[-1] = "Confusion" // @poff=184
0x4a9: Call2 0x432
...
0x500: Pop(0)
0x501: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x502: Pop(1)
0x503: PushEmpty(int)
0x504: Call2 0xa06

0x505: Pop(0)
0x506: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x507: Pop(1)
0x508: PushEmpty(string)
0x509: Call2 0xa0a

0x50a: Pop(0)
0x50b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x50c: Pop(1)
0x50d: PushEmpty(string)
0x50e: Call2 0xa0c

0x50f: Pop(0)
0x510: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x511: Pop(1)
0x512: PushEmpty(int)
0x513: Call2 0xb03

0x514: Pop(0)
0x515: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x516: Pop(1)
0x517: Stack[-2] = (int) -1
...
0x528: Stack[-11] = Stack[-2]
0x529: Stack[-6] = Stack[-1]
0x52a: Push(-2, 4); TaskCall(7)
0x52b: Call2 0x542

0x52c: Pop(-2, 4); TaskReturn
0x52d: Pop(2)
0x52e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x52f: Pop(0)
...
0x538: Stack[-10] = Stack[-1]
0x539: Call2 0x8e8

0x53a: Pop(1)
0x53b: @ StopDialog(Stack[-4])
0x53c: Pop(0)
0x53d: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x53e: Pop(0)
0x53f: Stack[-2] = Stack[-10]
0x540: Return(); Pop(8)
...
0x568: Push("all") // @poff=138
0x569: Push("idle") // @poff=146
...
0x571: Push("all") // @poff=138
0x572: Push("idle") // @poff=146
...
0x5c1: Pop(0)
0x5c2: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x5c3: Pop(1)
0x5c4: PushEmpty(int)
0x5c5: Call2 0xa06

0x5c6: Pop(0)
0x5c7: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x5c8: Pop(1)
0x5c9: PushEmpty(string)
0x5ca: Call2 0xa0a

0x5cb: Pop(0)
0x5cc: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x5cd: Pop(1)
0x5ce: PushEmpty(string)
0x5cf: Call2 0xa0c

0x5d0: Pop(0)
0x5d1: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x5d2: Pop(1)
0x5d3: PushEmpty(int)
0x5d4: Call2 0xb03

0x5d5: Pop(0)
0x5d6: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x5d7: Pop(1)
0x5d8: Stack[-2] = (int) -1
...
0x5e9: Stack[-11] = Stack[-2]
0x5ea: Stack[-6] = Stack[-1]
0x5eb: Push(-2, 4); TaskCall(9)
0x5ec: Call2 0x603

0x5ed: Pop(-2, 4); TaskReturn
0x5ee: Pop(2)
0x5ef: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5f0: Pop(0)
...
0x5f3: @ sync()
0x5f4: Pop(0)
0x5f5: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5f6: Pop(0)
0x5f7: GOTO 0x5f1
...
0x5fd: Pop(0)
0x5fe: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x5ff: Pop(0)
0x600: Stack[-2] = Stack[-10]
0x601: Return(); Pop(8)
...
0x61a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x61b: Pop(3)
...
0x633: Push("all") // @poff=138
0x634: Push("idle") // @poff=146
...
0x7a0: Stack[-2] = Stack[-5]
0x7a1: Pop(2)
0x7a2: Return(); Pop(2)

0x7a3: Stack[-1] = 0
0x7a4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x7a5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x7a6: @ RotateAsync(Stack[-2], Stack[-1])
0x7a7: Pop(2)
0x7a8: Return(); Pop(0)

0x7a9: PushEmpty(object, bool, object, bool)
0x7aa: Push("player") // @poff=224
...
0x885: Pop(0)
0x886: @@ GetPosition(Stack[-2]); Obj=7 // @poff=238
0x887: Pop(0)
...
0x892: Pop(2)
0x893: Stack[-1] = Stack[-8]
0x894: Return(); Pop(6)

0x895: PushEmpty(cvector, cvector)
0x896: @@ GetPosition(Stack[-1]); Obj=3 // @poff=238
0x897: Pop(0)
0x898: PushEmpty(bool, cvector)
0x899: Stack[-3] = Stack[-1]
0x89a: Call2 0x88b

0x89b: Stack[-2] = Stack[-6]
0x89c: Pop(2)
0x89d: Return(); Pop(2)
...
0x8a4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=238
0x8a5: Pop(0)
0x8a6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=250
0x8a7: Pop(0)
...
0x8f6: Push("head") // @poff=264
0x8f7: @ UnlookAsync(Stack[-1])
0x8f8: Pop(1)
0x8f9: Return(); Pop(2)

0x8fa: PushEmpty(int, int, int, int)
0x8fb: Push("voice_common") // @poff=274
...
0x913: Push("voice_common") // @poff=274
0x914: Push((int) 1)
...
0x91b: Push("voice_common") // @poff=274
0x91c: Push((int) 0)
...
0x92e: Push("voice_common") // @poff=274
0x92f: Push((int) 1)
...
0x93c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x93d: Pop(1)
...
0x967: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x968: Pop(1)
...
0x97c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x97d: Pop(1)
0x97e: PushEmpty(bool, string)
0x97f: Stack[-3] = Stack[-1]
0x980: Call2 0x9a3

0x981: Stack[-2] = Stack[-14]
0x982: Pop(2)
0x983: Return(); Pop(10)
...
0x98f: Push("Can't find lsh animation : ") // @poff=332
...
0x99e: Push("Can't find lsh animation : ") // @poff=332
...
0x9c2: Push((float)9.999999974752427e-07)
...
0x9d0: Pop(0)
0x9d1: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xa0a: Stack[-1] = "ui/NPC_Lara.png" // @poff=388
0xa0b: Return(); Pop(0)

0xa0c: Stack[-1] = "ui/NPC_Lara_b.png" // @poff=420
0xa0d: Return(); Pop(0)
...
0xa17: Stack[-1] = Stack[-2]
0xa18: Pop(1)
0xa19: Push("b4q01LaraGotoRubin") // @poff=468
0xa1a: Push("pt_map_warehouse_gangster") // @poff=506
0xa1b: Push((int) 1)
...
0xa1f: Pop(0)
0xa20: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=558
0xa21: Pop(5)
0xa22: PushEmpty()
0xa23: Call2 0xa9b
...
0xa26: Stack[-2] = "quest_b4_01" // @poff=566
0xa27: Stack[-1] = "place_rubin" // @poff=590
0xa28: Call2 0x9ce
...
0xa2b: Stack[-1] = 0
0xa2c: PushEmpty()
0xa2d: Push("b4q01LaraWasBadRep") // @poff=614
0xa2e: Push((int) 1)
...
0xa42: Stack[-1] = Stack[-4]
0xa43: Pop(1)
0xa44: Stack[-2] = "pt_map_warehouse_gangster" // @poff=506
0xa45: Stack[-1] = (int) 2
0xa46: Call2 0xae2
...
0xa4a: Pop(0)
0xa4b: @@ ShowMap(Stack[-1]); Obj=2 // @poff=692
0xa4c: Pop(1)
0xa4d: Return(); Pop(0)

0xa4e: PushEmpty()
0xa4f: PushEmpty(int, string)
0xa50: Stack[-1] = "b8q02" // @poff=700
0xa51: Call2 0x9c9
...
0xa5c: Stack[-1] = "oob8Lara1" // @poff=672
0xa5d: Call2 0x9c9
...
0xa7e: Stack[-1] = "b4q01LaraWasBadRep" // @poff=614
0xa7f: Call2 0x9c9
...
0xa8a: Stack[-1] = "oob4Lara1" // @poff=652
0xa8b: Call2 0x9c9
...
0xa95: Push("reputation") // @poff=712
0xa96: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=316
0xa97: Pop(1)
0xa98: Push((float)0.699999988079071)
...
0xaad: Push("Can't retrieve diary root") // @poff=734
0xaae: @ Trace(Stack[-1])
0xaaf: Pop(1)
...
0xab8: Stack[-1] = Stack[-4]
0xab9: Pop(1)
0xaba: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=786
0xabb: Pop(0)
0xabc: Pop(0); Push((bool) Stack[-2] == 0)
0xabd: IF (Stack[-1] == 0) GOTO 0xac4; Pop(1)

0xabe: Push("Can't find diary parent with id: ") // @poff=791
...
0xac4: @@ AddChild(Stack[-8]); Obj=2 // @poff=859
0xac5: Pop(0)
0xac6: Push((int) 7)
0xac7: @ SendWorldWndMessage(Stack[-1])
0xac8: Pop(1)
0xac9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=868
0xaca: Pop(0)
...
0xad3: Pop(0)
0xad4: Pop(0); PushNull((bool) Stack[-2] == 0)
0xad5: IF (Stack[-1] == 0) GOTO 0xadc; Pop(1)

0xad6: Push("Can't find main outdoor scene") // @poff=880
0xad7: @ Trace(Stack[-1])
0xad8: Pop(1)
0xad9: Stack[-1] = 0
0xada: Stack[-1] = Stack[-5]
0xadb: Return(); Pop(4)

0xadc: @@ GetMap(Stack[-1]); Obj=2 // @poff=940
0xadd: Pop(0)
0xade: Stack[-1] = Stack[-5]
0xadf: Return(); Pop(4)
...
0xae4: Pop(0)
0xae5: Pop(0); PushNull((bool) Stack[-2] == 0)
0xae6: IF (Stack[-1] == 0) GOTO 0xaeb; Pop(1)

0xae7: Push("Can't find main outdoor scene") // @poff=880
0xae8: @ Trace(Stack[-1])
0xae9: Pop(1)
0xaea: Return(); Pop(8)

0xaeb: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=947
0xaec: Pop(0)
0xaed: Pop(0); Push((bool) Stack[-1] == 0)
0xaee: IF (Stack[-1] == 0) GOTO 0xaf5; Pop(1)

0xaef: Push("Warning: outdoor scene locator ") // @poff=958
0xaf0: Pop(1); Push(Stack[-1] + Stack[-11]);
0xaf1: Push(" doesnt exist") // @poff=1022
0xaf2: Pop(2); Push(Stack[-2] + Stack[-1]);
0xaf3: @ Trace(Stack[-1])
0xaf4: Pop(1)
0xaf5: @@ GetMap(Stack[-11]); Obj=2 // @poff=940
0xaf6: Pop(0)
0xaf7: Pop(0); PushNull((bool) Stack[-11] == 0)
0xaf8: IF (Stack[-1] == 0) GOTO 0xafd; Pop(1)

0xaf9: Push("Can't find map") // @poff=1050
0xafa: @ Trace(Stack[-1])
0xafb: Pop(1)
0xafc: Return(); Pop(8)
...
0xaff: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1080
0xb00: Pop(2)
0xb01: Return(); Pop(8)

0xb02: Stack[-2] = 0
0xb03: PushEmpty(int, int)
0xb04: Push("branch") // @poff=1093
