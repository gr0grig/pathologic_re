...
Strings:
	...
	W:mt_mark
	W:d12_mark
// @pool_raw:
// @pool_encoding:utf8
...
0x103: Pop(0)
0x104: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x105: Pop(1)
0x106: PushEmpty(int)
0x107: Call2 0x52f

0x108: Pop(0)
0x109: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x10a: Pop(1)
0x10b: PushEmpty(string)
0x10c: Call2 0x533

0x10d: Pop(0)
0x10e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x10f: Pop(1)
0x110: PushEmpty(string)
0x111: Call2 0x535

0x112: Pop(0)
0x113: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x114: Pop(1)
0x115: PushEmpty(int)
0x116: Call2 0x539

0x117: Pop(0)
0x118: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x119: Pop(1)
0x11a: Stack[-2] = (int) -1
...
0x126: Stack[-1] = Stack[-2]
0x127: Pop(1)
0x128: Call2 0x439

0x129: Pop(2)
0x12a: PushEmpty(object, object)
0x12b: Stack[-11] = Stack[-2]
0x12c: Stack[-6] = Stack[-1]
0x12d: Push(-2, 4); TaskCall(3)
0x12e: Call2 0x145

0x12f: Pop(-2, 4); TaskReturn
0x130: Pop(2)
0x131: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x132: Pop(0)
...
0x135: @ sync()
0x136: Pop(0)
0x137: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x138: Pop(0)
0x139: GOTO 0x133

0x13a: PushEmpty(object)
0x13b: Stack[-10] = Stack[-1]
0x13c: Call2 0x427

0x13d: Pop(1)
0x13e: @ StopDialog(Stack[-4])
0x13f: Pop(0)
0x140: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x141: Pop(0)
0x142: Stack[-2] = Stack[-10]
0x143: Return(); Pop(8)
...
0x14c: Stack[-1] = "Neutral" // @poff=156
0x14d: Call2 0x184
...
0x1a4: Stack[-1] = "Neutral" // @poff=156
0x1a5: Call2 0x184
...
0x1c0: Stack[-1] = "Neutral" // @poff=156
0x1c1: Call2 0x184
...
0x1d7: Stack[-1] = "Neutral" // @poff=156
0x1d8: Call2 0x184
...
0x24f: Stack[-1] = "Neutral" // @poff=156
0x250: Call2 0x282
...
0x2a2: Stack[-1] = "Neutral" // @poff=156
0x2a3: Call2 0x282
...
0x2df: Stack[-2] = Stack[-5]
0x2e0: Pop(2)
0x2e1: Return(); Pop(2)

0x2e2: Stack[-1] = 0
0x2e3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2e4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2e5: @ RotateAsync(Stack[-2], Stack[-1])
0x2e6: Pop(2)
0x2e7: Return(); Pop(0)

0x2e8: PushEmpty(object, bool, object, bool)
0x2e9: Push("player") // @poff=172
...
0x346: Stack[-1] = "Neutral" // @poff=156
0x347: Call2 0x4c3
...
0x355: Stack[-1] = "Neutral" // @poff=156
0x356: Call2 0x4c3
...
0x36c: Stack[-1] = "Neutral" // @poff=156
0x36d: Call2 0x4c3
...
0x3a0: Stack[-3] = (int) 0
0x3a1: Push("all") // @poff=138
0x3a2: PushEmpty(string, int)
0x3a3: Stack[-6] = Stack[-1]
0x3a4: Call2 0x517
...
0x3c4: Pop(0)
0x3c5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=186
0x3c6: Pop(0)
...
0x3d5: @@ GetPosition(Stack[-1]); Obj=3 // @poff=186
0x3d6: Pop(0)
...
0x3e3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=186
0x3e4: Pop(0)
0x3e5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=198
0x3e6: Pop(0)
...
0x452: Push("voice_common") // @poff=222
0x453: Push((int) 1)
...
0x45a: Push("voice_common") // @poff=222
0x45b: Push((int) 0)
...
0x46d: Push("voice_common") // @poff=222
0x46e: Push((int) 1)
...
0x47b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x47c: Pop(1)
...
0x4a6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x4a7: Pop(1)
...
0x4bb: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=264
0x4bc: Pop(1)
0x4bd: PushEmpty(bool, string)
0x4be: Stack[-3] = Stack[-1]
0x4bf: Call2 0x4e2

0x4c0: Stack[-2] = Stack[-14]
0x4c1: Pop(2)
0x4c2: Return(); Pop(10)
...
0x4ce: Push("Can't find lsh animation : ") // @poff=276
...
0x4dd: Push("Can't find lsh animation : ") // @poff=276
...
0x501: Push((float)9.999999974752427e-07)
...
0x533: Stack[-1] = "ui/NPC_Mark.png" // @poff=332
0x534: Return(); Pop(0)

0x535: Stack[-1] = "ui/NPC_Mark_b.png" // @poff=364
0x536: Return(); Pop(0)
...
0x555: Pop(2)
0x556: Push("mt_mark") // @poff=414
0x557: Push((int) 1)
0x558: @ SetVariable(Stack[-2], Stack[-1])
0x559: Pop(2)
0x55a: Push("d12_mark") // @poff=430
...
0x569: Stack[-7] = Stack[-1]
0x56a: Push(-2, 1); TaskCall(2)
0x56b: Call2 0xf4

0x56c: Pop(-2, 1); TaskReturn
0x56d: Pop(2)
0x56e: Push("d12_mark") // @poff=430
0x56f: Push((int) 1)
