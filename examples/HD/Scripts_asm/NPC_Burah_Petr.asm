...
Strings:
	...
	W:mt_petr
	W:d12_petr
// @pool_raw:
// @pool_encoding:utf8
...
0x1cd: Stack[-1] = "Untrust" // @poff=156
0x1ce: Call2 0x172
...
0x1f6: Stack[-1] = "Untrust" // @poff=156
0x1f7: Call2 0x172
...
0x208: Stack[-1] = "Untrust" // @poff=156
0x209: Call2 0x172
...
0x2a4: Push("all") // @poff=138
0x2a5: Push("idle") // @poff=146
...
0x335: Pop(0)
0x336: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x337: Pop(1)
0x338: PushEmpty(int)
0x339: Call2 0x663

0x33a: Pop(0)
0x33b: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x33c: Pop(1)
0x33d: PushEmpty(string)
0x33e: Call2 0x667

0x33f: Pop(0)
0x340: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x341: Pop(1)
0x342: PushEmpty(string)
0x343: Call2 0x669

0x344: Pop(0)
0x345: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x346: Pop(1)
0x347: PushEmpty(int)
0x348: Call2 0x67f

0x349: Pop(0)
0x34a: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x34b: Pop(1)
0x34c: Stack[-2] = (int) -1
...
0x367: @ sync()
0x368: Pop(0)
0x369: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x36a: Pop(0)
0x36b: GOTO 0x365

0x36c: PushEmpty(object)
0x36d: Stack[-10] = Stack[-1]
0x36e: Call2 0x556

0x36f: Pop(1)
0x370: @ StopDialog(Stack[-4])
0x371: Pop(0)
0x372: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x373: Pop(0)
...
0x40c: Stack[-3] = Stack[-1]
0x40d: Call2 0x503

0x40e: Stack[-2] = Stack[-5]
0x40f: Pop(2)
0x410: Return(); Pop(2)
...
0x4f3: Pop(0)
0x4f4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=186
0x4f5: Pop(0)
...
0x500: Pop(2)
0x501: Stack[-1] = Stack[-8]
0x502: Return(); Pop(6)

0x503: PushEmpty(cvector, cvector)
0x504: @@ GetPosition(Stack[-1]); Obj=3 // @poff=186
0x505: Pop(0)
0x506: PushEmpty(bool, cvector)
0x507: Stack[-3] = Stack[-1]
0x508: Call2 0x4f9

0x509: Stack[-2] = Stack[-6]
0x50a: Pop(2)
0x50b: Return(); Pop(2)
...
0x512: @@ GetPosition(Stack[-8]); Obj=20 // @poff=186
0x513: Pop(0)
0x514: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=198
0x515: Pop(0)
...
0x581: Push("voice_common") // @poff=222
0x582: Push((int) 1)
...
0x589: Push("voice_common") // @poff=222
0x58a: Push((int) 0)
...
0x59c: Push("voice_common") // @poff=222
0x59d: Push((int) 1)
...
0x5aa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x5ab: Pop(1)
...
0x5d5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x5d6: Pop(1)
...
0x5ea: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=264
0x5eb: Pop(1)
0x5ec: PushEmpty(bool, string)
0x5ed: Stack[-3] = Stack[-1]
0x5ee: Call2 0x611

0x5ef: Stack[-2] = Stack[-14]
0x5f0: Pop(2)
0x5f1: Return(); Pop(10)
...
0x5fd: Push("Can't find lsh animation : ") // @poff=280
...
0x60c: Push("Can't find lsh animation : ") // @poff=280
...
0x630: Push((float)9.999999974752427e-07)
...
0x667: Stack[-1] = "ui/NPC_Petr.png" // @poff=336
0x668: Return(); Pop(0)

0x669: Stack[-1] = "ui/NPC_Petr_b.png" // @poff=368
0x66a: Return(); Pop(0)
...
0x675: Stack[-1] = "oob2Petr1" // @poff=404
0x676: Call2 0x637
...
0x6bb: Stack[-7] = Stack[-1]
0x6bc: Push(-2, 1); TaskCall(4)
0x6bd: Call2 0x223

0x6be: Pop(-2, 1); TaskReturn
0x6bf: Pop(2)
0x6c0: Push("d12_petr") // @poff=454
0x6c1: Push((int) 1)
