...
Strings:
	...
	W:branch
	W:d12_rubin
// @pool_raw:
// @pool_encoding:utf8
...
0x13a: Stack[-11] = Stack[-2]
0x13b: Stack[-6] = Stack[-1]
0x13c: Push(-2, 4); TaskCall(3)
0x13d: Call2 0x154

0x13e: Pop(-2, 4); TaskReturn
0x13f: Pop(2)
0x140: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x141: Pop(0)
...
0x14e: Pop(0)
0x14f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x150: Pop(0)
0x151: Stack[-2] = Stack[-10]
0x152: Return(); Pop(8)
...
0x1eb: Stack[-2] = Stack[-5]
0x1ec: Pop(2)
0x1ed: Return(); Pop(2)

0x1ee: Stack[-1] = 0
0x1ef: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1f0: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1f1: @ RotateAsync(Stack[-2], Stack[-1])
0x1f2: Pop(2)
0x1f3: Return(); Pop(0)

0x1f4: PushEmpty(object, bool, object, bool)
0x1f5: Push("player") // @poff=156
...
0x26f: Stack[-5] = Stack[-1]
0x270: Call2 0x2e0

0x271: Pop(2)
0x272: EventEnable(0)
0x273: PushEmpty(object)
0x274: Stack[-4] = Stack[-1]
0x275: Call2 0x456
...
0x2ac: Stack[-3] = (int) 0
0x2ad: Push("all") // @poff=138
0x2ae: PushEmpty(string, int)
0x2af: Stack[-6] = Stack[-1]
0x2b0: Call2 0x423
...
0x2d0: Pop(0)
0x2d1: @@ GetPosition(Stack[-2]); Obj=7 // @poff=170
0x2d2: Pop(0)
...
0x2e1: @@ GetPosition(Stack[-1]); Obj=3 // @poff=170
0x2e2: Pop(0)
0x2e3: PushEmpty(bool, cvector)
0x2e4: Stack[-3] = Stack[-1]
0x2e5: Call2 0x2d6

0x2e6: Stack[-2] = Stack[-6]
0x2e7: Pop(2)
0x2e8: Return(); Pop(2)
...
0x2ef: @@ GetPosition(Stack[-8]); Obj=20 // @poff=170
0x2f0: Pop(0)
0x2f1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=182
0x2f2: Pop(0)
...
0x318: Pop(0)
0x319: Push((bool) 1)
0x31a: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x31b: Pop(1)
0x31c: Push(CvectorIndex(Stack[-4], 0))
0x31d: Push(CvectorIndex(Stack[-5], 2))
0x31e: @ Rotate(Stack[-2], Stack[-1])
0x31f: Pop(2)
...
0x325: Push("head") // @poff=196
0x326: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x327: Pop(1)
0x328: Push(Stack[-1])
0x329: IF (Stack[-1] == 0) GOTO 0x32d; Pop(1)

0x32a: Push("head") // @poff=196
0x32b: @ LookAsyncCamera(Stack[-1])
0x32c: Pop(1)
0x32d: @ CameraWaitForPlayFinish()
0x32e: Pop(0)
0x32f: @ ResumeWorld()
0x330: Pop(0)
0x331: Stack[-21] = (bool) 1
0x332: Return(); Pop(18)

0x333: PushEmpty(bool, bool)
0x334: Push((bool) 1)
0x335: @ CameraSwitchToNormal(Stack[-1])
0x336: Pop(1)
...
0x341: Push("head") // @poff=196
0x342: @ UnlookAsync(Stack[-1])
0x343: Pop(1)
0x344: Return(); Pop(2)

0x345: PushEmpty(int, int, int, int)
0x346: Push("voice_common") // @poff=206
0x347: @ GetVariable(Stack[-1], Stack[-3])
0x348: Pop(1)
0x349: Push(Stack[-2])
0x34a: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)
...
0x350: IF (Stack[-1] == 0) GOTO 0x359; Pop(1)

0x351: PushEmpty(bool, object)
0x352: Stack[-7] = Stack[-1]
0x353: Call2 0x3a4
...
0x357: Stack[-6] = (bool) 0
0x358: Return(); Pop(4)

0x359: Push((int) 2)
0x35a: @ irand(Stack[-2], Stack[-1])
0x35b: Pop(1)
0x35c: Push(Stack[-1])
0x35d: IF (Stack[-1] == 0) GOTO 0x366; Pop(1)

0x35e: Push("voice_common") // @poff=206
0x35f: Push((int) 1)
0x360: Pop(1); Push(Stack[-4] + Stack[-1]);
0x361: Push((int) 3)
...
0x366: Push("voice_common") // @poff=206
0x367: Push((int) 0)
...
0x370: IF (Stack[-1] == 0) GOTO 0x379; Pop(1)
...
0x377: Stack[-6] = (bool) 0
0x378: Return(); Pop(4)

0x379: Push("voice_common") // @poff=206
0x37a: Push((int) 1)
...
0x380: Stack[-5] = "c" // @poff=232
0x381: Stack[-4] = (int) 0
0x382: Push((int) 1)
0x383: IF (Stack[-1] == 0) GOTO 0x38f; Pop(1)

0x384: Push((int) 1)
0x385: Pop(1); Push(Stack[-5] + Stack[-1]);
0x386: Pop(1); Push(Stack[-6] + Stack[-1]);
0x387: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=236
0x388: Pop(1)
0x389: Pop(0); Push((bool) Stack[-3] == 0)
0x38a: IF (Stack[-1] == 0) GOTO 0x38c; Pop(1)

0x38b: GOTO 0x38f

0x38c: Push((int) 1)
0x38d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x38e: GOTO 0x382

0x38f: Pop(0); Push((bool) Stack[-4] == 0)
0x390: IF (Stack[-1] == 0) GOTO 0x393; Pop(1)

0x391: Stack[-12] = (bool) 0
0x392: Return(); Pop(10)

0x393: Stack[-2] = (int) 0
0x394: Push((int) 1)
0x395: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x396: IF (Stack[-1] == 0) GOTO 0x399; Pop(1)

0x397: @ irand(Stack[-2], Stack[-4])
0x398: Pop(0)
0x399: Push((int) 1)
0x39a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x39b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x39c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x39d: Pop(1)
0x39e: PushEmpty(bool, string)
0x39f: Stack[-3] = Stack[-1]
0x3a0: Call2 0x3ee

0x3a1: Stack[-2] = Stack[-14]
0x3a2: Pop(2)
0x3a3: Return(); Pop(10)

0x3a4: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3a5: Push("d") // @poff=202
0x3a6: PushEmpty(int)
0x3a7: Call2 0x414

0x3a8: Pop(0)
0x3a9: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3aa: Push("m") // @poff=260
0x3ab: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3ac: Stack[-4] = (int) 0
0x3ad: Push((int) 1)
0x3ae: IF (Stack[-1] == 0) GOTO 0x3ba; Pop(1)

0x3af: Push((int) 1)
0x3b0: Pop(1); Push(Stack[-5] + Stack[-1]);
0x3b1: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3b2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=236
0x3b3: Pop(1)
...
0x3b7: Push((int) 1)
0x3b8: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3b9: GOTO 0x3ad

0x3ba: Pop(0); Push((bool) Stack[-4] == 0)
0x3bb: IF (Stack[-1] == 0) GOTO 0x3be; Pop(1)

0x3bc: Stack[-12] = (bool) 0
0x3bd: Return(); Pop(10)

0x3be: Stack[-2] = (int) 0
0x3bf: Push((int) 1)
0x3c0: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x3c1: IF (Stack[-1] == 0) GOTO 0x3c4; Pop(1)

0x3c2: @ irand(Stack[-2], Stack[-4])
0x3c3: Pop(0)
0x3c4: Push((int) 1)
0x3c5: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3c6: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3c7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x3c8: Pop(1)
0x3c9: PushEmpty(bool, string)
0x3ca: Stack[-3] = Stack[-1]
0x3cb: Call2 0x3ee

0x3cc: Stack[-2] = Stack[-14]
0x3cd: Pop(2)
0x3ce: Return(); Pop(10)

0x3cf: PushEmpty(bool, float, float, bool, float, float)
0x3d0: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3d1: Pop(0)
0x3d2: Push(Stack[-3])
0x3d3: IF (Stack[-1] == 0) GOTO 0x3da; Pop(1)

0x3d4: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3d5: Pop(0)
0x3d6: Push((bool) 0)
0x3d7: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3d8: Pop(1)
0x3d9: GOTO 0x3de

0x3da: Push("Can't find lsh animation : ") // @poff=264
0x3db: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3dc: @ Trace(Stack[-1])
0x3dd: Pop(1)
0x3de: Return(); Pop(6)

0x3df: PushEmpty(bool, float, float, bool, float, float)
0x3e0: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3e1: Pop(0)
0x3e2: Push(Stack[-3])
0x3e3: IF (Stack[-1] == 0) GOTO 0x3e9; Pop(1)

0x3e4: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3e5: Pop(0)
0x3e6: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3e7: Pop(0)
0x3e8: GOTO 0x3ed

0x3e9: Push("Can't find lsh animation : ") // @poff=264
0x3ea: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3eb: @ Trace(Stack[-1])
0x3ec: Pop(1)
0x3ed: Return(); Pop(6)
...
0x3f3: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3f4: Pop(0)
0x3f5: Push(Stack[-1])
0x3f6: IF (Stack[-1] == 0) GOTO 0x3fb; Pop(1)

0x3f7: @ lshPlaySpeech(Stack[-3])
0x3f8: Pop(0)
0x3f9: Stack[-4] = (bool) 1
0x3fa: Return(); Pop(2)
...
0x40b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x40c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x40d: Push((float)9.999999974752427e-07)
0x40e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x40f: IF (Stack[-1] == 0) GOTO 0x412; Pop(1)

0x410: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x411: Return(); Pop(2)

0x412: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x413: Return(); Pop(2)
...
0x420: Pop(0)
0x421: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x422: Return(); Pop(0)

0x423: PushEmpty(string, string)
0x424: Stack[-1] = "idle" // @poff=146
0x425: Push(Stack[-3])
0x426: IF (Stack[-1] == 0) GOTO 0x428; Pop(1)

0x427: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x428: Stack[-1] = Stack[-4]
0x429: Return(); Pop(2)

0x42a: PushEmpty(int, bool, int, bool)
0x42b: Stack[-2] = (int) 0
...
0x430: Pop(1)
0x431: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x432: Pop(2)
...
0x436: Push((int) 1)
0x437: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x438: GOTO 0x42c

0x439: Stack[-2] = Stack[-5]
0x43a: Return(); Pop(4)

0x43b: Stack[-1] = (int) 515551
0x43c: Return(); Pop(0)

0x43d: Stack[-1] = (int) 502876
0x43e: Return(); Pop(0)

0x43f: Stack[-1] = "ui/NPC_Rubin.png" // @poff=320
0x440: Return(); Pop(0)

0x441: Stack[-1] = "ui/NPC_Rubin_b.png" // @poff=354
0x442: Return(); Pop(0)
...
0x446: Push("branch") // @poff=392
0x447: @ GetVariable(Stack[-1], Stack[-2])
0x448: Pop(1)
0x449: Push((int) 0)
...
0x457: Push("d12_rubin") // @poff=406
0x458: @ GetVariable(Stack[-1], Stack[-2])
0x459: Pop(1)
0x45a: PushEmpty(bool)
0x45b: Stack[-1] = (bool) 0
0x45c: PushEmpty(bool, int)
0x45d: Stack[-1] = (int) 12
0x45e: Call2 0x41d

0x45f: Pop(1)
0x460: IF (Stack[-1] == 0) GOTO 0x464; Pop(1)

0x461: Pop(0); Push((bool) Stack[-2] == 0)
0x462: IF (Stack[-1] == 0) GOTO 0x464; Pop(1)

0x463: Stack[-1] = (bool) 1
0x464: IF (Stack[-1] == 0) GOTO 0x470; Pop(1)

0x465: PushEmpty(int, object)
0x466: Stack[-5] = Stack[-1]
0x467: Push(-2, 1); TaskCall(0)
0x468: Call2 0x0

0x469: Pop(-2, 1); TaskReturn
0x46a: Pop(2)
0x46b: Push("d12_rubin") // @poff=406
0x46c: Push((int) 1)
0x46d: @ SetVariable(Stack[-2], Stack[-1])
0x46e: Pop(2)
0x46f: Return(); Pop(2)

0x470: PushEmpty(int, object)
0x471: Stack[-5] = Stack[-1]
0x472: Push(-2, 1); TaskCall(2)
0x473: Call2 0x103

0x474: Pop(-2, 1); TaskReturn
0x475: Pop(2)
0x476: Return(); Pop(2)
