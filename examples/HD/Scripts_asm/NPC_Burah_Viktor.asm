...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x115: Pop(0)
0x116: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x117: Pop(1)
0x118: PushEmpty(int)
0x119: Call2 0x81e

0x11a: Pop(0)
0x11b: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x11c: Pop(1)
0x11d: PushEmpty(string)
0x11e: Call2 0x822

0x11f: Pop(0)
0x120: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x121: Pop(1)
0x122: PushEmpty(string)
0x123: Call2 0x824

0x124: Pop(0)
0x125: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x126: Pop(1)
0x127: PushEmpty(int)
0x128: Call2 0x8d8

0x129: Pop(0)
0x12a: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x12b: Pop(1)
0x12c: Stack[-2] = (int) -1
...
0x20a: Stack[-1] = "Confusion" // @poff=168
0x20b: Call2 0x1a5
...
0x245: Stack[-1] = "Confusion" // @poff=168
0x246: Call2 0x1a5
...
0x2a4: Stack[-1] = "Surprise" // @poff=198
0x2a5: Call2 0x1a5
...
0x2b6: Stack[-1] = "Surprise" // @poff=198
0x2b7: Call2 0x1a5
...
0x2e0: Pop(0)
0x2e1: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2e2: Pop(1)
0x2e3: PushEmpty(int)
0x2e4: Call2 0x81e

0x2e5: Pop(0)
0x2e6: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2e7: Pop(1)
0x2e8: PushEmpty(string)
0x2e9: Call2 0x822

0x2ea: Pop(0)
0x2eb: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2ec: Pop(1)
0x2ed: PushEmpty(string)
0x2ee: Call2 0x824

0x2ef: Pop(0)
0x2f0: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2f1: Pop(1)
0x2f2: PushEmpty(int)
0x2f3: Call2 0x8d8

0x2f4: Pop(0)
0x2f5: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2f6: Pop(1)
0x2f7: Stack[-2] = (int) -1
...
0x308: Stack[-11] = Stack[-2]
0x309: Stack[-6] = Stack[-1]
0x30a: Push(-2, 4); TaskCall(6)
0x30b: Call2 0x322

0x30c: Pop(-2, 4); TaskReturn
0x30d: Pop(2)
0x30e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x30f: Pop(0)
...
0x312: @ sync()
0x313: Pop(0)
0x314: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x315: Pop(0)
0x316: GOTO 0x310

0x317: PushEmpty(object)
0x318: Stack[-10] = Stack[-1]
0x319: Call2 0x707

0x31a: Pop(1)
0x31b: @ StopDialog(Stack[-4])
0x31c: Pop(0)
0x31d: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x31e: Pop(0)
0x31f: Stack[-2] = Stack[-10]
0x320: Return(); Pop(8)
...
0x370: Push("all") // @poff=138
0x371: Push("idle") // @poff=146
...
0x379: Push("all") // @poff=138
0x37a: Push("idle") // @poff=146
...
0x490: Pop(0)
0x491: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x492: Pop(1)
0x493: PushEmpty(int)
0x494: Call2 0x81e

0x495: Pop(0)
0x496: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x497: Pop(1)
0x498: PushEmpty(string)
0x499: Call2 0x822

0x49a: Pop(0)
0x49b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x49c: Pop(1)
0x49d: PushEmpty(string)
0x49e: Call2 0x824

0x49f: Pop(0)
0x4a0: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x4a1: Pop(1)
0x4a2: PushEmpty(int)
0x4a3: Call2 0x8d8

0x4a4: Pop(0)
0x4a5: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x4a6: Pop(1)
0x4a7: Stack[-2] = (int) -1
...
0x4b8: Stack[-11] = Stack[-2]
0x4b9: Stack[-6] = Stack[-1]
...
0x4c2: @ sync()
0x4c3: Pop(0)
0x4c4: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4c5: Pop(0)
0x4c6: GOTO 0x4c0

0x4c7: PushEmpty(object)
0x4c8: Stack[-10] = Stack[-1]
0x4c9: Call2 0x707

0x4ca: Pop(1)
0x4cb: @ StopDialog(Stack[-4])
0x4cc: Pop(0)
0x4cd: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4ce: Pop(0)
...
0x4d9: Stack[-1] = "Neutral" // @poff=89
0x4da: Call2 0x511

0x4db: Pop(1)
0x4dc: Push((int) 535231)
0x4dd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x4de: Pop(1)
0x4df: @@@ ClearReplies(); Obj=0 // @poff=116
0x4e0: Pop(0)
...
0x593: Pop(0)
0x594: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x595: Pop(1)
0x596: PushEmpty(int)
0x597: Call2 0x81e

0x598: Pop(0)
0x599: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x59a: Pop(1)
0x59b: PushEmpty(string)
0x59c: Call2 0x822

0x59d: Pop(0)
0x59e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x59f: Pop(1)
0x5a0: PushEmpty(string)
0x5a1: Call2 0x824

0x5a2: Pop(0)
0x5a3: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x5a4: Pop(1)
0x5a5: PushEmpty(int)
0x5a6: Call2 0x8d8

0x5a7: Pop(0)
0x5a8: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x5a9: Pop(1)
0x5aa: Stack[-2] = (int) -1
...
0x656: PushEmpty()
0x657: Push("icot_viktor_NPC_Trigger") // @poff=216
...
0x6b5: @@ GetPosition(Stack[-1]); Obj=3 // @poff=276
0x6b6: Pop(0)
...
0x6c3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=276
0x6c4: Pop(0)
0x6c5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=288
0x6c6: Pop(0)
...
0x732: Push("voice_common") // @poff=312
0x733: Push((int) 1)
...
0x73a: Push("voice_common") // @poff=312
0x73b: Push((int) 0)
...
0x74d: Push("voice_common") // @poff=312
0x74e: Push((int) 1)
...
0x75b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=342
0x75c: Pop(1)
...
0x786: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=342
0x787: Pop(1)
...
0x79b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=354
0x79c: Pop(1)
0x79d: PushEmpty(bool, string)
0x79e: Stack[-3] = Stack[-1]
0x79f: Call2 0x7c2

0x7a0: Stack[-2] = Stack[-14]
0x7a1: Pop(2)
0x7a2: Return(); Pop(10)
...
0x7ae: Push("Can't find lsh animation : ") // @poff=370
...
0x7bd: Push("Can't find lsh animation : ") // @poff=370
...
0x7f2: Push("Door ") // @poff=426
0x7f3: Pop(1); Push(Stack[-1] + Stack[-5]);
0x7f4: Push(" not found") // @poff=438
0x7f5: Pop(2); Push(Stack[-2] + Stack[-1]);
0x7f6: @ Trace(Stack[-1])
0x7f7: Pop(1)
0x7f8: GOTO 0x7fc

0x7f9: Push("locked") // @poff=460
0x7fa: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=474
0x7fb: Pop(1)
0x7fc: Return(); Pop(2)
...
0x800: Pop(0)
0x801: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x822: Stack[-1] = "ui/NPC_Viktor.png" // @poff=486
0x823: Return(); Pop(0)

0x824: Stack[-1] = "ui/NPC_Viktor_b.png" // @poff=522
0x825: Return(); Pop(0)
...
0x82f: Stack[-1] = Stack[-2]
0x830: Pop(1)
0x831: Push("b7q01DankoGotoSobor") // @poff=574
0x832: Push("pt_map_aglaja") // @poff=614
0x833: Push((int) 1)
...
0x837: Pop(0)
0x838: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=642
0x839: Pop(5)
0x83a: PushEmpty()
0x83b: Call2 0x891
...
0x83e: Stack[-2] = "quest_b7_01" // @poff=650
0x83f: Stack[-1] = "place_aglaja" // @poff=674
0x840: Call2 0x7fe
...
0x843: Stack[-1] = 0
0x844: PushEmpty()
0x845: Push("oob6Viktor1") // @poff=700
0x846: Push((int) 1)
...
0x84d: Stack[-1] = Stack[-2]
0x84e: Pop(1)
0x84f: Push("b6q03ViktorGotoMaria") // @poff=724
0x850: Push("pt_map_maria") // @poff=766
0x851: Push((int) 3)
...
0x855: Pop(0)
0x856: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=642
0x857: Pop(5)
0x858: Return(); Pop(2)
...
0x85c: Stack[-2] = "cot_maria@door1" // @poff=792
...
0x861: PushEmpty()
0x862: Push("b6ViktorVisit") // @poff=824
0x863: Push((int) 1)
...
0x867: PushEmpty()
0x868: Push("playsound") // @poff=852
0x869: Push("mapmark") // @poff=872
...
0x86f: Stack[-1] = "b6q03NinaTalk" // @poff=888
0x870: Call2 0x7e8
...
0x87b: Stack[-1] = "oob6Viktor1" // @poff=700
0x87c: Call2 0x7e8
...
0x8a3: Push("Can't retrieve diary root") // @poff=916
0x8a4: @ Trace(Stack[-1])
0x8a5: Pop(1)
0x8a6: Stack[-3] = (bool) 0
0x8a7: Return(); Pop(2)

0x8a8: Stack[-1] = Stack[-3]
0x8a9: Return(); Pop(2)
...
0x8af: Pop(1)
0x8b0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=968
0x8b1: Pop(0)
0x8b2: Pop(0); Push((bool) Stack[-2] == 0)
0x8b3: IF (Stack[-1] == 0) GOTO 0x8ba; Pop(1)

0x8b4: Push("Can't find diary parent with id: ") // @poff=973
...
0x8ba: @@ AddChild(Stack[-8]); Obj=2 // @poff=1041
0x8bb: Pop(0)
0x8bc: Push((int) 7)
0x8bd: @ SendWorldWndMessage(Stack[-1])
0x8be: Pop(1)
0x8bf: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1050
0x8c0: Pop(0)
...
0x8c9: Pop(0)
0x8ca: Pop(0); PushNull((bool) Stack[-2] == 0)
0x8cb: IF (Stack[-1] == 0) GOTO 0x8d2; Pop(1)

0x8cc: Push("Can't find main outdoor scene") // @poff=1062
0x8cd: @ Trace(Stack[-1])
0x8ce: Pop(1)
0x8cf: Stack[-1] = 0
...
0x8d2: @@ GetMap(Stack[-1]); Obj=2 // @poff=1122
0x8d3: Pop(0)
