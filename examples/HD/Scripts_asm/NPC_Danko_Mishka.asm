...
Strings:
	...
	W:d6q01
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x145: Pop(0)
0x146: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x147: Pop(1)
0x148: PushEmpty(int)
0x149: Call2 0x788

0x14a: Pop(0)
0x14b: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x14c: Pop(1)
0x14d: PushEmpty(string)
0x14e: Call2 0x78c

0x14f: Pop(0)
0x150: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x151: Pop(1)
0x152: PushEmpty(string)
0x153: Call2 0x78e

0x154: Pop(0)
0x155: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x156: Pop(1)
0x157: PushEmpty(int)
0x158: Call2 0x7b6

0x159: Pop(0)
0x15a: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x15b: Pop(1)
0x15c: Stack[-2] = (int) -1
...
0x16d: Stack[-11] = Stack[-2]
0x16e: Stack[-6] = Stack[-1]
0x16f: Push(-2, 4); TaskCall(3)
0x170: Call2 0x187

0x171: Pop(-2, 4); TaskReturn
0x172: Pop(2)
0x173: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x174: Pop(0)
...
0x177: @ sync()
0x178: Pop(0)
0x179: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x17a: Pop(0)
0x17b: GOTO 0x175

0x17c: PushEmpty(object)
0x17d: Stack[-10] = Stack[-1]
0x17e: Call2 0x67b

0x17f: Pop(1)
0x180: @ StopDialog(Stack[-4])
0x181: Pop(0)
0x182: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x183: Pop(0)
0x184: Stack[-2] = Stack[-10]
0x185: Return(); Pop(8)
...
0x24f: Stack[-1] = "Suspicion" // @poff=168
0x250: Call2 0x290
...
0x28a: Push("all") // @poff=138
0x28b: Push("idle") // @poff=146
...
0x2b8: Stack[-1] = "Suspicion" // @poff=168
0x2b9: Call2 0x290
...
0x2dd: Stack[-1] = "Suspicion" // @poff=168
0x2de: Call2 0x290
...
0x2ef: Stack[-1] = "Suspicion" // @poff=168
0x2f0: Call2 0x290
...
0x354: Pop(0)
0x355: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x356: Pop(1)
0x357: PushEmpty(int)
0x358: Call2 0x788

0x359: Pop(0)
0x35a: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x35b: Pop(1)
0x35c: PushEmpty(string)
0x35d: Call2 0x78c

0x35e: Pop(0)
0x35f: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x360: Pop(1)
0x361: PushEmpty(string)
0x362: Call2 0x78e

0x363: Pop(0)
0x364: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x365: Pop(1)
0x366: PushEmpty(int)
0x367: Call2 0x7b6

0x368: Pop(0)
0x369: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x36a: Pop(1)
0x36b: Stack[-2] = (int) -1
...
0x37c: Stack[-11] = Stack[-2]
0x37d: Stack[-6] = Stack[-1]
0x37e: Push(-2, 4); TaskCall(7)
0x37f: Call2 0x396

0x380: Pop(-2, 4); TaskReturn
0x381: Pop(2)
0x382: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x383: Pop(0)
...
0x386: @ sync()
0x387: Pop(0)
0x388: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x389: Pop(0)
0x38a: GOTO 0x384

0x38b: PushEmpty(object)
0x38c: Stack[-10] = Stack[-1]
0x38d: Call2 0x67b

0x38e: Pop(1)
0x38f: @ StopDialog(Stack[-4])
0x390: Pop(0)
0x391: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x392: Pop(0)
0x393: Stack[-2] = Stack[-10]
0x394: Return(); Pop(8)
...
0x3cf: Push("all") // @poff=138
0x3d0: Push("idle") // @poff=146
...
0x3f5: Stack[-1] = "Neutral" // @poff=89
0x3f6: Call2 0x3d5

0x3f7: Pop(1)
0x3f8: Push((int) 535284)
0x3f9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3fa: Pop(1)
0x3fb: @@@ ClearReplies(); Obj=0 // @poff=116
0x3fc: Pop(0)
...
0x457: Pop(0)
0x458: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x459: Pop(1)
0x45a: PushEmpty(int)
0x45b: Call2 0x788

0x45c: Pop(0)
0x45d: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x45e: Pop(1)
0x45f: PushEmpty(string)
0x460: Call2 0x78c

0x461: Pop(0)
0x462: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x463: Pop(1)
0x464: PushEmpty(string)
0x465: Call2 0x78e

0x466: Pop(0)
0x467: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x468: Pop(1)
0x469: PushEmpty(int)
0x46a: Call2 0x7b6

0x46b: Pop(0)
0x46c: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x46d: Pop(1)
0x46e: Stack[-2] = (int) -1
...
0x47a: Stack[-1] = Stack[-2]
0x47b: Pop(1)
0x47c: Call2 0x68d

0x47d: Pop(2)
0x47e: PushEmpty(object, object)
0x47f: Stack[-11] = Stack[-2]
0x480: Stack[-6] = Stack[-1]
0x481: Push(-2, 4); TaskCall(9)
0x482: Call2 0x499

0x483: Pop(-2, 4); TaskReturn
0x484: Pop(2)
0x485: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x486: Pop(0)
...
0x489: @ sync()
0x48a: Pop(0)
0x48b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x48c: Pop(0)
0x48d: GOTO 0x487

0x48e: PushEmpty(object)
0x48f: Stack[-10] = Stack[-1]
0x490: Call2 0x67b

0x491: Pop(1)
0x492: @ StopDialog(Stack[-4])
0x493: Pop(0)
0x494: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x495: Pop(0)
0x496: Stack[-2] = Stack[-10]
0x497: Return(); Pop(8)
...
0x4c4: Push("all") // @poff=138
0x4c5: Push("idle") // @poff=146
...
0x536: Stack[-1] = 0
0x537: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x538: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x539: @ RotateAsync(Stack[-2], Stack[-1])
0x53a: Pop(2)
0x53b: Return(); Pop(0)

0x53c: PushEmpty(object, bool, object, bool)
0x53d: Push("player") // @poff=212
...
0x5b7: Stack[-5] = Stack[-1]
0x5b8: Call2 0x628

0x5b9: Pop(2)
0x5ba: EventEnable(0)
0x5bb: PushEmpty(object)
0x5bc: Stack[-4] = Stack[-1]
0x5bd: Call2 0x7c7

0x5be: Pop(1)
0x5bf: PushEmpty(string)
0x5c0: Stack[-1] = "Neutral" // @poff=89
0x5c1: Call2 0x717
...
0x618: Pop(0)
0x619: @@ GetPosition(Stack[-2]); Obj=7 // @poff=226
0x61a: Pop(0)
...
0x625: Pop(2)
0x626: Stack[-1] = Stack[-8]
0x627: Return(); Pop(6)

0x628: PushEmpty(cvector, cvector)
0x629: @@ GetPosition(Stack[-1]); Obj=3 // @poff=226
0x62a: Pop(0)
0x62b: PushEmpty(bool, cvector)
0x62c: Stack[-3] = Stack[-1]
0x62d: Call2 0x61e

0x62e: Stack[-2] = Stack[-6]
0x62f: Pop(2)
0x630: Return(); Pop(2)
...
0x637: @@ GetPosition(Stack[-8]); Obj=20 // @poff=226
0x638: Pop(0)
0x639: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x63a: Pop(0)
...
0x6a6: Push("voice_common") // @poff=262
0x6a7: Push((int) 1)
...
0x6ae: Push("voice_common") // @poff=262
0x6af: Push((int) 0)
...
0x6c1: Push("voice_common") // @poff=262
0x6c2: Push((int) 1)
...
0x6cf: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x6d0: Pop(1)
...
0x6e4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x6e5: Pop(1)
0x6e6: PushEmpty(bool, string)
0x6e7: Stack[-3] = Stack[-1]
0x6e8: Call2 0x736

0x6e9: Stack[-2] = Stack[-14]
0x6ea: Pop(2)
0x6eb: Return(); Pop(10)

0x6ec: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x6ed: Push("d") // @poff=258
0x6ee: PushEmpty(int)
0x6ef: Call2 0x761

0x6f0: Pop(0)
0x6f1: Pop(2); Push(Stack[-2] + Stack[-1]);
0x6f2: Push("m") // @poff=164
...
0x6fa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x6fb: Pop(1)
...
0x70f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x710: Pop(1)
0x711: PushEmpty(bool, string)
0x712: Stack[-3] = Stack[-1]
0x713: Call2 0x736

0x714: Stack[-2] = Stack[-14]
0x715: Pop(2)
0x716: Return(); Pop(10)
...
0x722: Push("Can't find lsh animation : ") // @poff=316
...
0x731: Push("Can't find lsh animation : ") // @poff=316
...
0x755: Push((float)9.999999974752427e-07)
...
0x78c: Stack[-1] = "ui/NPC_Mishka.png" // @poff=372
0x78d: Return(); Pop(0)

0x78e: Stack[-1] = "ui/NPC_Mishka_b.png" // @poff=408
0x78f: Return(); Pop(0)
...
0x792: PushEmpty()
0x793: Push("ood6Mishka1") // @poff=448
0x794: Push((int) 1)
...
0x798: PushEmpty()
0x799: Push("KnowMishka") // @poff=472
0x79a: Push((int) 1)
...
0x7ac: Stack[-1] = "ood6Mishka1" // @poff=448
0x7ad: Call2 0x75c
