...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x216: Pop(0)
0x217: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x218: Pop(1)
0x219: PushEmpty(int)
0x21a: Call2 0x55f

0x21b: Pop(0)
0x21c: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x21d: Pop(1)
0x21e: PushEmpty(string)
0x21f: Call2 0x563

0x220: Pop(0)
0x221: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x222: Pop(1)
0x223: PushEmpty(string)
0x224: Call2 0x565

0x225: Pop(0)
0x226: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x227: Pop(1)
0x228: PushEmpty(int)
0x229: Call2 0x641

0x22a: Pop(0)
0x22b: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x22c: Pop(1)
0x22d: Stack[-2] = (int) -1
...
0x33b: Push("player") // @poff=172
0x33c: @ FindActor(Stack[-4]T, Stack[-1])
0x33d: Pop(1)
...
0x350: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x3a5: Pop(0)
0x3a6: Push("all") // @poff=138
0x3a7: PushEmpty(string, int)
0x3a8: Stack[-7] = Stack[-1]
0x3a9: Call2 0x547
...
0x3db: Pop(0)
0x3dc: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x3dd: Pop(0)
...
0x3e7: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x3e8: Pop(0)
0x3e9: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x3ea: Pop(0)
...
0x456: Push("voice_common") // @poff=222
0x457: Push((int) 1)
...
0x471: Push("voice_common") // @poff=222
0x472: Push((int) 1)
...
0x47f: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x480: Pop(1)
...
0x4aa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x4ab: Pop(1)
...
0x4bf: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=264
0x4c0: Pop(1)
0x4c1: PushEmpty(bool, string)
0x4c2: Stack[-3] = Stack[-1]
0x4c3: Call2 0x4f1

0x4c4: Stack[-2] = Stack[-14]
0x4c5: Pop(2)
0x4c6: Return(); Pop(10)
...
0x4d2: Push("Can't find lsh animation : ") // @poff=280
...
0x4e1: Push("Can't find lsh animation : ") // @poff=280
...
0x4e7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x4e8: Pop(0)
...
0x510: Push((float)9.999999974752427e-07)
...
0x529: Pop(0)
0x52a: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x54f: Stack[-2] = (int) 0
0x550: Push("all") // @poff=138
0x551: PushEmpty(string, int)
0x552: Stack[-5] = Stack[-1]
0x553: Call2 0x547
...
0x563: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=346
0x564: Return(); Pop(0)

0x565: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=386
0x566: Return(); Pop(0)
...
0x569: PushEmpty()
0x56a: Push("ood7Nudegirl1") // @poff=430
0x56b: Push((int) 1)
...
0x577: Pop(1)
0x578: Push("d7q04NudeGotoAndrei") // @poff=470
0x579: Push("pt_map_andrei") // @poff=510
0x57a: Push((int) 0)
...
0x57e: Pop(0)
0x57f: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=538
0x580: Pop(5)
0x581: PushEmpty()
0x582: Call2 0x5cc
...
0x588: Stack[-1] = "quest_d7_04" // @poff=546
0x589: Call2 0x51c

0x58a: Pop(2)
0x58b: PushEmpty(bool, string, string)
0x58c: Stack[-2] = "quest_d7_04" // @poff=546
0x58d: Stack[-1] = "init_kabak" // @poff=570
0x58e: Call2 0x527
...
0x591: Stack[-1] = 0
0x592: PushEmpty()
0x593: Push("ood7Nudegirl2") // @poff=592
0x594: Push((int) 1)
...
0x59c: Stack[-1] = Stack[-4]
0x59d: Pop(1)
0x59e: Stack[-2] = "pt_map_andrei" // @poff=510
0x59f: Stack[-1] = (int) 2
0x5a0: Call2 0x620
...
0x5a4: Pop(0)
0x5a5: @@ ShowMap(Stack[-1]); Obj=2 // @poff=620
0x5a6: Pop(1)
0x5a7: Return(); Pop(0)

0x5a8: PushEmpty()
0x5a9: PushEmpty(int, string)
0x5aa: Stack[-1] = "ood7Nudegirl1" // @poff=430
0x5ab: Call2 0x517
...
0x5c2: Stack[-1] = "ood7Nudegirl2" // @poff=592
0x5c3: Call2 0x517
...
0x5eb: Push("Can't retrieve diary root") // @poff=628
0x5ec: @ Trace(Stack[-1])
0x5ed: Pop(1)
0x5ee: Stack[-3] = (bool) 0
0x5ef: Return(); Pop(2)

0x5f0: Stack[-1] = Stack[-3]
0x5f1: Return(); Pop(2)
...
0x5f6: Stack[-1] = Stack[-4]
0x5f7: Pop(1)
0x5f8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=680
0x5f9: Pop(0)
0x5fa: Pop(0); Push((bool) Stack[-2] == 0)
0x5fb: IF (Stack[-1] == 0) GOTO 0x602; Pop(1)

0x5fc: Push("Can't find diary parent with id: ") // @poff=685
...
0x602: @@ AddChild(Stack[-8]); Obj=2 // @poff=753
0x603: Pop(0)
0x604: Push((int) 7)
0x605: @ SendWorldWndMessage(Stack[-1])
0x606: Pop(1)
0x607: @@ GetCategory(Stack[-1]); Obj=8 // @poff=762
0x608: Pop(0)
...
0x611: Pop(0)
0x612: Pop(0); PushNull((bool) Stack[-2] == 0)
0x613: IF (Stack[-1] == 0) GOTO 0x61a; Pop(1)

0x614: Push("Can't find main outdoor scene") // @poff=774
0x615: @ Trace(Stack[-1])
0x616: Pop(1)
0x617: Stack[-1] = 0
...
0x61a: @@ GetMap(Stack[-1]); Obj=2 // @poff=834
0x61b: Pop(0)
0x61c: Stack[-1] = Stack[-5]
0x61d: Return(); Pop(4)
...
0x622: Pop(0)
0x623: Pop(0); PushNull((bool) Stack[-2] == 0)
0x624: IF (Stack[-1] == 0) GOTO 0x629; Pop(1)

0x625: Push("Can't find main outdoor scene") // @poff=774
0x626: @ Trace(Stack[-1])
0x627: Pop(1)
0x628: Return(); Pop(8)

0x629: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=841
0x62a: Pop(0)
0x62b: Pop(0); Push((bool) Stack[-1] == 0)
0x62c: IF (Stack[-1] == 0) GOTO 0x633; Pop(1)

0x62d: Push("Warning: outdoor scene locator ") // @poff=852
0x62e: Pop(1); Push(Stack[-1] + Stack[-11]);
0x62f: Push(" doesnt exist") // @poff=916
0x630: Pop(2); Push(Stack[-2] + Stack[-1]);
0x631: @ Trace(Stack[-1])
0x632: Pop(1)
0x633: @@ GetMap(Stack[-11]); Obj=2 // @poff=834
0x634: Pop(0)
0x635: Pop(0); PushNull((bool) Stack[-11] == 0)
0x636: IF (Stack[-1] == 0) GOTO 0x63b; Pop(1)

0x637: Push("Can't find map") // @poff=944
0x638: @ Trace(Stack[-1])
0x639: Pop(1)
0x63a: Return(); Pop(8)
...
0x63d: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=974
0x63e: Pop(2)
0x63f: Return(); Pop(8)

0x640: Stack[-2] = 0
0x641: PushEmpty(int, int)
0x642: Push("branch") // @poff=987
