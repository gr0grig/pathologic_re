...
Strings:
	...
	W:k2q01
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x100: Stack[-1] = "Distrust" // @poff=156
0x101: Call2 0x9e
...
0x12e: Stack[-1] = "Distrust" // @poff=156
0x12f: Call2 0x9e
...
0x15c: Stack[-1] = "Distrust" // @poff=156
0x15d: Call2 0x9e
...
0x18a: Stack[-1] = "Repentance" // @poff=186
0x18b: Call2 0x9e
...
0x1b9: Pop(0)
0x1ba: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x1bb: Pop(1)
0x1bc: PushEmpty(int)
0x1bd: Call2 0x766

0x1be: Pop(0)
0x1bf: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x1c0: Pop(1)
0x1c1: PushEmpty(string)
0x1c2: Call2 0x76a

0x1c3: Pop(0)
0x1c4: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x1c5: Pop(1)
0x1c6: PushEmpty(string)
0x1c7: Call2 0x76c

0x1c8: Pop(0)
0x1c9: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x1ca: Pop(1)
0x1cb: PushEmpty(int)
0x1cc: Call2 0x7a0

0x1cd: Pop(0)
0x1ce: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x1cf: Pop(1)
0x1d0: Stack[-2] = (int) -1
...
0x1e6: Pop(2)
0x1e7: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1e8: Pop(0)
...
0x1eb: @ sync()
0x1ec: Pop(0)
0x1ed: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1ee: Pop(0)
0x1ef: GOTO 0x1e9

0x1f0: PushEmpty(object)
0x1f1: Stack[-10] = Stack[-1]
0x1f2: Call2 0x602

0x1f3: Pop(1)
0x1f4: @ StopDialog(Stack[-4])
0x1f5: Pop(0)
0x1f6: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x1f7: Pop(0)
0x1f8: Stack[-2] = Stack[-10]
0x1f9: Return(); Pop(8)
...
0x226: Push("all") // @poff=138
0x227: Push("idle") // @poff=146
...
0x2b2: Pop(0)
0x2b3: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2b4: Pop(1)
0x2b5: PushEmpty(int)
0x2b6: Call2 0x766

0x2b7: Pop(0)
0x2b8: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2b9: Pop(1)
0x2ba: PushEmpty(string)
0x2bb: Call2 0x76a

0x2bc: Pop(0)
0x2bd: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2be: Pop(1)
0x2bf: PushEmpty(string)
0x2c0: Call2 0x76c

0x2c1: Pop(0)
0x2c2: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2c3: Pop(1)
0x2c4: PushEmpty(int)
0x2c5: Call2 0x7a0

0x2c6: Pop(0)
0x2c7: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2c8: Pop(1)
0x2c9: Stack[-2] = (int) -1
...
0x2df: Pop(2)
0x2e0: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2e1: Pop(0)
...
0x2e4: @ sync()
0x2e5: Pop(0)
0x2e6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2e7: Pop(0)
0x2e8: GOTO 0x2e2

0x2e9: PushEmpty(object)
0x2ea: Stack[-10] = Stack[-1]
0x2eb: Call2 0x602

0x2ec: Pop(1)
0x2ed: @ StopDialog(Stack[-4])
0x2ee: Pop(0)
0x2ef: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2f0: Pop(0)
0x2f1: Stack[-2] = Stack[-10]
0x2f2: Return(); Pop(8)
...
0x3b5: Pop(0)
0x3b6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x3b7: Pop(1)
0x3b8: PushEmpty(int)
0x3b9: Call2 0x766

0x3ba: Pop(0)
0x3bb: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x3bc: Pop(1)
0x3bd: PushEmpty(string)
0x3be: Call2 0x76a

0x3bf: Pop(0)
0x3c0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x3c1: Pop(1)
0x3c2: PushEmpty(string)
0x3c3: Call2 0x76c

0x3c4: Pop(0)
0x3c5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x3c6: Pop(1)
0x3c7: PushEmpty(int)
0x3c8: Call2 0x7a0

0x3c9: Pop(0)
0x3ca: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x3cb: Pop(1)
0x3cc: Stack[-2] = (int) -1
...
0x3dd: Stack[-11] = Stack[-2]
0x3de: Stack[-6] = Stack[-1]
0x3df: Push(-2, 4); TaskCall(7)
0x3e0: Call2 0x3f7

0x3e1: Pop(-2, 4); TaskReturn
0x3e2: Pop(2)
0x3e3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3e4: Pop(0)
...
0x3e7: @ sync()
0x3e8: Pop(0)
0x3e9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3ea: Pop(0)
0x3eb: GOTO 0x3e5
...
0x3f1: Pop(0)
0x3f2: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x3f3: Pop(0)
0x3f4: Stack[-2] = Stack[-10]
0x3f5: Return(); Pop(8)
...
0x422: Push("all") // @poff=138
0x423: Push("idle") // @poff=146
...
0x494: Stack[-1] = 0
0x495: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x496: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x497: @ RotateAsync(Stack[-2], Stack[-1])
0x498: Pop(2)
0x499: Return(); Pop(0)

0x49a: PushEmpty(object, bool, object, bool)
0x49b: Push("player") // @poff=208
...
0x576: Pop(0)
0x577: @@ GetPosition(Stack[-2]); Obj=7 // @poff=222
0x578: Pop(0)
...
0x57d: Push("HasProperty") // @poff=234
0x57e: Push((int) 2)
...
0x584: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=258
0x585: Pop(0)
...
0x58a: Stack[-10] = Stack[-2]
0x58b: Stack[-9] = Stack[-1]
0x58c: Call2 0x57c
...
0x592: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=270
0x593: Pop(0)
0x594: PushEmpty(float, float, float, float)
0x595: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x596: Stack[-8] = Stack[-2]
0x597: Stack[-7] = Stack[-1]
0x598: Call2 0x6e3

0x599: Pop(3)
0x59a: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=282
0x59b: Pop(1)
0x59c: Stack[-8] = (bool) 1
0x59d: Return(); Pop(2)

0x59e: PushEmpty(int, int)
0x59f: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=270
0x5a0: Pop(0)
0x5a1: Pop(0); Push(Stack[-1] + Stack[-3]);
0x5a2: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=282
0x5a3: Pop(1)
0x5a4: Return(); Pop(2)
...
0x5b0: @@ GetPosition(Stack[-1]); Obj=3 // @poff=222
0x5b1: Pop(0)
0x5b2: PushEmpty(bool, cvector)
0x5b3: Stack[-3] = Stack[-1]
0x5b4: Call2 0x5a5

0x5b5: Stack[-2] = Stack[-6]
0x5b6: Pop(2)
0x5b7: Return(); Pop(2)
...
0x5be: @@ GetPosition(Stack[-8]); Obj=20 // @poff=222
0x5bf: Pop(0)
0x5c0: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=294
0x5c1: Pop(0)
...
0x62d: Push("voice_common") // @poff=318
0x62e: Push((int) 1)
...
0x635: Push("voice_common") // @poff=318
0x636: Push((int) 0)
...
0x648: Push("voice_common") // @poff=318
0x649: Push((int) 1)
...
0x656: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=258
0x657: Pop(1)
...
0x681: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=258
0x682: Pop(1)
...
0x696: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=270
0x697: Pop(1)
0x698: PushEmpty(bool, string)
0x699: Stack[-3] = Stack[-1]
0x69a: Call2 0x6bd

0x69b: Stack[-2] = Stack[-14]
0x69c: Pop(2)
0x69d: Return(); Pop(10)
...
0x6a9: Push("Can't find lsh animation : ") // @poff=352
...
0x6b8: Push("Can't find lsh animation : ") // @poff=352
...
0x6f5: Pop(0)
0x6f6: @@ add(Stack[-4]); Obj=1 // @poff=408
0x6f7: Pop(0)
0x6f8: @@ add(Stack[-3]); Obj=1 // @poff=408
0x6f9: Pop(0)
0x6fa: Push((int) 3)
...
0x72c: Stack[-8] = Stack[-5]
0x72d: Stack[-4] = "reputation" // @poff=436
0x72e: Stack[-7] = Stack[-3]
0x72f: Stack[-2] = (int) 0
0x730: Stack[-1] = (int) 1
0x731: Call2 0x588
...
0x737: Pop(0)
0x738: @@ add(Stack[-3]); Obj=1 // @poff=408
0x739: Pop(0)
0x73a: Push((int) 16)
...
0x76a: Stack[-1] = "ui/NPC_BigVlad.png" // @poff=458
0x76b: Return(); Pop(0)

0x76c: Stack[-1] = "ui/NPC_BigVlad_b.png" // @poff=496
0x76d: Return(); Pop(0)
...
0x773: Stack[-1] = (float) 0.019999999552965164
0x774: Call2 0x712
...
0x782: PushEmpty()
0x783: Push("ook2BigVlad1") // @poff=538
0x784: Push((int) 1)
...
0x796: Stack[-1] = "ook2BigVlad1" // @poff=538
0x797: Call2 0x6ee
