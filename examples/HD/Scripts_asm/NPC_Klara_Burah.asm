...
Strings:
	...
	A:get
	W:mt_burah
// @pool_raw:
// @pool_encoding:utf8
...
0x11f: Stack[-1] = "Doubt" // @poff=156
0x120: Call2 0x9e

0x121: Pop(1)
0x122: Push((int) 526809)
0x123: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x124: Pop(1)
0x125: @@@ ClearReplies(); Obj=0 // @poff=116
0x126: Pop(0)
...
0x136: Stack[-1] = "Agression" // @poff=168
0x137: Call2 0x9e
...
0x14d: Stack[-1] = "Agression" // @poff=168
0x14e: Call2 0x9e
...
0x171: Stack[-1] = "Agression" // @poff=168
0x172: Call2 0x9e
...
0x19f: Stack[-1] = "Agression" // @poff=168
0x1a0: Call2 0x9e
...
0x1ce: Pop(0)
0x1cf: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x1d0: Pop(1)
0x1d1: PushEmpty(int)
0x1d2: Call2 0xf28

0x1d3: Pop(0)
0x1d4: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x1d5: Pop(1)
0x1d6: PushEmpty(string)
0x1d7: Call2 0xf2c

0x1d8: Pop(0)
0x1d9: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x1da: Pop(1)
0x1db: PushEmpty(string)
0x1dc: Call2 0xf2e

0x1dd: Pop(0)
0x1de: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x1df: Pop(1)
0x1e0: PushEmpty(int)
0x1e1: Call2 0x11af

0x1e2: Pop(0)
0x1e3: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x1e4: Pop(1)
0x1e5: Stack[-2] = (int) -1
...
0x1f1: Stack[-1] = Stack[-2]
0x1f2: Pop(1)
0x1f3: Call2 0xdba

0x1f4: Pop(2)
0x1f5: PushEmpty(object, object)
0x1f6: Stack[-11] = Stack[-2]
0x1f7: Stack[-6] = Stack[-1]
0x1f8: Push(-2, 4); TaskCall(3)
0x1f9: Call2 0x210

0x1fa: Pop(-2, 4); TaskReturn
0x1fb: Pop(2)
0x1fc: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1fd: Pop(0)
...
0x200: @ sync()
0x201: Pop(0)
0x202: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x203: Pop(0)
0x204: GOTO 0x1fe
...
0x20a: Pop(0)
0x20b: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x20c: Pop(0)
0x20d: Stack[-2] = Stack[-10]
0x20e: Return(); Pop(8)
...
0x240: Push("all") // @poff=138
0x241: Push("idle") // @poff=146
...
0x249: Push("all") // @poff=138
0x24a: Push("idle") // @poff=146
...
0x277: Stack[-1] = "Neutral" // @poff=89
0x278: Call2 0x24f

0x279: Pop(1)
0x27a: Push((int) 525257)
0x27b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x27c: Pop(1)
0x27d: @@@ ClearReplies(); Obj=0 // @poff=116
0x27e: Pop(0)
...
0x287: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x288: Pop(3)
...
0x2aa: Stack[-1] = "Sorrow" // @poff=188
0x2ab: Call2 0x24f

0x2ac: Pop(1)
0x2ad: Push((int) 529162)
0x2ae: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2af: Pop(1)
0x2b0: @@@ ClearReplies(); Obj=0 // @poff=116
0x2b1: Pop(0)
...
0x2d2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2d3: Pop(1)
0x2d4: @@@ ClearReplies(); Obj=0 // @poff=116
0x2d5: Pop(0)
...
0x2fd: Pop(0)
0x2fe: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2ff: Pop(1)
0x300: PushEmpty(int)
0x301: Call2 0xf28

0x302: Pop(0)
0x303: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x304: Pop(1)
0x305: PushEmpty(string)
0x306: Call2 0xf2c

0x307: Pop(0)
0x308: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x309: Pop(1)
0x30a: PushEmpty(string)
0x30b: Call2 0xf2e

0x30c: Pop(0)
0x30d: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x30e: Pop(1)
0x30f: PushEmpty(int)
0x310: Call2 0x11af

0x311: Pop(0)
0x312: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x313: Pop(1)
0x314: Stack[-2] = (int) -1
...
0x325: Stack[-11] = Stack[-2]
0x326: Stack[-6] = Stack[-1]
0x327: Push(-2, 4); TaskCall(5)
0x328: Call2 0x33f

0x329: Pop(-2, 4); TaskReturn
0x32a: Pop(2)
0x32b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x32c: Pop(0)
...
0x32f: @ sync()
0x330: Pop(0)
0x331: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x332: Pop(0)
0x333: GOTO 0x32d

0x334: PushEmpty(object)
0x335: Stack[-10] = Stack[-1]
0x336: Call2 0xda8

0x337: Pop(1)
0x338: @ StopDialog(Stack[-4])
0x339: Pop(0)
0x33a: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x33b: Pop(0)
0x33c: Stack[-2] = Stack[-10]
0x33d: Return(); Pop(8)
...
0x3ec: Pop(0)
0x3ed: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x3ee: Pop(1)
0x3ef: PushEmpty(int)
0x3f0: Call2 0xf28

0x3f1: Pop(0)
0x3f2: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x3f3: Pop(1)
0x3f4: PushEmpty(string)
0x3f5: Call2 0xf2c

0x3f6: Pop(0)
0x3f7: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x3f8: Pop(1)
0x3f9: PushEmpty(string)
0x3fa: Call2 0xf2e

0x3fb: Pop(0)
0x3fc: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x3fd: Pop(1)
0x3fe: PushEmpty(int)
0x3ff: Call2 0x11af

0x400: Pop(0)
0x401: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x402: Pop(1)
0x403: Stack[-2] = (int) -1
...
0x43f: Stack[-1] = "Neutral" // @poff=89
0x440: Call2 0x4c0

0x441: Pop(1)
0x442: Push((int) 526373)
0x443: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x444: Pop(1)
0x445: @@@ ClearReplies(); Obj=0 // @poff=116
0x446: Pop(0)
...
0x453: Stack[-1] = "Neutral" // @poff=89
0x454: Call2 0x4c0

0x455: Pop(1)
0x456: Push((int) 526173)
0x457: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x458: Pop(1)
0x459: @@@ ClearReplies(); Obj=0 // @poff=116
0x45a: Pop(0)
...
0x493: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x494: Pop(3)
...
0x4b1: Push("all") // @poff=138
0x4b2: Push("idle") // @poff=146
...
0x54a: Stack[-1] = "Neutral" // @poff=89
0x54b: Call2 0x4c0

0x54c: Pop(1)
0x54d: Push((int) 526373)
0x54e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x54f: Pop(1)
0x550: @@@ ClearReplies(); Obj=0 // @poff=116
0x551: Pop(0)
...
0x55a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x55b: Pop(3)
0x55c: Return(); Pop(0)
...
0x594: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x595: Pop(3)
...
0x59e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x59f: Pop(3)
...
0x5c6: Stack[-1] = "Smile" // @poff=202
0x5c7: Call2 0x4c0

0x5c8: Pop(1)
0x5c9: Push((int) 526388)
0x5ca: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x5cb: Pop(1)
0x5cc: @@@ ClearReplies(); Obj=0 // @poff=116
0x5cd: Pop(0)
...
0x5dd: Stack[-1] = "Neutral" // @poff=89
0x5de: Call2 0x4c0

0x5df: Pop(1)
0x5e0: Push((int) 526379)
0x5e1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x5e2: Pop(1)
0x5e3: @@@ ClearReplies(); Obj=0 // @poff=116
0x5e4: Pop(0)
...
0x601: Stack[-1] = "Doubt" // @poff=156
0x602: Call2 0x4c0

0x603: Pop(1)
0x604: Push((int) 528688)
0x605: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x606: Pop(1)
0x607: @@@ ClearReplies(); Obj=0 // @poff=116
0x608: Pop(0)
...
0x613: Stack[-1] = "Sorrow" // @poff=188
0x614: Call2 0x4c0

0x615: Pop(1)
0x616: Push((int) 528690)
0x617: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x618: Pop(1)
0x619: @@@ ClearReplies(); Obj=0 // @poff=116
0x61a: Pop(0)
0x61b: Push((int) 528691)
0x61c: Push((int) 30107)
0x61d: Push((int) 30106)
0x61e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x61f: Pop(3)
...
0x64e: Stack[-1] = "Doubt" // @poff=156
0x64f: Call2 0x4c0

0x650: Pop(1)
0x651: Push((int) 528694)
0x652: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x653: Pop(1)
0x654: @@@ ClearReplies(); Obj=0 // @poff=116
0x655: Pop(0)
...
0x739: Pop(0)
0x73a: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x73b: Pop(1)
0x73c: PushEmpty(int)
0x73d: Call2 0xf28

0x73e: Pop(0)
0x73f: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x740: Pop(1)
0x741: PushEmpty(string)
0x742: Call2 0xf2c

0x743: Pop(0)
0x744: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x745: Pop(1)
0x746: PushEmpty(string)
0x747: Call2 0xf2e

0x748: Pop(0)
0x749: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x74a: Pop(1)
0x74b: PushEmpty(int)
0x74c: Call2 0x11af

0x74d: Pop(0)
0x74e: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x74f: Pop(1)
0x750: Stack[-2] = (int) -1
...
0x761: Stack[-11] = Stack[-2]
0x762: Stack[-6] = Stack[-1]
0x763: Push(-2, 4); TaskCall(9)
0x764: Call2 0x77b

0x765: Pop(-2, 4); TaskReturn
0x766: Pop(2)
0x767: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x768: Pop(0)
...
0x76b: @ sync()
0x76c: Pop(0)
0x76d: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x76e: Pop(0)
0x76f: GOTO 0x769

0x770: PushEmpty(object)
0x771: Stack[-10] = Stack[-1]
0x772: Call2 0xda8

0x773: Pop(1)
0x774: @ StopDialog(Stack[-4])
0x775: Pop(0)
0x776: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x777: Pop(0)
0x778: Stack[-2] = Stack[-10]
0x779: Return(); Pop(8)
...
0x7b0: Push("all") // @poff=138
0x7b1: Push("idle") // @poff=146
...
0x7b9: Push("all") // @poff=138
0x7ba: Push("idle") // @poff=146
...
0x7ec: Stack[-1] = "Neutral" // @poff=89
0x7ed: Call2 0x7bf

0x7ee: Pop(1)
0x7ef: Push((int) 527204)
0x7f0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x7f1: Pop(1)
0x7f2: @@@ ClearReplies(); Obj=0 // @poff=116
0x7f3: Pop(0)
...
0x80d: Stack[-1] = "Sorrow" // @poff=188
0x80e: Call2 0x7bf

0x80f: Pop(1)
0x810: Push((int) 527206)
0x811: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x812: Pop(1)
0x813: @@@ ClearReplies(); Obj=0 // @poff=116
0x814: Pop(0)
...
0x81f: Stack[-1] = "Doubt" // @poff=156
0x820: Call2 0x7bf

0x821: Pop(1)
0x822: Push((int) 527208)
0x823: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x824: Pop(1)
0x825: @@@ ClearReplies(); Obj=0 // @poff=116
0x826: Pop(0)
0x827: Push((int) 527534)
0x828: Push((int) 28874)
0x829: Push((int) 28872)
0x82a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x82b: Pop(3)
0x82c: Push((int) 527535)
0x82d: Push((int) 28874)
0x82e: Push((int) 28873)
0x82f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x830: Pop(3)
0x831: Return(); Pop(0)
...
0x836: Stack[-1] = "Doubt" // @poff=156
0x837: Call2 0x7bf

0x838: Pop(1)
0x839: Push((int) 527536)
0x83a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x83b: Pop(1)
0x83c: @@@ ClearReplies(); Obj=0 // @poff=116
0x83d: Pop(0)
0x83e: Push((int) 527537)
0x83f: Push((int) 28876)
0x840: Push((int) 28875)
0x841: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x842: Pop(3)
...
0x84d: Stack[-1] = "Doubt" // @poff=156
0x84e: Call2 0x7bf

0x84f: Pop(1)
0x850: Push((int) 527538)
0x851: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x852: Pop(1)
0x853: @@@ ClearReplies(); Obj=0 // @poff=116
0x854: Pop(0)
0x855: Push((int) 527540)
0x856: Push((int) 28881)
0x857: Push((int) 28880)
0x858: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x859: Pop(3)
0x85a: Return(); Pop(0)
...
0x85f: Stack[-1] = "Sorrow" // @poff=188
0x860: Call2 0x7bf

0x861: Pop(1)
0x862: Push((int) 527541)
0x863: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x864: Pop(1)
0x865: @@@ ClearReplies(); Obj=0 // @poff=116
0x866: Pop(0)
0x867: Push((int) 527542)
0x868: Push((int) 28883)
0x869: Push((int) 28882)
0x86a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x86b: Pop(3)
0x86c: Return(); Pop(0)
...
0x871: Stack[-1] = "Sorrow" // @poff=188
0x872: Call2 0x7bf

0x873: Pop(1)
0x874: Push((int) 527543)
0x875: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x876: Pop(1)
0x877: @@@ ClearReplies(); Obj=0 // @poff=116
0x878: Pop(0)
0x879: Push((int) 527209)
0x87a: Push((int) 28884)
0x87b: Push((int) 28517)
0x87c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x87d: Pop(3)
0x87e: Push((int) 527546)
0x87f: Push((int) 28884)
0x880: Push((int) 28886)
0x881: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x882: Pop(3)
0x883: Return(); Pop(0)
...
0x888: Stack[-1] = "Smile" // @poff=202
0x889: Call2 0x7bf

0x88a: Pop(1)
0x88b: Push((int) 527544)
0x88c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x88d: Pop(1)
0x88e: @@@ ClearReplies(); Obj=0 // @poff=116
0x88f: Pop(0)
0x890: Push((int) 527545)
0x891: Push((int) -1)
0x892: Push((int) 28885)
0x893: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x894: Pop(3)
0x895: Return(); Pop(0)
...
0x8b2: Pop(0)
0x8b3: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x8b4: Pop(1)
0x8b5: PushEmpty(int)
0x8b6: Call2 0xf28

0x8b7: Pop(0)
0x8b8: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x8b9: Pop(1)
0x8ba: PushEmpty(string)
0x8bb: Call2 0xf2c

0x8bc: Pop(0)
0x8bd: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x8be: Pop(1)
0x8bf: PushEmpty(string)
0x8c0: Call2 0xf2e

0x8c1: Pop(0)
0x8c2: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x8c3: Pop(1)
0x8c4: PushEmpty(int)
0x8c5: Call2 0x11af

0x8c6: Pop(0)
0x8c7: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x8c8: Pop(1)
0x8c9: Stack[-2] = (int) -1
...
0x8df: Pop(2)
0x8e0: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x8e1: Pop(0)
...
0x8e4: @ sync()
0x8e5: Pop(0)
0x8e6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x8e7: Pop(0)
0x8e8: GOTO 0x8e2

0x8e9: PushEmpty(object)
0x8ea: Stack[-10] = Stack[-1]
0x8eb: Call2 0xda8

0x8ec: Pop(1)
0x8ed: @ StopDialog(Stack[-4])
0x8ee: Pop(0)
0x8ef: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x8f0: Pop(0)
0x8f1: Stack[-2] = Stack[-10]
0x8f2: Return(); Pop(8)
...
0x96a: Push("all") // @poff=138
0x96b: Push("idle") // @poff=146
...
0x973: Push("all") // @poff=138
0x974: Push("idle") // @poff=146
...
0x9ca: Stack[-1] = "Neutral" // @poff=89
0x9cb: Call2 0x979

0x9cc: Pop(1)
0x9cd: Push((int) 539318)
0x9ce: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x9cf: Pop(1)
0x9d0: @@@ ClearReplies(); Obj=0 // @poff=116
0x9d1: Pop(0)
...
0xa07: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa08: Pop(3)
0xa09: Push((int) 539335)
0xa0a: Push((int) -1)
0xa0b: Push((int) 41279)
0xa0c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa0d: Pop(3)
0xa0e: Return(); Pop(0)
...
0xa13: Stack[-1] = "Doubt" // @poff=156
0xa14: Call2 0x979

0xa15: Pop(1)
0xa16: Push((int) 539333)
0xa17: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa18: Pop(1)
0xa19: @@@ ClearReplies(); Obj=0 // @poff=116
0xa1a: Pop(0)
...
0xa68: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa69: Pop(3)
...
0xa86: Stack[-1] = "Doubt" // @poff=156
0xa87: Call2 0x979

0xa88: Pop(1)
0xa89: Push((int) 542952)
0xa8a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa8b: Pop(1)
0xa8c: @@@ ClearReplies(); Obj=0 // @poff=116
0xa8d: Pop(0)
0xa8e: Push((int) 542953)
0xa8f: Push((int) 45394)
0xa90: Push((int) 45393)
0xa91: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa92: Pop(3)
0xa93: Return(); Pop(0)
...
0xa98: Stack[-1] = "Sorrow" // @poff=188
0xa99: Call2 0x979

0xa9a: Pop(1)
0xa9b: Push((int) 542954)
0xa9c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa9d: Pop(1)
0xa9e: @@@ ClearReplies(); Obj=0 // @poff=116
0xa9f: Pop(0)
0xaa0: Push((int) 542948)
0xaa1: Push((int) 45388)
0xaa2: Push((int) 45387)
0xaa3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xaa4: Pop(3)
...
0xaaf: Stack[-1] = "Sorrow" // @poff=188
0xab0: Call2 0x979

0xab1: Pop(1)
0xab2: Push((int) 542949)
0xab3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xab4: Pop(1)
0xab5: @@@ ClearReplies(); Obj=0 // @poff=116
0xab6: Pop(0)
...
0xad8: Stack[-1] = "Neutral" // @poff=89
0xad9: Call2 0x979

0xada: Pop(1)
0xadb: Push((int) 542968)
0xadc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xadd: Pop(1)
0xade: @@@ ClearReplies(); Obj=0 // @poff=116
0xadf: Pop(0)
...
0xaea: Stack[-1] = "Sorrow" // @poff=188
0xaeb: Call2 0x979

0xaec: Pop(1)
0xaed: Push((int) 542970)
0xaee: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xaef: Pop(1)
0xaf0: @@@ ClearReplies(); Obj=0 // @poff=116
0xaf1: Pop(0)
...
0xafc: Stack[-1] = "Neutral" // @poff=89
0xafd: Call2 0x979

0xafe: Pop(1)
0xaff: Push((int) 541455)
0xb00: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xb01: Pop(1)
0xb02: @@@ ClearReplies(); Obj=0 // @poff=116
0xb03: Pop(0)
0xb04: Push((int) 541456)
0xb05: Push((int) 41267)
0xb06: Push((int) 43612)
0xb07: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xb08: Pop(3)
0xb09: Return(); Pop(0)
...
0xb56: Stack[-1] = "Smile" // @poff=202
0xb57: Call2 0x979

0xb58: Pop(1)
0xb59: Push((int) 542958)
0xb5a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xb5b: Pop(1)
0xb5c: @@@ ClearReplies(); Obj=0 // @poff=116
0xb5d: Pop(0)
0xb5e: Push((int) 542959)
0xb5f: Push((int) 45396)
0xb60: Push((int) 45399)
0xb61: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xb62: Pop(3)
0xb63: Return(); Pop(0)
...
0xb80: Pop(0)
0xb81: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xb82: Pop(1)
0xb83: PushEmpty(int)
0xb84: Call2 0xf28

0xb85: Pop(0)
0xb86: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xb87: Pop(1)
0xb88: PushEmpty(string)
0xb89: Call2 0xf2c

0xb8a: Pop(0)
0xb8b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xb8c: Pop(1)
0xb8d: PushEmpty(string)
0xb8e: Call2 0xf2e

0xb8f: Pop(0)
0xb90: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xb91: Pop(1)
0xb92: PushEmpty(int)
0xb93: Call2 0x11af

0xb94: Pop(0)
0xb95: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xb96: Pop(1)
0xb97: Stack[-2] = (int) -1
...
0xba3: Stack[-1] = Stack[-2]
0xba4: Pop(1)
0xba5: Call2 0xdba

0xba6: Pop(2)
0xba7: PushEmpty(object, object)
0xba8: Stack[-11] = Stack[-2]
0xba9: Stack[-6] = Stack[-1]
0xbaa: Push(-2, 4); TaskCall(13)
0xbab: Call2 0xbc2

0xbac: Pop(-2, 4); TaskReturn
0xbad: Pop(2)
0xbae: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xbaf: Pop(0)
...
0xbb2: @ sync()
0xbb3: Pop(0)
0xbb4: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xbb5: Pop(0)
0xbb6: GOTO 0xbb0

0xbb7: PushEmpty(object)
0xbb8: Stack[-10] = Stack[-1]
0xbb9: Call2 0xda8

0xbba: Pop(1)
0xbbb: @ StopDialog(Stack[-4])
0xbbc: Pop(0)
0xbbd: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0xbbe: Pop(0)
0xbbf: Stack[-2] = Stack[-10]
0xbc0: Return(); Pop(8)
...
0xbc9: Stack[-1] = "Neutral" // @poff=89
0xbca: Call2 0xbfc

0xbcb: Pop(1)
0xbcc: Push((int) 540545)
0xbcd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xbce: Pop(1)
0xbcf: @@@ ClearReplies(); Obj=0 // @poff=116
0xbd0: Pop(0)
0xbd1: Push((int) 540546)
0xbd2: Push((int) -1)
0xbd3: Push((int) 42555)
0xbd4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xbd5: Pop(3)
...
0xbed: Push("all") // @poff=138
0xbee: Push("idle") // @poff=146
...
0xbf6: Push("all") // @poff=138
0xbf7: Push("idle") // @poff=146
...
0xc1c: Stack[-1] = "Neutral" // @poff=89
0xc1d: Call2 0xbfc

0xc1e: Pop(1)
0xc1f: Push((int) 540545)
0xc20: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xc21: Pop(1)
0xc22: @@@ ClearReplies(); Obj=0 // @poff=116
0xc23: Pop(0)
...
0xc2c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xc2d: Pop(3)
0xc2e: Return(); Pop(0)
...
0xc59: Stack[-2] = Stack[-5]
0xc5a: Pop(2)
0xc5b: Return(); Pop(2)

0xc5c: Stack[-1] = 0
0xc5d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xc5e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0xc5f: @ RotateAsync(Stack[-2], Stack[-1])
0xc60: Pop(2)
0xc61: Return(); Pop(0)

0xc62: PushEmpty(object, bool, object, bool)
0xc63: Push("player") // @poff=214
...
0xd1a: Stack[-3] = (int) 0
0xd1b: Push("all") // @poff=138
0xd1c: PushEmpty(string, int)
0xd1d: Stack[-6] = Stack[-1]
0xd1e: Call2 0xf10
...
0xd3e: Pop(0)
0xd3f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=228
0xd40: Pop(0)
...
0xd45: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=240
0xd46: Pop(0)
0xd47: Pop(0); Push(Stack[-1] + Stack[-3]);
0xd48: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=252
0xd49: Pop(1)
0xd4a: Return(); Pop(2)
...
0xd56: @@ GetPosition(Stack[-1]); Obj=3 // @poff=228
0xd57: Pop(0)
0xd58: PushEmpty(bool, cvector)
0xd59: Stack[-3] = Stack[-1]
0xd5a: Call2 0xd4b

0xd5b: Stack[-2] = Stack[-6]
0xd5c: Pop(2)
0xd5d: Return(); Pop(2)
...
0xd64: @@ GetPosition(Stack[-8]); Obj=20 // @poff=228
0xd65: Pop(0)
0xd66: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=264
0xd67: Pop(0)
...
0xdd3: Push("voice_common") // @poff=288
0xdd4: Push((int) 1)
...
0xddb: Push("voice_common") // @poff=288
0xddc: Push((int) 0)
...
0xdee: Push("voice_common") // @poff=288
0xdef: Push((int) 1)
...
0xdfc: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=318
0xdfd: Pop(1)
...
0xe11: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=240
0xe12: Pop(1)
0xe13: PushEmpty(bool, string)
0xe14: Stack[-3] = Stack[-1]
0xe15: Call2 0xe63

0xe16: Stack[-2] = Stack[-14]
0xe17: Pop(2)
0xe18: Return(); Pop(10)

0xe19: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xe1a: Push("d") // @poff=284
0xe1b: PushEmpty(int)
0xe1c: Call2 0xf01

0xe1d: Pop(0)
0xe1e: Pop(2); Push(Stack[-2] + Stack[-1]);
0xe1f: Push("m") // @poff=330
...
0xe27: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=318
0xe28: Pop(1)
...
0xe3c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=240
0xe3d: Pop(1)
0xe3e: PushEmpty(bool, string)
0xe3f: Stack[-3] = Stack[-1]
0xe40: Call2 0xe63

0xe41: Stack[-2] = Stack[-14]
0xe42: Pop(2)
0xe43: Return(); Pop(10)
...
0xe4f: Push("Can't find lsh animation : ") // @poff=334
...
0xe5e: Push("Can't find lsh animation : ") // @poff=334
...
0xe82: Push((float)9.999999974752427e-07)
...
0xe9e: Push("Door ") // @poff=400
0xe9f: Pop(1); Push(Stack[-1] + Stack[-5]);
0xea0: Push(" not found") // @poff=412
0xea1: Pop(2); Push(Stack[-2] + Stack[-1]);
0xea2: @ Trace(Stack[-1])
0xea3: Pop(1)
0xea4: GOTO 0xea8

0xea5: Push("locked") // @poff=434
0xea6: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=252
0xea7: Pop(1)
0xea8: Return(); Pop(2)
...
0xeac: Pop(0)
0xead: @@ add(Stack[-4]); Obj=1 // @poff=448
0xeae: Pop(0)
0xeaf: @@ add(Stack[-3]); Obj=1 // @poff=448
0xeb0: Pop(0)
0xeb1: Push((int) 3)
...
0xeb9: Stack[-2] = "money" // @poff=452
0xeba: Stack[-6] = Stack[-1]
0xebb: Call2 0xd44
...
0xec0: Push("Money") // @poff=464
0xec1: @ GetInvItemByName(Stack[-2], Stack[-1])
0xec2: Pop(1)
0xec3: PushEmpty(int, int)
0xec4: Stack[-3] = Stack[-2]
0xec5: Stack[-5] = Stack[-1]
0xec6: Call2 0xeaa
...
0xeca: @@ GetItemID(Stack[-3]); Obj=8 // @poff=476
0xecb: Pop(0)
0xecc: Push("Category") // @poff=486
0xecd: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xece: Pop(1)
0xecf: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=504
0xed0: Pop(0)
0xed1: Pop(0); Push((bool) Stack[-1] == 0)
0xed2: IF (Stack[-1] == 0) GOTO 0xed6; Pop(1)

0xed3: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=512
0xed4: Pop(0)
0xed5: GOTO 0xedb

0xed6: PushEmpty(int, int)
0xed7: Stack[-5] = Stack[-2]
0xed8: Stack[-9] = Stack[-1]
0xed9: Call2 0xeaa
...
0xede: Pop(0)
0xedf: @@ SetItemName(Stack[-4]); Obj=1 // @poff=522
0xee0: Pop(0)
0xee1: PushEmpty(object, object, int)
0xee2: Stack[-8] = Stack[-3]
0xee3: Stack[-4] = Stack[-2]
0xee4: Stack[-6] = Stack[-1]
0xee5: Call2 0xec9
...
0xeeb: Pop(0)
0xeec: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=534
0xeed: Pop(0)
0xeee: Stack[-1] = Stack[-7]
0xeef: Return(); Pop(4)

0xef0: PushEmpty(object, object)
0xef1: @ FindActor(Stack[-1], Stack[-4])
0xef2: Pop(0)
0xef3: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xf18: Stack[-2] = (int) 0
0xf19: Push("all") // @poff=138
0xf1a: PushEmpty(string, int)
0xf1b: Stack[-5] = Stack[-1]
0xf1c: Call2 0xf10
...
0xf2c: Stack[-1] = "ui/NPC_Burah.png" // @poff=542
0xf2d: Return(); Pop(0)

0xf2e: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=576
0xf2f: Return(); Pop(0)
...
0xf36: Stack[-1] = Stack[-4]
0xf37: Pop(1)
0xf38: Stack[-2] = "pt_map_burah_home" // @poff=614
0xf39: Stack[-1] = (int) 2
0xf3a: Call2 0x118e
...
0xf3e: Pop(0)
0xf3f: @@ ShowMap(Stack[-1]); Obj=2 // @poff=650
0xf40: Pop(1)
0xf41: Return(); Pop(0)

0xf42: PushEmpty()
0xf43: PushEmpty(string, bool)
0xf44: Stack[-2] = "boiny@door1" // @poff=658
...
0xf49: PushEmpty()
0xf4a: Push("ook1Burah1") // @poff=682
0xf4b: Push((int) 1)
...
0xf52: Stack[-1] = Stack[-2]
0xf53: Pop(1)
0xf54: Push("k1q01BurahGotoAnna") // @poff=704
0xf55: Push("pt_map_anna") // @poff=742
0xf56: Push((int) 1)
...
0xf5a: Pop(0)
0xf5b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=766
0xf5c: Pop(5)
0xf5d: PushEmpty()
0xf5e: Call2 0x1106
...
0xf6d: Stack[-1] = "k7q01CorpseMark" // @poff=786
0xf6e: Call2 0xe89
...
0xf73: Push("k7q01CorpseMark") // @poff=786
0xf74: Push((int) 1)
...
0xf79: Stack[-1] = Stack[-2]
0xf7a: Pop(1)
0xf7b: Push("k7q01BirdmaskGotoCorpse") // @poff=818
0xf7c: Push("pt_d7q02_corpse") // @poff=866
0xf7d: Push((int) 3)
...
0xf81: Pop(0)
0xf82: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=766
0xf83: Pop(5)
0xf84: PushEmpty(bool, string, string)
0xf85: Stack[-2] = "quest_k7_01" // @poff=898
0xf86: Stack[-1] = "place_corpse" // @poff=922
0xf87: Call2 0xef0
...
0xf8b: PushEmpty()
0xf8c: Push("ook7Burah1") // @poff=948
0xf8d: Push((int) 1)
...
0xf98: Pop(0)
0xf99: Push("bird_balahon") // @poff=982
0xf9a: Push((int) 1)
0xf9b: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1008
0xf9c: Pop(2)
0xf9d: Return(); Pop(2)
...
0xfa1: Stack[-1] = Stack[-2]
0xfa2: Pop(1)
0xfa3: Push("k7q03BurahGotoFather") // @poff=1025
0xfa4: Push("pt_map_burah_home") // @poff=614
0xfa5: Push((int) 0)
...
0xfa9: Pop(0)
0xfaa: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=766
0xfab: Pop(5)
0xfac: PushEmpty()
0xfad: Call2 0x112d
...
0xfb3: Stack[-1] = "quest_k7_03" // @poff=1067
0xfb4: Call2 0xe8e

0xfb5: Pop(2)
0xfb6: PushEmpty(bool, string, string)
0xfb7: Stack[-2] = "quest_k7_03" // @poff=1067
0xfb8: Stack[-1] = "place_family" // @poff=1091
0xfb9: Call2 0xef0
...
0xfbc: Stack[-1] = 0
0xfbd: PushEmpty()
0xfbe: Push("ook7Burah2") // @poff=1117
0xfbf: Push((int) 1)
...
0xfc3: PushEmpty()
0xfc4: Push("tvirin 5 is given") // @poff=1139
0xfc5: @ Trace(Stack[-1])
0xfc6: Pop(1)
0xfc7: PushEmpty(object, string, int)
0xfc8: Stack[-5] = Stack[-3]
0xfc9: Stack[-2] = "tvirin" // @poff=1175
0xfca: Stack[-1] = (int) 5
0xfcb: Call2 0xedc
...
0xfd3: Stack[-2] = "quest_k7_03" // @poff=1067
0xfd4: Stack[-1] = "completed" // @poff=1189
0xfd5: Call2 0xef0
...
0xfd8: PushEmpty()
0xfd9: Push("money2000 is given") // @poff=1209
0xfda: @ Trace(Stack[-1])
0xfdb: Pop(1)
0xfdc: PushEmpty(object, int)
0xfdd: Stack[-4] = Stack[-2]
...
0xfeb: PushEmpty()
0xfec: Push("playsound") // @poff=1261
0xfed: Push("givemoney") // @poff=1281
0xfee: @ TriggerWorld(Stack[-2], Stack[-1])
0xfef: Pop(2)
0xff0: Return(); Pop(0)

0xff1: PushEmpty()
0xff2: Push("playsound") // @poff=1261
0xff3: Push("giveitem") // @poff=1301
0xff4: @ TriggerWorld(Stack[-2], Stack[-1])
0xff5: Pop(2)
0xff6: Return(); Pop(0)

0xff7: PushEmpty()
0xff8: Push("ook12BurahFactory1") // @poff=1319
0xff9: Push((int) 1)
...
0xffd: PushEmpty()
0xffe: Push("k12q01BurahInSobor") // @poff=1357
0xfff: Push((int) 1)
...
0x1008: Stack[-1] = "k12q01_Burah" // @poff=1395
0x1009: Call2 0xe89
...
0x100e: Push("k12q01_Burah") // @poff=1395
0x100f: Push((int) 1)
...
0x1016: PushEmpty()
0x1017: Push("k12BurahVisit") // @poff=1421
0x1018: Push((int) 1)
...
0x1028: Stack[-1] = "game_final" // @poff=1449
0x1029: Call2 0xe89
...
0x1034: Stack[-1] = "k1q01LaskaGotoBurah" // @poff=1471
0x1035: Call2 0xe89
...
0x1040: Stack[-1] = "ook1Burah1" // @poff=682
0x1041: Call2 0xe89
...
0x104c: Stack[-1] = "k12DankoVisit" // @poff=1511
0x104d: Call2 0xe89
...
0x1064: Stack[-4] = Stack[-2]
0x1065: Stack[-1] = "bird_balahon" // @poff=982
0x1066: Call2 0xee9
...
0x107b: Stack[-1] = "ook7Burah1" // @poff=948
0x107c: Call2 0xe89
...
0x1087: Stack[-1] = "k7q03" // @poff=1539
0x1088: Call2 0xe89
...
0x1093: Stack[-1] = "ook7Burah2" // @poff=1117
0x1094: Call2 0xe89
...
0x109f: Stack[-1] = "k7q03" // @poff=1539
0x10a0: Call2 0xe89
...
0x10ab: Stack[-1] = "k11q01" // @poff=1247
0x10ac: Call2 0xe89
...
0x10b7: Stack[-1] = "k12q01ChildsAreVisited" // @poff=1551
0x10b8: Call2 0xe89
...
0x10c3: Stack[-1] = "k12q01BurahInSobor" // @poff=1357
0x10c4: Call2 0xe89
...
0x10cf: Stack[-1] = "ook12BurahFactory1" // @poff=1319
0x10d0: Call2 0xe89
...
0x1159: Push("Can't retrieve diary root") // @poff=1597
0x115a: @ Trace(Stack[-1])
0x115b: Pop(1)
0x115c: Stack[-3] = (bool) 0
0x115d: Return(); Pop(2)

0x115e: Stack[-1] = Stack[-3]
0x115f: Return(); Pop(2)
...
0x1164: Stack[-1] = Stack[-4]
0x1165: Pop(1)
0x1166: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1649
0x1167: Pop(0)
0x1168: Pop(0); Push((bool) Stack[-2] == 0)
0x1169: IF (Stack[-1] == 0) GOTO 0x1170; Pop(1)

0x116a: Push("Can't find diary parent with id: ") // @poff=1654
...
0x1170: @@ AddChild(Stack[-8]); Obj=2 // @poff=1722
0x1171: Pop(0)
0x1172: Push((int) 7)
0x1173: @ SendWorldWndMessage(Stack[-1])
0x1174: Pop(1)
0x1175: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1731
0x1176: Pop(0)
...
0x117f: Pop(0)
0x1180: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1181: IF (Stack[-1] == 0) GOTO 0x1188; Pop(1)

0x1182: Push("Can't find main outdoor scene") // @poff=1743
0x1183: @ Trace(Stack[-1])
0x1184: Pop(1)
0x1185: Stack[-1] = 0
0x1186: Stack[-1] = Stack[-5]
0x1187: Return(); Pop(4)

0x1188: @@ GetMap(Stack[-1]); Obj=2 // @poff=1803
0x1189: Pop(0)
0x118a: Stack[-1] = Stack[-5]
0x118b: Return(); Pop(4)
...
0x1190: Pop(0)
0x1191: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1192: IF (Stack[-1] == 0) GOTO 0x1197; Pop(1)

0x1193: Push("Can't find main outdoor scene") // @poff=1743
0x1194: @ Trace(Stack[-1])
0x1195: Pop(1)
0x1196: Return(); Pop(8)

0x1197: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1810
0x1198: Pop(0)
0x1199: Pop(0); Push((bool) Stack[-1] == 0)
0x119a: IF (Stack[-1] == 0) GOTO 0x11a1; Pop(1)

0x119b: Push("Warning: outdoor scene locator ") // @poff=1821
0x119c: Pop(1); Push(Stack[-1] + Stack[-11]);
0x119d: Push(" doesnt exist") // @poff=1885
0x119e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x119f: @ Trace(Stack[-1])
0x11a0: Pop(1)
0x11a1: @@ GetMap(Stack[-11]); Obj=2 // @poff=1803
0x11a2: Pop(0)
0x11a3: Pop(0); PushNull((bool) Stack[-11] == 0)
0x11a4: IF (Stack[-1] == 0) GOTO 0x11a9; Pop(1)

0x11a5: Push("Can't find map") // @poff=1913
...
0x11ab: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1943
0x11ac: Pop(2)
0x11ad: Return(); Pop(8)

0x11ae: Stack[-2] = 0
0x11af: PushEmpty(int, int)
0x11b0: Push("branch") // @poff=1956
...
0x11c0: PushEmpty()
0x11c1: Push((int) 18)
0x11c2: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11c3: Pop(1)
0x11c4: Push((int) 24)
0x11c5: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11c6: Pop(1)
0x11c7: Push((int) 20)
0x11c8: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11c9: Pop(1)
0x11ca: Push((int) 14)
0x11cb: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11cc: Pop(1)
0x11cd: Push((bool) 0)
...
0x11d0: Push((int) 10)
0x11d1: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11d2: Pop(1)
0x11d3: Push((int) 17)
0x11d4: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11d5: Pop(1)
0x11d6: Push((int) 8)
0x11d7: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11d8: Pop(1)
0x11d9: GOTO 0x11e0
...
0x11dd: Push((int) 10)
0x11de: @@ add(Stack[-1]); Obj=4 // @poff=448
0x11df: Pop(1)
0x11e0: Return(); Pop(0)

0x11e1: PushEmpty(int, int)
0x11e2: Push("vol_") // @poff=1970
...
0x120a: Pop(1)
0x120b: IF (Stack[-1] == 1) GOTO 0x1212; Pop(1)

0x120c: PushEmpty(bool, int)
0x120d: Stack[-4] = Stack[-1]
0x120e: Call2 0x11e1

0x120f: Pop(1)
0x1210: IF (Stack[-1] == 1) GOTO 0x1212; Pop(1)
...
0x121c: Push("mt_burah") // @poff=1989
...
0x1226: Pop(2)
0x1227: Push("mt_burah") // @poff=1989
0x1228: Push((int) 1)
