...
Strings:
	...
	W:branch
	W:mt_eva
// @pool_raw:
// @pool_encoding:utf8
...
0x184: Push("all") // @poff=138
0x185: Push("idle") // @poff=146
...
0x27a: Stack[-1] = "Modesty" // @poff=166
0x27b: Call2 0x18a
...
0x2b5: Stack[-1] = "Modesty" // @poff=166
0x2b6: Call2 0x18a
...
0x2cc: Stack[-1] = "Modesty" // @poff=166
0x2cd: Call2 0x18a
...
0x323: Stack[-1] = "Modesty" // @poff=166
0x324: Call2 0x18a
...
0x33a: Stack[-1] = "Modesty" // @poff=166
0x33b: Call2 0x18a

0x33c: Pop(1)
0x33d: Push((int) 539130)
0x33e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x33f: Pop(1)
0x340: @@@ ClearReplies(); Obj=0 // @poff=116
0x341: Pop(0)
...
0x368: Stack[-1] = "Modesty" // @poff=166
0x369: Call2 0x18a
...
0x396: Stack[-1] = "Neutral" // @poff=89
0x397: Call2 0x18a

0x398: Pop(1)
0x399: Push((int) 539147)
0x39a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x39b: Pop(1)
0x39c: @@@ ClearReplies(); Obj=0 // @poff=116
0x39d: Pop(0)
...
0x3a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x3a7: Pop(3)
0x3a8: Return(); Pop(0)
...
0x3f2: Stack[-1] = "Modesty" // @poff=166
0x3f3: Call2 0x18a
...
0x409: Stack[-1] = "Modesty" // @poff=166
0x40a: Call2 0x18a
...
0x438: Pop(0)
0x439: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x43a: Pop(1)
0x43b: PushEmpty(int)
0x43c: Call2 0xbc2

0x43d: Pop(0)
0x43e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x43f: Pop(1)
0x440: PushEmpty(string)
0x441: Call2 0xbc6

0x442: Pop(0)
0x443: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x444: Pop(1)
0x445: PushEmpty(string)
0x446: Call2 0xbc8

0x447: Pop(0)
0x448: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x449: Pop(1)
0x44a: PushEmpty(int)
0x44b: Call2 0xd4c

0x44c: Pop(0)
0x44d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x44e: Pop(1)
0x44f: Stack[-2] = (int) -1
...
0x45b: Stack[-1] = Stack[-2]
0x45c: Pop(1)
0x45d: Call2 0xa97

0x45e: Pop(2)
0x45f: PushEmpty(object, object)
0x460: Stack[-11] = Stack[-2]
...
0x465: Pop(2)
0x466: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x467: Pop(0)
...
0x46a: @ sync()
0x46b: Pop(0)
0x46c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x46d: Pop(0)
0x46e: GOTO 0x468
...
0x474: Pop(0)
0x475: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x476: Pop(0)
0x477: Stack[-2] = Stack[-10]
0x478: Return(); Pop(8)
...
0x4b7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x4b8: Pop(3)
0x4b9: GOTO 0x4bc
...
0x4d4: Push("all") // @poff=138
0x4d5: Push("idle") // @poff=146
...
0x58d: Stack[-1] = "Modesty" // @poff=166
0x58e: Call2 0x4da
...
0x59f: Stack[-1] = "Modesty" // @poff=166
0x5a0: Call2 0x4da
...
0x5c8: Stack[-1] = "Neutral" // @poff=89
0x5c9: Call2 0x4da

0x5ca: Pop(1)
0x5cb: Push((int) 526039)
0x5cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x5cd: Pop(1)
0x5ce: @@@ ClearReplies(); Obj=0 // @poff=116
0x5cf: Pop(0)
...
0x5f1: Stack[-1] = "Modesty" // @poff=166
0x5f2: Call2 0x4da
...
0x61b: Pop(0)
0x61c: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x61d: Pop(1)
0x61e: PushEmpty(int)
0x61f: Call2 0xbc2

0x620: Pop(0)
0x621: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x622: Pop(1)
0x623: PushEmpty(string)
0x624: Call2 0xbc6

0x625: Pop(0)
0x626: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x627: Pop(1)
0x628: PushEmpty(string)
0x629: Call2 0xbc8

0x62a: Pop(0)
0x62b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x62c: Pop(1)
0x62d: PushEmpty(int)
0x62e: Call2 0xd4c

0x62f: Pop(0)
0x630: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x631: Pop(1)
0x632: Stack[-2] = (int) -1
...
0x75a: Pop(0)
0x75b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x75c: Pop(1)
0x75d: PushEmpty(int)
0x75e: Call2 0xbc2

0x75f: Pop(0)
0x760: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x761: Pop(1)
0x762: PushEmpty(string)
0x763: Call2 0xbc6

0x764: Pop(0)
0x765: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x766: Pop(1)
0x767: PushEmpty(string)
0x768: Call2 0xbc8

0x769: Pop(0)
0x76a: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x76b: Pop(1)
0x76c: PushEmpty(int)
0x76d: Call2 0xd4c

0x76e: Pop(0)
0x76f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x770: Pop(1)
0x771: Stack[-2] = (int) -1
...
0x85d: Pop(0)
0x85e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x85f: Pop(1)
0x860: PushEmpty(int)
0x861: Call2 0xbc2

0x862: Pop(0)
0x863: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x864: Pop(1)
0x865: PushEmpty(string)
0x866: Call2 0xbc6

0x867: Pop(0)
0x868: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x869: Pop(1)
0x86a: PushEmpty(string)
0x86b: Call2 0xbc8

0x86c: Pop(0)
0x86d: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x86e: Pop(1)
0x86f: PushEmpty(int)
0x870: Call2 0xd4c

0x871: Pop(0)
0x872: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x873: Pop(1)
0x874: Stack[-2] = (int) -1
...
0x936: Stack[-2] = Stack[-5]
0x937: Pop(2)
0x938: Return(); Pop(2)

0x939: Stack[-1] = 0
0x93a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x93b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x93c: @ RotateAsync(Stack[-2], Stack[-1])
0x93d: Pop(2)
0x93e: Return(); Pop(0)

0x93f: PushEmpty(object, bool, object, bool)
0x940: Push("player") // @poff=192
...
0x9bf: Stack[-4] = Stack[-1]
0x9c0: Call2 0xd5d

0x9c1: Pop(1)
0x9c2: PushEmpty(string)
0x9c3: Stack[-1] = "Neutral" // @poff=89
0x9c4: Call2 0xb21
...
0x9f7: Stack[-3] = (int) 0
0x9f8: Push("all") // @poff=138
0x9f9: PushEmpty(string, int)
0x9fa: Stack[-6] = Stack[-1]
0x9fb: Call2 0xbaa
...
0xa1b: Pop(0)
0xa1c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=206
0xa1d: Pop(0)
...
0xa22: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=218
0xa23: Pop(0)
0xa24: Pop(0); Push(Stack[-1] + Stack[-3]);
0xa25: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=230
0xa26: Pop(1)
0xa27: Return(); Pop(2)
...
0xa2f: Pop(2)
0xa30: Stack[-1] = Stack[-8]
0xa31: Return(); Pop(6)

0xa32: PushEmpty(cvector, cvector)
0xa33: @@ GetPosition(Stack[-1]); Obj=3 // @poff=206
0xa34: Pop(0)
0xa35: PushEmpty(bool, cvector)
0xa36: Stack[-3] = Stack[-1]
0xa37: Call2 0xa28

0xa38: Stack[-2] = Stack[-6]
0xa39: Pop(2)
0xa3a: Return(); Pop(2)
...
0xa41: @@ GetPosition(Stack[-8]); Obj=20 // @poff=206
0xa42: Pop(0)
0xa43: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=242
0xa44: Pop(0)
...
0xab0: Push("voice_common") // @poff=266
0xab1: Push((int) 1)
...
0xab8: Push("voice_common") // @poff=266
0xab9: Push((int) 0)
...
0xacb: Push("voice_common") // @poff=266
0xacc: Push((int) 1)
...
0xad9: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0xada: Pop(1)
...
0xaee: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=218
0xaef: Pop(1)
0xaf0: PushEmpty(bool, string)
0xaf1: Stack[-3] = Stack[-1]
0xaf2: Call2 0xb40

0xaf3: Stack[-2] = Stack[-14]
0xaf4: Pop(2)
0xaf5: Return(); Pop(10)

0xaf6: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xaf7: Push("d") // @poff=262
0xaf8: PushEmpty(int)
0xaf9: Call2 0xb9b

0xafa: Pop(0)
0xafb: Pop(2); Push(Stack[-2] + Stack[-1]);
0xafc: Push("m") // @poff=308
...
0xb04: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0xb05: Pop(1)
...
0xb19: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=218
0xb1a: Pop(1)
0xb1b: PushEmpty(bool, string)
0xb1c: Stack[-3] = Stack[-1]
0xb1d: Call2 0xb40

0xb1e: Stack[-2] = Stack[-14]
0xb1f: Pop(2)
0xb20: Return(); Pop(10)
...
0xb2c: Push("Can't find lsh animation : ") // @poff=312
...
0xb3b: Push("Can't find lsh animation : ") // @poff=312
...
0xb5f: Push((float)9.999999974752427e-07)
...
0xb68: Pop(0)
0xb69: Stack[-1] = Stack[-4]
0xb6a: Return(); Pop(2)

0xb6b: PushEmpty(object, object)
0xb6c: @ CreateIntVector(Stack[-1])
0xb6d: Pop(0)
0xb6e: @@ add(Stack[-4]); Obj=1 // @poff=368
0xb6f: Pop(0)
0xb70: @@ add(Stack[-3]); Obj=1 // @poff=368
0xb71: Pop(0)
0xb72: Push((int) 3)
...
0xb79: Stack[-7] = Stack[-3]
0xb7a: Stack[-2] = "money" // @poff=372
...
0xb81: Push("Money") // @poff=384
0xb82: @ GetInvItemByName(Stack[-2], Stack[-1])
0xb83: Pop(1)
0xb84: PushEmpty(int, int)
0xb85: Stack[-3] = Stack[-2]
0xb86: Stack[-5] = Stack[-1]
0xb87: Call2 0xb6b
...
0xb8c: Pop(0)
0xb8d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xbc6: Stack[-1] = "ui/NPC_Eva.png" // @poff=396
0xbc7: Return(); Pop(0)

0xbc8: Stack[-1] = "ui/NPC_Eva_b.png" // @poff=426
0xbc9: Return(); Pop(0)
...
0xbd0: Pop(1)
0xbd1: Push("k3q03EvaGotoSklad") // @poff=460
0xbd2: Push("pt_region01_center01") // @poff=496
0xbd3: Push((int) 0)
...
0xbd7: Pop(0)
0xbd8: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=538
0xbd9: Pop(5)
0xbda: Return(); Pop(2)

0xbdb: Stack[-1] = 0
0xbdc: PushEmpty()
0xbdd: Push("k3q02") // @poff=546
0xbde: Push((int) 3)
...
0xbfc: PushEmpty()
0xbfd: @@ SelectWeapon(); Obj=2 // @poff=612
0xbfe: Pop(0)
0xbff: PushEmpty(bool, string, string)
0xc00: Stack[-2] = "quest_k6_01" // @poff=625
0xc01: Stack[-1] = "unlock_eva" // @poff=649
0xc02: Call2 0xb8a
...
0xc15: PushEmpty()
0xc16: Push("money1000 is given") // @poff=691
0xc17: @ Trace(Stack[-1])
0xc18: Pop(1)
0xc19: PushEmpty(object, int)
0xc1a: Stack[-4] = Stack[-2]
...
0xc1f: PushEmpty()
0xc20: Push("playsound") // @poff=729
0xc21: Push("givemoney") // @poff=749
...
0xc2a: Pop(1)
0xc2b: Stack[-2] = "pt_region01_center01" // @poff=496
0xc2c: Stack[-1] = (int) 2
0xc2d: Call2 0xd2b
...
0xc31: Pop(0)
0xc32: @@ ShowMap(Stack[-1]); Obj=2 // @poff=769
0xc33: Pop(1)
0xc34: Return(); Pop(0)

0xc35: PushEmpty()
0xc36: Push("k3q02") // @poff=546
0xc37: Push((int) -1)
...
0xc3e: PushEmpty()
0xc3f: Push("playsound") // @poff=729
0xc40: Push("giveitem") // @poff=777
...
0xc5e: Stack[-1] = "ook3Eva1" // @poff=558
0xc5f: Call2 0xb66
...
0xc76: Stack[-1] = "ook6Eva1" // @poff=576
0xc77: Call2 0xb66
...
0xc8e: Stack[-1] = "ook6Eva2" // @poff=594
0xc8f: Call2 0xb66
...
0xca6: Stack[-1] = "ook11Eva1" // @poff=671
0xca7: Call2 0xb66
...
0xcf6: Push("Can't retrieve diary root") // @poff=833
0xcf7: @ Trace(Stack[-1])
0xcf8: Pop(1)
0xcf9: Stack[-3] = (bool) 0
0xcfa: Return(); Pop(2)

0xcfb: Stack[-1] = Stack[-3]
0xcfc: Return(); Pop(2)
...
0xd01: Stack[-1] = Stack[-4]
0xd02: Pop(1)
0xd03: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=885
0xd04: Pop(0)
0xd05: Pop(0); Push((bool) Stack[-2] == 0)
0xd06: IF (Stack[-1] == 0) GOTO 0xd0d; Pop(1)

0xd07: Push("Can't find diary parent with id: ") // @poff=890
...
0xd0d: @@ AddChild(Stack[-8]); Obj=2 // @poff=958
0xd0e: Pop(0)
0xd0f: Push((int) 7)
0xd10: @ SendWorldWndMessage(Stack[-1])
0xd11: Pop(1)
0xd12: @@ GetCategory(Stack[-1]); Obj=8 // @poff=967
0xd13: Pop(0)
...
0xd1c: Pop(0)
0xd1d: Pop(0); PushNull((bool) Stack[-2] == 0)
0xd1e: IF (Stack[-1] == 0) GOTO 0xd25; Pop(1)

0xd1f: Push("Can't find main outdoor scene") // @poff=979
0xd20: @ Trace(Stack[-1])
0xd21: Pop(1)
0xd22: Stack[-1] = 0
0xd23: Stack[-1] = Stack[-5]
0xd24: Return(); Pop(4)

0xd25: @@ GetMap(Stack[-1]); Obj=2 // @poff=1039
0xd26: Pop(0)
0xd27: Stack[-1] = Stack[-5]
0xd28: Return(); Pop(4)
...
0xd2d: Pop(0)
0xd2e: Pop(0); PushNull((bool) Stack[-2] == 0)
0xd2f: IF (Stack[-1] == 0) GOTO 0xd34; Pop(1)

0xd30: Push("Can't find main outdoor scene") // @poff=979
0xd31: @ Trace(Stack[-1])
0xd32: Pop(1)
0xd33: Return(); Pop(8)

0xd34: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1046
0xd35: Pop(0)
0xd36: Pop(0); Push((bool) Stack[-1] == 0)
0xd37: IF (Stack[-1] == 0) GOTO 0xd3e; Pop(1)

0xd38: Push("Warning: outdoor scene locator ") // @poff=1057
0xd39: Pop(1); Push(Stack[-1] + Stack[-11]);
0xd3a: Push(" doesnt exist") // @poff=1121
0xd3b: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd3c: @ Trace(Stack[-1])
0xd3d: Pop(1)
0xd3e: @@ GetMap(Stack[-11]); Obj=2 // @poff=1039
0xd3f: Pop(0)
0xd40: Pop(0); PushNull((bool) Stack[-11] == 0)
0xd41: IF (Stack[-1] == 0) GOTO 0xd46; Pop(1)

0xd42: Push("Can't find map") // @poff=1149
0xd43: @ Trace(Stack[-1])
0xd44: Pop(1)
0xd45: Return(); Pop(8)
...
0xd48: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1179
0xd49: Pop(2)
0xd4a: Return(); Pop(8)

0xd4b: Stack[-2] = 0
0xd4c: PushEmpty(int, int)
0xd4d: Push("branch") // @poff=1192
