...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x6b: Stack[-1] = "Anger" // @poff=89
0x6c: Call2 0xbc

0x6d: Pop(1)
0x6e: Push((int) 524754)
0x6f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x70: Pop(1)
0x71: @@@ ClearReplies(); Obj=0 // @poff=112
0x72: Pop(0)
0x73: Push((int) 526909)
0x74: Push((int) 28202)
0x75: Push((int) 28201)
0x76: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x77: Pop(3)
0x78: GOTO 0x9e

0x79: PushEmpty(string)
0x7a: Stack[-1] = "Jeer" // @poff=134
0x7b: Call2 0xbc

0x7c: Pop(1)
0x7d: Push((int) 524756)
0x7e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7f: Pop(1)
0x80: @@@ ClearReplies(); Obj=0 // @poff=112
0x81: Pop(0)
...
0x88: Push((int) 26088)
0x89: Push((int) 26087)
0x8a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8b: Pop(3)
...
0x92: Push((int) -1)
0x93: Push((int) 31738)
0x94: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x95: Pop(3)
0x96: Push((int) 524757)
0x97: Push((int) -1)
0x98: Push((int) 26081)
0x99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x9a: Pop(3)
0x9b: GOTO 0x9e
...
0xad: Push("all") // @poff=144
0xae: Push("idle") // @poff=152
...
0xb6: Push("all") // @poff=144
0xb7: Push("idle") // @poff=152
...
0x13e: Stack[-1] = "Anger" // @poff=89
0x13f: Call2 0xbc

0x140: Pop(1)
0x141: Push((int) 524754)
0x142: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x143: Pop(1)
0x144: @@@ ClearReplies(); Obj=0 // @poff=112
0x145: Pop(0)
0x146: Push((int) 526909)
0x147: Push((int) 28202)
0x148: Push((int) 28201)
0x149: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x14a: Pop(3)
0x14b: Return(); Pop(0)

0x14c: PushEmpty(string)
0x14d: Stack[-1] = "Jeer" // @poff=134
0x14e: Call2 0xbc

0x14f: Pop(1)
0x150: Push((int) 524756)
0x151: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x152: Pop(1)
0x153: @@@ ClearReplies(); Obj=0 // @poff=112
0x154: Pop(0)
...
0x15d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x15e: Pop(3)
...
0x167: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x168: Pop(3)
0x169: Push((int) 524757)
0x16a: Push((int) -1)
0x16b: Push((int) 26081)
0x16c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x16d: Pop(3)
0x16e: Return(); Pop(0)
...
0x173: Stack[-1] = "Distrust" // @poff=162
0x174: Call2 0xbc

0x175: Pop(1)
0x176: Push((int) 524764)
0x177: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x178: Pop(1)
0x179: @@@ ClearReplies(); Obj=0 // @poff=112
0x17a: Pop(0)
0x17b: Push((int) 524765)
0x17c: Push((int) 26090)
0x17d: Push((int) 26089)
0x17e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x17f: Pop(3)
0x180: Push((int) 526923)
0x181: Push((int) 28216)
0x182: Push((int) 28215)
0x183: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x184: Pop(3)
0x185: Return(); Pop(0)
...
0x18a: Stack[-1] = "Anger" // @poff=89
0x18b: Call2 0xbc

0x18c: Pop(1)
0x18d: Push((int) 526924)
0x18e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x18f: Pop(1)
0x190: @@@ ClearReplies(); Obj=0 // @poff=112
0x191: Pop(0)
0x192: Push((int) 526925)
0x193: Push((int) 28219)
0x194: Push((int) 28217)
0x195: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x196: Pop(3)
0x197: Push((int) 526926)
0x198: Push((int) -1)
0x199: Push((int) 28218)
0x19a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x19b: Pop(3)
0x19c: Return(); Pop(0)
...
0x1a1: Stack[-1] = "Anger" // @poff=89
0x1a2: Call2 0xbc

0x1a3: Pop(1)
0x1a4: Push((int) 526927)
0x1a5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1a6: Pop(1)
0x1a7: @@@ ClearReplies(); Obj=0 // @poff=112
0x1a8: Pop(0)
0x1a9: Push((int) 526928)
0x1aa: Push((int) -1)
0x1ab: Push((int) 28220)
0x1ac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1ad: Pop(3)
0x1ae: Push((int) 526929)
0x1af: Push((int) -1)
0x1b0: Push((int) 28221)
0x1b1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1b2: Pop(3)
0x1b3: Return(); Pop(0)
...
0x1b8: Stack[-1] = "Neutral" // @poff=180
0x1b9: Call2 0xbc

0x1ba: Pop(1)
0x1bb: Push((int) 524766)
0x1bc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1bd: Pop(1)
0x1be: @@@ ClearReplies(); Obj=0 // @poff=112
0x1bf: Pop(0)
0x1c0: Push((int) 526915)
0x1c1: Push((int) 28208)
0x1c2: Push((int) 28207)
0x1c3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1c4: Pop(3)
0x1c5: Push((int) 526930)
0x1c6: Push((int) 28223)
0x1c7: Push((int) 28222)
0x1c8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1c9: Pop(3)
0x1ca: Return(); Pop(0)
...
0x1cf: Stack[-1] = "Anger" // @poff=89
0x1d0: Call2 0xbc

0x1d1: Pop(1)
0x1d2: Push((int) 526931)
0x1d3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1d4: Pop(1)
0x1d5: @@@ ClearReplies(); Obj=0 // @poff=112
0x1d6: Pop(0)
0x1d7: Push((int) 526932)
0x1d8: Push((int) 28208)
0x1d9: Push((int) 28224)
0x1da: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1db: Pop(3)
0x1dc: Return(); Pop(0)
...
0x1e1: Stack[-1] = "Distrust" // @poff=162
0x1e2: Call2 0xbc

0x1e3: Pop(1)
0x1e4: Push((int) 526916)
0x1e5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1e6: Pop(1)
0x1e7: @@@ ClearReplies(); Obj=0 // @poff=112
0x1e8: Pop(0)
0x1e9: Push((int) 526917)
0x1ea: Push((int) 28210)
0x1eb: Push((int) 28209)
0x1ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1ed: Pop(3)
0x1ee: Push((int) 527156)
0x1ef: Push((int) 28460)
0x1f0: Push((int) 28459)
0x1f1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1f2: Pop(3)
0x1f3: Return(); Pop(0)
...
0x1f8: Stack[-1] = "Distrust" // @poff=162
0x1f9: Call2 0xbc

0x1fa: Pop(1)
0x1fb: Push((int) 527157)
0x1fc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1fd: Pop(1)
0x1fe: @@@ ClearReplies(); Obj=0 // @poff=112
0x1ff: Pop(0)
0x200: Push((int) 527158)
0x201: Push((int) 28210)
0x202: Push((int) 28461)
0x203: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x204: Pop(3)
0x205: Return(); Pop(0)
...
0x20a: Stack[-1] = "Distrust" // @poff=162
0x20b: Call2 0xbc

0x20c: Pop(1)
0x20d: Push((int) 526918)
0x20e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x20f: Pop(1)
0x210: @@@ ClearReplies(); Obj=0 // @poff=112
0x211: Pop(0)
0x212: Push((int) 526919)
0x213: Push((int) 28212)
0x214: Push((int) 28211)
0x215: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x216: Pop(3)
0x217: Push((int) 527159)
0x218: Push((int) 28464)
0x219: Push((int) 28463)
0x21a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x21b: Pop(3)
0x21c: Return(); Pop(0)
...
0x221: Stack[-1] = "Distrust" // @poff=162
0x222: Call2 0xbc

0x223: Pop(1)
0x224: Push((int) 527160)
0x225: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x226: Pop(1)
0x227: @@@ ClearReplies(); Obj=0 // @poff=112
0x228: Pop(0)
0x229: Push((int) 527161)
0x22a: Push((int) 28214)
0x22b: Push((int) 28465)
0x22c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x22d: Pop(3)
0x22e: Return(); Pop(0)
...
0x233: Stack[-1] = "Anger" // @poff=89
0x234: Call2 0xbc

0x235: Pop(1)
0x236: Push((int) 526920)
0x237: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x238: Pop(1)
0x239: @@@ ClearReplies(); Obj=0 // @poff=112
0x23a: Pop(0)
0x23b: Push((int) 526921)
0x23c: Push((int) 28214)
0x23d: Push((int) 28213)
0x23e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x23f: Pop(3)
0x240: Push((int) 527166)
0x241: Push((int) 28214)
0x242: Push((int) 28471)
0x243: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x244: Pop(3)
0x245: Return(); Pop(0)
...
0x24a: Stack[-1] = "Anger" // @poff=89
0x24b: Call2 0xbc

0x24c: Pop(1)
0x24d: Push((int) 526922)
0x24e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x24f: Pop(1)
0x250: @@@ ClearReplies(); Obj=0 // @poff=112
0x251: Pop(0)
0x252: Push((int) 527162)
0x253: Push((int) 28467)
0x254: Push((int) 28466)
0x255: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x256: Pop(3)
0x257: Push((int) 527167)
0x258: Push((int) 28467)
0x259: Push((int) 28473)
0x25a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x25b: Pop(3)
0x25c: Return(); Pop(0)
...
0x261: Stack[-1] = "Anger" // @poff=89
0x262: Call2 0xbc

0x263: Pop(1)
0x264: Push((int) 527163)
0x265: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x266: Pop(1)
0x267: @@@ ClearReplies(); Obj=0 // @poff=112
0x268: Pop(0)
0x269: Push((int) 527164)
0x26a: Push((int) 28469)
0x26b: Push((int) 28468)
0x26c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x26d: Pop(3)
0x26e: Push((int) 527169)
0x26f: Push((int) 28477)
0x270: Push((int) 28476)
0x271: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x272: Pop(3)
0x273: Return(); Pop(0)
...
0x278: Stack[-1] = "Neutral" // @poff=180
0x279: Call2 0xbc

0x27a: Pop(1)
0x27b: Push((int) 527170)
0x27c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x27d: Pop(1)
0x27e: @@@ ClearReplies(); Obj=0 // @poff=112
0x27f: Pop(0)
0x280: Push((int) 527171)
0x281: Push((int) 28469)
0x282: Push((int) 28478)
0x283: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x284: Pop(3)
0x285: Return(); Pop(0)
...
0x28a: Stack[-1] = "Distrust" // @poff=162
0x28b: Call2 0xbc

0x28c: Pop(1)
0x28d: Push((int) 527165)
0x28e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x28f: Pop(1)
0x290: @@@ ClearReplies(); Obj=0 // @poff=112
0x291: Pop(0)
0x292: Push((int) 524767)
0x293: Push((int) -1)
0x294: Push((int) 26091)
0x295: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x296: Pop(3)
0x297: Push((int) 527168)
0x298: Push((int) -1)
0x299: Push((int) 28475)
0x29a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x29b: Pop(3)
0x29c: Return(); Pop(0)
...
0x2a1: Stack[-1] = "Anger" // @poff=89
0x2a2: Call2 0xbc

0x2a3: Pop(1)
0x2a4: Push((int) 526910)
0x2a5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x2a6: Pop(1)
0x2a7: @@@ ClearReplies(); Obj=0 // @poff=112
0x2a8: Pop(0)
0x2a9: Push((int) 527148)
0x2aa: Push((int) 28450)
0x2ab: Push((int) 28448)
0x2ac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2ad: Pop(3)
0x2ae: Push((int) 527149)
0x2af: Push((int) 28450)
0x2b0: Push((int) 28449)
0x2b1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2b2: Pop(3)
0x2b3: Return(); Pop(0)
...
0x2b8: Stack[-1] = "Neutral" // @poff=180
0x2b9: Call2 0xbc

0x2ba: Pop(1)
0x2bb: Push((int) 527150)
0x2bc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x2bd: Pop(1)
0x2be: @@@ ClearReplies(); Obj=0 // @poff=112
0x2bf: Pop(0)
0x2c0: Push((int) 526911)
0x2c1: Push((int) 28452)
0x2c2: Push((int) 28203)
0x2c3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2c4: Pop(3)
0x2c5: Return(); Pop(0)
...
0x2ca: Stack[-1] = "Neutral" // @poff=180
0x2cb: Call2 0xbc

0x2cc: Pop(1)
0x2cd: Push((int) 527151)
0x2ce: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x2cf: Pop(1)
0x2d0: @@@ ClearReplies(); Obj=0 // @poff=112
0x2d1: Pop(0)
0x2d2: Push((int) 527152)
0x2d3: Push((int) 28204)
0x2d4: Push((int) 28453)
0x2d5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2d6: Pop(3)
0x2d7: Push((int) 527153)
0x2d8: Push((int) 28204)
0x2d9: Push((int) 28454)
0x2da: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2db: Pop(3)
0x2dc: Return(); Pop(0)
...
0x2e1: Stack[-1] = "Jeer" // @poff=134
0x2e2: Call2 0xbc

0x2e3: Pop(1)
0x2e4: Push((int) 526912)
0x2e5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x2e6: Pop(1)
0x2e7: @@@ ClearReplies(); Obj=0 // @poff=112
0x2e8: Pop(0)
0x2e9: Push((int) 527146)
0x2ea: Push((int) 28447)
0x2eb: Push((int) 28446)
0x2ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2ed: Pop(3)
0x2ee: Push((int) 524755)
0x2ef: Push((int) -1)
0x2f0: Push((int) 26079)
0x2f1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x2f2: Pop(3)
0x2f3: Return(); Pop(0)
...
0x2f8: Stack[-1] = "Jeer" // @poff=134
0x2f9: Call2 0xbc

0x2fa: Pop(1)
0x2fb: Push((int) 527147)
0x2fc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x2fd: Pop(1)
0x2fe: @@@ ClearReplies(); Obj=0 // @poff=112
0x2ff: Pop(0)
0x300: Push((int) 527154)
0x301: Push((int) -1)
0x302: Push((int) 28456)
0x303: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x304: Pop(3)
0x305: Push((int) 527155)
0x306: Push((int) -1)
0x307: Push((int) 28457)
0x308: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x309: Pop(3)
0x30a: Return(); Pop(0)
...
0x327: Pop(0)
0x328: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x329: Pop(1)
0x32a: PushEmpty(int)
0x32b: Call2 0x101c

0x32c: Pop(0)
0x32d: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x32e: Pop(1)
0x32f: PushEmpty(string)
0x330: Call2 0x1020

0x331: Pop(0)
0x332: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x333: Pop(1)
0x334: PushEmpty(string)
0x335: Call2 0x1022

0x336: Pop(0)
0x337: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x338: Pop(1)
0x339: PushEmpty(int)
0x33a: Call2 0x1204

0x33b: Pop(0)
0x33c: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x33d: Pop(1)
0x33e: Stack[-2] = (int) -1
...
0x34a: Stack[-1] = Stack[-2]
0x34b: Pop(1)
0x34c: Call2 0xeac

0x34d: Pop(2)
0x34e: PushEmpty(object, object)
0x34f: Stack[-11] = Stack[-2]
...
0x354: Pop(2)
0x355: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x356: Pop(0)
...
0x359: @ sync()
0x35a: Pop(0)
0x35b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x35c: Pop(0)
0x35d: GOTO 0x357
...
0x363: Pop(0)
0x364: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x365: Pop(0)
0x366: Stack[-2] = Stack[-10]
0x367: Return(); Pop(8)
...
0x370: Stack[-1] = "Neutral" // @poff=180
0x371: Call2 0x3a3

0x372: Pop(1)
0x373: Push((int) 525480)
0x374: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x375: Pop(1)
0x376: @@@ ClearReplies(); Obj=0 // @poff=112
0x377: Pop(0)
0x378: Push((int) 525481)
0x379: Push((int) 27536)
0x37a: Push((int) 26837)
0x37b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x37c: Pop(3)
0x37d: Push((int) 526263)
0x37e: Push((int) 27536)
0x37f: Push((int) 27537)
0x380: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x381: Pop(3)
0x382: GOTO 0x385
...
0x394: Push("all") // @poff=144
0x395: Push("idle") // @poff=152
...
0x39d: Push("all") // @poff=144
0x39e: Push("idle") // @poff=152
...
0x3c3: Stack[-1] = "Neutral" // @poff=180
0x3c4: Call2 0x3a3

0x3c5: Pop(1)
0x3c6: Push((int) 525480)
0x3c7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x3c8: Pop(1)
0x3c9: @@@ ClearReplies(); Obj=0 // @poff=112
0x3ca: Pop(0)
0x3cb: Push((int) 525481)
0x3cc: Push((int) 27536)
0x3cd: Push((int) 26837)
0x3ce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x3cf: Pop(3)
0x3d0: Push((int) 526263)
0x3d1: Push((int) 27536)
0x3d2: Push((int) 27537)
0x3d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x3d4: Pop(3)
0x3d5: Return(); Pop(0)
...
0x3da: Stack[-1] = "Neutral" // @poff=180
0x3db: Call2 0x3a3

0x3dc: Pop(1)
0x3dd: Push((int) 526262)
0x3de: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x3df: Pop(1)
0x3e0: @@@ ClearReplies(); Obj=0 // @poff=112
0x3e1: Pop(0)
0x3e2: Push((int) 526264)
0x3e3: Push((int) 27540)
0x3e4: Push((int) 27539)
0x3e5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x3e6: Pop(3)
0x3e7: Push((int) 526266)
0x3e8: Push((int) -1)
0x3e9: Push((int) 27541)
0x3ea: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x3eb: Pop(3)
0x3ec: Return(); Pop(0)
...
0x3f1: Stack[-1] = "Neutral" // @poff=180
0x3f2: Call2 0x3a3

0x3f3: Pop(1)
0x3f4: Push((int) 526265)
0x3f5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x3f6: Pop(1)
0x3f7: @@@ ClearReplies(); Obj=0 // @poff=112
0x3f8: Pop(0)
0x3f9: Push((int) 526267)
0x3fa: Push((int) -1)
0x3fb: Push((int) 27542)
0x3fc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x3fd: Pop(3)
0x3fe: Push((int) 526268)
0x3ff: Push((int) -1)
0x400: Push((int) 27543)
0x401: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x402: Pop(3)
0x403: Return(); Pop(0)
...
0x420: Pop(0)
0x421: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x422: Pop(1)
0x423: PushEmpty(int)
0x424: Call2 0x101c

0x425: Pop(0)
0x426: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x427: Pop(1)
0x428: PushEmpty(string)
0x429: Call2 0x1020

0x42a: Pop(0)
0x42b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x42c: Pop(1)
0x42d: PushEmpty(string)
0x42e: Call2 0x1022

0x42f: Pop(0)
0x430: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x431: Pop(1)
0x432: PushEmpty(int)
0x433: Call2 0x1204

0x434: Pop(0)
0x435: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x436: Pop(1)
0x437: Stack[-2] = (int) -1
...
0x44d: Pop(2)
0x44e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x44f: Pop(0)
...
0x458: Stack[-10] = Stack[-1]
0x459: Call2 0xe9a

0x45a: Pop(1)
0x45b: @ StopDialog(Stack[-4])
0x45c: Pop(0)
0x45d: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x45e: Pop(0)
...
0x469: Stack[-1] = "Jeer" // @poff=134
0x46a: Call2 0x4aa

0x46b: Pop(1)
0x46c: Push((int) 525594)
0x46d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x46e: Pop(1)
0x46f: @@@ ClearReplies(); Obj=0 // @poff=112
0x470: Pop(0)
...
0x482: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x483: Pop(3)
0x484: Push((int) 525595)
0x485: Push((int) -1)
0x486: Push((int) 26942)
0x487: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x488: Pop(3)
0x489: GOTO 0x48c
...
0x49b: Push("all") // @poff=144
0x49c: Push("idle") // @poff=152
...
0x4a4: Push("all") // @poff=144
0x4a5: Push("idle") // @poff=152
...
0x4e2: Stack[-1] = "Jeer" // @poff=134
0x4e3: Call2 0x4aa

0x4e4: Pop(1)
0x4e5: Push((int) 525594)
0x4e6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x4e7: Pop(1)
0x4e8: @@@ ClearReplies(); Obj=0 // @poff=112
0x4e9: Pop(0)
...
0x4fb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x4fc: Pop(3)
0x4fd: Push((int) 525595)
0x4fe: Push((int) -1)
0x4ff: Push((int) 26942)
0x500: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x501: Pop(3)
0x502: Return(); Pop(0)
...
0x507: Stack[-1] = "Anger" // @poff=89
0x508: Call2 0x4aa

0x509: Pop(1)
0x50a: Push((int) 525597)
0x50b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x50c: Pop(1)
0x50d: @@@ ClearReplies(); Obj=0 // @poff=112
0x50e: Pop(0)
0x50f: Push((int) 540670)
0x510: Push((int) 42702)
0x511: Push((int) 42701)
0x512: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x513: Pop(3)
0x514: Push((int) 540672)
0x515: Push((int) 42702)
0x516: Push((int) 42703)
0x517: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x518: Pop(3)
0x519: Return(); Pop(0)
...
0x51e: Stack[-1] = "Anger" // @poff=89
0x51f: Call2 0x4aa

0x520: Pop(1)
0x521: Push((int) 540671)
0x522: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x523: Pop(1)
0x524: @@@ ClearReplies(); Obj=0 // @poff=112
0x525: Pop(0)
0x526: Push((int) 540673)
0x527: Push((int) 42706)
0x528: Push((int) 42704)
0x529: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x52a: Pop(3)
0x52b: Push((int) 540675)
0x52c: Push((int) 42706)
0x52d: Push((int) 42707)
0x52e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x52f: Pop(3)
0x530: Return(); Pop(0)
...
0x535: Stack[-1] = "Anger" // @poff=89
0x536: Call2 0x4aa

0x537: Pop(1)
0x538: Push((int) 540674)
0x539: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x53a: Pop(1)
0x53b: @@@ ClearReplies(); Obj=0 // @poff=112
0x53c: Pop(0)
0x53d: Push((int) 525598)
0x53e: Push((int) -1)
0x53f: Push((int) 26945)
0x540: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x541: Pop(3)
0x542: Push((int) 540676)
0x543: Push((int) -1)
0x544: Push((int) 42709)
0x545: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x546: Pop(3)
0x547: Return(); Pop(0)
...
0x564: Pop(0)
0x565: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x566: Pop(1)
0x567: PushEmpty(int)
0x568: Call2 0x101c

0x569: Pop(0)
0x56a: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x56b: Pop(1)
0x56c: PushEmpty(string)
0x56d: Call2 0x1020

0x56e: Pop(0)
0x56f: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x570: Pop(1)
0x571: PushEmpty(string)
0x572: Call2 0x1022

0x573: Pop(0)
0x574: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x575: Pop(1)
0x576: PushEmpty(int)
0x577: Call2 0x1204

0x578: Pop(0)
0x579: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x57a: Pop(1)
0x57b: Stack[-2] = (int) -1
...
0x587: Stack[-1] = Stack[-2]
0x588: Pop(1)
0x589: Call2 0xeac

0x58a: Pop(2)
0x58b: PushEmpty(object, object)
0x58c: Stack[-11] = Stack[-2]
0x58d: Stack[-6] = Stack[-1]
0x58e: Push(-2, 4); TaskCall(7)
0x58f: Call2 0x5a6

0x590: Pop(-2, 4); TaskReturn
0x591: Pop(2)
0x592: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x593: Pop(0)
...
0x596: @ sync()
0x597: Pop(0)
0x598: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x599: Pop(0)
0x59a: GOTO 0x594

0x59b: PushEmpty(object)
0x59c: Stack[-10] = Stack[-1]
0x59d: Call2 0xe9a

0x59e: Pop(1)
0x59f: @ StopDialog(Stack[-4])
0x5a0: Pop(0)
0x5a1: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x5a2: Pop(0)
0x5a3: Stack[-2] = Stack[-10]
0x5a4: Return(); Pop(8)
...
0x5ad: Stack[-1] = "Anger" // @poff=89
0x5ae: Call2 0x5e5

0x5af: Pop(1)
0x5b0: Push((int) 525864)
0x5b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x5b2: Pop(1)
0x5b3: @@@ ClearReplies(); Obj=0 // @poff=112
0x5b4: Pop(0)
...
0x5bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x5be: Pop(3)
0x5bf: Push((int) 525874)
0x5c0: Push((int) -1)
0x5c1: Push((int) 27173)
0x5c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x5c3: Pop(3)
0x5c4: GOTO 0x5c7
...
0x5d6: Push("all") // @poff=144
0x5d7: Push("idle") // @poff=152
...
0x5df: Push("all") // @poff=144
0x5e0: Push("idle") // @poff=152
...
0x60d: Stack[-1] = "Anger" // @poff=89
0x60e: Call2 0x5e5

0x60f: Pop(1)
0x610: Push((int) 525864)
0x611: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x612: Pop(1)
0x613: @@@ ClearReplies(); Obj=0 // @poff=112
0x614: Pop(0)
...
0x61d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x61e: Pop(3)
0x61f: Push((int) 525874)
0x620: Push((int) -1)
0x621: Push((int) 27173)
0x622: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x623: Pop(3)
0x624: Return(); Pop(0)
...
0x629: Stack[-1] = "Distrust" // @poff=162
0x62a: Call2 0x5e5

0x62b: Pop(1)
0x62c: Push((int) 529065)
0x62d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x62e: Pop(1)
0x62f: @@@ ClearReplies(); Obj=0 // @poff=112
0x630: Pop(0)
0x631: Push((int) 529066)
0x632: Push((int) 27165)
0x633: Push((int) 30509)
0x634: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x635: Pop(3)
0x636: Push((int) 540766)
0x637: Push((int) 27165)
0x638: Push((int) 42809)
0x639: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x63a: Pop(3)
0x63b: Return(); Pop(0)
...
0x640: Stack[-1] = "Distrust" // @poff=162
0x641: Call2 0x5e5

0x642: Pop(1)
0x643: Push((int) 525866)
0x644: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x645: Pop(1)
0x646: @@@ ClearReplies(); Obj=0 // @poff=112
0x647: Pop(0)
0x648: Push((int) 525868)
0x649: Push((int) 27168)
0x64a: Push((int) 27167)
0x64b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x64c: Pop(3)
0x64d: Push((int) 529067)
0x64e: Push((int) 30511)
0x64f: Push((int) 30510)
0x650: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x651: Pop(3)
0x652: Return(); Pop(0)
...
0x657: Stack[-1] = "Neutral" // @poff=180
0x658: Call2 0x5e5

0x659: Pop(1)
0x65a: Push((int) 529068)
0x65b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x65c: Pop(1)
0x65d: @@@ ClearReplies(); Obj=0 // @poff=112
0x65e: Pop(0)
0x65f: Push((int) 529069)
0x660: Push((int) 27171)
0x661: Push((int) 30512)
0x662: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x663: Pop(3)
0x664: Return(); Pop(0)
...
0x669: Stack[-1] = "Anger" // @poff=89
0x66a: Call2 0x5e5

0x66b: Pop(1)
0x66c: Push((int) 525869)
0x66d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x66e: Pop(1)
0x66f: @@@ ClearReplies(); Obj=0 // @poff=112
0x670: Pop(0)
0x671: Push((int) 525870)
0x672: Push((int) 27171)
0x673: Push((int) 27169)
0x674: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x675: Pop(3)
0x676: Return(); Pop(0)
...
0x67b: Stack[-1] = "Neutral" // @poff=180
0x67c: Call2 0x5e5

0x67d: Pop(1)
0x67e: Push((int) 525872)
0x67f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x680: Pop(1)
0x681: @@@ ClearReplies(); Obj=0 // @poff=112
0x682: Pop(0)
0x683: Push((int) 525873)
0x684: Push((int) -1)
0x685: Push((int) 27172)
0x686: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x687: Pop(3)
0x688: Return(); Pop(0)
...
0x6a5: Pop(0)
0x6a6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x6a7: Pop(1)
0x6a8: PushEmpty(int)
0x6a9: Call2 0x101c

0x6aa: Pop(0)
0x6ab: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x6ac: Pop(1)
0x6ad: PushEmpty(string)
0x6ae: Call2 0x1020

0x6af: Pop(0)
0x6b0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x6b1: Pop(1)
0x6b2: PushEmpty(string)
0x6b3: Call2 0x1022

0x6b4: Pop(0)
0x6b5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x6b6: Pop(1)
0x6b7: PushEmpty(int)
0x6b8: Call2 0x1204

0x6b9: Pop(0)
0x6ba: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x6bb: Pop(1)
0x6bc: Stack[-2] = (int) -1
...
0x6ce: Stack[-6] = Stack[-1]
0x6cf: Push(-2, 4); TaskCall(9)
0x6d0: Call2 0x6e7

0x6d1: Pop(-2, 4); TaskReturn
0x6d2: Pop(2)
0x6d3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x6d4: Pop(0)
...
0x6d7: @ sync()
0x6d8: Pop(0)
0x6d9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x6da: Pop(0)
0x6db: GOTO 0x6d5

0x6dc: PushEmpty(object)
0x6dd: Stack[-10] = Stack[-1]
0x6de: Call2 0xe9a

0x6df: Pop(1)
0x6e0: @ StopDialog(Stack[-4])
0x6e1: Pop(0)
0x6e2: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x6e3: Pop(0)
0x6e4: Stack[-2] = Stack[-10]
0x6e5: Return(); Pop(8)
...
0x6ee: Stack[-1] = "Neutral" // @poff=180
0x6ef: Call2 0x735

0x6f0: Pop(1)
0x6f1: Push((int) 526481)
0x6f2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x6f3: Pop(1)
0x6f4: @@@ ClearReplies(); Obj=0 // @poff=112
0x6f5: Pop(0)
...
0x6fe: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x6ff: Pop(3)
...
0x708: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x709: Pop(3)
0x70a: Push((int) 526489)
0x70b: Push((int) -1)
0x70c: Push((int) 27755)
0x70d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x70e: Pop(3)
0x70f: Push((int) 528924)
0x710: Push((int) -1)
0x711: Push((int) 30354)
0x712: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x713: Pop(3)
0x714: GOTO 0x717
...
0x726: Push("all") // @poff=144
0x727: Push("idle") // @poff=152
...
0x72f: Push("all") // @poff=144
0x730: Push("idle") // @poff=152
...
0x78c: Stack[-1] = "Neutral" // @poff=180
0x78d: Call2 0x735

0x78e: Pop(1)
0x78f: Push((int) 526481)
0x790: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x791: Pop(1)
0x792: @@@ ClearReplies(); Obj=0 // @poff=112
0x793: Pop(0)
...
0x79c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x79d: Pop(3)
...
0x7a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7a7: Pop(3)
0x7a8: Push((int) 526489)
0x7a9: Push((int) -1)
0x7aa: Push((int) 27755)
0x7ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7ac: Pop(3)
0x7ad: Push((int) 528924)
0x7ae: Push((int) -1)
0x7af: Push((int) 30354)
0x7b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7b1: Pop(3)
0x7b2: Return(); Pop(0)
...
0x7b7: Stack[-1] = "Neutral" // @poff=180
0x7b8: Call2 0x735

0x7b9: Pop(1)
0x7ba: Push((int) 528933)
0x7bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7bc: Pop(1)
0x7bd: @@@ ClearReplies(); Obj=0 // @poff=112
0x7be: Pop(0)
0x7bf: Push((int) 528934)
0x7c0: Push((int) 27771)
0x7c1: Push((int) 30367)
0x7c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7c3: Pop(3)
0x7c4: Push((int) 541644)
0x7c5: Push((int) 43817)
0x7c6: Push((int) 43816)
0x7c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7c8: Pop(3)
0x7c9: Return(); Pop(0)
...
0x7ce: Stack[-1] = "Distrust" // @poff=162
0x7cf: Call2 0x735

0x7d0: Pop(1)
0x7d1: Push((int) 541645)
0x7d2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7d3: Pop(1)
0x7d4: @@@ ClearReplies(); Obj=0 // @poff=112
0x7d5: Pop(0)
0x7d6: Push((int) 541646)
0x7d7: Push((int) 43819)
0x7d8: Push((int) 43818)
0x7d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7da: Pop(3)
0x7db: Push((int) 541648)
0x7dc: Push((int) 43821)
0x7dd: Push((int) 43820)
0x7de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7df: Pop(3)
0x7e0: Return(); Pop(0)
...
0x7e5: Stack[-1] = "Neutral" // @poff=180
0x7e6: Call2 0x735

0x7e7: Pop(1)
0x7e8: Push((int) 541649)
0x7e9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7ea: Pop(1)
0x7eb: @@@ ClearReplies(); Obj=0 // @poff=112
0x7ec: Pop(0)
0x7ed: Push((int) 541650)
0x7ee: Push((int) 43825)
0x7ef: Push((int) 43822)
0x7f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x7f1: Pop(3)
0x7f2: Return(); Pop(0)
...
0x7f7: Stack[-1] = "Anger" // @poff=89
0x7f8: Call2 0x735

0x7f9: Pop(1)
0x7fa: Push((int) 541647)
0x7fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7fc: Pop(1)
0x7fd: @@@ ClearReplies(); Obj=0 // @poff=112
0x7fe: Pop(0)
0x7ff: Push((int) 541651)
0x800: Push((int) 43825)
0x801: Push((int) 43823)
0x802: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x803: Pop(3)
0x804: Push((int) 541652)
0x805: Push((int) -1)
0x806: Push((int) 43824)
0x807: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x808: Pop(3)
0x809: Return(); Pop(0)
...
0x80e: Stack[-1] = "Anger" // @poff=89
0x80f: Call2 0x735

0x810: Pop(1)
0x811: Push((int) 541653)
0x812: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x813: Pop(1)
0x814: @@@ ClearReplies(); Obj=0 // @poff=112
0x815: Pop(0)
0x816: Push((int) 541654)
0x817: Push((int) 27773)
0x818: Push((int) 43827)
0x819: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x81a: Pop(3)
0x81b: Push((int) 541655)
0x81c: Push((int) -1)
0x81d: Push((int) 43828)
0x81e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x81f: Pop(3)
0x820: Return(); Pop(0)
...
0x825: Stack[-1] = "Neutral" // @poff=180
0x826: Call2 0x735

0x827: Pop(1)
0x828: Push((int) 526505)
0x829: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x82a: Pop(1)
0x82b: @@@ ClearReplies(); Obj=0 // @poff=112
0x82c: Pop(0)
0x82d: Push((int) 526506)
0x82e: Push((int) 27773)
0x82f: Push((int) 27772)
0x830: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x831: Pop(3)
0x832: Return(); Pop(0)
...
0x837: Stack[-1] = "Anger" // @poff=89
0x838: Call2 0x735

0x839: Pop(1)
0x83a: Push((int) 526507)
0x83b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x83c: Pop(1)
0x83d: @@@ ClearReplies(); Obj=0 // @poff=112
0x83e: Pop(0)
0x83f: Push((int) 526508)
0x840: Push((int) 27775)
0x841: Push((int) 27774)
0x842: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x843: Pop(3)
0x844: Push((int) 541656)
0x845: Push((int) -1)
0x846: Push((int) 43830)
0x847: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x848: Pop(3)
0x849: Return(); Pop(0)
...
0x84e: Stack[-1] = "Anger" // @poff=89
0x84f: Call2 0x735

0x850: Pop(1)
0x851: Push((int) 526509)
0x852: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x853: Pop(1)
0x854: @@@ ClearReplies(); Obj=0 // @poff=112
0x855: Pop(0)
0x856: Push((int) 526510)
0x857: Push((int) 27777)
0x858: Push((int) 27776)
0x859: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x85a: Pop(3)
0x85b: Push((int) 541657)
0x85c: Push((int) 27777)
0x85d: Push((int) 43831)
0x85e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x85f: Pop(3)
0x860: Return(); Pop(0)
...
0x865: Stack[-1] = "Distrust" // @poff=162
0x866: Call2 0x735

0x867: Pop(1)
0x868: Push((int) 526511)
0x869: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x86a: Pop(1)
0x86b: @@@ ClearReplies(); Obj=0 // @poff=112
0x86c: Pop(0)
0x86d: Push((int) 526512)
0x86e: Push((int) 30368)
0x86f: Push((int) 27778)
0x870: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x871: Pop(3)
0x872: Return(); Pop(0)
...
0x877: Stack[-1] = "Neutral" // @poff=180
0x878: Call2 0x735

0x879: Pop(1)
0x87a: Push((int) 528935)
0x87b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x87c: Pop(1)
0x87d: @@@ ClearReplies(); Obj=0 // @poff=112
0x87e: Pop(0)
0x87f: Push((int) 528936)
0x880: Push((int) 30370)
0x881: Push((int) 30369)
0x882: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x883: Pop(3)
0x884: Return(); Pop(0)
...
0x889: Stack[-1] = "Neutral" // @poff=180
0x88a: Call2 0x735

0x88b: Pop(1)
0x88c: Push((int) 528937)
0x88d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x88e: Pop(1)
0x88f: @@@ ClearReplies(); Obj=0 // @poff=112
0x890: Pop(0)
0x891: Push((int) 528938)
0x892: Push((int) -1)
0x893: Push((int) 30371)
0x894: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x895: Pop(3)
0x896: Return(); Pop(0)
...
0x89b: Stack[-1] = "Jeer" // @poff=134
0x89c: Call2 0x735

0x89d: Pop(1)
0x89e: Push((int) 528925)
0x89f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x8a0: Pop(1)
0x8a1: @@@ ClearReplies(); Obj=0 // @poff=112
0x8a2: Pop(0)
0x8a3: Push((int) 528926)
0x8a4: Push((int) 30357)
0x8a5: Push((int) 30356)
0x8a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8a7: Pop(3)
0x8a8: Return(); Pop(0)
...
0x8ad: Stack[-1] = "Anger" // @poff=89
0x8ae: Call2 0x735

0x8af: Pop(1)
0x8b0: Push((int) 528927)
0x8b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x8b2: Pop(1)
0x8b3: @@@ ClearReplies(); Obj=0 // @poff=112
0x8b4: Pop(0)
0x8b5: Push((int) 528928)
0x8b6: Push((int) 27749)
0x8b7: Push((int) 30358)
0x8b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8b9: Pop(3)
0x8ba: Push((int) 528929)
0x8bb: Push((int) 27749)
0x8bc: Push((int) 30359)
0x8bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8be: Pop(3)
0x8bf: Return(); Pop(0)
...
0x8c4: Stack[-1] = "Anger" // @poff=89
0x8c5: Call2 0x735

0x8c6: Pop(1)
0x8c7: Push((int) 526483)
0x8c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x8c9: Pop(1)
0x8ca: @@@ ClearReplies(); Obj=0 // @poff=112
0x8cb: Pop(0)
0x8cc: Push((int) 526484)
0x8cd: Push((int) 27751)
0x8ce: Push((int) 27750)
0x8cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8d0: Pop(3)
0x8d1: Return(); Pop(0)
...
0x8d6: Stack[-1] = "Neutral" // @poff=180
0x8d7: Call2 0x735

0x8d8: Pop(1)
0x8d9: Push((int) 526485)
0x8da: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x8db: Pop(1)
0x8dc: @@@ ClearReplies(); Obj=0 // @poff=112
0x8dd: Pop(0)
0x8de: Push((int) 526486)
0x8df: Push((int) 27753)
0x8e0: Push((int) 27752)
0x8e1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8e2: Pop(3)
0x8e3: Push((int) 528930)
0x8e4: Push((int) 30363)
0x8e5: Push((int) 30362)
0x8e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8e7: Pop(3)
0x8e8: Return(); Pop(0)
...
0x8ed: Stack[-1] = "Neutral" // @poff=180
0x8ee: Call2 0x735

0x8ef: Pop(1)
0x8f0: Push((int) 528931)
0x8f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x8f2: Pop(1)
0x8f3: @@@ ClearReplies(); Obj=0 // @poff=112
0x8f4: Pop(0)
0x8f5: Push((int) 528932)
0x8f6: Push((int) 27753)
0x8f7: Push((int) 30364)
0x8f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8f9: Pop(3)
0x8fa: Return(); Pop(0)
...
0x8ff: Stack[-1] = "Neutral" // @poff=180
0x900: Call2 0x735

0x901: Pop(1)
0x902: Push((int) 526487)
0x903: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x904: Pop(1)
0x905: @@@ ClearReplies(); Obj=0 // @poff=112
0x906: Pop(0)
0x907: Push((int) 526488)
0x908: Push((int) 30348)
0x909: Push((int) 27754)
0x90a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x90b: Pop(3)
0x90c: Return(); Pop(0)
...
0x911: Stack[-1] = "Neutral" // @poff=180
0x912: Call2 0x735

0x913: Pop(1)
0x914: Push((int) 528918)
0x915: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x916: Pop(1)
0x917: @@@ ClearReplies(); Obj=0 // @poff=112
0x918: Pop(0)
0x919: Push((int) 528919)
0x91a: Push((int) 30350)
0x91b: Push((int) 30349)
0x91c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x91d: Pop(3)
0x91e: Return(); Pop(0)
...
0x923: Stack[-1] = "Distrust" // @poff=162
0x924: Call2 0x735

0x925: Pop(1)
0x926: Push((int) 528920)
0x927: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x928: Pop(1)
0x929: @@@ ClearReplies(); Obj=0 // @poff=112
0x92a: Pop(0)
0x92b: Push((int) 528921)
0x92c: Push((int) -1)
0x92d: Push((int) 30351)
0x92e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x92f: Pop(3)
0x930: Return(); Pop(0)
...
0x94d: Pop(0)
0x94e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x94f: Pop(1)
0x950: PushEmpty(int)
0x951: Call2 0x101c

0x952: Pop(0)
0x953: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x954: Pop(1)
0x955: PushEmpty(string)
0x956: Call2 0x1020

0x957: Pop(0)
0x958: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x959: Pop(1)
0x95a: PushEmpty(string)
0x95b: Call2 0x1022

0x95c: Pop(0)
0x95d: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x95e: Pop(1)
0x95f: PushEmpty(int)
0x960: Call2 0x1204

0x961: Pop(0)
0x962: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x963: Pop(1)
0x964: Stack[-2] = (int) -1
...
0x970: Stack[-1] = Stack[-2]
0x971: Pop(1)
0x972: Call2 0xeac

0x973: Pop(2)
0x974: PushEmpty(object, object)
0x975: Stack[-11] = Stack[-2]
0x976: Stack[-6] = Stack[-1]
0x977: Push(-2, 4); TaskCall(11)
0x978: Call2 0x98f

0x979: Pop(-2, 4); TaskReturn
0x97a: Pop(2)
0x97b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x97c: Pop(0)
...
0x97f: @ sync()
0x980: Pop(0)
0x981: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x982: Pop(0)
0x983: GOTO 0x97d

0x984: PushEmpty(object)
0x985: Stack[-10] = Stack[-1]
0x986: Call2 0xe9a

0x987: Pop(1)
0x988: @ StopDialog(Stack[-4])
0x989: Pop(0)
0x98a: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x98b: Pop(0)
0x98c: Stack[-2] = Stack[-10]
0x98d: Return(); Pop(8)
...
0x996: Stack[-1] = "Neutral" // @poff=180
0x997: Call2 0x9e9

0x998: Pop(1)
0x999: Push((int) 526953)
0x99a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x99b: Pop(1)
0x99c: @@@ ClearReplies(); Obj=0 // @poff=112
0x99d: Pop(0)
...
0x9ad: IF (Stack[-1] == 1) GOTO 0x9bd; Pop(1)
...
0x9bb: IF (Stack[-1] == 1) GOTO 0x9bd; Pop(1)
...
0x9c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x9c2: Pop(3)
0x9c3: Push((int) 526957)
0x9c4: Push((int) -1)
0x9c5: Push((int) 28249)
0x9c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x9c7: Pop(3)
0x9c8: GOTO 0x9cb
...
0x9da: Push("all") // @poff=144
0x9db: Push("idle") // @poff=152
...
0x9e3: Push("all") // @poff=144
0x9e4: Push("idle") // @poff=152
...
0xa11: Stack[-1] = "Neutral" // @poff=180
0xa12: Call2 0x9e9

0xa13: Pop(1)
0xa14: Push((int) 526953)
0xa15: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa16: Pop(1)
0xa17: @@@ ClearReplies(); Obj=0 // @poff=112
0xa18: Pop(0)
...
0xa28: IF (Stack[-1] == 1) GOTO 0xa38; Pop(1)
...
0xa36: IF (Stack[-1] == 1) GOTO 0xa38; Pop(1)
...
0xa3c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa3d: Pop(3)
0xa3e: Push((int) 526957)
0xa3f: Push((int) -1)
0xa40: Push((int) 28249)
0xa41: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa42: Pop(3)
0xa43: Return(); Pop(0)
...
0xa48: Stack[-1] = "Neutral" // @poff=180
0xa49: Call2 0x9e9

0xa4a: Pop(1)
0xa4b: Push((int) 527972)
0xa4c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa4d: Pop(1)
0xa4e: @@@ ClearReplies(); Obj=0 // @poff=112
0xa4f: Pop(0)
0xa50: Push((int) 527977)
0xa51: Push((int) 29339)
0xa52: Push((int) 29335)
0xa53: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa54: Pop(3)
0xa55: Push((int) 527978)
0xa56: Push((int) 29337)
0xa57: Push((int) 29336)
0xa58: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa59: Pop(3)
0xa5a: Return(); Pop(0)
...
0xa5f: Stack[-1] = "Neutral" // @poff=180
0xa60: Call2 0x9e9

0xa61: Pop(1)
0xa62: Push((int) 527979)
0xa63: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa64: Pop(1)
0xa65: @@@ ClearReplies(); Obj=0 // @poff=112
0xa66: Pop(0)
0xa67: Push((int) 527980)
0xa68: Push((int) 29339)
0xa69: Push((int) 29338)
0xa6a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa6b: Pop(3)
0xa6c: Return(); Pop(0)
...
0xa71: Stack[-1] = "Distrust" // @poff=162
0xa72: Call2 0x9e9

0xa73: Pop(1)
0xa74: Push((int) 527981)
0xa75: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa76: Pop(1)
0xa77: @@@ ClearReplies(); Obj=0 // @poff=112
0xa78: Pop(0)
0xa79: Push((int) 527982)
0xa7a: Push((int) 29341)
0xa7b: Push((int) 29340)
0xa7c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa7d: Pop(3)
0xa7e: Return(); Pop(0)
...
0xa83: Stack[-1] = "Distrust" // @poff=162
0xa84: Call2 0x9e9

0xa85: Pop(1)
0xa86: Push((int) 527983)
0xa87: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa88: Pop(1)
0xa89: @@@ ClearReplies(); Obj=0 // @poff=112
0xa8a: Pop(0)
0xa8b: Push((int) 527988)
0xa8c: Push((int) 29347)
0xa8d: Push((int) 29346)
0xa8e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa8f: Pop(3)
0xa90: Push((int) 527990)
0xa91: Push((int) 29349)
0xa92: Push((int) 29348)
0xa93: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa94: Pop(3)
0xa95: Return(); Pop(0)
...
0xa9a: Stack[-1] = "Anger" // @poff=89
0xa9b: Call2 0x9e9

0xa9c: Pop(1)
0xa9d: Push((int) 527991)
0xa9e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xa9f: Pop(1)
0xaa0: @@@ ClearReplies(); Obj=0 // @poff=112
0xaa1: Pop(0)
0xaa2: Push((int) 527992)
0xaa3: Push((int) 28247)
0xaa4: Push((int) 29350)
0xaa5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xaa6: Pop(3)
0xaa7: Return(); Pop(0)
...
0xaac: Stack[-1] = "Neutral" // @poff=180
0xaad: Call2 0x9e9

0xaae: Pop(1)
0xaaf: Push((int) 527989)
0xab0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xab1: Pop(1)
0xab2: @@@ ClearReplies(); Obj=0 // @poff=112
0xab3: Pop(0)
0xab4: Push((int) 527984)
0xab5: Push((int) 28247)
0xab6: Push((int) 29342)
0xab7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xab8: Pop(3)
0xab9: Push((int) 527986)
0xaba: Push((int) 29345)
0xabb: Push((int) 29344)
0xabc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xabd: Pop(3)
0xabe: Return(); Pop(0)
...
0xac3: Stack[-1] = "Neutral" // @poff=180
0xac4: Call2 0x9e9

0xac5: Pop(1)
0xac6: Push((int) 527987)
0xac7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xac8: Pop(1)
0xac9: @@@ ClearReplies(); Obj=0 // @poff=112
0xaca: Pop(0)
0xacb: Push((int) 527993)
0xacc: Push((int) 28247)
0xacd: Push((int) 29352)
0xace: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xacf: Pop(3)
0xad0: Return(); Pop(0)
...
0xad5: Stack[-1] = "Neutral" // @poff=180
0xad6: Call2 0x9e9

0xad7: Pop(1)
0xad8: Push((int) 526955)
0xad9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xada: Pop(1)
0xadb: @@@ ClearReplies(); Obj=0 // @poff=112
0xadc: Pop(0)
0xadd: Push((int) 526956)
0xade: Push((int) 29354)
0xadf: Push((int) 28248)
0xae0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xae1: Pop(3)
0xae2: Return(); Pop(0)
...
0xae7: Stack[-1] = "Distrust" // @poff=162
0xae8: Call2 0x9e9

0xae9: Pop(1)
0xaea: Push((int) 527994)
0xaeb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xaec: Pop(1)
0xaed: @@@ ClearReplies(); Obj=0 // @poff=112
0xaee: Pop(0)
0xaef: Push((int) 527995)
0xaf0: Push((int) 29362)
0xaf1: Push((int) 29355)
0xaf2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xaf3: Pop(3)
0xaf4: Push((int) 527996)
0xaf5: Push((int) 29357)
0xaf6: Push((int) 29356)
0xaf7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xaf8: Pop(3)
0xaf9: Return(); Pop(0)
...
0xafe: Stack[-1] = "Anger" // @poff=89
0xaff: Call2 0x9e9

0xb00: Pop(1)
0xb01: Push((int) 527997)
0xb02: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xb03: Pop(1)
0xb04: @@@ ClearReplies(); Obj=0 // @poff=112
0xb05: Pop(0)
0xb06: Push((int) 527998)
0xb07: Push((int) -1)
0xb08: Push((int) 29358)
0xb09: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xb0a: Pop(3)
0xb0b: Push((int) 527999)
0xb0c: Push((int) -1)
0xb0d: Push((int) 29359)
0xb0e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xb0f: Pop(3)
0xb10: Return(); Pop(0)
...
0xb15: Stack[-1] = "Distrust" // @poff=162
0xb16: Call2 0x9e9

0xb17: Pop(1)
0xb18: Push((int) 528002)
0xb19: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xb1a: Pop(1)
0xb1b: @@@ ClearReplies(); Obj=0 // @poff=112
0xb1c: Pop(0)
0xb1d: Push((int) 528003)
0xb1e: Push((int) 29364)
0xb1f: Push((int) 29363)
0xb20: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xb21: Pop(3)
0xb22: Return(); Pop(0)
...
0xb27: Stack[-1] = "Grin" // @poff=196
0xb28: Call2 0x9e9

0xb29: Pop(1)
0xb2a: Push((int) 528004)
0xb2b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xb2c: Pop(1)
0xb2d: @@@ ClearReplies(); Obj=0 // @poff=112
0xb2e: Pop(0)
0xb2f: Push((int) 528005)
0xb30: Push((int) -1)
0xb31: Push((int) 29365)
0xb32: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xb33: Pop(3)
0xb34: Return(); Pop(0)
...
0xb51: Pop(0)
0xb52: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xb53: Pop(1)
0xb54: PushEmpty(int)
0xb55: Call2 0x101c

0xb56: Pop(0)
0xb57: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xb58: Pop(1)
0xb59: PushEmpty(string)
0xb5a: Call2 0x1020

0xb5b: Pop(0)
0xb5c: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xb5d: Pop(1)
0xb5e: PushEmpty(string)
0xb5f: Call2 0x1022

0xb60: Pop(0)
0xb61: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xb62: Pop(1)
0xb63: PushEmpty(int)
0xb64: Call2 0x1204

0xb65: Pop(0)
0xb66: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xb67: Pop(1)
0xb68: Stack[-2] = (int) -1
...
0xb79: Stack[-11] = Stack[-2]
0xb7a: Stack[-6] = Stack[-1]
0xb7b: Push(-2, 4); TaskCall(13)
0xb7c: Call2 0xb93

0xb7d: Pop(-2, 4); TaskReturn
0xb7e: Pop(2)
0xb7f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xb80: Pop(0)
...
0xb83: @ sync()
0xb84: Pop(0)
0xb85: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xb86: Pop(0)
0xb87: GOTO 0xb81

0xb88: PushEmpty(object)
0xb89: Stack[-10] = Stack[-1]
0xb8a: Call2 0xe9a

0xb8b: Pop(1)
0xb8c: @ StopDialog(Stack[-4])
0xb8d: Pop(0)
0xb8e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0xb8f: Pop(0)
0xb90: Stack[-2] = Stack[-10]
0xb91: Return(); Pop(8)
...
0xb9a: Stack[-1] = "Neutral" // @poff=180
0xb9b: Call2 0xbd2

0xb9c: Pop(1)
0xb9d: Push((int) 535231)
0xb9e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xb9f: Pop(1)
0xba0: @@@ ClearReplies(); Obj=0 // @poff=112
0xba1: Pop(0)
0xba2: Push((int) 535232)
0xba3: Push((int) 36953)
0xba4: Push((int) 36907)
0xba5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xba6: Pop(3)
0xba7: Push((int) 535233)
0xba8: Push((int) -1)
0xba9: Push((int) 36908)
0xbaa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xbab: Pop(3)
0xbac: Push((int) 535280)
0xbad: Push((int) -1)
0xbae: Push((int) 36956)
0xbaf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xbb0: Pop(3)
0xbb1: GOTO 0xbb4
...
0xbc3: Push("all") // @poff=144
0xbc4: Push("idle") // @poff=152
...
0xbcc: Push("all") // @poff=144
0xbcd: Push("idle") // @poff=152
...
0xbf2: Stack[-1] = "Neutral" // @poff=180
0xbf3: Call2 0xbd2

0xbf4: Pop(1)
0xbf5: Push((int) 535231)
0xbf6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xbf7: Pop(1)
0xbf8: @@@ ClearReplies(); Obj=0 // @poff=112
0xbf9: Pop(0)
0xbfa: Push((int) 535232)
0xbfb: Push((int) 36953)
0xbfc: Push((int) 36907)
0xbfd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xbfe: Pop(3)
0xbff: Push((int) 535233)
0xc00: Push((int) -1)
0xc01: Push((int) 36908)
0xc02: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc03: Pop(3)
0xc04: Push((int) 535280)
0xc05: Push((int) -1)
0xc06: Push((int) 36956)
0xc07: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc08: Pop(3)
0xc09: Return(); Pop(0)
...
0xc0e: Stack[-1] = "Neutral" // @poff=180
0xc0f: Call2 0xbd2

0xc10: Pop(1)
0xc11: Push((int) 535277)
0xc12: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xc13: Pop(1)
0xc14: @@@ ClearReplies(); Obj=0 // @poff=112
0xc15: Pop(0)
0xc16: Push((int) 535278)
0xc17: Push((int) 36957)
0xc18: Push((int) 36954)
0xc19: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc1a: Pop(3)
0xc1b: Push((int) 535279)
0xc1c: Push((int) 36957)
0xc1d: Push((int) 36955)
0xc1e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc1f: Pop(3)
0xc20: Return(); Pop(0)
...
0xc25: Stack[-1] = "Neutral" // @poff=180
0xc26: Call2 0xbd2

0xc27: Pop(1)
0xc28: Push((int) 535281)
0xc29: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xc2a: Pop(1)
0xc2b: @@@ ClearReplies(); Obj=0 // @poff=112
0xc2c: Pop(0)
0xc2d: Push((int) 535282)
0xc2e: Push((int) -1)
0xc2f: Push((int) 36958)
0xc30: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc31: Pop(3)
0xc32: Push((int) 535283)
0xc33: Push((int) -1)
0xc34: Push((int) 36959)
0xc35: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xc36: Pop(3)
0xc37: Return(); Pop(0)
...
0xc54: Pop(0)
0xc55: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xc56: Pop(1)
0xc57: PushEmpty(int)
0xc58: Call2 0x101c

0xc59: Pop(0)
0xc5a: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xc5b: Pop(1)
0xc5c: PushEmpty(string)
0xc5d: Call2 0x1020

0xc5e: Pop(0)
0xc5f: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xc60: Pop(1)
0xc61: PushEmpty(string)
0xc62: Call2 0x1022

0xc63: Pop(0)
0xc64: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xc65: Pop(1)
0xc66: PushEmpty(int)
0xc67: Call2 0x1204

0xc68: Pop(0)
0xc69: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xc6a: Pop(1)
0xc6b: Stack[-2] = (int) -1
...
0xc77: Stack[-1] = Stack[-2]
0xc78: Pop(1)
0xc79: Call2 0xeac

0xc7a: Pop(2)
0xc7b: PushEmpty(object, object)
0xc7c: Stack[-11] = Stack[-2]
0xc7d: Stack[-6] = Stack[-1]
0xc7e: Push(-2, 4); TaskCall(15)
0xc7f: Call2 0xc96

0xc80: Pop(-2, 4); TaskReturn
0xc81: Pop(2)
0xc82: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xc83: Pop(0)
...
0xc86: @ sync()
0xc87: Pop(0)
0xc88: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xc89: Pop(0)
0xc8a: GOTO 0xc84

0xc8b: PushEmpty(object)
0xc8c: Stack[-10] = Stack[-1]
0xc8d: Call2 0xe9a

0xc8e: Pop(1)
0xc8f: @ StopDialog(Stack[-4])
0xc90: Pop(0)
0xc91: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0xc92: Pop(0)
0xc93: Stack[-2] = Stack[-10]
0xc94: Return(); Pop(8)
...
0xc9d: Stack[-1] = "Neutral" // @poff=180
0xc9e: Call2 0xcd0

0xc9f: Pop(1)
0xca0: Push((int) 540545)
0xca1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xca2: Pop(1)
0xca3: @@@ ClearReplies(); Obj=0 // @poff=112
0xca4: Pop(0)
0xca5: Push((int) 540546)
0xca6: Push((int) -1)
0xca7: Push((int) 42555)
0xca8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xca9: Pop(3)
0xcaa: Push((int) 540798)
0xcab: Push((int) -1)
0xcac: Push((int) 42847)
0xcad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xcae: Pop(3)
0xcaf: GOTO 0xcb2
...
0xcc1: Push("all") // @poff=144
0xcc2: Push("idle") // @poff=152
...
0xcca: Push("all") // @poff=144
0xccb: Push("idle") // @poff=152
...
0xcf0: Stack[-1] = "Neutral" // @poff=180
0xcf1: Call2 0xcd0

0xcf2: Pop(1)
0xcf3: Push((int) 540545)
0xcf4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xcf5: Pop(1)
0xcf6: @@@ ClearReplies(); Obj=0 // @poff=112
0xcf7: Pop(0)
0xcf8: Push((int) 540546)
0xcf9: Push((int) -1)
0xcfa: Push((int) 42555)
0xcfb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xcfc: Pop(3)
0xcfd: Push((int) 540798)
0xcfe: Push((int) -1)
0xcff: Push((int) 42847)
0xd00: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xd01: Pop(3)
0xd02: Return(); Pop(0)
...
0xd2e: Stack[-3] = Stack[-1]
0xd2f: Call2 0xe47

0xd30: Stack[-2] = Stack[-5]
0xd31: Pop(2)
0xd32: Return(); Pop(2)

0xd33: Stack[-1] = 0
0xd34: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xd35: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0xd36: @ RotateAsync(Stack[-2], Stack[-1])
0xd37: Pop(2)
0xd38: Return(); Pop(0)

0xd39: PushEmpty(object, bool, object, bool)
0xd3a: Push("player") // @poff=206
...
0xd97: Stack[-1] = "Neutral" // @poff=180
0xd98: Call2 0xf36
...
0xda6: Stack[-1] = "Neutral" // @poff=180
0xda7: Call2 0xf36
...
0xdb9: Stack[-4] = Stack[-1]
0xdba: Call2 0x1215

0xdbb: Pop(1)
0xdbc: PushEmpty(string)
0xdbd: Stack[-1] = "Neutral" // @poff=180
0xdbe: Call2 0xf36
...
0xdf1: Stack[-3] = (int) 0
0xdf2: Push("all") // @poff=144
0xdf3: PushEmpty(string, int)
0xdf4: Stack[-6] = Stack[-1]
0xdf5: Call2 0x1004
...
0xe15: Pop(0)
0xe16: @@ GetPosition(Stack[-2]); Obj=7 // @poff=220
0xe17: Pop(0)
...
0xe1c: Push("HasProperty") // @poff=232
0xe1d: Push((int) 2)
...
0xe23: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=256
0xe24: Pop(0)
...
0xe29: Stack[-10] = Stack[-2]
0xe2a: Stack[-9] = Stack[-1]
0xe2b: Call2 0xe1b
...
0xe31: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=268
0xe32: Pop(0)
0xe33: PushEmpty(float, float, float, float)
0xe34: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xe35: Stack[-8] = Stack[-2]
0xe36: Stack[-7] = Stack[-1]
0xe37: Call2 0xf7b

0xe38: Pop(3)
0xe39: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=280
0xe3a: Pop(1)
...
0xe48: @@ GetPosition(Stack[-1]); Obj=3 // @poff=220
0xe49: Pop(0)
0xe4a: PushEmpty(bool, cvector)
0xe4b: Stack[-3] = Stack[-1]
0xe4c: Call2 0xe3d

0xe4d: Stack[-2] = Stack[-6]
0xe4e: Pop(2)
0xe4f: Return(); Pop(2)
...
0xe56: @@ GetPosition(Stack[-8]); Obj=20 // @poff=220
0xe57: Pop(0)
0xe58: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=292
0xe59: Pop(0)
...
0xec5: Push("voice_common") // @poff=316
0xec6: Push((int) 1)
...
0xecd: Push("voice_common") // @poff=316
0xece: Push((int) 0)
...
0xee0: Push("voice_common") // @poff=316
0xee1: Push((int) 1)
...
0xeee: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=256
0xeef: Pop(1)
...
0xf19: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=256
0xf1a: Pop(1)
...
0xf2e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=268
0xf2f: Pop(1)
0xf30: PushEmpty(bool, string)
0xf31: Stack[-3] = Stack[-1]
0xf32: Call2 0xf55

0xf33: Stack[-2] = Stack[-14]
0xf34: Pop(2)
0xf35: Return(); Pop(10)
...
0xf41: Push("Can't find lsh animation : ") // @poff=350
...
0xf50: Push("Can't find lsh animation : ") // @poff=350
...
0xf74: Push((float)9.999999974752427e-07)
...
0xf82: Stack[-1] = Stack[-4]
0xf83: Return(); Pop(0)

0xf84: Stack[-3] = Stack[-4]
0xf85: Return(); Pop(0)
...
0xf8d: Pop(0)
0xf8e: @@ add(Stack[-4]); Obj=1 // @poff=406
0xf8f: Pop(0)
0xf90: @@ add(Stack[-3]); Obj=1 // @poff=406
0xf91: Pop(0)
0xf92: Push((int) 3)
...
0xf98: @@ GetItemID(Stack[-3]); Obj=8 // @poff=410
0xf99: Pop(0)
0xf9a: Push("Category") // @poff=420
0xf9b: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xf9c: Pop(1)
0xf9d: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=438
0xf9e: Pop(0)
0xf9f: Pop(0); Push((bool) Stack[-1] == 0)
0xfa0: IF (Stack[-1] == 0) GOTO 0xfa4; Pop(1)

0xfa1: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=446
0xfa2: Pop(0)
0xfa3: GOTO 0xfa9

0xfa4: PushEmpty(int, int)
0xfa5: Stack[-5] = Stack[-2]
0xfa6: Stack[-9] = Stack[-1]
0xfa7: Call2 0xf8b
...
0xfac: Pop(0)
0xfad: @@ SetItemName(Stack[-4]); Obj=1 // @poff=456
0xfae: Pop(0)
0xfaf: PushEmpty(object, object, int)
0xfb0: Stack[-8] = Stack[-3]
0xfb1: Stack[-4] = Stack[-2]
0xfb2: Stack[-6] = Stack[-1]
0xfb3: Call2 0xf97
...
0xfcd: Stack[-2] = Stack[-1]
0xfce: Call2 0xfda

0xfcf: Pop(1)
0xfd0: PushEmpty(bool, object, string, float, float, float)
0xfd1: Stack[-8] = Stack[-5]
0xfd2: Stack[-4] = "reputation" // @poff=468
0xfd3: Stack[-7] = Stack[-3]
0xfd4: Stack[-2] = (int) 0
0xfd5: Stack[-1] = (int) 1
0xfd6: Call2 0xe27
...
0xfdc: Pop(0)
0xfdd: @@ add(Stack[-3]); Obj=1 // @poff=406
0xfde: Pop(0)
0xfdf: Push((int) 16)
...
0xfe6: Pop(0)
0xfe7: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x1020: Stack[-1] = "ui/NPC_Georg.png" // @poff=490
0x1021: Return(); Pop(0)

0x1022: Stack[-1] = "ui/NPC_Georg_b.png" // @poff=524
0x1023: Return(); Pop(0)
...
0x102d: Stack[-1] = Stack[-2]
0x102e: Pop(1)
0x102f: Push("k1q02GeorgGotoMaria") // @poff=574
0x1030: Push("pt_map_maria") // @poff=614
0x1031: Push((int) 0)
...
0x1035: Pop(0)
0x1036: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=640
0x1037: Pop(5)
0x1038: PushEmpty()
0x1039: Call2 0x115b
...
0x1046: PushEmpty()
0x1047: Push("beta_pills 5 is given") // @poff=648
0x1048: @ Trace(Stack[-1])
0x1049: Pop(1)
0x104a: PushEmpty(object, string, int)
0x104b: Stack[-5] = Stack[-3]
0x104c: Stack[-2] = "beta_pills" // @poff=692
...
0x1051: PushEmpty()
0x1052: Push("ook3Georg1") // @poff=714
0x1053: Push((int) 1)
...
0x1060: PushEmpty()
0x1061: Push("ook10Georg1") // @poff=748
0x1062: Push((int) 1)
...
0x106f: Stack[-2] = "quest_k9_01" // @poff=784
0x1070: Stack[-1] = "init_termitnik2" // @poff=808
0x1071: Call2 0xfe4
...
0x107d: PushEmpty()
0x107e: Push("ook1Georg1") // @poff=840
0x107f: Push((int) 1)
...
0x108c: PushEmpty()
0x108d: Push("raincoat_repel is given") // @poff=862
0x108e: @ Trace(Stack[-1])
0x108f: Pop(1)
0x1090: PushEmpty(object, string, int)
0x1091: Stack[-5] = Stack[-3]
0x1092: Stack[-2] = "raincoat_repel" // @poff=910
...
0x109c: Stack[-2] = "quest_k9_01" // @poff=784
0x109d: Stack[-1] = "fail" // @poff=940
0x109e: Call2 0xfe4
...
0x10a1: PushEmpty()
0x10a2: Push("revolver ammo6 is given") // @poff=950
0x10a3: @ Trace(Stack[-1])
0x10a4: Pop(1)
0x10a5: PushEmpty(object, string, int)
0x10a6: Stack[-5] = Stack[-3]
0x10a7: Stack[-2] = "revolver_ammo" // @poff=998
...
0x10ae: Stack[-5] = Stack[-2]
0x10af: Stack[-1] = (float) -0.30000001192092896
0x10b0: Call2 0xfb7
...
0x10bf: Pop(1)
0x10c0: Stack[-2] = "pt_map_maria" // @poff=614
...
0x10c6: Pop(0)
0x10c7: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1026
0x10c8: Pop(1)
0x10c9: Return(); Pop(0)

0x10ca: PushEmpty()
0x10cb: PushEmpty(int, string)
0x10cc: Stack[-1] = "k1q02" // @poff=562
0x10cd: Call2 0xf86
...
0x10e4: Stack[-1] = "k3q03" // @poff=1034
0x10e5: Call2 0xf86
...
0x10f0: Stack[-1] = "ook3Georg1" // @poff=714
0x10f1: Call2 0xf86
...
0x1108: Stack[-1] = "k10q01" // @poff=1046
0x1109: Call2 0xf86
...
0x1114: Stack[-1] = "k10q01" // @poff=1046
0x1115: Call2 0xf86
...
0x1120: Stack[-1] = "ook10Georg1" // @poff=748
0x1121: Call2 0xf86
...
0x1144: Stack[-1] = "ook1Georg1" // @poff=840
0x1145: Call2 0xf86
...
0x11ae: Push("Can't retrieve diary root") // @poff=1060
0x11af: @ Trace(Stack[-1])
0x11b0: Pop(1)
0x11b1: Stack[-3] = (bool) 0
0x11b2: Return(); Pop(2)

0x11b3: Stack[-1] = Stack[-3]
0x11b4: Return(); Pop(2)
...
0x11b9: Stack[-1] = Stack[-4]
0x11ba: Pop(1)
0x11bb: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1112
0x11bc: Pop(0)
0x11bd: Pop(0); Push((bool) Stack[-2] == 0)
0x11be: IF (Stack[-1] == 0) GOTO 0x11c5; Pop(1)

0x11bf: Push("Can't find diary parent with id: ") // @poff=1117
...
0x11c5: @@ AddChild(Stack[-8]); Obj=2 // @poff=1185
0x11c6: Pop(0)
0x11c7: Push((int) 7)
0x11c8: @ SendWorldWndMessage(Stack[-1])
0x11c9: Pop(1)
0x11ca: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1194
0x11cb: Pop(0)
...
0x11d4: Pop(0)
0x11d5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x11d6: IF (Stack[-1] == 0) GOTO 0x11dd; Pop(1)

0x11d7: Push("Can't find main outdoor scene") // @poff=1206
...
0x11dd: @@ GetMap(Stack[-1]); Obj=2 // @poff=1266
0x11de: Pop(0)
0x11df: Stack[-1] = Stack[-5]
0x11e0: Return(); Pop(4)
...
0x11e5: Pop(0)
0x11e6: Pop(0); PushNull((bool) Stack[-2] == 0)
0x11e7: IF (Stack[-1] == 0) GOTO 0x11ec; Pop(1)

0x11e8: Push("Can't find main outdoor scene") // @poff=1206
0x11e9: @ Trace(Stack[-1])
0x11ea: Pop(1)
0x11eb: Return(); Pop(8)

0x11ec: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1273
0x11ed: Pop(0)
0x11ee: Pop(0); Push((bool) Stack[-1] == 0)
0x11ef: IF (Stack[-1] == 0) GOTO 0x11f6; Pop(1)

0x11f0: Push("Warning: outdoor scene locator ") // @poff=1284
0x11f1: Pop(1); Push(Stack[-1] + Stack[-11]);
0x11f2: Push(" doesnt exist") // @poff=1348
0x11f3: Pop(2); Push(Stack[-2] + Stack[-1]);
0x11f4: @ Trace(Stack[-1])
0x11f5: Pop(1)
0x11f6: @@ GetMap(Stack[-11]); Obj=2 // @poff=1266
0x11f7: Pop(0)
0x11f8: Pop(0); PushNull((bool) Stack[-11] == 0)
0x11f9: IF (Stack[-1] == 0) GOTO 0x11fe; Pop(1)

0x11fa: Push("Can't find map") // @poff=1376
...
0x1200: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1406
0x1201: Pop(2)
0x1202: Return(); Pop(8)

0x1203: Stack[-2] = 0
0x1204: PushEmpty(int, int)
0x1205: Push("branch") // @poff=1419
