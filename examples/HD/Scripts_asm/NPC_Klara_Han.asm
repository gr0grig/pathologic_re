...
Strings:
	...
	W:branch
	W:mt_han
// @pool_raw:
// @pool_encoding:utf8
...
0x13d: Stack[-1] = "Questioning" // @poff=178
0x13e: Call2 0x95
...
0x190: Pop(0)
0x191: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x192: Pop(1)
0x193: PushEmpty(int)
0x194: Call2 0x6ba

0x195: Pop(0)
0x196: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x197: Pop(1)
0x198: PushEmpty(string)
0x199: Call2 0x6be

0x19a: Pop(0)
0x19b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x19c: Pop(1)
0x19d: PushEmpty(string)
0x19e: Call2 0x6c0

0x19f: Pop(0)
0x1a0: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x1a1: Pop(1)
0x1a2: PushEmpty(int)
0x1a3: Call2 0x70f

0x1a4: Pop(0)
0x1a5: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x1a6: Pop(1)
0x1a7: Stack[-2] = (int) -1
...
0x1b8: Stack[-11] = Stack[-2]
0x1b9: Stack[-6] = Stack[-1]
...
0x1c2: @ sync()
0x1c3: Pop(0)
0x1c4: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1c5: Pop(0)
0x1c6: GOTO 0x1c0

0x1c7: PushEmpty(object)
0x1c8: Stack[-10] = Stack[-1]
0x1c9: Call2 0x5ad

0x1ca: Pop(1)
0x1cb: @ StopDialog(Stack[-4])
0x1cc: Pop(0)
0x1cd: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x1ce: Pop(0)
0x1cf: Stack[-2] = Stack[-10]
0x1d0: Return(); Pop(8)
...
0x289: Pop(0)
0x28a: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x28b: Pop(1)
0x28c: PushEmpty(int)
0x28d: Call2 0x6ba

0x28e: Pop(0)
0x28f: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x290: Pop(1)
0x291: PushEmpty(string)
0x292: Call2 0x6be

0x293: Pop(0)
0x294: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x295: Pop(1)
0x296: PushEmpty(string)
0x297: Call2 0x6c0

0x298: Pop(0)
0x299: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x29a: Pop(1)
0x29b: PushEmpty(int)
0x29c: Call2 0x70f

0x29d: Pop(0)
0x29e: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x29f: Pop(1)
0x2a0: Stack[-2] = (int) -1
...
0x2b6: Pop(2)
0x2b7: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2b8: Pop(0)
...
0x2bb: @ sync()
0x2bc: Pop(0)
0x2bd: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2be: Pop(0)
0x2bf: GOTO 0x2b9
...
0x2c5: Pop(0)
0x2c6: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2c7: Pop(0)
...
0x2fb: Push("all") // @poff=138
0x2fc: Push("idle") // @poff=146
...
0x38c: Pop(0)
0x38d: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x38e: Pop(1)
0x38f: PushEmpty(int)
0x390: Call2 0x6ba

0x391: Pop(0)
0x392: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x393: Pop(1)
0x394: PushEmpty(string)
0x395: Call2 0x6be

0x396: Pop(0)
0x397: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x398: Pop(1)
0x399: PushEmpty(string)
0x39a: Call2 0x6c0

0x39b: Pop(0)
0x39c: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x39d: Pop(1)
0x39e: PushEmpty(int)
0x39f: Call2 0x70f

0x3a0: Pop(0)
0x3a1: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x3a2: Pop(1)
0x3a3: Stack[-2] = (int) -1
...
0x3b4: Stack[-11] = Stack[-2]
0x3b5: Stack[-6] = Stack[-1]
0x3b6: Push(-2, 4); TaskCall(7)
0x3b7: Call2 0x3ce

0x3b8: Pop(-2, 4); TaskReturn
0x3b9: Pop(2)
0x3ba: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3bb: Pop(0)
...
0x3be: @ sync()
0x3bf: Pop(0)
0x3c0: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3c1: Pop(0)
0x3c2: GOTO 0x3bc

0x3c3: PushEmpty(object)
0x3c4: Stack[-10] = Stack[-1]
0x3c5: Call2 0x5ad

0x3c6: Pop(1)
0x3c7: @ StopDialog(Stack[-4])
0x3c8: Pop(0)
0x3c9: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x3ca: Pop(0)
0x3cb: Stack[-2] = Stack[-10]
0x3cc: Return(); Pop(8)
...
0x3f9: Push("all") // @poff=138
0x3fa: Push("idle") // @poff=146
...
0x402: Push("all") // @poff=138
0x403: Push("idle") // @poff=146
...
0x468: Stack[-1] = 0
0x469: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x46a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x46b: @ RotateAsync(Stack[-2], Stack[-1])
0x46c: Pop(2)
0x46d: Return(); Pop(0)

0x46e: PushEmpty(object, bool, object, bool)
0x46f: Push("player") // @poff=202
...
0x54a: Pop(0)
0x54b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=216
0x54c: Pop(0)
...
0x55b: @@ GetPosition(Stack[-1]); Obj=3 // @poff=216
0x55c: Pop(0)
0x55d: PushEmpty(bool, cvector)
0x55e: Stack[-3] = Stack[-1]
0x55f: Call2 0x550

0x560: Stack[-2] = Stack[-6]
0x561: Pop(2)
0x562: Return(); Pop(2)
...
0x569: @@ GetPosition(Stack[-8]); Obj=20 // @poff=216
0x56a: Pop(0)
0x56b: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=228
0x56c: Pop(0)
...
0x592: Pop(0)
0x593: Push((bool) 1)
0x594: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x595: Pop(1)
0x596: Push(CvectorIndex(Stack[-4], 0))
0x597: Push(CvectorIndex(Stack[-5], 2))
...
0x59f: Push("head") // @poff=242
0x5a0: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5a1: Pop(1)
0x5a2: Push(Stack[-1])
0x5a3: IF (Stack[-1] == 0) GOTO 0x5a7; Pop(1)

0x5a4: Push("head") // @poff=242
0x5a5: @ LookAsyncCamera(Stack[-1])
0x5a6: Pop(1)
0x5a7: @ CameraWaitForPlayFinish()
0x5a8: Pop(0)
0x5a9: @ ResumeWorld()
0x5aa: Pop(0)
0x5ab: Stack[-21] = (bool) 1
0x5ac: Return(); Pop(18)

0x5ad: PushEmpty(bool, bool)
0x5ae: Push((bool) 1)
0x5af: @ CameraSwitchToNormal(Stack[-1])
0x5b0: Pop(1)
...
0x5b6: Push("head") // @poff=242
0x5b7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5b8: Pop(1)
0x5b9: Push(Stack[-1])
0x5ba: IF (Stack[-1] == 0) GOTO 0x5be; Pop(1)

0x5bb: Push("head") // @poff=242
0x5bc: @ UnlookAsync(Stack[-1])
0x5bd: Pop(1)
0x5be: Return(); Pop(2)

0x5bf: PushEmpty(int, int, int, int)
0x5c0: Push("voice_common") // @poff=252
0x5c1: @ GetVariable(Stack[-1], Stack[-3])
0x5c2: Pop(1)
0x5c3: Push(Stack[-2])
0x5c4: IF (Stack[-1] == 0) GOTO 0x5e5; Pop(1)

0x5c5: PushEmpty(bool, object)
0x5c6: Stack[-7] = Stack[-1]
0x5c7: Call2 0x5f9
...
0x5d1: Stack[-6] = (bool) 0
0x5d2: Return(); Pop(4)

0x5d3: Push((int) 2)
0x5d4: @ irand(Stack[-2], Stack[-1])
0x5d5: Pop(1)
0x5d6: Push(Stack[-1])
0x5d7: IF (Stack[-1] == 0) GOTO 0x5e0; Pop(1)

0x5d8: Push("voice_common") // @poff=252
0x5d9: Push((int) 1)
0x5da: Pop(1); Push(Stack[-4] + Stack[-1]);
0x5db: Push((int) 3)
0x5dc: Pop(2); Push(Stack[-2] % Stack[-1]);
0x5dd: @ SetVariable(Stack[-2], Stack[-1])
0x5de: Pop(2)
0x5df: GOTO 0x5e4

0x5e0: Push("voice_common") // @poff=252
0x5e1: Push((int) 0)
...
0x5f1: Stack[-6] = (bool) 0
0x5f2: Return(); Pop(4)

0x5f3: Push("voice_common") // @poff=252
0x5f4: Push((int) 1)
...
0x5f9: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x5fa: Stack[-5] = "c" // @poff=278
0x5fb: Stack[-4] = (int) 0
0x5fc: Push((int) 1)
0x5fd: IF (Stack[-1] == 0) GOTO 0x609; Pop(1)

0x5fe: Push((int) 1)
0x5ff: Pop(1); Push(Stack[-5] + Stack[-1]);
0x600: Pop(1); Push(Stack[-6] + Stack[-1]);
0x601: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x602: Pop(1)
0x603: Pop(0); Push((bool) Stack[-3] == 0)
0x604: IF (Stack[-1] == 0) GOTO 0x606; Pop(1)

0x605: GOTO 0x609

0x606: Push((int) 1)
0x607: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x608: GOTO 0x5fc

0x609: Pop(0); Push((bool) Stack[-4] == 0)
0x60a: IF (Stack[-1] == 0) GOTO 0x60d; Pop(1)

0x60b: Stack[-12] = (bool) 0
0x60c: Return(); Pop(10)

0x60d: Stack[-2] = (int) 0
0x60e: Push((int) 1)
0x60f: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x610: IF (Stack[-1] == 0) GOTO 0x613; Pop(1)

0x611: @ irand(Stack[-2], Stack[-4])
0x612: Pop(0)
0x613: Push((int) 1)
0x614: Pop(1); Push(Stack[-3] + Stack[-1]);
0x615: Pop(1); Push(Stack[-6] + Stack[-1]);
0x616: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=294
0x617: Pop(1)
0x618: PushEmpty(bool, string)
0x619: Stack[-3] = Stack[-1]
0x61a: Call2 0x668

0x61b: Stack[-2] = Stack[-14]
0x61c: Pop(2)
0x61d: Return(); Pop(10)

0x61e: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x61f: Push("d") // @poff=248
0x620: PushEmpty(int)
0x621: Call2 0x693

0x622: Pop(0)
0x623: Pop(2); Push(Stack[-2] + Stack[-1]);
0x624: Push("m") // @poff=306
0x625: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x626: Stack[-4] = (int) 0
0x627: Push((int) 1)
0x628: IF (Stack[-1] == 0) GOTO 0x634; Pop(1)

0x629: Push((int) 1)
0x62a: Pop(1); Push(Stack[-5] + Stack[-1]);
0x62b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x62c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x62d: Pop(1)
0x62e: Pop(0); Push((bool) Stack[-3] == 0)
0x62f: IF (Stack[-1] == 0) GOTO 0x631; Pop(1)

0x630: GOTO 0x634

0x631: Push((int) 1)
0x632: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x633: GOTO 0x627

0x634: Pop(0); Push((bool) Stack[-4] == 0)
0x635: IF (Stack[-1] == 0) GOTO 0x638; Pop(1)

0x636: Stack[-12] = (bool) 0
0x637: Return(); Pop(10)

0x638: Stack[-2] = (int) 0
0x639: Push((int) 1)
0x63a: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x63b: IF (Stack[-1] == 0) GOTO 0x63e; Pop(1)

0x63c: @ irand(Stack[-2], Stack[-4])
0x63d: Pop(0)
0x63e: Push((int) 1)
0x63f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x640: Pop(1); Push(Stack[-6] + Stack[-1]);
0x641: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=294
0x642: Pop(1)
0x643: PushEmpty(bool, string)
0x644: Stack[-3] = Stack[-1]
0x645: Call2 0x668

0x646: Stack[-2] = Stack[-14]
0x647: Pop(2)
0x648: Return(); Pop(10)

0x649: PushEmpty(bool, float, float, bool, float, float)
0x64a: @ lshHasAnimation(Stack[-3], Stack[-7])
0x64b: Pop(0)
0x64c: Push(Stack[-3])
0x64d: IF (Stack[-1] == 0) GOTO 0x654; Pop(1)

0x64e: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x64f: Pop(0)
0x650: Push((bool) 0)
0x651: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x652: Pop(1)
0x653: GOTO 0x658

0x654: Push("Can't find lsh animation : ") // @poff=310
0x655: Pop(1); Push(Stack[-1] + Stack[-8]);
0x656: @ Trace(Stack[-1])
0x657: Pop(1)
0x658: Return(); Pop(6)

0x659: PushEmpty(bool, float, float, bool, float, float)
0x65a: @ lshHasAnimation(Stack[-3], Stack[-8])
0x65b: Pop(0)
0x65c: Push(Stack[-3])
0x65d: IF (Stack[-1] == 0) GOTO 0x663; Pop(1)

0x65e: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x65f: Pop(0)
0x660: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x661: Pop(0)
0x662: GOTO 0x667

0x663: Push("Can't find lsh animation : ") // @poff=310
0x664: Pop(1); Push(Stack[-1] + Stack[-9]);
0x665: @ Trace(Stack[-1])
0x666: Pop(1)
0x667: Return(); Pop(6)
...
0x66d: @ lshHasSpeech(Stack[-1], Stack[-3])
0x66e: Pop(0)
0x66f: Push(Stack[-1])
0x670: IF (Stack[-1] == 0) GOTO 0x675; Pop(1)

0x671: @ lshPlaySpeech(Stack[-3])
0x672: Pop(0)
0x673: Stack[-4] = (bool) 1
0x674: Return(); Pop(2)
...
0x685: Pop(0); Push(Stack[-3] | Stack[-3]);
0x686: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x687: Push((float)9.999999974752427e-07)
0x688: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x689: IF (Stack[-1] == 0) GOTO 0x68c; Pop(1)

0x68a: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x68b: Return(); Pop(2)

0x68c: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x68d: Return(); Pop(2)

0x68e: PushEmpty(int, int)
0x68f: @ GetVariable(Stack[-3], Stack[-1])
0x690: Pop(0)
0x691: Stack[-1] = Stack[-4]
0x692: Return(); Pop(2)

0x693: PushEmpty(float, float)
0x694: @ GetGameTime(Stack[-1])
0x695: Pop(0)
0x696: Push((int) 1)
0x697: PushEmpty(int)
0x698: Push((int) 24)
0x699: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x69a: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x69b: Return(); Pop(2)
...
0x69f: Pop(0)
0x6a0: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x6a1: Return(); Pop(0)

0x6a2: PushEmpty(string, string)
0x6a3: Stack[-1] = "idle" // @poff=146
0x6a4: Push(Stack[-3])
0x6a5: IF (Stack[-1] == 0) GOTO 0x6a7; Pop(1)

0x6a6: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x6a7: Stack[-1] = Stack[-4]
0x6a8: Return(); Pop(2)

0x6a9: PushEmpty(int, bool, int, bool)
0x6aa: Stack[-2] = (int) 0
0x6ab: Push("all") // @poff=138
0x6ac: PushEmpty(string, int)
0x6ad: Stack[-5] = Stack[-1]
0x6ae: Call2 0x6a2

0x6af: Pop(1)
0x6b0: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6b1: Pop(2)
...
0x6b5: Push((int) 1)
0x6b6: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6b7: GOTO 0x6ab

0x6b8: Stack[-2] = Stack[-5]
0x6b9: Return(); Pop(4)

0x6ba: Stack[-1] = (int) 515536
0x6bb: Return(); Pop(0)

0x6bc: Stack[-1] = (int) 502861
0x6bd: Return(); Pop(0)

0x6be: Stack[-1] = "ui/NPC_Han.png" // @poff=366
0x6bf: Return(); Pop(0)

0x6c0: Stack[-1] = "ui/NPC_Han_b.png" // @poff=396
0x6c1: Return(); Pop(0)
...
0x6c4: PushEmpty()
0x6c5: Push("k9q01") // @poff=430
0x6c6: Push((int) 6)
0x6c7: @ SetVariable(Stack[-2], Stack[-1])
0x6c8: Pop(2)
0x6c9: PushEmpty()
0x6ca: Call2 0x6d9
...
0x6cd: PushEmpty()
0x6ce: PushEmpty(int, string)
0x6cf: Stack[-1] = "k9q01" // @poff=430
0x6d0: Call2 0x68e
...
0x6d7: Stack[-2] = (bool) 0
0x6d8: Return(); Pop(0)

0x6d9: PushEmpty(object, object)
0x6da: Push((int) 523)
0x6db: Push((int) 1)
0x6dc: Push((int) 529815)
0x6dd: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6de: Pop(3)
0x6df: PushEmpty(bool, object, int)
0x6e0: Stack[-4] = Stack[-2]
0x6e1: Stack[-1] = (int) 517
0x6e2: Call2 0x6f3
...
0x6e7: @ GetDiaryRoot(Stack[-1])
0x6e8: Pop(0)
0x6e9: Pop(0); Push((bool) Stack[-1] == 0)
0x6ea: IF (Stack[-1] == 0) GOTO 0x6f0; Pop(1)

0x6eb: Push("Can't retrieve diary root") // @poff=442
0x6ec: @ Trace(Stack[-1])
0x6ed: Pop(1)
0x6ee: Stack[-3] = (bool) 0
0x6ef: Return(); Pop(2)
...
0x6f2: Stack[-1] = 0
0x6f3: PushEmpty(object, object, int, object, object, int)
0x6f4: PushEmpty(object)
0x6f5: Call2 0x6e6

0x6f6: Stack[-1] = Stack[-4]
0x6f7: Pop(1)
0x6f8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=494
0x6f9: Pop(0)
0x6fa: Pop(0); Push((bool) Stack[-2] == 0)
0x6fb: IF (Stack[-1] == 0) GOTO 0x702; Pop(1)

0x6fc: Push("Can't find diary parent with id: ") // @poff=499
0x6fd: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6fe: @ Trace(Stack[-1])
0x6ff: Pop(1)
0x700: Stack[-9] = (bool) 0
0x701: Return(); Pop(6)

0x702: @@ AddChild(Stack[-8]); Obj=2 // @poff=567
0x703: Pop(0)
0x704: Push((int) 7)
0x705: @ SendWorldWndMessage(Stack[-1])
0x706: Pop(1)
0x707: @@ GetCategory(Stack[-1]); Obj=8 // @poff=576
0x708: Pop(0)
0x709: @ SetDiarySection(Stack[-1])
0x70a: Pop(0)
0x70b: Stack[-9] = (bool) 0
0x70c: Return(); Pop(6)

0x70d: Stack[-2] = 0
0x70e: Stack[-3] = 0
0x70f: PushEmpty(int, int)
0x710: Push("branch") // @poff=588
0x711: @ GetVariable(Stack[-1], Stack[-2])
0x712: Pop(1)
0x713: Push((int) 0)
...
0x719: Push((int) 1)
0x71a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x720: PushEmpty(int, int)
0x721: Push("mt_han") // @poff=602
0x722: @ GetVariable(Stack[-1], Stack[-2])
0x723: Pop(1)
0x724: Pop(0); Push((bool) Stack[-1] == 0)
0x725: IF (Stack[-1] == 0) GOTO 0x730; Pop(1)

0x726: PushEmpty(int, object)
0x727: Stack[-5] = Stack[-1]
0x728: Push(-2, 1); TaskCall(2)
0x729: Call2 0x181

0x72a: Pop(-2, 1); TaskReturn
0x72b: Pop(2)
0x72c: Push("mt_han") // @poff=602
0x72d: Push((int) 1)
0x72e: @ SetVariable(Stack[-2], Stack[-1])
0x72f: Pop(2)
0x730: PushEmpty(bool, int)
0x731: Stack[-1] = (int) 9
0x732: Call2 0x69c

0x733: Pop(1)
0x734: IF (Stack[-1] == 0) GOTO 0x73c; Pop(1)

0x735: PushEmpty(int, object)
0x736: Stack[-5] = Stack[-1]
0x737: Push(-2, 1); TaskCall(0)
0x738: Call2 0x0

0x739: Pop(-2, 1); TaskReturn
0x73a: Pop(2)
0x73b: Return(); Pop(2)

0x73c: PushEmpty(bool, int)
0x73d: Stack[-1] = (int) 12
0x73e: Call2 0x69c
...
0x743: Push(-2, 1); TaskCall(4)
0x744: Call2 0x27a

0x745: Pop(-2, 1); TaskReturn
0x746: Pop(2)
0x747: Return(); Pop(2)

0x748: PushEmpty(int, object)
0x749: Stack[-5] = Stack[-1]
0x74a: Push(-2, 1); TaskCall(6)
0x74b: Call2 0x37d

0x74c: Pop(-2, 1); TaskReturn
0x74d: Pop(2)
0x74e: Return(); Pop(2)
