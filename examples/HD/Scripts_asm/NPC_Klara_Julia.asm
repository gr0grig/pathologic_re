...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x108: Pop(0)
0x109: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x10a: Pop(1)
0x10b: PushEmpty(int)
0x10c: Call2 0xb39

0x10d: Pop(0)
0x10e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x10f: Pop(1)
0x110: PushEmpty(string)
0x111: Call2 0xb3d

0x112: Pop(0)
0x113: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x114: Pop(1)
0x115: PushEmpty(string)
0x116: Call2 0xb3f

0x117: Pop(0)
0x118: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x119: Pop(1)
0x11a: PushEmpty(int)
0x11b: Call2 0xd02

0x11c: Pop(0)
0x11d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x11e: Pop(1)
0x11f: Stack[-2] = (int) -1
...
0x135: Pop(2)
0x136: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x137: Pop(0)
...
0x13a: @ sync()
0x13b: Pop(0)
0x13c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x13d: Pop(0)
0x13e: GOTO 0x138

0x13f: PushEmpty(object)
0x140: Stack[-10] = Stack[-1]
0x141: Call2 0x9e3

0x142: Pop(1)
0x143: @ StopDialog(Stack[-4])
0x144: Pop(0)
0x145: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x146: Pop(0)
...
0x183: Push("all") // @poff=138
0x184: Push("idle") // @poff=146
...
0x23a: Stack[-1] = "Untrust" // @poff=166
0x23b: Call2 0x192
...
0x251: Stack[-1] = "Independence" // @poff=182
0x252: Call2 0x192
...
0x2a8: Stack[-1] = "Independence" // @poff=182
0x2a9: Call2 0x192
...
0x2bf: Stack[-1] = "Untrust" // @poff=166
0x2c0: Call2 0x192
...
0x2e9: Pop(0)
0x2ea: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2eb: Pop(1)
0x2ec: PushEmpty(int)
0x2ed: Call2 0xb39

0x2ee: Pop(0)
0x2ef: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2f0: Pop(1)
0x2f1: PushEmpty(string)
0x2f2: Call2 0xb3d

0x2f3: Pop(0)
0x2f4: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2f5: Pop(1)
0x2f6: PushEmpty(string)
0x2f7: Call2 0xb3f

0x2f8: Pop(0)
0x2f9: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2fa: Pop(1)
0x2fb: PushEmpty(int)
0x2fc: Call2 0xd02

0x2fd: Pop(0)
0x2fe: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2ff: Pop(1)
0x300: Stack[-2] = (int) -1
...
0x311: Stack[-11] = Stack[-2]
0x312: Stack[-6] = Stack[-1]
0x313: Push(-2, 4); TaskCall(5)
0x314: Call2 0x32b

0x315: Pop(-2, 4); TaskReturn
0x316: Pop(2)
0x317: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x318: Pop(0)
...
0x31b: @ sync()
0x31c: Pop(0)
0x31d: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x31e: Pop(0)
0x31f: GOTO 0x319

0x320: PushEmpty(object)
0x321: Stack[-10] = Stack[-1]
0x322: Call2 0x9e3

0x323: Pop(1)
0x324: @ StopDialog(Stack[-4])
0x325: Pop(0)
0x326: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x327: Pop(0)
0x328: Stack[-2] = Stack[-10]
0x329: Return(); Pop(8)
...
0x433: Stack[-1] = "Independence" // @poff=182
0x434: Call2 0x36f
...
0x445: Stack[-1] = "Independence" // @poff=182
0x446: Call2 0x36f
...
0x457: Stack[-1] = "Untrust" // @poff=166
0x458: Call2 0x36f
...
0x480: Stack[-1] = "Untrust" // @poff=166
0x481: Call2 0x36f
...
0x4bc: Pop(0)
0x4bd: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x4be: Pop(1)
0x4bf: PushEmpty(int)
0x4c0: Call2 0xb39

0x4c1: Pop(0)
0x4c2: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x4c3: Pop(1)
0x4c4: PushEmpty(string)
0x4c5: Call2 0xb3d

0x4c6: Pop(0)
0x4c7: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x4c8: Pop(1)
0x4c9: PushEmpty(string)
0x4ca: Call2 0xb3f

0x4cb: Pop(0)
0x4cc: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x4cd: Pop(1)
0x4ce: PushEmpty(int)
0x4cf: Call2 0xd02

0x4d0: Pop(0)
0x4d1: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x4d2: Pop(1)
0x4d3: Stack[-2] = (int) -1
...
0x4e9: Pop(2)
0x4ea: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4eb: Pop(0)
...
0x4ee: @ sync()
0x4ef: Pop(0)
0x4f0: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4f1: Pop(0)
0x4f2: GOTO 0x4ec

0x4f3: PushEmpty(object)
0x4f4: Stack[-10] = Stack[-1]
0x4f5: Call2 0x9e3

0x4f6: Pop(1)
0x4f7: @ StopDialog(Stack[-4])
0x4f8: Pop(0)
0x4f9: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4fa: Pop(0)
...
0x540: Push("all") // @poff=138
0x541: Push("idle") // @poff=146
...
0x5ba: Stack[-1] = "Independence" // @poff=182
0x5bb: Call2 0x546
...
0x5de: Stack[-1] = "Untrust" // @poff=166
0x5df: Call2 0x546
...
0x5f0: Stack[-1] = "Untrust" // @poff=166
0x5f1: Call2 0x546
...
0x643: Pop(0)
0x644: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x645: Pop(1)
0x646: PushEmpty(int)
0x647: Call2 0xb39

0x648: Pop(0)
0x649: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x64a: Pop(1)
0x64b: PushEmpty(string)
0x64c: Call2 0xb3d

0x64d: Pop(0)
0x64e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x64f: Pop(1)
0x650: PushEmpty(string)
0x651: Call2 0xb3f

0x652: Pop(0)
0x653: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x654: Pop(1)
0x655: PushEmpty(int)
0x656: Call2 0xd02

0x657: Pop(0)
0x658: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x659: Pop(1)
0x65a: Stack[-2] = (int) -1
...
0x666: Stack[-1] = Stack[-2]
0x667: Pop(1)
0x668: Call2 0x9f5

0x669: Pop(2)
0x66a: PushEmpty(object, object)
0x66b: Stack[-11] = Stack[-2]
0x66c: Stack[-6] = Stack[-1]
0x66d: Push(-2, 4); TaskCall(9)
0x66e: Call2 0x685

0x66f: Pop(-2, 4); TaskReturn
0x670: Pop(2)
0x671: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x672: Pop(0)
...
0x675: @ sync()
0x676: Pop(0)
0x677: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x678: Pop(0)
0x679: GOTO 0x673

0x67a: PushEmpty(object)
0x67b: Stack[-10] = Stack[-1]
0x67c: Call2 0x9e3

0x67d: Pop(1)
0x67e: @ StopDialog(Stack[-4])
0x67f: Pop(0)
0x680: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x681: Pop(0)
0x682: Stack[-2] = Stack[-10]
0x683: Return(); Pop(8)
...
0x79d: Pop(0)
0x79e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x79f: Pop(1)
0x7a0: PushEmpty(int)
0x7a1: Call2 0xb39

0x7a2: Pop(0)
0x7a3: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x7a4: Pop(1)
0x7a5: PushEmpty(string)
0x7a6: Call2 0xb3d

0x7a7: Pop(0)
0x7a8: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x7a9: Pop(1)
0x7aa: PushEmpty(string)
0x7ab: Call2 0xb3f

0x7ac: Pop(0)
0x7ad: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x7ae: Pop(1)
0x7af: PushEmpty(int)
0x7b0: Call2 0xd02

0x7b1: Pop(0)
0x7b2: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x7b3: Pop(1)
0x7b4: Stack[-2] = (int) -1
...
0x7c6: Stack[-6] = Stack[-1]
0x7c7: Push(-2, 4); TaskCall(11)
0x7c8: Call2 0x7df

0x7c9: Pop(-2, 4); TaskReturn
0x7ca: Pop(2)
0x7cb: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x7cc: Pop(0)
...
0x7cf: @ sync()
0x7d0: Pop(0)
0x7d1: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x7d2: Pop(0)
0x7d3: GOTO 0x7cd

0x7d4: PushEmpty(object)
0x7d5: Stack[-10] = Stack[-1]
0x7d6: Call2 0x9e3

0x7d7: Pop(1)
0x7d8: @ StopDialog(Stack[-4])
0x7d9: Pop(0)
0x7da: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x7db: Pop(0)
0x7dc: Stack[-2] = Stack[-10]
0x7dd: Return(); Pop(8)
...
0x80a: Push("all") // @poff=138
0x80b: Push("idle") // @poff=146
...
0x813: Push("all") // @poff=138
0x814: Push("idle") // @poff=146
...
0x839: Stack[-1] = "Neutral" // @poff=89
0x83a: Call2 0x819

0x83b: Pop(1)
0x83c: Push((int) 540539)
0x83d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x83e: Pop(1)
0x83f: @@@ ClearReplies(); Obj=0 // @poff=116
0x840: Pop(0)
...
0x849: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x84a: Pop(3)
0x84b: Return(); Pop(0)
...
0x877: Stack[-3] = Stack[-1]
0x878: Call2 0x990

0x879: Stack[-2] = Stack[-5]
0x87a: Pop(2)
0x87b: Return(); Pop(2)

0x87c: Stack[-1] = 0
0x87d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x87e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x87f: @ RotateAsync(Stack[-2], Stack[-1])
0x880: Pop(2)
0x881: Return(); Pop(0)

0x882: PushEmpty(object, bool, object, bool)
0x883: Push("player") // @poff=218
...
0x93a: Stack[-3] = (int) 0
0x93b: Push("all") // @poff=138
0x93c: PushEmpty(string, int)
0x93d: Stack[-6] = Stack[-1]
0x93e: Call2 0xb21
...
0x95e: Pop(0)
0x95f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=232
0x960: Pop(0)
...
0x965: Push("HasProperty") // @poff=244
0x966: Push((int) 2)
...
0x96c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=268
0x96d: Pop(0)
...
0x972: Stack[-10] = Stack[-2]
0x973: Stack[-9] = Stack[-1]
0x974: Call2 0x964
...
0x97a: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=280
0x97b: Pop(0)
0x97c: PushEmpty(float, float, float, float)
0x97d: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x97e: Stack[-8] = Stack[-2]
0x97f: Stack[-7] = Stack[-1]
0x980: Call2 0xac4

0x981: Pop(3)
0x982: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=292
0x983: Pop(1)
...
0x98d: Pop(2)
0x98e: Stack[-1] = Stack[-8]
0x98f: Return(); Pop(6)

0x990: PushEmpty(cvector, cvector)
0x991: @@ GetPosition(Stack[-1]); Obj=3 // @poff=232
0x992: Pop(0)
0x993: PushEmpty(bool, cvector)
0x994: Stack[-3] = Stack[-1]
0x995: Call2 0x986

0x996: Stack[-2] = Stack[-6]
0x997: Pop(2)
0x998: Return(); Pop(2)
...
0x99f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=232
0x9a0: Pop(0)
0x9a1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=304
0x9a2: Pop(0)
...
0xa0e: Push("voice_common") // @poff=328
0xa0f: Push((int) 1)
...
0xa16: Push("voice_common") // @poff=328
0xa17: Push((int) 0)
...
0xa29: Push("voice_common") // @poff=328
0xa2a: Push((int) 1)
...
0xa37: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0xa38: Pop(1)
...
0xa4c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0xa4d: Pop(1)
...
0xa55: Push("d") // @poff=324
0xa56: PushEmpty(int)
0xa57: Call2 0xb12

0xa58: Pop(0)
0xa59: Pop(2); Push(Stack[-2] + Stack[-1]);
0xa5a: Push("m") // @poff=358
...
0xa62: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0xa63: Pop(1)
...
0xa77: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0xa78: Pop(1)
0xa79: PushEmpty(bool, string)
0xa7a: Stack[-3] = Stack[-1]
0xa7b: Call2 0xa9e

0xa7c: Stack[-2] = Stack[-14]
0xa7d: Pop(2)
0xa7e: Return(); Pop(10)
...
0xa8a: Push("Can't find lsh animation : ") // @poff=362
...
0xa99: Push("Can't find lsh animation : ") // @poff=362
...
0xabd: Push((float)9.999999974752427e-07)
...
0xaee: Stack[-8] = Stack[-5]
0xaef: Stack[-4] = "reputation" // @poff=418
0xaf0: Stack[-7] = Stack[-3]
0xaf1: Stack[-2] = (int) 0
0xaf2: Stack[-1] = (int) 1
0xaf3: Call2 0x970
...
0xaf9: Pop(0)
0xafa: @@ add(Stack[-3]); Obj=1 // @poff=440
0xafb: Pop(0)
0xafc: Push((int) 16)
...
0xb03: Pop(0)
0xb04: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xb3d: Stack[-1] = "ui/NPC_Julia.png" // @poff=444
0xb3e: Return(); Pop(0)

0xb3f: Stack[-1] = "ui/NPC_Julia_b.png" // @poff=478
0xb40: Return(); Pop(0)
...
0xb4a: Stack[-1] = Stack[-2]
0xb4b: Pop(1)
0xb4c: Push("k3q02JuliaGotoEva") // @poff=528
0xb4d: Push("pt_map_eva") // @poff=564
0xb4e: Push((int) 0)
...
0xb52: Pop(0)
0xb53: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=586
0xb54: Pop(5)
0xb55: PushEmpty()
0xb56: Call2 0xc8d
...
0xb62: Pop(1)
0xb63: Push("k6q01IfAnna") // @poff=606
0xb64: Push("pt_map_anna") // @poff=630
0xb65: Push((int) 1)
...
0xb69: Pop(0)
0xb6a: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=586
0xb6b: Pop(5)
0xb6c: Push("k6q01IfEva") // @poff=654
0xb6d: Push("pt_map_eva") // @poff=564
0xb6e: Push((int) 1)
...
0xb72: Pop(0)
0xb73: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=586
0xb74: Pop(5)
0xb75: Push("k6q01IfLara") // @poff=676
0xb76: Push("pt_map_lara") // @poff=700
0xb77: Push((int) 1)
...
0xb7b: Pop(0)
0xb7c: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=586
0xb7d: Pop(5)
0xb7e: Push("k6q01IfOspina") // @poff=724
0xb7f: Push("pt_map_ospina") // @poff=752
0xb80: Push((int) 1)
...
0xb84: Pop(0)
0xb85: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=586
0xb86: Pop(5)
0xb87: PushEmpty()
0xb88: Call2 0xc9a
...
0xb8b: Stack[-2] = "quest_k6_01" // @poff=780
0xb8c: Stack[-1] = "place_danko" // @poff=804
0xb8d: Call2 0xb01
...
0xb92: Push("k11q01SoulCount") // @poff=828
0xb93: @ GetVariable(Stack[-1], Stack[-2])
0xb94: Pop(1)
0xb95: Push((int) 1)
0xb96: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xb97: Push("k11q01SoulCount") // @poff=828
...
0xbc4: PushEmpty()
0xbc5: Push("ook11Julia1") // @poff=860
0xbc6: Push((int) 1)
...
0xbca: PushEmpty()
0xbcb: Push("ook3Julia1") // @poff=884
0xbcc: Push((int) 1)
...
0xbd4: Stack[-1] = Stack[-4]
0xbd5: Pop(1)
0xbd6: Stack[-2] = "pt_map_theater" // @poff=906
0xbd7: Stack[-1] = (int) 1
0xbd8: Call2 0xce1
...
0xbdc: Pop(0)
0xbdd: @@ ShowMap(Stack[-1]); Obj=2 // @poff=936
0xbde: Pop(1)
0xbdf: Return(); Pop(0)

0xbe0: PushEmpty()
0xbe1: Push("k3q02") // @poff=516
0xbe2: Push((int) -1)
...
0xbe9: PushEmpty()
0xbea: Push("k6StopKaterinaTalks") // @poff=944
0xbeb: Push((int) 1)
...
0xbf1: Stack[-5] = Stack[-2]
0xbf2: Stack[-1] = (float) 0.30000001192092896
0xbf3: Call2 0xad4
...
0xc1c: Stack[-1] = "ook11Julia1" // @poff=860
0xc1d: Call2 0xacf
...
0xc28: Stack[-1] = "ook3Julia1" // @poff=884
0xc29: Call2 0xacf
...
0xcac: Push("Can't retrieve diary root") // @poff=998
0xcad: @ Trace(Stack[-1])
0xcae: Pop(1)
0xcaf: Stack[-3] = (bool) 0
0xcb0: Return(); Pop(2)

0xcb1: Stack[-1] = Stack[-3]
0xcb2: Return(); Pop(2)
...
0xcb7: Stack[-1] = Stack[-4]
0xcb8: Pop(1)
0xcb9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1050
0xcba: Pop(0)
0xcbb: Pop(0); Push((bool) Stack[-2] == 0)
0xcbc: IF (Stack[-1] == 0) GOTO 0xcc3; Pop(1)

0xcbd: Push("Can't find diary parent with id: ") // @poff=1055
...
0xcc3: @@ AddChild(Stack[-8]); Obj=2 // @poff=1123
0xcc4: Pop(0)
0xcc5: Push((int) 7)
0xcc6: @ SendWorldWndMessage(Stack[-1])
0xcc7: Pop(1)
0xcc8: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1132
0xcc9: Pop(0)
...
0xcd2: Pop(0)
0xcd3: Pop(0); PushNull((bool) Stack[-2] == 0)
0xcd4: IF (Stack[-1] == 0) GOTO 0xcdb; Pop(1)

0xcd5: Push("Can't find main outdoor scene") // @poff=1144
0xcd6: @ Trace(Stack[-1])
0xcd7: Pop(1)
0xcd8: Stack[-1] = 0
...
0xcdb: @@ GetMap(Stack[-1]); Obj=2 // @poff=1204
0xcdc: Pop(0)
...
0xce3: Pop(0)
0xce4: Pop(0); PushNull((bool) Stack[-2] == 0)
0xce5: IF (Stack[-1] == 0) GOTO 0xcea; Pop(1)

0xce6: Push("Can't find main outdoor scene") // @poff=1144
0xce7: @ Trace(Stack[-1])
0xce8: Pop(1)
0xce9: Return(); Pop(8)

0xcea: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1211
0xceb: Pop(0)
0xcec: Pop(0); Push((bool) Stack[-1] == 0)
0xced: IF (Stack[-1] == 0) GOTO 0xcf4; Pop(1)

0xcee: Push("Warning: outdoor scene locator ") // @poff=1222
0xcef: Pop(1); Push(Stack[-1] + Stack[-11]);
0xcf0: Push(" doesnt exist") // @poff=1286
0xcf1: Pop(2); Push(Stack[-2] + Stack[-1]);
0xcf2: @ Trace(Stack[-1])
0xcf3: Pop(1)
0xcf4: @@ GetMap(Stack[-11]); Obj=2 // @poff=1204
0xcf5: Pop(0)
0xcf6: Pop(0); PushNull((bool) Stack[-11] == 0)
0xcf7: IF (Stack[-1] == 0) GOTO 0xcfc; Pop(1)

0xcf8: Push("Can't find map") // @poff=1314
0xcf9: @ Trace(Stack[-1])
0xcfa: Pop(1)
0xcfb: Return(); Pop(8)
...
0xcfe: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1344
0xcff: Pop(2)
0xd00: Return(); Pop(8)

0xd01: Stack[-2] = 0
0xd02: PushEmpty(int, int)
0xd03: Push("branch") // @poff=1357
