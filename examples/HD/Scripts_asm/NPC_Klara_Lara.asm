...
Strings:
	...
	W:k2q03
	W:k2q03Arfist
	W:pt_map_k2q03_arfist
	A:AddMark
	W:quest_k2_03
	W:place_arfist
	W:completed
	W:k4q03
	W:k4q03LaraGotoAlexandr
	W:pt_map_alexandr
	W:quest_k4_03
	W:ook4Lara1
	W:ook4Lara2
	W:smoked_meat2 is given
	W:smoked_meat
	W:ook6Lara1
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xd1: Push("all") // @poff=138
0xd2: Push("idle") // @poff=146
...
0x1eb: Stack[-1] = "Sympathy" // @poff=156
0x1ec: Call2 0xe0
...
0x254: Stack[-1] = "Confusion" // @poff=184
0x255: Call2 0xe0
...
0x27d: Stack[-1] = "Confusion" // @poff=184
0x27e: Call2 0xe0
...
0x345: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x346: Pop(3)
0x347: Return(); Pop(0)
...
0x34c: Stack[-1] = "Fear" // @poff=174
0x34d: Call2 0xe0

0x34e: Pop(1)
0x34f: Push((int) 541567)
0x350: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x351: Pop(1)
0x352: @@@ ClearReplies(); Obj=0 // @poff=116
0x353: Pop(0)
...
0x370: Stack[-1] = "Confusion" // @poff=184
0x371: Call2 0xe0
...
0x39f: Pop(0)
0x3a0: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x3a1: Pop(1)
0x3a2: PushEmpty(int)
0x3a3: Call2 0xeb1

0x3a4: Pop(0)
0x3a5: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x3a6: Pop(1)
0x3a7: PushEmpty(string)
0x3a8: Call2 0xeb5

0x3a9: Pop(0)
0x3aa: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x3ab: Pop(1)
0x3ac: PushEmpty(string)
0x3ad: Call2 0xeb7

0x3ae: Pop(0)
0x3af: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x3b0: Pop(1)
0x3b1: PushEmpty(int)
0x3b2: Call2 0x1193

0x3b3: Pop(0)
0x3b4: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x3b5: Pop(1)
0x3b6: Stack[-2] = (int) -1
...
0x3c7: Stack[-11] = Stack[-2]
0x3c8: Stack[-6] = Stack[-1]
0x3c9: Push(-2, 4); TaskCall(3)
0x3ca: Call2 0x3e1

0x3cb: Pop(-2, 4); TaskReturn
0x3cc: Pop(2)
0x3cd: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3ce: Pop(0)
...
0x3d1: @ sync()
0x3d2: Pop(0)
0x3d3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3d4: Pop(0)
0x3d5: GOTO 0x3cf

0x3d6: PushEmpty(object)
0x3d7: Stack[-10] = Stack[-1]
0x3d8: Call2 0xd11

0x3d9: Pop(1)
0x3da: @ StopDialog(Stack[-4])
0x3db: Pop(0)
0x3dc: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x3dd: Pop(0)
0x3de: Stack[-2] = Stack[-10]
0x3df: Return(); Pop(8)
...
0x40c: Push("all") // @poff=138
0x40d: Push("idle") // @poff=146
...
0x415: Push("all") // @poff=138
0x416: Push("idle") // @poff=146
...
0x43b: Stack[-1] = "Neutral" // @poff=89
0x43c: Call2 0x41b

0x43d: Pop(1)
0x43e: Push((int) 525495)
0x43f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x440: Pop(1)
0x441: @@@ ClearReplies(); Obj=0 // @poff=116
0x442: Pop(0)
...
0x46a: Pop(0)
0x46b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x46c: Pop(1)
0x46d: PushEmpty(int)
0x46e: Call2 0xeb1

0x46f: Pop(0)
0x470: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x471: Pop(1)
0x472: PushEmpty(string)
0x473: Call2 0xeb5

0x474: Pop(0)
0x475: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x476: Pop(1)
0x477: PushEmpty(string)
0x478: Call2 0xeb7

0x479: Pop(0)
0x47a: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x47b: Pop(1)
0x47c: PushEmpty(int)
0x47d: Call2 0x1193

0x47e: Pop(0)
0x47f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x480: Pop(1)
0x481: Stack[-2] = (int) -1
...
0x492: Stack[-11] = Stack[-2]
0x493: Stack[-6] = Stack[-1]
...
0x49c: @ sync()
0x49d: Pop(0)
0x49e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x49f: Pop(0)
0x4a0: GOTO 0x49a

0x4a1: PushEmpty(object)
0x4a2: Stack[-10] = Stack[-1]
0x4a3: Call2 0xd11

0x4a4: Pop(1)
0x4a5: @ StopDialog(Stack[-4])
0x4a6: Pop(0)
0x4a7: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4a8: Pop(0)
0x4a9: Stack[-2] = Stack[-10]
0x4aa: Return(); Pop(8)
...
0x4fc: IF (Stack[-1] == 1) GOTO 0x50c; Pop(1)
...
0x50a: IF (Stack[-1] == 1) GOTO 0x50c; Pop(1)
...
0x529: Push("all") // @poff=138
0x52a: Push("idle") // @poff=146
...
0x532: Push("all") // @poff=138
0x533: Push("idle") // @poff=146
...
0x5a0: Stack[-1] = "Neutral" // @poff=89
0x5a1: Call2 0x538

0x5a2: Pop(1)
0x5a3: Push((int) 525791)
0x5a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x5a5: Pop(1)
0x5a6: @@@ ClearReplies(); Obj=0 // @poff=116
0x5a7: Pop(0)
0x5a8: Push((int) 529235)
0x5a9: Push((int) 30690)
0x5aa: Push((int) 30689)
0x5ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x5ac: Pop(3)
0x5ad: Return(); Pop(0)

0x5ae: PushEmpty(string)
0x5af: Stack[-1] = "Neutral" // @poff=89
0x5b0: Call2 0x538

0x5b1: Pop(1)
0x5b2: Push((int) 525796)
0x5b3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x5b4: Pop(1)
0x5b5: @@@ ClearReplies(); Obj=0 // @poff=116
0x5b6: Pop(0)
...
0x5da: IF (Stack[-1] == 1) GOTO 0x5ea; Pop(1)
...
0x5e8: IF (Stack[-1] == 1) GOTO 0x5ea; Pop(1)
...
0x5fa: Stack[-1] = "Confusion" // @poff=184
0x5fb: Call2 0x538
...
0x60c: Stack[-1] = "Sympathy" // @poff=156
0x60d: Call2 0x538

0x60e: Pop(1)
0x60f: Push((int) 525814)
0x610: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x611: Pop(1)
0x612: @@@ ClearReplies(); Obj=0 // @poff=116
0x613: Pop(0)
...
0x61e: Stack[-1] = "Sympathy" // @poff=156
0x61f: Call2 0x538
...
0x630: Stack[-1] = "Confusion" // @poff=184
0x631: Call2 0x538
...
0x642: Stack[-1] = "Confusion" // @poff=184
0x643: Call2 0x538
...
0x659: Stack[-1] = "Sympathy" // @poff=156
0x65a: Call2 0x538
...
0x683: Pop(0)
0x684: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x685: Pop(1)
0x686: PushEmpty(int)
0x687: Call2 0xeb1

0x688: Pop(0)
0x689: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x68a: Pop(1)
0x68b: PushEmpty(string)
0x68c: Call2 0xeb5

0x68d: Pop(0)
0x68e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x68f: Pop(1)
0x690: PushEmpty(string)
0x691: Call2 0xeb7

0x692: Pop(0)
0x693: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x694: Pop(1)
0x695: PushEmpty(int)
0x696: Call2 0x1193

0x697: Pop(0)
0x698: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x699: Pop(1)
0x69a: Stack[-2] = (int) -1
...
0x6a6: Stack[-1] = Stack[-2]
0x6a7: Pop(1)
0x6a8: Call2 0xd23

0x6a9: Pop(2)
0x6aa: PushEmpty(object, object)
0x6ab: Stack[-11] = Stack[-2]
0x6ac: Stack[-6] = Stack[-1]
0x6ad: Push(-2, 4); TaskCall(7)
0x6ae: Call2 0x6c5

0x6af: Pop(-2, 4); TaskReturn
0x6b0: Pop(2)
0x6b1: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x6b2: Pop(0)
...
0x6b5: @ sync()
0x6b6: Pop(0)
0x6b7: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x6b8: Pop(0)
0x6b9: GOTO 0x6b3

0x6ba: PushEmpty(object)
0x6bb: Stack[-10] = Stack[-1]
0x6bc: Call2 0xd11

0x6bd: Pop(1)
0x6be: @ StopDialog(Stack[-4])
0x6bf: Pop(0)
0x6c0: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x6c1: Pop(0)
0x6c2: Stack[-2] = Stack[-10]
0x6c3: Return(); Pop(8)
...
0x6f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x6f4: Pop(3)
0x6f5: Push((int) 528852)
0x6f6: Push((int) -1)
0x6f7: Push((int) 30272)
0x6f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x6f9: Pop(3)
0x6fa: GOTO 0x6fd
...
0x70c: Push("all") // @poff=138
0x70d: Push("idle") // @poff=146
...
0x715: Push("all") // @poff=138
0x716: Push("idle") // @poff=146
...
0x77e: Stack[-1] = "Fear" // @poff=174
0x77f: Call2 0x71b

0x780: Pop(1)
0x781: Push((int) 526081)
0x782: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x783: Pop(1)
0x784: @@@ ClearReplies(); Obj=0 // @poff=116
0x785: Pop(0)
...
0x7e8: Pop(0)
0x7e9: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x7ea: Pop(1)
0x7eb: PushEmpty(int)
0x7ec: Call2 0xeb1

0x7ed: Pop(0)
0x7ee: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x7ef: Pop(1)
0x7f0: PushEmpty(string)
0x7f1: Call2 0xeb5

0x7f2: Pop(0)
0x7f3: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x7f4: Pop(1)
0x7f5: PushEmpty(string)
0x7f6: Call2 0xeb7

0x7f7: Pop(0)
0x7f8: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x7f9: Pop(1)
0x7fa: PushEmpty(int)
0x7fb: Call2 0x1193

0x7fc: Pop(0)
0x7fd: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x7fe: Pop(1)
0x7ff: Stack[-2] = (int) -1
...
0x80b: Stack[-1] = Stack[-2]
0x80c: Pop(1)
0x80d: Call2 0xd23

0x80e: Pop(2)
0x80f: PushEmpty(object, object)
0x810: Stack[-11] = Stack[-2]
...
0x815: Pop(2)
0x816: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x817: Pop(0)
...
0x81a: @ sync()
0x81b: Pop(0)
0x81c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x81d: Pop(0)
0x81e: GOTO 0x818

0x81f: PushEmpty(object)
0x820: Stack[-10] = Stack[-1]
0x821: Call2 0xd11

0x822: Pop(1)
0x823: @ StopDialog(Stack[-4])
0x824: Pop(0)
0x825: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x826: Pop(0)
...
0x831: Stack[-1] = "Neutral" // @poff=89
0x832: Call2 0x872

0x833: Pop(1)
0x834: Push((int) 527588)
0x835: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x836: Pop(1)
0x837: @@@ ClearReplies(); Obj=0 // @poff=116
0x838: Pop(0)
...
0x84f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x850: Pop(3)
0x851: GOTO 0x854
...
0x863: Push("all") // @poff=138
0x864: Push("idle") // @poff=146
...
0x86c: Push("all") // @poff=138
0x86d: Push("idle") // @poff=146
...
0x8c7: Stack[-1] = "Fear" // @poff=174
0x8c8: Call2 0x872

0x8c9: Pop(1)
0x8ca: Push((int) 527593)
0x8cb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x8cc: Pop(1)
0x8cd: @@@ ClearReplies(); Obj=0 // @poff=116
0x8ce: Pop(0)
...
0x8d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x8d8: Pop(3)
0x8d9: Return(); Pop(0)
...
0x8de: Stack[-1] = "Neutral" // @poff=89
0x8df: Call2 0x872

0x8e0: Pop(1)
0x8e1: Push((int) 527610)
0x8e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x8e3: Pop(1)
0x8e4: @@@ ClearReplies(); Obj=0 // @poff=116
0x8e5: Pop(0)
0x8e6: Push((int) 527611)
0x8e7: Push((int) 28940)
0x8e8: Push((int) 28955)
0x8e9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x8ea: Pop(3)
0x8eb: Return(); Pop(0)
...
0x8f0: Stack[-1] = "Sympathy" // @poff=156
0x8f1: Call2 0x872

0x8f2: Pop(1)
0x8f3: Push((int) 527595)
0x8f4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x8f5: Pop(1)
0x8f6: @@@ ClearReplies(); Obj=0 // @poff=116
0x8f7: Pop(0)
...
0x914: Stack[-1] = "Neutral" // @poff=89
0x915: Call2 0x872

0x916: Pop(1)
0x917: Push((int) 527599)
0x918: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x919: Pop(1)
0x91a: @@@ ClearReplies(); Obj=0 // @poff=116
0x91b: Pop(0)
0x91c: Push((int) 527600)
0x91d: Push((int) 28944)
0x91e: Push((int) 28943)
0x91f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x920: Pop(3)
0x921: Return(); Pop(0)
...
0x926: Stack[-1] = "Sympathy" // @poff=156
0x927: Call2 0x872

0x928: Pop(1)
0x929: Push((int) 527601)
0x92a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x92b: Pop(1)
0x92c: @@@ ClearReplies(); Obj=0 // @poff=116
0x92d: Pop(0)
...
0x938: Stack[-1] = "Sympathy" // @poff=156
0x939: Call2 0x872
...
0x9ab: Stack[-1] = "Tiredness" // @poff=204
0x9ac: Call2 0x9e3

0x9ad: Pop(1)
0x9ae: Push((int) 539312)
0x9af: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x9b0: Pop(1)
0x9b1: @@@ ClearReplies(); Obj=0 // @poff=116
0x9b2: Pop(0)
0x9b3: Push((int) 542603)
0x9b4: Push((int) 45006)
0x9b5: Push((int) 45004)
0x9b6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x9b7: Pop(3)
...
0x9d4: Push("all") // @poff=138
0x9d5: Push("idle") // @poff=146
...
0x9dd: Push("all") // @poff=138
0x9de: Push("idle") // @poff=146
...
0xa03: Stack[-1] = "Tiredness" // @poff=204
0xa04: Call2 0x9e3
...
0xa18: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa19: Pop(3)
0xa1a: Return(); Pop(0)
...
0xa1f: Stack[-1] = "Confusion" // @poff=184
0xa20: Call2 0x9e3

0xa21: Pop(1)
0xa22: Push((int) 542605)
0xa23: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa24: Pop(1)
0xa25: @@@ ClearReplies(); Obj=0 // @poff=116
0xa26: Pop(0)
0xa27: Push((int) 542606)
0xa28: Push((int) 45011)
0xa29: Push((int) 45007)
0xa2a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa2b: Pop(3)
0xa2c: Push((int) 542607)
0xa2d: Push((int) 45009)
0xa2e: Push((int) 45008)
0xa2f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa30: Pop(3)
0xa31: Return(); Pop(0)
...
0xa36: Stack[-1] = "Neutral" // @poff=89
0xa37: Call2 0x9e3

0xa38: Pop(1)
0xa39: Push((int) 542608)
0xa3a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa3b: Pop(1)
0xa3c: @@@ ClearReplies(); Obj=0 // @poff=116
0xa3d: Pop(0)
0xa3e: Push((int) 542609)
0xa3f: Push((int) -1)
0xa40: Push((int) 45010)
0xa41: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa42: Pop(3)
0xa43: Return(); Pop(0)
...
0xa48: Stack[-1] = "Sympathy" // @poff=156
0xa49: Call2 0x9e3

0xa4a: Pop(1)
0xa4b: Push((int) 542610)
0xa4c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa4d: Pop(1)
0xa4e: @@@ ClearReplies(); Obj=0 // @poff=116
0xa4f: Pop(0)
...
0xa5f: Stack[-1] = "Sympathy" // @poff=156
0xa60: Call2 0x9e3
...
0xa71: Stack[-1] = "Sympathy" // @poff=156
0xa72: Call2 0x9e3

0xa73: Pop(1)
0xa74: Push((int) 542615)
0xa75: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa76: Pop(1)
0xa77: @@@ ClearReplies(); Obj=0 // @poff=116
0xa78: Pop(0)
0xa79: Push((int) 542616)
0xa7a: Push((int) 45018)
0xa7b: Push((int) 45017)
0xa7c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa7d: Pop(3)
0xa7e: Return(); Pop(0)
...
0xa83: Stack[-1] = "Neutral" // @poff=89
0xa84: Call2 0x9e3

0xa85: Pop(1)
0xa86: Push((int) 542617)
0xa87: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa88: Pop(1)
0xa89: @@@ ClearReplies(); Obj=0 // @poff=116
0xa8a: Pop(0)
0xa8b: Push((int) 542618)
0xa8c: Push((int) 45020)
0xa8d: Push((int) 45019)
0xa8e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xa8f: Pop(3)
0xa90: Return(); Pop(0)
...
0xa95: Stack[-1] = "Neutral" // @poff=89
0xa96: Call2 0x9e3

0xa97: Pop(1)
0xa98: Push((int) 542619)
0xa99: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa9a: Pop(1)
0xa9b: @@@ ClearReplies(); Obj=0 // @poff=116
0xa9c: Pop(0)
...
0xac4: Pop(0)
0xac5: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xac6: Pop(1)
0xac7: PushEmpty(int)
0xac8: Call2 0xeb1

0xac9: Pop(0)
0xaca: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xacb: Pop(1)
0xacc: PushEmpty(string)
0xacd: Call2 0xeb5

0xace: Pop(0)
0xacf: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xad0: Pop(1)
0xad1: PushEmpty(string)
0xad2: Call2 0xeb7

0xad3: Pop(0)
0xad4: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xad5: Pop(1)
0xad6: PushEmpty(int)
0xad7: Call2 0x1193

0xad8: Pop(0)
0xad9: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xada: Pop(1)
0xadb: Stack[-2] = (int) -1
...
0xaec: Stack[-11] = Stack[-2]
0xaed: Stack[-6] = Stack[-1]
0xaee: Push(-2, 4); TaskCall(13)
0xaef: Call2 0xb06

0xaf0: Pop(-2, 4); TaskReturn
0xaf1: Pop(2)
0xaf2: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xaf3: Pop(0)
...
0xaf6: @ sync()
0xaf7: Pop(0)
0xaf8: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0xaf9: Pop(0)
0xafa: GOTO 0xaf4

0xafb: PushEmpty(object)
0xafc: Stack[-10] = Stack[-1]
0xafd: Call2 0xd11

0xafe: Pop(1)
0xaff: @ StopDialog(Stack[-4])
0xb00: Pop(0)
0xb01: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0xb02: Pop(0)
0xb03: Stack[-2] = Stack[-10]
0xb04: Return(); Pop(8)
...
0xb0d: Stack[-1] = "Neutral" // @poff=89
0xb0e: Call2 0xb40

0xb0f: Pop(1)
0xb10: Push((int) 540539)
0xb11: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xb12: Pop(1)
0xb13: @@@ ClearReplies(); Obj=0 // @poff=116
0xb14: Pop(0)
0xb15: Push((int) 540540)
0xb16: Push((int) -1)
0xb17: Push((int) 42549)
0xb18: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0xb19: Pop(3)
...
0xb3a: Push("all") // @poff=138
0xb3b: Push("idle") // @poff=146
...
0xba3: Stack[-1] = 0
0xba4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xba5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0xba6: @ RotateAsync(Stack[-2], Stack[-1])
0xba7: Pop(2)
0xba8: Return(); Pop(0)

0xba9: PushEmpty(object, bool, object, bool)
0xbaa: Push("player") // @poff=224
...
0xc61: Stack[-3] = (int) 0
0xc62: Push("all") // @poff=138
0xc63: PushEmpty(string, int)
0xc64: Stack[-6] = Stack[-1]
0xc65: Call2 0xe99
...
0xc85: Pop(0)
0xc86: @@ GetPosition(Stack[-2]); Obj=7 // @poff=238
0xc87: Pop(0)
...
0xc8c: Push("HasProperty") // @poff=250
0xc8d: Push((int) 2)
...
0xc93: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=274
0xc94: Pop(0)
0xc95: Stack[-1] = Stack[-5]
0xc96: Return(); Pop(2)

0xc97: PushEmpty(float, float)
0xc98: PushEmpty(bool, object, string)
0xc99: Stack[-10] = Stack[-2]
0xc9a: Stack[-9] = Stack[-1]
0xc9b: Call2 0xc8b
...
0xca1: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=286
0xca2: Pop(0)
0xca3: PushEmpty(float, float, float, float)
0xca4: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xca5: Stack[-8] = Stack[-2]
0xca6: Stack[-7] = Stack[-1]
0xca7: Call2 0xdf2

0xca8: Pop(3)
0xca9: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=298
0xcaa: Pop(1)
0xcab: Stack[-8] = (bool) 1
0xcac: Return(); Pop(2)

0xcad: PushEmpty(int, int)
0xcae: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=286
0xcaf: Pop(0)
0xcb0: Pop(0); Push(Stack[-1] + Stack[-3]);
0xcb1: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=298
0xcb2: Pop(1)
0xcb3: Return(); Pop(2)
...
0xcbb: Pop(2)
0xcbc: Stack[-1] = Stack[-8]
0xcbd: Return(); Pop(6)

0xcbe: PushEmpty(cvector, cvector)
0xcbf: @@ GetPosition(Stack[-1]); Obj=3 // @poff=238
0xcc0: Pop(0)
...
0xccd: @@ GetPosition(Stack[-8]); Obj=20 // @poff=238
0xcce: Pop(0)
0xccf: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=310
0xcd0: Pop(0)
...
0xcf6: Pop(0)
0xcf7: Push((bool) 1)
0xcf8: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0xcf9: Pop(1)
0xcfa: Push(CvectorIndex(Stack[-4], 0))
0xcfb: Push(CvectorIndex(Stack[-5], 2))
0xcfc: @ Rotate(Stack[-2], Stack[-1])
0xcfd: Pop(2)
...
0xd03: Push("head") // @poff=324
0xd04: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xd05: Pop(1)
0xd06: Push(Stack[-1])
0xd07: IF (Stack[-1] == 0) GOTO 0xd0b; Pop(1)

0xd08: Push("head") // @poff=324
0xd09: @ LookAsyncCamera(Stack[-1])
0xd0a: Pop(1)
0xd0b: @ CameraWaitForPlayFinish()
0xd0c: Pop(0)
0xd0d: @ ResumeWorld()
0xd0e: Pop(0)
0xd0f: Stack[-21] = (bool) 1
0xd10: Return(); Pop(18)

0xd11: PushEmpty(bool, bool)
0xd12: Push((bool) 1)
0xd13: @ CameraSwitchToNormal(Stack[-1])
0xd14: Pop(1)
...
0xd1a: Push("head") // @poff=324
0xd1b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0xd1c: Pop(1)
0xd1d: Push(Stack[-1])
0xd1e: IF (Stack[-1] == 0) GOTO 0xd22; Pop(1)

0xd1f: Push("head") // @poff=324
0xd20: @ UnlookAsync(Stack[-1])
0xd21: Pop(1)
0xd22: Return(); Pop(2)

0xd23: PushEmpty(int, int, int, int)
0xd24: Push("voice_common") // @poff=334
0xd25: @ GetVariable(Stack[-1], Stack[-3])
0xd26: Pop(1)
0xd27: Push(Stack[-2])
0xd28: IF (Stack[-1] == 0) GOTO 0xd49; Pop(1)

0xd29: PushEmpty(bool, object)
0xd2a: Stack[-7] = Stack[-1]
0xd2b: Call2 0xd5d

0xd2c: Pop(1)
0xd2d: Pop(1); Push((bool) Stack[-1] == 0)
0xd2e: IF (Stack[-1] == 0) GOTO 0xd37; Pop(1)

0xd2f: PushEmpty(bool, object)
0xd30: Stack[-7] = Stack[-1]
0xd31: Call2 0xd82

0xd32: Pop(1)
0xd33: Pop(1); Push((bool) Stack[-1] == 0)
0xd34: IF (Stack[-1] == 0) GOTO 0xd37; Pop(1)

0xd35: Stack[-6] = (bool) 0
0xd36: Return(); Pop(4)

0xd37: Push((int) 2)
0xd38: @ irand(Stack[-2], Stack[-1])
0xd39: Pop(1)
0xd3a: Push(Stack[-1])
0xd3b: IF (Stack[-1] == 0) GOTO 0xd44; Pop(1)

0xd3c: Push("voice_common") // @poff=334
0xd3d: Push((int) 1)
0xd3e: Pop(1); Push(Stack[-4] + Stack[-1]);
0xd3f: Push((int) 3)
0xd40: Pop(2); Push(Stack[-2] % Stack[-1]);
0xd41: @ SetVariable(Stack[-2], Stack[-1])
0xd42: Pop(2)
0xd43: GOTO 0xd48

0xd44: Push("voice_common") // @poff=334
0xd45: Push((int) 0)
...
0xd4a: Stack[-7] = Stack[-1]
0xd4b: Call2 0xd82

0xd4c: Pop(1)
0xd4d: Pop(1); Push((bool) Stack[-1] == 0)
0xd4e: IF (Stack[-1] == 0) GOTO 0xd57; Pop(1)

0xd4f: PushEmpty(bool, object)
0xd50: Stack[-7] = Stack[-1]
0xd51: Call2 0xd5d
...
0xd55: Stack[-6] = (bool) 0
0xd56: Return(); Pop(4)

0xd57: Push("voice_common") // @poff=334
0xd58: Push((int) 1)
0xd59: @ SetVariable(Stack[-2], Stack[-1])
0xd5a: Pop(2)
0xd5b: Stack[-6] = (bool) 1
0xd5c: Return(); Pop(4)

0xd5d: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xd5e: Stack[-5] = "c" // @poff=360
0xd5f: Stack[-4] = (int) 0
0xd60: Push((int) 1)
0xd61: IF (Stack[-1] == 0) GOTO 0xd6d; Pop(1)

0xd62: Push((int) 1)
0xd63: Pop(1); Push(Stack[-5] + Stack[-1]);
0xd64: Pop(1); Push(Stack[-6] + Stack[-1]);
0xd65: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=274
0xd66: Pop(1)
...
0xd6a: Push((int) 1)
0xd6b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xd6c: GOTO 0xd60

0xd6d: Pop(0); Push((bool) Stack[-4] == 0)
0xd6e: IF (Stack[-1] == 0) GOTO 0xd71; Pop(1)

0xd6f: Stack[-12] = (bool) 0
0xd70: Return(); Pop(10)

0xd71: Stack[-2] = (int) 0
0xd72: Push((int) 1)
0xd73: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0xd74: IF (Stack[-1] == 0) GOTO 0xd77; Pop(1)

0xd75: @ irand(Stack[-2], Stack[-4])
0xd76: Pop(0)
0xd77: Push((int) 1)
0xd78: Pop(1); Push(Stack[-3] + Stack[-1]);
0xd79: Pop(1); Push(Stack[-6] + Stack[-1]);
0xd7a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=286
0xd7b: Pop(1)
0xd7c: PushEmpty(bool, string)
0xd7d: Stack[-3] = Stack[-1]
0xd7e: Call2 0xdcc

0xd7f: Stack[-2] = Stack[-14]
0xd80: Pop(2)
0xd81: Return(); Pop(10)

0xd82: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xd83: Push("d") // @poff=330
0xd84: PushEmpty(int)
0xd85: Call2 0xe8a

0xd86: Pop(0)
0xd87: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd88: Push("m") // @poff=364
0xd89: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xd8a: Stack[-4] = (int) 0
0xd8b: Push((int) 1)
0xd8c: IF (Stack[-1] == 0) GOTO 0xd98; Pop(1)

0xd8d: Push((int) 1)
0xd8e: Pop(1); Push(Stack[-5] + Stack[-1]);
0xd8f: Pop(1); Push(Stack[-6] + Stack[-1]);
0xd90: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=274
0xd91: Pop(1)
0xd92: Pop(0); Push((bool) Stack[-3] == 0)
0xd93: IF (Stack[-1] == 0) GOTO 0xd95; Pop(1)

0xd94: GOTO 0xd98

0xd95: Push((int) 1)
0xd96: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xd97: GOTO 0xd8b

0xd98: Pop(0); Push((bool) Stack[-4] == 0)
0xd99: IF (Stack[-1] == 0) GOTO 0xd9c; Pop(1)

0xd9a: Stack[-12] = (bool) 0
0xd9b: Return(); Pop(10)

0xd9c: Stack[-2] = (int) 0
0xd9d: Push((int) 1)
0xd9e: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0xd9f: IF (Stack[-1] == 0) GOTO 0xda2; Pop(1)

0xda0: @ irand(Stack[-2], Stack[-4])
0xda1: Pop(0)
0xda2: Push((int) 1)
0xda3: Pop(1); Push(Stack[-3] + Stack[-1]);
0xda4: Pop(1); Push(Stack[-6] + Stack[-1]);
0xda5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=286
0xda6: Pop(1)
0xda7: PushEmpty(bool, string)
0xda8: Stack[-3] = Stack[-1]
0xda9: Call2 0xdcc

0xdaa: Stack[-2] = Stack[-14]
0xdab: Pop(2)
0xdac: Return(); Pop(10)

0xdad: PushEmpty(bool, float, float, bool, float, float)
0xdae: @ lshHasAnimation(Stack[-3], Stack[-7])
0xdaf: Pop(0)
0xdb0: Push(Stack[-3])
0xdb1: IF (Stack[-1] == 0) GOTO 0xdb8; Pop(1)

0xdb2: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0xdb3: Pop(0)
0xdb4: Push((bool) 0)
0xdb5: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0xdb6: Pop(1)
0xdb7: GOTO 0xdbc

0xdb8: Push("Can't find lsh animation : ") // @poff=368
0xdb9: Pop(1); Push(Stack[-1] + Stack[-8]);
0xdba: @ Trace(Stack[-1])
0xdbb: Pop(1)
0xdbc: Return(); Pop(6)

0xdbd: PushEmpty(bool, float, float, bool, float, float)
0xdbe: @ lshHasAnimation(Stack[-3], Stack[-8])
0xdbf: Pop(0)
0xdc0: Push(Stack[-3])
0xdc1: IF (Stack[-1] == 0) GOTO 0xdc7; Pop(1)

0xdc2: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0xdc3: Pop(0)
0xdc4: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0xdc5: Pop(0)
0xdc6: GOTO 0xdcb

0xdc7: Push("Can't find lsh animation : ") // @poff=368
0xdc8: Pop(1); Push(Stack[-1] + Stack[-9]);
0xdc9: @ Trace(Stack[-1])
0xdca: Pop(1)
0xdcb: Return(); Pop(6)
...
0xdd1: @ lshHasSpeech(Stack[-1], Stack[-3])
0xdd2: Pop(0)
0xdd3: Push(Stack[-1])
0xdd4: IF (Stack[-1] == 0) GOTO 0xdd9; Pop(1)

0xdd5: @ lshPlaySpeech(Stack[-3])
0xdd6: Pop(0)
0xdd7: Stack[-4] = (bool) 1
0xdd8: Return(); Pop(2)
...
0xde3: @ self(Stack[-1])
0xde4: Pop(0)
0xde5: Stack[-1] = Stack[-3]
0xde6: Return(); Pop(2)

0xde7: Stack[-1] = 0
0xde8: PushEmpty(float, float)
0xde9: Pop(0); Push(Stack[-3] | Stack[-3]);
0xdea: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xdeb: Push((float)9.999999974752427e-07)
0xdec: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xded: IF (Stack[-1] == 0) GOTO 0xdf0; Pop(1)

0xdee: Stack[-4] = CVector(0.0, 0.0, 0.0)
0xdef: Return(); Pop(2)

0xdf0: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xdf1: Return(); Pop(2)

0xdf2: PushEmpty()
0xdf3: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xdf4: IF (Stack[-1] == 0) GOTO 0xdf7; Pop(1)

0xdf5: Stack[-2] = Stack[-4]
0xdf6: Return(); Pop(0)

0xdf7: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xdf8: IF (Stack[-1] == 0) GOTO 0xdfb; Pop(1)

0xdf9: Stack[-1] = Stack[-4]
0xdfa: Return(); Pop(0)

0xdfb: Stack[-3] = Stack[-4]
0xdfc: Return(); Pop(0)

0xdfd: PushEmpty(int, int)
0xdfe: @ GetVariable(Stack[-3], Stack[-1])
0xdff: Pop(0)
0xe00: Stack[-1] = Stack[-4]
0xe01: Return(); Pop(2)

0xe02: PushEmpty(object, object, object, object)
0xe03: @ GetMainOutdoorScene(Stack[-2])
0xe04: Pop(0)
0xe05: Push(".bin") // @poff=424
0xe06: Pop(1); Push(Stack[-6] + Stack[-1]);
0xe07: @ AddBlankActor(Stack[-2], Stack[-3], Stack[-6], Stack[-1])
0xe08: Pop(1)
0xe09: Stack[-1] = Stack[-6]
0xe0a: Return(); Pop(4)

0xe0b: Stack[-1] = 0
0xe0c: Stack[-2] = 0
0xe0d: PushEmpty(object, object)
0xe0e: @ CreateIntVector(Stack[-1])
0xe0f: Pop(0)
0xe10: @@ add(Stack[-4]); Obj=1 // @poff=434
0xe11: Pop(0)
0xe12: @@ add(Stack[-3]); Obj=1 // @poff=434
0xe13: Pop(0)
0xe14: Push((int) 3)
0xe15: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xe16: Pop(1)
0xe17: Return(); Pop(2)

0xe18: Stack[-1] = 0
0xe19: PushEmpty(int, int)
0xe1a: PushEmpty(object, string, int)
0xe1b: Stack[-7] = Stack[-3]
0xe1c: Stack[-2] = "money" // @poff=438
0xe1d: Stack[-6] = Stack[-1]
0xe1e: Call2 0xcad

0xe1f: Pop(3)
0xe20: Push((int) 0)
0xe21: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0xe22: IF (Stack[-1] == 0) GOTO 0xe2b; Pop(1)

0xe23: Push("Money") // @poff=450
0xe24: @ GetInvItemByName(Stack[-2], Stack[-1])
0xe25: Pop(1)
0xe26: PushEmpty(int, int)
0xe27: Stack[-3] = Stack[-2]
0xe28: Stack[-5] = Stack[-1]
0xe29: Call2 0xe0d

0xe2a: Pop(2)
0xe2b: Return(); Pop(2)

0xe2c: PushEmpty(int, int, bool, int, int, bool)
0xe2d: @@ GetItemID(Stack[-3]); Obj=8 // @poff=462
0xe2e: Pop(0)
0xe2f: Push("Category") // @poff=472
0xe30: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xe31: Pop(1)
0xe32: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=490
0xe33: Pop(0)
0xe34: Pop(0); Push((bool) Stack[-1] == 0)
0xe35: IF (Stack[-1] == 0) GOTO 0xe39; Pop(1)

0xe36: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=498
0xe37: Pop(0)
0xe38: GOTO 0xe3e

0xe39: PushEmpty(int, int)
0xe3a: Stack[-5] = Stack[-2]
0xe3b: Stack[-9] = Stack[-1]
0xe3c: Call2 0xe0d

0xe3d: Pop(2)
0xe3e: Return(); Pop(6)

0xe3f: PushEmpty(object, object)
0xe40: @ CreateInvItem(Stack[-1])
0xe41: Pop(0)
0xe42: @@ SetItemName(Stack[-4]); Obj=1 // @poff=508
0xe43: Pop(0)
0xe44: PushEmpty(object, object, int)
0xe45: Stack[-8] = Stack[-3]
0xe46: Stack[-4] = Stack[-2]
0xe47: Stack[-6] = Stack[-1]
0xe48: Call2 0xe2c
...
0xe4b: Stack[-1] = 0
0xe4c: PushEmpty()
0xe4d: Pop(0); Push((bool) Stack[-2] == 0)
0xe4e: IF (Stack[-1] == 0) GOTO 0xe51; Pop(1)

0xe4f: Stack[-3] = (bool) 0
0xe50: Return(); Pop(0)

0xe51: Push((int) 0)
0xe52: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0xe53: IF (Stack[-1] == 0) GOTO 0xe58; Pop(1)

0xe54: Push((int) 8)
0xe55: @ SendWorldWndMessage(Stack[-1])
0xe56: Pop(1)
0xe57: GOTO 0xe61

0xe58: Push((int) 0)
0xe59: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xe5a: IF (Stack[-1] == 0) GOTO 0xe5f; Pop(1)

0xe5b: Push((int) 9)
0xe5c: @ SendWorldWndMessage(Stack[-1])
0xe5d: Pop(1)
0xe5e: GOTO 0xe61

0xe5f: Stack[-3] = (bool) 0
0xe60: Return(); Pop(0)

0xe61: PushEmpty(float)
0xe62: Stack[-2] = Stack[-1]
0xe63: Call2 0xe6f

0xe64: Pop(1)
0xe65: PushEmpty(bool, object, string, float, float, float)
0xe66: Stack[-8] = Stack[-5]
0xe67: Stack[-4] = "reputation" // @poff=520
0xe68: Stack[-7] = Stack[-3]
0xe69: Stack[-2] = (int) 0
0xe6a: Stack[-1] = (int) 1
0xe6b: Call2 0xc97

0xe6c: Pop(6)
0xe6d: Stack[-3] = (bool) 1
0xe6e: Return(); Pop(0)

0xe6f: PushEmpty(object, object)
0xe70: @ CreateFloatVector(Stack[-1])
0xe71: Pop(0)
0xe72: @@ add(Stack[-3]); Obj=1 // @poff=434
0xe73: Pop(0)
0xe74: Push((int) 16)
0xe75: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xe76: Pop(1)
0xe77: Return(); Pop(2)

0xe78: Stack[-1] = 0
0xe79: PushEmpty(object, object)
0xe7a: @ FindActor(Stack[-1], Stack[-4])
0xe7b: Pop(0)
0xe7c: Pop(0); PushNull((bool) Stack[-1] == 0)
0xe7d: IF (Stack[-1] == 0) GOTO 0xe80; Pop(1)

0xe7e: Stack[-5] = (bool) 0
0xe7f: Return(); Pop(2)

0xe80: @ Trigger(Stack[-1], Stack[-3])
0xe81: Pop(0)
0xe82: Stack[-5] = (bool) 1
0xe83: Return(); Pop(2)

0xe84: Stack[-1] = 0
0xe85: PushEmpty(float, float)
0xe86: @ GetGameTime(Stack[-1])
0xe87: Pop(0)
0xe88: Stack[-1] = Stack[-3]
0xe89: Return(); Pop(2)

0xe8a: PushEmpty(float, float)
0xe8b: @ GetGameTime(Stack[-1])
0xe8c: Pop(0)
0xe8d: Push((int) 1)
0xe8e: PushEmpty(int)
0xe8f: Push((int) 24)
0xe90: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0xe91: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xe92: Return(); Pop(2)
...
0xe96: Pop(0)
0xe97: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0xe98: Return(); Pop(0)

0xe99: PushEmpty(string, string)
0xe9a: Stack[-1] = "idle" // @poff=146
0xe9b: Push(Stack[-3])
0xe9c: IF (Stack[-1] == 0) GOTO 0xe9e; Pop(1)

0xe9d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xe9e: Stack[-1] = Stack[-4]
0xe9f: Return(); Pop(2)

0xea0: PushEmpty(int, bool, int, bool)
0xea1: Stack[-2] = (int) 0
0xea2: Push("all") // @poff=138
0xea3: PushEmpty(string, int)
0xea4: Stack[-5] = Stack[-1]
0xea5: Call2 0xe99

0xea6: Pop(1)
0xea7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xea8: Pop(2)
0xea9: Pop(0); Push((bool) Stack[-1] == 0)
0xeaa: IF (Stack[-1] == 0) GOTO 0xeac; Pop(1)

0xeab: GOTO 0xeaf

0xeac: Push((int) 1)
0xead: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xeae: GOTO 0xea2

0xeaf: Stack[-2] = Stack[-5]
0xeb0: Return(); Pop(4)

0xeb1: Stack[-1] = (int) 515541
0xeb2: Return(); Pop(0)

0xeb3: Stack[-1] = (int) 502866
0xeb4: Return(); Pop(0)

0xeb5: Stack[-1] = "ui/NPC_Lara.png" // @poff=542
0xeb6: Return(); Pop(0)

0xeb7: Stack[-1] = "ui/NPC_Lara_b.png" // @poff=574
0xeb8: Return(); Pop(0)

0xeb9: Stack[-1] = (bool) 1
0xeba: Return(); Pop(0)

0xebb: PushEmpty()
0xebc: PushEmpty(bool, object, float)
0xebd: Stack[-5] = Stack[-2]
0xebe: Stack[-1] = (float) 0.05000000074505806
0xebf: Call2 0xe4c
...
0xec2: PushEmpty()
0xec3: Push("k2q02") // @poff=610
0xec4: Push((int) 2)
0xec5: @ SetVariable(Stack[-2], Stack[-1])
0xec6: Pop(2)
0xec7: PushEmpty()
0xec8: Call2 0x10d0
...
0xecb: PushEmpty()
0xecc: Push("ook2Lara1") // @poff=622
0xecd: Push((int) 1)
0xece: @ SetVariable(Stack[-2], Stack[-1])
0xecf: Pop(2)
0xed0: Return(); Pop(0)

0xed1: PushEmpty(object, object)
0xed2: Push("k2q03") // @poff=642
0xed3: Push((int) 1)
0xed4: @ SetVariable(Stack[-2], Stack[-1])
0xed5: Pop(2)
0xed6: PushEmpty(object)
0xed7: Call2 0x1161

0xed8: Stack[-1] = Stack[-2]
0xed9: Pop(1)
0xeda: Push("k2q03Arfist") // @poff=654
0xedb: Push("pt_map_k2q03_arfist") // @poff=678
0xedc: Push((int) 0)
0xedd: Push((int) 529268)
0xede: PushEmpty(float)
0xedf: Call2 0xe85

0xee0: Pop(0)
0xee1: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=718
0xee2: Pop(5)
0xee3: PushEmpty()
0xee4: Call2 0x10dd
...
0xee8: Pop(0)
0xee9: PushEmpty(object, string)
0xeea: Stack[-1] = "quest_k2_03" // @poff=726
0xeeb: Call2 0xe02

0xeec: Pop(2)
0xeed: PushEmpty(bool, string, string)
0xeee: Stack[-2] = "quest_k2_03" // @poff=726
0xeef: Stack[-1] = "place_arfist" // @poff=750
0xef0: Call2 0xe79
...
0xef7: Pop(0)
0xef8: PushEmpty(bool, string, string)
0xef9: Stack[-2] = "quest_k2_03" // @poff=726
0xefa: Stack[-1] = "completed" // @poff=776
0xefb: Call2 0xe79

0xefc: Pop(3)
0xefd: Return(); Pop(0)

0xefe: PushEmpty(object, object)
0xeff: Push("k4q03") // @poff=796
0xf00: Push((int) 1)
0xf01: @ SetVariable(Stack[-2], Stack[-1])
0xf02: Pop(2)
0xf03: PushEmpty(object)
0xf04: Call2 0x1161

0xf05: Stack[-1] = Stack[-2]
0xf06: Pop(1)
0xf07: Push("k4q03LaraGotoAlexandr") // @poff=808
0xf08: Push("pt_map_alexandr") // @poff=852
0xf09: Push((int) 0)
0xf0a: Push((int) 515280)
0xf0b: PushEmpty(float)
0xf0c: Call2 0xe85

0xf0d: Pop(0)
0xf0e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=718
0xf0f: Pop(5)
0xf10: PushEmpty()
0xf11: Call2 0x1104
...
0xf15: Pop(0)
0xf16: PushEmpty(object, string)
0xf17: Stack[-1] = "quest_k4_03" // @poff=884
0xf18: Call2 0xe02
...
0xf22: PushEmpty()
0xf23: Push("ook4Lara2") // @poff=928
0xf24: Push((int) 1)
0xf25: @ SetVariable(Stack[-2], Stack[-1])
0xf26: Pop(2)
0xf27: Return(); Pop(0)
...
0xf2b: Pop(0)
0xf2c: PushEmpty(bool, string, string)
0xf2d: Stack[-2] = "quest_k4_03" // @poff=884
0xf2e: Stack[-1] = "completed" // @poff=776
0xf2f: Call2 0xe79
...
0xf32: PushEmpty()
0xf33: Push("smoked_meat2 is given") // @poff=948
0xf34: @ Trace(Stack[-1])
0xf35: Pop(1)
0xf36: PushEmpty(object, string, int)
0xf37: Stack[-5] = Stack[-3]
0xf38: Stack[-2] = "smoked_meat" // @poff=992
0xf39: Stack[-1] = (int) 2
0xf3a: Call2 0xe3f
...
0xf3d: PushEmpty()
0xf3e: Push("ook6Lara1") // @poff=1016
0xf3f: Push((int) 1)
0xf40: @ SetVariable(Stack[-2], Stack[-1])
0xf41: Pop(2)
0xf42: Return(); Pop(0)
...
0xf48: PushEmpty()
0xf49: Push("money2000 is given") // @poff=1036
0xf4a: @ Trace(Stack[-1])
0xf4b: Pop(1)
0xf4c: PushEmpty(object, int)
0xf4d: Stack[-4] = Stack[-2]
0xf4e: Stack[-1] = (int) 2000
0xf4f: Call2 0xe19

0xf50: Pop(2)
0xf51: Return(); Pop(0)

0xf52: PushEmpty(int, int)
0xf53: Push("k11q01SoulCount") // @poff=1074
0xf54: @ GetVariable(Stack[-1], Stack[-2])
0xf55: Pop(1)
0xf56: Push((int) 1)
0xf57: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xf58: Push("k11q01SoulCount") // @poff=1074
0xf59: @ SetVariable(Stack[-1], Stack[-2])
0xf5a: Pop(1)
0xf5b: Push((int) 2)
...
0xf64: IF (Stack[-1] == 0) GOTO 0xf69; Pop(1)
...
0xf6b: IF (Stack[-1] == 0) GOTO 0xf70; Pop(1)
...
0xf70: Push((int) 5)
0xf71: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0xf77: Push((int) 6)
0xf78: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xf79: IF (Stack[-1] == 0) GOTO 0xf7e; Pop(1)
...
0xf7e: Push((int) 7)
0xf7f: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xf80: IF (Stack[-1] == 0) GOTO 0xf84; Pop(1)
...
0xf85: PushEmpty()
0xf86: Push("ook11Lara1") // @poff=1106
0xf87: Push((int) 1)
0xf88: @ SetVariable(Stack[-2], Stack[-1])
0xf89: Pop(2)
0xf8a: Return(); Pop(0)

0xf8b: PushEmpty()
0xf8c: PushEmpty(object, string, float)
0xf8d: PushEmpty(object)
0xf8e: Call2 0x1161

0xf8f: Stack[-1] = Stack[-4]
0xf90: Pop(1)
0xf91: Stack[-2] = "pt_map_k2q03_arfist" // @poff=678
0xf92: Stack[-1] = (int) 2
0xf93: Call2 0x1172

0xf94: Pop(3)
0xf95: PushEmpty(object)
0xf96: Call2 0x1161

0xf97: Pop(0)
0xf98: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1128
0xf99: Pop(1)
0xf9a: Return(); Pop(0)

0xf9b: PushEmpty()
0xf9c: Push("playsound") // @poff=1136
0xf9d: Push("givemoney") // @poff=1156
0xf9e: @ TriggerWorld(Stack[-2], Stack[-1])
0xf9f: Pop(2)
0xfa0: Return(); Pop(0)

0xfa1: PushEmpty()
0xfa2: Push("playsound") // @poff=1136
0xfa3: Push("giveitem") // @poff=1176
0xfa4: @ TriggerWorld(Stack[-2], Stack[-1])
0xfa5: Pop(2)
0xfa6: Return(); Pop(0)

0xfa7: PushEmpty()
0xfa8: Push("k2LaraVisit") // @poff=1194
0xfa9: Push((int) 1)
0xfaa: @ SetVariable(Stack[-2], Stack[-1])
0xfab: Pop(2)
0xfac: Return(); Pop(0)

0xfad: PushEmpty()
0xfae: Push("k4LaraVisit") // @poff=1218
0xfaf: Push((int) 1)
0xfb0: @ SetVariable(Stack[-2], Stack[-1])
0xfb1: Pop(2)
0xfb2: Return(); Pop(0)

0xfb3: PushEmpty()
0xfb4: PushEmpty(object, string, float)
0xfb5: PushEmpty(object)
0xfb6: Call2 0x1161

0xfb7: Stack[-1] = Stack[-4]
0xfb8: Pop(1)
0xfb9: Stack[-2] = "pt_map_alexandr" // @poff=852
0xfba: Stack[-1] = (int) 2
0xfbb: Call2 0x1172

0xfbc: Pop(3)
0xfbd: PushEmpty(object)
0xfbe: Call2 0x1161

0xfbf: Pop(0)
0xfc0: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1128
0xfc1: Pop(1)
0xfc2: Return(); Pop(0)

0xfc3: PushEmpty()
0xfc4: Push("etorfin is given") // @poff=1242
0xfc5: @ Trace(Stack[-1])
0xfc6: Pop(1)
0xfc7: PushEmpty(object, string, int)
0xfc8: Stack[-5] = Stack[-3]
0xfc9: Stack[-2] = "etorfin" // @poff=1276
0xfca: Stack[-1] = (int) 1
0xfcb: Call2 0xe3f
...
0xfce: PushEmpty()
0xfcf: PushEmpty(int, string)
0xfd0: Stack[-1] = "k2q02" // @poff=610
0xfd1: Call2 0xdfd

0xfd2: Pop(1)
0xfd3: Push((int) 1)
0xfd4: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xfd5: IF (Stack[-1] == 0) GOTO 0xfd8; Pop(1)

0xfd6: Stack[-2] = (bool) 1
0xfd7: Return(); Pop(0)

0xfd8: Stack[-2] = (bool) 0
0xfd9: Return(); Pop(0)

0xfda: PushEmpty()
0xfdb: PushEmpty(int, string)
0xfdc: Stack[-1] = "ook2Lara1" // @poff=622
0xfdd: Call2 0xdfd

0xfde: Pop(1)
0xfdf: Push((int) 0)
0xfe0: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xfe1: IF (Stack[-1] == 0) GOTO 0xfe4; Pop(1)

0xfe2: Stack[-2] = (bool) 1
0xfe3: Return(); Pop(0)

0xfe4: Stack[-2] = (bool) 0
0xfe5: Return(); Pop(0)

0xfe6: PushEmpty()
0xfe7: PushEmpty(int, string)
0xfe8: Stack[-1] = "k2q03" // @poff=642
0xfe9: Call2 0xdfd
...
0xfee: Stack[-2] = (bool) 1
0xfef: Return(); Pop(0)

0xff0: Stack[-2] = (bool) 0
0xff1: Return(); Pop(0)

0xff2: PushEmpty()
0xff3: PushEmpty(int, string)
0xff4: Stack[-1] = "k2q03" // @poff=642
0xff5: Call2 0xdfd

0xff6: Pop(1)
0xff7: Push((int) 2)
0xff8: Pop(2); Push((bool) Stack[-2] == Stack[-1])
...
0xffe: PushEmpty()
0xfff: PushEmpty(int, string)
0x1000: Stack[-1] = "k4q03" // @poff=796
0x1001: Call2 0xdfd

0x1002: Pop(1)
0x1003: Push((int) 0)
0x1004: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1005: IF (Stack[-1] == 0) GOTO 0x1008; Pop(1)

0x1006: Stack[-2] = (bool) 1
0x1007: Return(); Pop(0)

0x1008: Stack[-2] = (bool) 0
0x1009: Return(); Pop(0)

0x100a: PushEmpty()
0x100b: PushEmpty(int, string)
0x100c: Stack[-1] = "ook4Lara1" // @poff=908
0x100d: Call2 0xdfd

0x100e: Pop(1)
0x100f: Push((int) 0)
0x1010: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1011: IF (Stack[-1] == 0) GOTO 0x1014; Pop(1)

0x1012: Stack[-2] = (bool) 1
0x1013: Return(); Pop(0)

0x1014: Stack[-2] = (bool) 0
0x1015: Return(); Pop(0)

0x1016: PushEmpty()
0x1017: PushEmpty(int, string)
0x1018: Stack[-1] = "k4q03" // @poff=796
0x1019: Call2 0xdfd

0x101a: Pop(1)
0x101b: Push((int) 3)
0x101c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x101d: IF (Stack[-1] == 0) GOTO 0x1020; Pop(1)

0x101e: Stack[-2] = (bool) 1
0x101f: Return(); Pop(0)

0x1020: Stack[-2] = (bool) 0
0x1021: Return(); Pop(0)

0x1022: PushEmpty()
0x1023: PushEmpty(int, string)
0x1024: Stack[-1] = "k4q03" // @poff=796
0x1025: Call2 0xdfd

0x1026: Pop(1)
0x1027: Push((int) 4)
0x1028: Pop(2); Push((bool) Stack[-2] == Stack[-1])
...
0x102e: PushEmpty()
0x102f: PushEmpty(int, string)
0x1030: Stack[-1] = "ook4Lara2" // @poff=928
0x1031: Call2 0xdfd
...
0x103a: PushEmpty()
0x103b: PushEmpty(int, string)
0x103c: Stack[-1] = "k4q03" // @poff=796
0x103d: Call2 0xdfd

0x103e: Pop(1)
0x103f: Push((int) -1)
0x1040: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1041: IF (Stack[-1] == 0) GOTO 0x1044; Pop(1)

0x1042: Stack[-2] = (bool) 1
0x1043: Return(); Pop(0)

0x1044: Stack[-2] = (bool) 0
0x1045: Return(); Pop(0)

0x1046: PushEmpty()
0x1047: PushEmpty(int, string)
0x1048: Stack[-1] = "k6q01" // @poff=1292
0x1049: Call2 0xdfd

0x104a: Pop(1)
0x104b: Push((int) 2)
0x104c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x104d: IF (Stack[-1] == 0) GOTO 0x1050; Pop(1)

0x104e: Stack[-2] = (bool) 1
0x104f: Return(); Pop(0)

0x1050: Stack[-2] = (bool) 0
0x1051: Return(); Pop(0)

0x1052: PushEmpty()
0x1053: PushEmpty(int, string)
0x1054: Stack[-1] = "k6q01DankoPos" // @poff=1304
0x1055: Call2 0xdfd

0x1056: Pop(1)
0x1057: Push((int) 2)
0x1058: Pop(2); Push((bool) Stack[-2] > Stack[-1])
0x1059: IF (Stack[-1] == 0) GOTO 0x105c; Pop(1)

0x105a: Stack[-2] = (bool) 1
0x105b: Return(); Pop(0)

0x105c: Stack[-2] = (bool) 0
0x105d: Return(); Pop(0)

0x105e: PushEmpty()
0x105f: PushEmpty(int, string)
0x1060: Stack[-1] = "ook6Lara1" // @poff=1016
0x1061: Call2 0xdfd
...
0x106a: PushEmpty()
0x106b: PushEmpty(int, string)
0x106c: Stack[-1] = "k11q01" // @poff=1332
0x106d: Call2 0xdfd

0x106e: Pop(1)
0x106f: Push((int) 9)
0x1070: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1071: IF (Stack[-1] == 0) GOTO 0x1074; Pop(1)

0x1072: Stack[-2] = (bool) 1
0x1073: Return(); Pop(0)

0x1074: Stack[-2] = (bool) 0
0x1075: Return(); Pop(0)

0x1076: PushEmpty()
0x1077: PushEmpty(int, string)
0x1078: Stack[-1] = "ook11Lara1" // @poff=1106
0x1079: Call2 0xdfd
...
0x1082: PushEmpty(object, object)
0x1083: Push((int) 498)
0x1084: Push((int) 1)
0x1085: Push((int) 528065)
0x1086: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x1087: Pop(3)
0x1088: PushEmpty(bool, object, int)
0x1089: Stack[-4] = Stack[-2]
0x108a: Stack[-1] = (int) 480
0x108b: Call2 0x1145
...
0x1090: Push((int) 497)
0x1091: Push((int) 1)
0x1092: Push((int) 528064)
0x1093: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x1094: Pop(3)
0x1095: PushEmpty(bool, object, int)
0x1096: Stack[-4] = Stack[-2]
0x1097: Stack[-1] = (int) 480
0x1098: Call2 0x1145
...
0x109d: Push((int) 496)
0x109e: Push((int) 1)
0x109f: Push((int) 528063)
0x10a0: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x10a1: Pop(3)
0x10a2: PushEmpty(bool, object, int)
0x10a3: Stack[-4] = Stack[-2]
0x10a4: Stack[-1] = (int) 480
0x10a5: Call2 0x1145
...
0x10aa: Push((int) 495)
0x10ab: Push((int) 1)
0x10ac: Push((int) 528062)
0x10ad: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x10ae: Pop(3)
0x10af: PushEmpty(bool, object, int)
0x10b0: Stack[-4] = Stack[-2]
0x10b1: Stack[-1] = (int) 480
0x10b2: Call2 0x1145
...
0x10b5: Stack[-1] = 0
0x10b6: PushEmpty(object, object)
0x10b7: Push((int) 494)
0x10b8: Push((int) 1)
0x10b9: Push((int) 528061)
0x10ba: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x10bb: Pop(3)
0x10bc: PushEmpty(bool, object, int)
0x10bd: Stack[-4] = Stack[-2]
0x10be: Stack[-1] = (int) 480
0x10bf: Call2 0x1145
...
0x10c4: Push((int) 493)
0x10c5: Push((int) 1)
0x10c6: Push((int) 528060)
0x10c7: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x10c8: Pop(3)
0x10c9: PushEmpty(bool, object, int)
0x10ca: Stack[-4] = Stack[-2]
0x10cb: Stack[-1] = (int) 480
0x10cc: Call2 0x1145
...
0x10cf: Stack[-1] = 0
0x10d0: PushEmpty(object, object)
0x10d1: Push((int) 472)
0x10d2: Push((int) 2)
0x10d3: Push((int) 527788)
0x10d4: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x10d5: Pop(3)
0x10d6: PushEmpty(bool, object, int)
0x10d7: Stack[-4] = Stack[-2]
0x10d8: Stack[-1] = (int) 470
0x10d9: Call2 0x1145
...
0x1139: @ GetDiaryRoot(Stack[-1])
0x113a: Pop(0)
0x113b: Pop(0); Push((bool) Stack[-1] == 0)
0x113c: IF (Stack[-1] == 0) GOTO 0x1142; Pop(1)

0x113d: Push("Can't retrieve diary root") // @poff=1346
0x113e: @ Trace(Stack[-1])
0x113f: Pop(1)
0x1140: Stack[-3] = (bool) 0
0x1141: Return(); Pop(2)

0x1142: Stack[-1] = Stack[-3]
0x1143: Return(); Pop(2)

0x1144: Stack[-1] = 0
0x1145: PushEmpty(object, object, int, object, object, int)
0x1146: PushEmpty(object)
0x1147: Call2 0x1138

0x1148: Stack[-1] = Stack[-4]
0x1149: Pop(1)
0x114a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1398
0x114b: Pop(0)
0x114c: Pop(0); Push((bool) Stack[-2] == 0)
0x114d: IF (Stack[-1] == 0) GOTO 0x1154; Pop(1)

0x114e: Push("Can't find diary parent with id: ") // @poff=1403
0x114f: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1150: @ Trace(Stack[-1])
0x1151: Pop(1)
0x1152: Stack[-9] = (bool) 0
0x1153: Return(); Pop(6)

0x1154: @@ AddChild(Stack[-8]); Obj=2 // @poff=1471
0x1155: Pop(0)
0x1156: Push((int) 7)
0x1157: @ SendWorldWndMessage(Stack[-1])
0x1158: Pop(1)
0x1159: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1480
0x115a: Pop(0)
0x115b: @ SetDiarySection(Stack[-1])
0x115c: Pop(0)
0x115d: Stack[-9] = (bool) 0
0x115e: Return(); Pop(6)

0x115f: Stack[-2] = 0
0x1160: Stack[-3] = 0
0x1161: PushEmpty(object, object, object, object)
0x1162: @ GetMainOutdoorScene(Stack[-2])
0x1163: Pop(0)
0x1164: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1165: IF (Stack[-1] == 0) GOTO 0x116c; Pop(1)

0x1166: Push("Can't find main outdoor scene") // @poff=1492
0x1167: @ Trace(Stack[-1])
0x1168: Pop(1)
0x1169: Stack[-1] = 0
0x116a: Stack[-1] = Stack[-5]
0x116b: Return(); Pop(4)

0x116c: @@ GetMap(Stack[-1]); Obj=2 // @poff=1552
0x116d: Pop(0)
0x116e: Stack[-1] = Stack[-5]
0x116f: Return(); Pop(4)

0x1170: Stack[-1] = 0
0x1171: Stack[-2] = 0
0x1172: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x1173: @ GetMainOutdoorScene(Stack[-2])
0x1174: Pop(0)
0x1175: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1176: IF (Stack[-1] == 0) GOTO 0x117b; Pop(1)

0x1177: Push("Can't find main outdoor scene") // @poff=1492
0x1178: @ Trace(Stack[-1])
0x1179: Pop(1)
0x117a: Return(); Pop(8)

0x117b: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1559
0x117c: Pop(0)
0x117d: Pop(0); Push((bool) Stack[-1] == 0)
0x117e: IF (Stack[-1] == 0) GOTO 0x1185; Pop(1)

0x117f: Push("Warning: outdoor scene locator ") // @poff=1570
0x1180: Pop(1); Push(Stack[-1] + Stack[-11]);
0x1181: Push(" doesnt exist") // @poff=1634
0x1182: Pop(2); Push(Stack[-2] + Stack[-1]);
0x1183: @ Trace(Stack[-1])
0x1184: Pop(1)
0x1185: @@ GetMap(Stack[-11]); Obj=2 // @poff=1552
0x1186: Pop(0)
0x1187: Pop(0); PushNull((bool) Stack[-11] == 0)
0x1188: IF (Stack[-1] == 0) GOTO 0x118d; Pop(1)

0x1189: Push("Can't find map") // @poff=1662
0x118a: @ Trace(Stack[-1])
0x118b: Pop(1)
0x118c: Return(); Pop(8)

0x118d: Push(CvectorIndex(Stack[-4], 0))
0x118e: Push(CvectorIndex(Stack[-5], 2))
0x118f: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1692
0x1190: Pop(2)
0x1191: Return(); Pop(8)

0x1192: Stack[-2] = 0
0x1193: PushEmpty(int, int)
0x1194: Push("branch") // @poff=1705
0x1195: @ GetVariable(Stack[-1], Stack[-2])
0x1196: Pop(1)
0x1197: Push((int) 0)
0x1198: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x1199: IF (Stack[-1] == 0) GOTO 0x119d; Pop(1)

0x119a: Stack[-3] = (int) 1
0x119b: Return(); Pop(2)
...
0x11a0: Stack[-3] = (int) 2
0x11a1: Return(); Pop(2)

0x11a2: Stack[-3] = (int) 3
0x11a3: Return(); Pop(2)

0x11a4: PushEmpty()
0x11a5: Push(GlobalVars[1])
0x11a6: Pop(1); Push((bool) Stack[-1] == 0)
0x11a7: IF (Stack[-1] == 0) GOTO 0x11b1; Pop(1)

0x11a8: PushEmpty(int, object)
0x11a9: Stack[-3] = Stack[-1]
0x11aa: Push(-2, 1); TaskCall(2)
0x11ab: Call2 0x390

0x11ac: Pop(-2, 1); TaskReturn
0x11ad: Pop(2)
0x11ae: Push(GlobalVars[1])
0x11af: Stack[-1] = (bool) 1
0x11b0: GlobalVars[1] = Stack[-1]; Pop(1)
0x11b1: PushEmpty(bool, int)
0x11b2: Stack[-1] = (int) 2
0x11b3: Call2 0xe93

0x11b4: Pop(1)
0x11b5: IF (Stack[-1] == 0) GOTO 0x11bd; Pop(1)

0x11b6: PushEmpty(int, object)
0x11b7: Stack[-3] = Stack[-1]
0x11b8: Push(-2, 1); TaskCall(0)
0x11b9: Call2 0x0

0x11ba: Pop(-2, 1); TaskReturn
0x11bb: Pop(2)
0x11bc: Return(); Pop(0)

0x11bd: PushEmpty(bool, int)
0x11be: Stack[-1] = (int) 4
0x11bf: Call2 0xe93

0x11c0: Pop(1)
0x11c1: IF (Stack[-1] == 0) GOTO 0x11c9; Pop(1)

0x11c2: PushEmpty(int, object)
0x11c3: Stack[-3] = Stack[-1]
0x11c4: Push(-2, 1); TaskCall(4)
0x11c5: Call2 0x45b

0x11c6: Pop(-2, 1); TaskReturn
0x11c7: Pop(2)
0x11c8: Return(); Pop(0)

0x11c9: PushEmpty(bool, int)
0x11ca: Stack[-1] = (int) 6
0x11cb: Call2 0xe93

0x11cc: Pop(1)
0x11cd: IF (Stack[-1] == 0) GOTO 0x11d5; Pop(1)

0x11ce: PushEmpty(int, object)
0x11cf: Stack[-3] = Stack[-1]
0x11d0: Push(-2, 1); TaskCall(6)
0x11d1: Call2 0x674

0x11d2: Pop(-2, 1); TaskReturn
0x11d3: Pop(2)
0x11d4: Return(); Pop(0)

0x11d5: PushEmpty(bool, int)
0x11d6: Stack[-1] = (int) 11
0x11d7: Call2 0xe93
...
0x11db: Stack[-3] = Stack[-1]
0x11dc: Push(-2, 1); TaskCall(8)
0x11dd: Call2 0x7d9
...
0x11ed: PushEmpty(int, object)
0x11ee: Stack[-3] = Stack[-1]
0x11ef: Push(-2, 1); TaskCall(12)
0x11f0: Call2 0xab5

0x11f1: Pop(-2, 1); TaskReturn
0x11f2: Pop(2)
0x11f3: Return(); Pop(0)
