...
Strings:
	...
	W:flower
	W:ook2Laska1
	W:k5q03LaskaGotoAlbinos
	W:pt_k5q03_albinos_path12
	W:quest_k5_03
	W:ook5Laska1
	W:k5LaskaVisit
	W:k6LaskaVisit
	W:ook6Laska1
	W:k6q03LaskaGotoAlbinos
	W:pt_k6q03_albinos_path9
	W:quest_k6_03
	W:playsound
	W:giveitem
	W:mapmark
	...
	W:branch
	W:mt_laska
// @pool_raw:
// @pool_encoding:utf8
...
0x6c: Stack[-1] = "Autizm" // @poff=89
0x6d: Call2 0xc1

0x6e: Pop(1)
0x6f: Push((int) 524644)
0x70: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x71: Pop(1)
0x72: @@@ ClearReplies(); Obj=0 // @poff=114
0x73: Pop(0)
0x74: Push((int) 526298)
0x75: Push((int) 27579)
0x76: Push((int) 27578)
0x77: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x78: Pop(3)
...
0x80: Stack[-1] = "Neutral" // @poff=136
0x81: Call2 0xc1

0x82: Pop(1)
0x83: Push((int) 524648)
0x84: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x85: Pop(1)
0x86: @@@ ClearReplies(); Obj=0 // @poff=114
0x87: Pop(0)
0x88: PushEmpty(bool)
0x89: Stack[-1] = (bool) 0
...
0x97: Push((int) 43988)
0x98: Push((int) 26020)
0x99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x9a: Pop(3)
0x9b: Push((int) 524649)
0x9c: Push((int) -1)
0x9d: Push((int) 25988)
0x9e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x9f: Pop(3)
0xa0: GOTO 0xa3
...
0xb2: Push("all") // @poff=152
0xb3: Push("idle") // @poff=160
...
0xbb: Push("all") // @poff=152
0xbc: Push("idle") // @poff=160
...
0x117: Stack[-1] = "Autizm" // @poff=89
0x118: Call2 0xc1

0x119: Pop(1)
0x11a: Push((int) 524644)
0x11b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x11c: Pop(1)
0x11d: @@@ ClearReplies(); Obj=0 // @poff=114
0x11e: Pop(0)
0x11f: Push((int) 526298)
0x120: Push((int) 27579)
0x121: Push((int) 27578)
0x122: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x123: Pop(3)
0x124: Push((int) 526300)
0x125: Push((int) 27581)
0x126: Push((int) 27580)
0x127: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x128: Pop(3)
0x129: Return(); Pop(0)

0x12a: PushEmpty(string)
0x12b: Stack[-1] = "Neutral" // @poff=136
0x12c: Call2 0xc1

0x12d: Pop(1)
0x12e: Push((int) 524648)
0x12f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x130: Pop(1)
0x131: @@@ ClearReplies(); Obj=0 // @poff=114
0x132: Pop(0)
...
0x144: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x145: Pop(3)
0x146: Push((int) 524649)
0x147: Push((int) -1)
0x148: Push((int) 25988)
0x149: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x14a: Pop(3)
0x14b: Return(); Pop(0)
...
0x150: Stack[-1] = "Welldie" // @poff=170
0x151: Call2 0xc1

0x152: Pop(1)
0x153: Push((int) 541782)
0x154: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x155: Pop(1)
0x156: @@@ ClearReplies(); Obj=0 // @poff=114
0x157: Pop(0)
0x158: Push((int) 541783)
0x159: Push((int) 26021)
0x15a: Push((int) 43989)
0x15b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x15c: Pop(3)
0x15d: Push((int) 541784)
0x15e: Push((int) 43991)
0x15f: Push((int) 43990)
0x160: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x161: Pop(3)
0x162: Return(); Pop(0)
...
0x167: Stack[-1] = "Autizm" // @poff=89
0x168: Call2 0xc1

0x169: Pop(1)
0x16a: Push((int) 541785)
0x16b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x16c: Pop(1)
0x16d: @@@ ClearReplies(); Obj=0 // @poff=114
0x16e: Pop(0)
0x16f: Push((int) 541786)
0x170: Push((int) 43995)
0x171: Push((int) 43992)
0x172: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x173: Pop(3)
0x174: Push((int) 541787)
0x175: Push((int) 43994)
0x176: Push((int) 43993)
0x177: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x178: Pop(3)
0x179: Return(); Pop(0)
...
0x17e: Stack[-1] = "Autizm" // @poff=89
0x17f: Call2 0xc1

0x180: Pop(1)
0x181: Push((int) 541788)
0x182: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x183: Pop(1)
0x184: @@@ ClearReplies(); Obj=0 // @poff=114
0x185: Pop(0)
0x186: Push((int) 541791)
0x187: Push((int) 26021)
0x188: Push((int) 43997)
0x189: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x18a: Pop(3)
0x18b: Return(); Pop(0)
...
0x190: Stack[-1] = "Pain" // @poff=186
0x191: Call2 0xc1

0x192: Pop(1)
0x193: Push((int) 541789)
0x194: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x195: Pop(1)
0x196: @@@ ClearReplies(); Obj=0 // @poff=114
0x197: Pop(0)
0x198: Push((int) 541790)
0x199: Push((int) 26021)
0x19a: Push((int) 43996)
0x19b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x19c: Pop(3)
0x19d: Return(); Pop(0)
...
0x1a2: Stack[-1] = "Disturbance" // @poff=196
0x1a3: Call2 0xc1

0x1a4: Pop(1)
0x1a5: Push((int) 524682)
0x1a6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1a7: Pop(1)
0x1a8: @@@ ClearReplies(); Obj=0 // @poff=114
0x1a9: Pop(0)
0x1aa: Push((int) 541792)
0x1ab: Push((int) 44001)
0x1ac: Push((int) 44000)
0x1ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1ae: Pop(3)
0x1af: Push((int) 541794)
0x1b0: Push((int) 44001)
0x1b1: Push((int) 44002)
0x1b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1b3: Pop(3)
0x1b4: Return(); Pop(0)
...
0x1b9: Stack[-1] = "Disturbance" // @poff=196
0x1ba: Call2 0xc1

0x1bb: Pop(1)
0x1bc: Push((int) 541793)
0x1bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1be: Pop(1)
0x1bf: @@@ ClearReplies(); Obj=0 // @poff=114
0x1c0: Pop(0)
0x1c1: Push((int) 526310)
0x1c2: Push((int) 27593)
0x1c3: Push((int) 27592)
0x1c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1c5: Pop(3)
0x1c6: Push((int) 541702)
0x1c7: Push((int) 44004)
0x1c8: Push((int) 43885)
0x1c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1ca: Pop(3)
0x1cb: Return(); Pop(0)
...
0x1d0: Stack[-1] = "Neutral" // @poff=136
0x1d1: Call2 0xc1

0x1d2: Pop(1)
0x1d3: Push((int) 541795)
0x1d4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1d5: Pop(1)
0x1d6: @@@ ClearReplies(); Obj=0 // @poff=114
0x1d7: Pop(0)
0x1d8: Push((int) 541796)
0x1d9: Push((int) 27593)
0x1da: Push((int) 44005)
0x1db: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1dc: Pop(3)
0x1dd: Return(); Pop(0)
...
0x1e2: Stack[-1] = "Pain" // @poff=186
0x1e3: Call2 0xc1

0x1e4: Pop(1)
0x1e5: Push((int) 526311)
0x1e6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1e7: Pop(1)
0x1e8: @@@ ClearReplies(); Obj=0 // @poff=114
0x1e9: Pop(0)
0x1ea: Push((int) 526312)
0x1eb: Push((int) 27595)
0x1ec: Push((int) 27594)
0x1ed: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1ee: Pop(3)
0x1ef: Push((int) 541751)
0x1f0: Push((int) 43953)
0x1f1: Push((int) 43952)
0x1f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1f3: Pop(3)
0x1f4: Return(); Pop(0)
...
0x1f9: Stack[-1] = "Neutral" // @poff=136
0x1fa: Call2 0xc1

0x1fb: Pop(1)
0x1fc: Push((int) 541752)
0x1fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1fe: Pop(1)
0x1ff: @@@ ClearReplies(); Obj=0 // @poff=114
0x200: Pop(0)
...
0x20b: Stack[-1] = "Neutral" // @poff=136
0x20c: Call2 0xc1
...
0x24b: Stack[-1] = "Disturbance" // @poff=196
0x24c: Call2 0xc1
...
0x25b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x25c: Pop(3)
0x25d: Return(); Pop(0)
...
0x262: Stack[-1] = "Disturbance" // @poff=196
0x263: Call2 0xc1

0x264: Pop(1)
0x265: Push((int) 524646)
0x266: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x267: Pop(1)
0x268: @@@ ClearReplies(); Obj=0 // @poff=114
0x269: Pop(0)
0x26a: Push((int) 524647)
0x26b: Push((int) -1)
0x26c: Push((int) 25986)
0x26d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x26e: Pop(3)
0x26f: Push((int) 526306)
0x270: Push((int) 27589)
0x271: Push((int) 27588)
0x272: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x273: Pop(3)
0x274: Return(); Pop(0)
...
0x279: Stack[-1] = "Neutral" // @poff=136
0x27a: Call2 0xc1

0x27b: Pop(1)
0x27c: Push((int) 526307)
0x27d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x27e: Pop(1)
0x27f: @@@ ClearReplies(); Obj=0 // @poff=114
0x280: Pop(0)
0x281: Push((int) 526308)
0x282: Push((int) -1)
0x283: Push((int) 27590)
0x284: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x285: Pop(3)
0x286: Push((int) 526309)
0x287: Push((int) -1)
0x288: Push((int) 27591)
0x289: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x28a: Pop(3)
0x28b: Return(); Pop(0)
...
0x2a8: Pop(0)
0x2a9: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2aa: Pop(1)
0x2ab: PushEmpty(int)
0x2ac: Call2 0xdae

0x2ad: Pop(0)
0x2ae: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2af: Pop(1)
0x2b0: PushEmpty(string)
0x2b1: Call2 0xdb2

0x2b2: Pop(0)
0x2b3: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2b4: Pop(1)
0x2b5: PushEmpty(string)
0x2b6: Call2 0xdb4

0x2b7: Pop(0)
0x2b8: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2b9: Pop(1)
0x2ba: PushEmpty(int)
0x2bb: Call2 0xf86

0x2bc: Pop(0)
0x2bd: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2be: Pop(1)
0x2bf: Stack[-2] = (int) -1
...
0x2cb: Stack[-1] = Stack[-2]
0x2cc: Pop(1)
0x2cd: Call2 0xc9c

0x2ce: Pop(2)
0x2cf: PushEmpty(object, object)
0x2d0: Stack[-11] = Stack[-2]
0x2d1: Stack[-6] = Stack[-1]
0x2d2: Push(-2, 4); TaskCall(3)
0x2d3: Call2 0x2ea

0x2d4: Pop(-2, 4); TaskReturn
0x2d5: Pop(2)
0x2d6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2d7: Pop(0)
...
0x2da: @ sync()
0x2db: Pop(0)
0x2dc: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2dd: Pop(0)
0x2de: GOTO 0x2d8

0x2df: PushEmpty(object)
0x2e0: Stack[-10] = Stack[-1]
0x2e1: Call2 0xc8a

0x2e2: Pop(1)
0x2e3: @ StopDialog(Stack[-4])
0x2e4: Pop(0)
0x2e5: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2e6: Pop(0)
0x2e7: Stack[-2] = Stack[-10]
0x2e8: Return(); Pop(8)
...
0x2f1: Stack[-1] = "Neutral" // @poff=136
0x2f2: Call2 0x361
...
0x308: IF (Stack[-1] == 1) GOTO 0x318; Pop(1)
...
0x316: IF (Stack[-1] == 1) GOTO 0x318; Pop(1)
...
0x31c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x31d: Pop(3)
...
0x339: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x33a: Pop(3)
0x33b: Push((int) 525305)
0x33c: Push((int) -1)
0x33d: Push((int) 26673)
0x33e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x33f: Pop(3)
0x340: GOTO 0x343
...
0x352: Push("all") // @poff=152
0x353: Push("idle") // @poff=160
...
0x35b: Push("all") // @poff=152
0x35c: Push("idle") // @poff=160
...
0x3a3: Stack[-1] = "Neutral" // @poff=136
0x3a4: Call2 0x361
...
0x3ba: IF (Stack[-1] == 1) GOTO 0x3ca; Pop(1)
...
0x3c8: IF (Stack[-1] == 1) GOTO 0x3ca; Pop(1)
...
0x3ce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x3cf: Pop(3)
...
0x3eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x3ec: Pop(3)
0x3ed: Push((int) 525305)
0x3ee: Push((int) -1)
0x3ef: Push((int) 26673)
0x3f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x3f1: Pop(3)
0x3f2: Return(); Pop(0)
...
0x3f7: Stack[-1] = "Disturbance" // @poff=196
0x3f8: Call2 0x361

0x3f9: Pop(1)
0x3fa: Push((int) 525311)
0x3fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x3fc: Pop(1)
0x3fd: @@@ ClearReplies(); Obj=0 // @poff=114
0x3fe: Pop(0)
0x3ff: Push((int) 525312)
0x400: Push((int) 42889)
0x401: Push((int) 26680)
0x402: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x403: Pop(3)
0x404: Push((int) 540831)
0x405: Push((int) -1)
0x406: Push((int) 42888)
0x407: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x408: Pop(3)
0x409: Return(); Pop(0)
...
0x40e: Stack[-1] = "Pain" // @poff=186
0x40f: Call2 0x361

0x410: Pop(1)
0x411: Push((int) 540832)
0x412: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x413: Pop(1)
0x414: @@@ ClearReplies(); Obj=0 // @poff=114
0x415: Pop(0)
0x416: Push((int) 540833)
0x417: Push((int) -1)
0x418: Push((int) 42890)
0x419: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x41a: Pop(3)
0x41b: Push((int) 540834)
0x41c: Push((int) -1)
0x41d: Push((int) 42891)
0x41e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x41f: Pop(3)
0x420: Return(); Pop(0)
...
0x425: Stack[-1] = "Autizm" // @poff=89
0x426: Call2 0x361

0x427: Pop(1)
0x428: Push((int) 525299)
0x429: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x42a: Pop(1)
0x42b: @@@ ClearReplies(); Obj=0 // @poff=114
0x42c: Pop(0)
0x42d: Push((int) 529180)
0x42e: Push((int) 30631)
0x42f: Push((int) 30630)
0x430: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x431: Pop(3)
0x432: Push((int) 540812)
0x433: Push((int) 30633)
0x434: Push((int) 42864)
0x435: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x436: Pop(3)
0x437: Return(); Pop(0)
...
0x43c: Stack[-1] = "Autizm" // @poff=89
0x43d: Call2 0x361

0x43e: Pop(1)
0x43f: Push((int) 529181)
0x440: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x441: Pop(1)
0x442: @@@ ClearReplies(); Obj=0 // @poff=114
0x443: Pop(0)
0x444: Push((int) 529182)
0x445: Push((int) 30633)
0x446: Push((int) 30632)
0x447: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x448: Pop(3)
0x449: Return(); Pop(0)
...
0x44e: Stack[-1] = "Welldie" // @poff=170
0x44f: Call2 0x361

0x450: Pop(1)
0x451: Push((int) 529183)
0x452: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x453: Pop(1)
0x454: @@@ ClearReplies(); Obj=0 // @poff=114
0x455: Pop(0)
0x456: Push((int) 525300)
0x457: Push((int) 26669)
0x458: Push((int) 26668)
0x459: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x45a: Pop(3)
0x45b: Push((int) 540813)
0x45c: Push((int) 42867)
0x45d: Push((int) 42866)
0x45e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x45f: Pop(3)
0x460: Return(); Pop(0)
...
0x465: Stack[-1] = "Disturbance" // @poff=196
0x466: Call2 0x361

0x467: Pop(1)
0x468: Push((int) 540814)
0x469: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x46a: Pop(1)
0x46b: @@@ ClearReplies(); Obj=0 // @poff=114
0x46c: Pop(0)
0x46d: Push((int) 540819)
0x46e: Push((int) 26669)
0x46f: Push((int) 42872)
0x470: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x471: Pop(3)
0x472: Push((int) 540820)
0x473: Push((int) 42875)
0x474: Push((int) 42874)
0x475: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x476: Pop(3)
0x477: Return(); Pop(0)
...
0x47c: Stack[-1] = "Neutral" // @poff=136
0x47d: Call2 0x361

0x47e: Pop(1)
0x47f: Push((int) 540821)
0x480: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x481: Pop(1)
0x482: @@@ ClearReplies(); Obj=0 // @poff=114
0x483: Pop(0)
0x484: Push((int) 540822)
0x485: Push((int) 42868)
0x486: Push((int) 42876)
0x487: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x488: Pop(3)
0x489: Return(); Pop(0)
...
0x48e: Stack[-1] = "Welldie" // @poff=170
0x48f: Call2 0x361

0x490: Pop(1)
0x491: Push((int) 525301)
0x492: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x493: Pop(1)
0x494: @@@ ClearReplies(); Obj=0 // @poff=114
0x495: Pop(0)
0x496: Push((int) 525302)
0x497: Push((int) 42868)
0x498: Push((int) 26670)
0x499: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x49a: Pop(3)
0x49b: Push((int) 540826)
0x49c: Push((int) 42882)
0x49d: Push((int) 42881)
0x49e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x49f: Pop(3)
0x4a0: Return(); Pop(0)
...
0x4a5: Stack[-1] = "Welldie" // @poff=170
0x4a6: Call2 0x361

0x4a7: Pop(1)
0x4a8: Push((int) 540827)
0x4a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x4aa: Pop(1)
0x4ab: @@@ ClearReplies(); Obj=0 // @poff=114
0x4ac: Pop(0)
0x4ad: Push((int) 540828)
0x4ae: Push((int) 42879)
0x4af: Push((int) 42883)
0x4b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4b1: Pop(3)
0x4b2: Return(); Pop(0)
...
0x4b7: Stack[-1] = "Disturbance" // @poff=196
0x4b8: Call2 0x361

0x4b9: Pop(1)
0x4ba: Push((int) 540815)
0x4bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x4bc: Pop(1)
0x4bd: @@@ ClearReplies(); Obj=0 // @poff=114
0x4be: Pop(0)
0x4bf: Push((int) 540816)
0x4c0: Push((int) 42870)
0x4c1: Push((int) 42869)
0x4c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4c3: Pop(3)
0x4c4: Push((int) 540823)
0x4c5: Push((int) 42879)
0x4c6: Push((int) 42878)
0x4c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4c8: Pop(3)
0x4c9: Return(); Pop(0)
...
0x4ce: Stack[-1] = "Neutral" // @poff=136
0x4cf: Call2 0x361

0x4d0: Pop(1)
0x4d1: Push((int) 540824)
0x4d2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x4d3: Pop(1)
0x4d4: @@@ ClearReplies(); Obj=0 // @poff=114
0x4d5: Pop(0)
0x4d6: Push((int) 540825)
0x4d7: Push((int) 42870)
0x4d8: Push((int) 42880)
0x4d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4da: Pop(3)
0x4db: Return(); Pop(0)
...
0x4e0: Stack[-1] = "Pain" // @poff=186
0x4e1: Call2 0x361

0x4e2: Pop(1)
0x4e3: Push((int) 540817)
0x4e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x4e5: Pop(1)
0x4e6: @@@ ClearReplies(); Obj=0 // @poff=114
0x4e7: Pop(0)
0x4e8: Push((int) 540818)
0x4e9: Push((int) 26671)
0x4ea: Push((int) 42871)
0x4eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4ec: Pop(3)
0x4ed: Return(); Pop(0)
...
0x4f2: Stack[-1] = "Pain" // @poff=186
0x4f3: Call2 0x361

0x4f4: Pop(1)
0x4f5: Push((int) 525303)
0x4f6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x4f7: Pop(1)
0x4f8: @@@ ClearReplies(); Obj=0 // @poff=114
0x4f9: Pop(0)
0x4fa: Push((int) 525304)
0x4fb: Push((int) -1)
0x4fc: Push((int) 26672)
0x4fd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x4fe: Pop(3)
0x4ff: Push((int) 540829)
0x500: Push((int) 42887)
0x501: Push((int) 42886)
0x502: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x503: Pop(3)
0x504: Return(); Pop(0)
...
0x509: Stack[-1] = "Neutral" // @poff=136
0x50a: Call2 0x361

0x50b: Pop(1)
0x50c: Push((int) 540830)
0x50d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x50e: Pop(1)
0x50f: @@@ ClearReplies(); Obj=0 // @poff=114
0x510: Pop(0)
0x511: Push((int) 529184)
0x512: Push((int) -1)
0x513: Push((int) 30634)
0x514: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x515: Pop(3)
0x516: Return(); Pop(0)
...
0x533: Pop(0)
0x534: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x535: Pop(1)
0x536: PushEmpty(int)
0x537: Call2 0xdae

0x538: Pop(0)
0x539: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x53a: Pop(1)
0x53b: PushEmpty(string)
0x53c: Call2 0xdb2

0x53d: Pop(0)
0x53e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x53f: Pop(1)
0x540: PushEmpty(string)
0x541: Call2 0xdb4

0x542: Pop(0)
0x543: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x544: Pop(1)
0x545: PushEmpty(int)
0x546: Call2 0xf86

0x547: Pop(0)
0x548: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x549: Pop(1)
0x54a: Stack[-2] = (int) -1
...
0x556: Stack[-1] = Stack[-2]
0x557: Pop(1)
0x558: Call2 0xc9c

0x559: Pop(2)
0x55a: PushEmpty(object, object)
0x55b: Stack[-11] = Stack[-2]
0x55c: Stack[-6] = Stack[-1]
0x55d: Push(-2, 4); TaskCall(5)
0x55e: Call2 0x575

0x55f: Pop(-2, 4); TaskReturn
0x560: Pop(2)
0x561: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x562: Pop(0)
...
0x565: @ sync()
0x566: Pop(0)
0x567: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x568: Pop(0)
0x569: GOTO 0x563

0x56a: PushEmpty(object)
0x56b: Stack[-10] = Stack[-1]
0x56c: Call2 0xc8a

0x56d: Pop(1)
0x56e: @ StopDialog(Stack[-4])
0x56f: Pop(0)
0x570: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x571: Pop(0)
0x572: Stack[-2] = Stack[-10]
0x573: Return(); Pop(8)
...
0x57c: Stack[-1] = "Neutral" // @poff=136
0x57d: Call2 0x5af

0x57e: Pop(1)
0x57f: Push((int) 525498)
0x580: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x581: Pop(1)
0x582: @@@ ClearReplies(); Obj=0 // @poff=114
0x583: Pop(0)
...
0x5a0: Push("all") // @poff=152
0x5a1: Push("idle") // @poff=160
...
0x5a9: Push("all") // @poff=152
0x5aa: Push("idle") // @poff=160
...
0x5cf: Stack[-1] = "Neutral" // @poff=136
0x5d0: Call2 0x5af

0x5d1: Pop(1)
0x5d2: Push((int) 525498)
0x5d3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x5d4: Pop(1)
0x5d5: @@@ ClearReplies(); Obj=0 // @poff=114
0x5d6: Pop(0)
0x5d7: Push((int) 525499)
0x5d8: Push((int) -1)
0x5d9: Push((int) 26855)
0x5da: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x5db: Pop(3)
0x5dc: Push((int) 526256)
0x5dd: Push((int) -1)
0x5de: Push((int) 27530)
0x5df: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x5e0: Pop(3)
0x5e1: Return(); Pop(0)
...
0x5fe: Pop(0)
0x5ff: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x600: Pop(1)
0x601: PushEmpty(int)
0x602: Call2 0xdae

0x603: Pop(0)
0x604: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x605: Pop(1)
0x606: PushEmpty(string)
0x607: Call2 0xdb2

0x608: Pop(0)
0x609: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x60a: Pop(1)
0x60b: PushEmpty(string)
0x60c: Call2 0xdb4

0x60d: Pop(0)
0x60e: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x60f: Pop(1)
0x610: PushEmpty(int)
0x611: Call2 0xf86

0x612: Pop(0)
0x613: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x614: Pop(1)
0x615: Stack[-2] = (int) -1
...
0x626: Stack[-11] = Stack[-2]
0x627: Stack[-6] = Stack[-1]
0x628: Push(-2, 4); TaskCall(7)
0x629: Call2 0x640

0x62a: Pop(-2, 4); TaskReturn
0x62b: Pop(2)
0x62c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x62d: Pop(0)
...
0x630: @ sync()
0x631: Pop(0)
0x632: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x633: Pop(0)
0x634: GOTO 0x62e

0x635: PushEmpty(object)
0x636: Stack[-10] = Stack[-1]
0x637: Call2 0xc8a

0x638: Pop(1)
0x639: @ StopDialog(Stack[-4])
0x63a: Pop(0)
0x63b: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x63c: Pop(0)
0x63d: Stack[-2] = Stack[-10]
0x63e: Return(); Pop(8)
...
0x656: Stack[-1] = "Autizm" // @poff=89
0x657: Call2 0x69d

0x658: Pop(1)
0x659: Push((int) 525944)
0x65a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x65b: Pop(1)
0x65c: @@@ ClearReplies(); Obj=0 // @poff=114
0x65d: Pop(0)
0x65e: Push((int) 542433)
0x65f: Push((int) 44818)
0x660: Push((int) 44817)
0x661: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x662: Pop(3)
0x663: Push((int) 542438)
0x664: Push((int) 44824)
0x665: Push((int) 44822)
0x666: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x667: Pop(3)
0x668: GOTO 0x67f

0x669: PushEmpty(string)
0x66a: Stack[-1] = "Neutral" // @poff=136
0x66b: Call2 0x69d

0x66c: Pop(1)
0x66d: Push((int) 525948)
0x66e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x66f: Pop(1)
0x670: @@@ ClearReplies(); Obj=0 // @poff=114
0x671: Pop(0)
0x672: Push((int) 525949)
0x673: Push((int) -1)
0x674: Push((int) 27233)
0x675: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x676: Pop(3)
0x677: Push((int) 529092)
0x678: Push((int) -1)
0x679: Push((int) 30537)
0x67a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x67b: Pop(3)
0x67c: GOTO 0x67f
...
0x68e: Push("all") // @poff=152
0x68f: Push("idle") // @poff=160
...
0x697: Push("all") // @poff=152
0x698: Push("idle") // @poff=160
...
0x6e6: Stack[-1] = "Autizm" // @poff=89
0x6e7: Call2 0x69d

0x6e8: Pop(1)
0x6e9: Push((int) 525944)
0x6ea: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x6eb: Pop(1)
0x6ec: @@@ ClearReplies(); Obj=0 // @poff=114
0x6ed: Pop(0)
...
0x6f6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x6f7: Pop(3)
0x6f8: Return(); Pop(0)

0x6f9: PushEmpty(string)
0x6fa: Stack[-1] = "Neutral" // @poff=136
0x6fb: Call2 0x69d

0x6fc: Pop(1)
0x6fd: Push((int) 525948)
0x6fe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x6ff: Pop(1)
0x700: @@@ ClearReplies(); Obj=0 // @poff=114
0x701: Pop(0)
0x702: Push((int) 525949)
0x703: Push((int) -1)
0x704: Push((int) 27233)
0x705: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x706: Pop(3)
0x707: Push((int) 529092)
0x708: Push((int) -1)
0x709: Push((int) 30537)
0x70a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x70b: Pop(3)
0x70c: Return(); Pop(0)
...
0x711: Stack[-1] = "Disturbance" // @poff=196
0x712: Call2 0x69d

0x713: Pop(1)
0x714: Push((int) 542439)
0x715: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x716: Pop(1)
0x717: @@@ ClearReplies(); Obj=0 // @poff=114
0x718: Pop(0)
0x719: Push((int) 542440)
0x71a: Push((int) 44818)
0x71b: Push((int) 44825)
0x71c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x71d: Pop(3)
0x71e: Return(); Pop(0)
...
0x723: Stack[-1] = "Pain" // @poff=186
0x724: Call2 0x69d

0x725: Pop(1)
0x726: Push((int) 542434)
0x727: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x728: Pop(1)
0x729: @@@ ClearReplies(); Obj=0 // @poff=114
0x72a: Pop(0)
0x72b: Push((int) 542435)
0x72c: Push((int) 44820)
0x72d: Push((int) 44819)
0x72e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x72f: Pop(3)
0x730: Push((int) 542437)
0x731: Push((int) 44820)
0x732: Push((int) 44821)
0x733: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x734: Pop(3)
0x735: Return(); Pop(0)
...
0x73a: Stack[-1] = "Pain" // @poff=186
0x73b: Call2 0x69d

0x73c: Pop(1)
0x73d: Push((int) 542436)
0x73e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x73f: Pop(1)
0x740: @@@ ClearReplies(); Obj=0 // @poff=114
0x741: Pop(0)
0x742: Push((int) 529090)
0x743: Push((int) 30536)
0x744: Push((int) 30535)
0x745: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x746: Pop(3)
0x747: Push((int) 542441)
0x748: Push((int) 30536)
0x749: Push((int) 44826)
0x74a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x74b: Pop(3)
0x74c: Return(); Pop(0)
...
0x751: Stack[-1] = "Neutral" // @poff=136
0x752: Call2 0x69d

0x753: Pop(1)
0x754: Push((int) 529091)
0x755: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x756: Pop(1)
0x757: @@@ ClearReplies(); Obj=0 // @poff=114
0x758: Pop(0)
0x759: Push((int) 525945)
0x75a: Push((int) 27230)
0x75b: Push((int) 27229)
0x75c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x75d: Pop(3)
0x75e: Push((int) 542442)
0x75f: Push((int) 44831)
0x760: Push((int) 44830)
0x761: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x762: Pop(3)
0x763: Return(); Pop(0)
...
0x768: Stack[-1] = "Disturbance" // @poff=196
0x769: Call2 0x69d

0x76a: Pop(1)
0x76b: Push((int) 542443)
0x76c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x76d: Pop(1)
0x76e: @@@ ClearReplies(); Obj=0 // @poff=114
0x76f: Pop(0)
0x770: Push((int) 542444)
0x771: Push((int) 27230)
0x772: Push((int) 44832)
0x773: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x774: Pop(3)
0x775: Return(); Pop(0)
...
0x77a: Stack[-1] = "Welldie" // @poff=170
0x77b: Call2 0x69d

0x77c: Pop(1)
0x77d: Push((int) 525946)
0x77e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x77f: Pop(1)
0x780: @@@ ClearReplies(); Obj=0 // @poff=114
0x781: Pop(0)
0x782: Push((int) 529093)
0x783: Push((int) 30539)
0x784: Push((int) 30538)
0x785: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x786: Pop(3)
0x787: Return(); Pop(0)
...
0x78c: Stack[-1] = "Disturbance" // @poff=196
0x78d: Call2 0x69d
...
0x797: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x798: Pop(3)
...
0x7bb: Pop(0)
0x7bc: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x7bd: Pop(1)
0x7be: PushEmpty(int)
0x7bf: Call2 0xdae

0x7c0: Pop(0)
0x7c1: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x7c2: Pop(1)
0x7c3: PushEmpty(string)
0x7c4: Call2 0xdb2

0x7c5: Pop(0)
0x7c6: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x7c7: Pop(1)
0x7c8: PushEmpty(string)
0x7c9: Call2 0xdb4

0x7ca: Pop(0)
0x7cb: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x7cc: Pop(1)
0x7cd: PushEmpty(int)
0x7ce: Call2 0xf86

0x7cf: Pop(0)
0x7d0: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x7d1: Pop(1)
0x7d2: Stack[-2] = (int) -1
...
0x7e3: Stack[-11] = Stack[-2]
0x7e4: Stack[-6] = Stack[-1]
0x7e5: Push(-2, 4); TaskCall(9)
0x7e6: Call2 0x7fd

0x7e7: Pop(-2, 4); TaskReturn
0x7e8: Pop(2)
0x7e9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x7ea: Pop(0)
...
0x7ed: @ sync()
0x7ee: Pop(0)
0x7ef: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x7f0: Pop(0)
0x7f1: GOTO 0x7eb

0x7f2: PushEmpty(object)
0x7f3: Stack[-10] = Stack[-1]
0x7f4: Call2 0xc8a

0x7f5: Pop(1)
0x7f6: @ StopDialog(Stack[-4])
0x7f7: Pop(0)
0x7f8: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x7f9: Pop(0)
...
0x813: Stack[-1] = "Disturbance" // @poff=196
0x814: Call2 0x85a

0x815: Pop(1)
0x816: Push((int) 528802)
0x817: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x818: Pop(1)
0x819: @@@ ClearReplies(); Obj=0 // @poff=114
0x81a: Pop(0)
0x81b: Push((int) 526757)
0x81c: Push((int) 30208)
0x81d: Push((int) 28034)
0x81e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x81f: Pop(3)
0x820: Push((int) 528803)
0x821: Push((int) 30208)
0x822: Push((int) 30216)
0x823: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x824: Pop(3)
0x825: GOTO 0x83c

0x826: PushEmpty(string)
0x827: Stack[-1] = "Neutral" // @poff=136
0x828: Call2 0x85a
...
0x84b: Push("all") // @poff=152
0x84c: Push("idle") // @poff=160
...
0x854: Push("all") // @poff=152
0x855: Push("idle") // @poff=160
...
0x8a3: Stack[-1] = "Disturbance" // @poff=196
0x8a4: Call2 0x85a

0x8a5: Pop(1)
0x8a6: Push((int) 528802)
0x8a7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x8a8: Pop(1)
0x8a9: @@@ ClearReplies(); Obj=0 // @poff=114
0x8aa: Pop(0)
0x8ab: Push((int) 526757)
0x8ac: Push((int) 30208)
0x8ad: Push((int) 28034)
0x8ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8af: Pop(3)
0x8b0: Push((int) 528803)
0x8b1: Push((int) 30208)
0x8b2: Push((int) 30216)
0x8b3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8b4: Pop(3)
0x8b5: Return(); Pop(0)

0x8b6: PushEmpty(string)
0x8b7: Stack[-1] = "Neutral" // @poff=136
0x8b8: Call2 0x85a

0x8b9: Pop(1)
0x8ba: Push((int) 526758)
0x8bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x8bc: Pop(1)
0x8bd: @@@ ClearReplies(); Obj=0 // @poff=114
0x8be: Pop(0)
0x8bf: Push((int) 526759)
0x8c0: Push((int) -1)
0x8c1: Push((int) 28036)
0x8c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8c3: Pop(3)
0x8c4: Push((int) 528801)
0x8c5: Push((int) -1)
0x8c6: Push((int) 30214)
0x8c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8c8: Pop(3)
0x8c9: Return(); Pop(0)
...
0x8ce: Stack[-1] = "Disturbance" // @poff=196
0x8cf: Call2 0x85a

0x8d0: Pop(1)
0x8d1: Push((int) 528795)
0x8d2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x8d3: Pop(1)
0x8d4: @@@ ClearReplies(); Obj=0 // @poff=114
0x8d5: Pop(0)
0x8d6: Push((int) 528796)
0x8d7: Push((int) 30210)
0x8d8: Push((int) 30209)
0x8d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8da: Pop(3)
0x8db: Push((int) 542079)
0x8dc: Push((int) 44899)
0x8dd: Push((int) 44372)
0x8de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8df: Pop(3)
0x8e0: Return(); Pop(0)
...
0x8e5: Stack[-1] = "Pain" // @poff=186
0x8e6: Call2 0x85a

0x8e7: Pop(1)
0x8e8: Push((int) 542509)
0x8e9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x8ea: Pop(1)
0x8eb: @@@ ClearReplies(); Obj=0 // @poff=114
0x8ec: Pop(0)
0x8ed: Push((int) 542510)
0x8ee: Push((int) 44902)
0x8ef: Push((int) 44900)
0x8f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8f1: Pop(3)
0x8f2: Push((int) 542511)
0x8f3: Push((int) 44902)
0x8f4: Push((int) 44901)
0x8f5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x8f6: Pop(3)
0x8f7: Return(); Pop(0)
...
0x8fc: Stack[-1] = "Autizm" // @poff=89
0x8fd: Call2 0x85a

0x8fe: Pop(1)
0x8ff: Push((int) 542512)
0x900: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x901: Pop(1)
0x902: @@@ ClearReplies(); Obj=0 // @poff=114
0x903: Pop(0)
0x904: Push((int) 542513)
0x905: Push((int) 30210)
0x906: Push((int) 44904)
0x907: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x908: Pop(3)
...
0x913: Stack[-1] = "Welldie" // @poff=170
0x914: Call2 0x85a
...
0x92a: Stack[-1] = "Neutral" // @poff=136
0x92b: Call2 0x85a
...
0x93c: Stack[-1] = "Neutral" // @poff=136
0x93d: Call2 0x85a
...
0x966: Pop(0)
0x967: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x968: Pop(1)
0x969: PushEmpty(int)
0x96a: Call2 0xdae

0x96b: Pop(0)
0x96c: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x96d: Pop(1)
0x96e: PushEmpty(string)
0x96f: Call2 0xdb2

0x970: Pop(0)
0x971: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x972: Pop(1)
0x973: PushEmpty(string)
0x974: Call2 0xdb4

0x975: Pop(0)
0x976: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x977: Pop(1)
0x978: PushEmpty(int)
0x979: Call2 0xf86

0x97a: Pop(0)
0x97b: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x97c: Pop(1)
0x97d: Stack[-2] = (int) -1
...
0x98e: Stack[-11] = Stack[-2]
0x98f: Stack[-6] = Stack[-1]
0x990: Push(-2, 4); TaskCall(11)
0x991: Call2 0x9a8

0x992: Pop(-2, 4); TaskReturn
0x993: Pop(2)
0x994: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x995: Pop(0)
...
0x998: @ sync()
0x999: Pop(0)
0x99a: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x99b: Pop(0)
0x99c: GOTO 0x996

0x99d: PushEmpty(object)
0x99e: Stack[-10] = Stack[-1]
0x99f: Call2 0xc8a

0x9a0: Pop(1)
0x9a1: @ StopDialog(Stack[-4])
0x9a2: Pop(0)
0x9a3: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x9a4: Pop(0)
0x9a5: Stack[-2] = Stack[-10]
0x9a6: Return(); Pop(8)
...
0x9af: Stack[-1] = "Neutral" // @poff=136
0x9b0: Call2 0x9e7

0x9b1: Pop(1)
0x9b2: Push((int) 535284)
0x9b3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x9b4: Pop(1)
0x9b5: @@@ ClearReplies(); Obj=0 // @poff=114
0x9b6: Pop(0)
0x9b7: Push((int) 535285)
0x9b8: Push((int) 36962)
0x9b9: Push((int) 36961)
0x9ba: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x9bb: Pop(3)
...
0x9d8: Push("all") // @poff=152
0x9d9: Push("idle") // @poff=160
...
0x9e1: Push("all") // @poff=152
0x9e2: Push("idle") // @poff=160
...
0xa07: Stack[-1] = "Neutral" // @poff=136
0xa08: Call2 0x9e7

0xa09: Pop(1)
0xa0a: Push((int) 535284)
0xa0b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xa0c: Pop(1)
0xa0d: @@@ ClearReplies(); Obj=0 // @poff=114
0xa0e: Pop(0)
0xa0f: Push((int) 535285)
0xa10: Push((int) 36962)
0xa11: Push((int) 36961)
0xa12: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa13: Pop(3)
0xa14: Push((int) 535292)
0xa15: Push((int) -1)
0xa16: Push((int) 36968)
0xa17: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa18: Pop(3)
0xa19: Push((int) 535293)
0xa1a: Push((int) -1)
0xa1b: Push((int) 36969)
0xa1c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa1d: Pop(3)
0xa1e: Return(); Pop(0)
...
0xa23: Stack[-1] = "Neutral" // @poff=136
0xa24: Call2 0x9e7

0xa25: Pop(1)
0xa26: Push((int) 535286)
0xa27: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xa28: Pop(1)
0xa29: @@@ ClearReplies(); Obj=0 // @poff=114
0xa2a: Pop(0)
0xa2b: Push((int) 535287)
0xa2c: Push((int) 36964)
0xa2d: Push((int) 36963)
0xa2e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa2f: Pop(3)
0xa30: Push((int) 535291)
0xa31: Push((int) -1)
0xa32: Push((int) 36967)
0xa33: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa34: Pop(3)
0xa35: Return(); Pop(0)
...
0xa3a: Stack[-1] = "Neutral" // @poff=136
0xa3b: Call2 0x9e7

0xa3c: Pop(1)
0xa3d: Push((int) 535288)
0xa3e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xa3f: Pop(1)
0xa40: @@@ ClearReplies(); Obj=0 // @poff=114
0xa41: Pop(0)
0xa42: Push((int) 535289)
0xa43: Push((int) -1)
0xa44: Push((int) 36965)
0xa45: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa46: Pop(3)
0xa47: Push((int) 535290)
0xa48: Push((int) -1)
0xa49: Push((int) 36966)
0xa4a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa4b: Pop(3)
0xa4c: Return(); Pop(0)
...
0xab2: Stack[-1] = "Neutral" // @poff=136
0xab3: Call2 0xae5

0xab4: Pop(1)
0xab5: Push((int) 540539)
0xab6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xab7: Pop(1)
0xab8: @@@ ClearReplies(); Obj=0 // @poff=114
0xab9: Pop(0)
0xaba: Push((int) 540540)
0xabb: Push((int) -1)
0xabc: Push((int) 42549)
0xabd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xabe: Pop(3)
0xabf: Push((int) 540799)
0xac0: Push((int) -1)
0xac1: Push((int) 42848)
0xac2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xac3: Pop(3)
0xac4: GOTO 0xac7
...
0xad6: Push("all") // @poff=152
0xad7: Push("idle") // @poff=160
...
0xadf: Push("all") // @poff=152
0xae0: Push("idle") // @poff=160
...
0xb05: Stack[-1] = "Neutral" // @poff=136
0xb06: Call2 0xae5

0xb07: Pop(1)
0xb08: Push((int) 540539)
0xb09: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xb0a: Pop(1)
0xb0b: @@@ ClearReplies(); Obj=0 // @poff=114
0xb0c: Pop(0)
0xb0d: Push((int) 540540)
0xb0e: Push((int) -1)
0xb0f: Push((int) 42549)
0xb10: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xb11: Pop(3)
0xb12: Push((int) 540799)
0xb13: Push((int) -1)
0xb14: Push((int) 42848)
0xb15: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xb16: Pop(3)
0xb17: Return(); Pop(0)
...
0xb40: Stack[-3] = Stack[-1]
0xb41: Call2 0xc37

0xb42: Stack[-2] = Stack[-5]
0xb43: Pop(2)
0xb44: Return(); Pop(2)

0xb45: Stack[-1] = 0
0xb46: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xb47: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0xb48: @ RotateAsync(Stack[-2], Stack[-1])
0xb49: Pop(2)
0xb4a: Return(); Pop(0)

0xb4b: PushEmpty(object, bool, object, bool)
0xb4c: Push("player") // @poff=220
...
0xba9: Stack[-1] = "Neutral" // @poff=136
0xbaa: Call2 0xd26
...
0xbb8: Stack[-1] = "Neutral" // @poff=136
0xbb9: Call2 0xd26
...
0xbcf: Stack[-1] = "Neutral" // @poff=136
0xbd0: Call2 0xd26
...
0xc03: Stack[-3] = (int) 0
0xc04: Push("all") // @poff=152
0xc05: PushEmpty(string, int)
0xc06: Stack[-6] = Stack[-1]
0xc07: Call2 0xd96
...
0xc27: Pop(0)
0xc28: @@ GetPosition(Stack[-2]); Obj=7 // @poff=234
0xc29: Pop(0)
...
0xc38: @@ GetPosition(Stack[-1]); Obj=3 // @poff=234
0xc39: Pop(0)
0xc3a: PushEmpty(bool, cvector)
0xc3b: Stack[-3] = Stack[-1]
0xc3c: Call2 0xc2d

0xc3d: Stack[-2] = Stack[-6]
0xc3e: Pop(2)
0xc3f: Return(); Pop(2)
...
0xc46: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0xc47: Pop(0)
0xc48: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=246
0xc49: Pop(0)
...
0xcb5: Push("voice_common") // @poff=270
0xcb6: Push((int) 1)
...
0xcbd: Push("voice_common") // @poff=270
0xcbe: Push((int) 0)
...
0xcd0: Push("voice_common") // @poff=270
0xcd1: Push((int) 1)
...
0xcde: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0xcdf: Pop(1)
...
0xcf3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0xcf4: Pop(1)
0xcf5: PushEmpty(bool, string)
0xcf6: Stack[-3] = Stack[-1]
0xcf7: Call2 0xd45

0xcf8: Stack[-2] = Stack[-14]
0xcf9: Pop(2)
0xcfa: Return(); Pop(10)

0xcfb: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0xcfc: Push("d") // @poff=266
0xcfd: PushEmpty(int)
0xcfe: Call2 0xd87

0xcff: Pop(0)
0xd00: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd01: Push("m") // @poff=99
...
0xd09: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0xd0a: Pop(1)
...
0xd1e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0xd1f: Pop(1)
0xd20: PushEmpty(bool, string)
0xd21: Stack[-3] = Stack[-1]
0xd22: Call2 0xd45

0xd23: Stack[-2] = Stack[-14]
0xd24: Pop(2)
0xd25: Return(); Pop(10)
...
0xd31: Push("Can't find lsh animation : ") // @poff=324
...
0xd40: Push("Can't find lsh animation : ") // @poff=324
...
0xd64: Push((float)9.999999974752427e-07)
...
0xd7d: Pop(0)
0xd7e: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=390
0xd7f: Pop(0)
0xd80: Stack[-1] = Stack[-7]
0xd81: Return(); Pop(4)
...
0xdb2: Stack[-1] = "ui/NPC_Laska.png" // @poff=398
0xdb3: Return(); Pop(0)

0xdb4: Stack[-1] = "ui/NPC_Laska_b.png" // @poff=432
0xdb5: Return(); Pop(0)
...
0xdbd: Pop(1)
0xdbe: Stack[-2] = "pt_map_burah_home" // @poff=470
0xdbf: Stack[-1] = (int) 2
0xdc0: Call2 0xf65
...
0xdc4: Pop(0)
0xdc5: @@ ShowMap(Stack[-1]); Obj=2 // @poff=506
0xdc6: Pop(1)
0xdc7: Return(); Pop(0)

0xdc8: PushEmpty()
0xdc9: Push("ook1Laska1") // @poff=514
0xdca: Push((int) 1)
...
0xdce: PushEmpty()
0xdcf: Push("ook1Laska2") // @poff=536
0xdd0: Push((int) 1)
...
0xdd5: Push("k1q01LaskaGotoBurah") // @poff=558
0xdd6: Push((int) 1)
...
0xddc: Pop(1)
0xddd: Push("k1q01LaskaGotoBurah") // @poff=558
0xdde: Push("pt_map_burah_home") // @poff=470
0xddf: Push((int) 1)
...
0xde3: Pop(0)
0xde4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=598
0xde5: Pop(5)
0xde6: PushEmpty()
0xde7: Call2 0xedd
...
0xdf2: Pop(0)
0xdf3: Push("milk") // @poff=618
0xdf4: Push((int) 1)
0xdf5: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=628
0xdf6: Pop(2)
0xdf7: Push("bread") // @poff=645
0xdf8: Push((int) 1)
0xdf9: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=628
0xdfa: Pop(2)
0xdfb: Push("flower") // @poff=657
0xdfc: Push((int) 1)
0xdfd: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=628
0xdfe: Pop(2)
0xdff: Return(); Pop(2)

0xe00: PushEmpty()
0xe01: Push("ook2Laska1") // @poff=671
0xe02: Push((int) 1)
...
0xe09: Stack[-1] = Stack[-2]
0xe0a: Pop(1)
0xe0b: Push("k5q03LaskaGotoAlbinos") // @poff=693
0xe0c: Push("pt_k5q03_albinos_path12") // @poff=737
0xe0d: Push((int) 0)
...
0xe11: Pop(0)
0xe12: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=598
0xe13: Pop(5)
0xe14: PushEmpty()
0xe15: Call2 0xef7
...
0xe1b: Stack[-1] = "quest_k5_03" // @poff=785
0xe1c: Call2 0xd70
...
0xe1f: Stack[-1] = 0
0xe20: PushEmpty()
0xe21: Push("ook5Laska1") // @poff=809
0xe22: Push((int) 1)
...
0xe26: PushEmpty()
0xe27: Push("k5LaskaVisit") // @poff=831
0xe28: Push((int) 1)
...
0xe2c: PushEmpty()
0xe2d: Push("k6LaskaVisit") // @poff=857
0xe2e: Push((int) 1)
...
0xe32: PushEmpty()
0xe33: Push("ook6Laska1") // @poff=883
0xe34: Push((int) 1)
...
0xe3c: Pop(1)
0xe3d: Push("k6q03LaskaGotoAlbinos") // @poff=905
0xe3e: Push("pt_k6q03_albinos_path9") // @poff=949
0xe3f: Push((int) 0)
...
0xe43: Pop(0)
0xe44: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=598
0xe45: Pop(5)
0xe46: PushEmpty()
0xe47: Call2 0xf11
...
0xe4d: Stack[-1] = "quest_k6_03" // @poff=995
0xe4e: Call2 0xd70
...
0xe51: Stack[-1] = 0
0xe52: PushEmpty()
0xe53: Push("playsound") // @poff=1019
0xe54: Push("giveitem") // @poff=1039
0xe55: @ TriggerWorld(Stack[-2], Stack[-1])
0xe56: Pop(2)
0xe57: Return(); Pop(0)

0xe58: PushEmpty()
0xe59: Push("playsound") // @poff=1019
0xe5a: Push("mapmark") // @poff=1057
...
0xe60: Stack[-1] = "ook1Laska1" // @poff=514
0xe61: Call2 0xd6b
...
0xe78: Stack[-1] = "ook1Laska2" // @poff=536
0xe79: Call2 0xd6b
...
0xea0: Stack[-6] = Stack[-2]
0xea1: Stack[-1] = "flower" // @poff=657
0xea2: Call2 0xd7b
...
0xea6: Stack[-6] = Stack[-2]
0xea7: Stack[-1] = "milk" // @poff=618
0xea8: Call2 0xd7b
...
0xeae: Stack[-5] = Stack[-2]
0xeaf: Stack[-1] = "bread" // @poff=645
0xeb0: Call2 0xd7b
...
0xebb: Stack[-1] = "ook2Laska1" // @poff=671
0xebc: Call2 0xd6b
...
0xec7: Stack[-1] = "ook5Laska1" // @poff=809
0xec8: Call2 0xd6b
...
0xed3: Stack[-1] = "ook6Laska1" // @poff=883
0xed4: Call2 0xd6b
...
0xf30: Push("Can't retrieve diary root") // @poff=1085
0xf31: @ Trace(Stack[-1])
0xf32: Pop(1)
0xf33: Stack[-3] = (bool) 0
0xf34: Return(); Pop(2)

0xf35: Stack[-1] = Stack[-3]
0xf36: Return(); Pop(2)
...
0xf3b: Stack[-1] = Stack[-4]
0xf3c: Pop(1)
0xf3d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1137
0xf3e: Pop(0)
0xf3f: Pop(0); Push((bool) Stack[-2] == 0)
0xf40: IF (Stack[-1] == 0) GOTO 0xf47; Pop(1)

0xf41: Push("Can't find diary parent with id: ") // @poff=1142
...
0xf47: @@ AddChild(Stack[-8]); Obj=2 // @poff=1210
0xf48: Pop(0)
0xf49: Push((int) 7)
0xf4a: @ SendWorldWndMessage(Stack[-1])
0xf4b: Pop(1)
0xf4c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1219
0xf4d: Pop(0)
...
0xf56: Pop(0)
0xf57: Pop(0); PushNull((bool) Stack[-2] == 0)
0xf58: IF (Stack[-1] == 0) GOTO 0xf5f; Pop(1)

0xf59: Push("Can't find main outdoor scene") // @poff=1231
0xf5a: @ Trace(Stack[-1])
0xf5b: Pop(1)
0xf5c: Stack[-1] = 0
...
0xf5f: @@ GetMap(Stack[-1]); Obj=2 // @poff=1291
0xf60: Pop(0)
0xf61: Stack[-1] = Stack[-5]
0xf62: Return(); Pop(4)
...
0xf67: Pop(0)
0xf68: Pop(0); PushNull((bool) Stack[-2] == 0)
0xf69: IF (Stack[-1] == 0) GOTO 0xf6e; Pop(1)

0xf6a: Push("Can't find main outdoor scene") // @poff=1231
0xf6b: @ Trace(Stack[-1])
0xf6c: Pop(1)
0xf6d: Return(); Pop(8)

0xf6e: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1298
0xf6f: Pop(0)
0xf70: Pop(0); Push((bool) Stack[-1] == 0)
0xf71: IF (Stack[-1] == 0) GOTO 0xf78; Pop(1)

0xf72: Push("Warning: outdoor scene locator ") // @poff=1309
0xf73: Pop(1); Push(Stack[-1] + Stack[-11]);
0xf74: Push(" doesnt exist") // @poff=1373
0xf75: Pop(2); Push(Stack[-2] + Stack[-1]);
0xf76: @ Trace(Stack[-1])
0xf77: Pop(1)
0xf78: @@ GetMap(Stack[-11]); Obj=2 // @poff=1291
0xf79: Pop(0)
0xf7a: Pop(0); PushNull((bool) Stack[-11] == 0)
0xf7b: IF (Stack[-1] == 0) GOTO 0xf80; Pop(1)

0xf7c: Push("Can't find map") // @poff=1401
0xf7d: @ Trace(Stack[-1])
0xf7e: Pop(1)
0xf7f: Return(); Pop(8)
...
0xf82: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1431
0xf83: Pop(2)
0xf84: Return(); Pop(8)

0xf85: Stack[-2] = 0
0xf86: PushEmpty(int, int)
0xf87: Push("branch") // @poff=1444
...
0xf9e: Stack[-5] = Stack[-1]
0xf9f: Push(-2, 1); TaskCall(4)
0xfa0: Call2 0x524

0xfa1: Pop(-2, 1); TaskReturn
0xfa2: Pop(2)
0xfa3: Push("mt_laska") // @poff=1458
0xfa4: Push((int) 1)
