...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x77: Push("all") // @poff=138
0x78: Push("idle") // @poff=146
...
0x80: Push("all") // @poff=138
0x81: Push("idle") // @poff=146
...
0xe7: Pop(0)
0xe8: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xe9: Pop(1)
0xea: PushEmpty(int)
0xeb: Call2 0x749

0xec: Pop(0)
0xed: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xee: Pop(1)
0xef: PushEmpty(string)
0xf0: Call2 0x74d

0xf1: Pop(0)
0xf2: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xf3: Pop(1)
0xf4: PushEmpty(string)
0xf5: Call2 0x74f

0xf6: Pop(0)
0xf7: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0xf8: Pop(1)
0xf9: PushEmpty(int)
0xfa: Call2 0x7dc

0xfb: Pop(0)
0xfc: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0xfd: Pop(1)
0xfe: Stack[-2] = (int) -1
...
0x168: Push("all") // @poff=138
0x169: Push("idle") // @poff=146
...
0x1ea: Stack[-1] = "Untrust" // @poff=156
0x1eb: Call2 0x177
...
0x1fc: Stack[-1] = "Untrust" // @poff=156
0x1fd: Call2 0x177
...
0x241: Stack[-1] = "Untrust" // @poff=156
0x242: Call2 0x177
...
0x253: Stack[-1] = "Patronage" // @poff=182
0x254: Call2 0x177
...
0x277: Stack[-1] = "Discontent" // @poff=202
0x278: Call2 0x177
...
0x29b: Stack[-1] = "Discontent" // @poff=202
0x29c: Call2 0x177
...
0x2cd: Stack[-1] = "Discontent" // @poff=202
0x2ce: Call2 0x177
...
0x309: Pop(0)
0x30a: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x30b: Pop(1)
0x30c: PushEmpty(int)
0x30d: Call2 0x749

0x30e: Pop(0)
0x30f: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x310: Pop(1)
0x311: PushEmpty(string)
0x312: Call2 0x74d

0x313: Pop(0)
0x314: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x315: Pop(1)
0x316: PushEmpty(string)
0x317: Call2 0x74f

0x318: Pop(0)
0x319: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x31a: Pop(1)
0x31b: PushEmpty(int)
0x31c: Call2 0x7dc

0x31d: Pop(0)
0x31e: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x31f: Pop(1)
0x320: Stack[-2] = (int) -1
...
0x331: Stack[-11] = Stack[-2]
0x332: Stack[-6] = Stack[-1]
0x333: Push(-2, 4); TaskCall(5)
0x334: Call2 0x34b

0x335: Pop(-2, 4); TaskReturn
0x336: Pop(2)
0x337: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x338: Pop(0)
...
0x33b: @ sync()
0x33c: Pop(0)
0x33d: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x33e: Pop(0)
0x33f: GOTO 0x339

0x340: PushEmpty(object)
0x341: Stack[-10] = Stack[-1]
0x342: Call2 0x630

0x343: Pop(1)
0x344: @ StopDialog(Stack[-4])
0x345: Pop(0)
0x346: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x347: Pop(0)
0x348: Stack[-2] = Stack[-10]
0x349: Return(); Pop(8)
...
0x37b: Push("all") // @poff=138
0x37c: Push("idle") // @poff=146
...
0x3c6: Stack[-1] = "Neutral" // @poff=89
0x3c7: Call2 0x38a

0x3c8: Pop(1)
0x3c9: Push((int) 535286)
0x3ca: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3cb: Pop(1)
0x3cc: @@@ ClearReplies(); Obj=0 // @poff=116
0x3cd: Pop(0)
...
0x3dd: Stack[-1] = "Neutral" // @poff=89
0x3de: Call2 0x38a

0x3df: Pop(1)
0x3e0: Push((int) 535288)
0x3e1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3e2: Pop(1)
0x3e3: @@@ ClearReplies(); Obj=0 // @poff=116
0x3e4: Pop(0)
...
0x40c: Pop(0)
0x40d: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x40e: Pop(1)
0x40f: PushEmpty(int)
0x410: Call2 0x749

0x411: Pop(0)
0x412: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x413: Pop(1)
0x414: PushEmpty(string)
0x415: Call2 0x74d

0x416: Pop(0)
0x417: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x418: Pop(1)
0x419: PushEmpty(string)
0x41a: Call2 0x74f

0x41b: Pop(0)
0x41c: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x41d: Pop(1)
0x41e: PushEmpty(int)
0x41f: Call2 0x7dc

0x420: Pop(0)
0x421: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x422: Pop(1)
0x423: Stack[-2] = (int) -1
...
0x439: Pop(2)
0x43a: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x43b: Pop(0)
...
0x43e: @ sync()
0x43f: Pop(0)
0x440: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x441: Pop(0)
0x442: GOTO 0x43c

0x443: PushEmpty(object)
0x444: Stack[-10] = Stack[-1]
0x445: Call2 0x630

0x446: Pop(1)
0x447: @ StopDialog(Stack[-4])
0x448: Pop(0)
0x449: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x44a: Pop(0)
0x44b: Stack[-2] = Stack[-10]
0x44c: Return(); Pop(8)
...
0x479: Push("all") // @poff=138
0x47a: Push("idle") // @poff=146
...
0x4e8: Stack[-2] = Stack[-5]
0x4e9: Pop(2)
0x4ea: Return(); Pop(2)

0x4eb: Stack[-1] = 0
0x4ec: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4ed: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x4ee: @ RotateAsync(Stack[-2], Stack[-1])
0x4ef: Pop(2)
0x4f0: Return(); Pop(0)

0x4f1: PushEmpty(object, bool, object, bool)
0x4f2: Push("player") // @poff=224
...
0x5cd: Pop(0)
0x5ce: @@ GetPosition(Stack[-2]); Obj=7 // @poff=238
0x5cf: Pop(0)
...
0x5de: @@ GetPosition(Stack[-1]); Obj=3 // @poff=238
0x5df: Pop(0)
...
0x5ec: @@ GetPosition(Stack[-8]); Obj=20 // @poff=238
0x5ed: Pop(0)
0x5ee: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=250
0x5ef: Pop(0)
...
0x65b: Push("voice_common") // @poff=274
0x65c: Push((int) 1)
...
0x663: Push("voice_common") // @poff=274
0x664: Push((int) 0)
...
0x676: Push("voice_common") // @poff=274
0x677: Push((int) 1)
...
0x684: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x685: Pop(1)
...
0x6af: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x6b0: Pop(1)
...
0x6c4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x6c5: Pop(1)
0x6c6: PushEmpty(bool, string)
0x6c7: Stack[-3] = Stack[-1]
0x6c8: Call2 0x6eb

0x6c9: Stack[-2] = Stack[-14]
0x6ca: Pop(2)
0x6cb: Return(); Pop(10)
...
0x6d7: Push("Can't find lsh animation : ") // @poff=332
...
0x6e6: Push("Can't find lsh animation : ") // @poff=332
...
0x70a: Push((float)9.999999974752427e-07)
...
0x74d: Stack[-1] = "ui/NPC_Mat.png" // @poff=388
0x74e: Return(); Pop(0)

0x74f: Stack[-1] = "ui/NPC_Mat_b.png" // @poff=418
0x750: Return(); Pop(0)
...
0x765: Stack[-2] = "quest_k8_01" // @poff=464
0x766: Stack[-1] = "unlock_boiny" // @poff=488
0x767: Call2 0x716
...
0x76f: Stack[-2] = "quest_k8_01" // @poff=464
0x770: Stack[-1] = "fail" // @poff=514
0x771: Call2 0x716
...
0x7b8: Push("Can't retrieve diary root") // @poff=524
0x7b9: @ Trace(Stack[-1])
0x7ba: Pop(1)
...
0x7c3: Stack[-1] = Stack[-4]
0x7c4: Pop(1)
0x7c5: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=576
0x7c6: Pop(0)
0x7c7: Pop(0); Push((bool) Stack[-2] == 0)
0x7c8: IF (Stack[-1] == 0) GOTO 0x7cf; Pop(1)

0x7c9: Push("Can't find diary parent with id: ") // @poff=581
...
0x7cf: @@ AddChild(Stack[-8]); Obj=2 // @poff=649
0x7d0: Pop(0)
0x7d1: Push((int) 7)
0x7d2: @ SendWorldWndMessage(Stack[-1])
0x7d3: Pop(1)
0x7d4: @@ GetCategory(Stack[-1]); Obj=8 // @poff=658
0x7d5: Pop(0)
