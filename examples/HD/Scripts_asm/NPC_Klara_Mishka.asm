...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x16c: Push("all") // @poff=138
0x16d: Push("idle") // @poff=146
...
0x1f4: Pop(0)
0x1f5: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x1f6: Pop(1)
0x1f7: PushEmpty(int)
0x1f8: Call2 0x520

0x1f9: Pop(0)
0x1fa: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x1fb: Pop(1)
0x1fc: PushEmpty(string)
0x1fd: Call2 0x524

0x1fe: Pop(0)
0x1ff: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x200: Pop(1)
0x201: PushEmpty(string)
0x202: Call2 0x526

0x203: Pop(0)
0x204: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x205: Pop(1)
0x206: PushEmpty(int)
0x207: Call2 0x52a

0x208: Pop(0)
0x209: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x20a: Pop(1)
0x20b: Stack[-2] = (int) -1
...
0x226: @ sync()
0x227: Pop(0)
0x228: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x229: Pop(0)
0x22a: GOTO 0x224

0x22b: PushEmpty(object)
0x22c: Stack[-10] = Stack[-1]
0x22d: Call2 0x418

0x22e: Pop(1)
0x22f: @ StopDialog(Stack[-4])
0x230: Pop(0)
0x231: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x232: Pop(0)
0x233: Stack[-2] = Stack[-10]
0x234: Return(); Pop(8)
...
0x2d0: Stack[-2] = Stack[-5]
0x2d1: Pop(2)
0x2d2: Return(); Pop(2)

0x2d3: Stack[-1] = 0
0x2d4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2d5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2d6: @ RotateAsync(Stack[-2], Stack[-1])
0x2d7: Pop(2)
0x2d8: Return(); Pop(0)

0x2d9: PushEmpty(object, bool, object, bool)
0x2da: Push("player") // @poff=156
...
0x391: Stack[-3] = (int) 0
0x392: Push("all") // @poff=138
0x393: PushEmpty(string, int)
0x394: Stack[-6] = Stack[-1]
0x395: Call2 0x508
...
0x3b5: Pop(0)
0x3b6: @@ GetPosition(Stack[-2]); Obj=7 // @poff=170
0x3b7: Pop(0)
...
0x3c2: Pop(2)
0x3c3: Stack[-1] = Stack[-8]
0x3c4: Return(); Pop(6)

0x3c5: PushEmpty(cvector, cvector)
0x3c6: @@ GetPosition(Stack[-1]); Obj=3 // @poff=170
0x3c7: Pop(0)
...
0x3d4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=170
0x3d5: Pop(0)
0x3d6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=182
0x3d7: Pop(0)
...
0x3fd: Pop(0)
0x3fe: Push((bool) 1)
0x3ff: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x400: Pop(1)
0x401: Push(CvectorIndex(Stack[-4], 0))
0x402: Push(CvectorIndex(Stack[-5], 2))
0x403: @ Rotate(Stack[-2], Stack[-1])
0x404: Pop(2)
...
0x40a: Push("head") // @poff=196
0x40b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x40c: Pop(1)
0x40d: Push(Stack[-1])
0x40e: IF (Stack[-1] == 0) GOTO 0x412; Pop(1)

0x40f: Push("head") // @poff=196
0x410: @ LookAsyncCamera(Stack[-1])
0x411: Pop(1)
0x412: @ CameraWaitForPlayFinish()
0x413: Pop(0)
0x414: @ ResumeWorld()
0x415: Pop(0)
0x416: Stack[-21] = (bool) 1
0x417: Return(); Pop(18)

0x418: PushEmpty(bool, bool)
0x419: Push((bool) 1)
0x41a: @ CameraSwitchToNormal(Stack[-1])
0x41b: Pop(1)
...
0x422: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x423: Pop(1)
0x424: Push(Stack[-1])
0x425: IF (Stack[-1] == 0) GOTO 0x429; Pop(1)

0x426: Push("head") // @poff=196
0x427: @ UnlookAsync(Stack[-1])
0x428: Pop(1)
0x429: Return(); Pop(2)

0x42a: PushEmpty(int, int, int, int)
0x42b: Push("voice_common") // @poff=206
0x42c: @ GetVariable(Stack[-1], Stack[-3])
0x42d: Pop(1)
0x42e: Push(Stack[-2])
0x42f: IF (Stack[-1] == 0) GOTO 0x450; Pop(1)
...
0x435: IF (Stack[-1] == 0) GOTO 0x43e; Pop(1)

0x436: PushEmpty(bool, object)
0x437: Stack[-7] = Stack[-1]
0x438: Call2 0x489
...
0x443: Push("voice_common") // @poff=206
0x444: Push((int) 1)
0x445: Pop(1); Push(Stack[-4] + Stack[-1]);
0x446: Push((int) 3)
...
0x45e: Push("voice_common") // @poff=206
0x45f: Push((int) 1)
...
0x464: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x465: Stack[-5] = "c" // @poff=232
0x466: Stack[-4] = (int) 0
0x467: Push((int) 1)
0x468: IF (Stack[-1] == 0) GOTO 0x474; Pop(1)

0x469: Push((int) 1)
0x46a: Pop(1); Push(Stack[-5] + Stack[-1]);
0x46b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x46c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=236
0x46d: Pop(1)
0x46e: Pop(0); Push((bool) Stack[-3] == 0)
0x46f: IF (Stack[-1] == 0) GOTO 0x471; Pop(1)

0x470: GOTO 0x474

0x471: Push((int) 1)
0x472: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x473: GOTO 0x467

0x474: Pop(0); Push((bool) Stack[-4] == 0)
...
0x478: Stack[-2] = (int) 0
0x479: Push((int) 1)
0x47a: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x47b: IF (Stack[-1] == 0) GOTO 0x47e; Pop(1)

0x47c: @ irand(Stack[-2], Stack[-4])
0x47d: Pop(0)
0x47e: Push((int) 1)
0x47f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x480: Pop(1); Push(Stack[-6] + Stack[-1]);
0x481: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x482: Pop(1)
0x483: PushEmpty(bool, string)
0x484: Stack[-3] = Stack[-1]
0x485: Call2 0x4d3

0x486: Stack[-2] = Stack[-14]
0x487: Pop(2)
0x488: Return(); Pop(10)

0x489: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x48a: Push("d") // @poff=202
0x48b: PushEmpty(int)
0x48c: Call2 0x4f9

0x48d: Pop(0)
0x48e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x48f: Push("m") // @poff=260
0x490: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x491: Stack[-4] = (int) 0
0x492: Push((int) 1)
0x493: IF (Stack[-1] == 0) GOTO 0x49f; Pop(1)

0x494: Push((int) 1)
0x495: Pop(1); Push(Stack[-5] + Stack[-1]);
0x496: Pop(1); Push(Stack[-6] + Stack[-1]);
0x497: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=236
0x498: Pop(1)
...
0x49c: Push((int) 1)
0x49d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x49e: GOTO 0x492

0x49f: Pop(0); Push((bool) Stack[-4] == 0)
0x4a0: IF (Stack[-1] == 0) GOTO 0x4a3; Pop(1)

0x4a1: Stack[-12] = (bool) 0
0x4a2: Return(); Pop(10)

0x4a3: Stack[-2] = (int) 0
0x4a4: Push((int) 1)
0x4a5: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x4a6: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a7: @ irand(Stack[-2], Stack[-4])
0x4a8: Pop(0)
0x4a9: Push((int) 1)
0x4aa: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4ab: Pop(1); Push(Stack[-6] + Stack[-1]);
0x4ac: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x4ad: Pop(1)
0x4ae: PushEmpty(bool, string)
0x4af: Stack[-3] = Stack[-1]
0x4b0: Call2 0x4d3

0x4b1: Stack[-2] = Stack[-14]
0x4b2: Pop(2)
0x4b3: Return(); Pop(10)

0x4b4: PushEmpty(bool, float, float, bool, float, float)
0x4b5: @ lshHasAnimation(Stack[-3], Stack[-7])
0x4b6: Pop(0)
0x4b7: Push(Stack[-3])
0x4b8: IF (Stack[-1] == 0) GOTO 0x4bf; Pop(1)

0x4b9: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x4ba: Pop(0)
0x4bb: Push((bool) 0)
...
0x4bf: Push("Can't find lsh animation : ") // @poff=264
0x4c0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x4c1: @ Trace(Stack[-1])
0x4c2: Pop(1)
0x4c3: Return(); Pop(6)

0x4c4: PushEmpty(bool, float, float, bool, float, float)
0x4c5: @ lshHasAnimation(Stack[-3], Stack[-8])
0x4c6: Pop(0)
0x4c7: Push(Stack[-3])
0x4c8: IF (Stack[-1] == 0) GOTO 0x4ce; Pop(1)

0x4c9: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x4ca: Pop(0)
0x4cb: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x4cc: Pop(0)
0x4cd: GOTO 0x4d2

0x4ce: Push("Can't find lsh animation : ") // @poff=264
0x4cf: Pop(1); Push(Stack[-1] + Stack[-9]);
0x4d0: @ Trace(Stack[-1])
0x4d1: Pop(1)
0x4d2: Return(); Pop(6)

0x4d3: PushEmpty(bool, bool)
0x4d4: PushEmpty(bool)
0x4d5: Call2 0x528

0x4d6: Pop(0)
0x4d7: IF (Stack[-1] == 0) GOTO 0x4e0; Pop(1)

0x4d8: @ lshHasSpeech(Stack[-1], Stack[-3])
0x4d9: Pop(0)
0x4da: Push(Stack[-1])
0x4db: IF (Stack[-1] == 0) GOTO 0x4e0; Pop(1)

0x4dc: @ lshPlaySpeech(Stack[-3])
0x4dd: Pop(0)
0x4de: Stack[-4] = (bool) 1
0x4df: Return(); Pop(2)

0x4e0: Stack[-4] = (bool) 0
0x4e1: Return(); Pop(2)
...
0x4ee: Stack[-1] = 0
0x4ef: PushEmpty(float, float)
0x4f0: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4f1: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x4f2: Push((float)9.999999974752427e-07)
0x4f3: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x4f4: IF (Stack[-1] == 0) GOTO 0x4f7; Pop(1)

0x4f5: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x4f6: Return(); Pop(2)

0x4f7: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x4f8: Return(); Pop(2)

0x4f9: PushEmpty(float, float)
0x4fa: @ GetGameTime(Stack[-1])
0x4fb: Pop(0)
0x4fc: Push((int) 1)
0x4fd: PushEmpty(int)
0x4fe: Push((int) 24)
0x4ff: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x500: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x501: Return(); Pop(2)
...
0x505: Pop(0)
0x506: Stack[-3] = Stack[-1] == Stack[-2]; Pop(1);
0x507: Return(); Pop(0)

0x508: PushEmpty(string, string)
0x509: Stack[-1] = "idle" // @poff=146
0x50a: Push(Stack[-3])
...
0x520: Stack[-1] = (int) 515546
0x521: Return(); Pop(0)

0x522: Stack[-1] = (int) 502871
0x523: Return(); Pop(0)

0x524: Stack[-1] = "ui/NPC_Mishka.png" // @poff=320
0x525: Return(); Pop(0)

0x526: Stack[-1] = "ui/NPC_Mishka_b.png" // @poff=356
0x527: Return(); Pop(0)
...
0x53b: PushEmpty()
0x53c: Push(GlobalVars[1])
0x53d: Pop(1); Push((bool) Stack[-1] == 0)
0x53e: IF (Stack[-1] == 0) GOTO 0x548; Pop(1)

0x53f: PushEmpty(int, object)
0x540: Stack[-3] = Stack[-1]
0x541: Push(-2, 1); TaskCall(0)
0x542: Call2 0x0

0x543: Pop(-2, 1); TaskReturn
0x544: Pop(2)
0x545: Push(GlobalVars[1])
0x546: Stack[-1] = (bool) 1
0x547: GlobalVars[1] = Stack[-1]; Pop(1)
0x548: PushEmpty(bool, int)
0x549: Stack[-1] = (int) 12
0x54a: Call2 0x502
...
0x54e: Stack[-3] = Stack[-1]
0x54f: Push(-2, 1); TaskCall(2)
0x550: Call2 0xe2

0x551: Pop(-2, 1); TaskReturn
0x552: Pop(2)
0x553: Return(); Pop(0)

0x554: PushEmpty(int, object)
0x555: Stack[-3] = Stack[-1]
0x556: Push(-2, 1); TaskCall(4)
0x557: Call2 0x1e5

0x558: Pop(-2, 1); TaskReturn
0x559: Pop(2)
0x55a: Return(); Pop(0)
