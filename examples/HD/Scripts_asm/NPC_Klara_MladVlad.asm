...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
...
0x186: Stack[-1] = "Neutral" // @poff=125
0x187: Call2 0x21b

0x188: Pop(1)
0x189: Push((int) 525337)
0x18a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x18b: Pop(1)
0x18c: @@@ ClearReplies(); Obj=0 // @poff=152
0x18d: Pop(0)
0x18e: Push((int) 525338)
0x18f: Push((int) 44250)
0x190: Push((int) 26706)
0x191: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x192: Pop(3)
0x193: Push((int) 539465)
0x194: Push((int) 44260)
0x195: Push((int) 41388)
0x196: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x197: Pop(3)
0x198: GOTO 0x1fd

0x199: PushEmpty(string)
0x19a: Stack[-1] = "Neutral" // @poff=125
0x19b: Call2 0x21b

0x19c: Pop(1)
0x19d: Push((int) 525237)
0x19e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x19f: Pop(1)
0x1a0: @@@ ClearReplies(); Obj=0 // @poff=152
0x1a1: Pop(0)
...
0x1aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1ab: Pop(3)
...
0x1bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1be: Pop(3)
...
0x1d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1d1: Pop(3)
...
0x1e4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1e5: Pop(3)
...
0x1ee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1ef: Pop(3)
0x1f0: Push((int) 525243)
0x1f1: Push((int) -1)
0x1f2: Push((int) 26611)
0x1f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1f4: Pop(3)
0x1f5: Push((int) 529207)
0x1f6: Push((int) -1)
0x1f7: Push((int) 30658)
0x1f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1f9: Pop(3)
0x1fa: GOTO 0x1fd
...
0x20c: Push("all") // @poff=28
0x20d: Push("idle") // @poff=18
...
0x215: Push("all") // @poff=28
0x216: Push("idle") // @poff=18
...
0x2c2: Stack[-1] = "Neutral" // @poff=125
0x2c3: Call2 0x21b

0x2c4: Pop(1)
0x2c5: Push((int) 525337)
0x2c6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x2c7: Pop(1)
0x2c8: @@@ ClearReplies(); Obj=0 // @poff=152
0x2c9: Pop(0)
0x2ca: Push((int) 525338)
0x2cb: Push((int) 44250)
0x2cc: Push((int) 26706)
0x2cd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2ce: Pop(3)
0x2cf: Push((int) 539465)
0x2d0: Push((int) 44260)
0x2d1: Push((int) 41388)
0x2d2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2d3: Pop(3)
0x2d4: Return(); Pop(0)

0x2d5: PushEmpty(string)
0x2d6: Stack[-1] = "Neutral" // @poff=125
0x2d7: Call2 0x21b

0x2d8: Pop(1)
0x2d9: Push((int) 525237)
0x2da: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x2db: Pop(1)
0x2dc: @@@ ClearReplies(); Obj=0 // @poff=152
0x2dd: Pop(0)
...
0x2e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2e7: Pop(3)
...
0x2f9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2fa: Pop(3)
...
0x30c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x30d: Pop(3)
...
0x320: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x321: Pop(3)
...
0x32a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x32b: Pop(3)
0x32c: Push((int) 525243)
0x32d: Push((int) -1)
0x32e: Push((int) 26611)
0x32f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x330: Pop(3)
0x331: Push((int) 529207)
0x332: Push((int) -1)
0x333: Push((int) 30658)
0x334: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x335: Pop(3)
0x336: Return(); Pop(0)
...
0x33b: Stack[-1] = "Untrust" // @poff=174
0x33c: Call2 0x21b

0x33d: Pop(1)
0x33e: Push((int) 525376)
0x33f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x340: Pop(1)
0x341: @@@ ClearReplies(); Obj=0 // @poff=152
0x342: Pop(0)
0x343: Push((int) 542113)
0x344: Push((int) 44419)
0x345: Push((int) 44418)
0x346: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x347: Pop(3)
0x348: Return(); Pop(0)
...
0x34d: Stack[-1] = "Untrust" // @poff=174
0x34e: Call2 0x21b

0x34f: Pop(1)
0x350: Push((int) 542114)
0x351: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x352: Pop(1)
0x353: @@@ ClearReplies(); Obj=0 // @poff=152
0x354: Pop(0)
...
0x35f: Stack[-1] = "Untrust" // @poff=174
0x360: Call2 0x21b

0x361: Pop(1)
0x362: Push((int) 542116)
0x363: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x364: Pop(1)
0x365: @@@ ClearReplies(); Obj=0 // @poff=152
0x366: Pop(0)
0x367: Push((int) 525377)
0x368: Push((int) 26747)
0x369: Push((int) 26745)
0x36a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x36b: Pop(3)
...
0x376: Stack[-1] = "Neutral" // @poff=125
0x377: Call2 0x21b

0x378: Pop(1)
0x379: Push((int) 542118)
0x37a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x37b: Pop(1)
0x37c: @@@ ClearReplies(); Obj=0 // @poff=152
0x37d: Pop(0)
0x37e: Push((int) 525378)
0x37f: Push((int) -1)
0x380: Push((int) 26746)
0x381: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x382: Pop(3)
0x383: Return(); Pop(0)
...
0x388: Stack[-1] = "Sly" // @poff=190
0x389: Call2 0x21b

0x38a: Pop(1)
0x38b: Push((int) 525379)
0x38c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x38d: Pop(1)
0x38e: @@@ ClearReplies(); Obj=0 // @poff=152
0x38f: Pop(0)
0x390: Push((int) 525380)
0x391: Push((int) -1)
0x392: Push((int) 26748)
0x393: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x394: Pop(3)
0x395: Return(); Pop(0)
...
0x39a: Stack[-1] = "Fear" // @poff=198
0x39b: Call2 0x21b

0x39c: Pop(1)
0x39d: Push((int) 525382)
0x39e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x39f: Pop(1)
0x3a0: @@@ ClearReplies(); Obj=0 // @poff=152
0x3a1: Pop(0)
0x3a2: Push((int) 525383)
0x3a3: Push((int) -1)
0x3a4: Push((int) 26751)
0x3a5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3a6: Pop(3)
0x3a7: Return(); Pop(0)
...
0x3ac: Stack[-1] = "Sly" // @poff=190
0x3ad: Call2 0x21b

0x3ae: Pop(1)
0x3af: Push((int) 542032)
0x3b0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3b1: Pop(1)
0x3b2: @@@ ClearReplies(); Obj=0 // @poff=152
0x3b3: Pop(0)
0x3b4: Push((int) 542033)
0x3b5: Push((int) 44311)
0x3b6: Push((int) 44310)
0x3b7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3b8: Pop(3)
0x3b9: Return(); Pop(0)
...
0x3be: Stack[-1] = "Untrust" // @poff=174
0x3bf: Call2 0x21b

0x3c0: Pop(1)
0x3c1: Push((int) 542034)
0x3c2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3c3: Pop(1)
0x3c4: @@@ ClearReplies(); Obj=0 // @poff=152
0x3c5: Pop(0)
0x3c6: Push((int) 542035)
0x3c7: Push((int) 44428)
0x3c8: Push((int) 44312)
0x3c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3ca: Pop(3)
0x3cb: Push((int) 542120)
0x3cc: Push((int) 26738)
0x3cd: Push((int) 44425)
0x3ce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3cf: Pop(3)
0x3d0: Return(); Pop(0)
...
0x3d5: Stack[-1] = "Neutral" // @poff=125
0x3d6: Call2 0x21b

0x3d7: Pop(1)
0x3d8: Push((int) 542122)
0x3d9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3da: Pop(1)
0x3db: @@@ ClearReplies(); Obj=0 // @poff=152
0x3dc: Pop(0)
0x3dd: Push((int) 542123)
0x3de: Push((int) 44430)
0x3df: Push((int) 44429)
0x3e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3e1: Pop(3)
0x3e2: Push((int) 542126)
0x3e3: Push((int) 26738)
0x3e4: Push((int) 44432)
0x3e5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3e6: Pop(3)
0x3e7: Return(); Pop(0)
...
0x3ec: Stack[-1] = "Neutral" // @poff=125
0x3ed: Call2 0x21b

0x3ee: Pop(1)
0x3ef: Push((int) 542124)
0x3f0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3f1: Pop(1)
0x3f2: @@@ ClearReplies(); Obj=0 // @poff=152
0x3f3: Pop(0)
0x3f4: Push((int) 542125)
0x3f5: Push((int) 26738)
0x3f6: Push((int) 44431)
0x3f7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3f8: Pop(3)
0x3f9: Return(); Pop(0)
...
0x3fe: Stack[-1] = "Neutral" // @poff=125
0x3ff: Call2 0x21b

0x400: Pop(1)
0x401: Push((int) 525370)
0x402: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x403: Pop(1)
0x404: @@@ ClearReplies(); Obj=0 // @poff=152
0x405: Pop(0)
0x406: Push((int) 525371)
0x407: Push((int) -1)
0x408: Push((int) 26739)
0x409: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x40a: Pop(3)
0x40b: Return(); Pop(0)
...
0x410: Stack[-1] = "Fear" // @poff=198
0x411: Call2 0x21b

0x412: Pop(1)
0x413: Push((int) 525373)
0x414: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x415: Pop(1)
0x416: @@@ ClearReplies(); Obj=0 // @poff=152
0x417: Pop(0)
0x418: Push((int) 525374)
0x419: Push((int) 44313)
0x41a: Push((int) 26742)
0x41b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x41c: Pop(3)
0x41d: Return(); Pop(0)
...
0x422: Stack[-1] = "Untrust" // @poff=174
0x423: Call2 0x21b

0x424: Pop(1)
0x425: Push((int) 542036)
0x426: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x427: Pop(1)
0x428: @@@ ClearReplies(); Obj=0 // @poff=152
0x429: Pop(0)
0x42a: Push((int) 542119)
0x42b: Push((int) -1)
0x42c: Push((int) 44424)
0x42d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x42e: Pop(3)
0x42f: Return(); Pop(0)
...
0x434: Stack[-1] = "Neutral" // @poff=125
0x435: Call2 0x21b

0x436: Pop(1)
0x437: Push((int) 525239)
0x438: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x439: Pop(1)
0x43a: @@@ ClearReplies(); Obj=0 // @poff=152
0x43b: Pop(0)
0x43c: Push((int) 529208)
0x43d: Push((int) 44301)
0x43e: Push((int) 30659)
0x43f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x440: Pop(3)
0x441: Push((int) 529212)
0x442: Push((int) 44453)
0x443: Push((int) 30663)
0x444: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x445: Pop(3)
0x446: Return(); Pop(0)
...
0x44b: Stack[-1] = "Rage" // @poff=208
0x44c: Call2 0x21b

0x44d: Pop(1)
0x44e: Push((int) 542140)
0x44f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x450: Pop(1)
0x451: @@@ ClearReplies(); Obj=0 // @poff=152
0x452: Pop(0)
0x453: Push((int) 542141)
0x454: Push((int) 44458)
0x455: Push((int) 44454)
0x456: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x457: Pop(3)
0x458: Return(); Pop(0)
...
0x45d: Stack[-1] = "Rage" // @poff=208
0x45e: Call2 0x21b

0x45f: Pop(1)
0x460: Push((int) 542145)
0x461: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x462: Pop(1)
0x463: @@@ ClearReplies(); Obj=0 // @poff=152
0x464: Pop(0)
0x465: Push((int) 542146)
0x466: Push((int) 30660)
0x467: Push((int) 44459)
0x468: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x469: Pop(3)
0x46a: Return(); Pop(0)
...
0x46f: Stack[-1] = "Untrust" // @poff=174
0x470: Call2 0x21b

0x471: Pop(1)
0x472: Push((int) 542024)
0x473: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x474: Pop(1)
0x475: @@@ ClearReplies(); Obj=0 // @poff=152
0x476: Pop(0)
0x477: Push((int) 542025)
0x478: Push((int) 30660)
0x479: Push((int) 44302)
0x47a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x47b: Pop(3)
0x47c: Push((int) 542143)
0x47d: Push((int) 44457)
0x47e: Push((int) 44456)
0x47f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x480: Pop(3)
0x481: Return(); Pop(0)
...
0x486: Stack[-1] = "Neutral" // @poff=125
0x487: Call2 0x21b

0x488: Pop(1)
0x489: Push((int) 542144)
0x48a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x48b: Pop(1)
0x48c: @@@ ClearReplies(); Obj=0 // @poff=152
0x48d: Pop(0)
0x48e: Push((int) 542147)
0x48f: Push((int) 30660)
0x490: Push((int) 44462)
0x491: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x492: Pop(3)
0x493: Return(); Pop(0)
...
0x498: Stack[-1] = "Fear" // @poff=198
0x499: Call2 0x21b

0x49a: Pop(1)
0x49b: Push((int) 529209)
0x49c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x49d: Pop(1)
0x49e: @@@ ClearReplies(); Obj=0 // @poff=152
0x49f: Pop(0)
0x4a0: Push((int) 529210)
0x4a1: Push((int) 30662)
0x4a2: Push((int) 30661)
0x4a3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4a4: Pop(3)
0x4a5: Return(); Pop(0)
...
0x4aa: Stack[-1] = "Sly" // @poff=190
0x4ab: Call2 0x21b

0x4ac: Pop(1)
0x4ad: Push((int) 529211)
0x4ae: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4af: Pop(1)
0x4b0: @@@ ClearReplies(); Obj=0 // @poff=152
0x4b1: Pop(0)
...
0x4ba: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4bb: Pop(3)
0x4bc: Return(); Pop(0)
...
0x4c1: Stack[-1] = "Neutral" // @poff=125
0x4c2: Call2 0x21b

0x4c3: Pop(1)
0x4c4: Push((int) 542151)
0x4c5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4c6: Pop(1)
0x4c7: @@@ ClearReplies(); Obj=0 // @poff=152
0x4c8: Pop(0)
0x4c9: Push((int) 542152)
0x4ca: Push((int) 44468)
0x4cb: Push((int) 44467)
0x4cc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4cd: Pop(3)
0x4ce: Return(); Pop(0)
...
0x4d3: Stack[-1] = "Neutral" // @poff=125
0x4d4: Call2 0x21b

0x4d5: Pop(1)
0x4d6: Push((int) 542153)
0x4d7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4d8: Pop(1)
0x4d9: @@@ ClearReplies(); Obj=0 // @poff=152
0x4da: Pop(0)
0x4db: Push((int) 542154)
0x4dc: Push((int) 26609)
0x4dd: Push((int) 44469)
0x4de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4df: Pop(3)
0x4e0: Return(); Pop(0)
...
0x4e5: Stack[-1] = "Sly" // @poff=190
0x4e6: Call2 0x21b

0x4e7: Pop(1)
0x4e8: Push((int) 525241)
0x4e9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4ea: Pop(1)
0x4eb: @@@ ClearReplies(); Obj=0 // @poff=152
0x4ec: Pop(0)
0x4ed: Push((int) 542022)
0x4ee: Push((int) 44300)
0x4ef: Push((int) 44299)
0x4f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4f1: Pop(3)
0x4f2: Return(); Pop(0)
...
0x4f7: Stack[-1] = "Untrust" // @poff=174
0x4f8: Call2 0x21b

0x4f9: Pop(1)
0x4fa: Push((int) 542023)
0x4fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4fc: Pop(1)
0x4fd: @@@ ClearReplies(); Obj=0 // @poff=152
0x4fe: Pop(0)
0x4ff: Push((int) 542155)
0x500: Push((int) 44472)
0x501: Push((int) 44471)
0x502: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x503: Pop(3)
0x504: Return(); Pop(0)
...
0x509: Stack[-1] = "Neutral" // @poff=125
0x50a: Call2 0x21b

0x50b: Pop(1)
0x50c: Push((int) 542156)
0x50d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x50e: Pop(1)
0x50f: @@@ ClearReplies(); Obj=0 // @poff=152
0x510: Pop(0)
0x511: Push((int) 525242)
0x512: Push((int) -1)
0x513: Push((int) 26610)
0x514: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x515: Pop(3)
0x516: Push((int) 542157)
0x517: Push((int) -1)
0x518: Push((int) 44473)
0x519: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x51a: Pop(3)
0x51b: Return(); Pop(0)
...
0x520: Stack[-1] = "Sly" // @poff=190
0x521: Call2 0x21b

0x522: Pop(1)
0x523: Push((int) 541993)
0x524: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x525: Pop(1)
0x526: @@@ ClearReplies(); Obj=0 // @poff=152
0x527: Pop(0)
0x528: Push((int) 541994)
0x529: Push((int) 44250)
0x52a: Push((int) 44261)
0x52b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x52c: Pop(3)
...
0x537: Stack[-1] = "Sly" // @poff=190
0x538: Call2 0x21b

0x539: Pop(1)
0x53a: Push((int) 541996)
0x53b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x53c: Pop(1)
0x53d: @@@ ClearReplies(); Obj=0 // @poff=152
0x53e: Pop(0)
0x53f: Push((int) 541997)
0x540: Push((int) 44250)
0x541: Push((int) 44264)
0x542: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x543: Pop(3)
0x544: Return(); Pop(0)
...
0x549: Stack[-1] = "Untrust" // @poff=174
0x54a: Call2 0x21b

0x54b: Pop(1)
0x54c: Push((int) 541985)
0x54d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x54e: Pop(1)
0x54f: @@@ ClearReplies(); Obj=0 // @poff=152
0x550: Pop(0)
0x551: Push((int) 541986)
0x552: Push((int) 26707)
0x553: Push((int) 44251)
0x554: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x555: Pop(3)
0x556: Push((int) 541998)
0x557: Push((int) 44252)
0x558: Push((int) 44266)
0x559: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x55a: Pop(3)
0x55b: Return(); Pop(0)
...
0x560: Stack[-1] = "Neutral" // @poff=125
0x561: Call2 0x21b

0x562: Pop(1)
0x563: Push((int) 541987)
0x564: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x565: Pop(1)
0x566: @@@ ClearReplies(); Obj=0 // @poff=152
0x567: Pop(0)
0x568: Push((int) 541988)
0x569: Push((int) 44268)
0x56a: Push((int) 44253)
0x56b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x56c: Pop(3)
...
0x577: Stack[-1] = "Untrust" // @poff=174
0x578: Call2 0x21b
...
0x58e: Stack[-1] = "Neutral" // @poff=125
0x58f: Call2 0x21b
...
0x59e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x59f: Pop(3)
0x5a0: Return(); Pop(0)
...
0x5a5: Stack[-1] = "Untrust" // @poff=174
0x5a6: Call2 0x21b

0x5a7: Pop(1)
0x5a8: Push((int) 542006)
0x5a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x5aa: Pop(1)
0x5ab: @@@ ClearReplies(); Obj=0 // @poff=152
0x5ac: Pop(0)
0x5ad: Push((int) 542007)
0x5ae: Push((int) -1)
0x5af: Push((int) 44277)
0x5b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5b1: Pop(3)
0x5b2: Push((int) 542008)
0x5b3: Push((int) 44255)
0x5b4: Push((int) 44278)
0x5b5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5b6: Pop(3)
0x5b7: Return(); Pop(0)
...
0x5bc: Stack[-1] = "Sly" // @poff=190
0x5bd: Call2 0x21b

0x5be: Pop(1)
0x5bf: Push((int) 541999)
0x5c0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x5c1: Pop(1)
0x5c2: @@@ ClearReplies(); Obj=0 // @poff=152
0x5c3: Pop(0)
0x5c4: Push((int) 542000)
0x5c5: Push((int) 44255)
0x5c6: Push((int) 44269)
0x5c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5c8: Pop(3)
0x5c9: Push((int) 542009)
0x5ca: Push((int) 44286)
0x5cb: Push((int) 44281)
0x5cc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5cd: Pop(3)
0x5ce: Return(); Pop(0)
...
0x5d3: Stack[-1] = "Sly" // @poff=190
0x5d4: Call2 0x21b

0x5d5: Pop(1)
0x5d6: Push((int) 541990)
0x5d7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x5d8: Pop(1)
0x5d9: @@@ ClearReplies(); Obj=0 // @poff=152
0x5da: Pop(0)
0x5db: Push((int) 542010)
0x5dc: Push((int) 44284)
0x5dd: Push((int) 44283)
0x5de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5df: Pop(3)
0x5e0: Push((int) 542012)
0x5e1: Push((int) 44286)
0x5e2: Push((int) 44285)
0x5e3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5e4: Pop(3)
0x5e5: Return(); Pop(0)
...
0x5ea: Stack[-1] = "Rage" // @poff=208
0x5eb: Call2 0x21b

0x5ec: Pop(1)
0x5ed: Push((int) 542013)
0x5ee: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x5ef: Pop(1)
0x5f0: @@@ ClearReplies(); Obj=0 // @poff=152
0x5f1: Pop(0)
0x5f2: Push((int) 542015)
0x5f3: Push((int) -1)
0x5f4: Push((int) 44290)
0x5f5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5f6: Pop(3)
0x5f7: Push((int) 542014)
0x5f8: Push((int) 44284)
0x5f9: Push((int) 44289)
0x5fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x5fb: Pop(3)
0x5fc: Return(); Pop(0)
...
0x601: Stack[-1] = "Sly" // @poff=190
0x602: Call2 0x21b

0x603: Pop(1)
0x604: Push((int) 542011)
0x605: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x606: Pop(1)
0x607: @@@ ClearReplies(); Obj=0 // @poff=152
0x608: Pop(0)
0x609: Push((int) 541991)
0x60a: Push((int) 44257)
0x60b: Push((int) 44256)
0x60c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x60d: Pop(3)
0x60e: Push((int) 542016)
0x60f: Push((int) 44293)
0x610: Push((int) 44292)
0x611: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x612: Pop(3)
0x613: Return(); Pop(0)
...
0x618: Stack[-1] = "Rage" // @poff=208
0x619: Call2 0x21b

0x61a: Pop(1)
0x61b: Push((int) 542017)
0x61c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x61d: Pop(1)
0x61e: @@@ ClearReplies(); Obj=0 // @poff=152
0x61f: Pop(0)
0x620: Push((int) 542018)
0x621: Push((int) 44297)
0x622: Push((int) 44294)
0x623: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x624: Pop(3)
0x625: Push((int) 542019)
0x626: Push((int) 44257)
0x627: Push((int) 44295)
0x628: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x629: Pop(3)
0x62a: Return(); Pop(0)
...
0x62f: Stack[-1] = "Sly" // @poff=190
0x630: Call2 0x21b

0x631: Pop(1)
0x632: Push((int) 542020)
0x633: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x634: Pop(1)
0x635: @@@ ClearReplies(); Obj=0 // @poff=152
0x636: Pop(0)
0x637: Push((int) 542021)
0x638: Push((int) 44257)
0x639: Push((int) 44298)
0x63a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x63b: Pop(3)
0x63c: Return(); Pop(0)
...
0x641: Stack[-1] = "Neutral" // @poff=125
0x642: Call2 0x21b

0x643: Pop(1)
0x644: Push((int) 541992)
0x645: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x646: Pop(1)
0x647: @@@ ClearReplies(); Obj=0 // @poff=152
0x648: Pop(0)
0x649: Push((int) 525340)
0x64a: Push((int) -1)
0x64b: Push((int) 26708)
0x64c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x64d: Pop(3)
0x64e: Push((int) 525341)
0x64f: Push((int) -1)
0x650: Push((int) 26709)
0x651: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x652: Pop(3)
0x653: Return(); Pop(0)
...
0x670: Pop(0)
0x671: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0x672: Pop(1)
0x673: PushEmpty(int)
0x674: Call2 0x1137

0x675: Pop(0)
0x676: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0x677: Pop(1)
0x678: PushEmpty(string)
0x679: Call2 0x113b

0x67a: Pop(0)
0x67b: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0x67c: Pop(1)
0x67d: PushEmpty(string)
0x67e: Call2 0x113d

0x67f: Pop(0)
0x680: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0x681: Pop(1)
0x682: PushEmpty(int)
0x683: Call2 0x1392

0x684: Pop(0)
0x685: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0x686: Pop(1)
0x687: Stack[-2] = (int) -1
...
0x699: Stack[-6] = Stack[-1]
0x69a: Push(-2, 4); TaskCall(7)
0x69b: Call2 0x6b2

0x69c: Pop(-2, 4); TaskReturn
0x69d: Pop(2)
0x69e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x69f: Pop(0)
...
0x6a2: @ sync()
0x6a3: Pop(0)
0x6a4: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x6a5: Pop(0)
0x6a6: GOTO 0x6a0

0x6a7: PushEmpty(object)
0x6a8: Stack[-10] = Stack[-1]
0x6a9: Call2 0xfae

0x6aa: Pop(1)
0x6ab: @ StopDialog(Stack[-4])
0x6ac: Pop(0)
0x6ad: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0x6ae: Pop(0)
0x6af: Stack[-2] = Stack[-10]
0x6b0: Return(); Pop(8)
...
0x6b9: Stack[-1] = "Neutral" // @poff=125
0x6ba: Call2 0x6fa

0x6bb: Pop(1)
0x6bc: Push((int) 525414)
0x6bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x6be: Pop(1)
0x6bf: @@@ ClearReplies(); Obj=0 // @poff=152
0x6c0: Pop(0)
...
0x6d2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x6d3: Pop(3)
0x6d4: Push((int) 525418)
0x6d5: Push((int) -1)
0x6d6: Push((int) 26786)
0x6d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x6d8: Pop(3)
0x6d9: GOTO 0x6dc
...
0x6eb: Push("all") // @poff=28
0x6ec: Push("idle") // @poff=18
...
0x6f4: Push("all") // @poff=28
0x6f5: Push("idle") // @poff=18
...
0x722: Stack[-1] = "Neutral" // @poff=125
0x723: Call2 0x6fa

0x724: Pop(1)
0x725: Push((int) 525414)
0x726: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x727: Pop(1)
0x728: @@@ ClearReplies(); Obj=0 // @poff=152
0x729: Pop(0)
...
0x73b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x73c: Pop(3)
0x73d: Push((int) 525418)
0x73e: Push((int) -1)
0x73f: Push((int) 26786)
0x740: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x741: Pop(3)
0x742: Return(); Pop(0)
...
0x747: Stack[-1] = "Untrust" // @poff=174
0x748: Call2 0x6fa

0x749: Pop(1)
0x74a: Push((int) 540558)
0x74b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x74c: Pop(1)
0x74d: @@@ ClearReplies(); Obj=0 // @poff=152
0x74e: Pop(0)
0x74f: Push((int) 540559)
0x750: Push((int) 26784)
0x751: Push((int) 42568)
0x752: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x753: Pop(3)
0x754: Push((int) 540560)
0x755: Push((int) 40922)
0x756: Push((int) 42569)
0x757: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x758: Pop(3)
0x759: Return(); Pop(0)
...
0x75e: Stack[-1] = "Untrust" // @poff=174
0x75f: Call2 0x6fa

0x760: Pop(1)
0x761: Push((int) 525416)
0x762: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x763: Pop(1)
0x764: @@@ ClearReplies(); Obj=0 // @poff=152
0x765: Pop(0)
0x766: Push((int) 525417)
0x767: Push((int) 40922)
0x768: Push((int) 26785)
0x769: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x76a: Pop(3)
0x76b: Push((int) 540561)
0x76c: Push((int) 40924)
0x76d: Push((int) 42571)
0x76e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x76f: Pop(3)
0x770: Return(); Pop(0)
...
0x775: Stack[-1] = "Fear" // @poff=198
0x776: Call2 0x6fa

0x777: Pop(1)
0x778: Push((int) 538982)
0x779: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x77a: Pop(1)
0x77b: @@@ ClearReplies(); Obj=0 // @poff=152
0x77c: Pop(0)
0x77d: Push((int) 538983)
0x77e: Push((int) 40924)
0x77f: Push((int) 40923)
0x780: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x781: Pop(3)
0x782: Return(); Pop(0)
...
0x787: Stack[-1] = "Neutral" // @poff=125
0x788: Call2 0x6fa

0x789: Pop(1)
0x78a: Push((int) 538984)
0x78b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x78c: Pop(1)
0x78d: @@@ ClearReplies(); Obj=0 // @poff=152
0x78e: Pop(0)
0x78f: Push((int) 538985)
0x790: Push((int) 40926)
0x791: Push((int) 40925)
0x792: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x793: Pop(3)
0x794: Push((int) 538988)
0x795: Push((int) 40929)
0x796: Push((int) 40928)
0x797: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x798: Pop(3)
0x799: Return(); Pop(0)
...
0x79e: Stack[-1] = "Untrust" // @poff=174
0x79f: Call2 0x6fa

0x7a0: Pop(1)
0x7a1: Push((int) 538989)
0x7a2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x7a3: Pop(1)
0x7a4: @@@ ClearReplies(); Obj=0 // @poff=152
0x7a5: Pop(0)
0x7a6: Push((int) 540565)
0x7a7: Push((int) 42578)
0x7a8: Push((int) 42577)
0x7a9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7aa: Pop(3)
0x7ab: Push((int) 538990)
0x7ac: Push((int) 40931)
0x7ad: Push((int) 40930)
0x7ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7af: Pop(3)
0x7b0: Return(); Pop(0)
...
0x7b5: Stack[-1] = "Fear" // @poff=198
0x7b6: Call2 0x6fa

0x7b7: Pop(1)
0x7b8: Push((int) 538991)
0x7b9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x7ba: Pop(1)
0x7bb: @@@ ClearReplies(); Obj=0 // @poff=152
0x7bc: Pop(0)
0x7bd: Push((int) 538992)
0x7be: Push((int) -1)
0x7bf: Push((int) 40932)
0x7c0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7c1: Pop(3)
0x7c2: Push((int) 540575)
0x7c3: Push((int) -1)
0x7c4: Push((int) 42589)
0x7c5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7c6: Pop(3)
0x7c7: Return(); Pop(0)
...
0x7cc: Stack[-1] = "Untrust" // @poff=174
0x7cd: Call2 0x6fa

0x7ce: Pop(1)
0x7cf: Push((int) 538986)
0x7d0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x7d1: Pop(1)
0x7d2: @@@ ClearReplies(); Obj=0 // @poff=152
0x7d3: Pop(0)
0x7d4: Push((int) 538987)
0x7d5: Push((int) 42573)
0x7d6: Push((int) 40927)
0x7d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7d8: Pop(3)
0x7d9: Return(); Pop(0)
...
0x7de: Stack[-1] = "Rage" // @poff=208
0x7df: Call2 0x6fa

0x7e0: Pop(1)
0x7e1: Push((int) 540562)
0x7e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x7e3: Pop(1)
0x7e4: @@@ ClearReplies(); Obj=0 // @poff=152
0x7e5: Pop(0)
0x7e6: Push((int) 540563)
0x7e7: Push((int) 40929)
0x7e8: Push((int) 42574)
0x7e9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7ea: Pop(3)
0x7eb: Push((int) 540564)
0x7ec: Push((int) 42578)
0x7ed: Push((int) 42576)
0x7ee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x7ef: Pop(3)
0x7f0: Return(); Pop(0)
...
0x7f5: Stack[-1] = "Rage" // @poff=208
0x7f6: Call2 0x6fa

0x7f7: Pop(1)
0x7f8: Push((int) 540566)
0x7f9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x7fa: Pop(1)
0x7fb: @@@ ClearReplies(); Obj=0 // @poff=152
0x7fc: Pop(0)
0x7fd: Push((int) 540592)
0x7fe: Push((int) 42607)
0x7ff: Push((int) 42606)
0x800: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x801: Pop(3)
0x802: Return(); Pop(0)
...
0x807: Stack[-1] = "Rage" // @poff=208
0x808: Call2 0x6fa

0x809: Pop(1)
0x80a: Push((int) 540593)
0x80b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x80c: Pop(1)
0x80d: @@@ ClearReplies(); Obj=0 // @poff=152
0x80e: Pop(0)
0x80f: Push((int) 540594)
0x810: Push((int) 42609)
0x811: Push((int) 42608)
0x812: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x813: Pop(3)
0x814: Push((int) 540601)
0x815: Push((int) -1)
0x816: Push((int) 42615)
0x817: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x818: Pop(3)
0x819: Return(); Pop(0)
...
0x81e: Stack[-1] = "Neutral" // @poff=125
0x81f: Call2 0x6fa

0x820: Pop(1)
0x821: Push((int) 540595)
0x822: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x823: Pop(1)
0x824: @@@ ClearReplies(); Obj=0 // @poff=152
0x825: Pop(0)
0x826: Push((int) 540596)
0x827: Push((int) 42611)
0x828: Push((int) 42610)
0x829: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x82a: Pop(3)
0x82b: Return(); Pop(0)
...
0x830: Stack[-1] = "Neutral" // @poff=125
0x831: Call2 0x6fa

0x832: Pop(1)
0x833: Push((int) 540597)
0x834: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x835: Pop(1)
0x836: @@@ ClearReplies(); Obj=0 // @poff=152
0x837: Pop(0)
0x838: Push((int) 540600)
0x839: Push((int) -1)
0x83a: Push((int) 42614)
0x83b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x83c: Pop(3)
0x83d: Return(); Pop(0)
...
0x85a: Pop(0)
0x85b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0x85c: Pop(1)
0x85d: PushEmpty(int)
0x85e: Call2 0x1137

0x85f: Pop(0)
0x860: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0x861: Pop(1)
0x862: PushEmpty(string)
0x863: Call2 0x113b

0x864: Pop(0)
0x865: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0x866: Pop(1)
0x867: PushEmpty(string)
0x868: Call2 0x113d

0x869: Pop(0)
0x86a: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0x86b: Pop(1)
0x86c: PushEmpty(int)
0x86d: Call2 0x1392

0x86e: Pop(0)
0x86f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0x870: Pop(1)
0x871: Stack[-2] = (int) -1
...
0x887: Pop(2)
0x888: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x889: Pop(0)
...
0x88c: @ sync()
0x88d: Pop(0)
0x88e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x88f: Pop(0)
0x890: GOTO 0x88a
...
0x896: Pop(0)
0x897: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0x898: Pop(0)
...
0x8a3: Stack[-1] = "Neutral" // @poff=125
0x8a4: Call2 0x8d6

0x8a5: Pop(1)
0x8a6: Push((int) 525513)
0x8a7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x8a8: Pop(1)
0x8a9: @@@ ClearReplies(); Obj=0 // @poff=152
0x8aa: Pop(0)
0x8ab: Push((int) 525514)
0x8ac: Push((int) 30738)
0x8ad: Push((int) 26870)
0x8ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x8af: Pop(3)
0x8b0: Push((int) 529284)
0x8b1: Push((int) 30738)
0x8b2: Push((int) 30737)
0x8b3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x8b4: Pop(3)
0x8b5: GOTO 0x8b8
...
0x8c7: Push("all") // @poff=28
0x8c8: Push("idle") // @poff=18
...
0x8d0: Push("all") // @poff=28
0x8d1: Push("idle") // @poff=18
...
0x8f6: Stack[-1] = "Neutral" // @poff=125
0x8f7: Call2 0x8d6

0x8f8: Pop(1)
0x8f9: Push((int) 525513)
0x8fa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x8fb: Pop(1)
0x8fc: @@@ ClearReplies(); Obj=0 // @poff=152
0x8fd: Pop(0)
0x8fe: Push((int) 525514)
0x8ff: Push((int) 30738)
0x900: Push((int) 26870)
0x901: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x902: Pop(3)
0x903: Push((int) 529284)
0x904: Push((int) 30738)
0x905: Push((int) 30737)
0x906: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x907: Pop(3)
0x908: Return(); Pop(0)
...
0x90d: Stack[-1] = "Neutral" // @poff=125
0x90e: Call2 0x8d6

0x90f: Pop(1)
0x910: Push((int) 529285)
0x911: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x912: Pop(1)
0x913: @@@ ClearReplies(); Obj=0 // @poff=152
0x914: Pop(0)
0x915: Push((int) 529286)
0x916: Push((int) -1)
0x917: Push((int) 30740)
0x918: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x919: Pop(3)
0x91a: Push((int) 529287)
0x91b: Push((int) -1)
0x91c: Push((int) 30741)
0x91d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x91e: Pop(3)
0x91f: Return(); Pop(0)
...
0x93c: Pop(0)
0x93d: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0x93e: Pop(1)
0x93f: PushEmpty(int)
0x940: Call2 0x1137

0x941: Pop(0)
0x942: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0x943: Pop(1)
0x944: PushEmpty(string)
0x945: Call2 0x113b

0x946: Pop(0)
0x947: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0x948: Pop(1)
0x949: PushEmpty(string)
0x94a: Call2 0x113d

0x94b: Pop(0)
0x94c: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0x94d: Pop(1)
0x94e: PushEmpty(int)
0x94f: Call2 0x1392

0x950: Pop(0)
0x951: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0x952: Pop(1)
0x953: Stack[-2] = (int) -1
...
0x95f: Stack[-1] = Stack[-2]
0x960: Pop(1)
0x961: Call2 0xfc0

0x962: Pop(2)
0x963: PushEmpty(object, object)
0x964: Stack[-11] = Stack[-2]
0x965: Stack[-6] = Stack[-1]
0x966: Push(-2, 4); TaskCall(11)
0x967: Call2 0x97e

0x968: Pop(-2, 4); TaskReturn
0x969: Pop(2)
0x96a: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x96b: Pop(0)
...
0x96e: @ sync()
0x96f: Pop(0)
0x970: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0x971: Pop(0)
0x972: GOTO 0x96c
...
0x978: Pop(0)
0x979: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0x97a: Pop(0)
0x97b: Stack[-2] = Stack[-10]
0x97c: Return(); Pop(8)
...
0x985: Stack[-1] = "Neutral" // @poff=125
0x986: Call2 0x9d5

0x987: Pop(1)
0x988: Push((int) 525841)
0x989: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x98a: Pop(1)
0x98b: @@@ ClearReplies(); Obj=0 // @poff=152
0x98c: Pop(0)
...
0x99e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x99f: Pop(3)
...
0x9a8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x9a9: Pop(3)
0x9aa: Push((int) 529095)
0x9ab: Push((int) -1)
0x9ac: Push((int) 30540)
0x9ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x9ae: Pop(3)
0x9af: Push((int) 529096)
0x9b0: Push((int) -1)
0x9b1: Push((int) 30541)
0x9b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x9b3: Pop(3)
0x9b4: GOTO 0x9b7
...
0x9c6: Push("all") // @poff=28
0x9c7: Push("idle") // @poff=18
...
0x9cf: Push("all") // @poff=28
0x9d0: Push("idle") // @poff=18
...
0xa0d: Stack[-1] = "Neutral" // @poff=125
0xa0e: Call2 0x9d5

0xa0f: Pop(1)
0xa10: Push((int) 525841)
0xa11: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa12: Pop(1)
0xa13: @@@ ClearReplies(); Obj=0 // @poff=152
0xa14: Pop(0)
...
0xa26: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa27: Pop(3)
...
0xa30: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa31: Pop(3)
0xa32: Push((int) 529095)
0xa33: Push((int) -1)
0xa34: Push((int) 30540)
0xa35: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa36: Pop(3)
0xa37: Push((int) 529096)
0xa38: Push((int) -1)
0xa39: Push((int) 30541)
0xa3a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa3b: Pop(3)
0xa3c: Return(); Pop(0)
...
0xa41: Stack[-1] = "Untrust" // @poff=174
0xa42: Call2 0x9d5

0xa43: Pop(1)
0xa44: Push((int) 529097)
0xa45: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa46: Pop(1)
0xa47: @@@ ClearReplies(); Obj=0 // @poff=152
0xa48: Pop(0)
0xa49: Push((int) 529098)
0xa4a: Push((int) -1)
0xa4b: Push((int) 30543)
0xa4c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa4d: Pop(3)
0xa4e: Push((int) 541643)
0xa4f: Push((int) -1)
0xa50: Push((int) 43815)
0xa51: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa52: Pop(3)
0xa53: Return(); Pop(0)
...
0xa58: Stack[-1] = "Sly" // @poff=190
0xa59: Call2 0x9d5

0xa5a: Pop(1)
0xa5b: Push((int) 529099)
0xa5c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa5d: Pop(1)
0xa5e: @@@ ClearReplies(); Obj=0 // @poff=152
0xa5f: Pop(0)
0xa60: Push((int) 529100)
0xa61: Push((int) 30546)
0xa62: Push((int) 30545)
0xa63: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa64: Pop(3)
0xa65: Return(); Pop(0)
...
0xa6a: Stack[-1] = "Sly" // @poff=190
0xa6b: Call2 0x9d5

0xa6c: Pop(1)
0xa6d: Push((int) 529101)
0xa6e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa6f: Pop(1)
0xa70: @@@ ClearReplies(); Obj=0 // @poff=152
0xa71: Pop(0)
0xa72: Push((int) 529102)
0xa73: Push((int) 27142)
0xa74: Push((int) 30547)
0xa75: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa76: Pop(3)
0xa77: Return(); Pop(0)
...
0xa7c: Stack[-1] = "Sly" // @poff=190
0xa7d: Call2 0x9d5

0xa7e: Pop(1)
0xa7f: Push((int) 525843)
0xa80: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa81: Pop(1)
0xa82: @@@ ClearReplies(); Obj=0 // @poff=152
0xa83: Pop(0)
0xa84: Push((int) 529103)
0xa85: Push((int) 30549)
0xa86: Push((int) 30548)
0xa87: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa88: Pop(3)
0xa89: Return(); Pop(0)
...
0xa8e: Stack[-1] = "Rage" // @poff=208
0xa8f: Call2 0x9d5

0xa90: Pop(1)
0xa91: Push((int) 529104)
0xa92: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xa93: Pop(1)
0xa94: @@@ ClearReplies(); Obj=0 // @poff=152
0xa95: Pop(0)
0xa96: Push((int) 529105)
0xa97: Push((int) 30551)
0xa98: Push((int) 30550)
0xa99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa9a: Pop(3)
0xa9b: Push((int) 539587)
0xa9c: Push((int) 41533)
0xa9d: Push((int) 41532)
0xa9e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xa9f: Pop(3)
0xaa0: Return(); Pop(0)
...
0xaa5: Stack[-1] = "Neutral" // @poff=125
0xaa6: Call2 0x9d5

0xaa7: Pop(1)
0xaa8: Push((int) 539588)
0xaa9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xaaa: Pop(1)
0xaab: @@@ ClearReplies(); Obj=0 // @poff=152
0xaac: Pop(0)
0xaad: Push((int) 539589)
0xaae: Push((int) 30551)
0xaaf: Push((int) 41534)
0xab0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xab1: Pop(3)
0xab2: Return(); Pop(0)
...
0xab7: Stack[-1] = "Untrust" // @poff=174
0xab8: Call2 0x9d5

0xab9: Pop(1)
0xaba: Push((int) 529106)
0xabb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xabc: Pop(1)
0xabd: @@@ ClearReplies(); Obj=0 // @poff=152
0xabe: Pop(0)
0xabf: Push((int) 525844)
0xac0: Push((int) -1)
0xac1: Push((int) 27143)
0xac2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xac3: Pop(3)
0xac4: Return(); Pop(0)
...
0xae1: Pop(0)
0xae2: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0xae3: Pop(1)
0xae4: PushEmpty(int)
0xae5: Call2 0x1137

0xae6: Pop(0)
0xae7: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0xae8: Pop(1)
0xae9: PushEmpty(string)
0xaea: Call2 0x113b

0xaeb: Pop(0)
0xaec: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0xaed: Pop(1)
0xaee: PushEmpty(string)
0xaef: Call2 0x113d

0xaf0: Pop(0)
0xaf1: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0xaf2: Pop(1)
0xaf3: PushEmpty(int)
0xaf4: Call2 0x1392

0xaf5: Pop(0)
0xaf6: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0xaf7: Pop(1)
0xaf8: Stack[-2] = (int) -1
...
0xb09: Stack[-11] = Stack[-2]
0xb0a: Stack[-6] = Stack[-1]
0xb0b: Push(-2, 4); TaskCall(13)
0xb0c: Call2 0xb23

0xb0d: Pop(-2, 4); TaskReturn
0xb0e: Pop(2)
0xb0f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xb10: Pop(0)
...
0xb13: @ sync()
0xb14: Pop(0)
0xb15: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xb16: Pop(0)
0xb17: GOTO 0xb11

0xb18: PushEmpty(object)
0xb19: Stack[-10] = Stack[-1]
0xb1a: Call2 0xfae

0xb1b: Pop(1)
0xb1c: @ StopDialog(Stack[-4])
0xb1d: Pop(0)
0xb1e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0xb1f: Pop(0)
0xb20: Stack[-2] = Stack[-10]
0xb21: Return(); Pop(8)
...
0xb2a: Stack[-1] = "Rage" // @poff=208
0xb2b: Call2 0xb71

0xb2c: Pop(1)
0xb2d: Push((int) 526738)
0xb2e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xb2f: Pop(1)
0xb30: @@@ ClearReplies(); Obj=0 // @poff=152
0xb31: Pop(0)
...
0xb3a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xb3b: Pop(3)
...
0xb44: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xb45: Pop(3)
0xb46: Push((int) 526742)
0xb47: Push((int) -1)
0xb48: Push((int) 28019)
0xb49: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xb4a: Pop(3)
0xb4b: Push((int) 528847)
0xb4c: Push((int) -1)
0xb4d: Push((int) 30265)
0xb4e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xb4f: Pop(3)
0xb50: GOTO 0xb53
...
0xb62: Push("all") // @poff=28
0xb63: Push("idle") // @poff=18
...
0xb6b: Push("all") // @poff=28
0xb6c: Push("idle") // @poff=18
...
0xba1: Stack[-1] = "Rage" // @poff=208
0xba2: Call2 0xb71

0xba3: Pop(1)
0xba4: Push((int) 526738)
0xba5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xba6: Pop(1)
0xba7: @@@ ClearReplies(); Obj=0 // @poff=152
0xba8: Pop(0)
...
0xbb1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbb2: Pop(3)
...
0xbc0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbc1: Pop(3)
0xbc2: Push((int) 528847)
0xbc3: Push((int) -1)
0xbc4: Push((int) 30265)
0xbc5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbc6: Pop(3)
0xbc7: Return(); Pop(0)
...
0xbcc: Stack[-1] = "Rage" // @poff=208
0xbcd: Call2 0xb71

0xbce: Pop(1)
0xbcf: Push((int) 528764)
0xbd0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xbd1: Pop(1)
0xbd2: @@@ ClearReplies(); Obj=0 // @poff=152
0xbd3: Pop(0)
...
0xbdc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbdd: Pop(3)
0xbde: Push((int) 528765)
0xbdf: Push((int) -1)
0xbe0: Push((int) 30181)
0xbe1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbe2: Pop(3)
0xbe3: Return(); Pop(0)
...
0xbe8: Stack[-1] = "Neutral" // @poff=125
0xbe9: Call2 0xb71

0xbea: Pop(1)
0xbeb: Push((int) 542464)
0xbec: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xbed: Pop(1)
0xbee: @@@ ClearReplies(); Obj=0 // @poff=152
0xbef: Pop(0)
0xbf0: Push((int) 542465)
0xbf1: Push((int) -1)
0xbf2: Push((int) 44858)
0xbf3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xbf4: Pop(3)
0xbf5: Return(); Pop(0)
...
0xbfa: Stack[-1] = "Neutral" // @poff=125
0xbfb: Call2 0xb71

0xbfc: Pop(1)
0xbfd: Push((int) 542467)
0xbfe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xbff: Pop(1)
0xc00: @@@ ClearReplies(); Obj=0 // @poff=152
0xc01: Pop(0)
0xc02: Push((int) 542468)
0xc03: Push((int) -1)
0xc04: Push((int) 44861)
0xc05: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc06: Pop(3)
0xc07: Push((int) 543008)
0xc08: Push((int) -1)
0xc09: Push((int) 45460)
0xc0a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc0b: Pop(3)
0xc0c: Return(); Pop(0)
...
0xc11: Stack[-1] = "Rage" // @poff=208
0xc12: Call2 0xb71

0xc13: Pop(1)
0xc14: Push((int) 526740)
0xc15: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc16: Pop(1)
0xc17: @@@ ClearReplies(); Obj=0 // @poff=152
0xc18: Pop(0)
0xc19: Push((int) 528841)
0xc1a: Push((int) 30260)
0xc1b: Push((int) 30259)
0xc1c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc1d: Pop(3)
0xc1e: Push((int) 528848)
0xc1f: Push((int) 30267)
0xc20: Push((int) 30266)
0xc21: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc22: Pop(3)
0xc23: Return(); Pop(0)
...
0xc28: Stack[-1] = "Neutral" // @poff=125
0xc29: Call2 0xb71

0xc2a: Pop(1)
0xc2b: Push((int) 528849)
0xc2c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc2d: Pop(1)
0xc2e: @@@ ClearReplies(); Obj=0 // @poff=152
0xc2f: Pop(0)
0xc30: Push((int) 528850)
0xc31: Push((int) 45452)
0xc32: Push((int) 30268)
0xc33: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc34: Pop(3)
0xc35: Push((int) 528851)
0xc36: Push((int) 45452)
0xc37: Push((int) 30269)
0xc38: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc39: Pop(3)
0xc3a: Return(); Pop(0)
...
0xc3f: Stack[-1] = "Neutral" // @poff=125
0xc40: Call2 0xb71
...
0xc4a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc4b: Pop(3)
0xc4c: Return(); Pop(0)
...
0xc51: Stack[-1] = "Sly" // @poff=190
0xc52: Call2 0xb71

0xc53: Pop(1)
0xc54: Push((int) 543006)
0xc55: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc56: Pop(1)
0xc57: @@@ ClearReplies(); Obj=0 // @poff=152
0xc58: Pop(0)
0xc59: Push((int) 543007)
0xc5a: Push((int) 30264)
0xc5b: Push((int) 45458)
0xc5c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc5d: Pop(3)
0xc5e: Return(); Pop(0)
...
0xc63: Stack[-1] = "Sly" // @poff=190
0xc64: Call2 0xb71

0xc65: Pop(1)
0xc66: Push((int) 528842)
0xc67: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc68: Pop(1)
0xc69: @@@ ClearReplies(); Obj=0 // @poff=152
0xc6a: Pop(0)
0xc6b: Push((int) 528843)
0xc6c: Push((int) 30262)
0xc6d: Push((int) 30261)
0xc6e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc6f: Pop(3)
0xc70: Return(); Pop(0)
...
0xc75: Stack[-1] = "Rage" // @poff=208
0xc76: Call2 0xb71

0xc77: Pop(1)
0xc78: Push((int) 528844)
0xc79: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc7a: Pop(1)
0xc7b: @@@ ClearReplies(); Obj=0 // @poff=152
0xc7c: Pop(0)
...
0xc85: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc86: Pop(3)
0xc87: Return(); Pop(0)
...
0xc8c: Stack[-1] = "Neutral" // @poff=125
0xc8d: Call2 0xb71

0xc8e: Pop(1)
0xc8f: Push((int) 528846)
0xc90: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xc91: Pop(1)
0xc92: @@@ ClearReplies(); Obj=0 // @poff=152
0xc93: Pop(0)
...
0xc9c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xc9d: Pop(3)
0xc9e: Return(); Pop(0)
...
0xcbb: Pop(0)
0xcbc: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0xcbd: Pop(1)
0xcbe: PushEmpty(int)
0xcbf: Call2 0x1137

0xcc0: Pop(0)
0xcc1: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0xcc2: Pop(1)
0xcc3: PushEmpty(string)
0xcc4: Call2 0x113b

0xcc5: Pop(0)
0xcc6: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0xcc7: Pop(1)
0xcc8: PushEmpty(string)
0xcc9: Call2 0x113d

0xcca: Pop(0)
0xccb: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0xccc: Pop(1)
0xccd: PushEmpty(int)
0xcce: Call2 0x1392

0xccf: Pop(0)
0xcd0: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0xcd1: Pop(1)
0xcd2: Stack[-2] = (int) -1
...
0xcde: Stack[-1] = Stack[-2]
0xcdf: Pop(1)
0xce0: Call2 0xfc0

0xce1: Pop(2)
0xce2: PushEmpty(object, object)
0xce3: Stack[-11] = Stack[-2]
0xce4: Stack[-6] = Stack[-1]
0xce5: Push(-2, 4); TaskCall(15)
0xce6: Call2 0xcfd

0xce7: Pop(-2, 4); TaskReturn
0xce8: Pop(2)
0xce9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xcea: Pop(0)
...
0xced: @ sync()
0xcee: Pop(0)
0xcef: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xcf0: Pop(0)
0xcf1: GOTO 0xceb

0xcf2: PushEmpty(object)
0xcf3: Stack[-10] = Stack[-1]
0xcf4: Call2 0xfae

0xcf5: Pop(1)
0xcf6: @ StopDialog(Stack[-4])
0xcf7: Pop(0)
0xcf8: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0xcf9: Pop(0)
0xcfa: Stack[-2] = Stack[-10]
0xcfb: Return(); Pop(8)
...
0xd04: Stack[-1] = "Neutral" // @poff=125
0xd05: Call2 0xd3c

0xd06: Pop(1)
0xd07: Push((int) 535231)
0xd08: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xd09: Pop(1)
0xd0a: @@@ ClearReplies(); Obj=0 // @poff=152
0xd0b: Pop(0)
0xd0c: Push((int) 535232)
0xd0d: Push((int) 36953)
0xd0e: Push((int) 36907)
0xd0f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd10: Pop(3)
0xd11: Push((int) 535233)
0xd12: Push((int) -1)
0xd13: Push((int) 36908)
0xd14: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd15: Pop(3)
...
0xd2d: Push("all") // @poff=28
0xd2e: Push("idle") // @poff=18
...
0xd36: Push("all") // @poff=28
0xd37: Push("idle") // @poff=18
...
0xd5c: Stack[-1] = "Neutral" // @poff=125
0xd5d: Call2 0xd3c

0xd5e: Pop(1)
0xd5f: Push((int) 535231)
0xd60: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xd61: Pop(1)
0xd62: @@@ ClearReplies(); Obj=0 // @poff=152
0xd63: Pop(0)
0xd64: Push((int) 535232)
0xd65: Push((int) 36953)
0xd66: Push((int) 36907)
0xd67: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd68: Pop(3)
0xd69: Push((int) 535233)
0xd6a: Push((int) -1)
0xd6b: Push((int) 36908)
0xd6c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd6d: Pop(3)
0xd6e: Push((int) 535280)
0xd6f: Push((int) -1)
0xd70: Push((int) 36956)
0xd71: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd72: Pop(3)
0xd73: Return(); Pop(0)
...
0xd78: Stack[-1] = "Neutral" // @poff=125
0xd79: Call2 0xd3c

0xd7a: Pop(1)
0xd7b: Push((int) 535277)
0xd7c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xd7d: Pop(1)
0xd7e: @@@ ClearReplies(); Obj=0 // @poff=152
0xd7f: Pop(0)
0xd80: Push((int) 535278)
0xd81: Push((int) 36957)
0xd82: Push((int) 36954)
0xd83: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd84: Pop(3)
0xd85: Push((int) 535279)
0xd86: Push((int) 36957)
0xd87: Push((int) 36955)
0xd88: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd89: Pop(3)
0xd8a: Return(); Pop(0)
...
0xd8f: Stack[-1] = "Neutral" // @poff=125
0xd90: Call2 0xd3c

0xd91: Pop(1)
0xd92: Push((int) 535281)
0xd93: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xd94: Pop(1)
0xd95: @@@ ClearReplies(); Obj=0 // @poff=152
0xd96: Pop(0)
0xd97: Push((int) 535282)
0xd98: Push((int) -1)
0xd99: Push((int) 36958)
0xd9a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xd9b: Pop(3)
0xd9c: Push((int) 535283)
0xd9d: Push((int) -1)
0xd9e: Push((int) 36959)
0xd9f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xda0: Pop(3)
0xda1: Return(); Pop(0)
...
0xdbe: Pop(0)
0xdbf: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=36
0xdc0: Pop(1)
0xdc1: PushEmpty(int)
0xdc2: Call2 0x1137

0xdc3: Pop(0)
0xdc4: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=47
0xdc5: Pop(1)
0xdc6: PushEmpty(string)
0xdc7: Call2 0x113b

0xdc8: Pop(0)
0xdc9: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=65
0xdca: Pop(1)
0xdcb: PushEmpty(string)
0xdcc: Call2 0x113d

0xdcd: Pop(0)
0xdce: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=74
0xdcf: Pop(1)
0xdd0: PushEmpty(int)
0xdd1: Call2 0x1392

0xdd2: Pop(0)
0xdd3: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=84
0xdd4: Pop(1)
0xdd5: Stack[-2] = (int) -1
...
0xde1: Stack[-1] = Stack[-2]
0xde2: Pop(1)
0xde3: Call2 0xfc0

0xde4: Pop(2)
0xde5: PushEmpty(object, object)
0xde6: Stack[-11] = Stack[-2]
0xde7: Stack[-6] = Stack[-1]
0xde8: Push(-2, 4); TaskCall(17)
0xde9: Call2 0xe00

0xdea: Pop(-2, 4); TaskReturn
0xdeb: Pop(2)
0xdec: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xded: Pop(0)
...
0xdf0: @ sync()
0xdf1: Pop(0)
0xdf2: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=98
0xdf3: Pop(0)
0xdf4: GOTO 0xdee

0xdf5: PushEmpty(object)
0xdf6: Stack[-10] = Stack[-1]
0xdf7: Call2 0xfae

0xdf8: Pop(1)
0xdf9: @ StopDialog(Stack[-4])
0xdfa: Pop(0)
0xdfb: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=110
0xdfc: Pop(0)
0xdfd: Stack[-2] = Stack[-10]
0xdfe: Return(); Pop(8)
...
0xe07: Stack[-1] = "Neutral" // @poff=125
0xe08: Call2 0xe3a

0xe09: Pop(1)
0xe0a: Push((int) 540545)
0xe0b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xe0c: Pop(1)
0xe0d: @@@ ClearReplies(); Obj=0 // @poff=152
0xe0e: Pop(0)
0xe0f: Push((int) 540546)
0xe10: Push((int) -1)
0xe11: Push((int) 42555)
0xe12: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xe13: Pop(3)
0xe14: Push((int) 540798)
0xe15: Push((int) -1)
0xe16: Push((int) 42847)
0xe17: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xe18: Pop(3)
0xe19: GOTO 0xe1c
...
0xe2b: Push("all") // @poff=28
0xe2c: Push("idle") // @poff=18
...
0xe34: Push("all") // @poff=28
0xe35: Push("idle") // @poff=18
...
0xe5a: Stack[-1] = "Neutral" // @poff=125
0xe5b: Call2 0xe3a

0xe5c: Pop(1)
0xe5d: Push((int) 540545)
0xe5e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0xe5f: Pop(1)
0xe60: @@@ ClearReplies(); Obj=0 // @poff=152
0xe61: Pop(0)
0xe62: Push((int) 540546)
0xe63: Push((int) -1)
0xe64: Push((int) 42555)
0xe65: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xe66: Pop(3)
0xe67: Push((int) 540798)
0xe68: Push((int) -1)
0xe69: Push((int) 42847)
0xe6a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0xe6b: Pop(3)
0xe6c: Return(); Pop(0)
...
0xe8e: Pop(1)
0xe8f: @@ GetLocator(Stack[-1], Stack[-11]); Obj=12 // @poff=218
0xe90: Pop(1)
...
0xea3: Pop(0)
0xea4: @ irand(Stack[-9], Stack[-2]T)
0xea5: Pop(0)
0xea6: PushEmpty(string, int)
0xea7: Stack[-11] = Stack[-1]
0xea8: Call2 0x1129

0xea9: Pop(1)
0xeaa: @@ GetLocator(Stack[-1], Stack[-9], Stack[-8], Stack[-7]); Obj=12 // @poff=218
0xeab: Pop(1)
...
0xee2: Push("all") // @poff=28
0xee3: Push("walk_stopl") // @poff=237
0xee4: @ GetAnimationOffset(Stack[-4], Stack[-2], Stack[-1])
0xee5: Pop(2)
0xee6: Push("all") // @poff=28
0xee7: Push("walk_stopr") // @poff=259
...
0xf1e: Push("HasProperty") // @poff=293
0xf1f: Push((int) 2)
...
0xf25: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=317
0xf26: Pop(0)
0xf27: Stack[-1] = Stack[-5]
0xf28: Return(); Pop(2)

0xf29: PushEmpty(float, float)
0xf2a: PushEmpty(bool, object, string)
0xf2b: Stack[-10] = Stack[-2]
0xf2c: Stack[-9] = Stack[-1]
0xf2d: Call2 0xf1d
...
0xf33: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=329
0xf34: Pop(0)
0xf35: PushEmpty(float, float, float, float)
0xf36: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xf37: Stack[-8] = Stack[-2]
0xf38: Stack[-7] = Stack[-1]
0xf39: Call2 0x1097

0xf3a: Pop(3)
0xf3b: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=341
0xf3c: Pop(1)
0xf3d: Stack[-8] = (bool) 1
0xf3e: Return(); Pop(2)

0xf3f: PushEmpty(int, int)
0xf40: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=329
0xf41: Pop(0)
0xf42: Pop(0); Push(Stack[-1] + Stack[-3]);
0xf43: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=341
0xf44: Pop(1)
0xf45: Return(); Pop(2)
...
0xf4d: Pop(2)
0xf4e: Stack[-1] = Stack[-8]
0xf4f: Return(); Pop(6)

0xf50: PushEmpty(cvector, cvector)
0xf51: @@ GetPosition(Stack[-1]); Obj=3 // @poff=281
0xf52: Pop(0)
0xf53: PushEmpty(bool, cvector)
0xf54: Stack[-3] = Stack[-1]
0xf55: Call2 0xf46

0xf56: Stack[-2] = Stack[-6]
0xf57: Pop(2)
0xf58: Return(); Pop(2)

0xf59: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0xf5a: @@ GetPosition(Stack[-3]); Obj=7 // @poff=281
0xf5b: Pop(0)
...
0xf6a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=281
0xf6b: Pop(0)
0xf6c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=353
0xf6d: Pop(0)
...
0xfd9: Push("voice_common") // @poff=377
0xfda: Push((int) 1)
...
0xfe1: Push("voice_common") // @poff=377
0xfe2: Push((int) 0)
...
0xff4: Push("voice_common") // @poff=377
0xff5: Push((int) 1)
...
0x1002: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=317
0x1003: Pop(1)
...
0x102d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=317
0x102e: Pop(1)
...
0x1042: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=329
0x1043: Pop(1)
0x1044: PushEmpty(bool, string)
0x1045: Stack[-3] = Stack[-1]
0x1046: Call2 0x1069

0x1047: Stack[-2] = Stack[-14]
0x1048: Pop(2)
...
0x1055: Push("Can't find lsh animation : ") // @poff=407
...
0x1064: Push("Can't find lsh animation : ") // @poff=407
...
0x1088: Push((float)9.999999974752427e-07)
...
0x10ae: Pop(0)
0x10af: Stack[-1] = Stack[-4]
0x10b0: Return(); Pop(2)

0x10b1: PushEmpty(object, object)
0x10b2: @ CreateIntVector(Stack[-1])
0x10b3: Pop(0)
0x10b4: @@ add(Stack[-4]); Obj=1 // @poff=463
0x10b5: Pop(0)
0x10b6: @@ add(Stack[-3]); Obj=1 // @poff=463
0x10b7: Pop(0)
0x10b8: Push((int) 3)
...
0x10bf: Stack[-7] = Stack[-3]
0x10c0: Stack[-2] = "money" // @poff=467
0x10c1: Stack[-6] = Stack[-1]
0x10c2: Call2 0xf3f
...
0x10c7: Push("Money") // @poff=479
0x10c8: @ GetInvItemByName(Stack[-2], Stack[-1])
0x10c9: Pop(1)
0x10ca: PushEmpty(int, int)
0x10cb: Stack[-3] = Stack[-2]
0x10cc: Stack[-5] = Stack[-1]
0x10cd: Call2 0x10b1
...
0x10e6: Stack[-2] = Stack[-1]
0x10e7: Call2 0x10f3

0x10e8: Pop(1)
0x10e9: PushEmpty(bool, object, string, float, float, float)
0x10ea: Stack[-8] = Stack[-5]
0x10eb: Stack[-4] = "reputation" // @poff=491
0x10ec: Stack[-7] = Stack[-3]
...
0x10f5: Pop(0)
0x10f6: @@ add(Stack[-3]); Obj=1 // @poff=463
0x10f7: Pop(0)
0x10f8: Push((int) 16)
...
0x113b: Stack[-1] = "ui/NPC_MladVlad.png" // @poff=521
0x113c: Return(); Pop(0)

0x113d: Stack[-1] = "ui/NPC_MladVlad_b.png" // @poff=561
0x113e: Return(); Pop(0)
...
0x1143: Stack[-5] = Stack[-2]
0x1144: Stack[-1] = (float) -0.05000000074505806
0x1145: Call2 0x10d0
...
0x114f: Stack[-1] = Stack[-2]
0x1150: Pop(1)
0x1151: Push("k2q01MladVladGotoOspina") // @poff=617
0x1152: Push("pt_map_ospina") // @poff=665
0x1153: Push((int) 1)
...
0x1157: Pop(0)
0x1158: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=693
0x1159: Pop(5)
0x115a: PushEmpty()
0x115b: Call2 0x12c2
...
0x115e: Stack[-1] = 0
0x115f: PushEmpty()
0x1160: Push("ook2MladVlad1") // @poff=701
0x1161: Push((int) 1)
...
0x116c: Stack[-1] = Stack[-2]
0x116d: Pop(1)
0x116e: Push("k2q04MladVladGotoAnna") // @poff=741
0x116f: Push("pt_map_anna") // @poff=785
0x1170: Push((int) 0)
...
0x1174: Pop(0)
0x1175: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=693
0x1176: Pop(5)
0x1177: PushEmpty()
0x1178: Call2 0x12cf
...
0x117e: Stack[-1] = 0
0x117f: PushEmpty()
0x1180: Push("ook2MladVlad2") // @poff=809
0x1181: Push((int) 1)
...
0x118c: Pop(0)
0x118d: Push("alpha_pills") // @poff=837
0x118e: Push((int) 4)
0x118f: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=861
0x1190: Pop(2)
0x1191: Push("beta_pills") // @poff=878
0x1192: Push((int) 4)
0x1193: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=861
0x1194: Pop(2)
0x1195: Return(); Pop(2)

0x1196: PushEmpty()
0x1197: Push("k2q04") // @poff=729
...
0x11b1: PushEmpty()
0x11b2: Push("ook3MladVlad1") // @poff=900
0x11b3: Push((int) 1)
...
0x11b7: PushEmpty()
0x11b8: Push("ook5MladVlad1") // @poff=928
0x11b9: Push((int) 1)
...
0x11cb: PushEmpty()
0x11cc: Push("money1000 is given") // @poff=968
0x11cd: @ Trace(Stack[-1])
0x11ce: Pop(1)
0x11cf: PushEmpty(object, int)
0x11d0: Stack[-4] = Stack[-2]
...
0x11d5: PushEmpty()
0x11d6: Push("money500 is given") // @poff=1006
0x11d7: @ Trace(Stack[-1])
0x11d8: Pop(1)
0x11d9: PushEmpty(object, int)
0x11da: Stack[-4] = Stack[-2]
...
0x11df: PushEmpty()
0x11e0: Push("playsound") // @poff=1042
0x11e1: Push("givemoney") // @poff=1062
...
0x11e7: Stack[-5] = Stack[-2]
0x11e8: Stack[-1] = (float) -0.019999999552965164
0x11e9: Call2 0x10d0
...
0x11ee: Stack[-5] = Stack[-2]
0x11ef: Stack[-1] = (float) 0.019999999552965164
0x11f0: Call2 0x10d0
...
0x11f3: PushEmpty()
0x11f4: Push("ook5MladVlad2") // @poff=1082
0x11f5: Push((int) 1)
...
0x11fd: Stack[-1] = Stack[-4]
0x11fe: Pop(1)
0x11ff: Stack[-2] = "pt_map_anna" // @poff=785
...
0x1205: Pop(0)
0x1206: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1110
0x1207: Pop(1)
0x1208: Return(); Pop(0)

0x1209: PushEmpty()
0x120a: PushEmpty(int, string)
0x120b: Stack[-1] = "k2q01" // @poff=605
0x120c: Call2 0x10ac
...
0x1217: Stack[-1] = "ook2MladVlad1" // @poff=701
0x1218: Call2 0x10ac
...
0x1245: Stack[-1] = "ook2MladVlad2" // @poff=809
0x1246: Call2 0x10ac
...
0x125d: Stack[-1] = "k3q01" // @poff=1118
0x125e: Call2 0x10ac
...
0x1269: Stack[-1] = "ook3MladVlad1" // @poff=900
0x126a: Call2 0x10ac
...
0x1275: Stack[-1] = "k5q01" // @poff=1130
0x1276: Call2 0x10ac
...
0x1281: Stack[-1] = "ook5MladVlad1" // @poff=928
0x1282: Call2 0x10ac
...
0x128d: Stack[-1] = "k6q01" // @poff=1142
0x128e: Call2 0x10ac
...
0x12a5: Stack[-1] = "ook5MladVlad2" // @poff=1082
0x12a6: Call2 0x10ac
...
0x12b0: Push("alpha_pills") // @poff=837
0x12b1: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=1154
0x12b2: Pop(1)
0x12b3: Push((int) 4)
...
0x12b8: Push("beta_pills") // @poff=878
0x12b9: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=1154
0x12ba: Pop(1)
0x12bb: Push((int) 4)
...
0x133c: Push("Can't retrieve diary root") // @poff=1173
...
0x1348: Pop(1)
0x1349: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1225
0x134a: Pop(0)
0x134b: Pop(0); Push((bool) Stack[-2] == 0)
0x134c: IF (Stack[-1] == 0) GOTO 0x1353; Pop(1)

0x134d: Push("Can't find diary parent with id: ") // @poff=1230
...
0x1353: @@ AddChild(Stack[-8]); Obj=2 // @poff=1298
0x1354: Pop(0)
0x1355: Push((int) 7)
0x1356: @ SendWorldWndMessage(Stack[-1])
0x1357: Pop(1)
0x1358: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1307
0x1359: Pop(0)
...
0x1362: Pop(0)
0x1363: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1364: IF (Stack[-1] == 0) GOTO 0x136b; Pop(1)

0x1365: Push("Can't find main outdoor scene") // @poff=1319
0x1366: @ Trace(Stack[-1])
0x1367: Pop(1)
0x1368: Stack[-1] = 0
0x1369: Stack[-1] = Stack[-5]
0x136a: Return(); Pop(4)

0x136b: @@ GetMap(Stack[-1]); Obj=2 // @poff=1379
0x136c: Pop(0)
0x136d: Stack[-1] = Stack[-5]
0x136e: Return(); Pop(4)
...
0x1373: Pop(0)
0x1374: Pop(0); PushNull((bool) Stack[-2] == 0)
0x1375: IF (Stack[-1] == 0) GOTO 0x137a; Pop(1)

0x1376: Push("Can't find main outdoor scene") // @poff=1319
0x1377: @ Trace(Stack[-1])
0x1378: Pop(1)
0x1379: Return(); Pop(8)

0x137a: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=218
0x137b: Pop(0)
0x137c: Pop(0); Push((bool) Stack[-1] == 0)
0x137d: IF (Stack[-1] == 0) GOTO 0x1384; Pop(1)

0x137e: Push("Warning: outdoor scene locator ") // @poff=1386
0x137f: Pop(1); Push(Stack[-1] + Stack[-11]);
0x1380: Push(" doesnt exist") // @poff=1450
0x1381: Pop(2); Push(Stack[-2] + Stack[-1]);
0x1382: @ Trace(Stack[-1])
0x1383: Pop(1)
0x1384: @@ GetMap(Stack[-11]); Obj=2 // @poff=1379
0x1385: Pop(0)
0x1386: Pop(0); PushNull((bool) Stack[-11] == 0)
0x1387: IF (Stack[-1] == 0) GOTO 0x138c; Pop(1)

0x1388: Push("Can't find map") // @poff=1478
...
0x138e: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1508
0x138f: Pop(2)
0x1390: Return(); Pop(8)

0x1391: Stack[-2] = 0
0x1392: PushEmpty(int, int)
0x1393: Push("branch") // @poff=1521
