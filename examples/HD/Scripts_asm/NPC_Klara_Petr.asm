...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xfe: Pop(0)
0xff: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x100: Pop(1)
0x101: PushEmpty(int)
0x102: Call2 0x952

0x103: Pop(0)
0x104: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x105: Pop(1)
0x106: PushEmpty(string)
0x107: Call2 0x956

0x108: Pop(0)
0x109: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x10a: Pop(1)
0x10b: PushEmpty(string)
0x10c: Call2 0x958

0x10d: Pop(0)
0x10e: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x10f: Pop(1)
0x110: PushEmpty(int)
0x111: Call2 0xa4c

0x112: Pop(0)
0x113: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x114: Pop(1)
0x115: Stack[-2] = (int) -1
...
0x222: Stack[-1] = "Neutral" // @poff=89
0x223: Call2 0x18e

0x224: Pop(1)
0x225: Push((int) 529114)
0x226: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x227: Pop(1)
0x228: @@@ ClearReplies(); Obj=0 // @poff=116
0x229: Pop(0)
...
0x2a7: Stack[-1] = "Autizm" // @poff=156
0x2a8: Call2 0x18e

0x2a9: Pop(1)
0x2aa: Push((int) 540912)
0x2ab: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2ac: Pop(1)
0x2ad: @@@ ClearReplies(); Obj=0 // @poff=116
0x2ae: Pop(0)
...
0x2be: Stack[-1] = "Autizm" // @poff=156
0x2bf: Call2 0x18e

0x2c0: Pop(1)
0x2c1: Push((int) 525928)
0x2c2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2c3: Pop(1)
0x2c4: @@@ ClearReplies(); Obj=0 // @poff=116
0x2c5: Pop(0)
...
0x30b: Stack[-1] = "Untrust" // @poff=182
0x30c: Call2 0x18e
...
0x339: Stack[-1] = "Untrust" // @poff=182
0x33a: Call2 0x18e
...
0x350: Stack[-1] = "Drunk" // @poff=170
0x351: Call2 0x18e

0x352: Pop(1)
0x353: Push((int) 525902)
0x354: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x355: Pop(1)
0x356: @@@ ClearReplies(); Obj=0 // @poff=116
0x357: Pop(0)
...
0x37e: Stack[-1] = "Untrust" // @poff=182
0x37f: Call2 0x18e
...
0x3a8: Pop(0)
0x3a9: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x3aa: Pop(1)
0x3ab: PushEmpty(int)
0x3ac: Call2 0x952

0x3ad: Pop(0)
0x3ae: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x3af: Pop(1)
0x3b0: PushEmpty(string)
0x3b1: Call2 0x956

0x3b2: Pop(0)
0x3b3: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x3b4: Pop(1)
0x3b5: PushEmpty(string)
0x3b6: Call2 0x958

0x3b7: Pop(0)
0x3b8: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x3b9: Pop(1)
0x3ba: PushEmpty(int)
0x3bb: Call2 0xa4c

0x3bc: Pop(0)
0x3bd: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x3be: Pop(1)
0x3bf: Stack[-2] = (int) -1
...
0x3cb: Stack[-1] = Stack[-2]
0x3cc: Pop(1)
0x3cd: Call2 0x81a

0x3ce: Pop(2)
0x3cf: PushEmpty(object, object)
0x3d0: Stack[-11] = Stack[-2]
0x3d1: Stack[-6] = Stack[-1]
0x3d2: Push(-2, 4); TaskCall(5)
0x3d3: Call2 0x3ea

0x3d4: Pop(-2, 4); TaskReturn
0x3d5: Pop(2)
0x3d6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3d7: Pop(0)
...
0x3da: @ sync()
0x3db: Pop(0)
0x3dc: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x3dd: Pop(0)
0x3de: GOTO 0x3d8

0x3df: PushEmpty(object)
0x3e0: Stack[-10] = Stack[-1]
0x3e1: Call2 0x808

0x3e2: Pop(1)
0x3e3: @ StopDialog(Stack[-4])
0x3e4: Pop(0)
0x3e5: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x3e6: Pop(0)
0x3e7: Stack[-2] = Stack[-10]
0x3e8: Return(); Pop(8)
...
0x428: Push("all") // @poff=138
0x429: Push("idle") // @poff=146
...
0x477: Stack[-1] = "Untrust" // @poff=182
0x478: Call2 0x42e
...
0x4e1: Pop(0)
0x4e2: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x4e3: Pop(1)
0x4e4: PushEmpty(int)
0x4e5: Call2 0x952

0x4e6: Pop(0)
0x4e7: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x4e8: Pop(1)
0x4e9: PushEmpty(string)
0x4ea: Call2 0x956

0x4eb: Pop(0)
0x4ec: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x4ed: Pop(1)
0x4ee: PushEmpty(string)
0x4ef: Call2 0x958

0x4f0: Pop(0)
0x4f1: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x4f2: Pop(1)
0x4f3: PushEmpty(int)
0x4f4: Call2 0xa4c

0x4f5: Pop(0)
0x4f6: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x4f7: Pop(1)
0x4f8: Stack[-2] = (int) -1
...
0x504: Stack[-1] = Stack[-2]
0x505: Pop(1)
0x506: Call2 0x81a

0x507: Pop(2)
0x508: PushEmpty(object, object)
0x509: Stack[-11] = Stack[-2]
0x50a: Stack[-6] = Stack[-1]
0x50b: Push(-2, 4); TaskCall(7)
0x50c: Call2 0x523

0x50d: Pop(-2, 4); TaskReturn
0x50e: Pop(2)
0x50f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x510: Pop(0)
...
0x519: Stack[-10] = Stack[-1]
0x51a: Call2 0x808

0x51b: Pop(1)
0x51c: @ StopDialog(Stack[-4])
0x51d: Pop(0)
0x51e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x51f: Pop(0)
0x520: Stack[-2] = Stack[-10]
0x521: Return(); Pop(8)
...
0x553: Push("all") // @poff=138
0x554: Push("idle") // @poff=146
...
0x55c: Push("all") // @poff=138
0x55d: Push("idle") // @poff=146
...
0x582: Stack[-1] = "Neutral" // @poff=89
0x583: Call2 0x562

0x584: Pop(1)
0x585: Push((int) 535231)
0x586: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x587: Pop(1)
0x588: @@@ ClearReplies(); Obj=0 // @poff=116
0x589: Pop(0)
...
0x5e4: Pop(0)
0x5e5: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x5e6: Pop(1)
0x5e7: PushEmpty(int)
0x5e8: Call2 0x952

0x5e9: Pop(0)
0x5ea: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x5eb: Pop(1)
0x5ec: PushEmpty(string)
0x5ed: Call2 0x956

0x5ee: Pop(0)
0x5ef: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x5f0: Pop(1)
0x5f1: PushEmpty(string)
0x5f2: Call2 0x958

0x5f3: Pop(0)
0x5f4: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x5f5: Pop(1)
0x5f6: PushEmpty(int)
0x5f7: Call2 0xa4c

0x5f8: Pop(0)
0x5f9: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x5fa: Pop(1)
0x5fb: Stack[-2] = (int) -1
...
0x60c: Stack[-11] = Stack[-2]
0x60d: Stack[-6] = Stack[-1]
0x60e: Push(-2, 4); TaskCall(9)
0x60f: Call2 0x626

0x610: Pop(-2, 4); TaskReturn
0x611: Pop(2)
0x612: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x613: Pop(0)
...
0x616: @ sync()
0x617: Pop(0)
0x618: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x619: Pop(0)
0x61a: GOTO 0x614

0x61b: PushEmpty(object)
0x61c: Stack[-10] = Stack[-1]
0x61d: Call2 0x808

0x61e: Pop(1)
0x61f: @ StopDialog(Stack[-4])
0x620: Pop(0)
0x621: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x622: Pop(0)
0x623: Stack[-2] = Stack[-10]
0x624: Return(); Pop(8)
...
0x651: Push("all") // @poff=138
0x652: Push("idle") // @poff=146
...
0x65a: Push("all") // @poff=138
0x65b: Push("idle") // @poff=146
...
0x680: Stack[-1] = "Neutral" // @poff=89
0x681: Call2 0x660

0x682: Pop(1)
0x683: Push((int) 540545)
0x684: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x685: Pop(1)
0x686: @@@ ClearReplies(); Obj=0 // @poff=116
0x687: Pop(0)
...
0x6c3: Stack[-1] = 0
0x6c4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x6c5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x6c6: @ RotateAsync(Stack[-2], Stack[-1])
0x6c7: Pop(2)
0x6c8: Return(); Pop(0)

0x6c9: PushEmpty(object, bool, object, bool)
0x6ca: Push("player") // @poff=198
...
0x7a5: Pop(0)
0x7a6: @@ GetPosition(Stack[-2]); Obj=7 // @poff=212
0x7a7: Pop(0)
...
0x7b2: Pop(2)
0x7b3: Stack[-1] = Stack[-8]
0x7b4: Return(); Pop(6)

0x7b5: PushEmpty(cvector, cvector)
0x7b6: @@ GetPosition(Stack[-1]); Obj=3 // @poff=212
0x7b7: Pop(0)
0x7b8: PushEmpty(bool, cvector)
0x7b9: Stack[-3] = Stack[-1]
0x7ba: Call2 0x7ab

0x7bb: Stack[-2] = Stack[-6]
0x7bc: Pop(2)
0x7bd: Return(); Pop(2)
...
0x7c4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=212
0x7c5: Pop(0)
0x7c6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=224
0x7c7: Pop(0)
...
0x7ed: Pop(0)
0x7ee: Push((bool) 1)
0x7ef: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x7f0: Pop(1)
0x7f1: Push(CvectorIndex(Stack[-4], 0))
0x7f2: Push(CvectorIndex(Stack[-5], 2))
0x7f3: @ Rotate(Stack[-2], Stack[-1])
0x7f4: Pop(2)
...
0x7fa: Push("head") // @poff=238
0x7fb: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7fc: Pop(1)
0x7fd: Push(Stack[-1])
0x7fe: IF (Stack[-1] == 0) GOTO 0x802; Pop(1)

0x7ff: Push("head") // @poff=238
0x800: @ LookAsyncCamera(Stack[-1])
0x801: Pop(1)
0x802: @ CameraWaitForPlayFinish()
0x803: Pop(0)
0x804: @ ResumeWorld()
0x805: Pop(0)
0x806: Stack[-21] = (bool) 1
0x807: Return(); Pop(18)

0x808: PushEmpty(bool, bool)
0x809: Push((bool) 1)
0x80a: @ CameraSwitchToNormal(Stack[-1])
0x80b: Pop(1)
...
0x811: Push("head") // @poff=238
0x812: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x813: Pop(1)
0x814: Push(Stack[-1])
0x815: IF (Stack[-1] == 0) GOTO 0x819; Pop(1)

0x816: Push("head") // @poff=238
0x817: @ UnlookAsync(Stack[-1])
0x818: Pop(1)
0x819: Return(); Pop(2)

0x81a: PushEmpty(int, int, int, int)
0x81b: Push("voice_common") // @poff=248
0x81c: @ GetVariable(Stack[-1], Stack[-3])
0x81d: Pop(1)
0x81e: Push(Stack[-2])
0x81f: IF (Stack[-1] == 0) GOTO 0x840; Pop(1)
...
0x823: Pop(1)
0x824: Pop(1); Push((bool) Stack[-1] == 0)
0x825: IF (Stack[-1] == 0) GOTO 0x82e; Pop(1)

0x826: PushEmpty(bool, object)
0x827: Stack[-7] = Stack[-1]
0x828: Call2 0x879
...
0x82e: Push((int) 2)
0x82f: @ irand(Stack[-2], Stack[-1])
0x830: Pop(1)
0x831: Push(Stack[-1])
0x832: IF (Stack[-1] == 0) GOTO 0x83b; Pop(1)

0x833: Push("voice_common") // @poff=248
0x834: Push((int) 1)
0x835: Pop(1); Push(Stack[-4] + Stack[-1]);
0x836: Push((int) 3)
0x837: Pop(2); Push(Stack[-2] % Stack[-1]);
0x838: @ SetVariable(Stack[-2], Stack[-1])
0x839: Pop(2)
0x83a: GOTO 0x83f

0x83b: Push("voice_common") // @poff=248
0x83c: Push((int) 0)
0x83d: @ SetVariable(Stack[-2], Stack[-1])
0x83e: Pop(2)
0x83f: GOTO 0x852

0x840: PushEmpty(bool, object)
0x841: Stack[-7] = Stack[-1]
0x842: Call2 0x879

0x843: Pop(1)
0x844: Pop(1); Push((bool) Stack[-1] == 0)
0x845: IF (Stack[-1] == 0) GOTO 0x84e; Pop(1)

0x846: PushEmpty(bool, object)
0x847: Stack[-7] = Stack[-1]
0x848: Call2 0x854
...
0x84c: Stack[-6] = (bool) 0
0x84d: Return(); Pop(4)

0x84e: Push("voice_common") // @poff=248
0x84f: Push((int) 1)
0x850: @ SetVariable(Stack[-2], Stack[-1])
0x851: Pop(2)
0x852: Stack[-6] = (bool) 1
0x853: Return(); Pop(4)

0x854: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x855: Stack[-5] = "c" // @poff=274
0x856: Stack[-4] = (int) 0
0x857: Push((int) 1)
...
0x85b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x85c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x85d: Pop(1)
0x85e: Pop(0); Push((bool) Stack[-3] == 0)
0x85f: IF (Stack[-1] == 0) GOTO 0x861; Pop(1)

0x860: GOTO 0x864

0x861: Push((int) 1)
0x862: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x863: GOTO 0x857

0x864: Pop(0); Push((bool) Stack[-4] == 0)
0x865: IF (Stack[-1] == 0) GOTO 0x868; Pop(1)

0x866: Stack[-12] = (bool) 0
0x867: Return(); Pop(10)
...
0x86c: @ irand(Stack[-2], Stack[-4])
0x86d: Pop(0)
0x86e: Push((int) 1)
0x86f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x870: Pop(1); Push(Stack[-6] + Stack[-1]);
0x871: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=290
0x872: Pop(1)
0x873: PushEmpty(bool, string)
0x874: Stack[-3] = Stack[-1]
0x875: Call2 0x8c3

0x876: Stack[-2] = Stack[-14]
0x877: Pop(2)
0x878: Return(); Pop(10)

0x879: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x87a: Push("d") // @poff=244
0x87b: PushEmpty(int)
0x87c: Call2 0x92b

0x87d: Pop(0)
0x87e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x87f: Push("m") // @poff=166
0x880: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x881: Stack[-4] = (int) 0
0x882: Push((int) 1)
0x883: IF (Stack[-1] == 0) GOTO 0x88f; Pop(1)

0x884: Push((int) 1)
0x885: Pop(1); Push(Stack[-5] + Stack[-1]);
0x886: Pop(1); Push(Stack[-6] + Stack[-1]);
0x887: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x888: Pop(1)
0x889: Pop(0); Push((bool) Stack[-3] == 0)
0x88a: IF (Stack[-1] == 0) GOTO 0x88c; Pop(1)

0x88b: GOTO 0x88f

0x88c: Push((int) 1)
0x88d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x88e: GOTO 0x882

0x88f: Pop(0); Push((bool) Stack[-4] == 0)
0x890: IF (Stack[-1] == 0) GOTO 0x893; Pop(1)

0x891: Stack[-12] = (bool) 0
0x892: Return(); Pop(10)

0x893: Stack[-2] = (int) 0
0x894: Push((int) 1)
0x895: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x896: IF (Stack[-1] == 0) GOTO 0x899; Pop(1)

0x897: @ irand(Stack[-2], Stack[-4])
0x898: Pop(0)
0x899: Push((int) 1)
0x89a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x89b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x89c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=290
0x89d: Pop(1)
0x89e: PushEmpty(bool, string)
0x89f: Stack[-3] = Stack[-1]
0x8a0: Call2 0x8c3

0x8a1: Stack[-2] = Stack[-14]
0x8a2: Pop(2)
0x8a3: Return(); Pop(10)

0x8a4: PushEmpty(bool, float, float, bool, float, float)
0x8a5: @ lshHasAnimation(Stack[-3], Stack[-7])
0x8a6: Pop(0)
0x8a7: Push(Stack[-3])
0x8a8: IF (Stack[-1] == 0) GOTO 0x8af; Pop(1)

0x8a9: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x8aa: Pop(0)
0x8ab: Push((bool) 0)
0x8ac: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8ad: Pop(1)
0x8ae: GOTO 0x8b3

0x8af: Push("Can't find lsh animation : ") // @poff=302
0x8b0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x8b1: @ Trace(Stack[-1])
0x8b2: Pop(1)
0x8b3: Return(); Pop(6)

0x8b4: PushEmpty(bool, float, float, bool, float, float)
0x8b5: @ lshHasAnimation(Stack[-3], Stack[-8])
0x8b6: Pop(0)
0x8b7: Push(Stack[-3])
0x8b8: IF (Stack[-1] == 0) GOTO 0x8be; Pop(1)

0x8b9: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x8ba: Pop(0)
0x8bb: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x8bc: Pop(0)
0x8bd: GOTO 0x8c2

0x8be: Push("Can't find lsh animation : ") // @poff=302
0x8bf: Pop(1); Push(Stack[-1] + Stack[-9]);
0x8c0: @ Trace(Stack[-1])
0x8c1: Pop(1)
0x8c2: Return(); Pop(6)
...
0x8c8: @ lshHasSpeech(Stack[-1], Stack[-3])
0x8c9: Pop(0)
0x8ca: Push(Stack[-1])
0x8cb: IF (Stack[-1] == 0) GOTO 0x8d0; Pop(1)

0x8cc: @ lshPlaySpeech(Stack[-3])
0x8cd: Pop(0)
0x8ce: Stack[-4] = (bool) 1
0x8cf: Return(); Pop(2)

0x8d0: Stack[-4] = (bool) 0
0x8d1: Return(); Pop(2)
...
0x8de: Stack[-1] = 0
0x8df: PushEmpty(float, float)
0x8e0: Pop(0); Push(Stack[-3] | Stack[-3]);
0x8e1: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x8e2: Push((float)9.999999974752427e-07)
0x8e3: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x8e4: IF (Stack[-1] == 0) GOTO 0x8e7; Pop(1)

0x8e5: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x8e6: Return(); Pop(2)

0x8e7: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x8e8: Return(); Pop(2)

0x8e9: PushEmpty(int, int)
0x8ea: @ GetVariable(Stack[-3], Stack[-1])
0x8eb: Pop(0)
0x8ec: Stack[-1] = Stack[-4]
0x8ed: Return(); Pop(2)

0x8ee: PushEmpty(object, object)
0x8ef: @ CreateIntVector(Stack[-1])
0x8f0: Pop(0)
0x8f1: @@ add(Stack[-4]); Obj=1 // @poff=358
0x8f2: Pop(0)
0x8f3: @@ add(Stack[-3]); Obj=1 // @poff=358
0x8f4: Pop(0)
0x8f5: Push((int) 3)
0x8f6: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x8f7: Pop(1)
0x8f8: Return(); Pop(2)

0x8f9: Stack[-1] = 0
0x8fa: PushEmpty(int, int, bool, int, int, bool)
0x8fb: @@ GetItemID(Stack[-3]); Obj=8 // @poff=362
0x8fc: Pop(0)
0x8fd: Push("Category") // @poff=372
0x8fe: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x8ff: Pop(1)
0x900: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=390
0x901: Pop(0)
0x902: Pop(0); Push((bool) Stack[-1] == 0)
0x903: IF (Stack[-1] == 0) GOTO 0x907; Pop(1)

0x904: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=398
0x905: Pop(0)
0x906: GOTO 0x90c

0x907: PushEmpty(int, int)
0x908: Stack[-5] = Stack[-2]
0x909: Stack[-9] = Stack[-1]
0x90a: Call2 0x8ee
...
0x90e: @ CreateInvItem(Stack[-1])
0x90f: Pop(0)
0x910: @@ SetItemName(Stack[-4]); Obj=1 // @poff=408
0x911: Pop(0)
0x912: PushEmpty(object, object, int)
0x913: Stack[-8] = Stack[-3]
0x914: Stack[-4] = Stack[-2]
0x915: Stack[-6] = Stack[-1]
0x916: Call2 0x8fa
...
0x919: Stack[-1] = 0
0x91a: PushEmpty(object, object)
0x91b: @ FindActor(Stack[-1], Stack[-4])
0x91c: Pop(0)
0x91d: Pop(0); PushNull((bool) Stack[-1] == 0)
0x91e: IF (Stack[-1] == 0) GOTO 0x921; Pop(1)

0x91f: Stack[-5] = (bool) 0
0x920: Return(); Pop(2)

0x921: @ Trigger(Stack[-1], Stack[-3])
0x922: Pop(0)
0x923: Stack[-5] = (bool) 1
0x924: Return(); Pop(2)
...
0x92c: @ GetGameTime(Stack[-1])
0x92d: Pop(0)
0x92e: Push((int) 1)
0x92f: PushEmpty(int)
0x930: Push((int) 24)
0x931: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x932: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x933: Return(); Pop(2)
...
0x950: Stack[-2] = Stack[-5]
0x951: Return(); Pop(4)

0x952: Stack[-1] = (int) 515550
0x953: Return(); Pop(0)

0x954: Stack[-1] = (int) 502875
0x955: Return(); Pop(0)

0x956: Stack[-1] = "ui/NPC_Petr.png" // @poff=420
0x957: Return(); Pop(0)

0x958: Stack[-1] = "ui/NPC_Petr_b.png" // @poff=452
0x959: Return(); Pop(0)
...
0x95d: Push("k5q02") // @poff=488
0x95e: Push((int) 2)
0x95f: @ SetVariable(Stack[-2], Stack[-1])
0x960: Pop(2)
0x961: PushEmpty(object)
0x962: Call2 0xa1a

0x963: Stack[-1] = Stack[-2]
0x964: Pop(1)
0x965: Push("k5q02PetrGotoAndrei") // @poff=500
0x966: Push("pt_map_andrei") // @poff=540
0x967: Push((int) 0)
0x968: Push((int) 515295)
0x969: PushEmpty(float)
0x96a: Call2 0x926

0x96b: Pop(0)
0x96c: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=568
0x96d: Pop(5)
0x96e: PushEmpty()
0x96f: Call2 0x9d7

0x970: Pop(0)
0x971: PushEmpty(bool, string, string)
0x972: Stack[-2] = "quest_k5_02" // @poff=576
0x973: Stack[-1] = "init_kabak" // @poff=600
0x974: Call2 0x91a
...
0x981: PushEmpty()
0x982: Push("tvirin 5 is given") // @poff=622
0x983: @ Trace(Stack[-1])
0x984: Pop(1)
0x985: PushEmpty(object, string, int)
0x986: Stack[-5] = Stack[-3]
0x987: Stack[-2] = "tvirin" // @poff=658
0x988: Stack[-1] = (int) 5
0x989: Call2 0x90d
...
0x98c: PushEmpty()
0x98d: Push("ook11Petr1") // @poff=672
0x98e: Push((int) 1)
...
0x992: PushEmpty()
0x993: Push("playsound") // @poff=694
0x994: Push("giveitem") // @poff=714
0x995: @ TriggerWorld(Stack[-2], Stack[-1])
0x996: Pop(2)
0x997: Return(); Pop(0)

0x998: PushEmpty()
0x999: Push("tvirin is given") // @poff=732
0x99a: @ Trace(Stack[-1])
0x99b: Pop(1)
0x99c: PushEmpty(object, string, int)
0x99d: Stack[-5] = Stack[-3]
0x99e: Stack[-2] = "tvirin" // @poff=658
0x99f: Stack[-1] = (int) 1
0x9a0: Call2 0x90d
...
0x9a3: PushEmpty()
0x9a4: PushEmpty(object, string, float)
0x9a5: PushEmpty(object)
0x9a6: Call2 0xa1a

0x9a7: Stack[-1] = Stack[-4]
0x9a8: Pop(1)
0x9a9: Stack[-2] = "pt_map_andrei" // @poff=540
0x9aa: Stack[-1] = (int) 2
0x9ab: Call2 0xa2b
...
0x9af: Pop(0)
0x9b0: @@ ShowMap(Stack[-1]); Obj=2 // @poff=764
0x9b1: Pop(1)
0x9b2: Return(); Pop(0)

0x9b3: PushEmpty()
0x9b4: PushEmpty(int, string)
0x9b5: Stack[-1] = "k5q02" // @poff=488
0x9b6: Call2 0x8e9
...
0x9cd: Stack[-1] = "ook11Petr1" // @poff=672
0x9ce: Call2 0x8e9
...
0x9d8: Push((int) 399)
0x9d9: Push((int) 2)
0x9da: Push((int) 525937)
0x9db: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9dc: Pop(3)
0x9dd: PushEmpty(bool, object, int)
0x9de: Stack[-4] = Stack[-2]
0x9df: Stack[-1] = (int) 397
0x9e0: Call2 0x9fe
...
0x9e5: Push((int) 403)
0x9e6: Push((int) 2)
0x9e7: Push((int) 525941)
0x9e8: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9e9: Pop(3)
0x9ea: PushEmpty(bool, object, int)
0x9eb: Stack[-4] = Stack[-2]
0x9ec: Stack[-1] = (int) 397
0x9ed: Call2 0x9fe
...
0x9f2: @ GetDiaryRoot(Stack[-1])
0x9f3: Pop(0)
0x9f4: Pop(0); Push((bool) Stack[-1] == 0)
0x9f5: IF (Stack[-1] == 0) GOTO 0x9fb; Pop(1)

0x9f6: Push("Can't retrieve diary root") // @poff=772
0x9f7: @ Trace(Stack[-1])
0x9f8: Pop(1)
0x9f9: Stack[-3] = (bool) 0
0x9fa: Return(); Pop(2)

0x9fb: Stack[-1] = Stack[-3]
0x9fc: Return(); Pop(2)

0x9fd: Stack[-1] = 0
0x9fe: PushEmpty(object, object, int, object, object, int)
0x9ff: PushEmpty(object)
0xa00: Call2 0x9f1

0xa01: Stack[-1] = Stack[-4]
0xa02: Pop(1)
0xa03: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=824
0xa04: Pop(0)
0xa05: Pop(0); Push((bool) Stack[-2] == 0)
0xa06: IF (Stack[-1] == 0) GOTO 0xa0d; Pop(1)

0xa07: Push("Can't find diary parent with id: ") // @poff=829
0xa08: Pop(1); Push(Stack[-1] + Stack[-8]);
0xa09: @ Trace(Stack[-1])
0xa0a: Pop(1)
0xa0b: Stack[-9] = (bool) 0
0xa0c: Return(); Pop(6)

0xa0d: @@ AddChild(Stack[-8]); Obj=2 // @poff=897
0xa0e: Pop(0)
0xa0f: Push((int) 7)
0xa10: @ SendWorldWndMessage(Stack[-1])
0xa11: Pop(1)
0xa12: @@ GetCategory(Stack[-1]); Obj=8 // @poff=906
0xa13: Pop(0)
0xa14: @ SetDiarySection(Stack[-1])
0xa15: Pop(0)
0xa16: Stack[-9] = (bool) 0
0xa17: Return(); Pop(6)

0xa18: Stack[-2] = 0
0xa19: Stack[-3] = 0
0xa1a: PushEmpty(object, object, object, object)
0xa1b: @ GetMainOutdoorScene(Stack[-2])
0xa1c: Pop(0)
0xa1d: Pop(0); PushNull((bool) Stack[-2] == 0)
0xa1e: IF (Stack[-1] == 0) GOTO 0xa25; Pop(1)

0xa1f: Push("Can't find main outdoor scene") // @poff=918
0xa20: @ Trace(Stack[-1])
0xa21: Pop(1)
0xa22: Stack[-1] = 0
0xa23: Stack[-1] = Stack[-5]
0xa24: Return(); Pop(4)

0xa25: @@ GetMap(Stack[-1]); Obj=2 // @poff=978
0xa26: Pop(0)
...
0xa29: Stack[-1] = 0
0xa2a: Stack[-2] = 0
0xa2b: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0xa2c: @ GetMainOutdoorScene(Stack[-2])
0xa2d: Pop(0)
0xa2e: Pop(0); PushNull((bool) Stack[-2] == 0)
0xa2f: IF (Stack[-1] == 0) GOTO 0xa34; Pop(1)

0xa30: Push("Can't find main outdoor scene") // @poff=918
0xa31: @ Trace(Stack[-1])
0xa32: Pop(1)
0xa33: Return(); Pop(8)

0xa34: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=985
0xa35: Pop(0)
0xa36: Pop(0); Push((bool) Stack[-1] == 0)
0xa37: IF (Stack[-1] == 0) GOTO 0xa3e; Pop(1)

0xa38: Push("Warning: outdoor scene locator ") // @poff=996
0xa39: Pop(1); Push(Stack[-1] + Stack[-11]);
0xa3a: Push(" doesnt exist") // @poff=1060
0xa3b: Pop(2); Push(Stack[-2] + Stack[-1]);
0xa3c: @ Trace(Stack[-1])
0xa3d: Pop(1)
0xa3e: @@ GetMap(Stack[-11]); Obj=2 // @poff=978
0xa3f: Pop(0)
0xa40: Pop(0); PushNull((bool) Stack[-11] == 0)
0xa41: IF (Stack[-1] == 0) GOTO 0xa46; Pop(1)

0xa42: Push("Can't find map") // @poff=1088
0xa43: @ Trace(Stack[-1])
0xa44: Pop(1)
0xa45: Return(); Pop(8)

0xa46: Push(CvectorIndex(Stack[-4], 0))
0xa47: Push(CvectorIndex(Stack[-5], 2))
0xa48: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1118
0xa49: Pop(2)
0xa4a: Return(); Pop(8)

0xa4b: Stack[-2] = 0
0xa4c: PushEmpty(int, int)
0xa4d: Push("branch") // @poff=1131
0xa4e: @ GetVariable(Stack[-1], Stack[-2])
0xa4f: Pop(1)
0xa50: Push((int) 0)
...
0xa5d: PushEmpty()
0xa5e: Push(GlobalVars[1])
0xa5f: Pop(1); Push((bool) Stack[-1] == 0)
0xa60: IF (Stack[-1] == 0) GOTO 0xa6a; Pop(1)

0xa61: PushEmpty(int, object)
0xa62: Stack[-3] = Stack[-1]
0xa63: Push(-2, 1); TaskCall(0)
0xa64: Call2 0x0

0xa65: Pop(-2, 1); TaskReturn
0xa66: Pop(2)
0xa67: Push(GlobalVars[1])
0xa68: Stack[-1] = (bool) 1
0xa69: GlobalVars[1] = Stack[-1]; Pop(1)
0xa6a: PushEmpty(bool, int)
0xa6b: Stack[-1] = (int) 5
0xa6c: Call2 0x934
...
0xa6f: PushEmpty(int, object)
0xa70: Stack[-3] = Stack[-1]
0xa71: Push(-2, 1); TaskCall(2)
0xa72: Call2 0xef

0xa73: Pop(-2, 1); TaskReturn
0xa74: Pop(2)
0xa75: Return(); Pop(0)

0xa76: PushEmpty(bool, int)
0xa77: Stack[-1] = (int) 11
0xa78: Call2 0x934

0xa79: Pop(1)
0xa7a: IF (Stack[-1] == 0) GOTO 0xa82; Pop(1)

0xa7b: PushEmpty(int, object)
0xa7c: Stack[-3] = Stack[-1]
0xa7d: Push(-2, 1); TaskCall(4)
0xa7e: Call2 0x399

0xa7f: Pop(-2, 1); TaskReturn
0xa80: Pop(2)
0xa81: Return(); Pop(0)

0xa82: PushEmpty(bool, int)
0xa83: Stack[-1] = (int) 12
0xa84: Call2 0x934
...
0xa89: Push(-2, 1); TaskCall(6)
0xa8a: Call2 0x4d2

0xa8b: Pop(-2, 1); TaskReturn
0xa8c: Pop(2)
0xa8d: Return(); Pop(0)

0xa8e: PushEmpty(int, object)
0xa8f: Stack[-3] = Stack[-1]
0xa90: Push(-2, 1); TaskCall(8)
0xa91: Call2 0x5d5
