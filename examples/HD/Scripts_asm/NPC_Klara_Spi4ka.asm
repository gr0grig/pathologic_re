...
Strings:
	...
	W:branch
	W:mt_spi4ka
// @pool_raw:
// @pool_encoding:utf8
...
0x10b: Pop(0)
0x10c: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x10d: Pop(1)
0x10e: PushEmpty(int)
0x10f: Call2 0x66b

0x110: Pop(0)
0x111: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x112: Pop(1)
0x113: PushEmpty(string)
0x114: Call2 0x66f

0x115: Pop(0)
0x116: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x117: Pop(1)
0x118: PushEmpty(string)
0x119: Call2 0x671

0x11a: Pop(0)
0x11b: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x11c: Pop(1)
0x11d: PushEmpty(int)
0x11e: Call2 0x6c0

0x11f: Pop(0)
0x120: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x121: Pop(1)
0x122: Stack[-2] = (int) -1
...
0x154: Stack[-1] = "Serious" // @poff=156
0x155: Call2 0x191
...
0x182: Push("all") // @poff=138
0x183: Push("idle") // @poff=146
...
0x18b: Push("all") // @poff=138
0x18c: Push("idle") // @poff=146
...
0x1b9: Stack[-1] = "Serious" // @poff=156
0x1ba: Call2 0x191
...
0x210: Stack[-1] = "Serious" // @poff=156
0x211: Call2 0x191
...
0x23a: Pop(0)
0x23b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x23c: Pop(1)
0x23d: PushEmpty(int)
0x23e: Call2 0x66b

0x23f: Pop(0)
0x240: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x241: Pop(1)
0x242: PushEmpty(string)
0x243: Call2 0x66f

0x244: Pop(0)
0x245: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x246: Pop(1)
0x247: PushEmpty(string)
0x248: Call2 0x671

0x249: Pop(0)
0x24a: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x24b: Pop(1)
0x24c: PushEmpty(int)
0x24d: Call2 0x6c0

0x24e: Pop(0)
0x24f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x250: Pop(1)
0x251: Stack[-2] = (int) -1
...
0x25d: Stack[-1] = Stack[-2]
0x25e: Pop(1)
0x25f: Call2 0x570

0x260: Pop(2)
0x261: PushEmpty(object, object)
0x262: Stack[-11] = Stack[-2]
0x263: Stack[-6] = Stack[-1]
0x264: Push(-2, 4); TaskCall(5)
0x265: Call2 0x27c

0x266: Pop(-2, 4); TaskReturn
0x267: Pop(2)
0x268: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x269: Pop(0)
...
0x26c: @ sync()
0x26d: Pop(0)
0x26e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x26f: Pop(0)
0x270: GOTO 0x26a

0x271: PushEmpty(object)
0x272: Stack[-10] = Stack[-1]
0x273: Call2 0x55e

0x274: Pop(1)
0x275: @ StopDialog(Stack[-4])
0x276: Pop(0)
0x277: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x278: Pop(0)
0x279: Stack[-2] = Stack[-10]
0x27a: Return(); Pop(8)
...
0x33d: Pop(0)
0x33e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x33f: Pop(1)
0x340: PushEmpty(int)
0x341: Call2 0x66b

0x342: Pop(0)
0x343: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x344: Pop(1)
0x345: PushEmpty(string)
0x346: Call2 0x66f

0x347: Pop(0)
0x348: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x349: Pop(1)
0x34a: PushEmpty(string)
0x34b: Call2 0x671

0x34c: Pop(0)
0x34d: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x34e: Pop(1)
0x34f: PushEmpty(int)
0x350: Call2 0x6c0

0x351: Pop(0)
0x352: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x353: Pop(1)
0x354: Stack[-2] = (int) -1
...
0x416: Stack[-2] = Stack[-5]
0x417: Pop(2)
0x418: Return(); Pop(2)

0x419: Stack[-1] = 0
0x41a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x41b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x41c: @ RotateAsync(Stack[-2], Stack[-1])
0x41d: Pop(2)
0x41e: Return(); Pop(0)

0x41f: PushEmpty(object, bool, object, bool)
0x420: Push("player") // @poff=186
...
0x4fb: Pop(0)
0x4fc: @@ GetPosition(Stack[-2]); Obj=7 // @poff=200
0x4fd: Pop(0)
...
0x508: Pop(2)
0x509: Stack[-1] = Stack[-8]
0x50a: Return(); Pop(6)

0x50b: PushEmpty(cvector, cvector)
0x50c: @@ GetPosition(Stack[-1]); Obj=3 // @poff=200
0x50d: Pop(0)
...
0x51a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=200
0x51b: Pop(0)
0x51c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=212
0x51d: Pop(0)
...
0x589: Push("voice_common") // @poff=236
0x58a: Push((int) 1)
...
0x591: Push("voice_common") // @poff=236
0x592: Push((int) 0)
...
0x5a4: Push("voice_common") // @poff=236
0x5a5: Push((int) 1)
...
0x5b2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x5b3: Pop(1)
...
0x5dd: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x5de: Pop(1)
...
0x5f2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x5f3: Pop(1)
0x5f4: PushEmpty(bool, string)
0x5f5: Stack[-3] = Stack[-1]
0x5f6: Call2 0x619

0x5f7: Stack[-2] = Stack[-14]
0x5f8: Pop(2)
0x5f9: Return(); Pop(10)
...
0x605: Push("Can't find lsh animation : ") // @poff=294
...
0x614: Push("Can't find lsh animation : ") // @poff=294
...
0x66f: Stack[-1] = "ui/NPC_Spi4ka.png" // @poff=350
0x670: Return(); Pop(0)

0x671: Stack[-1] = "ui/NPC_Spi4ka_b.png" // @poff=386
0x672: Return(); Pop(0)
...
0x69c: Push("Can't retrieve diary root") // @poff=438
0x69d: @ Trace(Stack[-1])
0x69e: Pop(1)
...
0x6a8: Pop(1)
0x6a9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=490
0x6aa: Pop(0)
0x6ab: Pop(0); Push((bool) Stack[-2] == 0)
0x6ac: IF (Stack[-1] == 0) GOTO 0x6b3; Pop(1)

0x6ad: Push("Can't find diary parent with id: ") // @poff=495
...
0x6b3: @@ AddChild(Stack[-8]); Obj=2 // @poff=563
0x6b4: Pop(0)
0x6b5: Push((int) 7)
0x6b6: @ SendWorldWndMessage(Stack[-1])
0x6b7: Pop(1)
0x6b8: @@ GetCategory(Stack[-1]); Obj=8 // @poff=572
0x6b9: Pop(0)
