...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x165: Push("all") // @poff=138
0x166: Push("idle") // @poff=146
...
0x16e: Push("all") // @poff=138
0x16f: Push("idle") // @poff=146
...
0x245: Stack[-1] = "Neutral" // @poff=89
0x246: Call2 0x174

0x247: Pop(1)
0x248: Push((int) 529002)
0x249: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x24a: Pop(1)
0x24b: @@@ ClearReplies(); Obj=0 // @poff=116
0x24c: Pop(0)
...
0x26e: Stack[-1] = "Neutral" // @poff=89
0x26f: Call2 0x174

0x270: Pop(1)
0x271: Push((int) 529007)
0x272: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x273: Pop(1)
0x274: @@@ ClearReplies(); Obj=0 // @poff=116
0x275: Pop(0)
...
0x280: Stack[-1] = "Refusal" // @poff=170
0x281: Call2 0x174
...
0x2e5: Pop(0)
0x2e6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2e7: Pop(1)
0x2e8: PushEmpty(int)
0x2e9: Call2 0x930

0x2ea: Pop(0)
0x2eb: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2ec: Pop(1)
0x2ed: PushEmpty(string)
0x2ee: Call2 0x934

0x2ef: Pop(0)
0x2f0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2f1: Pop(1)
0x2f2: PushEmpty(string)
0x2f3: Call2 0x936

0x2f4: Pop(0)
0x2f5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2f6: Pop(1)
0x2f7: PushEmpty(int)
0x2f8: Call2 0xa15

0x2f9: Pop(0)
0x2fa: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2fb: Pop(1)
0x2fc: Stack[-2] = (int) -1
...
0x308: Stack[-1] = Stack[-2]
0x309: Pop(1)
0x30a: Call2 0x829

0x30b: Pop(2)
0x30c: PushEmpty(object, object)
0x30d: Stack[-11] = Stack[-2]
0x30e: Stack[-6] = Stack[-1]
0x30f: Push(-2, 4); TaskCall(5)
0x310: Call2 0x327

0x311: Pop(-2, 4); TaskReturn
0x312: Pop(2)
0x313: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x314: Pop(0)
...
0x317: @ sync()
0x318: Pop(0)
0x319: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x31a: Pop(0)
0x31b: GOTO 0x315

0x31c: PushEmpty(object)
0x31d: Stack[-10] = Stack[-1]
0x31e: Call2 0x817

0x31f: Pop(1)
0x320: @ StopDialog(Stack[-4])
0x321: Pop(0)
0x322: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x323: Pop(0)
0x324: Stack[-2] = Stack[-10]
0x325: Return(); Pop(8)
...
0x371: IF (Stack[-1] == 1) GOTO 0x381; Pop(1)
...
0x39e: Push("all") // @poff=138
0x39f: Push("idle") // @poff=146
...
0x400: Stack[-1] = "Neutral" // @poff=89
0x401: Call2 0x3ad

0x402: Pop(1)
0x403: Push((int) 527376)
0x404: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x405: Pop(1)
0x406: @@@ ClearReplies(); Obj=0 // @poff=116
0x407: Pop(0)
...
0x40f: Stack[-1] = "Neutral" // @poff=89
0x410: Call2 0x3ad

0x411: Pop(1)
0x412: Push((int) 527212)
0x413: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x414: Pop(1)
0x415: @@@ ClearReplies(); Obj=0 // @poff=116
0x416: Pop(0)
...
0x430: IF (Stack[-1] == 1) GOTO 0x440; Pop(1)
...
0x43e: IF (Stack[-1] == 1) GOTO 0x440; Pop(1)
...
0x450: Stack[-1] = "Refusal" // @poff=170
0x451: Call2 0x3ad
...
0x462: Stack[-1] = "Refusal" // @poff=170
0x463: Call2 0x3ad
...
0x498: Stack[-1] = "Neutral" // @poff=89
0x499: Call2 0x3ad

0x49a: Pop(1)
0x49b: Push((int) 527340)
0x49c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x49d: Pop(1)
0x49e: @@@ ClearReplies(); Obj=0 // @poff=116
0x49f: Pop(0)
...
0x4e5: Stack[-1] = "Neutral" // @poff=89
0x4e6: Call2 0x3ad

0x4e7: Pop(1)
0x4e8: Push((int) 527344)
0x4e9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x4ea: Pop(1)
0x4eb: @@@ ClearReplies(); Obj=0 // @poff=116
0x4ec: Pop(0)
...
0x4f7: Stack[-1] = "Refusal" // @poff=170
0x4f8: Call2 0x3ad
...
0x563: Stack[-1] = "Oracle" // @poff=156
0x564: Call2 0x3ad

0x565: Pop(1)
0x566: Push((int) 527372)
0x567: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x568: Pop(1)
0x569: @@@ ClearReplies(); Obj=0 // @poff=116
0x56a: Pop(0)
...
0x5a4: Pop(0)
0x5a5: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x5a6: Pop(1)
0x5a7: PushEmpty(int)
0x5a8: Call2 0x930

0x5a9: Pop(0)
0x5aa: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x5ab: Pop(1)
0x5ac: PushEmpty(string)
0x5ad: Call2 0x934

0x5ae: Pop(0)
0x5af: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x5b0: Pop(1)
0x5b1: PushEmpty(string)
0x5b2: Call2 0x936

0x5b3: Pop(0)
0x5b4: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x5b5: Pop(1)
0x5b6: PushEmpty(int)
0x5b7: Call2 0xa15

0x5b8: Pop(0)
0x5b9: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x5ba: Pop(1)
0x5bb: Stack[-2] = (int) -1
...
0x5d1: Pop(2)
0x5d2: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5d3: Pop(0)
...
0x5d6: @ sync()
0x5d7: Pop(0)
0x5d8: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x5d9: Pop(0)
0x5da: GOTO 0x5d4
...
0x5e0: Pop(0)
0x5e1: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x5e2: Pop(0)
0x5e3: Stack[-2] = Stack[-10]
0x5e4: Return(); Pop(8)
...
0x616: Push("all") // @poff=138
0x617: Push("idle") // @poff=146
...
0x61f: Push("all") // @poff=138
0x620: Push("idle") // @poff=146
...
0x69f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x6a0: Pop(3)
0x6a1: Return(); Pop(0)
...
0x6cf: Stack[-2] = Stack[-5]
0x6d0: Pop(2)
0x6d1: Return(); Pop(2)

0x6d2: Stack[-1] = 0
0x6d3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x6d4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x6d5: @ RotateAsync(Stack[-2], Stack[-1])
0x6d6: Pop(2)
0x6d7: Return(); Pop(0)

0x6d8: PushEmpty(object, bool, object, bool)
0x6d9: Push("player") // @poff=186
...
0x7b4: Pop(0)
0x7b5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=200
0x7b6: Pop(0)
...
0x7c1: Pop(2)
0x7c2: Stack[-1] = Stack[-8]
0x7c3: Return(); Pop(6)

0x7c4: PushEmpty(cvector, cvector)
0x7c5: @@ GetPosition(Stack[-1]); Obj=3 // @poff=200
0x7c6: Pop(0)
0x7c7: PushEmpty(bool, cvector)
0x7c8: Stack[-3] = Stack[-1]
0x7c9: Call2 0x7ba

0x7ca: Stack[-2] = Stack[-6]
0x7cb: Pop(2)
0x7cc: Return(); Pop(2)
...
0x7d3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=200
0x7d4: Pop(0)
0x7d5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=212
0x7d6: Pop(0)
...
0x842: Push("voice_common") // @poff=236
0x843: Push((int) 1)
...
0x84a: Push("voice_common") // @poff=236
0x84b: Push((int) 0)
...
0x85d: Push("voice_common") // @poff=236
0x85e: Push((int) 1)
...
0x86b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x86c: Pop(1)
...
0x896: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x897: Pop(1)
...
0x8ab: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x8ac: Pop(1)
0x8ad: PushEmpty(bool, string)
0x8ae: Stack[-3] = Stack[-1]
0x8af: Call2 0x8d2

0x8b0: Stack[-2] = Stack[-14]
0x8b1: Pop(2)
0x8b2: Return(); Pop(10)
...
0x8be: Push("Can't find lsh animation : ") // @poff=294
...
0x8cd: Push("Can't find lsh animation : ") // @poff=294
...
0x8f1: Push((float)9.999999974752427e-07)
...
0x934: Stack[-1] = "ui/NPC_Starshina.png" // @poff=350
0x935: Return(); Pop(0)

0x936: Stack[-1] = "ui/NPC_Starshina_b.png" // @poff=392
0x937: Return(); Pop(0)
...
0x94c: PushEmpty()
0x94d: Push("ook11Starshina1") // @poff=450
0x94e: Push((int) 1)
...
0x95b: Stack[-2] = "quest_k11_01" // @poff=496
0x95c: Stack[-1] = "place_burah" // @poff=522
0x95d: Call2 0x8fd
...
0x960: PushEmpty()
0x961: Push("ook11Starshina2") // @poff=546
0x962: Push((int) 1)
...
0x96b: Stack[-2] = "quest_k11_01" // @poff=496
0x96c: Stack[-1] = "fail" // @poff=578
0x96d: Call2 0x8fd
...
0x996: Stack[-1] = "ook11Starshina1" // @poff=450
0x997: Call2 0x8f8
...
0x9ae: Stack[-1] = "ook11Starshina2" // @poff=546
0x9af: Call2 0x8f8
...
0x9f1: Push("Can't retrieve diary root") // @poff=588
0x9f2: @ Trace(Stack[-1])
0x9f3: Pop(1)
...
0x9fd: Pop(1)
0x9fe: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=640
0x9ff: Pop(0)
0xa00: Pop(0); Push((bool) Stack[-2] == 0)
0xa01: IF (Stack[-1] == 0) GOTO 0xa08; Pop(1)

0xa02: Push("Can't find diary parent with id: ") // @poff=645
...
0xa08: @@ AddChild(Stack[-8]); Obj=2 // @poff=713
0xa09: Pop(0)
0xa0a: Push((int) 7)
0xa0b: @ SendWorldWndMessage(Stack[-1])
0xa0c: Pop(1)
0xa0d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=722
0xa0e: Pop(0)
