...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x65: Stack[-1] = "Confusion" // @poff=89
0x66: Call2 0xab

0x67: Pop(1)
0x68: Push((int) 525599)
0x69: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x6a: Pop(1)
0x6b: @@@ ClearReplies(); Obj=0 // @poff=120
0x6c: Pop(0)
0x6d: PushEmpty(bool)
0x6e: Stack[-1] = (bool) 0
...
0x7c: Push((int) 26948)
0x7d: Push((int) 26947)
0x7e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x7f: Pop(3)
0x80: Push((int) 525605)
0x81: Push((int) -1)
0x82: Push((int) 26952)
0x83: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x84: Pop(3)
0x85: Push((int) 542220)
0x86: Push((int) -1)
0x87: Push((int) 44551)
0x88: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x89: Pop(3)
0x8a: GOTO 0x8d
...
0x9c: Push("all") // @poff=142
0x9d: Push("idle") // @poff=150
...
0xa5: Push("all") // @poff=142
0xa6: Push("idle") // @poff=150
...
0xe8: Stack[-1] = "Confusion" // @poff=89
0xe9: Call2 0xab

0xea: Pop(1)
0xeb: Push((int) 525599)
0xec: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0xed: Pop(1)
0xee: @@@ ClearReplies(); Obj=0 // @poff=120
0xef: Pop(0)
0xf0: PushEmpty(bool)
0xf1: Stack[-1] = (bool) 0
...
0x101: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x102: Pop(3)
0x103: Push((int) 525605)
0x104: Push((int) -1)
0x105: Push((int) 26952)
0x106: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x107: Pop(3)
0x108: Push((int) 542220)
0x109: Push((int) -1)
0x10a: Push((int) 44551)
0x10b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x10c: Pop(3)
0x10d: Return(); Pop(0)
...
0x112: Stack[-1] = "Confusion" // @poff=89
0x113: Call2 0xab

0x114: Pop(1)
0x115: Push((int) 525601)
0x116: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x117: Pop(1)
0x118: @@@ ClearReplies(); Obj=0 // @poff=120
0x119: Pop(0)
0x11a: Push((int) 542221)
0x11b: Push((int) 44554)
0x11c: Push((int) 44552)
0x11d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x11e: Pop(3)
0x11f: Push((int) 542222)
0x120: Push((int) 44555)
0x121: Push((int) 44553)
0x122: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x123: Pop(3)
0x124: Return(); Pop(0)
...
0x129: Stack[-1] = "Anger" // @poff=160
0x12a: Call2 0xab

0x12b: Pop(1)
0x12c: Push((int) 542224)
0x12d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x12e: Pop(1)
0x12f: @@@ ClearReplies(); Obj=0 // @poff=120
0x130: Pop(0)
0x131: Push((int) 542225)
0x132: Push((int) 44554)
0x133: Push((int) 44556)
0x134: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x135: Pop(3)
0x136: Push((int) 542226)
0x137: Push((int) 44560)
0x138: Push((int) 44557)
0x139: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x13a: Pop(3)
0x13b: Return(); Pop(0)
...
0x140: Stack[-1] = "Anger" // @poff=160
0x141: Call2 0xab

0x142: Pop(1)
0x143: Push((int) 542223)
0x144: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x145: Pop(1)
0x146: @@@ ClearReplies(); Obj=0 // @poff=120
0x147: Pop(0)
0x148: Push((int) 542227)
0x149: Push((int) 44562)
0x14a: Push((int) 44559)
0x14b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x14c: Pop(3)
0x14d: Push((int) 542232)
0x14e: Push((int) 44562)
0x14f: Push((int) 44564)
0x150: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x151: Pop(3)
0x152: Return(); Pop(0)
...
0x157: Stack[-1] = "Surprise" // @poff=172
0x158: Call2 0xab

0x159: Pop(1)
0x15a: Push((int) 542230)
0x15b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x15c: Pop(1)
0x15d: @@@ ClearReplies(); Obj=0 // @poff=120
0x15e: Pop(0)
0x15f: Push((int) 542231)
0x160: Push((int) 44560)
0x161: Push((int) 44563)
0x162: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x163: Pop(3)
0x164: Push((int) 542229)
0x165: Push((int) 44560)
0x166: Push((int) 44561)
0x167: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x168: Pop(3)
0x169: Return(); Pop(0)
...
0x16e: Stack[-1] = "Surprise" // @poff=172
0x16f: Call2 0xab

0x170: Pop(1)
0x171: Push((int) 542228)
0x172: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x173: Pop(1)
0x174: @@@ ClearReplies(); Obj=0 // @poff=120
0x175: Pop(0)
0x176: Push((int) 525602)
0x177: Push((int) 26950)
0x178: Push((int) 26949)
0x179: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x17a: Pop(3)
0x17b: Push((int) 542238)
0x17c: Push((int) 44568)
0x17d: Push((int) 44573)
0x17e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x17f: Pop(3)
0x180: Return(); Pop(0)
...
0x185: Stack[-1] = "Surprise" // @poff=172
0x186: Call2 0xab
...
0x190: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x191: Pop(3)
...
0x19c: Stack[-1] = "Neutral" // @poff=190
0x19d: Call2 0xab

0x19e: Pop(1)
0x19f: Push((int) 542234)
0x1a0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1a1: Pop(1)
0x1a2: @@@ ClearReplies(); Obj=0 // @poff=120
0x1a3: Pop(0)
0x1a4: Push((int) 542236)
0x1a5: Push((int) 44571)
0x1a6: Push((int) 44570)
0x1a7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1a8: Pop(3)
0x1a9: Return(); Pop(0)
...
0x1ae: Stack[-1] = "Neutral" // @poff=190
0x1af: Call2 0xab

0x1b0: Pop(1)
0x1b1: Push((int) 542237)
0x1b2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1b3: Pop(1)
0x1b4: @@@ ClearReplies(); Obj=0 // @poff=120
0x1b5: Pop(0)
0x1b6: Push((int) 525604)
0x1b7: Push((int) -1)
0x1b8: Push((int) 26951)
0x1b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1ba: Pop(3)
0x1bb: Push((int) 541131)
0x1bc: Push((int) -1)
0x1bd: Push((int) 43252)
0x1be: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1bf: Pop(3)
0x1c0: Return(); Pop(0)
...
0x1dd: Pop(0)
0x1de: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x1df: Pop(1)
0x1e0: PushEmpty(int)
0x1e1: Call2 0xa0b

0x1e2: Pop(0)
0x1e3: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x1e4: Pop(1)
0x1e5: PushEmpty(string)
0x1e6: Call2 0xa0f

0x1e7: Pop(0)
0x1e8: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x1e9: Pop(1)
0x1ea: PushEmpty(string)
0x1eb: Call2 0xa11

0x1ec: Pop(0)
0x1ed: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x1ee: Pop(1)
0x1ef: PushEmpty(int)
0x1f0: Call2 0xac4

0x1f1: Pop(0)
0x1f2: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x1f3: Pop(1)
0x1f4: Stack[-2] = (int) -1
...
0x205: Stack[-11] = Stack[-2]
0x206: Stack[-6] = Stack[-1]
0x207: Push(-2, 4); TaskCall(4)
0x208: Call2 0x21f

0x209: Pop(-2, 4); TaskReturn
0x20a: Pop(2)
0x20b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x20c: Pop(0)
...
0x20f: @ sync()
0x210: Pop(0)
0x211: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x212: Pop(0)
0x213: GOTO 0x20d

0x214: PushEmpty(object)
0x215: Stack[-10] = Stack[-1]
0x216: Call2 0x8b3

0x217: Pop(1)
0x218: @ StopDialog(Stack[-4])
0x219: Pop(0)
0x21a: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x21b: Pop(0)
0x21c: Stack[-2] = Stack[-10]
0x21d: Return(); Pop(8)
...
0x226: Stack[-1] = "Neutral" // @poff=190
0x227: Call2 0x259

0x228: Pop(1)
0x229: Push((int) 525531)
0x22a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x22b: Pop(1)
0x22c: @@@ ClearReplies(); Obj=0 // @poff=120
0x22d: Pop(0)
0x22e: Push((int) 525532)
0x22f: Push((int) 44536)
0x230: Push((int) 26888)
0x231: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x232: Pop(3)
0x233: Push((int) 542207)
0x234: Push((int) 44538)
0x235: Push((int) 44535)
0x236: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x237: Pop(3)
0x238: GOTO 0x23b
...
0x24a: Push("all") // @poff=142
0x24b: Push("idle") // @poff=150
...
0x253: Push("all") // @poff=142
0x254: Push("idle") // @poff=150
...
0x279: Stack[-1] = "Neutral" // @poff=190
0x27a: Call2 0x259
...
0x289: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x28a: Pop(3)
0x28b: Return(); Pop(0)
...
0x290: Stack[-1] = "Neutral" // @poff=190
0x291: Call2 0x259

0x292: Pop(1)
0x293: Push((int) 542208)
0x294: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x295: Pop(1)
0x296: @@@ ClearReplies(); Obj=0 // @poff=120
0x297: Pop(0)
...
0x2a0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2a1: Pop(3)
0x2a2: Return(); Pop(0)
...
0x2a7: Stack[-1] = "Neutral" // @poff=190
0x2a8: Call2 0x259

0x2a9: Pop(1)
0x2aa: Push((int) 542210)
0x2ab: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2ac: Pop(1)
0x2ad: @@@ ClearReplies(); Obj=0 // @poff=120
0x2ae: Pop(0)
0x2af: Push((int) 542211)
0x2b0: Push((int) 44542)
0x2b1: Push((int) 44539)
0x2b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2b3: Pop(3)
0x2b4: Push((int) 542212)
0x2b5: Push((int) 44548)
0x2b6: Push((int) 44541)
0x2b7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2b8: Pop(3)
0x2b9: Return(); Pop(0)
...
0x2be: Stack[-1] = "Neutral" // @poff=190
0x2bf: Call2 0x259

0x2c0: Pop(1)
0x2c1: Push((int) 542217)
0x2c2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2c3: Pop(1)
0x2c4: @@@ ClearReplies(); Obj=0 // @poff=120
0x2c5: Pop(0)
0x2c6: Push((int) 542218)
0x2c7: Push((int) 44542)
0x2c8: Push((int) 44549)
0x2c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2ca: Pop(3)
0x2cb: Push((int) 542219)
0x2cc: Push((int) -1)
0x2cd: Push((int) 44550)
0x2ce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2cf: Pop(3)
0x2d0: Return(); Pop(0)
...
0x2d5: Stack[-1] = "Neutral" // @poff=190
0x2d6: Call2 0x259

0x2d7: Pop(1)
0x2d8: Push((int) 542213)
0x2d9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2da: Pop(1)
0x2db: @@@ ClearReplies(); Obj=0 // @poff=120
0x2dc: Pop(0)
0x2dd: Push((int) 542215)
0x2de: Push((int) -1)
0x2df: Push((int) 44546)
0x2e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2e1: Pop(3)
0x2e2: Push((int) 542216)
0x2e3: Push((int) -1)
0x2e4: Push((int) 44547)
0x2e5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2e6: Pop(3)
0x2e7: Return(); Pop(0)
...
0x34d: Stack[-1] = "Fear" // @poff=206
0x34e: Call2 0x3a0

0x34f: Pop(1)
0x350: Push((int) 526939)
0x351: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x352: Pop(1)
0x353: @@@ ClearReplies(); Obj=0 // @poff=120
0x354: Pop(0)
...
0x364: IF (Stack[-1] == 1) GOTO 0x374; Pop(1)
...
0x378: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x379: Pop(3)
0x37a: Push((int) 526945)
0x37b: Push((int) -1)
0x37c: Push((int) 28237)
0x37d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x37e: Pop(3)
0x37f: GOTO 0x382
...
0x391: Push("all") // @poff=142
0x392: Push("idle") // @poff=150
...
0x39a: Push("all") // @poff=142
0x39b: Push("idle") // @poff=150
...
0x3c8: Stack[-1] = "Fear" // @poff=206
0x3c9: Call2 0x3a0

0x3ca: Pop(1)
0x3cb: Push((int) 526939)
0x3cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x3cd: Pop(1)
0x3ce: @@@ ClearReplies(); Obj=0 // @poff=120
0x3cf: Pop(0)
...
0x3df: IF (Stack[-1] == 1) GOTO 0x3ef; Pop(1)
...
0x3f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x3f4: Pop(3)
...
0x3ff: Stack[-1] = "Neutral" // @poff=190
0x400: Call2 0x3a0
...
0x40f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x410: Pop(3)
0x411: Return(); Pop(0)
...
0x416: Stack[-1] = "Neutral" // @poff=190
0x417: Call2 0x3a0

0x418: Pop(1)
0x419: Push((int) 527973)
0x41a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x41b: Pop(1)
0x41c: @@@ ClearReplies(); Obj=0 // @poff=120
0x41d: Pop(0)
0x41e: Push((int) 527974)
0x41f: Push((int) 29332)
0x420: Push((int) 29331)
0x421: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x422: Pop(3)
0x423: Return(); Pop(0)
...
0x428: Stack[-1] = "Neutral" // @poff=190
0x429: Call2 0x3a0

0x42a: Pop(1)
0x42b: Push((int) 527975)
0x42c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x42d: Pop(1)
0x42e: @@@ ClearReplies(); Obj=0 // @poff=120
0x42f: Pop(0)
0x430: Push((int) 527976)
0x431: Push((int) 29321)
0x432: Push((int) 29333)
0x433: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x434: Pop(3)
0x435: Return(); Pop(0)
...
0x43a: Stack[-1] = "Surprise" // @poff=172
0x43b: Call2 0x3a0

0x43c: Pop(1)
0x43d: Push((int) 526943)
0x43e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x43f: Pop(1)
0x440: @@@ ClearReplies(); Obj=0 // @poff=120
0x441: Pop(0)
0x442: Push((int) 526944)
0x443: Push((int) 29321)
0x444: Push((int) 28236)
0x445: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x446: Pop(3)
0x447: Return(); Pop(0)
...
0x44c: Stack[-1] = "Surprise" // @poff=172
0x44d: Call2 0x3a0

0x44e: Pop(1)
0x44f: Push((int) 527964)
0x450: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x451: Pop(1)
0x452: @@@ ClearReplies(); Obj=0 // @poff=120
0x453: Pop(0)
0x454: Push((int) 527966)
0x455: Push((int) 29324)
0x456: Push((int) 29323)
0x457: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x458: Pop(3)
0x459: Return(); Pop(0)
...
0x45e: Stack[-1] = "Confusion" // @poff=89
0x45f: Call2 0x3a0

0x460: Pop(1)
0x461: Push((int) 527967)
0x462: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x463: Pop(1)
0x464: @@@ ClearReplies(); Obj=0 // @poff=120
0x465: Pop(0)
0x466: Push((int) 527969)
0x467: Push((int) 29327)
0x468: Push((int) 29326)
0x469: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x46a: Pop(3)
0x46b: Push((int) 527968)
0x46c: Push((int) -1)
0x46d: Push((int) 29325)
0x46e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x46f: Pop(3)
0x470: Return(); Pop(0)
...
0x475: Stack[-1] = "Confusion" // @poff=89
0x476: Call2 0x3a0

0x477: Pop(1)
0x478: Push((int) 527970)
0x479: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x47a: Pop(1)
0x47b: @@@ ClearReplies(); Obj=0 // @poff=120
0x47c: Pop(0)
0x47d: Push((int) 527971)
0x47e: Push((int) -1)
0x47f: Push((int) 29328)
0x480: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x481: Pop(3)
0x482: Return(); Pop(0)
...
0x49f: Pop(0)
0x4a0: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x4a1: Pop(1)
0x4a2: PushEmpty(int)
0x4a3: Call2 0xa0b

0x4a4: Pop(0)
0x4a5: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x4a6: Pop(1)
0x4a7: PushEmpty(string)
0x4a8: Call2 0xa0f

0x4a9: Pop(0)
0x4aa: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x4ab: Pop(1)
0x4ac: PushEmpty(string)
0x4ad: Call2 0xa11

0x4ae: Pop(0)
0x4af: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x4b0: Pop(1)
0x4b1: PushEmpty(int)
0x4b2: Call2 0xac4

0x4b3: Pop(0)
0x4b4: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x4b5: Pop(1)
0x4b6: Stack[-2] = (int) -1
...
0x4c7: Stack[-11] = Stack[-2]
0x4c8: Stack[-6] = Stack[-1]
...
0x4d1: @ sync()
0x4d2: Pop(0)
0x4d3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x4d4: Pop(0)
0x4d5: GOTO 0x4cf
...
0x4db: Pop(0)
0x4dc: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x4dd: Pop(0)
0x4de: Stack[-2] = Stack[-10]
0x4df: Return(); Pop(8)
...
0x4e8: Stack[-1] = "Neutral" // @poff=190
0x4e9: Call2 0x525

0x4ea: Pop(1)
0x4eb: Push((int) 528940)
0x4ec: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x4ed: Pop(1)
0x4ee: @@@ ClearReplies(); Obj=0 // @poff=120
0x4ef: Pop(0)
...
0x4f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x4f9: Pop(3)
0x4fa: Push((int) 528941)
0x4fb: Push((int) -1)
0x4fc: Push((int) 30374)
0x4fd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x4fe: Pop(3)
0x4ff: Push((int) 528942)
0x500: Push((int) -1)
0x501: Push((int) 30375)
0x502: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x503: Pop(3)
0x504: GOTO 0x507
...
0x516: Push("all") // @poff=142
0x517: Push("idle") // @poff=150
...
0x51f: Push("all") // @poff=142
0x520: Push("idle") // @poff=150
...
0x54d: Stack[-1] = "Neutral" // @poff=190
0x54e: Call2 0x525

0x54f: Pop(1)
0x550: Push((int) 528940)
0x551: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x552: Pop(1)
0x553: @@@ ClearReplies(); Obj=0 // @poff=120
0x554: Pop(0)
...
0x55d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x55e: Pop(3)
0x55f: Push((int) 528941)
0x560: Push((int) -1)
0x561: Push((int) 30374)
0x562: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x563: Pop(3)
0x564: Push((int) 528942)
0x565: Push((int) -1)
0x566: Push((int) 30375)
0x567: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x568: Pop(3)
0x569: Return(); Pop(0)
...
0x56e: Stack[-1] = "Confusion" // @poff=89
0x56f: Call2 0x525

0x570: Pop(1)
0x571: Push((int) 528944)
0x572: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x573: Pop(1)
0x574: @@@ ClearReplies(); Obj=0 // @poff=120
0x575: Pop(0)
0x576: Push((int) 528945)
0x577: Push((int) 30379)
0x578: Push((int) 30378)
0x579: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x57a: Pop(3)
0x57b: Push((int) 528948)
0x57c: Push((int) 30382)
0x57d: Push((int) 30381)
0x57e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x57f: Pop(3)
0x580: Return(); Pop(0)
...
0x585: Stack[-1] = "Confusion" // @poff=89
0x586: Call2 0x525

0x587: Pop(1)
0x588: Push((int) 528949)
0x589: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x58a: Pop(1)
0x58b: @@@ ClearReplies(); Obj=0 // @poff=120
0x58c: Pop(0)
0x58d: Push((int) 528950)
0x58e: Push((int) 30384)
0x58f: Push((int) 30383)
0x590: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x591: Pop(3)
0x592: Return(); Pop(0)
...
0x597: Stack[-1] = "Neutral" // @poff=190
0x598: Call2 0x525

0x599: Pop(1)
0x59a: Push((int) 528951)
0x59b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x59c: Pop(1)
0x59d: @@@ ClearReplies(); Obj=0 // @poff=120
0x59e: Pop(0)
0x59f: Push((int) 528952)
0x5a0: Push((int) 30391)
0x5a1: Push((int) 30385)
0x5a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5a3: Pop(3)
0x5a4: Push((int) 528954)
0x5a5: Push((int) 30386)
0x5a6: Push((int) 30387)
0x5a7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5a8: Pop(3)
0x5a9: Return(); Pop(0)
...
0x5ae: Stack[-1] = "Surprise" // @poff=172
0x5af: Call2 0x525

0x5b0: Pop(1)
0x5b1: Push((int) 528953)
0x5b2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x5b3: Pop(1)
0x5b4: @@@ ClearReplies(); Obj=0 // @poff=120
0x5b5: Pop(0)
0x5b6: Push((int) 528955)
0x5b7: Push((int) 30389)
0x5b8: Push((int) 30388)
0x5b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5ba: Pop(3)
0x5bb: Push((int) 528957)
0x5bc: Push((int) 30389)
0x5bd: Push((int) 30390)
0x5be: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5bf: Pop(3)
0x5c0: Return(); Pop(0)
...
0x5c5: Stack[-1] = "Surprise" // @poff=172
0x5c6: Call2 0x525

0x5c7: Pop(1)
0x5c8: Push((int) 528956)
0x5c9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x5ca: Pop(1)
0x5cb: @@@ ClearReplies(); Obj=0 // @poff=120
0x5cc: Pop(0)
0x5cd: Push((int) 528960)
0x5ce: Push((int) 30379)
0x5cf: Push((int) 30394)
0x5d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5d1: Pop(3)
0x5d2: Return(); Pop(0)
...
0x5d7: Stack[-1] = "Neutral" // @poff=190
0x5d8: Call2 0x525

0x5d9: Pop(1)
0x5da: Push((int) 528958)
0x5db: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x5dc: Pop(1)
0x5dd: @@@ ClearReplies(); Obj=0 // @poff=120
0x5de: Pop(0)
0x5df: Push((int) 528959)
0x5e0: Push((int) 30379)
0x5e1: Push((int) 30392)
0x5e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5e3: Pop(3)
0x5e4: Return(); Pop(0)
...
0x5e9: Stack[-1] = "Neutral" // @poff=190
0x5ea: Call2 0x525

0x5eb: Pop(1)
0x5ec: Push((int) 528946)
0x5ed: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x5ee: Pop(1)
0x5ef: @@@ ClearReplies(); Obj=0 // @poff=120
0x5f0: Pop(0)
0x5f1: Push((int) 528947)
0x5f2: Push((int) -1)
0x5f3: Push((int) 30380)
0x5f4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x5f5: Pop(3)
0x5f6: Return(); Pop(0)
...
0x613: Pop(0)
0x614: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x615: Pop(1)
0x616: PushEmpty(int)
0x617: Call2 0xa0b

0x618: Pop(0)
0x619: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x61a: Pop(1)
0x61b: PushEmpty(string)
0x61c: Call2 0xa0f

0x61d: Pop(0)
0x61e: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x61f: Pop(1)
0x620: PushEmpty(string)
0x621: Call2 0xa11

0x622: Pop(0)
0x623: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x624: Pop(1)
0x625: PushEmpty(int)
0x626: Call2 0xac4

0x627: Pop(0)
0x628: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x629: Pop(1)
0x62a: Stack[-2] = (int) -1
...
0x636: Stack[-1] = Stack[-2]
0x637: Pop(1)
0x638: Call2 0x8c5

0x639: Pop(2)
0x63a: PushEmpty(object, object)
0x63b: Stack[-11] = Stack[-2]
0x63c: Stack[-6] = Stack[-1]
0x63d: Push(-2, 4); TaskCall(10)
0x63e: Call2 0x655

0x63f: Pop(-2, 4); TaskReturn
0x640: Pop(2)
0x641: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x642: Pop(0)
...
0x645: @ sync()
0x646: Pop(0)
0x647: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x648: Pop(0)
0x649: GOTO 0x643

0x64a: PushEmpty(object)
0x64b: Stack[-10] = Stack[-1]
0x64c: Call2 0x8b3

0x64d: Pop(1)
0x64e: @ StopDialog(Stack[-4])
0x64f: Pop(0)
0x650: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x651: Pop(0)
0x652: Stack[-2] = Stack[-10]
0x653: Return(); Pop(8)
...
0x65c: Stack[-1] = "Neutral" // @poff=190
0x65d: Call2 0x694

0x65e: Pop(1)
0x65f: Push((int) 535231)
0x660: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x661: Pop(1)
0x662: @@@ ClearReplies(); Obj=0 // @poff=120
0x663: Pop(0)
0x664: Push((int) 535232)
0x665: Push((int) 36953)
0x666: Push((int) 36907)
0x667: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x668: Pop(3)
0x669: Push((int) 535233)
0x66a: Push((int) -1)
0x66b: Push((int) 36908)
0x66c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x66d: Pop(3)
0x66e: Push((int) 535280)
0x66f: Push((int) -1)
0x670: Push((int) 36956)
0x671: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x672: Pop(3)
0x673: GOTO 0x676
...
0x685: Push("all") // @poff=142
0x686: Push("idle") // @poff=150
...
0x68e: Push("all") // @poff=142
0x68f: Push("idle") // @poff=150
...
0x6b4: Stack[-1] = "Neutral" // @poff=190
0x6b5: Call2 0x694

0x6b6: Pop(1)
0x6b7: Push((int) 535231)
0x6b8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x6b9: Pop(1)
0x6ba: @@@ ClearReplies(); Obj=0 // @poff=120
0x6bb: Pop(0)
0x6bc: Push((int) 535232)
0x6bd: Push((int) 36953)
0x6be: Push((int) 36907)
0x6bf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6c0: Pop(3)
0x6c1: Push((int) 535233)
0x6c2: Push((int) -1)
0x6c3: Push((int) 36908)
0x6c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6c5: Pop(3)
0x6c6: Push((int) 535280)
0x6c7: Push((int) -1)
0x6c8: Push((int) 36956)
0x6c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6ca: Pop(3)
0x6cb: Return(); Pop(0)
...
0x6d0: Stack[-1] = "Neutral" // @poff=190
0x6d1: Call2 0x694

0x6d2: Pop(1)
0x6d3: Push((int) 535277)
0x6d4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x6d5: Pop(1)
0x6d6: @@@ ClearReplies(); Obj=0 // @poff=120
0x6d7: Pop(0)
0x6d8: Push((int) 535278)
0x6d9: Push((int) 36957)
0x6da: Push((int) 36954)
0x6db: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6dc: Pop(3)
0x6dd: Push((int) 535279)
0x6de: Push((int) 36957)
0x6df: Push((int) 36955)
0x6e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6e1: Pop(3)
0x6e2: Return(); Pop(0)
...
0x6e7: Stack[-1] = "Neutral" // @poff=190
0x6e8: Call2 0x694

0x6e9: Pop(1)
0x6ea: Push((int) 535281)
0x6eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x6ec: Pop(1)
0x6ed: @@@ ClearReplies(); Obj=0 // @poff=120
0x6ee: Pop(0)
0x6ef: Push((int) 535282)
0x6f0: Push((int) -1)
0x6f1: Push((int) 36958)
0x6f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6f3: Pop(3)
0x6f4: Push((int) 535283)
0x6f5: Push((int) -1)
0x6f6: Push((int) 36959)
0x6f7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x6f8: Pop(3)
0x6f9: Return(); Pop(0)
...
0x716: Pop(0)
0x717: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x718: Pop(1)
0x719: PushEmpty(int)
0x71a: Call2 0xa0b

0x71b: Pop(0)
0x71c: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x71d: Pop(1)
0x71e: PushEmpty(string)
0x71f: Call2 0xa0f

0x720: Pop(0)
0x721: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x722: Pop(1)
0x723: PushEmpty(string)
0x724: Call2 0xa11

0x725: Pop(0)
0x726: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x727: Pop(1)
0x728: PushEmpty(int)
0x729: Call2 0xac4

0x72a: Pop(0)
0x72b: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x72c: Pop(1)
0x72d: Stack[-2] = (int) -1
...
0x73e: Stack[-11] = Stack[-2]
0x73f: Stack[-6] = Stack[-1]
0x740: Push(-2, 4); TaskCall(12)
0x741: Call2 0x758

0x742: Pop(-2, 4); TaskReturn
0x743: Pop(2)
0x744: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x745: Pop(0)
...
0x748: @ sync()
0x749: Pop(0)
0x74a: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x74b: Pop(0)
0x74c: GOTO 0x746

0x74d: PushEmpty(object)
0x74e: Stack[-10] = Stack[-1]
0x74f: Call2 0x8b3

0x750: Pop(1)
0x751: @ StopDialog(Stack[-4])
0x752: Pop(0)
0x753: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x754: Pop(0)
0x755: Stack[-2] = Stack[-10]
0x756: Return(); Pop(8)
...
0x75f: Stack[-1] = "Neutral" // @poff=190
0x760: Call2 0x792

0x761: Pop(1)
0x762: Push((int) 540545)
0x763: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x764: Pop(1)
0x765: @@@ ClearReplies(); Obj=0 // @poff=120
0x766: Pop(0)
0x767: Push((int) 540546)
0x768: Push((int) -1)
0x769: Push((int) 42555)
0x76a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x76b: Pop(3)
0x76c: Push((int) 540798)
0x76d: Push((int) -1)
0x76e: Push((int) 42847)
0x76f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x770: Pop(3)
0x771: GOTO 0x774
...
0x783: Push("all") // @poff=142
0x784: Push("idle") // @poff=150
...
0x78c: Push("all") // @poff=142
0x78d: Push("idle") // @poff=150
...
0x7b2: Stack[-1] = "Neutral" // @poff=190
0x7b3: Call2 0x792

0x7b4: Pop(1)
0x7b5: Push((int) 540545)
0x7b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x7b7: Pop(1)
0x7b8: @@@ ClearReplies(); Obj=0 // @poff=120
0x7b9: Pop(0)
0x7ba: Push((int) 540546)
0x7bb: Push((int) -1)
0x7bc: Push((int) 42555)
0x7bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x7be: Pop(3)
0x7bf: Push((int) 540798)
0x7c0: Push((int) -1)
0x7c1: Push((int) 42847)
0x7c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x7c3: Pop(3)
0x7c4: Return(); Pop(0)
...
0x7d9: PushEmpty()
0x7da: Push("icot_viktor_NPC_Trigger") // @poff=216
...
0x7e1: @ GetPosition(Stack[-1]T)
0x7e2: Pop(0)
0x7e3: @ GetDirection(Stack[-2]T)
0x7e4: Pop(0)
...
0x7f4: Stack[-1] = "Neutral" // @poff=190
0x7f5: Call2 0x94f
...
0x7fd: @ SetPosition(Stack[-1]T)
0x7fe: Pop(0)
0x7ff: @ SetDirection(Stack[-2]T)
0x800: Pop(0)
0x801: Stack[0 + Tasks[-1].StackPointer] = (bool)0
0x802: Push("all") // @poff=142
0x803: Push("stand") // @poff=264
0x804: Push((int) 0)
...
0x80b: Push("all") // @poff=142
0x80c: Push("stand") // @poff=264
...
0x824: Stack[-5] = Stack[-1]
0x825: Call2 0x860

0x826: Pop(2)
0x827: EventEnable(0)
0x828: PushEmpty(object)
0x829: Stack[-4] = Stack[-1]
0x82a: Call2 0xad5
...
0x82e: Push("HasProperty") // @poff=276
0x82f: Push((int) 2)
...
0x835: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=300
0x836: Pop(0)
...
0x83b: Stack[-10] = Stack[-2]
0x83c: Stack[-9] = Stack[-1]
0x83d: Call2 0x82d
...
0x843: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=312
0x844: Pop(0)
0x845: PushEmpty(float, float, float, float)
0x846: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x847: Stack[-8] = Stack[-2]
0x848: Stack[-7] = Stack[-1]
0x849: Call2 0x994

0x84a: Pop(3)
0x84b: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=324
0x84c: Pop(1)
0x84d: Stack[-8] = (bool) 1
0x84e: Return(); Pop(2)

0x84f: PushEmpty(int, int)
0x850: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=312
0x851: Pop(0)
0x852: Pop(0); Push(Stack[-1] + Stack[-3]);
0x853: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=324
0x854: Pop(1)
0x855: Return(); Pop(2)
...
0x85d: Pop(2)
0x85e: Stack[-1] = Stack[-8]
0x85f: Return(); Pop(6)

0x860: PushEmpty(cvector, cvector)
0x861: @@ GetPosition(Stack[-1]); Obj=3 // @poff=336
0x862: Pop(0)
0x863: PushEmpty(bool, cvector)
0x864: Stack[-3] = Stack[-1]
0x865: Call2 0x856

0x866: Stack[-2] = Stack[-6]
0x867: Pop(2)
0x868: Return(); Pop(2)
...
0x86f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=336
0x870: Pop(0)
0x871: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=348
0x872: Pop(0)
...
0x8de: Push("voice_common") // @poff=372
0x8df: Push((int) 1)
...
0x8e6: Push("voice_common") // @poff=372
0x8e7: Push((int) 0)
...
0x8f9: Push("voice_common") // @poff=372
0x8fa: Push((int) 1)
...
0x907: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x908: Pop(1)
...
0x932: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x933: Pop(1)
...
0x947: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x948: Pop(1)
0x949: PushEmpty(bool, string)
0x94a: Stack[-3] = Stack[-1]
0x94b: Call2 0x96e

0x94c: Stack[-2] = Stack[-14]
0x94d: Pop(2)
0x94e: Return(); Pop(10)
...
0x95a: Push("Can't find lsh animation : ") // @poff=406
...
0x969: Push("Can't find lsh animation : ") // @poff=406
...
0x98d: Push((float)9.999999974752427e-07)
...
0x9b2: Stack[-7] = Stack[-3]
0x9b3: Stack[-2] = "money" // @poff=466
0x9b4: Stack[-6] = Stack[-1]
0x9b5: Call2 0x84f
...
0x9dd: Stack[-8] = Stack[-5]
0x9de: Stack[-4] = "reputation" // @poff=490
0x9df: Stack[-7] = Stack[-3]
0x9e0: Stack[-2] = (int) 0
0x9e1: Stack[-1] = (int) 1
0x9e2: Call2 0x839
...
0x9e8: Pop(0)
0x9e9: @@ add(Stack[-3]); Obj=1 // @poff=462
0x9ea: Pop(0)
0x9eb: Push((int) 16)
...
0x9f2: Pop(0)
0x9f3: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xa0f: Stack[-1] = "ui/NPC_Viktor.png" // @poff=512
0xa10: Return(); Pop(0)

0xa11: Stack[-1] = "ui/NPC_Viktor_b.png" // @poff=548
0xa12: Return(); Pop(0)
...
0xa17: Stack[-5] = Stack[-2]
0xa18: Stack[-1] = (float) 0.05000000074505806
0xa19: Call2 0x9c3
...
0xa1c: PushEmpty()
0xa1d: Push("ook3Viktor1") // @poff=588
0xa1e: Push((int) 1)
...
0xa22: PushEmpty()
0xa23: Push("money2000 is given") // @poff=612
0xa24: @ Trace(Stack[-1])
0xa25: Pop(1)
0xa26: PushEmpty(object, int)
0xa27: Stack[-4] = Stack[-2]
...
0xa2c: PushEmpty()
0xa2d: Push("ook10Viktor1") // @poff=650
0xa2e: Push((int) 1)
...
0xa3b: Stack[-2] = "quest_k9_01" // @poff=688
0xa3c: Stack[-1] = "init_mnogogrannik" // @poff=712
0xa3d: Call2 0x9f0
...
0xa40: PushEmpty()
0xa41: Push("playsound") // @poff=748
0xa42: Push("givemoney") // @poff=768
...
0xa54: Stack[-1] = "ook3Viktor1" // @poff=588
0xa55: Call2 0x99f
...
0xa6c: Stack[-1] = "ook10Viktor1" // @poff=650
0xa6d: Call2 0x99f
...
0xaa0: Push("Can't retrieve diary root") // @poff=814
0xaa1: @ Trace(Stack[-1])
0xaa2: Pop(1)
0xaa3: Stack[-3] = (bool) 0
0xaa4: Return(); Pop(2)

0xaa5: Stack[-1] = Stack[-3]
0xaa6: Return(); Pop(2)
...
0xaac: Pop(1)
0xaad: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=866
0xaae: Pop(0)
0xaaf: Pop(0); Push((bool) Stack[-2] == 0)
0xab0: IF (Stack[-1] == 0) GOTO 0xab7; Pop(1)

0xab1: Push("Can't find diary parent with id: ") // @poff=871
...
0xab7: @@ AddChild(Stack[-8]); Obj=2 // @poff=939
0xab8: Pop(0)
0xab9: Push((int) 7)
0xaba: @ SendWorldWndMessage(Stack[-1])
0xabb: Pop(1)
0xabc: @@ GetCategory(Stack[-1]); Obj=8 // @poff=948
0xabd: Pop(0)
