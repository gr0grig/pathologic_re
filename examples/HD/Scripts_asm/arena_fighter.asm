...
0x5b8: Push((float)0.699999988079071)
0x5b9: Push((int) 500)
...
0x5d8: Push(-1, 0); TaskCall(0)
0x5d9: Call2 0x0

0x5da: Pop(-1, 0); TaskReturn
0x5db: Pop(1)
0x5dc: Return(); Pop(0)

0x5dd: PushEmpty()
0x5de: PushEmpty(object, int, float)
0x5df: Stack[-7] = Stack[-3]
0x5e0: Stack[-6] = Stack[-2]
0x5e1: Stack[-5] = Stack[-1]
0x5e2: Call2 0x4fd
...
0x5e7: Stack[-11] = Stack[-5]
0x5e8: Stack[-10] = Stack[-4]
0x5e9: Stack[-9] = Stack[-3]
0x5ea: Stack[-7] = Stack[-2]
