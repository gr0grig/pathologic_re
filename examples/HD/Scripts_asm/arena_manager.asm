...
Strings:
	...
	W:arena_fighter.xml
	W:pers_worker
	W:arena_spectator_worker.xml
	W:pt_arena_spectator1
	W:pt_arena_spectator2
	W:pers_unosha
	W:arena_spectator_unosha.xml
	W:pt_arena_spectator3
	W:pt_arena_spectator4
	W:arena_spectator_unosha2.xml
	W:pt_arena_spectator5
	W:pers_dohodyaga
	W:arena_spectator_dohodyaga.xml
	W:pt_arena_spectator6
	W:pers_boy
	W:arena_spectator_boy.xml
	W:pt_arena_spectator7
	A:IsDead
	W:pt_arena_return
	A:GetItemCount
	A:GetItem
	...
	A:GetItemAmount
	A:RemoveItem
	W:Locator doesn't exist for arena spectator 
	...
	W:giveitem
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x15f: Pop(0)
0x160: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x161: Pop(1)
0x162: PushEmpty(int)
0x163: Call2 0x626

0x164: Pop(0)
0x165: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x166: Pop(1)
0x167: PushEmpty(string)
0x168: Call2 0x62a

0x169: Pop(0)
0x16a: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x16b: Pop(1)
0x16c: PushEmpty(string)
0x16d: Call2 0x62c

0x16e: Pop(0)
0x16f: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x170: Pop(1)
0x171: PushEmpty(int)
0x172: Call2 0x658

0x173: Pop(0)
0x174: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x175: Pop(1)
0x176: Stack[-2] = (int) -1
...
0x185: Pop(2)
0x186: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x187: Pop(0)
...
0x18a: @ sync()
0x18b: Pop(0)
0x18c: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x18d: Pop(0)
0x18e: GOTO 0x188

0x18f: PushEmpty(object)
0x190: Stack[-10] = Stack[-1]
0x191: Call2 0x4db

0x192: Pop(1)
0x193: @ StopDialog(Stack[-4])
0x194: Pop(0)
0x195: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x196: Pop(0)
0x197: Stack[-2] = Stack[-10]
0x198: Return(); Pop(8)
...
0x1c5: Push("all") // @poff=138
0x1c6: Push("idle") // @poff=146
...
0x1ce: Push("all") // @poff=138
0x1cf: Push("idle") // @poff=146
...
0x2ae: @ GetPFPosition(Stack[-1]T)
0x2af: Pop(0)
0x2b0: @ GetDirection(Stack[-0]T)
0x2b1: Pop(0)
0x2b2: PushEmpty()
0x2b3: Call2 0x306
...
0x2cf: @ FindPathTo(Stack[-1], Stack[-1]T)
0x2d0: Pop(0)
...
0x2de: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2df: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x2f1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2f2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x326: Pop(3)
0x327: @ CreateIntVector(Stack[-1]T)
0x328: Pop(0)
0x329: @ CreateIntVector(Stack[-3]T)
0x32a: Pop(0)
0x32b: @ CreateIntVector(Stack[-5]T)
0x32c: Pop(0)
0x32d: @ CreateIntVector(Stack[-7]T)
0x32e: Pop(0)
0x32f: @ CreateIntVector(Stack[-9]T)
0x330: Pop(0)
0x331: PushEmpty(object, object, int, object)
0x332: Stack[-29] = Stack[-3]
0x333: Stack[-2] = (int) 0
...
0x37a: @@ RemoveAllItems(Stack[-11]); Obj=25 // @poff=180
0x37b: Pop(0)
0x37c: Push((int) 1)
0x37d: Stack[-12] = Stack[-12] + Stack[-1]; Pop(1);
0x37e: GOTO 0x377

0x37f: @@ SelectWeapon(); Obj=25 // @poff=195
0x380: Pop(0)
0x381: @ GetScene(Stack[-10])
0x382: Pop(0)
0x383: Push("pt_arena_player") // @poff=208
0x384: @@ GetLocator(Stack[-1], Stack[-6], Stack[-10], Stack[-9]); Obj=11 // @poff=240
0x385: Pop(1)
0x386: Push("pt_arena_enemy") // @poff=251
0x387: @@ GetLocator(Stack[-1], Stack[-6], Stack[-8], Stack[-7]); Obj=11 // @poff=240
0x388: Pop(1)
0x389: @ Teleport(Stack[-25], Stack[-10], Stack[-9], Stack[-8])
0x38a: Pop(0)
0x38b: Push("pers_butcher") // @poff=281
0x38c: Push("arena_fighter.xml") // @poff=307
0x38d: @ AddActor(Stack[-6], Stack[-2], Stack[-12], Stack[-9], Stack[-8], Stack[-1])
0x38e: Pop(2)
0x38f: PushEmpty(object, string, string, string)
0x390: Stack[-14] = Stack[-4]
0x391: Stack[-3] = "pers_worker" // @poff=343
0x392: Stack[-2] = "arena_spectator_worker.xml" // @poff=367
0x393: Stack[-1] = "pt_arena_spectator1" // @poff=421
0x394: Call2 0x465

0x395: Pop(4)
0x396: PushEmpty(object, string, string, string)
0x397: Stack[-14] = Stack[-4]
0x398: Stack[-3] = "pers_worker" // @poff=343
0x399: Stack[-2] = "arena_spectator_worker.xml" // @poff=367
0x39a: Stack[-1] = "pt_arena_spectator2" // @poff=461
0x39b: Call2 0x465

0x39c: Pop(4)
0x39d: PushEmpty(object, string, string, string)
0x39e: Stack[-14] = Stack[-4]
0x39f: Stack[-3] = "pers_unosha" // @poff=501
0x3a0: Stack[-2] = "arena_spectator_unosha.xml" // @poff=525
0x3a1: Stack[-1] = "pt_arena_spectator3" // @poff=579
0x3a2: Call2 0x465

0x3a3: Pop(4)
0x3a4: PushEmpty(object, string, string, string)
0x3a5: Stack[-14] = Stack[-4]
0x3a6: Stack[-3] = "pers_unosha" // @poff=501
0x3a7: Stack[-2] = "arena_spectator_unosha.xml" // @poff=525
0x3a8: Stack[-1] = "pt_arena_spectator4" // @poff=619
0x3a9: Call2 0x465

0x3aa: Pop(4)
0x3ab: PushEmpty(object, string, string, string)
0x3ac: Stack[-14] = Stack[-4]
0x3ad: Stack[-3] = "pers_unosha" // @poff=501
0x3ae: Stack[-2] = "arena_spectator_unosha2.xml" // @poff=659
0x3af: Stack[-1] = "pt_arena_spectator5" // @poff=715
0x3b0: Call2 0x465

0x3b1: Pop(4)
0x3b2: PushEmpty(object, string, string, string)
0x3b3: Stack[-14] = Stack[-4]
0x3b4: Stack[-3] = "pers_dohodyaga" // @poff=755
0x3b5: Stack[-2] = "arena_spectator_dohodyaga.xml" // @poff=785
0x3b6: Stack[-1] = "pt_arena_spectator6" // @poff=845
0x3b7: Call2 0x465

0x3b8: Pop(4)
0x3b9: PushEmpty(object, string, string, string)
0x3ba: Stack[-14] = Stack[-4]
0x3bb: Stack[-3] = "pers_boy" // @poff=885
0x3bc: Stack[-2] = "arena_spectator_boy.xml" // @poff=903
0x3bd: Stack[-1] = "pt_arena_spectator7" // @poff=951
0x3be: Call2 0x465
...
0x3d7: @@ IsDead(Stack[-3]); Obj=4 // @poff=991
0x3d8: Pop(0)
0x3d9: Push(Stack[-3])
...
0x415: Pop(5)
0x416: @@ SelectWeapon(); Obj=25 // @poff=195
0x417: Pop(0)
0x418: Push("pt_arena_return") // @poff=998
0x419: @@ GetLocator(Stack[-1], Stack[-6], Stack[-3], Stack[-2]); Obj=11 // @poff=240
0x41a: Pop(1)
...
0x439: Push((int) 0)
0x43a: @@ GetItemCount(Stack[-9], Stack[-1]); Obj=18 // @poff=1030
0x43b: Pop(1)
0x43c: Stack[-7] = (int) 0
0x43d: Pop(0); Push((bool) Stack[-7] < Stack[-8])
0x43e: IF (Stack[-1] == 0) GOTO 0x464; Pop(1)

0x43f: @@ GetItem(Stack[-6], Stack[-7]); Obj=17 // @poff=1043
0x440: Pop(0)
0x441: @@ GetItemID(Stack[-5]); Obj=6 // @poff=1051
0x442: Pop(0)
0x443: Push("Group") // @poff=1061
0x444: @ HasInvItemProperty(Stack[-5], Stack[-6], Stack[-1])
0x445: Pop(1)
0x446: Push(Stack[-4])
0x447: IF (Stack[-1] == 0) GOTO 0x456; Pop(1)

0x448: Push("Group") // @poff=1061
...
0x450: Push((int) 0)
0x451: @@ IsItemSelected(Stack[-3], Stack[-8], Stack[-1]); Obj=18 // @poff=1073
0x452: Pop(1)
0x453: Push(Stack[-2])
...
0x456: Push((int) 0)
0x457: @@ GetItemAmount(Stack[-2], Stack[-8], Stack[-1]); Obj=18 // @poff=1088
0x458: Pop(1)
0x459: Push((int) 0)
0x45a: @@ RemoveItem(Stack[-8], Stack[-2], Stack[-1]); Obj=18 // @poff=1102
0x45b: Pop(1)
0x45c: Push((int) -1)
...
0x466: @@ GetLocator(Stack[-9], Stack[-2], Stack[-4], Stack[-3]); Obj=12 // @poff=240
0x467: Pop(0)
0x468: Pop(0); Push((bool) Stack[-2] == 0)
0x469: IF (Stack[-1] == 0) GOTO 0x46f; Pop(1)

0x46a: Push("Locator doesn't exist for arena spectator ") // @poff=1113
...
0x46f: Push((bool) 1)
0x470: @@ AddStationaryActor(Stack[-2], Stack[-5], Stack[-4], Stack[-12], Stack[-11], Stack[-1]); Obj=13 // @poff=1199
0x471: Pop(1)
0x472: @@@ add(Stack[-1]); Obj=15 // @poff=1218
0x473: Pop(0)
0x474: Return(); Pop(8)

0x475: Stack[-1] = 0
0x476: PushEmpty(int, int, object, object, int, int, object, object)
0x477: @@@ size(Stack[-4]); Obj=15 // @poff=1222
0x478: Pop(0)
0x479: Stack[-3] = (int) 0
0x47a: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x47b: IF (Stack[-1] == 0) GOTO 0x48b; Pop(1)

0x47c: @@@ get(Stack[-2], Stack[-3]); Obj=15 // @poff=1227
0x47d: Pop(0)
0x47e: @@ GetActor(Stack[-1]); Obj=2 // @poff=1231
0x47f: Pop(0)
...
0x490: Pop(0)
0x491: @@ GetPosition(Stack[-2]); Obj=7 // @poff=1253
0x492: Pop(0)
...
0x497: @@ GetPosition(Stack[-8]); Obj=20 // @poff=1253
0x498: Pop(0)
0x499: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=1265
0x49a: Pop(0)
...
0x4f1: Push("noaccess") // @poff=1279
0x4f2: @@ HasProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=1297
0x4f3: Pop(1)
0x4f4: Push(Stack[-2])
0x4f5: IF (Stack[-1] == 0) GOTO 0x4ff; Pop(1)

0x4f6: Push("noaccess") // @poff=1279
0x4f7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=1309
0x4f8: Pop(1)
0x4f9: Push("noaccess") // @poff=1279
0x4fa: Push((int) 1)
0x4fb: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4fc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=1321
0x4fd: Pop(2)
0x4fe: GOTO 0x503

0x4ff: Push("noaccess") // @poff=1279
0x500: Push((int) 1)
0x501: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=1321
0x502: Pop(2)
0x503: Return(); Pop(4)
...
0x508: Push("noaccess") // @poff=1279
0x509: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=1309
0x50a: Pop(1)
0x50b: Push((int) 1)
0x50c: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x50d: IF (Stack[-1] == 0) GOTO 0x514; Pop(1)

0x50e: Push("noaccess") // @poff=1279
0x50f: Push((int) 1)
0x510: Pop(1); Push(Stack[-3] - Stack[-1]);
0x511: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=1321
0x512: Pop(2)
0x513: GOTO 0x517

0x514: Push("noaccess") // @poff=1279
0x515: @@ RemoveProperty(Stack[-1]); Obj=4 // @poff=1333
0x516: Pop(1)
0x517: Return(); Pop(2)
...
0x523: Push("Can't find lsh animation : ") // @poff=1348
...
0x532: Push("Can't find lsh animation : ") // @poff=1348
...
0x53b: Pop(1)
0x53c: @@ GetItemCount(Stack[-4], Stack[-12]); Obj=13 // @poff=1030
0x53d: Pop(0)
0x53e: Stack[-3] = (int) 0
0x53f: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x540: IF (Stack[-1] == 0) GOTO 0x54d; Pop(1)

0x541: @@ GetItem(Stack[-2], Stack[-3], Stack[-12]); Obj=13 // @poff=1043
0x542: Pop(0)
0x543: @@ add(Stack[-2]); Obj=5 // @poff=1218
0x544: Pop(0)
0x545: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12]); Obj=13 // @poff=1088
0x546: Pop(0)
0x547: @@ add(Stack[-1]); Obj=11 // @poff=1218
0x548: Pop(0)
0x549: Stack[-2] = 0
0x54a: Push((int) 1)
...
0x552: Pop(0)
0x553: @@ GetItemCount(Stack[-3], Stack[-9]); Obj=10 // @poff=1030
0x554: Pop(0)
0x555: Stack[-2] = (int) 0
0x556: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x557: IF (Stack[-1] == 0) GOTO 0x561; Pop(1)

0x558: @@ IsItemSelected(Stack[-1], Stack[-2], Stack[-9]); Obj=10 // @poff=1073
0x559: Pop(0)
0x55a: Push(Stack[-1])
0x55b: IF (Stack[-1] == 0) GOTO 0x55e; Pop(1)

0x55c: @@ add(Stack[-2]); Obj=4 // @poff=1218
0x55d: Pop(0)
0x55e: Push((int) 1)
0x55f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x560: GOTO 0x556

0x561: Stack[-4] = Stack[-11]
0x562: Return(); Pop(8)

0x563: Stack[-4] = 0
0x564: PushEmpty(int, int, object, int, bool, int, int, int, int, object, int, bool, int, int)
0x565: @@ RemoveAllItems(Stack[-18]); Obj=19 // @poff=180
0x566: Pop(0)
0x567: @@ size(Stack[-7]); Obj=17 // @poff=1222
0x568: Pop(0)
0x569: Stack[-6] = (int) 0
0x56a: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x56b: IF (Stack[-1] == 0) GOTO 0x576; Pop(1)

0x56c: @@ get(Stack[-5], Stack[-6]); Obj=17 // @poff=1227
0x56d: Pop(0)
0x56e: @@ get(Stack[-4], Stack[-6]); Obj=16 // @poff=1227
0x56f: Pop(0)
0x570: @@ AddItem(Stack[-3], Stack[-5], Stack[-18], Stack[-4]); Obj=19 // @poff=1404
0x571: Pop(0)
0x572: Stack[-5] = 0
0x573: Push((int) 1)
...
0x576: @@ size(Stack[-7]); Obj=15 // @poff=1222
0x577: Pop(0)
0x578: Stack[-2] = (int) 0
0x579: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x57a: IF (Stack[-1] == 0) GOTO 0x583; Pop(1)

0x57b: @@ get(Stack[-1], Stack[-2]); Obj=15 // @poff=1227
0x57c: Pop(0)
0x57d: Push((bool) 1)
0x57e: @@ SelectItem(Stack[-2], Stack[-1], Stack[-19]); Obj=20 // @poff=1412
0x57f: Pop(1)
0x580: Push((int) 1)
...
0x585: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=1265
0x586: Pop(0)
...
0x599: Push((float)9.999999974752427e-07)
...
0x5b7: Stack[-2] = "noinv_drop" // @poff=1423
0x5b8: Stack[-1] = (int) -1
0x5b9: Call2 0x5af
...
0x5bd: Stack[-2] = "noinv_drop" // @poff=1423
0x5be: Stack[-1] = (int) 1
0x5bf: Call2 0x5af
...
0x5c3: Stack[-2] = "nouse_container" // @poff=1445
0x5c4: Stack[-1] = (int) -1
0x5c5: Call2 0x5af
...
0x5c9: Stack[-2] = "nouse_container" // @poff=1445
0x5ca: Stack[-1] = (int) 1
0x5cb: Call2 0x5af
...
0x5d0: Pop(0)
0x5d1: @@ add(Stack[-4]); Obj=1 // @poff=1218
0x5d2: Pop(0)
0x5d3: @@ add(Stack[-3]); Obj=1 // @poff=1218
0x5d4: Pop(0)
0x5d5: Push((int) 3)
...
0x5db: @@ GetItemID(Stack[-3]); Obj=8 // @poff=1051
0x5dc: Pop(0)
0x5dd: Push("Category") // @poff=1477
0x5de: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5df: Pop(1)
0x5e0: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=1404
0x5e1: Pop(0)
0x5e2: Pop(0); Push((bool) Stack[-1] == 0)
0x5e3: IF (Stack[-1] == 0) GOTO 0x5e7; Pop(1)

0x5e4: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=1495
0x5e5: Pop(0)
0x5e6: GOTO 0x5ec

0x5e7: PushEmpty(int, int)
0x5e8: Stack[-5] = Stack[-2]
...
0x5ef: Pop(0)
0x5f0: @@ SetItemName(Stack[-4]); Obj=1 // @poff=1505
0x5f1: Pop(0)
0x5f2: PushEmpty(object, object, int)
0x5f3: Stack[-8] = Stack[-3]
0x5f4: Stack[-4] = Stack[-2]
...
0x616: Stack[-2] = (int) 0
0x617: Push("all") // @poff=138
0x618: PushEmpty(string, int)
0x619: Stack[-5] = Stack[-1]
0x61a: Call2 0x60e
...
0x62a: Stack[-1] = "ui/NPC_Morlok.png" // @poff=1517
0x62b: Return(); Pop(0)

0x62c: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=1553
0x62d: Return(); Pop(0)
...
0x630: PushEmpty()
0x631: Push("ooArenaManager1") // @poff=1593
0x632: Push((int) 1)
...
0x636: PushEmpty()
0x637: Push((int) 1)
0x638: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1625
0x639: Pop(1)
0x63a: Return(); Pop(0)

0x63b: PushEmpty()
0x63c: Push("blood is given") // @poff=1640
0x63d: @ Trace(Stack[-1])
0x63e: Pop(1)
0x63f: PushEmpty(object, string, int)
0x640: Stack[-5] = Stack[-3]
0x641: Stack[-2] = "blood" // @poff=1670
0x642: Stack[-1] = (int) 1
0x643: Call2 0x5ed
...
0x646: PushEmpty()
0x647: Push("playsound") // @poff=1682
0x648: Push("giveitem") // @poff=1702
...
0x64e: Stack[-1] = "ooArenaManager1" // @poff=1593
0x64f: Call2 0x5aa
...
0x66a: Pop(0); PushNull((bool) Stack[-3] == 0)
