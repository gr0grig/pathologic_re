...
0x66: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=111
0x67: Pop(0)
0x68: Pop(0); Push((bool) Stack[-4] == 0)
0x69: IF (Stack[-1] == 0) GOTO 0x72; Pop(1)

0x6a: Push("Locator ") // @poff=122
0x6b: Pop(1); Push(Stack[-1] + Stack[-12]);
0x6c: Push(" doesn't exist") // @poff=140
