...
Events:
EVENT_16 Op = 0xaba Vars = (object, string)
EVENT_41 Op = 0xac7 Vars = (object)
EVENT_22 Op = 0xacd Vars = (object, int, float, float)
EVENT_43 Op = 0xad5 Vars = (object, int, float, float, cvector, cvector)
...
0x965: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x966: Return(); Pop(2)
...
0x9a8: Pop(0)
0x9a9: Push((int) 0)
0x9aa: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x9ab: IF (Stack[-1] == 0) GOTO 0x9b0; Pop(1)

0x9ac: Push((float)0.699999988079071)
0x9ad: Push((int) 500)
0x9ae: @ RumblePlay(Stack[-2], Stack[-1])
0x9af: Pop(2)
0x9b0: Push((int) 15)
0x9b1: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x9b2: Pop(1)
0x9b3: Return(); Pop(2)
...
0x9b9: PushEmpty(int)
0x9ba: Push((int) 24)
0x9bb: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x9bc: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x9bd: Return(); Pop(2)
...
0x9c0: Pop(0)
0x9c1: Push(Stack[-1])
0x9c2: IF (Stack[-1] == 0) GOTO 0x9c6; Pop(1)

0x9c3: Push("attack") // @poff=234
0x9c4: @ PlayGlobalMusic(Stack[-1])
0x9c5: Pop(1)
0x9c6: Return(); Pop(2)

0x9c7: PushEmpty(object, object)
0x9c8: @ GetScene(Stack[-1])
0x9c9: Pop(0)
0x9ca: Push("battle") // @poff=775
0x9cb: PushEmpty(object)
0x9cc: Call2 0x959

0x9cd: Pop(0)
0x9ce: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x9cf: Pop(2)
0x9d0: Return(); Pop(2)

0x9d1: Stack[-1] = 0
0x9d2: PushEmpty(int, int)
0x9d3: Push("branch") // @poff=789
0x9d4: @ GetVariable(Stack[-1], Stack[-2])
0x9d5: Pop(1)
...
0x9db: Pop(0)
0x9dc: Push((int) 1)
0x9dd: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9de: IF (Stack[-1] == 0) GOTO 0x9e2; Pop(1)

0x9df: @ WorkWithCorpse(Stack[-1])
0x9e0: Pop(0)
0x9e1: GOTO 0x9e4

0x9e2: @ Barter(Stack[-1])
0x9e3: Pop(0)
0x9e4: Return(); Pop(0)

0x9e5: PushEmpty(int, bool, int, bool)
0x9e6: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x9e7: IF (Stack[-1] == 0) GOTO 0x9ec; Pop(1)

0x9e8: Push("GenerateMoney: iMin > iMax") // @poff=803
0x9e9: @ Trace(Stack[-1])
0x9ea: Pop(1)
0x9eb: Return(); Pop(4)

0x9ec: Stack[-2] = (int) 0
0x9ed: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x9ee: IF (Stack[-1] == 0) GOTO 0x9f3; Pop(1)

0x9ef: Pop(0); Push(Stack[-5] - Stack[-6]);
0x9f0: @ irand(Stack[-3], Stack[-1])
0x9f1: Pop(1)
0x9f2: GOTO 0x9f7

0x9f3: Push((int) 0)
0x9f4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x9f5: IF (Stack[-1] == 0) GOTO 0x9f7; Pop(1)

0x9f6: Return(); Pop(4)

0x9f7: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x9f8: Push((int) 0)
...
0x9fd: Stack[-1] = "Money" // @poff=857
0x9fe: Call2 0xaad

0x9ff: Pop(1)
0xa00: Push((int) 0)
0xa01: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xa02: Pop(2)
0xa03: Return(); Pop(4)

0xa04: PushEmpty(object, int, bool, object, int, bool)
0xa05: @ CreateInvItem(Stack[-3])
0xa06: Pop(0)
0xa07: @@ SetItemName(Stack[-7]); Obj=3 // @poff=869
0xa08: Pop(0)
0xa09: Push("Organ") // @poff=881
0xa0a: Push((int) 1)
0xa0b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0xa0c: Pop(2)
0xa0d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=893
0xa0e: Pop(0)
0xa0f: Push((int) 0)
0xa10: Push((int) 1)
0xa11: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xa12: Pop(2)
0xa13: Return(); Pop(6)
...
0xa1d: Stack[-1] = "liver" // @poff=903
0xa1e: Call2 0xa04

0xa1f: Pop(1)
0xa20: PushEmpty(string)
0xa21: Stack[-1] = "kidney" // @poff=915
0xa22: Call2 0xa04

0xa23: Pop(1)
0xa24: PushEmpty(string)
0xa25: Stack[-1] = "heart" // @poff=929
0xa26: Call2 0xa04

0xa27: Pop(1)
0xa28: PushEmpty(string)
0xa29: Stack[-1] = "blood" // @poff=941
0xa2a: Call2 0xa04

0xa2b: Pop(1)
0xa2c: Return(); Pop(0)

0xa2d: PushEmpty(bool, bool)
0xa2e: Push((int) 0)
0xa2f: @ ClearSubContainer(Stack[-1])
0xa30: Pop(1)
...
0xa39: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xa3a: Call2 0x9e5

0xa3b: Pop(2)
0xa3c: PushEmpty(string, int, int)
0xa3d: Stack[-3] = "hook" // @poff=953
0xa3e: Stack[-2] = (int) 1
0xa3f: Stack[-1] = (int) 4
0xa40: Call2 0x916

0xa41: Pop(3)
0xa42: PushEmpty(string, int, int)
0xa43: Stack[-3] = "watch" // @poff=963
0xa44: Stack[-2] = (int) 1
0xa45: Stack[-1] = (int) 10
0xa46: Call2 0x916

0xa47: Pop(3)
0xa48: Return(); Pop(2)

0xa49: PushEmpty(int, bool, int, int, bool, int)
0xa4a: Push((int) 0)
0xa4b: @ ClearSubContainer(Stack[-1])
0xa4c: Pop(1)
0xa4d: PushEmpty(int)
0xa4e: Call2 0x9b5
...
0xa50: Pop(1)
0xa51: Push(Stack[-7])
0xa52: IF (Stack[-1] == 0) GOTO 0xa7f; Pop(1)

0xa53: PushEmpty(string, int, int, int)
0xa54: Stack[-4] = "alpha_pills" // @poff=975
0xa55: Stack[-3] = (int) 1
0xa56: Stack[-2] = (int) 2
0xa57: Stack[-1] = (int) 4
0xa58: Call2 0x921
...
0xa59: Pop(4)
0xa5a: PushEmpty(string, int, int, int)
0xa5b: Stack[-4] = "meradorm" // @poff=999
0xa5c: Stack[-3] = (int) 2
0xa5d: Stack[-2] = (int) 3
0xa5e: Stack[-1] = (int) 3
0xa5f: Call2 0x921
...
0xa64: PushEmpty(string, int, int)
0xa65: Stack[-3] = "beta_pills" // @poff=1017
0xa66: Stack[-2] = (int) 1
0xa67: Stack[-1] = (int) 4
0xa68: Call2 0x916
...
0xa6d: PushEmpty(string, int, int, int)
0xa6e: Stack[-4] = "monomicin" // @poff=1039
0xa6f: Stack[-3] = (int) 1
0xa70: Stack[-2] = (int) 2
0xa71: Stack[-1] = (int) 2
0xa72: Call2 0x921
...
0xa79: Stack[-3] = "monomicin" // @poff=1039
0xa7a: Stack[-2] = (int) 1
0xa7b: Stack[-1] = (int) 2
0xa7c: Call2 0x916
...
0xa7f: PushEmpty(string, int, int)
0xa80: Stack[-3] = "lockpick" // @poff=1059
0xa81: Stack[-2] = (int) 1
0xa82: Stack[-1] = (int) 4
0xa83: Call2 0x916

0xa84: Pop(3)
0xa85: PushEmpty(string, int, int)
0xa86: Stack[-3] = "rifle_ammo" // @poff=1077
0xa87: Stack[-2] = (int) 1
0xa88: Stack[-1] = (int) 2
0xa89: Call2 0x916

0xa8a: Pop(3)
0xa8b: PushEmpty(string, int, int)
0xa8c: Stack[-3] = "revolver_ammo" // @poff=1099
0xa8d: Stack[-2] = (int) 1
0xa8e: Stack[-1] = (int) 2
0xa8f: Call2 0x916

0xa90: Pop(3)
0xa91: PushEmpty(string, int, int, int)
0xa92: Stack[-4] = "samopal_ammo" // @poff=1127
0xa93: Stack[-3] = (int) 1
0xa94: Stack[-2] = (int) 2
0xa95: Stack[-1] = (int) 2
0xa96: Call2 0x921
...
0xa9a: IF (Stack[-1] == 0) GOTO 0xaa3; Pop(1)

0xa9b: PushEmpty(string, int, int, int)
0xa9c: Stack[-4] = "monomicin" // @poff=1039
0xa9d: Stack[-3] = (int) 1
0xa9e: Stack[-2] = (int) 2
0xa9f: Stack[-1] = (int) 2
0xaa0: Call2 0x921
...
0xaa5: IF (Stack[-1] == 0) GOTO 0xaac; Pop(1)

0xaa6: PushEmpty(string, int, int)
0xaa7: Stack[-3] = "monomicin" // @poff=1039
0xaa8: Stack[-2] = (int) 1
0xaa9: Stack[-1] = (int) 2
0xaaa: Call2 0x916
...
0xaae: @ GetInvItemByName(Stack[-1], Stack[-3])
0xaaf: Pop(0)
...
0xab5: Push(-1, 0); TaskCall(0)
0xab6: Call2 0x0

0xab7: Pop(-1, 0); TaskReturn
0xab8: Pop(1)
0xab9: Return(); Pop(0)

0xaba: PushEmpty(float, float)
0xabb: Push("health") // @poff=556
0xabc: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xabd: IF (Stack[-1] == 0) GOTO 0xac6; Pop(1)

0xabe: Push("health") // @poff=556
0xabf: @ GetProperty(Stack[-1], Stack[-2])
0xac0: Pop(1)
0xac1: Push((int) 0)
0xac2: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xac3: IF (Stack[-1] == 0) GOTO 0xac6; Pop(1)

0xac4: @ SignalDeath(Stack[-4])
0xac5: Pop(0)
0xac6: Return(); Pop(2)

0xac7: PushEmpty()
0xac8: PushEmpty(object)
0xac9: Stack[-2] = Stack[-1]
0xaca: Call2 0xab2
...
0xacd: PushEmpty()
0xace: PushEmpty(object, int, float)
0xacf: Stack[-7] = Stack[-3]
0xad0: Stack[-6] = Stack[-2]
0xad1: Stack[-5] = Stack[-1]
0xad2: Call2 0x8a9
...
0xad5: PushEmpty()
0xad6: PushEmpty(object, int, float, cvector, cvector)
0xad7: Stack[-11] = Stack[-5]
0xad8: Stack[-10] = Stack[-4]
0xad9: Stack[-9] = Stack[-3]
0xada: Stack[-7] = Stack[-2]
0xadb: Stack[-6] = Stack[-1]
0xadc: Call2 0x8ed
...
0xadf: PushEmpty()
0xae0: Push("unholster") // @poff=1153
0xae1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xae2: IF (Stack[-1] == 0) GOTO 0xaea; Pop(1)

0xae3: PushEmpty(bool, object)
0xae4: Stack[-4] = Stack[-1]
0xae5: Call2 0xc23

0xae6: Stack[-2] = Stack[-5]
0xae7: Pop(2)
0xae8: Return(); Pop(0)

0xae9: GOTO 0xafd

0xaea: Push("player_shot") // @poff=1173
0xaeb: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xaec: IF (Stack[-1] == 0) GOTO 0xaf4; Pop(1)

0xaed: PushEmpty(bool, object)
0xaee: Stack[-4] = Stack[-1]
0xaef: Call2 0xc28

0xaf0: Stack[-2] = Stack[-5]
0xaf1: Pop(2)
0xaf2: Return(); Pop(0)

0xaf3: GOTO 0xafd

0xaf4: Push("battle") // @poff=775
0xaf5: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xaf6: IF (Stack[-1] == 0) GOTO 0xafd; Pop(1)

0xaf7: PushEmpty(bool, object)
0xaf8: Stack[-4] = Stack[-1]
0xaf9: Call2 0xc3d

0xafa: Stack[-2] = Stack[-5]
0xafb: Pop(2)
0xafc: Return(); Pop(0)

0xafd: Stack[-3] = (bool) 0
0xafe: Return(); Pop(0)

0xaff: PushEmpty()
0xb00: Push("unholster") // @poff=1153
0xb01: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb02: IF (Stack[-1] == 0) GOTO 0xb08; Pop(1)

0xb03: PushEmpty(object)
0xb04: Stack[-3] = Stack[-1]
0xb05: Call2 0xc26

0xb06: Pop(1)
0xb07: GOTO 0xb17

0xb08: Push("player_shot") // @poff=1173
0xb09: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb0a: IF (Stack[-1] == 0) GOTO 0xb10; Pop(1)

0xb0b: PushEmpty(object)
0xb0c: Stack[-3] = Stack[-1]
0xb0d: Call2 0xc37

0xb0e: Pop(1)
0xb0f: GOTO 0xb17

0xb10: Push("battle") // @poff=775
0xb11: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb12: IF (Stack[-1] == 0) GOTO 0xb17; Pop(1)

0xb13: PushEmpty(object)
0xb14: Stack[-3] = Stack[-1]
0xb15: Call2 0xc40
...
0xb21: Stack[-6] = Stack[-1]
0xb22: Call2 0x7e2

0xb23: Pop(1)
0xb24: IF (Stack[-1] == 0) GOTO 0xb26; Pop(1)

0xb25: Stack[-1] = (bool) 1
0xb26: IF (Stack[-1] == 0) GOTO 0xb2d; Pop(1)

0xb27: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1197
0xb28: Pop(0)
0xb29: Pop(0); Push((bool) Stack[-1] == 0)
0xb2a: IF (Stack[-1] == 0) GOTO 0xb2d; Pop(1)

0xb2b: Stack[-4] = (bool) 1
0xb2c: Return(); Pop(2)

0xb2d: Stack[-4] = (bool) 0
0xb2e: Return(); Pop(2)

0xb2f: PushEmpty()
0xb30: PushEmpty(object)
...
0xb39: Pop(1)
0xb3a: IF (Stack[-1] == 0) GOTO 0xb41; Pop(1)

0xb3b: PushEmpty(object)
0xb3c: Call2 0x959

0xb3d: Pop(0)
0xb3e: Push((float)-0.05000000074505806)
0xb3f: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0xb40: Pop(2)
0xb41: Return(); Pop(0)

0xb42: PushEmpty(object, object)
0xb43: Push("heal") // @poff=1215
0xb44: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb45: IF (Stack[-1] == 0) GOTO 0xb50; Pop(1)

0xb46: Push("player") // @poff=1225
0xb47: @ FindActor(Stack[-2], Stack[-1])
0xb48: Pop(1)
0xb49: PushEmpty(bool, object)
0xb4a: Stack[-3] = Stack[-1]
0xb4b: Call2 0xc42

0xb4c: Stack[-2] = Stack[-6]
0xb4d: Pop(2)
0xb4e: Return(); Pop(2)

0xb4f: Stack[-1] = 0
0xb50: Stack[-4] = (bool) 0
0xb51: Return(); Pop(2)

0xb52: PushEmpty(object, object)
0xb53: Push("heal") // @poff=1215
0xb54: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb55: IF (Stack[-1] == 0) GOTO 0xb5e; Pop(1)

0xb56: Push("player") // @poff=1225
...
0xb5f: PushEmpty(string, string)
0xb60: Stack[-1] = "idle" // @poff=1239
0xb61: Push(Stack[-3])
0xb62: IF (Stack[-1] == 0) GOTO 0xb64; Pop(1)

0xb63: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xb64: Stack[-1] = Stack[-4]
0xb65: Return(); Pop(2)

0xb66: PushEmpty(int, bool, int, bool)
0xb67: Stack[-2] = (int) 0
0xb68: Push("all") // @poff=170
0xb69: PushEmpty(string, int)
0xb6a: Stack[-5] = Stack[-1]
0xb6b: Call2 0xb5f

0xb6c: Pop(1)
0xb6d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xb6e: Pop(2)
...
0xb72: Push((int) 1)
0xb73: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xb74: GOTO 0xb68

0xb75: Stack[-2] = Stack[-5]
0xb76: Return(); Pop(4)

0xb77: PushEmpty()
0xb78: PushEmpty(bool)
0xb79: Call2 0xc5d
...
0xb83: Push(-1, 1); TaskCall(3)
0xb84: Call2 0x307

0xb85: Pop(-1, 1); TaskReturn
0xb86: Pop(1)
0xb87: Return(); Pop(0)
...
0xb95: Push(-1, 6); TaskCall(4)
0xb96: Call2 0x41a

0xb97: Pop(-1, 6); TaskReturn
0xb98: Pop(1)
0xb99: Return(); Pop(0)

0xb9a: PushEmpty(string, string, string, string)
0xb9b: PushEmpty(bool, object, string)
0xb9c: Stack[-9] = Stack[-2]
0xb9d: Stack[-1] = "class" // @poff=1249
0xb9e: Call2 0x7e7

0xb9f: Pop(2)
0xba0: Pop(1); Push((bool) Stack[-1] == 0)
0xba1: IF (Stack[-1] == 0) GOTO 0xba4; Pop(1)

0xba2: Stack[-7] = (bool) 0
0xba3: Return(); Pop(4)

0xba4: Push("class") // @poff=1249
0xba5: @ GetProperty(Stack[-1], Stack[-3])
0xba6: Pop(1)
0xba7: Push("class") // @poff=1249
0xba8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xba9: Pop(1)
0xbaa: PushEmpty(bool)
0xbab: Stack[-1] = (bool) 0
0xbac: Pop(0); Push((bool) Stack[-6] == 0)
0xbad: IF (Stack[-1] == 0) GOTO 0xbb1; Pop(1)

0xbae: Pop(0); Push((bool) Stack[-3] == Stack[-2])
0xbaf: IF (Stack[-1] == 0) GOTO 0xbb1; Pop(1)

0xbb0: Stack[-1] = (bool) 1
0xbb1: IF (Stack[-1] == 0) GOTO 0xbb4; Pop(1)

0xbb2: Stack[-7] = (bool) 1
0xbb3: Return(); Pop(4)

0xbb4: Push("rat") // @poff=1261
0xbb5: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbb6: IF (Stack[-1] == 0) GOTO 0xbba; Pop(1)

0xbb7: Stack[-7] = (bool) 0
0xbb8: Return(); Pop(4)

0xbb9: GOTO 0xbe3

0xbba: Push("rat_big") // @poff=1269
0xbbb: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbbc: IF (Stack[-1] == 0) GOTO 0xbc0; Pop(1)
...
0xbc0: Push("dog") // @poff=1285
0xbc1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbc2: IF (Stack[-1] == 0) GOTO 0xbc6; Pop(1)

0xbc3: Stack[-7] = (bool) 0
0xbc4: Return(); Pop(4)

0xbc5: GOTO 0xbe3

0xbc6: Push("grabitel") // @poff=1293
0xbc7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbc8: IF (Stack[-1] == 0) GOTO 0xbcc; Pop(1)

0xbc9: Stack[-7] = (bool) 0
0xbca: Return(); Pop(4)

0xbcb: GOTO 0xbe3

0xbcc: Push("bomber") // @poff=1311
0xbcd: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbce: IF (Stack[-1] == 0) GOTO 0xbd2; Pop(1)

0xbcf: Stack[-7] = (bool) 0
0xbd0: Return(); Pop(4)

0xbd1: GOTO 0xbe3

0xbd2: Push("sanitar") // @poff=1325
0xbd3: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbd4: IF (Stack[-1] == 0) GOTO 0xbd8; Pop(1)

0xbd5: Stack[-7] = (bool) 0
0xbd6: Return(); Pop(4)

0xbd7: GOTO 0xbe3

0xbd8: Push("hunter") // @poff=1341
0xbd9: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbda: IF (Stack[-1] == 0) GOTO 0xbde; Pop(1)

0xbdb: Stack[-7] = (bool) 0
0xbdc: Return(); Pop(4)

0xbdd: GOTO 0xbe3

0xbde: Push("soldier") // @poff=1355
0xbdf: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xbe0: IF (Stack[-1] == 0) GOTO 0xbe3; Pop(1)

0xbe1: Stack[-7] = (bool) 0
0xbe2: Return(); Pop(4)

0xbe3: Stack[-7] = (bool) 1
0xbe4: Return(); Pop(4)

0xbe5: PushEmpty()
0xbe6: PushEmpty(int, object)
0xbe7: Stack[-4] = Stack[-1]
0xbe8: Call2 0xb88
...
0xbf2: PushEmpty(bool, bool)
0xbf3: PushEmpty(bool, object, bool)
0xbf4: Stack[-8] = Stack[-2]
0xbf5: Stack[-1] = !Stack[-6]; Pop(0);
0xbf6: Call2 0xb9a
...
0xbfa: Stack[-7] = (bool) 0
0xbfb: Return(); Pop(2)

0xbfc: @ CanSee(Stack[-1], Stack[-6])
0xbfd: Pop(0)
0xbfe: PushEmpty(bool)
0xbff: Stack[-1] = (bool) 1
0xc00: Push(Stack[-2])
0xc01: IF (Stack[-1] == 1) GOTO 0xc0a; Pop(1)

0xc02: PushEmpty(float, object)
0xc03: Stack[-9] = Stack[-1]
0xc04: Call2 0x7da

0xc05: Pop(1)
0xc06: Pop(0); Push(Stack[-6] * Stack[-6]);
0xc07: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc08: IF (Stack[-1] == 1) GOTO 0xc0a; Pop(1)

0xc09: Stack[-1] = (bool) 0
0xc0a: IF (Stack[-1] == 0) GOTO 0xc0d; Pop(1)

0xc0b: Stack[-7] = (bool) 1
0xc0c: Return(); Pop(2)

0xc0d: Stack[-7] = (bool) 0
0xc0e: Return(); Pop(2)
...
0xc29: @ CanSee(Stack[-1], Stack[-3])
0xc2a: Pop(0)
0xc2b: Stack[-4] = (bool) 1
0xc2c: Push(Stack[-1])
0xc2d: IF (Stack[-1] == 1) GOTO 0xc36; Pop(1)

0xc2e: PushEmpty(float, object)
0xc2f: Stack[-5] = Stack[-1]
0xc30: Call2 0x7da

0xc31: Pop(1)
0xc32: Push((int) 2250000)
0xc33: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc34: IF (Stack[-1] == 1) GOTO 0xc36; Pop(1)

0xc35: Stack[-4] = (bool) 0
0xc36: Return(); Pop(2)

0xc37: PushEmpty()
0xc38: PushEmpty(object)
0xc39: Stack[-2] = Stack[-1]
0xc3a: Call2 0xb80
...
0xc47: Push(GlobalVars[0])
0xc48: Stack[-1] = (bool) 0
0xc49: GlobalVars[0] = Stack[-1]; Pop(1)
...
0xc50: Push(GlobalVars[0])
0xc51: IF (Stack[-1] == 0) GOTO 0xc5c; Pop(1)

0xc52: @ IsOverrideActive(Stack[-1])
0xc53: Pop(0)
0xc54: Pop(0); Push((bool) Stack[-1] == 0)
0xc55: IF (Stack[-1] == 0) GOTO 0xc5a; Pop(1)

0xc56: PushEmpty(object)
0xc57: Stack[-4] = Stack[-1]
0xc58: Call2 0x9d8
...
0xc5f: PushEmpty()
0xc60: PushEmpty(bool, object, object, float, bool)
0xc61: Stack[-8] = Stack[-4]
0xc62: Stack[-7] = Stack[-3]
0xc63: Stack[-2] = (float) 700.0
0xc64: Stack[-6] = Stack[-1]
0xc65: Call2 0xbf2

0xc66: Stack[-5] = Stack[-9]
0xc67: Pop(5)
0xc68: Return(); Pop(0)
...
0xc6d: Pop(1)
0xc6e: IF (Stack[-1] == 0) GOTO 0xc7a; Pop(1)

0xc6f: PushEmpty(object)
0xc70: Call2 0x959

0xc71: Pop(0)
0xc72: Push((float)-0.10000000149011612)
0xc73: Push((bool) 1)
0xc74: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc75: Pop(3)
...
0xc7c: Pop(0)
0xc7d: Push(GlobalVars[0])
0xc7e: Stack[-1] = (bool) 1
0xc7f: GlobalVars[0] = Stack[-1]; Pop(1)
0xc80: Push((int) 50)
0xc81: Push((int) 40)
0xc82: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xc83: Pop(2)
0xc84: Return(); Pop(0)
