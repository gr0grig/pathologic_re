...
0x856: Push((float)0.699999988079071)
0x857: Push((int) 500)
...
0x87f: Push("GenerateMoney: iMin > iMax") // @poff=789
0x880: @ Trace(Stack[-1])
0x881: Pop(1)
0x882: Return(); Pop(4)
...
0x8d4: Stack[-1] = "syringe" // @poff=887
0x8d5: Call2 0x94a
...
0x912: Stack[-1] = "bracelet" // @poff=939
0x913: Call2 0x94a
...
0x91e: Stack[-1] = "ear_ring" // @poff=957
0x91f: Call2 0x94a
...
0x92a: Stack[-1] = "gold_ring" // @poff=975
0x92b: Call2 0x94a
...
0x936: Stack[-1] = "silver_ring" // @poff=995
0x937: Call2 0x94a
...
0x942: Stack[-1] = "flower" // @poff=1019
0x943: Call2 0x94a
...
0x96c: Stack[-7] = Stack[-3]
0x96d: Stack[-6] = Stack[-2]
...
0x974: Stack[-11] = Stack[-5]
0x975: Stack[-10] = Stack[-4]
0x976: Stack[-9] = Stack[-3]
0x977: Stack[-7] = Stack[-2]
...
0x99c: PushEmpty()
0x99d: Push("unholster") // @poff=1033
...
0x9c4: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1077
0x9c5: Pop(0)
...
0xa38: Stack[-9] = Stack[-2]
0xa39: Stack[-1] = "class" // @poff=1129
0xa3a: Call2 0x6d4
...
0xa40: Push("class") // @poff=1129
0xa41: @ GetProperty(Stack[-1], Stack[-3])
0xa42: Pop(1)
0xa43: Push("class") // @poff=1129
0xa44: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xa45: Pop(1)
...
0xa9c: Push(Stack[-2])
0xa9d: IF (Stack[-1] == 1) GOTO 0xaa6; Pop(1)

0xa9e: PushEmpty(float, object)
0xa9f: Stack[-9] = Stack[-1]
0xaa0: Call2 0x6c7
...
0xaee: Pop(0)
0xaef: Push((float)-0.05000000074505806)
0xaf0: Push((bool) 1)
