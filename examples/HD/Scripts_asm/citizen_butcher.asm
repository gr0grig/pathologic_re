...
0x98d: Push((float)0.699999988079071)
0x98e: Push((int) 500)
...
0x9c9: Push("GenerateMoney: iMin > iMax") // @poff=803
0x9ca: @ Trace(Stack[-1])
0x9cb: Pop(1)
0x9cc: Return(); Pop(4)
...
0x9e7: Pop(0)
0x9e8: @@ SetItemName(Stack[-7]); Obj=3 // @poff=869
0x9e9: Pop(0)
0x9ea: Push("Organ") // @poff=881
0x9eb: Push((int) 1)
0x9ec: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x9ed: Pop(2)
0x9ee: @@ GetItemID(Stack[-2]); Obj=3 // @poff=893
0x9ef: Pop(0)
0x9f0: Push((int) 0)
0x9f1: Push((int) 1)
...
0x9fe: Stack[-1] = "liver" // @poff=903
0x9ff: Call2 0x9e5

0xa00: Pop(1)
0xa01: PushEmpty(string)
0xa02: Stack[-1] = "kidney" // @poff=915
0xa03: Call2 0x9e5

0xa04: Pop(1)
0xa05: PushEmpty(string)
0xa06: Stack[-1] = "heart" // @poff=929
0xa07: Call2 0x9e5

0xa08: Pop(1)
0xa09: PushEmpty(string)
0xa0a: Stack[-1] = "blood" // @poff=941
0xa0b: Call2 0x9e5
...
0xa47: Stack[-1] = "syringe" // @poff=985
0xa48: Call2 0xabd
...
0xa85: Stack[-1] = "bracelet" // @poff=1037
0xa86: Call2 0xabd
...
0xa91: Stack[-1] = "ear_ring" // @poff=1055
0xa92: Call2 0xabd
...
0xa9d: Stack[-1] = "gold_ring" // @poff=1073
0xa9e: Call2 0xabd
...
0xaa9: Stack[-1] = "silver_ring" // @poff=1093
0xaaa: Call2 0xabd
...
0xab5: Stack[-1] = "flower" // @poff=1117
0xab6: Call2 0xabd
...
0xadf: Stack[-7] = Stack[-3]
0xae0: Stack[-6] = Stack[-2]
0xae1: Stack[-5] = Stack[-1]
0xae2: Call2 0x8a9
...
0xae7: Stack[-11] = Stack[-5]
0xae8: Stack[-10] = Stack[-4]
0xae9: Stack[-9] = Stack[-3]
0xaea: Stack[-7] = Stack[-2]
0xaeb: Stack[-6] = Stack[-1]
0xaec: Call2 0x8ed
...
0xaef: PushEmpty()
0xaf0: Push("unholster") // @poff=1131
...
0xaf6: Stack[-2] = Stack[-5]
0xaf7: Pop(2)
0xaf8: Return(); Pop(0)

0xaf9: GOTO 0xb0d

0xafa: Push("player_shot") // @poff=1151
...
0xb0f: PushEmpty()
0xb10: Push("unholster") // @poff=1131
...
0xb37: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1175
0xb38: Pop(0)
...
0xb77: Stack[-2] = (int) 0
0xb78: Push("all") // @poff=170
0xb79: PushEmpty(string, int)
0xb7a: Stack[-5] = Stack[-1]
0xb7b: Call2 0xb6f
...
0xbac: Stack[-9] = Stack[-2]
0xbad: Stack[-1] = "class" // @poff=1227
0xbae: Call2 0x7e7
...
0xbb4: Push("class") // @poff=1227
0xbb5: @ GetProperty(Stack[-1], Stack[-3])
0xbb6: Pop(1)
0xbb7: Push("class") // @poff=1227
0xbb8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xbb9: Pop(1)
...
0xbf9: Stack[-2] = Stack[-5]
0xbfa: Pop(2)
0xbfb: Return(); Pop(0)

0xbfc: PushEmpty()
0xbfd: PushEmpty(object)
0xbfe: Stack[-2] = Stack[-1]
0xbff: Call2 0xba2
...
0xc38: PushEmpty(bool, bool)
0xc39: @ CanSee(Stack[-1], Stack[-3])
0xc3a: Pop(0)
0xc3b: Stack[-4] = (bool) 1
0xc3c: Push(Stack[-1])
0xc3d: IF (Stack[-1] == 1) GOTO 0xc46; Pop(1)

0xc3e: PushEmpty(float, object)
0xc3f: Stack[-5] = Stack[-1]
0xc40: Call2 0x7da

0xc41: Pop(1)
0xc42: Push((int) 2250000)
0xc43: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc44: IF (Stack[-1] == 1) GOTO 0xc46; Pop(1)

0xc45: Stack[-4] = (bool) 0
0xc46: Return(); Pop(2)
...
0xc57: Push(GlobalVars[0])
0xc58: Stack[-1] = (bool) 0
0xc59: GlobalVars[0] = Stack[-1]; Pop(1)
0xc5a: Return(); Pop(0)

0xc5b: PushEmpty(bool, bool)
0xc5c: Push(GlobalVars[0])
0xc5d: IF (Stack[-1] == 0) GOTO 0xc67; Pop(1)

0xc5e: @ IsOverrideActive(Stack[-1])
0xc5f: Pop(0)
0xc60: Pop(0); Push((bool) Stack[-1] == 0)
0xc61: IF (Stack[-1] == 0) GOTO 0xc66; Pop(1)

0xc62: PushEmpty(object)
0xc63: Stack[-4] = Stack[-1]
0xc64: Call2 0x9b9
...
0xc6a: PushEmpty()
0xc6b: PushEmpty(bool, object, object, float, bool)
0xc6c: Stack[-8] = Stack[-4]
0xc6d: Stack[-7] = Stack[-3]
0xc6e: Stack[-2] = (float) 700.0
0xc6f: Stack[-6] = Stack[-1]
0xc70: Call2 0xc02

0xc71: Stack[-5] = Stack[-9]
0xc72: Pop(5)
0xc73: Return(); Pop(0)
...
0xc7a: PushEmpty(object)
0xc7b: Call2 0x93f

0xc7c: Pop(0)
0xc7d: Push((float)-0.07000000029802322)
0xc7e: Push((bool) 1)
0xc7f: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc80: Pop(3)
...
0xc87: Pop(0)
0xc88: Push(GlobalVars[0])
0xc89: Stack[-1] = (bool) 1
0xc8a: GlobalVars[0] = Stack[-1]; Pop(1)
0xc8b: Push((int) 50)
0xc8c: Push((int) 40)
0xc8d: @ SetRTEnvelope(Stack[-2], Stack[-1])
0xc8e: Pop(2)
0xc8f: Return(); Pop(0)
