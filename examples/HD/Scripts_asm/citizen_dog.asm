...
0xa5c: Push((float)0.699999988079071)
0xa5d: Push((int) 500)
...
0xa96: Stack[-7] = Stack[-3]
0xa97: Stack[-6] = Stack[-2]
0xa98: Stack[-5] = Stack[-1]
0xa99: Call2 0x970
...
0xa9e: Stack[-11] = Stack[-5]
0xa9f: Stack[-10] = Stack[-4]
0xaa0: Stack[-9] = Stack[-3]
0xaa1: Stack[-7] = Stack[-2]
0xaa2: Stack[-6] = Stack[-1]
0xaa3: Call2 0x9b4
...
0xaad: Stack[-2] = Stack[-5]
0xaae: Pop(2)
0xaaf: Return(); Pop(0)

0xab0: GOTO 0xac4

0xab1: Push("player_shot") // @poff=861
...
0xaee: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=885
0xaef: Pop(0)
...
0xb2e: Stack[-2] = (int) 0
0xb2f: Push("all") // @poff=170
0xb30: PushEmpty(string, int)
0xb31: Stack[-5] = Stack[-1]
0xb32: Call2 0xb26
...
0xb63: Stack[-9] = Stack[-2]
0xb64: Stack[-1] = "class" // @poff=937
0xb65: Call2 0x8ae
...
0xb6b: Push("class") // @poff=937
0xb6c: @ GetProperty(Stack[-1], Stack[-3])
0xb6d: Pop(1)
0xb6e: Push("class") // @poff=937
0xb6f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=634
0xb70: Pop(1)
...
0xbae: Stack[-4] = Stack[-1]
0xbaf: Call2 0xb4f

0xbb0: Stack[-2] = Stack[-5]
0xbb1: Pop(2)
0xbb2: Return(); Pop(0)

0xbb3: PushEmpty()
0xbb4: PushEmpty(object)
0xbb5: Stack[-2] = Stack[-1]
0xbb6: Call2 0xb59
...
0xbf3: Push(Stack[-1])
0xbf4: IF (Stack[-1] == 1) GOTO 0xbfd; Pop(1)

0xbf5: PushEmpty(float, object)
0xbf6: Stack[-5] = Stack[-1]
0xbf7: Call2 0x8a1

0xbf8: Pop(1)
0xbf9: Push((int) 4000000)
0xbfa: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xbfb: IF (Stack[-1] == 1) GOTO 0xbfd; Pop(1)
...
0xc1a: Stack[-8] = Stack[-4]
0xc1b: Stack[-7] = Stack[-3]
0xc1c: Stack[-2] = (float) 500.0
0xc1d: Stack[-6] = Stack[-1]
0xc1e: Call2 0xbb9

0xc1f: Stack[-5] = Stack[-9]
0xc20: Pop(5)
0xc21: Return(); Pop(0)

0xc22: PushEmpty()
0xc23: PushEmpty(bool, object)
0xc24: Stack[-3] = Stack[-1]
0xc25: Call2 0x8a9
