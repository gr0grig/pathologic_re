...
// @pool_raw:
...
0xf50: Push("reputation") // @poff=677
0xf51: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=380
0xf52: Pop(1)
0xf53: Stack[-1] = Stack[-5]
0xf54: Return(); Pop(4)
...
0xf6a: Stack[-4] = "rifle_ammo" // @poff=699
0xf6b: Stack[-3] = (int) 1
0xf6c: Stack[-2] = (int) 2
0xf6d: Stack[-1] = (int) 2
0xf6e: Call2 0xc85
...
0xf71: Stack[-4] = "revolver_ammo" // @poff=721
0xf72: Stack[-3] = (int) 1
0xf73: Stack[-2] = (int) 2
0xf74: Stack[-1] = (int) 2
0xf75: Call2 0xc85
...
0xf78: Stack[-4] = "samopal_ammo" // @poff=749
0xf79: Stack[-3] = (int) 2
0xf7a: Stack[-2] = (int) 2
0xf7b: Stack[-1] = (int) 2
0xf7c: Call2 0xc85
...
0xf80: Stack[-3] = "lockpick" // @poff=775
0xf81: Stack[-2] = (int) 1
0xf82: Stack[-1] = (int) 4
0xf83: Call2 0xc7a
...
0xf86: Stack[-4] = "alpha_pills" // @poff=793
0xf87: Stack[-3] = (int) 1
0xf88: Stack[-2] = (int) 2
0xf89: Stack[-1] = (int) 3
0xf8a: Call2 0xc85
...
0xf8d: Stack[-3] = "meradorm" // @poff=817
0xf8e: Stack[-2] = (int) 1
0xf8f: Stack[-1] = (int) 2
0xf90: Call2 0xc7a
...
0xfa0: Stack[-3] = "beta_pills" // @poff=849
0xfa1: Stack[-2] = (int) 1
0xfa2: Stack[-1] = (int) 2
0xfa3: Call2 0xc7a
...
0xfa9: Stack[-3] = "gamma_pills" // @poff=871
0xfaa: Stack[-2] = (int) 1
0xfab: Stack[-1] = (int) 7
0xfac: Call2 0xc7a
...
0xfb3: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=895
0xfb4: Return(); Pop(0)

0xfb5: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=935
0xfb6: Return(); Pop(0)
