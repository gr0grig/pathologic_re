...
0xc65: Push(Stack[-1])
0xc66: IF (Stack[-1] == 1) GOTO 0xc6f; Pop(1)

0xc67: PushEmpty(float, object)
0xc68: Stack[-5] = Stack[-1]
0xc69: Call2 0x7da

0xc6a: Pop(1)
0xc6b: Push((int) 2250000)
0xc6c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc6d: IF (Stack[-1] == 1) GOTO 0xc6f; Pop(1)
...
0xc98: Stack[-8] = Stack[-4]
0xc99: Stack[-7] = Stack[-3]
0xc9a: Stack[-2] = (float) 700.0
0xc9b: Stack[-6] = Stack[-1]
0xc9c: Call2 0xc02

0xc9d: Stack[-5] = Stack[-9]
0xc9e: Pop(5)
0xc9f: Return(); Pop(0)

0xca0: PushEmpty()
0xca1: PushEmpty(bool, object)
0xca2: Stack[-3] = Stack[-1]
0xca3: Call2 0x7e2
...
0xca8: Pop(0)
0xca9: Push((float)-0.07000000029802322)
0xcaa: Push((bool) 1)
