...
Strings:
	...
	W:reputation
// @pool_raw:
...
0xaa6: PushEmpty()
0xaa7: Stack[-3] = (float) 0.05000000074505806
0xaa8: Return(); Pop(0)
...
0xac1: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xac2: Pop(0)
0xac3: Push(Stack[-8])
0xac4: IF (Stack[-1] == 0) GOTO 0xacd; Pop(1)

0xac5: Push("attack") // @poff=382
...
0xae1: Pop(0)
0xae2: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0xae3: Pop(0)
...
0xafd: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0xafe: Pop(0)
...
0xb17: Pop(1)
0xb18: Push("all") // @poff=16
0xb19: Push("attack_on") // @poff=410
...
0xb31: IF (Stack[-1] == 1) GOTO 0xb37; Pop(1)

0xb32: PushEmpty(bool)
0xb33: Call2 0xd03

0xb34: Pop(0)
0xb35: IF (Stack[-1] == 1) GOTO 0xb37; Pop(1)

0xb36: Stack[-1] = (bool) 0
0xb37: IF (Stack[-1] == 0) GOTO 0xb48; Pop(1)

0xb38: @ Face(Stack[-0]T)
0xb39: Pop(0)
0xb3a: PushEmpty()
0xb3b: Call2 0xd35

0xb3c: Pop(0)
0xb3d: Push("all") // @poff=16
0xb3e: Push("attack_stay") // @poff=430
0xb3f: @ PlayAnimation(Stack[-2], Stack[-1])
0xb40: Pop(2)
0xb41: PushEmpty(bool, float)
0xb42: Stack[-25] = Stack[-1]
0xb43: Call2 0xc7f
...
0xb48: @ Face(Stack[-0]T)
0xb49: Pop(0)
0xb4a: Push("all") // @poff=16
0xb4b: Push("fjump") // @poff=454
...
0xb66: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0xb67: Pop(0)
...
0xb85: Push("all") // @poff=16
0xb86: Push("attack_off") // @poff=466
...
0xb93: Push("all") // @poff=16
0xb94: Push("attack_begin") // @poff=488
0xb95: Push((int) 1)
0xb96: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xba1: Push("attack") // @poff=382
0xba2: Push((int) 1)
0xba3: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xbad: Push("all") // @poff=16
0xbae: Push("bjump") // @poff=514
...
0xbb5: Push((float)0.8999999761581421)
0xbb6: Pop(1); Push(Stack[-9] * Stack[-1]);
0xbb7: @ GetVictim(Stack[-1], Stack[-4])
0xbb8: Pop(1)
0xbb9: @ ReportAttack(Stack[-0]T)
0xbba: Pop(0)
...
0xbbe: Stack[-6] = Stack[-2]
0xbbf: Stack[-10] = Stack[-1]
0xbc0: Call2 0xaa6

0xbc1: Stack[-3] = Stack[-5]
0xbc2: Pop(3)
0xbc3: PushEmpty(float, object, float, int)
0xbc4: Stack[-7] = Stack[-3]
0xbc5: Stack[-6] = Stack[-2]
0xbc6: PushEmpty(int, object, int)
0xbc7: Stack[-10] = Stack[-2]
0xbc8: Stack[-14] = Stack[-1]
0xbc9: Call2 0xaa9

0xbca: Stack[-3] = Stack[-4]
0xbcb: Pop(3)
0xbcc: Call2 0xe77

0xbcd: Stack[-4] = Stack[-5]
0xbce: Pop(4)
0xbcf: PushEmpty(int)
0xbd0: Call2 0xd33

0xbd1: Pop(0)
0xbd2: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0xbd3: Pop(1)
0xbd4: PushEmpty(object, float)
0xbd5: Stack[-5] = Stack[-2]
0xbd6: Stack[-3] = Stack[-1]
0xbd7: Call2 0xd3a
...
0xbde: Pop(0)
0xbdf: @ irand(Stack[-4], Stack[-1]T)
0xbe0: Pop(0)
0xbe1: Push((int) 1)
0xbe2: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xbe3: @ Face(Stack[-0]T)
0xbe4: Pop(0)
0xbe5: Push((bool) 1)
...
0xbea: Pop(0)
0xbeb: Push("all") // @poff=16
0xbec: Push("attack_begin") // @poff=488
...
0xc00: Stack[-11] = Stack[-2]
0xc01: Stack[-6] = Stack[-1]
0xc02: Call2 0xbb4

0xc03: Pop(2)
0xc04: Push("all") // @poff=16
0xc05: Push("attack_middle") // @poff=526
...
0xc0d: Pop(0)
0xc0e: Push("all") // @poff=16
0xc0f: Push("attack_middle") // @poff=526
...
0xc23: Stack[-11] = Stack[-2]
0xc24: Stack[-6] = Stack[-1]
0xc25: Call2 0xbb4

0xc26: Pop(2)
0xc27: Stack[-2] = (int) 1
0xc28: Push("attack_middle") // @poff=526
0xc29: Pop(1); Push(Stack[-1] + Stack[-5]);
0xc2a: Push("_") // @poff=554
0xc2b: Pop(2); Push(Stack[-2] + Stack[-1]);
0xc2c: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0xc2d: Push("all") // @poff=16
...
0xc52: Pop(1)
0xc53: Push("all") // @poff=16
0xc54: Push("attack_end") // @poff=558
...
0xc93: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0xc94: Pop(0)
...
0xcdf: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0xce0: Pop(1)
...
0xce4: @ Face(Stack[-0]T)
0xce5: Pop(0)
0xce6: Push("all") // @poff=16
0xce7: Push("bjump") // @poff=514
0xce8: @ PlayAnimation(Stack[-2], Stack[-1])
0xce9: Pop(2)
0xcea: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0xceb: Pop(0)
...
0xd21: @ irand(Stack[-1], Stack[-2]T)
0xd22: Pop(0)
0xd23: Push((int) 1)
0xd24: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xd25: Push("attack") // @poff=382
...
0xd36: Stack[-1] = "attack_stay" // @poff=430
0xd37: Call2 0x1054
...
0xd68: Stack[-15] = Stack[-5]
0xd69: Stack[-14] = Stack[-4]
0xd6a: Stack[-13] = Stack[-3]
0xd6b: Stack[-12] = Stack[-2]
0xd6c: Stack[-11] = Stack[-1]
0xd6d: Call2 0xdb2

0xd6e: Stack[-6] = Stack[-7]
0xd6f: Pop(6)
0xd70: Push( Stack[2 + Tasks[-1].StackPointer] )
0xd71: IF (Stack[-1] == 0) GOTO 0xd75; Pop(1)

0xd72: Push("head") // @poff=316
0xd73: @ UnlookAsync(Stack[-1])
0xd74: Pop(1)
0xd75: Push((int) 1)
0xd76: @ KillTimer(Stack[-1])
0xd77: Pop(1)
0xd78: Stack[-1] = Stack[-10]
0xd79: Return(); Pop(4)
...
0xdb5: Stack[-17] = Stack[-7]
0xdb6: PushEmpty(bool, object)
0xdb7: Stack[-23] = Stack[-1]
0xdb8: Call2 0xe3e
...
0xdbe: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0xdbf: Pop(0)
...
0xdd5: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0xdd6: Pop(0)
...
0xde7: Push((int) 0)
0xde8: Push((float)0.30000001192092896)
...
0xe0a: Push((int) 0)
0xe0b: Push((float)0.30000001192092896)
...
0xe40: Stack[-3] = Stack[-1]
0xe41: Call2 0xee9

0xe42: Stack[-2] = Stack[-4]
0xe43: Pop(2)
0xe44: Return(); Pop(0)

0xe45: Stack[-1] = "walk" // @poff=616
0xe46: Return(); Pop(0)

0xe47: Stack[-1] = "run" // @poff=626
0xe48: Return(); Pop(0)
...
0xe53: Stack[-2] = "bullet" // @poff=644
0xe54: Return(); Pop(0)

0xe55: Stack[-2] = "phys" // @poff=658
0xe56: Return(); Pop(0)

0xe57: PushEmpty(cvector, cvector, cvector, cvector)
0xe58: @ GetPosition(Stack[-2])
0xe59: Pop(0)
0xe5a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0xe5b: Pop(0)
...
0xe60: Pop(0)
0xe61: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0xe62: Pop(0)
...
0xe68: Pop(0)
0xe69: Stack[-1] = Stack[-4]
0xe6a: Return(); Pop(2)

0xe6b: PushEmpty(bool, bool)
0xe6c: Push("HasProperty") // @poff=668
0xe6d: Push((int) 2)
...
0xe73: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0xe74: Pop(0)
0xe75: Stack[-1] = Stack[-5]
0xe76: Return(); Pop(2)

0xe77: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0xe78: PushEmpty(bool, object, string)
0xe79: Stack[-18] = Stack[-2]
0xe7a: Stack[-1] = "health" // @poff=704
0xe7b: Call2 0xe6b
...
0xe82: Stack[-18] = Stack[-2]
0xe83: Stack[-1] = "armor" // @poff=718
0xe84: Call2 0xe6b
...
0xe8a: Push("armor") // @poff=718
0xe8b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0xe8c: Pop(1)
0xe8d: Push("armor_") // @poff=742
0xe8e: PushEmpty(string, int)
0xe8f: Stack[-16] = Stack[-1]
0xe90: Call2 0xe49

0xe91: Pop(1)
0xe92: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xe93: PushEmpty(bool, object, string)
0xe94: Stack[-18] = Stack[-2]
...
0xe9c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0xe9d: Pop(0)
...
0xea4: Stack[-3] = Stack[-6]
0xea5: Pop(3)
0xea6: Push("health") // @poff=704
0xea7: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0xea8: Pop(1)
0xea9: Push((int) 1)
0xeaa: Pop(1); Push(Stack[-1] - Stack[-4]);
0xeab: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0xeac: Push("health") // @poff=704
...
0xeb2: Pop(3)
0xeb3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0xeb4: Pop(2)
0xeb5: PushEmpty(bool, object)
0xeb6: Stack[-17] = Stack[-1]
0xeb7: Call2 0xe66
...
0xebd: Pop(1)
0xebe: Stack[-1] = Stack[-16]
0xebf: Return(); Pop(12)

0xec0: PushEmpty(bool, bool)
0xec1: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0xec2: Pop(0)
0xec3: Stack[-1] = Stack[-4]
0xec4: Return(); Pop(2)

0xec5: PushEmpty(object, object, object, object)
0xec6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0xeda: Pop(0)
0xedb: Pop(0); PushNull((bool) Stack[-2] == 0)
0xedc: IF (Stack[-1] == 0) GOTO 0xedf; Pop(1)

0xedd: Stack[-6] = (bool) 0
0xede: Return(); Pop(4)

0xedf: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0xee0: Pop(0)
...
0xef3: Stack[-6] = Stack[-2]
0xef4: Stack[-1] = "noaccess" // @poff=798
0xef5: Call2 0xe6b
...
0xefb: Push("noaccess") // @poff=798
0xefc: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0xefd: Pop(1)
0xefe: Push((int) 0)
...
0xf02: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0xf10: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0xf11: Pop(0)
...
0xf21: Stack[-1] = "fhit" // @poff=816
0xf22: GOTO 0xf24

0xf23: Stack[-1] = "bhit" // @poff=826
0xf24: Push("hit_react") // @poff=836
0xf25: Push("1") // @poff=856
0xf26: Pop(1); Push(Stack[-3] + Stack[-1]);
0xf27: Push("2") // @poff=860
...
0xf40: Stack[-25] = Stack[-1]
0xf41: Call2 0xe57

0xf42: Stack[-2] = Stack[-3]
0xf43: Pop(2)
0xf44: Call2 0x1083

0xf45: Stack[-2] = Stack[-11]
0xf46: Pop(2)
0xf47: @ CreateVectorVector(Stack[-8])
0xf48: Pop(0)
0xf49: Stack[-7] = (int) 1
0xf4a: Push("hit") // @poff=818
...
0xf5f: Pop(0)
0xf60: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0xf61: Pop(0)
0xf62: PushEmpty(object, int, float, cvector, cvector)
0xf63: Stack[-26] = Stack[-5]
0xf64: Stack[-25] = Stack[-4]
0xf65: Stack[-24] = Stack[-3]
0xf66: Stack[-6] = Stack[-2]
...
0xf80: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0xf81: Pop(0)
...
0xf90: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0xf91: Pop(0)
0xf92: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0xf93: Pop(0)
...
0xfe8: Stack[-4] = Stack[-2]
0xfe9: Stack[-1] = (int) 70
0xfea: Call2 0xfee

0xfeb: Stack[-3] = Stack[-5]
0xfec: Pop(3)
0xfed: Return(); Pop(0)
...
0xfef: @@ GetPosition(Stack[-7]); Obj=18 // @poff=166
0xff0: Pop(0)
0xff1: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=302
0xff2: Pop(0)
...
0x102e: Push("Can't find lsh animation : ") // @poff=923
...
0x103d: Push("Can't find lsh animation : ") // @poff=923
...
0x1086: Push((float)9.999999974752427e-07)
...
0x1090: Stack[-2] = Stack[-3]
0x1091: GOTO 0x1093

0x1092: Stack[-1] = Stack[-3]
0x1093: Return(); Pop(0)
...
0x10dc: Stack[-1] = "branch" // @poff=993
0x10dd: Call2 0x109f
...
0x10e8: Stack[-1] = "branch" // @poff=993
0x10e9: Call2 0x109f
...
0x117c: Push("branch") // @poff=993
0x117d: @ GetVariable(Stack[-1], Stack[-2])
0x117e: Pop(1)
0x117f: Stack[-1] = Stack[-3]
0x1180: Return(); Pop(2)
...
0x1191: Push("GenerateMoney: iMin > iMax") // @poff=1007
...
0x11a6: Stack[-1] = "Money" // @poff=1061
0x11a7: Call2 0x1285
...
0x11af: Pop(0)
0x11b0: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1073
0x11b1: Pop(0)
0x11b2: Push("Organ") // @poff=1085
0x11b3: Push((int) 1)
0x11b4: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0x11b5: Pop(2)
0x11b6: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1097
0x11b7: Pop(0)
0x11b8: Push((int) 0)
0x11b9: Push((int) 1)
...
0x11c6: Stack[-1] = "liver" // @poff=1107
0x11c7: Call2 0x11ad

0x11c8: Pop(1)
0x11c9: PushEmpty(string)
0x11ca: Stack[-1] = "kidney" // @poff=1119
0x11cb: Call2 0x11ad

0x11cc: Pop(1)
0x11cd: PushEmpty(string)
0x11ce: Stack[-1] = "heart" // @poff=1133
0x11cf: Call2 0x11ad

0x11d0: Pop(1)
0x11d1: PushEmpty(string)
0x11d2: Stack[-1] = "blood" // @poff=1145
0x11d3: Call2 0x11ad
...
0x11eb: Stack[-1] = "lemon" // @poff=1157
0x11ec: Call2 0x1285
...
0x120f: Stack[-1] = "syringe" // @poff=1189
0x1210: Call2 0x1285
...
0x121b: Stack[-1] = "watch" // @poff=1205
0x121c: Call2 0x1285
...
0x1227: Stack[-1] = "razor" // @poff=1217
0x1228: Call2 0x1285
...
0x1241: Stack[-1] = "beads" // @poff=1229
0x1242: Call2 0x1285
...
0x124d: Stack[-1] = "bracelet" // @poff=1241
0x124e: Call2 0x1285
...
0x1259: Stack[-1] = "ear_ring" // @poff=1259
0x125a: Call2 0x1285
...
0x1265: Stack[-1] = "gold_ring" // @poff=1277
0x1266: Call2 0x1285
...
0x1271: Stack[-1] = "silver_ring" // @poff=1297
0x1272: Call2 0x1285
...
0x127d: Stack[-1] = "flower" // @poff=1321
0x127e: Call2 0x1285
...
0x12a7: Stack[-7] = Stack[-3]
0x12a8: Stack[-6] = Stack[-2]
0x12a9: Stack[-5] = Stack[-1]
0x12aa: Call2 0xf2d
...
0x12af: Stack[-11] = Stack[-5]
0x12b0: Stack[-10] = Stack[-4]
0x12b1: Stack[-9] = Stack[-3]
0x12b2: Stack[-7] = Stack[-2]
0x12b3: Stack[-6] = Stack[-1]
0x12b4: Call2 0xf71
...
0x12ff: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1379
0x1300: Pop(0)
...
0x1373: Stack[-9] = Stack[-2]
0x1374: Stack[-1] = "class" // @poff=1421
0x1375: Call2 0xe6b
...
0x137b: Push("class") // @poff=1421
0x137c: @ GetProperty(Stack[-1], Stack[-3])
0x137d: Pop(1)
0x137e: Push("class") // @poff=1421
0x137f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=730
0x1380: Pop(1)
...
0x139d: Push("grabitel") // @poff=1465
...
0x13be: Stack[-4] = Stack[-1]
0x13bf: Call2 0x135f

0x13c0: Stack[-2] = Stack[-5]
0x13c1: Pop(2)
0x13c2: Return(); Pop(0)

0x13c3: PushEmpty()
0x13c4: PushEmpty(object)
0x13c5: Stack[-2] = Stack[-1]
0x13c6: Call2 0x1369
...
0x143b: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1557
0x143c: Return(); Pop(0)

0x143d: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1597
0x143e: Return(); Pop(0)
...
0x1479: Push("reputation") // @poff=1641
0x147a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x147b: Pop(1)
0x147c: Push((float)0.4000000059604645)
...
0x1488: Stack[-8] = Stack[-4]
0x1489: Stack[-7] = Stack[-3]
0x148a: Stack[-2] = (float) 700.0
0x148b: Stack[-6] = Stack[-1]
0x148c: Call2 0x13c9

0x148d: Stack[-5] = Stack[-9]
0x148e: Pop(5)
0x148f: Return(); Pop(0)

0x1490: PushEmpty()
0x1491: PushEmpty(bool, object)
0x1492: Stack[-3] = Stack[-1]
0x1493: Call2 0xe66
...
0x1498: Pop(0)
0x1499: Push((float)-0.03999999910593033)
0x149a: Push((bool) 1)
