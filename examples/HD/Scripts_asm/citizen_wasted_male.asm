...
// @pool_raw:
// @pool_encoding:utf8
...
0xd5: Stack[-1] = "Neutral" // @poff=89
0xd6: Call2 0xb0

0xd7: Pop(1)
0xd8: Push((int) 543337)
0xd9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xda: Pop(1)
0xdb: @@@ ClearReplies(); Obj=0 // @poff=116
0xdc: Pop(0)
...
0x15b: Stack[-5] = Stack[-1]
0x15c: Call2 0xe58

0x15d: Stack[-2] = Stack[-3]
0x15e: Pop(2)
0x15f: Push((int) 0)
...
0x16c: Pop(0); PushNull((bool) Stack[-21] == 0)
0x16d: IF (Stack[-1] == 0) GOTO 0x173; Pop(1)

0x16e: PushEmpty(string)
0x16f: Stack[-1] = "fdie" // @poff=156
0x170: Call2 0x1c6

0x171: Pop(1)
0x172: GOTO 0x1c5

0x173: @@ GetPosition(Stack[-10]); Obj=21 // @poff=166
0x174: Pop(0)
...
0x184: Stack[-6] = "fdie" // @poff=156
0x185: GOTO 0x187

0x186: Stack[-6] = "bdie" // @poff=178
...
0x18d: @ StopAsync()
0x18e: Pop(0)
0x18f: Stack[-21] = Stack[-5]
0x190: Push("GetScriptProperty") // @poff=188
0x191: Push((int) 2)
0x192: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x193: IF (Stack[-1] == 0) GOTO 0x19f; Pop(1)

0x194: Push("Owner") // @poff=224
0x195: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=236
0x196: Pop(1)
0x197: Push(Stack[-4])
0x198: IF (Stack[-1] == 0) GOTO 0x19f; Pop(1)

0x199: Push("Owner") // @poff=224
0x19a: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=254
0x19b: Pop(1)
0x19c: Pop(0); PushNull((bool) Stack[-5] == 0)
0x19d: IF (Stack[-1] == 0) GOTO 0x19f; Pop(1)

0x19e: Stack[-21] = Stack[-5]
0x19f: Push("@GetEyesHeight") // @poff=272
0x1a0: Push((int) 1)
0x1a1: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x1a2: IF (Stack[-1] == 0) GOTO 0x1ae; Pop(1)

0x1a3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0x1a4: Pop(0)
...
0x1ba: @ StopAsync()
0x1bb: Pop(0)
0x1bc: Push("head") // @poff=316
0x1bd: @ UnlookAsync(Stack[-1])
0x1be: Pop(1)
0x1bf: Push("all") // @poff=138
...
0x22c: Stack[-9] = Stack[-3]
0x22d: Stack[-8] = Stack[-2]
0x22e: Stack[-7] = Stack[-1]
0x22f: Call2 0xead
...
0x233: Stack[-8] = Stack[-2]
0x234: Stack[-6] = Stack[-1]
0x235: Call2 0xdfb

0x236: Stack[-3] = Stack[-4]
0x237: Pop(3)
0x238: Push((int) 0)
...
0x248: Stack[-5] = Stack[-1]
0x249: Call2 0xe25

0x24a: Stack[-2] = Stack[-3]
0x24b: Pop(2)
0x24c: Push((int) 0)
...
0x25c: Stack[-7] = Stack[-2]
0x25d: Stack[-6] = Stack[-1]
0x25e: Call2 0xcf5
...
0x26c: Stack[-7] = Stack[-1]
0x26d: Call2 0xe2a

0x26e: Stack[-3] = Stack[-4]
0x26f: Pop(3)
0x270: Push((int) 0)
...
0x36d: Stack[-4] = Stack[-1]
0x36e: Call2 0xd4b

0x36f: Pop(1)
0x370: PushEmpty(int, object)
0x371: Stack[-5] = Stack[-1]
0x372: Call2 0xd9e

0x373: Stack[-2] = Stack[-3]
0x374: Pop(2)
0x375: Push((int) 0)
...
0x385: Stack[-9] = Stack[-3]
0x386: Stack[-8] = Stack[-2]
0x387: Stack[-7] = Stack[-1]
0x388: Call2 0xead
...
0x38c: Stack[-8] = Stack[-2]
0x38d: Stack[-6] = Stack[-1]
0x38e: Call2 0xdfb

0x38f: Stack[-3] = Stack[-4]
0x390: Pop(3)
0x391: Push((int) 0)
...
0x3d3: Stack[-5] = Stack[-2]
0x3d4: Stack[-6] = Stack[-1]
0x3d5: Call2 0xe36
...
0x45e: Stack[-6] = Stack[-2]
0x45f: Stack[-5] = Stack[-1]
0x460: Call2 0xb3b
...
0x4b7: Stack[-9] = Stack[-3]
0x4b8: Stack[-8] = Stack[-2]
0x4b9: Stack[-7] = Stack[-1]
0x4ba: Call2 0xead
...
0x4be: Stack[-8] = Stack[-2]
0x4bf: Stack[-6] = Stack[-1]
0x4c0: Call2 0xdfb

0x4c1: Stack[-3] = Stack[-4]
0x4c2: Pop(3)
0x4c3: Push((int) 0)
...
0x4f6: Stack[-6] = Stack[-2]
0x4f7: Stack[-7] = Stack[-1]
0x4f8: Call2 0xe2a

0x4f9: Stack[-3] = Stack[-4]
0x4fa: Pop(3)
0x4fb: Push((int) 0)
...
0x540: Stack[-2] = Stack[-3]
0x541: Pop(2)
0x542: PushEmpty(float, cvector, cvector)
0x543: Stack[-5] = Stack[-2]
0x544: Stack[-4] = Stack[-1]
0x545: Call2 0xb3b

0x546: Pop(2)
0x547: Push((float)0.4999999701976776)
...
0x56c: PushEmpty()
0x56d: Stack[-3] = (float) 0.10000000149011612
0x56e: Return(); Pop(0)
...
0x587: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x588: Pop(0)
0x589: Push(Stack[-8])
0x58a: IF (Stack[-1] == 0) GOTO 0x593; Pop(1)

0x58b: Push("attack") // @poff=382
...
0x5a7: Pop(0)
0x5a8: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x5a9: Pop(0)
...
0x5c3: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0x5c4: Pop(0)
...
0x5dd: Pop(1)
0x5de: Push("all") // @poff=138
0x5df: Push("attack_on") // @poff=410
...
0x5f7: IF (Stack[-1] == 1) GOTO 0x5fd; Pop(1)

0x5f8: PushEmpty(bool)
0x5f9: Call2 0x7c9

0x5fa: Pop(0)
0x5fb: IF (Stack[-1] == 1) GOTO 0x5fd; Pop(1)

0x5fc: Stack[-1] = (bool) 0
0x5fd: IF (Stack[-1] == 0) GOTO 0x60e; Pop(1)

0x5fe: @ Face(Stack[-0]T)
0x5ff: Pop(0)
0x600: PushEmpty()
0x601: Call2 0x7fb
...
0x60e: @ Face(Stack[-0]T)
0x60f: Pop(0)
0x610: Push("all") // @poff=138
0x611: Push("fjump") // @poff=454
...
0x62c: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x62d: Pop(0)
...
0x64b: Push("all") // @poff=138
0x64c: Push("attack_off") // @poff=466
...
0x65a: Push("attack_begin") // @poff=488
0x65b: Push((int) 1)
0x65c: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x667: Push("attack") // @poff=382
0x668: Push((int) 1)
0x669: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x673: Push("all") // @poff=138
0x674: Push("bjump") // @poff=514
...
0x67b: Push((float)0.8999999761581421)
0x67c: Pop(1); Push(Stack[-9] * Stack[-1]);
0x67d: @ GetVictim(Stack[-1], Stack[-4])
0x67e: Pop(1)
0x67f: @ ReportAttack(Stack[-0]T)
0x680: Pop(0)
...
0x684: Stack[-6] = Stack[-2]
0x685: Stack[-10] = Stack[-1]
0x686: Call2 0x56c

0x687: Stack[-3] = Stack[-5]
0x688: Pop(3)
0x689: PushEmpty(float, object, float, int)
0x68a: Stack[-7] = Stack[-3]
0x68b: Stack[-6] = Stack[-2]
0x68c: PushEmpty(int, object, int)
0x68d: Stack[-10] = Stack[-2]
0x68e: Stack[-14] = Stack[-1]
0x68f: Call2 0x56f

0x690: Stack[-3] = Stack[-4]
0x691: Pop(3)
0x692: Call2 0x93d

0x693: Stack[-4] = Stack[-5]
0x694: Pop(4)
0x695: PushEmpty(int)
0x696: Call2 0x7f9

0x697: Pop(0)
0x698: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x699: Pop(1)
0x69a: PushEmpty(object, float)
0x69b: Stack[-5] = Stack[-2]
...
0x6a4: Pop(0)
0x6a5: @ irand(Stack[-4], Stack[-1]T)
0x6a6: Pop(0)
0x6a7: Push((int) 1)
0x6a8: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x6a9: @ Face(Stack[-0]T)
0x6aa: Pop(0)
0x6ab: Push((bool) 1)
...
0x6b0: Pop(0)
0x6b1: Push("all") // @poff=138
0x6b2: Push("attack_begin") // @poff=488
...
0x6c6: Stack[-11] = Stack[-2]
0x6c7: Stack[-6] = Stack[-1]
0x6c8: Call2 0x67a

0x6c9: Pop(2)
0x6ca: Push("all") // @poff=138
0x6cb: Push("attack_middle") // @poff=526
...
0x6d3: Pop(0)
0x6d4: Push("all") // @poff=138
0x6d5: Push("attack_middle") // @poff=526
...
0x6ec: Pop(2)
0x6ed: Stack[-2] = (int) 1
0x6ee: Push("attack_middle") // @poff=526
0x6ef: Pop(1); Push(Stack[-1] + Stack[-5]);
0x6f0: Push("_") // @poff=554
...
0x70f: Stack[-11] = Stack[-2]
0x710: Stack[-6] = Stack[-1]
0x711: Call2 0x67a
...
0x718: Pop(1)
0x719: Push("all") // @poff=138
0x71a: Push("attack_end") // @poff=558
...
0x759: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0x75a: Pop(0)
...
0x7a5: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x7a6: Pop(1)
...
0x7aa: @ Face(Stack[-0]T)
0x7ab: Pop(0)
0x7ac: Push("all") // @poff=138
0x7ad: Push("bjump") // @poff=514
0x7ae: @ PlayAnimation(Stack[-2], Stack[-1])
0x7af: Pop(2)
0x7b0: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0x7b1: Pop(0)
...
0x7e7: @ irand(Stack[-1], Stack[-2]T)
0x7e8: Pop(0)
0x7e9: Push((int) 1)
0x7ea: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x7eb: Push("attack") // @poff=382
...
0x7fc: Stack[-1] = "attack_stay" // @poff=430
0x7fd: Call2 0xadd
...
0x82e: Stack[-15] = Stack[-5]
0x82f: Stack[-14] = Stack[-4]
0x830: Stack[-13] = Stack[-3]
0x831: Stack[-12] = Stack[-2]
0x832: Stack[-11] = Stack[-1]
0x833: Call2 0x878

0x834: Stack[-6] = Stack[-7]
0x835: Pop(6)
0x836: Push( Stack[2 + Tasks[-1].StackPointer] )
0x837: IF (Stack[-1] == 0) GOTO 0x83b; Pop(1)

0x838: Push("head") // @poff=316
0x839: @ UnlookAsync(Stack[-1])
0x83a: Pop(1)
0x83b: Push((int) 1)
0x83c: @ KillTimer(Stack[-1])
0x83d: Pop(1)
0x83e: Stack[-1] = Stack[-10]
0x83f: Return(); Pop(4)
...
0x87b: Stack[-17] = Stack[-7]
0x87c: PushEmpty(bool, object)
0x87d: Stack[-23] = Stack[-1]
0x87e: Call2 0x904
...
0x884: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x885: Pop(0)
...
0x89b: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0x89c: Pop(0)
...
0x8ad: Push((int) 0)
0x8ae: Push((float)0.30000001192092896)
...
0x8d0: Push((int) 0)
0x8d1: Push((float)0.30000001192092896)
...
0x908: Stack[-2] = Stack[-4]
0x909: Pop(2)
0x90a: Return(); Pop(0)

0x90b: Stack[-1] = "walk" // @poff=616
0x90c: Return(); Pop(0)

0x90d: Stack[-1] = "run" // @poff=626
0x90e: Return(); Pop(0)
...
0x919: Stack[-2] = "bullet" // @poff=644
0x91a: Return(); Pop(0)

0x91b: Stack[-2] = "phys" // @poff=658
0x91c: Return(); Pop(0)

0x91d: PushEmpty(cvector, cvector, cvector, cvector)
0x91e: @ GetPosition(Stack[-2])
0x91f: Pop(0)
0x920: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x921: Pop(0)
...
0x926: Pop(0)
0x927: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0x928: Pop(0)
...
0x932: Push("HasProperty") // @poff=668
0x933: Push((int) 2)
...
0x939: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x93a: Pop(0)
0x93b: Stack[-1] = Stack[-5]
0x93c: Return(); Pop(2)

0x93d: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x93e: PushEmpty(bool, object, string)
0x93f: Stack[-18] = Stack[-2]
0x940: Stack[-1] = "health" // @poff=704
0x941: Call2 0x931
...
0x948: Stack[-18] = Stack[-2]
0x949: Stack[-1] = "armor" // @poff=718
0x94a: Call2 0x931
...
0x950: Push("armor") // @poff=718
0x951: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x952: Pop(1)
0x953: Push("armor_") // @poff=742
0x954: PushEmpty(string, int)
0x955: Stack[-16] = Stack[-1]
0x956: Call2 0x90f

0x957: Pop(1)
0x958: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x959: PushEmpty(bool, object, string)
0x95a: Stack[-18] = Stack[-2]
0x95b: Stack[-8] = Stack[-1]
0x95c: Call2 0x931
...
0x962: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x963: Pop(0)
...
0x96a: Stack[-3] = Stack[-6]
0x96b: Pop(3)
0x96c: Push("health") // @poff=704
0x96d: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x96e: Pop(1)
0x96f: Push((int) 1)
0x970: Pop(1); Push(Stack[-1] - Stack[-4]);
0x971: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x972: Push("health") // @poff=704
...
0x978: Pop(3)
0x979: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0x97a: Pop(2)
0x97b: PushEmpty(bool, object)
0x97c: Stack[-17] = Stack[-1]
0x97d: Call2 0x92c
...
0x983: Pop(1)
0x984: Stack[-1] = Stack[-16]
0x985: Return(); Pop(12)

0x986: PushEmpty(bool, bool)
0x987: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0x988: Pop(0)
0x989: Stack[-1] = Stack[-4]
0x98a: Return(); Pop(2)

0x98b: PushEmpty(object, object, object, object)
0x98c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x9a0: Pop(0)
0x9a1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x9a2: IF (Stack[-1] == 0) GOTO 0x9a5; Pop(1)

0x9a3: Stack[-6] = (bool) 0
0x9a4: Return(); Pop(4)

0x9a5: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0x9a6: Pop(0)
...
0x9b9: Stack[-6] = Stack[-2]
0x9ba: Stack[-1] = "noaccess" // @poff=798
0x9bb: Call2 0x931
...
0x9c1: Push("noaccess") // @poff=798
0x9c2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x9c3: Pop(1)
0x9c4: Push((int) 0)
...
0x9c8: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x9d6: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0x9d7: Pop(0)
...
0x9e7: Stack[-1] = "fhit" // @poff=816
0x9e8: GOTO 0x9ea

0x9e9: Stack[-1] = "bhit" // @poff=826
0x9ea: Push("hit_react") // @poff=836
0x9eb: Push("1") // @poff=856
0x9ec: Pop(1); Push(Stack[-3] + Stack[-1]);
0x9ed: Push("2") // @poff=860
...
0xa0b: Stack[-2] = Stack[-11]
0xa0c: Pop(2)
0xa0d: @ CreateVectorVector(Stack[-8])
0xa0e: Pop(0)
0xa0f: Stack[-7] = (int) 1
0xa10: Push("hit") // @poff=818
...
0xa25: Pop(0)
0xa26: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0xa27: Pop(0)
0xa28: PushEmpty(object, int, float, cvector, cvector)
0xa29: Stack[-26] = Stack[-5]
0xa2a: Stack[-25] = Stack[-4]
0xa2b: Stack[-24] = Stack[-3]
0xa2c: Stack[-6] = Stack[-2]
...
0xa46: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0xa47: Pop(0)
...
0xa56: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0xa57: Pop(0)
0xa58: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0xa59: Pop(0)
...
0xab7: Push("Can't find lsh animation : ") // @poff=923
...
0xac6: Push("Can't find lsh animation : ") // @poff=923
...
0xb0f: Push((float)9.999999974752427e-07)
...
0xb3d: Stack[-5] = Stack[-2]
0xb3e: Stack[-4] = Stack[-1]
0xb3f: Call2 0xb28

0xb40: Pop(2)
0xb41: PushEmpty(float, cvector)
0xb42: Stack[-5] = Stack[-1]
0xb43: Call2 0xb31

0xb44: Pop(1)
0xb45: PushEmpty(float, cvector)
0xb46: Stack[-5] = Stack[-1]
0xb47: Call2 0xb31
...
0xbcf: Push("GenerateMoney: iMin > iMax") // @poff=1007
0xbd0: @ Trace(Stack[-1])
0xbd1: Pop(1)
0xbd2: Return(); Pop(4)
...
0xbed: Pop(0)
0xbee: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1073
0xbef: Pop(0)
0xbf0: Push("Organ") // @poff=1085
0xbf1: Push((int) 1)
0xbf2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0xbf3: Pop(2)
0xbf4: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1097
0xbf5: Pop(0)
0xbf6: Push((int) 0)
0xbf7: Push((int) 1)
...
0xc04: Stack[-1] = "liver" // @poff=1107
0xc05: Call2 0xbeb

0xc06: Pop(1)
0xc07: PushEmpty(string)
0xc08: Stack[-1] = "kidney" // @poff=1119
0xc09: Call2 0xbeb

0xc0a: Pop(1)
0xc0b: PushEmpty(string)
0xc0c: Stack[-1] = "heart" // @poff=1133
0xc0d: Call2 0xbeb

0xc0e: Pop(1)
0xc0f: PushEmpty(string)
0xc10: Stack[-1] = "blood" // @poff=1145
0xc11: Call2 0xbeb
...
0xc4d: Stack[-1] = "syringe" // @poff=1189
0xc4e: Call2 0xcc3
...
0xc8b: Stack[-1] = "bracelet" // @poff=1241
0xc8c: Call2 0xcc3
...
0xc97: Stack[-1] = "ear_ring" // @poff=1259
0xc98: Call2 0xcc3
...
0xca3: Stack[-1] = "gold_ring" // @poff=1277
0xca4: Call2 0xcc3
...
0xcaf: Stack[-1] = "silver_ring" // @poff=1297
0xcb0: Call2 0xcc3
...
0xcbb: Stack[-1] = "flower" // @poff=1321
0xcbc: Call2 0xcc3
...
0xce5: Stack[-7] = Stack[-3]
0xce6: Stack[-6] = Stack[-2]
0xce7: Stack[-5] = Stack[-1]
0xce8: Call2 0x9f3
...
0xced: Stack[-11] = Stack[-5]
0xcee: Stack[-10] = Stack[-4]
0xcef: Stack[-9] = Stack[-3]
0xcf0: Stack[-7] = Stack[-2]
0xcf1: Stack[-6] = Stack[-1]
0xcf2: Call2 0xa37
...
0xd15: PushEmpty()
0xd16: Push("unholster") // @poff=1335
...
0xd3d: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1379
0xd3e: Pop(0)
...
0xdb2: Stack[-9] = Stack[-2]
0xdb3: Stack[-1] = "class" // @poff=1421
0xdb4: Call2 0x931
...
0xdba: Push("class") // @poff=1421
0xdbb: @ GetProperty(Stack[-1], Stack[-3])
0xdbc: Pop(1)
0xdbd: Push("class") // @poff=1421
0xdbe: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=730
0xdbf: Pop(1)
...
0xdfd: Stack[-4] = Stack[-1]
0xdfe: Call2 0xd9e

0xdff: Stack[-2] = Stack[-5]
0xe00: Pop(2)
0xe01: Return(); Pop(0)

0xe02: PushEmpty()
0xe03: PushEmpty(object)
0xe04: Stack[-2] = Stack[-1]
0xe05: Call2 0xda8
...
0xe6b: Push(Stack[-1])
0xe6c: IF (Stack[-1] == 1) GOTO 0xe75; Pop(1)
...
0xe73: IF (Stack[-1] == 1) GOTO 0xe75; Pop(1)
...
0xe8a: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1557
0xe8b: Return(); Pop(0)

0xe8c: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1597
0xe8d: Return(); Pop(0)
...
0xeaf: Stack[-8] = Stack[-4]
0xeb0: Stack[-7] = Stack[-3]
0xeb1: Stack[-2] = (float) 700.0
0xeb2: Stack[-6] = Stack[-1]
0xeb3: Call2 0xe08

0xeb4: Stack[-5] = Stack[-9]
0xeb5: Pop(5)
0xeb6: Return(); Pop(0)

0xeb7: PushEmpty()
0xeb8: PushEmpty(bool, object)
0xeb9: Stack[-3] = Stack[-1]
0xeba: Call2 0x92c
...
0xebf: Pop(0)
0xec0: Push((float)-0.07000000029802322)
0xec1: Push((bool) 1)
