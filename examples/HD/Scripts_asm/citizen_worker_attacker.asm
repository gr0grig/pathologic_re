...
Strings:
	...
	W:reputation
// @pool_raw:
// @pool_encoding:utf8
...
0xd82: PushEmpty()
0xd83: Stack[-3] = (float) 0.05000000074505806
0xd84: Return(); Pop(0)
...
0xd9d: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xd9e: Pop(0)
0xd9f: Push(Stack[-8])
0xda0: IF (Stack[-1] == 0) GOTO 0xda9; Pop(1)

0xda1: Push("attack") // @poff=382
...
0xdbd: Pop(0)
0xdbe: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0xdbf: Pop(0)
...
0xdd9: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0xdda: Pop(0)
...
0xdf3: Pop(1)
0xdf4: Push("all") // @poff=138
0xdf5: Push("attack_on") // @poff=410
...
0xe0d: IF (Stack[-1] == 1) GOTO 0xe13; Pop(1)

0xe0e: PushEmpty(bool)
0xe0f: Call2 0xfdf

0xe10: Pop(0)
0xe11: IF (Stack[-1] == 1) GOTO 0xe13; Pop(1)

0xe12: Stack[-1] = (bool) 0
0xe13: IF (Stack[-1] == 0) GOTO 0xe24; Pop(1)

0xe14: @ Face(Stack[-0]T)
0xe15: Pop(0)
0xe16: PushEmpty()
0xe17: Call2 0x1011

0xe18: Pop(0)
0xe19: Push("all") // @poff=138
0xe1a: Push("attack_stay") // @poff=430
0xe1b: @ PlayAnimation(Stack[-2], Stack[-1])
0xe1c: Pop(2)
0xe1d: PushEmpty(bool, float)
0xe1e: Stack[-25] = Stack[-1]
0xe1f: Call2 0xf5b
...
0xe25: Pop(0)
0xe26: Push("all") // @poff=138
0xe27: Push("fjump") // @poff=454
...
0xe42: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0xe43: Pop(0)
...
0xe61: Push("all") // @poff=138
0xe62: Push("attack_off") // @poff=466
...
0xe6f: Push("all") // @poff=138
0xe70: Push("attack_begin") // @poff=488
0xe71: Push((int) 1)
0xe72: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xe7d: Push("attack") // @poff=382
0xe7e: Push((int) 1)
0xe7f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xe89: Push("all") // @poff=138
0xe8a: Push("bjump") // @poff=514
...
0xe91: Push((float)0.8999999761581421)
0xe92: Pop(1); Push(Stack[-9] * Stack[-1]);
0xe93: @ GetVictim(Stack[-1], Stack[-4])
0xe94: Pop(1)
0xe95: @ ReportAttack(Stack[-0]T)
0xe96: Pop(0)
...
0xe9a: Stack[-6] = Stack[-2]
0xe9b: Stack[-10] = Stack[-1]
0xe9c: Call2 0xd82

0xe9d: Stack[-3] = Stack[-5]
0xe9e: Pop(3)
0xe9f: PushEmpty(float, object, float, int)
0xea0: Stack[-7] = Stack[-3]
0xea1: Stack[-6] = Stack[-2]
0xea2: PushEmpty(int, object, int)
0xea3: Stack[-10] = Stack[-2]
0xea4: Stack[-14] = Stack[-1]
0xea5: Call2 0xd85

0xea6: Stack[-3] = Stack[-4]
0xea7: Pop(3)
0xea8: Call2 0x1153

0xea9: Stack[-4] = Stack[-5]
0xeaa: Pop(4)
0xeab: PushEmpty(int)
0xeac: Call2 0x100f

0xead: Pop(0)
0xeae: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0xeaf: Pop(1)
0xeb0: PushEmpty(object, float)
0xeb1: Stack[-5] = Stack[-2]
0xeb2: Stack[-3] = Stack[-1]
0xeb3: Call2 0x1016
...
0xeba: Pop(0)
0xebb: @ irand(Stack[-4], Stack[-1]T)
0xebc: Pop(0)
0xebd: Push((int) 1)
0xebe: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0xebf: @ Face(Stack[-0]T)
0xec0: Pop(0)
0xec1: Push((bool) 1)
...
0xec8: Push("attack_begin") // @poff=488
...
0xedc: Stack[-11] = Stack[-2]
0xedd: Stack[-6] = Stack[-1]
0xede: Call2 0xe90

0xedf: Pop(2)
0xee0: Push("all") // @poff=138
0xee1: Push("attack_middle") // @poff=526
...
0xee9: Pop(0)
0xeea: Push("all") // @poff=138
0xeeb: Push("attack_middle") // @poff=526
...
0xeff: Stack[-11] = Stack[-2]
0xf00: Stack[-6] = Stack[-1]
0xf01: Call2 0xe90

0xf02: Pop(2)
0xf03: Stack[-2] = (int) 1
0xf04: Push("attack_middle") // @poff=526
0xf05: Pop(1); Push(Stack[-1] + Stack[-5]);
0xf06: Push("_") // @poff=554
0xf07: Pop(2); Push(Stack[-2] + Stack[-1]);
0xf08: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0xf09: Push("all") // @poff=138
...
0xf25: Stack[-11] = Stack[-2]
0xf26: Stack[-6] = Stack[-1]
0xf27: Call2 0xe90
...
0xf2e: Pop(1)
0xf2f: Push("all") // @poff=138
0xf30: Push("attack_end") // @poff=558
...
0xf6f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0xf70: Pop(0)
...
0xfbb: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0xfbc: Pop(1)
...
0xfc0: @ Face(Stack[-0]T)
0xfc1: Pop(0)
0xfc2: Push("all") // @poff=138
0xfc3: Push("bjump") // @poff=514
0xfc4: @ PlayAnimation(Stack[-2], Stack[-1])
0xfc5: Pop(2)
0xfc6: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0xfc7: Pop(0)
...
0xffd: @ irand(Stack[-1], Stack[-2]T)
0xffe: Pop(0)
0xfff: Push((int) 1)
0x1000: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x1001: Push("attack") // @poff=382
...
0x1012: Stack[-1] = "attack_stay" // @poff=430
0x1013: Call2 0x12f3
...
0x1044: Stack[-15] = Stack[-5]
0x1045: Stack[-14] = Stack[-4]
0x1046: Stack[-13] = Stack[-3]
0x1047: Stack[-12] = Stack[-2]
0x1048: Stack[-11] = Stack[-1]
0x1049: Call2 0x108e

0x104a: Stack[-6] = Stack[-7]
0x104b: Pop(6)
0x104c: Push( Stack[2 + Tasks[-1].StackPointer] )
0x104d: IF (Stack[-1] == 0) GOTO 0x1051; Pop(1)

0x104e: Push("head") // @poff=316
0x104f: @ UnlookAsync(Stack[-1])
0x1050: Pop(1)
0x1051: Push((int) 1)
0x1052: @ KillTimer(Stack[-1])
0x1053: Pop(1)
0x1054: Stack[-1] = Stack[-10]
0x1055: Return(); Pop(4)
...
0x1091: Stack[-17] = Stack[-7]
0x1092: PushEmpty(bool, object)
0x1093: Stack[-23] = Stack[-1]
0x1094: Call2 0x111a
...
0x109a: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x109b: Pop(0)
...
0x10b1: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0x10b2: Pop(0)
...
0x10c3: Push((int) 0)
0x10c4: Push((float)0.30000001192092896)
...
0x10e6: Push((int) 0)
0x10e7: Push((float)0.30000001192092896)
...
0x111c: Stack[-3] = Stack[-1]
0x111d: Call2 0x11c5

0x111e: Stack[-2] = Stack[-4]
0x111f: Pop(2)
0x1120: Return(); Pop(0)

0x1121: Stack[-1] = "walk" // @poff=616
0x1122: Return(); Pop(0)

0x1123: Stack[-1] = "run" // @poff=626
0x1124: Return(); Pop(0)
...
0x112f: Stack[-2] = "bullet" // @poff=644
0x1130: Return(); Pop(0)

0x1131: Stack[-2] = "phys" // @poff=658
0x1132: Return(); Pop(0)

0x1133: PushEmpty(cvector, cvector, cvector, cvector)
0x1134: @ GetPosition(Stack[-2])
0x1135: Pop(0)
0x1136: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x1137: Pop(0)
...
0x113c: Pop(0)
0x113d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0x113e: Pop(0)
...
0x1148: Push("HasProperty") // @poff=668
0x1149: Push((int) 2)
...
0x114f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x1150: Pop(0)
0x1151: Stack[-1] = Stack[-5]
0x1152: Return(); Pop(2)

0x1153: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x1154: PushEmpty(bool, object, string)
0x1155: Stack[-18] = Stack[-2]
0x1156: Stack[-1] = "health" // @poff=704
0x1157: Call2 0x1147
...
0x115e: Stack[-18] = Stack[-2]
0x115f: Stack[-1] = "armor" // @poff=718
0x1160: Call2 0x1147
...
0x1166: Push("armor") // @poff=718
0x1167: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x1168: Pop(1)
0x1169: Push("armor_") // @poff=742
0x116a: PushEmpty(string, int)
0x116b: Stack[-16] = Stack[-1]
0x116c: Call2 0x1125

0x116d: Pop(1)
0x116e: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x116f: PushEmpty(bool, object, string)
0x1170: Stack[-18] = Stack[-2]
0x1171: Stack[-8] = Stack[-1]
0x1172: Call2 0x1147
...
0x1178: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x1179: Pop(0)
...
0x1180: Stack[-3] = Stack[-6]
0x1181: Pop(3)
0x1182: Push("health") // @poff=704
0x1183: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x1184: Pop(1)
0x1185: Push((int) 1)
0x1186: Pop(1); Push(Stack[-1] - Stack[-4]);
0x1187: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x1188: Push("health") // @poff=704
...
0x118e: Pop(3)
0x118f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0x1190: Pop(2)
0x1191: PushEmpty(bool, object)
0x1192: Stack[-17] = Stack[-1]
0x1193: Call2 0x1142
...
0x1199: Pop(1)
0x119a: Stack[-1] = Stack[-16]
0x119b: Return(); Pop(12)

0x119c: PushEmpty(bool, bool)
0x119d: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0x119e: Pop(0)
0x119f: Stack[-1] = Stack[-4]
0x11a0: Return(); Pop(2)

0x11a1: PushEmpty(object, object, object, object)
0x11a2: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x11b6: Pop(0)
0x11b7: Pop(0); PushNull((bool) Stack[-2] == 0)
0x11b8: IF (Stack[-1] == 0) GOTO 0x11bb; Pop(1)

0x11b9: Stack[-6] = (bool) 0
0x11ba: Return(); Pop(4)

0x11bb: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0x11bc: Pop(0)
...
0x11cf: Stack[-6] = Stack[-2]
0x11d0: Stack[-1] = "noaccess" // @poff=798
0x11d1: Call2 0x1147
...
0x11d7: Push("noaccess") // @poff=798
0x11d8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x11d9: Pop(1)
0x11da: Push((int) 0)
...
0x11de: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x11ec: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0x11ed: Pop(0)
...
0x11fd: Stack[-1] = "fhit" // @poff=816
0x11fe: GOTO 0x1200

0x11ff: Stack[-1] = "bhit" // @poff=826
0x1200: Push("hit_react") // @poff=836
0x1201: Push("1") // @poff=856
0x1202: Pop(1); Push(Stack[-3] + Stack[-1]);
0x1203: Push("2") // @poff=860
...
0x121c: Stack[-25] = Stack[-1]
0x121d: Call2 0x1133

0x121e: Stack[-2] = Stack[-3]
0x121f: Pop(2)
0x1220: Call2 0x1322

0x1221: Stack[-2] = Stack[-11]
0x1222: Pop(2)
0x1223: @ CreateVectorVector(Stack[-8])
0x1224: Pop(0)
0x1225: Stack[-7] = (int) 1
0x1226: Push("hit") // @poff=818
...
0x123b: Pop(0)
0x123c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0x123d: Pop(0)
0x123e: PushEmpty(object, int, float, cvector, cvector)
0x123f: Stack[-26] = Stack[-5]
0x1240: Stack[-25] = Stack[-4]
0x1241: Stack[-24] = Stack[-3]
0x1242: Stack[-6] = Stack[-2]
...
0x124f: Pop(0)
0x1250: Push("scripted") // @poff=877
0x1251: Push("blood_dir.xml") // @poff=895
...
0x125c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0x125d: Pop(0)
...
0x126c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0x126d: Pop(0)
0x126e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0x126f: Pop(0)
...
0x12cd: Push("Can't find lsh animation : ") // @poff=923
...
0x12dc: Push("Can't find lsh animation : ") // @poff=923
...
0x12e2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0x12e3: Pop(0)
...
0x1325: Push((float)9.999999974752427e-07)
...
0x132f: Stack[-2] = Stack[-3]
0x1330: GOTO 0x1332

0x1331: Stack[-1] = Stack[-3]
0x1332: Return(); Pop(0)
...
0x1377: PushEmpty()
0x1378: Push((int) 100)
0x1379: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=993
0x137a: Pop(1)
0x137b: Return(); Pop(0)

0x137c: PushEmpty()
0x137d: PushEmpty(int, string)
0x137e: Stack[-1] = "branch" // @poff=1008
0x137f: Call2 0x1344
...
0x138a: Stack[-1] = "branch" // @poff=1008
0x138b: Call2 0x1344
...
0x1396: Stack[-1] = "branch" // @poff=1008
0x1397: Call2 0x1344
...
0x148b: Push("branch") // @poff=1008
0x148c: @ GetVariable(Stack[-1], Stack[-2])
0x148d: Pop(1)
0x148e: Stack[-1] = Stack[-3]
0x148f: Return(); Pop(2)

0x1490: PushEmpty(int, int)
0x1491: @@ GetItemID(Stack[-1]); Obj=3 // @poff=1022
0x1492: Pop(0)
0x1493: Stack[-1] = Stack[-4]
0x1494: Return(); Pop(2)
...
0x14a1: Stack[-4] = "Price" // @poff=1032
0x14a2: Push((int) 1)
...
0x14b8: Stack[-6] = Stack[-17]
0x14b9: Return(); Pop(14)

0x14ba: PushEmpty(int, object)
0x14bb: Stack[-18] = Stack[-1]
0x14bc: Call2 0x1490

0x14bd: Pop(1)
0x14be: Push("BarterPrice") // @poff=1044
...
0x14c7: Stack[-18] = Stack[-1]
0x14c8: Call2 0x1490

0x14c9: Pop(1)
0x14ca: Push("BarterPrice") // @poff=1044
...
0x14e5: Push("GenerateMoney: iMin > iMax") // @poff=1068
...
0x14fa: Stack[-1] = "Money" // @poff=1122
0x14fb: Call2 0x15d9
...
0x1503: Pop(0)
0x1504: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1134
0x1505: Pop(0)
0x1506: Push("Organ") // @poff=1146
0x1507: Push((int) 1)
0x1508: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0x1509: Pop(2)
0x150a: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1022
0x150b: Pop(0)
0x150c: Push((int) 0)
0x150d: Push((int) 1)
...
0x151a: Stack[-1] = "liver" // @poff=1158
0x151b: Call2 0x1501

0x151c: Pop(1)
0x151d: PushEmpty(string)
0x151e: Stack[-1] = "kidney" // @poff=1170
0x151f: Call2 0x1501

0x1520: Pop(1)
0x1521: PushEmpty(string)
0x1522: Stack[-1] = "heart" // @poff=1184
0x1523: Call2 0x1501

0x1524: Pop(1)
0x1525: PushEmpty(string)
0x1526: Stack[-1] = "blood" // @poff=1196
0x1527: Call2 0x1501
...
0x153f: Stack[-1] = "lemon" // @poff=1208
0x1540: Call2 0x15d9
...
0x1563: Stack[-1] = "syringe" // @poff=1240
0x1564: Call2 0x15d9
...
0x156f: Stack[-1] = "watch" // @poff=1256
0x1570: Call2 0x15d9
...
0x157b: Stack[-1] = "razor" // @poff=1268
0x157c: Call2 0x15d9
...
0x1595: Stack[-1] = "beads" // @poff=1280
0x1596: Call2 0x15d9
...
0x15a1: Stack[-1] = "bracelet" // @poff=1292
0x15a2: Call2 0x15d9
...
0x15ad: Stack[-1] = "ear_ring" // @poff=1310
0x15ae: Call2 0x15d9
...
0x15b9: Stack[-1] = "gold_ring" // @poff=1328
0x15ba: Call2 0x15d9
...
0x15c5: Stack[-1] = "silver_ring" // @poff=1348
0x15c6: Call2 0x15d9
...
0x15d1: Stack[-1] = "flower" // @poff=1372
0x15d2: Call2 0x15d9
...
0x15db: Pop(0)
0x15dc: Stack[-1] = Stack[-4]
0x15dd: Return(); Pop(2)

0x15de: PushEmpty()
0x15df: PushEmpty(object)
0x15e0: Stack[-2] = Stack[-1]
...
0x15fb: Stack[-7] = Stack[-3]
0x15fc: Stack[-6] = Stack[-2]
0x15fd: Stack[-5] = Stack[-1]
0x15fe: Call2 0x1209
...
0x1603: Stack[-11] = Stack[-5]
0x1604: Stack[-10] = Stack[-4]
0x1605: Stack[-9] = Stack[-3]
0x1606: Stack[-7] = Stack[-2]
0x1607: Stack[-6] = Stack[-1]
0x1608: Call2 0x124d
...
0x1653: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1430
0x1654: Pop(0)
...
0x16c7: Stack[-9] = Stack[-2]
0x16c8: Stack[-1] = "class" // @poff=1472
0x16c9: Call2 0x1147
...
0x16cf: Push("class") // @poff=1472
0x16d0: @ GetProperty(Stack[-1], Stack[-3])
0x16d1: Pop(1)
0x16d2: Push("class") // @poff=1472
0x16d3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=730
0x16d4: Pop(1)
...
0x16f1: Push("grabitel") // @poff=1516
...
0x1714: Stack[-2] = Stack[-5]
0x1715: Pop(2)
0x1716: Return(); Pop(0)

0x1717: PushEmpty()
0x1718: PushEmpty(object)
0x1719: Stack[-2] = Stack[-1]
0x171a: Call2 0x16bd
...
0x1795: Pop(0)
0x1796: @@ GetSubContainerCount(Stack[-22]); Obj=53 // @poff=1608
0x1797: Pop(0)
0x1798: Stack[-21] = (int) 0
0x1799: Pop(0); Push((bool) Stack[-21] < Stack[-22])
0x179a: IF (Stack[-1] == 0) GOTO 0x17e1; Pop(1)

0x179b: @@ GetItemCount(Stack[-20], Stack[-21]); Obj=53 // @poff=1629
0x179c: Pop(0)
0x179d: Stack[-19] = (int) 0
0x179e: Pop(0); Push((bool) Stack[-19] < Stack[-20])
0x179f: IF (Stack[-1] == 0) GOTO 0x17de; Pop(1)

0x17a0: @@ GetItem(Stack[-18], Stack[-19], Stack[-21]); Obj=53 // @poff=1642
0x17a1: Pop(0)
0x17a2: @@ GetItemID(Stack[-17]); Obj=18 // @poff=1022
0x17a3: Pop(0)
0x17a4: Push("HasDurability") // @poff=1650
0x17a5: @ HasInvItemProperty(Stack[-17], Stack[-18], Stack[-1])
0x17a6: Pop(1)
0x17a7: Push(Stack[-16])
0x17a8: IF (Stack[-1] == 0) GOTO 0x17da; Pop(1)

0x17a9: Push("durability") // @poff=1678
0x17aa: @@ HasProperty(Stack[-17], Stack[-1]); Obj=19 // @poff=692
0x17ab: Pop(1)
0x17ac: Push(Stack[-16])
0x17ad: IF (Stack[-1] == 0) GOTO 0x17da; Pop(1)

0x17ae: Push("durability") // @poff=1678
0x17af: @@ GetProperty(Stack[-16], Stack[-1]); Obj=19 // @poff=730
0x17b0: Pop(1)
...
0x17bd: @@ add(Stack[-18]); Obj=26 // @poff=864
0x17be: Pop(0)
0x17bf: @@ add(Stack[-21]); Obj=25 // @poff=864
0x17c0: Pop(0)
0x17c1: @@ add(Stack[-19]); Obj=24 // @poff=864
0x17c2: Pop(0)
0x17c3: PushEmpty(int, object, int)
0x17c4: Stack[-21] = Stack[-2]
0x17c5: Stack[-1] = (int) 0
0x17c6: Call2 0x1495

0x17c7: Stack[-3] = Stack[-17]
0x17c8: Pop(3)
...
0x17d8: @@ add(Stack[-13]); Obj=23 // @poff=864
0x17d9: Pop(0)
0x17da: Stack[-18] = 0
0x17db: Push((int) 1)
...
0x17e2: Pop(0)
0x17e3: Push("repair.xml") // @poff=1700
0x17e4: @ ChooseItem(Stack[-27], Stack[-13], Stack[-24], Stack[-1])
0x17e5: Pop(1)
0x17e6: @@ size(Stack[-11]); Obj=12 // @poff=868
0x17e7: Pop(0)
...
0x17ef: @@ get(Stack[-8], Stack[-9]); Obj=12 // @poff=873
0x17f0: Pop(0)
0x17f1: @@ get(Stack[-7], Stack[-8]); Obj=23 // @poff=873
0x17f2: Pop(0)
...
0x17f7: Push("money") // @poff=1722
0x17f8: @@ GetProperty(Stack[-1], Stack[-7]); Obj=54 // @poff=730
0x17f9: Pop(1)
...
0x17ff: Push("money") // @poff=1722
0x1800: @@ SetProperty(Stack[-1], Stack[-7]); Obj=54 // @poff=756
0x1801: Pop(1)
0x1802: Stack[-5] = (int) 0
0x1803: Pop(0); Push((bool) Stack[-5] < Stack[-11])
0x1804: IF (Stack[-1] == 0) GOTO 0x1818; Pop(1)

0x1805: @@ get(Stack[-4], Stack[-5]); Obj=12 // @poff=873
0x1806: Pop(0)
0x1807: @@ get(Stack[-3], Stack[-4]); Obj=25 // @poff=873
0x1808: Pop(0)
0x1809: @@ get(Stack[-2], Stack[-4]); Obj=24 // @poff=873
0x180a: Pop(0)
0x180b: @@ GetItem(Stack[-1], Stack[-2], Stack[-3]); Obj=53 // @poff=1642
0x180c: Pop(0)
0x180d: Push("durability") // @poff=1678
0x180e: Push((int) 100)
0x180f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=756
0x1810: Pop(2)
0x1811: Push((int) 1)
0x1812: @@ SetItem(Stack[-2], Stack[-1], Stack[-3], Stack[-4]); Obj=54 // @poff=1734
0x1813: Pop(1)
0x1814: Stack[-1] = 0
0x1815: Push((int) 1)
...
0x181f: @@ GetItemID(Stack[-2]); Obj=5 // @poff=1022
0x1820: Pop(0)
0x1821: Push("Weapon") // @poff=1742
0x1822: @ HasInvItemProperty(Stack[-2], Stack[-3], Stack[-1])
0x1823: Pop(1)
0x1824: Stack[-1] = Stack[-6]
0x1825: Return(); Pop(4)

0x1826: PushEmpty()
0x1827: PushEmpty(int, object)
0x1828: Stack[-3] = Stack[-1]
...
0x1839: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1756
0x183a: Return(); Pop(0)

0x183b: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1796
0x183c: Return(); Pop(0)
...
0x185d: Stack[-5] = Stack[-1]
0x185e: Call2 0x1142

0x185f: Pop(1)
0x1860: IF (Stack[-1] == 0) GOTO 0x1869; Pop(1)

0x1861: Push("reputation") // @poff=1840
0x1862: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x1863: Pop(1)
0x1864: Push((float)0.4000000059604645)
...
0x1870: Stack[-8] = Stack[-4]
0x1871: Stack[-7] = Stack[-3]
0x1872: Stack[-2] = (float) 700.0
0x1873: Stack[-6] = Stack[-1]
0x1874: Call2 0x171d

0x1875: Stack[-5] = Stack[-9]
0x1876: Pop(5)
0x1877: Return(); Pop(0)

0x1878: PushEmpty()
0x1879: PushEmpty(bool, object)
0x187a: Stack[-3] = Stack[-1]
0x187b: Call2 0x1142
...
0x1880: Pop(0)
0x1881: Push((float)-0.03999999910593033)
0x1882: Push((bool) 1)
