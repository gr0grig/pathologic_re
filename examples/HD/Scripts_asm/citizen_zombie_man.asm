...
Strings:
	...
	W:player
	W:idle
// @pool_raw:
...
0x34e: Push("all") // @poff=170
0x34f: Push("dattack_begin") // @poff=178
...
0x35f: Stack[-6] = Stack[-2]
0x360: Stack[-1] = (float) 0.20000000298023224
0x361: Call2 0x6f1

0x362: Pop(3)
0x363: Push("all") // @poff=170
0x364: Push("dattack_end") // @poff=206
...
0x384: Stack[-5] = Stack[-1]
0x385: Call2 0xad7

0x386: Stack[-2] = Stack[-3]
0x387: Pop(2)
0x388: Push((int) 0)
...
0x3b3: Stack[-6] = Stack[-8]
0x3b4: Pop(6)
0x3b5: Return(); Pop(0)

0x3b6: Stack[-1] = "zwalk" // @poff=230
0x3b7: Return(); Pop(0)
...
0x3bb: Stack[-17] = Stack[-7]
0x3bc: PushEmpty(bool, object)
0x3bd: Stack[-23] = Stack[-1]
0x3be: Call2 0x444
...
0x3c4: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x3c5: Pop(0)
...
0x3db: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=242
0x3dc: Pop(0)
...
0x3ed: Push((int) 0)
0x3ee: Push((float)0.30000001192092896)
...
0x410: Push((int) 0)
0x411: Push((float)0.30000001192092896)
...
0x448: Stack[-2] = Stack[-4]
0x449: Pop(2)
0x44a: Return(); Pop(0)

0x44b: Stack[-1] = "run" // @poff=256
0x44c: Return(); Pop(0)
...
0x44f: Pop(0)
0x450: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x451: Pop(0)
...
0x46e: Stack[-1] = (float) 1.7453293800354004
0x46f: Call2 0x44d

0x470: Stack[-2] = Stack[-7]
0x471: Pop(2)
...
0x477: Stack[-1] = (float) 2.6179938316345215
0x478: Call2 0x44d

0x479: Stack[-2] = Stack[-7]
0x47a: Pop(2)
...
0x47f: Push("Can't retreat, distance: ") // @poff=264
...
0x495: Push((int) 1)
0x496: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x497: Pop(1)
0x498: Push(Stack[-3])
0x499: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)

0x49a: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x49f: Stack[-1] = (float) 2.6179938316345215
0x4a0: Call2 0x44d

0x4a1: Stack[-2] = Stack[-4]
0x4a2: Pop(2)
...
0x4b2: IF (Stack[-1] == 1) GOTO 0x495; Pop(1)
...
0x4b9: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4c8: Stack[-1] = (float) 1.7453293800354004
0x4c9: Call2 0x44d

0x4ca: Stack[-2] = Stack[-4]
0x4cb: Pop(2)
...
0x4d8: IF (Stack[-1] == 1) GOTO 0x4de; Pop(1)

0x4d9: PushEmpty(bool)
0x4da: Call2 0x4f8

0x4db: Pop(0)
0x4dc: IF (Stack[-1] == 1) GOTO 0x4de; Pop(1)
...
0x501: Stack[-5] = Stack[-2]
0x502: Stack[-4] = Stack[-1]
0x503: Call2 0x83e

0x504: Pop(2)
0x505: Push((float)-0.3420201241970062)
...
0x50c: Stack[-6] = Stack[-2]
0x50d: Stack[-1] = (float) 0.10000000149011612
0x50e: Call2 0x846

0x50f: Pop(3)
0x510: Push("all") // @poff=170
0x511: Push("bow") // @poff=316
...
0x519: Stack[-1] = (float) -0.05999999865889549
0x51a: Call2 0x873

0x51b: Pop(1)
0x51c: PushEmpty(bool, object, string, float, float, float)
0x51d: Stack[-9] = Stack[-5]
0x51e: Stack[-4] = "health" // @poff=324
0x51f: Stack[-3] = (float) -0.05999999865889549
0x520: Stack[-2] = (int) 0
0x521: Stack[-1] = (int) 1
0x522: Call2 0x6db

0x523: Pop(6)
0x524: Push("disease") // @poff=338
0x525: @ HasProperty(Stack[-1], Stack[-2])
0x526: Pop(1)
0x527: Push(Stack[-1])
0x528: IF (Stack[-1] == 0) GOTO 0x52d; Pop(1)

0x529: Push("disease") // @poff=338
0x52a: Push((int) 0)
...
0x53b: Pop(0)
0x53c: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x53d: Pop(0)
...
0x55a: Stack[-1] = (float) 1.7453293800354004
0x55b: Call2 0x539

0x55c: Stack[-2] = Stack[-7]
0x55d: Pop(2)
...
0x563: Stack[-1] = (float) 2.6179938316345215
0x564: Call2 0x539

0x565: Stack[-2] = Stack[-7]
0x566: Pop(2)
...
0x56b: Push("Can't retreat, distance: ") // @poff=264
...
0x581: Push((int) 1)
0x582: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x583: Pop(1)
0x584: Push(Stack[-3])
0x585: IF (Stack[-1] == 0) GOTO 0x59d; Pop(1)

0x586: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x58b: Stack[-1] = (float) 2.6179938316345215
0x58c: Call2 0x539
...
0x59e: IF (Stack[-1] == 1) GOTO 0x581; Pop(1)
...
0x5a5: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x5b4: Stack[-1] = (float) 1.7453293800354004
0x5b5: Call2 0x539
...
0x5c4: IF (Stack[-1] == 1) GOTO 0x5ca; Pop(1)

0x5c5: PushEmpty(bool)
0x5c6: Call2 0x5e4

0x5c7: Pop(0)
0x5c8: IF (Stack[-1] == 1) GOTO 0x5ca; Pop(1)
...
0x5ea: Stack[-2] = Stack[-3]
0x5eb: Pop(2)
0x5ec: PushEmpty(float, cvector, cvector)
0x5ed: Stack[-5] = Stack[-2]
0x5ee: Stack[-4] = Stack[-1]
0x5ef: Call2 0x83e

0x5f0: Pop(2)
0x5f1: Push((float)-0.3420201241970062)
...
0x5fd: Pop(0)
0x5fe: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x5ff: Pop(0)
...
0x61c: Stack[-1] = (float) 1.7453293800354004
0x61d: Call2 0x5fb

0x61e: Stack[-2] = Stack[-7]
0x61f: Pop(2)
...
0x625: Stack[-1] = (float) 2.6179938316345215
0x626: Call2 0x5fb

0x627: Stack[-2] = Stack[-7]
0x628: Pop(2)
...
0x62d: Push("Can't retreat, distance: ") // @poff=264
...
0x643: Push((int) 1)
0x644: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x645: Pop(1)
0x646: Push(Stack[-3])
0x647: IF (Stack[-1] == 0) GOTO 0x65f; Pop(1)

0x648: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x64d: Stack[-1] = (float) 2.6179938316345215
0x64e: Call2 0x5fb
...
0x660: IF (Stack[-1] == 1) GOTO 0x643; Pop(1)
...
0x676: Stack[-1] = (float) 1.7453293800354004
0x677: Call2 0x5fb
...
0x686: IF (Stack[-1] == 1) GOTO 0x68c; Pop(1)

0x687: PushEmpty(bool)
0x688: Call2 0x6a6

0x689: Pop(0)
0x68a: IF (Stack[-1] == 1) GOTO 0x68c; Pop(1)
...
0x6ac: Stack[-2] = Stack[-3]
0x6ad: Pop(2)
0x6ae: PushEmpty(float, cvector, cvector)
0x6af: Stack[-5] = Stack[-2]
0x6b0: Stack[-4] = Stack[-1]
0x6b1: Call2 0x83e

0x6b2: Pop(2)
0x6b3: Push((float)-0.3420201241970062)
...
0x6c4: Pop(0)
0x6c5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x6c6: Pop(0)
...
0x6d0: Push("HasProperty") // @poff=354
0x6d1: Push((int) 2)
...
0x6d7: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=378
0x6d8: Pop(0)
...
0x6dd: Stack[-10] = Stack[-2]
0x6de: Stack[-9] = Stack[-1]
0x6df: Call2 0x6cf
...
0x6e5: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=390
0x6e6: Pop(0)
0x6e7: PushEmpty(float, float, float, float)
0x6e8: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x6e9: Stack[-8] = Stack[-2]
0x6ea: Stack[-7] = Stack[-1]
0x6eb: Call2 0x833

0x6ec: Pop(3)
0x6ed: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=402
0x6ee: Pop(1)
...
0x6f3: Stack[-9] = Stack[-2]
0x6f4: Stack[-1] = "disease" // @poff=338
0x6f5: Call2 0x6cf
...
0x6fd: Stack[-9] = Stack[-2]
0x6fe: Stack[-1] = "armor_disease" // @poff=414
0x6ff: Call2 0x6cf

0x700: Pop(2)
0x701: IF (Stack[-1] == 0) GOTO 0x707; Pop(1)

0x702: Push("armor_disease") // @poff=414
0x703: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=390
0x704: Pop(1)
0x705: Push((int) 100)
0x706: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x707: PushEmpty(bool, object, string)
0x708: Stack[-9] = Stack[-2]
0x709: Stack[-1] = "immunity" // @poff=442
0x70a: Call2 0x6cf

0x70b: Pop(2)
0x70c: IF (Stack[-1] == 0) GOTO 0x719; Pop(1)

0x70d: Push("immunity") // @poff=442
0x70e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=390
0x70f: Pop(1)
0x710: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x711: PushEmpty(bool, object, string, float, float, float)
0x712: Stack[-12] = Stack[-5]
0x713: Stack[-4] = "immunity" // @poff=442
...
0x724: Stack[-12] = Stack[-5]
0x725: Stack[-4] = "disease" // @poff=338
0x726: Stack[-11] = Stack[-3]
0x727: Stack[-2] = (int) 0
0x728: Stack[-1] = (int) 1
0x729: Call2 0x6db
...
0x733: Pop(1)
0x734: Stack[-5] = Stack[-7]
0x735: Return(); Pop(4)

0x736: PushEmpty(bool, bool)
0x737: @@ IsDead(Stack[-1]); Obj=3 // @poff=460
0x738: Pop(0)
0x739: Stack[-1] = Stack[-4]
0x73a: Return(); Pop(2)

0x73b: PushEmpty(object, object, object, object)
0x73c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x750: Pop(0)
0x751: Pop(0); PushNull((bool) Stack[-2] == 0)
0x752: IF (Stack[-1] == 0) GOTO 0x755; Pop(1)

0x753: Stack[-6] = (bool) 0
0x754: Return(); Pop(4)

0x755: @@ GetScene(Stack[-1]); Obj=5 // @poff=481
0x756: Pop(0)
...
0x769: Stack[-6] = Stack[-2]
0x76a: Stack[-1] = "noaccess" // @poff=490
0x76b: Call2 0x6cf
...
0x771: Push("noaccess") // @poff=490
0x772: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=390
0x773: Pop(1)
0x774: Push((int) 0)
...
0x778: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x786: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x787: Pop(0)
...
0x797: Stack[-1] = "fhit" // @poff=508
0x798: GOTO 0x79a

0x799: Stack[-1] = "bhit" // @poff=518
0x79a: Push("hit_react") // @poff=528
0x79b: Push("1") // @poff=548
0x79c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x79d: Push("2") // @poff=552
...
0x7b6: Stack[-25] = Stack[-1]
0x7b7: Call2 0x6bb

0x7b8: Stack[-2] = Stack[-3]
0x7b9: Pop(2)
0x7ba: Call2 0x829

0x7bb: Stack[-2] = Stack[-11]
0x7bc: Pop(2)
0x7bd: @ CreateVectorVector(Stack[-8])
0x7be: Pop(0)
0x7bf: Stack[-7] = (int) 1
0x7c0: Push("hit") // @poff=510
...
0x7d5: Pop(0)
0x7d6: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=565
0x7d7: Pop(0)
0x7d8: PushEmpty(object, int, float, cvector, cvector)
0x7d9: Stack[-26] = Stack[-5]
0x7da: Stack[-25] = Stack[-4]
0x7db: Stack[-24] = Stack[-3]
0x7dc: Stack[-6] = Stack[-2]
...
0x82c: Push((float)9.999999974752427e-07)
...
0x85c: Stack[-2] = Stack[-1]
0x85d: Call2 0x884

0x85e: Pop(1)
0x85f: PushEmpty(bool, object, string, float, float, float)
0x860: Stack[-8] = Stack[-5]
0x861: Stack[-4] = "reputation" // @poff=615
0x862: Stack[-7] = Stack[-3]
0x863: Stack[-2] = (int) 0
0x864: Stack[-1] = (int) 1
0x865: Call2 0x6db
...
0x86b: Pop(0)
0x86c: @@ add(Stack[-3]); Obj=1 // @poff=556
0x86d: Pop(0)
0x86e: Push((int) 14)
...
0x886: Pop(0)
0x887: @@ add(Stack[-3]); Obj=1 // @poff=556
0x888: Pop(0)
0x889: Push((int) 16)
...
0x8ad: Push("GenerateMoney: iMin > iMax") // @poff=651
0x8ae: @ Trace(Stack[-1])
0x8af: Pop(1)
0x8b0: Return(); Pop(4)
...
0x8b4: Pop(0); Push(Stack[-5] - Stack[-6]);
...
0x8bc: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x8bd: Push((int) 0)
...
0x8cb: Pop(0)
0x8cc: @@ SetItemName(Stack[-7]); Obj=3 // @poff=717
0x8cd: Pop(0)
0x8ce: Push("Organ") // @poff=729
0x8cf: Push((int) 1)
0x8d0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=402
0x8d1: Pop(2)
0x8d2: @@ GetItemID(Stack[-2]); Obj=3 // @poff=741
0x8d3: Pop(0)
0x8d4: Push((int) 0)
0x8d5: Push((int) 1)
...
0x8e2: Stack[-1] = "diseased_liver" // @poff=751
0x8e3: Call2 0x8c9

0x8e4: Pop(1)
0x8e5: PushEmpty(string)
0x8e6: Stack[-1] = "diseased_kidney" // @poff=781
0x8e7: Call2 0x8c9

0x8e8: Pop(1)
0x8e9: PushEmpty(string)
0x8ea: Stack[-1] = "diseased_heart" // @poff=813
0x8eb: Call2 0x8c9

0x8ec: Pop(1)
0x8ed: PushEmpty(string)
0x8ee: Stack[-1] = "diseased_blood" // @poff=843
0x8ef: Call2 0x8c9
...
0x8fd: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x8fe: Call2 0x8aa
...
0x92b: Stack[-1] = "syringe" // @poff=905
0x92c: Call2 0x9a1
...
0x950: Pop(0)
0x951: Push((int) 50)
0x952: Pop(2); Push(Stack[-2] * Stack[-1]);
0x953: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x954: Call2 0x8aa
...
0x969: Stack[-1] = "bracelet" // @poff=957
0x96a: Call2 0x9a1
...
0x975: Stack[-1] = "ear_ring" // @poff=975
0x976: Call2 0x9a1
...
0x981: Stack[-1] = "gold_ring" // @poff=993
0x982: Call2 0x9a1
...
0x98d: Stack[-1] = "silver_ring" // @poff=1013
0x98e: Call2 0x9a1
...
0x999: Stack[-1] = "flower" // @poff=1037
0x99a: Call2 0x9a1
...
0x9c3: Stack[-7] = Stack[-3]
0x9c4: Stack[-6] = Stack[-2]
...
0x9cb: Stack[-11] = Stack[-5]
0x9cc: Stack[-10] = Stack[-4]
0x9cd: Stack[-9] = Stack[-3]
0x9ce: Stack[-7] = Stack[-2]
0x9cf: Stack[-6] = Stack[-1]
0x9d0: Call2 0x7e7
...
0x9de: Push("player_shot") // @poff=1071
...
0x9f3: PushEmpty()
0x9f4: Push("unholster") // @poff=1051
...
0x9fc: Push("player_shot") // @poff=1071
...
0xa1b: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1109
0xa1c: Pop(0)
0xa1d: Pop(0); Push((bool) Stack[-1] == 0)
...
0xa54: Stack[-1] = "idle" // @poff=1151
0xa55: Push(Stack[-3])
0xa56: IF (Stack[-1] == 0) GOTO 0xa58; Pop(1)

0xa57: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xa58: Stack[-1] = Stack[-4]
0xa59: Return(); Pop(2)

0xa5a: PushEmpty(int, bool, int, bool)
0xa5b: Stack[-2] = (int) 0
0xa5c: Push("all") // @poff=170
0xa5d: PushEmpty(string, int)
0xa5e: Stack[-5] = Stack[-1]
0xa5f: Call2 0xa53

0xa60: Pop(1)
0xa61: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xa62: Pop(2)
0xa63: Pop(0); Push((bool) Stack[-1] == 0)
0xa64: IF (Stack[-1] == 0) GOTO 0xa66; Pop(1)

0xa65: GOTO 0xa69

0xa66: Push((int) 1)
0xa67: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xa68: GOTO 0xa5c

0xa69: Stack[-2] = Stack[-5]
0xa6a: Return(); Pop(4)
...
0xa71: Push(-1, 0); TaskCall(3)
0xa72: Call2 0x307

0xa73: Pop(-1, 0); TaskReturn
0xa74: Pop(1)
0xa75: Return(); Pop(0)

0xa76: PushEmpty()
0xa77: PushEmpty(bool, object)
0xa78: Stack[-4] = Stack[-1]
0xa79: Call2 0x75f
...
0xa83: Push(-1, 3); TaskCall(5)
0xa84: Call2 0x46b

0xa85: Pop(-1, 3); TaskReturn
0xa86: Pop(1)
0xa87: Return(); Pop(0)
...
0xab6: Stack[-2] = Stack[-4]
0xab7: Pop(2)
0xab8: Return(); Pop(0)

0xab9: PushEmpty()
0xaba: PushEmpty(object)
0xabb: Stack[-2] = Stack[-1]
0xabc: Push(-1, 3); TaskCall(6)
0xabd: Call2 0x508

0xabe: Pop(-1, 3); TaskReturn
0xabf: Pop(1)
0xac0: Return(); Pop(0)

0xac1: Push(GlobalVars[0])
0xac2: Stack[-1] = (bool) 0
0xac3: GlobalVars[0] = Stack[-1]; Pop(1)
0xac4: Return(); Pop(0)
...
0xac9: Pop(0)
0xaca: Pop(0); Push((bool) Stack[-1] == 0)
...
0xaf4: GlobalVars[0] = Stack[-1]; Pop(1)
0xaf5: Push((int) 50)
0xaf6: Push((int) 40)
...
0xb06: Stack[-2] = Stack[-1]
0xb07: Push(-1, 3); TaskCall(7)
0xb08: Call2 0x619

0xb09: Pop(-1, 3); TaskReturn
0xb0a: Pop(1)
0xb0b: Return(); Pop(0)
