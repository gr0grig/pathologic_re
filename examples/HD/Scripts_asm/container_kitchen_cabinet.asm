...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0x9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=14
0xa: Pop(1)
0xb: Push(Stack[-1])
0xc: IF (Stack[-1] == 0) GOTO 0x3a; Pop(1)

0xd: PushEmpty(string, int, int)
0xe: Stack[-3] = "Knife" // @poff=26
0xf: Stack[-2] = (int) 1
0x10: Stack[-1] = (int) 30
0x11: Call2 0xd2
...
0x6a: Stack[-3] = "dried_fish" // @poff=128
0x6b: Stack[-2] = (int) 1
0x6c: Stack[-1] = (int) 50
0x6d: Call2 0xd2
...
0x76: Stack[-3] = "vegetables" // @poff=158
0x77: Stack[-2] = (int) 1
0x78: Stack[-1] = (int) 50
0x79: Call2 0xd2
...
0x82: Stack[-3] = "dried_meat" // @poff=190
0x83: Stack[-2] = (int) 1
0x84: Stack[-1] = (int) 50
0x85: Call2 0xd2
...
0x88: Stack[-3] = "smoked_meat" // @poff=212
0x89: Stack[-2] = (int) 1
0x8a: Stack[-1] = (int) 50
0x8b: Call2 0xd2
...
0x8e: Stack[-3] = "fresh_fish" // @poff=236
0x8f: Stack[-2] = (int) 1
0x90: Stack[-1] = (int) 50
0x91: Call2 0xd2
...
0x94: Stack[-3] = "fresh_meat" // @poff=258
0x95: Stack[-2] = (int) 1
0x96: Stack[-1] = (int) 50
0x97: Call2 0xd2
...
0xb3: IF (Stack[-1] == 1) GOTO 0xba; Pop(1)
...
0xbc: @@ IsOnGround(Stack[-4]); Obj=9 // @poff=292
0xbd: Pop(0)
0xbe: Push(Stack[-4])
...
0xdf: Stack[-10] = Stack[-2]
0xe0: Stack[-9] = Stack[-1]
0xe1: Call2 0xec
...
0xf2: Push("nouse_container") // @poff=303
