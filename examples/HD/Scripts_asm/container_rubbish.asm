...
Strings:
	...
	A:GetProperty
	W:nouse_container
// @pool_raw:
...
0x1: Push("playsound") // @poff=0
0x2: Push("meshok_drop") // @poff=20
...
0x28: @ StopGroup0()
0x29: Pop(0)
0x2a: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=44
0x2b: Pop(0)
0x2c: Push(Stack[-2])
...
0x54: Pop(0)
0x55: Push("undisposable") // @poff=55
0x56: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=81
0x57: Pop(1)
0x58: Push(Stack[-2])
0x59: IF (Stack[-1] == 0) GOTO 0x60; Pop(1)

0x5a: Push("undisposable") // @poff=55
0x5b: @@ GetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=93
0x5c: Pop(1)
0x5d: Push(Stack[-1])
...
0x74: Push("nouse_container") // @poff=105
