...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0x7: Pop(0)
0x8: Push("nailed") // @poff=0
0x9: @@ GetProperty(Stack[-1], Stack[-4]); Obj=5 // @poff=14
0xa: Pop(1)
0xb: Push(Stack[-3])
0xc: IF (Stack[-1] == 0) GOTO 0xa3; Pop(1)

0xd: PushEmpty(string, int, int, int)
0xe: Stack[-4] = "alpha_pills" // @poff=26
0xf: Stack[-3] = (int) 1
0x10: Stack[-2] = (int) 2
0x11: Stack[-1] = (int) 3
0x12: Call2 0x151
...
0x2d: Stack[-4] = "kerosene" // @poff=110
0x2e: Stack[-3] = (int) 1
0x2f: Stack[-2] = (int) 3
0x30: Stack[-1] = (int) 10
0x31: Call2 0x151
...
0x50: Stack[-3] = "neomicin" // @poff=164
0x51: Stack[-2] = (int) 1
0x52: Stack[-1] = (int) 15
0x53: Call2 0x146
...
0x56: Stack[-3] = "glove_disp" // @poff=182
0x57: Stack[-2] = (int) 1
0x58: Stack[-1] = (int) 30
0x59: Call2 0x146
...
0x5f: Stack[-3] = "novocaine" // @poff=204
0x60: Stack[-2] = (int) 1
0x61: Stack[-1] = (int) 20
0x62: Call2 0x146
...
0x65: Stack[-4] = "beta_pills" // @poff=224
0x66: Stack[-3] = (int) 1
0x67: Stack[-2] = (int) 4
0x68: Stack[-1] = (int) 2
0x69: Call2 0x151
...
0x7b: Stack[-3] = "monomicin" // @poff=276
0x7c: Stack[-2] = (int) 1
0x7d: Stack[-1] = (int) 25
0x7e: Call2 0x146
...
0x87: Stack[-4] = "gamma_pills" // @poff=310
0x88: Stack[-3] = (int) 1
0x89: Stack[-2] = (int) 8
0x8a: Stack[-1] = (int) 2
0x8b: Call2 0x151
...
0x91: Stack[-3] = "feromicin" // @poff=334
0x92: Stack[-2] = (int) 1
0x93: Stack[-1] = (int) 35
0x94: Call2 0x146
...
0x97: Stack[-3] = "delta_pills" // @poff=354
0x98: Stack[-2] = (int) 1
0x99: Stack[-1] = (int) 16
0x9a: Call2 0x146
...
0xa5: Stack[-1] = Stack[-2]
0xa6: Pop(1)
0xa7: PushEmpty(string, int, int)
0xa8: Stack[-3] = "bandage" // @poff=394
0xa9: Stack[-2] = (int) 1
0xaa: Stack[-1] = (int) 50
0xab: Call2 0x146
...
0xae: Stack[-3] = "tourniquet" // @poff=410
0xaf: Stack[-2] = (int) 1
0xb0: Stack[-1] = (int) 50
0xb1: Call2 0x146
...
0xb4: Stack[-4] = "alpha_pills" // @poff=26
0xb5: Stack[-3] = (int) 1
0xb6: Stack[-2] = (int) 4
0xb7: Stack[-1] = (int) 3
0xb8: Call2 0x151
...
0xf6: Stack[-3] = "bracelet" // @poff=482
0xf7: Stack[-2] = (int) 1
0xf8: Stack[-1] = (int) 20
0xf9: Call2 0x146
...
0xfc: Stack[-3] = "ear_ring" // @poff=500
0xfd: Stack[-2] = (int) 1
0xfe: Stack[-1] = (int) 20
0xff: Call2 0x146
...
0x102: Stack[-3] = "gold_ring" // @poff=518
0x103: Stack[-2] = (int) 1
...
0x108: Stack[-3] = "silver_ring" // @poff=538
0x109: Stack[-2] = (int) 1
...
0x130: @@ IsOnGround(Stack[-4]); Obj=9 // @poff=574
0x131: Pop(0)
0x132: Push(Stack[-4])
...
0x148: Stack[-7] = Stack[-2]
0x149: Stack[-6] = Stack[-1]
0x14a: Call2 0x160
...
0x153: Stack[-10] = Stack[-2]
0x154: Stack[-9] = Stack[-1]
0x155: Call2 0x160
...
0x166: Push("nouse_container") // @poff=585
