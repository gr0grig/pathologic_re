...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0xd: Stack[-4] = "alpha_pills" // @poff=18
0xe: Stack[-3] = (int) 1
0xf: Stack[-2] = (int) 25
0x10: Stack[-1] = (int) 4
0x11: Call2 0xa6
...
0x28: Stack[-3] = "novocaine" // @poff=68
0x29: Stack[-2] = (int) 1
0x2a: Stack[-1] = (int) 10
0x2b: Call2 0x9b
...
0x40: Stack[-4] = "revolver_ammo" // @poff=118
0x41: Stack[-3] = (int) 1
0x42: Stack[-2] = (int) 20
0x43: Stack[-1] = (int) 2
0x44: Call2 0xa6
...
0x47: Stack[-3] = "rifle_ammo" // @poff=146
0x48: Stack[-2] = (int) 1
0x49: Stack[-1] = (int) 10
0x4a: Call2 0x9b
...
0x59: Stack[-4] = "kerosene" // @poff=198
0x5a: Stack[-3] = (int) 1
0x5b: Stack[-2] = (int) 4
0x5c: Stack[-1] = (int) 10
0x5d: Call2 0xa6
...
0x60: Stack[-3] = "lockpick" // @poff=216
0x61: Stack[-2] = (int) 1
0x62: Stack[-1] = (int) 20
0x63: Call2 0x9b
...
0x85: IF (Stack[-1] == 1) GOTO 0x8c; Pop(1)
...
0x8a: IF (Stack[-1] == 1) GOTO 0x8c; Pop(1)
...
0x8e: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=270
0x8f: Pop(0)
0x90: Push(Stack[-2])
...
0xa8: Stack[-10] = Stack[-2]
0xa9: Stack[-9] = Stack[-1]
0xaa: Call2 0xb5
...
0xbb: Push("nouse_container") // @poff=281
