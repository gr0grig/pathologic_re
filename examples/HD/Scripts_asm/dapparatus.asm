...
Strings:
	W:dapparatus.xml
	W:branch
// @pool_raw:64006100700070006100720061007400750073002e0078006d006c0000006200720061006e00630068000000
...
0x14: Push("dapparatus.xml") // @poff=0
0x15: Push((bool) 0)
0x16: Push((bool) 0)
