...
Strings:
	...
	W:cleanup
	W:restore
// @pool_raw:61006e0069006d006100740069006f006e00000061006c006c00000063006c00650061006e0075007000000072006500730074006f00720065000000
...
0x12: Push("animation") // @poff=0
0x13: @ GetProperty(Stack[-1], Stack[-2])
0x14: Pop(1)
0x15: Push("all") // @poff=20
