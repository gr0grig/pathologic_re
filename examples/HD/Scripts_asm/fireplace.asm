...
Strings:
	...
	A:Enable
	W:fire_loop
// @pool_raw:66006900720065000000430061006e00270074002000660069006e0064002000660069007200650020007000610072007400690063006c0065002000730079007300740065006d000000416464536f7572636500456e61626c650066006900720065005f006c006f006f0070000000
...
0x13: Push((float)0.0)
0x14: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x15: Pop(3)
0x16: Push(CVector(10.0, 0.0, 0.0))
0x17: Push(CVector(0.0, 1.0, 0.0))
0x18: Push((float)0.0)
0x19: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x1a: Pop(3)
0x1b: Push(CVector(0.0, 0.0, 10.0))
0x1c: Push(CVector(0.0, 1.0, 0.0))
0x1d: Push((float)0.0)
0x1e: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x1f: Pop(3)
0x20: Push(CVector(-10.0, 0.0, 0.0))
0x21: Push(CVector(0.0, 1.0, 0.0))
0x22: Push((float)0.0)
0x23: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x24: Pop(3)
0x25: Push(CVector(0.0, 0.0, -10.0))
0x26: Push(CVector(0.0, 1.0, 0.0))
0x27: Push((float)0.0)
0x28: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x29: Pop(3)
0x2a: Push(CVector(10.0, 0.0, 10.0))
0x2b: Push(CVector(0.0, 1.0, 0.0))
0x2c: Push((float)0.0)
0x2d: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x2e: Pop(3)
0x2f: Push(CVector(-10.0, 0.0, -10.0))
0x30: Push(CVector(0.0, 1.0, 0.0))
0x31: Push((float)0.0)
0x32: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x33: Pop(3)
0x34: Push(CVector(-10.0, 0.0, 10.0))
0x35: Push(CVector(0.0, 1.0, 0.0))
0x36: Push((float)0.0)
0x37: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x38: Pop(3)
0x39: Push(CVector(10.0, 0.0, -10.0))
0x3a: Push(CVector(0.0, 1.0, 0.0))
0x3b: Push((float)0.0)
0x3c: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=5 // @poff=74
0x3d: Pop(3)
0x3e: @@ Enable(); Obj=2 // @poff=84
0x3f: Pop(0)
0x40: Push((bool) 1)
0x41: IF (Stack[-1] == 0) GOTO 0x4a; Pop(1)

0x42: Push("fire_loop") // @poff=91
