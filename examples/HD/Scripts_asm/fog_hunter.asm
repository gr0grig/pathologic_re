...
0xa4: Push("attack") // @poff=104
0xa5: @ PlaySound(Stack[-1])
0xa6: Pop(1)
0xa7: PushEmpty(float, object, float)
0xa8: Stack[-32] = Stack[-2]
0xa9: Stack[-1] = (float) 0.20000000298023224
0xaa: Call2 0x2c9

0xab: Stack[-3] = Stack[-4]
0xac: Pop(3)
0xad: Push((int) 5)
0xae: Push((float)0.20000000298023224)
...
0xc6: Push(CvectorIndex(Stack[3 + Tasks[-1].StackPointer], 1))
0xc7: Stack[-1] = (int) 0
0xc8: CvectorIndex(Stack[3 + Tasks[-1].StackPointer], 1) = Stack[-1];
0xc9: @@@ GetPFPosition(Stack[-2]T); Obj=0 // @poff=22
0xca: Pop(0)
0xcb: Push(CvectorIndex(Stack[2 + Tasks[-1].StackPointer], 1))
0xcc: Stack[-1] = (int) 0
...
0xd8: Push("fog hunter inited") // @poff=118
0xd9: @ Trace(Stack[-1])
0xda: Pop(1)
0xdb: @ PutOnGrid()
0xdc: Pop(0)
...
0x17d: Push("fog hunter following") // @poff=154
0x17e: @ Trace(Stack[-1])
0x17f: Pop(1)
0x180: PushEmpty(object)
0x181: Call2 0x29b

0x182: Stack[-1] = Stack[-2]
0x183: Pop(1)
...
0x1dd: @@ GetPosition(Stack[-5]); Obj=21 // @poff=196
0x1de: Pop(0)
...
0x1f4: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=22
0x1f5: Pop(0)
...
0x25d: Stack[-1] = "walk" // @poff=208
0x25e: Return(); Pop(0)

0x25f: Stack[-1] = "run" // @poff=218
0x260: Return(); Pop(0)

0x261: PushEmpty(float, cvector, cvector, bool, float, cvector, cvector, bool)
0x262: Push("fog hunter idling") // @poff=226
0x263: @ Trace(Stack[-1])
0x264: Pop(1)
0x265: Push((int) 2)
...
0x28f: @@ GetPosition(Stack[-1]); Obj=3 // @poff=196
0x290: Pop(0)
0x291: Stack[-1] = Stack[-4]
0x292: Return(); Pop(2)

0x293: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x294: @ GetPosition(Stack[-3])
0x295: Pop(0)
0x296: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x297: Pop(0)
...
0x2a8: Push("HasProperty") // @poff=276
0x2a9: Push((int) 2)
...
0x2af: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=300
0x2b0: Pop(0)
...
0x2bd: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=312
0x2be: Pop(0)
0x2bf: PushEmpty(float, float, float, float)
0x2c0: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x2c1: Stack[-8] = Stack[-2]
0x2c2: Stack[-7] = Stack[-1]
0x2c3: Call2 0x368

0x2c4: Pop(3)
0x2c5: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=324
0x2c6: Pop(1)
...
0x2cb: Stack[-9] = Stack[-2]
0x2cc: Stack[-1] = "disease" // @poff=336
0x2cd: Call2 0x2a7
...
0x2d5: Stack[-9] = Stack[-2]
0x2d6: Stack[-1] = "armor_disease" // @poff=352
0x2d7: Call2 0x2a7

0x2d8: Pop(2)
0x2d9: IF (Stack[-1] == 0) GOTO 0x2df; Pop(1)

0x2da: Push("armor_disease") // @poff=352
0x2db: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=312
0x2dc: Pop(1)
0x2dd: Push((int) 100)
0x2de: Stack[-3] = Stack[-3] / Stack[-1]; Pop(1);
0x2df: PushEmpty(bool, object, string)
0x2e0: Stack[-9] = Stack[-2]
0x2e1: Stack[-1] = "immunity" // @poff=380
0x2e2: Call2 0x2a7

0x2e3: Pop(2)
0x2e4: IF (Stack[-1] == 0) GOTO 0x2f1; Pop(1)

0x2e5: Push("immunity") // @poff=380
0x2e6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=312
0x2e7: Pop(1)
0x2e8: Stack[-2] = Stack[-2] + Stack[-1]; Pop(0);
0x2e9: PushEmpty(bool, object, string, float, float, float)
0x2ea: Stack[-12] = Stack[-5]
0x2eb: Stack[-4] = "immunity" // @poff=380
...
0x2fc: Stack[-12] = Stack[-5]
0x2fd: Stack[-4] = "disease" // @poff=336
0x2fe: Stack[-11] = Stack[-3]
0x2ff: Stack[-2] = (int) 0
0x300: Stack[-1] = (int) 1
0x301: Call2 0x2b3
...
0x30b: Pop(1)
0x30c: Stack[-5] = Stack[-7]
0x30d: Return(); Pop(4)

0x30e: PushEmpty(bool, bool)
0x30f: @@ IsDead(Stack[-1]); Obj=3 // @poff=398
0x310: Pop(0)
0x311: Stack[-1] = Stack[-4]
0x312: Return(); Pop(2)

0x313: PushEmpty(object, object, object, object)
0x314: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x328: Pop(0)
0x329: Pop(0); PushNull((bool) Stack[-2] == 0)
0x32a: IF (Stack[-1] == 0) GOTO 0x32d; Pop(1)

0x32b: Stack[-6] = (bool) 0
0x32c: Return(); Pop(4)

0x32d: @@ GetScene(Stack[-1]); Obj=5 // @poff=419
0x32e: Pop(0)
...
0x341: Stack[-6] = Stack[-2]
0x342: Stack[-1] = "noaccess" // @poff=428
0x343: Call2 0x2a7
...
0x349: Push("noaccess") // @poff=428
0x34a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=312
0x34b: Pop(1)
0x34c: Push((int) 0)
...
0x36f: Stack[-1] = Stack[-4]
0x370: Return(); Pop(0)

0x371: Stack[-3] = Stack[-4]
0x372: Return(); Pop(0)

0x373: PushEmpty(object, object)
0x374: @ CreateFloatVector(Stack[-1])
0x375: Pop(0)
0x376: @@ add(Stack[-3]); Obj=1 // @poff=446
0x377: Pop(0)
0x378: Push((int) 14)
...
0x3bd: Push("GetCurrentRegion") // @poff=450
0x3be: Push((int) 1)
...
0x3c3: @@ GetCurrentRegion(Stack[-1]); Obj=2 // @poff=484
0x3c4: Pop(0)
