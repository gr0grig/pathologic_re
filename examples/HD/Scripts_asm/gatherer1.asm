...
// @pool_raw:
...
0x89: Stack[-1] = "Neutral" // @poff=0
0x8a: Call2 0xf8

0x8b: Pop(1)
0x8c: Push((int) 518145)
0x8d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x8e: Pop(1)
0x8f: @@@ ClearReplies(); Obj=0 // @poff=134
0x90: Pop(0)
...
0x97: Push((int) -1)
0x98: Push((int) 31336)
0x99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x9a: Pop(3)
0x9b: GOTO 0xda
...
0xac: Stack[-1] = "Neutral" // @poff=0
0xad: Call2 0xf8

0xae: Pop(1)
0xaf: Push((int) 518150)
0xb0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0xb1: Pop(1)
0xb2: @@@ ClearReplies(); Obj=0 // @poff=134
0xb3: Pop(0)
0xb4: Push((int) 518151)
0xb5: Push((int) 19265)
0xb6: Push((int) 19264)
0xb7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0xb8: Pop(3)
0xb9: GOTO 0xda
...
0xbf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0xc0: Pop(1)
0xc1: @@@ ClearReplies(); Obj=0 // @poff=134
0xc2: Pop(0)
...
0xd3: Push((int) -1)
0xd4: Push((int) 19270)
0xd5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0xd6: Pop(3)
0xd7: GOTO 0xda
...
0xe9: Push("all") // @poff=16
0xea: Push("idle") // @poff=24
...
0xf2: Push("all") // @poff=16
0xf3: Push("idle") // @poff=24
...
0x145: Stack[-1] = "Neutral" // @poff=0
0x146: Call2 0xf8

0x147: Pop(1)
0x148: Push((int) 518145)
0x149: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x14a: Pop(1)
0x14b: @@@ ClearReplies(); Obj=0 // @poff=134
0x14c: Pop(0)
0x14d: Push((int) 518146)
0x14e: Push((int) 19260)
0x14f: Push((int) 19259)
0x150: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x151: Pop(3)
...
0x16c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x16d: Pop(1)
0x16e: @@@ ClearReplies(); Obj=0 // @poff=134
0x16f: Pop(0)
0x170: Push((int) 518151)
0x171: Push((int) 19265)
0x172: Push((int) 19264)
0x173: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x174: Pop(3)
0x175: Return(); Pop(0)
...
0x23a: Pop(0)
0x23b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=34
0x23c: Pop(1)
0x23d: PushEmpty(int)
0x23e: Call2 0x725

0x23f: Pop(0)
0x240: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=45
0x241: Pop(1)
0x242: PushEmpty(string)
0x243: Call2 0x729

0x244: Pop(0)
0x245: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=63
0x246: Pop(1)
0x247: PushEmpty(string)
0x248: Call2 0x72b

0x249: Pop(0)
0x24a: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=72
0x24b: Pop(1)
0x24c: PushEmpty(int)
0x24d: Call2 0x70e

0x24e: Pop(0)
0x24f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=82
0x250: Pop(1)
0x251: Stack[-2] = (int) -1
...
0x260: Pop(2)
0x261: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=96
0x262: Pop(0)
...
0x265: @ sync()
0x266: Pop(0)
0x267: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=96
0x268: Pop(0)
0x269: GOTO 0x263

0x26a: PushEmpty(object)
0x26b: Stack[-10] = Stack[-1]
0x26c: Call2 0x561

0x26d: Pop(1)
0x26e: @ StopDialog(Stack[-4])
0x26f: Pop(0)
0x270: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=108
0x271: Pop(0)
0x272: Stack[-2] = Stack[-10]
0x273: Return(); Pop(8)
...
0x280: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x281: Pop(1)
0x282: @@@ ClearReplies(); Obj=0 // @poff=134
0x283: Pop(0)
...
0x29f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x2a0: Pop(3)
0x2a1: GOTO 0x2a4
...
0x2b3: Push("all") // @poff=16
0x2b4: Push("idle") // @poff=24
...
0x2bc: Push("all") // @poff=16
0x2bd: Push("idle") // @poff=24
...
0x30a: Stack[-1] = "Neutral" // @poff=0
0x30b: Call2 0x2c2

0x30c: Pop(1)
0x30d: Push((int) 525385)
0x30e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x30f: Pop(1)
0x310: @@@ ClearReplies(); Obj=0 // @poff=134
0x311: Pop(0)
...
0x323: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x324: Pop(3)
0x325: Push((int) 539023)
0x326: Push((int) -1)
0x327: Push((int) 40966)
0x328: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x329: Pop(3)
0x32a: Push((int) 539024)
0x32b: Push((int) -1)
0x32c: Push((int) 40967)
0x32d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x32e: Pop(3)
0x32f: Return(); Pop(0)
...
0x338: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x339: Pop(1)
0x33a: @@@ ClearReplies(); Obj=0 // @poff=134
0x33b: Pop(0)
0x33c: Push((int) 539005)
0x33d: Push((int) 40948)
0x33e: Push((int) 40947)
0x33f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x340: Pop(3)
...
0x34f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x350: Pop(1)
0x351: @@@ ClearReplies(); Obj=0 // @poff=134
0x352: Pop(0)
0x353: Push((int) 539007)
0x354: Push((int) 40950)
0x355: Push((int) 40949)
0x356: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x357: Pop(3)
0x358: Return(); Pop(0)
...
0x361: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x362: Pop(1)
0x363: @@@ ClearReplies(); Obj=0 // @poff=134
0x364: Pop(0)
...
0x36d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x36e: Pop(3)
0x36f: Return(); Pop(0)
...
0x378: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x379: Pop(1)
0x37a: @@@ ClearReplies(); Obj=0 // @poff=134
0x37b: Pop(0)
...
0x38f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0x390: Pop(1)
0x391: @@@ ClearReplies(); Obj=0 // @poff=134
0x392: Pop(0)
...
0x430: Stack[-8] = Stack[-2]
0x431: Stack[-7] = Stack[-1]
0x432: Call2 0x46a
...
0x471: Push("player") // @poff=172
0x472: @ FindActor(Stack[-4]T, Stack[-1])
0x473: Pop(1)
...
0x486: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x4db: Pop(0)
0x4dc: Push("all") // @poff=16
0x4dd: PushEmpty(string, int)
0x4de: Stack[-7] = Stack[-1]
0x4df: Call2 0x603
...
0x511: Pop(0)
0x512: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x513: Pop(0)
...
0x51d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x51e: Pop(0)
0x51f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x520: Pop(0)
...
0x574: @@ GetPosition(Stack[-7]); Obj=18 // @poff=196
0x575: Pop(0)
0x576: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=208
0x577: Pop(0)
...
0x5b3: Push("Can't find lsh animation : ") // @poff=222
...
0x5c2: Push("Can't find lsh animation : ") // @poff=222
...
0x5c8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x5c9: Pop(0)
...
0x5e2: Push((float)9.999999974752427e-07)
...
0x5f0: Pop(0)
0x5f1: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=278
0x5f2: Pop(0)
...
0x60b: Stack[-2] = (int) 0
0x60c: Push("all") // @poff=16
0x60d: PushEmpty(string, int)
0x60e: Stack[-5] = Stack[-1]
0x60f: Call2 0x603
...
0x61f: Pop(1)
0x620: Push("Gatherer1_") // @poff=286
0x621: Pop(1); Push(Stack[-1] + Stack[-3]);
0x622: Push((int) 1)
0x623: @ SetVariable(Stack[-2], Stack[-1])
0x624: Pop(2)
0x625: Push("blood") // @poff=308
0x626: Push((int) 1)
0x627: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=8 // @poff=320
0x628: Pop(2)
0x629: Return(); Pop(4)

0x62a: PushEmpty()
0x62b: Push("ookGatherer1") // @poff=337
0x62c: Push((int) 1)
...
0x634: Pop(1)
0x635: Push("k2q04MorlokGotoAndrei") // @poff=363
0x636: Push("pt_map_andrei") // @poff=407
0x637: Push((int) 0)
...
0x63b: Pop(0)
0x63c: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=435
0x63d: Pop(5)
0x63e: PushEmpty()
0x63f: Call2 0x699
...
0x642: Stack[-1] = 0
0x643: PushEmpty()
0x644: Push("oobSysGatherer1_1") // @poff=443
0x645: Push((int) 1)
...
0x649: PushEmpty()
0x64a: Push("playsound") // @poff=479
0x64b: Push("giveitem") // @poff=499
...
0x64f: PushEmpty()
0x650: Push((int) 1000)
0x651: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=517
0x652: Pop(1)
0x653: Return(); Pop(0)

0x654: PushEmpty()
0x655: PushEmpty(int, string)
0x656: Stack[-1] = "k2q04" // @poff=532
0x657: Call2 0x5e9
...
0x662: Stack[-1] = "ookGatherer1" // @poff=337
0x663: Call2 0x5e9
...
0x66e: Stack[-1] = "oobSysGatherer1_1" // @poff=443
0x66f: Call2 0x5e9
...
0x691: Pop(1)
0x692: Push("Gatherer1_") // @poff=286
...
0x6ab: Push("Can't retrieve diary root") // @poff=544
0x6ac: @ Trace(Stack[-1])
0x6ad: Pop(1)
...
0x6b7: Pop(1)
0x6b8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=596
0x6b9: Pop(0)
0x6ba: Pop(0); Push((bool) Stack[-2] == 0)
0x6bb: IF (Stack[-1] == 0) GOTO 0x6c2; Pop(1)

0x6bc: Push("Can't find diary parent with id: ") // @poff=601
...
0x6c2: @@ AddChild(Stack[-8]); Obj=2 // @poff=669
0x6c3: Pop(0)
0x6c4: Push((int) 7)
0x6c5: @ SendWorldWndMessage(Stack[-1])
0x6c6: Pop(1)
0x6c7: @@ GetCategory(Stack[-1]); Obj=8 // @poff=678
0x6c8: Pop(0)
...
0x6d4: Push("Can't find main outdoor scene") // @poff=690
0x6d5: @ Trace(Stack[-1])
0x6d6: Pop(1)
0x6d7: Stack[-1] = 0
...
0x6da: @@ GetMap(Stack[-1]); Obj=2 // @poff=750
0x6db: Pop(0)
...
0x6ea: Stack[-1] = "grass_black_tvir" // @poff=757
0x6eb: Call2 0x709
...
0x6f6: Stack[-1] = "grass_blood_tvir" // @poff=791
0x6f7: Call2 0x709
...
0x702: Stack[-1] = "grass_brown_tvir" // @poff=825
0x703: Call2 0x709
...
0x729: Stack[-1] = "ui/NPC_Morlok.png" // @poff=873
0x72a: Return(); Pop(0)

0x72b: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=909
0x72c: Return(); Pop(0)
