...
// @pool_raw:
...
0x287: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x288: Pop(3)
0x289: Push((int) 539025)
0x28a: Push((int) -1)
0x28b: Push((int) 40968)
0x28c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=147
0x28d: Pop(3)
0x28e: GOTO 0x291
...
0x2a0: Push("all") // @poff=16
0x2a1: Push("idle") // @poff=24
...
0x2a9: Push("all") // @poff=16
0x2aa: Push("idle") // @poff=24
...
0x34b: Stack[-8] = Stack[-2]
0x34c: Stack[-7] = Stack[-1]
0x34d: Call2 0x385
...
0x38c: Push("player") // @poff=172
0x38d: @ FindActor(Stack[-4]T, Stack[-1])
0x38e: Pop(1)
...
0x3a1: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x42c: Pop(0)
0x42d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x42e: Pop(0)
...
0x438: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x439: Pop(0)
0x43a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x43b: Pop(0)
...
0x48f: @@ GetPosition(Stack[-7]); Obj=18 // @poff=196
0x490: Pop(0)
0x491: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=208
0x492: Pop(0)
...
0x4ce: Push("Can't find lsh animation : ") // @poff=222
...
0x4dd: Push("Can't find lsh animation : ") // @poff=222
...
0x4fd: Push((float)9.999999974752427e-07)
...
0x50b: Pop(0)
0x50c: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=278
0x50d: Pop(0)
...
0x535: Pop(1)
0x536: Push("Gatherer2_") // @poff=286
0x537: Pop(1); Push(Stack[-1] + Stack[-3]);
0x538: Push((int) 1)
0x539: @ SetVariable(Stack[-2], Stack[-1])
0x53a: Pop(2)
0x53b: Push("blood") // @poff=308
0x53c: Push((int) 1)
0x53d: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=8 // @poff=320
0x53e: Pop(2)
0x53f: Return(); Pop(4)

0x540: PushEmpty()
0x541: Push("oobSysGatherer2_1") // @poff=337
0x542: Push((int) 1)
...
0x546: PushEmpty()
0x547: Push("playsound") // @poff=373
0x548: Push("giveitem") // @poff=393
...
0x54c: PushEmpty()
0x54d: Push((int) 1000)
0x54e: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=411
0x54f: Pop(1)
0x550: Return(); Pop(0)

0x551: PushEmpty()
0x552: PushEmpty(int, string)
0x553: Stack[-1] = "oobSysGatherer2_1" // @poff=337
0x554: Call2 0x504
...
0x569: Stack[-4] = Stack[-2]
0x56a: Stack[-1] = "blood" // @poff=308
0x56b: Call2 0x509
...
0x576: Pop(1)
0x577: Push("Gatherer2_") // @poff=286
...
0x588: Stack[-1] = "grass_black_tvir" // @poff=426
0x589: Call2 0x5a7
...
0x594: Stack[-1] = "grass_blood_tvir" // @poff=460
0x595: Call2 0x5a7
...
0x599: Pop(2)
0x59a: Push((int) 15)
0x59b: @ irand(Stack[-2], Stack[-1])
0x59c: Pop(1)
0x59d: Push((int) 5)
0x59e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x59f: PushEmpty(int, string)
0x5a0: Stack[-1] = "grass_brown_tvir" // @poff=494
0x5a1: Call2 0x5a7

0x5a2: Pop(1)
0x5a3: Push((int) 0)
0x5a4: @ AddItem(Stack[-4], Stack[-2], Stack[-1], Stack[-3])
0x5a5: Pop(2)
0x5a6: Return(); Pop(4)

0x5a7: PushEmpty(int, int)
0x5a8: @ GetInvItemByName(Stack[-1], Stack[-3])
0x5a9: Pop(0)
0x5aa: Stack[-1] = Stack[-4]
0x5ab: Return(); Pop(2)

0x5ac: PushEmpty(int, int)
0x5ad: Push("branch") // @poff=528
0x5ae: @ GetVariable(Stack[-1], Stack[-2])
0x5af: Pop(1)
0x5b0: Push((int) 0)
...
0x5bd: PushEmpty(int, int)
0x5be: Push("branch") // @poff=528
0x5bf: @ GetVariable(Stack[-1], Stack[-2])
0x5c0: Pop(1)
0x5c1: Stack[-1] = Stack[-3]
0x5c2: Return(); Pop(2)

0x5c3: Stack[-1] = (int) 521048
0x5c4: Return(); Pop(0)

0x5c5: Stack[-1] = (int) 521047
0x5c6: Return(); Pop(0)

0x5c7: Stack[-1] = "ui/NPC_Morlok.png" // @poff=542
0x5c8: Return(); Pop(0)

0x5c9: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=578
0x5ca: Return(); Pop(0)
