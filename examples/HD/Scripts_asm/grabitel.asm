...
0xa82: Push((float)0.699999988079071)
0xa83: Push((int) 500)
...
0xa8d: Pop(0)
0xa8e: @@ add(Stack[-3]); Obj=1 // @poff=918
0xa8f: Pop(0)
0xa90: Push((int) 16)
...
0xad1: Stack[-9] = Stack[-3]
0xad2: Stack[-8] = Stack[-2]
0xad3: Stack[-7] = Stack[-1]
0xad4: Call2 0xa21

0xad5: Stack[-4] = Stack[-6]
0xad6: Pop(4)
0xad7: Push((int) 0)
...
0xadd: Stack[-10] = Stack[-4]
0xade: Stack[-9] = Stack[-3]
0xadf: Stack[-8] = Stack[-2]
...
0xaec: Stack[-8] = Stack[-2]
0xaed: Stack[-1] = "class" // @poff=1241
0xaee: Call2 0x7e6
...
0xaf4: Push("class") // @poff=1241
0xaf5: @ GetProperty(Stack[-1], Stack[-3])
0xaf6: Pop(1)
0xaf7: Push("class") // @poff=1241
0xaf8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=762
0xaf9: Pop(1)
...
0xb0d: @@ in(Stack[-4], Stack[-8]); Obj=1 // @poff=1253
0xb0e: Pop(1)
0xb0f: Push(Stack[-3])
...
0xb14: Stack[-9] = Stack[-1]
0xb15: Call2 0x7e1

0xb16: Pop(1)
0xb17: IF (Stack[-1] == 0) GOTO 0xb1e; Pop(1)

0xb18: Push("reputation") // @poff=1177
0xb19: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=762
0xb1a: Pop(1)
0xb1b: Push((float)0.33000001311302185)
0xb1c: Stack[-9] = Stack[-3] >= Stack[-1]; Pop(1);
0xb1d: Return(); Pop(6)

0xb1e: PushEmpty(bool, object, string)
0xb1f: Stack[-10] = Stack[-2]
0xb20: Stack[-1] = "class" // @poff=1241
0xb21: Call2 0x7e6
...
0xb27: Push("class") // @poff=1241
0xb28: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=762
0xb29: Pop(1)
...
0xb92: Stack[-8] = Stack[-1]
0xb93: Call2 0x7d9

0xb94: Stack[-2] = Stack[-3]
0xb95: Pop(2)
...
0xb9d: Push(Stack[-4])
0xb9e: IF (Stack[-1] == 1) GOTO 0xba3; Pop(1)

0xb9f: Push((float)490000.0)
0xba0: Pop(1); Push((bool) Stack[-4] <= Stack[-1])
0xba1: IF (Stack[-1] == 1) GOTO 0xba3; Pop(1)
...
0xbb1: Stack[-4] = Stack[-2]
0xbb2: Stack[-1] = (float) 0.05000000074505806
0xbb3: Call2 0xa57
...
0xbbe: Stack[-7] = Stack[-3]
0xbbf: Stack[-6] = Stack[-2]
0xbc0: Stack[-5] = Stack[-1]
0xbc1: Call2 0x912
...
0xbc6: Stack[-11] = Stack[-5]
0xbc7: Stack[-10] = Stack[-4]
0xbc8: Stack[-9] = Stack[-3]
0xbc9: Stack[-7] = Stack[-2]
0xbca: Stack[-6] = Stack[-1]
0xbcb: Call2 0x956
...
0xbf7: Push("GenerateMoney: iMin > iMax") // @poff=1270
0xbf8: @ Trace(Stack[-1])
0xbf9: Pop(1)
0xbfa: Return(); Pop(4)
...
0xc15: Pop(0)
0xc16: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1336
0xc17: Pop(0)
0xc18: Push("Organ") // @poff=1348
0xc19: Push((int) 1)
0xc1a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=774
0xc1b: Pop(2)
0xc1c: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1360
0xc1d: Pop(0)
0xc1e: Push((int) 0)
0xc1f: Push((int) 1)
...
0xc2c: Stack[-1] = "liver" // @poff=1370
0xc2d: Call2 0xc13

0xc2e: Pop(1)
0xc2f: PushEmpty(string)
0xc30: Stack[-1] = "kidney" // @poff=1382
0xc31: Call2 0xc13

0xc32: Pop(1)
0xc33: PushEmpty(string)
0xc34: Stack[-1] = "heart" // @poff=1396
0xc35: Call2 0xc13

0xc36: Pop(1)
0xc37: PushEmpty(string)
0xc38: Stack[-1] = "blood" // @poff=1408
0xc39: Call2 0xc13
...
0xc4c: Stack[-3] = "lockpick" // @poff=1432
0xc4d: Stack[-2] = (int) 1
0xc4e: Stack[-1] = (int) 6
0xc4f: Call2 0x97f
...
0xc52: Stack[-1] = "grabitel_mark" // @poff=1450
0xc53: Call2 0xc5a
