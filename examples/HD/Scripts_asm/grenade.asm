...
0x53: Pop(0)
0x54: Push("grenade") // @poff=91
0x55: @ FindGeometry(Stack[-1], Stack[-3])
0x56: Pop(1)
0x57: Push((bool) 0)
0x58: @@ Enable(Stack[-1]); Obj=3 // @poff=26
0x59: Pop(1)
0x5a: Push("grenadefire") // @poff=107
0x5b: @ FindParticleSystem(Stack[-1], Stack[-2])
0x5c: Pop(1)
0x5d: Pop(0); PushNull((bool) Stack[-1] == 0)
0x5e: IF (Stack[-1] == 0) GOTO 0x63; Pop(1)

0x5f: Push("Can't find fire particle system") // @poff=131
0x60: @ Trace(Stack[-1])
0x61: Pop(1)
0x62: Return(); Pop(20)
...
0x65: Push((int) 0)
0x66: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x67: Pop(3)
0x68: Push(CVector(50.0, 0.0, 50.0))
0x69: Push(CVector(0.0, 1.0, 0.0))
0x6a: Push((int) 0)
0x6b: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x6c: Pop(3)
0x6d: Push(CVector(-50.0, 0.0, 50.0))
0x6e: Push(CVector(0.0, 1.0, 0.0))
0x6f: Push((int) 0)
0x70: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x71: Pop(3)
0x72: Push(CVector(-50.0, 0.0, -50.0))
0x73: Push(CVector(0.0, 1.0, 0.0))
0x74: Push((int) 0)
0x75: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x76: Pop(3)
0x77: Push(CVector(50.0, 0.0, -50.0))
0x78: Push(CVector(0.0, 1.0, 0.0))
0x79: Push((int) 0)
0x7a: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x7b: Pop(3)
0x7c: Push(CVector(25.0, 0.0, 25.0))
0x7d: Push(CVector(0.0, 1.0, 0.0))
0x7e: Push((int) 0)
0x7f: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x80: Pop(3)
0x81: Push(CVector(-25.0, 0.0, 25.0))
0x82: Push(CVector(0.0, 1.0, 0.0))
0x83: Push((int) 0)
0x84: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x85: Pop(3)
0x86: Push(CVector(-25.0, 0.0, -25.0))
0x87: Push(CVector(0.0, 1.0, 0.0))
0x88: Push((int) 0)
0x89: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x8a: Pop(3)
0x8b: Push(CVector(25.0, 0.0, -25.0))
0x8c: Push(CVector(0.0, 1.0, 0.0))
0x8d: Push((int) 0)
0x8e: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=195
0x8f: Pop(3)
0x90: @@ Enable(); Obj=1 // @poff=26
0x91: Pop(0)
0x92: Push((bool) 0)
0x93: @@ Fade(Stack[-1]); Obj=2 // @poff=205
0x94: Pop(1)
0x95: Push(GlobalVars[4])
0x96: @@ Fade(); Obj=1 // @poff=205
0x97: Pop(1)
0x98: Push((float)10.0)
0x99: @ Sleep(Stack[-1])
0x9a: Pop(1)
0x9b: @@ Fade(); Obj=1 // @poff=205
0x9c: Pop(0)
0x9d: Pop(0); Push(( Stack[-10] != 0 )
0x9e: IF (Stack[-1] == 0) GOTO 0xa2; Pop(1)

0x9f: Push((float)1.0)
0xa0: @@ FadeOut(Stack[-1]); Obj=11 // @poff=210
0xa1: Pop(1)
0xa2: Push((float)2.0)
0xa3: @ Sleep(Stack[-1])
0xa4: Pop(1)
...
0xf0: Stack[-2] = "bullet" // @poff=230
0xf1: Return(); Pop(0)

0xf2: Stack[-2] = "phys" // @poff=244
0xf3: Return(); Pop(0)
...
0xfa: @@ GetPosition(Stack[-1]); Obj=3 // @poff=254
0xfb: Pop(0)
...
0x104: Push("HasProperty") // @poff=266
0x105: Push((int) 2)
...
0x10b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=290
0x10c: Pop(0)
...
0x111: Stack[-18] = Stack[-2]
0x112: Stack[-1] = "health" // @poff=302
0x113: Call2 0x103
...
0x11a: Stack[-18] = Stack[-2]
0x11b: Stack[-1] = "armor" // @poff=316
0x11c: Call2 0x103
...
0x122: Push("armor") // @poff=316
0x123: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=328
0x124: Pop(1)
0x125: Push("armor_") // @poff=340
0x126: PushEmpty(string, int)
0x127: Stack[-16] = Stack[-1]
0x128: Call2 0xe6

0x129: Pop(1)
0x12a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x12b: PushEmpty(bool, object, string)
0x12c: Stack[-18] = Stack[-2]
0x12d: Stack[-8] = Stack[-1]
0x12e: Call2 0x103
...
0x134: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=328
0x135: Pop(0)
...
0x13c: Stack[-3] = Stack[-6]
0x13d: Pop(3)
0x13e: Push("health") // @poff=302
0x13f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=328
0x140: Pop(1)
0x141: Push((int) 1)
0x142: Pop(1); Push(Stack[-1] - Stack[-4]);
0x143: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x144: Push("health") // @poff=302
...
0x14a: Pop(3)
0x14b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=354
0x14c: Pop(2)
0x14d: PushEmpty(bool, object)
0x14e: Stack[-17] = Stack[-1]
0x14f: Call2 0xfe
...
0x173: Stack[-3] = Stack[-4]
0x174: Return(); Pop(0)

0x175: PushEmpty(object, object)
0x176: @ CreateFloatVector(Stack[-1])
0x177: Pop(0)
0x178: @@ add(Stack[-3]); Obj=1 // @poff=366
0x179: Pop(0)
0x17a: Push((int) 0)
0x17b: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x17c: IF (Stack[-1] == 0) GOTO 0x181; Pop(1)

0x17d: Push((float)0.699999988079071)
0x17e: Push((int) 500)
0x17f: @ RumblePlay(Stack[-2], Stack[-1])
0x180: Pop(2)
0x181: Push((int) 15)
0x182: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x183: Pop(1)
0x184: Return(); Pop(2)
