...
Strings:
	...
	W:class
	W:guard
// @pool_raw:
...
0x3f: Stack[-5] = Stack[-1]
0x40: Call2 0x8dd

0x41: Stack[-2] = Stack[-3]
0x42: Pop(2)
0x43: Push((int) 0)
...
0x5a: Stack[-8] = Stack[-2]
0x5b: Stack[-6] = Stack[-1]
0x5c: Call2 0x8ef
...
0x8c: Stack[-6] = Stack[-2]
0x8d: Stack[-5] = Stack[-1]
0x8e: Call2 0x781
...
0x93: Stack[-7] = Stack[-1]
0x94: Call2 0x910

0x95: Stack[-3] = Stack[-4]
0x96: Pop(3)
0x97: Push((int) 0)
...
0xa1: Stack[-5] = Stack[-2]
0xa2: Stack[-6] = Stack[-1]
0xa3: Call2 0x913
...
0xe3: @ GetPFPosition(Stack[-1]T)
0xe4: Pop(0)
0xe5: @ GetDirection(Stack[-0]T)
0xe6: Pop(0)
0xe7: PushEmpty()
0xe8: Call2 0x13b
...
0x104: @ FindPathTo(Stack[-1], Stack[-1]T)
0x105: Pop(0)
...
0x113: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x114: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x126: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x127: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x15e: Pop(0); PushNull((bool) Stack[-21] == 0)
0x15f: IF (Stack[-1] == 0) GOTO 0x165; Pop(1)

0x160: PushEmpty(string)
0x161: Stack[-1] = "fdie" // @poff=0
0x162: Call2 0x1b8

0x163: Pop(1)
0x164: GOTO 0x1b7

0x165: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x166: Pop(0)
...
0x176: Stack[-6] = "fdie" // @poff=0
0x177: GOTO 0x179

0x178: Stack[-6] = "bdie" // @poff=22
...
0x17f: @ StopAsync()
0x180: Pop(0)
0x181: Stack[-21] = Stack[-5]
0x182: Push("GetScriptProperty") // @poff=32
0x183: Push((int) 2)
0x184: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x185: IF (Stack[-1] == 0) GOTO 0x191; Pop(1)

0x186: Push("Owner") // @poff=68
0x187: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x188: Pop(1)
0x189: Push(Stack[-4])
0x18a: IF (Stack[-1] == 0) GOTO 0x191; Pop(1)

0x18b: Push("Owner") // @poff=68
0x18c: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x18d: Pop(1)
0x18e: Pop(0); PushNull((bool) Stack[-5] == 0)
0x18f: IF (Stack[-1] == 0) GOTO 0x191; Pop(1)

0x190: Stack[-21] = Stack[-5]
0x191: Push("@GetEyesHeight") // @poff=116
0x192: Push((int) 1)
0x193: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x194: IF (Stack[-1] == 0) GOTO 0x1a0; Pop(1)

0x195: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x196: Pop(0)
...
0x1a2: Stack[-7] = Stack[-1]
0x1a3: Call2 0x6df

0x1a4: Pop(1)
0x1a5: Push("all") // @poff=170
...
0x1ac: @ StopAsync()
0x1ad: Pop(0)
0x1ae: Push("head") // @poff=160
0x1af: @ UnlookAsync(Stack[-1])
0x1b0: Pop(1)
0x1b1: Push("all") // @poff=170
...
0x1e0: PushEmpty()
0x1e1: Stack[-3] = (float) 0.05000000074505806
0x1e2: Return(); Pop(0)
...
0x1fb: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1fc: Pop(0)
0x1fd: Push(Stack[-8])
0x1fe: IF (Stack[-1] == 0) GOTO 0x207; Pop(1)

0x1ff: Push("attack") // @poff=234
...
0x21b: Pop(0)
0x21c: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x21d: Pop(0)
...
0x237: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=248
0x238: Pop(0)
...
0x251: Pop(1)
0x252: Push("all") // @poff=170
0x253: Push("attack_on") // @poff=262
...
0x26b: IF (Stack[-1] == 1) GOTO 0x271; Pop(1)

0x26c: PushEmpty(bool)
0x26d: Call2 0x43d

0x26e: Pop(0)
0x26f: IF (Stack[-1] == 1) GOTO 0x271; Pop(1)

0x270: Stack[-1] = (bool) 0
0x271: IF (Stack[-1] == 0) GOTO 0x282; Pop(1)

0x272: @ Face(Stack[-0]T)
0x273: Pop(0)
0x274: PushEmpty()
0x275: Call2 0x46f

0x276: Pop(0)
0x277: Push("all") // @poff=170
0x278: Push("attack_stay") // @poff=282
0x279: @ PlayAnimation(Stack[-2], Stack[-1])
0x27a: Pop(2)
0x27b: PushEmpty(bool, float)
0x27c: Stack[-25] = Stack[-1]
0x27d: Call2 0x3b9
...
0x282: @ Face(Stack[-0]T)
0x283: Pop(0)
0x284: Push("all") // @poff=170
0x285: Push("fjump") // @poff=306
...
0x2a0: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x2a1: Pop(0)
...
0x2bf: Push("all") // @poff=170
0x2c0: Push("attack_off") // @poff=318
...
0x2cd: Push("all") // @poff=170
0x2ce: Push("attack_begin") // @poff=340
0x2cf: Push((int) 1)
0x2d0: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2db: Push("attack") // @poff=234
0x2dc: Push((int) 1)
0x2dd: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2e7: Push("all") // @poff=170
0x2e8: Push("bjump") // @poff=366
...
0x2ef: Push((float)0.8999999761581421)
0x2f0: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2f1: @ GetVictim(Stack[-1], Stack[-4])
0x2f2: Pop(1)
0x2f3: @ ReportAttack(Stack[-0]T)
0x2f4: Pop(0)
...
0x2f9: Stack[-10] = Stack[-1]
0x2fa: Call2 0x1e0

0x2fb: Stack[-3] = Stack[-5]
0x2fc: Pop(3)
0x2fd: PushEmpty(float, object, float, int)
0x2fe: Stack[-7] = Stack[-3]
0x2ff: Stack[-6] = Stack[-2]
0x300: PushEmpty(int, object, int)
0x301: Stack[-10] = Stack[-2]
0x302: Stack[-14] = Stack[-1]
0x303: Call2 0x1e3

0x304: Stack[-3] = Stack[-4]
0x305: Pop(3)
0x306: Call2 0x5b1

0x307: Stack[-4] = Stack[-5]
0x308: Pop(4)
0x309: PushEmpty(int)
0x30a: Call2 0x46d

0x30b: Pop(0)
0x30c: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x30d: Pop(1)
0x30e: PushEmpty(object, float)
0x30f: Stack[-5] = Stack[-2]
...
0x318: Pop(0)
0x319: @ irand(Stack[-4], Stack[-1]T)
0x31a: Pop(0)
0x31b: Push((int) 1)
0x31c: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x31d: @ Face(Stack[-0]T)
0x31e: Pop(0)
0x31f: Push((bool) 1)
...
0x326: Push("attack_begin") // @poff=340
...
0x33a: Stack[-11] = Stack[-2]
0x33b: Stack[-6] = Stack[-1]
0x33c: Call2 0x2ee

0x33d: Pop(2)
0x33e: Push("all") // @poff=170
0x33f: Push("attack_middle") // @poff=378
...
0x347: Pop(0)
0x348: Push("all") // @poff=170
0x349: Push("attack_middle") // @poff=378
...
0x383: Stack[-11] = Stack[-2]
0x384: Stack[-6] = Stack[-1]
0x385: Call2 0x2ee
...
0x38c: Pop(1)
0x38d: Push("all") // @poff=170
0x38e: Push("attack_end") // @poff=410
...
0x3cd: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=248
0x3ce: Pop(0)
...
0x419: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x41a: Pop(1)
...
0x41f: Pop(0)
0x420: Push("all") // @poff=170
0x421: Push("bjump") // @poff=366
0x422: @ PlayAnimation(Stack[-2], Stack[-1])
0x423: Pop(2)
0x424: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=248
0x425: Pop(0)
...
0x45b: @ irand(Stack[-1], Stack[-2]T)
0x45c: Pop(0)
0x45d: Push((int) 1)
0x45e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x45f: Push("attack") // @poff=234
...
0x470: Stack[-1] = "attack_stay" // @poff=282
0x471: Call2 0x6df
...
0x4a2: Stack[-15] = Stack[-5]
0x4a3: Stack[-14] = Stack[-4]
0x4a4: Stack[-13] = Stack[-3]
0x4a5: Stack[-12] = Stack[-2]
0x4a6: Stack[-11] = Stack[-1]
0x4a7: Call2 0x4ec

0x4a8: Stack[-6] = Stack[-7]
0x4a9: Pop(6)
0x4aa: Push( Stack[2 + Tasks[-1].StackPointer] )
0x4ab: IF (Stack[-1] == 0) GOTO 0x4af; Pop(1)

0x4ac: Push("head") // @poff=160
0x4ad: @ UnlookAsync(Stack[-1])
0x4ae: Pop(1)
0x4af: Push((int) 1)
0x4b0: @ KillTimer(Stack[-1])
0x4b1: Pop(1)
0x4b2: Stack[-1] = Stack[-10]
0x4b3: Return(); Pop(4)
...
0x4ef: Stack[-17] = Stack[-7]
0x4f0: PushEmpty(bool, object)
0x4f1: Stack[-23] = Stack[-1]
0x4f2: Call2 0x578
...
0x4f8: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x4f9: Pop(0)
...
0x50f: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=248
0x510: Pop(0)
...
0x521: Push((int) 0)
0x522: Push((float)0.30000001192092896)
...
0x544: Push((int) 0)
0x545: Push((float)0.30000001192092896)
...
0x57c: Stack[-2] = Stack[-4]
0x57d: Pop(2)
0x57e: Return(); Pop(0)

0x57f: Stack[-1] = "walk" // @poff=468
0x580: Return(); Pop(0)

0x581: Stack[-1] = "run" // @poff=478
0x582: Return(); Pop(0)
...
0x58d: Stack[-2] = "bullet" // @poff=496
0x58e: Return(); Pop(0)

0x58f: Stack[-2] = "phys" // @poff=510
0x590: Return(); Pop(0)

0x591: PushEmpty(cvector, cvector, cvector, cvector)
0x592: @ GetPosition(Stack[-2])
0x593: Pop(0)
0x594: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x595: Pop(0)
...
0x59a: Pop(0)
0x59b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x59c: Pop(0)
...
0x5a6: Push("HasProperty") // @poff=520
0x5a7: Push((int) 2)
...
0x5ad: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x5ae: Pop(0)
...
0x5b3: Stack[-18] = Stack[-2]
0x5b4: Stack[-1] = "health" // @poff=556
0x5b5: Call2 0x5a5
...
0x5bc: Stack[-18] = Stack[-2]
0x5bd: Stack[-1] = "armor" // @poff=570
0x5be: Call2 0x5a5
...
0x5c4: Push("armor") // @poff=570
0x5c5: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x5c6: Pop(1)
0x5c7: Push("armor_") // @poff=594
0x5c8: PushEmpty(string, int)
0x5c9: Stack[-16] = Stack[-1]
0x5ca: Call2 0x583

0x5cb: Pop(1)
0x5cc: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5cd: PushEmpty(bool, object, string)
0x5ce: Stack[-18] = Stack[-2]
0x5cf: Stack[-8] = Stack[-1]
0x5d0: Call2 0x5a5
...
0x5d6: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x5d7: Pop(0)
...
0x5de: Stack[-3] = Stack[-6]
0x5df: Pop(3)
0x5e0: Push("health") // @poff=556
0x5e1: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x5e2: Pop(1)
0x5e3: Push((int) 1)
0x5e4: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5e5: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5e6: Push("health") // @poff=556
...
0x5ec: Pop(3)
0x5ed: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x5ee: Pop(2)
0x5ef: PushEmpty(bool, object)
0x5f0: Stack[-17] = Stack[-1]
0x5f1: Call2 0x5a0
...
0x5f7: Pop(1)
0x5f8: Stack[-1] = Stack[-16]
0x5f9: Return(); Pop(12)

0x5fa: PushEmpty(bool, bool)
0x5fb: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x5fc: Pop(0)
0x5fd: Stack[-1] = Stack[-4]
0x5fe: Return(); Pop(2)

0x5ff: PushEmpty(object, object, object, object)
0x600: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x614: Pop(0)
0x615: Pop(0); PushNull((bool) Stack[-2] == 0)
0x616: IF (Stack[-1] == 0) GOTO 0x619; Pop(1)

0x617: Stack[-6] = (bool) 0
0x618: Return(); Pop(4)

0x619: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x61a: Pop(0)
...
0x62d: Stack[-6] = Stack[-2]
0x62e: Stack[-1] = "noaccess" // @poff=650
0x62f: Call2 0x5a5
...
0x635: Push("noaccess") // @poff=650
0x636: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x637: Pop(1)
0x638: Push((int) 0)
...
0x63c: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x64a: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x64b: Pop(0)
...
0x65b: Stack[-1] = "fhit" // @poff=668
0x65c: GOTO 0x65e

0x65d: Stack[-1] = "bhit" // @poff=678
0x65e: Push("hit_react") // @poff=688
0x65f: Push("1") // @poff=708
0x660: Pop(1); Push(Stack[-3] + Stack[-1]);
0x661: Push("2") // @poff=712
...
0x67a: Stack[-25] = Stack[-1]
0x67b: Call2 0x591

0x67c: Stack[-2] = Stack[-3]
0x67d: Pop(2)
0x67e: Call2 0x70e

0x67f: Stack[-2] = Stack[-11]
0x680: Pop(2)
0x681: @ CreateVectorVector(Stack[-8])
0x682: Pop(0)
0x683: Stack[-7] = (int) 1
0x684: Push("hit") // @poff=670
...
0x699: Pop(0)
0x69a: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x69b: Pop(0)
0x69c: PushEmpty(object, int, float, cvector, cvector)
0x69d: Stack[-26] = Stack[-5]
0x69e: Stack[-25] = Stack[-4]
0x69f: Stack[-24] = Stack[-3]
0x6a0: Stack[-6] = Stack[-2]
...
0x6ba: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x6bb: Pop(0)
...
0x6ca: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x6cb: Pop(0)
...
0x6d6: Stack[-7] = Stack[-2]
0x6d7: Stack[-6] = Stack[-1]
0x6d8: Call2 0x72e
...
0x711: Push((float)9.999999974752427e-07)
...
0x7a9: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=833
0x7aa: Pop(0)
...
0x7e2: Push("branch") // @poff=875
0x7e3: @ GetVariable(Stack[-1], Stack[-2])
0x7e4: Pop(1)
0x7e5: Stack[-1] = Stack[-3]
0x7e6: Return(); Pop(2)
...
0x7f7: Push("GenerateMoney: iMin > iMax") // @poff=889
0x7f8: @ Trace(Stack[-1])
0x7f9: Pop(1)
0x7fa: Return(); Pop(4)
...
0x815: Pop(0)
0x816: @@ SetItemName(Stack[-7]); Obj=3 // @poff=955
0x817: Pop(0)
0x818: Push("Organ") // @poff=967
0x819: Push((int) 1)
0x81a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x81b: Pop(2)
0x81c: @@ GetItemID(Stack[-2]); Obj=3 // @poff=979
0x81d: Pop(0)
0x81e: Push((int) 0)
0x81f: Push((int) 1)
...
0x82c: Stack[-1] = "liver" // @poff=989
0x82d: Call2 0x813

0x82e: Pop(1)
0x82f: PushEmpty(string)
0x830: Stack[-1] = "kidney" // @poff=1001
0x831: Call2 0x813

0x832: Pop(1)
0x833: PushEmpty(string)
0x834: Stack[-1] = "heart" // @poff=1015
0x835: Call2 0x813

0x836: Pop(1)
0x837: PushEmpty(string)
0x838: Stack[-1] = "blood" // @poff=1027
0x839: Call2 0x813
...
0x84c: Stack[-3] = "tourniquet" // @poff=1039
0x84d: Stack[-2] = (int) 1
...
0x852: Stack[-3] = "bandage" // @poff=1061
0x853: Stack[-2] = (int) 1
...
0x858: Stack[-3] = "bottle_empty" // @poff=1077
0x859: Stack[-2] = (int) 1
0x85a: Stack[-1] = (int) 2
0x85b: Call2 0x6d4
...
0x85e: Stack[-3] = "tvirin" // @poff=1103
0x85f: Stack[-2] = (int) 1
0x860: Stack[-1] = (int) 8
0x861: Call2 0x6d4
...
0x886: Stack[-7] = Stack[-3]
0x887: Stack[-6] = Stack[-2]
...
0x88e: Stack[-11] = Stack[-5]
0x88f: Stack[-10] = Stack[-4]
0x890: Stack[-9] = Stack[-3]
0x891: Stack[-7] = Stack[-2]
0x892: Stack[-6] = Stack[-1]
0x893: Call2 0x6ab
...
0x8ac: Stack[-2] = Stack[-5]
0x8ad: Return(); Pop(4)

0x8ae: Push("head") // @poff=160
...
0x8ce: Pop(0)
0x8cf: Push("all") // @poff=170
0x8d0: PushEmpty(string, int)
0x8d1: Stack[-4] = Stack[-1]
0x8d2: Call2 0x896
...
0x8f1: Stack[-4] = Stack[-1]
0x8f2: Call2 0x8dd

0x8f3: Stack[-2] = Stack[-5]
0x8f4: Pop(2)
0x8f5: Return(); Pop(0)
...
0x938: Stack[-9] = Stack[-2]
0x939: Stack[-1] = "class" // @poff=1127
0x93a: Call2 0x5a5
...
0x940: Push("class") // @poff=1127
0x941: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=582
0x942: Pop(1)
0x943: Push("guard") // @poff=1139
...
0x94c: Push(Stack[-2])
0x94d: IF (Stack[-1] == 1) GOTO 0x956; Pop(1)

0x94e: PushEmpty(float, object)
0x94f: Stack[-10] = Stack[-1]
0x950: Call2 0x598
...
0x96d: Pop(0)
0x96e: Push((float)-0.029999999329447746)
0x96f: Push((bool) 1)
