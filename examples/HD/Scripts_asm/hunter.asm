...
0x7c5: Pop(0)
0x7c6: Push((int) 0)
0x7c7: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x7c8: IF (Stack[-1] == 0) GOTO 0x7cd; Pop(1)

0x7c9: Push((float)0.699999988079071)
0x7ca: Push((int) 500)
0x7cb: @ RumblePlay(Stack[-2], Stack[-1])
0x7cc: Pop(2)
0x7cd: Push((int) 15)
0x7ce: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7cf: Pop(1)
0x7d0: Return(); Pop(2)

0x7d1: Stack[-1] = 0
0x7d2: PushEmpty(object, object)
0x7d3: @ CreateFloatVector(Stack[-1])
0x7d4: Pop(0)
0x7d5: @@ add(Stack[-3]); Obj=1 // @poff=742
0x7d6: Pop(0)
0x7d7: Push((int) 16)
0x7d8: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7d9: Pop(1)
0x7da: Return(); Pop(2)

0x7db: Stack[-1] = 0
0x7dc: PushEmpty(float, float)
0x7dd: @ GetGameTime(Stack[-1])
0x7de: Pop(0)
0x7df: Push((int) 1)
0x7e0: PushEmpty(int)
0x7e1: Push((int) 24)
0x7e2: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x7e3: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x7e4: Return(); Pop(2)

0x7e5: PushEmpty(bool, bool)
0x7e6: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7e7: Pop(0)
0x7e8: Push(Stack[-1])
0x7e9: IF (Stack[-1] == 0) GOTO 0x7ed; Pop(1)

0x7ea: Push("attack") // @poff=300
0x7eb: @ PlayGlobalMusic(Stack[-1])
0x7ec: Pop(1)
0x7ed: Return(); Pop(2)

0x7ee: PushEmpty(object, object)
0x7ef: @ GetScene(Stack[-1])
0x7f0: Pop(0)
0x7f1: Push("battle") // @poff=823
0x7f2: PushEmpty(object)
0x7f3: Call2 0x764

0x7f4: Pop(0)
0x7f5: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x7f6: Pop(2)
0x7f7: Return(); Pop(2)

0x7f8: Stack[-1] = 0
0x7f9: PushEmpty(int, int)
0x7fa: Push("branch") // @poff=837
0x7fb: @ GetVariable(Stack[-1], Stack[-2])
0x7fc: Pop(1)
...
0x802: Pop(0)
0x803: Push((int) 1)
0x804: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x805: IF (Stack[-1] == 0) GOTO 0x809; Pop(1)

0x806: @ WorkWithCorpse(Stack[-1])
0x807: Pop(0)
0x808: GOTO 0x80b

0x809: @ Barter(Stack[-1])
0x80a: Pop(0)
0x80b: Return(); Pop(0)

0x80c: PushEmpty(int, bool, int, bool)
0x80d: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x80e: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x80f: Push("GenerateMoney: iMin > iMax") // @poff=851
0x810: @ Trace(Stack[-1])
0x811: Pop(1)
0x812: Return(); Pop(4)

0x813: Stack[-2] = (int) 0
0x814: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x815: IF (Stack[-1] == 0) GOTO 0x81a; Pop(1)

0x816: Pop(0); Push(Stack[-5] - Stack[-6]);
0x817: @ irand(Stack[-3], Stack[-1])
0x818: Pop(1)
0x819: GOTO 0x81e

0x81a: Push((int) 0)
0x81b: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x81c: IF (Stack[-1] == 0) GOTO 0x81e; Pop(1)

0x81d: Return(); Pop(4)

0x81e: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x81f: Push((int) 0)
...
0x823: PushEmpty(int, string)
0x824: Stack[-1] = "Money" // @poff=905
0x825: Call2 0x87e

0x826: Pop(1)
0x827: Push((int) 0)
0x828: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x829: Pop(2)
0x82a: Return(); Pop(4)

0x82b: PushEmpty(object, int, bool, object, int, bool)
0x82c: @ CreateInvItem(Stack[-3])
0x82d: Pop(0)
0x82e: @@ SetItemName(Stack[-7]); Obj=3 // @poff=917
0x82f: Pop(0)
0x830: Push("Organ") // @poff=929
0x831: Push((int) 1)
0x832: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=602
0x833: Pop(2)
0x834: @@ GetItemID(Stack[-2]); Obj=3 // @poff=941
0x835: Pop(0)
0x836: Push((int) 0)
0x837: Push((int) 1)
0x838: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x839: Pop(2)
0x83a: Return(); Pop(6)
...
0x844: Stack[-1] = "liver" // @poff=951
0x845: Call2 0x82b

0x846: Pop(1)
0x847: PushEmpty(string)
0x848: Stack[-1] = "kidney" // @poff=963
0x849: Call2 0x82b

0x84a: Pop(1)
0x84b: PushEmpty(string)
0x84c: Stack[-1] = "heart" // @poff=977
0x84d: Call2 0x82b

0x84e: Pop(1)
0x84f: PushEmpty(string)
0x850: Stack[-1] = "blood" // @poff=989
0x851: Call2 0x82b

0x852: Pop(1)
0x853: Return(); Pop(0)

0x854: PushEmpty(int, bool, int, bool)
0x855: Push((int) 0)
0x856: @ ClearSubContainer(Stack[-1])
0x857: Pop(1)
0x858: PushEmpty(int, int)
0x859: Stack[-2] = (int) 200
0x85a: Stack[-1] = (int) 500
0x85b: Call2 0x80c

0x85c: Pop(2)
0x85d: PushEmpty(string, int, int)
0x85e: Stack[-3] = "revolver_ammo" // @poff=1001
0x85f: Stack[-2] = (int) 1
0x860: Stack[-1] = (int) 80
0x861: Call2 0x730

0x862: Pop(3)
0x863: PushEmpty(string, int, int)
0x864: Stack[-3] = "samopal_ammo" // @poff=1029
0x865: Stack[-2] = (int) 1
0x866: Stack[-1] = (int) 80
0x867: Call2 0x730

0x868: Pop(3)
0x869: PushEmpty(string, int, int)
0x86a: Stack[-3] = "rifle_ammo" // @poff=1055
0x86b: Stack[-2] = (int) 1
0x86c: Stack[-1] = (int) 80
0x86d: Call2 0x730

0x86e: Pop(3)
0x86f: PushEmpty(string, int, int)
0x870: Stack[-3] = "lockpick" // @poff=1077
0x871: Stack[-2] = (int) 1
0x872: Stack[-1] = (int) 80
0x873: Call2 0x730

0x874: Pop(3)
0x875: PushEmpty(int, string)
0x876: Stack[-1] = "hunter_mark" // @poff=1095
0x877: Call2 0x87e
...
0x87f: @ GetInvItemByName(Stack[-1], Stack[-3])
0x880: Pop(0)
...
0x887: Pop(1)
0x888: IF (Stack[-1] == 0) GOTO 0x8a4; Pop(1)
...
0x890: IF (Stack[-1] == 0) GOTO 0x898; Pop(1)
...
0x893: Pop(0)
0x894: Push((int) 6)
0x895: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x896: IF (Stack[-1] == 0) GOTO 0x898; Pop(1)

0x897: Stack[-1] = (bool) 1
0x898: IF (Stack[-1] == 0) GOTO 0x89f; Pop(1)

0x899: PushEmpty(bool, object, float)
0x89a: Stack[-4] = Stack[-2]
0x89b: Stack[-1] = (float) 0.10000000149011612
0x89c: Call2 0x79e

0x89d: Pop(3)
0x89e: GOTO 0x8a4

0x89f: PushEmpty(bool, object, float)
0x8a0: Stack[-4] = Stack[-2]
0x8a1: Stack[-1] = (float) 0.05000000074505806
0x8a2: Call2 0x79e

0x8a3: Pop(3)
0x8a4: PushEmpty(object)
0x8a5: Stack[-2] = Stack[-1]
0x8a6: Push(-1, 0); TaskCall(0)
0x8a7: Call2 0x0
...
0x8ad: Stack[-7] = Stack[-3]
0x8ae: Stack[-6] = Stack[-2]
...
0x8b5: Stack[-11] = Stack[-5]
0x8b6: Stack[-10] = Stack[-4]
0x8b7: Stack[-9] = Stack[-3]
0x8b8: Stack[-7] = Stack[-2]
0x8b9: Stack[-6] = Stack[-1]
0x8ba: Call2 0x707
...
0x8d0: PushEmpty(string, string)
0x8d1: Stack[-1] = "idle" // @poff=1119
0x8d2: Push(Stack[-3])
0x8d3: IF (Stack[-1] == 0) GOTO 0x8d5; Pop(1)

0x8d4: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x8d5: Stack[-1] = Stack[-4]
0x8d6: Return(); Pop(2)

0x8d7: PushEmpty(int, bool, int, bool)
0x8d8: Stack[-2] = (int) 0
0x8d9: Push("all") // @poff=170
0x8da: PushEmpty(string, int)
0x8db: Stack[-5] = Stack[-1]
0x8dc: Call2 0x8d0

0x8dd: Pop(1)
0x8de: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8df: Pop(2)
0x8e0: Pop(0); Push((bool) Stack[-1] == 0)
0x8e1: IF (Stack[-1] == 0) GOTO 0x8e3; Pop(1)

0x8e2: GOTO 0x8e6

0x8e3: Push((int) 1)
0x8e4: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x8e5: GOTO 0x8d9

0x8e6: Stack[-2] = Stack[-5]
0x8e7: Return(); Pop(4)

0x8e8: Push(GlobalVars[0])
0x8e9: PushEmpty(object)
0x8ea: Call2 0x798

0x8eb: Stack[-1] = Stack[-2]
0x8ec: Pop(1)
0x8ed: GlobalVars[0] = Stack[-1]; Pop(1)
0x8ee: Return(); Pop(0)

0x8ef: PushEmpty(bool, bool, bool, bool)
0x8f0: Push(GlobalVars[0])
0x8f1: @@ in(Stack[-3], Stack[-6]); Obj=1 // @poff=1129
0x8f2: Pop(1)
0x8f3: Push(Stack[-2])
0x8f4: IF (Stack[-1] == 0) GOTO 0x8f7; Pop(1)

0x8f5: Stack[-6] = (bool) 1
0x8f6: Return(); Pop(4)

0x8f7: @ IsPlayerActor(Stack[-5], Stack[-1])
0x8f8: Pop(0)
0x8f9: Stack[-1] = Stack[-6]
0x8fa: Return(); Pop(4)

0x8fb: PushEmpty(cvector, cvector)
0x8fc: PushEmpty(bool, object)
0x8fd: Stack[-5] = Stack[-1]
0x8fe: Call2 0x8ef

0x8ff: Pop(1)
0x900: IF (Stack[-1] == 0) GOTO 0x90f; Pop(1)

0x901: PushEmpty(cvector, object)
0x902: Stack[-5] = Stack[-1]
0x903: Call2 0x5df

0x904: Stack[-2] = Stack[-3]
0x905: Pop(2)
0x906: PushEmpty(float, float)
0x907: Push(CvectorIndex(Stack[-3], 1))
...
0x90b: Pop(1)
0x90c: Push((int) 200)
0x90d: Stack[-6] = Stack[-2] < Stack[-1]; Pop(2);
0x90e: Return(); Pop(2)

0x90f: Stack[-4] = (bool) 0
0x910: Return(); Pop(2)

0x911: PushEmpty()
0x912: PushEmpty(object)
0x913: Stack[-2] = Stack[-1]
0x914: Call2 0x924
...
0x91b: Stack[-2] = Stack[-4]
0x91c: Pop(2)
0x91d: Return(); Pop(0)

0x91e: PushEmpty()
0x91f: PushEmpty(object)
0x920: Stack[-2] = Stack[-1]
0x921: Call2 0x924
...
0x924: PushEmpty()
0x925: PushEmpty(object, bool)
0x926: Stack[-3] = Stack[-2]
0x927: Stack[-1] = (bool) 1
0x928: Push(-2, 7); TaskCall(2)
0x929: Call2 0x1a6

0x92a: Pop(-2, 7); TaskReturn
0x92b: Pop(2)
0x92c: @ ResetAAS()
0x92d: Pop(0)
0x92e: Return(); Pop(0)
...
0x930: Pop(0); PushNull((bool) Stack[-3] == 0)
0x931: IF (Stack[-1] == 0) GOTO 0x933; Pop(1)

0x932: Return(); Pop(2)

0x933: Push(GlobalVars[0])
0x934: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=1129
0x935: Pop(1)
0x936: Pop(0); Push((bool) Stack[-1] == 0)
0x937: IF (Stack[-1] == 0) GOTO 0x93b; Pop(1)

0x938: Push(GlobalVars[0])
0x939: @@ add(Stack[-4]); Obj=1 // @poff=742
0x93a: Pop(1)
0x93b: Return(); Pop(2)

0x93c: PushEmpty()
0x93d: PushEmpty(object)
0x93e: Stack[-2] = Stack[-1]
0x93f: Call2 0x92f

0x940: Pop(1)
0x941: PushEmpty(object, bool)
0x942: Stack[-3] = Stack[-2]
0x943: Stack[-1] = (bool) 1
0x944: Push(-2, 7); TaskCall(2)
0x945: Call2 0x1a6

0x946: Pop(-2, 7); TaskReturn
0x947: Pop(2)
0x948: @ ResetAAS()
0x949: Pop(0)
0x94a: Return(); Pop(0)
