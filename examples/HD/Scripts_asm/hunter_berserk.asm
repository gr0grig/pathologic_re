...
0x6ac: Push((float)0.699999988079071)
0x6ad: Push((int) 500)
...
0x6b7: Pop(0)
0x6b8: @@ add(Stack[-3]); Obj=1 // @poff=756
0x6b9: Pop(0)
0x6ba: Push((int) 16)
...
0x6f2: Push("GenerateMoney: iMin > iMax") // @poff=865
0x6f3: @ Trace(Stack[-1])
0x6f4: Pop(1)
0x6f5: Return(); Pop(4)
...
0x710: Pop(0)
0x711: @@ SetItemName(Stack[-7]); Obj=3 // @poff=931
0x712: Pop(0)
0x713: Push("Organ") // @poff=943
0x714: Push((int) 1)
0x715: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=616
0x716: Pop(2)
0x717: @@ GetItemID(Stack[-2]); Obj=3 // @poff=955
0x718: Pop(0)
0x719: Push((int) 0)
0x71a: Push((int) 1)
...
0x727: Stack[-1] = "liver" // @poff=965
0x728: Call2 0x70e

0x729: Pop(1)
0x72a: PushEmpty(string)
0x72b: Stack[-1] = "kidney" // @poff=977
0x72c: Call2 0x70e

0x72d: Pop(1)
0x72e: PushEmpty(string)
0x72f: Stack[-1] = "heart" // @poff=991
0x730: Call2 0x70e

0x731: Pop(1)
0x732: PushEmpty(string)
0x733: Stack[-1] = "blood" // @poff=1003
0x734: Call2 0x70e
...
0x741: Stack[-3] = "revolver_ammo" // @poff=1015
0x742: Stack[-2] = (int) 1
...
0x747: Stack[-3] = "samopal_ammo" // @poff=1043
0x748: Stack[-2] = (int) 1
...
0x74d: Stack[-3] = "rifle_ammo" // @poff=1069
0x74e: Stack[-2] = (int) 1
...
0x753: Stack[-3] = "lockpick" // @poff=1091
0x754: Stack[-2] = (int) 1
...
0x759: Stack[-1] = "hunter_mark" // @poff=1109
0x75a: Call2 0x761
...
0x77d: Stack[-4] = Stack[-2]
0x77e: Stack[-1] = (float) 0.10000000149011612
0x77f: Call2 0x681
...
0x783: Stack[-4] = Stack[-2]
0x784: Stack[-1] = (float) 0.05000000074505806
0x785: Call2 0x681

0x786: Pop(3)
0x787: PushEmpty(object)
0x788: Stack[-2] = Stack[-1]
