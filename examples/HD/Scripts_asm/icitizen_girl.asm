...
Strings:
	...
	W:ToDie
// @pool_raw:
...
0x179f: Push("Received steal") // @poff=616
...
0x17a7: Stack[-5] = Stack[-1]
0x17a8: Call2 0x172e

0x17a9: Stack[-2] = Stack[-6]
0x17aa: Pop(2)
0x17ab: Return(); Pop(2)
...
0x17bb: Pop(0)
0x17bc: Stack[-1] = Stack[-4]
0x17bd: Return(); Pop(2)

0x17be: PushEmpty()
0x17bf: PushEmpty(object)
0x17c0: Stack[-2] = Stack[-1]
...
0x17ca: Push(Stack[-1])
0x17cb: IF (Stack[-1] == 1) GOTO 0x17d4; Pop(1)
...
0x17d2: IF (Stack[-1] == 1) GOTO 0x17d4; Pop(1)
...
0x17df: Stack[-3] = Stack[-1]
0x17e0: Call2 0x17c6

0x17e1: Stack[-2] = Stack[-4]
0x17e2: Pop(2)
0x17e3: Return(); Pop(0)

0x17e4: PushEmpty()
0x17e5: PushEmpty(object)
0x17e6: Stack[-2] = Stack[-1]
0x17e7: Call2 0x17d5
...
0x17ef: PushEmpty()
0x17f0: Push("d1GhostCatHDPathologic") // @poff=646
0x17f1: Push((int) 1)
0x17f2: @ SetVariable(Stack[-2], Stack[-1])
0x17f3: Pop(2)
0x17f4: PushEmpty(object, string)
0x17f5: Stack[-1] = "quest_ghost_cat" // @poff=692
0x17f6: Call2 0x1661
...
0x17fb: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=724
0x17fc: Pop(1)
0x17fd: Return(); Pop(0)

0x17fe: PushEmpty()
0x17ff: PushEmpty(int, string)
0x1800: Stack[-1] = "branch" // @poff=739
0x1801: Call2 0x165c
...
0x180c: Stack[-1] = "branch" // @poff=739
0x180d: Call2 0x165c
...
0x1928: Push("branch") // @poff=739
0x1929: @ GetVariable(Stack[-1], Stack[-2])
0x192a: Pop(1)
0x192b: Stack[-1] = Stack[-3]
0x192c: Return(); Pop(2)
...
0x194c: Stack[-4] = "meradorm" // @poff=777
...
0x1956: Stack[-3] = "beta_pills" // @poff=795
...
0x195f: Stack[-4] = "monomicin" // @poff=817
...
0x196a: Stack[-3] = "monomicin" // @poff=817
...
0x1971: Stack[-3] = "lockpick" // @poff=837
...
0x1977: Stack[-3] = "rifle_ammo" // @poff=855
...
0x197d: Stack[-3] = "revolver_ammo" // @poff=877
...
0x1983: Stack[-4] = "samopal_ammo" // @poff=905
...
0x198d: Stack[-4] = "monomicin" // @poff=817
...
0x1998: Stack[-3] = "monomicin" // @poff=817
...
0x19a2: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=931
0x19a3: Return(); Pop(0)

0x19a4: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=971
0x19a5: Return(); Pop(0)
...
0x19dc: Stack[-7] = Stack[-3]
0x19dd: Stack[-6] = Stack[-2]
