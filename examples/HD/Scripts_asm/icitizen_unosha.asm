...
0x845: Push((float)0.699999988079071)
0x846: Push((int) 500)
...
0x881: Push("GenerateMoney: iMin > iMax") // @poff=803
0x882: @ Trace(Stack[-1])
0x883: Pop(1)
0x884: Return(); Pop(4)
...
0x89f: Pop(0)
0x8a0: @@ SetItemName(Stack[-7]); Obj=3 // @poff=869
0x8a1: Pop(0)
0x8a2: Push("Organ") // @poff=881
0x8a3: Push((int) 1)
0x8a4: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x8a5: Pop(2)
0x8a6: @@ GetItemID(Stack[-2]); Obj=3 // @poff=893
0x8a7: Pop(0)
0x8a8: Push((int) 0)
0x8a9: Push((int) 1)
...
0x8b6: Stack[-1] = "liver" // @poff=903
0x8b7: Call2 0x89d

0x8b8: Pop(1)
0x8b9: PushEmpty(string)
0x8ba: Stack[-1] = "kidney" // @poff=915
0x8bb: Call2 0x89d

0x8bc: Pop(1)
0x8bd: PushEmpty(string)
0x8be: Stack[-1] = "heart" // @poff=929
0x8bf: Call2 0x89d

0x8c0: Pop(1)
0x8c1: PushEmpty(string)
0x8c2: Stack[-1] = "blood" // @poff=941
0x8c3: Call2 0x89d
...
0x8ff: Stack[-1] = "syringe" // @poff=985
0x900: Call2 0x975
...
0x93d: Stack[-1] = "bracelet" // @poff=1037
0x93e: Call2 0x975
...
0x949: Stack[-1] = "ear_ring" // @poff=1055
0x94a: Call2 0x975
...
0x955: Stack[-1] = "gold_ring" // @poff=1073
0x956: Call2 0x975
...
0x961: Stack[-1] = "silver_ring" // @poff=1093
0x962: Call2 0x975
...
0x96d: Stack[-1] = "flower" // @poff=1117
0x96e: Call2 0x975
...
0x997: Stack[-7] = Stack[-3]
0x998: Stack[-6] = Stack[-2]
0x999: Stack[-5] = Stack[-1]
0x99a: Call2 0x761
...
0x99f: Stack[-11] = Stack[-5]
0x9a0: Stack[-10] = Stack[-4]
0x9a1: Stack[-9] = Stack[-3]
0x9a2: Stack[-7] = Stack[-2]
0x9a3: Stack[-6] = Stack[-1]
0x9a4: Call2 0x7a5
...
0x9a7: PushEmpty()
0x9a8: Push("unholster") // @poff=1131
...
0x9c7: PushEmpty()
0x9c8: Push("unholster") // @poff=1131
...
0x9d0: Push("player_shot") // @poff=1151
...
0x9ef: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1175
0x9f0: Pop(0)
...
0xa4c: Stack[-9] = Stack[-2]
0xa4d: Stack[-1] = "class" // @poff=1217
0xa4e: Call2 0x69f
...
0xa54: Push("class") // @poff=1217
0xa55: @ GetProperty(Stack[-1], Stack[-3])
0xa56: Pop(1)
0xa57: Push("class") // @poff=1217
0xa58: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=582
0xa59: Pop(1)
...
0xa97: Stack[-4] = Stack[-1]
0xa98: Call2 0xa38

0xa99: Stack[-2] = Stack[-5]
0xa9a: Pop(2)
0xa9b: Return(); Pop(0)
...
0xab0: Push(Stack[-2])
0xab1: IF (Stack[-1] == 1) GOTO 0xaba; Pop(1)

0xab2: PushEmpty(float, object)
0xab3: Stack[-9] = Stack[-1]
0xab4: Call2 0x692
...
0xaca: Push("Received steal") // @poff=1339
0xacb: @ Trace(Stack[-1])
0xacc: Pop(1)
...
0xaed: Push(Stack[-1])
0xaee: IF (Stack[-1] == 1) GOTO 0xaf7; Pop(1)
...
0xaf5: IF (Stack[-1] == 1) GOTO 0xaf7; Pop(1)
...
0xb25: Stack[-3] = (int) 0
0xb26: Push("all") // @poff=170
0xb27: PushEmpty(string, int)
0xb28: Stack[-6] = Stack[-1]
0xb29: Call2 0xb08
...
0xb46: Stack[-8] = Stack[-4]
0xb47: Stack[-7] = Stack[-3]
0xb48: Stack[-2] = (float) 500.0
0xb49: Stack[-6] = Stack[-1]
0xb4a: Call2 0xaa2

0xb4b: Stack[-5] = Stack[-9]
0xb4c: Pop(5)
0xb4d: Return(); Pop(0)

0xb4e: PushEmpty()
0xb4f: PushEmpty(bool, object)
0xb50: Stack[-3] = Stack[-1]
0xb51: Call2 0x69a
...
0xb56: Pop(0)
0xb57: Push((float)-0.07000000029802322)
0xb58: Push((bool) 1)
