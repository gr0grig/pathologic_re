...
Strings:
	...
	W:player
	W:idle
// @pool_raw:
...
0x664: Stack[-2] = "bullet" // @poff=496
0x665: Return(); Pop(0)

0x666: Stack[-2] = "phys" // @poff=510
0x667: Return(); Pop(0)

0x668: PushEmpty(cvector, cvector, cvector, cvector)
0x669: @ GetPosition(Stack[-2])
0x66a: Pop(0)
0x66b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x66c: Pop(0)
...
0x675: Push("HasProperty") // @poff=520
0x676: Push((int) 2)
...
0x67c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x67d: Pop(0)
...
0x682: Stack[-18] = Stack[-2]
0x683: Stack[-1] = "health" // @poff=556
0x684: Call2 0x674
...
0x68b: Stack[-18] = Stack[-2]
0x68c: Stack[-1] = "armor" // @poff=570
0x68d: Call2 0x674
...
0x693: Push("armor") // @poff=570
0x694: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x695: Pop(1)
0x696: Push("armor_") // @poff=594
0x697: PushEmpty(string, int)
0x698: Stack[-16] = Stack[-1]
0x699: Call2 0x65a

0x69a: Pop(1)
0x69b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x69c: PushEmpty(bool, object, string)
0x69d: Stack[-18] = Stack[-2]
0x69e: Stack[-8] = Stack[-1]
0x69f: Call2 0x674
...
0x6a5: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x6a6: Pop(0)
...
0x6ad: Stack[-3] = Stack[-6]
0x6ae: Pop(3)
0x6af: Push("health") // @poff=556
0x6b0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x6b1: Pop(1)
0x6b2: Push((int) 1)
0x6b3: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6b4: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6b5: Push("health") // @poff=556
...
0x6bb: Pop(3)
0x6bc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x6bd: Pop(2)
0x6be: PushEmpty(bool, object)
0x6bf: Stack[-17] = Stack[-1]
0x6c0: Call2 0x66f
...
0x6c6: Pop(1)
0x6c7: Stack[-1] = Stack[-16]
0x6c8: Return(); Pop(12)

0x6c9: PushEmpty(bool, bool)
0x6ca: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x6cb: Pop(0)
0x6cc: Stack[-1] = Stack[-4]
0x6cd: Return(); Pop(2)

0x6ce: PushEmpty(object, object, object, object)
0x6cf: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6e3: Pop(0)
0x6e4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6e5: IF (Stack[-1] == 0) GOTO 0x6e8; Pop(1)

0x6e6: Stack[-6] = (bool) 0
0x6e7: Return(); Pop(4)

0x6e8: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x6e9: Pop(0)
...
0x6fd: Stack[-1] = "noaccess" // @poff=650
0x6fe: Call2 0x674
...
0x704: Push("noaccess") // @poff=650
0x705: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x706: Pop(1)
0x707: Push((int) 0)
...
0x70b: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x719: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x71a: Pop(0)
...
0x72a: Stack[-1] = "fhit" // @poff=668
0x72b: GOTO 0x72d

0x72c: Stack[-1] = "bhit" // @poff=678
0x72d: Push("hit_react") // @poff=688
0x72e: Push("1") // @poff=708
0x72f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x730: Push("2") // @poff=712
...
0x74e: Stack[-2] = Stack[-11]
0x74f: Pop(2)
0x750: @ CreateVectorVector(Stack[-8])
0x751: Pop(0)
0x752: Stack[-7] = (int) 1
0x753: Push("hit") // @poff=670
...
0x768: Pop(0)
0x769: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x76a: Pop(0)
0x76b: PushEmpty(object, int, float, cvector, cvector)
0x76c: Stack[-26] = Stack[-5]
0x76d: Stack[-25] = Stack[-4]
0x76e: Stack[-24] = Stack[-3]
0x76f: Stack[-6] = Stack[-2]
...
0x789: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x78a: Pop(0)
...
0x7b0: Stack[-10] = Stack[-2]
0x7b1: Stack[-9] = Stack[-1]
0x7b2: Call2 0x808
...
0x7ef: Push((float)9.999999974752427e-07)
...
0x833: Push("branch") // @poff=789
0x834: @ GetVariable(Stack[-1], Stack[-2])
0x835: Pop(1)
0x836: Stack[-1] = Stack[-3]
0x837: Return(); Pop(2)
...
0x847: Pop(0)
0x848: @@ SetItemName(Stack[-7]); Obj=3 // @poff=803
0x849: Pop(0)
0x84a: Push("Organ") // @poff=815
0x84b: Push((int) 1)
0x84c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x84d: Pop(2)
0x84e: @@ GetItemID(Stack[-2]); Obj=3 // @poff=827
0x84f: Pop(0)
0x850: Push((int) 0)
0x851: Push((int) 1)
...
0x85e: Stack[-1] = "liver" // @poff=837
0x85f: Call2 0x845

0x860: Pop(1)
0x861: PushEmpty(string)
0x862: Stack[-1] = "kidney" // @poff=849
0x863: Call2 0x845

0x864: Pop(1)
0x865: PushEmpty(string)
0x866: Stack[-1] = "heart" // @poff=863
0x867: Call2 0x845

0x868: Pop(1)
0x869: PushEmpty(string)
0x86a: Stack[-1] = "blood" // @poff=875
0x86b: Call2 0x845
...
0x882: Push(-1, 0); TaskCall(0)
0x883: Call2 0x0

0x884: Pop(-1, 0); TaskReturn
0x885: Pop(1)
0x886: Return(); Pop(0)

0x887: PushEmpty(float, float)
0x888: Push("health") // @poff=556
...
0x89c: Stack[-7] = Stack[-3]
0x89d: Stack[-6] = Stack[-2]
...
0x8a4: Stack[-11] = Stack[-5]
0x8a5: Stack[-10] = Stack[-4]
0x8a6: Stack[-9] = Stack[-3]
0x8a7: Stack[-7] = Stack[-2]
0x8a8: Stack[-6] = Stack[-1]
0x8a9: Call2 0x77a
...
0x8f4: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=955
0x8f5: Pop(0)
...
0x951: Push(-1, 6); TaskCall(2)
0x952: Call2 0x196

0x953: Pop(-1, 6); TaskReturn
0x954: Pop(1)
0x955: Return(); Pop(0)
...
0x987: Pop(0)
0x988: Pop(0); Push((bool) Stack[-1] == 0)
...
0x992: GlobalVars[0] = Stack[-1]; Pop(1)
0x993: Return(); Pop(0)
...
0x99f: Pop(0)
0x9a0: Push((float)-0.07000000029802322)
0x9a1: Push((bool) 1)
...
0x9ac: GlobalVars[0] = Stack[-1]; Pop(1)
0x9ad: Push((int) 50)
0x9ae: Push((int) 40)
