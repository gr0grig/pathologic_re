...
Strings:
	...
	W:butcher
	W:morlok
// @pool_raw:
...
Events:
EVENT_16 Op = 0x88a Vars = (object, string)
EVENT_41 Op = 0x897 Vars = (object)
EVENT_22 Op = 0x89d Vars = (object, int, float, float)
EVENT_43 Op = 0x8a5 Vars = (object, int, float, float, cvector, cvector)
...
0xca: Stack[-9] = Stack[-3]
0xcb: Stack[-8] = Stack[-2]
0xcc: Stack[-7] = Stack[-1]
0xcd: Call2 0x99f
...
0xd1: Stack[-8] = Stack[-2]
0xd2: Stack[-6] = Stack[-1]
0xd3: Call2 0x959

0xd4: Stack[-3] = Stack[-4]
0xd5: Pop(3)
0xd6: Push((int) 0)
...
0xfa: Stack[-7] = Stack[-2]
0xfb: Stack[-6] = Stack[-1]
0xfc: Call2 0x8af
...
0x103: Stack[-6] = Stack[-2]
0x104: Stack[-5] = Stack[-1]
0x105: Call2 0x8cf
...
0x109: Stack[-6] = Stack[-2]
0x10a: Stack[-7] = Stack[-1]
0x10b: Call2 0x96b

0x10c: Stack[-3] = Stack[-4]
0x10d: Pop(3)
0x10e: Push((int) 0)
...
0x118: Stack[-5] = Stack[-2]
0x119: Stack[-6] = Stack[-1]
0x11a: Call2 0x96e
...
0x162: Pop(0)
0x163: Push("all") // @poff=170
0x164: PushEmpty(string, int)
0x165: Stack[-7] = Stack[-1]
0x166: Call2 0x92f
...
0x19e: PushEmpty()
0x19f: Stack[-3] = (float) 0.05000000074505806
0x1a0: Return(); Pop(0)
...
0x1b9: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1ba: Pop(0)
0x1bb: Push(Stack[-8])
0x1bc: IF (Stack[-1] == 0) GOTO 0x1c5; Pop(1)

0x1bd: Push("attack") // @poff=234
...
0x1d9: Pop(0)
0x1da: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x1db: Pop(0)
...
0x1f5: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=248
0x1f6: Pop(0)
...
0x20f: Pop(1)
0x210: Push("all") // @poff=170
0x211: Push("attack_on") // @poff=262
...
0x229: IF (Stack[-1] == 1) GOTO 0x22f; Pop(1)

0x22a: PushEmpty(bool)
0x22b: Call2 0x3fb

0x22c: Pop(0)
0x22d: IF (Stack[-1] == 1) GOTO 0x22f; Pop(1)

0x22e: Stack[-1] = (bool) 0
0x22f: IF (Stack[-1] == 0) GOTO 0x240; Pop(1)

0x230: @ Face(Stack[-0]T)
0x231: Pop(0)
0x232: PushEmpty()
0x233: Call2 0x42d

0x234: Pop(0)
0x235: Push("all") // @poff=170
0x236: Push("attack_stay") // @poff=282
0x237: @ PlayAnimation(Stack[-2], Stack[-1])
0x238: Pop(2)
0x239: PushEmpty(bool, float)
0x23a: Stack[-25] = Stack[-1]
0x23b: Call2 0x377
...
0x240: @ Face(Stack[-0]T)
0x241: Pop(0)
0x242: Push("all") // @poff=170
0x243: Push("fjump") // @poff=306
...
0x25e: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x25f: Pop(0)
...
0x27d: Push("all") // @poff=170
0x27e: Push("attack_off") // @poff=318
...
0x28b: Push("all") // @poff=170
0x28c: Push("attack_begin") // @poff=340
0x28d: Push((int) 1)
0x28e: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x299: Push("attack") // @poff=234
0x29a: Push((int) 1)
0x29b: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2a5: Push("all") // @poff=170
0x2a6: Push("bjump") // @poff=366
...
0x2ad: Push((float)0.8999999761581421)
0x2ae: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2af: @ GetVictim(Stack[-1], Stack[-4])
0x2b0: Pop(1)
0x2b1: @ ReportAttack(Stack[-0]T)
0x2b2: Pop(0)
...
0x2b7: Stack[-10] = Stack[-1]
0x2b8: Call2 0x19e

0x2b9: Stack[-3] = Stack[-5]
0x2ba: Pop(3)
0x2bb: PushEmpty(float, object, float, int)
0x2bc: Stack[-7] = Stack[-3]
0x2bd: Stack[-6] = Stack[-2]
0x2be: PushEmpty(int, object, int)
0x2bf: Stack[-10] = Stack[-2]
0x2c0: Stack[-14] = Stack[-1]
0x2c1: Call2 0x1a1

0x2c2: Stack[-3] = Stack[-4]
0x2c3: Pop(3)
0x2c4: Call2 0x683

0x2c5: Stack[-4] = Stack[-5]
0x2c6: Pop(4)
0x2c7: PushEmpty(int)
0x2c8: Call2 0x42b

0x2c9: Pop(0)
0x2ca: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2cb: Pop(1)
0x2cc: PushEmpty(object, float)
0x2cd: Stack[-5] = Stack[-2]
0x2ce: Stack[-3] = Stack[-1]
0x2cf: Call2 0x432
...
0x2d6: Pop(0)
0x2d7: @ irand(Stack[-4], Stack[-1]T)
0x2d8: Pop(0)
0x2d9: Push((int) 1)
0x2da: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x2db: @ Face(Stack[-0]T)
0x2dc: Pop(0)
0x2dd: Push((bool) 1)
...
0x2e4: Push("attack_begin") // @poff=340
...
0x2f8: Stack[-11] = Stack[-2]
0x2f9: Stack[-6] = Stack[-1]
0x2fa: Call2 0x2ac

0x2fb: Pop(2)
0x2fc: Push("all") // @poff=170
0x2fd: Push("attack_middle") // @poff=378
...
0x305: Pop(0)
0x306: Push("all") // @poff=170
0x307: Push("attack_middle") // @poff=378
...
0x31b: Stack[-11] = Stack[-2]
0x31c: Stack[-6] = Stack[-1]
0x31d: Call2 0x2ac

0x31e: Pop(2)
0x31f: Stack[-2] = (int) 1
0x320: Push("attack_middle") // @poff=378
0x321: Pop(1); Push(Stack[-1] + Stack[-5]);
0x322: Push("_") // @poff=406
0x323: Pop(2); Push(Stack[-2] + Stack[-1]);
0x324: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x325: Push("all") // @poff=170
...
0x341: Stack[-11] = Stack[-2]
0x342: Stack[-6] = Stack[-1]
0x343: Call2 0x2ac
...
0x34a: Pop(1)
0x34b: Push("all") // @poff=170
0x34c: Push("attack_end") // @poff=410
...
0x38b: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=248
0x38c: Pop(0)
...
0x3d7: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x3d8: Pop(1)
...
0x3dc: @ Face(Stack[-0]T)
0x3dd: Pop(0)
0x3de: Push("all") // @poff=170
0x3df: Push("bjump") // @poff=366
0x3e0: @ PlayAnimation(Stack[-2], Stack[-1])
0x3e1: Pop(2)
0x3e2: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=248
0x3e3: Pop(0)
...
0x419: @ irand(Stack[-1], Stack[-2]T)
0x41a: Pop(0)
0x41b: Push((int) 1)
0x41c: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x41d: Push("attack") // @poff=234
...
0x42e: Stack[-1] = "attack_stay" // @poff=282
0x42f: Call2 0x7c0
...
0x460: Stack[-15] = Stack[-5]
0x461: Stack[-14] = Stack[-4]
0x462: Stack[-13] = Stack[-3]
0x463: Stack[-12] = Stack[-2]
0x464: Stack[-11] = Stack[-1]
0x465: Call2 0x4aa

0x466: Stack[-6] = Stack[-7]
0x467: Pop(6)
0x468: Push( Stack[2 + Tasks[-1].StackPointer] )
0x469: IF (Stack[-1] == 0) GOTO 0x46d; Pop(1)

0x46a: Push("head") // @poff=160
...
0x4ad: Stack[-17] = Stack[-7]
0x4ae: PushEmpty(bool, object)
0x4af: Stack[-23] = Stack[-1]
0x4b0: Call2 0x536
...
0x4b6: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x4b7: Pop(0)
...
0x4cd: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=248
0x4ce: Pop(0)
...
0x4df: Push((int) 0)
0x4e0: Push((float)0.30000001192092896)
...
0x502: Push((int) 0)
0x503: Push((float)0.30000001192092896)
...
0x53a: Stack[-2] = Stack[-4]
0x53b: Pop(2)
0x53c: Return(); Pop(0)

0x53d: Stack[-1] = "walk" // @poff=468
0x53e: Return(); Pop(0)

0x53f: Stack[-1] = "run" // @poff=478
0x540: Return(); Pop(0)
...
0x564: Stack[-5] = Stack[-1]
0x565: Call2 0x970

0x566: Stack[-2] = Stack[-3]
0x567: Pop(2)
0x568: Push((int) 0)
...
0x578: Stack[-4] = Stack[-1]
0x579: Call2 0x905

0x57a: Pop(1)
0x57b: PushEmpty(int, object)
0x57c: Stack[-5] = Stack[-1]
0x57d: Call2 0x947

0x57e: Stack[-2] = Stack[-3]
0x57f: Pop(2)
0x580: Push((int) 0)
...
0x590: Stack[-9] = Stack[-3]
0x591: Stack[-8] = Stack[-2]
0x592: Stack[-7] = Stack[-1]
0x593: Call2 0x99f
...
0x597: Stack[-8] = Stack[-2]
0x598: Stack[-6] = Stack[-1]
0x599: Call2 0x959

0x59a: Stack[-3] = Stack[-4]
0x59b: Pop(3)
0x59c: Push((int) 0)
...
0x5c0: Stack[-7] = Stack[-2]
0x5c1: Stack[-6] = Stack[-1]
0x5c2: Call2 0x8af
...
0x667: Stack[-2] = "bullet" // @poff=496
0x668: Return(); Pop(0)

0x669: Stack[-2] = "phys" // @poff=510
0x66a: Return(); Pop(0)

0x66b: PushEmpty(cvector, cvector, cvector, cvector)
0x66c: @ GetPosition(Stack[-2])
0x66d: Pop(0)
0x66e: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x66f: Pop(0)
...
0x678: Push("HasProperty") // @poff=520
0x679: Push((int) 2)
...
0x67f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x680: Pop(0)
...
0x685: Stack[-18] = Stack[-2]
0x686: Stack[-1] = "health" // @poff=556
0x687: Call2 0x677
...
0x68e: Stack[-18] = Stack[-2]
0x68f: Stack[-1] = "armor" // @poff=570
0x690: Call2 0x677
...
0x696: Push("armor") // @poff=570
0x697: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x698: Pop(1)
0x699: Push("armor_") // @poff=594
0x69a: PushEmpty(string, int)
0x69b: Stack[-16] = Stack[-1]
0x69c: Call2 0x65d
...
0x6a8: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x6a9: Pop(0)
...
0x6b0: Stack[-3] = Stack[-6]
0x6b1: Pop(3)
0x6b2: Push("health") // @poff=556
0x6b3: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x6b4: Pop(1)
0x6b5: Push((int) 1)
0x6b6: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6b7: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6b8: Push("health") // @poff=556
...
0x6be: Pop(3)
0x6bf: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x6c0: Pop(2)
0x6c1: PushEmpty(bool, object)
0x6c2: Stack[-17] = Stack[-1]
0x6c3: Call2 0x672
...
0x6c9: Pop(1)
0x6ca: Stack[-1] = Stack[-16]
0x6cb: Return(); Pop(12)

0x6cc: PushEmpty(bool, bool)
0x6cd: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x6ce: Pop(0)
0x6cf: Stack[-1] = Stack[-4]
0x6d0: Return(); Pop(2)

0x6d1: PushEmpty(object, object, object, object)
0x6d2: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6e6: Pop(0)
0x6e7: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6e8: IF (Stack[-1] == 0) GOTO 0x6eb; Pop(1)

0x6e9: Stack[-6] = (bool) 0
0x6ea: Return(); Pop(4)

0x6eb: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x6ec: Pop(0)
...
0x6ff: Stack[-6] = Stack[-2]
0x700: Stack[-1] = "noaccess" // @poff=650
0x701: Call2 0x677
...
0x707: Push("noaccess") // @poff=650
0x708: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x709: Pop(1)
0x70a: Push((int) 0)
...
0x70e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x71c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x71d: Pop(0)
...
0x72d: Stack[-1] = "fhit" // @poff=668
0x72e: GOTO 0x730

0x72f: Stack[-1] = "bhit" // @poff=678
0x730: Push("hit_react") // @poff=688
0x731: Push("1") // @poff=708
0x732: Pop(1); Push(Stack[-3] + Stack[-1]);
0x733: Push("2") // @poff=712
...
0x74c: Stack[-25] = Stack[-1]
0x74d: Call2 0x66b

0x74e: Stack[-2] = Stack[-3]
0x74f: Pop(2)
0x750: Call2 0x7ef

0x751: Stack[-2] = Stack[-11]
0x752: Pop(2)
0x753: @ CreateVectorVector(Stack[-8])
0x754: Pop(0)
0x755: Stack[-7] = (int) 1
0x756: Push("hit") // @poff=670
...
0x76b: Pop(0)
0x76c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x76d: Pop(0)
0x76e: PushEmpty(object, int, float, cvector, cvector)
0x76f: Stack[-26] = Stack[-5]
0x770: Stack[-25] = Stack[-4]
0x771: Stack[-24] = Stack[-3]
0x772: Stack[-6] = Stack[-2]
...
0x78c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x78d: Pop(0)
...
0x798: Pop(0)
0x799: Stack[-1] = Stack[-3]
0x79a: Return(); Pop(2)

0x79b: PushEmpty(float, cvector, float, cvector)
0x79c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x79d: Pop(0)
...
0x7f2: Push((float)9.999999974752427e-07)
...
0x812: Pop(0)
0x813: @@ add(Stack[-3]); Obj=1 // @poff=716
0x814: Pop(0)
0x815: Push((int) 0)
0x816: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x817: IF (Stack[-1] == 0) GOTO 0x81c; Pop(1)

0x818: Push((float)0.699999988079071)
0x819: Push((int) 500)
0x81a: @ RumblePlay(Stack[-2], Stack[-1])
0x81b: Pop(2)
0x81c: Push((int) 15)
0x81d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x81e: Pop(1)
0x81f: Return(); Pop(2)

0x820: Stack[-1] = 0
0x821: PushEmpty(bool, bool)
0x822: @ IsPlayerActor(Stack[-3], Stack[-1])
0x823: Pop(0)
0x824: Push(Stack[-1])
0x825: IF (Stack[-1] == 0) GOTO 0x829; Pop(1)

0x826: Push("attack") // @poff=234
0x827: @ PlayGlobalMusic(Stack[-1])
0x828: Pop(1)
0x829: Return(); Pop(2)

0x82a: PushEmpty(object, object)
0x82b: @ GetScene(Stack[-1])
0x82c: Pop(0)
0x82d: Push("battle") // @poff=775
0x82e: PushEmpty(object)
0x82f: Call2 0x7e9

0x830: Pop(0)
0x831: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x832: Pop(2)
0x833: Return(); Pop(2)

0x834: Stack[-1] = 0
0x835: PushEmpty(int, int)
0x836: Push("branch") // @poff=789
0x837: @ GetVariable(Stack[-1], Stack[-2])
0x838: Pop(1)
0x839: Stack[-1] = Stack[-3]
0x83a: Return(); Pop(2)
...
0x83e: Pop(0)
0x83f: Push((int) 1)
0x840: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x841: IF (Stack[-1] == 0) GOTO 0x845; Pop(1)

0x842: @ WorkWithCorpse(Stack[-1])
0x843: Pop(0)
0x844: GOTO 0x847

0x845: @ Barter(Stack[-1])
0x846: Pop(0)
0x847: Return(); Pop(0)

0x848: PushEmpty(object, int, bool, object, int, bool)
0x849: @ CreateInvItem(Stack[-3])
0x84a: Pop(0)
0x84b: @@ SetItemName(Stack[-7]); Obj=3 // @poff=803
0x84c: Pop(0)
0x84d: Push("Organ") // @poff=815
0x84e: Push((int) 1)
0x84f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x850: Pop(2)
0x851: @@ GetItemID(Stack[-2]); Obj=3 // @poff=827
0x852: Pop(0)
0x853: Push((int) 0)
0x854: Push((int) 1)
0x855: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x856: Pop(2)
0x857: Return(); Pop(6)
...
0x85b: Pop(0)
0x85c: Push((int) 1)
0x85d: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x85e: IF (Stack[-1] == 0) GOTO 0x860; Pop(1)

0x85f: Return(); Pop(0)

0x860: PushEmpty(string)
0x861: Stack[-1] = "liver" // @poff=837
0x862: Call2 0x848

0x863: Pop(1)
0x864: PushEmpty(string)
0x865: Stack[-1] = "kidney" // @poff=849
0x866: Call2 0x848

0x867: Pop(1)
0x868: PushEmpty(string)
0x869: Stack[-1] = "heart" // @poff=863
0x86a: Call2 0x848

0x86b: Pop(1)
0x86c: PushEmpty(string)
0x86d: Stack[-1] = "blood" // @poff=875
0x86e: Call2 0x848
...
0x871: Push((int) 0)
0x872: @ ClearSubContainer(Stack[-1])
0x873: Pop(1)
0x874: PushEmpty(string, int, int, int)
0x875: Stack[-4] = "rusk" // @poff=887
0x876: Stack[-3] = (int) 1
0x877: Stack[-2] = (int) 1
0x878: Stack[-1] = (int) 2
0x879: Call2 0x7b1
...
0x884: Stack[-2] = Stack[-1]
0x885: Push(-1, 0); TaskCall(0)
0x886: Call2 0x0

0x887: Pop(-1, 0); TaskReturn
0x888: Pop(1)
0x889: Return(); Pop(0)

0x88a: PushEmpty(float, float)
0x88b: Push("health") // @poff=556
0x88c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x88d: IF (Stack[-1] == 0) GOTO 0x896; Pop(1)

0x88e: Push("health") // @poff=556
0x88f: @ GetProperty(Stack[-1], Stack[-2])
0x890: Pop(1)
0x891: Push((int) 0)
0x892: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x893: IF (Stack[-1] == 0) GOTO 0x896; Pop(1)

0x894: @ SignalDeath(Stack[-4])
0x895: Pop(0)
0x896: Return(); Pop(2)
...
0x89d: PushEmpty()
0x89e: PushEmpty(object, int, float)
0x89f: Stack[-7] = Stack[-3]
0x8a0: Stack[-6] = Stack[-2]
...
0x8a5: PushEmpty()
0x8a6: PushEmpty(object, int, float, cvector, cvector)
0x8a7: Stack[-11] = Stack[-5]
0x8a8: Stack[-10] = Stack[-4]
0x8a9: Stack[-9] = Stack[-3]
0x8aa: Stack[-7] = Stack[-2]
0x8ab: Stack[-6] = Stack[-1]
0x8ac: Call2 0x77d
...
0x8f5: Stack[-1] = (bool) 1
0x8f6: IF (Stack[-1] == 0) GOTO 0x8fd; Pop(1)

0x8f7: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=955
0x8f8: Pop(0)
0x8f9: Pop(0); Push((bool) Stack[-1] == 0)
0x8fa: IF (Stack[-1] == 0) GOTO 0x8fd; Pop(1)

0x8fb: Stack[-4] = (bool) 1
0x8fc: Return(); Pop(2)

0x8fd: Stack[-4] = (bool) 0
0x8fe: Return(); Pop(2)
...
0x90d: Pop(0)
0x90e: Push((float)-0.029999999329447746)
0x90f: @ ReportReputationChange(Stack[-3], Stack[-2], Stack[-1])
0x910: Pop(2)
0x911: Return(); Pop(0)

0x912: PushEmpty(object, object)
0x913: Push("heal") // @poff=973
0x914: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x915: IF (Stack[-1] == 0) GOTO 0x920; Pop(1)

0x916: Push("player") // @poff=983
0x917: @ FindActor(Stack[-2], Stack[-1])
0x918: Pop(1)
0x919: PushEmpty(bool, object)
0x91a: Stack[-3] = Stack[-1]
0x91b: Call2 0x989

0x91c: Stack[-2] = Stack[-6]
0x91d: Pop(2)
0x91e: Return(); Pop(2)

0x91f: Stack[-1] = 0
0x920: Stack[-4] = (bool) 0
0x921: Return(); Pop(2)

0x922: PushEmpty(object, object)
0x923: Push("heal") // @poff=973
0x924: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x925: IF (Stack[-1] == 0) GOTO 0x92e; Pop(1)

0x926: Push("player") // @poff=983
0x927: @ FindActor(Stack[-2], Stack[-1])
0x928: Pop(1)
...
0x92f: PushEmpty(string, string)
0x930: Stack[-1] = "idle" // @poff=997
0x931: Push(Stack[-3])
0x932: IF (Stack[-1] == 0) GOTO 0x934; Pop(1)

0x933: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x934: Stack[-1] = Stack[-4]
0x935: Return(); Pop(2)

0x936: PushEmpty(int, bool, int, bool)
0x937: Stack[-2] = (int) 0
0x938: Push("all") // @poff=170
0x939: PushEmpty(string, int)
0x93a: Stack[-5] = Stack[-1]
0x93b: Call2 0x92f

0x93c: Pop(1)
0x93d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x93e: Pop(2)
0x93f: Pop(0); Push((bool) Stack[-1] == 0)
0x940: IF (Stack[-1] == 0) GOTO 0x942; Pop(1)

0x941: GOTO 0x945

0x942: Push((int) 1)
0x943: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x944: GOTO 0x938

0x945: Stack[-2] = Stack[-5]
0x946: Return(); Pop(4)

0x947: PushEmpty()
0x948: PushEmpty(bool, object)
0x949: Stack[-3] = Stack[-1]
0x94a: Call2 0x6f5
...
0x954: Push(-1, 6); TaskCall(2)
0x955: Call2 0x196

0x956: Pop(-1, 6); TaskReturn
0x957: Pop(1)
0x958: Return(); Pop(0)

0x959: PushEmpty()
0x95a: PushEmpty(int, object)
0x95b: Stack[-4] = Stack[-1]
0x95c: Call2 0x947

0x95d: Stack[-2] = Stack[-5]
0x95e: Pop(2)
0x95f: Return(); Pop(0)

0x960: PushEmpty()
0x961: PushEmpty(object)
0x962: Stack[-2] = Stack[-1]
0x963: Call2 0x951
...
0x989: PushEmpty()
0x98a: Stack[-2] = (bool) 0
0x98b: Return(); Pop(0)

0x98c: PushEmpty()
0x98d: Return(); Pop(0)

0x98e: PushEmpty(bool, bool)
0x98f: Push(GlobalVars[0])
0x990: IF (Stack[-1] == 0) GOTO 0x99a; Pop(1)

0x991: @ IsOverrideActive(Stack[-1])
0x992: Pop(0)
0x993: Pop(0); Push((bool) Stack[-1] == 0)
...
0x99b: Push(GlobalVars[0])
0x99c: Stack[-1] = (bool) 0
0x99d: GlobalVars[0] = Stack[-1]; Pop(1)
0x99e: Return(); Pop(0)

0x99f: PushEmpty(string, string)
0x9a0: PushEmpty(bool, object, string)
0x9a1: Stack[-7] = Stack[-2]
0x9a2: Stack[-1] = "class" // @poff=1007
0x9a3: Call2 0x677

0x9a4: Pop(2)
0x9a5: Pop(1); Push((bool) Stack[-1] == 0)
0x9a6: IF (Stack[-1] == 0) GOTO 0x9a9; Pop(1)

0x9a7: Stack[-6] = (bool) 0
0x9a8: Return(); Pop(2)

0x9a9: Push("class") // @poff=1007
0x9aa: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=582
0x9ab: Pop(1)
0x9ac: Stack[-6] = (bool) 1
0x9ad: Push("butcher") // @poff=1019
0x9ae: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9af: IF (Stack[-1] == 1) GOTO 0x9b4; Pop(1)

0x9b0: Push("morlok") // @poff=1035
0x9b1: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x9b2: IF (Stack[-1] == 1) GOTO 0x9b4; Pop(1)

0x9b3: Stack[-6] = (bool) 0
0x9b4: Return(); Pop(2)
...
0x9bd: Pop(0)
0x9be: Push((float)-0.07000000029802322)
0x9bf: Push((bool) 1)
0x9c0: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x9c1: Pop(3)
0x9c2: PushEmpty()
0x9c3: Call2 0x871
...
0x9ca: GlobalVars[0] = Stack[-1]; Pop(1)
0x9cb: Push((int) 50)
0x9cc: Push((int) 40)
