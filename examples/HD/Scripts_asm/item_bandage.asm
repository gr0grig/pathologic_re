...
Strings:
	W:health
	A:add
// @pool_raw:6800650061006c0074006800000061646400
...
0x6: Pop(5)
0x7: PushEmpty(float)
0x8: Stack[-1] = (float) 0.20000000298023224
0x9: Call2 0x2a
...
0x17: Stack[-10] = Stack[-2]
0x18: Stack[-9] = Stack[-1]
0x19: Call2 0x1f
...
0x28: Stack[-3] = Stack[-4]
0x29: Return(); Pop(0)

0x2a: PushEmpty(object, object)
0x2b: @ CreateFloatVector(Stack[-1])
0x2c: Pop(0)
0x2d: @@ add(Stack[-3]); Obj=1 // @poff=14
0x2e: Pop(0)
0x2f: Push((int) 0)
0x30: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x31: IF (Stack[-1] == 0) GOTO 0x36; Pop(1)

0x32: Push((float)0.699999988079071)
0x33: Push((int) 500)
0x34: @ RumblePlay(Stack[-2], Stack[-1])
0x35: Pop(2)
0x36: Push((int) 15)
0x37: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x38: Pop(1)
0x39: Return(); Pop(2)
