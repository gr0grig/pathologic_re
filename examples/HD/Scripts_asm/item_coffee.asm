...
Strings:
	...
	W:tiredness
	A:add
// @pool_raw:6400720069006e006b0000006800650061006c0074006800000069006d006d0075006e00690074007900000064006900730065006100730065000000680075006e006700650072000000740069007200650064006e00650073007300000061646400
...
0x0: Push("drink") // @poff=0
0x1: @ PlaySound(Stack[-1])
0x2: Pop(1)
0x3: PushEmpty(bool, string, float, float, float)
0x4: Stack[-4] = "health" // @poff=12
0x5: Stack[-3] = (float) -0.05000000074505806
0x6: Stack[-2] = (int) 0
0x7: Stack[-1] = (int) 1
0x8: Call2 0x3b
...
0x9: Pop(5)
0xa: PushEmpty(float)
0xb: Stack[-1] = (float) -0.05000000074505806
0xc: Call2 0x81

0xd: Pop(1)
0xe: PushEmpty(bool, string, float, float, float)
0xf: Stack[-4] = "immunity" // @poff=26
...
0x16: Stack[-1] = (float) 0.0
0x17: Call2 0x6d

0x18: Pop(1)
0x19: PushEmpty(bool, string, float, float, float)
0x1a: Stack[-4] = "disease" // @poff=44
...
0x25: Stack[-4] = "hunger" // @poff=60
0x26: Stack[-3] = (float) 0.0
0x27: Stack[-2] = (int) 0
0x28: Stack[-1] = (int) 1
0x29: Call2 0x3b
...
0x2c: Stack[-1] = (float) 0.0
0x2d: Call2 0x63

0x2e: Pop(1)
0x2f: PushEmpty(bool, string, float, float, float)
0x30: Stack[-4] = "tiredness" // @poff=74
0x31: Stack[-3] = (float) -0.20000000298023224
0x32: Stack[-2] = (int) 0
0x33: Stack[-1] = (int) 1
0x34: Call2 0x3b
...
0x37: Stack[-1] = (float) -0.20000000298023224
0x38: Call2 0x59
...
0x5b: Pop(0)
0x5c: @@ add(Stack[-3]); Obj=1 // @poff=94
0x5d: Pop(0)
0x5e: Push((int) 11)
...
0x65: Pop(0)
0x66: @@ add(Stack[-3]); Obj=1 // @poff=94
0x67: Pop(0)
0x68: Push((int) 12)
...
0x6f: Pop(0)
0x70: @@ add(Stack[-3]); Obj=1 // @poff=94
0x71: Pop(0)
0x72: Push((int) 13)
...
0x79: Pop(0)
0x7a: @@ add(Stack[-3]); Obj=1 // @poff=94
0x7b: Pop(0)
0x7c: Push((int) 14)
...
0x83: Pop(0)
0x84: @@ add(Stack[-3]); Obj=1 // @poff=94
0x85: Pop(0)
0x86: Push((int) 0)
0x87: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x88: IF (Stack[-1] == 0) GOTO 0x8d; Pop(1)

0x89: Push((float)0.699999988079071)
0x8a: Push((int) 500)
0x8b: @ RumblePlay(Stack[-2], Stack[-1])
0x8c: Pop(2)
0x8d: Push((int) 15)
0x8e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x8f: Pop(1)
0x90: Return(); Pop(2)
