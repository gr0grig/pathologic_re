...
Strings:
	...
	W:health
	A:add
// @pool_raw:64006900730065006100730065000000740069007200650064006e0065007300730000006800650061006c0074006800000061646400
...
0x1: Push("disease") // @poff=0
0x2: @ GetProperty(Stack[-1], Stack[-2])
0x3: Pop(1)
0x4: Push("disease") // @poff=0
0x5: Push((float)0.20000000298023224)
0x6: Pop(1); Push(Stack[-3] * Stack[-1]);
0x7: @ SetProperty(Stack[-2], Stack[-1])
0x8: Pop(2)
0x9: PushEmpty(float)
0xa: Push((float)0.20000000298023224)
...
0x10: Stack[-4] = "tiredness" // @poff=16
0x11: Stack[-3] = (float) 0.30000001192092896
0x12: Stack[-2] = (int) 0
0x13: Stack[-1] = (int) 1
0x14: Call2 0x26
...
0x17: Stack[-1] = (float) 0.30000001192092896
0x18: Call2 0x44

0x19: Pop(1)
0x1a: PushEmpty(bool, string, float, float, float)
0x1b: Stack[-4] = "health" // @poff=36
0x1c: Stack[-3] = (float) -0.30000001192092896
0x1d: Stack[-2] = (int) 0
0x1e: Stack[-1] = (int) 1
0x1f: Call2 0x26
...
0x22: Stack[-1] = (float) -0.30000001192092896
0x23: Call2 0x58
...
0x31: Stack[-10] = Stack[-2]
0x32: Stack[-9] = Stack[-1]
0x33: Call2 0x39
...
0x50: Pop(0)
0x51: @@ add(Stack[-3]); Obj=1 // @poff=50
0x52: Pop(0)
0x53: Push((int) 14)
