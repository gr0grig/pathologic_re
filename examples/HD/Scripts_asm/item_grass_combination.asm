...
Strings:
	...
	W:immunity
	A:add
// @pool_raw:6500720072006f0072003a002000000068006c005f0069006e006300000047657450726f70657274790069006d005f0069006e0063000000470043003a00200000006800650061006c0074006800000069006d006d0075006e00690074007900000061646400
...
0x15: Pop(1)
0x16: Push("hl_inc") // @poff=16
0x17: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=30
0x18: Pop(1)
0x19: Push("im_inc") // @poff=42
0x1a: @@ GetProperty(Stack[-3], Stack[-1]); Obj=5 // @poff=30
0x1b: Pop(1)
0x1c: Push("GC: ") // @poff=56
...
0x27: Stack[-4] = "health" // @poff=66
0x28: Stack[-8] = Stack[-3]
0x29: Stack[-2] = (int) 0
0x2a: Stack[-1] = (int) 1
0x2b: Call2 0x42
...
0x32: Stack[-4] = "immunity" // @poff=80
0x33: Stack[-7] = Stack[-3]
0x34: Stack[-2] = (int) 0
0x35: Stack[-1] = (int) 1
0x36: Call2 0x42
...
0x4d: Stack[-10] = Stack[-2]
0x4e: Stack[-9] = Stack[-1]
0x4f: Call2 0x55
