...
Strings:
	...
	W:tiredness
	A:add
// @pool_raw:65006100740000006800650061006c0074006800000069006d006d0075006e00690074007900000064006900730065006100730065000000680075006e006700650072000000740069007200650064006e00650073007300000061646400
...
0xf: Stack[-4] = "immunity" // @poff=22
0x10: Stack[-3] = (float) 0.05000000074505806
0x11: Stack[-2] = (int) 0
0x12: Stack[-1] = (int) 1
0x13: Call2 0x3b
...
0x16: Stack[-1] = (float) 0.05000000074505806
0x17: Call2 0x6d

0x18: Pop(1)
0x19: PushEmpty(bool, string, float, float, float)
0x1a: Stack[-4] = "disease" // @poff=40
...
0x25: Stack[-4] = "hunger" // @poff=56
0x26: Stack[-3] = (float) 0.10000000149011612
0x27: Stack[-2] = (int) 0
0x28: Stack[-1] = (int) 1
0x29: Call2 0x3b
...
0x30: Stack[-4] = "tiredness" // @poff=70
0x31: Stack[-3] = (float) -0.10000000149011612
0x32: Stack[-2] = (int) 0
0x33: Stack[-1] = (int) 1
0x34: Call2 0x3b
...
0x37: Stack[-1] = (float) -0.10000000149011612
0x38: Call2 0x59
...
0x5b: Pop(0)
0x5c: @@ add(Stack[-3]); Obj=1 // @poff=90
0x5d: Pop(0)
0x5e: Push((int) 11)
...
0x65: Pop(0)
0x66: @@ add(Stack[-3]); Obj=1 // @poff=90
0x67: Pop(0)
0x68: Push((int) 12)
...
0x6f: Pop(0)
0x70: @@ add(Stack[-3]); Obj=1 // @poff=90
0x71: Pop(0)
0x72: Push((int) 13)
...
0x79: Pop(0)
0x7a: @@ add(Stack[-3]); Obj=1 // @poff=90
0x7b: Pop(0)
0x7c: Push((int) 14)
...
0x83: Pop(0)
0x84: @@ add(Stack[-3]); Obj=1 // @poff=90
0x85: Pop(0)
0x86: Push((int) 0)
