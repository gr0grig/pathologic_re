...
0x5: Push((float)0.4000000059604645)
0x6: Pop(1); Push(Stack[-3] * Stack[-1]);
0x7: @ SetProperty(Stack[-2], Stack[-1])
0x8: Pop(2)
0x9: PushEmpty(float)
0xa: Push((float)0.4000000059604645)
