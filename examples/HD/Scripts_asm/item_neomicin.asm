...
0x5: Push((float)0.6000000238418579)
0x6: Pop(1); Push(Stack[-3] * Stack[-1]);
0x7: @ SetProperty(Stack[-2], Stack[-1])
0x8: Pop(2)
0x9: PushEmpty(float)
0xa: Push((float)0.6000000238418579)
...
0x11: Stack[-3] = (float) 0.15000000596046448
0x12: Stack[-2] = (int) 0
0x13: Stack[-1] = (int) 1
0x14: Call2 0x26
...
0x17: Stack[-1] = (float) 0.15000000596046448
0x18: Call2 0x44

0x19: Pop(1)
0x1a: PushEmpty(bool, string, float, float, float)
0x1b: Stack[-4] = "health" // @poff=36
0x1c: Stack[-3] = (float) -0.15000000596046448
0x1d: Stack[-2] = (int) 0
0x1e: Stack[-1] = (int) 1
0x1f: Call2 0x26
...
0x22: Stack[-1] = (float) -0.15000000596046448
0x23: Call2 0x58
