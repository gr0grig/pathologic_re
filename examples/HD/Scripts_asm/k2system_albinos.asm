...
// @pool_raw:
// @pool_encoding:utf8
...
0x308: Stack[-2] = "klara2_svita_positioner" // @poff=164
0x309: Stack[-1] = "wonder" // @poff=212
0x30a: Call2 0x461
...
0x311: Stack[-2] = "klara2_svita_positioner" // @poff=164
0x312: Stack[-1] = "wrong_wonder" // @poff=226
0x313: Call2 0x461
...
0x324: Push("player") // @poff=252
0x325: @ FindActor(Stack[-4]T, Stack[-1])
0x326: Pop(1)
...
0x339: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x3c4: Pop(0)
0x3c5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=276
0x3c6: Pop(0)
...
0x3d0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=276
0x3d1: Pop(0)
0x3d2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=288
0x3d3: Pop(0)
...
0x431: Push("Can't find lsh animation : ") // @poff=302
...
0x440: Push("Can't find lsh animation : ") // @poff=302
...
0x446: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=288
0x447: Pop(0)
...
0x463: Pop(0)
0x464: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x490: Stack[-1] = "AlbinosLate1" // @poff=358
0x491: Call2 0x52d
...
0x496: Stack[-2] = "klara2_svita_positioner" // @poff=164
0x497: Stack[-1] = "wonder" // @poff=212
0x498: Call2 0x461
...
0x49d: Stack[-2] = "klara2_svita_positioner" // @poff=164
0x49e: Stack[-1] = "bad_wonder" // @poff=384
0x49f: Call2 0x461
...
0x4a4: Stack[-1] = "Albinos1" // @poff=406
0x4a5: Call2 0x52d
...
0x4aa: Stack[-1] = "BadKlara" // @poff=424
0x4ab: Call2 0x52d
...
0x4d3: Stack[-1] = "AlbinosLate1" // @poff=358
0x4d4: Call2 0x538
...
0x4da: Stack[-1] = "Albinos1" // @poff=406
0x4db: Call2 0x538

0x4dc: Stack[-2] = Stack[-4]
0x4dd: Pop(2)
0x4de: Return(); Pop(0)

0x4df: PushEmpty()
0x4e0: PushEmpty(bool, string)
0x4e1: Stack[-1] = "BadKlara" // @poff=424
0x4e2: Call2 0x538
...
0x4f8: Push("Can't retrieve diary root") // @poff=442
0x4f9: @ Trace(Stack[-1])
0x4fa: Pop(1)
...
0x504: Pop(1)
0x505: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=494
0x506: Pop(0)
0x507: Pop(0); Push((bool) Stack[-2] == 0)
0x508: IF (Stack[-1] == 0) GOTO 0x50f; Pop(1)

0x509: Push("Can't find diary parent with id: ") // @poff=499
...
0x50f: @@ AddChild(Stack[-8]); Obj=2 // @poff=567
0x510: Pop(0)
0x511: Push((int) 7)
0x512: @ SendWorldWndMessage(Stack[-1])
0x513: Pop(1)
0x514: @@ GetCategory(Stack[-1]); Obj=8 // @poff=576
0x515: Pop(0)
...
0x52e: Push("day") // @poff=156
0x52f: @ GetProperty(Stack[-1], Stack[-2])
0x530: Pop(1)
0x531: Push("K2S_Klara2Svita") // @poff=602
...
0x539: Push("day") // @poff=156
0x53a: @ GetProperty(Stack[-1], Stack[-3])
0x53b: Pop(1)
0x53c: Push("K2S_Klara2Svita") // @poff=602
...
0x548: Stack[-1] = "ui/NPC_Albinos.png" // @poff=634
0x549: Return(); Pop(0)

0x54a: Stack[-1] = "ui/NPC_Albinos_b.png" // @poff=672
0x54b: Return(); Pop(0)
