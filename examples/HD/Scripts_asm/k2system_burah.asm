...
// @pool_raw:
// @pool_encoding:utf8
...
0xf1: Pop(0)
0xf2: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0xf3: Pop(1)
0xf4: PushEmpty(int)
0xf5: Call2 0x627

0xf6: Pop(0)
0xf7: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0xf8: Pop(1)
0xf9: PushEmpty(string)
0xfa: Call2 0x62b

0xfb: Pop(0)
0xfc: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0xfd: Pop(1)
0xfe: PushEmpty(string)
0xff: Call2 0x62d

0x100: Pop(0)
0x101: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x102: Pop(1)
0x103: PushEmpty(int)
0x104: Call2 0x700

0x105: Pop(0)
0x106: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x107: Pop(1)
0x108: Stack[-2] = (int) -1
...
0x114: Stack[-1] = Stack[-2]
0x115: Pop(1)
0x116: Call2 0x4c7

0x117: Pop(2)
0x118: PushEmpty(object, object)
0x119: Stack[-11] = Stack[-2]
...
0x11e: Pop(2)
0x11f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x120: Pop(0)
...
0x123: @ sync()
0x124: Pop(0)
0x125: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x126: Pop(0)
0x127: GOTO 0x121

0x128: PushEmpty(object)
0x129: Stack[-10] = Stack[-1]
0x12a: Call2 0x4b5

0x12b: Pop(1)
0x12c: @ StopDialog(Stack[-4])
0x12d: Pop(0)
0x12e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x12f: Pop(0)
...
0x186: Push("all") // @poff=138
0x187: Push("idle") // @poff=146
...
0x281: Stack[-1] = "Neutral" // @poff=89
0x282: Call2 0x195

0x283: Pop(1)
0x284: Push((int) 539751)
0x285: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x286: Pop(1)
0x287: @@@ ClearReplies(); Obj=0 // @poff=116
0x288: Pop(0)
...
0x34e: Stack[-1] = 0
0x34f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x350: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x351: @ RotateAsync(Stack[-2], Stack[-1])
0x352: Pop(2)
0x353: Return(); Pop(0)

0x354: PushEmpty(object, bool, object, bool)
0x355: Push("player") // @poff=188
...
0x430: Pop(0)
0x431: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x432: Pop(0)
...
0x437: Push("HasProperty") // @poff=214
0x438: Push((int) 2)
...
0x43e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=238
0x43f: Pop(0)
...
0x444: Stack[-10] = Stack[-2]
0x445: Stack[-9] = Stack[-1]
0x446: Call2 0x436
...
0x44c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=250
0x44d: Pop(0)
0x44e: PushEmpty(float, float, float, float)
0x44f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x450: Stack[-8] = Stack[-2]
0x451: Stack[-7] = Stack[-1]
0x452: Call2 0x596

0x453: Pop(3)
0x454: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=262
0x455: Pop(1)
...
0x45f: Pop(2)
0x460: Stack[-1] = Stack[-8]
0x461: Return(); Pop(6)

0x462: PushEmpty(cvector, cvector)
0x463: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x464: Pop(0)
0x465: PushEmpty(bool, cvector)
0x466: Stack[-3] = Stack[-1]
0x467: Call2 0x458

0x468: Stack[-2] = Stack[-6]
0x469: Pop(2)
0x46a: Return(); Pop(2)
...
0x471: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x472: Pop(0)
0x473: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=274
0x474: Pop(0)
...
0x49a: Pop(0)
0x49b: Push((bool) 1)
0x49c: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x49d: Pop(1)
0x49e: Push(CvectorIndex(Stack[-4], 0))
0x49f: Push(CvectorIndex(Stack[-5], 2))
0x4a0: @ Rotate(Stack[-2], Stack[-1])
0x4a1: Pop(2)
...
0x4a7: Push("head") // @poff=288
0x4a8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4a9: Pop(1)
0x4aa: Push(Stack[-1])
0x4ab: IF (Stack[-1] == 0) GOTO 0x4af; Pop(1)

0x4ac: Push("head") // @poff=288
0x4ad: @ LookAsyncCamera(Stack[-1])
0x4ae: Pop(1)
0x4af: @ CameraWaitForPlayFinish()
0x4b0: Pop(0)
0x4b1: @ ResumeWorld()
0x4b2: Pop(0)
0x4b3: Stack[-21] = (bool) 1
0x4b4: Return(); Pop(18)

0x4b5: PushEmpty(bool, bool)
0x4b6: Push((bool) 1)
0x4b7: @ CameraSwitchToNormal(Stack[-1])
0x4b8: Pop(1)
...
0x4be: Push("head") // @poff=288
0x4bf: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4c0: Pop(1)
0x4c1: Push(Stack[-1])
0x4c2: IF (Stack[-1] == 0) GOTO 0x4c6; Pop(1)

0x4c3: Push("head") // @poff=288
0x4c4: @ UnlookAsync(Stack[-1])
0x4c5: Pop(1)
0x4c6: Return(); Pop(2)

0x4c7: PushEmpty(int, int, int, int)
0x4c8: Push("voice_common") // @poff=298
0x4c9: @ GetVariable(Stack[-1], Stack[-3])
0x4ca: Pop(1)
0x4cb: Push(Stack[-2])
0x4cc: IF (Stack[-1] == 0) GOTO 0x4ed; Pop(1)

0x4cd: PushEmpty(bool, object)
0x4ce: Stack[-7] = Stack[-1]
0x4cf: Call2 0x501

0x4d0: Pop(1)
0x4d1: Pop(1); Push((bool) Stack[-1] == 0)
0x4d2: IF (Stack[-1] == 0) GOTO 0x4db; Pop(1)

0x4d3: PushEmpty(bool, object)
0x4d4: Stack[-7] = Stack[-1]
0x4d5: Call2 0x526
...
0x4dd: Pop(1)
0x4de: Push(Stack[-1])
0x4df: IF (Stack[-1] == 0) GOTO 0x4e8; Pop(1)

0x4e0: Push("voice_common") // @poff=298
0x4e1: Push((int) 1)
0x4e2: Pop(1); Push(Stack[-4] + Stack[-1]);
0x4e3: Push((int) 3)
0x4e4: Pop(2); Push(Stack[-2] % Stack[-1]);
0x4e5: @ SetVariable(Stack[-2], Stack[-1])
0x4e6: Pop(2)
0x4e7: GOTO 0x4ec

0x4e8: Push("voice_common") // @poff=298
0x4e9: Push((int) 0)
0x4ea: @ SetVariable(Stack[-2], Stack[-1])
0x4eb: Pop(2)
0x4ec: GOTO 0x4ff

0x4ed: PushEmpty(bool, object)
0x4ee: Stack[-7] = Stack[-1]
0x4ef: Call2 0x526
...
0x4f9: Stack[-6] = (bool) 0
0x4fa: Return(); Pop(4)

0x4fb: Push("voice_common") // @poff=298
0x4fc: Push((int) 1)
0x4fd: @ SetVariable(Stack[-2], Stack[-1])
0x4fe: Pop(2)
0x4ff: Stack[-6] = (bool) 1
0x500: Return(); Pop(4)

0x501: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x502: Stack[-5] = "c" // @poff=324
0x503: Stack[-4] = (int) 0
0x504: Push((int) 1)
0x505: IF (Stack[-1] == 0) GOTO 0x511; Pop(1)

0x506: Push((int) 1)
0x507: Pop(1); Push(Stack[-5] + Stack[-1]);
0x508: Pop(1); Push(Stack[-6] + Stack[-1]);
0x509: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x50a: Pop(1)
0x50b: Pop(0); Push((bool) Stack[-3] == 0)
0x50c: IF (Stack[-1] == 0) GOTO 0x50e; Pop(1)

0x50d: GOTO 0x511

0x50e: Push((int) 1)
0x50f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x510: GOTO 0x504

0x511: Pop(0); Push((bool) Stack[-4] == 0)
0x512: IF (Stack[-1] == 0) GOTO 0x515; Pop(1)

0x513: Stack[-12] = (bool) 0
0x514: Return(); Pop(10)

0x515: Stack[-2] = (int) 0
0x516: Push((int) 1)
0x517: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x518: IF (Stack[-1] == 0) GOTO 0x51b; Pop(1)

0x519: @ irand(Stack[-2], Stack[-4])
0x51a: Pop(0)
0x51b: Push((int) 1)
0x51c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x51d: Pop(1); Push(Stack[-6] + Stack[-1]);
0x51e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x51f: Pop(1)
0x520: PushEmpty(bool, string)
0x521: Stack[-3] = Stack[-1]
0x522: Call2 0x570

0x523: Stack[-2] = Stack[-14]
0x524: Pop(2)
0x525: Return(); Pop(10)

0x526: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x527: Push("d") // @poff=294
0x528: PushEmpty(int)
0x529: Call2 0x606

0x52a: Pop(0)
0x52b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x52c: Push("m") // @poff=328
0x52d: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x52e: Stack[-4] = (int) 0
0x52f: Push((int) 1)
0x530: IF (Stack[-1] == 0) GOTO 0x53c; Pop(1)

0x531: Push((int) 1)
0x532: Pop(1); Push(Stack[-5] + Stack[-1]);
0x533: Pop(1); Push(Stack[-6] + Stack[-1]);
0x534: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x535: Pop(1)
0x536: Pop(0); Push((bool) Stack[-3] == 0)
0x537: IF (Stack[-1] == 0) GOTO 0x539; Pop(1)

0x538: GOTO 0x53c

0x539: Push((int) 1)
0x53a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x53b: GOTO 0x52f

0x53c: Pop(0); Push((bool) Stack[-4] == 0)
0x53d: IF (Stack[-1] == 0) GOTO 0x540; Pop(1)

0x53e: Stack[-12] = (bool) 0
0x53f: Return(); Pop(10)

0x540: Stack[-2] = (int) 0
0x541: Push((int) 1)
0x542: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x543: IF (Stack[-1] == 0) GOTO 0x546; Pop(1)

0x544: @ irand(Stack[-2], Stack[-4])
0x545: Pop(0)
0x546: Push((int) 1)
0x547: Pop(1); Push(Stack[-3] + Stack[-1]);
0x548: Pop(1); Push(Stack[-6] + Stack[-1]);
0x549: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x54a: Pop(1)
0x54b: PushEmpty(bool, string)
0x54c: Stack[-3] = Stack[-1]
0x54d: Call2 0x570

0x54e: Stack[-2] = Stack[-14]
0x54f: Pop(2)
0x550: Return(); Pop(10)

0x551: PushEmpty(bool, float, float, bool, float, float)
0x552: @ lshHasAnimation(Stack[-3], Stack[-7])
0x553: Pop(0)
0x554: Push(Stack[-3])
0x555: IF (Stack[-1] == 0) GOTO 0x55c; Pop(1)

0x556: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x557: Pop(0)
0x558: Push((bool) 0)
0x559: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x55a: Pop(1)
0x55b: GOTO 0x560

0x55c: Push("Can't find lsh animation : ") // @poff=332
0x55d: Pop(1); Push(Stack[-1] + Stack[-8]);
0x55e: @ Trace(Stack[-1])
0x55f: Pop(1)
0x560: Return(); Pop(6)

0x561: PushEmpty(bool, float, float, bool, float, float)
0x562: @ lshHasAnimation(Stack[-3], Stack[-8])
0x563: Pop(0)
0x564: Push(Stack[-3])
0x565: IF (Stack[-1] == 0) GOTO 0x56b; Pop(1)

0x566: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x567: Pop(0)
0x568: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x569: Pop(0)
0x56a: GOTO 0x56f

0x56b: Push("Can't find lsh animation : ") // @poff=332
0x56c: Pop(1); Push(Stack[-1] + Stack[-9]);
0x56d: @ Trace(Stack[-1])
0x56e: Pop(1)
0x56f: Return(); Pop(6)
...
0x573: Pop(0)
0x574: IF (Stack[-1] == 0) GOTO 0x57d; Pop(1)

0x575: @ lshHasSpeech(Stack[-1], Stack[-3])
0x576: Pop(0)
0x577: Push(Stack[-1])
0x578: IF (Stack[-1] == 0) GOTO 0x57d; Pop(1)

0x579: @ lshPlaySpeech(Stack[-3])
0x57a: Pop(0)
0x57b: Stack[-4] = (bool) 1
0x57c: Return(); Pop(2)

0x57d: Stack[-4] = (bool) 0
0x57e: Return(); Pop(2)
...
0x58d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x58e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x58f: Push((float)9.999999974752427e-07)
0x590: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x591: IF (Stack[-1] == 0) GOTO 0x594; Pop(1)

0x592: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x593: Return(); Pop(2)

0x594: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x595: Return(); Pop(2)

0x596: PushEmpty()
0x597: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x598: IF (Stack[-1] == 0) GOTO 0x59b; Pop(1)

0x599: Stack[-2] = Stack[-4]
0x59a: Return(); Pop(0)

0x59b: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x59c: IF (Stack[-1] == 0) GOTO 0x59f; Pop(1)

0x59d: Stack[-1] = Stack[-4]
0x59e: Return(); Pop(0)

0x59f: Stack[-3] = Stack[-4]
0x5a0: Return(); Pop(0)

0x5a1: PushEmpty(object, object)
0x5a2: @ CreateIntVector(Stack[-1])
0x5a3: Pop(0)
0x5a4: @@ add(Stack[-4]); Obj=1 // @poff=388
0x5a5: Pop(0)
0x5a6: @@ add(Stack[-3]); Obj=1 // @poff=388
0x5a7: Pop(0)
0x5a8: Push((int) 3)
0x5a9: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x5aa: Pop(1)
0x5ab: Return(); Pop(2)

0x5ac: Stack[-1] = 0
0x5ad: PushEmpty(int, int, bool, int, int, bool)
0x5ae: @@ GetItemID(Stack[-3]); Obj=8 // @poff=392
0x5af: Pop(0)
0x5b0: Push("Category") // @poff=402
0x5b1: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5b2: Pop(1)
0x5b3: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=420
0x5b4: Pop(0)
0x5b5: Pop(0); Push((bool) Stack[-1] == 0)
0x5b6: IF (Stack[-1] == 0) GOTO 0x5ba; Pop(1)

0x5b7: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=428
0x5b8: Pop(0)
0x5b9: GOTO 0x5bf

0x5ba: PushEmpty(int, int)
0x5bb: Stack[-5] = Stack[-2]
0x5bc: Stack[-9] = Stack[-1]
0x5bd: Call2 0x5a1
...
0x5c1: @ CreateInvItem(Stack[-1])
0x5c2: Pop(0)
0x5c3: @@ SetItemName(Stack[-4]); Obj=1 // @poff=438
0x5c4: Pop(0)
0x5c5: PushEmpty(object, object, int)
0x5c6: Stack[-8] = Stack[-3]
0x5c7: Stack[-4] = Stack[-2]
...
0x5cc: Stack[-1] = 0
0x5cd: PushEmpty()
0x5ce: Pop(0); Push((bool) Stack[-2] == 0)
0x5cf: IF (Stack[-1] == 0) GOTO 0x5d2; Pop(1)

0x5d0: Stack[-3] = (bool) 0
0x5d1: Return(); Pop(0)
...
0x5d5: Push((int) 8)
0x5d6: @ SendWorldWndMessage(Stack[-1])
0x5d7: Pop(1)
0x5d8: GOTO 0x5e2
...
0x5dc: Push((int) 9)
0x5dd: @ SendWorldWndMessage(Stack[-1])
0x5de: Pop(1)
0x5df: GOTO 0x5e2

0x5e0: Stack[-3] = (bool) 0
0x5e1: Return(); Pop(0)

0x5e2: PushEmpty(float)
0x5e3: Stack[-2] = Stack[-1]
0x5e4: Call2 0x5f0

0x5e5: Pop(1)
0x5e6: PushEmpty(bool, object, string, float, float, float)
0x5e7: Stack[-8] = Stack[-5]
0x5e8: Stack[-4] = "reputation" // @poff=450
0x5e9: Stack[-7] = Stack[-3]
0x5ea: Stack[-2] = (int) 0
0x5eb: Stack[-1] = (int) 1
0x5ec: Call2 0x442

0x5ed: Pop(6)
0x5ee: Stack[-3] = (bool) 1
0x5ef: Return(); Pop(0)

0x5f0: PushEmpty(object, object)
0x5f1: @ CreateFloatVector(Stack[-1])
0x5f2: Pop(0)
0x5f3: @@ add(Stack[-3]); Obj=1 // @poff=388
0x5f4: Pop(0)
0x5f5: Push((int) 16)
0x5f6: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x5f7: Pop(1)
0x5f8: Return(); Pop(2)
...
0x5fc: Pop(0)
0x5fd: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x60a: PushEmpty(int)
0x60b: Push((int) 24)
0x60c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x60d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x60e: Return(); Pop(2)
...
0x627: Stack[-1] = (int) 515592
0x628: Return(); Pop(0)

0x629: Stack[-1] = (int) 511961
0x62a: Return(); Pop(0)

0x62b: Stack[-1] = "ui/NPC_Burah.png" // @poff=472
0x62c: Return(); Pop(0)

0x62d: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=506
0x62e: Return(); Pop(0)
...
0x631: PushEmpty()
0x632: PushEmpty(bool, object, float)
0x633: Stack[-5] = Stack[-2]
0x634: Stack[-1] = (float) 0.05000000074505806
0x635: Call2 0x5cd
...
0x63b: Stack[-1] = (float) -0.05000000074505806
0x63c: Call2 0x5cd
...
0x63f: PushEmpty()
0x640: Push("beta_pills 5 is given") // @poff=544
0x641: @ Trace(Stack[-1])
0x642: Pop(1)
0x643: PushEmpty(object, string, int)
0x644: Stack[-5] = Stack[-3]
0x645: Stack[-2] = "beta_pills" // @poff=588
0x646: Stack[-1] = (int) 5
0x647: Call2 0x5c0
...
0x64a: PushEmpty()
0x64b: Push("playsound") // @poff=610
0x64c: Push("giveitem") // @poff=630
0x64d: @ TriggerWorld(Stack[-2], Stack[-1])
0x64e: Pop(2)
0x64f: Return(); Pop(0)

0x650: PushEmpty()
0x651: Push("burah_serum is given") // @poff=648
0x652: @ Trace(Stack[-1])
0x653: Pop(1)
0x654: PushEmpty(object, string, int)
0x655: Stack[-5] = Stack[-3]
0x656: Stack[-2] = "burah_serum" // @poff=690
0x657: Stack[-1] = (int) 1
0x658: Call2 0x5c0
...
0x67b: Stack[-5] = Stack[-2]
0x67c: Stack[-1] = (float) -0.30000001192092896
0x67d: Call2 0x5cd
...
0x6b0: PushEmpty(object, object)
0x6b1: Push((int) 753)
0x6b2: Push((int) 2)
0x6b3: Push((int) 539738)
0x6b4: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6b5: Pop(3)
0x6b6: PushEmpty(bool, object, int)
0x6b7: Stack[-4] = Stack[-2]
0x6b8: Stack[-1] = (int) 751
0x6b9: Call2 0x6e4
...
0x6be: Push((int) 754)
0x6bf: Push((int) 2)
0x6c0: Push((int) 539739)
0x6c1: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6c2: Pop(3)
0x6c3: PushEmpty(bool, object, int)
0x6c4: Stack[-4] = Stack[-2]
0x6c5: Stack[-1] = (int) 751
0x6c6: Call2 0x6e4
...
0x6cb: Push((int) 761)
0x6cc: Push((int) 2)
0x6cd: Push((int) 539746)
0x6ce: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6cf: Pop(3)
0x6d0: PushEmpty(bool, object, int)
0x6d1: Stack[-4] = Stack[-2]
0x6d2: Stack[-1] = (int) 757
0x6d3: Call2 0x6e4
...
0x6d8: @ GetDiaryRoot(Stack[-1])
0x6d9: Pop(0)
0x6da: Pop(0); Push((bool) Stack[-1] == 0)
0x6db: IF (Stack[-1] == 0) GOTO 0x6e1; Pop(1)

0x6dc: Push("Can't retrieve diary root") // @poff=714
0x6dd: @ Trace(Stack[-1])
0x6de: Pop(1)
0x6df: Stack[-3] = (bool) 0
0x6e0: Return(); Pop(2)

0x6e1: Stack[-1] = Stack[-3]
0x6e2: Return(); Pop(2)

0x6e3: Stack[-1] = 0
0x6e4: PushEmpty(object, object, int, object, object, int)
0x6e5: PushEmpty(object)
0x6e6: Call2 0x6d7

0x6e7: Stack[-1] = Stack[-4]
0x6e8: Pop(1)
0x6e9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=766
0x6ea: Pop(0)
0x6eb: Pop(0); Push((bool) Stack[-2] == 0)
0x6ec: IF (Stack[-1] == 0) GOTO 0x6f3; Pop(1)

0x6ed: Push("Can't find diary parent with id: ") // @poff=771
0x6ee: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6ef: @ Trace(Stack[-1])
0x6f0: Pop(1)
0x6f1: Stack[-9] = (bool) 0
0x6f2: Return(); Pop(6)

0x6f3: @@ AddChild(Stack[-8]); Obj=2 // @poff=839
0x6f4: Pop(0)
0x6f5: Push((int) 7)
0x6f6: @ SendWorldWndMessage(Stack[-1])
0x6f7: Pop(1)
0x6f8: @@ GetCategory(Stack[-1]); Obj=8 // @poff=848
0x6f9: Pop(0)
0x6fa: @ SetDiarySection(Stack[-1])
0x6fb: Pop(0)
0x6fc: Stack[-9] = (bool) 0
0x6fd: Return(); Pop(6)

0x6fe: Stack[-2] = 0
0x6ff: Stack[-3] = 0
0x700: PushEmpty(int, int)
0x701: Push("branch") // @poff=860
...
0x711: PushEmpty(bool, string, string)
0x712: Stack[-2] = "klara2_npc_positioner" // @poff=874
0x713: Stack[-1] = "remove_danko" // @poff=918
0x714: Call2 0x5fa

0x715: Pop(3)
0x716: Return(); Pop(0)

0x717: PushEmpty(bool, string, string)
0x718: Stack[-2] = "klara2_npc_positioner" // @poff=874
0x719: Stack[-1] = "remove_burah" // @poff=944
0x71a: Call2 0x5fa
...
0x71e: Push("k2system_klara_day") // @poff=970
0x71f: @ GetVariable(Stack[-1], Stack[-2])
0x720: Pop(1)
0x721: Stack[-1] = Stack[-3]
0x722: Return(); Pop(2)

0x723: PushEmpty(int, int)
0x724: Push("k2system_burah_day") // @poff=1008
...
0x72a: Push("k2system_danko_day") // @poff=1046
0x72b: @ GetVariable(Stack[-1], Stack[-2])
0x72c: Pop(1)
...
0x733: Pop(1)
0x734: Push("k2system_burah_state") // @poff=1084
0x735: Pop(1); Push(Stack[-1] + Stack[-3]);
0x736: @ GetVariable(Stack[-1], Stack[-2])
0x737: Pop(1)
0x738: Stack[-1] = Stack[-5]
0x739: Return(); Pop(4)

0x73a: PushEmpty(int, int)
0x73b: PushEmpty(int)
0x73c: Call2 0x723

0x73d: Stack[-1] = Stack[-2]
0x73e: Pop(1)
0x73f: Push("k2system_burah_state") // @poff=1084
0x740: Pop(1); Push(Stack[-1] + Stack[-2]);
0x741: @ SetVariable(Stack[-1], Stack[-4])
0x742: Pop(1)
0x743: Return(); Pop(2)

0x744: PushEmpty(int, int, int, int)
0x745: PushEmpty(int)
0x746: Call2 0x729

0x747: Stack[-1] = Stack[-3]
0x748: Pop(1)
0x749: Push("k2system_danko_state") // @poff=1126
0x74a: Pop(1); Push(Stack[-1] + Stack[-3]);
...
0x753: Pop(1)
0x754: Push("k2system_danko_state") // @poff=1126
0x755: Pop(1); Push(Stack[-1] + Stack[-2]);
0x756: @ SetVariable(Stack[-1], Stack[-4])
0x757: Pop(1)
0x758: Return(); Pop(2)

0x759: PushEmpty(int, int, int, int)
0x75a: PushEmpty(int)
0x75b: Call2 0x71d

0x75c: Stack[-1] = Stack[-3]
0x75d: Pop(1)
0x75e: Push("k2system_klara_state") // @poff=1168
0x75f: Pop(1); Push(Stack[-1] + Stack[-3]);
0x760: @ GetVariable(Stack[-1], Stack[-2])
0x761: Pop(1)
...
0x768: Pop(1)
0x769: Push("k2system_klara_state") // @poff=1168
0x76a: Pop(1); Push(Stack[-1] + Stack[-2]);
0x76b: @ SetVariable(Stack[-1], Stack[-4])
0x76c: Pop(1)
0x76d: Return(); Pop(2)
...
0x778: Pop(0)
0x779: Push((int) 1)
0x77a: Stack[-3] = Stack[-2] == Stack[-1]; Pop(2);
0x77b: Return(); Pop(0)
...
0x79d: PushEmpty(int, int)
0x79e: Push("day") // @poff=1000
0x79f: @ GetProperty(Stack[-1], Stack[-2])
0x7a0: Pop(1)
0x7a1: PushEmpty(int)
0x7a2: Call2 0x606
...
0x7a5: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7a6: PushEmpty(int, object)
0x7a7: Stack[-5] = Stack[-1]
0x7a8: Push(-2, 1); TaskCall(2)
0x7a9: Call2 0xe2

0x7aa: Pop(-2, 1); TaskReturn
0x7ab: Pop(2)
0x7ac: GOTO 0x7b3

0x7ad: PushEmpty(int, object)
0x7ae: Stack[-5] = Stack[-1]
0x7af: Push(-2, 1); TaskCall(0)
0x7b0: Call2 0x0

0x7b1: Pop(-2, 1); TaskReturn
0x7b2: Pop(2)
0x7b3: Return(); Pop(2)
