...
// @pool_raw:
// @pool_encoding:utf8
...
0x178: Push("all") // @poff=138
0x179: Push("idle") // @poff=146
...
0x334: Stack[-2] = Stack[-5]
0x335: Pop(2)
0x336: Return(); Pop(2)

0x337: Stack[-1] = 0
0x338: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x339: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x33a: @ RotateAsync(Stack[-2], Stack[-1])
0x33b: Pop(2)
0x33c: Return(); Pop(0)

0x33d: PushEmpty(object, bool, object, bool)
0x33e: Push("player") // @poff=188
...
0x419: Pop(0)
0x41a: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x41b: Pop(0)
...
0x420: Push("HasProperty") // @poff=214
0x421: Push((int) 2)
...
0x427: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=238
0x428: Pop(0)
...
0x42d: Stack[-10] = Stack[-2]
0x42e: Stack[-9] = Stack[-1]
0x42f: Call2 0x41f
...
0x435: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=250
0x436: Pop(0)
0x437: PushEmpty(float, float, float, float)
0x438: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x439: Stack[-8] = Stack[-2]
0x43a: Stack[-7] = Stack[-1]
0x43b: Call2 0x586

0x43c: Pop(3)
0x43d: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=262
0x43e: Pop(1)
0x43f: Stack[-8] = (bool) 1
0x440: Return(); Pop(2)

0x441: PushEmpty(int, int)
0x442: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=250
0x443: Pop(0)
0x444: Pop(0); Push(Stack[-1] + Stack[-3]);
0x445: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=262
0x446: Pop(1)
0x447: Return(); Pop(2)
...
0x44f: Pop(2)
0x450: Stack[-1] = Stack[-8]
0x451: Return(); Pop(6)

0x452: PushEmpty(cvector, cvector)
0x453: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x454: Pop(0)
...
0x461: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x462: Pop(0)
0x463: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=274
0x464: Pop(0)
...
0x4d0: Push("voice_common") // @poff=298
0x4d1: Push((int) 1)
...
0x4d8: Push("voice_common") // @poff=298
0x4d9: Push((int) 0)
...
0x4eb: Push("voice_common") // @poff=298
0x4ec: Push((int) 1)
...
0x4f9: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x4fa: Pop(1)
...
0x50e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x50f: Pop(1)
0x510: PushEmpty(bool, string)
0x511: Stack[-3] = Stack[-1]
0x512: Call2 0x560

0x513: Stack[-2] = Stack[-14]
0x514: Pop(2)
0x515: Return(); Pop(10)

0x516: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x517: Push("d") // @poff=294
0x518: PushEmpty(int)
0x519: Call2 0x5e9

0x51a: Pop(0)
0x51b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x51c: Push("m") // @poff=328
...
0x524: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x525: Pop(1)
...
0x539: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x53a: Pop(1)
0x53b: PushEmpty(bool, string)
0x53c: Stack[-3] = Stack[-1]
0x53d: Call2 0x560

0x53e: Stack[-2] = Stack[-14]
0x53f: Pop(2)
0x540: Return(); Pop(10)
...
0x54c: Push("Can't find lsh animation : ") // @poff=332
...
0x55b: Push("Can't find lsh animation : ") // @poff=332
...
0x59f: Stack[-7] = Stack[-3]
0x5a0: Stack[-2] = "money" // @poff=392
...
0x5c6: Stack[-2] = Stack[-1]
0x5c7: Call2 0x5d3

0x5c8: Pop(1)
0x5c9: PushEmpty(bool, object, string, float, float, float)
0x5ca: Stack[-8] = Stack[-5]
0x5cb: Stack[-4] = "reputation" // @poff=416
0x5cc: Stack[-7] = Stack[-3]
0x5cd: Stack[-2] = (int) 0
0x5ce: Stack[-1] = (int) 1
0x5cf: Call2 0x42b
...
0x5d5: Pop(0)
0x5d6: @@ add(Stack[-3]); Obj=1 // @poff=388
0x5d7: Pop(0)
0x5d8: Push((int) 16)
...
0x5df: Pop(0)
0x5e0: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x60e: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=438
0x60f: Return(); Pop(0)

0x610: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=478
0x611: Return(); Pop(0)
...
0x617: Stack[-1] = (float) 0.05000000074505806
0x618: Call2 0x5b0
...
0x61d: Stack[-5] = Stack[-2]
0x61e: Stack[-1] = (float) -0.05000000074505806
0x61f: Call2 0x5b0
...
0x622: PushEmpty()
0x623: Push("playsound") // @poff=522
0x624: Push("givemoney") // @poff=542
...
0x65e: Stack[-5] = Stack[-2]
0x65f: Stack[-1] = (float) -0.30000001192092896
0x660: Call2 0x5b0
...
0x6bf: Push("Can't retrieve diary root") // @poff=562
0x6c0: @ Trace(Stack[-1])
0x6c1: Pop(1)
...
0x6ca: Stack[-1] = Stack[-4]
0x6cb: Pop(1)
0x6cc: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=614
0x6cd: Pop(0)
0x6ce: Pop(0); Push((bool) Stack[-2] == 0)
0x6cf: IF (Stack[-1] == 0) GOTO 0x6d6; Pop(1)

0x6d0: Push("Can't find diary parent with id: ") // @poff=619
...
0x6d6: @@ AddChild(Stack[-8]); Obj=2 // @poff=687
0x6d7: Pop(0)
0x6d8: Push((int) 7)
0x6d9: @ SendWorldWndMessage(Stack[-1])
0x6da: Pop(1)
0x6db: @@ GetCategory(Stack[-1]); Obj=8 // @poff=696
0x6dc: Pop(0)
...
0x6f5: Stack[-2] = "klara2_npc_positioner" // @poff=722
0x6f6: Stack[-1] = "remove_danko" // @poff=766
0x6f7: Call2 0x5dd
...
0x6fb: Stack[-2] = "klara2_npc_positioner" // @poff=722
0x6fc: Stack[-1] = "remove_burah" // @poff=792
0x6fd: Call2 0x5dd
...
0x701: Push("k2system_klara_day") // @poff=818
...
0x707: Push("k2system_burah_day") // @poff=856
0x708: @ GetVariable(Stack[-1], Stack[-2])
0x709: Pop(1)
0x70a: Stack[-1] = Stack[-3]
0x70b: Return(); Pop(2)

0x70c: PushEmpty(int, int)
0x70d: Push("k2system_danko_day") // @poff=894
...
0x716: Pop(1)
0x717: Push("k2system_burah_state") // @poff=932
...
0x721: Pop(1)
0x722: Push("k2system_burah_state") // @poff=932
...
0x72b: Pop(1)
0x72c: Push("k2system_danko_state") // @poff=974
...
0x736: Pop(1)
0x737: Push("k2system_danko_state") // @poff=974
...
0x73f: Stack[-1] = Stack[-3]
0x740: Pop(1)
0x741: Push("k2system_klara_state") // @poff=1016
0x742: Pop(1); Push(Stack[-1] + Stack[-3]);
0x743: @ GetVariable(Stack[-1], Stack[-2])
0x744: Pop(1)
0x745: Stack[-1] = Stack[-5]
0x746: Return(); Pop(4)
...
0x74a: Stack[-1] = Stack[-2]
0x74b: Pop(1)
0x74c: Push("k2system_klara_state") // @poff=1016
