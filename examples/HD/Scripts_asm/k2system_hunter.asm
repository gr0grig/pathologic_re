...
Strings:
	...
	W:blood
	W:dead
// @pool_raw:
...
Events:
EVENT_6 Op = 0x6ea Vars = ()
EVENT_22 Op = 0x704 Vars = (object, int, float, float)
EVENT_43 Op = 0x70c Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x716 Vars = (object, string)
EVENT_41 Op = 0x723 Vars = (object)
...
0xad: PushEmpty()
0xae: Stack[-3] = (float) 0.20000000298023224
0xaf: Return(); Pop(0)
...
0xc8: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xc9: Pop(0)
0xca: Push(Stack[-8])
0xcb: IF (Stack[-1] == 0) GOTO 0xd4; Pop(1)

0xcc: Push("attack") // @poff=64
...
0xe8: Pop(0)
0xe9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=78
0xea: Pop(0)
...
0x104: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=78
0x105: Pop(0)
...
0x138: IF (Stack[-1] == 1) GOTO 0x13e; Pop(1)

0x139: PushEmpty(bool)
0x13a: Call2 0x30a

0x13b: Pop(0)
0x13c: IF (Stack[-1] == 1) GOTO 0x13e; Pop(1)
...
0x143: Pop(0)
0x144: Push("all") // @poff=0
0x145: Push("attack_stay") // @poff=112
0x146: @ PlayAnimation(Stack[-2], Stack[-1])
0x147: Pop(2)
0x148: PushEmpty(bool, float)
0x149: Stack[-25] = Stack[-1]
0x14a: Call2 0x286
...
0x14f: @ Face(Stack[-0]T)
0x150: Pop(0)
0x151: Push("all") // @poff=0
0x152: Push("fjump") // @poff=136
...
0x16d: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=78
0x16e: Pop(0)
...
0x18c: Push("all") // @poff=0
0x18d: Push("attack_off") // @poff=148
...
0x19a: Push("all") // @poff=0
0x19b: Push("attack_begin") // @poff=170
0x19c: Push((int) 1)
0x19d: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1a8: Push("attack") // @poff=64
0x1a9: Push((int) 1)
0x1aa: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1b4: Push("all") // @poff=0
0x1b5: Push("bjump") // @poff=196
...
0x1bc: Push((float)0.8999999761581421)
0x1bd: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1be: @ GetVictim(Stack[-1], Stack[-4])
0x1bf: Pop(1)
0x1c0: @ ReportAttack(Stack[-0]T)
0x1c1: Pop(0)
...
0x1c5: Stack[-6] = Stack[-2]
0x1c6: Stack[-10] = Stack[-1]
0x1c7: Call2 0xad

0x1c8: Stack[-3] = Stack[-5]
0x1c9: Pop(3)
0x1ca: PushEmpty(float, object, float, int)
0x1cb: Stack[-7] = Stack[-3]
0x1cc: Stack[-6] = Stack[-2]
0x1cd: PushEmpty(int, object, int)
0x1ce: Stack[-10] = Stack[-2]
0x1cf: Stack[-14] = Stack[-1]
0x1d0: Call2 0xb0
...
0x1d4: Stack[-4] = Stack[-5]
0x1d5: Pop(4)
0x1d6: PushEmpty(int)
0x1d7: Call2 0x33a

0x1d8: Pop(0)
0x1d9: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1da: Pop(1)
...
0x1e5: Pop(0)
0x1e6: @ irand(Stack[-4], Stack[-1]T)
0x1e7: Pop(0)
0x1e8: Push((int) 1)
0x1e9: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x1ea: @ Face(Stack[-0]T)
0x1eb: Pop(0)
0x1ec: Push((bool) 1)
...
0x1f1: Pop(0)
0x1f2: Push("all") // @poff=0
0x1f3: Push("attack_begin") // @poff=170
...
0x20a: Pop(2)
0x20b: Push("all") // @poff=0
0x20c: Push("attack_middle") // @poff=208
...
0x214: Pop(0)
0x215: Push("all") // @poff=0
0x216: Push("attack_middle") // @poff=208
...
0x22a: Stack[-11] = Stack[-2]
0x22b: Stack[-6] = Stack[-1]
0x22c: Call2 0x1bb

0x22d: Pop(2)
0x22e: Stack[-2] = (int) 1
0x22f: Push("attack_middle") // @poff=208
0x230: Pop(1); Push(Stack[-1] + Stack[-5]);
0x231: Push("_") // @poff=236
0x232: Pop(2); Push(Stack[-2] + Stack[-1]);
0x233: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x234: Push("all") // @poff=0
...
0x259: Pop(1)
0x25a: Push("all") // @poff=0
0x25b: Push("attack_end") // @poff=240
...
0x29a: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=78
0x29b: Pop(0)
...
0x2e6: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2e7: Pop(1)
...
0x2eb: @ Face(Stack[-0]T)
0x2ec: Pop(0)
0x2ed: Push("all") // @poff=0
0x2ee: Push("bjump") // @poff=196
0x2ef: @ PlayAnimation(Stack[-2], Stack[-1])
0x2f0: Pop(2)
0x2f1: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=78
0x2f2: Pop(0)
...
0x328: @ irand(Stack[-1], Stack[-2]T)
0x329: Pop(0)
0x32a: Push((int) 1)
0x32b: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x32c: Push("attack") // @poff=64
...
0x33d: Stack[-1] = "attack_stay" // @poff=112
0x33e: Call2 0x626
...
0x368: Stack[-15] = Stack[-5]
0x369: Stack[-14] = Stack[-4]
0x36a: Stack[-13] = Stack[-3]
0x36b: Stack[-12] = Stack[-2]
0x36c: Stack[-11] = Stack[-1]
0x36d: Call2 0x3b2

0x36e: Stack[-6] = Stack[-7]
0x36f: Pop(6)
0x370: Push( Stack[2 + Tasks[-1].StackPointer] )
0x371: IF (Stack[-1] == 0) GOTO 0x375; Pop(1)

0x372: Push("head") // @poff=298
...
0x3b5: Stack[-17] = Stack[-7]
0x3b6: PushEmpty(bool, object)
0x3b7: Stack[-23] = Stack[-1]
0x3b8: Call2 0x43e
...
0x3be: @@ GetPosition(Stack[-5]); Obj=21 // @poff=308
0x3bf: Pop(0)
...
0x3d5: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=78
0x3d6: Pop(0)
...
0x3e7: Push((int) 0)
0x3e8: Push((float)0.30000001192092896)
...
0x40a: Push((int) 0)
0x40b: Push((float)0.30000001192092896)
...
0x445: Stack[-1] = "walk" // @poff=320
0x446: Return(); Pop(0)

0x447: Stack[-1] = "run" // @poff=330
0x448: Return(); Pop(0)

0x449: PushEmpty()
0x44a: EventDisable(0)
0x44b: PushEmpty(object)
0x44c: Stack[-2] = Stack[-1]
0x44d: Call2 0x462
...
0x463: Pop(0); PushNull((bool) Stack[-21] == 0)
0x464: IF (Stack[-1] == 0) GOTO 0x46a; Pop(1)

0x465: PushEmpty(string)
0x466: Stack[-1] = "fdie" // @poff=338
0x467: Call2 0x4bd

0x468: Pop(1)
0x469: GOTO 0x4bc

0x46a: @@ GetPosition(Stack[-10]); Obj=21 // @poff=308
0x46b: Pop(0)
...
0x47b: Stack[-6] = "fdie" // @poff=338
0x47c: GOTO 0x47e

0x47d: Stack[-6] = "bdie" // @poff=348
...
0x484: @ StopAsync()
0x485: Pop(0)
0x486: Stack[-21] = Stack[-5]
0x487: Push("GetScriptProperty") // @poff=358
0x488: Push((int) 2)
0x489: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x48a: IF (Stack[-1] == 0) GOTO 0x496; Pop(1)

0x48b: Push("Owner") // @poff=394
0x48c: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=406
0x48d: Pop(1)
0x48e: Push(Stack[-4])
0x48f: IF (Stack[-1] == 0) GOTO 0x496; Pop(1)

0x490: Push("Owner") // @poff=394
0x491: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=424
0x492: Pop(1)
0x493: Pop(0); PushNull((bool) Stack[-5] == 0)
0x494: IF (Stack[-1] == 0) GOTO 0x496; Pop(1)

0x495: Stack[-21] = Stack[-5]
0x496: Push("@GetEyesHeight") // @poff=442
0x497: Push((int) 1)
0x498: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x499: IF (Stack[-1] == 0) GOTO 0x4a5; Pop(1)

0x49a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=472
0x49b: Pop(0)
...
0x4b1: @ StopAsync()
0x4b2: Pop(0)
0x4b3: Push("head") // @poff=298
0x4b4: @ UnlookAsync(Stack[-1])
0x4b5: Pop(1)
0x4b6: Push("all") // @poff=0
...
0x4e7: Stack[-2] = "bullet" // @poff=496
0x4e8: Return(); Pop(0)

0x4e9: Stack[-2] = "phys" // @poff=510
0x4ea: Return(); Pop(0)

0x4eb: PushEmpty(cvector, cvector, cvector, cvector)
0x4ec: @ GetPosition(Stack[-2])
0x4ed: Pop(0)
0x4ee: @@ GetPosition(Stack[-1]); Obj=5 // @poff=308
0x4ef: Pop(0)
...
0x4f8: Push("HasProperty") // @poff=520
0x4f9: Push((int) 2)
...
0x4ff: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x500: Pop(0)
...
0x516: Push("armor") // @poff=570
0x517: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=582
0x518: Pop(1)
0x519: Push("armor_") // @poff=594
...
0x528: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=582
0x529: Pop(0)
...
0x531: Pop(3)
0x532: Push("health") // @poff=556
0x533: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=582
0x534: Pop(1)
0x535: Push((int) 1)
0x536: Pop(1); Push(Stack[-1] - Stack[-4]);
0x537: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x538: Push("health") // @poff=556
...
0x53e: Pop(3)
0x53f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=608
0x540: Pop(2)
...
0x54d: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x54e: Pop(0)
...
0x56b: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x56c: Pop(0)
...
0x580: Stack[-1] = "noaccess" // @poff=650
0x581: Call2 0x4f7
...
0x587: Push("noaccess") // @poff=650
0x588: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=582
0x589: Pop(1)
0x58a: Push((int) 0)
...
0x59c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=308
0x59d: Pop(0)
...
0x5ad: Stack[-1] = "fhit" // @poff=668
0x5ae: GOTO 0x5b0

0x5af: Stack[-1] = "bhit" // @poff=678
0x5b0: Push("hit_react") // @poff=688
0x5b1: Push("1") // @poff=708
0x5b2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5b3: Push("2") // @poff=712
...
0x5e1: @@ add(Stack[-5]); Obj=8 // @poff=716
0x5e2: Pop(0)
0x5e3: Push((int) 1)
0x5e4: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x5e5: GOTO 0x5d6

0x5e6: @@ size(Stack[-3]); Obj=8 // @poff=720
0x5e7: Pop(0)
0x5e8: Push(Stack[-3])
...
0x5eb: Pop(0)
0x5ec: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x5ed: Pop(0)
...
0x5ff: Pop(0)
0x600: Push("scripted") // @poff=729
0x601: Push("blood_dir.xml") // @poff=747
...
0x60c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x60d: Pop(0)
...
0x662: Stack[-2] = Stack[-3]
0x663: GOTO 0x665

0x664: Stack[-1] = Stack[-3]
0x665: Return(); Pop(0)
...
0x669: Stack[-2] = Stack[-4]
0x66a: Return(); Pop(0)

0x66b: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x66c: IF (Stack[-1] == 0) GOTO 0x66f; Pop(1)

0x66d: Stack[-1] = Stack[-4]
0x66e: Return(); Pop(0)

0x66f: Stack[-3] = Stack[-4]
0x670: Return(); Pop(0)

0x671: PushEmpty(object, object)
0x672: @ CreateFloatVector(Stack[-1])
0x673: Pop(0)
0x674: @@ add(Stack[-3]); Obj=1 // @poff=716
0x675: Pop(0)
0x676: Push((int) 0)
0x677: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x678: IF (Stack[-1] == 0) GOTO 0x67d; Pop(1)

0x679: Push((float)0.699999988079071)
0x67a: Push((int) 500)
0x67b: @ RumblePlay(Stack[-2], Stack[-1])
0x67c: Pop(2)
0x67d: Push((int) 15)
0x67e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x67f: Pop(1)
0x680: Return(); Pop(2)

0x681: Stack[-1] = 0
0x682: PushEmpty(bool, bool)
0x683: @ IsPlayerActor(Stack[-3], Stack[-1])
0x684: Pop(0)
0x685: Push(Stack[-1])
0x686: IF (Stack[-1] == 0) GOTO 0x68a; Pop(1)

0x687: Push("attack") // @poff=64
0x688: @ PlayGlobalMusic(Stack[-1])
0x689: Pop(1)
0x68a: Return(); Pop(2)

0x68b: PushEmpty(object, object)
0x68c: @ GetScene(Stack[-1])
0x68d: Pop(0)
0x68e: Push("battle") // @poff=775
0x68f: PushEmpty(object)
0x690: Call2 0x64f

0x691: Pop(0)
0x692: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x693: Pop(2)
0x694: Return(); Pop(2)

0x695: Stack[-1] = 0
0x696: PushEmpty(string, string)
0x697: Stack[-1] = "idle" // @poff=789
0x698: Push(Stack[-3])
0x699: IF (Stack[-1] == 0) GOTO 0x69b; Pop(1)

0x69a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x69b: Stack[-1] = Stack[-4]
0x69c: Return(); Pop(2)

0x69d: PushEmpty(int, bool, int, bool)
0x69e: Stack[-2] = (int) 0
0x69f: Push("all") // @poff=0
0x6a0: PushEmpty(string, int)
0x6a1: Stack[-5] = Stack[-1]
0x6a2: Call2 0x696

0x6a3: Pop(1)
0x6a4: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6a5: Pop(2)
...
0x6a9: Push((int) 1)
0x6aa: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6ab: GOTO 0x69f

0x6ac: Stack[-2] = Stack[-5]
0x6ad: Return(); Pop(4)

0x6ae: PushEmpty(int, int)
0x6af: Push("branch") // @poff=799
0x6b0: @ GetVariable(Stack[-1], Stack[-2])
0x6b1: Pop(1)
0x6b2: Stack[-1] = Stack[-3]
0x6b3: Return(); Pop(2)
...
0x6b7: Pop(0)
0x6b8: Push((int) 1)
0x6b9: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x6ba: IF (Stack[-1] == 0) GOTO 0x6be; Pop(1)

0x6bb: @ WorkWithCorpse(Stack[-1])
0x6bc: Pop(0)
0x6bd: GOTO 0x6c0

0x6be: @ Barter(Stack[-1])
0x6bf: Pop(0)
0x6c0: Return(); Pop(0)

0x6c1: PushEmpty(object, int, bool, object, int, bool)
0x6c2: @ CreateInvItem(Stack[-3])
0x6c3: Pop(0)
0x6c4: @@ SetItemName(Stack[-7]); Obj=3 // @poff=813
0x6c5: Pop(0)
0x6c6: Push("Organ") // @poff=825
0x6c7: Push((int) 1)
0x6c8: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=608
0x6c9: Pop(2)
0x6ca: @@ GetItemID(Stack[-2]); Obj=3 // @poff=837
0x6cb: Pop(0)
0x6cc: Push((int) 0)
0x6cd: Push((int) 1)
0x6ce: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x6cf: Pop(2)
0x6d0: Return(); Pop(6)
...
0x6da: Stack[-1] = "liver" // @poff=847
0x6db: Call2 0x6c1

0x6dc: Pop(1)
0x6dd: PushEmpty(string)
0x6de: Stack[-1] = "kidney" // @poff=859
0x6df: Call2 0x6c1

0x6e0: Pop(1)
0x6e1: PushEmpty(string)
0x6e2: Stack[-1] = "heart" // @poff=873
0x6e3: Call2 0x6c1

0x6e4: Pop(1)
0x6e5: PushEmpty(string)
0x6e6: Stack[-1] = "blood" // @poff=885
0x6e7: Call2 0x6c1
...
0x6f3: @ GetScene(Stack[-1])
0x6f4: Pop(0)
0x6f5: PushEmpty()
0x6f6: Call2 0x6d2

0x6f7: Pop(0)
0x6f8: Push("dead") // @poff=897
0x6f9: Push((int) 1)
0x6fa: @ SetProperty(Stack[-2], Stack[-1])
0x6fb: Pop(2)
0x6fc: PushEmpty(object)
0x6fd: Stack[-4] = Stack[-1]
0x6fe: Push(-1, 0); TaskCall(3)
0x6ff: Call2 0x449

0x700: Pop(-1, 0); TaskReturn
0x701: Pop(1)
0x702: Return(); Pop(2)

0x703: Stack[-1] = 0
0x704: PushEmpty()
0x705: PushEmpty(object, int, float)
0x706: Stack[-7] = Stack[-3]
0x707: Stack[-6] = Stack[-2]
...
0x70c: PushEmpty()
0x70d: PushEmpty(object, int, float, cvector, cvector)
0x70e: Stack[-11] = Stack[-5]
0x70f: Stack[-10] = Stack[-4]
0x710: Stack[-9] = Stack[-3]
0x711: Stack[-7] = Stack[-2]
0x712: Stack[-6] = Stack[-1]
0x713: Call2 0x5fd

0x714: Pop(5)
0x715: Return(); Pop(0)

0x716: PushEmpty(float, float)
0x717: Push("health") // @poff=556
0x718: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x719: IF (Stack[-1] == 0) GOTO 0x722; Pop(1)

0x71a: Push("health") // @poff=556
