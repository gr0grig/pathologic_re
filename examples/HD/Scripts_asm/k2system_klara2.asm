...
Strings:
	...
	W:mt_klara2
	W:ACHIEVEMENT_SOMETHING
// @pool_raw:
// @pool_encoding:utf8
...
0x253: Stack[-1] = "Neutral" // @poff=89
0x254: Call2 0x19e

0x255: Pop(1)
0x256: Push((int) 538543)
0x257: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x258: Pop(1)
0x259: @@@ ClearReplies(); Obj=0 // @poff=116
0x25a: Pop(0)
...
0x2c0: Pop(0)
0x2c1: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x2c2: Pop(1)
0x2c3: PushEmpty(int)
0x2c4: Call2 0x65b

0x2c5: Pop(0)
0x2c6: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x2c7: Pop(1)
0x2c8: PushEmpty(string)
0x2c9: Call2 0x65f

0x2ca: Pop(0)
0x2cb: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x2cc: Pop(1)
0x2cd: PushEmpty(string)
0x2ce: Call2 0x661

0x2cf: Pop(0)
0x2d0: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x2d1: Pop(1)
0x2d2: PushEmpty(int)
0x2d3: Call2 0x6cf

0x2d4: Pop(0)
0x2d5: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x2d6: Pop(1)
0x2d7: Stack[-2] = (int) -1
...
0x2e1: Stack[-11] = Stack[-2]
0x2e2: Stack[-6] = Stack[-1]
0x2e3: Push(-2, 4); TaskCall(5)
0x2e4: Call2 0x2fb

0x2e5: Pop(-2, 4); TaskReturn
0x2e6: Pop(2)
0x2e7: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2e8: Pop(0)
...
0x2f5: Pop(0)
0x2f6: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2f7: Pop(0)
0x2f8: Stack[-2] = Stack[-10]
0x2f9: Return(); Pop(8)
...
0x4ea: Pop(0)
0x4eb: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x4ec: Pop(0)
...
0x4fb: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x4fc: Pop(0)
...
0x509: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x50a: Pop(0)
0x50b: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=214
0x50c: Pop(0)
...
0x532: Pop(0)
0x533: Push((bool) 1)
0x534: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x535: Pop(1)
0x536: Push(CvectorIndex(Stack[-4], 0))
0x537: Push(CvectorIndex(Stack[-5], 2))
0x538: @ Rotate(Stack[-2], Stack[-1])
0x539: Pop(2)
...
0x53f: Push("head") // @poff=228
0x540: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x541: Pop(1)
0x542: Push(Stack[-1])
0x543: IF (Stack[-1] == 0) GOTO 0x547; Pop(1)

0x544: Push("head") // @poff=228
0x545: @ LookAsyncCamera(Stack[-1])
0x546: Pop(1)
0x547: @ CameraWaitForPlayFinish()
0x548: Pop(0)
0x549: @ ResumeWorld()
0x54a: Pop(0)
0x54b: Stack[-21] = (bool) 1
0x54c: Return(); Pop(18)

0x54d: PushEmpty(bool, bool)
0x54e: Push((bool) 1)
0x54f: @ CameraSwitchToNormal(Stack[-1])
0x550: Pop(1)
...
0x556: Push("head") // @poff=228
0x557: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x558: Pop(1)
0x559: Push(Stack[-1])
0x55a: IF (Stack[-1] == 0) GOTO 0x55e; Pop(1)

0x55b: Push("head") // @poff=228
0x55c: @ UnlookAsync(Stack[-1])
0x55d: Pop(1)
0x55e: Return(); Pop(2)

0x55f: PushEmpty(int, int, int, int)
0x560: Push("voice_common") // @poff=238
0x561: @ GetVariable(Stack[-1], Stack[-3])
0x562: Pop(1)
0x563: Push(Stack[-2])
0x564: IF (Stack[-1] == 0) GOTO 0x585; Pop(1)

0x565: PushEmpty(bool, object)
0x566: Stack[-7] = Stack[-1]
0x567: Call2 0x599
...
0x571: Stack[-6] = (bool) 0
0x572: Return(); Pop(4)

0x573: Push((int) 2)
0x574: @ irand(Stack[-2], Stack[-1])
0x575: Pop(1)
0x576: Push(Stack[-1])
0x577: IF (Stack[-1] == 0) GOTO 0x580; Pop(1)

0x578: Push("voice_common") // @poff=238
0x579: Push((int) 1)
0x57a: Pop(1); Push(Stack[-4] + Stack[-1]);
0x57b: Push((int) 3)
0x57c: Pop(2); Push(Stack[-2] % Stack[-1]);
0x57d: @ SetVariable(Stack[-2], Stack[-1])
0x57e: Pop(2)
0x57f: GOTO 0x584

0x580: Push("voice_common") // @poff=238
0x581: Push((int) 0)
0x582: @ SetVariable(Stack[-2], Stack[-1])
0x583: Pop(2)
0x584: GOTO 0x597

0x585: PushEmpty(bool, object)
0x586: Stack[-7] = Stack[-1]
0x587: Call2 0x5be
...
0x591: Stack[-6] = (bool) 0
0x592: Return(); Pop(4)

0x593: Push("voice_common") // @poff=238
0x594: Push((int) 1)
0x595: @ SetVariable(Stack[-2], Stack[-1])
0x596: Pop(2)
0x597: Stack[-6] = (bool) 1
0x598: Return(); Pop(4)

0x599: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x59a: Stack[-5] = "c" // @poff=264
0x59b: Stack[-4] = (int) 0
0x59c: Push((int) 1)
0x59d: IF (Stack[-1] == 0) GOTO 0x5a9; Pop(1)

0x59e: Push((int) 1)
0x59f: Pop(1); Push(Stack[-5] + Stack[-1]);
0x5a0: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5a1: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x5a2: Pop(1)
0x5a3: Pop(0); Push((bool) Stack[-3] == 0)
0x5a4: IF (Stack[-1] == 0) GOTO 0x5a6; Pop(1)

0x5a5: GOTO 0x5a9

0x5a6: Push((int) 1)
0x5a7: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x5a8: GOTO 0x59c

0x5a9: Pop(0); Push((bool) Stack[-4] == 0)
0x5aa: IF (Stack[-1] == 0) GOTO 0x5ad; Pop(1)

0x5ab: Stack[-12] = (bool) 0
0x5ac: Return(); Pop(10)
...
0x5b1: @ irand(Stack[-2], Stack[-4])
0x5b2: Pop(0)
0x5b3: Push((int) 1)
0x5b4: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5b5: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5b6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x5b7: Pop(1)
0x5b8: PushEmpty(bool, string)
0x5b9: Stack[-3] = Stack[-1]
0x5ba: Call2 0x608

0x5bb: Stack[-2] = Stack[-14]
0x5bc: Pop(2)
0x5bd: Return(); Pop(10)

0x5be: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x5bf: Push("d") // @poff=234
0x5c0: PushEmpty(int)
0x5c1: Call2 0x63a

0x5c2: Pop(0)
0x5c3: Pop(2); Push(Stack[-2] + Stack[-1]);
0x5c4: Push("m") // @poff=292
0x5c5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5c6: Stack[-4] = (int) 0
0x5c7: Push((int) 1)
0x5c8: IF (Stack[-1] == 0) GOTO 0x5d4; Pop(1)

0x5c9: Push((int) 1)
0x5ca: Pop(1); Push(Stack[-5] + Stack[-1]);
0x5cb: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5cc: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x5cd: Pop(1)
0x5ce: Pop(0); Push((bool) Stack[-3] == 0)
0x5cf: IF (Stack[-1] == 0) GOTO 0x5d1; Pop(1)

0x5d0: GOTO 0x5d4

0x5d1: Push((int) 1)
0x5d2: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x5d3: GOTO 0x5c7

0x5d4: Pop(0); Push((bool) Stack[-4] == 0)
0x5d5: IF (Stack[-1] == 0) GOTO 0x5d8; Pop(1)

0x5d6: Stack[-12] = (bool) 0
0x5d7: Return(); Pop(10)

0x5d8: Stack[-2] = (int) 0
0x5d9: Push((int) 1)
0x5da: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x5db: IF (Stack[-1] == 0) GOTO 0x5de; Pop(1)

0x5dc: @ irand(Stack[-2], Stack[-4])
0x5dd: Pop(0)
0x5de: Push((int) 1)
0x5df: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5e0: Pop(1); Push(Stack[-6] + Stack[-1]);
0x5e1: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x5e2: Pop(1)
0x5e3: PushEmpty(bool, string)
0x5e4: Stack[-3] = Stack[-1]
0x5e5: Call2 0x608

0x5e6: Stack[-2] = Stack[-14]
0x5e7: Pop(2)
0x5e8: Return(); Pop(10)

0x5e9: PushEmpty(bool, float, float, bool, float, float)
0x5ea: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5eb: Pop(0)
0x5ec: Push(Stack[-3])
0x5ed: IF (Stack[-1] == 0) GOTO 0x5f4; Pop(1)

0x5ee: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5ef: Pop(0)
0x5f0: Push((bool) 0)
0x5f1: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5f2: Pop(1)
0x5f3: GOTO 0x5f8

0x5f4: Push("Can't find lsh animation : ") // @poff=296
0x5f5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x5f6: @ Trace(Stack[-1])
0x5f7: Pop(1)
0x5f8: Return(); Pop(6)

0x5f9: PushEmpty(bool, float, float, bool, float, float)
0x5fa: @ lshHasAnimation(Stack[-3], Stack[-8])
0x5fb: Pop(0)
0x5fc: Push(Stack[-3])
0x5fd: IF (Stack[-1] == 0) GOTO 0x603; Pop(1)

0x5fe: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x5ff: Pop(0)
0x600: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x601: Pop(0)
0x602: GOTO 0x607

0x603: Push("Can't find lsh animation : ") // @poff=296
0x604: Pop(1); Push(Stack[-1] + Stack[-9]);
0x605: @ Trace(Stack[-1])
0x606: Pop(1)
0x607: Return(); Pop(6)
...
0x60d: @ lshHasSpeech(Stack[-1], Stack[-3])
0x60e: Pop(0)
0x60f: Push(Stack[-1])
0x610: IF (Stack[-1] == 0) GOTO 0x615; Pop(1)

0x611: @ lshPlaySpeech(Stack[-3])
0x612: Pop(0)
0x613: Stack[-4] = (bool) 1
0x614: Return(); Pop(2)

0x615: Stack[-4] = (bool) 0
0x616: Return(); Pop(2)
...
0x625: Pop(0); Push(Stack[-3] | Stack[-3]);
0x626: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x627: Push((float)9.999999974752427e-07)
0x628: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x629: IF (Stack[-1] == 0) GOTO 0x62c; Pop(1)

0x62a: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x62b: Return(); Pop(2)

0x62c: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x62d: Return(); Pop(2)
...
0x643: PushEmpty(string, string)
0x644: Stack[-1] = "idle" // @poff=146
0x645: Push(Stack[-3])
0x646: IF (Stack[-1] == 0) GOTO 0x648; Pop(1)

0x647: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x648: Stack[-1] = Stack[-4]
0x649: Return(); Pop(2)

0x64a: PushEmpty(int, bool, int, bool)
0x64b: Stack[-2] = (int) 0
0x64c: Push("all") // @poff=138
0x64d: PushEmpty(string, int)
0x64e: Stack[-5] = Stack[-1]
0x64f: Call2 0x643

0x650: Pop(1)
0x651: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x652: Pop(2)
0x653: Pop(0); Push((bool) Stack[-1] == 0)
0x654: IF (Stack[-1] == 0) GOTO 0x656; Pop(1)

0x655: GOTO 0x659

0x656: Push((int) 1)
0x657: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x658: GOTO 0x64c

0x659: Stack[-2] = Stack[-5]
0x65a: Return(); Pop(4)

0x65b: Stack[-1] = (int) 515540
0x65c: Return(); Pop(0)

0x65d: Stack[-1] = (int) 502865
0x65e: Return(); Pop(0)

0x65f: Stack[-1] = "ui/NPC_Klara.png" // @poff=352
0x660: Return(); Pop(0)

0x661: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=386
0x662: Return(); Pop(0)
...
0x673: Stack[-2] = "klara2_positioner" // @poff=436
0x674: Stack[-1] = "remove_klara" // @poff=472
0x675: Call2 0x62e
...
0x678: PushEmpty()
0x679: PushEmpty(bool, string, string)
0x67a: Stack[-2] = "klara2_svita_positioner" // @poff=498
0x67b: Stack[-1] = "place_svita" // @poff=546
0x67c: Call2 0x62e
...
0x67f: PushEmpty()
0x680: PushEmpty(bool, string, string)
0x681: Stack[-2] = "klara2_positioner" // @poff=436
0x682: Stack[-1] = "klara_stay" // @poff=570
0x683: Call2 0x62e
...
0x6a5: Stack[-2] = (bool) 1
0x6a6: Return(); Pop(0)

0x6a7: Stack[-2] = (bool) 0
0x6a8: Return(); Pop(0)
...
0x6af: Stack[-2] = (bool) 1
0x6b0: Return(); Pop(0)

0x6b1: Stack[-2] = (bool) 0
0x6b2: Return(); Pop(0)

0x6b3: PushEmpty()
0x6b4: PushEmpty(bool, string)
0x6b5: Stack[-1] = "Late1" // @poff=424
0x6b6: Call2 0x6eb
...
0x6ba: PushEmpty()
0x6bb: PushEmpty(bool, string)
0x6bc: Stack[-1] = "1" // @poff=432
0x6bd: Call2 0x6eb
...
0x6c4: Pop(0)
0x6c5: Push((int) 6)
0x6c6: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x6c7: Return(); Pop(0)
...
0x6cb: Pop(0)
0x6cc: Push((int) 7)
0x6cd: Stack[-4] = Stack[-2] == Stack[-1]; Pop(2);
0x6ce: Return(); Pop(0)

0x6cf: PushEmpty(int, int)
0x6d0: Push("branch") // @poff=592
...
0x6e0: PushEmpty(int, int)
0x6e1: Push("day") // @poff=606
0x6e2: @ GetProperty(Stack[-1], Stack[-2])
0x6e3: Pop(1)
0x6e4: Push("K2S_Klara2") // @poff=614
0x6e5: Pop(1); Push(Stack[-1] + Stack[-4]);
0x6e6: Pop(1); Push(Stack[-1] + Stack[-2]);
0x6e7: Push((int) 1)
0x6e8: @ SetVariable(Stack[-2], Stack[-1])
0x6e9: Pop(2)
0x6ea: Return(); Pop(2)

0x6eb: PushEmpty(int, int, int, int)
0x6ec: Push("day") // @poff=606
0x6ed: @ GetProperty(Stack[-1], Stack[-3])
0x6ee: Pop(1)
0x6ef: Push("K2S_Klara2") // @poff=614
0x6f0: Pop(1); Push(Stack[-1] + Stack[-6]);
0x6f1: Pop(1); Push(Stack[-1] + Stack[-3]);
0x6f2: @ GetVariable(Stack[-1], Stack[-2])
0x6f3: Pop(1)
0x6f4: Push((int) 0)
0x6f5: Stack[-7] = Stack[-2] == Stack[-1]; Pop(1);
0x6f6: Return(); Pop(4)

0x6f7: PushEmpty(int, int)
0x6f8: Push("k2system_klara_day") // @poff=636
0x6f9: @ GetVariable(Stack[-1], Stack[-2])
0x6fa: Pop(1)
...
0x701: Pop(1)
0x702: Push("k2system_klara_state") // @poff=674
0x703: Pop(1); Push(Stack[-1] + Stack[-2]);
0x704: @ SetVariable(Stack[-1], Stack[-4])
0x705: Pop(1)
0x706: Return(); Pop(2)
...
0x70c: PushEmpty(int, int, int, int)
0x70d: Push("mt_klara2") // @poff=716
0x70e: @ GetVariable(Stack[-1], Stack[-3])
0x70f: Pop(1)
0x710: Pop(0); Push((bool) Stack[-2] == 0)
0x711: IF (Stack[-1] == 0) GOTO 0x71f; Pop(1)

0x712: PushEmpty(int, object)
0x713: Stack[-7] = Stack[-1]
0x714: Push(-2, 1); TaskCall(0)
0x715: Call2 0x0

0x716: Pop(-2, 1); TaskReturn
0x717: Pop(2)
0x718: Push("mt_klara2") // @poff=716
0x719: Push((int) 1)
0x71a: @ SetVariable(Stack[-2], Stack[-1])
0x71b: Pop(2)
0x71c: Push("ACHIEVEMENT_SOMETHING") // @poff=736
0x71d: @ UnlockAchievement(Stack[-1])
0x71e: Pop(1)
0x71f: Push("day") // @poff=606
0x720: @ GetProperty(Stack[-1], Stack[-2])
0x721: Pop(1)
0x722: PushEmpty(int)
0x723: Call2 0x63a
...
0x727: PushEmpty(int, object)
0x728: Stack[-7] = Stack[-1]
0x729: Push(-2, 1); TaskCall(2)
0x72a: Call2 0x110

0x72b: Pop(-2, 1); TaskReturn
0x72c: Pop(2)
0x72d: GOTO 0x734

0x72e: PushEmpty(int, object)
0x72f: Stack[-7] = Stack[-1]
0x730: Push(-2, 1); TaskCall(4)
0x731: Call2 0x2b1

0x732: Pop(-2, 1); TaskReturn
0x733: Pop(2)
0x734: Return(); Pop(4)
