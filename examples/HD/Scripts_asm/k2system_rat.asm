...
Strings:
	...
	A:SetItemName
	W:quality
// @pool_raw:
...
Events:
EVENT_41 Op = 0x51d Vars = (object)
EVENT_6 Op = 0x54a Vars = ()
...
0x4a8: @ GetScene(Stack[-1])
0x4a9: Pop(0)
0x4aa: Push("battle") // @poff=458
0x4ab: PushEmpty(object)
0x4ac: Call2 0x449

0x4ad: Pop(0)
0x4ae: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x4af: Pop(2)
0x4b0: Return(); Pop(2)

0x4b1: Stack[-1] = 0
0x4b2: PushEmpty()
0x4b3: PushEmpty(bool, object)
...
0x4cb: Push(-1, 1); TaskCall(3)
0x4cc: Call2 0xe4

0x4cd: Pop(-1, 1); TaskReturn
0x4ce: Pop(1)
0x4cf: @ ResetAAS()
0x4d0: Pop(0)
0x4d1: Return(); Pop(0)
...
0x4d5: Push(-1, 1); TaskCall(3)
0x4d6: Call2 0xe4

0x4d7: Pop(-1, 1); TaskReturn
0x4d8: Pop(1)
0x4d9: @ ResetAAS()
0x4da: Pop(0)
0x4db: Return(); Pop(0)
...
0x4dc: PushEmpty()
0x4dd: PushEmpty()
0x4de: Push(-0, 0); TaskCall(2)
0x4df: Call2 0xb3

0x4e0: Pop(-0, 0); TaskReturn
0x4e1: Pop(0)
0x4e2: Return(); Pop(0)

0x4e3: PushEmpty(float, bool, float, bool)
0x4e4: Push("health") // @poff=0
0x4e5: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x4e6: IF (Stack[-1] == 0) GOTO 0x4fc; Pop(1)

0x4e7: Push("health") // @poff=0
0x4e8: @ GetProperty(Stack[-1], Stack[-3])
0x4e9: Pop(1)
0x4ea: Push(GlobalVars[0])
0x4eb: Stack[-2] = Stack[-3] < Stack[-1]; Pop(1);
0x4ec: Push(GlobalVars[0])
0x4ed: Stack[-3] = Stack[-1]
0x4ee: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x4fc: Stack[-7] = (bool) 0
0x4fd: Return(); Pop(4)

0x4fe: PushEmpty(float, float)
0x4ff: Push("health") // @poff=0
0x500: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x501: IF (Stack[-1] == 0) GOTO 0x51c; Pop(1)

0x502: Push("health") // @poff=0
0x503: @ GetProperty(Stack[-1], Stack[-2])
0x504: Pop(1)
0x505: Push((int) 0)
0x506: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x507: IF (Stack[-1] == 0) GOTO 0x50a; Pop(1)

0x508: @ SignalDeath(Stack[-4])
0x509: Pop(0)
0x50a: PushEmpty(bool)
0x50b: Stack[-1] = (bool) 0
0x50c: Push(GlobalVars[0])
...
0x518: Push(-1, 4); TaskCall(5)
0x519: Call2 0x25f

0x51a: Pop(-1, 4); TaskReturn
0x51b: Pop(1)
0x51c: Return(); Pop(2)
...
0x523: PushEmpty(float, float)
0x524: PushEmpty(float, object, float, int)
0x525: Stack[-7] = Stack[-3]
0x526: Stack[-2] = (float) 0.02500000037252903
0x527: Stack[-1] = (int) 0
0x528: Call2 0x396

0x529: Stack[-4] = Stack[-5]
0x52a: Pop(4)
0x52b: Push((int) 7)
0x52c: Push((float)0.02500000037252903)
0x52d: @ ReportHit(Stack[-5], Stack[-2], Stack[-3], Stack[-1])
0x52e: Pop(2)
0x52f: Return(); Pop(2)

0x530: PushEmpty(object, float, object, float)
0x531: @ CreateInvItem(Stack[-2])
0x532: Pop(0)
0x533: Push("rat") // @poff=472
0x534: @@ SetItemName(Stack[-1]); Obj=3 // @poff=480
0x535: Pop(1)
0x536: Push((float)0.25)
0x537: Push((float)0.5)
0x538: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x539: Pop(2)
0x53a: Push("quality") // @poff=492
0x53b: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=348
0x53c: Pop(1)
0x53d: PushEmpty(object, object, int)
0x53e: Stack[-8] = Stack[-3]
0x53f: Stack[-5] = Stack[-2]
0x540: Stack[-1] = (int) 1
0x541: Call2 0x483
