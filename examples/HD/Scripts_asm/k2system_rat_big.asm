...
0x503: Push((float)0.699999988079071)
0x504: Push((int) 500)
...
0x528: Stack[-3] = Stack[-1]
0x529: Call2 0x517

0x52a: Stack[-2] = Stack[-4]
0x52b: Pop(2)
0x52c: Return(); Pop(0)
...
0x58a: Stack[-7] = Stack[-3]
0x58b: Stack[-2] = (float) 0.019999999552965164
0x58c: Stack[-1] = (int) 0
0x58d: Call2 0x3ac

0x58e: Stack[-4] = Stack[-5]
0x58f: Pop(4)
0x590: Push((int) 7)
0x591: Push((float)0.019999999552965164)
0x592: @ ReportHit(Stack[-5], Stack[-2], Stack[-3], Stack[-1])
0x593: Pop(2)
0x594: PushEmpty(float, object, float)
0x595: Stack[-6] = Stack[-2]
0x596: Stack[-1] = (float) 0.05000000074505806
0x597: Call2 0x3f5

0x598: Stack[-3] = Stack[-4]
0x599: Pop(3)
0x59a: Push((int) 5)
0x59b: Push((float)0.05000000074505806)
...
0x5a1: Pop(0)
0x5a2: Push("rat_big") // @poff=534
0x5a3: @@ SetItemName(Stack[-1]); Obj=3 // @poff=550
0x5a4: Pop(1)
0x5a5: Push((float)0.5)
0x5a6: Push((int) 1)
0x5a7: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x5a8: Pop(2)
0x5a9: Push("quality") // @poff=562
0x5aa: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=322
0x5ab: Pop(1)
0x5ac: PushEmpty(object, object, int)
0x5ad: Stack[-8] = Stack[-3]
