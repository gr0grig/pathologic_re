...
0x7b4: Push((float)0.699999988079071)
0x7b5: Push((int) 500)
...
0x7bf: Pop(0)
0x7c0: @@ add(Stack[-3]); Obj=1 // @poff=818
0x7c1: Pop(0)
0x7c2: Push((int) 16)
...
0x80b: Pop(0)
0x80c: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=110
0x80d: Pop(1)
0x80e: Return(); Pop(2)
...
0x817: Stack[-4] = Stack[-2]
0x818: Stack[-1] = (float) -0.10000000149011612
0x819: Call2 0x789
...
0x827: Stack[-7] = Stack[-3]
0x828: Stack[-6] = Stack[-2]
0x829: Stack[-5] = Stack[-1]
0x82a: Call2 0x6c9
...
0x82f: Stack[-11] = Stack[-5]
0x830: Stack[-10] = Stack[-4]
0x831: Stack[-9] = Stack[-3]
0x832: Stack[-7] = Stack[-2]
...
0x843: Stack[-2] = Stack[-4]
0x844: Pop(2)
0x845: Return(); Pop(0)

0x846: PushEmpty()
0x847: PushEmpty(object, bool)
0x848: Stack[-3] = Stack[-2]
