...
0x4a: Stack[-10] = Stack[-1]
0x4b: Call2 0x1ce

0x4c: Pop(1)
0x4d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4e: Push("_albinos") // @poff=104
0x4f: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x50: Stack[-2] = "pers_rat" // @poff=122
0x51: Stack[-1] = "k2system_rat.xml" // @poff=140
0x52: Call2 0x126
...
0x61: Push("_patrol") // @poff=174
0x62: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x63: Stack[-2] = "pers_rat_big" // @poff=190
0x64: Stack[-1] = "k2system_rat_big.xml" // @poff=216
0x65: Call2 0x126
...
0x6d: Stack[-6] = Stack[-4]
0x6e: Push("pt_k2system") // @poff=80
0x6f: PushEmpty(int, int)
0x70: Stack[-10] = Stack[-1]
0x71: Call2 0x1ce

0x72: Pop(1)
0x73: Pop(2); Push(Stack[-2] + Stack[-1]);
0x74: Push("_nude") // @poff=258
0x75: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x76: Stack[-2] = "pers_rat" // @poff=122
0x77: Stack[-1] = "k2system_rat.xml" // @poff=140
0x78: Call2 0x126
...
0x80: Stack[-6] = Stack[-4]
0x81: Push("pt_k2system") // @poff=80
0x82: PushEmpty(int, int)
0x83: Stack[-10] = Stack[-1]
0x84: Call2 0x1ce

0x85: Pop(1)
0x86: Pop(2); Push(Stack[-2] + Stack[-1]);
0x87: Push("_dohodyaga1") // @poff=270
0x88: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x89: Stack[-2] = "pers_rat_big" // @poff=190
0x8a: Stack[-1] = "k2system_rat_big.xml" // @poff=216
0x8b: Call2 0x126
...
0x94: Push("pt_k2system") // @poff=80
0x95: PushEmpty(int, int)
0x96: Stack[-10] = Stack[-1]
0x97: Call2 0x1ce

0x98: Pop(1)
0x99: Pop(2); Push(Stack[-2] + Stack[-1]);
0x9a: Push("_dohodyaga2") // @poff=294
0x9b: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x9c: Stack[-2] = "pers_rat" // @poff=122
0x9d: Stack[-1] = "k2system_rat.xml" // @poff=140
0x9e: Call2 0x126
...
0xb4: Stack[-6] = Stack[-4]
0xb5: Push("pt_k2system") // @poff=80
0xb6: PushEmpty(int, int)
0xb7: Stack[-11] = Stack[-1]
0xb8: Call2 0x1ce

0xb9: Pop(1)
0xba: Pop(2); Push(Stack[-2] + Stack[-1]);
0xbb: Push("_albinos") // @poff=104
0xbc: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xbd: Stack[-2] = "pers_albinos" // @poff=318
0xbe: Push("k2system") // @poff=86
0xbf: Pop(1); Push(Stack[-1] + Stack[-9]);
0xc0: Push("_albinos.xml") // @poff=344
0xc1: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xc2: Call2 0x138

0xc3: Pop(4)
0xc4: @@@ add(Stack[-1]); Obj=0 // @poff=370
0xc5: Pop(1)
0xc6: PushEmpty(object, object, string, string, string)
0xc7: Stack[-6] = Stack[-4]
0xc8: Push("pt_k2system") // @poff=80
0xc9: PushEmpty(int, int)
0xca: Stack[-11] = Stack[-1]
0xcb: Call2 0x1ce

0xcc: Pop(1)
0xcd: Pop(2); Push(Stack[-2] + Stack[-1]);
0xce: Push("_patrol") // @poff=174
0xcf: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xd0: Stack[-2] = "pers_patrool" // @poff=374
0xd1: Push("k2system") // @poff=86
0xd2: Pop(1); Push(Stack[-1] + Stack[-9]);
0xd3: Push("_patrol.xml") // @poff=400
0xd4: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xd5: Call2 0x138

0xd6: Pop(4)
0xd7: @@@ add(Stack[-1]); Obj=0 // @poff=370
0xd8: Pop(1)
0xd9: PushEmpty(object, object, string, string, string)
0xda: Stack[-6] = Stack[-4]
0xdb: Push("pt_k2system") // @poff=80
0xdc: PushEmpty(int, int)
0xdd: Stack[-11] = Stack[-1]
0xde: Call2 0x1ce

0xdf: Pop(1)
0xe0: Pop(2); Push(Stack[-2] + Stack[-1]);
0xe1: Push("_nude") // @poff=258
0xe2: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xe3: Stack[-2] = "pers_nudegirl" // @poff=424
0xe4: Push("k2system") // @poff=86
0xe5: Pop(1); Push(Stack[-1] + Stack[-9]);
0xe6: Push("_nude.xml") // @poff=452
0xe7: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xe8: Call2 0x138

0xe9: Pop(4)
0xea: @@@ add(Stack[-1]); Obj=0 // @poff=370
0xeb: Pop(1)
0xec: PushEmpty(object, object, string, string, string)
0xed: Stack[-6] = Stack[-4]
0xee: Push("pt_k2system") // @poff=80
0xef: PushEmpty(int, int)
0xf0: Stack[-11] = Stack[-1]
0xf1: Call2 0x1ce

0xf2: Pop(1)
0xf3: Pop(2); Push(Stack[-2] + Stack[-1]);
0xf4: Push("_dohodyaga1") // @poff=270
0xf5: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0xf6: Stack[-2] = "pers_dohodyaga" // @poff=472
0xf7: Push("k2system") // @poff=86
0xf8: Pop(1); Push(Stack[-1] + Stack[-9]);
0xf9: Push("_dohodyaga1.xml") // @poff=502
0xfa: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xfb: Call2 0x138

0xfc: Pop(4)
0xfd: @@@ add(Stack[-1]); Obj=0 // @poff=370
0xfe: Pop(1)
0xff: PushEmpty(object, object, string, string, string)
0x100: Stack[-6] = Stack[-4]
0x101: Push("pt_k2system") // @poff=80
0x102: PushEmpty(int, int)
0x103: Stack[-11] = Stack[-1]
0x104: Call2 0x1ce

0x105: Pop(1)
0x106: Pop(2); Push(Stack[-2] + Stack[-1]);
0x107: Push("_dohodyaga2") // @poff=294
0x108: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x109: Stack[-2] = "pers_dohodyaga" // @poff=472
0x10a: Push("k2system") // @poff=86
0x10b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x10c: Push("_dohodyaga2.xml") // @poff=534
0x10d: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x10e: Call2 0x138

0x10f: Pop(4)
0x110: @@@ add(Stack[-1]); Obj=0 // @poff=370
0x111: Pop(1)
0x112: Return(); Pop(2)
...
0x127: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=572
0x128: Pop(0)
0x129: Pop(0); Push((bool) Stack[-4] == 0)
0x12a: IF (Stack[-1] == 0) GOTO 0x133; Pop(1)

0x12b: Push("Locator ") // @poff=583
0x12c: Pop(1); Push(Stack[-1] + Stack[-12]);
0x12d: Push(" doesn't exist") // @poff=601
...
0x145: @@ AddStationaryActor(Stack[-1], Stack[-3], Stack[-2], Stack[-10], Stack[-9]); Obj=12 // @poff=631
0x146: Pop(0)
0x147: Stack[-1] = Stack[-13]
0x148: Return(); Pop(8)
...
0x162: @@ size(Stack[-4]); Obj=10 // @poff=650
0x163: Pop(0)
0x164: Stack[-3] = (int) 0
0x165: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x166: IF (Stack[-1] == 0) GOTO 0x176; Pop(1)

0x167: @@ get(Stack[-2], Stack[-3]); Obj=10 // @poff=655
0x168: Pop(0)
0x169: Push(Stack[-2])
0x16a: IF (Stack[-1] == 0) GOTO 0x172; Pop(1)

0x16b: @@ GetActor(Stack[-1]); Obj=2 // @poff=666
0x16c: Pop(0)
0x16d: Push(Stack[-1])
...
0x19f: Push("Can't retrieve diary root") // @poff=675
0x1a0: @ Trace(Stack[-1])
0x1a1: Pop(1)
0x1a2: Stack[-3] = (bool) 0
0x1a3: Return(); Pop(2)

0x1a4: Stack[-1] = Stack[-3]
0x1a5: Return(); Pop(2)
...
0x1aa: Stack[-1] = Stack[-4]
0x1ab: Pop(1)
0x1ac: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=727
0x1ad: Pop(0)
0x1ae: Pop(0); Push((bool) Stack[-2] == 0)
0x1af: IF (Stack[-1] == 0) GOTO 0x1b6; Pop(1)

0x1b0: Push("Can't find diary parent with id: ") // @poff=732
...
0x1b6: @@ AddChild(Stack[-8]); Obj=2 // @poff=800
0x1b7: Pop(0)
0x1b8: Push((int) 7)
0x1b9: @ SendWorldWndMessage(Stack[-1])
0x1ba: Pop(1)
0x1bb: @@ GetCategory(Stack[-1]); Obj=8 // @poff=809
0x1bc: Pop(0)
...
0x1c2: Stack[-3] = 0
0x1c3: PushEmpty()
0x1c4: Push("K2SystemSvitaRemoved") // @poff=821
