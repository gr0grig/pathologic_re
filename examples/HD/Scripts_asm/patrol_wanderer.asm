...
Strings:
	...
	W:hunter
	W:grabitel
// @pool_raw:
...
0xa2: Push("all") // @poff=16
0xa3: Push("idle") // @poff=24
...
0xd1: Stack[-1] = "Neutral" // @poff=0
0xd2: Call2 0xb1

0xd3: Pop(1)
0xd4: Push((int) 537930)
0xd5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=123
0xd6: Pop(1)
0xd7: @@@ ClearReplies(); Obj=0 // @poff=134
0xd8: Pop(0)
...
0x14b: Stack[-7] = Stack[-3]
0x14c: Stack[-6] = Stack[-2]
...
0x173: Stack[-7] = Stack[-1]
0x174: Call2 0x1af

0x175: Stack[-2] = Stack[-4]
0x176: Pop(2)
...
0x1ec: Stack[-7] = Stack[-3]
0x1ed: Stack[-6] = Stack[-2]
0x1ee: Stack[-5] = Stack[-1]
0x1ef: Call2 0xc15
...
0x219: Pop(0)
0x21a: Push("all") // @poff=16
0x21b: PushEmpty(string, int)
0x21c: Stack[-7] = Stack[-1]
0x21d: Call2 0x95e
...
0x255: Stack[-7] = Stack[-3]
0x256: Stack[-6] = Stack[-2]
...
0x27a: Stack[-15] = Stack[-5]
0x27b: Stack[-14] = Stack[-4]
0x27c: Stack[-13] = Stack[-3]
0x27d: Stack[-12] = Stack[-2]
0x27e: Stack[-11] = Stack[-1]
0x27f: Call2 0x2c4

0x280: Stack[-6] = Stack[-7]
0x281: Pop(6)
0x282: Push( Stack[2 + Tasks[-1].StackPointer] )
0x283: IF (Stack[-1] == 0) GOTO 0x287; Pop(1)

0x284: Push("head") // @poff=156
0x285: @ UnlookAsync(Stack[-1])
0x286: Pop(1)
0x287: Push((int) 1)
0x288: @ KillTimer(Stack[-1])
0x289: Pop(1)
0x28a: Stack[-1] = Stack[-10]
0x28b: Return(); Pop(4)
...
0x2c7: Stack[-17] = Stack[-7]
0x2c8: PushEmpty(bool, object)
0x2c9: Stack[-23] = Stack[-1]
0x2ca: Call2 0x350
...
0x2d0: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x2d1: Pop(0)
...
0x2e7: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=178
0x2e8: Pop(0)
...
0x2f9: Push((int) 0)
0x2fa: Push((float)0.30000001192092896)
...
0x31c: Push((int) 0)
0x31d: Push((float)0.30000001192092896)
...
0x354: Stack[-2] = Stack[-4]
0x355: Pop(2)
0x356: Return(); Pop(0)

0x357: Stack[-1] = "walk" // @poff=192
0x358: Return(); Pop(0)

0x359: Stack[-1] = "run" // @poff=202
0x35a: Return(); Pop(0)

0x35b: PushEmpty()
0x35c: PushEmpty(object, bool, float)
0x35d: Stack[-5] = Stack[-3]
0x35e: Stack[-4] = Stack[-2]
...
0x363: PushEmpty()
0x364: Stack[-3] = (float) 0.10000000149011612
0x365: Return(); Pop(0)
...
0x371: Stack[-7] = Stack[-3]
0x372: Stack[-6] = Stack[-2]
0x373: Stack[-5] = Stack[-1]
0x374: Call2 0xc15
...
0x38c: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x38d: Pop(0)
0x38e: Push(Stack[-8])
0x38f: IF (Stack[-1] == 0) GOTO 0x398; Pop(1)

0x390: Push("attack") // @poff=266
...
0x3ac: Pop(0)
0x3ad: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=178
0x3ae: Pop(0)
...
0x3c8: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=178
0x3c9: Pop(0)
...
0x3e2: Pop(1)
0x3e3: Push("all") // @poff=16
0x3e4: Push("attack_on") // @poff=280
...
0x3fa: Push((float)0.6000000238418579)
0x3fb: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x3fc: IF (Stack[-1] == 1) GOTO 0x402; Pop(1)
...
0x403: @ Face(Stack[-0]T)
0x404: Pop(0)
0x405: PushEmpty()
0x406: Call2 0x600

0x407: Pop(0)
0x408: Push("all") // @poff=16
0x409: Push("attack_stay") // @poff=300
0x40a: @ PlayAnimation(Stack[-2], Stack[-1])
0x40b: Pop(2)
0x40c: PushEmpty(bool, float)
0x40d: Stack[-25] = Stack[-1]
0x40e: Call2 0x54a
...
0x413: @ Face(Stack[-0]T)
0x414: Pop(0)
0x415: Push("all") // @poff=16
0x416: Push("fjump") // @poff=324
...
0x431: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=178
0x432: Pop(0)
...
0x450: Push("all") // @poff=16
0x451: Push("attack_off") // @poff=336
...
0x45e: Push("all") // @poff=16
0x45f: Push("attack_begin") // @poff=358
0x460: Push((int) 1)
0x461: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x46c: Push("attack") // @poff=266
0x46d: Push((int) 1)
0x46e: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x478: Push("all") // @poff=16
0x479: Push("bjump") // @poff=384
...
0x480: Push((float)0.8999999761581421)
0x481: Pop(1); Push(Stack[-9] * Stack[-1]);
0x482: @ GetVictim(Stack[-1], Stack[-4])
0x483: Pop(1)
0x484: @ ReportAttack(Stack[-0]T)
0x485: Pop(0)
...
0x489: Stack[-6] = Stack[-2]
0x48a: Stack[-10] = Stack[-1]
0x48b: Call2 0x363

0x48c: Stack[-3] = Stack[-5]
0x48d: Pop(3)
0x48e: PushEmpty(float, object, float, int)
0x48f: Stack[-7] = Stack[-3]
0x490: Stack[-6] = Stack[-2]
0x491: PushEmpty(int, object, int)
0x492: Stack[-10] = Stack[-2]
0x493: Stack[-14] = Stack[-1]
0x494: Call2 0x366

0x495: Stack[-3] = Stack[-4]
0x496: Pop(3)
0x497: Call2 0x6e3

0x498: Stack[-4] = Stack[-5]
0x499: Pop(4)
0x49a: PushEmpty(int)
0x49b: Call2 0x5fe

0x49c: Pop(0)
0x49d: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x49e: Pop(1)
0x49f: PushEmpty(object, float)
0x4a0: Stack[-5] = Stack[-2]
...
0x4a9: Pop(0)
0x4aa: @ irand(Stack[-4], Stack[-1]T)
0x4ab: Pop(0)
0x4ac: Push((int) 1)
0x4ad: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x4ae: @ Face(Stack[-0]T)
0x4af: Pop(0)
0x4b0: Push((bool) 1)
...
0x4b7: Push("attack_begin") // @poff=358
...
0x4cb: Stack[-11] = Stack[-2]
0x4cc: Stack[-6] = Stack[-1]
0x4cd: Call2 0x47f

0x4ce: Pop(2)
0x4cf: Push("all") // @poff=16
0x4d0: Push("attack_middle") // @poff=396
...
0x4d8: Pop(0)
0x4d9: Push("all") // @poff=16
0x4da: Push("attack_middle") // @poff=396
...
0x4ee: Stack[-11] = Stack[-2]
0x4ef: Stack[-6] = Stack[-1]
0x4f0: Call2 0x47f

0x4f1: Pop(2)
0x4f2: Stack[-2] = (int) 1
0x4f3: Push("attack_middle") // @poff=396
0x4f4: Pop(1); Push(Stack[-1] + Stack[-5]);
0x4f5: Push("_") // @poff=424
0x4f6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4f7: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x4f8: Push("all") // @poff=16
...
0x51d: Pop(1)
0x51e: Push("all") // @poff=16
0x51f: Push("attack_end") // @poff=428
...
0x55e: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=178
0x55f: Pop(0)
...
0x5aa: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x5ab: Pop(1)
...
0x5af: @ Face(Stack[-0]T)
0x5b0: Pop(0)
0x5b1: Push("all") // @poff=16
0x5b2: Push("bjump") // @poff=384
0x5b3: @ PlayAnimation(Stack[-2], Stack[-1])
0x5b4: Pop(2)
0x5b5: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=178
0x5b6: Pop(0)
...
0x5ec: @ irand(Stack[-1], Stack[-2]T)
0x5ed: Pop(0)
0x5ee: Push((int) 1)
0x5ef: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x5f0: Push("attack") // @poff=266
...
0x601: Stack[-1] = "attack_stay" // @poff=300
0x602: Call2 0x8da
...
0x63b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x63c: IF (Stack[-1] == 0) GOTO 0x642; Pop(1)

0x63d: PushEmpty(string)
0x63e: Stack[-1] = "fdie" // @poff=486
0x63f: Call2 0x695

0x640: Pop(1)
0x641: GOTO 0x694

0x642: @@ GetPosition(Stack[-10]); Obj=21 // @poff=166
0x643: Pop(0)
...
0x653: Stack[-6] = "fdie" // @poff=486
0x654: GOTO 0x656

0x655: Stack[-6] = "bdie" // @poff=496
...
0x65c: @ StopAsync()
0x65d: Pop(0)
0x65e: Stack[-21] = Stack[-5]
0x65f: Push("GetScriptProperty") // @poff=506
0x660: Push((int) 2)
0x661: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x662: IF (Stack[-1] == 0) GOTO 0x66e; Pop(1)

0x663: Push("Owner") // @poff=542
0x664: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=554
0x665: Pop(1)
0x666: Push(Stack[-4])
0x667: IF (Stack[-1] == 0) GOTO 0x66e; Pop(1)

0x668: Push("Owner") // @poff=542
0x669: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=572
0x66a: Pop(1)
0x66b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x66c: IF (Stack[-1] == 0) GOTO 0x66e; Pop(1)

0x66d: Stack[-21] = Stack[-5]
0x66e: Push("@GetEyesHeight") // @poff=590
0x66f: Push((int) 1)
0x670: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x671: IF (Stack[-1] == 0) GOTO 0x67d; Pop(1)

0x672: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=620
0x673: Pop(0)
...
0x67f: Stack[-7] = Stack[-1]
0x680: Call2 0x8da

0x681: Pop(1)
0x682: Push("all") // @poff=16
...
0x689: @ StopAsync()
0x68a: Pop(0)
0x68b: Push("head") // @poff=156
0x68c: @ UnlookAsync(Stack[-1])
0x68d: Pop(1)
0x68e: Push("all") // @poff=16
...
0x6bf: Stack[-2] = "bullet" // @poff=644
0x6c0: Return(); Pop(0)

0x6c1: Stack[-2] = "phys" // @poff=658
0x6c2: Return(); Pop(0)

0x6c3: PushEmpty(cvector, cvector, cvector, cvector)
0x6c4: @ GetPosition(Stack[-2])
0x6c5: Pop(0)
0x6c6: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x6c7: Pop(0)
...
0x6cc: Pop(0)
0x6cd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0x6ce: Pop(0)
...
0x6d8: Push("HasProperty") // @poff=668
0x6d9: Push((int) 2)
...
0x6df: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x6e0: Pop(0)
...
0x6e5: Stack[-18] = Stack[-2]
0x6e6: Stack[-1] = "health" // @poff=704
0x6e7: Call2 0x6d7
...
0x6ee: Stack[-18] = Stack[-2]
0x6ef: Stack[-1] = "armor" // @poff=718
0x6f0: Call2 0x6d7
...
0x6f6: Push("armor") // @poff=718
0x6f7: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x6f8: Pop(1)
0x6f9: Push("armor_") // @poff=742
0x6fa: PushEmpty(string, int)
0x6fb: Stack[-16] = Stack[-1]
0x6fc: Call2 0x6b5

0x6fd: Pop(1)
0x6fe: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6ff: PushEmpty(bool, object, string)
0x700: Stack[-18] = Stack[-2]
0x701: Stack[-8] = Stack[-1]
0x702: Call2 0x6d7
...
0x708: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x709: Pop(0)
...
0x710: Stack[-3] = Stack[-6]
0x711: Pop(3)
0x712: Push("health") // @poff=704
0x713: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x714: Pop(1)
0x715: Push((int) 1)
0x716: Pop(1); Push(Stack[-1] - Stack[-4]);
0x717: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x718: Push("health") // @poff=704
...
0x71e: Pop(3)
0x71f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0x720: Pop(2)
0x721: PushEmpty(bool, object)
0x722: Stack[-17] = Stack[-1]
0x723: Call2 0x6d2
...
0x729: Pop(1)
0x72a: Stack[-1] = Stack[-16]
0x72b: Return(); Pop(12)

0x72c: PushEmpty(bool, bool)
0x72d: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0x72e: Pop(0)
0x72f: Stack[-1] = Stack[-4]
0x730: Return(); Pop(2)

0x731: PushEmpty(object, object, object, object)
0x732: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x746: Pop(0)
0x747: Pop(0); PushNull((bool) Stack[-2] == 0)
0x748: IF (Stack[-1] == 0) GOTO 0x74b; Pop(1)

0x749: Stack[-6] = (bool) 0
0x74a: Return(); Pop(4)

0x74b: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0x74c: Pop(0)
...
0x75f: Stack[-6] = Stack[-2]
0x760: Stack[-1] = "noaccess" // @poff=798
0x761: Call2 0x6d7
...
0x767: Push("noaccess") // @poff=798
0x768: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x769: Pop(1)
0x76a: Push((int) 0)
...
0x76e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x77c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0x77d: Pop(0)
...
0x78d: Stack[-1] = "fhit" // @poff=816
0x78e: GOTO 0x790

0x78f: Stack[-1] = "bhit" // @poff=826
0x790: Push("hit_react") // @poff=836
0x791: Push("1") // @poff=856
0x792: Pop(1); Push(Stack[-3] + Stack[-1]);
0x793: Push("2") // @poff=860
...
0x7ac: Stack[-25] = Stack[-1]
0x7ad: Call2 0x6c3

0x7ae: Stack[-2] = Stack[-3]
0x7af: Pop(2)
0x7b0: Call2 0x909
...
0x7cb: Pop(0)
0x7cc: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0x7cd: Pop(0)
0x7ce: PushEmpty(object, int, float, cvector, cvector)
0x7cf: Stack[-26] = Stack[-5]
0x7d0: Stack[-25] = Stack[-4]
0x7d1: Stack[-24] = Stack[-3]
0x7d2: Stack[-6] = Stack[-2]
...
0x7ec: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0x7ed: Pop(0)
...
0x7fc: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0x7fd: Pop(0)
0x7fe: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=620
0x7ff: Pop(0)
...
0x854: Stack[-4] = Stack[-2]
0x855: Stack[-1] = (int) 70
0x856: Call2 0x85a

0x857: Stack[-3] = Stack[-5]
0x858: Pop(3)
0x859: Return(); Pop(0)
...
0x85b: @@ GetPosition(Stack[-7]); Obj=18 // @poff=166
0x85c: Pop(0)
0x85d: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=620
0x85e: Pop(0)
...
0x89a: Push("Can't find lsh animation : ") // @poff=923
...
0x8a9: Push("Can't find lsh animation : ") // @poff=923
...
0x8af: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=620
0x8b0: Pop(0)
...
0x8c2: Stack[-7] = Stack[-2]
0x8c3: Stack[-6] = Stack[-1]
0x8c4: Call2 0x925
...
0x8cd: Stack[-10] = Stack[-2]
0x8ce: Stack[-9] = Stack[-1]
0x8cf: Call2 0x925
...
0x90c: Push((float)9.999999974752427e-07)
...
0x916: Stack[-2] = Stack[-3]
0x917: GOTO 0x919

0x918: Stack[-1] = Stack[-3]
0x919: Return(); Pop(0)
...
0x966: Stack[-2] = (int) 0
0x967: Push("all") // @poff=16
0x968: PushEmpty(string, int)
0x969: Stack[-5] = Stack[-1]
0x96a: Call2 0x95e
...
0x974: Stack[-2] = Stack[-5]
0x975: Return(); Pop(4)

0x976: PushEmpty(int, int)
0x977: Push("branch") // @poff=993
...
0x988: Push("branch") // @poff=993
0x989: @ GetVariable(Stack[-1], Stack[-2])
0x98a: Pop(1)
0x98b: Stack[-1] = Stack[-3]
0x98c: Return(); Pop(2)
...
0x99d: Push("GenerateMoney: iMin > iMax") // @poff=1007
0x99e: @ Trace(Stack[-1])
0x99f: Pop(1)
0x9a0: Return(); Pop(4)
...
0x9bb: Pop(0)
0x9bc: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1073
0x9bd: Pop(0)
0x9be: Push("Organ") // @poff=1085
0x9bf: Push((int) 1)
0x9c0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0x9c1: Pop(2)
0x9c2: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1097
0x9c3: Pop(0)
0x9c4: Push((int) 0)
0x9c5: Push((int) 1)
...
0x9d2: Stack[-1] = "liver" // @poff=1107
0x9d3: Call2 0x9b9

0x9d4: Pop(1)
0x9d5: PushEmpty(string)
0x9d6: Stack[-1] = "kidney" // @poff=1119
0x9d7: Call2 0x9b9

0x9d8: Pop(1)
0x9d9: PushEmpty(string)
0x9da: Stack[-1] = "heart" // @poff=1133
0x9db: Call2 0x9b9

0x9dc: Pop(1)
0x9dd: PushEmpty(string)
0x9de: Stack[-1] = "blood" // @poff=1145
0x9df: Call2 0x9b9
...
0x9f3: Stack[-3] = "tourniquet" // @poff=1157
0x9f4: Stack[-2] = (int) 1
0x9f5: Stack[-1] = (int) 7
0x9f6: Call2 0x8c0
...
0x9f9: Stack[-3] = "bandage" // @poff=1179
0x9fa: Stack[-2] = (int) 1
0x9fb: Stack[-1] = (int) 7
0x9fc: Call2 0x8c0
...
0x9ff: Stack[-3] = "packet" // @poff=1195
0xa00: Stack[-2] = (int) 1
...
0xa05: Stack[-3] = "bottle_water" // @poff=1209
0xa06: Stack[-2] = (int) 1
0xa07: Stack[-1] = (int) 3
0xa08: Call2 0x8c0
...
0xa28: Stack[-4] = "alpha_pills" // @poff=1267
0xa29: Stack[-3] = (int) 1
0xa2a: Stack[-2] = (int) 2
0xa2b: Stack[-1] = (int) 3
0xa2c: Call2 0x8cb
...
0xa32: Stack[-4] = "beta_pills" // @poff=1291
0xa33: Stack[-3] = (int) 1
0xa34: Stack[-2] = (int) 4
0xa35: Stack[-1] = (int) 3
0xa36: Call2 0x8cb
...
0xa3c: Stack[-4] = "alpha_pills" // @poff=1267
0xa3d: Stack[-3] = (int) 1
0xa3e: Stack[-2] = (int) 2
0xa3f: Stack[-1] = (int) 8
0xa40: Call2 0x8cb
...
0xa43: Stack[-4] = "gamma_pills" // @poff=1313
0xa44: Stack[-3] = (int) 1
0xa45: Stack[-2] = (int) 8
0xa46: Stack[-1] = (int) 3
0xa47: Call2 0x8cb
...
0xa4d: Stack[-3] = "revolver_ammo" // @poff=1337
0xa4e: Stack[-2] = (int) 1
0xa4f: Stack[-1] = (int) 3
0xa50: Call2 0x8c0
...
0xa53: Stack[-3] = "rifle_ammo" // @poff=1365
0xa54: Stack[-2] = (int) 1
0xa55: Stack[-1] = (int) 3
0xa56: Call2 0x8c0
...
0xa59: Stack[-1] = "patrol_mark" // @poff=1387
0xa5a: Call2 0xae2
...
0xa72: Stack[-3] = "bottle_water" // @poff=1209
0xa73: Stack[-2] = (int) 1
0xa74: Stack[-1] = (int) 3
0xa75: Call2 0x8c0
...
0xa8d: Stack[-4] = "alpha_pills" // @poff=1267
0xa8e: Stack[-3] = (int) 1
0xa8f: Stack[-2] = (int) 4
0xa90: Stack[-1] = (int) 3
0xa91: Call2 0x8cb
...
0xa97: Stack[-4] = "beta_pills" // @poff=1291
0xa98: Stack[-3] = (int) 1
0xa99: Stack[-2] = (int) 8
0xa9a: Stack[-1] = (int) 3
0xa9b: Call2 0x8cb
...
0xaa1: Stack[-4] = "gamma_pills" // @poff=1313
0xaa2: Stack[-3] = (int) 1
...
0xaae: Stack[-1] = Stack[-2]
0xaaf: Pop(1)
0xab0: PushEmpty(string, int, int, int)
0xab1: Stack[-4] = "fresh_meat" // @poff=1411
0xab2: Stack[-3] = (int) 1
0xab3: Stack[-2] = (int) 4
0xab4: Stack[-1] = (int) 3
0xab5: Call2 0x8cb
...
0xab8: Stack[-4] = "dried_meat" // @poff=1433
0xab9: Stack[-3] = (int) 1
0xaba: Stack[-2] = (int) 4
0xabb: Stack[-1] = (int) 3
0xabc: Call2 0x8cb
...
0xabf: Stack[-4] = "smoked_meat" // @poff=1455
0xac0: Stack[-3] = (int) 1
0xac1: Stack[-2] = (int) 4
0xac2: Stack[-1] = (int) 3
0xac3: Call2 0x8cb
...
0xac6: Stack[-4] = "vegetables" // @poff=1479
0xac7: Stack[-3] = (int) 1
0xac8: Stack[-2] = (int) 3
0xac9: Stack[-1] = (int) 3
0xaca: Call2 0x8cb
...
0xad0: Stack[-3] = "revolver_ammo" // @poff=1337
0xad1: Stack[-2] = (int) 1
0xad2: Stack[-1] = (int) 5
0xad3: Call2 0x8c0
...
0xad6: Stack[-3] = "rifle_ammo" // @poff=1365
0xad7: Stack[-2] = (int) 1
0xad8: Stack[-1] = (int) 5
0xad9: Call2 0x8c0
...
0xadc: Stack[-3] = "samopal_ammo" // @poff=1501
0xadd: Stack[-2] = (int) 1
0xade: Stack[-1] = (int) 5
0xadf: Call2 0x8c0
...
0xae9: Stack[-7] = Stack[-2]
0xaea: Stack[-1] = "class" // @poff=1527
0xaeb: Call2 0x6d7
...
0xaf1: Push("class") // @poff=1527
0xaf2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=730
0xaf3: Pop(1)
...
0xb08: Push("patrol") // @poff=1539
0xb09: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0xb0a: IF (Stack[-1] == 1) GOTO 0xb0f; Pop(1)

0xb0b: Push("sanitar") // @poff=1553
0xb0c: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0xb0d: IF (Stack[-1] == 1) GOTO 0xb0f; Pop(1)

0xb0e: Stack[-1] = (bool) 0
0xb0f: IF (Stack[-1] == 1) GOTO 0xb14; Pop(1)

0xb10: Push("soldier") // @poff=1569
0xb11: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0xb12: IF (Stack[-1] == 1) GOTO 0xb14; Pop(1)

0xb13: Stack[-1] = (bool) 0
0xb14: IF (Stack[-1] == 1) GOTO 0xb19; Pop(1)

0xb15: Push("woman") // @poff=1585
0xb16: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0xb17: IF (Stack[-1] == 1) GOTO 0xb19; Pop(1)

0xb18: Stack[-1] = (bool) 0
0xb19: IF (Stack[-1] == 1) GOTO 0xb1e; Pop(1)

0xb1a: Push("wasted_girl") // @poff=1597
0xb1b: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0xb1c: IF (Stack[-1] == 1) GOTO 0xb1e; Pop(1)

0xb1d: Stack[-1] = (bool) 0
0xb1e: IF (Stack[-1] == 1) GOTO 0xb23; Pop(1)

0xb1f: Push("vaxxabitka") // @poff=1621
0xb20: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0xb21: IF (Stack[-1] == 1) GOTO 0xb23; Pop(1)

0xb22: Stack[-1] = (bool) 0
0xb23: IF (Stack[-1] == 1) GOTO 0xb28; Pop(1)

0xb24: Push("vaxxabit") // @poff=1643
0xb25: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xb26: IF (Stack[-1] == 1) GOTO 0xb28; Pop(1)

0xb27: Stack[-1] = (bool) 0
0xb28: IF (Stack[-1] == 1) GOTO 0xb2d; Pop(1)

0xb29: Push("little_girl") // @poff=1661
0xb2a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0xb2b: IF (Stack[-1] == 1) GOTO 0xb2d; Pop(1)

0xb2c: Stack[-1] = (bool) 0
0xb2d: IF (Stack[-1] == 1) GOTO 0xb32; Pop(1)

0xb2e: Push("girl") // @poff=1611
0xb2f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xb30: IF (Stack[-1] == 1) GOTO 0xb32; Pop(1)

0xb31: Stack[-1] = (bool) 0
0xb32: IF (Stack[-1] == 1) GOTO 0xb37; Pop(1)

0xb33: Push("dohodyaga") // @poff=1685
0xb34: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb35: IF (Stack[-1] == 1) GOTO 0xb37; Pop(1)

0xb36: Stack[-1] = (bool) 0
0xb37: IF (Stack[-1] == 1) GOTO 0xb3c; Pop(1)

0xb38: Push("nudegirl") // @poff=1705
0xb39: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xb3a: IF (Stack[-1] == 1) GOTO 0xb3c; Pop(1)
...
0xb4e: Push("worker") // @poff=1723
0xb4f: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xb50: IF (Stack[-1] == 1) GOTO 0xb55; Pop(1)

0xb51: Push("butcher") // @poff=1737
0xb52: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xb53: IF (Stack[-1] == 1) GOTO 0xb55; Pop(1)

0xb54: Stack[-1] = (bool) 0
0xb55: IF (Stack[-1] == 1) GOTO 0xb5a; Pop(1)

0xb56: Push("boy") // @poff=1753
0xb57: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0xb58: IF (Stack[-1] == 1) GOTO 0xb5a; Pop(1)

0xb59: Stack[-1] = (bool) 0
0xb5a: IF (Stack[-1] == 1) GOTO 0xb5f; Pop(1)

0xb5b: Push("unosha") // @poff=1761
0xb5c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xb5d: IF (Stack[-1] == 1) GOTO 0xb5f; Pop(1)

0xb5e: Stack[-1] = (bool) 0
0xb5f: IF (Stack[-1] == 1) GOTO 0xb64; Pop(1)

0xb60: Push("wasted_male") // @poff=1775
0xb61: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb62: IF (Stack[-1] == 1) GOTO 0xb64; Pop(1)

0xb63: Stack[-1] = (bool) 0
0xb64: IF (Stack[-1] == 1) GOTO 0xb69; Pop(1)

0xb65: Push("alkash") // @poff=1799
0xb66: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xb67: IF (Stack[-1] == 1) GOTO 0xb69; Pop(1)

0xb68: Stack[-1] = (bool) 0
0xb69: IF (Stack[-1] == 1) GOTO 0xb6e; Pop(1)

0xb6a: Push("morlok") // @poff=1813
0xb6b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xb6c: IF (Stack[-1] == 1) GOTO 0xb6e; Pop(1)
...
0xb98: Stack[-3] = Stack[-1]
0xb99: Call2 0xc39

0xb9a: Stack[-2] = Stack[-4]
0xb9b: Pop(2)
0xb9c: Return(); Pop(0)
...
0xbc1: Pop(0)
0xbc2: Push((float)-0.07000000029802322)
...
0xbdd: Pop(0)
0xbde: Push((float)-0.12999999523162842)
0xbdf: Push((bool) 1)
...
0xbeb: Stack[-7] = Stack[-3]
0xbec: Stack[-6] = Stack[-2]
0xbed: Stack[-5] = Stack[-1]
0xbee: Call2 0x799
...
0xbf3: Stack[-11] = Stack[-5]
0xbf4: Stack[-10] = Stack[-4]
0xbf5: Stack[-9] = Stack[-3]
0xbf6: Stack[-7] = Stack[-2]
...
0xc20: Push(Stack[-2])
0xc21: IF (Stack[-1] == 1) GOTO 0xc2a; Pop(1)

0xc22: PushEmpty(float, object)
0xc23: Stack[-8] = Stack[-1]
0xc24: Call2 0x6ca

0xc25: Pop(1)
0xc26: Push((float)160000.0)
0xc27: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xc28: IF (Stack[-1] == 1) GOTO 0xc2a; Pop(1)
...
0xc33: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1838
0xc34: Return(); Pop(0)

0xc35: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1878
0xc36: Return(); Pop(0)
...
0xc43: @@ in(Stack[-4], Stack[-8]); Obj=1 // @poff=1827
0xc44: Pop(1)
0xc45: Push(Stack[-3])
...
0xc4a: Stack[-9] = Stack[-1]
0xc4b: Call2 0x6d2

0xc4c: Pop(1)
0xc4d: IF (Stack[-1] == 0) GOTO 0xc54; Pop(1)

0xc4e: Push("reputation") // @poff=1922
0xc4f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=730
0xc50: Pop(1)
0xc51: Push((float)0.33000001311302185)
0xc52: Stack[-9] = Stack[-3] < Stack[-1]; Pop(1);
0xc53: Return(); Pop(6)

0xc54: PushEmpty(bool, object, string)
0xc55: Stack[-10] = Stack[-2]
0xc56: Stack[-1] = "class" // @poff=1527
0xc57: Call2 0x6d7

0xc58: Pop(2)
0xc59: IF (Stack[-1] == 0) GOTO 0xc6d; Pop(1)

0xc5a: Push("class") // @poff=1527
0xc5b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=730
0xc5c: Pop(1)
0xc5d: Stack[-8] = (bool) 1
0xc5e: PushEmpty(bool)
0xc5f: Stack[-1] = (bool) 1
0xc60: Push("bomber") // @poff=1944
0xc61: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc62: IF (Stack[-1] == 1) GOTO 0xc67; Pop(1)

0xc63: Push("hunter") // @poff=1958
0xc64: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc65: IF (Stack[-1] == 1) GOTO 0xc67; Pop(1)

0xc66: Stack[-1] = (bool) 0
0xc67: IF (Stack[-1] == 1) GOTO 0xc6c; Pop(1)

0xc68: Push("grabitel") // @poff=1972
0xc69: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc6a: IF (Stack[-1] == 1) GOTO 0xc6c; Pop(1)
