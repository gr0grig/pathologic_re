...
Strings:
	...
	A:AddItem
	A:SetItemName
// @pool_raw:
...
0x1: @ GetScene(Stack[-0]T)
0x2: Pop(0)
0x3: @ GetPosition(Stack[-1]T)
0x4: Pop(0)
0x5: Push(CvectorIndex(Stack[1 + Tasks[-1].StackPointer], 1))
0x6: Stack[-1] = (int) 0
...
0x45: Push("walk_distance") // @poff=0
0x46: Push((int) 1000)
0x47: Pop(1); Push(Stack[-1] * Stack[2 + Tasks[-1].StackPointer]);
...
0x69: IF (Stack[-1] == 1) GOTO 0x75; Pop(1)
...
0x72: Stack[-1] = (bool) 1
0x73: IF (Stack[-1] == 1) GOTO 0x75; Pop(1)
...
0x7e: IF (Stack[-1] == 1) GOTO 0x83; Pop(1)
...
0x8a: Stack[-1] = (float) 0.14000000059604645
0x8b: Call2 0x199
...
0xb4: Stack[-1] = (float) 0.14000000059604645
0xb5: Call2 0x199
...
0xd2: Stack[-1] = (float) 0.10000000149011612
0xd3: Call2 0x199
...
0xf2: Stack[-1] = (float) 0.14000000059604645
0xf3: Call2 0x199
...
0xfd: Stack[-4] = "silver_ring" // @poff=96
0xfe: Stack[-3] = (int) 1
0xff: Stack[-2] = (int) 5
0x100: Stack[-1] = (int) 1
0x101: Call2 0x1d3
...
0x108: Stack[-4] = "gold_ring" // @poff=120
0x109: Stack[-3] = (int) 1
...
0x11b: Stack[-1] = (float) 0.10000000149011612
0x11c: Call2 0x199
...
0x13b: Stack[-1] = (float) 0.14000000059604645
0x13c: Call2 0x199
...
0x159: Stack[-1] = (float) 0.10000000149011612
0x15a: Call2 0x199
...
0x181: Pop(0)
0x182: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=180
0x183: Pop(1)
0x184: Stack[-1] = Stack[-5]
0x185: Return(); Pop(4)

0x186: Stack[-2] = 0
0x187: PushEmpty(int, int)
0x188: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=194
0x189: Pop(0)
0x18a: Pop(0); Push(Stack[-1] + Stack[-3]);
0x18b: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=206
0x18c: Pop(1)
0x18d: Return(); Pop(2)
...
0x1a5: Pop(0)
0x1a6: @@ add(Stack[-4]); Obj=1 // @poff=218
0x1a7: Pop(0)
0x1a8: @@ add(Stack[-3]); Obj=1 // @poff=218
0x1a9: Pop(0)
0x1aa: Push((int) 3)
...
0x1c3: @@ GetItemID(Stack[-3]); Obj=8 // @poff=246
0x1c4: Pop(0)
0x1c5: Push("Category") // @poff=256
0x1c6: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x1c7: Pop(1)
0x1c8: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=274
0x1c9: Pop(0)
0x1ca: Push(Stack[-1])
0x1cb: IF (Stack[-1] == 0) GOTO 0x1d1; Pop(1)

0x1cc: PushEmpty(int, int)
0x1cd: Stack[-5] = Stack[-2]
0x1ce: Stack[-9] = Stack[-1]
0x1cf: Call2 0x1a3

0x1d0: Pop(2)
0x1d1: Stack[-1] = Stack[-10]
0x1d2: Return(); Pop(6)
...
0x1dd: Pop(0)
0x1de: @@ SetItemName(Stack[-8]); Obj=1 // @poff=282
0x1df: Pop(0)
