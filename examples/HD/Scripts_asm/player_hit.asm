...
Strings:
	...
	W:GetPosition
	W:blocking
// @pool_raw:
// @pool_encoding:utf8
...
0x1a: Stack[-10] = Stack[-4]
0x1b: Stack[-9] = Stack[-3]
0x1c: Stack[-8] = Stack[-2]
...
0x52: Stack[-7] = (int) 0
0x53: Stack[-14] = Stack[-6]
0x54: Stack[-15] = Stack[-5]
0x55: Stack[-12] = Stack[-4]
0x56: Stack[-11] = Stack[-3]
0x57: Stack[-10] = Stack[-2]
0x58: Stack[-9] = Stack[-1]
0x59: Call2 0x191
...
0x65: Stack[-7] = (int) 0
0x66: Stack[-14] = Stack[-6]
0x67: Stack[-15] = Stack[-5]
0x68: Stack[-12] = Stack[-4]
0x69: Stack[-11] = Stack[-3]
0x6a: Stack[-10] = Stack[-2]
0x6b: Stack[-9] = Stack[-1]
0x6c: Call2 0x191
...
0x73: Stack[-14] = Stack[-6]
0x74: Stack[-15] = Stack[-5]
0x75: Stack[-12] = Stack[-4]
0x76: Stack[-11] = Stack[-3]
0x77: Stack[-10] = Stack[-2]
...
0x83: Stack[-9] = Stack[-3]
0x84: Stack[-8] = Stack[-2]
0x85: Stack[-7] = Stack[-1]
0x86: Call2 0x161

0x87: Pop(3)
0x88: PushEmpty(float, float)
0x89: Stack[-6] = Stack[-1]
0x8a: Call2 0xd7
...
0x99: Stack[-10] = Stack[-4]
0x9a: Stack[-9] = Stack[-3]
0x9b: Stack[-8] = Stack[-2]
...
0xa2: Pop(0)
0xa3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=0
0xa4: Pop(0)
...
0xb0: Push((float)9.999999974752427e-07)
...
0xbe: Stack[-1] = Stack[-4]
0xbf: Return(); Pop(0)

0xc0: Stack[-3] = Stack[-4]
0xc1: Return(); Pop(0)
...
0x119: Stack[-1] = "hit_physical1" // @poff=48
0x11a: Call2 0xef

0x11b: Pop(1)
0x11c: PushEmpty(string)
0x11d: Stack[-1] = "scream_physical1" // @poff=76
0x11e: Call2 0x109
...
0x125: Stack[-1] = "hit_physical2" // @poff=110
0x126: Call2 0xef

0x127: Pop(1)
0x128: PushEmpty(string)
0x129: Stack[-1] = "scream_physical2" // @poff=138
0x12a: Call2 0x109
...
0x131: Stack[-1] = "hit_bullet" // @poff=172
0x132: Call2 0xef

0x133: Pop(1)
0x134: PushEmpty(string)
0x135: Stack[-1] = "scream_bullet" // @poff=194
0x136: Call2 0x109
...
0x13d: Stack[-1] = "hit_oscoloc" // @poff=222
0x13e: Call2 0xef

0x13f: Pop(1)
0x140: PushEmpty(string)
0x141: Stack[-1] = "scream_oscoloc" // @poff=246
0x142: Call2 0x109
...
0x149: Stack[-1] = "hit_mental" // @poff=276
0x14a: Call2 0xef

0x14b: Pop(1)
0x14c: PushEmpty(string)
0x14d: Stack[-1] = "scream_mental" // @poff=298
0x14e: Call2 0x109
...
0x155: Stack[-1] = "hit_rat" // @poff=326
0x156: Call2 0xef

0x157: Pop(1)
0x158: PushEmpty(string)
0x159: Stack[-1] = "scream_rat" // @poff=342
0x15a: Call2 0x109
...
0x177: Push("GetPosition") // @poff=364
0x178: Push((int) 1)
...
0x181: Stack[-9] = Stack[-1]
0x182: Call2 0xa0

0x183: Stack[-2] = Stack[-3]
0x184: Pop(2)
0x185: Call2 0xad
...
0x1ab: Stack[-2] = (int) 0
0x1ac: Stack[-1] = (float) 0.9900000095367432
0x1ad: Call2 0xb7
...
0x1b7: Stack[-2] = (int) 0
0x1b8: Stack[-1] = (float) 0.9900000095367432
0x1b9: Call2 0xb7
...
0x1cf: Push((int) 1)
0x1d0: Push((float)0.10000000149011612)
