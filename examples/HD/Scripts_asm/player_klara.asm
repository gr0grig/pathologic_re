...
Strings:
	...
	W:use_success
	W:use_fail
	W:player_reputation_decrease.bin
	W:player_klara_dream.bin
	W:player_init
	W:empty
	W:lockpick
	W:gun
	...
	W:vcharge
	W:player_shot
// @pool_raw:
...
0x31: Stack[-1] = 0
0x32: Stack[-1] = "scalpel" // @poff=60
0x33: Return(); Pop(0)

0x34: PushEmpty()
0x35: Stack[-2] = (float) 0.6000000238418579
0x36: Return(); Pop(0)
...
0x83: Stack[-20] = Stack[-2]
0x84: Stack[-1] = "health" // @poff=106
0x85: Call2 0x54a
...
0x97: Push("GetDirection") // @poff=120
0x98: Push((int) 1)
...
0x9c: Pop(0)
0x9d: @@ GetDirection(Stack[-9]); Obj=14 // @poff=146
0x9e: Pop(0)
0x9f: PushEmpty(float, cvector, cvector)
0xa0: Stack[-13] = Stack[-2]
0xa1: Stack[-12] = Stack[-1]
0xa2: Call2 0x631

0xa3: Pop(2)
0xa4: Push((float)0.4999999701976776)
0xa5: Stack[-13] = Stack[-2] >= Stack[-1]; Pop(2);
0xa6: Push(Stack[-11])
0xa7: IF (Stack[-1] == 0) GOTO 0xb1; Pop(1)

0xa8: Stack[-8] = "battack" // @poff=159
0xa9: PushEmpty(string)
0xaa: Call2 0x32

0xab: Pop(0)
0xac: Push("_back") // @poff=175
...
0xda: Push("GetDirection") // @poff=120
0xdb: Push((int) 1)
...
0xdf: Pop(0)
0xe0: @@ GetDirection(Stack[-5]); Obj=14 // @poff=146
0xe1: Pop(0)
0xe2: PushEmpty(float, cvector, cvector)
0xe3: Stack[-9] = Stack[-2]
0xe4: Stack[-8] = Stack[-1]
0xe5: Call2 0x631

0xe6: Pop(2)
0xe7: Push((float)0.4999999701976776)
...
0x133: Pop(0)
0x134: IF (Stack[-1] == 1) GOTO 0x6d; Pop(1)
...
0x15f: Stack[-10] = Stack[-2]
0x160: Stack[-1] = "lp" // @poff=240
0x161: Call2 0x54a

0x162: Pop(2)
0x163: IF (Stack[-1] == 0) GOTO 0x18b; Pop(1)

0x164: Push("lp") // @poff=240
0x165: @@ GetProperty(Stack[-1], Stack[-6]); Obj=8 // @poff=246
0x166: Pop(1)
0x167: Push(Stack[-5])
0x168: IF (Stack[-1] == 0) GOTO 0x18b; Pop(1)

0x169: Push("locked") // @poff=258
0x16a: @@ GetProperty(Stack[-1], Stack[-5]); Obj=8 // @poff=246
0x16b: Pop(1)
0x16c: Push(Stack[-4])
0x16d: IF (Stack[-1] == 0) GOTO 0x18b; Pop(1)

0x16e: Stack[-6] = (bool) 1
0x16f: Push("locked") // @poff=258
0x170: Push((bool) 0)
0x171: @@ SetProperty(Stack[-2], Stack[-1]); Obj=9 // @poff=272
0x172: Pop(2)
0x173: Stack[-2] = (int) 0
0x174: Push("uses") // @poff=284
...
0x18d: Push("use_success") // @poff=294
0x18e: @ PlayAnimation(Stack[-1])
0x18f: Pop(1)
0x190: GOTO 0x194

0x191: Push("use_fail") // @poff=318
...
0x1bc: Pop(0)
0x1bd: Push("player_reputation_decrease.bin") // @poff=336
0x1be: @@ add(Stack[-1]); Obj=3 // @poff=200
0x1bf: Pop(1)
0x1c0: Push("player_klara_dream.bin") // @poff=398
0x1c1: @@ add(Stack[-1]); Obj=3 // @poff=200
0x1c2: Pop(1)
0x1c3: Push("player_init") // @poff=444
...
0x1c8: @ Diary()
0x1c9: Pop(0)
0x1ca: Push("player_init") // @poff=444
0x1cb: Push((int) 1)
...
0x26e: Push((float)0.10000000149011612)
0x26f: @ Sleep(Stack[-1])
0x270: Pop(1)
0x271: GOTO 0x260
...
0x2f9: Push("attack") // @poff=76
0x2fa: Pop(1); Push(Stack[-1] + Stack[-20]);
0x2fb: Push("_phase1") // @poff=90
...
0x313: Stack[-17] = Stack[-2]
0x314: Stack[-1] = "healable" // @poff=871
0x315: Call2 0x54a

0x316: Pop(2)
0x317: IF (Stack[-1] == 0) GOTO 0x331; Pop(1)

0x318: Push("heal_phase1") // @poff=889
...
0x321: Stack[-16] = Stack[-1]
0x322: Call2 0x5ba

0x323: Pop(1)
0x324: IF (Stack[-1] == 0) GOTO 0x328; Pop(1)

0x325: Push("heal") // @poff=913
0x326: @ Trigger(Stack[-15], Stack[-1])
0x327: Pop(1)
0x328: Push("heal_phase2") // @poff=923
...
0x331: Push("GetDirection") // @poff=120
0x332: Push((int) 1)
...
0x336: Pop(0)
0x337: @@ GetDirection(Stack[-9]); Obj=14 // @poff=146
0x338: Pop(0)
0x339: PushEmpty(float, cvector, cvector)
0x33a: Stack[-13] = Stack[-2]
0x33b: Stack[-12] = Stack[-1]
0x33c: Call2 0x631

0x33d: Pop(2)
0x33e: Push((float)0.4999999701976776)
...
0x344: Stack[-8] = "battack" // @poff=159
0x345: Push("punch_back") // @poff=947
...
0x362: Push("GetDirection") // @poff=120
0x363: Push((int) 1)
...
0x367: Pop(0)
0x368: @@ GetDirection(Stack[-5]); Obj=14 // @poff=146
0x369: Pop(0)
0x36a: PushEmpty(float, cvector, cvector)
0x36b: Stack[-9] = Stack[-2]
0x36c: Stack[-8] = Stack[-1]
0x36d: Call2 0x631

0x36e: Pop(2)
0x36f: Push((float)0.4999999701976776)
0x370: Stack[-13] = Stack[-2] >= Stack[-1]; Pop(2);
0x371: GOTO 0x373

0x372: Stack[-11] = (bool) 0
0x373: PushEmpty(float, bool)
0x374: Stack[-13] = Stack[-1]
0x375: Call2 0x3bd

0x376: Stack[-2] = Stack[-6]
0x377: Pop(2)
0x378: Push((int) 4)
...
0x37e: Stack[-18] = Stack[-3]
0x37f: Stack[-8] = Stack[-2]
0x380: Stack[-1] = (int) 0
0x381: Call2 0x56c

0x382: Stack[-4] = Stack[-7]
0x383: Pop(4)
0x384: Push(Stack[-3])
...
0x3af: Pop(0)
0x3b0: IF (Stack[-1] == 1) GOTO 0x308; Pop(1)
...
0x3c0: Stack[-2] = (float) 0.4000000059604645
0x3c1: GOTO 0x3c3

0x3c2: Stack[-2] = (float) 0.20000000298023224
0x3c3: Return(); Pop(0)
...
0x3de: Pop(0)
0x3df: Push("_noammo") // @poff=1039
0x3e0: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3e1: @ PlaySound(Stack[-1])
0x3e2: Pop(1)
0x3e3: Push("noammo") // @poff=1041
...
0x3ee: Stack[-1] = (float) 0.02617993950843811
0x3ef: Return(); Pop(0)

0x3f0: PushEmpty(bool, int, bool, int)
0x3f1: Push("ammo") // @poff=1001
0x3f2: @ GetWeaponProperty(Stack[-3], Stack[-1], Stack[-2])
0x3f3: Pop(1)
0x3f4: Push("ammo") // @poff=1001
0x3f5: Push((int) 1)
...
0x40e: Stack[-2] = "revolver_ammo" // @poff=1011
0x40f: Stack[-1] = (int) 2
0x410: Call2 0x777
...
0x415: Pop(0)
0x416: Push("_reload") // @poff=1055
0x417: Pop(2); Push(Stack[-2] + Stack[-1]);
0x418: @ PlaySound(Stack[-1])
0x419: Pop(1)
0x41a: Push("reload") // @poff=1057
...
0x426: Pop(0)
0x427: PushEmpty(int)
0x428: Stack[-2] = Stack[-1]
0x429: Call2 0x88e

0x42a: Pop(1)
0x42b: Return(); Pop(0)

0x42c: Stack[-1] = "gun" // @poff=498
0x42d: Return(); Pop(0)

0x42e: Stack[-1] = (float) 1.2999999523162842
0x42f: Return(); Pop(0)
...
0x43f: Pop(0)
0x440: Stack[-23] = "attack1" // @poff=1071
0x441: Push((bool) 1)
...
0x496: Stack[-18] = Stack[-3]
0x497: Stack[-15] = Stack[-2]
0x498: PushEmpty(int)
0x499: Call2 0x430

0x49a: Stack[-1] = Stack[-2]
0x49b: Pop(1)
0x49c: Call2 0x56c
...
0x4a1: @@ add(Stack[-14]); Obj=17 // @poff=200
0x4a2: Pop(0)
0x4a3: PushEmpty(int)
0x4a4: Call2 0x432
...
0x4ac: Push("health") // @poff=106
0x4ad: @@ GetProperty(Stack[-1], Stack[-10]); Obj=15 // @poff=246
0x4ae: Pop(1)
...
0x4c5: Stack[-4] = Stack[-11]
0x4c6: Pop(4)
0x4c7: Push(Stack[-7])
0x4c8: IF (Stack[-1] == 0) GOTO 0x4d0; Pop(1)

0x4c9: @@ add(Stack[-8]); Obj=17 // @poff=200
0x4ca: Pop(0)
0x4cb: PushEmpty(int)
0x4cc: Call2 0x432
...
0x4d8: Pop(0)
0x4d9: Push("scripted") // @poff=1109
0x4da: Push(CVector(0.0, 0.0, 1.0))
0x4db: Push("richochet.xml") // @poff=1127
0x4dc: @ AddActorByType(Stack[-8], Stack[-3], Stack[-9], Stack[-15], Stack[-2], Stack[-1])
0x4dd: Pop(3)
0x4de: Push("Material") // @poff=1155
0x4df: @@ SetScriptProperty(Stack[-1], Stack[-14]); Obj=6 // @poff=1173
0x4e0: Pop(1)
...
0x513: Pop(0)
0x514: IF (Stack[-1] == 1) GOTO 0x438; Pop(1)
...
0x522: Stack[-2] = "revolver_ammo" // @poff=1011
0x523: Stack[-1] = (int) 2
0x524: Call2 0x777
...
0x529: Pop(0)
0x52a: Push("_reload") // @poff=1055
0x52b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x52c: @ PlaySound(Stack[-1])
0x52d: Pop(1)
0x52e: Push("reload") // @poff=1057
...
0x541: Stack[-2] = "bullet" // @poff=1201
0x542: Return(); Pop(0)

0x543: Stack[-2] = "phys" // @poff=1215
0x544: Return(); Pop(0)

0x545: PushEmpty(bool, bool)
0x546: @ IsPlayerActor(Stack[-3], Stack[-1])
0x547: Pop(0)
0x548: Stack[-1] = Stack[-4]
0x549: Return(); Pop(2)

0x54a: PushEmpty(bool, bool)
0x54b: Push("HasProperty") // @poff=1225
0x54c: Push((int) 2)
...
0x552: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=1249
0x553: Pop(0)
...
0x558: Stack[-10] = Stack[-2]
0x559: Stack[-9] = Stack[-1]
0x55a: Call2 0x54a
...
0x560: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=246
0x561: Pop(0)
0x562: PushEmpty(float, float, float, float)
0x563: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x564: Stack[-8] = Stack[-2]
0x565: Stack[-7] = Stack[-1]
0x566: Call2 0x5fc

0x567: Pop(3)
0x568: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=272
0x569: Pop(1)
...
0x56e: Stack[-18] = Stack[-2]
0x56f: Stack[-1] = "health" // @poff=106
0x570: Call2 0x54a
...
0x577: Stack[-18] = Stack[-2]
0x578: Stack[-1] = "armor" // @poff=1261
0x579: Call2 0x54a
...
0x57f: Push("armor") // @poff=1261
0x580: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=246
0x581: Pop(1)
0x582: Push("armor_") // @poff=1273
0x583: PushEmpty(string, int)
0x584: Stack[-16] = Stack[-1]
0x585: Call2 0x537

0x586: Pop(1)
0x587: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x588: PushEmpty(bool, object, string)
0x589: Stack[-18] = Stack[-2]
0x58a: Stack[-8] = Stack[-1]
0x58b: Call2 0x54a
...
0x591: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=246
0x592: Pop(0)
...
0x599: Stack[-3] = Stack[-6]
0x59a: Pop(3)
0x59b: Push("health") // @poff=106
0x59c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=246
0x59d: Pop(1)
0x59e: Push((int) 1)
0x59f: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5a0: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5a1: Push("health") // @poff=106
...
0x5a7: Pop(3)
0x5a8: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=272
0x5a9: Pop(2)
0x5aa: PushEmpty(bool, object)
0x5ab: Stack[-17] = Stack[-1]
0x5ac: Call2 0x545
...
0x5b2: Pop(1)
0x5b3: Stack[-1] = Stack[-16]
0x5b4: Return(); Pop(12)

0x5b5: PushEmpty(bool, bool)
0x5b6: @@ IsDead(Stack[-1]); Obj=3 // @poff=1287
0x5b7: Pop(0)
0x5b8: Stack[-1] = Stack[-4]
0x5b9: Return(); Pop(2)

0x5ba: PushEmpty(object, object, object, object)
0x5bb: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5c0: Pop(0)
0x5c1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5c2: IF (Stack[-1] == 0) GOTO 0x5c5; Pop(1)

0x5c3: Stack[-6] = (bool) 0
0x5c4: Return(); Pop(4)

0x5c5: @@ GetScene(Stack[-1]); Obj=5 // @poff=1294
0x5c6: Pop(0)
...
0x5df: Stack[-2] = "ground" // @poff=1325
0x5e0: Return(); Pop(0)
...
0x5eb: Stack[-2] = "carpet" // @poff=1351
0x5ec: Return(); Pop(0)

0x5ed: Stack[-2] = "stone" // @poff=1365
0x5ee: Return(); Pop(0)
...
0x5f8: Stack[-2] = Stack[-3]
0x5f9: GOTO 0x5fb

0x5fa: Stack[-1] = Stack[-3]
0x5fb: Return(); Pop(0)
...
0x633: Stack[-5] = Stack[-2]
0x634: Stack[-4] = Stack[-1]
0x635: Call2 0x61e
...
0x658: Stack[-2] = Stack[-1]
0x659: Call2 0x676

0x65a: Pop(1)
0x65b: PushEmpty(bool, object, string, float, float, float)
0x65c: Stack[-8] = Stack[-5]
0x65d: Stack[-4] = "reputation" // @poff=1377
0x65e: Stack[-7] = Stack[-3]
0x65f: Stack[-2] = (int) 0
0x660: Stack[-1] = (int) 1
0x661: Call2 0x556
...
0x678: Pop(0)
0x679: @@ add(Stack[-3]); Obj=1 // @poff=200
0x67a: Pop(0)
0x67b: Push((int) 16)
...
0x69e: Push("branch") // @poff=1435
0x69f: @ GetVariable(Stack[-1], Stack[-2])
0x6a0: Pop(1)
0x6a1: Stack[-1] = Stack[-3]
0x6a2: Return(); Pop(2)
...
0x6c7: Stack[-9] = Stack[-1]
0x6c8: Call2 0x5cf

0x6c9: Stack[-2] = Stack[-8]
0x6ca: Pop(2)
0x6cb: Stack[-5] = (int) 0
0x6cc: Push("step_") // @poff=1449
...
0x702: Push("ACHIEVEMENT_MIGHT") // @poff=1461
0x703: @ UnlockAchievement(Stack[-1])
0x704: Pop(1)
0x705: @ GetMainOutdoorScene(Stack[-2])
0x706: Pop(0)
0x707: Push("player_death") // @poff=1497
0x708: Push("play_death_klara.bin") // @poff=1523
...
0x71c: Pop(0)
0x71d: Push((int) 11)
0x71e: Push((float)0.15000000596046448)
...
0x73b: Pop(0)
0x73c: Push((int) 10)
0x73d: Push((float)0.3499999940395355)
...
0x746: Pop(0)
0x747: Push((int) 12)
0x748: Push((float)0.6000000238418579)
...
0x79c: Push("durability") // @poff=1565
...
0x7a7: Push("durability") // @poff=1565
...
0x7b2: Stack[-4] = Stack[-5]
0x7b3: Pop(4)
0x7b4: Push("durability") // @poff=1565
...
0x7c9: Push("birdMaskAchievement") // @poff=1587
...
0x7d1: Pop(1)
0x7d2: Push("bird_mask") // @poff=1627
0x7d3: @ GetInvItemByName(Stack[-10], Stack[-1])
0x7d4: Pop(1)
0x7d5: Push("bird_balahon") // @poff=1647
...
0x7df: Pop(1)
0x7e0: @@ GetItemID(Stack[-3]); Obj=4 // @poff=1673
0x7e1: Pop(0)
...
0x7ff: Push("birdMaskAchievement") // @poff=1587
0x800: Push((int) 1)
0x801: @ SetVariable(Stack[-2], Stack[-1])
0x802: Pop(2)
0x803: Push("ACHIEVEMENT_THEY") // @poff=1683
0x804: @ UnlockAchievement(Stack[-1])
0x805: Pop(1)
0x806: PushEmpty(bool, int)
0x807: Stack[-25] = Stack[-1]
0x808: Call2 0x6a3

0x809: Stack[-2] = Stack[-26]
0x80a: Pop(2)
0x80b: Return(); Pop(22)
...
0x834: Pop(0)
0x835: @@ add(Stack[-7]); Obj=1 // @poff=200
0x836: Pop(0)
0x837: Push((int) 10)
...
0x84b: @@ in(Stack[-2], Stack[-6]); Obj=1 // @poff=197
0x84c: Pop(1)
0x84d: Push(Stack[-1])
0x84e: IF (Stack[-1] == 0) GOTO 0x854; Pop(1)

0x84f: Push("Reputation is not changed for enemy: ") // @poff=1733
...
0x857: @@ in(Stack[-2], Stack[-6]); Obj=1 // @poff=197
0x858: Pop(1)
0x859: Push(Stack[-1])
...
0x85d: @@ add(Stack[-6]); Obj=1 // @poff=200
0x85e: Pop(1)
...
0x879: Push((float)0.003499999875202775)
...
0x87f: Pop(1)
0x880: Stack[-6] = Stack[-2]
0x881: Stack[-1] = (int) 0
0x882: Call2 0x56c

0x883: Stack[-4] = Stack[-5]
0x884: Pop(4)
...
0x89b: Pop(0)
0x89c: Pop(0); PushNull((bool) Stack[-14] == 0)
0x89d: IF (Stack[-1] == 0) GOTO 0x8a2; Pop(1)

0x89e: Push("Can't find main outdoor oscene") // @poff=1809
0x89f: @ Trace(Stack[-1])
0x8a0: Pop(1)
0x8a1: Return(); Pop(28)

0x8a2: @@ GetMap(Stack[-12]); Obj=14 // @poff=1871
0x8a3: Pop(0)
0x8a4: Pop(0); PushNull((bool) Stack[-12] == 0)
0x8a5: IF (Stack[-1] == 0) GOTO 0x8aa; Pop(1)

0x8a6: Push("Can't find map") // @poff=1878
0x8a7: @ Trace(Stack[-1])
0x8a8: Pop(1)
0x8a9: Return(); Pop(28)
...
0x8af: @@ GetName(Stack[-10]); Obj=13 // @poff=1908
0x8b0: Pop(0)
0x8b1: Push("pt_gmap_") // @poff=1916
0x8b2: Pop(1); Push(Stack[-1] + Stack[-11]);
0x8b3: @@ GetLocator(Stack[-1], Stack[-10], Stack[-12], Stack[-9]); Obj=15 // @poff=1934
0x8b4: Pop(1)
0x8b5: Pop(0); Push((bool) Stack[-9] == 0)
0x8b6: IF (Stack[-1] == 0) GOTO 0x8bc; Pop(1)

0x8b7: Push("FIXME: No map locator for scene : ") // @poff=1945
...
0x8be: @@ SetMapParams(Stack[-2], Stack[-1]); Obj=14 // @poff=2015
0x8bf: Pop(2)
...
0x8da: Push("people.xml") // @poff=2028
0x8db: Push((bool) 1)
...
0x8e8: Pop(1)
0x8e9: Push("flashlight_off") // @poff=2050
...
0x8f3: Pop(1)
0x8f4: Push("flashlight_on") // @poff=2080
0x8f5: @ PlaySound(Stack[-1])
0x8f6: Pop(1)
0x8f7: GOTO 0x8fb

0x8f8: Push("flashlight_nofuel") // @poff=2108
...
0x92b: Push("people.xml") // @poff=2028
0x92c: Push((bool) 1)
...
0x94b: Pop(0)
0x94c: Push("player_shot") // @poff=2172
