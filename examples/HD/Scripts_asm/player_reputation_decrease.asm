...
Strings:
	...
	W:sleeping
	A:add
// @pool_raw:6b00360071003000310000006b0036007100300031004900740065006d007300520065006d006f007600650064000000720065007000750074006100740069006f006e00000073006c0065006500700069006e006700000061646400
...
0x25: Push("k6q01ItemsRemoved") // @poff=12
...
0x2d: Stack[-4] = "reputation" // @poff=48
0x2e: Stack[-8] = Stack[-3]
0x2f: Stack[-2] = (int) 0
0x30: Stack[-1] = (int) 1
0x31: Call2 0x59
