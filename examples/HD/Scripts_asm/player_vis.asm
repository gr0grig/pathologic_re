...
0x8: Stack[-1] = (float) 0.1568627506494522
0x9: GOTO 0x2a
...
0x11: Stack[-2] = (float) 0.1568627506494522
0x12: Stack[-1] = (float) 0.47058823704719543
0x13: Call2 0x31

0x14: Stack[-6] = Stack[-7]
0x15: Pop(6)
0x16: GOTO 0x2a
...
0x1a: Stack[-1] = (float) 0.47058823704719543
0x1b: GOTO 0x2a
...
0x20: Stack[-8] = Stack[-5]
0x21: Stack[-4] = (float) 20.0
0x22: Stack[-3] = (float) 21.0
0x23: Stack[-2] = (float) 0.47058823704719543
0x24: Stack[-1] = (float) 0.1568627506494522
0x25: Call2 0x31

0x26: Stack[-6] = Stack[-7]
0x27: Pop(6)
0x28: GOTO 0x2a

0x29: Stack[-1] = (float) 0.1568627506494522
