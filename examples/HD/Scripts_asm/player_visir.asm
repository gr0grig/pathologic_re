...
0x6c: Stack[-4] = Stack[-5]
0x6d: Pop(4)
0x6e: Push("vcharge") // @poff=12
0x6f: @ SetProperty(Stack[-1], Stack[-2])
0x70: Pop(1)
0x71: Stack[-1] = Stack[-4]
0x72: Return(); Pop(2)

0x73: PushEmpty(bool, bool, bool, bool)
0x74: Push("sleeping") // @poff=28
