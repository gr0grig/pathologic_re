...
// @pool_raw:
// @pool_encoding:utf8
...
0x750: Push("Can't find lsh animation : ") // @poff=923
...
0x75f: Push("Can't find lsh animation : ") // @poff=923
...
0x765: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=620
0x766: Pop(0)
...
0x7d8: Pop(0)
0x7d9: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x81c: Pop(0)
0x81d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1007
0x81e: Pop(0)
0x81f: Push("Organ") // @poff=1019
0x820: Push((int) 1)
0x821: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0x822: Pop(2)
0x823: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1031
0x824: Pop(0)
0x825: Push((int) 0)
0x826: Push((int) 1)
...
0x833: Stack[-1] = "liver" // @poff=1041
0x834: Call2 0x81a

0x835: Pop(1)
0x836: PushEmpty(string)
0x837: Stack[-1] = "kidney" // @poff=1053
0x838: Call2 0x81a

0x839: Pop(1)
0x83a: PushEmpty(string)
0x83b: Stack[-1] = "heart" // @poff=1067
0x83c: Call2 0x81a

0x83d: Pop(1)
0x83e: PushEmpty(string)
0x83f: Stack[-1] = "blood" // @poff=1079
0x840: Call2 0x81a
...
0x847: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1091
0x848: Return(); Pop(0)

0x849: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1131
0x84a: Return(); Pop(0)
...
0x84f: Stack[-2] = "quest_b10_01" // @poff=1175
0x850: Stack[-1] = "butcher_dead" // @poff=1201
0x851: Call2 0x7d6
...
0x85a: Pop(0)
0x85b: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1227
0x85c: Pop(1)
...
0x867: Stack[-7] = Stack[-3]
0x868: Stack[-6] = Stack[-2]
0x869: Stack[-5] = Stack[-1]
0x86a: Call2 0x691
...
0x86f: Stack[-11] = Stack[-5]
0x870: Stack[-10] = Stack[-4]
0x871: Stack[-9] = Stack[-3]
0x872: Stack[-7] = Stack[-2]
0x873: Stack[-6] = Stack[-1]
0x874: Call2 0x6d5
