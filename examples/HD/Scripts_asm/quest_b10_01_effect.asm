...
Strings:
	...
	W:b10q01_stop
	A:add
// @pool_raw:680075006e0067006500720000006200310030007100300031005f00730074006f007000000061646400
...
0x49: Stack[-10] = Stack[-2]
0x4a: Stack[-9] = Stack[-1]
0x4b: Call2 0x51
...
0x58: Stack[-1] = Stack[-4]
0x59: Return(); Pop(0)

0x5a: Stack[-3] = Stack[-4]
0x5b: Return(); Pop(0)

0x5c: PushEmpty(object, object)
0x5d: @ CreateFloatVector(Stack[-1])
0x5e: Pop(0)
0x5f: @@ add(Stack[-3]); Obj=1 // @poff=38
0x60: Pop(0)
0x61: Push((int) 12)
