...
Strings:
	...
	W:cleanup
	W:restore
// @pool_raw:6800650061006c0074006800000053657450726f70657274790073006300720069007000740065006400000066006900720065002e0078006d006c0000006500780070006c006f0064006500000063006c00650061006e0075007000000072006500730074006f00720065000000
...
0xc: Push("health") // @poff=0
0xd: Push((int) 0)
0xe: @@ SetProperty(Stack[-2], Stack[-1]); Obj=11 // @poff=14
0xf: Pop(2)
0x10: @ GetScene(Stack[-3])
0x11: Pop(0)
0x12: @ GetPosition(Stack[-2])
0x13: Pop(0)
0x14: Push("scripted") // @poff=26
0x15: Push(CVector(0.0, 0.0, 0.0))
0x16: Push("fire.xml") // @poff=44
0x17: @ AddActorByType(Stack[-4], Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x18: Pop(3)
0x19: Push("explode") // @poff=62
