...
// @pool_raw:
// @pool_encoding:utf8
...
0x184: Stack[-1] = 0
0x185: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x186: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x187: @ RotateAsync(Stack[-2], Stack[-1])
0x188: Pop(2)
0x189: Return(); Pop(0)

0x18a: PushEmpty(object, bool, object, bool)
0x18b: Push("player") // @poff=206
...
0x266: Pop(0)
0x267: @@ GetPosition(Stack[-2]); Obj=7 // @poff=220
0x268: Pop(0)
...
0x273: Pop(2)
0x274: Stack[-1] = Stack[-8]
0x275: Return(); Pop(6)

0x276: PushEmpty(cvector, cvector)
0x277: @@ GetPosition(Stack[-1]); Obj=3 // @poff=220
0x278: Pop(0)
0x279: PushEmpty(bool, cvector)
0x27a: Stack[-3] = Stack[-1]
0x27b: Call2 0x26c

0x27c: Stack[-2] = Stack[-6]
0x27d: Pop(2)
0x27e: Return(); Pop(2)
...
0x285: @@ GetPosition(Stack[-8]); Obj=20 // @poff=220
0x286: Pop(0)
0x287: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=232
0x288: Pop(0)
...
0x2f4: Push("voice_common") // @poff=256
0x2f5: Push((int) 1)
...
0x2fc: Push("voice_common") // @poff=256
0x2fd: Push((int) 0)
...
0x30f: Push("voice_common") // @poff=256
0x310: Push((int) 1)
...
0x31d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=286
0x31e: Pop(1)
...
0x348: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=286
0x349: Pop(1)
...
0x35d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=298
0x35e: Pop(1)
...
0x370: Push("Can't find lsh animation : ") // @poff=314
...
0x37f: Push("Can't find lsh animation : ") // @poff=314
...
0x3a3: Push((float)9.999999974752427e-07)
...
0x3ce: Stack[-2] = Stack[-5]
0x3cf: Return(); Pop(4)

0x3d0: PushEmpty()
0x3d1: Push("b10q04PlennikTalk") // @poff=370
0x3d2: Push((int) 1)
...
0x3d8: Stack[-1] = "b10q04PlennikTalk" // @poff=370
0x3d9: Call2 0x3aa
...
0x3f7: Stack[-1] = "ui/NPC_BigVlad.png" // @poff=420
0x3f8: Return(); Pop(0)

0x3f9: Stack[-1] = "ui/NPC_BigVlad_b.png" // @poff=458
0x3fa: Return(); Pop(0)
