...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x164: Push("player") // @poff=172
0x165: @ FindActor(Stack[-4]T, Stack[-1])
0x166: Pop(1)
...
0x179: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x204: Pop(0)
0x205: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x206: Pop(0)
...
0x210: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x211: Pop(0)
0x212: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x213: Pop(0)
...
0x271: Push("Can't find lsh animation : ") // @poff=222
...
0x280: Push("Can't find lsh animation : ") // @poff=222
...
0x286: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x287: Pop(0)
...
0x2a0: Push((float)9.999999974752427e-07)
...
0x2cd: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=278
0x2ce: Return(); Pop(0)

0x2cf: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=318
0x2d0: Return(); Pop(0)
...
0x2d3: PushEmpty()
0x2d4: Push("oob10GirlLaska1") // @poff=362
0x2d5: Push((int) 1)
...
0x2da: Push("b10q04GirlGotoKapella") // @poff=394
0x2db: Push((int) 1)
...
0x2e1: Pop(1)
0x2e2: Push("b10q04GirlGotoKapella") // @poff=394
0x2e3: Push("pt_map_kapella") // @poff=438
0x2e4: Push((int) 0)
...
0x2e8: Pop(0)
0x2e9: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=468
0x2ea: Pop(5)
0x2eb: Return(); Pop(2)
...
0x2f2: Pop(1)
0x2f3: Stack[-2] = "pt_map_kapella" // @poff=438
0x2f4: Stack[-1] = (int) 2
0x2f5: Call2 0x31a
...
0x2f9: Pop(0)
0x2fa: @@ ShowMap(Stack[-1]); Obj=2 // @poff=476
0x2fb: Pop(1)
0x2fc: Return(); Pop(0)

0x2fd: PushEmpty()
0x2fe: PushEmpty(int, string)
0x2ff: Stack[-1] = "oob10GirlLaska1" // @poff=362
0x300: Call2 0x2a7
...
0x30b: Pop(0)
0x30c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x30d: IF (Stack[-1] == 0) GOTO 0x314; Pop(1)

0x30e: Push("Can't find main outdoor scene") // @poff=484
0x30f: @ Trace(Stack[-1])
0x310: Pop(1)
0x311: Stack[-1] = 0
...
0x314: @@ GetMap(Stack[-1]); Obj=2 // @poff=544
0x315: Pop(0)
0x316: Stack[-1] = Stack[-5]
0x317: Return(); Pop(4)
...
0x31c: Pop(0)
0x31d: Pop(0); PushNull((bool) Stack[-2] == 0)
0x31e: IF (Stack[-1] == 0) GOTO 0x323; Pop(1)

0x31f: Push("Can't find main outdoor scene") // @poff=484
0x320: @ Trace(Stack[-1])
0x321: Pop(1)
0x322: Return(); Pop(8)

0x323: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=551
0x324: Pop(0)
0x325: Pop(0); Push((bool) Stack[-1] == 0)
0x326: IF (Stack[-1] == 0) GOTO 0x32d; Pop(1)

0x327: Push("Warning: outdoor scene locator ") // @poff=562
0x328: Pop(1); Push(Stack[-1] + Stack[-11]);
0x329: Push(" doesnt exist") // @poff=626
0x32a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x32b: @ Trace(Stack[-1])
0x32c: Pop(1)
0x32d: @@ GetMap(Stack[-11]); Obj=2 // @poff=544
0x32e: Pop(0)
0x32f: Pop(0); PushNull((bool) Stack[-11] == 0)
0x330: IF (Stack[-1] == 0) GOTO 0x335; Pop(1)

0x331: Push("Can't find map") // @poff=654
0x332: @ Trace(Stack[-1])
0x333: Pop(1)
0x334: Return(); Pop(8)
...
0x337: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=684
0x338: Pop(2)
0x339: Return(); Pop(8)

0x33a: Stack[-2] = 0
0x33b: PushEmpty(int, int)
0x33c: Push("branch") // @poff=697
