...
Strings:
	...
	W:idle
// @pool_raw:
...
0x47: Stack[-1] = 0
0x48: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x49: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x4a: @ RotateAsync(Stack[-2], Stack[-1])
0x4b: Pop(2)
0x4c: Return(); Pop(0)

0x4d: PushEmpty(object, bool, object, bool)
0x4e: Push("player") // @poff=32
...
0xcd: Stack[-4] = Stack[-1]
0xce: Call2 0x0

0xcf: Pop(1)
0xd0: PushEmpty(string)
0xd1: Stack[-1] = "Neutral" // @poff=46
0xd2: Call2 0x16c
...
0x129: Pop(0)
0x12a: @@ GetPosition(Stack[-2]); Obj=7 // @poff=70
0x12b: Pop(0)
...
0x136: Pop(2)
0x137: Stack[-1] = Stack[-8]
0x138: Return(); Pop(6)

0x139: PushEmpty(cvector, cvector)
0x13a: @@ GetPosition(Stack[-1]); Obj=3 // @poff=70
0x13b: Pop(0)
0x13c: PushEmpty(bool, cvector)
0x13d: Stack[-3] = Stack[-1]
0x13e: Call2 0x12f

0x13f: Stack[-2] = Stack[-6]
0x140: Pop(2)
0x141: Return(); Pop(2)
...
0x14f: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=86
0x150: Pop(1)
...
0x164: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=98
0x165: Pop(1)
0x166: PushEmpty(bool, string)
0x167: Stack[-3] = Stack[-1]
0x168: Call2 0x17c

0x169: Stack[-2] = Stack[-14]
0x16a: Pop(2)
0x16b: Return(); Pop(10)
...
0x177: Push("Can't find lsh animation : ") // @poff=110
...
0x18c: @ self(Stack[-1])
0x18d: Pop(0)
0x18e: Stack[-1] = Stack[-3]
0x18f: Return(); Pop(2)

0x190: Stack[-1] = 0
0x191: PushEmpty(string, string)
0x192: Stack[-1] = "idle" // @poff=166
0x193: Push(Stack[-3])
...
0x199: Stack[-2] = (int) 0
0x19a: Push("all") // @poff=62
0x19b: PushEmpty(string, int)
0x19c: Stack[-5] = Stack[-1]
0x19d: Call2 0x191
