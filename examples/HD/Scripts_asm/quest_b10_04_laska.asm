...
// @pool_raw:
// @pool_encoding:utf8
...
0x196: Stack[-2] = Stack[-5]
0x197: Pop(2)
0x198: Return(); Pop(2)

0x199: Stack[-1] = 0
0x19a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x19b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x19c: @ RotateAsync(Stack[-2], Stack[-1])
0x19d: Pop(2)
0x19e: Return(); Pop(0)

0x19f: PushEmpty(object, bool, object, bool)
0x1a0: Push("player") // @poff=188
...
0x27b: Pop(0)
0x27c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x27d: Pop(0)
...
0x28c: @@ GetPosition(Stack[-1]); Obj=3 // @poff=202
0x28d: Pop(0)
0x28e: PushEmpty(bool, cvector)
0x28f: Stack[-3] = Stack[-1]
0x290: Call2 0x281

0x291: Stack[-2] = Stack[-6]
0x292: Pop(2)
0x293: Return(); Pop(2)
...
0x29a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x29b: Pop(0)
0x29c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=214
0x29d: Pop(0)
...
0x2ec: Push("head") // @poff=228
0x2ed: @ UnlookAsync(Stack[-1])
0x2ee: Pop(1)
0x2ef: Return(); Pop(2)

0x2f0: PushEmpty(int, int, int, int)
0x2f1: Push("voice_common") // @poff=238
...
0x309: Push("voice_common") // @poff=238
0x30a: Push((int) 1)
...
0x311: Push("voice_common") // @poff=238
0x312: Push((int) 0)
...
0x324: Push("voice_common") // @poff=238
0x325: Push((int) 1)
...
0x350: Push("d") // @poff=234
0x351: PushEmpty(int)
0x352: Call2 0x3d0

0x353: Pop(0)
0x354: Pop(2); Push(Stack[-2] + Stack[-1]);
0x355: Push("m") // @poff=292
...
0x35d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x35e: Pop(1)
...
0x372: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x373: Pop(1)
...
0x385: Push("Can't find lsh animation : ") // @poff=296
...
0x394: Push("Can't find lsh animation : ") // @poff=296
...
0x3b8: Push((float)9.999999974752427e-07)
...
0x3c6: Pop(0)
0x3c7: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3f1: PushEmpty()
0x3f2: Push("b10q04LaskaTalk") // @poff=352
0x3f3: Push((int) 9)
...
0x3fa: Stack[-2] = "quest_b10_04" // @poff=384
0x3fb: Stack[-1] = "restore_laska" // @poff=410
0x3fc: Call2 0x3c4
...
0x401: Stack[-1] = "b10q04LaskaTalk" // @poff=352
0x402: Call2 0x3bf
...
0x41d: Push("Can't retrieve diary root") // @poff=438
0x41e: @ Trace(Stack[-1])
0x41f: Pop(1)
...
0x429: Pop(1)
0x42a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=490
0x42b: Pop(0)
0x42c: Pop(0); Push((bool) Stack[-2] == 0)
0x42d: IF (Stack[-1] == 0) GOTO 0x434; Pop(1)

0x42e: Push("Can't find diary parent with id: ") // @poff=495
...
0x434: @@ AddChild(Stack[-8]); Obj=2 // @poff=563
0x435: Pop(0)
0x436: Push((int) 7)
0x437: @ SendWorldWndMessage(Stack[-1])
0x438: Pop(1)
0x439: @@ GetCategory(Stack[-1]); Obj=8 // @poff=572
0x43a: Pop(0)
...
0x456: Stack[-1] = "ui/NPC_Laska.png" // @poff=598
0x457: Return(); Pop(0)

0x458: Stack[-1] = "ui/NPC_Laska_b.png" // @poff=632
0x459: Return(); Pop(0)
