...
// @pool_raw:
// @pool_encoding:utf8
...
0x9b: Push("all") // @poff=154
0x9c: Push("idle") // @poff=162
...
0xa4: Push("all") // @poff=154
0xa5: Push("idle") // @poff=162
...
0x1ba: Stack[-1] = 0
0x1bb: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1bc: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1bd: @ RotateAsync(Stack[-2], Stack[-1])
0x1be: Pop(2)
0x1bf: Return(); Pop(0)

0x1c0: PushEmpty(object, bool, object, bool)
0x1c1: Push("player") // @poff=224
...
0x21e: Stack[-1] = "Neutral" // @poff=138
0x21f: Call2 0x39b
...
0x22d: Stack[-1] = "Neutral" // @poff=138
0x22e: Call2 0x39b
...
0x244: Stack[-1] = "Neutral" // @poff=138
0x245: Call2 0x39b
...
0x29c: Pop(0)
0x29d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=238
0x29e: Pop(0)
...
0x2a9: Pop(2)
0x2aa: Stack[-1] = Stack[-8]
0x2ab: Return(); Pop(6)

0x2ac: PushEmpty(cvector, cvector)
0x2ad: @@ GetPosition(Stack[-1]); Obj=3 // @poff=238
0x2ae: Pop(0)
0x2af: PushEmpty(bool, cvector)
0x2b0: Stack[-3] = Stack[-1]
0x2b1: Call2 0x2a2

0x2b2: Stack[-2] = Stack[-6]
0x2b3: Pop(2)
0x2b4: Return(); Pop(2)
...
0x2bb: @@ GetPosition(Stack[-8]); Obj=20 // @poff=238
0x2bc: Pop(0)
0x2bd: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=250
0x2be: Pop(0)
...
0x32a: Push("voice_common") // @poff=274
0x32b: Push((int) 1)
...
0x332: Push("voice_common") // @poff=274
0x333: Push((int) 0)
...
0x345: Push("voice_common") // @poff=274
0x346: Push((int) 1)
...
0x353: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x354: Pop(1)
...
0x368: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x369: Pop(1)
...
0x371: Push("d") // @poff=270
0x372: PushEmpty(int)
0x373: Call2 0x3e5

0x374: Pop(0)
0x375: Pop(2); Push(Stack[-2] + Stack[-1]);
0x376: Push("m") // @poff=328
...
0x37e: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x37f: Pop(1)
...
0x393: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x394: Pop(1)
...
0x3a6: Push("Can't find lsh animation : ") // @poff=332
...
0x3b5: Push("Can't find lsh animation : ") // @poff=332
...
0x3d9: Push((float)9.999999974752427e-07)
...
0x406: PushEmpty()
0x407: Push("b10q04PlennikTalk") // @poff=388
0x408: Push((int) 1)
...
0x40e: Stack[-1] = "b10q04PlennikTalk" // @poff=388
0x40f: Call2 0x3e0
...
0x42d: Stack[-1] = "ui/NPC_MladVlad.png" // @poff=438
0x42e: Return(); Pop(0)

0x42f: Stack[-1] = "ui/NPC_MladVlad_b.png" // @poff=478
0x430: Return(); Pop(0)
