...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
...
0x1a: Stack[-8] = Stack[-2]
0x1b: Stack[-7] = Stack[-1]
0x1c: Call2 0x54
...
0x5b: Push("player") // @poff=16
0x5c: @ FindActor(Stack[-4]T, Stack[-1])
0x5d: Pop(1)
...
0x70: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0xc5: Pop(0)
0xc6: Push("all") // @poff=40
0xc7: PushEmpty(string, int)
0xc8: Stack[-7] = Stack[-1]
0xc9: Call2 0x3ff
...
0x108: Pop(0)
0x109: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=48
0x10a: Pop(1)
0x10b: PushEmpty(int)
0x10c: Call2 0x417

0x10d: Pop(0)
0x10e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=59
0x10f: Pop(1)
0x110: PushEmpty(string)
0x111: Call2 0x41b

0x112: Pop(0)
0x113: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=77
0x114: Pop(1)
0x115: PushEmpty(string)
0x116: Call2 0x41d

0x117: Pop(0)
0x118: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=86
0x119: Pop(1)
0x11a: PushEmpty(int)
0x11b: Call2 0x54e

0x11c: Pop(0)
0x11d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=96
0x11e: Pop(1)
0x11f: Stack[-2] = (int) -1
...
0x12e: Pop(2)
0x12f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=110
0x130: Pop(0)
...
0x133: @ sync()
0x134: Pop(0)
0x135: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=110
0x136: Pop(0)
0x137: GOTO 0x131

0x138: PushEmpty(object)
0x139: Stack[-10] = Stack[-1]
0x13a: Call2 0x396

0x13b: Pop(1)
0x13c: @ StopDialog(Stack[-4])
0x13d: Pop(0)
0x13e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=122
0x13f: Pop(0)
0x140: Stack[-2] = Stack[-10]
0x141: Return(); Pop(8)
...
0x15d: Stack[-1] = "Neutral" // @poff=137
0x15e: Call2 0x1ee

0x15f: Pop(1)
0x160: Push((int) 530386)
0x161: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x162: Pop(1)
0x163: @@@ ClearReplies(); Obj=0 // @poff=164
0x164: Pop(0)
0x165: Push((int) 530387)
0x166: Push((int) 31760)
0x167: Push((int) 31759)
0x168: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x169: Pop(3)
0x16a: Push((int) 531497)
0x16b: Push((int) 31762)
0x16c: Push((int) 32855)
0x16d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x16e: Pop(3)
0x16f: GOTO 0x1d0
...
0x18a: Stack[-1] = "Neutral" // @poff=137
0x18b: Call2 0x1ee

0x18c: Pop(1)
0x18d: Push((int) 530396)
0x18e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x18f: Pop(1)
0x190: @@@ ClearReplies(); Obj=0 // @poff=164
0x191: Pop(0)
0x192: Push((int) 530397)
0x193: Push((int) 31770)
0x194: Push((int) 31769)
0x195: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x196: Pop(3)
0x197: GOTO 0x1d0

0x198: PushEmpty(string)
0x199: Stack[-1] = "Neutral" // @poff=137
0x19a: Call2 0x1ee

0x19b: Pop(1)
0x19c: Push((int) 530394)
0x19d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x19e: Pop(1)
0x19f: @@@ ClearReplies(); Obj=0 // @poff=164
0x1a0: Pop(0)
...
0x1c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x1c7: Pop(3)
0x1c8: Push((int) 530395)
0x1c9: Push((int) -1)
0x1ca: Push((int) 31767)
0x1cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x1cc: Pop(3)
0x1cd: GOTO 0x1d0
...
0x1df: Push("all") // @poff=40
0x1e0: Push("idle") // @poff=186
...
0x1e8: Push("all") // @poff=40
0x1e9: Push("idle") // @poff=186
...
0x24b: Stack[-1] = "Neutral" // @poff=137
0x24c: Call2 0x1ee

0x24d: Pop(1)
0x24e: Push((int) 530386)
0x24f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x250: Pop(1)
0x251: @@@ ClearReplies(); Obj=0 // @poff=164
0x252: Pop(0)
0x253: Push((int) 530387)
0x254: Push((int) 31760)
0x255: Push((int) 31759)
0x256: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x257: Pop(3)
0x258: Push((int) 531497)
0x259: Push((int) 31762)
0x25a: Push((int) 32855)
0x25b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x25c: Pop(3)
0x25d: Return(); Pop(0)
...
0x278: Stack[-1] = "Neutral" // @poff=137
0x279: Call2 0x1ee

0x27a: Pop(1)
0x27b: Push((int) 530396)
0x27c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x27d: Pop(1)
0x27e: @@@ ClearReplies(); Obj=0 // @poff=164
0x27f: Pop(0)
0x280: Push((int) 530397)
0x281: Push((int) 31770)
0x282: Push((int) 31769)
0x283: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x284: Pop(3)
0x285: Return(); Pop(0)

0x286: PushEmpty(string)
0x287: Stack[-1] = "Neutral" // @poff=137
0x288: Call2 0x1ee

0x289: Pop(1)
0x28a: Push((int) 530394)
0x28b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x28c: Pop(1)
0x28d: @@@ ClearReplies(); Obj=0 // @poff=164
0x28e: Pop(0)
...
0x2b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2b5: Pop(3)
0x2b6: Push((int) 530395)
0x2b7: Push((int) -1)
0x2b8: Push((int) 31767)
0x2b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2ba: Pop(3)
0x2bb: Return(); Pop(0)
...
0x2c0: Stack[-1] = "Neutral" // @poff=137
0x2c1: Call2 0x1ee

0x2c2: Pop(1)
0x2c3: Push((int) 530403)
0x2c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x2c5: Pop(1)
0x2c6: @@@ ClearReplies(); Obj=0 // @poff=164
0x2c7: Pop(0)
0x2c8: Push((int) 530404)
0x2c9: Push((int) -1)
0x2ca: Push((int) 31776)
0x2cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2cc: Pop(3)
0x2cd: Return(); Pop(0)
...
0x2d2: Stack[-1] = "Neutral" // @poff=137
0x2d3: Call2 0x1ee

0x2d4: Pop(1)
0x2d5: Push((int) 530398)
0x2d6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x2d7: Pop(1)
0x2d8: @@@ ClearReplies(); Obj=0 // @poff=164
0x2d9: Pop(0)
0x2da: Push((int) 530399)
0x2db: Push((int) 31772)
0x2dc: Push((int) 31771)
0x2dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2de: Pop(3)
0x2df: Push((int) 531496)
0x2e0: Push((int) -1)
0x2e1: Push((int) 32854)
0x2e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2e3: Pop(3)
0x2e4: Return(); Pop(0)
...
0x2e9: Stack[-1] = "Neutral" // @poff=137
0x2ea: Call2 0x1ee

0x2eb: Pop(1)
0x2ec: Push((int) 530400)
0x2ed: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x2ee: Pop(1)
0x2ef: @@@ ClearReplies(); Obj=0 // @poff=164
0x2f0: Pop(0)
0x2f1: Push((int) 530401)
0x2f2: Push((int) -1)
0x2f3: Push((int) 31773)
0x2f4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x2f5: Pop(3)
0x2f6: Return(); Pop(0)
...
0x2fb: Stack[-1] = "Neutral" // @poff=137
0x2fc: Call2 0x1ee

0x2fd: Pop(1)
0x2fe: Push((int) 530388)
0x2ff: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x300: Pop(1)
0x301: @@@ ClearReplies(); Obj=0 // @poff=164
0x302: Pop(0)
0x303: Push((int) 530389)
0x304: Push((int) 31762)
0x305: Push((int) 31761)
0x306: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x307: Pop(3)
0x308: Push((int) 531498)
0x309: Push((int) 31762)
0x30a: Push((int) 32857)
0x30b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x30c: Pop(3)
0x30d: Return(); Pop(0)
...
0x312: Stack[-1] = "Neutral" // @poff=137
0x313: Call2 0x1ee

0x314: Pop(1)
0x315: Push((int) 530390)
0x316: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x317: Pop(1)
0x318: @@@ ClearReplies(); Obj=0 // @poff=164
0x319: Pop(0)
0x31a: Push((int) 530391)
0x31b: Push((int) 31764)
0x31c: Push((int) 31763)
0x31d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x31e: Pop(3)
0x31f: Push((int) 531499)
0x320: Push((int) 31764)
0x321: Push((int) 32859)
0x322: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x323: Pop(3)
0x324: Return(); Pop(0)
...
0x329: Stack[-1] = "Neutral" // @poff=137
0x32a: Call2 0x1ee

0x32b: Pop(1)
0x32c: Push((int) 530392)
0x32d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x32e: Pop(1)
0x32f: @@@ ClearReplies(); Obj=0 // @poff=164
0x330: Pop(0)
0x331: Push((int) 530393)
0x332: Push((int) -1)
0x333: Push((int) 31765)
0x334: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x335: Pop(3)
0x336: Return(); Pop(0)
...
0x346: Pop(0)
0x347: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x348: Pop(0)
...
0x352: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x353: Pop(0)
0x354: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x355: Pop(0)
...
0x3b3: Push("Can't find lsh animation : ") // @poff=222
...
0x3c2: Push("Can't find lsh animation : ") // @poff=222
...
0x3c8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x3c9: Pop(0)
...
0x3e2: Push((float)9.999999974752427e-07)
...
0x3f0: Pop(0)
0x3f1: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x41b: Stack[-1] = "ui/NPC_Morlok.png" // @poff=278
0x41c: Return(); Pop(0)

0x41d: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=314
0x41e: Return(); Pop(0)
...
0x425: Stack[-1] = Stack[-4]
0x426: Pop(1)
0x427: Stack[-2] = "pt_map_notkin" // @poff=354
0x428: Stack[-1] = (int) 2
0x429: Call2 0x52d
...
0x42d: Pop(0)
0x42e: @@ ShowMap(Stack[-1]); Obj=2 // @poff=382
0x42f: Pop(1)
0x430: Return(); Pop(0)

0x431: PushEmpty(object, object)
0x432: Push("b10q04NotkinTalk") // @poff=390
0x433: Push((int) 1)
...
0x439: Pop(1)
0x43a: Push("b10q04MorlokGotoNotkin") // @poff=424
0x43b: Push("pt_map_notkin") // @poff=354
0x43c: Push((int) 0)
...
0x440: Pop(0)
0x441: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=470
0x442: Pop(5)
0x443: PushEmpty()
0x444: Call2 0x4e6
...
0x44d: Stack[-2] = "quest_b10_04" // @poff=478
0x44e: Stack[-1] = "completed" // @poff=504
0x44f: Call2 0x3ee
...
0x452: PushEmpty()
0x453: Push("oob10MorlokMain1") // @poff=524
0x454: Push((int) 1)
...
0x458: PushEmpty()
0x459: Push("oob10MorlokMain2") // @poff=558
0x45a: Push((int) 1)
...
0x45e: PushEmpty()
0x45f: Push("b10q04MorlokTalk") // @poff=592
0x460: Push((int) 1)
...
0x478: Stack[-1] = "b10q04NotkinTalk" // @poff=390
0x479: Call2 0x3e9
...
0x47f: Stack[-1] = "b10q04Spi4kaTalk" // @poff=640
0x480: Call2 0x3e9
...
0x488: Stack[-1] = "b10q04MishkaTalk" // @poff=674
0x489: Call2 0x3e9
...
0x491: Stack[-1] = "b10q04LaskaTalk" // @poff=708
0x492: Call2 0x3e9
...
0x49f: Stack[-1] = "b10q04NotkinTalk" // @poff=390
0x4a0: Call2 0x3e9
...
0x4c3: Stack[-1] = "oob10MorlokMain1" // @poff=524
0x4c4: Call2 0x3e9
...
0x4cf: Stack[-1] = "oob10MorlokMain2" // @poff=558
0x4d0: Call2 0x3e9
...
0x4f8: Push("Can't retrieve diary root") // @poff=740
0x4f9: @ Trace(Stack[-1])
0x4fa: Pop(1)
...
0x503: Stack[-1] = Stack[-4]
0x504: Pop(1)
0x505: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=792
0x506: Pop(0)
0x507: Pop(0); Push((bool) Stack[-2] == 0)
0x508: IF (Stack[-1] == 0) GOTO 0x50f; Pop(1)

0x509: Push("Can't find diary parent with id: ") // @poff=797
...
0x50f: @@ AddChild(Stack[-8]); Obj=2 // @poff=865
0x510: Pop(0)
0x511: Push((int) 7)
0x512: @ SendWorldWndMessage(Stack[-1])
0x513: Pop(1)
0x514: @@ GetCategory(Stack[-1]); Obj=8 // @poff=874
0x515: Pop(0)
...
0x51e: Pop(0)
0x51f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x520: IF (Stack[-1] == 0) GOTO 0x527; Pop(1)

0x521: Push("Can't find main outdoor scene") // @poff=886
0x522: @ Trace(Stack[-1])
0x523: Pop(1)
0x524: Stack[-1] = 0
...
0x527: @@ GetMap(Stack[-1]); Obj=2 // @poff=946
0x528: Pop(0)
0x529: Stack[-1] = Stack[-5]
0x52a: Return(); Pop(4)
...
0x52f: Pop(0)
0x530: Pop(0); PushNull((bool) Stack[-2] == 0)
0x531: IF (Stack[-1] == 0) GOTO 0x536; Pop(1)

0x532: Push("Can't find main outdoor scene") // @poff=886
0x533: @ Trace(Stack[-1])
0x534: Pop(1)
0x535: Return(); Pop(8)

0x536: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=953
0x537: Pop(0)
0x538: Pop(0); Push((bool) Stack[-1] == 0)
0x539: IF (Stack[-1] == 0) GOTO 0x540; Pop(1)

0x53a: Push("Warning: outdoor scene locator ") // @poff=964
0x53b: Pop(1); Push(Stack[-1] + Stack[-11]);
0x53c: Push(" doesnt exist") // @poff=1028
0x53d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x53e: @ Trace(Stack[-1])
0x53f: Pop(1)
0x540: @@ GetMap(Stack[-11]); Obj=2 // @poff=946
0x541: Pop(0)
0x542: Pop(0); PushNull((bool) Stack[-11] == 0)
0x543: IF (Stack[-1] == 0) GOTO 0x548; Pop(1)

0x544: Push("Can't find map") // @poff=1056
0x545: @ Trace(Stack[-1])
0x546: Pop(1)
0x547: Return(); Pop(8)
...
0x54a: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1086
0x54b: Pop(2)
0x54c: Return(); Pop(8)

0x54d: Stack[-2] = 0
0x54e: PushEmpty(int, int)
0x54f: Push("branch") // @poff=1099
