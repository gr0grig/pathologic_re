...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
...
0x150: Stack[-1] = "Neutral" // @poff=137
0x151: Call2 0x1be

0x152: Pop(1)
0x153: Push((int) 530541)
0x154: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x155: Pop(1)
0x156: @@@ ClearReplies(); Obj=0 // @poff=164
0x157: Pop(0)
0x158: Push((int) 530542)
0x159: Push((int) -1)
0x15a: Push((int) 31889)
0x15b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x15c: Pop(3)
0x15d: GOTO 0x1a0
...
0x164: Stack[-1] = "Neutral" // @poff=137
0x165: Call2 0x1be

0x166: Pop(1)
0x167: Push((int) 530427)
0x168: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x169: Pop(1)
0x16a: @@@ ClearReplies(); Obj=0 // @poff=164
0x16b: Pop(0)
0x16c: Push((int) 530428)
0x16d: Push((int) -1)
0x16e: Push((int) 31800)
0x16f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x170: Pop(3)
0x171: GOTO 0x1a0

0x172: PushEmpty(string)
0x173: Stack[-1] = "Neutral" // @poff=137
0x174: Call2 0x1be

0x175: Pop(1)
0x176: Push((int) 530429)
0x177: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x178: Pop(1)
0x179: @@@ ClearReplies(); Obj=0 // @poff=164
0x17a: Pop(0)
...
0x196: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x197: Pop(3)
0x198: Push((int) 530435)
0x199: Push((int) -1)
0x19a: Push((int) 31807)
0x19b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x19c: Pop(3)
0x19d: GOTO 0x1a0
...
0x1af: Push("all") // @poff=40
0x1b0: Push("idle") // @poff=186
...
0x1b8: Push("all") // @poff=40
0x1b9: Push("idle") // @poff=186
...
0x213: Stack[-1] = "Neutral" // @poff=137
0x214: Call2 0x1be

0x215: Pop(1)
0x216: Push((int) 530541)
0x217: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x218: Pop(1)
0x219: @@@ ClearReplies(); Obj=0 // @poff=164
0x21a: Pop(0)
0x21b: Push((int) 530542)
0x21c: Push((int) -1)
0x21d: Push((int) 31889)
0x21e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x21f: Pop(3)
0x220: Return(); Pop(0)
...
0x236: Stack[-1] = "Neutral" // @poff=137
0x237: Call2 0x1be

0x238: Pop(1)
0x239: Push((int) 530429)
0x23a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x23b: Pop(1)
0x23c: @@@ ClearReplies(); Obj=0 // @poff=164
0x23d: Pop(0)
...
0x259: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x25a: Pop(3)
0x25b: Push((int) 530435)
0x25c: Push((int) -1)
0x25d: Push((int) 31807)
0x25e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x25f: Pop(3)
0x260: Return(); Pop(0)
...
0x26a: Stack[-1] = "Neutral" // @poff=137
0x26b: Call2 0x1be

0x26c: Pop(1)
0x26d: Push((int) 530431)
0x26e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x26f: Pop(1)
0x270: @@@ ClearReplies(); Obj=0 // @poff=164
0x271: Pop(0)
0x272: Push((int) 530432)
0x273: Push((int) -1)
0x274: Push((int) 31804)
0x275: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x276: Pop(3)
0x277: Return(); Pop(0)
...
0x27f: Stack[-1] = "Neutral" // @poff=137
0x280: Call2 0x1be

0x281: Pop(1)
0x282: Push((int) 530433)
0x283: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=153
0x284: Pop(1)
0x285: @@@ ClearReplies(); Obj=0 // @poff=164
0x286: Pop(0)
0x287: Push((int) 530434)
0x288: Push((int) -1)
0x289: Push((int) 31806)
0x28a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=177
0x28b: Pop(3)
0x28c: Return(); Pop(0)
...
0x309: Push("Can't find lsh animation : ") // @poff=222
...
0x318: Push("Can't find lsh animation : ") // @poff=222
...
0x31e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x31f: Pop(0)
...
0x338: Push((float)9.999999974752427e-07)
...
0x346: Pop(0)
0x347: @@ add(Stack[-4]); Obj=1 // @poff=278
0x348: Pop(0)
0x349: @@ add(Stack[-3]); Obj=1 // @poff=278
0x34a: Pop(0)
0x34b: Push((int) 3)
...
0x351: @@ GetItemID(Stack[-3]); Obj=8 // @poff=282
0x352: Pop(0)
0x353: Push("Category") // @poff=292
0x354: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x355: Pop(1)
0x356: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=310
0x357: Pop(0)
0x358: Pop(0); Push((bool) Stack[-1] == 0)
0x359: IF (Stack[-1] == 0) GOTO 0x35d; Pop(1)

0x35a: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=318
0x35b: Pop(0)
0x35c: GOTO 0x362

0x35d: PushEmpty(int, int)
0x35e: Stack[-5] = Stack[-2]
...
0x365: Pop(0)
0x366: @@ SetItemName(Stack[-4]); Obj=1 // @poff=328
0x367: Pop(0)
0x368: PushEmpty(object, object, int)
0x369: Stack[-8] = Stack[-3]
0x36a: Stack[-4] = Stack[-2]
0x36b: Stack[-6] = Stack[-1]
0x36c: Call2 0x350
...
0x372: Pop(0)
0x373: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x39d: Stack[-1] = "ui/NPC_Morlok.png" // @poff=340
0x39e: Return(); Pop(0)

0x39f: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=376
0x3a0: Return(); Pop(0)
...
0x3a3: PushEmpty()
0x3a4: Push("avroks blood is given") // @poff=416
0x3a5: @ Trace(Stack[-1])
0x3a6: Pop(1)
0x3a7: PushEmpty(object, string, int)
0x3a8: Stack[-5] = Stack[-3]
0x3a9: Stack[-2] = "avroks_blood" // @poff=460
0x3aa: Stack[-1] = (int) 1
0x3ab: Call2 0x363
...
0x3af: Push("b10q04LaskaTalk") // @poff=486
0x3b0: Push((int) 1)
...
0x3b6: Pop(1)
0x3b7: Push("b10q04MorlokGotoLaska") // @poff=518
0x3b8: Push("pt_map_laska") // @poff=562
0x3b9: Push((int) 0)
...
0x3bd: Pop(0)
0x3be: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=588
0x3bf: Pop(5)
0x3c0: PushEmpty()
0x3c1: Call2 0x44f
...
0x3c4: Stack[-2] = "quest_b10_04" // @poff=596
0x3c5: Stack[-1] = "init_storojka" // @poff=622
0x3c6: Call2 0x370
...
0x3c9: Stack[-1] = 0
0x3ca: PushEmpty()
0x3cb: Push("oob10MorlokLaska1") // @poff=650
0x3cc: Push((int) 1)
...
0x3d0: PushEmpty()
0x3d1: Push("playsound") // @poff=686
0x3d2: Push("giveitem") // @poff=706
...
0x3db: Pop(1)
0x3dc: Stack[-2] = "pt_map_laska" // @poff=562
0x3dd: Stack[-1] = (int) 2
0x3de: Call2 0x496
...
0x3e2: Pop(0)
0x3e3: @@ ShowMap(Stack[-1]); Obj=2 // @poff=724
0x3e4: Pop(1)
0x3e5: Return(); Pop(0)
...
0x3ee: Stack[-1] = "b10q04NotkinTalk" // @poff=732
0x3ef: Call2 0x33f
...
0x3f5: Stack[-1] = "b10q04Spi4kaTalk" // @poff=766
0x3f6: Call2 0x33f
...
0x3fe: Stack[-1] = "b10q04MishkaTalk" // @poff=800
0x3ff: Call2 0x33f
...
0x407: Stack[-1] = "b10q04LaskaTalk" // @poff=486
0x408: Call2 0x33f
...
0x415: Stack[-1] = "b10q04LaskaTalk" // @poff=486
0x416: Call2 0x33f
...
0x42d: Stack[-1] = "b10q04LaskaTalk" // @poff=486
0x42e: Call2 0x33f
...
0x439: Stack[-1] = "oob10MorlokLaska1" // @poff=650
0x43a: Call2 0x33f
...
0x445: Stack[-1] = "b10q04MorlokTalk" // @poff=848
0x446: Call2 0x33f
...
0x461: Push("Can't retrieve diary root") // @poff=882
0x462: @ Trace(Stack[-1])
0x463: Pop(1)
...
0x46d: Pop(1)
0x46e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=934
0x46f: Pop(0)
0x470: Pop(0); Push((bool) Stack[-2] == 0)
0x471: IF (Stack[-1] == 0) GOTO 0x478; Pop(1)

0x472: Push("Can't find diary parent with id: ") // @poff=939
...
0x478: @@ AddChild(Stack[-8]); Obj=2 // @poff=1007
0x479: Pop(0)
0x47a: Push((int) 7)
0x47b: @ SendWorldWndMessage(Stack[-1])
0x47c: Pop(1)
0x47d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1016
0x47e: Pop(0)
...
0x487: Pop(0)
0x488: Pop(0); PushNull((bool) Stack[-2] == 0)
0x489: IF (Stack[-1] == 0) GOTO 0x490; Pop(1)

0x48a: Push("Can't find main outdoor scene") // @poff=1028
0x48b: @ Trace(Stack[-1])
0x48c: Pop(1)
0x48d: Stack[-1] = 0
...
0x490: @@ GetMap(Stack[-1]); Obj=2 // @poff=1088
0x491: Pop(0)
...
0x498: Pop(0)
0x499: Pop(0); PushNull((bool) Stack[-2] == 0)
0x49a: IF (Stack[-1] == 0) GOTO 0x49f; Pop(1)

0x49b: Push("Can't find main outdoor scene") // @poff=1028
0x49c: @ Trace(Stack[-1])
0x49d: Pop(1)
0x49e: Return(); Pop(8)

0x49f: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1095
0x4a0: Pop(0)
0x4a1: Pop(0); Push((bool) Stack[-1] == 0)
0x4a2: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a3: Push("Warning: outdoor scene locator ") // @poff=1106
0x4a4: Pop(1); Push(Stack[-1] + Stack[-11]);
0x4a5: Push(" doesnt exist") // @poff=1170
0x4a6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4a7: @ Trace(Stack[-1])
0x4a8: Pop(1)
0x4a9: @@ GetMap(Stack[-11]); Obj=2 // @poff=1088
0x4aa: Pop(0)
0x4ab: Pop(0); PushNull((bool) Stack[-11] == 0)
0x4ac: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)

0x4ad: Push("Can't find map") // @poff=1198
0x4ae: @ Trace(Stack[-1])
0x4af: Pop(1)
0x4b0: Return(); Pop(8)
...
0x4b3: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1228
0x4b4: Pop(2)
0x4b5: Return(); Pop(8)

0x4b6: Stack[-2] = 0
0x4b7: PushEmpty(int, int)
0x4b8: Push("branch") // @poff=1241
