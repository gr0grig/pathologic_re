...
Strings:
	...
	W:avroks_blood
	W:b10q04MishkaTalk
	W:b10q04MorlokGotoMishka
	W:pt_map_mishka
	A:AddMark
	W:oob10MorlokMishka1
	W:playsound
	W:giveitem
	A:ShowMap
	W:b10q04NotkinTalk
	...
	A:SetMapParams
	W:branch
// @pool_raw:
...
0x391: Stack[-1] = "ui/NPC_Morlok.png" // @poff=340
0x392: Return(); Pop(0)

0x393: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=376
0x394: Return(); Pop(0)
...
0x397: PushEmpty()
0x398: Push("avroks blood is given") // @poff=416
0x399: @ Trace(Stack[-1])
0x39a: Pop(1)
0x39b: PushEmpty(object, string, int)
0x39c: Stack[-5] = Stack[-3]
0x39d: Stack[-2] = "avroks_blood" // @poff=460
0x39e: Stack[-1] = (int) 1
0x39f: Call2 0x363
...
0x3a3: Push("b10q04MishkaTalk") // @poff=486
0x3a4: Push((int) 1)
...
0x3aa: Pop(1)
0x3ab: Push("b10q04MorlokGotoMishka") // @poff=520
0x3ac: Push("pt_map_mishka") // @poff=566
0x3ad: Push((int) 0)
0x3ae: Push((int) 530550)
0x3af: PushEmpty(float)
0x3b0: Call2 0x370

0x3b1: Pop(0)
0x3b2: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=594
0x3b3: Pop(5)
0x3b4: PushEmpty()
0x3b5: Call2 0x43e
...
0x3b8: Stack[-1] = 0
0x3b9: PushEmpty()
0x3ba: Push("oob10MorlokMishka1") // @poff=602
0x3bb: Push((int) 1)
...
0x3bf: PushEmpty()
0x3c0: Push("playsound") // @poff=640
0x3c1: Push("giveitem") // @poff=660
...
0x3c9: Stack[-1] = Stack[-4]
0x3ca: Pop(1)
0x3cb: Stack[-2] = "pt_map_mishka" // @poff=566
0x3cc: Stack[-1] = (int) 2
0x3cd: Call2 0x485
...
0x3d1: Pop(0)
0x3d2: @@ ShowMap(Stack[-1]); Obj=2 // @poff=678
0x3d3: Pop(1)
0x3d4: Return(); Pop(0)
...
0x3dd: Stack[-1] = "b10q04NotkinTalk" // @poff=686
0x3de: Call2 0x33f
...
0x3e4: Stack[-1] = "b10q04Spi4kaTalk" // @poff=720
0x3e5: Call2 0x33f
...
0x3ed: Stack[-1] = "b10q04MishkaTalk" // @poff=486
0x3ee: Call2 0x33f
...
0x3f6: Stack[-1] = "b10q04LaskaTalk" // @poff=754
0x3f7: Call2 0x33f
...
0x404: Stack[-1] = "b10q04MishkaTalk" // @poff=486
0x405: Call2 0x33f
...
0x41c: Stack[-1] = "b10q04MishkaTalk" // @poff=486
0x41d: Call2 0x33f
...
0x428: Stack[-1] = "oob10MorlokMishka1" // @poff=602
0x429: Call2 0x33f
...
0x434: Stack[-1] = "b10q04MorlokTalk" // @poff=800
0x435: Call2 0x33f
...
0x450: Push("Can't retrieve diary root") // @poff=834
0x451: @ Trace(Stack[-1])
0x452: Pop(1)
0x453: Stack[-3] = (bool) 0
0x454: Return(); Pop(2)

0x455: Stack[-1] = Stack[-3]
0x456: Return(); Pop(2)
...
0x45b: Stack[-1] = Stack[-4]
0x45c: Pop(1)
0x45d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=886
0x45e: Pop(0)
0x45f: Pop(0); Push((bool) Stack[-2] == 0)
0x460: IF (Stack[-1] == 0) GOTO 0x467; Pop(1)

0x461: Push("Can't find diary parent with id: ") // @poff=891
...
0x467: @@ AddChild(Stack[-8]); Obj=2 // @poff=959
0x468: Pop(0)
0x469: Push((int) 7)
0x46a: @ SendWorldWndMessage(Stack[-1])
0x46b: Pop(1)
0x46c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=968
0x46d: Pop(0)
...
0x476: Pop(0)
0x477: Pop(0); PushNull((bool) Stack[-2] == 0)
0x478: IF (Stack[-1] == 0) GOTO 0x47f; Pop(1)

0x479: Push("Can't find main outdoor scene") // @poff=980
0x47a: @ Trace(Stack[-1])
0x47b: Pop(1)
0x47c: Stack[-1] = 0
...
0x47f: @@ GetMap(Stack[-1]); Obj=2 // @poff=1040
0x480: Pop(0)
...
0x48a: Push("Can't find main outdoor scene") // @poff=980
0x48b: @ Trace(Stack[-1])
0x48c: Pop(1)
0x48d: Return(); Pop(8)

0x48e: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1047
0x48f: Pop(0)
0x490: Pop(0); Push((bool) Stack[-1] == 0)
0x491: IF (Stack[-1] == 0) GOTO 0x498; Pop(1)

0x492: Push("Warning: outdoor scene locator ") // @poff=1058
0x493: Pop(1); Push(Stack[-1] + Stack[-11]);
0x494: Push(" doesnt exist") // @poff=1122
0x495: Pop(2); Push(Stack[-2] + Stack[-1]);
0x496: @ Trace(Stack[-1])
0x497: Pop(1)
0x498: @@ GetMap(Stack[-11]); Obj=2 // @poff=1040
0x499: Pop(0)
0x49a: Pop(0); PushNull((bool) Stack[-11] == 0)
0x49b: IF (Stack[-1] == 0) GOTO 0x4a0; Pop(1)

0x49c: Push("Can't find map") // @poff=1150
0x49d: @ Trace(Stack[-1])
0x49e: Pop(1)
0x49f: Return(); Pop(8)
...
0x4a2: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1180
0x4a3: Pop(2)
0x4a4: Return(); Pop(8)

0x4a5: Stack[-2] = 0
0x4a6: PushEmpty(int, int)
0x4a7: Push("branch") // @poff=1193
