...
Strings:
	...
	W:oob10Officer1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x18a: Push("player") // @poff=172
0x18b: @ FindActor(Stack[-4]T, Stack[-1])
0x18c: Pop(1)
...
0x19f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x22a: Pop(0)
0x22b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x22c: Pop(0)
...
0x236: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x237: Pop(0)
0x238: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x239: Pop(0)
...
0x297: Push("Can't find lsh animation : ") // @poff=222
...
0x2a6: Push("Can't find lsh animation : ") // @poff=222
...
0x2ee: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=278
0x2ef: Return(); Pop(0)

0x2f0: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=318
0x2f1: Return(); Pop(0)
...
0x2f4: PushEmpty()
0x2f5: Push("oob10Officer1") // @poff=362
0x2f6: Push((int) 1)
...
0x2fc: Stack[-1] = "oob10Officer1" // @poff=362
0x2fd: Call2 0x2cd
