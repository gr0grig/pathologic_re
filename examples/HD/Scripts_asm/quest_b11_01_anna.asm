...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x6c: Stack[-1] = "Dream" // @poff=89
0x6d: Call2 0xd7

0x6e: Pop(1)
0x6f: Push((int) 522034)
0x70: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x71: Pop(1)
0x72: @@@ ClearReplies(); Obj=0 // @poff=112
0x73: Pop(0)
...
0x81: Stack[-1] = "Neutral" // @poff=134
0x82: Call2 0xd7

0x83: Pop(1)
0x84: Push((int) 522039)
0x85: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x86: Pop(1)
0x87: @@@ ClearReplies(); Obj=0 // @poff=112
0x88: Pop(0)
0x89: Push((int) 522040)
0x8a: Push((int) -1)
0x8b: Push((int) 23210)
0x8c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x8d: Pop(3)
0x8e: Push((int) 522041)
0x8f: Push((int) -1)
0x90: Push((int) 23211)
0x91: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x92: Pop(3)
0x93: GOTO 0xb9

0x94: PushEmpty(string)
0x95: Stack[-1] = "Neutral" // @poff=134
0x96: Call2 0xd7

0x97: Pop(1)
0x98: Push((int) 522042)
0x99: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x9a: Pop(1)
0x9b: @@@ ClearReplies(); Obj=0 // @poff=112
0x9c: Pop(0)
...
0xa8: Push((int) -1)
0xa9: Push((int) 23788)
0xaa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xab: Pop(3)
...
0xb2: Push((int) -1)
0xb3: Push((int) 23789)
0xb4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xb5: Pop(3)
0xb6: GOTO 0xb9
...
0xc8: Push("all") // @poff=150
0xc9: Push("idle") // @poff=158
...
0xd1: Push("all") // @poff=150
0xd2: Push("idle") // @poff=158
...
0x12f: Stack[-1] = "Dream" // @poff=89
0x130: Call2 0xd7

0x131: Pop(1)
0x132: Push((int) 522034)
0x133: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x134: Pop(1)
0x135: @@@ ClearReplies(); Obj=0 // @poff=112
0x136: Pop(0)
0x137: Push((int) 523328)
0x138: Push((int) 24543)
0x139: Push((int) 24542)
0x13a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x13b: Pop(3)
0x13c: Return(); Pop(0)
...
0x144: Stack[-1] = "Neutral" // @poff=134
0x145: Call2 0xd7

0x146: Pop(1)
0x147: Push((int) 522039)
0x148: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x149: Pop(1)
0x14a: @@@ ClearReplies(); Obj=0 // @poff=112
0x14b: Pop(0)
0x14c: Push((int) 522040)
0x14d: Push((int) -1)
0x14e: Push((int) 23210)
0x14f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x150: Pop(3)
0x151: Push((int) 522041)
0x152: Push((int) -1)
0x153: Push((int) 23211)
0x154: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x155: Pop(3)
0x156: Return(); Pop(0)

0x157: PushEmpty(string)
0x158: Stack[-1] = "Neutral" // @poff=134
0x159: Call2 0xd7

0x15a: Pop(1)
0x15b: Push((int) 522042)
0x15c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x15d: Pop(1)
0x15e: @@@ ClearReplies(); Obj=0 // @poff=112
0x15f: Pop(0)
0x160: Push((int) 522043)
0x161: Push((int) -1)
0x162: Push((int) 23213)
0x163: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x164: Pop(3)
...
0x16d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x16e: Pop(3)
...
0x193: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x194: Pop(3)
0x195: Return(); Pop(0)
...
0x19a: Stack[-1] = "Dream" // @poff=89
0x19b: Call2 0xd7

0x19c: Pop(1)
0x19d: Push((int) 523332)
0x19e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x19f: Pop(1)
0x1a0: @@@ ClearReplies(); Obj=0 // @poff=112
0x1a1: Pop(0)
0x1a2: Push((int) 523337)
0x1a3: Push((int) 24555)
0x1a4: Push((int) 24551)
0x1a5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1a6: Pop(3)
0x1a7: Push((int) 541843)
0x1a8: Push((int) 24548)
0x1a9: Push((int) 44061)
0x1aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1ab: Pop(3)
0x1ac: Return(); Pop(0)
...
0x1b1: Stack[-1] = "Dream" // @poff=89
0x1b2: Call2 0xd7

0x1b3: Pop(1)
0x1b4: Push((int) 523334)
0x1b5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1b6: Pop(1)
0x1b7: @@@ ClearReplies(); Obj=0 // @poff=112
0x1b8: Pop(0)
0x1b9: Push((int) 523335)
0x1ba: Push((int) 24550)
0x1bb: Push((int) 24549)
0x1bc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1bd: Pop(3)
0x1be: Return(); Pop(0)
...
0x1c3: Stack[-1] = "Dream" // @poff=89
0x1c4: Call2 0xd7

0x1c5: Pop(1)
0x1c6: Push((int) 523340)
0x1c7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1c8: Pop(1)
0x1c9: @@@ ClearReplies(); Obj=0 // @poff=112
0x1ca: Pop(0)
0x1cb: Push((int) 523341)
0x1cc: Push((int) 24550)
0x1cd: Push((int) 24556)
0x1ce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1cf: Pop(3)
0x1d0: Return(); Pop(0)
...
0x1d5: Stack[-1] = "Dream" // @poff=89
0x1d6: Call2 0xd7

0x1d7: Pop(1)
0x1d8: Push((int) 523324)
0x1d9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1da: Pop(1)
0x1db: @@@ ClearReplies(); Obj=0 // @poff=112
0x1dc: Pop(0)
0x1dd: Push((int) 523325)
0x1de: Push((int) 23214)
0x1df: Push((int) 24539)
0x1e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1e1: Pop(3)
0x1e2: Return(); Pop(0)
...
0x1e7: Stack[-1] = "Dream" // @poff=89
0x1e8: Call2 0xd7

0x1e9: Pop(1)
0x1ea: Push((int) 522044)
0x1eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1ec: Pop(1)
0x1ed: @@@ ClearReplies(); Obj=0 // @poff=112
0x1ee: Pop(0)
0x1ef: Push((int) 522045)
0x1f0: Push((int) -1)
0x1f1: Push((int) 23215)
0x1f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1f3: Pop(3)
0x1f4: Push((int) 523321)
0x1f5: Push((int) 24550)
0x1f6: Push((int) 24535)
0x1f7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1f8: Pop(3)
0x1f9: Return(); Pop(0)
...
0x1fe: Stack[-1] = "Dream" // @poff=89
0x1ff: Call2 0xd7

0x200: Pop(1)
0x201: Push((int) 523336)
0x202: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x203: Pop(1)
0x204: @@@ ClearReplies(); Obj=0 // @poff=112
0x205: Pop(0)
0x206: Push((int) 523338)
0x207: Push((int) -1)
0x208: Push((int) 24553)
0x209: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x20a: Pop(3)
0x20b: Push((int) 523339)
0x20c: Push((int) -1)
0x20d: Push((int) 24554)
0x20e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x20f: Pop(3)
0x210: Return(); Pop(0)
...
0x215: Stack[-1] = "Dream" // @poff=89
0x216: Call2 0xd7

0x217: Pop(1)
0x218: Push((int) 523326)
0x219: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x21a: Pop(1)
0x21b: @@@ ClearReplies(); Obj=0 // @poff=112
0x21c: Pop(0)
0x21d: Push((int) 523327)
0x21e: Push((int) 24544)
0x21f: Push((int) 24541)
0x220: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x221: Pop(3)
0x222: Return(); Pop(0)
...
0x227: Stack[-1] = "Dream" // @poff=89
0x228: Call2 0xd7

0x229: Pop(1)
0x22a: Push((int) 523330)
0x22b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x22c: Pop(1)
0x22d: @@@ ClearReplies(); Obj=0 // @poff=112
0x22e: Pop(0)
0x22f: Push((int) 523331)
0x230: Push((int) 23206)
0x231: Push((int) 24545)
0x232: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x233: Pop(3)
0x234: Return(); Pop(0)
...
0x239: Stack[-1] = "Dream" // @poff=89
0x23a: Call2 0xd7

0x23b: Pop(1)
0x23c: Push((int) 522036)
0x23d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x23e: Pop(1)
0x23f: @@@ ClearReplies(); Obj=0 // @poff=112
0x240: Pop(0)
0x241: Push((int) 522037)
0x242: Push((int) -1)
0x243: Push((int) 23207)
0x244: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x245: Pop(3)
0x246: Push((int) 522038)
0x247: Push((int) -1)
0x248: Push((int) 23208)
0x249: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x24a: Pop(3)
0x24b: Return(); Pop(0)
...
0x269: Stack[-1] = "Neutral" // @poff=134
0x26a: Call2 0x381
...
0x28f: Pop(2)
0x290: Stack[-1] = Stack[-8]
0x291: Return(); Pop(6)

0x292: PushEmpty(cvector, cvector)
0x293: @@ GetPosition(Stack[-1]); Obj=3 // @poff=168
0x294: Pop(0)
0x295: PushEmpty(bool, cvector)
0x296: Stack[-3] = Stack[-1]
0x297: Call2 0x288

0x298: Stack[-2] = Stack[-6]
0x299: Pop(2)
0x29a: Return(); Pop(2)
...
0x2a1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=168
0x2a2: Pop(0)
0x2a3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=180
0x2a4: Pop(0)
...
0x310: Push("voice_common") // @poff=204
0x311: Push((int) 1)
...
0x318: Push("voice_common") // @poff=204
0x319: Push((int) 0)
...
0x32b: Push("voice_common") // @poff=204
0x32c: Push((int) 1)
...
0x339: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=234
0x33a: Pop(1)
...
0x34e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=246
0x34f: Pop(1)
...
0x357: Push("d") // @poff=200
0x358: PushEmpty(int)
0x359: Call2 0x3e3

0x35a: Pop(0)
0x35b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x35c: Push("m") // @poff=97
...
0x364: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=234
0x365: Pop(1)
...
0x379: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=246
0x37a: Pop(1)
...
0x38c: Push("Can't find lsh animation : ") // @poff=258
...
0x39b: Push("Can't find lsh animation : ") // @poff=258
...
0x3bf: Push((float)9.999999974752427e-07)
...
0x3d9: Pop(0)
0x3da: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3f0: Stack[-1] = "ui/NPC_Anna.png" // @poff=314
0x3f1: Return(); Pop(0)

0x3f2: Stack[-1] = "ui/NPC_Anna_b.png" // @poff=346
0x3f3: Return(); Pop(0)
...
0x3f6: PushEmpty()
0x3f7: Push("b11q01KnowWhoKilled") // @poff=382
0x3f8: Push((int) 1)
...
0x3ff: PushEmpty()
0x400: Push("b11q01VictimChoosed") // @poff=422
0x401: Push((int) 1)
0x402: @ SetVariable(Stack[-2], Stack[-1])
0x403: Pop(2)
0x404: Push("b11q01KillAnna") // @poff=462
0x405: Push((int) 1)
0x406: @ SetVariable(Stack[-2], Stack[-1])
0x407: Pop(2)
0x408: PushEmpty(bool, string, string, string)
0x409: Stack[-3] = "volonteers_burah" // @poff=492
0x40a: Stack[-2] = "disease" // @poff=526
0x40b: Stack[-1] = "anna" // @poff=542
0x40c: Call2 0x3d7

0x40d: Pop(4)
0x40e: Push("Anna is diseased") // @poff=552
0x40f: @ Trace(Stack[-1])
0x410: Pop(1)
0x411: Return(); Pop(0)

0x412: PushEmpty()
0x413: Push("oob11Anna1") // @poff=586
0x414: Push((int) 1)
...
0x418: PushEmpty()
0x419: Push("b11q01") // @poff=608
0x41a: Push((int) 2)
0x41b: @ SetVariable(Stack[-2], Stack[-1])
0x41c: Pop(2)
0x41d: PushEmpty(bool, string, string)
0x41e: Stack[-2] = "quest_b11_01" // @poff=622
0x41f: Stack[-1] = "open_well_exit" // @poff=648
0x420: Call2 0x3cb
...
0x425: Stack[-1] = "b11q01VictimChoosed" // @poff=422
0x426: Call2 0x3c6
...
0x431: Stack[-1] = "oob11Anna1" // @poff=586
0x432: Call2 0x3c6
...
0x43d: Stack[-1] = "b11q01KillAnna" // @poff=462
0x43e: Call2 0x3c6
...
0x459: Push("Can't retrieve diary root") // @poff=678
0x45a: @ Trace(Stack[-1])
0x45b: Pop(1)
...
0x465: Pop(1)
0x466: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=730
0x467: Pop(0)
0x468: Pop(0); Push((bool) Stack[-2] == 0)
0x469: IF (Stack[-1] == 0) GOTO 0x470; Pop(1)

0x46a: Push("Can't find diary parent with id: ") // @poff=735
...
0x470: @@ AddChild(Stack[-8]); Obj=2 // @poff=803
0x471: Pop(0)
0x472: Push((int) 7)
0x473: @ SendWorldWndMessage(Stack[-1])
0x474: Pop(1)
0x475: @@ GetCategory(Stack[-1]); Obj=8 // @poff=812
0x476: Pop(0)
