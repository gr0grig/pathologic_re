...
Strings:
	...
	W:oob11Birdmask1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1b3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x1b4: Pop(0)
0x1b5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x1b6: Pop(0)
...
0x200: Push("head") // @poff=198
0x201: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x202: Pop(1)
0x203: Push(Stack[-1])
0x204: IF (Stack[-1] == 0) GOTO 0x208; Pop(1)

0x205: Push("head") // @poff=198
0x206: @ UnlookAsync(Stack[-1])
0x207: Pop(1)
0x208: Return(); Pop(2)

0x209: PushEmpty(bool, float, float, bool, float, float)
0x20a: @ lshHasAnimation(Stack[-3], Stack[-7])
0x20b: Pop(0)
0x20c: Push(Stack[-3])
0x20d: IF (Stack[-1] == 0) GOTO 0x214; Pop(1)

0x20e: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x20f: Pop(0)
0x210: Push((bool) 0)
0x211: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x212: Pop(1)
0x213: GOTO 0x218

0x214: Push("Can't find lsh animation : ") // @poff=208
0x215: Pop(1); Push(Stack[-1] + Stack[-8]);
0x216: @ Trace(Stack[-1])
0x217: Pop(1)
0x218: Return(); Pop(6)

0x219: PushEmpty(bool, float, float, bool, float, float)
0x21a: @ lshHasAnimation(Stack[-3], Stack[-8])
0x21b: Pop(0)
0x21c: Push(Stack[-3])
0x21d: IF (Stack[-1] == 0) GOTO 0x223; Pop(1)

0x21e: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x21f: Pop(0)
0x220: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x221: Pop(0)
0x222: GOTO 0x227

0x223: Push("Can't find lsh animation : ") // @poff=208
0x224: Pop(1); Push(Stack[-1] + Stack[-9]);
0x225: @ Trace(Stack[-1])
0x226: Pop(1)
0x227: Return(); Pop(6)
...
0x234: Stack[-1] = 0
0x235: PushEmpty(float, float)
0x236: Pop(0); Push(Stack[-3] | Stack[-3]);
0x237: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x238: Push((float)9.999999974752427e-07)
0x239: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x23a: IF (Stack[-1] == 0) GOTO 0x23d; Pop(1)

0x23b: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x23c: Return(); Pop(2)

0x23d: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x23e: Return(); Pop(2)

0x23f: PushEmpty(int, int)
0x240: @ GetVariable(Stack[-3], Stack[-1])
0x241: Pop(0)
0x242: Stack[-1] = Stack[-4]
0x243: Return(); Pop(2)

0x244: PushEmpty(string, string)
0x245: Stack[-1] = "idle" // @poff=146
0x246: Push(Stack[-3])
0x247: IF (Stack[-1] == 0) GOTO 0x249; Pop(1)

0x248: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x249: Stack[-1] = Stack[-4]
0x24a: Return(); Pop(2)

0x24b: PushEmpty(int, bool, int, bool)
0x24c: Stack[-2] = (int) 0
0x24d: Push("all") // @poff=138
0x24e: PushEmpty(string, int)
0x24f: Stack[-5] = Stack[-1]
0x250: Call2 0x244

0x251: Pop(1)
0x252: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x253: Pop(2)
...
0x257: Push((int) 1)
0x258: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x259: GOTO 0x24d

0x25a: Stack[-2] = Stack[-5]
0x25b: Return(); Pop(4)

0x25c: Stack[-1] = (int) 515571
0x25d: Return(); Pop(0)

0x25e: Stack[-1] = (int) 504029
0x25f: Return(); Pop(0)

0x260: Stack[-1] = "ui/NPC_bmask.png" // @poff=264
0x261: Return(); Pop(0)

0x262: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=298
0x263: Return(); Pop(0)
...
0x266: PushEmpty()
0x267: Push("oob11Birdmask1") // @poff=336
0x268: Push((int) 1)
...
0x26c: PushEmpty()
0x26d: PushEmpty(int, string)
0x26e: Stack[-1] = "oob11Birdmask1" // @poff=336
0x26f: Call2 0x23f
...
0x274: Stack[-2] = (bool) 1
0x275: Return(); Pop(0)

0x276: Stack[-2] = (bool) 0
0x277: Return(); Pop(0)

0x278: PushEmpty(int, int)
0x279: Push("branch") // @poff=366
