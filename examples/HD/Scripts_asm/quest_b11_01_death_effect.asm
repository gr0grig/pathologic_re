...
0x35: Stack[-3] = Stack[-4]
0x36: Return(); Pop(0)

0x37: PushEmpty(object, object)
0x38: @ CreateFloatVector(Stack[-1])
0x39: Pop(0)
0x3a: @@ add(Stack[-3]); Obj=1 // @poff=14
0x3b: Pop(0)
0x3c: Push((int) 0)
0x3d: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x3e: IF (Stack[-1] == 0) GOTO 0x43; Pop(1)

0x3f: Push((float)0.699999988079071)
0x40: Push((int) 500)
0x41: @ RumblePlay(Stack[-2], Stack[-1])
0x42: Pop(2)
0x43: Push((int) 15)
0x44: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x45: Pop(1)
0x46: Return(); Pop(2)
