...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x81: Stack[-1] = "Neutral" // @poff=138
0x82: Call2 0xcd

0x83: Pop(1)
0x84: Push((int) 522028)
0x85: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x86: Pop(1)
0x87: @@@ ClearReplies(); Obj=0 // @poff=116
0x88: Pop(0)
...
0xbe: Push("all") // @poff=154
0xbf: Push("idle") // @poff=162
...
0xc7: Push("all") // @poff=154
0xc8: Push("idle") // @poff=162
...
0x13a: Stack[-1] = "Neutral" // @poff=138
0x13b: Call2 0xcd
...
0x14e: Stack[-1] = "Neutral" // @poff=138
0x14f: Call2 0xcd
...
0x255: Stack[-1] = "Neutral" // @poff=138
0x256: Call2 0x36d
...
0x27b: Pop(2)
0x27c: Stack[-1] = Stack[-8]
0x27d: Return(); Pop(6)

0x27e: PushEmpty(cvector, cvector)
0x27f: @@ GetPosition(Stack[-1]); Obj=3 // @poff=182
0x280: Pop(0)
...
0x28d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=182
0x28e: Pop(0)
0x28f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=194
0x290: Pop(0)
...
0x2fc: Push("voice_common") // @poff=218
0x2fd: Push((int) 1)
...
0x304: Push("voice_common") // @poff=218
0x305: Push((int) 0)
...
0x317: Push("voice_common") // @poff=218
0x318: Push((int) 1)
...
0x325: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=248
0x326: Pop(1)
...
0x33a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=260
0x33b: Pop(1)
0x33c: PushEmpty(bool, string)
0x33d: Stack[-3] = Stack[-1]
0x33e: Call2 0x38c

0x33f: Stack[-2] = Stack[-14]
0x340: Pop(2)
0x341: Return(); Pop(10)

0x342: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x343: Push("d") // @poff=214
0x344: PushEmpty(int)
0x345: Call2 0x3cf

0x346: Pop(0)
0x347: Pop(2); Push(Stack[-2] + Stack[-1]);
0x348: Push("m") // @poff=272
...
0x350: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=248
0x351: Pop(1)
...
0x365: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=260
0x366: Pop(1)
0x367: PushEmpty(bool, string)
0x368: Stack[-3] = Stack[-1]
0x369: Call2 0x38c

0x36a: Stack[-2] = Stack[-14]
0x36b: Pop(2)
0x36c: Return(); Pop(10)
...
0x378: Push("Can't find lsh animation : ") // @poff=276
...
0x387: Push("Can't find lsh animation : ") // @poff=276
...
0x3ab: Push((float)9.999999974752427e-07)
...
0x3dc: Stack[-1] = "ui/NPC_Julia.png" // @poff=332
0x3dd: Return(); Pop(0)

0x3de: Stack[-1] = "ui/NPC_Julia_b.png" // @poff=366
0x3df: Return(); Pop(0)
...
0x3e2: PushEmpty()
0x3e3: Push("b11q01KnowWhoKilled") // @poff=404
0x3e4: Push((int) 1)
...
0x3eb: PushEmpty()
0x3ec: Push("b11q01VictimChoosed") // @poff=444
0x3ed: Push((int) 1)
0x3ee: @ SetVariable(Stack[-2], Stack[-1])
0x3ef: Pop(2)
0x3f0: Push("b11q01KillJulia") // @poff=484
0x3f1: Push((int) 1)
0x3f2: @ SetVariable(Stack[-2], Stack[-1])
0x3f3: Pop(2)
0x3f4: PushEmpty(bool, string, string, string)
0x3f5: Stack[-3] = "volonteers_burah" // @poff=516
0x3f6: Stack[-2] = "disease" // @poff=550
0x3f7: Stack[-1] = "julia" // @poff=566
0x3f8: Call2 0x3c3

0x3f9: Pop(4)
0x3fa: Push("Julia is diseased") // @poff=578
0x3fb: @ Trace(Stack[-1])
0x3fc: Pop(1)
0x3fd: Return(); Pop(0)

0x3fe: PushEmpty()
0x3ff: Push("oob11Julia1") // @poff=614
0x400: Push((int) 1)
...
0x404: PushEmpty()
0x405: Push("b11q01") // @poff=638
0x406: Push((int) 2)
0x407: @ SetVariable(Stack[-2], Stack[-1])
0x408: Pop(2)
0x409: PushEmpty(bool, string, string)
0x40a: Stack[-2] = "quest_b11_01" // @poff=652
0x40b: Stack[-1] = "open_well_exit" // @poff=678
0x40c: Call2 0x3b7
...
0x411: Stack[-1] = "b11q01VictimChoosed" // @poff=444
0x412: Call2 0x3b2
...
0x41d: Stack[-1] = "oob11Julia1" // @poff=614
0x41e: Call2 0x3b2
...
0x429: Stack[-1] = "b11q01KillJulia" // @poff=484
0x42a: Call2 0x3b2
...
0x445: Push("Can't retrieve diary root") // @poff=708
0x446: @ Trace(Stack[-1])
0x447: Pop(1)
...
0x450: Stack[-1] = Stack[-4]
0x451: Pop(1)
0x452: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=760
0x453: Pop(0)
0x454: Pop(0); Push((bool) Stack[-2] == 0)
0x455: IF (Stack[-1] == 0) GOTO 0x45c; Pop(1)

0x456: Push("Can't find diary parent with id: ") // @poff=765
...
0x45c: @@ AddChild(Stack[-8]); Obj=2 // @poff=833
0x45d: Pop(0)
0x45e: Push((int) 7)
0x45f: @ SendWorldWndMessage(Stack[-1])
0x460: Pop(1)
0x461: @@ GetCategory(Stack[-1]); Obj=8 // @poff=842
0x462: Pop(0)
