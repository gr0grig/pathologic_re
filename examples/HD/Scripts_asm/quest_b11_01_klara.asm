...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xbd: Push("all") // @poff=148
0xbe: Push("idle") // @poff=156
...
0xc6: Push("all") // @poff=148
0xc7: Push("idle") // @poff=156
...
0x2ae: Stack[-2] = Stack[-5]
0x2af: Pop(2)
0x2b0: Return(); Pop(2)

0x2b1: Stack[-1] = 0
0x2b2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2b3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2b4: @ RotateAsync(Stack[-2], Stack[-1])
0x2b5: Pop(2)
0x2b6: Return(); Pop(0)

0x2b7: PushEmpty(object, bool, object, bool)
0x2b8: Push("player") // @poff=198
...
0x393: Pop(0)
0x394: @@ GetPosition(Stack[-2]); Obj=7 // @poff=212
0x395: Pop(0)
...
0x3a4: @@ GetPosition(Stack[-1]); Obj=3 // @poff=212
0x3a5: Pop(0)
0x3a6: PushEmpty(bool, cvector)
0x3a7: Stack[-3] = Stack[-1]
0x3a8: Call2 0x399

0x3a9: Stack[-2] = Stack[-6]
0x3aa: Pop(2)
0x3ab: Return(); Pop(2)
...
0x3b2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=212
0x3b3: Pop(0)
0x3b4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=224
0x3b5: Pop(0)
...
0x421: Push("voice_common") // @poff=248
0x422: Push((int) 1)
...
0x429: Push("voice_common") // @poff=248
0x42a: Push((int) 0)
...
0x43c: Push("voice_common") // @poff=248
0x43d: Push((int) 1)
...
0x44a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x44b: Pop(1)
...
0x475: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x476: Pop(1)
...
0x48a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=290
0x48b: Pop(1)
0x48c: PushEmpty(bool, string)
0x48d: Stack[-3] = Stack[-1]
0x48e: Call2 0x4b1

0x48f: Stack[-2] = Stack[-14]
0x490: Pop(2)
0x491: Return(); Pop(10)
...
0x49d: Push("Can't find lsh animation : ") // @poff=306
...
0x4ac: Push("Can't find lsh animation : ") // @poff=306
...
0x4d0: Push((float)9.999999974752427e-07)
...
0x501: Stack[-1] = "ui/NPC_Klara.png" // @poff=362
0x502: Return(); Pop(0)

0x503: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=396
0x504: Return(); Pop(0)
...
0x507: PushEmpty()
0x508: Push("oob11KlaraD1") // @poff=434
0x509: Push((int) 1)
...
0x50f: Stack[-1] = "b11q01VictimChoosed" // @poff=460
0x510: Call2 0x4d7
...
0x51b: Stack[-1] = "oob11KlaraD1" // @poff=434
0x51c: Call2 0x4d7
