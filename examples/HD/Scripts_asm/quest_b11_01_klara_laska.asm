...
Strings:
	...
	W:b9KlaraLetter
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x65: Stack[-1] = (bool) 1
0x66: IF (Stack[-1] == 1) GOTO 0x76; Pop(1)
...
0x7d: Stack[-1] = "Saveyouall" // @poff=89
0x7e: Call2 0x102

0x7f: Pop(1)
0x80: Push((int) 522101)
0x81: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x82: Pop(1)
0x83: @@@ ClearReplies(); Obj=0 // @poff=122
0x84: Pop(0)
0x85: Push((int) 522102)
0x86: Push((int) 24452)
0x87: Push((int) 23269)
0x88: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x89: Pop(3)
0x8a: Push((int) 522103)
0x8b: Push((int) 24448)
0x8c: Push((int) 23270)
0x8d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x8e: Pop(3)
0x8f: GOTO 0xe4

0x90: PushEmpty(string)
0x91: Stack[-1] = "Smile" // @poff=144
0x92: Call2 0x102

0x93: Pop(1)
0x94: Push((int) 522104)
0x95: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x96: Pop(1)
0x97: @@@ ClearReplies(); Obj=0 // @poff=122
0x98: Pop(0)
0x99: PushEmpty(bool)
0x9a: Stack[-1] = (bool) 0
0x9b: PushEmpty(bool)
...
0xb2: Push((int) 24464)
0xb3: Push((int) 24463)
0xb4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xb5: Pop(3)
0xb6: PushEmpty(bool)
0xb7: Stack[-1] = (bool) 0
...
0xc5: Push((int) 24443)
0xc6: Push((int) 23272)
0xc7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xc8: Pop(3)
0xc9: PushEmpty(bool)
0xca: Stack[-1] = (bool) 0
...
0xd8: Push((int) 36216)
0xd9: Push((int) 36215)
0xda: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xdb: Pop(3)
0xdc: Push((int) 523242)
0xdd: Push((int) -1)
0xde: Push((int) 24442)
0xdf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xe0: Pop(3)
0xe1: GOTO 0xe4
...
0xf3: Push("all") // @poff=103
0xf4: Push("idle") // @poff=156
...
0xfc: Push("all") // @poff=103
0xfd: Push("idle") // @poff=156
...
0x160: IF (Stack[-1] == 1) GOTO 0x170; Pop(1)
...
0x16e: IF (Stack[-1] == 1) GOTO 0x170; Pop(1)
...
0x177: Stack[-1] = "Saveyouall" // @poff=89
0x178: Call2 0x102

0x179: Pop(1)
0x17a: Push((int) 522101)
0x17b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x17c: Pop(1)
0x17d: @@@ ClearReplies(); Obj=0 // @poff=122
0x17e: Pop(0)
0x17f: Push((int) 522102)
0x180: Push((int) 24452)
0x181: Push((int) 23269)
0x182: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x183: Pop(3)
0x184: Push((int) 522103)
0x185: Push((int) 24448)
0x186: Push((int) 23270)
0x187: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x188: Pop(3)
0x189: Return(); Pop(0)

0x18a: PushEmpty(string)
0x18b: Stack[-1] = "Smile" // @poff=144
0x18c: Call2 0x102

0x18d: Pop(1)
0x18e: Push((int) 522104)
0x18f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x190: Pop(1)
0x191: @@@ ClearReplies(); Obj=0 // @poff=122
0x192: Pop(0)
...
0x1ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1af: Pop(3)
...
0x1c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1c2: Pop(3)
...
0x1d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1d5: Pop(3)
0x1d6: Push((int) 523242)
0x1d7: Push((int) -1)
0x1d8: Push((int) 24442)
0x1d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1da: Pop(3)
0x1db: Return(); Pop(0)
...
0x1e0: Stack[-1] = "Neutral" // @poff=166
0x1e1: Call2 0x102

0x1e2: Pop(1)
0x1e3: Push((int) 534578)
0x1e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1e5: Pop(1)
0x1e6: @@@ ClearReplies(); Obj=0 // @poff=122
0x1e7: Pop(0)
0x1e8: Push((int) 534579)
0x1e9: Push((int) 36219)
0x1ea: Push((int) 36217)
0x1eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1ec: Pop(3)
0x1ed: Push((int) 534580)
0x1ee: Push((int) -1)
0x1ef: Push((int) 36218)
0x1f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1f1: Pop(3)
0x1f2: Return(); Pop(0)
...
0x1f7: Stack[-1] = "Saveyouall" // @poff=89
0x1f8: Call2 0x102

0x1f9: Pop(1)
0x1fa: Push((int) 534581)
0x1fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1fc: Pop(1)
0x1fd: @@@ ClearReplies(); Obj=0 // @poff=122
0x1fe: Pop(0)
0x1ff: Push((int) 534582)
0x200: Push((int) -1)
0x201: Push((int) 36220)
0x202: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x203: Pop(3)
0x204: Push((int) 534583)
0x205: Push((int) -1)
0x206: Push((int) 36221)
0x207: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x208: Pop(3)
0x209: Return(); Pop(0)
...
0x20e: Stack[-1] = "Sly" // @poff=182
0x20f: Call2 0x102

0x210: Pop(1)
0x211: Push((int) 523243)
0x212: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x213: Pop(1)
0x214: @@@ ClearReplies(); Obj=0 // @poff=122
0x215: Pop(0)
0x216: Push((int) 523244)
0x217: Push((int) -1)
0x218: Push((int) 24444)
0x219: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x21a: Pop(3)
0x21b: Push((int) 523245)
0x21c: Push((int) 24446)
0x21d: Push((int) 24445)
0x21e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x21f: Pop(3)
0x220: Return(); Pop(0)
...
0x225: Stack[-1] = "Sly" // @poff=182
0x226: Call2 0x102

0x227: Pop(1)
0x228: Push((int) 523246)
0x229: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x22a: Pop(1)
0x22b: @@@ ClearReplies(); Obj=0 // @poff=122
0x22c: Pop(0)
0x22d: Push((int) 523247)
0x22e: Push((int) -1)
0x22f: Push((int) 24447)
0x230: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x231: Pop(3)
0x232: Return(); Pop(0)
...
0x237: Stack[-1] = "Neutral" // @poff=166
0x238: Call2 0x102

0x239: Pop(1)
0x23a: Push((int) 523264)
0x23b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x23c: Pop(1)
0x23d: @@@ ClearReplies(); Obj=0 // @poff=122
0x23e: Pop(0)
0x23f: Push((int) 523265)
0x240: Push((int) 24466)
0x241: Push((int) 24465)
0x242: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x243: Pop(3)
0x244: Return(); Pop(0)
...
0x249: Stack[-1] = "Saveyouall" // @poff=89
0x24a: Call2 0x102

0x24b: Pop(1)
0x24c: Push((int) 523266)
0x24d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x24e: Pop(1)
0x24f: @@@ ClearReplies(); Obj=0 // @poff=122
0x250: Pop(0)
0x251: Push((int) 523267)
0x252: Push((int) -1)
0x253: Push((int) 24467)
0x254: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x255: Pop(3)
0x256: Push((int) 523268)
0x257: Push((int) -1)
0x258: Push((int) 24468)
0x259: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x25a: Pop(3)
0x25b: Return(); Pop(0)
...
0x260: Stack[-1] = "Smile" // @poff=144
0x261: Call2 0x102

0x262: Pop(1)
0x263: Push((int) 523248)
0x264: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x265: Pop(1)
0x266: @@@ ClearReplies(); Obj=0 // @poff=122
0x267: Pop(0)
0x268: Push((int) 523250)
0x269: Push((int) 24452)
0x26a: Push((int) 24450)
0x26b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x26c: Pop(3)
0x26d: Push((int) 523249)
0x26e: Push((int) 24452)
0x26f: Push((int) 24449)
0x270: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x271: Pop(3)
0x272: Return(); Pop(0)
...
0x277: Stack[-1] = "Saveyouall" // @poff=89
0x278: Call2 0x102

0x279: Pop(1)
0x27a: Push((int) 523252)
0x27b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x27c: Pop(1)
0x27d: @@@ ClearReplies(); Obj=0 // @poff=122
0x27e: Pop(0)
0x27f: Push((int) 523253)
0x280: Push((int) 24451)
0x281: Push((int) 24453)
0x282: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x283: Pop(3)
0x284: Return(); Pop(0)
...
0x289: Stack[-1] = "Neutral" // @poff=166
0x28a: Call2 0x102

0x28b: Pop(1)
0x28c: Push((int) 523251)
0x28d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x28e: Pop(1)
0x28f: @@@ ClearReplies(); Obj=0 // @poff=122
0x290: Pop(0)
0x291: Push((int) 523254)
0x292: Push((int) 24456)
0x293: Push((int) 24454)
0x294: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x295: Pop(3)
0x296: Push((int) 523255)
0x297: Push((int) 24469)
0x298: Push((int) 24455)
0x299: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x29a: Pop(3)
0x29b: Return(); Pop(0)
...
0x2a0: Stack[-1] = "Sly" // @poff=182
0x2a1: Call2 0x102

0x2a2: Pop(1)
0x2a3: Push((int) 523269)
0x2a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x2a5: Pop(1)
0x2a6: @@@ ClearReplies(); Obj=0 // @poff=122
0x2a7: Pop(0)
0x2a8: Push((int) 523270)
0x2a9: Push((int) 24456)
0x2aa: Push((int) 24470)
0x2ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2ac: Pop(3)
0x2ad: Return(); Pop(0)
...
0x2b2: Stack[-1] = "Neutral" // @poff=166
0x2b3: Call2 0x102

0x2b4: Pop(1)
0x2b5: Push((int) 523256)
0x2b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x2b7: Pop(1)
0x2b8: @@@ ClearReplies(); Obj=0 // @poff=122
0x2b9: Pop(0)
0x2ba: Push((int) 523257)
0x2bb: Push((int) 24458)
0x2bc: Push((int) 24457)
0x2bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2be: Pop(3)
0x2bf: Push((int) 523271)
0x2c0: Push((int) 24473)
0x2c1: Push((int) 24472)
0x2c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2c3: Pop(3)
0x2c4: Return(); Pop(0)
...
0x2c9: Stack[-1] = "Sly" // @poff=182
0x2ca: Call2 0x102

0x2cb: Pop(1)
0x2cc: Push((int) 523272)
0x2cd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x2ce: Pop(1)
0x2cf: @@@ ClearReplies(); Obj=0 // @poff=122
0x2d0: Pop(0)
0x2d1: Push((int) 523273)
0x2d2: Push((int) 24475)
0x2d3: Push((int) 24474)
0x2d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2d5: Pop(3)
0x2d6: Push((int) 523275)
0x2d7: Push((int) 24475)
0x2d8: Push((int) 24476)
0x2d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2da: Pop(3)
0x2db: Return(); Pop(0)
...
0x2e0: Stack[-1] = "Sly" // @poff=182
0x2e1: Call2 0x102

0x2e2: Pop(1)
0x2e3: Push((int) 523274)
0x2e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x2e5: Pop(1)
0x2e6: @@@ ClearReplies(); Obj=0 // @poff=122
0x2e7: Pop(0)
0x2e8: Push((int) 523276)
0x2e9: Push((int) -1)
0x2ea: Push((int) 24478)
0x2eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2ec: Pop(3)
0x2ed: Push((int) 523277)
0x2ee: Push((int) -1)
0x2ef: Push((int) 24479)
0x2f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x2f1: Pop(3)
0x2f2: Return(); Pop(0)
...
0x2f7: Stack[-1] = "Neutral" // @poff=166
0x2f8: Call2 0x102

0x2f9: Pop(1)
0x2fa: Push((int) 523258)
0x2fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x2fc: Pop(1)
0x2fd: @@@ ClearReplies(); Obj=0 // @poff=122
0x2fe: Pop(0)
0x2ff: Push((int) 523259)
0x300: Push((int) 24460)
0x301: Push((int) 24459)
0x302: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x303: Pop(3)
0x304: Return(); Pop(0)
...
0x309: Stack[-1] = "Sly" // @poff=182
0x30a: Call2 0x102

0x30b: Pop(1)
0x30c: Push((int) 523260)
0x30d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x30e: Pop(1)
0x30f: @@@ ClearReplies(); Obj=0 // @poff=122
0x310: Pop(0)
0x311: Push((int) 523261)
0x312: Push((int) -1)
0x313: Push((int) 24461)
0x314: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x315: Pop(3)
0x316: Push((int) 523262)
0x317: Push((int) -1)
0x318: Push((int) 24462)
0x319: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x31a: Pop(3)
0x31b: Return(); Pop(0)
...
0x373: Stack[-2] = Stack[-5]
0x374: Pop(2)
0x375: Return(); Pop(2)

0x376: Stack[-1] = 0
0x377: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x378: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x379: @ RotateAsync(Stack[-2], Stack[-1])
0x37a: Pop(2)
0x37b: Return(); Pop(0)

0x37c: PushEmpty(object, bool, object, bool)
0x37d: Push("player") // @poff=222
...
0x3da: Stack[-1] = "Neutral" // @poff=166
0x3db: Call2 0x557
...
0x3e9: Stack[-1] = "Neutral" // @poff=166
0x3ea: Call2 0x557
...
0x3fc: Stack[-4] = Stack[-1]
0x3fd: Call2 0x329

0x3fe: Pop(1)
0x3ff: PushEmpty(string)
0x400: Stack[-1] = "Neutral" // @poff=166
0x401: Call2 0x557
...
0x434: Stack[-3] = (int) 0
0x435: Push("all") // @poff=103
0x436: PushEmpty(string, int)
0x437: Stack[-6] = Stack[-1]
0x438: Call2 0x5aa
...
0x458: Pop(0)
0x459: @@ GetPosition(Stack[-2]); Obj=7 // @poff=236
0x45a: Pop(0)
...
0x465: Pop(2)
0x466: Stack[-1] = Stack[-8]
0x467: Return(); Pop(6)

0x468: PushEmpty(cvector, cvector)
0x469: @@ GetPosition(Stack[-1]); Obj=3 // @poff=236
0x46a: Pop(0)
0x46b: PushEmpty(bool, cvector)
0x46c: Stack[-3] = Stack[-1]
0x46d: Call2 0x45e

0x46e: Stack[-2] = Stack[-6]
0x46f: Pop(2)
0x470: Return(); Pop(2)
...
0x477: @@ GetPosition(Stack[-8]); Obj=20 // @poff=236
0x478: Pop(0)
0x479: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=248
0x47a: Pop(0)
...
0x4e6: Push("voice_common") // @poff=272
0x4e7: Push((int) 1)
...
0x4ee: Push("voice_common") // @poff=272
0x4ef: Push((int) 0)
...
0x501: Push("voice_common") // @poff=272
0x502: Push((int) 1)
...
0x50f: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=302
0x510: Pop(1)
...
0x53a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=302
0x53b: Pop(1)
...
0x54f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=314
0x550: Pop(1)
...
0x562: Push("Can't find lsh animation : ") // @poff=330
...
0x571: Push("Can't find lsh animation : ") // @poff=330
...
0x595: Push((float)9.999999974752427e-07)
...
0x5c6: Stack[-1] = "ui/NPC_Klara.png" // @poff=386
0x5c7: Return(); Pop(0)

0x5c8: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=420
0x5c9: Return(); Pop(0)
...
0x5cc: PushEmpty()
0x5cd: Push("oob11Klara1") // @poff=458
0x5ce: Push((int) 1)
...
0x5d2: PushEmpty()
0x5d3: Push("b11q01KlaraWillHelp") // @poff=482
0x5d4: Push((int) 1)
...
0x5d8: PushEmpty()
0x5d9: Push("oob11Klara2") // @poff=522
0x5da: Push((int) 1)
...
0x5de: PushEmpty()
0x5df: Push("oob11Klara3") // @poff=546
0x5e0: Push((int) 1)
...
0x5fe: Stack[-1] = "oob11Klara1" // @poff=458
0x5ff: Call2 0x59c
...
0x60a: Stack[-1] = "b11q01KlaraWillHelp" // @poff=482
0x60b: Call2 0x59c
...
0x616: Stack[-1] = "oob11Klara2" // @poff=522
0x617: Call2 0x59c
...
0x622: Stack[-1] = "b9KlaraLetter" // @poff=584
0x623: Call2 0x59c
...
0x62e: Stack[-1] = "oob11Klara3" // @poff=546
0x62f: Call2 0x59c
