...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x6c: Stack[-1] = "Tiredness" // @poff=89
0x6d: Call2 0xd7

0x6e: Pop(1)
0x6f: Push((int) 522012)
0x70: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x71: Pop(1)
0x72: @@@ ClearReplies(); Obj=0 // @poff=120
0x73: Pop(0)
...
0x81: Stack[-1] = "Neutral" // @poff=142
0x82: Call2 0xd7

0x83: Pop(1)
0x84: Push((int) 522016)
0x85: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x86: Pop(1)
0x87: @@@ ClearReplies(); Obj=0 // @poff=120
0x88: Pop(0)
0x89: Push((int) 522017)
0x8a: Push((int) -1)
0x8b: Push((int) 23187)
0x8c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x8d: Pop(3)
0x8e: Push((int) 522018)
0x8f: Push((int) -1)
0x90: Push((int) 23188)
0x91: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x92: Pop(3)
0x93: GOTO 0xb9

0x94: PushEmpty(string)
0x95: Stack[-1] = "Neutral" // @poff=142
0x96: Call2 0xd7

0x97: Pop(1)
0x98: Push((int) 522014)
0x99: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x9a: Pop(1)
0x9b: @@@ ClearReplies(); Obj=0 // @poff=120
0x9c: Pop(0)
...
0xb2: Push((int) -1)
0xb3: Push((int) 24682)
0xb4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0xb5: Pop(3)
0xb6: GOTO 0xb9
...
0xc8: Push("all") // @poff=158
0xc9: Push("idle") // @poff=166
...
0xd1: Push("all") // @poff=158
0xd2: Push("idle") // @poff=166
...
0x12f: Stack[-1] = "Tiredness" // @poff=89
0x130: Call2 0xd7

0x131: Pop(1)
0x132: Push((int) 522012)
0x133: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x134: Pop(1)
0x135: @@@ ClearReplies(); Obj=0 // @poff=120
0x136: Pop(0)
0x137: Push((int) 523423)
0x138: Push((int) 24645)
0x139: Push((int) 24644)
0x13a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x13b: Pop(3)
0x13c: Return(); Pop(0)
...
0x144: Stack[-1] = "Neutral" // @poff=142
0x145: Call2 0xd7
...
0x154: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x155: Pop(3)
0x156: Return(); Pop(0)

0x157: PushEmpty(string)
0x158: Stack[-1] = "Neutral" // @poff=142
0x159: Call2 0xd7

0x15a: Pop(1)
0x15b: Push((int) 522014)
0x15c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x15d: Pop(1)
0x15e: @@@ ClearReplies(); Obj=0 // @poff=120
0x15f: Pop(0)
0x160: Push((int) 523455)
0x161: Push((int) -1)
0x162: Push((int) 24681)
0x163: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x164: Pop(3)
...
0x16d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x16e: Pop(3)
...
0x17e: Stack[-1] = "Tiredness" // @poff=89
0x17f: Call2 0xd7

0x180: Pop(1)
0x181: Push((int) 523424)
0x182: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x183: Pop(1)
0x184: @@@ ClearReplies(); Obj=0 // @poff=120
0x185: Pop(0)
...
0x18e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x18f: Pop(3)
...
0x19a: Stack[-1] = "Tiredness" // @poff=89
0x19b: Call2 0xd7

0x19c: Pop(1)
0x19d: Push((int) 523445)
0x19e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x19f: Pop(1)
0x1a0: @@@ ClearReplies(); Obj=0 // @poff=120
0x1a1: Pop(0)
0x1a2: Push((int) 523446)
0x1a3: Push((int) 24671)
0x1a4: Push((int) 24670)
0x1a5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1a6: Pop(3)
...
0x1b1: Stack[-1] = "Tiredness" // @poff=89
0x1b2: Call2 0xd7

0x1b3: Pop(1)
0x1b4: Push((int) 523449)
0x1b5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1b6: Pop(1)
0x1b7: @@@ ClearReplies(); Obj=0 // @poff=120
0x1b8: Pop(0)
0x1b9: Push((int) 523459)
0x1ba: Push((int) 24686)
0x1bb: Push((int) 24685)
0x1bc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1bd: Pop(3)
0x1be: Return(); Pop(0)
...
0x1c3: Stack[-1] = "Tiredness" // @poff=89
0x1c4: Call2 0xd7

0x1c5: Pop(1)
0x1c6: Push((int) 523460)
0x1c7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1c8: Pop(1)
0x1c9: @@@ ClearReplies(); Obj=0 // @poff=120
0x1ca: Pop(0)
...
0x1d5: Stack[-1] = "Tiredness" // @poff=89
0x1d6: Call2 0xd7

0x1d7: Pop(1)
0x1d8: Push((int) 523447)
0x1d9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1da: Pop(1)
0x1db: @@@ ClearReplies(); Obj=0 // @poff=120
0x1dc: Pop(0)
0x1dd: Push((int) 523457)
0x1de: Push((int) 24684)
0x1df: Push((int) 24683)
0x1e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1e1: Pop(3)
0x1e2: Return(); Pop(0)
...
0x1e7: Stack[-1] = "Tiredness" // @poff=89
0x1e8: Call2 0xd7

0x1e9: Pop(1)
0x1ea: Push((int) 523458)
0x1eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1ec: Pop(1)
0x1ed: @@@ ClearReplies(); Obj=0 // @poff=120
0x1ee: Pop(0)
0x1ef: Push((int) 523461)
0x1f0: Push((int) 24688)
0x1f1: Push((int) 24687)
0x1f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1f3: Pop(3)
0x1f4: Return(); Pop(0)
...
0x1f9: Stack[-1] = "Tiredness" // @poff=89
0x1fa: Call2 0xd7

0x1fb: Pop(1)
0x1fc: Push((int) 523462)
0x1fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1fe: Pop(1)
0x1ff: @@@ ClearReplies(); Obj=0 // @poff=120
0x200: Pop(0)
0x201: Push((int) 523448)
0x202: Push((int) 24663)
0x203: Push((int) 24672)
0x204: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x205: Pop(3)
0x206: Return(); Pop(0)
...
0x20b: Stack[-1] = "Tiredness" // @poff=89
0x20c: Call2 0xd7

0x20d: Pop(1)
0x20e: Push((int) 523438)
0x20f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x210: Pop(1)
0x211: @@@ ClearReplies(); Obj=0 // @poff=120
0x212: Pop(0)
...
0x222: Stack[-1] = "Tiredness" // @poff=89
0x223: Call2 0xd7
...
0x239: Stack[-1] = "Tiredness" // @poff=89
0x23a: Call2 0xd7
...
0x24b: Stack[-1] = "Tiredness" // @poff=89
0x24c: Call2 0xd7
...
0x25d: Stack[-1] = "Tiredness" // @poff=89
0x25e: Call2 0xd7

0x25f: Pop(1)
0x260: Push((int) 523430)
0x261: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x262: Pop(1)
0x263: @@@ ClearReplies(); Obj=0 // @poff=120
0x264: Pop(0)
0x265: Push((int) 522020)
0x266: Push((int) -1)
0x267: Push((int) 23190)
0x268: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x269: Pop(3)
...
0x28d: Stack[-1] = "Neutral" // @poff=142
0x28e: Call2 0x3a5
...
0x2b7: @@ GetPosition(Stack[-1]); Obj=3 // @poff=176
0x2b8: Pop(0)
0x2b9: PushEmpty(bool, cvector)
0x2ba: Stack[-3] = Stack[-1]
0x2bb: Call2 0x2ac

0x2bc: Stack[-2] = Stack[-6]
0x2bd: Pop(2)
0x2be: Return(); Pop(2)
...
0x2c5: @@ GetPosition(Stack[-8]); Obj=20 // @poff=176
0x2c6: Pop(0)
0x2c7: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=188
0x2c8: Pop(0)
...
0x334: Push("voice_common") // @poff=212
0x335: Push((int) 1)
...
0x33c: Push("voice_common") // @poff=212
0x33d: Push((int) 0)
...
0x34f: Push("voice_common") // @poff=212
0x350: Push((int) 1)
...
0x35d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=242
0x35e: Pop(1)
...
0x372: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=254
0x373: Pop(1)
0x374: PushEmpty(bool, string)
0x375: Stack[-3] = Stack[-1]
0x376: Call2 0x3c4

0x377: Stack[-2] = Stack[-14]
0x378: Pop(2)
0x379: Return(); Pop(10)

0x37a: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x37b: Push("d") // @poff=208
0x37c: PushEmpty(int)
0x37d: Call2 0x407

0x37e: Pop(0)
0x37f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x380: Push("m") // @poff=266
...
0x388: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=242
0x389: Pop(1)
...
0x39d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=254
0x39e: Pop(1)
0x39f: PushEmpty(bool, string)
0x3a0: Stack[-3] = Stack[-1]
0x3a1: Call2 0x3c4

0x3a2: Stack[-2] = Stack[-14]
0x3a3: Pop(2)
0x3a4: Return(); Pop(10)
...
0x3b0: Push("Can't find lsh animation : ") // @poff=270
...
0x3bf: Push("Can't find lsh animation : ") // @poff=270
...
0x3e3: Push((float)9.999999974752427e-07)
...
0x3fd: Pop(0)
0x3fe: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x414: Stack[-1] = "ui/NPC_Lara.png" // @poff=326
0x415: Return(); Pop(0)

0x416: Stack[-1] = "ui/NPC_Lara_b.png" // @poff=358
0x417: Return(); Pop(0)
...
0x41a: PushEmpty()
0x41b: Push("b11q01KnowWhoKilled") // @poff=394
0x41c: Push((int) 1)
...
0x423: PushEmpty()
0x424: Push("b11q01VictimChoosed") // @poff=434
0x425: Push((int) 1)
0x426: @ SetVariable(Stack[-2], Stack[-1])
0x427: Pop(2)
0x428: Push("b11q01KillLara") // @poff=474
0x429: Push((int) 1)
0x42a: @ SetVariable(Stack[-2], Stack[-1])
0x42b: Pop(2)
0x42c: PushEmpty(bool, string, string, string)
0x42d: Stack[-3] = "volonteers_burah" // @poff=504
0x42e: Stack[-2] = "disease" // @poff=538
0x42f: Stack[-1] = "lara" // @poff=554
0x430: Call2 0x3fb

0x431: Pop(4)
0x432: Push("Lara is diseased") // @poff=564
0x433: @ Trace(Stack[-1])
0x434: Pop(1)
0x435: Return(); Pop(0)

0x436: PushEmpty()
0x437: Push("oob11Lara1") // @poff=598
0x438: Push((int) 1)
...
0x43c: PushEmpty()
0x43d: Push("b11q01") // @poff=620
0x43e: Push((int) 2)
0x43f: @ SetVariable(Stack[-2], Stack[-1])
0x440: Pop(2)
0x441: PushEmpty(bool, string, string)
0x442: Stack[-2] = "quest_b11_01" // @poff=634
0x443: Stack[-1] = "open_well_exit" // @poff=660
0x444: Call2 0x3ef
...
0x449: Stack[-1] = "b11q01VictimChoosed" // @poff=434
0x44a: Call2 0x3ea
...
0x455: Stack[-1] = "oob11Lara1" // @poff=598
0x456: Call2 0x3ea
...
0x461: Stack[-1] = "b11q01KillLara" // @poff=474
0x462: Call2 0x3ea
...
0x47d: Push("Can't retrieve diary root") // @poff=690
0x47e: @ Trace(Stack[-1])
0x47f: Pop(1)
...
0x489: Pop(1)
0x48a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=742
0x48b: Pop(0)
0x48c: Pop(0); Push((bool) Stack[-2] == 0)
0x48d: IF (Stack[-1] == 0) GOTO 0x494; Pop(1)

0x48e: Push("Can't find diary parent with id: ") // @poff=747
...
0x494: @@ AddChild(Stack[-8]); Obj=2 // @poff=815
0x495: Pop(0)
0x496: Push((int) 7)
0x497: @ SendWorldWndMessage(Stack[-1])
0x498: Pop(1)
0x499: @@ GetCategory(Stack[-1]); Obj=8 // @poff=824
0x49a: Pop(0)
