...
Strings:
	...
	W:battle
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x76d Vars = (object, int, float, float)
EVENT_43 Op = 0x775 Vars = (object, int, float, float, cvector, cvector)
...
0x7c: Stack[-6] = Stack[-2]
0x7d: Stack[-1] = (int) 4
0x7e: Call2 0x67a

0x7f: Stack[-3] = Stack[-4]
0x80: Pop(3)
...
0x86: @@ RemoveAllItems(Stack[-1]); Obj=2 // @poff=0
0x87: Pop(0)
0x88: Push((int) 1)
0x89: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x8a: GOTO 0x83

0x8b: @@ SelectWeapon(); Obj=2 // @poff=15
0x8c: Pop(0)
0x8d: Push((bool) 1)
...
0xba: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xbb: Pop(0)
0xbc: Push(Stack[-8])
0xbd: IF (Stack[-1] == 0) GOTO 0xc6; Pop(1)

0xbe: Push("attack") // @poff=84
...
0xda: Pop(0)
0xdb: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=98
0xdc: Pop(0)
...
0xf6: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=98
0xf7: Pop(0)
...
0x110: Pop(1)
0x111: Push("all") // @poff=112
0x112: Push("attack_on") // @poff=120
...
0x12a: IF (Stack[-1] == 1) GOTO 0x130; Pop(1)

0x12b: PushEmpty(bool)
0x12c: Call2 0x2fc

0x12d: Pop(0)
0x12e: IF (Stack[-1] == 1) GOTO 0x130; Pop(1)

0x12f: Stack[-1] = (bool) 0
0x130: IF (Stack[-1] == 0) GOTO 0x141; Pop(1)

0x131: @ Face(Stack[-0]T)
0x132: Pop(0)
0x133: PushEmpty()
0x134: Call2 0x32e

0x135: Pop(0)
0x136: Push("all") // @poff=112
0x137: Push("attack_stay") // @poff=140
0x138: @ PlayAnimation(Stack[-2], Stack[-1])
0x139: Pop(2)
0x13a: PushEmpty(bool, float)
0x13b: Stack[-25] = Stack[-1]
0x13c: Call2 0x278
...
0x141: @ Face(Stack[-0]T)
0x142: Pop(0)
0x143: Push("all") // @poff=112
0x144: Push("fjump") // @poff=164
...
0x15f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=98
0x160: Pop(0)
...
0x17e: Push("all") // @poff=112
0x17f: Push("attack_off") // @poff=176
...
0x18c: Push("all") // @poff=112
0x18d: Push("attack_begin") // @poff=198
0x18e: Push((int) 1)
0x18f: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x19a: Push("attack") // @poff=84
0x19b: Push((int) 1)
0x19c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1a6: Push("all") // @poff=112
0x1a7: Push("bjump") // @poff=224
...
0x1ae: Push((float)0.8999999761581421)
0x1af: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1b0: @ GetVictim(Stack[-1], Stack[-4])
0x1b1: Pop(1)
0x1b2: @ ReportAttack(Stack[-0]T)
0x1b3: Pop(0)
...
0x1b8: Stack[-10] = Stack[-1]
0x1b9: Call2 0x9f

0x1ba: Stack[-3] = Stack[-5]
0x1bb: Pop(3)
0x1bc: PushEmpty(float, object, float, int)
0x1bd: Stack[-7] = Stack[-3]
0x1be: Stack[-6] = Stack[-2]
0x1bf: PushEmpty(int, object, int)
0x1c0: Stack[-10] = Stack[-2]
0x1c1: Stack[-14] = Stack[-1]
0x1c2: Call2 0xa2

0x1c3: Stack[-3] = Stack[-4]
0x1c4: Pop(3)
0x1c5: Call2 0x54e

0x1c6: Stack[-4] = Stack[-5]
0x1c7: Pop(4)
0x1c8: PushEmpty(int)
0x1c9: Call2 0x32c

0x1ca: Pop(0)
0x1cb: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1cc: Pop(1)
0x1cd: PushEmpty(object, float)
0x1ce: Stack[-5] = Stack[-2]
...
0x1d7: Pop(0)
0x1d8: @ irand(Stack[-4], Stack[-1]T)
0x1d9: Pop(0)
0x1da: Push((int) 1)
0x1db: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x1dc: @ Face(Stack[-0]T)
0x1dd: Pop(0)
0x1de: Push((bool) 1)
...
0x1e3: Pop(0)
0x1e4: Push("all") // @poff=112
0x1e5: Push("attack_begin") // @poff=198
...
0x1fc: Pop(2)
0x1fd: Push("all") // @poff=112
0x1fe: Push("attack_middle") // @poff=236
...
0x206: Pop(0)
0x207: Push("all") // @poff=112
0x208: Push("attack_middle") // @poff=236
...
0x21c: Stack[-11] = Stack[-2]
0x21d: Stack[-6] = Stack[-1]
0x21e: Call2 0x1ad

0x21f: Pop(2)
0x220: Stack[-2] = (int) 1
0x221: Push("attack_middle") // @poff=236
0x222: Pop(1); Push(Stack[-1] + Stack[-5]);
0x223: Push("_") // @poff=264
0x224: Pop(2); Push(Stack[-2] + Stack[-1]);
0x225: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x226: Push("all") // @poff=112
...
0x24b: Pop(1)
0x24c: Push("all") // @poff=112
0x24d: Push("attack_end") // @poff=268
...
0x28c: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=98
0x28d: Pop(0)
...
0x2d8: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x2d9: Pop(1)
...
0x2de: Pop(0)
0x2df: Push("all") // @poff=112
0x2e0: Push("bjump") // @poff=224
0x2e1: @ PlayAnimation(Stack[-2], Stack[-1])
0x2e2: Pop(2)
0x2e3: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=98
0x2e4: Pop(0)
...
0x31a: @ irand(Stack[-1], Stack[-2]T)
0x31b: Pop(0)
0x31c: Push((int) 1)
0x31d: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x31e: Push("attack") // @poff=84
...
0x32f: Stack[-1] = "attack_stay" // @poff=140
0x330: Call2 0x6b9
...
0x35a: Stack[-15] = Stack[-5]
0x35b: Stack[-14] = Stack[-4]
0x35c: Stack[-13] = Stack[-3]
0x35d: Stack[-12] = Stack[-2]
0x35e: Stack[-11] = Stack[-1]
0x35f: Call2 0x3a4

0x360: Stack[-6] = Stack[-7]
0x361: Pop(6)
0x362: Push( Stack[2 + Tasks[-1].StackPointer] )
0x363: IF (Stack[-1] == 0) GOTO 0x367; Pop(1)

0x364: Push("head") // @poff=326
0x365: @ UnlookAsync(Stack[-1])
0x366: Pop(1)
0x367: Push((int) 1)
0x368: @ KillTimer(Stack[-1])
0x369: Pop(1)
0x36a: Stack[-1] = Stack[-10]
0x36b: Return(); Pop(4)
...
0x3a7: Stack[-17] = Stack[-7]
0x3a8: PushEmpty(bool, object)
0x3a9: Stack[-23] = Stack[-1]
0x3aa: Call2 0x430
...
0x3b0: @@ GetPosition(Stack[-5]); Obj=21 // @poff=336
0x3b1: Pop(0)
...
0x3c7: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=98
0x3c8: Pop(0)
...
0x3d9: Push((int) 0)
0x3da: Push((float)0.30000001192092896)
...
0x3fc: Push((int) 0)
0x3fd: Push((float)0.30000001192092896)
...
0x437: Stack[-1] = "walk" // @poff=348
0x438: Return(); Pop(0)

0x439: Stack[-1] = "run" // @poff=358
0x43a: Return(); Pop(0)
...
0x478: Stack[-6] = Stack[-5]
0x479: Stack[-4] = (int) 3
0x47a: Push(GlobalVars[6])
0x47b: Stack[-1] = Stack[-4]
0x47c: Pop(1)
...
0x486: Stack[-6] = Stack[-5]
0x487: Stack[-4] = (int) 4
0x488: Push(GlobalVars[8])
0x489: Stack[-1] = Stack[-4]
0x48a: Pop(1)
0x48b: Push(GlobalVars[9])
0x48c: Stack[-1] = Stack[-3]
0x48d: Pop(1)
0x48e: Push(GlobalVars[14])
0x48f: Stack[-1] = Stack[-2]
0x490: Pop(1)
0x491: Call2 0x68e

0x492: Pop(5)
0x493: @@ SelectWeapon(); Obj=1 // @poff=15
0x494: Pop(0)
0x495: PushEmpty(object, string, string)
0x496: Stack[-4] = Stack[-3]
0x497: Stack[-2] = "boiny" // @poff=418
0x498: Stack[-1] = "pt_Starshina" // @poff=430
0x499: Call2 0x72d

0x49a: Pop(3)
0x49b: PushEmpty(bool, string, string)
0x49c: Stack[-2] = "quest_b11_01" // @poff=456
0x49d: Stack[-1] = "fight_win" // @poff=482
0x49e: Call2 0x721
...
0x4a7: Pop(0); PushNull((bool) Stack[-21] == 0)
0x4a8: IF (Stack[-1] == 0) GOTO 0x4ae; Pop(1)

0x4a9: PushEmpty(string)
0x4aa: Stack[-1] = "fdie" // @poff=502
0x4ab: Call2 0x501

0x4ac: Pop(1)
0x4ad: GOTO 0x500

0x4ae: @@ GetPosition(Stack[-10]); Obj=21 // @poff=336
0x4af: Pop(0)
...
0x4bf: Stack[-6] = "fdie" // @poff=502
0x4c0: GOTO 0x4c2

0x4c1: Stack[-6] = "bdie" // @poff=512
...
0x4c8: @ StopAsync()
0x4c9: Pop(0)
0x4ca: Stack[-21] = Stack[-5]
0x4cb: Push("GetScriptProperty") // @poff=522
0x4cc: Push((int) 2)
0x4cd: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4ce: IF (Stack[-1] == 0) GOTO 0x4da; Pop(1)

0x4cf: Push("Owner") // @poff=558
0x4d0: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=570
0x4d1: Pop(1)
0x4d2: Push(Stack[-4])
0x4d3: IF (Stack[-1] == 0) GOTO 0x4da; Pop(1)

0x4d4: Push("Owner") // @poff=558
0x4d5: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=588
0x4d6: Pop(1)
0x4d7: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4d8: IF (Stack[-1] == 0) GOTO 0x4da; Pop(1)

0x4d9: Stack[-21] = Stack[-5]
0x4da: Push("@GetEyesHeight") // @poff=606
0x4db: Push((int) 1)
0x4dc: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4dd: IF (Stack[-1] == 0) GOTO 0x4e9; Pop(1)

0x4de: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=636
0x4df: Pop(0)
...
0x4f5: @ StopAsync()
0x4f6: Pop(0)
0x4f7: Push("head") // @poff=326
0x4f8: @ UnlookAsync(Stack[-1])
0x4f9: Pop(1)
0x4fa: Push("all") // @poff=112
...
0x543: Push("HasProperty") // @poff=698
0x544: Push((int) 2)
...
0x54a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=722
0x54b: Pop(0)
...
0x550: Stack[-18] = Stack[-2]
0x551: Stack[-1] = "health" // @poff=734
0x552: Call2 0x542
...
0x559: Stack[-18] = Stack[-2]
0x55a: Stack[-1] = "armor" // @poff=748
0x55b: Call2 0x542
...
0x561: Push("armor") // @poff=748
0x562: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=760
0x563: Pop(1)
0x564: Push("armor_") // @poff=772
0x565: PushEmpty(string, int)
0x566: Stack[-16] = Stack[-1]
0x567: Call2 0x521

0x568: Pop(1)
0x569: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x56a: PushEmpty(bool, object, string)
0x56b: Stack[-18] = Stack[-2]
...
0x573: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=760
0x574: Pop(0)
...
0x57b: Stack[-3] = Stack[-6]
0x57c: Pop(3)
0x57d: Push("health") // @poff=734
0x57e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=760
0x57f: Pop(1)
0x580: Push((int) 1)
0x581: Pop(1); Push(Stack[-1] - Stack[-4]);
0x582: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x583: Push("health") // @poff=734
...
0x589: Pop(3)
0x58a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=786
0x58b: Pop(2)
0x58c: PushEmpty(bool, object)
0x58d: Stack[-17] = Stack[-1]
0x58e: Call2 0x53d
...
0x594: Pop(1)
0x595: Stack[-1] = Stack[-16]
0x596: Return(); Pop(12)

0x597: PushEmpty(bool, bool)
0x598: @@ IsDead(Stack[-1]); Obj=3 // @poff=798
0x599: Pop(0)
0x59a: Stack[-1] = Stack[-4]
0x59b: Return(); Pop(2)

0x59c: PushEmpty(object, object, object, object)
0x59d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5b1: Pop(0)
0x5b2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5b3: IF (Stack[-1] == 0) GOTO 0x5b6; Pop(1)

0x5b4: Stack[-6] = (bool) 0
0x5b5: Return(); Pop(4)

0x5b6: @@ GetScene(Stack[-1]); Obj=5 // @poff=819
0x5b7: Pop(0)
...
0x5ca: Stack[-6] = Stack[-2]
0x5cb: Stack[-1] = "noaccess" // @poff=828
0x5cc: Call2 0x542
...
0x5d2: Push("noaccess") // @poff=828
0x5d3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=760
0x5d4: Pop(1)
0x5d5: Push((int) 0)
...
0x5d9: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x5e7: @@ GetPosition(Stack[-5]); Obj=15 // @poff=336
0x5e8: Pop(0)
...
0x5f8: Stack[-1] = "fhit" // @poff=846
0x5f9: GOTO 0x5fb

0x5fa: Stack[-1] = "bhit" // @poff=856
0x5fb: Push("hit_react") // @poff=866
0x5fc: Push("1") // @poff=478
0x5fd: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5fe: Push("2") // @poff=886
...
0x617: Stack[-25] = Stack[-1]
0x618: Call2 0x52f

0x619: Stack[-2] = Stack[-3]
0x61a: Pop(2)
0x61b: Call2 0x6e8

0x61c: Stack[-2] = Stack[-11]
0x61d: Pop(2)
0x61e: @ CreateVectorVector(Stack[-8])
0x61f: Pop(0)
0x620: Stack[-7] = (int) 1
0x621: Push("hit") // @poff=848
...
0x636: Pop(0)
0x637: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=899
0x638: Pop(0)
0x639: PushEmpty(object, int, float, cvector, cvector)
0x63a: Stack[-26] = Stack[-5]
0x63b: Stack[-25] = Stack[-4]
0x63c: Stack[-24] = Stack[-3]
0x63d: Stack[-6] = Stack[-2]
...
0x657: @@ GetPosition(Stack[-3]); Obj=7 // @poff=336
0x658: Pop(0)
...
0x665: Pop(1)
0x666: @@ GetItemCount(Stack[-4], Stack[-12]); Obj=13 // @poff=949
0x667: Pop(0)
0x668: Stack[-3] = (int) 0
0x669: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x66a: IF (Stack[-1] == 0) GOTO 0x677; Pop(1)

0x66b: @@ GetItem(Stack[-2], Stack[-3], Stack[-12]); Obj=13 // @poff=962
0x66c: Pop(0)
0x66d: @@ add(Stack[-2]); Obj=5 // @poff=890
0x66e: Pop(0)
0x66f: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12]); Obj=13 // @poff=970
0x670: Pop(0)
0x671: @@ add(Stack[-1]); Obj=11 // @poff=890
0x672: Pop(0)
0x673: Stack[-2] = 0
0x674: Push((int) 1)
...
0x67c: Pop(0)
0x67d: @@ GetItemCount(Stack[-3], Stack[-9]); Obj=10 // @poff=949
0x67e: Pop(0)
0x67f: Stack[-2] = (int) 0
0x680: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x681: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x682: @@ IsItemSelected(Stack[-1], Stack[-2], Stack[-9]); Obj=10 // @poff=984
0x683: Pop(0)
0x684: Push(Stack[-1])
0x685: IF (Stack[-1] == 0) GOTO 0x688; Pop(1)

0x686: @@ add(Stack[-2]); Obj=4 // @poff=890
0x687: Pop(0)
0x688: Push((int) 1)
0x689: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x68a: GOTO 0x680

0x68b: Stack[-4] = Stack[-11]
0x68c: Return(); Pop(8)

0x68d: Stack[-4] = 0
0x68e: PushEmpty(int, int, object, int, bool, int, int, int, int, object, int, bool, int, int)
0x68f: @@ RemoveAllItems(Stack[-18]); Obj=19 // @poff=0
0x690: Pop(0)
0x691: @@ size(Stack[-7]); Obj=17 // @poff=894
0x692: Pop(0)
0x693: Stack[-6] = (int) 0
0x694: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x695: IF (Stack[-1] == 0) GOTO 0x6a0; Pop(1)

0x696: @@ get(Stack[-5], Stack[-6]); Obj=17 // @poff=899
0x697: Pop(0)
0x698: @@ get(Stack[-4], Stack[-6]); Obj=16 // @poff=899
0x699: Pop(0)
0x69a: @@ AddItem(Stack[-3], Stack[-5], Stack[-18], Stack[-4]); Obj=19 // @poff=999
0x69b: Pop(0)
0x69c: Stack[-5] = 0
0x69d: Push((int) 1)
...
0x6a0: @@ size(Stack[-7]); Obj=15 // @poff=894
0x6a1: Pop(0)
0x6a2: Stack[-2] = (int) 0
0x6a3: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x6a4: IF (Stack[-1] == 0) GOTO 0x6ad; Pop(1)

0x6a5: @@ get(Stack[-1], Stack[-2]); Obj=15 // @poff=899
0x6a6: Pop(0)
0x6a7: Push((bool) 1)
0x6a8: @@ SelectItem(Stack[-2], Stack[-1], Stack[-19]); Obj=20 // @poff=1007
0x6a9: Pop(1)
0x6aa: Push((int) 1)
...
0x6af: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=636
0x6b0: Pop(0)
...
0x6eb: Push((float)9.999999974752427e-07)
...
0x712: Pop(0)
0x713: @@ add(Stack[-3]); Obj=1 // @poff=890
0x714: Pop(0)
0x715: Push((int) 0)
0x716: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x717: IF (Stack[-1] == 0) GOTO 0x71c; Pop(1)

0x718: Push((float)0.699999988079071)
0x719: Push((int) 500)
0x71a: @ RumblePlay(Stack[-2], Stack[-1])
0x71b: Pop(2)
0x71c: Push((int) 15)
0x71d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x71e: Pop(1)
0x71f: Return(); Pop(2)

0x720: Stack[-1] = 0
0x721: PushEmpty(object, object)
0x722: @ FindActor(Stack[-1], Stack[-4])
0x723: Pop(0)
0x724: Pop(0); PushNull((bool) Stack[-1] == 0)
0x725: IF (Stack[-1] == 0) GOTO 0x728; Pop(1)

0x726: Stack[-5] = (bool) 0
0x727: Return(); Pop(2)

0x728: @ Trigger(Stack[-1], Stack[-3])
0x729: Pop(0)
0x72a: Stack[-5] = (bool) 1
0x72b: Return(); Pop(2)

0x72c: Stack[-1] = 0
0x72d: PushEmpty(object, bool, cvector, cvector, object, bool, cvector, cvector)
0x72e: Pop(0); Push((bool) Stack[-11] == 0)
0x72f: IF (Stack[-1] == 0) GOTO 0x731; Pop(1)

0x730: Return(); Pop(8)

0x731: @ GetSceneByName(Stack[-4], Stack[-10])
0x732: Pop(0)
0x733: @@ GetLocator(Stack[-9], Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=1018
0x734: Pop(0)
0x735: Pop(0); Push((bool) Stack[-3] == 0)
0x736: IF (Stack[-1] == 0) GOTO 0x741; Pop(1)

0x737: Push("Teleport location '") // @poff=1029
0x738: Pop(1); Push(Stack[-1] + Stack[-10]);
0x739: Push("' not found in scene '") // @poff=1069
0x73a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x73b: Pop(1); Push(Stack[-1] + Stack[-11]);
0x73c: Push("'") // @poff=1065
0x73d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x73e: @ Trace(Stack[-1])
0x73f: Pop(1)
0x740: GOTO 0x743

0x741: @ Teleport(Stack[-11], Stack[-4], Stack[-2], Stack[-1])
0x742: Pop(0)
0x743: Return(); Pop(8)

0x744: Stack[-4] = 0
0x745: PushEmpty(object, object)
0x746: @ FindActor(Stack[-1], Stack[-3])
0x747: Pop(0)
0x748: Pop(0); Push((bool) Stack[-1] == 0)
0x749: IF (Stack[-1] == 0) GOTO 0x74c; Pop(1)

0x74a: Stack[-4] = (bool) 0
0x74b: Return(); Pop(2)

0x74c: @ RemoveActor(Stack[-1])
0x74d: Pop(0)
0x74e: Stack[-4] = (bool) 1
0x74f: Return(); Pop(2)

0x750: Stack[-1] = 0
0x751: PushEmpty(bool, bool)
0x752: @ IsPlayerActor(Stack[-3], Stack[-1])
0x753: Pop(0)
0x754: Push(Stack[-1])
0x755: IF (Stack[-1] == 0) GOTO 0x759; Pop(1)

0x756: Push("attack") // @poff=84
0x757: @ PlayGlobalMusic(Stack[-1])
0x758: Pop(1)
0x759: Return(); Pop(2)

0x75a: PushEmpty(object, object)
0x75b: @ GetScene(Stack[-1])
0x75c: Pop(0)
0x75d: Push("battle") // @poff=1115
0x75e: PushEmpty(object)
0x75f: Call2 0x6e2

0x760: Pop(0)
0x761: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x762: Pop(2)
0x763: Return(); Pop(2)
...
0x768: Push(-1, 0); TaskCall(2)
0x769: Call2 0x43b

0x76a: Pop(-1, 0); TaskReturn
0x76b: Pop(1)
0x76c: Return(); Pop(0)

0x76d: PushEmpty()
0x76e: PushEmpty(object, int, float)
0x76f: Stack[-7] = Stack[-3]
0x770: Stack[-6] = Stack[-2]
0x771: Stack[-5] = Stack[-1]
0x772: Call2 0x604
...
0x775: PushEmpty()
0x776: PushEmpty(object, int, float, cvector, cvector)
0x777: Stack[-11] = Stack[-5]
0x778: Stack[-10] = Stack[-4]
0x779: Stack[-9] = Stack[-3]
0x77a: Stack[-7] = Stack[-2]
