...
Strings:
	...
	W:cleanup
	W:restore
// @pool_raw:6400690073006500610073006500000063006f0072007000730065000000456e61626c650063006c00650061006e0075007000000072006500730074006f00720065000000
...
0x4: Pop(2)
0x5: Push("corpse") // @poff=16
0x6: @ FindGeometry(Stack[-1], Stack[-2])
0x7: Pop(1)
0x8: Push((bool) 1)
0x9: @@ Enable(Stack[-1]); Obj=2 // @poff=30
0xa: Pop(1)
0xb: Push((bool) 1)
