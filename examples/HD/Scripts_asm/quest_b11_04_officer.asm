...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1c2: Push("player") // @poff=172
0x1c3: @ FindActor(Stack[-4]T, Stack[-1])
0x1c4: Pop(1)
...
0x1d7: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x262: Pop(0)
0x263: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x264: Pop(0)
...
0x26e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x26f: Pop(0)
0x270: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x271: Pop(0)
...
0x297: Pop(0)
0x298: Push((bool) 1)
0x299: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x29a: Pop(1)
...
0x2b3: Push((bool) 1)
0x2b4: @ CameraSwitchToNormal(Stack[-1])
0x2b5: Pop(1)
...
0x2c4: PushEmpty(bool, float, float, bool, float, float)
0x2c5: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2c6: Pop(0)
0x2c7: Push(Stack[-3])
0x2c8: IF (Stack[-1] == 0) GOTO 0x2cf; Pop(1)

0x2c9: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2ca: Pop(0)
0x2cb: Push((bool) 0)
0x2cc: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2cd: Pop(1)
0x2ce: GOTO 0x2d3

0x2cf: Push("Can't find lsh animation : ") // @poff=222
0x2d0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2d1: @ Trace(Stack[-1])
0x2d2: Pop(1)
0x2d3: Return(); Pop(6)

0x2d4: PushEmpty(bool, float, float, bool, float, float)
0x2d5: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2d6: Pop(0)
0x2d7: Push(Stack[-3])
0x2d8: IF (Stack[-1] == 0) GOTO 0x2de; Pop(1)

0x2d9: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2da: Pop(0)
0x2db: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2dc: Pop(0)
0x2dd: GOTO 0x2e2

0x2de: Push("Can't find lsh animation : ") // @poff=222
0x2df: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2e0: @ Trace(Stack[-1])
0x2e1: Pop(1)
0x2e2: Return(); Pop(6)
...
0x301: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x302: Return(); Pop(2)
...
0x30a: PushEmpty(string, string)
0x30b: Stack[-1] = "idle" // @poff=146
0x30c: Push(Stack[-3])
0x30d: IF (Stack[-1] == 0) GOTO 0x30f; Pop(1)

0x30e: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x30f: Stack[-1] = Stack[-4]
0x310: Return(); Pop(2)

0x311: PushEmpty(int, bool, int, bool)
0x312: Stack[-2] = (int) 0
...
0x317: Pop(1)
0x318: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x319: Pop(2)
...
0x31d: Push((int) 1)
0x31e: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x31f: GOTO 0x313

0x320: Stack[-2] = Stack[-5]
0x321: Return(); Pop(4)

0x322: Stack[-1] = (int) 515597
0x323: Return(); Pop(0)

0x324: Stack[-1] = (int) 514841
0x325: Return(); Pop(0)

0x326: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=278
0x327: Return(); Pop(0)

0x328: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=318
0x329: Return(); Pop(0)
...
0x353: Push("Can't retrieve diary root") // @poff=376
0x354: @ Trace(Stack[-1])
0x355: Pop(1)
...
0x35f: Pop(1)
0x360: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=428
0x361: Pop(0)
0x362: Pop(0); Push((bool) Stack[-2] == 0)
0x363: IF (Stack[-1] == 0) GOTO 0x36a; Pop(1)

0x364: Push("Can't find diary parent with id: ") // @poff=433
...
0x36a: @@ AddChild(Stack[-8]); Obj=2 // @poff=501
0x36b: Pop(0)
0x36c: Push((int) 7)
0x36d: @ SendWorldWndMessage(Stack[-1])
0x36e: Pop(1)
0x36f: @@ GetCategory(Stack[-1]); Obj=8 // @poff=510
0x370: Pop(0)
