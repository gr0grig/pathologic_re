...
0x9e: Push((float)0.699999988079071)
0x9f: Push((int) 500)
...
0xb6: Pop(0)
0xb7: Push("flame") // @poff=182
0xb8: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=194
0xb9: Pop(2)
0xba: Push(GlobalVars[1])
0xbb: Stack[-1] = (bool) 0
0xbc: GlobalVars[1] = Stack[-1]; Pop(1)
0xbd: Push((float)0.05000000074505806)
0xbe: @@ SetLength(Stack[-1]); Obj=2 // @poff=201
0xbf: Pop(1)
0xc0: Push(GlobalVars[2])
0xc1: Stack[-2] = Stack[-1]
0xc2: GlobalVars[2] = Stack[-1]; Pop(1)
0xc3: Push((int) 70)
0xc4: Push((float)0.10000000149011612)
...
0xd0: Pop(1); PushNull((bool) Stack[-1] == 0)
0xd1: IF (Stack[-1] == 0) GOTO 0xd3; Pop(1)

0xd2: Return(); Pop(14)

0xd3: Push(GlobalVars[2])
0xd4: @@ Intersect(Stack[-8], Stack[-7]); Obj=1 // @poff=211
0xd5: Pop(1)
...
0xe1: Push((float)0.05000000074505806)
0xe2: @@ SetLength(Stack[-1]); Obj=2 // @poff=201
0xe3: Pop(2)
0xe4: @@ Next(Stack[-4], Stack[-5]); Obj=7 // @poff=221
0xe5: Pop(0)
0xe6: Push(Stack[-4])
...
0xf4: Stack[-9] = Stack[-3]
0xf5: Stack[-2] = (float) 0.10000000149011612
0xf6: Stack[-1] = (int) 2
0xf7: Call2 0x35

0xf8: Stack[-4] = Stack[-7]
0xf9: Pop(4)
0xfa: PushEmpty(bool, object, string)
0xfb: Stack[-8] = Stack[-2]
0xfc: Stack[-1] = "disease" // @poff=226
0xfd: Call2 0x29

0xfe: Pop(2)
0xff: IF (Stack[-1] == 0) GOTO 0x10d; Pop(1)

0x100: Push("disease") // @poff=226
0x101: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=140
0x102: Pop(1)
0x103: Push((float)0.019999999552965164)
...
0x108: Push((float)0.019999999552965164)
0x109: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0x10a: Push("disease") // @poff=226
0x10b: @@ SetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=166
0x10c: Pop(1)
0x10d: PushEmpty(bool, object, string)
0x10e: Stack[-8] = Stack[-2]
0x10f: Stack[-1] = "fire" // @poff=44
0x110: Call2 0x29

0x111: Pop(2)
0x112: IF (Stack[-1] == 0) GOTO 0x11b; Pop(1)

0x113: Push("fire") // @poff=44
0x114: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=140
0x115: Pop(1)
0x116: Push("fire") // @poff=44
0x117: Push((float)0.10000000149011612)
0x118: Pop(1); Push(Stack[-3] + Stack[-1]);
0x119: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=166
0x11a: Pop(2)
0x11b: GOTO 0xe4
...
0x123: Stack[-1] = Stack[-6]
0x124: Pop(1)
0x125: GOTO 0x127

0x126: Stack[-5] = (float) 0.05000000074505806
0x127: Push(GlobalVars[2])
0x128: @@ GetLength(Stack[-5]); Obj=1 // @poff=242
0x129: Pop(1)
0x12a: Pop(0); Push((bool) Stack[-5] < Stack[-4])
0x12b: IF (Stack[-1] == 0) GOTO 0x12d; Pop(1)

0x12c: Stack[-5] = Stack[-4]
0x12d: Push(GlobalVars[2])
0x12e: @@ SetLength(Stack[-5]); Obj=1 // @poff=201
0x12f: Pop(1)
...
0x136: Pop(1); PushNull((bool) Stack[-1] == 0)
...
0x13e: Push("flame_loop") // @poff=252
0x13f: Push((int) 0)
0x140: Push((int) 200)
...
0x148: Push((int) 2)
0x149: @@ FadeIn(Stack[-1]); Obj=2 // @poff=274
0x14a: Pop(2)
0x14b: GOTO 0x153
...
0x150: Push((int) 2)
0x151: @@ FadeOut(Stack[-1]); Obj=2 // @poff=281
0x152: Pop(2)
0x153: Push(GlobalVars[1])
0x154: Stack[-12] = Stack[-1]
