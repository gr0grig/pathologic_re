...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1a0: Push("player") // @poff=172
0x1a1: @ FindActor(Stack[-4]T, Stack[-1])
0x1a2: Pop(1)
...
0x1b5: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x20a: Pop(0)
0x20b: Push("all") // @poff=138
0x20c: PushEmpty(string, int)
0x20d: Stack[-7] = Stack[-1]
0x20e: Call2 0x2f9
...
0x240: Pop(0)
0x241: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x242: Pop(0)
...
0x24c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x24d: Pop(0)
0x24e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x24f: Pop(0)
...
0x275: Pop(0)
0x276: Push((bool) 1)
0x277: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x278: Pop(1)
0x279: Push(CvectorIndex(Stack[-4], 0))
0x27a: Push(CvectorIndex(Stack[-5], 2))
0x27b: @ Rotate(Stack[-2], Stack[-1])
0x27c: Pop(2)
...
0x287: Push("head") // @poff=186
0x288: @ LookAsyncCamera(Stack[-1])
0x289: Pop(1)
0x28a: @ CameraWaitForPlayFinish()
0x28b: Pop(0)
0x28c: @ ResumeWorld()
0x28d: Pop(0)
0x28e: Stack[-21] = (bool) 1
0x28f: Return(); Pop(18)

0x290: PushEmpty(bool, bool)
0x291: Push((bool) 1)
0x292: @ CameraSwitchToNormal(Stack[-1])
0x293: Pop(1)
...
0x29a: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x29b: Pop(1)
0x29c: Push(Stack[-1])
0x29d: IF (Stack[-1] == 0) GOTO 0x2a1; Pop(1)

0x29e: Push("head") // @poff=186
0x29f: @ UnlookAsync(Stack[-1])
0x2a0: Pop(1)
0x2a1: Return(); Pop(2)

0x2a2: PushEmpty(bool, float, float, bool, float, float)
0x2a3: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2a4: Pop(0)
0x2a5: Push(Stack[-3])
0x2a6: IF (Stack[-1] == 0) GOTO 0x2ad; Pop(1)

0x2a7: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2a8: Pop(0)
0x2a9: Push((bool) 0)
0x2aa: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2ab: Pop(1)
0x2ac: GOTO 0x2b1

0x2ad: Push("Can't find lsh animation : ") // @poff=222
0x2ae: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2af: @ Trace(Stack[-1])
0x2b0: Pop(1)
0x2b1: Return(); Pop(6)

0x2b2: PushEmpty(bool, float, float, bool, float, float)
0x2b3: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2b4: Pop(0)
0x2b5: Push(Stack[-3])
0x2b6: IF (Stack[-1] == 0) GOTO 0x2bc; Pop(1)

0x2b7: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2b8: Pop(0)
0x2b9: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2ba: Pop(0)
0x2bb: GOTO 0x2c0

0x2bc: Push("Can't find lsh animation : ") // @poff=222
0x2bd: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2be: @ Trace(Stack[-1])
0x2bf: Pop(1)
0x2c0: Return(); Pop(6)

0x2c1: PushEmpty(float, cvector, float, cvector)
0x2c2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2c3: Pop(0)
0x2c4: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x2c5: Push(CvectorIndex(Stack[-1], 1))
0x2c6: Stack[-3] = Stack[-1]
0x2c7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2c8: Push("head") // @poff=186
0x2c9: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2ca: Pop(1)
0x2cb: Return(); Pop(4)
...
0x2dc: Push((float)9.999999974752427e-07)
...
0x2e9: @ FindActor(Stack[-1], Stack[-4])
0x2ea: Pop(0)
0x2eb: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2ec: IF (Stack[-1] == 0) GOTO 0x2ef; Pop(1)

0x2ed: Stack[-5] = (bool) 0
0x2ee: Return(); Pop(2)

0x2ef: @ Trigger(Stack[-1], Stack[-3])
0x2f0: Pop(0)
0x2f1: Stack[-5] = (bool) 1
0x2f2: Return(); Pop(2)

0x2f3: Stack[-1] = 0
0x2f4: PushEmpty(float, float)
0x2f5: @ GetGameTime(Stack[-1])
0x2f6: Pop(0)
0x2f7: Stack[-1] = Stack[-3]
0x2f8: Return(); Pop(2)

0x2f9: PushEmpty(string, string)
0x2fa: Stack[-1] = "idle" // @poff=146
0x2fb: Push(Stack[-3])
0x2fc: IF (Stack[-1] == 0) GOTO 0x2fe; Pop(1)

0x2fd: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2fe: Stack[-1] = Stack[-4]
0x2ff: Return(); Pop(2)

0x300: PushEmpty(int, bool, int, bool)
0x301: Stack[-2] = (int) 0
0x302: Push("all") // @poff=138
0x303: PushEmpty(string, int)
0x304: Stack[-5] = Stack[-1]
0x305: Call2 0x2f9

0x306: Pop(1)
0x307: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x308: Pop(2)
0x309: Pop(0); Push((bool) Stack[-1] == 0)
0x30a: IF (Stack[-1] == 0) GOTO 0x30c; Pop(1)

0x30b: GOTO 0x30f

0x30c: Push((int) 1)
0x30d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x30e: GOTO 0x302

0x30f: Stack[-2] = Stack[-5]
0x310: Return(); Pop(4)

0x311: Stack[-1] = (int) 530494
0x312: Return(); Pop(0)

0x313: Stack[-1] = (int) 530493
0x314: Return(); Pop(0)

0x315: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=278
0x316: Return(); Pop(0)

0x317: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=318
0x318: Return(); Pop(0)
...
0x323: Pop(1)
0x324: Push("b11q04SanitarGotoOfficer") // @poff=376
0x325: Push("pt_gmap_vagon_army") // @poff=426
0x326: Push((int) 0)
0x327: Push((int) 530531)
0x328: PushEmpty(float)
0x329: Call2 0x2f4

0x32a: Pop(0)
0x32b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=464
0x32c: Pop(5)
0x32d: PushEmpty()
0x32e: Call2 0x353

0x32f: Pop(0)
0x330: PushEmpty(bool, string, string)
0x331: Stack[-2] = "quest_b11_04" // @poff=472
0x332: Stack[-1] = "place_officer" // @poff=498
0x333: Call2 0x2e8
...
0x336: Stack[-1] = 0
0x337: PushEmpty()
0x338: PushEmpty(object, string, float)
0x339: PushEmpty(object)
0x33a: Call2 0x389

0x33b: Stack[-1] = Stack[-4]
0x33c: Pop(1)
0x33d: Stack[-2] = "pt_gmap_vagon_army" // @poff=426
0x33e: Stack[-1] = (int) 2
0x33f: Call2 0x39a
...
0x343: Pop(0)
0x344: @@ ShowMap(Stack[-1]); Obj=2 // @poff=526
0x345: Pop(1)
0x346: Return(); Pop(0)

0x347: PushEmpty()
0x348: PushEmpty(int, string)
0x349: Stack[-1] = "b11q04" // @poff=362
0x34a: Call2 0x2e3
...
0x354: Push((int) 553)
0x355: Push((int) 2)
0x356: Push((int) 530528)
0x357: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x358: Pop(3)
0x359: PushEmpty(bool, object, int)
0x35a: Stack[-4] = Stack[-2]
0x35b: Stack[-1] = (int) 551
0x35c: Call2 0x36d
...
0x361: @ GetDiaryRoot(Stack[-1])
0x362: Pop(0)
0x363: Pop(0); Push((bool) Stack[-1] == 0)
0x364: IF (Stack[-1] == 0) GOTO 0x36a; Pop(1)

0x365: Push("Can't retrieve diary root") // @poff=534
0x366: @ Trace(Stack[-1])
0x367: Pop(1)
0x368: Stack[-3] = (bool) 0
0x369: Return(); Pop(2)

0x36a: Stack[-1] = Stack[-3]
0x36b: Return(); Pop(2)

0x36c: Stack[-1] = 0
0x36d: PushEmpty(object, object, int, object, object, int)
0x36e: PushEmpty(object)
0x36f: Call2 0x360

0x370: Stack[-1] = Stack[-4]
0x371: Pop(1)
0x372: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=586
0x373: Pop(0)
0x374: Pop(0); Push((bool) Stack[-2] == 0)
0x375: IF (Stack[-1] == 0) GOTO 0x37c; Pop(1)

0x376: Push("Can't find diary parent with id: ") // @poff=591
0x377: Pop(1); Push(Stack[-1] + Stack[-8]);
0x378: @ Trace(Stack[-1])
0x379: Pop(1)
0x37a: Stack[-9] = (bool) 0
0x37b: Return(); Pop(6)

0x37c: @@ AddChild(Stack[-8]); Obj=2 // @poff=659
0x37d: Pop(0)
0x37e: Push((int) 7)
0x37f: @ SendWorldWndMessage(Stack[-1])
0x380: Pop(1)
0x381: @@ GetCategory(Stack[-1]); Obj=8 // @poff=668
0x382: Pop(0)
0x383: @ SetDiarySection(Stack[-1])
0x384: Pop(0)
0x385: Stack[-9] = (bool) 0
0x386: Return(); Pop(6)

0x387: Stack[-2] = 0
0x388: Stack[-3] = 0
0x389: PushEmpty(object, object, object, object)
0x38a: @ GetMainOutdoorScene(Stack[-2])
0x38b: Pop(0)
0x38c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x38d: IF (Stack[-1] == 0) GOTO 0x394; Pop(1)

0x38e: Push("Can't find main outdoor scene") // @poff=680
0x38f: @ Trace(Stack[-1])
0x390: Pop(1)
0x391: Stack[-1] = 0
...
0x394: @@ GetMap(Stack[-1]); Obj=2 // @poff=740
0x395: Pop(0)
...
0x398: Stack[-1] = 0
0x399: Stack[-2] = 0
0x39a: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x39b: @ GetMainOutdoorScene(Stack[-2])
0x39c: Pop(0)
0x39d: Pop(0); PushNull((bool) Stack[-2] == 0)
0x39e: IF (Stack[-1] == 0) GOTO 0x3a3; Pop(1)

0x39f: Push("Can't find main outdoor scene") // @poff=680
0x3a0: @ Trace(Stack[-1])
0x3a1: Pop(1)
0x3a2: Return(); Pop(8)

0x3a3: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=747
0x3a4: Pop(0)
0x3a5: Pop(0); Push((bool) Stack[-1] == 0)
0x3a6: IF (Stack[-1] == 0) GOTO 0x3ad; Pop(1)

0x3a7: Push("Warning: outdoor scene locator ") // @poff=758
0x3a8: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3a9: Push(" doesnt exist") // @poff=822
0x3aa: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3ab: @ Trace(Stack[-1])
0x3ac: Pop(1)
0x3ad: @@ GetMap(Stack[-11]); Obj=2 // @poff=740
0x3ae: Pop(0)
0x3af: Pop(0); PushNull((bool) Stack[-11] == 0)
0x3b0: IF (Stack[-1] == 0) GOTO 0x3b5; Pop(1)

0x3b1: Push("Can't find map") // @poff=850
0x3b2: @ Trace(Stack[-1])
0x3b3: Pop(1)
0x3b4: Return(); Pop(8)

0x3b5: Push(CvectorIndex(Stack[-4], 0))
0x3b6: Push(CvectorIndex(Stack[-5], 2))
0x3b7: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=880
0x3b8: Pop(2)
0x3b9: Return(); Pop(8)

0x3ba: Stack[-2] = 0
0x3bb: PushEmpty(int, int)
0x3bc: Push("branch") // @poff=893
