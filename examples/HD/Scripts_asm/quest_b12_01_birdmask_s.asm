...
Strings:
	...
	A:get
	W:game_final
// @pool_raw:
// @pool_encoding:utf8
...
0x2c5: Push("player") // @poff=156
0x2c6: @ FindActor(Stack[-4]T, Stack[-1])
0x2c7: Pop(1)
...
0x2da: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x365: Pop(0)
0x366: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x367: Pop(0)
...
0x371: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x372: Pop(0)
0x373: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x374: Pop(0)
...
0x3d2: Push("Can't find lsh animation : ") // @poff=206
...
0x3e1: Push("Can't find lsh animation : ") // @poff=206
...
0x3e7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x3e8: Pop(0)
...
0x3fb: Push((float)9.999999974752427e-07)
...
0x40c: Push("Door ") // @poff=262
0x40d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x40e: Push(" not found") // @poff=274
0x40f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x410: @ Trace(Stack[-1])
0x411: Pop(1)
0x412: GOTO 0x416

0x413: Push("locked") // @poff=296
0x414: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=310
0x415: Pop(1)
0x416: Return(); Pop(2)
...
0x41a: Pop(0)
0x41b: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x434: Stack[-2] = (int) 0
0x435: Push("all") // @poff=138
0x436: PushEmpty(string, int)
0x437: Stack[-5] = Stack[-1]
0x438: Call2 0x42c
...
0x448: Stack[-1] = "ui/NPC_bmask.png" // @poff=322
0x449: Return(); Pop(0)

0x44a: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=356
0x44b: Return(); Pop(0)
...
0x44e: PushEmpty()
0x44f: Push("oob12BirdmaskS1") // @poff=394
0x450: Push((int) 1)
...
0x456: Stack[-2] = "quest_b12_01" // @poff=426
0x457: Stack[-1] = "init_sobor" // @poff=452
0x458: Call2 0x418
...
0x45b: PushEmpty()
0x45c: Push("oob12BirdmaskS2") // @poff=474
0x45d: Push((int) 1)
...
0x461: PushEmpty()
0x462: Push("oob12BirdmaskS3") // @poff=506
0x463: Push((int) 1)
...
0x467: PushEmpty()
0x468: Push("oob12BirdmaskS4") // @poff=538
0x469: Push((int) 1)
...
0x46f: Stack[-2] = "sobor@door1" // @poff=570
...
0x48a: Stack[-1] = "oob12BirdmaskS1" // @poff=394
0x48b: Call2 0x402
...
0x496: Stack[-1] = "oob12BirdmaskS2" // @poff=474
0x497: Call2 0x402
...
0x4a2: Stack[-1] = "oob12BirdmaskS3" // @poff=506
0x4a3: Call2 0x402
...
0x4ae: Stack[-1] = "oob12BirdmaskS4" // @poff=538
0x4af: Call2 0x402
...
0x4da: PushEmpty()
0x4db: Push((int) 18)
0x4dc: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4dd: Pop(1)
0x4de: Push((int) 24)
0x4df: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4e0: Pop(1)
0x4e1: Push((int) 20)
0x4e2: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4e3: Pop(1)
0x4e4: Push((int) 14)
0x4e5: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4e6: Pop(1)
0x4e7: Push((bool) 0)
...
0x4ea: Push((int) 10)
0x4eb: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4ec: Pop(1)
0x4ed: Push((int) 17)
0x4ee: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4ef: Pop(1)
0x4f0: Push((int) 8)
0x4f1: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4f2: Pop(1)
0x4f3: GOTO 0x4fa
...
0x4f7: Push((int) 10)
0x4f8: @@ add(Stack[-1]); Obj=4 // @poff=608
0x4f9: Pop(1)
0x4fa: Return(); Pop(0)

0x4fb: PushEmpty(int, int)
0x4fc: Push("vol_") // @poff=612
...
0x513: Stack[-7] = Stack[-3]
0x514: Stack[-2] = (bool) 0
0x515: Stack[-1] = (int) -1
0x516: Call2 0x4da

0x517: Pop(3)
0x518: @@ size(Stack[-3]); Obj=4 // @poff=622
0x519: Pop(0)
0x51a: Stack[-2] = (int) 0
0x51b: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x51c: IF (Stack[-1] == 0) GOTO 0x532; Pop(1)

0x51d: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=627
0x51e: Pop(0)
...
0x524: Pop(1)
0x525: IF (Stack[-1] == 1) GOTO 0x52c; Pop(1)
...
0x529: Pop(1)
0x52a: IF (Stack[-1] == 1) GOTO 0x52c; Pop(1)
...
0x536: Push("game_final") // @poff=631
0x537: @ GetVariable(Stack[-1], Stack[-2])
0x538: Pop(1)
0x539: Stack[-1] = Stack[-3]
0x53a: Return(); Pop(2)
