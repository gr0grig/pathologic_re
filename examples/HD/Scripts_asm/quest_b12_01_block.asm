...
// @pool_raw:
// @pool_encoding:utf8
...
0x29d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=200
0x29e: Pop(0)
0x29f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=212
0x2a0: Pop(0)
...
0x30c: Push("voice_common") // @poff=236
0x30d: Push((int) 1)
...
0x314: Push("voice_common") // @poff=236
0x315: Push((int) 0)
...
0x327: Push("voice_common") // @poff=236
0x328: Push((int) 1)
...
0x335: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x336: Pop(1)
...
0x34a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x34b: Pop(1)
...
0x353: Push("d") // @poff=232
0x354: PushEmpty(int)
0x355: Call2 0x3d8

0x356: Pop(0)
0x357: Pop(2); Push(Stack[-2] + Stack[-1]);
0x358: Push("m") // @poff=290
...
0x360: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x361: Pop(1)
...
0x375: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x376: Pop(1)
0x377: PushEmpty(bool, string)
0x378: Stack[-3] = Stack[-1]
0x379: Call2 0x39c

0x37a: Stack[-2] = Stack[-14]
0x37b: Pop(2)
0x37c: Return(); Pop(10)
...
0x388: Push("Can't find lsh animation : ") // @poff=294
...
0x397: Push("Can't find lsh animation : ") // @poff=294
...
0x3bb: Push((float)9.999999974752427e-07)
...
0x3cc: Push("Door ") // @poff=350
0x3cd: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3ce: Push(" not found") // @poff=362
0x3cf: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3d0: @ Trace(Stack[-1])
0x3d1: Pop(1)
0x3d2: GOTO 0x3d6

0x3d3: Push("locked") // @poff=384
0x3d4: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=398
0x3d5: Pop(1)
0x3d6: Return(); Pop(2)
...
0x3e1: PushEmpty()
0x3e2: Push("game_final") // @poff=410
0x3e3: Push((int) 1)
...
0x3e7: PushEmpty()
0x3e8: Push("game_final") // @poff=410
0x3e9: Push((int) 2)
...
0x3ed: PushEmpty()
0x3ee: Push("game_final") // @poff=410
0x3ef: Push((int) 3)
...
0x3f5: Stack[-2] = "isobor@door1" // @poff=432
...
0x409: PushEmpty()
0x40a: Push("game_final") // @poff=410
0x40b: Push((int) 4)
...
0x416: Stack[-1] = "game_final" // @poff=410
0x417: Call2 0x3c2
...
0x422: Stack[-1] = "b12q01DankoInSobor" // @poff=458
0x423: Call2 0x3c2
...
0x42e: Stack[-1] = "b12q01KlaraInSobor" // @poff=496
0x42f: Call2 0x3c2
...
0x471: Push("Can't retrieve diary root") // @poff=534
0x472: @ Trace(Stack[-1])
0x473: Pop(1)
...
0x47d: Pop(1)
0x47e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=586
0x47f: Pop(0)
0x480: Pop(0); Push((bool) Stack[-2] == 0)
0x481: IF (Stack[-1] == 0) GOTO 0x488; Pop(1)

0x482: Push("Can't find diary parent with id: ") // @poff=591
...
0x488: @@ AddChild(Stack[-8]); Obj=2 // @poff=659
0x489: Pop(0)
0x48a: Push((int) 7)
0x48b: @ SendWorldWndMessage(Stack[-1])
0x48c: Pop(1)
0x48d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=668
0x48e: Pop(0)
...
0x4aa: Stack[-1] = "ui/NPC_Block.png" // @poff=694
0x4ab: Return(); Pop(0)

0x4ac: Stack[-1] = "ui/NPC_Block_b.png" // @poff=728
0x4ad: Return(); Pop(0)
