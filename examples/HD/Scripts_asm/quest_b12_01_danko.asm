...
// @pool_raw:
// @pool_encoding:utf8
...
0xc2: Push("all") // @poff=138
0xc3: Push("idle") // @poff=146
...
0x262: @@ GetPosition(Stack[-8]); Obj=20 // @poff=228
0x263: Pop(0)
0x264: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=240
0x265: Pop(0)
...
0x2d1: Push("voice_common") // @poff=264
0x2d2: Push((int) 1)
...
0x2d9: Push("voice_common") // @poff=264
0x2da: Push((int) 0)
...
0x2ec: Push("voice_common") // @poff=264
0x2ed: Push((int) 1)
...
0x2fa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=294
0x2fb: Pop(1)
...
0x325: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=294
0x326: Pop(1)
...
0x33a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=306
0x33b: Pop(1)
...
0x34d: Push("Can't find lsh animation : ") // @poff=322
...
0x35c: Push("Can't find lsh animation : ") // @poff=322
...
0x380: Push((float)9.999999974752427e-07)
...
0x395: PushEmpty()
0x396: Push("oob12DankoSobor1") // @poff=378
0x397: Push((int) 1)
...
0x39b: PushEmpty()
0x39c: Push("oob12DankoSobor2") // @poff=412
0x39d: Push((int) 1)
...
0x3a1: PushEmpty()
0x3a2: Push("oob12DankoSobor3") // @poff=446
0x3a3: Push((int) 1)
...
0x3a7: PushEmpty()
0x3a8: Push("oob12DankoSobor4") // @poff=480
0x3a9: Push((int) 1)
...
0x3af: Stack[-1] = "game_final" // @poff=514
0x3b0: Call2 0x387
...
0x3bb: Stack[-1] = "oob12DankoSobor1" // @poff=378
0x3bc: Call2 0x387
...
0x3c7: Stack[-1] = "oob12DankoSobor2" // @poff=412
0x3c8: Call2 0x387
...
0x3d3: Stack[-1] = "oob12DankoSobor3" // @poff=446
0x3d4: Call2 0x387
...
0x3df: Stack[-1] = "oob12DankoSobor4" // @poff=480
0x3e0: Call2 0x387
...
0x3fe: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=550
0x3ff: Return(); Pop(0)

0x400: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=590
0x401: Return(); Pop(0)
