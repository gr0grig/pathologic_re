...
Strings:
	...
	W:oob12KapellaSobor1
	W:game_final
	W:branch
	W:ui/NPC_Kapella.png
	W:ui/NPC_Kapella_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0xfe: Stack[-1] = "Strength" // @poff=156
0xff: Call2 0xa5
...
0x115: Stack[-1] = "Strength" // @poff=156
0x116: Call2 0xa5
...
0x12c: Stack[-1] = "Strength" // @poff=156
0x12d: Call2 0xa5
...
0x13e: Stack[-1] = "Sympathy" // @poff=174
0x13f: Call2 0xa5
...
0x16c: Stack[-1] = "Sympathy" // @poff=174
0x16d: Call2 0xa5
...
0x183: Stack[-1] = "Sympathy" // @poff=174
0x184: Call2 0xa5
...
0x195: Stack[-1] = "Strength" // @poff=156
0x196: Call2 0xa5
...
0x1a7: Stack[-1] = "Sympathy" // @poff=174
0x1a8: Call2 0xa5
...
0x1b9: Stack[-1] = "Sympathy" // @poff=174
0x1ba: Call2 0xa5
...
0x1cb: Stack[-1] = "Sympathy" // @poff=174
0x1cc: Call2 0xa5
...
0x233: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0x234: Pop(0)
0x235: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=246
0x236: Pop(0)
...
0x25c: Pop(0)
0x25d: Push((bool) 1)
0x25e: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x25f: Pop(1)
0x260: Push(CvectorIndex(Stack[-4], 0))
0x261: Push(CvectorIndex(Stack[-5], 2))
0x262: @ Rotate(Stack[-2], Stack[-1])
0x263: Pop(2)
...
0x269: Push("head") // @poff=260
0x26a: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x26b: Pop(1)
0x26c: Push(Stack[-1])
0x26d: IF (Stack[-1] == 0) GOTO 0x271; Pop(1)

0x26e: Push("head") // @poff=260
0x26f: @ LookAsyncCamera(Stack[-1])
0x270: Pop(1)
0x271: @ CameraWaitForPlayFinish()
0x272: Pop(0)
0x273: @ ResumeWorld()
0x274: Pop(0)
0x275: Stack[-21] = (bool) 1
0x276: Return(); Pop(18)

0x277: PushEmpty(bool, bool)
0x278: Push((bool) 1)
0x279: @ CameraSwitchToNormal(Stack[-1])
0x27a: Pop(1)
...
0x280: Push("head") // @poff=260
0x281: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x282: Pop(1)
0x283: Push(Stack[-1])
0x284: IF (Stack[-1] == 0) GOTO 0x288; Pop(1)

0x285: Push("head") // @poff=260
0x286: @ UnlookAsync(Stack[-1])
0x287: Pop(1)
0x288: Return(); Pop(2)

0x289: PushEmpty(int, int, int, int)
0x28a: Push("voice_common") // @poff=270
0x28b: @ GetVariable(Stack[-1], Stack[-3])
0x28c: Pop(1)
0x28d: Push(Stack[-2])
0x28e: IF (Stack[-1] == 0) GOTO 0x2af; Pop(1)

0x28f: PushEmpty(bool, object)
0x290: Stack[-7] = Stack[-1]
0x291: Call2 0x2c3

0x292: Pop(1)
0x293: Pop(1); Push((bool) Stack[-1] == 0)
0x294: IF (Stack[-1] == 0) GOTO 0x29d; Pop(1)

0x295: PushEmpty(bool, object)
0x296: Stack[-7] = Stack[-1]
0x297: Call2 0x2e8
...
0x29b: Stack[-6] = (bool) 0
0x29c: Return(); Pop(4)

0x29d: Push((int) 2)
0x29e: @ irand(Stack[-2], Stack[-1])
0x29f: Pop(1)
0x2a0: Push(Stack[-1])
0x2a1: IF (Stack[-1] == 0) GOTO 0x2aa; Pop(1)

0x2a2: Push("voice_common") // @poff=270
0x2a3: Push((int) 1)
0x2a4: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2a5: Push((int) 3)
0x2a6: Pop(2); Push(Stack[-2] % Stack[-1]);
0x2a7: @ SetVariable(Stack[-2], Stack[-1])
0x2a8: Pop(2)
0x2a9: GOTO 0x2ae

0x2aa: Push("voice_common") // @poff=270
0x2ab: Push((int) 0)
...
0x2bb: Stack[-6] = (bool) 0
0x2bc: Return(); Pop(4)

0x2bd: Push("voice_common") // @poff=270
0x2be: Push((int) 1)
0x2bf: @ SetVariable(Stack[-2], Stack[-1])
0x2c0: Pop(2)
0x2c1: Stack[-6] = (bool) 1
0x2c2: Return(); Pop(4)

0x2c3: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x2c4: Stack[-5] = "c" // @poff=296
0x2c5: Stack[-4] = (int) 0
0x2c6: Push((int) 1)
0x2c7: IF (Stack[-1] == 0) GOTO 0x2d3; Pop(1)

0x2c8: Push((int) 1)
0x2c9: Pop(1); Push(Stack[-5] + Stack[-1]);
0x2ca: Pop(1); Push(Stack[-6] + Stack[-1]);
0x2cb: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x2cc: Pop(1)
0x2cd: Pop(0); Push((bool) Stack[-3] == 0)
0x2ce: IF (Stack[-1] == 0) GOTO 0x2d0; Pop(1)

0x2cf: GOTO 0x2d3

0x2d0: Push((int) 1)
0x2d1: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x2d2: GOTO 0x2c6

0x2d3: Pop(0); Push((bool) Stack[-4] == 0)
...
0x2d7: Stack[-2] = (int) 0
0x2d8: Push((int) 1)
0x2d9: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x2da: IF (Stack[-1] == 0) GOTO 0x2dd; Pop(1)

0x2db: @ irand(Stack[-2], Stack[-4])
0x2dc: Pop(0)
0x2dd: Push((int) 1)
0x2de: Pop(1); Push(Stack[-3] + Stack[-1]);
0x2df: Pop(1); Push(Stack[-6] + Stack[-1]);
0x2e0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x2e1: Pop(1)
0x2e2: PushEmpty(bool, string)
0x2e3: Stack[-3] = Stack[-1]
0x2e4: Call2 0x332

0x2e5: Stack[-2] = Stack[-14]
0x2e6: Pop(2)
0x2e7: Return(); Pop(10)

0x2e8: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x2e9: Push("d") // @poff=266
0x2ea: PushEmpty(int)
0x2eb: Call2 0x35d

0x2ec: Pop(0)
0x2ed: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2ee: Push("m") // @poff=324
0x2ef: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x2f0: Stack[-4] = (int) 0
0x2f1: Push((int) 1)
...
0x2f6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x2f7: Pop(1)
...
0x30b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x30c: Pop(1)
0x30d: PushEmpty(bool, string)
0x30e: Stack[-3] = Stack[-1]
0x30f: Call2 0x332

0x310: Stack[-2] = Stack[-14]
0x311: Pop(2)
0x312: Return(); Pop(10)

0x313: PushEmpty(bool, float, float, bool, float, float)
0x314: @ lshHasAnimation(Stack[-3], Stack[-7])
0x315: Pop(0)
0x316: Push(Stack[-3])
0x317: IF (Stack[-1] == 0) GOTO 0x31e; Pop(1)

0x318: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x319: Pop(0)
0x31a: Push((bool) 0)
...
0x31e: Push("Can't find lsh animation : ") // @poff=328
0x31f: Pop(1); Push(Stack[-1] + Stack[-8]);
0x320: @ Trace(Stack[-1])
0x321: Pop(1)
0x322: Return(); Pop(6)

0x323: PushEmpty(bool, float, float, bool, float, float)
0x324: @ lshHasAnimation(Stack[-3], Stack[-8])
0x325: Pop(0)
0x326: Push(Stack[-3])
0x327: IF (Stack[-1] == 0) GOTO 0x32d; Pop(1)

0x328: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x329: Pop(0)
0x32a: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x32b: Pop(0)
0x32c: GOTO 0x331

0x32d: Push("Can't find lsh animation : ") // @poff=328
0x32e: Pop(1); Push(Stack[-1] + Stack[-9]);
0x32f: @ Trace(Stack[-1])
0x330: Pop(1)
0x331: Return(); Pop(6)
...
0x337: @ lshHasSpeech(Stack[-1], Stack[-3])
0x338: Pop(0)
0x339: Push(Stack[-1])
0x33a: IF (Stack[-1] == 0) GOTO 0x33f; Pop(1)

0x33b: @ lshPlaySpeech(Stack[-3])
0x33c: Pop(0)
0x33d: Stack[-4] = (bool) 1
0x33e: Return(); Pop(2)

0x33f: Stack[-4] = (bool) 0
0x340: Return(); Pop(2)
...
0x349: @ self(Stack[-1])
0x34a: Pop(0)
0x34b: Stack[-1] = Stack[-3]
0x34c: Return(); Pop(2)

0x34d: Stack[-1] = 0
0x34e: PushEmpty(float, float)
0x34f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x350: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x351: Push((float)9.999999974752427e-07)
0x352: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x353: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x354: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x355: Return(); Pop(2)

0x356: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x357: Return(); Pop(2)

0x358: PushEmpty(int, int)
0x359: @ GetVariable(Stack[-3], Stack[-1])
0x35a: Pop(0)
...
0x366: PushEmpty()
0x367: Push("oob12KapellaSobor1") // @poff=384
0x368: Push((int) 1)
...
0x36c: PushEmpty()
0x36d: PushEmpty(int, string)
0x36e: Stack[-1] = "game_final" // @poff=422
0x36f: Call2 0x358
...
0x374: Stack[-2] = (bool) 1
0x375: Return(); Pop(0)

0x376: Stack[-2] = (bool) 0
0x377: Return(); Pop(0)

0x378: PushEmpty()
0x379: PushEmpty(int, string)
0x37a: Stack[-1] = "oob12KapellaSobor1" // @poff=384
0x37b: Call2 0x358
...
0x395: Stack[-1] = (int) 515538
0x396: Return(); Pop(0)

0x397: Stack[-1] = (int) 502863
0x398: Return(); Pop(0)

0x399: Stack[-1] = "ui/NPC_Kapella.png" // @poff=458
0x39a: Return(); Pop(0)

0x39b: Stack[-1] = "ui/NPC_Kapella_b.png" // @poff=496
0x39c: Return(); Pop(0)
