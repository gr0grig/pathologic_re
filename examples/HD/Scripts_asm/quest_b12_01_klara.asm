...
// @pool_raw:
// @pool_encoding:utf8
...
0x136: Stack[-1] = "Fear" // @poff=170
0x137: Call2 0xb4

0x138: Pop(1)
0x139: Push((int) 523129)
0x13a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x13b: Pop(1)
0x13c: @@@ ClearReplies(); Obj=0 // @poff=122
0x13d: Pop(0)
0x13e: Push((int) 523130)
0x13f: Push((int) -1)
0x140: Push((int) 24330)
0x141: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x142: Pop(3)
...
0x14d: Stack[-1] = "Neutral" // @poff=144
0x14e: Call2 0xb4

0x14f: Pop(1)
0x150: Push((int) 523132)
0x151: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x152: Pop(1)
0x153: @@@ ClearReplies(); Obj=0 // @poff=122
0x154: Pop(0)
0x155: Push((int) 523133)
0x156: Push((int) -1)
0x157: Push((int) 24333)
0x158: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x159: Pop(3)
...
0x164: Stack[-1] = "Saveyouall" // @poff=89
0x165: Call2 0xb4

0x166: Pop(1)
0x167: Push((int) 523115)
0x168: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x169: Pop(1)
0x16a: @@@ ClearReplies(); Obj=0 // @poff=122
0x16b: Pop(0)
0x16c: Push((int) 523116)
0x16d: Push((int) 24317)
0x16e: Push((int) 24316)
0x16f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x170: Pop(3)
0x171: Return(); Pop(0)
...
0x176: Stack[-1] = "Smile" // @poff=180
0x177: Call2 0xb4

0x178: Pop(1)
0x179: Push((int) 523117)
0x17a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x17b: Pop(1)
0x17c: @@@ ClearReplies(); Obj=0 // @poff=122
0x17d: Pop(0)
0x17e: Push((int) 523118)
0x17f: Push((int) 24319)
0x180: Push((int) 24318)
0x181: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x182: Pop(3)
0x183: Push((int) 540129)
0x184: Push((int) 24321)
0x185: Push((int) 42100)
0x186: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x187: Pop(3)
0x188: Return(); Pop(0)
...
0x18d: Stack[-1] = "Smile" // @poff=180
0x18e: Call2 0xb4

0x18f: Pop(1)
0x190: Push((int) 523119)
0x191: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x192: Pop(1)
0x193: @@@ ClearReplies(); Obj=0 // @poff=122
0x194: Pop(0)
0x195: Push((int) 523120)
0x196: Push((int) 24321)
0x197: Push((int) 24320)
0x198: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x199: Pop(3)
0x19a: Return(); Pop(0)
...
0x19f: Stack[-1] = "Smile" // @poff=180
0x1a0: Call2 0xb4

0x1a1: Pop(1)
0x1a2: Push((int) 523121)
0x1a3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1a4: Pop(1)
0x1a5: @@@ ClearReplies(); Obj=0 // @poff=122
0x1a6: Pop(0)
0x1a7: Push((int) 523122)
0x1a8: Push((int) 24323)
0x1a9: Push((int) 24322)
0x1aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1ab: Pop(3)
0x1ac: Return(); Pop(0)
...
0x1b1: Stack[-1] = "Smile" // @poff=180
0x1b2: Call2 0xb4

0x1b3: Pop(1)
0x1b4: Push((int) 523123)
0x1b5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1b6: Pop(1)
0x1b7: @@@ ClearReplies(); Obj=0 // @poff=122
0x1b8: Pop(0)
0x1b9: Push((int) 523124)
0x1ba: Push((int) -1)
0x1bb: Push((int) 24324)
0x1bc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1bd: Pop(3)
...
0x210: @@ GetPosition(Stack[-8]); Obj=20 // @poff=224
0x211: Pop(0)
0x212: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=236
0x213: Pop(0)
...
0x27f: Push("voice_common") // @poff=260
0x280: Push((int) 1)
...
0x287: Push("voice_common") // @poff=260
0x288: Push((int) 0)
...
0x29a: Push("voice_common") // @poff=260
0x29b: Push((int) 1)
...
0x2a8: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=290
0x2a9: Pop(1)
...
0x2d3: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=290
0x2d4: Pop(1)
...
0x2e8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=302
0x2e9: Pop(1)
...
0x2fb: Push("Can't find lsh animation : ") // @poff=318
...
0x30a: Push("Can't find lsh animation : ") // @poff=318
...
0x32e: Push((float)9.999999974752427e-07)
...
0x343: PushEmpty()
0x344: Push("oob12KlaraSobor1") // @poff=374
0x345: Push((int) 1)
...
0x349: PushEmpty()
0x34a: Push("oob12KlaraSobor2") // @poff=408
0x34b: Push((int) 1)
...
0x351: Stack[-1] = "game_final" // @poff=442
0x352: Call2 0x335
...
0x35d: Stack[-1] = "oob12KlaraSobor1" // @poff=374
0x35e: Call2 0x335
...
0x369: Stack[-1] = "oob12KlaraSobor2" // @poff=408
0x36a: Call2 0x335
...
0x388: Stack[-1] = "ui/NPC_Klara.png" // @poff=478
0x389: Return(); Pop(0)

0x38a: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=512
0x38b: Return(); Pop(0)
