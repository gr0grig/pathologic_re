...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b4: Stack[-8] = Stack[-2]
0x2b5: Stack[-7] = Stack[-1]
0x2b6: Call2 0x2ee
...
0x2f5: Push("player") // @poff=172
0x2f6: @ FindActor(Stack[-4]T, Stack[-1])
0x2f7: Pop(1)
...
0x30a: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x395: Pop(0)
0x396: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x397: Pop(0)
...
0x3a1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x3a2: Pop(0)
0x3a3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x3a4: Pop(0)
...
0x402: Push("Can't find lsh animation : ") // @poff=222
...
0x411: Push("Can't find lsh animation : ") // @poff=222
...
0x417: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x418: Pop(0)
...
0x431: Push((float)9.999999974752427e-07)
...
0x442: Push("Door ") // @poff=278
0x443: Pop(1); Push(Stack[-1] + Stack[-5]);
0x444: Push(" not found") // @poff=290
0x445: Pop(2); Push(Stack[-2] + Stack[-1]);
0x446: @ Trace(Stack[-1])
0x447: Pop(1)
0x448: GOTO 0x44c

0x449: Push("locked") // @poff=312
0x44a: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x44b: Pop(1)
0x44c: Return(); Pop(2)

0x44d: Stack[-1] = 0
0x44e: PushEmpty()
0x44f: Push("oob12Littleboy1") // @poff=338
0x450: Push((int) 1)
...
0x454: PushEmpty()
0x455: Push("oob12Littleboy2") // @poff=370
0x456: Push((int) 1)
...
0x45a: PushEmpty()
0x45b: Push("oob12Littleboy3") // @poff=402
0x45c: Push((int) 1)
...
0x462: Stack[-2] = "mnogogrannik@door2" // @poff=434
...
0x469: Stack[-1] = "B_Mission5" // @poff=472
0x46a: Call2 0x438
...
0x46f: Push("B_Mission5") // @poff=472
0x470: Push((int) 1)
...
0x487: PushEmpty()
0x488: Push("b12q01ChildsAreVisited") // @poff=494
0x489: Push((int) 1)
...
0x48f: Stack[-1] = "oob12Littleboy1" // @poff=338
0x490: Call2 0x438
...
0x49b: Stack[-1] = "oob12Littleboy2" // @poff=370
0x49c: Call2 0x438
...
0x4a7: Stack[-1] = "oob12Littleboy3" // @poff=402
0x4a8: Call2 0x438
...
0x4c3: Push("Can't retrieve diary root") // @poff=540
0x4c4: @ Trace(Stack[-1])
0x4c5: Pop(1)
...
0x4cf: Pop(1)
0x4d0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=592
0x4d1: Pop(0)
0x4d2: Pop(0); Push((bool) Stack[-2] == 0)
0x4d3: IF (Stack[-1] == 0) GOTO 0x4da; Pop(1)

0x4d4: Push("Can't find diary parent with id: ") // @poff=597
...
0x4da: @@ AddChild(Stack[-8]); Obj=2 // @poff=665
0x4db: Pop(0)
0x4dc: Push((int) 7)
0x4dd: @ SendWorldWndMessage(Stack[-1])
0x4de: Pop(1)
0x4df: @@ GetCategory(Stack[-1]); Obj=8 // @poff=674
0x4e0: Pop(0)
...
0x4ea: Stack[-1] = Stack[-3]
0x4eb: Pop(1)
0x4ec: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=592
0x4ed: Pop(0)
...
0x50d: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=707
0x50e: Return(); Pop(0)

0x50f: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=747
0x510: Return(); Pop(0)
