...
// @pool_raw:
// @pool_encoding:utf8
...
0x1b1: Stack[-8] = Stack[-2]
0x1b2: Stack[-7] = Stack[-1]
0x1b3: Call2 0x1eb
...
0x1f2: Push("player") // @poff=172
0x1f3: @ FindActor(Stack[-4]T, Stack[-1])
0x1f4: Pop(1)
...
0x207: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x292: Pop(0)
0x293: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x294: Pop(0)
...
0x29e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x29f: Pop(0)
0x2a0: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x2a1: Pop(0)
...
0x2c7: Pop(0)
0x2c8: Push((bool) 1)
0x2c9: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2ca: Pop(1)
0x2cb: Push(CvectorIndex(Stack[-4], 0))
0x2cc: Push(CvectorIndex(Stack[-5], 2))
0x2cd: @ Rotate(Stack[-2], Stack[-1])
0x2ce: Pop(2)
...
0x2da: @ LookAsyncCamera(Stack[-1])
0x2db: Pop(1)
0x2dc: @ CameraWaitForPlayFinish()
0x2dd: Pop(0)
0x2de: @ ResumeWorld()
0x2df: Pop(0)
0x2e0: Stack[-21] = (bool) 1
0x2e1: Return(); Pop(18)

0x2e2: PushEmpty(bool, bool)
0x2e3: Push((bool) 1)
0x2e4: @ CameraSwitchToNormal(Stack[-1])
0x2e5: Pop(1)
...
0x2ec: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2ed: Pop(1)
0x2ee: Push(Stack[-1])
0x2ef: IF (Stack[-1] == 0) GOTO 0x2f3; Pop(1)

0x2f0: Push("head") // @poff=186
...
0x2ff: Push("Can't find lsh animation : ") // @poff=222
...
0x30e: Push("Can't find lsh animation : ") // @poff=222
0x30f: Pop(1); Push(Stack[-1] + Stack[-9]);
0x310: @ Trace(Stack[-1])
0x311: Pop(1)
0x312: Return(); Pop(6)

0x313: PushEmpty(float, cvector, float, cvector)
0x314: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x315: Pop(0)
0x316: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x317: Push(CvectorIndex(Stack[-1], 1))
0x318: Stack[-3] = Stack[-1]
0x319: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x31a: Push("head") // @poff=186
0x31b: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x31c: Pop(1)
0x31d: Return(); Pop(4)
...
0x33b: @ FindActor(Stack[-1], Stack[-4])
0x33c: Pop(0)
0x33d: Pop(0); Push((bool) Stack[-1] == 0)
0x33e: IF (Stack[-1] == 0) GOTO 0x346; Pop(1)

0x33f: Push("Door ") // @poff=278
0x340: Pop(1); Push(Stack[-1] + Stack[-5]);
0x341: Push(" not found") // @poff=290
0x342: Pop(2); Push(Stack[-2] + Stack[-1]);
0x343: @ Trace(Stack[-1])
0x344: Pop(1)
0x345: GOTO 0x349

0x346: Push("locked") // @poff=312
0x347: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x348: Pop(1)
0x349: Return(); Pop(2)

0x34a: Stack[-1] = 0
0x34b: PushEmpty()
0x34c: Push("oob12Littlegirl1") // @poff=338
0x34d: Push((int) 1)
...
0x351: PushEmpty()
0x352: Push("oob12Littlegirl2") // @poff=372
0x353: Push((int) 1)
...
0x359: Stack[-2] = "mnogogrannik@door2" // @poff=406
...
0x35e: PushEmpty()
0x35f: PushEmpty(int, string)
0x360: Stack[-1] = "B_Mission5" // @poff=444
0x361: Call2 0x335

0x362: Pop(1)
0x363: Push((int) 0)
0x364: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x365: IF (Stack[-1] == 0) GOTO 0x37d; Pop(1)

0x366: Push("B_Mission5") // @poff=444
0x367: Push((int) 1)
...
0x36c: Pop(0)
0x36d: PushEmpty(bool, int)
0x36e: Stack[-1] = (int) 562
0x36f: Call2 0x3d2

0x370: Pop(2)
0x371: PushEmpty(bool, int)
0x372: Stack[-1] = (int) 563
0x373: Call2 0x3d2

0x374: Pop(2)
0x375: PushEmpty(bool, int)
0x376: Stack[-1] = (int) 564
0x377: Call2 0x3d2

0x378: Pop(2)
0x379: PushEmpty(bool, int)
0x37a: Stack[-1] = (int) 565
0x37b: Call2 0x3d2
...
0x37e: PushEmpty()
0x37f: Push("b12q01ChildsAreVisited") // @poff=466
0x380: Push((int) 1)
0x381: @ SetVariable(Stack[-2], Stack[-1])
0x382: Pop(2)
0x383: Return(); Pop(0)

0x384: PushEmpty()
0x385: PushEmpty(int, string)
0x386: Stack[-1] = "oob12Littlegirl1" // @poff=338
0x387: Call2 0x335
...
0x38c: Stack[-2] = (bool) 1
0x38d: Return(); Pop(0)

0x38e: Stack[-2] = (bool) 0
0x38f: Return(); Pop(0)

0x390: PushEmpty()
0x391: PushEmpty(int, string)
0x392: Stack[-1] = "oob12Littlegirl2" // @poff=372
0x393: Call2 0x335
...
0x39d: Push((int) 566)
0x39e: Push((int) 0)
0x39f: Push((int) 530580)
0x3a0: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x3a1: Pop(3)
0x3a2: PushEmpty(bool, object, int)
...
0x3aa: @ GetDiaryRoot(Stack[-1])
0x3ab: Pop(0)
0x3ac: Pop(0); Push((bool) Stack[-1] == 0)
0x3ad: IF (Stack[-1] == 0) GOTO 0x3b3; Pop(1)

0x3ae: Push("Can't retrieve diary root") // @poff=512
0x3af: @ Trace(Stack[-1])
0x3b0: Pop(1)
0x3b1: Stack[-3] = (bool) 0
0x3b2: Return(); Pop(2)
...
0x3b5: Stack[-1] = 0
0x3b6: PushEmpty(object, object, int, object, object, int)
0x3b7: PushEmpty(object)
0x3b8: Call2 0x3a9

0x3b9: Stack[-1] = Stack[-4]
0x3ba: Pop(1)
0x3bb: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=564
0x3bc: Pop(0)
0x3bd: Pop(0); Push((bool) Stack[-2] == 0)
0x3be: IF (Stack[-1] == 0) GOTO 0x3c5; Pop(1)

0x3bf: Push("Can't find diary parent with id: ") // @poff=569
0x3c0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3c1: @ Trace(Stack[-1])
0x3c2: Pop(1)
0x3c3: Stack[-9] = (bool) 0
0x3c4: Return(); Pop(6)

0x3c5: @@ AddChild(Stack[-8]); Obj=2 // @poff=637
0x3c6: Pop(0)
0x3c7: Push((int) 7)
0x3c8: @ SendWorldWndMessage(Stack[-1])
0x3c9: Pop(1)
0x3ca: @@ GetCategory(Stack[-1]); Obj=8 // @poff=646
0x3cb: Pop(0)
0x3cc: @ SetDiarySection(Stack[-1])
0x3cd: Pop(0)
...
0x3d0: Stack[-2] = 0
0x3d1: Stack[-3] = 0
0x3d2: PushEmpty(object, object, object, object)
0x3d3: PushEmpty(object)
0x3d4: Call2 0x3a9

0x3d5: Stack[-1] = Stack[-3]
0x3d6: Pop(1)
0x3d7: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=564
0x3d8: Pop(0)
...
0x3dd: @@ Remove(); Obj=1 // @poff=658
0x3de: Pop(0)
0x3df: Stack[-6] = (bool) 1
0x3e0: Return(); Pop(4)

0x3e1: Stack[-1] = 0
0x3e2: Stack[-2] = 0
0x3e3: PushEmpty(int, int)
0x3e4: Push("branch") // @poff=665
...
0x3f4: Stack[-1] = (int) 515561
0x3f5: Return(); Pop(0)

0x3f6: Stack[-1] = (int) 503346
0x3f7: Return(); Pop(0)

0x3f8: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=679
0x3f9: Return(); Pop(0)

0x3fa: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=719
0x3fb: Return(); Pop(0)

0x3fc: Stack[-1] = (bool) 0
0x3fd: Return(); Pop(0)

0x3fe: PushEmpty(string, string)
0x3ff: Stack[-1] = "idle" // @poff=146
0x400: Push(Stack[-3])
0x401: IF (Stack[-1] == 0) GOTO 0x403; Pop(1)

0x402: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x403: Stack[-1] = Stack[-4]
0x404: Return(); Pop(2)

0x405: PushEmpty(int, bool, int, bool)
0x406: Stack[-2] = (int) 0
0x407: Push("all") // @poff=138
...
0x411: Push((int) 1)
0x412: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x413: GOTO 0x407

0x414: Stack[-2] = Stack[-5]
0x415: Return(); Pop(4)
