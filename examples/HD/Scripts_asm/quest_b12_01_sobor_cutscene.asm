...
Strings:
	...
	W:cs_d12_sobor_danko
	W:cs_d12_danko.xml
	W:cs_d12_sobor_danko.mot
	W:cs_d12_sobor_kapella
	W:cs_d12_kapella.xml
	W:cs_d12_sobor_kapella.mot
	W:quest_b12_01
...
// @pool_raw:
...
0x4b: Stack[-2] = "cs_d12_sobor_danko" // @poff=356
0x4c: Stack[-1] = "cs_d12_danko.xml" // @poff=394
0x4d: Call2 0xc3
...
0x51: Pop(0)
0x52: Push("cs_d12_sobor_danko.mot") // @poff=428
...
0x5e: Stack[-2] = "cs_d12_sobor_kapella" // @poff=474
0x5f: Stack[-1] = "cs_d12_kapella.xml" // @poff=516
0x60: Call2 0xc3
...
0x64: Pop(0)
0x65: Push("cs_d12_sobor_kapella.mot") // @poff=554
...
0x78: Stack[-2] = "quest_b12_01" // @poff=604
0x79: Stack[-1] = "sobor_cutscene_end" // @poff=630
0x7a: Call2 0xcb
...
0x96: Push("noaccess") // @poff=682
0x97: @@ HasProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=700
0x98: Pop(1)
0x99: Push(Stack[-2])
0x9a: IF (Stack[-1] == 0) GOTO 0xa4; Pop(1)

0x9b: Push("noaccess") // @poff=682
0x9c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=712
0x9d: Pop(1)
0x9e: Push("noaccess") // @poff=682
0x9f: Push((int) 1)
0xa0: Pop(1); Push(Stack[-3] + Stack[-1]);
0xa1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=724
0xa2: Pop(2)
0xa3: GOTO 0xa8

0xa4: Push("noaccess") // @poff=682
0xa5: Push((int) 1)
0xa6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=724
0xa7: Pop(2)
0xa8: Return(); Pop(4)
...
0xad: Push("noaccess") // @poff=682
0xae: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=712
0xaf: Pop(1)
0xb0: Push((int) 1)
0xb1: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0xb2: IF (Stack[-1] == 0) GOTO 0xb9; Pop(1)

0xb3: Push("noaccess") // @poff=682
0xb4: Push((int) 1)
0xb5: Pop(1); Push(Stack[-3] - Stack[-1]);
0xb6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=724
0xb7: Pop(2)
0xb8: GOTO 0xbc

0xb9: Push("noaccess") // @poff=682
0xba: @@ RemoveProperty(Stack[-1]); Obj=4 // @poff=736
0xbb: Pop(1)
0xbc: Return(); Pop(2)
...
0xe2: Push("b12q01KlaraInSobor") // @poff=751
...
0xe9: Push("b12q01DankoInSobor") // @poff=789
