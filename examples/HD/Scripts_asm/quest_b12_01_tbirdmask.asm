...
// @pool_raw:
// @pool_encoding:utf8
...
0x1f8: Stack[-8] = Stack[-2]
0x1f9: Stack[-7] = Stack[-1]
0x1fa: Call2 0x232
...
0x239: Push("player") // @poff=172
0x23a: @ FindActor(Stack[-4]T, Stack[-1])
0x23b: Pop(1)
...
0x24e: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2d9: Pop(0)
0x2da: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x2db: Pop(0)
...
0x2e5: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x2e6: Pop(0)
0x2e7: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x2e8: Pop(0)
...
0x30e: Pop(0)
0x30f: Push((bool) 1)
0x310: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x311: Pop(1)
0x312: Push(CvectorIndex(Stack[-4], 0))
0x313: Push(CvectorIndex(Stack[-5], 2))
0x314: @ Rotate(Stack[-2], Stack[-1])
0x315: Pop(2)
...
0x31c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x31d: Pop(1)
0x31e: Push(Stack[-1])
0x31f: IF (Stack[-1] == 0) GOTO 0x323; Pop(1)

0x320: Push("head") // @poff=186
0x321: @ LookAsyncCamera(Stack[-1])
0x322: Pop(1)
0x323: @ CameraWaitForPlayFinish()
0x324: Pop(0)
0x325: @ ResumeWorld()
0x326: Pop(0)
0x327: Stack[-21] = (bool) 1
0x328: Return(); Pop(18)

0x329: PushEmpty(bool, bool)
0x32a: Push((bool) 1)
0x32b: @ CameraSwitchToNormal(Stack[-1])
0x32c: Pop(1)
...
0x332: Push("head") // @poff=186
0x333: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x334: Pop(1)
0x335: Push(Stack[-1])
...
0x33b: PushEmpty(bool, float, float, bool, float, float)
0x33c: @ lshHasAnimation(Stack[-3], Stack[-7])
0x33d: Pop(0)
0x33e: Push(Stack[-3])
0x33f: IF (Stack[-1] == 0) GOTO 0x346; Pop(1)

0x340: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x341: Pop(0)
0x342: Push((bool) 0)
0x343: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x344: Pop(1)
0x345: GOTO 0x34a

0x346: Push("Can't find lsh animation : ") // @poff=222
0x347: Pop(1); Push(Stack[-1] + Stack[-8]);
0x348: @ Trace(Stack[-1])
0x349: Pop(1)
0x34a: Return(); Pop(6)

0x34b: PushEmpty(bool, float, float, bool, float, float)
0x34c: @ lshHasAnimation(Stack[-3], Stack[-8])
0x34d: Pop(0)
0x34e: Push(Stack[-3])
0x34f: IF (Stack[-1] == 0) GOTO 0x355; Pop(1)

0x350: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x351: Pop(0)
0x352: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x353: Pop(0)
0x354: GOTO 0x359

0x355: Push("Can't find lsh animation : ") // @poff=222
0x356: Pop(1); Push(Stack[-1] + Stack[-9]);
0x357: @ Trace(Stack[-1])
0x358: Pop(1)
0x359: Return(); Pop(6)

0x35a: PushEmpty(float, cvector, float, cvector)
0x35b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x35c: Pop(0)
0x35d: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x35e: Push(CvectorIndex(Stack[-1], 1))
0x35f: Stack[-3] = Stack[-1]
0x360: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x361: Push("head") // @poff=186
0x362: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x363: Pop(1)
0x364: Return(); Pop(4)
...
0x373: Pop(0); Push(Stack[-3] | Stack[-3]);
0x374: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x375: Push((float)9.999999974752427e-07)
0x376: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x377: IF (Stack[-1] == 0) GOTO 0x37a; Pop(1)

0x378: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x379: Return(); Pop(2)

0x37a: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x37b: Return(); Pop(2)

0x37c: PushEmpty(int, int)
0x37d: @ GetVariable(Stack[-3], Stack[-1])
0x37e: Pop(0)
0x37f: Stack[-1] = Stack[-4]
0x380: Return(); Pop(2)

0x381: PushEmpty(object, object)
0x382: @ FindActor(Stack[-1], Stack[-4])
0x383: Pop(0)
0x384: Pop(0); Push((bool) Stack[-1] == 0)
0x385: IF (Stack[-1] == 0) GOTO 0x38d; Pop(1)

0x386: Push("Door ") // @poff=278
0x387: Pop(1); Push(Stack[-1] + Stack[-5]);
0x388: Push(" not found") // @poff=290
0x389: Pop(2); Push(Stack[-2] + Stack[-1]);
0x38a: @ Trace(Stack[-1])
0x38b: Pop(1)
0x38c: GOTO 0x390

0x38d: Push("locked") // @poff=312
0x38e: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x38f: Pop(1)
0x390: Return(); Pop(2)
...
0x3aa: PushEmpty()
0x3ab: Push("oob12TBirdmask1") // @poff=338
0x3ac: Push((int) 1)
...
0x3b0: PushEmpty()
0x3b1: PushEmpty(string, bool)
0x3b2: Stack[-2] = "itheater@door1" // @poff=370
...
0x3b7: PushEmpty()
0x3b8: Push("b12q01TheaterIsVisited") // @poff=400
0x3b9: Push((int) 1)
...
0x3bf: Stack[-1] = "oob12TBirdmask1" // @poff=338
0x3c0: Call2 0x37c
...
0x3da: Stack[-1] = (int) 515571
0x3db: Return(); Pop(0)

0x3dc: Stack[-1] = (int) 504029
0x3dd: Return(); Pop(0)

0x3de: Stack[-1] = "ui/NPC_bmask.png" // @poff=460
0x3df: Return(); Pop(0)

0x3e0: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=494
0x3e1: Return(); Pop(0)
