...
// @pool_raw:
// @pool_encoding:utf8
...
0x18c: Stack[-8] = Stack[-2]
0x18d: Stack[-7] = Stack[-1]
0x18e: Call2 0x1c6
...
0x1cd: Push("player") // @poff=172
0x1ce: @ FindActor(Stack[-4]T, Stack[-1])
0x1cf: Pop(1)
...
0x1e2: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x26d: Pop(0)
0x26e: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x26f: Pop(0)
...
0x279: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x27a: Pop(0)
0x27b: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x27c: Pop(0)
...
0x2da: Push("Can't find lsh animation : ") // @poff=222
...
0x2ef: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2f0: Pop(0)
...
0x31a: Push("Door ") // @poff=278
0x31b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x31c: Push(" not found") // @poff=290
0x31d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x31e: @ Trace(Stack[-1])
0x31f: Pop(1)
0x320: GOTO 0x324

0x321: Push("locked") // @poff=312
0x322: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x323: Pop(1)
0x324: Return(); Pop(2)
...
0x33e: PushEmpty()
0x33f: Push("oob12TWhitemask1") // @poff=338
0x340: Push((int) 1)
...
0x346: Stack[-2] = "itheater@door1" // @poff=372
...
0x34b: PushEmpty()
0x34c: Push("b12q01TheaterIsVisited") // @poff=402
0x34d: Push((int) 1)
...
0x353: Stack[-1] = "oob12TWhitemask1" // @poff=338
0x354: Call2 0x310
...
0x372: Stack[-1] = "ui/NPC_wmask.png" // @poff=462
0x373: Return(); Pop(0)

0x374: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=496
0x375: Return(); Pop(0)
