...
Strings:
	...
	W:remove2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x19a: Push("player") // @poff=156
0x19b: @ FindActor(Stack[-4]T, Stack[-1])
0x19c: Pop(1)
...
0x1af: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x23a: Pop(0)
0x23b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x23c: Pop(0)
...
0x246: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x247: Pop(0)
0x248: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x249: Pop(0)
...
0x26f: Pop(0)
0x270: Push((bool) 1)
0x271: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x272: Pop(1)
...
0x28b: Push((bool) 1)
0x28c: @ CameraSwitchToNormal(Stack[-1])
0x28d: Pop(1)
...
0x293: Push("head") // @poff=170
0x294: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x295: Pop(1)
0x296: Push(Stack[-1])
0x297: IF (Stack[-1] == 0) GOTO 0x29b; Pop(1)

0x298: Push("head") // @poff=170
0x299: @ UnlookAsync(Stack[-1])
0x29a: Pop(1)
0x29b: Return(); Pop(2)

0x29c: PushEmpty(bool, float, float, bool, float, float)
0x29d: @ lshHasAnimation(Stack[-3], Stack[-7])
0x29e: Pop(0)
0x29f: Push(Stack[-3])
0x2a0: IF (Stack[-1] == 0) GOTO 0x2a7; Pop(1)

0x2a1: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2a2: Pop(0)
0x2a3: Push((bool) 0)
0x2a4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2a5: Pop(1)
0x2a6: GOTO 0x2ab

0x2a7: Push("Can't find lsh animation : ") // @poff=206
0x2a8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2a9: @ Trace(Stack[-1])
0x2aa: Pop(1)
0x2ab: Return(); Pop(6)

0x2ac: PushEmpty(bool, float, float, bool, float, float)
0x2ad: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2ae: Pop(0)
0x2af: Push(Stack[-3])
0x2b0: IF (Stack[-1] == 0) GOTO 0x2b6; Pop(1)

0x2b1: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2b2: Pop(0)
0x2b3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2b4: Pop(0)
0x2b5: GOTO 0x2ba

0x2b6: Push("Can't find lsh animation : ") // @poff=206
0x2b7: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2b8: @ Trace(Stack[-1])
0x2b9: Pop(1)
0x2ba: Return(); Pop(6)

0x2bb: PushEmpty(float, cvector, float, cvector)
0x2bc: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2bd: Pop(0)
0x2be: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x2bf: Push(CvectorIndex(Stack[-1], 1))
0x2c0: Stack[-3] = Stack[-1]
0x2c1: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2c2: Push("head") // @poff=170
0x2c3: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2c4: Pop(1)
0x2c5: Return(); Pop(4)
...
0x2ce: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2cf: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2d0: Push((float)9.999999974752427e-07)
0x2d1: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2d2: IF (Stack[-1] == 0) GOTO 0x2d5; Pop(1)

0x2d3: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2d4: Return(); Pop(2)

0x2d5: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2d6: Return(); Pop(2)

0x2d7: PushEmpty(int, int)
0x2d8: @ GetVariable(Stack[-3], Stack[-1])
0x2d9: Pop(0)
0x2da: Stack[-1] = Stack[-4]
0x2db: Return(); Pop(2)

0x2dc: PushEmpty(object, object)
0x2dd: @ FindActor(Stack[-1], Stack[-4])
0x2de: Pop(0)
0x2df: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2e0: IF (Stack[-1] == 0) GOTO 0x2e3; Pop(1)

0x2e1: Stack[-5] = (bool) 0
0x2e2: Return(); Pop(2)

0x2e3: @ Trigger(Stack[-1], Stack[-3])
0x2e4: Pop(0)
0x2e5: Stack[-5] = (bool) 1
0x2e6: Return(); Pop(2)

0x2e7: Stack[-1] = 0
0x2e8: Stack[-1] = (int) 515571
0x2e9: Return(); Pop(0)

0x2ea: Stack[-1] = (int) 504029
0x2eb: Return(); Pop(0)

0x2ec: Stack[-1] = "ui/NPC_bmask.png" // @poff=262
0x2ed: Return(); Pop(0)

0x2ee: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=296
0x2ef: Return(); Pop(0)

0x2f0: Stack[-1] = (bool) 0
0x2f1: Return(); Pop(0)

0x2f2: PushEmpty(string, string)
0x2f3: Stack[-1] = "idle" // @poff=146
0x2f4: Push(Stack[-3])
0x2f5: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f6: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2f7: Stack[-1] = Stack[-4]
0x2f8: Return(); Pop(2)

0x2f9: PushEmpty(int, bool, int, bool)
0x2fa: Stack[-2] = (int) 0
...
0x305: Push((int) 1)
0x306: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x307: GOTO 0x2fb

0x308: Stack[-2] = Stack[-5]
0x309: Return(); Pop(4)

0x30a: PushEmpty()
0x30b: Push("oob1Birdmask2_1") // @poff=334
0x30c: Push((int) 1)
0x30d: @ SetVariable(Stack[-2], Stack[-1])
0x30e: Pop(2)
0x30f: PushEmpty(bool, string, string)
0x310: Stack[-2] = "quest_b1_01" // @poff=366
0x311: Stack[-1] = "remove2" // @poff=390
0x312: Call2 0x2dc
...
0x317: Stack[-1] = "oob1Birdmask2_1" // @poff=334
0x318: Call2 0x2d7
