...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2b4: Push("Can't find lsh animation : ") // @poff=206
...
0x2c3: Push("Can't find lsh animation : ") // @poff=206
...
0x2fa: Stack[-1] = "ui/NPC_wmask.png" // @poff=262
0x2fb: Return(); Pop(0)

0x2fc: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=296
0x2fd: Return(); Pop(0)
...
0x318: PushEmpty()
0x319: Push("oob1WhiteMask1") // @poff=334
0x31a: Push((int) 1)
...
0x322: Pop(1)
0x323: Push("b1BigVlad11Hours") // @poff=364
0x324: Push("pt_map_bigvlad") // @poff=398
0x325: Push((int) 3)
...
0x329: Pop(0)
0x32a: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=428
0x32b: Pop(5)
0x32c: Return(); Pop(2)
...
0x33a: Stack[-1] = "oob1WhiteMask1" // @poff=334
0x33b: Call2 0x2e4
...
0x354: Push("Can't find main outdoor scene") // @poff=436
0x355: @ Trace(Stack[-1])
0x356: Pop(1)
0x357: Stack[-1] = 0
...
0x35a: @@ GetMap(Stack[-1]); Obj=2 // @poff=496
0x35b: Pop(0)
0x35c: Stack[-1] = Stack[-5]
0x35d: Return(); Pop(4)

0x35e: Stack[-1] = 0
0x35f: Stack[-2] = 0
0x360: PushEmpty(int, int)
0x361: Push("branch") // @poff=503
