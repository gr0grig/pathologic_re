...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x5: Stack[-6] = Stack[-4]
0x6: Stack[-3] = "pt_b1q02_agony" // @poff=18
0x7: Stack[-2] = "pers_worker" // @poff=48
0x8: Stack[-1] = "b1q02_agony.xml" // @poff=72
0x9: Call2 0x8a
...
0x8b: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=282
0x8c: Pop(0)
0x8d: Pop(0); Push((bool) Stack[-4] == 0)
0x8e: IF (Stack[-1] == 0) GOTO 0x97; Pop(1)

0x8f: Push("Locator ") // @poff=293
0x90: Pop(1); Push(Stack[-1] + Stack[-12]);
0x91: Push(" doesn't exist") // @poff=311
