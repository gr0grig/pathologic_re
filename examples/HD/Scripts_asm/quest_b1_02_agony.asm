...
0x11: Stack[-2] = "quest_b1_02" // @poff=0
0x12: Stack[-1] = "agony_dead" // @poff=24
0x13: Call2 0x156
...
0x35: Stack[-1] = (float) 0.3333333432674408
0x36: Call2 0x124
...
0x3b: Push("agony") // @poff=46
0x3c: Push(CVector(0.0, 40.0, 0.0))
0x3d: @ PlayGlobalSound(Stack[-2], Stack[-1])
0x3e: Pop(2)
0x3f: Push("all") // @poff=58
0x40: Push("agony") // @poff=46
...
0x52: @ WaitForAnimEnd()
0x53: Pop(0)
0x54: Push("all") // @poff=58
0x55: Push("agony_sleep") // @poff=78
...
0x78: Stack[-8] = Stack[-2]
0x79: Stack[-1] = (float) -0.30000001192092896
0x7a: Call2 0x129

0x7b: Pop(3)
0x7c: Push("death") // @poff=102
...
0x84: @ WaitForAnimEnd()
0x85: Pop(0)
0x86: Push("all") // @poff=58
0x87: Push("agony_die") // @poff=114
...
0xb3: Push("HasProperty") // @poff=134
0xb4: Push((int) 2)
...
0xba: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=158
0xbb: Pop(0)
...
0xc0: Stack[-10] = Stack[-2]
0xc1: Stack[-9] = Stack[-1]
0xc2: Call2 0xb2
...
0xc8: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=170
0xc9: Pop(0)
...
0xe3: @@ GetPosition(Stack[-5]); Obj=15 // @poff=194
0xe4: Pop(0)
...
0xf4: Stack[-1] = "fhit" // @poff=206
0xf5: GOTO 0xf7

0xf6: Stack[-1] = "bhit" // @poff=216
0xf7: Push("hit_react") // @poff=226
0xf8: Push("1") // @poff=246
...
0x143: Stack[-8] = Stack[-5]
0x144: Stack[-4] = "reputation" // @poff=296
0x145: Stack[-7] = Stack[-3]
0x146: Stack[-2] = (int) 0
0x147: Stack[-1] = (int) 1
0x148: Call2 0xbe
...
0x14e: Pop(0)
0x14f: @@ add(Stack[-3]); Obj=1 // @poff=318
0x150: Pop(0)
0x151: Push((int) 16)
...
0x158: Pop(0)
0x159: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x171: Stack[-11] = Stack[-5]
0x172: Stack[-10] = Stack[-4]
0x173: Stack[-9] = Stack[-3]
0x174: Stack[-7] = Stack[-2]
