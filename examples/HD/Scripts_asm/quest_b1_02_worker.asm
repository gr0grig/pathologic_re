...
Strings:
	...
	W:oob1Worker1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2ec: Push("Can't find lsh animation : ") // @poff=208
...
0x2fb: Push("Can't find lsh animation : ") // @poff=208
...
0x31e: Pop(0)
0x31f: @@ add(Stack[-4]); Obj=1 // @poff=264
0x320: Pop(0)
0x321: @@ add(Stack[-3]); Obj=1 // @poff=264
0x322: Pop(0)
0x323: Push((int) 3)
...
0x329: @@ GetItemID(Stack[-3]); Obj=8 // @poff=268
0x32a: Pop(0)
0x32b: Push("Category") // @poff=278
0x32c: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x32d: Pop(1)
0x32e: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=296
0x32f: Pop(0)
0x330: Pop(0); Push((bool) Stack[-1] == 0)
0x331: IF (Stack[-1] == 0) GOTO 0x335; Pop(1)

0x332: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=304
0x333: Pop(0)
0x334: GOTO 0x33a

0x335: PushEmpty(int, int)
0x336: Stack[-5] = Stack[-2]
0x337: Stack[-9] = Stack[-1]
0x338: Call2 0x31c
...
0x357: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=314
0x358: Return(); Pop(0)

0x359: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=354
0x35a: Return(); Pop(0)
...
0x35d: PushEmpty()
0x35e: Push("playsound") // @poff=398
0x35f: Push("giveitem") // @poff=418
0x360: @ TriggerWorld(Stack[-2], Stack[-1])
0x361: Pop(2)
0x362: Return(); Pop(0)

0x363: PushEmpty()
0x364: Push("oob1Worker2") // @poff=436
0x365: Push((int) 1)
...
0x369: PushEmpty()
0x36a: Push("oob1Worker3") // @poff=460
0x36b: Push((int) 1)
...
0x370: Push("Knife is given") // @poff=484
0x371: @ Trace(Stack[-1])
0x372: Pop(1)
0x373: @ CreateInvItem(Stack[-1])
0x374: Pop(0)
0x375: Push("Knife") // @poff=514
0x376: @@ SetItemName(Stack[-1]); Obj=2 // @poff=526
0x377: Pop(1)
0x378: Push("durability") // @poff=538
0x379: Push((int) 70)
0x37a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=560
0x37b: Pop(2)
0x37c: PushEmpty(object, object, int)
0x37d: Stack[-7] = Stack[-3]
0x37e: Stack[-4] = Stack[-2]
0x37f: Stack[-1] = (int) 1
0x380: Call2 0x328
...
0x383: Stack[-1] = 0
0x384: PushEmpty()
0x385: Push("oob1Worker1") // @poff=572
0x386: Push((int) 1)
...
0x38c: Stack[-1] = "oob1Worker2" // @poff=436
0x38d: Call2 0x317
...
0x398: Stack[-1] = "oob1Worker3" // @poff=460
0x399: Call2 0x317
...
0x3a4: Stack[-1] = "oob1Worker1" // @poff=572
0x3a5: Call2 0x317
