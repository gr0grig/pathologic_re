...
Strings:
	...
	W:quest_b1_03
	W:doberman_dead
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0xa3c Vars = (object, int, float, float)
EVENT_43 Op = 0xa44 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xa4e Vars = (object, string)
EVENT_41 Op = 0xa5b Vars = (object)
...
0xf2: Stack[-1] = "Neutral" // @poff=89
0xf3: Call2 0x84

0xf4: Pop(1)
0xf5: Push((int) 519591)
0xf6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xf7: Pop(1)
0xf8: @@@ ClearReplies(); Obj=0 // @poff=116
0xf9: Pop(0)
...
0x197: Stack[-6] = Stack[-2]
0x198: Stack[-1] = (float) 0.05000000074505806
0x199: Call2 0x966
...
0x22a: Pop(0)
0x22b: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=156
0x22c: Pop(0)
...
0x249: Stack[-1] = (float) 1.7453293800354004
0x24a: Call2 0x228

0x24b: Stack[-2] = Stack[-7]
0x24c: Pop(2)
...
0x252: Stack[-1] = (float) 2.6179938316345215
0x253: Call2 0x228

0x254: Stack[-2] = Stack[-7]
0x255: Pop(2)
...
0x25a: Push("Can't retreat, distance: ") // @poff=168
...
0x270: Push((int) 1)
0x271: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x272: Pop(1)
0x273: Push(Stack[-3])
0x274: IF (Stack[-1] == 0) GOTO 0x28c; Pop(1)

0x275: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x27a: Stack[-1] = (float) 2.6179938316345215
0x27b: Call2 0x228

0x27c: Stack[-2] = Stack[-4]
0x27d: Pop(2)
...
0x28d: IF (Stack[-1] == 1) GOTO 0x270; Pop(1)
...
0x294: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2a3: Stack[-1] = (float) 1.7453293800354004
0x2a4: Call2 0x228
...
0x2b3: IF (Stack[-1] == 1) GOTO 0x2b9; Pop(1)

0x2b4: PushEmpty(bool)
0x2b5: Call2 0x2d3

0x2b6: Pop(0)
0x2b7: IF (Stack[-1] == 1) GOTO 0x2b9; Pop(1)
...
0x2d9: Stack[-2] = Stack[-3]
0x2da: Pop(2)
0x2db: PushEmpty(float, cvector, cvector)
0x2dc: Stack[-5] = Stack[-2]
0x2dd: Stack[-4] = Stack[-1]
0x2de: Call2 0x95e

0x2df: Pop(2)
0x2e0: Push((float)-0.3420201241970062)
...
0x2e8: Pop(0)
0x2e9: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=220
0x2ea: Pop(1)
0x2eb: PushEmpty(object, bool, float)
0x2ec: Stack[-7] = Stack[-3]
0x2ed: Stack[-6] = Stack[-2]
...
0x2f6: Stack[-1] = 0
0x2f7: PushEmpty()
0x2f8: Stack[-3] = (float) 0.029999999329447746
0x2f9: Return(); Pop(0)
...
0x312: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x313: Pop(0)
0x314: Push(Stack[-8])
0x315: IF (Stack[-1] == 0) GOTO 0x31e; Pop(1)

0x316: Push("attack") // @poff=298
...
0x332: Pop(0)
0x333: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=312
0x334: Pop(0)
...
0x34e: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=312
0x34f: Pop(0)
...
0x382: IF (Stack[-1] == 1) GOTO 0x388; Pop(1)

0x383: PushEmpty(bool)
0x384: Call2 0x554

0x385: Pop(0)
0x386: IF (Stack[-1] == 1) GOTO 0x388; Pop(1)

0x387: Stack[-1] = (bool) 0
0x388: IF (Stack[-1] == 0) GOTO 0x399; Pop(1)

0x389: @ Face(Stack[-0]T)
0x38a: Pop(0)
0x38b: PushEmpty()
0x38c: Call2 0x586

0x38d: Pop(0)
0x38e: Push("all") // @poff=138
0x38f: Push("attack_stay") // @poff=346
0x390: @ PlayAnimation(Stack[-2], Stack[-1])
0x391: Pop(2)
0x392: PushEmpty(bool, float)
0x393: Stack[-25] = Stack[-1]
0x394: Call2 0x4d0
...
0x399: @ Face(Stack[-0]T)
0x39a: Pop(0)
0x39b: Push("all") // @poff=138
0x39c: Push("fjump") // @poff=370
...
0x3b7: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=312
0x3b8: Pop(0)
...
0x3d6: Push("all") // @poff=138
0x3d7: Push("attack_off") // @poff=382
...
0x3e4: Push("all") // @poff=138
0x3e5: Push("attack_begin") // @poff=404
0x3e6: Push((int) 1)
0x3e7: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3f2: Push("attack") // @poff=298
0x3f3: Push((int) 1)
0x3f4: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x406: Push((float)0.8999999761581421)
0x407: Pop(1); Push(Stack[-9] * Stack[-1]);
0x408: @ GetVictim(Stack[-1], Stack[-4])
0x409: Pop(1)
0x40a: @ ReportAttack(Stack[-0]T)
0x40b: Pop(0)
...
0x40f: Stack[-6] = Stack[-2]
0x410: Stack[-10] = Stack[-1]
0x411: Call2 0x2f7

0x412: Stack[-3] = Stack[-5]
0x413: Pop(3)
0x414: PushEmpty(float, object, float, int)
0x415: Stack[-7] = Stack[-3]
0x416: Stack[-6] = Stack[-2]
0x417: PushEmpty(int, object, int)
0x418: Stack[-10] = Stack[-2]
0x419: Stack[-14] = Stack[-1]
0x41a: Call2 0x2fa

0x41b: Stack[-3] = Stack[-4]
0x41c: Pop(3)
0x41d: Call2 0x773

0x41e: Stack[-4] = Stack[-5]
0x41f: Pop(4)
0x420: PushEmpty(int)
0x421: Call2 0x584

0x422: Pop(0)
0x423: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x424: Pop(1)
0x425: PushEmpty(object, float)
0x426: Stack[-5] = Stack[-2]
...
0x42f: Pop(0)
0x430: @ irand(Stack[-4], Stack[-1]T)
0x431: Pop(0)
0x432: Push((int) 1)
0x433: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x434: @ Face(Stack[-0]T)
0x435: Pop(0)
0x436: Push((bool) 1)
...
0x43b: Pop(0)
0x43c: Push("all") // @poff=138
0x43d: Push("attack_begin") // @poff=404
...
0x452: Stack[-6] = Stack[-1]
0x453: Call2 0x405

0x454: Pop(2)
0x455: Push("all") // @poff=138
0x456: Push("attack_middle") // @poff=442
...
0x45e: Pop(0)
0x45f: Push("all") // @poff=138
0x460: Push("attack_middle") // @poff=442
...
0x474: Stack[-11] = Stack[-2]
0x475: Stack[-6] = Stack[-1]
0x476: Call2 0x405

0x477: Pop(2)
0x478: Stack[-2] = (int) 1
0x479: Push("attack_middle") // @poff=442
0x47a: Pop(1); Push(Stack[-1] + Stack[-5]);
0x47b: Push("_") // @poff=470
...
0x4a3: Pop(1)
0x4a4: Push("all") // @poff=138
0x4a5: Push("attack_end") // @poff=474
...
0x4e4: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=312
0x4e5: Pop(0)
...
0x530: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x531: Pop(1)
...
0x535: @ Face(Stack[-0]T)
0x536: Pop(0)
0x537: Push("all") // @poff=138
0x538: Push("bjump") // @poff=430
0x539: @ PlayAnimation(Stack[-2], Stack[-1])
0x53a: Pop(2)
0x53b: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=312
0x53c: Pop(0)
...
0x572: @ irand(Stack[-1], Stack[-2]T)
0x573: Pop(0)
0x574: Push((int) 1)
0x575: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x576: Push("attack") // @poff=298
...
0x587: Stack[-1] = "attack_stay" // @poff=346
0x588: Call2 0x913
...
0x5b2: Stack[-15] = Stack[-5]
0x5b3: Stack[-14] = Stack[-4]
0x5b4: Stack[-13] = Stack[-3]
0x5b5: Stack[-12] = Stack[-2]
0x5b6: Stack[-11] = Stack[-1]
0x5b7: Call2 0x5fc

0x5b8: Stack[-6] = Stack[-7]
0x5b9: Pop(6)
0x5ba: Push( Stack[2 + Tasks[-1].StackPointer] )
0x5bb: IF (Stack[-1] == 0) GOTO 0x5bf; Pop(1)

0x5bc: Push("head") // @poff=532
0x5bd: @ UnlookAsync(Stack[-1])
0x5be: Pop(1)
0x5bf: Push((int) 1)
0x5c0: @ KillTimer(Stack[-1])
0x5c1: Pop(1)
0x5c2: Stack[-1] = Stack[-10]
0x5c3: Return(); Pop(4)
...
0x5ff: Stack[-17] = Stack[-7]
0x600: PushEmpty(bool, object)
0x601: Stack[-23] = Stack[-1]
0x602: Call2 0x688
...
0x608: @@ GetPosition(Stack[-5]); Obj=21 // @poff=156
0x609: Pop(0)
...
0x61f: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=312
0x620: Pop(0)
...
0x631: Push((int) 0)
0x632: Push((float)0.30000001192092896)
...
0x654: Push((int) 0)
0x655: Push((float)0.30000001192092896)
...
0x68f: Stack[-1] = "walk" // @poff=542
0x690: Return(); Pop(0)

0x691: Stack[-1] = "run" // @poff=552
0x692: Return(); Pop(0)

0x693: PushEmpty(bool, bool)
0x694: Push("powder") // @poff=560
0x695: Push((int) 0)
0x696: Push((int) 1)
0x697: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x698: Pop(3)
0x699: PushEmpty(object)
0x69a: Stack[-4] = Stack[-1]
0x69b: Call2 0x69e
...
0x6b8: Pop(0); PushNull((bool) Stack[-21] == 0)
0x6b9: IF (Stack[-1] == 0) GOTO 0x6bf; Pop(1)

0x6ba: PushEmpty(string)
0x6bb: Stack[-1] = "fdie" // @poff=574
0x6bc: Call2 0x712

0x6bd: Pop(1)
0x6be: GOTO 0x711

0x6bf: @@ GetPosition(Stack[-10]); Obj=21 // @poff=156
0x6c0: Pop(0)
...
0x6d0: Stack[-6] = "fdie" // @poff=574
0x6d1: GOTO 0x6d3

0x6d2: Stack[-6] = "bdie" // @poff=584
...
0x6d9: @ StopAsync()
0x6da: Pop(0)
0x6db: Stack[-21] = Stack[-5]
0x6dc: Push("GetScriptProperty") // @poff=594
0x6dd: Push((int) 2)
0x6de: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x6df: IF (Stack[-1] == 0) GOTO 0x6eb; Pop(1)

0x6e0: Push("Owner") // @poff=630
0x6e1: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=642
0x6e2: Pop(1)
0x6e3: Push(Stack[-4])
0x6e4: IF (Stack[-1] == 0) GOTO 0x6eb; Pop(1)

0x6e5: Push("Owner") // @poff=630
0x6e6: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=660
0x6e7: Pop(1)
0x6e8: Pop(0); PushNull((bool) Stack[-5] == 0)
0x6e9: IF (Stack[-1] == 0) GOTO 0x6eb; Pop(1)

0x6ea: Stack[-21] = Stack[-5]
0x6eb: Push("@GetEyesHeight") // @poff=678
0x6ec: Push((int) 1)
0x6ed: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x6ee: IF (Stack[-1] == 0) GOTO 0x6fa; Pop(1)

0x6ef: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=708
0x6f0: Pop(0)
...
0x6fc: Stack[-7] = Stack[-1]
0x6fd: Call2 0x913

0x6fe: Pop(1)
0x6ff: Push("all") // @poff=138
...
0x706: @ StopAsync()
0x707: Pop(0)
0x708: Push("head") // @poff=532
0x709: @ UnlookAsync(Stack[-1])
0x70a: Pop(1)
0x70b: Push("all") // @poff=138
...
0x73c: Stack[-2] = "bullet" // @poff=732
0x73d: Return(); Pop(0)

0x73e: Stack[-2] = "phys" // @poff=746
0x73f: Return(); Pop(0)
...
0x747: Pop(0)
0x748: @@ GetPosition(Stack[-1]); Obj=5 // @poff=156
0x749: Pop(0)
...
0x74e: Pop(0)
0x74f: Stack[-1] = Stack[-4]
0x750: Return(); Pop(2)

0x751: PushEmpty(bool, bool)
0x752: Push("HasProperty") // @poff=756
0x753: Push((int) 2)
...
0x759: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=780
0x75a: Pop(0)
0x75b: Stack[-1] = Stack[-5]
0x75c: Return(); Pop(2)

0x75d: PushEmpty(float, float)
0x75e: PushEmpty(bool, object, string)
0x75f: Stack[-10] = Stack[-2]
0x760: Stack[-9] = Stack[-1]
0x761: Call2 0x751
...
0x767: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=792
0x768: Pop(0)
0x769: PushEmpty(float, float, float, float)
0x76a: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x76b: Stack[-8] = Stack[-2]
0x76c: Stack[-7] = Stack[-1]
0x76d: Call2 0x953

0x76e: Pop(3)
0x76f: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=804
0x770: Pop(1)
...
0x775: Stack[-18] = Stack[-2]
0x776: Stack[-1] = "health" // @poff=816
0x777: Call2 0x751
...
0x77e: Stack[-18] = Stack[-2]
0x77f: Stack[-1] = "armor" // @poff=830
0x780: Call2 0x751
...
0x786: Push("armor") // @poff=830
0x787: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=792
0x788: Pop(1)
0x789: Push("armor_") // @poff=842
0x78a: PushEmpty(string, int)
0x78b: Stack[-16] = Stack[-1]
0x78c: Call2 0x732

0x78d: Pop(1)
0x78e: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x78f: PushEmpty(bool, object, string)
0x790: Stack[-18] = Stack[-2]
0x791: Stack[-8] = Stack[-1]
0x792: Call2 0x751
...
0x798: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=792
0x799: Pop(0)
...
0x7a0: Stack[-3] = Stack[-6]
0x7a1: Pop(3)
0x7a2: Push("health") // @poff=816
0x7a3: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=792
0x7a4: Pop(1)
0x7a5: Push((int) 1)
0x7a6: Pop(1); Push(Stack[-1] - Stack[-4]);
0x7a7: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x7a8: Push("health") // @poff=816
...
0x7ae: Pop(3)
0x7af: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=804
0x7b0: Pop(2)
0x7b1: PushEmpty(bool, object)
0x7b2: Stack[-17] = Stack[-1]
0x7b3: Call2 0x74c
...
0x7b9: Pop(1)
0x7ba: Stack[-1] = Stack[-16]
0x7bb: Return(); Pop(12)

0x7bc: PushEmpty(bool, bool)
0x7bd: @@ IsDead(Stack[-1]); Obj=3 // @poff=856
0x7be: Pop(0)
0x7bf: Stack[-1] = Stack[-4]
0x7c0: Return(); Pop(2)

0x7c1: PushEmpty(object, object, object, object)
0x7c2: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7d6: Pop(0)
0x7d7: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7d8: IF (Stack[-1] == 0) GOTO 0x7db; Pop(1)

0x7d9: Stack[-6] = (bool) 0
0x7da: Return(); Pop(4)

0x7db: @@ GetScene(Stack[-1]); Obj=5 // @poff=877
0x7dc: Pop(0)
...
0x7ef: Stack[-6] = Stack[-2]
0x7f0: Stack[-1] = "noaccess" // @poff=886
0x7f1: Call2 0x751
...
0x7f7: Push("noaccess") // @poff=886
0x7f8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=792
0x7f9: Pop(1)
0x7fa: Push((int) 0)
...
0x7fe: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x80c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=156
0x80d: Pop(0)
...
0x81d: Stack[-1] = "fhit" // @poff=904
0x81e: GOTO 0x820

0x81f: Stack[-1] = "bhit" // @poff=914
0x820: Push("hit_react") // @poff=924
0x821: Push("1") // @poff=944
0x822: Pop(1); Push(Stack[-3] + Stack[-1]);
0x823: Push("2") // @poff=948
...
0x83c: Stack[-25] = Stack[-1]
0x83d: Call2 0x745

0x83e: Stack[-2] = Stack[-3]
0x83f: Pop(2)
0x840: Call2 0x942
...
0x85b: Pop(0)
0x85c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=961
0x85d: Pop(0)
0x85e: PushEmpty(object, int, float, cvector, cvector)
0x85f: Stack[-26] = Stack[-5]
0x860: Stack[-25] = Stack[-4]
0x861: Stack[-24] = Stack[-3]
0x862: Stack[-6] = Stack[-2]
...
0x87c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=156
0x87d: Pop(0)
...
0x88c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x88d: Pop(0)
0x88e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=708
0x88f: Pop(0)
...
0x8b5: Pop(0)
0x8b6: Push((bool) 1)
0x8b7: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x8b8: Pop(1)
0x8b9: Push(CvectorIndex(Stack[-4], 0))
0x8ba: Push(CvectorIndex(Stack[-5], 2))
0x8bb: @ Rotate(Stack[-2], Stack[-1])
0x8bc: Pop(2)
...
0x8c2: Push("head") // @poff=532
0x8c3: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8c4: Pop(1)
0x8c5: Push(Stack[-1])
0x8c6: IF (Stack[-1] == 0) GOTO 0x8ca; Pop(1)

0x8c7: Push("head") // @poff=532
0x8c8: @ LookAsyncCamera(Stack[-1])
0x8c9: Pop(1)
0x8ca: @ CameraWaitForPlayFinish()
0x8cb: Pop(0)
0x8cc: @ ResumeWorld()
0x8cd: Pop(0)
0x8ce: Stack[-21] = (bool) 1
0x8cf: Return(); Pop(18)

0x8d0: PushEmpty(bool, bool)
0x8d1: Push((bool) 1)
0x8d2: @ CameraSwitchToNormal(Stack[-1])
0x8d3: Pop(1)
...
0x8d9: Push("head") // @poff=532
0x8da: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8db: Pop(1)
0x8dc: Push(Stack[-1])
0x8dd: IF (Stack[-1] == 0) GOTO 0x8e1; Pop(1)

0x8de: Push("head") // @poff=532
0x8df: @ UnlookAsync(Stack[-1])
0x8e0: Pop(1)
0x8e1: Return(); Pop(2)

0x8e2: PushEmpty(bool, float, float, bool, float, float)
0x8e3: @ lshHasAnimation(Stack[-3], Stack[-7])
0x8e4: Pop(0)
0x8e5: Push(Stack[-3])
0x8e6: IF (Stack[-1] == 0) GOTO 0x8ed; Pop(1)

0x8e7: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x8e8: Pop(0)
0x8e9: Push((bool) 0)
0x8ea: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x8eb: Pop(1)
0x8ec: GOTO 0x8f1

0x8ed: Push("Can't find lsh animation : ") // @poff=1011
0x8ee: Pop(1); Push(Stack[-1] + Stack[-8]);
0x8ef: @ Trace(Stack[-1])
0x8f0: Pop(1)
0x8f1: Return(); Pop(6)

0x8f2: PushEmpty(bool, float, float, bool, float, float)
0x8f3: @ lshHasAnimation(Stack[-3], Stack[-8])
0x8f4: Pop(0)
0x8f5: Push(Stack[-3])
0x8f6: IF (Stack[-1] == 0) GOTO 0x8fc; Pop(1)

0x8f7: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x8f8: Pop(0)
0x8f9: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x8fa: Pop(0)
0x8fb: GOTO 0x900

0x8fc: Push("Can't find lsh animation : ") // @poff=1011
0x8fd: Pop(1); Push(Stack[-1] + Stack[-9]);
0x8fe: @ Trace(Stack[-1])
0x8ff: Pop(1)
0x900: Return(); Pop(6)

0x901: PushEmpty(float, cvector, float, cvector)
0x902: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=708
0x903: Pop(0)
0x904: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x905: Push(CvectorIndex(Stack[-1], 1))
0x906: Stack[-3] = Stack[-1]
0x907: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x908: Push("head") // @poff=532
0x909: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x90a: Pop(1)
0x90b: Return(); Pop(4)
...
0x913: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x914: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x915: Pop(0)
0x916: Pop(0); Push((bool) Stack[-8] == 0)
0x917: IF (Stack[-1] == 0) GOTO 0x92c; Pop(1)

0x918: Stack[-7] = (int) 0
0x919: Push((int) 1)
0x91a: Pop(1); Push(Stack[-8] + Stack[-1]);
0x91b: Pop(1); Push(Stack[-18] + Stack[-1]);
0x91c: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x91d: Pop(1)
0x91e: Pop(0); Push((bool) Stack[-6] == 0)
0x91f: IF (Stack[-1] == 0) GOTO 0x921; Pop(1)

0x920: GOTO 0x924

0x921: Push((int) 1)
0x922: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x923: GOTO 0x919

0x924: Pop(0); Push((bool) Stack[-7] == 0)
0x925: IF (Stack[-1] == 0) GOTO 0x927; Pop(1)

0x926: Return(); Pop(16)

0x927: @ irand(Stack[-5], Stack[-7])
0x928: Pop(0)
0x929: Push((int) 1)
0x92a: Pop(1); Push(Stack[-6] + Stack[-1]);
0x92b: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x92c: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x92d: Pop(0)
0x92e: Push(Stack[-4])
0x92f: IF (Stack[-1] == 0) GOTO 0x93b; Pop(1)

0x930: @ GetEyesHeight(Stack[-3])
0x931: Pop(0)
0x932: @ GetDirection(Stack[-2])
0x933: Pop(0)
0x934: Push((int) 50)
0x935: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x936: Push(CvectorIndex(Stack[-1], 1))
0x937: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x938: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x939: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x93a: Pop(0)
0x93b: Return(); Pop(16)
...
0x941: Stack[-1] = 0
0x942: PushEmpty(float, float)
0x943: Pop(0); Push(Stack[-3] | Stack[-3]);
0x944: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x945: Push((float)9.999999974752427e-07)
0x946: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x947: IF (Stack[-1] == 0) GOTO 0x94a; Pop(1)

0x948: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x949: Return(); Pop(2)

0x94a: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x94b: Return(); Pop(2)

0x94c: PushEmpty()
0x94d: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x94e: IF (Stack[-1] == 0) GOTO 0x951; Pop(1)

0x94f: Stack[-2] = Stack[-3]
0x950: GOTO 0x952
...
0x953: PushEmpty()
0x954: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x955: IF (Stack[-1] == 0) GOTO 0x958; Pop(1)

0x956: Stack[-2] = Stack[-4]
0x957: Return(); Pop(0)

0x958: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x959: IF (Stack[-1] == 0) GOTO 0x95c; Pop(1)

0x95a: Stack[-1] = Stack[-4]
0x95b: Return(); Pop(0)

0x95c: Stack[-3] = Stack[-4]
0x95d: Return(); Pop(0)

0x95e: PushEmpty()
0x95f: Pop(0); Push(Stack[-2] | Stack[-1]);
0x960: Pop(0); Push(Stack[-3] | Stack[-3]);
0x961: Pop(0); Push(Stack[-3] | Stack[-3]);
0x962: Pop(2); Push(Stack[-2] * Stack[-1]);
0x963: Pop(1); Push(Sqrt(Stack[-1]))
0x964: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x965: Return(); Pop(0)

0x966: PushEmpty()
0x967: Pop(0); Push((bool) Stack[-2] == 0)
0x968: IF (Stack[-1] == 0) GOTO 0x96b; Pop(1)

0x969: Stack[-3] = (bool) 0
0x96a: Return(); Pop(0)

0x96b: Push((int) 0)
0x96c: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x96d: IF (Stack[-1] == 0) GOTO 0x972; Pop(1)

0x96e: Push((int) 8)
0x96f: @ SendWorldWndMessage(Stack[-1])
0x970: Pop(1)
0x971: GOTO 0x97b
...
0x975: Push((int) 9)
0x976: @ SendWorldWndMessage(Stack[-1])
0x977: Pop(1)
0x978: GOTO 0x97b

0x979: Stack[-3] = (bool) 0
0x97a: Return(); Pop(0)

0x97b: PushEmpty(float)
0x97c: Stack[-2] = Stack[-1]
0x97d: Call2 0x99a

0x97e: Pop(1)
0x97f: PushEmpty(bool, object, string, float, float, float)
0x980: Stack[-8] = Stack[-5]
0x981: Stack[-4] = "reputation" // @poff=1067
0x982: Stack[-7] = Stack[-3]
0x983: Stack[-2] = (int) 0
0x984: Stack[-1] = (int) 1
0x985: Call2 0x75d

0x986: Pop(6)
0x987: Stack[-3] = (bool) 1
0x988: Return(); Pop(0)

0x989: PushEmpty(object, object)
0x98a: @ CreateFloatVector(Stack[-1])
0x98b: Pop(0)
0x98c: @@ add(Stack[-3]); Obj=1 // @poff=952
0x98d: Pop(0)
0x98e: Push((int) 0)
0x98f: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x990: IF (Stack[-1] == 0) GOTO 0x995; Pop(1)

0x991: Push((float)0.699999988079071)
0x992: Push((int) 500)
0x993: @ RumblePlay(Stack[-2], Stack[-1])
0x994: Pop(2)
0x995: Push((int) 15)
...
0x99b: @ CreateFloatVector(Stack[-1])
0x99c: Pop(0)
0x99d: @@ add(Stack[-3]); Obj=1 // @poff=952
0x99e: Pop(0)
0x99f: Push((int) 16)
0x9a0: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x9a1: Pop(1)
0x9a2: Return(); Pop(2)

0x9a3: Stack[-1] = 0
0x9a4: PushEmpty(object, object)
0x9a5: @ FindActor(Stack[-1], Stack[-4])
0x9a6: Pop(0)
0x9a7: Pop(0); PushNull((bool) Stack[-1] == 0)
0x9a8: IF (Stack[-1] == 0) GOTO 0x9ab; Pop(1)

0x9a9: Stack[-5] = (bool) 0
0x9aa: Return(); Pop(2)

0x9ab: @ Trigger(Stack[-1], Stack[-3])
0x9ac: Pop(0)
0x9ad: Stack[-5] = (bool) 1
0x9ae: Return(); Pop(2)

0x9af: Stack[-1] = 0
0x9b0: PushEmpty(bool, bool)
0x9b1: @ IsPlayerActor(Stack[-3], Stack[-1])
0x9b2: Pop(0)
0x9b3: Push(Stack[-1])
0x9b4: IF (Stack[-1] == 0) GOTO 0x9b8; Pop(1)

0x9b5: Push("attack") // @poff=298
0x9b6: @ PlayGlobalMusic(Stack[-1])
0x9b7: Pop(1)
0x9b8: Return(); Pop(2)

0x9b9: PushEmpty(object, object)
0x9ba: @ GetScene(Stack[-1])
0x9bb: Pop(0)
0x9bc: Push("battle") // @poff=1089
0x9bd: PushEmpty(object)
0x9be: Call2 0x93c

0x9bf: Pop(0)
0x9c0: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x9c1: Pop(2)
0x9c2: Return(); Pop(2)

0x9c3: Stack[-1] = 0
0x9c4: PushEmpty(string, string)
0x9c5: Stack[-1] = "idle" // @poff=146
0x9c6: Push(Stack[-3])
...
0x9da: Stack[-2] = Stack[-5]
0x9db: Return(); Pop(4)

0x9dc: PushEmpty()
0x9dd: Push((int) 1)
0x9de: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1103
0x9df: Pop(1)
0x9e0: Return(); Pop(0)

0x9e1: PushEmpty()
0x9e2: Push("b1q03_retreat") // @poff=1118
0x9e3: Push((int) 1)
0x9e4: @ SetVariable(Stack[-2], Stack[-1])
0x9e5: Pop(2)
0x9e6: Push((int) 0)
0x9e7: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1103
0x9e8: Pop(1)
0x9e9: Return(); Pop(0)

0x9ea: PushEmpty(int, int)
0x9eb: Push("branch") // @poff=1146
0x9ec: @ GetVariable(Stack[-1], Stack[-2])
0x9ed: Pop(1)
0x9ee: Push((int) 0)
...
0x9fb: PushEmpty(int, int)
0x9fc: Push("branch") // @poff=1146
0x9fd: @ GetVariable(Stack[-1], Stack[-2])
0x9fe: Pop(1)
...
0xa04: Pop(0)
0xa05: Push((int) 1)
0xa06: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xa07: IF (Stack[-1] == 0) GOTO 0xa0b; Pop(1)

0xa08: @ WorkWithCorpse(Stack[-1])
0xa09: Pop(0)
0xa0a: GOTO 0xa0d

0xa0b: @ Barter(Stack[-1])
0xa0c: Pop(0)
0xa0d: Return(); Pop(0)

0xa0e: Stack[-1] = (int) 518097
0xa0f: Return(); Pop(0)

0xa10: Stack[-1] = (int) 518096
0xa11: Return(); Pop(0)

0xa12: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1160
0xa13: Return(); Pop(0)

0xa14: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1200
0xa15: Return(); Pop(0)

0xa16: Stack[-1] = (bool) 0
0xa17: Return(); Pop(0)

0xa18: PushEmpty(object, object)
0xa19: @ GetScene(Stack[-1])
0xa1a: Pop(0)
0xa1b: PushEmpty(object)
0xa1c: Call2 0x93c

0xa1d: Pop(0)
0xa1e: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=220
0xa1f: Pop(1)
0xa20: Return(); Pop(2)
...
0xa26: Pop(1)
0xa27: IF (Stack[-1] == 0) GOTO 0xa32; Pop(1)

0xa28: PushEmpty(bool, object, float)
0xa29: Stack[-4] = Stack[-2]
0xa2a: Stack[-1] = (float) -0.10000000149011612
0xa2b: Call2 0x966

0xa2c: Pop(3)
0xa2d: PushEmpty(bool, string, string)
0xa2e: Stack[-2] = "quest_b1_03" // @poff=1244
0xa2f: Stack[-1] = "doberman_dead" // @poff=1268
0xa30: Call2 0x9a4
...
0xa34: Pop(0)
0xa35: PushEmpty(object)
0xa36: Stack[-2] = Stack[-1]
0xa37: Push(-1, 0); TaskCall(6)
0xa38: Call2 0x693

0xa39: Pop(-1, 0); TaskReturn
0xa3a: Pop(1)
0xa3b: Return(); Pop(0)

0xa3c: PushEmpty()
0xa3d: PushEmpty(object, int, float)
0xa3e: Stack[-7] = Stack[-3]
0xa3f: Stack[-6] = Stack[-2]
0xa40: Stack[-5] = Stack[-1]
0xa41: Call2 0x829
...
0xa44: PushEmpty()
0xa45: PushEmpty(object, int, float, cvector, cvector)
0xa46: Stack[-11] = Stack[-5]
0xa47: Stack[-10] = Stack[-4]
0xa48: Stack[-9] = Stack[-3]
0xa49: Stack[-7] = Stack[-2]
0xa4a: Stack[-6] = Stack[-1]
0xa4b: Call2 0x86d

0xa4c: Pop(5)
0xa4d: Return(); Pop(0)

0xa4e: PushEmpty(float, float)
0xa4f: Push("health") // @poff=816
0xa50: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa51: IF (Stack[-1] == 0) GOTO 0xa5a; Pop(1)

0xa52: Push("health") // @poff=816
0xa53: @ GetProperty(Stack[-1], Stack[-2])
0xa54: Pop(1)
0xa55: Push((int) 0)
0xa56: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa57: IF (Stack[-1] == 0) GOTO 0xa5a; Pop(1)

0xa58: @ SignalDeath(Stack[-4])
0xa59: Pop(0)
0xa5a: Return(); Pop(2)

0xa5b: PushEmpty()
0xa5c: PushEmpty(object)
0xa5d: Stack[-2] = Stack[-1]
0xa5e: Call2 0xa22
...
0xa63: Stack[-3] = Stack[-1]
0xa64: Call2 0x7e5

0xa65: Stack[-2] = Stack[-4]
0xa66: Pop(2)
0xa67: Return(); Pop(0)

0xa68: PushEmpty()
0xa69: PushEmpty(object, bool)
0xa6a: Stack[-3] = Stack[-2]
0xa6b: Stack[-1] = (bool) 1
0xa6c: Push(-2, 6); TaskCall(4)
0xa6d: Call2 0x2e3

0xa6e: Pop(-2, 6); TaskReturn
0xa6f: Pop(2)
0xa70: Return(); Pop(0)
