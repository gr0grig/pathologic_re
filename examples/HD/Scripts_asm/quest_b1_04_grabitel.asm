...
// @pool_raw:
...
Events:
EVENT_22 Op = 0x84f Vars = (object, int, float, float)
EVENT_43 Op = 0x857 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x861 Vars = (object, string)
...
0xb1: Pop(0); PushNull((bool) Stack[-21] == 0)
0xb2: IF (Stack[-1] == 0) GOTO 0xb8; Pop(1)

0xb3: PushEmpty(string)
0xb4: Stack[-1] = "fdie" // @poff=30
0xb5: Call2 0x10b

0xb6: Pop(1)
0xb7: GOTO 0x10a

0xb8: @@ GetPosition(Stack[-10]); Obj=21 // @poff=40
0xb9: Pop(0)
...
0xc9: Stack[-6] = "fdie" // @poff=30
0xca: GOTO 0xcc

0xcb: Stack[-6] = "bdie" // @poff=52
...
0xd2: @ StopAsync()
0xd3: Pop(0)
0xd4: Stack[-21] = Stack[-5]
0xd5: Push("GetScriptProperty") // @poff=62
0xd6: Push((int) 2)
0xd7: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0xd8: IF (Stack[-1] == 0) GOTO 0xe4; Pop(1)

0xd9: Push("Owner") // @poff=98
0xda: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=110
0xdb: Pop(1)
0xdc: Push(Stack[-4])
0xdd: IF (Stack[-1] == 0) GOTO 0xe4; Pop(1)

0xde: Push("Owner") // @poff=98
0xdf: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=128
0xe0: Pop(1)
0xe1: Pop(0); PushNull((bool) Stack[-5] == 0)
0xe2: IF (Stack[-1] == 0) GOTO 0xe4; Pop(1)

0xe3: Stack[-21] = Stack[-5]
0xe4: Push("@GetEyesHeight") // @poff=146
0xe5: Push((int) 1)
0xe6: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0xe7: IF (Stack[-1] == 0) GOTO 0xf3; Pop(1)

0xe8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=176
0xe9: Pop(0)
0xea: Stack[-1] = CVector(0.0, 0.0, 0.0)
0xeb: Push(CvectorIndex(Stack[-1], 1))
0xec: Stack[-3] = Stack[-1]
0xed: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xee: Push("head") // @poff=190
...
0xff: @ StopAsync()
0x100: Pop(0)
0x101: Push("head") // @poff=190
0x102: @ UnlookAsync(Stack[-1])
0x103: Pop(1)
0x104: Push("all") // @poff=0
...
0x137: Stack[-2] = Stack[-3]
0x138: Pop(2)
0x139: PushEmpty(bool, float, float, float)
0x13a: Stack[-5] = Stack[-3]
...
0x177: Push("all") // @poff=0
0x178: Push("aattack_end1") // @poff=230
0x179: @ PlayAnimation(Stack[-2], Stack[-1])
0x17a: Pop(2)
0x17b: @ GetScene(Stack[-7])
0x17c: Pop(0)
0x17d: Push("knife") // @poff=256
0x17e: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-7])
0x17f: Pop(1)
0x180: Push("scripted") // @poff=268
0x181: Push(CVector(0.0, 0.0, 1.0))
0x182: Push("grabitel_knife.xml") // @poff=286
0x183: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-9], Stack[-2], Stack[-1])
0x184: Pop(3)
0x185: Push("Owner") // @poff=98
0x186: PushEmpty(object)
0x187: Call2 0x795

0x188: Pop(0)
0x189: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=324
0x18a: Pop(2)
0x18b: Push("Target") // @poff=342
0x18c: @@ SetScriptProperty(Stack[-1], Stack[-16]); Obj=5 // @poff=324
0x18d: Pop(1)
0x18e: @@ GetPosition(Stack[-3]); Obj=15 // @poff=40
0x18f: Pop(0)
0x190: @@ GetEyesHeight(Stack[-2]); Obj=15 // @poff=176
0x191: Pop(0)
...
0x198: Stack[-10] = Stack[-3]
0x199: Stack[-7] = Stack[-2]
0x19a: Stack[-1] = (float) 2000.0
0x19b: Call2 0x8d1

0x19c: Stack[-4] = Stack[-5]
0x19d: Pop(4)
0x19e: Push("StartDirection") // @poff=356
0x19f: @@ SetScriptProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=324
0x1a0: Pop(1)
...
0x1c3: Stack[-6] = Stack[-2]
0x1c4: Stack[-5] = Stack[-1]
0x1c5: Call2 0x8f6
...
0x1e0: Push("all") // @poff=0
0x1e1: Push("attack_off") // @poff=396
...
0x1ea: PushEmpty()
0x1eb: Stack[-3] = (float) 0.15000000596046448
0x1ec: Return(); Pop(0)
...
0x230: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x231: Pop(0)
0x232: Push(Stack[-8])
0x233: IF (Stack[-1] == 0) GOTO 0x23c; Pop(1)

0x234: Push("attack") // @poff=474
...
0x250: Pop(0)
0x251: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=488
0x252: Pop(0)
...
0x26c: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=488
0x26d: Pop(0)
...
0x286: Pop(1)
0x287: Push("all") // @poff=0
0x288: Push("attack_on") // @poff=502
...
0x29e: Push((float)0.19999998807907104)
0x29f: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x2a0: IF (Stack[-1] == 1) GOTO 0x2a6; Pop(1)

0x2a1: PushEmpty(bool)
0x2a2: Call2 0x474

0x2a3: Pop(0)
0x2a4: IF (Stack[-1] == 1) GOTO 0x2a6; Pop(1)

0x2a5: Stack[-1] = (bool) 0
0x2a6: IF (Stack[-1] == 0) GOTO 0x2b7; Pop(1)

0x2a7: @ Face(Stack[-0]T)
0x2a8: Pop(0)
0x2a9: PushEmpty()
0x2aa: Call2 0x4a4
...
0x2b7: @ Face(Stack[-0]T)
0x2b8: Pop(0)
0x2b9: Push("all") // @poff=0
0x2ba: Push("fjump") // @poff=546
...
0x2d5: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=488
0x2d6: Pop(0)
...
0x2f4: Push("all") // @poff=0
0x2f5: Push("attack_off") // @poff=396
...
0x302: Push("all") // @poff=0
0x303: Push("attack_begin") // @poff=558
0x304: Push((int) 1)
0x305: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x310: Push("attack") // @poff=474
0x311: Push((int) 1)
0x312: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x31c: Push("all") // @poff=0
0x31d: Push("bjump") // @poff=584
...
0x324: Push((float)0.8999999761581421)
0x325: Pop(1); Push(Stack[-9] * Stack[-1]);
0x326: @ GetVictim(Stack[-1], Stack[-4])
0x327: Pop(1)
0x328: @ ReportAttack(Stack[-0]T)
0x329: Pop(0)
...
0x330: Stack[-3] = Stack[-5]
0x331: Pop(3)
0x332: PushEmpty(float, object, float, int)
0x333: Stack[-7] = Stack[-3]
0x334: Stack[-6] = Stack[-2]
0x335: PushEmpty(int, object, int)
0x336: Stack[-10] = Stack[-2]
0x337: Stack[-14] = Stack[-1]
0x338: Call2 0x1ed

0x339: Stack[-3] = Stack[-4]
0x33a: Pop(3)
0x33b: Call2 0x617

0x33c: Stack[-4] = Stack[-5]
0x33d: Pop(4)
0x33e: PushEmpty(int)
0x33f: Call2 0x1f0

0x340: Pop(0)
0x341: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x342: Pop(1)
0x343: PushEmpty(object, float)
0x344: Stack[-5] = Stack[-2]
...
0x34d: Pop(0)
0x34e: @ irand(Stack[-4], Stack[-1]T)
0x34f: Pop(0)
0x350: Push((int) 1)
0x351: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x352: @ Face(Stack[-0]T)
0x353: Pop(0)
0x354: Push((bool) 1)
...
0x359: Pop(0)
0x35a: Push("all") // @poff=0
0x35b: Push("attack_begin") // @poff=558
...
0x36f: Stack[-11] = Stack[-2]
0x370: Stack[-6] = Stack[-1]
0x371: Call2 0x323

0x372: Pop(2)
0x373: Push("all") // @poff=0
0x374: Push("attack_middle") // @poff=596
...
0x37c: Pop(0)
0x37d: Push("all") // @poff=0
0x37e: Push("attack_middle") // @poff=596
...
0x3c1: Pop(1)
0x3c2: Push("all") // @poff=0
0x3c3: Push("attack_end") // @poff=628
...
0x3cc: Stack[-1] = (float) 0.44999998807907104
0x3cd: Call2 0x3d5
...
0x404: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=488
0x405: Pop(0)
...
0x450: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x451: Pop(1)
...
0x455: @ Face(Stack[-0]T)
0x456: Pop(0)
0x457: Push("all") // @poff=0
0x458: Push("bjump") // @poff=584
0x459: @ PlayAnimation(Stack[-2], Stack[-1])
0x45a: Pop(2)
0x45b: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=488
0x45c: Pop(0)
...
0x492: @ irand(Stack[-1], Stack[-2]T)
0x493: Pop(0)
0x494: Push((int) 1)
0x495: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x496: Push("attack") // @poff=474
...
0x4a5: Stack[-1] = "attack_stay" // @poff=522
0x4a6: Call2 0x76c
...
0x4b7: Stack[-6] = Stack[-2]
0x4b8: Stack[-5] = Stack[-1]
0x4b9: Call2 0x8f6
...
0x4e6: Stack[-15] = Stack[-5]
0x4e7: Stack[-14] = Stack[-4]
0x4e8: Stack[-13] = Stack[-3]
0x4e9: Stack[-12] = Stack[-2]
0x4ea: Stack[-11] = Stack[-1]
0x4eb: Call2 0x530

0x4ec: Stack[-6] = Stack[-7]
0x4ed: Pop(6)
0x4ee: Push( Stack[2 + Tasks[-1].StackPointer] )
0x4ef: IF (Stack[-1] == 0) GOTO 0x4f3; Pop(1)

0x4f0: Push("head") // @poff=190
...
0x533: Stack[-17] = Stack[-7]
0x534: PushEmpty(bool, object)
0x535: Stack[-23] = Stack[-1]
0x536: Call2 0x5bc
...
0x53c: @@ GetPosition(Stack[-5]); Obj=21 // @poff=40
0x53d: Pop(0)
...
0x553: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=488
0x554: Pop(0)
...
0x565: Push((int) 0)
0x566: Push((float)0.30000001192092896)
...
0x588: Push((int) 0)
0x589: Push((float)0.30000001192092896)
...
0x5c0: Stack[-2] = Stack[-4]
0x5c1: Pop(2)
0x5c2: Return(); Pop(0)

0x5c3: Stack[-1] = "walk" // @poff=686
0x5c4: Return(); Pop(0)

0x5c5: Stack[-1] = "run" // @poff=696
0x5c6: Return(); Pop(0)

0x5c7: PushEmpty()
0x5c8: PushEmpty(bool, object)
0x5c9: Stack[-3] = Stack[-1]
...
0x5dd: Stack[-2] = "bullet" // @poff=714
0x5de: Return(); Pop(0)

0x5df: Stack[-2] = "phys" // @poff=728
0x5e0: Return(); Pop(0)

0x5e1: PushEmpty(cvector, cvector, cvector, cvector)
0x5e2: @ GetPosition(Stack[-2])
0x5e3: Pop(0)
0x5e4: @@ GetPosition(Stack[-1]); Obj=5 // @poff=40
0x5e5: Pop(0)
...
0x5ea: Pop(0)
0x5eb: @@ GetPosition(Stack[-2]); Obj=7 // @poff=40
0x5ec: Pop(0)
...
0x5f6: Push("HasProperty") // @poff=738
0x5f7: Push((int) 2)
...
0x5fd: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=762
0x5fe: Pop(0)
...
0x603: Stack[-10] = Stack[-2]
0x604: Stack[-9] = Stack[-1]
0x605: Call2 0x5f5
...
0x60b: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=774
0x60c: Pop(0)
0x60d: PushEmpty(float, float, float, float)
0x60e: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x60f: Stack[-8] = Stack[-2]
0x610: Stack[-7] = Stack[-1]
0x611: Call2 0x7c4

0x612: Pop(3)
0x613: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=786
0x614: Pop(1)
...
0x622: Stack[-18] = Stack[-2]
0x623: Stack[-1] = "armor" // @poff=812
0x624: Call2 0x5f5
...
0x62a: Push("armor") // @poff=812
0x62b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=774
0x62c: Pop(1)
0x62d: Push("armor_") // @poff=824
0x62e: PushEmpty(string, int)
0x62f: Stack[-16] = Stack[-1]
0x630: Call2 0x5d3

0x631: Pop(1)
0x632: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x633: PushEmpty(bool, object, string)
0x634: Stack[-18] = Stack[-2]
...
0x63c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=774
0x63d: Pop(0)
...
0x644: Stack[-3] = Stack[-6]
0x645: Pop(3)
0x646: Push("health") // @poff=798
0x647: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=774
0x648: Pop(1)
0x649: Push((int) 1)
0x64a: Pop(1); Push(Stack[-1] - Stack[-4]);
0x64b: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x64c: Push("health") // @poff=798
...
0x652: Pop(3)
0x653: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=786
0x654: Pop(2)
0x655: PushEmpty(bool, object)
0x656: Stack[-17] = Stack[-1]
0x657: Call2 0x5f0
...
0x65d: Pop(1)
0x65e: Stack[-1] = Stack[-16]
0x65f: Return(); Pop(12)

0x660: PushEmpty(float, float)
0x661: PushEmpty(bool, object, string)
0x662: Stack[-6] = Stack[-2]
0x663: Stack[-1] = "health" // @poff=798
0x664: Call2 0x5f5
...
0x679: Push("health") // @poff=798
0x67a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=774
0x67b: Pop(1)
...
0x680: @@ IsDead(Stack[-1]); Obj=3 // @poff=838
0x681: Pop(0)
0x682: Stack[-1] = Stack[-4]
0x683: Return(); Pop(2)

0x684: PushEmpty(object, object, object, object)
0x685: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x699: Pop(0)
0x69a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x69b: IF (Stack[-1] == 0) GOTO 0x69e; Pop(1)

0x69c: Stack[-6] = (bool) 0
0x69d: Return(); Pop(4)

0x69e: @@ GetScene(Stack[-1]); Obj=5 // @poff=859
0x69f: Pop(0)
...
0x6b2: Stack[-6] = Stack[-2]
0x6b3: Stack[-1] = "noaccess" // @poff=868
0x6b4: Call2 0x5f5
...
0x6ba: Push("noaccess") // @poff=868
0x6bb: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=774
0x6bc: Pop(1)
0x6bd: Push((int) 0)
...
0x6e2: @@ GetPosition(Stack[-5]); Obj=15 // @poff=40
0x6e3: Pop(0)
...
0x6f3: Stack[-1] = "fhit" // @poff=886
0x6f4: GOTO 0x6f6

0x6f5: Stack[-1] = "bhit" // @poff=896
0x6f6: Push("hit_react") // @poff=906
0x6f7: Push("1") // @poff=226
0x6f8: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6f9: Push("2") // @poff=926
...
0x712: Stack[-25] = Stack[-1]
0x713: Call2 0x5e1

0x714: Stack[-2] = Stack[-3]
0x715: Pop(2)
0x716: Call2 0x79b
...
0x731: Pop(0)
0x732: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=939
0x733: Pop(0)
0x734: PushEmpty(object, int, float, cvector, cvector)
0x735: Stack[-26] = Stack[-5]
0x736: Stack[-25] = Stack[-4]
0x737: Stack[-24] = Stack[-3]
0x738: Stack[-6] = Stack[-2]
...
0x752: @@ GetPosition(Stack[-3]); Obj=7 // @poff=40
0x753: Pop(0)
...
0x79e: Push((float)9.999999974752427e-07)
...
0x7f1: Stack[-8] = Stack[-5]
0x7f2: Stack[-4] = "reputation" // @poff=971
0x7f3: Stack[-7] = Stack[-3]
0x7f4: Stack[-2] = (int) 0
0x7f5: Stack[-1] = (int) 1
0x7f6: Call2 0x601
...
0x7fc: Pop(0)
0x7fd: @@ add(Stack[-3]); Obj=1 // @poff=930
0x7fe: Pop(0)
0x7ff: Push((int) 0)
0x800: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x801: IF (Stack[-1] == 0) GOTO 0x806; Pop(1)

0x802: Push((float)0.699999988079071)
0x803: Push((int) 500)
0x804: @ RumblePlay(Stack[-2], Stack[-1])
0x805: Pop(2)
0x806: Push((int) 15)
0x807: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x808: Pop(1)
0x809: Return(); Pop(2)

0x80a: Stack[-1] = 0
0x80b: PushEmpty(object, object)
0x80c: @ CreateFloatVector(Stack[-1])
0x80d: Pop(0)
0x80e: @@ add(Stack[-3]); Obj=1 // @poff=930
0x80f: Pop(0)
0x810: Push((int) 16)
...
0x82a: Push("god_mode") // @poff=1007
0x82b: @ GetVariable(Stack[-1], Stack[-2])
0x82c: Pop(1)
0x82d: Stack[-1] = Stack[-3]
0x82e: Return(); Pop(2)

0x82f: PushEmpty(string, string)
0x830: Stack[-1] = "idle" // @poff=1025
0x831: Push(Stack[-3])
0x832: IF (Stack[-1] == 0) GOTO 0x834; Pop(1)

0x833: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x834: Stack[-1] = Stack[-4]
0x835: Return(); Pop(2)

0x836: PushEmpty(int, bool, int, bool)
0x837: Stack[-2] = (int) 0
0x838: Push("all") // @poff=0
0x839: PushEmpty(string, int)
0x83a: Stack[-5] = Stack[-1]
0x83b: Call2 0x82f

0x83c: Pop(1)
0x83d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x83e: Pop(2)
0x83f: Pop(0); Push((bool) Stack[-1] == 0)
0x840: IF (Stack[-1] == 0) GOTO 0x842; Pop(1)

0x841: GOTO 0x845

0x842: Push((int) 1)
0x843: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x844: GOTO 0x838

0x845: Stack[-2] = Stack[-5]
0x846: Return(); Pop(4)

0x847: PushEmpty()
0x848: PushEmpty(object)
0x849: Stack[-2] = Stack[-1]
0x84a: Push(-1, 0); TaskCall(1)
0x84b: Call2 0x80

0x84c: Pop(-1, 0); TaskReturn
0x84d: Pop(1)
0x84e: Return(); Pop(0)

0x84f: PushEmpty()
0x850: PushEmpty(object, int, float)
0x851: Stack[-7] = Stack[-3]
0x852: Stack[-6] = Stack[-2]
0x853: Stack[-5] = Stack[-1]
0x854: Call2 0x6ff
...
0x857: PushEmpty()
0x858: PushEmpty(object, int, float, cvector, cvector)
0x859: Stack[-11] = Stack[-5]
0x85a: Stack[-10] = Stack[-4]
0x85b: Stack[-9] = Stack[-3]
0x85c: Stack[-7] = Stack[-2]
0x85d: Stack[-6] = Stack[-1]
0x85e: Call2 0x743

0x85f: Pop(5)
0x860: Return(); Pop(0)

0x861: PushEmpty(float, float)
0x862: Push("health") // @poff=798
0x863: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x864: IF (Stack[-1] == 0) GOTO 0x86d; Pop(1)

0x865: Push("health") // @poff=798
0x866: @ GetProperty(Stack[-1], Stack[-2])
0x867: Pop(1)
0x868: Push((int) 0)
0x869: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x86a: IF (Stack[-1] == 0) GOTO 0x86d; Pop(1)

0x86b: @ SignalDeath(Stack[-4])
0x86c: Pop(0)
0x86d: Return(); Pop(2)

0x86e: PushEmpty()
0x86f: PushEmpty(object)
0x870: Stack[-2] = Stack[-1]
0x871: Call2 0x847
...
0x88a: Pop(0)
0x88b: Push((int) 1)
0x88c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x88d: IF (Stack[-1] == 0) GOTO 0x891; Pop(1)

0x88e: @ WorkWithCorpse(Stack[-1])
0x88f: Pop(0)
0x890: GOTO 0x893

0x891: @ Barter(Stack[-1])
0x892: Pop(0)
0x893: Return(); Pop(0)

0x894: PushEmpty(object, int, bool, object, int, bool)
0x895: @ CreateInvItem(Stack[-3])
0x896: Pop(0)
0x897: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1049
0x898: Pop(0)
0x899: Push("Organ") // @poff=1061
0x89a: Push((int) 1)
0x89b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=786
0x89c: Pop(2)
0x89d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1073
0x89e: Pop(0)
0x89f: Push((int) 0)
0x8a0: Push((int) 1)
0x8a1: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x8a2: Pop(2)
0x8a3: Return(); Pop(6)
...
0x8a7: Pop(0)
0x8a8: Push((int) 1)
0x8a9: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x8aa: IF (Stack[-1] == 0) GOTO 0x8ac; Pop(1)

0x8ab: Return(); Pop(0)

0x8ac: PushEmpty(string)
0x8ad: Stack[-1] = "liver" // @poff=1083
0x8ae: Call2 0x894

0x8af: Pop(1)
0x8b0: PushEmpty(string)
0x8b1: Stack[-1] = "kidney" // @poff=1095
0x8b2: Call2 0x894

0x8b3: Pop(1)
0x8b4: PushEmpty(string)
0x8b5: Stack[-1] = "heart" // @poff=1109
0x8b6: Call2 0x894

0x8b7: Pop(1)
0x8b8: PushEmpty(string)
0x8b9: Stack[-1] = "blood" // @poff=1121
0x8ba: Call2 0x894
...
0x8be: Push("b1q04_attack") // @poff=1133
0x8bf: Push((int) 1)
0x8c0: @ SetVariable(Stack[-2], Stack[-1])
0x8c1: Pop(2)
0x8c2: @ GetScene(Stack[-1])
0x8c3: Pop(0)
0x8c4: PushEmpty(object)
0x8c5: Call2 0x795

0x8c6: Pop(0)
0x8c7: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1159
0x8c8: Pop(1)
0x8c9: PushEmpty(object)
0x8ca: Stack[-4] = Stack[-1]
0x8cb: Push(-1, 0); TaskCall(6)
0x8cc: Call2 0x5c7

0x8cd: Pop(-1, 0); TaskReturn
0x8ce: Pop(1)
0x8cf: Return(); Pop(2)

0x8d0: Stack[-1] = 0
0x8d1: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0x8d2: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x8d3: Stack[-5] = (int) 250000
0x8d4: Push(CvectorIndex(Stack[-6], 1))
0x8d5: Push((int) 1000)
0x8d6: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8d7: Pop(0); Push(Stack[-14] * Stack[-14]);
0x8d8: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x8d9: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x8da: PushEmpty(float, float, float, float)
0x8db: Stack[-9] = Stack[-3]
0x8dc: Stack[-8] = Stack[-2]
0x8dd: Stack[-7] = Stack[-1]
0x8de: Call2 0x7ac

0x8df: Stack[-4] = Stack[-6]
0x8e0: Pop(4)
0x8e1: Push((int) 0)
...
0x8e6: PushEmpty(float, float, float, float, float)
0x8e7: Stack[-10] = Stack[-4]
0x8e8: Stack[-9] = Stack[-3]
0x8e9: Stack[-8] = Stack[-2]
0x8ea: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x8eb: Call2 0x7b3

0x8ec: Pop(4)
0x8ed: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x8ee: Push(CVector(0.0, 500.0, 0.0))
0x8ef: Pop(1); Push(Stack[-1] * Stack[-2]);
0x8f0: Pop(1); Push(Stack[-1] * Stack[-2]);
0x8f1: Pop(1); Push(Stack[-7] + Stack[-1]);
0x8f2: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x8f3: Return(); Pop(12)
