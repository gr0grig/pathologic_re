...
0x6a8: Push((float)0.699999988079071)
0x6a9: Push((int) 500)
...
0x6b3: Pop(0)
0x6b4: @@ add(Stack[-3]); Obj=1 // @poff=738
0x6b5: Pop(0)
0x6b6: Push((int) 16)
...
0x6d7: Stack[-2] = (int) 0
0x6d8: Push("all") // @poff=0
0x6d9: PushEmpty(string, int)
0x6da: Stack[-5] = Stack[-1]
0x6db: Call2 0x6cf
...
0x6f1: Stack[-7] = Stack[-3]
0x6f2: Stack[-6] = Stack[-2]
...
0x6f9: Stack[-11] = Stack[-5]
0x6fa: Stack[-10] = Stack[-4]
...
0x736: Pop(0)
0x737: @@ SetItemName(Stack[-7]); Obj=3 // @poff=857
0x738: Pop(0)
0x739: Push("Organ") // @poff=869
0x73a: Push((int) 1)
0x73b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=590
0x73c: Pop(2)
0x73d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=881
0x73e: Pop(0)
0x73f: Push((int) 0)
0x740: Push((int) 1)
...
0x74d: Stack[-1] = "liver" // @poff=891
0x74e: Call2 0x734

0x74f: Pop(1)
0x750: PushEmpty(string)
0x751: Stack[-1] = "kidney" // @poff=903
0x752: Call2 0x734

0x753: Pop(1)
0x754: PushEmpty(string)
0x755: Stack[-1] = "heart" // @poff=917
0x756: Call2 0x734

0x757: Pop(1)
0x758: PushEmpty(string)
0x759: Stack[-1] = "blood" // @poff=929
0x75a: Call2 0x734
...
0x75e: Push("b1q04_attack") // @poff=941
0x75f: Push((int) 1)
...
0x766: Pop(0)
0x767: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=967
0x768: Pop(1)
0x769: PushEmpty(object)
0x76a: Stack[-4] = Stack[-1]
