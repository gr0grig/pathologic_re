...
// @pool_raw:
// @pool_encoding:utf8
...
0x83a: Push("Can't find lsh animation : ") // @poff=937
...
0x849: Push("Can't find lsh animation : ") // @poff=937
...
0x892: Push((float)9.999999974752427e-07)
...
0x89c: Stack[-2] = Stack[-3]
0x89d: GOTO 0x89f

0x89e: Stack[-1] = Stack[-3]
0x89f: Return(); Pop(0)
...
0x8f0: Stack[-1] = Stack[-2]
0x8f1: Pop(1)
0x8f2: Push("b1q05PatrolGroup") // @poff=1007
0x8f3: Push("pt_b1q05_patrol1") // @poff=1041
0x8f4: Push((int) 0)
...
0x8f8: Pop(0)
0x8f9: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1075
0x8fa: Pop(5)
0x8fb: PushEmpty()
0x8fc: Call2 0x913
...
0x908: Pop(1)
0x909: Stack[-2] = "pt_b1q05_patrol1" // @poff=1041
0x90a: Stack[-1] = (int) 2
0x90b: Call2 0x967
...
0x90f: Pop(0)
0x910: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1083
0x911: Pop(1)
0x912: Return(); Pop(0)
...
0x932: Push("Can't retrieve diary root") // @poff=1091
0x933: @ Trace(Stack[-1])
0x934: Pop(1)
0x935: Stack[-3] = (bool) 0
0x936: Return(); Pop(2)

0x937: Stack[-1] = Stack[-3]
0x938: Return(); Pop(2)
...
0x93e: Pop(1)
0x93f: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1143
0x940: Pop(0)
0x941: Pop(0); Push((bool) Stack[-2] == 0)
0x942: IF (Stack[-1] == 0) GOTO 0x949; Pop(1)

0x943: Push("Can't find diary parent with id: ") // @poff=1148
...
0x949: @@ AddChild(Stack[-8]); Obj=2 // @poff=1216
0x94a: Pop(0)
0x94b: Push((int) 7)
0x94c: @ SendWorldWndMessage(Stack[-1])
0x94d: Pop(1)
0x94e: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1225
0x94f: Pop(0)
...
0x958: Pop(0)
0x959: Pop(0); PushNull((bool) Stack[-2] == 0)
0x95a: IF (Stack[-1] == 0) GOTO 0x961; Pop(1)

0x95b: Push("Can't find main outdoor scene") // @poff=1237
0x95c: @ Trace(Stack[-1])
0x95d: Pop(1)
0x95e: Stack[-1] = 0
...
0x961: @@ GetMap(Stack[-1]); Obj=2 // @poff=1297
0x962: Pop(0)
0x963: Stack[-1] = Stack[-5]
0x964: Return(); Pop(4)
...
0x969: Pop(0)
0x96a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x96b: IF (Stack[-1] == 0) GOTO 0x970; Pop(1)

0x96c: Push("Can't find main outdoor scene") // @poff=1237
0x96d: @ Trace(Stack[-1])
0x96e: Pop(1)
0x96f: Return(); Pop(8)

0x970: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1304
0x971: Pop(0)
0x972: Pop(0); Push((bool) Stack[-1] == 0)
0x973: IF (Stack[-1] == 0) GOTO 0x97a; Pop(1)

0x974: Push("Warning: outdoor scene locator ") // @poff=1315
0x975: Pop(1); Push(Stack[-1] + Stack[-11]);
0x976: Push(" doesnt exist") // @poff=1379
0x977: Pop(2); Push(Stack[-2] + Stack[-1]);
0x978: @ Trace(Stack[-1])
0x979: Pop(1)
0x97a: @@ GetMap(Stack[-11]); Obj=2 // @poff=1297
0x97b: Pop(0)
0x97c: Pop(0); PushNull((bool) Stack[-11] == 0)
0x97d: IF (Stack[-1] == 0) GOTO 0x982; Pop(1)

0x97e: Push("Can't find map") // @poff=1407
0x97f: @ Trace(Stack[-1])
0x980: Pop(1)
0x981: Return(); Pop(8)
...
0x984: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1437
0x985: Pop(2)
0x986: Return(); Pop(8)

0x987: Stack[-2] = 0
0x988: PushEmpty(int, int)
0x989: Push("branch") // @poff=1450
...
0x99a: Push("branch") // @poff=1450
0x99b: @ GetVariable(Stack[-1], Stack[-2])
0x99c: Pop(1)
0x99d: Stack[-1] = Stack[-3]
0x99e: Return(); Pop(2)
...
0x9ae: Pop(0)
0x9af: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1464
0x9b0: Pop(0)
0x9b1: Push("Organ") // @poff=1476
0x9b2: Push((int) 1)
0x9b3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=770
0x9b4: Pop(2)
0x9b5: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1488
0x9b6: Pop(0)
0x9b7: Push((int) 0)
0x9b8: Push((int) 1)
...
0x9c5: Stack[-1] = "liver" // @poff=1498
0x9c6: Call2 0x9ac

0x9c7: Pop(1)
0x9c8: PushEmpty(string)
0x9c9: Stack[-1] = "kidney" // @poff=1510
0x9ca: Call2 0x9ac

0x9cb: Pop(1)
0x9cc: PushEmpty(string)
0x9cd: Stack[-1] = "heart" // @poff=1524
0x9ce: Call2 0x9ac

0x9cf: Pop(1)
0x9d0: PushEmpty(string)
0x9d1: Stack[-1] = "blood" // @poff=1536
0x9d2: Call2 0x9ac
...
0x9d9: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1548
0x9da: Return(); Pop(0)

0x9db: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1588
0x9dc: Return(); Pop(0)
...
0x9e0: Push("b1q05ToAttack") // @poff=1632
...
0x9e6: Push("b1q05ToAttack") // @poff=1632
0x9e7: Push((int) 1)
...
0x9f0: Pop(0)
0x9f1: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1660
0x9f2: Pop(1)
0x9f3: PushEmpty()
0x9f4: Call2 0x9bd
