...
Strings:
	...
	W:quest_b1_05
	W:rat_dead
// @pool_raw:
...
0xae: Pop(0)
0xaf: Stack[-1] = Stack[-4]
0xb0: Return(); Pop(2)

0xb1: Stack[-1] = 0
0xb2: Return(); Pop(0)

0xb3: Push("death") // @poff=38
0xb4: @ Speak(Stack[-1])
0xb5: Pop(1)
0xb6: PushEmpty(string)
0xb7: Stack[-1] = "die" // @poff=50
0xb8: Call2 0xbb
...
0xd2: Pop(1)
0xd3: Push("all") // @poff=58
0xd4: @ PlayAnimation(Stack[-1], Stack[-2])
0xd5: Pop(1)
0xd6: @ WaitForAnimEnd()
0xd7: Pop(0)
0xd8: Push("all") // @poff=58
...
0xf1: @@@ GetPosition(Stack[-6]); Obj=0 // @poff=66
0xf2: Pop(0)
...
0x108: Pop(0)
0x109: Push("all") // @poff=58
0x10a: Push("attack_begin") // @poff=92
...
0x127: Pop(1)
0x128: Push("all") // @poff=58
0x129: Push("attack_end") // @poff=118
...
0x164: PushEmpty()
0x165: Push("player_shot") // @poff=14
...
0x177: Stack[-10] = Stack[-5]
0x178: Push((float)0.8999999761581421)
...
0x17e: Stack[-6] = Stack[-7]
0x17f: Pop(6)
0x180: PushEmpty()
0x181: Call2 0x18f

0x182: Pop(0)
0x183: Stack[-1] = Stack[-5]
0x184: Return(); Pop(2)
...
0x1c3: PushEmpty()
0x1c4: Push("player_shot") // @poff=14
...
0x1d4: Stack[-17] = Stack[-7]
0x1d5: PushEmpty(bool, object)
0x1d6: Stack[-23] = Stack[-1]
0x1d7: Call2 0x254
...
0x1dd: @@ GetPosition(Stack[-5]); Obj=21 // @poff=66
0x1de: Pop(0)
...
0x1f4: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=148
0x1f5: Pop(0)
...
0x206: Push((int) 0)
0x207: Push((float)0.30000001192092896)
...
0x229: Push((int) 0)
0x22a: Push((float)0.30000001192092896)
...
0x258: Stack[-2] = Stack[-4]
0x259: Pop(2)
0x25a: Return(); Pop(0)

0x25b: Stack[-1] = "walk" // @poff=162
0x25c: Return(); Pop(0)

0x25d: Stack[-1] = "run" // @poff=140
0x25e: Return(); Pop(0)

0x25f: PushEmpty()
0x260: Stack[3 + Tasks[-1].StackPointer] = Stack[-1]
0x261: Push("retreat") // @poff=172
0x262: @ Speak(Stack[-1])
0x263: Pop(1)
0x264: Push((int) 110)
0x265: Push((int) 1)
...
0x27f: Pop(0)
0x280: @@@ GetPosition(Stack[-1]); Obj=3 // @poff=66
0x281: Pop(0)
0x282: PushEmpty(float, cvector, cvector)
0x283: Stack[-5] = Stack[-2]
...
0x295: Stack[-5] = Stack[-2]
0x296: Stack[-4] = Stack[-1]
0x297: Call2 0x4ef
...
0x2bb: Pop(0)
0x2bc: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=66
0x2bd: Pop(0)
...
0x2da: Stack[-1] = (float) 1.7453293800354004
0x2db: Call2 0x2b9

0x2dc: Stack[-2] = Stack[-7]
0x2dd: Pop(2)
...
0x2e3: Stack[-1] = (float) 2.6179938316345215
0x2e4: Call2 0x2b9
...
0x2eb: Push("Can't retreat, distance: ") // @poff=188
...
0x301: Push((int) 1)
0x302: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x303: Pop(1)
0x304: Push(Stack[-3])
0x305: IF (Stack[-1] == 0) GOTO 0x31d; Pop(1)

0x306: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x30b: Stack[-1] = (float) 2.6179938316345215
0x30c: Call2 0x2b9

0x30d: Stack[-2] = Stack[-4]
0x30e: Pop(2)
...
0x31e: IF (Stack[-1] == 1) GOTO 0x301; Pop(1)
...
0x325: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x334: Stack[-1] = (float) 1.7453293800354004
0x335: Call2 0x2b9
...
0x344: IF (Stack[-1] == 1) GOTO 0x34a; Pop(1)
...
0x361: Stack[-2] = Stack[-3]
0x362: Pop(2)
0x363: PushEmpty(float, cvector, cvector)
0x364: Stack[-5] = Stack[-2]
0x365: Stack[-4] = Stack[-1]
0x366: Call2 0x46f

0x367: Pop(2)
0x368: Push((float)-0.3420201241970062)
...
0x375: Stack[-2] = "bullet" // @poff=250
0x376: Return(); Pop(0)

0x377: Stack[-2] = "phys" // @poff=264
0x378: Return(); Pop(0)
...
0x380: Pop(0)
0x381: @@ GetPosition(Stack[-1]); Obj=5 // @poff=66
0x382: Pop(0)
...
0x38b: Push("HasProperty") // @poff=274
0x38c: Push((int) 2)
...
0x392: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=298
0x393: Pop(0)
...
0x398: Stack[-18] = Stack[-2]
0x399: Stack[-1] = "health" // @poff=0
0x39a: Call2 0x38a
...
0x3a1: Stack[-18] = Stack[-2]
0x3a2: Stack[-1] = "armor" // @poff=310
0x3a3: Call2 0x38a
...
0x3a9: Push("armor") // @poff=310
0x3aa: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=322
0x3ab: Pop(1)
0x3ac: Push("armor_") // @poff=334
0x3ad: PushEmpty(string, int)
0x3ae: Stack[-16] = Stack[-1]
0x3af: Call2 0x36b

0x3b0: Pop(1)
0x3b1: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3b2: PushEmpty(bool, object, string)
0x3b3: Stack[-18] = Stack[-2]
0x3b4: Stack[-8] = Stack[-1]
0x3b5: Call2 0x38a
...
0x3bb: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=322
0x3bc: Pop(0)
...
0x3c3: Stack[-3] = Stack[-6]
0x3c4: Pop(3)
0x3c5: Push("health") // @poff=0
0x3c6: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=322
0x3c7: Pop(1)
0x3c8: Push((int) 1)
0x3c9: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3ca: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3cb: Push("health") // @poff=0
...
0x3d1: Pop(3)
0x3d2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=348
0x3d3: Pop(2)
0x3d4: PushEmpty(bool, object)
0x3d5: Stack[-17] = Stack[-1]
0x3d6: Call2 0x385
...
0x3dc: Pop(1)
0x3dd: Stack[-1] = Stack[-16]
0x3de: Return(); Pop(12)

0x3df: PushEmpty(bool, bool)
0x3e0: @@ IsDead(Stack[-1]); Obj=3 // @poff=360
0x3e1: Pop(0)
0x3e2: Stack[-1] = Stack[-4]
0x3e3: Return(); Pop(2)

0x3e4: PushEmpty(object, object, object, object)
0x3e5: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3f9: Pop(0)
0x3fa: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3fb: IF (Stack[-1] == 0) GOTO 0x3fe; Pop(1)

0x3fc: Stack[-6] = (bool) 0
0x3fd: Return(); Pop(4)

0x3fe: @@ GetScene(Stack[-1]); Obj=5 // @poff=381
0x3ff: Pop(0)
...
0x413: Stack[-1] = "noaccess" // @poff=390
0x414: Call2 0x38a
...
0x41a: Push("noaccess") // @poff=390
0x41b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=322
0x41c: Pop(1)
0x41d: Push((int) 0)
...
0x452: Push((float)9.999999974752427e-07)
...
0x479: Pop(0)
0x47a: @@ add(Stack[-4]); Obj=1 // @poff=408
0x47b: Pop(0)
0x47c: @@ add(Stack[-3]); Obj=1 // @poff=408
0x47d: Pop(0)
0x47e: Push((int) 3)
...
0x484: @@ GetItemID(Stack[-3]); Obj=8 // @poff=412
0x485: Pop(0)
0x486: Push("Category") // @poff=422
0x487: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x488: Pop(1)
0x489: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=440
0x48a: Pop(0)
0x48b: Pop(0); Push((bool) Stack[-1] == 0)
0x48c: IF (Stack[-1] == 0) GOTO 0x490; Pop(1)

0x48d: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=448
0x48e: Pop(0)
0x48f: GOTO 0x495

0x490: PushEmpty(int, int)
0x491: Stack[-5] = Stack[-2]
0x492: Stack[-9] = Stack[-1]
0x493: Call2 0x477
...
0x498: Pop(0)
0x499: @@ add(Stack[-3]); Obj=1 // @poff=408
0x49a: Pop(0)
0x49b: Push((int) 0)
0x49c: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x49d: IF (Stack[-1] == 0) GOTO 0x4a2; Pop(1)

0x49e: Push((float)0.699999988079071)
0x49f: Push((int) 500)
0x4a0: @ RumblePlay(Stack[-2], Stack[-1])
0x4a1: Pop(2)
0x4a2: Push((int) 15)
...
0x4a8: @ FindActor(Stack[-1], Stack[-4])
0x4a9: Pop(0)
0x4aa: Pop(0); PushNull((bool) Stack[-1] == 0)
0x4ab: IF (Stack[-1] == 0) GOTO 0x4ae; Pop(1)

0x4ac: Stack[-5] = (bool) 0
0x4ad: Return(); Pop(2)

0x4ae: @ Trigger(Stack[-1], Stack[-3])
0x4af: Pop(0)
0x4b0: Stack[-5] = (bool) 1
0x4b1: Return(); Pop(2)

0x4b2: Stack[-1] = 0
0x4b3: PushEmpty(object, object)
0x4b4: @ GetScene(Stack[-1])
0x4b5: Pop(0)
0x4b6: Push("battle") // @poff=458
0x4b7: PushEmpty(object)
0x4b8: Call2 0x449

0x4b9: Pop(0)
0x4ba: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x4bb: Pop(2)
0x4bc: Return(); Pop(2)
...
0x4d7: Push(-1, 1); TaskCall(3)
0x4d8: Call2 0xe4

0x4d9: Pop(-1, 1); TaskReturn
0x4da: Pop(1)
0x4db: @ ResetAAS()
0x4dc: Pop(0)
0x4dd: Return(); Pop(0)
...
0x4e1: Push(-1, 1); TaskCall(3)
0x4e2: Call2 0xe4

0x4e3: Pop(-1, 1); TaskReturn
0x4e4: Pop(1)
0x4e5: @ ResetAAS()
0x4e6: Pop(0)
0x4e7: Return(); Pop(0)
...
0x4e8: PushEmpty()
0x4e9: PushEmpty()
0x4ea: Push(-0, 0); TaskCall(2)
0x4eb: Call2 0xb3

0x4ec: Pop(-0, 0); TaskReturn
0x4ed: Pop(0)
0x4ee: Return(); Pop(0)

0x4ef: PushEmpty(float, bool, float, bool)
0x4f0: Push("health") // @poff=0
0x4f1: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x4f2: IF (Stack[-1] == 0) GOTO 0x508; Pop(1)

0x4f3: Push("health") // @poff=0
0x4f4: @ GetProperty(Stack[-1], Stack[-3])
0x4f5: Pop(1)
0x4f6: Push(GlobalVars[0])
0x4f7: Stack[-2] = Stack[-3] < Stack[-1]; Pop(1);
0x4f8: Push(GlobalVars[0])
0x4f9: Stack[-3] = Stack[-1]
0x4fa: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x506: Stack[-7] = (bool) 1
0x507: Return(); Pop(4)

0x508: Stack[-7] = (bool) 0
0x509: Return(); Pop(4)

0x50a: PushEmpty(float, float)
0x50b: Push("health") // @poff=0
0x50c: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x50d: IF (Stack[-1] == 0) GOTO 0x528; Pop(1)

0x50e: Push("health") // @poff=0
0x50f: @ GetProperty(Stack[-1], Stack[-2])
0x510: Pop(1)
0x511: Push((int) 0)
0x512: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x513: IF (Stack[-1] == 0) GOTO 0x516; Pop(1)

0x514: @ SignalDeath(Stack[-4])
0x515: Pop(0)
...
0x521: IF (Stack[-1] == 0) GOTO 0x528; Pop(1)

0x522: PushEmpty(object)
0x523: Stack[-5] = Stack[-1]
0x524: Push(-1, 4); TaskCall(5)
0x525: Call2 0x25f

0x526: Pop(-1, 4); TaskReturn
0x527: Pop(1)
0x528: Return(); Pop(2)
...
0x530: PushEmpty(float, object, float, int)
0x531: Stack[-7] = Stack[-3]
0x532: Stack[-2] = (float) 0.02500000037252903
0x533: Stack[-1] = (int) 0
0x534: Call2 0x396

0x535: Stack[-4] = Stack[-5]
0x536: Pop(4)
0x537: Push((int) 7)
0x538: Push((float)0.02500000037252903)
0x539: @ ReportHit(Stack[-5], Stack[-2], Stack[-3], Stack[-1])
0x53a: Pop(2)
0x53b: Return(); Pop(2)

0x53c: PushEmpty(object, float, object, float)
0x53d: @ CreateInvItem(Stack[-2])
0x53e: Pop(0)
0x53f: Push("rat") // @poff=472
0x540: @@ SetItemName(Stack[-1]); Obj=3 // @poff=480
0x541: Pop(1)
0x542: Push((float)0.25)
0x543: Push((float)0.5)
0x544: @ rand(Stack[-3], Stack[-2], Stack[-1])
0x545: Pop(2)
0x546: Push("quality") // @poff=492
0x547: @@ SetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=348
0x548: Pop(1)
0x549: PushEmpty(object, object, int)
0x54a: Stack[-8] = Stack[-3]
0x54b: Stack[-5] = Stack[-2]
0x54c: Stack[-1] = (int) 1
0x54d: Call2 0x483

0x54e: Pop(3)
0x54f: PushEmpty(object)
0x550: Call2 0x449

0x551: Pop(0)
0x552: @ RemoveActor(Stack[-1])
0x553: Pop(1)
0x554: Return(); Pop(4)
...
0x55e: PushEmpty(bool, string, string)
0x55f: Stack[-2] = "quest_b1_05" // @poff=508
0x560: Stack[-1] = "rat_dead" // @poff=532
0x561: Call2 0x4a7
