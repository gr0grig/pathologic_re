...
// @pool_raw:
// @pool_encoding:utf8
...
0x254: Stack[-1] = "Serious" // @poff=178
0x255: Call2 0x18e
...
0x278: Stack[-1] = "Serious" // @poff=178
0x279: Call2 0x18e
...
0x28f: Stack[-1] = "Serious" // @poff=178
0x290: Call2 0x18e

0x291: Pop(1)
0x292: Push((int) 530979)
0x293: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x294: Pop(1)
0x295: @@@ ClearReplies(); Obj=0 // @poff=116
0x296: Pop(0)
...
0x2ca: Stack[-1] = "Serious" // @poff=178
0x2cb: Call2 0x18e
...
0x2e1: Stack[-1] = "Serious" // @poff=178
0x2e2: Call2 0x18e
...
0x33b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=226
0x33c: Pop(0)
0x33d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x33e: Pop(0)
...
0x3aa: Push("voice_common") // @poff=262
0x3ab: Push((int) 1)
...
0x3b2: Push("voice_common") // @poff=262
0x3b3: Push((int) 0)
...
0x3c5: Push("voice_common") // @poff=262
0x3c6: Push((int) 1)
...
0x3d3: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x3d4: Pop(1)
...
0x3fe: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x3ff: Pop(1)
...
0x413: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x414: Pop(1)
0x415: PushEmpty(bool, string)
0x416: Stack[-3] = Stack[-1]
0x417: Call2 0x43a

0x418: Stack[-2] = Stack[-14]
0x419: Pop(2)
0x41a: Return(); Pop(10)
...
0x426: Push("Can't find lsh animation : ") // @poff=320
...
0x435: Push("Can't find lsh animation : ") // @poff=320
...
0x459: Push((float)9.999999974752427e-07)
...
0x46a: Push("Door ") // @poff=376
0x46b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x46c: Push(" not found") // @poff=388
0x46d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x46e: @ Trace(Stack[-1])
0x46f: Pop(1)
0x470: GOTO 0x474

0x471: Push("locked") // @poff=410
0x472: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=424
0x473: Pop(1)
0x474: Return(); Pop(2)
...
0x478: Pop(0)
0x479: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x490: PushEmpty()
0x491: Push("oob1Spi4ka1") // @poff=436
0x492: Push((int) 1)
...
0x49a: Pop(1)
0x49b: Push("b1q05Spi4kaGotoLaska") // @poff=460
0x49c: Push("pt_map_laska") // @poff=502
0x49d: Push((int) 3)
...
0x4a1: Pop(0)
0x4a2: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=528
0x4a3: Pop(5)
0x4a4: Push("b1q05Spi4kaGotoMishka") // @poff=536
0x4a5: Push("pt_map_mishka") // @poff=580
0x4a6: Push((int) 3)
...
0x4aa: Pop(0)
0x4ab: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=528
0x4ac: Pop(5)
0x4ad: PushEmpty()
0x4ae: Call2 0x4ea
...
0x4b1: Stack[-2] = "quest_b1_05" // @poff=608
0x4b2: Stack[-1] = "completed" // @poff=632
0x4b3: Call2 0x476
...
0x4bc: Pop(1)
0x4bd: Stack[-2] = "pt_map_laska" // @poff=502
0x4be: Stack[-1] = (int) 2
0x4bf: Call2 0x531
...
0x4c3: Pop(0)
0x4c4: @@ ShowMap(Stack[-1]); Obj=2 // @poff=652
0x4c5: Pop(1)
0x4c6: Return(); Pop(0)
...
0x4cc: Pop(1)
0x4cd: Stack[-2] = "pt_map_mishka" // @poff=580
0x4ce: Stack[-1] = (int) 2
0x4cf: Call2 0x531
...
0x4d3: Pop(0)
0x4d4: @@ ShowMap(Stack[-1]); Obj=2 // @poff=652
0x4d5: Pop(1)
0x4d6: Return(); Pop(0)

0x4d7: PushEmpty()
0x4d8: PushEmpty(string, bool)
0x4d9: Stack[-2] = "vagon_mishka@door1" // @poff=660
...
0x4e0: Stack[-1] = "oob1Spi4ka1" // @poff=436
0x4e1: Call2 0x460
...
0x4fc: Push("Can't retrieve diary root") // @poff=698
0x4fd: @ Trace(Stack[-1])
0x4fe: Pop(1)
0x4ff: Stack[-3] = (bool) 0
0x500: Return(); Pop(2)

0x501: Stack[-1] = Stack[-3]
0x502: Return(); Pop(2)
...
0x508: Pop(1)
0x509: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=750
0x50a: Pop(0)
0x50b: Pop(0); Push((bool) Stack[-2] == 0)
0x50c: IF (Stack[-1] == 0) GOTO 0x513; Pop(1)

0x50d: Push("Can't find diary parent with id: ") // @poff=755
...
0x513: @@ AddChild(Stack[-8]); Obj=2 // @poff=823
0x514: Pop(0)
0x515: Push((int) 7)
0x516: @ SendWorldWndMessage(Stack[-1])
0x517: Pop(1)
0x518: @@ GetCategory(Stack[-1]); Obj=8 // @poff=832
0x519: Pop(0)
...
0x522: Pop(0)
0x523: Pop(0); PushNull((bool) Stack[-2] == 0)
0x524: IF (Stack[-1] == 0) GOTO 0x52b; Pop(1)

0x525: Push("Can't find main outdoor scene") // @poff=844
0x526: @ Trace(Stack[-1])
0x527: Pop(1)
0x528: Stack[-1] = 0
...
0x52b: @@ GetMap(Stack[-1]); Obj=2 // @poff=904
0x52c: Pop(0)
0x52d: Stack[-1] = Stack[-5]
0x52e: Return(); Pop(4)
...
0x533: Pop(0)
0x534: Pop(0); PushNull((bool) Stack[-2] == 0)
0x535: IF (Stack[-1] == 0) GOTO 0x53a; Pop(1)

0x536: Push("Can't find main outdoor scene") // @poff=844
0x537: @ Trace(Stack[-1])
0x538: Pop(1)
0x539: Return(); Pop(8)

0x53a: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=911
0x53b: Pop(0)
0x53c: Pop(0); Push((bool) Stack[-1] == 0)
0x53d: IF (Stack[-1] == 0) GOTO 0x544; Pop(1)

0x53e: Push("Warning: outdoor scene locator ") // @poff=922
0x53f: Pop(1); Push(Stack[-1] + Stack[-11]);
0x540: Push(" doesnt exist") // @poff=986
0x541: Pop(2); Push(Stack[-2] + Stack[-1]);
0x542: @ Trace(Stack[-1])
0x543: Pop(1)
0x544: @@ GetMap(Stack[-11]); Obj=2 // @poff=904
0x545: Pop(0)
0x546: Pop(0); PushNull((bool) Stack[-11] == 0)
0x547: IF (Stack[-1] == 0) GOTO 0x54c; Pop(1)

0x548: Push("Can't find map") // @poff=1014
0x549: @ Trace(Stack[-1])
0x54a: Pop(1)
0x54b: Return(); Pop(8)
...
0x54e: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1044
0x54f: Pop(2)
0x550: Return(); Pop(8)

0x551: Stack[-2] = 0
0x552: PushEmpty(int, int)
0x553: Push("branch") // @poff=1057
...
0x564: Push("mt_spi4ka") // @poff=1071
...
0x56e: Pop(2)
0x56f: Push("mt_spi4ka") // @poff=1071
0x570: Push((int) 1)
...
0x578: Stack[-1] = "ui/NPC_Spi4ka.png" // @poff=1091
0x579: Return(); Pop(0)

0x57a: Stack[-1] = "ui/NPC_Spi4ka_b.png" // @poff=1127
0x57b: Return(); Pop(0)
