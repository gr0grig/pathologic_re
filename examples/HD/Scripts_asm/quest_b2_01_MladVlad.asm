...
// @pool_raw:
// @pool_encoding:utf8
...
0x17f: Stack[-1] = "Untrust" // @poff=164
0x180: Call2 0xa4
...
0x1a8: Stack[-1] = "Untrust" // @poff=164
0x1a9: Call2 0xa4
...
0x21f: Stack[-2] = Stack[-5]
0x220: Pop(2)
0x221: Return(); Pop(2)

0x222: Stack[-1] = 0
0x223: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x224: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x225: @ RotateAsync(Stack[-2], Stack[-1])
0x226: Pop(2)
0x227: Return(); Pop(0)

0x228: PushEmpty(object, bool, object, bool)
0x229: Push("player") // @poff=212
...
0x304: Pop(0)
0x305: @@ GetPosition(Stack[-2]); Obj=7 // @poff=226
0x306: Pop(0)
...
0x315: @@ GetPosition(Stack[-1]); Obj=3 // @poff=226
0x316: Pop(0)
...
0x323: @@ GetPosition(Stack[-8]); Obj=20 // @poff=226
0x324: Pop(0)
0x325: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x326: Pop(0)
...
0x39a: Push("voice_common") // @poff=262
0x39b: Push((int) 0)
...
0x3ad: Push("voice_common") // @poff=262
0x3ae: Push((int) 1)
...
0x3bb: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x3bc: Pop(1)
...
0x3e6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x3e7: Pop(1)
...
0x3fb: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x3fc: Pop(1)
0x3fd: PushEmpty(bool, string)
0x3fe: Stack[-3] = Stack[-1]
0x3ff: Call2 0x422

0x400: Stack[-2] = Stack[-14]
0x401: Pop(2)
0x402: Return(); Pop(10)
...
0x40e: Push("Can't find lsh animation : ") // @poff=320
...
0x41d: Push("Can't find lsh animation : ") // @poff=320
...
0x478: Stack[-2] = Stack[-5]
0x479: Return(); Pop(4)

0x47a: PushEmpty()
0x47b: Push("oob2MladVladFactory1") // @poff=376
0x47c: Push((int) 1)
...
0x480: PushEmpty()
0x481: Push("oob2MladVladFactory2") // @poff=418
0x482: Push((int) 1)
...
0x486: PushEmpty()
0x487: Push("oob2MladVladFactory3") // @poff=460
0x488: Push((int) 1)
...
0x492: Stack[-1] = "oob2MladVladFactory1" // @poff=376
0x493: Call2 0x448
...
0x499: Stack[-1] = "oob2MladVladFactory2" // @poff=418
0x49a: Call2 0x448
...
0x4a2: Stack[-1] = "oob2MladVladFactory3" // @poff=460
0x4a3: Call2 0x448
...
0x4ab: Stack[-2] = "quest_b2_01" // @poff=502
0x4ac: Stack[-1] = "remove_mladvlad" // @poff=526
0x4ad: Call2 0x44d
...
0x4b2: Stack[-1] = "oob2MladVladFactory1" // @poff=376
0x4b3: Call2 0x448
...
0x4be: Stack[-1] = "oob2MladVladFactory2" // @poff=418
0x4bf: Call2 0x448
...
0x4ca: Stack[-1] = "oob2MladVladFactory3" // @poff=460
0x4cb: Call2 0x448
...
0x4e9: Stack[-1] = "ui/NPC_MladVlad.png" // @poff=572
0x4ea: Return(); Pop(0)

0x4eb: Stack[-1] = "ui/NPC_MladVlad_b.png" // @poff=612
0x4ec: Return(); Pop(0)
