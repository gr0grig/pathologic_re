...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x30a: Push("Can't find lsh animation : ") // @poff=206
...
0x319: Push("Can't find lsh animation : ") // @poff=206
...
0x31f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x320: Pop(0)
...
0x341: Pop(0)
0x342: @@ add(Stack[-4]); Obj=1 // @poff=262
0x343: Pop(0)
0x344: @@ add(Stack[-3]); Obj=1 // @poff=262
0x345: Pop(0)
0x346: Push((int) 3)
...
0x34c: @@ GetItemID(Stack[-3]); Obj=8 // @poff=266
0x34d: Pop(0)
0x34e: Push("Category") // @poff=276
0x34f: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x350: Pop(1)
0x351: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=294
0x352: Pop(0)
0x353: Pop(0); Push((bool) Stack[-1] == 0)
0x354: IF (Stack[-1] == 0) GOTO 0x358; Pop(1)

0x355: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=302
0x356: Pop(0)
0x357: GOTO 0x35d

0x358: PushEmpty(int, int)
0x359: Stack[-5] = Stack[-2]
0x35a: Stack[-9] = Stack[-1]
0x35b: Call2 0x33f
...
0x360: Pop(0)
0x361: @@ SetItemName(Stack[-4]); Obj=1 // @poff=312
0x362: Pop(0)
0x363: PushEmpty(object, object, int)
0x364: Stack[-8] = Stack[-3]
0x365: Stack[-4] = Stack[-2]
...
0x36d: Pop(0)
0x36e: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x393: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=324
0x394: Return(); Pop(0)

0x395: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=364
0x396: Return(); Pop(0)
...
0x399: PushEmpty()
0x39a: Push("oob2TravnikWife1") // @poff=408
0x39b: Push((int) 1)
...
0x3a4: Stack[-2] = "quest_b2_02" // @poff=442
0x3a5: Stack[-1] = "fail" // @poff=466
0x3a6: Call2 0x36b
...
0x3b2: Stack[-2] = "quest_b2_02" // @poff=442
0x3b3: Stack[-1] = "move_bride" // @poff=488
0x3b4: Call2 0x36b
...
0x3b7: PushEmpty()
0x3b8: Push("white plet 3 is given") // @poff=510
0x3b9: @ Trace(Stack[-1])
0x3ba: Pop(1)
0x3bb: PushEmpty(object, string, int)
0x3bc: Stack[-5] = Stack[-3]
0x3bd: Stack[-2] = "grass_white_plet" // @poff=554
0x3be: Stack[-1] = (int) 3
0x3bf: Call2 0x35e
...
0x3c2: PushEmpty()
0x3c3: Push("savyur 3 is given") // @poff=588
0x3c4: @ Trace(Stack[-1])
0x3c5: Pop(1)
0x3c6: PushEmpty(object, string, int)
0x3c7: Stack[-5] = Stack[-3]
0x3c8: Stack[-2] = "grass_savyur" // @poff=624
0x3c9: Stack[-1] = (int) 3
0x3ca: Call2 0x35e
...
0x3cd: PushEmpty()
0x3ce: Push("playsound") // @poff=650
0x3cf: Push("giveitem") // @poff=670
...
0x405: Stack[-1] = "oob2TravnikWife1" // @poff=408
0x406: Call2 0x33a
...
0x42e: Push("Can't retrieve diary root") // @poff=688
0x42f: @ Trace(Stack[-1])
0x430: Pop(1)
...
0x439: Stack[-1] = Stack[-4]
0x43a: Pop(1)
0x43b: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=740
0x43c: Pop(0)
0x43d: Pop(0); Push((bool) Stack[-2] == 0)
0x43e: IF (Stack[-1] == 0) GOTO 0x445; Pop(1)

0x43f: Push("Can't find diary parent with id: ") // @poff=745
...
0x445: @@ AddChild(Stack[-8]); Obj=2 // @poff=813
0x446: Pop(0)
0x447: Push((int) 7)
0x448: @ SendWorldWndMessage(Stack[-1])
0x449: Pop(1)
0x44a: @@ GetCategory(Stack[-1]); Obj=8 // @poff=822
0x44b: Pop(0)
