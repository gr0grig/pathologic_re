...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x354: Push("Can't find lsh animation : ") // @poff=206
...
0x363: Push("Can't find lsh animation : ") // @poff=206
...
0x369: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x36a: Pop(0)
...
0x37d: Push((float)9.999999974752427e-07)
...
0x386: Pop(0)
0x387: Stack[-1] = Stack[-4]
0x388: Return(); Pop(2)

0x389: PushEmpty(object, object)
0x38a: @ CreateIntVector(Stack[-1])
0x38b: Pop(0)
0x38c: @@ add(Stack[-4]); Obj=1 // @poff=262
0x38d: Pop(0)
0x38e: @@ add(Stack[-3]); Obj=1 // @poff=262
0x38f: Pop(0)
0x390: Push((int) 3)
...
0x396: @@ GetItemID(Stack[-3]); Obj=8 // @poff=266
0x397: Pop(0)
0x398: Push("Category") // @poff=276
0x399: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x39a: Pop(1)
0x39b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=294
0x39c: Pop(0)
0x39d: Pop(0); Push((bool) Stack[-1] == 0)
0x39e: IF (Stack[-1] == 0) GOTO 0x3a2; Pop(1)

0x39f: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=302
0x3a0: Pop(0)
0x3a1: GOTO 0x3a7

0x3a2: PushEmpty(int, int)
0x3a3: Stack[-5] = Stack[-2]
...
0x3aa: Pop(0)
0x3ab: @@ SetItemName(Stack[-4]); Obj=1 // @poff=312
0x3ac: Pop(0)
0x3ad: PushEmpty(object, object, int)
0x3ae: Stack[-8] = Stack[-3]
0x3af: Stack[-4] = Stack[-2]
...
0x3dd: Stack[-1] = "ui/NPC_Morlok.png" // @poff=324
0x3de: Return(); Pop(0)

0x3df: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=360
0x3e0: Return(); Pop(0)
...
0x3e3: PushEmpty()
0x3e4: Push("oob2Gatherer1") // @poff=400
0x3e5: Push((int) 1)
...
0x3fa: Stack[-2] = "quest_b2_02" // @poff=440
0x3fb: Stack[-1] = "completed" // @poff=464
0x3fc: Call2 0x3b5
...
0x3ff: PushEmpty()
0x400: Push("oob2Gatherer2") // @poff=484
0x401: Push((int) 1)
...
0x405: PushEmpty()
0x406: Push("playsound") // @poff=512
0x407: Push("giveitem") // @poff=532
0x408: @ TriggerWorld(Stack[-2], Stack[-1])
0x409: Pop(2)
0x40a: Return(); Pop(0)

0x40b: PushEmpty()
0x40c: Push("recipe9 is given") // @poff=550
0x40d: @ Trace(Stack[-1])
0x40e: Pop(1)
0x40f: PushEmpty(object, string, int)
0x410: Stack[-5] = Stack[-3]
0x411: Stack[-2] = "recipe9" // @poff=584
0x412: Stack[-1] = (int) 1
0x413: Call2 0x3a8
...
0x418: Stack[-1] = "oob2Gatherer1" // @poff=400
0x419: Call2 0x384
...
0x448: Stack[-1] = "oob2Gatherer2" // @poff=484
0x449: Call2 0x384
...
0x47e: Push("Can't retrieve diary root") // @poff=600
0x47f: @ Trace(Stack[-1])
0x480: Pop(1)
...
0x48a: Pop(1)
0x48b: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=652
0x48c: Pop(0)
0x48d: Pop(0); Push((bool) Stack[-2] == 0)
0x48e: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x48f: Push("Can't find diary parent with id: ") // @poff=657
...
0x495: @@ AddChild(Stack[-8]); Obj=2 // @poff=725
0x496: Pop(0)
0x497: Push((int) 7)
0x498: @ SendWorldWndMessage(Stack[-1])
0x499: Pop(1)
0x49a: @@ GetCategory(Stack[-1]); Obj=8 // @poff=734
0x49b: Pop(0)
