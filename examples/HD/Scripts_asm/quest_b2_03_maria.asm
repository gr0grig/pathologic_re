...
// @pool_raw:
// @pool_encoding:utf8
...
0x99: Stack[-1] = "Mysterious" // @poff=150
0x9a: Call2 0xe0
...
0xd1: Push("all") // @poff=172
0xd2: Push("idle") // @poff=180
...
0xda: Push("all") // @poff=172
0xdb: Push("idle") // @poff=180
...
0x187: Stack[-1] = "Mysterious" // @poff=150
0x188: Call2 0xe0
...
0x1f7: Stack[-1] = "Neutral" // @poff=190
0x1f8: Call2 0xe0
...
0x20e: Stack[-1] = "Neutral" // @poff=190
0x20f: Call2 0xe0
...
0x225: Stack[-1] = "Neutral" // @poff=190
0x226: Call2 0xe0
...
0x292: Stack[-1] = 0
0x293: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x294: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x295: @ RotateAsync(Stack[-2], Stack[-1])
0x296: Pop(2)
0x297: Return(); Pop(0)

0x298: PushEmpty(object, bool, object, bool)
0x299: Push("player") // @poff=238
...
0x2f6: Stack[-1] = "Neutral" // @poff=190
0x2f7: Call2 0x47a
...
0x305: Stack[-1] = "Neutral" // @poff=190
0x306: Call2 0x47a
...
0x31c: Stack[-1] = "Neutral" // @poff=190
0x31d: Call2 0x47a
...
0x374: Pop(0)
0x375: @@ GetPosition(Stack[-2]); Obj=7 // @poff=252
0x376: Pop(0)
...
0x37b: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=264
0x37c: Pop(0)
0x37d: Pop(0); Push(Stack[-1] + Stack[-3]);
0x37e: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=276
0x37f: Pop(1)
0x380: Return(); Pop(2)
...
0x38c: @@ GetPosition(Stack[-1]); Obj=3 // @poff=252
0x38d: Pop(0)
0x38e: PushEmpty(bool, cvector)
0x38f: Stack[-3] = Stack[-1]
0x390: Call2 0x381

0x391: Stack[-2] = Stack[-6]
0x392: Pop(2)
0x393: Return(); Pop(2)
...
0x39a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=252
0x39b: Pop(0)
0x39c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=288
0x39d: Pop(0)
...
0x409: Push("voice_common") // @poff=312
0x40a: Push((int) 1)
...
0x411: Push("voice_common") // @poff=312
0x412: Push((int) 0)
...
0x424: Push("voice_common") // @poff=312
0x425: Push((int) 1)
...
0x432: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=342
0x433: Pop(1)
...
0x45d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=342
0x45e: Pop(1)
...
0x472: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=264
0x473: Pop(1)
...
0x485: Push("Can't find lsh animation : ") // @poff=358
...
0x494: Push("Can't find lsh animation : ") // @poff=358
...
0x4b8: Push((float)9.999999974752427e-07)
...
0x4c6: Pop(0)
0x4c7: @@ add(Stack[-4]); Obj=1 // @poff=414
0x4c8: Pop(0)
0x4c9: @@ add(Stack[-3]); Obj=1 // @poff=414
0x4ca: Pop(0)
0x4cb: Push((int) 3)
...
0x4d3: Stack[-2] = "money" // @poff=418
0x4d4: Stack[-6] = Stack[-1]
0x4d5: Call2 0x37a
...
0x4e4: @@ GetItemID(Stack[-3]); Obj=8 // @poff=442
0x4e5: Pop(0)
0x4e6: Push("Category") // @poff=452
0x4e7: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x4e8: Pop(1)
0x4e9: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=470
0x4ea: Pop(0)
0x4eb: Pop(0); Push((bool) Stack[-1] == 0)
0x4ec: IF (Stack[-1] == 0) GOTO 0x4f0; Pop(1)

0x4ed: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=478
0x4ee: Pop(0)
0x4ef: GOTO 0x4f5

0x4f0: PushEmpty(int, int)
0x4f1: Stack[-5] = Stack[-2]
0x4f2: Stack[-9] = Stack[-1]
0x4f3: Call2 0x4c4
...
0x4f8: Pop(0)
0x4f9: @@ SetItemName(Stack[-4]); Obj=1 // @poff=488
0x4fa: Pop(0)
0x4fb: PushEmpty(object, object, int)
0x4fc: Stack[-8] = Stack[-3]
0x4fd: Stack[-4] = Stack[-2]
0x4fe: Stack[-6] = Stack[-1]
0x4ff: Call2 0x4e3
...
0x505: Pop(0)
0x506: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x530: PushEmpty()
0x531: Push("playsound") // @poff=500
0x532: Push("giveitem") // @poff=520
0x533: @ TriggerWorld(Stack[-2], Stack[-1])
0x534: Pop(2)
0x535: Return(); Pop(0)

0x536: PushEmpty()
0x537: Push("oob2MariaKabak1") // @poff=538
0x538: Push((int) 1)
...
0x551: Stack[-2] = "quest_b2_03" // @poff=586
0x552: Stack[-1] = "fail" // @poff=610
0x553: Call2 0x503
...
0x556: PushEmpty()
0x557: Push("recipe5 is given") // @poff=620
0x558: @ Trace(Stack[-1])
0x559: Pop(1)
0x55a: PushEmpty(object, string, int)
0x55b: Stack[-5] = Stack[-3]
0x55c: Stack[-2] = "recipe5" // @poff=654
0x55d: Stack[-1] = (int) 1
0x55e: Call2 0x4f6
...
0x561: PushEmpty()
0x562: Push("money 5000 is given") // @poff=670
0x563: @ Trace(Stack[-1])
0x564: Pop(1)
0x565: PushEmpty(object, int)
0x566: Stack[-4] = Stack[-2]
...
0x579: Stack[-1] = "oob2MariaKabak1" // @poff=538
0x57a: Call2 0x4bf
...
0x585: Stack[-1] = "b2q03_1" // @poff=570
0x586: Call2 0x4bf
...
0x591: Stack[-1] = "b2q03_1" // @poff=570
0x592: Call2 0x4bf
...
0x5c7: Push("Can't retrieve diary root") // @poff=722
0x5c8: @ Trace(Stack[-1])
0x5c9: Pop(1)
...
0x5d2: Stack[-1] = Stack[-4]
0x5d3: Pop(1)
0x5d4: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=774
0x5d5: Pop(0)
0x5d6: Pop(0); Push((bool) Stack[-2] == 0)
0x5d7: IF (Stack[-1] == 0) GOTO 0x5de; Pop(1)

0x5d8: Push("Can't find diary parent with id: ") // @poff=779
...
0x5de: @@ AddChild(Stack[-8]); Obj=2 // @poff=847
0x5df: Pop(0)
0x5e0: Push((int) 7)
0x5e1: @ SendWorldWndMessage(Stack[-1])
0x5e2: Pop(1)
0x5e3: @@ GetCategory(Stack[-1]); Obj=8 // @poff=856
0x5e4: Pop(0)
...
0x600: Stack[-1] = "ui/NPC_Maria.png" // @poff=882
0x601: Return(); Pop(0)

0x602: Stack[-1] = "ui/NPC_Maria_b.png" // @poff=916
0x603: Return(); Pop(0)
