...
Strings:
	...
	W:ui/NPC_Petr.png
	W:ui/NPC_Petr_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0xa1: Stack[-1] = "Untrust" // @poff=138
0xa2: Call2 0xd4

0xa3: Pop(1)
0xa4: Push((int) 531055)
0xa5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa6: Pop(1)
0xa7: @@@ ClearReplies(); Obj=0 // @poff=116
0xa8: Pop(0)
...
0xc5: Push("all") // @poff=154
0xc6: Push("idle") // @poff=162
...
0xce: Push("all") // @poff=154
0xcf: Push("idle") // @poff=162
...
0x13d: Stack[-1] = "Untrust" // @poff=138
0x13e: Call2 0xd4
...
0x16b: Stack[-1] = "Autizm" // @poff=172
0x16c: Call2 0xd4

0x16d: Pop(1)
0x16e: Push((int) 531244)
0x16f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x170: Pop(1)
0x171: @@@ ClearReplies(); Obj=0 // @poff=116
0x172: Pop(0)
...
0x1d5: Stack[-2] = Stack[-5]
0x1d6: Pop(2)
0x1d7: Return(); Pop(2)

0x1d8: Stack[-1] = 0
0x1d9: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1da: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1db: @ RotateAsync(Stack[-2], Stack[-1])
0x1dc: Pop(2)
0x1dd: Return(); Pop(0)

0x1de: PushEmpty(object, bool, object, bool)
0x1df: Push("player") // @poff=218
...
0x296: Stack[-3] = (int) 0
0x297: Push("all") // @poff=154
0x298: PushEmpty(string, int)
0x299: Stack[-6] = Stack[-1]
0x29a: Call2 0x40c
...
0x2ba: Pop(0)
0x2bb: @@ GetPosition(Stack[-2]); Obj=7 // @poff=232
0x2bc: Pop(0)
...
0x2c7: Pop(2)
0x2c8: Stack[-1] = Stack[-8]
0x2c9: Return(); Pop(6)

0x2ca: PushEmpty(cvector, cvector)
0x2cb: @@ GetPosition(Stack[-1]); Obj=3 // @poff=232
0x2cc: Pop(0)
0x2cd: PushEmpty(bool, cvector)
0x2ce: Stack[-3] = Stack[-1]
0x2cf: Call2 0x2c0

0x2d0: Stack[-2] = Stack[-6]
0x2d1: Pop(2)
0x2d2: Return(); Pop(2)
...
0x2d9: @@ GetPosition(Stack[-8]); Obj=20 // @poff=232
0x2da: Pop(0)
0x2db: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=244
0x2dc: Pop(0)
...
0x302: Pop(0)
0x303: Push((bool) 1)
0x304: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x305: Pop(1)
...
0x31e: Push((bool) 1)
0x31f: @ CameraSwitchToNormal(Stack[-1])
0x320: Pop(1)
...
0x326: Push("head") // @poff=258
0x327: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x328: Pop(1)
0x329: Push(Stack[-1])
0x32a: IF (Stack[-1] == 0) GOTO 0x32e; Pop(1)

0x32b: Push("head") // @poff=258
0x32c: @ UnlookAsync(Stack[-1])
0x32d: Pop(1)
0x32e: Return(); Pop(2)

0x32f: PushEmpty(int, int, int, int)
0x330: Push("voice_common") // @poff=268
0x331: @ GetVariable(Stack[-1], Stack[-3])
0x332: Pop(1)
0x333: Push(Stack[-2])
0x334: IF (Stack[-1] == 0) GOTO 0x355; Pop(1)

0x335: PushEmpty(bool, object)
0x336: Stack[-7] = Stack[-1]
0x337: Call2 0x369
...
0x343: Push((int) 2)
0x344: @ irand(Stack[-2], Stack[-1])
0x345: Pop(1)
0x346: Push(Stack[-1])
0x347: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x348: Push("voice_common") // @poff=268
0x349: Push((int) 1)
0x34a: Pop(1); Push(Stack[-4] + Stack[-1]);
0x34b: Push((int) 3)
...
0x350: Push("voice_common") // @poff=268
0x351: Push((int) 0)
...
0x361: Stack[-6] = (bool) 0
0x362: Return(); Pop(4)

0x363: Push("voice_common") // @poff=268
0x364: Push((int) 1)
0x365: @ SetVariable(Stack[-2], Stack[-1])
0x366: Pop(2)
0x367: Stack[-6] = (bool) 1
0x368: Return(); Pop(4)

0x369: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x36a: Stack[-5] = "c" // @poff=294
0x36b: Stack[-4] = (int) 0
0x36c: Push((int) 1)
0x36d: IF (Stack[-1] == 0) GOTO 0x379; Pop(1)

0x36e: Push((int) 1)
0x36f: Pop(1); Push(Stack[-5] + Stack[-1]);
0x370: Pop(1); Push(Stack[-6] + Stack[-1]);
0x371: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x372: Pop(1)
...
0x376: Push((int) 1)
0x377: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x378: GOTO 0x36c

0x379: Pop(0); Push((bool) Stack[-4] == 0)
0x37a: IF (Stack[-1] == 0) GOTO 0x37d; Pop(1)

0x37b: Stack[-12] = (bool) 0
0x37c: Return(); Pop(10)

0x37d: Stack[-2] = (int) 0
0x37e: Push((int) 1)
0x37f: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x380: IF (Stack[-1] == 0) GOTO 0x383; Pop(1)

0x381: @ irand(Stack[-2], Stack[-4])
0x382: Pop(0)
0x383: Push((int) 1)
0x384: Pop(1); Push(Stack[-3] + Stack[-1]);
0x385: Pop(1); Push(Stack[-6] + Stack[-1]);
0x386: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=310
0x387: Pop(1)
0x388: PushEmpty(bool, string)
0x389: Stack[-3] = Stack[-1]
0x38a: Call2 0x3d8

0x38b: Stack[-2] = Stack[-14]
0x38c: Pop(2)
0x38d: Return(); Pop(10)

0x38e: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x38f: Push("d") // @poff=264
0x390: PushEmpty(int)
0x391: Call2 0x403

0x392: Pop(0)
0x393: Pop(2); Push(Stack[-2] + Stack[-1]);
0x394: Push("m") // @poff=182
...
0x399: Push((int) 1)
0x39a: Pop(1); Push(Stack[-5] + Stack[-1]);
0x39b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x39c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x39d: Pop(1)
0x39e: Pop(0); Push((bool) Stack[-3] == 0)
0x39f: IF (Stack[-1] == 0) GOTO 0x3a1; Pop(1)

0x3a0: GOTO 0x3a4

0x3a1: Push((int) 1)
0x3a2: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3a3: GOTO 0x397

0x3a4: Pop(0); Push((bool) Stack[-4] == 0)
0x3a5: IF (Stack[-1] == 0) GOTO 0x3a8; Pop(1)

0x3a6: Stack[-12] = (bool) 0
0x3a7: Return(); Pop(10)

0x3a8: Stack[-2] = (int) 0
0x3a9: Push((int) 1)
0x3aa: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x3ab: IF (Stack[-1] == 0) GOTO 0x3ae; Pop(1)

0x3ac: @ irand(Stack[-2], Stack[-4])
0x3ad: Pop(0)
0x3ae: Push((int) 1)
0x3af: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3b0: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3b1: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=310
0x3b2: Pop(1)
0x3b3: PushEmpty(bool, string)
0x3b4: Stack[-3] = Stack[-1]
0x3b5: Call2 0x3d8

0x3b6: Stack[-2] = Stack[-14]
0x3b7: Pop(2)
0x3b8: Return(); Pop(10)

0x3b9: PushEmpty(bool, float, float, bool, float, float)
0x3ba: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3bb: Pop(0)
0x3bc: Push(Stack[-3])
0x3bd: IF (Stack[-1] == 0) GOTO 0x3c4; Pop(1)

0x3be: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3bf: Pop(0)
0x3c0: Push((bool) 0)
...
0x3c4: Push("Can't find lsh animation : ") // @poff=322
0x3c5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3c6: @ Trace(Stack[-1])
0x3c7: Pop(1)
0x3c8: Return(); Pop(6)

0x3c9: PushEmpty(bool, float, float, bool, float, float)
0x3ca: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3cb: Pop(0)
0x3cc: Push(Stack[-3])
0x3cd: IF (Stack[-1] == 0) GOTO 0x3d3; Pop(1)

0x3ce: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3cf: Pop(0)
0x3d0: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3d1: Pop(0)
0x3d2: GOTO 0x3d7

0x3d3: Push("Can't find lsh animation : ") // @poff=322
0x3d4: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3d5: @ Trace(Stack[-1])
0x3d6: Pop(1)
0x3d7: Return(); Pop(6)

0x3d8: PushEmpty(bool, bool)
...
0x3dd: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3de: Pop(0)
0x3df: Push(Stack[-1])
0x3e0: IF (Stack[-1] == 0) GOTO 0x3e5; Pop(1)

0x3e1: @ lshPlaySpeech(Stack[-3])
0x3e2: Pop(0)
0x3e3: Stack[-4] = (bool) 1
0x3e4: Return(); Pop(2)

0x3e5: Stack[-4] = (bool) 0
0x3e6: Return(); Pop(2)
...
0x3ef: @ self(Stack[-1])
0x3f0: Pop(0)
0x3f1: Stack[-1] = Stack[-3]
0x3f2: Return(); Pop(2)

0x3f3: Stack[-1] = 0
0x3f4: PushEmpty(float, float)
0x3f5: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3f6: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3f7: Push((float)9.999999974752427e-07)
0x3f8: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3f9: IF (Stack[-1] == 0) GOTO 0x3fc; Pop(1)

0x3fa: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3fb: Return(); Pop(2)

0x3fc: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3fd: Return(); Pop(2)

0x3fe: PushEmpty(int, int)
0x3ff: @ GetVariable(Stack[-3], Stack[-1])
0x400: Pop(0)
...
0x40c: PushEmpty(string, string)
0x40d: Stack[-1] = "idle" // @poff=162
0x40e: Push(Stack[-3])
0x40f: IF (Stack[-1] == 0) GOTO 0x411; Pop(1)

0x410: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x411: Stack[-1] = Stack[-4]
0x412: Return(); Pop(2)

0x413: PushEmpty(int, bool, int, bool)
0x414: Stack[-2] = (int) 0
0x415: Push("all") // @poff=154
0x416: PushEmpty(string, int)
0x417: Stack[-5] = Stack[-1]
0x418: Call2 0x40c

0x419: Pop(1)
0x41a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x41b: Pop(2)
...
0x41f: Push((int) 1)
0x420: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x421: GOTO 0x415
...
0x424: PushEmpty()
0x425: Push("oob2PetrKabak1") // @poff=378
0x426: Push((int) 1)
0x427: @ SetVariable(Stack[-2], Stack[-1])
0x428: Pop(2)
0x429: Return(); Pop(0)

0x42a: PushEmpty()
0x42b: Push("oob2PetrKabak2") // @poff=408
0x42c: Push((int) 1)
...
0x43e: Stack[-1] = "oob2PetrKabak1" // @poff=378
0x43f: Call2 0x3fe
...
0x44a: Stack[-1] = "oob2PetrKabak2" // @poff=408
0x44b: Call2 0x3fe
...
0x461: Push("branch") // @poff=450
0x462: @ GetVariable(Stack[-1], Stack[-2])
0x463: Pop(1)
0x464: Push((int) 0)
...
0x471: Stack[-1] = (int) 515550
0x472: Return(); Pop(0)

0x473: Stack[-1] = (int) 502875
0x474: Return(); Pop(0)

0x475: Stack[-1] = "ui/NPC_Petr.png" // @poff=464
0x476: Return(); Pop(0)

0x477: Stack[-1] = "ui/NPC_Petr_b.png" // @poff=496
0x478: Return(); Pop(0)
