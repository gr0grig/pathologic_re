...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x357: Push("voice_common") // @poff=208
0x358: Push((int) 1)
...
0x35f: Push("voice_common") // @poff=208
0x360: Push((int) 0)
...
0x372: Push("voice_common") // @poff=208
0x373: Push((int) 1)
...
0x380: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x381: Pop(1)
...
0x395: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x396: Pop(1)
...
0x39e: Push("d") // @poff=204
0x39f: PushEmpty(int)
0x3a0: Call2 0x417

0x3a1: Pop(0)
0x3a2: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3a3: Push("m") // @poff=262
...
0x3ab: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=238
0x3ac: Pop(1)
...
0x3c0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=250
0x3c1: Pop(1)
...
0x3d3: Push("Can't find lsh animation : ") // @poff=266
...
0x3e2: Push("Can't find lsh animation : ") // @poff=266
...
0x424: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=322
0x425: Return(); Pop(0)

0x426: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=362
0x427: Return(); Pop(0)
...
0x440: Stack[-2] = Stack[-5]
0x441: Return(); Pop(4)

0x442: PushEmpty(object, object)
0x443: Push("b3q01") // @poff=406
0x444: Push((int) 3)
...
0x44a: Pop(1)
0x44b: Push("b3q01ButcherGotoBigVlad") // @poff=418
0x44c: Push("pt_map_bigvlad") // @poff=466
0x44d: Push((int) 1)
...
0x451: Pop(0)
0x452: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=496
0x453: Pop(5)
0x454: PushEmpty()
0x455: Call2 0x477
...
0x458: Stack[-1] = 0
0x459: PushEmpty()
0x45a: Push("oob3Butcher1") // @poff=504
0x45b: Push((int) 1)
...
0x461: Stack[-1] = "oob3Butcher1" // @poff=504
0x462: Call2 0x40d
...
0x489: Push("Can't retrieve diary root") // @poff=530
0x48a: @ Trace(Stack[-1])
0x48b: Pop(1)
...
0x495: Pop(1)
0x496: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=582
0x497: Pop(0)
0x498: Pop(0); Push((bool) Stack[-2] == 0)
0x499: IF (Stack[-1] == 0) GOTO 0x4a0; Pop(1)

0x49a: Push("Can't find diary parent with id: ") // @poff=587
...
0x4a0: @@ AddChild(Stack[-8]); Obj=2 // @poff=655
0x4a1: Pop(0)
0x4a2: Push((int) 7)
0x4a3: @ SendWorldWndMessage(Stack[-1])
0x4a4: Pop(1)
0x4a5: @@ GetCategory(Stack[-1]); Obj=8 // @poff=664
0x4a6: Pop(0)
...
0x4af: Pop(0)
0x4b0: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4b1: IF (Stack[-1] == 0) GOTO 0x4b8; Pop(1)

0x4b2: Push("Can't find main outdoor scene") // @poff=676
0x4b3: @ Trace(Stack[-1])
0x4b4: Pop(1)
0x4b5: Stack[-1] = 0
0x4b6: Stack[-1] = Stack[-5]
0x4b7: Return(); Pop(4)

0x4b8: @@ GetMap(Stack[-1]); Obj=2 // @poff=736
0x4b9: Pop(0)
