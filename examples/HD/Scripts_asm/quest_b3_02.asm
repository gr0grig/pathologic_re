...
Strings:
	...
	A:AddChild
	A:GetCategory
// @pool_raw:
...
0x5c: Push("place_grabitel2") // @poff=356
...
0x67: Push("pt_b3q02_grabitel2_") // @poff=388
0x68: Stack[-4] = Stack[-1] + Stack[-7]; Pop(1);
0x69: Stack[-2] = "pers_grabitel" // @poff=132
0x6a: Stack[-1] = "b3q02_grabitel2.xml" // @poff=428
0x6b: Call2 0xe6

0x6c: Pop(4)
0x6d: @@@ add(Stack[-1]); Obj=0 // @poff=200
0x6e: Pop(1)
0x6f: Push((int) 1)
...
0xa3: Stack[-2] = "warehouse_notkin@door1" // @poff=44
0xa4: Stack[-1] = (bool) 0
0xa5: Call2 0xf8
...
0xae: @@@ size(Stack[-1]); Obj=0 // @poff=310
0xaf: Pop(0)
...
0xb9: Stack[-2] = "warehouse_notkin@door1" // @poff=44
0xba: Stack[-1] = (bool) 0
0xbb: Call2 0xf8

0xbc: Pop(2)
0xbd: Push("b3q02Dead") // @poff=504
0xbe: Push((bool) 1)
...
0xf3: @@ AddStationaryActor(Stack[-1], Stack[-3], Stack[-2], Stack[-10], Stack[-9]); Obj=12 // @poff=583
0xf4: Pop(0)
0xf5: Stack[-1] = Stack[-13]
0xf6: Return(); Pop(8)
...
0xfd: Push("Door ") // @poff=602
0xfe: Pop(1); Push(Stack[-1] + Stack[-5]);
0xff: Push(" not found") // @poff=614
0x100: Pop(2); Push(Stack[-2] + Stack[-1]);
0x101: @ Trace(Stack[-1])
0x102: Pop(1)
0x103: GOTO 0x107

0x104: Push("locked") // @poff=636
0x105: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=650
0x106: Pop(1)
0x107: Return(); Pop(2)
...
0x130: Push("Can't retrieve diary root") // @poff=669
0x131: @ Trace(Stack[-1])
0x132: Pop(1)
0x133: Stack[-3] = (bool) 0
0x134: Return(); Pop(2)

0x135: Stack[-1] = Stack[-3]
0x136: Return(); Pop(2)
...
0x13b: Stack[-1] = Stack[-4]
0x13c: Pop(1)
0x13d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=721
0x13e: Pop(0)
0x13f: Pop(0); Push((bool) Stack[-2] == 0)
0x140: IF (Stack[-1] == 0) GOTO 0x147; Pop(1)

0x141: Push("Can't find diary parent with id: ") // @poff=726
...
0x147: @@ AddChild(Stack[-8]); Obj=2 // @poff=794
0x148: Pop(0)
0x149: Push((int) 7)
0x14a: @ SendWorldWndMessage(Stack[-1])
0x14b: Pop(1)
0x14c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=803
0x14d: Pop(0)
