...
Strings:
	...
	W:grabitel_dead
// @pool_raw:
...
Events:
EVENT_22 Op = 0xb7b Vars = (object, int, float, float)
EVENT_43 Op = 0xb83 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xb8d Vars = (object, string)
EVENT_41 Op = 0xb9a Vars = (object)
...
0x15: @ Face(Stack[-15])
0x16: Pop(0)
0x17: Push("all") // @poff=0
0x18: Push("aattack_begin1") // @poff=8
0x19: @ PlayAnimation(Stack[-2], Stack[-1])
0x1a: Pop(2)
0x1b: @ WaitForAnimEnd()
0x1c: Pop(0)
0x1d: PushEmpty(bool, object)
0x1e: Stack[-17] = Stack[-1]
0x1f: Call2 0x84a
...
0x27: Push("all") // @poff=0
0x28: Push("aattack_end1") // @poff=38
0x29: @ PlayAnimation(Stack[-2], Stack[-1])
0x2a: Pop(2)
0x2b: @ GetScene(Stack[-7])
0x2c: Pop(0)
0x2d: Push("knife") // @poff=64
0x2e: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-7])
0x2f: Pop(1)
0x30: Push("scripted") // @poff=76
0x31: Push(CVector(0.0, 0.0, 1.0))
0x32: Push("grabitel_knife.xml") // @poff=94
0x33: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-9], Stack[-2], Stack[-1])
0x34: Pop(3)
0x35: Push("Owner") // @poff=132
0x36: PushEmpty(object)
0x37: Call2 0x9bf

0x38: Pop(0)
0x39: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=144
0x3a: Pop(2)
0x3b: Push("Target") // @poff=162
0x3c: @@ SetScriptProperty(Stack[-1], Stack[-16]); Obj=5 // @poff=144
0x3d: Pop(1)
0x3e: @@ GetPosition(Stack[-3]); Obj=15 // @poff=176
0x3f: Pop(0)
0x40: @@ GetEyesHeight(Stack[-2]); Obj=15 // @poff=188
0x41: Pop(0)
...
0x48: Stack[-10] = Stack[-3]
0x49: Stack[-7] = Stack[-2]
0x4a: Stack[-1] = (float) 2000.0
0x4b: Call2 0xa6f

0x4c: Stack[-4] = Stack[-5]
0x4d: Pop(4)
0x4e: Push("StartDirection") // @poff=202
0x4f: @@ SetScriptProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=144
0x50: Pop(1)
0x51: @ WaitForAnimEnd()
0x52: Pop(0)
0x53: @ StopAsync()
...
0x73: Stack[-6] = Stack[-2]
0x74: Stack[-5] = Stack[-1]
0x75: Call2 0xba2
...
0x90: Push("all") // @poff=0
0x91: Push("attack_off") // @poff=242
0x92: @ PlayAnimation(Stack[-2], Stack[-1])
0x93: Pop(2)
0x94: @ WaitForAnimEnd()
0x95: Pop(0)
0x96: Push(GlobalVars[0])
0x97: Stack[-1] = Stack[-3]
0x98: Pop(1)
0x99: Return(); Pop(0)

0x9a: PushEmpty()
0x9b: Stack[-3] = (float) 0.15000000596046448
0x9c: Return(); Pop(0)
...
0xbe: Stack[-6] = Stack[-2]
0xbf: Stack[-5] = Stack[-1]
0xc0: Call2 0xba2
...
0xe0: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0xe1: Pop(0)
0xe2: Push(Stack[-8])
0xe3: IF (Stack[-1] == 0) GOTO 0xec; Pop(1)

0xe4: Push("attack") // @poff=320
...
0x100: Pop(0)
0x101: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=334
0x102: Pop(0)
...
0x11c: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=334
0x11d: Pop(0)
...
0x136: Pop(1)
0x137: Push("all") // @poff=0
0x138: Push("attack_on") // @poff=348
...
0x14e: Push((float)0.19999998807907104)
0x14f: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x150: IF (Stack[-1] == 1) GOTO 0x156; Pop(1)
...
0x157: @ Face(Stack[-0]T)
0x158: Pop(0)
0x159: PushEmpty()
0x15a: Call2 0x354

0x15b: Pop(0)
0x15c: Push("all") // @poff=0
0x15d: Push("attack_stay") // @poff=368
0x15e: @ PlayAnimation(Stack[-2], Stack[-1])
0x15f: Pop(2)
0x160: PushEmpty(bool, float)
0x161: Stack[-25] = Stack[-1]
0x162: Call2 0x2a0
...
0x167: @ Face(Stack[-0]T)
0x168: Pop(0)
0x169: Push("all") // @poff=0
0x16a: Push("fjump") // @poff=392
...
0x185: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=334
0x186: Pop(0)
...
0x1a4: Push("all") // @poff=0
0x1a5: Push("attack_off") // @poff=242
...
0x1b2: Push("all") // @poff=0
0x1b3: Push("attack_begin") // @poff=404
0x1b4: Push((int) 1)
0x1b5: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1c0: Push("attack") // @poff=320
0x1c1: Push((int) 1)
0x1c2: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1cc: Push("all") // @poff=0
0x1cd: Push("bjump") // @poff=430
...
0x1d4: Push((float)0.8999999761581421)
0x1d5: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1d6: @ GetVictim(Stack[-1], Stack[-4])
0x1d7: Pop(1)
0x1d8: @ ReportAttack(Stack[-0]T)
0x1d9: Pop(0)
...
0x1dd: Stack[-6] = Stack[-2]
0x1de: Stack[-10] = Stack[-1]
0x1df: Call2 0x9a

0x1e0: Stack[-3] = Stack[-5]
0x1e1: Pop(3)
0x1e2: PushEmpty(float, object, float, int)
0x1e3: Stack[-7] = Stack[-3]
0x1e4: Stack[-6] = Stack[-2]
0x1e5: PushEmpty(int, object, int)
0x1e6: Stack[-10] = Stack[-2]
0x1e7: Stack[-14] = Stack[-1]
0x1e8: Call2 0x9d

0x1e9: Stack[-3] = Stack[-4]
0x1ea: Pop(3)
0x1eb: Call2 0x7b9

0x1ec: Stack[-4] = Stack[-5]
0x1ed: Pop(4)
0x1ee: PushEmpty(int)
0x1ef: Call2 0xa0

0x1f0: Pop(0)
0x1f1: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1f2: Pop(1)
0x1f3: PushEmpty(object, float)
0x1f4: Stack[-5] = Stack[-2]
0x1f5: Stack[-3] = Stack[-1]
0x1f6: Call2 0xa2
...
0x1fd: Pop(0)
0x1fe: @ irand(Stack[-4], Stack[-1]T)
0x1ff: Pop(0)
0x200: Push((int) 1)
0x201: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x202: @ Face(Stack[-0]T)
0x203: Pop(0)
0x204: Push((bool) 1)
...
0x209: Pop(0)
0x20a: Push("all") // @poff=0
0x20b: Push("attack_begin") // @poff=404
...
0x222: Pop(2)
0x223: Push("all") // @poff=0
0x224: Push("attack_middle") // @poff=442
...
0x22c: Pop(0)
0x22d: Push("all") // @poff=0
0x22e: Push("attack_middle") // @poff=442
...
0x268: Stack[-11] = Stack[-2]
0x269: Stack[-6] = Stack[-1]
0x26a: Call2 0x1d3
...
0x271: Pop(1)
0x272: Push("all") // @poff=0
0x273: Push("attack_end") // @poff=474
...
0x27c: Stack[-1] = (float) 0.44999998807907104
0x27d: Call2 0x285
...
0x2b4: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=334
0x2b5: Pop(0)
...
0x300: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x301: Pop(1)
...
0x305: @ Face(Stack[-0]T)
0x306: Pop(0)
0x307: Push("all") // @poff=0
0x308: Push("bjump") // @poff=430
0x309: @ PlayAnimation(Stack[-2], Stack[-1])
0x30a: Pop(2)
0x30b: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=334
0x30c: Pop(0)
...
0x342: @ irand(Stack[-1], Stack[-2]T)
0x343: Pop(0)
0x344: Push((int) 1)
0x345: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x346: Push("attack") // @poff=320
...
0x355: Stack[-1] = "attack_stay" // @poff=368
0x356: Call2 0x996
...
0x367: Stack[-6] = Stack[-2]
0x368: Stack[-5] = Stack[-1]
0x369: Call2 0xba2
...
0x396: Stack[-15] = Stack[-5]
0x397: Stack[-14] = Stack[-4]
0x398: Stack[-13] = Stack[-3]
0x399: Stack[-12] = Stack[-2]
0x39a: Stack[-11] = Stack[-1]
0x39b: Call2 0x3e0

0x39c: Stack[-6] = Stack[-7]
0x39d: Pop(6)
0x39e: Push( Stack[2 + Tasks[-1].StackPointer] )
0x39f: IF (Stack[-1] == 0) GOTO 0x3a3; Pop(1)

0x3a0: Push("head") // @poff=532
0x3a1: @ UnlookAsync(Stack[-1])
0x3a2: Pop(1)
0x3a3: Push((int) 1)
0x3a4: @ KillTimer(Stack[-1])
0x3a5: Pop(1)
0x3a6: Stack[-1] = Stack[-10]
0x3a7: Return(); Pop(4)
...
0x3e3: Stack[-17] = Stack[-7]
0x3e4: PushEmpty(bool, object)
0x3e5: Stack[-23] = Stack[-1]
0x3e6: Call2 0x46c
...
0x3ec: @@ GetPosition(Stack[-5]); Obj=21 // @poff=176
0x3ed: Pop(0)
...
0x403: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=334
0x404: Pop(0)
...
0x415: Push((int) 0)
0x416: Push((float)0.30000001192092896)
...
0x438: Push((int) 0)
0x439: Push((float)0.30000001192092896)
...
0x470: Stack[-2] = Stack[-4]
0x471: Pop(2)
0x472: Return(); Pop(0)

0x473: Stack[-1] = "walk" // @poff=542
0x474: Return(); Pop(0)

0x475: Stack[-1] = "run" // @poff=552
0x476: Return(); Pop(0)
...
0x486: Pop(0)
0x487: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=560
0x488: Pop(1)
0x489: PushEmpty(int)
0x48a: Call2 0xa92

0x48b: Pop(0)
0x48c: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=571
0x48d: Pop(1)
0x48e: PushEmpty(string)
0x48f: Call2 0xa96

0x490: Pop(0)
0x491: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=589
0x492: Pop(1)
0x493: PushEmpty(string)
0x494: Call2 0xa98

0x495: Pop(0)
0x496: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=598
0x497: Pop(1)
0x498: PushEmpty(int)
0x499: Call2 0xacd

0x49a: Pop(0)
0x49b: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=608
0x49c: Pop(1)
0x49d: Stack[-2] = (int) -1
...
0x4ac: Pop(2)
0x4ad: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=622
0x4ae: Pop(0)
...
0x4b1: @ sync()
0x4b2: Pop(0)
0x4b3: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=622
0x4b4: Pop(0)
0x4b5: GOTO 0x4af

0x4b6: PushEmpty(object)
0x4b7: Stack[-10] = Stack[-1]
0x4b8: Call2 0x948

0x4b9: Pop(1)
0x4ba: @ StopDialog(Stack[-4])
0x4bb: Pop(0)
0x4bc: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=634
0x4bd: Pop(0)
0x4be: Stack[-2] = Stack[-10]
0x4bf: Return(); Pop(8)
...
0x4d3: Stack[-1] = "Neutral" // @poff=649
0x4d4: Call2 0x524

0x4d5: Pop(1)
0x4d6: Push((int) 518381)
0x4d7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x4d8: Pop(1)
0x4d9: @@@ ClearReplies(); Obj=0 // @poff=676
0x4da: Pop(0)
0x4db: Push((int) 519109)
0x4dc: Push((int) 20244)
0x4dd: Push((int) 20240)
0x4de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x4df: Pop(3)
0x4e0: Push((int) 518382)
0x4e1: Push((int) 20241)
0x4e2: Push((int) 19495)
0x4e3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x4e4: Pop(3)
0x4e5: GOTO 0x506
...
0x4f1: Stack[-1] = "Neutral" // @poff=649
0x4f2: Call2 0x524

0x4f3: Pop(1)
0x4f4: Push((int) 518383)
0x4f5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x4f6: Pop(1)
0x4f7: @@@ ClearReplies(); Obj=0 // @poff=676
0x4f8: Pop(0)
0x4f9: Push((int) 518384)
0x4fa: Push((int) 20252)
0x4fb: Push((int) 19497)
0x4fc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x4fd: Pop(3)
0x4fe: Push((int) 519119)
0x4ff: Push((int) 20252)
0x500: Push((int) 20251)
0x501: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x502: Pop(3)
0x503: GOTO 0x506
...
0x515: Push("all") // @poff=0
0x516: Push("idle") // @poff=698
...
0x51e: Push("all") // @poff=0
0x51f: Push("idle") // @poff=698
...
0x56f: Stack[-1] = "Neutral" // @poff=649
0x570: Call2 0x524

0x571: Pop(1)
0x572: Push((int) 518381)
0x573: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x574: Pop(1)
0x575: @@@ ClearReplies(); Obj=0 // @poff=676
0x576: Pop(0)
0x577: Push((int) 519109)
0x578: Push((int) 20244)
0x579: Push((int) 20240)
0x57a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x57b: Pop(3)
0x57c: Push((int) 518382)
0x57d: Push((int) 20241)
0x57e: Push((int) 19495)
0x57f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x580: Pop(3)
0x581: Return(); Pop(0)
...
0x58d: Stack[-1] = "Neutral" // @poff=649
0x58e: Call2 0x524

0x58f: Pop(1)
0x590: Push((int) 518383)
0x591: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x592: Pop(1)
0x593: @@@ ClearReplies(); Obj=0 // @poff=676
0x594: Pop(0)
0x595: Push((int) 518384)
0x596: Push((int) 20252)
0x597: Push((int) 19497)
0x598: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x599: Pop(3)
0x59a: Push((int) 519119)
0x59b: Push((int) 20252)
0x59c: Push((int) 20251)
0x59d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x59e: Pop(3)
0x59f: Return(); Pop(0)
...
0x5a4: Stack[-1] = "Neutral" // @poff=649
0x5a5: Call2 0x524

0x5a6: Pop(1)
0x5a7: Push((int) 519120)
0x5a8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x5a9: Pop(1)
0x5aa: @@@ ClearReplies(); Obj=0 // @poff=676
0x5ab: Pop(0)
0x5ac: Push((int) 519121)
0x5ad: Push((int) 20256)
0x5ae: Push((int) 20254)
0x5af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5b0: Pop(3)
0x5b1: Push((int) 519122)
0x5b2: Push((int) -1)
0x5b3: Push((int) 20255)
0x5b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5b5: Pop(3)
0x5b6: Return(); Pop(0)
...
0x5bb: Stack[-1] = "Neutral" // @poff=649
0x5bc: Call2 0x524

0x5bd: Pop(1)
0x5be: Push((int) 519123)
0x5bf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x5c0: Pop(1)
0x5c1: @@@ ClearReplies(); Obj=0 // @poff=676
0x5c2: Pop(0)
0x5c3: Push((int) 519124)
0x5c4: Push((int) -1)
0x5c5: Push((int) 20257)
0x5c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5c7: Pop(3)
0x5c8: Push((int) 519125)
0x5c9: Push((int) -1)
0x5ca: Push((int) 20258)
0x5cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5cc: Pop(3)
0x5cd: Return(); Pop(0)
...
0x5d2: Stack[-1] = "Neutral" // @poff=649
0x5d3: Call2 0x524

0x5d4: Pop(1)
0x5d5: Push((int) 519110)
0x5d6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x5d7: Pop(1)
0x5d8: @@@ ClearReplies(); Obj=0 // @poff=676
0x5d9: Pop(0)
0x5da: Push((int) 519111)
0x5db: Push((int) -1)
0x5dc: Push((int) 20242)
0x5dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5de: Pop(3)
0x5df: Push((int) 519112)
0x5e0: Push((int) -1)
0x5e1: Push((int) 20243)
0x5e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5e3: Pop(3)
0x5e4: Return(); Pop(0)
...
0x5e9: Stack[-1] = "Neutral" // @poff=649
0x5ea: Call2 0x524

0x5eb: Pop(1)
0x5ec: Push((int) 519113)
0x5ed: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x5ee: Pop(1)
0x5ef: @@@ ClearReplies(); Obj=0 // @poff=676
0x5f0: Pop(0)
0x5f1: Push((int) 519114)
0x5f2: Push((int) 20247)
0x5f3: Push((int) 20245)
0x5f4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5f5: Pop(3)
0x5f6: Push((int) 519115)
0x5f7: Push((int) 20247)
0x5f8: Push((int) 20246)
0x5f9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x5fa: Pop(3)
0x5fb: Return(); Pop(0)
...
0x600: Stack[-1] = "Neutral" // @poff=649
0x601: Call2 0x524

0x602: Pop(1)
0x603: Push((int) 519116)
0x604: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=665
0x605: Pop(1)
0x606: @@@ ClearReplies(); Obj=0 // @poff=676
0x607: Pop(0)
0x608: Push((int) 519117)
0x609: Push((int) -1)
0x60a: Push((int) 20248)
0x60b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x60c: Pop(3)
0x60d: Push((int) 519118)
0x60e: Push((int) -1)
0x60f: Push((int) 20250)
0x610: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=689
0x611: Pop(3)
0x612: Return(); Pop(0)
...
0x635: Stack[-2] = "quest_b3_02" // @poff=708
0x636: Stack[-1] = "grabitel_attack" // @poff=732
0x637: Call2 0xa49
...
0x666: Pop(0)
0x667: Push("all") // @poff=0
0x668: PushEmpty(string, int)
0x669: Stack[-7] = Stack[-1]
0x66a: Call2 0xa9c
...
0x6f4: Pop(0); PushNull((bool) Stack[-21] == 0)
0x6f5: IF (Stack[-1] == 0) GOTO 0x6fb; Pop(1)

0x6f6: PushEmpty(string)
0x6f7: Stack[-1] = "fdie" // @poff=764
0x6f8: Call2 0x74e

0x6f9: Pop(1)
0x6fa: GOTO 0x74d

0x6fb: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x6fc: Pop(0)
...
0x70c: Stack[-6] = "fdie" // @poff=764
0x70d: GOTO 0x70f

0x70e: Stack[-6] = "bdie" // @poff=774
...
0x715: @ StopAsync()
0x716: Pop(0)
0x717: Stack[-21] = Stack[-5]
0x718: Push("GetScriptProperty") // @poff=784
0x719: Push((int) 2)
0x71a: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x71b: IF (Stack[-1] == 0) GOTO 0x727; Pop(1)

0x71c: Push("Owner") // @poff=132
0x71d: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=820
0x71e: Pop(1)
0x71f: Push(Stack[-4])
0x720: IF (Stack[-1] == 0) GOTO 0x727; Pop(1)

0x721: Push("Owner") // @poff=132
0x722: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=838
0x723: Pop(1)
0x724: Pop(0); PushNull((bool) Stack[-5] == 0)
0x725: IF (Stack[-1] == 0) GOTO 0x727; Pop(1)

0x726: Stack[-21] = Stack[-5]
0x727: Push("@GetEyesHeight") // @poff=856
0x728: Push((int) 1)
0x729: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x72a: IF (Stack[-1] == 0) GOTO 0x736; Pop(1)

0x72b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x72c: Pop(0)
...
0x738: Stack[-7] = Stack[-1]
0x739: Call2 0x996

0x73a: Pop(1)
0x73b: Push("all") // @poff=0
...
0x742: @ StopAsync()
0x743: Pop(0)
0x744: Push("head") // @poff=532
0x745: @ UnlookAsync(Stack[-1])
0x746: Pop(1)
0x747: Push("all") // @poff=0
...
0x778: Stack[-2] = "bullet" // @poff=896
0x779: Return(); Pop(0)

0x77a: Stack[-2] = "phys" // @poff=910
0x77b: Return(); Pop(0)

0x77c: PushEmpty(cvector, cvector, cvector, cvector)
0x77d: @ GetPosition(Stack[-2])
0x77e: Pop(0)
0x77f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x780: Pop(0)
...
0x785: Pop(0)
0x786: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x787: Pop(0)
...
0x794: Pop(0)
0x795: Stack[-1] = Stack[-4]
0x796: Return(); Pop(2)

0x797: PushEmpty(bool, bool)
0x798: Push("HasProperty") // @poff=934
0x799: Push((int) 2)
...
0x79f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=958
0x7a0: Pop(0)
0x7a1: Stack[-1] = Stack[-5]
0x7a2: Return(); Pop(2)

0x7a3: PushEmpty(float, float)
0x7a4: PushEmpty(bool, object, string)
0x7a5: Stack[-10] = Stack[-2]
0x7a6: Stack[-9] = Stack[-1]
0x7a7: Call2 0x797
...
0x7ad: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=970
0x7ae: Pop(0)
0x7af: PushEmpty(float, float, float, float)
0x7b0: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x7b1: Stack[-8] = Stack[-2]
0x7b2: Stack[-7] = Stack[-1]
0x7b3: Call2 0x9ee

0x7b4: Pop(3)
0x7b5: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=982
0x7b6: Pop(1)
...
0x7bb: Stack[-18] = Stack[-2]
0x7bc: Stack[-1] = "health" // @poff=994
0x7bd: Call2 0x797
...
0x7c4: Stack[-18] = Stack[-2]
0x7c5: Stack[-1] = "armor" // @poff=1008
0x7c6: Call2 0x797
...
0x7cc: Push("armor") // @poff=1008
0x7cd: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=970
0x7ce: Pop(1)
0x7cf: Push("armor_") // @poff=1020
0x7d0: PushEmpty(string, int)
0x7d1: Stack[-16] = Stack[-1]
0x7d2: Call2 0x76e

0x7d3: Pop(1)
0x7d4: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x7d5: PushEmpty(bool, object, string)
0x7d6: Stack[-18] = Stack[-2]
0x7d7: Stack[-8] = Stack[-1]
0x7d8: Call2 0x797
...
0x7de: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=970
0x7df: Pop(0)
...
0x7e6: Stack[-3] = Stack[-6]
0x7e7: Pop(3)
0x7e8: Push("health") // @poff=994
0x7e9: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=970
0x7ea: Pop(1)
0x7eb: Push((int) 1)
0x7ec: Pop(1); Push(Stack[-1] - Stack[-4]);
0x7ed: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x7ee: Push("health") // @poff=994
...
0x7f4: Pop(3)
0x7f5: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=982
0x7f6: Pop(2)
0x7f7: PushEmpty(bool, object)
0x7f8: Stack[-17] = Stack[-1]
0x7f9: Call2 0x792
...
0x7ff: Pop(1)
0x800: Stack[-1] = Stack[-16]
0x801: Return(); Pop(12)

0x802: PushEmpty(float, float)
0x803: PushEmpty(bool, object, string)
0x804: Stack[-6] = Stack[-2]
0x805: Stack[-1] = "health" // @poff=994
0x806: Call2 0x797
...
0x81b: Push("health") // @poff=994
0x81c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=970
0x81d: Pop(1)
...
0x822: @@ IsDead(Stack[-1]); Obj=3 // @poff=1034
0x823: Pop(0)
0x824: Stack[-1] = Stack[-4]
0x825: Return(); Pop(2)

0x826: PushEmpty(object, object, object, object)
0x827: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x83b: Pop(0)
0x83c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x83d: IF (Stack[-1] == 0) GOTO 0x840; Pop(1)

0x83e: Stack[-6] = (bool) 0
0x83f: Return(); Pop(4)

0x840: @@ GetScene(Stack[-1]); Obj=5 // @poff=1055
0x841: Pop(0)
...
0x854: Stack[-6] = Stack[-2]
0x855: Stack[-1] = "noaccess" // @poff=1064
0x856: Call2 0x797
...
0x85c: Push("noaccess") // @poff=1064
0x85d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=970
0x85e: Pop(1)
0x85f: Push((int) 0)
...
0x884: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x885: Pop(0)
...
0x895: Stack[-1] = "fhit" // @poff=1082
0x896: GOTO 0x898

0x897: Stack[-1] = "bhit" // @poff=1092
0x898: Push("hit_react") // @poff=1102
0x899: Push("1") // @poff=34
0x89a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x89b: Push("2") // @poff=728
...
0x8b9: Stack[-2] = Stack[-11]
0x8ba: Pop(2)
0x8bb: @ CreateVectorVector(Stack[-8])
0x8bc: Pop(0)
0x8bd: Stack[-7] = (int) 1
0x8be: Push("hit") // @poff=1084
...
0x8d3: Pop(0)
0x8d4: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=1131
0x8d5: Pop(0)
0x8d6: PushEmpty(object, int, float, cvector, cvector)
0x8d7: Stack[-26] = Stack[-5]
0x8d8: Stack[-25] = Stack[-4]
0x8d9: Stack[-24] = Stack[-3]
0x8da: Stack[-6] = Stack[-2]
...
0x8f4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x8f5: Pop(0)
...
0x904: @@ GetPosition(Stack[-8]); Obj=20 // @poff=176
0x905: Pop(0)
0x906: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=188
0x907: Pop(0)
...
0x92d: Pop(0)
0x92e: Push((bool) 1)
0x92f: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x930: Pop(1)
0x931: Push(CvectorIndex(Stack[-4], 0))
0x932: Push(CvectorIndex(Stack[-5], 2))
0x933: @ Rotate(Stack[-2], Stack[-1])
0x934: Pop(2)
...
0x93a: Push("head") // @poff=532
0x93b: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x93c: Pop(1)
0x93d: Push(Stack[-1])
0x93e: IF (Stack[-1] == 0) GOTO 0x942; Pop(1)

0x93f: Push("head") // @poff=532
0x940: @ LookAsyncCamera(Stack[-1])
0x941: Pop(1)
0x942: @ CameraWaitForPlayFinish()
0x943: Pop(0)
0x944: @ ResumeWorld()
0x945: Pop(0)
0x946: Stack[-21] = (bool) 1
0x947: Return(); Pop(18)

0x948: PushEmpty(bool, bool)
0x949: Push((bool) 1)
0x94a: @ CameraSwitchToNormal(Stack[-1])
0x94b: Pop(1)
...
0x951: Push("head") // @poff=532
0x952: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x953: Pop(1)
0x954: Push(Stack[-1])
0x955: IF (Stack[-1] == 0) GOTO 0x959; Pop(1)

0x956: Push("head") // @poff=532
0x957: @ UnlookAsync(Stack[-1])
0x958: Pop(1)
0x959: Return(); Pop(2)

0x95a: PushEmpty(bool, float, float, bool, float, float)
0x95b: @ lshHasAnimation(Stack[-3], Stack[-7])
0x95c: Pop(0)
0x95d: Push(Stack[-3])
0x95e: IF (Stack[-1] == 0) GOTO 0x965; Pop(1)

0x95f: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x960: Pop(0)
0x961: Push((bool) 0)
0x962: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x963: Pop(1)
0x964: GOTO 0x969

0x965: Push("Can't find lsh animation : ") // @poff=1163
0x966: Pop(1); Push(Stack[-1] + Stack[-8]);
0x967: @ Trace(Stack[-1])
0x968: Pop(1)
0x969: Return(); Pop(6)

0x96a: PushEmpty(bool, float, float, bool, float, float)
0x96b: @ lshHasAnimation(Stack[-3], Stack[-8])
0x96c: Pop(0)
0x96d: Push(Stack[-3])
0x96e: IF (Stack[-1] == 0) GOTO 0x974; Pop(1)

0x96f: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x970: Pop(0)
0x971: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x972: Pop(0)
0x973: GOTO 0x978

0x974: Push("Can't find lsh animation : ") // @poff=1163
0x975: Pop(1); Push(Stack[-1] + Stack[-9]);
0x976: @ Trace(Stack[-1])
0x977: Pop(1)
0x978: Return(); Pop(6)

0x979: PushEmpty(float, cvector, float, cvector)
0x97a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x97b: Pop(0)
0x97c: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x97d: Push(CvectorIndex(Stack[-1], 1))
0x97e: Stack[-3] = Stack[-1]
0x97f: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x980: Push("head") // @poff=532
0x981: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x982: Pop(1)
0x983: Return(); Pop(4)
...
0x98b: PushEmpty(bool, bool)
0x98c: PushEmpty(bool, int, int)
0x98d: Stack[-7] = Stack[-2]
0x98e: Stack[-6] = Stack[-1]
0x98f: Call2 0xa01
...
0x992: Push((int) 0)
0x993: @ AddItem(Stack[-2], Stack[-6], Stack[-1])
0x994: Pop(1)
0x995: Return(); Pop(2)

0x996: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x997: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x998: Pop(0)
0x999: Pop(0); Push((bool) Stack[-8] == 0)
0x99a: IF (Stack[-1] == 0) GOTO 0x9af; Pop(1)

0x99b: Stack[-7] = (int) 0
0x99c: Push((int) 1)
0x99d: Pop(1); Push(Stack[-8] + Stack[-1]);
0x99e: Pop(1); Push(Stack[-18] + Stack[-1]);
0x99f: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x9a0: Pop(1)
0x9a1: Pop(0); Push((bool) Stack[-6] == 0)
0x9a2: IF (Stack[-1] == 0) GOTO 0x9a4; Pop(1)

0x9a3: GOTO 0x9a7

0x9a4: Push((int) 1)
0x9a5: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x9a6: GOTO 0x99c

0x9a7: Pop(0); Push((bool) Stack[-7] == 0)
0x9a8: IF (Stack[-1] == 0) GOTO 0x9aa; Pop(1)

0x9a9: Return(); Pop(16)

0x9aa: @ irand(Stack[-5], Stack[-7])
0x9ab: Pop(0)
0x9ac: Push((int) 1)
0x9ad: Pop(1); Push(Stack[-6] + Stack[-1]);
0x9ae: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x9af: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x9b0: Pop(0)
0x9b1: Push(Stack[-4])
0x9b2: IF (Stack[-1] == 0) GOTO 0x9be; Pop(1)

0x9b3: @ GetEyesHeight(Stack[-3])
0x9b4: Pop(0)
0x9b5: @ GetDirection(Stack[-2])
0x9b6: Pop(0)
0x9b7: Push((int) 50)
0x9b8: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x9b9: Push(CvectorIndex(Stack[-1], 1))
0x9ba: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x9bb: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x9bc: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x9bd: Pop(0)
0x9be: Return(); Pop(16)
...
0x9c4: Stack[-1] = 0
0x9c5: PushEmpty(float, float)
0x9c6: Pop(0); Push(Stack[-3] | Stack[-3]);
0x9c7: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x9c8: Push((float)9.999999974752427e-07)
0x9c9: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x9ca: IF (Stack[-1] == 0) GOTO 0x9cd; Pop(1)

0x9cb: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x9cc: Return(); Pop(2)

0x9cd: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x9ce: Return(); Pop(2)

0x9cf: PushEmpty()
0x9d0: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x9d1: IF (Stack[-1] == 0) GOTO 0x9d4; Pop(1)

0x9d2: Stack[-2] = Stack[-3]
0x9d3: GOTO 0x9d5
...
0x9d6: PushEmpty()
0x9d7: Pop(0); Push(Stack[-2] * Stack[-2]);
0x9d8: Push((int) 4)
0x9d9: Pop(1); Push(Stack[-1] * Stack[-5]);
0x9da: Pop(1); Push(Stack[-1] * Stack[-3]);
0x9db: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x9dc: Return(); Pop(0)

0x9dd: PushEmpty(float, float)
0x9de: Pop(0); Push(( -Stack[-5])
0x9df: Pop(1); Push(Stack[-1] - Stack[-4]);
0x9e0: Push((int) 2)
0x9e1: Pop(1); Push(Stack[-1] * Stack[-8]);
0x9e2: Stack[-3] = Stack[-2] / Stack[-1]; Pop(2);
0x9e3: Push((int) 0)
0x9e4: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x9e5: IF (Stack[-1] == 0) GOTO 0x9e8; Pop(1)

0x9e6: Stack[-1] = Stack[-7]
0x9e7: Return(); Pop(2)

0x9e8: Pop(0); Push(( -Stack[-5])
0x9e9: Pop(1); Push(Stack[-1] + Stack[-4]);
0x9ea: Push((int) 2)
0x9eb: Pop(1); Push(Stack[-1] * Stack[-8]);
0x9ec: Stack[-9] = Stack[-2] / Stack[-1]; Pop(2);
0x9ed: Return(); Pop(2)

0x9ee: PushEmpty()
0x9ef: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x9f0: IF (Stack[-1] == 0) GOTO 0x9f3; Pop(1)

0x9f1: Stack[-2] = Stack[-4]
0x9f2: Return(); Pop(0)

0x9f3: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x9f4: IF (Stack[-1] == 0) GOTO 0x9f7; Pop(1)

0x9f5: Stack[-1] = Stack[-4]
0x9f6: Return(); Pop(0)

0x9f7: Stack[-3] = Stack[-4]
0x9f8: Return(); Pop(0)

0x9f9: PushEmpty()
0x9fa: Stack[-4] = (bool) 0
0x9fb: Pop(0); Push((bool) Stack[-3] >= Stack[-2])
0x9fc: IF (Stack[-1] == 0) GOTO 0xa00; Pop(1)

0x9fd: Pop(0); Push((bool) Stack[-3] <= Stack[-1])
0x9fe: IF (Stack[-1] == 0) GOTO 0xa00; Pop(1)

0x9ff: Stack[-4] = (bool) 1
0xa00: Return(); Pop(0)

0xa01: PushEmpty(int, int)
0xa02: @ irand(Stack[-1], Stack[-3])
0xa03: Pop(0)
0xa04: Stack[-5] = Stack[-1] < Stack[-4]; Pop(0);
0xa05: Return(); Pop(2)

0xa06: PushEmpty(int, int)
0xa07: @ GetVariable(Stack[-3], Stack[-1])
0xa08: Pop(0)
0xa09: Stack[-1] = Stack[-4]
0xa0a: Return(); Pop(2)

0xa0b: PushEmpty()
0xa0c: Pop(0); Push((bool) Stack[-2] == 0)
...
0xa12: IF (Stack[-1] == 0) GOTO 0xa17; Pop(1)

0xa13: Push((int) 8)
0xa14: @ SendWorldWndMessage(Stack[-1])
0xa15: Pop(1)
0xa16: GOTO 0xa20
...
0xa1a: Push((int) 9)
0xa1b: @ SendWorldWndMessage(Stack[-1])
0xa1c: Pop(1)
0xa1d: GOTO 0xa20

0xa1e: Stack[-3] = (bool) 0
0xa1f: Return(); Pop(0)

0xa20: PushEmpty(float)
0xa21: Stack[-2] = Stack[-1]
0xa22: Call2 0xa3f

0xa23: Pop(1)
0xa24: PushEmpty(bool, object, string, float, float, float)
0xa25: Stack[-8] = Stack[-5]
0xa26: Stack[-4] = "reputation" // @poff=1219
0xa27: Stack[-7] = Stack[-3]
0xa28: Stack[-2] = (int) 0
0xa29: Stack[-1] = (int) 1
0xa2a: Call2 0x7a3

0xa2b: Pop(6)
0xa2c: Stack[-3] = (bool) 1
0xa2d: Return(); Pop(0)

0xa2e: PushEmpty(object, object)
0xa2f: @ CreateFloatVector(Stack[-1])
0xa30: Pop(0)
0xa31: @@ add(Stack[-3]); Obj=1 // @poff=1122
0xa32: Pop(0)
0xa33: Push((int) 0)
0xa34: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0xa35: IF (Stack[-1] == 0) GOTO 0xa3a; Pop(1)

0xa36: Push((float)0.699999988079071)
0xa37: Push((int) 500)
0xa38: @ RumblePlay(Stack[-2], Stack[-1])
0xa39: Pop(2)
0xa3a: Push((int) 15)
0xa3b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa3c: Pop(1)
0xa3d: Return(); Pop(2)

0xa3e: Stack[-1] = 0
0xa3f: PushEmpty(object, object)
0xa40: @ CreateFloatVector(Stack[-1])
0xa41: Pop(0)
0xa42: @@ add(Stack[-3]); Obj=1 // @poff=1122
0xa43: Pop(0)
0xa44: Push((int) 16)
0xa45: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa46: Pop(1)
0xa47: Return(); Pop(2)

0xa48: Stack[-1] = 0
0xa49: PushEmpty(object, object)
0xa4a: @ FindActor(Stack[-1], Stack[-4])
0xa4b: Pop(0)
0xa4c: Pop(0); PushNull((bool) Stack[-1] == 0)
0xa4d: IF (Stack[-1] == 0) GOTO 0xa50; Pop(1)

0xa4e: Stack[-5] = (bool) 0
0xa4f: Return(); Pop(2)

0xa50: @ Trigger(Stack[-1], Stack[-3])
0xa51: Pop(0)
0xa52: Stack[-5] = (bool) 1
0xa53: Return(); Pop(2)

0xa54: Stack[-1] = 0
0xa55: PushEmpty(bool, bool)
0xa56: @ IsPlayerActor(Stack[-3], Stack[-1])
0xa57: Pop(0)
0xa58: Push(Stack[-1])
0xa59: IF (Stack[-1] == 0) GOTO 0xa5d; Pop(1)

0xa5a: Push("attack") // @poff=320
0xa5b: @ PlayGlobalMusic(Stack[-1])
0xa5c: Pop(1)
0xa5d: Return(); Pop(2)

0xa5e: PushEmpty(object, object)
0xa5f: @ GetScene(Stack[-1])
0xa60: Pop(0)
0xa61: Push("battle") // @poff=1241
0xa62: PushEmpty(object)
0xa63: Call2 0x9bf

0xa64: Pop(0)
0xa65: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xa66: Pop(2)
0xa67: Return(); Pop(2)

0xa68: Stack[-1] = 0
0xa69: PushEmpty(bool, bool)
0xa6a: Push("god_mode") // @poff=1255
0xa6b: @ GetVariable(Stack[-1], Stack[-2])
0xa6c: Pop(1)
0xa6d: Stack[-1] = Stack[-3]
0xa6e: Return(); Pop(2)

0xa6f: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0xa70: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0xa71: Stack[-5] = (int) 250000
0xa72: Push(CvectorIndex(Stack[-6], 1))
0xa73: Push((int) 1000)
0xa74: Pop(2); Push(Stack[-2] * Stack[-1]);
0xa75: Pop(0); Push(Stack[-14] * Stack[-14]);
0xa76: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0xa77: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0xa78: PushEmpty(float, float, float, float)
0xa79: Stack[-9] = Stack[-3]
0xa7a: Stack[-8] = Stack[-2]
0xa7b: Stack[-7] = Stack[-1]
0xa7c: Call2 0x9d6

0xa7d: Stack[-4] = Stack[-6]
0xa7e: Pop(4)
0xa7f: Push((int) 0)
...
0xa84: PushEmpty(float, float, float, float, float)
0xa85: Stack[-10] = Stack[-4]
0xa86: Stack[-9] = Stack[-3]
0xa87: Stack[-8] = Stack[-2]
0xa88: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0xa89: Call2 0x9dd

0xa8a: Pop(4)
0xa8b: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xa8c: Push(CVector(0.0, 500.0, 0.0))
0xa8d: Pop(1); Push(Stack[-1] * Stack[-2]);
0xa8e: Pop(1); Push(Stack[-1] * Stack[-2]);
0xa8f: Pop(1); Push(Stack[-7] + Stack[-1]);
0xa90: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0xa91: Return(); Pop(12)

0xa92: Stack[-1] = (int) 518411
0xa93: Return(); Pop(0)

0xa94: Stack[-1] = (int) 518410
0xa95: Return(); Pop(0)

0xa96: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1273
0xa97: Return(); Pop(0)

0xa98: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1313
0xa99: Return(); Pop(0)

0xa9a: Stack[-1] = (bool) 0
0xa9b: Return(); Pop(0)

0xa9c: PushEmpty(string, string)
0xa9d: Stack[-1] = "idle" // @poff=698
0xa9e: Push(Stack[-3])
0xa9f: IF (Stack[-1] == 0) GOTO 0xaa1; Pop(1)

0xaa0: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xaa1: Stack[-1] = Stack[-4]
0xaa2: Return(); Pop(2)

0xaa3: PushEmpty(int, bool, int, bool)
0xaa4: Stack[-2] = (int) 0
0xaa5: Push("all") // @poff=0
0xaa6: PushEmpty(string, int)
0xaa7: Stack[-5] = Stack[-1]
0xaa8: Call2 0xa9c

0xaa9: Pop(1)
0xaaa: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xaab: Pop(2)
...
0xaaf: Push((int) 1)
0xab0: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xab1: GOTO 0xaa5

0xab2: Stack[-2] = Stack[-5]
0xab3: Return(); Pop(4)

0xab4: PushEmpty()
0xab5: Push("b3q02GrabitelTalk") // @poff=1357
0xab6: Push((int) 1)
...
0xaba: PushEmpty()
0xabb: PushEmpty(bool, string, string)
0xabc: Stack[-2] = "quest_b3_02" // @poff=708
0xabd: Stack[-1] = "grabitel_attack" // @poff=732
0xabe: Call2 0xa49
...
0xac9: Stack[-2] = (bool) 1
0xaca: Return(); Pop(0)

0xacb: Stack[-2] = (bool) 0
0xacc: Return(); Pop(0)

0xacd: PushEmpty(int, int)
0xace: Push("branch") // @poff=1405
0xacf: @ GetVariable(Stack[-1], Stack[-2])
0xad0: Pop(1)
0xad1: Push((int) 0)
0xad2: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xad3: IF (Stack[-1] == 0) GOTO 0xad7; Pop(1)
...
0xadf: Push("branch") // @poff=1405
0xae0: @ GetVariable(Stack[-1], Stack[-2])
0xae1: Pop(1)
0xae2: Stack[-1] = Stack[-3]
0xae3: Return(); Pop(2)
...
0xaeb: @ WorkWithCorpse(Stack[-1])
0xaec: Pop(0)
0xaed: GOTO 0xaf0

0xaee: @ Barter(Stack[-1])
0xaef: Pop(0)
0xaf0: Return(); Pop(0)

0xaf1: PushEmpty(int, bool, int, bool)
0xaf2: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0xaf3: IF (Stack[-1] == 0) GOTO 0xaf8; Pop(1)

0xaf4: Push("GenerateMoney: iMin > iMax") // @poff=1419
0xaf5: @ Trace(Stack[-1])
0xaf6: Pop(1)
0xaf7: Return(); Pop(4)

0xaf8: Stack[-2] = (int) 0
0xaf9: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0xafa: IF (Stack[-1] == 0) GOTO 0xaff; Pop(1)

0xafb: Pop(0); Push(Stack[-5] - Stack[-6]);
0xafc: @ irand(Stack[-3], Stack[-1])
0xafd: Pop(1)
0xafe: GOTO 0xb03

0xaff: Push((int) 0)
0xb00: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xb01: IF (Stack[-1] == 0) GOTO 0xb03; Pop(1)

0xb02: Return(); Pop(4)

0xb03: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0xb04: Push((int) 0)
0xb05: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xb06: IF (Stack[-1] == 0) GOTO 0xb08; Pop(1)

0xb07: Return(); Pop(4)

0xb08: PushEmpty(int, string)
0xb09: Stack[-1] = "Money" // @poff=1473
0xb0a: Call2 0xb57

0xb0b: Pop(1)
0xb0c: Push((int) 0)
0xb0d: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xb0e: Pop(2)
0xb0f: Return(); Pop(4)

0xb10: PushEmpty(object, int, bool, object, int, bool)
0xb11: @ CreateInvItem(Stack[-3])
0xb12: Pop(0)
0xb13: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1485
0xb14: Pop(0)
0xb15: Push("Organ") // @poff=1497
0xb16: Push((int) 1)
0xb17: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=982
0xb18: Pop(2)
0xb19: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1509
0xb1a: Pop(0)
0xb1b: Push((int) 0)
0xb1c: Push((int) 1)
0xb1d: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xb1e: Pop(2)
0xb1f: Return(); Pop(6)
...
0xb29: Stack[-1] = "liver" // @poff=1519
0xb2a: Call2 0xb10

0xb2b: Pop(1)
0xb2c: PushEmpty(string)
0xb2d: Stack[-1] = "kidney" // @poff=1531
0xb2e: Call2 0xb10

0xb2f: Pop(1)
0xb30: PushEmpty(string)
0xb31: Stack[-1] = "heart" // @poff=1545
0xb32: Call2 0xb10

0xb33: Pop(1)
0xb34: PushEmpty(string)
0xb35: Stack[-1] = "blood" // @poff=1557
0xb36: Call2 0xb10

0xb37: Pop(1)
0xb38: Return(); Pop(0)

0xb39: PushEmpty(int, bool, int, bool)
0xb3a: Push((int) 0)
0xb3b: @ ClearSubContainer(Stack[-1])
0xb3c: Pop(1)
0xb3d: PushEmpty(int, int)
0xb3e: Stack[-2] = (int) 300
0xb3f: Stack[-1] = (int) 750
0xb40: Call2 0xaf1

0xb41: Pop(2)
0xb42: PushEmpty(string, int, int)
0xb43: Stack[-3] = "Knife" // @poff=1569
0xb44: Stack[-2] = (int) 1
0xb45: Stack[-1] = (int) 8
0xb46: Call2 0x98b

0xb47: Pop(3)
0xb48: PushEmpty(string, int, int)
0xb49: Stack[-3] = "lockpick" // @poff=1581
0xb4a: Stack[-2] = (int) 1
0xb4b: Stack[-1] = (int) 6
0xb4c: Call2 0x98b
...
0xb4f: Stack[-1] = "grabitel_mark" // @poff=1599
0xb50: Call2 0xb57

0xb51: Pop(1)
0xb52: Push((int) 0)
0xb53: Push((int) 1)
0xb54: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb55: Pop(3)
0xb56: Return(); Pop(4)

0xb57: PushEmpty(int, int)
0xb58: @ GetInvItemByName(Stack[-1], Stack[-3])
0xb59: Pop(0)
0xb5a: Stack[-1] = Stack[-4]
0xb5b: Return(); Pop(2)

0xb5c: PushEmpty(object, object)
0xb5d: @ GetScene(Stack[-1])
0xb5e: Pop(0)
0xb5f: PushEmpty(object)
0xb60: Call2 0x9bf

0xb61: Pop(0)
0xb62: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1627
0xb63: Pop(1)
0xb64: PushEmpty(bool, string, string)
0xb65: Stack[-2] = "quest_b3_02" // @poff=708
0xb66: Stack[-1] = "grabitel_dead" // @poff=1649
0xb67: Call2 0xa49
...
0xb6e: PushEmpty(bool, object, float)
0xb6f: Stack[-6] = Stack[-2]
0xb70: Stack[-1] = (float) 0.029999999329447746
0xb71: Call2 0xa0b

0xb72: Pop(3)
0xb73: PushEmpty(object)
0xb74: Stack[-4] = Stack[-1]
0xb75: Push(-1, 0); TaskCall(7)
0xb76: Call2 0x6ce

0xb77: Pop(-1, 0); TaskReturn
0xb78: Pop(1)
0xb79: Return(); Pop(2)

0xb7a: Stack[-1] = 0
0xb7b: PushEmpty()
0xb7c: PushEmpty(object, int, float)
0xb7d: Stack[-7] = Stack[-3]
0xb7e: Stack[-6] = Stack[-2]
0xb7f: Stack[-5] = Stack[-1]
0xb80: Call2 0x8a1
...
0xb83: PushEmpty()
0xb84: PushEmpty(object, int, float, cvector, cvector)
0xb85: Stack[-11] = Stack[-5]
0xb86: Stack[-10] = Stack[-4]
0xb87: Stack[-9] = Stack[-3]
0xb88: Stack[-7] = Stack[-2]
0xb89: Stack[-6] = Stack[-1]
0xb8a: Call2 0x8e5
...
0xb8e: Push("health") // @poff=994
0xb8f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xb90: IF (Stack[-1] == 0) GOTO 0xb99; Pop(1)

0xb91: Push("health") // @poff=994
0xb92: @ GetProperty(Stack[-1], Stack[-2])
0xb93: Pop(1)
0xb94: Push((int) 0)
0xb95: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xb96: IF (Stack[-1] == 0) GOTO 0xb99; Pop(1)

0xb97: @ SignalDeath(Stack[-4])
0xb98: Pop(0)
0xb99: Return(); Pop(2)
