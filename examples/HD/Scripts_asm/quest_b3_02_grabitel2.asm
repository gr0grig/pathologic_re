...
// @pool_raw:
...
Events:
EVENT_22 Op = 0x8fb Vars = (object, int, float, float)
EVENT_43 Op = 0x903 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x90d Vars = (object, string)
EVENT_41 Op = 0x91a Vars = (object)
...
0x4c3: Pop(0)
0x4c4: Push("all") // @poff=0
0x4c5: PushEmpty(string, int)
0x4c6: Stack[-7] = Stack[-1]
0x4c7: Call2 0x828
...
0x51d: Pop(0); PushNull((bool) Stack[-21] == 0)
0x51e: IF (Stack[-1] == 0) GOTO 0x524; Pop(1)

0x51f: PushEmpty(string)
0x520: Stack[-1] = "fdie" // @poff=560
0x521: Call2 0x577

0x522: Pop(1)
0x523: GOTO 0x576

0x524: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x525: Pop(0)
...
0x535: Stack[-6] = "fdie" // @poff=560
0x536: GOTO 0x538

0x537: Stack[-6] = "bdie" // @poff=570
...
0x53e: @ StopAsync()
0x53f: Pop(0)
0x540: Stack[-21] = Stack[-5]
0x541: Push("GetScriptProperty") // @poff=580
0x542: Push((int) 2)
0x543: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x544: IF (Stack[-1] == 0) GOTO 0x550; Pop(1)

0x545: Push("Owner") // @poff=132
0x546: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=616
0x547: Pop(1)
0x548: Push(Stack[-4])
0x549: IF (Stack[-1] == 0) GOTO 0x550; Pop(1)

0x54a: Push("Owner") // @poff=132
0x54b: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=634
0x54c: Pop(1)
0x54d: Pop(0); PushNull((bool) Stack[-5] == 0)
0x54e: IF (Stack[-1] == 0) GOTO 0x550; Pop(1)

0x54f: Stack[-21] = Stack[-5]
0x550: Push("@GetEyesHeight") // @poff=652
0x551: Push((int) 1)
0x552: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x553: IF (Stack[-1] == 0) GOTO 0x55f; Pop(1)

0x554: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x555: Pop(0)
...
0x561: Stack[-7] = Stack[-1]
0x562: Call2 0x760

0x563: Pop(1)
0x564: Push("all") // @poff=0
...
0x56b: @ StopAsync()
0x56c: Pop(0)
0x56d: Push("head") // @poff=532
0x56e: @ UnlookAsync(Stack[-1])
0x56f: Pop(1)
0x570: Push("all") // @poff=0
...
0x5a1: Stack[-5] = Stack[-1]
0x5a2: Call2 0x5d1

0x5a3: Stack[-2] = Stack[-3]
0x5a4: Pop(2)
0x5a5: PushEmpty(bool, float, float, float)
0x5a6: Stack[-5] = Stack[-3]
...
0x5c6: Stack[-2] = "bullet" // @poff=692
0x5c7: Return(); Pop(0)

0x5c8: Stack[-2] = "phys" // @poff=706
0x5c9: Return(); Pop(0)

0x5ca: PushEmpty(cvector, cvector, cvector, cvector)
0x5cb: @ GetPosition(Stack[-2])
0x5cc: Pop(0)
0x5cd: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x5ce: Pop(0)
...
0x5d3: Pop(0)
0x5d4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x5d5: Pop(0)
...
0x5db: Pop(0)
0x5dc: Stack[-1] = Stack[-4]
0x5dd: Return(); Pop(2)

0x5de: PushEmpty(bool, bool)
0x5df: Push("HasProperty") // @poff=716
0x5e0: Push((int) 2)
...
0x5e6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=740
0x5e7: Pop(0)
0x5e8: Stack[-1] = Stack[-5]
0x5e9: Return(); Pop(2)

0x5ea: PushEmpty(float, float)
0x5eb: PushEmpty(bool, object, string)
0x5ec: Stack[-10] = Stack[-2]
0x5ed: Stack[-9] = Stack[-1]
0x5ee: Call2 0x5de
...
0x5f4: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=752
0x5f5: Pop(0)
0x5f6: PushEmpty(float, float, float, float)
0x5f7: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x5f8: Stack[-8] = Stack[-2]
0x5f9: Stack[-7] = Stack[-1]
0x5fa: Call2 0x7b8

0x5fb: Pop(3)
0x5fc: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=764
0x5fd: Pop(1)
...
0x602: Stack[-18] = Stack[-2]
0x603: Stack[-1] = "health" // @poff=776
0x604: Call2 0x5de
...
0x60b: Stack[-18] = Stack[-2]
0x60c: Stack[-1] = "armor" // @poff=790
0x60d: Call2 0x5de
...
0x613: Push("armor") // @poff=790
0x614: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=752
0x615: Pop(1)
0x616: Push("armor_") // @poff=802
0x617: PushEmpty(string, int)
0x618: Stack[-16] = Stack[-1]
0x619: Call2 0x5bc

0x61a: Pop(1)
0x61b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x61c: PushEmpty(bool, object, string)
0x61d: Stack[-18] = Stack[-2]
0x61e: Stack[-8] = Stack[-1]
0x61f: Call2 0x5de
...
0x625: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=752
0x626: Pop(0)
...
0x62d: Stack[-3] = Stack[-6]
0x62e: Pop(3)
0x62f: Push("health") // @poff=776
0x630: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=752
0x631: Pop(1)
0x632: Push((int) 1)
0x633: Pop(1); Push(Stack[-1] - Stack[-4]);
0x634: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x635: Push("health") // @poff=776
...
0x63b: Pop(3)
0x63c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=764
0x63d: Pop(2)
0x63e: PushEmpty(bool, object)
0x63f: Stack[-17] = Stack[-1]
0x640: Call2 0x5d9
...
0x646: Pop(1)
0x647: Stack[-1] = Stack[-16]
0x648: Return(); Pop(12)

0x649: PushEmpty(float, float)
0x64a: PushEmpty(bool, object, string)
0x64b: Stack[-6] = Stack[-2]
0x64c: Stack[-1] = "health" // @poff=776
0x64d: Call2 0x5de
...
0x662: Push("health") // @poff=776
0x663: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=752
0x664: Pop(1)
...
0x669: @@ IsDead(Stack[-1]); Obj=3 // @poff=816
0x66a: Pop(0)
0x66b: Stack[-1] = Stack[-4]
0x66c: Return(); Pop(2)

0x66d: PushEmpty(object, object, object, object)
0x66e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x682: Pop(0)
0x683: Pop(0); PushNull((bool) Stack[-2] == 0)
0x684: IF (Stack[-1] == 0) GOTO 0x687; Pop(1)

0x685: Stack[-6] = (bool) 0
0x686: Return(); Pop(4)

0x687: @@ GetScene(Stack[-1]); Obj=5 // @poff=837
0x688: Pop(0)
...
0x69b: Stack[-6] = Stack[-2]
0x69c: Stack[-1] = "noaccess" // @poff=846
0x69d: Call2 0x5de
...
0x6a3: Push("noaccess") // @poff=846
0x6a4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=752
0x6a5: Pop(1)
0x6a6: Push((int) 0)
...
0x6b0: Pop(2)
0x6b1: Stack[-1] = Stack[-8]
0x6b2: Return(); Pop(6)

0x6b3: PushEmpty(cvector, cvector)
0x6b4: @@ GetPosition(Stack[-1]); Obj=3 // @poff=176
0x6b5: Pop(0)
...
0x6bd: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6cb: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x6cc: Pop(0)
...
0x6dc: Stack[-1] = "fhit" // @poff=864
0x6dd: GOTO 0x6df

0x6de: Stack[-1] = "bhit" // @poff=874
0x6df: Push("hit_react") // @poff=884
0x6e0: Push("1") // @poff=34
0x6e1: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6e2: Push("2") // @poff=904
...
0x6fb: Stack[-25] = Stack[-1]
0x6fc: Call2 0x5ca

0x6fd: Stack[-2] = Stack[-3]
0x6fe: Pop(2)
0x6ff: Call2 0x78f

0x700: Stack[-2] = Stack[-11]
0x701: Pop(2)
0x702: @ CreateVectorVector(Stack[-8])
0x703: Pop(0)
0x704: Stack[-7] = (int) 1
0x705: Push("hit") // @poff=866
...
0x71a: Pop(0)
0x71b: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=917
0x71c: Pop(0)
0x71d: PushEmpty(object, int, float, cvector, cvector)
0x71e: Stack[-26] = Stack[-5]
0x71f: Stack[-25] = Stack[-4]
0x720: Stack[-24] = Stack[-3]
0x721: Stack[-6] = Stack[-2]
...
0x73b: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x73c: Pop(0)
...
0x747: Pop(0)
0x748: Stack[-1] = Stack[-3]
0x749: Return(); Pop(2)

0x74a: PushEmpty(float, cvector, float, cvector)
0x74b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x74c: Pop(0)
...
0x757: Stack[-7] = Stack[-2]
0x758: Stack[-6] = Stack[-1]
0x759: Call2 0x7cb
...
0x792: Push((float)9.999999974752427e-07)
...
0x7fb: Push((float)0.699999988079071)
0x7fc: Push((int) 500)
...
0x806: Pop(0)
0x807: @@ add(Stack[-3]); Obj=1 // @poff=908
0x808: Pop(0)
0x809: Push((int) 16)
...
0x83e: Stack[-2] = Stack[-5]
0x83f: Return(); Pop(4)

0x840: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0x841: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x842: Stack[-5] = (int) 250000
0x843: Push(CvectorIndex(Stack[-6], 1))
0x844: Push((int) 1000)
0x845: Pop(2); Push(Stack[-2] * Stack[-1]);
0x846: Pop(0); Push(Stack[-14] * Stack[-14]);
0x847: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x848: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x849: PushEmpty(float, float, float, float)
0x84a: Stack[-9] = Stack[-3]
0x84b: Stack[-8] = Stack[-2]
0x84c: Stack[-7] = Stack[-1]
0x84d: Call2 0x7a0

0x84e: Stack[-4] = Stack[-6]
0x84f: Pop(4)
0x850: Push((int) 0)
...
0x855: PushEmpty(float, float, float, float, float)
0x856: Stack[-10] = Stack[-4]
0x857: Stack[-9] = Stack[-3]
0x858: Stack[-8] = Stack[-2]
0x859: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x85a: Call2 0x7a7

0x85b: Pop(4)
0x85c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x85d: Push(CVector(0.0, 500.0, 0.0))
0x85e: Pop(1); Push(Stack[-1] * Stack[-2]);
0x85f: Pop(1); Push(Stack[-1] * Stack[-2]);
0x860: Pop(1); Push(Stack[-7] + Stack[-1]);
0x861: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x862: Return(); Pop(12)

0x863: PushEmpty(int, int)
0x864: Push("branch") // @poff=1013
...
0x876: PushEmpty(int, bool, int, bool)
0x877: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x878: IF (Stack[-1] == 0) GOTO 0x87d; Pop(1)

0x879: Push("GenerateMoney: iMin > iMax") // @poff=1027
0x87a: @ Trace(Stack[-1])
0x87b: Pop(1)
0x87c: Return(); Pop(4)

0x87d: Stack[-2] = (int) 0
0x87e: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x87f: IF (Stack[-1] == 0) GOTO 0x884; Pop(1)

0x880: Pop(0); Push(Stack[-5] - Stack[-6]);
0x881: @ irand(Stack[-3], Stack[-1])
0x882: Pop(1)
0x883: GOTO 0x888

0x884: Push((int) 0)
0x885: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x886: IF (Stack[-1] == 0) GOTO 0x888; Pop(1)

0x887: Return(); Pop(4)

0x888: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x889: Push((int) 0)
...
0x88e: Stack[-1] = "Money" // @poff=1081
0x88f: Call2 0x8dc

0x890: Pop(1)
0x891: Push((int) 0)
0x892: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x893: Pop(2)
0x894: Return(); Pop(4)

0x895: PushEmpty(object, int, bool, object, int, bool)
0x896: @ CreateInvItem(Stack[-3])
0x897: Pop(0)
0x898: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1093
0x899: Pop(0)
0x89a: Push("Organ") // @poff=1105
0x89b: Push((int) 1)
0x89c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=764
0x89d: Pop(2)
0x89e: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1117
0x89f: Pop(0)
0x8a0: Push((int) 0)
0x8a1: Push((int) 1)
0x8a2: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x8a3: Pop(2)
0x8a4: Return(); Pop(6)
...
0x8a8: Pop(0)
0x8a9: Push((int) 1)
0x8aa: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x8ab: IF (Stack[-1] == 0) GOTO 0x8ad; Pop(1)

0x8ac: Return(); Pop(0)

0x8ad: PushEmpty(string)
0x8ae: Stack[-1] = "liver" // @poff=1127
0x8af: Call2 0x895

0x8b0: Pop(1)
0x8b1: PushEmpty(string)
0x8b2: Stack[-1] = "kidney" // @poff=1139
0x8b3: Call2 0x895

0x8b4: Pop(1)
0x8b5: PushEmpty(string)
0x8b6: Stack[-1] = "heart" // @poff=1153
0x8b7: Call2 0x895

0x8b8: Pop(1)
0x8b9: PushEmpty(string)
0x8ba: Stack[-1] = "blood" // @poff=1165
0x8bb: Call2 0x895

0x8bc: Pop(1)
0x8bd: Return(); Pop(0)

0x8be: PushEmpty(int, bool, int, bool)
0x8bf: Push((int) 0)
0x8c0: @ ClearSubContainer(Stack[-1])
0x8c1: Pop(1)
0x8c2: PushEmpty(int, int)
0x8c3: Stack[-2] = (int) 300
0x8c4: Stack[-1] = (int) 750
0x8c5: Call2 0x876

0x8c6: Pop(2)
0x8c7: PushEmpty(string, int, int)
0x8c8: Stack[-3] = "Knife" // @poff=1177
0x8c9: Stack[-2] = (int) 1
0x8ca: Stack[-1] = (int) 8
0x8cb: Call2 0x755

0x8cc: Pop(3)
0x8cd: PushEmpty(string, int, int)
0x8ce: Stack[-3] = "lockpick" // @poff=1189
0x8cf: Stack[-2] = (int) 1
0x8d0: Stack[-1] = (int) 6
0x8d1: Call2 0x755
...
0x8d4: Stack[-1] = "grabitel_mark" // @poff=1207
0x8d5: Call2 0x8dc
...
0x8dd: @ GetInvItemByName(Stack[-1], Stack[-3])
0x8de: Pop(0)
0x8df: Stack[-1] = Stack[-4]
0x8e0: Return(); Pop(2)

0x8e1: PushEmpty(object, object)
0x8e2: @ GetScene(Stack[-1])
0x8e3: Pop(0)
0x8e4: PushEmpty(object)
0x8e5: Call2 0x789

0x8e6: Pop(0)
0x8e7: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x8e8: Pop(1)
0x8e9: PushEmpty(bool, object)
0x8ea: Stack[-5] = Stack[-1]
0x8eb: Call2 0x5d9
...
0x8ef: Stack[-6] = Stack[-2]
0x8f0: Stack[-1] = (float) 0.019999999552965164
0x8f1: Call2 0x7d0

0x8f2: Pop(3)
0x8f3: PushEmpty(object)
0x8f4: Stack[-4] = Stack[-1]
0x8f5: Push(-1, 0); TaskCall(4)
0x8f6: Call2 0x4f7

0x8f7: Pop(-1, 0); TaskReturn
0x8f8: Pop(1)
0x8f9: Return(); Pop(2)

0x8fa: Stack[-1] = 0
0x8fb: PushEmpty()
0x8fc: PushEmpty(object, int, float)
0x8fd: Stack[-7] = Stack[-3]
0x8fe: Stack[-6] = Stack[-2]
0x8ff: Stack[-5] = Stack[-1]
0x900: Call2 0x6e8
...
0x903: PushEmpty()
0x904: PushEmpty(object, int, float, cvector, cvector)
0x905: Stack[-11] = Stack[-5]
0x906: Stack[-10] = Stack[-4]
0x907: Stack[-9] = Stack[-3]
0x908: Stack[-7] = Stack[-2]
0x909: Stack[-6] = Stack[-1]
0x90a: Call2 0x72c

0x90b: Pop(5)
0x90c: Return(); Pop(0)

0x90d: PushEmpty(float, float)
0x90e: Push("health") // @poff=776
0x90f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x910: IF (Stack[-1] == 0) GOTO 0x919; Pop(1)

0x911: Push("health") // @poff=776
0x912: @ GetProperty(Stack[-1], Stack[-2])
0x913: Pop(1)
0x914: Push((int) 0)
0x915: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x916: IF (Stack[-1] == 0) GOTO 0x919; Pop(1)

0x917: @ SignalDeath(Stack[-4])
0x918: Pop(0)
0x919: Return(); Pop(2)

0x91a: PushEmpty()
0x91b: PushEmpty(object)
0x91c: Stack[-2] = Stack[-1]
0x91d: Call2 0x8e1
...
0x92f: PushEmpty()
0x930: Stack[-3] = (bool) 0
0x931: Return(); Pop(0)

0x932: PushEmpty(object, object)
0x933: @ GetScene(Stack[-1])
0x934: Pop(0)
0x935: PushEmpty(object)
0x936: Call2 0x789

0x937: Pop(0)
0x938: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x939: Pop(1)
0x93a: PushEmpty(bool, object)
0x93b: Stack[-5] = Stack[-1]
0x93c: Push(-2, 0); TaskCall(5)
0x93d: Call2 0x597

0x93e: Pop(-2, 0); TaskReturn
0x93f: Pop(2)
0x940: Return(); Pop(2)
