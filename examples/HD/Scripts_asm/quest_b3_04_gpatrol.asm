...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
...
0x65d: Push((float)0.699999988079071)
0x65e: Push((int) 500)
...
0x68f: Pop(0)
0x690: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x691: Pop(0)
0x692: Push("Organ") // @poff=829
0x693: Push((int) 1)
0x694: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=622
0x695: Pop(2)
0x696: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x697: Pop(0)
0x698: Push((int) 0)
0x699: Push((int) 1)
...
0x6a6: Stack[-1] = "liver" // @poff=851
0x6a7: Call2 0x68d

0x6a8: Pop(1)
0x6a9: PushEmpty(string)
0x6aa: Stack[-1] = "kidney" // @poff=863
0x6ab: Call2 0x68d

0x6ac: Pop(1)
0x6ad: PushEmpty(string)
0x6ae: Stack[-1] = "heart" // @poff=877
0x6af: Call2 0x68d

0x6b0: Pop(1)
0x6b1: PushEmpty(string)
0x6b2: Stack[-1] = "blood" // @poff=889
0x6b3: Call2 0x68d
...
0x6bb: Pop(0)
0x6bc: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=901
0x6bd: Pop(1)
0x6be: Return(); Pop(2)

0x6bf: Stack[-1] = 0
0x6c0: PushEmpty(bool, bool)
0x6c1: Push("revolver_ammo") // @poff=923
0x6c2: Push((int) 0)
0x6c3: Push((int) 2)
0x6c4: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6c5: Pop(3)
0x6c6: Push("alpha_pills") // @poff=951
0x6c7: Push((int) 0)
0x6c8: Push((int) 12)
...
0x6da: Stack[-7] = Stack[-3]
0x6db: Stack[-6] = Stack[-2]
...
0x6e2: Stack[-11] = Stack[-5]
0x6e3: Stack[-10] = Stack[-4]
0x6e4: Stack[-9] = Stack[-3]
0x6e5: Stack[-7] = Stack[-2]
0x6e6: Stack[-6] = Stack[-1]
0x6e7: Call2 0x5e2
