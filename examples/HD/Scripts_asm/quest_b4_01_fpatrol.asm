...
0x6a0: Push((float)0.699999988079071)
0x6a1: Push((int) 500)
...
0x6ab: Pop(0)
0x6ac: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6de: Pop(0)
0x6df: @@ SetItemName(Stack[-7]); Obj=3 // @poff=886
0x6e0: Pop(0)
0x6e1: Push("Organ") // @poff=898
0x6e2: Push((int) 1)
0x6e3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=695
0x6e4: Pop(2)
0x6e5: @@ GetItemID(Stack[-2]); Obj=3 // @poff=910
0x6e6: Pop(0)
0x6e7: Push((int) 0)
0x6e8: Push((int) 1)
...
0x6f5: Stack[-1] = "liver" // @poff=920
0x6f6: Call2 0x6dc

0x6f7: Pop(1)
0x6f8: PushEmpty(string)
0x6f9: Stack[-1] = "kidney" // @poff=932
0x6fa: Call2 0x6dc

0x6fb: Pop(1)
0x6fc: PushEmpty(string)
0x6fd: Stack[-1] = "heart" // @poff=946
0x6fe: Call2 0x6dc

0x6ff: Pop(1)
0x700: PushEmpty(string)
0x701: Stack[-1] = "blood" // @poff=958
0x702: Call2 0x6dc
...
0x70f: Stack[-2] = "quest_b4_01" // @poff=24
0x710: Stack[-1] = "patrol_dead" // @poff=970
0x711: Call2 0x6a9

0x712: Pop(3)
0x713: Push("revolver_ammo") // @poff=994
0x714: Push((int) 0)
0x715: Push((int) 4)
0x716: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x717: Pop(3)
0x718: Push("meradorm") // @poff=1022
0x719: Push((int) 0)
0x71a: Push((int) 1)
0x71b: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x71c: Pop(3)
0x71d: Push("morfin") // @poff=1040
0x71e: Push((int) 0)
0x71f: Push((int) 1)
0x720: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x721: Pop(3)
0x722: PushEmpty(string, int, int, int)
0x723: Stack[-4] = "alpha_pills" // @poff=1054
0x724: Stack[-3] = (int) 2
0x725: Stack[-2] = (int) 3
0x726: Stack[-1] = (int) 5
0x727: Call2 0x639
...
0x72a: Stack[-4] = "beta_pills" // @poff=1078
0x72b: Stack[-3] = (int) 2
0x72c: Stack[-2] = (int) 3
0x72d: Stack[-1] = (int) 4
0x72e: Call2 0x639
...
0x73c: Stack[-7] = Stack[-3]
0x73d: Stack[-6] = Stack[-2]
...
0x744: Stack[-11] = Stack[-5]
0x745: Stack[-10] = Stack[-4]
0x746: Stack[-9] = Stack[-3]
0x747: Stack[-7] = Stack[-2]
0x748: Stack[-6] = Stack[-1]
0x749: Call2 0x610
