...
Strings:
	...
	W:blood_dir.xml
	W:battle
// @pool_raw:
...
0x25: Stack[-1] = 0
0x26: PushEmpty()
0x27: Stack[-3] = (float) 0.019999999552965164
0x28: Return(); Pop(0)
...
0x41: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x42: Pop(0)
0x43: Push(Stack[-8])
0x44: IF (Stack[-1] == 0) GOTO 0x4d; Pop(1)

0x45: Push("attack") // @poff=86
...
0x61: Pop(0)
0x62: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=100
0x63: Pop(0)
...
0x7d: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=100
0x7e: Pop(0)
...
0x97: Pop(1)
0x98: Push("all") // @poff=114
0x99: Push("attack_on") // @poff=122
...
0xb1: IF (Stack[-1] == 1) GOTO 0xb7; Pop(1)
...
0xbc: Pop(0)
0xbd: Push("all") // @poff=114
0xbe: Push("attack_stay") // @poff=142
0xbf: @ PlayAnimation(Stack[-2], Stack[-1])
0xc0: Pop(2)
0xc1: PushEmpty(bool, float)
0xc2: Stack[-25] = Stack[-1]
0xc3: Call2 0x1ff
...
0xc8: @ Face(Stack[-0]T)
0xc9: Pop(0)
0xca: Push("all") // @poff=114
0xcb: Push("fjump") // @poff=166
...
0xe6: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=100
0xe7: Pop(0)
...
0x105: Push("all") // @poff=114
0x106: Push("attack_off") // @poff=178
...
0x113: Push("all") // @poff=114
0x114: Push("attack_begin") // @poff=200
0x115: Push((int) 1)
0x116: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x121: Push("attack") // @poff=86
0x122: Push((int) 1)
0x123: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x12d: Push("all") // @poff=114
0x12e: Push("bjump") // @poff=226
...
0x135: Push((float)0.8999999761581421)
0x136: Pop(1); Push(Stack[-9] * Stack[-1]);
0x137: @ GetVictim(Stack[-1], Stack[-4])
0x138: Pop(1)
0x139: @ ReportAttack(Stack[-0]T)
0x13a: Pop(0)
...
0x14d: Stack[-4] = Stack[-5]
0x14e: Pop(4)
0x14f: PushEmpty(int)
0x150: Call2 0x2b3

0x151: Pop(0)
0x152: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x153: Pop(1)
0x154: PushEmpty(object, float)
0x155: Stack[-5] = Stack[-2]
...
0x15e: Pop(0)
0x15f: @ irand(Stack[-4], Stack[-1]T)
0x160: Pop(0)
0x161: Push((int) 1)
0x162: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x163: @ Face(Stack[-0]T)
0x164: Pop(0)
0x165: Push((bool) 1)
...
0x16a: Pop(0)
0x16b: Push("all") // @poff=114
0x16c: Push("attack_begin") // @poff=200
...
0x183: Pop(2)
0x184: Push("all") // @poff=114
0x185: Push("attack_middle") // @poff=238
...
0x18d: Pop(0)
0x18e: Push("all") // @poff=114
0x18f: Push("attack_middle") // @poff=238
...
0x1c9: Stack[-11] = Stack[-2]
0x1ca: Stack[-6] = Stack[-1]
0x1cb: Call2 0x134
...
0x1d2: Pop(1)
0x1d3: Push("all") // @poff=114
0x1d4: Push("attack_end") // @poff=270
...
0x213: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=100
0x214: Pop(0)
...
0x25f: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x260: Pop(1)
...
0x264: @ Face(Stack[-0]T)
0x265: Pop(0)
0x266: Push("all") // @poff=114
0x267: Push("bjump") // @poff=226
0x268: @ PlayAnimation(Stack[-2], Stack[-1])
0x269: Pop(2)
0x26a: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=100
0x26b: Pop(0)
...
0x2a1: @ irand(Stack[-1], Stack[-2]T)
0x2a2: Pop(0)
0x2a3: Push((int) 1)
0x2a4: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x2a5: Push("attack") // @poff=86
...
0x2b6: Stack[-1] = "attack_stay" // @poff=142
0x2b7: Call2 0x58a
...
0x2e1: Stack[-15] = Stack[-5]
0x2e2: Stack[-14] = Stack[-4]
0x2e3: Stack[-13] = Stack[-3]
0x2e4: Stack[-12] = Stack[-2]
0x2e5: Stack[-11] = Stack[-1]
0x2e6: Call2 0x32b

0x2e7: Stack[-6] = Stack[-7]
0x2e8: Pop(6)
0x2e9: Push( Stack[2 + Tasks[-1].StackPointer] )
0x2ea: IF (Stack[-1] == 0) GOTO 0x2ee; Pop(1)

0x2eb: Push("head") // @poff=328
...
0x32e: Stack[-17] = Stack[-7]
0x32f: PushEmpty(bool, object)
0x330: Stack[-23] = Stack[-1]
0x331: Call2 0x3b7
...
0x337: @@ GetPosition(Stack[-5]); Obj=21 // @poff=338
0x338: Pop(0)
...
0x34e: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=100
0x34f: Pop(0)
...
0x360: Push((int) 0)
0x361: Push((float)0.30000001192092896)
...
0x383: Push((int) 0)
0x384: Push((float)0.30000001192092896)
...
0x3be: Stack[-1] = "walk" // @poff=350
0x3bf: Return(); Pop(0)

0x3c0: Stack[-1] = "run" // @poff=360
0x3c1: Return(); Pop(0)
...
0x3cc: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3cd: IF (Stack[-1] == 0) GOTO 0x3d3; Pop(1)

0x3ce: PushEmpty(string)
0x3cf: Stack[-1] = "fdie" // @poff=368
0x3d0: Call2 0x426

0x3d1: Pop(1)
0x3d2: GOTO 0x425

0x3d3: @@ GetPosition(Stack[-10]); Obj=21 // @poff=338
0x3d4: Pop(0)
...
0x3e4: Stack[-6] = "fdie" // @poff=368
0x3e5: GOTO 0x3e7

0x3e6: Stack[-6] = "bdie" // @poff=378
...
0x3ed: @ StopAsync()
0x3ee: Pop(0)
0x3ef: Stack[-21] = Stack[-5]
0x3f0: Push("GetScriptProperty") // @poff=388
0x3f1: Push((int) 2)
0x3f2: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3f3: IF (Stack[-1] == 0) GOTO 0x3ff; Pop(1)

0x3f4: Push("Owner") // @poff=424
0x3f5: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=436
0x3f6: Pop(1)
0x3f7: Push(Stack[-4])
0x3f8: IF (Stack[-1] == 0) GOTO 0x3ff; Pop(1)

0x3f9: Push("Owner") // @poff=424
0x3fa: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=454
0x3fb: Pop(1)
0x3fc: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3fd: IF (Stack[-1] == 0) GOTO 0x3ff; Pop(1)

0x3fe: Stack[-21] = Stack[-5]
0x3ff: Push("@GetEyesHeight") // @poff=472
0x400: Push((int) 1)
0x401: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x402: IF (Stack[-1] == 0) GOTO 0x40e; Pop(1)

0x403: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=502
0x404: Pop(0)
0x405: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x406: Push(CvectorIndex(Stack[-1], 1))
0x407: Stack[-3] = Stack[-1]
0x408: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x409: Push("head") // @poff=328
...
0x410: Stack[-7] = Stack[-1]
0x411: Call2 0x58a

0x412: Pop(1)
0x413: Push("all") // @poff=114
...
0x41a: @ StopAsync()
0x41b: Pop(0)
0x41c: Push("head") // @poff=328
0x41d: @ UnlookAsync(Stack[-1])
0x41e: Pop(1)
0x41f: Push("all") // @poff=114
...
0x450: Stack[-2] = "bullet" // @poff=526
0x451: Return(); Pop(0)

0x452: Stack[-2] = "phys" // @poff=540
0x453: Return(); Pop(0)

0x454: PushEmpty(cvector, cvector, cvector, cvector)
0x455: @ GetPosition(Stack[-2])
0x456: Pop(0)
0x457: @@ GetPosition(Stack[-1]); Obj=5 // @poff=338
0x458: Pop(0)
...
0x461: Push("HasProperty") // @poff=550
0x462: Push((int) 2)
...
0x468: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=574
0x469: Pop(0)
0x46a: Stack[-1] = Stack[-5]
0x46b: Return(); Pop(2)

0x46c: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x46d: PushEmpty(bool, object, string)
0x46e: Stack[-18] = Stack[-2]
0x46f: Stack[-1] = "health" // @poff=586
0x470: Call2 0x460
...
0x477: Stack[-18] = Stack[-2]
0x478: Stack[-1] = "armor" // @poff=600
0x479: Call2 0x460
...
0x47f: Push("armor") // @poff=600
0x480: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=612
0x481: Pop(1)
0x482: Push("armor_") // @poff=624
0x483: PushEmpty(string, int)
0x484: Stack[-16] = Stack[-1]
0x485: Call2 0x446

0x486: Pop(1)
0x487: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x488: PushEmpty(bool, object, string)
0x489: Stack[-18] = Stack[-2]
0x48a: Stack[-8] = Stack[-1]
0x48b: Call2 0x460
...
0x491: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=612
0x492: Pop(0)
...
0x499: Stack[-3] = Stack[-6]
0x49a: Pop(3)
0x49b: Push("health") // @poff=586
0x49c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=612
0x49d: Pop(1)
0x49e: Push((int) 1)
0x49f: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4a0: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4a1: Push("health") // @poff=586
...
0x4a7: Pop(3)
0x4a8: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=638
0x4a9: Pop(2)
0x4aa: PushEmpty(bool, object)
0x4ab: Stack[-17] = Stack[-1]
0x4ac: Call2 0x45b
...
0x4b6: @@ IsDead(Stack[-1]); Obj=3 // @poff=650
0x4b7: Pop(0)
0x4b8: Stack[-1] = Stack[-4]
0x4b9: Return(); Pop(2)

0x4ba: PushEmpty(object, object, object, object)
0x4bb: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4cf: Pop(0)
0x4d0: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4d1: IF (Stack[-1] == 0) GOTO 0x4d4; Pop(1)

0x4d2: Stack[-6] = (bool) 0
0x4d3: Return(); Pop(4)

0x4d4: @@ GetScene(Stack[-1]); Obj=5 // @poff=671
0x4d5: Pop(0)
...
0x4e8: Stack[-6] = Stack[-2]
0x4e9: Stack[-1] = "noaccess" // @poff=680
0x4ea: Call2 0x460
...
0x4f0: Push("noaccess") // @poff=680
0x4f1: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=612
0x4f2: Pop(1)
0x4f3: Push((int) 0)
...
0x4f7: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x505: @@ GetPosition(Stack[-5]); Obj=15 // @poff=338
0x506: Pop(0)
...
0x516: Stack[-1] = "fhit" // @poff=698
0x517: GOTO 0x519

0x518: Stack[-1] = "bhit" // @poff=708
0x519: Push("hit_react") // @poff=718
0x51a: Push("1") // @poff=738
0x51b: Pop(1); Push(Stack[-3] + Stack[-1]);
0x51c: Push("2") // @poff=742
...
0x53a: Stack[-2] = Stack[-11]
0x53b: Pop(2)
0x53c: @ CreateVectorVector(Stack[-8])
0x53d: Pop(0)
0x53e: Stack[-7] = (int) 1
0x53f: Push("hit") // @poff=700
...
0x554: Pop(0)
0x555: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=755
0x556: Pop(0)
0x557: PushEmpty(object, int, float, cvector, cvector)
0x558: Stack[-26] = Stack[-5]
0x559: Stack[-25] = Stack[-4]
0x55a: Stack[-24] = Stack[-3]
0x55b: Stack[-6] = Stack[-2]
...
0x575: @@ GetPosition(Stack[-3]); Obj=7 // @poff=338
0x576: Pop(0)
...
0x604: Stack[-2] = Stack[-1]
0x605: Push(-1, 0); TaskCall(3)
0x606: Call2 0x3c2
...
0x60c: Stack[-7] = Stack[-3]
0x60d: Stack[-6] = Stack[-2]
...
0x614: Stack[-11] = Stack[-5]
0x615: Stack[-10] = Stack[-4]
0x616: Stack[-9] = Stack[-3]
0x617: Stack[-7] = Stack[-2]
