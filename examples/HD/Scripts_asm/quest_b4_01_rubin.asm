...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x120: Stack[-1] = "Warning" // @poff=142
0x121: Call2 0xae
...
0x156: Stack[-1] = "Warning" // @poff=142
0x157: Call2 0xae
...
0x168: Stack[-1] = "Warning" // @poff=142
0x169: Call2 0xae
...
0x17a: Stack[-1] = "Warning" // @poff=142
0x17b: Call2 0xae
...
0x19e: Stack[-1] = "Confusion" // @poff=89
0x19f: Call2 0xae
...
0x1b5: Stack[-1] = "Warning" // @poff=142
0x1b6: Call2 0xae
...
0x1cc: Stack[-1] = "Warning" // @poff=142
0x1cd: Call2 0xae
...
0x1de: Stack[-1] = "Confusion" // @poff=89
0x1df: Call2 0xae

0x1e0: Pop(1)
0x1e1: Push((int) 518975)
0x1e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1e3: Pop(1)
0x1e4: @@@ ClearReplies(); Obj=0 // @poff=120
0x1e5: Pop(0)
0x1e6: Push((int) 518993)
0x1e7: Push((int) 20110)
0x1e8: Push((int) 20108)
0x1e9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1ea: Pop(3)
...
0x1f5: Stack[-1] = "Rage" // @poff=176
0x1f6: Call2 0xae

0x1f7: Pop(1)
0x1f8: Push((int) 518995)
0x1f9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1fa: Pop(1)
0x1fb: @@@ ClearReplies(); Obj=0 // @poff=120
0x1fc: Pop(0)
0x1fd: Push((int) 518996)
0x1fe: Push((int) 20113)
0x1ff: Push((int) 20112)
0x200: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x201: Pop(3)
...
0x20c: Stack[-1] = "Rage" // @poff=176
0x20d: Call2 0xae

0x20e: Pop(1)
0x20f: Push((int) 518997)
0x210: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x211: Pop(1)
0x212: @@@ ClearReplies(); Obj=0 // @poff=120
0x213: Pop(0)
0x214: Push((int) 518998)
0x215: Push((int) 20115)
0x216: Push((int) 20114)
0x217: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x218: Pop(3)
0x219: Return(); Pop(0)
...
0x21e: Stack[-1] = "Rage" // @poff=176
0x21f: Call2 0xae

0x220: Pop(1)
0x221: Push((int) 518999)
0x222: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x223: Pop(1)
0x224: @@@ ClearReplies(); Obj=0 // @poff=120
0x225: Pop(0)
0x226: Push((int) 519005)
0x227: Push((int) 20122)
0x228: Push((int) 20121)
0x229: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x22a: Pop(3)
0x22b: Push((int) 519001)
0x22c: Push((int) 20118)
0x22d: Push((int) 20117)
0x22e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x22f: Pop(3)
0x230: Return(); Pop(0)
...
0x235: Stack[-1] = "Neutral" // @poff=186
0x236: Call2 0xae

0x237: Pop(1)
0x238: Push((int) 519002)
0x239: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x23a: Pop(1)
0x23b: @@@ ClearReplies(); Obj=0 // @poff=120
0x23c: Pop(0)
0x23d: Push((int) 519003)
0x23e: Push((int) 20124)
0x23f: Push((int) 20119)
0x240: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x241: Pop(3)
0x242: Return(); Pop(0)
...
0x247: Stack[-1] = "Neutral" // @poff=186
0x248: Call2 0xae

0x249: Pop(1)
0x24a: Push((int) 519007)
0x24b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x24c: Pop(1)
0x24d: @@@ ClearReplies(); Obj=0 // @poff=120
0x24e: Pop(0)
0x24f: Push((int) 519008)
0x250: Push((int) 20122)
0x251: Push((int) 20125)
0x252: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x253: Pop(3)
0x254: Return(); Pop(0)
...
0x259: Stack[-1] = "Confusion" // @poff=89
0x25a: Call2 0xae

0x25b: Pop(1)
0x25c: Push((int) 519006)
0x25d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x25e: Pop(1)
0x25f: @@@ ClearReplies(); Obj=0 // @poff=120
0x260: Pop(0)
0x261: Push((int) 519000)
0x262: Push((int) 20120)
0x263: Push((int) 20116)
0x264: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x265: Pop(3)
0x266: Return(); Pop(0)
...
0x26b: Stack[-1] = "Confusion" // @poff=89
0x26c: Call2 0xae

0x26d: Pop(1)
0x26e: Push((int) 519004)
0x26f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x270: Pop(1)
0x271: @@@ ClearReplies(); Obj=0 // @poff=120
0x272: Pop(0)
0x273: Push((int) 519009)
0x274: Push((int) 20128)
0x275: Push((int) 20127)
0x276: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x277: Pop(3)
0x278: Return(); Pop(0)
...
0x27d: Stack[-1] = "Neutral" // @poff=186
0x27e: Call2 0xae

0x27f: Pop(1)
0x280: Push((int) 519010)
0x281: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x282: Pop(1)
0x283: @@@ ClearReplies(); Obj=0 // @poff=120
0x284: Pop(0)
0x285: Push((int) 519011)
0x286: Push((int) 20130)
0x287: Push((int) 20129)
0x288: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x289: Pop(3)
0x28a: Return(); Pop(0)
...
0x28f: Stack[-1] = "Neutral" // @poff=186
0x290: Call2 0xae

0x291: Pop(1)
0x292: Push((int) 519012)
0x293: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x294: Pop(1)
0x295: @@@ ClearReplies(); Obj=0 // @poff=120
0x296: Pop(0)
0x297: Push((int) 518559)
0x298: Push((int) -1)
0x299: Push((int) 19669)
0x29a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x29b: Pop(3)
0x29c: Push((int) 519013)
0x29d: Push((int) -1)
0x29e: Push((int) 20131)
0x29f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2a0: Pop(3)
0x2a1: Return(); Pop(0)
...
0x35e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x35f: Pop(0)
0x360: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=230
0x361: Pop(0)
...
0x3cd: Push("voice_common") // @poff=254
0x3ce: Push((int) 1)
...
0x3d5: Push("voice_common") // @poff=254
0x3d6: Push((int) 0)
...
0x3e8: Push("voice_common") // @poff=254
0x3e9: Push((int) 1)
...
0x3f6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x3f7: Pop(1)
...
0x421: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x422: Pop(1)
...
0x436: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=296
0x437: Pop(1)
0x438: PushEmpty(bool, string)
0x439: Stack[-3] = Stack[-1]
0x43a: Call2 0x45d

0x43b: Stack[-2] = Stack[-14]
0x43c: Pop(2)
0x43d: Return(); Pop(10)
...
0x449: Push("Can't find lsh animation : ") // @poff=312
...
0x458: Push("Can't find lsh animation : ") // @poff=312
...
0x47c: Push((float)9.999999974752427e-07)
...
0x495: Stack[-1] = "ui/NPC_Rubin.png" // @poff=368
0x496: Return(); Pop(0)

0x497: Stack[-1] = "ui/NPC_Rubin_b.png" // @poff=402
0x498: Return(); Pop(0)
...
0x4a3: Stack[-2] = (int) 0
0x4a4: Push("all") // @poff=158
0x4a5: PushEmpty(string, int)
0x4a6: Stack[-5] = Stack[-1]
0x4a7: Call2 0x49b
...
0x4b1: Stack[-2] = Stack[-5]
0x4b2: Return(); Pop(4)

0x4b3: PushEmpty()
0x4b4: Push("oob4Rubin1") // @poff=440
0x4b5: Push((int) 1)
...
0x4c2: PushEmpty()
0x4c3: Push("oob4Rubin2") // @poff=474
0x4c4: Push((int) 1)
...
0x4ca: Stack[-1] = "oob4Rubin1" // @poff=440
0x4cb: Call2 0x483
...
0x4d6: Stack[-1] = "oob4Rubin2" // @poff=474
0x4d7: Call2 0x483
...
0x4f2: Push("Can't retrieve diary root") // @poff=496
0x4f3: @ Trace(Stack[-1])
0x4f4: Pop(1)
...
0x4fe: Pop(1)
0x4ff: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=548
0x500: Pop(0)
0x501: Pop(0); Push((bool) Stack[-2] == 0)
0x502: IF (Stack[-1] == 0) GOTO 0x509; Pop(1)

0x503: Push("Can't find diary parent with id: ") // @poff=553
...
0x509: @@ AddChild(Stack[-8]); Obj=2 // @poff=621
0x50a: Pop(0)
0x50b: Push((int) 7)
0x50c: @ SendWorldWndMessage(Stack[-1])
0x50d: Pop(1)
0x50e: @@ GetCategory(Stack[-1]); Obj=8 // @poff=630
0x50f: Pop(0)
