...
Strings:
	...
	W:oob4boy2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x9d5 Vars = (object, int, float, float)
EVENT_43 Op = 0x9dd Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x9e7 Vars = (object, string)
EVENT_41 Op = 0x9f4 Vars = (object)
...
0x232: Pop(0)
0x233: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=164
0x234: Pop(1)
0x235: PushEmpty(bool, string, int, bool)
0x236: Stack[-3] = "pt_b4q02_boy_path" // @poff=186
0x237: Stack[-2] = (int) 0
...
0x257: @@ GetLocator(Stack[-1], Stack[-5], Stack[-4], Stack[-3]); Obj=8 // @poff=222
0x258: Pop(1)
...
0x262: Stack[-19] = Stack[-3]
0x263: Stack[-6] = Stack[-2]
...
0x293: Pop(0)
0x294: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=164
0x295: Pop(1)
0x296: PushEmpty(object, bool, float)
0x297: Stack[-6] = Stack[-3]
...
0x2a1: Stack[-1] = 0
0x2a2: PushEmpty()
0x2a3: Stack[-3] = (float) 0.029999999329447746
0x2a4: Return(); Pop(0)
...
0x2bd: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x2be: Pop(0)
0x2bf: Push(Stack[-8])
0x2c0: IF (Stack[-1] == 0) GOTO 0x2c9; Pop(1)

0x2c1: Push("attack") // @poff=289
...
0x2dd: Pop(0)
0x2de: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=303
0x2df: Pop(0)
...
0x2f9: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=303
0x2fa: Pop(0)
...
0x32d: IF (Stack[-1] == 1) GOTO 0x333; Pop(1)

0x32e: PushEmpty(bool)
0x32f: Call2 0x4ff

0x330: Pop(0)
0x331: IF (Stack[-1] == 1) GOTO 0x333; Pop(1)

0x332: Stack[-1] = (bool) 0
0x333: IF (Stack[-1] == 0) GOTO 0x344; Pop(1)

0x334: @ Face(Stack[-0]T)
0x335: Pop(0)
0x336: PushEmpty()
0x337: Call2 0x531

0x338: Pop(0)
0x339: Push("all") // @poff=138
0x33a: Push("attack_stay") // @poff=337
0x33b: @ PlayAnimation(Stack[-2], Stack[-1])
0x33c: Pop(2)
0x33d: PushEmpty(bool, float)
0x33e: Stack[-25] = Stack[-1]
0x33f: Call2 0x47b
...
0x344: @ Face(Stack[-0]T)
0x345: Pop(0)
0x346: Push("all") // @poff=138
0x347: Push("fjump") // @poff=361
...
0x362: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=303
0x363: Pop(0)
...
0x381: Push("all") // @poff=138
0x382: Push("attack_off") // @poff=373
...
0x38f: Push("all") // @poff=138
0x390: Push("attack_begin") // @poff=395
0x391: Push((int) 1)
0x392: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x39d: Push("attack") // @poff=289
0x39e: Push((int) 1)
0x39f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3a9: Push("all") // @poff=138
0x3aa: Push("bjump") // @poff=421
...
0x3b1: Push((float)0.8999999761581421)
0x3b2: Pop(1); Push(Stack[-9] * Stack[-1]);
0x3b3: @ GetVictim(Stack[-1], Stack[-4])
0x3b4: Pop(1)
0x3b5: @ ReportAttack(Stack[-0]T)
0x3b6: Pop(0)
...
0x3ba: Stack[-6] = Stack[-2]
0x3bb: Stack[-10] = Stack[-1]
0x3bc: Call2 0x2a2

0x3bd: Stack[-3] = Stack[-5]
0x3be: Pop(3)
0x3bf: PushEmpty(float, object, float, int)
0x3c0: Stack[-7] = Stack[-3]
0x3c1: Stack[-6] = Stack[-2]
0x3c2: PushEmpty(int, object, int)
0x3c3: Stack[-10] = Stack[-2]
0x3c4: Stack[-14] = Stack[-1]
0x3c5: Call2 0x2a5

0x3c6: Stack[-3] = Stack[-4]
0x3c7: Pop(3)
0x3c8: Call2 0x70e

0x3c9: Stack[-4] = Stack[-5]
0x3ca: Pop(4)
0x3cb: PushEmpty(int)
0x3cc: Call2 0x52f

0x3cd: Pop(0)
0x3ce: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x3cf: Pop(1)
...
0x3da: Pop(0)
0x3db: @ irand(Stack[-4], Stack[-1]T)
0x3dc: Pop(0)
0x3dd: Push((int) 1)
0x3de: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3df: @ Face(Stack[-0]T)
0x3e0: Pop(0)
0x3e1: Push((bool) 1)
...
0x3e6: Pop(0)
0x3e7: Push("all") // @poff=138
0x3e8: Push("attack_begin") // @poff=395
...
0x3fc: Stack[-11] = Stack[-2]
0x3fd: Stack[-6] = Stack[-1]
0x3fe: Call2 0x3b0

0x3ff: Pop(2)
0x400: Push("all") // @poff=138
0x401: Push("attack_middle") // @poff=433
...
0x40b: Push("attack_middle") // @poff=433
...
0x41f: Stack[-11] = Stack[-2]
0x420: Stack[-6] = Stack[-1]
0x421: Call2 0x3b0

0x422: Pop(2)
0x423: Stack[-2] = (int) 1
0x424: Push("attack_middle") // @poff=433
0x425: Pop(1); Push(Stack[-1] + Stack[-5]);
0x426: Push("_") // @poff=461
0x427: Pop(2); Push(Stack[-2] + Stack[-1]);
0x428: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x429: Push("all") // @poff=138
...
0x44e: Pop(1)
0x44f: Push("all") // @poff=138
0x450: Push("attack_end") // @poff=465
...
0x48f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=303
0x490: Pop(0)
...
0x4db: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x4dc: Pop(1)
...
0x4e0: @ Face(Stack[-0]T)
0x4e1: Pop(0)
0x4e2: Push("all") // @poff=138
0x4e3: Push("bjump") // @poff=421
0x4e4: @ PlayAnimation(Stack[-2], Stack[-1])
0x4e5: Pop(2)
0x4e6: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=303
0x4e7: Pop(0)
...
0x51d: @ irand(Stack[-1], Stack[-2]T)
0x51e: Pop(0)
0x51f: Push((int) 1)
0x520: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x521: Push("attack") // @poff=289
...
0x532: Stack[-1] = "attack_stay" // @poff=337
0x533: Call2 0x8ae
...
0x55d: Stack[-15] = Stack[-5]
0x55e: Stack[-14] = Stack[-4]
0x55f: Stack[-13] = Stack[-3]
0x560: Stack[-12] = Stack[-2]
0x561: Stack[-11] = Stack[-1]
0x562: Call2 0x5a7

0x563: Stack[-6] = Stack[-7]
0x564: Pop(6)
0x565: Push( Stack[2 + Tasks[-1].StackPointer] )
0x566: IF (Stack[-1] == 0) GOTO 0x56a; Pop(1)

0x567: Push("head") // @poff=523
...
0x5aa: Stack[-17] = Stack[-7]
0x5ab: PushEmpty(bool, object)
0x5ac: Stack[-23] = Stack[-1]
0x5ad: Call2 0x633
...
0x5b3: @@ GetPosition(Stack[-5]); Obj=21 // @poff=533
0x5b4: Pop(0)
...
0x5ca: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=303
0x5cb: Pop(0)
...
0x5dc: Push((int) 0)
0x5dd: Push((float)0.30000001192092896)
...
0x5ff: Push((int) 0)
0x600: Push((float)0.30000001192092896)
...
0x637: Stack[-2] = Stack[-4]
0x638: Pop(2)
0x639: Return(); Pop(0)

0x63a: Stack[-1] = "walk" // @poff=545
0x63b: Return(); Pop(0)

0x63c: Stack[-1] = "run" // @poff=156
0x63d: Return(); Pop(0)

0x63e: PushEmpty()
0x63f: EventDisable(0)
0x640: PushEmpty(object)
0x641: Stack[-2] = Stack[-1]
0x642: Call2 0x657
...
0x658: Pop(0); PushNull((bool) Stack[-21] == 0)
0x659: IF (Stack[-1] == 0) GOTO 0x65f; Pop(1)

0x65a: PushEmpty(string)
0x65b: Stack[-1] = "fdie" // @poff=555
0x65c: Call2 0x6b2

0x65d: Pop(1)
0x65e: GOTO 0x6b1

0x65f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=533
0x660: Pop(0)
...
0x670: Stack[-6] = "fdie" // @poff=555
0x671: GOTO 0x673

0x672: Stack[-6] = "bdie" // @poff=565
...
0x679: @ StopAsync()
0x67a: Pop(0)
0x67b: Stack[-21] = Stack[-5]
0x67c: Push("GetScriptProperty") // @poff=575
0x67d: Push((int) 2)
0x67e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x67f: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x680: Push("Owner") // @poff=611
0x681: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=623
0x682: Pop(1)
0x683: Push(Stack[-4])
0x684: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x685: Push("Owner") // @poff=611
0x686: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=641
0x687: Pop(1)
0x688: Pop(0); PushNull((bool) Stack[-5] == 0)
0x689: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x68a: Stack[-21] = Stack[-5]
0x68b: Push("@GetEyesHeight") // @poff=659
0x68c: Push((int) 1)
0x68d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x68e: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x68f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=689
0x690: Pop(0)
0x691: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x692: Push(CvectorIndex(Stack[-1], 1))
0x693: Stack[-3] = Stack[-1]
0x694: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x695: Push("head") // @poff=523
...
0x6a6: @ StopAsync()
0x6a7: Pop(0)
0x6a8: Push("head") // @poff=523
0x6a9: @ UnlookAsync(Stack[-1])
0x6aa: Pop(1)
0x6ab: Push("all") // @poff=138
...
0x6dc: Stack[-2] = "bullet" // @poff=713
0x6dd: Return(); Pop(0)

0x6de: Stack[-2] = "phys" // @poff=727
0x6df: Return(); Pop(0)

0x6e0: PushEmpty(cvector, cvector, cvector, cvector)
0x6e1: @ GetPosition(Stack[-2])
0x6e2: Pop(0)
0x6e3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=533
0x6e4: Pop(0)
...
0x6ed: Push("HasProperty") // @poff=737
0x6ee: Push((int) 2)
...
0x6f4: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=761
0x6f5: Pop(0)
0x6f6: Stack[-1] = Stack[-5]
0x6f7: Return(); Pop(2)

0x6f8: PushEmpty(float, float)
0x6f9: PushEmpty(bool, object, string)
0x6fa: Stack[-10] = Stack[-2]
...
0x702: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=773
0x703: Pop(0)
0x704: PushEmpty(float, float, float, float)
0x705: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x706: Stack[-8] = Stack[-2]
0x707: Stack[-7] = Stack[-1]
0x708: Call2 0x8ee

0x709: Pop(3)
0x70a: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=785
0x70b: Pop(1)
...
0x710: Stack[-18] = Stack[-2]
0x711: Stack[-1] = "health" // @poff=797
0x712: Call2 0x6ec
...
0x719: Stack[-18] = Stack[-2]
0x71a: Stack[-1] = "armor" // @poff=811
0x71b: Call2 0x6ec
...
0x721: Push("armor") // @poff=811
0x722: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=773
0x723: Pop(1)
0x724: Push("armor_") // @poff=823
0x725: PushEmpty(string, int)
0x726: Stack[-16] = Stack[-1]
0x727: Call2 0x6d2

0x728: Pop(1)
0x729: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x72a: PushEmpty(bool, object, string)
0x72b: Stack[-18] = Stack[-2]
0x72c: Stack[-8] = Stack[-1]
0x72d: Call2 0x6ec
...
0x733: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=773
0x734: Pop(0)
...
0x73b: Stack[-3] = Stack[-6]
0x73c: Pop(3)
0x73d: Push("health") // @poff=797
0x73e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=773
0x73f: Pop(1)
0x740: Push((int) 1)
0x741: Pop(1); Push(Stack[-1] - Stack[-4]);
0x742: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x743: Push("health") // @poff=797
...
0x749: Pop(3)
0x74a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=785
0x74b: Pop(2)
0x74c: PushEmpty(bool, object)
0x74d: Stack[-17] = Stack[-1]
0x74e: Call2 0x6e7
...
0x754: Pop(1)
0x755: Stack[-1] = Stack[-16]
0x756: Return(); Pop(12)

0x757: PushEmpty(bool, bool)
0x758: @@ IsDead(Stack[-1]); Obj=3 // @poff=837
0x759: Pop(0)
0x75a: Stack[-1] = Stack[-4]
0x75b: Return(); Pop(2)

0x75c: PushEmpty(object, object, object, object)
0x75d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x771: Pop(0)
0x772: Pop(0); PushNull((bool) Stack[-2] == 0)
0x773: IF (Stack[-1] == 0) GOTO 0x776; Pop(1)

0x774: Stack[-6] = (bool) 0
0x775: Return(); Pop(4)

0x776: @@ GetScene(Stack[-1]); Obj=5 // @poff=858
0x777: Pop(0)
...
0x78a: Stack[-6] = Stack[-2]
0x78b: Stack[-1] = "noaccess" // @poff=867
0x78c: Call2 0x6ec
...
0x792: Push("noaccess") // @poff=867
0x793: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=773
0x794: Pop(1)
0x795: Push((int) 0)
...
0x799: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x7a7: @@ GetPosition(Stack[-5]); Obj=15 // @poff=533
0x7a8: Pop(0)
...
0x7b8: Stack[-1] = "fhit" // @poff=885
0x7b9: GOTO 0x7bb

0x7ba: Stack[-1] = "bhit" // @poff=895
0x7bb: Push("hit_react") // @poff=905
0x7bc: Push("1") // @poff=925
0x7bd: Pop(1); Push(Stack[-3] + Stack[-1]);
0x7be: Push("2") // @poff=929
...
0x7d7: Stack[-25] = Stack[-1]
0x7d8: Call2 0x6e0

0x7d9: Stack[-2] = Stack[-3]
0x7da: Pop(2)
0x7db: Call2 0x8dd
...
0x7f6: Pop(0)
0x7f7: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=942
0x7f8: Pop(0)
0x7f9: PushEmpty(object, int, float, cvector, cvector)
0x7fa: Stack[-26] = Stack[-5]
0x7fb: Stack[-25] = Stack[-4]
0x7fc: Stack[-24] = Stack[-3]
0x7fd: Stack[-6] = Stack[-2]
...
0x817: @@ GetPosition(Stack[-3]); Obj=7 // @poff=533
0x818: Pop(0)
...
0x827: @@ GetPosition(Stack[-8]); Obj=20 // @poff=533
0x828: Pop(0)
0x829: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=689
0x82a: Pop(0)
...
0x850: Pop(0)
0x851: Push((bool) 1)
0x852: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x853: Pop(1)
0x854: Push(CvectorIndex(Stack[-4], 0))
0x855: Push(CvectorIndex(Stack[-5], 2))
0x856: @ Rotate(Stack[-2], Stack[-1])
0x857: Pop(2)
...
0x85d: Push("head") // @poff=523
0x85e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x85f: Pop(1)
0x860: Push(Stack[-1])
0x861: IF (Stack[-1] == 0) GOTO 0x865; Pop(1)

0x862: Push("head") // @poff=523
0x863: @ LookAsyncCamera(Stack[-1])
0x864: Pop(1)
0x865: @ CameraWaitForPlayFinish()
0x866: Pop(0)
0x867: @ ResumeWorld()
0x868: Pop(0)
0x869: Stack[-21] = (bool) 1
0x86a: Return(); Pop(18)

0x86b: PushEmpty(bool, bool)
0x86c: Push((bool) 1)
0x86d: @ CameraSwitchToNormal(Stack[-1])
0x86e: Pop(1)
...
0x874: Push("head") // @poff=523
0x875: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x876: Pop(1)
0x877: Push(Stack[-1])
0x878: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x879: Push("head") // @poff=523
0x87a: @ UnlookAsync(Stack[-1])
0x87b: Pop(1)
0x87c: Return(); Pop(2)

0x87d: PushEmpty(bool, float, float, bool, float, float)
0x87e: @ lshHasAnimation(Stack[-3], Stack[-7])
0x87f: Pop(0)
0x880: Push(Stack[-3])
0x881: IF (Stack[-1] == 0) GOTO 0x888; Pop(1)

0x882: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x883: Pop(0)
0x884: Push((bool) 0)
0x885: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x886: Pop(1)
0x887: GOTO 0x88c

0x888: Push("Can't find lsh animation : ") // @poff=992
0x889: Pop(1); Push(Stack[-1] + Stack[-8]);
0x88a: @ Trace(Stack[-1])
0x88b: Pop(1)
0x88c: Return(); Pop(6)

0x88d: PushEmpty(bool, float, float, bool, float, float)
0x88e: @ lshHasAnimation(Stack[-3], Stack[-8])
0x88f: Pop(0)
0x890: Push(Stack[-3])
0x891: IF (Stack[-1] == 0) GOTO 0x897; Pop(1)

0x892: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x893: Pop(0)
0x894: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x895: Pop(0)
0x896: GOTO 0x89b

0x897: Push("Can't find lsh animation : ") // @poff=992
0x898: Pop(1); Push(Stack[-1] + Stack[-9]);
0x899: @ Trace(Stack[-1])
0x89a: Pop(1)
0x89b: Return(); Pop(6)

0x89c: PushEmpty(float, cvector, float, cvector)
0x89d: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=689
0x89e: Pop(0)
0x89f: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x8a0: Push(CvectorIndex(Stack[-1], 1))
0x8a1: Stack[-3] = Stack[-1]
0x8a2: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8a3: Push("head") // @poff=523
0x8a4: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x8a5: Pop(1)
0x8a6: Return(); Pop(4)
...
0x8ae: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x8af: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x8b0: Pop(0)
0x8b1: Pop(0); Push((bool) Stack[-8] == 0)
0x8b2: IF (Stack[-1] == 0) GOTO 0x8c7; Pop(1)

0x8b3: Stack[-7] = (int) 0
0x8b4: Push((int) 1)
0x8b5: Pop(1); Push(Stack[-8] + Stack[-1]);
0x8b6: Pop(1); Push(Stack[-18] + Stack[-1]);
0x8b7: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x8b8: Pop(1)
0x8b9: Pop(0); Push((bool) Stack[-6] == 0)
0x8ba: IF (Stack[-1] == 0) GOTO 0x8bc; Pop(1)

0x8bb: GOTO 0x8bf

0x8bc: Push((int) 1)
0x8bd: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x8be: GOTO 0x8b4

0x8bf: Pop(0); Push((bool) Stack[-7] == 0)
0x8c0: IF (Stack[-1] == 0) GOTO 0x8c2; Pop(1)

0x8c1: Return(); Pop(16)

0x8c2: @ irand(Stack[-5], Stack[-7])
0x8c3: Pop(0)
0x8c4: Push((int) 1)
0x8c5: Pop(1); Push(Stack[-6] + Stack[-1]);
0x8c6: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x8c7: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x8c8: Pop(0)
0x8c9: Push(Stack[-4])
0x8ca: IF (Stack[-1] == 0) GOTO 0x8d6; Pop(1)

0x8cb: @ GetEyesHeight(Stack[-3])
0x8cc: Pop(0)
0x8cd: @ GetDirection(Stack[-2])
0x8ce: Pop(0)
0x8cf: Push((int) 50)
0x8d0: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x8d1: Push(CvectorIndex(Stack[-1], 1))
0x8d2: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x8d3: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x8d4: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x8d5: Pop(0)
0x8d6: Return(); Pop(16)
...
0x8e0: Push((float)9.999999974752427e-07)
...
0x8e7: PushEmpty()
0x8e8: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x8e9: IF (Stack[-1] == 0) GOTO 0x8ec; Pop(1)

0x8ea: Stack[-2] = Stack[-3]
0x8eb: GOTO 0x8ed
...
0x8ee: PushEmpty()
0x8ef: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x8f0: IF (Stack[-1] == 0) GOTO 0x8f3; Pop(1)

0x8f1: Stack[-2] = Stack[-4]
0x8f2: Return(); Pop(0)

0x8f3: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x8f4: IF (Stack[-1] == 0) GOTO 0x8f7; Pop(1)

0x8f5: Stack[-1] = Stack[-4]
0x8f6: Return(); Pop(0)

0x8f7: Stack[-3] = Stack[-4]
0x8f8: Return(); Pop(0)

0x8f9: PushEmpty(int, int)
0x8fa: @ GetVariable(Stack[-3], Stack[-1])
0x8fb: Pop(0)
0x8fc: Stack[-1] = Stack[-4]
0x8fd: Return(); Pop(2)

0x8fe: PushEmpty()
0x8ff: Pop(0); Push((bool) Stack[-2] == 0)
0x900: IF (Stack[-1] == 0) GOTO 0x903; Pop(1)

0x901: Stack[-3] = (bool) 0
0x902: Return(); Pop(0)

0x903: Push((int) 0)
0x904: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x905: IF (Stack[-1] == 0) GOTO 0x90a; Pop(1)

0x906: Push((int) 8)
0x907: @ SendWorldWndMessage(Stack[-1])
0x908: Pop(1)
0x909: GOTO 0x913

0x90a: Push((int) 0)
0x90b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x90c: IF (Stack[-1] == 0) GOTO 0x911; Pop(1)
...
0x913: PushEmpty(float)
0x914: Stack[-2] = Stack[-1]
0x915: Call2 0x932

0x916: Pop(1)
0x917: PushEmpty(bool, object, string, float, float, float)
0x918: Stack[-8] = Stack[-5]
0x919: Stack[-4] = "reputation" // @poff=1048
0x91a: Stack[-7] = Stack[-3]
0x91b: Stack[-2] = (int) 0
0x91c: Stack[-1] = (int) 1
0x91d: Call2 0x6f8

0x91e: Pop(6)
0x91f: Stack[-3] = (bool) 1
0x920: Return(); Pop(0)

0x921: PushEmpty(object, object)
0x922: @ CreateFloatVector(Stack[-1])
0x923: Pop(0)
0x924: @@ add(Stack[-3]); Obj=1 // @poff=933
0x925: Pop(0)
0x926: Push((int) 0)
0x927: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x928: IF (Stack[-1] == 0) GOTO 0x92d; Pop(1)

0x929: Push((float)0.699999988079071)
0x92a: Push((int) 500)
0x92b: @ RumblePlay(Stack[-2], Stack[-1])
0x92c: Pop(2)
0x92d: Push((int) 15)
0x92e: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x92f: Pop(1)
0x930: Return(); Pop(2)

0x931: Stack[-1] = 0
0x932: PushEmpty(object, object)
0x933: @ CreateFloatVector(Stack[-1])
0x934: Pop(0)
0x935: @@ add(Stack[-3]); Obj=1 // @poff=933
0x936: Pop(0)
0x937: Push((int) 16)
0x938: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x939: Pop(1)
0x93a: Return(); Pop(2)

0x93b: Stack[-1] = 0
0x93c: PushEmpty(object, object)
0x93d: @ FindActor(Stack[-1], Stack[-4])
0x93e: Pop(0)
0x93f: Pop(0); PushNull((bool) Stack[-1] == 0)
0x940: IF (Stack[-1] == 0) GOTO 0x943; Pop(1)

0x941: Stack[-5] = (bool) 0
0x942: Return(); Pop(2)

0x943: @ Trigger(Stack[-1], Stack[-3])
0x944: Pop(0)
0x945: Stack[-5] = (bool) 1
0x946: Return(); Pop(2)

0x947: Stack[-1] = 0
0x948: PushEmpty(bool, bool)
0x949: @ IsPlayerActor(Stack[-3], Stack[-1])
0x94a: Pop(0)
0x94b: Push(Stack[-1])
0x94c: IF (Stack[-1] == 0) GOTO 0x950; Pop(1)

0x94d: Push("attack") // @poff=289
0x94e: @ PlayGlobalMusic(Stack[-1])
0x94f: Pop(1)
0x950: Return(); Pop(2)

0x951: PushEmpty(object, object)
0x952: @ GetScene(Stack[-1])
0x953: Pop(0)
0x954: Push("battle") // @poff=1070
0x955: PushEmpty(object)
0x956: Call2 0x8d7

0x957: Pop(0)
0x958: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x959: Pop(2)
0x95a: Return(); Pop(2)

0x95b: Stack[-1] = 0
0x95c: Stack[-1] = (int) 515558
0x95d: Return(); Pop(0)

0x95e: Stack[-1] = (int) 503343
0x95f: Return(); Pop(0)

0x960: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1084
0x961: Return(); Pop(0)

0x962: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1124
0x963: Return(); Pop(0)

0x964: Stack[-1] = (bool) 0
0x965: Return(); Pop(0)

0x966: PushEmpty(string, string)
0x967: Stack[-1] = "idle" // @poff=146
0x968: Push(Stack[-3])
0x969: IF (Stack[-1] == 0) GOTO 0x96b; Pop(1)

0x96a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x96b: Stack[-1] = Stack[-4]
0x96c: Return(); Pop(2)

0x96d: PushEmpty(int, bool, int, bool)
0x96e: Stack[-2] = (int) 0
0x96f: Push("all") // @poff=138
0x970: PushEmpty(string, int)
0x971: Stack[-5] = Stack[-1]
0x972: Call2 0x966

0x973: Pop(1)
0x974: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x975: Pop(2)
...
0x979: Push((int) 1)
0x97a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x97b: GOTO 0x96f
...
0x97e: PushEmpty()
0x97f: Push("oob4boy1") // @poff=1168
0x980: Push((int) 1)
0x981: @ SetVariable(Stack[-2], Stack[-1])
0x982: Pop(2)
0x983: Return(); Pop(0)

0x984: PushEmpty()
0x985: PushEmpty(bool, string, string)
0x986: Stack[-2] = "quest_b4_02" // @poff=1186
0x987: Stack[-1] = "boy_run" // @poff=1210
0x988: Call2 0x93c
...
0x991: PushEmpty()
0x992: PushEmpty(int, string)
0x993: Stack[-1] = "oob4boy1" // @poff=1168
0x994: Call2 0x8f9

0x995: Pop(1)
0x996: Push((int) 0)
0x997: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x998: IF (Stack[-1] == 0) GOTO 0x99b; Pop(1)

0x999: Stack[-2] = (bool) 1
0x99a: Return(); Pop(0)

0x99b: Stack[-2] = (bool) 0
0x99c: Return(); Pop(0)

0x99d: PushEmpty()
0x99e: PushEmpty(int, string)
0x99f: Stack[-1] = "oob4boy2" // @poff=1226
0x9a0: Call2 0x8f9

0x9a1: Pop(1)
0x9a2: Push((int) 0)
0x9a3: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9a4: IF (Stack[-1] == 0) GOTO 0x9a7; Pop(1)

0x9a5: Stack[-2] = (bool) 1
0x9a6: Return(); Pop(0)

0x9a7: Stack[-2] = (bool) 0
0x9a8: Return(); Pop(0)

0x9a9: PushEmpty(int, int)
0x9aa: Push("branch") // @poff=1244
...
0x9ba: PushEmpty(int, int)
0x9bb: Push("branch") // @poff=1244
0x9bc: @ GetVariable(Stack[-1], Stack[-2])
0x9bd: Pop(1)
...
0x9c7: @ WorkWithCorpse(Stack[-1])
0x9c8: Pop(0)
0x9c9: GOTO 0x9cc

0x9ca: @ Barter(Stack[-1])
0x9cb: Pop(0)
0x9cc: Return(); Pop(0)

0x9cd: PushEmpty()
0x9ce: PushEmpty(object)
0x9cf: Stack[-2] = Stack[-1]
0x9d0: Push(-1, 0); TaskCall(6)
0x9d1: Call2 0x63e

0x9d2: Pop(-1, 0); TaskReturn
0x9d3: Pop(1)
0x9d4: Return(); Pop(0)

0x9d5: PushEmpty()
0x9d6: PushEmpty(object, int, float)
0x9d7: Stack[-7] = Stack[-3]
0x9d8: Stack[-6] = Stack[-2]
...
0x9dd: PushEmpty()
0x9de: PushEmpty(object, int, float, cvector, cvector)
0x9df: Stack[-11] = Stack[-5]
0x9e0: Stack[-10] = Stack[-4]
0x9e1: Stack[-9] = Stack[-3]
0x9e2: Stack[-7] = Stack[-2]
0x9e3: Stack[-6] = Stack[-1]
0x9e4: Call2 0x808

0x9e5: Pop(5)
0x9e6: Return(); Pop(0)

0x9e7: PushEmpty(float, float)
0x9e8: Push("health") // @poff=797
0x9e9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9ea: IF (Stack[-1] == 0) GOTO 0x9f3; Pop(1)

0x9eb: Push("health") // @poff=797
0x9ec: @ GetProperty(Stack[-1], Stack[-2])
0x9ed: Pop(1)
0x9ee: Push((int) 0)
0x9ef: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x9f0: IF (Stack[-1] == 0) GOTO 0x9f3; Pop(1)

0x9f1: @ SignalDeath(Stack[-4])
0x9f2: Pop(0)
0x9f3: Return(); Pop(2)
...
0x9fa: PushEmpty(bool, object, float)
0x9fb: Stack[-4] = Stack[-2]
0x9fc: Stack[-1] = (float) -0.10000000149011612
0x9fd: Call2 0x8fe
