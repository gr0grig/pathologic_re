...
Events:
EVENT_22 Op = 0x85e Vars = (object, int, float, float)
EVENT_43 Op = 0x866 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x870 Vars = (object, string)
EVENT_41 Op = 0x87d Vars = (object)
...
0x3a: @ Face(Stack[-15])
0x3b: Pop(0)
0x3c: Push("all") // @poff=0
0x3d: Push("aattack_begin1") // @poff=8
0x3e: @ PlayAnimation(Stack[-2], Stack[-1])
0x3f: Pop(2)
0x40: @ WaitForAnimEnd()
0x41: Pop(0)
0x42: PushEmpty(bool, object)
0x43: Stack[-17] = Stack[-1]
0x44: Call2 0x6a7
...
0x4c: Push("all") // @poff=0
0x4d: Push("aattack_end1") // @poff=38
0x4e: @ PlayAnimation(Stack[-2], Stack[-1])
0x4f: Pop(2)
0x50: @ GetScene(Stack[-7])
0x51: Pop(0)
0x52: Push("knife") // @poff=64
0x53: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-7])
0x54: Pop(1)
0x55: Push("scripted") // @poff=76
0x56: Push(CVector(0.0, 0.0, 1.0))
0x57: Push("grabitel_knife.xml") // @poff=94
0x58: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-9], Stack[-2], Stack[-1])
0x59: Pop(3)
0x5a: Push("Owner") // @poff=132
0x5b: PushEmpty(object)
0x5c: Call2 0x79f

0x5d: Pop(0)
0x5e: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=144
0x5f: Pop(2)
0x60: Push("Target") // @poff=162
0x61: @@ SetScriptProperty(Stack[-1], Stack[-16]); Obj=5 // @poff=144
0x62: Pop(1)
0x63: @@ GetPosition(Stack[-3]); Obj=15 // @poff=176
0x64: Pop(0)
0x65: @@ GetEyesHeight(Stack[-2]); Obj=15 // @poff=188
0x66: Pop(0)
...
0x6d: Stack[-10] = Stack[-3]
0x6e: Stack[-7] = Stack[-2]
0x6f: Stack[-1] = (float) 2000.0
0x70: Call2 0x90e

0x71: Stack[-4] = Stack[-5]
0x72: Pop(4)
0x73: Push("StartDirection") // @poff=202
0x74: @@ SetScriptProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=144
0x75: Pop(1)
0x76: @ WaitForAnimEnd()
0x77: Pop(0)
0x78: @ StopAsync()
...
0xb5: Push("all") // @poff=0
0xb6: Push("attack_off") // @poff=242
...
0xbf: PushEmpty()
0xc0: Stack[-3] = (float) 0.15000000596046448
0xc1: Return(); Pop(0)
...
0xe3: Stack[-6] = Stack[-2]
0xe4: Stack[-5] = Stack[-1]
0xe5: Call2 0x943
...
0x105: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x106: Pop(0)
0x107: Push(Stack[-8])
0x108: IF (Stack[-1] == 0) GOTO 0x111; Pop(1)

0x109: Push("attack") // @poff=320
...
0x125: Pop(0)
0x126: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=334
0x127: Pop(0)
...
0x141: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=334
0x142: Pop(0)
...
0x173: Push((float)0.19999998807907104)
0x174: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x175: IF (Stack[-1] == 1) GOTO 0x17b; Pop(1)

0x176: PushEmpty(bool)
0x177: Call2 0x349

0x178: Pop(0)
0x179: IF (Stack[-1] == 1) GOTO 0x17b; Pop(1)
...
0x18c: @ Face(Stack[-0]T)
0x18d: Pop(0)
0x18e: Push("all") // @poff=0
0x18f: Push("fjump") // @poff=392
...
0x1aa: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=334
0x1ab: Pop(0)
...
0x1ca: Push("attack_off") // @poff=242
...
0x1d7: Push("all") // @poff=0
0x1d8: Push("attack_begin") // @poff=404
0x1d9: Push((int) 1)
0x1da: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1e5: Push("attack") // @poff=320
0x1e6: Push((int) 1)
0x1e7: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1f1: Push("all") // @poff=0
0x1f2: Push("bjump") // @poff=430
...
0x1f9: Push((float)0.8999999761581421)
0x1fa: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1fb: @ GetVictim(Stack[-1], Stack[-4])
0x1fc: Pop(1)
0x1fd: @ ReportAttack(Stack[-0]T)
0x1fe: Pop(0)
...
0x203: Stack[-10] = Stack[-1]
0x204: Call2 0xbf

0x205: Stack[-3] = Stack[-5]
0x206: Pop(3)
0x207: PushEmpty(float, object, float, int)
0x208: Stack[-7] = Stack[-3]
0x209: Stack[-6] = Stack[-2]
0x20a: PushEmpty(int, object, int)
0x20b: Stack[-10] = Stack[-2]
0x20c: Stack[-14] = Stack[-1]
0x20d: Call2 0xc2

0x20e: Stack[-3] = Stack[-4]
0x20f: Pop(3)
0x210: Call2 0x616

0x211: Stack[-4] = Stack[-5]
0x212: Pop(4)
0x213: PushEmpty(int)
0x214: Call2 0xc5

0x215: Pop(0)
0x216: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x217: Pop(1)
0x218: PushEmpty(object, float)
0x219: Stack[-5] = Stack[-2]
0x21a: Stack[-3] = Stack[-1]
0x21b: Call2 0xc7
...
0x222: Pop(0)
0x223: @ irand(Stack[-4], Stack[-1]T)
0x224: Pop(0)
0x225: Push((int) 1)
0x226: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x227: @ Face(Stack[-0]T)
0x228: Pop(0)
0x229: Push((bool) 1)
...
0x22e: Pop(0)
0x22f: Push("all") // @poff=0
0x230: Push("attack_begin") // @poff=404
...
0x247: Pop(2)
0x248: Push("all") // @poff=0
0x249: Push("attack_middle") // @poff=442
...
0x251: Pop(0)
0x252: Push("all") // @poff=0
0x253: Push("attack_middle") // @poff=442
...
0x267: Stack[-11] = Stack[-2]
0x268: Stack[-6] = Stack[-1]
0x269: Call2 0x1f8

0x26a: Pop(2)
0x26b: Stack[-2] = (int) 1
0x26c: Push("attack_middle") // @poff=442
0x26d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x26e: Push("_") // @poff=470
0x26f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x270: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x271: Push("all") // @poff=0
...
0x296: Pop(1)
0x297: Push("all") // @poff=0
0x298: Push("attack_end") // @poff=474
...
0x2a1: Stack[-1] = (float) 0.44999998807907104
0x2a2: Call2 0x2aa
...
0x2d9: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=334
0x2da: Pop(0)
...
0x325: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x326: Pop(1)
...
0x32a: @ Face(Stack[-0]T)
0x32b: Pop(0)
0x32c: Push("all") // @poff=0
0x32d: Push("bjump") // @poff=430
0x32e: @ PlayAnimation(Stack[-2], Stack[-1])
0x32f: Pop(2)
0x330: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=334
0x331: Pop(0)
...
0x367: @ irand(Stack[-1], Stack[-2]T)
0x368: Pop(0)
0x369: Push((int) 1)
0x36a: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x36b: Push("attack") // @poff=320
...
0x37a: Stack[-1] = "attack_stay" // @poff=368
0x37b: Call2 0x776
...
0x38c: Stack[-6] = Stack[-2]
0x38d: Stack[-5] = Stack[-1]
0x38e: Call2 0x943
...
0x3bb: Stack[-15] = Stack[-5]
0x3bc: Stack[-14] = Stack[-4]
0x3bd: Stack[-13] = Stack[-3]
0x3be: Stack[-12] = Stack[-2]
0x3bf: Stack[-11] = Stack[-1]
0x3c0: Call2 0x405

0x3c1: Stack[-6] = Stack[-7]
0x3c2: Pop(6)
0x3c3: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3c4: IF (Stack[-1] == 0) GOTO 0x3c8; Pop(1)

0x3c5: Push("head") // @poff=532
0x3c6: @ UnlookAsync(Stack[-1])
0x3c7: Pop(1)
0x3c8: Push((int) 1)
0x3c9: @ KillTimer(Stack[-1])
0x3ca: Pop(1)
0x3cb: Stack[-1] = Stack[-10]
0x3cc: Return(); Pop(4)
...
0x408: Stack[-17] = Stack[-7]
0x409: PushEmpty(bool, object)
0x40a: Stack[-23] = Stack[-1]
0x40b: Call2 0x491
...
0x411: @@ GetPosition(Stack[-5]); Obj=21 // @poff=176
0x412: Pop(0)
...
0x428: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=334
0x429: Pop(0)
...
0x43a: Push((int) 0)
0x43b: Push((float)0.30000001192092896)
...
0x45d: Push((int) 0)
0x45e: Push((float)0.30000001192092896)
...
0x498: Stack[-1] = "walk" // @poff=542
0x499: Return(); Pop(0)

0x49a: Stack[-1] = "run" // @poff=552
0x49b: Return(); Pop(0)
...
0x535: Stack[-4] = Stack[-2]
0x536: Stack[-1] = (float) 0.019999999552965164
0x537: Call2 0x7e6

0x538: Pop(3)
0x539: PushEmpty(object)
0x53a: Stack[-2] = Stack[-1]
0x53b: Call2 0x53e
...
0x558: Pop(0); PushNull((bool) Stack[-21] == 0)
0x559: IF (Stack[-1] == 0) GOTO 0x55f; Pop(1)

0x55a: PushEmpty(string)
0x55b: Stack[-1] = "fdie" // @poff=560
0x55c: Call2 0x5b2

0x55d: Pop(1)
0x55e: GOTO 0x5b1

0x55f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x560: Pop(0)
...
0x570: Stack[-6] = "fdie" // @poff=560
0x571: GOTO 0x573

0x572: Stack[-6] = "bdie" // @poff=570
...
0x579: @ StopAsync()
0x57a: Pop(0)
0x57b: Stack[-21] = Stack[-5]
0x57c: Push("GetScriptProperty") // @poff=580
0x57d: Push((int) 2)
0x57e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x57f: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)

0x580: Push("Owner") // @poff=132
0x581: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=616
0x582: Pop(1)
0x583: Push(Stack[-4])
0x584: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)

0x585: Push("Owner") // @poff=132
0x586: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=634
0x587: Pop(1)
0x588: Pop(0); PushNull((bool) Stack[-5] == 0)
0x589: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)

0x58a: Stack[-21] = Stack[-5]
0x58b: Push("@GetEyesHeight") // @poff=652
0x58c: Push((int) 1)
0x58d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x58e: IF (Stack[-1] == 0) GOTO 0x59a; Pop(1)

0x58f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x590: Pop(0)
0x591: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x592: Push(CvectorIndex(Stack[-1], 1))
0x593: Stack[-3] = Stack[-1]
0x594: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x595: Push("head") // @poff=532
...
0x5a6: @ StopAsync()
0x5a7: Pop(0)
0x5a8: Push("head") // @poff=532
0x5a9: @ UnlookAsync(Stack[-1])
0x5aa: Pop(1)
0x5ab: Push("all") // @poff=0
...
0x5dc: Stack[-2] = "bullet" // @poff=692
0x5dd: Return(); Pop(0)

0x5de: Stack[-2] = "phys" // @poff=706
0x5df: Return(); Pop(0)

0x5e0: PushEmpty(cvector, cvector, cvector, cvector)
0x5e1: @ GetPosition(Stack[-2])
0x5e2: Pop(0)
0x5e3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x5e4: Pop(0)
...
0x5e9: Pop(0)
0x5ea: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x5eb: Pop(0)
...
0x5f5: Push("HasProperty") // @poff=716
0x5f6: Push((int) 2)
...
0x5fc: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=740
0x5fd: Pop(0)
0x5fe: Stack[-1] = Stack[-5]
0x5ff: Return(); Pop(2)

0x600: PushEmpty(float, float)
0x601: PushEmpty(bool, object, string)
0x602: Stack[-10] = Stack[-2]
0x603: Stack[-9] = Stack[-1]
0x604: Call2 0x5f4
...
0x60a: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=752
0x60b: Pop(0)
0x60c: PushEmpty(float, float, float, float)
0x60d: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x60e: Stack[-8] = Stack[-2]
0x60f: Stack[-7] = Stack[-1]
0x610: Call2 0x7ce

0x611: Pop(3)
0x612: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=764
0x613: Pop(1)
...
0x618: Stack[-18] = Stack[-2]
0x619: Stack[-1] = "health" // @poff=776
0x61a: Call2 0x5f4
...
0x621: Stack[-18] = Stack[-2]
0x622: Stack[-1] = "armor" // @poff=790
0x623: Call2 0x5f4
...
0x629: Push("armor") // @poff=790
0x62a: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=752
0x62b: Pop(1)
0x62c: Push("armor_") // @poff=802
0x62d: PushEmpty(string, int)
0x62e: Stack[-16] = Stack[-1]
0x62f: Call2 0x5d2

0x630: Pop(1)
0x631: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x632: PushEmpty(bool, object, string)
0x633: Stack[-18] = Stack[-2]
0x634: Stack[-8] = Stack[-1]
0x635: Call2 0x5f4
...
0x63b: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=752
0x63c: Pop(0)
...
0x643: Stack[-3] = Stack[-6]
0x644: Pop(3)
0x645: Push("health") // @poff=776
0x646: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=752
0x647: Pop(1)
0x648: Push((int) 1)
0x649: Pop(1); Push(Stack[-1] - Stack[-4]);
0x64a: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x64b: Push("health") // @poff=776
...
0x651: Pop(3)
0x652: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=764
0x653: Pop(2)
0x654: PushEmpty(bool, object)
0x655: Stack[-17] = Stack[-1]
0x656: Call2 0x5ef
...
0x65c: Pop(1)
0x65d: Stack[-1] = Stack[-16]
0x65e: Return(); Pop(12)

0x65f: PushEmpty(float, float)
0x660: PushEmpty(bool, object, string)
0x661: Stack[-6] = Stack[-2]
0x662: Stack[-1] = "health" // @poff=776
0x663: Call2 0x5f4
...
0x678: Push("health") // @poff=776
0x679: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=752
0x67a: Pop(1)
...
0x67f: @@ IsDead(Stack[-1]); Obj=3 // @poff=816
0x680: Pop(0)
0x681: Stack[-1] = Stack[-4]
0x682: Return(); Pop(2)

0x683: PushEmpty(object, object, object, object)
0x684: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x698: Pop(0)
0x699: Pop(0); PushNull((bool) Stack[-2] == 0)
0x69a: IF (Stack[-1] == 0) GOTO 0x69d; Pop(1)

0x69b: Stack[-6] = (bool) 0
0x69c: Return(); Pop(4)

0x69d: @@ GetScene(Stack[-1]); Obj=5 // @poff=837
0x69e: Pop(0)
...
0x6b1: Stack[-6] = Stack[-2]
0x6b2: Stack[-1] = "noaccess" // @poff=846
0x6b3: Call2 0x5f4
...
0x6b9: Push("noaccess") // @poff=846
0x6ba: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=752
0x6bb: Pop(1)
0x6bc: Push((int) 0)
...
0x6e1: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x6e2: Pop(0)
...
0x6f2: Stack[-1] = "fhit" // @poff=864
0x6f3: GOTO 0x6f5

0x6f4: Stack[-1] = "bhit" // @poff=874
0x6f5: Push("hit_react") // @poff=884
0x6f6: Push("1") // @poff=34
0x6f7: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6f8: Push("2") // @poff=904
...
0x716: Stack[-2] = Stack[-11]
0x717: Pop(2)
0x718: @ CreateVectorVector(Stack[-8])
0x719: Pop(0)
0x71a: Stack[-7] = (int) 1
0x71b: Push("hit") // @poff=866
...
0x730: Pop(0)
0x731: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=917
0x732: Pop(0)
0x733: PushEmpty(object, int, float, cvector, cvector)
0x734: Stack[-26] = Stack[-5]
0x735: Stack[-25] = Stack[-4]
0x736: Stack[-24] = Stack[-3]
0x737: Stack[-6] = Stack[-2]
...
0x751: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x752: Pop(0)
...
0x761: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x762: Pop(0)
...
0x76d: Stack[-7] = Stack[-2]
0x76e: Stack[-6] = Stack[-1]
0x76f: Call2 0x7e1
...
0x7a8: Push((float)9.999999974752427e-07)
...
0x800: Stack[-8] = Stack[-5]
0x801: Stack[-4] = "reputation" // @poff=949
0x802: Stack[-7] = Stack[-3]
0x803: Stack[-2] = (int) 0
0x804: Stack[-1] = (int) 1
0x805: Call2 0x600
...
0x81c: Pop(0)
0x81d: @@ add(Stack[-3]); Obj=1 // @poff=908
0x81e: Pop(0)
0x81f: Push((int) 16)
...
0x825: @ IsPlayerActor(Stack[-3], Stack[-1])
0x826: Pop(0)
0x827: Push(Stack[-1])
0x828: IF (Stack[-1] == 0) GOTO 0x82c; Pop(1)

0x829: Push("attack") // @poff=320
0x82a: @ PlayGlobalMusic(Stack[-1])
0x82b: Pop(1)
0x82c: Return(); Pop(2)

0x82d: PushEmpty(object, object)
0x82e: @ GetScene(Stack[-1])
0x82f: Pop(0)
0x830: Push("battle") // @poff=971
0x831: PushEmpty(object)
0x832: Call2 0x79f

0x833: Pop(0)
0x834: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x835: Pop(2)
0x836: Return(); Pop(2)

0x837: Stack[-1] = 0
0x838: PushEmpty(bool, bool)
0x839: Push("god_mode") // @poff=985
0x83a: @ GetVariable(Stack[-1], Stack[-2])
0x83b: Pop(1)
0x83c: Stack[-1] = Stack[-3]
0x83d: Return(); Pop(2)

0x83e: PushEmpty(string, string)
0x83f: Stack[-1] = "idle" // @poff=1003
0x840: Push(Stack[-3])
0x841: IF (Stack[-1] == 0) GOTO 0x843; Pop(1)

0x842: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x843: Stack[-1] = Stack[-4]
0x844: Return(); Pop(2)

0x845: PushEmpty(int, bool, int, bool)
0x846: Stack[-2] = (int) 0
0x847: Push("all") // @poff=0
0x848: PushEmpty(string, int)
0x849: Stack[-5] = Stack[-1]
0x84a: Call2 0x83e

0x84b: Pop(1)
0x84c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x84d: Pop(2)
0x84e: Pop(0); Push((bool) Stack[-1] == 0)
0x84f: IF (Stack[-1] == 0) GOTO 0x851; Pop(1)

0x850: GOTO 0x854

0x851: Push((int) 1)
0x852: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x853: GOTO 0x847

0x854: Stack[-2] = Stack[-5]
0x855: Return(); Pop(4)

0x856: PushEmpty()
0x857: PushEmpty(object)
0x858: Stack[-2] = Stack[-1]
0x859: Push(-1, 0); TaskCall(6)
0x85a: Call2 0x528

0x85b: Pop(-1, 0); TaskReturn
0x85c: Pop(1)
0x85d: Return(); Pop(0)

0x85e: PushEmpty()
0x85f: PushEmpty(object, int, float)
0x860: Stack[-7] = Stack[-3]
0x861: Stack[-6] = Stack[-2]
0x862: Stack[-5] = Stack[-1]
0x863: Call2 0x6fe
...
0x866: PushEmpty()
0x867: PushEmpty(object, int, float, cvector, cvector)
0x868: Stack[-11] = Stack[-5]
0x869: Stack[-10] = Stack[-4]
0x86a: Stack[-9] = Stack[-3]
...
0x870: PushEmpty(float, float)
0x871: Push("health") // @poff=776
0x872: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x873: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x874: Push("health") // @poff=776
0x875: @ GetProperty(Stack[-1], Stack[-2])
0x876: Pop(1)
0x877: Push((int) 0)
0x878: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x879: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x87a: @ SignalDeath(Stack[-4])
0x87b: Pop(0)
0x87c: Return(); Pop(2)

0x87d: PushEmpty()
0x87e: PushEmpty(object)
0x87f: Stack[-2] = Stack[-1]
0x880: Call2 0x856
...
0x887: Stack[-2] = Stack[-4]
0x888: Pop(2)
0x889: Return(); Pop(0)

0x88a: PushEmpty()
0x88b: PushEmpty(object)
0x88c: Stack[-2] = Stack[-1]
0x88d: Call2 0x931
...
0x8a6: Push("GenerateMoney: iMin > iMax") // @poff=1027
0x8a7: @ Trace(Stack[-1])
0x8a8: Pop(1)
0x8a9: Return(); Pop(4)
...
0x8c4: Pop(0)
0x8c5: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1093
0x8c6: Pop(0)
0x8c7: Push("Organ") // @poff=1105
0x8c8: Push((int) 1)
0x8c9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=764
0x8ca: Pop(2)
0x8cb: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1117
0x8cc: Pop(0)
0x8cd: Push((int) 0)
0x8ce: Push((int) 1)
...
0x8db: Stack[-1] = "liver" // @poff=1127
0x8dc: Call2 0x8c2

0x8dd: Pop(1)
0x8de: PushEmpty(string)
0x8df: Stack[-1] = "kidney" // @poff=1139
0x8e0: Call2 0x8c2

0x8e1: Pop(1)
0x8e2: PushEmpty(string)
0x8e3: Stack[-1] = "heart" // @poff=1153
0x8e4: Call2 0x8c2

0x8e5: Pop(1)
0x8e6: PushEmpty(string)
0x8e7: Stack[-1] = "blood" // @poff=1165
0x8e8: Call2 0x8c2
...
0x8ec: Push((int) 0)
0x8ed: @ ClearSubContainer(Stack[-1])
0x8ee: Pop(1)
0x8ef: PushEmpty(int, int)
0x8f0: Stack[-2] = (int) 300
0x8f1: Stack[-1] = (int) 750
0x8f2: Call2 0x8a3

0x8f3: Pop(2)
0x8f4: PushEmpty(string, int, int)
0x8f5: Stack[-3] = "Knife" // @poff=1177
0x8f6: Stack[-2] = (int) 1
0x8f7: Stack[-1] = (int) 8
0x8f8: Call2 0x76b

0x8f9: Pop(3)
0x8fa: PushEmpty(string, int, int)
0x8fb: Stack[-3] = "lockpick" // @poff=1189
0x8fc: Stack[-2] = (int) 1
0x8fd: Stack[-1] = (int) 6
0x8fe: Call2 0x76b

0x8ff: Pop(3)
0x900: PushEmpty(int, string)
0x901: Stack[-1] = "grabitel_mark" // @poff=1207
0x902: Call2 0x909

0x903: Pop(1)
0x904: Push((int) 0)
0x905: Push((int) 1)
0x906: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x907: Pop(3)
0x908: Return(); Pop(4)

0x909: PushEmpty(int, int)
0x90a: @ GetInvItemByName(Stack[-1], Stack[-3])
0x90b: Pop(0)
0x90c: Stack[-1] = Stack[-4]
0x90d: Return(); Pop(2)

0x90e: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0x90f: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x910: Stack[-5] = (int) 250000
0x911: Push(CvectorIndex(Stack[-6], 1))
0x912: Push((int) 1000)
0x913: Pop(2); Push(Stack[-2] * Stack[-1]);
0x914: Pop(0); Push(Stack[-14] * Stack[-14]);
0x915: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x916: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x917: PushEmpty(float, float, float, float)
0x918: Stack[-9] = Stack[-3]
0x919: Stack[-8] = Stack[-2]
0x91a: Stack[-7] = Stack[-1]
0x91b: Call2 0x7b6

0x91c: Stack[-4] = Stack[-6]
0x91d: Pop(4)
0x91e: Push((int) 0)
...
0x923: PushEmpty(float, float, float, float, float)
0x924: Stack[-10] = Stack[-4]
0x925: Stack[-9] = Stack[-3]
0x926: Stack[-8] = Stack[-2]
0x927: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x928: Call2 0x7bd

0x929: Pop(4)
0x92a: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x92b: Push(CVector(0.0, 500.0, 0.0))
0x92c: Pop(1); Push(Stack[-1] * Stack[-2]);
0x92d: Pop(1); Push(Stack[-1] * Stack[-2]);
0x92e: Pop(1); Push(Stack[-7] + Stack[-1]);
0x92f: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x930: Return(); Pop(12)

0x931: PushEmpty(object, object)
0x932: @ GetScene(Stack[-1])
0x933: Pop(0)
0x934: PushEmpty(object)
0x935: Call2 0x79f

0x936: Pop(0)
0x937: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1235
0x938: Pop(1)
0x939: PushEmpty(object)
0x93a: Stack[-4] = Stack[-1]
0x93b: Push(-1, 0); TaskCall(5)
0x93c: Call2 0x51c

0x93d: Pop(-1, 0); TaskReturn
0x93e: Pop(1)
0x93f: Return(); Pop(2)
