...
// @pool_raw:
// @pool_encoding:utf8
...
0x9d: Stack[-1] = "Neutral" // @poff=89
0x9e: Call2 0xcb

0x9f: Pop(1)
0xa0: Push((int) 524880)
0xa1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xa2: Pop(1)
0xa3: @@@ ClearReplies(); Obj=0 // @poff=116
0xa4: Pop(0)
...
0x18f: Stack[-1] = "Neutral" // @poff=89
0x190: Call2 0xcb

0x191: Pop(1)
0x192: Push((int) 518677)
0x193: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x194: Pop(1)
0x195: @@@ ClearReplies(); Obj=0 // @poff=116
0x196: Pop(0)
...
0x26a: Stack[-2] = "quest_b5_01" // @poff=156
0x26b: Stack[-1] = "butcher_attack" // @poff=180
0x26c: Call2 0x998
...
0x283: Push("player") // @poff=210
0x284: @ FindActor(Stack[-4]T, Stack[-1])
0x285: Pop(1)
...
0x298: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x326: Pop(0)
0x327: @@ RemoveStationaryActor(Stack[-1]); Obj=3 // @poff=234
0x328: Pop(1)
0x329: Push("player") // @poff=210
0x32a: @ FindActor(Stack[-2], Stack[-1])
0x32b: Pop(1)
0x32c: PushEmpty(object, bool, float)
0x32d: Stack[-4] = Stack[-3]
...
0x338: Stack[-2] = 0
0x339: PushEmpty()
0x33a: Stack[-3] = (float) 0.10000000149011612
0x33b: Return(); Pop(0)
...
0x354: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x355: Pop(0)
0x356: Push(Stack[-8])
0x357: IF (Stack[-1] == 0) GOTO 0x360; Pop(1)

0x358: Push("attack") // @poff=196
...
0x374: Pop(0)
0x375: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=312
0x376: Pop(0)
...
0x390: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=312
0x391: Pop(0)
...
0x3c4: IF (Stack[-1] == 1) GOTO 0x3ca; Pop(1)
...
0x3db: @ Face(Stack[-0]T)
0x3dc: Pop(0)
0x3dd: Push("all") // @poff=138
0x3de: Push("fjump") // @poff=370
...
0x3f9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=312
0x3fa: Pop(0)
...
0x418: Push("all") // @poff=138
0x419: Push("attack_off") // @poff=382
...
0x426: Push("all") // @poff=138
0x427: Push("attack_begin") // @poff=404
0x428: Push((int) 1)
0x429: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x434: Push("attack") // @poff=196
0x435: Push((int) 1)
0x436: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x440: Push("all") // @poff=138
0x441: Push("bjump") // @poff=430
...
0x448: Push((float)0.8999999761581421)
0x449: Pop(1); Push(Stack[-9] * Stack[-1]);
0x44a: @ GetVictim(Stack[-1], Stack[-4])
0x44b: Pop(1)
0x44c: @ ReportAttack(Stack[-0]T)
0x44d: Pop(0)
...
0x452: Stack[-10] = Stack[-1]
0x453: Call2 0x339

0x454: Stack[-3] = Stack[-5]
0x455: Pop(3)
0x456: PushEmpty(float, object, float, int)
0x457: Stack[-7] = Stack[-3]
0x458: Stack[-6] = Stack[-2]
0x459: PushEmpty(int, object, int)
0x45a: Stack[-10] = Stack[-2]
0x45b: Stack[-14] = Stack[-1]
0x45c: Call2 0x33c

0x45d: Stack[-3] = Stack[-4]
0x45e: Pop(3)
0x45f: Call2 0x797

0x460: Stack[-4] = Stack[-5]
0x461: Pop(4)
0x462: PushEmpty(int)
0x463: Call2 0x5c6

0x464: Pop(0)
0x465: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x466: Pop(1)
0x467: PushEmpty(object, float)
0x468: Stack[-5] = Stack[-2]
...
0x471: Pop(0)
0x472: @ irand(Stack[-4], Stack[-1]T)
0x473: Pop(0)
0x474: Push((int) 1)
0x475: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x476: @ Face(Stack[-0]T)
0x477: Pop(0)
0x478: Push((bool) 1)
...
0x47f: Push("attack_begin") // @poff=404
...
0x493: Stack[-11] = Stack[-2]
0x494: Stack[-6] = Stack[-1]
0x495: Call2 0x447

0x496: Pop(2)
0x497: Push("all") // @poff=138
0x498: Push("attack_middle") // @poff=442
...
0x4a2: Push("attack_middle") // @poff=442
...
0x4e5: Pop(1)
0x4e6: Push("all") // @poff=138
0x4e7: Push("attack_end") // @poff=474
...
0x526: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=312
0x527: Pop(0)
...
0x572: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x573: Pop(1)
...
0x577: @ Face(Stack[-0]T)
0x578: Pop(0)
0x579: Push("all") // @poff=138
0x57a: Push("bjump") // @poff=430
0x57b: @ PlayAnimation(Stack[-2], Stack[-1])
0x57c: Pop(2)
0x57d: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=312
0x57e: Pop(0)
...
0x5b4: @ irand(Stack[-1], Stack[-2]T)
0x5b5: Pop(0)
0x5b6: Push((int) 1)
0x5b7: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x5b8: Push("attack") // @poff=196
...
0x5c9: Stack[-1] = "attack_stay" // @poff=346
0x5ca: Call2 0x937
...
0x5f4: Stack[-15] = Stack[-5]
0x5f5: Stack[-14] = Stack[-4]
0x5f6: Stack[-13] = Stack[-3]
0x5f7: Stack[-12] = Stack[-2]
0x5f8: Stack[-11] = Stack[-1]
0x5f9: Call2 0x63e

0x5fa: Stack[-6] = Stack[-7]
0x5fb: Pop(6)
0x5fc: Push( Stack[2 + Tasks[-1].StackPointer] )
0x5fd: IF (Stack[-1] == 0) GOTO 0x601; Pop(1)

0x5fe: Push("head") // @poff=224
0x5ff: @ UnlookAsync(Stack[-1])
0x600: Pop(1)
0x601: Push((int) 1)
0x602: @ KillTimer(Stack[-1])
0x603: Pop(1)
0x604: Stack[-1] = Stack[-10]
0x605: Return(); Pop(4)
...
0x641: Stack[-17] = Stack[-7]
0x642: PushEmpty(bool, object)
0x643: Stack[-23] = Stack[-1]
0x644: Call2 0x6ca
...
0x64a: @@ GetPosition(Stack[-5]); Obj=21 // @poff=532
0x64b: Pop(0)
...
0x661: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=312
0x662: Pop(0)
...
0x696: Push((int) 0)
0x697: Push((float)0.30000001192092896)
...
0x6ce: Stack[-2] = Stack[-4]
0x6cf: Pop(2)
0x6d0: Return(); Pop(0)

0x6d1: Stack[-1] = "walk" // @poff=544
0x6d2: Return(); Pop(0)

0x6d3: Stack[-1] = "run" // @poff=554
0x6d4: Return(); Pop(0)
...
0x6ef: Pop(0); PushNull((bool) Stack[-21] == 0)
0x6f0: IF (Stack[-1] == 0) GOTO 0x6f6; Pop(1)

0x6f1: PushEmpty(string)
0x6f2: Stack[-1] = "fdie" // @poff=562
0x6f3: Call2 0x749

0x6f4: Pop(1)
0x6f5: GOTO 0x748

0x6f6: @@ GetPosition(Stack[-10]); Obj=21 // @poff=532
0x6f7: Pop(0)
...
0x707: Stack[-6] = "fdie" // @poff=562
0x708: GOTO 0x70a

0x709: Stack[-6] = "bdie" // @poff=572
...
0x710: @ StopAsync()
0x711: Pop(0)
0x712: Stack[-21] = Stack[-5]
0x713: Push("GetScriptProperty") // @poff=582
0x714: Push((int) 2)
0x715: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x716: IF (Stack[-1] == 0) GOTO 0x722; Pop(1)

0x717: Push("Owner") // @poff=618
0x718: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=630
0x719: Pop(1)
0x71a: Push(Stack[-4])
0x71b: IF (Stack[-1] == 0) GOTO 0x722; Pop(1)

0x71c: Push("Owner") // @poff=618
0x71d: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=648
0x71e: Pop(1)
0x71f: Pop(0); PushNull((bool) Stack[-5] == 0)
0x720: IF (Stack[-1] == 0) GOTO 0x722; Pop(1)

0x721: Stack[-21] = Stack[-5]
0x722: Push("@GetEyesHeight") // @poff=666
0x723: Push((int) 1)
0x724: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x725: IF (Stack[-1] == 0) GOTO 0x731; Pop(1)

0x726: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=696
0x727: Pop(0)
...
0x733: Stack[-7] = Stack[-1]
0x734: Call2 0x937

0x735: Pop(1)
0x736: Push("all") // @poff=138
...
0x73d: @ StopAsync()
0x73e: Pop(0)
0x73f: Push("head") // @poff=224
0x740: @ UnlookAsync(Stack[-1])
0x741: Pop(1)
0x742: Push("all") // @poff=138
...
0x755: Stack[-2] = Stack[-1]
0x756: Call2 0x937

0x757: Pop(1)
0x758: Push("all") // @poff=138
0x759: @ PlayAnimation(Stack[-1], Stack[-2])
0x75a: Pop(1)
0x75b: @ WaitForAnimEnd()
0x75c: Pop(0)
0x75d: Push("all") // @poff=138
...
0x773: Stack[-2] = "bullet" // @poff=720
0x774: Return(); Pop(0)

0x775: Stack[-2] = "phys" // @poff=734
0x776: Return(); Pop(0)

0x777: PushEmpty(cvector, cvector, cvector, cvector)
0x778: @ GetPosition(Stack[-2])
0x779: Pop(0)
0x77a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=532
0x77b: Pop(0)
...
0x780: Pop(0)
0x781: @@ GetPosition(Stack[-2]); Obj=7 // @poff=532
0x782: Pop(0)
...
0x78c: Push("HasProperty") // @poff=744
0x78d: Push((int) 2)
...
0x793: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=768
0x794: Pop(0)
...
0x799: Stack[-18] = Stack[-2]
0x79a: Stack[-1] = "health" // @poff=780
0x79b: Call2 0x78b
...
0x7a2: Stack[-18] = Stack[-2]
0x7a3: Stack[-1] = "armor" // @poff=794
0x7a4: Call2 0x78b
...
0x7aa: Push("armor") // @poff=794
0x7ab: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=806
0x7ac: Pop(1)
0x7ad: Push("armor_") // @poff=818
0x7ae: PushEmpty(string, int)
0x7af: Stack[-16] = Stack[-1]
0x7b0: Call2 0x769

0x7b1: Pop(1)
0x7b2: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x7b3: PushEmpty(bool, object, string)
0x7b4: Stack[-18] = Stack[-2]
0x7b5: Stack[-8] = Stack[-1]
0x7b6: Call2 0x78b
...
0x7bc: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=806
0x7bd: Pop(0)
...
0x7c4: Stack[-3] = Stack[-6]
0x7c5: Pop(3)
0x7c6: Push("health") // @poff=780
0x7c7: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=806
0x7c8: Pop(1)
0x7c9: Push((int) 1)
0x7ca: Pop(1); Push(Stack[-1] - Stack[-4]);
0x7cb: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x7cc: Push("health") // @poff=780
...
0x7d2: Pop(3)
0x7d3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=832
0x7d4: Pop(2)
0x7d5: PushEmpty(bool, object)
0x7d6: Stack[-17] = Stack[-1]
0x7d7: Call2 0x786
...
0x7dd: Pop(1)
0x7de: Stack[-1] = Stack[-16]
0x7df: Return(); Pop(12)

0x7e0: PushEmpty(bool, bool)
0x7e1: @@ IsDead(Stack[-1]); Obj=3 // @poff=844
0x7e2: Pop(0)
0x7e3: Stack[-1] = Stack[-4]
0x7e4: Return(); Pop(2)

0x7e5: PushEmpty(object, object, object, object)
0x7e6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7fa: Pop(0)
0x7fb: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7fc: IF (Stack[-1] == 0) GOTO 0x7ff; Pop(1)

0x7fd: Stack[-6] = (bool) 0
0x7fe: Return(); Pop(4)

0x7ff: @@ GetScene(Stack[-1]); Obj=5 // @poff=865
0x800: Pop(0)
...
0x813: Stack[-6] = Stack[-2]
0x814: Stack[-1] = "noaccess" // @poff=874
0x815: Call2 0x78b
...
0x81b: Push("noaccess") // @poff=874
0x81c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=806
0x81d: Pop(1)
0x81e: Push((int) 0)
...
0x822: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x830: @@ GetPosition(Stack[-5]); Obj=15 // @poff=532
0x831: Pop(0)
...
0x841: Stack[-1] = "fhit" // @poff=892
0x842: GOTO 0x844

0x843: Stack[-1] = "bhit" // @poff=902
0x844: Push("hit_react") // @poff=912
0x845: Push("1") // @poff=176
0x846: Pop(1); Push(Stack[-3] + Stack[-1]);
0x847: Push("2") // @poff=932
...
0x860: Stack[-25] = Stack[-1]
0x861: Call2 0x777

0x862: Stack[-2] = Stack[-3]
0x863: Pop(2)
0x864: Call2 0x966

0x865: Stack[-2] = Stack[-11]
0x866: Pop(2)
0x867: @ CreateVectorVector(Stack[-8])
0x868: Pop(0)
0x869: Stack[-7] = (int) 1
0x86a: Push("hit") // @poff=894
...
0x87f: Pop(0)
0x880: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=945
0x881: Pop(0)
0x882: PushEmpty(object, int, float, cvector, cvector)
0x883: Stack[-26] = Stack[-5]
0x884: Stack[-25] = Stack[-4]
0x885: Stack[-24] = Stack[-3]
0x886: Stack[-6] = Stack[-2]
...
0x893: Pop(0)
0x894: Push("scripted") // @poff=949
0x895: Push("blood_dir.xml") // @poff=967
...
0x8a0: @@ GetPosition(Stack[-3]); Obj=7 // @poff=532
0x8a1: Pop(0)
...
0x8b0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=532
0x8b1: Pop(0)
0x8b2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=696
0x8b3: Pop(0)
...
0x8d9: Pop(0)
0x8da: Push((bool) 1)
0x8db: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x8dc: Pop(1)
0x8dd: Push(CvectorIndex(Stack[-4], 0))
0x8de: Push(CvectorIndex(Stack[-5], 2))
0x8df: @ Rotate(Stack[-2], Stack[-1])
0x8e0: Pop(2)
...
0x8e6: Push("head") // @poff=224
0x8e7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8e8: Pop(1)
0x8e9: Push(Stack[-1])
0x8ea: IF (Stack[-1] == 0) GOTO 0x8ee; Pop(1)

0x8eb: Push("head") // @poff=224
0x8ec: @ LookAsyncCamera(Stack[-1])
0x8ed: Pop(1)
0x8ee: @ CameraWaitForPlayFinish()
0x8ef: Pop(0)
0x8f0: @ ResumeWorld()
0x8f1: Pop(0)
0x8f2: Stack[-21] = (bool) 1
0x8f3: Return(); Pop(18)

0x8f4: PushEmpty(bool, bool)
0x8f5: Push((bool) 1)
0x8f6: @ CameraSwitchToNormal(Stack[-1])
0x8f7: Pop(1)
...
0x8fd: Push("head") // @poff=224
0x8fe: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x8ff: Pop(1)
0x900: Push(Stack[-1])
0x901: IF (Stack[-1] == 0) GOTO 0x905; Pop(1)

0x902: Push("head") // @poff=224
0x903: @ UnlookAsync(Stack[-1])
0x904: Pop(1)
0x905: Return(); Pop(2)

0x906: PushEmpty(bool, float, float, bool, float, float)
0x907: @ lshHasAnimation(Stack[-3], Stack[-7])
0x908: Pop(0)
0x909: Push(Stack[-3])
0x90a: IF (Stack[-1] == 0) GOTO 0x911; Pop(1)

0x90b: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x90c: Pop(0)
0x90d: Push((bool) 0)
0x90e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x90f: Pop(1)
0x910: GOTO 0x915

0x911: Push("Can't find lsh animation : ") // @poff=995
0x912: Pop(1); Push(Stack[-1] + Stack[-8]);
0x913: @ Trace(Stack[-1])
0x914: Pop(1)
0x915: Return(); Pop(6)

0x916: PushEmpty(bool, float, float, bool, float, float)
0x917: @ lshHasAnimation(Stack[-3], Stack[-8])
0x918: Pop(0)
0x919: Push(Stack[-3])
0x91a: IF (Stack[-1] == 0) GOTO 0x920; Pop(1)

0x91b: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x91c: Pop(0)
0x91d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x91e: Pop(0)
0x91f: GOTO 0x924

0x920: Push("Can't find lsh animation : ") // @poff=995
0x921: Pop(1); Push(Stack[-1] + Stack[-9]);
0x922: @ Trace(Stack[-1])
0x923: Pop(1)
0x924: Return(); Pop(6)

0x925: PushEmpty(float, cvector, float, cvector)
0x926: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=696
0x927: Pop(0)
0x928: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x929: Push(CvectorIndex(Stack[-1], 1))
0x92a: Stack[-3] = Stack[-1]
0x92b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x92c: Push("head") // @poff=224
0x92d: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x92e: Pop(1)
0x92f: Return(); Pop(4)
...
0x937: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x938: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x939: Pop(0)
0x93a: Pop(0); Push((bool) Stack[-8] == 0)
0x93b: IF (Stack[-1] == 0) GOTO 0x950; Pop(1)

0x93c: Stack[-7] = (int) 0
0x93d: Push((int) 1)
0x93e: Pop(1); Push(Stack[-8] + Stack[-1]);
0x93f: Pop(1); Push(Stack[-18] + Stack[-1]);
0x940: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x941: Pop(1)
0x942: Pop(0); Push((bool) Stack[-6] == 0)
0x943: IF (Stack[-1] == 0) GOTO 0x945; Pop(1)

0x944: GOTO 0x948

0x945: Push((int) 1)
0x946: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x947: GOTO 0x93d

0x948: Pop(0); Push((bool) Stack[-7] == 0)
0x949: IF (Stack[-1] == 0) GOTO 0x94b; Pop(1)

0x94a: Return(); Pop(16)

0x94b: @ irand(Stack[-5], Stack[-7])
0x94c: Pop(0)
0x94d: Push((int) 1)
0x94e: Pop(1); Push(Stack[-6] + Stack[-1]);
0x94f: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x950: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x951: Pop(0)
0x952: Push(Stack[-4])
0x953: IF (Stack[-1] == 0) GOTO 0x95f; Pop(1)

0x954: @ GetEyesHeight(Stack[-3])
0x955: Pop(0)
0x956: @ GetDirection(Stack[-2])
0x957: Pop(0)
0x958: Push((int) 50)
0x959: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x95a: Push(CvectorIndex(Stack[-1], 1))
0x95b: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x95c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x95d: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x95e: Pop(0)
0x95f: Return(); Pop(16)

0x960: PushEmpty(object, object)
0x961: @ self(Stack[-1])
0x962: Pop(0)
0x963: Stack[-1] = Stack[-3]
0x964: Return(); Pop(2)

0x965: Stack[-1] = 0
0x966: PushEmpty(float, float)
0x967: Pop(0); Push(Stack[-3] | Stack[-3]);
0x968: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x969: Push((float)9.999999974752427e-07)
0x96a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x96b: IF (Stack[-1] == 0) GOTO 0x96e; Pop(1)

0x96c: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x96d: Return(); Pop(2)

0x96e: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x96f: Return(); Pop(2)

0x970: PushEmpty()
0x971: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x972: IF (Stack[-1] == 0) GOTO 0x975; Pop(1)

0x973: Stack[-2] = Stack[-3]
0x974: GOTO 0x976
...
0x977: PushEmpty()
0x978: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x979: IF (Stack[-1] == 0) GOTO 0x97c; Pop(1)

0x97a: Stack[-2] = Stack[-4]
0x97b: Return(); Pop(0)

0x97c: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x97d: IF (Stack[-1] == 0) GOTO 0x980; Pop(1)

0x97e: Stack[-1] = Stack[-4]
0x97f: Return(); Pop(0)

0x980: Stack[-3] = Stack[-4]
0x981: Return(); Pop(0)

0x982: PushEmpty(int, int)
0x983: @ GetVariable(Stack[-3], Stack[-1])
0x984: Pop(0)
0x985: Stack[-1] = Stack[-4]
0x986: Return(); Pop(2)

0x987: PushEmpty(object, object)
0x988: @ CreateFloatVector(Stack[-1])
0x989: Pop(0)
0x98a: @@ add(Stack[-3]); Obj=1 // @poff=936
0x98b: Pop(0)
0x98c: Push((int) 0)
0x98d: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x98e: IF (Stack[-1] == 0) GOTO 0x993; Pop(1)

0x98f: Push((float)0.699999988079071)
0x990: Push((int) 500)
0x991: @ RumblePlay(Stack[-2], Stack[-1])
0x992: Pop(2)
0x993: Push((int) 15)
0x994: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x995: Pop(1)
0x996: Return(); Pop(2)

0x997: Stack[-1] = 0
0x998: PushEmpty(object, object)
0x999: @ FindActor(Stack[-1], Stack[-4])
0x99a: Pop(0)
0x99b: Pop(0); PushNull((bool) Stack[-1] == 0)
0x99c: IF (Stack[-1] == 0) GOTO 0x99f; Pop(1)

0x99d: Stack[-5] = (bool) 0
0x99e: Return(); Pop(2)

0x99f: @ Trigger(Stack[-1], Stack[-3])
0x9a0: Pop(0)
0x9a1: Stack[-5] = (bool) 1
0x9a2: Return(); Pop(2)

0x9a3: Stack[-1] = 0
0x9a4: PushEmpty(bool, bool)
0x9a5: @ IsPlayerActor(Stack[-3], Stack[-1])
0x9a6: Pop(0)
0x9a7: Push(Stack[-1])
0x9a8: IF (Stack[-1] == 0) GOTO 0x9ac; Pop(1)

0x9a9: Push("attack") // @poff=196
0x9aa: @ PlayGlobalMusic(Stack[-1])
0x9ab: Pop(1)
0x9ac: Return(); Pop(2)

0x9ad: PushEmpty(object, object)
0x9ae: @ GetScene(Stack[-1])
0x9af: Pop(0)
0x9b0: Push("battle") // @poff=1051
0x9b1: PushEmpty(object)
0x9b2: Call2 0x960

0x9b3: Pop(0)
0x9b4: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x9b5: Pop(2)
0x9b6: Return(); Pop(2)

0x9b7: Stack[-1] = 0
0x9b8: PushEmpty()
0x9b9: PushEmpty(bool, string, string)
0x9ba: Stack[-2] = "quest_b5_01" // @poff=156
0x9bb: Stack[-1] = "butcher_attack" // @poff=180
0x9bc: Call2 0x998
...
0x9bf: PushEmpty()
0x9c0: Push("oob5Butcher1") // @poff=1065
0x9c1: Push((int) 1)
0x9c2: @ SetVariable(Stack[-2], Stack[-1])
0x9c3: Pop(2)
0x9c4: Return(); Pop(0)

0x9c5: PushEmpty()
0x9c6: PushEmpty(int, string)
0x9c7: Stack[-1] = "b5q01WifeDead" // @poff=1091
0x9c8: Call2 0x982
...
0x9d3: Stack[-1] = "oob5Butcher1" // @poff=1065
0x9d4: Call2 0x982

0x9d5: Pop(1)
0x9d6: Push((int) 0)
0x9d7: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9d8: IF (Stack[-1] == 0) GOTO 0x9db; Pop(1)

0x9d9: Stack[-2] = (bool) 1
0x9da: Return(); Pop(0)

0x9db: Stack[-2] = (bool) 0
0x9dc: Return(); Pop(0)

0x9dd: PushEmpty(int, int)
0x9de: Push("branch") // @poff=1119
0x9df: @ GetVariable(Stack[-1], Stack[-2])
0x9e0: Pop(1)
0x9e1: Push((int) 0)
...
0x9ef: Push("branch") // @poff=1119
0x9f0: @ GetVariable(Stack[-1], Stack[-2])
0x9f1: Pop(1)
0x9f2: Stack[-1] = Stack[-3]
0x9f3: Return(); Pop(2)
...
0x9f7: Pop(0)
0x9f8: Push((int) 1)
0x9f9: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x9fa: IF (Stack[-1] == 0) GOTO 0x9fe; Pop(1)

0x9fb: @ WorkWithCorpse(Stack[-1])
0x9fc: Pop(0)
0x9fd: GOTO 0xa00

0x9fe: @ Barter(Stack[-1])
0x9ff: Pop(0)
0xa00: Return(); Pop(0)

0xa01: PushEmpty(string, string)
0xa02: Stack[-1] = "idle" // @poff=146
0xa03: Push(Stack[-3])
0xa04: IF (Stack[-1] == 0) GOTO 0xa06; Pop(1)

0xa05: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xa06: Stack[-1] = Stack[-4]
0xa07: Return(); Pop(2)

0xa08: PushEmpty(int, bool, int, bool)
0xa09: Stack[-2] = (int) 0
0xa0a: Push("all") // @poff=138
0xa0b: PushEmpty(string, int)
0xa0c: Stack[-5] = Stack[-1]
0xa0d: Call2 0xa01

0xa0e: Pop(1)
0xa0f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xa10: Pop(2)
0xa11: Pop(0); Push((bool) Stack[-1] == 0)
0xa12: IF (Stack[-1] == 0) GOTO 0xa14; Pop(1)

0xa13: GOTO 0xa17

0xa14: Push((int) 1)
0xa15: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xa16: GOTO 0xa0a

0xa17: Stack[-2] = Stack[-5]
0xa18: Return(); Pop(4)

0xa19: Stack[-1] = (int) 515562
0xa1a: Return(); Pop(0)

0xa1b: Stack[-1] = (int) 503347
0xa1c: Return(); Pop(0)

0xa1d: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1133
0xa1e: Return(); Pop(0)

0xa1f: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1173
0xa20: Return(); Pop(0)
...
0xa24: @ GetScene(Stack[-1])
0xa25: Pop(0)
0xa26: PushEmpty(object)
0xa27: Call2 0x960

0xa28: Pop(0)
0xa29: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=234
0xa2a: Pop(1)
0xa2b: PushEmpty(object)
0xa2c: Stack[-4] = Stack[-1]
0xa2d: Push(-1, 0); TaskCall(5)
0xa2e: Call2 0x6d5

0xa2f: Pop(-1, 0); TaskReturn
0xa30: Pop(1)
0xa31: Return(); Pop(2)
...
0xa35: Stack[-7] = Stack[-3]
0xa36: Stack[-6] = Stack[-2]
0xa37: Stack[-5] = Stack[-1]
0xa38: Call2 0x84d
...
0xa3d: Stack[-11] = Stack[-5]
0xa3e: Stack[-10] = Stack[-4]
0xa3f: Stack[-9] = Stack[-3]
0xa40: Stack[-7] = Stack[-2]
0xa41: Stack[-6] = Stack[-1]
0xa42: Call2 0x891
