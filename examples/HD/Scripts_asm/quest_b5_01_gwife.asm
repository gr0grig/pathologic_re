...
Strings:
	...
	W:quest_b5_01
	W:gwife_dead
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x58a Vars = (object, int, float, float)
EVENT_43 Op = 0x592 Vars = (object, int, float, float, cvector, cvector)
...
0x19b: Push("player") // @poff=172
0x19c: @ FindActor(Stack[-4]T, Stack[-1])
0x19d: Pop(1)
...
0x1b0: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x23e: Pop(0)
0x23f: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x240: Pop(1)
...
0x254: Pop(0)
0x255: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=218
0x256: Pop(0)
...
0x273: Stack[-1] = (float) 1.7453293800354004
0x274: Call2 0x252
...
0x27c: Stack[-1] = (float) 2.6179938316345215
0x27d: Call2 0x252

0x27e: Stack[-2] = Stack[-7]
0x27f: Pop(2)
...
0x284: Push("Can't retreat, distance: ") // @poff=230
...
0x29a: Push((int) 1)
0x29b: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x29c: Pop(1)
0x29d: Push(Stack[-3])
0x29e: IF (Stack[-1] == 0) GOTO 0x2b6; Pop(1)

0x29f: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2a4: Stack[-1] = (float) 2.6179938316345215
0x2a5: Call2 0x252

0x2a6: Stack[-2] = Stack[-4]
0x2a7: Pop(2)
...
0x2b7: IF (Stack[-1] == 1) GOTO 0x29a; Pop(1)
...
0x2be: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2cd: Stack[-1] = (float) 1.7453293800354004
0x2ce: Call2 0x252

0x2cf: Stack[-2] = Stack[-4]
0x2d0: Pop(2)
...
0x2dd: IF (Stack[-1] == 1) GOTO 0x2e3; Pop(1)

0x2de: PushEmpty(bool)
0x2df: Call2 0x2fd

0x2e0: Pop(0)
0x2e1: IF (Stack[-1] == 1) GOTO 0x2e3; Pop(1)
...
0x309: Pop(2)
0x30a: Push((float)-0.3420201241970062)
...
0x327: Pop(0); PushNull((bool) Stack[-21] == 0)
0x328: IF (Stack[-1] == 0) GOTO 0x32e; Pop(1)

0x329: PushEmpty(string)
0x32a: Stack[-1] = "fdie" // @poff=282
0x32b: Call2 0x381

0x32c: Pop(1)
0x32d: GOTO 0x380

0x32e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=218
0x32f: Pop(0)
...
0x33f: Stack[-6] = "fdie" // @poff=282
0x340: GOTO 0x342

0x341: Stack[-6] = "bdie" // @poff=292
...
0x348: @ StopAsync()
0x349: Pop(0)
0x34a: Stack[-21] = Stack[-5]
0x34b: Push("GetScriptProperty") // @poff=302
0x34c: Push((int) 2)
0x34d: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x34e: IF (Stack[-1] == 0) GOTO 0x35a; Pop(1)

0x34f: Push("Owner") // @poff=338
0x350: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=350
0x351: Pop(1)
0x352: Push(Stack[-4])
0x353: IF (Stack[-1] == 0) GOTO 0x35a; Pop(1)

0x354: Push("Owner") // @poff=338
0x355: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=368
0x356: Pop(1)
0x357: Pop(0); PushNull((bool) Stack[-5] == 0)
0x358: IF (Stack[-1] == 0) GOTO 0x35a; Pop(1)

0x359: Stack[-21] = Stack[-5]
0x35a: Push("@GetEyesHeight") // @poff=386
0x35b: Push((int) 1)
0x35c: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x35d: IF (Stack[-1] == 0) GOTO 0x369; Pop(1)

0x35e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x35f: Pop(0)
...
0x3a8: Pop(0)
0x3a9: @@ GetPosition(Stack[-1]); Obj=5 // @poff=218
0x3aa: Pop(0)
...
0x3af: Pop(0)
0x3b0: @@ GetPosition(Stack[-2]); Obj=7 // @poff=218
0x3b1: Pop(0)
...
0x3bd: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x3cb: @@ GetPosition(Stack[-5]); Obj=15 // @poff=218
0x3cc: Pop(0)
...
0x3dc: Stack[-1] = "fhit" // @poff=430
0x3dd: GOTO 0x3df

0x3de: Stack[-1] = "bhit" // @poff=440
0x3df: Push("hit_react") // @poff=450
0x3e0: Push("1") // @poff=470
0x3e1: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3e2: Push("2") // @poff=474
...
0x3fb: Stack[-25] = Stack[-1]
0x3fc: Call2 0x3a6

0x3fd: Stack[-2] = Stack[-3]
0x3fe: Pop(2)
0x3ff: Call2 0x4f6

0x400: Stack[-2] = Stack[-11]
0x401: Pop(2)
0x402: @ CreateVectorVector(Stack[-8])
0x403: Pop(0)
0x404: Stack[-7] = (int) 1
0x405: Push("hit") // @poff=432
...
0x41a: Pop(0)
0x41b: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=487
0x41c: Pop(0)
0x41d: PushEmpty(object, int, float, cvector, cvector)
0x41e: Stack[-26] = Stack[-5]
0x41f: Stack[-25] = Stack[-4]
0x420: Stack[-24] = Stack[-3]
0x421: Stack[-6] = Stack[-2]
...
0x440: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x441: Pop(0)
0x442: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=416
0x443: Pop(0)
...
0x469: Pop(0)
0x46a: Push((bool) 1)
0x46b: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x46c: Pop(1)
0x46d: Push(CvectorIndex(Stack[-4], 0))
0x46e: Push(CvectorIndex(Stack[-5], 2))
...
0x476: Push("head") // @poff=186
0x477: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x478: Pop(1)
0x479: Push(Stack[-1])
0x47a: IF (Stack[-1] == 0) GOTO 0x47e; Pop(1)

0x47b: Push("head") // @poff=186
0x47c: @ LookAsyncCamera(Stack[-1])
0x47d: Pop(1)
0x47e: @ CameraWaitForPlayFinish()
0x47f: Pop(0)
0x480: @ ResumeWorld()
0x481: Pop(0)
0x482: Stack[-21] = (bool) 1
0x483: Return(); Pop(18)

0x484: PushEmpty(bool, bool)
0x485: Push((bool) 1)
0x486: @ CameraSwitchToNormal(Stack[-1])
0x487: Pop(1)
...
0x48d: Push("head") // @poff=186
0x48e: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x48f: Pop(1)
0x490: Push(Stack[-1])
0x491: IF (Stack[-1] == 0) GOTO 0x495; Pop(1)

0x492: Push("head") // @poff=186
0x493: @ UnlookAsync(Stack[-1])
0x494: Pop(1)
0x495: Return(); Pop(2)

0x496: PushEmpty(bool, float, float, bool, float, float)
0x497: @ lshHasAnimation(Stack[-3], Stack[-7])
0x498: Pop(0)
0x499: Push(Stack[-3])
0x49a: IF (Stack[-1] == 0) GOTO 0x4a1; Pop(1)

0x49b: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x49c: Pop(0)
0x49d: Push((bool) 0)
0x49e: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x49f: Pop(1)
0x4a0: GOTO 0x4a5

0x4a1: Push("Can't find lsh animation : ") // @poff=537
0x4a2: Pop(1); Push(Stack[-1] + Stack[-8]);
0x4a3: @ Trace(Stack[-1])
0x4a4: Pop(1)
0x4a5: Return(); Pop(6)

0x4a6: PushEmpty(bool, float, float, bool, float, float)
0x4a7: @ lshHasAnimation(Stack[-3], Stack[-8])
0x4a8: Pop(0)
0x4a9: Push(Stack[-3])
0x4aa: IF (Stack[-1] == 0) GOTO 0x4b0; Pop(1)

0x4ab: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x4ac: Pop(0)
0x4ad: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x4ae: Pop(0)
0x4af: GOTO 0x4b4

0x4b0: Push("Can't find lsh animation : ") // @poff=537
0x4b1: Pop(1); Push(Stack[-1] + Stack[-9]);
0x4b2: @ Trace(Stack[-1])
0x4b3: Pop(1)
0x4b4: Return(); Pop(6)

0x4b5: PushEmpty(float, cvector, float, cvector)
0x4b6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x4b7: Pop(0)
0x4b8: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x4b9: Push(CvectorIndex(Stack[-1], 1))
0x4ba: Stack[-3] = Stack[-1]
0x4bb: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4bc: Push("head") // @poff=186
0x4bd: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x4be: Pop(1)
0x4bf: Return(); Pop(4)
...
0x4c7: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x4c8: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x4c9: Pop(0)
0x4ca: Pop(0); Push((bool) Stack[-8] == 0)
0x4cb: IF (Stack[-1] == 0) GOTO 0x4e0; Pop(1)

0x4cc: Stack[-7] = (int) 0
0x4cd: Push((int) 1)
0x4ce: Pop(1); Push(Stack[-8] + Stack[-1]);
0x4cf: Pop(1); Push(Stack[-18] + Stack[-1]);
0x4d0: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x4d1: Pop(1)
...
0x4d5: Push((int) 1)
0x4d6: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x4d7: GOTO 0x4cd

0x4d8: Pop(0); Push((bool) Stack[-7] == 0)
0x4d9: IF (Stack[-1] == 0) GOTO 0x4db; Pop(1)

0x4da: Return(); Pop(16)

0x4db: @ irand(Stack[-5], Stack[-7])
0x4dc: Pop(0)
0x4dd: Push((int) 1)
0x4de: Pop(1); Push(Stack[-6] + Stack[-1]);
0x4df: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x4e0: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x4e1: Pop(0)
0x4e2: Push(Stack[-4])
0x4e3: IF (Stack[-1] == 0) GOTO 0x4ef; Pop(1)

0x4e4: @ GetEyesHeight(Stack[-3])
0x4e5: Pop(0)
0x4e6: @ GetDirection(Stack[-2])
0x4e7: Pop(0)
0x4e8: Push((int) 50)
0x4e9: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x4ea: Push(CvectorIndex(Stack[-1], 1))
0x4eb: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x4ec: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4ed: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x4ee: Pop(0)
0x4ef: Return(); Pop(16)
...
0x4f9: Push((float)9.999999974752427e-07)
...
0x500: PushEmpty()
0x501: Pop(0); Push(Stack[-2] | Stack[-1]);
0x502: Pop(0); Push(Stack[-3] | Stack[-3]);
0x503: Pop(0); Push(Stack[-3] | Stack[-3]);
0x504: Pop(2); Push(Stack[-2] * Stack[-1]);
0x505: Pop(1); Push(Sqrt(Stack[-1]))
0x506: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x507: Return(); Pop(0)

0x508: PushEmpty(int, int)
0x509: @ GetVariable(Stack[-3], Stack[-1])
0x50a: Pop(0)
0x50b: Stack[-1] = Stack[-4]
0x50c: Return(); Pop(2)

0x50d: PushEmpty(object, object)
0x50e: @ FindActor(Stack[-1], Stack[-4])
0x50f: Pop(0)
0x510: Pop(0); PushNull((bool) Stack[-1] == 0)
0x511: IF (Stack[-1] == 0) GOTO 0x514; Pop(1)

0x512: Stack[-5] = (bool) 0
0x513: Return(); Pop(2)

0x514: @ Trigger(Stack[-1], Stack[-3])
0x515: Pop(0)
0x516: Stack[-5] = (bool) 1
0x517: Return(); Pop(2)
...
0x531: PushEmpty()
0x532: Push("oob5GathererWife1") // @poff=593
0x533: Push((int) 1)
0x534: @ SetVariable(Stack[-2], Stack[-1])
0x535: Pop(2)
0x536: Return(); Pop(0)

0x537: PushEmpty()
0x538: PushEmpty(int, string)
0x539: Stack[-1] = "oob5GathererWife1" // @poff=593
0x53a: Call2 0x508
...
0x53f: Stack[-2] = (bool) 1
0x540: Return(); Pop(0)

0x541: Stack[-2] = (bool) 0
0x542: Return(); Pop(0)

0x543: PushEmpty(int, int)
0x544: Push("branch") // @poff=629
0x545: @ GetVariable(Stack[-1], Stack[-2])
0x546: Pop(1)
0x547: Push((int) 0)
...
0x554: PushEmpty(int, int)
0x555: Push("branch") // @poff=629
...
0x55d: Pop(0)
0x55e: Push((int) 1)
0x55f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x560: IF (Stack[-1] == 0) GOTO 0x564; Pop(1)

0x561: @ WorkWithCorpse(Stack[-1])
0x562: Pop(0)
0x563: GOTO 0x566

0x564: @ Barter(Stack[-1])
0x565: Pop(0)
0x566: Return(); Pop(0)

0x567: Stack[-1] = (int) 518607
0x568: Return(); Pop(0)

0x569: Stack[-1] = (int) 518606
0x56a: Return(); Pop(0)

0x56b: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=643
0x56c: Return(); Pop(0)

0x56d: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=683
0x56e: Return(); Pop(0)
...
0x572: @ GetScene(Stack[-1])
0x573: Pop(0)
0x574: PushEmpty(object)
0x575: Call2 0x4f0

0x576: Pop(0)
0x577: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x578: Pop(1)
0x579: Push("b5q01NudeDead") // @poff=727
0x57a: Push((bool) 1)
0x57b: @ SetVariable(Stack[-2], Stack[-1])
0x57c: Pop(2)
0x57d: PushEmpty(bool, string, string)
0x57e: Stack[-2] = "quest_b5_01" // @poff=755
0x57f: Stack[-1] = "gwife_dead" // @poff=779
0x580: Call2 0x50d

0x581: Pop(3)
0x582: PushEmpty(object)
0x583: Stack[-4] = Stack[-1]
0x584: Push(-1, 0); TaskCall(4)
0x585: Call2 0x30d

0x586: Pop(-1, 0); TaskReturn
0x587: Pop(1)
0x588: Return(); Pop(2)

0x589: Stack[-1] = 0
0x58a: PushEmpty()
0x58b: PushEmpty(object, int, float)
0x58c: Stack[-7] = Stack[-3]
0x58d: Stack[-6] = Stack[-2]
...
0x592: PushEmpty()
0x593: PushEmpty(object, int, float, cvector, cvector)
0x594: Stack[-11] = Stack[-5]
0x595: Stack[-10] = Stack[-4]
0x596: Stack[-9] = Stack[-3]
0x597: Stack[-7] = Stack[-2]
