...
// @pool_raw:
// @pool_encoding:utf8
...
0x27f: Stack[-8] = Stack[-2]
0x280: Stack[-7] = Stack[-1]
0x281: Call2 0x2b9
...
0x2c0: Push("player") // @poff=172
0x2c1: @ FindActor(Stack[-4]T, Stack[-1])
0x2c2: Pop(1)
...
0x2d5: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x360: Pop(0)
0x361: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x362: Pop(0)
...
0x36c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x36d: Pop(0)
0x36e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x36f: Pop(0)
...
0x3cd: Push("Can't find lsh animation : ") // @poff=222
...
0x3dc: Push("Can't find lsh animation : ") // @poff=222
...
0x3e2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x3e3: Pop(0)
...
0x40a: Pop(0)
0x40b: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x437: Stack[-2] = Stack[-5]
0x438: Return(); Pop(4)

0x439: PushEmpty()
0x43a: Push("b5q01TalkToVera") // @poff=278
0x43b: Push((int) 1)
...
0x441: Stack[-1] = "b5q01PlaceButchers" // @poff=310
0x442: Call2 0x403
...
0x447: Push("b5q01PlaceButchers") // @poff=310
0x448: Push((int) 1)
...
0x44e: Pop(1)
0x44f: Push("b5q01GathererWife") // @poff=348
0x450: Push("pt_gatherer3") // @poff=384
0x451: Push((int) 1)
...
0x455: Pop(0)
0x456: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=410
0x457: Pop(5)
0x458: PushEmpty(bool, string, string)
0x459: Stack[-2] = "quest_b5_01" // @poff=418
0x45a: Stack[-1] = "place_butchers" // @poff=442
0x45b: Call2 0x408
...
0x45f: PushEmpty()
0x460: Push("oob5Vera1_1") // @poff=472
0x461: Push((int) 1)
...
0x469: Pop(1)
0x46a: Push("b5q01VeraGotoStvorki") // @poff=496
0x46b: Push("pt_b5q01_vera") // @poff=538
0x46c: Push((int) 1)
...
0x470: Pop(0)
0x471: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=410
0x472: Pop(5)
0x473: PushEmpty(bool, string, string)
0x474: Stack[-2] = "quest_b5_01" // @poff=418
0x475: Stack[-1] = "vera_stvorki" // @poff=566
0x476: Call2 0x408
...
0x479: Stack[-1] = 0
0x47a: PushEmpty()
0x47b: Push("oob5Vera1_2") // @poff=592
0x47c: Push((int) 1)
...
0x48a: Pop(1)
0x48b: Stack[-2] = "pt_gatherer3" // @poff=384
0x48c: Stack[-1] = (int) 2
0x48d: Call2 0x52f
...
0x491: Pop(0)
0x492: @@ ShowMap(Stack[-1]); Obj=2 // @poff=616
0x493: Pop(1)
0x494: Return(); Pop(0)
...
0x49a: Pop(1)
0x49b: Stack[-2] = "pt_b5q01_vera" // @poff=538
0x49c: Stack[-1] = (int) 2
0x49d: Call2 0x52f
...
0x4a1: Pop(0)
0x4a2: @@ ShowMap(Stack[-1]); Obj=2 // @poff=616
0x4a3: Pop(1)
0x4a4: Return(); Pop(0)
...
0x4bd: Stack[-1] = "oob5Vera1_1" // @poff=472
0x4be: Call2 0x403
...
0x4c9: Stack[-1] = "oob5Vera1_2" // @poff=592
0x4ca: Call2 0x403
...
0x4fa: Push("Can't retrieve diary root") // @poff=636
0x4fb: @ Trace(Stack[-1])
0x4fc: Pop(1)
0x4fd: Stack[-3] = (bool) 0
0x4fe: Return(); Pop(2)

0x4ff: Stack[-1] = Stack[-3]
0x500: Return(); Pop(2)
...
0x505: Stack[-1] = Stack[-4]
0x506: Pop(1)
0x507: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=688
0x508: Pop(0)
0x509: Pop(0); Push((bool) Stack[-2] == 0)
0x50a: IF (Stack[-1] == 0) GOTO 0x511; Pop(1)

0x50b: Push("Can't find diary parent with id: ") // @poff=693
...
0x511: @@ AddChild(Stack[-8]); Obj=2 // @poff=761
0x512: Pop(0)
0x513: Push((int) 7)
0x514: @ SendWorldWndMessage(Stack[-1])
0x515: Pop(1)
0x516: @@ GetCategory(Stack[-1]); Obj=8 // @poff=770
0x517: Pop(0)
...
0x520: Pop(0)
0x521: Pop(0); PushNull((bool) Stack[-2] == 0)
0x522: IF (Stack[-1] == 0) GOTO 0x529; Pop(1)

0x523: Push("Can't find main outdoor scene") // @poff=782
0x524: @ Trace(Stack[-1])
0x525: Pop(1)
0x526: Stack[-1] = 0
...
0x529: @@ GetMap(Stack[-1]); Obj=2 // @poff=842
0x52a: Pop(0)
0x52b: Stack[-1] = Stack[-5]
0x52c: Return(); Pop(4)
...
0x531: Pop(0)
0x532: Pop(0); PushNull((bool) Stack[-2] == 0)
0x533: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x534: Push("Can't find main outdoor scene") // @poff=782
0x535: @ Trace(Stack[-1])
0x536: Pop(1)
0x537: Return(); Pop(8)

0x538: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=849
0x539: Pop(0)
0x53a: Pop(0); Push((bool) Stack[-1] == 0)
0x53b: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x53c: Push("Warning: outdoor scene locator ") // @poff=860
0x53d: Pop(1); Push(Stack[-1] + Stack[-11]);
0x53e: Push(" doesnt exist") // @poff=924
0x53f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x540: @ Trace(Stack[-1])
0x541: Pop(1)
0x542: @@ GetMap(Stack[-11]); Obj=2 // @poff=842
0x543: Pop(0)
0x544: Pop(0); PushNull((bool) Stack[-11] == 0)
0x545: IF (Stack[-1] == 0) GOTO 0x54a; Pop(1)

0x546: Push("Can't find map") // @poff=952
0x547: @ Trace(Stack[-1])
0x548: Pop(1)
0x549: Return(); Pop(8)
...
0x54c: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=982
0x54d: Pop(2)
0x54e: Return(); Pop(8)

0x54f: Stack[-2] = 0
0x550: PushEmpty(int, int)
0x551: Push("branch") // @poff=995
...
0x565: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1009
0x566: Return(); Pop(0)

0x567: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1049
0x568: Return(); Pop(0)
