...
Strings:
	...
	W:b5q01VeraDead
	W:health
// @pool_raw:
// @pool_encoding:utf8
...
0x4f2: Push("Can't find lsh animation : ") // @poff=597
...
0x501: Push("Can't find lsh animation : ") // @poff=597
...
0x507: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=416
0x508: Pop(0)
...
0x54a: Push((float)9.999999974752427e-07)
...
0x583: Stack[-8] = Stack[-5]
0x584: Stack[-4] = "reputation" // @poff=653
0x585: Stack[-7] = Stack[-3]
0x586: Stack[-2] = (int) 0
0x587: Stack[-1] = (int) 1
0x588: Call2 0x3f7
...
0x58e: Pop(0)
0x58f: @@ add(Stack[-3]); Obj=1 // @poff=538
0x590: Pop(0)
0x591: Push((int) 16)
...
0x598: Pop(0)
0x599: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5b8: Stack[-2] = Stack[-5]
0x5b9: Return(); Pop(4)

0x5ba: PushEmpty()
0x5bb: PushEmpty(bool, string, string)
0x5bc: Stack[-2] = "quest_b5_01" // @poff=675
0x5bd: Stack[-1] = "vera_retreat" // @poff=699
0x5be: Call2 0x596
...
0x5c1: PushEmpty()
0x5c2: Push("oob5Vera2_1") // @poff=725
0x5c3: Push((int) 1)
...
0x5c9: Stack[-1] = "oob5Vera2_1" // @poff=725
0x5ca: Call2 0x564
...
0x5fb: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=763
0x5fc: Return(); Pop(0)

0x5fd: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=803
0x5fe: Return(); Pop(0)
...
0x606: Pop(0)
0x607: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=196
0x608: Pop(1)
...
0x60f: Stack[-6] = Stack[-2]
0x610: Stack[-1] = (float) -0.10000000149011612
0x611: Call2 0x569

0x612: Pop(3)
0x613: Push("b5q01VeraDead") // @poff=847
0x614: Push((bool) 1)
...
0x621: Stack[-7] = Stack[-3]
0x622: Stack[-6] = Stack[-2]
0x623: Stack[-5] = Stack[-1]
0x624: Call2 0x439
...
0x629: Stack[-11] = Stack[-5]
0x62a: Stack[-10] = Stack[-4]
0x62b: Stack[-9] = Stack[-3]
0x62c: Stack[-7] = Stack[-2]
0x62d: Stack[-6] = Stack[-1]
0x62e: Call2 0x47d
