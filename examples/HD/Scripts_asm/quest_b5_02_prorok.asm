...
// @pool_raw:
// @pool_encoding:utf8
...
0x2f4: Push("Can't find lsh animation : ") // @poff=222
...
0x303: Push("Can't find lsh animation : ") // @poff=222
...
0x309: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x30a: Pop(0)
...
0x323: Push((float)9.999999974752427e-07)
...
0x35c: Stack[-2] = "quest_b5_02" // @poff=290
0x35d: Stack[-1] = "remove_prophet" // @poff=314
0x35e: Call2 0x32f
...
0x361: PushEmpty()
0x362: Push("oob5Prophet1") // @poff=344
0x363: Push((int) 1)
...
0x369: Stack[-1] = "oob5Prophet1" // @poff=344
0x36a: Call2 0x32a
...
0x385: Push("Can't retrieve diary root") // @poff=370
0x386: @ Trace(Stack[-1])
0x387: Pop(1)
...
0x391: Pop(1)
0x392: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=422
0x393: Pop(0)
0x394: Pop(0); Push((bool) Stack[-2] == 0)
0x395: IF (Stack[-1] == 0) GOTO 0x39c; Pop(1)

0x396: Push("Can't find diary parent with id: ") // @poff=427
...
0x39c: @@ AddChild(Stack[-8]); Obj=2 // @poff=495
0x39d: Pop(0)
0x39e: Push((int) 7)
0x39f: @ SendWorldWndMessage(Stack[-1])
0x3a0: Pop(1)
0x3a1: @@ GetCategory(Stack[-1]); Obj=8 // @poff=504
0x3a2: Pop(0)
...
0x3be: Stack[-1] = "ui/NPC_Prophet.png" // @poff=530
0x3bf: Return(); Pop(0)

0x3c0: Stack[-1] = "ui/NPC_Prophet_b.png" // @poff=568
0x3c1: Return(); Pop(0)
