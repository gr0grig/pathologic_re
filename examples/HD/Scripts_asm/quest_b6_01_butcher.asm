...
0x15: Stack[-8] = Stack[-2]
0x16: Stack[-7] = Stack[-1]
0x17: Call2 0x4f
...
0x56: Push("player") // @poff=16
0x57: @ FindActor(Stack[-4]T, Stack[-1])
0x58: Pop(1)
...
0x6b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0xf6: Pop(0)
0xf7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=48
0xf8: Pop(0)
...
0x102: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=60
0x103: Pop(0)
