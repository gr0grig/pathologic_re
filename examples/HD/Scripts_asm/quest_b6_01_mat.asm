...
Strings:
	...
	W:ui/NPC_Mat.png
	W:ui/NPC_Mat_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0x62: Stack[-1] = "Patronage" // @poff=89
0x63: Call2 0xde
...
0x97: Push((int) 21836)
0x98: Push((int) 21835)
0x99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x9a: Pop(3)
0x9b: PushEmpty(bool)
0x9c: Stack[-1] = (bool) 0
...
0xaa: Push((int) 21897)
0xab: Push((int) 21896)
0xac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0xad: Pop(3)
...
0xb4: Push((int) 29927)
0xb5: Push((int) 29926)
0xb6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0xb7: Pop(3)
0xb8: Push((int) 520629)
0xb9: Push((int) -1)
0xba: Push((int) 21838)
0xbb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0xbc: Pop(3)
0xbd: GOTO 0xc0
...
0xcf: Push("all") // @poff=158
0xd0: Push("idle") // @poff=166
...
0xd8: Push("all") // @poff=158
0xd9: Push("idle") // @poff=166
...
0x156: Stack[-1] = "Patronage" // @poff=89
0x157: Call2 0xde
...
0x166: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x167: Pop(3)
0x168: Return(); Pop(0)

0x169: PushEmpty(string)
0x16a: Stack[-1] = "Neutral" // @poff=142
0x16b: Call2 0xde

0x16c: Pop(1)
0x16d: Push((int) 520622)
0x16e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x16f: Pop(1)
0x170: @@@ ClearReplies(); Obj=0 // @poff=120
0x171: Pop(0)
...
0x17a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x17b: Pop(3)
...
0x18d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x18e: Pop(3)
...
0x1a0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1a1: Pop(3)
...
0x1aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1ab: Pop(3)
0x1ac: Push((int) 520629)
0x1ad: Push((int) -1)
0x1ae: Push((int) 21838)
0x1af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1b0: Pop(3)
0x1b1: Return(); Pop(0)
...
0x1b6: Stack[-1] = "Patronage" // @poff=89
0x1b7: Call2 0xde

0x1b8: Pop(1)
0x1b9: Push((int) 528535)
0x1ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1bb: Pop(1)
0x1bc: @@@ ClearReplies(); Obj=0 // @poff=120
0x1bd: Pop(0)
0x1be: Push((int) 528536)
0x1bf: Push((int) 29929)
0x1c0: Push((int) 29928)
0x1c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1c2: Pop(3)
0x1c3: Return(); Pop(0)
...
0x1c8: Stack[-1] = "Neutral" // @poff=142
0x1c9: Call2 0xde

0x1ca: Pop(1)
0x1cb: Push((int) 528537)
0x1cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1cd: Pop(1)
0x1ce: @@@ ClearReplies(); Obj=0 // @poff=120
0x1cf: Pop(0)
0x1d0: Push((int) 528538)
0x1d1: Push((int) 29931)
0x1d2: Push((int) 29930)
0x1d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1d4: Pop(3)
0x1d5: Return(); Pop(0)
...
0x1da: Stack[-1] = "Neutral" // @poff=142
0x1db: Call2 0xde
...
0x1ec: Stack[-1] = "Neutral" // @poff=142
0x1ed: Call2 0xde

0x1ee: Pop(1)
0x1ef: Push((int) 528541)
0x1f0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1f1: Pop(1)
0x1f2: @@@ ClearReplies(); Obj=0 // @poff=120
0x1f3: Pop(0)
0x1f4: Push((int) 528542)
0x1f5: Push((int) 29935)
0x1f6: Push((int) 29934)
0x1f7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1f8: Pop(3)
0x1f9: Return(); Pop(0)
...
0x1fe: Stack[-1] = "Neutral" // @poff=142
0x1ff: Call2 0xde

0x200: Pop(1)
0x201: Push((int) 528543)
0x202: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x203: Pop(1)
0x204: @@@ ClearReplies(); Obj=0 // @poff=120
0x205: Pop(0)
0x206: Push((int) 528544)
0x207: Push((int) 29937)
0x208: Push((int) 29936)
0x209: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x20a: Pop(3)
0x20b: Return(); Pop(0)
...
0x210: Stack[-1] = "Neutral" // @poff=142
0x211: Call2 0xde

0x212: Pop(1)
0x213: Push((int) 528545)
0x214: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x215: Pop(1)
0x216: @@@ ClearReplies(); Obj=0 // @poff=120
0x217: Pop(0)
0x218: Push((int) 528546)
0x219: Push((int) -1)
0x21a: Push((int) 29938)
0x21b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x21c: Pop(3)
0x21d: Return(); Pop(0)
...
0x222: Stack[-1] = "Rage" // @poff=176
0x223: Call2 0xde

0x224: Pop(1)
0x225: Push((int) 520687)
0x226: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x227: Pop(1)
0x228: @@@ ClearReplies(); Obj=0 // @poff=120
0x229: Pop(0)
0x22a: Push((int) 520689)
0x22b: Push((int) 21900)
0x22c: Push((int) 21899)
0x22d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x22e: Pop(3)
0x22f: Push((int) 520688)
0x230: Push((int) -1)
0x231: Push((int) 21898)
0x232: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x233: Pop(3)
0x234: Return(); Pop(0)
...
0x239: Stack[-1] = "Rage" // @poff=176
0x23a: Call2 0xde

0x23b: Pop(1)
0x23c: Push((int) 520690)
0x23d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x23e: Pop(1)
0x23f: @@@ ClearReplies(); Obj=0 // @poff=120
0x240: Pop(0)
0x241: Push((int) 520691)
0x242: Push((int) -1)
0x243: Push((int) 21901)
0x244: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x245: Pop(3)
0x246: Push((int) 520692)
0x247: Push((int) -1)
0x248: Push((int) 21902)
0x249: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x24a: Pop(3)
0x24b: Return(); Pop(0)
...
0x250: Stack[-1] = "Patronage" // @poff=89
0x251: Call2 0xde

0x252: Pop(1)
0x253: Push((int) 520627)
0x254: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x255: Pop(1)
0x256: @@@ ClearReplies(); Obj=0 // @poff=120
0x257: Pop(0)
0x258: Push((int) 520628)
0x259: Push((int) 21885)
0x25a: Push((int) 21837)
0x25b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x25c: Pop(3)
...
0x267: Stack[-1] = "Neutral" // @poff=142
0x268: Call2 0xde
...
0x279: Stack[-1] = "Patronage" // @poff=89
0x27a: Call2 0xde
...
0x290: Stack[-1] = "Patronage" // @poff=89
0x291: Call2 0xde
...
0x2a7: Stack[-1] = "Neutral" // @poff=142
0x2a8: Call2 0xde
...
0x2b9: Stack[-1] = "Neutral" // @poff=142
0x2ba: Call2 0xde

0x2bb: Pop(1)
0x2bc: Push((int) 520684)
0x2bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2be: Pop(1)
0x2bf: @@@ ClearReplies(); Obj=0 // @poff=120
0x2c0: Pop(0)
0x2c1: Push((int) 520685)
0x2c2: Push((int) -1)
0x2c3: Push((int) 21895)
0x2c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2c5: Pop(3)
0x2c6: Return(); Pop(0)
...
0x2cb: Stack[-1] = "Rage" // @poff=176
0x2cc: Call2 0xde

0x2cd: Pop(1)
0x2ce: Push((int) 520624)
0x2cf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2d0: Pop(1)
0x2d1: @@@ ClearReplies(); Obj=0 // @poff=120
0x2d2: Pop(0)
0x2d3: Push((int) 520625)
0x2d4: Push((int) -1)
0x2d5: Push((int) 21834)
0x2d6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2d7: Pop(3)
0x2d8: Return(); Pop(0)
...
0x2dd: Stack[-1] = "Patronage" // @poff=89
0x2de: Call2 0xde

0x2df: Pop(1)
0x2e0: Push((int) 520597)
0x2e1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2e2: Pop(1)
0x2e3: @@@ ClearReplies(); Obj=0 // @poff=120
0x2e4: Pop(0)
0x2e5: Push((int) 528414)
0x2e6: Push((int) 29795)
0x2e7: Push((int) 29794)
0x2e8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2e9: Pop(3)
0x2ea: Return(); Pop(0)
...
0x2ef: Stack[-1] = "Rage" // @poff=176
0x2f0: Call2 0xde

0x2f1: Pop(1)
0x2f2: Push((int) 528415)
0x2f3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x2f4: Pop(1)
0x2f5: @@@ ClearReplies(); Obj=0 // @poff=120
0x2f6: Pop(0)
0x2f7: Push((int) 528416)
0x2f8: Push((int) 29798)
0x2f9: Push((int) 29797)
0x2fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x2fb: Pop(3)
0x2fc: Push((int) 528418)
0x2fd: Push((int) 21806)
0x2fe: Push((int) 29799)
0x2ff: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x300: Pop(3)
0x301: Return(); Pop(0)
...
0x306: Stack[-1] = "Discontent" // @poff=186
0x307: Call2 0xde

0x308: Pop(1)
0x309: Push((int) 528417)
0x30a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x30b: Pop(1)
0x30c: @@@ ClearReplies(); Obj=0 // @poff=120
0x30d: Pop(0)
0x30e: Push((int) 520598)
0x30f: Push((int) 21804)
0x310: Push((int) 21803)
0x311: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x312: Pop(3)
0x313: Push((int) 520620)
0x314: Push((int) 21808)
0x315: Push((int) 21827)
0x316: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x317: Pop(3)
0x318: Return(); Pop(0)
...
0x31d: Stack[-1] = "Patronage" // @poff=89
0x31e: Call2 0xde

0x31f: Pop(1)
0x320: Push((int) 520599)
0x321: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x322: Pop(1)
0x323: @@@ ClearReplies(); Obj=0 // @poff=120
0x324: Pop(0)
0x325: Push((int) 520600)
0x326: Push((int) 21806)
0x327: Push((int) 21805)
0x328: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x329: Pop(3)
0x32a: Return(); Pop(0)
...
0x32f: Stack[-1] = "Neutral" // @poff=142
0x330: Call2 0xde

0x331: Pop(1)
0x332: Push((int) 520601)
0x333: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x334: Pop(1)
0x335: @@@ ClearReplies(); Obj=0 // @poff=120
0x336: Pop(0)
0x337: Push((int) 520602)
0x338: Push((int) 21808)
0x339: Push((int) 21807)
0x33a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x33b: Pop(3)
0x33c: Push((int) 520605)
0x33d: Push((int) 21811)
0x33e: Push((int) 21810)
0x33f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x340: Pop(3)
0x341: Return(); Pop(0)
...
0x346: Stack[-1] = "Untrust" // @poff=208
0x347: Call2 0xde

0x348: Pop(1)
0x349: Push((int) 520606)
0x34a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x34b: Pop(1)
0x34c: @@@ ClearReplies(); Obj=0 // @poff=120
0x34d: Pop(0)
0x34e: Push((int) 520607)
0x34f: Push((int) 21813)
0x350: Push((int) 21812)
0x351: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x352: Pop(3)
0x353: Push((int) 520617)
0x354: Push((int) 21824)
0x355: Push((int) 21823)
0x356: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x357: Pop(3)
0x358: Return(); Pop(0)
...
0x35d: Stack[-1] = "Untrust" // @poff=208
0x35e: Call2 0xde

0x35f: Pop(1)
0x360: Push((int) 520618)
0x361: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x362: Pop(1)
0x363: @@@ ClearReplies(); Obj=0 // @poff=120
0x364: Pop(0)
0x365: Push((int) 520619)
0x366: Push((int) 21815)
0x367: Push((int) 21825)
0x368: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x369: Pop(3)
0x36a: Return(); Pop(0)
...
0x36f: Stack[-1] = "Untrust" // @poff=208
0x370: Call2 0xde

0x371: Pop(1)
0x372: Push((int) 520608)
0x373: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x374: Pop(1)
0x375: @@@ ClearReplies(); Obj=0 // @poff=120
0x376: Pop(0)
0x377: Push((int) 520609)
0x378: Push((int) 21815)
0x379: Push((int) 21814)
0x37a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x37b: Pop(3)
0x37c: Push((int) 520616)
0x37d: Push((int) -1)
0x37e: Push((int) 21822)
0x37f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x380: Pop(3)
0x381: Return(); Pop(0)
...
0x386: Stack[-1] = "Untrust" // @poff=208
0x387: Call2 0xde

0x388: Pop(1)
0x389: Push((int) 520610)
0x38a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x38b: Pop(1)
0x38c: @@@ ClearReplies(); Obj=0 // @poff=120
0x38d: Pop(0)
0x38e: Push((int) 520611)
0x38f: Push((int) 21817)
0x390: Push((int) 21816)
0x391: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x392: Pop(3)
0x393: Push((int) 520615)
0x394: Push((int) 21817)
0x395: Push((int) 21821)
0x396: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x397: Pop(3)
0x398: Return(); Pop(0)
...
0x39d: Stack[-1] = "Rage" // @poff=176
0x39e: Call2 0xde

0x39f: Pop(1)
0x3a0: Push((int) 520612)
0x3a1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x3a2: Pop(1)
0x3a3: @@@ ClearReplies(); Obj=0 // @poff=120
0x3a4: Pop(0)
0x3a5: Push((int) 520613)
0x3a6: Push((int) 21808)
0x3a7: Push((int) 21818)
0x3a8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x3a9: Pop(3)
0x3aa: Push((int) 520614)
0x3ab: Push((int) -1)
0x3ac: Push((int) 21820)
0x3ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x3ae: Pop(3)
0x3af: Return(); Pop(0)
...
0x3b4: Stack[-1] = "Rage" // @poff=176
0x3b5: Call2 0xde

0x3b6: Pop(1)
0x3b7: Push((int) 520603)
0x3b8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x3b9: Pop(1)
0x3ba: @@@ ClearReplies(); Obj=0 // @poff=120
0x3bb: Pop(0)
0x3bc: Push((int) 520604)
0x3bd: Push((int) -1)
0x3be: Push((int) 21809)
0x3bf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x3c0: Pop(3)
0x3c1: Push((int) 528419)
0x3c2: Push((int) -1)
0x3c3: Push((int) 29801)
0x3c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x3c5: Pop(3)
0x3c6: Return(); Pop(0)
...
0x421: Stack[-1] = 0
0x422: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x423: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x424: @ RotateAsync(Stack[-2], Stack[-1])
0x425: Pop(2)
0x426: Return(); Pop(0)

0x427: PushEmpty(object, bool, object, bool)
0x428: Push("player") // @poff=256
...
0x485: Stack[-1] = "Neutral" // @poff=142
0x486: Call2 0x602
...
0x494: Stack[-1] = "Neutral" // @poff=142
0x495: Call2 0x602
...
0x4ab: Stack[-1] = "Neutral" // @poff=142
0x4ac: Call2 0x602
...
0x503: Pop(0)
0x504: @@ GetPosition(Stack[-2]); Obj=7 // @poff=270
0x505: Pop(0)
...
0x510: Pop(2)
0x511: Stack[-1] = Stack[-8]
0x512: Return(); Pop(6)

0x513: PushEmpty(cvector, cvector)
0x514: @@ GetPosition(Stack[-1]); Obj=3 // @poff=270
0x515: Pop(0)
...
0x522: @@ GetPosition(Stack[-8]); Obj=20 // @poff=270
0x523: Pop(0)
0x524: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=282
0x525: Pop(0)
...
0x591: Push("voice_common") // @poff=306
0x592: Push((int) 1)
...
0x599: Push("voice_common") // @poff=306
0x59a: Push((int) 0)
...
0x5ac: Push("voice_common") // @poff=306
0x5ad: Push((int) 1)
...
0x5ba: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=336
0x5bb: Pop(1)
...
0x5cf: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=348
0x5d0: Pop(1)
...
0x5d8: Push("d") // @poff=302
0x5d9: PushEmpty(int)
0x5da: Call2 0x689

0x5db: Pop(0)
0x5dc: Pop(2); Push(Stack[-2] + Stack[-1]);
0x5dd: Push("m") // @poff=360
...
0x5e5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=336
0x5e6: Pop(1)
...
0x5fa: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=348
0x5fb: Pop(1)
0x5fc: PushEmpty(bool, string)
0x5fd: Stack[-3] = Stack[-1]
0x5fe: Call2 0x621

0x5ff: Stack[-2] = Stack[-14]
0x600: Pop(2)
0x601: Return(); Pop(10)
...
0x60d: Push("Can't find lsh animation : ") // @poff=364
...
0x61c: Push("Can't find lsh animation : ") // @poff=364
...
0x640: Push((float)9.999999974752427e-07)
...
0x649: Pop(0)
0x64a: Stack[-1] = Stack[-4]
0x64b: Return(); Pop(2)

0x64c: PushEmpty(object, object)
0x64d: @ CreateIntVector(Stack[-1])
0x64e: Pop(0)
0x64f: @@ add(Stack[-4]); Obj=1 // @poff=420
0x650: Pop(0)
0x651: @@ add(Stack[-3]); Obj=1 // @poff=420
0x652: Pop(0)
0x653: Push((int) 3)
...
0x659: @@ GetItemID(Stack[-3]); Obj=8 // @poff=424
0x65a: Pop(0)
0x65b: Push("Category") // @poff=434
0x65c: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x65d: Pop(1)
0x65e: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=452
0x65f: Pop(0)
0x660: Pop(0); Push((bool) Stack[-1] == 0)
0x661: IF (Stack[-1] == 0) GOTO 0x665; Pop(1)

0x662: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=460
0x663: Pop(0)
0x664: GOTO 0x66a

0x665: PushEmpty(int, int)
0x666: Stack[-5] = Stack[-2]
0x667: Stack[-9] = Stack[-1]
0x668: Call2 0x64c
...
0x66d: Pop(0)
0x66e: @@ SetItemName(Stack[-4]); Obj=1 // @poff=470
0x66f: Pop(0)
0x670: PushEmpty(object, object, int)
0x671: Stack[-8] = Stack[-3]
0x672: Stack[-4] = Stack[-2]
0x673: Stack[-6] = Stack[-1]
0x674: Call2 0x658
...
0x67a: Pop(0)
0x67b: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6c1: Pop(1)
0x6c2: Push("b6q01MatGotoByk") // @poff=512
0x6c3: Push("pt_b6q01_bull") // @poff=544
0x6c4: Push((int) 1)
...
0x6c8: Pop(0)
0x6c9: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=7 // @poff=572
0x6ca: Pop(5)
0x6cb: PushEmpty()
0x6cc: Call2 0x76a

0x6cd: Pop(0)
0x6ce: Push("alpha_pills") // @poff=580
0x6cf: Push((int) 50)
0x6d0: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=8 // @poff=604
0x6d1: Pop(2)
0x6d2: PushEmpty(bool, string, string)
0x6d3: Stack[-2] = "quest_b6_01" // @poff=621
0x6d4: Stack[-1] = "init_altar" // @poff=645
0x6d5: Call2 0x678

0x6d6: Pop(3)
0x6d7: PushEmpty(bool, string, string)
0x6d8: Stack[-2] = "quest_b6_01" // @poff=621
0x6d9: Stack[-1] = "clean_termitnik" // @poff=667
0x6da: Call2 0x678
...
0x6dd: Stack[-2] = 0
0x6de: PushEmpty()
0x6df: Push("playsound") // @poff=699
0x6e0: Push("giveitem") // @poff=719
0x6e1: @ TriggerWorld(Stack[-2], Stack[-1])
0x6e2: Pop(2)
0x6e3: Return(); Pop(0)

0x6e4: PushEmpty()
0x6e5: Push("oob6Mat2") // @poff=737
0x6e6: Push((int) 1)
...
0x6ee: Stack[-1] = Stack[-4]
0x6ef: Pop(1)
0x6f0: Stack[-2] = "pt_map_kurgan" // @poff=755
0x6f1: Stack[-1] = (int) 2
0x6f2: Call2 0x7b1
...
0x6f6: Pop(0)
0x6f7: @@ ShowMap(Stack[-1]); Obj=2 // @poff=783
0x6f8: Pop(1)
0x6f9: Return(); Pop(0)

0x6fa: PushEmpty()
0x6fb: Push("recipe1 is given") // @poff=791
0x6fc: @ Trace(Stack[-1])
0x6fd: Pop(1)
0x6fe: PushEmpty(object, string, int)
0x6ff: Stack[-5] = Stack[-3]
0x700: Stack[-2] = "recipe1" // @poff=825
0x701: Stack[-1] = (int) 1
0x702: Call2 0x66b
...
0x707: Stack[-1] = "oob6Mat2" // @poff=737
0x708: Call2 0x647
...
0x713: Stack[-1] = "oob6Mat1" // @poff=482
0x714: Call2 0x647
...
0x74a: Push("alpha_pills") // @poff=580
0x74b: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=841
0x74c: Pop(1)
0x74d: Push((int) 50)
...
0x751: Push("alpha_pills") // @poff=580
0x752: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=841
0x753: Pop(1)
...
0x77c: Push("Can't retrieve diary root") // @poff=860
0x77d: @ Trace(Stack[-1])
0x77e: Pop(1)
0x77f: Stack[-3] = (bool) 0
0x780: Return(); Pop(2)

0x781: Stack[-1] = Stack[-3]
0x782: Return(); Pop(2)
...
0x787: Stack[-1] = Stack[-4]
0x788: Pop(1)
0x789: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=912
0x78a: Pop(0)
0x78b: Pop(0); Push((bool) Stack[-2] == 0)
0x78c: IF (Stack[-1] == 0) GOTO 0x793; Pop(1)

0x78d: Push("Can't find diary parent with id: ") // @poff=917
...
0x793: @@ AddChild(Stack[-8]); Obj=2 // @poff=985
0x794: Pop(0)
0x795: Push((int) 7)
0x796: @ SendWorldWndMessage(Stack[-1])
0x797: Pop(1)
0x798: @@ GetCategory(Stack[-1]); Obj=8 // @poff=994
0x799: Pop(0)
...
0x7a2: Pop(0)
0x7a3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7a4: IF (Stack[-1] == 0) GOTO 0x7ab; Pop(1)

0x7a5: Push("Can't find main outdoor scene") // @poff=1006
0x7a6: @ Trace(Stack[-1])
0x7a7: Pop(1)
0x7a8: Stack[-1] = 0
...
0x7ab: @@ GetMap(Stack[-1]); Obj=2 // @poff=1066
0x7ac: Pop(0)
...
0x7b3: Pop(0)
0x7b4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7b5: IF (Stack[-1] == 0) GOTO 0x7ba; Pop(1)

0x7b6: Push("Can't find main outdoor scene") // @poff=1006
0x7b7: @ Trace(Stack[-1])
0x7b8: Pop(1)
0x7b9: Return(); Pop(8)

0x7ba: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1073
0x7bb: Pop(0)
0x7bc: Pop(0); Push((bool) Stack[-1] == 0)
0x7bd: IF (Stack[-1] == 0) GOTO 0x7c4; Pop(1)

0x7be: Push("Warning: outdoor scene locator ") // @poff=1084
0x7bf: Pop(1); Push(Stack[-1] + Stack[-11]);
0x7c0: Push(" doesnt exist") // @poff=1148
0x7c1: Pop(2); Push(Stack[-2] + Stack[-1]);
0x7c2: @ Trace(Stack[-1])
0x7c3: Pop(1)
0x7c4: @@ GetMap(Stack[-11]); Obj=2 // @poff=1066
0x7c5: Pop(0)
0x7c6: Pop(0); PushNull((bool) Stack[-11] == 0)
0x7c7: IF (Stack[-1] == 0) GOTO 0x7cc; Pop(1)

0x7c8: Push("Can't find map") // @poff=1176
0x7c9: @ Trace(Stack[-1])
0x7ca: Pop(1)
0x7cb: Return(); Pop(8)
...
0x7ce: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1206
0x7cf: Pop(2)
0x7d0: Return(); Pop(8)

0x7d1: Stack[-2] = 0
0x7d2: PushEmpty(int, int)
0x7d3: Push("branch") // @poff=1219
...
0x7e7: Stack[-1] = "ui/NPC_Mat.png" // @poff=1233
0x7e8: Return(); Pop(0)

0x7e9: Stack[-1] = "ui/NPC_Mat_b.png" // @poff=1263
0x7ea: Return(); Pop(0)
