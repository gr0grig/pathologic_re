...
// @pool_raw:
// @pool_encoding:utf8
...
0x388: Push("Can't find lsh animation : ") // @poff=411
...
0x397: Push("Can't find lsh animation : ") // @poff=411
...
0x3ac: Push((float)9.999999974752427e-07)
...
0x3cb: Stack[-1] = "idle" // @poff=146
0x3cc: Push(Stack[-3])
0x3cd: IF (Stack[-1] == 0) GOTO 0x3cf; Pop(1)

0x3ce: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3cf: Stack[-1] = Stack[-4]
0x3d0: Return(); Pop(2)

0x3d1: PushEmpty(int, bool, int, bool)
0x3d2: Stack[-2] = (int) 0
0x3d3: Push("all") // @poff=138
0x3d4: PushEmpty(string, int)
0x3d5: Stack[-5] = Stack[-1]
0x3d6: Call2 0x3ca
...
0x3e2: PushEmpty()
0x3e3: Push("oob6Morlok1") // @poff=467
0x3e4: Push((int) 1)
...
0x3e8: PushEmpty()
0x3e9: Push((int) 1)
0x3ea: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=491
0x3eb: Pop(1)
0x3ec: Return(); Pop(0)
...
0x3fe: Stack[-1] = "oob6Morlok1" // @poff=467
0x3ff: Call2 0x3b9
...
0x415: Push((int) 4)
0x416: @@ GetItemCount(Stack[-7], Stack[-1]); Obj=14 // @poff=156
0x417: Pop(1)
0x418: Stack[-5] = (int) 0
...
0x41b: Push((int) 4)
0x41c: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=14 // @poff=169
0x41d: Pop(1)
0x41e: @@ GetItemID(Stack[-3]); Obj=4 // @poff=177
0x41f: Pop(0)
0x420: Push("Microscope") // @poff=187
...
0x426: Push("Microscope") // @poff=187
...
0x446: Push("Can't retrieve diary root") // @poff=506
0x447: @ Trace(Stack[-1])
0x448: Pop(1)
...
0x452: Pop(1)
0x453: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=558
0x454: Pop(0)
0x455: Pop(0); Push((bool) Stack[-2] == 0)
0x456: IF (Stack[-1] == 0) GOTO 0x45d; Pop(1)

0x457: Push("Can't find diary parent with id: ") // @poff=563
...
0x45d: @@ AddChild(Stack[-8]); Obj=2 // @poff=631
0x45e: Pop(0)
0x45f: Push((int) 7)
0x460: @ SendWorldWndMessage(Stack[-1])
0x461: Pop(1)
0x462: @@ GetCategory(Stack[-1]); Obj=8 // @poff=640
0x463: Pop(0)
...
0x47f: Stack[-1] = "ui/NPC_Morlok.png" // @poff=666
0x480: Return(); Pop(0)

0x481: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=702
0x482: Return(); Pop(0)
