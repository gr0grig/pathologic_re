...
// @pool_raw:
// @pool_encoding:utf8
...
0x62: Stack[-1] = "Fear" // @poff=89
0x63: Call2 0xbd

0x64: Pop(1)
0x65: Push((int) 521178)
0x66: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x67: Pop(1)
0x68: @@@ ClearReplies(); Obj=0 // @poff=110
0x69: Pop(0)
...
0x71: Stack[-1] = "Fear" // @poff=89
0x72: Call2 0xbd

0x73: Pop(1)
0x74: Push((int) 521184)
0x75: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x76: Pop(1)
0x77: @@@ ClearReplies(); Obj=0 // @poff=110
0x78: Pop(0)
...
0x93: Push((int) 22391)
0x94: Push((int) 22390)
0x95: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x96: Pop(3)
0x97: Push((int) 521191)
0x98: Push((int) -1)
0x99: Push((int) 22393)
0x9a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x9b: Pop(3)
0x9c: GOTO 0x9f
...
0xae: Push("all") // @poff=132
0xaf: Push("idle") // @poff=140
...
0x11b: Stack[-1] = "Fear" // @poff=89
0x11c: Call2 0xbd

0x11d: Pop(1)
0x11e: Push((int) 521178)
0x11f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x120: Pop(1)
0x121: @@@ ClearReplies(); Obj=0 // @poff=110
0x122: Pop(0)
0x123: Push((int) 528362)
0x124: Push((int) 29735)
0x125: Push((int) 29734)
0x126: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x127: Pop(3)
0x128: Return(); Pop(0)

0x129: PushEmpty(string)
0x12a: Stack[-1] = "Fear" // @poff=89
0x12b: Call2 0xbd

0x12c: Pop(1)
0x12d: Push((int) 521184)
0x12e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x12f: Pop(1)
0x130: @@@ ClearReplies(); Obj=0 // @poff=110
0x131: Pop(0)
...
0x13a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x13b: Pop(3)
...
0x14e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x14f: Pop(3)
0x150: Push((int) 521191)
0x151: Push((int) -1)
0x152: Push((int) 22393)
0x153: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x154: Pop(3)
0x155: Return(); Pop(0)
...
0x15a: Stack[-1] = "Saveyouall" // @poff=150
0x15b: Call2 0xbd

0x15c: Pop(1)
0x15d: Push((int) 521189)
0x15e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x15f: Pop(1)
0x160: @@@ ClearReplies(); Obj=0 // @poff=110
0x161: Pop(0)
0x162: Push((int) 528371)
0x163: Push((int) 29744)
0x164: Push((int) 29743)
0x165: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x166: Pop(3)
0x167: Push((int) 528373)
0x168: Push((int) 29744)
0x169: Push((int) 29745)
0x16a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x16b: Pop(3)
0x16c: Return(); Pop(0)
...
0x171: Stack[-1] = "Saveyouall" // @poff=150
0x172: Call2 0xbd

0x173: Pop(1)
0x174: Push((int) 528372)
0x175: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x176: Pop(1)
0x177: @@@ ClearReplies(); Obj=0 // @poff=110
0x178: Pop(0)
0x179: Push((int) 521190)
0x17a: Push((int) -1)
0x17b: Push((int) 22392)
0x17c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x17d: Pop(3)
0x17e: Return(); Pop(0)
...
0x183: Stack[-1] = "Saveyouall" // @poff=150
0x184: Call2 0xbd

0x185: Pop(1)
0x186: Push((int) 521186)
0x187: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x188: Pop(1)
0x189: @@@ ClearReplies(); Obj=0 // @poff=110
0x18a: Pop(0)
0x18b: Push((int) 521187)
0x18c: Push((int) -1)
0x18d: Push((int) 22389)
0x18e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x18f: Pop(3)
0x190: Return(); Pop(0)
...
0x195: Stack[-1] = "Fear" // @poff=89
0x196: Call2 0xbd

0x197: Pop(1)
0x198: Push((int) 528363)
0x199: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x19a: Pop(1)
0x19b: @@@ ClearReplies(); Obj=0 // @poff=110
0x19c: Pop(0)
0x19d: Push((int) 528364)
0x19e: Push((int) 29737)
0x19f: Push((int) 29736)
0x1a0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1a1: Pop(3)
0x1a2: Return(); Pop(0)
...
0x1a7: Stack[-1] = "Fear" // @poff=89
0x1a8: Call2 0xbd

0x1a9: Pop(1)
0x1aa: Push((int) 528365)
0x1ab: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1ac: Pop(1)
0x1ad: @@@ ClearReplies(); Obj=0 // @poff=110
0x1ae: Pop(0)
...
0x1cb: Stack[-1] = "Saveyouall" // @poff=150
0x1cc: Call2 0xbd
...
0x235: Stack[-2] = Stack[-5]
0x236: Pop(2)
0x237: Return(); Pop(2)

0x238: Stack[-1] = 0
0x239: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x23a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x23b: @ RotateAsync(Stack[-2], Stack[-1])
0x23c: Pop(2)
0x23d: Return(); Pop(0)

0x23e: PushEmpty(object, bool, object, bool)
0x23f: Push("player") // @poff=204
...
0x29c: Stack[-1] = "Neutral" // @poff=218
0x29d: Call2 0x43b
...
0x2ab: Stack[-1] = "Neutral" // @poff=218
0x2ac: Call2 0x43b
...
0x2be: Stack[-4] = Stack[-1]
0x2bf: Call2 0x1eb

0x2c0: Pop(1)
0x2c1: PushEmpty(string)
0x2c2: Stack[-1] = "Neutral" // @poff=218
0x2c3: Call2 0x43b
...
0x31a: Pop(0)
0x31b: @@ GetPosition(Stack[-2]); Obj=7 // @poff=234
0x31c: Pop(0)
...
0x321: Push("HasProperty") // @poff=246
0x322: Push((int) 2)
...
0x328: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=270
0x329: Pop(0)
0x32a: Stack[-1] = Stack[-5]
0x32b: Return(); Pop(2)

0x32c: PushEmpty(float, float)
0x32d: PushEmpty(bool, object, string)
0x32e: Stack[-10] = Stack[-2]
0x32f: Stack[-9] = Stack[-1]
0x330: Call2 0x320
...
0x336: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=282
0x337: Pop(0)
0x338: PushEmpty(float, float, float, float)
0x339: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x33a: Stack[-8] = Stack[-2]
0x33b: Stack[-7] = Stack[-1]
0x33c: Call2 0x480

0x33d: Pop(3)
0x33e: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=294
0x33f: Pop(1)
...
0x349: Pop(2)
0x34a: Stack[-1] = Stack[-8]
0x34b: Return(); Pop(6)

0x34c: PushEmpty(cvector, cvector)
0x34d: @@ GetPosition(Stack[-1]); Obj=3 // @poff=234
0x34e: Pop(0)
0x34f: PushEmpty(bool, cvector)
0x350: Stack[-3] = Stack[-1]
0x351: Call2 0x342

0x352: Stack[-2] = Stack[-6]
0x353: Pop(2)
0x354: Return(); Pop(2)
...
0x35b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0x35c: Pop(0)
0x35d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=306
0x35e: Pop(0)
...
0x3ca: Push("voice_common") // @poff=330
0x3cb: Push((int) 1)
...
0x3d2: Push("voice_common") // @poff=330
0x3d3: Push((int) 0)
...
0x3e5: Push("voice_common") // @poff=330
0x3e6: Push((int) 1)
...
0x3f3: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=270
0x3f4: Pop(1)
...
0x408: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=282
0x409: Pop(1)
0x40a: PushEmpty(bool, string)
0x40b: Stack[-3] = Stack[-1]
0x40c: Call2 0x45a

0x40d: Stack[-2] = Stack[-14]
0x40e: Pop(2)
0x40f: Return(); Pop(10)

0x410: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x411: Push("d") // @poff=326
0x412: PushEmpty(int)
0x413: Call2 0x4fa

0x414: Pop(0)
0x415: Pop(2); Push(Stack[-2] + Stack[-1]);
0x416: Push("m") // @poff=360
...
0x41e: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=270
0x41f: Pop(1)
...
0x433: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=282
0x434: Pop(1)
0x435: PushEmpty(bool, string)
0x436: Stack[-3] = Stack[-1]
0x437: Call2 0x45a

0x438: Stack[-2] = Stack[-14]
0x439: Pop(2)
0x43a: Return(); Pop(10)
...
0x446: Push("Can't find lsh animation : ") // @poff=364
...
0x455: Push("Can't find lsh animation : ") // @poff=364
...
0x479: Push((float)9.999999974752427e-07)
...
0x492: Pop(0)
0x493: @@ add(Stack[-4]); Obj=1 // @poff=420
0x494: Pop(0)
0x495: @@ add(Stack[-3]); Obj=1 // @poff=420
0x496: Pop(0)
0x497: Push((int) 3)
...
0x49d: @@ GetItemID(Stack[-3]); Obj=8 // @poff=424
0x49e: Pop(0)
0x49f: Push("Category") // @poff=434
0x4a0: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x4a1: Pop(1)
0x4a2: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=452
0x4a3: Pop(0)
0x4a4: Pop(0); Push((bool) Stack[-1] == 0)
0x4a5: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a6: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=460
0x4a7: Pop(0)
0x4a8: GOTO 0x4ae

0x4a9: PushEmpty(int, int)
0x4aa: Stack[-5] = Stack[-2]
0x4ab: Stack[-9] = Stack[-1]
0x4ac: Call2 0x490
...
0x4b1: Pop(0)
0x4b2: @@ SetItemName(Stack[-4]); Obj=1 // @poff=470
0x4b3: Pop(0)
0x4b4: PushEmpty(object, object, int)
0x4b5: Stack[-8] = Stack[-3]
...
0x4d6: Stack[-8] = Stack[-5]
0x4d7: Stack[-4] = "reputation" // @poff=482
0x4d8: Stack[-7] = Stack[-3]
0x4d9: Stack[-2] = (int) 0
0x4da: Stack[-1] = (int) 1
0x4db: Call2 0x32c
...
0x4e1: Pop(0)
0x4e2: @@ add(Stack[-3]); Obj=1 // @poff=420
0x4e3: Pop(0)
0x4e4: Push((int) 16)
...
0x4eb: Pop(0)
0x4ec: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x519: Stack[-2] = Stack[-5]
0x51a: Return(); Pop(4)

0x51b: PushEmpty(object, object)
0x51c: Push("b6q02") // @poff=504
0x51d: Push((int) 1)
...
0x523: Pop(1)
0x524: Push("b6q02KlaraGotoRat") // @poff=516
0x525: Push("pt_map_theater") // @poff=552
0x526: Push((int) 0)
...
0x52a: Pop(0)
0x52b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=582
0x52c: Pop(5)
0x52d: PushEmpty()
0x52e: Call2 0x5a2
...
0x534: Stack[-2] = "quest_b6_02" // @poff=590
0x535: Stack[-1] = "init_maze" // @poff=614
0x536: Call2 0x4e9
...
0x53f: Stack[-2] = "quest_b6_02" // @poff=590
0x540: Stack[-1] = "completed" // @poff=634
0x541: Call2 0x4e9
...
0x544: PushEmpty()
0x545: Push("oob6Klara2_1") // @poff=654
0x546: Push((int) 1)
...
0x54a: PushEmpty()
0x54b: Push("playsound") // @poff=680
0x54c: Push("giveitem") // @poff=700
0x54d: @ TriggerWorld(Stack[-2], Stack[-1])
0x54e: Pop(2)
0x54f: Return(); Pop(0)

0x550: PushEmpty()
0x551: Push("recipe7 is given") // @poff=718
0x552: @ Trace(Stack[-1])
0x553: Pop(1)
0x554: PushEmpty(object, string, int)
0x555: Stack[-5] = Stack[-3]
0x556: Stack[-2] = "recipe7" // @poff=752
0x557: Stack[-1] = (int) 1
0x558: Call2 0x4af
...
0x55f: Stack[-1] = Stack[-4]
0x560: Pop(1)
0x561: Stack[-2] = "pt_map_theater" // @poff=552
0x562: Stack[-1] = (int) 2
0x563: Call2 0x603
...
0x567: Pop(0)
0x568: @@ ShowMap(Stack[-1]); Obj=2 // @poff=768
0x569: Pop(1)
0x56a: Return(); Pop(0)

0x56b: PushEmpty()
0x56c: PushEmpty(bool, object, float)
0x56d: Stack[-5] = Stack[-2]
0x56e: Stack[-1] = (float) -0.10000000149011612
0x56f: Call2 0x4bc
...
0x58c: Stack[-1] = "oob6Klara2_1" // @poff=654
0x58d: Call2 0x48b
...
0x5ce: Push("Can't retrieve diary root") // @poff=776
0x5cf: @ Trace(Stack[-1])
0x5d0: Pop(1)
...
0x5d9: Stack[-1] = Stack[-4]
0x5da: Pop(1)
0x5db: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=828
0x5dc: Pop(0)
0x5dd: Pop(0); Push((bool) Stack[-2] == 0)
0x5de: IF (Stack[-1] == 0) GOTO 0x5e5; Pop(1)

0x5df: Push("Can't find diary parent with id: ") // @poff=833
...
0x5e5: @@ AddChild(Stack[-8]); Obj=2 // @poff=901
0x5e6: Pop(0)
0x5e7: Push((int) 7)
0x5e8: @ SendWorldWndMessage(Stack[-1])
0x5e9: Pop(1)
0x5ea: @@ GetCategory(Stack[-1]); Obj=8 // @poff=910
0x5eb: Pop(0)
...
0x5f4: Pop(0)
0x5f5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5f6: IF (Stack[-1] == 0) GOTO 0x5fd; Pop(1)

0x5f7: Push("Can't find main outdoor scene") // @poff=922
0x5f8: @ Trace(Stack[-1])
0x5f9: Pop(1)
0x5fa: Stack[-1] = 0
...
0x5fd: @@ GetMap(Stack[-1]); Obj=2 // @poff=982
0x5fe: Pop(0)
...
0x608: Push("Can't find main outdoor scene") // @poff=922
0x609: @ Trace(Stack[-1])
0x60a: Pop(1)
0x60b: Return(); Pop(8)

0x60c: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=989
0x60d: Pop(0)
0x60e: Pop(0); Push((bool) Stack[-1] == 0)
0x60f: IF (Stack[-1] == 0) GOTO 0x616; Pop(1)

0x610: Push("Warning: outdoor scene locator ") // @poff=1000
0x611: Pop(1); Push(Stack[-1] + Stack[-11]);
0x612: Push(" doesnt exist") // @poff=1064
0x613: Pop(2); Push(Stack[-2] + Stack[-1]);
0x614: @ Trace(Stack[-1])
0x615: Pop(1)
0x616: @@ GetMap(Stack[-11]); Obj=2 // @poff=982
0x617: Pop(0)
0x618: Pop(0); PushNull((bool) Stack[-11] == 0)
0x619: IF (Stack[-1] == 0) GOTO 0x61e; Pop(1)

0x61a: Push("Can't find map") // @poff=1092
0x61b: @ Trace(Stack[-1])
0x61c: Pop(1)
0x61d: Return(); Pop(8)
...
0x620: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1122
0x621: Pop(2)
0x622: Return(); Pop(8)

0x623: Stack[-2] = 0
0x624: PushEmpty(int, int)
0x625: Push("branch") // @poff=1135
...
0x639: Stack[-1] = "ui/NPC_Klara.png" // @poff=1149
0x63a: Return(); Pop(0)

0x63b: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=1183
0x63c: Return(); Pop(0)
