...
// @pool_raw:
// @pool_encoding:utf8
...
0x27f: Push("Can't find lsh animation : ") // @poff=208
...
0x28e: Push("Can't find lsh animation : ") // @poff=208
...
0x2a3: Push((float)9.999999974752427e-07)
...
0x2ac: Pop(0)
0x2ad: Stack[-1] = Stack[-4]
0x2ae: Return(); Pop(2)

0x2af: PushEmpty(string, string)
0x2b0: Stack[-1] = "idle" // @poff=146
0x2b1: Push(Stack[-3])
...
0x2d0: PushEmpty()
0x2d1: Push("oob6Prophet1") // @poff=276
0x2d2: Push((int) 1)
...
0x2d8: Stack[-1] = "oob6Prophet1" // @poff=276
0x2d9: Call2 0x2aa
...
0x2f4: Push("Can't retrieve diary root") // @poff=302
0x2f5: @ Trace(Stack[-1])
0x2f6: Pop(1)
...
0x300: Pop(1)
0x301: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=354
0x302: Pop(0)
0x303: Pop(0); Push((bool) Stack[-2] == 0)
0x304: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x305: Push("Can't find diary parent with id: ") // @poff=359
...
0x30b: @@ AddChild(Stack[-8]); Obj=2 // @poff=427
0x30c: Pop(0)
0x30d: Push((int) 7)
0x30e: @ SendWorldWndMessage(Stack[-1])
0x30f: Pop(1)
0x310: @@ GetCategory(Stack[-1]); Obj=8 // @poff=436
0x311: Pop(0)
...
0x32d: Stack[-1] = "ui/NPC_Prophet.png" // @poff=462
0x32e: Return(); Pop(0)

0x32f: Stack[-1] = "ui/NPC_Prophet_b.png" // @poff=500
0x330: Return(); Pop(0)
