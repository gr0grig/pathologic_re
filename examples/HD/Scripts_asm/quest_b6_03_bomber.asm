...
0x623: Push("woman") // @poff=705
0x624: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x625: IF (Stack[-1] == 1) GOTO 0x62a; Pop(1)

0x626: Push("worker") // @poff=717
0x627: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x628: IF (Stack[-1] == 1) GOTO 0x62a; Pop(1)

0x629: Stack[-1] = (bool) 0
0x62a: IF (Stack[-1] == 1) GOTO 0x62f; Pop(1)

0x62b: Push("butcher") // @poff=731
0x62c: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x62d: IF (Stack[-1] == 1) GOTO 0x62f; Pop(1)

0x62e: Stack[-1] = (bool) 0
0x62f: IF (Stack[-1] == 1) GOTO 0x634; Pop(1)

0x630: Push("wasted_girl") // @poff=747
0x631: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x632: IF (Stack[-1] == 1) GOTO 0x634; Pop(1)

0x633: Stack[-1] = (bool) 0
0x634: IF (Stack[-1] == 1) GOTO 0x639; Pop(1)

0x635: Push("boy") // @poff=771
0x636: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x637: IF (Stack[-1] == 1) GOTO 0x639; Pop(1)

0x638: Stack[-1] = (bool) 0
0x639: IF (Stack[-1] == 1) GOTO 0x63e; Pop(1)

0x63a: Push("vaxxabitka") // @poff=779
0x63b: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x63c: IF (Stack[-1] == 1) GOTO 0x63e; Pop(1)

0x63d: Stack[-1] = (bool) 0
0x63e: IF (Stack[-1] == 1) GOTO 0x643; Pop(1)

0x63f: Push("unosha") // @poff=801
0x640: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x641: IF (Stack[-1] == 1) GOTO 0x643; Pop(1)

0x642: Stack[-1] = (bool) 0
0x643: IF (Stack[-1] == 1) GOTO 0x648; Pop(1)

0x644: Push("wasted_male") // @poff=815
0x645: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x646: IF (Stack[-1] == 1) GOTO 0x648; Pop(1)

0x647: Stack[-1] = (bool) 0
0x648: IF (Stack[-1] == 1) GOTO 0x64d; Pop(1)

0x649: Push("alkash") // @poff=839
0x64a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x64b: IF (Stack[-1] == 1) GOTO 0x64d; Pop(1)

0x64c: Stack[-1] = (bool) 0
0x64d: IF (Stack[-1] == 1) GOTO 0x652; Pop(1)

0x64e: Push("dohodyaga") // @poff=853
0x64f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x650: IF (Stack[-1] == 1) GOTO 0x652; Pop(1)

0x651: Stack[-1] = (bool) 0
0x652: IF (Stack[-1] == 1) GOTO 0x657; Pop(1)

0x653: Push("vaxxabit") // @poff=873
0x654: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x655: IF (Stack[-1] == 1) GOTO 0x657; Pop(1)

0x656: Stack[-1] = (bool) 0
0x657: IF (Stack[-1] == 1) GOTO 0x65c; Pop(1)

0x658: Push("nudegirl") // @poff=891
0x659: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x65a: IF (Stack[-1] == 1) GOTO 0x65c; Pop(1)

0x65b: Stack[-1] = (bool) 0
0x65c: IF (Stack[-1] == 1) GOTO 0x661; Pop(1)

0x65d: Push("morlok") // @poff=909
0x65e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x65f: IF (Stack[-1] == 1) GOTO 0x661; Pop(1)
...
0x669: Pop(0); Push(Stack[-3] | Stack[-3]);
0x66a: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x66b: Push((float)9.999999974752427e-07)
...
0x670: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x671: Return(); Pop(2)
...
0x687: Stack[-1] = 0
0x688: PushEmpty()
0x689: Pop(0); Push((bool) Stack[-2] == 0)
...
0x6a2: Stack[-8] = Stack[-5]
0x6a3: Stack[-4] = "reputation" // @poff=923
0x6a4: Stack[-7] = Stack[-3]
0x6a5: Stack[-2] = (int) 0
0x6a6: Stack[-1] = (int) 1
0x6a7: Call2 0x4d0
...
0x6ad: Pop(0)
0x6ae: @@ add(Stack[-3]); Obj=1 // @poff=664
0x6af: Pop(0)
0x6b0: Push((int) 16)
...
0x6d1: Push((int) 1)
0x6d2: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6d3: GOTO 0x6c7

0x6d4: Stack[-2] = Stack[-5]
0x6d5: Return(); Pop(4)

0x6d6: PushEmpty(int, int)
0x6d7: Push("branch") // @poff=955
0x6d8: @ GetVariable(Stack[-1], Stack[-2])
0x6d9: Pop(1)
0x6da: Stack[-1] = Stack[-3]
0x6db: Return(); Pop(2)
...
0x6ec: Push("GenerateMoney: iMin > iMax") // @poff=969
0x6ed: @ Trace(Stack[-1])
0x6ee: Pop(1)
0x6ef: Return(); Pop(4)
...
0x6f3: Pop(0); Push(Stack[-5] - Stack[-6]);
...
0x6fb: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x6fc: Push((int) 0)
...
0x70a: Pop(0)
0x70b: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1035
0x70c: Pop(0)
0x70d: Push("Organ") // @poff=1047
0x70e: Push((int) 1)
0x70f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x710: Pop(2)
0x711: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1059
0x712: Pop(0)
0x713: Push((int) 0)
0x714: Push((int) 1)
...
0x721: Stack[-1] = "liver" // @poff=1069
0x722: Call2 0x708

0x723: Pop(1)
0x724: PushEmpty(string)
0x725: Stack[-1] = "kidney" // @poff=1081
0x726: Call2 0x708

0x727: Pop(1)
0x728: PushEmpty(string)
0x729: Stack[-1] = "heart" // @poff=1095
0x72a: Call2 0x708

0x72b: Pop(1)
0x72c: PushEmpty(string)
0x72d: Stack[-1] = "blood" // @poff=1107
0x72e: Call2 0x708
...
0x73b: Stack[-3] = "fresh_meat" // @poff=1119
0x73c: Stack[-2] = (int) 1
0x73d: Stack[-1] = (int) 6
0x73e: Call2 0x5c8
...
0x748: Stack[-3] = "gamma_pills" // @poff=1151
0x749: Stack[-2] = (int) 1
0x74a: Stack[-1] = (int) 3
0x74b: Call2 0x5c8
...
0x74e: Stack[-1] = "bomber_mark" // @poff=1175
0x74f: Call2 0x756
...
0x767: Pop(1)
0x768: Push("class") // @poff=1199
0x769: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x76a: Pop(1)
0x76b: Stack[-6] = Stack[-1] == Stack[-2]; Pop(0);
0x76c: Return(); Pop(4)

0x76d: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x76e: Push(CvectorIndex(Stack[-11], 0))
0x76f: Push(CvectorIndex(Stack[-12], 0))
0x770: Pop(2); Push(Stack[-2] * Stack[-1]);
0x771: Push(CvectorIndex(Stack[-12], 2))
0x772: Push(CvectorIndex(Stack[-13], 2))
0x773: Pop(2); Push(Stack[-2] * Stack[-1]);
0x774: Pop(2); Push(Stack[-2] + Stack[-1]);
0x775: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x776: Push(CvectorIndex(Stack[-11], 1))
0x777: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x778: Push(CvectorIndex(Stack[-13], 0))
0x779: Push(CvectorIndex(Stack[-13], 0))
0x77a: Pop(2); Push(Stack[-2] - Stack[-1]);
0x77b: Push(CvectorIndex(Stack[-14], 0))
0x77c: Push(CvectorIndex(Stack[-14], 0))
0x77d: Pop(2); Push(Stack[-2] - Stack[-1]);
0x77e: Pop(2); Push(Stack[-2] * Stack[-1]);
0x77f: Push(CvectorIndex(Stack[-14], 2))
0x780: Push(CvectorIndex(Stack[-14], 2))
0x781: Pop(2); Push(Stack[-2] - Stack[-1]);
0x782: Push(CvectorIndex(Stack[-15], 2))
0x783: Push(CvectorIndex(Stack[-15], 2))
0x784: Pop(2); Push(Stack[-2] - Stack[-1]);
0x785: Pop(2); Push(Stack[-2] * Stack[-1]);
0x786: Pop(2); Push(Stack[-2] + Stack[-1]);
0x787: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x788: Push((float)500.0)
0x789: Pop(0); Push(Stack[-4] * Stack[-5]);
0x78a: Push(CvectorIndex(Stack[-14], 1))
0x78b: Push(CvectorIndex(Stack[-16], 1))
0x78c: Pop(2); Push(Stack[-2] - Stack[-1]);
0x78d: Pop(2); Push(Stack[-2] - Stack[-1]);
0x78e: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x78f: Push((int) 0)
0x790: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x791: IF (Stack[-1] == 0) GOTO 0x794; Pop(1)

0x792: Stack[-14] = (int) -1
0x793: Return(); Pop(10)

0x794: Pop(0); Push(Stack[-3] / Stack[-5]);
0x795: Pop(0); Push(Sqrt(Stack[-3]))
0x796: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
...
0x7c7: Push(-1, 3); TaskCall(2)
0x7c8: Call2 0x15d

0x7c9: Pop(-1, 3); TaskReturn
0x7ca: Pop(1)
0x7cb: Return(); Pop(0)

0x7cc: PushEmpty()
0x7cd: PushEmpty(bool, object)
0x7ce: Stack[-3] = Stack[-1]
0x7cf: Call2 0x846

0x7d0: Stack[-2] = Stack[-4]
0x7d1: Pop(2)
0x7d2: Return(); Pop(0)

0x7d3: PushEmpty()
0x7d4: PushEmpty(object)
0x7d5: Stack[-2] = Stack[-1]
0x7d6: Push(-1, 2); TaskCall(4)
0x7d7: Call2 0x2ab

0x7d8: Pop(-1, 2); TaskReturn
0x7d9: Pop(1)
0x7da: @ ResetAAS()
0x7db: Pop(0)
0x7dc: Return(); Pop(0)
...
0x7df: Stack[-2] = Stack[-1]
0x7e0: Call2 0x87e

0x7e1: Pop(1)
0x7e2: PushEmpty(object)
0x7e3: Stack[-2] = Stack[-1]
0x7e4: Push(-1, 2); TaskCall(4)
0x7e5: Call2 0x2ab

0x7e6: Pop(-1, 2); TaskReturn
0x7e7: Pop(1)
0x7e8: @ ResetAAS()
0x7e9: Pop(0)
0x7ea: Return(); Pop(0)
...
0x7ed: Stack[-7] = Stack[-3]
0x7ee: Stack[-6] = Stack[-2]
0x7ef: Stack[-5] = Stack[-1]
0x7f0: Call2 0x566
...
0x7f5: Stack[-11] = Stack[-5]
0x7f6: Stack[-10] = Stack[-4]
...
0x808: Stack[-4] = Stack[-2]
0x809: Stack[-1] = (float) 0.05000000074505806
0x80a: Call2 0x688

0x80b: Pop(3)
0x80c: PushEmpty(object)
0x80d: Stack[-2] = Stack[-1]
0x80e: Push(-1, 0); TaskCall(1)
0x80f: Call2 0xb9

0x810: Pop(-1, 0); TaskReturn
0x811: Pop(1)
0x812: Return(); Pop(0)
...
0x830: Push(Stack[-2])
0x831: IF (Stack[-1] == 1) GOTO 0x83a; Pop(1)
...
0x850: @@ in(Stack[-5], Stack[-10]); Obj=1 // @poff=1225
0x851: Pop(1)
0x852: Push(Stack[-4])
...
0x857: Stack[-12] = Stack[-2]
0x858: Stack[-1] = "disease" // @poff=1228
0x859: Call2 0x4c4
...
0x85f: Push("disease") // @poff=1228
0x860: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=544
0x861: Pop(1)
...
0x867: Stack[-11] = Stack[-4] > Stack[-1]; Pop(1);
0x868: Return(); Pop(8)

0x869: GOTO 0x87c

0x86a: Push((float)0.009999999776482582)
0x86b: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x86c: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x86d: PushEmpty(bool, object, string)
0x86e: Stack[-12] = Stack[-2]
0x86f: Stack[-1] = "class" // @poff=1199
0x870: Call2 0x4c4

0x871: Pop(2)
0x872: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x873: Push("class") // @poff=1199
0x874: @@ GetProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=544
0x875: Pop(1)
0x876: PushEmpty(bool, string)
0x877: Stack[-3] = Stack[-1]
0x878: Call2 0x60b

0x879: Stack[-2] = Stack[-12]
0x87a: Pop(2)
0x87b: Return(); Pop(8)
...
0x87f: Pop(0); PushNull((bool) Stack[-3] == 0)
0x880: IF (Stack[-1] == 0) GOTO 0x882; Pop(1)

0x881: Return(); Pop(2)

0x882: Push(GlobalVars[0])
0x883: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=1225
0x884: Pop(1)
0x885: Pop(0); Push((bool) Stack[-1] == 0)
0x886: IF (Stack[-1] == 0) GOTO 0x88a; Pop(1)

0x887: Push(GlobalVars[0])
0x888: @@ add(Stack[-4]); Obj=1 // @poff=664
0x889: Pop(1)
0x88a: Return(); Pop(2)
