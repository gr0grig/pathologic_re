...
// @pool_raw:
// @pool_encoding:utf8
...
0x2c9: Push("Can't find lsh animation : ") // @poff=208
...
0x2d8: Push("Can't find lsh animation : ") // @poff=208
...
0x2ed: Push((float)9.999999974752427e-07)
...
0x31e: Pop(1)
0x31f: Push("b7q01WastedGotoViktor") // @poff=276
0x320: Push("pt_map_viktor") // @poff=320
0x321: Push((int) 1)
...
0x325: Pop(0)
0x326: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=348
0x327: Pop(5)
0x328: PushEmpty()
0x329: Call2 0x35b
...
0x32c: Stack[-1] = 0
0x32d: PushEmpty()
0x32e: Push("oob7WastedMaleM1") // @poff=356
0x32f: Push((int) 1)
...
0x338: Pop(1)
0x339: Stack[-2] = "pt_map_viktor" // @poff=320
0x33a: Stack[-1] = (int) 2
0x33b: Call2 0x3a2
...
0x33f: Pop(0)
0x340: @@ ShowMap(Stack[-1]); Obj=2 // @poff=390
0x341: Pop(1)
0x342: Return(); Pop(0)

0x343: PushEmpty()
0x344: PushEmpty(int, string)
0x345: Stack[-1] = "oob7WastedMaleM1" // @poff=356
0x346: Call2 0x2f4
...
0x36d: Push("Can't retrieve diary root") // @poff=398
0x36e: @ Trace(Stack[-1])
0x36f: Pop(1)
...
0x379: Pop(1)
0x37a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=450
0x37b: Pop(0)
0x37c: Pop(0); Push((bool) Stack[-2] == 0)
0x37d: IF (Stack[-1] == 0) GOTO 0x384; Pop(1)

0x37e: Push("Can't find diary parent with id: ") // @poff=455
...
0x384: @@ AddChild(Stack[-8]); Obj=2 // @poff=523
0x385: Pop(0)
0x386: Push((int) 7)
0x387: @ SendWorldWndMessage(Stack[-1])
0x388: Pop(1)
0x389: @@ GetCategory(Stack[-1]); Obj=8 // @poff=532
0x38a: Pop(0)
...
0x393: Pop(0)
0x394: Pop(0); PushNull((bool) Stack[-2] == 0)
0x395: IF (Stack[-1] == 0) GOTO 0x39c; Pop(1)

0x396: Push("Can't find main outdoor scene") // @poff=544
0x397: @ Trace(Stack[-1])
0x398: Pop(1)
0x399: Stack[-1] = 0
...
0x39c: @@ GetMap(Stack[-1]); Obj=2 // @poff=604
0x39d: Pop(0)
...
0x3a7: Push("Can't find main outdoor scene") // @poff=544
0x3a8: @ Trace(Stack[-1])
0x3a9: Pop(1)
0x3aa: Return(); Pop(8)

0x3ab: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=611
0x3ac: Pop(0)
0x3ad: Pop(0); Push((bool) Stack[-1] == 0)
0x3ae: IF (Stack[-1] == 0) GOTO 0x3b5; Pop(1)

0x3af: Push("Warning: outdoor scene locator ") // @poff=622
0x3b0: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3b1: Push(" doesnt exist") // @poff=686
0x3b2: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3b3: @ Trace(Stack[-1])
0x3b4: Pop(1)
0x3b5: @@ GetMap(Stack[-11]); Obj=2 // @poff=604
0x3b6: Pop(0)
0x3b7: Pop(0); PushNull((bool) Stack[-11] == 0)
0x3b8: IF (Stack[-1] == 0) GOTO 0x3bd; Pop(1)

0x3b9: Push("Can't find map") // @poff=714
0x3ba: @ Trace(Stack[-1])
0x3bb: Pop(1)
0x3bc: Return(); Pop(8)
...
0x3bf: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=744
0x3c0: Pop(2)
0x3c1: Return(); Pop(8)

0x3c2: Stack[-2] = 0
0x3c3: PushEmpty(int, int)
0x3c4: Push("branch") // @poff=757
...
0x3d8: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=771
0x3d9: Return(); Pop(0)

0x3da: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=811
0x3db: Return(); Pop(0)
