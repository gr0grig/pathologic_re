...
// @pool_raw:
// @pool_encoding:utf8
...
0x139: Pop(0)
0x13a: Push("all") // @poff=138
0x13b: PushEmpty(string, int)
0x13c: Stack[-7] = Stack[-1]
0x13d: Call2 0x1ff
...
0x173: @@ GetPosition(Stack[-8]); Obj=20 // @poff=172
0x174: Pop(0)
0x175: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=184
0x176: Pop(0)
...
0x19c: Pop(0)
0x19d: Push((bool) 1)
0x19e: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x19f: Pop(1)
0x1a0: Push(CvectorIndex(Stack[-4], 0))
0x1a1: Push(CvectorIndex(Stack[-5], 2))
0x1a2: @ Rotate(Stack[-2], Stack[-1])
0x1a3: Pop(2)
...
0x1a9: Push("head") // @poff=198
0x1aa: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1ab: Pop(1)
0x1ac: Push(Stack[-1])
0x1ad: IF (Stack[-1] == 0) GOTO 0x1b1; Pop(1)

0x1ae: Push("head") // @poff=198
0x1af: @ LookAsyncCamera(Stack[-1])
0x1b0: Pop(1)
0x1b1: @ CameraWaitForPlayFinish()
0x1b2: Pop(0)
0x1b3: @ ResumeWorld()
0x1b4: Pop(0)
0x1b5: Stack[-21] = (bool) 1
0x1b6: Return(); Pop(18)

0x1b7: PushEmpty(bool, bool)
0x1b8: Push((bool) 1)
0x1b9: @ CameraSwitchToNormal(Stack[-1])
0x1ba: Pop(1)
...
0x1c0: Push("head") // @poff=198
0x1c1: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x1c2: Pop(1)
0x1c3: Push(Stack[-1])
0x1c4: IF (Stack[-1] == 0) GOTO 0x1c8; Pop(1)

0x1c5: Push("head") // @poff=198
0x1c6: @ UnlookAsync(Stack[-1])
0x1c7: Pop(1)
0x1c8: Return(); Pop(2)

0x1c9: PushEmpty(bool, float, float, bool, float, float)
0x1ca: @ lshHasAnimation(Stack[-3], Stack[-7])
0x1cb: Pop(0)
0x1cc: Push(Stack[-3])
0x1cd: IF (Stack[-1] == 0) GOTO 0x1d4; Pop(1)

0x1ce: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x1cf: Pop(0)
0x1d0: Push((bool) 0)
0x1d1: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x1d2: Pop(1)
0x1d3: GOTO 0x1d8

0x1d4: Push("Can't find lsh animation : ") // @poff=208
0x1d5: Pop(1); Push(Stack[-1] + Stack[-8]);
0x1d6: @ Trace(Stack[-1])
0x1d7: Pop(1)
0x1d8: Return(); Pop(6)

0x1d9: PushEmpty(bool, float, float, bool, float, float)
0x1da: @ lshHasAnimation(Stack[-3], Stack[-8])
0x1db: Pop(0)
0x1dc: Push(Stack[-3])
0x1dd: IF (Stack[-1] == 0) GOTO 0x1e3; Pop(1)

0x1de: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x1df: Pop(0)
0x1e0: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x1e1: Pop(0)
0x1e2: GOTO 0x1e7

0x1e3: Push("Can't find lsh animation : ") // @poff=208
0x1e4: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1e5: @ Trace(Stack[-1])
0x1e6: Pop(1)
0x1e7: Return(); Pop(6)
...
0x1f0: @ self(Stack[-1])
0x1f1: Pop(0)
0x1f2: Stack[-1] = Stack[-3]
0x1f3: Return(); Pop(2)

0x1f4: Stack[-1] = 0
0x1f5: PushEmpty(float, float)
0x1f6: Pop(0); Push(Stack[-3] | Stack[-3]);
0x1f7: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x1f8: Push((float)9.999999974752427e-07)
0x1f9: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x1fa: IF (Stack[-1] == 0) GOTO 0x1fd; Pop(1)

0x1fb: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x1fc: Return(); Pop(2)

0x1fd: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x1fe: Return(); Pop(2)

0x1ff: PushEmpty(string, string)
0x200: Stack[-1] = "idle" // @poff=146
0x201: Push(Stack[-3])
0x202: IF (Stack[-1] == 0) GOTO 0x204; Pop(1)

0x203: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x204: Stack[-1] = Stack[-4]
0x205: Return(); Pop(2)

0x206: PushEmpty(int, bool, int, bool)
0x207: Stack[-2] = (int) 0
0x208: Push("all") // @poff=138
0x209: PushEmpty(string, int)
0x20a: Stack[-5] = Stack[-1]
0x20b: Call2 0x1ff

0x20c: Pop(1)
0x20d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x20e: Pop(2)
...
0x212: Push((int) 1)
0x213: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x214: GOTO 0x208

0x215: Stack[-2] = Stack[-5]
0x216: Return(); Pop(4)

0x217: PushEmpty(int, int)
0x218: Push("branch") // @poff=264
0x219: @ GetVariable(Stack[-1], Stack[-2])
0x21a: Pop(1)
0x21b: Push((int) 0)
...
0x228: Stack[-1] = (int) 515556
0x229: Return(); Pop(0)

0x22a: Stack[-1] = (int) 503341
0x22b: Return(); Pop(0)

0x22c: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=278
0x22d: Return(); Pop(0)

0x22e: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=318
0x22f: Return(); Pop(0)
