...
// @pool_raw:
// @pool_encoding:utf8
...
0x25e: Push("Can't find lsh animation : ") // @poff=208
...
0x26d: Push("Can't find lsh animation : ") // @poff=208
...
0x2b5: Stack[-2] = Stack[-5]
0x2b6: Return(); Pop(4)

0x2b7: PushEmpty(object, object)
0x2b8: Push("b7q01") // @poff=264
0x2b9: Push((int) 4)
...
0x2be: Stack[-1] = Stack[-2]
0x2bf: Pop(1)
0x2c0: Push("b7q01PatrolGotoGorbun") // @poff=276
0x2c1: Push("pt_map_gorbun") // @poff=320
0x2c2: Push((int) 1)
...
0x2c6: Pop(0)
0x2c7: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=348
0x2c8: Pop(5)
0x2c9: PushEmpty()
0x2ca: Call2 0x2ef
...
0x2cd: Stack[-2] = "quest_b7_01" // @poff=356
0x2ce: Stack[-1] = "init_gorbun_house" // @poff=380
0x2cf: Call2 0x28e
...
0x2d8: Pop(1)
0x2d9: Stack[-2] = "pt_map_gorbun" // @poff=320
0x2da: Stack[-1] = (int) 2
0x2db: Call2 0x336
...
0x2df: Pop(0)
0x2e0: @@ ShowMap(Stack[-1]); Obj=2 // @poff=416
0x2e1: Pop(1)
0x2e2: Return(); Pop(0)

0x2e3: PushEmpty()
0x2e4: PushEmpty(int, string)
0x2e5: Stack[-1] = "b7q01" // @poff=264
0x2e6: Call2 0x289
...
0x301: Push("Can't retrieve diary root") // @poff=424
0x302: @ Trace(Stack[-1])
0x303: Pop(1)
...
0x30d: Pop(1)
0x30e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=476
0x30f: Pop(0)
0x310: Pop(0); Push((bool) Stack[-2] == 0)
0x311: IF (Stack[-1] == 0) GOTO 0x318; Pop(1)

0x312: Push("Can't find diary parent with id: ") // @poff=481
...
0x318: @@ AddChild(Stack[-8]); Obj=2 // @poff=549
0x319: Pop(0)
0x31a: Push((int) 7)
0x31b: @ SendWorldWndMessage(Stack[-1])
0x31c: Pop(1)
0x31d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=558
0x31e: Pop(0)
...
0x32a: Push("Can't find main outdoor scene") // @poff=570
0x32b: @ Trace(Stack[-1])
0x32c: Pop(1)
0x32d: Stack[-1] = 0
...
0x330: @@ GetMap(Stack[-1]); Obj=2 // @poff=630
0x331: Pop(0)
...
0x338: Pop(0)
0x339: Pop(0); PushNull((bool) Stack[-2] == 0)
0x33a: IF (Stack[-1] == 0) GOTO 0x33f; Pop(1)

0x33b: Push("Can't find main outdoor scene") // @poff=570
0x33c: @ Trace(Stack[-1])
0x33d: Pop(1)
0x33e: Return(); Pop(8)

0x33f: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=637
0x340: Pop(0)
0x341: Pop(0); Push((bool) Stack[-1] == 0)
0x342: IF (Stack[-1] == 0) GOTO 0x349; Pop(1)

0x343: Push("Warning: outdoor scene locator ") // @poff=648
0x344: Pop(1); Push(Stack[-1] + Stack[-11]);
0x345: Push(" doesnt exist") // @poff=712
0x346: Pop(2); Push(Stack[-2] + Stack[-1]);
0x347: @ Trace(Stack[-1])
0x348: Pop(1)
0x349: @@ GetMap(Stack[-11]); Obj=2 // @poff=630
0x34a: Pop(0)
0x34b: Pop(0); PushNull((bool) Stack[-11] == 0)
0x34c: IF (Stack[-1] == 0) GOTO 0x351; Pop(1)

0x34d: Push("Can't find map") // @poff=740
0x34e: @ Trace(Stack[-1])
0x34f: Pop(1)
0x350: Return(); Pop(8)
...
0x353: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=770
0x354: Pop(2)
0x355: Return(); Pop(8)

0x356: Stack[-2] = 0
0x357: PushEmpty(int, int)
0x358: Push("branch") // @poff=783
...
0x36c: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=797
0x36d: Return(); Pop(0)

0x36e: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=837
0x36f: Return(); Pop(0)
