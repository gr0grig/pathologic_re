...
// @pool_raw:
// @pool_encoding:utf8
...
0x1e6: Push("Can't find lsh animation : ") // @poff=208
...
0x1f5: Push("Can't find lsh animation : ") // @poff=208
...
0x23a: Stack[-1] = (int) 515571
0x23b: Return(); Pop(0)

0x23c: Stack[-1] = (int) 504029
0x23d: Return(); Pop(0)

0x23e: Stack[-1] = "ui/NPC_bmask.png" // @poff=278
0x23f: Return(); Pop(0)

0x240: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=312
0x241: Return(); Pop(0)
