...
// @pool_raw:
// @pool_encoding:utf8
...
0x272: Push("Can't find lsh animation : ") // @poff=208
...
0x281: Push("Can't find lsh animation : ") // @poff=208
...
0x2c7: Pop(1)
0x2c8: Push("b7q01BirdmaskGotoMat") // @poff=276
0x2c9: Push("pt_map_mat") // @poff=318
0x2ca: Push((int) 1)
...
0x2ce: Pop(0)
0x2cf: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=340
0x2d0: Pop(5)
0x2d1: PushEmpty()
0x2d2: Call2 0x2f2
...
0x2db: Pop(1)
0x2dc: Stack[-2] = "pt_map_mat" // @poff=318
0x2dd: Stack[-1] = (int) 2
0x2de: Call2 0x339
...
0x2e2: Pop(0)
0x2e3: @@ ShowMap(Stack[-1]); Obj=2 // @poff=348
0x2e4: Pop(1)
0x2e5: Return(); Pop(0)

0x2e6: PushEmpty()
0x2e7: PushEmpty(int, string)
0x2e8: Stack[-1] = "b7q01" // @poff=264
0x2e9: Call2 0x29d
...
0x304: Push("Can't retrieve diary root") // @poff=356
0x305: @ Trace(Stack[-1])
0x306: Pop(1)
...
0x310: Pop(1)
0x311: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=408
0x312: Pop(0)
0x313: Pop(0); Push((bool) Stack[-2] == 0)
0x314: IF (Stack[-1] == 0) GOTO 0x31b; Pop(1)

0x315: Push("Can't find diary parent with id: ") // @poff=413
...
0x31b: @@ AddChild(Stack[-8]); Obj=2 // @poff=481
0x31c: Pop(0)
0x31d: Push((int) 7)
0x31e: @ SendWorldWndMessage(Stack[-1])
0x31f: Pop(1)
0x320: @@ GetCategory(Stack[-1]); Obj=8 // @poff=490
0x321: Pop(0)
...
0x32a: Pop(0)
0x32b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x32c: IF (Stack[-1] == 0) GOTO 0x333; Pop(1)

0x32d: Push("Can't find main outdoor scene") // @poff=502
0x32e: @ Trace(Stack[-1])
0x32f: Pop(1)
0x330: Stack[-1] = 0
...
0x333: @@ GetMap(Stack[-1]); Obj=2 // @poff=562
0x334: Pop(0)
...
0x33b: Pop(0)
0x33c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x33d: IF (Stack[-1] == 0) GOTO 0x342; Pop(1)

0x33e: Push("Can't find main outdoor scene") // @poff=502
0x33f: @ Trace(Stack[-1])
0x340: Pop(1)
0x341: Return(); Pop(8)

0x342: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=569
0x343: Pop(0)
0x344: Pop(0); Push((bool) Stack[-1] == 0)
0x345: IF (Stack[-1] == 0) GOTO 0x34c; Pop(1)

0x346: Push("Warning: outdoor scene locator ") // @poff=580
0x347: Pop(1); Push(Stack[-1] + Stack[-11]);
0x348: Push(" doesnt exist") // @poff=644
0x349: Pop(2); Push(Stack[-2] + Stack[-1]);
0x34a: @ Trace(Stack[-1])
0x34b: Pop(1)
0x34c: @@ GetMap(Stack[-11]); Obj=2 // @poff=562
0x34d: Pop(0)
0x34e: Pop(0); PushNull((bool) Stack[-11] == 0)
0x34f: IF (Stack[-1] == 0) GOTO 0x354; Pop(1)

0x350: Push("Can't find map") // @poff=672
0x351: @ Trace(Stack[-1])
0x352: Pop(1)
0x353: Return(); Pop(8)
...
0x356: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=702
0x357: Pop(2)
0x358: Return(); Pop(8)

0x359: Stack[-2] = 0
0x35a: PushEmpty(int, int)
0x35b: Push("branch") // @poff=715
...
0x36f: Stack[-1] = "ui/NPC_bmask.png" // @poff=729
0x370: Return(); Pop(0)

0x371: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=763
0x372: Return(); Pop(0)
