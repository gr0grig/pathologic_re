...
Strings:
	...
	W:lockpick
	W:grabitel_mark
// @pool_raw:
...
Events:
EVENT_6 Op = 0x85c Vars = ()
EVENT_22 Op = 0x881 Vars = (object, int, float, float)
EVENT_43 Op = 0x889 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x893 Vars = (object, string)
EVENT_41 Op = 0x8a0 Vars = (object)
...
0x4da: Pop(0); PushNull((bool) Stack[-21] == 0)
0x4db: IF (Stack[-1] == 0) GOTO 0x4e1; Pop(1)

0x4dc: PushEmpty(string)
0x4dd: Stack[-1] = "fdie" // @poff=590
0x4de: Call2 0x534

0x4df: Pop(1)
0x4e0: GOTO 0x533

0x4e1: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x4e2: Pop(0)
...
0x4f2: Stack[-6] = "fdie" // @poff=590
0x4f3: GOTO 0x4f5

0x4f4: Stack[-6] = "bdie" // @poff=600
...
0x4fb: @ StopAsync()
0x4fc: Pop(0)
0x4fd: Stack[-21] = Stack[-5]
0x4fe: Push("GetScriptProperty") // @poff=610
0x4ff: Push((int) 2)
0x500: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x501: IF (Stack[-1] == 0) GOTO 0x50d; Pop(1)

0x502: Push("Owner") // @poff=132
0x503: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=646
0x504: Pop(1)
0x505: Push(Stack[-4])
0x506: IF (Stack[-1] == 0) GOTO 0x50d; Pop(1)

0x507: Push("Owner") // @poff=132
0x508: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=664
0x509: Pop(1)
0x50a: Pop(0); PushNull((bool) Stack[-5] == 0)
0x50b: IF (Stack[-1] == 0) GOTO 0x50d; Pop(1)

0x50c: Stack[-21] = Stack[-5]
0x50d: Push("@GetEyesHeight") // @poff=682
0x50e: Push((int) 1)
0x50f: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x510: IF (Stack[-1] == 0) GOTO 0x51c; Pop(1)

0x511: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x512: Pop(0)
...
0x528: @ StopAsync()
0x529: Pop(0)
0x52a: Push("head") // @poff=532
0x52b: @ UnlookAsync(Stack[-1])
0x52c: Pop(1)
0x52d: Push("all") // @poff=0
...
0x55e: Stack[-2] = "bullet" // @poff=722
0x55f: Return(); Pop(0)

0x560: Stack[-2] = "phys" // @poff=736
0x561: Return(); Pop(0)

0x562: PushEmpty(cvector, cvector, cvector, cvector)
0x563: @ GetPosition(Stack[-2])
0x564: Pop(0)
0x565: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x566: Pop(0)
...
0x56b: Pop(0)
0x56c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x56d: Pop(0)
...
0x577: Push("HasProperty") // @poff=746
0x578: Push((int) 2)
...
0x57e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=770
0x57f: Pop(0)
...
0x58c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=782
0x58d: Pop(0)
0x58e: PushEmpty(float, float, float, float)
0x58f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x590: Stack[-8] = Stack[-2]
0x591: Stack[-7] = Stack[-1]
0x592: Call2 0x74b

0x593: Pop(3)
0x594: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=794
0x595: Pop(1)
...
0x59a: Stack[-18] = Stack[-2]
0x59b: Stack[-1] = "health" // @poff=806
0x59c: Call2 0x576
...
0x5a3: Stack[-18] = Stack[-2]
0x5a4: Stack[-1] = "armor" // @poff=820
0x5a5: Call2 0x576
...
0x5ab: Push("armor") // @poff=820
0x5ac: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=782
0x5ad: Pop(1)
0x5ae: Push("armor_") // @poff=832
0x5af: PushEmpty(string, int)
0x5b0: Stack[-16] = Stack[-1]
0x5b1: Call2 0x554

0x5b2: Pop(1)
0x5b3: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5b4: PushEmpty(bool, object, string)
0x5b5: Stack[-18] = Stack[-2]
0x5b6: Stack[-8] = Stack[-1]
0x5b7: Call2 0x576
...
0x5bd: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=782
0x5be: Pop(0)
...
0x5c5: Stack[-3] = Stack[-6]
0x5c6: Pop(3)
0x5c7: Push("health") // @poff=806
0x5c8: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=782
0x5c9: Pop(1)
0x5ca: Push((int) 1)
0x5cb: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5cc: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5cd: Push("health") // @poff=806
...
0x5d3: Pop(3)
0x5d4: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=794
0x5d5: Pop(2)
0x5d6: PushEmpty(bool, object)
0x5d7: Stack[-17] = Stack[-1]
0x5d8: Call2 0x571
...
0x5fa: Push("health") // @poff=806
0x5fb: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=782
0x5fc: Pop(1)
...
0x601: @@ IsDead(Stack[-1]); Obj=3 // @poff=846
0x602: Pop(0)
0x603: Stack[-1] = Stack[-4]
0x604: Return(); Pop(2)

0x605: PushEmpty(object, object, object, object)
0x606: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x61a: Pop(0)
0x61b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x61c: IF (Stack[-1] == 0) GOTO 0x61f; Pop(1)

0x61d: Stack[-6] = (bool) 0
0x61e: Return(); Pop(4)

0x61f: @@ GetScene(Stack[-1]); Obj=5 // @poff=867
0x620: Pop(0)
...
0x633: Stack[-6] = Stack[-2]
0x634: Stack[-1] = "noaccess" // @poff=876
0x635: Call2 0x576
...
0x63b: Push("noaccess") // @poff=876
0x63c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=782
0x63d: Pop(1)
0x63e: Push((int) 0)
...
0x663: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x664: Pop(0)
...
0x674: Stack[-1] = "fhit" // @poff=894
0x675: GOTO 0x677

0x676: Stack[-1] = "bhit" // @poff=904
0x677: Push("hit_react") // @poff=914
0x678: Push("1") // @poff=34
0x679: Pop(1); Push(Stack[-3] + Stack[-1]);
0x67a: Push("2") // @poff=934
...
0x6b2: Pop(0)
0x6b3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=947
0x6b4: Pop(0)
0x6b5: PushEmpty(object, int, float, cvector, cvector)
0x6b6: Stack[-26] = Stack[-5]
0x6b7: Stack[-25] = Stack[-4]
0x6b8: Stack[-24] = Stack[-3]
...
0x6d3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x6d4: Pop(0)
...
0x6ea: Stack[-7] = Stack[-2]
0x6eb: Stack[-6] = Stack[-1]
0x6ec: Call2 0x75e
...
0x725: Push((float)9.999999974752427e-07)
...
0x77d: Stack[-8] = Stack[-5]
0x77e: Stack[-4] = "reputation" // @poff=979
0x77f: Stack[-7] = Stack[-3]
0x780: Stack[-2] = (int) 0
0x781: Stack[-1] = (int) 1
0x782: Call2 0x582
...
0x788: Pop(0)
0x789: @@ add(Stack[-3]); Obj=1 // @poff=938
0x78a: Pop(0)
0x78b: Push((int) 0)
0x78c: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x78d: IF (Stack[-1] == 0) GOTO 0x792; Pop(1)

0x78e: Push((float)0.699999988079071)
0x78f: Push((int) 500)
0x790: @ RumblePlay(Stack[-2], Stack[-1])
0x791: Pop(2)
0x792: Push((int) 15)
0x793: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x794: Pop(1)
0x795: Return(); Pop(2)

0x796: Stack[-1] = 0
0x797: PushEmpty(object, object)
0x798: @ CreateFloatVector(Stack[-1])
0x799: Pop(0)
0x79a: @@ add(Stack[-3]); Obj=1 // @poff=938
0x79b: Pop(0)
0x79c: Push((int) 16)
0x79d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x79e: Pop(1)
0x79f: Return(); Pop(2)

0x7a0: Stack[-1] = 0
0x7a1: PushEmpty(bool, bool)
0x7a2: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7a3: Pop(0)
0x7a4: Push(Stack[-1])
0x7a5: IF (Stack[-1] == 0) GOTO 0x7a9; Pop(1)

0x7a6: Push("attack") // @poff=320
0x7a7: @ PlayGlobalMusic(Stack[-1])
0x7a8: Pop(1)
0x7a9: Return(); Pop(2)

0x7aa: PushEmpty(object, object)
0x7ab: @ GetScene(Stack[-1])
0x7ac: Pop(0)
0x7ad: Push("battle") // @poff=1001
0x7ae: PushEmpty(object)
0x7af: Call2 0x71c

0x7b0: Pop(0)
0x7b1: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x7b2: Pop(2)
0x7b3: Return(); Pop(2)

0x7b4: Stack[-1] = 0
0x7b5: PushEmpty(bool, bool)
0x7b6: Push("god_mode") // @poff=1015
0x7b7: @ GetVariable(Stack[-1], Stack[-2])
0x7b8: Pop(1)
0x7b9: Stack[-1] = Stack[-3]
0x7ba: Return(); Pop(2)

0x7bb: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0x7bc: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x7bd: Stack[-5] = (int) 250000
0x7be: Push(CvectorIndex(Stack[-6], 1))
0x7bf: Push((int) 1000)
0x7c0: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7c1: Pop(0); Push(Stack[-14] * Stack[-14]);
0x7c2: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x7c3: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x7c4: PushEmpty(float, float, float, float)
0x7c5: Stack[-9] = Stack[-3]
0x7c6: Stack[-8] = Stack[-2]
0x7c7: Stack[-7] = Stack[-1]
0x7c8: Call2 0x733

0x7c9: Stack[-4] = Stack[-6]
0x7ca: Pop(4)
0x7cb: Push((int) 0)
...
0x7d0: PushEmpty(float, float, float, float, float)
0x7d1: Stack[-10] = Stack[-4]
0x7d2: Stack[-9] = Stack[-3]
0x7d3: Stack[-8] = Stack[-2]
0x7d4: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x7d5: Call2 0x73a

0x7d6: Pop(4)
0x7d7: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7d8: Push(CVector(0.0, 500.0, 0.0))
0x7d9: Pop(1); Push(Stack[-1] * Stack[-2]);
0x7da: Pop(1); Push(Stack[-1] * Stack[-2]);
0x7db: Pop(1); Push(Stack[-7] + Stack[-1]);
0x7dc: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x7dd: Return(); Pop(12)

0x7de: PushEmpty(int, int)
0x7df: Push("branch") // @poff=1033
0x7e0: @ GetVariable(Stack[-1], Stack[-2])
0x7e1: Pop(1)
0x7e2: Stack[-1] = Stack[-3]
0x7e3: Return(); Pop(2)
...
0x7e7: Pop(0)
0x7e8: Push((int) 1)
0x7e9: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x7ea: IF (Stack[-1] == 0) GOTO 0x7ee; Pop(1)

0x7eb: @ WorkWithCorpse(Stack[-1])
0x7ec: Pop(0)
0x7ed: GOTO 0x7f0

0x7ee: @ Barter(Stack[-1])
0x7ef: Pop(0)
0x7f0: Return(); Pop(0)

0x7f1: PushEmpty(int, bool, int, bool)
0x7f2: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x7f3: IF (Stack[-1] == 0) GOTO 0x7f8; Pop(1)

0x7f4: Push("GenerateMoney: iMin > iMax") // @poff=1047
0x7f5: @ Trace(Stack[-1])
0x7f6: Pop(1)
0x7f7: Return(); Pop(4)

0x7f8: Stack[-2] = (int) 0
0x7f9: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x7fa: IF (Stack[-1] == 0) GOTO 0x7ff; Pop(1)

0x7fb: Pop(0); Push(Stack[-5] - Stack[-6]);
0x7fc: @ irand(Stack[-3], Stack[-1])
0x7fd: Pop(1)
0x7fe: GOTO 0x803

0x7ff: Push((int) 0)
0x800: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x801: IF (Stack[-1] == 0) GOTO 0x803; Pop(1)

0x802: Return(); Pop(4)

0x803: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x804: Push((int) 0)
...
0x809: Stack[-1] = "Money" // @poff=1101
0x80a: Call2 0x857

0x80b: Pop(1)
0x80c: Push((int) 0)
0x80d: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x80e: Pop(2)
0x80f: Return(); Pop(4)

0x810: PushEmpty(object, int, bool, object, int, bool)
0x811: @ CreateInvItem(Stack[-3])
0x812: Pop(0)
0x813: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1113
0x814: Pop(0)
0x815: Push("Organ") // @poff=1125
0x816: Push((int) 1)
0x817: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=794
0x818: Pop(2)
0x819: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1137
0x81a: Pop(0)
0x81b: Push((int) 0)
0x81c: Push((int) 1)
0x81d: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x81e: Pop(2)
0x81f: Return(); Pop(6)
...
0x829: Stack[-1] = "liver" // @poff=1147
0x82a: Call2 0x810

0x82b: Pop(1)
0x82c: PushEmpty(string)
0x82d: Stack[-1] = "kidney" // @poff=1159
0x82e: Call2 0x810

0x82f: Pop(1)
0x830: PushEmpty(string)
0x831: Stack[-1] = "heart" // @poff=1173
0x832: Call2 0x810

0x833: Pop(1)
0x834: PushEmpty(string)
0x835: Stack[-1] = "blood" // @poff=1185
0x836: Call2 0x810
...
0x83a: Push((int) 0)
0x83b: @ ClearSubContainer(Stack[-1])
0x83c: Pop(1)
0x83d: PushEmpty(int, int)
0x83e: Stack[-2] = (int) 300
0x83f: Stack[-1] = (int) 750
0x840: Call2 0x7f1

0x841: Pop(2)
0x842: PushEmpty(string, int, int)
0x843: Stack[-3] = "Knife" // @poff=1197
0x844: Stack[-2] = (int) 1
0x845: Stack[-1] = (int) 8
0x846: Call2 0x6e8

0x847: Pop(3)
0x848: PushEmpty(string, int, int)
0x849: Stack[-3] = "lockpick" // @poff=1209
0x84a: Stack[-2] = (int) 1
0x84b: Stack[-1] = (int) 6
0x84c: Call2 0x6e8
...
0x84f: Stack[-1] = "grabitel_mark" // @poff=1227
0x850: Call2 0x857
...
0x868: Pop(1)
0x869: IF (Stack[-1] == 0) GOTO 0x872; Pop(1)

0x86a: PushEmpty()
0x86b: Call2 0x839

0x86c: Pop(0)
0x86d: PushEmpty(bool, object, float)
0x86e: Stack[-4] = Stack[-2]
0x86f: Stack[-1] = (float) 0.029999999329447746
0x870: Call2 0x763
...
0x876: Stack[-2] = Stack[-1]
0x877: Push(-1, 0); TaskCall(5)
0x878: Call2 0x4c0

0x879: Pop(-1, 0); TaskReturn
0x87a: Pop(1)
0x87b: Return(); Pop(0)
...
0x87e: PushEmpty()
0x87f: Stack[-3] = (bool) 0
0x880: Return(); Pop(0)

0x881: PushEmpty()
0x882: PushEmpty(object, int, float)
0x883: Stack[-7] = Stack[-3]
0x884: Stack[-6] = Stack[-2]
0x885: Stack[-5] = Stack[-1]
0x886: Call2 0x680
...
0x889: PushEmpty()
0x88a: PushEmpty(object, int, float, cvector, cvector)
0x88b: Stack[-11] = Stack[-5]
0x88c: Stack[-10] = Stack[-4]
0x88d: Stack[-9] = Stack[-3]
0x88e: Stack[-7] = Stack[-2]
...
0x893: PushEmpty(float, float)
0x894: Push("health") // @poff=806
0x895: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x896: IF (Stack[-1] == 0) GOTO 0x89f; Pop(1)

0x897: Push("health") // @poff=806
...
0x89d: @ SignalDeath(Stack[-4])
0x89e: Pop(0)
0x89f: Return(); Pop(2)

0x8a0: PushEmpty()
0x8a1: PushEmpty(object)
0x8a2: Stack[-2] = Stack[-1]
0x8a3: Call2 0x864
