...
// @pool_raw:
// @pool_encoding:utf8
...
0x27a: Push("Can't find lsh animation : ") // @poff=208
...
0x289: Push("Can't find lsh animation : ") // @poff=208
...
0x2cc: Stack[-2] = Stack[-5]
0x2cd: Return(); Pop(4)

0x2ce: PushEmpty()
0x2cf: Push("b7q02") // @poff=264
0x2d0: Push((int) 2)
...
0x2d7: Stack[-2] = "quest_b7_02" // @poff=276
0x2d8: Stack[-1] = "place_grabitels" // @poff=300
0x2d9: Call2 0x2aa
...
0x2dc: PushEmpty()
0x2dd: Push("oob7Morlok1") // @poff=332
0x2de: Push((int) 1)
...
0x2e4: Stack[-1] = "oob7Morlok1" // @poff=332
0x2e5: Call2 0x2a5
...
0x300: Push("Can't retrieve diary root") // @poff=356
0x301: @ Trace(Stack[-1])
0x302: Pop(1)
...
0x30c: Pop(1)
0x30d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=408
0x30e: Pop(0)
0x30f: Pop(0); Push((bool) Stack[-2] == 0)
0x310: IF (Stack[-1] == 0) GOTO 0x317; Pop(1)

0x311: Push("Can't find diary parent with id: ") // @poff=413
...
0x317: @@ AddChild(Stack[-8]); Obj=2 // @poff=481
0x318: Pop(0)
0x319: Push((int) 7)
0x31a: @ SendWorldWndMessage(Stack[-1])
0x31b: Pop(1)
0x31c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=490
0x31d: Pop(0)
...
0x339: Stack[-1] = "ui/NPC_Morlok.png" // @poff=516
0x33a: Return(); Pop(0)

0x33b: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=552
0x33c: Return(); Pop(0)
