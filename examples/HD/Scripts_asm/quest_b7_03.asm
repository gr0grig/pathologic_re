...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x6: @ Trace(Stack[-3])
0x7: Pop(0)
0x8: Push("place_birdmask") // @poff=0
0x9: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa: IF (Stack[-1] == 0) GOTO 0x18; Pop(1)

0xb: Push("theater") // @poff=30
0xc: @ GetSceneByName(Stack[-2], Stack[-1])
0xd: Pop(1)
0xe: PushEmpty(object, object, string, string, string)
0xf: Stack[-6] = Stack[-4]
0x10: Stack[-3] = "pt_b7q03_birdmask" // @poff=46
0x11: Stack[-2] = "pers_birdmask" // @poff=82
0x12: Stack[-1] = "b7q03_birdmask.xml" // @poff=110
0x13: Call2 0x72
...
0x73: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=238
0x74: Pop(0)
0x75: Pop(0); Push((bool) Stack[-4] == 0)
0x76: IF (Stack[-1] == 0) GOTO 0x7f; Pop(1)

0x77: Push("Locator ") // @poff=249
0x78: Pop(1); Push(Stack[-1] + Stack[-12]);
0x79: Push(" doesn't exist") // @poff=267
