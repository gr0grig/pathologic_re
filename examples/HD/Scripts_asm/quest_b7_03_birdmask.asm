...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b3: Push("Can't find lsh animation : ") // @poff=208
...
0x2c2: Push("Can't find lsh animation : ") // @poff=208
...
0x2d7: Push((float)9.999999974752427e-07)
...
0x2e5: Pop(0)
0x2e6: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x30e: Pop(0)
0x30f: Push("disease") // @poff=276
0x310: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=292
0x311: Pop(1)
0x312: Push((float)0.5)
0x313: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x314: IF (Stack[-1] == 0) GOTO 0x319; Pop(1)

0x315: Push("disease") // @poff=276
0x316: Push((float)0.5)
0x317: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=304
0x318: Pop(2)
0x319: PushEmpty(bool, string, string)
0x31a: Stack[-2] = "quest_b7_03" // @poff=316
0x31b: Stack[-1] = "remove_birdmask" // @poff=340
0x31c: Call2 0x2e3
...
0x31f: PushEmpty()
0x320: Push("b7q03SerumWorks") // @poff=372
0x321: Push((int) 1)
...
0x33c: Push("disease") // @poff=276
0x33d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=292
0x33e: Pop(1)
0x33f: Push((int) 0)
...
0x354: Push("Can't retrieve diary root") // @poff=404
0x355: @ Trace(Stack[-1])
0x356: Pop(1)
...
0x360: Pop(1)
0x361: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=456
0x362: Pop(0)
0x363: Pop(0); Push((bool) Stack[-2] == 0)
0x364: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x365: Push("Can't find diary parent with id: ") // @poff=461
...
0x36b: @@ AddChild(Stack[-8]); Obj=2 // @poff=529
0x36c: Pop(0)
0x36d: Push((int) 7)
0x36e: @ SendWorldWndMessage(Stack[-1])
0x36f: Pop(1)
0x370: @@ GetCategory(Stack[-1]); Obj=8 // @poff=538
0x371: Pop(0)
...
0x38d: Stack[-1] = "ui/NPC_bmask.png" // @poff=564
0x38e: Return(); Pop(0)

0x38f: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=598
0x390: Return(); Pop(0)
