...
// @pool_raw:
// @pool_encoding:utf8
...
0x70: Push((int) 22582)
0x71: Push((int) 22581)
0x72: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x73: Pop(3)
0x74: Push((int) 521406)
0x75: Push((int) -1)
0x76: Push((int) 22584)
0x77: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x78: Pop(3)
0x79: GOTO 0x7c
...
0x8b: Push("all") // @poff=132
0x8c: Push("idle") // @poff=140
...
0x94: Push("all") // @poff=132
0x95: Push("idle") // @poff=140
...
0xea: Stack[-1] = "Grin" // @poff=89
0xeb: Call2 0x9a

0xec: Pop(1)
0xed: Push((int) 521402)
0xee: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xef: Pop(1)
0xf0: @@@ ClearReplies(); Obj=0 // @poff=110
0xf1: Pop(0)
...
0xf8: Push((int) 25181)
0xf9: Push((int) 25179)
0xfa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xfb: Pop(3)
...
0x104: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x105: Pop(3)
0x106: Push((int) 521406)
0x107: Push((int) -1)
0x108: Push((int) 22584)
0x109: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x10a: Pop(3)
0x10b: Return(); Pop(0)
...
0x110: Stack[-1] = "Grin" // @poff=89
0x111: Call2 0x9a

0x112: Pop(1)
0x113: Push((int) 521404)
0x114: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x115: Pop(1)
0x116: @@@ ClearReplies(); Obj=0 // @poff=110
0x117: Pop(0)
0x118: Push((int) 523900)
0x119: Push((int) 25190)
0x11a: Push((int) 25180)
0x11b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x11c: Pop(3)
0x11d: Push((int) 523911)
0x11e: Push((int) 25192)
0x11f: Push((int) 25191)
0x120: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x121: Pop(3)
0x122: Push((int) 523909)
0x123: Push((int) -1)
0x124: Push((int) 25189)
0x125: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x126: Pop(3)
0x127: Return(); Pop(0)
...
0x12c: Stack[-1] = "Sly" // @poff=150
0x12d: Call2 0x9a

0x12e: Pop(1)
0x12f: Push((int) 523912)
0x130: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x131: Pop(1)
0x132: @@@ ClearReplies(); Obj=0 // @poff=110
0x133: Pop(0)
0x134: Push((int) 523913)
0x135: Push((int) 25190)
0x136: Push((int) 25193)
0x137: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x138: Pop(3)
0x139: Return(); Pop(0)
...
0x13e: Stack[-1] = "Grin" // @poff=89
0x13f: Call2 0x9a

0x140: Pop(1)
0x141: Push((int) 523910)
0x142: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x143: Pop(1)
0x144: @@@ ClearReplies(); Obj=0 // @poff=110
0x145: Pop(0)
0x146: Push((int) 523914)
0x147: Push((int) 25196)
0x148: Push((int) 25195)
0x149: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x14a: Pop(3)
0x14b: Return(); Pop(0)
...
0x150: Stack[-1] = "Smile" // @poff=158
0x151: Call2 0x9a

0x152: Pop(1)
0x153: Push((int) 523915)
0x154: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x155: Pop(1)
0x156: @@@ ClearReplies(); Obj=0 // @poff=110
0x157: Pop(0)
0x158: Push((int) 523916)
0x159: Push((int) -1)
0x15a: Push((int) 25197)
0x15b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x15c: Pop(3)
0x15d: Push((int) 523917)
0x15e: Push((int) -1)
0x15f: Push((int) 25198)
0x160: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x161: Pop(3)
0x162: Return(); Pop(0)
...
0x167: Stack[-1] = "Grin" // @poff=89
0x168: Call2 0x9a

0x169: Pop(1)
0x16a: Push((int) 523901)
0x16b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x16c: Pop(1)
0x16d: @@@ ClearReplies(); Obj=0 // @poff=110
0x16e: Pop(0)
0x16f: Push((int) 523902)
0x170: Push((int) 25183)
0x171: Push((int) 25182)
0x172: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x173: Pop(3)
0x174: Return(); Pop(0)
...
0x179: Stack[-1] = "Sly" // @poff=150
0x17a: Call2 0x9a

0x17b: Pop(1)
0x17c: Push((int) 523903)
0x17d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x17e: Pop(1)
0x17f: @@@ ClearReplies(); Obj=0 // @poff=110
0x180: Pop(0)
0x181: Push((int) 523904)
0x182: Push((int) 25185)
0x183: Push((int) 25184)
0x184: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x185: Pop(3)
0x186: Push((int) 523918)
0x187: Push((int) 25200)
0x188: Push((int) 25199)
0x189: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x18a: Pop(3)
0x18b: Return(); Pop(0)
...
0x190: Stack[-1] = "Smile" // @poff=158
0x191: Call2 0x9a

0x192: Pop(1)
0x193: Push((int) 523919)
0x194: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x195: Pop(1)
0x196: @@@ ClearReplies(); Obj=0 // @poff=110
0x197: Pop(0)
0x198: Push((int) 523920)
0x199: Push((int) 25196)
0x19a: Push((int) 25201)
0x19b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x19c: Pop(3)
0x19d: Return(); Pop(0)
...
0x1a2: Stack[-1] = "Sly" // @poff=150
0x1a3: Call2 0x9a

0x1a4: Pop(1)
0x1a5: Push((int) 523905)
0x1a6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1a7: Pop(1)
0x1a8: @@@ ClearReplies(); Obj=0 // @poff=110
0x1a9: Pop(0)
0x1aa: Push((int) 523906)
0x1ab: Push((int) 25187)
0x1ac: Push((int) 25186)
0x1ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1ae: Pop(3)
0x1af: Push((int) 523921)
0x1b0: Push((int) 25204)
0x1b1: Push((int) 25203)
0x1b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1b3: Pop(3)
0x1b4: Return(); Pop(0)
...
0x1b9: Stack[-1] = "Grin" // @poff=89
0x1ba: Call2 0x9a

0x1bb: Pop(1)
0x1bc: Push((int) 523922)
0x1bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1be: Pop(1)
0x1bf: @@@ ClearReplies(); Obj=0 // @poff=110
0x1c0: Pop(0)
0x1c1: Push((int) 523923)
0x1c2: Push((int) 25200)
0x1c3: Push((int) 25205)
0x1c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1c5: Pop(3)
0x1c6: Return(); Pop(0)
...
0x1cb: Stack[-1] = "Grin" // @poff=89
0x1cc: Call2 0x9a

0x1cd: Pop(1)
0x1ce: Push((int) 523907)
0x1cf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1d0: Pop(1)
0x1d1: @@@ ClearReplies(); Obj=0 // @poff=110
0x1d2: Pop(0)
0x1d3: Push((int) 523924)
0x1d4: Push((int) 25208)
0x1d5: Push((int) 25207)
0x1d6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1d7: Pop(3)
0x1d8: Push((int) 523926)
0x1d9: Push((int) 25210)
0x1da: Push((int) 25209)
0x1db: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1dc: Pop(3)
0x1dd: Return(); Pop(0)
...
0x1e2: Stack[-1] = "Grin" // @poff=89
0x1e3: Call2 0x9a

0x1e4: Pop(1)
0x1e5: Push((int) 523927)
0x1e6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1e7: Pop(1)
0x1e8: @@@ ClearReplies(); Obj=0 // @poff=110
0x1e9: Pop(0)
0x1ea: Push((int) 523928)
0x1eb: Push((int) -1)
0x1ec: Push((int) 25211)
0x1ed: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1ee: Pop(3)
0x1ef: Push((int) 523929)
0x1f0: Push((int) -1)
0x1f1: Push((int) 25212)
0x1f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1f3: Pop(3)
0x1f4: Return(); Pop(0)
...
0x1f9: Stack[-1] = "Fear" // @poff=170
0x1fa: Call2 0x9a

0x1fb: Pop(1)
0x1fc: Push((int) 523925)
0x1fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1fe: Pop(1)
0x1ff: @@@ ClearReplies(); Obj=0 // @poff=110
0x200: Pop(0)
0x201: Push((int) 521405)
0x202: Push((int) -1)
0x203: Push((int) 22583)
0x204: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x205: Pop(3)
0x206: Return(); Pop(0)
...
0x25c: Stack[-3] = Stack[-1]
0x25d: Call2 0x353

0x25e: Stack[-2] = Stack[-5]
0x25f: Pop(2)
0x260: Return(); Pop(2)

0x261: Stack[-1] = 0
0x262: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x263: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x264: @ RotateAsync(Stack[-2], Stack[-1])
0x265: Pop(2)
0x266: Return(); Pop(0)

0x267: PushEmpty(object, bool, object, bool)
0x268: Push("player") // @poff=212
...
0x2c5: Stack[-1] = "Neutral" // @poff=226
0x2c6: Call2 0x442
...
0x2d4: Stack[-1] = "Neutral" // @poff=226
0x2d5: Call2 0x442
...
0x2eb: Stack[-1] = "Neutral" // @poff=226
0x2ec: Call2 0x442
...
0x31f: Stack[-3] = (int) 0
0x320: Push("all") // @poff=132
0x321: PushEmpty(string, int)
0x322: Stack[-6] = Stack[-1]
0x323: Call2 0x4a1
...
0x343: Pop(0)
0x344: @@ GetPosition(Stack[-2]); Obj=7 // @poff=242
0x345: Pop(0)
...
0x350: Pop(2)
0x351: Stack[-1] = Stack[-8]
0x352: Return(); Pop(6)

0x353: PushEmpty(cvector, cvector)
0x354: @@ GetPosition(Stack[-1]); Obj=3 // @poff=242
0x355: Pop(0)
...
0x362: @@ GetPosition(Stack[-8]); Obj=20 // @poff=242
0x363: Pop(0)
0x364: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=254
0x365: Pop(0)
...
0x38b: Pop(0)
0x38c: Push((bool) 1)
0x38d: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x38e: Pop(1)
0x38f: Push(CvectorIndex(Stack[-4], 0))
0x390: Push(CvectorIndex(Stack[-5], 2))
0x391: @ Rotate(Stack[-2], Stack[-1])
0x392: Pop(2)
...
0x398: Push("head") // @poff=268
0x399: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x39a: Pop(1)
0x39b: Push(Stack[-1])
0x39c: IF (Stack[-1] == 0) GOTO 0x3a0; Pop(1)

0x39d: Push("head") // @poff=268
0x39e: @ LookAsyncCamera(Stack[-1])
0x39f: Pop(1)
0x3a0: @ CameraWaitForPlayFinish()
0x3a1: Pop(0)
0x3a2: @ ResumeWorld()
0x3a3: Pop(0)
0x3a4: Stack[-21] = (bool) 1
0x3a5: Return(); Pop(18)

0x3a6: PushEmpty(bool, bool)
0x3a7: Push((bool) 1)
0x3a8: @ CameraSwitchToNormal(Stack[-1])
0x3a9: Pop(1)
...
0x3af: Push("head") // @poff=268
0x3b0: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3b1: Pop(1)
0x3b2: Push(Stack[-1])
0x3b3: IF (Stack[-1] == 0) GOTO 0x3b7; Pop(1)

0x3b4: Push("head") // @poff=268
0x3b5: @ UnlookAsync(Stack[-1])
0x3b6: Pop(1)
0x3b7: Return(); Pop(2)

0x3b8: PushEmpty(int, int, int, int)
0x3b9: Push("voice_common") // @poff=278
0x3ba: @ GetVariable(Stack[-1], Stack[-3])
0x3bb: Pop(1)
0x3bc: Push(Stack[-2])
0x3bd: IF (Stack[-1] == 0) GOTO 0x3de; Pop(1)

0x3be: PushEmpty(bool, object)
0x3bf: Stack[-7] = Stack[-1]
0x3c0: Call2 0x3f2
...
0x3ca: Stack[-6] = (bool) 0
0x3cb: Return(); Pop(4)

0x3cc: Push((int) 2)
0x3cd: @ irand(Stack[-2], Stack[-1])
0x3ce: Pop(1)
0x3cf: Push(Stack[-1])
0x3d0: IF (Stack[-1] == 0) GOTO 0x3d9; Pop(1)

0x3d1: Push("voice_common") // @poff=278
0x3d2: Push((int) 1)
0x3d3: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3d4: Push((int) 3)
...
0x3d9: Push("voice_common") // @poff=278
0x3da: Push((int) 0)
0x3db: @ SetVariable(Stack[-2], Stack[-1])
0x3dc: Pop(2)
0x3dd: GOTO 0x3f0

0x3de: PushEmpty(bool, object)
0x3df: Stack[-7] = Stack[-1]
0x3e0: Call2 0x417
...
0x3ea: Stack[-6] = (bool) 0
0x3eb: Return(); Pop(4)

0x3ec: Push("voice_common") // @poff=278
0x3ed: Push((int) 1)
...
0x3f2: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3f3: Stack[-5] = "c" // @poff=304
0x3f4: Stack[-4] = (int) 0
0x3f5: Push((int) 1)
...
0x3fa: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=308
0x3fb: Pop(1)
...
0x40f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=320
0x410: Pop(1)
0x411: PushEmpty(bool, string)
0x412: Stack[-3] = Stack[-1]
0x413: Call2 0x461

0x414: Stack[-2] = Stack[-14]
0x415: Pop(2)
0x416: Return(); Pop(10)

0x417: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x418: Push("d") // @poff=274
0x419: PushEmpty(int)
0x41a: Call2 0x498

0x41b: Pop(0)
0x41c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x41d: Push("m") // @poff=332
0x41e: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x41f: Stack[-4] = (int) 0
0x420: Push((int) 1)
0x421: IF (Stack[-1] == 0) GOTO 0x42d; Pop(1)

0x422: Push((int) 1)
0x423: Pop(1); Push(Stack[-5] + Stack[-1]);
0x424: Pop(1); Push(Stack[-6] + Stack[-1]);
0x425: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=308
0x426: Pop(1)
...
0x42a: Push((int) 1)
0x42b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x42c: GOTO 0x420

0x42d: Pop(0); Push((bool) Stack[-4] == 0)
...
0x431: Stack[-2] = (int) 0
0x432: Push((int) 1)
0x433: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x434: IF (Stack[-1] == 0) GOTO 0x437; Pop(1)

0x435: @ irand(Stack[-2], Stack[-4])
0x436: Pop(0)
0x437: Push((int) 1)
0x438: Pop(1); Push(Stack[-3] + Stack[-1]);
0x439: Pop(1); Push(Stack[-6] + Stack[-1]);
0x43a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=320
0x43b: Pop(1)
0x43c: PushEmpty(bool, string)
0x43d: Stack[-3] = Stack[-1]
0x43e: Call2 0x461

0x43f: Stack[-2] = Stack[-14]
0x440: Pop(2)
0x441: Return(); Pop(10)

0x442: PushEmpty(bool, float, float, bool, float, float)
0x443: @ lshHasAnimation(Stack[-3], Stack[-7])
0x444: Pop(0)
0x445: Push(Stack[-3])
0x446: IF (Stack[-1] == 0) GOTO 0x44d; Pop(1)

0x447: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x448: Pop(0)
0x449: Push((bool) 0)
...
0x44d: Push("Can't find lsh animation : ") // @poff=336
0x44e: Pop(1); Push(Stack[-1] + Stack[-8]);
0x44f: @ Trace(Stack[-1])
0x450: Pop(1)
0x451: Return(); Pop(6)

0x452: PushEmpty(bool, float, float, bool, float, float)
0x453: @ lshHasAnimation(Stack[-3], Stack[-8])
0x454: Pop(0)
0x455: Push(Stack[-3])
0x456: IF (Stack[-1] == 0) GOTO 0x45c; Pop(1)

0x457: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x458: Pop(0)
0x459: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x45a: Pop(0)
0x45b: GOTO 0x460

0x45c: Push("Can't find lsh animation : ") // @poff=336
0x45d: Pop(1); Push(Stack[-1] + Stack[-9]);
0x45e: @ Trace(Stack[-1])
0x45f: Pop(1)
0x460: Return(); Pop(6)
...
0x466: @ lshHasSpeech(Stack[-1], Stack[-3])
0x467: Pop(0)
0x468: Push(Stack[-1])
0x469: IF (Stack[-1] == 0) GOTO 0x46e; Pop(1)

0x46a: @ lshPlaySpeech(Stack[-3])
0x46b: Pop(0)
0x46c: Stack[-4] = (bool) 1
0x46d: Return(); Pop(2)

0x46e: Stack[-4] = (bool) 0
0x46f: Return(); Pop(2)
...
0x47c: Stack[-1] = 0
0x47d: PushEmpty(float, float)
0x47e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x47f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x480: Push((float)9.999999974752427e-07)
0x481: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x482: IF (Stack[-1] == 0) GOTO 0x485; Pop(1)

0x483: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x484: Return(); Pop(2)

0x485: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x486: Return(); Pop(2)

0x487: PushEmpty(int, int)
0x488: @ GetVariable(Stack[-3], Stack[-1])
0x489: Pop(0)
0x48a: Stack[-1] = Stack[-4]
0x48b: Return(); Pop(2)

0x48c: PushEmpty(object, object)
0x48d: @ FindActor(Stack[-1], Stack[-4])
0x48e: Pop(0)
0x48f: Pop(0); PushNull((bool) Stack[-1] == 0)
0x490: IF (Stack[-1] == 0) GOTO 0x493; Pop(1)

0x491: Stack[-5] = (bool) 0
0x492: Return(); Pop(2)

0x493: @ Trigger(Stack[-1], Stack[-3])
0x494: Pop(0)
0x495: Stack[-5] = (bool) 1
0x496: Return(); Pop(2)

0x497: Stack[-1] = 0
0x498: PushEmpty(float, float)
0x499: @ GetGameTime(Stack[-1])
0x49a: Pop(0)
0x49b: Push((int) 1)
0x49c: PushEmpty(int)
0x49d: Push((int) 24)
0x49e: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x49f: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x4a0: Return(); Pop(2)

0x4a1: PushEmpty(string, string)
0x4a2: Stack[-1] = "idle" // @poff=140
0x4a3: Push(Stack[-3])
0x4a4: IF (Stack[-1] == 0) GOTO 0x4a6; Pop(1)

0x4a5: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x4a6: Stack[-1] = Stack[-4]
0x4a7: Return(); Pop(2)

0x4a8: PushEmpty(int, bool, int, bool)
0x4a9: Stack[-2] = (int) 0
0x4aa: Push("all") // @poff=132
0x4ab: PushEmpty(string, int)
0x4ac: Stack[-5] = Stack[-1]
0x4ad: Call2 0x4a1

0x4ae: Pop(1)
0x4af: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x4b0: Pop(2)
...
0x4b4: Push((int) 1)
0x4b5: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x4b6: GOTO 0x4aa

0x4b7: Stack[-2] = Stack[-5]
0x4b8: Return(); Pop(4)

0x4b9: PushEmpty()
0x4ba: Push("b8q01") // @poff=392
0x4bb: Push((int) 3)
...
0x4c5: Pop(0)
0x4c6: PushEmpty(bool, string, string)
0x4c7: Stack[-2] = "quest_b8_01" // @poff=404
0x4c8: Stack[-1] = "fail" // @poff=428
0x4c9: Call2 0x48c
...
0x4cc: PushEmpty()
0x4cd: PushEmpty(int, string)
0x4ce: Stack[-1] = "b8q01" // @poff=392
0x4cf: Call2 0x487
...
0x4d4: Stack[-2] = (bool) 1
0x4d5: Return(); Pop(0)

0x4d6: Stack[-2] = (bool) 0
0x4d7: Return(); Pop(0)

0x4d8: PushEmpty(object, object)
0x4d9: Push((int) 693)
0x4da: Push((int) 1)
0x4db: Push((int) 535229)
0x4dc: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x4dd: Pop(3)
0x4de: PushEmpty(bool, object, int)
0x4df: Stack[-4] = Stack[-2]
0x4e0: Stack[-1] = (int) 284
0x4e1: Call2 0x4ff
...
0x4e6: Push((int) 287)
0x4e7: Push((int) 1)
0x4e8: Push((int) 521458)
0x4e9: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x4ea: Pop(3)
0x4eb: PushEmpty(bool, object, int)
0x4ec: Stack[-4] = Stack[-2]
0x4ed: Stack[-1] = (int) 284
0x4ee: Call2 0x4ff
...
0x4f3: @ GetDiaryRoot(Stack[-1])
0x4f4: Pop(0)
0x4f5: Pop(0); Push((bool) Stack[-1] == 0)
0x4f6: IF (Stack[-1] == 0) GOTO 0x4fc; Pop(1)

0x4f7: Push("Can't retrieve diary root") // @poff=438
0x4f8: @ Trace(Stack[-1])
0x4f9: Pop(1)
0x4fa: Stack[-3] = (bool) 0
0x4fb: Return(); Pop(2)

0x4fc: Stack[-1] = Stack[-3]
0x4fd: Return(); Pop(2)

0x4fe: Stack[-1] = 0
0x4ff: PushEmpty(object, object, int, object, object, int)
0x500: PushEmpty(object)
0x501: Call2 0x4f2

0x502: Stack[-1] = Stack[-4]
0x503: Pop(1)
0x504: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=490
0x505: Pop(0)
0x506: Pop(0); Push((bool) Stack[-2] == 0)
0x507: IF (Stack[-1] == 0) GOTO 0x50e; Pop(1)

0x508: Push("Can't find diary parent with id: ") // @poff=495
0x509: Pop(1); Push(Stack[-1] + Stack[-8]);
0x50a: @ Trace(Stack[-1])
0x50b: Pop(1)
0x50c: Stack[-9] = (bool) 0
0x50d: Return(); Pop(6)

0x50e: @@ AddChild(Stack[-8]); Obj=2 // @poff=563
0x50f: Pop(0)
0x510: Push((int) 7)
0x511: @ SendWorldWndMessage(Stack[-1])
0x512: Pop(1)
0x513: @@ GetCategory(Stack[-1]); Obj=8 // @poff=572
0x514: Pop(0)
0x515: @ SetDiarySection(Stack[-1])
0x516: Pop(0)
...
0x51c: Push("branch") // @poff=584
0x51d: @ GetVariable(Stack[-1], Stack[-2])
0x51e: Pop(1)
0x51f: Push((int) 0)
...
0x525: Push((int) 1)
0x526: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x52c: Stack[-1] = (int) 515540
0x52d: Return(); Pop(0)

0x52e: Stack[-1] = (int) 502865
0x52f: Return(); Pop(0)

0x530: Stack[-1] = "ui/NPC_Klara.png" // @poff=598
0x531: Return(); Pop(0)

0x532: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=632
0x533: Return(); Pop(0)
