...
Strings:
	...
	W:Rifle
	W:grabitel_mark
// @pool_raw:
...
Events:
EVENT_22 Op = 0xbd1 Vars = (object, int, float, float)
EVENT_43 Op = 0xbd9 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xbe3 Vars = (object, string)
EVENT_41 Op = 0xbf0 Vars = (object)
EVENT_6 Op = 0xc9b Vars = ()
...
0x47b: Push((int) 130)
0x47c: Push((float)0.30000001192092896)
...
0x49e: Pop(0)
0x49f: Push((float)0.20000000298023224)
...
0x4b6: Push((int) 130)
0x4b7: Push((float)0.30000001192092896)
...
0x4e2: Stack[-6] = Stack[-2]
0x4e3: Stack[-5] = Stack[-1]
0x4e4: Call2 0xb9e
...
0x570: Stack[-6] = Stack[-2]
0x571: Stack[-5] = Stack[-1]
0x572: Call2 0xb9e
...
0x59c: Pop(0)
0x59d: Push("all") // @poff=0
0x59e: PushEmpty(string, int)
0x59f: Stack[-7] = Stack[-1]
0x5a0: Call2 0xac4
...
0x609: Stack[-6] = Stack[-2]
0x60a: Stack[-5] = Stack[-1]
0x60b: Call2 0xb9e
...
0x631: Push("all") // @poff=0
0x632: Push("hunt") // @poff=560
...
0x666: Stack[-17] = Stack[-7]
0x667: PushEmpty(bool, object)
0x668: Stack[-23] = Stack[-1]
0x669: Call2 0x63d
...
0x66f: @@ GetPosition(Stack[-5]); Obj=21 // @poff=176
0x670: Pop(0)
...
0x686: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=334
0x687: Pop(0)
...
0x698: Push((int) 0)
0x699: Push((float)0.30000001192092896)
...
0x6bb: Push((int) 0)
0x6bc: Push((float)0.30000001192092896)
...
0x6e6: Stack[-1] = "walk" // @poff=542
0x6e7: Return(); Pop(0)

0x6e8: Stack[-1] = "run" // @poff=552
0x6e9: Return(); Pop(0)
...
0x6f6: Stack[-3] = Stack[-1]
0x6f7: Call2 0x6fb

0x6f8: Stack[-2] = Stack[-4]
0x6f9: Pop(2)
0x6fa: Return(); Pop(0)

0x6fb: PushEmpty(float, float)
0x6fc: PushEmpty(bool, object)
0x6fd: Stack[-5] = Stack[-1]
0x6fe: Call2 0x89f
...
0x707: Stack[-2] = Stack[-3]
0x708: Pop(2)
0x709: PushEmpty(bool, float, float, float)
0x70a: Stack[-5] = Stack[-3]
...
0x72d: Stack[-4] = Stack[-2]
0x72e: Stack[-1] = (float) 0.009999999776482582
0x72f: Call2 0xa6c
...
0x750: Pop(0); PushNull((bool) Stack[-21] == 0)
0x751: IF (Stack[-1] == 0) GOTO 0x757; Pop(1)

0x752: PushEmpty(string)
0x753: Stack[-1] = "fdie" // @poff=570
0x754: Call2 0x7aa

0x755: Pop(1)
0x756: GOTO 0x7a9

0x757: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x758: Pop(0)
...
0x768: Stack[-6] = "fdie" // @poff=570
0x769: GOTO 0x76b

0x76a: Stack[-6] = "bdie" // @poff=580
...
0x771: @ StopAsync()
0x772: Pop(0)
0x773: Stack[-21] = Stack[-5]
0x774: Push("GetScriptProperty") // @poff=590
0x775: Push((int) 2)
0x776: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x777: IF (Stack[-1] == 0) GOTO 0x783; Pop(1)

0x778: Push("Owner") // @poff=132
0x779: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=626
0x77a: Pop(1)
0x77b: Push(Stack[-4])
0x77c: IF (Stack[-1] == 0) GOTO 0x783; Pop(1)

0x77d: Push("Owner") // @poff=132
0x77e: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=644
0x77f: Pop(1)
0x780: Pop(0); PushNull((bool) Stack[-5] == 0)
0x781: IF (Stack[-1] == 0) GOTO 0x783; Pop(1)

0x782: Stack[-21] = Stack[-5]
0x783: Push("@GetEyesHeight") // @poff=662
0x784: Push((int) 1)
0x785: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x786: IF (Stack[-1] == 0) GOTO 0x792; Pop(1)

0x787: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x788: Pop(0)
0x789: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x78a: Push(CvectorIndex(Stack[-1], 1))
0x78b: Stack[-3] = Stack[-1]
0x78c: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x78d: Push("head") // @poff=532
...
0x794: Stack[-7] = Stack[-1]
0x795: Call2 0x99f

0x796: Pop(1)
0x797: Push("all") // @poff=0
...
0x79e: @ StopAsync()
0x79f: Pop(0)
0x7a0: Push("head") // @poff=532
0x7a1: @ UnlookAsync(Stack[-1])
0x7a2: Pop(1)
0x7a3: Push("all") // @poff=0
...
0x7d4: Stack[-2] = "bullet" // @poff=702
0x7d5: Return(); Pop(0)

0x7d6: Stack[-2] = "phys" // @poff=716
0x7d7: Return(); Pop(0)

0x7d8: PushEmpty(cvector, cvector, cvector, cvector)
0x7d9: @ GetPosition(Stack[-2])
0x7da: Pop(0)
0x7db: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x7dc: Pop(0)
...
0x7e1: Pop(0)
0x7e2: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x7e3: Pop(0)
...
0x7e9: Pop(0)
0x7ea: Stack[-1] = Stack[-4]
0x7eb: Return(); Pop(2)

0x7ec: PushEmpty(bool, bool)
0x7ed: Push("HasProperty") // @poff=726
0x7ee: Push((int) 2)
...
0x7f4: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=750
0x7f5: Pop(0)
0x7f6: Stack[-1] = Stack[-5]
0x7f7: Return(); Pop(2)

0x7f8: PushEmpty(float, float)
0x7f9: PushEmpty(bool, object, string)
0x7fa: Stack[-10] = Stack[-2]
0x7fb: Stack[-9] = Stack[-1]
0x7fc: Call2 0x7ec
...
0x802: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=762
0x803: Pop(0)
0x804: PushEmpty(float, float, float, float)
0x805: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x806: Stack[-8] = Stack[-2]
0x807: Stack[-7] = Stack[-1]
0x808: Call2 0xa4e

0x809: Pop(3)
0x80a: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=774
0x80b: Pop(1)
...
0x819: Stack[-18] = Stack[-2]
0x81a: Stack[-1] = "armor" // @poff=800
0x81b: Call2 0x7ec
...
0x821: Push("armor") // @poff=800
0x822: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=762
0x823: Pop(1)
0x824: Push("armor_") // @poff=812
0x825: PushEmpty(string, int)
0x826: Stack[-16] = Stack[-1]
0x827: Call2 0x7ca
...
0x833: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=762
0x834: Pop(0)
...
0x83b: Stack[-3] = Stack[-6]
0x83c: Pop(3)
0x83d: Push("health") // @poff=786
0x83e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=762
0x83f: Pop(1)
0x840: Push((int) 1)
0x841: Pop(1); Push(Stack[-1] - Stack[-4]);
0x842: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x843: Push("health") // @poff=786
...
0x849: Pop(3)
0x84a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=774
0x84b: Pop(2)
0x84c: PushEmpty(bool, object)
0x84d: Stack[-17] = Stack[-1]
0x84e: Call2 0x7e7
...
0x870: Push("health") // @poff=786
0x871: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=762
0x872: Pop(1)
...
0x877: @@ IsDead(Stack[-1]); Obj=3 // @poff=826
0x878: Pop(0)
0x879: Stack[-1] = Stack[-4]
0x87a: Return(); Pop(2)

0x87b: PushEmpty(object, object, object, object)
0x87c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x890: Pop(0)
0x891: Pop(0); PushNull((bool) Stack[-2] == 0)
0x892: IF (Stack[-1] == 0) GOTO 0x895; Pop(1)

0x893: Stack[-6] = (bool) 0
0x894: Return(); Pop(4)

0x895: @@ GetScene(Stack[-1]); Obj=5 // @poff=847
0x896: Pop(0)
...
0x8a9: Stack[-6] = Stack[-2]
0x8aa: Stack[-1] = "noaccess" // @poff=856
0x8ab: Call2 0x7ec
...
0x8b1: Push("noaccess") // @poff=856
0x8b2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=762
0x8b3: Pop(1)
0x8b4: Push((int) 0)
...
0x8b8: Pop(0); PushNull((bool) Stack[-7] == 0)
...
0x8bd: Pop(0)
0x8be: Pop(0); PushNull((bool) Stack[-3] == 0)
0x8bf: IF (Stack[-1] == 0) GOTO 0x8c2; Pop(1)

0x8c0: Stack[-8] = (bool) 0
0x8c1: Return(); Pop(6)

0x8c2: @@ GetScene(Stack[-2]); Obj=7 // @poff=847
0x8c3: Pop(0)
...
0x8c9: Stack[-10] = Stack[-2]
0x8ca: Stack[-1] = "noaccess" // @poff=856
0x8cb: Call2 0x7ec
...
0x8d1: Push("noaccess") // @poff=856
0x8d2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=762
0x8d3: Pop(1)
0x8d4: Push((int) 0)
...
0x8fb: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x8fc: Pop(0)
...
0x90c: Stack[-1] = "fhit" // @poff=874
0x90d: GOTO 0x90f

0x90e: Stack[-1] = "bhit" // @poff=884
0x90f: Push("hit_react") // @poff=894
0x910: Push("1") // @poff=34
0x911: Pop(1); Push(Stack[-3] + Stack[-1]);
0x912: Push("2") // @poff=914
...
0x92b: Stack[-25] = Stack[-1]
0x92c: Call2 0x7d8

0x92d: Stack[-2] = Stack[-3]
0x92e: Pop(2)
0x92f: Call2 0xa25

0x930: Stack[-2] = Stack[-11]
0x931: Pop(2)
0x932: @ CreateVectorVector(Stack[-8])
0x933: Pop(0)
0x934: Stack[-7] = (int) 1
0x935: Push("hit") // @poff=876
...
0x94a: Pop(0)
0x94b: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=927
0x94c: Pop(0)
0x94d: PushEmpty(object, int, float, cvector, cvector)
0x94e: Stack[-26] = Stack[-5]
0x94f: Stack[-25] = Stack[-4]
0x950: Stack[-24] = Stack[-3]
0x951: Stack[-6] = Stack[-2]
...
0x96b: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x96c: Pop(0)
...
0x977: Pop(0)
0x978: Stack[-1] = Stack[-3]
0x979: Return(); Pop(2)

0x97a: PushEmpty(float, cvector, float, cvector)
0x97b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x97c: Pop(0)
...
0x987: Stack[-7] = Stack[-2]
0x988: Stack[-6] = Stack[-1]
0x989: Call2 0xa61
...
0x992: Stack[-10] = Stack[-2]
0x993: Stack[-9] = Stack[-1]
0x994: Call2 0xa61
...
0x9e0: Push("woman") // @poff=959
0x9e1: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x9e2: IF (Stack[-1] == 1) GOTO 0x9e7; Pop(1)

0x9e3: Push("worker") // @poff=971
0x9e4: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x9e5: IF (Stack[-1] == 1) GOTO 0x9e7; Pop(1)

0x9e6: Stack[-1] = (bool) 0
0x9e7: IF (Stack[-1] == 1) GOTO 0x9ec; Pop(1)

0x9e8: Push("butcher") // @poff=985
0x9e9: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x9ea: IF (Stack[-1] == 1) GOTO 0x9ec; Pop(1)

0x9eb: Stack[-1] = (bool) 0
0x9ec: IF (Stack[-1] == 1) GOTO 0x9f1; Pop(1)

0x9ed: Push("wasted_girl") // @poff=1001
0x9ee: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x9ef: IF (Stack[-1] == 1) GOTO 0x9f1; Pop(1)

0x9f0: Stack[-1] = (bool) 0
0x9f1: IF (Stack[-1] == 1) GOTO 0x9f6; Pop(1)

0x9f2: Push("boy") // @poff=1025
0x9f3: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x9f4: IF (Stack[-1] == 1) GOTO 0x9f6; Pop(1)

0x9f5: Stack[-1] = (bool) 0
0x9f6: IF (Stack[-1] == 1) GOTO 0x9fb; Pop(1)

0x9f7: Push("vaxxabitka") // @poff=1033
0x9f8: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x9f9: IF (Stack[-1] == 1) GOTO 0x9fb; Pop(1)

0x9fa: Stack[-1] = (bool) 0
0x9fb: IF (Stack[-1] == 1) GOTO 0xa00; Pop(1)

0x9fc: Push("unosha") // @poff=1055
0x9fd: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x9fe: IF (Stack[-1] == 1) GOTO 0xa00; Pop(1)

0x9ff: Stack[-1] = (bool) 0
0xa00: IF (Stack[-1] == 1) GOTO 0xa05; Pop(1)

0xa01: Push("wasted_male") // @poff=1069
0xa02: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xa03: IF (Stack[-1] == 1) GOTO 0xa05; Pop(1)

0xa04: Stack[-1] = (bool) 0
0xa05: IF (Stack[-1] == 1) GOTO 0xa0a; Pop(1)

0xa06: Push("alkash") // @poff=1093
0xa07: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0xa08: IF (Stack[-1] == 1) GOTO 0xa0a; Pop(1)

0xa09: Stack[-1] = (bool) 0
0xa0a: IF (Stack[-1] == 1) GOTO 0xa0f; Pop(1)

0xa0b: Push("dohodyaga") // @poff=1107
0xa0c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xa0d: IF (Stack[-1] == 1) GOTO 0xa0f; Pop(1)

0xa0e: Stack[-1] = (bool) 0
0xa0f: IF (Stack[-1] == 1) GOTO 0xa14; Pop(1)

0xa10: Push("vaxxabit") // @poff=1127
0xa11: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa12: IF (Stack[-1] == 1) GOTO 0xa14; Pop(1)

0xa13: Stack[-1] = (bool) 0
0xa14: IF (Stack[-1] == 1) GOTO 0xa19; Pop(1)

0xa15: Push("nudegirl") // @poff=1145
0xa16: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xa17: IF (Stack[-1] == 1) GOTO 0xa19; Pop(1)

0xa18: Stack[-1] = (bool) 0
0xa19: IF (Stack[-1] == 1) GOTO 0xa1e; Pop(1)

0xa1a: Push("morlok") // @poff=1163
...
0xa28: Push((float)9.999999974752427e-07)
...
0xa82: Stack[-2] = Stack[-1]
0xa83: Call2 0xaa0

0xa84: Pop(1)
0xa85: PushEmpty(bool, object, string, float, float, float)
0xa86: Stack[-8] = Stack[-5]
0xa87: Stack[-4] = "reputation" // @poff=1177
0xa88: Stack[-7] = Stack[-3]
0xa89: Stack[-2] = (int) 0
0xa8a: Stack[-1] = (int) 1
0xa8b: Call2 0x7f8
...
0xa91: Pop(0)
0xa92: @@ add(Stack[-3]); Obj=1 // @poff=918
0xa93: Pop(0)
0xa94: Push((int) 0)
0xa95: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0xa96: IF (Stack[-1] == 0) GOTO 0xa9b; Pop(1)

0xa97: Push((float)0.699999988079071)
0xa98: Push((int) 500)
0xa99: @ RumblePlay(Stack[-2], Stack[-1])
0xa9a: Pop(2)
0xa9b: Push((int) 15)
0xa9c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xa9d: Pop(1)
0xa9e: Return(); Pop(2)

0xa9f: Stack[-1] = 0
0xaa0: PushEmpty(object, object)
0xaa1: @ CreateFloatVector(Stack[-1])
0xaa2: Pop(0)
0xaa3: @@ add(Stack[-3]); Obj=1 // @poff=918
0xaa4: Pop(0)
0xaa5: Push((int) 16)
0xaa6: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xaa7: Pop(1)
0xaa8: Return(); Pop(2)

0xaa9: Stack[-1] = 0
0xaaa: PushEmpty(bool, bool)
0xaab: @ IsPlayerActor(Stack[-3], Stack[-1])
0xaac: Pop(0)
0xaad: Push(Stack[-1])
0xaae: IF (Stack[-1] == 0) GOTO 0xab2; Pop(1)

0xaaf: Push("attack") // @poff=320
0xab0: @ PlayGlobalMusic(Stack[-1])
0xab1: Pop(1)
0xab2: Return(); Pop(2)

0xab3: PushEmpty(object, object)
0xab4: @ GetScene(Stack[-1])
0xab5: Pop(0)
0xab6: Push("battle") // @poff=1199
0xab7: PushEmpty(object)
0xab8: Call2 0xa1f

0xab9: Pop(0)
0xaba: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0xabb: Pop(2)
0xabc: Return(); Pop(2)

0xabd: Stack[-1] = 0
0xabe: PushEmpty(bool, bool)
0xabf: Push("god_mode") // @poff=1213
0xac0: @ GetVariable(Stack[-1], Stack[-2])
0xac1: Pop(1)
0xac2: Stack[-1] = Stack[-3]
0xac3: Return(); Pop(2)

0xac4: PushEmpty(string, string)
0xac5: Stack[-1] = "idle" // @poff=1231
0xac6: Push(Stack[-3])
0xac7: IF (Stack[-1] == 0) GOTO 0xac9; Pop(1)

0xac8: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xac9: Stack[-1] = Stack[-4]
0xaca: Return(); Pop(2)

0xacb: PushEmpty(int, bool, int, bool)
0xacc: Stack[-2] = (int) 0
0xacd: Push("all") // @poff=0
0xace: PushEmpty(string, int)
0xacf: Stack[-5] = Stack[-1]
0xad0: Call2 0xac4

0xad1: Pop(1)
0xad2: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xad3: Pop(2)
...
0xad7: Push((int) 1)
0xad8: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xad9: GOTO 0xacd

0xada: Stack[-2] = Stack[-5]
0xadb: Return(); Pop(4)

0xadc: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0xadd: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0xade: Stack[-5] = (int) 250000
0xadf: Push(CvectorIndex(Stack[-6], 1))
0xae0: Push((int) 1000)
0xae1: Pop(2); Push(Stack[-2] * Stack[-1]);
0xae2: Pop(0); Push(Stack[-14] * Stack[-14]);
0xae3: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0xae4: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0xae5: PushEmpty(float, float, float, float)
0xae6: Stack[-9] = Stack[-3]
0xae7: Stack[-8] = Stack[-2]
0xae8: Stack[-7] = Stack[-1]
0xae9: Call2 0xa36

0xaea: Stack[-4] = Stack[-6]
0xaeb: Pop(4)
0xaec: Push((int) 0)
...
0xaf1: PushEmpty(float, float, float, float, float)
0xaf2: Stack[-10] = Stack[-4]
0xaf3: Stack[-9] = Stack[-3]
0xaf4: Stack[-8] = Stack[-2]
0xaf5: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0xaf6: Call2 0xa3d

0xaf7: Pop(4)
0xaf8: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xaf9: Push(CVector(0.0, 500.0, 0.0))
0xafa: Pop(1); Push(Stack[-1] * Stack[-2]);
0xafb: Pop(1); Push(Stack[-1] * Stack[-2]);
0xafc: Pop(1); Push(Stack[-7] + Stack[-1]);
0xafd: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0xafe: Return(); Pop(12)

0xaff: PushEmpty(string, string, string, string)
0xb00: PushEmpty(bool, object, string)
0xb01: Stack[-8] = Stack[-2]
0xb02: Stack[-1] = "class" // @poff=1241
0xb03: Call2 0x7ec

0xb04: Pop(2)
0xb05: Pop(1); Push((bool) Stack[-1] == 0)
0xb06: IF (Stack[-1] == 0) GOTO 0xb09; Pop(1)

0xb07: Stack[-6] = (bool) 0
0xb08: Return(); Pop(4)

0xb09: Push("class") // @poff=1241
0xb0a: @ GetProperty(Stack[-1], Stack[-3])
0xb0b: Pop(1)
0xb0c: Push("class") // @poff=1241
0xb0d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=762
0xb0e: Pop(1)
0xb0f: Stack[-6] = Stack[-1] == Stack[-2]; Pop(0);
0xb10: Return(); Pop(4)

0xb11: Push(GlobalVars[1])
0xb12: PushEmpty(object)
0xb13: Call2 0xa66

0xb14: Stack[-1] = Stack[-2]
0xb15: Pop(1)
0xb16: GlobalVars[1] = Stack[-1]; Pop(1)
0xb17: Return(); Pop(0)

0xb18: PushEmpty(bool, float, string, bool, float, string)
0xb19: PushEmpty(bool, object)
0xb1a: Stack[-9] = Stack[-1]
0xb1b: Call2 0x89f
...
0xb1f: Stack[-8] = (bool) 0
0xb20: Return(); Pop(6)

0xb21: Push(GlobalVars[1])
0xb22: @@ in(Stack[-4], Stack[-8]); Obj=1 // @poff=1253
0xb23: Pop(1)
0xb24: Push(Stack[-3])
0xb25: IF (Stack[-1] == 0) GOTO 0xb28; Pop(1)

0xb26: Stack[-8] = (bool) 1
0xb27: Return(); Pop(6)

0xb28: PushEmpty(bool, object)
0xb29: Stack[-9] = Stack[-1]
0xb2a: Call2 0x7e7

0xb2b: Pop(1)
0xb2c: IF (Stack[-1] == 0) GOTO 0xb33; Pop(1)

0xb2d: Push("reputation") // @poff=1177
0xb2e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=762
0xb2f: Pop(1)
0xb30: Push((float)0.33000001311302185)
0xb31: Stack[-9] = Stack[-3] >= Stack[-1]; Pop(1);
0xb32: Return(); Pop(6)

0xb33: PushEmpty(bool, object, string)
0xb34: Stack[-10] = Stack[-2]
0xb35: Stack[-1] = "class" // @poff=1241
0xb36: Call2 0x7ec

0xb37: Pop(2)
0xb38: Pop(1); Push((bool) Stack[-1] == 0)
0xb39: IF (Stack[-1] == 0) GOTO 0xb3c; Pop(1)

0xb3a: Stack[-8] = (bool) 0
0xb3b: Return(); Pop(6)

0xb3c: Push("class") // @poff=1241
0xb3d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=762
0xb3e: Pop(1)
0xb3f: PushEmpty(bool, string)
0xb40: Stack[-3] = Stack[-1]
0xb41: Call2 0x9c8

0xb42: Stack[-2] = Stack[-10]
0xb43: Pop(2)
0xb44: Return(); Pop(6)

0xb45: PushEmpty()
0xb46: PushEmpty(bool, object)
0xb47: Stack[-3] = Stack[-1]
0xb48: Call2 0xb18

0xb49: Stack[-2] = Stack[-4]
0xb4a: Pop(2)
0xb4b: Return(); Pop(0)
...
0xb4f: Push(-2, 0); TaskCall(7)
0xb50: Call2 0x6ea

0xb51: Pop(-2, 0); TaskReturn
0xb52: Pop(1)
0xb53: IF (Stack[-1] == 0) GOTO 0xb5a; Pop(1)

0xb54: PushEmpty(object)
0xb55: Stack[-2] = Stack[-1]
0xb56: Push(-1, 3); TaskCall(6)
0xb57: Call2 0x613

0xb58: Pop(-1, 3); TaskReturn
0xb59: Pop(1)
0xb5a: @ ResetAAS()
0xb5b: Pop(0)
0xb5c: Return(); Pop(0)
...
0xb5f: Stack[-3] = Stack[-1]
0xb60: Call2 0xb18

0xb61: Stack[-2] = Stack[-4]
0xb62: Pop(2)
0xb63: Return(); Pop(0)

0xb64: PushEmpty()
0xb65: PushEmpty(bool, object)
0xb66: Stack[-3] = Stack[-1]
0xb67: Push(-2, 0); TaskCall(7)
0xb68: Call2 0x6ea

0xb69: Pop(-2, 0); TaskReturn
0xb6a: Pop(1)
0xb6b: IF (Stack[-1] == 0) GOTO 0xb72; Pop(1)

0xb6c: PushEmpty(object)
0xb6d: Stack[-2] = Stack[-1]
0xb6e: Push(-1, 3); TaskCall(6)
0xb6f: Call2 0x613

0xb70: Pop(-1, 3); TaskReturn
0xb71: Pop(1)
0xb72: @ ResetAAS()
0xb73: Pop(0)
0xb74: Return(); Pop(0)
...
0xb76: Pop(0); PushNull((bool) Stack[-3] == 0)
0xb77: IF (Stack[-1] == 0) GOTO 0xb79; Pop(1)

0xb78: Return(); Pop(2)

0xb79: Push(GlobalVars[1])
0xb7a: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=1253
0xb7b: Pop(1)
0xb7c: Pop(0); Push((bool) Stack[-1] == 0)
0xb7d: IF (Stack[-1] == 0) GOTO 0xb81; Pop(1)

0xb7e: Push(GlobalVars[1])
0xb7f: @@ add(Stack[-4]); Obj=1 // @poff=918
0xb80: Pop(1)
0xb81: Return(); Pop(2)
...
0xb8a: Pop(1)
0xb8b: Pop(1); Push((bool) Stack[-1] == 0)
...
0xb90: Push(-2, 0); TaskCall(7)
0xb91: Call2 0x6ea

0xb92: Pop(-2, 0); TaskReturn
0xb93: Pop(1)
0xb94: IF (Stack[-1] == 0) GOTO 0xb9b; Pop(1)

0xb95: PushEmpty(object)
0xb96: Stack[-2] = Stack[-1]
0xb97: Push(-1, 3); TaskCall(6)
0xb98: Call2 0x613

0xb99: Pop(-1, 3); TaskReturn
0xb9a: Pop(1)
0xb9b: @ ResetAAS()
0xb9c: Pop(0)
0xb9d: Return(); Pop(0)

0xb9e: PushEmpty(bool, float, bool, float)
0xb9f: PushEmpty(bool, object)
0xba0: Stack[-7] = Stack[-1]
0xba1: Call2 0xaff

0xba2: Pop(1)
0xba3: IF (Stack[-1] == 0) GOTO 0xbbd; Pop(1)

0xba4: @ CanSee(Stack[-2], Stack[-6])
0xba5: Pop(0)
0xba6: PushEmpty(float, object)
0xba7: Stack[-8] = Stack[-1]
0xba8: Call2 0x7df

0xba9: Stack[-2] = Stack[-3]
0xbaa: Pop(2)
0xbab: PushEmpty(bool)
0xbac: Stack[-1] = (bool) 0
0xbad: Push((float)1000000.0)
0xbae: Pop(1); Push((bool) Stack[-3] <= Stack[-1])
0xbaf: IF (Stack[-1] == 0) GOTO 0xbba; Pop(1)

0xbb0: PushEmpty(bool)
0xbb1: Stack[-1] = (bool) 1
0xbb2: Push(Stack[-4])
0xbb3: IF (Stack[-1] == 1) GOTO 0xbb8; Pop(1)

0xbb4: Push((float)490000.0)
0xbb5: Pop(1); Push((bool) Stack[-4] <= Stack[-1])
0xbb6: IF (Stack[-1] == 1) GOTO 0xbb8; Pop(1)

0xbb7: Stack[-1] = (bool) 0
0xbb8: IF (Stack[-1] == 0) GOTO 0xbba; Pop(1)

0xbb9: Stack[-1] = (bool) 1
0xbba: IF (Stack[-1] == 0) GOTO 0xbbd; Pop(1)

0xbbb: Stack[-7] = (bool) 1
0xbbc: Return(); Pop(4)

0xbbd: Stack[-7] = (bool) 0
0xbbe: Return(); Pop(4)

0xbbf: PushEmpty()
0xbc0: PushEmpty(bool, object)
0xbc1: Stack[-3] = Stack[-1]
0xbc2: Call2 0x7e7

0xbc3: Pop(1)
0xbc4: IF (Stack[-1] == 0) GOTO 0xbca; Pop(1)

0xbc5: PushEmpty(bool, object, float)
0xbc6: Stack[-4] = Stack[-2]
0xbc7: Stack[-1] = (float) 0.05000000074505806
0xbc8: Call2 0xa6c

0xbc9: Pop(3)
0xbca: PushEmpty(object)
0xbcb: Stack[-2] = Stack[-1]
0xbcc: Push(-1, 0); TaskCall(8)
0xbcd: Call2 0x720

0xbce: Pop(-1, 0); TaskReturn
0xbcf: Pop(1)
0xbd0: Return(); Pop(0)

0xbd1: PushEmpty()
0xbd2: PushEmpty(object, int, float)
0xbd3: Stack[-7] = Stack[-3]
0xbd4: Stack[-6] = Stack[-2]
0xbd5: Stack[-5] = Stack[-1]
0xbd6: Call2 0x918
...
0xbd9: PushEmpty()
0xbda: PushEmpty(object, int, float, cvector, cvector)
0xbdb: Stack[-11] = Stack[-5]
0xbdc: Stack[-10] = Stack[-4]
0xbdd: Stack[-9] = Stack[-3]
0xbde: Stack[-7] = Stack[-2]
0xbdf: Stack[-6] = Stack[-1]
0xbe0: Call2 0x95c

0xbe1: Pop(5)
0xbe2: Return(); Pop(0)

0xbe3: PushEmpty(float, float)
0xbe4: Push("health") // @poff=786
0xbe5: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xbe6: IF (Stack[-1] == 0) GOTO 0xbef; Pop(1)

0xbe7: Push("health") // @poff=786
0xbe8: @ GetProperty(Stack[-1], Stack[-2])
0xbe9: Pop(1)
0xbea: Push((int) 0)
0xbeb: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xbec: IF (Stack[-1] == 0) GOTO 0xbef; Pop(1)

0xbed: @ SignalDeath(Stack[-4])
0xbee: Pop(0)
0xbef: Return(); Pop(2)

0xbf0: PushEmpty()
0xbf1: PushEmpty(object)
0xbf2: Stack[-2] = Stack[-1]
0xbf3: Call2 0xbbf

0xbf4: Pop(1)
0xbf5: Return(); Pop(0)

0xbf6: PushEmpty(int, int)
0xbf7: Push("branch") // @poff=1256
0xbf8: @ GetVariable(Stack[-1], Stack[-2])
0xbf9: Pop(1)
0xbfa: Stack[-1] = Stack[-3]
0xbfb: Return(); Pop(2)
...
0xbff: Pop(0)
0xc00: Push((int) 1)
0xc01: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xc02: IF (Stack[-1] == 0) GOTO 0xc06; Pop(1)

0xc03: @ WorkWithCorpse(Stack[-1])
0xc04: Pop(0)
0xc05: GOTO 0xc08

0xc06: @ Barter(Stack[-1])
0xc07: Pop(0)
0xc08: Return(); Pop(0)

0xc09: PushEmpty(int, bool, int, bool)
0xc0a: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0xc0b: IF (Stack[-1] == 0) GOTO 0xc10; Pop(1)

0xc0c: Push("GenerateMoney: iMin > iMax") // @poff=1270
0xc0d: @ Trace(Stack[-1])
0xc0e: Pop(1)
0xc0f: Return(); Pop(4)

0xc10: Stack[-2] = (int) 0
0xc11: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0xc12: IF (Stack[-1] == 0) GOTO 0xc17; Pop(1)

0xc13: Pop(0); Push(Stack[-5] - Stack[-6]);
0xc14: @ irand(Stack[-3], Stack[-1])
0xc15: Pop(1)
0xc16: GOTO 0xc1b

0xc17: Push((int) 0)
0xc18: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0xc19: IF (Stack[-1] == 0) GOTO 0xc1b; Pop(1)

0xc1a: Return(); Pop(4)

0xc1b: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0xc1c: Push((int) 0)
...
0xc21: Stack[-1] = "Money" // @poff=1324
0xc22: Call2 0xc96

0xc23: Pop(1)
0xc24: Push((int) 0)
0xc25: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xc26: Pop(2)
0xc27: Return(); Pop(4)

0xc28: PushEmpty(object, int, bool, object, int, bool)
0xc29: @ CreateInvItem(Stack[-3])
0xc2a: Pop(0)
0xc2b: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1336
0xc2c: Pop(0)
0xc2d: Push("Organ") // @poff=1348
0xc2e: Push((int) 1)
0xc2f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=774
0xc30: Pop(2)
0xc31: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1360
0xc32: Pop(0)
0xc33: Push((int) 0)
0xc34: Push((int) 1)
0xc35: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0xc36: Pop(2)
0xc37: Return(); Pop(6)
...
0xc41: Stack[-1] = "liver" // @poff=1370
0xc42: Call2 0xc28

0xc43: Pop(1)
0xc44: PushEmpty(string)
0xc45: Stack[-1] = "kidney" // @poff=1382
0xc46: Call2 0xc28

0xc47: Pop(1)
0xc48: PushEmpty(string)
0xc49: Stack[-1] = "heart" // @poff=1396
0xc4a: Call2 0xc28

0xc4b: Pop(1)
0xc4c: PushEmpty(string)
0xc4d: Stack[-1] = "blood" // @poff=1408
0xc4e: Call2 0xc28
...
0xc52: Push((int) 0)
0xc53: @ ClearSubContainer(Stack[-1])
0xc54: Pop(1)
0xc55: PushEmpty(int, int)
0xc56: Stack[-2] = (int) 1500
0xc57: Stack[-1] = (int) 3000
0xc58: Call2 0xc09

0xc59: Pop(2)
0xc5a: PushEmpty(string, int, int)
0xc5b: Stack[-3] = "Knife" // @poff=1420
0xc5c: Stack[-2] = (int) 1
0xc5d: Stack[-1] = (int) 4
0xc5e: Call2 0x985

0xc5f: Pop(3)
0xc60: PushEmpty(string, int, int)
0xc61: Stack[-3] = "lockpick" // @poff=1432
0xc62: Stack[-2] = (int) 1
0xc63: Stack[-1] = (int) 3
0xc64: Call2 0x985
...
0xc67: Stack[-4] = "rifle_ammo" // @poff=1450
0xc68: Stack[-3] = (int) 1
0xc69: Stack[-2] = (int) 3
0xc6a: Stack[-1] = (int) 3
0xc6b: Call2 0x990
...
0xc6e: Stack[-4] = "samopal_ammo" // @poff=1472
0xc6f: Stack[-3] = (int) 1
0xc70: Stack[-2] = (int) 3
0xc71: Stack[-1] = (int) 3
0xc72: Call2 0x990
...
0xc73: Pop(4)
0xc74: PushEmpty(string, int, int, int)
0xc75: Stack[-4] = "revolver_ammo" // @poff=1498
0xc76: Stack[-3] = (int) 1
0xc77: Stack[-2] = (int) 3
0xc78: Stack[-1] = (int) 3
0xc79: Call2 0x990
...
0xc7a: Pop(4)
0xc7b: PushEmpty(string, int, int)
0xc7c: Stack[-3] = "Samopal" // @poff=1526
0xc7d: Stack[-2] = (int) 1
0xc7e: Stack[-1] = (int) 20
0xc7f: Call2 0x985

0xc80: Pop(3)
0xc81: PushEmpty(string, int, int)
0xc82: Stack[-3] = "Revolver" // @poff=1542
0xc83: Stack[-2] = (int) 1
0xc84: Stack[-1] = (int) 20
0xc85: Call2 0x985

0xc86: Pop(3)
0xc87: PushEmpty(string, int, int)
0xc88: Stack[-3] = "Rifle" // @poff=1560
0xc89: Stack[-2] = (int) 1
0xc8a: Stack[-1] = (int) 20
0xc8b: Call2 0x985

0xc8c: Pop(3)
0xc8d: PushEmpty(int, string)
0xc8e: Stack[-1] = "grabitel_mark" // @poff=1572
0xc8f: Call2 0xc96

0xc90: Pop(1)
0xc91: Push((int) 0)
0xc92: Push((int) 1)
0xc93: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xc94: Pop(3)
0xc95: Return(); Pop(4)

0xc96: PushEmpty(int, int)
0xc97: @ GetInvItemByName(Stack[-1], Stack[-3])
0xc98: Pop(0)
0xc99: Stack[-1] = Stack[-4]
0xc9a: Return(); Pop(2)
