...
// @pool_raw:
// @pool_encoding:utf8
...
0x6b: Stack[-1] = "Menace" // @poff=89
0x6c: Call2 0xdb

0x6d: Pop(1)
0x6e: Push((int) 521581)
0x6f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x70: Pop(1)
0x71: @@@ ClearReplies(); Obj=0 // @poff=114
0x72: Pop(0)
0x73: Push((int) 531554)
0x74: Push((int) 32918)
0x75: Push((int) 32917)
0x76: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x77: Pop(3)
0x78: GOTO 0xbd
...
0x8e: Push((int) 22740)
0x8f: Push((int) 22739)
0x90: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x91: Pop(3)
...
0x98: Push((int) 23547)
0x99: Push((int) 23546)
0x9a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x9b: Pop(3)
0x9c: Push((int) 521586)
0x9d: Push((int) -1)
0x9e: Push((int) 22747)
0x9f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xa0: Pop(3)
0xa1: GOTO 0xbd

0xa2: PushEmpty(string)
0xa3: Stack[-1] = "Neutral" // @poff=136
0xa4: Call2 0xdb

0xa5: Pop(1)
0xa6: Push((int) 521601)
0xa7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xa8: Pop(1)
0xa9: @@@ ClearReplies(); Obj=0 // @poff=114
0xaa: Pop(0)
...
0xb1: Push((int) 23551)
0xb2: Push((int) 23550)
0xb3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xb4: Pop(3)
0xb5: Push((int) 521602)
0xb6: Push((int) -1)
0xb7: Push((int) 22767)
0xb8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xb9: Pop(3)
0xba: GOTO 0xbd
...
0xcc: Push("all") // @poff=152
0xcd: Push("idle") // @poff=160
...
0xd5: Push("all") // @poff=152
0xd6: Push("idle") // @poff=160
...
0x15a: Stack[-1] = "Menace" // @poff=89
0x15b: Call2 0xdb

0x15c: Pop(1)
0x15d: Push((int) 521581)
0x15e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x15f: Pop(1)
0x160: @@@ ClearReplies(); Obj=0 // @poff=114
0x161: Pop(0)
0x162: Push((int) 531554)
0x163: Push((int) 32918)
0x164: Push((int) 32917)
0x165: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x166: Pop(3)
0x167: Return(); Pop(0)
...
0x17f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x180: Pop(3)
...
0x18e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x18f: Pop(3)
0x190: Return(); Pop(0)

0x191: PushEmpty(string)
0x192: Stack[-1] = "Neutral" // @poff=136
0x193: Call2 0xdb

0x194: Pop(1)
0x195: Push((int) 521601)
0x196: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x197: Pop(1)
0x198: @@@ ClearReplies(); Obj=0 // @poff=114
0x199: Pop(0)
...
0x1a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1a3: Pop(3)
0x1a4: Push((int) 521602)
0x1a5: Push((int) -1)
0x1a6: Push((int) 22767)
0x1a7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1a8: Pop(3)
0x1a9: Return(); Pop(0)
...
0x1ae: Stack[-1] = "Sorrow" // @poff=170
0x1af: Call2 0xdb

0x1b0: Pop(1)
0x1b1: Push((int) 522386)
0x1b2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1b3: Pop(1)
0x1b4: @@@ ClearReplies(); Obj=0 // @poff=114
0x1b5: Pop(0)
0x1b6: Push((int) 522387)
0x1b7: Push((int) 23553)
0x1b8: Push((int) 23552)
0x1b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1ba: Pop(3)
0x1bb: Return(); Pop(0)
...
0x1c0: Stack[-1] = "Sorrow" // @poff=170
0x1c1: Call2 0xdb

0x1c2: Pop(1)
0x1c3: Push((int) 522388)
0x1c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1c5: Pop(1)
0x1c6: @@@ ClearReplies(); Obj=0 // @poff=114
0x1c7: Pop(0)
0x1c8: Push((int) 522389)
0x1c9: Push((int) -1)
0x1ca: Push((int) 23554)
0x1cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1cc: Pop(3)
0x1cd: Return(); Pop(0)
...
0x1d2: Stack[-1] = "Neutral" // @poff=136
0x1d3: Call2 0xdb

0x1d4: Pop(1)
0x1d5: Push((int) 522382)
0x1d6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1d7: Pop(1)
0x1d8: @@@ ClearReplies(); Obj=0 // @poff=114
0x1d9: Pop(0)
0x1da: Push((int) 522383)
0x1db: Push((int) -1)
0x1dc: Push((int) 23548)
0x1dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1de: Pop(3)
0x1df: Return(); Pop(0)
...
0x1e4: Stack[-1] = "Sorrow" // @poff=170
0x1e5: Call2 0xdb

0x1e6: Pop(1)
0x1e7: Push((int) 521579)
0x1e8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1e9: Pop(1)
0x1ea: @@@ ClearReplies(); Obj=0 // @poff=114
0x1eb: Pop(0)
0x1ec: Push((int) 522377)
0x1ed: Push((int) 23543)
0x1ee: Push((int) 23542)
0x1ef: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x1f0: Pop(3)
0x1f1: Return(); Pop(0)
...
0x1f6: Stack[-1] = "Sorrow" // @poff=170
0x1f7: Call2 0xdb

0x1f8: Pop(1)
0x1f9: Push((int) 522378)
0x1fa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x1fb: Pop(1)
0x1fc: @@@ ClearReplies(); Obj=0 // @poff=114
0x1fd: Pop(0)
0x1fe: Push((int) 521580)
0x1ff: Push((int) -1)
0x200: Push((int) 22741)
0x201: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x202: Pop(3)
0x203: Push((int) 522379)
0x204: Push((int) 23545)
0x205: Push((int) 23544)
0x206: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x207: Pop(3)
0x208: Return(); Pop(0)
...
0x20d: Stack[-1] = "Sorrow" // @poff=170
0x20e: Call2 0xdb

0x20f: Pop(1)
0x210: Push((int) 522380)
0x211: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x212: Pop(1)
0x213: @@@ ClearReplies(); Obj=0 // @poff=114
0x214: Pop(0)
0x215: Push((int) 522384)
0x216: Push((int) -1)
0x217: Push((int) 23549)
0x218: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x219: Pop(3)
0x21a: Return(); Pop(0)
...
0x21f: Stack[-1] = "Neutral" // @poff=136
0x220: Call2 0xdb

0x221: Pop(1)
0x222: Push((int) 531555)
0x223: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x224: Pop(1)
0x225: @@@ ClearReplies(); Obj=0 // @poff=114
0x226: Pop(0)
0x227: Push((int) 521582)
0x228: Push((int) 23526)
0x229: Push((int) 22743)
0x22a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x22b: Pop(3)
0x22c: Return(); Pop(0)
...
0x231: Stack[-1] = "Untrust" // @poff=184
0x232: Call2 0xdb

0x233: Pop(1)
0x234: Push((int) 522363)
0x235: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x236: Pop(1)
0x237: @@@ ClearReplies(); Obj=0 // @poff=114
0x238: Pop(0)
0x239: Push((int) 522364)
0x23a: Push((int) 23528)
0x23b: Push((int) 23527)
0x23c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x23d: Pop(3)
0x23e: Push((int) 522369)
0x23f: Push((int) 23533)
0x240: Push((int) 23532)
0x241: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x242: Pop(3)
0x243: Return(); Pop(0)
...
0x248: Stack[-1] = "Neutral" // @poff=136
0x249: Call2 0xdb

0x24a: Pop(1)
0x24b: Push((int) 522370)
0x24c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x24d: Pop(1)
0x24e: @@@ ClearReplies(); Obj=0 // @poff=114
0x24f: Pop(0)
0x250: Push((int) 522371)
0x251: Push((int) 22744)
0x252: Push((int) 23534)
0x253: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x254: Pop(3)
0x255: Return(); Pop(0)
...
0x25a: Stack[-1] = "Untrust" // @poff=184
0x25b: Call2 0xdb

0x25c: Pop(1)
0x25d: Push((int) 522365)
0x25e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x25f: Pop(1)
0x260: @@@ ClearReplies(); Obj=0 // @poff=114
0x261: Pop(0)
...
0x26c: Stack[-1] = "Untrust" // @poff=184
0x26d: Call2 0xdb
...
0x27e: Stack[-1] = "Untrust" // @poff=184
0x27f: Call2 0xdb

0x280: Pop(1)
0x281: Push((int) 521583)
0x282: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x283: Pop(1)
0x284: @@@ ClearReplies(); Obj=0 // @poff=114
0x285: Pop(0)
...
0x290: Stack[-1] = "Untrust" // @poff=184
0x291: Call2 0xdb

0x292: Pop(1)
0x293: Push((int) 522373)
0x294: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x295: Pop(1)
0x296: @@@ ClearReplies(); Obj=0 // @poff=114
0x297: Pop(0)
0x298: Push((int) 522374)
0x299: Push((int) 23540)
0x29a: Push((int) 23539)
0x29b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x29c: Pop(3)
0x29d: Return(); Pop(0)
...
0x2a2: Stack[-1] = "Neutral" // @poff=136
0x2a3: Call2 0xdb

0x2a4: Pop(1)
0x2a5: Push((int) 522375)
0x2a6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x2a7: Pop(1)
0x2a8: @@@ ClearReplies(); Obj=0 // @poff=114
0x2a9: Pop(0)
0x2aa: Push((int) 521584)
0x2ab: Push((int) -1)
0x2ac: Push((int) 22745)
0x2ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x2ae: Pop(3)
0x2af: Push((int) 522376)
0x2b0: Push((int) -1)
0x2b1: Push((int) 23541)
0x2b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x2b3: Pop(3)
0x2b4: Return(); Pop(0)
...
0x2d2: Stack[-1] = "Neutral" // @poff=136
0x2d3: Call2 0x3ea
...
0x2f8: Pop(2)
0x2f9: Stack[-1] = Stack[-8]
0x2fa: Return(); Pop(6)

0x2fb: PushEmpty(cvector, cvector)
0x2fc: @@ GetPosition(Stack[-1]); Obj=3 // @poff=200
0x2fd: Pop(0)
0x2fe: PushEmpty(bool, cvector)
0x2ff: Stack[-3] = Stack[-1]
0x300: Call2 0x2f1

0x301: Stack[-2] = Stack[-6]
0x302: Pop(2)
0x303: Return(); Pop(2)
...
0x30a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=200
0x30b: Pop(0)
0x30c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=212
0x30d: Pop(0)
...
0x379: Push("voice_common") // @poff=236
0x37a: Push((int) 1)
...
0x381: Push("voice_common") // @poff=236
0x382: Push((int) 0)
...
0x394: Push("voice_common") // @poff=236
0x395: Push((int) 1)
...
0x3a2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x3a3: Pop(1)
...
0x3cd: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x3ce: Pop(1)
...
0x3e2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x3e3: Pop(1)
0x3e4: PushEmpty(bool, string)
0x3e5: Stack[-3] = Stack[-1]
0x3e6: Call2 0x409

0x3e7: Stack[-2] = Stack[-14]
0x3e8: Pop(2)
0x3e9: Return(); Pop(10)
...
0x3f5: Push("Can't find lsh animation : ") // @poff=294
...
0x404: Push("Can't find lsh animation : ") // @poff=294
...
0x428: Push((float)9.999999974752427e-07)
...
0x43d: PushEmpty()
0x43e: Push("oob9Danko1") // @poff=350
0x43f: Push((int) 1)
...
0x443: PushEmpty()
0x444: Push("oob9Danko2") // @poff=372
0x445: Push((int) 1)
...
0x452: PushEmpty()
0x453: Push("b9q01DankoAmmo") // @poff=406
0x454: Push((int) 1)
...
0x458: PushEmpty()
0x459: Push("oob9Danko3") // @poff=436
0x45a: Push((int) 1)
...
0x45e: PushEmpty()
0x45f: Push("oob9Danko4") // @poff=458
0x460: Push((int) 1)
...
0x466: Stack[-1] = "map_chertez_state" // @poff=480
0x467: Call2 0x42f
...
0x46c: Push("map_chertez_state") // @poff=480
0x46d: Push((int) 4)
0x46e: @ SetVariable(Stack[-2], Stack[-1])
0x46f: Pop(2)
0x470: Push("map_chertez_force") // @poff=516
0x471: Push((int) 1)
...
0x47a: Pop(1)
0x47b: Stack[-2] = "pt_map_aglaja" // @poff=552
0x47c: Stack[-1] = (int) -1
0x47d: Call2 0x508
...
0x481: Pop(0)
0x482: @@ ShowMap(Stack[-1]); Obj=2 // @poff=580
0x483: Pop(1)
0x484: Return(); Pop(0)

0x485: PushEmpty()
0x486: PushEmpty(int, string)
0x487: Stack[-1] = "b9q01DankoFree" // @poff=588
0x488: Call2 0x42f
...
0x493: Stack[-1] = "oob9Danko1" // @poff=350
0x494: Call2 0x42f
...
0x49f: Stack[-1] = "oob9Danko2" // @poff=372
0x4a0: Call2 0x42f
...
0x4ab: Stack[-1] = "oob9Danko3" // @poff=436
0x4ac: Call2 0x42f
...
0x4b7: Stack[-1] = "oob9Danko4" // @poff=458
0x4b8: Call2 0x42f
...
0x4d3: Push("Can't retrieve diary root") // @poff=618
0x4d4: @ Trace(Stack[-1])
0x4d5: Pop(1)
0x4d6: Stack[-3] = (bool) 0
0x4d7: Return(); Pop(2)

0x4d8: Stack[-1] = Stack[-3]
0x4d9: Return(); Pop(2)
...
0x4df: Pop(1)
0x4e0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=670
0x4e1: Pop(0)
0x4e2: Pop(0); Push((bool) Stack[-2] == 0)
0x4e3: IF (Stack[-1] == 0) GOTO 0x4ea; Pop(1)

0x4e4: Push("Can't find diary parent with id: ") // @poff=675
...
0x4ea: @@ AddChild(Stack[-8]); Obj=2 // @poff=743
0x4eb: Pop(0)
0x4ec: Push((int) 7)
0x4ed: @ SendWorldWndMessage(Stack[-1])
0x4ee: Pop(1)
0x4ef: @@ GetCategory(Stack[-1]); Obj=8 // @poff=752
0x4f0: Pop(0)
...
0x4f9: Pop(0)
0x4fa: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4fb: IF (Stack[-1] == 0) GOTO 0x502; Pop(1)

0x4fc: Push("Can't find main outdoor scene") // @poff=764
0x4fd: @ Trace(Stack[-1])
0x4fe: Pop(1)
0x4ff: Stack[-1] = 0
...
0x502: @@ GetMap(Stack[-1]); Obj=2 // @poff=824
0x503: Pop(0)
...
0x50a: Pop(0)
0x50b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x50c: IF (Stack[-1] == 0) GOTO 0x511; Pop(1)

0x50d: Push("Can't find main outdoor scene") // @poff=764
0x50e: @ Trace(Stack[-1])
0x50f: Pop(1)
0x510: Return(); Pop(8)

0x511: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=831
0x512: Pop(0)
0x513: Pop(0); Push((bool) Stack[-1] == 0)
0x514: IF (Stack[-1] == 0) GOTO 0x51b; Pop(1)

0x515: Push("Warning: outdoor scene locator ") // @poff=842
0x516: Pop(1); Push(Stack[-1] + Stack[-11]);
0x517: Push(" doesnt exist") // @poff=906
0x518: Pop(2); Push(Stack[-2] + Stack[-1]);
0x519: @ Trace(Stack[-1])
0x51a: Pop(1)
0x51b: @@ GetMap(Stack[-11]); Obj=2 // @poff=824
0x51c: Pop(0)
0x51d: Pop(0); PushNull((bool) Stack[-11] == 0)
0x51e: IF (Stack[-1] == 0) GOTO 0x523; Pop(1)

0x51f: Push("Can't find map") // @poff=934
0x520: @ Trace(Stack[-1])
0x521: Pop(1)
0x522: Return(); Pop(8)
...
0x525: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=964
0x526: Pop(2)
0x527: Return(); Pop(8)

0x528: Stack[-2] = 0
0x529: PushEmpty(int, int)
0x52a: Push("branch") // @poff=977
...
0x53e: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=991
0x53f: Return(); Pop(0)

0x540: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=1031
0x541: Return(); Pop(0)
