...
// @pool_raw:
// @pool_encoding:utf8
...
0x261: Push("Can't find lsh animation : ") // @poff=208
...
0x270: Push("Can't find lsh animation : ") // @poff=208
...
0x293: Pop(0)
0x294: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2ba: PushEmpty()
0x2bb: Push("oob9MDoberman1") // @poff=264
0x2bc: Push((int) 1)
...
0x2cb: Pop(1)
0x2cc: Push("b9q01MDobermanGotoFactory") // @poff=306
0x2cd: Push("pt_gmap_factory") // @poff=358
0x2ce: Push((int) 1)
...
0x2d2: Pop(0)
0x2d3: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x2d4: Pop(5)
0x2d5: PushEmpty()
0x2d6: Call2 0x307
...
0x2d9: Stack[-2] = "quest_b9_01" // @poff=398
0x2da: Stack[-1] = "remove_mdoberman" // @poff=422
0x2db: Call2 0x291
...
0x2e4: Pop(1)
0x2e5: Stack[-2] = "pt_gmap_factory" // @poff=358
0x2e6: Stack[-1] = (int) 2
0x2e7: Call2 0x34e
...
0x2eb: Pop(0)
0x2ec: @@ ShowMap(Stack[-1]); Obj=2 // @poff=456
0x2ed: Pop(1)
0x2ee: Return(); Pop(0)

0x2ef: PushEmpty()
0x2f0: PushEmpty(int, string)
0x2f1: Stack[-1] = "b9q01" // @poff=294
0x2f2: Call2 0x28c
...
0x2fd: Stack[-1] = "oob9MDoberman1" // @poff=264
0x2fe: Call2 0x28c
...
0x319: Push("Can't retrieve diary root") // @poff=464
0x31a: @ Trace(Stack[-1])
0x31b: Pop(1)
...
0x325: Pop(1)
0x326: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=516
0x327: Pop(0)
0x328: Pop(0); Push((bool) Stack[-2] == 0)
0x329: IF (Stack[-1] == 0) GOTO 0x330; Pop(1)

0x32a: Push("Can't find diary parent with id: ") // @poff=521
...
0x330: @@ AddChild(Stack[-8]); Obj=2 // @poff=589
0x331: Pop(0)
0x332: Push((int) 7)
0x333: @ SendWorldWndMessage(Stack[-1])
0x334: Pop(1)
0x335: @@ GetCategory(Stack[-1]); Obj=8 // @poff=598
0x336: Pop(0)
...
0x342: Push("Can't find main outdoor scene") // @poff=610
0x343: @ Trace(Stack[-1])
0x344: Pop(1)
0x345: Stack[-1] = 0
...
0x348: @@ GetMap(Stack[-1]); Obj=2 // @poff=670
0x349: Pop(0)
0x34a: Stack[-1] = Stack[-5]
0x34b: Return(); Pop(4)
...
0x350: Pop(0)
0x351: Pop(0); PushNull((bool) Stack[-2] == 0)
0x352: IF (Stack[-1] == 0) GOTO 0x357; Pop(1)

0x353: Push("Can't find main outdoor scene") // @poff=610
0x354: @ Trace(Stack[-1])
0x355: Pop(1)
0x356: Return(); Pop(8)

0x357: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=677
0x358: Pop(0)
0x359: Pop(0); Push((bool) Stack[-1] == 0)
0x35a: IF (Stack[-1] == 0) GOTO 0x361; Pop(1)

0x35b: Push("Warning: outdoor scene locator ") // @poff=688
0x35c: Pop(1); Push(Stack[-1] + Stack[-11]);
0x35d: Push(" doesnt exist") // @poff=752
0x35e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x35f: @ Trace(Stack[-1])
0x360: Pop(1)
0x361: @@ GetMap(Stack[-11]); Obj=2 // @poff=670
0x362: Pop(0)
0x363: Pop(0); PushNull((bool) Stack[-11] == 0)
0x364: IF (Stack[-1] == 0) GOTO 0x369; Pop(1)

0x365: Push("Can't find map") // @poff=780
0x366: @ Trace(Stack[-1])
0x367: Pop(1)
0x368: Return(); Pop(8)
...
0x36b: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=810
0x36c: Pop(2)
0x36d: Return(); Pop(8)

0x36e: Stack[-2] = 0
0x36f: PushEmpty(int, int)
0x370: Push("branch") // @poff=823
...
0x384: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=837
0x385: Return(); Pop(0)

0x386: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=877
0x387: Return(); Pop(0)
