...
// @pool_raw:
// @pool_encoding:utf8
...
0x298: Stack[-1] = 0
0x299: PushEmpty()
0x29a: Stack[-3] = (float) 0.30000001192092896
0x29b: Return(); Pop(0)
...
0x2b4: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x2b5: Pop(0)
0x2b6: Push(Stack[-8])
0x2b7: IF (Stack[-1] == 0) GOTO 0x2c0; Pop(1)

0x2b8: Push("attack") // @poff=226
...
0x2d4: Pop(0)
0x2d5: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x2d6: Pop(0)
...
0x2f0: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=240
0x2f1: Pop(0)
...
0x324: IF (Stack[-1] == 1) GOTO 0x32a; Pop(1)

0x325: PushEmpty(bool)
0x326: Call2 0x4f6

0x327: Pop(0)
0x328: IF (Stack[-1] == 1) GOTO 0x32a; Pop(1)

0x329: Stack[-1] = (bool) 0
0x32a: IF (Stack[-1] == 0) GOTO 0x33b; Pop(1)

0x32b: @ Face(Stack[-0]T)
0x32c: Pop(0)
0x32d: PushEmpty()
0x32e: Call2 0x528
...
0x33b: @ Face(Stack[-0]T)
0x33c: Pop(0)
0x33d: Push("all") // @poff=138
0x33e: Push("fjump") // @poff=298
...
0x359: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=240
0x35a: Pop(0)
...
0x378: Push("all") // @poff=138
0x379: Push("attack_off") // @poff=310
...
0x387: Push("attack_begin") // @poff=332
0x388: Push((int) 1)
0x389: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x394: Push("attack") // @poff=226
0x395: Push((int) 1)
0x396: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3a8: Push((float)0.8999999761581421)
0x3a9: Pop(1); Push(Stack[-9] * Stack[-1]);
0x3aa: @ GetVictim(Stack[-1], Stack[-4])
0x3ab: Pop(1)
0x3ac: @ ReportAttack(Stack[-0]T)
0x3ad: Pop(0)
...
0x3b1: Stack[-6] = Stack[-2]
0x3b2: Stack[-10] = Stack[-1]
0x3b3: Call2 0x299

0x3b4: Stack[-3] = Stack[-5]
0x3b5: Pop(3)
0x3b6: PushEmpty(float, object, float, int)
0x3b7: Stack[-7] = Stack[-3]
0x3b8: Stack[-6] = Stack[-2]
0x3b9: PushEmpty(int, object, int)
0x3ba: Stack[-10] = Stack[-2]
0x3bb: Stack[-14] = Stack[-1]
0x3bc: Call2 0x29c

0x3bd: Stack[-3] = Stack[-4]
0x3be: Pop(3)
0x3bf: Call2 0x74a

0x3c0: Stack[-4] = Stack[-5]
0x3c1: Pop(4)
0x3c2: PushEmpty(int)
0x3c3: Call2 0x526

0x3c4: Pop(0)
0x3c5: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x3c6: Pop(1)
0x3c7: PushEmpty(object, float)
0x3c8: Stack[-5] = Stack[-2]
...
0x3d1: Pop(0)
0x3d2: @ irand(Stack[-4], Stack[-1]T)
0x3d3: Pop(0)
0x3d4: Push((int) 1)
0x3d5: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3d6: @ Face(Stack[-0]T)
0x3d7: Pop(0)
0x3d8: Push((bool) 1)
...
0x3dd: Pop(0)
0x3de: Push("all") // @poff=138
0x3df: Push("attack_begin") // @poff=332
...
0x3f3: Stack[-11] = Stack[-2]
0x3f4: Stack[-6] = Stack[-1]
0x3f5: Call2 0x3a7

0x3f6: Pop(2)
0x3f7: Push("all") // @poff=138
0x3f8: Push("attack_middle") // @poff=370
...
0x400: Pop(0)
0x401: Push("all") // @poff=138
0x402: Push("attack_middle") // @poff=370
...
0x416: Stack[-11] = Stack[-2]
0x417: Stack[-6] = Stack[-1]
0x418: Call2 0x3a7

0x419: Pop(2)
0x41a: Stack[-2] = (int) 1
0x41b: Push("attack_middle") // @poff=370
0x41c: Pop(1); Push(Stack[-1] + Stack[-5]);
0x41d: Push("_") // @poff=398
...
0x445: Pop(1)
0x446: Push("all") // @poff=138
0x447: Push("attack_end") // @poff=402
...
0x486: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=240
0x487: Pop(0)
...
0x4d2: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x4d3: Pop(1)
...
0x4d7: @ Face(Stack[-0]T)
0x4d8: Pop(0)
0x4d9: Push("all") // @poff=138
0x4da: Push("bjump") // @poff=358
0x4db: @ PlayAnimation(Stack[-2], Stack[-1])
0x4dc: Pop(2)
0x4dd: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=240
0x4de: Pop(0)
...
0x514: @ irand(Stack[-1], Stack[-2]T)
0x515: Pop(0)
0x516: Push((int) 1)
0x517: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x518: Push("attack") // @poff=226
...
0x529: Stack[-1] = "attack_stay" // @poff=274
0x52a: Call2 0x8e5
...
0x554: Stack[-15] = Stack[-5]
0x555: Stack[-14] = Stack[-4]
0x556: Stack[-13] = Stack[-3]
0x557: Stack[-12] = Stack[-2]
0x558: Stack[-11] = Stack[-1]
0x559: Call2 0x59e

0x55a: Stack[-6] = Stack[-7]
0x55b: Pop(6)
0x55c: Push( Stack[2 + Tasks[-1].StackPointer] )
0x55d: IF (Stack[-1] == 0) GOTO 0x561; Pop(1)

0x55e: Push("head") // @poff=460
...
0x5a1: Stack[-17] = Stack[-7]
0x5a2: PushEmpty(bool, object)
0x5a3: Stack[-23] = Stack[-1]
0x5a4: Call2 0x62a
...
0x5aa: @@ GetPosition(Stack[-5]); Obj=21 // @poff=470
0x5ab: Pop(0)
...
0x5c1: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=240
0x5c2: Pop(0)
...
0x5d3: Push((int) 0)
0x5d4: Push((float)0.30000001192092896)
...
0x5f6: Push((int) 0)
0x5f7: Push((float)0.30000001192092896)
...
0x62e: Stack[-2] = Stack[-4]
0x62f: Pop(2)
0x630: Return(); Pop(0)

0x631: Stack[-1] = "walk" // @poff=482
0x632: Return(); Pop(0)

0x633: Stack[-1] = "run" // @poff=492
0x634: Return(); Pop(0)

0x635: PushEmpty()
0x636: PushEmpty(bool, string, string)
0x637: Stack[-2] = "quest_b9_01" // @poff=500
0x638: Stack[-1] = "doberman_dead" // @poff=524
0x639: Call2 0x973
...
0x64c: Stack[-4] = Stack[-2]
0x64d: Stack[-1] = (float) -0.029999999329447746
0x64e: Call2 0x935
...
0x667: Pop(0); PushNull((bool) Stack[-21] == 0)
0x668: IF (Stack[-1] == 0) GOTO 0x66e; Pop(1)

0x669: PushEmpty(string)
0x66a: Stack[-1] = "fdie" // @poff=552
0x66b: Call2 0x6c1

0x66c: Pop(1)
0x66d: GOTO 0x6c0

0x66e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=470
0x66f: Pop(0)
...
0x67f: Stack[-6] = "fdie" // @poff=552
0x680: GOTO 0x682

0x681: Stack[-6] = "bdie" // @poff=562
...
0x68b: Push("GetScriptProperty") // @poff=572
0x68c: Push((int) 2)
0x68d: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x68e: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x68f: Push("Owner") // @poff=608
0x690: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=620
0x691: Pop(1)
0x692: Push(Stack[-4])
0x693: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x694: Push("Owner") // @poff=608
0x695: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=638
0x696: Pop(1)
0x697: Pop(0); PushNull((bool) Stack[-5] == 0)
0x698: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x699: Stack[-21] = Stack[-5]
0x69a: Push("@GetEyesHeight") // @poff=656
0x69b: Push((int) 1)
0x69c: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x69d: IF (Stack[-1] == 0) GOTO 0x6a9; Pop(1)

0x69e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=686
0x69f: Pop(0)
...
0x6b5: @ StopAsync()
0x6b6: Pop(0)
0x6b7: Push("head") // @poff=460
0x6b8: @ UnlookAsync(Stack[-1])
0x6b9: Pop(1)
0x6ba: Push("all") // @poff=138
...
0x6ff: Stack[-2] = "quest_b9_01" // @poff=500
0x700: Stack[-1] = "factory_fight" // @poff=700
0x701: Call2 0x973
...
0x718: Stack[-2] = "bullet" // @poff=738
0x719: Return(); Pop(0)

0x71a: Stack[-2] = "phys" // @poff=752
0x71b: Return(); Pop(0)

0x71c: PushEmpty(cvector, cvector, cvector, cvector)
0x71d: @ GetPosition(Stack[-2])
0x71e: Pop(0)
0x71f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=470
0x720: Pop(0)
...
0x729: Push("HasProperty") // @poff=762
0x72a: Push((int) 2)
...
0x730: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=786
0x731: Pop(0)
0x732: Stack[-1] = Stack[-5]
0x733: Return(); Pop(2)

0x734: PushEmpty(float, float)
0x735: PushEmpty(bool, object, string)
0x736: Stack[-10] = Stack[-2]
0x737: Stack[-9] = Stack[-1]
0x738: Call2 0x728
...
0x73e: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=798
0x73f: Pop(0)
0x740: PushEmpty(float, float, float, float)
0x741: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x742: Stack[-8] = Stack[-2]
0x743: Stack[-7] = Stack[-1]
0x744: Call2 0x925

0x745: Pop(3)
0x746: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=810
0x747: Pop(1)
...
0x74c: Stack[-18] = Stack[-2]
0x74d: Stack[-1] = "health" // @poff=822
0x74e: Call2 0x728
...
0x755: Stack[-18] = Stack[-2]
0x756: Stack[-1] = "armor" // @poff=836
0x757: Call2 0x728
...
0x75d: Push("armor") // @poff=836
0x75e: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=798
0x75f: Pop(1)
0x760: Push("armor_") // @poff=848
0x761: PushEmpty(string, int)
0x762: Stack[-16] = Stack[-1]
0x763: Call2 0x70e

0x764: Pop(1)
0x765: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x766: PushEmpty(bool, object, string)
0x767: Stack[-18] = Stack[-2]
...
0x76f: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=798
0x770: Pop(0)
...
0x777: Stack[-3] = Stack[-6]
0x778: Pop(3)
0x779: Push("health") // @poff=822
0x77a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=798
0x77b: Pop(1)
0x77c: Push((int) 1)
0x77d: Pop(1); Push(Stack[-1] - Stack[-4]);
0x77e: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x77f: Push("health") // @poff=822
...
0x785: Pop(3)
0x786: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=810
0x787: Pop(2)
0x788: PushEmpty(bool, object)
0x789: Stack[-17] = Stack[-1]
0x78a: Call2 0x723
...
0x790: Pop(1)
0x791: Stack[-1] = Stack[-16]
0x792: Return(); Pop(12)

0x793: PushEmpty(bool, bool)
0x794: @@ IsDead(Stack[-1]); Obj=3 // @poff=862
0x795: Pop(0)
0x796: Stack[-1] = Stack[-4]
0x797: Return(); Pop(2)

0x798: PushEmpty(object, object, object, object)
0x799: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7ad: Pop(0)
0x7ae: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7af: IF (Stack[-1] == 0) GOTO 0x7b2; Pop(1)

0x7b0: Stack[-6] = (bool) 0
0x7b1: Return(); Pop(4)

0x7b2: @@ GetScene(Stack[-1]); Obj=5 // @poff=883
0x7b3: Pop(0)
...
0x7c6: Stack[-6] = Stack[-2]
0x7c7: Stack[-1] = "noaccess" // @poff=892
0x7c8: Call2 0x728
...
0x7ce: Push("noaccess") // @poff=892
0x7cf: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=798
0x7d0: Pop(1)
0x7d1: Push((int) 0)
...
0x7d5: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x7e3: @@ GetPosition(Stack[-5]); Obj=15 // @poff=470
0x7e4: Pop(0)
...
0x7f4: Stack[-1] = "fhit" // @poff=910
0x7f5: GOTO 0x7f7

0x7f6: Stack[-1] = "bhit" // @poff=920
0x7f7: Push("hit_react") // @poff=930
0x7f8: Push("1") // @poff=520
0x7f9: Pop(1); Push(Stack[-3] + Stack[-1]);
0x7fa: Push("2") // @poff=950
...
0x818: Stack[-2] = Stack[-11]
0x819: Pop(2)
0x81a: @ CreateVectorVector(Stack[-8])
0x81b: Pop(0)
0x81c: Stack[-7] = (int) 1
0x81d: Push("hit") // @poff=912
...
0x832: Pop(0)
0x833: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=963
0x834: Pop(0)
0x835: PushEmpty(object, int, float, cvector, cvector)
0x836: Stack[-26] = Stack[-5]
0x837: Stack[-25] = Stack[-4]
0x838: Stack[-24] = Stack[-3]
0x839: Stack[-6] = Stack[-2]
...
0x853: @@ GetPosition(Stack[-3]); Obj=7 // @poff=470
0x854: Pop(0)
...
0x85e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=470
0x85f: Pop(0)
0x860: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=686
0x861: Pop(0)
...
0x8bf: Push("Can't find lsh animation : ") // @poff=1013
...
0x8ce: Push("Can't find lsh animation : ") // @poff=1013
...
0x8d4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=686
0x8d5: Pop(0)
...
0x917: Push((float)9.999999974752427e-07)
...
0x94f: Stack[-8] = Stack[-5]
0x950: Stack[-4] = "reputation" // @poff=1069
0x951: Stack[-7] = Stack[-3]
0x952: Stack[-2] = (int) 0
0x953: Stack[-1] = (int) 1
0x954: Call2 0x734
...
0x96b: Pop(0)
0x96c: @@ add(Stack[-3]); Obj=1 // @poff=954
0x96d: Pop(0)
0x96e: Push((int) 16)
...
0x975: Pop(0)
0x976: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x994: Push("rifle_ammo") // @poff=1105
0x995: Push((int) 30)
0x996: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1127
0x997: Pop(2)
0x998: Return(); Pop(2)

0x999: PushEmpty()
0x99a: Push("oob9Doberman1") // @poff=1144
0x99b: Push((int) 1)
...
0x99f: PushEmpty()
0x9a0: Push("oob9Doberman2") // @poff=1172
0x9a1: Push((int) 1)
...
0x9aa: PushEmpty()
0x9ab: Push("b9q01DankoFree") // @poff=1200
0x9ac: Push((int) 1)
...
0x9b3: Stack[-2] = "quest_b9_01" // @poff=500
0x9b4: Stack[-1] = "danko_free" // @poff=1230
0x9b5: Call2 0x973
...
0x9b8: PushEmpty()
0x9b9: Push("playsound") // @poff=1252
0x9ba: Push("giveitem") // @poff=1272
...
0x9d6: Stack[-1] = "oob9Doberman1" // @poff=1144
0x9d7: Call2 0x930
...
0x9e2: Stack[-1] = "oob9Doberman2" // @poff=1172
0x9e3: Call2 0x930
...
0x9f0: Stack[-1] = "b1q03_retreat" // @poff=1302
0x9f1: Call2 0x930
...
0x9f7: Stack[-1] = "b1q03_dead" // @poff=1330
0x9f8: Call2 0x930
...
0xa05: Stack[-1] = "b9q01DankoFree" // @poff=1200
0xa06: Call2 0x930
...
0xa10: Push("rifle_ammo") // @poff=1105
0xa11: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=1352
0xa12: Pop(1)
0xa13: Push((int) 30)
...
0xa35: Push("Can't retrieve diary root") // @poff=1371
0xa36: @ Trace(Stack[-1])
0xa37: Pop(1)
...
0xa41: Pop(1)
0xa42: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1423
0xa43: Pop(0)
0xa44: Pop(0); Push((bool) Stack[-2] == 0)
0xa45: IF (Stack[-1] == 0) GOTO 0xa4c; Pop(1)

0xa46: Push("Can't find diary parent with id: ") // @poff=1428
...
0xa4c: @@ AddChild(Stack[-8]); Obj=2 // @poff=1496
0xa4d: Pop(0)
0xa4e: Push((int) 7)
0xa4f: @ SendWorldWndMessage(Stack[-1])
0xa50: Pop(1)
0xa51: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1505
0xa52: Pop(0)
...
0xa7f: Pop(0)
0xa80: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1531
0xa81: Pop(0)
0xa82: Push("Organ") // @poff=1543
0xa83: Push((int) 1)
0xa84: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=810
0xa85: Pop(2)
0xa86: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1555
0xa87: Pop(0)
0xa88: Push((int) 0)
0xa89: Push((int) 1)
...
0xa96: Stack[-1] = "liver" // @poff=1565
0xa97: Call2 0xa7d

0xa98: Pop(1)
0xa99: PushEmpty(string)
0xa9a: Stack[-1] = "kidney" // @poff=1577
0xa9b: Call2 0xa7d

0xa9c: Pop(1)
0xa9d: PushEmpty(string)
0xa9e: Stack[-1] = "heart" // @poff=1591
0xa9f: Call2 0xa7d

0xaa0: Pop(1)
0xaa1: PushEmpty(string)
0xaa2: Stack[-1] = "blood" // @poff=1603
0xaa3: Call2 0xa7d
...
0xab0: Stack[-11] = Stack[-5]
0xab1: Stack[-10] = Stack[-4]
0xab2: Stack[-9] = Stack[-3]
...
0xacf: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1615
0xad0: Return(); Pop(0)

0xad1: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1655
0xad2: Return(); Pop(0)
