...
Strings:
	...
	W:heart
	W:blood
// @pool_raw:
...
0x2a: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x2b: Pop(0)
0x2c: Push(Stack[-8])
0x2d: IF (Stack[-1] == 0) GOTO 0x36; Pop(1)

0x2e: Push("attack") // @poff=70
...
0x4a: Pop(0)
0x4b: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0x4c: Pop(0)
...
0x66: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=84
0x67: Pop(0)
...
0x80: Pop(1)
0x81: Push("all") // @poff=98
0x82: Push("attack_on") // @poff=106
...
0x9a: IF (Stack[-1] == 1) GOTO 0xa0; Pop(1)

0x9b: PushEmpty(bool)
0x9c: Call2 0x26c

0x9d: Pop(0)
0x9e: IF (Stack[-1] == 1) GOTO 0xa0; Pop(1)
...
0xa5: Pop(0)
0xa6: Push("all") // @poff=98
0xa7: Push("attack_stay") // @poff=126
0xa8: @ PlayAnimation(Stack[-2], Stack[-1])
0xa9: Pop(2)
0xaa: PushEmpty(bool, float)
0xab: Stack[-25] = Stack[-1]
0xac: Call2 0x1e8
...
0xb1: @ Face(Stack[-0]T)
0xb2: Pop(0)
0xb3: Push("all") // @poff=98
0xb4: Push("fjump") // @poff=150
...
0xcf: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0xd0: Pop(0)
...
0xee: Push("all") // @poff=98
0xef: Push("attack_off") // @poff=162
...
0xfc: Push("all") // @poff=98
0xfd: Push("attack_begin") // @poff=184
0xfe: Push((int) 1)
0xff: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x10a: Push("attack") // @poff=70
0x10b: Push((int) 1)
0x10c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x116: Push("all") // @poff=98
0x117: Push("bjump") // @poff=210
...
0x11e: Push((float)0.8999999761581421)
0x11f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x120: @ GetVictim(Stack[-1], Stack[-4])
0x121: Pop(1)
0x122: @ ReportAttack(Stack[-0]T)
0x123: Pop(0)
...
0x136: Stack[-4] = Stack[-5]
0x137: Pop(4)
0x138: PushEmpty(int)
0x139: Call2 0x29c

0x13a: Pop(0)
0x13b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x13c: Pop(1)
...
0x147: Pop(0)
0x148: @ irand(Stack[-4], Stack[-1]T)
0x149: Pop(0)
0x14a: Push((int) 1)
0x14b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x14c: @ Face(Stack[-0]T)
0x14d: Pop(0)
0x14e: Push((bool) 1)
...
0x153: Pop(0)
0x154: Push("all") // @poff=98
0x155: Push("attack_begin") // @poff=184
...
0x169: Stack[-11] = Stack[-2]
0x16a: Stack[-6] = Stack[-1]
0x16b: Call2 0x11d

0x16c: Pop(2)
0x16d: Push("all") // @poff=98
0x16e: Push("attack_middle") // @poff=222
...
0x18c: Stack[-11] = Stack[-2]
0x18d: Stack[-6] = Stack[-1]
0x18e: Call2 0x11d

0x18f: Pop(2)
0x190: Stack[-2] = (int) 1
0x191: Push("attack_middle") // @poff=222
0x192: Pop(1); Push(Stack[-1] + Stack[-5]);
0x193: Push("_") // @poff=250
0x194: Pop(2); Push(Stack[-2] + Stack[-1]);
0x195: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x196: Push("all") // @poff=98
...
0x1bb: Pop(1)
0x1bc: Push("all") // @poff=98
0x1bd: Push("attack_end") // @poff=254
...
0x1fc: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=84
0x1fd: Pop(0)
...
0x248: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x249: Pop(1)
...
0x24d: @ Face(Stack[-0]T)
0x24e: Pop(0)
0x24f: Push("all") // @poff=98
0x250: Push("bjump") // @poff=210
0x251: @ PlayAnimation(Stack[-2], Stack[-1])
0x252: Pop(2)
0x253: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=84
0x254: Pop(0)
...
0x28a: @ irand(Stack[-1], Stack[-2]T)
0x28b: Pop(0)
0x28c: Push((int) 1)
0x28d: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x28e: Push("attack") // @poff=70
...
0x29f: Stack[-1] = "attack_stay" // @poff=126
0x2a0: Call2 0x5d8
...
0x2ca: Stack[-15] = Stack[-5]
0x2cb: Stack[-14] = Stack[-4]
0x2cc: Stack[-13] = Stack[-3]
0x2cd: Stack[-12] = Stack[-2]
0x2ce: Stack[-11] = Stack[-1]
0x2cf: Call2 0x314

0x2d0: Stack[-6] = Stack[-7]
0x2d1: Pop(6)
0x2d2: Push( Stack[2 + Tasks[-1].StackPointer] )
0x2d3: IF (Stack[-1] == 0) GOTO 0x2d7; Pop(1)

0x2d4: Push("head") // @poff=312
0x2d5: @ UnlookAsync(Stack[-1])
0x2d6: Pop(1)
0x2d7: Push((int) 1)
0x2d8: @ KillTimer(Stack[-1])
0x2d9: Pop(1)
0x2da: Stack[-1] = Stack[-10]
0x2db: Return(); Pop(4)
...
0x317: Stack[-17] = Stack[-7]
0x318: PushEmpty(bool, object)
0x319: Stack[-23] = Stack[-1]
0x31a: Call2 0x3a0
...
0x320: @@ GetPosition(Stack[-5]); Obj=21 // @poff=322
0x321: Pop(0)
...
0x337: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=84
0x338: Pop(0)
...
0x349: Push((int) 0)
0x34a: Push((float)0.30000001192092896)
...
0x36c: Push((int) 0)
0x36d: Push((float)0.30000001192092896)
...
0x3a4: Stack[-2] = Stack[-4]
0x3a5: Pop(2)
0x3a6: Return(); Pop(0)

0x3a7: Stack[-1] = "walk" // @poff=334
0x3a8: Return(); Pop(0)

0x3a9: Stack[-1] = "run" // @poff=344
0x3aa: Return(); Pop(0)

0x3ab: PushEmpty()
0x3ac: PushEmpty(bool, string, string)
0x3ad: Stack[-2] = "quest_b9_01" // @poff=352
0x3ae: Stack[-1] = "doberman_dead" // @poff=376
0x3af: Call2 0x661
...
0x3c2: Stack[-4] = Stack[-2]
0x3c3: Stack[-1] = (float) -0.029999999329447746
0x3c4: Call2 0x623
...
0x3f5: Stack[-6] = "fdie" // @poff=404
0x3f6: GOTO 0x3f8

0x3f7: Stack[-6] = "bdie" // @poff=414
...
0x46f: Stack[-2] = "quest_b9_01" // @poff=352
0x470: Stack[-1] = "factory_fight" // @poff=552
0x471: Call2 0x661
...
0x488: Stack[-2] = "bullet" // @poff=590
0x489: Return(); Pop(0)

0x48a: Stack[-2] = "phys" // @poff=604
0x48b: Return(); Pop(0)

0x48c: PushEmpty(cvector, cvector, cvector, cvector)
0x48d: @ GetPosition(Stack[-2])
0x48e: Pop(0)
0x48f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=322
0x490: Pop(0)
...
0x499: Push("HasProperty") // @poff=614
0x49a: Push((int) 2)
...
0x4a0: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=638
0x4a1: Pop(0)
...
0x4ae: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=650
0x4af: Pop(0)
...
0x4b5: Pop(3)
0x4b6: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=662
0x4b7: Pop(1)
...
0x4cd: Push("armor") // @poff=688
0x4ce: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=650
0x4cf: Pop(1)
0x4d0: Push("armor_") // @poff=700
...
0x4df: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=650
0x4e0: Pop(0)
...
0x4e8: Pop(3)
0x4e9: Push("health") // @poff=674
0x4ea: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=650
0x4eb: Pop(1)
0x4ec: Push((int) 1)
0x4ed: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4ee: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4ef: Push("health") // @poff=674
...
0x4f5: Pop(3)
0x4f6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=662
0x4f7: Pop(2)
...
0x504: @@ IsDead(Stack[-1]); Obj=3 // @poff=714
0x505: Pop(0)
...
0x522: @@ GetScene(Stack[-1]); Obj=5 // @poff=735
0x523: Pop(0)
...
0x537: Stack[-1] = "noaccess" // @poff=744
0x538: Call2 0x498
...
0x53e: Push("noaccess") // @poff=744
0x53f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=650
0x540: Pop(1)
0x541: Push((int) 0)
...
0x553: @@ GetPosition(Stack[-5]); Obj=15 // @poff=322
0x554: Pop(0)
...
0x564: Stack[-1] = "fhit" // @poff=762
0x565: GOTO 0x567

0x566: Stack[-1] = "bhit" // @poff=772
0x567: Push("hit_react") // @poff=782
0x568: Push("1") // @poff=372
0x569: Pop(1); Push(Stack[-3] + Stack[-1]);
0x56a: Push("2") // @poff=802
...
0x598: @@ add(Stack[-5]); Obj=8 // @poff=806
0x599: Pop(0)
0x59a: Push((int) 1)
0x59b: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x59c: GOTO 0x58d

0x59d: @@ size(Stack[-3]); Obj=8 // @poff=810
0x59e: Pop(0)
0x59f: Push(Stack[-3])
...
0x5a2: Pop(0)
0x5a3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=815
0x5a4: Pop(0)
...
0x5b6: Pop(0)
0x5b7: Push("scripted") // @poff=819
0x5b8: Push("blood_dir.xml") // @poff=837
...
0x5c3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=322
0x5c4: Pop(0)
...
0x5ce: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=538
0x5cf: Pop(0)
...
0x60a: Push((float)9.999999974752427e-07)
...
0x614: Stack[-2] = Stack[-3]
0x615: GOTO 0x617

0x616: Stack[-1] = Stack[-3]
0x617: Return(); Pop(0)
...
0x63d: Stack[-8] = Stack[-5]
0x63e: Stack[-4] = "reputation" // @poff=865
0x63f: Stack[-7] = Stack[-3]
0x640: Stack[-2] = (int) 0
0x641: Stack[-1] = (int) 1
0x642: Call2 0x4a4
...
0x659: Pop(0)
0x65a: @@ add(Stack[-3]); Obj=1 // @poff=806
0x65b: Pop(0)
0x65c: Push((int) 16)
...
0x663: Pop(0)
0x664: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x696: Pop(0)
0x697: @@ SetItemName(Stack[-7]); Obj=3 // @poff=915
0x698: Pop(0)
0x699: Push("Organ") // @poff=927
0x69a: Push((int) 1)
0x69b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=662
0x69c: Pop(2)
0x69d: @@ GetItemID(Stack[-2]); Obj=3 // @poff=939
0x69e: Pop(0)
0x69f: Push((int) 0)
0x6a0: Push((int) 1)
...
0x6ad: Stack[-1] = "liver" // @poff=949
0x6ae: Call2 0x694

0x6af: Pop(1)
0x6b0: PushEmpty(string)
0x6b1: Stack[-1] = "kidney" // @poff=961
0x6b2: Call2 0x694

0x6b3: Pop(1)
0x6b4: PushEmpty(string)
0x6b5: Stack[-1] = "heart" // @poff=975
0x6b6: Call2 0x694

0x6b7: Pop(1)
0x6b8: PushEmpty(string)
0x6b9: Stack[-1] = "blood" // @poff=987
0x6ba: Call2 0x694
...
0x6bf: Stack[-7] = Stack[-3]
0x6c0: Stack[-6] = Stack[-2]
0x6c1: Stack[-5] = Stack[-1]
0x6c2: Call2 0x570
...
0x6c7: Stack[-11] = Stack[-5]
0x6c8: Stack[-10] = Stack[-4]
0x6c9: Stack[-9] = Stack[-3]
0x6ca: Stack[-7] = Stack[-2]
0x6cb: Stack[-6] = Stack[-1]
0x6cc: Call2 0x5b4
