...
Strings:
	...
	W:b9q03AglajaTalk
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x63: Stack[-1] = "Isee" // @poff=89
0x64: Call2 0xaa

0x65: Pop(1)
0x66: Push((int) 530278)
0x67: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x68: Pop(1)
0x69: @@@ ClearReplies(); Obj=0 // @poff=110
0x6a: Pop(0)
0x6b: Push((int) 530919)
0x6c: Push((int) 32247)
0x6d: Push((int) 32246)
0x6e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x6f: Pop(3)
0x70: Push((int) 530923)
0x71: Push((int) 32251)
0x72: Push((int) 32250)
0x73: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x74: Pop(3)
0x75: GOTO 0x8c

0x76: PushEmpty(string)
0x77: Stack[-1] = "Neutral" // @poff=132
0x78: Call2 0xaa

0x79: Pop(1)
0x7a: Push((int) 530288)
0x7b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x7c: Pop(1)
0x7d: @@@ ClearReplies(); Obj=0 // @poff=110
0x7e: Pop(0)
0x7f: Push((int) 530289)
0x80: Push((int) -1)
0x81: Push((int) 31677)
0x82: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x83: Pop(3)
0x84: Push((int) 530918)
0x85: Push((int) -1)
0x86: Push((int) 32245)
0x87: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x88: Pop(3)
0x89: GOTO 0x8c
...
0x9b: Push("all") // @poff=148
0x9c: Push("idle") // @poff=156
...
0xa4: Push("all") // @poff=148
0xa5: Push("idle") // @poff=156
...
0xd5: Stack[-1] = "Isee" // @poff=89
0xd6: Call2 0xaa

0xd7: Pop(1)
0xd8: Push((int) 530278)
0xd9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xda: Pop(1)
0xdb: @@@ ClearReplies(); Obj=0 // @poff=110
0xdc: Pop(0)
0xdd: Push((int) 530919)
0xde: Push((int) 32247)
0xdf: Push((int) 32246)
0xe0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xe1: Pop(3)
0xe2: Push((int) 530923)
0xe3: Push((int) 32251)
0xe4: Push((int) 32250)
0xe5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xe6: Pop(3)
0xe7: Return(); Pop(0)

0xe8: PushEmpty(string)
0xe9: Stack[-1] = "Neutral" // @poff=132
0xea: Call2 0xaa

0xeb: Pop(1)
0xec: Push((int) 530288)
0xed: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xee: Pop(1)
0xef: @@@ ClearReplies(); Obj=0 // @poff=110
0xf0: Pop(0)
0xf1: Push((int) 530289)
0xf2: Push((int) -1)
0xf3: Push((int) 31677)
0xf4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xf5: Pop(3)
0xf6: Push((int) 530918)
0xf7: Push((int) -1)
0xf8: Push((int) 32245)
0xf9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xfa: Pop(3)
0xfb: Return(); Pop(0)
...
0x100: Stack[-1] = "Neutral" // @poff=132
0x101: Call2 0xaa

0x102: Pop(1)
0x103: Push((int) 530924)
0x104: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x105: Pop(1)
0x106: @@@ ClearReplies(); Obj=0 // @poff=110
0x107: Pop(0)
0x108: Push((int) 530926)
0x109: Push((int) 32247)
0x10a: Push((int) 32253)
0x10b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x10c: Pop(3)
0x10d: Push((int) 530925)
0x10e: Push((int) 32247)
0x10f: Push((int) 32252)
0x110: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x111: Pop(3)
0x112: Return(); Pop(0)
...
0x117: Stack[-1] = "Isee" // @poff=89
0x118: Call2 0xaa

0x119: Pop(1)
0x11a: Push((int) 530920)
0x11b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x11c: Pop(1)
0x11d: @@@ ClearReplies(); Obj=0 // @poff=110
0x11e: Pop(0)
0x11f: Push((int) 530921)
0x120: Push((int) 32249)
0x121: Push((int) 32248)
0x122: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x123: Pop(3)
0x124: Push((int) 531006)
0x125: Push((int) -1)
0x126: Push((int) 32333)
0x127: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x128: Pop(3)
0x129: Return(); Pop(0)
...
0x12e: Stack[-1] = "Neutral" // @poff=132
0x12f: Call2 0xaa

0x130: Pop(1)
0x131: Push((int) 530922)
0x132: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x133: Pop(1)
0x134: @@@ ClearReplies(); Obj=0 // @poff=110
0x135: Pop(0)
0x136: Push((int) 530279)
0x137: Push((int) 31668)
0x138: Push((int) 31667)
0x139: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x13a: Pop(3)
0x13b: Push((int) 531005)
0x13c: Push((int) 32334)
0x13d: Push((int) 32332)
0x13e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x13f: Pop(3)
0x140: Return(); Pop(0)
...
0x145: Stack[-1] = "Neutral" // @poff=132
0x146: Call2 0xaa

0x147: Pop(1)
0x148: Push((int) 531007)
0x149: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x14a: Pop(1)
0x14b: @@@ ClearReplies(); Obj=0 // @poff=110
0x14c: Pop(0)
0x14d: Push((int) 531008)
0x14e: Push((int) 31668)
0x14f: Push((int) 32335)
0x150: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x151: Pop(3)
0x152: Return(); Pop(0)
...
0x157: Stack[-1] = "Neutral" // @poff=132
0x158: Call2 0xaa

0x159: Pop(1)
0x15a: Push((int) 530280)
0x15b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x15c: Pop(1)
0x15d: @@@ ClearReplies(); Obj=0 // @poff=110
0x15e: Pop(0)
0x15f: Push((int) 531011)
0x160: Push((int) 32340)
0x161: Push((int) 32339)
0x162: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x163: Pop(3)
0x164: Push((int) 531009)
0x165: Push((int) 32338)
0x166: Push((int) 32337)
0x167: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x168: Pop(3)
0x169: Return(); Pop(0)
...
0x16e: Stack[-1] = "Neutral" // @poff=132
0x16f: Call2 0xaa

0x170: Pop(1)
0x171: Push((int) 531010)
0x172: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x173: Pop(1)
0x174: @@@ ClearReplies(); Obj=0 // @poff=110
0x175: Pop(0)
0x176: Push((int) 531013)
0x177: Push((int) 32340)
0x178: Push((int) 32341)
0x179: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x17a: Pop(3)
0x17b: Push((int) 531014)
0x17c: Push((int) -1)
0x17d: Push((int) 32342)
0x17e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x17f: Pop(3)
0x180: Return(); Pop(0)
...
0x185: Stack[-1] = "Threat" // @poff=166
0x186: Call2 0xaa

0x187: Pop(1)
0x188: Push((int) 531012)
0x189: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x18a: Pop(1)
0x18b: @@@ ClearReplies(); Obj=0 // @poff=110
0x18c: Pop(0)
0x18d: Push((int) 530281)
0x18e: Push((int) 31670)
0x18f: Push((int) 31669)
0x190: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x191: Pop(3)
0x192: Push((int) 531016)
0x193: Push((int) -1)
0x194: Push((int) 32345)
0x195: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x196: Pop(3)
0x197: Return(); Pop(0)
...
0x19c: Stack[-1] = "Neutral" // @poff=132
0x19d: Call2 0xaa

0x19e: Pop(1)
0x19f: Push((int) 530282)
0x1a0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1a1: Pop(1)
0x1a2: @@@ ClearReplies(); Obj=0 // @poff=110
0x1a3: Pop(0)
0x1a4: Push((int) 530283)
0x1a5: Push((int) -1)
0x1a6: Push((int) 31671)
0x1a7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1a8: Pop(3)
0x1a9: Push((int) 531015)
0x1aa: Push((int) 32346)
0x1ab: Push((int) 32344)
0x1ac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1ad: Pop(3)
0x1ae: Return(); Pop(0)
...
0x1b3: Stack[-1] = "Neutral" // @poff=132
0x1b4: Call2 0xaa

0x1b5: Pop(1)
0x1b6: Push((int) 531017)
0x1b7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1b8: Pop(1)
0x1b9: @@@ ClearReplies(); Obj=0 // @poff=110
0x1ba: Pop(0)
...
0x1c3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1c4: Pop(3)
0x1c5: Return(); Pop(0)
...
0x1e3: Stack[-1] = "Neutral" // @poff=132
0x1e4: Call2 0x31a
...
0x22c: @@ GetPosition(Stack[-1]); Obj=3 // @poff=212
0x22d: Pop(0)
0x22e: PushEmpty(bool, cvector)
0x22f: Stack[-3] = Stack[-1]
0x230: Call2 0x221

0x231: Stack[-2] = Stack[-6]
0x232: Pop(2)
0x233: Return(); Pop(2)
...
0x23a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=212
0x23b: Pop(0)
0x23c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=224
0x23d: Pop(0)
...
0x2a9: Push("voice_common") // @poff=248
0x2aa: Push((int) 1)
...
0x2b1: Push("voice_common") // @poff=248
0x2b2: Push((int) 0)
...
0x2c4: Push("voice_common") // @poff=248
0x2c5: Push((int) 1)
...
0x2d2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x2d3: Pop(1)
...
0x2fd: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=278
0x2fe: Pop(1)
...
0x312: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=290
0x313: Pop(1)
0x314: PushEmpty(bool, string)
0x315: Stack[-3] = Stack[-1]
0x316: Call2 0x339

0x317: Stack[-2] = Stack[-14]
0x318: Pop(2)
0x319: Return(); Pop(10)
...
0x325: Push("Can't find lsh animation : ") // @poff=306
...
0x334: Push("Can't find lsh animation : ") // @poff=306
...
0x358: Push((float)9.999999974752427e-07)
...
0x371: Stack[-1] = "ui/NPC_Aglaja.png" // @poff=362
0x372: Return(); Pop(0)

0x373: Stack[-1] = "ui/NPC_Aglaja_b.png" // @poff=398
0x374: Return(); Pop(0)
...
0x377: PushEmpty()
0x378: Push("b9q03AglajaTalk") // @poff=438
0x379: Push((int) 1)
...
0x37f: Stack[-1] = "b9q03AglajaTalk" // @poff=438
0x380: Call2 0x35f
