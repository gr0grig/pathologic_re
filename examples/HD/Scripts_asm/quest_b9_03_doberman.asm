...
Strings:
	...
	W:battle
	W:b9q03DobermanGotoFollower
	W:pt_b9q03_follower
	A:AddMark
	A:ShowMap
	W:oob9DobermanSpi4ka1_1
	W:place_follower
	W:init_bonefires
	...
	W:doberman_dead
// @pool_raw:
// @pool_encoding:utf8
...
0x155: Stack[-2] = "quest_b9_03" // @poff=156
0x156: Stack[-1] = "doberman_attack" // @poff=180
0x157: Call2 0x8f7
...
0x283: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x284: Pop(0)
0x285: Push(Stack[-8])
0x286: IF (Stack[-1] == 0) GOTO 0x28f; Pop(1)

0x287: Push("attack") // @poff=198
...
0x2a3: Pop(0)
0x2a4: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=308
0x2a5: Pop(0)
...
0x2bf: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=308
0x2c0: Pop(0)
...
0x2d9: Pop(1)
0x2da: Push("all") // @poff=138
0x2db: Push("attack_on") // @poff=322
...
0x2f3: IF (Stack[-1] == 1) GOTO 0x2f9; Pop(1)

0x2f4: PushEmpty(bool)
0x2f5: Call2 0x4c5

0x2f6: Pop(0)
0x2f7: IF (Stack[-1] == 1) GOTO 0x2f9; Pop(1)

0x2f8: Stack[-1] = (bool) 0
0x2f9: IF (Stack[-1] == 0) GOTO 0x30a; Pop(1)

0x2fa: @ Face(Stack[-0]T)
0x2fb: Pop(0)
0x2fc: PushEmpty()
0x2fd: Call2 0x4f7
...
0x30a: @ Face(Stack[-0]T)
0x30b: Pop(0)
0x30c: Push("all") // @poff=138
0x30d: Push("fjump") // @poff=366
...
0x328: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=308
0x329: Pop(0)
...
0x347: Push("all") // @poff=138
0x348: Push("attack_off") // @poff=378
...
0x355: Push("all") // @poff=138
0x356: Push("attack_begin") // @poff=400
0x357: Push((int) 1)
0x358: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x363: Push("attack") // @poff=198
0x364: Push((int) 1)
0x365: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x377: Push((float)0.8999999761581421)
0x378: Pop(1); Push(Stack[-9] * Stack[-1]);
0x379: @ GetVictim(Stack[-1], Stack[-4])
0x37a: Pop(1)
0x37b: @ ReportAttack(Stack[-0]T)
0x37c: Pop(0)
...
0x380: Stack[-6] = Stack[-2]
0x381: Stack[-10] = Stack[-1]
0x382: Call2 0x262

0x383: Stack[-3] = Stack[-5]
0x384: Pop(3)
0x385: PushEmpty(float, object, float, int)
0x386: Stack[-7] = Stack[-3]
0x387: Stack[-6] = Stack[-2]
0x388: PushEmpty(int, object, int)
0x389: Stack[-10] = Stack[-2]
0x38a: Stack[-14] = Stack[-1]
0x38b: Call2 0x265

0x38c: Stack[-3] = Stack[-4]
0x38d: Pop(3)
0x38e: Call2 0x6e2

0x38f: Stack[-4] = Stack[-5]
0x390: Pop(4)
0x391: PushEmpty(int)
0x392: Call2 0x4f5

0x393: Pop(0)
0x394: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x395: Pop(1)
...
0x3a0: Pop(0)
0x3a1: @ irand(Stack[-4], Stack[-1]T)
0x3a2: Pop(0)
0x3a3: Push((int) 1)
0x3a4: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3a5: @ Face(Stack[-0]T)
0x3a6: Pop(0)
0x3a7: Push((bool) 1)
...
0x3ac: Pop(0)
0x3ad: Push("all") // @poff=138
0x3ae: Push("attack_begin") // @poff=400
...
0x3c2: Stack[-11] = Stack[-2]
0x3c3: Stack[-6] = Stack[-1]
0x3c4: Call2 0x376

0x3c5: Pop(2)
0x3c6: Push("all") // @poff=138
0x3c7: Push("attack_middle") // @poff=438
...
0x3d1: Push("attack_middle") // @poff=438
...
0x3e5: Stack[-11] = Stack[-2]
0x3e6: Stack[-6] = Stack[-1]
0x3e7: Call2 0x376

0x3e8: Pop(2)
0x3e9: Stack[-2] = (int) 1
0x3ea: Push("attack_middle") // @poff=438
0x3eb: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3ec: Push("_") // @poff=466
0x3ed: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3ee: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x3ef: Push("all") // @poff=138
...
0x416: Push("attack_end") // @poff=470
...
0x455: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=308
0x456: Pop(0)
...
0x4a1: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x4a2: Pop(1)
...
0x4a6: @ Face(Stack[-0]T)
0x4a7: Pop(0)
0x4a8: Push("all") // @poff=138
0x4a9: Push("bjump") // @poff=426
0x4aa: @ PlayAnimation(Stack[-2], Stack[-1])
0x4ab: Pop(2)
0x4ac: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=308
0x4ad: Pop(0)
...
0x4e3: @ irand(Stack[-1], Stack[-2]T)
0x4e4: Pop(0)
0x4e5: Push((int) 1)
0x4e6: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x4e7: Push("attack") // @poff=198
...
0x4f8: Stack[-1] = "attack_stay" // @poff=342
0x4f9: Call2 0x891
...
0x529: Stack[-15] = Stack[-5]
0x52a: Stack[-14] = Stack[-4]
0x52b: Stack[-13] = Stack[-3]
0x52c: Stack[-12] = Stack[-2]
0x52d: Stack[-11] = Stack[-1]
0x52e: Call2 0x573

0x52f: Stack[-6] = Stack[-7]
0x530: Pop(6)
0x531: Push( Stack[2 + Tasks[-1].StackPointer] )
0x532: IF (Stack[-1] == 0) GOTO 0x536; Pop(1)

0x533: Push("head") // @poff=242
...
0x576: Stack[-17] = Stack[-7]
0x577: PushEmpty(bool, object)
0x578: Stack[-23] = Stack[-1]
0x579: Call2 0x5ff
...
0x57f: @@ GetPosition(Stack[-5]); Obj=21 // @poff=528
0x580: Pop(0)
...
0x596: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=308
0x597: Pop(0)
...
0x5a8: Push((int) 0)
0x5a9: Push((float)0.30000001192092896)
...
0x5cb: Push((int) 0)
0x5cc: Push((float)0.30000001192092896)
...
0x606: Stack[-1] = "walk" // @poff=540
0x607: Return(); Pop(0)

0x608: Stack[-1] = "run" // @poff=550
0x609: Return(); Pop(0)

0x60a: PushEmpty()
0x60b: PushEmpty(string, int, int, int)
0x60c: Stack[-4] = "samopal_ammo" // @poff=558
0x60d: Stack[-3] = (int) 1
0x60e: Stack[-2] = (int) 1
0x60f: Stack[-1] = (int) 4
0x610: Call2 0x882
...
0x63a: Pop(0); PushNull((bool) Stack[-21] == 0)
0x63b: IF (Stack[-1] == 0) GOTO 0x641; Pop(1)

0x63c: PushEmpty(string)
0x63d: Stack[-1] = "fdie" // @poff=584
0x63e: Call2 0x694

0x63f: Pop(1)
0x640: GOTO 0x693

0x641: @@ GetPosition(Stack[-10]); Obj=21 // @poff=528
0x642: Pop(0)
...
0x652: Stack[-6] = "fdie" // @poff=584
0x653: GOTO 0x655

0x654: Stack[-6] = "bdie" // @poff=594
...
0x65b: @ StopAsync()
0x65c: Pop(0)
0x65d: Stack[-21] = Stack[-5]
0x65e: Push("GetScriptProperty") // @poff=604
0x65f: Push((int) 2)
0x660: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x661: IF (Stack[-1] == 0) GOTO 0x66d; Pop(1)

0x662: Push("Owner") // @poff=640
0x663: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=652
0x664: Pop(1)
0x665: Push(Stack[-4])
0x666: IF (Stack[-1] == 0) GOTO 0x66d; Pop(1)

0x667: Push("Owner") // @poff=640
0x668: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=670
0x669: Pop(1)
0x66a: Pop(0); PushNull((bool) Stack[-5] == 0)
0x66b: IF (Stack[-1] == 0) GOTO 0x66d; Pop(1)

0x66c: Stack[-21] = Stack[-5]
0x66d: Push("@GetEyesHeight") // @poff=688
0x66e: Push((int) 1)
0x66f: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x670: IF (Stack[-1] == 0) GOTO 0x67c; Pop(1)

0x671: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=718
0x672: Pop(0)
0x673: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x674: Push(CvectorIndex(Stack[-1], 1))
0x675: Stack[-3] = Stack[-1]
0x676: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x677: Push("head") // @poff=242
...
0x688: @ StopAsync()
0x689: Pop(0)
0x68a: Push("head") // @poff=242
0x68b: @ UnlookAsync(Stack[-1])
0x68c: Pop(1)
0x68d: Push("all") // @poff=138
...
0x6be: Stack[-2] = "bullet" // @poff=742
0x6bf: Return(); Pop(0)

0x6c0: Stack[-2] = "phys" // @poff=756
0x6c1: Return(); Pop(0)

0x6c2: PushEmpty(cvector, cvector, cvector, cvector)
0x6c3: @ GetPosition(Stack[-2])
0x6c4: Pop(0)
0x6c5: @@ GetPosition(Stack[-1]); Obj=5 // @poff=528
0x6c6: Pop(0)
...
0x6cb: Pop(0)
0x6cc: @@ GetPosition(Stack[-2]); Obj=7 // @poff=528
0x6cd: Pop(0)
...
0x6d3: Pop(0)
0x6d4: Stack[-1] = Stack[-4]
0x6d5: Return(); Pop(2)

0x6d6: PushEmpty(bool, bool)
0x6d7: Push("HasProperty") // @poff=766
0x6d8: Push((int) 2)
...
0x6de: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=790
0x6df: Pop(0)
0x6e0: Stack[-1] = Stack[-5]
0x6e1: Return(); Pop(2)

0x6e2: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x6e3: PushEmpty(bool, object, string)
0x6e4: Stack[-18] = Stack[-2]
0x6e5: Stack[-1] = "health" // @poff=802
0x6e6: Call2 0x6d6
...
0x6ed: Stack[-18] = Stack[-2]
0x6ee: Stack[-1] = "armor" // @poff=816
0x6ef: Call2 0x6d6
...
0x6f5: Push("armor") // @poff=816
0x6f6: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=828
0x6f7: Pop(1)
0x6f8: Push("armor_") // @poff=840
0x6f9: PushEmpty(string, int)
0x6fa: Stack[-16] = Stack[-1]
0x6fb: Call2 0x6b4

0x6fc: Pop(1)
0x6fd: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6fe: PushEmpty(bool, object, string)
0x6ff: Stack[-18] = Stack[-2]
0x700: Stack[-8] = Stack[-1]
0x701: Call2 0x6d6
...
0x707: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=828
0x708: Pop(0)
...
0x70f: Stack[-3] = Stack[-6]
0x710: Pop(3)
0x711: Push("health") // @poff=802
0x712: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=828
0x713: Pop(1)
0x714: Push((int) 1)
0x715: Pop(1); Push(Stack[-1] - Stack[-4]);
0x716: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x717: Push("health") // @poff=802
...
0x71d: Pop(3)
0x71e: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=854
0x71f: Pop(2)
0x720: PushEmpty(bool, object)
0x721: Stack[-17] = Stack[-1]
0x722: Call2 0x6d1
...
0x728: Pop(1)
0x729: Stack[-1] = Stack[-16]
0x72a: Return(); Pop(12)

0x72b: PushEmpty(bool, bool)
0x72c: @@ IsDead(Stack[-1]); Obj=3 // @poff=866
0x72d: Pop(0)
0x72e: Stack[-1] = Stack[-4]
0x72f: Return(); Pop(2)

0x730: PushEmpty(object, object, object, object)
0x731: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x745: Pop(0)
0x746: Pop(0); PushNull((bool) Stack[-2] == 0)
0x747: IF (Stack[-1] == 0) GOTO 0x74a; Pop(1)

0x748: Stack[-6] = (bool) 0
0x749: Return(); Pop(4)

0x74a: @@ GetScene(Stack[-1]); Obj=5 // @poff=887
0x74b: Pop(0)
...
0x75e: Stack[-6] = Stack[-2]
0x75f: Stack[-1] = "noaccess" // @poff=896
0x760: Call2 0x6d6
...
0x766: Push("noaccess") // @poff=896
0x767: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=828
0x768: Pop(1)
0x769: Push((int) 0)
...
0x76d: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x77b: @@ GetPosition(Stack[-5]); Obj=15 // @poff=528
0x77c: Pop(0)
...
0x78c: Stack[-1] = "fhit" // @poff=914
0x78d: GOTO 0x78f

0x78e: Stack[-1] = "bhit" // @poff=924
0x78f: Push("hit_react") // @poff=934
0x790: Push("1") // @poff=954
0x791: Pop(1); Push(Stack[-3] + Stack[-1]);
0x792: Push("2") // @poff=958
...
0x7ab: Stack[-25] = Stack[-1]
0x7ac: Call2 0x6c2

0x7ad: Stack[-2] = Stack[-3]
0x7ae: Pop(2)
0x7af: Call2 0x8c0

0x7b0: Stack[-2] = Stack[-11]
0x7b1: Pop(2)
0x7b2: @ CreateVectorVector(Stack[-8])
0x7b3: Pop(0)
0x7b4: Stack[-7] = (int) 1
0x7b5: Push("hit") // @poff=916
...
0x7ca: Pop(0)
0x7cb: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=971
0x7cc: Pop(0)
0x7cd: PushEmpty(object, int, float, cvector, cvector)
0x7ce: Stack[-26] = Stack[-5]
0x7cf: Stack[-25] = Stack[-4]
0x7d0: Stack[-24] = Stack[-3]
0x7d1: Stack[-6] = Stack[-2]
...
0x7eb: @@ GetPosition(Stack[-3]); Obj=7 // @poff=528
0x7ec: Pop(0)
...
0x7fb: @@ GetPosition(Stack[-8]); Obj=20 // @poff=528
0x7fc: Pop(0)
0x7fd: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=718
0x7fe: Pop(0)
...
0x85c: Push("Can't find lsh animation : ") // @poff=1021
...
0x86b: Push("Can't find lsh animation : ") // @poff=1021
...
0x884: Stack[-10] = Stack[-2]
0x885: Stack[-9] = Stack[-1]
0x886: Call2 0x8dc
...
0x8c3: Push((float)9.999999974752427e-07)
...
0x8cd: Stack[-2] = Stack[-3]
0x8ce: GOTO 0x8d0

0x8cf: Stack[-1] = Stack[-3]
0x8d0: Return(); Pop(0)
...
0x8f9: Pop(0)
0x8fa: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x91f: Stack[-1] = Stack[-2]
0x920: Pop(1)
0x921: Push("b9q03DobermanGotoFollower") // @poff=1091
0x922: Push("pt_b9q03_follower") // @poff=1143
0x923: Push((int) 0)
...
0x927: Pop(0)
0x928: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1179
0x929: Pop(5)
0x92a: PushEmpty()
0x92b: Call2 0x97f
...
0x92e: Stack[-2] = "quest_b9_03" // @poff=156
0x92f: Stack[-1] = "doberman_attack" // @poff=180
0x930: Call2 0x8f7
...
0x936: Pop(1)
0x937: Stack[-2] = "pt_b9q03_follower" // @poff=1143
0x938: Stack[-1] = (int) 2
0x939: Call2 0x9c6
...
0x93d: Pop(0)
0x93e: @@ ShowMap(Stack[-1]); Obj=4 // @poff=1187
0x93f: Pop(1)
0x940: Return(); Pop(2)

0x941: Stack[-1] = 0
0x942: PushEmpty()
0x943: Push("oob9DobermanSpi4ka1_1") // @poff=1195
0x944: Push((int) 1)
...
0x94c: Pop(1)
0x94d: Push("b9q03DobermanGotoFollower") // @poff=1091
0x94e: Push("pt_b9q03_follower") // @poff=1143
0x94f: Push((int) 0)
...
0x953: Pop(0)
0x954: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1179
0x955: Pop(5)
0x956: PushEmpty()
0x957: Call2 0x97f
...
0x95a: Stack[-2] = "quest_b9_03" // @poff=156
0x95b: Stack[-1] = "place_follower" // @poff=1239
0x95c: Call2 0x8f7

0x95d: Pop(3)
0x95e: PushEmpty(bool, string, string)
0x95f: Stack[-2] = "quest_b9_03" // @poff=156
0x960: Stack[-1] = "init_bonefires" // @poff=1269
0x961: Call2 0x8f7
...
0x966: Stack[-1] = Stack[-4]
0x967: Pop(1)
0x968: Stack[-2] = "pt_b9q03_follower" // @poff=1143
0x969: Stack[-1] = (int) 2
0x96a: Call2 0x9c6
...
0x96e: Pop(0)
0x96f: @@ ShowMap(Stack[-1]); Obj=4 // @poff=1187
0x970: Pop(1)
0x971: Return(); Pop(2)
...
0x975: Stack[-1] = "oob9DobermanSpi4ka1_1" // @poff=1195
0x976: Call2 0x8e1
...
0x991: Push("Can't retrieve diary root") // @poff=1299
0x992: @ Trace(Stack[-1])
0x993: Pop(1)
0x994: Stack[-3] = (bool) 0
0x995: Return(); Pop(2)

0x996: Stack[-1] = Stack[-3]
0x997: Return(); Pop(2)
...
0x99c: Stack[-1] = Stack[-4]
0x99d: Pop(1)
0x99e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1351
0x99f: Pop(0)
0x9a0: Pop(0); Push((bool) Stack[-2] == 0)
0x9a1: IF (Stack[-1] == 0) GOTO 0x9a8; Pop(1)

0x9a2: Push("Can't find diary parent with id: ") // @poff=1356
...
0x9a8: @@ AddChild(Stack[-8]); Obj=2 // @poff=1424
0x9a9: Pop(0)
0x9aa: Push((int) 7)
0x9ab: @ SendWorldWndMessage(Stack[-1])
0x9ac: Pop(1)
0x9ad: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1433
0x9ae: Pop(0)
...
0x9b7: Pop(0)
0x9b8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x9b9: IF (Stack[-1] == 0) GOTO 0x9c0; Pop(1)

0x9ba: Push("Can't find main outdoor scene") // @poff=1445
0x9bb: @ Trace(Stack[-1])
0x9bc: Pop(1)
0x9bd: Stack[-1] = 0
...
0x9c0: @@ GetMap(Stack[-1]); Obj=2 // @poff=1505
0x9c1: Pop(0)
0x9c2: Stack[-1] = Stack[-5]
0x9c3: Return(); Pop(4)
...
0x9c8: Pop(0)
0x9c9: Pop(0); PushNull((bool) Stack[-2] == 0)
0x9ca: IF (Stack[-1] == 0) GOTO 0x9cf; Pop(1)

0x9cb: Push("Can't find main outdoor scene") // @poff=1445
0x9cc: @ Trace(Stack[-1])
0x9cd: Pop(1)
0x9ce: Return(); Pop(8)

0x9cf: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1512
0x9d0: Pop(0)
0x9d1: Pop(0); Push((bool) Stack[-1] == 0)
0x9d2: IF (Stack[-1] == 0) GOTO 0x9d9; Pop(1)

0x9d3: Push("Warning: outdoor scene locator ") // @poff=1523
0x9d4: Pop(1); Push(Stack[-1] + Stack[-11]);
0x9d5: Push(" doesnt exist") // @poff=1587
0x9d6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x9d7: @ Trace(Stack[-1])
0x9d8: Pop(1)
0x9d9: @@ GetMap(Stack[-11]); Obj=2 // @poff=1505
0x9da: Pop(0)
0x9db: Pop(0); PushNull((bool) Stack[-11] == 0)
0x9dc: IF (Stack[-1] == 0) GOTO 0x9e1; Pop(1)

0x9dd: Push("Can't find map") // @poff=1615
0x9de: @ Trace(Stack[-1])
0x9df: Pop(1)
0x9e0: Return(); Pop(8)
...
0x9e3: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1645
0x9e4: Pop(2)
0x9e5: Return(); Pop(8)
...
0x9f6: Pop(0)
0x9f7: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1658
0x9f8: Pop(0)
0x9f9: Push("Organ") // @poff=1670
0x9fa: Push((int) 1)
0x9fb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=854
0x9fc: Pop(2)
0x9fd: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1682
0x9fe: Pop(0)
0x9ff: Push((int) 0)
0xa00: Push((int) 1)
...
0xa0d: Stack[-1] = "liver" // @poff=1692
0xa0e: Call2 0x9f4

0xa0f: Pop(1)
0xa10: PushEmpty(string)
0xa11: Stack[-1] = "kidney" // @poff=1704
0xa12: Call2 0x9f4

0xa13: Pop(1)
0xa14: PushEmpty(string)
0xa15: Stack[-1] = "heart" // @poff=1718
0xa16: Call2 0x9f4

0xa17: Pop(1)
0xa18: PushEmpty(string)
0xa19: Stack[-1] = "blood" // @poff=1730
0xa1a: Call2 0x9f4
...
0xa50: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1756
0xa51: Return(); Pop(0)

0xa52: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1796
0xa53: Return(); Pop(0)
...
0xa58: Stack[-2] = "quest_b9_03" // @poff=156
0xa59: Stack[-1] = "doberman_dead" // @poff=1840
0xa5a: Call2 0x8f7
...
0xa65: Stack[-7] = Stack[-3]
0xa66: Stack[-6] = Stack[-2]
0xa67: Stack[-5] = Stack[-1]
0xa68: Call2 0x798
...
0xa6d: Stack[-11] = Stack[-5]
0xa6e: Stack[-10] = Stack[-4]
0xa6f: Stack[-9] = Stack[-3]
0xa70: Stack[-7] = Stack[-2]
0xa71: Stack[-6] = Stack[-1]
0xa72: Call2 0x7dc
