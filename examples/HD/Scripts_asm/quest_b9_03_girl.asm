...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1a8: Push("player") // @poff=172
0x1a9: @ FindActor(Stack[-4]T, Stack[-1])
0x1aa: Pop(1)
...
0x1bd: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x248: Pop(0)
0x249: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x24a: Pop(0)
...
0x254: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x255: Pop(0)
0x256: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x257: Pop(0)
...
0x2b5: Push("Can't find lsh animation : ") // @poff=222
...
0x2c4: Push("Can't find lsh animation : ") // @poff=222
...
0x2ca: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2cb: Pop(0)
...
0x2e4: Push((float)9.999999974752427e-07)
...
0x30c: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=278
0x30d: Return(); Pop(0)

0x30e: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=318
0x30f: Return(); Pop(0)
...
0x31f: Stack[-1] = "oob9Girl1" // @poff=362
0x320: Call2 0x2eb
...
0x33b: Push("Can't retrieve diary root") // @poff=382
0x33c: @ Trace(Stack[-1])
0x33d: Pop(1)
0x33e: Stack[-3] = (bool) 0
0x33f: Return(); Pop(2)

0x340: Stack[-1] = Stack[-3]
0x341: Return(); Pop(2)
...
0x347: Pop(1)
0x348: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=434
0x349: Pop(0)
0x34a: Pop(0); Push((bool) Stack[-2] == 0)
0x34b: IF (Stack[-1] == 0) GOTO 0x352; Pop(1)

0x34c: Push("Can't find diary parent with id: ") // @poff=439
...
0x352: @@ AddChild(Stack[-8]); Obj=2 // @poff=507
0x353: Pop(0)
0x354: Push((int) 7)
0x355: @ SendWorldWndMessage(Stack[-1])
0x356: Pop(1)
0x357: @@ GetCategory(Stack[-1]); Obj=8 // @poff=516
0x358: Pop(0)
