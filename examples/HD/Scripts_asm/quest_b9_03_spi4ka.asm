...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x62: Stack[-1] = "Azart" // @poff=89
0x63: Call2 0xa4

0x64: Pop(1)
0x65: Push((int) 530337)
0x66: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x67: Pop(1)
0x68: @@@ ClearReplies(); Obj=0 // @poff=112
0x69: Pop(0)
...
0x76: Stack[-1] = "Neutral" // @poff=134
0x77: Call2 0xa4

0x78: Pop(1)
0x79: Push((int) 530341)
0x7a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x7b: Pop(1)
0x7c: @@@ ClearReplies(); Obj=0 // @poff=112
0x7d: Pop(0)
0x7e: Push((int) 530342)
0x7f: Push((int) -1)
0x80: Push((int) 31729)
0x81: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x82: Pop(3)
0x83: GOTO 0x86
...
0x95: Push("all") // @poff=150
0x96: Push("idle") // @poff=158
...
0x9e: Push("all") // @poff=150
0x9f: Push("idle") // @poff=158
...
0xce: Stack[-1] = "Azart" // @poff=89
0xcf: Call2 0xa4

0xd0: Pop(1)
0xd1: Push((int) 530337)
0xd2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xd3: Pop(1)
0xd4: @@@ ClearReplies(); Obj=0 // @poff=112
0xd5: Pop(0)
0xd6: Push((int) 530338)
0xd7: Push((int) 32415)
0xd8: Push((int) 31725)
0xd9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xda: Pop(3)
0xdb: Push((int) 531096)
0xdc: Push((int) 32418)
0xdd: Push((int) 32414)
0xde: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xdf: Pop(3)
0xe0: Return(); Pop(0)

0xe1: PushEmpty(string)
0xe2: Stack[-1] = "Neutral" // @poff=134
0xe3: Call2 0xa4

0xe4: Pop(1)
0xe5: Push((int) 530341)
0xe6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xe7: Pop(1)
0xe8: @@@ ClearReplies(); Obj=0 // @poff=112
0xe9: Pop(0)
0xea: Push((int) 530342)
0xeb: Push((int) -1)
0xec: Push((int) 31729)
0xed: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xee: Pop(3)
0xef: Return(); Pop(0)
...
0xf4: Stack[-1] = "Azart" // @poff=89
0xf5: Call2 0xa4

0xf6: Pop(1)
0xf7: Push((int) 531100)
0xf8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xf9: Pop(1)
0xfa: @@@ ClearReplies(); Obj=0 // @poff=112
0xfb: Pop(0)
0xfc: Push((int) 531101)
0xfd: Push((int) -1)
0xfe: Push((int) 32419)
0xff: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x100: Pop(3)
0x101: Push((int) 531102)
0x102: Push((int) 31726)
0x103: Push((int) 32420)
0x104: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x105: Pop(3)
0x106: Return(); Pop(0)
...
0x10b: Stack[-1] = "Serious" // @poff=168
0x10c: Call2 0xa4

0x10d: Pop(1)
0x10e: Push((int) 530339)
0x10f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x110: Pop(1)
0x111: @@@ ClearReplies(); Obj=0 // @poff=112
0x112: Pop(0)
0x113: Push((int) 531202)
0x114: Push((int) 32518)
0x115: Push((int) 32511)
0x116: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x117: Pop(3)
0x118: Push((int) 530340)
0x119: Push((int) -1)
0x11a: Push((int) 31727)
0x11b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x11c: Pop(3)
0x11d: Return(); Pop(0)
...
0x122: Stack[-1] = "Serious" // @poff=168
0x123: Call2 0xa4

0x124: Pop(1)
0x125: Push((int) 531208)
0x126: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x127: Pop(1)
0x128: @@@ ClearReplies(); Obj=0 // @poff=112
0x129: Pop(0)
0x12a: Push((int) 531209)
0x12b: Push((int) -1)
0x12c: Push((int) 32519)
0x12d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x12e: Pop(3)
0x12f: Push((int) 531210)
0x130: Push((int) 32521)
0x131: Push((int) 32520)
0x132: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x133: Pop(3)
0x134: Return(); Pop(0)
...
0x139: Stack[-1] = "Fear" // @poff=184
0x13a: Call2 0xa4

0x13b: Pop(1)
0x13c: Push((int) 531211)
0x13d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x13e: Pop(1)
0x13f: @@@ ClearReplies(); Obj=0 // @poff=112
0x140: Pop(0)
...
0x24f: Stack[-1] = "Neutral" // @poff=134
0x250: Call2 0x3cc
...
0x25e: Stack[-1] = "Neutral" // @poff=134
0x25f: Call2 0x3cc
...
0x275: Stack[-1] = "Neutral" // @poff=134
0x276: Call2 0x3cc
...
0x2cd: Pop(0)
0x2ce: @@ GetPosition(Stack[-2]); Obj=7 // @poff=254
0x2cf: Pop(0)
...
0x2de: @@ GetPosition(Stack[-1]); Obj=3 // @poff=254
0x2df: Pop(0)
...
0x2ec: @@ GetPosition(Stack[-8]); Obj=20 // @poff=254
0x2ed: Pop(0)
0x2ee: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=266
0x2ef: Pop(0)
...
0x315: Pop(0)
0x316: Push((bool) 1)
0x317: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x318: Pop(1)
...
0x331: Push((bool) 1)
0x332: @ CameraSwitchToNormal(Stack[-1])
0x333: Pop(1)
...
0x339: Push("head") // @poff=280
0x33a: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x33b: Pop(1)
0x33c: Push(Stack[-1])
0x33d: IF (Stack[-1] == 0) GOTO 0x341; Pop(1)

0x33e: Push("head") // @poff=280
0x33f: @ UnlookAsync(Stack[-1])
0x340: Pop(1)
0x341: Return(); Pop(2)

0x342: PushEmpty(int, int, int, int)
0x343: Push("voice_common") // @poff=290
0x344: @ GetVariable(Stack[-1], Stack[-3])
0x345: Pop(1)
0x346: Push(Stack[-2])
0x347: IF (Stack[-1] == 0) GOTO 0x368; Pop(1)
...
0x356: Push((int) 2)
0x357: @ irand(Stack[-2], Stack[-1])
0x358: Pop(1)
0x359: Push(Stack[-1])
0x35a: IF (Stack[-1] == 0) GOTO 0x363; Pop(1)

0x35b: Push("voice_common") // @poff=290
0x35c: Push((int) 1)
...
0x363: Push("voice_common") // @poff=290
0x364: Push((int) 0)
...
0x36d: IF (Stack[-1] == 0) GOTO 0x376; Pop(1)
...
0x374: Stack[-6] = (bool) 0
0x375: Return(); Pop(4)

0x376: Push("voice_common") // @poff=290
0x377: Push((int) 1)
...
0x37c: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x37d: Stack[-5] = "c" // @poff=316
0x37e: Stack[-4] = (int) 0
0x37f: Push((int) 1)
...
0x384: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=320
0x385: Pop(1)
...
0x399: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=332
0x39a: Pop(1)
...
0x3a1: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3a2: Push("d") // @poff=286
0x3a3: PushEmpty(int)
0x3a4: Call2 0x416

0x3a5: Pop(0)
0x3a6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3a7: Push("m") // @poff=344
0x3a8: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3a9: Stack[-4] = (int) 0
0x3aa: Push((int) 1)
...
0x3af: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=320
0x3b0: Pop(1)
...
0x3c4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=332
0x3c5: Pop(1)
0x3c6: PushEmpty(bool, string)
0x3c7: Stack[-3] = Stack[-1]
0x3c8: Call2 0x3eb

0x3c9: Stack[-2] = Stack[-14]
0x3ca: Pop(2)
0x3cb: Return(); Pop(10)

0x3cc: PushEmpty(bool, float, float, bool, float, float)
0x3cd: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3ce: Pop(0)
0x3cf: Push(Stack[-3])
0x3d0: IF (Stack[-1] == 0) GOTO 0x3d7; Pop(1)

0x3d1: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3d2: Pop(0)
0x3d3: Push((bool) 0)
0x3d4: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3d5: Pop(1)
0x3d6: GOTO 0x3db

0x3d7: Push("Can't find lsh animation : ") // @poff=348
0x3d8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3d9: @ Trace(Stack[-1])
0x3da: Pop(1)
0x3db: Return(); Pop(6)

0x3dc: PushEmpty(bool, float, float, bool, float, float)
0x3dd: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3de: Pop(0)
0x3df: Push(Stack[-3])
0x3e0: IF (Stack[-1] == 0) GOTO 0x3e6; Pop(1)

0x3e1: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3e2: Pop(0)
0x3e3: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3e4: Pop(0)
0x3e5: GOTO 0x3ea

0x3e6: Push("Can't find lsh animation : ") // @poff=348
0x3e7: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3e8: @ Trace(Stack[-1])
0x3e9: Pop(1)
0x3ea: Return(); Pop(6)
...
0x3ee: Pop(0)
0x3ef: IF (Stack[-1] == 0) GOTO 0x3f8; Pop(1)

0x3f0: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3f1: Pop(0)
0x3f2: Push(Stack[-1])
0x3f3: IF (Stack[-1] == 0) GOTO 0x3f8; Pop(1)

0x3f4: @ lshPlaySpeech(Stack[-3])
0x3f5: Pop(0)
0x3f6: Stack[-4] = (bool) 1
0x3f7: Return(); Pop(2)

0x3f8: Stack[-4] = (bool) 0
0x3f9: Return(); Pop(2)
...
0x408: Pop(0); Push(Stack[-3] | Stack[-3]);
0x409: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x40a: Push((float)9.999999974752427e-07)
0x40b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x40c: IF (Stack[-1] == 0) GOTO 0x40f; Pop(1)

0x40d: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x40e: Return(); Pop(2)

0x40f: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x410: Return(); Pop(2)

0x411: PushEmpty(int, int)
0x412: @ GetVariable(Stack[-3], Stack[-1])
0x413: Pop(0)
0x414: Stack[-1] = Stack[-4]
0x415: Return(); Pop(2)

0x416: PushEmpty(float, float)
0x417: @ GetGameTime(Stack[-1])
0x418: Pop(0)
0x419: Push((int) 1)
0x41a: PushEmpty(int)
0x41b: Push((int) 24)
0x41c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x41d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x41e: Return(); Pop(2)

0x41f: PushEmpty(string, string)
0x420: Stack[-1] = "idle" // @poff=158
0x421: Push(Stack[-3])
0x422: IF (Stack[-1] == 0) GOTO 0x424; Pop(1)

0x423: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x424: Stack[-1] = Stack[-4]
0x425: Return(); Pop(2)

0x426: PushEmpty(int, bool, int, bool)
0x427: Stack[-2] = (int) 0
0x428: Push("all") // @poff=150
0x429: PushEmpty(string, int)
0x42a: Stack[-5] = Stack[-1]
0x42b: Call2 0x41f

0x42c: Pop(1)
0x42d: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x42e: Pop(2)
0x42f: Pop(0); Push((bool) Stack[-1] == 0)
0x430: IF (Stack[-1] == 0) GOTO 0x432; Pop(1)

0x431: GOTO 0x435

0x432: Push((int) 1)
0x433: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x434: GOTO 0x428

0x435: Stack[-2] = Stack[-5]
0x436: Return(); Pop(4)

0x437: Stack[-1] = (int) 515552
0x438: Return(); Pop(0)

0x439: Stack[-1] = (int) 502877
0x43a: Return(); Pop(0)

0x43b: Stack[-1] = "ui/NPC_Spi4ka.png" // @poff=404
0x43c: Return(); Pop(0)

0x43d: Stack[-1] = "ui/NPC_Spi4ka_b.png" // @poff=440
0x43e: Return(); Pop(0)
...
0x441: PushEmpty()
0x442: Push("oob9Spi4ka_Kapella1") // @poff=480
0x443: Push((int) 1)
...
0x449: Stack[-1] = "oob9Spi4ka_Kapella1" // @poff=480
0x44a: Call2 0x411
