...
// @pool_raw:
...
0x12: IF (Stack[-1] == 1) GOTO 0xc; Pop(1)
...
0x28: Pop(0)
0x29: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x2a: Pop(1)
0x2b: PushEmpty(int)
0x2c: Call2 0xaea

0x2d: Pop(0)
0x2e: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=27
0x2f: Pop(1)
0x30: PushEmpty(string)
0x31: Call2 0xaee

0x32: Pop(0)
0x33: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=45
0x34: Pop(1)
0x35: PushEmpty(string)
0x36: Call2 0xaf0

0x37: Pop(0)
0x38: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=54
0x39: Pop(1)
0x3a: PushEmpty(int)
0x3b: Call2 0x8bf

0x3c: Pop(0)
0x3d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=64
0x3e: Pop(1)
0x3f: Stack[-2] = (int) -1
...
0x49: Stack[-11] = Stack[-2]
0x4a: Stack[-6] = Stack[-1]
0x4b: Push(-2, 4); TaskCall(2)
0x4c: Call2 0x63

0x4d: Pop(-2, 4); TaskReturn
0x4e: Pop(2)
0x4f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=78
0x50: Pop(0)
...
0x53: @ sync()
0x54: Pop(0)
0x55: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=78
0x56: Pop(0)
0x57: GOTO 0x51

0x58: PushEmpty(object)
0x59: Stack[-10] = Stack[-1]
0x5a: Call2 0x6f6

0x5b: Pop(1)
0x5c: @ StopDialog(Stack[-4])
0x5d: Pop(0)
0x5e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=90
0x5f: Pop(0)
...
0x79: Stack[-1] = "Neutral" // @poff=105
0x7a: Call2 0xd9

0x7b: Pop(1)
0x7c: Push((int) 515453)
0x7d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x7e: Pop(1)
0x7f: @@@ ClearReplies(); Obj=0 // @poff=132
0x80: Pop(0)
0x81: Push((int) 515454)
0x82: Push((int) 16572)
0x83: Push((int) 16571)
0x84: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x85: Pop(3)
0x86: Push((int) 539571)
0x87: Push((int) 41513)
0x88: Push((int) 41512)
0x89: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x8a: Pop(3)
0x8b: GOTO 0xbb
...
0x97: Stack[-1] = "Neutral" // @poff=105
0x98: Call2 0xd9

0x99: Pop(1)
0x9a: Push((int) 515459)
0x9b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x9c: Pop(1)
0x9d: @@@ ClearReplies(); Obj=0 // @poff=132
0x9e: Pop(0)
0x9f: Push((int) 515460)
0xa0: Push((int) 41515)
0xa1: Push((int) 16577)
0xa2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0xa3: Pop(3)
0xa4: Push((int) 539577)
0xa5: Push((int) 41519)
0xa6: Push((int) 41518)
0xa7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0xa8: Pop(3)
0xa9: GOTO 0xbb

0xaa: PushEmpty(string)
0xab: Stack[-1] = "Neutral" // @poff=105
0xac: Call2 0xd9

0xad: Pop(1)
0xae: Push((int) 515465)
0xaf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0xb0: Pop(1)
0xb1: @@@ ClearReplies(); Obj=0 // @poff=132
0xb2: Pop(0)
0xb3: Push((int) 515466)
0xb4: Push((int) -1)
0xb5: Push((int) 16583)
0xb6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0xb7: Pop(3)
0xb8: GOTO 0xbb
...
0xca: Push("all") // @poff=154
0xcb: Push("idle") // @poff=162
...
0xd3: Push("all") // @poff=154
0xd4: Push("idle") // @poff=162
...
0x120: Stack[-1] = "Neutral" // @poff=105
0x121: Call2 0xd9

0x122: Pop(1)
0x123: Push((int) 515453)
0x124: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x125: Pop(1)
0x126: @@@ ClearReplies(); Obj=0 // @poff=132
0x127: Pop(0)
0x128: Push((int) 515454)
0x129: Push((int) 16572)
0x12a: Push((int) 16571)
0x12b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x12c: Pop(3)
0x12d: Push((int) 539571)
0x12e: Push((int) 41513)
0x12f: Push((int) 41512)
0x130: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x131: Pop(3)
0x132: Return(); Pop(0)
...
0x13e: Stack[-1] = "Neutral" // @poff=105
0x13f: Call2 0xd9

0x140: Pop(1)
0x141: Push((int) 515459)
0x142: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x143: Pop(1)
0x144: @@@ ClearReplies(); Obj=0 // @poff=132
0x145: Pop(0)
0x146: Push((int) 515460)
0x147: Push((int) 41515)
0x148: Push((int) 16577)
0x149: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x14a: Pop(3)
0x14b: Push((int) 539577)
0x14c: Push((int) 41519)
0x14d: Push((int) 41518)
0x14e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x14f: Pop(3)
0x150: Return(); Pop(0)

0x151: PushEmpty(string)
0x152: Stack[-1] = "Neutral" // @poff=105
0x153: Call2 0xd9

0x154: Pop(1)
0x155: Push((int) 515465)
0x156: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x157: Pop(1)
0x158: @@@ ClearReplies(); Obj=0 // @poff=132
0x159: Pop(0)
0x15a: Push((int) 515466)
0x15b: Push((int) -1)
0x15c: Push((int) 16583)
0x15d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x15e: Pop(3)
0x15f: Return(); Pop(0)
...
0x164: Stack[-1] = "Neutral" // @poff=105
0x165: Call2 0xd9

0x166: Pop(1)
0x167: Push((int) 539574)
0x168: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x169: Pop(1)
0x16a: @@@ ClearReplies(); Obj=0 // @poff=132
0x16b: Pop(0)
0x16c: Push((int) 539575)
0x16d: Push((int) 41519)
0x16e: Push((int) 41516)
0x16f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x170: Pop(3)
0x171: Push((int) 539576)
0x172: Push((int) 41519)
0x173: Push((int) 41517)
0x174: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x175: Pop(3)
0x176: Return(); Pop(0)
...
0x17b: Stack[-1] = "Neutral" // @poff=105
0x17c: Call2 0xd9

0x17d: Pop(1)
0x17e: Push((int) 539578)
0x17f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x180: Pop(1)
0x181: @@@ ClearReplies(); Obj=0 // @poff=132
0x182: Pop(0)
0x183: Push((int) 539579)
0x184: Push((int) -1)
0x185: Push((int) 41522)
0x186: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x187: Pop(3)
0x188: Push((int) 539580)
0x189: Push((int) -1)
0x18a: Push((int) 41523)
0x18b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x18c: Pop(3)
0x18d: Return(); Pop(0)
...
0x192: Stack[-1] = "Neutral" // @poff=105
0x193: Call2 0xd9

0x194: Pop(1)
0x195: Push((int) 539572)
0x196: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x197: Pop(1)
0x198: @@@ ClearReplies(); Obj=0 // @poff=132
0x199: Pop(0)
0x19a: Push((int) 539878)
0x19b: Push((int) 41840)
0x19c: Push((int) 41833)
0x19d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x19e: Pop(3)
0x19f: Push((int) 539573)
0x1a0: Push((int) 16572)
0x1a1: Push((int) 41514)
0x1a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1a3: Pop(3)
0x1a4: Return(); Pop(0)
...
0x1a9: Stack[-1] = "Neutral" // @poff=105
0x1aa: Call2 0xd9

0x1ab: Pop(1)
0x1ac: Push((int) 515455)
0x1ad: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x1ae: Pop(1)
0x1af: @@@ ClearReplies(); Obj=0 // @poff=132
0x1b0: Pop(0)
0x1b1: Push((int) 515456)
0x1b2: Push((int) 16574)
0x1b3: Push((int) 16573)
0x1b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1b5: Pop(3)
0x1b6: Push((int) 539581)
0x1b7: Push((int) 16574)
0x1b8: Push((int) 41525)
0x1b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1ba: Pop(3)
0x1bb: Return(); Pop(0)
...
0x1c0: Stack[-1] = "Neutral" // @poff=105
0x1c1: Call2 0xd9

0x1c2: Pop(1)
0x1c3: Push((int) 515457)
0x1c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x1c5: Pop(1)
0x1c6: @@@ ClearReplies(); Obj=0 // @poff=132
0x1c7: Pop(0)
0x1c8: Push((int) 539582)
0x1c9: Push((int) 41528)
0x1ca: Push((int) 41527)
0x1cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1cc: Pop(3)
0x1cd: Push((int) 539880)
0x1ce: Push((int) 41836)
0x1cf: Push((int) 41835)
0x1d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1d1: Pop(3)
0x1d2: Return(); Pop(0)
...
0x1d7: Stack[-1] = "Neutral" // @poff=105
0x1d8: Call2 0xd9

0x1d9: Pop(1)
0x1da: Push((int) 539881)
0x1db: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x1dc: Pop(1)
0x1dd: @@@ ClearReplies(); Obj=0 // @poff=132
0x1de: Pop(0)
0x1df: Push((int) 539882)
0x1e0: Push((int) 41528)
0x1e1: Push((int) 41837)
0x1e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1e3: Pop(3)
0x1e4: Push((int) 539883)
0x1e5: Push((int) 41840)
0x1e6: Push((int) 41839)
0x1e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1e8: Pop(3)
0x1e9: Return(); Pop(0)
...
0x1ee: Stack[-1] = "Neutral" // @poff=105
0x1ef: Call2 0xd9

0x1f0: Pop(1)
0x1f1: Push((int) 539884)
0x1f2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x1f3: Pop(1)
0x1f4: @@@ ClearReplies(); Obj=0 // @poff=132
0x1f5: Pop(0)
0x1f6: Push((int) 539885)
0x1f7: Push((int) 41528)
0x1f8: Push((int) 41842)
0x1f9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x1fa: Pop(3)
0x1fb: Return(); Pop(0)
...
0x200: Stack[-1] = "Neutral" // @poff=105
0x201: Call2 0xd9

0x202: Pop(1)
0x203: Push((int) 539583)
0x204: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=121
0x205: Pop(1)
0x206: @@@ ClearReplies(); Obj=0 // @poff=132
0x207: Pop(0)
0x208: Push((int) 539584)
0x209: Push((int) -1)
0x20a: Push((int) 41529)
0x20b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x20c: Pop(3)
0x20d: Push((int) 515458)
0x20e: Push((int) -1)
0x20f: Push((int) 16575)
0x210: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=145
0x211: Pop(3)
0x212: Return(); Pop(0)
...
0x24b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x24c: IF (Stack[-1] == 0) GOTO 0x252; Pop(1)

0x24d: PushEmpty(string)
0x24e: Stack[-1] = "fdie" // @poff=172
0x24f: Call2 0x2a5

0x250: Pop(1)
0x251: GOTO 0x2a4

0x252: @@ GetPosition(Stack[-10]); Obj=21 // @poff=182
0x253: Pop(0)
...
0x263: Stack[-6] = "fdie" // @poff=172
0x264: GOTO 0x266

0x265: Stack[-6] = "bdie" // @poff=194
...
0x26c: @ StopAsync()
0x26d: Pop(0)
0x26e: Stack[-21] = Stack[-5]
0x26f: Push("GetScriptProperty") // @poff=204
0x270: Push((int) 2)
0x271: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x272: IF (Stack[-1] == 0) GOTO 0x27e; Pop(1)

0x273: Push("Owner") // @poff=240
0x274: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=252
0x275: Pop(1)
0x276: Push(Stack[-4])
0x277: IF (Stack[-1] == 0) GOTO 0x27e; Pop(1)

0x278: Push("Owner") // @poff=240
0x279: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=270
0x27a: Pop(1)
0x27b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x27c: IF (Stack[-1] == 0) GOTO 0x27e; Pop(1)

0x27d: Stack[-21] = Stack[-5]
0x27e: Push("@GetEyesHeight") // @poff=288
0x27f: Push((int) 1)
0x280: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x281: IF (Stack[-1] == 0) GOTO 0x28d; Pop(1)

0x282: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=318
0x283: Pop(0)
...
0x28f: Stack[-7] = Stack[-1]
0x290: Call2 0x748

0x291: Pop(1)
0x292: Push("all") // @poff=154
...
0x299: @ StopAsync()
0x29a: Pop(0)
0x29b: Push("head") // @poff=332
0x29c: @ UnlookAsync(Stack[-1])
0x29d: Pop(1)
0x29e: Push("all") // @poff=154
...
0x2cf: IF (Stack[-1] == 1) GOTO 0x2d7; Pop(1)
...
0x2d5: IF (Stack[-1] == 1) GOTO 0x2d7; Pop(1)
...
0x319: Stack[-7] = Stack[-3]
0x31a: Stack[-6] = Stack[-2]
0x31b: Stack[-5] = Stack[-1]
0x31c: Call2 0xab6
...
0x345: Pop(0)
0x346: @ Face(Stack[-0]T)
0x347: Pop(0)
0x348: Push(Stack[-5])
0x349: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x34a: Push("all") // @poff=154
0x34b: Push("attack_on") // @poff=342
0x34c: @ PlayAnimation(Stack[-2], Stack[-1])
0x34d: Pop(2)
0x34e: @ WaitForAnimEnd()
0x34f: Pop(0)
0x350: Push("all") // @poff=154
0x351: Push("attack_on") // @poff=342
...
0x35c: @ CanSee(Stack[-1], Stack[-0]T)
0x35d: Pop(0)
0x35e: Push(Stack[-1])
...
0x36d: Push("all") // @poff=154
0x36e: Push("hunt") // @poff=362
...
0x379: Pop(0)
0x37a: Push("all") // @poff=154
0x37b: Push("attack_on") // @poff=342
...
0x391: Push("all") // @poff=154
0x392: Push("attack_on") // @poff=342
...
0x39e: Pop(0)
0x39f: Push("all") // @poff=154
0x3a0: Push("attack_on") // @poff=342
...
0x3ac: @ CanSee(Stack[-1], Stack[-0]T)
0x3ad: Pop(0)
0x3ae: Push(Stack[-1])
0x3af: IF (Stack[-1] == 0) GOTO 0x3b6; Pop(1)

0x3b0: @ Face(Stack[-0]T)
0x3b1: Pop(0)
0x3b2: PushEmpty()
0x3b3: Call2 0x3f1
...
0x3c4: @ StopAsync()
0x3c5: Pop(0)
0x3c6: Push("all") // @poff=154
0x3c7: Push("attack_off") // @poff=372
...
0x3ff: Pop(0)
0x400: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x401: Pop(1)
...
0x407: Stack[-2] = Stack[-15]
0x408: Pop(2)
0x409: PushEmpty(float, cvector, cvector)
0x40a: Stack[-17] = Stack[-2]
0x40b: Stack[-16] = Stack[-1]
0x40c: Call2 0x80c

0x40d: Pop(2)
0x40e: Push((float)0.9993908405303955)
...
0x414: Pop(0)
0x415: Push("all") // @poff=154
0x416: Push("attack_begin1") // @poff=416
0x417: @ PlayAnimation(Stack[-2], Stack[-1])
0x418: Pop(2)
0x419: Push("attack") // @poff=444
...
0x41f: Pop(0)
0x420: Push("light-dynamic") // @poff=458
0x421: Push("soldier_fire.xml") // @poff=486
...
0x43d: Push((float)0.03490658476948738)
...
0x44b: Stack[-4] = Stack[-7]
0x44c: Pop(4)
0x44d: Push((int) 2)
0x44e: Push((float)1.5)
0x44f: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x450: Pop(2)
0x451: GOTO 0x461
...
0x456: Pop(0)
0x457: Push("scripted") // @poff=530
0x458: Push(CVector(0.0, 0.0, 1.0))
0x459: Push("richochet.xml") // @poff=548
0x45a: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x45b: Pop(3)
0x45c: Push("Material") // @poff=576
0x45d: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=594
0x45e: Pop(1)
0x45f: Stack[-1] = 0
0x460: Stack[-2] = 0
0x461: Push("all") // @poff=154
0x462: Push("attack_end1") // @poff=612
0x463: @ PlayAnimation(Stack[-2], Stack[-1])
0x464: Pop(2)
0x465: @ WaitForAnimEnd()
0x466: Pop(0)
0x467: Push("all") // @poff=154
0x468: Push("attack_on") // @poff=342
...
0x487: Stack[-7] = Stack[-3]
0x488: Stack[-6] = Stack[-2]
...
0x4ad: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=636
0x4ae: Pop(1)
...
0x4ce: Stack[-2] = "quest_d10_01" // @poff=639
0x4cf: Stack[-1] = "soldier_fight" // @poff=665
0x4d0: Call2 0x833
...
0x4de: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=636
0x4df: Pop(1)
0x4e0: Push(Stack[-1])
...
0x504: @ GetPFPosition(Stack[-1]T)
0x505: Pop(0)
0x506: @ GetDirection(Stack[-0]T)
0x507: Pop(0)
0x508: PushEmpty()
0x509: Call2 0x55c
...
0x525: @ FindPathTo(Stack[-1], Stack[-1]T)
0x526: Pop(0)
...
0x534: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x535: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x547: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x548: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x567: Stack[-2] = "bullet" // @poff=703
0x568: Return(); Pop(0)

0x569: Stack[-2] = "phys" // @poff=717
0x56a: Return(); Pop(0)

0x56b: PushEmpty(cvector, cvector, cvector, cvector)
0x56c: @ GetPosition(Stack[-2])
0x56d: Pop(0)
0x56e: @@ GetPosition(Stack[-1]); Obj=5 // @poff=182
0x56f: Pop(0)
...
0x574: Pop(0)
0x575: @@ GetPosition(Stack[-2]); Obj=7 // @poff=182
0x576: Pop(0)
...
0x587: Push("HasProperty") // @poff=741
0x588: Push((int) 2)
...
0x58e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=765
0x58f: Pop(0)
0x590: Stack[-1] = Stack[-5]
0x591: Return(); Pop(2)
...
0x59d: Stack[-18] = Stack[-2]
0x59e: Stack[-1] = "armor" // @poff=791
0x59f: Call2 0x586
...
0x5a5: Push("armor") // @poff=791
0x5a6: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=803
0x5a7: Pop(1)
0x5a8: Push("armor_") // @poff=815
0x5a9: PushEmpty(string, int)
0x5aa: Stack[-16] = Stack[-1]
0x5ab: Call2 0x55d

0x5ac: Pop(1)
0x5ad: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5ae: PushEmpty(bool, object, string)
0x5af: Stack[-18] = Stack[-2]
0x5b0: Stack[-8] = Stack[-1]
0x5b1: Call2 0x586
...
0x5b7: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=803
0x5b8: Pop(0)
...
0x5bf: Stack[-3] = Stack[-6]
0x5c0: Pop(3)
0x5c1: Push("health") // @poff=777
0x5c2: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=803
0x5c3: Pop(1)
0x5c4: Push((int) 1)
0x5c5: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5c6: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5c7: Push("health") // @poff=777
...
0x5cd: Pop(3)
0x5ce: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=829
0x5cf: Pop(2)
0x5d0: PushEmpty(bool, object)
0x5d1: Stack[-17] = Stack[-1]
0x5d2: Call2 0x581
...
0x5d8: Pop(1)
0x5d9: Stack[-1] = Stack[-16]
0x5da: Return(); Pop(12)

0x5db: PushEmpty(bool, bool)
0x5dc: @@ IsDead(Stack[-1]); Obj=3 // @poff=841
0x5dd: Pop(0)
0x5de: Stack[-1] = Stack[-4]
0x5df: Return(); Pop(2)

0x5e0: PushEmpty(object, object, object, object)
0x5e1: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5f5: Pop(0)
0x5f6: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5f7: IF (Stack[-1] == 0) GOTO 0x5fa; Pop(1)

0x5f8: Stack[-6] = (bool) 0
0x5f9: Return(); Pop(4)

0x5fa: @@ GetScene(Stack[-1]); Obj=5 // @poff=862
0x5fb: Pop(0)
...
0x60e: Stack[-6] = Stack[-2]
0x60f: Stack[-1] = "noaccess" // @poff=871
0x610: Call2 0x586
...
0x616: Push("noaccess") // @poff=871
0x617: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=803
0x618: Pop(1)
0x619: Push((int) 0)
...
0x61d: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x62b: @@ GetPosition(Stack[-5]); Obj=15 // @poff=182
0x62c: Pop(0)
...
0x63c: Stack[-1] = "fhit" // @poff=889
0x63d: GOTO 0x63f

0x63e: Stack[-1] = "bhit" // @poff=899
0x63f: Push("hit_react") // @poff=909
0x640: Push("1") // @poff=440
0x641: Pop(1); Push(Stack[-3] + Stack[-1]);
0x642: Push("2") // @poff=929
...
0x660: Stack[-2] = Stack[-11]
0x661: Pop(2)
0x662: @ CreateVectorVector(Stack[-8])
0x663: Pop(0)
0x664: Stack[-7] = (int) 1
0x665: Push("hit") // @poff=891
...
0x67a: Pop(0)
0x67b: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=942
0x67c: Pop(0)
0x67d: PushEmpty(object, int, float, cvector, cvector)
0x67e: Stack[-26] = Stack[-5]
0x67f: Stack[-25] = Stack[-4]
0x680: Stack[-24] = Stack[-3]
0x681: Stack[-6] = Stack[-2]
...
0x69b: @@ GetPosition(Stack[-3]); Obj=7 // @poff=182
0x69c: Pop(0)
...
0x6a7: Pop(0)
0x6a8: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=318
0x6a9: Pop(0)
...
0x6b2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=182
0x6b3: Pop(0)
0x6b4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=318
0x6b5: Pop(0)
...
0x713: Push("Can't find lsh animation : ") // @poff=974
...
0x722: Push("Can't find lsh animation : ") // @poff=974
...
0x73b: Stack[-10] = Stack[-2]
0x73c: Stack[-9] = Stack[-1]
0x73d: Call2 0x7ee
...
0x789: Push("woman") // @poff=1030
0x78a: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x78b: IF (Stack[-1] == 1) GOTO 0x790; Pop(1)

0x78c: Push("worker") // @poff=1042
0x78d: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x78e: IF (Stack[-1] == 1) GOTO 0x790; Pop(1)

0x78f: Stack[-1] = (bool) 0
0x790: IF (Stack[-1] == 1) GOTO 0x795; Pop(1)

0x791: Push("butcher") // @poff=1056
0x792: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x793: IF (Stack[-1] == 1) GOTO 0x795; Pop(1)

0x794: Stack[-1] = (bool) 0
0x795: IF (Stack[-1] == 1) GOTO 0x79a; Pop(1)

0x796: Push("wasted_girl") // @poff=1072
0x797: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x798: IF (Stack[-1] == 1) GOTO 0x79a; Pop(1)

0x799: Stack[-1] = (bool) 0
0x79a: IF (Stack[-1] == 1) GOTO 0x79f; Pop(1)

0x79b: Push("boy") // @poff=1096
0x79c: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x79d: IF (Stack[-1] == 1) GOTO 0x79f; Pop(1)

0x79e: Stack[-1] = (bool) 0
0x79f: IF (Stack[-1] == 1) GOTO 0x7a4; Pop(1)

0x7a0: Push("vaxxabitka") // @poff=1104
0x7a1: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x7a2: IF (Stack[-1] == 1) GOTO 0x7a4; Pop(1)

0x7a3: Stack[-1] = (bool) 0
0x7a4: IF (Stack[-1] == 1) GOTO 0x7a9; Pop(1)

0x7a5: Push("unosha") // @poff=1126
0x7a6: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x7a7: IF (Stack[-1] == 1) GOTO 0x7a9; Pop(1)

0x7a8: Stack[-1] = (bool) 0
0x7a9: IF (Stack[-1] == 1) GOTO 0x7ae; Pop(1)

0x7aa: Push("wasted_male") // @poff=1140
0x7ab: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7ac: IF (Stack[-1] == 1) GOTO 0x7ae; Pop(1)

0x7ad: Stack[-1] = (bool) 0
0x7ae: IF (Stack[-1] == 1) GOTO 0x7b3; Pop(1)

0x7af: Push("alkash") // @poff=1164
0x7b0: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x7b1: IF (Stack[-1] == 1) GOTO 0x7b3; Pop(1)

0x7b2: Stack[-1] = (bool) 0
0x7b3: IF (Stack[-1] == 1) GOTO 0x7b8; Pop(1)

0x7b4: Push("dohodyaga") // @poff=1178
0x7b5: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7b6: IF (Stack[-1] == 1) GOTO 0x7b8; Pop(1)

0x7b7: Stack[-1] = (bool) 0
0x7b8: IF (Stack[-1] == 1) GOTO 0x7bd; Pop(1)

0x7b9: Push("vaxxabit") // @poff=1198
0x7ba: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7bb: IF (Stack[-1] == 1) GOTO 0x7bd; Pop(1)

0x7bc: Stack[-1] = (bool) 0
0x7bd: IF (Stack[-1] == 1) GOTO 0x7c2; Pop(1)

0x7be: Push("nudegirl") // @poff=1216
0x7bf: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x7c0: IF (Stack[-1] == 1) GOTO 0x7c2; Pop(1)

0x7c1: Stack[-1] = (bool) 0
0x7c2: IF (Stack[-1] == 1) GOTO 0x7c7; Pop(1)

0x7c3: Push("morlok") // @poff=1234
0x7c4: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x7c5: IF (Stack[-1] == 1) GOTO 0x7c7; Pop(1)
...
0x7d1: Push((float)9.999999974752427e-07)
...
0x7df: Stack[-2] = Stack[-3]
0x7e0: GOTO 0x7e2

0x7e1: Stack[-1] = Stack[-3]
0x7e2: Return(); Pop(0)
...
0x80e: Stack[-5] = Stack[-2]
0x80f: Stack[-4] = Stack[-1]
0x810: Call2 0x7f9

0x811: Pop(2)
0x812: PushEmpty(float, cvector)
0x813: Stack[-5] = Stack[-1]
0x814: Call2 0x802
...
0x835: Pop(0)
0x836: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x852: Stack[-1] = 0
0x853: PushEmpty()
0x854: Push("d10q01SoldierTalk") // @poff=1262
0x855: Push((int) 1)
...
0x859: PushEmpty()
0x85a: Push("ood10MSoldier1") // @poff=1298
0x85b: Push((int) 1)
...
0x85f: PushEmpty()
0x860: Push("ood10MSoldier2") // @poff=1328
0x861: Push((int) 1)
...
0x86c: Stack[-2] = "quest_d10_01" // @poff=639
0x86d: Stack[-1] = "soldier_fight" // @poff=665
0x86e: Call2 0x833
...
0x873: Stack[-1] = "ood10MSoldier1" // @poff=1298
0x874: Call2 0x81d
...
0x87f: Stack[-1] = "ood10MSoldier2" // @poff=1328
0x880: Call2 0x81d
...
0x89b: Push("Can't retrieve diary root") // @poff=1358
0x89c: @ Trace(Stack[-1])
0x89d: Pop(1)
0x89e: Stack[-3] = (bool) 0
0x89f: Return(); Pop(2)

0x8a0: Stack[-1] = Stack[-3]
0x8a1: Return(); Pop(2)
...
0x8a6: Stack[-1] = Stack[-4]
0x8a7: Pop(1)
0x8a8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1410
0x8a9: Pop(0)
0x8aa: Pop(0); Push((bool) Stack[-2] == 0)
0x8ab: IF (Stack[-1] == 0) GOTO 0x8b2; Pop(1)

0x8ac: Push("Can't find diary parent with id: ") // @poff=1415
...
0x8b2: @@ AddChild(Stack[-8]); Obj=2 // @poff=1483
0x8b3: Pop(0)
0x8b4: Push((int) 7)
0x8b5: @ SendWorldWndMessage(Stack[-1])
0x8b6: Pop(1)
0x8b7: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1492
0x8b8: Pop(0)
...
0x8d1: Push("branch") // @poff=1504
0x8d2: @ GetVariable(Stack[-1], Stack[-2])
0x8d3: Pop(1)
0x8d4: Stack[-1] = Stack[-3]
0x8d5: Return(); Pop(2)
...
0x8e6: Push("GenerateMoney: iMin > iMax") // @poff=1518
0x8e7: @ Trace(Stack[-1])
0x8e8: Pop(1)
0x8e9: Return(); Pop(4)
...
0x904: Pop(0)
0x905: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1584
0x906: Pop(0)
0x907: Push("Organ") // @poff=1596
0x908: Push((int) 1)
0x909: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=829
0x90a: Pop(2)
0x90b: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1608
0x90c: Pop(0)
0x90d: Push((int) 0)
0x90e: Push((int) 1)
...
0x91b: Stack[-1] = "liver" // @poff=1618
0x91c: Call2 0x902

0x91d: Pop(1)
0x91e: PushEmpty(string)
0x91f: Stack[-1] = "kidney" // @poff=1630
0x920: Call2 0x902

0x921: Pop(1)
0x922: PushEmpty(string)
0x923: Stack[-1] = "heart" // @poff=1644
0x924: Call2 0x902

0x925: Pop(1)
0x926: PushEmpty(string)
0x927: Stack[-1] = "blood" // @poff=1656
0x928: Call2 0x902
...
0x935: Stack[-4] = "rifle_ammo" // @poff=1668
0x936: Stack[-3] = (int) 1
0x937: Stack[-2] = (int) 3
0x938: Stack[-1] = (int) 3
0x939: Call2 0x739
...
0x943: Stack[-3] = "bandage" // @poff=1700
0x944: Stack[-2] = (int) 1
0x945: Stack[-1] = (int) 6
0x946: Call2 0x72e
...
0x949: Stack[-3] = "tourniquet" // @poff=1716
0x94a: Stack[-2] = (int) 1
0x94b: Stack[-1] = (int) 6
0x94c: Call2 0x72e
...
0x951: Pop(0)
0x952: Stack[-1] = Stack[-4]
0x953: Return(); Pop(2)

0x954: PushEmpty()
0x955: PushEmpty(object)
0x956: Stack[-2] = Stack[-1]
...
0x95e: Stack[-7] = Stack[-3]
0x95f: Stack[-6] = Stack[-2]
0x960: Stack[-5] = Stack[-1]
0x961: Call2 0x648
...
0x966: Stack[-11] = Stack[-5]
0x967: Stack[-10] = Stack[-4]
0x968: Stack[-9] = Stack[-3]
0x969: Stack[-7] = Stack[-2]
0x96a: Stack[-6] = Stack[-1]
0x96b: Call2 0x68c
...
0x98f: Stack[-7] = Stack[-2]
0x990: Stack[-1] = "class" // @poff=1738
0x991: Call2 0x586
...
0x997: Push("class") // @poff=1738
0x998: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=803
0x999: Pop(1)
...
0x9ae: Push("patrol") // @poff=1750
0x9af: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x9b0: IF (Stack[-1] == 1) GOTO 0x9b5; Pop(1)

0x9b1: Push("sanitar") // @poff=1764
0x9b2: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x9b3: IF (Stack[-1] == 1) GOTO 0x9b5; Pop(1)

0x9b4: Stack[-1] = (bool) 0
0x9b5: IF (Stack[-1] == 1) GOTO 0x9ba; Pop(1)

0x9b6: Push("soldier") // @poff=1780
...
0x9c0: Push("wasted_girl") // @poff=1072
0x9c1: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x9c2: IF (Stack[-1] == 1) GOTO 0x9c4; Pop(1)

0x9c3: Stack[-1] = (bool) 0
0x9c4: IF (Stack[-1] == 1) GOTO 0x9c9; Pop(1)

0x9c5: Push("vaxxabitka") // @poff=1104
0x9c6: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x9c7: IF (Stack[-1] == 1) GOTO 0x9c9; Pop(1)

0x9c8: Stack[-1] = (bool) 0
0x9c9: IF (Stack[-1] == 1) GOTO 0x9ce; Pop(1)

0x9ca: Push("vaxxabit") // @poff=1198
0x9cb: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x9cc: IF (Stack[-1] == 1) GOTO 0x9ce; Pop(1)

0x9cd: Stack[-1] = (bool) 0
0x9ce: IF (Stack[-1] == 1) GOTO 0x9d3; Pop(1)

0x9cf: Push("little_girl") // @poff=1796
0x9d0: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x9d1: IF (Stack[-1] == 1) GOTO 0x9d3; Pop(1)

0x9d2: Stack[-1] = (bool) 0
0x9d3: IF (Stack[-1] == 1) GOTO 0x9d8; Pop(1)

0x9d4: Push("girl") // @poff=1086
0x9d5: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x9d6: IF (Stack[-1] == 1) GOTO 0x9d8; Pop(1)

0x9d7: Stack[-1] = (bool) 0
0x9d8: IF (Stack[-1] == 1) GOTO 0x9dd; Pop(1)

0x9d9: Push("dohodyaga") // @poff=1178
0x9da: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9db: IF (Stack[-1] == 1) GOTO 0x9dd; Pop(1)

0x9dc: Stack[-1] = (bool) 0
0x9dd: IF (Stack[-1] == 1) GOTO 0x9e2; Pop(1)

0x9de: Push("nudegirl") // @poff=1216
0x9df: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x9e0: IF (Stack[-1] == 1) GOTO 0x9e2; Pop(1)
...
0xa06: Push("wasted_male") // @poff=1140
...
0xa54: Stack[-9] = Stack[-1]
0xa55: Call2 0x581

0xa56: Pop(1)
0xa57: IF (Stack[-1] == 0) GOTO 0xa5e; Pop(1)

0xa58: Push("reputation") // @poff=1820
0xa59: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=803
0xa5a: Pop(1)
0xa5b: Push((float)0.33000001311302185)
0xa5c: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0xa5d: Return(); Pop(6)

0xa5e: PushEmpty(bool, object, string)
0xa5f: Stack[-10] = Stack[-2]
0xa60: Stack[-1] = "class" // @poff=1738
0xa61: Call2 0x586
...
0xa67: Push("class") // @poff=1738
0xa68: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=803
0xa69: Pop(1)
0xa6a: PushEmpty(bool)
0xa6b: Stack[-1] = (bool) 1
0xa6c: PushEmpty(bool)
0xa6d: Stack[-1] = (bool) 1
0xa6e: Push("bomber") // @poff=1842
0xa6f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xa70: IF (Stack[-1] == 1) GOTO 0xa75; Pop(1)

0xa71: Push("hunter") // @poff=1856
0xa72: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xa73: IF (Stack[-1] == 1) GOTO 0xa75; Pop(1)

0xa74: Stack[-1] = (bool) 0
0xa75: IF (Stack[-1] == 1) GOTO 0xa7a; Pop(1)

0xa76: Push("grabitel") // @poff=1870
0xa77: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa78: IF (Stack[-1] == 1) GOTO 0xa7a; Pop(1)
...
0xa7e: Stack[-10] = Stack[-2]
0xa7f: Stack[-1] = "disease" // @poff=1888
0xa80: Call2 0x586
...
0xa89: Stack[-5] = Stack[-1]
0xa8a: Call2 0x771

0xa8b: Pop(1)
0xa8c: IF (Stack[-1] == 1) GOTO 0xa91; Pop(1)

0xa8d: Push("dog") // @poff=1904
...
0xa92: Push("disease") // @poff=1888
0xa93: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=803
0xa94: Pop(1)
0xa95: Push((int) 0)
...
0xaa4: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=636
0xaa5: Pop(1)
0xaa6: Push(Stack[-1])
...
0xac1: Push(Stack[-2])
0xac2: IF (Stack[-1] == 1) GOTO 0xacb; Pop(1)

0xac3: PushEmpty(float, object)
0xac4: Stack[-8] = Stack[-1]
0xac5: Call2 0x572

0xac6: Pop(1)
0xac7: Push((float)490000.0)
0xac8: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xac9: IF (Stack[-1] == 1) GOTO 0xacb; Pop(1)
...
0xaee: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1912
0xaef: Return(); Pop(0)

0xaf0: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1952
0xaf1: Return(); Pop(0)
