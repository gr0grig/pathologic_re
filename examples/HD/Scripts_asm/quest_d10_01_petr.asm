...
Strings:
	...
	W:ui/NPC_Petr.png
	W:ui/NPC_Petr_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0x262: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x263: Pop(1)
0x264: @@@ ClearReplies(); Obj=0 // @poff=116
0x265: Pop(0)
...
0x3b5: Stack[-1] = "Neutral" // @poff=89
0x3b6: Call2 0xc4

0x3b7: Pop(1)
0x3b8: Push((int) 539554)
0x3b9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3ba: Pop(1)
0x3bb: @@@ ClearReplies(); Obj=0 // @poff=116
0x3bc: Pop(0)
...
0x3de: Stack[-1] = "Neutral" // @poff=89
0x3df: Call2 0xc4

0x3e0: Pop(1)
0x3e1: Push((int) 512857)
0x3e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3e3: Pop(1)
0x3e4: @@@ ClearReplies(); Obj=0 // @poff=116
0x3e5: Pop(0)
...
0x45d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=188
0x45e: Pop(0)
0x45f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=200
0x460: Pop(0)
...
0x4cc: Push("voice_common") // @poff=224
0x4cd: Push((int) 1)
...
0x4d4: Push("voice_common") // @poff=224
0x4d5: Push((int) 0)
...
0x4e7: Push("voice_common") // @poff=224
0x4e8: Push((int) 1)
...
0x4f5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x4f6: Pop(1)
...
0x520: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=254
0x521: Pop(1)
...
0x535: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=266
0x536: Pop(1)
...
0x548: Push("Can't find lsh animation : ") // @poff=282
...
0x557: Push("Can't find lsh animation : ") // @poff=282
...
0x57b: Push((float)9.999999974752427e-07)
...
0x589: Pop(0)
0x58a: @@ add(Stack[-4]); Obj=1 // @poff=338
0x58b: Pop(0)
0x58c: @@ add(Stack[-3]); Obj=1 // @poff=338
0x58d: Pop(0)
0x58e: Push((int) 3)
...
0x594: @@ GetItemID(Stack[-3]); Obj=8 // @poff=342
0x595: Pop(0)
0x596: Push("Category") // @poff=352
0x597: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x598: Pop(1)
0x599: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=370
0x59a: Pop(0)
0x59b: Pop(0); Push((bool) Stack[-1] == 0)
0x59c: IF (Stack[-1] == 0) GOTO 0x5a0; Pop(1)

0x59d: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=378
0x59e: Pop(0)
0x59f: GOTO 0x5a5

0x5a0: PushEmpty(int, int)
0x5a1: Stack[-5] = Stack[-2]
0x5a2: Stack[-9] = Stack[-1]
0x5a3: Call2 0x587
...
0x5a8: Pop(0)
0x5a9: @@ SetItemName(Stack[-4]); Obj=1 // @poff=388
0x5aa: Pop(0)
0x5ab: PushEmpty(object, object, int)
0x5ac: Stack[-8] = Stack[-3]
0x5ad: Stack[-4] = Stack[-2]
0x5ae: Stack[-6] = Stack[-1]
0x5af: Call2 0x593
...
0x5b5: Pop(0)
0x5b6: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5cd: Pop(1)
0x5ce: Stack[-2] = "pt_map_aglaja" // @poff=400
0x5cf: Stack[-1] = (int) 2
0x5d0: Call2 0x6cf
...
0x5d4: Pop(0)
0x5d5: @@ ShowMap(Stack[-1]); Obj=2 // @poff=428
0x5d6: Pop(1)
0x5d7: Return(); Pop(0)

0x5d8: PushEmpty()
0x5d9: PushEmpty(bool, string, string, string)
0x5da: Stack[-3] = "volonteers_danko" // @poff=436
0x5db: Stack[-2] = "disease" // @poff=470
0x5dc: Stack[-1] = "petr" // @poff=486
0x5dd: Call2 0x5b3
...
0x5e2: Stack[-1] = "map_chertez_state" // @poff=496
0x5e3: Call2 0x582
...
0x5e8: Push("map_chertez_state") // @poff=496
0x5e9: Push((int) 4)
0x5ea: @ SetVariable(Stack[-2], Stack[-1])
0x5eb: Pop(2)
0x5ec: Push("map_chertez_force") // @poff=532
0x5ed: Push((int) 1)
...
0x5f2: Push("tvirin") // @poff=568
0x5f3: Push((int) 5)
0x5f4: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=582
0x5f5: Pop(2)
0x5f6: Return(); Pop(2)

0x5f7: PushEmpty()
0x5f8: Push("ood10Petr1") // @poff=599
0x5f9: Push((int) 1)
...
0x60d: Pop(0)
0x60e: Push("blueprint is given") // @poff=635
0x60f: @ Trace(Stack[-1])
0x610: Pop(1)
0x611: PushEmpty(object, string, int)
0x612: Stack[-5] = Stack[-3]
0x613: Stack[-2] = "d10q01_blueprint" // @poff=673
0x614: Stack[-1] = (int) 1
0x615: Call2 0x5a6
...
0x618: PushEmpty()
0x619: Push("ood10Petr3") // @poff=707
0x61a: Push((int) 1)
...
0x620: Stack[-1] = "ood10Petr1" // @poff=599
0x621: Call2 0x582
...
0x62c: Stack[-1] = "d10q01MariaSavePetr" // @poff=729
0x62d: Call2 0x582
...
0x666: Stack[-1] = "ood10Petr3" // @poff=707
0x667: Call2 0x582
...
0x671: Push("tvirin") // @poff=568
0x672: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=769
0x673: Pop(1)
0x674: Push((int) 5)
...
0x69a: Push("Can't retrieve diary root") // @poff=788
0x69b: @ Trace(Stack[-1])
0x69c: Pop(1)
...
0x6a6: Pop(1)
0x6a7: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=840
0x6a8: Pop(0)
0x6a9: Pop(0); Push((bool) Stack[-2] == 0)
0x6aa: IF (Stack[-1] == 0) GOTO 0x6b1; Pop(1)

0x6ab: Push("Can't find diary parent with id: ") // @poff=845
...
0x6b1: @@ AddChild(Stack[-8]); Obj=2 // @poff=913
0x6b2: Pop(0)
0x6b3: Push((int) 7)
0x6b4: @ SendWorldWndMessage(Stack[-1])
0x6b5: Pop(1)
0x6b6: @@ GetCategory(Stack[-1]); Obj=8 // @poff=922
0x6b7: Pop(0)
...
0x6c3: Push("Can't find main outdoor scene") // @poff=934
0x6c4: @ Trace(Stack[-1])
0x6c5: Pop(1)
0x6c6: Stack[-1] = 0
...
0x6c9: @@ GetMap(Stack[-1]); Obj=2 // @poff=994
0x6ca: Pop(0)
...
0x6d4: Push("Can't find main outdoor scene") // @poff=934
0x6d5: @ Trace(Stack[-1])
0x6d6: Pop(1)
0x6d7: Return(); Pop(8)

0x6d8: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1001
0x6d9: Pop(0)
0x6da: Pop(0); Push((bool) Stack[-1] == 0)
0x6db: IF (Stack[-1] == 0) GOTO 0x6e2; Pop(1)

0x6dc: Push("Warning: outdoor scene locator ") // @poff=1012
0x6dd: Pop(1); Push(Stack[-1] + Stack[-11]);
0x6de: Push(" doesnt exist") // @poff=1076
0x6df: Pop(2); Push(Stack[-2] + Stack[-1]);
0x6e0: @ Trace(Stack[-1])
0x6e1: Pop(1)
0x6e2: @@ GetMap(Stack[-11]); Obj=2 // @poff=994
0x6e3: Pop(0)
0x6e4: Pop(0); PushNull((bool) Stack[-11] == 0)
0x6e5: IF (Stack[-1] == 0) GOTO 0x6ea; Pop(1)

0x6e6: Push("Can't find map") // @poff=1104
0x6e7: @ Trace(Stack[-1])
0x6e8: Pop(1)
0x6e9: Return(); Pop(8)
...
0x6ec: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1134
0x6ed: Pop(2)
0x6ee: Return(); Pop(8)

0x6ef: Stack[-2] = 0
0x6f0: PushEmpty(int, int)
0x6f1: Push("branch") // @poff=1147
...
0x705: Stack[-1] = "ui/NPC_Petr.png" // @poff=1161
0x706: Return(); Pop(0)

0x707: Stack[-1] = "ui/NPC_Petr_b.png" // @poff=1193
0x708: Return(); Pop(0)
