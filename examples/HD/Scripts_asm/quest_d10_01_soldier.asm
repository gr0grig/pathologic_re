...
Strings:
	...
	W:disease
	W:dog
// @pool_raw:
...
0x44: Pop(0); PushNull((bool) Stack[-21] == 0)
0x45: IF (Stack[-1] == 0) GOTO 0x4b; Pop(1)

0x46: PushEmpty(string)
0x47: Stack[-1] = "fdie" // @poff=16
0x48: Call2 0x9e

0x49: Pop(1)
0x4a: GOTO 0x9d

0x4b: @@ GetPosition(Stack[-10]); Obj=21 // @poff=26
0x4c: Pop(0)
...
0x5c: Stack[-6] = "fdie" // @poff=16
0x5d: GOTO 0x5f

0x5e: Stack[-6] = "bdie" // @poff=38
...
0x65: @ StopAsync()
0x66: Pop(0)
0x67: Stack[-21] = Stack[-5]
0x68: Push("GetScriptProperty") // @poff=48
0x69: Push((int) 2)
0x6a: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x6b: IF (Stack[-1] == 0) GOTO 0x77; Pop(1)

0x6c: Push("Owner") // @poff=84
0x6d: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=96
0x6e: Pop(1)
0x6f: Push(Stack[-4])
0x70: IF (Stack[-1] == 0) GOTO 0x77; Pop(1)

0x71: Push("Owner") // @poff=84
0x72: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=114
0x73: Pop(1)
0x74: Pop(0); PushNull((bool) Stack[-5] == 0)
0x75: IF (Stack[-1] == 0) GOTO 0x77; Pop(1)

0x76: Stack[-21] = Stack[-5]
0x77: Push("@GetEyesHeight") // @poff=132
0x78: Push((int) 1)
0x79: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x7a: IF (Stack[-1] == 0) GOTO 0x86; Pop(1)

0x7b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=162
0x7c: Pop(0)
0x7d: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x7e: Push(CvectorIndex(Stack[-1], 1))
0x7f: Stack[-3] = Stack[-1]
0x80: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x81: Push("head") // @poff=176
...
0x88: Stack[-7] = Stack[-1]
0x89: Call2 0x4be

0x8a: Pop(1)
0x8b: Push("all") // @poff=186
...
0x92: @ StopAsync()
0x93: Pop(0)
0x94: Push("head") // @poff=176
0x95: @ UnlookAsync(Stack[-1])
0x96: Pop(1)
0x97: Push("all") // @poff=186
...
0xaa: Stack[-2] = Stack[-1]
0xab: Call2 0x4be

0xac: Pop(1)
0xad: Push("all") // @poff=186
0xae: @ PlayAnimation(Stack[-1], Stack[-2])
0xaf: Pop(1)
0xb0: @ WaitForAnimEnd()
0xb1: Pop(0)
0xb2: Push("all") // @poff=186
...
0xc8: IF (Stack[-1] == 1) GOTO 0xd0; Pop(1)
...
0xce: IF (Stack[-1] == 1) GOTO 0xd0; Pop(1)
...
0x112: Stack[-7] = Stack[-3]
0x113: Stack[-6] = Stack[-2]
0x114: Stack[-5] = Stack[-1]
0x115: Call2 0x7aa
...
0x13e: Pop(0)
0x13f: @ Face(Stack[-0]T)
0x140: Pop(0)
0x141: Push(Stack[-5])
0x142: IF (Stack[-1] == 0) GOTO 0x149; Pop(1)

0x143: Push("all") // @poff=186
0x144: Push("attack_on") // @poff=194
0x145: @ PlayAnimation(Stack[-2], Stack[-1])
0x146: Pop(2)
0x147: @ WaitForAnimEnd()
0x148: Pop(0)
0x149: Push("all") // @poff=186
0x14a: Push("attack_on") // @poff=194
...
0x155: @ CanSee(Stack[-1], Stack[-0]T)
0x156: Pop(0)
0x157: Push(Stack[-1])
...
0x166: Push("all") // @poff=186
0x167: Push("hunt") // @poff=214
...
0x172: Pop(0)
0x173: Push("all") // @poff=186
0x174: Push("attack_on") // @poff=194
...
0x18a: Push("all") // @poff=186
0x18b: Push("attack_on") // @poff=194
...
0x197: Pop(0)
0x198: Push("all") // @poff=186
0x199: Push("attack_on") // @poff=194
...
0x1a5: @ CanSee(Stack[-1], Stack[-0]T)
0x1a6: Pop(0)
0x1a7: Push(Stack[-1])
0x1a8: IF (Stack[-1] == 0) GOTO 0x1af; Pop(1)

0x1a9: @ Face(Stack[-0]T)
0x1aa: Pop(0)
0x1ab: PushEmpty()
0x1ac: Call2 0x1ea
...
0x1bd: @ StopAsync()
0x1be: Pop(0)
0x1bf: Push("all") // @poff=186
0x1c0: Push("attack_off") // @poff=224
...
0x1f8: Pop(0)
0x1f9: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x1fa: Pop(1)
...
0x200: Stack[-2] = Stack[-15]
0x201: Pop(2)
0x202: PushEmpty(float, cvector, cvector)
0x203: Stack[-17] = Stack[-2]
0x204: Stack[-16] = Stack[-1]
0x205: Call2 0x582

0x206: Pop(2)
0x207: Push((float)0.9993908405303955)
...
0x20d: Pop(0)
0x20e: Push("all") // @poff=186
0x20f: Push("attack_begin1") // @poff=268
0x210: @ PlayAnimation(Stack[-2], Stack[-1])
0x211: Pop(2)
0x212: Push("attack") // @poff=296
...
0x218: Pop(0)
0x219: Push("light-dynamic") // @poff=310
0x21a: Push("soldier_fire.xml") // @poff=338
...
0x236: Push((float)0.03490658476948738)
...
0x244: Stack[-4] = Stack[-7]
0x245: Pop(4)
0x246: Push((int) 2)
0x247: Push((float)1.5)
0x248: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x249: Pop(2)
0x24a: GOTO 0x25a
...
0x24f: Pop(0)
0x250: Push("scripted") // @poff=382
0x251: Push(CVector(0.0, 0.0, 1.0))
0x252: Push("richochet.xml") // @poff=400
0x253: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x254: Pop(3)
0x255: Push("Material") // @poff=428
0x256: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=446
0x257: Pop(1)
0x258: Stack[-1] = 0
0x259: Stack[-2] = 0
0x25a: Push("all") // @poff=186
0x25b: Push("attack_end1") // @poff=464
0x25c: @ PlayAnimation(Stack[-2], Stack[-1])
0x25d: Pop(2)
0x25e: @ WaitForAnimEnd()
0x25f: Pop(0)
0x260: Push("all") // @poff=186
0x261: Push("attack_on") // @poff=194
...
0x280: Stack[-7] = Stack[-3]
0x281: Stack[-6] = Stack[-2]
...
0x2a0: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=488
0x2a1: Pop(1)
...
0x2c1: Stack[-2] = "quest_d10_01" // @poff=491
0x2c2: Stack[-1] = "soldier_fight" // @poff=517
0x2c3: Call2 0x5a4
...
0x2d1: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=488
0x2d2: Pop(1)
0x2d3: Push(Stack[-1])
...
0x2f7: @ GetPFPosition(Stack[-1]T)
0x2f8: Pop(0)
0x2f9: @ GetDirection(Stack[-0]T)
0x2fa: Pop(0)
0x2fb: PushEmpty()
0x2fc: Call2 0x34f
...
0x318: @ FindPathTo(Stack[-1], Stack[-1]T)
0x319: Pop(0)
...
0x327: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x328: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x33a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x33b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x35a: Stack[-2] = "bullet" // @poff=555
0x35b: Return(); Pop(0)

0x35c: Stack[-2] = "phys" // @poff=569
0x35d: Return(); Pop(0)

0x35e: PushEmpty(cvector, cvector, cvector, cvector)
0x35f: @ GetPosition(Stack[-2])
0x360: Pop(0)
0x361: @@ GetPosition(Stack[-1]); Obj=5 // @poff=26
0x362: Pop(0)
...
0x367: Pop(0)
0x368: @@ GetPosition(Stack[-2]); Obj=7 // @poff=26
0x369: Pop(0)
...
0x37a: Push("HasProperty") // @poff=593
0x37b: Push((int) 2)
...
0x381: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=617
0x382: Pop(0)
...
0x387: Stack[-18] = Stack[-2]
0x388: Stack[-1] = "health" // @poff=629
0x389: Call2 0x379
...
0x390: Stack[-18] = Stack[-2]
0x391: Stack[-1] = "armor" // @poff=643
0x392: Call2 0x379
...
0x398: Push("armor") // @poff=643
0x399: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=655
0x39a: Pop(1)
0x39b: Push("armor_") // @poff=667
0x39c: PushEmpty(string, int)
0x39d: Stack[-16] = Stack[-1]
0x39e: Call2 0x350

0x39f: Pop(1)
0x3a0: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3a1: PushEmpty(bool, object, string)
0x3a2: Stack[-18] = Stack[-2]
0x3a3: Stack[-8] = Stack[-1]
0x3a4: Call2 0x379
...
0x3aa: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=655
0x3ab: Pop(0)
...
0x3b2: Stack[-3] = Stack[-6]
0x3b3: Pop(3)
0x3b4: Push("health") // @poff=629
0x3b5: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=655
0x3b6: Pop(1)
0x3b7: Push((int) 1)
0x3b8: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3b9: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3ba: Push("health") // @poff=629
...
0x3c0: Pop(3)
0x3c1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=681
0x3c2: Pop(2)
0x3c3: PushEmpty(bool, object)
0x3c4: Stack[-17] = Stack[-1]
0x3c5: Call2 0x374
...
0x3cb: Pop(1)
0x3cc: Stack[-1] = Stack[-16]
0x3cd: Return(); Pop(12)

0x3ce: PushEmpty(bool, bool)
0x3cf: @@ IsDead(Stack[-1]); Obj=3 // @poff=693
0x3d0: Pop(0)
0x3d1: Stack[-1] = Stack[-4]
0x3d2: Return(); Pop(2)

0x3d3: PushEmpty(object, object, object, object)
0x3d4: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3ed: @@ GetScene(Stack[-1]); Obj=5 // @poff=714
0x3ee: Pop(0)
...
0x401: Stack[-6] = Stack[-2]
0x402: Stack[-1] = "noaccess" // @poff=723
0x403: Call2 0x379
...
0x409: Push("noaccess") // @poff=723
0x40a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=655
0x40b: Pop(1)
0x40c: Push((int) 0)
...
0x410: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x41e: @@ GetPosition(Stack[-5]); Obj=15 // @poff=26
0x41f: Pop(0)
...
0x42f: Stack[-1] = "fhit" // @poff=741
0x430: GOTO 0x432

0x431: Stack[-1] = "bhit" // @poff=751
0x432: Push("hit_react") // @poff=761
0x433: Push("1") // @poff=292
0x434: Pop(1); Push(Stack[-3] + Stack[-1]);
0x435: Push("2") // @poff=781
...
0x450: Stack[-2] = Stack[-3]
0x451: Pop(2)
0x452: Call2 0x544

0x453: Stack[-2] = Stack[-11]
0x454: Pop(2)
0x455: @ CreateVectorVector(Stack[-8])
0x456: Pop(0)
0x457: Stack[-7] = (int) 1
0x458: Push("hit") // @poff=743
...
0x46d: Pop(0)
0x46e: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=794
0x46f: Pop(0)
0x470: PushEmpty(object, int, float, cvector, cvector)
0x471: Stack[-26] = Stack[-5]
0x472: Stack[-25] = Stack[-4]
0x473: Stack[-24] = Stack[-3]
0x474: Stack[-6] = Stack[-2]
...
0x48e: @@ GetPosition(Stack[-3]); Obj=7 // @poff=26
0x48f: Pop(0)
...
0x49a: Pop(0)
0x49b: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=162
0x49c: Pop(0)
...
0x4a6: Stack[-7] = Stack[-2]
0x4a7: Stack[-6] = Stack[-1]
0x4a8: Call2 0x564
...
0x4b1: Stack[-10] = Stack[-2]
0x4b2: Stack[-9] = Stack[-1]
0x4b3: Call2 0x564
...
0x4ff: Push("woman") // @poff=826
0x500: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x501: IF (Stack[-1] == 1) GOTO 0x506; Pop(1)

0x502: Push("worker") // @poff=838
0x503: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x504: IF (Stack[-1] == 1) GOTO 0x506; Pop(1)

0x505: Stack[-1] = (bool) 0
0x506: IF (Stack[-1] == 1) GOTO 0x50b; Pop(1)

0x507: Push("butcher") // @poff=852
0x508: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x509: IF (Stack[-1] == 1) GOTO 0x50b; Pop(1)

0x50a: Stack[-1] = (bool) 0
0x50b: IF (Stack[-1] == 1) GOTO 0x510; Pop(1)

0x50c: Push("wasted_girl") // @poff=868
0x50d: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x50e: IF (Stack[-1] == 1) GOTO 0x510; Pop(1)

0x50f: Stack[-1] = (bool) 0
0x510: IF (Stack[-1] == 1) GOTO 0x515; Pop(1)

0x511: Push("boy") // @poff=892
0x512: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x513: IF (Stack[-1] == 1) GOTO 0x515; Pop(1)

0x514: Stack[-1] = (bool) 0
0x515: IF (Stack[-1] == 1) GOTO 0x51a; Pop(1)

0x516: Push("vaxxabitka") // @poff=900
0x517: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x518: IF (Stack[-1] == 1) GOTO 0x51a; Pop(1)

0x519: Stack[-1] = (bool) 0
0x51a: IF (Stack[-1] == 1) GOTO 0x51f; Pop(1)

0x51b: Push("unosha") // @poff=922
0x51c: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x51d: IF (Stack[-1] == 1) GOTO 0x51f; Pop(1)

0x51e: Stack[-1] = (bool) 0
0x51f: IF (Stack[-1] == 1) GOTO 0x524; Pop(1)

0x520: Push("wasted_male") // @poff=936
0x521: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x522: IF (Stack[-1] == 1) GOTO 0x524; Pop(1)

0x523: Stack[-1] = (bool) 0
0x524: IF (Stack[-1] == 1) GOTO 0x529; Pop(1)

0x525: Push("alkash") // @poff=960
0x526: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x527: IF (Stack[-1] == 1) GOTO 0x529; Pop(1)

0x528: Stack[-1] = (bool) 0
0x529: IF (Stack[-1] == 1) GOTO 0x52e; Pop(1)

0x52a: Push("dohodyaga") // @poff=974
0x52b: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x52c: IF (Stack[-1] == 1) GOTO 0x52e; Pop(1)

0x52d: Stack[-1] = (bool) 0
0x52e: IF (Stack[-1] == 1) GOTO 0x533; Pop(1)

0x52f: Push("vaxxabit") // @poff=994
0x530: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x531: IF (Stack[-1] == 1) GOTO 0x533; Pop(1)

0x532: Stack[-1] = (bool) 0
0x533: IF (Stack[-1] == 1) GOTO 0x538; Pop(1)

0x534: Push("nudegirl") // @poff=1012
0x535: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x536: IF (Stack[-1] == 1) GOTO 0x538; Pop(1)

0x537: Stack[-1] = (bool) 0
0x538: IF (Stack[-1] == 1) GOTO 0x53d; Pop(1)

0x539: Push("morlok") // @poff=1030
0x53a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x53b: IF (Stack[-1] == 1) GOTO 0x53d; Pop(1)
...
0x547: Push((float)9.999999974752427e-07)
...
0x555: Stack[-2] = Stack[-3]
0x556: GOTO 0x558

0x557: Stack[-1] = Stack[-3]
0x558: Return(); Pop(0)
...
0x5a6: Pop(0)
0x5a7: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5da: Push("GenerateMoney: iMin > iMax") // @poff=1072
0x5db: @ Trace(Stack[-1])
0x5dc: Pop(1)
0x5dd: Return(); Pop(4)
...
0x5f8: Pop(0)
0x5f9: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1138
0x5fa: Pop(0)
0x5fb: Push("Organ") // @poff=1150
0x5fc: Push((int) 1)
0x5fd: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=681
0x5fe: Pop(2)
0x5ff: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1162
0x600: Pop(0)
0x601: Push((int) 0)
0x602: Push((int) 1)
...
0x60f: Stack[-1] = "liver" // @poff=1172
0x610: Call2 0x5f6

0x611: Pop(1)
0x612: PushEmpty(string)
0x613: Stack[-1] = "kidney" // @poff=1184
0x614: Call2 0x5f6

0x615: Pop(1)
0x616: PushEmpty(string)
0x617: Stack[-1] = "heart" // @poff=1198
0x618: Call2 0x5f6

0x619: Pop(1)
0x61a: PushEmpty(string)
0x61b: Stack[-1] = "blood" // @poff=1210
0x61c: Call2 0x5f6
...
0x629: Stack[-4] = "rifle_ammo" // @poff=1222
0x62a: Stack[-3] = (int) 1
0x62b: Stack[-2] = (int) 3
0x62c: Stack[-1] = (int) 3
0x62d: Call2 0x4af
...
0x637: Stack[-3] = "bandage" // @poff=1254
0x638: Stack[-2] = (int) 1
0x639: Stack[-1] = (int) 6
0x63a: Call2 0x4a4
...
0x63d: Stack[-3] = "tourniquet" // @poff=1270
0x63e: Stack[-2] = (int) 1
0x63f: Stack[-1] = (int) 6
0x640: Call2 0x4a4
...
0x645: Pop(0)
0x646: Stack[-1] = Stack[-4]
0x647: Return(); Pop(2)

0x648: PushEmpty()
0x649: PushEmpty(object)
0x64a: Stack[-2] = Stack[-1]
...
0x652: Stack[-7] = Stack[-3]
0x653: Stack[-6] = Stack[-2]
0x654: Stack[-5] = Stack[-1]
0x655: Call2 0x43b
...
0x65a: Stack[-11] = Stack[-5]
0x65b: Stack[-10] = Stack[-4]
0x65c: Stack[-9] = Stack[-3]
0x65d: Stack[-7] = Stack[-2]
0x65e: Stack[-6] = Stack[-1]
0x65f: Call2 0x47f
...
0x68b: Push("class") // @poff=1292
0x68c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=655
0x68d: Pop(1)
...
0x6a2: Push("patrol") // @poff=1304
0x6a3: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x6a4: IF (Stack[-1] == 1) GOTO 0x6a9; Pop(1)

0x6a5: Push("sanitar") // @poff=1318
0x6a6: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x6a7: IF (Stack[-1] == 1) GOTO 0x6a9; Pop(1)

0x6a8: Stack[-1] = (bool) 0
0x6a9: IF (Stack[-1] == 1) GOTO 0x6ae; Pop(1)

0x6aa: Push("soldier") // @poff=1334
0x6ab: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x6ac: IF (Stack[-1] == 1) GOTO 0x6ae; Pop(1)

0x6ad: Stack[-1] = (bool) 0
0x6ae: IF (Stack[-1] == 1) GOTO 0x6b3; Pop(1)

0x6af: Push("woman") // @poff=826
0x6b0: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x6b1: IF (Stack[-1] == 1) GOTO 0x6b3; Pop(1)

0x6b2: Stack[-1] = (bool) 0
0x6b3: IF (Stack[-1] == 1) GOTO 0x6b8; Pop(1)

0x6b4: Push("wasted_girl") // @poff=868
0x6b5: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x6b6: IF (Stack[-1] == 1) GOTO 0x6b8; Pop(1)

0x6b7: Stack[-1] = (bool) 0
0x6b8: IF (Stack[-1] == 1) GOTO 0x6bd; Pop(1)

0x6b9: Push("vaxxabitka") // @poff=900
0x6ba: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x6bb: IF (Stack[-1] == 1) GOTO 0x6bd; Pop(1)

0x6bc: Stack[-1] = (bool) 0
0x6bd: IF (Stack[-1] == 1) GOTO 0x6c2; Pop(1)

0x6be: Push("vaxxabit") // @poff=994
0x6bf: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6c0: IF (Stack[-1] == 1) GOTO 0x6c2; Pop(1)

0x6c1: Stack[-1] = (bool) 0
0x6c2: IF (Stack[-1] == 1) GOTO 0x6c7; Pop(1)

0x6c3: Push("little_girl") // @poff=1350
0x6c4: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x6c5: IF (Stack[-1] == 1) GOTO 0x6c7; Pop(1)

0x6c6: Stack[-1] = (bool) 0
0x6c7: IF (Stack[-1] == 1) GOTO 0x6cc; Pop(1)

0x6c8: Push("girl") // @poff=882
0x6c9: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x6ca: IF (Stack[-1] == 1) GOTO 0x6cc; Pop(1)

0x6cb: Stack[-1] = (bool) 0
0x6cc: IF (Stack[-1] == 1) GOTO 0x6d1; Pop(1)

0x6cd: Push("dohodyaga") // @poff=974
0x6ce: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6cf: IF (Stack[-1] == 1) GOTO 0x6d1; Pop(1)

0x6d0: Stack[-1] = (bool) 0
0x6d1: IF (Stack[-1] == 1) GOTO 0x6d6; Pop(1)

0x6d2: Push("nudegirl") // @poff=1012
0x6d3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x6d4: IF (Stack[-1] == 1) GOTO 0x6d6; Pop(1)
...
0x6e8: Push("worker") // @poff=838
0x6e9: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6ea: IF (Stack[-1] == 1) GOTO 0x6ef; Pop(1)

0x6eb: Push("butcher") // @poff=852
0x6ec: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6ed: IF (Stack[-1] == 1) GOTO 0x6ef; Pop(1)

0x6ee: Stack[-1] = (bool) 0
0x6ef: IF (Stack[-1] == 1) GOTO 0x6f4; Pop(1)

0x6f0: Push("boy") // @poff=892
0x6f1: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x6f2: IF (Stack[-1] == 1) GOTO 0x6f4; Pop(1)

0x6f3: Stack[-1] = (bool) 0
0x6f4: IF (Stack[-1] == 1) GOTO 0x6f9; Pop(1)

0x6f5: Push("unosha") // @poff=922
0x6f6: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x6f7: IF (Stack[-1] == 1) GOTO 0x6f9; Pop(1)

0x6f8: Stack[-1] = (bool) 0
0x6f9: IF (Stack[-1] == 1) GOTO 0x6fe; Pop(1)

0x6fa: Push("wasted_male") // @poff=936
0x6fb: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6fc: IF (Stack[-1] == 1) GOTO 0x6fe; Pop(1)

0x6fd: Stack[-1] = (bool) 0
0x6fe: IF (Stack[-1] == 1) GOTO 0x703; Pop(1)

0x6ff: Push("alkash") // @poff=960
0x700: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x701: IF (Stack[-1] == 1) GOTO 0x703; Pop(1)

0x702: Stack[-1] = (bool) 0
0x703: IF (Stack[-1] == 1) GOTO 0x708; Pop(1)

0x704: Push("morlok") // @poff=1030
0x705: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x706: IF (Stack[-1] == 1) GOTO 0x708; Pop(1)
...
0x748: Stack[-9] = Stack[-1]
0x749: Call2 0x374

0x74a: Pop(1)
0x74b: IF (Stack[-1] == 0) GOTO 0x752; Pop(1)

0x74c: Push("reputation") // @poff=1374
0x74d: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=655
0x74e: Pop(1)
0x74f: Push((float)0.33000001311302185)
0x750: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x751: Return(); Pop(6)

0x752: PushEmpty(bool, object, string)
0x753: Stack[-10] = Stack[-2]
0x754: Stack[-1] = "class" // @poff=1292
0x755: Call2 0x379
...
0x772: Stack[-10] = Stack[-2]
0x773: Stack[-1] = "disease" // @poff=1442
0x774: Call2 0x379
...
0x77d: Stack[-5] = Stack[-1]
0x77e: Call2 0x4e7

0x77f: Pop(1)
0x780: IF (Stack[-1] == 1) GOTO 0x785; Pop(1)

0x781: Push("dog") // @poff=1458
...
0x786: Push("disease") // @poff=1442
0x787: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=655
0x788: Pop(1)
0x789: Push((int) 0)
...
0x798: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=488
0x799: Pop(1)
0x79a: Push(Stack[-1])
...
0x7a1: Stack[-2] = Stack[-6]
0x7a2: Pop(2)
0x7a3: Return(); Pop(2)

0x7a4: PushEmpty()
0x7a5: PushEmpty(object)
0x7a6: Stack[-2] = Stack[-1]
0x7a7: Call2 0x7c4
...
0x7b5: Push(Stack[-2])
0x7b6: IF (Stack[-1] == 1) GOTO 0x7bf; Pop(1)

0x7b7: PushEmpty(float, object)
0x7b8: Stack[-8] = Stack[-1]
0x7b9: Call2 0x365

0x7ba: Pop(1)
0x7bb: Push((float)490000.0)
0x7bc: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x7bd: IF (Stack[-1] == 1) GOTO 0x7bf; Pop(1)
...
0x7c6: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=488
0x7c7: Pop(1)
0x7c8: Push(Stack[-1])
