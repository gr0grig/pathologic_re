...
Strings:
	...
	W:locked
	A:SetProperty
// @pool_raw:
...
0x0: Push("d10q02") // @poff=0
0x1: Push((int) 1)
0x2: @ SetVariable(Stack[-2], Stack[-1])
0x3: Pop(2)
0x4: PushEmpty(string, bool)
0x5: Stack[-2] = "cot_georg@door1" // @poff=14
0x6: Stack[-1] = (bool) 1
0x7: Call2 0x77

0x8: Pop(2)
0x9: PushEmpty(string, bool)
0xa: Stack[-2] = "cot_maria@door1" // @poff=46
0xb: Stack[-1] = (bool) 0
0xc: Call2 0x77

0xd: Pop(2)
0xe: PushEmpty(string, bool)
0xf: Stack[-2] = "cot_viktor@door1" // @poff=78
0x10: Stack[-1] = (bool) 0
0x11: Call2 0x77

0x12: Pop(2)
0x13: PushEmpty(string, bool)
0x14: Stack[-2] = "warehouse_rubin@door1" // @poff=112
0x15: Stack[-1] = (bool) 0
0x16: Call2 0x77
...
0x7c: Push("Door ") // @poff=212
0x7d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x7e: Push(" not found") // @poff=224
0x7f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x80: @ Trace(Stack[-1])
0x81: Pop(1)
0x82: GOTO 0x86

0x83: Push("locked") // @poff=246
0x84: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=260
0x85: Pop(1)
0x86: Return(); Pop(2)
