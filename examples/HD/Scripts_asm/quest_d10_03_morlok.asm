...
// @pool_raw:
// @pool_encoding:utf8
...
0xe0: Stack[-8] = Stack[-2]
0xe1: Stack[-7] = Stack[-1]
0xe2: Call2 0x11a
...
0x22e: Push("Can't find lsh animation : ") // @poff=222
...
0x23d: Push("Can't find lsh animation : ") // @poff=222
...
0x243: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x244: Pop(0)
...
0x25d: Push((float)9.999999974752427e-07)
...
0x291: Stack[-1] = "ui/NPC_Morlok.png" // @poff=292
0x292: Return(); Pop(0)

0x293: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=328
0x294: Return(); Pop(0)
