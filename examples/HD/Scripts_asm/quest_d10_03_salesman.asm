...
// @pool_raw:
// @pool_encoding:utf8
...
0x14d: Stack[-8] = Stack[-2]
0x14e: Stack[-7] = Stack[-1]
0x14f: Call2 0x187
...
0x18e: Push("player") // @poff=172
0x18f: @ FindActor(Stack[-4]T, Stack[-1])
0x190: Pop(1)
...
0x1a3: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x22e: Pop(0)
0x22f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x230: Pop(0)
...
0x23a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x23b: Pop(0)
0x23c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x23d: Pop(0)
...
0x29b: Push("Can't find lsh animation : ") // @poff=222
...
0x2aa: Push("Can't find lsh animation : ") // @poff=222
...
0x2b0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2b1: Pop(0)
...
0x2ca: Push((float)9.999999974752427e-07)
...
0x2ee: PushEmpty()
0x2ef: Push("ood10Salesman1") // @poff=278
0x2f0: Push((int) 1)
...
0x2ff: Stack[-1] = "ood10Salesman1" // @poff=278
0x300: Call2 0x2d1
...
0x31b: Push("Can't retrieve diary root") // @poff=322
0x31c: @ Trace(Stack[-1])
0x31d: Pop(1)
...
0x327: Pop(1)
0x328: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=374
0x329: Pop(0)
0x32a: Pop(0); Push((bool) Stack[-2] == 0)
0x32b: IF (Stack[-1] == 0) GOTO 0x332; Pop(1)

0x32c: Push("Can't find diary parent with id: ") // @poff=379
...
0x332: @@ AddChild(Stack[-8]); Obj=2 // @poff=447
0x333: Pop(0)
0x334: Push((int) 7)
0x335: @ SendWorldWndMessage(Stack[-1])
0x336: Pop(1)
0x337: @@ GetCategory(Stack[-1]); Obj=8 // @poff=456
0x338: Pop(0)
...
0x354: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=482
0x355: Return(); Pop(0)

0x356: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=522
0x357: Return(); Pop(0)
