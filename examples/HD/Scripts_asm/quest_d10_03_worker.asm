...
// @pool_raw:
// @pool_encoding:utf8
...
0x133: Stack[-8] = Stack[-2]
0x134: Stack[-7] = Stack[-1]
0x135: Call2 0x16d
...
0x174: Push("player") // @poff=172
0x175: @ FindActor(Stack[-4]T, Stack[-1])
0x176: Pop(1)
...
0x189: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1de: Pop(0)
0x1df: Push("all") // @poff=138
0x1e0: PushEmpty(string, int)
0x1e1: Stack[-7] = Stack[-1]
0x1e2: Call2 0x2bc
...
0x214: Pop(0)
0x215: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x216: Pop(0)
...
0x220: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x221: Pop(0)
0x222: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x223: Pop(0)
...
0x281: Push("Can't find lsh animation : ") // @poff=222
...
0x296: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x297: Pop(0)
...
0x2b0: Push((float)9.999999974752427e-07)
...
0x2d2: Stack[-2] = Stack[-5]
0x2d3: Return(); Pop(4)

0x2d4: PushEmpty()
0x2d5: Push("ood10Crowd1") // @poff=278
0x2d6: Push((int) 1)
...
0x2dc: Stack[-1] = "ood10Crowd1" // @poff=278
0x2dd: Call2 0x2b7
...
0x2f7: Stack[-1] = (int) 515568
0x2f8: Return(); Pop(0)

0x2f9: Stack[-1] = (int) 503353
0x2fa: Return(); Pop(0)

0x2fb: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=316
0x2fc: Return(); Pop(0)

0x2fd: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=356
0x2fe: Return(); Pop(0)
