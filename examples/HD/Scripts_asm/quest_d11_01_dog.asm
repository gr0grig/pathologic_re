...
0x44: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x45: Pop(0)
0x46: Push(Stack[-8])
0x47: IF (Stack[-1] == 0) GOTO 0x50; Pop(1)

0x48: Push("attack") // @poff=86
...
0x64: Pop(0)
0x65: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=100
0x66: Pop(0)
...
0x80: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=100
0x81: Pop(0)
...
0x9a: Pop(1)
0x9b: Push("all") // @poff=114
0x9c: Push("attack_on") // @poff=122
...
0xb4: IF (Stack[-1] == 1) GOTO 0xba; Pop(1)

0xb5: PushEmpty(bool)
0xb6: Call2 0x286

0xb7: Pop(0)
0xb8: IF (Stack[-1] == 1) GOTO 0xba; Pop(1)
...
0xbf: Pop(0)
0xc0: Push("all") // @poff=114
0xc1: Push("attack_stay") // @poff=142
0xc2: @ PlayAnimation(Stack[-2], Stack[-1])
0xc3: Pop(2)
0xc4: PushEmpty(bool, float)
0xc5: Stack[-25] = Stack[-1]
0xc6: Call2 0x202
...
0xcb: @ Face(Stack[-0]T)
0xcc: Pop(0)
0xcd: Push("all") // @poff=114
0xce: Push("fjump") // @poff=166
...
0xe9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=100
0xea: Pop(0)
...
0x108: Push("all") // @poff=114
0x109: Push("attack_off") // @poff=178
...
0x116: Push("all") // @poff=114
0x117: Push("attack_begin") // @poff=200
0x118: Push((int) 1)
0x119: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x124: Push("attack") // @poff=86
0x125: Push((int) 1)
0x126: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x130: Push("all") // @poff=114
0x131: Push("bjump") // @poff=226
...
0x138: Push((float)0.8999999761581421)
0x139: Pop(1); Push(Stack[-9] * Stack[-1]);
0x13a: @ GetVictim(Stack[-1], Stack[-4])
0x13b: Pop(1)
0x13c: @ ReportAttack(Stack[-0]T)
0x13d: Pop(0)
...
0x141: Stack[-6] = Stack[-2]
0x142: Stack[-10] = Stack[-1]
0x143: Call2 0x29

0x144: Stack[-3] = Stack[-5]
0x145: Pop(3)
0x146: PushEmpty(float, object, float, int)
0x147: Stack[-7] = Stack[-3]
0x148: Stack[-6] = Stack[-2]
0x149: PushEmpty(int, object, int)
0x14a: Stack[-10] = Stack[-2]
0x14b: Stack[-14] = Stack[-1]
0x14c: Call2 0x2c

0x14d: Stack[-3] = Stack[-4]
0x14e: Pop(3)
0x14f: Call2 0x46f

0x150: Stack[-4] = Stack[-5]
0x151: Pop(4)
0x152: PushEmpty(int)
0x153: Call2 0x2b6

0x154: Pop(0)
0x155: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x156: Pop(1)
0x157: PushEmpty(object, float)
0x158: Stack[-5] = Stack[-2]
...
0x161: Pop(0)
0x162: @ irand(Stack[-4], Stack[-1]T)
0x163: Pop(0)
0x164: Push((int) 1)
0x165: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x166: @ Face(Stack[-0]T)
0x167: Pop(0)
0x168: Push((bool) 1)
...
0x16d: Pop(0)
0x16e: Push("all") // @poff=114
0x16f: Push("attack_begin") // @poff=200
...
0x186: Pop(2)
0x187: Push("all") // @poff=114
0x188: Push("attack_middle") // @poff=238
...
0x190: Pop(0)
0x191: Push("all") // @poff=114
0x192: Push("attack_middle") // @poff=238
...
0x1cc: Stack[-11] = Stack[-2]
0x1cd: Stack[-6] = Stack[-1]
0x1ce: Call2 0x137
...
0x1d5: Pop(1)
0x1d6: Push("all") // @poff=114
0x1d7: Push("attack_end") // @poff=270
...
0x216: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=100
0x217: Pop(0)
...
0x262: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x263: Pop(1)
...
0x267: @ Face(Stack[-0]T)
0x268: Pop(0)
0x269: Push("all") // @poff=114
0x26a: Push("bjump") // @poff=226
0x26b: @ PlayAnimation(Stack[-2], Stack[-1])
0x26c: Pop(2)
0x26d: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=100
0x26e: Pop(0)
...
0x2a4: @ irand(Stack[-1], Stack[-2]T)
0x2a5: Pop(0)
0x2a6: Push((int) 1)
0x2a7: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x2a8: Push("attack") // @poff=86
...
0x2b9: Stack[-1] = "attack_stay" // @poff=142
0x2ba: Call2 0x58d
...
0x2e4: Stack[-15] = Stack[-5]
0x2e5: Stack[-14] = Stack[-4]
0x2e6: Stack[-13] = Stack[-3]
0x2e7: Stack[-12] = Stack[-2]
0x2e8: Stack[-11] = Stack[-1]
0x2e9: Call2 0x32e

0x2ea: Stack[-6] = Stack[-7]
0x2eb: Pop(6)
0x2ec: Push( Stack[2 + Tasks[-1].StackPointer] )
0x2ed: IF (Stack[-1] == 0) GOTO 0x2f1; Pop(1)

0x2ee: Push("head") // @poff=328
0x2ef: @ UnlookAsync(Stack[-1])
0x2f0: Pop(1)
0x2f1: Push((int) 1)
0x2f2: @ KillTimer(Stack[-1])
0x2f3: Pop(1)
0x2f4: Stack[-1] = Stack[-10]
0x2f5: Return(); Pop(4)
...
0x331: Stack[-17] = Stack[-7]
0x332: PushEmpty(bool, object)
0x333: Stack[-23] = Stack[-1]
0x334: Call2 0x3ba
...
0x33a: @@ GetPosition(Stack[-5]); Obj=21 // @poff=338
0x33b: Pop(0)
...
0x351: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=100
0x352: Pop(0)
...
0x363: Push((int) 0)
0x364: Push((float)0.30000001192092896)
...
0x386: Push((int) 0)
0x387: Push((float)0.30000001192092896)
...
0x3c1: Stack[-1] = "walk" // @poff=350
0x3c2: Return(); Pop(0)

0x3c3: Stack[-1] = "run" // @poff=360
0x3c4: Return(); Pop(0)
...
0x3cf: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3d0: IF (Stack[-1] == 0) GOTO 0x3d6; Pop(1)

0x3d1: PushEmpty(string)
0x3d2: Stack[-1] = "fdie" // @poff=368
0x3d3: Call2 0x429

0x3d4: Pop(1)
0x3d5: GOTO 0x428

0x3d6: @@ GetPosition(Stack[-10]); Obj=21 // @poff=338
0x3d7: Pop(0)
...
0x3e7: Stack[-6] = "fdie" // @poff=368
0x3e8: GOTO 0x3ea

0x3e9: Stack[-6] = "bdie" // @poff=378
...
0x3f0: @ StopAsync()
0x3f1: Pop(0)
0x3f2: Stack[-21] = Stack[-5]
0x3f3: Push("GetScriptProperty") // @poff=388
0x3f4: Push((int) 2)
0x3f5: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3f6: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x3f7: Push("Owner") // @poff=424
0x3f8: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=436
0x3f9: Pop(1)
0x3fa: Push(Stack[-4])
0x3fb: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x3fc: Push("Owner") // @poff=424
0x3fd: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=454
0x3fe: Pop(1)
0x3ff: Pop(0); PushNull((bool) Stack[-5] == 0)
0x400: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x401: Stack[-21] = Stack[-5]
0x402: Push("@GetEyesHeight") // @poff=472
0x403: Push((int) 1)
0x404: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x405: IF (Stack[-1] == 0) GOTO 0x411; Pop(1)

0x406: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=502
0x407: Pop(0)
...
0x41d: @ StopAsync()
0x41e: Pop(0)
0x41f: Push("head") // @poff=328
0x420: @ UnlookAsync(Stack[-1])
0x421: Pop(1)
0x422: Push("all") // @poff=114
...
0x453: Stack[-2] = "bullet" // @poff=526
0x454: Return(); Pop(0)

0x455: Stack[-2] = "phys" // @poff=540
0x456: Return(); Pop(0)

0x457: PushEmpty(cvector, cvector, cvector, cvector)
0x458: @ GetPosition(Stack[-2])
0x459: Pop(0)
0x45a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=338
0x45b: Pop(0)
...
0x460: Pop(0)
0x461: Stack[-1] = Stack[-4]
0x462: Return(); Pop(2)

0x463: PushEmpty(bool, bool)
0x464: Push("HasProperty") // @poff=550
0x465: Push((int) 2)
...
0x46b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=574
0x46c: Pop(0)
...
0x471: Stack[-18] = Stack[-2]
0x472: Stack[-1] = "health" // @poff=586
0x473: Call2 0x463
...
0x482: Push("armor") // @poff=600
0x483: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=612
0x484: Pop(1)
0x485: Push("armor_") // @poff=624
0x486: PushEmpty(string, int)
0x487: Stack[-16] = Stack[-1]
0x488: Call2 0x449

0x489: Pop(1)
0x48a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x48b: PushEmpty(bool, object, string)
0x48c: Stack[-18] = Stack[-2]
0x48d: Stack[-8] = Stack[-1]
0x48e: Call2 0x463
...
0x494: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=612
0x495: Pop(0)
...
0x49c: Stack[-3] = Stack[-6]
0x49d: Pop(3)
0x49e: Push("health") // @poff=586
0x49f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=612
0x4a0: Pop(1)
0x4a1: Push((int) 1)
0x4a2: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4a3: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4a4: Push("health") // @poff=586
...
0x4aa: Pop(3)
0x4ab: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=638
0x4ac: Pop(2)
0x4ad: PushEmpty(bool, object)
0x4ae: Stack[-17] = Stack[-1]
0x4af: Call2 0x45e
...
0x4b9: @@ IsDead(Stack[-1]); Obj=3 // @poff=650
0x4ba: Pop(0)
...
0x4d7: @@ GetScene(Stack[-1]); Obj=5 // @poff=671
0x4d8: Pop(0)
...
0x4ec: Stack[-1] = "noaccess" // @poff=680
0x4ed: Call2 0x463
...
0x4f3: Push("noaccess") // @poff=680
0x4f4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=612
0x4f5: Pop(1)
0x4f6: Push((int) 0)
...
0x4fa: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x508: @@ GetPosition(Stack[-5]); Obj=15 // @poff=338
0x509: Pop(0)
...
0x519: Stack[-1] = "fhit" // @poff=698
0x51a: GOTO 0x51c

0x51b: Stack[-1] = "bhit" // @poff=708
0x51c: Push("hit_react") // @poff=718
0x51d: Push("1") // @poff=738
0x51e: Pop(1); Push(Stack[-3] + Stack[-1]);
0x51f: Push("2") // @poff=742
...
0x538: Stack[-25] = Stack[-1]
0x539: Call2 0x457

0x53a: Stack[-2] = Stack[-3]
0x53b: Pop(2)
0x53c: Call2 0x5bc
...
0x557: Pop(0)
0x558: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=755
0x559: Pop(0)
0x55a: PushEmpty(object, int, float, cvector, cvector)
0x55b: Stack[-26] = Stack[-5]
0x55c: Stack[-25] = Stack[-4]
0x55d: Stack[-24] = Stack[-3]
0x55e: Stack[-6] = Stack[-2]
...
0x578: @@ GetPosition(Stack[-3]); Obj=7 // @poff=338
0x579: Pop(0)
...
0x583: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=502
0x584: Pop(0)
...
0x60f: Stack[-7] = Stack[-3]
0x610: Stack[-6] = Stack[-2]
0x611: Stack[-5] = Stack[-1]
0x612: Call2 0x525
...
0x617: Stack[-11] = Stack[-5]
0x618: Stack[-10] = Stack[-4]
0x619: Stack[-9] = Stack[-3]
0x61a: Stack[-7] = Stack[-2]
0x61b: Stack[-6] = Stack[-1]
0x61c: Call2 0x569
