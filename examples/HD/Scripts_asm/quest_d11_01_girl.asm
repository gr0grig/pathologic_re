...
// @pool_raw:
// @pool_encoding:utf8
...
0x276: Push("Can't find lsh animation : ") // @poff=224
...
0x285: Push("Can't find lsh animation : ") // @poff=224
...
0x29a: Push((float)9.999999974752427e-07)
...
0x2a8: Pop(0)
0x2a9: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2bb: Stack[-1] = Stack[-4]
0x2bc: Pop(1)
0x2bd: Stack[-2] = "pt_map_uprava_admin" // @poff=280
0x2be: Stack[-1] = (int) 2
0x2bf: Call2 0x351
...
0x2c3: Pop(0)
0x2c4: @@ ShowMap(Stack[-1]); Obj=2 // @poff=320
0x2c5: Pop(1)
0x2c6: Return(); Pop(0)

0x2c7: PushEmpty()
0x2c8: Push("ood11Nude1") // @poff=328
0x2c9: Push((int) 1)
...
0x2d5: Pop(1)
0x2d6: Push("d11q01NudeGotoRastrel") // @poff=364
0x2d7: Push("pt_d11q01_msoldier") // @poff=408
0x2d8: Push((int) 1)
...
0x2dc: Pop(0)
0x2dd: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=446
0x2de: Pop(5)
0x2df: Push("d11q01NudeGotoBlock") // @poff=454
0x2e0: Push("pt_map_uprava_admin") // @poff=280
0x2e1: Push((int) 1)
...
0x2e5: Pop(0)
0x2e6: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=446
0x2e7: Pop(5)
0x2e8: PushEmpty()
0x2e9: Call2 0x30a
...
0x2ec: Stack[-2] = "quest_d11_01" // @poff=494
0x2ed: Stack[-1] = "init_soldiers" // @poff=520
0x2ee: Call2 0x2a6
...
0x300: Stack[-1] = "ood11Nude1" // @poff=328
0x301: Call2 0x2a1
...
0x31c: Push("Can't retrieve diary root") // @poff=548
0x31d: @ Trace(Stack[-1])
0x31e: Pop(1)
...
0x327: Stack[-1] = Stack[-4]
0x328: Pop(1)
0x329: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=600
0x32a: Pop(0)
0x32b: Pop(0); Push((bool) Stack[-2] == 0)
0x32c: IF (Stack[-1] == 0) GOTO 0x333; Pop(1)

0x32d: Push("Can't find diary parent with id: ") // @poff=605
...
0x333: @@ AddChild(Stack[-8]); Obj=2 // @poff=673
0x334: Pop(0)
0x335: Push((int) 7)
0x336: @ SendWorldWndMessage(Stack[-1])
0x337: Pop(1)
0x338: @@ GetCategory(Stack[-1]); Obj=8 // @poff=682
0x339: Pop(0)
...
0x342: Pop(0)
0x343: Pop(0); PushNull((bool) Stack[-2] == 0)
0x344: IF (Stack[-1] == 0) GOTO 0x34b; Pop(1)

0x345: Push("Can't find main outdoor scene") // @poff=694
0x346: @ Trace(Stack[-1])
0x347: Pop(1)
0x348: Stack[-1] = 0
0x349: Stack[-1] = Stack[-5]
0x34a: Return(); Pop(4)

0x34b: @@ GetMap(Stack[-1]); Obj=2 // @poff=754
0x34c: Pop(0)
0x34d: Stack[-1] = Stack[-5]
0x34e: Return(); Pop(4)
...
0x353: Pop(0)
0x354: Pop(0); PushNull((bool) Stack[-2] == 0)
0x355: IF (Stack[-1] == 0) GOTO 0x35a; Pop(1)

0x356: Push("Can't find main outdoor scene") // @poff=694
0x357: @ Trace(Stack[-1])
0x358: Pop(1)
0x359: Return(); Pop(8)

0x35a: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=761
0x35b: Pop(0)
0x35c: Pop(0); Push((bool) Stack[-1] == 0)
0x35d: IF (Stack[-1] == 0) GOTO 0x364; Pop(1)

0x35e: Push("Warning: outdoor scene locator ") // @poff=772
0x35f: Pop(1); Push(Stack[-1] + Stack[-11]);
0x360: Push(" doesnt exist") // @poff=836
0x361: Pop(2); Push(Stack[-2] + Stack[-1]);
0x362: @ Trace(Stack[-1])
0x363: Pop(1)
0x364: @@ GetMap(Stack[-11]); Obj=2 // @poff=754
0x365: Pop(0)
0x366: Pop(0); PushNull((bool) Stack[-11] == 0)
0x367: IF (Stack[-1] == 0) GOTO 0x36c; Pop(1)

0x368: Push("Can't find map") // @poff=864
0x369: @ Trace(Stack[-1])
0x36a: Pop(1)
0x36b: Return(); Pop(8)
...
0x36e: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=894
0x36f: Pop(2)
0x370: Return(); Pop(8)

0x371: Stack[-2] = 0
0x372: PushEmpty(int, int)
0x373: Push("branch") // @poff=907
...
0x387: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=921
0x388: Return(); Pop(0)

0x389: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=961
0x38a: Return(); Pop(0)
