...
// @pool_raw:
...
0x2c7: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=346
0x2c8: Pop(1)
...
0x306: @ GetPFPosition(Stack[-1]T)
0x307: Pop(0)
0x308: @ GetDirection(Stack[-0]T)
0x309: Pop(0)
0x30a: PushEmpty()
0x30b: Call2 0x35e
...
0x327: @ FindPathTo(Stack[-1], Stack[-1]T)
0x328: Pop(0)
...
0x336: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x337: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x349: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x34a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x37f: Pop(0); PushNull((bool) Stack[-21] == 0)
0x380: IF (Stack[-1] == 0) GOTO 0x386; Pop(1)

0x381: PushEmpty(string)
0x382: Stack[-1] = "fdie" // @poff=349
0x383: Call2 0x3d9

0x384: Pop(1)
0x385: GOTO 0x3d8

0x386: @@ GetPosition(Stack[-10]); Obj=21 // @poff=359
0x387: Pop(0)
...
0x397: Stack[-6] = "fdie" // @poff=349
0x398: GOTO 0x39a

0x399: Stack[-6] = "bdie" // @poff=371
...
0x3a0: @ StopAsync()
0x3a1: Pop(0)
0x3a2: Stack[-21] = Stack[-5]
0x3a3: Push("GetScriptProperty") // @poff=381
0x3a4: Push((int) 2)
0x3a5: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3a6: IF (Stack[-1] == 0) GOTO 0x3b2; Pop(1)

0x3a7: Push("Owner") // @poff=417
0x3a8: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=429
0x3a9: Pop(1)
0x3aa: Push(Stack[-4])
0x3ab: IF (Stack[-1] == 0) GOTO 0x3b2; Pop(1)

0x3ac: Push("Owner") // @poff=417
0x3ad: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=447
0x3ae: Pop(1)
0x3af: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3b0: IF (Stack[-1] == 0) GOTO 0x3b2; Pop(1)

0x3b1: Stack[-21] = Stack[-5]
0x3b2: Push("@GetEyesHeight") // @poff=465
0x3b3: Push((int) 1)
0x3b4: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x3b5: IF (Stack[-1] == 0) GOTO 0x3c1; Pop(1)

0x3b6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=495
0x3b7: Pop(0)
...
0x3cd: @ StopAsync()
0x3ce: Pop(0)
0x3cf: Push("head") // @poff=509
0x3d0: @ UnlookAsync(Stack[-1])
0x3d1: Pop(1)
0x3d2: Push("all") // @poff=0
...
0x3e5: Stack[-2] = Stack[-1]
0x3e6: Call2 0x541

0x3e7: Pop(1)
0x3e8: Push("all") // @poff=0
0x3e9: @ PlayAnimation(Stack[-1], Stack[-2])
0x3ea: Pop(1)
0x3eb: @ WaitForAnimEnd()
0x3ec: Pop(0)
0x3ed: Push("all") // @poff=0
...
0x403: Stack[-2] = "bullet" // @poff=529
0x404: Return(); Pop(0)

0x405: Stack[-2] = "phys" // @poff=543
0x406: Return(); Pop(0)

0x407: PushEmpty(cvector, cvector, cvector, cvector)
0x408: @ GetPosition(Stack[-2])
0x409: Pop(0)
0x40a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=359
0x40b: Pop(0)
...
0x410: Pop(0)
0x411: @@ GetPosition(Stack[-2]); Obj=7 // @poff=359
0x412: Pop(0)
...
0x41c: Push("HasProperty") // @poff=553
0x41d: Push((int) 2)
...
0x423: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=577
0x424: Pop(0)
...
0x429: Stack[-18] = Stack[-2]
0x42a: Stack[-1] = "health" // @poff=589
0x42b: Call2 0x41b
...
0x432: Stack[-18] = Stack[-2]
0x433: Stack[-1] = "armor" // @poff=603
0x434: Call2 0x41b
...
0x43a: Push("armor") // @poff=603
0x43b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=615
0x43c: Pop(1)
0x43d: Push("armor_") // @poff=627
0x43e: PushEmpty(string, int)
0x43f: Stack[-16] = Stack[-1]
0x440: Call2 0x3f9

0x441: Pop(1)
0x442: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x443: PushEmpty(bool, object, string)
0x444: Stack[-18] = Stack[-2]
...
0x44c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=615
0x44d: Pop(0)
...
0x454: Stack[-3] = Stack[-6]
0x455: Pop(3)
0x456: Push("health") // @poff=589
0x457: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=615
0x458: Pop(1)
0x459: Push((int) 1)
0x45a: Pop(1); Push(Stack[-1] - Stack[-4]);
0x45b: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x45c: Push("health") // @poff=589
...
0x462: Pop(3)
0x463: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=641
0x464: Pop(2)
0x465: PushEmpty(bool, object)
0x466: Stack[-17] = Stack[-1]
0x467: Call2 0x416
...
0x46d: Pop(1)
0x46e: Stack[-1] = Stack[-16]
0x46f: Return(); Pop(12)

0x470: PushEmpty(bool, bool)
0x471: @@ IsDead(Stack[-1]); Obj=3 // @poff=653
0x472: Pop(0)
0x473: Stack[-1] = Stack[-4]
0x474: Return(); Pop(2)

0x475: PushEmpty(object, object, object, object)
0x476: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x48a: Pop(0)
0x48b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x48c: IF (Stack[-1] == 0) GOTO 0x48f; Pop(1)

0x48d: Stack[-6] = (bool) 0
0x48e: Return(); Pop(4)

0x48f: @@ GetScene(Stack[-1]); Obj=5 // @poff=674
0x490: Pop(0)
...
0x4a3: Stack[-6] = Stack[-2]
0x4a4: Stack[-1] = "noaccess" // @poff=683
0x4a5: Call2 0x41b
...
0x4ab: Push("noaccess") // @poff=683
0x4ac: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=615
0x4ad: Pop(1)
0x4ae: Push((int) 0)
...
0x4b2: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x4c0: @@ GetPosition(Stack[-5]); Obj=15 // @poff=359
0x4c1: Pop(0)
...
0x4d1: Stack[-1] = "fhit" // @poff=701
0x4d2: GOTO 0x4d4

0x4d3: Stack[-1] = "bhit" // @poff=711
0x4d4: Push("hit_react") // @poff=721
0x4d5: Push("1") // @poff=160
0x4d6: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4d7: Push("2") // @poff=741
...
0x4f0: Stack[-25] = Stack[-1]
0x4f1: Call2 0x407

0x4f2: Stack[-2] = Stack[-3]
0x4f3: Pop(2)
0x4f4: Call2 0x5c7

0x4f5: Stack[-2] = Stack[-11]
0x4f6: Pop(2)
0x4f7: @ CreateVectorVector(Stack[-8])
0x4f8: Pop(0)
0x4f9: Stack[-7] = (int) 1
0x4fa: Push("hit") // @poff=703
...
0x50f: Pop(0)
0x510: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=754
0x511: Pop(0)
0x512: PushEmpty(object, int, float, cvector, cvector)
0x513: Stack[-26] = Stack[-5]
0x514: Stack[-25] = Stack[-4]
0x515: Stack[-24] = Stack[-3]
...
0x530: @@ GetPosition(Stack[-3]); Obj=7 // @poff=359
0x531: Pop(0)
...
0x53c: Pop(0)
0x53d: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=495
0x53e: Pop(0)
...
0x58f: Push("wasted_girl") // @poff=828
...
0x599: Push("vaxxabitka") // @poff=860
...
0x5a3: Push("wasted_male") // @poff=896
0x5a4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x5a5: IF (Stack[-1] == 1) GOTO 0x5a7; Pop(1)

0x5a6: Stack[-1] = (bool) 0
0x5a7: IF (Stack[-1] == 1) GOTO 0x5ac; Pop(1)

0x5a8: Push("alkash") // @poff=920
0x5a9: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x5aa: IF (Stack[-1] == 1) GOTO 0x5ac; Pop(1)

0x5ab: Stack[-1] = (bool) 0
0x5ac: IF (Stack[-1] == 1) GOTO 0x5b1; Pop(1)

0x5ad: Push("dohodyaga") // @poff=934
0x5ae: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x5af: IF (Stack[-1] == 1) GOTO 0x5b1; Pop(1)

0x5b0: Stack[-1] = (bool) 0
0x5b1: IF (Stack[-1] == 1) GOTO 0x5b6; Pop(1)

0x5b2: Push("vaxxabit") // @poff=954
0x5b3: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x5b4: IF (Stack[-1] == 1) GOTO 0x5b6; Pop(1)

0x5b5: Stack[-1] = (bool) 0
0x5b6: IF (Stack[-1] == 1) GOTO 0x5bb; Pop(1)

0x5b7: Push("nudegirl") // @poff=972
0x5b8: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5b9: IF (Stack[-1] == 1) GOTO 0x5bb; Pop(1)

0x5ba: Stack[-1] = (bool) 0
0x5bb: IF (Stack[-1] == 1) GOTO 0x5c0; Pop(1)

0x5bc: Push("morlok") // @poff=990
...
0x5ca: Push((float)9.999999974752427e-07)
...
0x64b: Stack[-7] = Stack[-3]
0x64c: Stack[-6] = Stack[-2]
0x64d: Stack[-5] = Stack[-1]
0x64e: Call2 0x4dd
...
0x653: Stack[-11] = Stack[-5]
0x654: Stack[-10] = Stack[-4]
0x655: Stack[-9] = Stack[-3]
0x656: Stack[-7] = Stack[-2]
0x657: Stack[-6] = Stack[-1]
0x658: Call2 0x521
...
0x670: Pop(0)
0x671: Push((float)0.05000000074505806)
0x672: Push((bool) 1)
...
0x67c: Stack[-7] = Stack[-2]
0x67d: Stack[-1] = "class" // @poff=1032
0x67e: Call2 0x41b
...
0x684: Push("class") // @poff=1032
0x685: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=615
0x686: Pop(1)
...
0x69b: Push("patrol") // @poff=1044
0x69c: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x69d: IF (Stack[-1] == 1) GOTO 0x6a2; Pop(1)

0x69e: Push("sanitar") // @poff=1058
0x69f: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x6a0: IF (Stack[-1] == 1) GOTO 0x6a2; Pop(1)

0x6a1: Stack[-1] = (bool) 0
0x6a2: IF (Stack[-1] == 1) GOTO 0x6a7; Pop(1)

0x6a3: Push("soldier") // @poff=1074
0x6a4: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x6a5: IF (Stack[-1] == 1) GOTO 0x6a7; Pop(1)

0x6a6: Stack[-1] = (bool) 0
0x6a7: IF (Stack[-1] == 1) GOTO 0x6ac; Pop(1)

0x6a8: Push("woman") // @poff=786
0x6a9: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x6aa: IF (Stack[-1] == 1) GOTO 0x6ac; Pop(1)

0x6ab: Stack[-1] = (bool) 0
0x6ac: IF (Stack[-1] == 1) GOTO 0x6b1; Pop(1)

0x6ad: Push("wasted_girl") // @poff=828
0x6ae: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x6af: IF (Stack[-1] == 1) GOTO 0x6b1; Pop(1)

0x6b0: Stack[-1] = (bool) 0
0x6b1: IF (Stack[-1] == 1) GOTO 0x6b6; Pop(1)

0x6b2: Push("vaxxabitka") // @poff=860
0x6b3: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x6b4: IF (Stack[-1] == 1) GOTO 0x6b6; Pop(1)

0x6b5: Stack[-1] = (bool) 0
0x6b6: IF (Stack[-1] == 1) GOTO 0x6bb; Pop(1)

0x6b7: Push("vaxxabit") // @poff=954
0x6b8: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6b9: IF (Stack[-1] == 1) GOTO 0x6bb; Pop(1)

0x6ba: Stack[-1] = (bool) 0
0x6bb: IF (Stack[-1] == 1) GOTO 0x6c0; Pop(1)

0x6bc: Push("little_girl") // @poff=1090
0x6bd: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x6be: IF (Stack[-1] == 1) GOTO 0x6c0; Pop(1)

0x6bf: Stack[-1] = (bool) 0
0x6c0: IF (Stack[-1] == 1) GOTO 0x6c5; Pop(1)

0x6c1: Push("girl") // @poff=842
0x6c2: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x6c3: IF (Stack[-1] == 1) GOTO 0x6c5; Pop(1)

0x6c4: Stack[-1] = (bool) 0
0x6c5: IF (Stack[-1] == 1) GOTO 0x6ca; Pop(1)

0x6c6: Push("dohodyaga") // @poff=934
0x6c7: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6c8: IF (Stack[-1] == 1) GOTO 0x6ca; Pop(1)

0x6c9: Stack[-1] = (bool) 0
0x6ca: IF (Stack[-1] == 1) GOTO 0x6cf; Pop(1)

0x6cb: Push("nudegirl") // @poff=972
0x6cc: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x6cd: IF (Stack[-1] == 1) GOTO 0x6cf; Pop(1)
...
0x6e1: Push("worker") // @poff=798
0x6e2: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6e3: IF (Stack[-1] == 1) GOTO 0x6e8; Pop(1)

0x6e4: Push("butcher") // @poff=812
0x6e5: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x6e6: IF (Stack[-1] == 1) GOTO 0x6e8; Pop(1)

0x6e7: Stack[-1] = (bool) 0
0x6e8: IF (Stack[-1] == 1) GOTO 0x6ed; Pop(1)

0x6e9: Push("boy") // @poff=852
0x6ea: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x6eb: IF (Stack[-1] == 1) GOTO 0x6ed; Pop(1)

0x6ec: Stack[-1] = (bool) 0
0x6ed: IF (Stack[-1] == 1) GOTO 0x6f2; Pop(1)

0x6ee: Push("unosha") // @poff=882
0x6ef: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x6f0: IF (Stack[-1] == 1) GOTO 0x6f2; Pop(1)

0x6f1: Stack[-1] = (bool) 0
0x6f2: IF (Stack[-1] == 1) GOTO 0x6f7; Pop(1)

0x6f3: Push("wasted_male") // @poff=896
0x6f4: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x6f5: IF (Stack[-1] == 1) GOTO 0x6f7; Pop(1)

0x6f6: Stack[-1] = (bool) 0
0x6f7: IF (Stack[-1] == 1) GOTO 0x6fc; Pop(1)

0x6f8: Push("alkash") // @poff=920
0x6f9: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x6fa: IF (Stack[-1] == 1) GOTO 0x6fc; Pop(1)

0x6fb: Stack[-1] = (bool) 0
0x6fc: IF (Stack[-1] == 1) GOTO 0x701; Pop(1)

0x6fd: Push("morlok") // @poff=990
0x6fe: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x6ff: IF (Stack[-1] == 1) GOTO 0x701; Pop(1)
...
0x70b: Stack[-4] = Stack[-2]
0x70c: Stack[-3] = Stack[-1]
...
0x75e: Stack[-9] = Stack[-1]
0x75f: Call2 0x416

0x760: Pop(1)
0x761: IF (Stack[-1] == 0) GOTO 0x768; Pop(1)

0x762: Push("reputation") // @poff=1114
0x763: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=615
0x764: Pop(1)
0x765: Push((float)0.33000001311302185)
0x766: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x767: Return(); Pop(6)

0x768: PushEmpty(bool, object, string)
0x769: Stack[-10] = Stack[-2]
0x76a: Stack[-1] = "class" // @poff=1032
0x76b: Call2 0x41b
...
0x771: Push("class") // @poff=1032
0x772: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=615
0x773: Pop(1)
0x774: PushEmpty(bool)
0x775: Stack[-1] = (bool) 1
0x776: PushEmpty(bool)
0x777: Stack[-1] = (bool) 1
0x778: Push("bomber") // @poff=1136
0x779: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x77a: IF (Stack[-1] == 1) GOTO 0x77f; Pop(1)

0x77b: Push("hunter") // @poff=1150
0x77c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x77d: IF (Stack[-1] == 1) GOTO 0x77f; Pop(1)

0x77e: Stack[-1] = (bool) 0
0x77f: IF (Stack[-1] == 1) GOTO 0x784; Pop(1)

0x780: Push("grabitel") // @poff=1164
0x781: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x782: IF (Stack[-1] == 1) GOTO 0x784; Pop(1)
...
0x788: Stack[-10] = Stack[-2]
0x789: Stack[-1] = "disease" // @poff=1182
0x78a: Call2 0x41b
...
0x795: Pop(1)
0x796: IF (Stack[-1] == 1) GOTO 0x79b; Pop(1)

0x797: Push("dog") // @poff=1198
0x798: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x799: IF (Stack[-1] == 1) GOTO 0x79b; Pop(1)

0x79a: Stack[-1] = (bool) 0
0x79b: IF (Stack[-1] == 0) GOTO 0x7a2; Pop(1)

0x79c: Push("disease") // @poff=1182
0x79d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=615
0x79e: Pop(1)
0x79f: Push((int) 0)
...
0x7ae: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=346
0x7af: Pop(1)
0x7b0: Push(Stack[-1])
...
0x7b5: Stack[-5] = Stack[-1]
0x7b6: Call2 0x754

0x7b7: Stack[-2] = Stack[-6]
0x7b8: Pop(2)
0x7b9: Return(); Pop(2)

0x7ba: PushEmpty()
0x7bb: PushEmpty(object)
0x7bc: Stack[-2] = Stack[-1]
0x7bd: Call2 0x7da
...
0x7cb: Push(Stack[-2])
0x7cc: IF (Stack[-1] == 1) GOTO 0x7d5; Pop(1)

0x7cd: PushEmpty(float, object)
0x7ce: Stack[-8] = Stack[-1]
0x7cf: Call2 0x40e

0x7d0: Pop(1)
0x7d1: Push((float)490000.0)
0x7d2: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x7d3: IF (Stack[-1] == 1) GOTO 0x7d5; Pop(1)
...
0x7e5: Pop(0)
0x7e6: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1206
0x7e7: Pop(1)
