...
// @pool_raw:
// @pool_encoding:utf8
...
0x1c0: Stack[-2] = "quest_d11_01" // @poff=208
0x1c1: Stack[-1] = "soldier_attack" // @poff=252
0x1c2: Call2 0x46d

0x1c3: Pop(3)
0x1c4: Push("health") // @poff=282
0x1c5: Push((int) 0)
0x1c6: @ SetProperty(Stack[-2], Stack[-1])
0x1c7: Pop(2)
0x1c8: Push("d11q01") // @poff=296
0x1c9: Push((int) 3)
0x1ca: @ SetVariable(Stack[-2], Stack[-1])
0x1cb: Pop(2)
0x1cc: PushEmpty(bool, string, string)
0x1cd: Stack[-2] = "quest_d11_01" // @poff=208
0x1ce: Stack[-1] = "restore_andrei" // @poff=310
0x1cf: Call2 0x46d
...
0x1dc: Push("player") // @poff=340
0x1dd: @ FindActor(Stack[-4]T, Stack[-1])
0x1de: Pop(1)
...
0x1f1: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x246: Pop(0)
0x247: Push("all") // @poff=138
0x248: PushEmpty(string, int)
0x249: Stack[-7] = Stack[-1]
0x24a: Call2 0x479
...
0x294: Pop(0); PushNull((bool) Stack[-21] == 0)
0x295: IF (Stack[-1] == 0) GOTO 0x29b; Pop(1)

0x296: PushEmpty(string)
0x297: Stack[-1] = "fdie" // @poff=364
0x298: Call2 0x2ee

0x299: Pop(1)
0x29a: GOTO 0x2ed

0x29b: @@ GetPosition(Stack[-10]); Obj=21 // @poff=374
0x29c: Pop(0)
...
0x2ac: Stack[-6] = "fdie" // @poff=364
0x2ad: GOTO 0x2af

0x2ae: Stack[-6] = "bdie" // @poff=386
...
0x2b5: @ StopAsync()
0x2b6: Pop(0)
0x2b7: Stack[-21] = Stack[-5]
0x2b8: Push("GetScriptProperty") // @poff=396
0x2b9: Push((int) 2)
0x2ba: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2bb: IF (Stack[-1] == 0) GOTO 0x2c7; Pop(1)

0x2bc: Push("Owner") // @poff=432
0x2bd: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=444
0x2be: Pop(1)
0x2bf: Push(Stack[-4])
0x2c0: IF (Stack[-1] == 0) GOTO 0x2c7; Pop(1)

0x2c1: Push("Owner") // @poff=432
0x2c2: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=462
0x2c3: Pop(1)
0x2c4: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2c5: IF (Stack[-1] == 0) GOTO 0x2c7; Pop(1)

0x2c6: Stack[-21] = Stack[-5]
0x2c7: Push("@GetEyesHeight") // @poff=480
0x2c8: Push((int) 1)
0x2c9: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2ca: IF (Stack[-1] == 0) GOTO 0x2d6; Pop(1)

0x2cb: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=510
0x2cc: Pop(0)
...
0x310: Pop(0)
0x311: @@ GetPosition(Stack[-1]); Obj=5 // @poff=374
0x312: Pop(0)
...
0x317: Pop(0)
0x318: @@ GetPosition(Stack[-2]); Obj=7 // @poff=374
0x319: Pop(0)
...
0x31e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x32c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=374
0x32d: Pop(0)
...
0x33d: Stack[-1] = "fhit" // @poff=524
0x33e: GOTO 0x340

0x33f: Stack[-1] = "bhit" // @poff=534
0x340: Push("hit_react") // @poff=544
0x341: Push("1") // @poff=230
0x342: Pop(1); Push(Stack[-3] + Stack[-1]);
0x343: Push("2") // @poff=180
...
0x35c: Stack[-25] = Stack[-1]
0x35d: Call2 0x30e

0x35e: Stack[-2] = Stack[-3]
0x35f: Pop(2)
0x360: Call2 0x457

0x361: Stack[-2] = Stack[-11]
0x362: Pop(2)
0x363: @ CreateVectorVector(Stack[-8])
0x364: Pop(0)
0x365: Stack[-7] = (int) 1
0x366: Push("hit") // @poff=526
...
0x37b: Pop(0)
0x37c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=573
0x37d: Pop(0)
0x37e: PushEmpty(object, int, float, cvector, cvector)
0x37f: Stack[-26] = Stack[-5]
0x380: Stack[-25] = Stack[-4]
0x381: Stack[-24] = Stack[-3]
0x382: Stack[-6] = Stack[-2]
...
0x3a1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=374
0x3a2: Pop(0)
0x3a3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=510
0x3a4: Pop(0)
...
0x402: Push("Can't find lsh animation : ") // @poff=623
...
0x411: Push("Can't find lsh animation : ") // @poff=623
...
0x45a: Push((float)9.999999974752427e-07)
...
0x468: Pop(0)
0x469: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=679
0x46a: Pop(0)
...
0x46f: Pop(0)
0x470: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x48f: Stack[-2] = Stack[-5]
0x490: Return(); Pop(4)

0x491: PushEmpty()
0x492: Push("d11q01") // @poff=296
0x493: Push((int) 3)
...
0x49a: Stack[-2] = "quest_d11_01" // @poff=208
0x49b: Stack[-1] = "restore_andrei" // @poff=310
0x49c: Call2 0x46d

0x49d: Pop(3)
0x49e: Push((int) 0)
0x49f: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=687
0x4a0: Pop(1)
0x4a1: Return(); Pop(0)

0x4a2: PushEmpty(int, int)
0x4a3: Push("burah_serum") // @poff=702
0x4a4: Push((int) 1)
0x4a5: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=726
0x4a6: Pop(2)
0x4a7: Return(); Pop(2)

0x4a8: PushEmpty()
0x4a9: Push("d11q01") // @poff=296
0x4aa: Push((int) 3)
...
0x4b1: Stack[-2] = "quest_d11_01" // @poff=208
0x4b2: Stack[-1] = "restore_andrei" // @poff=310
0x4b3: Call2 0x46d

0x4b4: Pop(3)
0x4b5: Push((int) 1)
0x4b6: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=687
0x4b7: Pop(1)
0x4b8: Return(); Pop(0)

0x4b9: PushEmpty()
0x4ba: Push("playsound") // @poff=743
0x4bb: Push("giveitem") // @poff=763
0x4bc: @ TriggerWorld(Stack[-2], Stack[-1])
0x4bd: Pop(2)
0x4be: Return(); Pop(0)

0x4bf: PushEmpty()
0x4c0: Push("d11q01") // @poff=296
0x4c1: Push((int) 3)
0x4c2: @ SetVariable(Stack[-2], Stack[-1])
0x4c3: Pop(2)
0x4c4: PushEmpty(bool, string, string)
0x4c5: Stack[-2] = "quest_d11_01" // @poff=208
0x4c6: Stack[-1] = "soldier_attack" // @poff=252
0x4c7: Call2 0x46d

0x4c8: Pop(3)
0x4c9: PushEmpty(bool, string, string)
0x4ca: Stack[-2] = "quest_d11_01" // @poff=208
0x4cb: Stack[-1] = "restore_andrei" // @poff=310
0x4cc: Call2 0x46d
...
0x4cf: PushEmpty()
0x4d0: Push("ood11Officer1") // @poff=781
0x4d1: Push((int) 1)
...
0x4d7: Stack[-4] = Stack[-2]
0x4d8: Stack[-1] = "burah_serum" // @poff=702
0x4d9: Call2 0x466
...
0x4e2: Stack[-1] = "ood11Officer1" // @poff=781
0x4e3: Call2 0x461
...
0x518: Push("Can't retrieve diary root") // @poff=809
0x519: @ Trace(Stack[-1])
0x51a: Pop(1)
...
0x523: Stack[-1] = Stack[-4]
0x524: Pop(1)
0x525: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=861
0x526: Pop(0)
0x527: Pop(0); Push((bool) Stack[-2] == 0)
0x528: IF (Stack[-1] == 0) GOTO 0x52f; Pop(1)

0x529: Push("Can't find diary parent with id: ") // @poff=866
...
0x52f: @@ AddChild(Stack[-8]); Obj=2 // @poff=934
0x530: Pop(0)
0x531: Push((int) 7)
0x532: @ SendWorldWndMessage(Stack[-1])
0x533: Pop(1)
0x534: @@ GetCategory(Stack[-1]); Obj=8 // @poff=943
0x535: Pop(0)
...
0x54e: Push("branch") // @poff=955
0x54f: @ GetVariable(Stack[-1], Stack[-2])
0x550: Pop(1)
0x551: Stack[-1] = Stack[-3]
0x552: Return(); Pop(2)
...
0x564: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=969
0x565: Return(); Pop(0)

0x566: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1009
0x567: Return(); Pop(0)
...
0x56f: Pop(0)
0x570: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1053
0x571: Pop(1)
...
0x584: Stack[-11] = Stack[-5]
0x585: Stack[-10] = Stack[-4]
0x586: Stack[-9] = Stack[-3]
0x587: Stack[-7] = Stack[-2]
0x588: Stack[-6] = Stack[-1]
0x589: Call2 0x38d
