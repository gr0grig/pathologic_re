...
0xa2: Pop(4)
0xa3: Push("all") // @poff=0
0xa4: Push("shoot_end") // @poff=42
...
0xae: Push("all") // @poff=0
0xaf: Push("shoot_end") // @poff=42
...
0xc1: @ CanSee(Stack[-1]T, Stack[-0]T)
0xc2: Pop(0)
...
0xde: Push("all") // @poff=0
0xdf: Push("attack_off") // @poff=62
...
0x107: Stack[-7] = Stack[-3]
0x108: Stack[-6] = Stack[-2]
0x109: Stack[-5] = Stack[-1]
0x10a: Call2 0x88a
...
0x12a: Pop(0)
0x12b: @ Face(Stack[-0]T)
0x12c: Pop(0)
0x12d: Push(Stack[-5])
0x12e: IF (Stack[-1] == 0) GOTO 0x135; Pop(1)

0x12f: Push("all") // @poff=0
0x130: Push("attack_on") // @poff=84
0x131: @ PlayAnimation(Stack[-2], Stack[-1])
0x132: Pop(2)
0x133: @ WaitForAnimEnd()
0x134: Pop(0)
0x135: Push("all") // @poff=0
0x136: Push("attack_on") // @poff=84
...
0x141: @ CanSee(Stack[-1], Stack[-0]T)
0x142: Pop(0)
0x143: Push(Stack[-1])
...
0x152: Push("all") // @poff=0
0x153: Push("hunt") // @poff=104
...
0x15e: Pop(0)
0x15f: Push("all") // @poff=0
0x160: Push("attack_on") // @poff=84
...
0x176: Push("all") // @poff=0
0x177: Push("attack_on") // @poff=84
...
0x183: Pop(0)
0x184: Push("all") // @poff=0
0x185: Push("attack_on") // @poff=84
...
0x191: @ CanSee(Stack[-1], Stack[-0]T)
0x192: Pop(0)
0x193: Push(Stack[-1])
0x194: IF (Stack[-1] == 0) GOTO 0x19b; Pop(1)

0x195: @ Face(Stack[-0]T)
0x196: Pop(0)
0x197: PushEmpty()
0x198: Call2 0x1d6
...
0x1a9: @ StopAsync()
0x1aa: Pop(0)
0x1ab: Push("all") // @poff=0
0x1ac: Push("attack_off") // @poff=62
...
0x1e4: Pop(0)
0x1e5: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x1e6: Pop(1)
...
0x1ec: Stack[-2] = Stack[-15]
0x1ed: Pop(2)
0x1ee: PushEmpty(float, cvector, cvector)
0x1ef: Stack[-17] = Stack[-2]
0x1f0: Stack[-16] = Stack[-1]
0x1f1: Call2 0x6be

0x1f2: Pop(2)
0x1f3: Push((float)0.9993908405303955)
...
0x1f9: Pop(0)
0x1fa: Push("all") // @poff=0
0x1fb: Push("attack_begin1") // @poff=136
0x1fc: @ PlayAnimation(Stack[-2], Stack[-1])
0x1fd: Pop(2)
0x1fe: Push("attack") // @poff=164
...
0x204: Pop(0)
0x205: Push("light-dynamic") // @poff=178
0x206: Push("soldier_fire.xml") // @poff=206
...
0x222: Push((float)0.03490658476948738)
...
0x230: Stack[-4] = Stack[-7]
0x231: Pop(4)
0x232: Push((int) 2)
0x233: Push((float)1.5)
0x234: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x235: Pop(2)
0x236: GOTO 0x246
...
0x23b: Pop(0)
0x23c: Push("scripted") // @poff=240
0x23d: Push(CVector(0.0, 0.0, 1.0))
0x23e: Push("richochet.xml") // @poff=258
0x23f: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x240: Pop(3)
0x241: Push("Material") // @poff=286
0x242: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=304
0x243: Pop(1)
0x244: Stack[-1] = 0
0x245: Stack[-2] = 0
0x246: Push("all") // @poff=0
0x247: Push("attack_end1") // @poff=322
0x248: @ PlayAnimation(Stack[-2], Stack[-1])
0x249: Pop(2)
0x24a: @ WaitForAnimEnd()
0x24b: Pop(0)
0x24c: Push("all") // @poff=0
0x24d: Push("attack_on") // @poff=84
...
0x26c: Stack[-7] = Stack[-3]
0x26d: Stack[-6] = Stack[-2]
...
0x285: Stack[-2] = "quest_d11_01" // @poff=346
0x286: Stack[-1] = "soldier_attack" // @poff=372
0x287: Call2 0x6e0
...
0x293: Stack[-2] = "quest_d11_01" // @poff=346
0x294: Stack[-1] = "soldier_attack" // @poff=372
0x295: Call2 0x6e0
...
0x2c0: Stack[-2] = "quest_d11_01" // @poff=346
0x2c1: Stack[-1] = "soldier_attack" // @poff=372
0x2c2: Call2 0x6e0
...
0x2d3: Push("all") // @poff=0
0x2d4: Push("attack_on") // @poff=84
...
0x2e3: Stack[-2] = Stack[-3]
0x2e4: Pop(2)
0x2e5: PushEmpty(float, cvector, cvector)
0x2e6: Stack[-5] = Stack[-2]
0x2e7: Stack[-4] = Stack[-1]
0x2e8: Call2 0x6be

0x2e9: Pop(2)
0x2ea: Push((float)0.7071067690849304)
...
0x2ef: Stack[-1] = (float) 4.71238899230957
0x2f0: Call2 0x5ed
...
0x302: IF (Stack[-1] == 1) GOTO 0x2de; Pop(1)

0x303: @ StopAsync()
0x304: Pop(0)
0x305: Push("spine") // @poff=402
...
0x30b: Pop(0)
0x30c: @@@ GetEyesHeight(Stack[-2]); Obj=0 // @poff=414
0x30d: Pop(0)
...
0x312: Push("spine") // @poff=402
0x313: @ DirLookAsyncRel(Stack[-0]T, Stack[-1], Stack[-2])
0x314: Pop(1)
0x315: Return(); Pop(6)
...
0x31f: Pop(1)
0x320: Push("all") // @poff=0
0x321: Push("attack_on") // @poff=84
...
0x32a: Push("all") // @poff=0
0x32b: Push("attack_on") // @poff=84
...
0x33b: Stack[-2] = "quest_d11_01" // @poff=346
0x33c: Stack[-1] = "soldier_attack" // @poff=372
0x33d: Call2 0x6e0
...
0x373: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=428
0x374: Pop(1)
...
0x398: Stack[-7] = Stack[-3]
0x399: Stack[-6] = Stack[-2]
...
0x3b2: @ GetPFPosition(Stack[-1]T)
0x3b3: Pop(0)
0x3b4: @ GetDirection(Stack[-0]T)
0x3b5: Pop(0)
0x3b6: PushEmpty()
0x3b7: Call2 0x40a
...
0x3d3: @ FindPathTo(Stack[-1], Stack[-1]T)
0x3d4: Pop(0)
...
0x3e2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3e3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3f5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3f6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x42b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x42c: IF (Stack[-1] == 0) GOTO 0x432; Pop(1)

0x42d: PushEmpty(string)
0x42e: Stack[-1] = "fdie" // @poff=431
0x42f: Call2 0x485

0x430: Pop(1)
0x431: GOTO 0x484

0x432: @@ GetPosition(Stack[-10]); Obj=21 // @poff=441
0x433: Pop(0)
...
0x443: Stack[-6] = "fdie" // @poff=431
0x444: GOTO 0x446

0x445: Stack[-6] = "bdie" // @poff=453
...
0x44c: @ StopAsync()
0x44d: Pop(0)
0x44e: Stack[-21] = Stack[-5]
0x44f: Push("GetScriptProperty") // @poff=463
0x450: Push((int) 2)
0x451: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x452: IF (Stack[-1] == 0) GOTO 0x45e; Pop(1)

0x453: Push("Owner") // @poff=499
0x454: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=511
0x455: Pop(1)
0x456: Push(Stack[-4])
0x457: IF (Stack[-1] == 0) GOTO 0x45e; Pop(1)

0x458: Push("Owner") // @poff=499
0x459: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=529
0x45a: Pop(1)
0x45b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x45c: IF (Stack[-1] == 0) GOTO 0x45e; Pop(1)

0x45d: Stack[-21] = Stack[-5]
0x45e: Push("@GetEyesHeight") // @poff=547
0x45f: Push((int) 1)
0x460: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x461: IF (Stack[-1] == 0) GOTO 0x46d; Pop(1)

0x462: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=414
0x463: Pop(0)
...
0x46f: Stack[-7] = Stack[-1]
0x470: Call2 0x5ff

0x471: Pop(1)
0x472: Push("all") // @poff=0
...
0x479: @ StopAsync()
0x47a: Pop(0)
0x47b: Push("head") // @poff=577
0x47c: @ UnlookAsync(Stack[-1])
0x47d: Pop(1)
0x47e: Push("all") // @poff=0
...
0x4af: Stack[-2] = "bullet" // @poff=597
0x4b0: Return(); Pop(0)

0x4b1: Stack[-2] = "phys" // @poff=611
0x4b2: Return(); Pop(0)

0x4b3: PushEmpty(cvector, cvector, cvector, cvector)
0x4b4: @ GetPosition(Stack[-2])
0x4b5: Pop(0)
0x4b6: @@ GetPosition(Stack[-1]); Obj=5 // @poff=441
0x4b7: Pop(0)
...
0x4bc: Pop(0)
0x4bd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=441
0x4be: Pop(0)
...
0x4cb: Pop(0)
0x4cc: Stack[-1] = Stack[-4]
0x4cd: Return(); Pop(2)

0x4ce: PushEmpty(bool, bool)
0x4cf: Push("HasProperty") // @poff=635
0x4d0: Push((int) 2)
...
0x4d6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=659
0x4d7: Pop(0)
...
0x4dc: Stack[-18] = Stack[-2]
0x4dd: Stack[-1] = "health" // @poff=671
0x4de: Call2 0x4ce
...
0x4e5: Stack[-18] = Stack[-2]
0x4e6: Stack[-1] = "armor" // @poff=685
0x4e7: Call2 0x4ce
...
0x4ed: Push("armor") // @poff=685
0x4ee: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=697
0x4ef: Pop(1)
0x4f0: Push("armor_") // @poff=709
0x4f1: PushEmpty(string, int)
0x4f2: Stack[-16] = Stack[-1]
0x4f3: Call2 0x4a5

0x4f4: Pop(1)
0x4f5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4f6: PushEmpty(bool, object, string)
0x4f7: Stack[-18] = Stack[-2]
...
0x4ff: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=697
0x500: Pop(0)
...
0x507: Stack[-3] = Stack[-6]
0x508: Pop(3)
0x509: Push("health") // @poff=671
0x50a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=697
0x50b: Pop(1)
0x50c: Push((int) 1)
0x50d: Pop(1); Push(Stack[-1] - Stack[-4]);
0x50e: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x50f: Push("health") // @poff=671
...
0x515: Pop(3)
0x516: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=723
0x517: Pop(2)
0x518: PushEmpty(bool, object)
0x519: Stack[-17] = Stack[-1]
0x51a: Call2 0x4c9
...
0x520: Pop(1)
0x521: Stack[-1] = Stack[-16]
0x522: Return(); Pop(12)

0x523: PushEmpty(bool, bool)
0x524: @@ IsDead(Stack[-1]); Obj=3 // @poff=735
0x525: Pop(0)
0x526: Stack[-1] = Stack[-4]
0x527: Return(); Pop(2)

0x528: PushEmpty(object, object, object, object)
0x529: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x53d: Pop(0)
0x53e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x53f: IF (Stack[-1] == 0) GOTO 0x542; Pop(1)

0x540: Stack[-6] = (bool) 0
0x541: Return(); Pop(4)

0x542: @@ GetScene(Stack[-1]); Obj=5 // @poff=756
0x543: Pop(0)
...
0x556: Stack[-6] = Stack[-2]
0x557: Stack[-1] = "noaccess" // @poff=765
0x558: Call2 0x4ce
...
0x55e: Push("noaccess") // @poff=765
0x55f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=697
0x560: Pop(1)
0x561: Push((int) 0)
...
0x565: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x573: @@ GetPosition(Stack[-5]); Obj=15 // @poff=441
0x574: Pop(0)
...
0x584: Stack[-1] = "fhit" // @poff=783
0x585: GOTO 0x587

0x586: Stack[-1] = "bhit" // @poff=793
0x587: Push("hit_react") // @poff=803
0x588: Push("1") // @poff=160
0x589: Pop(1); Push(Stack[-3] + Stack[-1]);
0x58a: Push("2") // @poff=823
...
0x5a3: Stack[-25] = Stack[-1]
0x5a4: Call2 0x4b3

0x5a5: Stack[-2] = Stack[-3]
0x5a6: Pop(2)
0x5a7: Call2 0x685

0x5a8: Stack[-2] = Stack[-11]
0x5a9: Pop(2)
0x5aa: @ CreateVectorVector(Stack[-8])
0x5ab: Pop(0)
0x5ac: Stack[-7] = (int) 1
0x5ad: Push("hit") // @poff=785
...
0x5c2: Pop(0)
0x5c3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=836
0x5c4: Pop(0)
0x5c5: PushEmpty(object, int, float, cvector, cvector)
0x5c6: Stack[-26] = Stack[-5]
0x5c7: Stack[-25] = Stack[-4]
0x5c8: Stack[-24] = Stack[-3]
0x5c9: Stack[-6] = Stack[-2]
...
0x5e3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=441
0x5e4: Pop(0)
...
0x5ee: @@ GetPosition(Stack[-3]); Obj=8 // @poff=441
0x5ef: Pop(0)
...
0x5fa: Pop(0)
0x5fb: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=414
0x5fc: Pop(0)
...
0x640: Push("woman") // @poff=868
0x641: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x642: IF (Stack[-1] == 1) GOTO 0x647; Pop(1)

0x643: Push("worker") // @poff=880
0x644: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x645: IF (Stack[-1] == 1) GOTO 0x647; Pop(1)

0x646: Stack[-1] = (bool) 0
0x647: IF (Stack[-1] == 1) GOTO 0x64c; Pop(1)

0x648: Push("butcher") // @poff=894
0x649: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x64a: IF (Stack[-1] == 1) GOTO 0x64c; Pop(1)

0x64b: Stack[-1] = (bool) 0
0x64c: IF (Stack[-1] == 1) GOTO 0x651; Pop(1)

0x64d: Push("wasted_girl") // @poff=910
0x64e: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x64f: IF (Stack[-1] == 1) GOTO 0x651; Pop(1)

0x650: Stack[-1] = (bool) 0
0x651: IF (Stack[-1] == 1) GOTO 0x656; Pop(1)

0x652: Push("boy") // @poff=934
0x653: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x654: IF (Stack[-1] == 1) GOTO 0x656; Pop(1)

0x655: Stack[-1] = (bool) 0
0x656: IF (Stack[-1] == 1) GOTO 0x65b; Pop(1)

0x657: Push("vaxxabitka") // @poff=942
0x658: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x659: IF (Stack[-1] == 1) GOTO 0x65b; Pop(1)

0x65a: Stack[-1] = (bool) 0
0x65b: IF (Stack[-1] == 1) GOTO 0x660; Pop(1)

0x65c: Push("unosha") // @poff=964
0x65d: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x65e: IF (Stack[-1] == 1) GOTO 0x660; Pop(1)

0x65f: Stack[-1] = (bool) 0
0x660: IF (Stack[-1] == 1) GOTO 0x665; Pop(1)

0x661: Push("wasted_male") // @poff=978
0x662: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x663: IF (Stack[-1] == 1) GOTO 0x665; Pop(1)

0x664: Stack[-1] = (bool) 0
0x665: IF (Stack[-1] == 1) GOTO 0x66a; Pop(1)

0x666: Push("alkash") // @poff=1002
0x667: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x668: IF (Stack[-1] == 1) GOTO 0x66a; Pop(1)

0x669: Stack[-1] = (bool) 0
0x66a: IF (Stack[-1] == 1) GOTO 0x66f; Pop(1)

0x66b: Push("dohodyaga") // @poff=1016
0x66c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x66d: IF (Stack[-1] == 1) GOTO 0x66f; Pop(1)

0x66e: Stack[-1] = (bool) 0
0x66f: IF (Stack[-1] == 1) GOTO 0x674; Pop(1)

0x670: Push("vaxxabit") // @poff=1036
0x671: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x672: IF (Stack[-1] == 1) GOTO 0x674; Pop(1)

0x673: Stack[-1] = (bool) 0
0x674: IF (Stack[-1] == 1) GOTO 0x679; Pop(1)

0x675: Push("nudegirl") // @poff=1054
0x676: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x677: IF (Stack[-1] == 1) GOTO 0x679; Pop(1)

0x678: Stack[-1] = (bool) 0
0x679: IF (Stack[-1] == 1) GOTO 0x67e; Pop(1)

0x67a: Push("morlok") // @poff=1072
0x67b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x67c: IF (Stack[-1] == 1) GOTO 0x67e; Pop(1)
...
0x688: Push((float)9.999999974752427e-07)
...
0x696: Stack[-2] = Stack[-3]
0x697: GOTO 0x699

0x698: Stack[-1] = Stack[-3]
0x699: Return(); Pop(0)
...
0x6c1: Stack[-4] = Stack[-1]
0x6c2: Call2 0x6ab

0x6c3: Pop(2)
0x6c4: PushEmpty(float, cvector)
0x6c5: Stack[-5] = Stack[-1]
0x6c6: Call2 0x6b4
...
0x6e2: Pop(0)
0x6e3: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x71d: Stack[-11] = Stack[-5]
0x71e: Stack[-10] = Stack[-4]
0x71f: Stack[-9] = Stack[-3]
0x720: Stack[-7] = Stack[-2]
0x721: Stack[-6] = Stack[-1]
0x722: Call2 0x5d4
...
0x73a: Pop(0)
0x73b: Push((float)0.05000000074505806)
0x73c: Push((bool) 1)
...
0x746: Stack[-7] = Stack[-2]
0x747: Stack[-1] = "class" // @poff=1114
0x748: Call2 0x4ce
...
0x74e: Push("class") // @poff=1114
0x74f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=697
0x750: Pop(1)
...
0x765: Push("patrol") // @poff=1126
0x766: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x767: IF (Stack[-1] == 1) GOTO 0x76c; Pop(1)

0x768: Push("sanitar") // @poff=1140
0x769: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x76a: IF (Stack[-1] == 1) GOTO 0x76c; Pop(1)

0x76b: Stack[-1] = (bool) 0
0x76c: IF (Stack[-1] == 1) GOTO 0x771; Pop(1)

0x76d: Push("soldier") // @poff=1156
0x76e: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x76f: IF (Stack[-1] == 1) GOTO 0x771; Pop(1)

0x770: Stack[-1] = (bool) 0
0x771: IF (Stack[-1] == 1) GOTO 0x776; Pop(1)

0x772: Push("woman") // @poff=868
0x773: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x774: IF (Stack[-1] == 1) GOTO 0x776; Pop(1)

0x775: Stack[-1] = (bool) 0
0x776: IF (Stack[-1] == 1) GOTO 0x77b; Pop(1)

0x777: Push("wasted_girl") // @poff=910
0x778: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x779: IF (Stack[-1] == 1) GOTO 0x77b; Pop(1)

0x77a: Stack[-1] = (bool) 0
0x77b: IF (Stack[-1] == 1) GOTO 0x780; Pop(1)

0x77c: Push("vaxxabitka") // @poff=942
0x77d: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x77e: IF (Stack[-1] == 1) GOTO 0x780; Pop(1)

0x77f: Stack[-1] = (bool) 0
0x780: IF (Stack[-1] == 1) GOTO 0x785; Pop(1)

0x781: Push("vaxxabit") // @poff=1036
0x782: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x783: IF (Stack[-1] == 1) GOTO 0x785; Pop(1)

0x784: Stack[-1] = (bool) 0
0x785: IF (Stack[-1] == 1) GOTO 0x78a; Pop(1)

0x786: Push("little_girl") // @poff=1172
0x787: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x788: IF (Stack[-1] == 1) GOTO 0x78a; Pop(1)

0x789: Stack[-1] = (bool) 0
0x78a: IF (Stack[-1] == 1) GOTO 0x78f; Pop(1)

0x78b: Push("girl") // @poff=924
0x78c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x78d: IF (Stack[-1] == 1) GOTO 0x78f; Pop(1)

0x78e: Stack[-1] = (bool) 0
0x78f: IF (Stack[-1] == 1) GOTO 0x794; Pop(1)

0x790: Push("dohodyaga") // @poff=1016
0x791: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x792: IF (Stack[-1] == 1) GOTO 0x794; Pop(1)

0x793: Stack[-1] = (bool) 0
0x794: IF (Stack[-1] == 1) GOTO 0x799; Pop(1)

0x795: Push("nudegirl") // @poff=1054
0x796: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x797: IF (Stack[-1] == 1) GOTO 0x799; Pop(1)
...
0x7ab: Push("worker") // @poff=880
0x7ac: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7ad: IF (Stack[-1] == 1) GOTO 0x7b2; Pop(1)

0x7ae: Push("butcher") // @poff=894
0x7af: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7b0: IF (Stack[-1] == 1) GOTO 0x7b2; Pop(1)

0x7b1: Stack[-1] = (bool) 0
0x7b2: IF (Stack[-1] == 1) GOTO 0x7b7; Pop(1)

0x7b3: Push("boy") // @poff=934
0x7b4: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x7b5: IF (Stack[-1] == 1) GOTO 0x7b7; Pop(1)

0x7b6: Stack[-1] = (bool) 0
0x7b7: IF (Stack[-1] == 1) GOTO 0x7bc; Pop(1)

0x7b8: Push("unosha") // @poff=964
0x7b9: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7ba: IF (Stack[-1] == 1) GOTO 0x7bc; Pop(1)

0x7bb: Stack[-1] = (bool) 0
0x7bc: IF (Stack[-1] == 1) GOTO 0x7c1; Pop(1)

0x7bd: Push("wasted_male") // @poff=978
0x7be: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7bf: IF (Stack[-1] == 1) GOTO 0x7c1; Pop(1)

0x7c0: Stack[-1] = (bool) 0
0x7c1: IF (Stack[-1] == 1) GOTO 0x7c6; Pop(1)

0x7c2: Push("alkash") // @poff=1002
0x7c3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x7c4: IF (Stack[-1] == 1) GOTO 0x7c6; Pop(1)

0x7c5: Stack[-1] = (bool) 0
0x7c6: IF (Stack[-1] == 1) GOTO 0x7cb; Pop(1)

0x7c7: Push("morlok") // @poff=1072
0x7c8: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x7c9: IF (Stack[-1] == 1) GOTO 0x7cb; Pop(1)
...
0x803: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=428
0x804: Pop(1)
0x805: Push(Stack[-1])
...
0x828: Stack[-9] = Stack[-1]
0x829: Call2 0x4c9

0x82a: Pop(1)
0x82b: IF (Stack[-1] == 0) GOTO 0x832; Pop(1)

0x82c: Push("reputation") // @poff=1196
0x82d: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=697
0x82e: Pop(1)
0x82f: Push((float)0.33000001311302185)
0x830: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x831: Return(); Pop(6)

0x832: PushEmpty(bool, object, string)
0x833: Stack[-10] = Stack[-2]
0x834: Stack[-1] = "class" // @poff=1114
0x835: Call2 0x4ce
...
0x83b: Push("class") // @poff=1114
0x83c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=697
0x83d: Pop(1)
0x83e: PushEmpty(bool)
0x83f: Stack[-1] = (bool) 1
0x840: PushEmpty(bool)
0x841: Stack[-1] = (bool) 1
0x842: Push("bomber") // @poff=1218
0x843: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x844: IF (Stack[-1] == 1) GOTO 0x849; Pop(1)

0x845: Push("hunter") // @poff=1232
0x846: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x847: IF (Stack[-1] == 1) GOTO 0x849; Pop(1)

0x848: Stack[-1] = (bool) 0
0x849: IF (Stack[-1] == 1) GOTO 0x84e; Pop(1)

0x84a: Push("grabitel") // @poff=1246
...
0x852: Stack[-10] = Stack[-2]
0x853: Stack[-1] = "disease" // @poff=1264
0x854: Call2 0x4ce
...
0x85d: Stack[-5] = Stack[-1]
0x85e: Call2 0x628

0x85f: Pop(1)
0x860: IF (Stack[-1] == 1) GOTO 0x865; Pop(1)

0x861: Push("dog") // @poff=1280
0x862: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x863: IF (Stack[-1] == 1) GOTO 0x865; Pop(1)

0x864: Stack[-1] = (bool) 0
0x865: IF (Stack[-1] == 0) GOTO 0x86c; Pop(1)

0x866: Push("disease") // @poff=1264
0x867: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=697
0x868: Pop(1)
0x869: Push((int) 0)
...
0x878: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=428
0x879: Pop(1)
0x87a: Push(Stack[-1])
...
0x87f: Stack[-5] = Stack[-1]
0x880: Call2 0x81e

0x881: Stack[-2] = Stack[-6]
0x882: Pop(2)
0x883: Return(); Pop(2)

0x884: PushEmpty()
0x885: PushEmpty(object)
0x886: Stack[-2] = Stack[-1]
0x887: Call2 0x8ab
...
0x895: Push(Stack[-2])
0x896: IF (Stack[-1] == 1) GOTO 0x89f; Pop(1)

0x897: PushEmpty(float, object)
0x898: Stack[-8] = Stack[-1]
0x899: Call2 0x4ba
...
0x8a5: Push("d11q01SoldierAttack") // @poff=1288
...
0x8b6: Pop(0)
0x8b7: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1328
0x8b8: Pop(1)
0x8b9: PushEmpty(bool, string, string)
0x8ba: Stack[-2] = "quest_d11_01" // @poff=346
0x8bb: Stack[-1] = "soldier_death" // @poff=1350
0x8bc: Call2 0x6e0

0x8bd: Pop(3)
0x8be: PushEmpty(object)
0x8bf: Stack[-4] = Stack[-1]
