...
0x3a: Stack[-13] = Stack[-4]
0x3b: Stack[-3] = "pt_d11q01_dog1" // @poff=151
0x3c: Stack[-2] = "pers_dog" // @poff=181
0x3d: Stack[-1] = "d11q01_dog.xml" // @poff=199
0x3e: Call2 0x66

0x3f: Pop(5)
0x40: PushEmpty(object, object, string, string, string)
0x41: Stack[-13] = Stack[-4]
0x42: Stack[-3] = "pt_d11q01_dog2" // @poff=229
0x43: Stack[-2] = "pers_dog" // @poff=181
0x44: Stack[-1] = "d11q01_dog.xml" // @poff=199
0x45: Call2 0x66

0x46: Pop(5)
0x47: PushEmpty(object, object, string, string, string)
0x48: Stack[-13] = Stack[-4]
0x49: Stack[-3] = "pt_d11q01_dog3" // @poff=259
0x4a: Stack[-2] = "pers_dog" // @poff=181
0x4b: Stack[-1] = "d11q01_dog.xml" // @poff=199
0x4c: Call2 0x66
