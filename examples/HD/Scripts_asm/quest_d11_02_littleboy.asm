...
// @pool_raw:
// @pool_encoding:utf8
...
0x275: Push("Can't find lsh animation : ") // @poff=224
...
0x284: Push("Can't find lsh animation : ") // @poff=224
...
0x299: Push((float)9.999999974752427e-07)
...
0x2a2: Pop(0)
0x2a3: Stack[-1] = Stack[-4]
0x2a4: Return(); Pop(2)

0x2a5: PushEmpty(object, object)
0x2a6: @ CreateIntVector(Stack[-1])
0x2a7: Pop(0)
0x2a8: @@ add(Stack[-4]); Obj=1 // @poff=280
0x2a9: Pop(0)
0x2aa: @@ add(Stack[-3]); Obj=1 // @poff=280
0x2ab: Pop(0)
0x2ac: Push((int) 3)
...
0x2b2: @@ GetItemID(Stack[-3]); Obj=8 // @poff=284
0x2b3: Pop(0)
0x2b4: Push("Category") // @poff=294
0x2b5: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2b6: Pop(1)
0x2b7: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=312
0x2b8: Pop(0)
0x2b9: Pop(0); Push((bool) Stack[-1] == 0)
0x2ba: IF (Stack[-1] == 0) GOTO 0x2be; Pop(1)

0x2bb: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=320
0x2bc: Pop(0)
0x2bd: GOTO 0x2c3

0x2be: PushEmpty(int, int)
0x2bf: Stack[-5] = Stack[-2]
0x2c0: Stack[-9] = Stack[-1]
0x2c1: Call2 0x2a5
...
0x2c6: Pop(0)
0x2c7: @@ SetItemName(Stack[-4]); Obj=1 // @poff=330
0x2c8: Pop(0)
0x2c9: PushEmpty(object, object, int)
0x2ca: Stack[-8] = Stack[-3]
0x2cb: Stack[-4] = Stack[-2]
0x2cc: Stack[-6] = Stack[-1]
0x2cd: Call2 0x2b1
...
0x2d3: Pop(0)
0x2d4: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2dc: Stack[-1] = 0
0x2dd: PushEmpty()
0x2de: Push("playsound") // @poff=342
0x2df: Push("giveitem") // @poff=362
0x2e0: @ TriggerWorld(Stack[-2], Stack[-1])
0x2e1: Pop(2)
0x2e2: Return(); Pop(0)

0x2e3: PushEmpty()
0x2e4: Push("revolver ammo6 is given") // @poff=380
0x2e5: @ Trace(Stack[-1])
0x2e6: Pop(1)
0x2e7: PushEmpty(object, string, int)
0x2e8: Stack[-5] = Stack[-3]
0x2e9: Stack[-2] = "revolver_ammo" // @poff=428
0x2ea: Stack[-1] = (int) 6
0x2eb: Call2 0x2c4
...
0x2fa: Stack[-2] = "quest_d11_02" // @poff=470
0x2fb: Stack[-1] = "init_graveyard" // @poff=496
0x2fc: Call2 0x2d1
...
0x30b: Stack[-2] = "quest_d11_02" // @poff=470
0x30c: Stack[-1] = "completed" // @poff=526
0x30d: Call2 0x2d1
...
0x310: PushEmpty()
0x311: Push("ood11ULittleBoy1") // @poff=546
0x312: Push((int) 1)
...
0x316: PushEmpty()
0x317: Push("ood11ULittleBoy2") // @poff=580
0x318: Push((int) 1)
...
0x31c: PushEmpty()
0x31d: Push((int) 1000)
0x31e: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=614
0x31f: Pop(1)
0x320: Return(); Pop(0)

0x321: PushEmpty()
0x322: PushEmpty(int, string)
0x323: Stack[-1] = "d11q02" // @poff=456
0x324: Call2 0x2a0
...
0x353: Stack[-1] = "ood11ULittleBoy1" // @poff=546
0x354: Call2 0x2a0
...
0x35f: Stack[-1] = "ood11ULittleBoy2" // @poff=580
0x360: Call2 0x2a0
...
0x395: Push("Can't retrieve diary root") // @poff=629
0x396: @ Trace(Stack[-1])
0x397: Pop(1)
...
0x3a0: Stack[-1] = Stack[-4]
0x3a1: Pop(1)
0x3a2: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=681
0x3a3: Pop(0)
0x3a4: Pop(0); Push((bool) Stack[-2] == 0)
0x3a5: IF (Stack[-1] == 0) GOTO 0x3ac; Pop(1)

0x3a6: Push("Can't find diary parent with id: ") // @poff=686
...
0x3ac: @@ AddChild(Stack[-8]); Obj=2 // @poff=754
0x3ad: Pop(0)
0x3ae: Push((int) 7)
0x3af: @ SendWorldWndMessage(Stack[-1])
0x3b0: Pop(1)
0x3b1: @@ GetCategory(Stack[-1]); Obj=8 // @poff=763
0x3b2: Pop(0)
...
0x3ce: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=789
0x3cf: Return(); Pop(0)

0x3d0: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=829
0x3d1: Return(); Pop(0)
