...
Strings:
	...
	W:actor_unload
	W:soldier_dead
// @pool_raw:
...
0x2b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2c: IF (Stack[-1] == 0) GOTO 0x32; Pop(1)

0x2d: PushEmpty(string)
0x2e: Stack[-1] = "fdie" // @poff=0
0x2f: Call2 0x85

0x30: Pop(1)
0x31: GOTO 0x84

0x32: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x33: Pop(0)
...
0x43: Stack[-6] = "fdie" // @poff=0
0x44: GOTO 0x46

0x45: Stack[-6] = "bdie" // @poff=22
...
0x4c: @ StopAsync()
0x4d: Pop(0)
0x4e: Stack[-21] = Stack[-5]
0x4f: Push("GetScriptProperty") // @poff=32
0x50: Push((int) 2)
0x51: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x52: IF (Stack[-1] == 0) GOTO 0x5e; Pop(1)

0x53: Push("Owner") // @poff=68
0x54: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x55: Pop(1)
0x56: Push(Stack[-4])
0x57: IF (Stack[-1] == 0) GOTO 0x5e; Pop(1)

0x58: Push("Owner") // @poff=68
0x59: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x5a: Pop(1)
0x5b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x5c: IF (Stack[-1] == 0) GOTO 0x5e; Pop(1)

0x5d: Stack[-21] = Stack[-5]
0x5e: Push("@GetEyesHeight") // @poff=116
0x5f: Push((int) 1)
0x60: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x61: IF (Stack[-1] == 0) GOTO 0x6d; Pop(1)

0x62: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x63: Pop(0)
0x64: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x65: Push(CvectorIndex(Stack[-1], 1))
0x66: Stack[-3] = Stack[-1]
0x67: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x68: Push("head") // @poff=160
...
0x6f: Stack[-7] = Stack[-1]
0x70: Call2 0x5f7

0x71: Pop(1)
0x72: Push("all") // @poff=170
...
0x79: @ StopAsync()
0x7a: Pop(0)
0x7b: Push("head") // @poff=160
0x7c: @ UnlookAsync(Stack[-1])
0x7d: Pop(1)
0x7e: Push("all") // @poff=170
...
0x93: Pop(1)
0x94: Push("all") // @poff=170
0x95: @ PlayAnimation(Stack[-1], Stack[-2])
0x96: Pop(1)
0x97: @ WaitForAnimEnd()
0x98: Pop(0)
0x99: Push("all") // @poff=170
...
0xaf: IF (Stack[-1] == 1) GOTO 0xb7; Pop(1)
...
0xf9: Stack[-7] = Stack[-3]
0xfa: Stack[-6] = Stack[-2]
0xfb: Stack[-5] = Stack[-1]
0xfc: Call2 0x92d
...
0x122: Pop(1)
0x123: @ CanSee(Stack[-1]T, Stack[-0]T)
0x124: Pop(0)
...
0x132: @ Face(Stack[-0]T)
0x133: Pop(0)
0x134: PushEmpty()
0x135: Call2 0x71f

0x136: Pop(0)
0x137: Push("all") // @poff=170
0x138: Push("shoot_begin") // @poff=178
...
0x153: Push("all") // @poff=170
0x154: Push("shoot_end") // @poff=212
...
0x166: @ CanSee(Stack[-1]T, Stack[-0]T)
0x167: Pop(0)
...
0x183: Push("all") // @poff=170
0x184: Push("attack_off") // @poff=232
...
0x1ac: Stack[-7] = Stack[-3]
0x1ad: Stack[-6] = Stack[-2]
...
0x1cf: Pop(0)
0x1d0: @ Face(Stack[-0]T)
0x1d1: Pop(0)
0x1d2: Push(Stack[-5])
0x1d3: IF (Stack[-1] == 0) GOTO 0x1da; Pop(1)

0x1d4: Push("all") // @poff=170
0x1d5: Push("attack_on") // @poff=254
0x1d6: @ PlayAnimation(Stack[-2], Stack[-1])
0x1d7: Pop(2)
0x1d8: @ WaitForAnimEnd()
0x1d9: Pop(0)
0x1da: Push("all") // @poff=170
0x1db: Push("attack_on") // @poff=254
...
0x1e6: @ CanSee(Stack[-1], Stack[-0]T)
0x1e7: Pop(0)
0x1e8: Push(Stack[-1])
...
0x1f7: Push("all") // @poff=170
0x1f8: Push("hunt") // @poff=274
...
0x203: Pop(0)
0x204: Push("all") // @poff=170
0x205: Push("attack_on") // @poff=254
...
0x21b: Push("all") // @poff=170
0x21c: Push("attack_on") // @poff=254
...
0x228: Pop(0)
0x229: Push("all") // @poff=170
0x22a: Push("attack_on") // @poff=254
...
0x236: @ CanSee(Stack[-1], Stack[-0]T)
0x237: Pop(0)
0x238: Push(Stack[-1])
0x239: IF (Stack[-1] == 0) GOTO 0x240; Pop(1)

0x23a: @ Face(Stack[-0]T)
0x23b: Pop(0)
0x23c: PushEmpty()
0x23d: Call2 0x27b
...
0x24e: @ StopAsync()
0x24f: Pop(0)
0x250: Push("all") // @poff=170
0x251: Push("attack_off") // @poff=232
...
0x289: Pop(0)
0x28a: @ SendPlayerEnemy(Stack[-0]T, Stack[-1])
0x28b: Pop(1)
...
0x291: Stack[-2] = Stack[-15]
0x292: Pop(2)
0x293: PushEmpty(float, cvector, cvector)
0x294: Stack[-17] = Stack[-2]
0x295: Stack[-16] = Stack[-1]
0x296: Call2 0x6bb

0x297: Pop(2)
0x298: Push((float)0.9993908405303955)
...
0x29e: Pop(0)
0x29f: Push("all") // @poff=170
0x2a0: Push("attack_begin1") // @poff=306
0x2a1: @ PlayAnimation(Stack[-2], Stack[-1])
0x2a2: Pop(2)
0x2a3: Push("attack") // @poff=334
...
0x2a9: Pop(0)
0x2aa: Push("light-dynamic") // @poff=348
0x2ab: Push("soldier_fire.xml") // @poff=376
...
0x2c7: Push((float)0.03490658476948738)
...
0x2d5: Stack[-4] = Stack[-7]
0x2d6: Pop(4)
0x2d7: Push((int) 2)
0x2d8: Push((float)1.5)
0x2d9: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x2da: Pop(2)
0x2db: GOTO 0x2eb
...
0x2e0: Pop(0)
0x2e1: Push("scripted") // @poff=410
0x2e2: Push(CVector(0.0, 0.0, 1.0))
0x2e3: Push("richochet.xml") // @poff=428
0x2e4: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x2e5: Pop(3)
0x2e6: Push("Material") // @poff=456
0x2e7: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=474
0x2e8: Pop(1)
0x2e9: Stack[-1] = 0
0x2ea: Stack[-2] = 0
0x2eb: Push("all") // @poff=170
0x2ec: Push("attack_end1") // @poff=492
0x2ed: @ PlayAnimation(Stack[-2], Stack[-1])
0x2ee: Pop(2)
0x2ef: @ WaitForAnimEnd()
0x2f0: Pop(0)
0x2f1: Push("all") // @poff=170
0x2f2: Push("attack_on") // @poff=254
...
0x311: Stack[-7] = Stack[-3]
0x312: Stack[-6] = Stack[-2]
...
0x33a: Stack[-2] = "quest_d11_02" // @poff=532
0x33b: Stack[-1] = "soldier_attack" // @poff=558
0x33c: Call2 0x70a
...
0x396: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=620
0x397: Pop(1)
...
0x3bb: Stack[-7] = Stack[-3]
0x3bc: Stack[-6] = Stack[-2]
...
0x3d5: @ GetPFPosition(Stack[-1]T)
0x3d6: Pop(0)
0x3d7: @ GetDirection(Stack[-0]T)
0x3d8: Pop(0)
0x3d9: PushEmpty()
0x3da: Call2 0x42d
...
0x3f6: @ FindPathTo(Stack[-1], Stack[-1]T)
0x3f7: Pop(0)
...
0x405: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x406: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x418: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x419: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x42f: Push("all") // @poff=170
0x430: Push("attack_on") // @poff=254
...
0x437: Push("all") // @poff=170
0x438: Push("attack_on") // @poff=254
...
0x440: Push("all") // @poff=170
0x441: Push("attack_begin1") // @poff=306
0x442: @ PlayAnimation(Stack[-2], Stack[-1])
0x443: Pop(2)
0x444: @ WaitForAnimEnd()
0x445: Pop(0)
0x446: PushEmpty(bool, string, string)
0x447: Stack[-2] = "quest_d11_02" // @poff=532
0x448: Stack[-1] = "execute" // @poff=516
0x449: Call2 0x70a

0x44a: Pop(3)
0x44b: Push("shot") // @poff=202
0x44c: Push(CVector(0.0, 150.0, 0.0))
0x44d: Push((int) 800)
0x44e: Push((int) 100000)
0x44f: @ PlayGlobalSound(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x450: Pop(4)
0x451: Push("all") // @poff=170
0x452: Push("attack_end1") // @poff=492
0x453: @ PlayAnimation(Stack[-2], Stack[-1])
0x454: Pop(2)
0x455: @ WaitForAnimEnd()
0x456: Pop(0)
0x457: Push("all") // @poff=170
0x458: Push("attack_off") // @poff=232
...
0x46b: Stack[-2] = "quest_d11_02" // @poff=532
0x46c: Stack[-1] = "soldier_attack" // @poff=558
0x46d: Call2 0x70a
...
0x482: Stack[-2] = "bullet" // @poff=633
0x483: Return(); Pop(0)

0x484: Stack[-2] = "phys" // @poff=647
0x485: Return(); Pop(0)

0x486: PushEmpty(cvector, cvector, cvector, cvector)
0x487: @ GetPosition(Stack[-2])
0x488: Pop(0)
0x489: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x48a: Pop(0)
...
0x48f: Pop(0)
0x490: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x491: Pop(0)
...
0x4a2: Push("HasProperty") // @poff=671
0x4a3: Push((int) 2)
...
0x4a9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=695
0x4aa: Pop(0)
...
0x4b7: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=707
0x4b8: Pop(0)
0x4b9: PushEmpty(float, float, float, float)
0x4ba: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4bb: Stack[-8] = Stack[-2]
0x4bc: Stack[-7] = Stack[-1]
0x4bd: Call2 0x692

0x4be: Pop(3)
0x4bf: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=719
0x4c0: Pop(1)
...
0x4c5: Stack[-18] = Stack[-2]
0x4c6: Stack[-1] = "health" // @poff=731
0x4c7: Call2 0x4a1
...
0x4ce: Stack[-18] = Stack[-2]
0x4cf: Stack[-1] = "armor" // @poff=745
0x4d0: Call2 0x4a1
...
0x4d6: Push("armor") // @poff=745
0x4d7: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=707
0x4d8: Pop(1)
0x4d9: Push("armor_") // @poff=757
0x4da: PushEmpty(string, int)
0x4db: Stack[-16] = Stack[-1]
0x4dc: Call2 0x478

0x4dd: Pop(1)
0x4de: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4df: PushEmpty(bool, object, string)
0x4e0: Stack[-18] = Stack[-2]
0x4e1: Stack[-8] = Stack[-1]
0x4e2: Call2 0x4a1
...
0x4e8: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=707
0x4e9: Pop(0)
...
0x4f0: Stack[-3] = Stack[-6]
0x4f1: Pop(3)
0x4f2: Push("health") // @poff=731
0x4f3: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=707
0x4f4: Pop(1)
0x4f5: Push((int) 1)
0x4f6: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4f7: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4f8: Push("health") // @poff=731
...
0x4fe: Pop(3)
0x4ff: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=719
0x500: Pop(2)
0x501: PushEmpty(bool, object)
0x502: Stack[-17] = Stack[-1]
0x503: Call2 0x49c
...
0x509: Pop(1)
0x50a: Stack[-1] = Stack[-16]
0x50b: Return(); Pop(12)

0x50c: PushEmpty(bool, bool)
0x50d: @@ IsDead(Stack[-1]); Obj=3 // @poff=771
0x50e: Pop(0)
0x50f: Stack[-1] = Stack[-4]
0x510: Return(); Pop(2)

0x511: PushEmpty(object, object, object, object)
0x512: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x526: Pop(0)
0x527: Pop(0); PushNull((bool) Stack[-2] == 0)
0x528: IF (Stack[-1] == 0) GOTO 0x52b; Pop(1)

0x529: Stack[-6] = (bool) 0
0x52a: Return(); Pop(4)

0x52b: @@ GetScene(Stack[-1]); Obj=5 // @poff=792
0x52c: Pop(0)
...
0x53f: Stack[-6] = Stack[-2]
0x540: Stack[-1] = "noaccess" // @poff=801
0x541: Call2 0x4a1
...
0x547: Push("noaccess") // @poff=801
0x548: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=707
0x549: Pop(1)
0x54a: Push((int) 0)
...
0x54e: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x55c: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x55d: Pop(0)
...
0x56d: Stack[-1] = "fhit" // @poff=819
0x56e: GOTO 0x570

0x56f: Stack[-1] = "bhit" // @poff=829
0x570: Push("hit_react") // @poff=839
0x571: Push("1") // @poff=330
0x572: Pop(1); Push(Stack[-3] + Stack[-1]);
0x573: Push("2") // @poff=554
...
0x591: Stack[-2] = Stack[-11]
0x592: Pop(2)
0x593: @ CreateVectorVector(Stack[-8])
0x594: Pop(0)
0x595: Stack[-7] = (int) 1
0x596: Push("hit") // @poff=821
...
0x5ab: Pop(0)
0x5ac: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=868
0x5ad: Pop(0)
0x5ae: PushEmpty(object, int, float, cvector, cvector)
0x5af: Stack[-26] = Stack[-5]
0x5b0: Stack[-25] = Stack[-4]
0x5b1: Stack[-24] = Stack[-3]
...
0x5cc: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x5cd: Pop(0)
...
0x5d8: Pop(0)
0x5d9: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x5da: Pop(0)
...
0x5df: Stack[-7] = Stack[-2]
0x5e0: Stack[-6] = Stack[-1]
0x5e1: Call2 0x69d
...
0x5ea: Stack[-10] = Stack[-2]
0x5eb: Stack[-9] = Stack[-1]
0x5ec: Call2 0x69d
...
0x638: Push("woman") // @poff=900
0x639: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x63a: IF (Stack[-1] == 1) GOTO 0x63f; Pop(1)

0x63b: Push("worker") // @poff=912
0x63c: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x63d: IF (Stack[-1] == 1) GOTO 0x63f; Pop(1)

0x63e: Stack[-1] = (bool) 0
0x63f: IF (Stack[-1] == 1) GOTO 0x644; Pop(1)

0x640: Push("butcher") // @poff=926
0x641: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x642: IF (Stack[-1] == 1) GOTO 0x644; Pop(1)

0x643: Stack[-1] = (bool) 0
0x644: IF (Stack[-1] == 1) GOTO 0x649; Pop(1)

0x645: Push("wasted_girl") // @poff=942
0x646: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x647: IF (Stack[-1] == 1) GOTO 0x649; Pop(1)

0x648: Stack[-1] = (bool) 0
0x649: IF (Stack[-1] == 1) GOTO 0x64e; Pop(1)

0x64a: Push("boy") // @poff=966
0x64b: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x64c: IF (Stack[-1] == 1) GOTO 0x64e; Pop(1)

0x64d: Stack[-1] = (bool) 0
0x64e: IF (Stack[-1] == 1) GOTO 0x653; Pop(1)

0x64f: Push("vaxxabitka") // @poff=974
0x650: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x651: IF (Stack[-1] == 1) GOTO 0x653; Pop(1)

0x652: Stack[-1] = (bool) 0
0x653: IF (Stack[-1] == 1) GOTO 0x658; Pop(1)

0x654: Push("unosha") // @poff=996
0x655: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x656: IF (Stack[-1] == 1) GOTO 0x658; Pop(1)

0x657: Stack[-1] = (bool) 0
0x658: IF (Stack[-1] == 1) GOTO 0x65d; Pop(1)

0x659: Push("wasted_male") // @poff=1010
0x65a: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x65b: IF (Stack[-1] == 1) GOTO 0x65d; Pop(1)

0x65c: Stack[-1] = (bool) 0
0x65d: IF (Stack[-1] == 1) GOTO 0x662; Pop(1)

0x65e: Push("alkash") // @poff=1034
0x65f: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x660: IF (Stack[-1] == 1) GOTO 0x662; Pop(1)

0x661: Stack[-1] = (bool) 0
0x662: IF (Stack[-1] == 1) GOTO 0x667; Pop(1)

0x663: Push("dohodyaga") // @poff=1048
0x664: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x665: IF (Stack[-1] == 1) GOTO 0x667; Pop(1)

0x666: Stack[-1] = (bool) 0
0x667: IF (Stack[-1] == 1) GOTO 0x66c; Pop(1)

0x668: Push("vaxxabit") // @poff=1068
0x669: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x66a: IF (Stack[-1] == 1) GOTO 0x66c; Pop(1)

0x66b: Stack[-1] = (bool) 0
0x66c: IF (Stack[-1] == 1) GOTO 0x671; Pop(1)

0x66d: Push("nudegirl") // @poff=1086
0x66e: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x66f: IF (Stack[-1] == 1) GOTO 0x671; Pop(1)

0x670: Stack[-1] = (bool) 0
0x671: IF (Stack[-1] == 1) GOTO 0x676; Pop(1)

0x672: Push("morlok") // @poff=1104
0x673: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x674: IF (Stack[-1] == 1) GOTO 0x676; Pop(1)
...
0x680: Push((float)9.999999974752427e-07)
...
0x6bd: Stack[-5] = Stack[-2]
0x6be: Stack[-4] = Stack[-1]
0x6bf: Call2 0x6a8

0x6c0: Pop(2)
0x6c1: PushEmpty(float, cvector)
0x6c2: Stack[-5] = Stack[-1]
0x6c3: Call2 0x6b1
...
0x6e2: Stack[-2] = Stack[-1]
0x6e3: Call2 0x700

0x6e4: Pop(1)
0x6e5: PushEmpty(bool, object, string, float, float, float)
0x6e6: Stack[-8] = Stack[-5]
0x6e7: Stack[-4] = "reputation" // @poff=1118
0x6e8: Stack[-7] = Stack[-3]
0x6e9: Stack[-2] = (int) 0
0x6ea: Stack[-1] = (int) 1
0x6eb: Call2 0x4ad
...
0x702: Pop(0)
0x703: @@ add(Stack[-3]); Obj=1 // @poff=859
0x704: Pop(0)
0x705: Push((int) 16)
...
0x70c: Pop(0)
0x70d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x740: Push("GenerateMoney: iMin > iMax") // @poff=1168
0x741: @ Trace(Stack[-1])
0x742: Pop(1)
0x743: Return(); Pop(4)
...
0x75e: Pop(0)
0x75f: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1234
0x760: Pop(0)
0x761: Push("Organ") // @poff=1246
0x762: Push((int) 1)
0x763: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=719
0x764: Pop(2)
0x765: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1258
0x766: Pop(0)
0x767: Push((int) 0)
0x768: Push((int) 1)
...
0x775: Stack[-1] = "liver" // @poff=1268
0x776: Call2 0x75c

0x777: Pop(1)
0x778: PushEmpty(string)
0x779: Stack[-1] = "kidney" // @poff=1280
0x77a: Call2 0x75c

0x77b: Pop(1)
0x77c: PushEmpty(string)
0x77d: Stack[-1] = "heart" // @poff=1294
0x77e: Call2 0x75c

0x77f: Pop(1)
0x780: PushEmpty(string)
0x781: Stack[-1] = "blood" // @poff=1306
0x782: Call2 0x75c
...
0x78f: Stack[-4] = "rifle_ammo" // @poff=1318
0x790: Stack[-3] = (int) 1
0x791: Stack[-2] = (int) 3
0x792: Stack[-1] = (int) 3
0x793: Call2 0x5e8
...
0x79d: Stack[-3] = "bandage" // @poff=1350
0x79e: Stack[-2] = (int) 1
0x79f: Stack[-1] = (int) 6
0x7a0: Call2 0x5dd
...
0x7a3: Stack[-3] = "tourniquet" // @poff=1366
0x7a4: Stack[-2] = (int) 1
0x7a5: Stack[-1] = (int) 6
0x7a6: Call2 0x5dd
...
0x7b8: Stack[-7] = Stack[-3]
0x7b9: Stack[-6] = Stack[-2]
0x7ba: Stack[-5] = Stack[-1]
0x7bb: Call2 0x579
...
0x7c0: Stack[-11] = Stack[-5]
0x7c1: Stack[-10] = Stack[-4]
0x7c2: Stack[-9] = Stack[-3]
0x7c3: Stack[-7] = Stack[-2]
0x7c4: Stack[-6] = Stack[-1]
0x7c5: Call2 0x5bd
...
0x7e9: Stack[-7] = Stack[-2]
0x7ea: Stack[-1] = "class" // @poff=1388
0x7eb: Call2 0x4a1
...
0x7f1: Push("class") // @poff=1388
0x7f2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=707
0x7f3: Pop(1)
...
0x808: Push("patrol") // @poff=1400
0x809: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x80a: IF (Stack[-1] == 1) GOTO 0x80f; Pop(1)

0x80b: Push("sanitar") // @poff=1414
0x80c: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x80d: IF (Stack[-1] == 1) GOTO 0x80f; Pop(1)

0x80e: Stack[-1] = (bool) 0
0x80f: IF (Stack[-1] == 1) GOTO 0x814; Pop(1)

0x810: Push("soldier") // @poff=1430
0x811: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x812: IF (Stack[-1] == 1) GOTO 0x814; Pop(1)

0x813: Stack[-1] = (bool) 0
0x814: IF (Stack[-1] == 1) GOTO 0x819; Pop(1)

0x815: Push("woman") // @poff=900
0x816: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x817: IF (Stack[-1] == 1) GOTO 0x819; Pop(1)

0x818: Stack[-1] = (bool) 0
0x819: IF (Stack[-1] == 1) GOTO 0x81e; Pop(1)

0x81a: Push("wasted_girl") // @poff=942
0x81b: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x81c: IF (Stack[-1] == 1) GOTO 0x81e; Pop(1)

0x81d: Stack[-1] = (bool) 0
0x81e: IF (Stack[-1] == 1) GOTO 0x823; Pop(1)

0x81f: Push("vaxxabitka") // @poff=974
0x820: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x821: IF (Stack[-1] == 1) GOTO 0x823; Pop(1)

0x822: Stack[-1] = (bool) 0
0x823: IF (Stack[-1] == 1) GOTO 0x828; Pop(1)

0x824: Push("vaxxabit") // @poff=1068
0x825: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x826: IF (Stack[-1] == 1) GOTO 0x828; Pop(1)

0x827: Stack[-1] = (bool) 0
0x828: IF (Stack[-1] == 1) GOTO 0x82d; Pop(1)

0x829: Push("little_girl") // @poff=1446
0x82a: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x82b: IF (Stack[-1] == 1) GOTO 0x82d; Pop(1)

0x82c: Stack[-1] = (bool) 0
0x82d: IF (Stack[-1] == 1) GOTO 0x832; Pop(1)

0x82e: Push("girl") // @poff=956
0x82f: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x830: IF (Stack[-1] == 1) GOTO 0x832; Pop(1)

0x831: Stack[-1] = (bool) 0
0x832: IF (Stack[-1] == 1) GOTO 0x837; Pop(1)

0x833: Push("dohodyaga") // @poff=1048
0x834: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x835: IF (Stack[-1] == 1) GOTO 0x837; Pop(1)

0x836: Stack[-1] = (bool) 0
0x837: IF (Stack[-1] == 1) GOTO 0x83c; Pop(1)

0x838: Push("nudegirl") // @poff=1086
0x839: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x83a: IF (Stack[-1] == 1) GOTO 0x83c; Pop(1)
...
0x84e: Push("worker") // @poff=912
0x84f: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x850: IF (Stack[-1] == 1) GOTO 0x855; Pop(1)

0x851: Push("butcher") // @poff=926
0x852: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x853: IF (Stack[-1] == 1) GOTO 0x855; Pop(1)

0x854: Stack[-1] = (bool) 0
0x855: IF (Stack[-1] == 1) GOTO 0x85a; Pop(1)

0x856: Push("boy") // @poff=966
0x857: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x858: IF (Stack[-1] == 1) GOTO 0x85a; Pop(1)

0x859: Stack[-1] = (bool) 0
0x85a: IF (Stack[-1] == 1) GOTO 0x85f; Pop(1)

0x85b: Push("unosha") // @poff=996
0x85c: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x85d: IF (Stack[-1] == 1) GOTO 0x85f; Pop(1)

0x85e: Stack[-1] = (bool) 0
0x85f: IF (Stack[-1] == 1) GOTO 0x864; Pop(1)

0x860: Push("wasted_male") // @poff=1010
0x861: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x862: IF (Stack[-1] == 1) GOTO 0x864; Pop(1)

0x863: Stack[-1] = (bool) 0
0x864: IF (Stack[-1] == 1) GOTO 0x869; Pop(1)

0x865: Push("alkash") // @poff=1034
0x866: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x867: IF (Stack[-1] == 1) GOTO 0x869; Pop(1)

0x868: Stack[-1] = (bool) 0
0x869: IF (Stack[-1] == 1) GOTO 0x86e; Pop(1)

0x86a: Push("morlok") // @poff=1104
0x86b: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x86c: IF (Stack[-1] == 1) GOTO 0x86e; Pop(1)
...
0x89b: Stack[-2] = Stack[-1]
0x89c: Call2 0x881

0x89d: Pop(1)
0x89e: PushEmpty(object, bool)
0x89f: Stack[-3] = Stack[-2]
...
0x8cb: Stack[-9] = Stack[-1]
0x8cc: Call2 0x49c

0x8cd: Pop(1)
0x8ce: IF (Stack[-1] == 0) GOTO 0x8d5; Pop(1)

0x8cf: Push("reputation") // @poff=1118
0x8d0: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=707
0x8d1: Pop(1)
0x8d2: Push((float)0.33000001311302185)
0x8d3: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x8d4: Return(); Pop(6)

0x8d5: PushEmpty(bool, object, string)
0x8d6: Stack[-10] = Stack[-2]
0x8d7: Stack[-1] = "class" // @poff=1388
0x8d8: Call2 0x4a1
...
0x8de: Push("class") // @poff=1388
0x8df: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=707
0x8e0: Pop(1)
0x8e1: PushEmpty(bool)
0x8e2: Stack[-1] = (bool) 1
0x8e3: PushEmpty(bool)
0x8e4: Stack[-1] = (bool) 1
0x8e5: Push("bomber") // @poff=1470
0x8e6: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8e7: IF (Stack[-1] == 1) GOTO 0x8ec; Pop(1)

0x8e8: Push("hunter") // @poff=1484
0x8e9: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8ea: IF (Stack[-1] == 1) GOTO 0x8ec; Pop(1)

0x8eb: Stack[-1] = (bool) 0
0x8ec: IF (Stack[-1] == 1) GOTO 0x8f1; Pop(1)

0x8ed: Push("grabitel") // @poff=1498
0x8ee: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8ef: IF (Stack[-1] == 1) GOTO 0x8f1; Pop(1)
...
0x8f5: Stack[-10] = Stack[-2]
0x8f6: Stack[-1] = "disease" // @poff=1516
0x8f7: Call2 0x4a1
...
0x900: Stack[-5] = Stack[-1]
0x901: Call2 0x620

0x902: Pop(1)
0x903: IF (Stack[-1] == 1) GOTO 0x908; Pop(1)

0x904: Push("dog") // @poff=1532
0x905: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x906: IF (Stack[-1] == 1) GOTO 0x908; Pop(1)

0x907: Stack[-1] = (bool) 0
0x908: IF (Stack[-1] == 0) GOTO 0x90f; Pop(1)

0x909: Push("disease") // @poff=1516
0x90a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=707
0x90b: Pop(1)
0x90c: Push((int) 0)
...
0x91b: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=620
0x91c: Pop(1)
0x91d: Push(Stack[-1])
...
0x922: Stack[-5] = Stack[-1]
0x923: Call2 0x8c1

0x924: Stack[-2] = Stack[-6]
0x925: Pop(2)
0x926: Return(); Pop(2)

0x927: PushEmpty()
0x928: PushEmpty(object)
0x929: Stack[-2] = Stack[-1]
0x92a: Call2 0x954
...
0x938: Push(Stack[-2])
0x939: IF (Stack[-1] == 1) GOTO 0x942; Pop(1)

0x93a: PushEmpty(float, object)
0x93b: Stack[-8] = Stack[-1]
0x93c: Call2 0x48d

0x93d: Pop(1)
0x93e: Push((float)490000.0)
0x93f: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x940: IF (Stack[-1] == 1) GOTO 0x942; Pop(1)
...
0x948: Stack[-2] = "quest_d11_02" // @poff=532
0x949: Stack[-1] = "actor_unload" // @poff=1540
0x94a: Call2 0x70a
...
0x95c: Stack[-2] = "quest_d11_02" // @poff=532
0x95d: Stack[-1] = "soldier_dead" // @poff=1566
0x95e: Call2 0x70a
...
0x967: Stack[-1] = (float) 0.029999999329447746
0x968: Call2 0x6cc

0x969: Pop(3)
0x96a: PushEmpty(object)
0x96b: Stack[-2] = Stack[-1]
0x96c: Call2 0x7ae
