...
// @pool_raw:
// @pool_encoding:utf8
...
0x130: @@ GetPosition(Stack[-8]); Obj=20 // @poff=228
0x131: Pop(0)
0x132: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=240
0x133: Pop(0)
...
0x191: Push("Can't find lsh animation : ") // @poff=264
...
0x1a0: Push("Can't find lsh animation : ") // @poff=264
...
0x1b5: Push((float)9.999999974752427e-07)
...
0x1be: Pop(0)
0x1bf: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x1c9: Stack[-2] = "quest_d11_02" // @poff=320
0x1ca: Stack[-1] = "actor_unload" // @poff=346
0x1cb: Call2 0x1bc
...
0x1e3: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=386
0x1e4: Return(); Pop(0)

0x1e5: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=426
0x1e6: Return(); Pop(0)
