...
// @pool_raw:
// @pool_encoding:utf8
...
0x154: @@ GetPosition(Stack[-8]); Obj=20 // @poff=228
0x155: Pop(0)
0x156: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=240
0x157: Pop(0)
...
0x1b5: Push("Can't find lsh animation : ") // @poff=264
...
0x1c4: Push("Can't find lsh animation : ") // @poff=264
...
0x1d9: Push((float)9.999999974752427e-07)
...
0x1e2: Pop(0)
0x1e3: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x1ed: Stack[-2] = "quest_d11_02" // @poff=320
0x1ee: Stack[-1] = "actor_unload" // @poff=346
0x1ef: Call2 0x1e0
...
0x207: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=386
0x208: Return(); Pop(0)

0x209: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=426
0x20a: Return(); Pop(0)
