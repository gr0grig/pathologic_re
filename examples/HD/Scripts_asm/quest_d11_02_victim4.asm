...
0x147: @@ GetPosition(Stack[-8]); Obj=20 // @poff=228
0x148: Pop(0)
0x149: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=240
0x14a: Pop(0)
...
0x1a8: Push("Can't find lsh animation : ") // @poff=264
...
0x1b7: Push("Can't find lsh animation : ") // @poff=264
...
0x1cc: Push((float)9.999999974752427e-07)
...
0x1d5: Pop(0)
0x1d6: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x1e0: Stack[-2] = "quest_d11_02" // @poff=320
0x1e1: Stack[-1] = "actor_unload" // @poff=346
0x1e2: Call2 0x1d3
...
0x1fa: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=386
0x1fb: Return(); Pop(0)

0x1fc: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=426
0x1fd: Return(); Pop(0)
