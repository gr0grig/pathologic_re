...
// @pool_raw:
// @pool_encoding:utf8
...
0x1fa: Stack[-1] = "Agression" // @poff=194
0x1fb: Call2 0xa4
...
0x27b: Stack[-2] = Stack[-5]
0x27c: Pop(2)
0x27d: Return(); Pop(2)

0x27e: Stack[-1] = 0
0x27f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x280: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x281: @ RotateAsync(Stack[-2], Stack[-1])
0x282: Pop(2)
0x283: Return(); Pop(0)

0x284: PushEmpty(object, bool, object, bool)
0x285: Push("player") // @poff=246
...
0x360: Pop(0)
0x361: @@ GetPosition(Stack[-2]); Obj=7 // @poff=260
0x362: Pop(0)
...
0x36d: Pop(2)
0x36e: Stack[-1] = Stack[-8]
0x36f: Return(); Pop(6)

0x370: PushEmpty(cvector, cvector)
0x371: @@ GetPosition(Stack[-1]); Obj=3 // @poff=260
0x372: Pop(0)
...
0x37f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=260
0x380: Pop(0)
0x381: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x382: Pop(0)
...
0x3ee: Push("voice_common") // @poff=296
0x3ef: Push((int) 1)
...
0x3f6: Push("voice_common") // @poff=296
0x3f7: Push((int) 0)
...
0x409: Push("voice_common") // @poff=296
0x40a: Push((int) 1)
...
0x417: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x418: Pop(1)
...
0x442: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x443: Pop(1)
...
0x457: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x458: Pop(1)
0x459: PushEmpty(bool, string)
0x45a: Stack[-3] = Stack[-1]
0x45b: Call2 0x47e

0x45c: Stack[-2] = Stack[-14]
0x45d: Pop(2)
0x45e: Return(); Pop(10)
...
0x46a: Push("Can't find lsh animation : ") // @poff=354
...
0x479: Push("Can't find lsh animation : ") // @poff=354
...
0x49d: Push((float)9.999999974752427e-07)
...
0x4c8: Stack[-2] = Stack[-5]
0x4c9: Return(); Pop(4)

0x4ca: PushEmpty()
0x4cb: PushEmpty(int, string)
0x4cc: Stack[-1] = "map_chertez_state" // @poff=410
0x4cd: Call2 0x4a4
...
0x4d2: Push("map_chertez_state") // @poff=410
0x4d3: Push((int) 5)
0x4d4: @ SetVariable(Stack[-2], Stack[-1])
0x4d5: Pop(2)
0x4d6: Push("map_chertez_force") // @poff=446
0x4d7: Push((int) 1)
...
0x4e0: Pop(1)
0x4e1: Stack[-2] = "pt_map_aglaja" // @poff=482
0x4e2: Stack[-1] = (int) -1
0x4e3: Call2 0x50e
...
0x4e7: Pop(0)
0x4e8: @@ ShowMap(Stack[-1]); Obj=2 // @poff=510
0x4e9: Pop(1)
0x4ea: Return(); Pop(0)

0x4eb: PushEmpty()
0x4ec: Push("ood11Burah1") // @poff=518
0x4ed: Push((int) 1)
...
0x4f3: Stack[-1] = "ood11Burah1" // @poff=518
0x4f4: Call2 0x4a4
...
0x502: Push("Can't find main outdoor scene") // @poff=542
0x503: @ Trace(Stack[-1])
0x504: Pop(1)
0x505: Stack[-1] = 0
0x506: Stack[-1] = Stack[-5]
0x507: Return(); Pop(4)

0x508: @@ GetMap(Stack[-1]); Obj=2 // @poff=602
0x509: Pop(0)
...
0x510: Pop(0)
0x511: Pop(0); PushNull((bool) Stack[-2] == 0)
0x512: IF (Stack[-1] == 0) GOTO 0x517; Pop(1)

0x513: Push("Can't find main outdoor scene") // @poff=542
0x514: @ Trace(Stack[-1])
0x515: Pop(1)
0x516: Return(); Pop(8)

0x517: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=609
0x518: Pop(0)
0x519: Pop(0); Push((bool) Stack[-1] == 0)
0x51a: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x51b: Push("Warning: outdoor scene locator ") // @poff=620
0x51c: Pop(1); Push(Stack[-1] + Stack[-11]);
0x51d: Push(" doesnt exist") // @poff=684
0x51e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x51f: @ Trace(Stack[-1])
0x520: Pop(1)
0x521: @@ GetMap(Stack[-11]); Obj=2 // @poff=602
0x522: Pop(0)
0x523: Pop(0); PushNull((bool) Stack[-11] == 0)
0x524: IF (Stack[-1] == 0) GOTO 0x529; Pop(1)

0x525: Push("Can't find map") // @poff=712
0x526: @ Trace(Stack[-1])
0x527: Pop(1)
0x528: Return(); Pop(8)
...
0x52b: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=742
0x52c: Pop(2)
0x52d: Return(); Pop(8)

0x52e: Stack[-2] = 0
0x52f: PushEmpty(int, int)
0x530: Push("branch") // @poff=755
...
0x544: Stack[-1] = "ui/NPC_Burah.png" // @poff=769
0x545: Return(); Pop(0)

0x546: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=803
0x547: Return(); Pop(0)
