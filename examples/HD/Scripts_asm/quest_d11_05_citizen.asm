...
// @pool_raw:
...
0x130: PushEmpty()
0x131: Stack[-3] = (float) 0.029999999329447746
0x132: Return(); Pop(0)
...
0x14b: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x14c: Pop(0)
0x14d: Push(Stack[-8])
0x14e: IF (Stack[-1] == 0) GOTO 0x157; Pop(1)

0x14f: Push("attack") // @poff=234
...
0x16b: Pop(0)
0x16c: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x16d: Pop(0)
...
0x187: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=248
0x188: Pop(0)
...
0x1a1: Pop(1)
0x1a2: Push("all") // @poff=0
0x1a3: Push("attack_on") // @poff=262
...
0x1bb: IF (Stack[-1] == 1) GOTO 0x1c1; Pop(1)

0x1bc: PushEmpty(bool)
0x1bd: Call2 0x38d

0x1be: Pop(0)
0x1bf: IF (Stack[-1] == 1) GOTO 0x1c1; Pop(1)

0x1c0: Stack[-1] = (bool) 0
0x1c1: IF (Stack[-1] == 0) GOTO 0x1d2; Pop(1)

0x1c2: @ Face(Stack[-0]T)
0x1c3: Pop(0)
0x1c4: PushEmpty()
0x1c5: Call2 0x3bf

0x1c6: Pop(0)
0x1c7: Push("all") // @poff=0
0x1c8: Push("attack_stay") // @poff=282
0x1c9: @ PlayAnimation(Stack[-2], Stack[-1])
0x1ca: Pop(2)
0x1cb: PushEmpty(bool, float)
0x1cc: Stack[-25] = Stack[-1]
0x1cd: Call2 0x309
...
0x1d2: @ Face(Stack[-0]T)
0x1d3: Pop(0)
0x1d4: Push("all") // @poff=0
0x1d5: Push("fjump") // @poff=306
...
0x1f0: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=248
0x1f1: Pop(0)
...
0x20f: Push("all") // @poff=0
0x210: Push("attack_off") // @poff=318
...
0x21d: Push("all") // @poff=0
0x21e: Push("attack_begin") // @poff=340
0x21f: Push((int) 1)
0x220: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x22b: Push("attack") // @poff=234
0x22c: Push((int) 1)
0x22d: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x237: Push("all") // @poff=0
0x238: Push("bjump") // @poff=366
...
0x23f: Push((float)0.8999999761581421)
0x240: Pop(1); Push(Stack[-9] * Stack[-1]);
0x241: @ GetVictim(Stack[-1], Stack[-4])
0x242: Pop(1)
0x243: @ ReportAttack(Stack[-0]T)
0x244: Pop(0)
...
0x248: Stack[-6] = Stack[-2]
0x249: Stack[-10] = Stack[-1]
0x24a: Call2 0x130

0x24b: Stack[-3] = Stack[-5]
0x24c: Pop(3)
0x24d: PushEmpty(float, object, float, int)
0x24e: Stack[-7] = Stack[-3]
0x24f: Stack[-6] = Stack[-2]
0x250: PushEmpty(int, object, int)
0x251: Stack[-10] = Stack[-2]
0x252: Stack[-14] = Stack[-1]
0x253: Call2 0x133

0x254: Stack[-3] = Stack[-4]
0x255: Pop(3)
0x256: Call2 0x508

0x257: Stack[-4] = Stack[-5]
0x258: Pop(4)
0x259: PushEmpty(int)
0x25a: Call2 0x3bd

0x25b: Pop(0)
0x25c: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x25d: Pop(1)
0x25e: PushEmpty(object, float)
0x25f: Stack[-5] = Stack[-2]
...
0x274: Pop(0)
0x275: Push("all") // @poff=0
0x276: Push("attack_begin") // @poff=340
...
0x28a: Stack[-11] = Stack[-2]
0x28b: Stack[-6] = Stack[-1]
0x28c: Call2 0x23e

0x28d: Pop(2)
0x28e: Push("all") // @poff=0
0x28f: Push("attack_middle") // @poff=378
...
0x297: Pop(0)
0x298: Push("all") // @poff=0
0x299: Push("attack_middle") // @poff=378
...
0x2dc: Pop(1)
0x2dd: Push("all") // @poff=0
0x2de: Push("attack_end") // @poff=410
...
0x31d: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=248
0x31e: Pop(0)
...
0x369: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x36a: Pop(1)
...
0x36e: @ Face(Stack[-0]T)
0x36f: Pop(0)
0x370: Push("all") // @poff=0
0x371: Push("bjump") // @poff=366
0x372: @ PlayAnimation(Stack[-2], Stack[-1])
0x373: Pop(2)
0x374: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=248
0x375: Pop(0)
...
0x3ab: @ irand(Stack[-1], Stack[-2]T)
0x3ac: Pop(0)
0x3ad: Push((int) 1)
0x3ae: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3af: Push("attack") // @poff=234
...
0x3c0: Stack[-1] = "attack_stay" // @poff=282
0x3c1: Call2 0x62b
...
0x3eb: Stack[-15] = Stack[-5]
0x3ec: Stack[-14] = Stack[-4]
0x3ed: Stack[-13] = Stack[-3]
0x3ee: Stack[-12] = Stack[-2]
0x3ef: Stack[-11] = Stack[-1]
0x3f0: Call2 0x435

0x3f1: Stack[-6] = Stack[-7]
0x3f2: Pop(6)
0x3f3: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3f4: IF (Stack[-1] == 0) GOTO 0x3f8; Pop(1)

0x3f5: Push("head") // @poff=168
0x3f6: @ UnlookAsync(Stack[-1])
0x3f7: Pop(1)
0x3f8: Push((int) 1)
0x3f9: @ KillTimer(Stack[-1])
0x3fa: Pop(1)
0x3fb: Stack[-1] = Stack[-10]
0x3fc: Return(); Pop(4)
...
0x438: Stack[-17] = Stack[-7]
0x439: PushEmpty(bool, object)
0x43a: Stack[-23] = Stack[-1]
0x43b: Call2 0x4c1
...
0x441: @@ GetPosition(Stack[-5]); Obj=21 // @poff=18
0x442: Pop(0)
...
0x458: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=248
0x459: Pop(0)
...
0x46a: Push((int) 0)
0x46b: Push((float)0.30000001192092896)
...
0x48d: Push((int) 0)
0x48e: Push((float)0.30000001192092896)
...
0x4c5: Stack[-2] = Stack[-4]
0x4c6: Pop(2)
0x4c7: Return(); Pop(0)

0x4c8: Stack[-1] = "walk" // @poff=468
0x4c9: Return(); Pop(0)

0x4ca: Stack[-1] = "run" // @poff=478
0x4cb: Return(); Pop(0)
...
0x4d6: Stack[-2] = "bullet" // @poff=496
0x4d7: Return(); Pop(0)

0x4d8: Stack[-2] = "phys" // @poff=510
0x4d9: Return(); Pop(0)

0x4da: PushEmpty(cvector, cvector, cvector, cvector)
0x4db: @ GetPosition(Stack[-2])
0x4dc: Pop(0)
0x4dd: @@ GetPosition(Stack[-1]); Obj=5 // @poff=18
0x4de: Pop(0)
...
0x4e3: Pop(0)
0x4e4: Stack[-1] = Stack[-4]
0x4e5: Return(); Pop(2)

0x4e6: PushEmpty(bool, bool)
0x4e7: Push("HasProperty") // @poff=520
0x4e8: Push((int) 2)
...
0x4ee: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=544
0x4ef: Pop(0)
...
0x4f4: Stack[-10] = Stack[-2]
0x4f5: Stack[-9] = Stack[-1]
0x4f6: Call2 0x4e6
...
0x4fc: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=556
0x4fd: Pop(0)
0x4fe: PushEmpty(float, float, float, float)
0x4ff: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x500: Stack[-8] = Stack[-2]
0x501: Stack[-7] = Stack[-1]
0x502: Call2 0x66b

0x503: Pop(3)
0x504: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=568
0x505: Pop(1)
...
0x50a: Stack[-18] = Stack[-2]
0x50b: Stack[-1] = "health" // @poff=580
0x50c: Call2 0x4e6
...
0x513: Stack[-18] = Stack[-2]
0x514: Stack[-1] = "armor" // @poff=594
0x515: Call2 0x4e6
...
0x51b: Push("armor") // @poff=594
0x51c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=556
0x51d: Pop(1)
0x51e: Push("armor_") // @poff=606
0x51f: PushEmpty(string, int)
0x520: Stack[-16] = Stack[-1]
0x521: Call2 0x4cc
...
0x52d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=556
0x52e: Pop(0)
...
0x535: Stack[-3] = Stack[-6]
0x536: Pop(3)
0x537: Push("health") // @poff=580
0x538: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=556
0x539: Pop(1)
0x53a: Push((int) 1)
0x53b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x53c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x53d: Push("health") // @poff=580
...
0x543: Pop(3)
0x544: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=568
0x545: Pop(2)
0x546: PushEmpty(bool, object)
0x547: Stack[-17] = Stack[-1]
0x548: Call2 0x4e1
...
0x54e: Pop(1)
0x54f: Stack[-1] = Stack[-16]
0x550: Return(); Pop(12)

0x551: PushEmpty(bool, bool)
0x552: @@ IsDead(Stack[-1]); Obj=3 // @poff=620
0x553: Pop(0)
0x554: Stack[-1] = Stack[-4]
0x555: Return(); Pop(2)

0x556: PushEmpty(object, object, object, object)
0x557: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x56b: Pop(0)
0x56c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x56d: IF (Stack[-1] == 0) GOTO 0x570; Pop(1)

0x56e: Stack[-6] = (bool) 0
0x56f: Return(); Pop(4)

0x570: @@ GetScene(Stack[-1]); Obj=5 // @poff=641
0x571: Pop(0)
...
0x584: Stack[-6] = Stack[-2]
0x585: Stack[-1] = "noaccess" // @poff=650
0x586: Call2 0x4e6
...
0x58c: Push("noaccess") // @poff=650
0x58d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=556
0x58e: Pop(1)
0x58f: Push((int) 0)
...
0x593: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x5a1: @@ GetPosition(Stack[-5]); Obj=15 // @poff=18
0x5a2: Pop(0)
...
0x5b2: Stack[-1] = "fhit" // @poff=668
0x5b3: GOTO 0x5b5

0x5b4: Stack[-1] = "bhit" // @poff=678
0x5b5: Push("hit_react") // @poff=688
0x5b6: Push("1") // @poff=708
0x5b7: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5b8: Push("2") // @poff=712
...
0x5d6: Stack[-2] = Stack[-11]
0x5d7: Pop(2)
0x5d8: @ CreateVectorVector(Stack[-8])
0x5d9: Pop(0)
0x5da: Stack[-7] = (int) 1
0x5db: Push("hit") // @poff=670
...
0x5f0: Pop(0)
0x5f1: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=725
0x5f2: Pop(0)
0x5f3: PushEmpty(object, int, float, cvector, cvector)
0x5f4: Stack[-26] = Stack[-5]
0x5f5: Stack[-25] = Stack[-4]
0x5f6: Stack[-24] = Stack[-3]
...
0x611: @@ GetPosition(Stack[-3]); Obj=7 // @poff=18
0x612: Pop(0)
...
0x621: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=154
0x622: Pop(0)
...
0x65d: Push((float)9.999999974752427e-07)
...
0x68c: Stack[-2] = Stack[-1]
0x68d: Call2 0x6aa

0x68e: Pop(1)
0x68f: PushEmpty(bool, object, string, float, float, float)
0x690: Stack[-8] = Stack[-5]
0x691: Stack[-4] = "reputation" // @poff=775
0x692: Stack[-7] = Stack[-3]
0x693: Stack[-2] = (int) 0
0x694: Stack[-1] = (int) 1
0x695: Call2 0x4f2
...
0x69b: Pop(0)
0x69c: @@ add(Stack[-3]); Obj=1 // @poff=716
0x69d: Pop(0)
0x69e: Push((int) 0)
0x69f: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x6a0: IF (Stack[-1] == 0) GOTO 0x6a5; Pop(1)

0x6a1: Push((float)0.699999988079071)
0x6a2: Push((int) 500)
0x6a3: @ RumblePlay(Stack[-2], Stack[-1])
0x6a4: Pop(2)
0x6a5: Push((int) 15)
...
0x6ac: Pop(0)
0x6ad: @@ add(Stack[-3]); Obj=1 // @poff=716
0x6ae: Pop(0)
0x6af: Push((int) 16)
...
0x72d: PushEmpty(object, object)
0x72e: @ GetScene(Stack[-1])
0x72f: Pop(0)
0x730: PushEmpty(object)
0x731: Call2 0x654

0x732: Pop(0)
0x733: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=835
0x734: Pop(1)
0x735: PushEmpty(object)
0x736: Stack[-4] = Stack[-1]
0x737: Push(-1, 6); TaskCall(2)
0x738: Call2 0x124

0x739: Pop(-1, 6); TaskReturn
0x73a: Pop(1)
0x73b: Return(); Pop(2)
