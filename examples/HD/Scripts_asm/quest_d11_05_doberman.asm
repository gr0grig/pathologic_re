...
Strings:
	...
	W:teleport
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1f4: Push("Can't find lsh animation : ") // @poff=206
...
0x203: Push("Can't find lsh animation : ") // @poff=206
...
0x209: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x20a: Pop(0)
...
0x24c: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=262
0x24d: Return(); Pop(0)

0x24e: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=302
0x24f: Return(); Pop(0)
...
0x254: Stack[-2] = "quest_d11_05" // @poff=346
0x255: Stack[-1] = "teleport" // @poff=372
0x256: Call2 0x224
