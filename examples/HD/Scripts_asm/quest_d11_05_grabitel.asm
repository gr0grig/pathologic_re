...
0x892: Pop(0)
0x893: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1027
0x894: Pop(1)
...
0x8a7: Stack[-9] = Stack[-3]
0x8a8: Stack[-8] = Stack[-2]
0x8a9: Stack[-7] = Stack[-1]
0x8aa: Call2 0x7a5

0x8ab: Stack[-4] = Stack[-6]
0x8ac: Pop(4)
0x8ad: Push((int) 0)
