...
// @pool_raw:
// @pool_encoding:utf8
...
0x1a0: Stack[-1] = "Untrust" // @poff=174
0x1a1: Call2 0xa0
...
0x1b2: Stack[-1] = "Untrust" // @poff=174
0x1b3: Call2 0xa0
...
0x217: Stack[-2] = Stack[-5]
0x218: Pop(2)
0x219: Return(); Pop(2)

0x21a: Stack[-1] = 0
0x21b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x21c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x21d: @ RotateAsync(Stack[-2], Stack[-1])
0x21e: Pop(2)
0x21f: Return(); Pop(0)

0x220: PushEmpty(object, bool, object, bool)
0x221: Push("player") // @poff=222
...
0x2fc: Pop(0)
0x2fd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=236
0x2fe: Pop(0)
...
0x303: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=248
0x304: Pop(0)
0x305: Pop(0); Push(Stack[-1] + Stack[-3]);
0x306: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=260
0x307: Pop(1)
0x308: Return(); Pop(2)
...
0x310: Pop(2)
0x311: Stack[-1] = Stack[-8]
0x312: Return(); Pop(6)

0x313: PushEmpty(cvector, cvector)
0x314: @@ GetPosition(Stack[-1]); Obj=3 // @poff=236
0x315: Pop(0)
0x316: PushEmpty(bool, cvector)
0x317: Stack[-3] = Stack[-1]
0x318: Call2 0x309

0x319: Stack[-2] = Stack[-6]
0x31a: Pop(2)
0x31b: Return(); Pop(2)
...
0x322: @@ GetPosition(Stack[-8]); Obj=20 // @poff=236
0x323: Pop(0)
0x324: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x325: Pop(0)
...
0x391: Push("voice_common") // @poff=296
0x392: Push((int) 1)
...
0x399: Push("voice_common") // @poff=296
0x39a: Push((int) 0)
...
0x3ac: Push("voice_common") // @poff=296
0x3ad: Push((int) 1)
...
0x3ba: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3bb: Pop(1)
...
0x3cf: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x3d0: Pop(1)
...
0x3d8: Push("d") // @poff=292
0x3d9: PushEmpty(int)
0x3da: Call2 0x477

0x3db: Pop(0)
0x3dc: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3dd: Push("m") // @poff=338
...
0x3e5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3e6: Pop(1)
...
0x3fa: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=248
0x3fb: Pop(1)
0x3fc: PushEmpty(bool, string)
0x3fd: Stack[-3] = Stack[-1]
0x3fe: Call2 0x421

0x3ff: Stack[-2] = Stack[-14]
0x400: Pop(2)
0x401: Return(); Pop(10)
...
0x40d: Push("Can't find lsh animation : ") // @poff=342
...
0x41c: Push("Can't find lsh animation : ") // @poff=342
...
0x44e: Pop(0)
0x44f: @@ add(Stack[-4]); Obj=1 // @poff=398
0x450: Pop(0)
0x451: @@ add(Stack[-3]); Obj=1 // @poff=398
0x452: Pop(0)
0x453: Push((int) 3)
...
0x45a: Stack[-7] = Stack[-3]
0x45b: Stack[-2] = "money" // @poff=402
0x45c: Stack[-6] = Stack[-1]
0x45d: Call2 0x302
...
0x462: Push("Money") // @poff=414
0x463: @ GetInvItemByName(Stack[-2], Stack[-1])
0x464: Pop(1)
0x465: PushEmpty(int, int)
0x466: Stack[-3] = Stack[-2]
0x467: Stack[-5] = Stack[-1]
0x468: Call2 0x44c
...
0x46d: Pop(0)
0x46e: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x4af: Stack[-2] = "quest_d11_05" // @poff=436
0x4b0: Stack[-1] = "place_enemy_after" // @poff=462
0x4b1: Call2 0x46b

0x4b2: Pop(3)
0x4b3: PushEmpty(bool, string, string)
0x4b4: Stack[-2] = "quest_d11_05" // @poff=436
0x4b5: Stack[-1] = "completed" // @poff=498
0x4b6: Call2 0x46b
...
0x4b9: PushEmpty()
0x4ba: Push("playsound") // @poff=518
0x4bb: Push("mapmark") // @poff=538
...
0x4ec: Push("money") // @poff=402
0x4ed: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=248
0x4ee: Pop(1)
0x4ef: Push((int) 1000)
...
0x504: Push("Can't retrieve diary root") // @poff=568
0x505: @ Trace(Stack[-1])
0x506: Pop(1)
0x507: Stack[-3] = (bool) 0
0x508: Return(); Pop(2)

0x509: Stack[-1] = Stack[-3]
0x50a: Return(); Pop(2)
...
0x510: Pop(1)
0x511: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=620
0x512: Pop(0)
0x513: Pop(0); Push((bool) Stack[-2] == 0)
0x514: IF (Stack[-1] == 0) GOTO 0x51b; Pop(1)

0x515: Push("Can't find diary parent with id: ") // @poff=625
...
0x51b: @@ AddChild(Stack[-8]); Obj=2 // @poff=693
0x51c: Pop(0)
0x51d: Push((int) 7)
0x51e: @ SendWorldWndMessage(Stack[-1])
0x51f: Pop(1)
0x520: @@ GetCategory(Stack[-1]); Obj=8 // @poff=702
0x521: Pop(0)
...
0x53d: Stack[-1] = "ui/NPC_MladVlad.png" // @poff=728
0x53e: Return(); Pop(0)

0x53f: Stack[-1] = "ui/NPC_MladVlad_b.png" // @poff=768
0x540: Return(); Pop(0)
