...
// @pool_raw:
// @pool_encoding:utf8
...
0xc0: Stack[-1] = "Staring" // @poff=89
0xc1: Call2 0x90

0xc2: Pop(1)
0xc3: Push((int) 534532)
0xc4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xc5: Pop(1)
0xc6: @@@ ClearReplies(); Obj=0 // @poff=116
0xc7: Pop(0)
...
0xf3: Stack[-1] = "Mysterious" // @poff=156
0xf4: Call2 0x90
...
0x105: Stack[-1] = "Mysterious" // @poff=156
0x106: Call2 0x90
...
0x11c: Stack[-1] = "Neutral" // @poff=178
0x11d: Call2 0x90
...
0x12e: Stack[-1] = "Neutral" // @poff=178
0x12f: Call2 0x90
...
0x140: Stack[-1] = "Neutral" // @poff=178
0x141: Call2 0x90
...
0x157: Stack[-1] = "Neutral" // @poff=178
0x158: Call2 0x90
...
0x169: Stack[-1] = "Neutral" // @poff=178
0x16a: Call2 0x90
...
0x17b: Stack[-1] = "Neutral" // @poff=178
0x17c: Call2 0x90
...
0x192: Stack[-1] = "Neutral" // @poff=178
0x193: Call2 0x90
...
0x1a9: Stack[-1] = "Neutral" // @poff=178
0x1aa: Call2 0x90
...
0x1bb: Stack[-1] = "Neutral" // @poff=178
0x1bc: Call2 0x90
...
0x1d2: Stack[-1] = "Mysterious" // @poff=156
0x1d3: Call2 0x90
...
0x1e4: Stack[-1] = "Mysterious" // @poff=156
0x1e5: Call2 0x90
...
0x24e: Stack[-2] = Stack[-5]
0x24f: Pop(2)
0x250: Return(); Pop(2)

0x251: Stack[-1] = 0
0x252: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x253: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x254: @ RotateAsync(Stack[-2], Stack[-1])
0x255: Pop(2)
0x256: Return(); Pop(0)

0x257: PushEmpty(object, bool, object, bool)
0x258: Push("player") // @poff=226
...
0x2b5: Stack[-1] = "Neutral" // @poff=178
0x2b6: Call2 0x432
...
0x2c4: Stack[-1] = "Neutral" // @poff=178
0x2c5: Call2 0x432
...
0x2db: Stack[-1] = "Neutral" // @poff=178
0x2dc: Call2 0x432
...
0x333: Pop(0)
0x334: @@ GetPosition(Stack[-2]); Obj=7 // @poff=240
0x335: Pop(0)
...
0x340: Pop(2)
0x341: Stack[-1] = Stack[-8]
0x342: Return(); Pop(6)

0x343: PushEmpty(cvector, cvector)
0x344: @@ GetPosition(Stack[-1]); Obj=3 // @poff=240
0x345: Pop(0)
0x346: PushEmpty(bool, cvector)
0x347: Stack[-3] = Stack[-1]
0x348: Call2 0x339

0x349: Stack[-2] = Stack[-6]
0x34a: Pop(2)
0x34b: Return(); Pop(2)
...
0x352: @@ GetPosition(Stack[-8]); Obj=20 // @poff=240
0x353: Pop(0)
0x354: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=252
0x355: Pop(0)
...
0x3c1: Push("voice_common") // @poff=276
0x3c2: Push((int) 1)
...
0x3c9: Push("voice_common") // @poff=276
0x3ca: Push((int) 0)
...
0x3dc: Push("voice_common") // @poff=276
0x3dd: Push((int) 1)
...
0x3ea: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=306
0x3eb: Pop(1)
...
0x415: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=306
0x416: Pop(1)
...
0x42a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=318
0x42b: Pop(1)
0x42c: PushEmpty(bool, string)
0x42d: Stack[-3] = Stack[-1]
0x42e: Call2 0x451

0x42f: Stack[-2] = Stack[-14]
0x430: Pop(2)
0x431: Return(); Pop(10)
...
0x43d: Push("Can't find lsh animation : ") // @poff=334
...
0x44c: Push("Can't find lsh animation : ") // @poff=334
...
0x470: Push((float)9.999999974752427e-07)
...
0x4ae: Stack[-2] = "quest_d11_06" // @poff=390
0x4af: Stack[-1] = "completed" // @poff=416
0x4b0: Call2 0x47c
...
0x4d1: Push("Can't retrieve diary root") // @poff=450
0x4d2: @ Trace(Stack[-1])
0x4d3: Pop(1)
...
0x4dc: Stack[-1] = Stack[-4]
0x4dd: Pop(1)
0x4de: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=502
0x4df: Pop(0)
0x4e0: Pop(0); Push((bool) Stack[-2] == 0)
0x4e1: IF (Stack[-1] == 0) GOTO 0x4e8; Pop(1)

0x4e2: Push("Can't find diary parent with id: ") // @poff=507
...
0x4e8: @@ AddChild(Stack[-8]); Obj=2 // @poff=575
0x4e9: Pop(0)
0x4ea: Push((int) 7)
0x4eb: @ SendWorldWndMessage(Stack[-1])
0x4ec: Pop(1)
0x4ed: @@ GetCategory(Stack[-1]); Obj=8 // @poff=584
0x4ee: Pop(0)
...
0x50a: Stack[-1] = "ui/NPC_Maria.png" // @poff=610
0x50b: Return(); Pop(0)

0x50c: Stack[-1] = "ui/NPC_Maria_b.png" // @poff=644
0x50d: Return(); Pop(0)
