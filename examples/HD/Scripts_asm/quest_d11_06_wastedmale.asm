...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x116: Push("player") // @poff=156
0x117: @ FindActor(Stack[-4]T, Stack[-1])
0x118: Pop(1)
...
0x12b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1b6: Pop(0)
0x1b7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1b8: Pop(0)
...
0x1c2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1c3: Pop(0)
0x1c4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1c5: Pop(0)
...
0x1eb: Pop(0)
0x1ec: Push((bool) 1)
0x1ed: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x1ee: Pop(1)
0x1ef: Push(CvectorIndex(Stack[-4], 0))
0x1f0: Push(CvectorIndex(Stack[-5], 2))
...
0x1fd: Push("head") // @poff=170
0x1fe: @ LookAsyncCamera(Stack[-1])
0x1ff: Pop(1)
0x200: @ CameraWaitForPlayFinish()
0x201: Pop(0)
0x202: @ ResumeWorld()
0x203: Pop(0)
0x204: Stack[-21] = (bool) 1
0x205: Return(); Pop(18)

0x206: PushEmpty(bool, bool)
0x207: Push((bool) 1)
0x208: @ CameraSwitchToNormal(Stack[-1])
0x209: Pop(1)
...
0x223: Push("Can't find lsh animation : ") // @poff=206
...
0x232: Push("Can't find lsh animation : ") // @poff=206
...
0x24c: Push((float)9.999999974752427e-07)
...
0x254: @ GetVariable(Stack[-3], Stack[-1])
0x255: Pop(0)
0x256: Stack[-1] = Stack[-4]
0x257: Return(); Pop(2)

0x258: PushEmpty(int, bool, int, bool)
0x259: @ GetInvItemByName(Stack[-2], Stack[-5])
0x25a: Pop(0)
0x25b: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=262
0x25c: Pop(0)
0x25d: Stack[-1] = Stack[-7]
0x25e: Return(); Pop(4)

0x25f: PushEmpty(object, object)
0x260: @ FindActor(Stack[-1], Stack[-4])
0x261: Pop(0)
0x262: Pop(0); PushNull((bool) Stack[-1] == 0)
0x263: IF (Stack[-1] == 0) GOTO 0x266; Pop(1)

0x264: Stack[-5] = (bool) 0
0x265: Return(); Pop(2)

0x266: @ Trigger(Stack[-1], Stack[-3])
0x267: Pop(0)
0x268: Stack[-5] = (bool) 1
0x269: Return(); Pop(2)

0x26a: Stack[-1] = 0
0x26b: Stack[-1] = (int) 515556
0x26c: Return(); Pop(0)

0x26d: Stack[-1] = (int) 503341
0x26e: Return(); Pop(0)

0x26f: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=270
0x270: Return(); Pop(0)

0x271: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=310
0x272: Return(); Pop(0)

0x273: Stack[-1] = (bool) 0
0x274: Return(); Pop(0)

0x275: PushEmpty(string, string)
0x276: Stack[-1] = "idle" // @poff=146
0x277: Push(Stack[-3])
0x278: IF (Stack[-1] == 0) GOTO 0x27a; Pop(1)

0x279: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x27a: Stack[-1] = Stack[-4]
0x27b: Return(); Pop(2)

0x27c: PushEmpty(int, bool, int, bool)
0x27d: Stack[-2] = (int) 0
0x27e: Push("all") // @poff=138
0x27f: PushEmpty(string, int)
0x280: Stack[-5] = Stack[-1]
0x281: Call2 0x275

0x282: Pop(1)
0x283: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x284: Pop(2)
...
0x288: Push((int) 1)
0x289: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x28a: GOTO 0x27e

0x28b: Stack[-2] = Stack[-5]
0x28c: Return(); Pop(4)

0x28d: PushEmpty()
0x28e: Push("d11q06") // @poff=354
0x28f: Push((int) 3)
0x290: @ SetVariable(Stack[-2], Stack[-1])
0x291: Pop(2)
0x292: PushEmpty()
0x293: Call2 0x2b7

0x294: Pop(0)
0x295: PushEmpty(bool, string, string)
0x296: Stack[-2] = "quest_d11_06" // @poff=368
0x297: Stack[-1] = "place_maria" // @poff=394
0x298: Call2 0x25f
...
0x29e: PushEmpty(bool, object, string)
0x29f: Stack[-5] = Stack[-2]
0x2a0: Stack[-1] = "d11q06KapellaBeads" // @poff=418
0x2a1: Call2 0x258

0x2a2: Pop(2)
0x2a3: IF (Stack[-1] == 0) GOTO 0x2ab; Pop(1)

0x2a4: PushEmpty(bool, object, string)
0x2a5: Stack[-5] = Stack[-2]
0x2a6: Stack[-1] = "d11q06KlaraRing" // @poff=456
0x2a7: Call2 0x258
...
0x2b8: Push((int) 691)
0x2b9: Push((int) 2)
0x2ba: Push((int) 534539)
0x2bb: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x2bc: Pop(3)
0x2bd: PushEmpty(bool, object, int)
0x2be: Stack[-4] = Stack[-2]
0x2bf: Stack[-1] = (int) 686
0x2c0: Call2 0x2d1
...
0x2c5: @ GetDiaryRoot(Stack[-1])
0x2c6: Pop(0)
0x2c7: Pop(0); Push((bool) Stack[-1] == 0)
0x2c8: IF (Stack[-1] == 0) GOTO 0x2ce; Pop(1)

0x2c9: Push("Can't retrieve diary root") // @poff=488
0x2ca: @ Trace(Stack[-1])
0x2cb: Pop(1)
...
0x2d0: Stack[-1] = 0
0x2d1: PushEmpty(object, object, int, object, object, int)
0x2d2: PushEmpty(object)
0x2d3: Call2 0x2c4

0x2d4: Stack[-1] = Stack[-4]
0x2d5: Pop(1)
0x2d6: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=540
0x2d7: Pop(0)
0x2d8: Pop(0); Push((bool) Stack[-2] == 0)
0x2d9: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2da: Push("Can't find diary parent with id: ") // @poff=545
0x2db: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2dc: @ Trace(Stack[-1])
0x2dd: Pop(1)
0x2de: Stack[-9] = (bool) 0
0x2df: Return(); Pop(6)

0x2e0: @@ AddChild(Stack[-8]); Obj=2 // @poff=613
0x2e1: Pop(0)
0x2e2: Push((int) 7)
0x2e3: @ SendWorldWndMessage(Stack[-1])
0x2e4: Pop(1)
0x2e5: @@ GetCategory(Stack[-1]); Obj=8 // @poff=622
0x2e6: Pop(0)
0x2e7: @ SetDiarySection(Stack[-1])
0x2e8: Pop(0)
0x2e9: Stack[-9] = (bool) 0
0x2ea: Return(); Pop(6)

0x2eb: Stack[-2] = 0
0x2ec: Stack[-3] = 0
0x2ed: PushEmpty(int, int)
0x2ee: Push("branch") // @poff=634
0x2ef: @ GetVariable(Stack[-1], Stack[-2])
0x2f0: Pop(1)
0x2f1: Push((int) 0)
