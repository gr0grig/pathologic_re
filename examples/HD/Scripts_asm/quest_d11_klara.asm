...
// @pool_raw:
// @pool_encoding:utf8
...
0x76: Stack[-1] = "Saveyouall" // @poff=138
0x77: Call2 0xc6
...
0xb7: Push("all") // @poff=152
0xb8: Push("idle") // @poff=160
...
0xc0: Push("all") // @poff=152
0xc1: Push("idle") // @poff=160
...
0x121: Stack[-1] = "Saveyouall" // @poff=138
0x122: Call2 0xc6
...
0x195: Stack[-1] = "Saveyouall" // @poff=138
0x196: Call2 0xc6
...
0x203: Stack[-1] = "Saveyouall" // @poff=138
0x204: Call2 0xc6
...
0x2b9: Stack[-1] = "Sly" // @poff=202
0x2ba: Call2 0xc6

0x2bb: Pop(1)
0x2bc: Push((int) 514362)
0x2bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2be: Pop(1)
0x2bf: @@@ ClearReplies(); Obj=0 // @poff=116
0x2c0: Pop(0)
...
0x2eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2ec: Pop(1)
0x2ed: @@@ ClearReplies(); Obj=0 // @poff=116
0x2ee: Pop(0)
...
0x334: Stack[-1] = "Saveyouall" // @poff=138
0x335: Call2 0xc6
...
0x3a1: Stack[-1] = 0
0x3a2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3a3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x3a4: @ RotateAsync(Stack[-2], Stack[-1])
0x3a5: Pop(2)
0x3a6: Return(); Pop(0)

0x3a7: PushEmpty(object, bool, object, bool)
0x3a8: Push("player") // @poff=242
...
0x45f: Stack[-3] = (int) 0
0x460: Push("all") // @poff=152
0x461: PushEmpty(string, int)
0x462: Stack[-6] = Stack[-1]
0x463: Call2 0x601
...
0x483: Pop(0)
0x484: @@ GetPosition(Stack[-2]); Obj=7 // @poff=256
0x485: Pop(0)
...
0x494: @@ GetPosition(Stack[-1]); Obj=3 // @poff=256
0x495: Pop(0)
...
0x4a2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=256
0x4a3: Pop(0)
0x4a4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=268
0x4a5: Pop(0)
...
0x511: Push("voice_common") // @poff=292
0x512: Push((int) 1)
...
0x519: Push("voice_common") // @poff=292
0x51a: Push((int) 0)
...
0x52c: Push("voice_common") // @poff=292
0x52d: Push((int) 1)
...
0x53a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=322
0x53b: Pop(1)
...
0x54f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=334
0x550: Pop(1)
...
0x558: Push("d") // @poff=288
0x559: PushEmpty(int)
0x55a: Call2 0x5f8

0x55b: Pop(0)
0x55c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x55d: Push("m") // @poff=346
...
0x565: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=322
0x566: Pop(1)
...
0x57a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=334
0x57b: Pop(1)
...
0x58d: Push("Can't find lsh animation : ") // @poff=350
...
0x59c: Push("Can't find lsh animation : ") // @poff=350
...
0x5cd: @ CreateIntVector(Stack[-1])
0x5ce: Pop(0)
0x5cf: @@ add(Stack[-4]); Obj=1 // @poff=406
0x5d0: Pop(0)
0x5d1: @@ add(Stack[-3]); Obj=1 // @poff=406
0x5d2: Pop(0)
0x5d3: Push((int) 3)
0x5d4: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x5d5: Pop(1)
0x5d6: Return(); Pop(2)

0x5d7: Stack[-1] = 0
0x5d8: PushEmpty(int, int, bool, int, int, bool)
0x5d9: @@ GetItemID(Stack[-3]); Obj=8 // @poff=410
0x5da: Pop(0)
0x5db: Push("Category") // @poff=420
0x5dc: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5dd: Pop(1)
0x5de: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=438
0x5df: Pop(0)
0x5e0: Pop(0); Push((bool) Stack[-1] == 0)
0x5e1: IF (Stack[-1] == 0) GOTO 0x5e5; Pop(1)

0x5e2: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=446
0x5e3: Pop(0)
0x5e4: GOTO 0x5ea

0x5e5: PushEmpty(int, int)
0x5e6: Stack[-5] = Stack[-2]
0x5e7: Stack[-9] = Stack[-1]
0x5e8: Call2 0x5cc
...
0x5ec: @ CreateInvItem(Stack[-1])
0x5ed: Pop(0)
0x5ee: @@ SetItemName(Stack[-4]); Obj=1 // @poff=456
0x5ef: Pop(0)
0x5f0: PushEmpty(object, object, int)
0x5f1: Stack[-8] = Stack[-3]
...
0x5f7: Stack[-1] = 0
0x5f8: PushEmpty(float, float)
0x5f9: @ GetGameTime(Stack[-1])
0x5fa: Pop(0)
0x5fb: Push((int) 1)
0x5fc: PushEmpty(int)
0x5fd: Push((int) 24)
0x5fe: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x5ff: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x600: Return(); Pop(2)

0x601: PushEmpty(string, string)
0x602: Stack[-1] = "idle" // @poff=160
0x603: Push(Stack[-3])
0x604: IF (Stack[-1] == 0) GOTO 0x606; Pop(1)

0x605: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x606: Stack[-1] = Stack[-4]
0x607: Return(); Pop(2)

0x608: PushEmpty(int, bool, int, bool)
0x609: Stack[-2] = (int) 0
0x60a: Push("all") // @poff=152
0x60b: PushEmpty(string, int)
0x60c: Stack[-5] = Stack[-1]
0x60d: Call2 0x601

0x60e: Pop(1)
0x60f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x610: Pop(2)
...
0x614: Push((int) 1)
0x615: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x616: GOTO 0x60a
...
0x619: PushEmpty()
0x61a: Push("d11q06KlaraRing") // @poff=468
0x61b: Push((int) 1)
...
0x620: Pop(0)
0x621: Push("d11q06KlaraRing is given") // @poff=500
0x622: @ Trace(Stack[-1])
0x623: Pop(1)
0x624: PushEmpty(object, string, int)
0x625: Stack[-5] = Stack[-3]
0x626: Stack[-2] = "d11q06KlaraRing" // @poff=468
0x627: Stack[-1] = (int) 1
0x628: Call2 0x5eb
...
0x62e: PushEmpty(int, string)
0x62f: Stack[-1] = "d11q06KapellaRing" // @poff=550
0x630: Call2 0x5c7
...
0x635: PushEmpty(int, string)
0x636: Stack[-1] = "d11q06KlaraRing" // @poff=468
0x637: Call2 0x5c7
...
0x63d: IF (Stack[-1] == 0) GOTO 0x645; Pop(1)

0x63e: Push("d11q06") // @poff=586
0x63f: Push((int) 2)
0x640: @ SetVariable(Stack[-2], Stack[-1])
0x641: Pop(2)
0x642: PushEmpty()
0x643: Call2 0x688
...
0x646: PushEmpty()
0x647: Push("ood11Klara2") // @poff=600
0x648: Push((int) 1)
0x649: @ SetVariable(Stack[-2], Stack[-1])
0x64a: Pop(2)
0x64b: Return(); Pop(0)

0x64c: PushEmpty()
0x64d: Push("ood11Klara3") // @poff=624
0x64e: Push((int) 1)
...
0x652: PushEmpty()
0x653: Push("ood11Klara1") // @poff=648
0x654: Push((int) 1)
0x655: @ SetVariable(Stack[-2], Stack[-1])
0x656: Pop(2)
0x657: Return(); Pop(0)

0x658: PushEmpty()
0x659: PushEmpty(int, string)
0x65a: Stack[-1] = "d11q06" // @poff=586
0x65b: Call2 0x5c7
...
0x666: Stack[-1] = "ood11Klara2" // @poff=600
0x667: Call2 0x5c7
...
0x672: Stack[-1] = "ood11Klara3" // @poff=624
0x673: Call2 0x5c7
...
0x67e: Stack[-1] = "ood11Klara1" // @poff=648
0x67f: Call2 0x5c7
...
0x6a7: Push("Can't retrieve diary root") // @poff=672
0x6a8: @ Trace(Stack[-1])
0x6a9: Pop(1)
...
0x6b3: Pop(1)
0x6b4: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=724
0x6b5: Pop(0)
0x6b6: Pop(0); Push((bool) Stack[-2] == 0)
0x6b7: IF (Stack[-1] == 0) GOTO 0x6be; Pop(1)

0x6b8: Push("Can't find diary parent with id: ") // @poff=729
...
0x6be: @@ AddChild(Stack[-8]); Obj=2 // @poff=797
0x6bf: Pop(0)
0x6c0: Push((int) 7)
0x6c1: @ SendWorldWndMessage(Stack[-1])
0x6c2: Pop(1)
0x6c3: @@ GetCategory(Stack[-1]); Obj=8 // @poff=806
0x6c4: Pop(0)
...
0x6c9: Stack[-2] = 0
0x6ca: Stack[-3] = 0
0x6cb: PushEmpty(int, int)
0x6cc: Push("branch") // @poff=818
0x6cd: @ GetVariable(Stack[-1], Stack[-2])
0x6ce: Pop(1)
0x6cf: Push((int) 0)
...
0x6dc: Stack[-1] = (int) 515540
0x6dd: Return(); Pop(0)

0x6de: Stack[-1] = (int) 502865
0x6df: Return(); Pop(0)

0x6e0: Stack[-1] = "ui/NPC_Klara.png" // @poff=832
0x6e1: Return(); Pop(0)

0x6e2: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=866
0x6e3: Return(); Pop(0)
