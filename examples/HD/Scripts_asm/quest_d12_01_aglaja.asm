...
// @pool_raw:
// @pool_encoding:utf8
...
0x1b5: Stack[-1] = "Arrogance" // @poff=180
0x1b6: Call2 0x95
...
0x214: @@ GetPosition(Stack[-8]); Obj=20 // @poff=232
0x215: Pop(0)
0x216: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=244
0x217: Pop(0)
...
0x283: Push("voice_common") // @poff=268
0x284: Push((int) 1)
...
0x28b: Push("voice_common") // @poff=268
0x28c: Push((int) 0)
...
0x29e: Push("voice_common") // @poff=268
0x29f: Push((int) 1)
...
0x2ac: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x2ad: Pop(1)
...
0x2d7: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x2d8: Pop(1)
...
0x2ec: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=310
0x2ed: Pop(1)
0x2ee: PushEmpty(bool, string)
0x2ef: Stack[-3] = Stack[-1]
0x2f0: Call2 0x313

0x2f1: Stack[-2] = Stack[-14]
0x2f2: Pop(2)
0x2f3: Return(); Pop(10)
...
0x2ff: Push("Can't find lsh animation : ") // @poff=326
...
0x30e: Push("Can't find lsh animation : ") // @poff=326
...
0x332: Push((float)9.999999974752427e-07)
...
0x347: PushEmpty()
0x348: Push("ood12AglajaSobor1") // @poff=382
0x349: Push((int) 1)
...
0x34f: Stack[-1] = "ood12AglajaSobor1" // @poff=382
0x350: Call2 0x339
...
0x36e: Stack[-1] = "ui/NPC_Aglaja.png" // @poff=432
0x36f: Return(); Pop(0)

0x370: Stack[-1] = "ui/NPC_Aglaja_b.png" // @poff=468
0x371: Return(); Pop(0)
