...
Strings:
	...
	A:get
	W:game_final
// @pool_raw:
// @pool_encoding:utf8
...
0x30a: Push("player") // @poff=156
0x30b: @ FindActor(Stack[-4]T, Stack[-1])
0x30c: Pop(1)
...
0x31f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x374: Pop(0)
0x375: Push("all") // @poff=138
0x376: PushEmpty(string, int)
0x377: Stack[-7] = Stack[-1]
0x378: Call2 0x471
...
0x3aa: Pop(0)
0x3ab: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x3ac: Pop(0)
...
0x3b6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x3b7: Pop(0)
0x3b8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x3b9: Pop(0)
...
0x417: Push("Can't find lsh animation : ") // @poff=206
...
0x426: Push("Can't find lsh animation : ") // @poff=206
...
0x451: Push("Door ") // @poff=262
0x452: Pop(1); Push(Stack[-1] + Stack[-5]);
0x453: Push(" not found") // @poff=274
0x454: Pop(2); Push(Stack[-2] + Stack[-1]);
0x455: @ Trace(Stack[-1])
0x456: Pop(1)
0x457: GOTO 0x45b

0x458: Push("locked") // @poff=296
0x459: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=310
0x45a: Pop(1)
0x45b: Return(); Pop(2)
...
0x45f: Pop(0)
0x460: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x479: Stack[-2] = (int) 0
0x47a: Push("all") // @poff=138
0x47b: PushEmpty(string, int)
0x47c: Stack[-5] = Stack[-1]
0x47d: Call2 0x471
...
0x48d: Stack[-1] = "ui/NPC_bmask.png" // @poff=322
0x48e: Return(); Pop(0)

0x48f: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=356
0x490: Return(); Pop(0)
...
0x493: PushEmpty()
0x494: Push("ood12BirdmaskS1") // @poff=394
0x495: Push((int) 1)
...
0x49b: Stack[-2] = "quest_d12_01" // @poff=426
0x49c: Stack[-1] = "init_sobor" // @poff=452
0x49d: Call2 0x45d
...
0x4a0: PushEmpty()
0x4a1: Push("ood12BirdmaskS2") // @poff=474
0x4a2: Push((int) 1)
...
0x4a6: PushEmpty()
0x4a7: Push("ood12BirdmaskS3") // @poff=506
0x4a8: Push((int) 1)
...
0x4ac: PushEmpty()
0x4ad: Push("ood12BirdmaskS4") // @poff=538
0x4ae: Push((int) 1)
...
0x4b4: Stack[-2] = "sobor@door1" // @poff=570
...
0x4cf: Stack[-1] = "ood12BirdmaskS1" // @poff=394
0x4d0: Call2 0x447
...
0x4db: Stack[-1] = "ood12BirdmaskS2" // @poff=474
0x4dc: Call2 0x447
...
0x4e7: Stack[-1] = "ood12BirdmaskS3" // @poff=506
0x4e8: Call2 0x447
...
0x4f3: Stack[-1] = "ood12BirdmaskS4" // @poff=538
0x4f4: Call2 0x447
...
0x51f: PushEmpty()
0x520: Push((int) 6)
0x521: @@ add(Stack[-1]); Obj=4 // @poff=608
0x522: Pop(1)
0x523: Push((int) 26)
0x524: @@ add(Stack[-1]); Obj=4 // @poff=608
0x525: Pop(1)
0x526: Push((int) 2)
0x527: @@ add(Stack[-1]); Obj=4 // @poff=608
0x528: Pop(1)
0x529: Push((int) 22)
0x52a: @@ add(Stack[-1]); Obj=4 // @poff=608
0x52b: Pop(1)
0x52c: Push((bool) 0)
...
0x52f: Push((int) 15)
0x530: @@ add(Stack[-1]); Obj=4 // @poff=608
0x531: Pop(1)
0x532: Push((int) 5)
0x533: @@ add(Stack[-1]); Obj=4 // @poff=608
0x534: Pop(1)
0x535: Push((int) 16)
0x536: @@ add(Stack[-1]); Obj=4 // @poff=608
0x537: Pop(1)
0x538: GOTO 0x53f
...
0x53c: Push((int) 15)
0x53d: @@ add(Stack[-1]); Obj=4 // @poff=608
0x53e: Pop(1)
0x53f: Return(); Pop(0)

0x540: PushEmpty(int, int)
0x541: Push("vol_") // @poff=612
...
0x558: Stack[-7] = Stack[-3]
0x559: Stack[-2] = (bool) 0
0x55a: Stack[-1] = (int) -1
0x55b: Call2 0x51f

0x55c: Pop(3)
0x55d: @@ size(Stack[-3]); Obj=4 // @poff=622
0x55e: Pop(0)
0x55f: Stack[-2] = (int) 0
0x560: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x561: IF (Stack[-1] == 0) GOTO 0x577; Pop(1)

0x562: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=627
0x563: Pop(0)
...
0x569: Pop(1)
0x56a: IF (Stack[-1] == 1) GOTO 0x571; Pop(1)
...
0x56e: Pop(1)
0x56f: IF (Stack[-1] == 1) GOTO 0x571; Pop(1)
...
0x57b: Push("game_final") // @poff=631
