...
Strings:
	...
	A:size
	A:get
// @pool_raw:
// @pool_encoding:utf8
...
0x212: Push("d12q01TheaterIsVisited") // @poff=156
...
0x398: PushEmpty()
0x399: Push("ood12BirdmaskT") // @poff=380
0x39a: Push((int) 1)
...
0x39e: PushEmpty()
0x39f: Push("ood12BirdmaskT2") // @poff=410
0x3a0: Push((int) 1)
...
0x3a6: Stack[-2] = "quest_d12_01" // @poff=442
0x3a7: Stack[-1] = "init_theater" // @poff=468
0x3a8: Call2 0x36a
...
0x3b7: Stack[-1] = "ood12BirdmaskT" // @poff=380
0x3b8: Call2 0x365
...
0x3c3: Stack[-1] = "ood12BirdmaskT2" // @poff=410
0x3c4: Call2 0x365
...
0x3cf: Stack[-1] = "d12q01ChildsAreVisited" // @poff=494
0x3d0: Call2 0x365
...
0x3f0: PushEmpty()
0x3f1: Push((int) 18)
0x3f2: @@ add(Stack[-1]); Obj=4 // @poff=554
0x3f3: Pop(1)
0x3f4: Push((int) 24)
0x3f5: @@ add(Stack[-1]); Obj=4 // @poff=554
0x3f6: Pop(1)
0x3f7: Push((int) 20)
0x3f8: @@ add(Stack[-1]); Obj=4 // @poff=554
0x3f9: Pop(1)
0x3fa: Push((int) 14)
0x3fb: @@ add(Stack[-1]); Obj=4 // @poff=554
0x3fc: Pop(1)
0x3fd: Push((bool) 0)
...
0x400: Push((int) 10)
0x401: @@ add(Stack[-1]); Obj=4 // @poff=554
0x402: Pop(1)
0x403: Push((int) 17)
0x404: @@ add(Stack[-1]); Obj=4 // @poff=554
0x405: Pop(1)
0x406: Push((int) 8)
0x407: @@ add(Stack[-1]); Obj=4 // @poff=554
0x408: Pop(1)
0x409: GOTO 0x410
...
0x40d: Push((int) 10)
0x40e: @@ add(Stack[-1]); Obj=4 // @poff=554
0x40f: Pop(1)
0x410: Return(); Pop(0)

0x411: PushEmpty()
0x412: Push((int) 6)
0x413: @@ add(Stack[-1]); Obj=4 // @poff=554
0x414: Pop(1)
0x415: Push((int) 26)
0x416: @@ add(Stack[-1]); Obj=4 // @poff=554
0x417: Pop(1)
0x418: Push((int) 2)
0x419: @@ add(Stack[-1]); Obj=4 // @poff=554
0x41a: Pop(1)
0x41b: Push((int) 22)
0x41c: @@ add(Stack[-1]); Obj=4 // @poff=554
0x41d: Pop(1)
0x41e: Push((bool) 0)
...
0x421: Push((int) 15)
0x422: @@ add(Stack[-1]); Obj=4 // @poff=554
0x423: Pop(1)
0x424: Push((int) 5)
0x425: @@ add(Stack[-1]); Obj=4 // @poff=554
0x426: Pop(1)
0x427: Push((int) 16)
0x428: @@ add(Stack[-1]); Obj=4 // @poff=554
0x429: Pop(1)
0x42a: GOTO 0x431
...
0x42e: Push((int) 15)
0x42f: @@ add(Stack[-1]); Obj=4 // @poff=554
0x430: Pop(1)
0x431: Return(); Pop(0)

0x432: PushEmpty()
0x433: Push((int) 7)
0x434: @@ add(Stack[-1]); Obj=4 // @poff=554
0x435: Pop(1)
0x436: Push((int) 23)
0x437: @@ add(Stack[-1]); Obj=4 // @poff=554
0x438: Pop(1)
0x439: Push((int) 21)
0x43a: @@ add(Stack[-1]); Obj=4 // @poff=554
0x43b: Pop(1)
0x43c: Push((int) 9)
0x43d: @@ add(Stack[-1]); Obj=4 // @poff=554
0x43e: Pop(1)
0x43f: Push((int) 3)
0x440: @@ add(Stack[-1]); Obj=4 // @poff=554
0x441: Pop(1)
0x442: Push((int) 1)
0x443: @@ add(Stack[-1]); Obj=4 // @poff=554
0x444: Pop(1)
0x445: Push((int) 11)
0x446: @@ add(Stack[-1]); Obj=4 // @poff=554
0x447: Pop(1)
0x448: Push((int) 13)
0x449: @@ add(Stack[-1]); Obj=4 // @poff=554
0x44a: Pop(1)
0x44b: Push((bool) 0)
...
0x44e: Push((int) 25)
0x44f: @@ add(Stack[-1]); Obj=4 // @poff=554
0x450: Pop(1)
0x451: Return(); Pop(0)

0x452: PushEmpty(int, int)
0x453: Push("vol_") // @poff=558
...
0x46e: Pop(3)
0x46f: @@ size(Stack[-3]); Obj=4 // @poff=568
0x470: Pop(0)
0x471: Stack[-2] = (int) 0
0x472: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x473: IF (Stack[-1] == 0) GOTO 0x489; Pop(1)

0x474: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=573
0x475: Pop(0)
...
0x494: Pop(3)
0x495: @@ size(Stack[-3]); Obj=4 // @poff=568
0x496: Pop(0)
0x497: Stack[-2] = (int) 0
0x498: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x499: IF (Stack[-1] == 0) GOTO 0x4af; Pop(1)

0x49a: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=573
0x49b: Pop(0)
...
0x4ba: Pop(3)
0x4bb: @@ size(Stack[-3]); Obj=4 // @poff=568
0x4bc: Pop(0)
0x4bd: Stack[-2] = (int) 0
0x4be: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x4bf: IF (Stack[-1] == 0) GOTO 0x4d5; Pop(1)

0x4c0: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=573
0x4c1: Pop(0)
