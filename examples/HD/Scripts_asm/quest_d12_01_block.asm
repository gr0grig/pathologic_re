...
// @pool_raw:
// @pool_encoding:utf8
...
0x274: @@ GetPosition(Stack[-8]); Obj=20 // @poff=200
0x275: Pop(0)
0x276: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=212
0x277: Pop(0)
...
0x2e3: Push("voice_common") // @poff=236
0x2e4: Push((int) 1)
...
0x2eb: Push("voice_common") // @poff=236
0x2ec: Push((int) 0)
...
0x2fe: Push("voice_common") // @poff=236
0x2ff: Push((int) 1)
...
0x30c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x30d: Pop(1)
...
0x321: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x322: Pop(1)
...
0x32a: Push("d") // @poff=232
0x32b: PushEmpty(int)
0x32c: Call2 0x3af

0x32d: Pop(0)
0x32e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x32f: Push("m") // @poff=290
...
0x337: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=266
0x338: Pop(1)
...
0x34c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=278
0x34d: Pop(1)
0x34e: PushEmpty(bool, string)
0x34f: Stack[-3] = Stack[-1]
0x350: Call2 0x373

0x351: Stack[-2] = Stack[-14]
0x352: Pop(2)
0x353: Return(); Pop(10)
...
0x35f: Push("Can't find lsh animation : ") // @poff=294
...
0x36e: Push("Can't find lsh animation : ") // @poff=294
...
0x392: Push((float)9.999999974752427e-07)
...
0x3a3: Push("Door ") // @poff=350
0x3a4: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3a5: Push(" not found") // @poff=362
0x3a6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3a7: @ Trace(Stack[-1])
0x3a8: Pop(1)
0x3a9: GOTO 0x3ad

0x3aa: Push("locked") // @poff=384
0x3ab: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=398
0x3ac: Pop(1)
0x3ad: Return(); Pop(2)
...
0x3b8: PushEmpty()
0x3b9: Push("game_final") // @poff=410
0x3ba: Push((int) 1)
...
0x3be: PushEmpty()
0x3bf: Push("game_final") // @poff=410
0x3c0: Push((int) 2)
...
0x3c4: PushEmpty()
0x3c5: Push("game_final") // @poff=410
0x3c6: Push((int) 3)
...
0x3cc: Stack[-2] = "isobor@door1" // @poff=432
...
0x3d1: PushEmpty()
0x3d2: Push("game_final") // @poff=410
0x3d3: Push((int) 4)
...
0x3ed: Stack[-1] = "game_final" // @poff=410
0x3ee: Call2 0x399
...
0x3f9: Stack[-1] = "d12q01BurahInSobor" // @poff=458
0x3fa: Call2 0x399
...
0x405: Stack[-1] = "d12q01KlaraInSobor" // @poff=496
0x406: Call2 0x399
...
0x448: Push("Can't retrieve diary root") // @poff=534
0x449: @ Trace(Stack[-1])
0x44a: Pop(1)
0x44b: Stack[-3] = (bool) 0
0x44c: Return(); Pop(2)

0x44d: Stack[-1] = Stack[-3]
0x44e: Return(); Pop(2)
...
0x453: Stack[-1] = Stack[-4]
0x454: Pop(1)
0x455: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=586
0x456: Pop(0)
0x457: Pop(0); Push((bool) Stack[-2] == 0)
0x458: IF (Stack[-1] == 0) GOTO 0x45f; Pop(1)

0x459: Push("Can't find diary parent with id: ") // @poff=591
...
0x45f: @@ AddChild(Stack[-8]); Obj=2 // @poff=659
0x460: Pop(0)
0x461: Push((int) 7)
0x462: @ SendWorldWndMessage(Stack[-1])
0x463: Pop(1)
0x464: @@ GetCategory(Stack[-1]); Obj=8 // @poff=668
0x465: Pop(0)
...
0x481: Stack[-1] = "ui/NPC_Block.png" // @poff=694
0x482: Return(); Pop(0)

0x483: Stack[-1] = "ui/NPC_Block_b.png" // @poff=728
0x484: Return(); Pop(0)
