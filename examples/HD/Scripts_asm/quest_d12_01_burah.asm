...
// @pool_raw:
// @pool_encoding:utf8
...
0xb8: Push("all") // @poff=138
0xb9: Push("idle") // @poff=146
...
0x180: Stack[-1] = "Agression" // @poff=170
0x181: Call2 0xbe
...
0x1e9: Stack[-1] = "Agression" // @poff=170
0x1ea: Call2 0xbe
...
0x212: Stack[-1] = "Agression" // @poff=170
0x213: Call2 0xbe
...
0x271: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0x272: Pop(0)
0x273: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=246
0x274: Pop(0)
...
0x29a: Pop(0)
0x29b: Push((bool) 1)
0x29c: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x29d: Pop(1)
0x29e: Push(CvectorIndex(Stack[-4], 0))
0x29f: Push(CvectorIndex(Stack[-5], 2))
0x2a0: @ Rotate(Stack[-2], Stack[-1])
0x2a1: Pop(2)
...
0x2a7: Push("head") // @poff=260
0x2a8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2a9: Pop(1)
0x2aa: Push(Stack[-1])
0x2ab: IF (Stack[-1] == 0) GOTO 0x2af; Pop(1)

0x2ac: Push("head") // @poff=260
0x2ad: @ LookAsyncCamera(Stack[-1])
0x2ae: Pop(1)
0x2af: @ CameraWaitForPlayFinish()
0x2b0: Pop(0)
0x2b1: @ ResumeWorld()
0x2b2: Pop(0)
0x2b3: Stack[-21] = (bool) 1
0x2b4: Return(); Pop(18)

0x2b5: PushEmpty(bool, bool)
0x2b6: Push((bool) 1)
0x2b7: @ CameraSwitchToNormal(Stack[-1])
0x2b8: Pop(1)
...
0x2be: Push("head") // @poff=260
0x2bf: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2c0: Pop(1)
0x2c1: Push(Stack[-1])
0x2c2: IF (Stack[-1] == 0) GOTO 0x2c6; Pop(1)

0x2c3: Push("head") // @poff=260
0x2c4: @ UnlookAsync(Stack[-1])
0x2c5: Pop(1)
0x2c6: Return(); Pop(2)

0x2c7: PushEmpty(int, int, int, int)
0x2c8: Push("voice_common") // @poff=270
0x2c9: @ GetVariable(Stack[-1], Stack[-3])
0x2ca: Pop(1)
0x2cb: Push(Stack[-2])
0x2cc: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)
...
0x2d9: Stack[-6] = (bool) 0
0x2da: Return(); Pop(4)

0x2db: Push((int) 2)
0x2dc: @ irand(Stack[-2], Stack[-1])
0x2dd: Pop(1)
0x2de: Push(Stack[-1])
0x2df: IF (Stack[-1] == 0) GOTO 0x2e8; Pop(1)

0x2e0: Push("voice_common") // @poff=270
0x2e1: Push((int) 1)
0x2e2: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2e3: Push((int) 3)
0x2e4: Pop(2); Push(Stack[-2] % Stack[-1]);
0x2e5: @ SetVariable(Stack[-2], Stack[-1])
0x2e6: Pop(2)
0x2e7: GOTO 0x2ec

0x2e8: Push("voice_common") // @poff=270
0x2e9: Push((int) 0)
...
0x2fb: Push("voice_common") // @poff=270
0x2fc: Push((int) 1)
0x2fd: @ SetVariable(Stack[-2], Stack[-1])
0x2fe: Pop(2)
0x2ff: Stack[-6] = (bool) 1
0x300: Return(); Pop(4)

0x301: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x302: Stack[-5] = "c" // @poff=296
0x303: Stack[-4] = (int) 0
0x304: Push((int) 1)
0x305: IF (Stack[-1] == 0) GOTO 0x311; Pop(1)

0x306: Push((int) 1)
0x307: Pop(1); Push(Stack[-5] + Stack[-1]);
0x308: Pop(1); Push(Stack[-6] + Stack[-1]);
0x309: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x30a: Pop(1)
...
0x311: Pop(0); Push((bool) Stack[-4] == 0)
0x312: IF (Stack[-1] == 0) GOTO 0x315; Pop(1)

0x313: Stack[-12] = (bool) 0
0x314: Return(); Pop(10)

0x315: Stack[-2] = (int) 0
0x316: Push((int) 1)
0x317: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x318: IF (Stack[-1] == 0) GOTO 0x31b; Pop(1)

0x319: @ irand(Stack[-2], Stack[-4])
0x31a: Pop(0)
0x31b: Push((int) 1)
0x31c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x31d: Pop(1); Push(Stack[-6] + Stack[-1]);
0x31e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x31f: Pop(1)
0x320: PushEmpty(bool, string)
0x321: Stack[-3] = Stack[-1]
0x322: Call2 0x370

0x323: Stack[-2] = Stack[-14]
0x324: Pop(2)
0x325: Return(); Pop(10)

0x326: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x327: Push("d") // @poff=266
0x328: PushEmpty(int)
0x329: Call2 0x39b

0x32a: Pop(0)
0x32b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x32c: Push("m") // @poff=324
0x32d: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x32e: Stack[-4] = (int) 0
0x32f: Push((int) 1)
0x330: IF (Stack[-1] == 0) GOTO 0x33c; Pop(1)

0x331: Push((int) 1)
0x332: Pop(1); Push(Stack[-5] + Stack[-1]);
0x333: Pop(1); Push(Stack[-6] + Stack[-1]);
0x334: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x335: Pop(1)
0x336: Pop(0); Push((bool) Stack[-3] == 0)
0x337: IF (Stack[-1] == 0) GOTO 0x339; Pop(1)

0x338: GOTO 0x33c

0x339: Push((int) 1)
0x33a: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x33b: GOTO 0x32f

0x33c: Pop(0); Push((bool) Stack[-4] == 0)
0x33d: IF (Stack[-1] == 0) GOTO 0x340; Pop(1)

0x33e: Stack[-12] = (bool) 0
0x33f: Return(); Pop(10)

0x340: Stack[-2] = (int) 0
0x341: Push((int) 1)
0x342: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x343: IF (Stack[-1] == 0) GOTO 0x346; Pop(1)

0x344: @ irand(Stack[-2], Stack[-4])
0x345: Pop(0)
0x346: Push((int) 1)
0x347: Pop(1); Push(Stack[-3] + Stack[-1]);
0x348: Pop(1); Push(Stack[-6] + Stack[-1]);
0x349: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x34a: Pop(1)
0x34b: PushEmpty(bool, string)
0x34c: Stack[-3] = Stack[-1]
0x34d: Call2 0x370

0x34e: Stack[-2] = Stack[-14]
0x34f: Pop(2)
0x350: Return(); Pop(10)

0x351: PushEmpty(bool, float, float, bool, float, float)
0x352: @ lshHasAnimation(Stack[-3], Stack[-7])
0x353: Pop(0)
0x354: Push(Stack[-3])
0x355: IF (Stack[-1] == 0) GOTO 0x35c; Pop(1)

0x356: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x357: Pop(0)
0x358: Push((bool) 0)
0x359: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x35a: Pop(1)
0x35b: GOTO 0x360

0x35c: Push("Can't find lsh animation : ") // @poff=328
0x35d: Pop(1); Push(Stack[-1] + Stack[-8]);
0x35e: @ Trace(Stack[-1])
0x35f: Pop(1)
0x360: Return(); Pop(6)

0x361: PushEmpty(bool, float, float, bool, float, float)
0x362: @ lshHasAnimation(Stack[-3], Stack[-8])
0x363: Pop(0)
0x364: Push(Stack[-3])
0x365: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x366: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x367: Pop(0)
0x368: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x369: Pop(0)
0x36a: GOTO 0x36f

0x36b: Push("Can't find lsh animation : ") // @poff=328
0x36c: Pop(1); Push(Stack[-1] + Stack[-9]);
0x36d: @ Trace(Stack[-1])
0x36e: Pop(1)
0x36f: Return(); Pop(6)
...
0x373: Pop(0)
0x374: IF (Stack[-1] == 0) GOTO 0x37d; Pop(1)

0x375: @ lshHasSpeech(Stack[-1], Stack[-3])
0x376: Pop(0)
0x377: Push(Stack[-1])
0x378: IF (Stack[-1] == 0) GOTO 0x37d; Pop(1)

0x379: @ lshPlaySpeech(Stack[-3])
0x37a: Pop(0)
0x37b: Stack[-4] = (bool) 1
0x37c: Return(); Pop(2)

0x37d: Stack[-4] = (bool) 0
0x37e: Return(); Pop(2)
...
0x38d: Pop(0); Push(Stack[-3] | Stack[-3]);
0x38e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x38f: Push((float)9.999999974752427e-07)
0x390: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x391: IF (Stack[-1] == 0) GOTO 0x394; Pop(1)

0x392: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x393: Return(); Pop(2)

0x394: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x395: Return(); Pop(2)

0x396: PushEmpty(int, int)
0x397: @ GetVariable(Stack[-3], Stack[-1])
0x398: Pop(0)
...
0x3a4: PushEmpty()
0x3a5: Push("ood12BurahSobor1") // @poff=384
0x3a6: Push((int) 1)
...
0x3aa: PushEmpty()
0x3ab: Push("ood12BurahSobor2") // @poff=418
0x3ac: Push((int) 1)
...
0x3b0: PushEmpty()
0x3b1: Push("ood12BurahSobor3") // @poff=452
0x3b2: Push((int) 1)
...
0x3b8: Stack[-1] = "game_final" // @poff=486
0x3b9: Call2 0x396
...
0x3c2: PushEmpty()
0x3c3: PushEmpty(int, string)
0x3c4: Stack[-1] = "ood12BurahSobor1" // @poff=384
0x3c5: Call2 0x396
...
0x3ca: Stack[-2] = (bool) 1
0x3cb: Return(); Pop(0)

0x3cc: Stack[-2] = (bool) 0
0x3cd: Return(); Pop(0)

0x3ce: PushEmpty()
0x3cf: PushEmpty(int, string)
0x3d0: Stack[-1] = "ood12BurahSobor2" // @poff=418
0x3d1: Call2 0x396
...
0x3d6: Stack[-2] = (bool) 1
0x3d7: Return(); Pop(0)

0x3d8: Stack[-2] = (bool) 0
0x3d9: Return(); Pop(0)

0x3da: PushEmpty()
0x3db: PushEmpty(int, string)
0x3dc: Stack[-1] = "ood12BurahSobor3" // @poff=452
0x3dd: Call2 0x396
...
0x3f7: Stack[-1] = (int) 515592
0x3f8: Return(); Pop(0)

0x3f9: Stack[-1] = (int) 511961
0x3fa: Return(); Pop(0)

0x3fb: Stack[-1] = "ui/NPC_Burah.png" // @poff=522
0x3fc: Return(); Pop(0)

0x3fd: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=556
0x3fe: Return(); Pop(0)
