...
// @pool_raw:
// @pool_encoding:utf8
...
0x29a: Stack[-1] = "Agression" // @poff=194
0x29b: Call2 0xe9
...
0x2b7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2b8: Pop(1)
0x2b9: @@@ ClearReplies(); Obj=0 // @poff=116
0x2ba: Pop(0)
...
0x324: @@ GetPosition(Stack[-8]); Obj=20 // @poff=246
0x325: Pop(0)
0x326: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=258
0x327: Pop(0)
...
0x393: Push("voice_common") // @poff=282
0x394: Push((int) 1)
...
0x39b: Push("voice_common") // @poff=282
0x39c: Push((int) 0)
...
0x3ae: Push("voice_common") // @poff=282
0x3af: Push((int) 1)
...
0x3bc: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x3bd: Pop(1)
...
0x3e7: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x3e8: Pop(1)
...
0x3fc: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=324
0x3fd: Pop(1)
0x3fe: PushEmpty(bool, string)
0x3ff: Stack[-3] = Stack[-1]
0x400: Call2 0x423

0x401: Stack[-2] = Stack[-14]
0x402: Pop(2)
0x403: Return(); Pop(10)
...
0x40f: Push("Can't find lsh animation : ") // @poff=340
...
0x41e: Push("Can't find lsh animation : ") // @poff=340
...
0x442: Push((float)9.999999974752427e-07)
...
0x457: PushEmpty()
0x458: Push("ood12BurahFactory1") // @poff=396
0x459: Push((int) 1)
...
0x45d: PushEmpty()
0x45e: Push("d12q01BurahInSobor") // @poff=434
0x45f: Push((int) 1)
...
0x468: Stack[-1] = "d12q01_Burah" // @poff=472
0x469: Call2 0x449
...
0x46e: Push("d12q01_Burah") // @poff=472
0x46f: Push((int) 1)
...
0x476: PushEmpty()
0x477: Push("d12q01BurahVisit") // @poff=498
0x478: Push((int) 1)
...
0x47c: PushEmpty()
0x47d: Push("ood12BurahFactory2") // @poff=532
0x47e: Push((int) 1)
...
0x48e: Stack[-1] = "b12q01ChildsAreVisited" // @poff=570
0x48f: Call2 0x449
...
0x49a: Stack[-1] = "game_final" // @poff=616
0x49b: Call2 0x449
...
0x4a6: Stack[-1] = "d12q01BurahInSobor" // @poff=434
0x4a7: Call2 0x449
...
0x4b2: Stack[-1] = "ood12BurahFactory1" // @poff=396
0x4b3: Call2 0x449
...
0x4be: Stack[-1] = "ood12BurahFactory2" // @poff=532
0x4bf: Call2 0x449
...
0x4ed: Push("Can't retrieve diary root") // @poff=638
0x4ee: @ Trace(Stack[-1])
0x4ef: Pop(1)
...
0x4f8: Stack[-1] = Stack[-4]
0x4f9: Pop(1)
0x4fa: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=690
0x4fb: Pop(0)
0x4fc: Pop(0); Push((bool) Stack[-2] == 0)
0x4fd: IF (Stack[-1] == 0) GOTO 0x504; Pop(1)

0x4fe: Push("Can't find diary parent with id: ") // @poff=695
...
0x504: @@ AddChild(Stack[-8]); Obj=2 // @poff=763
0x505: Pop(0)
0x506: Push((int) 7)
0x507: @ SendWorldWndMessage(Stack[-1])
0x508: Pop(1)
0x509: @@ GetCategory(Stack[-1]); Obj=8 // @poff=772
0x50a: Pop(0)
...
0x522: PushEmpty()
0x523: Push((int) 18)
0x524: @@ add(Stack[-1]); Obj=4 // @poff=798
0x525: Pop(1)
0x526: Push((int) 24)
0x527: @@ add(Stack[-1]); Obj=4 // @poff=798
0x528: Pop(1)
0x529: Push((int) 20)
0x52a: @@ add(Stack[-1]); Obj=4 // @poff=798
0x52b: Pop(1)
0x52c: Push((int) 14)
0x52d: @@ add(Stack[-1]); Obj=4 // @poff=798
0x52e: Pop(1)
0x52f: Push((bool) 0)
...
0x532: Push((int) 10)
0x533: @@ add(Stack[-1]); Obj=4 // @poff=798
0x534: Pop(1)
0x535: Push((int) 17)
0x536: @@ add(Stack[-1]); Obj=4 // @poff=798
0x537: Pop(1)
0x538: Push((int) 8)
0x539: @@ add(Stack[-1]); Obj=4 // @poff=798
0x53a: Pop(1)
0x53b: GOTO 0x542
...
0x53f: Push((int) 10)
0x540: @@ add(Stack[-1]); Obj=4 // @poff=798
0x541: Pop(1)
0x542: Return(); Pop(0)

0x543: PushEmpty(int, int)
0x544: Push("vol_") // @poff=802
...
0x55b: Stack[-7] = Stack[-3]
0x55c: Stack[-2] = (bool) 0
0x55d: Stack[-1] = (int) -1
0x55e: Call2 0x522

0x55f: Pop(3)
0x560: @@ size(Stack[-3]); Obj=4 // @poff=812
0x561: Pop(0)
0x562: Stack[-2] = (int) 0
0x563: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x564: IF (Stack[-1] == 0) GOTO 0x57a; Pop(1)

0x565: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=817
0x566: Pop(0)
...
0x56c: Pop(1)
0x56d: IF (Stack[-1] == 1) GOTO 0x574; Pop(1)
...
0x571: Pop(1)
0x572: IF (Stack[-1] == 1) GOTO 0x574; Pop(1)
...
0x581: Stack[-1] = "ui/NPC_Burah.png" // @poff=821
0x582: Return(); Pop(0)

0x583: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=855
0x584: Return(); Pop(0)
