...
Strings:
	...
	W:ui/NPC_Eva.png
	W:ui/NPC_Eva_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0x7a: Push((int) 43845)
0x7b: Push((int) 43844)
0x7c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x7d: Pop(3)
...
0x95: Push("all") // @poff=132
0x96: Push("idle") // @poff=140
...
0x9e: Push("all") // @poff=132
0x9f: Push("idle") // @poff=140
...
0xdc: Stack[-1] = "Sexy" // @poff=89
0xdd: Call2 0xa4

0xde: Pop(1)
0xdf: Push((int) 541659)
0xe0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xe1: Pop(1)
0xe2: @@@ ClearReplies(); Obj=0 // @poff=110
0xe3: Pop(0)
...
0xea: Push((int) 43852)
0xeb: Push((int) 43835)
0xec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xed: Pop(3)
...
0xfe: Push((int) 43845)
0xff: Push((int) 43844)
0x100: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x101: Pop(3)
0x102: Push((int) 541661)
0x103: Push((int) -1)
0x104: Push((int) 43836)
0x105: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x106: Pop(3)
0x107: Return(); Pop(0)
...
0x10c: Stack[-1] = "Love" // @poff=150
0x10d: Call2 0xa4

0x10e: Pop(1)
0x10f: Push((int) 541669)
0x110: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x111: Pop(1)
0x112: @@@ ClearReplies(); Obj=0 // @poff=110
0x113: Pop(0)
0x114: Push((int) 541670)
0x115: Push((int) 43840)
0x116: Push((int) 43846)
0x117: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x118: Pop(3)
0x119: Push((int) 541682)
0x11a: Push((int) 43860)
0x11b: Push((int) 43859)
0x11c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x11d: Pop(3)
0x11e: Return(); Pop(0)
...
0x123: Stack[-1] = "Love" // @poff=150
0x124: Call2 0xa4

0x125: Pop(1)
0x126: Push((int) 541683)
0x127: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x128: Pop(1)
0x129: @@@ ClearReplies(); Obj=0 // @poff=110
0x12a: Pop(0)
0x12b: Push((int) 541684)
0x12c: Push((int) 43863)
0x12d: Push((int) 43861)
0x12e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x12f: Pop(3)
...
0x13a: Stack[-1] = "Neutral" // @poff=160
0x13b: Call2 0xa4

0x13c: Pop(1)
0x13d: Push((int) 541686)
0x13e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x13f: Pop(1)
0x140: @@@ ClearReplies(); Obj=0 // @poff=110
0x141: Pop(0)
0x142: Push((int) 541687)
0x143: Push((int) -1)
0x144: Push((int) 43864)
0x145: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x146: Pop(3)
...
0x168: Stack[-1] = "Fear" // @poff=176
0x169: Call2 0xa4

0x16a: Pop(1)
0x16b: Push((int) 541675)
0x16c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x16d: Pop(1)
0x16e: @@@ ClearReplies(); Obj=0 // @poff=110
0x16f: Pop(0)
0x170: Push((int) 541680)
0x171: Push((int) 43838)
0x172: Push((int) 43856)
0x173: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x174: Pop(3)
0x175: Push((int) 541681)
0x176: Push((int) -1)
0x177: Push((int) 43857)
0x178: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x179: Pop(3)
0x17a: Return(); Pop(0)
...
0x17f: Stack[-1] = "Sexy" // @poff=89
0x180: Call2 0xa4

0x181: Pop(1)
0x182: Push((int) 541676)
0x183: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x184: Pop(1)
0x185: @@@ ClearReplies(); Obj=0 // @poff=110
0x186: Pop(0)
...
0x18f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x190: Pop(3)
0x191: Return(); Pop(0)
...
0x196: Stack[-1] = "Sexy" // @poff=89
0x197: Call2 0xa4

0x198: Pop(1)
0x199: Push((int) 541678)
0x19a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x19b: Pop(1)
0x19c: @@@ ClearReplies(); Obj=0 // @poff=110
0x19d: Pop(0)
0x19e: Push((int) 541679)
0x19f: Push((int) 43838)
0x1a0: Push((int) 43855)
0x1a1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1a2: Pop(3)
...
0x1ad: Stack[-1] = "Fear" // @poff=176
0x1ae: Call2 0xa4

0x1af: Pop(1)
0x1b0: Push((int) 541663)
0x1b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1b2: Pop(1)
0x1b3: @@@ ClearReplies(); Obj=0 // @poff=110
0x1b4: Pop(0)
0x1b5: Push((int) 541671)
0x1b6: Push((int) 43848)
0x1b7: Push((int) 43847)
0x1b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1b9: Pop(3)
...
0x1db: Stack[-1] = "Fear" // @poff=176
0x1dc: Call2 0xa4

0x1dd: Pop(1)
0x1de: Push((int) 541672)
0x1df: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1e0: Pop(1)
0x1e1: @@@ ClearReplies(); Obj=0 // @poff=110
0x1e2: Pop(0)
0x1e3: Push((int) 541673)
0x1e4: Push((int) 43875)
0x1e5: Push((int) 43849)
0x1e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1e7: Pop(3)
...
0x268: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x269: Pop(0)
0x26a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=230
0x26b: Pop(0)
...
0x2d7: Push("voice_common") // @poff=254
0x2d8: Push((int) 1)
...
0x2df: Push("voice_common") // @poff=254
0x2e0: Push((int) 0)
...
0x2f2: Push("voice_common") // @poff=254
0x2f3: Push((int) 1)
...
0x300: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x301: Pop(1)
...
0x32b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x32c: Pop(1)
...
0x340: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=296
0x341: Pop(1)
...
0x353: Push("Can't find lsh animation : ") // @poff=312
...
0x362: Push("Can't find lsh animation : ") // @poff=312
...
0x386: Push((float)9.999999974752427e-07)
...
0x39b: PushEmpty()
0x39c: Push("ood12EvaRevenant1") // @poff=368
0x39d: Push((int) 1)
...
0x3a3: Stack[-1] = "ood12EvaRevenant1" // @poff=368
0x3a4: Call2 0x38d
...
0x3c2: Stack[-1] = "ui/NPC_Eva.png" // @poff=418
0x3c3: Return(); Pop(0)

0x3c4: Stack[-1] = "ui/NPC_Eva_b.png" // @poff=448
0x3c5: Return(); Pop(0)
