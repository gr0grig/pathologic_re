...
// @pool_raw:
// @pool_encoding:utf8
...
0x5e: Stack[-1] = "Saveyouall" // @poff=89
0x5f: Call2 0xb4

0x60: Pop(1)
0x61: Push((int) 540282)
0x62: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x63: Pop(1)
0x64: @@@ ClearReplies(); Obj=0 // @poff=122
0x65: Pop(0)
...
0x6c: Push((int) 42264)
0x6d: Push((int) 42263)
0x6e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x6f: Pop(3)
...
0x76: Push((int) 42278)
0x77: Push((int) 42277)
0x78: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x79: Pop(3)
0x7a: Push((int) 540305)
0x7b: Push((int) -1)
0x7c: Push((int) 42286)
0x7d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x7e: Pop(3)
0x7f: GOTO 0x96

0x80: PushEmpty(string)
0x81: Stack[-1] = "Neutral" // @poff=144
0x82: Call2 0xb4

0x83: Pop(1)
0x84: Push((int) 541639)
0x85: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x86: Pop(1)
0x87: @@@ ClearReplies(); Obj=0 // @poff=122
0x88: Pop(0)
0x89: Push((int) 541640)
0x8a: Push((int) -1)
0x8b: Push((int) 43812)
0x8c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x8d: Pop(3)
0x8e: Push((int) 541641)
0x8f: Push((int) -1)
0x90: Push((int) 43813)
0x91: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x92: Pop(3)
0x93: GOTO 0x96
...
0xa5: Push("all") // @poff=103
0xa6: Push("idle") // @poff=160
...
0xae: Push("all") // @poff=103
0xaf: Push("idle") // @poff=160
...
0xea: Stack[-1] = "Saveyouall" // @poff=89
0xeb: Call2 0xb4

0xec: Pop(1)
0xed: Push((int) 540282)
0xee: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0xef: Pop(1)
0xf0: @@@ ClearReplies(); Obj=0 // @poff=122
0xf1: Pop(0)
...
0xf8: Push((int) 42264)
0xf9: Push((int) 42263)
0xfa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xfb: Pop(3)
...
0x104: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x105: Pop(3)
0x106: Push((int) 540305)
0x107: Push((int) -1)
0x108: Push((int) 42286)
0x109: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x10a: Pop(3)
0x10b: Return(); Pop(0)

0x10c: PushEmpty(string)
0x10d: Stack[-1] = "Neutral" // @poff=144
0x10e: Call2 0xb4

0x10f: Pop(1)
0x110: Push((int) 541639)
0x111: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x112: Pop(1)
0x113: @@@ ClearReplies(); Obj=0 // @poff=122
0x114: Pop(0)
0x115: Push((int) 541640)
0x116: Push((int) -1)
0x117: Push((int) 43812)
0x118: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x119: Pop(3)
0x11a: Push((int) 541641)
0x11b: Push((int) -1)
0x11c: Push((int) 43813)
0x11d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x11e: Pop(3)
0x11f: Return(); Pop(0)
...
0x124: Stack[-1] = "Saveyouall" // @poff=89
0x125: Call2 0xb4

0x126: Pop(1)
0x127: Push((int) 540297)
0x128: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x129: Pop(1)
0x12a: @@@ ClearReplies(); Obj=0 // @poff=122
0x12b: Pop(0)
0x12c: Push((int) 540298)
0x12d: Push((int) 42280)
0x12e: Push((int) 42279)
0x12f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x130: Pop(3)
0x131: Push((int) 540479)
0x132: Push((int) 42283)
0x133: Push((int) 42474)
0x134: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x135: Pop(3)
0x136: Return(); Pop(0)
...
0x13b: Stack[-1] = "Smile" // @poff=170
0x13c: Call2 0xb4

0x13d: Pop(1)
0x13e: Push((int) 540299)
0x13f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x140: Pop(1)
0x141: @@@ ClearReplies(); Obj=0 // @poff=122
0x142: Pop(0)
0x143: Push((int) 540300)
0x144: Push((int) 42476)
0x145: Push((int) 42281)
0x146: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x147: Pop(3)
0x148: Push((int) 540301)
0x149: Push((int) 42283)
0x14a: Push((int) 42282)
0x14b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x14c: Pop(3)
0x14d: Return(); Pop(0)
...
0x152: Stack[-1] = "Saveyouall" // @poff=89
0x153: Call2 0xb4

0x154: Pop(1)
0x155: Push((int) 540302)
0x156: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x157: Pop(1)
0x158: @@@ ClearReplies(); Obj=0 // @poff=122
0x159: Pop(0)
0x15a: Push((int) 540303)
0x15b: Push((int) 42476)
0x15c: Push((int) 42284)
0x15d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x15e: Pop(3)
0x15f: Push((int) 540304)
0x160: Push((int) 42478)
0x161: Push((int) 42285)
0x162: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x163: Pop(3)
0x164: Return(); Pop(0)
...
0x169: Stack[-1] = "Neutral" // @poff=144
0x16a: Call2 0xb4

0x16b: Pop(1)
0x16c: Push((int) 540481)
0x16d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x16e: Pop(1)
0x16f: @@@ ClearReplies(); Obj=0 // @poff=122
0x170: Pop(0)
0x171: Push((int) 540482)
0x172: Push((int) -1)
0x173: Push((int) 42479)
0x174: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x175: Pop(3)
0x176: Push((int) 540483)
0x177: Push((int) 42476)
0x178: Push((int) 42480)
0x179: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x17a: Pop(3)
0x17b: Return(); Pop(0)
...
0x180: Stack[-1] = "Fear" // @poff=182
0x181: Call2 0xb4

0x182: Pop(1)
0x183: Push((int) 540480)
0x184: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x185: Pop(1)
0x186: @@@ ClearReplies(); Obj=0 // @poff=122
0x187: Pop(0)
0x188: Push((int) 540484)
0x189: Push((int) -1)
0x18a: Push((int) 42482)
0x18b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x18c: Pop(3)
0x18d: Push((int) 540485)
0x18e: Push((int) 42484)
0x18f: Push((int) 42483)
0x190: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x191: Pop(3)
0x192: Return(); Pop(0)
...
0x197: Stack[-1] = "Fear" // @poff=182
0x198: Call2 0xb4

0x199: Pop(1)
0x19a: Push((int) 540486)
0x19b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x19c: Pop(1)
0x19d: @@@ ClearReplies(); Obj=0 // @poff=122
0x19e: Pop(0)
0x19f: Push((int) 540487)
0x1a0: Push((int) -1)
0x1a1: Push((int) 42485)
0x1a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1a3: Pop(3)
0x1a4: Push((int) 540488)
0x1a5: Push((int) -1)
0x1a6: Push((int) 42486)
0x1a7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1a8: Pop(3)
0x1a9: Return(); Pop(0)
...
0x1ae: Stack[-1] = "Saveyouall" // @poff=89
0x1af: Call2 0xb4

0x1b0: Pop(1)
0x1b1: Push((int) 540284)
0x1b2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1b3: Pop(1)
0x1b4: @@@ ClearReplies(); Obj=0 // @poff=122
0x1b5: Pop(0)
0x1b6: Push((int) 540285)
0x1b7: Push((int) 42266)
0x1b8: Push((int) 42265)
0x1b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1ba: Pop(3)
0x1bb: Push((int) 540489)
0x1bc: Push((int) 42266)
0x1bd: Push((int) 42487)
0x1be: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1bf: Pop(3)
0x1c0: Return(); Pop(0)
...
0x1c5: Stack[-1] = "Saveyouall" // @poff=89
0x1c6: Call2 0xb4

0x1c7: Pop(1)
0x1c8: Push((int) 540286)
0x1c9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1ca: Pop(1)
0x1cb: @@@ ClearReplies(); Obj=0 // @poff=122
0x1cc: Pop(0)
0x1cd: Push((int) 540287)
0x1ce: Push((int) 42268)
0x1cf: Push((int) 42267)
0x1d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1d1: Pop(3)
0x1d2: Push((int) 540295)
0x1d3: Push((int) 42270)
0x1d4: Push((int) 42275)
0x1d5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1d6: Pop(3)
0x1d7: Return(); Pop(0)
...
0x1dc: Stack[-1] = "Smile" // @poff=170
0x1dd: Call2 0xb4

0x1de: Pop(1)
0x1df: Push((int) 540288)
0x1e0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1e1: Pop(1)
0x1e2: @@@ ClearReplies(); Obj=0 // @poff=122
0x1e3: Pop(0)
0x1e4: Push((int) 540289)
0x1e5: Push((int) 42270)
0x1e6: Push((int) 42269)
0x1e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1e8: Pop(3)
0x1e9: Push((int) 540490)
0x1ea: Push((int) 42490)
0x1eb: Push((int) 42489)
0x1ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1ed: Pop(3)
0x1ee: Return(); Pop(0)
...
0x1f3: Stack[-1] = "Sly" // @poff=192
0x1f4: Call2 0xb4

0x1f5: Pop(1)
0x1f6: Push((int) 540491)
0x1f7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x1f8: Pop(1)
0x1f9: @@@ ClearReplies(); Obj=0 // @poff=122
0x1fa: Pop(0)
0x1fb: Push((int) 540492)
0x1fc: Push((int) -1)
0x1fd: Push((int) 42491)
0x1fe: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x1ff: Pop(3)
0x200: Push((int) 540493)
0x201: Push((int) -1)
0x202: Push((int) 42492)
0x203: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x204: Pop(3)
0x205: Return(); Pop(0)
...
0x20a: Stack[-1] = "Smile" // @poff=170
0x20b: Call2 0xb4

0x20c: Pop(1)
0x20d: Push((int) 540290)
0x20e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x20f: Pop(1)
0x210: @@@ ClearReplies(); Obj=0 // @poff=122
0x211: Pop(0)
0x212: Push((int) 540291)
0x213: Push((int) 42272)
0x214: Push((int) 42271)
0x215: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x216: Pop(3)
0x217: Push((int) 540494)
0x218: Push((int) -1)
0x219: Push((int) 42493)
0x21a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x21b: Pop(3)
0x21c: Return(); Pop(0)
...
0x221: Stack[-1] = "Sly" // @poff=192
0x222: Call2 0xb4

0x223: Pop(1)
0x224: Push((int) 540292)
0x225: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x226: Pop(1)
0x227: @@@ ClearReplies(); Obj=0 // @poff=122
0x228: Pop(0)
0x229: Push((int) 540293)
0x22a: Push((int) -1)
0x22b: Push((int) 42273)
0x22c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x22d: Pop(3)
0x22e: Push((int) 540294)
0x22f: Push((int) -1)
0x230: Push((int) 42274)
0x231: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x232: Pop(3)
0x233: Return(); Pop(0)
...
0x280: @@ GetPosition(Stack[-8]); Obj=20 // @poff=232
0x281: Pop(0)
0x282: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=244
0x283: Pop(0)
...
0x2a9: Pop(0)
0x2aa: Push((bool) 1)
0x2ab: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2ac: Pop(1)
0x2ad: Push(CvectorIndex(Stack[-4], 0))
0x2ae: Push(CvectorIndex(Stack[-5], 2))
0x2af: @ Rotate(Stack[-2], Stack[-1])
0x2b0: Pop(2)
...
0x2b6: Push("head") // @poff=258
0x2b7: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2b8: Pop(1)
0x2b9: Push(Stack[-1])
0x2ba: IF (Stack[-1] == 0) GOTO 0x2be; Pop(1)

0x2bb: Push("head") // @poff=258
0x2bc: @ LookAsyncCamera(Stack[-1])
0x2bd: Pop(1)
0x2be: @ CameraWaitForPlayFinish()
0x2bf: Pop(0)
0x2c0: @ ResumeWorld()
0x2c1: Pop(0)
0x2c2: Stack[-21] = (bool) 1
0x2c3: Return(); Pop(18)

0x2c4: PushEmpty(bool, bool)
0x2c5: Push((bool) 1)
0x2c6: @ CameraSwitchToNormal(Stack[-1])
0x2c7: Pop(1)
...
0x2cd: Push("head") // @poff=258
0x2ce: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2cf: Pop(1)
0x2d0: Push(Stack[-1])
0x2d1: IF (Stack[-1] == 0) GOTO 0x2d5; Pop(1)

0x2d2: Push("head") // @poff=258
0x2d3: @ UnlookAsync(Stack[-1])
0x2d4: Pop(1)
0x2d5: Return(); Pop(2)

0x2d6: PushEmpty(int, int, int, int)
0x2d7: Push("voice_common") // @poff=268
0x2d8: @ GetVariable(Stack[-1], Stack[-3])
0x2d9: Pop(1)
0x2da: Push(Stack[-2])
0x2db: IF (Stack[-1] == 0) GOTO 0x2fc; Pop(1)
...
0x2ea: Push((int) 2)
0x2eb: @ irand(Stack[-2], Stack[-1])
0x2ec: Pop(1)
0x2ed: Push(Stack[-1])
0x2ee: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2ef: Push("voice_common") // @poff=268
0x2f0: Push((int) 1)
0x2f1: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2f2: Push((int) 3)
0x2f3: Pop(2); Push(Stack[-2] % Stack[-1]);
0x2f4: @ SetVariable(Stack[-2], Stack[-1])
0x2f5: Pop(2)
0x2f6: GOTO 0x2fb

0x2f7: Push("voice_common") // @poff=268
0x2f8: Push((int) 0)
...
0x308: Stack[-6] = (bool) 0
0x309: Return(); Pop(4)

0x30a: Push("voice_common") // @poff=268
0x30b: Push((int) 1)
0x30c: @ SetVariable(Stack[-2], Stack[-1])
0x30d: Pop(2)
0x30e: Stack[-6] = (bool) 1
0x30f: Return(); Pop(4)

0x310: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x311: Stack[-5] = "c" // @poff=294
0x312: Stack[-4] = (int) 0
0x313: Push((int) 1)
0x314: IF (Stack[-1] == 0) GOTO 0x320; Pop(1)

0x315: Push((int) 1)
0x316: Pop(1); Push(Stack[-5] + Stack[-1]);
0x317: Pop(1); Push(Stack[-6] + Stack[-1]);
0x318: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x319: Pop(1)
0x31a: Pop(0); Push((bool) Stack[-3] == 0)
0x31b: IF (Stack[-1] == 0) GOTO 0x31d; Pop(1)

0x31c: GOTO 0x320

0x31d: Push((int) 1)
0x31e: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x31f: GOTO 0x313

0x320: Pop(0); Push((bool) Stack[-4] == 0)
...
0x324: Stack[-2] = (int) 0
0x325: Push((int) 1)
0x326: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x327: IF (Stack[-1] == 0) GOTO 0x32a; Pop(1)

0x328: @ irand(Stack[-2], Stack[-4])
0x329: Pop(0)
0x32a: Push((int) 1)
0x32b: Pop(1); Push(Stack[-3] + Stack[-1]);
0x32c: Pop(1); Push(Stack[-6] + Stack[-1]);
0x32d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=310
0x32e: Pop(1)
0x32f: PushEmpty(bool, string)
0x330: Stack[-3] = Stack[-1]
0x331: Call2 0x37f

0x332: Stack[-2] = Stack[-14]
0x333: Pop(2)
0x334: Return(); Pop(10)

0x335: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x336: Push("d") // @poff=264
0x337: PushEmpty(int)
0x338: Call2 0x3aa

0x339: Pop(0)
0x33a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x33b: Push("m") // @poff=322
...
0x343: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=298
0x344: Pop(1)
...
0x358: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=310
0x359: Pop(1)
...
0x360: PushEmpty(bool, float, float, bool, float, float)
0x361: @ lshHasAnimation(Stack[-3], Stack[-7])
0x362: Pop(0)
0x363: Push(Stack[-3])
0x364: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x365: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x366: Pop(0)
0x367: Push((bool) 0)
0x368: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x369: Pop(1)
0x36a: GOTO 0x36f

0x36b: Push("Can't find lsh animation : ") // @poff=326
0x36c: Pop(1); Push(Stack[-1] + Stack[-8]);
0x36d: @ Trace(Stack[-1])
0x36e: Pop(1)
0x36f: Return(); Pop(6)

0x370: PushEmpty(bool, float, float, bool, float, float)
0x371: @ lshHasAnimation(Stack[-3], Stack[-8])
0x372: Pop(0)
0x373: Push(Stack[-3])
0x374: IF (Stack[-1] == 0) GOTO 0x37a; Pop(1)

0x375: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x376: Pop(0)
0x377: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x378: Pop(0)
0x379: GOTO 0x37e

0x37a: Push("Can't find lsh animation : ") // @poff=326
0x37b: Pop(1); Push(Stack[-1] + Stack[-9]);
0x37c: @ Trace(Stack[-1])
0x37d: Pop(1)
0x37e: Return(); Pop(6)
...
0x384: @ lshHasSpeech(Stack[-1], Stack[-3])
0x385: Pop(0)
0x386: Push(Stack[-1])
0x387: IF (Stack[-1] == 0) GOTO 0x38c; Pop(1)

0x388: @ lshPlaySpeech(Stack[-3])
0x389: Pop(0)
0x38a: Stack[-4] = (bool) 1
0x38b: Return(); Pop(2)

0x38c: Stack[-4] = (bool) 0
0x38d: Return(); Pop(2)
...
0x39c: Pop(0); Push(Stack[-3] | Stack[-3]);
0x39d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x39e: Push((float)9.999999974752427e-07)
0x39f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3a0: IF (Stack[-1] == 0) GOTO 0x3a3; Pop(1)

0x3a1: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3a2: Return(); Pop(2)

0x3a3: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3a4: Return(); Pop(2)

0x3a5: PushEmpty(int, int)
0x3a6: @ GetVariable(Stack[-3], Stack[-1])
0x3a7: Pop(0)
0x3a8: Stack[-1] = Stack[-4]
0x3a9: Return(); Pop(2)

0x3aa: PushEmpty(float, float)
0x3ab: @ GetGameTime(Stack[-1])
0x3ac: Pop(0)
0x3ad: Push((int) 1)
0x3ae: PushEmpty(int)
0x3af: Push((int) 24)
0x3b0: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x3b1: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x3b2: Return(); Pop(2)

0x3b3: PushEmpty()
0x3b4: Push("ood12KlaraSobor1") // @poff=382
0x3b5: Push((int) 1)
0x3b6: @ SetVariable(Stack[-2], Stack[-1])
0x3b7: Pop(2)
0x3b8: Return(); Pop(0)

0x3b9: PushEmpty()
0x3ba: Push("ood12KlaraSobor2") // @poff=416
0x3bb: Push((int) 1)
...
0x3c1: Stack[-1] = "game_final" // @poff=450
0x3c2: Call2 0x3a5
...
0x3cd: Stack[-1] = "ood12KlaraSobor1" // @poff=382
0x3ce: Call2 0x3a5
...
0x3d7: PushEmpty()
0x3d8: PushEmpty(int, string)
0x3d9: Stack[-1] = "ood12KlaraSobor2" // @poff=416
0x3da: Call2 0x3a5

0x3db: Pop(1)
0x3dc: Push((int) 0)
0x3dd: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x3de: IF (Stack[-1] == 0) GOTO 0x3e1; Pop(1)

0x3df: Stack[-2] = (bool) 1
0x3e0: Return(); Pop(0)

0x3e1: Stack[-2] = (bool) 0
0x3e2: Return(); Pop(0)

0x3e3: PushEmpty(int, int)
0x3e4: Push("branch") // @poff=472
...
0x3f4: Stack[-1] = (int) 515540
0x3f5: Return(); Pop(0)

0x3f6: Stack[-1] = (int) 502865
0x3f7: Return(); Pop(0)

0x3f8: Stack[-1] = "ui/NPC_Klara.png" // @poff=486
0x3f9: Return(); Pop(0)

0x3fa: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=520
0x3fb: Return(); Pop(0)
