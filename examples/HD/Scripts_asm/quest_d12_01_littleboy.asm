...
// @pool_raw:
// @pool_encoding:utf8
...
0x2e1: Push("player") // @poff=172
0x2e2: @ FindActor(Stack[-4]T, Stack[-1])
0x2e3: Pop(1)
...
0x2f6: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x381: Pop(0)
0x382: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x383: Pop(0)
...
0x38d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x38e: Pop(0)
0x38f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x390: Pop(0)
...
0x3b6: Pop(0)
0x3b7: Push((bool) 1)
0x3b8: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x3b9: Pop(1)
0x3ba: Push(CvectorIndex(Stack[-4], 0))
0x3bb: Push(CvectorIndex(Stack[-5], 2))
...
0x3c3: Push("head") // @poff=186
0x3c4: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3c5: Pop(1)
0x3c6: Push(Stack[-1])
0x3c7: IF (Stack[-1] == 0) GOTO 0x3cb; Pop(1)

0x3c8: Push("head") // @poff=186
0x3c9: @ LookAsyncCamera(Stack[-1])
0x3ca: Pop(1)
0x3cb: @ CameraWaitForPlayFinish()
0x3cc: Pop(0)
0x3cd: @ ResumeWorld()
0x3ce: Pop(0)
0x3cf: Stack[-21] = (bool) 1
0x3d0: Return(); Pop(18)

0x3d1: PushEmpty(bool, bool)
0x3d2: Push((bool) 1)
0x3d3: @ CameraSwitchToNormal(Stack[-1])
0x3d4: Pop(1)
...
0x3da: Push("head") // @poff=186
0x3db: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3dc: Pop(1)
0x3dd: Push(Stack[-1])
0x3de: IF (Stack[-1] == 0) GOTO 0x3e2; Pop(1)

0x3df: Push("head") // @poff=186
0x3e0: @ UnlookAsync(Stack[-1])
0x3e1: Pop(1)
0x3e2: Return(); Pop(2)

0x3e3: PushEmpty(bool, float, float, bool, float, float)
0x3e4: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3e5: Pop(0)
0x3e6: Push(Stack[-3])
0x3e7: IF (Stack[-1] == 0) GOTO 0x3ee; Pop(1)

0x3e8: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3e9: Pop(0)
0x3ea: Push((bool) 0)
...
0x3ee: Push("Can't find lsh animation : ") // @poff=222
0x3ef: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3f0: @ Trace(Stack[-1])
0x3f1: Pop(1)
0x3f2: Return(); Pop(6)

0x3f3: PushEmpty(bool, float, float, bool, float, float)
0x3f4: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3f5: Pop(0)
0x3f6: Push(Stack[-3])
0x3f7: IF (Stack[-1] == 0) GOTO 0x3fd; Pop(1)

0x3f8: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3f9: Pop(0)
0x3fa: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3fb: Pop(0)
0x3fc: GOTO 0x401

0x3fd: Push("Can't find lsh animation : ") // @poff=222
0x3fe: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3ff: @ Trace(Stack[-1])
0x400: Pop(1)
0x401: Return(); Pop(6)

0x402: PushEmpty(float, cvector, float, cvector)
0x403: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x404: Pop(0)
...
0x409: Push("head") // @poff=186
0x40a: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x40b: Pop(1)
0x40c: Return(); Pop(4)
...
0x419: Stack[-1] = 0
0x41a: PushEmpty(float, float)
0x41b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x41c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x41d: Push((float)9.999999974752427e-07)
0x41e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x41f: IF (Stack[-1] == 0) GOTO 0x422; Pop(1)

0x420: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x421: Return(); Pop(2)

0x422: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x423: Return(); Pop(2)

0x424: PushEmpty(int, int)
0x425: @ GetVariable(Stack[-3], Stack[-1])
0x426: Pop(0)
...
0x42b: Stack[-1] = "D_Mission5" // @poff=278
0x42c: Call2 0x424

0x42d: Pop(1)
0x42e: Push((int) 0)
0x42f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x430: IF (Stack[-1] == 0) GOTO 0x448; Pop(1)

0x431: Push("D_Mission5") // @poff=278
0x432: Push((int) 1)
...
0x437: Pop(0)
0x438: PushEmpty(bool, int)
0x439: Stack[-1] = (int) 30
0x43a: Call2 0x4a3

0x43b: Pop(2)
0x43c: PushEmpty(bool, int)
0x43d: Stack[-1] = (int) 3
0x43e: Call2 0x4a3

0x43f: Pop(2)
0x440: PushEmpty(bool, int)
0x441: Stack[-1] = (int) 4
0x442: Call2 0x4a3

0x443: Pop(2)
0x444: PushEmpty(bool, int)
0x445: Stack[-1] = (int) 5
0x446: Call2 0x4a3
...
0x449: PushEmpty()
0x44a: Push("ood12Littleboy1") // @poff=300
0x44b: Push((int) 1)
...
0x44f: PushEmpty()
0x450: Push("ood12Littleboy2") // @poff=332
0x451: Push((int) 1)
0x452: @ SetVariable(Stack[-2], Stack[-1])
0x453: Pop(2)
0x454: Return(); Pop(0)

0x455: PushEmpty()
0x456: PushEmpty(int, string)
0x457: Stack[-1] = "ood12Littleboy1" // @poff=300
0x458: Call2 0x424
...
0x45d: Stack[-2] = (bool) 1
0x45e: Return(); Pop(0)

0x45f: Stack[-2] = (bool) 0
0x460: Return(); Pop(0)

0x461: PushEmpty()
0x462: PushEmpty(int, string)
0x463: Stack[-1] = "ood12Littleboy2" // @poff=332
0x464: Call2 0x424
...
0x47f: Push("Can't retrieve diary root") // @poff=364
0x480: @ Trace(Stack[-1])
0x481: Pop(1)
...
0x48b: Pop(1)
0x48c: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=416
0x48d: Pop(0)
0x48e: Pop(0); Push((bool) Stack[-2] == 0)
0x48f: IF (Stack[-1] == 0) GOTO 0x496; Pop(1)

0x490: Push("Can't find diary parent with id: ") // @poff=421
...
0x496: @@ AddChild(Stack[-8]); Obj=2 // @poff=489
0x497: Pop(0)
0x498: Push((int) 7)
0x499: @ SendWorldWndMessage(Stack[-1])
0x49a: Pop(1)
0x49b: @@ GetCategory(Stack[-1]); Obj=8 // @poff=498
0x49c: Pop(0)
...
0x4a1: Stack[-2] = 0
0x4a2: Stack[-3] = 0
0x4a3: PushEmpty(object, object, object, object)
0x4a4: PushEmpty(object)
0x4a5: Call2 0x47a

0x4a6: Stack[-1] = Stack[-3]
0x4a7: Pop(1)
0x4a8: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=416
0x4a9: Pop(0)
0x4aa: Pop(0); Push((bool) Stack[-1] == 0)
0x4ab: IF (Stack[-1] == 0) GOTO 0x4ae; Pop(1)

0x4ac: Stack[-6] = (bool) 0
0x4ad: Return(); Pop(4)

0x4ae: @@ Remove(); Obj=1 // @poff=510
0x4af: Pop(0)
0x4b0: Stack[-6] = (bool) 1
0x4b1: Return(); Pop(4)

0x4b2: Stack[-1] = 0
0x4b3: Stack[-2] = 0
0x4b4: PushEmpty(int, int)
0x4b5: Push("branch") // @poff=517
0x4b6: @ GetVariable(Stack[-1], Stack[-2])
0x4b7: Pop(1)
0x4b8: Push((int) 0)
...
0x4c5: Stack[-1] = (int) 515560
0x4c6: Return(); Pop(0)

0x4c7: Stack[-1] = (int) 503345
0x4c8: Return(); Pop(0)

0x4c9: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=531
0x4ca: Return(); Pop(0)

0x4cb: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=571
0x4cc: Return(); Pop(0)

0x4cd: Stack[-1] = (bool) 0
0x4ce: Return(); Pop(0)

0x4cf: PushEmpty(string, string)
0x4d0: Stack[-1] = "idle" // @poff=146
0x4d1: Push(Stack[-3])
0x4d2: IF (Stack[-1] == 0) GOTO 0x4d4; Pop(1)

0x4d3: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x4d4: Stack[-1] = Stack[-4]
0x4d5: Return(); Pop(2)

0x4d6: PushEmpty(int, bool, int, bool)
0x4d7: Stack[-2] = (int) 0
...
0x4dc: Pop(1)
0x4dd: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x4de: Pop(2)
...
0x4e2: Push((int) 1)
0x4e3: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x4e4: GOTO 0x4d8
