...
// @pool_raw:
// @pool_encoding:utf8
...
0x1a2: Stack[-8] = Stack[-2]
0x1a3: Stack[-7] = Stack[-1]
0x1a4: Call2 0x1dc
...
0x1e3: Push("player") // @poff=172
0x1e4: @ FindActor(Stack[-4]T, Stack[-1])
0x1e5: Pop(1)
...
0x1f8: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x24d: Pop(0)
0x24e: Push("all") // @poff=138
0x24f: PushEmpty(string, int)
0x250: Stack[-7] = Stack[-1]
0x251: Call2 0x3d1
...
0x283: Pop(0)
0x284: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x285: Pop(0)
...
0x28f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x290: Pop(0)
0x291: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x292: Pop(0)
...
0x2b8: Pop(0)
0x2b9: Push((bool) 1)
0x2ba: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2bb: Pop(1)
0x2bc: Push(CvectorIndex(Stack[-4], 0))
0x2bd: Push(CvectorIndex(Stack[-5], 2))
0x2be: @ Rotate(Stack[-2], Stack[-1])
0x2bf: Pop(2)
...
0x2cb: @ LookAsyncCamera(Stack[-1])
0x2cc: Pop(1)
0x2cd: @ CameraWaitForPlayFinish()
0x2ce: Pop(0)
0x2cf: @ ResumeWorld()
0x2d0: Pop(0)
0x2d1: Stack[-21] = (bool) 1
0x2d2: Return(); Pop(18)

0x2d3: PushEmpty(bool, bool)
0x2d4: Push((bool) 1)
0x2d5: @ CameraSwitchToNormal(Stack[-1])
0x2d6: Pop(1)
...
0x2dc: Push("head") // @poff=186
0x2dd: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2de: Pop(1)
0x2df: Push(Stack[-1])
0x2e0: IF (Stack[-1] == 0) GOTO 0x2e4; Pop(1)

0x2e1: Push("head") // @poff=186
0x2e2: @ UnlookAsync(Stack[-1])
0x2e3: Pop(1)
0x2e4: Return(); Pop(2)

0x2e5: PushEmpty(bool, float, float, bool, float, float)
0x2e6: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2e7: Pop(0)
0x2e8: Push(Stack[-3])
0x2e9: IF (Stack[-1] == 0) GOTO 0x2f0; Pop(1)

0x2ea: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2eb: Pop(0)
0x2ec: Push((bool) 0)
...
0x2f0: Push("Can't find lsh animation : ") // @poff=222
0x2f1: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2f2: @ Trace(Stack[-1])
0x2f3: Pop(1)
0x2f4: Return(); Pop(6)

0x2f5: PushEmpty(bool, float, float, bool, float, float)
0x2f6: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2f7: Pop(0)
0x2f8: Push(Stack[-3])
0x2f9: IF (Stack[-1] == 0) GOTO 0x2ff; Pop(1)

0x2fa: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2fb: Pop(0)
0x2fc: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2fd: Pop(0)
0x2fe: GOTO 0x303

0x2ff: Push("Can't find lsh animation : ") // @poff=222
0x300: Pop(1); Push(Stack[-1] + Stack[-9]);
0x301: @ Trace(Stack[-1])
0x302: Pop(1)
0x303: Return(); Pop(6)

0x304: PushEmpty(float, cvector, float, cvector)
0x305: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x306: Pop(0)
0x307: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x308: Push(CvectorIndex(Stack[-1], 1))
0x309: Stack[-3] = Stack[-1]
0x30a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x30b: Push("head") // @poff=186
0x30c: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x30d: Pop(1)
0x30e: Return(); Pop(4)
...
0x322: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x323: Return(); Pop(2)
...
0x32b: PushEmpty()
0x32c: Push("ood12Littlegirl2") // @poff=278
0x32d: Push((int) 1)
0x32e: @ SetVariable(Stack[-2], Stack[-1])
0x32f: Pop(2)
0x330: Return(); Pop(0)

0x331: PushEmpty()
0x332: PushEmpty(int, string)
0x333: Stack[-1] = "D_Mission5" // @poff=312
0x334: Call2 0x326

0x335: Pop(1)
0x336: Push((int) 0)
0x337: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x338: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x339: Push("D_Mission5") // @poff=312
0x33a: Push((int) 1)
...
0x33f: Pop(0)
0x340: PushEmpty(bool, int)
0x341: Stack[-1] = (int) 30
0x342: Call2 0x3a5

0x343: Pop(2)
0x344: PushEmpty(bool, int)
0x345: Stack[-1] = (int) 3
0x346: Call2 0x3a5

0x347: Pop(2)
0x348: PushEmpty(bool, int)
0x349: Stack[-1] = (int) 4
0x34a: Call2 0x3a5

0x34b: Pop(2)
0x34c: PushEmpty(bool, int)
0x34d: Stack[-1] = (int) 5
0x34e: Call2 0x3a5
...
0x351: PushEmpty()
0x352: Push("ood12Littlegirl1") // @poff=334
0x353: Push((int) 1)
...
0x359: Stack[-1] = "ood12Littlegirl2" // @poff=278
0x35a: Call2 0x326
...
0x365: Stack[-1] = "ood12Littlegirl1" // @poff=334
0x366: Call2 0x326
...
0x381: Push("Can't retrieve diary root") // @poff=368
0x382: @ Trace(Stack[-1])
0x383: Pop(1)
...
0x38d: Pop(1)
0x38e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=420
0x38f: Pop(0)
0x390: Pop(0); Push((bool) Stack[-2] == 0)
0x391: IF (Stack[-1] == 0) GOTO 0x398; Pop(1)

0x392: Push("Can't find diary parent with id: ") // @poff=425
...
0x398: @@ AddChild(Stack[-8]); Obj=2 // @poff=493
0x399: Pop(0)
0x39a: Push((int) 7)
0x39b: @ SendWorldWndMessage(Stack[-1])
0x39c: Pop(1)
0x39d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=502
0x39e: Pop(0)
...
0x3a3: Stack[-2] = 0
0x3a4: Stack[-3] = 0
0x3a5: PushEmpty(object, object, object, object)
0x3a6: PushEmpty(object)
0x3a7: Call2 0x37c

0x3a8: Stack[-1] = Stack[-3]
0x3a9: Pop(1)
0x3aa: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=420
0x3ab: Pop(0)
...
0x3b4: Stack[-1] = 0
0x3b5: Stack[-2] = 0
0x3b6: PushEmpty(int, int)
0x3b7: Push("branch") // @poff=521
0x3b8: @ GetVariable(Stack[-1], Stack[-2])
0x3b9: Pop(1)
0x3ba: Push((int) 0)
...
0x3c7: Stack[-1] = (int) 515561
0x3c8: Return(); Pop(0)

0x3c9: Stack[-1] = (int) 503346
0x3ca: Return(); Pop(0)

0x3cb: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=535
0x3cc: Return(); Pop(0)

0x3cd: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=575
0x3ce: Return(); Pop(0)

0x3cf: Stack[-1] = (bool) 0
0x3d0: Return(); Pop(0)

0x3d1: PushEmpty(string, string)
0x3d2: Stack[-1] = "idle" // @poff=146
0x3d3: Push(Stack[-3])
0x3d4: IF (Stack[-1] == 0) GOTO 0x3d6; Pop(1)

0x3d5: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3d6: Stack[-1] = Stack[-4]
0x3d7: Return(); Pop(2)

0x3d8: PushEmpty(int, bool, int, bool)
0x3d9: Stack[-2] = (int) 0
0x3da: Push("all") // @poff=138
0x3db: PushEmpty(string, int)
0x3dc: Stack[-5] = Stack[-1]
0x3dd: Call2 0x3d1

0x3de: Pop(1)
0x3df: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3e0: Pop(2)
