...
// @pool_raw:
// @pool_encoding:utf8
...
0x154: Stack[-1] = "Staring" // @poff=156
0x155: Call2 0x90
...
0x1b3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=204
0x1b4: Pop(0)
0x1b5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=216
0x1b6: Pop(0)
...
0x222: Push("voice_common") // @poff=240
0x223: Push((int) 1)
...
0x22a: Push("voice_common") // @poff=240
0x22b: Push((int) 0)
...
0x23d: Push("voice_common") // @poff=240
0x23e: Push((int) 1)
...
0x24b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=270
0x24c: Pop(1)
...
0x276: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=270
0x277: Pop(1)
...
0x28b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=282
0x28c: Pop(1)
0x28d: PushEmpty(bool, string)
0x28e: Stack[-3] = Stack[-1]
0x28f: Call2 0x2b2

0x290: Stack[-2] = Stack[-14]
0x291: Pop(2)
0x292: Return(); Pop(10)
...
0x29e: Push("Can't find lsh animation : ") // @poff=298
...
0x2ad: Push("Can't find lsh animation : ") // @poff=298
...
0x2e6: PushEmpty()
0x2e7: Push("ood12MariaSobor1") // @poff=354
0x2e8: Push((int) 1)
...
0x2ee: Stack[-1] = "ood12MariaSobor1" // @poff=354
0x2ef: Call2 0x2d8
...
0x30d: Stack[-1] = "ui/NPC_Maria.png" // @poff=402
0x30e: Return(); Pop(0)

0x30f: Stack[-1] = "ui/NPC_Maria_b.png" // @poff=436
0x310: Return(); Pop(0)
