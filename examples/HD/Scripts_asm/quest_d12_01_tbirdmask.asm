...
// @pool_raw:
// @pool_encoding:utf8
...
0x2aa: Pop(0)
0x2ab: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x2ac: Pop(0)
...
0x2b6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x2b7: Pop(0)
0x2b8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x2b9: Pop(0)
...
0x317: Push("Can't find lsh animation : ") // @poff=222
...
0x326: Push("Can't find lsh animation : ") // @poff=222
...
0x32c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x32d: Pop(0)
...
0x346: Push((float)9.999999974752427e-07)
...
0x357: Push("Door ") // @poff=278
0x358: Pop(1); Push(Stack[-1] + Stack[-5]);
0x359: Push(" not found") // @poff=290
0x35a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x35b: @ Trace(Stack[-1])
0x35c: Pop(1)
0x35d: GOTO 0x361

0x35e: Push("locked") // @poff=312
0x35f: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x360: Pop(1)
0x361: Return(); Pop(2)
...
0x37d: Stack[-2] = "itheater@door1" // @poff=338
...
0x382: PushEmpty()
0x383: Push("ood12TBirdmask1") // @poff=368
0x384: Push((int) 1)
...
0x38a: Stack[-1] = "ood12TBirdmask1" // @poff=368
0x38b: Call2 0x34d
...
0x3a9: Stack[-1] = "ui/NPC_bmask.png" // @poff=414
0x3aa: Return(); Pop(0)

0x3ab: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=448
0x3ac: Return(); Pop(0)
