...
// @pool_raw:
// @pool_encoding:utf8
...
0x257: Push("player") // @poff=172
0x258: @ FindActor(Stack[-4]T, Stack[-1])
0x259: Pop(1)
...
0x26c: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2f7: Pop(0)
0x2f8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x2f9: Pop(0)
...
0x303: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x304: Pop(0)
0x305: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x306: Pop(0)
...
0x364: Push("Can't find lsh animation : ") // @poff=222
...
0x373: Push("Can't find lsh animation : ") // @poff=222
...
0x379: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x37a: Pop(0)
...
0x3a4: Push("Door ") // @poff=278
0x3a5: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3a6: Push(" not found") // @poff=290
0x3a7: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3a8: @ Trace(Stack[-1])
0x3a9: Pop(1)
0x3aa: GOTO 0x3ae

0x3ab: Push("locked") // @poff=312
0x3ac: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x3ad: Pop(1)
0x3ae: Return(); Pop(2)

0x3af: Stack[-1] = 0
0x3b0: PushEmpty(string, string)
0x3b1: Stack[-1] = "idle" // @poff=146
0x3b2: Push(Stack[-3])
...
0x3c6: Stack[-2] = Stack[-5]
0x3c7: Return(); Pop(4)

0x3c8: PushEmpty()
0x3c9: PushEmpty(string, bool)
0x3ca: Stack[-2] = "itheater@door1" // @poff=338
...
0x3cf: PushEmpty()
0x3d0: Push("ood12Whitemask1") // @poff=368
0x3d1: Push((int) 1)
...
0x3d5: PushEmpty()
0x3d6: Push("ood12Whitemask2") // @poff=400
0x3d7: Push((int) 1)
...
0x3dd: Stack[-1] = "ood12Whitemask1" // @poff=368
0x3de: Call2 0x39a
...
0x3e9: Stack[-1] = "ood12Whitemask2" // @poff=400
0x3ea: Call2 0x39a
...
0x408: Stack[-1] = "ui/NPC_wmask.png" // @poff=446
0x409: Return(); Pop(0)

0x40a: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=480
0x40b: Return(); Pop(0)
