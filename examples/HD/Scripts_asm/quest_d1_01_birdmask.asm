...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x232: Push("Can't find lsh animation : ") // @poff=286
...
0x241: Push("Can't find lsh animation : ") // @poff=286
...
0x250: Push((float)9.999999974752427e-07)
...
0x259: Pop(0)
0x25a: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x27f: Stack[-1] = "ui/NPC_bmask.png" // @poff=342
0x280: Return(); Pop(0)

0x281: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=376
0x282: Return(); Pop(0)
