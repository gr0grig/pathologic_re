...
Strings:
	...
	W:branch
	W:ui/NPC_Morlok.png
	W:ui/NPC_Morlok_b.png
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x870 Vars = (object, int, float, float)
EVENT_43 Op = 0x878 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x882 Vars = (object, string)
EVENT_41 Op = 0x88f Vars = (object)
...
0x1a2: PushEmpty()
0x1a3: Stack[-3] = (float) 0.10000000149011612
0x1a4: Return(); Pop(0)
...
0x1bd: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1be: Pop(0)
0x1bf: Push(Stack[-8])
0x1c0: IF (Stack[-1] == 0) GOTO 0x1c9; Pop(1)

0x1c1: Push("attack") // @poff=180
...
0x1dd: Pop(0)
0x1de: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=266
0x1df: Pop(0)
...
0x1f9: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=266
0x1fa: Pop(0)
...
0x213: Pop(1)
0x214: Push("all") // @poff=138
0x215: Push("attack_on") // @poff=280
...
0x22d: IF (Stack[-1] == 1) GOTO 0x233; Pop(1)

0x22e: PushEmpty(bool)
0x22f: Call2 0x3ff

0x230: Pop(0)
0x231: IF (Stack[-1] == 1) GOTO 0x233; Pop(1)

0x232: Stack[-1] = (bool) 0
0x233: IF (Stack[-1] == 0) GOTO 0x244; Pop(1)

0x234: @ Face(Stack[-0]T)
0x235: Pop(0)
0x236: PushEmpty()
0x237: Call2 0x431

0x238: Pop(0)
0x239: Push("all") // @poff=138
0x23a: Push("attack_stay") // @poff=300
0x23b: @ PlayAnimation(Stack[-2], Stack[-1])
0x23c: Pop(2)
0x23d: PushEmpty(bool, float)
0x23e: Stack[-25] = Stack[-1]
0x23f: Call2 0x37b
...
0x244: @ Face(Stack[-0]T)
0x245: Pop(0)
0x246: Push("all") // @poff=138
0x247: Push("fjump") // @poff=324
...
0x262: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=266
0x263: Pop(0)
...
0x282: Push("attack_off") // @poff=336
...
0x290: Push("attack_begin") // @poff=358
0x291: Push((int) 1)
0x292: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x29d: Push("attack") // @poff=180
0x29e: Push((int) 1)
0x29f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2a9: Push("all") // @poff=138
0x2aa: Push("bjump") // @poff=384
...
0x2b1: Push((float)0.8999999761581421)
0x2b2: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2b3: @ GetVictim(Stack[-1], Stack[-4])
0x2b4: Pop(1)
0x2b5: @ ReportAttack(Stack[-0]T)
0x2b6: Pop(0)
...
0x2bb: Stack[-10] = Stack[-1]
0x2bc: Call2 0x1a2

0x2bd: Stack[-3] = Stack[-5]
0x2be: Pop(3)
0x2bf: PushEmpty(float, object, float, int)
0x2c0: Stack[-7] = Stack[-3]
0x2c1: Stack[-6] = Stack[-2]
0x2c2: PushEmpty(int, object, int)
0x2c3: Stack[-10] = Stack[-2]
0x2c4: Stack[-14] = Stack[-1]
0x2c5: Call2 0x1a5

0x2c6: Stack[-3] = Stack[-4]
0x2c7: Pop(3)
0x2c8: Call2 0x5ff

0x2c9: Stack[-4] = Stack[-5]
0x2ca: Pop(4)
0x2cb: PushEmpty(int)
0x2cc: Call2 0x42f

0x2cd: Pop(0)
0x2ce: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2cf: Pop(1)
0x2d0: PushEmpty(object, float)
0x2d1: Stack[-5] = Stack[-2]
...
0x2da: Pop(0)
0x2db: @ irand(Stack[-4], Stack[-1]T)
0x2dc: Pop(0)
0x2dd: Push((int) 1)
0x2de: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x2df: @ Face(Stack[-0]T)
0x2e0: Pop(0)
0x2e1: Push((bool) 1)
...
0x2e6: Pop(0)
0x2e7: Push("all") // @poff=138
0x2e8: Push("attack_begin") // @poff=358
...
0x301: Push("attack_middle") // @poff=396
...
0x309: Pop(0)
0x30a: Push("all") // @poff=138
0x30b: Push("attack_middle") // @poff=396
...
0x31f: Stack[-11] = Stack[-2]
0x320: Stack[-6] = Stack[-1]
0x321: Call2 0x2b0

0x322: Pop(2)
0x323: Stack[-2] = (int) 1
0x324: Push("attack_middle") // @poff=396
0x325: Pop(1); Push(Stack[-1] + Stack[-5]);
0x326: Push("_") // @poff=424
...
0x345: Stack[-11] = Stack[-2]
0x346: Stack[-6] = Stack[-1]
0x347: Call2 0x2b0
...
0x350: Push("attack_end") // @poff=428
...
0x38f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=266
0x390: Pop(0)
...
0x3db: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x3dc: Pop(1)
...
0x3e0: @ Face(Stack[-0]T)
0x3e1: Pop(0)
0x3e2: Push("all") // @poff=138
0x3e3: Push("bjump") // @poff=384
0x3e4: @ PlayAnimation(Stack[-2], Stack[-1])
0x3e5: Pop(2)
0x3e6: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=266
0x3e7: Pop(0)
...
0x41d: @ irand(Stack[-1], Stack[-2]T)
0x41e: Pop(0)
0x41f: Push((int) 1)
0x420: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x421: Push("attack") // @poff=180
...
0x432: Stack[-1] = "attack_stay" // @poff=300
0x433: Call2 0x79f
...
0x45d: Stack[-15] = Stack[-5]
0x45e: Stack[-14] = Stack[-4]
0x45f: Stack[-13] = Stack[-3]
0x460: Stack[-12] = Stack[-2]
0x461: Stack[-11] = Stack[-1]
0x462: Call2 0x4a7

0x463: Stack[-6] = Stack[-7]
0x464: Pop(6)
0x465: Push( Stack[2 + Tasks[-1].StackPointer] )
0x466: IF (Stack[-1] == 0) GOTO 0x46a; Pop(1)

0x467: Push("head") // @poff=486
0x468: @ UnlookAsync(Stack[-1])
0x469: Pop(1)
0x46a: Push((int) 1)
0x46b: @ KillTimer(Stack[-1])
0x46c: Pop(1)
0x46d: Stack[-1] = Stack[-10]
0x46e: Return(); Pop(4)
...
0x4aa: Stack[-17] = Stack[-7]
0x4ab: PushEmpty(bool, object)
0x4ac: Stack[-23] = Stack[-1]
0x4ad: Call2 0x533
...
0x4b3: @@ GetPosition(Stack[-5]); Obj=21 // @poff=496
0x4b4: Pop(0)
...
0x4ca: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=266
0x4cb: Pop(0)
...
0x4dc: Push((int) 0)
0x4dd: Push((float)0.30000001192092896)
...
0x4ff: Push((int) 0)
0x500: Push((float)0.30000001192092896)
...
0x537: Stack[-2] = Stack[-4]
0x538: Pop(2)
0x539: Return(); Pop(0)

0x53a: Stack[-1] = "walk" // @poff=508
0x53b: Return(); Pop(0)

0x53c: Stack[-1] = "run" // @poff=518
0x53d: Return(); Pop(0)
...
0x55b: Stack[-1] = "fdie" // @poff=526
0x55c: Call2 0x5b2

0x55d: Pop(1)
0x55e: GOTO 0x5b1

0x55f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=496
0x560: Pop(0)
...
0x570: Stack[-6] = "fdie" // @poff=526
0x571: GOTO 0x573

0x572: Stack[-6] = "bdie" // @poff=536
...
0x5a6: @ StopAsync()
0x5a7: Pop(0)
0x5a8: Push("head") // @poff=486
0x5a9: @ UnlookAsync(Stack[-1])
0x5aa: Pop(1)
0x5ab: Push("all") // @poff=138
...
0x5f4: Push("HasProperty") // @poff=722
0x5f5: Push((int) 2)
...
0x5fb: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=746
0x5fc: Pop(0)
...
0x601: Stack[-18] = Stack[-2]
0x602: Stack[-1] = "health" // @poff=758
0x603: Call2 0x5f3
...
0x60a: Stack[-18] = Stack[-2]
0x60b: Stack[-1] = "armor" // @poff=772
0x60c: Call2 0x5f3
...
0x612: Push("armor") // @poff=772
0x613: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=784
0x614: Pop(1)
0x615: Push("armor_") // @poff=796
0x616: PushEmpty(string, int)
0x617: Stack[-16] = Stack[-1]
0x618: Call2 0x5d2

0x619: Pop(1)
0x61a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x61b: PushEmpty(bool, object, string)
0x61c: Stack[-18] = Stack[-2]
0x61d: Stack[-8] = Stack[-1]
0x61e: Call2 0x5f3
...
0x624: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=784
0x625: Pop(0)
...
0x62c: Stack[-3] = Stack[-6]
0x62d: Pop(3)
0x62e: Push("health") // @poff=758
0x62f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=784
0x630: Pop(1)
0x631: Push((int) 1)
0x632: Pop(1); Push(Stack[-1] - Stack[-4]);
0x633: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x634: Push("health") // @poff=758
...
0x63a: Pop(3)
0x63b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=810
0x63c: Pop(2)
0x63d: PushEmpty(bool, object)
0x63e: Stack[-17] = Stack[-1]
0x63f: Call2 0x5ee
...
0x645: Pop(1)
0x646: Stack[-1] = Stack[-16]
0x647: Return(); Pop(12)

0x648: PushEmpty(bool, bool)
0x649: @@ IsDead(Stack[-1]); Obj=3 // @poff=822
0x64a: Pop(0)
0x64b: Stack[-1] = Stack[-4]
0x64c: Return(); Pop(2)

0x64d: PushEmpty(object, object, object, object)
0x64e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x662: Pop(0)
0x663: Pop(0); PushNull((bool) Stack[-2] == 0)
0x664: IF (Stack[-1] == 0) GOTO 0x667; Pop(1)

0x665: Stack[-6] = (bool) 0
0x666: Return(); Pop(4)

0x667: @@ GetScene(Stack[-1]); Obj=5 // @poff=843
0x668: Pop(0)
...
0x67b: Stack[-6] = Stack[-2]
0x67c: Stack[-1] = "noaccess" // @poff=852
0x67d: Call2 0x5f3
...
0x683: Push("noaccess") // @poff=852
0x684: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=784
0x685: Pop(1)
0x686: Push((int) 0)
...
0x68a: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x698: @@ GetPosition(Stack[-5]); Obj=15 // @poff=496
0x699: Pop(0)
...
0x6a9: Stack[-1] = "fhit" // @poff=870
0x6aa: GOTO 0x6ac

0x6ab: Stack[-1] = "bhit" // @poff=880
0x6ac: Push("hit_react") // @poff=890
0x6ad: Push("1") // @poff=176
0x6ae: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6af: Push("2") // @poff=910
...
0x6e7: Pop(0)
0x6e8: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=923
0x6e9: Pop(0)
0x6ea: PushEmpty(object, int, float, cvector, cvector)
0x6eb: Stack[-26] = Stack[-5]
0x6ec: Stack[-25] = Stack[-4]
0x6ed: Stack[-24] = Stack[-3]
0x6ee: Stack[-6] = Stack[-2]
...
0x708: @@ GetPosition(Stack[-3]); Obj=7 // @poff=496
0x709: Pop(0)
...
0x718: @@ GetPosition(Stack[-8]); Obj=20 // @poff=496
0x719: Pop(0)
0x71a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=660
0x71b: Pop(0)
...
0x741: Pop(0)
0x742: Push((bool) 1)
0x743: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x744: Pop(1)
0x745: Push(CvectorIndex(Stack[-4], 0))
0x746: Push(CvectorIndex(Stack[-5], 2))
0x747: @ Rotate(Stack[-2], Stack[-1])
0x748: Pop(2)
...
0x74e: Push("head") // @poff=486
0x74f: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x750: Pop(1)
0x751: Push(Stack[-1])
0x752: IF (Stack[-1] == 0) GOTO 0x756; Pop(1)

0x753: Push("head") // @poff=486
0x754: @ LookAsyncCamera(Stack[-1])
0x755: Pop(1)
0x756: @ CameraWaitForPlayFinish()
0x757: Pop(0)
0x758: @ ResumeWorld()
0x759: Pop(0)
0x75a: Stack[-21] = (bool) 1
0x75b: Return(); Pop(18)

0x75c: PushEmpty(bool, bool)
0x75d: Push((bool) 1)
0x75e: @ CameraSwitchToNormal(Stack[-1])
0x75f: Pop(1)
...
0x765: Push("head") // @poff=486
0x766: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x767: Pop(1)
0x768: Push(Stack[-1])
0x769: IF (Stack[-1] == 0) GOTO 0x76d; Pop(1)

0x76a: Push("head") // @poff=486
0x76b: @ UnlookAsync(Stack[-1])
0x76c: Pop(1)
0x76d: Return(); Pop(2)

0x76e: PushEmpty(bool, float, float, bool, float, float)
0x76f: @ lshHasAnimation(Stack[-3], Stack[-7])
0x770: Pop(0)
0x771: Push(Stack[-3])
0x772: IF (Stack[-1] == 0) GOTO 0x779; Pop(1)

0x773: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x774: Pop(0)
0x775: Push((bool) 0)
0x776: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x777: Pop(1)
0x778: GOTO 0x77d

0x779: Push("Can't find lsh animation : ") // @poff=973
0x77a: Pop(1); Push(Stack[-1] + Stack[-8]);
0x77b: @ Trace(Stack[-1])
0x77c: Pop(1)
0x77d: Return(); Pop(6)

0x77e: PushEmpty(bool, float, float, bool, float, float)
0x77f: @ lshHasAnimation(Stack[-3], Stack[-8])
0x780: Pop(0)
0x781: Push(Stack[-3])
0x782: IF (Stack[-1] == 0) GOTO 0x788; Pop(1)

0x783: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x784: Pop(0)
0x785: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x786: Pop(0)
0x787: GOTO 0x78c

0x788: Push("Can't find lsh animation : ") // @poff=973
0x789: Pop(1); Push(Stack[-1] + Stack[-9]);
0x78a: @ Trace(Stack[-1])
0x78b: Pop(1)
0x78c: Return(); Pop(6)

0x78d: PushEmpty(float, cvector, float, cvector)
0x78e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=660
0x78f: Pop(0)
0x790: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x791: Push(CvectorIndex(Stack[-1], 1))
0x792: Stack[-3] = Stack[-1]
0x793: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x794: Push("head") // @poff=486
0x795: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x796: Pop(1)
0x797: Return(); Pop(4)
...
0x79f: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7a0: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7a1: Pop(0)
0x7a2: Pop(0); Push((bool) Stack[-8] == 0)
0x7a3: IF (Stack[-1] == 0) GOTO 0x7b8; Pop(1)

0x7a4: Stack[-7] = (int) 0
0x7a5: Push((int) 1)
0x7a6: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7a7: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7a8: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7a9: Pop(1)
0x7aa: Pop(0); Push((bool) Stack[-6] == 0)
0x7ab: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7ac: GOTO 0x7b0

0x7ad: Push((int) 1)
0x7ae: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7af: GOTO 0x7a5

0x7b0: Pop(0); Push((bool) Stack[-7] == 0)
0x7b1: IF (Stack[-1] == 0) GOTO 0x7b3; Pop(1)

0x7b2: Return(); Pop(16)

0x7b3: @ irand(Stack[-5], Stack[-7])
0x7b4: Pop(0)
0x7b5: Push((int) 1)
0x7b6: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7b7: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7b8: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7b9: Pop(0)
0x7ba: Push(Stack[-4])
0x7bb: IF (Stack[-1] == 0) GOTO 0x7c7; Pop(1)

0x7bc: @ GetEyesHeight(Stack[-3])
0x7bd: Pop(0)
0x7be: @ GetDirection(Stack[-2])
0x7bf: Pop(0)
0x7c0: Push((int) 50)
0x7c1: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7c2: Push(CvectorIndex(Stack[-1], 1))
0x7c3: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7c4: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7c5: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x7c6: Pop(0)
0x7c7: Return(); Pop(16)
...
0x7d8: PushEmpty()
0x7d9: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x7da: IF (Stack[-1] == 0) GOTO 0x7dd; Pop(1)

0x7db: Stack[-2] = Stack[-3]
0x7dc: GOTO 0x7de
...
0x7e4: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7e5: IF (Stack[-1] == 0) GOTO 0x7e8; Pop(1)

0x7e6: Stack[-1] = Stack[-4]
0x7e7: Return(); Pop(0)

0x7e8: Stack[-3] = Stack[-4]
0x7e9: Return(); Pop(0)

0x7ea: PushEmpty(object, object)
0x7eb: @ CreateFloatVector(Stack[-1])
0x7ec: Pop(0)
0x7ed: @@ add(Stack[-3]); Obj=1 // @poff=914
0x7ee: Pop(0)
0x7ef: Push((int) 0)
0x7f0: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x7f1: IF (Stack[-1] == 0) GOTO 0x7f6; Pop(1)

0x7f2: Push((float)0.699999988079071)
0x7f3: Push((int) 500)
0x7f4: @ RumblePlay(Stack[-2], Stack[-1])
0x7f5: Pop(2)
0x7f6: Push((int) 15)
0x7f7: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7f8: Pop(1)
0x7f9: Return(); Pop(2)

0x7fa: Stack[-1] = 0
0x7fb: PushEmpty(object, object)
0x7fc: @ FindActor(Stack[-1], Stack[-4])
0x7fd: Pop(0)
0x7fe: Pop(0); PushNull((bool) Stack[-1] == 0)
0x7ff: IF (Stack[-1] == 0) GOTO 0x802; Pop(1)

0x800: Stack[-5] = (bool) 0
0x801: Return(); Pop(2)

0x802: @ Trigger(Stack[-1], Stack[-3])
0x803: Pop(0)
0x804: Stack[-5] = (bool) 1
0x805: Return(); Pop(2)
...
0x81a: Stack[-1] = 0
0x81b: PushEmpty(string, string)
0x81c: Stack[-1] = "idle" // @poff=146
0x81d: Push(Stack[-3])
0x81e: IF (Stack[-1] == 0) GOTO 0x820; Pop(1)

0x81f: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x820: Stack[-1] = Stack[-4]
0x821: Return(); Pop(2)

0x822: PushEmpty(int, bool, int, bool)
0x823: Stack[-2] = (int) 0
0x824: Push("all") // @poff=138
0x825: PushEmpty(string, int)
0x826: Stack[-5] = Stack[-1]
0x827: Call2 0x81b

0x828: Pop(1)
0x829: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x82a: Pop(2)
0x82b: Pop(0); Push((bool) Stack[-1] == 0)
0x82c: IF (Stack[-1] == 0) GOTO 0x82e; Pop(1)

0x82d: GOTO 0x831

0x82e: Push((int) 1)
0x82f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x830: GOTO 0x824

0x831: Stack[-2] = Stack[-5]
0x832: Return(); Pop(4)

0x833: PushEmpty()
0x834: PushEmpty(bool, string, string)
0x835: Stack[-2] = "quest_d1_01" // @poff=156
0x836: Stack[-1] = "attack" // @poff=180
0x837: Call2 0x7fb
...
0x83b: Push("branch") // @poff=1043
0x83c: @ GetVariable(Stack[-1], Stack[-2])
0x83d: Pop(1)
0x83e: Push((int) 0)
...
0x84c: Push("branch") // @poff=1043
0x84d: @ GetVariable(Stack[-1], Stack[-2])
0x84e: Pop(1)
...
0x857: IF (Stack[-1] == 0) GOTO 0x85b; Pop(1)

0x858: @ WorkWithCorpse(Stack[-1])
0x859: Pop(0)
0x85a: GOTO 0x85d

0x85b: @ Barter(Stack[-1])
0x85c: Pop(0)
0x85d: Return(); Pop(0)

0x85e: Stack[-1] = (int) 521048
0x85f: Return(); Pop(0)

0x860: Stack[-1] = (int) 521047
0x861: Return(); Pop(0)

0x862: Stack[-1] = "ui/NPC_Morlok.png" // @poff=1057
0x863: Return(); Pop(0)

0x864: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=1093
0x865: Return(); Pop(0)

0x866: Stack[-1] = (bool) 0
0x867: Return(); Pop(0)

0x868: PushEmpty()
0x869: PushEmpty(object)
0x86a: Stack[-2] = Stack[-1]
0x86b: Push(-1, 0); TaskCall(5)
0x86c: Call2 0x53e

0x86d: Pop(-1, 0); TaskReturn
0x86e: Pop(1)
0x86f: Return(); Pop(0)

0x870: PushEmpty()
0x871: PushEmpty(object, int, float)
0x872: Stack[-7] = Stack[-3]
0x873: Stack[-6] = Stack[-2]
0x874: Stack[-5] = Stack[-1]
0x875: Call2 0x6b5
...
0x878: PushEmpty()
0x879: PushEmpty(object, int, float, cvector, cvector)
0x87a: Stack[-11] = Stack[-5]
0x87b: Stack[-10] = Stack[-4]
0x87c: Stack[-9] = Stack[-3]
0x87d: Stack[-7] = Stack[-2]
0x87e: Stack[-6] = Stack[-1]
0x87f: Call2 0x6f9
...
0x883: Push("health") // @poff=758
0x884: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x885: IF (Stack[-1] == 0) GOTO 0x88e; Pop(1)

0x886: Push("health") // @poff=758
0x887: @ GetProperty(Stack[-1], Stack[-2])
0x888: Pop(1)
0x889: Push((int) 0)
0x88a: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x88b: IF (Stack[-1] == 0) GOTO 0x88e; Pop(1)

0x88c: @ SignalDeath(Stack[-4])
0x88d: Pop(0)
0x88e: Return(); Pop(2)
