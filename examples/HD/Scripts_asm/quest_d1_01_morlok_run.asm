...
0x723: Push((float)0.699999988079071)
0x724: Push((int) 500)
...
0x756: Stack[-2] = Stack[-5]
0x757: Return(); Pop(4)

0x758: PushEmpty(int, int)
0x759: Push("branch") // @poff=966
...
0x76d: Pop(0)
0x76e: @@ SetItemName(Stack[-7]); Obj=3 // @poff=980
0x76f: Pop(0)
0x770: Push("Organ") // @poff=992
0x771: Push((int) 1)
0x772: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=775
0x773: Pop(2)
0x774: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1004
0x775: Pop(0)
0x776: Push((int) 0)
0x777: Push((int) 1)
...
0x784: Stack[-1] = "liver" // @poff=1014
0x785: Call2 0x76b

0x786: Pop(1)
0x787: PushEmpty(string)
0x788: Stack[-1] = "kidney" // @poff=1026
0x789: Call2 0x76b

0x78a: Pop(1)
0x78b: PushEmpty(string)
0x78c: Stack[-1] = "heart" // @poff=1040
0x78d: Call2 0x76b

0x78e: Pop(1)
0x78f: PushEmpty(string)
0x790: Stack[-1] = "blood" // @poff=1052
0x791: Call2 0x76b
...
0x7b4: Stack[-11] = Stack[-5]
0x7b5: Stack[-10] = Stack[-4]
0x7b6: Stack[-9] = Stack[-3]
0x7b7: Stack[-7] = Stack[-2]
0x7b8: Stack[-6] = Stack[-1]
0x7b9: Call2 0x6a7
