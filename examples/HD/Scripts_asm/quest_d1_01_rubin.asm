...
// @pool_raw:
// @pool_encoding:utf8
...
0x116: Stack[-1] = "Warning" // @poff=138
0x117: Call2 0xa9
...
0x12d: Stack[-1] = "Warning" // @poff=138
0x12e: Call2 0xa9
...
0x144: Stack[-1] = "Warning" // @poff=138
0x145: Call2 0xa9
...
0x15b: Stack[-1] = "Warning" // @poff=138
0x15c: Call2 0xa9
...
0x189: Stack[-1] = "Confusion" // @poff=182
0x18a: Call2 0xa9
...
0x1a0: Stack[-1] = "Confusion" // @poff=182
0x1a1: Call2 0xa9
...
0x1b2: Stack[-1] = "Warning" // @poff=138
0x1b3: Call2 0xa9
...
0x1c4: Stack[-1] = "Warning" // @poff=138
0x1c5: Call2 0xa9
...
0x1ff: Stack[-1] = "Confusion" // @poff=182
0x200: Call2 0xa9
...
0x216: Stack[-1] = "Confusion" // @poff=182
0x217: Call2 0xa9
...
0x22d: Stack[-1] = "Confusion" // @poff=182
0x22e: Call2 0xa9
...
0x256: Stack[-1] = "Warning" // @poff=138
0x257: Call2 0xa9
...
0x2c0: Stack[-2] = Stack[-5]
0x2c1: Pop(2)
0x2c2: Return(); Pop(2)

0x2c3: Stack[-1] = 0
0x2c4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2c5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2c6: @ RotateAsync(Stack[-2], Stack[-1])
0x2c7: Pop(2)
0x2c8: Return(); Pop(0)

0x2c9: PushEmpty(object, bool, object, bool)
0x2ca: Push("player") // @poff=234
...
0x3a5: Pop(0)
0x3a6: @@ GetPosition(Stack[-2]); Obj=7 // @poff=248
0x3a7: Pop(0)
...
0x3b2: Pop(2)
0x3b3: Stack[-1] = Stack[-8]
0x3b4: Return(); Pop(6)

0x3b5: PushEmpty(cvector, cvector)
0x3b6: @@ GetPosition(Stack[-1]); Obj=3 // @poff=248
0x3b7: Pop(0)
0x3b8: PushEmpty(bool, cvector)
0x3b9: Stack[-3] = Stack[-1]
0x3ba: Call2 0x3ab

0x3bb: Stack[-2] = Stack[-6]
0x3bc: Pop(2)
0x3bd: Return(); Pop(2)
...
0x3c4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=248
0x3c5: Pop(0)
0x3c6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=260
0x3c7: Pop(0)
...
0x433: Push("voice_common") // @poff=284
0x434: Push((int) 1)
...
0x43b: Push("voice_common") // @poff=284
0x43c: Push((int) 0)
...
0x44e: Push("voice_common") // @poff=284
0x44f: Push((int) 1)
...
0x45c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x45d: Pop(1)
...
0x487: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x488: Pop(1)
...
0x49c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=326
0x49d: Pop(1)
...
0x4af: Push("Can't find lsh animation : ") // @poff=342
...
0x4be: Push("Can't find lsh animation : ") // @poff=342
...
0x4e2: Push((float)9.999999974752427e-07)
...
0x50d: Stack[-2] = Stack[-5]
0x50e: Return(); Pop(4)

0x50f: PushEmpty()
0x510: Push("d1q01") // @poff=398
0x511: Push((int) 8)
...
0x536: Push("Can't retrieve diary root") // @poff=410
0x537: @ Trace(Stack[-1])
0x538: Pop(1)
0x539: Stack[-3] = (bool) 0
0x53a: Return(); Pop(2)

0x53b: Stack[-1] = Stack[-3]
0x53c: Return(); Pop(2)
...
0x541: Stack[-1] = Stack[-4]
0x542: Pop(1)
0x543: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=462
0x544: Pop(0)
0x545: Pop(0); Push((bool) Stack[-2] == 0)
0x546: IF (Stack[-1] == 0) GOTO 0x54d; Pop(1)

0x547: Push("Can't find diary parent with id: ") // @poff=467
...
0x54d: @@ AddChild(Stack[-8]); Obj=2 // @poff=535
0x54e: Pop(0)
0x54f: Push((int) 7)
0x550: @ SendWorldWndMessage(Stack[-1])
0x551: Pop(1)
0x552: @@ GetCategory(Stack[-1]); Obj=8 // @poff=544
0x553: Pop(0)
...
0x56f: Stack[-1] = "ui/NPC_Rubin.png" // @poff=570
0x570: Return(); Pop(0)

0x571: Stack[-1] = "ui/NPC_Rubin_b.png" // @poff=604
0x572: Return(); Pop(0)
