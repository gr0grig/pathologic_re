...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x201: Push("Can't find lsh animation : ") // @poff=286
...
0x210: Push("Can't find lsh animation : ") // @poff=286
...
0x21f: Push((float)9.999999974752427e-07)
...
0x228: Pop(0)
0x229: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x24e: Stack[-1] = "ui/NPC_wmask.png" // @poff=342
0x24f: Return(); Pop(0)

0x250: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=376
0x251: Return(); Pop(0)
