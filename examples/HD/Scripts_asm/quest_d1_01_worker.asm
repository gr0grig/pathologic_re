...
// @pool_raw:
// @pool_encoding:utf8
...
0x193: Pop(0)
0x194: Push("all") // @poff=138
0x195: PushEmpty(string, int)
0x196: Stack[-7] = Stack[-1]
0x197: Call2 0x84c
...
0x1d3: PushEmpty()
0x1d4: Stack[-3] = (float) 0.10000000149011612
0x1d5: Return(); Pop(0)
...
0x1ee: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x1ef: Pop(0)
0x1f0: Push(Stack[-8])
0x1f1: IF (Stack[-1] == 0) GOTO 0x1fa; Pop(1)

0x1f2: Push("attack") // @poff=180
...
0x20e: Pop(0)
0x20f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=266
0x210: Pop(0)
...
0x22a: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=266
0x22b: Pop(0)
...
0x25e: IF (Stack[-1] == 1) GOTO 0x264; Pop(1)

0x25f: PushEmpty(bool)
0x260: Call2 0x430

0x261: Pop(0)
0x262: IF (Stack[-1] == 1) GOTO 0x264; Pop(1)

0x263: Stack[-1] = (bool) 0
0x264: IF (Stack[-1] == 0) GOTO 0x275; Pop(1)

0x265: @ Face(Stack[-0]T)
0x266: Pop(0)
0x267: PushEmpty()
0x268: Call2 0x462
...
0x293: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=266
0x294: Pop(0)
...
0x2b3: Push("attack_off") // @poff=336
...
0x2c1: Push("attack_begin") // @poff=358
0x2c2: Push((int) 1)
0x2c3: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2ce: Push("attack") // @poff=180
0x2cf: Push((int) 1)
0x2d0: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2e2: Push((float)0.8999999761581421)
0x2e3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2e4: @ GetVictim(Stack[-1], Stack[-4])
0x2e5: Pop(1)
0x2e6: @ ReportAttack(Stack[-0]T)
0x2e7: Pop(0)
...
0x2eb: Stack[-6] = Stack[-2]
0x2ec: Stack[-10] = Stack[-1]
0x2ed: Call2 0x1d3

0x2ee: Stack[-3] = Stack[-5]
0x2ef: Pop(3)
0x2f0: PushEmpty(float, object, float, int)
0x2f1: Stack[-7] = Stack[-3]
0x2f2: Stack[-6] = Stack[-2]
0x2f3: PushEmpty(int, object, int)
0x2f4: Stack[-10] = Stack[-2]
0x2f5: Stack[-14] = Stack[-1]
0x2f6: Call2 0x1d6

0x2f7: Stack[-3] = Stack[-4]
0x2f8: Pop(3)
0x2f9: Call2 0x630

0x2fa: Stack[-4] = Stack[-5]
0x2fb: Pop(4)
0x2fc: PushEmpty(int)
0x2fd: Call2 0x460

0x2fe: Pop(0)
0x2ff: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x300: Pop(1)
0x301: PushEmpty(object, float)
0x302: Stack[-5] = Stack[-2]
...
0x30b: Pop(0)
0x30c: @ irand(Stack[-4], Stack[-1]T)
0x30d: Pop(0)
0x30e: Push((int) 1)
0x30f: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x310: @ Face(Stack[-0]T)
0x311: Pop(0)
0x312: Push((bool) 1)
...
0x319: Push("attack_begin") // @poff=358
...
0x32d: Stack[-11] = Stack[-2]
0x32e: Stack[-6] = Stack[-1]
0x32f: Call2 0x2e1

0x330: Pop(2)
0x331: Push("all") // @poff=138
0x332: Push("attack_middle") // @poff=396
...
0x33c: Push("attack_middle") // @poff=396
...
0x376: Stack[-11] = Stack[-2]
0x377: Stack[-6] = Stack[-1]
0x378: Call2 0x2e1
...
0x37f: Pop(1)
0x380: Push("all") // @poff=138
0x381: Push("attack_end") // @poff=428
...
0x3c0: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=266
0x3c1: Pop(0)
...
0x40c: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x40d: Pop(1)
...
0x411: @ Face(Stack[-0]T)
0x412: Pop(0)
0x413: Push("all") // @poff=138
0x414: Push("bjump") // @poff=384
0x415: @ PlayAnimation(Stack[-2], Stack[-1])
0x416: Pop(2)
0x417: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=266
0x418: Pop(0)
...
0x44e: @ irand(Stack[-1], Stack[-2]T)
0x44f: Pop(0)
0x450: Push((int) 1)
0x451: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x452: Push("attack") // @poff=180
...
0x463: Stack[-1] = "attack_stay" // @poff=300
0x464: Call2 0x7d0
...
0x48e: Stack[-15] = Stack[-5]
0x48f: Stack[-14] = Stack[-4]
0x490: Stack[-13] = Stack[-3]
0x491: Stack[-12] = Stack[-2]
0x492: Stack[-11] = Stack[-1]
0x493: Call2 0x4d8

0x494: Stack[-6] = Stack[-7]
0x495: Pop(6)
0x496: Push( Stack[2 + Tasks[-1].StackPointer] )
0x497: IF (Stack[-1] == 0) GOTO 0x49b; Pop(1)

0x498: Push("head") // @poff=486
0x499: @ UnlookAsync(Stack[-1])
0x49a: Pop(1)
0x49b: Push((int) 1)
0x49c: @ KillTimer(Stack[-1])
0x49d: Pop(1)
0x49e: Stack[-1] = Stack[-10]
0x49f: Return(); Pop(4)
...
0x4db: Stack[-17] = Stack[-7]
0x4dc: PushEmpty(bool, object)
0x4dd: Stack[-23] = Stack[-1]
0x4de: Call2 0x564
...
0x4e4: @@ GetPosition(Stack[-5]); Obj=21 // @poff=496
0x4e5: Pop(0)
...
0x4fb: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=266
0x4fc: Pop(0)
...
0x50d: Push((int) 0)
0x50e: Push((float)0.30000001192092896)
...
0x530: Push((int) 0)
0x531: Push((float)0.30000001192092896)
...
0x568: Stack[-2] = Stack[-4]
0x569: Pop(2)
0x56a: Return(); Pop(0)

0x56b: Stack[-1] = "walk" // @poff=508
0x56c: Return(); Pop(0)

0x56d: Stack[-1] = "run" // @poff=518
0x56e: Return(); Pop(0)
...
0x589: Pop(0); PushNull((bool) Stack[-21] == 0)
0x58a: IF (Stack[-1] == 0) GOTO 0x590; Pop(1)

0x58b: PushEmpty(string)
0x58c: Stack[-1] = "fdie" // @poff=526
0x58d: Call2 0x5e3

0x58e: Pop(1)
0x58f: GOTO 0x5e2

0x590: @@ GetPosition(Stack[-10]); Obj=21 // @poff=496
0x591: Pop(0)
...
0x5a1: Stack[-6] = "fdie" // @poff=526
0x5a2: GOTO 0x5a4

0x5a3: Stack[-6] = "bdie" // @poff=536
...
0x5aa: @ StopAsync()
0x5ab: Pop(0)
0x5ac: Stack[-21] = Stack[-5]
0x5ad: Push("GetScriptProperty") // @poff=546
0x5ae: Push((int) 2)
0x5af: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x5b0: IF (Stack[-1] == 0) GOTO 0x5bc; Pop(1)

0x5b1: Push("Owner") // @poff=582
0x5b2: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=594
0x5b3: Pop(1)
0x5b4: Push(Stack[-4])
0x5b5: IF (Stack[-1] == 0) GOTO 0x5bc; Pop(1)

0x5b6: Push("Owner") // @poff=582
0x5b7: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=612
0x5b8: Pop(1)
0x5b9: Pop(0); PushNull((bool) Stack[-5] == 0)
0x5ba: IF (Stack[-1] == 0) GOTO 0x5bc; Pop(1)

0x5bb: Stack[-21] = Stack[-5]
0x5bc: Push("@GetEyesHeight") // @poff=630
0x5bd: Push((int) 1)
0x5be: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x5bf: IF (Stack[-1] == 0) GOTO 0x5cb; Pop(1)

0x5c0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=660
0x5c1: Pop(0)
...
0x5d7: @ StopAsync()
0x5d8: Pop(0)
0x5d9: Push("head") // @poff=486
0x5da: @ UnlookAsync(Stack[-1])
0x5db: Pop(1)
0x5dc: Push("all") // @poff=138
...
0x625: Push("HasProperty") // @poff=722
0x626: Push((int) 2)
...
0x62c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=746
0x62d: Pop(0)
...
0x632: Stack[-18] = Stack[-2]
0x633: Stack[-1] = "health" // @poff=758
0x634: Call2 0x624
...
0x63b: Stack[-18] = Stack[-2]
0x63c: Stack[-1] = "armor" // @poff=772
0x63d: Call2 0x624
...
0x643: Push("armor") // @poff=772
0x644: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=784
0x645: Pop(1)
0x646: Push("armor_") // @poff=796
0x647: PushEmpty(string, int)
0x648: Stack[-16] = Stack[-1]
0x649: Call2 0x603

0x64a: Pop(1)
0x64b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x64c: PushEmpty(bool, object, string)
0x64d: Stack[-18] = Stack[-2]
0x64e: Stack[-8] = Stack[-1]
0x64f: Call2 0x624
...
0x655: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=784
0x656: Pop(0)
...
0x65d: Stack[-3] = Stack[-6]
0x65e: Pop(3)
0x65f: Push("health") // @poff=758
0x660: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=784
0x661: Pop(1)
0x662: Push((int) 1)
0x663: Pop(1); Push(Stack[-1] - Stack[-4]);
0x664: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x665: Push("health") // @poff=758
...
0x66b: Pop(3)
0x66c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=810
0x66d: Pop(2)
0x66e: PushEmpty(bool, object)
0x66f: Stack[-17] = Stack[-1]
0x670: Call2 0x61f
...
0x676: Pop(1)
0x677: Stack[-1] = Stack[-16]
0x678: Return(); Pop(12)

0x679: PushEmpty(bool, bool)
0x67a: @@ IsDead(Stack[-1]); Obj=3 // @poff=822
0x67b: Pop(0)
...
0x698: @@ GetScene(Stack[-1]); Obj=5 // @poff=843
0x699: Pop(0)
...
0x6ad: Stack[-1] = "noaccess" // @poff=852
0x6ae: Call2 0x624
...
0x6bb: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6c9: @@ GetPosition(Stack[-5]); Obj=15 // @poff=496
0x6ca: Pop(0)
...
0x6da: Stack[-1] = "fhit" // @poff=870
0x6db: GOTO 0x6dd

0x6dc: Stack[-1] = "bhit" // @poff=880
0x6dd: Push("hit_react") // @poff=890
0x6de: Push("1") // @poff=176
0x6df: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6e0: Push("2") // @poff=910
...
0x6f9: Stack[-25] = Stack[-1]
0x6fa: Call2 0x611

0x6fb: Stack[-2] = Stack[-3]
0x6fc: Pop(2)
0x6fd: Call2 0x7ff
...
0x718: Pop(0)
0x719: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=923
0x71a: Pop(0)
0x71b: PushEmpty(object, int, float, cvector, cvector)
0x71c: Stack[-26] = Stack[-5]
0x71d: Stack[-25] = Stack[-4]
0x71e: Stack[-24] = Stack[-3]
0x71f: Stack[-6] = Stack[-2]
...
0x739: @@ GetPosition(Stack[-3]); Obj=7 // @poff=496
0x73a: Pop(0)
...
0x749: @@ GetPosition(Stack[-8]); Obj=20 // @poff=496
0x74a: Pop(0)
0x74b: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=660
0x74c: Pop(0)
...
0x7aa: Push("Can't find lsh animation : ") // @poff=973
...
0x7b9: Push("Can't find lsh animation : ") // @poff=973
...
0x7bf: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=660
0x7c0: Pop(0)
...
0x802: Push((float)9.999999974752427e-07)
...
0x82e: Pop(0)
0x82f: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x866: Stack[-2] = "quest_d1_01" // @poff=156
0x867: Stack[-1] = "attack" // @poff=180
0x868: Call2 0x82c
...
0x893: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1057
0x894: Return(); Pop(0)

0x895: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1097
0x896: Return(); Pop(0)
...
0x8a3: Stack[-7] = Stack[-3]
0x8a4: Stack[-6] = Stack[-2]
0x8a5: Stack[-5] = Stack[-1]
0x8a6: Call2 0x6e6
...
0x8ab: Stack[-11] = Stack[-5]
0x8ac: Stack[-10] = Stack[-4]
0x8ad: Stack[-9] = Stack[-3]
0x8ae: Stack[-7] = Stack[-2]
0x8af: Stack[-6] = Stack[-1]
0x8b0: Call2 0x72a
