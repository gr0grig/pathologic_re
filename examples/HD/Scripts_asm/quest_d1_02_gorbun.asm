...
Strings:
	...
	A:GetMap
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x219: Stack[-8] = Stack[-2]
0x21a: Stack[-7] = Stack[-1]
0x21b: Call2 0x253
...
0x25a: Push("player") // @poff=172
0x25b: @ FindActor(Stack[-4]T, Stack[-1])
0x25c: Pop(1)
...
0x26f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2fa: Pop(0)
0x2fb: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x2fc: Pop(0)
...
0x301: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=208
0x302: Pop(0)
0x303: Pop(0); Push(Stack[-1] + Stack[-3]);
0x304: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=220
0x305: Pop(1)
0x306: Return(); Pop(2)
...
0x30e: Pop(0)
0x30f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=232
0x310: Pop(0)
...
0x36e: Push("Can't find lsh animation : ") // @poff=246
...
0x37d: Push("Can't find lsh animation : ") // @poff=246
...
0x383: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=232
0x384: Pop(0)
...
0x39d: Push((float)9.999999974752427e-07)
...
0x3ab: Pop(0)
0x3ac: @@ add(Stack[-4]); Obj=1 // @poff=302
0x3ad: Pop(0)
0x3ae: @@ add(Stack[-3]); Obj=1 // @poff=302
0x3af: Pop(0)
0x3b0: Push((int) 3)
...
0x3ca: Pop(0)
0x3cb: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3d8: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=330
0x3d9: Return(); Pop(0)

0x3da: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=370
0x3db: Return(); Pop(0)
...
0x3fa: Pop(1)
0x3fb: Push("d1q02AnnaGotoLaska") // @poff=414
0x3fc: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=452
0x3fd: Pop(1)
0x3fe: Push(Stack[-1])
0x3ff: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x400: @@ Remove(); Obj=1 // @poff=461
0x401: Pop(0)
0x402: Push("d1q02JuliaGotoAnna") // @poff=468
0x403: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=452
0x404: Pop(1)
0x405: Push(Stack[-1])
0x406: IF (Stack[-1] == 0) GOTO 0x409; Pop(1)

0x407: @@ Remove(); Obj=1 // @poff=461
0x408: Pop(0)
0x409: PushEmpty()
0x40a: Call2 0x47e
...
0x40d: Stack[-2] = "quest_d1_02" // @poff=506
0x40e: Stack[-1] = "completed" // @poff=530
0x40f: Call2 0x3c8
...
0x413: Stack[-2] = 0
0x414: PushEmpty()
0x415: Push("ood1GorbunLaska1") // @poff=550
0x416: Push((int) 1)
...
0x423: PushEmpty()
0x424: Push("money 2000 removed") // @poff=596
0x425: @ Trace(Stack[-1])
0x426: Pop(1)
0x427: PushEmpty(object, int)
0x428: Stack[-4] = Stack[-2]
...
0x42d: PushEmpty()
0x42e: Push("ood1GorbunLaska2") // @poff=634
0x42f: Push((int) 1)
...
0x433: PushEmpty()
0x434: Push("playsound") // @poff=668
0x435: Push("givemoney") // @poff=688
...
0x445: Stack[-1] = "ood1GorbunLaska1" // @poff=550
0x446: Call2 0x3a4
...
0x451: Stack[-1] = "ood1GorbunLaska2" // @poff=634
0x452: Call2 0x3a4
...
0x474: Push("money") // @poff=306
0x475: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=208
0x476: Pop(1)
0x477: Push((int) 2000)
...
0x49d: Push("Can't retrieve diary root") // @poff=708
0x49e: @ Trace(Stack[-1])
0x49f: Pop(1)
...
0x4a8: Stack[-1] = Stack[-4]
0x4a9: Pop(1)
0x4aa: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=760
0x4ab: Pop(0)
0x4ac: Pop(0); Push((bool) Stack[-2] == 0)
0x4ad: IF (Stack[-1] == 0) GOTO 0x4b4; Pop(1)

0x4ae: Push("Can't find diary parent with id: ") // @poff=765
...
0x4b4: @@ AddChild(Stack[-8]); Obj=2 // @poff=833
0x4b5: Pop(0)
0x4b6: Push((int) 7)
0x4b7: @ SendWorldWndMessage(Stack[-1])
0x4b8: Pop(1)
0x4b9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=842
0x4ba: Pop(0)
...
0x4c6: Push("Can't find main outdoor scene") // @poff=854
0x4c7: @ Trace(Stack[-1])
0x4c8: Pop(1)
0x4c9: Stack[-1] = 0
0x4ca: Stack[-1] = Stack[-5]
0x4cb: Return(); Pop(4)

0x4cc: @@ GetMap(Stack[-1]); Obj=2 // @poff=914
0x4cd: Pop(0)
