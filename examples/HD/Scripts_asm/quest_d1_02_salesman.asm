...
Strings:
	...
	W:d1q02
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1d5: Push("player") // @poff=172
0x1d6: @ FindActor(Stack[-4]T, Stack[-1])
0x1d7: Pop(1)
...
0x1ea: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x275: Pop(0)
0x276: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x277: Pop(0)
...
0x281: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x282: Pop(0)
0x283: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x284: Pop(0)
...
0x2e2: Push("Can't find lsh animation : ") // @poff=222
...
0x2f1: Push("Can't find lsh animation : ") // @poff=222
...
0x2f7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2f8: Pop(0)
...
0x321: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=278
0x322: Return(); Pop(0)

0x323: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=318
0x324: Return(); Pop(0)
...
0x33f: PushEmpty()
0x340: Push("ood1SalesmanLaska1") // @poff=362
0x341: Push((int) 1)
...
0x353: Stack[-1] = "ood1SalesmanLaska1" // @poff=362
0x354: Call2 0x318
