...
Strings:
	...
	W:butcher_fail
	W:butcher_death
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x7b1 Vars = (object, int, float, float)
EVENT_43 Op = 0x7b9 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x7c3 Vars = (object, string)
EVENT_41 Op = 0x7d0 Vars = (object)
...
0xfd: Stack[-2] = "quest_d1_03" // @poff=172
0xfe: Stack[-1] = "butcher_battle" // @poff=196
0xff: Call2 0x75e

0x100: Pop(3)
0x101: Push("player") // @poff=226
0x102: @ FindActor(Stack[-2], Stack[-1])
0x103: Pop(1)
0x104: PushEmpty(object, bool, float)
0x105: Stack[-4] = Stack[-3]
...
0x10e: Stack[-1] = 0
0x10f: PushEmpty()
0x110: Stack[-3] = (float) 0.10000000149011612
0x111: Return(); Pop(0)
...
0x130: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x131: Pop(0)
0x132: Push(Stack[-8])
0x133: IF (Stack[-1] == 0) GOTO 0x13c; Pop(1)

0x134: Push("attack") // @poff=296
...
0x150: Pop(0)
0x151: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=310
0x152: Pop(0)
...
0x16c: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=310
0x16d: Pop(0)
...
0x1a0: IF (Stack[-1] == 1) GOTO 0x1a6; Pop(1)

0x1a1: PushEmpty(bool)
0x1a2: Call2 0x372

0x1a3: Pop(0)
0x1a4: IF (Stack[-1] == 1) GOTO 0x1a6; Pop(1)

0x1a5: Stack[-1] = (bool) 0
0x1a6: IF (Stack[-1] == 0) GOTO 0x1b7; Pop(1)

0x1a7: @ Face(Stack[-0]T)
0x1a8: Pop(0)
0x1a9: PushEmpty()
0x1aa: Call2 0x3a4
...
0x1b7: @ Face(Stack[-0]T)
0x1b8: Pop(0)
0x1b9: Push("all") // @poff=138
0x1ba: Push("fjump") // @poff=368
...
0x1d5: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=310
0x1d6: Pop(0)
...
0x1f4: Push("all") // @poff=138
0x1f5: Push("attack_off") // @poff=380
...
0x203: Push("attack_begin") // @poff=402
0x204: Push((int) 1)
0x205: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x210: Push("attack") // @poff=296
0x211: Push((int) 1)
0x212: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x21c: Push("all") // @poff=138
0x21d: Push("bjump") // @poff=428
...
0x224: Push((float)0.8999999761581421)
0x225: Pop(1); Push(Stack[-9] * Stack[-1]);
0x226: @ GetVictim(Stack[-1], Stack[-4])
0x227: Pop(1)
0x228: @ ReportAttack(Stack[-0]T)
0x229: Pop(0)
...
0x22d: Stack[-6] = Stack[-2]
0x22e: Stack[-10] = Stack[-1]
0x22f: Call2 0x10f

0x230: Stack[-3] = Stack[-5]
0x231: Pop(3)
0x232: PushEmpty(float, object, float, int)
0x233: Stack[-7] = Stack[-3]
0x234: Stack[-6] = Stack[-2]
0x235: PushEmpty(int, object, int)
0x236: Stack[-10] = Stack[-2]
0x237: Stack[-14] = Stack[-1]
0x238: Call2 0x112
...
0x23c: Stack[-4] = Stack[-5]
0x23d: Pop(4)
0x23e: PushEmpty(int)
0x23f: Call2 0x3a2

0x240: Pop(0)
0x241: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x242: Pop(1)
0x243: PushEmpty(object, float)
0x244: Stack[-5] = Stack[-2]
...
0x259: Pop(0)
0x25a: Push("all") // @poff=138
0x25b: Push("attack_begin") // @poff=402
...
0x274: Push("attack_middle") // @poff=440
...
0x27c: Pop(0)
0x27d: Push("all") // @poff=138
0x27e: Push("attack_middle") // @poff=440
...
0x293: Stack[-6] = Stack[-1]
0x294: Call2 0x223

0x295: Pop(2)
0x296: Stack[-2] = (int) 1
0x297: Push("attack_middle") // @poff=440
0x298: Pop(1); Push(Stack[-1] + Stack[-5]);
0x299: Push("_") // @poff=468
...
0x2c3: Push("attack_end") // @poff=472
...
0x302: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=310
0x303: Pop(0)
...
0x34e: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x34f: Pop(1)
...
0x353: @ Face(Stack[-0]T)
0x354: Pop(0)
0x355: Push("all") // @poff=138
0x356: Push("bjump") // @poff=428
0x357: @ PlayAnimation(Stack[-2], Stack[-1])
0x358: Pop(2)
0x359: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=310
0x35a: Pop(0)
...
0x390: @ irand(Stack[-1], Stack[-2]T)
0x391: Pop(0)
0x392: Push((int) 1)
0x393: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x394: Push("attack") // @poff=296
...
0x3a5: Stack[-1] = "attack_stay" // @poff=344
0x3a6: Call2 0x702
...
0x3d6: Stack[-15] = Stack[-5]
0x3d7: Stack[-14] = Stack[-4]
0x3d8: Stack[-13] = Stack[-3]
0x3d9: Stack[-12] = Stack[-2]
0x3da: Stack[-11] = Stack[-1]
0x3db: Call2 0x420

0x3dc: Stack[-6] = Stack[-7]
0x3dd: Pop(6)
0x3de: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3df: IF (Stack[-1] == 0) GOTO 0x3e3; Pop(1)

0x3e0: Push("head") // @poff=530
0x3e1: @ UnlookAsync(Stack[-1])
0x3e2: Pop(1)
0x3e3: Push((int) 1)
0x3e4: @ KillTimer(Stack[-1])
0x3e5: Pop(1)
0x3e6: Stack[-1] = Stack[-10]
0x3e7: Return(); Pop(4)
...
0x423: Stack[-17] = Stack[-7]
0x424: PushEmpty(bool, object)
0x425: Stack[-23] = Stack[-1]
0x426: Call2 0x4ac
...
0x42c: @@ GetPosition(Stack[-5]); Obj=21 // @poff=540
0x42d: Pop(0)
...
0x443: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=310
0x444: Pop(0)
...
0x455: Push((int) 0)
0x456: Push((float)0.30000001192092896)
...
0x478: Push((int) 0)
0x479: Push((float)0.30000001192092896)
...
0x4b3: Stack[-1] = "walk" // @poff=552
0x4b4: Return(); Pop(0)

0x4b5: Stack[-1] = "run" // @poff=562
0x4b6: Return(); Pop(0)
...
0x4c7: Pop(0); PushNull((bool) Stack[-21] == 0)
0x4c8: IF (Stack[-1] == 0) GOTO 0x4ce; Pop(1)

0x4c9: PushEmpty(string)
0x4ca: Stack[-1] = "fdie" // @poff=570
0x4cb: Call2 0x521

0x4cc: Pop(1)
0x4cd: GOTO 0x520

0x4ce: @@ GetPosition(Stack[-10]); Obj=21 // @poff=540
0x4cf: Pop(0)
...
0x4df: Stack[-6] = "fdie" // @poff=570
0x4e0: GOTO 0x4e2

0x4e1: Stack[-6] = "bdie" // @poff=580
...
0x4e8: @ StopAsync()
0x4e9: Pop(0)
0x4ea: Stack[-21] = Stack[-5]
0x4eb: Push("GetScriptProperty") // @poff=590
0x4ec: Push((int) 2)
0x4ed: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4ee: IF (Stack[-1] == 0) GOTO 0x4fa; Pop(1)

0x4ef: Push("Owner") // @poff=626
0x4f0: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=638
0x4f1: Pop(1)
0x4f2: Push(Stack[-4])
0x4f3: IF (Stack[-1] == 0) GOTO 0x4fa; Pop(1)

0x4f4: Push("Owner") // @poff=626
0x4f5: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=656
0x4f6: Pop(1)
0x4f7: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4f8: IF (Stack[-1] == 0) GOTO 0x4fa; Pop(1)

0x4f9: Stack[-21] = Stack[-5]
0x4fa: Push("@GetEyesHeight") // @poff=674
0x4fb: Push((int) 1)
0x4fc: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4fd: IF (Stack[-1] == 0) GOTO 0x509; Pop(1)

0x4fe: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=704
0x4ff: Pop(0)
0x500: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x501: Push(CvectorIndex(Stack[-1], 1))
0x502: Stack[-3] = Stack[-1]
0x503: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x504: Push("head") // @poff=530
...
0x515: @ StopAsync()
0x516: Pop(0)
0x517: Push("head") // @poff=530
0x518: @ UnlookAsync(Stack[-1])
0x519: Pop(1)
0x51a: Push("all") // @poff=138
...
0x52d: Stack[-2] = Stack[-1]
0x52e: Call2 0x702

0x52f: Pop(1)
0x530: Push("all") // @poff=138
0x531: @ PlayAnimation(Stack[-1], Stack[-2])
0x532: Pop(1)
0x533: @ WaitForAnimEnd()
0x534: Pop(0)
0x535: Push("all") // @poff=138
...
0x54b: Stack[-2] = "bullet" // @poff=728
0x54c: Return(); Pop(0)

0x54d: Stack[-2] = "phys" // @poff=742
0x54e: Return(); Pop(0)

0x54f: PushEmpty(cvector, cvector, cvector, cvector)
0x550: @ GetPosition(Stack[-2])
0x551: Pop(0)
0x552: @@ GetPosition(Stack[-1]); Obj=5 // @poff=540
0x553: Pop(0)
...
0x558: Pop(0)
0x559: Stack[-1] = Stack[-4]
0x55a: Return(); Pop(2)

0x55b: PushEmpty(bool, bool)
0x55c: Push("HasProperty") // @poff=752
0x55d: Push((int) 2)
...
0x563: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=776
0x564: Pop(0)
...
0x569: Stack[-18] = Stack[-2]
0x56a: Stack[-1] = "health" // @poff=788
0x56b: Call2 0x55b
...
0x572: Stack[-18] = Stack[-2]
0x573: Stack[-1] = "armor" // @poff=802
0x574: Call2 0x55b
...
0x57a: Push("armor") // @poff=802
0x57b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=814
0x57c: Pop(1)
0x57d: Push("armor_") // @poff=826
0x57e: PushEmpty(string, int)
0x57f: Stack[-16] = Stack[-1]
0x580: Call2 0x541

0x581: Pop(1)
0x582: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x583: PushEmpty(bool, object, string)
0x584: Stack[-18] = Stack[-2]
...
0x58c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=814
0x58d: Pop(0)
...
0x594: Stack[-3] = Stack[-6]
0x595: Pop(3)
0x596: Push("health") // @poff=788
0x597: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=814
0x598: Pop(1)
0x599: Push((int) 1)
0x59a: Pop(1); Push(Stack[-1] - Stack[-4]);
0x59b: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x59c: Push("health") // @poff=788
...
0x5a2: Pop(3)
0x5a3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=840
0x5a4: Pop(2)
0x5a5: PushEmpty(bool, object)
0x5a6: Stack[-17] = Stack[-1]
0x5a7: Call2 0x556
...
0x5ad: Pop(1)
0x5ae: Stack[-1] = Stack[-16]
0x5af: Return(); Pop(12)

0x5b0: PushEmpty(bool, bool)
0x5b1: @@ IsDead(Stack[-1]); Obj=3 // @poff=852
0x5b2: Pop(0)
0x5b3: Stack[-1] = Stack[-4]
0x5b4: Return(); Pop(2)

0x5b5: PushEmpty(object, object, object, object)
0x5b6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5ca: Pop(0)
0x5cb: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5cc: IF (Stack[-1] == 0) GOTO 0x5cf; Pop(1)

0x5cd: Stack[-6] = (bool) 0
0x5ce: Return(); Pop(4)

0x5cf: @@ GetScene(Stack[-1]); Obj=5 // @poff=873
0x5d0: Pop(0)
...
0x5e4: Stack[-1] = "noaccess" // @poff=882
0x5e5: Call2 0x55b
...
0x5eb: Push("noaccess") // @poff=882
0x5ec: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=814
0x5ed: Pop(1)
0x5ee: Push((int) 0)
...
0x5f2: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x600: @@ GetPosition(Stack[-5]); Obj=15 // @poff=540
0x601: Pop(0)
...
0x611: Stack[-1] = "fhit" // @poff=900
0x612: GOTO 0x614

0x613: Stack[-1] = "bhit" // @poff=910
0x614: Push("hit_react") // @poff=920
0x615: Push("1") // @poff=940
0x616: Pop(1); Push(Stack[-3] + Stack[-1]);
0x617: Push("2") // @poff=944
...
0x630: Stack[-25] = Stack[-1]
0x631: Call2 0x54f

0x632: Stack[-2] = Stack[-3]
0x633: Pop(2)
0x634: Call2 0x731

0x635: Stack[-2] = Stack[-11]
0x636: Pop(2)
0x637: @ CreateVectorVector(Stack[-8])
0x638: Pop(0)
0x639: Stack[-7] = (int) 1
0x63a: Push("hit") // @poff=902
...
0x64f: Pop(0)
0x650: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=957
0x651: Pop(0)
0x652: PushEmpty(object, int, float, cvector, cvector)
0x653: Stack[-26] = Stack[-5]
0x654: Stack[-25] = Stack[-4]
0x655: Stack[-24] = Stack[-3]
0x656: Stack[-6] = Stack[-2]
...
0x670: @@ GetPosition(Stack[-3]); Obj=7 // @poff=540
0x671: Pop(0)
...
0x67b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=540
0x67c: Pop(0)
0x67d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=704
0x67e: Pop(0)
...
0x6a4: Pop(0)
0x6a5: Push((bool) 1)
0x6a6: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x6a7: Pop(1)
0x6a8: Push(CvectorIndex(Stack[-4], 0))
0x6a9: Push(CvectorIndex(Stack[-5], 2))
0x6aa: @ Rotate(Stack[-2], Stack[-1])
0x6ab: Pop(2)
...
0x6b1: Push("head") // @poff=530
0x6b2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6b3: Pop(1)
0x6b4: Push(Stack[-1])
0x6b5: IF (Stack[-1] == 0) GOTO 0x6b9; Pop(1)

0x6b6: Push("head") // @poff=530
0x6b7: @ LookAsyncCamera(Stack[-1])
0x6b8: Pop(1)
0x6b9: @ CameraWaitForPlayFinish()
0x6ba: Pop(0)
0x6bb: @ ResumeWorld()
0x6bc: Pop(0)
0x6bd: Stack[-21] = (bool) 1
0x6be: Return(); Pop(18)

0x6bf: PushEmpty(bool, bool)
0x6c0: Push((bool) 1)
0x6c1: @ CameraSwitchToNormal(Stack[-1])
0x6c2: Pop(1)
...
0x6c8: Push("head") // @poff=530
0x6c9: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x6ca: Pop(1)
0x6cb: Push(Stack[-1])
0x6cc: IF (Stack[-1] == 0) GOTO 0x6d0; Pop(1)

0x6cd: Push("head") // @poff=530
0x6ce: @ UnlookAsync(Stack[-1])
0x6cf: Pop(1)
0x6d0: Return(); Pop(2)

0x6d1: PushEmpty(bool, float, float, bool, float, float)
0x6d2: @ lshHasAnimation(Stack[-3], Stack[-7])
0x6d3: Pop(0)
0x6d4: Push(Stack[-3])
0x6d5: IF (Stack[-1] == 0) GOTO 0x6dc; Pop(1)

0x6d6: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x6d7: Pop(0)
0x6d8: Push((bool) 0)
0x6d9: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6da: Pop(1)
0x6db: GOTO 0x6e0

0x6dc: Push("Can't find lsh animation : ") // @poff=1007
0x6dd: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6de: @ Trace(Stack[-1])
0x6df: Pop(1)
0x6e0: Return(); Pop(6)

0x6e1: PushEmpty(bool, float, float, bool, float, float)
0x6e2: @ lshHasAnimation(Stack[-3], Stack[-8])
0x6e3: Pop(0)
0x6e4: Push(Stack[-3])
0x6e5: IF (Stack[-1] == 0) GOTO 0x6eb; Pop(1)

0x6e6: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x6e7: Pop(0)
0x6e8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x6e9: Pop(0)
0x6ea: GOTO 0x6ef

0x6eb: Push("Can't find lsh animation : ") // @poff=1007
0x6ec: Pop(1); Push(Stack[-1] + Stack[-9]);
0x6ed: @ Trace(Stack[-1])
0x6ee: Pop(1)
0x6ef: Return(); Pop(6)

0x6f0: PushEmpty(float, cvector, float, cvector)
0x6f1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=704
0x6f2: Pop(0)
0x6f3: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x6f4: Push(CvectorIndex(Stack[-1], 1))
0x6f5: Stack[-3] = Stack[-1]
0x6f6: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x6f7: Push("head") // @poff=530
0x6f8: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x6f9: Pop(1)
0x6fa: Return(); Pop(4)
...
0x702: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x703: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x704: Pop(0)
0x705: Pop(0); Push((bool) Stack[-8] == 0)
0x706: IF (Stack[-1] == 0) GOTO 0x71b; Pop(1)

0x707: Stack[-7] = (int) 0
0x708: Push((int) 1)
0x709: Pop(1); Push(Stack[-8] + Stack[-1]);
0x70a: Pop(1); Push(Stack[-18] + Stack[-1]);
0x70b: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x70c: Pop(1)
0x70d: Pop(0); Push((bool) Stack[-6] == 0)
...
0x713: Pop(0); Push((bool) Stack[-7] == 0)
0x714: IF (Stack[-1] == 0) GOTO 0x716; Pop(1)

0x715: Return(); Pop(16)

0x716: @ irand(Stack[-5], Stack[-7])
0x717: Pop(0)
0x718: Push((int) 1)
0x719: Pop(1); Push(Stack[-6] + Stack[-1]);
0x71a: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x71b: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x71c: Pop(0)
0x71d: Push(Stack[-4])
0x71e: IF (Stack[-1] == 0) GOTO 0x72a; Pop(1)

0x71f: @ GetEyesHeight(Stack[-3])
0x720: Pop(0)
0x721: @ GetDirection(Stack[-2])
0x722: Pop(0)
0x723: Push((int) 50)
0x724: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x725: Push(CvectorIndex(Stack[-1], 1))
0x726: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x727: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x728: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x729: Pop(0)
0x72a: Return(); Pop(16)
...
0x730: Stack[-1] = 0
0x731: PushEmpty(float, float)
0x732: Pop(0); Push(Stack[-3] | Stack[-3]);
0x733: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x734: Push((float)9.999999974752427e-07)
0x735: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x736: IF (Stack[-1] == 0) GOTO 0x739; Pop(1)

0x737: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x738: Return(); Pop(2)

0x739: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x73a: Return(); Pop(2)

0x73b: PushEmpty()
0x73c: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x73d: IF (Stack[-1] == 0) GOTO 0x740; Pop(1)

0x73e: Stack[-2] = Stack[-3]
0x73f: GOTO 0x741
...
0x742: PushEmpty()
0x743: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x744: IF (Stack[-1] == 0) GOTO 0x747; Pop(1)

0x745: Stack[-2] = Stack[-4]
0x746: Return(); Pop(0)

0x747: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x748: IF (Stack[-1] == 0) GOTO 0x74b; Pop(1)

0x749: Stack[-1] = Stack[-4]
0x74a: Return(); Pop(0)

0x74b: Stack[-3] = Stack[-4]
0x74c: Return(); Pop(0)

0x74d: PushEmpty(object, object)
0x74e: @ CreateFloatVector(Stack[-1])
0x74f: Pop(0)
0x750: @@ add(Stack[-3]); Obj=1 // @poff=948
0x751: Pop(0)
0x752: Push((int) 0)
0x753: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x754: IF (Stack[-1] == 0) GOTO 0x759; Pop(1)

0x755: Push((float)0.699999988079071)
0x756: Push((int) 500)
0x757: @ RumblePlay(Stack[-2], Stack[-1])
0x758: Pop(2)
0x759: Push((int) 15)
0x75a: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x75b: Pop(1)
0x75c: Return(); Pop(2)

0x75d: Stack[-1] = 0
0x75e: PushEmpty(object, object)
0x75f: @ FindActor(Stack[-1], Stack[-4])
0x760: Pop(0)
0x761: Pop(0); PushNull((bool) Stack[-1] == 0)
0x762: IF (Stack[-1] == 0) GOTO 0x765; Pop(1)

0x763: Stack[-5] = (bool) 0
0x764: Return(); Pop(2)

0x765: @ Trigger(Stack[-1], Stack[-3])
0x766: Pop(0)
0x767: Stack[-5] = (bool) 1
0x768: Return(); Pop(2)

0x769: Stack[-1] = 0
0x76a: PushEmpty(bool, bool)
0x76b: @ IsPlayerActor(Stack[-3], Stack[-1])
0x76c: Pop(0)
0x76d: Push(Stack[-1])
0x76e: IF (Stack[-1] == 0) GOTO 0x772; Pop(1)

0x76f: Push("attack") // @poff=296
0x770: @ PlayGlobalMusic(Stack[-1])
0x771: Pop(1)
0x772: Return(); Pop(2)

0x773: PushEmpty(object, object)
0x774: @ GetScene(Stack[-1])
0x775: Pop(0)
0x776: Push("battle") // @poff=212
0x777: PushEmpty(object)
0x778: Call2 0x72b

0x779: Pop(0)
0x77a: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x77b: Pop(2)
0x77c: Return(); Pop(2)

0x77d: Stack[-1] = 0
0x77e: PushEmpty(int, int)
0x77f: Push("branch") // @poff=1063
0x780: @ GetVariable(Stack[-1], Stack[-2])
0x781: Pop(1)
0x782: Push((int) 0)
...
0x78f: Stack[-1] = (int) 515562
0x790: Return(); Pop(0)

0x791: Stack[-1] = (int) 503347
0x792: Return(); Pop(0)

0x793: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1077
0x794: Return(); Pop(0)

0x795: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1117
0x796: Return(); Pop(0)
...
0x79b: Pop(0)
0x79c: @ RemoveActor(Stack[-1])
0x79d: Pop(1)
0x79e: PushEmpty(bool, string, string)
0x79f: Stack[-2] = "quest_d1_03" // @poff=172
0x7a0: Stack[-1] = "butcher_fail" // @poff=1161
0x7a1: Call2 0x75e
...
0x7a4: PushEmpty()
0x7a5: PushEmpty(bool, string, string)
0x7a6: Stack[-2] = "quest_d1_03" // @poff=172
0x7a7: Stack[-1] = "butcher_death" // @poff=1187
0x7a8: Call2 0x75e

0x7a9: Pop(3)
0x7aa: PushEmpty(object)
0x7ab: Stack[-2] = Stack[-1]
0x7ac: Push(-1, 0); TaskCall(5)
0x7ad: Call2 0x4bd

0x7ae: Pop(-1, 0); TaskReturn
0x7af: Pop(1)
0x7b0: Return(); Pop(0)

0x7b1: PushEmpty()
0x7b2: PushEmpty(object, int, float)
0x7b3: Stack[-7] = Stack[-3]
0x7b4: Stack[-6] = Stack[-2]
...
0x7b9: PushEmpty()
0x7ba: PushEmpty(object, int, float, cvector, cvector)
0x7bb: Stack[-11] = Stack[-5]
0x7bc: Stack[-10] = Stack[-4]
0x7bd: Stack[-9] = Stack[-3]
0x7be: Stack[-7] = Stack[-2]
...
0x7c3: PushEmpty(float, float)
0x7c4: Push("health") // @poff=788
0x7c5: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7c6: IF (Stack[-1] == 0) GOTO 0x7cf; Pop(1)

0x7c7: Push("health") // @poff=788
0x7c8: @ GetProperty(Stack[-1], Stack[-2])
0x7c9: Pop(1)
0x7ca: Push((int) 0)
0x7cb: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7cc: IF (Stack[-1] == 0) GOTO 0x7cf; Pop(1)

0x7cd: @ SignalDeath(Stack[-4])
0x7ce: Pop(0)
0x7cf: Return(); Pop(2)
