...
// @pool_raw:
// @pool_encoding:utf8
...
0xb49: Push("Can't find lsh animation : ") // @poff=923
...
0xb58: Push("Can't find lsh animation : ") // @poff=923
...
0xb71: Stack[-7] = Stack[-2]
0xb72: Stack[-6] = Stack[-1]
0xb73: Call2 0xbd4
...
0xb7c: Stack[-10] = Stack[-2]
0xb7d: Stack[-9] = Stack[-1]
0xb7e: Call2 0xbd4
...
0xbbb: Push((float)9.999999974752427e-07)
...
0xbc5: Stack[-2] = Stack[-3]
0xbc6: GOTO 0xbc8

0xbc7: Stack[-1] = Stack[-3]
0xbc8: Return(); Pop(0)
...
0xbee: Stack[-5] = Stack[-2]
0xbef: Stack[-4] = Stack[-1]
0xbf0: Call2 0xbd9

0xbf1: Pop(2)
0xbf2: PushEmpty(float, cvector)
0xbf3: Stack[-5] = Stack[-1]
0xbf4: Call2 0xbe2

0xbf5: Pop(1)
0xbf6: PushEmpty(float, cvector)
0xbf7: Stack[-5] = Stack[-1]
0xbf8: Call2 0xbe2
...
0xc2f: Stack[-1] = 0
0xc30: PushEmpty()
0xc31: Push("ood1Doberman1_1") // @poff=993
0xc32: Push((int) 1)
...
0xc38: Stack[-1] = "ood1Doberman1_1" // @poff=993
0xc39: Call2 0xbfd
...
0xc69: Push("GenerateMoney: iMin > iMax") // @poff=1039
0xc6a: @ Trace(Stack[-1])
0xc6b: Pop(1)
0xc6c: Return(); Pop(4)
...
0xc87: Pop(0)
0xc88: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1105
0xc89: Pop(0)
0xc8a: Push("Organ") // @poff=1117
0xc8b: Push((int) 1)
0xc8c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0xc8d: Pop(2)
0xc8e: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1129
0xc8f: Pop(0)
0xc90: Push((int) 0)
0xc91: Push((int) 1)
...
0xc9e: Stack[-1] = "liver" // @poff=1139
0xc9f: Call2 0xc85

0xca0: Pop(1)
0xca1: PushEmpty(string)
0xca2: Stack[-1] = "kidney" // @poff=1151
0xca3: Call2 0xc85

0xca4: Pop(1)
0xca5: PushEmpty(string)
0xca6: Stack[-1] = "heart" // @poff=1165
0xca7: Call2 0xc85

0xca8: Pop(1)
0xca9: PushEmpty(string)
0xcaa: Stack[-1] = "blood" // @poff=1177
0xcab: Call2 0xc85
...
0xcdc: Stack[-4] = "meradorm" // @poff=1235
0xcdd: Stack[-3] = (int) 2
0xcde: Stack[-2] = (int) 3
0xcdf: Stack[-1] = (int) 3
0xce0: Call2 0xb7a
...
0xce6: Stack[-3] = "beta_pills" // @poff=1253
0xce7: Stack[-2] = (int) 1
0xce8: Stack[-1] = (int) 4
0xce9: Call2 0xb6f
...
0xcef: Stack[-4] = "monomicin" // @poff=1275
0xcf0: Stack[-3] = (int) 1
0xcf1: Stack[-2] = (int) 2
0xcf2: Stack[-1] = (int) 2
0xcf3: Call2 0xb7a
...
0xcfa: Stack[-3] = "monomicin" // @poff=1275
0xcfb: Stack[-2] = (int) 1
0xcfc: Stack[-1] = (int) 2
0xcfd: Call2 0xb6f
...
0xd01: Stack[-3] = "lockpick" // @poff=1295
0xd02: Stack[-2] = (int) 1
0xd03: Stack[-1] = (int) 4
0xd04: Call2 0xb6f
...
0xd07: Stack[-3] = "rifle_ammo" // @poff=1313
0xd08: Stack[-2] = (int) 1
0xd09: Stack[-1] = (int) 2
0xd0a: Call2 0xb6f
...
0xd0d: Stack[-3] = "revolver_ammo" // @poff=1335
0xd0e: Stack[-2] = (int) 1
0xd0f: Stack[-1] = (int) 2
0xd10: Call2 0xb6f
...
0xd13: Stack[-4] = "samopal_ammo" // @poff=1363
0xd14: Stack[-3] = (int) 1
0xd15: Stack[-2] = (int) 2
0xd16: Stack[-1] = (int) 2
0xd17: Call2 0xb7a
...
0xd1d: Stack[-4] = "monomicin" // @poff=1275
0xd1e: Stack[-3] = (int) 1
0xd1f: Stack[-2] = (int) 2
0xd20: Stack[-1] = (int) 2
0xd21: Call2 0xb7a
...
0xd28: Stack[-3] = "monomicin" // @poff=1275
0xd29: Stack[-2] = (int) 1
0xd2a: Stack[-1] = (int) 2
0xd2b: Call2 0xb6f
...
0xd50: Stack[-7] = Stack[-3]
0xd51: Stack[-6] = Stack[-2]
0xd52: Stack[-5] = Stack[-1]
0xd53: Call2 0xa85
...
0xd58: Stack[-11] = Stack[-5]
0xd59: Stack[-10] = Stack[-4]
0xd5a: Stack[-9] = Stack[-3]
0xd5b: Stack[-7] = Stack[-2]
0xd5c: Stack[-6] = Stack[-1]
0xd5d: Call2 0xac9
...
0xd60: PushEmpty()
0xd61: Push("unholster") // @poff=1389
0xd62: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd63: IF (Stack[-1] == 0) GOTO 0xd6b; Pop(1)

0xd64: PushEmpty(bool, object)
0xd65: Stack[-4] = Stack[-1]
0xd66: Call2 0xe37

0xd67: Stack[-2] = Stack[-5]
0xd68: Pop(2)
0xd69: Return(); Pop(0)

0xd6a: GOTO 0xd7e

0xd6b: Push("player_shot") // @poff=1409
...
0xd80: PushEmpty()
0xd81: Push("unholster") // @poff=1389
...
0xd89: Push("player_shot") // @poff=1409
...
0xda8: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1433
0xda9: Pop(0)
...
0xde8: Stack[-2] = (int) 0
0xde9: Push("all") // @poff=138
0xdea: PushEmpty(string, int)
0xdeb: Stack[-5] = Stack[-1]
0xdec: Call2 0xde0
...
0xe1d: Stack[-4] = Stack[-1]
0xe1e: Call2 0xe09

0xe1f: Stack[-2] = Stack[-5]
0xe20: Pop(2)
0xe21: Return(); Pop(0)

0xe22: PushEmpty()
0xe23: PushEmpty(object)
0xe24: Stack[-2] = Stack[-1]
0xe25: Call2 0xe13
...
0xe40: Push(Stack[-1])
0xe41: IF (Stack[-1] == 1) GOTO 0xe4a; Pop(1)
...
0xe48: IF (Stack[-1] == 1) GOTO 0xe4a; Pop(1)
...
0xe64: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1475
0xe65: Return(); Pop(0)

0xe66: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1515
0xe67: Return(); Pop(0)
...
0xe91: Pop(0)
0xe92: Push((float)-0.10000000149011612)
0xe93: Push((bool) 1)
