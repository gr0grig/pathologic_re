...
// @pool_raw:
// @pool_encoding:utf8
...
0x5f9: PushEmpty()
0x5fa: Stack[-3] = (float) 0.029999999329447746
0x5fb: Return(); Pop(0)
...
0x614: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x615: Pop(0)
0x616: Push(Stack[-8])
0x617: IF (Stack[-1] == 0) GOTO 0x620; Pop(1)

0x618: Push("attack") // @poff=382
...
0x634: Pop(0)
0x635: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x636: Pop(0)
...
0x650: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=396
0x651: Pop(0)
...
0x684: IF (Stack[-1] == 1) GOTO 0x68a; Pop(1)

0x685: PushEmpty(bool)
0x686: Call2 0x856

0x687: Pop(0)
0x688: IF (Stack[-1] == 1) GOTO 0x68a; Pop(1)

0x689: Stack[-1] = (bool) 0
0x68a: IF (Stack[-1] == 0) GOTO 0x69b; Pop(1)

0x68b: @ Face(Stack[-0]T)
0x68c: Pop(0)
0x68d: PushEmpty()
0x68e: Call2 0x888

0x68f: Pop(0)
0x690: Push("all") // @poff=138
0x691: Push("attack_stay") // @poff=430
0x692: @ PlayAnimation(Stack[-2], Stack[-1])
0x693: Pop(2)
0x694: PushEmpty(bool, float)
0x695: Stack[-25] = Stack[-1]
0x696: Call2 0x7d2
...
0x69b: @ Face(Stack[-0]T)
0x69c: Pop(0)
0x69d: Push("all") // @poff=138
0x69e: Push("fjump") // @poff=454
...
0x6b9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=396
0x6ba: Pop(0)
...
0x6d8: Push("all") // @poff=138
0x6d9: Push("attack_off") // @poff=466
...
0x6e6: Push("all") // @poff=138
0x6e7: Push("attack_begin") // @poff=488
0x6e8: Push((int) 1)
0x6e9: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x6f4: Push("attack") // @poff=382
0x6f5: Push((int) 1)
0x6f6: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x700: Push("all") // @poff=138
0x701: Push("bjump") // @poff=514
...
0x708: Push((float)0.8999999761581421)
0x709: Pop(1); Push(Stack[-9] * Stack[-1]);
0x70a: @ GetVictim(Stack[-1], Stack[-4])
0x70b: Pop(1)
0x70c: @ ReportAttack(Stack[-0]T)
0x70d: Pop(0)
...
0x711: Stack[-6] = Stack[-2]
0x712: Stack[-10] = Stack[-1]
0x713: Call2 0x5f9

0x714: Stack[-3] = Stack[-5]
0x715: Pop(3)
0x716: PushEmpty(float, object, float, int)
0x717: Stack[-7] = Stack[-3]
0x718: Stack[-6] = Stack[-2]
0x719: PushEmpty(int, object, int)
0x71a: Stack[-10] = Stack[-2]
0x71b: Stack[-14] = Stack[-1]
0x71c: Call2 0x5fc

0x71d: Stack[-3] = Stack[-4]
0x71e: Pop(3)
0x71f: Call2 0x9ca

0x720: Stack[-4] = Stack[-5]
0x721: Pop(4)
0x722: PushEmpty(int)
0x723: Call2 0x886

0x724: Pop(0)
0x725: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x726: Pop(1)
0x727: PushEmpty(object, float)
0x728: Stack[-5] = Stack[-2]
...
0x731: Pop(0)
0x732: @ irand(Stack[-4], Stack[-1]T)
0x733: Pop(0)
0x734: Push((int) 1)
0x735: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x736: @ Face(Stack[-0]T)
0x737: Pop(0)
0x738: Push((bool) 1)
...
0x73f: Push("attack_begin") // @poff=488
...
0x753: Stack[-11] = Stack[-2]
0x754: Stack[-6] = Stack[-1]
0x755: Call2 0x707

0x756: Pop(2)
0x757: Push("all") // @poff=138
0x758: Push("attack_middle") // @poff=526
...
0x760: Pop(0)
0x761: Push("all") // @poff=138
0x762: Push("attack_middle") // @poff=526
...
0x776: Stack[-11] = Stack[-2]
0x777: Stack[-6] = Stack[-1]
0x778: Call2 0x707

0x779: Pop(2)
0x77a: Stack[-2] = (int) 1
0x77b: Push("attack_middle") // @poff=526
0x77c: Pop(1); Push(Stack[-1] + Stack[-5]);
0x77d: Push("_") // @poff=554
...
0x79c: Stack[-11] = Stack[-2]
0x79d: Stack[-6] = Stack[-1]
0x79e: Call2 0x707
...
0x7a5: Pop(1)
0x7a6: Push("all") // @poff=138
0x7a7: Push("attack_end") // @poff=558
...
0x7e6: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=396
0x7e7: Pop(0)
...
0x832: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x833: Pop(1)
...
0x837: @ Face(Stack[-0]T)
0x838: Pop(0)
0x839: Push("all") // @poff=138
0x83a: Push("bjump") // @poff=514
0x83b: @ PlayAnimation(Stack[-2], Stack[-1])
0x83c: Pop(2)
0x83d: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=396
0x83e: Pop(0)
...
0x874: @ irand(Stack[-1], Stack[-2]T)
0x875: Pop(0)
0x876: Push((int) 1)
0x877: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x878: Push("attack") // @poff=382
...
0x889: Stack[-1] = "attack_stay" // @poff=430
0x88a: Call2 0xb84
...
0x8bb: Stack[-15] = Stack[-5]
0x8bc: Stack[-14] = Stack[-4]
0x8bd: Stack[-13] = Stack[-3]
0x8be: Stack[-12] = Stack[-2]
0x8bf: Stack[-11] = Stack[-1]
0x8c0: Call2 0x905

0x8c1: Stack[-6] = Stack[-7]
0x8c2: Pop(6)
0x8c3: Push( Stack[2 + Tasks[-1].StackPointer] )
0x8c4: IF (Stack[-1] == 0) GOTO 0x8c8; Pop(1)

0x8c5: Push("head") // @poff=316
0x8c6: @ UnlookAsync(Stack[-1])
0x8c7: Pop(1)
0x8c8: Push((int) 1)
0x8c9: @ KillTimer(Stack[-1])
0x8ca: Pop(1)
0x8cb: Stack[-1] = Stack[-10]
0x8cc: Return(); Pop(4)
...
0x908: Stack[-17] = Stack[-7]
0x909: PushEmpty(bool, object)
0x90a: Stack[-23] = Stack[-1]
0x90b: Call2 0x991
...
0x911: @@ GetPosition(Stack[-5]); Obj=21 // @poff=166
0x912: Pop(0)
...
0x928: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=396
0x929: Pop(0)
...
0x93a: Push((int) 0)
0x93b: Push((float)0.30000001192092896)
...
0x95d: Push((int) 0)
0x95e: Push((float)0.30000001192092896)
...
0x998: Stack[-1] = "walk" // @poff=616
0x999: Return(); Pop(0)

0x99a: Stack[-1] = "run" // @poff=626
0x99b: Return(); Pop(0)
...
0x9a6: Stack[-2] = "bullet" // @poff=644
0x9a7: Return(); Pop(0)

0x9a8: Stack[-2] = "phys" // @poff=658
0x9a9: Return(); Pop(0)

0x9aa: PushEmpty(cvector, cvector, cvector, cvector)
0x9ab: @ GetPosition(Stack[-2])
0x9ac: Pop(0)
0x9ad: @@ GetPosition(Stack[-1]); Obj=5 // @poff=166
0x9ae: Pop(0)
...
0x9b3: Pop(0)
0x9b4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=166
0x9b5: Pop(0)
...
0x9bb: Pop(0)
0x9bc: Stack[-1] = Stack[-4]
0x9bd: Return(); Pop(2)

0x9be: PushEmpty(bool, bool)
0x9bf: Push("HasProperty") // @poff=668
0x9c0: Push((int) 2)
...
0x9c6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=692
0x9c7: Pop(0)
...
0x9cc: Stack[-18] = Stack[-2]
0x9cd: Stack[-1] = "health" // @poff=704
0x9ce: Call2 0x9be
...
0x9d5: Stack[-18] = Stack[-2]
0x9d6: Stack[-1] = "armor" // @poff=718
0x9d7: Call2 0x9be
...
0x9dd: Push("armor") // @poff=718
0x9de: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x9df: Pop(1)
0x9e0: Push("armor_") // @poff=742
0x9e1: PushEmpty(string, int)
0x9e2: Stack[-16] = Stack[-1]
0x9e3: Call2 0x99c

0x9e4: Pop(1)
0x9e5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x9e6: PushEmpty(bool, object, string)
0x9e7: Stack[-18] = Stack[-2]
0x9e8: Stack[-8] = Stack[-1]
0x9e9: Call2 0x9be
...
0x9ef: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x9f0: Pop(0)
...
0x9f7: Stack[-3] = Stack[-6]
0x9f8: Pop(3)
0x9f9: Push("health") // @poff=704
0x9fa: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x9fb: Pop(1)
0x9fc: Push((int) 1)
0x9fd: Pop(1); Push(Stack[-1] - Stack[-4]);
0x9fe: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x9ff: Push("health") // @poff=704
...
0xa05: Pop(3)
0xa06: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=756
0xa07: Pop(2)
0xa08: PushEmpty(bool, object)
0xa09: Stack[-17] = Stack[-1]
0xa0a: Call2 0x9b9
...
0xa10: Pop(1)
0xa11: Stack[-1] = Stack[-16]
0xa12: Return(); Pop(12)

0xa13: PushEmpty(bool, bool)
0xa14: @@ IsDead(Stack[-1]); Obj=3 // @poff=768
0xa15: Pop(0)
0xa16: Stack[-1] = Stack[-4]
0xa17: Return(); Pop(2)

0xa18: PushEmpty(object, object, object, object)
0xa19: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0xa32: @@ GetScene(Stack[-1]); Obj=5 // @poff=789
0xa33: Pop(0)
...
0xa46: Stack[-6] = Stack[-2]
0xa47: Stack[-1] = "noaccess" // @poff=798
0xa48: Call2 0x9be
...
0xa4e: Push("noaccess") // @poff=798
0xa4f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0xa50: Pop(1)
0xa51: Push((int) 0)
...
0xa55: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0xa63: @@ GetPosition(Stack[-5]); Obj=15 // @poff=166
0xa64: Pop(0)
...
0xa74: Stack[-1] = "fhit" // @poff=816
0xa75: GOTO 0xa77

0xa76: Stack[-1] = "bhit" // @poff=826
0xa77: Push("hit_react") // @poff=836
0xa78: Push("1") // @poff=856
0xa79: Pop(1); Push(Stack[-3] + Stack[-1]);
0xa7a: Push("2") // @poff=860
...
0xa93: Stack[-25] = Stack[-1]
0xa94: Call2 0x9aa

0xa95: Stack[-2] = Stack[-3]
0xa96: Pop(2)
0xa97: Call2 0xbb3

0xa98: Stack[-2] = Stack[-11]
0xa99: Pop(2)
0xa9a: @ CreateVectorVector(Stack[-8])
0xa9b: Pop(0)
0xa9c: Stack[-7] = (int) 1
0xa9d: Push("hit") // @poff=818
...
0xab2: Pop(0)
0xab3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=873
0xab4: Pop(0)
0xab5: PushEmpty(object, int, float, cvector, cvector)
0xab6: Stack[-26] = Stack[-5]
0xab7: Stack[-25] = Stack[-4]
0xab8: Stack[-24] = Stack[-3]
0xab9: Stack[-6] = Stack[-2]
...
0xac6: Pop(0)
0xac7: Push("scripted") // @poff=877
0xac8: Push("blood_dir.xml") // @poff=895
...
0xad3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=166
0xad4: Pop(0)
...
0xae3: @@ GetPosition(Stack[-8]); Obj=20 // @poff=166
0xae4: Pop(0)
0xae5: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=302
0xae6: Pop(0)
...
0xb44: Push("Can't find lsh animation : ") // @poff=923
...
0xb53: Push("Can't find lsh animation : ") // @poff=923
...
0xb59: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=302
0xb5a: Pop(0)
...
0xb77: Stack[-10] = Stack[-2]
0xb78: Stack[-9] = Stack[-1]
0xb79: Call2 0xbcf
...
0xbb6: Push((float)9.999999974752427e-07)
...
0xbe9: Stack[-5] = Stack[-2]
0xbea: Stack[-4] = Stack[-1]
0xbeb: Call2 0xbd4

0xbec: Pop(2)
0xbed: PushEmpty(float, cvector)
0xbee: Stack[-5] = Stack[-1]
0xbef: Call2 0xbdd
...
0xc2a: Stack[-1] = 0
0xc2b: PushEmpty()
0xc2c: Push("ood1Doberman2_1") // @poff=993
0xc2d: Push((int) 1)
...
0xc33: Stack[-1] = "ood1Doberman2_1" // @poff=993
0xc34: Call2 0xbf8
...
0xc64: Push("GenerateMoney: iMin > iMax") // @poff=1039
0xc65: @ Trace(Stack[-1])
0xc66: Pop(1)
0xc67: Return(); Pop(4)
...
0xc82: Pop(0)
0xc83: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1105
0xc84: Pop(0)
0xc85: Push("Organ") // @poff=1117
0xc86: Push((int) 1)
0xc87: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=756
0xc88: Pop(2)
0xc89: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1129
0xc8a: Pop(0)
0xc8b: Push((int) 0)
0xc8c: Push((int) 1)
...
0xc99: Stack[-1] = "liver" // @poff=1139
0xc9a: Call2 0xc80

0xc9b: Pop(1)
0xc9c: PushEmpty(string)
0xc9d: Stack[-1] = "kidney" // @poff=1151
0xc9e: Call2 0xc80

0xc9f: Pop(1)
0xca0: PushEmpty(string)
0xca1: Stack[-1] = "heart" // @poff=1165
0xca2: Call2 0xc80

0xca3: Pop(1)
0xca4: PushEmpty(string)
0xca5: Stack[-1] = "blood" // @poff=1177
0xca6: Call2 0xc80
...
0xcd7: Stack[-4] = "meradorm" // @poff=1235
0xcd8: Stack[-3] = (int) 2
0xcd9: Stack[-2] = (int) 3
0xcda: Stack[-1] = (int) 3
0xcdb: Call2 0xb75
...
0xce1: Stack[-3] = "beta_pills" // @poff=1253
0xce2: Stack[-2] = (int) 1
0xce3: Stack[-1] = (int) 4
0xce4: Call2 0xb6a
...
0xcea: Stack[-4] = "monomicin" // @poff=1275
0xceb: Stack[-3] = (int) 1
0xcec: Stack[-2] = (int) 2
0xced: Stack[-1] = (int) 2
0xcee: Call2 0xb75
...
0xcf5: Stack[-3] = "monomicin" // @poff=1275
0xcf6: Stack[-2] = (int) 1
0xcf7: Stack[-1] = (int) 2
0xcf8: Call2 0xb6a
...
0xcfc: Stack[-3] = "lockpick" // @poff=1295
0xcfd: Stack[-2] = (int) 1
0xcfe: Stack[-1] = (int) 4
0xcff: Call2 0xb6a
...
0xd02: Stack[-3] = "rifle_ammo" // @poff=1313
0xd03: Stack[-2] = (int) 1
0xd04: Stack[-1] = (int) 2
0xd05: Call2 0xb6a
...
0xd08: Stack[-3] = "revolver_ammo" // @poff=1335
0xd09: Stack[-2] = (int) 1
0xd0a: Stack[-1] = (int) 2
0xd0b: Call2 0xb6a
...
0xd0e: Stack[-4] = "samopal_ammo" // @poff=1363
0xd0f: Stack[-3] = (int) 1
0xd10: Stack[-2] = (int) 2
0xd11: Stack[-1] = (int) 2
0xd12: Call2 0xb75
...
0xd18: Stack[-4] = "monomicin" // @poff=1275
0xd19: Stack[-3] = (int) 1
0xd1a: Stack[-2] = (int) 2
0xd1b: Stack[-1] = (int) 2
0xd1c: Call2 0xb75
...
0xd23: Stack[-3] = "monomicin" // @poff=1275
0xd24: Stack[-2] = (int) 1
0xd25: Stack[-1] = (int) 2
0xd26: Call2 0xb6a
...
0xd4b: Stack[-7] = Stack[-3]
0xd4c: Stack[-6] = Stack[-2]
0xd4d: Stack[-5] = Stack[-1]
0xd4e: Call2 0xa80
...
0xd53: Stack[-11] = Stack[-5]
0xd54: Stack[-10] = Stack[-4]
0xd55: Stack[-9] = Stack[-3]
0xd56: Stack[-7] = Stack[-2]
0xd57: Stack[-6] = Stack[-1]
0xd58: Call2 0xac4
...
0xd7b: PushEmpty()
0xd7c: Push("unholster") // @poff=1389
...
0xda3: @@ IsWeaponHolstered(Stack[-1]); Obj=3 // @poff=1433
0xda4: Pop(0)
...
0xe18: Stack[-4] = Stack[-1]
0xe19: Call2 0xe04

0xe1a: Stack[-2] = Stack[-5]
0xe1b: Pop(2)
0xe1c: Return(); Pop(0)
...
0xe3b: Push(Stack[-1])
0xe3c: IF (Stack[-1] == 1) GOTO 0xe45; Pop(1)

0xe3d: PushEmpty(float, object)
0xe3e: Stack[-5] = Stack[-1]
0xe3f: Call2 0x9b1

0xe40: Pop(1)
0xe41: Push((int) 2250000)
0xe42: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xe43: IF (Stack[-1] == 1) GOTO 0xe45; Pop(1)
...
0xe5f: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1475
0xe60: Return(); Pop(0)

0xe61: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1515
0xe62: Return(); Pop(0)
...
0xe8c: Pop(0)
0xe8d: Push((float)-0.10000000149011612)
0xe8e: Push((bool) 1)
