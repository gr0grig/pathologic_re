...
// @pool_raw:
// @pool_encoding:utf8
...
0x750: Push("Can't find lsh animation : ") // @poff=961
...
0x75f: Push("Can't find lsh animation : ") // @poff=961
...
0x7bd: Stack[-2] = Stack[-4]
0x7be: Return(); Pop(0)

0x7bf: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x7c0: IF (Stack[-1] == 0) GOTO 0x7c3; Pop(1)

0x7c1: Stack[-1] = Stack[-4]
0x7c2: Return(); Pop(0)

0x7c3: Stack[-3] = Stack[-4]
0x7c4: Return(); Pop(0)

0x7c5: PushEmpty()
0x7c6: Pop(0); Push((bool) Stack[-2] == 0)
...
0x7df: Stack[-8] = Stack[-5]
0x7e0: Stack[-4] = "reputation" // @poff=1017
0x7e1: Stack[-7] = Stack[-3]
0x7e2: Stack[-2] = (int) 0
0x7e3: Stack[-1] = (int) 1
0x7e4: Call2 0x5c5
...
0x7fb: Pop(0)
0x7fc: @@ add(Stack[-3]); Obj=1 // @poff=902
0x7fd: Pop(0)
0x7fe: Push((int) 16)
...
0x805: Pop(0)
0x806: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x825: Stack[-2] = "quest_d2_02" // @poff=1053
0x826: Stack[-1] = "player_attack" // @poff=1077
0x827: Call2 0x803
...
0x82c: Stack[-2] = "quest_d2_02" // @poff=1053
0x82d: Stack[-1] = "completed" // @poff=1105
0x82e: Call2 0x803
...
0x857: Pop(0)
0x858: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1139
0x859: Pop(0)
0x85a: Push("Organ") // @poff=1151
0x85b: Push((int) 1)
0x85c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=754
0x85d: Pop(2)
0x85e: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1163
0x85f: Pop(0)
0x860: Push((int) 0)
0x861: Push((int) 1)
...
0x86e: Stack[-1] = "liver" // @poff=1173
0x86f: Call2 0x855

0x870: Pop(1)
0x871: PushEmpty(string)
0x872: Stack[-1] = "kidney" // @poff=1185
0x873: Call2 0x855

0x874: Pop(1)
0x875: PushEmpty(string)
0x876: Stack[-1] = "heart" // @poff=1199
0x877: Call2 0x855

0x878: Pop(1)
0x879: PushEmpty(string)
0x87a: Stack[-1] = "blood" // @poff=1211
0x87b: Call2 0x855
...
0x888: GlobalVars[0] = Stack[-1]; Pop(1)
0x889: PushEmpty(bool, string, string)
0x88a: Stack[-2] = "quest_d2_02" // @poff=1053
0x88b: Stack[-1] = "player_attack" // @poff=1077
0x88c: Call2 0x803
...
0x890: Stack[-2] = "quest_d2_02" // @poff=1053
0x891: Stack[-1] = "mpatrol_unload" // @poff=1223
0x892: Call2 0x803
...
0x896: Push("revolver_ammo") // @poff=1253
0x897: Push((int) 0)
0x898: Push((int) 2)
0x899: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x89a: Pop(3)
0x89b: Push("alpha_pills") // @poff=1281
0x89c: Push((int) 0)
0x89d: Push((int) 2)
...
0x8a6: Stack[-6] = Stack[-2]
0x8a7: Stack[-1] = (float) -0.15000000596046448
0x8a8: Call2 0x7c5
...
0x8af: Push(-1, 0); TaskCall(4)
0x8b0: Call2 0x47f

0x8b1: Pop(-1, 0); TaskReturn
0x8b2: Pop(1)
0x8b3: Return(); Pop(2)

0x8b4: PushEmpty()
0x8b5: PushEmpty(object, int, float)
0x8b6: Stack[-7] = Stack[-3]
0x8b7: Stack[-6] = Stack[-2]
...
0x8be: Stack[-11] = Stack[-5]
0x8bf: Stack[-10] = Stack[-4]
0x8c0: Stack[-9] = Stack[-3]
0x8c1: Stack[-7] = Stack[-2]
...
0x8dd: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1305
0x8de: Return(); Pop(0)

0x8df: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1345
0x8e0: Return(); Pop(0)
