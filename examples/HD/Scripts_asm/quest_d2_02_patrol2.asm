...
// @pool_raw:
// @pool_encoding:utf8
...
0x74a: Push("voice_common") // @poff=961
0x74b: Push((int) 1)
...
0x752: Push("voice_common") // @poff=961
0x753: Push((int) 0)
...
0x765: Push("voice_common") // @poff=961
0x766: Push((int) 1)
...
0x773: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=730
0x774: Pop(1)
...
0x79e: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=730
0x79f: Pop(1)
...
0x7b3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=742
0x7b4: Pop(1)
0x7b5: PushEmpty(bool, string)
0x7b6: Stack[-3] = Stack[-1]
0x7b7: Call2 0x7e5

0x7b8: Stack[-2] = Stack[-14]
0x7b9: Pop(2)
0x7ba: Return(); Pop(10)
...
0x7c6: Push("Can't find lsh animation : ") // @poff=995
...
0x7d5: Push("Can't find lsh animation : ") // @poff=995
...
0x7db: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x7dc: Pop(0)
...
0x82d: Push((float)9.999999974752427e-07)
...
0x860: Stack[-2] = Stack[-1]
0x861: Call2 0x87e

0x862: Pop(1)
0x863: PushEmpty(bool, object, string, float, float, float)
0x864: Stack[-8] = Stack[-5]
0x865: Stack[-4] = "reputation" // @poff=1051
0x866: Stack[-7] = Stack[-3]
0x867: Stack[-2] = (int) 0
0x868: Stack[-1] = (int) 1
0x869: Call2 0x5b1
...
0x880: Pop(0)
0x881: @@ add(Stack[-3]); Obj=1 // @poff=902
0x882: Pop(0)
0x883: Push((int) 16)
...
0x8d7: Pop(0)
0x8d8: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1101
0x8d9: Pop(0)
0x8da: Push("Organ") // @poff=1113
0x8db: Push((int) 1)
0x8dc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=754
0x8dd: Pop(2)
0x8de: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1125
0x8df: Pop(0)
0x8e0: Push((int) 0)
0x8e1: Push((int) 1)
...
0x8ee: Stack[-1] = "liver" // @poff=1135
0x8ef: Call2 0x8d5

0x8f0: Pop(1)
0x8f1: PushEmpty(string)
0x8f2: Stack[-1] = "kidney" // @poff=1147
0x8f3: Call2 0x8d5

0x8f4: Pop(1)
0x8f5: PushEmpty(string)
0x8f6: Stack[-1] = "heart" // @poff=1161
0x8f7: Call2 0x8d5

0x8f8: Pop(1)
0x8f9: PushEmpty(string)
0x8fa: Stack[-1] = "blood" // @poff=1173
0x8fb: Call2 0x8d5
...
0x90a: Stack[-2] = "quest_d2_02" // @poff=1185
0x90b: Stack[-1] = "player_attack" // @poff=1209
0x90c: Call2 0x888
...
0x910: Stack[-2] = "quest_d2_02" // @poff=1185
0x911: Stack[-1] = "patrol2_unload" // @poff=1237
0x912: Call2 0x888
...
0x926: Stack[-6] = Stack[-2]
0x927: Stack[-1] = (float) -0.15000000596046448
0x928: Call2 0x84a
...
0x936: Stack[-7] = Stack[-3]
0x937: Stack[-6] = Stack[-2]
0x938: Stack[-5] = Stack[-1]
0x939: Call2 0x67d
...
0x93e: Stack[-11] = Stack[-5]
0x93f: Stack[-10] = Stack[-4]
0x940: Stack[-9] = Stack[-3]
0x941: Stack[-7] = Stack[-2]
0x942: Stack[-6] = Stack[-1]
0x943: Call2 0x6c1
...
0x95d: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1319
0x95e: Return(); Pop(0)

0x95f: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1359
0x960: Return(); Pop(0)
