...
// @pool_raw:
// @pool_encoding:utf8
...
0x25b: Push("Can't find lsh animation : ") // @poff=236
...
0x26a: Push("Can't find lsh animation : ") // @poff=236
...
0x27f: Push((float)9.999999974752427e-07)
...
0x290: PushEmpty()
0x291: Push("ood2Birdmask1") // @poff=292
0x292: Push((int) 1)
...
0x29e: Pop(1)
0x29f: Push("d2q03BirdmaskGotoLara") // @poff=320
0x2a0: Push("pt_map_lara") // @poff=364
0x2a1: Push((int) 0)
...
0x2a5: Pop(0)
0x2a6: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=388
0x2a7: Pop(5)
0x2a8: PushEmpty()
0x2a9: Call2 0x2d1
...
0x2af: Stack[-1] = "KnowTheater" // @poff=396
0x2b0: Call2 0x286
...
0x2bb: Stack[-1] = "ood2Birdmask1" // @poff=292
0x2bc: Call2 0x286
...
0x2e3: Push("Can't retrieve diary root") // @poff=420
0x2e4: @ Trace(Stack[-1])
0x2e5: Pop(1)
...
0x2ef: Pop(1)
0x2f0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=472
0x2f1: Pop(0)
0x2f2: Pop(0); Push((bool) Stack[-2] == 0)
0x2f3: IF (Stack[-1] == 0) GOTO 0x2fa; Pop(1)

0x2f4: Push("Can't find diary parent with id: ") // @poff=477
...
0x2fa: @@ AddChild(Stack[-8]); Obj=2 // @poff=545
0x2fb: Pop(0)
0x2fc: Push((int) 7)
0x2fd: @ SendWorldWndMessage(Stack[-1])
0x2fe: Pop(1)
0x2ff: @@ GetCategory(Stack[-1]); Obj=8 // @poff=554
0x300: Pop(0)
...
0x309: Pop(0)
0x30a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x30b: IF (Stack[-1] == 0) GOTO 0x312; Pop(1)

0x30c: Push("Can't find main outdoor scene") // @poff=566
0x30d: @ Trace(Stack[-1])
0x30e: Pop(1)
0x30f: Stack[-1] = 0
0x310: Stack[-1] = Stack[-5]
0x311: Return(); Pop(4)

0x312: @@ GetMap(Stack[-1]); Obj=2 // @poff=626
0x313: Pop(0)
...
0x32d: Stack[-1] = "ui/NPC_bmask.png" // @poff=647
0x32e: Return(); Pop(0)

0x32f: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=681
0x330: Return(); Pop(0)
