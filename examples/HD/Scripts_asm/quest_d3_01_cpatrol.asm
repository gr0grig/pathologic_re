...
// @pool_raw:
// @pool_encoding:utf8
...
0x73c: Pop(1)
0x73d: Push(CvectorIndex(Stack[-4], 0))
0x73e: Push(CvectorIndex(Stack[-5], 2))
...
0x771: Push("Can't find lsh animation : ") // @poff=937
...
0x780: Push("Can't find lsh animation : ") // @poff=937
0x781: Pop(1); Push(Stack[-1] + Stack[-9]);
0x782: @ Trace(Stack[-1])
0x783: Pop(1)
0x784: Return(); Pop(6)

0x785: PushEmpty(float, cvector, float, cvector)
0x786: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x787: Pop(0)
0x788: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x789: Push(CvectorIndex(Stack[-1], 1))
0x78a: Stack[-3] = Stack[-1]
0x78b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x78c: Push("head") // @poff=460
...
0x799: Pop(0)
0x79a: Pop(0); Push((bool) Stack[-8] == 0)
0x79b: IF (Stack[-1] == 0) GOTO 0x7b0; Pop(1)

0x79c: Stack[-7] = (int) 0
0x79d: Push((int) 1)
0x79e: Pop(1); Push(Stack[-8] + Stack[-1]);
0x79f: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7a0: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7a1: Pop(1)
0x7a2: Pop(0); Push((bool) Stack[-6] == 0)
0x7a3: IF (Stack[-1] == 0) GOTO 0x7a5; Pop(1)

0x7a4: GOTO 0x7a8

0x7a5: Push((int) 1)
0x7a6: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7a7: GOTO 0x79d

0x7a8: Pop(0); Push((bool) Stack[-7] == 0)
...
0x7ac: Pop(0)
0x7ad: Push((int) 1)
0x7ae: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7af: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x7b7: Pop(0)
0x7b8: Push((int) 50)
0x7b9: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x7ba: Push(CvectorIndex(Stack[-1], 1))
0x7bb: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x7bc: CvectorIndex(Stack[-2], 1) = Stack[-1];
...
0x7c7: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7c8: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x7c9: Push((float)9.999999974752427e-07)
...
0x7ce: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x7cf: Return(); Pop(2)

0x7d0: PushEmpty(cvector, cvector)
0x7d1: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x7d2: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x7d3: Return(); Pop(2)
...
0x801: Stack[-4] = "reputation" // @poff=993
...
0x80b: Pop(0)
0x80c: @@ add(Stack[-3]); Obj=1 // @poff=878
0x80d: Pop(0)
0x80e: Push((int) 0)
...
0x81c: Pop(0)
0x81d: @@ add(Stack[-3]); Obj=1 // @poff=878
0x81e: Pop(0)
0x81f: Push((int) 16)
...
0x826: Pop(0)
0x827: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x849: Stack[-2] = "quest_d3_01" // @poff=1029
0x84a: Stack[-1] = "patrol_talk" // @poff=1053
0x84b: Call2 0x824
...
0x860: Push("Can't retrieve diary root") // @poff=1077
0x861: @ Trace(Stack[-1])
0x862: Pop(1)
0x863: Stack[-3] = (bool) 0
0x864: Return(); Pop(2)

0x865: Stack[-1] = Stack[-3]
0x866: Return(); Pop(2)
...
0x86c: Pop(1)
0x86d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1129
0x86e: Pop(0)
0x86f: Pop(0); Push((bool) Stack[-2] == 0)
0x870: IF (Stack[-1] == 0) GOTO 0x877; Pop(1)

0x871: Push("Can't find diary parent with id: ") // @poff=1134
0x872: Pop(1); Push(Stack[-1] + Stack[-8]);
0x873: @ Trace(Stack[-1])
0x874: Pop(1)
0x875: Stack[-9] = (bool) 0
0x876: Return(); Pop(6)

0x877: @@ AddChild(Stack[-8]); Obj=2 // @poff=1202
0x878: Pop(0)
0x879: Push((int) 7)
0x87a: @ SendWorldWndMessage(Stack[-1])
0x87b: Pop(1)
0x87c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1211
0x87d: Pop(0)
...
0x8aa: Pop(0)
0x8ab: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1237
0x8ac: Pop(0)
0x8ad: Push("Organ") // @poff=1249
0x8ae: Push((int) 1)
0x8af: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=730
0x8b0: Pop(2)
0x8b1: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1261
0x8b2: Pop(0)
0x8b3: Push((int) 0)
0x8b4: Push((int) 1)
...
0x8c1: Stack[-1] = "liver" // @poff=1271
0x8c2: Call2 0x8a8

0x8c3: Pop(1)
0x8c4: PushEmpty(string)
0x8c5: Stack[-1] = "kidney" // @poff=1283
0x8c6: Call2 0x8a8

0x8c7: Pop(1)
0x8c8: PushEmpty(string)
0x8c9: Stack[-1] = "heart" // @poff=1297
0x8ca: Call2 0x8a8

0x8cb: Pop(1)
0x8cc: PushEmpty(string)
0x8cd: Stack[-1] = "blood" // @poff=1309
0x8ce: Call2 0x8a8
...
0x8d2: Push("revolver_ammo") // @poff=1321
0x8d3: Push((int) 0)
0x8d4: Push((int) 2)
0x8d5: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8d6: Pop(3)
0x8d7: Push("alpha_pills") // @poff=1349
0x8d8: Push((int) 0)
0x8d9: Push((int) 2)
...
0x919: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1373
0x91a: Return(); Pop(0)

0x91b: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1413
0x91c: Return(); Pop(0)
