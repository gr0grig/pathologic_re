...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
// @pool_encoding:utf8
...
0x186: PushEmpty()
0x187: Push("kill_player") // @poff=156
...
0x193: Push("talk_player") // @poff=180
...
0x19e: Stack[-2] = "quest_d3_01" // @poff=204
0x19f: Stack[-1] = "kill_player" // @poff=156
0x1a0: Call2 0x8c4
...
0x1a4: @ GetPFPosition(Stack[-1]T)
0x1a5: Pop(0)
0x1a6: @ GetDirection(Stack[-0]T)
0x1a7: Pop(0)
0x1a8: PushEmpty()
0x1a9: Call2 0x1fc
...
0x1c5: @ FindPathTo(Stack[-1], Stack[-1]T)
0x1c6: Pop(0)
...
0x1e7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1e8: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x20b: Stack[-1] = 0
0x20c: PushEmpty()
0x20d: Stack[-3] = (float) 0.15000000596046448
0x20e: Return(); Pop(0)
...
0x227: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x228: Pop(0)
0x229: Push(Stack[-8])
0x22a: IF (Stack[-1] == 0) GOTO 0x233; Pop(1)

0x22b: Push("attack") // @poff=284
...
0x247: Pop(0)
0x248: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=298
0x249: Pop(0)
...
0x263: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=298
0x264: Pop(0)
...
0x27d: Pop(1)
0x27e: Push("all") // @poff=138
0x27f: Push("attack_on") // @poff=312
...
0x297: IF (Stack[-1] == 1) GOTO 0x29d; Pop(1)

0x298: PushEmpty(bool)
0x299: Call2 0x469

0x29a: Pop(0)
0x29b: IF (Stack[-1] == 1) GOTO 0x29d; Pop(1)

0x29c: Stack[-1] = (bool) 0
0x29d: IF (Stack[-1] == 0) GOTO 0x2ae; Pop(1)

0x29e: @ Face(Stack[-0]T)
0x29f: Pop(0)
0x2a0: PushEmpty()
0x2a1: Call2 0x49b
...
0x2ae: @ Face(Stack[-0]T)
0x2af: Pop(0)
0x2b0: Push("all") // @poff=138
0x2b1: Push("fjump") // @poff=356
...
0x2cc: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=298
0x2cd: Pop(0)
...
0x2ec: Push("attack_off") // @poff=368
...
0x2fa: Push("attack_begin") // @poff=390
0x2fb: Push((int) 1)
0x2fc: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x307: Push("attack") // @poff=284
0x308: Push((int) 1)
0x309: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x31b: Push((float)0.8999999761581421)
0x31c: Pop(1); Push(Stack[-9] * Stack[-1]);
0x31d: @ GetVictim(Stack[-1], Stack[-4])
0x31e: Pop(1)
0x31f: @ ReportAttack(Stack[-0]T)
0x320: Pop(0)
...
0x325: Stack[-10] = Stack[-1]
0x326: Call2 0x20c

0x327: Stack[-3] = Stack[-5]
0x328: Pop(3)
0x329: PushEmpty(float, object, float, int)
0x32a: Stack[-7] = Stack[-3]
0x32b: Stack[-6] = Stack[-2]
0x32c: PushEmpty(int, object, int)
0x32d: Stack[-10] = Stack[-2]
0x32e: Stack[-14] = Stack[-1]
0x32f: Call2 0x20f

0x330: Stack[-3] = Stack[-4]
0x331: Pop(3)
0x332: Call2 0x67d

0x333: Stack[-4] = Stack[-5]
0x334: Pop(4)
0x335: PushEmpty(int)
0x336: Call2 0x499

0x337: Pop(0)
0x338: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x339: Pop(1)
0x33a: PushEmpty(object, float)
0x33b: Stack[-5] = Stack[-2]
...
0x344: Pop(0)
0x345: @ irand(Stack[-4], Stack[-1]T)
0x346: Pop(0)
0x347: Push((int) 1)
0x348: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x349: @ Face(Stack[-0]T)
0x34a: Pop(0)
0x34b: Push((bool) 1)
...
0x352: Push("attack_begin") // @poff=390
...
0x366: Stack[-11] = Stack[-2]
0x367: Stack[-6] = Stack[-1]
0x368: Call2 0x31a

0x369: Pop(2)
0x36a: Push("all") // @poff=138
0x36b: Push("attack_middle") // @poff=428
...
0x373: Pop(0)
0x374: Push("all") // @poff=138
0x375: Push("attack_middle") // @poff=428
...
0x3af: Stack[-11] = Stack[-2]
0x3b0: Stack[-6] = Stack[-1]
0x3b1: Call2 0x31a
...
0x3b8: Pop(1)
0x3b9: Push("all") // @poff=138
0x3ba: Push("attack_end") // @poff=460
...
0x3f9: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=298
0x3fa: Pop(0)
...
0x445: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x446: Pop(1)
...
0x44a: @ Face(Stack[-0]T)
0x44b: Pop(0)
0x44c: Push("all") // @poff=138
0x44d: Push("bjump") // @poff=416
0x44e: @ PlayAnimation(Stack[-2], Stack[-1])
0x44f: Pop(2)
0x450: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=298
0x451: Pop(0)
...
0x487: @ irand(Stack[-1], Stack[-2]T)
0x488: Pop(0)
0x489: Push((int) 1)
0x48a: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x48b: Push("attack") // @poff=284
...
0x49c: Stack[-1] = "attack_stay" // @poff=332
0x49d: Call2 0x818
...
0x4c7: Stack[-15] = Stack[-5]
0x4c8: Stack[-14] = Stack[-4]
0x4c9: Stack[-13] = Stack[-3]
0x4ca: Stack[-12] = Stack[-2]
0x4cb: Stack[-11] = Stack[-1]
0x4cc: Call2 0x511

0x4cd: Stack[-6] = Stack[-7]
0x4ce: Pop(6)
0x4cf: Push( Stack[2 + Tasks[-1].StackPointer] )
0x4d0: IF (Stack[-1] == 0) GOTO 0x4d4; Pop(1)

0x4d1: Push("head") // @poff=518
...
0x514: Stack[-17] = Stack[-7]
0x515: PushEmpty(bool, object)
0x516: Stack[-23] = Stack[-1]
0x517: Call2 0x59d
...
0x51d: @@ GetPosition(Stack[-5]); Obj=21 // @poff=528
0x51e: Pop(0)
...
0x534: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=298
0x535: Pop(0)
...
0x546: Push((int) 0)
0x547: Push((float)0.30000001192092896)
...
0x59f: Stack[-3] = Stack[-1]
0x5a0: Call2 0x6ef

0x5a1: Stack[-2] = Stack[-4]
0x5a2: Pop(2)
0x5a3: Return(); Pop(0)

0x5a4: Stack[-1] = "walk" // @poff=540
0x5a5: Return(); Pop(0)

0x5a6: Stack[-1] = "run" // @poff=550
0x5a7: Return(); Pop(0)
...
0x5c0: Pop(0); PushNull((bool) Stack[-21] == 0)
0x5c1: IF (Stack[-1] == 0) GOTO 0x5c7; Pop(1)

0x5c2: PushEmpty(string)
0x5c3: Stack[-1] = "fdie" // @poff=558
0x5c4: Call2 0x61a

0x5c5: Pop(1)
0x5c6: GOTO 0x619

0x5c7: @@ GetPosition(Stack[-10]); Obj=21 // @poff=528
0x5c8: Pop(0)
...
0x5d8: Stack[-6] = "fdie" // @poff=558
0x5d9: GOTO 0x5db

0x5da: Stack[-6] = "bdie" // @poff=568
...
0x5e1: @ StopAsync()
0x5e2: Pop(0)
0x5e3: Stack[-21] = Stack[-5]
0x5e4: Push("GetScriptProperty") // @poff=578
0x5e5: Push((int) 2)
0x5e6: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x5e7: IF (Stack[-1] == 0) GOTO 0x5f3; Pop(1)

0x5e8: Push("Owner") // @poff=614
0x5e9: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=626
0x5ea: Pop(1)
0x5eb: Push(Stack[-4])
0x5ec: IF (Stack[-1] == 0) GOTO 0x5f3; Pop(1)

0x5ed: Push("Owner") // @poff=614
0x5ee: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=644
0x5ef: Pop(1)
0x5f0: Pop(0); PushNull((bool) Stack[-5] == 0)
0x5f1: IF (Stack[-1] == 0) GOTO 0x5f3; Pop(1)

0x5f2: Stack[-21] = Stack[-5]
0x5f3: Push("@GetEyesHeight") // @poff=662
0x5f4: Push((int) 1)
0x5f5: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x5f6: IF (Stack[-1] == 0) GOTO 0x602; Pop(1)

0x5f7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=692
0x5f8: Pop(0)
...
0x60e: @ StopAsync()
0x60f: Pop(0)
0x610: Push("head") // @poff=518
0x611: @ UnlookAsync(Stack[-1])
0x612: Pop(1)
0x613: Push("all") // @poff=138
...
0x644: Stack[-2] = "bullet" // @poff=716
0x645: Return(); Pop(0)

0x646: Stack[-2] = "phys" // @poff=730
0x647: Return(); Pop(0)

0x648: PushEmpty(cvector, cvector, cvector, cvector)
0x649: @ GetPosition(Stack[-2])
0x64a: Pop(0)
0x64b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=528
0x64c: Pop(0)
...
0x651: Pop(0)
0x652: Stack[-1] = Stack[-4]
0x653: Return(); Pop(2)

0x654: PushEmpty(bool, bool)
0x655: Push("HasProperty") // @poff=740
0x656: Push((int) 2)
...
0x65c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=764
0x65d: Pop(0)
...
0x662: Stack[-10] = Stack[-2]
0x663: Stack[-9] = Stack[-1]
0x664: Call2 0x654
...
0x66a: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=776
0x66b: Pop(0)
0x66c: PushEmpty(float, float, float, float)
0x66d: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x66e: Stack[-8] = Stack[-2]
0x66f: Stack[-7] = Stack[-1]
0x670: Call2 0x85c

0x671: Pop(3)
0x672: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=788
0x673: Pop(1)
0x674: Stack[-8] = (bool) 1
0x675: Return(); Pop(2)

0x676: PushEmpty(int, int)
0x677: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=776
0x678: Pop(0)
0x679: Pop(0); Push(Stack[-1] + Stack[-3]);
0x67a: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=788
0x67b: Pop(1)
0x67c: Return(); Pop(2)

0x67d: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x67e: PushEmpty(bool, object, string)
0x67f: Stack[-18] = Stack[-2]
0x680: Stack[-1] = "health" // @poff=800
0x681: Call2 0x654
...
0x688: Stack[-18] = Stack[-2]
0x689: Stack[-1] = "armor" // @poff=814
0x68a: Call2 0x654
...
0x690: Push("armor") // @poff=814
0x691: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=776
0x692: Pop(1)
0x693: Push("armor_") // @poff=826
0x694: PushEmpty(string, int)
0x695: Stack[-16] = Stack[-1]
0x696: Call2 0x63a

0x697: Pop(1)
0x698: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x699: PushEmpty(bool, object, string)
0x69a: Stack[-18] = Stack[-2]
0x69b: Stack[-8] = Stack[-1]
0x69c: Call2 0x654
...
0x6a2: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=776
0x6a3: Pop(0)
...
0x6aa: Stack[-3] = Stack[-6]
0x6ab: Pop(3)
0x6ac: Push("health") // @poff=800
0x6ad: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=776
0x6ae: Pop(1)
0x6af: Push((int) 1)
0x6b0: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6b1: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6b2: Push("health") // @poff=800
...
0x6b8: Pop(3)
0x6b9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=788
0x6ba: Pop(2)
0x6bb: PushEmpty(bool, object)
0x6bc: Stack[-17] = Stack[-1]
0x6bd: Call2 0x64f
...
0x6c3: Pop(1)
0x6c4: Stack[-1] = Stack[-16]
0x6c5: Return(); Pop(12)

0x6c6: PushEmpty(bool, bool)
0x6c7: @@ IsDead(Stack[-1]); Obj=3 // @poff=840
0x6c8: Pop(0)
0x6c9: Stack[-1] = Stack[-4]
0x6ca: Return(); Pop(2)

0x6cb: PushEmpty(object, object, object, object)
0x6cc: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6e0: Pop(0)
0x6e1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6e2: IF (Stack[-1] == 0) GOTO 0x6e5; Pop(1)

0x6e3: Stack[-6] = (bool) 0
0x6e4: Return(); Pop(4)

0x6e5: @@ GetScene(Stack[-1]); Obj=5 // @poff=861
0x6e6: Pop(0)
...
0x6f9: Stack[-6] = Stack[-2]
0x6fa: Stack[-1] = "noaccess" // @poff=870
0x6fb: Call2 0x654
...
0x701: Push("noaccess") // @poff=870
0x702: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=776
0x703: Pop(1)
0x704: Push((int) 0)
...
0x708: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x716: @@ GetPosition(Stack[-5]); Obj=15 // @poff=528
0x717: Pop(0)
...
0x727: Stack[-1] = "fhit" // @poff=888
0x728: GOTO 0x72a

0x729: Stack[-1] = "bhit" // @poff=898
0x72a: Push("hit_react") // @poff=908
0x72b: Push("1") // @poff=224
0x72c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x72d: Push("2") // @poff=928
...
0x746: Stack[-25] = Stack[-1]
0x747: Call2 0x648

0x748: Stack[-2] = Stack[-3]
0x749: Pop(2)
0x74a: Call2 0x847

0x74b: Stack[-2] = Stack[-11]
0x74c: Pop(2)
0x74d: @ CreateVectorVector(Stack[-8])
0x74e: Pop(0)
0x74f: Stack[-7] = (int) 1
0x750: Push("hit") // @poff=890
...
0x765: Pop(0)
0x766: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=941
0x767: Pop(0)
0x768: PushEmpty(object, int, float, cvector, cvector)
0x769: Stack[-26] = Stack[-5]
0x76a: Stack[-25] = Stack[-4]
0x76b: Stack[-24] = Stack[-3]
0x76c: Stack[-6] = Stack[-2]
...
0x779: Pop(0)
0x77a: Push("scripted") // @poff=945
0x77b: Push("blood_dir.xml") // @poff=963
...
0x786: @@ GetPosition(Stack[-3]); Obj=7 // @poff=528
0x787: Pop(0)
...
0x791: @@ GetPosition(Stack[-8]); Obj=20 // @poff=528
0x792: Pop(0)
0x793: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=692
0x794: Pop(0)
...
0x7f2: Push("Can't find lsh animation : ") // @poff=991
...
0x801: Push("Can't find lsh animation : ") // @poff=991
...
0x807: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=692
0x808: Pop(0)
...
0x84a: Push((float)9.999999974752427e-07)
...
0x865: Stack[-3] = Stack[-4]
0x866: Return(); Pop(0)

0x867: PushEmpty(object, object)
0x868: @ CreateIntVector(Stack[-1])
0x869: Pop(0)
0x86a: @@ add(Stack[-4]); Obj=1 // @poff=932
0x86b: Pop(0)
0x86c: @@ add(Stack[-3]); Obj=1 // @poff=932
0x86d: Pop(0)
0x86e: Push((int) 3)
...
0x875: Stack[-7] = Stack[-3]
0x876: Stack[-2] = "money" // @poff=1047
...
0x89c: Stack[-2] = Stack[-1]
0x89d: Call2 0x8ba

0x89e: Pop(1)
0x89f: PushEmpty(bool, object, string, float, float, float)
0x8a0: Stack[-8] = Stack[-5]
0x8a1: Stack[-4] = "reputation" // @poff=1071
0x8a2: Stack[-7] = Stack[-3]
0x8a3: Stack[-2] = (int) 0
0x8a4: Stack[-1] = (int) 1
0x8a5: Call2 0x660
...
0x8bc: Pop(0)
0x8bd: @@ add(Stack[-3]); Obj=1 // @poff=932
0x8be: Pop(0)
0x8bf: Push((int) 16)
...
0x8c6: Pop(0)
0x8c7: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x8e3: Stack[-1] = 0
0x8e4: PushEmpty()
0x8e5: Push("d3q01") // @poff=1107
0x8e6: Push((int) 8)
0x8e7: @ SetVariable(Stack[-2], Stack[-1])
0x8e8: Pop(2)
0x8e9: PushEmpty(bool, string, string)
0x8ea: Stack[-2] = "quest_d3_01" // @poff=204
0x8eb: Stack[-1] = "gpatrol_attack" // @poff=1119
0x8ec: Call2 0x8c4
...
0x8f8: Stack[-2] = "quest_d3_01" // @poff=204
0x8f9: Stack[-1] = "gpatrol_talk" // @poff=1149
0x8fa: Call2 0x8c4
...
0x8fd: PushEmpty()
0x8fe: Push("playsound") // @poff=1175
0x8ff: Push("givemoney") // @poff=1195
...
0x905: Stack[-5] = Stack[-2]
0x906: Stack[-1] = (float) -0.30000001192092896
0x907: Call2 0x886
...
0x915: Push("money") // @poff=1047
0x916: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=776
0x917: Pop(1)
...
0x941: Pop(0)
0x942: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1229
0x943: Pop(0)
0x944: Push("Organ") // @poff=1241
0x945: Push((int) 1)
0x946: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=788
0x947: Pop(2)
0x948: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1253
0x949: Pop(0)
0x94a: Push((int) 0)
0x94b: Push((int) 1)
...
0x958: Stack[-1] = "liver" // @poff=1263
0x959: Call2 0x93f

0x95a: Pop(1)
0x95b: PushEmpty(string)
0x95c: Stack[-1] = "kidney" // @poff=1275
0x95d: Call2 0x93f

0x95e: Pop(1)
0x95f: PushEmpty(string)
0x960: Stack[-1] = "heart" // @poff=1289
0x961: Call2 0x93f

0x962: Pop(1)
0x963: PushEmpty(string)
0x964: Stack[-1] = "blood" // @poff=1301
0x965: Call2 0x93f
...
0x96c: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1313
0x96d: Return(); Pop(0)

0x96e: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1353
0x96f: Return(); Pop(0)
...
0x973: Push("revolver_ammo") // @poff=1397
0x974: Push((int) 0)
0x975: Push((int) 2)
0x976: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x977: Pop(3)
0x978: Push("alpha_pills") // @poff=1425
0x979: Push((int) 0)
0x97a: Push((int) 2)
...
0x989: Stack[-7] = Stack[-3]
0x98a: Stack[-6] = Stack[-2]
0x98b: Stack[-5] = Stack[-1]
0x98c: Call2 0x733
...
0x991: Stack[-11] = Stack[-5]
0x992: Stack[-10] = Stack[-4]
0x993: Stack[-9] = Stack[-3]
0x994: Stack[-7] = Stack[-2]
0x995: Stack[-6] = Stack[-1]
0x996: Call2 0x777
