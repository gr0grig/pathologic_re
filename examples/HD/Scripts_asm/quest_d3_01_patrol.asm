...
// @pool_raw:
// @pool_encoding:utf8
...
0x7a9: Push("head") // @poff=460
0x7aa: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x7ab: Pop(1)
0x7ac: Push(Stack[-1])
0x7ad: IF (Stack[-1] == 0) GOTO 0x7b1; Pop(1)

0x7ae: Push("head") // @poff=460
0x7af: @ UnlookAsync(Stack[-1])
0x7b0: Pop(1)
0x7b1: Return(); Pop(2)

0x7b2: PushEmpty(bool, float, float, bool, float, float)
0x7b3: @ lshHasAnimation(Stack[-3], Stack[-7])
0x7b4: Pop(0)
0x7b5: Push(Stack[-3])
0x7b6: IF (Stack[-1] == 0) GOTO 0x7bd; Pop(1)

0x7b7: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x7b8: Pop(0)
0x7b9: Push((bool) 0)
0x7ba: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x7bb: Pop(1)
0x7bc: GOTO 0x7c1

0x7bd: Push("Can't find lsh animation : ") // @poff=937
0x7be: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7bf: @ Trace(Stack[-1])
0x7c0: Pop(1)
0x7c1: Return(); Pop(6)

0x7c2: PushEmpty(bool, float, float, bool, float, float)
0x7c3: @ lshHasAnimation(Stack[-3], Stack[-8])
0x7c4: Pop(0)
0x7c5: Push(Stack[-3])
0x7c6: IF (Stack[-1] == 0) GOTO 0x7cc; Pop(1)

0x7c7: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x7c8: Pop(0)
0x7c9: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x7ca: Pop(0)
0x7cb: GOTO 0x7d0

0x7cc: Push("Can't find lsh animation : ") // @poff=937
0x7cd: Pop(1); Push(Stack[-1] + Stack[-9]);
0x7ce: @ Trace(Stack[-1])
0x7cf: Pop(1)
0x7d0: Return(); Pop(6)

0x7d1: PushEmpty(float, cvector, float, cvector)
0x7d2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=634
0x7d3: Pop(0)
0x7d4: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x7d5: Push(CvectorIndex(Stack[-1], 1))
0x7d6: Stack[-3] = Stack[-1]
0x7d7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x7d8: Push("head") // @poff=460
0x7d9: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x7da: Pop(1)
0x7db: Return(); Pop(4)
...
0x7e3: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x7e4: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x7e5: Pop(0)
0x7e6: Pop(0); Push((bool) Stack[-8] == 0)
0x7e7: IF (Stack[-1] == 0) GOTO 0x7fc; Pop(1)

0x7e8: Stack[-7] = (int) 0
0x7e9: Push((int) 1)
0x7ea: Pop(1); Push(Stack[-8] + Stack[-1]);
0x7eb: Pop(1); Push(Stack[-18] + Stack[-1]);
0x7ec: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x7ed: Pop(1)
0x7ee: Pop(0); Push((bool) Stack[-6] == 0)
0x7ef: IF (Stack[-1] == 0) GOTO 0x7f1; Pop(1)

0x7f0: GOTO 0x7f4

0x7f1: Push((int) 1)
0x7f2: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x7f3: GOTO 0x7e9

0x7f4: Pop(0); Push((bool) Stack[-7] == 0)
0x7f5: IF (Stack[-1] == 0) GOTO 0x7f7; Pop(1)

0x7f6: Return(); Pop(16)

0x7f7: @ irand(Stack[-5], Stack[-7])
0x7f8: Pop(0)
0x7f9: Push((int) 1)
0x7fa: Pop(1); Push(Stack[-6] + Stack[-1]);
0x7fb: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x7fc: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x7fd: Pop(0)
0x7fe: Push(Stack[-4])
0x7ff: IF (Stack[-1] == 0) GOTO 0x80b; Pop(1)

0x800: @ GetEyesHeight(Stack[-3])
0x801: Pop(0)
0x802: @ GetDirection(Stack[-2])
0x803: Pop(0)
0x804: Push((int) 50)
0x805: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x806: Push(CvectorIndex(Stack[-1], 1))
0x807: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x808: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x809: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x80a: Pop(0)
0x80b: Return(); Pop(16)
...
0x80d: @ self(Stack[-1])
0x80e: Pop(0)
0x80f: Stack[-1] = Stack[-3]
0x810: Return(); Pop(2)

0x811: Stack[-1] = 0
0x812: PushEmpty(float, float)
0x813: Pop(0); Push(Stack[-3] | Stack[-3]);
0x814: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x815: Push((float)9.999999974752427e-07)
0x816: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x817: IF (Stack[-1] == 0) GOTO 0x81a; Pop(1)

0x818: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x819: Return(); Pop(2)

0x81a: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x81b: Return(); Pop(2)

0x81c: PushEmpty(cvector, cvector)
0x81d: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x81e: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x81f: Return(); Pop(2)

0x820: PushEmpty()
0x821: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x822: IF (Stack[-1] == 0) GOTO 0x825; Pop(1)

0x823: Stack[-2] = Stack[-3]
0x824: GOTO 0x826

0x825: Stack[-1] = Stack[-3]
0x826: Return(); Pop(0)

0x827: PushEmpty()
0x828: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x829: IF (Stack[-1] == 0) GOTO 0x82c; Pop(1)

0x82a: Stack[-2] = Stack[-4]
0x82b: Return(); Pop(0)

0x82c: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x82d: IF (Stack[-1] == 0) GOTO 0x830; Pop(1)

0x82e: Stack[-1] = Stack[-4]
0x82f: Return(); Pop(0)

0x830: Stack[-3] = Stack[-4]
0x831: Return(); Pop(0)

0x832: PushEmpty()
0x833: Pop(0); Push((bool) Stack[-2] == 0)
0x834: IF (Stack[-1] == 0) GOTO 0x837; Pop(1)

0x835: Stack[-3] = (bool) 0
0x836: Return(); Pop(0)
...
0x83a: Push((int) 8)
0x83b: @ SendWorldWndMessage(Stack[-1])
0x83c: Pop(1)
0x83d: GOTO 0x847
...
0x841: Push((int) 9)
0x842: @ SendWorldWndMessage(Stack[-1])
0x843: Pop(1)
0x844: GOTO 0x847

0x845: Stack[-3] = (bool) 0
0x846: Return(); Pop(0)

0x847: PushEmpty(float)
0x848: Stack[-2] = Stack[-1]
0x849: Call2 0x866

0x84a: Pop(1)
0x84b: PushEmpty(bool, object, string, float, float, float)
0x84c: Stack[-8] = Stack[-5]
0x84d: Stack[-4] = "reputation" // @poff=993
0x84e: Stack[-7] = Stack[-3]
0x84f: Stack[-2] = (int) 0
0x850: Stack[-1] = (int) 1
0x851: Call2 0x632

0x852: Pop(6)
0x853: Stack[-3] = (bool) 1
0x854: Return(); Pop(0)

0x855: PushEmpty(object, object)
0x856: @ CreateFloatVector(Stack[-1])
0x857: Pop(0)
0x858: @@ add(Stack[-3]); Obj=1 // @poff=878
0x859: Pop(0)
0x85a: Push((int) 0)
0x85b: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x85c: IF (Stack[-1] == 0) GOTO 0x861; Pop(1)

0x85d: Push((float)0.699999988079071)
0x85e: Push((int) 500)
0x85f: @ RumblePlay(Stack[-2], Stack[-1])
0x860: Pop(2)
0x861: Push((int) 15)
0x862: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x863: Pop(1)
0x864: Return(); Pop(2)

0x865: Stack[-1] = 0
0x866: PushEmpty(object, object)
0x867: @ CreateFloatVector(Stack[-1])
0x868: Pop(0)
0x869: @@ add(Stack[-3]); Obj=1 // @poff=878
0x86a: Pop(0)
0x86b: Push((int) 16)
0x86c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x86d: Pop(1)
0x86e: Return(); Pop(2)

0x86f: Stack[-1] = 0
0x870: PushEmpty(bool, bool)
0x871: @ IsPlayerActor(Stack[-3], Stack[-1])
0x872: Pop(0)
0x873: Push(Stack[-1])
0x874: IF (Stack[-1] == 0) GOTO 0x878; Pop(1)

0x875: Push("attack") // @poff=226
0x876: @ PlayGlobalMusic(Stack[-1])
0x877: Pop(1)
0x878: Return(); Pop(2)

0x879: PushEmpty(object, object)
0x87a: @ GetScene(Stack[-1])
0x87b: Pop(0)
0x87c: Push("battle") // @poff=1015
0x87d: PushEmpty(object)
0x87e: Call2 0x80c

0x87f: Pop(0)
0x880: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x881: Pop(2)
0x882: Return(); Pop(2)

0x883: Stack[-1] = 0
0x884: PushEmpty(int, int)
0x885: Push("branch") // @poff=1029
...
0x8aa: Pop(0)
0x8ab: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1043
0x8ac: Pop(0)
0x8ad: Push("Organ") // @poff=1055
0x8ae: Push((int) 1)
0x8af: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=730
0x8b0: Pop(2)
0x8b1: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1067
0x8b2: Pop(0)
0x8b3: Push((int) 0)
0x8b4: Push((int) 1)
...
0x8c1: Stack[-1] = "liver" // @poff=1077
0x8c2: Call2 0x8a8

0x8c3: Pop(1)
0x8c4: PushEmpty(string)
0x8c5: Stack[-1] = "kidney" // @poff=1089
0x8c6: Call2 0x8a8

0x8c7: Pop(1)
0x8c8: PushEmpty(string)
0x8c9: Stack[-1] = "heart" // @poff=1103
0x8ca: Call2 0x8a8

0x8cb: Pop(1)
0x8cc: PushEmpty(string)
0x8cd: Stack[-1] = "blood" // @poff=1115
0x8ce: Call2 0x8a8
...
0x8d2: Push("revolver_ammo") // @poff=1127
0x8d3: Push((int) 0)
0x8d4: Push((int) 2)
0x8d5: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8d6: Pop(3)
0x8d7: Push("alpha_pills") // @poff=1155
0x8d8: Push((int) 0)
0x8d9: Push((int) 2)
...
0x8e5: Stack[-6] = Stack[-2]
0x8e6: Stack[-1] = (float) -0.20000000298023224
0x8e7: Call2 0x832

0x8e8: Pop(3)
0x8e9: PushEmpty(object)
0x8ea: Stack[-4] = Stack[-1]
0x8eb: Push(-1, 0); TaskCall(4)
0x8ec: Call2 0x4f7

0x8ed: Pop(-1, 0); TaskReturn
0x8ee: Pop(1)
0x8ef: Return(); Pop(2)

0x8f0: PushEmpty()
0x8f1: PushEmpty(object, int, float)
0x8f2: Stack[-7] = Stack[-3]
0x8f3: Stack[-6] = Stack[-2]
0x8f4: Stack[-5] = Stack[-1]
0x8f5: Call2 0x6fe
...
0x8fa: Stack[-11] = Stack[-5]
0x8fb: Stack[-10] = Stack[-4]
0x8fc: Stack[-9] = Stack[-3]
0x8fd: Stack[-7] = Stack[-2]
0x8fe: Stack[-6] = Stack[-1]
0x8ff: Call2 0x742
...
0x919: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1179
0x91a: Return(); Pop(0)

0x91b: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1219
0x91c: Return(); Pop(0)
