...
Strings:
	...
	A:GetLocator
	W:d3q01
// @pool_raw:70006c006100790065007200000063006f0074005f0061006c006500780061006e00640072000000700074005f00640033007100300031005f00740065006c00650070006f007200740000004765744c6f6361746f7200640033007100300031000000
...
0xf: Push("cot_alexandr") // @poff=14
0x10: @ GetSceneByName(Stack[-5], Stack[-1])
0x11: Pop(1)
0x12: Push("pt_d3q01_teleport") // @poff=40
0x13: @@ GetLocator(Stack[-1], Stack[-2], Stack[-4], Stack[-3]); Obj=5 // @poff=76
0x14: Pop(1)
0x15: @ Teleport(Stack[-5], Stack[-4], Stack[-3], Stack[-2])
0x16: Pop(0)
0x17: Stack[-4] = 0
0x18: Push("d3q01") // @poff=87
0x19: Push((int) 8)
