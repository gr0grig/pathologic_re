...
0x36: Stack[-8] = Stack[-2]
0x37: Stack[-7] = Stack[-1]
0x38: Call2 0x70
...
0x77: Push("player") // @poff=44
0x78: @ FindActor(Stack[-4]T, Stack[-1])
0x79: Pop(1)
...
0x8c: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x120: Stack[-1] = 0
0x121: PushEmpty()
0x122: Stack[-3] = (float) 0.10000000149011612
0x123: Return(); Pop(0)
...
0x144: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x145: Pop(0)
0x146: Push(Stack[-8])
0x147: IF (Stack[-1] == 0) GOTO 0x150; Pop(1)

0x148: Push("attack") // @poff=132
...
0x164: Pop(0)
0x165: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=146
0x166: Pop(0)
...
0x180: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=146
0x181: Pop(0)
...
0x19a: Pop(1)
0x19b: Push("all") // @poff=68
0x19c: Push("attack_on") // @poff=160
...
0x1b4: IF (Stack[-1] == 1) GOTO 0x1ba; Pop(1)

0x1b5: PushEmpty(bool)
0x1b6: Call2 0x386

0x1b7: Pop(0)
0x1b8: IF (Stack[-1] == 1) GOTO 0x1ba; Pop(1)
...
0x1bf: Pop(0)
0x1c0: Push("all") // @poff=68
0x1c1: Push("attack_stay") // @poff=180
0x1c2: @ PlayAnimation(Stack[-2], Stack[-1])
0x1c3: Pop(2)
0x1c4: PushEmpty(bool, float)
0x1c5: Stack[-25] = Stack[-1]
0x1c6: Call2 0x302
...
0x1cb: @ Face(Stack[-0]T)
0x1cc: Pop(0)
0x1cd: Push("all") // @poff=68
0x1ce: Push("fjump") // @poff=204
...
0x1e9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=146
0x1ea: Pop(0)
...
0x208: Push("all") // @poff=68
0x209: Push("attack_off") // @poff=216
...
0x216: Push("all") // @poff=68
0x217: Push("attack_begin") // @poff=238
0x218: Push((int) 1)
0x219: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x224: Push("attack") // @poff=132
0x225: Push((int) 1)
0x226: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x230: Push("all") // @poff=68
0x231: Push("bjump") // @poff=264
...
0x238: Push((float)0.8999999761581421)
0x239: Pop(1); Push(Stack[-9] * Stack[-1]);
0x23a: @ GetVictim(Stack[-1], Stack[-4])
0x23b: Pop(1)
0x23c: @ ReportAttack(Stack[-0]T)
0x23d: Pop(0)
...
0x241: Stack[-6] = Stack[-2]
0x242: Stack[-10] = Stack[-1]
0x243: Call2 0x121

0x244: Stack[-3] = Stack[-5]
0x245: Pop(3)
0x246: PushEmpty(float, object, float, int)
0x247: Stack[-7] = Stack[-3]
0x248: Stack[-6] = Stack[-2]
0x249: PushEmpty(int, object, int)
0x24a: Stack[-10] = Stack[-2]
0x24b: Stack[-14] = Stack[-1]
0x24c: Call2 0x124

0x24d: Stack[-3] = Stack[-4]
0x24e: Pop(3)
0x24f: Call2 0x587

0x250: Stack[-4] = Stack[-5]
0x251: Pop(4)
0x252: PushEmpty(int)
0x253: Call2 0x3b6

0x254: Pop(0)
0x255: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x256: Pop(1)
0x257: PushEmpty(object, float)
0x258: Stack[-5] = Stack[-2]
0x259: Stack[-3] = Stack[-1]
0x25a: Call2 0x3bd
...
0x261: Pop(0)
0x262: @ irand(Stack[-4], Stack[-1]T)
0x263: Pop(0)
0x264: Push((int) 1)
0x265: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x266: @ Face(Stack[-0]T)
0x267: Pop(0)
0x268: Push((bool) 1)
...
0x26d: Pop(0)
0x26e: Push("all") // @poff=68
0x26f: Push("attack_begin") // @poff=238
...
0x283: Stack[-11] = Stack[-2]
0x284: Stack[-6] = Stack[-1]
0x285: Call2 0x237

0x286: Pop(2)
0x287: Push("all") // @poff=68
0x288: Push("attack_middle") // @poff=276
...
0x2d5: Pop(1)
0x2d6: Push("all") // @poff=68
0x2d7: Push("attack_end") // @poff=308
...
0x316: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=146
0x317: Pop(0)
...
0x362: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x363: Pop(1)
...
0x367: @ Face(Stack[-0]T)
0x368: Pop(0)
0x369: Push("all") // @poff=68
0x36a: Push("bjump") // @poff=264
0x36b: @ PlayAnimation(Stack[-2], Stack[-1])
0x36c: Pop(2)
0x36d: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=146
0x36e: Pop(0)
...
0x3a4: @ irand(Stack[-1], Stack[-2]T)
0x3a5: Pop(0)
0x3a6: Push((int) 1)
0x3a7: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3a8: Push("attack") // @poff=132
...
0x3b9: Stack[-1] = "attack_stay" // @poff=180
0x3ba: Call2 0x6aa
...
0x3ec: Stack[-15] = Stack[-5]
0x3ed: Stack[-14] = Stack[-4]
0x3ee: Stack[-13] = Stack[-3]
0x3ef: Stack[-12] = Stack[-2]
0x3f0: Stack[-11] = Stack[-1]
0x3f1: Call2 0x436

0x3f2: Stack[-6] = Stack[-7]
0x3f3: Pop(6)
0x3f4: Push( Stack[2 + Tasks[-1].StackPointer] )
0x3f5: IF (Stack[-1] == 0) GOTO 0x3f9; Pop(1)

0x3f6: Push("head") // @poff=58
...
0x439: Stack[-17] = Stack[-7]
0x43a: PushEmpty(bool, object)
0x43b: Stack[-23] = Stack[-1]
0x43c: Call2 0x4c2
...
0x442: @@ GetPosition(Stack[-5]); Obj=21 // @poff=366
0x443: Pop(0)
...
0x459: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=146
0x45a: Pop(0)
...
0x46b: Push((int) 0)
0x46c: Push((float)0.30000001192092896)
...
0x48e: Push((int) 0)
0x48f: Push((float)0.30000001192092896)
...
0x4c9: Stack[-1] = "walk" // @poff=378
0x4ca: Return(); Pop(0)

0x4cb: Stack[-1] = "run" // @poff=388
0x4cc: Return(); Pop(0)
...
0x4df: Pop(0); PushNull((bool) Stack[-21] == 0)
0x4e0: IF (Stack[-1] == 0) GOTO 0x4e6; Pop(1)

0x4e1: PushEmpty(string)
0x4e2: Stack[-1] = "fdie" // @poff=396
0x4e3: Call2 0x539

0x4e4: Pop(1)
0x4e5: GOTO 0x538

0x4e6: @@ GetPosition(Stack[-10]); Obj=21 // @poff=366
0x4e7: Pop(0)
...
0x4f7: Stack[-6] = "fdie" // @poff=396
0x4f8: GOTO 0x4fa

0x4f9: Stack[-6] = "bdie" // @poff=406
...
0x500: @ StopAsync()
0x501: Pop(0)
0x502: Stack[-21] = Stack[-5]
0x503: Push("GetScriptProperty") // @poff=416
0x504: Push((int) 2)
0x505: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x506: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x507: Push("Owner") // @poff=452
0x508: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=464
0x509: Pop(1)
0x50a: Push(Stack[-4])
0x50b: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x50c: Push("Owner") // @poff=452
0x50d: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=482
0x50e: Pop(1)
0x50f: Pop(0); PushNull((bool) Stack[-5] == 0)
0x510: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x511: Stack[-21] = Stack[-5]
0x512: Push("@GetEyesHeight") // @poff=500
0x513: Push((int) 1)
0x514: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x515: IF (Stack[-1] == 0) GOTO 0x521; Pop(1)

0x516: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=530
0x517: Pop(0)
...
0x523: Stack[-7] = Stack[-1]
0x524: Call2 0x6aa

0x525: Pop(1)
0x526: Push("all") // @poff=68
...
0x52d: @ StopAsync()
0x52e: Pop(0)
0x52f: Push("head") // @poff=58
0x530: @ UnlookAsync(Stack[-1])
0x531: Pop(1)
0x532: Push("all") // @poff=68
...
0x563: Stack[-2] = "bullet" // @poff=554
0x564: Return(); Pop(0)

0x565: Stack[-2] = "phys" // @poff=568
0x566: Return(); Pop(0)

0x567: PushEmpty(cvector, cvector, cvector, cvector)
0x568: @ GetPosition(Stack[-2])
0x569: Pop(0)
0x56a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=366
0x56b: Pop(0)
...
0x570: Pop(0)
0x571: @@ GetPosition(Stack[-2]); Obj=7 // @poff=366
0x572: Pop(0)
...
0x57c: Push("HasProperty") // @poff=578
0x57d: Push((int) 2)
...
0x583: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=602
0x584: Pop(0)
0x585: Stack[-1] = Stack[-5]
0x586: Return(); Pop(2)
...
0x592: Stack[-18] = Stack[-2]
0x593: Stack[-1] = "armor" // @poff=628
0x594: Call2 0x57b
...
0x59a: Push("armor") // @poff=628
0x59b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=640
0x59c: Pop(1)
0x59d: Push("armor_") // @poff=652
0x59e: PushEmpty(string, int)
0x59f: Stack[-16] = Stack[-1]
0x5a0: Call2 0x559
...
0x5ac: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=640
0x5ad: Pop(0)
...
0x5b4: Stack[-3] = Stack[-6]
0x5b5: Pop(3)
0x5b6: Push("health") // @poff=614
0x5b7: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=640
0x5b8: Pop(1)
0x5b9: Push((int) 1)
0x5ba: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5bb: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5bc: Push("health") // @poff=614
...
0x5c2: Pop(3)
0x5c3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=666
0x5c4: Pop(2)
0x5c5: PushEmpty(bool, object)
0x5c6: Stack[-17] = Stack[-1]
0x5c7: Call2 0x576
...
0x5cd: Pop(1)
0x5ce: Stack[-1] = Stack[-16]
0x5cf: Return(); Pop(12)

0x5d0: PushEmpty(bool, bool)
0x5d1: @@ IsDead(Stack[-1]); Obj=3 // @poff=678
0x5d2: Pop(0)
0x5d3: Stack[-1] = Stack[-4]
0x5d4: Return(); Pop(2)

0x5d5: PushEmpty(object, object, object, object)
0x5d6: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5ea: Pop(0)
0x5eb: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5ec: IF (Stack[-1] == 0) GOTO 0x5ef; Pop(1)

0x5ed: Stack[-6] = (bool) 0
0x5ee: Return(); Pop(4)

0x5ef: @@ GetScene(Stack[-1]); Obj=5 // @poff=699
0x5f0: Pop(0)
...
0x604: Stack[-1] = "noaccess" // @poff=708
0x605: Call2 0x57b
...
0x60b: Push("noaccess") // @poff=708
0x60c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=640
0x60d: Pop(1)
0x60e: Push((int) 0)
...
0x612: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x620: @@ GetPosition(Stack[-5]); Obj=15 // @poff=366
0x621: Pop(0)
...
0x631: Stack[-1] = "fhit" // @poff=726
0x632: GOTO 0x634

0x633: Stack[-1] = "bhit" // @poff=736
0x634: Push("hit_react") // @poff=746
0x635: Push("1") // @poff=766
0x636: Pop(1); Push(Stack[-3] + Stack[-1]);
0x637: Push("2") // @poff=770
...
0x650: Stack[-25] = Stack[-1]
0x651: Call2 0x567

0x652: Stack[-2] = Stack[-3]
0x653: Pop(2)
0x654: Call2 0x6d9

0x655: Stack[-2] = Stack[-11]
0x656: Pop(2)
0x657: @ CreateVectorVector(Stack[-8])
0x658: Pop(0)
0x659: Stack[-7] = (int) 1
0x65a: Push("hit") // @poff=728
...
0x66f: Pop(0)
0x670: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=783
0x671: Pop(0)
0x672: PushEmpty(object, int, float, cvector, cvector)
0x673: Stack[-26] = Stack[-5]
0x674: Stack[-25] = Stack[-4]
0x675: Stack[-24] = Stack[-3]
0x676: Stack[-6] = Stack[-2]
...
0x690: @@ GetPosition(Stack[-3]); Obj=7 // @poff=366
0x691: Pop(0)
...
0x69c: Pop(0)
0x69d: Stack[-1] = Stack[-3]
0x69e: Return(); Pop(2)

0x69f: PushEmpty(float, cvector, float, cvector)
0x6a0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=530
0x6a1: Pop(0)
...
0x6dc: Push((float)9.999999974752427e-07)
...
0x708: Pop(0)
0x709: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x73c: Stack[-2] = Stack[-5]
0x73d: Return(); Pop(4)

0x73e: PushEmpty()
0x73f: PushEmpty(bool, string, string)
0x740: Stack[-2] = "quest_d1_03" // @poff=857
0x741: Stack[-1] = "butcher_death" // @poff=881
0x742: Call2 0x706
...
0x74d: Stack[-7] = Stack[-3]
0x74e: Stack[-6] = Stack[-2]
0x74f: Stack[-5] = Stack[-1]
0x750: Call2 0x63d
...
0x755: Stack[-11] = Stack[-5]
0x756: Stack[-10] = Stack[-4]
0x757: Stack[-9] = Stack[-3]
0x758: Stack[-7] = Stack[-2]
