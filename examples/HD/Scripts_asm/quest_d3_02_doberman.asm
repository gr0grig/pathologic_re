...
Strings:
	...
	W:d3q02
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x145: Push("player") // @poff=172
0x146: @ FindActor(Stack[-4]T, Stack[-1])
0x147: Pop(1)
...
0x15a: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1e5: Pop(0)
0x1e6: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x1e7: Pop(0)
...
0x1f1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x1f2: Pop(0)
0x1f3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x1f4: Pop(0)
...
0x252: Push("Can't find lsh animation : ") // @poff=222
...
0x261: Push("Can't find lsh animation : ") // @poff=222
...
0x267: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x268: Pop(0)
...
0x2b5: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=278
0x2b6: Return(); Pop(0)

0x2b7: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=318
0x2b8: Return(); Pop(0)
...
0x2bd: Stack[-2] = "quest_d3_02" // @poff=362
0x2be: Stack[-1] = "teleport" // @poff=386
0x2bf: Call2 0x28d
