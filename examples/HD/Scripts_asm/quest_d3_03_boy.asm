...
Strings:
	...
	W:health
	W:boy_attacked
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x64d Vars = (object, int, float, float)
EVENT_43 Op = 0x655 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x65f Vars = (object, string)
EVENT_41 Op = 0x66c Vars = (object)
EVENT_17 Op = 0x681 Vars = (object)
...
0xc6: Stack[-1] = "Neutral" // @poff=89
0xc7: Call2 0x84

0xc8: Pop(1)
0xc9: Push((int) 510904)
0xca: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0xcb: Pop(1)
0xcc: @@@ ClearReplies(); Obj=0 // @poff=116
0xcd: Pop(0)
...
0x106: Stack[-1] = "Neutral" // @poff=89
0x107: Call2 0x84

0x108: Pop(1)
0x109: Push((int) 510906)
0x10a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x10b: Pop(1)
0x10c: @@@ ClearReplies(); Obj=0 // @poff=116
0x10d: Pop(0)
...
0x1b8: Stack[-2] = "quest_d3_03" // @poff=156
0x1b9: Stack[-1] = "boy_free" // @poff=180
0x1ba: Call2 0x595

0x1bb: Pop(3)
0x1bc: Push("noaccess") // @poff=198
0x1bd: Push((int) 0)
...
0x1f2: Stack[-7] = Stack[-1]
0x1f3: Call2 0x22c

0x1f4: Stack[-2] = Stack[-4]
0x1f5: Pop(2)
...
0x298: Pop(0)
0x299: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=216
0x29a: Pop(0)
...
0x2b7: Stack[-1] = (float) 1.7453293800354004
0x2b8: Call2 0x296

0x2b9: Stack[-2] = Stack[-7]
0x2ba: Pop(2)
...
0x2c0: Stack[-1] = (float) 2.6179938316345215
0x2c1: Call2 0x296

0x2c2: Stack[-2] = Stack[-7]
0x2c3: Pop(2)
...
0x2c8: Push("Can't retreat, distance: ") // @poff=228
...
0x2de: Push((int) 1)
0x2df: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x2e0: Pop(1)
0x2e1: Push(Stack[-3])
0x2e2: IF (Stack[-1] == 0) GOTO 0x2fa; Pop(1)

0x2e3: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2e8: Stack[-1] = (float) 2.6179938316345215
0x2e9: Call2 0x296

0x2ea: Stack[-2] = Stack[-4]
0x2eb: Pop(2)
...
0x2fb: IF (Stack[-1] == 1) GOTO 0x2de; Pop(1)
...
0x302: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x311: Stack[-1] = (float) 1.7453293800354004
0x312: Call2 0x296

0x313: Stack[-2] = Stack[-4]
0x314: Pop(2)
...
0x321: IF (Stack[-1] == 1) GOTO 0x327; Pop(1)

0x322: PushEmpty(bool)
0x323: Call2 0x341

0x324: Pop(0)
0x325: IF (Stack[-1] == 1) GOTO 0x327; Pop(1)
...
0x347: Stack[-2] = Stack[-3]
0x348: Pop(2)
0x349: PushEmpty(float, cvector, cvector)
0x34a: Stack[-5] = Stack[-2]
0x34b: Stack[-4] = Stack[-1]
0x34c: Call2 0x561

0x34d: Pop(2)
0x34e: Push((float)-0.3420201241970062)
...
0x35b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x35c: IF (Stack[-1] == 0) GOTO 0x362; Pop(1)

0x35d: PushEmpty(string)
0x35e: Stack[-1] = "fdie" // @poff=280
0x35f: Call2 0x3b5

0x360: Pop(1)
0x361: GOTO 0x3b4

0x362: @@ GetPosition(Stack[-10]); Obj=21 // @poff=216
0x363: Pop(0)
...
0x373: Stack[-6] = "fdie" // @poff=280
0x374: GOTO 0x376

0x375: Stack[-6] = "bdie" // @poff=290
...
0x37c: @ StopAsync()
0x37d: Pop(0)
0x37e: Stack[-21] = Stack[-5]
0x37f: Push("GetScriptProperty") // @poff=300
0x380: Push((int) 2)
0x381: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x382: IF (Stack[-1] == 0) GOTO 0x38e; Pop(1)

0x383: Push("Owner") // @poff=336
0x384: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=348
0x385: Pop(1)
0x386: Push(Stack[-4])
0x387: IF (Stack[-1] == 0) GOTO 0x38e; Pop(1)

0x388: Push("Owner") // @poff=336
0x389: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=366
0x38a: Pop(1)
0x38b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x38c: IF (Stack[-1] == 0) GOTO 0x38e; Pop(1)

0x38d: Stack[-21] = Stack[-5]
0x38e: Push("@GetEyesHeight") // @poff=384
0x38f: Push((int) 1)
0x390: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x391: IF (Stack[-1] == 0) GOTO 0x39d; Pop(1)

0x392: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=414
0x393: Pop(0)
...
0x3a9: @ StopAsync()
0x3aa: Pop(0)
0x3ab: Push("head") // @poff=428
0x3ac: @ UnlookAsync(Stack[-1])
0x3ad: Pop(1)
0x3ae: Push("all") // @poff=138
...
0x3dc: Pop(0)
0x3dd: @@ GetPosition(Stack[-1]); Obj=5 // @poff=216
0x3de: Pop(0)
0x3df: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x3e0: Return(); Pop(4)

0x3e1: PushEmpty(bool, bool)
0x3e2: Push("HasProperty") // @poff=438
0x3e3: Push((int) 2)
...
0x3e9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=462
0x3ea: Pop(0)
0x3eb: Stack[-1] = Stack[-5]
0x3ec: Return(); Pop(2)

0x3ed: PushEmpty(bool, bool)
0x3ee: @@ IsDead(Stack[-1]); Obj=3 // @poff=474
0x3ef: Pop(0)
0x3f0: Stack[-1] = Stack[-4]
0x3f1: Return(); Pop(2)

0x3f2: PushEmpty(object, object, object, object)
0x3f3: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x407: Pop(0)
0x408: Pop(0); PushNull((bool) Stack[-2] == 0)
0x409: IF (Stack[-1] == 0) GOTO 0x40c; Pop(1)

0x40a: Stack[-6] = (bool) 0
0x40b: Return(); Pop(4)

0x40c: @@ GetScene(Stack[-1]); Obj=5 // @poff=495
0x40d: Pop(0)
...
0x420: Stack[-6] = Stack[-2]
0x421: Stack[-1] = "noaccess" // @poff=198
0x422: Call2 0x3e1
...
0x428: Push("noaccess") // @poff=198
0x429: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=504
0x42a: Pop(1)
0x42b: Push((int) 0)
...
0x42f: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x43d: @@ GetPosition(Stack[-5]); Obj=15 // @poff=216
0x43e: Pop(0)
...
0x44e: Stack[-1] = "fhit" // @poff=516
0x44f: GOTO 0x451

0x450: Stack[-1] = "bhit" // @poff=526
0x451: Push("hit_react") // @poff=536
0x452: Push("1") // @poff=556
0x453: Pop(1); Push(Stack[-3] + Stack[-1]);
0x454: Push("2") // @poff=560
...
0x46d: Stack[-25] = Stack[-1]
0x46e: Call2 0x3da

0x46f: Stack[-2] = Stack[-3]
0x470: Pop(2)
0x471: Call2 0x557

0x472: Stack[-2] = Stack[-11]
0x473: Pop(2)
0x474: @ CreateVectorVector(Stack[-8])
0x475: Pop(0)
0x476: Stack[-7] = (int) 1
0x477: Push("hit") // @poff=518
...
0x48c: Pop(0)
0x48d: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=573
0x48e: Pop(0)
0x48f: PushEmpty(object, int, float, cvector, cvector)
0x490: Stack[-26] = Stack[-5]
0x491: Stack[-25] = Stack[-4]
0x492: Stack[-24] = Stack[-3]
0x493: Stack[-6] = Stack[-2]
...
0x4b2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=216
0x4b3: Pop(0)
0x4b4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=414
0x4b5: Pop(0)
...
0x4db: Pop(0)
0x4dc: Push((bool) 1)
0x4dd: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x4de: Pop(1)
0x4df: Push(CvectorIndex(Stack[-4], 0))
0x4e0: Push(CvectorIndex(Stack[-5], 2))
0x4e1: @ Rotate(Stack[-2], Stack[-1])
0x4e2: Pop(2)
...
0x4e8: Push("head") // @poff=428
0x4e9: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x4ea: Pop(1)
0x4eb: Push(Stack[-1])
0x4ec: IF (Stack[-1] == 0) GOTO 0x4f0; Pop(1)

0x4ed: Push("head") // @poff=428
0x4ee: @ LookAsyncCamera(Stack[-1])
0x4ef: Pop(1)
0x4f0: @ CameraWaitForPlayFinish()
0x4f1: Pop(0)
0x4f2: @ ResumeWorld()
0x4f3: Pop(0)
0x4f4: Stack[-21] = (bool) 1
0x4f5: Return(); Pop(18)

0x4f6: PushEmpty(bool, bool)
0x4f7: Push((bool) 1)
0x4f8: @ CameraSwitchToNormal(Stack[-1])
0x4f9: Pop(1)
...
0x4ff: Push("head") // @poff=428
0x500: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x501: Pop(1)
0x502: Push(Stack[-1])
0x503: IF (Stack[-1] == 0) GOTO 0x507; Pop(1)

0x504: Push("head") // @poff=428
0x505: @ UnlookAsync(Stack[-1])
0x506: Pop(1)
0x507: Return(); Pop(2)

0x508: PushEmpty(bool, float, float, bool, float, float)
0x509: @ lshHasAnimation(Stack[-3], Stack[-7])
0x50a: Pop(0)
0x50b: Push(Stack[-3])
0x50c: IF (Stack[-1] == 0) GOTO 0x513; Pop(1)

0x50d: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x50e: Pop(0)
0x50f: Push((bool) 0)
0x510: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x511: Pop(1)
0x512: GOTO 0x517

0x513: Push("Can't find lsh animation : ") // @poff=623
...
0x519: @ lshHasAnimation(Stack[-3], Stack[-8])
0x51a: Pop(0)
0x51b: Push(Stack[-3])
0x51c: IF (Stack[-1] == 0) GOTO 0x522; Pop(1)

0x51d: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x51e: Pop(0)
0x51f: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x520: Pop(0)
0x521: GOTO 0x526

0x522: Push("Can't find lsh animation : ") // @poff=623
0x523: Pop(1); Push(Stack[-1] + Stack[-9]);
0x524: @ Trace(Stack[-1])
0x525: Pop(1)
0x526: Return(); Pop(6)
...
0x557: PushEmpty(float, float)
0x558: Pop(0); Push(Stack[-3] | Stack[-3]);
0x559: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x55a: Push((float)9.999999974752427e-07)
0x55b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x55c: IF (Stack[-1] == 0) GOTO 0x55f; Pop(1)

0x55d: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x55e: Return(); Pop(2)

0x55f: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x560: Return(); Pop(2)

0x561: PushEmpty()
0x562: Pop(0); Push(Stack[-2] | Stack[-1]);
0x563: Pop(0); Push(Stack[-3] | Stack[-3]);
0x564: Pop(0); Push(Stack[-3] | Stack[-3]);
0x565: Pop(2); Push(Stack[-2] * Stack[-1]);
0x566: Pop(1); Push(Sqrt(Stack[-1]))
0x567: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x568: Return(); Pop(0)

0x569: PushEmpty(object, object)
0x56a: @ CreateIntVector(Stack[-1])
0x56b: Pop(0)
0x56c: @@ add(Stack[-4]); Obj=1 // @poff=564
0x56d: Pop(0)
0x56e: @@ add(Stack[-3]); Obj=1 // @poff=564
0x56f: Pop(0)
0x570: Push((int) 3)
0x571: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x572: Pop(1)
0x573: Return(); Pop(2)

0x574: Stack[-1] = 0
0x575: PushEmpty(int, int, bool, int, int, bool)
0x576: @@ GetItemID(Stack[-3]); Obj=8 // @poff=679
0x577: Pop(0)
0x578: Push("Category") // @poff=689
0x579: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x57a: Pop(1)
0x57b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=707
0x57c: Pop(0)
0x57d: Pop(0); Push((bool) Stack[-1] == 0)
0x57e: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x57f: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=715
0x580: Pop(0)
0x581: GOTO 0x587

0x582: PushEmpty(int, int)
0x583: Stack[-5] = Stack[-2]
0x584: Stack[-9] = Stack[-1]
0x585: Call2 0x569
...
0x589: @ CreateInvItem(Stack[-1])
0x58a: Pop(0)
0x58b: @@ SetItemName(Stack[-4]); Obj=1 // @poff=725
0x58c: Pop(0)
0x58d: PushEmpty(object, object, int)
0x58e: Stack[-8] = Stack[-3]
0x58f: Stack[-4] = Stack[-2]
...
0x596: @ FindActor(Stack[-1], Stack[-4])
0x597: Pop(0)
0x598: Pop(0); PushNull((bool) Stack[-1] == 0)
0x599: IF (Stack[-1] == 0) GOTO 0x59c; Pop(1)

0x59a: Stack[-5] = (bool) 0
0x59b: Return(); Pop(2)

0x59c: @ Trigger(Stack[-1], Stack[-3])
0x59d: Pop(0)
0x59e: Stack[-5] = (bool) 1
0x59f: Return(); Pop(2)

0x5a0: Stack[-1] = 0
0x5a1: PushEmpty(string, string)
0x5a2: Stack[-1] = "idle" // @poff=146
0x5a3: Push(Stack[-3])
0x5a4: IF (Stack[-1] == 0) GOTO 0x5a6; Pop(1)

0x5a5: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x5a6: Stack[-1] = Stack[-4]
0x5a7: Return(); Pop(2)

0x5a8: PushEmpty(int, bool, int, bool)
0x5a9: Stack[-2] = (int) 0
0x5aa: Push("all") // @poff=138
0x5ab: PushEmpty(string, int)
0x5ac: Stack[-5] = Stack[-1]
0x5ad: Call2 0x5a1

0x5ae: Pop(1)
0x5af: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5b0: Pop(2)
0x5b1: Pop(0); Push((bool) Stack[-1] == 0)
0x5b2: IF (Stack[-1] == 0) GOTO 0x5b4; Pop(1)

0x5b3: GOTO 0x5b7

0x5b4: Push((int) 1)
0x5b5: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x5b6: GOTO 0x5aa

0x5b7: Stack[-2] = Stack[-5]
0x5b8: Return(); Pop(4)

0x5b9: PushEmpty()
0x5ba: Push("playsound") // @poff=737
0x5bb: Push("giveitem") // @poff=757
0x5bc: @ TriggerWorld(Stack[-2], Stack[-1])
0x5bd: Pop(2)
0x5be: Return(); Pop(0)

0x5bf: PushEmpty(float, float)
0x5c0: Push("d3q03") // @poff=775
0x5c1: Push((int) 2)
...
0x5c6: Pop(0)
0x5c7: Push("disease") // @poff=787
0x5c8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=504
0x5c9: Pop(1)
0x5ca: Push((float)0.5)
0x5cb: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x5cc: IF (Stack[-1] == 0) GOTO 0x5d1; Pop(1)

0x5cd: Push("disease") // @poff=787
0x5ce: Push((float)0.5)
0x5cf: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=803
0x5d0: Pop(2)
0x5d1: Return(); Pop(2)

0x5d2: PushEmpty()
0x5d3: Push("powder is given") // @poff=815
0x5d4: @ Trace(Stack[-1])
0x5d5: Pop(1)
0x5d6: PushEmpty(object, string, int)
0x5d7: Stack[-5] = Stack[-3]
0x5d8: Stack[-2] = "powder" // @poff=847
0x5d9: Stack[-1] = (int) 1
0x5da: Call2 0x588
...
0x5e0: Pop(0)
0x5e1: PushEmpty(bool, string, string)
0x5e2: Stack[-2] = "quest_d3_03" // @poff=156
0x5e3: Stack[-1] = "fail" // @poff=861
0x5e4: Call2 0x595
...
0x5e8: Push((int) 84)
0x5e9: Push((int) 2)
0x5ea: Push((int) 512166)
0x5eb: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5ec: Pop(3)
0x5ed: PushEmpty(bool, object, int)
0x5ee: Stack[-4] = Stack[-2]
0x5ef: Stack[-1] = (int) 27
0x5f0: Call2 0x60e
...
0x5f3: Stack[-1] = 0
0x5f4: PushEmpty(object, object)
0x5f5: Push((int) 86)
0x5f6: Push((int) 2)
0x5f7: Push((int) 512168)
0x5f8: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5f9: Pop(3)
0x5fa: PushEmpty(bool, object, int)
0x5fb: Stack[-4] = Stack[-2]
0x5fc: Stack[-1] = (int) 27
0x5fd: Call2 0x60e
...
0x602: @ GetDiaryRoot(Stack[-1])
0x603: Pop(0)
0x604: Pop(0); Push((bool) Stack[-1] == 0)
0x605: IF (Stack[-1] == 0) GOTO 0x60b; Pop(1)

0x606: Push("Can't retrieve diary root") // @poff=871
0x607: @ Trace(Stack[-1])
0x608: Pop(1)
0x609: Stack[-3] = (bool) 0
0x60a: Return(); Pop(2)
...
0x60d: Stack[-1] = 0
0x60e: PushEmpty(object, object, int, object, object, int)
0x60f: PushEmpty(object)
0x610: Call2 0x601

0x611: Stack[-1] = Stack[-4]
0x612: Pop(1)
0x613: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=923
0x614: Pop(0)
0x615: Pop(0); Push((bool) Stack[-2] == 0)
0x616: IF (Stack[-1] == 0) GOTO 0x61d; Pop(1)

0x617: Push("Can't find diary parent with id: ") // @poff=928
0x618: Pop(1); Push(Stack[-1] + Stack[-8]);
0x619: @ Trace(Stack[-1])
0x61a: Pop(1)
0x61b: Stack[-9] = (bool) 0
0x61c: Return(); Pop(6)

0x61d: @@ AddChild(Stack[-8]); Obj=2 // @poff=996
0x61e: Pop(0)
0x61f: Push((int) 7)
0x620: @ SendWorldWndMessage(Stack[-1])
0x621: Pop(1)
0x622: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1005
0x623: Pop(0)
0x624: @ SetDiarySection(Stack[-1])
0x625: Pop(0)
0x626: Stack[-9] = (bool) 0
0x627: Return(); Pop(6)

0x628: Stack[-2] = 0
0x629: Stack[-3] = 0
0x62a: PushEmpty(int, int)
0x62b: Push("branch") // @poff=1017
0x62c: @ GetVariable(Stack[-1], Stack[-2])
0x62d: Pop(1)
0x62e: Push((int) 0)
...
0x63b: Stack[-1] = (int) 515560
0x63c: Return(); Pop(0)

0x63d: Stack[-1] = (int) 503345
0x63e: Return(); Pop(0)

0x63f: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1031
0x640: Return(); Pop(0)

0x641: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1071
0x642: Return(); Pop(0)
...
0x647: Stack[-2] = Stack[-1]
0x648: Push(-1, 0); TaskCall(6)
0x649: Call2 0x351

0x64a: Pop(-1, 0); TaskReturn
0x64b: Pop(1)
0x64c: Return(); Pop(0)

0x64d: PushEmpty()
0x64e: PushEmpty(object, int, float)
0x64f: Stack[-7] = Stack[-3]
0x650: Stack[-6] = Stack[-2]
0x651: Stack[-5] = Stack[-1]
0x652: Call2 0x45a
...
0x655: PushEmpty()
0x656: PushEmpty(object, int, float, cvector, cvector)
0x657: Stack[-11] = Stack[-5]
0x658: Stack[-10] = Stack[-4]
0x659: Stack[-9] = Stack[-3]
0x65a: Stack[-7] = Stack[-2]
...
0x660: Push("health") // @poff=1115
0x661: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x662: IF (Stack[-1] == 0) GOTO 0x66b; Pop(1)

0x663: Push("health") // @poff=1115
0x664: @ GetProperty(Stack[-1], Stack[-2])
0x665: Pop(1)
0x666: Push((int) 0)
0x667: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x668: IF (Stack[-1] == 0) GOTO 0x66b; Pop(1)

0x669: @ SignalDeath(Stack[-4])
0x66a: Pop(0)
0x66b: Return(); Pop(2)
...
0x67c: Push(-1, 3); TaskCall(5)
0x67d: Call2 0x2b4

0x67e: Pop(-1, 3); TaskReturn
0x67f: Pop(1)
0x680: Return(); Pop(0)

0x681: PushEmpty(bool, bool)
0x682: @ IsPlayerActor(Stack[-3], Stack[-1])
0x683: Pop(0)
0x684: Push(Stack[-1])
0x685: IF (Stack[-1] == 0) GOTO 0x68b; Pop(1)

0x686: PushEmpty(bool, string, string)
0x687: Stack[-2] = "quest_d3_03" // @poff=156
0x688: Stack[-1] = "boy_attacked" // @poff=1129
0x689: Call2 0x595
