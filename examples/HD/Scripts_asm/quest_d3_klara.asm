...
// @pool_raw:
// @pool_encoding:utf8
...
0x58: Stack[-1] = "Saveyouall" // @poff=89
0x59: Call2 0x95

0x5a: Pop(1)
0x5b: Push((int) 510202)
0x5c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x5d: Pop(1)
0x5e: @@@ ClearReplies(); Obj=0 // @poff=122
0x5f: Pop(0)
...
0x66: Push((int) 11250)
0x67: Push((int) 35646)
0x68: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x69: Pop(3)
0x6a: Push((int) 510203)
0x6b: Push((int) -1)
0x6c: Push((int) 11249)
0x6d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x6e: Pop(3)
0x6f: Push((int) 536145)
0x70: Push((int) -1)
0x71: Push((int) 37905)
0x72: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x73: Pop(3)
0x74: GOTO 0x77
...
0x86: Push("all") // @poff=103
0x87: Push("idle") // @poff=144
...
0x8f: Push("all") // @poff=103
0x90: Push("idle") // @poff=144
...
0xbd: Stack[-1] = "Saveyouall" // @poff=89
0xbe: Call2 0x95

0xbf: Pop(1)
0xc0: Push((int) 510202)
0xc1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0xc2: Pop(1)
0xc3: @@@ ClearReplies(); Obj=0 // @poff=122
0xc4: Pop(0)
...
0xcb: Push((int) 11250)
0xcc: Push((int) 35646)
0xcd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xce: Pop(3)
0xcf: Push((int) 510203)
0xd0: Push((int) -1)
0xd1: Push((int) 11249)
0xd2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xd3: Pop(3)
0xd4: Push((int) 536145)
0xd5: Push((int) -1)
0xd6: Push((int) 37905)
0xd7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xd8: Pop(3)
0xd9: Return(); Pop(0)
...
0xde: Stack[-1] = "Saveyouall" // @poff=89
0xdf: Call2 0x95

0xe0: Pop(1)
0xe1: Push((int) 510204)
0xe2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0xe3: Pop(1)
0xe4: @@@ ClearReplies(); Obj=0 // @poff=122
0xe5: Pop(0)
0xe6: Push((int) 534061)
0xe7: Push((int) 35649)
0xe8: Push((int) 35648)
0xe9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xea: Pop(3)
0xeb: Push((int) 534063)
0xec: Push((int) 35649)
0xed: Push((int) 35650)
0xee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0xef: Pop(3)
0xf0: Return(); Pop(0)
...
0xf5: Stack[-1] = "Saveyouall" // @poff=89
0xf6: Call2 0x95

0xf7: Pop(1)
0xf8: Push((int) 534062)
0xf9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0xfa: Pop(1)
0xfb: @@@ ClearReplies(); Obj=0 // @poff=122
0xfc: Pop(0)
0xfd: Push((int) 510205)
0xfe: Push((int) 11252)
0xff: Push((int) 11251)
0x100: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x101: Pop(3)
0x102: Push((int) 534064)
0x103: Push((int) -1)
0x104: Push((int) 35652)
0x105: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x106: Pop(3)
0x107: Return(); Pop(0)
...
0x10c: Stack[-1] = "Saveyouall" // @poff=89
0x10d: Call2 0x95

0x10e: Pop(1)
0x10f: Push((int) 510206)
0x110: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=111
0x111: Pop(1)
0x112: @@@ ClearReplies(); Obj=0 // @poff=122
0x113: Pop(0)
0x114: Push((int) 510207)
0x115: Push((int) -1)
0x116: Push((int) 11253)
0x117: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x118: Pop(3)
0x119: Push((int) 534065)
0x11a: Push((int) -1)
0x11b: Push((int) 35653)
0x11c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=135
0x11d: Pop(3)
0x11e: Return(); Pop(0)
...
0x167: @@ GetPosition(Stack[-8]); Obj=20 // @poff=186
0x168: Pop(0)
0x169: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=198
0x16a: Pop(0)
...
0x1d6: Push("voice_common") // @poff=222
0x1d7: Push((int) 1)
...
0x1de: Push("voice_common") // @poff=222
0x1df: Push((int) 0)
...
0x1f1: Push("voice_common") // @poff=222
0x1f2: Push((int) 1)
...
0x1ff: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x200: Pop(1)
...
0x22a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=252
0x22b: Pop(1)
...
0x23f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=264
0x240: Pop(1)
...
0x252: Push("Can't find lsh animation : ") // @poff=280
...
0x261: Push("Can't find lsh animation : ") // @poff=280
...
0x29a: PushEmpty()
0x29b: Push("ood3Klara1") // @poff=336
0x29c: Push((int) 1)
...
0x2a2: Stack[-1] = "ood3Klara1" // @poff=336
0x2a3: Call2 0x28c
...
0x2c1: Stack[-1] = "ui/NPC_Klara.png" // @poff=372
0x2c2: Return(); Pop(0)

0x2c3: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=406
0x2c4: Return(); Pop(0)
