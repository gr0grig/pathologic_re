...
// @pool_raw:
// @pool_encoding:utf8
...
0x21d: Push("Can't find lsh animation : ") // @poff=244
...
0x22c: Push("Can't find lsh animation : ") // @poff=244
...
0x23b: Push((float)9.999999974752427e-07)
...
0x244: Pop(0)
0x245: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x26f: Pop(1)
0x270: Push("d4q01Whitemask") // @poff=300
0x271: Push("pt_d4q01_key1_region") // @poff=330
0x272: Push((int) 1)
...
0x276: Pop(0)
0x277: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=372
0x278: Pop(5)
0x279: Return(); Pop(2)
...
0x280: Pop(1)
0x281: Stack[-2] = "pt_d4q01_key1_region" // @poff=330
0x282: Stack[-1] = (int) 2
0x283: Call2 0x29c
...
0x287: Pop(0)
0x288: @@ ShowMap(Stack[-1]); Obj=2 // @poff=380
0x289: Pop(1)
0x28a: Return(); Pop(0)
...
0x28d: Pop(0)
0x28e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x28f: IF (Stack[-1] == 0) GOTO 0x296; Pop(1)

0x290: Push("Can't find main outdoor scene") // @poff=388
0x291: @ Trace(Stack[-1])
0x292: Pop(1)
0x293: Stack[-1] = 0
0x294: Stack[-1] = Stack[-5]
0x295: Return(); Pop(4)

0x296: @@ GetMap(Stack[-1]); Obj=2 // @poff=448
0x297: Pop(0)
...
0x29e: Pop(0)
0x29f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2a0: IF (Stack[-1] == 0) GOTO 0x2a5; Pop(1)

0x2a1: Push("Can't find main outdoor scene") // @poff=388
0x2a2: @ Trace(Stack[-1])
0x2a3: Pop(1)
0x2a4: Return(); Pop(8)

0x2a5: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=455
0x2a6: Pop(0)
0x2a7: Pop(0); Push((bool) Stack[-1] == 0)
0x2a8: IF (Stack[-1] == 0) GOTO 0x2af; Pop(1)

0x2a9: Push("Warning: outdoor scene locator ") // @poff=466
0x2aa: Pop(1); Push(Stack[-1] + Stack[-11]);
0x2ab: Push(" doesnt exist") // @poff=530
0x2ac: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2ad: @ Trace(Stack[-1])
0x2ae: Pop(1)
0x2af: @@ GetMap(Stack[-11]); Obj=2 // @poff=448
0x2b0: Pop(0)
0x2b1: Pop(0); PushNull((bool) Stack[-11] == 0)
0x2b2: IF (Stack[-1] == 0) GOTO 0x2b7; Pop(1)

0x2b3: Push("Can't find map") // @poff=558
0x2b4: @ Trace(Stack[-1])
0x2b5: Pop(1)
0x2b6: Return(); Pop(8)
...
0x2b9: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=588
0x2ba: Pop(2)
0x2bb: Return(); Pop(8)

0x2bc: Stack[-2] = 0
0x2bd: PushEmpty(int, int)
0x2be: Push("branch") // @poff=601
...
0x2d2: Stack[-1] = "ui/NPC_bmask.png" // @poff=615
0x2d3: Return(); Pop(0)

0x2d4: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=649
0x2d5: Return(); Pop(0)
