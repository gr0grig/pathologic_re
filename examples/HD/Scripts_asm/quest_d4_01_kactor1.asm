...
Strings:
	...
	W:On Actor Stuck 1
	W:OnActorStuck
	W:Random point found
	W:Random point not found
	W:all
	A:SetNPCName
	A:SetNPCDescription
	A:SetPhoto
...
// @pool_raw:
...
0x57: Push("On Actor Stuck") // @poff=0
0x58: @ Trace(Stack[-1])
0x59: Pop(1)
0x5a: PushEmpty()
0x5b: Call2 0xde
...
0x65: Stack[-17] = Stack[-7]
0x66: PushEmpty(bool, object)
0x67: Stack[-23] = Stack[-1]
0x68: Call2 0xee
...
0x6e: @@ GetPosition(Stack[-5]); Obj=21 // @poff=30
0x6f: Pop(0)
...
0x85: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=42
0x86: Pop(0)
...
0xba: Push((int) 0)
0xbb: Push((float)0.30000001192092896)
...
0xf2: Stack[-2] = Stack[-4]
0xf3: Pop(2)
0xf4: Return(); Pop(0)

0xf5: Stack[-1] = "walk" // @poff=56
0xf6: Return(); Pop(0)

0xf7: Stack[-1] = "run" // @poff=66
0xf8: Return(); Pop(0)

0xf9: PushEmpty()
0xfa: @ GetPosition(Stack[-2]T)
0xfb: Pop(0)
...
0x131: Push("On Actor Stuck 1") // @poff=74
0x132: @ Trace(Stack[-1])
0x133: Pop(1)
0x134: PushEmpty()
0x135: Call2 0x1d0
...
0x13d: Push("OnActorStuck") // @poff=108
0x13e: @ Trace(Stack[-1])
0x13f: Pop(1)
0x140: PushEmpty()
0x141: Call2 0x1d0
...
0x14a: Push("Random point found") // @poff=134
0x14b: @ Trace(Stack[-1])
0x14c: Pop(1)
...
0x150: Push("Random point not found") // @poff=172
0x151: @ Trace(Stack[-1])
0x152: Pop(1)
0x153: Return(); Pop(6)
...
0x157: Stack[-17] = Stack[-7]
0x158: PushEmpty(bool, object)
0x159: Stack[-23] = Stack[-1]
0x15a: Call2 0x1e0
...
0x160: @@ GetPosition(Stack[-5]); Obj=21 // @poff=30
0x161: Pop(0)
...
0x177: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=42
0x178: Pop(0)
...
0x189: Push((int) 0)
0x18a: Push((float)0.30000001192092896)
...
0x1ac: Push((int) 0)
0x1ad: Push((float)0.30000001192092896)
...
0x1e4: Stack[-2] = Stack[-4]
0x1e5: Pop(2)
0x1e6: Return(); Pop(0)

0x1e7: Stack[-1] = "walk" // @poff=56
0x1e8: Return(); Pop(0)

0x1e9: Stack[-1] = "run" // @poff=66
0x1ea: Return(); Pop(0)
...
0x210: Stack[-7] = Stack[-1]
0x211: Call2 0x24c

0x212: Stack[-2] = Stack[-4]
0x213: Pop(2)
...
0x2b2: Pop(0)
0x2b3: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=226
0x2b4: Pop(1)
0x2b5: PushEmpty(int)
0x2b6: Call2 0x711

0x2b7: Pop(0)
0x2b8: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=237
0x2b9: Pop(1)
0x2ba: PushEmpty(string)
0x2bb: Call2 0x715

0x2bc: Pop(0)
0x2bd: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=255
0x2be: Pop(1)
0x2bf: PushEmpty(string)
0x2c0: Call2 0x717

0x2c1: Pop(0)
0x2c2: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=264
0x2c3: Pop(1)
0x2c4: PushEmpty(int)
0x2c5: Call2 0x700

0x2c6: Pop(0)
0x2c7: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=274
0x2c8: Pop(1)
0x2c9: Stack[-2] = (int) -1
...
0x2d8: Pop(2)
0x2d9: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=288
0x2da: Pop(0)
...
0x2dd: @ sync()
0x2de: Pop(0)
0x2df: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=288
0x2e0: Pop(0)
0x2e1: GOTO 0x2db

0x2e2: PushEmpty(object)
0x2e3: Stack[-10] = Stack[-1]
0x2e4: Call2 0x626

0x2e5: Pop(1)
0x2e6: @ StopDialog(Stack[-4])
0x2e7: Pop(0)
0x2e8: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=300
0x2e9: Pop(0)
...
0x2f9: Stack[-1] = "Neutral" // @poff=315
0x2fa: Call2 0x340

0x2fb: Pop(1)
0x2fc: Push((int) 509667)
0x2fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x2fe: Pop(1)
0x2ff: @@@ ClearReplies(); Obj=0 // @poff=342
0x300: Pop(0)
0x301: Push((int) 509668)
0x302: Push((int) 10643)
0x303: Push((int) 10642)
0x304: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x305: Pop(3)
0x306: Push((int) 509677)
0x307: Push((int) 10653)
0x308: Push((int) 10652)
0x309: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x30a: Pop(3)
0x30b: GOTO 0x322

0x30c: PushEmpty(string)
0x30d: Stack[-1] = "Neutral" // @poff=315
0x30e: Call2 0x340

0x30f: Pop(1)
0x310: Push((int) 509681)
0x311: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x312: Pop(1)
0x313: @@@ ClearReplies(); Obj=0 // @poff=342
0x314: Pop(0)
0x315: Push((int) 509682)
0x316: Push((int) 10660)
0x317: Push((int) 10659)
0x318: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x319: Pop(3)
0x31a: Push((int) 509699)
0x31b: Push((int) -1)
0x31c: Push((int) 10678)
0x31d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x31e: Pop(3)
0x31f: GOTO 0x322
...
0x331: Push("all") // @poff=218
0x332: Push("idle") // @poff=364
...
0x33a: Push("all") // @poff=218
0x33b: Push("idle") // @poff=364
...
0x3a6: Stack[-1] = "Neutral" // @poff=315
0x3a7: Call2 0x340

0x3a8: Pop(1)
0x3a9: Push((int) 509667)
0x3aa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3ab: Pop(1)
0x3ac: @@@ ClearReplies(); Obj=0 // @poff=342
0x3ad: Pop(0)
0x3ae: Push((int) 509668)
0x3af: Push((int) 10643)
0x3b0: Push((int) 10642)
0x3b1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3b2: Pop(3)
0x3b3: Push((int) 509677)
0x3b4: Push((int) 10653)
0x3b5: Push((int) 10652)
0x3b6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3b7: Pop(3)
0x3b8: Return(); Pop(0)

0x3b9: PushEmpty(string)
0x3ba: Stack[-1] = "Neutral" // @poff=315
0x3bb: Call2 0x340

0x3bc: Pop(1)
0x3bd: Push((int) 509681)
0x3be: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3bf: Pop(1)
0x3c0: @@@ ClearReplies(); Obj=0 // @poff=342
0x3c1: Pop(0)
0x3c2: Push((int) 509682)
0x3c3: Push((int) 10660)
0x3c4: Push((int) 10659)
0x3c5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3c6: Pop(3)
0x3c7: Push((int) 509699)
0x3c8: Push((int) -1)
0x3c9: Push((int) 10678)
0x3ca: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3cb: Pop(3)
0x3cc: Return(); Pop(0)
...
0x3d1: Stack[-1] = "Neutral" // @poff=315
0x3d2: Call2 0x340

0x3d3: Pop(1)
0x3d4: Push((int) 509683)
0x3d5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3d6: Pop(1)
0x3d7: @@@ ClearReplies(); Obj=0 // @poff=342
0x3d8: Pop(0)
0x3d9: Push((int) 509684)
0x3da: Push((int) 10662)
0x3db: Push((int) 10661)
0x3dc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3dd: Pop(3)
0x3de: Push((int) 509694)
0x3df: Push((int) 10672)
0x3e0: Push((int) 10671)
0x3e1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3e2: Pop(3)
0x3e3: Push((int) 509698)
0x3e4: Push((int) 10662)
0x3e5: Push((int) 10676)
0x3e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3e7: Pop(3)
0x3e8: Return(); Pop(0)
...
0x3ed: Stack[-1] = "Neutral" // @poff=315
0x3ee: Call2 0x340

0x3ef: Pop(1)
0x3f0: Push((int) 509695)
0x3f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3f2: Pop(1)
0x3f3: @@@ ClearReplies(); Obj=0 // @poff=342
0x3f4: Pop(0)
0x3f5: Push((int) 509696)
0x3f6: Push((int) 10665)
0x3f7: Push((int) 10673)
0x3f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3f9: Pop(3)
0x3fa: Push((int) 509697)
0x3fb: Push((int) -1)
0x3fc: Push((int) 10675)
0x3fd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3fe: Pop(3)
0x3ff: Return(); Pop(0)
...
0x404: Stack[-1] = "Neutral" // @poff=315
0x405: Call2 0x340

0x406: Pop(1)
0x407: Push((int) 509685)
0x408: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x409: Pop(1)
0x40a: @@@ ClearReplies(); Obj=0 // @poff=342
0x40b: Pop(0)
0x40c: Push((int) 509687)
0x40d: Push((int) 10665)
0x40e: Push((int) 10664)
0x40f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x410: Pop(3)
0x411: Push((int) 509686)
0x412: Push((int) -1)
0x413: Push((int) 10663)
0x414: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x415: Pop(3)
0x416: Return(); Pop(0)
...
0x41b: Stack[-1] = "Neutral" // @poff=315
0x41c: Call2 0x340

0x41d: Pop(1)
0x41e: Push((int) 509688)
0x41f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x420: Pop(1)
0x421: @@@ ClearReplies(); Obj=0 // @poff=342
0x422: Pop(0)
0x423: Push((int) 509689)
0x424: Push((int) -1)
0x425: Push((int) 10666)
0x426: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x427: Pop(3)
0x428: Push((int) 509690)
0x429: Push((int) 10668)
0x42a: Push((int) 10667)
0x42b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x42c: Pop(3)
0x42d: Return(); Pop(0)
...
0x432: Stack[-1] = "Neutral" // @poff=315
0x433: Call2 0x340

0x434: Pop(1)
0x435: Push((int) 509691)
0x436: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x437: Pop(1)
0x438: @@@ ClearReplies(); Obj=0 // @poff=342
0x439: Pop(0)
0x43a: Push((int) 509692)
0x43b: Push((int) -1)
0x43c: Push((int) 10669)
0x43d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x43e: Pop(3)
0x43f: Push((int) 509693)
0x440: Push((int) -1)
0x441: Push((int) 10670)
0x442: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x443: Pop(3)
0x444: Push((int) 538762)
0x445: Push((int) -1)
0x446: Push((int) 40678)
0x447: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x448: Pop(3)
0x449: Return(); Pop(0)
...
0x44e: Stack[-1] = "Neutral" // @poff=315
0x44f: Call2 0x340

0x450: Pop(1)
0x451: Push((int) 509678)
0x452: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x453: Pop(1)
0x454: @@@ ClearReplies(); Obj=0 // @poff=342
0x455: Pop(0)
0x456: Push((int) 509679)
0x457: Push((int) 10643)
0x458: Push((int) 10654)
0x459: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x45a: Pop(3)
0x45b: Push((int) 509680)
0x45c: Push((int) 10643)
0x45d: Push((int) 10656)
0x45e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x45f: Pop(3)
0x460: Return(); Pop(0)
...
0x465: Stack[-1] = "Neutral" // @poff=315
0x466: Call2 0x340

0x467: Pop(1)
0x468: Push((int) 509669)
0x469: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x46a: Pop(1)
0x46b: @@@ ClearReplies(); Obj=0 // @poff=342
0x46c: Pop(0)
0x46d: Push((int) 509670)
0x46e: Push((int) 10645)
0x46f: Push((int) 10644)
0x470: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x471: Pop(3)
0x472: Return(); Pop(0)
...
0x477: Stack[-1] = "Neutral" // @poff=315
0x478: Call2 0x340

0x479: Pop(1)
0x47a: Push((int) 509671)
0x47b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x47c: Pop(1)
0x47d: @@@ ClearReplies(); Obj=0 // @poff=342
0x47e: Pop(0)
0x47f: Push((int) 509672)
0x480: Push((int) 43766)
0x481: Push((int) 10646)
0x482: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x483: Pop(3)
0x484: Push((int) 509676)
0x485: Push((int) 10647)
0x486: Push((int) 10650)
0x487: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x488: Pop(3)
0x489: Return(); Pop(0)
...
0x48e: Stack[-1] = "Neutral" // @poff=315
0x48f: Call2 0x340

0x490: Pop(1)
0x491: Push((int) 509673)
0x492: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x493: Pop(1)
0x494: @@@ ClearReplies(); Obj=0 // @poff=342
0x495: Pop(0)
0x496: Push((int) 541600)
0x497: Push((int) 43766)
0x498: Push((int) 43765)
0x499: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x49a: Pop(3)
0x49b: Push((int) 541602)
0x49c: Push((int) 43766)
0x49d: Push((int) 43767)
0x49e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x49f: Pop(3)
0x4a0: Return(); Pop(0)
...
0x4a5: Stack[-1] = "Neutral" // @poff=315
0x4a6: Call2 0x340

0x4a7: Pop(1)
0x4a8: Push((int) 541601)
0x4a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x4aa: Pop(1)
0x4ab: @@@ ClearReplies(); Obj=0 // @poff=342
0x4ac: Pop(0)
0x4ad: Push((int) 509674)
0x4ae: Push((int) -1)
0x4af: Push((int) 10648)
0x4b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x4b1: Pop(3)
0x4b2: Push((int) 509675)
0x4b3: Push((int) -1)
0x4b4: Push((int) 10649)
0x4b5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x4b6: Pop(3)
0x4b7: Return(); Pop(0)
...
0x4e1: Stack[-5] = Stack[-1]
0x4e2: Call2 0x4c5

0x4e3: Stack[-2] = Stack[-3]
0x4e4: Pop(2)
0x4e5: Push((int) 0)
...
0x4e9: Stack[-2] = "quest_d4_01" // @poff=374
0x4ea: Stack[-1] = "key1_done" // @poff=398
0x4eb: Call2 0x699

0x4ec: Pop(3)
0x4ed: PushEmpty(object)
0x4ee: Stack[-4] = Stack[-1]
...
0x509: Stack[-2] = "quest_d4_01" // @poff=374
0x50a: Stack[-1] = "key1_done" // @poff=398
0x50b: Call2 0x699
...
0x535: Pop(0)
0x536: Push("all") // @poff=218
0x537: PushEmpty(string, int)
0x538: Stack[-7] = Stack[-1]
0x539: Call2 0x6a5
...
0x589: Pop(0)
0x58a: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=418
0x58b: Pop(1)
...
0x590: Push("HasProperty") // @poff=432
0x591: Push((int) 2)
...
0x597: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=456
0x598: Pop(0)
0x599: Stack[-1] = Stack[-5]
0x59a: Return(); Pop(2)

0x59b: PushEmpty(bool, bool)
0x59c: @@ IsDead(Stack[-1]); Obj=3 // @poff=468
0x59d: Pop(0)
0x59e: Stack[-1] = Stack[-4]
0x59f: Return(); Pop(2)

0x5a0: PushEmpty(object, object, object, object)
0x5a1: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5b5: Pop(0)
0x5b6: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5b7: IF (Stack[-1] == 0) GOTO 0x5ba; Pop(1)

0x5b8: Stack[-6] = (bool) 0
0x5b9: Return(); Pop(4)

0x5ba: @@ GetScene(Stack[-1]); Obj=5 // @poff=489
0x5bb: Pop(0)
...
0x5ce: Stack[-6] = Stack[-2]
0x5cf: Stack[-1] = "noaccess" // @poff=498
0x5d0: Call2 0x58f
...
0x5d6: Push("noaccess") // @poff=498
0x5d7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=516
0x5d8: Pop(1)
0x5d9: Push((int) 0)
...
0x5e2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=30
0x5e3: Pop(0)
0x5e4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=528
0x5e5: Pop(0)
...
0x643: Push("Can't find lsh animation : ") // @poff=552
...
0x652: Push("Can't find lsh animation : ") // @poff=552
...
0x661: Push((float)9.999999974752427e-07)
...
0x66f: Pop(0)
0x670: @@ add(Stack[-4]); Obj=1 // @poff=608
0x671: Pop(0)
0x672: @@ add(Stack[-3]); Obj=1 // @poff=608
0x673: Pop(0)
0x674: Push((int) 3)
...
0x67a: @@ GetItemID(Stack[-3]); Obj=8 // @poff=612
0x67b: Pop(0)
0x67c: Push("Category") // @poff=622
0x67d: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x67e: Pop(1)
0x67f: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=640
0x680: Pop(0)
0x681: Pop(0); Push((bool) Stack[-1] == 0)
0x682: IF (Stack[-1] == 0) GOTO 0x686; Pop(1)

0x683: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=648
0x684: Pop(0)
0x685: GOTO 0x68b

0x686: PushEmpty(int, int)
0x687: Stack[-5] = Stack[-2]
0x688: Stack[-9] = Stack[-1]
0x689: Call2 0x66d
...
0x68e: Pop(0)
0x68f: @@ SetItemName(Stack[-4]); Obj=1 // @poff=658
0x690: Pop(0)
0x691: PushEmpty(object, object, int)
0x692: Stack[-8] = Stack[-3]
0x693: Stack[-4] = Stack[-2]
0x694: Stack[-6] = Stack[-1]
0x695: Call2 0x679
...
0x69b: Pop(0)
0x69c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6bf: PushEmpty()
0x6c0: Push("playsound") // @poff=670
0x6c1: Push("giveitem") // @poff=690
0x6c2: @ TriggerWorld(Stack[-2], Stack[-1])
0x6c3: Pop(2)
0x6c4: Return(); Pop(0)

0x6c5: PushEmpty()
0x6c6: Push("ood4WhiteMask1") // @poff=708
0x6c7: Push((int) 1)
...
0x6cb: PushEmpty()
0x6cc: Push("d4q01KeyWhite") // @poff=738
0x6cd: Push((int) 1)
0x6ce: @ SetVariable(Stack[-2], Stack[-1])
0x6cf: Pop(2)
0x6d0: Push("theaterkey is given") // @poff=766
0x6d1: @ Trace(Stack[-1])
0x6d2: Pop(1)
0x6d3: PushEmpty(object, string, int)
0x6d4: Stack[-5] = Stack[-3]
0x6d5: Stack[-2] = "d4q01_theater_key" // @poff=806
0x6d6: Stack[-1] = (int) 1
0x6d7: Call2 0x68c

0x6d8: Pop(3)
0x6d9: PushEmpty(bool, string, string)
0x6da: Stack[-2] = "quest_d4_01" // @poff=374
0x6db: Stack[-1] = "init_theater" // @poff=842
0x6dc: Call2 0x699
...
0x6df: PushEmpty()
0x6e0: Push("tvirin is given") // @poff=868
0x6e1: @ Trace(Stack[-1])
0x6e2: Pop(1)
0x6e3: PushEmpty(object, string, int)
0x6e4: Stack[-5] = Stack[-3]
0x6e5: Stack[-2] = "tvirin" // @poff=900
0x6e6: Stack[-1] = (int) 1
0x6e7: Call2 0x68c
...
0x6ea: PushEmpty()
0x6eb: Push((int) 0)
0x6ec: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=914
0x6ed: Pop(1)
0x6ee: Return(); Pop(0)

0x6ef: PushEmpty()
0x6f0: Push((int) 1)
0x6f1: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=914
0x6f2: Pop(1)
0x6f3: Return(); Pop(0)

0x6f4: PushEmpty()
0x6f5: PushEmpty(int, string)
0x6f6: Stack[-1] = "ood4WhiteMask1" // @poff=708
0x6f7: Call2 0x668
...
0x715: Stack[-1] = "ui/NPC_wmask.png" // @poff=943
0x716: Return(); Pop(0)

0x717: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=977
0x718: Return(); Pop(0)
