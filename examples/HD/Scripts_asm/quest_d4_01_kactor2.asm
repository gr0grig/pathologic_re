...
// @pool_raw:
...
0x322: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x323: Pop(3)
0x324: Push((int) 509724)
0x325: Push((int) -1)
0x326: Push((int) 10707)
0x327: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x328: Pop(3)
0x329: GOTO 0x32c
...
0x33b: Push("all") // @poff=218
0x33c: Push("idle") // @poff=364
...
0x344: Push("all") // @poff=218
0x345: Push("idle") // @poff=364
...
0x3a3: Stack[-1] = "Neutral" // @poff=315
0x3a4: Call2 0x34a

0x3a5: Pop(1)
0x3a6: Push((int) 509701)
0x3a7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3a8: Pop(1)
0x3a9: @@@ ClearReplies(); Obj=0 // @poff=342
0x3aa: Pop(0)
0x3ab: Push((int) 509702)
0x3ac: Push((int) 10682)
0x3ad: Push((int) 10681)
0x3ae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3af: Pop(3)
0x3b0: Push((int) 509711)
0x3b1: Push((int) 10682)
0x3b2: Push((int) 10691)
0x3b3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3b4: Pop(3)
0x3b5: Return(); Pop(0)

0x3b6: PushEmpty(string)
0x3b7: Stack[-1] = "Neutral" // @poff=315
0x3b8: Call2 0x34a

0x3b9: Pop(1)
0x3ba: Push((int) 509712)
0x3bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3bc: Pop(1)
0x3bd: @@@ ClearReplies(); Obj=0 // @poff=342
0x3be: Pop(0)
0x3bf: Push((int) 509713)
0x3c0: Push((int) 10695)
0x3c1: Push((int) 10694)
0x3c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3c3: Pop(3)
0x3c4: Push((int) 509720)
0x3c5: Push((int) 10702)
0x3c6: Push((int) 10701)
0x3c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3c8: Pop(3)
0x3c9: Push((int) 509723)
0x3ca: Push((int) 10695)
0x3cb: Push((int) 10705)
0x3cc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3cd: Pop(3)
0x3ce: Push((int) 509724)
0x3cf: Push((int) -1)
0x3d0: Push((int) 10707)
0x3d1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3d2: Pop(3)
0x3d3: Return(); Pop(0)
...
0x3d8: Stack[-1] = "Neutral" // @poff=315
0x3d9: Call2 0x34a

0x3da: Pop(1)
0x3db: Push((int) 509721)
0x3dc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3dd: Pop(1)
0x3de: @@@ ClearReplies(); Obj=0 // @poff=342
0x3df: Pop(0)
0x3e0: Push((int) 509722)
0x3e1: Push((int) 10697)
0x3e2: Push((int) 10703)
0x3e3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3e4: Pop(3)
0x3e5: Return(); Pop(0)
...
0x3ea: Stack[-1] = "Neutral" // @poff=315
0x3eb: Call2 0x34a

0x3ec: Pop(1)
0x3ed: Push((int) 509714)
0x3ee: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x3ef: Pop(1)
0x3f0: @@@ ClearReplies(); Obj=0 // @poff=342
0x3f1: Pop(0)
0x3f2: Push((int) 509715)
0x3f3: Push((int) 10697)
0x3f4: Push((int) 10696)
0x3f5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3f6: Pop(3)
0x3f7: Push((int) 509719)
0x3f8: Push((int) -1)
0x3f9: Push((int) 10700)
0x3fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x3fb: Pop(3)
0x3fc: Return(); Pop(0)
...
0x401: Stack[-1] = "Neutral" // @poff=315
0x402: Call2 0x34a

0x403: Pop(1)
0x404: Push((int) 509716)
0x405: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x406: Pop(1)
0x407: @@@ ClearReplies(); Obj=0 // @poff=342
0x408: Pop(0)
0x409: Push((int) 509717)
0x40a: Push((int) -1)
0x40b: Push((int) 10698)
0x40c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x40d: Pop(3)
0x40e: Push((int) 509718)
0x40f: Push((int) -1)
0x410: Push((int) 10699)
0x411: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x412: Pop(3)
0x413: Return(); Pop(0)
...
0x418: Stack[-1] = "Neutral" // @poff=315
0x419: Call2 0x34a

0x41a: Pop(1)
0x41b: Push((int) 509703)
0x41c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x41d: Pop(1)
0x41e: @@@ ClearReplies(); Obj=0 // @poff=342
0x41f: Pop(0)
0x420: Push((int) 509704)
0x421: Push((int) 10684)
0x422: Push((int) 10683)
0x423: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x424: Pop(3)
0x425: Push((int) 509710)
0x426: Push((int) 10684)
0x427: Push((int) 10689)
0x428: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x429: Pop(3)
0x42a: Return(); Pop(0)
...
0x42f: Stack[-1] = "Neutral" // @poff=315
0x430: Call2 0x34a

0x431: Pop(1)
0x432: Push((int) 509705)
0x433: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x434: Pop(1)
0x435: @@@ ClearReplies(); Obj=0 // @poff=342
0x436: Pop(0)
0x437: Push((int) 509706)
0x438: Push((int) 10686)
0x439: Push((int) 10685)
0x43a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x43b: Pop(3)
0x43c: Return(); Pop(0)
...
0x441: Stack[-1] = "Neutral" // @poff=315
0x442: Call2 0x34a

0x443: Pop(1)
0x444: Push((int) 509707)
0x445: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=331
0x446: Pop(1)
0x447: @@@ ClearReplies(); Obj=0 // @poff=342
0x448: Pop(0)
0x449: Push((int) 509708)
0x44a: Push((int) -1)
0x44b: Push((int) 10687)
0x44c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x44d: Pop(3)
0x44e: Push((int) 509709)
0x44f: Push((int) -1)
0x450: Push((int) 10688)
0x451: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=355
0x452: Pop(3)
0x453: Return(); Pop(0)
...
0x485: Stack[-2] = "quest_d4_01" // @poff=374
0x486: Stack[-1] = "key2_done" // @poff=398
0x487: Call2 0x635
...
0x4a5: Stack[-2] = "quest_d4_01" // @poff=374
0x4a6: Stack[-1] = "key2_done" // @poff=398
0x4a7: Call2 0x635
...
0x525: Pop(0)
0x526: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=418
0x527: Pop(1)
...
0x52c: Push("HasProperty") // @poff=432
0x52d: Push((int) 2)
...
0x533: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=456
0x534: Pop(0)
0x535: Stack[-1] = Stack[-5]
0x536: Return(); Pop(2)

0x537: PushEmpty(bool, bool)
0x538: @@ IsDead(Stack[-1]); Obj=3 // @poff=468
0x539: Pop(0)
0x53a: Stack[-1] = Stack[-4]
0x53b: Return(); Pop(2)

0x53c: PushEmpty(object, object, object, object)
0x53d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x551: Pop(0)
0x552: Pop(0); PushNull((bool) Stack[-2] == 0)
0x553: IF (Stack[-1] == 0) GOTO 0x556; Pop(1)

0x554: Stack[-6] = (bool) 0
0x555: Return(); Pop(4)

0x556: @@ GetScene(Stack[-1]); Obj=5 // @poff=489
0x557: Pop(0)
...
0x56a: Stack[-6] = Stack[-2]
0x56b: Stack[-1] = "noaccess" // @poff=498
0x56c: Call2 0x52b
...
0x572: Push("noaccess") // @poff=498
0x573: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=516
0x574: Pop(1)
0x575: Push((int) 0)
...
0x57e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=30
0x57f: Pop(0)
0x580: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=528
0x581: Pop(0)
...
0x5df: Push("Can't find lsh animation : ") // @poff=552
...
0x5ee: Push("Can't find lsh animation : ") // @poff=552
...
0x5fd: Push((float)9.999999974752427e-07)
...
0x606: Pop(0)
0x607: Stack[-1] = Stack[-4]
0x608: Return(); Pop(2)

0x609: PushEmpty(object, object)
0x60a: @ CreateIntVector(Stack[-1])
0x60b: Pop(0)
0x60c: @@ add(Stack[-4]); Obj=1 // @poff=608
0x60d: Pop(0)
0x60e: @@ add(Stack[-3]); Obj=1 // @poff=608
0x60f: Pop(0)
0x610: Push((int) 3)
...
0x616: @@ GetItemID(Stack[-3]); Obj=8 // @poff=612
0x617: Pop(0)
0x618: Push("Category") // @poff=622
0x619: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x61a: Pop(1)
0x61b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=640
0x61c: Pop(0)
0x61d: Pop(0); Push((bool) Stack[-1] == 0)
0x61e: IF (Stack[-1] == 0) GOTO 0x622; Pop(1)

0x61f: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=648
0x620: Pop(0)
0x621: GOTO 0x627

0x622: PushEmpty(int, int)
0x623: Stack[-5] = Stack[-2]
0x624: Stack[-9] = Stack[-1]
0x625: Call2 0x609
...
0x62a: Pop(0)
0x62b: @@ SetItemName(Stack[-4]); Obj=1 // @poff=658
0x62c: Pop(0)
0x62d: PushEmpty(object, object, int)
0x62e: Stack[-8] = Stack[-3]
0x62f: Stack[-4] = Stack[-2]
0x630: Stack[-6] = Stack[-1]
0x631: Call2 0x615
...
0x637: Pop(0)
0x638: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x65b: PushEmpty()
0x65c: Push("playsound") // @poff=670
0x65d: Push("giveitem") // @poff=690
0x65e: @ TriggerWorld(Stack[-2], Stack[-1])
0x65f: Pop(2)
0x660: Return(); Pop(0)

0x661: PushEmpty()
0x662: Push("d4q01KeyWasted") // @poff=708
0x663: Push((int) 1)
0x664: @ SetVariable(Stack[-2], Stack[-1])
0x665: Pop(2)
0x666: Push("soborkey is given") // @poff=738
0x667: @ Trace(Stack[-1])
0x668: Pop(1)
0x669: PushEmpty(object, string, int)
0x66a: Stack[-5] = Stack[-3]
0x66b: Stack[-2] = "d4q01_sobor_key" // @poff=774
0x66c: Stack[-1] = (int) 1
0x66d: Call2 0x628

0x66e: Pop(3)
0x66f: PushEmpty(bool, string, string)
0x670: Stack[-2] = "quest_d4_01" // @poff=374
0x671: Stack[-1] = "init_sobor" // @poff=806
0x672: Call2 0x635
...
0x675: PushEmpty()
0x676: Push("ood4WastedMale1") // @poff=828
0x677: Push((int) 1)
...
0x67b: PushEmpty()
0x67c: Push("tvirin is given") // @poff=860
0x67d: @ Trace(Stack[-1])
0x67e: Pop(1)
0x67f: PushEmpty(object, string, int)
0x680: Stack[-5] = Stack[-3]
0x681: Stack[-2] = "tvirin" // @poff=892
0x682: Stack[-1] = (int) 1
0x683: Call2 0x628
...
0x686: PushEmpty()
0x687: Push((int) 0)
0x688: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=906
0x689: Pop(1)
0x68a: Return(); Pop(0)

0x68b: PushEmpty()
0x68c: Push((int) 1)
0x68d: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=906
0x68e: Pop(1)
0x68f: Return(); Pop(0)

0x690: PushEmpty()
0x691: PushEmpty(int, string)
0x692: Stack[-1] = "ood4WastedMale1" // @poff=828
0x693: Call2 0x604
...
0x6b1: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=935
0x6b2: Return(); Pop(0)

0x6b3: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=975
0x6b4: Return(); Pop(0)
