...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b8: Push("Can't find lsh animation : ") // @poff=206
...
0x2c7: Push("Can't find lsh animation : ") // @poff=206
...
0x2cd: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2ce: Pop(0)
...
0x2e1: Push((float)9.999999974752427e-07)
...
0x305: PushEmpty()
0x306: Push("ood4SoborGuard1") // @poff=262
0x307: Push((int) 1)
...
0x30b: PushEmpty()
0x30c: Push("ood4TheaterGuard2") // @poff=294
0x30d: Push((int) 1)
...
0x313: Stack[-1] = "d4q01KeyWasted" // @poff=330
0x314: Call2 0x2e8
...
0x32b: Stack[-1] = "ood4SoborGuard1" // @poff=262
0x32c: Call2 0x2e8
...
0x337: Stack[-1] = "ood4TheaterGuard2" // @poff=294
0x338: Call2 0x2e8
...
0x356: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=386
0x357: Return(); Pop(0)

0x358: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=426
0x359: Return(); Pop(0)
