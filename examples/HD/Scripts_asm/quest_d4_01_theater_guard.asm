...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b3: Push("Can't find lsh animation : ") // @poff=206
...
0x2c2: Push("Can't find lsh animation : ") // @poff=206
...
0x2c8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2c9: Pop(0)
...
0x2fe: Stack[-2] = Stack[-5]
0x2ff: Return(); Pop(4)

0x300: PushEmpty()
0x301: Push("ood4TheaterGuard1") // @poff=262
0x302: Push((int) 1)
...
0x306: PushEmpty()
0x307: Push("ood4TheaterGuard2") // @poff=298
0x308: Push((int) 1)
...
0x30e: Stack[-1] = "d4q01KeyWhite" // @poff=334
0x30f: Call2 0x2e3
...
0x326: Stack[-1] = "ood4TheaterGuard1" // @poff=262
0x327: Call2 0x2e3
...
0x332: Stack[-1] = "ood4TheaterGuard2" // @poff=298
0x333: Call2 0x2e3
...
0x351: Stack[-1] = "ui/NPC_bmask.png" // @poff=388
0x352: Return(); Pop(0)

0x353: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=422
0x354: Return(); Pop(0)
