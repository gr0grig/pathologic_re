...
// @pool_raw:
// @pool_encoding:utf8
...
0x244: Push("Can't find lsh animation : ") // @poff=250
...
0x253: Push("Can't find lsh animation : ") // @poff=250
...
0x262: Push((float)9.999999974752427e-07)
...
0x26b: Pop(0)
0x26c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x295: Stack[-1] = Stack[-2]
0x296: Pop(1)
0x297: Push("d4q01WastedMale") // @poff=306
0x298: Push("pt_d4q01_key2_region") // @poff=338
0x299: Push((int) 1)
...
0x29d: Pop(0)
0x29e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=380
0x29f: Pop(5)
0x2a0: Return(); Pop(2)
...
0x2a7: Pop(1)
0x2a8: Stack[-2] = "pt_d4q01_key2_region" // @poff=338
0x2a9: Stack[-1] = (int) 2
0x2aa: Call2 0x2c3
...
0x2ae: Pop(0)
0x2af: @@ ShowMap(Stack[-1]); Obj=2 // @poff=388
0x2b0: Pop(1)
0x2b1: Return(); Pop(0)
...
0x2b4: Pop(0)
0x2b5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2b6: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2b7: Push("Can't find main outdoor scene") // @poff=396
0x2b8: @ Trace(Stack[-1])
0x2b9: Pop(1)
0x2ba: Stack[-1] = 0
...
0x2bd: @@ GetMap(Stack[-1]); Obj=2 // @poff=456
0x2be: Pop(0)
...
0x2c5: Pop(0)
0x2c6: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2c7: IF (Stack[-1] == 0) GOTO 0x2cc; Pop(1)

0x2c8: Push("Can't find main outdoor scene") // @poff=396
0x2c9: @ Trace(Stack[-1])
0x2ca: Pop(1)
0x2cb: Return(); Pop(8)

0x2cc: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=463
0x2cd: Pop(0)
0x2ce: Pop(0); Push((bool) Stack[-1] == 0)
0x2cf: IF (Stack[-1] == 0) GOTO 0x2d6; Pop(1)

0x2d0: Push("Warning: outdoor scene locator ") // @poff=474
0x2d1: Pop(1); Push(Stack[-1] + Stack[-11]);
0x2d2: Push(" doesnt exist") // @poff=538
0x2d3: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2d4: @ Trace(Stack[-1])
0x2d5: Pop(1)
0x2d6: @@ GetMap(Stack[-11]); Obj=2 // @poff=456
0x2d7: Pop(0)
0x2d8: Pop(0); PushNull((bool) Stack[-11] == 0)
0x2d9: IF (Stack[-1] == 0) GOTO 0x2de; Pop(1)

0x2da: Push("Can't find map") // @poff=566
0x2db: @ Trace(Stack[-1])
0x2dc: Pop(1)
0x2dd: Return(); Pop(8)
...
0x2e0: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=596
0x2e1: Pop(2)
0x2e2: Return(); Pop(8)

0x2e3: Stack[-2] = 0
0x2e4: PushEmpty(int, int)
0x2e5: Push("branch") // @poff=609
...
0x2f9: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=623
0x2fa: Return(); Pop(0)

0x2fb: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=663
0x2fc: Return(); Pop(0)
