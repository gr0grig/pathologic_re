...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b3: Push("Can't find lsh animation : ") // @poff=192
...
0x2c2: Push("Can't find lsh animation : ") // @poff=192
...
0x2d1: Push((float)9.999999974752427e-07)
...
0x2df: Pop(0)
0x2e0: @@ add(Stack[-4]); Obj=1 // @poff=248
0x2e1: Pop(0)
0x2e2: @@ add(Stack[-3]); Obj=1 // @poff=248
0x2e3: Pop(0)
0x2e4: Push((int) 3)
...
0x2ea: @@ GetItemID(Stack[-3]); Obj=8 // @poff=252
0x2eb: Pop(0)
0x2ec: Push("Category") // @poff=262
0x2ed: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2ee: Pop(1)
0x2ef: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=280
0x2f0: Pop(0)
0x2f1: Pop(0); Push((bool) Stack[-1] == 0)
0x2f2: IF (Stack[-1] == 0) GOTO 0x2f6; Pop(1)

0x2f3: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=288
0x2f4: Pop(0)
0x2f5: GOTO 0x2fb

0x2f6: PushEmpty(int, int)
0x2f7: Stack[-5] = Stack[-2]
0x2f8: Stack[-9] = Stack[-1]
0x2f9: Call2 0x2dd
...
0x2fe: Pop(0)
0x2ff: @@ SetItemName(Stack[-4]); Obj=1 // @poff=298
0x300: Pop(0)
0x301: PushEmpty(object, object, int)
0x302: Stack[-8] = Stack[-3]
0x303: Stack[-4] = Stack[-2]
...
0x30b: Pop(0)
0x30c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x31d: Stack[-2] = (int) 0
0x31e: Push("all") // @poff=138
0x31f: PushEmpty(string, int)
0x320: Stack[-5] = Stack[-1]
0x321: Call2 0x315
...
0x32b: Stack[-2] = Stack[-5]
0x32c: Return(); Pop(4)

0x32d: PushEmpty()
0x32e: Push("playsound") // @poff=310
0x32f: Push("giveitem") // @poff=330
0x330: @ TriggerWorld(Stack[-2], Stack[-1])
0x331: Pop(2)
0x332: Return(); Pop(0)

0x333: PushEmpty()
0x334: Push("powder is given") // @poff=348
0x335: @ Trace(Stack[-1])
0x336: Pop(1)
0x337: PushEmpty(object, string, int)
0x338: Stack[-5] = Stack[-3]
0x339: Stack[-2] = "powder" // @poff=380
0x33a: Stack[-1] = (int) 1
0x33b: Call2 0x2fc
...
0x33e: PushEmpty()
0x33f: Push("ood4BirdmaskHome1") // @poff=394
0x340: Push((int) 1)
...
0x344: PushEmpty()
0x345: Push("ood4BirdmaskHome2") // @poff=430
0x346: Push((int) 1)
...
0x34e: Pop(1)
0x34f: Push("d4q02BirdmaskNearHome") // @poff=466
0x350: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0x351: Pop(1)
0x352: Push(Stack[-1])
0x353: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x354: @@ Remove(); Obj=1 // @poff=519
0x355: Pop(0)
0x356: Push("d4q02MladVladGotoAJLSelf") // @poff=526
0x357: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0x358: Pop(1)
0x359: Push(Stack[-1])
0x35a: IF (Stack[-1] == 0) GOTO 0x35d; Pop(1)

0x35b: @@ Remove(); Obj=1 // @poff=519
0x35c: Pop(0)
0x35d: Push("d4q02MladVladGotoAnna") // @poff=576
0x35e: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0x35f: Pop(1)
0x360: Push(Stack[-1])
0x361: IF (Stack[-1] == 0) GOTO 0x364; Pop(1)

0x362: @@ Remove(); Obj=1 // @poff=519
0x363: Pop(0)
0x364: Push("d4q02MladVladGotoJulia") // @poff=620
0x365: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0x366: Pop(1)
0x367: Push(Stack[-1])
0x368: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x369: @@ Remove(); Obj=1 // @poff=519
0x36a: Pop(0)
0x36b: Push("d4q02MladVladGotoLara") // @poff=666
0x36c: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0x36d: Pop(1)
0x36e: Push(Stack[-1])
0x36f: IF (Stack[-1] == 0) GOTO 0x372; Pop(1)

0x370: @@ Remove(); Obj=1 // @poff=519
0x371: Pop(0)
0x372: PushEmpty()
0x373: Call2 0x3b8
...
0x376: Stack[-2] = "quest_d4_02" // @poff=710
0x377: Stack[-1] = "completed" // @poff=734
0x378: Call2 0x309
...
0x382: Stack[-2] = "quest_d4_02" // @poff=710
0x383: Stack[-1] = "birdmask_talk" // @poff=754
0x384: Call2 0x309
...
0x389: Stack[-1] = "ood4BirdmaskHome1" // @poff=394
0x38a: Call2 0x2d8
...
0x395: Stack[-1] = "ood4BirdmaskHome2" // @poff=430
0x396: Call2 0x2d8
...
0x3a1: Stack[-1] = "d4q02_survived" // @poff=782
0x3a2: Call2 0x2d8
...
0x3ca: Push("Can't retrieve diary root") // @poff=812
0x3cb: @ Trace(Stack[-1])
0x3cc: Pop(1)
...
0x3d5: Stack[-1] = Stack[-4]
0x3d6: Pop(1)
0x3d7: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=864
0x3d8: Pop(0)
0x3d9: Pop(0); Push((bool) Stack[-2] == 0)
0x3da: IF (Stack[-1] == 0) GOTO 0x3e1; Pop(1)

0x3db: Push("Can't find diary parent with id: ") // @poff=869
...
0x3e1: @@ AddChild(Stack[-8]); Obj=2 // @poff=937
0x3e2: Pop(0)
0x3e3: Push((int) 7)
0x3e4: @ SendWorldWndMessage(Stack[-1])
0x3e5: Pop(1)
0x3e6: @@ GetCategory(Stack[-1]); Obj=8 // @poff=946
0x3e7: Pop(0)
...
0x3f0: Pop(0)
0x3f1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3f2: IF (Stack[-1] == 0) GOTO 0x3f9; Pop(1)

0x3f3: Push("Can't find main outdoor scene") // @poff=958
0x3f4: @ Trace(Stack[-1])
0x3f5: Pop(1)
0x3f6: Stack[-1] = 0
...
0x3f9: @@ GetMap(Stack[-1]); Obj=2 // @poff=1018
0x3fa: Pop(0)
...
0x414: Stack[-1] = "ui/NPC_bmask.png" // @poff=1039
0x415: Return(); Pop(0)

0x416: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=1073
0x417: Return(); Pop(0)
