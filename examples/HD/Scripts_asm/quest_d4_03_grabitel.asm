...
0x6bc: Push((float)0.699999988079071)
0x6bd: Push((int) 500)
...
0x6c7: Pop(0)
0x6c8: @@ add(Stack[-3]); Obj=1 // @poff=796
0x6c9: Pop(0)
0x6ca: Push((int) 16)
...
0x6d1: Pop(0)
0x6d2: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x705: Push("GenerateMoney: iMin > iMax") // @poff=905
0x706: @ Trace(Stack[-1])
0x707: Pop(1)
0x708: Return(); Pop(4)
...
0x731: Stack[-3] = "lockpick" // @poff=983
0x732: Stack[-2] = (int) 1
0x733: Stack[-1] = (int) 6
0x734: Call2 0x636
...
0x737: Stack[-1] = "grabitel_mark" // @poff=1001
0x738: Call2 0x73f
...
0x741: Pop(0)
0x742: Stack[-1] = Stack[-4]
0x743: Return(); Pop(2)

0x744: PushEmpty()
0x745: PushEmpty(bool, string, string)
0x746: Stack[-2] = "quest_d4_03" // @poff=0
0x747: Stack[-1] = "death" // @poff=1029
0x748: Call2 0x6cf

0x749: Pop(3)
0x74a: PushEmpty(bool, object)
0x74b: Stack[-3] = Stack[-1]
0x74c: Call2 0x4f1
...
0x751: Stack[-1] = (float) 0.029999999329447746
0x752: Call2 0x691
...
0x75d: Stack[-7] = Stack[-3]
0x75e: Stack[-6] = Stack[-2]
0x75f: Stack[-5] = Stack[-1]
0x760: Call2 0x5ce
...
0x765: Stack[-11] = Stack[-5]
0x766: Stack[-10] = Stack[-4]
0x767: Stack[-9] = Stack[-3]
0x768: Stack[-7] = Stack[-2]
0x769: Stack[-6] = Stack[-1]
0x76a: Call2 0x612
