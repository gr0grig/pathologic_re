...
// @pool_raw:
// @pool_encoding:utf8
...
0x5d: Stack[-1] = "Doubt" // @poff=89
0x5e: Call2 0x95

0x5f: Pop(1)
0x60: Push((int) 510543)
0x61: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x62: Pop(1)
0x63: @@@ ClearReplies(); Obj=0 // @poff=112
0x64: Pop(0)
0x65: Push((int) 510544)
0x66: Push((int) 11634)
0x67: Push((int) 11633)
0x68: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x69: Pop(3)
0x6a: Push((int) 510560)
0x6b: Push((int) 16756)
0x6c: Push((int) 11649)
0x6d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x6e: Pop(3)
...
0x86: Push("all") // @poff=134
0x87: Push("idle") // @poff=142
...
0x8f: Push("all") // @poff=134
0x90: Push("idle") // @poff=142
...
0xc7: Stack[-1] = "Doubt" // @poff=89
0xc8: Call2 0x95

0xc9: Pop(1)
0xca: Push((int) 510543)
0xcb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xcc: Pop(1)
0xcd: @@@ ClearReplies(); Obj=0 // @poff=112
0xce: Pop(0)
0xcf: Push((int) 510544)
0xd0: Push((int) 11634)
0xd1: Push((int) 11633)
0xd2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xd3: Pop(3)
0xd4: Push((int) 510560)
0xd5: Push((int) 16756)
0xd6: Push((int) 11649)
0xd7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xd8: Pop(3)
0xd9: Push((int) 510566)
0xda: Push((int) 11634)
0xdb: Push((int) 11655)
0xdc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xdd: Pop(3)
0xde: Return(); Pop(0)
...
0xe3: Stack[-1] = "Agression" // @poff=152
0xe4: Call2 0x95

0xe5: Pop(1)
0xe6: Push((int) 515702)
0xe7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xe8: Pop(1)
0xe9: @@@ ClearReplies(); Obj=0 // @poff=112
0xea: Pop(0)
0xeb: Push((int) 515703)
0xec: Push((int) 11650)
0xed: Push((int) 16757)
0xee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xef: Pop(3)
0xf0: Return(); Pop(0)
...
0xf5: Stack[-1] = "Agression" // @poff=152
0xf6: Call2 0x95

0xf7: Pop(1)
0xf8: Push((int) 510561)
0xf9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0xfa: Pop(1)
0xfb: @@@ ClearReplies(); Obj=0 // @poff=112
0xfc: Pop(0)
0xfd: Push((int) 510562)
0xfe: Push((int) 11652)
0xff: Push((int) 11651)
0x100: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x101: Pop(3)
0x102: Return(); Pop(0)
...
0x107: Stack[-1] = "Sorrow" // @poff=172
0x108: Call2 0x95

0x109: Pop(1)
0x10a: Push((int) 510563)
0x10b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x10c: Pop(1)
0x10d: @@@ ClearReplies(); Obj=0 // @poff=112
0x10e: Pop(0)
0x10f: Push((int) 510564)
0x110: Push((int) 16749)
0x111: Push((int) 11653)
0x112: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x113: Pop(3)
0x114: Push((int) 510565)
0x115: Push((int) -1)
0x116: Push((int) 11654)
0x117: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x118: Pop(3)
0x119: Return(); Pop(0)
...
0x11e: Stack[-1] = "Smile" // @poff=186
0x11f: Call2 0x95

0x120: Pop(1)
0x121: Push((int) 510545)
0x122: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x123: Pop(1)
0x124: @@@ ClearReplies(); Obj=0 // @poff=112
0x125: Pop(0)
0x126: Push((int) 510546)
0x127: Push((int) 11636)
0x128: Push((int) 11635)
0x129: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x12a: Pop(3)
0x12b: Push((int) 510553)
0x12c: Push((int) 11643)
0x12d: Push((int) 11642)
0x12e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x12f: Pop(3)
0x130: Push((int) 510557)
0x131: Push((int) 11647)
0x132: Push((int) 11646)
0x133: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x134: Pop(3)
0x135: Return(); Pop(0)
...
0x13a: Stack[-1] = "Agression" // @poff=152
0x13b: Call2 0x95

0x13c: Pop(1)
0x13d: Push((int) 510558)
0x13e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x13f: Pop(1)
0x140: @@@ ClearReplies(); Obj=0 // @poff=112
0x141: Pop(0)
0x142: Push((int) 510559)
0x143: Push((int) 16743)
0x144: Push((int) 11648)
0x145: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x146: Pop(3)
0x147: Return(); Pop(0)
...
0x14c: Stack[-1] = "Doubt" // @poff=89
0x14d: Call2 0x95

0x14e: Pop(1)
0x14f: Push((int) 510554)
0x150: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x151: Pop(1)
0x152: @@@ ClearReplies(); Obj=0 // @poff=112
0x153: Pop(0)
0x154: Push((int) 510555)
0x155: Push((int) 16743)
0x156: Push((int) 11644)
0x157: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x158: Pop(3)
0x159: Push((int) 510556)
0x15a: Push((int) -1)
0x15b: Push((int) 11645)
0x15c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x15d: Pop(3)
0x15e: Return(); Pop(0)
...
0x163: Stack[-1] = "Sorrow" // @poff=172
0x164: Call2 0x95

0x165: Pop(1)
0x166: Push((int) 510547)
0x167: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x168: Pop(1)
0x169: @@@ ClearReplies(); Obj=0 // @poff=112
0x16a: Pop(0)
...
0x191: Stack[-1] = "Neutral" // @poff=198
0x192: Call2 0x95

0x193: Pop(1)
0x194: Push((int) 515695)
0x195: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x196: Pop(1)
0x197: @@@ ClearReplies(); Obj=0 // @poff=112
0x198: Pop(0)
0x199: Push((int) 515696)
0x19a: Push((int) 16749)
0x19b: Push((int) 16748)
0x19c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x19d: Pop(3)
...
0x1a8: Stack[-1] = "Neutral" // @poff=198
0x1a9: Call2 0x95
...
0x1b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1b9: Pop(3)
0x1ba: Return(); Pop(0)
...
0x1bf: Stack[-1] = "Neutral" // @poff=198
0x1c0: Call2 0x95

0x1c1: Pop(1)
0x1c2: Push((int) 515700)
0x1c3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1c4: Pop(1)
0x1c5: @@@ ClearReplies(); Obj=0 // @poff=112
0x1c6: Pop(0)
0x1c7: Push((int) 515704)
0x1c8: Push((int) 16760)
0x1c9: Push((int) 16759)
0x1ca: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1cb: Pop(3)
0x1cc: Return(); Pop(0)
...
0x1d1: Stack[-1] = "Neutral" // @poff=198
0x1d2: Call2 0x95

0x1d3: Pop(1)
0x1d4: Push((int) 515705)
0x1d5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1d6: Pop(1)
0x1d7: @@@ ClearReplies(); Obj=0 // @poff=112
0x1d8: Pop(0)
0x1d9: Push((int) 515706)
0x1da: Push((int) 16762)
0x1db: Push((int) 16761)
0x1dc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1dd: Pop(3)
0x1de: Push((int) 515708)
0x1df: Push((int) 16764)
0x1e0: Push((int) 16763)
0x1e1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1e2: Pop(3)
0x1e3: Return(); Pop(0)
...
0x1e8: Stack[-1] = "Neutral" // @poff=198
0x1e9: Call2 0x95

0x1ea: Pop(1)
0x1eb: Push((int) 515709)
0x1ec: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1ed: Pop(1)
0x1ee: @@@ ClearReplies(); Obj=0 // @poff=112
0x1ef: Pop(0)
0x1f0: Push((int) 515710)
0x1f1: Push((int) 16762)
0x1f2: Push((int) 16765)
0x1f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1f4: Pop(3)
0x1f5: Return(); Pop(0)
...
0x1fa: Stack[-1] = "Neutral" // @poff=198
0x1fb: Call2 0x95

0x1fc: Pop(1)
0x1fd: Push((int) 515707)
0x1fe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1ff: Pop(1)
0x200: @@@ ClearReplies(); Obj=0 // @poff=112
0x201: Pop(0)
0x202: Push((int) 512539)
0x203: Push((int) -1)
0x204: Push((int) 13708)
0x205: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x206: Pop(3)
0x207: Return(); Pop(0)
...
0x250: @@ GetPosition(Stack[-8]); Obj=20 // @poff=246
0x251: Pop(0)
0x252: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=258
0x253: Pop(0)
...
0x2bf: Push("voice_common") // @poff=282
0x2c0: Push((int) 1)
...
0x2c7: Push("voice_common") // @poff=282
0x2c8: Push((int) 0)
...
0x2da: Push("voice_common") // @poff=282
0x2db: Push((int) 1)
...
0x2e8: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x2e9: Pop(1)
...
0x313: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x314: Pop(1)
...
0x328: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=324
0x329: Pop(1)
0x32a: PushEmpty(bool, string)
0x32b: Stack[-3] = Stack[-1]
0x32c: Call2 0x34f

0x32d: Stack[-2] = Stack[-14]
0x32e: Pop(2)
0x32f: Return(); Pop(10)
...
0x33b: Push("Can't find lsh animation : ") // @poff=340
...
0x34a: Push("Can't find lsh animation : ") // @poff=340
...
0x36e: Push((float)9.999999974752427e-07)
...
0x39c: Pop(1)
0x39d: Push("d5q01BurahMeeting") // @poff=408
0x39e: Push("pt_d5q01_girl_corpse1") // @poff=444
0x39f: Push((int) 1)
...
0x3a3: Pop(0)
0x3a4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=488
0x3a5: Pop(5)
0x3a6: PushEmpty()
0x3a7: Call2 0x3c2
...
0x3aa: Stack[-2] = "quest_d5_01" // @poff=496
0x3ab: Stack[-1] = "burah_free" // @poff=520
0x3ac: Call2 0x37a
...
0x3af: Stack[-1] = 0
0x3b0: PushEmpty()
0x3b1: Push("ood5Burah1") // @poff=542
0x3b2: Push((int) 1)
...
0x3b8: Stack[-1] = "ood5Burah1" // @poff=542
0x3b9: Call2 0x375
...
0x3d4: Push("Can't retrieve diary root") // @poff=564
0x3d5: @ Trace(Stack[-1])
0x3d6: Pop(1)
...
0x3e0: Pop(1)
0x3e1: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=616
0x3e2: Pop(0)
0x3e3: Pop(0); Push((bool) Stack[-2] == 0)
0x3e4: IF (Stack[-1] == 0) GOTO 0x3eb; Pop(1)

0x3e5: Push("Can't find diary parent with id: ") // @poff=621
...
0x3eb: @@ AddChild(Stack[-8]); Obj=2 // @poff=689
0x3ec: Pop(0)
0x3ed: Push((int) 7)
0x3ee: @ SendWorldWndMessage(Stack[-1])
0x3ef: Pop(1)
0x3f0: @@ GetCategory(Stack[-1]); Obj=8 // @poff=698
0x3f1: Pop(0)
...
0x3fa: Pop(0)
0x3fb: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3fc: IF (Stack[-1] == 0) GOTO 0x403; Pop(1)

0x3fd: Push("Can't find main outdoor scene") // @poff=710
0x3fe: @ Trace(Stack[-1])
0x3ff: Pop(1)
0x400: Stack[-1] = 0
0x401: Stack[-1] = Stack[-5]
0x402: Return(); Pop(4)

0x403: @@ GetMap(Stack[-1]); Obj=2 // @poff=770
0x404: Pop(0)
...
0x41e: Stack[-1] = "ui/NPC_Burah.png" // @poff=791
0x41f: Return(); Pop(0)

0x420: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=825
0x421: Return(); Pop(0)
