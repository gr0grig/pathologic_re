...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
// @pool_encoding:utf8
...
0x6d9: Push("Can't find lsh animation : ") // @poff=995
...
0x6e8: Push("Can't find lsh animation : ") // @poff=995
...
0x6ee: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=668
0x6ef: Pop(0)
...
0x731: Push((float)9.999999974752427e-07)
...
0x75d: Pop(0)
0x75e: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x7a1: Pop(0)
0x7a2: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1079
0x7a3: Pop(0)
0x7a4: Push("Organ") // @poff=1091
0x7a5: Push((int) 1)
0x7a6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=832
0x7a7: Pop(2)
0x7a8: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1103
0x7a9: Pop(0)
0x7aa: Push((int) 0)
0x7ab: Push((int) 1)
...
0x7b8: Stack[-1] = "liver" // @poff=1113
0x7b9: Call2 0x79f

0x7ba: Pop(1)
0x7bb: PushEmpty(string)
0x7bc: Stack[-1] = "kidney" // @poff=1125
0x7bd: Call2 0x79f

0x7be: Pop(1)
0x7bf: PushEmpty(string)
0x7c0: Stack[-1] = "heart" // @poff=1139
0x7c1: Call2 0x79f

0x7c2: Pop(1)
0x7c3: PushEmpty(string)
0x7c4: Stack[-1] = "blood" // @poff=1151
0x7c5: Call2 0x79f
...
0x7ca: Stack[-7] = Stack[-3]
0x7cb: Stack[-6] = Stack[-2]
...
0x7d2: Stack[-11] = Stack[-5]
0x7d3: Stack[-10] = Stack[-4]
0x7d4: Stack[-9] = Stack[-3]
0x7d5: Stack[-7] = Stack[-2]
0x7d6: Stack[-6] = Stack[-1]
0x7d7: Call2 0x65e
...
0x7f1: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1163
0x7f2: Return(); Pop(0)

0x7f3: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1203
0x7f4: Return(); Pop(0)
