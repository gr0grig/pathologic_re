...
0x5ee: Push((float)0.699999988079071)
0x5ef: Push((int) 500)
...
0x5f9: Pop(0)
0x5fa: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x62c: Pop(0)
0x62d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=847
0x62e: Pop(0)
0x62f: Push("Organ") // @poff=859
0x630: Push((int) 1)
0x631: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=656
0x632: Pop(2)
0x633: @@ GetItemID(Stack[-2]); Obj=3 // @poff=871
0x634: Pop(0)
0x635: Push((int) 0)
0x636: Push((int) 1)
...
0x643: Stack[-1] = "liver" // @poff=881
0x644: Call2 0x62a

0x645: Pop(1)
0x646: PushEmpty(string)
0x647: Stack[-1] = "kidney" // @poff=893
0x648: Call2 0x62a

0x649: Pop(1)
0x64a: PushEmpty(string)
0x64b: Stack[-1] = "heart" // @poff=907
0x64c: Call2 0x62a

0x64d: Pop(1)
0x64e: PushEmpty(string)
0x64f: Stack[-1] = "blood" // @poff=919
0x650: Call2 0x62a
...
0x65d: Stack[-7] = Stack[-3]
0x65e: Stack[-6] = Stack[-2]
0x65f: Stack[-5] = Stack[-1]
0x660: Call2 0x533
...
0x665: Stack[-11] = Stack[-5]
0x666: Stack[-10] = Stack[-4]
0x667: Stack[-9] = Stack[-3]
0x668: Stack[-7] = Stack[-2]
0x669: Stack[-6] = Stack[-1]
0x66a: Call2 0x577
