...
// @pool_raw:
// @pool_encoding:utf8
...
0x12a: Push("player") // @poff=156
0x12b: @ FindActor(Stack[-4]T, Stack[-1])
0x12c: Pop(1)
...
0x13f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1ca: Pop(0)
0x1cb: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1cc: Pop(0)
...
0x1d6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1d7: Pop(0)
0x1d8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1d9: Pop(0)
...
0x1ff: Pop(0)
0x200: Push((bool) 1)
0x201: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x202: Pop(1)
...
0x21b: Push((bool) 1)
0x21c: @ CameraSwitchToNormal(Stack[-1])
0x21d: Pop(1)
...
0x223: Push("head") // @poff=170
0x224: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x225: Pop(1)
0x226: Push(Stack[-1])
...
0x22c: PushEmpty(bool, float, float, bool, float, float)
0x22d: @ lshHasAnimation(Stack[-3], Stack[-7])
0x22e: Pop(0)
0x22f: Push(Stack[-3])
0x230: IF (Stack[-1] == 0) GOTO 0x237; Pop(1)

0x231: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x232: Pop(0)
0x233: Push((bool) 0)
0x234: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x235: Pop(1)
0x236: GOTO 0x23b

0x237: Push("Can't find lsh animation : ") // @poff=206
0x238: Pop(1); Push(Stack[-1] + Stack[-8]);
0x239: @ Trace(Stack[-1])
0x23a: Pop(1)
0x23b: Return(); Pop(6)

0x23c: PushEmpty(bool, float, float, bool, float, float)
0x23d: @ lshHasAnimation(Stack[-3], Stack[-8])
0x23e: Pop(0)
0x23f: Push(Stack[-3])
0x240: IF (Stack[-1] == 0) GOTO 0x246; Pop(1)

0x241: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x242: Pop(0)
0x243: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x244: Pop(0)
0x245: GOTO 0x24a

0x246: Push("Can't find lsh animation : ") // @poff=206
0x247: Pop(1); Push(Stack[-1] + Stack[-9]);
0x248: @ Trace(Stack[-1])
0x249: Pop(1)
0x24a: Return(); Pop(6)

0x24b: PushEmpty(float, cvector, float, cvector)
0x24c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x24d: Pop(0)
0x24e: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x24f: Push(CvectorIndex(Stack[-1], 1))
0x250: Stack[-3] = Stack[-1]
0x251: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x252: Push("head") // @poff=170
0x253: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x254: Pop(1)
0x255: Return(); Pop(4)
...
0x260: Push((float)9.999999974752427e-07)
...
0x280: Push("branch") // @poff=262
0x281: @ GetVariable(Stack[-1], Stack[-2])
0x282: Pop(1)
0x283: Push((int) 0)
...
0x290: Stack[-1] = (int) 515556
0x291: Return(); Pop(0)

0x292: Stack[-1] = (int) 503341
0x293: Return(); Pop(0)

0x294: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=276
0x295: Return(); Pop(0)

0x296: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=316
0x297: Return(); Pop(0)
