...
0x225: Push("Can't find lsh animation : ") // @poff=206
...
0x234: Push("Can't find lsh animation : ") // @poff=206
...
0x23a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x23b: Pop(0)
...
0x26b: Stack[-2] = Stack[-5]
0x26c: Return(); Pop(4)

0x26d: PushEmpty(int, int)
0x26e: Push("branch") // @poff=262
...
0x282: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=276
0x283: Return(); Pop(0)

0x284: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=316
0x285: Return(); Pop(0)
