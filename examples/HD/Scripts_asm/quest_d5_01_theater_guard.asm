...
// @pool_raw:
// @pool_encoding:utf8
...
0x2ad: Pop(0)
0x2ae: Push((bool) 1)
0x2af: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2b0: Pop(1)
...
0x2c9: Push((bool) 1)
0x2ca: @ CameraSwitchToNormal(Stack[-1])
0x2cb: Pop(1)
...
0x2db: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2dc: Pop(0)
0x2dd: Push(Stack[-3])
0x2de: IF (Stack[-1] == 0) GOTO 0x2e5; Pop(1)

0x2df: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2e0: Pop(0)
0x2e1: Push((bool) 0)
0x2e2: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2e3: Pop(1)
0x2e4: GOTO 0x2e9

0x2e5: Push("Can't find lsh animation : ") // @poff=206
0x2e6: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2e7: @ Trace(Stack[-1])
0x2e8: Pop(1)
0x2e9: Return(); Pop(6)

0x2ea: PushEmpty(bool, float, float, bool, float, float)
0x2eb: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2ec: Pop(0)
0x2ed: Push(Stack[-3])
0x2ee: IF (Stack[-1] == 0) GOTO 0x2f4; Pop(1)

0x2ef: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2f0: Pop(0)
0x2f1: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2f2: Pop(0)
0x2f3: GOTO 0x2f8

0x2f4: Push("Can't find lsh animation : ") // @poff=206
...
0x2fb: Pop(0)
0x2fc: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x311: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x312: Return(); Pop(2)
...
0x332: PushEmpty()
0x333: Push("ood5Whitemask1") // @poff=262
0x334: Push((int) 1)
...
0x338: PushEmpty()
0x339: Push("ood5Whitemask2") // @poff=292
0x33a: Push((int) 1)
...
0x340: Stack[-1] = "ood5Whitemask1" // @poff=262
0x341: Call2 0x315
...
0x34c: Stack[-1] = "ood5Whitemask2" // @poff=292
0x34d: Call2 0x315
...
0x367: Stack[-1] = (int) 515569
0x368: Return(); Pop(0)

0x369: Stack[-1] = (int) 503354
0x36a: Return(); Pop(0)

0x36b: Stack[-1] = "ui/NPC_wmask.png" // @poff=336
0x36c: Return(); Pop(0)

0x36d: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=370
0x36e: Return(); Pop(0)
