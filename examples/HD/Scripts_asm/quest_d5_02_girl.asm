...
// @pool_raw:
// @pool_encoding:utf8
...
0x19b: Stack[-8] = Stack[-2]
0x19c: Stack[-7] = Stack[-1]
0x19d: Call2 0x1d5
...
0x27c: Pop(0)
0x27d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x27e: Pop(0)
...
0x288: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x289: Pop(0)
0x28a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x28b: Pop(0)
...
0x2e9: Push("Can't find lsh animation : ") // @poff=222
...
0x2f8: Push("Can't find lsh animation : ") // @poff=222
...
0x2fe: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2ff: Pop(0)
...
0x318: Push((float)9.999999974752427e-07)
...
0x326: Pop(0)
0x327: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x352: Pop(1)
0x353: Stack[-2] = "pt_d5q01_girl_corpse1" // @poff=278
0x354: Stack[-1] = (int) 2
0x355: Call2 0x3cc
...
0x359: Pop(0)
0x35a: @@ ShowMap(Stack[-1]); Obj=2 // @poff=322
0x35b: Pop(1)
0x35c: Return(); Pop(0)

0x35d: PushEmpty(object, object)
0x35e: Push("d5q02") // @poff=330
0x35f: Push((int) 4)
...
0x364: Stack[-1] = Stack[-2]
0x365: Pop(1)
0x366: Push("d5q02NudeMeeting") // @poff=342
0x367: Push("pt_d5q01_girl_corpse1") // @poff=278
0x368: Push((int) 0)
...
0x36c: Pop(0)
0x36d: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=376
0x36e: Pop(5)
0x36f: PushEmpty()
0x370: Call2 0x385
...
0x373: Stack[-2] = "quest_d5_02" // @poff=384
0x374: Stack[-1] = "remove_girl" // @poff=408
0x375: Call2 0x324
...
0x397: Push("Can't retrieve diary root") // @poff=432
0x398: @ Trace(Stack[-1])
0x399: Pop(1)
...
0x3a3: Pop(1)
0x3a4: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=484
0x3a5: Pop(0)
0x3a6: Pop(0); Push((bool) Stack[-2] == 0)
0x3a7: IF (Stack[-1] == 0) GOTO 0x3ae; Pop(1)

0x3a8: Push("Can't find diary parent with id: ") // @poff=489
...
0x3ae: @@ AddChild(Stack[-8]); Obj=2 // @poff=557
0x3af: Pop(0)
0x3b0: Push((int) 7)
0x3b1: @ SendWorldWndMessage(Stack[-1])
0x3b2: Pop(1)
0x3b3: @@ GetCategory(Stack[-1]); Obj=8 // @poff=566
0x3b4: Pop(0)
...
0x3bd: Pop(0)
0x3be: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3bf: IF (Stack[-1] == 0) GOTO 0x3c6; Pop(1)

0x3c0: Push("Can't find main outdoor scene") // @poff=578
0x3c1: @ Trace(Stack[-1])
0x3c2: Pop(1)
0x3c3: Stack[-1] = 0
...
0x3c6: @@ GetMap(Stack[-1]); Obj=2 // @poff=638
0x3c7: Pop(0)
0x3c8: Stack[-1] = Stack[-5]
0x3c9: Return(); Pop(4)
...
0x3ce: Pop(0)
0x3cf: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3d0: IF (Stack[-1] == 0) GOTO 0x3d5; Pop(1)

0x3d1: Push("Can't find main outdoor scene") // @poff=578
0x3d2: @ Trace(Stack[-1])
0x3d3: Pop(1)
0x3d4: Return(); Pop(8)

0x3d5: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=645
0x3d6: Pop(0)
0x3d7: Pop(0); Push((bool) Stack[-1] == 0)
0x3d8: IF (Stack[-1] == 0) GOTO 0x3df; Pop(1)

0x3d9: Push("Warning: outdoor scene locator ") // @poff=656
0x3da: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3db: Push(" doesnt exist") // @poff=720
0x3dc: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3dd: @ Trace(Stack[-1])
0x3de: Pop(1)
0x3df: @@ GetMap(Stack[-11]); Obj=2 // @poff=638
0x3e0: Pop(0)
0x3e1: Pop(0); PushNull((bool) Stack[-11] == 0)
0x3e2: IF (Stack[-1] == 0) GOTO 0x3e7; Pop(1)

0x3e3: Push("Can't find map") // @poff=748
0x3e4: @ Trace(Stack[-1])
0x3e5: Pop(1)
0x3e6: Return(); Pop(8)
...
0x3e9: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=778
0x3ea: Pop(2)
0x3eb: Return(); Pop(8)

0x3ec: Stack[-2] = 0
0x3ed: PushEmpty(int, int)
0x3ee: Push("branch") // @poff=791
...
0x402: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=805
0x403: Return(); Pop(0)

0x404: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=845
0x405: Return(); Pop(0)
