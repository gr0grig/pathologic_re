...
// @pool_raw:
...
Events:
EVENT_26 Op = 0x683 Vars = (string)
EVENT_6 Op = 0x69b Vars = ()
...
0x17e: Stack[-1] = "Neutral" // @poff=125
0x17f: Call2 0x1fa

0x180: Pop(1)
0x181: Push((int) 511917)
0x182: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x183: Pop(1)
0x184: @@@ ClearReplies(); Obj=0 // @poff=152
0x185: Pop(0)
0x186: Push((int) 515734)
0x187: Push((int) 16793)
0x188: Push((int) 16792)
0x189: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x18a: Pop(3)
0x18b: Push((int) 515732)
0x18c: Push((int) 16791)
0x18d: Push((int) 16790)
0x18e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x18f: Pop(3)
0x190: GOTO 0x1dc

0x191: PushEmpty(string)
0x192: Stack[-1] = "Neutral" // @poff=125
0x193: Call2 0x1fa

0x194: Pop(1)
0x195: Push((int) 511935)
0x196: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x197: Pop(1)
0x198: @@@ ClearReplies(); Obj=0 // @poff=152
0x199: Pop(0)
...
0x1a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1a3: Pop(3)
...
0x1bf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1c0: Pop(3)
...
0x1d2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1d3: Pop(3)
0x1d4: Push((int) 512490)
0x1d5: Push((int) -1)
0x1d6: Push((int) 13659)
0x1d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x1d8: Pop(3)
0x1d9: GOTO 0x1dc
...
0x1eb: Push("all") // @poff=28
0x1ec: Push("idle") // @poff=18
...
0x1f4: Push("all") // @poff=28
0x1f5: Push("idle") // @poff=18
...
0x293: Stack[-1] = "Neutral" // @poff=125
0x294: Call2 0x1fa

0x295: Pop(1)
0x296: Push((int) 511917)
0x297: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x298: Pop(1)
0x299: @@@ ClearReplies(); Obj=0 // @poff=152
0x29a: Pop(0)
0x29b: Push((int) 515734)
0x29c: Push((int) 16793)
0x29d: Push((int) 16792)
0x29e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x29f: Pop(3)
...
0x2a7: Stack[-1] = "Neutral" // @poff=125
0x2a8: Call2 0x1fa

0x2a9: Pop(1)
0x2aa: Push((int) 511935)
0x2ab: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x2ac: Pop(1)
0x2ad: @@@ ClearReplies(); Obj=0 // @poff=152
0x2ae: Pop(0)
...
0x2b7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2b8: Pop(3)
...
0x2d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2d5: Pop(3)
...
0x2e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2e8: Pop(3)
0x2e9: Push((int) 512490)
0x2ea: Push((int) -1)
0x2eb: Push((int) 13659)
0x2ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2ed: Pop(3)
0x2ee: Return(); Pop(0)
...
0x2f3: Stack[-1] = "Neutral" // @poff=125
0x2f4: Call2 0x1fa

0x2f5: Pop(1)
0x2f6: Push((int) 511939)
0x2f7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x2f8: Pop(1)
0x2f9: @@@ ClearReplies(); Obj=0 // @poff=152
0x2fa: Pop(0)
0x2fb: Push((int) 511947)
0x2fc: Push((int) 13165)
0x2fd: Push((int) 13164)
0x2fe: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x2ff: Pop(3)
0x300: Return(); Pop(0)
...
0x305: Stack[-1] = "Neutral" // @poff=125
0x306: Call2 0x1fa

0x307: Pop(1)
0x308: Push((int) 511948)
0x309: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x30a: Pop(1)
0x30b: @@@ ClearReplies(); Obj=0 // @poff=152
0x30c: Pop(0)
0x30d: Push((int) 511949)
0x30e: Push((int) 13167)
0x30f: Push((int) 13166)
0x310: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x311: Pop(3)
0x312: Push((int) 515752)
0x313: Push((int) 13167)
0x314: Push((int) 16816)
0x315: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x316: Pop(3)
0x317: Return(); Pop(0)
...
0x31c: Stack[-1] = "Neutral" // @poff=125
0x31d: Call2 0x1fa

0x31e: Pop(1)
0x31f: Push((int) 511950)
0x320: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x321: Pop(1)
0x322: @@@ ClearReplies(); Obj=0 // @poff=152
0x323: Pop(0)
0x324: Push((int) 511951)
0x325: Push((int) 13171)
0x326: Push((int) 13168)
0x327: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x328: Pop(3)
0x329: Return(); Pop(0)
...
0x32e: Stack[-1] = "Neutral" // @poff=125
0x32f: Call2 0x1fa

0x330: Pop(1)
0x331: Push((int) 511954)
0x332: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x333: Pop(1)
0x334: @@@ ClearReplies(); Obj=0 // @poff=152
0x335: Pop(0)
0x336: Push((int) 511955)
0x337: Push((int) -1)
0x338: Push((int) 13172)
0x339: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x33a: Pop(3)
0x33b: Push((int) 515754)
0x33c: Push((int) -1)
0x33d: Push((int) 16820)
0x33e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x33f: Pop(3)
0x340: Return(); Pop(0)
...
0x345: Stack[-1] = "Neutral" // @poff=125
0x346: Call2 0x1fa

0x347: Pop(1)
0x348: Push((int) 511938)
0x349: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x34a: Pop(1)
0x34b: @@@ ClearReplies(); Obj=0 // @poff=152
0x34c: Pop(0)
0x34d: Push((int) 511940)
0x34e: Push((int) 13158)
0x34f: Push((int) 13157)
0x350: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x351: Pop(3)
0x352: Push((int) 515753)
0x353: Push((int) 13160)
0x354: Push((int) 16818)
0x355: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x356: Pop(3)
0x357: Return(); Pop(0)
...
0x35c: Stack[-1] = "Neutral" // @poff=125
0x35d: Call2 0x1fa

0x35e: Pop(1)
0x35f: Push((int) 511941)
0x360: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x361: Pop(1)
0x362: @@@ ClearReplies(); Obj=0 // @poff=152
0x363: Pop(0)
0x364: Push((int) 511942)
0x365: Push((int) 13160)
0x366: Push((int) 13159)
0x367: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x368: Pop(3)
0x369: Push((int) 515749)
0x36a: Push((int) 13160)
0x36b: Push((int) 16811)
0x36c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x36d: Pop(3)
0x36e: Return(); Pop(0)
...
0x373: Stack[-1] = "Neutral" // @poff=125
0x374: Call2 0x1fa

0x375: Pop(1)
0x376: Push((int) 511943)
0x377: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x378: Pop(1)
0x379: @@@ ClearReplies(); Obj=0 // @poff=152
0x37a: Pop(0)
0x37b: Push((int) 511944)
0x37c: Push((int) 13162)
0x37d: Push((int) 13161)
0x37e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x37f: Pop(3)
0x380: Return(); Pop(0)
...
0x385: Stack[-1] = "Neutral" // @poff=125
0x386: Call2 0x1fa

0x387: Pop(1)
0x388: Push((int) 511945)
0x389: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x38a: Pop(1)
0x38b: @@@ ClearReplies(); Obj=0 // @poff=152
0x38c: Pop(0)
0x38d: Push((int) 511946)
0x38e: Push((int) 13169)
0x38f: Push((int) 13163)
0x390: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x391: Pop(3)
0x392: Return(); Pop(0)
...
0x397: Stack[-1] = "Neutral" // @poff=125
0x398: Call2 0x1fa

0x399: Pop(1)
0x39a: Push((int) 511952)
0x39b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x39c: Pop(1)
0x39d: @@@ ClearReplies(); Obj=0 // @poff=152
0x39e: Pop(0)
...
0x3bb: Stack[-1] = "Neutral" // @poff=125
0x3bc: Call2 0x1fa
...
0x3cd: Stack[-1] = "Neutral" // @poff=125
0x3ce: Call2 0x1fa

0x3cf: Pop(1)
0x3d0: Push((int) 515735)
0x3d1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3d2: Pop(1)
0x3d3: @@@ ClearReplies(); Obj=0 // @poff=152
0x3d4: Pop(0)
0x3d5: Push((int) 511918)
0x3d6: Push((int) 13135)
0x3d7: Push((int) 13134)
0x3d8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3d9: Pop(3)
...
0x3e4: Stack[-1] = "Neutral" // @poff=125
0x3e5: Call2 0x1fa

0x3e6: Pop(1)
0x3e7: Push((int) 515738)
0x3e8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3e9: Pop(1)
0x3ea: @@@ ClearReplies(); Obj=0 // @poff=152
0x3eb: Pop(0)
0x3ec: Push((int) 515739)
0x3ed: Push((int) 13137)
0x3ee: Push((int) 16798)
0x3ef: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x3f0: Pop(3)
0x3f1: Return(); Pop(0)
...
0x3f6: Stack[-1] = "Neutral" // @poff=125
0x3f7: Call2 0x1fa

0x3f8: Pop(1)
0x3f9: Push((int) 511919)
0x3fa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x3fb: Pop(1)
0x3fc: @@@ ClearReplies(); Obj=0 // @poff=152
0x3fd: Pop(0)
0x3fe: Push((int) 511920)
0x3ff: Push((int) 13137)
0x400: Push((int) 13136)
0x401: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x402: Pop(3)
0x403: Push((int) 515743)
0x404: Push((int) 16805)
0x405: Push((int) 16804)
0x406: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x407: Pop(3)
0x408: Return(); Pop(0)
...
0x40d: Stack[-1] = "Neutral" // @poff=125
0x40e: Call2 0x1fa

0x40f: Pop(1)
0x410: Push((int) 515744)
0x411: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x412: Pop(1)
0x413: @@@ ClearReplies(); Obj=0 // @poff=152
0x414: Pop(0)
0x415: Push((int) 515745)
0x416: Push((int) 16807)
0x417: Push((int) 16806)
0x418: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x419: Pop(3)
0x41a: Return(); Pop(0)
...
0x41f: Stack[-1] = "Neutral" // @poff=125
0x420: Call2 0x1fa

0x421: Pop(1)
0x422: Push((int) 515746)
0x423: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x424: Pop(1)
0x425: @@@ ClearReplies(); Obj=0 // @poff=152
0x426: Pop(0)
...
0x436: Stack[-1] = "Neutral" // @poff=125
0x437: Call2 0x1fa

0x438: Pop(1)
0x439: Push((int) 511921)
0x43a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x43b: Pop(1)
0x43c: @@@ ClearReplies(); Obj=0 // @poff=152
0x43d: Pop(0)
0x43e: Push((int) 511924)
0x43f: Push((int) 13141)
0x440: Push((int) 13140)
0x441: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x442: Pop(3)
0x443: Push((int) 511922)
0x444: Push((int) 13139)
0x445: Push((int) 13138)
0x446: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x447: Pop(3)
0x448: Return(); Pop(0)
...
0x44d: Stack[-1] = "Neutral" // @poff=125
0x44e: Call2 0x1fa

0x44f: Pop(1)
0x450: Push((int) 511923)
0x451: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x452: Pop(1)
0x453: @@@ ClearReplies(); Obj=0 // @poff=152
0x454: Pop(0)
...
0x45f: Stack[-1] = "Neutral" // @poff=125
0x460: Call2 0x1fa

0x461: Pop(1)
0x462: Push((int) 511925)
0x463: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x464: Pop(1)
0x465: @@@ ClearReplies(); Obj=0 // @poff=152
0x466: Pop(0)
0x467: Push((int) 511926)
0x468: Push((int) 13143)
0x469: Push((int) 13142)
0x46a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x46b: Pop(3)
0x46c: Push((int) 511930)
0x46d: Push((int) 13148)
0x46e: Push((int) 13147)
0x46f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x470: Pop(3)
0x471: Return(); Pop(0)
...
0x476: Stack[-1] = "Neutral" // @poff=125
0x477: Call2 0x1fa

0x478: Pop(1)
0x479: Push((int) 511931)
0x47a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x47b: Pop(1)
0x47c: @@@ ClearReplies(); Obj=0 // @poff=152
0x47d: Pop(0)
0x47e: Push((int) 511932)
0x47f: Push((int) 13150)
0x480: Push((int) 13149)
0x481: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x482: Pop(3)
0x483: Push((int) 515741)
0x484: Push((int) 13150)
0x485: Push((int) 16801)
0x486: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x487: Pop(3)
0x488: Return(); Pop(0)
...
0x48d: Stack[-1] = "Neutral" // @poff=125
0x48e: Call2 0x1fa

0x48f: Pop(1)
0x490: Push((int) 511933)
0x491: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x492: Pop(1)
0x493: @@@ ClearReplies(); Obj=0 // @poff=152
0x494: Pop(0)
0x495: Push((int) 511934)
0x496: Push((int) -1)
0x497: Push((int) 13151)
0x498: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x499: Pop(3)
0x49a: Push((int) 515742)
0x49b: Push((int) 13143)
0x49c: Push((int) 16803)
0x49d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x49e: Pop(3)
0x49f: Return(); Pop(0)
...
0x4a4: Stack[-1] = "Neutral" // @poff=125
0x4a5: Call2 0x1fa

0x4a6: Pop(1)
0x4a7: Push((int) 511927)
0x4a8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=141
0x4a9: Pop(1)
0x4aa: @@@ ClearReplies(); Obj=0 // @poff=152
0x4ab: Pop(0)
0x4ac: Push((int) 511928)
0x4ad: Push((int) -1)
0x4ae: Push((int) 13144)
0x4af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4b0: Pop(3)
0x4b1: Push((int) 515740)
0x4b2: Push((int) -1)
0x4b3: Push((int) 16800)
0x4b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=165
0x4b5: Pop(3)
0x4b6: Return(); Pop(0)
...
0x4d1: Pop(1)
0x4d2: @@ GetLocator(Stack[-1], Stack[-11]); Obj=12 // @poff=174
0x4d3: Pop(1)
...
0x4e6: Pop(0)
0x4e7: @ irand(Stack[-9], Stack[-2]T)
0x4e8: Pop(0)
0x4e9: PushEmpty(string, int)
0x4ea: Stack[-11] = Stack[-1]
0x4eb: Call2 0x676

0x4ec: Pop(1)
0x4ed: @@ GetLocator(Stack[-1], Stack[-9], Stack[-8], Stack[-7]); Obj=12 // @poff=174
0x4ee: Pop(1)
...
0x525: Push("all") // @poff=28
0x526: Push("walk_stopl") // @poff=193
0x527: @ GetAnimationOffset(Stack[-4], Stack[-2], Stack[-1])
0x528: Pop(2)
0x529: Push("all") // @poff=28
0x52a: Push("walk_stopr") // @poff=215
...
0x561: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=249
0x562: Pop(0)
0x563: Pop(0); Push(Stack[-1] + Stack[-3]);
0x564: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=261
0x565: Pop(1)
0x566: Return(); Pop(2)
...
0x58b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=237
0x58c: Pop(0)
0x58d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=273
0x58e: Pop(0)
...
0x5b4: Pop(0)
0x5b5: Push((bool) 1)
0x5b6: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x5b7: Pop(1)
0x5b8: Push(CvectorIndex(Stack[-4], 0))
0x5b9: Push(CvectorIndex(Stack[-5], 2))
0x5ba: @ Rotate(Stack[-2], Stack[-1])
0x5bb: Pop(2)
...
0x5c1: Push("head") // @poff=287
0x5c2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5c3: Pop(1)
0x5c4: Push(Stack[-1])
0x5c5: IF (Stack[-1] == 0) GOTO 0x5c9; Pop(1)

0x5c6: Push("head") // @poff=287
0x5c7: @ LookAsyncCamera(Stack[-1])
0x5c8: Pop(1)
0x5c9: @ CameraWaitForPlayFinish()
0x5ca: Pop(0)
0x5cb: @ ResumeWorld()
0x5cc: Pop(0)
0x5cd: Stack[-21] = (bool) 1
0x5ce: Return(); Pop(18)

0x5cf: PushEmpty(bool, bool)
0x5d0: Push((bool) 1)
0x5d1: @ CameraSwitchToNormal(Stack[-1])
0x5d2: Pop(1)
...
0x5d8: Push("head") // @poff=287
0x5d9: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5da: Pop(1)
0x5db: Push(Stack[-1])
0x5dc: IF (Stack[-1] == 0) GOTO 0x5e0; Pop(1)

0x5dd: Push("head") // @poff=287
0x5de: @ UnlookAsync(Stack[-1])
0x5df: Pop(1)
0x5e0: Return(); Pop(2)

0x5e1: PushEmpty(bool, float, float, bool, float, float)
0x5e2: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5e3: Pop(0)
0x5e4: Push(Stack[-3])
0x5e5: IF (Stack[-1] == 0) GOTO 0x5ec; Pop(1)

0x5e6: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5e7: Pop(0)
0x5e8: Push((bool) 0)
...
0x5ec: Push("Can't find lsh animation : ") // @poff=297
0x5ed: Pop(1); Push(Stack[-1] + Stack[-8]);
0x5ee: @ Trace(Stack[-1])
0x5ef: Pop(1)
0x5f0: Return(); Pop(6)

0x5f1: PushEmpty(bool, float, float, bool, float, float)
0x5f2: @ lshHasAnimation(Stack[-3], Stack[-8])
0x5f3: Pop(0)
0x5f4: Push(Stack[-3])
0x5f5: IF (Stack[-1] == 0) GOTO 0x5fb; Pop(1)

0x5f6: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x5f7: Pop(0)
0x5f8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x5f9: Pop(0)
0x5fa: GOTO 0x5ff

0x5fb: Push("Can't find lsh animation : ") // @poff=297
0x5fc: Pop(1); Push(Stack[-1] + Stack[-9]);
0x5fd: @ Trace(Stack[-1])
0x5fe: Pop(1)
0x5ff: Return(); Pop(6)
...
0x608: @ self(Stack[-1])
0x609: Pop(0)
0x60a: Stack[-1] = Stack[-3]
0x60b: Return(); Pop(2)

0x60c: Stack[-1] = 0
0x60d: PushEmpty(float, float)
0x60e: Pop(0); Push(Stack[-3] | Stack[-3]);
0x60f: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x610: Push((float)9.999999974752427e-07)
0x611: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x612: IF (Stack[-1] == 0) GOTO 0x615; Pop(1)

0x613: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x614: Return(); Pop(2)

0x615: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x616: Return(); Pop(2)
...
0x61f: PushEmpty()
0x620: Push(CvectorIndex(Stack[-1], 0))
0x621: Push(CvectorIndex(Stack[-2], 0))
0x622: Pop(2); Push(Stack[-2] * Stack[-1]);
0x623: Push(CvectorIndex(Stack[-2], 2))
0x624: Push(CvectorIndex(Stack[-3], 2))
0x625: Pop(2); Push(Stack[-2] * Stack[-1]);
0x626: Pop(2); Push(Stack[-2] + Stack[-1]);
0x627: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x628: Return(); Pop(0)

0x629: PushEmpty(int, int)
0x62a: @ GetVariable(Stack[-3], Stack[-1])
0x62b: Pop(0)
0x62c: Stack[-1] = Stack[-4]
0x62d: Return(); Pop(2)

0x62e: PushEmpty(object, object)
0x62f: @ CreateIntVector(Stack[-1])
0x630: Pop(0)
0x631: @@ add(Stack[-4]); Obj=1 // @poff=353
0x632: Pop(0)
0x633: @@ add(Stack[-3]); Obj=1 // @poff=353
0x634: Pop(0)
0x635: Push((int) 3)
0x636: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x637: Pop(1)
0x638: Return(); Pop(2)

0x639: Stack[-1] = 0
0x63a: PushEmpty(int, int)
0x63b: PushEmpty(object, string, int)
0x63c: Stack[-7] = Stack[-3]
0x63d: Stack[-2] = "money" // @poff=357
0x63e: Stack[-6] = Stack[-1]
0x63f: Call2 0x560

0x640: Pop(3)
0x641: Push((int) 0)
0x642: Pop(1); Push((bool) Stack[-4] > Stack[-1])
0x643: IF (Stack[-1] == 0) GOTO 0x64c; Pop(1)

0x644: Push("Money") // @poff=369
0x645: @ GetInvItemByName(Stack[-2], Stack[-1])
0x646: Pop(1)
0x647: PushEmpty(int, int)
0x648: Stack[-3] = Stack[-2]
0x649: Stack[-5] = Stack[-1]
0x64a: Call2 0x62e
...
0x64e: @ FindActor(Stack[-1], Stack[-4])
0x64f: Pop(0)
0x650: Pop(0); PushNull((bool) Stack[-1] == 0)
0x651: IF (Stack[-1] == 0) GOTO 0x654; Pop(1)

0x652: Stack[-5] = (bool) 0
0x653: Return(); Pop(2)

0x654: @ Trigger(Stack[-1], Stack[-3])
0x655: Pop(0)
0x656: Stack[-5] = (bool) 1
0x657: Return(); Pop(2)

0x658: Stack[-1] = 0
0x659: PushEmpty(float, float)
0x65a: @ GetGameTime(Stack[-1])
0x65b: Pop(0)
0x65c: Stack[-1] = Stack[-3]
0x65d: Return(); Pop(2)

0x65e: PushEmpty(string, string)
0x65f: Stack[-1] = "idle" // @poff=18
0x660: Push(Stack[-3])
0x661: IF (Stack[-1] == 0) GOTO 0x663; Pop(1)

0x662: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x663: Stack[-1] = Stack[-4]
0x664: Return(); Pop(2)

0x665: PushEmpty(int, bool, int, bool)
0x666: Stack[-2] = (int) 0
0x667: Push("all") // @poff=28
0x668: PushEmpty(string, int)
0x669: Stack[-5] = Stack[-1]
0x66a: Call2 0x65e
...
0x67a: Push("pt_") // @poff=381
0x67b: Push(GlobalVars[0])
0x67c: Stack[-4] = Stack[-2] + Stack[-1]; Pop(2);
0x67d: GOTO 0x682

0x67e: Push("pt_") // @poff=381
0x67f: Push(GlobalVars[0])
0x680: Pop(2); Push(Stack[-2] + Stack[-1]);
0x681: Stack[-3] = Stack[-1] + Stack[-2]; Pop(1);
0x682: Return(); Pop(0)

0x683: PushEmpty(bool, bool)
0x684: Push("cleanup") // @poff=389
0x685: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x686: IF (Stack[-1] == 0) GOTO 0x694; Pop(1)

0x687: Push(GlobalVars[1])
0x688: Stack[-1] = (bool) 1
0x689: GlobalVars[1] = Stack[-1]; Pop(1)
0x68a: @ IsLoaded(Stack[-1])
0x68b: Pop(0)
0x68c: Pop(0); Push((bool) Stack[-1] == 0)
0x68d: IF (Stack[-1] == 0) GOTO 0x693; Pop(1)

0x68e: PushEmpty(object)
0x68f: Call2 0x607

0x690: Pop(0)
0x691: @ RemoveActor(Stack[-1])
0x692: Pop(1)
0x693: GOTO 0x69a

0x694: Push("restore") // @poff=405
0x695: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x696: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x697: Push(GlobalVars[1])
0x698: Stack[-1] = (bool) 0
0x699: GlobalVars[1] = Stack[-1]; Pop(1)
0x69a: Return(); Pop(2)

0x69b: Push(GlobalVars[1])
...
0x69f: Pop(0)
0x6a0: @ RemoveActor(Stack[-1])
0x6a1: Pop(1)
0x6a2: Return(); Pop(0)

0x6a3: PushEmpty()
0x6a4: Push("money10000 is given") // @poff=421
0x6a5: @ Trace(Stack[-1])
0x6a6: Pop(1)
0x6a7: PushEmpty(object, int)
0x6a8: Stack[-4] = Stack[-2]
0x6a9: Stack[-1] = (int) 10000
0x6aa: Call2 0x63a
...
0x6ad: PushEmpty()
0x6ae: Push("playsound") // @poff=461
0x6af: Push("givemoney") // @poff=481
0x6b0: @ TriggerWorld(Stack[-2], Stack[-1])
0x6b1: Pop(2)
0x6b2: Return(); Pop(0)

0x6b3: PushEmpty()
0x6b4: Push("d5q02") // @poff=501
0x6b5: Push((int) -1)
...
0x6bd: Push("d5q02") // @poff=501
0x6be: Push((int) 2)
0x6bf: @ SetVariable(Stack[-2], Stack[-1])
0x6c0: Pop(2)
...
0x6c4: Pop(1)
0x6c5: Push("d5q02GorbunFindTheDaughter") // @poff=513
0x6c6: Push("pt_map_gorbun") // @poff=567
0x6c7: Push((int) 0)
0x6c8: Push((int) 515362)
0x6c9: PushEmpty(float)
0x6ca: Call2 0x659

0x6cb: Pop(0)
0x6cc: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=595
0x6cd: Pop(5)
0x6ce: PushEmpty()
0x6cf: Call2 0x777
...
0x6d2: Stack[-1] = 0
0x6d3: PushEmpty()
0x6d4: Push("ood5Gorbun1") // @poff=603
0x6d5: Push((int) 1)
0x6d6: @ SetVariable(Stack[-2], Stack[-1])
0x6d7: Pop(2)
0x6d8: Return(); Pop(0)

0x6d9: PushEmpty(object, object, object, object)
0x6da: PushEmpty(object)
0x6db: Call2 0x7ba

0x6dc: Stack[-1] = Stack[-3]
0x6dd: Pop(1)
0x6de: Push("d5q02AnnaGotoGorbun") // @poff=627
0x6df: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=667
0x6e0: Pop(1)
0x6e1: Push(Stack[-1])
0x6e2: IF (Stack[-1] == 0) GOTO 0x6e5; Pop(1)

0x6e3: @@ Remove(); Obj=1 // @poff=676
0x6e4: Pop(0)
0x6e5: Push("d5q02AnnaGotoGorbunSelf") // @poff=683
0x6e6: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=667
0x6e7: Pop(1)
0x6e8: Push(Stack[-1])
0x6e9: IF (Stack[-1] == 0) GOTO 0x6ec; Pop(1)

0x6ea: @@ Remove(); Obj=1 // @poff=676
0x6eb: Pop(0)
0x6ec: Push("d5q02AnnaGotoKabak") // @poff=731
0x6ed: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=667
0x6ee: Pop(1)
0x6ef: Push(Stack[-1])
0x6f0: IF (Stack[-1] == 0) GOTO 0x6f3; Pop(1)

0x6f1: @@ Remove(); Obj=1 // @poff=676
0x6f2: Pop(0)
0x6f3: Push("d5q02GorbunFindTheDaughter") // @poff=513
0x6f4: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=667
0x6f5: Pop(1)
0x6f6: Push(Stack[-1])
0x6f7: IF (Stack[-1] == 0) GOTO 0x6fa; Pop(1)

0x6f8: @@ Remove(); Obj=1 // @poff=676
0x6f9: Pop(0)
0x6fa: Push("d5q02NudeMeeting") // @poff=769
0x6fb: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=667
0x6fc: Pop(1)
0x6fd: Push(Stack[-1])
0x6fe: IF (Stack[-1] == 0) GOTO 0x701; Pop(1)

0x6ff: @@ Remove(); Obj=1 // @poff=676
0x700: Pop(0)
0x701: PushEmpty()
0x702: Call2 0x784
...
0x705: Stack[-2] = "quest_d5_02" // @poff=803
0x706: Stack[-1] = "completed" // @poff=827
0x707: Call2 0x64d
...
0x70b: Stack[-2] = 0
0x70c: PushEmpty()
0x70d: Push("ood5Gorbun2") // @poff=847
0x70e: Push((int) 1)
0x70f: @ SetVariable(Stack[-2], Stack[-1])
0x710: Pop(2)
0x711: Return(); Pop(0)

0x712: PushEmpty()
0x713: Push("ood5Gorbun3") // @poff=871
0x714: Push((int) 1)
0x715: @ SetVariable(Stack[-2], Stack[-1])
0x716: Pop(2)
0x717: Return(); Pop(0)

0x718: PushEmpty()
0x719: Push("money 50000 is given") // @poff=895
0x71a: @ Trace(Stack[-1])
0x71b: Pop(1)
0x71c: PushEmpty(object, int)
0x71d: Stack[-4] = Stack[-2]
0x71e: Stack[-1] = (int) 50000
0x71f: Call2 0x63a
...
0x722: PushEmpty()
0x723: PushEmpty(int, string)
0x724: Stack[-1] = "d5q02" // @poff=501
0x725: Call2 0x629
...
0x72a: Stack[-2] = (bool) 1
0x72b: Return(); Pop(0)

0x72c: Stack[-2] = (bool) 0
0x72d: Return(); Pop(0)

0x72e: PushEmpty()
0x72f: PushEmpty(int, string)
0x730: Stack[-1] = "ood5Gorbun1" // @poff=603
0x731: Call2 0x629

0x732: Pop(1)
0x733: Push((int) 0)
0x734: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x735: IF (Stack[-1] == 0) GOTO 0x738; Pop(1)

0x736: Stack[-2] = (bool) 1
0x737: Return(); Pop(0)

0x738: Stack[-2] = (bool) 0
0x739: Return(); Pop(0)

0x73a: PushEmpty()
0x73b: PushEmpty(int, string)
0x73c: Stack[-1] = "d5q02" // @poff=501
0x73d: Call2 0x629

0x73e: Pop(1)
0x73f: Push((int) 4)
0x740: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x741: IF (Stack[-1] == 0) GOTO 0x744; Pop(1)

0x742: Stack[-2] = (bool) 1
0x743: Return(); Pop(0)

0x744: Stack[-2] = (bool) 0
0x745: Return(); Pop(0)

0x746: PushEmpty()
0x747: PushEmpty(int, string)
0x748: Stack[-1] = "d5q02KnowNudeIsDead" // @poff=937
0x749: Call2 0x629

0x74a: Pop(1)
0x74b: Push((int) 1)
0x74c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x74d: IF (Stack[-1] == 0) GOTO 0x750; Pop(1)

0x74e: Stack[-2] = (bool) 1
0x74f: Return(); Pop(0)

0x750: Stack[-2] = (bool) 0
0x751: Return(); Pop(0)

0x752: PushEmpty()
0x753: PushEmpty(int, string)
0x754: Stack[-1] = "ood5Gorbun2" // @poff=847
0x755: Call2 0x629
...
0x75a: Stack[-2] = (bool) 1
0x75b: Return(); Pop(0)

0x75c: Stack[-2] = (bool) 0
0x75d: Return(); Pop(0)

0x75e: PushEmpty()
0x75f: PushEmpty(int, string)
0x760: Stack[-1] = "ood5Gorbun3" // @poff=871
0x761: Call2 0x629

0x762: Pop(1)
0x763: Push((int) 0)
0x764: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x765: IF (Stack[-1] == 0) GOTO 0x768; Pop(1)

0x766: Stack[-2] = (bool) 1
0x767: Return(); Pop(0)

0x768: Stack[-2] = (bool) 0
0x769: Return(); Pop(0)

0x76a: PushEmpty(object, object)
0x76b: Push((int) 715)
0x76c: Push((int) 2)
0x76d: Push((int) 536323)
0x76e: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x76f: Pop(3)
0x770: PushEmpty(bool, object, int)
0x771: Stack[-4] = Stack[-2]
0x772: Stack[-1] = (int) 148
0x773: Call2 0x79e
...
0x778: Push((int) 150)
0x779: Push((int) 2)
0x77a: Push((int) 515356)
0x77b: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x77c: Pop(3)
0x77d: PushEmpty(bool, object, int)
0x77e: Stack[-4] = Stack[-2]
0x77f: Stack[-1] = (int) 148
0x780: Call2 0x79e
...
0x785: Push((int) 153)
0x786: Push((int) 2)
0x787: Push((int) 515359)
0x788: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x789: Pop(3)
0x78a: PushEmpty(bool, object, int)
0x78b: Stack[-4] = Stack[-2]
0x78c: Stack[-1] = (int) 148
0x78d: Call2 0x79e
...
0x792: @ GetDiaryRoot(Stack[-1])
0x793: Pop(0)
0x794: Pop(0); Push((bool) Stack[-1] == 0)
0x795: IF (Stack[-1] == 0) GOTO 0x79b; Pop(1)

0x796: Push("Can't retrieve diary root") // @poff=977
0x797: @ Trace(Stack[-1])
0x798: Pop(1)
0x799: Stack[-3] = (bool) 0
0x79a: Return(); Pop(2)

0x79b: Stack[-1] = Stack[-3]
0x79c: Return(); Pop(2)

0x79d: Stack[-1] = 0
0x79e: PushEmpty(object, object, int, object, object, int)
0x79f: PushEmpty(object)
0x7a0: Call2 0x791

0x7a1: Stack[-1] = Stack[-4]
0x7a2: Pop(1)
0x7a3: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1029
0x7a4: Pop(0)
0x7a5: Pop(0); Push((bool) Stack[-2] == 0)
0x7a6: IF (Stack[-1] == 0) GOTO 0x7ad; Pop(1)

0x7a7: Push("Can't find diary parent with id: ") // @poff=1034
0x7a8: Pop(1); Push(Stack[-1] + Stack[-8]);
0x7a9: @ Trace(Stack[-1])
0x7aa: Pop(1)
0x7ab: Stack[-9] = (bool) 0
0x7ac: Return(); Pop(6)

0x7ad: @@ AddChild(Stack[-8]); Obj=2 // @poff=1102
0x7ae: Pop(0)
0x7af: Push((int) 7)
0x7b0: @ SendWorldWndMessage(Stack[-1])
0x7b1: Pop(1)
0x7b2: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1111
0x7b3: Pop(0)
0x7b4: @ SetDiarySection(Stack[-1])
0x7b5: Pop(0)
0x7b6: Stack[-9] = (bool) 0
0x7b7: Return(); Pop(6)

0x7b8: Stack[-2] = 0
0x7b9: Stack[-3] = 0
0x7ba: PushEmpty(object, object, object, object)
0x7bb: @ GetMainOutdoorScene(Stack[-2])
0x7bc: Pop(0)
0x7bd: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7be: IF (Stack[-1] == 0) GOTO 0x7c5; Pop(1)

0x7bf: Push("Can't find main outdoor scene") // @poff=1123
0x7c0: @ Trace(Stack[-1])
0x7c1: Pop(1)
0x7c2: Stack[-1] = 0
...
0x7c5: @@ GetMap(Stack[-1]); Obj=2 // @poff=1183
0x7c6: Pop(0)
...
0x7cc: Push("branch") // @poff=1190
0x7cd: @ GetVariable(Stack[-1], Stack[-2])
0x7ce: Pop(1)
0x7cf: Push((int) 0)
0x7d0: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x7d1: IF (Stack[-1] == 0) GOTO 0x7d5; Pop(1)
...
0x7d7: IF (Stack[-1] == 0) GOTO 0x7da; Pop(1)
...
0x7dc: Stack[-1] = (int) 515594
0x7dd: Return(); Pop(0)

0x7de: Stack[-1] = (int) 512583
0x7df: Return(); Pop(0)

0x7e0: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1204
0x7e1: Return(); Pop(0)

0x7e2: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1244
0x7e3: Return(); Pop(0)
...
0x7e8: Stack[-3] = Stack[-1]
0x7e9: Push(-2, 1); TaskCall(4)
0x7ea: Call2 0x11a

0x7eb: Pop(-2, 1); TaskReturn
0x7ec: Pop(2)
0x7ed: Return(); Pop(0)
