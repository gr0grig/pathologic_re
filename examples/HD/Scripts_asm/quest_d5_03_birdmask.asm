...
// @pool_raw:
// @pool_encoding:utf8
...
0x312: Push("Can't find lsh animation : ") // @poff=328
...
0x321: Push("Can't find lsh animation : ") // @poff=328
...
0x336: Push((float)9.999999974752427e-07)
...
0x34f: Pop(0)
0x350: @@ add(Stack[-4]); Obj=1 // @poff=384
0x351: Pop(0)
0x352: @@ add(Stack[-3]); Obj=1 // @poff=384
0x353: Pop(0)
0x354: Push((int) 3)
...
0x35b: Stack[-7] = Stack[-3]
0x35c: Stack[-2] = "money" // @poff=388
0x35d: Stack[-6] = Stack[-1]
0x35e: Call2 0x2a9
...
0x382: Stack[-2] = Stack[-1]
0x383: Call2 0x38f

0x384: Pop(1)
0x385: PushEmpty(bool, object, string, float, float, float)
0x386: Stack[-8] = Stack[-5]
0x387: Stack[-4] = "reputation" // @poff=412
0x388: Stack[-7] = Stack[-3]
0x389: Stack[-2] = (int) 0
0x38a: Stack[-1] = (int) 1
0x38b: Call2 0x293
...
0x391: Pop(0)
0x392: @@ add(Stack[-3]); Obj=1 // @poff=384
0x393: Pop(0)
0x394: Push((int) 16)
...
0x39b: Pop(0)
0x39c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3af: Stack[-2] = "quest_d5_03" // @poff=156
0x3b0: Stack[-1] = "fail" // @poff=434
0x3b1: Call2 0x399
...
0x3b4: PushEmpty()
0x3b5: Push("money 60000 removed") // @poff=444
0x3b6: @ Trace(Stack[-1])
0x3b7: Pop(1)
...
0x3be: PushEmpty()
0x3bf: Push("playsound") // @poff=484
0x3c0: Push("givemoney") // @poff=504
0x3c1: @ TriggerWorld(Stack[-2], Stack[-1])
0x3c2: Pop(2)
0x3c3: Return(); Pop(0)

0x3c4: PushEmpty()
0x3c5: Push("ood5Birdmask1") // @poff=524
0x3c6: Push((int) 1)
...
0x3ce: Pop(1)
0x3cf: Push("d5q03BirdmaskBringMoneySelf") // @poff=552
0x3d0: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3d1: Pop(1)
0x3d2: Push(Stack[-1])
0x3d3: IF (Stack[-1] == 0) GOTO 0x3d6; Pop(1)

0x3d4: @@ Remove(); Obj=1 // @poff=617
0x3d5: Pop(0)
0x3d6: Push("d5q03BirdmaskGotoMladVlad") // @poff=624
0x3d7: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3d8: Pop(1)
0x3d9: Push(Stack[-1])
0x3da: IF (Stack[-1] == 0) GOTO 0x3dd; Pop(1)

0x3db: @@ Remove(); Obj=1 // @poff=617
0x3dc: Pop(0)
0x3dd: Push("d5q03BirdmaskGotoViktor") // @poff=676
0x3de: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3df: Pop(1)
0x3e0: Push(Stack[-1])
0x3e1: IF (Stack[-1] == 0) GOTO 0x3e4; Pop(1)

0x3e2: @@ Remove(); Obj=1 // @poff=617
0x3e3: Pop(0)
0x3e4: Push("d5q03MladVladSavePrisonersSelf") // @poff=724
0x3e5: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3e6: Pop(1)
0x3e7: Push(Stack[-1])
0x3e8: IF (Stack[-1] == 0) GOTO 0x3eb; Pop(1)

0x3e9: @@ Remove(); Obj=1 // @poff=617
0x3ea: Pop(0)
0x3eb: Push("d5q03SavePrisoners") // @poff=786
0x3ec: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3ed: Pop(1)
0x3ee: Push(Stack[-1])
0x3ef: IF (Stack[-1] == 0) GOTO 0x3f2; Pop(1)

0x3f0: @@ Remove(); Obj=1 // @poff=617
0x3f1: Pop(0)
0x3f2: Push("d5q03ViktorSavePrisonersSelf") // @poff=824
0x3f3: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=608
0x3f4: Pop(1)
0x3f5: Push(Stack[-1])
0x3f6: IF (Stack[-1] == 0) GOTO 0x3f9; Pop(1)

0x3f7: @@ Remove(); Obj=1 // @poff=617
0x3f8: Pop(0)
0x3f9: PushEmpty()
0x3fa: Call2 0x49d
...
0x3fb: Pop(0)
0x3fc: Push((int) 1)
0x3fd: @@ SetReturnValue(Stack[-1]); Obj=6 // @poff=882
0x3fe: Pop(1)
0x3ff: Return(); Pop(4)
...
0x409: Stack[-1] = Stack[-2]
0x40a: Pop(1)
0x40b: Push("d5q03BirdmaskBringMoneySelf") // @poff=552
0x40c: Push("pt_map_uprava_prison") // @poff=909
0x40d: Push((int) 0)
...
0x411: Pop(0)
0x412: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=951
0x413: Pop(5)
0x414: Push("d5q03BirdmaskGotoMladVlad") // @poff=624
0x415: Push("pt_map_mladvlad") // @poff=959
0x416: Push((int) 0)
...
0x41a: Pop(0)
0x41b: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=951
0x41c: Pop(5)
0x41d: Push("d5q03BirdmaskGotoViktor") // @poff=676
0x41e: Push("pt_map_viktor") // @poff=991
0x41f: Push((int) 0)
...
0x423: Pop(0)
0x424: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=951
0x425: Pop(5)
0x426: PushEmpty()
0x427: Call2 0x490
...
0x42d: Stack[-5] = Stack[-2]
0x42e: Stack[-1] = (float) -0.30000001192092896
0x42f: Call2 0x36c
...
0x43e: Stack[-1] = "ood5Birdmask1" // @poff=524
0x43f: Call2 0x348
...
0x479: Push("money") // @poff=388
0x47a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=268
0x47b: Pop(1)
...
0x4af: Push("Can't retrieve diary root") // @poff=1019
0x4b0: @ Trace(Stack[-1])
0x4b1: Pop(1)
0x4b2: Stack[-3] = (bool) 0
0x4b3: Return(); Pop(2)

0x4b4: Stack[-1] = Stack[-3]
0x4b5: Return(); Pop(2)
...
0x4ba: Stack[-1] = Stack[-4]
0x4bb: Pop(1)
0x4bc: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1071
0x4bd: Pop(0)
0x4be: Pop(0); Push((bool) Stack[-2] == 0)
0x4bf: IF (Stack[-1] == 0) GOTO 0x4c6; Pop(1)

0x4c0: Push("Can't find diary parent with id: ") // @poff=1076
...
0x4c6: @@ AddChild(Stack[-8]); Obj=2 // @poff=1144
0x4c7: Pop(0)
0x4c8: Push((int) 7)
0x4c9: @ SendWorldWndMessage(Stack[-1])
0x4ca: Pop(1)
0x4cb: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1153
0x4cc: Pop(0)
...
0x4d5: Pop(0)
0x4d6: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4d7: IF (Stack[-1] == 0) GOTO 0x4de; Pop(1)

0x4d8: Push("Can't find main outdoor scene") // @poff=1165
0x4d9: @ Trace(Stack[-1])
0x4da: Pop(1)
0x4db: Stack[-1] = 0
0x4dc: Stack[-1] = Stack[-5]
0x4dd: Return(); Pop(4)

0x4de: @@ GetMap(Stack[-1]); Obj=2 // @poff=1225
0x4df: Pop(0)
...
0x4f9: Stack[-1] = "ui/NPC_bmask.png" // @poff=1246
0x4fa: Return(); Pop(0)

0x4fb: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=1280
0x4fc: Return(); Pop(0)
