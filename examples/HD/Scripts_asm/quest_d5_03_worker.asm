...
// @pool_raw:
// @pool_encoding:utf8
...
0x241: Push("Can't find lsh animation : ") // @poff=208
...
0x250: Push("Can't find lsh animation : ") // @poff=208
...
0x289: PushEmpty()
0x28a: Push("ood5Prisoner1") // @poff=264
0x28b: Push((int) 1)
...
0x291: Stack[-1] = "ood5Prisoner1" // @poff=264
0x292: Call2 0x26c
...
0x2ac: Stack[-1] = (int) 515568
0x2ad: Return(); Pop(0)

0x2ae: Stack[-1] = (int) 503353
0x2af: Return(); Pop(0)

0x2b0: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=306
0x2b1: Return(); Pop(0)

0x2b2: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=346
0x2b3: Return(); Pop(0)
