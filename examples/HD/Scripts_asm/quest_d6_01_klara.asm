...
// @pool_raw:
// @pool_encoding:utf8
...
0x76: Stack[-1] = "Fear" // @poff=89
0x77: Call2 0x120

0x78: Pop(1)
0x79: Push((int) 512737)
0x7a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x7b: Pop(1)
0x7c: @@@ ClearReplies(); Obj=0 // @poff=110
0x7d: Pop(0)
0x7e: Push((int) 512738)
0x7f: Push((int) 13933)
0x80: Push((int) 13932)
0x81: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x82: Pop(3)
0x83: Push((int) 512744)
0x84: Push((int) 13965)
0x85: Push((int) 13938)
0x86: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x87: Pop(3)
0x88: Push((int) 512745)
0x89: Push((int) 13954)
0x8a: Push((int) 13939)
0x8b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x8c: Pop(3)
0x8d: GOTO 0x102
...
0x9f: Stack[-1] = "Fear" // @poff=89
0xa0: Call2 0x120

0xa1: Pop(1)
0xa2: Push((int) 533081)
0xa3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xa4: Pop(1)
0xa5: @@@ ClearReplies(); Obj=0 // @poff=110
0xa6: Pop(0)
0xa7: Push((int) 533082)
0xa8: Push((int) -1)
0xa9: Push((int) 34594)
0xaa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xab: Pop(3)
0xac: Push((int) 536138)
0xad: Push((int) -1)
0xae: Push((int) 37897)
0xaf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xb0: Pop(3)
0xb1: GOTO 0x102
...
0xc1: Stack[-1] = "Neutral" // @poff=132
0xc2: Call2 0x120

0xc3: Pop(1)
0xc4: Push((int) 512748)
0xc5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xc6: Pop(1)
0xc7: @@@ ClearReplies(); Obj=0 // @poff=110
0xc8: Pop(0)
...
0xcf: Push((int) 3753)
0xd0: Push((int) 13943)
0xd1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xd2: Pop(3)
0xd3: PushEmpty(bool)
0xd4: Stack[-1] = (bool) 0
0xd5: PushEmpty(bool)
...
0xf6: Push((int) 11864)
0xf7: Push((int) 13944)
0xf8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xf9: Pop(3)
0xfa: Push((int) 512769)
0xfb: Push((int) -1)
0xfc: Push((int) 13968)
0xfd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xfe: Pop(3)
0xff: GOTO 0x102
...
0x111: Push("all") // @poff=148
0x112: Push("idle") // @poff=156
...
0x11a: Push("all") // @poff=148
0x11b: Push("idle") // @poff=156
...
0x1c8: Stack[-1] = "Fear" // @poff=89
0x1c9: Call2 0x120

0x1ca: Pop(1)
0x1cb: Push((int) 512737)
0x1cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1cd: Pop(1)
0x1ce: @@@ ClearReplies(); Obj=0 // @poff=110
0x1cf: Pop(0)
0x1d0: Push((int) 512738)
0x1d1: Push((int) 13933)
0x1d2: Push((int) 13932)
0x1d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1d4: Pop(3)
0x1d5: Push((int) 512744)
0x1d6: Push((int) 13965)
0x1d7: Push((int) 13938)
0x1d8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1d9: Pop(3)
0x1da: Push((int) 512745)
0x1db: Push((int) 13954)
0x1dc: Push((int) 13939)
0x1dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1de: Pop(3)
0x1df: Return(); Pop(0)
...
0x1f1: Stack[-1] = "Fear" // @poff=89
0x1f2: Call2 0x120

0x1f3: Pop(1)
0x1f4: Push((int) 533081)
0x1f5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1f6: Pop(1)
0x1f7: @@@ ClearReplies(); Obj=0 // @poff=110
0x1f8: Pop(0)
0x1f9: Push((int) 533082)
0x1fa: Push((int) -1)
0x1fb: Push((int) 34594)
0x1fc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1fd: Pop(3)
0x1fe: Push((int) 536138)
0x1ff: Push((int) -1)
0x200: Push((int) 37897)
0x201: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x202: Pop(3)
0x203: Return(); Pop(0)
...
0x209: Pop(1)
0x20a: IF (Stack[-1] == 1) GOTO 0x211; Pop(1)
...
0x20e: Pop(1)
0x20f: IF (Stack[-1] == 1) GOTO 0x211; Pop(1)

0x210: Stack[-1] = (bool) 0
0x211: IF (Stack[-1] == 0) GOTO 0x252; Pop(1)

0x212: PushEmpty(string)
0x213: Stack[-1] = "Neutral" // @poff=132
0x214: Call2 0x120

0x215: Pop(1)
0x216: Push((int) 512748)
0x217: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x218: Pop(1)
0x219: @@@ ClearReplies(); Obj=0 // @poff=110
0x21a: Pop(0)
...
0x223: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x224: Pop(3)
...
0x24a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x24b: Pop(3)
0x24c: Push((int) 512769)
0x24d: Push((int) -1)
0x24e: Push((int) 13968)
0x24f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x250: Pop(3)
0x251: Return(); Pop(0)
...
0x256: Stack[-1] = "Saveyouall" // @poff=166
0x257: Call2 0x120

0x258: Pop(1)
0x259: Push((int) 510739)
0x25a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x25b: Pop(1)
0x25c: @@@ ClearReplies(); Obj=0 // @poff=110
0x25d: Pop(0)
0x25e: Push((int) 510740)
0x25f: Push((int) 11866)
0x260: Push((int) 11865)
0x261: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x262: Pop(3)
0x263: Push((int) 510752)
0x264: Push((int) 11866)
0x265: Push((int) 11879)
0x266: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x267: Pop(3)
0x268: Return(); Pop(0)
...
0x26d: Stack[-1] = "Saveyouall" // @poff=166
0x26e: Call2 0x120

0x26f: Pop(1)
0x270: Push((int) 510741)
0x271: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x272: Pop(1)
0x273: @@@ ClearReplies(); Obj=0 // @poff=110
0x274: Pop(0)
0x275: Push((int) 510742)
0x276: Push((int) 11868)
0x277: Push((int) 11867)
0x278: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x279: Pop(3)
0x27a: Push((int) 510751)
0x27b: Push((int) 11870)
0x27c: Push((int) 11877)
0x27d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x27e: Pop(3)
0x27f: Return(); Pop(0)
...
0x284: Stack[-1] = "Fear" // @poff=89
0x285: Call2 0x120

0x286: Pop(1)
0x287: Push((int) 510743)
0x288: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x289: Pop(1)
0x28a: @@@ ClearReplies(); Obj=0 // @poff=110
0x28b: Pop(0)
0x28c: Push((int) 510744)
0x28d: Push((int) 11870)
0x28e: Push((int) 11869)
0x28f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x290: Pop(3)
0x291: Push((int) 510749)
0x292: Push((int) 11870)
0x293: Push((int) 11874)
0x294: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x295: Pop(3)
0x296: Push((int) 510750)
0x297: Push((int) -1)
0x298: Push((int) 11876)
0x299: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x29a: Pop(3)
0x29b: Return(); Pop(0)
...
0x2a0: Stack[-1] = "Saveyouall" // @poff=166
0x2a1: Call2 0x120

0x2a2: Pop(1)
0x2a3: Push((int) 510745)
0x2a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2a5: Pop(1)
0x2a6: @@@ ClearReplies(); Obj=0 // @poff=110
0x2a7: Pop(0)
0x2a8: Push((int) 510747)
0x2a9: Push((int) -1)
0x2aa: Push((int) 11872)
0x2ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2ac: Pop(3)
0x2ad: Push((int) 510748)
0x2ae: Push((int) -1)
0x2af: Push((int) 11873)
0x2b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2b1: Pop(3)
...
0x2bc: Stack[-1] = "Neutral" // @poff=132
0x2bd: Call2 0x120
...
0x2cf: Push((int) 3763)
0x2d0: Push((int) 3783)
0x2d1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2d2: Pop(3)
0x2d3: Return(); Pop(0)
...
0x2d8: Stack[-1] = "Saveyouall" // @poff=166
0x2d9: Call2 0x120

0x2da: Pop(1)
0x2db: Push((int) 503505)
0x2dc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2dd: Pop(1)
0x2de: @@@ ClearReplies(); Obj=0 // @poff=110
0x2df: Pop(0)
...
0x2e6: Push((int) 3763)
0x2e7: Push((int) 3781)
0x2e8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2e9: Pop(3)
0x2ea: Return(); Pop(0)
...
0x2ef: Stack[-1] = "Saveyouall" // @poff=166
0x2f0: Call2 0x120

0x2f1: Pop(1)
0x2f2: Push((int) 503486)
0x2f3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x2f4: Pop(1)
0x2f5: @@@ ClearReplies(); Obj=0 // @poff=110
0x2f6: Pop(0)
0x2f7: Push((int) 503487)
0x2f8: Push((int) 3775)
0x2f9: Push((int) 3757)
0x2fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x2fb: Pop(3)
0x2fc: Push((int) 503488)
0x2fd: Push((int) 3770)
0x2fe: Push((int) 3758)
0x2ff: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x300: Pop(3)
...
0x355: Stack[-1] = "Neutral" // @poff=132
0x356: Call2 0x120
...
0x36c: Stack[-1] = "Neutral" // @poff=132
0x36d: Call2 0x120
...
0x37f: Push((int) -1)
0x380: Push((int) 3774)
0x381: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x382: Pop(3)
0x383: Return(); Pop(0)
...
0x388: Stack[-1] = "Saveyouall" // @poff=166
0x389: Call2 0x120

0x38a: Pop(1)
0x38b: Push((int) 503517)
0x38c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x38d: Pop(1)
0x38e: @@@ ClearReplies(); Obj=0 // @poff=110
0x38f: Pop(0)
0x390: Push((int) 503518)
0x391: Push((int) 3770)
0x392: Push((int) 3798)
0x393: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x394: Pop(3)
0x395: Push((int) 503520)
0x396: Push((int) 3801)
0x397: Push((int) 3800)
0x398: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x399: Pop(3)
0x39a: Return(); Pop(0)
...
0x39f: Stack[-1] = "Saveyouall" // @poff=166
0x3a0: Call2 0x120

0x3a1: Pop(1)
0x3a2: Push((int) 503521)
0x3a3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3a4: Pop(1)
0x3a5: @@@ ClearReplies(); Obj=0 // @poff=110
0x3a6: Pop(0)
0x3a7: Push((int) 503522)
0x3a8: Push((int) 3804)
0x3a9: Push((int) 3802)
0x3aa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3ab: Pop(3)
0x3ac: Push((int) 503523)
0x3ad: Push((int) -1)
0x3ae: Push((int) 3803)
0x3af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3b0: Pop(3)
0x3b1: Return(); Pop(0)
...
0x3b6: Stack[-1] = "Fear" // @poff=89
0x3b7: Call2 0x120

0x3b8: Pop(1)
0x3b9: Push((int) 503524)
0x3ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3bb: Pop(1)
0x3bc: @@@ ClearReplies(); Obj=0 // @poff=110
0x3bd: Pop(0)
0x3be: Push((int) 503525)
0x3bf: Push((int) 3770)
0x3c0: Push((int) 3805)
0x3c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3c2: Pop(3)
0x3c3: Return(); Pop(0)
...
0x3c8: Stack[-1] = "Neutral" // @poff=132
0x3c9: Call2 0x120

0x3ca: Pop(1)
0x3cb: Push((int) 503499)
0x3cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3cd: Pop(1)
0x3ce: @@@ ClearReplies(); Obj=0 // @poff=110
0x3cf: Pop(0)
0x3d0: Push((int) 503500)
0x3d1: Push((int) 3770)
0x3d2: Push((int) 3772)
0x3d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3d4: Pop(3)
0x3d5: Push((int) 503516)
0x3d6: Push((int) -1)
0x3d7: Push((int) 3796)
0x3d8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3d9: Pop(3)
0x3da: Return(); Pop(0)
...
0x3df: Stack[-1] = "Neutral" // @poff=132
0x3e0: Call2 0x120

0x3e1: Pop(1)
0x3e2: Push((int) 503498)
0x3e3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3e4: Pop(1)
0x3e5: @@@ ClearReplies(); Obj=0 // @poff=110
0x3e6: Pop(0)
0x3e7: Push((int) 503526)
0x3e8: Push((int) -1)
0x3e9: Push((int) 3807)
0x3ea: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3eb: Pop(3)
0x3ec: Push((int) 503527)
0x3ed: Push((int) 3809)
0x3ee: Push((int) 3808)
0x3ef: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x3f0: Pop(3)
0x3f1: Return(); Pop(0)
...
0x3f6: Stack[-1] = "Fear" // @poff=89
0x3f7: Call2 0x120

0x3f8: Pop(1)
0x3f9: Push((int) 503528)
0x3fa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x3fb: Pop(1)
0x3fc: @@@ ClearReplies(); Obj=0 // @poff=110
0x3fd: Pop(0)
0x3fe: Push((int) 503529)
0x3ff: Push((int) 3811)
0x400: Push((int) 3810)
0x401: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x402: Pop(3)
0x403: Return(); Pop(0)
...
0x408: Stack[-1] = "Fear" // @poff=89
0x409: Call2 0x120

0x40a: Pop(1)
0x40b: Push((int) 503530)
0x40c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x40d: Pop(1)
0x40e: @@@ ClearReplies(); Obj=0 // @poff=110
0x40f: Pop(0)
0x410: Push((int) 503531)
0x411: Push((int) -1)
0x412: Push((int) 3812)
0x413: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x414: Pop(3)
0x415: Push((int) 503532)
0x416: Push((int) -1)
0x417: Push((int) 3813)
0x418: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x419: Pop(3)
0x41a: Return(); Pop(0)
...
0x41f: Stack[-1] = "Saveyouall" // @poff=166
0x420: Call2 0x120

0x421: Pop(1)
0x422: Push((int) 503503)
0x423: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x424: Pop(1)
0x425: @@@ ClearReplies(); Obj=0 // @poff=110
0x426: Pop(0)
0x427: Push((int) 503504)
0x428: Push((int) 3770)
0x429: Push((int) 3776)
0x42a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x42b: Pop(3)
0x42c: Return(); Pop(0)
...
0x431: Stack[-1] = "Fear" // @poff=89
0x432: Call2 0x120

0x433: Pop(1)
0x434: Push((int) 512767)
0x435: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x436: Pop(1)
0x437: @@@ ClearReplies(); Obj=0 // @poff=110
0x438: Pop(0)
0x439: Push((int) 512768)
0x43a: Push((int) 13933)
0x43b: Push((int) 13966)
0x43c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x43d: Pop(3)
0x43e: Return(); Pop(0)
...
0x44e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x44f: Pop(3)
...
0x458: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x459: Pop(3)
0x45a: Return(); Pop(0)
...
0x45f: Stack[-1] = "Fear" // @poff=89
0x460: Call2 0x120

0x461: Pop(1)
0x462: Push((int) 512741)
0x463: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x464: Pop(1)
0x465: @@@ ClearReplies(); Obj=0 // @poff=110
0x466: Pop(0)
0x467: Push((int) 512742)
0x468: Push((int) 13937)
0x469: Push((int) 13936)
0x46a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x46b: Pop(3)
0x46c: Push((int) 512751)
0x46d: Push((int) 13947)
0x46e: Push((int) 13945)
0x46f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x470: Pop(3)
0x471: Push((int) 512752)
0x472: Push((int) 13937)
0x473: Push((int) 13946)
0x474: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x475: Pop(3)
0x476: Return(); Pop(0)
...
0x47b: Stack[-1] = "Saveyouall" // @poff=166
0x47c: Call2 0x120

0x47d: Pop(1)
0x47e: Push((int) 512753)
0x47f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x480: Pop(1)
0x481: @@@ ClearReplies(); Obj=0 // @poff=110
0x482: Pop(0)
0x483: Push((int) 512754)
0x484: Push((int) 13949)
0x485: Push((int) 13948)
0x486: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x487: Pop(3)
0x488: Push((int) 538781)
0x489: Push((int) -1)
0x48a: Push((int) 40701)
0x48b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x48c: Pop(3)
0x48d: Return(); Pop(0)
...
0x492: Stack[-1] = "Fear" // @poff=89
0x493: Call2 0x120

0x494: Pop(1)
0x495: Push((int) 512755)
0x496: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x497: Pop(1)
0x498: @@@ ClearReplies(); Obj=0 // @poff=110
0x499: Pop(0)
0x49a: Push((int) 512756)
0x49b: Push((int) -1)
0x49c: Push((int) 13950)
0x49d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x49e: Pop(3)
0x49f: Push((int) 512757)
0x4a0: Push((int) -1)
0x4a1: Push((int) 13951)
0x4a2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4a3: Pop(3)
0x4a4: Return(); Pop(0)
...
0x4a9: Stack[-1] = "Fear" // @poff=89
0x4aa: Call2 0x120

0x4ab: Pop(1)
0x4ac: Push((int) 512743)
0x4ad: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x4ae: Pop(1)
0x4af: @@@ ClearReplies(); Obj=0 // @poff=110
0x4b0: Pop(0)
0x4b1: Push((int) 512758)
0x4b2: Push((int) 13954)
0x4b3: Push((int) 13952)
0x4b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4b5: Pop(3)
0x4b6: Push((int) 512759)
0x4b7: Push((int) 13954)
0x4b8: Push((int) 13953)
0x4b9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4ba: Pop(3)
0x4bb: Return(); Pop(0)
...
0x4c0: Stack[-1] = "Fear" // @poff=89
0x4c1: Call2 0x120

0x4c2: Pop(1)
0x4c3: Push((int) 512760)
0x4c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x4c5: Pop(1)
0x4c6: @@@ ClearReplies(); Obj=0 // @poff=110
0x4c7: Pop(0)
0x4c8: Push((int) 512761)
0x4c9: Push((int) 13957)
0x4ca: Push((int) 13956)
0x4cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4cc: Pop(3)
0x4cd: Return(); Pop(0)
...
0x4d2: Stack[-1] = "Fear" // @poff=89
0x4d3: Call2 0x120

0x4d4: Pop(1)
0x4d5: Push((int) 512762)
0x4d6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x4d7: Pop(1)
0x4d8: @@@ ClearReplies(); Obj=0 // @poff=110
0x4d9: Pop(0)
0x4da: Push((int) 512763)
0x4db: Push((int) 13959)
0x4dc: Push((int) 13958)
0x4dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4de: Pop(3)
0x4df: Return(); Pop(0)
...
0x4e4: Stack[-1] = "Fear" // @poff=89
0x4e5: Call2 0x120

0x4e6: Pop(1)
0x4e7: Push((int) 512764)
0x4e8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x4e9: Pop(1)
0x4ea: @@@ ClearReplies(); Obj=0 // @poff=110
0x4eb: Pop(0)
0x4ec: Push((int) 512765)
0x4ed: Push((int) -1)
0x4ee: Push((int) 13960)
0x4ef: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4f0: Pop(3)
0x4f1: Push((int) 512766)
0x4f2: Push((int) -1)
0x4f3: Push((int) 13961)
0x4f4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x4f5: Pop(3)
0x4f6: Return(); Pop(0)
...
0x54c: Stack[-3] = Stack[-1]
0x54d: Call2 0x643

0x54e: Stack[-2] = Stack[-5]
0x54f: Pop(2)
0x550: Return(); Pop(2)

0x551: Stack[-1] = 0
0x552: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x553: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x554: @ RotateAsync(Stack[-2], Stack[-1])
0x555: Pop(2)
0x556: Return(); Pop(0)

0x557: PushEmpty(object, bool, object, bool)
0x558: Push("player") // @poff=220
...
0x5b5: Stack[-1] = "Neutral" // @poff=132
0x5b6: Call2 0x732
...
0x5c4: Stack[-1] = "Neutral" // @poff=132
0x5c5: Call2 0x732
...
0x5db: Stack[-1] = "Neutral" // @poff=132
0x5dc: Call2 0x732
...
0x60f: Stack[-3] = (int) 0
0x610: Push("all") // @poff=148
0x611: PushEmpty(string, int)
0x612: Stack[-6] = Stack[-1]
0x613: Call2 0x7bd
...
0x633: Pop(0)
0x634: @@ GetPosition(Stack[-2]); Obj=7 // @poff=234
0x635: Pop(0)
...
0x640: Pop(2)
0x641: Stack[-1] = Stack[-8]
0x642: Return(); Pop(6)

0x643: PushEmpty(cvector, cvector)
0x644: @@ GetPosition(Stack[-1]); Obj=3 // @poff=234
0x645: Pop(0)
0x646: PushEmpty(bool, cvector)
0x647: Stack[-3] = Stack[-1]
0x648: Call2 0x639
...
0x652: @@ GetPosition(Stack[-8]); Obj=20 // @poff=234
0x653: Pop(0)
0x654: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=246
0x655: Pop(0)
...
0x6c1: Push("voice_common") // @poff=270
0x6c2: Push((int) 1)
...
0x6c9: Push("voice_common") // @poff=270
0x6ca: Push((int) 0)
...
0x6dc: Push("voice_common") // @poff=270
0x6dd: Push((int) 1)
...
0x6ea: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x6eb: Pop(1)
...
0x715: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=300
0x716: Pop(1)
...
0x72a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=312
0x72b: Pop(1)
0x72c: PushEmpty(bool, string)
0x72d: Stack[-3] = Stack[-1]
0x72e: Call2 0x751

0x72f: Stack[-2] = Stack[-14]
0x730: Pop(2)
0x731: Return(); Pop(10)
...
0x73d: Push("Can't find lsh animation : ") // @poff=328
...
0x74c: Push("Can't find lsh animation : ") // @poff=328
...
0x770: Push((float)9.999999974752427e-07)
...
0x77e: Pop(0)
0x77f: @@ add(Stack[-4]); Obj=1 // @poff=384
0x780: Pop(0)
0x781: @@ add(Stack[-3]); Obj=1 // @poff=384
0x782: Pop(0)
0x783: Push((int) 3)
...
0x789: @@ GetItemID(Stack[-3]); Obj=8 // @poff=388
0x78a: Pop(0)
0x78b: Push("Category") // @poff=398
0x78c: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x78d: Pop(1)
0x78e: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=416
0x78f: Pop(0)
0x790: Pop(0); Push((bool) Stack[-1] == 0)
0x791: IF (Stack[-1] == 0) GOTO 0x795; Pop(1)

0x792: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=424
0x793: Pop(0)
0x794: GOTO 0x79a

0x795: PushEmpty(int, int)
0x796: Stack[-5] = Stack[-2]
0x797: Stack[-9] = Stack[-1]
0x798: Call2 0x77c
...
0x79d: Pop(0)
0x79e: @@ SetItemName(Stack[-4]); Obj=1 // @poff=434
0x79f: Pop(0)
0x7a0: PushEmpty(object, object, int)
0x7a1: Stack[-8] = Stack[-3]
0x7a2: Stack[-4] = Stack[-2]
0x7a3: Stack[-6] = Stack[-1]
0x7a4: Call2 0x788
...
0x7aa: Pop(0)
0x7ab: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x7da: Stack[-2] = "quest_d6_01" // @poff=446
0x7db: Stack[-1] = "completed" // @poff=470
0x7dc: Call2 0x7a8
...
0x7e2: Pop(0)
0x7e3: Push("klara blood is given") // @poff=490
0x7e4: @ Trace(Stack[-1])
0x7e5: Pop(1)
0x7e6: PushEmpty(object, string, int)
0x7e7: Stack[-5] = Stack[-3]
0x7e8: Stack[-2] = "d6q01_klara_blood" // @poff=532
0x7e9: Stack[-1] = (int) 1
0x7ea: Call2 0x79b
...
0x7ed: PushEmpty()
0x7ee: Push("playsound") // @poff=568
0x7ef: Push("giveitem") // @poff=588
0x7f0: @ TriggerWorld(Stack[-2], Stack[-1])
0x7f1: Pop(2)
0x7f2: Return(); Pop(0)

0x7f3: PushEmpty()
0x7f4: Push("ood6Klara1") // @poff=606
0x7f5: Push((int) 1)
...
0x7f9: PushEmpty()
0x7fa: Push("ood6Klara2") // @poff=628
0x7fb: Push((int) 1)
...
0x7ff: PushEmpty()
0x800: Push("d6q01KlaraVolonteer") // @poff=650
0x801: Push((int) 1)
...
0x808: Stack[-2] = "quest_d6_01" // @poff=446
0x809: Stack[-1] = "completed" // @poff=470
0x80a: Call2 0x7a8
...
0x80d: PushEmpty()
0x80e: Push("ood6Klara3") // @poff=690
0x80f: Push((int) 1)
...
0x818: Stack[-2] = "quest_d6_01" // @poff=446
0x819: Stack[-1] = "failed" // @poff=712
0x81a: Call2 0x7a8
...
0x82b: Stack[-1] = "ood6Klara1" // @poff=606
0x82c: Call2 0x777
...
0x843: Stack[-1] = "ood6Klara2" // @poff=628
0x844: Call2 0x777
...
0x84f: Stack[-1] = "microscope_d6q01_klara_blood" // @poff=738
0x850: Call2 0x777
...
0x873: Stack[-1] = "ood6Klara3" // @poff=690
0x874: Call2 0x777
...
0x8b6: Push("Can't retrieve diary root") // @poff=796
0x8b7: @ Trace(Stack[-1])
0x8b8: Pop(1)
...
0x8c2: Pop(1)
0x8c3: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=848
0x8c4: Pop(0)
0x8c5: Pop(0); Push((bool) Stack[-2] == 0)
0x8c6: IF (Stack[-1] == 0) GOTO 0x8cd; Pop(1)

0x8c7: Push("Can't find diary parent with id: ") // @poff=853
...
0x8cd: @@ AddChild(Stack[-8]); Obj=2 // @poff=921
0x8ce: Pop(0)
0x8cf: Push((int) 7)
0x8d0: @ SendWorldWndMessage(Stack[-1])
0x8d1: Pop(1)
0x8d2: @@ GetCategory(Stack[-1]); Obj=8 // @poff=930
0x8d3: Pop(0)
...
0x8ef: Stack[-1] = "ui/NPC_Klara.png" // @poff=956
0x8f0: Return(); Pop(0)

0x8f1: Stack[-1] = "ui/NPC_Klara_b.png" // @poff=990
0x8f2: Return(); Pop(0)
