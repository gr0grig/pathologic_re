...
Strings:
	...
	W:ood6Littleboy1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x218: Push("Can't find lsh animation : ") // @poff=206
...
0x227: Push("Can't find lsh animation : ") // @poff=206
...
0x22d: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x22e: Pop(0)
...
0x241: Push((float)9.999999974752427e-07)
...
0x269: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=262
0x26a: Return(); Pop(0)

0x26b: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=302
0x26c: Return(); Pop(0)
...
0x26f: PushEmpty()
0x270: Push("ood6Littleboy1") // @poff=346
0x271: Push((int) 1)
...
0x277: Stack[-1] = "ood6Littleboy1" // @poff=346
0x278: Call2 0x248
