...
Strings:
	...
	W:ood6Littlegirl2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x267: Push("Can't find lsh animation : ") // @poff=206
...
0x2a5: Stack[-1] = (int) 515561
0x2a6: Return(); Pop(0)

0x2a7: Stack[-1] = (int) 503346
0x2a8: Return(); Pop(0)

0x2a9: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=262
0x2aa: Return(); Pop(0)

0x2ab: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=302
0x2ac: Return(); Pop(0)
...
0x2af: PushEmpty()
0x2b0: Push("ood6Littlegirl1") // @poff=346
0x2b1: Push((int) 1)
...
0x2b5: PushEmpty()
0x2b6: Push("ood6Littlegirl2") // @poff=378
0x2b7: Push((int) 1)
...
0x2bd: Stack[-1] = "ood6Littlegirl1" // @poff=346
0x2be: Call2 0x288
...
0x2c9: Stack[-1] = "ood6Littlegirl2" // @poff=378
0x2ca: Call2 0x288
