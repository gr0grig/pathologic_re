...
Strings:
	...
	W:ood6Unosha2
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x250: Push("Can't find lsh animation : ") // @poff=206
...
0x25f: Push("Can't find lsh animation : ") // @poff=206
...
0x265: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x266: Pop(0)
...
0x279: Push((float)9.999999974752427e-07)
...
0x2a1: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=262
0x2a2: Return(); Pop(0)

0x2a3: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=302
0x2a4: Return(); Pop(0)
...
0x2a7: PushEmpty()
0x2a8: Push("ood6Unosha1") // @poff=346
0x2a9: Push((int) 1)
...
0x2ad: PushEmpty()
0x2ae: Push("ood6Unosha2") // @poff=370
0x2af: Push((int) 1)
...
0x2b5: Stack[-1] = "ood6Unosha1" // @poff=346
0x2b6: Call2 0x280
...
0x2c1: Stack[-1] = "ood6Unosha2" // @poff=370
0x2c2: Call2 0x280
