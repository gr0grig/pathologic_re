...
Strings:
	...
	W:ood6WastedMale1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2a1: PushEmpty(string, string)
0x2a2: Stack[-1] = "idle" // @poff=146
0x2a3: Push(Stack[-3])
0x2a4: IF (Stack[-1] == 0) GOTO 0x2a6; Pop(1)

0x2a5: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2a6: Stack[-1] = Stack[-4]
0x2a7: Return(); Pop(2)

0x2a8: PushEmpty(int, bool, int, bool)
0x2a9: Stack[-2] = (int) 0
0x2aa: Push("all") // @poff=138
0x2ab: PushEmpty(string, int)
0x2ac: Stack[-5] = Stack[-1]
0x2ad: Call2 0x2a1

0x2ae: Pop(1)
0x2af: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2b0: Pop(2)
...
0x2b4: Push((int) 1)
0x2b5: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x2b6: GOTO 0x2aa

0x2b7: Stack[-2] = Stack[-5]
0x2b8: Return(); Pop(4)

0x2b9: Stack[-1] = (int) 515556
0x2ba: Return(); Pop(0)

0x2bb: Stack[-1] = (int) 503341
0x2bc: Return(); Pop(0)

0x2bd: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=262
0x2be: Return(); Pop(0)

0x2bf: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=302
0x2c0: Return(); Pop(0)
...
0x2c3: PushEmpty()
0x2c4: Push("ood6WastedMale1") // @poff=346
0x2c5: Push((int) 1)
...
0x2cb: Stack[-1] = "ood6WastedMale1" // @poff=346
0x2cc: Call2 0x29c
