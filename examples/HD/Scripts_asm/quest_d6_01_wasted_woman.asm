...
Strings:
	...
	W:ood6WastedWoman1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x271: Push("Can't find lsh animation : ") // @poff=206
...
0x277: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x278: Pop(0)
...
0x28b: Push((float)9.999999974752427e-07)
...
0x2b3: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=262
0x2b4: Return(); Pop(0)

0x2b5: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=302
0x2b6: Return(); Pop(0)
...
0x2b9: PushEmpty()
0x2ba: Push("ood6WastedWoman1") // @poff=346
0x2bb: Push((int) 1)
...
0x2c1: Stack[-1] = "ood6WastedWoman1" // @poff=346
0x2c2: Call2 0x292
