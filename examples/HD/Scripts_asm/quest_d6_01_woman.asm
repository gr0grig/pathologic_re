...
Strings:
	...
	W:ood6Woman1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x22f: Push("Can't find lsh animation : ") // @poff=206
...
0x23e: Push("Can't find lsh animation : ") // @poff=206
...
0x244: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x245: Pop(0)
...
0x258: Push((float)9.999999974752427e-07)
...
0x280: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=262
0x281: Return(); Pop(0)

0x282: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=302
0x283: Return(); Pop(0)
...
0x286: PushEmpty()
0x287: Push("ood6Woman1") // @poff=346
0x288: Push((int) 1)
...
0x28e: Stack[-1] = "ood6Woman1" // @poff=346
0x28f: Call2 0x25f
