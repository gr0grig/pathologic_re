...
Strings:
	...
	W:ood6Worker1
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x255: Push("Can't find lsh animation : ") // @poff=206
...
0x25b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x25c: Pop(0)
...
0x26f: Push((float)9.999999974752427e-07)
...
0x297: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=262
0x298: Return(); Pop(0)

0x299: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=302
0x29a: Return(); Pop(0)
...
0x29d: PushEmpty()
0x29e: Push("ood6Worker1") // @poff=346
0x29f: Push((int) 1)
...
0x2a5: Stack[-1] = "ood6Worker1" // @poff=346
0x2a6: Call2 0x276
