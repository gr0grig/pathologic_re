...
Strings:
	...
	W:rat_big
	W:bomber
// @pool_raw:
...
EVENT_16 Op = 0x7b6 Vars = (object, string)
EVENT_41 Op = 0x7c3 Vars = (object)
EVENT_6 Op = 0x815 Vars = ()
...
0x359: Pop(1)
0x35a: Push("all") // @poff=170
0x35b: Push("scream") // @poff=484
0x35c: Push((int) 1)
...
0x395: Stack[-6] = Stack[-2]
0x396: Stack[-5] = Stack[-1]
0x397: Call2 0x7c9
...
0x3a2: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3b0: @ GetSeeThreshold(Stack[-0]T)
0x3b1: Pop(0)
0x3b2: @ GetSeeFOV(Stack[-1]T)
0x3b3: Pop(0)
0x3b4: Push((float)1.5)
0x3b5: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x3c1: Push((float)1.7999999523162842)
0x3c2: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[-1]);
0x3c3: @ SetSeeFOV(Stack[-1])
0x3c4: Pop(1)
0x3c5: Push("all") // @poff=170
0x3c6: Push("hunt") // @poff=498
0x3c7: @ PlayAnimation(Stack[-2], Stack[-1])
0x3c8: Pop(2)
0x3c9: @ WaitForAnimEnd(Stack[-2])
0x3ca: Pop(0)
0x3cb: @ SetSeeFOV(Stack[-1]T)
0x3cc: Pop(0)
...
0x3f4: @ IsPlayerActor(Stack[-2]T, Stack[-1])
0x3f5: Pop(0)
0x3f6: Push(Stack[-1])
...
0x41f: @ SetSeeThreshold(Stack[-0]T)
0x420: Pop(0)
0x421: @ SetSeeFOV(Stack[-1]T)
0x422: Pop(0)
0x423: @ Stop()
0x424: Pop(0)
0x425: @ StopGroup0()
...
0x460: Stack[-6] = Stack[-2]
0x461: Stack[-5] = Stack[-1]
0x462: Call2 0x7c9
...
0x485: @ rand(Stack[-2])
0x486: Pop(0)
0x487: Push((float)0.30000001192092896)
0x488: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x489: IF (Stack[-1] == 0) GOTO 0x494; Pop(1)

0x48a: Push("all") // @poff=170
0x48b: Push("hunt") // @poff=498
...
0x4b2: Pop(0)
0x4b3: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x4b4: Pop(0)
...
0x4b9: Pop(0)
0x4ba: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x4bb: Pop(0)
...
0x4c5: Push("HasProperty") // @poff=508
0x4c6: Push((int) 2)
...
0x4cc: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=532
0x4cd: Pop(0)
...
0x4d2: Stack[-10] = Stack[-2]
0x4d3: Stack[-9] = Stack[-1]
0x4d4: Call2 0x4c4
...
0x4da: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=544
0x4db: Pop(0)
0x4dc: PushEmpty(float, float, float, float)
0x4dd: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4de: Stack[-8] = Stack[-2]
0x4df: Stack[-7] = Stack[-1]
0x4e0: Call2 0x61b

0x4e1: Pop(3)
0x4e2: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=556
0x4e3: Pop(1)
0x4e4: Stack[-8] = (bool) 1
0x4e5: Return(); Pop(2)

0x4e6: PushEmpty(bool, bool)
0x4e7: @@ IsDead(Stack[-1]); Obj=3 // @poff=568
0x4e8: Pop(0)
0x4e9: Stack[-1] = Stack[-4]
0x4ea: Return(); Pop(2)

0x4eb: PushEmpty(object, object, object, object)
0x4ec: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x500: Pop(0)
0x501: Pop(0); PushNull((bool) Stack[-2] == 0)
0x502: IF (Stack[-1] == 0) GOTO 0x505; Pop(1)

0x503: Stack[-6] = (bool) 0
0x504: Return(); Pop(4)

0x505: @@ GetScene(Stack[-1]); Obj=5 // @poff=589
0x506: Pop(0)
...
0x51a: Stack[-1] = "noaccess" // @poff=598
0x51b: Call2 0x4c4
...
0x521: Push("noaccess") // @poff=598
0x522: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x523: Pop(1)
0x524: Push((int) 0)
...
0x549: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x54a: Pop(0)
...
0x55a: Stack[-1] = "fhit" // @poff=616
0x55b: GOTO 0x55d

0x55c: Stack[-1] = "bhit" // @poff=626
0x55d: Push("hit_react") // @poff=636
0x55e: Push("1") // @poff=656
0x55f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x560: Push("2") // @poff=660
...
0x579: Stack[-25] = Stack[-1]
0x57a: Call2 0x4b0

0x57b: Stack[-2] = Stack[-3]
0x57c: Pop(2)
0x57d: Call2 0x611

0x57e: Stack[-2] = Stack[-11]
0x57f: Pop(2)
0x580: @ CreateVectorVector(Stack[-8])
0x581: Pop(0)
0x582: Stack[-7] = (int) 1
0x583: Push("hit") // @poff=618
...
0x598: Pop(0)
0x599: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=673
0x59a: Pop(0)
0x59b: PushEmpty(object, int, float, cvector, cvector)
0x59c: Stack[-26] = Stack[-5]
0x59d: Stack[-25] = Stack[-4]
0x59e: Stack[-24] = Stack[-3]
0x59f: Stack[-6] = Stack[-2]
...
0x5be: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x5bf: Pop(0)
...
0x5d5: Stack[-10] = Stack[-2]
0x5d6: Stack[-9] = Stack[-1]
0x5d7: Call2 0x626
...
0x614: Push((float)9.999999974752427e-07)
...
0x645: Stack[-8] = Stack[-5]
0x646: Stack[-4] = "reputation" // @poff=705
0x647: Stack[-7] = Stack[-3]
0x648: Stack[-2] = (int) 0
0x649: Stack[-1] = (int) 1
0x64a: Call2 0x4d0
...
0x650: Pop(0)
0x651: @@ add(Stack[-3]); Obj=1 // @poff=664
0x652: Pop(0)
0x653: Push((int) 16)
...
0x657: Stack[-1] = 0
0x658: PushEmpty(bool, bool)
0x659: @ IsPlayerActor(Stack[-3], Stack[-1])
0x65a: Pop(0)
0x65b: Push(Stack[-1])
0x65c: IF (Stack[-1] == 0) GOTO 0x660; Pop(1)

0x65d: Push("attack") // @poff=334
0x65e: @ PlayGlobalMusic(Stack[-1])
0x65f: Pop(1)
0x660: Return(); Pop(2)

0x661: PushEmpty(string, string)
0x662: Stack[-1] = "idle" // @poff=727
0x663: Push(Stack[-3])
0x664: IF (Stack[-1] == 0) GOTO 0x666; Pop(1)

0x665: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x666: Stack[-1] = Stack[-4]
0x667: Return(); Pop(2)

0x668: PushEmpty(int, bool, int, bool)
0x669: Stack[-2] = (int) 0
0x66a: Push("all") // @poff=170
0x66b: PushEmpty(string, int)
0x66c: Stack[-5] = Stack[-1]
0x66d: Call2 0x661

0x66e: Pop(1)
0x66f: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x670: Pop(2)
...
0x674: Push((int) 1)
0x675: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x676: GOTO 0x66a

0x677: Stack[-2] = Stack[-5]
0x678: Return(); Pop(4)

0x679: PushEmpty(int, int)
0x67a: Push("branch") // @poff=737
0x67b: @ GetVariable(Stack[-1], Stack[-2])
0x67c: Pop(1)
...
0x686: @ WorkWithCorpse(Stack[-1])
0x687: Pop(0)
0x688: GOTO 0x68b

0x689: @ Barter(Stack[-1])
0x68a: Pop(0)
0x68b: Return(); Pop(0)

0x68c: PushEmpty(int, bool, int, bool)
0x68d: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x68e: IF (Stack[-1] == 0) GOTO 0x693; Pop(1)

0x68f: Push("GenerateMoney: iMin > iMax") // @poff=751
0x690: @ Trace(Stack[-1])
0x691: Pop(1)
0x692: Return(); Pop(4)

0x693: Stack[-2] = (int) 0
0x694: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x695: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x696: Pop(0); Push(Stack[-5] - Stack[-6]);
0x697: @ irand(Stack[-3], Stack[-1])
0x698: Pop(1)
0x699: GOTO 0x69e

0x69a: Push((int) 0)
0x69b: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x69c: IF (Stack[-1] == 0) GOTO 0x69e; Pop(1)

0x69d: Return(); Pop(4)

0x69e: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x69f: Push((int) 0)
...
0x6a4: Stack[-1] = "Money" // @poff=805
0x6a5: Call2 0x6f9

0x6a6: Pop(1)
0x6a7: Push((int) 0)
0x6a8: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x6a9: Pop(2)
0x6aa: Return(); Pop(4)

0x6ab: PushEmpty(object, int, bool, object, int, bool)
0x6ac: @ CreateInvItem(Stack[-3])
0x6ad: Pop(0)
0x6ae: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x6af: Pop(0)
0x6b0: Push("Organ") // @poff=829
0x6b1: Push((int) 1)
0x6b2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x6b3: Pop(2)
0x6b4: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x6b5: Pop(0)
0x6b6: Push((int) 0)
0x6b7: Push((int) 1)
0x6b8: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x6b9: Pop(2)
0x6ba: Return(); Pop(6)
...
0x6be: Pop(0)
0x6bf: Push((int) 1)
0x6c0: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x6c1: IF (Stack[-1] == 0) GOTO 0x6c3; Pop(1)

0x6c2: Return(); Pop(0)

0x6c3: PushEmpty(string)
0x6c4: Stack[-1] = "liver" // @poff=851
0x6c5: Call2 0x6ab

0x6c6: Pop(1)
0x6c7: PushEmpty(string)
0x6c8: Stack[-1] = "kidney" // @poff=863
0x6c9: Call2 0x6ab

0x6ca: Pop(1)
0x6cb: PushEmpty(string)
0x6cc: Stack[-1] = "heart" // @poff=877
0x6cd: Call2 0x6ab

0x6ce: Pop(1)
0x6cf: PushEmpty(string)
0x6d0: Stack[-1] = "blood" // @poff=889
0x6d1: Call2 0x6ab
...
0x6d5: Push((int) 0)
0x6d6: @ ClearSubContainer(Stack[-1])
0x6d7: Pop(1)
0x6d8: PushEmpty(int, int)
0x6d9: Stack[-2] = (int) 600
0x6da: Stack[-1] = (int) 1500
0x6db: Call2 0x68c

0x6dc: Pop(2)
0x6dd: PushEmpty(string, int, int)
0x6de: Stack[-3] = "fresh_meat" // @poff=901
0x6df: Stack[-2] = (int) 1
0x6e0: Stack[-1] = (int) 6
0x6e1: Call2 0x5c8

0x6e2: Pop(3)
0x6e3: PushEmpty(string, int, int, int)
0x6e4: Stack[-4] = "rusk" // @poff=923
0x6e5: Stack[-3] = (int) 1
0x6e6: Stack[-2] = (int) 6
0x6e7: Stack[-1] = (int) 2
0x6e8: Call2 0x5d3
...
0x6e9: Pop(4)
0x6ea: PushEmpty(string, int, int)
0x6eb: Stack[-3] = "gamma_pills" // @poff=933
0x6ec: Stack[-2] = (int) 1
0x6ed: Stack[-1] = (int) 3
0x6ee: Call2 0x5c8

0x6ef: Pop(3)
0x6f0: PushEmpty(int, string)
0x6f1: Stack[-1] = "bomber_mark" // @poff=957
0x6f2: Call2 0x6f9

0x6f3: Pop(1)
0x6f4: Push((int) 0)
0x6f5: Push((int) 1)
0x6f6: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6f7: Pop(3)
0x6f8: Return(); Pop(4)

0x6f9: PushEmpty(int, int)
0x6fa: @ GetInvItemByName(Stack[-1], Stack[-3])
0x6fb: Pop(0)
0x6fc: Stack[-1] = Stack[-4]
0x6fd: Return(); Pop(2)

0x6fe: PushEmpty(string, string, string, string)
0x6ff: PushEmpty(bool, object, string)
0x700: Stack[-8] = Stack[-2]
0x701: Stack[-1] = "class" // @poff=981
0x702: Call2 0x4c4
...
0x708: Push("class") // @poff=981
0x709: @ GetProperty(Stack[-1], Stack[-3])
0x70a: Pop(1)
0x70b: Push("class") // @poff=981
0x70c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x70d: Pop(1)
0x70e: Stack[-6] = Stack[-1] == Stack[-2]; Pop(0);
0x70f: Return(); Pop(4)

0x710: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x711: Push(CvectorIndex(Stack[-11], 0))
0x712: Push(CvectorIndex(Stack[-12], 0))
0x713: Pop(2); Push(Stack[-2] * Stack[-1]);
0x714: Push(CvectorIndex(Stack[-12], 2))
0x715: Push(CvectorIndex(Stack[-13], 2))
0x716: Pop(2); Push(Stack[-2] * Stack[-1]);
0x717: Pop(2); Push(Stack[-2] + Stack[-1]);
0x718: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x719: Push(CvectorIndex(Stack[-11], 1))
0x71a: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x71b: Push(CvectorIndex(Stack[-13], 0))
0x71c: Push(CvectorIndex(Stack[-13], 0))
0x71d: Pop(2); Push(Stack[-2] - Stack[-1]);
0x71e: Push(CvectorIndex(Stack[-14], 0))
0x71f: Push(CvectorIndex(Stack[-14], 0))
0x720: Pop(2); Push(Stack[-2] - Stack[-1]);
0x721: Pop(2); Push(Stack[-2] * Stack[-1]);
0x722: Push(CvectorIndex(Stack[-14], 2))
0x723: Push(CvectorIndex(Stack[-14], 2))
0x724: Pop(2); Push(Stack[-2] - Stack[-1]);
0x725: Push(CvectorIndex(Stack[-15], 2))
0x726: Push(CvectorIndex(Stack[-15], 2))
0x727: Pop(2); Push(Stack[-2] - Stack[-1]);
0x728: Pop(2); Push(Stack[-2] * Stack[-1]);
0x729: Pop(2); Push(Stack[-2] + Stack[-1]);
0x72a: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x72b: Push((float)500.0)
0x72c: Pop(0); Push(Stack[-4] * Stack[-5]);
0x72d: Push(CvectorIndex(Stack[-14], 1))
0x72e: Push(CvectorIndex(Stack[-16], 1))
0x72f: Pop(2); Push(Stack[-2] - Stack[-1]);
0x730: Pop(2); Push(Stack[-2] - Stack[-1]);
0x731: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x732: Push((int) 0)
0x733: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x734: IF (Stack[-1] == 0) GOTO 0x737; Pop(1)

0x735: Stack[-14] = (int) -1
0x736: Return(); Pop(10)

0x737: Pop(0); Push(Stack[-3] / Stack[-5]);
0x738: Pop(0); Push(Sqrt(Stack[-3]))
0x739: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x73a: Stack[-1] = Stack[-14]
0x73b: Return(); Pop(10)
...
0x74e: Stack[-2] = (int) 30
0x74f: Return(); Pop(0)

0x750: Stack[-2] = (int) 700
0x751: Return(); Pop(0)

0x752: PushEmpty()
0x753: Push((int) 10)
0x754: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x755: IF (Stack[-1] == 0) GOTO 0x759; Pop(1)

0x756: Stack[-3] = (int) 10
0x757: Return(); Pop(0)
...
0x769: Stack[-2] = Stack[-1]
0x76a: Push(-1, 3); TaskCall(2)
0x76b: Call2 0x15d

0x76c: Pop(-1, 3); TaskReturn
0x76d: Pop(1)
0x76e: Return(); Pop(0)
...
0x773: Stack[-2] = Stack[-4]
0x774: Pop(2)
0x775: Return(); Pop(0)

0x776: PushEmpty()
0x777: PushEmpty(object)
0x778: Stack[-2] = Stack[-1]
0x779: Push(-1, 2); TaskCall(4)
0x77a: Call2 0x2ab

0x77b: Pop(-1, 2); TaskReturn
0x77c: Pop(1)
0x77d: @ ResetAAS()
0x77e: Pop(0)
0x77f: Return(); Pop(0)
...
0x787: Push(-1, 2); TaskCall(4)
0x788: Call2 0x2ab

0x789: Pop(-1, 2); TaskReturn
0x78a: Pop(1)
0x78b: @ ResetAAS()
0x78c: Pop(0)
0x78d: Return(); Pop(0)
...
0x790: Stack[-7] = Stack[-3]
0x791: Stack[-6] = Stack[-2]
0x792: Stack[-5] = Stack[-1]
0x793: Call2 0x566
...
0x798: Stack[-11] = Stack[-5]
0x799: Stack[-10] = Stack[-4]
0x79a: Stack[-9] = Stack[-3]
0x79b: Stack[-7] = Stack[-2]
0x79c: Stack[-6] = Stack[-1]
0x79d: Call2 0x5aa
...
0x7aa: PushEmpty(bool, object, float)
0x7ab: Stack[-4] = Stack[-2]
0x7ac: Stack[-1] = (float) 0.05000000074505806
0x7ad: Call2 0x62b

0x7ae: Pop(3)
0x7af: PushEmpty(object)
0x7b0: Stack[-2] = Stack[-1]
0x7b1: Push(-1, 0); TaskCall(1)
0x7b2: Call2 0xb9
...
0x7b6: PushEmpty(float, float)
0x7b7: Push("health") // @poff=993
0x7b8: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7b9: IF (Stack[-1] == 0) GOTO 0x7c2; Pop(1)

0x7ba: Push("health") // @poff=993
0x7bb: @ GetProperty(Stack[-1], Stack[-2])
0x7bc: Pop(1)
0x7bd: Push((int) 0)
0x7be: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7bf: IF (Stack[-1] == 0) GOTO 0x7c2; Pop(1)

0x7c0: @ SignalDeath(Stack[-4])
0x7c1: Pop(0)
0x7c2: Return(); Pop(2)
...
0x7cb: Stack[-5] = Stack[-1]
0x7cc: Call2 0x6fe

0x7cd: Pop(1)
0x7ce: IF (Stack[-1] == 0) GOTO 0x7e0; Pop(1)

0x7cf: @ CanSee(Stack[-1], Stack[-4])
0x7d0: Pop(0)
0x7d1: PushEmpty(bool)
0x7d2: Stack[-1] = (bool) 1
0x7d3: Push(Stack[-2])
0x7d4: IF (Stack[-1] == 1) GOTO 0x7dd; Pop(1)

0x7d5: PushEmpty(float, object)
0x7d6: Stack[-7] = Stack[-1]
0x7d7: Call2 0x4b7

0x7d8: Pop(1)
0x7d9: Push((float)490000.0)
...
0x7de: Stack[-5] = (bool) 1
0x7df: Return(); Pop(2)

0x7e0: Stack[-5] = (bool) 0
0x7e1: Return(); Pop(2)

0x7e2: Return(); Pop(0)

0x7e3: PushEmpty(string, string)
0x7e4: PushEmpty(bool, object)
0x7e5: Stack[-5] = Stack[-1]
0x7e6: Call2 0x50f
...
0x7ea: Stack[-4] = (bool) 0
0x7eb: Return(); Pop(2)

0x7ec: PushEmpty(bool, object, string)
0x7ed: Stack[-6] = Stack[-2]
0x7ee: Stack[-1] = "health" // @poff=993
0x7ef: Call2 0x4c4
...
0x7f7: Stack[-1] = "class" // @poff=981
0x7f8: Call2 0x4c4

0x7f9: Pop(2)
0x7fa: IF (Stack[-1] == 0) GOTO 0x811; Pop(1)

0x7fb: Push("class") // @poff=981
0x7fc: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x7fd: Pop(1)
0x7fe: PushEmpty(bool)
0x7ff: Stack[-1] = (bool) 1
0x800: PushEmpty(bool)
0x801: Stack[-1] = (bool) 1
0x802: Push("rat") // @poff=1007
0x803: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x804: IF (Stack[-1] == 1) GOTO 0x809; Pop(1)

0x805: Push("rat_big") // @poff=1015
0x806: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x807: IF (Stack[-1] == 1) GOTO 0x809; Pop(1)

0x808: Stack[-1] = (bool) 0
0x809: IF (Stack[-1] == 1) GOTO 0x80e; Pop(1)

0x80a: Push("bomber") // @poff=1031
...
0x80f: Stack[-4] = (bool) 0
0x810: Return(); Pop(2)

0x811: Stack[-4] = (bool) 1
0x812: Return(); Pop(2)
