...
0x65a: Pop(0)
0x65b: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x683: Stack[-2] = Stack[-5]
0x684: Return(); Pop(4)

0x685: PushEmpty(int, int)
0x686: Push("branch") // @poff=737
...
0x69b: Push("GenerateMoney: iMin > iMax") // @poff=751
0x69c: @ Trace(Stack[-1])
0x69d: Pop(1)
0x69e: Return(); Pop(4)
...
0x6b9: Pop(0)
0x6ba: @@ SetItemName(Stack[-7]); Obj=3 // @poff=817
0x6bb: Pop(0)
0x6bc: Push("Organ") // @poff=829
0x6bd: Push((int) 1)
0x6be: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=556
0x6bf: Pop(2)
0x6c0: @@ GetItemID(Stack[-2]); Obj=3 // @poff=841
0x6c1: Pop(0)
0x6c2: Push((int) 0)
0x6c3: Push((int) 1)
...
0x6d0: Stack[-1] = "liver" // @poff=851
0x6d1: Call2 0x6b7

0x6d2: Pop(1)
0x6d3: PushEmpty(string)
0x6d4: Stack[-1] = "kidney" // @poff=863
0x6d5: Call2 0x6b7

0x6d6: Pop(1)
0x6d7: PushEmpty(string)
0x6d8: Stack[-1] = "heart" // @poff=877
0x6d9: Call2 0x6b7

0x6da: Pop(1)
0x6db: PushEmpty(string)
0x6dc: Stack[-1] = "blood" // @poff=889
0x6dd: Call2 0x6b7
...
0x6ea: Stack[-3] = "fresh_meat" // @poff=901
0x6eb: Stack[-2] = (int) 1
0x6ec: Stack[-1] = (int) 6
0x6ed: Call2 0x5c8
...
0x6f7: Stack[-3] = "gamma_pills" // @poff=933
0x6f8: Stack[-2] = (int) 1
0x6f9: Stack[-1] = (int) 3
0x6fa: Call2 0x5c8
...
0x6fd: Stack[-1] = "bomber_mark" // @poff=957
0x6fe: Call2 0x705
...
0x716: Pop(1)
0x717: Push("class") // @poff=981
0x718: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=544
0x719: Pop(1)
...
0x77d: Stack[-3] = Stack[-1]
0x77e: Call2 0x7ef

0x77f: Stack[-2] = Stack[-4]
0x780: Pop(2)
0x781: Return(); Pop(0)
...
0x79c: Stack[-7] = Stack[-3]
0x79d: Stack[-6] = Stack[-2]
0x79e: Stack[-5] = Stack[-1]
0x79f: Call2 0x566
...
0x7a4: Stack[-11] = Stack[-5]
0x7a5: Stack[-10] = Stack[-4]
0x7a6: Stack[-9] = Stack[-3]
0x7a7: Stack[-7] = Stack[-2]
0x7a8: Stack[-6] = Stack[-1]
0x7a9: Call2 0x5aa
...
0x7b7: Stack[-4] = Stack[-2]
0x7b8: Stack[-1] = (float) 0.05000000074505806
0x7b9: Call2 0x62b
...
0x7df: Push(Stack[-2])
0x7e0: IF (Stack[-1] == 1) GOTO 0x7e9; Pop(1)
...
0x7e7: IF (Stack[-1] == 1) GOTO 0x7e9; Pop(1)
...
0x7f9: Stack[-6] = Stack[-2]
0x7fa: Stack[-1] = "health" // @poff=993
0x7fb: Call2 0x4c4
...
0x803: Stack[-1] = "class" // @poff=981
0x804: Call2 0x4c4

0x805: Pop(2)
0x806: IF (Stack[-1] == 0) GOTO 0x81d; Pop(1)

0x807: Push("class") // @poff=981
0x808: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x809: Pop(1)
0x80a: PushEmpty(bool)
0x80b: Stack[-1] = (bool) 1
0x80c: PushEmpty(bool)
0x80d: Stack[-1] = (bool) 1
0x80e: Push("rat") // @poff=1007
0x80f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x810: IF (Stack[-1] == 1) GOTO 0x815; Pop(1)

0x811: Push("rat_big") // @poff=1015
0x812: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x813: IF (Stack[-1] == 1) GOTO 0x815; Pop(1)

0x814: Stack[-1] = (bool) 0
0x815: IF (Stack[-1] == 1) GOTO 0x81a; Pop(1)

0x816: Push("bomber") // @poff=1031
0x817: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x818: IF (Stack[-1] == 1) GOTO 0x81a; Pop(1)
...
0x82b: Stack[-2] = "quest_d6_02" // @poff=1045
0x82c: Stack[-1] = "gorbun_death" // @poff=1069
0x82d: Call2 0x658
