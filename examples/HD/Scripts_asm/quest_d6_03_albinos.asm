...
Strings:
	...
	W:albinos_dead
	W:player
// @pool_raw:
// @pool_encoding:utf8
...
0x4aa: Push("voice_common") // @poff=679
0x4ab: Push((int) 1)
...
0x4b2: Push("voice_common") // @poff=679
0x4b3: Push((int) 0)
...
0x4c5: Push("voice_common") // @poff=679
0x4c6: Push((int) 1)
...
0x4d3: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=496
0x4d4: Pop(1)
...
0x4fe: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=496
0x4ff: Pop(1)
...
0x513: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=534
0x514: Pop(1)
0x515: PushEmpty(bool, string)
0x516: Stack[-3] = Stack[-1]
0x517: Call2 0x53a

0x518: Stack[-2] = Stack[-14]
0x519: Pop(2)
0x51a: Return(); Pop(10)
...
0x526: Push("Can't find lsh animation : ") // @poff=713
...
0x535: Push("Can't find lsh animation : ") // @poff=713
...
0x582: Push((float)9.999999974752427e-07)
...
0x5bb: Pop(0)
0x5bc: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5ec: PushEmpty()
0x5ed: Push("ood6Albinos1") // @poff=781
0x5ee: Push((int) 1)
...
0x5f4: Stack[-1] = "ood6Albinos1" // @poff=781
0x5f5: Call2 0x5a3
...
0x613: Stack[-1] = "ui/NPC_Albinos.png" // @poff=821
0x614: Return(); Pop(0)

0x615: Stack[-1] = "ui/NPC_Albinos_b.png" // @poff=859
0x616: Return(); Pop(0)
...
0x61e: Stack[-2] = "quest_d6_03" // @poff=156
0x61f: Stack[-1] = "albinos_dead" // @poff=901
0x620: Call2 0x5b9
...
0x637: Stack[-6] = Stack[-3]
0x638: Stack[-2] = (float) 0.05000000074505806
0x639: Stack[-1] = (int) 0
0x63a: Call2 0x36e

0x63b: Stack[-4] = Stack[-5]
0x63c: Pop(4)
0x63d: Push((int) 6)
0x63e: Push((float)0.05000000074505806)
...
0x645: Stack[-7] = Stack[-3]
0x646: Stack[-6] = Stack[-2]
0x647: Stack[-5] = Stack[-1]
0x648: Call2 0x3e3
...
0x64d: Stack[-11] = Stack[-5]
0x64e: Stack[-10] = Stack[-4]
0x64f: Stack[-9] = Stack[-3]
0x650: Stack[-7] = Stack[-2]
0x651: Stack[-6] = Stack[-1]
0x652: Call2 0x427
