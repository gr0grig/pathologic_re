...
// @pool_raw:
// @pool_encoding:utf8
...
0x1f4: Stack[-1] = "Neutral" // @poff=89
0x1f5: Call2 0xd2

0x1f6: Pop(1)
0x1f7: Push((int) 513201)
0x1f8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x1f9: Pop(1)
0x1fa: @@@ ClearReplies(); Obj=0 // @poff=116
0x1fb: Pop(0)
...
0x278: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x279: Pop(0)
0x27a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=168
0x27b: Pop(0)
...
0x2d9: Push("Can't find lsh animation : ") // @poff=192
...
0x2e8: Push("Can't find lsh animation : ") // @poff=192
...
0x2f5: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2f6: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2f7: Push((float)9.999999974752427e-07)
0x2f8: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2f9: IF (Stack[-1] == 0) GOTO 0x2fc; Pop(1)

0x2fa: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2fb: Return(); Pop(2)

0x2fc: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2fd: Return(); Pop(2)

0x2fe: PushEmpty(int, int)
0x2ff: @ GetVariable(Stack[-3], Stack[-1])
0x300: Pop(0)
0x301: Stack[-1] = Stack[-4]
0x302: Return(); Pop(2)

0x303: PushEmpty(object, object)
0x304: @ CreateIntVector(Stack[-1])
0x305: Pop(0)
0x306: @@ add(Stack[-4]); Obj=1 // @poff=248
0x307: Pop(0)
0x308: @@ add(Stack[-3]); Obj=1 // @poff=248
0x309: Pop(0)
0x30a: Push((int) 3)
0x30b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x30c: Pop(1)
0x30d: Return(); Pop(2)

0x30e: Stack[-1] = 0
0x30f: PushEmpty(int, int, bool, int, int, bool)
0x310: @@ GetItemID(Stack[-3]); Obj=8 // @poff=252
0x311: Pop(0)
0x312: Push("Category") // @poff=262
0x313: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x314: Pop(1)
0x315: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=280
0x316: Pop(0)
0x317: Pop(0); Push((bool) Stack[-1] == 0)
0x318: IF (Stack[-1] == 0) GOTO 0x31c; Pop(1)

0x319: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=288
0x31a: Pop(0)
0x31b: GOTO 0x321

0x31c: PushEmpty(int, int)
0x31d: Stack[-5] = Stack[-2]
0x31e: Stack[-9] = Stack[-1]
0x31f: Call2 0x303
...
0x323: @ CreateInvItem(Stack[-1])
0x324: Pop(0)
0x325: @@ SetItemName(Stack[-4]); Obj=1 // @poff=298
0x326: Pop(0)
0x327: PushEmpty(object, object, int)
0x328: Stack[-8] = Stack[-3]
0x329: Stack[-4] = Stack[-2]
...
0x331: Pop(0)
0x332: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x33a: Stack[-1] = 0
0x33b: PushEmpty()
0x33c: Push("playsound") // @poff=310
0x33d: Push("giveitem") // @poff=330
0x33e: @ TriggerWorld(Stack[-2], Stack[-1])
0x33f: Pop(2)
0x340: Return(); Pop(0)

0x341: PushEmpty()
0x342: Push("ood7UBirdmask1") // @poff=348
0x343: Push((int) 1)
...
0x347: PushEmpty()
0x348: Push("ureport is given") // @poff=378
0x349: @ Trace(Stack[-1])
0x34a: Pop(1)
0x34b: PushEmpty(object, string, int)
0x34c: Stack[-5] = Stack[-3]
0x34d: Stack[-2] = "d7q01_ureport" // @poff=412
0x34e: Stack[-1] = (int) 1
0x34f: Call2 0x322
...
0x354: Stack[-2] = "quest_d7_01" // @poff=440
0x355: Stack[-1] = "kill_player" // @poff=464
0x356: Call2 0x32f
...
0x37b: PushEmpty()
0x37c: PushEmpty(int, string)
0x37d: Stack[-1] = "ood7UBirdmask1" // @poff=348
0x37e: Call2 0x2fe

0x37f: Pop(1)
0x380: Push((int) 0)
0x381: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x382: IF (Stack[-1] == 0) GOTO 0x385; Pop(1)

0x383: Stack[-2] = (bool) 1
0x384: Return(); Pop(0)

0x385: Stack[-2] = (bool) 0
0x386: Return(); Pop(0)

0x387: PushEmpty(int, int, int, bool, bool, int, object, int, bool, bool, int, int, int, bool, bool, int, object, int, bool, bool)
0x388: Push((int) 1)
0x389: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=500
0x38a: Pop(1)
0x38b: Push("bird_mask") // @poff=513
0x38c: @ GetInvItemByName(Stack[-10], Stack[-1])
0x38d: Pop(1)
0x38e: Push("bird_balahon") // @poff=533
0x38f: @ GetInvItemByName(Stack[-9], Stack[-1])
0x390: Pop(1)
0x391: Stack[-7] = (bool) 0
0x392: Stack[-6] = (bool) 0
0x393: Stack[-5] = (int) 0
0x394: Pop(0); Push((bool) Stack[-5] < Stack[-10])
0x395: IF (Stack[-1] == 0) GOTO 0x3b0; Pop(1)

0x396: Push((int) 1)
0x397: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=559
0x398: Pop(1)
0x399: @@ GetItemID(Stack[-3]); Obj=4 // @poff=252
0x39a: Pop(0)
0x39b: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x39c: IF (Stack[-1] == 0) GOTO 0x3a4; Pop(1)

0x39d: Push((int) 1)
0x39e: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=567
0x39f: Pop(1)
0x3a0: Push(Stack[-2])
0x3a1: IF (Stack[-1] == 0) GOTO 0x3a3; Pop(1)

0x3a2: Stack[-7] = (bool) 1
0x3a3: GOTO 0x3ac

0x3a4: Pop(0); Push((bool) Stack[-3] == Stack[-8])
0x3a5: IF (Stack[-1] == 0) GOTO 0x3ac; Pop(1)

0x3a6: Push((int) 1)
0x3a7: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=567
0x3a8: Pop(1)
0x3a9: Push(Stack[-1])
...
0x3ac: Stack[-4] = 0
0x3ad: Push((int) 1)
0x3ae: Stack[-6] = Stack[-6] + Stack[-1]; Pop(1);
0x3af: GOTO 0x394

0x3b0: Stack[-22] = (bool) 0
0x3b1: Push(Stack[-7])
...
0x3b5: Stack[-22] = (bool) 1
0x3b6: Return(); Pop(20)

0x3b7: PushEmpty(int, int)
0x3b8: Push("branch") // @poff=582
...
0x3c8: Stack[-1] = (int) 515571
0x3c9: Return(); Pop(0)

0x3ca: Stack[-1] = (int) 504029
0x3cb: Return(); Pop(0)

0x3cc: Stack[-1] = "ui/NPC_bmask.png" // @poff=596
0x3cd: Return(); Pop(0)

0x3ce: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=630
0x3cf: Return(); Pop(0)
