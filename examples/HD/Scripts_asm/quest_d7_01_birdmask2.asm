...
// @pool_raw:
// @pool_encoding:utf8
...
0xc7: Push("all") // @poff=138
0xc8: Push("idle") // @poff=146
...
0x26a: Stack[-1] = "Neutral" // @poff=89
0x26b: Call2 0xcd

0x26c: Pop(1)
0x26d: Push((int) 513277)
0x26e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x26f: Pop(1)
0x270: @@@ ClearReplies(); Obj=0 // @poff=116
0x271: Pop(0)
...
0x28e: Stack[-1] = "Neutral" // @poff=89
0x28f: Call2 0xcd

0x290: Pop(1)
0x291: Push((int) 513272)
0x292: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x293: Pop(1)
0x294: @@@ ClearReplies(); Obj=0 // @poff=116
0x295: Pop(0)
...
0x2da: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x2db: Pop(0)
0x2dc: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=168
0x2dd: Pop(0)
...
0x303: Pop(0)
0x304: Push((bool) 1)
0x305: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x306: Pop(1)
0x307: Push(CvectorIndex(Stack[-4], 0))
0x308: Push(CvectorIndex(Stack[-5], 2))
0x309: @ Rotate(Stack[-2], Stack[-1])
0x30a: Pop(2)
...
0x310: Push("head") // @poff=182
0x311: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x312: Pop(1)
0x313: Push(Stack[-1])
0x314: IF (Stack[-1] == 0) GOTO 0x318; Pop(1)

0x315: Push("head") // @poff=182
0x316: @ LookAsyncCamera(Stack[-1])
0x317: Pop(1)
0x318: @ CameraWaitForPlayFinish()
0x319: Pop(0)
0x31a: @ ResumeWorld()
0x31b: Pop(0)
0x31c: Stack[-21] = (bool) 1
0x31d: Return(); Pop(18)

0x31e: PushEmpty(bool, bool)
0x31f: Push((bool) 1)
0x320: @ CameraSwitchToNormal(Stack[-1])
0x321: Pop(1)
...
0x327: Push("head") // @poff=182
0x328: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x329: Pop(1)
0x32a: Push(Stack[-1])
0x32b: IF (Stack[-1] == 0) GOTO 0x32f; Pop(1)

0x32c: Push("head") // @poff=182
0x32d: @ UnlookAsync(Stack[-1])
0x32e: Pop(1)
0x32f: Return(); Pop(2)
...
0x33b: Push("Can't find lsh animation : ") // @poff=192
...
0x34a: Push("Can't find lsh animation : ") // @poff=192
...
0x356: PushEmpty(float, float)
0x357: Pop(0); Push(Stack[-3] | Stack[-3]);
0x358: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x359: Push((float)9.999999974752427e-07)
0x35a: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x35b: IF (Stack[-1] == 0) GOTO 0x35e; Pop(1)

0x35c: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x35d: Return(); Pop(2)

0x35e: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x35f: Return(); Pop(2)

0x360: PushEmpty(int, int)
0x361: @ GetVariable(Stack[-3], Stack[-1])
0x362: Pop(0)
0x363: Stack[-1] = Stack[-4]
0x364: Return(); Pop(2)

0x365: PushEmpty(object, object)
0x366: @ CreateIntVector(Stack[-1])
0x367: Pop(0)
0x368: @@ add(Stack[-4]); Obj=1 // @poff=248
0x369: Pop(0)
0x36a: @@ add(Stack[-3]); Obj=1 // @poff=248
0x36b: Pop(0)
0x36c: Push((int) 3)
0x36d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x36e: Pop(1)
0x36f: Return(); Pop(2)

0x370: Stack[-1] = 0
0x371: PushEmpty(int, int, bool, int, int, bool)
0x372: @@ GetItemID(Stack[-3]); Obj=8 // @poff=252
0x373: Pop(0)
0x374: Push("Category") // @poff=262
0x375: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x376: Pop(1)
0x377: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=280
0x378: Pop(0)
0x379: Pop(0); Push((bool) Stack[-1] == 0)
0x37a: IF (Stack[-1] == 0) GOTO 0x37e; Pop(1)

0x37b: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=288
0x37c: Pop(0)
0x37d: GOTO 0x383

0x37e: PushEmpty(int, int)
0x37f: Stack[-5] = Stack[-2]
0x380: Stack[-9] = Stack[-1]
0x381: Call2 0x365
...
0x385: @ CreateInvItem(Stack[-1])
0x386: Pop(0)
0x387: @@ SetItemName(Stack[-4]); Obj=1 // @poff=298
0x388: Pop(0)
0x389: PushEmpty(object, object, int)
0x38a: Stack[-8] = Stack[-3]
...
0x392: @ FindActor(Stack[-1], Stack[-4])
0x393: Pop(0)
0x394: Pop(0); PushNull((bool) Stack[-1] == 0)
0x395: IF (Stack[-1] == 0) GOTO 0x398; Pop(1)

0x396: Stack[-5] = (bool) 0
0x397: Return(); Pop(2)

0x398: @ Trigger(Stack[-1], Stack[-3])
0x399: Pop(0)
0x39a: Stack[-5] = (bool) 1
0x39b: Return(); Pop(2)

0x39c: Stack[-1] = 0
0x39d: PushEmpty()
0x39e: Push("playsound") // @poff=310
0x39f: Push("giveitem") // @poff=330
0x3a0: @ TriggerWorld(Stack[-2], Stack[-1])
0x3a1: Pop(2)
0x3a2: Return(); Pop(0)

0x3a3: PushEmpty()
0x3a4: Push("dreport is given") // @poff=348
0x3a5: @ Trace(Stack[-1])
0x3a6: Pop(1)
0x3a7: PushEmpty(object, string, int)
0x3a8: Stack[-5] = Stack[-3]
0x3a9: Stack[-2] = "d7q01_dreport" // @poff=382
0x3aa: Stack[-1] = (int) 1
0x3ab: Call2 0x384
...
0x3ae: PushEmpty()
0x3af: Push("ood7DBirdmask1") // @poff=410
0x3b0: Push((int) 1)
...
0x3b6: Stack[-2] = "quest_d7_01" // @poff=440
0x3b7: Stack[-1] = "kill_player" // @poff=464
0x3b8: Call2 0x391
...
0x3df: Stack[-1] = "ood7DBirdmask1" // @poff=410
0x3e0: Call2 0x360
...
0x3e9: PushEmpty(int, int, int, bool, bool, int, object, int, bool, bool, int, int, int, bool, bool, int, object, int, bool, bool)
0x3ea: Push((int) 1)
0x3eb: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=500
0x3ec: Pop(1)
0x3ed: Push("bird_mask") // @poff=513
0x3ee: @ GetInvItemByName(Stack[-10], Stack[-1])
0x3ef: Pop(1)
0x3f0: Push("bird_balahon") // @poff=533
0x3f1: @ GetInvItemByName(Stack[-9], Stack[-1])
0x3f2: Pop(1)
0x3f3: Stack[-7] = (bool) 0
0x3f4: Stack[-6] = (bool) 0
0x3f5: Stack[-5] = (int) 0
0x3f6: Pop(0); Push((bool) Stack[-5] < Stack[-10])
0x3f7: IF (Stack[-1] == 0) GOTO 0x412; Pop(1)

0x3f8: Push((int) 1)
0x3f9: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=559
0x3fa: Pop(1)
0x3fb: @@ GetItemID(Stack[-3]); Obj=4 // @poff=252
0x3fc: Pop(0)
0x3fd: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x3fe: IF (Stack[-1] == 0) GOTO 0x406; Pop(1)

0x3ff: Push((int) 1)
0x400: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=567
0x401: Pop(1)
0x402: Push(Stack[-2])
0x403: IF (Stack[-1] == 0) GOTO 0x405; Pop(1)

0x404: Stack[-7] = (bool) 1
0x405: GOTO 0x40e

0x406: Pop(0); Push((bool) Stack[-3] == Stack[-8])
0x407: IF (Stack[-1] == 0) GOTO 0x40e; Pop(1)

0x408: Push((int) 1)
0x409: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=567
0x40a: Pop(1)
0x40b: Push(Stack[-1])
...
0x40e: Stack[-4] = 0
0x40f: Push((int) 1)
0x410: Stack[-6] = Stack[-6] + Stack[-1]; Pop(1);
0x411: GOTO 0x3f6

0x412: Stack[-22] = (bool) 0
0x413: Push(Stack[-7])
...
0x417: Stack[-22] = (bool) 1
0x418: Return(); Pop(20)

0x419: PushEmpty(int, int)
0x41a: Push("branch") // @poff=582
0x41b: @ GetVariable(Stack[-1], Stack[-2])
0x41c: Pop(1)
0x41d: Push((int) 0)
...
0x42e: Stack[-1] = "ui/NPC_bmask.png" // @poff=596
0x42f: Return(); Pop(0)

0x430: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=630
0x431: Return(); Pop(0)
