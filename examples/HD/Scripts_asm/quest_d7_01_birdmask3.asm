...
// @pool_raw:
// @pool_encoding:utf8
...
0x2cf: @@ GetPosition(Stack[-8]); Obj=20 // @poff=156
0x2d0: Pop(0)
0x2d1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=168
0x2d2: Pop(0)
...
0x330: Push("Can't find lsh animation : ") // @poff=192
...
0x33f: Push("Can't find lsh animation : ") // @poff=192
...
0x34e: Push((float)9.999999974752427e-07)
...
0x35c: Pop(0)
0x35d: @@ add(Stack[-4]); Obj=1 // @poff=248
0x35e: Pop(0)
0x35f: @@ add(Stack[-3]); Obj=1 // @poff=248
0x360: Pop(0)
0x361: Push((int) 3)
...
0x367: @@ GetItemID(Stack[-3]); Obj=8 // @poff=252
0x368: Pop(0)
0x369: Push("Category") // @poff=262
0x36a: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x36b: Pop(1)
0x36c: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=280
0x36d: Pop(0)
0x36e: Pop(0); Push((bool) Stack[-1] == 0)
0x36f: IF (Stack[-1] == 0) GOTO 0x373; Pop(1)

0x370: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=288
0x371: Pop(0)
0x372: GOTO 0x378

0x373: PushEmpty(int, int)
0x374: Stack[-5] = Stack[-2]
...
0x37b: Pop(0)
0x37c: @@ SetItemName(Stack[-4]); Obj=1 // @poff=298
0x37d: Pop(0)
0x37e: PushEmpty(object, object, int)
0x37f: Stack[-8] = Stack[-3]
0x380: Stack[-4] = Stack[-2]
...
0x388: Pop(0)
0x389: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x391: Stack[-1] = 0
0x392: PushEmpty()
0x393: Push("playsound") // @poff=310
0x394: Push("giveitem") // @poff=330
0x395: @ TriggerWorld(Stack[-2], Stack[-1])
0x396: Pop(2)
0x397: Return(); Pop(0)

0x398: PushEmpty()
0x399: Push("d7q01") // @poff=348
0x39a: Push((int) 3)
...
0x3a1: PushEmpty()
0x3a2: Push("mreport is given") // @poff=360
0x3a3: @ Trace(Stack[-1])
0x3a4: Pop(1)
0x3a5: PushEmpty(object, string, int)
0x3a6: Stack[-5] = Stack[-3]
0x3a7: Stack[-2] = "d7q01_mreport" // @poff=394
0x3a8: Stack[-1] = (int) 1
0x3a9: Call2 0x379
...
0x3ac: PushEmpty()
0x3ad: Push("ood7MBirdmask1") // @poff=422
0x3ae: Push((int) 1)
...
0x3b4: Stack[-2] = "quest_d7_01" // @poff=452
0x3b5: Stack[-1] = "sobor_teleport" // @poff=476
0x3b6: Call2 0x386
...
0x3d1: Stack[-1] = "ood7MBirdmask1" // @poff=422
0x3d2: Call2 0x355
...
0x3dc: Push((int) 1)
0x3dd: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=506
0x3de: Pop(1)
0x3df: Push("bird_mask") // @poff=519
0x3e0: @ GetInvItemByName(Stack[-10], Stack[-1])
0x3e1: Pop(1)
0x3e2: Push("bird_balahon") // @poff=539
...
0x3ea: Push((int) 1)
0x3eb: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=565
0x3ec: Pop(1)
0x3ed: @@ GetItemID(Stack[-3]); Obj=4 // @poff=252
0x3ee: Pop(0)
0x3ef: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x3f0: IF (Stack[-1] == 0) GOTO 0x3f8; Pop(1)

0x3f1: Push((int) 1)
0x3f2: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=573
0x3f3: Pop(1)
0x3f4: Push(Stack[-2])
...
0x3fa: Push((int) 1)
0x3fb: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=573
0x3fc: Pop(1)
0x3fd: Push(Stack[-1])
...
0x41d: Push("Can't retrieve diary root") // @poff=588
0x41e: @ Trace(Stack[-1])
0x41f: Pop(1)
...
0x429: Pop(1)
0x42a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=640
0x42b: Pop(0)
0x42c: Pop(0); Push((bool) Stack[-2] == 0)
0x42d: IF (Stack[-1] == 0) GOTO 0x434; Pop(1)

0x42e: Push("Can't find diary parent with id: ") // @poff=645
...
0x434: @@ AddChild(Stack[-8]); Obj=2 // @poff=713
0x435: Pop(0)
0x436: Push((int) 7)
0x437: @ SendWorldWndMessage(Stack[-1])
0x438: Pop(1)
0x439: @@ GetCategory(Stack[-1]); Obj=8 // @poff=722
0x43a: Pop(0)
...
0x456: Stack[-1] = "ui/NPC_bmask.png" // @poff=748
0x457: Return(); Pop(0)

0x458: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=782
0x459: Return(); Pop(0)
