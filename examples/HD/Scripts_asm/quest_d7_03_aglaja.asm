...
// @pool_raw:
// @pool_encoding:utf8
...
0x70: Stack[-1] = "Isee" // @poff=89
0x71: Call2 0xb2

0x72: Pop(1)
0x73: Push((int) 533268)
0x74: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x75: Pop(1)
0x76: @@@ ClearReplies(); Obj=0 // @poff=110
0x77: Pop(0)
...
0x7f: Stack[-1] = "Neutral" // @poff=132
0x80: Call2 0xb2

0x81: Pop(1)
0x82: Push((int) 533273)
0x83: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x84: Pop(1)
0x85: @@@ ClearReplies(); Obj=0 // @poff=110
0x86: Pop(0)
...
0x8d: Push((int) -1)
0x8e: Push((int) 36185)
0x8f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x90: Pop(3)
0x91: GOTO 0x94
...
0x128: Stack[-1] = "Isee" // @poff=89
0x129: Call2 0xb2

0x12a: Pop(1)
0x12b: Push((int) 533268)
0x12c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x12d: Pop(1)
0x12e: @@@ ClearReplies(); Obj=0 // @poff=110
0x12f: Pop(0)
0x130: Push((int) 534543)
0x131: Push((int) 36176)
0x132: Push((int) 36175)
0x133: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x134: Pop(3)
0x135: Return(); Pop(0)

0x136: PushEmpty(string)
0x137: Stack[-1] = "Neutral" // @poff=132
0x138: Call2 0xb2

0x139: Pop(1)
0x13a: Push((int) 533273)
0x13b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x13c: Pop(1)
0x13d: @@@ ClearReplies(); Obj=0 // @poff=110
0x13e: Pop(0)
0x13f: Push((int) 533274)
0x140: Push((int) -1)
0x141: Push((int) 34788)
0x142: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x143: Pop(3)
0x144: Push((int) 534553)
0x145: Push((int) -1)
0x146: Push((int) 36185)
0x147: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x148: Pop(3)
0x149: Return(); Pop(0)
...
0x14e: Stack[-1] = "Isee" // @poff=89
0x14f: Call2 0xb2

0x150: Pop(1)
0x151: Push((int) 534544)
0x152: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x153: Pop(1)
0x154: @@@ ClearReplies(); Obj=0 // @poff=110
0x155: Pop(0)
0x156: Push((int) 534545)
0x157: Push((int) 36178)
0x158: Push((int) 36177)
0x159: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x15a: Pop(3)
0x15b: Return(); Pop(0)
...
0x160: Stack[-1] = "Isee" // @poff=89
0x161: Call2 0xb2

0x162: Pop(1)
0x163: Push((int) 534546)
0x164: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x165: Pop(1)
0x166: @@@ ClearReplies(); Obj=0 // @poff=110
0x167: Pop(0)
0x168: Push((int) 534547)
0x169: Push((int) 36180)
0x16a: Push((int) 36179)
0x16b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x16c: Pop(3)
0x16d: Push((int) 535169)
0x16e: Push((int) 36835)
0x16f: Push((int) 36834)
0x170: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x171: Pop(3)
0x172: Return(); Pop(0)
...
0x177: Stack[-1] = "Neutral" // @poff=132
0x178: Call2 0xb2

0x179: Pop(1)
0x17a: Push((int) 535170)
0x17b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x17c: Pop(1)
0x17d: @@@ ClearReplies(); Obj=0 // @poff=110
0x17e: Pop(0)
0x17f: Push((int) 535171)
0x180: Push((int) 36180)
0x181: Push((int) 36836)
0x182: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x183: Pop(3)
0x184: Return(); Pop(0)
...
0x189: Stack[-1] = "Isee" // @poff=89
0x18a: Call2 0xb2

0x18b: Pop(1)
0x18c: Push((int) 534548)
0x18d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x18e: Pop(1)
0x18f: @@@ ClearReplies(); Obj=0 // @poff=110
0x190: Pop(0)
0x191: Push((int) 534549)
0x192: Push((int) 36182)
0x193: Push((int) 36181)
0x194: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x195: Pop(3)
0x196: Return(); Pop(0)
...
0x19b: Stack[-1] = "Threat" // @poff=166
0x19c: Call2 0xb2

0x19d: Pop(1)
0x19e: Push((int) 534550)
0x19f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1a0: Pop(1)
0x1a1: @@@ ClearReplies(); Obj=0 // @poff=110
0x1a2: Pop(0)
0x1a3: Push((int) 534551)
0x1a4: Push((int) 36841)
0x1a5: Push((int) 36183)
0x1a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1a7: Pop(3)
...
0x1b2: Stack[-1] = "Neutral" // @poff=132
0x1b3: Call2 0xb2

0x1b4: Pop(1)
0x1b5: Push((int) 535173)
0x1b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1b7: Pop(1)
0x1b8: @@@ ClearReplies(); Obj=0 // @poff=110
0x1b9: Pop(0)
0x1ba: Push((int) 535174)
0x1bb: Push((int) 36184)
0x1bc: Push((int) 36840)
0x1bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1be: Pop(3)
0x1bf: Return(); Pop(0)
...
0x1c4: Stack[-1] = "Threat" // @poff=166
0x1c5: Call2 0xb2

0x1c6: Pop(1)
0x1c7: Push((int) 535175)
0x1c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x1c9: Pop(1)
0x1ca: @@@ ClearReplies(); Obj=0 // @poff=110
0x1cb: Pop(0)
0x1cc: Push((int) 535176)
0x1cd: Push((int) 36184)
0x1ce: Push((int) 36842)
0x1cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1d0: Pop(3)
...
0x1e0: Stack[-1] = "Neutral" // @poff=132
0x1e1: Call2 0xb2
...
0x1f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1f1: Pop(3)
0x1f2: Push((int) 533271)
0x1f3: Push((int) -1)
0x1f4: Push((int) 34785)
0x1f5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1f6: Pop(3)
0x1f7: Push((int) 533272)
0x1f8: Push((int) -1)
0x1f9: Push((int) 34786)
0x1fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x1fb: Pop(3)
0x1fc: Return(); Pop(0)
...
0x252: Stack[-3] = Stack[-1]
0x253: Call2 0x349

0x254: Stack[-2] = Stack[-5]
0x255: Pop(2)
0x256: Return(); Pop(2)

0x257: Stack[-1] = 0
0x258: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x259: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x25a: @ RotateAsync(Stack[-2], Stack[-1])
0x25b: Pop(2)
0x25c: Return(); Pop(0)

0x25d: PushEmpty(object, bool, object, bool)
0x25e: Push("player") // @poff=212
...
0x2bb: Stack[-1] = "Neutral" // @poff=132
0x2bc: Call2 0x438
...
0x2ca: Stack[-1] = "Neutral" // @poff=132
0x2cb: Call2 0x438
...
0x2e1: Stack[-1] = "Neutral" // @poff=132
0x2e2: Call2 0x438
...
0x315: Stack[-3] = (int) 0
0x316: Push("all") // @poff=148
0x317: PushEmpty(string, int)
0x318: Stack[-6] = Stack[-1]
0x319: Call2 0x4c3
...
0x339: Pop(0)
0x33a: @@ GetPosition(Stack[-2]); Obj=7 // @poff=226
0x33b: Pop(0)
...
0x346: Pop(2)
0x347: Stack[-1] = Stack[-8]
0x348: Return(); Pop(6)

0x349: PushEmpty(cvector, cvector)
0x34a: @@ GetPosition(Stack[-1]); Obj=3 // @poff=226
0x34b: Pop(0)
0x34c: PushEmpty(bool, cvector)
0x34d: Stack[-3] = Stack[-1]
0x34e: Call2 0x33f

0x34f: Stack[-2] = Stack[-6]
0x350: Pop(2)
0x351: Return(); Pop(2)
...
0x358: @@ GetPosition(Stack[-8]); Obj=20 // @poff=226
0x359: Pop(0)
0x35a: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x35b: Pop(0)
...
0x3c7: Push("voice_common") // @poff=262
0x3c8: Push((int) 1)
...
0x3cf: Push("voice_common") // @poff=262
0x3d0: Push((int) 0)
...
0x3e2: Push("voice_common") // @poff=262
0x3e3: Push((int) 1)
...
0x3f0: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x3f1: Pop(1)
...
0x405: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x406: Pop(1)
...
0x40e: Push("d") // @poff=258
0x40f: PushEmpty(int)
0x410: Call2 0x4ba

0x411: Pop(0)
0x412: Pop(2); Push(Stack[-2] + Stack[-1]);
0x413: Push("m") // @poff=316
...
0x41b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=292
0x41c: Pop(1)
...
0x430: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=304
0x431: Pop(1)
...
0x443: Push("Can't find lsh animation : ") // @poff=320
...
0x452: Push("Can't find lsh animation : ") // @poff=320
...
0x476: Push((float)9.999999974752427e-07)
...
0x484: Pop(0)
0x485: @@ add(Stack[-4]); Obj=1 // @poff=376
0x486: Pop(0)
0x487: @@ add(Stack[-3]); Obj=1 // @poff=376
0x488: Pop(0)
0x489: Push((int) 3)
...
0x48f: @@ GetItemID(Stack[-3]); Obj=8 // @poff=380
0x490: Pop(0)
0x491: Push("Category") // @poff=390
0x492: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x493: Pop(1)
0x494: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=408
0x495: Pop(0)
0x496: Pop(0); Push((bool) Stack[-1] == 0)
0x497: IF (Stack[-1] == 0) GOTO 0x49b; Pop(1)

0x498: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=416
0x499: Pop(0)
0x49a: GOTO 0x4a0

0x49b: PushEmpty(int, int)
0x49c: Stack[-5] = Stack[-2]
0x49d: Stack[-9] = Stack[-1]
0x49e: Call2 0x482
...
0x4a3: Pop(0)
0x4a4: @@ SetItemName(Stack[-4]); Obj=1 // @poff=426
0x4a5: Pop(0)
0x4a6: PushEmpty(object, object, int)
0x4a7: Stack[-8] = Stack[-3]
...
0x4b0: Pop(0)
0x4b1: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x4d9: Stack[-2] = Stack[-5]
0x4da: Return(); Pop(4)

0x4db: PushEmpty()
0x4dc: Push("ood7AglajaPetr1") // @poff=438
0x4dd: Push((int) 1)
...
0x4e3: Stack[-2] = "quest_d7_03" // @poff=470
0x4e4: Stack[-1] = "remove_maria" // @poff=494
0x4e5: Call2 0x4ae
...
0x4ed: Stack[-2] = "quest_d7_03" // @poff=470
0x4ee: Stack[-1] = "completed" // @poff=520
0x4ef: Call2 0x4ae
...
0x4f2: PushEmpty()
0x4f3: Push("samopal is given") // @poff=540
0x4f4: @ Trace(Stack[-1])
0x4f5: Pop(1)
0x4f6: PushEmpty(object, string, int)
0x4f7: Stack[-5] = Stack[-3]
0x4f8: Stack[-2] = "Samopal" // @poff=574
0x4f9: Stack[-1] = (int) 1
0x4fa: Call2 0x4a1
...
0x4fd: PushEmpty()
0x4fe: Push("whitevaccine is given") // @poff=590
0x4ff: @ Trace(Stack[-1])
0x500: Pop(1)
0x501: PushEmpty(object, string, int)
0x502: Stack[-5] = Stack[-3]
0x503: Stack[-2] = "white_vaccine" // @poff=634
0x504: Stack[-1] = (int) 1
0x505: Call2 0x4a1
...
0x508: PushEmpty()
0x509: Push("feromicin is given") // @poff=662
0x50a: @ Trace(Stack[-1])
0x50b: Pop(1)
0x50c: PushEmpty(object, string, int)
0x50d: Stack[-5] = Stack[-3]
0x50e: Stack[-2] = "feromicin" // @poff=700
0x50f: Stack[-1] = (int) 1
0x510: Call2 0x4a1
...
0x513: PushEmpty()
0x514: Push("neomicin is given") // @poff=720
0x515: @ Trace(Stack[-1])
0x516: Pop(1)
0x517: PushEmpty(object, string, int)
0x518: Stack[-5] = Stack[-3]
0x519: Stack[-2] = "neomicin" // @poff=756
0x51a: Stack[-1] = (int) 1
0x51b: Call2 0x4a1
...
0x51e: PushEmpty()
0x51f: Push("samopal ammo5 is given") // @poff=774
0x520: @ Trace(Stack[-1])
0x521: Pop(1)
0x522: PushEmpty(object, string, int)
0x523: Stack[-5] = Stack[-3]
0x524: Stack[-2] = "samopal_ammo" // @poff=820
0x525: Stack[-1] = (int) 5
0x526: Call2 0x4a1
...
0x52b: Stack[-1] = "ood7AglajaPetr1" // @poff=438
0x52c: Call2 0x47d
...
0x55f: Push("Can't retrieve diary root") // @poff=858
0x560: @ Trace(Stack[-1])
0x561: Pop(1)
0x562: Stack[-3] = (bool) 0
0x563: Return(); Pop(2)

0x564: Stack[-1] = Stack[-3]
0x565: Return(); Pop(2)
...
0x56b: Pop(1)
0x56c: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=910
0x56d: Pop(0)
0x56e: Pop(0); Push((bool) Stack[-2] == 0)
0x56f: IF (Stack[-1] == 0) GOTO 0x576; Pop(1)

0x570: Push("Can't find diary parent with id: ") // @poff=915
...
0x576: @@ AddChild(Stack[-8]); Obj=2 // @poff=983
0x577: Pop(0)
0x578: Push((int) 7)
0x579: @ SendWorldWndMessage(Stack[-1])
0x57a: Pop(1)
0x57b: @@ GetCategory(Stack[-1]); Obj=8 // @poff=992
0x57c: Pop(0)
...
0x598: Stack[-1] = "ui/NPC_Aglaja.png" // @poff=1018
0x599: Return(); Pop(0)

0x59a: Stack[-1] = "ui/NPC_Aglaja_b.png" // @poff=1054
0x59b: Return(); Pop(0)
