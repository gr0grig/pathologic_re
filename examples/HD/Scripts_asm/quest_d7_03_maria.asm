...
// @pool_raw:
// @pool_encoding:utf8
...
0x9a: Push("all") // @poff=144
0x9b: Push("idle") // @poff=152
...
0xa3: Push("all") // @poff=144
0xa4: Push("idle") // @poff=152
...
0xd3: Stack[-1] = "Rage" // @poff=89
0xd4: Call2 0xa9

0xd5: Pop(1)
0xd6: Push((int) 533260)
0xd7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xd8: Pop(1)
0xd9: @@@ ClearReplies(); Obj=0 // @poff=110
0xda: Pop(0)
...
0xe1: Push((int) 34776)
0xe2: Push((int) 37465)
0xe3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xe4: Pop(3)
0xe5: Return(); Pop(0)

0xe6: PushEmpty(string)
0xe7: Stack[-1] = "Angry" // @poff=132
0xe8: Call2 0xa9

0xe9: Pop(1)
0xea: Push((int) 533258)
0xeb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0xec: Pop(1)
0xed: @@@ ClearReplies(); Obj=0 // @poff=110
0xee: Pop(0)
0xef: Push((int) 533259)
0xf0: Push((int) -1)
0xf1: Push((int) 34773)
0xf2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xf3: Pop(3)
0xf4: Push((int) 535778)
0xf5: Push((int) -1)
0xf6: Push((int) 37462)
0xf7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0xf8: Pop(3)
0xf9: Return(); Pop(0)
...
0xfe: Stack[-1] = "Angry" // @poff=132
0xff: Call2 0xa9

0x100: Pop(1)
0x101: Push((int) 533262)
0x102: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x103: Pop(1)
0x104: @@@ ClearReplies(); Obj=0 // @poff=110
0x105: Pop(0)
...
0x10e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x10f: Pop(3)
0x110: Return(); Pop(0)
...
0x115: Stack[-1] = "Angry" // @poff=132
0x116: Call2 0xa9

0x117: Pop(1)
0x118: Push((int) 535783)
0x119: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x11a: Pop(1)
0x11b: @@@ ClearReplies(); Obj=0 // @poff=110
0x11c: Pop(0)
...
0x127: Stack[-1] = "Angry" // @poff=132
0x128: Call2 0xa9

0x129: Pop(1)
0x12a: Push((int) 535776)
0x12b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x12c: Pop(1)
0x12d: @@@ ClearReplies(); Obj=0 // @poff=110
0x12e: Pop(0)
0x12f: Push((int) 535777)
0x130: Push((int) 37463)
0x131: Push((int) 37461)
0x132: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x133: Pop(3)
0x134: Return(); Pop(0)
...
0x139: Stack[-1] = "Staring" // @poff=162
0x13a: Call2 0xa9

0x13b: Pop(1)
0x13c: Push((int) 535779)
0x13d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=99
0x13e: Pop(1)
0x13f: @@@ ClearReplies(); Obj=0 // @poff=110
0x140: Pop(0)
0x141: Push((int) 535780)
0x142: Push((int) -1)
0x143: Push((int) 37464)
0x144: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=123
0x145: Pop(3)
...
0x194: @@ GetPosition(Stack[-8]); Obj=20 // @poff=210
0x195: Pop(0)
0x196: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=222
0x197: Pop(0)
...
0x203: Push("voice_common") // @poff=246
0x204: Push((int) 1)
...
0x20b: Push("voice_common") // @poff=246
0x20c: Push((int) 0)
...
0x21e: Push("voice_common") // @poff=246
0x21f: Push((int) 1)
...
0x22c: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=276
0x22d: Pop(1)
...
0x257: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=276
0x258: Pop(1)
...
0x26c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=288
0x26d: Pop(1)
0x26e: PushEmpty(bool, string)
0x26f: Stack[-3] = Stack[-1]
0x270: Call2 0x293

0x271: Stack[-2] = Stack[-14]
0x272: Pop(2)
0x273: Return(); Pop(10)
...
0x27f: Push("Can't find lsh animation : ") // @poff=304
...
0x28e: Push("Can't find lsh animation : ") // @poff=304
...
0x2b2: Push((float)9.999999974752427e-07)
...
0x2c7: PushEmpty()
0x2c8: Push("ood7MariaPetr1") // @poff=360
0x2c9: Push((int) 1)
...
0x2cf: Stack[-1] = "ood7MariaPetr1" // @poff=360
0x2d0: Call2 0x2b9
...
0x2ee: Stack[-1] = "ui/NPC_Maria.png" // @poff=404
0x2ef: Return(); Pop(0)

0x2f0: Stack[-1] = "ui/NPC_Maria_b.png" // @poff=438
0x2f1: Return(); Pop(0)
