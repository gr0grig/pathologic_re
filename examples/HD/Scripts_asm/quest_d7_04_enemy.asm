...
Strings:
	...
	W:im_inc
	W:hl_inc
// @pool_raw:
...
Events:
EVENT_26 Op = 0xc54 Vars = (string)
EVENT_22 Op = 0xdbf Vars = (object, int, float, float)
EVENT_43 Op = 0xdc7 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xdd1 Vars = (object, string)
...
0xa8d: Pop(0)
0xa8e: Stack[-1] = Stack[-4]
0xa8f: Return(); Pop(2)

0xa90: PushEmpty(bool, bool)
0xa91: Push("HasProperty") // @poff=664
0xa92: Push((int) 2)
...
0xa98: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=688
0xa99: Pop(0)
...
0xa9e: Stack[-18] = Stack[-2]
0xa9f: Stack[-1] = "health" // @poff=700
0xaa0: Call2 0xa90
...
0xaa7: Stack[-18] = Stack[-2]
0xaa8: Stack[-1] = "armor" // @poff=714
0xaa9: Call2 0xa90
...
0xaaf: Push("armor") // @poff=714
0xab0: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=726
0xab1: Pop(1)
0xab2: Push("armor_") // @poff=738
0xab3: PushEmpty(string, int)
0xab4: Stack[-16] = Stack[-1]
0xab5: Call2 0xa76

0xab6: Pop(1)
0xab7: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xab8: PushEmpty(bool, object, string)
0xab9: Stack[-18] = Stack[-2]
0xaba: Stack[-8] = Stack[-1]
0xabb: Call2 0xa90
...
0xac1: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=726
0xac2: Pop(0)
...
0xac9: Stack[-3] = Stack[-6]
0xaca: Pop(3)
0xacb: Push("health") // @poff=700
0xacc: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=726
0xacd: Pop(1)
0xace: Push((int) 1)
0xacf: Pop(1); Push(Stack[-1] - Stack[-4]);
0xad0: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0xad1: Push("health") // @poff=700
...
0xad7: Pop(3)
0xad8: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=752
0xad9: Pop(2)
0xada: PushEmpty(bool, object)
0xadb: Stack[-17] = Stack[-1]
0xadc: Call2 0xa8b
...
0xae2: Pop(1)
0xae3: Stack[-1] = Stack[-16]
0xae4: Return(); Pop(12)

0xae5: PushEmpty(bool, bool)
0xae6: @@ IsDead(Stack[-1]); Obj=3 // @poff=764
0xae7: Pop(0)
0xae8: Stack[-1] = Stack[-4]
0xae9: Return(); Pop(2)

0xaea: PushEmpty(object, object, object, object)
0xaeb: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0xaff: Pop(0)
0xb00: Pop(0); PushNull((bool) Stack[-2] == 0)
0xb01: IF (Stack[-1] == 0) GOTO 0xb04; Pop(1)

0xb02: Stack[-6] = (bool) 0
0xb03: Return(); Pop(4)

0xb04: @@ GetScene(Stack[-1]); Obj=5 // @poff=785
0xb05: Pop(0)
...
0xb18: Stack[-6] = Stack[-2]
0xb19: Stack[-1] = "noaccess" // @poff=794
0xb1a: Call2 0xa90
...
0xb20: Push("noaccess") // @poff=794
0xb21: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=726
0xb22: Pop(1)
0xb23: Push((int) 0)
...
0xb27: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0xb35: @@ GetPosition(Stack[-5]); Obj=15 // @poff=43
0xb36: Pop(0)
...
0xb46: Stack[-1] = "fhit" // @poff=812
0xb47: GOTO 0xb49

0xb48: Stack[-1] = "bhit" // @poff=822
0xb49: Push("hit_react") // @poff=832
0xb4a: Push("1") // @poff=852
0xb4b: Pop(1); Push(Stack[-3] + Stack[-1]);
0xb4c: Push("2") // @poff=856
...
0xb6a: Stack[-2] = Stack[-11]
0xb6b: Pop(2)
0xb6c: @ CreateVectorVector(Stack[-8])
0xb6d: Pop(0)
0xb6e: Stack[-7] = (int) 1
0xb6f: Push("hit") // @poff=814
...
0xb84: Pop(0)
0xb85: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=869
0xb86: Pop(0)
0xb87: PushEmpty(object, int, float, cvector, cvector)
0xb88: Stack[-26] = Stack[-5]
0xb89: Stack[-25] = Stack[-4]
0xb8a: Stack[-24] = Stack[-3]
...
0xba5: @@ GetPosition(Stack[-3]); Obj=7 // @poff=43
0xba6: Pop(0)
...
0xbb1: Pop(0)
0xbb2: Stack[-1] = Stack[-3]
0xbb3: Return(); Pop(2)

0xbb4: PushEmpty(float, cvector, float, cvector)
0xbb5: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=600
0xbb6: Pop(0)
...
0xbbb: Push("head") // @poff=428
0xbbc: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0xbbd: Pop(1)
0xbbe: Return(); Pop(4)

0xbbf: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0xbc0: @ IsExisting3DSound(Stack[-8], Stack[-17])
0xbc1: Pop(0)
0xbc2: Pop(0); Push((bool) Stack[-8] == 0)
0xbc3: IF (Stack[-1] == 0) GOTO 0xbd8; Pop(1)

0xbc4: Stack[-7] = (int) 0
0xbc5: Push((int) 1)
0xbc6: Pop(1); Push(Stack[-8] + Stack[-1]);
0xbc7: Pop(1); Push(Stack[-18] + Stack[-1]);
0xbc8: @ IsExisting3DSound(Stack[-7], Stack[-1])
0xbc9: Pop(1)
0xbca: Pop(0); Push((bool) Stack[-6] == 0)
0xbcb: IF (Stack[-1] == 0) GOTO 0xbcd; Pop(1)

0xbcc: GOTO 0xbd0

0xbcd: Push((int) 1)
0xbce: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0xbcf: GOTO 0xbc5

0xbd0: Pop(0); Push((bool) Stack[-7] == 0)
0xbd1: IF (Stack[-1] == 0) GOTO 0xbd3; Pop(1)

0xbd2: Return(); Pop(16)

0xbd3: @ irand(Stack[-5], Stack[-7])
0xbd4: Pop(0)
0xbd5: Push((int) 1)
0xbd6: Pop(1); Push(Stack[-6] + Stack[-1]);
0xbd7: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0xbd8: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0xbd9: Pop(0)
0xbda: Push(Stack[-4])
0xbdb: IF (Stack[-1] == 0) GOTO 0xbe7; Pop(1)

0xbdc: @ GetEyesHeight(Stack[-3])
0xbdd: Pop(0)
0xbde: @ GetDirection(Stack[-2])
0xbdf: Pop(0)
0xbe0: Push((int) 50)
0xbe1: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0xbe2: Push(CvectorIndex(Stack[-1], 1))
0xbe3: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0xbe4: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xbe5: @ PlayGlobalSound(Stack[-17], Stack[-1])
0xbe6: Pop(0)
0xbe7: Return(); Pop(16)
...
0xbed: Stack[-1] = 0
0xbee: PushEmpty(float, float)
0xbef: Pop(0); Push(Stack[-3] | Stack[-3]);
0xbf0: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xbf1: Push((float)9.999999974752427e-07)
0xbf2: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xbf3: IF (Stack[-1] == 0) GOTO 0xbf6; Pop(1)

0xbf4: Stack[-4] = CVector(0.0, 0.0, 0.0)
0xbf5: Return(); Pop(2)

0xbf6: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xbf7: Return(); Pop(2)

0xbf8: PushEmpty()
0xbf9: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0xbfa: IF (Stack[-1] == 0) GOTO 0xbfd; Pop(1)

0xbfb: Stack[-2] = Stack[-3]
0xbfc: GOTO 0xbfe

0xbfd: Stack[-1] = Stack[-3]
0xbfe: Return(); Pop(0)

0xbff: PushEmpty()
0xc00: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xc01: IF (Stack[-1] == 0) GOTO 0xc04; Pop(1)

0xc02: Stack[-2] = Stack[-4]
0xc03: Return(); Pop(0)

0xc04: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xc05: IF (Stack[-1] == 0) GOTO 0xc08; Pop(1)

0xc06: Stack[-1] = Stack[-4]
0xc07: Return(); Pop(0)

0xc08: Stack[-3] = Stack[-4]
0xc09: Return(); Pop(0)

0xc0a: PushEmpty(float, float)
0xc0b: @ rand(Stack[-1])
0xc0c: Pop(0)
0xc0d: Stack[-4] = Stack[-1] < Stack[-3]; Pop(0);
0xc0e: Return(); Pop(2)

0xc0f: PushEmpty(object, object)
0xc10: @ CreateFloatVector(Stack[-1])
0xc11: Pop(0)
0xc12: @@ add(Stack[-3]); Obj=1 // @poff=860
0xc13: Pop(0)
0xc14: Push((int) 0)
0xc15: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0xc16: IF (Stack[-1] == 0) GOTO 0xc1b; Pop(1)

0xc17: Push((float)0.699999988079071)
0xc18: Push((int) 500)
0xc19: @ RumblePlay(Stack[-2], Stack[-1])
0xc1a: Pop(2)
0xc1b: Push((int) 15)
0xc1c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc1d: Pop(1)
0xc1e: Return(); Pop(2)

0xc1f: Stack[-1] = 0
0xc20: PushEmpty(bool, bool)
0xc21: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc22: Pop(0)
0xc23: Push(Stack[-1])
0xc24: IF (Stack[-1] == 0) GOTO 0xc28; Pop(1)

0xc25: Push("attack") // @poff=186
0xc26: @ PlayGlobalMusic(Stack[-1])
0xc27: Pop(1)
0xc28: Return(); Pop(2)

0xc29: PushEmpty(string, string)
0xc2a: Stack[-1] = "idle" // @poff=919
0xc2b: Push(Stack[-3])
0xc2c: IF (Stack[-1] == 0) GOTO 0xc2e; Pop(1)

0xc2d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xc2e: Stack[-1] = Stack[-4]
0xc2f: Return(); Pop(2)

0xc30: PushEmpty(int, bool, int, bool)
0xc31: Stack[-2] = (int) 0
0xc32: Push("all") // @poff=214
0xc33: PushEmpty(string, int)
0xc34: Stack[-5] = Stack[-1]
0xc35: Call2 0xc29

0xc36: Pop(1)
0xc37: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xc38: Pop(2)
0xc39: Pop(0); Push((bool) Stack[-1] == 0)
0xc3a: IF (Stack[-1] == 0) GOTO 0xc3c; Pop(1)

0xc3b: GOTO 0xc3f

0xc3c: Push((int) 1)
0xc3d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xc3e: GOTO 0xc32

0xc3f: Stack[-2] = Stack[-5]
0xc40: Return(); Pop(4)

0xc41: PushEmpty(int, int)
0xc42: Push("branch") // @poff=929
0xc43: @ GetVariable(Stack[-1], Stack[-2])
0xc44: Pop(1)
...
0xc4d: IF (Stack[-1] == 0) GOTO 0xc51; Pop(1)

0xc4e: @ WorkWithCorpse(Stack[-1])
0xc4f: Pop(0)
0xc50: GOTO 0xc53

0xc51: @ Barter(Stack[-1])
0xc52: Pop(0)
0xc53: Return(); Pop(0)

0xc54: PushEmpty()
0xc55: Push("cleanup") // @poff=614
0xc56: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xc57: IF (Stack[-1] == 0) GOTO 0xc5b; Pop(1)

0xc58: Push(GlobalVars[0])
0xc59: Stack[-1] = (bool) 1
0xc5a: GlobalVars[0] = Stack[-1]; Pop(1)
0xc5b: Return(); Pop(0)

0xc5c: PushEmpty(cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float)
0xc5d: PushEmpty(object)
0xc5e: Call2 0xbe8

0xc5f: Pop(0)
0xc60: Pop(1); Push((bool) Stack[-19] == Stack[-1])
0xc61: IF (Stack[-1] == 0) GOTO 0xc64; Pop(1)

0xc62: Stack[-19] = (bool) 0
0xc63: Return(); Pop(16)
...
0xc73: Pop(0)
0xc74: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc75: IF (Stack[-1] == 0) GOTO 0xc87; Pop(1)

0xc76: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xc77: Pop(0)
0xc78: @ GetPosition(Stack[-7])
0xc79: Pop(0)
0xc7a: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0xc7b: Stack[-5] = Stack[-6] | Stack[-6]; Pop(0);
0xc7c: Push((float)4000000.0)
0xc7d: Pop(1); Push((bool) Stack[-6] < Stack[-1])
0xc7e: IF (Stack[-1] == 0) GOTO 0xc86; Pop(1)

0xc7f: PushEmpty(bool, object)
0xc80: Stack[-20] = Stack[-1]
0xc81: Call2 0xd70

0xc82: Pop(1)
0xc83: IF (Stack[-1] == 0) GOTO 0xc86; Pop(1)

0xc84: Stack[-19] = (bool) 1
0xc85: Return(); Pop(16)

0xc86: GOTO 0xca4

0xc87: Push("player_shot") // @poff=943
0xc88: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xc89: IF (Stack[-1] == 0) GOTO 0xca4; Pop(1)

0xc8a: @@ GetPosition(Stack[-4]); Obj=18 // @poff=43
0xc8b: Pop(0)
0xc8c: @ GetPosition(Stack[-3])
0xc8d: Pop(0)
0xc8e: Stack[-2] = Stack[-4] - Stack[-3]; Pop(0);
0xc8f: Stack[-1] = Stack[-2] | Stack[-2]; Pop(0);
0xc90: Push((float)360000.0)
0xc91: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc92: IF (Stack[-1] == 0) GOTO 0xc9a; Pop(1)

0xc93: PushEmpty(bool, object)
0xc94: Stack[-20] = Stack[-1]
0xc95: Call2 0xd70
...
0xc9a: Push((float)12250000.0)
0xc9b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc9c: IF (Stack[-1] == 0) GOTO 0xca4; Pop(1)

0xc9d: PushEmpty(bool, object)
0xc9e: Stack[-20] = Stack[-1]
0xc9f: Call2 0xd4c

0xca0: Pop(1)
0xca1: IF (Stack[-1] == 0) GOTO 0xca4; Pop(1)

0xca2: Stack[-19] = (bool) 1
0xca3: Return(); Pop(16)

0xca4: Stack[-19] = (bool) 0
0xca5: Return(); Pop(16)

0xca6: PushEmpty()
0xca7: PushEmpty(bool)
0xca8: Stack[-1] = (bool) 0
0xca9: Push("IsDead") // @poff=771
0xcaa: Push((int) 1)
0xcab: Pop(2); Push(IsFuncExist(Stack[-4], Stack[-2], Stack[-1]))
0xcac: IF (Stack[-1] == 0) GOTO 0xcb3; Pop(1)

0xcad: PushEmpty(bool, object)
0xcae: Stack[-4] = Stack[-1]
0xcaf: Call2 0xae5

0xcb0: Pop(1)
0xcb1: IF (Stack[-1] == 0) GOTO 0xcb3; Pop(1)

0xcb2: Stack[-1] = (bool) 1
0xcb3: IF (Stack[-1] == 0) GOTO 0xccc; Pop(1)

0xcb4: PushEmpty(bool, object, string)
0xcb5: Stack[-4] = Stack[-2]
0xcb6: PushEmpty(string)
0xcb7: Call2 0xdea

0xcb8: Stack[-1] = Stack[-2]
0xcb9: Pop(1)
0xcba: Call2 0xa90
...
0xcc1: Pop(0)
0xcc2: Push((int) 1)
0xcc3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=752
0xcc4: Pop(2)
0xcc5: PushEmpty(bool, object)
0xcc6: Stack[-3] = Stack[-1]
0xcc7: Call2 0xd3a
...
0xccd: Stack[-3] = Stack[-1]
0xcce: Call2 0xa8b

0xccf: Pop(1)
0xcd0: IF (Stack[-1] == 0) GOTO 0xcd7; Pop(1)

0xcd1: PushEmpty(bool, object)
0xcd2: Stack[-3] = Stack[-1]
0xcd3: Call2 0xd70
...
0xce0: Stack[-3] = Stack[-1]
0xce1: Call2 0xd5e

0xce2: Stack[-2] = Stack[-4]
0xce3: Pop(2)
0xce4: Return(); Pop(0)

0xce5: Stack[-2] = (bool) 0
0xce6: Return(); Pop(0)

0xce7: PushEmpty(object, cvector, cvector, cvector, bool, float, int, object, cvector, cvector, cvector, bool, float, int)
0xce8: @ GetMainOutdoorScene(Stack[-7])
0xce9: Pop(0)
0xcea: @ GetPosition(Stack[-6])
0xceb: Pop(0)
0xcec: Stack[-2] = (int) 4000000
0xced: Stack[-1] = (int) 0
0xcee: Push(GlobalVars[1])
0xcef: Stack[-1] = (int) 0
0xcf0: GlobalVars[1] = Stack[-1]; Pop(1)
0xcf1: Push((bool) 1)
0xcf2: IF (Stack[-1] == 0) GOTO 0xd04; Pop(1)

0xcf3: PushEmpty(string)
0xcf4: Call2 0xde6

0xcf5: Pop(0)
0xcf6: Push(GlobalVars[1])
0xcf7: Push((int) 1)
0xcf8: Pop(2); Push(Stack[-2] + Stack[-1]);
0xcf9: Pop(2); Push(Stack[-2] + Stack[-1]);
0xcfa: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xcfb: Pop(1)
...
0xcff: Push(GlobalVars[1])
0xd00: Push((int) 1)
0xd01: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xd02: GlobalVars[1] = Stack[-1]; Pop(1)
0xd03: GOTO 0xcf1

0xd04: Push("Pantrol point count: ") // @poff=967
0xd05: Push(GlobalVars[1])
0xd06: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd07: @ Trace(Stack[-1])
0xd08: Pop(1)
0xd09: Stack[-15] = (bool) 1
0xd0a: Return(); Pop(14)

0xd0b: Stack[-7] = 0
0xd0c: PushEmpty()
0xd0d: Push(GlobalVars[2])
0xd0e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd0f: IF (Stack[-1] == 0) GOTO 0xd12; Pop(1)

0xd10: Stack[-2] = (bool) 0
0xd11: Return(); Pop(0)

0xd12: Push((int) 0)
0xd13: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd14: IF (Stack[-1] == 0) GOTO 0xd1e; Pop(1)

0xd15: Push(GlobalVars[3])
0xd16: Push(GlobalVars[2])
0xd17: Stack[-1] = Stack[-2]
0xd18: Pop(1)
0xd19: GlobalVars[3] = Stack[-1]; Pop(1)
0xd1a: Push("changing state to c_iStateWaitForLoad") // @poff=1011
0xd1b: @ Trace(Stack[-1])
0xd1c: Pop(1)
0xd1d: GOTO 0xd35
...
0xd20: IF (Stack[-1] == 0) GOTO 0xd25; Pop(1)

0xd21: Push("changing state to c_iStateHeatHands") // @poff=1087
0xd22: @ Trace(Stack[-1])
0xd23: Pop(1)
0xd24: GOTO 0xd35

0xd25: Push((int) 2)
0xd26: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd27: IF (Stack[-1] == 0) GOTO 0xd2c; Pop(1)

0xd28: Push("changing state to c_iStateIdle") // @poff=1159
0xd29: @ Trace(Stack[-1])
0xd2a: Pop(1)
0xd2b: GOTO 0xd35
...
0xd2f: Push("changing state to c_iStatePatrol") // @poff=1221
0xd30: @ Trace(Stack[-1])
0xd31: Pop(1)
0xd32: GOTO 0xd35
...
0xd35: Push(GlobalVars[2])
0xd36: Stack[-2] = Stack[-1]
0xd37: GlobalVars[2] = Stack[-1]; Pop(1)
0xd38: Stack[-2] = (bool) 1
0xd39: Return(); Pop(0)

0xd3a: PushEmpty()
0xd3b: Push(GlobalVars[2])
0xd3c: Push((int) 4)
0xd3d: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd3e: IF (Stack[-1] == 0) GOTO 0xd41; Pop(1)

0xd3f: Stack[-2] = (bool) 0
0xd40: Return(); Pop(0)

0xd41: Push(GlobalVars[2])
0xd42: Stack[-1] = (int) 4
0xd43: GlobalVars[2] = Stack[-1]; Pop(1)
0xd44: Push("changing state to c_iStateAware") // @poff=1287
0xd45: @ Trace(Stack[-1])
0xd46: Pop(1)
0xd47: Push(GlobalVars[4])
0xd48: Stack[-2] = Stack[-1]
0xd49: GlobalVars[4] = Stack[-1]; Pop(1)
0xd4a: Stack[-2] = (bool) 1
0xd4b: Return(); Pop(0)

0xd4c: PushEmpty()
0xd4d: Push(GlobalVars[2])
0xd4e: Push((int) 5)
0xd4f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd50: IF (Stack[-1] == 0) GOTO 0xd53; Pop(1)

0xd51: Stack[-2] = (bool) 0
0xd52: Return(); Pop(0)

0xd53: Push(GlobalVars[2])
0xd54: Stack[-1] = (int) 5
0xd55: GlobalVars[2] = Stack[-1]; Pop(1)
0xd56: Push("changing state to c_iStateSearchEnemy") // @poff=1351
0xd57: @ Trace(Stack[-1])
0xd58: Pop(1)
0xd59: Push(GlobalVars[5])
0xd5a: Stack[-2] = Stack[-1]
0xd5b: GlobalVars[5] = Stack[-1]; Pop(1)
0xd5c: Stack[-2] = (bool) 1
0xd5d: Return(); Pop(0)

0xd5e: PushEmpty()
0xd5f: Push(GlobalVars[2])
0xd60: Push((int) 6)
0xd61: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd62: IF (Stack[-1] == 0) GOTO 0xd65; Pop(1)

0xd63: Stack[-2] = (bool) 0
0xd64: Return(); Pop(0)

0xd65: Push(GlobalVars[2])
0xd66: Stack[-1] = (int) 6
0xd67: GlobalVars[2] = Stack[-1]; Pop(1)
0xd68: Push("changing state to c_iStateHearEnemy") // @poff=1427
0xd69: @ Trace(Stack[-1])
0xd6a: Pop(1)
0xd6b: Push(GlobalVars[6])
0xd6c: Stack[-2] = Stack[-1]
0xd6d: GlobalVars[6] = Stack[-1]; Pop(1)
0xd6e: Stack[-2] = (bool) 1
0xd6f: Return(); Pop(0)

0xd70: PushEmpty()
0xd71: Push(GlobalVars[2])
0xd72: Push((int) 7)
0xd73: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd74: IF (Stack[-1] == 0) GOTO 0xd77; Pop(1)

0xd75: Stack[-2] = (bool) 0
0xd76: Return(); Pop(0)

0xd77: Push(GlobalVars[2])
0xd78: Stack[-1] = (int) 7
0xd79: GlobalVars[2] = Stack[-1]; Pop(1)
0xd7a: Push("changing state to c_iStateAttack") // @poff=1499
0xd7b: @ Trace(Stack[-1])
0xd7c: Pop(1)
0xd7d: Push(GlobalVars[7])
0xd7e: Stack[-2] = Stack[-1]
0xd7f: GlobalVars[7] = Stack[-1]; Pop(1)
...
0xd85: Pop(0)
0xd86: Push("_locked") // @poff=1565
0xd87: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd88: @ GetVariable(Stack[-1], Stack[-2])
0xd89: Pop(1)
0xd8a: Push((int) 0)
0xd8b: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0xd8c: Return(); Pop(2)
...
0xd90: Pop(0)
0xd91: Push("_locked") // @poff=1565
0xd92: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd93: Push(Stack[-2])
...
0xd9b: PushEmpty(int, int)
0xd9c: PushEmpty(string)
0xd9d: Call2 0xde6

0xd9e: Pop(0)
0xd9f: Push("_locked") // @poff=1565
...
0xda5: Pop(0)
0xda6: Stack[-4] = Stack[-2] >= Stack[-1]; Pop(1);
0xda7: Return(); Pop(2)
...
0xdab: Pop(0)
0xdac: Push("_locked") // @poff=1565
0xdad: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdae: @ GetVariable(Stack[-1], Stack[-2])
0xdaf: Pop(1)
0xdb0: Push(Stack[-3])
0xdb1: IF (Stack[-1] == 0) GOTO 0xdb5; Pop(1)

0xdb2: Push((int) 1)
0xdb3: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdb4: GOTO 0xdb7

0xdb5: Push((int) -1)
0xdb6: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdb7: PushEmpty(string)
0xdb8: Call2 0xde6

0xdb9: Pop(0)
0xdba: Push("_locked") // @poff=1565
0xdbb: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdbc: @ SetVariable(Stack[-1], Stack[-2])
0xdbd: Pop(1)
0xdbe: Return(); Pop(2)

0xdbf: PushEmpty()
0xdc0: PushEmpty(object, int, float)
0xdc1: Stack[-7] = Stack[-3]
0xdc2: Stack[-6] = Stack[-2]
0xdc3: Stack[-5] = Stack[-1]
0xdc4: Call2 0xb52
...
0xdc7: PushEmpty()
0xdc8: PushEmpty(object, int, float, cvector, cvector)
0xdc9: Stack[-11] = Stack[-5]
0xdca: Stack[-10] = Stack[-4]
0xdcb: Stack[-9] = Stack[-3]
0xdcc: Stack[-7] = Stack[-2]
0xdcd: Stack[-6] = Stack[-1]
0xdce: Call2 0xb96

0xdcf: Pop(5)
0xdd0: Return(); Pop(0)

0xdd1: PushEmpty(float, float)
0xdd2: Push("health") // @poff=700
0xdd3: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xdd4: IF (Stack[-1] == 0) GOTO 0xddd; Pop(1)

0xdd5: Push("health") // @poff=700
0xdd6: @ GetProperty(Stack[-1], Stack[-2])
0xdd7: Pop(1)
0xdd8: Push((int) 0)
0xdd9: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xdda: IF (Stack[-1] == 0) GOTO 0xddd; Pop(1)

0xddb: @ SignalDeath(Stack[-4])
0xddc: Pop(0)
0xddd: Return(); Pop(2)

0xdde: PushEmpty()
0xddf: PushEmpty(object)
0xde0: Stack[-2] = Stack[-1]
0xde1: Push(-1, 0); TaskCall(8)
0xde2: Call2 0x99e

0xde3: Pop(-1, 0); TaskReturn
0xde4: Pop(1)
0xde5: Return(); Pop(0)

0xde6: Stack[-1] = "pt_d7q04_patrol" // @poff=1581
0xde7: Return(); Pop(0)

0xde8: Stack[-1] = "d7q04_helpme" // @poff=1613
0xde9: Return(); Pop(0)

0xdea: Stack[-1] = "d7q04_corpse" // @poff=1639
0xdeb: Return(); Pop(0)

0xdec: Stack[-1] = "pt_d7q04_bonfire" // @poff=1665
0xded: Return(); Pop(0)

0xdee: Stack[-1] = (int) 3
0xdef: Return(); Pop(0)

0xdf0: PushEmpty(object, float, float, bool, object, float, float, bool)
0xdf1: @ CreateInvItem(Stack[-4])
0xdf2: Pop(0)
0xdf3: Push((int) 40)
0xdf4: Push((int) 80)
0xdf5: @ rand(Stack[-5], Stack[-2], Stack[-1])
0xdf6: Pop(2)
0xdf7: Push((int) 5)
0xdf8: Push((int) 20)
0xdf9: @ rand(Stack[-4], Stack[-2], Stack[-1])
0xdfa: Pop(2)
0xdfb: Push("grass_combination") // @poff=1699
0xdfc: @@ SetItemName(Stack[-1]); Obj=5 // @poff=1735
0xdfd: Pop(1)
0xdfe: Push("im_inc") // @poff=1747
0xdff: Push((float)100.0)
0xe00: Pop(1); Push(Stack[-5] / Stack[-1]);
0xe01: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=752
0xe02: Pop(2)
0xe03: Push("hl_inc") // @poff=1761
0xe04: Push((float)100.0)
0xe05: Pop(1); Push(Stack[-4] / Stack[-1]);
0xe06: Pop(1); Push(( -Stack[-1])
0xe07: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=752
0xe08: Pop(2)
0xe09: Push((int) 0)
0xe0a: Push((int) 1)
0xe0b: @ AddItem(Stack[-3], Stack[-6], Stack[-2], Stack[-1])
0xe0c: Pop(2)
0xe0d: Return(); Pop(8)
