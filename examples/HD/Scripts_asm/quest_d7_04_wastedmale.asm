...
// @pool_raw:
// @pool_encoding:utf8
...
0x18b: Stack[-8] = Stack[-2]
0x18c: Stack[-7] = Stack[-1]
0x18d: Call2 0x1c5
...
0x2d9: Push("Can't find lsh animation : ") // @poff=222
...
0x2e8: Push("Can't find lsh animation : ") // @poff=222
...
0x308: Push((float)9.999999974752427e-07)
...
0x316: Pop(0)
0x317: @@ add(Stack[-4]); Obj=1 // @poff=278
0x318: Pop(0)
0x319: @@ add(Stack[-3]); Obj=1 // @poff=278
0x31a: Pop(0)
0x31b: Push((int) 3)
...
0x321: @@ GetItemID(Stack[-3]); Obj=8 // @poff=282
0x322: Pop(0)
0x323: Push("Category") // @poff=292
0x324: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x325: Pop(1)
0x326: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=310
0x327: Pop(0)
0x328: Pop(0); Push((bool) Stack[-1] == 0)
0x329: IF (Stack[-1] == 0) GOTO 0x32d; Pop(1)

0x32a: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=318
0x32b: Pop(0)
0x32c: GOTO 0x332
...
0x335: Pop(0)
0x336: @@ SetItemName(Stack[-4]); Obj=1 // @poff=328
0x337: Pop(0)
0x338: PushEmpty(object, object, int)
0x339: Stack[-8] = Stack[-3]
0x33a: Stack[-4] = Stack[-2]
...
0x342: Pop(0)
0x343: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x356: Pop(1)
0x357: Stack[-2] = "pt_gatherer2" // @poff=340
0x358: Stack[-1] = (int) 2
0x359: Call2 0x3f0
...
0x35d: Pop(0)
0x35e: @@ ShowMap(Stack[-1]); Obj=2 // @poff=366
0x35f: Pop(1)
0x360: Return(); Pop(0)

0x361: PushEmpty(object, object)
0x362: Push("d7q04") // @poff=374
0x363: Push((int) 2)
...
0x369: Pop(1)
0x36a: Push("d7q04WastedGotoGatherer") // @poff=386
0x36b: Push("pt_gatherer2") // @poff=340
0x36c: Push((int) 0)
...
0x370: Pop(0)
0x371: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=434
0x372: Pop(5)
0x373: PushEmpty()
0x374: Call2 0x3a9
...
0x377: Stack[-2] = "quest_d7_04" // @poff=442
0x378: Stack[-1] = "init_andrei" // @poff=466
0x379: Call2 0x340
...
0x37e: Push("Rifle is given") // @poff=490
0x37f: @ Trace(Stack[-1])
0x380: Pop(1)
0x381: @ CreateInvItem(Stack[-1])
0x382: Pop(0)
0x383: Push("Rifle") // @poff=520
0x384: @@ SetItemName(Stack[-1]); Obj=2 // @poff=328
0x385: Pop(1)
0x386: Push("durability") // @poff=532
0x387: Push((int) 100)
0x388: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=554
0x389: Pop(2)
0x38a: PushEmpty(object, object, int)
0x38b: Stack[-7] = Stack[-3]
0x38c: Stack[-4] = Stack[-2]
0x38d: Stack[-1] = (int) 1
0x38e: Call2 0x320
...
0x391: Stack[-1] = 0
0x392: PushEmpty()
0x393: Push("rifle ammo10 is given") // @poff=566
0x394: @ Trace(Stack[-1])
0x395: Pop(1)
0x396: PushEmpty(object, string, int)
0x397: Stack[-5] = Stack[-3]
0x398: Stack[-2] = "rifle_ammo" // @poff=610
...
0x3bb: Push("Can't retrieve diary root") // @poff=632
0x3bc: @ Trace(Stack[-1])
0x3bd: Pop(1)
0x3be: Stack[-3] = (bool) 0
0x3bf: Return(); Pop(2)

0x3c0: Stack[-1] = Stack[-3]
0x3c1: Return(); Pop(2)
...
0x3c6: Stack[-1] = Stack[-4]
0x3c7: Pop(1)
0x3c8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=684
0x3c9: Pop(0)
0x3ca: Pop(0); Push((bool) Stack[-2] == 0)
0x3cb: IF (Stack[-1] == 0) GOTO 0x3d2; Pop(1)

0x3cc: Push("Can't find diary parent with id: ") // @poff=689
...
0x3d2: @@ AddChild(Stack[-8]); Obj=2 // @poff=757
0x3d3: Pop(0)
0x3d4: Push((int) 7)
0x3d5: @ SendWorldWndMessage(Stack[-1])
0x3d6: Pop(1)
0x3d7: @@ GetCategory(Stack[-1]); Obj=8 // @poff=766
0x3d8: Pop(0)
...
0x3e1: Pop(0)
0x3e2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3e3: IF (Stack[-1] == 0) GOTO 0x3ea; Pop(1)

0x3e4: Push("Can't find main outdoor scene") // @poff=778
0x3e5: @ Trace(Stack[-1])
0x3e6: Pop(1)
0x3e7: Stack[-1] = 0
...
0x3ea: @@ GetMap(Stack[-1]); Obj=2 // @poff=838
0x3eb: Pop(0)
...
0x3f2: Pop(0)
0x3f3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3f4: IF (Stack[-1] == 0) GOTO 0x3f9; Pop(1)

0x3f5: Push("Can't find main outdoor scene") // @poff=778
0x3f6: @ Trace(Stack[-1])
0x3f7: Pop(1)
0x3f8: Return(); Pop(8)

0x3f9: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=845
0x3fa: Pop(0)
0x3fb: Pop(0); Push((bool) Stack[-1] == 0)
0x3fc: IF (Stack[-1] == 0) GOTO 0x403; Pop(1)

0x3fd: Push("Warning: outdoor scene locator ") // @poff=856
0x3fe: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3ff: Push(" doesnt exist") // @poff=920
0x400: Pop(2); Push(Stack[-2] + Stack[-1]);
0x401: @ Trace(Stack[-1])
0x402: Pop(1)
0x403: @@ GetMap(Stack[-11]); Obj=2 // @poff=838
0x404: Pop(0)
0x405: Pop(0); PushNull((bool) Stack[-11] == 0)
0x406: IF (Stack[-1] == 0) GOTO 0x40b; Pop(1)

0x407: Push("Can't find map") // @poff=948
0x408: @ Trace(Stack[-1])
0x409: Pop(1)
0x40a: Return(); Pop(8)
...
0x40d: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=978
0x40e: Pop(2)
0x40f: Return(); Pop(8)

0x410: Stack[-2] = 0
0x411: PushEmpty(int, int)
0x412: Push("branch") // @poff=991
...
0x43e: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=1005
0x43f: Return(); Pop(0)

0x440: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=1045
0x441: Return(); Pop(0)
