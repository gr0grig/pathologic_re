...
// @pool_raw:
// @pool_encoding:utf8
...
0x20f: Push("player") // @poff=172
0x210: @ FindActor(Stack[-4]T, Stack[-1])
0x211: Pop(1)
...
0x224: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2af: Pop(0)
0x2b0: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x2b1: Pop(0)
...
0x2bb: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x2bc: Pop(0)
0x2bd: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x2be: Pop(0)
...
0x31c: Push("Can't find lsh animation : ") // @poff=222
...
0x32b: Push("Can't find lsh animation : ") // @poff=222
...
0x331: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x332: Pop(0)
...
0x34b: Push((float)9.999999974752427e-07)
...
0x35c: PushEmpty()
0x35d: Push("ood8Doberman1") // @poff=278
0x35e: Push((int) 1)
...
0x367: Pop(1)
0x368: Stack[-2] = "pt_map_kapella" // @poff=306
0x369: Stack[-1] = (int) 2
0x36a: Call2 0x3ec
...
0x36e: Pop(0)
0x36f: @@ ShowMap(Stack[-1]); Obj=2 // @poff=336
0x370: Pop(1)
0x371: Return(); Pop(0)

0x372: PushEmpty(object, object)
0x373: Push("d8q02") // @poff=344
0x374: Push((int) 1)
...
0x379: Stack[-1] = Stack[-2]
0x37a: Pop(1)
0x37b: Push("d8q02GotoKapella") // @poff=356
0x37c: Push("pt_map_kapella") // @poff=306
0x37d: Push((int) 0)
...
0x381: Pop(0)
0x382: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=390
0x383: Pop(5)
0x384: PushEmpty()
0x385: Call2 0x398
...
0x38e: Stack[-1] = "ood8Doberman1" // @poff=278
0x38f: Call2 0x352
...
0x3b7: Push("Can't retrieve diary root") // @poff=398
0x3b8: @ Trace(Stack[-1])
0x3b9: Pop(1)
...
0x3c3: Pop(1)
0x3c4: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=450
0x3c5: Pop(0)
0x3c6: Pop(0); Push((bool) Stack[-2] == 0)
0x3c7: IF (Stack[-1] == 0) GOTO 0x3ce; Pop(1)

0x3c8: Push("Can't find diary parent with id: ") // @poff=455
...
0x3ce: @@ AddChild(Stack[-8]); Obj=2 // @poff=523
0x3cf: Pop(0)
0x3d0: Push((int) 7)
0x3d1: @ SendWorldWndMessage(Stack[-1])
0x3d2: Pop(1)
0x3d3: @@ GetCategory(Stack[-1]); Obj=8 // @poff=532
0x3d4: Pop(0)
...
0x3dd: Pop(0)
0x3de: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3df: IF (Stack[-1] == 0) GOTO 0x3e6; Pop(1)

0x3e0: Push("Can't find main outdoor scene") // @poff=544
0x3e1: @ Trace(Stack[-1])
0x3e2: Pop(1)
0x3e3: Stack[-1] = 0
...
0x3e6: @@ GetMap(Stack[-1]); Obj=2 // @poff=604
0x3e7: Pop(0)
...
0x3f1: Push("Can't find main outdoor scene") // @poff=544
0x3f2: @ Trace(Stack[-1])
0x3f3: Pop(1)
0x3f4: Return(); Pop(8)

0x3f5: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=611
0x3f6: Pop(0)
0x3f7: Pop(0); Push((bool) Stack[-1] == 0)
0x3f8: IF (Stack[-1] == 0) GOTO 0x3ff; Pop(1)

0x3f9: Push("Warning: outdoor scene locator ") // @poff=622
0x3fa: Pop(1); Push(Stack[-1] + Stack[-11]);
0x3fb: Push(" doesnt exist") // @poff=686
0x3fc: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3fd: @ Trace(Stack[-1])
0x3fe: Pop(1)
0x3ff: @@ GetMap(Stack[-11]); Obj=2 // @poff=604
0x400: Pop(0)
0x401: Pop(0); PushNull((bool) Stack[-11] == 0)
0x402: IF (Stack[-1] == 0) GOTO 0x407; Pop(1)

0x403: Push("Can't find map") // @poff=714
0x404: @ Trace(Stack[-1])
0x405: Pop(1)
0x406: Return(); Pop(8)
...
0x409: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=744
0x40a: Pop(2)
0x40b: Return(); Pop(8)

0x40c: Stack[-2] = 0
0x40d: PushEmpty(int, int)
0x40e: Push("branch") // @poff=757
...
0x43a: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=771
0x43b: Return(); Pop(0)

0x43c: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=811
0x43d: Return(); Pop(0)
