...
// @pool_raw:
// @pool_encoding:utf8
...
0xc9: Push("all") // @poff=138
0xca: Push("idle") // @poff=146
...
0x204: Stack[-1] = "Agression" // @poff=194
0x205: Call2 0xd8
...
0x21b: Stack[-1] = "Agression" // @poff=194
0x21c: Call2 0xd8
...
0x296: Stack[-1] = "Agression" // @poff=194
0x297: Call2 0xd8
...
0x2bf: Stack[-1] = "Agression" // @poff=194
0x2c0: Call2 0xd8
...
0x363: Stack[-1] = "Agression" // @poff=194
0x364: Call2 0xd8
...
0x46f: Stack[-1] = 0
0x470: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x471: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x472: @ RotateAsync(Stack[-2], Stack[-1])
0x473: Pop(2)
0x474: Return(); Pop(0)

0x475: PushEmpty(object, bool, object, bool)
0x476: Push("player") // @poff=246
...
0x52d: Stack[-3] = (int) 0
0x52e: Push("all") // @poff=138
0x52f: PushEmpty(string, int)
0x530: Stack[-6] = Stack[-1]
0x531: Call2 0x6db
...
0x551: Pop(0)
0x552: @@ GetPosition(Stack[-2]); Obj=7 // @poff=260
0x553: Pop(0)
...
0x55e: Pop(2)
0x55f: Stack[-1] = Stack[-8]
0x560: Return(); Pop(6)

0x561: PushEmpty(cvector, cvector)
0x562: @@ GetPosition(Stack[-1]); Obj=3 // @poff=260
0x563: Pop(0)
0x564: PushEmpty(bool, cvector)
0x565: Stack[-3] = Stack[-1]
0x566: Call2 0x557

0x567: Stack[-2] = Stack[-6]
0x568: Pop(2)
0x569: Return(); Pop(2)
...
0x570: @@ GetPosition(Stack[-8]); Obj=20 // @poff=260
0x571: Pop(0)
0x572: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x573: Pop(0)
...
0x5df: Push("voice_common") // @poff=296
0x5e0: Push((int) 1)
...
0x5e7: Push("voice_common") // @poff=296
0x5e8: Push((int) 0)
...
0x5fa: Push("voice_common") // @poff=296
0x5fb: Push((int) 1)
...
0x608: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x609: Pop(1)
...
0x633: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x634: Pop(1)
...
0x648: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x649: Pop(1)
0x64a: PushEmpty(bool, string)
0x64b: Stack[-3] = Stack[-1]
0x64c: Call2 0x66f

0x64d: Stack[-2] = Stack[-14]
0x64e: Pop(2)
0x64f: Return(); Pop(10)
...
0x65b: Push("Can't find lsh animation : ") // @poff=354
...
0x66a: Push("Can't find lsh animation : ") // @poff=354
...
0x68e: Push((float)9.999999974752427e-07)
...
0x697: Pop(0)
0x698: Stack[-1] = Stack[-4]
0x699: Return(); Pop(2)

0x69a: PushEmpty(object, object)
0x69b: @ CreateIntVector(Stack[-1])
0x69c: Pop(0)
0x69d: @@ add(Stack[-4]); Obj=1 // @poff=410
0x69e: Pop(0)
0x69f: @@ add(Stack[-3]); Obj=1 // @poff=410
0x6a0: Pop(0)
0x6a1: Push((int) 3)
...
0x6a7: @@ GetItemID(Stack[-3]); Obj=8 // @poff=414
0x6a8: Pop(0)
0x6a9: Push("Category") // @poff=424
0x6aa: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x6ab: Pop(1)
0x6ac: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=442
0x6ad: Pop(0)
0x6ae: Pop(0); Push((bool) Stack[-1] == 0)
0x6af: IF (Stack[-1] == 0) GOTO 0x6b3; Pop(1)

0x6b0: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=450
0x6b1: Pop(0)
0x6b2: GOTO 0x6b8

0x6b3: PushEmpty(int, int)
0x6b4: Stack[-5] = Stack[-2]
0x6b5: Stack[-9] = Stack[-1]
0x6b6: Call2 0x69a
...
0x6bb: Pop(0)
0x6bc: @@ SetItemName(Stack[-4]); Obj=1 // @poff=460
0x6bd: Pop(0)
0x6be: PushEmpty(object, object, int)
0x6bf: Stack[-8] = Stack[-3]
...
0x6c8: Pop(0)
0x6c9: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6f1: Stack[-2] = Stack[-5]
0x6f2: Return(); Pop(4)

0x6f3: PushEmpty()
0x6f4: Push("playsound") // @poff=472
0x6f5: Push("giveitem") // @poff=492
0x6f6: @ TriggerWorld(Stack[-2], Stack[-1])
0x6f7: Pop(2)
0x6f8: Return(); Pop(0)

0x6f9: PushEmpty()
0x6fa: Push("ood8Burah2") // @poff=510
0x6fb: Push((int) 1)
...
0x6ff: PushEmpty()
0x700: Push("ood8Burah3") // @poff=532
0x701: Push((int) 1)
...
0x716: Stack[-2] = "quest_d8_03" // @poff=566
0x717: Stack[-1] = "completed" // @poff=590
0x718: Call2 0x6c6
...
0x71b: PushEmpty()
0x71c: Push("burah gives blood") // @poff=610
0x71d: @ Trace(Stack[-1])
0x71e: Pop(1)
0x71f: PushEmpty(object, string, int)
0x720: Stack[-5] = Stack[-3]
0x721: Stack[-2] = "d8q03_blood" // @poff=646
0x722: Stack[-1] = (int) 1
0x723: Call2 0x6b9
...
0x72f: PushEmpty()
0x730: Push("burah gives serum") // @poff=670
0x731: @ Trace(Stack[-1])
0x732: Pop(1)
0x733: PushEmpty(object, string, int)
0x734: Stack[-5] = Stack[-3]
0x735: Stack[-2] = "burah_serum" // @poff=706
0x736: Stack[-1] = (int) 1
0x737: Call2 0x6b9
...
0x73a: PushEmpty()
0x73b: Push("ood8Burah1") // @poff=730
0x73c: Push((int) 1)
...
0x74e: Stack[-1] = "ood8Burah2" // @poff=510
0x74f: Call2 0x695
...
0x75a: Stack[-1] = "d8BurahLetter" // @poff=764
0x75b: Call2 0x695
...
0x766: Stack[-1] = "ood8Burah3" // @poff=532
0x767: Call2 0x695
...
0x77e: Stack[-1] = "microscope_d8q03_blood" // @poff=792
0x77f: Call2 0x695
...
0x796: Stack[-1] = "ood8Burah1" // @poff=730
0x797: Call2 0x695
...
0x7d9: Push("Can't retrieve diary root") // @poff=838
0x7da: @ Trace(Stack[-1])
0x7db: Pop(1)
...
0x7e5: Pop(1)
0x7e6: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=890
0x7e7: Pop(0)
0x7e8: Pop(0); Push((bool) Stack[-2] == 0)
0x7e9: IF (Stack[-1] == 0) GOTO 0x7f0; Pop(1)

0x7ea: Push("Can't find diary parent with id: ") // @poff=895
...
0x7f0: @@ AddChild(Stack[-8]); Obj=2 // @poff=963
0x7f1: Pop(0)
0x7f2: Push((int) 7)
0x7f3: @ SendWorldWndMessage(Stack[-1])
0x7f4: Pop(1)
0x7f5: @@ GetCategory(Stack[-1]); Obj=8 // @poff=972
0x7f6: Pop(0)
...
0x812: Stack[-1] = "ui/NPC_Burah.png" // @poff=998
0x813: Return(); Pop(0)

0x814: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=1032
0x815: Return(); Pop(0)
