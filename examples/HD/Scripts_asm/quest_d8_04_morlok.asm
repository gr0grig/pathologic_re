...
Strings:
	...
	W:death
// @pool_raw:
// @pool_encoding:utf8
...
0x818: Push("Can't find lsh animation : ") // @poff=961
...
0x827: Push("Can't find lsh animation : ") // @poff=961
...
0x870: Push((float)9.999999974752427e-07)
...
0x87a: Stack[-2] = Stack[-3]
0x87b: GOTO 0x87d

0x87c: Stack[-1] = Stack[-3]
0x87d: Return(); Pop(0)
...
0x8a1: Pop(0)
0x8a2: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x8d5: Stack[-2] = Stack[-5]
0x8d6: Return(); Pop(4)

0x8d7: PushEmpty()
0x8d8: Push((int) 1)
0x8d9: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=1031
0x8da: Pop(1)
0x8db: Return(); Pop(0)

0x8dc: PushEmpty()
0x8dd: Push("d8q04") // @poff=1046
0x8de: Push((int) 2)
...
0x8ea: Stack[-2] = "quest_d8_04" // @poff=156
0x8eb: Stack[-1] = "fail" // @poff=1058
0x8ec: Call2 0x89f
...
0x91a: Push("Can't retrieve diary root") // @poff=1068
0x91b: @ Trace(Stack[-1])
0x91c: Pop(1)
...
0x926: Pop(1)
0x927: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1120
0x928: Pop(0)
0x929: Pop(0); Push((bool) Stack[-2] == 0)
0x92a: IF (Stack[-1] == 0) GOTO 0x931; Pop(1)

0x92b: Push("Can't find diary parent with id: ") // @poff=1125
...
0x931: @@ AddChild(Stack[-8]); Obj=2 // @poff=1193
0x932: Pop(0)
0x933: Push((int) 7)
0x934: @ SendWorldWndMessage(Stack[-1])
0x935: Pop(1)
0x936: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1202
0x937: Pop(0)
...
0x950: Push("branch") // @poff=1214
0x951: @ GetVariable(Stack[-1], Stack[-2])
0x952: Pop(1)
0x953: Stack[-1] = Stack[-3]
0x954: Return(); Pop(2)
...
0x966: Stack[-1] = "ui/NPC_Morlok.png" // @poff=1228
0x967: Return(); Pop(0)

0x968: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=1264
0x969: Return(); Pop(0)
...
0x976: Stack[-7] = Stack[-3]
0x977: Stack[-6] = Stack[-2]
0x978: Stack[-5] = Stack[-1]
0x979: Call2 0x754
...
0x97e: Stack[-11] = Stack[-5]
0x97f: Stack[-10] = Stack[-4]
0x980: Stack[-9] = Stack[-3]
...
0x995: Stack[-2] = "quest_d8_04" // @poff=156
0x996: Stack[-1] = "death" // @poff=1304
0x997: Call2 0x89f
