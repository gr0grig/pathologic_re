...
Strings:
	...
	W:teleport_to_han
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x12d: Push("player") // @poff=156
0x12e: @ FindActor(Stack[-4]T, Stack[-1])
0x12f: Pop(1)
...
0x142: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1cd: Pop(0)
0x1ce: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1cf: Pop(0)
...
0x1d9: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1da: Pop(0)
0x1db: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1dc: Pop(0)
...
0x202: Pop(0)
0x203: Push((bool) 1)
0x204: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x205: Pop(1)
0x206: Push(CvectorIndex(Stack[-4], 0))
0x207: Push(CvectorIndex(Stack[-5], 2))
0x208: @ Rotate(Stack[-2], Stack[-1])
0x209: Pop(2)
...
0x215: @ LookAsyncCamera(Stack[-1])
0x216: Pop(1)
0x217: @ CameraWaitForPlayFinish()
0x218: Pop(0)
0x219: @ ResumeWorld()
0x21a: Pop(0)
0x21b: Stack[-21] = (bool) 1
0x21c: Return(); Pop(18)

0x21d: PushEmpty(bool, bool)
0x21e: Push((bool) 1)
0x21f: @ CameraSwitchToNormal(Stack[-1])
0x220: Pop(1)
...
0x22f: PushEmpty(bool, float, float, bool, float, float)
0x230: @ lshHasAnimation(Stack[-3], Stack[-7])
0x231: Pop(0)
0x232: Push(Stack[-3])
0x233: IF (Stack[-1] == 0) GOTO 0x23a; Pop(1)

0x234: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x235: Pop(0)
0x236: Push((bool) 0)
0x237: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x238: Pop(1)
0x239: GOTO 0x23e

0x23a: Push("Can't find lsh animation : ") // @poff=206
0x23b: Pop(1); Push(Stack[-1] + Stack[-8]);
0x23c: @ Trace(Stack[-1])
0x23d: Pop(1)
0x23e: Return(); Pop(6)

0x23f: PushEmpty(bool, float, float, bool, float, float)
0x240: @ lshHasAnimation(Stack[-3], Stack[-8])
0x241: Pop(0)
0x242: Push(Stack[-3])
0x243: IF (Stack[-1] == 0) GOTO 0x249; Pop(1)

0x244: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x245: Pop(0)
0x246: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x247: Pop(0)
0x248: GOTO 0x24d

0x249: Push("Can't find lsh animation : ") // @poff=206
0x24a: Pop(1); Push(Stack[-1] + Stack[-9]);
0x24b: @ Trace(Stack[-1])
0x24c: Pop(1)
0x24d: Return(); Pop(6)
...
0x250: Pop(0)
0x251: Stack[-1] = CVector(0.0, 0.0, 0.0)
...
0x266: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x267: Return(); Pop(2)
...
0x26b: @ FindActor(Stack[-1], Stack[-4])
0x26c: Pop(0)
0x26d: Pop(0); PushNull((bool) Stack[-1] == 0)
0x26e: IF (Stack[-1] == 0) GOTO 0x271; Pop(1)

0x26f: Stack[-5] = (bool) 0
0x270: Return(); Pop(2)

0x271: @ Trigger(Stack[-1], Stack[-3])
0x272: Pop(0)
0x273: Stack[-5] = (bool) 1
0x274: Return(); Pop(2)

0x275: Stack[-1] = 0
0x276: PushEmpty(string, string)
0x277: Stack[-1] = "idle" // @poff=146
0x278: Push(Stack[-3])
0x279: IF (Stack[-1] == 0) GOTO 0x27b; Pop(1)

0x27a: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x27b: Stack[-1] = Stack[-4]
0x27c: Return(); Pop(2)

0x27d: PushEmpty(int, bool, int, bool)
0x27e: Stack[-2] = (int) 0
...
0x283: Pop(1)
0x284: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x285: Pop(2)
...
0x289: Push((int) 1)
0x28a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x28b: GOTO 0x27f

0x28c: Stack[-2] = Stack[-5]
0x28d: Return(); Pop(4)

0x28e: Stack[-1] = (int) 518097
0x28f: Return(); Pop(0)

0x290: Stack[-1] = (int) 518096
0x291: Return(); Pop(0)

0x292: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=262
0x293: Return(); Pop(0)

0x294: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=302
0x295: Return(); Pop(0)
...
0x298: PushEmpty()
0x299: PushEmpty(bool, string, string)
0x29a: Stack[-2] = "quest_d9_01" // @poff=346
0x29b: Stack[-1] = "teleport_to_han" // @poff=370
0x29c: Call2 0x26a
