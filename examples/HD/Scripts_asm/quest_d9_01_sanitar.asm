...
0x3d4: Push((float)0.699999988079071)
0x3d5: Push((int) 500)
...
0x3fe: Push("GenerateMoney: iMin > iMax") // @poff=777
0x3ff: @ Trace(Stack[-1])
0x400: Pop(1)
0x401: Return(); Pop(4)
...
0x41c: Pop(0)
0x41d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=843
0x41e: Pop(0)
0x41f: Push("Organ") // @poff=855
0x420: Push((int) 1)
0x421: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=364
0x422: Pop(2)
0x423: @@ GetItemID(Stack[-2]); Obj=3 // @poff=867
0x424: Pop(0)
0x425: Push((int) 0)
0x426: Push((int) 1)
...
0x433: Stack[-1] = "liver" // @poff=877
0x434: Call2 0x41a

0x435: Pop(1)
0x436: PushEmpty(string)
0x437: Stack[-1] = "kidney" // @poff=889
0x438: Call2 0x41a

0x439: Pop(1)
0x43a: PushEmpty(string)
0x43b: Stack[-1] = "heart" // @poff=903
0x43c: Call2 0x41a

0x43d: Pop(1)
0x43e: PushEmpty(string)
0x43f: Stack[-1] = "blood" // @poff=915
0x440: Call2 0x41a
...
0x454: Stack[-4] = "alpha_pills" // @poff=937
0x455: Stack[-3] = (int) 1
0x456: Stack[-2] = (int) 3
0x457: Stack[-1] = (int) 5
0x458: Call2 0x310
...
0x45b: Stack[-4] = "beta_pills" // @poff=961
0x45c: Stack[-3] = (int) 1
0x45d: Stack[-2] = (int) 6
0x45e: Stack[-1] = (int) 4
0x45f: Call2 0x310
...
0x462: Stack[-4] = "gamma_pills" // @poff=983
0x463: Stack[-3] = (int) 1
...
0x469: Stack[-1] = "ognemet_ammo" // @poff=1007
0x46a: Call2 0x471
...
0x473: Pop(0)
0x474: Stack[-1] = Stack[-4]
0x475: Return(); Pop(2)

0x476: PushEmpty(string, string)
0x477: PushEmpty(bool, object, string)
0x478: Stack[-7] = Stack[-2]
0x479: Stack[-1] = "class" // @poff=1033
0x47a: Call2 0x1fc
...
0x480: Push("class") // @poff=1033
0x481: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=338
0x482: Pop(1)
...
0x497: Push("patrol") // @poff=1045
0x498: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x499: IF (Stack[-1] == 1) GOTO 0x49e; Pop(1)

0x49a: Push("sanitar") // @poff=1059
0x49b: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x49c: IF (Stack[-1] == 1) GOTO 0x49e; Pop(1)

0x49d: Stack[-1] = (bool) 0
0x49e: IF (Stack[-1] == 1) GOTO 0x4a3; Pop(1)

0x49f: Push("soldier") // @poff=1075
0x4a0: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x4a1: IF (Stack[-1] == 1) GOTO 0x4a3; Pop(1)

0x4a2: Stack[-1] = (bool) 0
0x4a3: IF (Stack[-1] == 1) GOTO 0x4a8; Pop(1)

0x4a4: Push("woman") // @poff=531
0x4a5: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x4a6: IF (Stack[-1] == 1) GOTO 0x4a8; Pop(1)

0x4a7: Stack[-1] = (bool) 0
0x4a8: IF (Stack[-1] == 1) GOTO 0x4ad; Pop(1)

0x4a9: Push("wasted_girl") // @poff=573
0x4aa: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x4ab: IF (Stack[-1] == 1) GOTO 0x4ad; Pop(1)

0x4ac: Stack[-1] = (bool) 0
0x4ad: IF (Stack[-1] == 1) GOTO 0x4b2; Pop(1)

0x4ae: Push("vaxxabitka") // @poff=605
0x4af: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x4b0: IF (Stack[-1] == 1) GOTO 0x4b2; Pop(1)

0x4b1: Stack[-1] = (bool) 0
0x4b2: IF (Stack[-1] == 1) GOTO 0x4b7; Pop(1)

0x4b3: Push("vaxxabit") // @poff=699
0x4b4: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x4b5: IF (Stack[-1] == 1) GOTO 0x4b7; Pop(1)

0x4b6: Stack[-1] = (bool) 0
0x4b7: IF (Stack[-1] == 1) GOTO 0x4bc; Pop(1)

0x4b8: Push("little_girl") // @poff=1091
0x4b9: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x4ba: IF (Stack[-1] == 1) GOTO 0x4bc; Pop(1)

0x4bb: Stack[-1] = (bool) 0
0x4bc: IF (Stack[-1] == 1) GOTO 0x4c1; Pop(1)

0x4bd: Push("girl") // @poff=587
0x4be: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x4bf: IF (Stack[-1] == 1) GOTO 0x4c1; Pop(1)

0x4c0: Stack[-1] = (bool) 0
0x4c1: IF (Stack[-1] == 1) GOTO 0x4c6; Pop(1)

0x4c2: Push("dohodyaga") // @poff=679
0x4c3: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x4c4: IF (Stack[-1] == 1) GOTO 0x4c6; Pop(1)

0x4c5: Stack[-1] = (bool) 0
0x4c6: IF (Stack[-1] == 1) GOTO 0x4cb; Pop(1)

0x4c7: Push("nudegirl") // @poff=717
0x4c8: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x4c9: IF (Stack[-1] == 1) GOTO 0x4cb; Pop(1)
...
0x4dd: Push("worker") // @poff=543
0x4de: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x4df: IF (Stack[-1] == 1) GOTO 0x4e4; Pop(1)

0x4e0: Push("butcher") // @poff=557
0x4e1: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x4e2: IF (Stack[-1] == 1) GOTO 0x4e4; Pop(1)

0x4e3: Stack[-1] = (bool) 0
0x4e4: IF (Stack[-1] == 1) GOTO 0x4e9; Pop(1)

0x4e5: Push("boy") // @poff=597
0x4e6: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x4e7: IF (Stack[-1] == 1) GOTO 0x4e9; Pop(1)

0x4e8: Stack[-1] = (bool) 0
0x4e9: IF (Stack[-1] == 1) GOTO 0x4ee; Pop(1)

0x4ea: Push("unosha") // @poff=627
0x4eb: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x4ec: IF (Stack[-1] == 1) GOTO 0x4ee; Pop(1)

0x4ed: Stack[-1] = (bool) 0
0x4ee: IF (Stack[-1] == 1) GOTO 0x4f3; Pop(1)

0x4ef: Push("wasted_male") // @poff=641
0x4f0: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x4f1: IF (Stack[-1] == 1) GOTO 0x4f3; Pop(1)

0x4f2: Stack[-1] = (bool) 0
0x4f3: IF (Stack[-1] == 1) GOTO 0x4f8; Pop(1)

0x4f4: Push("alkash") // @poff=665
0x4f5: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x4f6: IF (Stack[-1] == 1) GOTO 0x4f8; Pop(1)

0x4f7: Stack[-1] = (bool) 0
0x4f8: IF (Stack[-1] == 1) GOTO 0x4fd; Pop(1)

0x4f9: Push("morlok") // @poff=735
0x4fa: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x4fb: IF (Stack[-1] == 1) GOTO 0x4fd; Pop(1)
...
0x513: Pop(0)
0x514: Push("flame") // @poff=1115
0x515: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=1127
0x516: Pop(2)
0x517: Push(GlobalVars[3])
0x518: Stack[-1] = (bool) 0
0x519: GlobalVars[3] = Stack[-1]; Pop(1)
0x51a: Push((float)0.05000000074505806)
0x51b: @@ SetLength(Stack[-1]); Obj=2 // @poff=1134
0x51c: Pop(1)
0x51d: Push(GlobalVars[0])
0x51e: Stack[-2] = Stack[-1]
0x51f: GlobalVars[0] = Stack[-1]; Pop(1)
0x520: Push((int) 70)
0x521: Push((float)0.10000000149011612)
...
0x52b: Stack[-1] = Stack[-6]
0x52c: Pop(1)
0x52d: GOTO 0x52f

0x52e: Stack[-5] = (float) 0.05000000074505806
0x52f: Push(GlobalVars[0])
0x530: @@ GetLength(Stack[-5]); Obj=1 // @poff=1144
0x531: Pop(1)
0x532: Pop(0); Push((bool) Stack[-5] < Stack[-4])
0x533: IF (Stack[-1] == 0) GOTO 0x535; Pop(1)

0x534: Stack[-5] = Stack[-4]
0x535: Push(GlobalVars[0])
0x536: @@ SetLength(Stack[-5]); Obj=1 // @poff=1134
0x537: Pop(1)
...
0x53e: Pop(1); PushNull((bool) Stack[-1] == 0)
...
0x546: Push("flame_loop") // @poff=1154
0x547: Push((int) 0)
0x548: Push((int) 200)
...
0x550: Push((int) 2)
0x551: @@ FadeIn(Stack[-1]); Obj=2 // @poff=1176
0x552: Pop(2)
0x553: GOTO 0x55b
...
0x558: Push((int) 2)
0x559: @@ FadeOut(Stack[-1]); Obj=2 // @poff=1183
0x55a: Pop(2)
0x55b: Push(GlobalVars[3])
0x55c: Stack[-12] = Stack[-1]
...
0x59b: @@ in(Stack[-6], Stack[-12]); Obj=1 // @poff=1239
0x59c: Pop(1)
0x59d: Push(Stack[-5])
...
0x5a2: Stack[-13] = Stack[-1]
0x5a3: Call2 0x1f7

0x5a4: Pop(1)
0x5a5: IF (Stack[-1] == 0) GOTO 0x5b4; Pop(1)

0x5a6: Push("reputation") // @poff=1242
0x5a7: @@ GetProperty(Stack[-1], Stack[-5]); Obj=12 // @poff=338
0x5a8: Pop(1)
0x5a9: Push((float)0.33000001311302185)
...
0x5ae: Push("disease") // @poff=1264
0x5af: @@ GetProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=338
0x5b0: Pop(1)
0x5b1: Push((float)0.33000001311302185)
0x5b2: Stack[-13] = Stack[-4] > Stack[-1]; Pop(1);
0x5b3: Return(); Pop(10)

0x5b4: PushEmpty(bool, object, string)
0x5b5: Stack[-14] = Stack[-2]
0x5b6: Stack[-1] = "class" // @poff=1033
0x5b7: Call2 0x1fc
...
0x5bd: Push("class") // @poff=1033
0x5be: @@ GetProperty(Stack[-1], Stack[-3]); Obj=12 // @poff=338
0x5bf: Pop(1)
...
0x5c6: Push("bomber") // @poff=1280
0x5c7: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x5c8: IF (Stack[-1] == 1) GOTO 0x5cd; Pop(1)

0x5c9: Push("hunter") // @poff=1294
0x5ca: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x5cb: IF (Stack[-1] == 1) GOTO 0x5cd; Pop(1)

0x5cc: Stack[-1] = (bool) 0
0x5cd: IF (Stack[-1] == 1) GOTO 0x5d2; Pop(1)

0x5ce: Push("grabitel") // @poff=1308
0x5cf: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x5d0: IF (Stack[-1] == 1) GOTO 0x5d2; Pop(1)

0x5d1: Stack[-1] = (bool) 0
0x5d2: IF (Stack[-1] == 1) GOTO 0x5d7; Pop(1)

0x5d3: Push("rat_big") // @poff=1326
...
0x5db: Stack[-14] = Stack[-2]
0x5dc: Stack[-1] = "disease" // @poff=1264
0x5dd: Call2 0x1fc
...
0x5e6: Stack[-5] = Stack[-1]
0x5e7: Call2 0x348

0x5e8: Pop(1)
0x5e9: IF (Stack[-1] == 1) GOTO 0x5ee; Pop(1)

0x5ea: Push("dog") // @poff=1342
0x5eb: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x5ec: IF (Stack[-1] == 1) GOTO 0x5ee; Pop(1)

0x5ed: Stack[-1] = (bool) 0
0x5ee: IF (Stack[-1] == 0) GOTO 0x5f5; Pop(1)

0x5ef: Push("disease") // @poff=1264
0x5f0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x5f1: Pop(1)
0x5f2: Push((int) 0)
...
0x60a: Pop(0)
0x60b: Push((float)-0.07000000029802322)
...
0x620: Stack[-7] = Stack[-3]
0x621: Stack[-6] = Stack[-2]
0x622: Stack[-5] = Stack[-1]
0x623: Call2 0x2be
...
0x628: Stack[-11] = Stack[-5]
0x629: Stack[-10] = Stack[-4]
0x62a: Stack[-9] = Stack[-3]
0x62b: Stack[-7] = Stack[-2]
0x62c: Stack[-6] = Stack[-1]
0x62d: Call2 0x302
...
0x64e: Push(Stack[-2])
0x64f: IF (Stack[-1] == 1) GOTO 0x658; Pop(1)

0x650: PushEmpty(float, object)
0x651: Stack[-8] = Stack[-1]
0x652: Call2 0x1ef
...
0x663: Pop(1); PushNull((bool) Stack[-1] == 0)
0x664: IF (Stack[-1] == 0) GOTO 0x666; Pop(1)

0x665: Return(); Pop(16)

0x666: Push(GlobalVars[0])
0x667: @@ Intersect(Stack[-9], Stack[-8]); Obj=1 // @poff=1350
0x668: Pop(1)
...
0x674: Push((float)0.05000000074505806)
0x675: @@ SetLength(Stack[-1]); Obj=2 // @poff=1134
0x676: Pop(2)
0x677: PushEmpty()
0x678: Call2 0x3dd

0x679: Pop(0)
0x67a: @@ Next(Stack[-5], Stack[-6]); Obj=8 // @poff=1360
0x67b: Pop(0)
0x67c: Push(Stack[-5])
...
0x68a: Stack[-9] = Stack[-2]
0x68b: Stack[-1] = "class" // @poff=1033
0x68c: Call2 0x1fc

0x68d: Pop(2)
0x68e: IF (Stack[-1] == 0) GOTO 0x692; Pop(1)

0x68f: Push("class") // @poff=1033
0x690: @@ GetProperty(Stack[-1], Stack[-5]); Obj=7 // @poff=338
0x691: Pop(1)
0x692: Push("sanitar") // @poff=1059
0x693: Pop(1); Push((bool) Stack[-5] != Stack[-1])
0x694: IF (Stack[-1] == 0) GOTO 0x6bd; Pop(1)

0x695: PushEmpty(float, object, float, int)
0x696: Stack[-10] = Stack[-3]
0x697: Stack[-2] = (float) 0.10000000149011612
0x698: Stack[-1] = (int) 2
0x699: Call2 0x208
...
0x69d: Stack[-9] = Stack[-2]
0x69e: Stack[-1] = "disease" // @poff=1264
0x69f: Call2 0x1fc

0x6a0: Pop(2)
0x6a1: IF (Stack[-1] == 0) GOTO 0x6af; Pop(1)

0x6a2: Push("disease") // @poff=1264
0x6a3: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=338
0x6a4: Pop(1)
0x6a5: Push((float)0.10000000149011612)
...
0x6aa: Push((float)0.10000000149011612)
0x6ab: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0x6ac: Push("disease") // @poff=1264
0x6ad: @@ SetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=364
0x6ae: Pop(1)
0x6af: PushEmpty(bool, object, string)
0x6b0: Stack[-9] = Stack[-2]
0x6b1: Stack[-1] = "fire" // @poff=242
0x6b2: Call2 0x1fc

0x6b3: Pop(2)
0x6b4: IF (Stack[-1] == 0) GOTO 0x6bd; Pop(1)

0x6b5: Push("fire") // @poff=242
0x6b6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=338
0x6b7: Pop(1)
0x6b8: Push("fire") // @poff=242
0x6b9: Push((float)0.10000000149011612)
0x6ba: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6bb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=8 // @poff=364
0x6bc: Pop(2)
0x6bd: GOTO 0x67a
...
0x6ea: PushEmpty()
0x6eb: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6f5: IF (Stack[-1] == 1) GOTO 0x703; Pop(1)
...
0x701: IF (Stack[-1] == 1) GOTO 0x703; Pop(1)

0x702: Stack[-3] = (bool) 0
0x703: Return(); Pop(0)

0x704: PushEmpty(bool, bool)
0x705: @ IsPlayerActor(Stack[-3], Stack[-1])
0x706: Pop(0)
0x707: Stack[-4] = (bool) 1
0x708: Push(Stack[-1])
0x709: IF (Stack[-1] == 1) GOTO 0x710; Pop(1)

0x70a: PushEmpty(bool, object)
0x70b: Stack[-5] = Stack[-1]
0x70c: Call2 0x591

0x70d: Pop(1)
0x70e: IF (Stack[-1] == 1) GOTO 0x710; Pop(1)

0x70f: Stack[-4] = (bool) 0
0x710: Return(); Pop(2)
