...
Strings:
	...
	W:branch
	W:player_shot
	W:Pantrol point count: 
	W:changing state to c_iStateWaitForLoad
	W:changing state to c_iStateHeatHands
	W:changing state to c_iStateIdle
	W:changing state to c_iStatePatrol
	W:changing state to c_iStateAware
	W:changing state to c_iStateSearchEnemy
	W:changing state to c_iStateHearEnemy
	W:changing state to c_iStateAttack
	W:_locked
	W:pt_d9q02_patrol
	W:d9q02_helpme
	W:d9q02_corpse
	W:pt_d9q02_center
	W:rusk
// @pool_raw:
...
Events:
EVENT_26 Op = 0xc9e Vars = (string)
EVENT_22 Op = 0xe09 Vars = (object, int, float, float)
EVENT_43 Op = 0xe11 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xe1b Vars = (object, string)
EVENT_41 Op = 0xe28 Vars = (object)
...
0xe: Push("FSM Init failed") // @poff=0
0xf: @ Trace(Stack[-1])
0x10: Pop(1)
...
0x17: @ GetPosition(Stack[-0]T)
0x18: Pop(0)
0x19: @ GetDirection(Stack[-1]T)
0x1a: Pop(0)
...
0x105: @@ GetLocator(Stack[-1], Stack[-8], Stack[-7], Stack[-6]); Obj=12 // @poff=32
0x106: Pop(1)
...
0x135: @@ GetPosition(Stack[-4]); Obj=1 // @poff=43
0x136: Pop(1)
0x137: Push(GlobalVars[4])
0x138: @@ GetDirection(Stack[-3]); Obj=1 // @poff=55
0x139: Pop(1)
0x13a: PushEmpty(bool, cvector, cvector, bool)
0x13b: Stack[-7] = Stack[-3]
...
0x167: Stack[-7] = Stack[-3]
0x168: Stack[-7] = Stack[-2]
...
0x1ac: Push("Unknown FSM state") // @poff=68
0x1ad: @ Trace(Stack[-1])
0x1ae: Pop(1)
0x1af: @ sync()
0x1b0: Pop(0)
...
0x1c3: PushEmpty()
0x1c4: Stack[-3] = (float) 0.10000000149011612
0x1c5: Return(); Pop(0)
...
0x1d3: Pop(0)
0x1d4: @ BroadcastMessage(Stack[-1], Stack[-7]T, Stack[-2])
0x1d5: Pop(1)
0x1d6: Push("helpme timer") // @poff=104
0x1d7: @ Trace(Stack[-1])
0x1d8: Pop(1)
0x1d9: Stack[-1] = 0
0x1da: Return(); Pop(2)
...
0x20d: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x20e: Pop(0)
0x20f: Push(Stack[-8])
0x210: IF (Stack[-1] == 0) GOTO 0x214; Pop(1)

0x211: Push("attack") // @poff=186
...
0x22e: Pop(0)
0x22f: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=200
0x230: Pop(0)
...
0x24b: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=200
0x24c: Pop(0)
...
0x266: Pop(1)
0x267: Push("all") // @poff=214
0x268: Push("attack_on") // @poff=222
...
0x27a: IF (Stack[-1] == 1) GOTO 0x27e; Pop(1)

0x27b: Push( Stack[4 + Tasks[-1].StackPointer] )
0x27c: IF (Stack[-1] == 1) GOTO 0x27e; Pop(1)
...
0x284: Push((float)0.6000000238418579)
0x285: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x286: IF (Stack[-1] == 1) GOTO 0x28c; Pop(1)

0x287: PushEmpty(bool)
0x288: Call2 0x481

0x289: Pop(0)
0x28a: IF (Stack[-1] == 1) GOTO 0x28c; Pop(1)

0x28b: Stack[-1] = (bool) 0
0x28c: IF (Stack[-1] == 0) GOTO 0x29d; Pop(1)

0x28d: @ Face(Stack[-0]T)
0x28e: Pop(0)
0x28f: PushEmpty()
0x290: Call2 0x4b1

0x291: Pop(0)
0x292: Push("all") // @poff=214
0x293: Push("attack_stay") // @poff=242
0x294: @ PlayAnimation(Stack[-2], Stack[-1])
0x295: Pop(2)
0x296: PushEmpty(bool, float)
0x297: Stack[-25] = Stack[-1]
0x298: Call2 0x3f1
...
0x29d: @ Face(Stack[-0]T)
0x29e: Pop(0)
0x29f: Push("all") // @poff=214
0x2a0: Push("fjump") // @poff=266
...
0x2bb: IF (Stack[-1] == 1) GOTO 0x2bf; Pop(1)

0x2bc: Push( Stack[4 + Tasks[-1].StackPointer] )
0x2bd: IF (Stack[-1] == 1) GOTO 0x2bf; Pop(1)
...
0x2c1: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=200
0x2c2: Pop(0)
...
0x2e0: IF (Stack[-1] == 1) GOTO 0x2e4; Pop(1)
...
0x2e6: Push("all") // @poff=214
0x2e7: Push("attack_off") // @poff=278
...
0x2fc: Push("all") // @poff=214
0x2fd: Push("attack_begin") // @poff=300
0x2fe: Push((int) 1)
0x2ff: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x30a: Push("attack") // @poff=186
0x30b: Push((int) 1)
0x30c: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x316: Push("all") // @poff=214
0x317: Push("bjump") // @poff=326
...
0x31e: Push((float)0.8999999761581421)
0x31f: Pop(1); Push(Stack[-9] * Stack[-1]);
0x320: @ GetVictim(Stack[-1], Stack[-4])
0x321: Pop(1)
0x322: @ ReportAttack(Stack[-0]T)
0x323: Pop(0)
...
0x327: Stack[-6] = Stack[-2]
0x328: Stack[-10] = Stack[-1]
0x329: Call2 0x1c3

0x32a: Stack[-3] = Stack[-5]
0x32b: Pop(3)
0x32c: PushEmpty(float, object, float, int)
0x32d: Stack[-7] = Stack[-3]
0x32e: Stack[-6] = Stack[-2]
0x32f: PushEmpty(int, object, int)
0x330: Stack[-10] = Stack[-2]
0x331: Stack[-14] = Stack[-1]
0x332: Call2 0x1c6

0x333: Stack[-3] = Stack[-4]
0x334: Pop(3)
0x335: Call2 0xab9
...
0x33a: Pop(0)
0x33b: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x33c: Pop(1)
0x33d: PushEmpty(object, float)
0x33e: Stack[-5] = Stack[-2]
...
0x347: Pop(0)
0x348: @ irand(Stack[-4], Stack[-1]T)
0x349: Pop(0)
0x34a: Push((int) 1)
0x34b: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x34c: @ Face(Stack[-0]T)
0x34d: Pop(0)
0x34e: Push((bool) 1)
0x34f: @ SetAttackState(Stack[-1])
0x350: Pop(1)
0x351: Push("all") // @poff=214
0x352: Push("attack_begin") // @poff=300
...
0x362: IF (Stack[-1] == 1) GOTO 0x366; Pop(1)

0x363: Push( Stack[4 + Tasks[-1].StackPointer] )
0x364: IF (Stack[-1] == 1) GOTO 0x366; Pop(1)
...
0x36c: Stack[-11] = Stack[-2]
0x36d: Stack[-6] = Stack[-1]
0x36e: Call2 0x31d

0x36f: Pop(2)
0x370: Push("all") // @poff=214
0x371: Push("attack_middle") // @poff=338
...
0x377: Push("all") // @poff=214
0x378: Push("attack_middle") // @poff=338
...
0x388: IF (Stack[-1] == 1) GOTO 0x38c; Pop(1)
...
0x392: Stack[-11] = Stack[-2]
0x393: Stack[-6] = Stack[-1]
0x394: Call2 0x31d

0x395: Pop(2)
0x396: Stack[-2] = (int) 1
0x397: Push("attack_middle") // @poff=338
0x398: Pop(1); Push(Stack[-1] + Stack[-5]);
0x399: Push("_") // @poff=366
0x39a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x39b: Stack[-2] = Stack[-1] + Stack[-3]; Pop(1);
0x39c: Push("all") // @poff=214
...
0x3b1: IF (Stack[-1] == 1) GOTO 0x3b5; Pop(1)

0x3b2: Push( Stack[4 + Tasks[-1].StackPointer] )
0x3b3: IF (Stack[-1] == 1) GOTO 0x3b5; Pop(1)
...
0x3bb: Stack[-11] = Stack[-2]
0x3bc: Stack[-6] = Stack[-1]
0x3bd: Call2 0x31d
...
0x3c4: Pop(1)
0x3c5: Push("all") // @poff=214
0x3c6: Push("attack_end") // @poff=370
...
0x404: IF (Stack[-1] == 1) GOTO 0x408; Pop(1)

0x405: Push( Stack[4 + Tasks[-1].StackPointer] )
0x406: IF (Stack[-1] == 1) GOTO 0x408; Pop(1)
...
0x40b: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=200
0x40c: Pop(0)
...
0x42a: IF (Stack[-1] == 1) GOTO 0x42e; Pop(1)

0x42b: Push( Stack[4 + Tasks[-1].StackPointer] )
0x42c: IF (Stack[-1] == 1) GOTO 0x42e; Pop(1)
...
0x45d: @ FindDirLength(Stack[-4], Stack[-1], Stack[-5]T)
0x45e: Pop(1)
...
0x462: @ Face(Stack[-0]T)
0x463: Pop(0)
0x464: Push("all") // @poff=214
0x465: Push("bjump") // @poff=326
0x466: @ PlayAnimation(Stack[-2], Stack[-1])
0x467: Pop(2)
0x468: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=200
0x469: Pop(0)
...
0x49f: @ irand(Stack[-1], Stack[-2]T)
0x4a0: Pop(0)
0x4a1: Push((int) 1)
0x4a2: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x4a3: Push("attack") // @poff=186
...
0x4b2: Stack[-1] = "attack_stay" // @poff=242
0x4b3: Call2 0xbdc
...
0x4c5: Stack[-13] = Stack[-5]
0x4c6: Stack[-12] = Stack[-4]
0x4c7: Stack[-11] = Stack[-3]
0x4c8: Stack[-10] = Stack[-2]
0x4c9: Stack[-9] = Stack[-1]
0x4ca: Call2 0x4ef

0x4cb: Stack[-6] = Stack[-7]
0x4cc: Pop(6)
0x4cd: Push((int) 2)
0x4ce: @ KillTimer(Stack[-1])
0x4cf: Pop(1)
0x4d0: Stack[-1] = Stack[-8]
0x4d1: Return(); Pop(2)
...
0x4da: Pop(0)
0x4db: @ BroadcastMessage(Stack[-1], Stack[-3]T, Stack[-2])
0x4dc: Pop(1)
0x4dd: Push("helpme timer") // @poff=104
0x4de: @ Trace(Stack[-1])
0x4df: Pop(1)
0x4e0: Stack[-1] = 0
0x4e1: GOTO 0x4e6
...
0x50e: Stack[-15] = Stack[-5]
0x50f: Stack[-14] = Stack[-4]
0x510: Stack[-13] = Stack[-3]
0x511: Stack[-12] = Stack[-2]
0x512: Stack[-11] = Stack[-1]
0x513: Call2 0x558

0x514: Stack[-6] = Stack[-7]
0x515: Pop(6)
0x516: Push( Stack[2 + Tasks[-1].StackPointer] )
0x517: IF (Stack[-1] == 0) GOTO 0x51b; Pop(1)

0x518: Push("head") // @poff=428
0x519: @ UnlookAsync(Stack[-1])
0x51a: Pop(1)
0x51b: Push((int) 1)
0x51c: @ KillTimer(Stack[-1])
0x51d: Pop(1)
0x51e: Stack[-1] = Stack[-10]
0x51f: Return(); Pop(4)
...
0x55b: Stack[-17] = Stack[-7]
0x55c: PushEmpty(bool, object)
0x55d: Stack[-23] = Stack[-1]
0x55e: Call2 0x5e4
...
0x564: @@ GetPosition(Stack[-5]); Obj=21 // @poff=43
0x565: Pop(0)
...
0x57b: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=200
0x57c: Pop(0)
...
0x58d: Push((int) 0)
0x58e: Push((float)0.30000001192092896)
...
0x5b0: Push((int) 0)
0x5b1: Push((float)0.30000001192092896)
...
0x5eb: Stack[-1] = "walk" // @poff=438
0x5ec: Return(); Pop(0)

0x5ed: Stack[-1] = "run" // @poff=448
0x5ee: Return(); Pop(0)
...
0x65e: Stack[-17] = Stack[-7]
0x65f: PushEmpty(bool, object)
0x660: Stack[-23] = Stack[-1]
0x661: Call2 0x6e7
...
0x667: @@ GetPosition(Stack[-5]); Obj=21 // @poff=43
0x668: Pop(0)
...
0x67e: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=200
0x67f: Pop(0)
...
0x690: Push((int) 0)
0x691: Push((float)0.30000001192092896)
...
0x6b3: Push((int) 0)
0x6b4: Push((float)0.30000001192092896)
...
0x6e9: Stack[-3] = Stack[-1]
0x6ea: Call2 0xb2b

0x6eb: Stack[-2] = Stack[-4]
0x6ec: Pop(2)
0x6ed: Return(); Pop(0)

0x6ee: Stack[-1] = "walk" // @poff=438
0x6ef: Return(); Pop(0)

0x6f0: Stack[-1] = "run" // @poff=448
0x6f1: Return(); Pop(0)
...
0x700: Stack[-5] = Stack[-2]
0x701: Stack[-4] = Stack[-1]
0x702: Call2 0xca6
...
0x74b: Pop(0)
0x74c: Push("all") // @poff=214
0x74d: PushEmpty(string, int)
0x74e: Stack[-7] = Stack[-1]
0x74f: Call2 0xc73
...
0x785: Stack[-10] = Stack[-6]
0x786: Stack[-9] = Stack[-5]
0x787: Stack[-4] = (int) 100
0x788: Stack[-3] = (int) 4000
0x789: Stack[-8] = Stack[-2]
0x78a: Stack[-1] = (bool) 1
0x78b: Call2 0x7c4

0x78c: Stack[-7] = Stack[-11]
0x78d: Pop(7)
0x78e: Return(); Pop(0)
...
0x7f4: Push((int) 0)
0x7f5: Push((float)0.30000001192092896)
...
0x817: Push((int) 0)
0x818: Push((float)0.30000001192092896)
...
0x850: Stack[-1] = "walk" // @poff=438
0x851: Return(); Pop(0)

0x852: Stack[-1] = "run" // @poff=448
0x853: Return(); Pop(0)
...
0x859: Pop(0)
0x85a: @@ GetLocator(Stack[-1], Stack[-5], Stack[-3], Stack[-2]); Obj=4 // @poff=32
0x85b: Pop(1)
...
0x861: Stack[-6] = Stack[-3]
0x862: Stack[-5] = Stack[-2]
0x863: Stack[-1] = (bool) 0
0x864: Call2 0x894

0x865: Stack[-4] = Stack[-13]
0x866: Pop(4)
0x867: Return(); Pop(8)
...
0x89a: Stack[-10] = Stack[-6]
0x89b: Stack[-9] = Stack[-5]
0x89c: Stack[-4] = (int) 100
0x89d: Stack[-3] = (int) 4000
0x89e: Stack[-8] = Stack[-2]
0x89f: Stack[-1] = (bool) 1
0x8a0: Call2 0x8ae

0x8a1: Stack[-7] = Stack[-11]
0x8a2: Pop(7)
0x8a3: Return(); Pop(0)
...
0x8de: Push((int) 0)
0x8df: Push((float)0.30000001192092896)
...
0x901: Push((int) 0)
0x902: Push((float)0.30000001192092896)
...
0x936: Stack[-2] = Stack[-1]
0x937: Call2 0xe28

0x938: Pop(1)
0x939: Return(); Pop(0)

0x93a: Stack[-1] = "walk" // @poff=438
0x93b: Return(); Pop(0)

0x93c: Stack[-1] = "run" // @poff=448
0x93d: Return(); Pop(0)
...
0x9d9: Pop(0); PushNull((bool) Stack[-21] == 0)
0x9da: IF (Stack[-1] == 0) GOTO 0x9e0; Pop(1)

0x9db: PushEmpty(string)
0x9dc: Stack[-1] = "fdie" // @poff=466
0x9dd: Call2 0xa33

0x9de: Pop(1)
0x9df: GOTO 0xa32

0x9e0: @@ GetPosition(Stack[-10]); Obj=21 // @poff=43
0x9e1: Pop(0)
...
0x9f1: Stack[-6] = "fdie" // @poff=466
0x9f2: GOTO 0x9f4

0x9f3: Stack[-6] = "bdie" // @poff=476
...
0x9fa: @ StopAsync()
0x9fb: Pop(0)
0x9fc: Stack[-21] = Stack[-5]
0x9fd: Push("GetScriptProperty") // @poff=486
0x9fe: Push((int) 2)
0x9ff: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0xa00: IF (Stack[-1] == 0) GOTO 0xa0c; Pop(1)

0xa01: Push("Owner") // @poff=522
0xa02: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=534
0xa03: Pop(1)
0xa04: Push(Stack[-4])
0xa05: IF (Stack[-1] == 0) GOTO 0xa0c; Pop(1)

0xa06: Push("Owner") // @poff=522
0xa07: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=552
0xa08: Pop(1)
0xa09: Pop(0); PushNull((bool) Stack[-5] == 0)
0xa0a: IF (Stack[-1] == 0) GOTO 0xa0c; Pop(1)

0xa0b: Stack[-21] = Stack[-5]
0xa0c: Push("@GetEyesHeight") // @poff=570
0xa0d: Push((int) 1)
0xa0e: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0xa0f: IF (Stack[-1] == 0) GOTO 0xa1b; Pop(1)

0xa10: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=600
0xa11: Pop(0)
0xa12: Stack[-1] = CVector(0.0, 0.0, 0.0)
0xa13: Push(CvectorIndex(Stack[-1], 1))
0xa14: Stack[-3] = Stack[-1]
0xa15: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xa16: Push("head") // @poff=428
...
0xa1d: Stack[-7] = Stack[-1]
0xa1e: Call2 0xbdc

0xa1f: Pop(1)
0xa20: Push("all") // @poff=214
...
0xa27: @ StopAsync()
0xa28: Pop(0)
0xa29: Push("head") // @poff=428
0xa2a: @ UnlookAsync(Stack[-1])
0xa2b: Pop(1)
0xa2c: Push("all") // @poff=214
...
0xa3f: Stack[-2] = Stack[-1]
0xa40: Call2 0xbdc

0xa41: Pop(1)
0xa42: Push("all") // @poff=214
0xa43: @ PlayAnimation(Stack[-1], Stack[-2])
0xa44: Pop(1)
0xa45: @ WaitForAnimEnd()
0xa46: Pop(0)
0xa47: Push("all") // @poff=214
...
0xa80: Stack[-2] = "bullet" // @poff=640
0xa81: Return(); Pop(0)

0xa82: Stack[-2] = "phys" // @poff=654
0xa83: Return(); Pop(0)

0xa84: PushEmpty(cvector, cvector, cvector, cvector)
0xa85: @ GetPosition(Stack[-2])
0xa86: Pop(0)
0xa87: @@ GetPosition(Stack[-1]); Obj=5 // @poff=43
0xa88: Pop(0)
0xa89: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0xa8a: Return(); Pop(4)

0xa8b: PushEmpty(object, object)
0xa8c: Push("player") // @poff=664
0xa8d: @ FindActor(Stack[-2], Stack[-1])
0xa8e: Pop(1)
0xa8f: Stack[-1] = Stack[-3]
0xa90: Return(); Pop(2)

0xa91: Stack[-1] = 0
0xa92: PushEmpty(bool, bool)
0xa93: @ IsPlayerActor(Stack[-3], Stack[-1])
0xa94: Pop(0)
0xa95: Stack[-1] = Stack[-4]
0xa96: Return(); Pop(2)

0xa97: PushEmpty(bool, bool)
0xa98: Push("HasProperty") // @poff=678
0xa99: Push((int) 2)
0xa9a: Pop(2); Push(IsFuncExist(Stack[-6], Stack[-2], Stack[-1]))
0xa9b: Pop(1); Push((bool) Stack[-1] == 0)
0xa9c: IF (Stack[-1] == 0) GOTO 0xa9f; Pop(1)

0xa9d: Stack[-5] = (bool) 0
0xa9e: Return(); Pop(2)

0xa9f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=702
0xaa0: Pop(0)
0xaa1: Stack[-1] = Stack[-5]
0xaa2: Return(); Pop(2)

0xaa3: PushEmpty(float, float)
0xaa4: PushEmpty(bool, object, string)
0xaa5: Stack[-10] = Stack[-2]
0xaa6: Stack[-9] = Stack[-1]
0xaa7: Call2 0xa97

0xaa8: Pop(2)
0xaa9: Pop(1); Push((bool) Stack[-1] == 0)
0xaaa: IF (Stack[-1] == 0) GOTO 0xaad; Pop(1)

0xaab: Stack[-8] = (bool) 0
0xaac: Return(); Pop(2)

0xaad: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=714
0xaae: Pop(0)
0xaaf: PushEmpty(float, float, float, float)
0xab0: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xab1: Stack[-8] = Stack[-2]
0xab2: Stack[-7] = Stack[-1]
0xab3: Call2 0xc1c

0xab4: Pop(3)
0xab5: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=726
0xab6: Pop(1)
0xab7: Stack[-8] = (bool) 1
0xab8: Return(); Pop(2)

0xab9: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0xaba: PushEmpty(bool, object, string)
0xabb: Stack[-18] = Stack[-2]
0xabc: Stack[-1] = "health" // @poff=738
0xabd: Call2 0xa97
...
0xac1: Stack[-16] = (float) 0.0
0xac2: Return(); Pop(12)

0xac3: PushEmpty(bool, object, string)
0xac4: Stack[-18] = Stack[-2]
0xac5: Stack[-1] = "armor" // @poff=752
0xac6: Call2 0xa97
...
0xacc: Push("armor") // @poff=752
0xacd: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=714
0xace: Pop(1)
0xacf: Push("armor_") // @poff=764
0xad0: PushEmpty(string, int)
0xad1: Stack[-16] = Stack[-1]
0xad2: Call2 0xa76

0xad3: Pop(1)
0xad4: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xad5: PushEmpty(bool, object, string)
0xad6: Stack[-18] = Stack[-2]
0xad7: Stack[-8] = Stack[-1]
0xad8: Call2 0xa97
...
0xade: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=714
0xadf: Pop(0)
0xae0: PushEmpty(float, float, float)
0xae1: Pop(0); Push(Stack[-9] + Stack[-7]);
0xae2: Push((float)100.0)
0xae3: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0xae4: Stack[-1] = (int) 1
0xae5: Call2 0xc15

0xae6: Stack[-3] = Stack[-6]
0xae7: Pop(3)
0xae8: Push("health") // @poff=738
0xae9: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=714
0xaea: Pop(1)
0xaeb: Push((int) 1)
0xaec: Pop(1); Push(Stack[-1] - Stack[-4]);
0xaed: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0xaee: Push("health") // @poff=738
0xaef: PushEmpty(float, float, float, float)
0xaf0: Stack[-3] = Stack[-7] - Stack[-6]; Pop(0);
0xaf1: Stack[-2] = (int) 0
0xaf2: Stack[-1] = (int) 1
0xaf3: Call2 0xc1c

0xaf4: Pop(3)
0xaf5: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=726
0xaf6: Pop(2)
0xaf7: PushEmpty(bool, object)
0xaf8: Stack[-17] = Stack[-1]
0xaf9: Call2 0xa92

0xafa: Pop(1)
0xafb: IF (Stack[-1] == 0) GOTO 0xb00; Pop(1)

0xafc: PushEmpty(float)
0xafd: Stack[-1] = -Stack[-2]; Pop(0);
0xafe: Call2 0xc4f

0xaff: Pop(1)
0xb00: Stack[-1] = Stack[-16]
0xb01: Return(); Pop(12)

0xb02: PushEmpty(bool, bool)
0xb03: @@ IsDead(Stack[-1]); Obj=3 // @poff=778
0xb04: Pop(0)
0xb05: Stack[-1] = Stack[-4]
0xb06: Return(); Pop(2)

0xb07: PushEmpty(object, object, object, object)
0xb08: Pop(0); PushNull((bool) Stack[-5] == 0)
0xb09: IF (Stack[-1] == 0) GOTO 0xb0c; Pop(1)

0xb0a: Stack[-6] = (bool) 0
0xb0b: Return(); Pop(4)

0xb0c: PushEmpty(bool)
0xb0d: Stack[-1] = (bool) 0
0xb0e: Push("IsDead") // @poff=785
0xb0f: Push((int) 1)
0xb10: Pop(2); Push(IsFuncExist(Stack[-8], Stack[-2], Stack[-1]))
0xb11: IF (Stack[-1] == 0) GOTO 0xb18; Pop(1)

0xb12: PushEmpty(bool, object)
0xb13: Stack[-8] = Stack[-1]
0xb14: Call2 0xb02
...
0xb19: Stack[-6] = (bool) 0
0xb1a: Return(); Pop(4)

0xb1b: @ GetScene(Stack[-2])
0xb1c: Pop(0)
0xb1d: Pop(0); PushNull((bool) Stack[-2] == 0)
0xb1e: IF (Stack[-1] == 0) GOTO 0xb21; Pop(1)

0xb1f: Stack[-6] = (bool) 0
0xb20: Return(); Pop(4)

0xb21: @@ GetScene(Stack[-1]); Obj=5 // @poff=799
0xb22: Pop(0)
0xb23: Pop(0); Push((bool) Stack[-2] != Stack[-1])
0xb24: IF (Stack[-1] == 0) GOTO 0xb27; Pop(1)

0xb25: Stack[-6] = (bool) 0
0xb26: Return(); Pop(4)

0xb27: Stack[-6] = (bool) 1
0xb28: Return(); Pop(4)
...
0xb2f: Pop(1)
0xb30: Pop(1); Push((bool) Stack[-1] == 0)
0xb31: IF (Stack[-1] == 0) GOTO 0xb34; Pop(1)

0xb32: Stack[-4] = (bool) 0
0xb33: Return(); Pop(2)

0xb34: PushEmpty(bool, object, string)
0xb35: Stack[-6] = Stack[-2]
0xb36: Stack[-1] = "noaccess" // @poff=808
0xb37: Call2 0xa97

0xb38: Pop(2)
0xb39: Pop(1); Push((bool) Stack[-1] == 0)
0xb3a: IF (Stack[-1] == 0) GOTO 0xb3d; Pop(1)

0xb3b: Stack[-4] = (bool) 1
0xb3c: Return(); Pop(2)

0xb3d: Push("noaccess") // @poff=808
0xb3e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=714
0xb3f: Pop(1)
0xb40: Push((int) 0)
0xb41: Stack[-5] = Stack[-2] == Stack[-1]; Pop(1);
0xb42: Return(); Pop(2)

0xb43: PushEmpty(bool, int, cvector, cvector, cvector, cvector, string, bool, int, cvector, cvector, cvector, cvector, string)
0xb44: Pop(0); PushNull((bool) Stack[-15] == 0)
0xb45: IF (Stack[-1] == 0) GOTO 0xb47; Pop(1)

0xb46: Return(); Pop(14)

0xb47: @ IsDead(Stack[-7])
0xb48: Pop(0)
0xb49: Push(Stack[-7])
...
0xb4c: @ GetSecondaryAnimationType(Stack[-6])
0xb4d: Pop(0)
0xb4e: Push((int) 0)
...
0xb52: @@ GetPosition(Stack[-5]); Obj=15 // @poff=43
0xb53: Pop(0)
0xb54: @ GetPosition(Stack[-4])
0xb55: Pop(0)
0xb56: @ GetDirection(Stack[-3])
0xb57: Pop(0)
0xb58: Stack[-2] = Stack[-4] - Stack[-5]; Pop(0);
0xb59: Push(CvectorIndex(Stack[-2], 0))
0xb5a: Push(CvectorIndex(Stack[-4], 0))
0xb5b: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb5c: Push(CvectorIndex(Stack[-3], 2))
0xb5d: Push(CvectorIndex(Stack[-5], 2))
0xb5e: Pop(2); Push(Stack[-2] * Stack[-1]);
0xb5f: Pop(2); Push(Stack[-2] + Stack[-1]);
0xb60: Push((int) 0)
0xb61: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0xb62: IF (Stack[-1] == 0) GOTO 0xb65; Pop(1)

0xb63: Stack[-1] = "fhit" // @poff=826
0xb64: GOTO 0xb66

0xb65: Stack[-1] = "bhit" // @poff=836
0xb66: Push("hit_react") // @poff=846
0xb67: Push("1") // @poff=866
0xb68: Pop(1); Push(Stack[-3] + Stack[-1]);
0xb69: Push("2") // @poff=870
0xb6a: Pop(1); Push(Stack[-4] + Stack[-1]);
0xb6b: Push((int) -10)
0xb6c: @ FadeSecondaryAnimation(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb6d: Pop(4)
0xb6e: Return(); Pop(14)

0xb6f: PushEmpty(cvector, object, int, bool, cvector, cvector, int, int, cvector, cvector, object, int, bool, cvector, cvector, int, int, cvector)
0xb70: PushEmpty(bool)
0xb71: Stack[-1] = (bool) 0
...
0xb76: Push((int) 4)
0xb77: Pop(1); Push((bool) Stack[-23] != Stack[-1])
0xb78: IF (Stack[-1] == 0) GOTO 0xb7a; Pop(1)

0xb79: Stack[-1] = (bool) 1
0xb7a: IF (Stack[-1] == 0) GOTO 0xb7f; Pop(1)

0xb7b: Push((int) 5)
0xb7c: Pop(1); Push((bool) Stack[-22] != Stack[-1])
0xb7d: IF (Stack[-1] == 0) GOTO 0xb7f; Pop(1)

0xb7e: Stack[-1] = (bool) 1
0xb7f: IF (Stack[-1] == 0) GOTO 0xbae; Pop(1)

0xb80: PushEmpty(cvector, cvector)
0xb81: PushEmpty(cvector, object)
0xb82: Stack[-25] = Stack[-1]
0xb83: Call2 0xa84

0xb84: Stack[-2] = Stack[-3]
0xb85: Pop(2)
0xb86: Call2 0xc0b

0xb87: Stack[-2] = Stack[-11]
0xb88: Pop(2)
0xb89: @ CreateVectorVector(Stack[-8])
0xb8a: Pop(0)
0xb8b: Stack[-7] = (int) 1
0xb8c: Push("hit") // @poff=828
0xb8d: Pop(1); Push(Stack[-1] + Stack[-8]);
0xb8e: @ GetGeometryLocator(Stack[-1], Stack[-7], Stack[-6], Stack[-5])
0xb8f: Pop(1)
0xb90: Pop(0); Push((bool) Stack[-6] == 0)
0xb91: IF (Stack[-1] == 0) GOTO 0xb93; Pop(1)

0xb92: GOTO 0xb9c

0xb93: Pop(0); Push(Stack[-4] | Stack[-9]);
0xb94: Push((float)0.7071067690849304)
0xb95: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0xb96: IF (Stack[-1] == 0) GOTO 0xb99; Pop(1)

0xb97: @@ add(Stack[-5]); Obj=8 // @poff=874
0xb98: Pop(0)
0xb99: Push((int) 1)
0xb9a: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0xb9b: GOTO 0xb8c

0xb9c: @@ size(Stack[-3]); Obj=8 // @poff=878
0xb9d: Pop(0)
0xb9e: Push(Stack[-3])
0xb9f: IF (Stack[-1] == 0) GOTO 0xbad; Pop(1)

0xba0: @ irand(Stack[-2], Stack[-3])
0xba1: Pop(0)
0xba2: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=883
0xba3: Pop(0)
0xba4: PushEmpty(object, int, float, cvector, cvector)
0xba5: Stack[-26] = Stack[-5]
0xba6: Stack[-25] = Stack[-4]
0xba7: Stack[-24] = Stack[-3]
0xba8: Stack[-6] = Stack[-2]
0xba9: Stack[-1] = -Stack[-14]; Pop(0);
0xbaa: Call2 0xbb3
...
0xbaf: Stack[-22] = Stack[-1]
0xbb0: Call2 0xb43

0xbb1: Pop(1)
0xbb2: Return(); Pop(18)

0xbb3: PushEmpty(object, object, object, object)
0xbb4: @ GetScene(Stack[-2])
0xbb5: Pop(0)
0xbb6: Push("scripted") // @poff=887
0xbb7: Push("blood_dir.xml") // @poff=905
0xbb8: @ AddActorByType(Stack[-3], Stack[-2], Stack[-4], Stack[-8], Stack[-7], Stack[-1])
0xbb9: Pop(2)
0xbba: PushEmpty(object)
0xbbb: Stack[-10] = Stack[-1]
0xbbc: Call2 0xb43
...
0xbbf: Stack[-1] = 0
0xbc0: Stack[-2] = 0
0xbc1: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0xbc2: @@ GetPosition(Stack[-3]); Obj=7 // @poff=43
0xbc3: Pop(0)
0xbc4: @ GetPosition(Stack[-2])
0xbc5: Pop(0)
0xbc6: Stack[-1] = Stack[-3] - Stack[-2]; Pop(0);
0xbc7: Push(CvectorIndex(Stack[-1], 0))
0xbc8: Push(CvectorIndex(Stack[-2], 2))
0xbc9: @ RotateAsync(Stack[-2], Stack[-1])
0xbca: Pop(2)
0xbcb: Return(); Pop(6)

0xbcc: PushEmpty(bool, bool)
0xbcd: @ IsLoaded(Stack[-1])
0xbce: Pop(0)
0xbcf: Stack[-1] = Stack[-3]
0xbd0: Return(); Pop(2)

0xbd1: PushEmpty(float, cvector, float, cvector)
0xbd2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=600
0xbd3: Pop(0)
0xbd4: Stack[-1] = CVector(0.0, 0.0, 0.0)
0xbd5: Push(CvectorIndex(Stack[-1], 1))
0xbd6: Stack[-3] = Stack[-1]
0xbd7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xbd8: Push("head") // @poff=428
0xbd9: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0xbda: Pop(1)
0xbdb: Return(); Pop(4)

0xbdc: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0xbdd: @ IsExisting3DSound(Stack[-8], Stack[-17])
0xbde: Pop(0)
0xbdf: Pop(0); Push((bool) Stack[-8] == 0)
0xbe0: IF (Stack[-1] == 0) GOTO 0xbf5; Pop(1)

0xbe1: Stack[-7] = (int) 0
0xbe2: Push((int) 1)
0xbe3: Pop(1); Push(Stack[-8] + Stack[-1]);
0xbe4: Pop(1); Push(Stack[-18] + Stack[-1]);
0xbe5: @ IsExisting3DSound(Stack[-7], Stack[-1])
0xbe6: Pop(1)
0xbe7: Pop(0); Push((bool) Stack[-6] == 0)
0xbe8: IF (Stack[-1] == 0) GOTO 0xbea; Pop(1)

0xbe9: GOTO 0xbed

0xbea: Push((int) 1)
0xbeb: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0xbec: GOTO 0xbe2

0xbed: Pop(0); Push((bool) Stack[-7] == 0)
0xbee: IF (Stack[-1] == 0) GOTO 0xbf0; Pop(1)

0xbef: Return(); Pop(16)

0xbf0: @ irand(Stack[-5], Stack[-7])
0xbf1: Pop(0)
0xbf2: Push((int) 1)
0xbf3: Pop(1); Push(Stack[-6] + Stack[-1]);
0xbf4: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0xbf5: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0xbf6: Pop(0)
0xbf7: Push(Stack[-4])
0xbf8: IF (Stack[-1] == 0) GOTO 0xc04; Pop(1)

0xbf9: @ GetEyesHeight(Stack[-3])
0xbfa: Pop(0)
0xbfb: @ GetDirection(Stack[-2])
0xbfc: Pop(0)
0xbfd: Push((int) 50)
0xbfe: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0xbff: Push(CvectorIndex(Stack[-1], 1))
0xc00: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0xc01: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xc02: @ PlayGlobalSound(Stack[-17], Stack[-1])
0xc03: Pop(0)
0xc04: Return(); Pop(16)
...
0xc06: @ self(Stack[-1])
0xc07: Pop(0)
0xc08: Stack[-1] = Stack[-3]
0xc09: Return(); Pop(2)

0xc0a: Stack[-1] = 0
0xc0b: PushEmpty(float, float)
0xc0c: Pop(0); Push(Stack[-3] | Stack[-3]);
0xc0d: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0xc0e: Push((float)9.999999974752427e-07)
0xc0f: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc10: IF (Stack[-1] == 0) GOTO 0xc13; Pop(1)

0xc11: Stack[-4] = CVector(0.0, 0.0, 0.0)
0xc12: Return(); Pop(2)

0xc13: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0xc14: Return(); Pop(2)

0xc15: PushEmpty()
0xc16: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0xc17: IF (Stack[-1] == 0) GOTO 0xc1a; Pop(1)

0xc18: Stack[-2] = Stack[-3]
0xc19: GOTO 0xc1b

0xc1a: Stack[-1] = Stack[-3]
0xc1b: Return(); Pop(0)

0xc1c: PushEmpty()
0xc1d: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0xc1e: IF (Stack[-1] == 0) GOTO 0xc21; Pop(1)

0xc1f: Stack[-2] = Stack[-4]
0xc20: Return(); Pop(0)

0xc21: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0xc22: IF (Stack[-1] == 0) GOTO 0xc25; Pop(1)

0xc23: Stack[-1] = Stack[-4]
0xc24: Return(); Pop(0)

0xc25: Stack[-3] = Stack[-4]
0xc26: Return(); Pop(0)

0xc27: PushEmpty(float, float)
0xc28: @ rand(Stack[-1])
0xc29: Pop(0)
0xc2a: Stack[-4] = Stack[-1] < Stack[-3]; Pop(0);
0xc2b: Return(); Pop(2)

0xc2c: PushEmpty()
0xc2d: Pop(0); Push((bool) Stack[-2] == 0)
0xc2e: IF (Stack[-1] == 0) GOTO 0xc31; Pop(1)

0xc2f: Stack[-3] = (bool) 0
0xc30: Return(); Pop(0)

0xc31: Push((int) 0)
0xc32: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0xc33: IF (Stack[-1] == 0) GOTO 0xc38; Pop(1)

0xc34: Push((int) 8)
0xc35: @ SendWorldWndMessage(Stack[-1])
0xc36: Pop(1)
0xc37: GOTO 0xc41

0xc38: Push((int) 0)
0xc39: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xc3a: IF (Stack[-1] == 0) GOTO 0xc3f; Pop(1)

0xc3b: Push((int) 9)
0xc3c: @ SendWorldWndMessage(Stack[-1])
0xc3d: Pop(1)
0xc3e: GOTO 0xc41

0xc3f: Stack[-3] = (bool) 0
0xc40: Return(); Pop(0)

0xc41: PushEmpty(float)
0xc42: Stack[-2] = Stack[-1]
0xc43: Call2 0xc60

0xc44: Pop(1)
0xc45: PushEmpty(bool, object, string, float, float, float)
0xc46: Stack[-8] = Stack[-5]
0xc47: Stack[-4] = "reputation" // @poff=933
0xc48: Stack[-7] = Stack[-3]
0xc49: Stack[-2] = (int) 0
0xc4a: Stack[-1] = (int) 1
0xc4b: Call2 0xaa3

0xc4c: Pop(6)
0xc4d: Stack[-3] = (bool) 1
0xc4e: Return(); Pop(0)

0xc4f: PushEmpty(object, object)
0xc50: @ CreateFloatVector(Stack[-1])
0xc51: Pop(0)
0xc52: @@ add(Stack[-3]); Obj=1 // @poff=874
0xc53: Pop(0)
0xc54: Push((int) 0)
0xc55: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0xc56: IF (Stack[-1] == 0) GOTO 0xc5b; Pop(1)

0xc57: Push((float)0.699999988079071)
0xc58: Push((int) 500)
0xc59: @ RumblePlay(Stack[-2], Stack[-1])
0xc5a: Pop(2)
0xc5b: Push((int) 15)
0xc5c: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc5d: Pop(1)
0xc5e: Return(); Pop(2)

0xc5f: Stack[-1] = 0
0xc60: PushEmpty(object, object)
0xc61: @ CreateFloatVector(Stack[-1])
0xc62: Pop(0)
0xc63: @@ add(Stack[-3]); Obj=1 // @poff=874
0xc64: Pop(0)
0xc65: Push((int) 16)
0xc66: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0xc67: Pop(1)
0xc68: Return(); Pop(2)

0xc69: Stack[-1] = 0
0xc6a: PushEmpty(bool, bool)
0xc6b: @ IsPlayerActor(Stack[-3], Stack[-1])
0xc6c: Pop(0)
0xc6d: Push(Stack[-1])
0xc6e: IF (Stack[-1] == 0) GOTO 0xc72; Pop(1)

0xc6f: Push("attack") // @poff=186
0xc70: @ PlayGlobalMusic(Stack[-1])
0xc71: Pop(1)
0xc72: Return(); Pop(2)

0xc73: PushEmpty(string, string)
0xc74: Stack[-1] = "idle" // @poff=955
0xc75: Push(Stack[-3])
0xc76: IF (Stack[-1] == 0) GOTO 0xc78; Pop(1)

0xc77: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0xc78: Stack[-1] = Stack[-4]
0xc79: Return(); Pop(2)

0xc7a: PushEmpty(int, bool, int, bool)
0xc7b: Stack[-2] = (int) 0
0xc7c: Push("all") // @poff=214
0xc7d: PushEmpty(string, int)
0xc7e: Stack[-5] = Stack[-1]
0xc7f: Call2 0xc73

0xc80: Pop(1)
0xc81: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0xc82: Pop(2)
0xc83: Pop(0); Push((bool) Stack[-1] == 0)
0xc84: IF (Stack[-1] == 0) GOTO 0xc86; Pop(1)

0xc85: GOTO 0xc89

0xc86: Push((int) 1)
0xc87: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xc88: GOTO 0xc7c

0xc89: Stack[-2] = Stack[-5]
0xc8a: Return(); Pop(4)

0xc8b: PushEmpty(int, int)
0xc8c: Push("branch") // @poff=965
0xc8d: @ GetVariable(Stack[-1], Stack[-2])
0xc8e: Pop(1)
0xc8f: Stack[-1] = Stack[-3]
0xc90: Return(); Pop(2)
...
0xc94: Pop(0)
0xc95: Push((int) 1)
0xc96: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xc97: IF (Stack[-1] == 0) GOTO 0xc9b; Pop(1)

0xc98: @ WorkWithCorpse(Stack[-1])
0xc99: Pop(0)
0xc9a: GOTO 0xc9d

0xc9b: @ Barter(Stack[-1])
0xc9c: Pop(0)
0xc9d: Return(); Pop(0)

0xc9e: PushEmpty()
0xc9f: Push("cleanup") // @poff=614
0xca0: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xca1: IF (Stack[-1] == 0) GOTO 0xca5; Pop(1)

0xca2: Push(GlobalVars[0])
0xca3: Stack[-1] = (bool) 1
0xca4: GlobalVars[0] = Stack[-1]; Pop(1)
0xca5: Return(); Pop(0)

0xca6: PushEmpty(cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float, cvector, cvector, cvector, float)
0xca7: PushEmpty(object)
0xca8: Call2 0xc05

0xca9: Pop(0)
0xcaa: Pop(1); Push((bool) Stack[-19] == Stack[-1])
0xcab: IF (Stack[-1] == 0) GOTO 0xcae; Pop(1)

0xcac: Stack[-19] = (bool) 0
0xcad: Return(); Pop(16)
...
0xcb0: Pop(0)
0xcb1: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xcb2: IF (Stack[-1] == 0) GOTO 0xcbb; Pop(1)

0xcb3: PushEmpty(bool, object)
0xcb4: Stack[-20] = Stack[-1]
0xcb5: Call2 0xd96

0xcb6: Pop(1)
0xcb7: IF (Stack[-1] == 0) GOTO 0xcba; Pop(1)

0xcb8: Stack[-19] = (bool) 1
0xcb9: Return(); Pop(16)
...
0xcbd: Pop(0)
0xcbe: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xcbf: IF (Stack[-1] == 0) GOTO 0xcd1; Pop(1)

0xcc0: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xcc1: Pop(0)
0xcc2: @ GetPosition(Stack[-7])
0xcc3: Pop(0)
0xcc4: Stack[-6] = Stack[-8] - Stack[-7]; Pop(0);
0xcc5: Stack[-5] = Stack[-6] | Stack[-6]; Pop(0);
0xcc6: Push((float)4000000.0)
0xcc7: Pop(1); Push((bool) Stack[-6] < Stack[-1])
0xcc8: IF (Stack[-1] == 0) GOTO 0xcd0; Pop(1)

0xcc9: PushEmpty(bool, object)
0xcca: Stack[-20] = Stack[-1]
0xccb: Call2 0xdba

0xccc: Pop(1)
0xccd: IF (Stack[-1] == 0) GOTO 0xcd0; Pop(1)

0xcce: Stack[-19] = (bool) 1
0xccf: Return(); Pop(16)

0xcd0: GOTO 0xcee

0xcd1: Push("player_shot") // @poff=979
0xcd2: Pop(1); Push((bool) Stack[-18] == Stack[-1])
0xcd3: IF (Stack[-1] == 0) GOTO 0xcee; Pop(1)

0xcd4: @@ GetPosition(Stack[-4]); Obj=18 // @poff=43
0xcd5: Pop(0)
0xcd6: @ GetPosition(Stack[-3])
0xcd7: Pop(0)
0xcd8: Stack[-2] = Stack[-4] - Stack[-3]; Pop(0);
0xcd9: Stack[-1] = Stack[-2] | Stack[-2]; Pop(0);
0xcda: Push((float)360000.0)
0xcdb: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xcdc: IF (Stack[-1] == 0) GOTO 0xce4; Pop(1)

0xcdd: PushEmpty(bool, object)
0xcde: Stack[-20] = Stack[-1]
0xcdf: Call2 0xdba

0xce0: Pop(1)
0xce1: IF (Stack[-1] == 0) GOTO 0xce4; Pop(1)

0xce2: Stack[-19] = (bool) 1
0xce3: Return(); Pop(16)

0xce4: Push((float)12250000.0)
0xce5: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0xce6: IF (Stack[-1] == 0) GOTO 0xcee; Pop(1)

0xce7: PushEmpty(bool, object)
0xce8: Stack[-20] = Stack[-1]
0xce9: Call2 0xd96

0xcea: Pop(1)
0xceb: IF (Stack[-1] == 0) GOTO 0xcee; Pop(1)

0xcec: Stack[-19] = (bool) 1
0xced: Return(); Pop(16)

0xcee: Stack[-19] = (bool) 0
0xcef: Return(); Pop(16)

0xcf0: PushEmpty()
0xcf1: PushEmpty(bool)
0xcf2: Stack[-1] = (bool) 0
0xcf3: Push("IsDead") // @poff=785
0xcf4: Push((int) 1)
0xcf5: Pop(2); Push(IsFuncExist(Stack[-4], Stack[-2], Stack[-1]))
0xcf6: IF (Stack[-1] == 0) GOTO 0xcfd; Pop(1)

0xcf7: PushEmpty(bool, object)
0xcf8: Stack[-4] = Stack[-1]
0xcf9: Call2 0xb02

0xcfa: Pop(1)
0xcfb: IF (Stack[-1] == 0) GOTO 0xcfd; Pop(1)

0xcfc: Stack[-1] = (bool) 1
0xcfd: IF (Stack[-1] == 0) GOTO 0xd16; Pop(1)

0xcfe: PushEmpty(bool, object, string)
0xcff: Stack[-4] = Stack[-2]
0xd00: PushEmpty(string)
0xd01: Call2 0xe34

0xd02: Stack[-1] = Stack[-2]
0xd03: Pop(1)
0xd04: Call2 0xa97
...
0xd0b: Pop(0)
0xd0c: Push((int) 1)
0xd0d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=726
0xd0e: Pop(2)
0xd0f: PushEmpty(bool, object)
0xd10: Stack[-3] = Stack[-1]
0xd11: Call2 0xd84

0xd12: Stack[-2] = Stack[-4]
0xd13: Pop(2)
0xd14: Return(); Pop(0)

0xd15: GOTO 0xd21

0xd16: PushEmpty(bool, object)
0xd17: Stack[-3] = Stack[-1]
0xd18: Call2 0xa92

0xd19: Pop(1)
0xd1a: IF (Stack[-1] == 0) GOTO 0xd21; Pop(1)

0xd1b: PushEmpty(bool, object)
0xd1c: Stack[-3] = Stack[-1]
0xd1d: Call2 0xdba

0xd1e: Stack[-2] = Stack[-4]
0xd1f: Pop(2)
0xd20: Return(); Pop(0)
...
0xd27: Pop(1)
0xd28: IF (Stack[-1] == 0) GOTO 0xd2f; Pop(1)

0xd29: PushEmpty(bool, object)
0xd2a: Stack[-3] = Stack[-1]
0xd2b: Call2 0xda8

0xd2c: Stack[-2] = Stack[-4]
0xd2d: Pop(2)
0xd2e: Return(); Pop(0)
...
0xd31: PushEmpty(object, cvector, cvector, cvector, bool, float, int, object, cvector, cvector, cvector, bool, float, int)
0xd32: @ GetMainOutdoorScene(Stack[-7])
0xd33: Pop(0)
0xd34: @ GetPosition(Stack[-6])
0xd35: Pop(0)
0xd36: Stack[-2] = (int) 4000000
0xd37: Stack[-1] = (int) 0
0xd38: Push(GlobalVars[1])
0xd39: Stack[-1] = (int) 0
0xd3a: GlobalVars[1] = Stack[-1]; Pop(1)
0xd3b: Push((bool) 1)
0xd3c: IF (Stack[-1] == 0) GOTO 0xd4e; Pop(1)

0xd3d: PushEmpty(string)
0xd3e: Call2 0xe30

0xd3f: Pop(0)
0xd40: Push(GlobalVars[1])
0xd41: Push((int) 1)
0xd42: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd43: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd44: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xd45: Pop(1)
0xd46: Pop(0); Push((bool) Stack[-3] == 0)
0xd47: IF (Stack[-1] == 0) GOTO 0xd49; Pop(1)

0xd48: GOTO 0xd4e

0xd49: Push(GlobalVars[1])
0xd4a: Push((int) 1)
0xd4b: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xd4c: GlobalVars[1] = Stack[-1]; Pop(1)
0xd4d: GOTO 0xd3b

0xd4e: Push("Pantrol point count: ") // @poff=1003
0xd4f: Push(GlobalVars[1])
0xd50: Pop(2); Push(Stack[-2] + Stack[-1]);
0xd51: @ Trace(Stack[-1])
0xd52: Pop(1)
0xd53: Stack[-15] = (bool) 1
0xd54: Return(); Pop(14)

0xd55: Stack[-7] = 0
0xd56: PushEmpty()
0xd57: Push(GlobalVars[2])
0xd58: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd59: IF (Stack[-1] == 0) GOTO 0xd5c; Pop(1)
...
0xd5e: IF (Stack[-1] == 0) GOTO 0xd68; Pop(1)

0xd5f: Push(GlobalVars[3])
0xd60: Push(GlobalVars[2])
0xd61: Stack[-1] = Stack[-2]
0xd62: Pop(1)
0xd63: GlobalVars[3] = Stack[-1]; Pop(1)
0xd64: Push("changing state to c_iStateWaitForLoad") // @poff=1047
0xd65: @ Trace(Stack[-1])
0xd66: Pop(1)
0xd67: GOTO 0xd7f
...
0xd6a: IF (Stack[-1] == 0) GOTO 0xd6f; Pop(1)

0xd6b: Push("changing state to c_iStateHeatHands") // @poff=1123
0xd6c: @ Trace(Stack[-1])
0xd6d: Pop(1)
0xd6e: GOTO 0xd7f
...
0xd71: IF (Stack[-1] == 0) GOTO 0xd76; Pop(1)

0xd72: Push("changing state to c_iStateIdle") // @poff=1195
0xd73: @ Trace(Stack[-1])
0xd74: Pop(1)
0xd75: GOTO 0xd7f

0xd76: Push((int) 3)
0xd77: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xd78: IF (Stack[-1] == 0) GOTO 0xd7d; Pop(1)

0xd79: Push("changing state to c_iStatePatrol") // @poff=1257
0xd7a: @ Trace(Stack[-1])
0xd7b: Pop(1)
0xd7c: GOTO 0xd7f

0xd7d: Stack[-2] = (bool) 0
0xd7e: Return(); Pop(0)

0xd7f: Push(GlobalVars[2])
0xd80: Stack[-2] = Stack[-1]
0xd81: GlobalVars[2] = Stack[-1]; Pop(1)
...
0xd8e: Push("changing state to c_iStateAware") // @poff=1323
0xd8f: @ Trace(Stack[-1])
0xd90: Pop(1)
0xd91: Push(GlobalVars[4])
0xd92: Stack[-2] = Stack[-1]
0xd93: GlobalVars[4] = Stack[-1]; Pop(1)
0xd94: Stack[-2] = (bool) 1
0xd95: Return(); Pop(0)

0xd96: PushEmpty()
0xd97: Push(GlobalVars[2])
0xd98: Push((int) 5)
0xd99: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xd9a: IF (Stack[-1] == 0) GOTO 0xd9d; Pop(1)

0xd9b: Stack[-2] = (bool) 0
0xd9c: Return(); Pop(0)

0xd9d: Push(GlobalVars[2])
0xd9e: Stack[-1] = (int) 5
0xd9f: GlobalVars[2] = Stack[-1]; Pop(1)
0xda0: Push("changing state to c_iStateSearchEnemy") // @poff=1387
0xda1: @ Trace(Stack[-1])
0xda2: Pop(1)
0xda3: Push(GlobalVars[5])
0xda4: Stack[-2] = Stack[-1]
0xda5: GlobalVars[5] = Stack[-1]; Pop(1)
0xda6: Stack[-2] = (bool) 1
0xda7: Return(); Pop(0)

0xda8: PushEmpty()
0xda9: Push(GlobalVars[2])
0xdaa: Push((int) 6)
0xdab: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xdac: IF (Stack[-1] == 0) GOTO 0xdaf; Pop(1)

0xdad: Stack[-2] = (bool) 0
0xdae: Return(); Pop(0)

0xdaf: Push(GlobalVars[2])
0xdb0: Stack[-1] = (int) 6
0xdb1: GlobalVars[2] = Stack[-1]; Pop(1)
0xdb2: Push("changing state to c_iStateHearEnemy") // @poff=1463
0xdb3: @ Trace(Stack[-1])
0xdb4: Pop(1)
0xdb5: Push(GlobalVars[6])
0xdb6: Stack[-2] = Stack[-1]
0xdb7: GlobalVars[6] = Stack[-1]; Pop(1)
0xdb8: Stack[-2] = (bool) 1
0xdb9: Return(); Pop(0)

0xdba: PushEmpty()
0xdbb: Push(GlobalVars[2])
0xdbc: Push((int) 7)
0xdbd: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0xdbe: IF (Stack[-1] == 0) GOTO 0xdc1; Pop(1)

0xdbf: Stack[-2] = (bool) 0
0xdc0: Return(); Pop(0)

0xdc1: Push(GlobalVars[2])
0xdc2: Stack[-1] = (int) 7
0xdc3: GlobalVars[2] = Stack[-1]; Pop(1)
0xdc4: Push("changing state to c_iStateAttack") // @poff=1535
0xdc5: @ Trace(Stack[-1])
0xdc6: Pop(1)
0xdc7: Push(GlobalVars[7])
0xdc8: Stack[-2] = Stack[-1]
0xdc9: GlobalVars[7] = Stack[-1]; Pop(1)
0xdca: Stack[-2] = (bool) 1
0xdcb: Return(); Pop(0)

0xdcc: PushEmpty(int, int)
0xdcd: PushEmpty(string)
0xdce: Call2 0xe36

0xdcf: Pop(0)
0xdd0: Push("_locked") // @poff=1601
0xdd1: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdd2: @ GetVariable(Stack[-1], Stack[-2])
0xdd3: Pop(1)
0xdd4: Push((int) 0)
0xdd5: Stack[-4] = Stack[-2] != Stack[-1]; Pop(1);
0xdd6: Return(); Pop(2)
...
0xde1: Push((int) 0)
0xde2: @ SetVariable(Stack[-2], Stack[-1])
0xde3: Pop(2)
0xde4: Return(); Pop(0)
...
0xde8: Pop(0)
0xde9: Push("_locked") // @poff=1601
0xdea: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdeb: @ GetVariable(Stack[-1], Stack[-2])
0xdec: Pop(1)
0xded: PushEmpty(int)
0xdee: Call2 0xe38

0xdef: Pop(0)
0xdf0: Stack[-4] = Stack[-2] >= Stack[-1]; Pop(1);
0xdf1: Return(); Pop(2)

0xdf2: PushEmpty(int, int)
0xdf3: PushEmpty(string)
0xdf4: Call2 0xe30

0xdf5: Pop(0)
0xdf6: Push("_locked") // @poff=1601
0xdf7: Pop(2); Push(Stack[-2] + Stack[-1]);
0xdf8: @ GetVariable(Stack[-1], Stack[-2])
0xdf9: Pop(1)
0xdfa: Push(Stack[-3])
0xdfb: IF (Stack[-1] == 0) GOTO 0xdff; Pop(1)

0xdfc: Push((int) 1)
0xdfd: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xdfe: GOTO 0xe01

0xdff: Push((int) -1)
0xe00: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0xe01: PushEmpty(string)
0xe02: Call2 0xe30

0xe03: Pop(0)
0xe04: Push("_locked") // @poff=1601
0xe05: Pop(2); Push(Stack[-2] + Stack[-1]);
0xe06: @ SetVariable(Stack[-1], Stack[-2])
0xe07: Pop(1)
0xe08: Return(); Pop(2)

0xe09: PushEmpty()
0xe0a: PushEmpty(object, int, float)
0xe0b: Stack[-7] = Stack[-3]
0xe0c: Stack[-6] = Stack[-2]
...
0xe11: PushEmpty()
0xe12: PushEmpty(object, int, float, cvector, cvector)
0xe13: Stack[-11] = Stack[-5]
0xe14: Stack[-10] = Stack[-4]
0xe15: Stack[-9] = Stack[-3]
0xe16: Stack[-7] = Stack[-2]
0xe17: Stack[-6] = Stack[-1]
0xe18: Call2 0xbb3

0xe19: Pop(5)
0xe1a: Return(); Pop(0)

0xe1b: PushEmpty(float, float)
0xe1c: Push("health") // @poff=738
0xe1d: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xe1e: IF (Stack[-1] == 0) GOTO 0xe27; Pop(1)

0xe1f: Push("health") // @poff=738
0xe20: @ GetProperty(Stack[-1], Stack[-2])
0xe21: Pop(1)
0xe22: Push((int) 0)
0xe23: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xe24: IF (Stack[-1] == 0) GOTO 0xe27; Pop(1)

0xe25: @ SignalDeath(Stack[-4])
0xe26: Pop(0)
0xe27: Return(); Pop(2)

0xe28: PushEmpty()
0xe29: PushEmpty(object)
0xe2a: Stack[-2] = Stack[-1]
0xe2b: Push(-1, 0); TaskCall(8)
0xe2c: Call2 0x99e

0xe2d: Pop(-1, 0); TaskReturn
0xe2e: Pop(1)
0xe2f: Return(); Pop(0)

0xe30: Stack[-1] = "pt_d9q02_patrol" // @poff=1617
0xe31: Return(); Pop(0)

0xe32: Stack[-1] = "d9q02_helpme" // @poff=1649
0xe33: Return(); Pop(0)

0xe34: Stack[-1] = "d9q02_corpse" // @poff=1675
0xe35: Return(); Pop(0)

0xe36: Stack[-1] = "pt_d9q02_center" // @poff=1701
0xe37: Return(); Pop(0)

0xe38: Stack[-1] = (int) 2
0xe39: Return(); Pop(0)

0xe3a: PushEmpty(bool, int, bool, int)
0xe3b: Push((int) 6)
0xe3c: @ irand(Stack[-2], Stack[-1])
0xe3d: Pop(1)
0xe3e: Push("rusk") // @poff=1733
0xe3f: Push((int) 0)
0xe40: Push((int) 1)
0xe41: Pop(1); Push(Stack[-4] + Stack[-1]);
0xe42: @ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0xe43: Pop(3)
0xe44: PushEmpty(bool, object, float)
0xe45: PushEmpty(object)
0xe46: Call2 0xa8b

0xe47: Stack[-1] = Stack[-3]
0xe48: Pop(1)
0xe49: Stack[-1] = (float) -0.029999999329447746
0xe4a: Call2 0xc2c
