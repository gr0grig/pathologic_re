...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x1: Push("termitnik") // @poff=0
0x2: @ GetSceneByName(Stack[-2], Stack[-1])
0x3: Pop(1)
0x4: PushEmpty(object, object, string, string, string)
0x5: Stack[-6] = Stack[-4]
0x6: Stack[-3] = "pt_d9q03_burah" // @poff=20
0x7: Stack[-2] = "NPC_Burah" // @poff=50
0x8: Stack[-1] = "d9q05_burah.xml" // @poff=70
0x9: Call2 0x6c
...
0x6d: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=188
0x6e: Pop(0)
0x6f: Pop(0); Push((bool) Stack[-4] == 0)
0x70: IF (Stack[-1] == 0) GOTO 0x79; Pop(1)

0x71: Push("Locator ") // @poff=199
0x72: Pop(1); Push(Stack[-1] + Stack[-12]);
0x73: Push(" doesn't exist") // @poff=217
