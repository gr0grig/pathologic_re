...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x19c: Stack[-1] = "Agression" // @poff=194
0x19d: Call2 0x9a
...
0x1ae: Stack[-1] = "Agression" // @poff=194
0x1af: Call2 0x9a
...
0x228: Stack[-3] = Stack[-1]
0x229: Call2 0x31f

0x22a: Stack[-2] = Stack[-5]
0x22b: Pop(2)
0x22c: Return(); Pop(2)

0x22d: Stack[-1] = 0
0x22e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x22f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x230: @ RotateAsync(Stack[-2], Stack[-1])
0x231: Pop(2)
0x232: Return(); Pop(0)

0x233: PushEmpty(object, bool, object, bool)
0x234: Push("player") // @poff=246
...
0x30f: Pop(0)
0x310: @@ GetPosition(Stack[-2]); Obj=7 // @poff=260
0x311: Pop(0)
...
0x320: @@ GetPosition(Stack[-1]); Obj=3 // @poff=260
0x321: Pop(0)
0x322: PushEmpty(bool, cvector)
0x323: Stack[-3] = Stack[-1]
0x324: Call2 0x315

0x325: Stack[-2] = Stack[-6]
0x326: Pop(2)
0x327: Return(); Pop(2)
...
0x32e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=260
0x32f: Pop(0)
0x330: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x331: Pop(0)
...
0x39d: Push("voice_common") // @poff=296
0x39e: Push((int) 1)
...
0x3a5: Push("voice_common") // @poff=296
0x3a6: Push((int) 0)
...
0x3b8: Push("voice_common") // @poff=296
0x3b9: Push((int) 1)
...
0x3c6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3c7: Pop(1)
...
0x3f1: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3f2: Pop(1)
...
0x406: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x407: Pop(1)
0x408: PushEmpty(bool, string)
0x409: Stack[-3] = Stack[-1]
0x40a: Call2 0x42d

0x40b: Stack[-2] = Stack[-14]
0x40c: Pop(2)
0x40d: Return(); Pop(10)
...
0x419: Push("Can't find lsh animation : ") // @poff=354
...
0x428: Push("Can't find lsh animation : ") // @poff=354
...
0x44c: Push((float)9.999999974752427e-07)
...
0x47d: Stack[-1] = "ui/NPC_Burah.png" // @poff=410
0x47e: Return(); Pop(0)

0x47f: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=444
0x480: Return(); Pop(0)
...
0x48c: PushEmpty()
0x48d: Push("ood9Burah1") // @poff=494
0x48e: Push((int) 1)
...
0x4a0: Stack[-1] = "ood9Burah1" // @poff=494
0x4a1: Call2 0x453
...
0x4bc: Push("Can't retrieve diary root") // @poff=516
0x4bd: @ Trace(Stack[-1])
0x4be: Pop(1)
...
0x4c8: Pop(1)
0x4c9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=568
0x4ca: Pop(0)
0x4cb: Pop(0); Push((bool) Stack[-2] == 0)
0x4cc: IF (Stack[-1] == 0) GOTO 0x4d3; Pop(1)

0x4cd: Push("Can't find diary parent with id: ") // @poff=573
...
0x4d3: @@ AddChild(Stack[-8]); Obj=2 // @poff=641
0x4d4: Pop(0)
0x4d5: Push((int) 7)
0x4d6: @ SendWorldWndMessage(Stack[-1])
0x4d7: Pop(1)
0x4d8: @@ GetCategory(Stack[-1]); Obj=8 // @poff=650
0x4d9: Pop(0)
