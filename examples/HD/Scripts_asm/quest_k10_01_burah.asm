...
// @pool_raw:
// @pool_encoding:utf8
...
0xd4: Stack[-1] = "Agression" // @poff=156
0xd5: Call2 0x90
...
0xe6: Stack[-1] = "Agression" // @poff=156
0xe7: Call2 0x90
...
0x114: Stack[-1] = "Agression" // @poff=156
0x115: Call2 0x90
...
0x1c6: Stack[-2] = Stack[-5]
0x1c7: Pop(2)
0x1c8: Return(); Pop(2)

0x1c9: Stack[-1] = 0
0x1ca: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1cb: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1cc: @ RotateAsync(Stack[-2], Stack[-1])
0x1cd: Pop(2)
0x1ce: Return(); Pop(0)

0x1cf: PushEmpty(object, bool, object, bool)
0x1d0: Push("player") // @poff=234
...
0x2ab: Pop(0)
0x2ac: @@ GetPosition(Stack[-2]); Obj=7 // @poff=248
0x2ad: Pop(0)
...
0x2b8: Pop(2)
0x2b9: Stack[-1] = Stack[-8]
0x2ba: Return(); Pop(6)

0x2bb: PushEmpty(cvector, cvector)
0x2bc: @@ GetPosition(Stack[-1]); Obj=3 // @poff=248
0x2bd: Pop(0)
...
0x2ca: @@ GetPosition(Stack[-8]); Obj=20 // @poff=248
0x2cb: Pop(0)
0x2cc: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=260
0x2cd: Pop(0)
...
0x339: Push("voice_common") // @poff=284
0x33a: Push((int) 1)
...
0x341: Push("voice_common") // @poff=284
0x342: Push((int) 0)
...
0x354: Push("voice_common") // @poff=284
0x355: Push((int) 1)
...
0x362: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x363: Pop(1)
...
0x38d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x38e: Pop(1)
...
0x3a2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=326
0x3a3: Pop(1)
0x3a4: PushEmpty(bool, string)
0x3a5: Stack[-3] = Stack[-1]
0x3a6: Call2 0x3c9

0x3a7: Stack[-2] = Stack[-14]
0x3a8: Pop(2)
0x3a9: Return(); Pop(10)
...
0x3b5: Push("Can't find lsh animation : ") // @poff=342
...
0x3c4: Push("Can't find lsh animation : ") // @poff=342
...
0x3e8: Push((float)9.999999974752427e-07)
...
0x3f6: Pop(0)
0x3f7: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x41f: Stack[-2] = Stack[-5]
0x420: Return(); Pop(4)

0x421: PushEmpty()
0x422: Push("k10q01") // @poff=398
0x423: Push((int) 7)
...
0x42a: Stack[-2] = "quest_k10_01" // @poff=412
0x42b: Stack[-1] = "place_prophet" // @poff=438
0x42c: Call2 0x3f4
...
0x44d: Push("Can't retrieve diary root") // @poff=466
0x44e: @ Trace(Stack[-1])
0x44f: Pop(1)
...
0x459: Pop(1)
0x45a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=518
0x45b: Pop(0)
0x45c: Pop(0); Push((bool) Stack[-2] == 0)
0x45d: IF (Stack[-1] == 0) GOTO 0x464; Pop(1)

0x45e: Push("Can't find diary parent with id: ") // @poff=523
...
0x464: @@ AddChild(Stack[-8]); Obj=2 // @poff=591
0x465: Pop(0)
0x466: Push((int) 7)
0x467: @ SendWorldWndMessage(Stack[-1])
0x468: Pop(1)
0x469: @@ GetCategory(Stack[-1]); Obj=8 // @poff=600
0x46a: Pop(0)
...
0x486: Stack[-1] = "ui/NPC_Burah.png" // @poff=626
0x487: Return(); Pop(0)

0x488: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=660
0x489: Return(); Pop(0)
