...
// @pool_raw:
// @pool_encoding:utf8
...
0x165: Stack[-1] = "Untrust" // @poff=182
0x166: Call2 0xa9
...
0x1a0: Stack[-1] = "Untrust" // @poff=182
0x1a1: Call2 0xa9
...
0x1b2: Stack[-1] = "Untrust" // @poff=182
0x1b3: Call2 0xa9
...
0x1c4: Stack[-1] = "Untrust" // @poff=182
0x1c5: Call2 0xa9
...
0x229: Stack[-2] = Stack[-5]
0x22a: Pop(2)
0x22b: Return(); Pop(2)

0x22c: Stack[-1] = 0
0x22d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x22e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x22f: @ RotateAsync(Stack[-2], Stack[-1])
0x230: Pop(2)
0x231: Return(); Pop(0)

0x232: PushEmpty(object, bool, object, bool)
0x233: Push("player") // @poff=230
...
0x30e: Pop(0)
0x30f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=244
0x310: Pop(0)
...
0x31b: Pop(2)
0x31c: Stack[-1] = Stack[-8]
0x31d: Return(); Pop(6)

0x31e: PushEmpty(cvector, cvector)
0x31f: @@ GetPosition(Stack[-1]); Obj=3 // @poff=244
0x320: Pop(0)
...
0x32d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=244
0x32e: Pop(0)
0x32f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=256
0x330: Pop(0)
...
0x39c: Push("voice_common") // @poff=280
0x39d: Push((int) 1)
...
0x3a4: Push("voice_common") // @poff=280
0x3a5: Push((int) 0)
...
0x3b7: Push("voice_common") // @poff=280
0x3b8: Push((int) 1)
...
0x3c5: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=310
0x3c6: Pop(1)
...
0x3f0: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=310
0x3f1: Pop(1)
...
0x405: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=322
0x406: Pop(1)
...
0x418: Push("Can't find lsh animation : ") // @poff=338
...
0x427: Push("Can't find lsh animation : ") // @poff=338
...
0x484: PushEmpty()
0x485: Push("k10q01KnowAboutRubin") // @poff=408
0x486: Push((int) 1)
...
0x4b5: Push("Can't retrieve diary root") // @poff=450
0x4b6: @ Trace(Stack[-1])
0x4b7: Pop(1)
0x4b8: Stack[-3] = (bool) 0
0x4b9: Return(); Pop(2)

0x4ba: Stack[-1] = Stack[-3]
0x4bb: Return(); Pop(2)
...
0x4c1: Pop(1)
0x4c2: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=502
0x4c3: Pop(0)
0x4c4: Pop(0); Push((bool) Stack[-2] == 0)
0x4c5: IF (Stack[-1] == 0) GOTO 0x4cc; Pop(1)

0x4c6: Push("Can't find diary parent with id: ") // @poff=507
...
0x4cc: @@ AddChild(Stack[-8]); Obj=2 // @poff=575
0x4cd: Pop(0)
0x4ce: Push((int) 7)
0x4cf: @ SendWorldWndMessage(Stack[-1])
0x4d0: Pop(1)
0x4d1: @@ GetCategory(Stack[-1]); Obj=8 // @poff=584
0x4d2: Pop(0)
...
0x4ee: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=610
0x4ef: Return(); Pop(0)

0x4f0: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=650
0x4f1: Return(); Pop(0)
