...
Strings:
	...
	W:k10q01
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x258: Push("Can't find lsh animation : ") // @poff=206
...
0x25e: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x25f: Pop(0)
...
0x272: Push((float)9.999999974752427e-07)
...
0x28e: Stack[-1] = "ui/NPC_Prophet.png" // @poff=262
0x28f: Return(); Pop(0)

0x290: Stack[-1] = "ui/NPC_Prophet_b.png" // @poff=300
0x291: Return(); Pop(0)
...
0x2ae: Stack[-2] = "quest_k10_01" // @poff=342
0x2af: Stack[-1] = "teleport" // @poff=368
0x2b0: Call2 0x27e
