...
// @pool_raw:
// @pool_encoding:utf8
...
0xf7: Stack[-1] = "Confusion" // @poff=156
0xf8: Call2 0x9f
...
0x10e: Stack[-1] = "Confusion" // @poff=156
0x10f: Call2 0x9f
...
0x144: Stack[-1] = "Warning" // @poff=176
0x145: Call2 0x9f
...
0x15b: Stack[-1] = "Confusion" // @poff=156
0x15c: Call2 0x9f
...
0x16d: Stack[-1] = "Warning" // @poff=176
0x16e: Call2 0x9f
...
0x17f: Stack[-1] = "Warning" // @poff=176
0x180: Call2 0x9f
...
0x1e7: Stack[-1] = 0
0x1e8: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1e9: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1ea: @ RotateAsync(Stack[-2], Stack[-1])
0x1eb: Pop(2)
0x1ec: Return(); Pop(0)

0x1ed: PushEmpty(object, bool, object, bool)
0x1ee: Push("player") // @poff=224
...
0x2c9: Pop(0)
0x2ca: @@ GetPosition(Stack[-2]); Obj=7 // @poff=238
0x2cb: Pop(0)
...
0x2da: @@ GetPosition(Stack[-1]); Obj=3 // @poff=238
0x2db: Pop(0)
0x2dc: PushEmpty(bool, cvector)
0x2dd: Stack[-3] = Stack[-1]
0x2de: Call2 0x2cf

0x2df: Stack[-2] = Stack[-6]
0x2e0: Pop(2)
0x2e1: Return(); Pop(2)
...
0x2e8: @@ GetPosition(Stack[-8]); Obj=20 // @poff=238
0x2e9: Pop(0)
0x2ea: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=250
0x2eb: Pop(0)
...
0x357: Push("voice_common") // @poff=274
0x358: Push((int) 1)
...
0x35f: Push("voice_common") // @poff=274
0x360: Push((int) 0)
...
0x372: Push("voice_common") // @poff=274
0x373: Push((int) 1)
...
0x380: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x381: Pop(1)
...
0x395: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x396: Pop(1)
...
0x39e: Push("d") // @poff=270
0x39f: PushEmpty(int)
0x3a0: Call2 0x41e

0x3a1: Pop(0)
0x3a2: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3a3: Push("m") // @poff=328
...
0x3ab: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=304
0x3ac: Pop(1)
...
0x3c0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=316
0x3c1: Pop(1)
0x3c2: PushEmpty(bool, string)
0x3c3: Stack[-3] = Stack[-1]
0x3c4: Call2 0x3e7

0x3c5: Stack[-2] = Stack[-14]
0x3c6: Pop(2)
0x3c7: Return(); Pop(10)
...
0x3d3: Push("Can't find lsh animation : ") // @poff=332
...
0x3e2: Push("Can't find lsh animation : ") // @poff=332
...
0x414: Pop(0)
0x415: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x444: Stack[-2] = "quest_k10_01" // @poff=388
0x445: Stack[-1] = "completed" // @poff=414
0x446: Call2 0x412
...
0x44b: Stack[-1] = "K_Mission4" // @poff=434
0x44c: Call2 0x40d
...
0x451: Push("K_Mission4") // @poff=434
0x452: Push((int) 1)
...
0x490: Push("Can't retrieve diary root") // @poff=470
0x491: @ Trace(Stack[-1])
0x492: Pop(1)
...
0x49c: Pop(1)
0x49d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=522
0x49e: Pop(0)
0x49f: Pop(0); Push((bool) Stack[-2] == 0)
0x4a0: IF (Stack[-1] == 0) GOTO 0x4a7; Pop(1)

0x4a1: Push("Can't find diary parent with id: ") // @poff=527
...
0x4a7: @@ AddChild(Stack[-8]); Obj=2 // @poff=595
0x4a8: Pop(0)
0x4a9: Push((int) 7)
0x4aa: @ SendWorldWndMessage(Stack[-1])
0x4ab: Pop(1)
0x4ac: @@ GetCategory(Stack[-1]); Obj=8 // @poff=604
0x4ad: Pop(0)
...
0x4b8: Pop(1)
0x4b9: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=522
0x4ba: Pop(0)
...
0x4da: Stack[-1] = "ui/NPC_Rubin.png" // @poff=637
0x4db: Return(); Pop(0)

0x4dc: Stack[-1] = "ui/NPC_Rubin_b.png" // @poff=671
0x4dd: Return(); Pop(0)
