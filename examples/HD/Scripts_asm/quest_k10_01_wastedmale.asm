...
// @pool_raw:
// @pool_encoding:utf8
...
0x1de: Push("player") // @poff=172
0x1df: @ FindActor(Stack[-4]T, Stack[-1])
0x1e0: Pop(1)
...
0x1f3: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x27e: Pop(0)
0x27f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x280: Pop(0)
...
0x28a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x28b: Pop(0)
0x28c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x28d: Pop(0)
...
0x2eb: Push("Can't find lsh animation : ") // @poff=222
...
0x2fa: Push("Can't find lsh animation : ") // @poff=222
...
0x300: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x301: Pop(0)
...
0x31a: Push((float)9.999999974752427e-07)
...
0x328: Pop(0)
0x329: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x33f: Stack[-2] = (int) 0
0x340: Push("all") // @poff=138
0x341: PushEmpty(string, int)
0x342: Stack[-5] = Stack[-1]
0x343: Call2 0x337
...
0x35f: Stack[-1] = Stack[-2]
0x360: Pop(1)
0x361: Push("k10q01WastedGotoBurah") // @poff=292
0x362: Push("pt_gmap_factory") // @poff=336
0x363: Push((int) 1)
...
0x367: Pop(0)
0x368: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=368
0x369: Pop(5)
0x36a: PushEmpty()
0x36b: Call2 0x3ae
...
0x36e: Stack[-2] = "quest_k10_01" // @poff=376
0x36f: Stack[-1] = "init_factory" // @poff=402
0x370: Call2 0x326
...
0x379: Pop(1)
0x37a: Stack[-2] = "pt_gmap_factory" // @poff=336
0x37b: Stack[-1] = (int) 2
0x37c: Call2 0x3f5
...
0x380: Pop(0)
0x381: @@ ShowMap(Stack[-1]); Obj=2 // @poff=428
0x382: Pop(1)
0x383: Return(); Pop(0)

0x384: PushEmpty()
0x385: Push((int) 0)
0x386: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=436
0x387: Pop(1)
0x388: Return(); Pop(0)

0x389: PushEmpty()
0x38a: PushEmpty(int, string)
0x38b: Stack[-1] = "k10q01" // @poff=278
0x38c: Call2 0x321
...
0x3c0: Push("Can't retrieve diary root") // @poff=451
0x3c1: @ Trace(Stack[-1])
0x3c2: Pop(1)
...
0x3cc: Pop(1)
0x3cd: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=503
0x3ce: Pop(0)
0x3cf: Pop(0); Push((bool) Stack[-2] == 0)
0x3d0: IF (Stack[-1] == 0) GOTO 0x3d7; Pop(1)

0x3d1: Push("Can't find diary parent with id: ") // @poff=508
...
0x3d7: @@ AddChild(Stack[-8]); Obj=2 // @poff=576
0x3d8: Pop(0)
0x3d9: Push((int) 7)
0x3da: @ SendWorldWndMessage(Stack[-1])
0x3db: Pop(1)
0x3dc: @@ GetCategory(Stack[-1]); Obj=8 // @poff=585
0x3dd: Pop(0)
...
0x3e9: Push("Can't find main outdoor scene") // @poff=597
0x3ea: @ Trace(Stack[-1])
0x3eb: Pop(1)
0x3ec: Stack[-1] = 0
...
0x3ef: @@ GetMap(Stack[-1]); Obj=2 // @poff=657
0x3f0: Pop(0)
...
0x3f7: Pop(0)
0x3f8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3f9: IF (Stack[-1] == 0) GOTO 0x3fe; Pop(1)

0x3fa: Push("Can't find main outdoor scene") // @poff=597
0x3fb: @ Trace(Stack[-1])
0x3fc: Pop(1)
0x3fd: Return(); Pop(8)

0x3fe: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=664
0x3ff: Pop(0)
0x400: Pop(0); Push((bool) Stack[-1] == 0)
0x401: IF (Stack[-1] == 0) GOTO 0x408; Pop(1)

0x402: Push("Warning: outdoor scene locator ") // @poff=675
0x403: Pop(1); Push(Stack[-1] + Stack[-11]);
0x404: Push(" doesnt exist") // @poff=739
0x405: Pop(2); Push(Stack[-2] + Stack[-1]);
0x406: @ Trace(Stack[-1])
0x407: Pop(1)
0x408: @@ GetMap(Stack[-11]); Obj=2 // @poff=657
0x409: Pop(0)
0x40a: Pop(0); PushNull((bool) Stack[-11] == 0)
0x40b: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x40c: Push("Can't find map") // @poff=767
0x40d: @ Trace(Stack[-1])
0x40e: Pop(1)
0x40f: Return(); Pop(8)
...
0x412: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=797
0x413: Pop(2)
0x414: Return(); Pop(8)

0x415: Stack[-2] = 0
0x416: PushEmpty(int, int)
0x417: Push("branch") // @poff=810
...
0x42b: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=824
0x42c: Return(); Pop(0)

0x42d: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=864
0x42e: Return(); Pop(0)
