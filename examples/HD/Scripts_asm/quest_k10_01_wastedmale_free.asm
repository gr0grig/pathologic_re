...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
EVENT_43 Op = 0x557 Vars = (object, int, float, float, cvector, cvector)
EVENT_41 Op = 0x561 Vars = (object)
...
0x19d: Pop(0)
0x19e: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=156
0x19f: Pop(1)
0x1a0: PushEmpty(object)
0x1a1: Stack[-6] = Stack[-1]
...
0x1af: Push("player") // @poff=178
0x1b0: @ FindActor(Stack[-4]T, Stack[-1])
0x1b1: Pop(1)
...
0x1c4: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x24f: Pop(0)
0x250: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=202
0x251: Pop(0)
...
0x26e: Stack[-1] = (float) 1.7453293800354004
0x26f: Call2 0x24d
...
0x277: Stack[-1] = (float) 2.6179938316345215
0x278: Call2 0x24d

0x279: Stack[-2] = Stack[-7]
0x27a: Pop(2)
...
0x27f: Push("Can't retreat, distance: ") // @poff=214
...
0x295: Push((int) 1)
0x296: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x297: Pop(1)
0x298: Push(Stack[-3])
0x299: IF (Stack[-1] == 0) GOTO 0x2b1; Pop(1)

0x29a: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x29f: Stack[-1] = (float) 2.6179938316345215
0x2a0: Call2 0x24d

0x2a1: Stack[-2] = Stack[-4]
0x2a2: Pop(2)
...
0x2b2: IF (Stack[-1] == 1) GOTO 0x295; Pop(1)
...
0x2b9: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2d8: IF (Stack[-1] == 1) GOTO 0x2de; Pop(1)

0x2d9: PushEmpty(bool)
0x2da: Call2 0x2f8

0x2db: Pop(0)
0x2dc: IF (Stack[-1] == 1) GOTO 0x2de; Pop(1)
...
0x302: Stack[-4] = Stack[-1]
0x303: Call2 0x437

0x304: Pop(2)
0x305: Push((float)-0.3420201241970062)
...
0x30f: Pop(0)
0x310: @@ GetPosition(Stack[-1]); Obj=5 // @poff=202
0x311: Pop(0)
...
0x316: Pop(0)
0x317: @@ GetPosition(Stack[-2]); Obj=7 // @poff=202
0x318: Pop(0)
...
0x31d: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x32b: @@ GetPosition(Stack[-5]); Obj=15 // @poff=202
0x32c: Pop(0)
...
0x33c: Stack[-1] = "fhit" // @poff=266
0x33d: GOTO 0x33f

0x33e: Stack[-1] = "bhit" // @poff=276
0x33f: Push("hit_react") // @poff=286
0x340: Push("1") // @poff=306
0x341: Pop(1); Push(Stack[-3] + Stack[-1]);
0x342: Push("2") // @poff=310
...
0x35b: Stack[-25] = Stack[-1]
0x35c: Call2 0x30d

0x35d: Stack[-2] = Stack[-3]
0x35e: Pop(2)
0x35f: Call2 0x42d

0x360: Stack[-2] = Stack[-11]
0x361: Pop(2)
0x362: @ CreateVectorVector(Stack[-8])
0x363: Pop(0)
0x364: Stack[-7] = (int) 1
0x365: Push("hit") // @poff=268
...
0x37a: Pop(0)
0x37b: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=323
0x37c: Pop(0)
0x37d: PushEmpty(object, int, float, cvector, cvector)
0x37e: Stack[-26] = Stack[-5]
0x37f: Stack[-25] = Stack[-4]
0x380: Stack[-24] = Stack[-3]
...
0x3a0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x3a1: Pop(0)
0x3a2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=373
0x3a3: Pop(0)
...
0x3c9: Pop(0)
0x3ca: Push((bool) 1)
0x3cb: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x3cc: Pop(1)
...
0x3e5: Push((bool) 1)
0x3e6: @ CameraSwitchToNormal(Stack[-1])
0x3e7: Pop(1)
...
0x3ed: Push("head") // @poff=192
0x3ee: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3ef: Pop(1)
0x3f0: Push(Stack[-1])
0x3f1: IF (Stack[-1] == 0) GOTO 0x3f5; Pop(1)

0x3f2: Push("head") // @poff=192
0x3f3: @ UnlookAsync(Stack[-1])
0x3f4: Pop(1)
0x3f5: Return(); Pop(2)
...
0x401: Push("Can't find lsh animation : ") // @poff=387
...
0x410: Push("Can't find lsh animation : ") // @poff=387
0x411: Pop(1); Push(Stack[-1] + Stack[-9]);
0x412: @ Trace(Stack[-1])
0x413: Pop(1)
0x414: Return(); Pop(6)

0x415: PushEmpty(float, cvector, float, cvector)
0x416: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=373
0x417: Pop(0)
0x418: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x419: Push(CvectorIndex(Stack[-1], 1))
0x41a: Stack[-3] = Stack[-1]
0x41b: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x41c: Push("head") // @poff=192
0x41d: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x41e: Pop(1)
0x41f: Return(); Pop(4)
...
0x430: Push((float)9.999999974752427e-07)
...
0x437: PushEmpty()
0x438: Pop(0); Push(Stack[-2] | Stack[-1]);
0x439: Pop(0); Push(Stack[-3] | Stack[-3]);
0x43a: Pop(0); Push(Stack[-3] | Stack[-3]);
0x43b: Pop(2); Push(Stack[-2] * Stack[-1]);
0x43c: Pop(1); Push(Sqrt(Stack[-1]))
0x43d: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x43e: Return(); Pop(0)

0x43f: PushEmpty(int, int)
0x440: @ GetVariable(Stack[-3], Stack[-1])
0x441: Pop(0)
0x442: Stack[-1] = Stack[-4]
0x443: Return(); Pop(2)

0x444: PushEmpty(object, object)
0x445: @ FindActor(Stack[-1], Stack[-4])
0x446: Pop(0)
0x447: Pop(0); PushNull((bool) Stack[-1] == 0)
0x448: IF (Stack[-1] == 0) GOTO 0x44b; Pop(1)

0x449: Stack[-5] = (bool) 0
0x44a: Return(); Pop(2)

0x44b: @ Trigger(Stack[-1], Stack[-3])
0x44c: Pop(0)
0x44d: Stack[-5] = (bool) 1
0x44e: Return(); Pop(2)

0x44f: Stack[-1] = 0
0x450: PushEmpty(float, float)
0x451: @ GetGameTime(Stack[-1])
0x452: Pop(0)
0x453: Stack[-1] = Stack[-3]
0x454: Return(); Pop(2)

0x455: PushEmpty(string, string)
0x456: Stack[-1] = "idle" // @poff=146
0x457: Push(Stack[-3])
0x458: IF (Stack[-1] == 0) GOTO 0x45a; Pop(1)

0x459: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x45a: Stack[-1] = Stack[-4]
0x45b: Return(); Pop(2)

0x45c: PushEmpty(int, bool, int, bool)
0x45d: Stack[-2] = (int) 0
0x45e: Push("all") // @poff=138
0x45f: PushEmpty(string, int)
0x460: Stack[-5] = Stack[-1]
0x461: Call2 0x455

0x462: Pop(1)
0x463: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x464: Pop(2)
...
0x468: Push((int) 1)
0x469: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x46a: GOTO 0x45e

0x46b: Stack[-2] = Stack[-5]
0x46c: Return(); Pop(4)

0x46d: Stack[-1] = (int) 515556
0x46e: Return(); Pop(0)

0x46f: Stack[-1] = (int) 503341
0x470: Return(); Pop(0)

0x471: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=443
0x472: Return(); Pop(0)

0x473: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=483
0x474: Return(); Pop(0)
...
0x488: Pop(1)
0x489: Push("k10q01WastedGotoBurah") // @poff=541
0x48a: Push("pt_gmap_factory") // @poff=585
0x48b: Push((int) 1)
0x48c: Push((int) 530196)
0x48d: PushEmpty(float)
0x48e: Call2 0x450

0x48f: Pop(0)
0x490: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=617
0x491: Pop(5)
0x492: PushEmpty()
0x493: Call2 0x4d6
...
0x496: Stack[-2] = "quest_k10_01" // @poff=625
0x497: Stack[-1] = "init_factory" // @poff=651
0x498: Call2 0x444
...
0x4a0: Stack[-1] = Stack[-4]
0x4a1: Pop(1)
0x4a2: Stack[-2] = "pt_gmap_factory" // @poff=585
0x4a3: Stack[-1] = (int) 2
0x4a4: Call2 0x51d
...
0x4a8: Pop(0)
0x4a9: @@ ShowMap(Stack[-1]); Obj=2 // @poff=677
0x4aa: Pop(1)
0x4ab: Return(); Pop(0)

0x4ac: PushEmpty()
0x4ad: Push((int) 0)
0x4ae: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=685
0x4af: Pop(1)
0x4b0: Return(); Pop(0)

0x4b1: PushEmpty()
0x4b2: PushEmpty(int, string)
0x4b3: Stack[-1] = "k10q01" // @poff=527
0x4b4: Call2 0x43f
...
0x4ca: Push((int) 451)
0x4cb: Push((int) 1)
0x4cc: Push((int) 527009)
0x4cd: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x4ce: Pop(3)
0x4cf: PushEmpty(bool, object, int)
0x4d0: Stack[-4] = Stack[-2]
0x4d1: Stack[-1] = (int) 447
0x4d2: Call2 0x4f0
...
0x4e8: Push("Can't retrieve diary root") // @poff=700
0x4e9: @ Trace(Stack[-1])
0x4ea: Pop(1)
...
0x4f4: Pop(1)
0x4f5: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=752
0x4f6: Pop(0)
0x4f7: Pop(0); Push((bool) Stack[-2] == 0)
0x4f8: IF (Stack[-1] == 0) GOTO 0x4ff; Pop(1)

0x4f9: Push("Can't find diary parent with id: ") // @poff=757
...
0x4ff: @@ AddChild(Stack[-8]); Obj=2 // @poff=825
0x500: Pop(0)
0x501: Push((int) 7)
0x502: @ SendWorldWndMessage(Stack[-1])
0x503: Pop(1)
0x504: @@ GetCategory(Stack[-1]); Obj=8 // @poff=834
0x505: Pop(0)
...
0x511: Push("Can't find main outdoor scene") // @poff=846
0x512: @ Trace(Stack[-1])
0x513: Pop(1)
0x514: Stack[-1] = 0
...
0x517: @@ GetMap(Stack[-1]); Obj=2 // @poff=906
0x518: Pop(0)
...
0x522: Push("Can't find main outdoor scene") // @poff=846
0x523: @ Trace(Stack[-1])
0x524: Pop(1)
0x525: Return(); Pop(8)

0x526: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=913
0x527: Pop(0)
0x528: Pop(0); Push((bool) Stack[-1] == 0)
0x529: IF (Stack[-1] == 0) GOTO 0x530; Pop(1)

0x52a: Push("Warning: outdoor scene locator ") // @poff=924
0x52b: Pop(1); Push(Stack[-1] + Stack[-11]);
0x52c: Push(" doesnt exist") // @poff=988
0x52d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x52e: @ Trace(Stack[-1])
0x52f: Pop(1)
0x530: @@ GetMap(Stack[-11]); Obj=2 // @poff=906
0x531: Pop(0)
0x532: Pop(0); PushNull((bool) Stack[-11] == 0)
0x533: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x534: Push("Can't find map") // @poff=1016
0x535: @ Trace(Stack[-1])
0x536: Pop(1)
0x537: Return(); Pop(8)
...
0x53a: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1046
0x53b: Pop(2)
0x53c: Return(); Pop(8)

0x53d: Stack[-2] = 0
0x53e: PushEmpty(int, int)
0x53f: Push("branch") // @poff=1059
...
0x559: Stack[-11] = Stack[-5]
0x55a: Stack[-10] = Stack[-4]
0x55b: Stack[-9] = Stack[-3]
