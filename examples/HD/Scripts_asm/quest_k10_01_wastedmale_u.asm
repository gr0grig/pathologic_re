...
0x62b: Push((float)0.699999988079071)
0x62c: Push((int) 500)
...
0x636: Pop(0)
0x637: @@ add(Stack[-3]); Obj=1 // @poff=730
0x638: Pop(0)
0x639: Push((int) 16)
...
0x659: Stack[-4] = Stack[-2]
0x65a: Stack[-1] = (float) 0.05000000074505806
0x65b: Call2 0x600
...
0x666: Stack[-7] = Stack[-3]
0x667: Stack[-6] = Stack[-2]
0x668: Stack[-5] = Stack[-1]
0x669: Call2 0x54d
...
0x66e: Stack[-11] = Stack[-5]
0x66f: Stack[-10] = Stack[-4]
0x670: Stack[-9] = Stack[-3]
0x671: Stack[-7] = Stack[-2]
0x672: Stack[-6] = Stack[-1]
0x673: Call2 0x591
