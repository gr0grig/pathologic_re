...
// @pool_raw:
// @pool_encoding:utf8
...
0x15a: Stack[-2] = Stack[-5]
0x15b: Pop(2)
0x15c: Return(); Pop(2)

0x15d: Stack[-1] = 0
0x15e: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x15f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x160: @ RotateAsync(Stack[-2], Stack[-1])
0x161: Pop(2)
0x162: Return(); Pop(0)

0x163: PushEmpty(object, bool, object, bool)
0x164: Push("player") // @poff=216
...
0x1c1: Stack[-1] = "Neutral" // @poff=168
0x1c2: Call2 0x33e
...
0x1d0: Stack[-1] = "Neutral" // @poff=168
0x1d1: Call2 0x33e
...
0x1e7: Stack[-1] = "Neutral" // @poff=168
0x1e8: Call2 0x33e
...
0x23f: Pop(0)
0x240: @@ GetPosition(Stack[-2]); Obj=7 // @poff=230
0x241: Pop(0)
...
0x24c: Pop(2)
0x24d: Stack[-1] = Stack[-8]
0x24e: Return(); Pop(6)

0x24f: PushEmpty(cvector, cvector)
0x250: @@ GetPosition(Stack[-1]); Obj=3 // @poff=230
0x251: Pop(0)
0x252: PushEmpty(bool, cvector)
0x253: Stack[-3] = Stack[-1]
0x254: Call2 0x245

0x255: Stack[-2] = Stack[-6]
0x256: Pop(2)
0x257: Return(); Pop(2)
...
0x25e: @@ GetPosition(Stack[-8]); Obj=20 // @poff=230
0x25f: Pop(0)
0x260: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=242
0x261: Pop(0)
...
0x2cd: Push("voice_common") // @poff=266
0x2ce: Push((int) 1)
...
0x2d5: Push("voice_common") // @poff=266
0x2d6: Push((int) 0)
...
0x2e8: Push("voice_common") // @poff=266
0x2e9: Push((int) 1)
...
0x2f6: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0x2f7: Pop(1)
...
0x30b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=308
0x30c: Pop(1)
...
0x314: Push("d") // @poff=262
0x315: PushEmpty(int)
0x316: Call2 0x388

0x317: Pop(0)
0x318: Pop(2); Push(Stack[-2] + Stack[-1]);
0x319: Push("m") // @poff=320
...
0x321: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0x322: Pop(1)
...
0x336: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=308
0x337: Pop(1)
0x338: PushEmpty(bool, string)
0x339: Stack[-3] = Stack[-1]
0x33a: Call2 0x35d

0x33b: Stack[-2] = Stack[-14]
0x33c: Pop(2)
0x33d: Return(); Pop(10)
...
0x349: Push("Can't find lsh animation : ") // @poff=324
...
0x358: Push("Can't find lsh animation : ") // @poff=324
...
0x3a9: PushEmpty()
0x3aa: Push("ook11Andrei1") // @poff=380
0x3ab: Push((int) 1)
...
0x3b1: Stack[-1] = "ook11Andrei1" // @poff=380
0x3b2: Call2 0x383
...
0x3d0: Stack[-1] = "ui/NPC_Andrei.png" // @poff=420
0x3d1: Return(); Pop(0)

0x3d2: Stack[-1] = "ui/NPC_Andrei_b.png" // @poff=456
0x3d3: Return(); Pop(0)
