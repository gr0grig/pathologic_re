...
// @pool_raw:
// @pool_encoding:utf8
...
0x152: Stack[-1] = "Untrust" // @poff=184
0x153: Call2 0x95
...
0x373: Pop(0)
0x374: @@ GetPosition(Stack[-2]); Obj=7 // @poff=258
0x375: Pop(0)
...
0x384: @@ GetPosition(Stack[-1]); Obj=3 // @poff=258
0x385: Pop(0)
...
0x392: @@ GetPosition(Stack[-8]); Obj=20 // @poff=258
0x393: Pop(0)
0x394: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=270
0x395: Pop(0)
...
0x401: Push("voice_common") // @poff=294
0x402: Push((int) 1)
...
0x409: Push("voice_common") // @poff=294
0x40a: Push((int) 0)
...
0x41c: Push("voice_common") // @poff=294
0x41d: Push((int) 1)
...
0x42a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=324
0x42b: Pop(1)
...
0x43f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=336
0x440: Pop(1)
0x441: PushEmpty(bool, string)
0x442: Stack[-3] = Stack[-1]
0x443: Call2 0x491

0x444: Stack[-2] = Stack[-14]
0x445: Pop(2)
0x446: Return(); Pop(10)

0x447: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x448: Push("d") // @poff=290
0x449: PushEmpty(int)
0x44a: Call2 0x4bc

0x44b: Pop(0)
0x44c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x44d: Push("m") // @poff=348
...
0x455: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=324
0x456: Pop(1)
...
0x46a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=336
0x46b: Pop(1)
0x46c: PushEmpty(bool, string)
0x46d: Stack[-3] = Stack[-1]
0x46e: Call2 0x491

0x46f: Stack[-2] = Stack[-14]
0x470: Pop(2)
0x471: Return(); Pop(10)
...
0x47d: Push("Can't find lsh animation : ") // @poff=352
...
0x48c: Push("Can't find lsh animation : ") // @poff=352
...
0x4b0: Push((float)9.999999974752427e-07)
...
0x504: Push("Can't retrieve diary root") // @poff=422
0x505: @ Trace(Stack[-1])
0x506: Pop(1)
...
0x510: Pop(1)
0x511: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=474
0x512: Pop(0)
0x513: Pop(0); Push((bool) Stack[-2] == 0)
0x514: IF (Stack[-1] == 0) GOTO 0x51b; Pop(1)

0x515: Push("Can't find diary parent with id: ") // @poff=479
...
0x51b: @@ AddChild(Stack[-8]); Obj=2 // @poff=547
0x51c: Pop(0)
0x51d: Push((int) 7)
0x51e: @ SendWorldWndMessage(Stack[-1])
0x51f: Pop(1)
0x520: @@ GetCategory(Stack[-1]); Obj=8 // @poff=556
0x521: Pop(0)
...
0x53d: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=582
0x53e: Return(); Pop(0)

0x53f: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=622
0x540: Return(); Pop(0)
