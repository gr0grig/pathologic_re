...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2a2: Push("Can't find lsh animation : ") // @poff=206
...
0x2b1: Push("Can't find lsh animation : ") // @poff=206
...
0x2b7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2b8: Pop(0)
...
0x2cb: Push((float)9.999999974752427e-07)
...
0x2e7: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=262
0x2e8: Return(); Pop(0)

0x2e9: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=302
0x2ea: Return(); Pop(0)
...
0x305: PushEmpty()
0x306: Push("ook11Officer1") // @poff=346
0x307: Push((int) 1)
...
0x314: Stack[-2] = "quest_k11_01" // @poff=388
0x315: Stack[-1] = "init_house_petr" // @poff=414
0x316: Call2 0x2d7
...
0x31b: Stack[-1] = "ook11Officer1" // @poff=346
0x31c: Call2 0x2d2
...
0x337: Push("Can't retrieve diary root") // @poff=446
0x338: @ Trace(Stack[-1])
0x339: Pop(1)
...
0x343: Pop(1)
0x344: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=498
0x345: Pop(0)
0x346: Pop(0); Push((bool) Stack[-2] == 0)
0x347: IF (Stack[-1] == 0) GOTO 0x34e; Pop(1)

0x348: Push("Can't find diary parent with id: ") // @poff=503
...
0x34e: @@ AddChild(Stack[-8]); Obj=2 // @poff=571
0x34f: Pop(0)
0x350: Push((int) 7)
0x351: @ SendWorldWndMessage(Stack[-1])
0x352: Pop(1)
0x353: @@ GetCategory(Stack[-1]); Obj=8 // @poff=580
0x354: Pop(0)
