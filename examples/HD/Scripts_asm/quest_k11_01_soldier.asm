...
Strings:
	...
	W:k11q01Cured
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2aa: Push(CvectorIndex(Stack[-5], 2))
...
0x2dd: Push("Can't find lsh animation : ") // @poff=206
...
0x2ec: Push("Can't find lsh animation : ") // @poff=206
0x2ed: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2ee: @ Trace(Stack[-1])
0x2ef: Pop(1)
0x2f0: Return(); Pop(6)

0x2f1: PushEmpty(float, cvector, float, cvector)
0x2f2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2f3: Pop(0)
0x2f4: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x2f5: Push(CvectorIndex(Stack[-1], 1))
0x2f6: Stack[-3] = Stack[-1]
0x2f7: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2f8: Push("head") // @poff=170
...
0x304: Pop(0); Push(Stack[-3] | Stack[-3]);
0x305: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x306: Push((float)9.999999974752427e-07)
...
0x30b: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x30c: Return(); Pop(2)
...
0x316: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=262
0x317: Return(); Pop(0)

0x318: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=302
0x319: Return(); Pop(0)
...
0x334: PushEmpty()
0x335: Push("ook11Soldier1") // @poff=346
0x336: Push((int) 1)
...
0x33a: PushEmpty()
0x33b: Push("ook11Soldier2") // @poff=374
0x33c: Push((int) 1)
...
0x34e: Stack[-1] = "ook11Soldier1" // @poff=346
0x34f: Call2 0x30d
...
0x35a: Stack[-1] = "k11q01Cured" // @poff=416
0x35b: Call2 0x30d
...
0x366: Stack[-1] = "ook11Soldier2" // @poff=374
0x367: Call2 0x30d
