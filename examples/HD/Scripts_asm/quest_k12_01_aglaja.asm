...
// @pool_raw:
// @pool_encoding:utf8
...
0x124: Stack[-1] = "Confusion" // @poff=166
0x125: Call2 0xa5
...
0x13b: Stack[-1] = "Confusion" // @poff=166
0x13c: Call2 0xa5
...
0x1ad: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x1ae: Pop(0)
0x1af: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=230
0x1b0: Pop(0)
...
0x21c: Push("voice_common") // @poff=254
0x21d: Push((int) 1)
...
0x224: Push("voice_common") // @poff=254
0x225: Push((int) 0)
...
0x237: Push("voice_common") // @poff=254
0x238: Push((int) 1)
...
0x245: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x246: Pop(1)
...
0x270: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x271: Pop(1)
...
0x285: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=296
0x286: Pop(1)
0x287: PushEmpty(bool, string)
0x288: Stack[-3] = Stack[-1]
0x289: Call2 0x2ac

0x28a: Stack[-2] = Stack[-14]
0x28b: Pop(2)
0x28c: Return(); Pop(10)
...
0x298: Push("Can't find lsh animation : ") // @poff=312
...
0x2a7: Push("Can't find lsh animation : ") // @poff=312
...
0x2e2: Stack[-1] = "game_final" // @poff=368
0x2e3: Call2 0x2d2
...
0x301: Stack[-1] = "ui/NPC_Aglaja.png" // @poff=404
0x302: Return(); Pop(0)

0x303: Stack[-1] = "ui/NPC_Aglaja_b.png" // @poff=440
0x304: Return(); Pop(0)
