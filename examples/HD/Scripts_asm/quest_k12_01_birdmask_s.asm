...
Strings:
	...
	A:get
	W:game_final
// @pool_raw:
// @pool_encoding:utf8
...
0x8f: Stack[-1] = "Neutral" // @poff=89
0x90: Call2 0xd1

0x91: Pop(1)
0x92: Push((int) 539223)
0x93: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x94: Pop(1)
0x95: @@@ ClearReplies(); Obj=0 // @poff=116
0x96: Pop(0)
...
0x22b: Push("player") // @poff=156
0x22c: @ FindActor(Stack[-4]T, Stack[-1])
0x22d: Pop(1)
...
0x240: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2cb: Pop(0)
0x2cc: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x2cd: Pop(0)
...
0x2d7: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x2d8: Pop(0)
0x2d9: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x2da: Pop(0)
...
0x338: Push("Can't find lsh animation : ") // @poff=206
...
0x347: Push("Can't find lsh animation : ") // @poff=206
...
0x34d: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x34e: Pop(0)
...
0x361: Push((float)9.999999974752427e-07)
...
0x372: Push("Door ") // @poff=262
0x373: Pop(1); Push(Stack[-1] + Stack[-5]);
0x374: Push(" not found") // @poff=274
0x375: Pop(2); Push(Stack[-2] + Stack[-1]);
0x376: @ Trace(Stack[-1])
0x377: Pop(1)
0x378: GOTO 0x37c

0x379: Push("locked") // @poff=296
0x37a: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=310
0x37b: Pop(1)
0x37c: Return(); Pop(2)
...
0x380: Pop(0)
0x381: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3ae: Stack[-1] = "ui/NPC_bmask.png" // @poff=322
0x3af: Return(); Pop(0)

0x3b0: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=356
0x3b1: Return(); Pop(0)
...
0x3b6: Stack[-2] = "quest_k12_01" // @poff=394
0x3b7: Stack[-1] = "init_sobor" // @poff=420
0x3b8: Call2 0x37e
...
0x3bb: PushEmpty()
0x3bc: Push("ook12BirdmaskS1") // @poff=442
0x3bd: Push((int) 1)
...
0x3c3: Stack[-2] = "sobor@door1" // @poff=474
...
0x3de: Stack[-1] = "ook12BirdmaskS1" // @poff=442
0x3df: Call2 0x368
...
0x40a: PushEmpty()
0x40b: Push((int) 7)
0x40c: @@ add(Stack[-1]); Obj=4 // @poff=512
0x40d: Pop(1)
0x40e: Push((int) 23)
0x40f: @@ add(Stack[-1]); Obj=4 // @poff=512
0x410: Pop(1)
0x411: Push((int) 21)
0x412: @@ add(Stack[-1]); Obj=4 // @poff=512
0x413: Pop(1)
0x414: Push((int) 9)
0x415: @@ add(Stack[-1]); Obj=4 // @poff=512
0x416: Pop(1)
0x417: Push((int) 3)
0x418: @@ add(Stack[-1]); Obj=4 // @poff=512
0x419: Pop(1)
0x41a: Push((int) 1)
0x41b: @@ add(Stack[-1]); Obj=4 // @poff=512
0x41c: Pop(1)
0x41d: Push((int) 11)
0x41e: @@ add(Stack[-1]); Obj=4 // @poff=512
0x41f: Pop(1)
0x420: Push((int) 13)
0x421: @@ add(Stack[-1]); Obj=4 // @poff=512
0x422: Pop(1)
0x423: Push((bool) 0)
...
0x426: Push((int) 25)
0x427: @@ add(Stack[-1]); Obj=4 // @poff=512
0x428: Pop(1)
0x429: Return(); Pop(0)

0x42a: PushEmpty(int, int)
0x42b: Push("vol_") // @poff=516
...
0x442: Stack[-7] = Stack[-3]
0x443: Stack[-2] = (bool) 0
0x444: Stack[-1] = (int) -1
0x445: Call2 0x40a

0x446: Pop(3)
0x447: @@ size(Stack[-3]); Obj=4 // @poff=526
0x448: Pop(0)
0x449: Stack[-2] = (int) 0
0x44a: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x44b: IF (Stack[-1] == 0) GOTO 0x461; Pop(1)

0x44c: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=531
0x44d: Pop(0)
...
0x453: Pop(1)
0x454: IF (Stack[-1] == 1) GOTO 0x45b; Pop(1)
...
0x458: Pop(1)
0x459: IF (Stack[-1] == 1) GOTO 0x45b; Pop(1)
...
0x465: Push("game_final") // @poff=535
