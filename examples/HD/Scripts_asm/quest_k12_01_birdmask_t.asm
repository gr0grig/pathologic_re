...
Strings:
	...
	A:size
	A:get
// @pool_raw:
// @pool_encoding:utf8
...
0x64: Push((int) 539229)
0x65: Push((int) 45272)
0x66: Push((int) 41172)
0x67: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x68: Pop(3)
0x69: Push((int) 539242)
0x6a: Push((int) -1)
0x6b: Push((int) 41185)
0x6c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x6d: Pop(3)
0x6e: GOTO 0xc5
...
0x126: Push((int) 539229)
0x127: Push((int) 45272)
0x128: Push((int) 41172)
0x129: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=129
0x12a: Pop(3)
0x12b: Push((int) 539242)
0x12c: Push((int) -1)
0x12d: Push((int) 41185)
...
0x212: Push("k12q01TheaterIsVisited") // @poff=156
...
0x228: Push("player") // @poff=202
0x229: @ FindActor(Stack[-4]T, Stack[-1])
0x22a: Pop(1)
...
0x23d: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x292: Pop(0)
0x293: Push("all") // @poff=138
0x294: PushEmpty(string, int)
0x295: Stack[-7] = Stack[-1]
0x296: Call2 0x376
...
0x2c8: Pop(0)
0x2c9: @@ GetPosition(Stack[-2]); Obj=7 // @poff=226
0x2ca: Pop(0)
...
0x2d4: @@ GetPosition(Stack[-8]); Obj=20 // @poff=226
0x2d5: Pop(0)
0x2d6: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=238
0x2d7: Pop(0)
...
0x335: Push("Can't find lsh animation : ") // @poff=252
...
0x344: Push("Can't find lsh animation : ") // @poff=252
...
0x34a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=238
0x34b: Pop(0)
...
0x35e: Push((float)9.999999974752427e-07)
...
0x36c: Pop(0)
0x36d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x392: Stack[-1] = "ui/NPC_bmask.png" // @poff=308
0x393: Return(); Pop(0)

0x394: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=342
0x395: Return(); Pop(0)
...
0x398: PushEmpty()
0x399: Push("ook12BirdmaskT1") // @poff=380
0x39a: Push((int) 1)
...
0x39e: PushEmpty()
0x39f: PushEmpty(bool, string, string)
0x3a0: Stack[-2] = "quest_k12_01" // @poff=412
0x3a1: Stack[-1] = "init_theater" // @poff=438
0x3a2: Call2 0x36a
...
0x3a5: PushEmpty()
0x3a6: Push("ook12BirdmaskT2") // @poff=464
0x3a7: Push((int) 1)
...
0x3b7: Stack[-1] = "k12q01ChildsAreVisited" // @poff=496
0x3b8: Call2 0x365
...
0x3c3: Stack[-1] = "ook12BirdmaskT1" // @poff=380
0x3c4: Call2 0x365
...
0x3cf: Stack[-1] = "ook12BirdmaskT2" // @poff=464
0x3d0: Call2 0x365
...
0x3f0: PushEmpty()
0x3f1: Push((int) 18)
0x3f2: @@ add(Stack[-1]); Obj=4 // @poff=556
0x3f3: Pop(1)
0x3f4: Push((int) 24)
0x3f5: @@ add(Stack[-1]); Obj=4 // @poff=556
0x3f6: Pop(1)
0x3f7: Push((int) 20)
0x3f8: @@ add(Stack[-1]); Obj=4 // @poff=556
0x3f9: Pop(1)
0x3fa: Push((int) 14)
0x3fb: @@ add(Stack[-1]); Obj=4 // @poff=556
0x3fc: Pop(1)
0x3fd: Push((bool) 0)
...
0x400: Push((int) 10)
0x401: @@ add(Stack[-1]); Obj=4 // @poff=556
0x402: Pop(1)
0x403: Push((int) 17)
0x404: @@ add(Stack[-1]); Obj=4 // @poff=556
0x405: Pop(1)
0x406: Push((int) 8)
0x407: @@ add(Stack[-1]); Obj=4 // @poff=556
0x408: Pop(1)
0x409: GOTO 0x410
...
0x40d: Push((int) 10)
0x40e: @@ add(Stack[-1]); Obj=4 // @poff=556
0x40f: Pop(1)
0x410: Return(); Pop(0)

0x411: PushEmpty()
0x412: Push((int) 6)
0x413: @@ add(Stack[-1]); Obj=4 // @poff=556
0x414: Pop(1)
0x415: Push((int) 26)
0x416: @@ add(Stack[-1]); Obj=4 // @poff=556
0x417: Pop(1)
0x418: Push((int) 2)
0x419: @@ add(Stack[-1]); Obj=4 // @poff=556
0x41a: Pop(1)
0x41b: Push((int) 22)
0x41c: @@ add(Stack[-1]); Obj=4 // @poff=556
0x41d: Pop(1)
0x41e: Push((bool) 0)
...
0x421: Push((int) 15)
0x422: @@ add(Stack[-1]); Obj=4 // @poff=556
0x423: Pop(1)
0x424: Push((int) 5)
0x425: @@ add(Stack[-1]); Obj=4 // @poff=556
0x426: Pop(1)
0x427: Push((int) 16)
0x428: @@ add(Stack[-1]); Obj=4 // @poff=556
0x429: Pop(1)
0x42a: GOTO 0x431
...
0x42e: Push((int) 15)
0x42f: @@ add(Stack[-1]); Obj=4 // @poff=556
0x430: Pop(1)
0x431: Return(); Pop(0)

0x432: PushEmpty()
0x433: Push((int) 7)
0x434: @@ add(Stack[-1]); Obj=4 // @poff=556
0x435: Pop(1)
0x436: Push((int) 23)
0x437: @@ add(Stack[-1]); Obj=4 // @poff=556
0x438: Pop(1)
0x439: Push((int) 21)
0x43a: @@ add(Stack[-1]); Obj=4 // @poff=556
0x43b: Pop(1)
0x43c: Push((int) 9)
0x43d: @@ add(Stack[-1]); Obj=4 // @poff=556
0x43e: Pop(1)
0x43f: Push((int) 3)
0x440: @@ add(Stack[-1]); Obj=4 // @poff=556
0x441: Pop(1)
0x442: Push((int) 1)
0x443: @@ add(Stack[-1]); Obj=4 // @poff=556
0x444: Pop(1)
0x445: Push((int) 11)
0x446: @@ add(Stack[-1]); Obj=4 // @poff=556
0x447: Pop(1)
0x448: Push((int) 13)
0x449: @@ add(Stack[-1]); Obj=4 // @poff=556
0x44a: Pop(1)
0x44b: Push((bool) 0)
...
0x44e: Push((int) 25)
0x44f: @@ add(Stack[-1]); Obj=4 // @poff=556
0x450: Pop(1)
0x451: Return(); Pop(0)

0x452: PushEmpty(int, int)
0x453: Push("vol_") // @poff=560
...
0x46a: Stack[-7] = Stack[-3]
0x46b: Stack[-2] = (bool) 0
0x46c: Stack[-1] = (int) -1
0x46d: Call2 0x3f0

0x46e: Pop(3)
0x46f: @@ size(Stack[-3]); Obj=4 // @poff=570
0x470: Pop(0)
0x471: Stack[-2] = (int) 0
0x472: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x473: IF (Stack[-1] == 0) GOTO 0x489; Pop(1)

0x474: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=575
0x475: Pop(0)
...
0x47b: Pop(1)
0x47c: IF (Stack[-1] == 1) GOTO 0x483; Pop(1)
...
0x480: Pop(1)
0x481: IF (Stack[-1] == 1) GOTO 0x483; Pop(1)
...
0x490: Stack[-7] = Stack[-3]
0x491: Stack[-2] = (bool) 0
0x492: Stack[-1] = (int) -1
0x493: Call2 0x411

0x494: Pop(3)
0x495: @@ size(Stack[-3]); Obj=4 // @poff=570
0x496: Pop(0)
0x497: Stack[-2] = (int) 0
0x498: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x499: IF (Stack[-1] == 0) GOTO 0x4af; Pop(1)

0x49a: @@ get(Stack[-1], Stack[-2]); Obj=4 // @poff=575
0x49b: Pop(0)
...
0x4a1: Pop(1)
0x4a2: IF (Stack[-1] == 1) GOTO 0x4a9; Pop(1)
...
0x4a6: Pop(1)
0x4a7: IF (Stack[-1] == 1) GOTO 0x4a9; Pop(1)
...
0x4cc: Pop(1)
0x4cd: IF (Stack[-1] == 1) GOTO 0x4cf; Pop(1)
