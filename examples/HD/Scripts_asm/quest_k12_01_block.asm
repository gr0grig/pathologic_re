...
// @pool_raw:
// @pool_encoding:utf8
...
0x5e: Stack[-1] = "Doubt" // @poff=89
0x5f: Call2 0xc3

0x60: Pop(1)
0x61: Push((int) 539253)
0x62: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x63: Pop(1)
0x64: @@@ ClearReplies(); Obj=0 // @poff=112
0x65: Pop(0)
0x66: Push((int) 539254)
0x67: Push((int) 41198)
0x68: Push((int) 41197)
0x69: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x6a: Pop(3)
0x6b: Push((int) 539271)
0x6c: Push((int) 41215)
0x6d: Push((int) 41214)
0x6e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x6f: Pop(3)
...
0x76: Push((int) 41201)
0x77: Push((int) 41200)
0x78: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x79: Pop(3)
...
0x80: Push((int) 41206)
0x81: Push((int) 41205)
0x82: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x83: Pop(3)
0x84: Push((int) 540270)
0x85: Push((int) 42254)
0x86: Push((int) 42253)
0x87: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x88: Pop(3)
0x89: GOTO 0xa5

0x8a: PushEmpty(string)
0x8b: Stack[-1] = "Neutral" // @poff=134
0x8c: Call2 0xc3

0x8d: Pop(1)
0x8e: Push((int) 539276)
0x8f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x90: Pop(1)
0x91: @@@ ClearReplies(); Obj=0 // @poff=112
0x92: Pop(0)
0x93: Push((int) 539277)
0x94: Push((int) -1)
0x95: Push((int) 41220)
0x96: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x97: Pop(3)
0x98: Push((int) 542911)
0x99: Push((int) -1)
0x9a: Push((int) 45342)
0x9b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x9c: Pop(3)
0x9d: Push((int) 542912)
0x9e: Push((int) -1)
0x9f: Push((int) 45343)
0xa0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0xa1: Pop(3)
0xa2: GOTO 0xa5
...
0xb4: Push("all") // @poff=150
0xb5: Push("idle") // @poff=158
...
0xbd: Push("all") // @poff=150
0xbe: Push("idle") // @poff=158
...
0x131: Stack[-1] = "Doubt" // @poff=89
0x132: Call2 0xc3

0x133: Pop(1)
0x134: Push((int) 539253)
0x135: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x136: Pop(1)
0x137: @@@ ClearReplies(); Obj=0 // @poff=112
0x138: Pop(0)
0x139: Push((int) 539254)
0x13a: Push((int) 41198)
0x13b: Push((int) 41197)
0x13c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x13d: Pop(3)
0x13e: Push((int) 539271)
0x13f: Push((int) 41215)
0x140: Push((int) 41214)
0x141: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x142: Pop(3)
...
0x14b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x14c: Pop(3)
...
0x155: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x156: Pop(3)
0x157: Push((int) 540270)
0x158: Push((int) 42254)
0x159: Push((int) 42253)
0x15a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x15b: Pop(3)
0x15c: Return(); Pop(0)

0x15d: PushEmpty(string)
0x15e: Stack[-1] = "Neutral" // @poff=134
0x15f: Call2 0xc3

0x160: Pop(1)
0x161: Push((int) 539276)
0x162: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x163: Pop(1)
0x164: @@@ ClearReplies(); Obj=0 // @poff=112
0x165: Pop(0)
0x166: Push((int) 539277)
0x167: Push((int) -1)
0x168: Push((int) 41220)
0x169: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x16a: Pop(3)
0x16b: Push((int) 542911)
0x16c: Push((int) -1)
0x16d: Push((int) 45342)
0x16e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x16f: Pop(3)
0x170: Push((int) 542912)
0x171: Push((int) -1)
0x172: Push((int) 45343)
0x173: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x174: Pop(3)
0x175: Return(); Pop(0)
...
0x17a: Stack[-1] = "Neutral" // @poff=134
0x17b: Call2 0xc3

0x17c: Pop(1)
0x17d: Push((int) 540271)
0x17e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x17f: Pop(1)
0x180: @@@ ClearReplies(); Obj=0 // @poff=112
0x181: Pop(0)
0x182: Push((int) 542922)
0x183: Push((int) 45358)
0x184: Push((int) 45356)
0x185: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x186: Pop(3)
0x187: Push((int) 542923)
0x188: Push((int) 45358)
0x189: Push((int) 45357)
0x18a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x18b: Pop(3)
0x18c: Push((int) 542925)
0x18d: Push((int) 45358)
0x18e: Push((int) 45359)
0x18f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x190: Pop(3)
0x191: Return(); Pop(0)
...
0x196: Stack[-1] = "Doubt" // @poff=89
0x197: Call2 0xc3

0x198: Pop(1)
0x199: Push((int) 542924)
0x19a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x19b: Pop(1)
0x19c: @@@ ClearReplies(); Obj=0 // @poff=112
0x19d: Pop(0)
0x19e: Push((int) 540272)
0x19f: Push((int) -1)
0x1a0: Push((int) 42255)
0x1a1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1a2: Pop(3)
0x1a3: Return(); Pop(0)
...
0x1a8: Stack[-1] = "Neutral" // @poff=134
0x1a9: Call2 0xc3

0x1aa: Pop(1)
0x1ab: Push((int) 539263)
0x1ac: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1ad: Pop(1)
0x1ae: @@@ ClearReplies(); Obj=0 // @poff=112
0x1af: Pop(0)
0x1b0: Push((int) 542926)
0x1b1: Push((int) 45363)
0x1b2: Push((int) 45362)
0x1b3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1b4: Pop(3)
0x1b5: Return(); Pop(0)
...
0x1ba: Stack[-1] = "Doubt" // @poff=89
0x1bb: Call2 0xc3

0x1bc: Pop(1)
0x1bd: Push((int) 542927)
0x1be: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1bf: Pop(1)
0x1c0: @@@ ClearReplies(); Obj=0 // @poff=112
0x1c1: Pop(0)
0x1c2: Push((int) 539270)
0x1c3: Push((int) -1)
0x1c4: Push((int) 41213)
0x1c5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1c6: Pop(3)
0x1c7: Return(); Pop(0)
...
0x1cc: Stack[-1] = "Untrust" // @poff=168
0x1cd: Call2 0xc3

0x1ce: Pop(1)
0x1cf: Push((int) 539258)
0x1d0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1d1: Pop(1)
0x1d2: @@@ ClearReplies(); Obj=0 // @poff=112
0x1d3: Pop(0)
0x1d4: Push((int) 539259)
0x1d5: Push((int) 41203)
0x1d6: Push((int) 41202)
0x1d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1d8: Pop(3)
0x1d9: Return(); Pop(0)
...
0x1de: Stack[-1] = "Untrust" // @poff=168
0x1df: Call2 0xc3

0x1e0: Pop(1)
0x1e1: Push((int) 539260)
0x1e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1e3: Pop(1)
0x1e4: @@@ ClearReplies(); Obj=0 // @poff=112
0x1e5: Pop(0)
0x1e6: Push((int) 539261)
0x1e7: Push((int) -1)
0x1e8: Push((int) 41204)
0x1e9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1ea: Pop(3)
0x1eb: Return(); Pop(0)
...
0x1f0: Stack[-1] = "Neutral" // @poff=134
0x1f1: Call2 0xc3

0x1f2: Pop(1)
0x1f3: Push((int) 539272)
0x1f4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x1f5: Pop(1)
0x1f6: @@@ ClearReplies(); Obj=0 // @poff=112
0x1f7: Pop(0)
0x1f8: Push((int) 539273)
0x1f9: Push((int) 41217)
0x1fa: Push((int) 41216)
0x1fb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x1fc: Pop(3)
0x1fd: Push((int) 542914)
0x1fe: Push((int) 45346)
0x1ff: Push((int) 45345)
0x200: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x201: Pop(3)
0x202: Return(); Pop(0)
...
0x207: Stack[-1] = "Neutral" // @poff=134
0x208: Call2 0xc3

0x209: Pop(1)
0x20a: Push((int) 542915)
0x20b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x20c: Pop(1)
0x20d: @@@ ClearReplies(); Obj=0 // @poff=112
0x20e: Pop(0)
0x20f: Push((int) 542916)
0x210: Push((int) 41217)
0x211: Push((int) 45347)
0x212: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x213: Pop(3)
0x214: Return(); Pop(0)
...
0x219: Stack[-1] = "Neutral" // @poff=134
0x21a: Call2 0xc3

0x21b: Pop(1)
0x21c: Push((int) 539274)
0x21d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x21e: Pop(1)
0x21f: @@@ ClearReplies(); Obj=0 // @poff=112
0x220: Pop(0)
0x221: Push((int) 539275)
0x222: Push((int) -1)
0x223: Push((int) 41218)
0x224: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x225: Pop(3)
0x226: Return(); Pop(0)

0x227: PushEmpty(string)
0x228: Stack[-1] = "Neutral" // @poff=134
0x229: Call2 0xc3

0x22a: Pop(1)
0x22b: Push((int) 542917)
0x22c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x22d: Pop(1)
0x22e: @@@ ClearReplies(); Obj=0 // @poff=112
0x22f: Pop(0)
0x230: Push((int) 542918)
0x231: Push((int) 41217)
0x232: Push((int) 45349)
0x233: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x234: Pop(3)
0x235: Push((int) 542919)
0x236: Push((int) 45351)
0x237: Push((int) 45350)
0x238: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x239: Pop(3)
0x23a: Return(); Pop(0)
...
0x23f: Stack[-1] = "Neutral" // @poff=134
0x240: Call2 0xc3

0x241: Pop(1)
0x242: Push((int) 542920)
0x243: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x244: Pop(1)
0x245: @@@ ClearReplies(); Obj=0 // @poff=112
0x246: Pop(0)
0x247: Push((int) 542921)
0x248: Push((int) 41217)
0x249: Push((int) 45352)
0x24a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x24b: Pop(3)
0x24c: Return(); Pop(0)
...
0x251: Stack[-1] = "Untrust" // @poff=168
0x252: Call2 0xc3

0x253: Pop(1)
0x254: Push((int) 539255)
0x255: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=101
0x256: Pop(1)
0x257: @@@ ClearReplies(); Obj=0 // @poff=112
0x258: Pop(0)
0x259: Push((int) 539256)
0x25a: Push((int) -1)
0x25b: Push((int) 41199)
0x25c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x25d: Pop(3)
0x25e: Push((int) 542913)
0x25f: Push((int) -1)
0x260: Push((int) 45344)
0x261: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=125
0x262: Pop(3)
0x263: Return(); Pop(0)
...
0x2b0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=216
0x2b1: Pop(0)
0x2b2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=228
0x2b3: Pop(0)
...
0x31f: Push("voice_common") // @poff=252
0x320: Push((int) 1)
...
0x327: Push("voice_common") // @poff=252
0x328: Push((int) 0)
...
0x33a: Push("voice_common") // @poff=252
0x33b: Push((int) 1)
...
0x348: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x349: Pop(1)
...
0x373: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x374: Pop(1)
...
0x388: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=294
0x389: Pop(1)
...
0x39b: Push("Can't find lsh animation : ") // @poff=310
...
0x3aa: Push("Can't find lsh animation : ") // @poff=310
...
0x3ce: Push((float)9.999999974752427e-07)
...
0x3df: Push("Door ") // @poff=366
0x3e0: Pop(1); Push(Stack[-1] + Stack[-5]);
0x3e1: Push(" not found") // @poff=378
0x3e2: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3e3: @ Trace(Stack[-1])
0x3e4: Pop(1)
0x3e5: GOTO 0x3e9

0x3e6: Push("locked") // @poff=400
0x3e7: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=414
0x3e8: Pop(1)
0x3e9: Return(); Pop(2)
...
0x3f4: PushEmpty()
0x3f5: Push("game_final") // @poff=426
0x3f6: Push((int) 1)
...
0x3fa: PushEmpty()
0x3fb: Push("game_final") // @poff=426
0x3fc: Push((int) 2)
...
0x400: PushEmpty()
0x401: Push("game_final") // @poff=426
0x402: Push((int) 3)
...
0x408: Stack[-2] = "isobor@door1" // @poff=448
...
0x41c: PushEmpty()
0x41d: Push("game_final") // @poff=426
0x41e: Push((int) 4)
...
0x429: Stack[-1] = "game_final" // @poff=426
0x42a: Call2 0x3d5
...
0x435: Stack[-1] = "k12q01BurahInSobor" // @poff=474
0x436: Call2 0x3d5
...
0x441: Stack[-1] = "k12q01DankoInSobor" // @poff=512
0x442: Call2 0x3d5
...
0x484: Push("Can't retrieve diary root") // @poff=550
0x485: @ Trace(Stack[-1])
0x486: Pop(1)
0x487: Stack[-3] = (bool) 0
0x488: Return(); Pop(2)

0x489: Stack[-1] = Stack[-3]
0x48a: Return(); Pop(2)
...
0x490: Pop(1)
0x491: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=602
0x492: Pop(0)
0x493: Pop(0); Push((bool) Stack[-2] == 0)
0x494: IF (Stack[-1] == 0) GOTO 0x49b; Pop(1)

0x495: Push("Can't find diary parent with id: ") // @poff=607
...
0x49b: @@ AddChild(Stack[-8]); Obj=2 // @poff=675
0x49c: Pop(0)
0x49d: Push((int) 7)
0x49e: @ SendWorldWndMessage(Stack[-1])
0x49f: Pop(1)
0x4a0: @@ GetCategory(Stack[-1]); Obj=8 // @poff=684
0x4a1: Pop(0)
...
0x4bd: Stack[-1] = "ui/NPC_Block.png" // @poff=710
0x4be: Return(); Pop(0)

0x4bf: Stack[-1] = "ui/NPC_Block_b.png" // @poff=744
0x4c0: Return(); Pop(0)
