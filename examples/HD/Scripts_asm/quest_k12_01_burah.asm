...
// @pool_raw:
// @pool_encoding:utf8
...
0x1d0: @@ GetPosition(Stack[-8]); Obj=20 // @poff=214
0x1d1: Pop(0)
0x1d2: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=226
0x1d3: Pop(0)
...
0x222: Push("head") // @poff=240
0x223: @ UnlookAsync(Stack[-1])
0x224: Pop(1)
0x225: Return(); Pop(2)

0x226: PushEmpty(int, int, int, int)
0x227: Push("voice_common") // @poff=250
...
0x23f: Push("voice_common") // @poff=250
0x240: Push((int) 1)
...
0x247: Push("voice_common") // @poff=250
0x248: Push((int) 0)
...
0x25a: Push("voice_common") // @poff=250
0x25b: Push((int) 1)
...
0x268: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=280
0x269: Pop(1)
...
0x293: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=280
0x294: Pop(1)
...
0x2a8: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=292
0x2a9: Pop(1)
0x2aa: PushEmpty(bool, string)
0x2ab: Stack[-3] = Stack[-1]
0x2ac: Call2 0x2cf

0x2ad: Stack[-2] = Stack[-14]
0x2ae: Pop(2)
0x2af: Return(); Pop(10)
...
0x2bb: Push("Can't find lsh animation : ") // @poff=308
...
0x2ca: Push("Can't find lsh animation : ") // @poff=308
...
0x2ee: Push((float)9.999999974752427e-07)
...
0x303: PushEmpty()
0x304: Push("ook12BurahSobor1") // @poff=364
0x305: Push((int) 1)
...
0x30b: Stack[-1] = "game_final" // @poff=398
0x30c: Call2 0x2f5
...
0x317: Stack[-1] = "ook12BurahSobor1" // @poff=364
0x318: Call2 0x2f5
...
0x336: Stack[-1] = "ui/NPC_Burah.png" // @poff=434
0x337: Return(); Pop(0)

0x338: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=468
0x339: Return(); Pop(0)
