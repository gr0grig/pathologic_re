...
// @pool_raw:
// @pool_encoding:utf8
...
0x1ec: @@ GetPosition(Stack[-8]); Obj=20 // @poff=202
0x1ed: Pop(0)
0x1ee: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=214
0x1ef: Pop(0)
...
0x25b: Push("voice_common") // @poff=238
0x25c: Push((int) 1)
...
0x263: Push("voice_common") // @poff=238
0x264: Push((int) 0)
...
0x276: Push("voice_common") // @poff=238
0x277: Push((int) 1)
...
0x284: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x285: Pop(1)
...
0x2af: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=268
0x2b0: Pop(1)
...
0x2c4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=280
0x2c5: Pop(1)
0x2c6: PushEmpty(bool, string)
0x2c7: Stack[-3] = Stack[-1]
0x2c8: Call2 0x2eb

0x2c9: Stack[-2] = Stack[-14]
0x2ca: Pop(2)
0x2cb: Return(); Pop(10)
...
0x2d7: Push("Can't find lsh animation : ") // @poff=296
...
0x2e6: Push("Can't find lsh animation : ") // @poff=296
...
0x30a: Push((float)9.999999974752427e-07)
...
0x31f: PushEmpty()
0x320: Push("ook12DankoSobor1") // @poff=352
0x321: Push((int) 1)
...
0x327: Stack[-1] = "game_final" // @poff=386
0x328: Call2 0x311
...
0x333: Stack[-1] = "ook12DankoSobor1" // @poff=352
0x334: Call2 0x311
...
0x352: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=422
0x353: Return(); Pop(0)

0x354: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=462
0x355: Return(); Pop(0)
