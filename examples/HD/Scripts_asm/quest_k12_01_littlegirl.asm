...
// @pool_raw:
// @pool_encoding:utf8
...
0x1f0: Push("player") // @poff=172
0x1f1: @ FindActor(Stack[-4]T, Stack[-1])
0x1f2: Pop(1)
...
0x205: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x29c: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x29d: Pop(0)
0x29e: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x29f: Pop(0)
...
0x2c5: Pop(0)
0x2c6: Push((bool) 1)
0x2c7: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2c8: Pop(1)
...
0x2e1: Push((bool) 1)
0x2e2: @ CameraSwitchToNormal(Stack[-1])
0x2e3: Pop(1)
...
0x2fd: Push("Can't find lsh animation : ") // @poff=222
...
0x30c: Push("Can't find lsh animation : ") // @poff=222
...
0x312: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x313: Pop(0)
...
0x338: PushEmpty()
0x339: Push("ook12Littlegirl1") // @poff=278
0x33a: Push((int) 1)
...
0x340: Stack[-1] = "ook12Littlegirl1" // @poff=278
0x341: Call2 0x333
...
0x35b: Stack[-1] = (int) 515561
0x35c: Return(); Pop(0)

0x35d: Stack[-1] = (int) 503346
0x35e: Return(); Pop(0)

0x35f: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=326
0x360: Return(); Pop(0)

0x361: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=366
0x362: Return(); Pop(0)

0x363: Stack[-1] = (bool) 0
0x364: Return(); Pop(0)

0x365: PushEmpty(string, string)
0x366: Stack[-1] = "idle" // @poff=146
0x367: Push(Stack[-3])
0x368: IF (Stack[-1] == 0) GOTO 0x36a; Pop(1)

0x369: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x36a: Stack[-1] = Stack[-4]
0x36b: Return(); Pop(2)

0x36c: PushEmpty(int, bool, int, bool)
0x36d: Stack[-2] = (int) 0
0x36e: Push("all") // @poff=138
0x36f: PushEmpty(string, int)
0x370: Stack[-5] = Stack[-1]
0x371: Call2 0x365

0x372: Pop(1)
0x373: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x374: Pop(2)
...
0x378: Push((int) 1)
0x379: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x37a: GOTO 0x36e

0x37b: Stack[-2] = Stack[-5]
0x37c: Return(); Pop(4)
