...
// @pool_raw:
// @pool_encoding:utf8
...
0x3c7: Stack[-1] = "Neutral" // @poff=89
0x3c8: Call2 0xa2

0x3c9: Pop(1)
0x3ca: Push((int) 541374)
0x3cb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x3cc: Pop(1)
0x3cd: @@@ ClearReplies(); Obj=0 // @poff=116
0x3ce: Pop(0)
...
0x415: Stack[-8] = Stack[-2]
0x416: Stack[-7] = Stack[-1]
0x417: Call2 0x44f
...
0x456: Push("player") // @poff=172
0x457: @ FindActor(Stack[-4]T, Stack[-1])
0x458: Pop(1)
...
0x46b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x4f6: Pop(0)
0x4f7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x4f8: Pop(0)
...
0x502: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x503: Pop(0)
0x504: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x505: Pop(0)
...
0x563: Push("Can't find lsh animation : ") // @poff=222
...
0x572: Push("Can't find lsh animation : ") // @poff=222
...
0x578: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x579: Pop(0)
...
0x592: Push((float)9.999999974752427e-07)
...
0x5a3: Push("Door ") // @poff=278
0x5a4: Pop(1); Push(Stack[-1] + Stack[-5]);
0x5a5: Push(" not found") // @poff=290
0x5a6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x5a7: @ Trace(Stack[-1])
0x5a8: Pop(1)
0x5a9: GOTO 0x5ad

0x5aa: Push("locked") // @poff=312
0x5ab: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x5ac: Pop(1)
0x5ad: Return(); Pop(2)

0x5ae: Stack[-1] = 0
0x5af: PushEmpty(string, string)
0x5b0: Stack[-1] = "idle" // @poff=146
0x5b1: Push(Stack[-3])
...
0x5b7: Stack[-2] = (int) 0
0x5b8: Push("all") // @poff=138
0x5b9: PushEmpty(string, int)
0x5ba: Stack[-5] = Stack[-1]
0x5bb: Call2 0x5af
...
0x5c5: Stack[-2] = Stack[-5]
0x5c6: Return(); Pop(4)

0x5c7: PushEmpty()
0x5c8: PushEmpty(string, bool)
0x5c9: Stack[-2] = "itheater@door1" // @poff=338
...
0x5ce: PushEmpty()
0x5cf: Push("ook12TBirdmask1") // @poff=368
0x5d0: Push((int) 1)
...
0x5d4: PushEmpty()
0x5d5: Push("ook12TBirdmask2") // @poff=400
0x5d6: Push((int) 1)
...
0x5dc: Stack[-1] = "k12DankoVisit" // @poff=432
0x5dd: Call2 0x599
...
0x5e8: Stack[-1] = "ook12TBirdmask1" // @poff=368
0x5e9: Call2 0x599
...
0x5f4: Stack[-1] = "ook12TBirdmask2" // @poff=400
0x5f5: Call2 0x599
...
0x600: Stack[-1] = "k12BurahVisit" // @poff=460
0x601: Call2 0x599
...
0x61f: Stack[-1] = "ui/NPC_bmask.png" // @poff=502
0x620: Return(); Pop(0)

0x621: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=536
0x622: Return(); Pop(0)
