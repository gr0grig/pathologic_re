...
// @pool_raw:
// @pool_encoding:utf8
...
0x1d3: Stack[-8] = Stack[-2]
0x1d4: Stack[-7] = Stack[-1]
0x1d5: Call2 0x20d
...
0x321: Push("Can't find lsh animation : ") // @poff=222
...
0x330: Push("Can't find lsh animation : ") // @poff=222
...
0x336: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x337: Pop(0)
...
0x350: Push((float)9.999999974752427e-07)
...
0x361: Push("Door ") // @poff=278
0x362: Pop(1); Push(Stack[-1] + Stack[-5]);
0x363: Push(" not found") // @poff=290
0x364: Pop(2); Push(Stack[-2] + Stack[-1]);
0x365: @ Trace(Stack[-1])
0x366: Pop(1)
0x367: GOTO 0x36b

0x368: Push("locked") // @poff=312
0x369: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=326
0x36a: Pop(1)
0x36b: Return(); Pop(2)

0x36c: Stack[-1] = 0
0x36d: PushEmpty(string, string)
0x36e: Stack[-1] = "idle" // @poff=146
0x36f: Push(Stack[-3])
...
0x383: Stack[-2] = Stack[-5]
0x384: Return(); Pop(4)

0x385: PushEmpty()
0x386: PushEmpty(string, bool)
0x387: Stack[-2] = "itheater@door1" // @poff=338
...
0x38c: PushEmpty()
0x38d: Push("ook12TWhitemask1") // @poff=368
0x38e: Push((int) 1)
...
0x394: Stack[-1] = "ook12TWhitemask1" // @poff=368
0x395: Call2 0x357
...
0x3b3: Stack[-1] = "ui/NPC_wmask.png" // @poff=416
0x3b4: Return(); Pop(0)

0x3b5: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=450
0x3b6: Return(); Pop(0)
