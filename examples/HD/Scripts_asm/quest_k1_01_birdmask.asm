...
Strings:
	...
	W:remove_birdmask
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x20a: Push("player") // @poff=156
0x20b: @ FindActor(Stack[-4]T, Stack[-1])
0x20c: Pop(1)
...
0x21f: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2aa: Pop(0)
0x2ab: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x2ac: Pop(0)
...
0x2b6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x2b7: Pop(0)
0x2b8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x2b9: Pop(0)
...
0x317: Push("Can't find lsh animation : ") // @poff=206
...
0x326: Push("Can't find lsh animation : ") // @poff=206
...
0x32c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x32d: Pop(0)
...
0x340: Push((float)9.999999974752427e-07)
...
0x349: Pop(0)
0x34a: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x357: Stack[-1] = "ui/NPC_bmask.png" // @poff=262
0x358: Return(); Pop(0)

0x359: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=296
0x35a: Return(); Pop(0)
...
0x377: Stack[-2] = "quest_k1_01" // @poff=334
0x378: Stack[-1] = "remove_birdmask" // @poff=358
0x379: Call2 0x347
