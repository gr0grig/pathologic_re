...
// @pool_raw:
// @pool_encoding:utf8
...
0x1ff: Stack[-1] = "Untrust" // @poff=182
0x200: Call2 0xe3
...
0x25a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=230
0x25b: Pop(0)
0x25c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=242
0x25d: Pop(0)
...
0x2c9: Push("voice_common") // @poff=266
0x2ca: Push((int) 1)
...
0x2d1: Push("voice_common") // @poff=266
0x2d2: Push((int) 0)
...
0x2e4: Push("voice_common") // @poff=266
0x2e5: Push((int) 1)
...
0x2f2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0x2f3: Pop(1)
...
0x31d: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=296
0x31e: Pop(1)
...
0x332: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=308
0x333: Pop(1)
...
0x345: Push("Can't find lsh animation : ") // @poff=324
...
0x354: Push("Can't find lsh animation : ") // @poff=324
...
0x378: Push((float)9.999999974752427e-07)
...
0x38d: PushEmpty()
0x38e: Push("ook1Danko1") // @poff=380
0x38f: Push((int) 1)
...
0x393: PushEmpty()
0x394: Push("ook1Danko2") // @poff=402
0x395: Push((int) 1)
...
0x3a7: Stack[-1] = "k1q01Healed" // @poff=436
0x3a8: Call2 0x37f
...
0x3b3: Stack[-1] = "ook1Danko1" // @poff=380
0x3b4: Call2 0x37f
...
0x3bf: Stack[-1] = "ook1Danko2" // @poff=402
0x3c0: Call2 0x37f
...
0x3de: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=474
0x3df: Return(); Pop(0)

0x3e0: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=514
0x3e1: Return(); Pop(0)
