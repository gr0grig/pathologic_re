...
Strings:
	...
	W:quest_k1_01
	W:doberman_dead
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x535 Vars = (object, int, float, float)
EVENT_43 Op = 0x53d Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x547 Vars = (object, string)
EVENT_41 Op = 0x554 Vars = (object)
...
0x156: Stack[-1] = "Neutral" // @poff=89
0x157: Call2 0xa6

0x158: Pop(1)
0x159: Push((int) 526785)
0x15a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x15b: Pop(1)
0x15c: @@@ ClearReplies(); Obj=0 // @poff=116
0x15d: Pop(0)
...
0x22e: Push("player") // @poff=156
0x22f: @ FindActor(Stack[-4]T, Stack[-1])
0x230: Pop(1)
...
0x243: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x2f1: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2f2: IF (Stack[-1] == 0) GOTO 0x2f8; Pop(1)

0x2f3: PushEmpty(string)
0x2f4: Stack[-1] = "fdie" // @poff=198
0x2f5: Call2 0x34b

0x2f6: Pop(1)
0x2f7: GOTO 0x34a

0x2f8: @@ GetPosition(Stack[-10]); Obj=21 // @poff=208
0x2f9: Pop(0)
...
0x309: Stack[-6] = "fdie" // @poff=198
0x30a: GOTO 0x30c

0x30b: Stack[-6] = "bdie" // @poff=220
...
0x312: @ StopAsync()
0x313: Pop(0)
0x314: Stack[-21] = Stack[-5]
0x315: Push("GetScriptProperty") // @poff=230
0x316: Push((int) 2)
0x317: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x318: IF (Stack[-1] == 0) GOTO 0x324; Pop(1)

0x319: Push("Owner") // @poff=266
0x31a: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=278
0x31b: Pop(1)
0x31c: Push(Stack[-4])
0x31d: IF (Stack[-1] == 0) GOTO 0x324; Pop(1)

0x31e: Push("Owner") // @poff=266
0x31f: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=296
0x320: Pop(1)
0x321: Pop(0); PushNull((bool) Stack[-5] == 0)
0x322: IF (Stack[-1] == 0) GOTO 0x324; Pop(1)

0x323: Stack[-21] = Stack[-5]
0x324: Push("@GetEyesHeight") // @poff=314
0x325: Push((int) 1)
0x326: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x327: IF (Stack[-1] == 0) GOTO 0x333; Pop(1)

0x328: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=344
0x329: Pop(0)
...
0x36d: Pop(0)
0x36e: @@ GetPosition(Stack[-1]); Obj=5 // @poff=208
0x36f: Pop(0)
...
0x374: Pop(0)
0x375: @@ GetPosition(Stack[-2]); Obj=7 // @poff=208
0x376: Pop(0)
...
0x37b: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x389: @@ GetPosition(Stack[-5]); Obj=15 // @poff=208
0x38a: Pop(0)
...
0x39a: Stack[-1] = "fhit" // @poff=358
0x39b: GOTO 0x39d

0x39c: Stack[-1] = "bhit" // @poff=368
0x39d: Push("hit_react") // @poff=378
0x39e: Push("1") // @poff=398
0x39f: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3a0: Push("2") // @poff=402
...
0x3b9: Stack[-25] = Stack[-1]
0x3ba: Call2 0x36b

0x3bb: Stack[-2] = Stack[-3]
0x3bc: Pop(2)
0x3bd: Call2 0x4ae
...
0x3d8: Pop(0)
0x3d9: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=415
0x3da: Pop(0)
0x3db: PushEmpty(object, int, float, cvector, cvector)
0x3dc: Stack[-26] = Stack[-5]
0x3dd: Stack[-25] = Stack[-4]
0x3de: Stack[-24] = Stack[-3]
...
0x3fe: @@ GetPosition(Stack[-8]); Obj=20 // @poff=208
0x3ff: Pop(0)
0x400: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=344
0x401: Pop(0)
...
0x427: Pop(0)
0x428: Push((bool) 1)
0x429: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x42a: Pop(1)
0x42b: Push(CvectorIndex(Stack[-4], 0))
0x42c: Push(CvectorIndex(Stack[-5], 2))
0x42d: @ Rotate(Stack[-2], Stack[-1])
0x42e: Pop(2)
...
0x434: Push("head") // @poff=170
0x435: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x436: Pop(1)
0x437: Push(Stack[-1])
0x438: IF (Stack[-1] == 0) GOTO 0x43c; Pop(1)

0x439: Push("head") // @poff=170
0x43a: @ LookAsyncCamera(Stack[-1])
0x43b: Pop(1)
0x43c: @ CameraWaitForPlayFinish()
0x43d: Pop(0)
0x43e: @ ResumeWorld()
0x43f: Pop(0)
0x440: Stack[-21] = (bool) 1
0x441: Return(); Pop(18)

0x442: PushEmpty(bool, bool)
0x443: Push((bool) 1)
0x444: @ CameraSwitchToNormal(Stack[-1])
0x445: Pop(1)
...
0x44b: Push("head") // @poff=170
0x44c: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x44d: Pop(1)
0x44e: Push(Stack[-1])
0x44f: IF (Stack[-1] == 0) GOTO 0x453; Pop(1)

0x450: Push("head") // @poff=170
0x451: @ UnlookAsync(Stack[-1])
0x452: Pop(1)
0x453: Return(); Pop(2)

0x454: PushEmpty(bool, float, float, bool, float, float)
0x455: @ lshHasAnimation(Stack[-3], Stack[-7])
0x456: Pop(0)
0x457: Push(Stack[-3])
0x458: IF (Stack[-1] == 0) GOTO 0x45f; Pop(1)

0x459: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x45a: Pop(0)
0x45b: Push((bool) 0)
0x45c: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x45d: Pop(1)
0x45e: GOTO 0x463

0x45f: Push("Can't find lsh animation : ") // @poff=465
0x460: Pop(1); Push(Stack[-1] + Stack[-8]);
0x461: @ Trace(Stack[-1])
0x462: Pop(1)
0x463: Return(); Pop(6)

0x464: PushEmpty(bool, float, float, bool, float, float)
0x465: @ lshHasAnimation(Stack[-3], Stack[-8])
0x466: Pop(0)
0x467: Push(Stack[-3])
0x468: IF (Stack[-1] == 0) GOTO 0x46e; Pop(1)

0x469: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x46a: Pop(0)
0x46b: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x46c: Pop(0)
0x46d: GOTO 0x472

0x46e: Push("Can't find lsh animation : ") // @poff=465
0x46f: Pop(1); Push(Stack[-1] + Stack[-9]);
0x470: @ Trace(Stack[-1])
0x471: Pop(1)
0x472: Return(); Pop(6)

0x473: PushEmpty(float, cvector, float, cvector)
0x474: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=344
0x475: Pop(0)
0x476: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x477: Push(CvectorIndex(Stack[-1], 1))
0x478: Stack[-3] = Stack[-1]
0x479: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x47a: Push("head") // @poff=170
0x47b: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x47c: Pop(1)
0x47d: Return(); Pop(4)
...
0x485: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x486: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x487: Pop(0)
...
0x48a: Stack[-7] = (int) 0
0x48b: Push((int) 1)
0x48c: Pop(1); Push(Stack[-8] + Stack[-1]);
0x48d: Pop(1); Push(Stack[-18] + Stack[-1]);
0x48e: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x48f: Pop(1)
0x490: Pop(0); Push((bool) Stack[-6] == 0)
0x491: IF (Stack[-1] == 0) GOTO 0x493; Pop(1)

0x492: GOTO 0x496

0x493: Push((int) 1)
0x494: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x495: GOTO 0x48b

0x496: Pop(0); Push((bool) Stack[-7] == 0)
0x497: IF (Stack[-1] == 0) GOTO 0x499; Pop(1)

0x498: Return(); Pop(16)

0x499: @ irand(Stack[-5], Stack[-7])
0x49a: Pop(0)
0x49b: Push((int) 1)
0x49c: Pop(1); Push(Stack[-6] + Stack[-1]);
0x49d: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x49e: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x49f: Pop(0)
0x4a0: Push(Stack[-4])
0x4a1: IF (Stack[-1] == 0) GOTO 0x4ad; Pop(1)

0x4a2: @ GetEyesHeight(Stack[-3])
0x4a3: Pop(0)
0x4a4: @ GetDirection(Stack[-2])
0x4a5: Pop(0)
0x4a6: Push((int) 50)
0x4a7: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x4a8: Push(CvectorIndex(Stack[-1], 1))
0x4a9: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x4aa: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4ab: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x4ac: Pop(0)
0x4ad: Return(); Pop(16)

0x4ae: PushEmpty(float, float)
0x4af: Pop(0); Push(Stack[-3] | Stack[-3]);
0x4b0: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x4b1: Push((float)9.999999974752427e-07)
0x4b2: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x4b3: IF (Stack[-1] == 0) GOTO 0x4b6; Pop(1)

0x4b4: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x4b5: Return(); Pop(2)

0x4b6: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x4b7: Return(); Pop(2)

0x4b8: PushEmpty(int, int)
0x4b9: @ GetVariable(Stack[-3], Stack[-1])
0x4ba: Pop(0)
0x4bb: Stack[-1] = Stack[-4]
0x4bc: Return(); Pop(2)

0x4bd: PushEmpty(object, object)
0x4be: @ FindActor(Stack[-1], Stack[-4])
0x4bf: Pop(0)
0x4c0: Pop(0); PushNull((bool) Stack[-1] == 0)
0x4c1: IF (Stack[-1] == 0) GOTO 0x4c4; Pop(1)

0x4c2: Stack[-5] = (bool) 0
0x4c3: Return(); Pop(2)

0x4c4: @ Trigger(Stack[-1], Stack[-3])
0x4c5: Pop(0)
0x4c6: Stack[-5] = (bool) 1
0x4c7: Return(); Pop(2)

0x4c8: Stack[-1] = 0
0x4c9: PushEmpty(string, string)
0x4ca: Stack[-1] = "idle" // @poff=146
0x4cb: Push(Stack[-3])
0x4cc: IF (Stack[-1] == 0) GOTO 0x4ce; Pop(1)

0x4cd: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x4ce: Stack[-1] = Stack[-4]
0x4cf: Return(); Pop(2)

0x4d0: PushEmpty(int, bool, int, bool)
0x4d1: Stack[-2] = (int) 0
0x4d2: Push("all") // @poff=138
0x4d3: PushEmpty(string, int)
0x4d4: Stack[-5] = Stack[-1]
0x4d5: Call2 0x4c9

0x4d6: Pop(1)
0x4d7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x4d8: Pop(2)
...
0x4dc: Push((int) 1)
0x4dd: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x4de: GOTO 0x4d2

0x4df: Stack[-2] = Stack[-5]
0x4e0: Return(); Pop(4)

0x4e1: PushEmpty()
0x4e2: Push("ook1Lisa1") // @poff=521
0x4e3: Push((int) 1)
0x4e4: @ SetVariable(Stack[-2], Stack[-1])
0x4e5: Pop(2)
0x4e6: Return(); Pop(0)

0x4e7: PushEmpty()
0x4e8: PushEmpty(int, string)
0x4e9: Stack[-1] = "k1q01" // @poff=541
0x4ea: Call2 0x4b8

0x4eb: Pop(1)
0x4ec: Push((int) 4)
0x4ed: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x4ee: IF (Stack[-1] == 0) GOTO 0x4f1; Pop(1)

0x4ef: Stack[-2] = (bool) 1
0x4f0: Return(); Pop(0)

0x4f1: Stack[-2] = (bool) 0
0x4f2: Return(); Pop(0)

0x4f3: PushEmpty()
0x4f4: PushEmpty(int, string)
0x4f5: Stack[-1] = "ook1Lisa1" // @poff=521
0x4f6: Call2 0x4b8
...
0x4fb: Stack[-2] = (bool) 1
0x4fc: Return(); Pop(0)

0x4fd: Stack[-2] = (bool) 0
0x4fe: Return(); Pop(0)

0x4ff: PushEmpty(int, int)
0x500: Push("branch") // @poff=553
0x501: @ GetVariable(Stack[-1], Stack[-2])
0x502: Pop(1)
0x503: Push((int) 0)
...
0x509: Push((int) 1)
0x50a: Pop(1); Push((bool) Stack[-2] == Stack[-1])
...
0x511: Push("branch") // @poff=553
0x512: @ GetVariable(Stack[-1], Stack[-2])
0x513: Pop(1)
...
0x51d: @ WorkWithCorpse(Stack[-1])
0x51e: Pop(0)
0x51f: GOTO 0x522

0x520: @ Barter(Stack[-1])
0x521: Pop(0)
0x522: Return(); Pop(0)

0x523: Stack[-1] = (int) 518097
0x524: Return(); Pop(0)

0x525: Stack[-1] = (int) 518096
0x526: Return(); Pop(0)

0x527: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=567
0x528: Return(); Pop(0)

0x529: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=607
0x52a: Return(); Pop(0)
...
0x530: Push(-1, 0); TaskCall(3)
0x531: Call2 0x2cc

0x532: Pop(-1, 0); TaskReturn
0x533: Pop(1)
0x534: Return(); Pop(0)

0x535: PushEmpty()
0x536: PushEmpty(object, int, float)
0x537: Stack[-7] = Stack[-3]
0x538: Stack[-6] = Stack[-2]
0x539: Stack[-5] = Stack[-1]
0x53a: Call2 0x3a6
...
0x53d: PushEmpty()
0x53e: PushEmpty(object, int, float, cvector, cvector)
0x53f: Stack[-11] = Stack[-5]
0x540: Stack[-10] = Stack[-4]
0x541: Stack[-9] = Stack[-3]
0x542: Stack[-7] = Stack[-2]
...
0x548: Push("health") // @poff=651
0x549: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x54a: IF (Stack[-1] == 0) GOTO 0x553; Pop(1)

0x54b: Push("health") // @poff=651
0x54c: @ GetProperty(Stack[-1], Stack[-2])
0x54d: Pop(1)
0x54e: Push((int) 0)
0x54f: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x550: IF (Stack[-1] == 0) GOTO 0x553; Pop(1)

0x551: @ SignalDeath(Stack[-4])
0x552: Pop(0)
0x553: Return(); Pop(2)

0x554: PushEmpty(bool, bool)
0x555: @ IsPlayerActor(Stack[-3], Stack[-1])
0x556: Pop(0)
0x557: Push(Stack[-1])
0x558: IF (Stack[-1] == 0) GOTO 0x55e; Pop(1)

0x559: PushEmpty(bool, string, string)
0x55a: Stack[-2] = "quest_k1_01" // @poff=665
0x55b: Stack[-1] = "doberman_dead" // @poff=689
0x55c: Call2 0x4bd
