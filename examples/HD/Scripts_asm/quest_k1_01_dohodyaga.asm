...
// @pool_raw:
// @pool_encoding:utf8
...
0x2b5: Push("player") // @poff=156
0x2b6: @ FindActor(Stack[-4]T, Stack[-1])
0x2b7: Pop(1)
...
0x2ca: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x355: Pop(0)
0x356: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x357: Pop(0)
...
0x361: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x362: Pop(0)
0x363: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x364: Pop(0)
...
0x38a: Pop(0)
0x38b: Push((bool) 1)
0x38c: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x38d: Pop(1)
...
0x3a6: Push((bool) 1)
0x3a7: @ CameraSwitchToNormal(Stack[-1])
0x3a8: Pop(1)
...
0x3ae: Push("head") // @poff=170
0x3af: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x3b0: Pop(1)
0x3b1: Push(Stack[-1])
0x3b2: IF (Stack[-1] == 0) GOTO 0x3b6; Pop(1)

0x3b3: Push("head") // @poff=170
0x3b4: @ UnlookAsync(Stack[-1])
0x3b5: Pop(1)
0x3b6: Return(); Pop(2)
...
0x3c2: Push("Can't find lsh animation : ") // @poff=206
...
0x3d1: Push("Can't find lsh animation : ") // @poff=206
0x3d2: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3d3: @ Trace(Stack[-1])
0x3d4: Pop(1)
0x3d5: Return(); Pop(6)

0x3d6: PushEmpty(float, cvector, float, cvector)
0x3d7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x3d8: Pop(0)
0x3d9: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x3da: Push(CvectorIndex(Stack[-1], 1))
0x3db: Stack[-3] = Stack[-1]
0x3dc: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x3dd: Push("head") // @poff=170
0x3de: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x3df: Pop(1)
0x3e0: Return(); Pop(4)
...
0x3e8: PushEmpty(float, float)
0x3e9: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3ea: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3eb: Push((float)9.999999974752427e-07)
0x3ec: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3ed: IF (Stack[-1] == 0) GOTO 0x3f0; Pop(1)

0x3ee: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3ef: Return(); Pop(2)

0x3f0: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3f1: Return(); Pop(2)

0x3f2: PushEmpty(int, int)
0x3f3: @ GetVariable(Stack[-3], Stack[-1])
0x3f4: Pop(0)
0x3f5: Stack[-1] = Stack[-4]
0x3f6: Return(); Pop(2)

0x3f7: PushEmpty(float, float)
0x3f8: @ GetGameTime(Stack[-1])
0x3f9: Pop(0)
0x3fa: Stack[-1] = Stack[-3]
0x3fb: Return(); Pop(2)

0x3fc: PushEmpty(string, string)
0x3fd: Stack[-1] = "idle" // @poff=146
0x3fe: Push(Stack[-3])
0x3ff: IF (Stack[-1] == 0) GOTO 0x401; Pop(1)

0x400: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x401: Stack[-1] = Stack[-4]
0x402: Return(); Pop(2)

0x403: PushEmpty(int, bool, int, bool)
0x404: Stack[-2] = (int) 0
0x405: Push("all") // @poff=138
...
0x412: Stack[-2] = Stack[-5]
0x413: Return(); Pop(4)

0x414: PushEmpty()
0x415: Push("ook1Dohodyaga1") // @poff=262
0x416: Push((int) 1)
...
0x41a: PushEmpty()
0x41b: Push("ook1Dohodyaga2") // @poff=292
0x41c: Push((int) 1)
...
0x422: Stack[-1] = "k1q01ooStationGotoLaska" // @poff=322
0x423: Call2 0x3f2

0x424: Pop(1)
0x425: Push((int) 0)
0x426: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x427: IF (Stack[-1] == 0) GOTO 0x43d; Pop(1)

0x428: Push("k1q01ooStationGotoLaska") // @poff=322
0x429: Push((int) 1)
...
0x42f: Pop(1)
0x430: Push("k1q01StationGotoLaska") // @poff=370
0x431: Push("pt_map_laska") // @poff=414
0x432: Push((int) 1)
0x433: Push((int) 524730)
0x434: PushEmpty(float)
0x435: Call2 0x3f7

0x436: Pop(0)
0x437: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=440
0x438: Pop(5)
0x439: PushEmpty()
0x43a: Call2 0x489
...
0x440: Stack[-1] = "k1q01ooStationGotoLaska" // @poff=322
0x441: Call2 0x3f2

0x442: Pop(1)
0x443: Push((int) 0)
0x444: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x445: IF (Stack[-1] == 0) GOTO 0x458; Pop(1)

0x446: Push("k1q01ooStationGotoLaska") // @poff=322
0x447: Push((int) 1)
0x448: @ SetVariable(Stack[-2], Stack[-1])
0x449: Pop(2)
0x44a: PushEmpty(object, string, float)
0x44b: PushEmpty(object)
0x44c: Call2 0x4bf

0x44d: Stack[-1] = Stack[-4]
0x44e: Pop(1)
0x44f: Stack[-2] = "pt_map_laska" // @poff=414
0x450: Stack[-1] = (int) 2
0x451: Call2 0x4d0
...
0x455: Pop(0)
0x456: @@ ShowMap(Stack[-1]); Obj=2 // @poff=448
0x457: Pop(1)
0x458: Return(); Pop(0)

0x459: PushEmpty()
0x45a: PushEmpty(int, string)
0x45b: Stack[-1] = "ook1Dohodyaga1" // @poff=262
0x45c: Call2 0x3f2
...
0x467: Stack[-1] = "k1q01DobermanDead" // @poff=456
0x468: Call2 0x3f2
...
0x471: PushEmpty()
0x472: PushEmpty(int, string)
0x473: Stack[-1] = "k1q01" // @poff=492
0x474: Call2 0x3f2
...
0x479: Stack[-2] = (bool) 1
0x47a: Return(); Pop(0)

0x47b: Stack[-2] = (bool) 0
0x47c: Return(); Pop(0)

0x47d: PushEmpty()
0x47e: PushEmpty(int, string)
0x47f: Stack[-1] = "ook1Dohodyaga2" // @poff=292
0x480: Call2 0x3f2
...
0x49b: Push("Can't retrieve diary root") // @poff=504
0x49c: @ Trace(Stack[-1])
0x49d: Pop(1)
...
0x4a7: Pop(1)
0x4a8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=556
0x4a9: Pop(0)
0x4aa: Pop(0); Push((bool) Stack[-2] == 0)
0x4ab: IF (Stack[-1] == 0) GOTO 0x4b2; Pop(1)

0x4ac: Push("Can't find diary parent with id: ") // @poff=561
...
0x4b2: @@ AddChild(Stack[-8]); Obj=2 // @poff=629
0x4b3: Pop(0)
0x4b4: Push((int) 7)
0x4b5: @ SendWorldWndMessage(Stack[-1])
0x4b6: Pop(1)
0x4b7: @@ GetCategory(Stack[-1]); Obj=8 // @poff=638
0x4b8: Pop(0)
...
0x4c4: Push("Can't find main outdoor scene") // @poff=650
0x4c5: @ Trace(Stack[-1])
0x4c6: Pop(1)
0x4c7: Stack[-1] = 0
...
0x4ca: @@ GetMap(Stack[-1]); Obj=2 // @poff=710
0x4cb: Pop(0)
...
0x4ce: Stack[-1] = 0
0x4cf: Stack[-2] = 0
0x4d0: PushEmpty(cvector, cvector, object, bool, cvector, cvector, object, bool)
0x4d1: @ GetMainOutdoorScene(Stack[-2])
0x4d2: Pop(0)
0x4d3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4d4: IF (Stack[-1] == 0) GOTO 0x4d9; Pop(1)

0x4d5: Push("Can't find main outdoor scene") // @poff=650
0x4d6: @ Trace(Stack[-1])
0x4d7: Pop(1)
0x4d8: Return(); Pop(8)

0x4d9: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=717
0x4da: Pop(0)
0x4db: Pop(0); Push((bool) Stack[-1] == 0)
0x4dc: IF (Stack[-1] == 0) GOTO 0x4e3; Pop(1)

0x4dd: Push("Warning: outdoor scene locator ") // @poff=728
0x4de: Pop(1); Push(Stack[-1] + Stack[-11]);
0x4df: Push(" doesnt exist") // @poff=792
0x4e0: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4e1: @ Trace(Stack[-1])
0x4e2: Pop(1)
0x4e3: @@ GetMap(Stack[-11]); Obj=2 // @poff=710
0x4e4: Pop(0)
0x4e5: Pop(0); PushNull((bool) Stack[-11] == 0)
0x4e6: IF (Stack[-1] == 0) GOTO 0x4eb; Pop(1)

0x4e7: Push("Can't find map") // @poff=820
0x4e8: @ Trace(Stack[-1])
0x4e9: Pop(1)
0x4ea: Return(); Pop(8)

0x4eb: Push(CvectorIndex(Stack[-4], 0))
0x4ec: Push(CvectorIndex(Stack[-5], 2))
0x4ed: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=850
0x4ee: Pop(2)
0x4ef: Return(); Pop(8)

0x4f0: Stack[-2] = 0
0x4f1: PushEmpty(int, int)
0x4f2: Push("branch") // @poff=863
0x4f3: @ GetVariable(Stack[-1], Stack[-2])
0x4f4: Pop(1)
0x4f5: Push((int) 0)
0x4f6: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x4f7: IF (Stack[-1] == 0) GOTO 0x4fb; Pop(1)
...
0x502: Stack[-1] = (int) 515563
0x503: Return(); Pop(0)

0x504: Stack[-1] = (int) 503348
0x505: Return(); Pop(0)

0x506: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=877
0x507: Return(); Pop(0)

0x508: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=917
0x509: Return(); Pop(0)
