...
// @pool_raw:
...
0x531: Stack[-1] = (float) 0.029999999329447746
0x532: Call2 0x7d1
...
0x553: Pop(0); PushNull((bool) Stack[-21] == 0)
0x554: IF (Stack[-1] == 0) GOTO 0x55a; Pop(1)

0x555: PushEmpty(string)
0x556: Stack[-1] = "fdie" // @poff=592
0x557: Call2 0x5ad

0x558: Pop(1)
0x559: GOTO 0x5ac

0x55a: @@ GetPosition(Stack[-10]); Obj=21 // @poff=176
0x55b: Pop(0)
...
0x56b: Stack[-6] = "fdie" // @poff=592
0x56c: GOTO 0x56e

0x56d: Stack[-6] = "bdie" // @poff=602
...
0x574: @ StopAsync()
0x575: Pop(0)
0x576: Stack[-21] = Stack[-5]
0x577: Push("GetScriptProperty") // @poff=612
0x578: Push((int) 2)
0x579: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x57a: IF (Stack[-1] == 0) GOTO 0x586; Pop(1)

0x57b: Push("Owner") // @poff=132
0x57c: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=648
0x57d: Pop(1)
0x57e: Push(Stack[-4])
0x57f: IF (Stack[-1] == 0) GOTO 0x586; Pop(1)

0x580: Push("Owner") // @poff=132
0x581: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=666
0x582: Pop(1)
0x583: Pop(0); PushNull((bool) Stack[-5] == 0)
0x584: IF (Stack[-1] == 0) GOTO 0x586; Pop(1)

0x585: Stack[-21] = Stack[-5]
0x586: Push("@GetEyesHeight") // @poff=684
0x587: Push((int) 1)
0x588: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x589: IF (Stack[-1] == 0) GOTO 0x595; Pop(1)

0x58a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x58b: Pop(0)
...
0x597: Stack[-7] = Stack[-1]
0x598: Call2 0x766

0x599: Pop(1)
0x59a: Push("all") // @poff=0
...
0x5a1: @ StopAsync()
0x5a2: Pop(0)
0x5a3: Push("head") // @poff=532
0x5a4: @ UnlookAsync(Stack[-1])
0x5a5: Pop(1)
0x5a6: Push("all") // @poff=0
...
0x5d7: Stack[-2] = "bullet" // @poff=724
0x5d8: Return(); Pop(0)

0x5d9: Stack[-2] = "phys" // @poff=738
0x5da: Return(); Pop(0)

0x5db: PushEmpty(cvector, cvector, cvector, cvector)
0x5dc: @ GetPosition(Stack[-2])
0x5dd: Pop(0)
0x5de: @@ GetPosition(Stack[-1]); Obj=5 // @poff=176
0x5df: Pop(0)
...
0x5e4: Pop(0)
0x5e5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=176
0x5e6: Pop(0)
...
0x5ec: Pop(0)
0x5ed: Stack[-1] = Stack[-4]
0x5ee: Return(); Pop(2)

0x5ef: PushEmpty(bool, bool)
0x5f0: Push("HasProperty") // @poff=748
0x5f1: Push((int) 2)
...
0x5f7: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=772
0x5f8: Pop(0)
...
0x5fd: Stack[-10] = Stack[-2]
0x5fe: Stack[-9] = Stack[-1]
0x5ff: Call2 0x5ef
...
0x605: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=784
0x606: Pop(0)
0x607: PushEmpty(float, float, float, float)
0x608: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x609: Stack[-8] = Stack[-2]
0x60a: Stack[-7] = Stack[-1]
0x60b: Call2 0x7be

0x60c: Pop(3)
0x60d: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=796
0x60e: Pop(1)
...
0x613: Stack[-18] = Stack[-2]
0x614: Stack[-1] = "health" // @poff=808
0x615: Call2 0x5ef
...
0x624: Push("armor") // @poff=822
0x625: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=784
0x626: Pop(1)
0x627: Push("armor_") // @poff=834
0x628: PushEmpty(string, int)
0x629: Stack[-16] = Stack[-1]
0x62a: Call2 0x5cd
...
0x636: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=784
0x637: Pop(0)
...
0x63e: Stack[-3] = Stack[-6]
0x63f: Pop(3)
0x640: Push("health") // @poff=808
0x641: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=784
0x642: Pop(1)
0x643: Push((int) 1)
0x644: Pop(1); Push(Stack[-1] - Stack[-4]);
0x645: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x646: Push("health") // @poff=808
...
0x64c: Pop(3)
0x64d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=796
0x64e: Pop(2)
0x64f: PushEmpty(bool, object)
0x650: Stack[-17] = Stack[-1]
0x651: Call2 0x5ea
...
0x657: Pop(1)
0x658: Stack[-1] = Stack[-16]
0x659: Return(); Pop(12)

0x65a: PushEmpty(float, float)
0x65b: PushEmpty(bool, object, string)
0x65c: Stack[-6] = Stack[-2]
0x65d: Stack[-1] = "health" // @poff=808
0x65e: Call2 0x5ef
...
0x673: Push("health") // @poff=808
0x674: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=784
0x675: Pop(1)
...
0x67a: @@ IsDead(Stack[-1]); Obj=3 // @poff=848
0x67b: Pop(0)
0x67c: Stack[-1] = Stack[-4]
0x67d: Return(); Pop(2)

0x67e: PushEmpty(object, object, object, object)
0x67f: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x693: Pop(0)
0x694: Pop(0); PushNull((bool) Stack[-2] == 0)
0x695: IF (Stack[-1] == 0) GOTO 0x698; Pop(1)

0x696: Stack[-6] = (bool) 0
0x697: Return(); Pop(4)

0x698: @@ GetScene(Stack[-1]); Obj=5 // @poff=869
0x699: Pop(0)
...
0x6ac: Stack[-6] = Stack[-2]
0x6ad: Stack[-1] = "noaccess" // @poff=878
0x6ae: Call2 0x5ef
...
0x6b4: Push("noaccess") // @poff=878
0x6b5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=784
0x6b6: Pop(1)
0x6b7: Push((int) 0)
...
0x6c1: Pop(2)
0x6c2: Stack[-1] = Stack[-8]
0x6c3: Return(); Pop(6)

0x6c4: PushEmpty(cvector, cvector)
0x6c5: @@ GetPosition(Stack[-1]); Obj=3 // @poff=176
0x6c6: Pop(0)
...
0x6ce: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x6dc: @@ GetPosition(Stack[-5]); Obj=15 // @poff=176
0x6dd: Pop(0)
...
0x6ed: Stack[-1] = "fhit" // @poff=896
0x6ee: GOTO 0x6f0

0x6ef: Stack[-1] = "bhit" // @poff=906
0x6f0: Push("hit_react") // @poff=916
0x6f1: Push("1") // @poff=34
0x6f2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6f3: Push("2") // @poff=936
...
0x70c: Stack[-25] = Stack[-1]
0x70d: Call2 0x5db

0x70e: Stack[-2] = Stack[-3]
0x70f: Pop(2)
0x710: Call2 0x795
...
0x72b: Pop(0)
0x72c: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=949
0x72d: Pop(0)
0x72e: PushEmpty(object, int, float, cvector, cvector)
0x72f: Stack[-26] = Stack[-5]
0x730: Stack[-25] = Stack[-4]
0x731: Stack[-24] = Stack[-3]
0x732: Stack[-6] = Stack[-2]
...
0x74c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=176
0x74d: Pop(0)
...
0x75c: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=188
0x75d: Pop(0)
...
0x798: Push((float)9.999999974752427e-07)
...
0x7c5: Stack[-1] = Stack[-4]
0x7c6: Return(); Pop(0)

0x7c7: Stack[-3] = Stack[-4]
0x7c8: Return(); Pop(0)
...
0x7eb: Stack[-8] = Stack[-5]
0x7ec: Stack[-4] = "reputation" // @poff=981
...
0x807: Pop(0)
0x808: @@ add(Stack[-3]); Obj=1 // @poff=940
0x809: Pop(0)
0x80a: Push((int) 16)
...
0x82b: Stack[-2] = Stack[-1]
0x82c: Push(-1, 0); TaskCall(6)
0x82d: Call2 0x525

0x82e: Pop(-1, 0); TaskReturn
0x82f: Pop(1)
0x830: Return(); Pop(0)

0x831: PushEmpty()
0x832: PushEmpty(object, int, float)
0x833: Stack[-7] = Stack[-3]
0x834: Stack[-6] = Stack[-2]
0x835: Stack[-5] = Stack[-1]
0x836: Call2 0x6f9
...
0x83b: Stack[-11] = Stack[-5]
0x83c: Stack[-10] = Stack[-4]
0x83d: Stack[-9] = Stack[-3]
0x83e: Stack[-7] = Stack[-2]
0x83f: Stack[-6] = Stack[-1]
0x840: Call2 0x73d
...
0x877: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x878: Stack[-5] = (int) 250000
0x879: Push(CvectorIndex(Stack[-6], 1))
0x87a: Push((int) 1000)
0x87b: Pop(2); Push(Stack[-2] * Stack[-1]);
0x87c: Pop(0); Push(Stack[-14] * Stack[-14]);
0x87d: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x87e: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x87f: PushEmpty(float, float, float, float)
0x880: Stack[-9] = Stack[-3]
0x881: Stack[-8] = Stack[-2]
0x882: Stack[-7] = Stack[-1]
0x883: Call2 0x7a6

0x884: Stack[-4] = Stack[-6]
0x885: Pop(4)
0x886: Push((int) 0)
...
0x88e: Stack[-8] = Stack[-2]
0x88f: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x890: Call2 0x7ad

0x891: Pop(4)
0x892: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x893: Push(CVector(0.0, 500.0, 0.0))
0x894: Pop(1); Push(Stack[-1] * Stack[-2]);
0x895: Pop(1); Push(Stack[-1] * Stack[-2]);
0x896: Pop(1); Push(Stack[-7] + Stack[-1]);
0x897: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x898: Return(); Pop(12)
...
0x89f: Push("b1q04_attack") // @poff=1049
0x8a0: Push((int) 1)
...
0x8a7: Pop(0)
0x8a8: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1075
0x8a9: Pop(1)
0x8aa: PushEmpty(object)
0x8ab: Stack[-4] = Stack[-1]
0x8ac: Push(-1, 0); TaskCall(4)
0x8ad: Call2 0x49c

0x8ae: Pop(-1, 0); TaskReturn
0x8af: Pop(1)
0x8b0: Return(); Pop(2)
