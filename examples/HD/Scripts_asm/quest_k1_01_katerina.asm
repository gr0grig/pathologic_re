...
// @pool_raw:
// @pool_encoding:utf8
...
0x11d: Stack[-1] = "Suffering" // @poff=156
0x11e: Call2 0xa9
...
0x134: Stack[-1] = "Penetrating" // @poff=176
0x135: Call2 0xa9
...
0x15d: Stack[-1] = "Suffering" // @poff=156
0x15e: Call2 0xa9
...
0x1c5: Stack[-1] = 0
0x1c6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1c7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1c8: @ RotateAsync(Stack[-2], Stack[-1])
0x1c9: Pop(2)
0x1ca: Return(); Pop(0)

0x1cb: PushEmpty(object, bool, object, bool)
0x1cc: Push("player") // @poff=232
...
0x2a7: Pop(0)
0x2a8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=246
0x2a9: Pop(0)
...
0x2b8: @@ GetPosition(Stack[-1]); Obj=3 // @poff=246
0x2b9: Pop(0)
...
0x2c6: @@ GetPosition(Stack[-8]); Obj=20 // @poff=246
0x2c7: Pop(0)
0x2c8: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=258
0x2c9: Pop(0)
...
0x335: Push("voice_common") // @poff=282
0x336: Push((int) 1)
...
0x33d: Push("voice_common") // @poff=282
0x33e: Push((int) 0)
...
0x350: Push("voice_common") // @poff=282
0x351: Push((int) 1)
...
0x35e: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x35f: Pop(1)
...
0x373: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=324
0x374: Pop(1)
...
0x37c: Push("d") // @poff=278
0x37d: PushEmpty(int)
0x37e: Call2 0x401

0x37f: Pop(0)
0x380: Pop(2); Push(Stack[-2] + Stack[-1]);
0x381: Push("m") // @poff=336
...
0x389: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=312
0x38a: Pop(1)
...
0x39e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=324
0x39f: Pop(1)
0x3a0: PushEmpty(bool, string)
0x3a1: Stack[-3] = Stack[-1]
0x3a2: Call2 0x3c5

0x3a3: Stack[-2] = Stack[-14]
0x3a4: Pop(2)
0x3a5: Return(); Pop(10)
...
0x3b1: Push("Can't find lsh animation : ") // @poff=340
...
0x3c0: Push("Can't find lsh animation : ") // @poff=340
...
0x3e4: Push((float)9.999999974752427e-07)
...
0x3f2: Pop(0)
0x3f3: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x42a: Pop(1)
0x42b: Push("k1q01KaterinaGotoAlexandr") // @poff=408
0x42c: Push("pt_map_alexandr") // @poff=460
0x42d: Push((int) 1)
...
0x431: Pop(0)
0x432: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=492
0x433: Pop(5)
0x434: PushEmpty()
0x435: Call2 0x45d
...
0x43b: Stack[-2] = "quest_k1_01" // @poff=500
0x43c: Stack[-1] = "remove_katerina" // @poff=524
0x43d: Call2 0x3f0
...
0x445: Stack[-1] = Stack[-4]
0x446: Pop(1)
0x447: Stack[-2] = "pt_map_alexandr" // @poff=460
0x448: Stack[-1] = (int) 2
0x449: Call2 0x4b1
...
0x44d: Pop(0)
0x44e: @@ ShowMap(Stack[-1]); Obj=2 // @poff=556
0x44f: Pop(1)
0x450: Return(); Pop(0)

0x451: PushEmpty()
0x452: PushEmpty(int, string)
0x453: Stack[-1] = "k1q01" // @poff=396
0x454: Call2 0x3eb
...
0x47c: Push("Can't retrieve diary root") // @poff=564
0x47d: @ Trace(Stack[-1])
0x47e: Pop(1)
...
0x488: Pop(1)
0x489: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=616
0x48a: Pop(0)
0x48b: Pop(0); Push((bool) Stack[-2] == 0)
0x48c: IF (Stack[-1] == 0) GOTO 0x493; Pop(1)

0x48d: Push("Can't find diary parent with id: ") // @poff=621
...
0x493: @@ AddChild(Stack[-8]); Obj=2 // @poff=689
0x494: Pop(0)
0x495: Push((int) 7)
0x496: @ SendWorldWndMessage(Stack[-1])
0x497: Pop(1)
0x498: @@ GetCategory(Stack[-1]); Obj=8 // @poff=698
0x499: Pop(0)
...
0x4a2: Pop(0)
0x4a3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4a4: IF (Stack[-1] == 0) GOTO 0x4ab; Pop(1)

0x4a5: Push("Can't find main outdoor scene") // @poff=710
0x4a6: @ Trace(Stack[-1])
0x4a7: Pop(1)
0x4a8: Stack[-1] = 0
...
0x4ab: @@ GetMap(Stack[-1]); Obj=2 // @poff=770
0x4ac: Pop(0)
...
0x4b3: Pop(0)
0x4b4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4b5: IF (Stack[-1] == 0) GOTO 0x4ba; Pop(1)

0x4b6: Push("Can't find main outdoor scene") // @poff=710
0x4b7: @ Trace(Stack[-1])
0x4b8: Pop(1)
0x4b9: Return(); Pop(8)

0x4ba: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=777
0x4bb: Pop(0)
0x4bc: Pop(0); Push((bool) Stack[-1] == 0)
0x4bd: IF (Stack[-1] == 0) GOTO 0x4c4; Pop(1)

0x4be: Push("Warning: outdoor scene locator ") // @poff=788
0x4bf: Pop(1); Push(Stack[-1] + Stack[-11]);
0x4c0: Push(" doesnt exist") // @poff=852
0x4c1: Pop(2); Push(Stack[-2] + Stack[-1]);
0x4c2: @ Trace(Stack[-1])
0x4c3: Pop(1)
0x4c4: @@ GetMap(Stack[-11]); Obj=2 // @poff=770
0x4c5: Pop(0)
0x4c6: Pop(0); PushNull((bool) Stack[-11] == 0)
0x4c7: IF (Stack[-1] == 0) GOTO 0x4cc; Pop(1)

0x4c8: Push("Can't find map") // @poff=880
0x4c9: @ Trace(Stack[-1])
0x4ca: Pop(1)
0x4cb: Return(); Pop(8)
...
0x4ce: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=910
0x4cf: Pop(2)
0x4d0: Return(); Pop(8)

0x4d1: Stack[-2] = 0
0x4d2: PushEmpty(int, int)
0x4d3: Push("branch") // @poff=923
...
0x4e7: Stack[-1] = "ui/NPC_Katerina.png" // @poff=937
0x4e8: Return(); Pop(0)

0x4e9: Stack[-1] = "ui/NPC_Katerina_b.png" // @poff=977
0x4ea: Return(); Pop(0)
