...
Strings:
	...
	W:remove_whitemask
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1bb: Push("player") // @poff=156
0x1bc: @ FindActor(Stack[-4]T, Stack[-1])
0x1bd: Pop(1)
...
0x1d0: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x25b: Pop(0)
0x25c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x25d: Pop(0)
...
0x267: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x268: Pop(0)
0x269: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x26a: Pop(0)
...
0x290: Pop(0)
0x291: Push((bool) 1)
0x292: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x293: Pop(1)
...
0x2ac: Push((bool) 1)
0x2ad: @ CameraSwitchToNormal(Stack[-1])
0x2ae: Pop(1)
...
0x2b4: Push("head") // @poff=170
0x2b5: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2b6: Pop(1)
0x2b7: Push(Stack[-1])
0x2b8: IF (Stack[-1] == 0) GOTO 0x2bc; Pop(1)

0x2b9: Push("head") // @poff=170
0x2ba: @ UnlookAsync(Stack[-1])
0x2bb: Pop(1)
0x2bc: Return(); Pop(2)

0x2bd: PushEmpty(bool, float, float, bool, float, float)
0x2be: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2bf: Pop(0)
0x2c0: Push(Stack[-3])
0x2c1: IF (Stack[-1] == 0) GOTO 0x2c8; Pop(1)

0x2c2: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2c3: Pop(0)
0x2c4: Push((bool) 0)
0x2c5: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2c6: Pop(1)
0x2c7: GOTO 0x2cc

0x2c8: Push("Can't find lsh animation : ") // @poff=206
0x2c9: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2ca: @ Trace(Stack[-1])
0x2cb: Pop(1)
0x2cc: Return(); Pop(6)

0x2cd: PushEmpty(bool, float, float, bool, float, float)
0x2ce: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2cf: Pop(0)
0x2d0: Push(Stack[-3])
0x2d1: IF (Stack[-1] == 0) GOTO 0x2d7; Pop(1)

0x2d2: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2d3: Pop(0)
0x2d4: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2d5: Pop(0)
0x2d6: GOTO 0x2db

0x2d7: Push("Can't find lsh animation : ") // @poff=206
0x2d8: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2d9: @ Trace(Stack[-1])
0x2da: Pop(1)
0x2db: Return(); Pop(6)

0x2dc: PushEmpty(float, cvector, float, cvector)
0x2dd: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x2de: Pop(0)
0x2df: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x2e0: Push(CvectorIndex(Stack[-1], 1))
0x2e1: Stack[-3] = Stack[-1]
0x2e2: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x2e3: Push("head") // @poff=170
0x2e4: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x2e5: Pop(1)
0x2e6: Return(); Pop(4)
...
0x2ef: Pop(0); Push(Stack[-3] | Stack[-3]);
0x2f0: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x2f1: Push((float)9.999999974752427e-07)
0x2f2: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2f3: IF (Stack[-1] == 0) GOTO 0x2f6; Pop(1)

0x2f4: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x2f5: Return(); Pop(2)

0x2f6: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x2f7: Return(); Pop(2)

0x2f8: PushEmpty(object, object)
0x2f9: @ FindActor(Stack[-1], Stack[-4])
0x2fa: Pop(0)
0x2fb: Pop(0); PushNull((bool) Stack[-1] == 0)
0x2fc: IF (Stack[-1] == 0) GOTO 0x2ff; Pop(1)

0x2fd: Stack[-5] = (bool) 0
0x2fe: Return(); Pop(2)

0x2ff: @ Trigger(Stack[-1], Stack[-3])
0x300: Pop(0)
0x301: Stack[-5] = (bool) 1
0x302: Return(); Pop(2)

0x303: Stack[-1] = 0
0x304: Stack[-1] = (int) 515569
0x305: Return(); Pop(0)

0x306: Stack[-1] = (int) 503354
0x307: Return(); Pop(0)

0x308: Stack[-1] = "ui/NPC_wmask.png" // @poff=262
0x309: Return(); Pop(0)

0x30a: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=296
0x30b: Return(); Pop(0)

0x30c: Stack[-1] = (bool) 0
0x30d: Return(); Pop(0)

0x30e: PushEmpty(string, string)
0x30f: Stack[-1] = "idle" // @poff=146
0x310: Push(Stack[-3])
0x311: IF (Stack[-1] == 0) GOTO 0x313; Pop(1)

0x312: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x313: Stack[-1] = Stack[-4]
0x314: Return(); Pop(2)

0x315: PushEmpty(int, bool, int, bool)
0x316: Stack[-2] = (int) 0
0x317: Push("all") // @poff=138
0x318: PushEmpty(string, int)
0x319: Stack[-5] = Stack[-1]
0x31a: Call2 0x30e

0x31b: Pop(1)
0x31c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x31d: Pop(2)
...
0x326: PushEmpty()
0x327: PushEmpty(bool, string, string)
0x328: Stack[-2] = "quest_k1_01" // @poff=334
0x329: Stack[-1] = "remove_whitemask" // @poff=358
0x32a: Call2 0x2f8
...
0x32e: Push("branch") // @poff=392
0x32f: @ GetVariable(Stack[-1], Stack[-2])
0x330: Pop(1)
0x331: Push((int) 0)
