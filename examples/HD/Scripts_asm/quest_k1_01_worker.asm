...
0x2b: Stack[-8] = Stack[-2]
0x2c: Stack[-7] = Stack[-1]
0x2d: Call2 0x65
...
0x6c: Push("player") // @poff=16
0x6d: @ FindActor(Stack[-4]T, Stack[-1])
0x6e: Pop(1)
...
0x81: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x10c: Pop(0)
0x10d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=48
0x10e: Pop(0)
...
0x118: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=60
0x119: Pop(0)
