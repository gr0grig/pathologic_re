...
// @pool_raw:
// @pool_encoding:utf8
...
0x142: Stack[-8] = Stack[-2]
0x143: Stack[-7] = Stack[-1]
0x144: Call2 0x17c
...
0x183: Push("player") // @poff=172
0x184: @ FindActor(Stack[-4]T, Stack[-1])
0x185: Pop(1)
...
0x198: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x223: Pop(0)
0x224: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x225: Pop(0)
...
0x22f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x230: Pop(0)
0x231: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x232: Pop(0)
...
0x290: Push("Can't find lsh animation : ") // @poff=222
...
0x29f: Push("Can't find lsh animation : ") // @poff=222
...
0x2a5: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2a6: Pop(0)
...
0x2bf: Push((float)9.999999974752427e-07)
...
0x2c8: Pop(0)
0x2c9: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2f3: Stack[-2] = "quest_k2_03" // @poff=290
0x2f4: Stack[-1] = "place_danko" // @poff=314
0x2f5: Call2 0x2c6
...
0x30a: Push("Can't retrieve diary root") // @poff=338
0x30b: @ Trace(Stack[-1])
0x30c: Pop(1)
...
0x316: Pop(1)
0x317: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=390
0x318: Pop(0)
0x319: Pop(0); Push((bool) Stack[-2] == 0)
0x31a: IF (Stack[-1] == 0) GOTO 0x321; Pop(1)

0x31b: Push("Can't find diary parent with id: ") // @poff=395
...
0x321: @@ AddChild(Stack[-8]); Obj=2 // @poff=463
0x322: Pop(0)
0x323: Push((int) 7)
0x324: @ SendWorldWndMessage(Stack[-1])
0x325: Pop(1)
0x326: @@ GetCategory(Stack[-1]); Obj=8 // @poff=472
0x327: Pop(0)
...
0x343: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=498
0x344: Return(); Pop(0)

0x345: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=538
0x346: Return(); Pop(0)
