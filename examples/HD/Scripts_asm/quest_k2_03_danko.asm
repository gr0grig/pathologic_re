...
// @pool_raw:
// @pool_encoding:utf8
...
0x58: Stack[-1] = "Menace" // @poff=89
0x59: Call2 0x86

0x5a: Pop(1)
0x5b: Push((int) 525332)
0x5c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x5d: Pop(1)
0x5e: @@@ ClearReplies(); Obj=0 // @poff=114
0x5f: Pop(0)
0x60: Push((int) 525333)
0x61: Push((int) -1)
0x62: Push((int) 26701)
0x63: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x64: Pop(3)
0x65: GOTO 0x68
...
0x77: Push("all") // @poff=136
0x78: Push("idle") // @poff=144
...
0x80: Push("all") // @poff=136
0x81: Push("idle") // @poff=144
...
0xa6: Stack[-1] = "Menace" // @poff=89
0xa7: Call2 0x86

0xa8: Pop(1)
0xa9: Push((int) 525332)
0xaa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xab: Pop(1)
0xac: @@@ ClearReplies(); Obj=0 // @poff=114
0xad: Pop(0)
0xae: Push((int) 525333)
0xaf: Push((int) -1)
0xb0: Push((int) 26701)
0xb1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xb2: Pop(3)
0xb3: Return(); Pop(0)
...
0x10b: Stack[-2] = Stack[-5]
0x10c: Pop(2)
0x10d: Return(); Pop(2)

0x10e: Stack[-1] = 0
0x10f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x110: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x111: @ RotateAsync(Stack[-2], Stack[-1])
0x112: Pop(2)
0x113: Return(); Pop(0)

0x114: PushEmpty(object, bool, object, bool)
0x115: Push("player") // @poff=186
...
0x172: Stack[-1] = "Neutral" // @poff=200
0x173: Call2 0x2ef
...
0x181: Stack[-1] = "Neutral" // @poff=200
0x182: Call2 0x2ef
...
0x194: Stack[-4] = Stack[-1]
0x195: Call2 0xc1

0x196: Pop(1)
0x197: PushEmpty(string)
0x198: Stack[-1] = "Neutral" // @poff=200
0x199: Call2 0x2ef
...
0x1f0: Pop(0)
0x1f1: @@ GetPosition(Stack[-2]); Obj=7 // @poff=216
0x1f2: Pop(0)
...
0x201: @@ GetPosition(Stack[-1]); Obj=3 // @poff=216
0x202: Pop(0)
...
0x20f: @@ GetPosition(Stack[-8]); Obj=20 // @poff=216
0x210: Pop(0)
0x211: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=228
0x212: Pop(0)
...
0x27e: Push("voice_common") // @poff=252
0x27f: Push((int) 1)
...
0x286: Push("voice_common") // @poff=252
0x287: Push((int) 0)
...
0x299: Push("voice_common") // @poff=252
0x29a: Push((int) 1)
...
0x2a7: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x2a8: Pop(1)
...
0x2d2: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=282
0x2d3: Pop(1)
...
0x2e7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=294
0x2e8: Pop(1)
...
0x2fa: Push("Can't find lsh animation : ") // @poff=310
...
0x309: Push("Can't find lsh animation : ") // @poff=310
...
0x32d: Push((float)9.999999974752427e-07)
...
0x353: Stack[-2] = Stack[-5]
0x354: Return(); Pop(4)

0x355: PushEmpty(int, int)
0x356: Push("branch") // @poff=366
...
0x36a: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=380
0x36b: Return(); Pop(0)

0x36c: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=420
0x36d: Return(); Pop(0)
