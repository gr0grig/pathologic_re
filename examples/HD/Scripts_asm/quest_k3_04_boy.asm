...
Strings:
	...
	W:quest_k3_04
	W:boy_attacked
// @pool_raw:
// @pool_encoding:utf8
...
0x102: Stack[-2] = "quest_d3_03" // @poff=156
0x103: Stack[-1] = "boy_free" // @poff=180
0x104: Call2 0x4e5

0x105: Pop(3)
0x106: Push("noaccess") // @poff=198
0x107: Push((int) 0)
...
0x1ac: Pop(0)
0x1ad: Push("all") // @poff=138
0x1ae: PushEmpty(string, int)
0x1af: Stack[-7] = Stack[-1]
0x1b0: Call2 0x4f1
...
0x1e2: Pop(0)
0x1e3: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=216
0x1e4: Pop(0)
...
0x201: Stack[-1] = (float) 1.7453293800354004
0x202: Call2 0x1e0

0x203: Stack[-2] = Stack[-7]
0x204: Pop(2)
...
0x20a: Stack[-1] = (float) 2.6179938316345215
0x20b: Call2 0x1e0

0x20c: Stack[-2] = Stack[-7]
0x20d: Pop(2)
...
0x212: Push("Can't retreat, distance: ") // @poff=228
...
0x228: Push((int) 1)
0x229: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x22a: Pop(1)
0x22b: Push(Stack[-3])
0x22c: IF (Stack[-1] == 0) GOTO 0x244; Pop(1)

0x22d: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x232: Stack[-1] = (float) 2.6179938316345215
0x233: Call2 0x1e0
...
0x245: IF (Stack[-1] == 1) GOTO 0x228; Pop(1)
...
0x24c: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x25b: Stack[-1] = (float) 1.7453293800354004
0x25c: Call2 0x1e0

0x25d: Stack[-2] = Stack[-4]
0x25e: Pop(2)
...
0x297: Pop(2)
0x298: Push((float)-0.3420201241970062)
...
0x2a5: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2a6: IF (Stack[-1] == 0) GOTO 0x2ac; Pop(1)

0x2a7: PushEmpty(string)
0x2a8: Stack[-1] = "fdie" // @poff=280
0x2a9: Call2 0x2ff

0x2aa: Pop(1)
0x2ab: GOTO 0x2fe

0x2ac: @@ GetPosition(Stack[-10]); Obj=21 // @poff=216
0x2ad: Pop(0)
...
0x2bd: Stack[-6] = "fdie" // @poff=280
0x2be: GOTO 0x2c0

0x2bf: Stack[-6] = "bdie" // @poff=290
...
0x2c6: @ StopAsync()
0x2c7: Pop(0)
0x2c8: Stack[-21] = Stack[-5]
0x2c9: Push("GetScriptProperty") // @poff=300
0x2ca: Push((int) 2)
0x2cb: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2cc: IF (Stack[-1] == 0) GOTO 0x2d8; Pop(1)

0x2cd: Push("Owner") // @poff=336
0x2ce: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=348
0x2cf: Pop(1)
0x2d0: Push(Stack[-4])
0x2d1: IF (Stack[-1] == 0) GOTO 0x2d8; Pop(1)

0x2d2: Push("Owner") // @poff=336
0x2d3: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=366
0x2d4: Pop(1)
0x2d5: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2d6: IF (Stack[-1] == 0) GOTO 0x2d8; Pop(1)

0x2d7: Stack[-21] = Stack[-5]
0x2d8: Push("@GetEyesHeight") // @poff=384
0x2d9: Push((int) 1)
0x2da: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2db: IF (Stack[-1] == 0) GOTO 0x2e7; Pop(1)

0x2dc: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=414
0x2dd: Pop(0)
...
0x2e9: Stack[-7] = Stack[-1]
0x2ea: Call2 0x478

0x2eb: Pop(1)
0x2ec: Push("all") // @poff=138
...
0x326: Pop(0)
0x327: @@ GetPosition(Stack[-1]); Obj=5 // @poff=216
0x328: Pop(0)
0x329: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x32a: Return(); Pop(4)

0x32b: PushEmpty(bool, bool)
0x32c: Push("HasProperty") // @poff=438
0x32d: Push((int) 2)
...
0x333: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=462
0x334: Pop(0)
0x335: Stack[-1] = Stack[-5]
0x336: Return(); Pop(2)

0x337: PushEmpty(bool, bool)
0x338: @@ IsDead(Stack[-1]); Obj=3 // @poff=474
0x339: Pop(0)
0x33a: Stack[-1] = Stack[-4]
0x33b: Return(); Pop(2)

0x33c: PushEmpty(object, object, object, object)
0x33d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x351: Pop(0)
0x352: Pop(0); PushNull((bool) Stack[-2] == 0)
0x353: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x354: Stack[-6] = (bool) 0
0x355: Return(); Pop(4)

0x356: @@ GetScene(Stack[-1]); Obj=5 // @poff=495
0x357: Pop(0)
...
0x36a: Stack[-6] = Stack[-2]
0x36b: Stack[-1] = "noaccess" // @poff=198
0x36c: Call2 0x32b
...
0x372: Push("noaccess") // @poff=198
0x373: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=504
0x374: Pop(1)
0x375: Push((int) 0)
...
0x379: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x387: @@ GetPosition(Stack[-5]); Obj=15 // @poff=216
0x388: Pop(0)
...
0x398: Stack[-1] = "fhit" // @poff=516
0x399: GOTO 0x39b

0x39a: Stack[-1] = "bhit" // @poff=526
0x39b: Push("hit_react") // @poff=536
0x39c: Push("1") // @poff=556
0x39d: Pop(1); Push(Stack[-3] + Stack[-1]);
0x39e: Push("2") // @poff=560
...
0x3b7: Stack[-25] = Stack[-1]
0x3b8: Call2 0x324

0x3b9: Stack[-2] = Stack[-3]
0x3ba: Pop(2)
0x3bb: Call2 0x4a7
...
0x3d6: Pop(0)
0x3d7: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=573
0x3d8: Pop(0)
0x3d9: PushEmpty(object, int, float, cvector, cvector)
0x3da: Stack[-26] = Stack[-5]
0x3db: Stack[-25] = Stack[-4]
0x3dc: Stack[-24] = Stack[-3]
...
0x3fc: @@ GetPosition(Stack[-8]); Obj=20 // @poff=216
0x3fd: Pop(0)
0x3fe: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=414
0x3ff: Pop(0)
...
0x45d: Push("Can't find lsh animation : ") // @poff=623
...
0x46c: Push("Can't find lsh animation : ") // @poff=623
...
0x4aa: Push((float)9.999999974752427e-07)
...
0x4bb: Pop(0)
0x4bc: @@ add(Stack[-4]); Obj=1 // @poff=564
0x4bd: Pop(0)
0x4be: @@ add(Stack[-3]); Obj=1 // @poff=564
0x4bf: Pop(0)
0x4c0: Push((int) 3)
...
0x4c6: @@ GetItemID(Stack[-3]); Obj=8 // @poff=679
0x4c7: Pop(0)
0x4c8: Push("Category") // @poff=689
0x4c9: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x4ca: Pop(1)
0x4cb: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=707
0x4cc: Pop(0)
0x4cd: Pop(0); Push((bool) Stack[-1] == 0)
0x4ce: IF (Stack[-1] == 0) GOTO 0x4d2; Pop(1)

0x4cf: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=715
0x4d0: Pop(0)
0x4d1: GOTO 0x4d7
...
0x4da: Pop(0)
0x4db: @@ SetItemName(Stack[-4]); Obj=1 // @poff=725
0x4dc: Pop(0)
0x4dd: PushEmpty(object, object, int)
0x4de: Stack[-8] = Stack[-3]
0x4df: Stack[-4] = Stack[-2]
0x4e0: Stack[-6] = Stack[-1]
0x4e1: Call2 0x4c5
...
0x4e7: Pop(0)
0x4e8: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x509: PushEmpty()
0x50a: Push("playsound") // @poff=737
0x50b: Push("giveitem") // @poff=757
0x50c: @ TriggerWorld(Stack[-2], Stack[-1])
0x50d: Pop(2)
0x50e: Return(); Pop(0)

0x50f: PushEmpty()
0x510: Push("k3q04LopuhTalk") // @poff=775
0x511: Push((int) 1)
...
0x515: PushEmpty()
0x516: Push("powder is given") // @poff=805
0x517: @ Trace(Stack[-1])
0x518: Pop(1)
0x519: PushEmpty(object, string, int)
0x51a: Stack[-5] = Stack[-3]
0x51b: Stack[-2] = "powder" // @poff=837
0x51c: Stack[-1] = (int) 1
0x51d: Call2 0x4d8
...
0x535: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=865
0x536: Return(); Pop(0)

0x537: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=905
0x538: Return(); Pop(0)
...
0x540: Pop(0)
0x541: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=949
0x542: Pop(1)
0x543: Return(); Pop(2)
...
0x552: Stack[-7] = Stack[-3]
0x553: Stack[-6] = Stack[-2]
...
0x55a: Stack[-11] = Stack[-5]
0x55b: Stack[-10] = Stack[-4]
0x55c: Stack[-9] = Stack[-3]
0x55d: Stack[-7] = Stack[-2]
0x55e: Stack[-6] = Stack[-1]
0x55f: Call2 0x3e8
...
0x58a: Stack[-2] = "quest_k3_04" // @poff=985
0x58b: Stack[-1] = "boy_attacked" // @poff=1009
0x58c: Call2 0x4e5
