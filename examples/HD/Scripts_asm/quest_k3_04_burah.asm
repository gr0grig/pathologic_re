...
Strings:
	...
	W:k3q04
	W:k3q04Promise
	W:grass combination (good) is given
	W:grass_combination
	A:SetItemName
	W:im_inc
	A:SetProperty
	W:hl_inc
	W:tr_inc
	W:grass combination (bad) is given
...
// @pool_raw:
// @pool_encoding:utf8
...
0x9a: Push("all") // @poff=152
0x9b: Push("idle") // @poff=160
...
0xa3: Push("all") // @poff=152
0xa4: Push("idle") // @poff=160
...
0xed: Stack[-1] = "Sorrow" // @poff=89
0xee: Call2 0xa9

0xef: Pop(1)
0xf0: Push((int) 525635)
0xf1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0xf2: Pop(1)
0xf3: @@@ ClearReplies(); Obj=0 // @poff=114
0xf4: Pop(0)
0xf5: Push((int) 529332)
0xf6: Push((int) 30788)
0xf7: Push((int) 30787)
0xf8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xf9: Pop(3)
0xfa: Push((int) 540664)
0xfb: Push((int) 42695)
0xfc: Push((int) 42694)
0xfd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0xfe: Pop(3)
0xff: Return(); Pop(0)

0x100: PushEmpty(string)
0x101: Stack[-1] = "Neutral" // @poff=136
0x102: Call2 0xa9

0x103: Pop(1)
0x104: Push((int) 525638)
0x105: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x106: Pop(1)
0x107: @@@ ClearReplies(); Obj=0 // @poff=114
0x108: Pop(0)
0x109: Push((int) 525639)
0x10a: Push((int) -1)
0x10b: Push((int) 26981)
0x10c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x10d: Pop(3)
...
0x12f: Stack[-1] = "Agression" // @poff=170
0x130: Call2 0xa9
...
0x141: Stack[-1] = "Agression" // @poff=170
0x142: Call2 0xa9

0x143: Pop(1)
0x144: Push((int) 540669)
0x145: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x146: Pop(1)
0x147: @@@ ClearReplies(); Obj=0 // @poff=114
0x148: Pop(0)
0x149: Push((int) 529334)
0x14a: Push((int) 30790)
0x14b: Push((int) 30789)
0x14c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x14d: Pop(3)
0x14e: Return(); Pop(0)
...
0x153: Stack[-1] = "Doubt" // @poff=190
0x154: Call2 0xa9

0x155: Pop(1)
0x156: Push((int) 529335)
0x157: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=103
0x158: Pop(1)
0x159: @@@ ClearReplies(); Obj=0 // @poff=114
0x15a: Pop(0)
0x15b: Push((int) 525636)
0x15c: Push((int) -1)
0x15d: Push((int) 26978)
0x15e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=127
0x15f: Pop(3)
...
0x1bd: Stack[-2] = Stack[-5]
0x1be: Pop(2)
0x1bf: Return(); Pop(2)

0x1c0: Stack[-1] = 0
0x1c1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1c2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1c3: @ RotateAsync(Stack[-2], Stack[-1])
0x1c4: Pop(2)
0x1c5: Return(); Pop(0)

0x1c6: PushEmpty(object, bool, object, bool)
0x1c7: Push("player") // @poff=234
...
0x224: Stack[-1] = "Neutral" // @poff=136
0x225: Call2 0x3a1
...
0x233: Stack[-1] = "Neutral" // @poff=136
0x234: Call2 0x3a1
...
0x24a: Stack[-1] = "Neutral" // @poff=136
0x24b: Call2 0x3a1
...
0x2a2: Pop(0)
0x2a3: @@ GetPosition(Stack[-2]); Obj=7 // @poff=248
0x2a4: Pop(0)
...
0x2af: Pop(2)
0x2b0: Stack[-1] = Stack[-8]
0x2b1: Return(); Pop(6)

0x2b2: PushEmpty(cvector, cvector)
0x2b3: @@ GetPosition(Stack[-1]); Obj=3 // @poff=248
0x2b4: Pop(0)
0x2b5: PushEmpty(bool, cvector)
0x2b6: Stack[-3] = Stack[-1]
0x2b7: Call2 0x2a8

0x2b8: Stack[-2] = Stack[-6]
0x2b9: Pop(2)
0x2ba: Return(); Pop(2)
...
0x2c1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=248
0x2c2: Pop(0)
0x2c3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=260
0x2c4: Pop(0)
...
0x330: Push("voice_common") // @poff=284
0x331: Push((int) 1)
...
0x338: Push("voice_common") // @poff=284
0x339: Push((int) 0)
...
0x34b: Push("voice_common") // @poff=284
0x34c: Push((int) 1)
...
0x359: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x35a: Pop(1)
...
0x36e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=326
0x36f: Pop(1)
...
0x377: Push("d") // @poff=280
0x378: PushEmpty(int)
0x379: Call2 0x40a

0x37a: Pop(0)
0x37b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x37c: Push("m") // @poff=338
...
0x384: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=314
0x385: Pop(1)
...
0x399: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=326
0x39a: Pop(1)
0x39b: PushEmpty(bool, string)
0x39c: Stack[-3] = Stack[-1]
0x39d: Call2 0x3c0

0x39e: Stack[-2] = Stack[-14]
0x39f: Pop(2)
0x3a0: Return(); Pop(10)
...
0x3ac: Push("Can't find lsh animation : ") // @poff=342
...
0x3bb: Push("Can't find lsh animation : ") // @poff=342
...
0x3df: Push((float)9.999999974752427e-07)
...
0x3ed: Pop(0)
0x3ee: @@ add(Stack[-4]); Obj=1 // @poff=398
0x3ef: Pop(0)
0x3f0: @@ add(Stack[-3]); Obj=1 // @poff=398
0x3f1: Pop(0)
0x3f2: Push((int) 3)
...
0x3f8: @@ GetItemID(Stack[-3]); Obj=8 // @poff=402
0x3f9: Pop(0)
0x3fa: Push("Category") // @poff=412
0x3fb: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x3fc: Pop(1)
0x3fd: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=430
0x3fe: Pop(0)
0x3ff: Pop(0); Push((bool) Stack[-1] == 0)
0x400: IF (Stack[-1] == 0) GOTO 0x404; Pop(1)

0x401: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=438
0x402: Pop(0)
0x403: GOTO 0x409
...
0x41b: Stack[-2] = (int) 0
0x41c: Push("all") // @poff=152
0x41d: PushEmpty(string, int)
0x41e: Stack[-5] = Stack[-1]
0x41f: Call2 0x413
...
0x42b: PushEmpty()
0x42c: Push("ook3BurahIndoor1") // @poff=448
0x42d: Push((int) 1)
...
0x43a: PushEmpty()
0x43b: Push("k3q04") // @poff=482
0x43c: Push((int) 3)
0x43d: @ SetVariable(Stack[-2], Stack[-1])
0x43e: Pop(2)
0x43f: Push("k3q04Promise") // @poff=494
0x440: Push((int) 1)
...
0x448: Push("grass combination (good) is given") // @poff=520
0x449: @ Trace(Stack[-1])
0x44a: Pop(1)
0x44b: @ CreateInvItem(Stack[-1])
0x44c: Pop(0)
0x44d: Push("grass_combination") // @poff=588
0x44e: @@ SetItemName(Stack[-1]); Obj=2 // @poff=624
0x44f: Pop(1)
0x450: Push("im_inc") // @poff=636
0x451: Push((float)0.4000000059604645)
0x452: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x453: Pop(2)
0x454: Push("hl_inc") // @poff=662
0x455: Push((float)-0.009999999776482582)
0x456: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x457: Pop(2)
0x458: Push("tr_inc") // @poff=676
0x459: Push((float)0.029999999329447746)
0x45a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x45b: Pop(2)
0x45c: PushEmpty(object, object, int)
0x45d: Stack[-7] = Stack[-3]
...
0x465: Push("grass combination (bad) is given") // @poff=690
0x466: @ Trace(Stack[-1])
0x467: Pop(1)
0x468: @ CreateInvItem(Stack[-1])
0x469: Pop(0)
0x46a: Push("grass_combination") // @poff=588
0x46b: @@ SetItemName(Stack[-1]); Obj=2 // @poff=624
0x46c: Pop(1)
0x46d: Push("im_inc") // @poff=636
0x46e: Push((float)0.20000000298023224)
0x46f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x470: Pop(2)
0x471: Push("hl_inc") // @poff=662
0x472: Push((float)-0.07999999821186066)
0x473: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x474: Pop(2)
0x475: Push("tr_inc") // @poff=676
0x476: Push((float)0.11999999731779099)
0x477: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=650
0x478: Pop(2)
0x479: PushEmpty(object, object, int)
0x47a: Stack[-7] = Stack[-3]
...
0x483: Stack[-1] = "ook3BurahIndoor1" // @poff=448
0x484: Call2 0x3e6
...
0x49f: Push("Can't retrieve diary root") // @poff=756
0x4a0: @ Trace(Stack[-1])
0x4a1: Pop(1)
...
0x4ab: Pop(1)
0x4ac: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=808
0x4ad: Pop(0)
0x4ae: Pop(0); Push((bool) Stack[-2] == 0)
0x4af: IF (Stack[-1] == 0) GOTO 0x4b6; Pop(1)

0x4b0: Push("Can't find diary parent with id: ") // @poff=813
...
0x4b6: @@ AddChild(Stack[-8]); Obj=2 // @poff=881
0x4b7: Pop(0)
0x4b8: Push((int) 7)
0x4b9: @ SendWorldWndMessage(Stack[-1])
0x4ba: Pop(1)
0x4bb: @@ GetCategory(Stack[-1]); Obj=8 // @poff=890
0x4bc: Pop(0)
...
0x4d8: Stack[-1] = "ui/NPC_Burah.png" // @poff=916
0x4d9: Return(); Pop(0)

0x4da: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=950
0x4db: Return(); Pop(0)
