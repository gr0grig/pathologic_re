...
// @pool_raw:
// @pool_encoding:utf8
...
0x1ab: Stack[-1] = "Untrust" // @poff=170
0x1ac: Call2 0xbd

0x1ad: Pop(1)
0x1ae: Push((int) 539172)
0x1af: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x1b0: Pop(1)
0x1b1: @@@ ClearReplies(); Obj=0 // @poff=116
0x1b2: Pop(0)
...
0x1c7: Stack[-1] = "Untrust" // @poff=170
0x1c8: Call2 0xbd
...
0x223: Stack[-1] = "Untrust" // @poff=170
0x224: Call2 0xbd
...
0x2d0: Stack[-1] = 0
0x2d1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2d2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x2d3: @ RotateAsync(Stack[-2], Stack[-1])
0x2d4: Pop(2)
0x2d5: Return(); Pop(0)

0x2d6: PushEmpty(object, bool, object, bool)
0x2d7: Push("player") // @poff=230
...
0x3b2: Pop(0)
0x3b3: @@ GetPosition(Stack[-2]); Obj=7 // @poff=244
0x3b4: Pop(0)
...
0x3b9: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=256
0x3ba: Pop(0)
0x3bb: Pop(0); Push(Stack[-1] + Stack[-3]);
0x3bc: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=268
0x3bd: Pop(1)
0x3be: Return(); Pop(2)
...
0x3ca: @@ GetPosition(Stack[-1]); Obj=3 // @poff=244
0x3cb: Pop(0)
...
0x3d8: @@ GetPosition(Stack[-8]); Obj=20 // @poff=244
0x3d9: Pop(0)
0x3da: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=280
0x3db: Pop(0)
...
0x447: Push("voice_common") // @poff=304
0x448: Push((int) 1)
...
0x44f: Push("voice_common") // @poff=304
0x450: Push((int) 0)
...
0x462: Push("voice_common") // @poff=304
0x463: Push((int) 1)
...
0x470: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=334
0x471: Pop(1)
...
0x485: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=256
0x486: Pop(1)
...
0x48e: Push("d") // @poff=300
0x48f: PushEmpty(int)
0x490: Call2 0x54d

0x491: Pop(0)
0x492: Pop(2); Push(Stack[-2] + Stack[-1]);
0x493: Push("m") // @poff=346
...
0x49b: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=334
0x49c: Pop(1)
...
0x4b0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=256
0x4b1: Pop(1)
...
0x4c3: Push("Can't find lsh animation : ") // @poff=350
...
0x4d2: Push("Can't find lsh animation : ") // @poff=350
...
0x4f6: Push((float)9.999999974752427e-07)
...
0x504: Pop(0)
0x505: @@ add(Stack[-4]); Obj=1 // @poff=406
0x506: Pop(0)
0x507: @@ add(Stack[-3]); Obj=1 // @poff=406
0x508: Pop(0)
0x509: Push((int) 3)
...
0x510: Stack[-7] = Stack[-3]
0x511: Stack[-2] = "money" // @poff=410
...
0x522: @@ GetItemID(Stack[-3]); Obj=8 // @poff=434
0x523: Pop(0)
0x524: Push("Category") // @poff=444
0x525: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x526: Pop(1)
0x527: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=462
0x528: Pop(0)
0x529: Pop(0); Push((bool) Stack[-1] == 0)
0x52a: IF (Stack[-1] == 0) GOTO 0x52e; Pop(1)

0x52b: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=470
0x52c: Pop(0)
0x52d: GOTO 0x533

0x52e: PushEmpty(int, int)
0x52f: Stack[-5] = Stack[-2]
0x530: Stack[-9] = Stack[-1]
0x531: Call2 0x502
...
0x536: Pop(0)
0x537: @@ SetItemName(Stack[-4]); Obj=1 // @poff=480
0x538: Pop(0)
0x539: PushEmpty(object, object, int)
0x53a: Stack[-8] = Stack[-3]
0x53b: Stack[-4] = Stack[-2]
0x53c: Stack[-6] = Stack[-1]
0x53d: Call2 0x521
...
0x543: Pop(0)
0x544: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x56c: Stack[-2] = Stack[-5]
0x56d: Return(); Pop(4)

0x56e: PushEmpty()
0x56f: Push("k3q04") // @poff=492
0x570: Push((int) 2)
...
0x57c: Stack[-2] = "quest_k3_04" // @poff=504
0x57d: Stack[-1] = "completed" // @poff=528
0x57e: Call2 0x541
...
0x586: Stack[-2] = "quest_k3_04" // @poff=504
0x587: Stack[-1] = "completed" // @poff=528
0x588: Call2 0x541

0x589: Pop(3)
0x58a: Push("k3q04Promise") // @poff=548
0x58b: @ GetVariable(Stack[-1], Stack[-2])
0x58c: Pop(1)
0x58d: Push(Stack[-1])
0x58e: IF (Stack[-1] == 0) GOTO 0x593; Pop(1)

0x58f: Push("k3q04SendBurahMail") // @poff=574
0x590: Push((int) 1)
...
0x594: PushEmpty()
0x595: Push("money2000 is given") // @poff=612
0x596: @ Trace(Stack[-1])
0x597: Pop(1)
...
0x59e: PushEmpty()
0x59f: Push("playsound") // @poff=650
0x5a0: Push("givemoney") // @poff=670
0x5a1: @ TriggerWorld(Stack[-2], Stack[-1])
0x5a2: Pop(2)
0x5a3: Return(); Pop(0)

0x5a4: PushEmpty()
0x5a5: Push("k3q04SawDanko") // @poff=690
0x5a6: Push((int) 1)
...
0x5af: Stack[-2] = "quest_k3_04" // @poff=504
0x5b0: Stack[-1] = "fail" // @poff=718
0x5b1: Call2 0x541
...
0x5b4: PushEmpty()
0x5b5: Push("neomicin is given") // @poff=728
0x5b6: @ Trace(Stack[-1])
0x5b7: Pop(1)
0x5b8: PushEmpty(object, string, int)
0x5b9: Stack[-5] = Stack[-3]
0x5ba: Stack[-2] = "neomicin" // @poff=764
0x5bb: Stack[-1] = (int) 1
0x5bc: Call2 0x534
...
0x5d9: Stack[-1] = "k3q04LopuhTalk" // @poff=782
0x5da: Call2 0x4fd
...
0x61c: Push("Can't retrieve diary root") // @poff=812
0x61d: @ Trace(Stack[-1])
0x61e: Pop(1)
...
0x628: Pop(1)
0x629: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=864
0x62a: Pop(0)
0x62b: Pop(0); Push((bool) Stack[-2] == 0)
0x62c: IF (Stack[-1] == 0) GOTO 0x633; Pop(1)

0x62d: Push("Can't find diary parent with id: ") // @poff=869
...
0x633: @@ AddChild(Stack[-8]); Obj=2 // @poff=937
0x634: Pop(0)
0x635: Push((int) 7)
0x636: @ SendWorldWndMessage(Stack[-1])
0x637: Pop(1)
0x638: @@ GetCategory(Stack[-1]); Obj=8 // @poff=946
0x639: Pop(0)
...
0x655: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=972
0x656: Return(); Pop(0)

0x657: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=1012
0x658: Return(); Pop(0)
