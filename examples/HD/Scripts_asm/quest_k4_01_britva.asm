...
// @pool_raw:
// @pool_encoding:utf8
...
0x157: Push("player") // @poff=172
0x158: @ FindActor(Stack[-4]T, Stack[-1])
0x159: Pop(1)
...
0x16c: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1f7: Pop(0)
0x1f8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x1f9: Pop(0)
...
0x203: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x204: Pop(0)
0x205: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x206: Pop(0)
...
0x264: Push("Can't find lsh animation : ") // @poff=222
...
0x279: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x27a: Pop(0)
...
0x293: Push((float)9.999999974752427e-07)
...
0x2c0: Stack[-2] = "quest_k4_01" // @poff=278
0x2c1: Stack[-1] = "cutscene" // @poff=302
0x2c2: Call2 0x29a
...
0x2da: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=334
0x2db: Return(); Pop(0)

0x2dc: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=374
0x2dd: Return(); Pop(0)
