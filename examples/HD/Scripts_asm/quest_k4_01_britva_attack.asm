...
EVENT_43 Op = 0x659 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x663 Vars = (object, string)
EVENT_41 Op = 0x670 Vars = (object)
...
0xf: Stack[-1] = 0
0x10: PushEmpty()
0x11: Stack[-3] = (float) 0.10000000149011612
0x12: Return(); Pop(0)
...
0x33: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x34: Pop(0)
0x35: Push(Stack[-8])
0x36: IF (Stack[-1] == 0) GOTO 0x3f; Pop(1)

0x37: Push("attack") // @poff=70
...
0x53: Pop(0)
0x54: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0x55: Pop(0)
...
0x6f: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=84
0x70: Pop(0)
...
0x89: Pop(1)
0x8a: Push("all") // @poff=98
0x8b: Push("attack_on") // @poff=106
...
0xa3: IF (Stack[-1] == 1) GOTO 0xa9; Pop(1)
...
0xae: Pop(0)
0xaf: Push("all") // @poff=98
0xb0: Push("attack_stay") // @poff=126
0xb1: @ PlayAnimation(Stack[-2], Stack[-1])
0xb2: Pop(2)
0xb3: PushEmpty(bool, float)
0xb4: Stack[-25] = Stack[-1]
0xb5: Call2 0x1f1
...
0xba: @ Face(Stack[-0]T)
0xbb: Pop(0)
0xbc: Push("all") // @poff=98
0xbd: Push("fjump") // @poff=150
...
0xd8: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=84
0xd9: Pop(0)
...
0xf7: Push("all") // @poff=98
0xf8: Push("attack_off") // @poff=162
...
0x105: Push("all") // @poff=98
0x106: Push("attack_begin") // @poff=184
0x107: Push((int) 1)
0x108: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x113: Push("attack") // @poff=70
0x114: Push((int) 1)
0x115: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x11f: Push("all") // @poff=98
0x120: Push("bjump") // @poff=210
...
0x127: Push((float)0.8999999761581421)
0x128: Pop(1); Push(Stack[-9] * Stack[-1]);
0x129: @ GetVictim(Stack[-1], Stack[-4])
0x12a: Pop(1)
0x12b: @ ReportAttack(Stack[-0]T)
0x12c: Pop(0)
...
0x136: Stack[-7] = Stack[-3]
0x137: Stack[-6] = Stack[-2]
0x138: PushEmpty(int, object, int)
0x139: Stack[-10] = Stack[-2]
0x13a: Stack[-14] = Stack[-1]
0x13b: Call2 0x13

0x13c: Stack[-3] = Stack[-4]
0x13d: Pop(3)
0x13e: Call2 0x484

0x13f: Stack[-4] = Stack[-5]
0x140: Pop(4)
0x141: PushEmpty(int)
0x142: Call2 0x2a5

0x143: Pop(0)
0x144: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x145: Pop(1)
0x146: PushEmpty(object, float)
0x147: Stack[-5] = Stack[-2]
...
0x15c: Pop(0)
0x15d: Push("all") // @poff=98
0x15e: Push("attack_begin") // @poff=184
...
0x175: Pop(2)
0x176: Push("all") // @poff=98
0x177: Push("attack_middle") // @poff=222
...
0x17f: Pop(0)
0x180: Push("all") // @poff=98
0x181: Push("attack_middle") // @poff=222
...
0x195: Stack[-11] = Stack[-2]
0x196: Stack[-6] = Stack[-1]
0x197: Call2 0x126

0x198: Pop(2)
0x199: Stack[-2] = (int) 1
0x19a: Push("attack_middle") // @poff=222
0x19b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x19c: Push("_") // @poff=250
...
0x1c4: Pop(1)
0x1c5: Push("all") // @poff=98
0x1c6: Push("attack_end") // @poff=254
...
0x205: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=84
0x206: Pop(0)
...
0x251: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x252: Pop(1)
...
0x256: @ Face(Stack[-0]T)
0x257: Pop(0)
0x258: Push("all") // @poff=98
0x259: Push("bjump") // @poff=210
0x25a: @ PlayAnimation(Stack[-2], Stack[-1])
0x25b: Pop(2)
0x25c: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=84
0x25d: Pop(0)
...
0x293: @ irand(Stack[-1], Stack[-2]T)
0x294: Pop(0)
0x295: Push((int) 1)
0x296: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x297: Push("attack") // @poff=70
...
0x2a8: Stack[-1] = "attack_stay" // @poff=126
0x2a9: Call2 0x5a2
...
0x2db: Stack[-15] = Stack[-5]
0x2dc: Stack[-14] = Stack[-4]
0x2dd: Stack[-13] = Stack[-3]
0x2de: Stack[-12] = Stack[-2]
0x2df: Stack[-11] = Stack[-1]
0x2e0: Call2 0x325

0x2e1: Stack[-6] = Stack[-7]
0x2e2: Pop(6)
0x2e3: Push( Stack[2 + Tasks[-1].StackPointer] )
0x2e4: IF (Stack[-1] == 0) GOTO 0x2e8; Pop(1)

0x2e5: Push("head") // @poff=312
0x2e6: @ UnlookAsync(Stack[-1])
0x2e7: Pop(1)
0x2e8: Push((int) 1)
0x2e9: @ KillTimer(Stack[-1])
0x2ea: Pop(1)
0x2eb: Stack[-1] = Stack[-10]
0x2ec: Return(); Pop(4)
...
0x328: Stack[-17] = Stack[-7]
0x329: PushEmpty(bool, object)
0x32a: Stack[-23] = Stack[-1]
0x32b: Call2 0x3b1
...
0x331: @@ GetPosition(Stack[-5]); Obj=21 // @poff=322
0x332: Pop(0)
...
0x348: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=84
0x349: Pop(0)
...
0x35a: Push((int) 0)
0x35b: Push((float)0.30000001192092896)
...
0x37d: Push((int) 0)
0x37e: Push((float)0.30000001192092896)
...
0x3b8: Stack[-1] = "walk" // @poff=334
0x3b9: Return(); Pop(0)

0x3ba: Stack[-1] = "run" // @poff=344
0x3bb: Return(); Pop(0)
...
0x3ce: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3cf: IF (Stack[-1] == 0) GOTO 0x3d5; Pop(1)

0x3d0: PushEmpty(string)
0x3d1: Stack[-1] = "fdie" // @poff=352
0x3d2: Call2 0x428

0x3d3: Pop(1)
0x3d4: GOTO 0x427

0x3d5: @@ GetPosition(Stack[-10]); Obj=21 // @poff=322
0x3d6: Pop(0)
...
0x3e6: Stack[-6] = "fdie" // @poff=352
0x3e7: GOTO 0x3e9

0x3e8: Stack[-6] = "bdie" // @poff=362
...
0x3ef: @ StopAsync()
0x3f0: Pop(0)
0x3f1: Stack[-21] = Stack[-5]
0x3f2: Push("GetScriptProperty") // @poff=372
0x3f3: Push((int) 2)
0x3f4: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3f5: IF (Stack[-1] == 0) GOTO 0x401; Pop(1)

0x3f6: Push("Owner") // @poff=408
0x3f7: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=420
0x3f8: Pop(1)
0x3f9: Push(Stack[-4])
0x3fa: IF (Stack[-1] == 0) GOTO 0x401; Pop(1)

0x3fb: Push("Owner") // @poff=408
0x3fc: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=438
0x3fd: Pop(1)
0x3fe: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3ff: IF (Stack[-1] == 0) GOTO 0x401; Pop(1)

0x400: Stack[-21] = Stack[-5]
0x401: Push("@GetEyesHeight") // @poff=456
0x402: Push((int) 1)
0x403: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x404: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x405: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x406: Pop(0)
0x407: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x408: Push(CvectorIndex(Stack[-1], 1))
0x409: Stack[-3] = Stack[-1]
0x40a: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x40b: Push("head") // @poff=312
...
0x412: Stack[-7] = Stack[-1]
0x413: Call2 0x5a2

0x414: Pop(1)
0x415: Push("all") // @poff=98
...
0x434: Stack[-2] = Stack[-1]
0x435: Call2 0x5a2

0x436: Pop(1)
0x437: Push("all") // @poff=98
0x438: @ PlayAnimation(Stack[-1], Stack[-2])
0x439: Pop(1)
0x43a: @ WaitForAnimEnd()
0x43b: Pop(0)
0x43c: Push("all") // @poff=98
...
0x452: Stack[-2] = "bullet" // @poff=510
0x453: Return(); Pop(0)

0x454: Stack[-2] = "phys" // @poff=524
0x455: Return(); Pop(0)

0x456: PushEmpty(cvector, cvector, cvector, cvector)
0x457: @ GetPosition(Stack[-2])
0x458: Pop(0)
0x459: @@ GetPosition(Stack[-1]); Obj=5 // @poff=322
0x45a: Pop(0)
...
0x463: Push("HasProperty") // @poff=534
0x464: Push((int) 2)
...
0x46a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=558
0x46b: Pop(0)
...
0x470: Stack[-10] = Stack[-2]
0x471: Stack[-9] = Stack[-1]
0x472: Call2 0x462
...
0x478: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=570
0x479: Pop(0)
0x47a: PushEmpty(float, float, float, float)
0x47b: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x47c: Stack[-8] = Stack[-2]
0x47d: Stack[-7] = Stack[-1]
0x47e: Call2 0x5e2

0x47f: Pop(3)
0x480: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=582
0x481: Pop(1)
...
0x486: Stack[-18] = Stack[-2]
0x487: Stack[-1] = "health" // @poff=594
0x488: Call2 0x462
...
0x48f: Stack[-18] = Stack[-2]
0x490: Stack[-1] = "armor" // @poff=608
0x491: Call2 0x462
...
0x497: Push("armor") // @poff=608
0x498: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=570
0x499: Pop(1)
0x49a: Push("armor_") // @poff=620
0x49b: PushEmpty(string, int)
0x49c: Stack[-16] = Stack[-1]
0x49d: Call2 0x448

0x49e: Pop(1)
0x49f: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4a0: PushEmpty(bool, object, string)
0x4a1: Stack[-18] = Stack[-2]
0x4a2: Stack[-8] = Stack[-1]
0x4a3: Call2 0x462
...
0x4a9: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=570
0x4aa: Pop(0)
...
0x4b1: Stack[-3] = Stack[-6]
0x4b2: Pop(3)
0x4b3: Push("health") // @poff=594
0x4b4: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=570
0x4b5: Pop(1)
0x4b6: Push((int) 1)
0x4b7: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4b8: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4b9: Push("health") // @poff=594
...
0x4bf: Pop(3)
0x4c0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=582
0x4c1: Pop(2)
0x4c2: PushEmpty(bool, object)
0x4c3: Stack[-17] = Stack[-1]
0x4c4: Call2 0x45d
...
0x4ca: Pop(1)
0x4cb: Stack[-1] = Stack[-16]
0x4cc: Return(); Pop(12)

0x4cd: PushEmpty(bool, bool)
0x4ce: @@ IsDead(Stack[-1]); Obj=3 // @poff=634
0x4cf: Pop(0)
0x4d0: Stack[-1] = Stack[-4]
0x4d1: Return(); Pop(2)

0x4d2: PushEmpty(object, object, object, object)
0x4d3: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4e7: Pop(0)
0x4e8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4e9: IF (Stack[-1] == 0) GOTO 0x4ec; Pop(1)

0x4ea: Stack[-6] = (bool) 0
0x4eb: Return(); Pop(4)

0x4ec: @@ GetScene(Stack[-1]); Obj=5 // @poff=655
0x4ed: Pop(0)
...
0x501: Stack[-1] = "noaccess" // @poff=664
0x502: Call2 0x462
...
0x508: Push("noaccess") // @poff=664
0x509: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=570
0x50a: Pop(1)
0x50b: Push((int) 0)
...
0x50f: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x51d: @@ GetPosition(Stack[-5]); Obj=15 // @poff=322
0x51e: Pop(0)
...
0x52e: Stack[-1] = "fhit" // @poff=682
0x52f: GOTO 0x531

0x530: Stack[-1] = "bhit" // @poff=692
0x531: Push("hit_react") // @poff=702
0x532: Push("1") // @poff=722
0x533: Pop(1); Push(Stack[-3] + Stack[-1]);
0x534: Push("2") // @poff=726
...
0x54d: Stack[-25] = Stack[-1]
0x54e: Call2 0x456

0x54f: Stack[-2] = Stack[-3]
0x550: Pop(2)
0x551: Call2 0x5d1
...
0x56c: Pop(0)
0x56d: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=739
0x56e: Pop(0)
0x56f: PushEmpty(object, int, float, cvector, cvector)
0x570: Stack[-26] = Stack[-5]
0x571: Stack[-25] = Stack[-4]
0x572: Stack[-24] = Stack[-3]
0x573: Stack[-6] = Stack[-2]
...
0x580: Pop(0)
0x581: Push("scripted") // @poff=743
0x582: Push("blood_dir.xml") // @poff=761
...
0x58d: @@ GetPosition(Stack[-3]); Obj=7 // @poff=322
0x58e: Pop(0)
...
0x598: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=486
0x599: Pop(0)
...
0x5d4: Push((float)9.999999974752427e-07)
...
0x607: Stack[-8] = Stack[-5]
0x608: Stack[-4] = "reputation" // @poff=789
0x609: Stack[-7] = Stack[-3]
0x60a: Stack[-2] = (int) 0
0x60b: Stack[-1] = (int) 1
0x60c: Call2 0x46e
...
0x612: Pop(0)
0x613: @@ add(Stack[-3]); Obj=1 // @poff=730
0x614: Pop(0)
0x615: Push((int) 0)
0x616: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x617: IF (Stack[-1] == 0) GOTO 0x61c; Pop(1)

0x618: Push((float)0.699999988079071)
0x619: Push((int) 500)
0x61a: @ RumblePlay(Stack[-2], Stack[-1])
0x61b: Pop(2)
0x61c: Push((int) 15)
0x61d: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x61e: Pop(1)
0x61f: Return(); Pop(2)

0x620: Stack[-1] = 0
0x621: PushEmpty(object, object)
0x622: @ CreateFloatVector(Stack[-1])
0x623: Pop(0)
0x624: @@ add(Stack[-3]); Obj=1 // @poff=730
0x625: Pop(0)
0x626: Push((int) 16)
0x627: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x628: Pop(1)
0x629: Return(); Pop(2)

0x62a: Stack[-1] = 0
0x62b: PushEmpty(bool, bool)
0x62c: @ IsPlayerActor(Stack[-3], Stack[-1])
0x62d: Pop(0)
0x62e: Push(Stack[-1])
0x62f: IF (Stack[-1] == 0) GOTO 0x633; Pop(1)

0x630: Push("attack") // @poff=70
0x631: @ PlayGlobalMusic(Stack[-1])
0x632: Pop(1)
0x633: Return(); Pop(2)

0x634: PushEmpty(object, object)
0x635: @ GetScene(Stack[-1])
0x636: Pop(0)
0x637: Push("battle") // @poff=811
0x638: PushEmpty(object)
0x639: Call2 0x5cb

0x63a: Pop(0)
0x63b: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x63c: Pop(2)
0x63d: Return(); Pop(2)
...
0x646: Stack[-4] = Stack[-2]
0x647: Stack[-1] = (float) 0.019999999552965164
0x648: Call2 0x5ed

0x649: Pop(3)
0x64a: PushEmpty(object)
0x64b: Stack[-2] = Stack[-1]
0x64c: Push(-1, 0); TaskCall(2)
0x64d: Call2 0x3c4

0x64e: Pop(-1, 0); TaskReturn
0x64f: Pop(1)
0x650: Return(); Pop(0)

0x651: PushEmpty()
0x652: PushEmpty(object, int, float)
0x653: Stack[-7] = Stack[-3]
0x654: Stack[-6] = Stack[-2]
...
0x659: PushEmpty()
0x65a: PushEmpty(object, int, float, cvector, cvector)
0x65b: Stack[-11] = Stack[-5]
0x65c: Stack[-10] = Stack[-4]
0x65d: Stack[-9] = Stack[-3]
0x65e: Stack[-7] = Stack[-2]
...
0x663: PushEmpty(float, float)
0x664: Push("health") // @poff=594
0x665: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x666: IF (Stack[-1] == 0) GOTO 0x66f; Pop(1)

0x667: Push("health") // @poff=594
0x668: @ GetProperty(Stack[-1], Stack[-2])
0x669: Pop(1)
0x66a: Push((int) 0)
0x66b: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x66c: IF (Stack[-1] == 0) GOTO 0x66f; Pop(1)

0x66d: @ SignalDeath(Stack[-4])
0x66e: Pop(0)
0x66f: Return(); Pop(2)

0x670: PushEmpty()
0x671: PushEmpty(object)
0x672: Stack[-2] = Stack[-1]
0x673: Call2 0x63f
