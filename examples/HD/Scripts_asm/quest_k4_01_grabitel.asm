...
Strings:
	...
	W:lockpick
	W:grabitel_mark
// @pool_raw:
...
Events:
EVENT_22 Op = 0x863 Vars = (object, int, float, float)
EVENT_43 Op = 0x86b Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x875 Vars = (object, string)
EVENT_41 Op = 0x882 Vars = (object)
...
0x8a: Stack[-6] = Stack[-2]
0x8b: Stack[-1] = (float) 0.029999999329447746
0x8c: Call2 0x7eb
...
0x92: Pop(0)
0x93: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=8
0x94: Pop(1)
0x95: PushEmpty(object)
0x96: Stack[-4] = Stack[-1]
0x97: Call2 0x9b
...
0xb5: Pop(0); PushNull((bool) Stack[-21] == 0)
0xb6: IF (Stack[-1] == 0) GOTO 0xbc; Pop(1)

0xb7: PushEmpty(string)
0xb8: Stack[-1] = "fdie" // @poff=30
0xb9: Call2 0x10f

0xba: Pop(1)
0xbb: GOTO 0x10e

0xbc: @@ GetPosition(Stack[-10]); Obj=21 // @poff=40
0xbd: Pop(0)
...
0xcd: Stack[-6] = "fdie" // @poff=30
0xce: GOTO 0xd0

0xcf: Stack[-6] = "bdie" // @poff=52
...
0xd6: @ StopAsync()
0xd7: Pop(0)
0xd8: Stack[-21] = Stack[-5]
0xd9: Push("GetScriptProperty") // @poff=62
0xda: Push((int) 2)
0xdb: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0xdc: IF (Stack[-1] == 0) GOTO 0xe8; Pop(1)

0xdd: Push("Owner") // @poff=98
0xde: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=110
0xdf: Pop(1)
0xe0: Push(Stack[-4])
0xe1: IF (Stack[-1] == 0) GOTO 0xe8; Pop(1)

0xe2: Push("Owner") // @poff=98
0xe3: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=128
0xe4: Pop(1)
0xe5: Pop(0); PushNull((bool) Stack[-5] == 0)
0xe6: IF (Stack[-1] == 0) GOTO 0xe8; Pop(1)

0xe7: Stack[-21] = Stack[-5]
0xe8: Push("@GetEyesHeight") // @poff=146
0xe9: Push((int) 1)
0xea: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0xeb: IF (Stack[-1] == 0) GOTO 0xf7; Pop(1)

0xec: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=176
0xed: Pop(0)
0xee: Stack[-1] = CVector(0.0, 0.0, 0.0)
0xef: Push(CvectorIndex(Stack[-1], 1))
0xf0: Stack[-3] = Stack[-1]
0xf1: CvectorIndex(Stack[-2], 1) = Stack[-1];
0xf2: Push("head") // @poff=190
...
0xf9: Stack[-7] = Stack[-1]
0xfa: Call2 0x77b

0xfb: Pop(1)
0xfc: Push("all") // @poff=0
...
0x103: @ StopAsync()
0x104: Pop(0)
0x105: Push("head") // @poff=190
0x106: @ UnlookAsync(Stack[-1])
0x107: Pop(1)
0x108: Push("all") // @poff=0
...
0x13b: Stack[-2] = Stack[-3]
0x13c: Pop(2)
0x13d: PushEmpty(bool, float, float, float)
0x13e: Stack[-5] = Stack[-3]
...
0x15b: Stack[-17] = Stack[-1]
0x15c: Call2 0x6ce

0x15d: Pop(2)
0x15e: PushEmpty(bool, object)
0x15f: Stack[-17] = Stack[-1]
0x160: Call2 0x6ac
...
0x17b: Push("all") // @poff=0
0x17c: Push("aattack_end1") // @poff=230
0x17d: @ PlayAnimation(Stack[-2], Stack[-1])
0x17e: Pop(2)
0x17f: @ GetScene(Stack[-7])
0x180: Pop(0)
0x181: Push("knife") // @poff=256
0x182: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-7])
0x183: Pop(1)
0x184: Push("scripted") // @poff=268
0x185: Push(CVector(0.0, 0.0, 1.0))
0x186: Push("grabitel_knife.xml") // @poff=286
0x187: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-9], Stack[-2], Stack[-1])
0x188: Pop(3)
0x189: Push("Owner") // @poff=98
0x18a: PushEmpty(object)
0x18b: Call2 0x7a4

0x18c: Pop(0)
0x18d: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=324
0x18e: Pop(2)
0x18f: Push("Target") // @poff=342
0x190: @@ SetScriptProperty(Stack[-1], Stack[-16]); Obj=5 // @poff=324
0x191: Pop(1)
0x192: @@ GetPosition(Stack[-3]); Obj=15 // @poff=40
0x193: Pop(0)
0x194: @@ GetEyesHeight(Stack[-2]); Obj=15 // @poff=176
0x195: Pop(0)
...
0x19c: Stack[-10] = Stack[-3]
0x19d: Stack[-7] = Stack[-2]
0x19e: Stack[-1] = (float) 2000.0
0x19f: Call2 0x8f2

0x1a0: Stack[-4] = Stack[-5]
0x1a1: Pop(4)
0x1a2: Push("StartDirection") // @poff=356
0x1a3: @@ SetScriptProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=324
0x1a4: Pop(1)
...
0x1e4: Push("all") // @poff=0
0x1e5: Push("attack_off") // @poff=396
...
0x1ee: PushEmpty()
0x1ef: Stack[-3] = (float) 0.15000000596046448
0x1f0: Return(); Pop(0)
...
0x234: @ IsPlayerActor(Stack[-0]T, Stack[-8])
0x235: Pop(0)
0x236: Push(Stack[-8])
0x237: IF (Stack[-1] == 0) GOTO 0x240; Pop(1)

0x238: Push("attack") // @poff=474
...
0x254: Pop(0)
0x255: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=488
0x256: Pop(0)
...
0x270: @@@ GetPFPosition(Stack[-3]); Obj=0 // @poff=488
0x271: Pop(0)
...
0x28a: Pop(1)
0x28b: Push("all") // @poff=0
0x28c: Push("attack_on") // @poff=502
...
0x2a2: Push((float)0.19999998807907104)
...
0x2af: Pop(0)
0x2b0: Push("all") // @poff=0
0x2b1: Push("attack_stay") // @poff=522
0x2b2: @ PlayAnimation(Stack[-2], Stack[-1])
0x2b3: Pop(2)
0x2b4: PushEmpty(bool, float)
0x2b5: Stack[-25] = Stack[-1]
0x2b6: Call2 0x3f4
...
0x2bb: @ Face(Stack[-0]T)
0x2bc: Pop(0)
0x2bd: Push("all") // @poff=0
0x2be: Push("fjump") // @poff=546
...
0x2d9: @@@ GetPFPosition(Stack[-10]); Obj=0 // @poff=488
0x2da: Pop(0)
...
0x2f8: Push("all") // @poff=0
0x2f9: Push("attack_off") // @poff=396
...
0x306: Push("all") // @poff=0
0x307: Push("attack_begin") // @poff=558
0x308: Push((int) 1)
0x309: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x314: Push("attack") // @poff=474
0x315: Push((int) 1)
0x316: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x328: Push((float)0.8999999761581421)
0x329: Pop(1); Push(Stack[-9] * Stack[-1]);
0x32a: @ GetVictim(Stack[-1], Stack[-4])
0x32b: Pop(1)
0x32c: @ ReportAttack(Stack[-0]T)
0x32d: Pop(0)
...
0x331: Stack[-6] = Stack[-2]
0x332: Stack[-10] = Stack[-1]
0x333: Call2 0x1ee

0x334: Stack[-3] = Stack[-5]
0x335: Pop(3)
0x336: PushEmpty(float, object, float, int)
0x337: Stack[-7] = Stack[-3]
0x338: Stack[-6] = Stack[-2]
0x339: PushEmpty(int, object, int)
0x33a: Stack[-10] = Stack[-2]
0x33b: Stack[-14] = Stack[-1]
0x33c: Call2 0x1f1

0x33d: Stack[-3] = Stack[-4]
0x33e: Pop(3)
0x33f: Call2 0x61b

0x340: Stack[-4] = Stack[-5]
0x341: Pop(4)
0x342: PushEmpty(int)
0x343: Call2 0x1f4

0x344: Pop(0)
0x345: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x346: Pop(1)
0x347: PushEmpty(object, float)
0x348: Stack[-5] = Stack[-2]
...
0x351: Pop(0)
0x352: @ irand(Stack[-4], Stack[-1]T)
0x353: Pop(0)
0x354: Push((int) 1)
0x355: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x356: @ Face(Stack[-0]T)
0x357: Pop(0)
0x358: Push((bool) 1)
...
0x35d: Pop(0)
0x35e: Push("all") // @poff=0
0x35f: Push("attack_begin") // @poff=558
...
0x373: Stack[-11] = Stack[-2]
0x374: Stack[-6] = Stack[-1]
0x375: Call2 0x327

0x376: Pop(2)
0x377: Push("all") // @poff=0
0x378: Push("attack_middle") // @poff=596
...
0x380: Pop(0)
0x381: Push("all") // @poff=0
0x382: Push("attack_middle") // @poff=596
...
0x3c5: Pop(1)
0x3c6: Push("all") // @poff=0
0x3c7: Push("attack_end") // @poff=628
...
0x3d0: Stack[-1] = (float) 0.44999998807907104
0x3d1: Call2 0x3d9
...
0x408: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=488
0x409: Pop(0)
...
0x454: @ FindDirLength(Stack[-4], Stack[-1], Stack[-4]T)
0x455: Pop(1)
...
0x459: @ Face(Stack[-0]T)
0x45a: Pop(0)
0x45b: Push("all") // @poff=0
0x45c: Push("bjump") // @poff=584
0x45d: @ PlayAnimation(Stack[-2], Stack[-1])
0x45e: Pop(2)
0x45f: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=488
0x460: Pop(0)
...
0x496: @ irand(Stack[-1], Stack[-2]T)
0x497: Pop(0)
0x498: Push((int) 1)
0x499: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x49a: Push("attack") // @poff=474
...
0x4a9: Stack[-1] = "attack_stay" // @poff=522
0x4aa: Call2 0x77b
...
0x4ea: Stack[-15] = Stack[-5]
0x4eb: Stack[-14] = Stack[-4]
0x4ec: Stack[-13] = Stack[-3]
0x4ed: Stack[-12] = Stack[-2]
0x4ee: Stack[-11] = Stack[-1]
0x4ef: Call2 0x534

0x4f0: Stack[-6] = Stack[-7]
0x4f1: Pop(6)
0x4f2: Push( Stack[2 + Tasks[-1].StackPointer] )
0x4f3: IF (Stack[-1] == 0) GOTO 0x4f7; Pop(1)

0x4f4: Push("head") // @poff=190
0x4f5: @ UnlookAsync(Stack[-1])
0x4f6: Pop(1)
0x4f7: Push((int) 1)
0x4f8: @ KillTimer(Stack[-1])
0x4f9: Pop(1)
0x4fa: Stack[-1] = Stack[-10]
0x4fb: Return(); Pop(4)
...
0x537: Stack[-17] = Stack[-7]
0x538: PushEmpty(bool, object)
0x539: Stack[-23] = Stack[-1]
0x53a: Call2 0x5c0
...
0x540: @@ GetPosition(Stack[-5]); Obj=21 // @poff=40
0x541: Pop(0)
...
0x557: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=488
0x558: Pop(0)
...
0x569: Push((int) 0)
0x56a: Push((float)0.30000001192092896)
...
0x58c: Push((int) 0)
0x58d: Push((float)0.30000001192092896)
...
0x5c4: Stack[-2] = Stack[-4]
0x5c5: Pop(2)
0x5c6: Return(); Pop(0)

0x5c7: Stack[-1] = "walk" // @poff=686
0x5c8: Return(); Pop(0)

0x5c9: Stack[-1] = "run" // @poff=696
0x5ca: Return(); Pop(0)

0x5cb: PushEmpty()
0x5cc: PushEmpty(bool, object)
0x5cd: Stack[-3] = Stack[-1]
...
0x5e1: Stack[-2] = "bullet" // @poff=714
0x5e2: Return(); Pop(0)

0x5e3: Stack[-2] = "phys" // @poff=728
0x5e4: Return(); Pop(0)

0x5e5: PushEmpty(cvector, cvector, cvector, cvector)
0x5e6: @ GetPosition(Stack[-2])
0x5e7: Pop(0)
0x5e8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=40
0x5e9: Pop(0)
...
0x5ee: Pop(0)
0x5ef: @@ GetPosition(Stack[-2]); Obj=7 // @poff=40
0x5f0: Pop(0)
...
0x5f6: Pop(0)
0x5f7: Stack[-1] = Stack[-4]
0x5f8: Return(); Pop(2)

0x5f9: PushEmpty(bool, bool)
0x5fa: Push("HasProperty") // @poff=738
0x5fb: Push((int) 2)
...
0x601: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=762
0x602: Pop(0)
...
0x60f: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=774
0x610: Pop(0)
0x611: PushEmpty(float, float, float, float)
0x612: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x613: Stack[-8] = Stack[-2]
0x614: Stack[-7] = Stack[-1]
0x615: Call2 0x7d3

0x616: Pop(3)
0x617: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=786
0x618: Pop(1)
...
0x626: Stack[-18] = Stack[-2]
0x627: Stack[-1] = "armor" // @poff=812
0x628: Call2 0x5f9
...
0x62e: Push("armor") // @poff=812
0x62f: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=774
0x630: Pop(1)
0x631: Push("armor_") // @poff=824
0x632: PushEmpty(string, int)
0x633: Stack[-16] = Stack[-1]
0x634: Call2 0x5d7

0x635: Pop(1)
0x636: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x637: PushEmpty(bool, object, string)
0x638: Stack[-18] = Stack[-2]
...
0x640: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=774
0x641: Pop(0)
...
0x648: Stack[-3] = Stack[-6]
0x649: Pop(3)
0x64a: Push("health") // @poff=798
0x64b: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=774
0x64c: Pop(1)
0x64d: Push((int) 1)
0x64e: Pop(1); Push(Stack[-1] - Stack[-4]);
0x64f: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x650: Push("health") // @poff=798
...
0x656: Pop(3)
0x657: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=786
0x658: Pop(2)
0x659: PushEmpty(bool, object)
0x65a: Stack[-17] = Stack[-1]
0x65b: Call2 0x5f4
...
0x661: Pop(1)
0x662: Stack[-1] = Stack[-16]
0x663: Return(); Pop(12)

0x664: PushEmpty(float, float)
0x665: PushEmpty(bool, object, string)
0x666: Stack[-6] = Stack[-2]
0x667: Stack[-1] = "health" // @poff=798
0x668: Call2 0x5f9
...
0x67d: Push("health") // @poff=798
0x67e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=774
0x67f: Pop(1)
...
0x684: @@ IsDead(Stack[-1]); Obj=3 // @poff=838
0x685: Pop(0)
0x686: Stack[-1] = Stack[-4]
0x687: Return(); Pop(2)

0x688: PushEmpty(object, object, object, object)
0x689: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x69d: Pop(0)
0x69e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x69f: IF (Stack[-1] == 0) GOTO 0x6a2; Pop(1)

0x6a0: Stack[-6] = (bool) 0
0x6a1: Return(); Pop(4)

0x6a2: @@ GetScene(Stack[-1]); Obj=5 // @poff=859
0x6a3: Pop(0)
...
0x6b7: Stack[-1] = "noaccess" // @poff=868
0x6b8: Call2 0x5f9
...
0x6be: Push("noaccess") // @poff=868
0x6bf: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=774
0x6c0: Pop(1)
0x6c1: Push((int) 0)
...
0x6e6: @@ GetPosition(Stack[-5]); Obj=15 // @poff=40
0x6e7: Pop(0)
...
0x6f7: Stack[-1] = "fhit" // @poff=886
0x6f8: GOTO 0x6fa

0x6f9: Stack[-1] = "bhit" // @poff=896
0x6fa: Push("hit_react") // @poff=906
0x6fb: Push("1") // @poff=226
0x6fc: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6fd: Push("2") // @poff=926
...
0x716: Stack[-25] = Stack[-1]
0x717: Call2 0x5e5

0x718: Stack[-2] = Stack[-3]
0x719: Pop(2)
0x71a: Call2 0x7aa
...
0x735: Pop(0)
0x736: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=939
0x737: Pop(0)
0x738: PushEmpty(object, int, float, cvector, cvector)
0x739: Stack[-26] = Stack[-5]
0x73a: Stack[-25] = Stack[-4]
0x73b: Stack[-24] = Stack[-3]
...
0x749: Pop(0)
0x74a: Push("scripted") // @poff=268
0x74b: Push("blood_dir.xml") // @poff=943
...
0x756: @@ GetPosition(Stack[-3]); Obj=7 // @poff=40
0x757: Pop(0)
...
0x762: Pop(0)
0x763: Stack[-1] = Stack[-3]
0x764: Return(); Pop(2)

0x765: PushEmpty(float, cvector, float, cvector)
0x766: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=176
0x767: Pop(0)
...
0x772: Stack[-7] = Stack[-2]
0x773: Stack[-6] = Stack[-1]
0x774: Call2 0x7e6
...
0x7ad: Push((float)9.999999974752427e-07)
...
0x801: Stack[-2] = Stack[-1]
0x802: Call2 0x81f

0x803: Pop(1)
0x804: PushEmpty(bool, object, string, float, float, float)
0x805: Stack[-8] = Stack[-5]
0x806: Stack[-4] = "reputation" // @poff=971
0x807: Stack[-7] = Stack[-3]
0x808: Stack[-2] = (int) 0
0x809: Stack[-1] = (int) 1
0x80a: Call2 0x605
...
0x810: Pop(0)
0x811: @@ add(Stack[-3]); Obj=1 // @poff=930
0x812: Pop(0)
0x813: Push((int) 0)
0x814: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x815: IF (Stack[-1] == 0) GOTO 0x81a; Pop(1)

0x816: Push((float)0.699999988079071)
0x817: Push((int) 500)
0x818: @ RumblePlay(Stack[-2], Stack[-1])
0x819: Pop(2)
0x81a: Push((int) 15)
0x81b: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x81c: Pop(1)
0x81d: Return(); Pop(2)

0x81e: Stack[-1] = 0
0x81f: PushEmpty(object, object)
0x820: @ CreateFloatVector(Stack[-1])
0x821: Pop(0)
0x822: @@ add(Stack[-3]); Obj=1 // @poff=930
0x823: Pop(0)
0x824: Push((int) 16)
0x825: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x826: Pop(1)
0x827: Return(); Pop(2)

0x828: Stack[-1] = 0
0x829: PushEmpty(bool, bool)
0x82a: @ IsPlayerActor(Stack[-3], Stack[-1])
0x82b: Pop(0)
0x82c: Push(Stack[-1])
0x82d: IF (Stack[-1] == 0) GOTO 0x831; Pop(1)

0x82e: Push("attack") // @poff=474
0x82f: @ PlayGlobalMusic(Stack[-1])
0x830: Pop(1)
0x831: Return(); Pop(2)

0x832: PushEmpty(object, object)
0x833: @ GetScene(Stack[-1])
0x834: Pop(0)
0x835: Push("battle") // @poff=993
0x836: PushEmpty(object)
0x837: Call2 0x7a4

0x838: Pop(0)
0x839: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x83a: Pop(2)
0x83b: Return(); Pop(2)

0x83c: Stack[-1] = 0
0x83d: PushEmpty(bool, bool)
0x83e: Push("god_mode") // @poff=1007
0x83f: @ GetVariable(Stack[-1], Stack[-2])
0x840: Pop(1)
0x841: Stack[-1] = Stack[-3]
0x842: Return(); Pop(2)

0x843: PushEmpty(string, string)
0x844: Stack[-1] = "idle" // @poff=1025
0x845: Push(Stack[-3])
0x846: IF (Stack[-1] == 0) GOTO 0x848; Pop(1)

0x847: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x848: Stack[-1] = Stack[-4]
0x849: Return(); Pop(2)

0x84a: PushEmpty(int, bool, int, bool)
0x84b: Stack[-2] = (int) 0
0x84c: Push("all") // @poff=0
0x84d: PushEmpty(string, int)
0x84e: Stack[-5] = Stack[-1]
0x84f: Call2 0x843

0x850: Pop(1)
0x851: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x852: Pop(2)
...
0x856: Push((int) 1)
0x857: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x858: GOTO 0x84c
...
0x85e: Push(-1, 0); TaskCall(1)
0x85f: Call2 0x80

0x860: Pop(-1, 0); TaskReturn
0x861: Pop(1)
0x862: Return(); Pop(0)

0x863: PushEmpty()
0x864: PushEmpty(object, int, float)
0x865: Stack[-7] = Stack[-3]
...
0x86b: PushEmpty()
0x86c: PushEmpty(object, int, float, cvector, cvector)
0x86d: Stack[-11] = Stack[-5]
0x86e: Stack[-10] = Stack[-4]
0x86f: Stack[-9] = Stack[-3]
0x870: Stack[-7] = Stack[-2]
0x871: Stack[-6] = Stack[-1]
0x872: Call2 0x747

0x873: Pop(5)
0x874: Return(); Pop(0)

0x875: PushEmpty(float, float)
0x876: Push("health") // @poff=798
0x877: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x878: IF (Stack[-1] == 0) GOTO 0x881; Pop(1)

0x879: Push("health") // @poff=798
0x87a: @ GetProperty(Stack[-1], Stack[-2])
0x87b: Pop(1)
0x87c: Push((int) 0)
0x87d: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x87e: IF (Stack[-1] == 0) GOTO 0x881; Pop(1)

0x87f: @ SignalDeath(Stack[-4])
0x880: Pop(0)
0x881: Return(); Pop(2)
...
0x88a: Stack[-3] = Stack[-1]
0x88b: Call2 0x6ac

0x88c: Stack[-2] = Stack[-4]
0x88d: Pop(2)
0x88e: Return(); Pop(0)

0x88f: PushEmpty()
0x890: PushEmpty(object)
0x891: Stack[-2] = Stack[-1]
0x892: Call2 0x8ea
...
0x8a8: PushEmpty(int, bool, int, bool)
0x8a9: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x8aa: IF (Stack[-1] == 0) GOTO 0x8af; Pop(1)

0x8ab: Push("GenerateMoney: iMin > iMax") // @poff=1049
0x8ac: @ Trace(Stack[-1])
0x8ad: Pop(1)
0x8ae: Return(); Pop(4)

0x8af: Stack[-2] = (int) 0
0x8b0: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x8b1: IF (Stack[-1] == 0) GOTO 0x8b6; Pop(1)

0x8b2: Pop(0); Push(Stack[-5] - Stack[-6]);
0x8b3: @ irand(Stack[-3], Stack[-1])
0x8b4: Pop(1)
0x8b5: GOTO 0x8ba

0x8b6: Push((int) 0)
0x8b7: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8b8: IF (Stack[-1] == 0) GOTO 0x8ba; Pop(1)

0x8b9: Return(); Pop(4)

0x8ba: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x8bb: Push((int) 0)
...
0x8bf: PushEmpty(int, string)
0x8c0: Stack[-1] = "Money" // @poff=1103
0x8c1: Call2 0x8e5

0x8c2: Pop(1)
0x8c3: Push((int) 0)
0x8c4: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x8c5: Pop(2)
0x8c6: Return(); Pop(4)

0x8c7: PushEmpty(int, bool, int, bool)
0x8c8: Push((int) 0)
0x8c9: @ ClearSubContainer(Stack[-1])
0x8ca: Pop(1)
0x8cb: PushEmpty(int, int)
0x8cc: Stack[-2] = (int) 300
0x8cd: Stack[-1] = (int) 750
0x8ce: Call2 0x8a8

0x8cf: Pop(2)
0x8d0: PushEmpty(string, int, int)
0x8d1: Stack[-3] = "Knife" // @poff=1115
0x8d2: Stack[-2] = (int) 1
0x8d3: Stack[-1] = (int) 8
0x8d4: Call2 0x770

0x8d5: Pop(3)
0x8d6: PushEmpty(string, int, int)
0x8d7: Stack[-3] = "lockpick" // @poff=1127
0x8d8: Stack[-2] = (int) 1
0x8d9: Stack[-1] = (int) 6
0x8da: Call2 0x770
...
0x8dd: Stack[-1] = "grabitel_mark" // @poff=1145
0x8de: Call2 0x8e5
...
0x8e6: @ GetInvItemByName(Stack[-1], Stack[-3])
0x8e7: Pop(0)
...
0x8ec: Stack[-2] = Stack[-1]
0x8ed: Push(-1, 0); TaskCall(6)
0x8ee: Call2 0x5cb

0x8ef: Pop(-1, 0); TaskReturn
0x8f0: Pop(1)
0x8f1: Return(); Pop(0)

0x8f2: PushEmpty(cvector, float, float, float, float, float, cvector, float, float, float, float, float)
0x8f3: Stack[-6] = Stack[-14] - Stack[-15]; Pop(0);
0x8f4: Stack[-5] = (int) 250000
0x8f5: Push(CvectorIndex(Stack[-6], 1))
0x8f6: Push((int) 1000)
0x8f7: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8f8: Pop(0); Push(Stack[-14] * Stack[-14]);
0x8f9: Stack[-6] = Stack[-2] - Stack[-1]; Pop(2);
0x8fa: Stack[-3] = Stack[-6] | Stack[-6]; Pop(0);
0x8fb: PushEmpty(float, float, float, float)
0x8fc: Stack[-9] = Stack[-3]
0x8fd: Stack[-8] = Stack[-2]
0x8fe: Stack[-7] = Stack[-1]
0x8ff: Call2 0x7bb

0x900: Stack[-4] = Stack[-6]
0x901: Pop(4)
0x902: Push((int) 0)
...
0x907: PushEmpty(float, float, float, float, float)
0x908: Stack[-10] = Stack[-4]
0x909: Stack[-9] = Stack[-3]
0x90a: Stack[-8] = Stack[-2]
0x90b: Stack[-1] = Sqrt(Stack[-7]); Pop(0);
0x90c: Call2 0x7c2

0x90d: Pop(4)
0x90e: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x90f: Push(CVector(0.0, 500.0, 0.0))
0x910: Pop(1); Push(Stack[-1] * Stack[-2]);
0x911: Pop(1); Push(Stack[-1] * Stack[-2]);
0x912: Pop(1); Push(Stack[-7] + Stack[-1]);
0x913: Stack[-17] = Stack[-1] / Stack[-2]; Pop(1);
0x914: Return(); Pop(12)
