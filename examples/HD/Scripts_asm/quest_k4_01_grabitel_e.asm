...
// @pool_raw:
// @pool_encoding:utf8
...
0x2fe: Pop(1)
0x2ff: Push(CvectorIndex(Stack[-4], 0))
0x300: Push(CvectorIndex(Stack[-5], 2))
...
0x333: Push("Can't find lsh animation : ") // @poff=447
...
0x342: Push("Can't find lsh animation : ") // @poff=447
...
0x348: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=326
0x349: Pop(0)
...
0x366: Pop(0)
0x367: Pop(0); Push((bool) Stack[-8] == 0)
0x368: IF (Stack[-1] == 0) GOTO 0x37d; Pop(1)

0x369: Stack[-7] = (int) 0
0x36a: Push((int) 1)
0x36b: Pop(1); Push(Stack[-8] + Stack[-1]);
0x36c: Pop(1); Push(Stack[-18] + Stack[-1]);
0x36d: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x36e: Pop(1)
0x36f: Pop(0); Push((bool) Stack[-6] == 0)
...
0x37c: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
...
0x384: Pop(0)
0x385: Push((int) 50)
0x386: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x387: Push(CvectorIndex(Stack[-1], 1))
0x388: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
...
0x390: Push((float)9.999999974752427e-07)
...
0x399: Pop(0)
0x39a: Stack[-5] = Stack[-1] < Stack[-4]; Pop(0);
0x39b: Return(); Pop(2)
...
0x3a3: Pop(0)
0x3a4: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3ae: Stack[-1] = "idle" // @poff=146
0x3af: Push(Stack[-3])
0x3b0: IF (Stack[-1] == 0) GOTO 0x3b2; Pop(1)

0x3b1: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3b2: Stack[-1] = Stack[-4]
0x3b3: Return(); Pop(2)

0x3b4: PushEmpty(int, bool, int, bool)
0x3b5: Stack[-2] = (int) 0
0x3b6: Push("all") // @poff=138
...
0x3c3: Stack[-2] = Stack[-5]
0x3c4: Return(); Pop(4)

0x3c5: PushEmpty()
0x3c6: Push("ook4GrabitelEntrance1") // @poff=503
0x3c7: Push((int) 1)
...
0x3cd: Stack[-1] = "ook4GrabitelEntrance1" // @poff=503
0x3ce: Call2 0x39c
...
0x3fe: Push("GenerateMoney: iMin > iMax") // @poff=561
0x3ff: @ Trace(Stack[-1])
0x400: Pop(1)
0x401: Return(); Pop(4)
...
0x42a: Stack[-3] = "lockpick" // @poff=639
0x42b: Stack[-2] = (int) 1
0x42c: Stack[-1] = (int) 6
0x42d: Call2 0x359
...
0x430: Stack[-1] = "grabitel_mark" // @poff=657
0x431: Call2 0x438
...
0x441: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=685
0x442: Return(); Pop(0)

0x443: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=725
0x444: Return(); Pop(0)
...
0x44a: Push(-1, 0); TaskCall(3)
0x44b: Call2 0x1a2

0x44c: Pop(-1, 0); TaskReturn
0x44d: Pop(1)
0x44e: Return(); Pop(0)

0x44f: PushEmpty()
0x450: PushEmpty(object, int, float)
0x451: Stack[-7] = Stack[-3]
0x452: Stack[-6] = Stack[-2]
0x453: Stack[-5] = Stack[-1]
0x454: Call2 0x27a
...
0x459: Stack[-11] = Stack[-5]
0x45a: Stack[-10] = Stack[-4]
0x45b: Stack[-9] = Stack[-3]
0x45c: Stack[-7] = Stack[-2]
0x45d: Stack[-6] = Stack[-1]
0x45e: Call2 0x2be
...
0x470: Stack[-2] = "quest_k4_01" // @poff=783
0x471: Stack[-1] = "grabitel_entrance_dead" // @poff=807
0x472: Call2 0x3a1
