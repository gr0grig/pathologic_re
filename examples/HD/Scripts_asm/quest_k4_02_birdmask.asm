...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x293: Push("HasProperty") // @poff=192
0x294: Push((int) 2)
...
0x29a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=216
0x29b: Pop(0)
0x29c: Stack[-1] = Stack[-5]
0x29d: Return(); Pop(2)

0x29e: PushEmpty(float, float)
0x29f: PushEmpty(bool, object, string)
0x2a0: Stack[-10] = Stack[-2]
0x2a1: Stack[-9] = Stack[-1]
0x2a2: Call2 0x292
...
0x2a8: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=228
0x2a9: Pop(0)
0x2aa: PushEmpty(float, float, float, float)
0x2ab: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x2ac: Stack[-8] = Stack[-2]
0x2ad: Stack[-7] = Stack[-1]
0x2ae: Call2 0x352

0x2af: Pop(3)
0x2b0: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=240
0x2b1: Pop(1)
0x2b2: Stack[-8] = (bool) 1
0x2b3: Return(); Pop(2)

0x2b4: PushEmpty(int, int)
0x2b5: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=228
0x2b6: Pop(0)
0x2b7: Pop(0); Push(Stack[-1] + Stack[-3]);
0x2b8: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=240
0x2b9: Pop(1)
0x2ba: Return(); Pop(2)
...
0x2c1: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x2c2: Pop(0)
0x2c3: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=252
0x2c4: Pop(0)
...
0x322: Push("Can't find lsh animation : ") // @poff=266
...
0x331: Push("Can't find lsh animation : ") // @poff=266
...
0x337: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=252
0x338: Pop(0)
...
0x364: Pop(0)
0x365: @@ add(Stack[-4]); Obj=1 // @poff=322
0x366: Pop(0)
0x367: @@ add(Stack[-3]); Obj=1 // @poff=322
0x368: Pop(0)
0x369: Push((int) 3)
...
0x371: Stack[-2] = "money" // @poff=326
0x372: Stack[-6] = Stack[-1]
0x373: Call2 0x2b4
...
0x378: Push("Money") // @poff=338
0x379: @ GetInvItemByName(Stack[-2], Stack[-1])
0x37a: Pop(1)
0x37b: PushEmpty(int, int)
0x37c: Stack[-3] = Stack[-2]
0x37d: Stack[-5] = Stack[-1]
0x37e: Call2 0x362
...
0x39b: Stack[-8] = Stack[-5]
0x39c: Stack[-4] = "reputation" // @poff=350
...
0x3a6: Pop(0)
0x3a7: @@ add(Stack[-3]); Obj=1 // @poff=322
0x3a8: Pop(0)
0x3a9: Push((int) 16)
...
0x3b0: Pop(0)
0x3b1: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x3be: Stack[-1] = "ui/NPC_bmask.png" // @poff=372
0x3bf: Return(); Pop(0)

0x3c0: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=406
0x3c1: Return(); Pop(0)
...
0x3dc: PushEmpty()
0x3dd: Push("ook4BirdmaskTheater1") // @poff=444
0x3de: Push((int) 1)
...
0x3e2: PushEmpty()
0x3e3: Push("k4q02BirdmaskGotoMaria") // @poff=486
0x3e4: Push((int) 1)
...
0x3ed: Stack[-2] = "quest_k4_02" // @poff=532
0x3ee: Stack[-1] = "init_theater" // @poff=556
0x3ef: Call2 0x3ae
...
0x3f2: PushEmpty()
0x3f3: Push("money 500 removed") // @poff=582
0x3f4: @ Trace(Stack[-1])
0x3f5: Pop(1)
0x3f6: PushEmpty(object, int)
0x3f7: Stack[-4] = Stack[-2]
...
0x3fe: Stack[-5] = Stack[-2]
0x3ff: Stack[-1] = (float) 0.10000000149011612
0x400: Call2 0x381
...
0x41d: Stack[-1] = "ook4BirdmaskTheater1" // @poff=444
0x41e: Call2 0x35d
...
0x429: Stack[-1] = "k4q02BirdmaskGotoMaria" // @poff=486
0x42a: Call2 0x35d
...
0x43e: Push("money") // @poff=326
0x43f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=228
0x440: Pop(1)
0x441: Push((int) 500)
...
0x45a: Push("Can't retrieve diary root") // @poff=630
0x45b: @ Trace(Stack[-1])
0x45c: Pop(1)
...
0x466: Pop(1)
0x467: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=682
0x468: Pop(0)
0x469: Pop(0); Push((bool) Stack[-2] == 0)
0x46a: IF (Stack[-1] == 0) GOTO 0x471; Pop(1)

0x46b: Push("Can't find diary parent with id: ") // @poff=687
...
0x471: @@ AddChild(Stack[-8]); Obj=2 // @poff=755
0x472: Pop(0)
0x473: Push((int) 7)
0x474: @ SendWorldWndMessage(Stack[-1])
0x475: Pop(1)
0x476: @@ GetCategory(Stack[-1]); Obj=8 // @poff=764
0x477: Pop(0)
