...
Strings:
	...
	W:ui/NPC_Prophet_b.png
// @pool_raw:
// @pool_encoding:utf8
...
0x2dc: Pop(0)
0x2dd: Push((bool) 1)
0x2de: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2df: Pop(1)
0x2e0: Push(CvectorIndex(Stack[-4], 0))
0x2e1: Push(CvectorIndex(Stack[-5], 2))
0x2e2: @ Rotate(Stack[-2], Stack[-1])
0x2e3: Pop(2)
...
0x2ee: Push("head") // @poff=186
0x2ef: @ LookAsyncCamera(Stack[-1])
0x2f0: Pop(1)
0x2f1: @ CameraWaitForPlayFinish()
0x2f2: Pop(0)
0x2f3: @ ResumeWorld()
0x2f4: Pop(0)
0x2f5: Stack[-21] = (bool) 1
0x2f6: Return(); Pop(18)

0x2f7: PushEmpty(bool, bool)
0x2f8: Push((bool) 1)
0x2f9: @ CameraSwitchToNormal(Stack[-1])
0x2fa: Pop(1)
...
0x314: Push("Can't find lsh animation : ") // @poff=222
...
0x323: Push("Can't find lsh animation : ") // @poff=222
0x324: Pop(1); Push(Stack[-1] + Stack[-9]);
0x325: @ Trace(Stack[-1])
0x326: Pop(1)
0x327: Return(); Pop(6)

0x328: PushEmpty(float, cvector, float, cvector)
0x329: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x32a: Pop(0)
0x32b: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x32c: Push(CvectorIndex(Stack[-1], 1))
0x32d: Stack[-3] = Stack[-1]
0x32e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x32f: Push("head") // @poff=186
0x330: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x331: Pop(1)
0x332: Return(); Pop(4)
...
0x33f: Stack[-1] = 0
0x340: PushEmpty(float, float)
0x341: Pop(0); Push(Stack[-3] | Stack[-3]);
0x342: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x343: Push((float)9.999999974752427e-07)
0x344: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x345: IF (Stack[-1] == 0) GOTO 0x348; Pop(1)

0x346: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x347: Return(); Pop(2)

0x348: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x349: Return(); Pop(2)

0x34a: PushEmpty(int, int)
0x34b: @ GetVariable(Stack[-3], Stack[-1])
0x34c: Pop(0)
0x34d: Stack[-1] = Stack[-4]
0x34e: Return(); Pop(2)
...
0x367: PushEmpty()
0x368: Push("k4q02") // @poff=278
0x369: Push((int) 3)
0x36a: @ SetVariable(Stack[-2], Stack[-1])
0x36b: Pop(2)
0x36c: PushEmpty()
0x36d: Call2 0x37c
...
0x370: PushEmpty()
0x371: PushEmpty(int, string)
0x372: Stack[-1] = "k4q02" // @poff=278
0x373: Call2 0x34a

0x374: Pop(1)
0x375: Push((int) 2)
0x376: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x377: IF (Stack[-1] == 0) GOTO 0x37a; Pop(1)

0x378: Stack[-2] = (bool) 1
0x379: Return(); Pop(0)

0x37a: Stack[-2] = (bool) 0
0x37b: Return(); Pop(0)

0x37c: PushEmpty(object, object)
0x37d: Push((int) 382)
0x37e: Push((int) 2)
0x37f: Push((int) 525788)
0x380: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x381: Pop(3)
0x382: PushEmpty(bool, object, int)
0x383: Stack[-4] = Stack[-2]
0x384: Stack[-1] = (int) 378
0x385: Call2 0x396
...
0x38a: @ GetDiaryRoot(Stack[-1])
0x38b: Pop(0)
0x38c: Pop(0); Push((bool) Stack[-1] == 0)
0x38d: IF (Stack[-1] == 0) GOTO 0x393; Pop(1)

0x38e: Push("Can't retrieve diary root") // @poff=290
0x38f: @ Trace(Stack[-1])
0x390: Pop(1)
0x391: Stack[-3] = (bool) 0
0x392: Return(); Pop(2)

0x393: Stack[-1] = Stack[-3]
0x394: Return(); Pop(2)

0x395: Stack[-1] = 0
0x396: PushEmpty(object, object, int, object, object, int)
0x397: PushEmpty(object)
0x398: Call2 0x389

0x399: Stack[-1] = Stack[-4]
0x39a: Pop(1)
0x39b: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=342
0x39c: Pop(0)
0x39d: Pop(0); Push((bool) Stack[-2] == 0)
0x39e: IF (Stack[-1] == 0) GOTO 0x3a5; Pop(1)

0x39f: Push("Can't find diary parent with id: ") // @poff=347
0x3a0: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3a1: @ Trace(Stack[-1])
0x3a2: Pop(1)
0x3a3: Stack[-9] = (bool) 0
0x3a4: Return(); Pop(6)

0x3a5: @@ AddChild(Stack[-8]); Obj=2 // @poff=415
0x3a6: Pop(0)
0x3a7: Push((int) 7)
0x3a8: @ SendWorldWndMessage(Stack[-1])
0x3a9: Pop(1)
0x3aa: @@ GetCategory(Stack[-1]); Obj=8 // @poff=424
0x3ab: Pop(0)
0x3ac: @ SetDiarySection(Stack[-1])
0x3ad: Pop(0)
0x3ae: Stack[-9] = (bool) 0
0x3af: Return(); Pop(6)

0x3b0: Stack[-2] = 0
0x3b1: Stack[-3] = 0
0x3b2: PushEmpty(int, int)
0x3b3: Push("branch") // @poff=436
0x3b4: @ GetVariable(Stack[-1], Stack[-2])
0x3b5: Pop(1)
0x3b6: Push((int) 0)
0x3b7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x3b8: IF (Stack[-1] == 0) GOTO 0x3bc; Pop(1)
...
0x3c3: Stack[-1] = (int) 518716
0x3c4: Return(); Pop(0)

0x3c5: Stack[-1] = (int) 518715
0x3c6: Return(); Pop(0)

0x3c7: Stack[-1] = "ui/NPC_Prophet.png" // @poff=450
0x3c8: Return(); Pop(0)

0x3c9: Stack[-1] = "ui/NPC_Prophet_b.png" // @poff=488
0x3ca: Return(); Pop(0)
