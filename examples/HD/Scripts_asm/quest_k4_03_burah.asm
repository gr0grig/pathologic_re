...
// @pool_raw:
// @pool_encoding:utf8
...
0x62: Stack[-1] = "Agression" // @poff=89
0x63: Call2 0xa9
...
0x9a: Push("all") // @poff=154
0x9b: Push("idle") // @poff=162
...
0xa3: Push("all") // @poff=154
0xa4: Push("idle") // @poff=162
...
0xeb: Stack[-1] = "Agression" // @poff=89
0xec: Call2 0xa9
...
0x116: Stack[-1] = "Agression" // @poff=89
0x117: Call2 0xa9
...
0x13f: Stack[-1] = "Neutral" // @poff=186
0x140: Call2 0xa9
...
0x156: Stack[-1] = "Agression" // @poff=89
0x157: Call2 0xa9
...
0x16d: Stack[-1] = "Doubt" // @poff=202
0x16e: Call2 0xa9

0x16f: Pop(1)
0x170: Push((int) 542331)
0x171: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x172: Pop(1)
0x173: @@@ ClearReplies(); Obj=0 // @poff=120
0x174: Pop(0)
...
0x17d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x17e: Pop(3)
0x17f: Return(); Pop(0)
...
0x184: Stack[-1] = "Neutral" // @poff=186
0x185: Call2 0xa9

0x186: Pop(1)
0x187: Push((int) 542343)
0x188: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x189: Pop(1)
0x18a: @@@ ClearReplies(); Obj=0 // @poff=120
0x18b: Pop(0)
0x18c: Push((int) 525810)
0x18d: Push((int) -1)
0x18e: Push((int) 27116)
0x18f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x190: Pop(3)
0x191: Return(); Pop(0)
...
0x196: Stack[-1] = "Sorrow" // @poff=172
0x197: Call2 0xa9

0x198: Pop(1)
0x199: Push((int) 542326)
0x19a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x19b: Pop(1)
0x19c: @@@ ClearReplies(); Obj=0 // @poff=120
0x19d: Pop(0)
...
0x1a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=133
0x1a7: Pop(3)
0x1a8: Return(); Pop(0)
...
0x1ad: Stack[-1] = "Neutral" // @poff=186
0x1ae: Call2 0xa9

0x1af: Pop(1)
0x1b0: Push((int) 542329)
0x1b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=109
0x1b2: Pop(1)
0x1b3: @@@ ClearReplies(); Obj=0 // @poff=120
0x1b4: Pop(0)
...
0x215: Stack[-1] = 0
0x216: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x217: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x218: @ RotateAsync(Stack[-2], Stack[-1])
0x219: Pop(2)
0x21a: Return(); Pop(0)

0x21b: PushEmpty(object, bool, object, bool)
0x21c: Push("player") // @poff=246
...
0x279: Stack[-1] = "Neutral" // @poff=186
0x27a: Call2 0x3f6
...
0x288: Stack[-1] = "Neutral" // @poff=186
0x289: Call2 0x3f6
...
0x29f: Stack[-1] = "Neutral" // @poff=186
0x2a0: Call2 0x3f6
...
0x2d3: Stack[-3] = (int) 0
0x2d4: Push("all") // @poff=154
0x2d5: PushEmpty(string, int)
0x2d6: Stack[-6] = Stack[-1]
0x2d7: Call2 0x449
...
0x2f7: Pop(0)
0x2f8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=260
0x2f9: Pop(0)
...
0x304: Pop(2)
0x305: Stack[-1] = Stack[-8]
0x306: Return(); Pop(6)

0x307: PushEmpty(cvector, cvector)
0x308: @@ GetPosition(Stack[-1]); Obj=3 // @poff=260
0x309: Pop(0)
0x30a: PushEmpty(bool, cvector)
0x30b: Stack[-3] = Stack[-1]
0x30c: Call2 0x2fd

0x30d: Stack[-2] = Stack[-6]
0x30e: Pop(2)
0x30f: Return(); Pop(2)
...
0x316: @@ GetPosition(Stack[-8]); Obj=20 // @poff=260
0x317: Pop(0)
0x318: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x319: Pop(0)
...
0x33f: Pop(0)
0x340: Push((bool) 1)
0x341: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x342: Pop(1)
...
0x35b: Push((bool) 1)
0x35c: @ CameraSwitchToNormal(Stack[-1])
0x35d: Pop(1)
...
0x363: Push("head") // @poff=286
0x364: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x365: Pop(1)
0x366: Push(Stack[-1])
0x367: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x368: Push("head") // @poff=286
0x369: @ UnlookAsync(Stack[-1])
0x36a: Pop(1)
0x36b: Return(); Pop(2)

0x36c: PushEmpty(int, int, int, int)
0x36d: Push("voice_common") // @poff=296
0x36e: @ GetVariable(Stack[-1], Stack[-3])
0x36f: Pop(1)
0x370: Push(Stack[-2])
0x371: IF (Stack[-1] == 0) GOTO 0x392; Pop(1)

0x372: PushEmpty(bool, object)
0x373: Stack[-7] = Stack[-1]
0x374: Call2 0x3a6
...
0x37e: Stack[-6] = (bool) 0
0x37f: Return(); Pop(4)

0x380: Push((int) 2)
0x381: @ irand(Stack[-2], Stack[-1])
0x382: Pop(1)
0x383: Push(Stack[-1])
0x384: IF (Stack[-1] == 0) GOTO 0x38d; Pop(1)

0x385: Push("voice_common") // @poff=296
0x386: Push((int) 1)
0x387: Pop(1); Push(Stack[-4] + Stack[-1]);
0x388: Push((int) 3)
0x389: Pop(2); Push(Stack[-2] % Stack[-1]);
0x38a: @ SetVariable(Stack[-2], Stack[-1])
0x38b: Pop(2)
0x38c: GOTO 0x391

0x38d: Push("voice_common") // @poff=296
0x38e: Push((int) 0)
...
0x393: Stack[-7] = Stack[-1]
0x394: Call2 0x3cb

0x395: Pop(1)
0x396: Pop(1); Push((bool) Stack[-1] == 0)
0x397: IF (Stack[-1] == 0) GOTO 0x3a0; Pop(1)

0x398: PushEmpty(bool, object)
0x399: Stack[-7] = Stack[-1]
0x39a: Call2 0x3a6
...
0x39e: Stack[-6] = (bool) 0
0x39f: Return(); Pop(4)

0x3a0: Push("voice_common") // @poff=296
0x3a1: Push((int) 1)
0x3a2: @ SetVariable(Stack[-2], Stack[-1])
0x3a3: Pop(2)
0x3a4: Stack[-6] = (bool) 1
0x3a5: Return(); Pop(4)

0x3a6: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3a7: Stack[-5] = "c" // @poff=322
0x3a8: Stack[-4] = (int) 0
0x3a9: Push((int) 1)
...
0x3ae: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3af: Pop(1)
...
0x3c3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x3c4: Pop(1)
0x3c5: PushEmpty(bool, string)
0x3c6: Stack[-3] = Stack[-1]
0x3c7: Call2 0x415

0x3c8: Stack[-2] = Stack[-14]
0x3c9: Pop(2)
0x3ca: Return(); Pop(10)

0x3cb: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x3cc: Push("d") // @poff=292
0x3cd: PushEmpty(int)
0x3ce: Call2 0x440

0x3cf: Pop(0)
0x3d0: Pop(2); Push(Stack[-2] + Stack[-1]);
0x3d1: Push("m") // @poff=350
0x3d2: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3d3: Stack[-4] = (int) 0
0x3d4: Push((int) 1)
0x3d5: IF (Stack[-1] == 0) GOTO 0x3e1; Pop(1)

0x3d6: Push((int) 1)
0x3d7: Pop(1); Push(Stack[-5] + Stack[-1]);
0x3d8: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3d9: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3da: Pop(1)
0x3db: Pop(0); Push((bool) Stack[-3] == 0)
0x3dc: IF (Stack[-1] == 0) GOTO 0x3de; Pop(1)

0x3dd: GOTO 0x3e1

0x3de: Push((int) 1)
0x3df: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x3e0: GOTO 0x3d4

0x3e1: Pop(0); Push((bool) Stack[-4] == 0)
...
0x3e5: Stack[-2] = (int) 0
0x3e6: Push((int) 1)
0x3e7: Pop(1); Push((bool) Stack[-5] > Stack[-1])
0x3e8: IF (Stack[-1] == 0) GOTO 0x3eb; Pop(1)

0x3e9: @ irand(Stack[-2], Stack[-4])
0x3ea: Pop(0)
0x3eb: Push((int) 1)
0x3ec: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3ed: Pop(1); Push(Stack[-6] + Stack[-1]);
0x3ee: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x3ef: Pop(1)
0x3f0: PushEmpty(bool, string)
0x3f1: Stack[-3] = Stack[-1]
0x3f2: Call2 0x415

0x3f3: Stack[-2] = Stack[-14]
0x3f4: Pop(2)
0x3f5: Return(); Pop(10)

0x3f6: PushEmpty(bool, float, float, bool, float, float)
0x3f7: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3f8: Pop(0)
0x3f9: Push(Stack[-3])
0x3fa: IF (Stack[-1] == 0) GOTO 0x401; Pop(1)

0x3fb: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3fc: Pop(0)
0x3fd: Push((bool) 0)
0x3fe: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3ff: Pop(1)
0x400: GOTO 0x405

0x401: Push("Can't find lsh animation : ") // @poff=354
0x402: Pop(1); Push(Stack[-1] + Stack[-8]);
0x403: @ Trace(Stack[-1])
0x404: Pop(1)
0x405: Return(); Pop(6)

0x406: PushEmpty(bool, float, float, bool, float, float)
0x407: @ lshHasAnimation(Stack[-3], Stack[-8])
0x408: Pop(0)
0x409: Push(Stack[-3])
0x40a: IF (Stack[-1] == 0) GOTO 0x410; Pop(1)

0x40b: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x40c: Pop(0)
0x40d: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x40e: Pop(0)
0x40f: GOTO 0x414

0x410: Push("Can't find lsh animation : ") // @poff=354
0x411: Pop(1); Push(Stack[-1] + Stack[-9]);
0x412: @ Trace(Stack[-1])
0x413: Pop(1)
0x414: Return(); Pop(6)
...
0x41a: @ lshHasSpeech(Stack[-1], Stack[-3])
0x41b: Pop(0)
0x41c: Push(Stack[-1])
0x41d: IF (Stack[-1] == 0) GOTO 0x422; Pop(1)

0x41e: @ lshPlaySpeech(Stack[-3])
0x41f: Pop(0)
0x420: Stack[-4] = (bool) 1
0x421: Return(); Pop(2)

0x422: Stack[-4] = (bool) 0
0x423: Return(); Pop(2)
...
0x432: Pop(0); Push(Stack[-3] | Stack[-3]);
0x433: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x434: Push((float)9.999999974752427e-07)
0x435: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x436: IF (Stack[-1] == 0) GOTO 0x439; Pop(1)

0x437: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x438: Return(); Pop(2)

0x439: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x43a: Return(); Pop(2)

0x43b: PushEmpty(int, int)
0x43c: @ GetVariable(Stack[-3], Stack[-1])
0x43d: Pop(0)
0x43e: Stack[-1] = Stack[-4]
0x43f: Return(); Pop(2)

0x440: PushEmpty(float, float)
0x441: @ GetGameTime(Stack[-1])
0x442: Pop(0)
0x443: Push((int) 1)
0x444: PushEmpty(int)
0x445: Push((int) 24)
0x446: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x447: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x448: Return(); Pop(2)

0x449: PushEmpty(string, string)
0x44a: Stack[-1] = "idle" // @poff=162
0x44b: Push(Stack[-3])
0x44c: IF (Stack[-1] == 0) GOTO 0x44e; Pop(1)

0x44d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x44e: Stack[-1] = Stack[-4]
0x44f: Return(); Pop(2)

0x450: PushEmpty(int, bool, int, bool)
0x451: Stack[-2] = (int) 0
0x452: Push("all") // @poff=154
0x453: PushEmpty(string, int)
0x454: Stack[-5] = Stack[-1]
0x455: Call2 0x449

0x456: Pop(1)
0x457: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x458: Pop(2)
0x459: Pop(0); Push((bool) Stack[-1] == 0)
0x45a: IF (Stack[-1] == 0) GOTO 0x45c; Pop(1)

0x45b: GOTO 0x45f

0x45c: Push((int) 1)
0x45d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x45e: GOTO 0x452

0x45f: Stack[-2] = Stack[-5]
0x460: Return(); Pop(4)

0x461: PushEmpty()
0x462: Push("k4q03") // @poff=410
0x463: Push((int) 3)
...
0x473: PushEmpty()
0x474: Push("ook4BurahIndoor1") // @poff=422
0x475: Push((int) 1)
0x476: @ SetVariable(Stack[-2], Stack[-1])
0x477: Pop(2)
0x478: Return(); Pop(0)

0x479: PushEmpty()
0x47a: PushEmpty(int, string)
0x47b: Stack[-1] = "ook4BurahIndoor1" // @poff=422
0x47c: Call2 0x43b
...
0x486: Push((int) 506)
0x487: Push((int) 2)
0x488: Push((int) 529270)
0x489: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x48a: Pop(3)
0x48b: PushEmpty(bool, object, int)
0x48c: Stack[-4] = Stack[-2]
0x48d: Stack[-1] = (int) 384
0x48e: Call2 0x4ac
...
0x493: Push((int) 505)
0x494: Push((int) 2)
0x495: Push((int) 529269)
0x496: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x497: Pop(3)
0x498: PushEmpty(bool, object, int)
0x499: Stack[-4] = Stack[-2]
0x49a: Stack[-1] = (int) 384
0x49b: Call2 0x4ac
...
0x4a0: @ GetDiaryRoot(Stack[-1])
0x4a1: Pop(0)
0x4a2: Pop(0); Push((bool) Stack[-1] == 0)
0x4a3: IF (Stack[-1] == 0) GOTO 0x4a9; Pop(1)

0x4a4: Push("Can't retrieve diary root") // @poff=456
0x4a5: @ Trace(Stack[-1])
0x4a6: Pop(1)
...
0x4ab: Stack[-1] = 0
0x4ac: PushEmpty(object, object, int, object, object, int)
0x4ad: PushEmpty(object)
0x4ae: Call2 0x49f

0x4af: Stack[-1] = Stack[-4]
0x4b0: Pop(1)
0x4b1: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=508
0x4b2: Pop(0)
0x4b3: Pop(0); Push((bool) Stack[-2] == 0)
0x4b4: IF (Stack[-1] == 0) GOTO 0x4bb; Pop(1)

0x4b5: Push("Can't find diary parent with id: ") // @poff=513
0x4b6: Pop(1); Push(Stack[-1] + Stack[-8]);
0x4b7: @ Trace(Stack[-1])
0x4b8: Pop(1)
0x4b9: Stack[-9] = (bool) 0
0x4ba: Return(); Pop(6)

0x4bb: @@ AddChild(Stack[-8]); Obj=2 // @poff=581
0x4bc: Pop(0)
0x4bd: Push((int) 7)
0x4be: @ SendWorldWndMessage(Stack[-1])
0x4bf: Pop(1)
0x4c0: @@ GetCategory(Stack[-1]); Obj=8 // @poff=590
0x4c1: Pop(0)
0x4c2: @ SetDiarySection(Stack[-1])
0x4c3: Pop(0)
...
0x4d9: Stack[-1] = (int) 515592
0x4da: Return(); Pop(0)

0x4db: Stack[-1] = (int) 511961
0x4dc: Return(); Pop(0)

0x4dd: Stack[-1] = "ui/NPC_Burah.png" // @poff=616
0x4de: Return(); Pop(0)

0x4df: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=650
0x4e0: Return(); Pop(0)
