...
// @pool_raw:
// @pool_encoding:utf8
...
0x166: Push("player") // @poff=172
0x167: @ FindActor(Stack[-4]T, Stack[-1])
0x168: Pop(1)
...
0x17b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1d0: Pop(0)
0x1d1: Push("all") // @poff=138
0x1d2: PushEmpty(string, int)
0x1d3: Stack[-7] = Stack[-1]
0x1d4: Call2 0x2b3
...
0x206: Pop(0)
0x207: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x208: Pop(0)
...
0x212: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x213: Pop(0)
0x214: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x215: Pop(0)
...
0x273: Push("Can't find lsh animation : ") // @poff=222
...
0x282: Push("Can't find lsh animation : ") // @poff=222
...
0x288: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x289: Pop(0)
...
0x2a2: Push((float)9.999999974752427e-07)
...
0x2b0: Pop(0)
0x2b1: Stack[-1] = Stack[-3]
0x2b2: Return(); Pop(2)

0x2b3: PushEmpty(string, string)
0x2b4: Stack[-1] = "idle" // @poff=146
0x2b5: Push(Stack[-3])
...
0x2d3: Pop(1)
0x2d4: Push("k5q02KabatchikGotoAlexandr") // @poff=290
0x2d5: Push("pt_map_alexandr") // @poff=344
0x2d6: Push((int) 0)
...
0x2da: Pop(0)
0x2db: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=376
0x2dc: Pop(5)
0x2dd: PushEmpty()
0x2de: Call2 0x2fe
...
0x2e7: Pop(1)
0x2e8: Stack[-2] = "pt_map_alexandr" // @poff=344
0x2e9: Stack[-1] = (int) 2
0x2ea: Call2 0x345
...
0x2ee: Pop(0)
0x2ef: @@ ShowMap(Stack[-1]); Obj=2 // @poff=384
0x2f0: Pop(1)
0x2f1: Return(); Pop(0)

0x2f2: PushEmpty()
0x2f3: PushEmpty(int, string)
0x2f4: Stack[-1] = "k5q02" // @poff=278
0x2f5: Call2 0x2a9
...
0x310: Push("Can't retrieve diary root") // @poff=392
0x311: @ Trace(Stack[-1])
0x312: Pop(1)
...
0x31c: Pop(1)
0x31d: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=444
0x31e: Pop(0)
0x31f: Pop(0); Push((bool) Stack[-2] == 0)
0x320: IF (Stack[-1] == 0) GOTO 0x327; Pop(1)

0x321: Push("Can't find diary parent with id: ") // @poff=449
...
0x327: @@ AddChild(Stack[-8]); Obj=2 // @poff=517
0x328: Pop(0)
0x329: Push((int) 7)
0x32a: @ SendWorldWndMessage(Stack[-1])
0x32b: Pop(1)
0x32c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=526
0x32d: Pop(0)
...
0x336: Pop(0)
0x337: Pop(0); PushNull((bool) Stack[-2] == 0)
0x338: IF (Stack[-1] == 0) GOTO 0x33f; Pop(1)

0x339: Push("Can't find main outdoor scene") // @poff=538
0x33a: @ Trace(Stack[-1])
0x33b: Pop(1)
0x33c: Stack[-1] = 0
0x33d: Stack[-1] = Stack[-5]
0x33e: Return(); Pop(4)

0x33f: @@ GetMap(Stack[-1]); Obj=2 // @poff=598
0x340: Pop(0)
...
0x34a: Push("Can't find main outdoor scene") // @poff=538
0x34b: @ Trace(Stack[-1])
0x34c: Pop(1)
0x34d: Return(); Pop(8)

0x34e: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=605
0x34f: Pop(0)
0x350: Pop(0); Push((bool) Stack[-1] == 0)
0x351: IF (Stack[-1] == 0) GOTO 0x358; Pop(1)

0x352: Push("Warning: outdoor scene locator ") // @poff=616
0x353: Pop(1); Push(Stack[-1] + Stack[-11]);
0x354: Push(" doesnt exist") // @poff=680
0x355: Pop(2); Push(Stack[-2] + Stack[-1]);
0x356: @ Trace(Stack[-1])
0x357: Pop(1)
0x358: @@ GetMap(Stack[-11]); Obj=2 // @poff=598
0x359: Pop(0)
0x35a: Pop(0); PushNull((bool) Stack[-11] == 0)
0x35b: IF (Stack[-1] == 0) GOTO 0x360; Pop(1)

0x35c: Push("Can't find map") // @poff=708
0x35d: @ Trace(Stack[-1])
0x35e: Pop(1)
0x35f: Return(); Pop(8)
...
0x362: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=738
0x363: Pop(2)
0x364: Return(); Pop(8)

0x365: Stack[-2] = 0
0x366: PushEmpty(int, int)
0x367: Push("branch") // @poff=751
...
0x37b: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=765
0x37c: Return(); Pop(0)

0x37d: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=805
0x37e: Return(); Pop(0)
