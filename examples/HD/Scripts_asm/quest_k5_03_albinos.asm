...
Strings:
	...
	W:reputation
	W:ui/NPC_Albinos.png
	W:ui/NPC_Albinos_b.png
	W:completed
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0x734 Vars = (object, int, float, float)
EVENT_43 Op = 0x73c Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0x746 Vars = (object, string)
EVENT_41 Op = 0x753 Vars = (object)
...
0x1ee: Stack[-2] = "quest_k5_03" // @poff=156
0x1ef: Stack[-1] = "abinos_unload" // @poff=180
0x1f0: Call2 0x693
...
0x29f: Pop(0)
0x2a0: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=232
0x2a1: Pop(1)
0x2a2: Push("pt_k5q03_albinos_path") // @poff=254
0x2a3: @ GetVariable(Stack[-1], Stack[-1]T)
0x2a4: Pop(1)
0x2a5: Push((int) -1)
...
0x2a9: Stack[-3] = "pt_k5q03_albinos_path" // @poff=254
...
0x2c1: Stack[-2] = "quest_k5_03" // @poff=156
0x2c2: Stack[-1] = "abinos_unload" // @poff=180
0x2c3: Call2 0x693
...
0x2ce: @@ GetLocator(Stack[-1], Stack[-5], Stack[-4], Stack[-3]); Obj=8 // @poff=298
0x2cf: Pop(1)
...
0x2d9: Stack[-19] = Stack[-3]
0x2da: Stack[-6] = Stack[-2]
0x2db: Stack[-5] = Stack[-1]
0x2dc: Call2 0x303
...
0x312: Stack[-2] = "quest_k5_03" // @poff=156
0x313: Stack[-1] = "albinos_retreated" // @poff=309
0x314: Call2 0x693
...
0x328: Pop(0)
0x329: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=345
0x32a: Pop(0)
...
0x347: Stack[-1] = (float) 1.7453293800354004
0x348: Call2 0x326

0x349: Stack[-2] = Stack[-7]
0x34a: Pop(2)
...
0x350: Stack[-1] = (float) 2.6179938316345215
0x351: Call2 0x326

0x352: Stack[-2] = Stack[-7]
0x353: Pop(2)
...
0x358: Push("Can't retreat, distance: ") // @poff=357
...
0x36e: Push((int) 1)
0x36f: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x370: Pop(1)
0x371: Push(Stack[-3])
0x372: IF (Stack[-1] == 0) GOTO 0x38a; Pop(1)

0x373: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x378: Stack[-1] = (float) 2.6179938316345215
0x379: Call2 0x326
...
0x38b: IF (Stack[-1] == 1) GOTO 0x36e; Pop(1)
...
0x392: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3a1: Stack[-1] = (float) 1.7453293800354004
0x3a2: Call2 0x326

0x3a3: Stack[-2] = Stack[-4]
0x3a4: Pop(2)
...
0x3b1: IF (Stack[-1] == 1) GOTO 0x3b7; Pop(1)

0x3b2: PushEmpty(bool)
0x3b3: Call2 0x3d1

0x3b4: Pop(0)
0x3b5: IF (Stack[-1] == 1) GOTO 0x3b7; Pop(1)
...
0x3dd: Pop(2)
0x3de: Push((float)-0.3420201241970062)
...
0x3eb: Pop(0); PushNull((bool) Stack[-21] == 0)
0x3ec: IF (Stack[-1] == 0) GOTO 0x3f2; Pop(1)

0x3ed: PushEmpty(string)
0x3ee: Stack[-1] = "fdie" // @poff=409
0x3ef: Call2 0x445

0x3f0: Pop(1)
0x3f1: GOTO 0x444

0x3f2: @@ GetPosition(Stack[-10]); Obj=21 // @poff=345
0x3f3: Pop(0)
...
0x403: Stack[-6] = "fdie" // @poff=409
0x404: GOTO 0x406

0x405: Stack[-6] = "bdie" // @poff=419
...
0x40c: @ StopAsync()
0x40d: Pop(0)
0x40e: Stack[-21] = Stack[-5]
0x40f: Push("GetScriptProperty") // @poff=429
0x410: Push((int) 2)
0x411: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x412: IF (Stack[-1] == 0) GOTO 0x41e; Pop(1)

0x413: Push("Owner") // @poff=465
0x414: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=477
0x415: Pop(1)
0x416: Push(Stack[-4])
0x417: IF (Stack[-1] == 0) GOTO 0x41e; Pop(1)

0x418: Push("Owner") // @poff=465
0x419: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=495
0x41a: Pop(1)
0x41b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x41c: IF (Stack[-1] == 0) GOTO 0x41e; Pop(1)

0x41d: Stack[-21] = Stack[-5]
0x41e: Push("@GetEyesHeight") // @poff=513
0x41f: Push((int) 1)
0x420: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x421: IF (Stack[-1] == 0) GOTO 0x42d; Pop(1)

0x422: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=543
0x423: Pop(0)
...
0x439: @ StopAsync()
0x43a: Pop(0)
0x43b: Push("head") // @poff=222
0x43c: @ UnlookAsync(Stack[-1])
0x43d: Pop(1)
0x43e: Push("all") // @poff=138
...
0x46f: Stack[-2] = "bullet" // @poff=567
0x470: Return(); Pop(0)

0x471: Stack[-2] = "phys" // @poff=581
0x472: Return(); Pop(0)
...
0x47a: Pop(0)
0x47b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=345
0x47c: Pop(0)
...
0x481: Pop(0)
0x482: @@ GetPosition(Stack[-2]); Obj=7 // @poff=345
0x483: Pop(0)
...
0x48d: Push("HasProperty") // @poff=591
0x48e: Push((int) 2)
...
0x494: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=615
0x495: Pop(0)
...
0x4a2: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=627
0x4a3: Pop(0)
0x4a4: PushEmpty(float, float, float, float)
0x4a5: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x4a6: Stack[-8] = Stack[-2]
0x4a7: Stack[-7] = Stack[-1]
0x4a8: Call2 0x642

0x4a9: Pop(3)
0x4aa: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=639
0x4ab: Pop(1)
...
0x4b0: Stack[-18] = Stack[-2]
0x4b1: Stack[-1] = "health" // @poff=651
0x4b2: Call2 0x48c
...
0x4b9: Stack[-18] = Stack[-2]
0x4ba: Stack[-1] = "armor" // @poff=665
0x4bb: Call2 0x48c
...
0x4c1: Push("armor") // @poff=665
0x4c2: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=627
0x4c3: Pop(1)
0x4c4: Push("armor_") // @poff=677
0x4c5: PushEmpty(string, int)
0x4c6: Stack[-16] = Stack[-1]
0x4c7: Call2 0x465

0x4c8: Pop(1)
0x4c9: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4ca: PushEmpty(bool, object, string)
0x4cb: Stack[-18] = Stack[-2]
0x4cc: Stack[-8] = Stack[-1]
0x4cd: Call2 0x48c
...
0x4d3: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=627
0x4d4: Pop(0)
...
0x4db: Stack[-3] = Stack[-6]
0x4dc: Pop(3)
0x4dd: Push("health") // @poff=651
0x4de: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=627
0x4df: Pop(1)
0x4e0: Push((int) 1)
0x4e1: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4e2: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4e3: Push("health") // @poff=651
...
0x4e9: Pop(3)
0x4ea: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=639
0x4eb: Pop(2)
0x4ec: PushEmpty(bool, object)
0x4ed: Stack[-17] = Stack[-1]
0x4ee: Call2 0x487
...
0x506: @@ GetPosition(Stack[-5]); Obj=15 // @poff=345
0x507: Pop(0)
...
0x517: Stack[-1] = "fhit" // @poff=691
0x518: GOTO 0x51a

0x519: Stack[-1] = "bhit" // @poff=701
0x51a: Push("hit_react") // @poff=711
0x51b: Push("1") // @poff=731
0x51c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x51d: Push("2") // @poff=735
...
0x53b: Stack[-2] = Stack[-11]
0x53c: Pop(2)
0x53d: @ CreateVectorVector(Stack[-8])
0x53e: Pop(0)
0x53f: Stack[-7] = (int) 1
0x540: Push("hit") // @poff=693
...
0x555: Pop(0)
0x556: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=748
0x557: Pop(0)
0x558: PushEmpty(object, int, float, cvector, cvector)
0x559: Stack[-26] = Stack[-5]
0x55a: Stack[-25] = Stack[-4]
0x55b: Stack[-24] = Stack[-3]
0x55c: Stack[-6] = Stack[-2]
...
0x57b: @@ GetPosition(Stack[-8]); Obj=20 // @poff=345
0x57c: Pop(0)
0x57d: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=543
0x57e: Pop(0)
...
0x5a4: Pop(0)
0x5a5: Push((bool) 1)
0x5a6: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x5a7: Pop(1)
0x5a8: Push(CvectorIndex(Stack[-4], 0))
0x5a9: Push(CvectorIndex(Stack[-5], 2))
0x5aa: @ Rotate(Stack[-2], Stack[-1])
0x5ab: Pop(2)
...
0x5b1: Push("head") // @poff=222
0x5b2: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5b3: Pop(1)
0x5b4: Push(Stack[-1])
0x5b5: IF (Stack[-1] == 0) GOTO 0x5b9; Pop(1)

0x5b6: Push("head") // @poff=222
0x5b7: @ LookAsyncCamera(Stack[-1])
0x5b8: Pop(1)
0x5b9: @ CameraWaitForPlayFinish()
0x5ba: Pop(0)
0x5bb: @ ResumeWorld()
0x5bc: Pop(0)
0x5bd: Stack[-21] = (bool) 1
0x5be: Return(); Pop(18)

0x5bf: PushEmpty(bool, bool)
0x5c0: Push((bool) 1)
0x5c1: @ CameraSwitchToNormal(Stack[-1])
0x5c2: Pop(1)
...
0x5c8: Push("head") // @poff=222
0x5c9: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x5ca: Pop(1)
0x5cb: Push(Stack[-1])
0x5cc: IF (Stack[-1] == 0) GOTO 0x5d0; Pop(1)

0x5cd: Push("head") // @poff=222
0x5ce: @ UnlookAsync(Stack[-1])
0x5cf: Pop(1)
0x5d0: Return(); Pop(2)

0x5d1: PushEmpty(bool, float, float, bool, float, float)
0x5d2: @ lshHasAnimation(Stack[-3], Stack[-7])
0x5d3: Pop(0)
0x5d4: Push(Stack[-3])
0x5d5: IF (Stack[-1] == 0) GOTO 0x5dc; Pop(1)

0x5d6: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x5d7: Pop(0)
0x5d8: Push((bool) 0)
0x5d9: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x5da: Pop(1)
0x5db: GOTO 0x5e0

0x5dc: Push("Can't find lsh animation : ") // @poff=798
0x5dd: Pop(1); Push(Stack[-1] + Stack[-8]);
0x5de: @ Trace(Stack[-1])
0x5df: Pop(1)
0x5e0: Return(); Pop(6)

0x5e1: PushEmpty(bool, float, float, bool, float, float)
0x5e2: @ lshHasAnimation(Stack[-3], Stack[-8])
0x5e3: Pop(0)
0x5e4: Push(Stack[-3])
0x5e5: IF (Stack[-1] == 0) GOTO 0x5eb; Pop(1)

0x5e6: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x5e7: Pop(0)
0x5e8: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x5e9: Pop(0)
0x5ea: GOTO 0x5ef

0x5eb: Push("Can't find lsh animation : ") // @poff=798
0x5ec: Pop(1); Push(Stack[-1] + Stack[-9]);
0x5ed: @ Trace(Stack[-1])
0x5ee: Pop(1)
0x5ef: Return(); Pop(6)

0x5f0: PushEmpty(float, cvector, float, cvector)
0x5f1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=543
0x5f2: Pop(0)
0x5f3: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x5f4: Push(CvectorIndex(Stack[-1], 1))
0x5f5: Stack[-3] = Stack[-1]
0x5f6: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x5f7: Push("head") // @poff=222
0x5f8: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x5f9: Pop(1)
0x5fa: Return(); Pop(4)

0x5fb: PushEmpty(bool)
0x5fc: Call2 0x6a7
...
0x602: PushEmpty(bool, int, bool, int, bool, float, cvector, cvector, bool, int, bool, int, bool, float, cvector, cvector)
0x603: @ IsExisting3DSound(Stack[-8], Stack[-17])
0x604: Pop(0)
0x605: Pop(0); Push((bool) Stack[-8] == 0)
0x606: IF (Stack[-1] == 0) GOTO 0x61b; Pop(1)

0x607: Stack[-7] = (int) 0
0x608: Push((int) 1)
0x609: Pop(1); Push(Stack[-8] + Stack[-1]);
0x60a: Pop(1); Push(Stack[-18] + Stack[-1]);
0x60b: @ IsExisting3DSound(Stack[-7], Stack[-1])
0x60c: Pop(1)
0x60d: Pop(0); Push((bool) Stack[-6] == 0)
0x60e: IF (Stack[-1] == 0) GOTO 0x610; Pop(1)

0x60f: GOTO 0x613

0x610: Push((int) 1)
0x611: Stack[-8] = Stack[-8] + Stack[-1]; Pop(1);
0x612: GOTO 0x608

0x613: Pop(0); Push((bool) Stack[-7] == 0)
0x614: IF (Stack[-1] == 0) GOTO 0x616; Pop(1)

0x615: Return(); Pop(16)

0x616: @ irand(Stack[-5], Stack[-7])
0x617: Pop(0)
0x618: Push((int) 1)
0x619: Pop(1); Push(Stack[-6] + Stack[-1]);
0x61a: Stack[-18] = Stack[-18] + Stack[-1]; Pop(1);
0x61b: @ Is3DSoundLoaded(Stack[-4], Stack[-17])
0x61c: Pop(0)
0x61d: Push(Stack[-4])
0x61e: IF (Stack[-1] == 0) GOTO 0x62a; Pop(1)

0x61f: @ GetEyesHeight(Stack[-3])
0x620: Pop(0)
0x621: @ GetDirection(Stack[-2])
0x622: Pop(0)
0x623: Push((int) 50)
0x624: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x625: Push(CvectorIndex(Stack[-1], 1))
0x626: Stack[-1] = Stack[-1] + Stack[-4]; Pop(0);
0x627: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x628: @ PlayGlobalSound(Stack[-17], Stack[-1])
0x629: Pop(0)
0x62a: Return(); Pop(16)
...
0x62c: @ self(Stack[-1])
0x62d: Pop(0)
0x62e: Stack[-1] = Stack[-3]
0x62f: Return(); Pop(2)

0x630: Stack[-1] = 0
0x631: PushEmpty(float, float)
0x632: Pop(0); Push(Stack[-3] | Stack[-3]);
0x633: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x634: Push((float)9.999999974752427e-07)
0x635: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x636: IF (Stack[-1] == 0) GOTO 0x639; Pop(1)

0x637: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x638: Return(); Pop(2)

0x639: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x63a: Return(); Pop(2)

0x63b: PushEmpty()
0x63c: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x63d: IF (Stack[-1] == 0) GOTO 0x640; Pop(1)

0x63e: Stack[-2] = Stack[-3]
0x63f: GOTO 0x641
...
0x642: PushEmpty()
0x643: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x644: IF (Stack[-1] == 0) GOTO 0x647; Pop(1)

0x645: Stack[-2] = Stack[-4]
0x646: Return(); Pop(0)

0x647: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x648: IF (Stack[-1] == 0) GOTO 0x64b; Pop(1)

0x649: Stack[-1] = Stack[-4]
0x64a: Return(); Pop(0)

0x64b: Stack[-3] = Stack[-4]
0x64c: Return(); Pop(0)

0x64d: PushEmpty()
0x64e: Pop(0); Push(Stack[-2] | Stack[-1]);
0x64f: Pop(0); Push(Stack[-3] | Stack[-3]);
0x650: Pop(0); Push(Stack[-3] | Stack[-3]);
0x651: Pop(2); Push(Stack[-2] * Stack[-1]);
0x652: Pop(1); Push(Sqrt(Stack[-1]))
0x653: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x654: Return(); Pop(0)

0x655: PushEmpty()
0x656: Pop(0); Push((bool) Stack[-2] == 0)
0x657: IF (Stack[-1] == 0) GOTO 0x65a; Pop(1)

0x658: Stack[-3] = (bool) 0
0x659: Return(); Pop(0)
...
0x65d: Push((int) 8)
0x65e: @ SendWorldWndMessage(Stack[-1])
0x65f: Pop(1)
0x660: GOTO 0x66a
...
0x664: Push((int) 9)
0x665: @ SendWorldWndMessage(Stack[-1])
0x666: Pop(1)
0x667: GOTO 0x66a

0x668: Stack[-3] = (bool) 0
0x669: Return(); Pop(0)

0x66a: PushEmpty(float)
0x66b: Stack[-2] = Stack[-1]
0x66c: Call2 0x689

0x66d: Pop(1)
0x66e: PushEmpty(bool, object, string, float, float, float)
0x66f: Stack[-8] = Stack[-5]
0x670: Stack[-4] = "reputation" // @poff=854
0x671: Stack[-7] = Stack[-3]
0x672: Stack[-2] = (int) 0
0x673: Stack[-1] = (int) 1
0x674: Call2 0x498

0x675: Pop(6)
0x676: Stack[-3] = (bool) 1
0x677: Return(); Pop(0)

0x678: PushEmpty(object, object)
0x679: @ CreateFloatVector(Stack[-1])
0x67a: Pop(0)
0x67b: @@ add(Stack[-3]); Obj=1 // @poff=739
0x67c: Pop(0)
0x67d: Push((int) 0)
0x67e: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x67f: IF (Stack[-1] == 0) GOTO 0x684; Pop(1)

0x680: Push((float)0.699999988079071)
0x681: Push((int) 500)
0x682: @ RumblePlay(Stack[-2], Stack[-1])
0x683: Pop(2)
0x684: Push((int) 15)
...
0x68a: @ CreateFloatVector(Stack[-1])
0x68b: Pop(0)
0x68c: @@ add(Stack[-3]); Obj=1 // @poff=739
0x68d: Pop(0)
0x68e: Push((int) 16)
0x68f: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x690: Pop(1)
0x691: Return(); Pop(2)

0x692: Stack[-1] = 0
0x693: PushEmpty(object, object)
0x694: @ FindActor(Stack[-1], Stack[-4])
0x695: Pop(0)
0x696: Pop(0); PushNull((bool) Stack[-1] == 0)
0x697: IF (Stack[-1] == 0) GOTO 0x69a; Pop(1)

0x698: Stack[-5] = (bool) 0
0x699: Return(); Pop(2)

0x69a: @ Trigger(Stack[-1], Stack[-3])
0x69b: Pop(0)
0x69c: Stack[-5] = (bool) 1
0x69d: Return(); Pop(2)

0x69e: Stack[-1] = 0
0x69f: Stack[-1] = (int) 515595
0x6a0: Return(); Pop(0)

0x6a1: Stack[-1] = (int) 512611
0x6a2: Return(); Pop(0)

0x6a3: Stack[-1] = "ui/NPC_Albinos.png" // @poff=876
0x6a4: Return(); Pop(0)

0x6a5: Stack[-1] = "ui/NPC_Albinos_b.png" // @poff=914
0x6a6: Return(); Pop(0)

0x6a7: Stack[-1] = (bool) 0
0x6a8: Return(); Pop(0)

0x6a9: PushEmpty(string, string)
0x6aa: Stack[-1] = "idle" // @poff=146
0x6ab: Push(Stack[-3])
0x6ac: IF (Stack[-1] == 0) GOTO 0x6ae; Pop(1)

0x6ad: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x6ae: Stack[-1] = Stack[-4]
0x6af: Return(); Pop(2)

0x6b0: PushEmpty(int, bool, int, bool)
0x6b1: Stack[-2] = (int) 0
0x6b2: Push("all") // @poff=138
0x6b3: PushEmpty(string, int)
0x6b4: Stack[-5] = Stack[-1]
0x6b5: Call2 0x6a9

0x6b6: Pop(1)
0x6b7: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x6b8: Pop(2)
...
0x6bc: Push((int) 1)
0x6bd: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x6be: GOTO 0x6b2

0x6bf: Stack[-2] = Stack[-5]
0x6c0: Return(); Pop(4)
...
0x6c4: Pop(0)
0x6c5: PushEmpty(bool, string, string)
0x6c6: Stack[-2] = "quest_k5_03" // @poff=156
0x6c7: Stack[-1] = "completed" // @poff=956
0x6c8: Call2 0x693
...
0x6cc: Push((int) 407)
0x6cd: Push((int) 2)
0x6ce: Push((int) 526025)
0x6cf: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6d0: Pop(3)
0x6d1: PushEmpty(bool, object, int)
0x6d2: Stack[-4] = Stack[-2]
0x6d3: Stack[-1] = (int) 405
0x6d4: Call2 0x6e5
...
0x6d9: @ GetDiaryRoot(Stack[-1])
0x6da: Pop(0)
0x6db: Pop(0); Push((bool) Stack[-1] == 0)
0x6dc: IF (Stack[-1] == 0) GOTO 0x6e2; Pop(1)

0x6dd: Push("Can't retrieve diary root") // @poff=976
0x6de: @ Trace(Stack[-1])
0x6df: Pop(1)
0x6e0: Stack[-3] = (bool) 0
0x6e1: Return(); Pop(2)
...
0x6e4: Stack[-1] = 0
0x6e5: PushEmpty(object, object, int, object, object, int)
0x6e6: PushEmpty(object)
0x6e7: Call2 0x6d8

0x6e8: Stack[-1] = Stack[-4]
0x6e9: Pop(1)
0x6ea: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1028
0x6eb: Pop(0)
0x6ec: Pop(0); Push((bool) Stack[-2] == 0)
0x6ed: IF (Stack[-1] == 0) GOTO 0x6f4; Pop(1)

0x6ee: Push("Can't find diary parent with id: ") // @poff=1033
0x6ef: Pop(1); Push(Stack[-1] + Stack[-8]);
0x6f0: @ Trace(Stack[-1])
0x6f1: Pop(1)
0x6f2: Stack[-9] = (bool) 0
0x6f3: Return(); Pop(6)

0x6f4: @@ AddChild(Stack[-8]); Obj=2 // @poff=1101
0x6f5: Pop(0)
0x6f6: Push((int) 7)
0x6f7: @ SendWorldWndMessage(Stack[-1])
0x6f8: Pop(1)
0x6f9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1110
0x6fa: Pop(0)
0x6fb: @ SetDiarySection(Stack[-1])
0x6fc: Pop(0)
0x6fd: Stack[-9] = (bool) 0
0x6fe: Return(); Pop(6)

0x6ff: Stack[-2] = 0
0x700: Stack[-3] = 0
0x701: PushEmpty(int, int)
0x702: Push("branch") // @poff=1122
0x703: @ GetVariable(Stack[-1], Stack[-2])
0x704: Pop(1)
0x705: Push((int) 0)
0x706: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x707: IF (Stack[-1] == 0) GOTO 0x70b; Pop(1)
...
0x712: PushEmpty(object, float, object, float)
0x713: Push("player") // @poff=208
0x714: @ FindActor(Stack[-3], Stack[-1])
0x715: Pop(1)
0x716: Push(Stack[-2])
0x717: IF (Stack[-1] == 0) GOTO 0x72a; Pop(1)

0x718: PushEmpty(float, object)
0x719: Stack[-4] = Stack[-1]
0x71a: Call2 0x47f

0x71b: Pop(1)
0x71c: Push((float)640000.0)
0x71d: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x71e: IF (Stack[-1] == 0) GOTO 0x72a; Pop(1)

0x71f: PushEmpty(float, object, float, int)
0x720: Stack[-6] = Stack[-3]
0x721: Stack[-2] = (float) 0.05000000074505806
0x722: Stack[-1] = (int) 0
0x723: Call2 0x4ae

0x724: Stack[-4] = Stack[-5]
0x725: Pop(4)
0x726: Push((int) 6)
0x727: Push((float)0.05000000074505806)
0x728: @ ReportHit(Stack[-4], Stack[-2], Stack[-3], Stack[-1])
0x729: Pop(2)
0x72a: Return(); Pop(4)
...
0x72f: Push(-1, 0); TaskCall(5)
0x730: Call2 0x3e1

0x731: Pop(-1, 0); TaskReturn
0x732: Pop(1)
0x733: Return(); Pop(0)

0x734: PushEmpty()
0x735: PushEmpty(object, int, float)
0x736: Stack[-7] = Stack[-3]
0x737: Stack[-6] = Stack[-2]
0x738: Stack[-5] = Stack[-1]
0x739: Call2 0x523
...
0x73c: PushEmpty()
0x73d: PushEmpty(object, int, float, cvector, cvector)
0x73e: Stack[-11] = Stack[-5]
0x73f: Stack[-10] = Stack[-4]
0x740: Stack[-9] = Stack[-3]
0x741: Stack[-7] = Stack[-2]
...
0x747: Push("health") // @poff=651
0x748: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x749: IF (Stack[-1] == 0) GOTO 0x752; Pop(1)

0x74a: Push("health") // @poff=651
0x74b: @ GetProperty(Stack[-1], Stack[-2])
0x74c: Pop(1)
0x74d: Push((int) 0)
0x74e: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x74f: IF (Stack[-1] == 0) GOTO 0x752; Pop(1)

0x750: @ SignalDeath(Stack[-4])
0x751: Pop(0)
0x752: Return(); Pop(2)
...
0x759: PushEmpty(bool, object, float)
0x75a: Stack[-4] = Stack[-2]
0x75b: Stack[-1] = (float) -0.10000000149011612
0x75c: Call2 0x655

0x75d: Pop(3)
0x75e: PushEmpty(object)
