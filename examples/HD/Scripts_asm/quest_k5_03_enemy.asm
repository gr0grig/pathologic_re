...
0xc2b: Push((float)0.699999988079071)
0xc2c: Push((int) 500)
...
0xc53: Stack[-2] = Stack[-5]
0xc54: Return(); Pop(4)

0xc55: PushEmpty(int, int)
0xc56: Push("branch") // @poff=929
...
0xc8a: @@ GetPosition(Stack[-8]); Obj=18 // @poff=43
0xc8b: Pop(0)
...
0xcd5: Pop(0)
0xcd6: Push((int) 1)
0xcd7: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=752
0xcd8: Pop(2)
...
0xd0e: @@ GetLocator(Stack[-1], Stack[-4], Stack[-6], Stack[-5]); Obj=8 // @poff=32
0xd0f: Pop(1)
...
0xd18: Push("Pantrol point count: ") // @poff=967
...
0xd2b: Stack[-1] = Stack[-2]
0xd2c: Pop(1)
0xd2d: GlobalVars[3] = Stack[-1]; Pop(1)
0xd2e: Push("changing state to c_iStateWaitForLoad") // @poff=1011
0xd2f: @ Trace(Stack[-1])
0xd30: Pop(1)
0xd31: GOTO 0xd49
...
0xd35: Push("changing state to c_iStateHeatHands") // @poff=1087
0xd36: @ Trace(Stack[-1])
0xd37: Pop(1)
0xd38: GOTO 0xd49
...
0xd3c: Push("changing state to c_iStateIdle") // @poff=1159
0xd3d: @ Trace(Stack[-1])
0xd3e: Pop(1)
0xd3f: GOTO 0xd49
...
0xd43: Push("changing state to c_iStatePatrol") // @poff=1221
0xd44: @ Trace(Stack[-1])
0xd45: Pop(1)
0xd46: GOTO 0xd49
...
0xd58: Push("changing state to c_iStateAware") // @poff=1287
0xd59: @ Trace(Stack[-1])
0xd5a: Pop(1)
0xd5b: Push(GlobalVars[4])
0xd5c: Stack[-2] = Stack[-1]
...
0xd6a: Push("changing state to c_iStateSearchEnemy") // @poff=1351
0xd6b: @ Trace(Stack[-1])
0xd6c: Pop(1)
0xd6d: Push(GlobalVars[5])
0xd6e: Stack[-2] = Stack[-1]
...
0xd7c: Push("changing state to c_iStateHearEnemy") // @poff=1427
0xd7d: @ Trace(Stack[-1])
0xd7e: Pop(1)
...
0xd8e: Push("changing state to c_iStateAttack") // @poff=1499
0xd8f: @ Trace(Stack[-1])
0xd90: Pop(1)
...
0xdd5: Stack[-7] = Stack[-3]
0xdd6: Stack[-6] = Stack[-2]
0xdd7: Stack[-5] = Stack[-1]
0xdd8: Call2 0xb52
...
0xddd: Stack[-11] = Stack[-5]
0xdde: Stack[-10] = Stack[-4]
0xddf: Stack[-9] = Stack[-3]
0xde0: Stack[-7] = Stack[-2]
0xde1: Stack[-6] = Stack[-1]
0xde2: Call2 0xb96
...
0xdfa: Stack[-1] = "pt_k5q03_patrol" // @poff=1581
0xdfb: Return(); Pop(0)

0xdfc: Stack[-1] = "k5q03_helpme" // @poff=1613
0xdfd: Return(); Pop(0)

0xdfe: Stack[-1] = "k5q03_corpse" // @poff=1639
0xdff: Return(); Pop(0)

0xe00: Stack[-1] = "pt_k5q03_center" // @poff=1665
0xe01: Return(); Pop(0)
...
0xe05: Stack[-4] = "gold_ring" // @poff=1697
0xe06: Stack[-3] = (int) 1
0xe07: Stack[-2] = (int) 2
0xe08: Stack[-1] = (int) 2
0xe09: Call2 0xbbf
...
0xe0c: Stack[-4] = "silver_ring" // @poff=1717
0xe0d: Stack[-3] = (int) 1
0xe0e: Stack[-2] = (int) 2
0xe0f: Stack[-1] = (int) 3
0xe10: Call2 0xbbf
...
0xe1a: Stack[-4] = "bracelet" // @poff=1753
0xe1b: Stack[-3] = (int) 1
0xe1c: Stack[-2] = (int) 2
0xe1d: Stack[-1] = (int) 2
0xe1e: Call2 0xbbf
