...
// @pool_raw:
// @pool_encoding:utf8
...
0x310: Push("Can't find lsh animation : ") // @poff=206
...
0x31f: Push("Can't find lsh animation : ") // @poff=206
...
0x325: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x326: Pop(0)
...
0x34a: Push("Door ") // @poff=262
0x34b: Pop(1); Push(Stack[-1] + Stack[-5]);
0x34c: Push(" not found") // @poff=274
0x34d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x34e: @ Trace(Stack[-1])
0x34f: Pop(1)
0x350: GOTO 0x354

0x351: Push("locked") // @poff=296
0x352: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=310
0x353: Pop(1)
0x354: Return(); Pop(2)

0x355: Stack[-1] = 0
0x356: PushEmpty(string, string)
0x357: Stack[-1] = "idle" // @poff=146
0x358: Push(Stack[-3])
...
0x36c: Stack[-2] = Stack[-5]
0x36d: Return(); Pop(4)

0x36e: PushEmpty()
0x36f: Push("k5q04_bring_water") // @poff=322
0x370: Push((int) 1)
...
0x381: Push("bottle_water") // @poff=370
0x382: Push((int) 20)
0x383: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=396
0x384: Pop(2)
0x385: Return(); Pop(2)

0x386: PushEmpty()
0x387: Push("playsound") // @poff=413
0x388: Push("giveitem") // @poff=433
...
0x38e: Stack[-2] = "sobor@door1" // @poff=451
...
0x3ad: Stack[-1] = "k5q04_bring_water" // @poff=322
0x3ae: Call2 0x340
...
0x3c2: Push("bottle_water") // @poff=370
0x3c3: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=475
0x3c4: Pop(1)
0x3c5: Push((int) 20)
...
0x3eb: Push("Can't retrieve diary root") // @poff=494
0x3ec: @ Trace(Stack[-1])
0x3ed: Pop(1)
...
0x3f7: Pop(1)
0x3f8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=546
0x3f9: Pop(0)
0x3fa: Pop(0); Push((bool) Stack[-2] == 0)
0x3fb: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x3fc: Push("Can't find diary parent with id: ") // @poff=551
...
0x402: @@ AddChild(Stack[-8]); Obj=2 // @poff=619
0x403: Pop(0)
0x404: Push((int) 7)
0x405: @ SendWorldWndMessage(Stack[-1])
0x406: Pop(1)
0x407: @@ GetCategory(Stack[-1]); Obj=8 // @poff=628
0x408: Pop(0)
...
0x420: Stack[-1] = (int) 515572
0x421: Return(); Pop(0)

0x422: Stack[-1] = (int) 504031
0x423: Return(); Pop(0)

0x424: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=654
0x425: Return(); Pop(0)

0x426: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=694
0x427: Return(); Pop(0)
