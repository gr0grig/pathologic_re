...
// @pool_raw:
// @pool_encoding:utf8
...
0x1ed: Push("Can't find lsh animation : ") // @poff=206
...
0x1fc: Push("Can't find lsh animation : ") // @poff=206
...
0x202: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x203: Pop(0)
...
0x233: Stack[-2] = Stack[-5]
0x234: Return(); Pop(4)

0x235: PushEmpty(int, int)
0x236: Push("branch") // @poff=262
...
0x246: Stack[-1] = (int) 515564
0x247: Return(); Pop(0)

0x248: Stack[-1] = (int) 503349
0x249: Return(); Pop(0)

0x24a: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=276
0x24b: Return(); Pop(0)

0x24c: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=316
0x24d: Return(); Pop(0)
