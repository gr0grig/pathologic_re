...
Strings:
	...
	W:placing danko from ospina to eva
	A:GetItemCount
	A:GetItem
	A:add
	A:GetItemAmount
	...
	A:size
	A:get
// @pool_raw:
...
0x18: Pop(2)
0x19: Push("cot_eva") // @poff=0
0x1a: @ GetSceneByName(Stack[-11], Stack[-1])
0x1b: Pop(1)
0x1c: Push("danko") // @poff=38
0x1d: @ Trigger(Stack[-11], Stack[-1])
0x1e: Pop(1)
0x1f: Stack[-10] = 0
0x20: GOTO 0x14e

0x21: Push("teleport") // @poff=78
...
0x44: Pop(1)
0x45: Stack[-2] = "cot_eva" // @poff=0
0x46: Stack[-1] = "pt_k6q01_klara" // @poff=164
0x47: Call2 0x285

0x48: Pop(3)
0x49: @ sync()
0x4a: Pop(0)
0x4b: Push("player") // @poff=194
...
0x7f: Stack[-2] = "icot_eva@door1" // @poff=96
0x80: Stack[-1] = (bool) 1
0x81: Call2 0x240

0x82: Pop(2)
0x83: Push("k6q01DoorWasLocked") // @poff=246
0x84: Push((int) 1)
0x85: @ SetVariable(Stack[-2], Stack[-1])
0x86: Pop(2)
0x87: Push("door_close") // @poff=126
0x88: @ PlaySound(Stack[-1])
0x89: Pop(1)
0x8a: GOTO 0x14e

0x8b: Push("unlock_eva") // @poff=284
0x8c: Pop(1); Push((bool) Stack[-22] == Stack[-1])
0x8d: IF (Stack[-1] == 0) GOTO 0xcc; Pop(1)

0x8e: PushEmpty(string, bool)
0x8f: Stack[-2] = "icot_eva@door1" // @poff=96
0x90: Stack[-1] = (bool) 0
0x91: Call2 0x240

0x92: Pop(2)
0x93: Push("door_open") // @poff=306
0x94: @ PlaySound(Stack[-1])
0x95: Pop(1)
0x96: Push("k6q01ItemsRemoved") // @poff=326
0x97: Push((int) 1)
0x98: @ SetVariable(Stack[-2], Stack[-1])
0x99: Pop(2)
0x9a: @ CreateIntVector(Stack[-3]T)
0x9b: Pop(0)
0x9c: @ CreateIntVector(Stack[-5]T)
0x9d: Pop(0)
0x9e: @ CreateIntVector(Stack[-7]T)
0x9f: Pop(0)
0xa0: @ CreateIntVector(Stack[-9]T)
0xa1: Pop(0)
0xa2: @ CreateIntVector(Stack[-11]T)
0xa3: Pop(0)
0xa4: Push("player") // @poff=194
...
0xbd: Pop(4)
0xbe: Push((int) 1)
0xbf: @@ ClearSubContainer(Stack[-1]); Obj=5 // @poff=362
0xc0: Pop(1)
0xc1: Push((int) 3)
0xc2: @@ ClearSubContainer(Stack[-1]); Obj=5 // @poff=362
0xc3: Pop(1)
0xc4: Push((int) 4)
0xc5: @@ ClearSubContainer(Stack[-1]); Obj=5 // @poff=362
0xc6: Pop(1)
0xc7: @@ SelectWeapon(); Obj=4 // @poff=380
0xc8: Pop(0)
0xc9: Stack[0 + Tasks[-1].StackPointer] = (bool)1
0xca: Stack[-4] = 0
0xcb: GOTO 0x14e

0xcc: Push("place_danko") // @poff=393
...
0xd4: Push("cot_anna") // @poff=417
0xd5: @ GetSceneByName(Stack[-3], Stack[-1])
0xd6: Pop(1)
0xd7: PushEmpty(object, object, string, string, string)
0xd8: Stack[-7] = Stack[-4]
0xd9: Stack[-3] = "pt_k6q01_danko" // @poff=435
0xda: Stack[-2] = "NPC_Bakalavr" // @poff=465
0xdb: Stack[-1] = "k6q01_danko.xml" // @poff=491
0xdc: Call2 0x22e
...
0xea: Pop(2)
0xeb: Push("k6q01DankoPos") // @poff=523
0xec: Push((int) 1)
...
0xf3: Push("cot_lara") // @poff=551
0xf4: @ GetSceneByName(Stack[-3], Stack[-1])
0xf5: Pop(1)
0xf6: PushEmpty(object, object, string, string, string)
0xf7: Stack[-7] = Stack[-4]
0xf8: Stack[-3] = "pt_k6q01_danko" // @poff=435
0xf9: Stack[-2] = "NPC_Bakalavr" // @poff=465
0xfa: Stack[-1] = "k6q01_danko.xml" // @poff=491
0xfb: Call2 0x22e
...
0x105: Pop(2)
0x106: Push("k6q01DankoPos") // @poff=523
0x107: Push((int) 2)
...
0x10e: Push("dt_house_1_04") // @poff=569
0x10f: @ GetSceneByName(Stack[-3], Stack[-1])
0x110: Pop(1)
0x111: PushEmpty(object, object, string, string, string)
0x112: Stack[-7] = Stack[-4]
0x113: Stack[-3] = "pt_k6q01_danko" // @poff=435
0x114: Stack[-2] = "NPC_Bakalavr" // @poff=465
0x115: Stack[-1] = "k6q01_danko.xml" // @poff=491
0x116: Call2 0x22e
...
0x11c: Pop(2)
0x11d: Push("k6q01DankoPos") // @poff=523
0x11e: Push((int) 3)
...
0x123: Stack[-2] = "icot_eva_door" // @poff=50
...
0x129: Pop(0)
0x12a: Push("k6q01DankoPos") // @poff=523
0x12b: Push((int) 4)
...
0x150: Push("k6q01DankoPos") // @poff=523
...
0x15b: Pop(0)
0x15c: Push("cot_lara") // @poff=551
0x15d: @ GetSceneByName(Stack[-5], Stack[-1])
0x15e: Pop(1)
0x15f: Push( Stack[1 + Tasks[-1].StackPointer] )
0x160: IF (Stack[-1] == 0) GOTO 0x164; Pop(1)

0x161: Push("cleanup") // @poff=148
0x162: @ Trigger(Stack[-1]T, Stack[-1])
0x163: Pop(1)
0x164: Pop(0); Push((bool) Stack[-5] != Stack[-4])
0x165: IF (Stack[-1] == 0) GOTO 0x16f; Pop(1)

0x166: Stack[-4] = Stack[-5]
0x167: Push("0: placing danko to lara") // @poff=627
0x168: @ Trace(Stack[-1])
0x169: Pop(1)
0x16a: Push("k6q01DankoPos") // @poff=523
0x16b: Push((int) 2)
0x16c: @ SetVariable(Stack[-2], Stack[-1])
0x16d: Pop(2)
0x16e: GOTO 0x179

0x16f: Push("dt_house_1_04") // @poff=569
0x170: @ GetSceneByName(Stack[-6], Stack[-1])
0x171: Pop(1)
0x172: Push("0: placing danko to ospina") // @poff=677
0x173: @ Trace(Stack[-1])
0x174: Pop(1)
0x175: Push("k6q01DankoPos") // @poff=523
0x176: Push((int) 3)
0x177: @ SetVariable(Stack[-2], Stack[-1])
0x178: Pop(2)
0x179: PushEmpty(object, object, string, string, string)
0x17a: Stack[-10] = Stack[-4]
0x17b: Stack[-3] = "pt_k6q01_danko" // @poff=435
0x17c: Stack[-2] = "NPC_Bakalavr" // @poff=465
0x17d: Stack[-1] = "k6q01_danko.xml" // @poff=491
0x17e: Call2 0x22e
...
0x198: Stack[-7] = Stack[-4]
0x199: Stack[-3] = "pt_k6q01_danko" // @poff=435
0x19a: Stack[-2] = "NPC_Bakalavr" // @poff=465
0x19b: Stack[-1] = "k6q01_danko.xml" // @poff=491
0x19c: Call2 0x22e

0x19d: Stack[1 + Tasks[-1].StackPointer] = Stack[-5]
0x19e: Pop(5)
0x19f: Push("1: placing danko to ospina") // @poff=731
0x1a0: @ Trace(Stack[-1])
0x1a1: Pop(1)
0x1a2: Push("k6q01DankoPos") // @poff=523
0x1a3: Push((int) 3)
...
0x1a8: Stack[-2] = "icot_eva_door" // @poff=50
...
0x1ae: Pop(0)
0x1af: Push("k6q01DankoPos") // @poff=523
0x1b0: Push((int) 4)
0x1b1: @ SetVariable(Stack[-2], Stack[-1])
0x1b2: Pop(2)
0x1b3: Push("1: placing danko to eva") // @poff=785
0x1b4: @ Trace(Stack[-1])
0x1b5: Pop(1)
0x1b6: Stack[-1] = 0
0x1b7: Stack[-2] = 0
...
0x1bd: Push("placing danko from ospina to eva") // @poff=833
0x1be: @ Trace(Stack[-1])
0x1bf: Pop(1)
0x1c0: Push( Stack[1 + Tasks[-1].StackPointer] )
0x1c1: IF (Stack[-1] == 0) GOTO 0x1c5; Pop(1)

0x1c2: Push("cleanup") // @poff=148
0x1c3: @ Trigger(Stack[-1]T, Stack[-1])
0x1c4: Pop(1)
0x1c5: PushEmpty()
0x1c6: Call2 0x5
...
0x1c9: Stack[-2] = "icot_eva_door" // @poff=50
0x1ca: Stack[-1] = (bool) 0
0x1cb: Call2 0x251

0x1cc: Pop(2)
0x1cd: Push("k6q01DankoPos") // @poff=523
0x1ce: Push((int) 4)
0x1cf: @ SetVariable(Stack[-2], Stack[-1])
0x1d0: Pop(2)
0x1d1: Return(); Pop(12)

0x1d2: Push("k6q01") // @poff=234
0x1d3: Push((int) -1)
...
0x1e2: Stack[-2] = "icot_eva_door" // @poff=50
...
0x1e8: Push("cleanup") // @poff=148
0x1e9: @ Trigger(Stack[-1]T, Stack[-1])
0x1ea: Pop(1)
0x1eb: Push("k6q01") // @poff=234
0x1ec: @ GetVariable(Stack[-1], Stack[-2])
0x1ed: Pop(1)
0x1ee: PushEmpty(string, bool)
0x1ef: Stack[-2] = "icot_eva@door1" // @poff=96
...
0x20d: Pop(1)
0x20e: @@ GetItemCount(Stack[-4], Stack[-12]); Obj=13 // @poff=899
0x20f: Pop(0)
0x210: Stack[-3] = (int) 0
0x211: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x212: IF (Stack[-1] == 0) GOTO 0x21f; Pop(1)

0x213: @@ GetItem(Stack[-2], Stack[-3], Stack[-12]); Obj=13 // @poff=912
0x214: Pop(0)
0x215: @@ add(Stack[-2]); Obj=5 // @poff=920
0x216: Pop(0)
0x217: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12]); Obj=13 // @poff=924
0x218: Pop(0)
0x219: @@ add(Stack[-1]); Obj=11 // @poff=920
0x21a: Pop(0)
0x21b: Stack[-2] = 0
0x21c: Push((int) 1)
...
0x245: Push("Door ") // @poff=997
0x246: Pop(1); Push(Stack[-1] + Stack[-5]);
0x247: Push(" not found") // @poff=1009
0x248: Pop(2); Push(Stack[-2] + Stack[-1]);
0x249: @ Trace(Stack[-1])
0x24a: Pop(1)
0x24b: GOTO 0x24f

0x24c: Push("locked") // @poff=1031
0x24d: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=1045
0x24e: Pop(1)
0x24f: Return(); Pop(2)
...
0x256: Push("Door ") // @poff=997
0x257: Pop(1); Push(Stack[-1] + Stack[-5]);
0x258: Push(" not found") // @poff=1009
...
0x25f: @@ Close(); Obj=1 // @poff=1057
0x260: Pop(0)
0x261: Push("locked") // @poff=1031
0x262: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=1045
0x263: Pop(1)
0x264: Return(); Pop(2)
...
0x268: Pop(0)
0x269: @@ add(Stack[-4]); Obj=1 // @poff=920
0x26a: Pop(0)
0x26b: @@ add(Stack[-3]); Obj=1 // @poff=920
0x26c: Pop(0)
0x26d: Push((int) 3)
...
0x273: @@ GetItemID(Stack[-3]); Obj=8 // @poff=1063
0x274: Pop(0)
0x275: Push("Category") // @poff=1073
0x276: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x277: Pop(1)
0x278: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=1091
0x279: Pop(0)
0x27a: Pop(0); Push((bool) Stack[-1] == 0)
0x27b: IF (Stack[-1] == 0) GOTO 0x27f; Pop(1)

0x27c: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=1099
0x27d: Pop(0)
0x27e: GOTO 0x284

0x27f: PushEmpty(int, int)
0x280: Stack[-5] = Stack[-2]
0x281: Stack[-9] = Stack[-1]
0x282: Call2 0x266
...
0x29e: @@ size(Stack[-4]); Obj=10 // @poff=1195
0x29f: Pop(0)
0x2a0: Stack[-3] = (int) 0
0x2a1: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x2a2: IF (Stack[-1] == 0) GOTO 0x2b1; Pop(1)

0x2a3: @@ get(Stack[-2], Stack[-3]); Obj=10 // @poff=1200
0x2a4: Pop(0)
0x2a5: @@ get(Stack[-1], Stack[-3]); Obj=9 // @poff=1200
0x2a6: Pop(0)
0x2a7: PushEmpty(object, object, int)
0x2a8: Stack[-14] = Stack[-3]
0x2a9: Stack[-5] = Stack[-2]
