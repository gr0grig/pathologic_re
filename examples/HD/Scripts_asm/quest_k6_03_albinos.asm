...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x592: Push("Can't find lsh animation : ") // @poff=798
...
0x5a1: Push("Can't find lsh animation : ") // @poff=798
...
0x5a7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=543
0x5a8: Pop(0)
...
0x5ea: Push((float)9.999999974752427e-07)
...
0x625: Stack[-8] = Stack[-5]
0x626: Stack[-4] = "reputation" // @poff=854
0x627: Stack[-7] = Stack[-3]
0x628: Stack[-2] = (int) 0
0x629: Stack[-1] = (int) 1
0x62a: Call2 0x44e
...
0x641: Pop(0)
0x642: @@ add(Stack[-3]); Obj=1 // @poff=739
0x643: Pop(0)
0x644: Push((int) 16)
...
0x64b: Pop(0)
0x64c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x659: Stack[-1] = "ui/NPC_Albinos.png" // @poff=876
0x65a: Return(); Pop(0)

0x65b: Stack[-1] = "ui/NPC_Albinos_b.png" // @poff=914
0x65c: Return(); Pop(0)
...
0x667: Stack[-2] = (int) 0
0x668: Push("all") // @poff=138
0x669: PushEmpty(string, int)
0x66a: Stack[-5] = Stack[-1]
0x66b: Call2 0x65f
...
0x67c: Stack[-2] = "quest_k6_03" // @poff=156
0x67d: Stack[-1] = "completed" // @poff=956
0x67e: Call2 0x649
...
0x693: Push("Can't retrieve diary root") // @poff=976
0x694: @ Trace(Stack[-1])
0x695: Pop(1)
...
0x69e: Stack[-1] = Stack[-4]
0x69f: Pop(1)
0x6a0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1028
0x6a1: Pop(0)
0x6a2: Pop(0); Push((bool) Stack[-2] == 0)
0x6a3: IF (Stack[-1] == 0) GOTO 0x6aa; Pop(1)

0x6a4: Push("Can't find diary parent with id: ") // @poff=1033
...
0x6aa: @@ AddChild(Stack[-8]); Obj=2 // @poff=1101
0x6ab: Pop(0)
0x6ac: Push((int) 7)
0x6ad: @ SendWorldWndMessage(Stack[-1])
0x6ae: Pop(1)
0x6af: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1110
0x6b0: Pop(0)
...
0x6d6: Stack[-6] = Stack[-3]
0x6d7: Stack[-2] = (float) 0.05000000074505806
0x6d8: Stack[-1] = (int) 0
0x6d9: Call2 0x464

0x6da: Stack[-4] = Stack[-5]
0x6db: Pop(4)
0x6dc: Push((int) 6)
0x6dd: Push((float)0.05000000074505806)
...
0x6ec: Stack[-7] = Stack[-3]
0x6ed: Stack[-6] = Stack[-2]
...
0x6f4: Stack[-11] = Stack[-5]
0x6f5: Stack[-10] = Stack[-4]
0x6f6: Stack[-9] = Stack[-3]
0x6f7: Stack[-7] = Stack[-2]
...
0x710: Stack[-4] = Stack[-2]
0x711: Stack[-1] = (float) -0.10000000149011612
0x712: Call2 0x60b
