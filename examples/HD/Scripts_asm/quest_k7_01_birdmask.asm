...
Strings:
	...
	A:SetMapParams
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0xe6: Push("all") // @poff=138
0xe7: Push("idle") // @poff=146
...
0xef: Push("all") // @poff=138
0xf0: Push("idle") // @poff=146
...
0x2c7: @ FindActor(Stack[-4]T, Stack[-1])
0x2c8: Pop(1)
...
0x2db: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x366: Pop(0)
0x367: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x368: Pop(0)
...
0x372: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x373: Pop(0)
0x374: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x375: Pop(0)
...
0x3d3: Push("Can't find lsh animation : ") // @poff=206
...
0x3e2: Push("Can't find lsh animation : ") // @poff=206
...
0x3e8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x3e9: Pop(0)
...
0x3fc: Push((float)9.999999974752427e-07)
...
0x40d: Push("Door ") // @poff=262
0x40e: Pop(1); Push(Stack[-1] + Stack[-5]);
0x40f: Push(" not found") // @poff=274
0x410: Pop(2); Push(Stack[-2] + Stack[-1]);
0x411: @ Trace(Stack[-1])
0x412: Pop(1)
0x413: GOTO 0x417

0x414: Push("locked") // @poff=296
0x415: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=310
0x416: Pop(1)
0x417: Return(); Pop(2)
...
0x41b: Pop(0)
0x41c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x43f: Stack[-1] = "ui/NPC_bmask.png" // @poff=322
0x440: Return(); Pop(0)

0x441: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=356
0x442: Return(); Pop(0)
...
0x44d: Stack[-2] = (int) 0
0x44e: Push("all") // @poff=138
0x44f: PushEmpty(string, int)
0x450: Stack[-5] = Stack[-1]
0x451: Call2 0x445
...
0x45b: Stack[-2] = Stack[-5]
0x45c: Return(); Pop(4)

0x45d: PushEmpty()
0x45e: Push("ook7Birdmask1") // @poff=394
0x45f: Push((int) 1)
...
0x465: Stack[-1] = "k7q01CorpseMark" // @poff=422
0x466: Call2 0x403
...
0x46b: Push("k7q01CorpseMark") // @poff=422
0x46c: Push((int) 1)
...
0x471: Stack[-1] = Stack[-2]
0x472: Pop(1)
0x473: Push("k7q01BirdmaskGotoCorpse") // @poff=454
0x474: Push("pt_d7q02_corpse") // @poff=502
0x475: Push((int) 3)
...
0x479: Pop(0)
0x47a: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=534
0x47b: Pop(5)
0x47c: PushEmpty(bool, string, string)
0x47d: Stack[-2] = "quest_k7_01" // @poff=542
0x47e: Stack[-1] = "place_corpse" // @poff=566
0x47f: Call2 0x419
...
0x488: Pop(1)
0x489: Stack[-2] = "pt_d7q02_corpse" // @poff=502
0x48a: Stack[-1] = (int) 2
0x48b: Call2 0x545
...
0x48f: Pop(0)
0x490: @@ ShowMap(Stack[-1]); Obj=2 // @poff=592
0x491: Pop(1)
0x492: Return(); Pop(0)

0x493: PushEmpty()
0x494: Push("ook7Birdmask2") // @poff=600
0x495: Push((int) 1)
...
0x499: PushEmpty()
0x49a: Push("ook7Birdmask3") // @poff=628
0x49b: Push((int) 1)
...
0x4a1: Stack[-2] = "sobor@door1" // @poff=656
...
0x4a8: Stack[-1] = "ook7Birdmask1" // @poff=394
0x4a9: Call2 0x403
...
0x4b4: Stack[-1] = "ook7Birdmask2" // @poff=600
0x4b5: Call2 0x403
...
0x4c0: Stack[-1] = "ook7Birdmask3" // @poff=628
0x4c1: Call2 0x403
...
0x4e9: Push((int) 1)
0x4ea: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=680
0x4eb: Pop(1)
0x4ec: Push("bird_mask") // @poff=693
0x4ed: @ GetInvItemByName(Stack[-10], Stack[-1])
0x4ee: Pop(1)
0x4ef: Push("bird_balahon") // @poff=713
...
0x4f7: Push((int) 1)
0x4f8: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=739
0x4f9: Pop(1)
0x4fa: @@ GetItemID(Stack[-3]); Obj=4 // @poff=747
0x4fb: Pop(0)
0x4fc: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x4fd: IF (Stack[-1] == 0) GOTO 0x505; Pop(1)

0x4fe: Push((int) 1)
0x4ff: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=757
0x500: Pop(1)
0x501: Push(Stack[-2])
...
0x507: Push((int) 1)
0x508: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=757
0x509: Pop(1)
0x50a: Push(Stack[-1])
...
0x536: Pop(0)
0x537: Pop(0); PushNull((bool) Stack[-2] == 0)
0x538: IF (Stack[-1] == 0) GOTO 0x53f; Pop(1)

0x539: Push("Can't find main outdoor scene") // @poff=772
0x53a: @ Trace(Stack[-1])
0x53b: Pop(1)
0x53c: Stack[-1] = 0
0x53d: Stack[-1] = Stack[-5]
0x53e: Return(); Pop(4)

0x53f: @@ GetMap(Stack[-1]); Obj=2 // @poff=832
0x540: Pop(0)
0x541: Stack[-1] = Stack[-5]
0x542: Return(); Pop(4)
...
0x547: Pop(0)
0x548: Pop(0); PushNull((bool) Stack[-2] == 0)
0x549: IF (Stack[-1] == 0) GOTO 0x54e; Pop(1)

0x54a: Push("Can't find main outdoor scene") // @poff=772
0x54b: @ Trace(Stack[-1])
0x54c: Pop(1)
0x54d: Return(); Pop(8)

0x54e: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=839
0x54f: Pop(0)
0x550: Pop(0); Push((bool) Stack[-1] == 0)
0x551: IF (Stack[-1] == 0) GOTO 0x558; Pop(1)

0x552: Push("Warning: outdoor scene locator ") // @poff=850
0x553: Pop(1); Push(Stack[-1] + Stack[-11]);
0x554: Push(" doesnt exist") // @poff=914
0x555: Pop(2); Push(Stack[-2] + Stack[-1]);
0x556: @ Trace(Stack[-1])
0x557: Pop(1)
0x558: @@ GetMap(Stack[-11]); Obj=2 // @poff=832
0x559: Pop(0)
0x55a: Pop(0); PushNull((bool) Stack[-11] == 0)
0x55b: IF (Stack[-1] == 0) GOTO 0x560; Pop(1)

0x55c: Push("Can't find map") // @poff=942
0x55d: @ Trace(Stack[-1])
0x55e: Pop(1)
0x55f: Return(); Pop(8)
...
0x562: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=972
0x563: Pop(2)
0x564: Return(); Pop(8)

0x565: Stack[-2] = 0
0x566: PushEmpty(int, int)
0x567: Push("branch") // @poff=985
