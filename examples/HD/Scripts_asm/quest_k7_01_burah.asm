...
// @pool_raw:
// @pool_encoding:utf8
...
0x39a: Stack[-1] = 0
0x39b: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x39c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x39d: @ RotateAsync(Stack[-2], Stack[-1])
0x39e: Pop(2)
0x39f: Return(); Pop(0)

0x3a0: PushEmpty(object, bool, object, bool)
0x3a1: Push("player") // @poff=226
...
0x47c: Pop(0)
0x47d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=240
0x47e: Pop(0)
...
0x483: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=252
0x484: Pop(0)
0x485: Pop(0); Push(Stack[-1] + Stack[-3]);
0x486: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=264
0x487: Pop(1)
0x488: Return(); Pop(2)
...
0x490: Pop(2)
0x491: Stack[-1] = Stack[-8]
0x492: Return(); Pop(6)

0x493: PushEmpty(cvector, cvector)
0x494: @@ GetPosition(Stack[-1]); Obj=3 // @poff=240
0x495: Pop(0)
0x496: PushEmpty(bool, cvector)
0x497: Stack[-3] = Stack[-1]
0x498: Call2 0x489

0x499: Stack[-2] = Stack[-6]
0x49a: Pop(2)
0x49b: Return(); Pop(2)
...
0x4a2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=240
0x4a3: Pop(0)
0x4a4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=276
0x4a5: Pop(0)
...
0x511: Push("voice_common") // @poff=300
0x512: Push((int) 1)
...
0x519: Push("voice_common") // @poff=300
0x51a: Push((int) 0)
...
0x52c: Push("voice_common") // @poff=300
0x52d: Push((int) 1)
...
0x53a: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=330
0x53b: Pop(1)
...
0x565: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=330
0x566: Pop(1)
...
0x57a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=252
0x57b: Pop(1)
0x57c: PushEmpty(bool, string)
0x57d: Stack[-3] = Stack[-1]
0x57e: Call2 0x5a1

0x57f: Stack[-2] = Stack[-14]
0x580: Pop(2)
0x581: Return(); Pop(10)
...
0x58d: Push("Can't find lsh animation : ") // @poff=346
...
0x59c: Push("Can't find lsh animation : ") // @poff=346
...
0x5c0: Push((float)9.999999974752427e-07)
...
0x5d9: Pop(0)
0x5da: @@ add(Stack[-4]); Obj=1 // @poff=412
0x5db: Pop(0)
0x5dc: @@ add(Stack[-3]); Obj=1 // @poff=412
0x5dd: Pop(0)
0x5de: Push((int) 3)
...
0x5e5: Stack[-7] = Stack[-3]
0x5e6: Stack[-2] = "money" // @poff=416
0x5e7: Stack[-6] = Stack[-1]
0x5e8: Call2 0x482
...
0x5f7: @@ GetItemID(Stack[-3]); Obj=8 // @poff=440
0x5f8: Pop(0)
0x5f9: Push("Category") // @poff=450
0x5fa: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x5fb: Pop(1)
0x5fc: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=468
0x5fd: Pop(0)
0x5fe: Pop(0); Push((bool) Stack[-1] == 0)
0x5ff: IF (Stack[-1] == 0) GOTO 0x603; Pop(1)

0x600: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=476
0x601: Pop(0)
0x602: GOTO 0x608

0x603: PushEmpty(int, int)
0x604: Stack[-5] = Stack[-2]
0x605: Stack[-9] = Stack[-1]
0x606: Call2 0x5d7
...
0x60b: Pop(0)
0x60c: @@ SetItemName(Stack[-4]); Obj=1 // @poff=486
0x60d: Pop(0)
0x60e: PushEmpty(object, object, int)
0x60f: Stack[-8] = Stack[-3]
0x610: Stack[-4] = Stack[-2]
0x611: Stack[-6] = Stack[-1]
0x612: Call2 0x5f6
...
0x618: Pop(0)
0x619: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=498
0x61a: Pop(0)
...
0x61f: Pop(0)
0x620: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x63f: Stack[-2] = (int) 0
0x640: Push("all") // @poff=138
0x641: PushEmpty(string, int)
0x642: Stack[-5] = Stack[-1]
0x643: Call2 0x637
...
0x654: Pop(1)
0x655: Stack[-2] = "pt_map_burah_home" // @poff=506
0x656: Stack[-1] = (int) 2
0x657: Call2 0x797
...
0x65b: Pop(0)
0x65c: @@ ShowMap(Stack[-1]); Obj=2 // @poff=542
0x65d: Pop(1)
0x65e: Return(); Pop(0)

0x65f: PushEmpty(object, object)
0x660: PushEmpty(int, string)
0x661: Stack[-1] = "k7q01CorpseMark" // @poff=550
0x662: Call2 0x5c7
...
0x667: Push("k7q01CorpseMark") // @poff=550
0x668: Push((int) 1)
...
0x66d: Stack[-1] = Stack[-2]
0x66e: Pop(1)
0x66f: Push("k7q01BirdmaskGotoCorpse") // @poff=582
0x670: Push("pt_d7q02_corpse") // @poff=630
0x671: Push((int) 3)
...
0x675: Pop(0)
0x676: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=662
0x677: Pop(5)
0x678: PushEmpty(bool, string, string)
0x679: Stack[-2] = "quest_k7_01" // @poff=670
0x67a: Stack[-1] = "place_corpse" // @poff=694
0x67b: Call2 0x61d
...
0x67f: PushEmpty()
0x680: Push("ook7Burah1") // @poff=720
0x681: Push((int) 1)
...
0x68c: Pop(0)
0x68d: Push("bird_balahon") // @poff=754
0x68e: Push((int) 1)
0x68f: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=780
0x690: Pop(2)
0x691: Return(); Pop(2)
...
0x695: Stack[-1] = Stack[-2]
0x696: Pop(1)
0x697: Push("k7q03BurahGotoFather") // @poff=797
0x698: Push("pt_map_burah_home") // @poff=506
0x699: Push((int) 0)
...
0x69d: Pop(0)
0x69e: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=662
0x69f: Pop(5)
0x6a0: PushEmpty()
0x6a1: Call2 0x736
...
0x6a7: Stack[-1] = "quest_k7_03" // @poff=839
0x6a8: Call2 0x5cc

0x6a9: Pop(2)
0x6aa: PushEmpty(bool, string, string)
0x6ab: Stack[-2] = "quest_k7_03" // @poff=839
0x6ac: Stack[-1] = "place_family" // @poff=863
0x6ad: Call2 0x61d
...
0x6b0: Stack[-1] = 0
0x6b1: PushEmpty()
0x6b2: Push("ook7Burah2") // @poff=889
0x6b3: Push((int) 1)
...
0x6b7: PushEmpty()
0x6b8: Push("tvirin 5 is given") // @poff=911
0x6b9: @ Trace(Stack[-1])
0x6ba: Pop(1)
0x6bb: PushEmpty(object, string, int)
0x6bc: Stack[-5] = Stack[-3]
0x6bd: Stack[-2] = "tvirin" // @poff=947
0x6be: Stack[-1] = (int) 5
0x6bf: Call2 0x609
...
0x6c7: Stack[-2] = "quest_k7_03" // @poff=839
0x6c8: Stack[-1] = "completed" // @poff=961
0x6c9: Call2 0x61d
...
0x6cc: PushEmpty()
0x6cd: Push("money2000 is given") // @poff=981
0x6ce: @ Trace(Stack[-1])
0x6cf: Pop(1)
...
0x6d6: PushEmpty()
0x6d7: Push("playsound") // @poff=1019
0x6d8: Push("givemoney") // @poff=1039
0x6d9: @ TriggerWorld(Stack[-2], Stack[-1])
0x6da: Pop(2)
0x6db: Return(); Pop(0)

0x6dc: PushEmpty()
0x6dd: Push("playsound") // @poff=1019
0x6de: Push("giveitem") // @poff=1059
...
0x6e5: Stack[-1] = "bird_balahon" // @poff=754
0x6e6: Call2 0x616
...
0x6fb: Stack[-1] = "ook7Burah1" // @poff=720
0x6fc: Call2 0x5c7
...
0x713: Stack[-1] = "ook7Burah2" // @poff=889
0x714: Call2 0x5c7
...
0x762: Push("Can't retrieve diary root") // @poff=1089
0x763: @ Trace(Stack[-1])
0x764: Pop(1)
...
0x76e: Pop(1)
0x76f: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1141
0x770: Pop(0)
0x771: Pop(0); Push((bool) Stack[-2] == 0)
0x772: IF (Stack[-1] == 0) GOTO 0x779; Pop(1)

0x773: Push("Can't find diary parent with id: ") // @poff=1146
...
0x779: @@ AddChild(Stack[-8]); Obj=2 // @poff=1214
0x77a: Pop(0)
0x77b: Push((int) 7)
0x77c: @ SendWorldWndMessage(Stack[-1])
0x77d: Pop(1)
0x77e: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1223
0x77f: Pop(0)
...
0x788: Pop(0)
0x789: Pop(0); PushNull((bool) Stack[-2] == 0)
0x78a: IF (Stack[-1] == 0) GOTO 0x791; Pop(1)

0x78b: Push("Can't find main outdoor scene") // @poff=1235
0x78c: @ Trace(Stack[-1])
0x78d: Pop(1)
0x78e: Stack[-1] = 0
...
0x791: @@ GetMap(Stack[-1]); Obj=2 // @poff=1295
0x792: Pop(0)
...
0x799: Pop(0)
0x79a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x79b: IF (Stack[-1] == 0) GOTO 0x7a0; Pop(1)

0x79c: Push("Can't find main outdoor scene") // @poff=1235
0x79d: @ Trace(Stack[-1])
0x79e: Pop(1)
0x79f: Return(); Pop(8)

0x7a0: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1302
0x7a1: Pop(0)
0x7a2: Pop(0); Push((bool) Stack[-1] == 0)
0x7a3: IF (Stack[-1] == 0) GOTO 0x7aa; Pop(1)

0x7a4: Push("Warning: outdoor scene locator ") // @poff=1313
0x7a5: Pop(1); Push(Stack[-1] + Stack[-11]);
0x7a6: Push(" doesnt exist") // @poff=1377
0x7a7: Pop(2); Push(Stack[-2] + Stack[-1]);
0x7a8: @ Trace(Stack[-1])
0x7a9: Pop(1)
0x7aa: @@ GetMap(Stack[-11]); Obj=2 // @poff=1295
0x7ab: Pop(0)
0x7ac: Pop(0); PushNull((bool) Stack[-11] == 0)
0x7ad: IF (Stack[-1] == 0) GOTO 0x7b2; Pop(1)

0x7ae: Push("Can't find map") // @poff=1405
0x7af: @ Trace(Stack[-1])
0x7b0: Pop(1)
0x7b1: Return(); Pop(8)
...
0x7b4: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1435
0x7b5: Pop(2)
0x7b6: Return(); Pop(8)

0x7b7: Stack[-2] = 0
0x7b8: PushEmpty(int, int)
0x7b9: Push("branch") // @poff=1448
...
0x7cd: Stack[-1] = "ui/NPC_Burah.png" // @poff=1462
0x7ce: Return(); Pop(0)

0x7cf: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=1496
0x7d0: Return(); Pop(0)
