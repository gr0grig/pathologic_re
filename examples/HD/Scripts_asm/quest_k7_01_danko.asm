...
// @pool_raw:
// @pool_encoding:utf8
...
0xdd: Push("all") // @poff=138
0xde: Push("idle") // @poff=146
...
0x1fb: Stack[-1] = "Untrust" // @poff=156
0x1fc: Call2 0xe3
...
0x224: Stack[-1] = "Untrust" // @poff=156
0x225: Call2 0xe3
...
0x288: Stack[-1] = "Untrust" // @poff=156
0x289: Call2 0xe3
...
0x29f: Stack[-1] = "Untrust" // @poff=156
0x2a0: Call2 0xe3
...
0x2e5: Stack[-1] = "Untrust" // @poff=156
0x2e6: Call2 0xe3
...
0x2f7: Stack[-1] = "Untrust" // @poff=156
0x2f8: Call2 0xe3

0x2f9: Pop(1)
0x2fa: Push((int) 526353)
0x2fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x2fc: Pop(1)
0x2fd: @@@ ClearReplies(); Obj=0 // @poff=116
0x2fe: Pop(0)
...
0x30e: Stack[-1] = "Untrust" // @poff=156
0x30f: Call2 0xe3
...
0x325: Stack[-1] = "Neutral" // @poff=89
0x326: Call2 0xe3

0x327: Pop(1)
0x328: Push((int) 528649)
0x329: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x32a: Pop(1)
0x32b: @@@ ClearReplies(); Obj=0 // @poff=116
0x32c: Pop(0)
...
0x3a4: Stack[-1] = 0
0x3a5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3a6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x3a7: @ RotateAsync(Stack[-2], Stack[-1])
0x3a8: Pop(2)
0x3a9: Return(); Pop(0)

0x3aa: PushEmpty(object, bool, object, bool)
0x3ab: Push("player") // @poff=244
...
0x486: Pop(0)
0x487: @@ GetPosition(Stack[-2]); Obj=7 // @poff=258
0x488: Pop(0)
...
0x48d: Push("HasProperty") // @poff=270
0x48e: Push((int) 2)
...
0x494: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=294
0x495: Pop(0)
...
0x4a2: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=306
0x4a3: Pop(0)
...
0x4a9: Pop(3)
0x4aa: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=318
0x4ab: Pop(1)
0x4ac: Stack[-8] = (bool) 1
0x4ad: Return(); Pop(2)

0x4ae: PushEmpty(int, int)
0x4af: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=306
0x4b0: Pop(0)
0x4b1: Pop(0); Push(Stack[-1] + Stack[-3]);
0x4b2: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=318
0x4b3: Pop(1)
0x4b4: Return(); Pop(2)
...
0x4bc: Pop(2)
0x4bd: Stack[-1] = Stack[-8]
0x4be: Return(); Pop(6)

0x4bf: PushEmpty(cvector, cvector)
0x4c0: @@ GetPosition(Stack[-1]); Obj=3 // @poff=258
0x4c1: Pop(0)
0x4c2: PushEmpty(bool, cvector)
0x4c3: Stack[-3] = Stack[-1]
0x4c4: Call2 0x4b5

0x4c5: Stack[-2] = Stack[-6]
0x4c6: Pop(2)
0x4c7: Return(); Pop(2)
...
0x4ce: @@ GetPosition(Stack[-8]); Obj=20 // @poff=258
0x4cf: Pop(0)
0x4d0: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=330
0x4d1: Pop(0)
...
0x53d: Push("voice_common") // @poff=354
0x53e: Push((int) 1)
...
0x545: Push("voice_common") // @poff=354
0x546: Push((int) 0)
...
0x558: Push("voice_common") // @poff=354
0x559: Push((int) 1)
...
0x566: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=294
0x567: Pop(1)
...
0x591: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=294
0x592: Pop(1)
...
0x5a6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=306
0x5a7: Pop(1)
...
0x5b9: Push("Can't find lsh animation : ") // @poff=388
...
0x5c8: Push("Can't find lsh animation : ") // @poff=388
...
0x5ec: Push((float)9.999999974752427e-07)
...
0x610: Pop(0)
0x611: @@ add(Stack[-4]); Obj=1 // @poff=454
0x612: Pop(0)
0x613: @@ add(Stack[-3]); Obj=1 // @poff=454
0x614: Pop(0)
0x615: Push((int) 3)
...
0x61d: Stack[-2] = "money" // @poff=458
0x61e: Stack[-6] = Stack[-1]
0x61f: Call2 0x4ae
...
0x624: Push("Money") // @poff=470
0x625: @ GetInvItemByName(Stack[-2], Stack[-1])
0x626: Pop(1)
0x627: PushEmpty(int, int)
0x628: Stack[-3] = Stack[-2]
0x629: Stack[-5] = Stack[-1]
0x62a: Call2 0x60e
...
0x62e: @@ GetItemID(Stack[-3]); Obj=8 // @poff=482
0x62f: Pop(0)
0x630: Push("Category") // @poff=492
0x631: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x632: Pop(1)
0x633: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=510
0x634: Pop(0)
0x635: Pop(0); Push((bool) Stack[-1] == 0)
0x636: IF (Stack[-1] == 0) GOTO 0x63a; Pop(1)

0x637: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=518
0x638: Pop(0)
0x639: GOTO 0x63f

0x63a: PushEmpty(int, int)
0x63b: Stack[-5] = Stack[-2]
0x63c: Stack[-9] = Stack[-1]
0x63d: Call2 0x60e
...
0x642: Pop(0)
0x643: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=528
0x644: Pop(0)
0x645: Stack[-1] = Stack[-7]
0x646: Return(); Pop(4)
...
0x661: Stack[-8] = Stack[-5]
0x662: Stack[-4] = "reputation" // @poff=536
0x663: Stack[-7] = Stack[-3]
0x664: Stack[-2] = (int) 0
0x665: Stack[-1] = (int) 1
0x666: Call2 0x498
...
0x66c: Pop(0)
0x66d: @@ add(Stack[-3]); Obj=1 // @poff=454
0x66e: Pop(0)
0x66f: Push((int) 16)
...
0x676: Pop(0)
0x677: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x6a4: Stack[-2] = Stack[-5]
0x6a5: Return(); Pop(4)

0x6a6: PushEmpty()
0x6a7: PushEmpty(bool, object, float)
0x6a8: Stack[-5] = Stack[-2]
0x6a9: Stack[-1] = (float) 0.05000000074505806
0x6aa: Call2 0x647
...
0x6af: Stack[-1] = "k7q01CorpseMark" // @poff=558
0x6b0: Call2 0x5fe
...
0x6b5: Push("k7q01CorpseMark") // @poff=558
0x6b6: Push((int) 1)
...
0x6bb: Stack[-1] = Stack[-2]
0x6bc: Pop(1)
0x6bd: Push("k7q01BirdmaskGotoCorpse") // @poff=590
0x6be: Push("pt_d7q02_corpse") // @poff=638
0x6bf: Push((int) 3)
...
0x6c3: Pop(0)
0x6c4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=670
0x6c5: Pop(5)
0x6c6: PushEmpty(bool, string, string)
0x6c7: Stack[-2] = "quest_k7_01" // @poff=678
0x6c8: Stack[-1] = "place_corpse" // @poff=702
0x6c9: Call2 0x674
...
0x6cd: PushEmpty()
0x6ce: Push("ook7DankoTheater1") // @poff=728
0x6cf: Push((int) 1)
...
0x6da: Pop(0)
0x6db: Push("bird_mask") // @poff=776
0x6dc: Push((int) 1)
0x6dd: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=796
0x6de: Pop(2)
0x6df: Return(); Pop(2)

0x6e0: PushEmpty()
0x6e1: Push("ook7DankoTheater2") // @poff=813
0x6e2: Push((int) 1)
...
0x6ea: Pop(1)
0x6eb: Push("k7q02DankoGotoGatherer") // @poff=849
0x6ec: Push("pt_gatherer3") // @poff=895
0x6ed: Push((int) 0)
...
0x6f1: Pop(0)
0x6f2: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=670
0x6f3: Pop(5)
0x6f4: PushEmpty()
0x6f5: Call2 0x799
...
0x6fb: Stack[-1] = "quest_k7_02" // @poff=921
0x6fc: Call2 0x603
...
0x705: Stack[-2] = "quest_k7_02" // @poff=921
0x706: Stack[-1] = "completed" // @poff=945
0x707: Call2 0x674
...
0x70f: Pop(1)
0x710: Stack[-2] = "pt_gatherer3" // @poff=895
0x711: Stack[-1] = (int) 2
0x712: Call2 0x7fa
...
0x716: Pop(0)
0x717: @@ ShowMap(Stack[-1]); Obj=2 // @poff=965
0x718: Pop(1)
0x719: Return(); Pop(0)

0x71a: PushEmpty()
0x71b: Push("playsound") // @poff=973
0x71c: Push("givemoney") // @poff=993
0x71d: @ TriggerWorld(Stack[-2], Stack[-1])
0x71e: Pop(2)
0x71f: Return(); Pop(0)

0x720: PushEmpty()
0x721: Push("playsound") // @poff=973
0x722: Push("giveitem") // @poff=1013
0x723: @ TriggerWorld(Stack[-2], Stack[-1])
0x724: Pop(2)
0x725: Return(); Pop(0)

0x726: PushEmpty()
0x727: Push("money 5000 is given") // @poff=1031
0x728: @ Trace(Stack[-1])
0x729: Pop(1)
0x72a: PushEmpty(object, int)
0x72b: Stack[-4] = Stack[-2]
...
0x731: Push("Samopal is given") // @poff=1071
0x732: @ Trace(Stack[-1])
0x733: Pop(1)
0x734: @ CreateInvItem(Stack[-1])
0x735: Pop(0)
0x736: Push("Samopal") // @poff=1105
0x737: @@ SetItemName(Stack[-1]); Obj=2 // @poff=1121
0x738: Pop(1)
0x739: Push("durability") // @poff=1133
0x73a: Push((int) 30)
0x73b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=318
0x73c: Pop(2)
0x73d: PushEmpty(object, object, int)
0x73e: Stack[-7] = Stack[-3]
0x73f: Stack[-4] = Stack[-2]
0x740: Stack[-1] = (int) 1
0x741: Call2 0x62d
...
0x753: Stack[-4] = Stack[-2]
0x754: Stack[-1] = "bird_mask" // @poff=776
0x755: Call2 0x640
...
0x75e: Stack[-1] = "ook7DankoTheater1" // @poff=728
0x75f: Call2 0x5fe
...
0x76a: Stack[-1] = "ook7DankoTheater2" // @poff=813
0x76b: Call2 0x5fe
...
0x7c5: Push("Can't retrieve diary root") // @poff=1167
0x7c6: @ Trace(Stack[-1])
0x7c7: Pop(1)
...
0x7d0: Stack[-1] = Stack[-4]
0x7d1: Pop(1)
0x7d2: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1219
0x7d3: Pop(0)
0x7d4: Pop(0); Push((bool) Stack[-2] == 0)
0x7d5: IF (Stack[-1] == 0) GOTO 0x7dc; Pop(1)

0x7d6: Push("Can't find diary parent with id: ") // @poff=1224
...
0x7dc: @@ AddChild(Stack[-8]); Obj=2 // @poff=1292
0x7dd: Pop(0)
0x7de: Push((int) 7)
0x7df: @ SendWorldWndMessage(Stack[-1])
0x7e0: Pop(1)
0x7e1: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1301
0x7e2: Pop(0)
...
0x7eb: Pop(0)
0x7ec: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7ed: IF (Stack[-1] == 0) GOTO 0x7f4; Pop(1)

0x7ee: Push("Can't find main outdoor scene") // @poff=1313
0x7ef: @ Trace(Stack[-1])
0x7f0: Pop(1)
0x7f1: Stack[-1] = 0
...
0x7f4: @@ GetMap(Stack[-1]); Obj=2 // @poff=1373
0x7f5: Pop(0)
...
0x7fc: Pop(0)
0x7fd: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7fe: IF (Stack[-1] == 0) GOTO 0x803; Pop(1)

0x7ff: Push("Can't find main outdoor scene") // @poff=1313
0x800: @ Trace(Stack[-1])
0x801: Pop(1)
0x802: Return(); Pop(8)

0x803: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1380
0x804: Pop(0)
0x805: Pop(0); Push((bool) Stack[-1] == 0)
0x806: IF (Stack[-1] == 0) GOTO 0x80d; Pop(1)

0x807: Push("Warning: outdoor scene locator ") // @poff=1391
0x808: Pop(1); Push(Stack[-1] + Stack[-11]);
0x809: Push(" doesnt exist") // @poff=1455
0x80a: Pop(2); Push(Stack[-2] + Stack[-1]);
0x80b: @ Trace(Stack[-1])
0x80c: Pop(1)
0x80d: @@ GetMap(Stack[-11]); Obj=2 // @poff=1373
0x80e: Pop(0)
0x80f: Pop(0); PushNull((bool) Stack[-11] == 0)
0x810: IF (Stack[-1] == 0) GOTO 0x815; Pop(1)

0x811: Push("Can't find map") // @poff=1483
0x812: @ Trace(Stack[-1])
0x813: Pop(1)
0x814: Return(); Pop(8)
...
0x817: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1513
0x818: Pop(2)
0x819: Return(); Pop(8)

0x81a: Stack[-2] = 0
0x81b: PushEmpty(int, int)
0x81c: Push("branch") // @poff=1526
...
0x830: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=1540
0x831: Return(); Pop(0)

0x832: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=1580
0x833: Return(); Pop(0)
