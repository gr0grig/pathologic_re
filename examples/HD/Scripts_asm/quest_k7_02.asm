...
// @pool_raw:
...
0x6c: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=177
0x6d: Pop(0)
0x6e: Pop(0); Push((bool) Stack[-4] == 0)
0x6f: IF (Stack[-1] == 0) GOTO 0x78; Pop(1)

0x70: Push("Locator ") // @poff=188
0x71: Pop(1); Push(Stack[-1] + Stack[-12]);
0x72: Push(" doesn't exist") // @poff=206
...
0x78: @@ AddStationaryActor(Stack[-1], Stack[-3], Stack[-2], Stack[-10], Stack[-9]); Obj=12 // @poff=236
0x79: Pop(0)
0x7a: Stack[-1] = Stack[-13]
0x7b: Return(); Pop(8)
