...
Strings:
	...
	A:GetCategory
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x146: Push("player") // @poff=156
0x147: @ FindActor(Stack[-4]T, Stack[-1])
0x148: Pop(1)
...
0x15b: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x1e6: Pop(0)
0x1e7: @@ GetPosition(Stack[-2]); Obj=7 // @poff=180
0x1e8: Pop(0)
...
0x1f2: @@ GetPosition(Stack[-8]); Obj=20 // @poff=180
0x1f3: Pop(0)
0x1f4: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=192
0x1f5: Pop(0)
...
0x253: Push("Can't find lsh animation : ") // @poff=206
...
0x262: Push("Can't find lsh animation : ") // @poff=206
...
0x268: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=192
0x269: Pop(0)
...
0x27c: Push((float)9.999999974752427e-07)
...
0x285: Pop(0)
0x286: Stack[-1] = Stack[-4]
0x287: Return(); Pop(2)

0x288: PushEmpty(object, object)
0x289: @ CreateIntVector(Stack[-1])
0x28a: Pop(0)
0x28b: @@ add(Stack[-4]); Obj=1 // @poff=262
0x28c: Pop(0)
0x28d: @@ add(Stack[-3]); Obj=1 // @poff=262
0x28e: Pop(0)
0x28f: Push((int) 3)
...
0x295: @@ GetItemID(Stack[-3]); Obj=8 // @poff=266
0x296: Pop(0)
0x297: Push("Category") // @poff=276
0x298: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x299: Pop(1)
0x29a: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=294
0x29b: Pop(0)
0x29c: Pop(0); Push((bool) Stack[-1] == 0)
0x29d: IF (Stack[-1] == 0) GOTO 0x2a1; Pop(1)

0x29e: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=302
0x29f: Pop(0)
0x2a0: GOTO 0x2a6

0x2a1: PushEmpty(int, int)
0x2a2: Stack[-5] = Stack[-2]
0x2a3: Stack[-9] = Stack[-1]
0x2a4: Call2 0x288
...
0x2a9: Pop(0)
0x2aa: @@ SetItemName(Stack[-4]); Obj=1 // @poff=312
0x2ab: Pop(0)
0x2ac: PushEmpty(object, object, int)
0x2ad: Stack[-8] = Stack[-3]
...
0x2b6: Pop(0)
0x2b7: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=324
0x2b8: Pop(0)
...
0x2bf: Stack[-1] = "ui/NPC_Morlok.png" // @poff=332
0x2c0: Return(); Pop(0)

0x2c1: Stack[-1] = "ui/NPC_Morlok_b.png" // @poff=368
0x2c2: Return(); Pop(0)
...
0x2db: Stack[-2] = Stack[-5]
0x2dc: Return(); Pop(4)

0x2dd: PushEmpty()
0x2de: Push("k7q02") // @poff=408
0x2df: Push((int) 2)
...
0x2e6: PushEmpty()
0x2e7: Push("white plet 10 is given") // @poff=420
0x2e8: @ Trace(Stack[-1])
0x2e9: Pop(1)
0x2ea: PushEmpty(object, string, int)
0x2eb: Stack[-5] = Stack[-3]
0x2ec: Stack[-2] = "grass_white_plet" // @poff=466
...
0x2f1: PushEmpty()
0x2f2: Push("playsound") // @poff=500
0x2f3: Push("giveitem") // @poff=520
0x2f4: @ TriggerWorld(Stack[-2], Stack[-1])
0x2f5: Pop(2)
0x2f6: Return(); Pop(0)

0x2f7: PushEmpty(int, int)
0x2f8: Push("Samopal") // @poff=538
0x2f9: Push((int) 1)
0x2fa: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=554
0x2fb: Pop(2)
0x2fc: Return(); Pop(2)

0x2fd: PushEmpty()
0x2fe: PushEmpty(int, string)
0x2ff: Stack[-1] = "k7q02" // @poff=408
0x300: Call2 0x283
...
0x30c: Stack[-1] = "Samopal" // @poff=538
0x30d: Call2 0x2b4
...
0x326: Push("Can't retrieve diary root") // @poff=571
0x327: @ Trace(Stack[-1])
0x328: Pop(1)
...
0x332: Pop(1)
0x333: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=623
0x334: Pop(0)
0x335: Pop(0); Push((bool) Stack[-2] == 0)
0x336: IF (Stack[-1] == 0) GOTO 0x33d; Pop(1)

0x337: Push("Can't find diary parent with id: ") // @poff=628
...
0x33d: @@ AddChild(Stack[-8]); Obj=2 // @poff=696
0x33e: Pop(0)
0x33f: Push((int) 7)
0x340: @ SendWorldWndMessage(Stack[-1])
0x341: Pop(1)
0x342: @@ GetCategory(Stack[-1]); Obj=8 // @poff=705
0x343: Pop(0)
