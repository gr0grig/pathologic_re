...
Strings:
	...
	W:burah_home
	W:noburah
// @pool_raw:
...
0x7: Stack[-2] = "boiny@door1" // @poff=0
0x8: Stack[-1] = (bool) 1
0x9: Call2 0x5f
...
0x4a: Stack[-2] = "boiny@door1" // @poff=0
0x4b: Stack[-1] = (bool) 1
0x4c: Call2 0x5f
...
0x64: Push("Door ") // @poff=108
0x65: Pop(1); Push(Stack[-1] + Stack[-5]);
0x66: Push(" not found") // @poff=120
0x67: Pop(2); Push(Stack[-2] + Stack[-1]);
0x68: @ Trace(Stack[-1])
0x69: Pop(1)
0x6a: GOTO 0x6e

0x6b: Push("locked") // @poff=142
0x6c: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=156
0x6d: Pop(1)
0x6e: Return(); Pop(2)
...
0x72: Pop(0)
0x73: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x7d: Stack[-2] = "klara2_npc_positioner" // @poff=168
0x7e: Stack[-1] = "init" // @poff=212
0x7f: Call2 0x70
...
0x83: Push("burah_home") // @poff=222
0x84: @ GetSceneByName(Stack[-2], Stack[-1])
0x85: Pop(1)
0x86: Push("noburah") // @poff=244
...
0x8c: Push("burah_home") // @poff=222
0x8d: @ GetSceneByName(Stack[-2], Stack[-1])
0x8e: Pop(1)
0x8f: Push("burah") // @poff=248
