...
// @pool_raw:
// @pool_encoding:utf8
...
0x147: Stack[-1] = "Agression" // @poff=168
0x148: Call2 0x99
...
0x182: Stack[-1] = "Doubt" // @poff=202
0x183: Call2 0x99

0x184: Pop(1)
0x185: Push((int) 528823)
0x186: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=105
0x187: Pop(1)
0x188: @@@ ClearReplies(); Obj=0 // @poff=116
0x189: Pop(0)
...
0x201: Stack[-3] = Stack[-1]
0x202: Call2 0x2f8

0x203: Stack[-2] = Stack[-5]
0x204: Pop(2)
0x205: Return(); Pop(2)

0x206: Stack[-1] = 0
0x207: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x208: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x209: @ RotateAsync(Stack[-2], Stack[-1])
0x20a: Pop(2)
0x20b: Return(); Pop(0)

0x20c: PushEmpty(object, bool, object, bool)
0x20d: Push("player") // @poff=246
...
0x2e8: Pop(0)
0x2e9: @@ GetPosition(Stack[-2]); Obj=7 // @poff=260
0x2ea: Pop(0)
...
0x2f5: Pop(2)
0x2f6: Stack[-1] = Stack[-8]
0x2f7: Return(); Pop(6)

0x2f8: PushEmpty(cvector, cvector)
0x2f9: @@ GetPosition(Stack[-1]); Obj=3 // @poff=260
0x2fa: Pop(0)
0x2fb: PushEmpty(bool, cvector)
0x2fc: Stack[-3] = Stack[-1]
0x2fd: Call2 0x2ee

0x2fe: Stack[-2] = Stack[-6]
0x2ff: Pop(2)
0x300: Return(); Pop(2)
...
0x307: @@ GetPosition(Stack[-8]); Obj=20 // @poff=260
0x308: Pop(0)
0x309: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=272
0x30a: Pop(0)
...
0x376: Push("voice_common") // @poff=296
0x377: Push((int) 1)
...
0x37e: Push("voice_common") // @poff=296
0x37f: Push((int) 0)
...
0x39f: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3a0: Pop(1)
...
0x3ca: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=326
0x3cb: Pop(1)
...
0x3df: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=338
0x3e0: Pop(1)
0x3e1: PushEmpty(bool, string)
0x3e2: Stack[-3] = Stack[-1]
0x3e3: Call2 0x406

0x3e4: Stack[-2] = Stack[-14]
0x3e5: Pop(2)
0x3e6: Return(); Pop(10)
...
0x3f2: Push("Can't find lsh animation : ") // @poff=354
...
0x425: Push((float)9.999999974752427e-07)
...
0x450: Stack[-2] = Stack[-5]
0x451: Return(); Pop(4)

0x452: PushEmpty()
0x453: Push("ook9BurahTermitnik2_1") // @poff=410
0x454: Push((int) 1)
...
0x458: PushEmpty()
0x459: Push("k9q01BurahTalk") // @poff=454
0x45a: Push((int) 1)
...
0x462: Stack[-1] = "k9q01BurahTalk" // @poff=454
0x463: Call2 0x42c
...
0x469: Stack[-1] = "k9q01DankoTalk" // @poff=484
0x46a: Call2 0x42c
...
0x487: Stack[-1] = "ook9BurahTermitnik2_1" // @poff=410
0x488: Call2 0x42c
...
0x4a3: Push("Can't retrieve diary root") // @poff=526
0x4a4: @ Trace(Stack[-1])
0x4a5: Pop(1)
...
0x4af: Pop(1)
0x4b0: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=578
0x4b1: Pop(0)
0x4b2: Pop(0); Push((bool) Stack[-2] == 0)
0x4b3: IF (Stack[-1] == 0) GOTO 0x4ba; Pop(1)

0x4b4: Push("Can't find diary parent with id: ") // @poff=583
...
0x4ba: @@ AddChild(Stack[-8]); Obj=2 // @poff=651
0x4bb: Pop(0)
0x4bc: Push((int) 7)
0x4bd: @ SendWorldWndMessage(Stack[-1])
0x4be: Pop(1)
0x4bf: @@ GetCategory(Stack[-1]); Obj=8 // @poff=660
0x4c0: Pop(0)
...
0x4dc: Stack[-1] = "ui/NPC_Burah.png" // @poff=686
0x4dd: Return(); Pop(0)

0x4de: Stack[-1] = "ui/NPC_Burah_b.png" // @poff=720
0x4df: Return(); Pop(0)
