...
// @pool_raw:
// @pool_encoding:utf8
...
0x111: Stack[-1] = "Untrust" // @poff=156
0x112: Call2 0x9e
...
0x128: Stack[-1] = "Untrust" // @poff=156
0x129: Call2 0x9e
...
0x13f: Stack[-1] = "Untrust" // @poff=156
0x140: Call2 0x9e
...
0x151: Stack[-1] = "Untrust" // @poff=156
0x152: Call2 0x9e
...
0x1bb: Stack[-2] = Stack[-5]
0x1bc: Pop(2)
0x1bd: Return(); Pop(2)

0x1be: Stack[-1] = 0
0x1bf: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1c0: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
0x1c1: @ RotateAsync(Stack[-2], Stack[-1])
0x1c2: Pop(2)
0x1c3: Return(); Pop(0)

0x1c4: PushEmpty(object, bool, object, bool)
0x1c5: Push("player") // @poff=204
...
0x2a0: Pop(0)
0x2a1: @@ GetPosition(Stack[-2]); Obj=7 // @poff=218
0x2a2: Pop(0)
...
0x2ad: Pop(2)
0x2ae: Stack[-1] = Stack[-8]
0x2af: Return(); Pop(6)

0x2b0: PushEmpty(cvector, cvector)
0x2b1: @@ GetPosition(Stack[-1]); Obj=3 // @poff=218
0x2b2: Pop(0)
...
0x2bf: @@ GetPosition(Stack[-8]); Obj=20 // @poff=218
0x2c0: Pop(0)
0x2c1: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=230
0x2c2: Pop(0)
...
0x2e8: Pop(0)
0x2e9: Push((bool) 1)
0x2ea: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x2eb: Pop(1)
...
0x304: Push((bool) 1)
0x305: @ CameraSwitchToNormal(Stack[-1])
0x306: Pop(1)
...
0x30c: Push("head") // @poff=244
0x30d: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x30e: Pop(1)
0x30f: Push(Stack[-1])
0x310: IF (Stack[-1] == 0) GOTO 0x314; Pop(1)

0x311: Push("head") // @poff=244
0x312: @ UnlookAsync(Stack[-1])
0x313: Pop(1)
0x314: Return(); Pop(2)

0x315: PushEmpty(int, int, int, int)
0x316: Push("voice_common") // @poff=254
0x317: @ GetVariable(Stack[-1], Stack[-3])
0x318: Pop(1)
0x319: Push(Stack[-2])
0x31a: IF (Stack[-1] == 0) GOTO 0x33b; Pop(1)
...
0x320: IF (Stack[-1] == 0) GOTO 0x329; Pop(1)
...
0x327: Stack[-6] = (bool) 0
0x328: Return(); Pop(4)

0x329: Push((int) 2)
0x32a: @ irand(Stack[-2], Stack[-1])
0x32b: Pop(1)
0x32c: Push(Stack[-1])
0x32d: IF (Stack[-1] == 0) GOTO 0x336; Pop(1)

0x32e: Push("voice_common") // @poff=254
0x32f: Push((int) 1)
0x330: Pop(1); Push(Stack[-4] + Stack[-1]);
0x331: Push((int) 3)
...
0x336: Push("voice_common") // @poff=254
0x337: Push((int) 0)
...
0x347: Stack[-6] = (bool) 0
0x348: Return(); Pop(4)

0x349: Push("voice_common") // @poff=254
0x34a: Push((int) 1)
...
0x350: Stack[-5] = "c" // @poff=280
0x351: Stack[-4] = (int) 0
0x352: Push((int) 1)
0x353: IF (Stack[-1] == 0) GOTO 0x35f; Pop(1)

0x354: Push((int) 1)
0x355: Pop(1); Push(Stack[-5] + Stack[-1]);
0x356: Pop(1); Push(Stack[-6] + Stack[-1]);
0x357: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x358: Pop(1)
...
0x35c: Push((int) 1)
0x35d: Stack[-5] = Stack[-5] + Stack[-1]; Pop(1);
0x35e: GOTO 0x352

0x35f: Pop(0); Push((bool) Stack[-4] == 0)
0x360: IF (Stack[-1] == 0) GOTO 0x363; Pop(1)

0x361: Stack[-12] = (bool) 0
0x362: Return(); Pop(10)
...
0x367: @ irand(Stack[-2], Stack[-4])
0x368: Pop(0)
0x369: Push((int) 1)
0x36a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x36b: Pop(1); Push(Stack[-6] + Stack[-1]);
0x36c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=296
0x36d: Pop(1)
0x36e: PushEmpty(bool, string)
0x36f: Stack[-3] = Stack[-1]
0x370: Call2 0x3be

0x371: Stack[-2] = Stack[-14]
0x372: Pop(2)
0x373: Return(); Pop(10)

0x374: PushEmpty(string, int, bool, int, string, string, int, bool, int, string)
0x375: Push("d") // @poff=250
0x376: PushEmpty(int)
0x377: Call2 0x3e9

0x378: Pop(0)
0x379: Pop(2); Push(Stack[-2] + Stack[-1]);
0x37a: Push("m") // @poff=308
0x37b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x37c: Stack[-4] = (int) 0
0x37d: Push((int) 1)
...
0x382: @@ HasProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=284
0x383: Pop(1)
...
0x397: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=296
0x398: Pop(1)
...
0x39f: PushEmpty(bool, float, float, bool, float, float)
0x3a0: @ lshHasAnimation(Stack[-3], Stack[-7])
0x3a1: Pop(0)
0x3a2: Push(Stack[-3])
0x3a3: IF (Stack[-1] == 0) GOTO 0x3aa; Pop(1)

0x3a4: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x3a5: Pop(0)
0x3a6: Push((bool) 0)
0x3a7: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x3a8: Pop(1)
0x3a9: GOTO 0x3ae

0x3aa: Push("Can't find lsh animation : ") // @poff=312
0x3ab: Pop(1); Push(Stack[-1] + Stack[-8]);
0x3ac: @ Trace(Stack[-1])
0x3ad: Pop(1)
0x3ae: Return(); Pop(6)

0x3af: PushEmpty(bool, float, float, bool, float, float)
0x3b0: @ lshHasAnimation(Stack[-3], Stack[-8])
0x3b1: Pop(0)
0x3b2: Push(Stack[-3])
0x3b3: IF (Stack[-1] == 0) GOTO 0x3b9; Pop(1)

0x3b4: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x3b5: Pop(0)
0x3b6: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x3b7: Pop(0)
0x3b8: GOTO 0x3bd

0x3b9: Push("Can't find lsh animation : ") // @poff=312
0x3ba: Pop(1); Push(Stack[-1] + Stack[-9]);
0x3bb: @ Trace(Stack[-1])
0x3bc: Pop(1)
0x3bd: Return(); Pop(6)
...
0x3c3: @ lshHasSpeech(Stack[-1], Stack[-3])
0x3c4: Pop(0)
0x3c5: Push(Stack[-1])
0x3c6: IF (Stack[-1] == 0) GOTO 0x3cb; Pop(1)

0x3c7: @ lshPlaySpeech(Stack[-3])
0x3c8: Pop(0)
0x3c9: Stack[-4] = (bool) 1
0x3ca: Return(); Pop(2)

0x3cb: Stack[-4] = (bool) 0
0x3cc: Return(); Pop(2)
...
0x3d9: Stack[-1] = 0
0x3da: PushEmpty(float, float)
0x3db: Pop(0); Push(Stack[-3] | Stack[-3]);
0x3dc: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x3dd: Push((float)9.999999974752427e-07)
0x3de: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x3df: IF (Stack[-1] == 0) GOTO 0x3e2; Pop(1)

0x3e0: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x3e1: Return(); Pop(2)

0x3e2: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x3e3: Return(); Pop(2)

0x3e4: PushEmpty(int, int)
0x3e5: @ GetVariable(Stack[-3], Stack[-1])
0x3e6: Pop(0)
0x3e7: Stack[-1] = Stack[-4]
0x3e8: Return(); Pop(2)

0x3e9: PushEmpty(float, float)
0x3ea: @ GetGameTime(Stack[-1])
0x3eb: Pop(0)
0x3ec: Push((int) 1)
0x3ed: PushEmpty(int)
0x3ee: Push((int) 24)
0x3ef: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x3f0: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x3f1: Return(); Pop(2)

0x3f2: PushEmpty(string, string)
0x3f3: Stack[-1] = "idle" // @poff=146
0x3f4: Push(Stack[-3])
0x3f5: IF (Stack[-1] == 0) GOTO 0x3f7; Pop(1)

0x3f6: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x3f7: Stack[-1] = Stack[-4]
0x3f8: Return(); Pop(2)

0x3f9: PushEmpty(int, bool, int, bool)
0x3fa: Stack[-2] = (int) 0
0x3fb: Push("all") // @poff=138
0x3fc: PushEmpty(string, int)
0x3fd: Stack[-5] = Stack[-1]
0x3fe: Call2 0x3f2

0x3ff: Pop(1)
0x400: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x401: Pop(2)
0x402: Pop(0); Push((bool) Stack[-1] == 0)
...
0x408: Stack[-2] = Stack[-5]
0x409: Return(); Pop(4)

0x40a: PushEmpty()
0x40b: Push("ook9DankoTermitnik2_1") // @poff=368
0x40c: Push((int) 1)
...
0x410: PushEmpty()
0x411: Push("k9q01DankoTalk") // @poff=412
0x412: Push((int) 1)
...
0x41a: Stack[-1] = "k9q01BurahTalk" // @poff=442
0x41b: Call2 0x3e4

0x41c: Pop(1)
0x41d: Push((int) 0)
0x41e: Pop(2); Push((bool) Stack[-2] != Stack[-1])
0x41f: IF (Stack[-1] == 0) GOTO 0x428; Pop(1)

0x420: PushEmpty(int, string)
0x421: Stack[-1] = "k9q01DankoTalk" // @poff=412
0x422: Call2 0x3e4
...
0x43d: PushEmpty()
0x43e: PushEmpty(int, string)
0x43f: Stack[-1] = "ook9DankoTermitnik2_1" // @poff=368
0x440: Call2 0x3e4
...
0x445: Stack[-2] = (bool) 1
0x446: Return(); Pop(0)

0x447: Stack[-2] = (bool) 0
0x448: Return(); Pop(0)

0x449: PushEmpty(object, object)
0x44a: Push((int) 520)
0x44b: Push((int) 1)
0x44c: Push((int) 529812)
0x44d: @ CreateDiaryEntry(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x44e: Pop(3)
0x44f: PushEmpty(bool, object, int)
0x450: Stack[-4] = Stack[-2]
0x451: Stack[-1] = (int) 517
0x452: Call2 0x463
...
0x457: @ GetDiaryRoot(Stack[-1])
0x458: Pop(0)
0x459: Pop(0); Push((bool) Stack[-1] == 0)
0x45a: IF (Stack[-1] == 0) GOTO 0x460; Pop(1)

0x45b: Push("Can't retrieve diary root") // @poff=484
0x45c: @ Trace(Stack[-1])
0x45d: Pop(1)
0x45e: Stack[-3] = (bool) 0
0x45f: Return(); Pop(2)
...
0x462: Stack[-1] = 0
0x463: PushEmpty(object, object, int, object, object, int)
0x464: PushEmpty(object)
0x465: Call2 0x456

0x466: Stack[-1] = Stack[-4]
0x467: Pop(1)
0x468: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=536
0x469: Pop(0)
0x46a: Pop(0); Push((bool) Stack[-2] == 0)
0x46b: IF (Stack[-1] == 0) GOTO 0x472; Pop(1)

0x46c: Push("Can't find diary parent with id: ") // @poff=541
0x46d: Pop(1); Push(Stack[-1] + Stack[-8]);
0x46e: @ Trace(Stack[-1])
0x46f: Pop(1)
0x470: Stack[-9] = (bool) 0
0x471: Return(); Pop(6)

0x472: @@ AddChild(Stack[-8]); Obj=2 // @poff=609
0x473: Pop(0)
0x474: Push((int) 7)
0x475: @ SendWorldWndMessage(Stack[-1])
0x476: Pop(1)
0x477: @@ GetCategory(Stack[-1]); Obj=8 // @poff=618
0x478: Pop(0)
0x479: @ SetDiarySection(Stack[-1])
0x47a: Pop(0)
...
0x480: Push("branch") // @poff=630
0x481: @ GetVariable(Stack[-1], Stack[-2])
0x482: Pop(1)
0x483: Push((int) 0)
...
0x490: Stack[-1] = (int) 515573
0x491: Return(); Pop(0)

0x492: Stack[-1] = (int) 504032
0x493: Return(); Pop(0)

0x494: Stack[-1] = "ui/NPC_Bakalavr.png" // @poff=644
0x495: Return(); Pop(0)

0x496: Stack[-1] = "ui/NPC_Bakalavr_b.png" // @poff=684
0x497: Return(); Pop(0)
