...
// @pool_raw:
// @pool_encoding:utf8
...
0x1c1: Push("player") // @poff=172
0x1c2: @ FindActor(Stack[-4]T, Stack[-1])
0x1c3: Pop(1)
...
0x1d6: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x261: Pop(0)
0x262: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x263: Pop(0)
...
0x26d: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x26e: Pop(0)
0x26f: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x270: Pop(0)
...
0x2ce: Push("Can't find lsh animation : ") // @poff=222
...
0x2dd: Push("Can't find lsh animation : ") // @poff=222
...
0x2e3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=208
0x2e4: Pop(0)
...
0x309: PushEmpty()
0x30a: Push("ook9Littleboy1") // @poff=278
0x30b: Push((int) 1)
...
0x311: Stack[-1] = "k9q01ChildTalk" // @poff=308
0x312: Call2 0x304
...
0x317: Push("k9q01ChildTalk") // @poff=308
0x318: Push((int) 1)
0x319: @ SetVariable(Stack[-2], Stack[-1])
0x31a: Pop(2)
0x31b: Push("k9q01") // @poff=338
0x31c: Push((int) 7)
...
0x325: Stack[-1] = "ook9Littleboy1" // @poff=278
0x326: Call2 0x304
...
0x341: Push("Can't retrieve diary root") // @poff=350
0x342: @ Trace(Stack[-1])
0x343: Pop(1)
0x344: Stack[-3] = (bool) 0
0x345: Return(); Pop(2)

0x346: Stack[-1] = Stack[-3]
0x347: Return(); Pop(2)
...
0x34d: Pop(1)
0x34e: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=402
0x34f: Pop(0)
0x350: Pop(0); Push((bool) Stack[-2] == 0)
0x351: IF (Stack[-1] == 0) GOTO 0x358; Pop(1)

0x352: Push("Can't find diary parent with id: ") // @poff=407
...
0x358: @@ AddChild(Stack[-8]); Obj=2 // @poff=475
0x359: Pop(0)
0x35a: Push((int) 7)
0x35b: @ SendWorldWndMessage(Stack[-1])
0x35c: Pop(1)
0x35d: @@ GetCategory(Stack[-1]); Obj=8 // @poff=484
0x35e: Pop(0)
...
0x37a: Stack[-1] = "ui/NPC_Citizen3.png" // @poff=510
0x37b: Return(); Pop(0)

0x37c: Stack[-1] = "ui/NPC_Citizen3_b.png" // @poff=550
0x37d: Return(); Pop(0)
...
0x388: Stack[-2] = (int) 0
0x389: Push("all") // @poff=138
0x38a: PushEmpty(string, int)
0x38b: Stack[-5] = Stack[-1]
0x38c: Call2 0x380
