...
// @pool_raw:
// @pool_encoding:utf8
...
0x1dd: Push("player") // @poff=172
0x1de: @ FindActor(Stack[-4]T, Stack[-1])
0x1df: Pop(1)
...
0x1f2: Pop(0); PushNull((bool) Stack[4 + Tasks[-1].StackPointer] == 0)
...
0x27d: Pop(0)
0x27e: @@ GetPosition(Stack[-2]); Obj=7 // @poff=196
0x27f: Pop(0)
...
0x289: @@ GetPosition(Stack[-8]); Obj=20 // @poff=196
0x28a: Pop(0)
0x28b: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=208
0x28c: Pop(0)
...
0x2ea: Push("Can't find lsh animation : ") // @poff=222
...
0x2f9: Push("Can't find lsh animation : ") // @poff=222
...
0x325: PushEmpty()
0x326: Push("ook9Littlegirl1") // @poff=278
0x327: Push((int) 1)
...
0x32d: Stack[-1] = "k9q01ChildTalk" // @poff=310
0x32e: Call2 0x320
...
0x333: Push("k9q01ChildTalk") // @poff=310
0x334: Push((int) 1)
0x335: @ SetVariable(Stack[-2], Stack[-1])
0x336: Pop(2)
0x337: Push("k9q01") // @poff=340
0x338: Push((int) 7)
...
0x341: Stack[-1] = "ook9Littlegirl1" // @poff=278
0x342: Call2 0x320
...
0x35d: Push("Can't retrieve diary root") // @poff=352
0x35e: @ Trace(Stack[-1])
0x35f: Pop(1)
...
0x369: Pop(1)
0x36a: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=404
0x36b: Pop(0)
0x36c: Pop(0); Push((bool) Stack[-2] == 0)
0x36d: IF (Stack[-1] == 0) GOTO 0x374; Pop(1)

0x36e: Push("Can't find diary parent with id: ") // @poff=409
...
0x374: @@ AddChild(Stack[-8]); Obj=2 // @poff=477
0x375: Pop(0)
0x376: Push((int) 7)
0x377: @ SendWorldWndMessage(Stack[-1])
0x378: Pop(1)
0x379: @@ GetCategory(Stack[-1]); Obj=8 // @poff=486
0x37a: Pop(0)
...
0x396: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=512
0x397: Return(); Pop(0)

0x398: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=552
0x399: Return(); Pop(0)
