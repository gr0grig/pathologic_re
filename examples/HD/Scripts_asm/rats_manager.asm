...
// @pool_raw:
// @pool_encoding:utf8
...
0x15d: Push("all") // @poff=138
0x15e: Push("idle") // @poff=146
...
0x1c5: Pop(0)
0x1c6: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x1c7: Pop(1)
0x1c8: PushEmpty(int)
0x1c9: Call2 0x825

0x1ca: Pop(0)
0x1cb: @@ SetNPCDescription(Stack[-1]); Obj=5 // @poff=11
0x1cc: Pop(1)
0x1cd: PushEmpty(string)
0x1ce: Call2 0x829

0x1cf: Pop(0)
0x1d0: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=29
0x1d1: Pop(1)
0x1d2: PushEmpty(string)
0x1d3: Call2 0x82b

0x1d4: Pop(0)
0x1d5: @@ SetPhoto2(Stack[-1]); Obj=5 // @poff=38
0x1d6: Pop(1)
0x1d7: PushEmpty(int)
0x1d8: Call2 0x80e

0x1d9: Pop(0)
0x1da: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=48
0x1db: Pop(1)
0x1dc: Stack[-2] = (int) -1
...
0x1e6: Stack[-11] = Stack[-2]
0x1e7: Stack[-6] = Stack[-1]
0x1e8: Push(-2, 4); TaskCall(5)
0x1e9: Call2 0x200

0x1ea: Pop(-2, 4); TaskReturn
0x1eb: Pop(2)
0x1ec: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1ed: Pop(0)
...
0x1f0: @ sync()
0x1f1: Pop(0)
0x1f2: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x1f3: Pop(0)
0x1f4: GOTO 0x1ee

0x1f5: PushEmpty(object)
0x1f6: Stack[-10] = Stack[-1]
0x1f7: Call2 0x6fe

0x1f8: Pop(1)
0x1f9: @ StopDialog(Stack[-4])
0x1fa: Pop(0)
0x1fb: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x1fc: Pop(0)
0x1fd: Stack[-2] = Stack[-10]
0x1fe: Return(); Pop(8)
...
0x22b: Push("all") // @poff=138
0x22c: Push("idle") // @poff=146
...
0x2aa: Stack[-11] = Stack[-2]
0x2ab: Stack[-6] = Stack[-1]
0x2ac: Push(-2, 4); TaskCall(7)
0x2ad: Call2 0x2c4

0x2ae: Pop(-2, 4); TaskReturn
0x2af: Pop(2)
0x2b0: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2b1: Pop(0)
...
0x2b4: @ sync()
0x2b5: Pop(0)
0x2b6: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=62
0x2b7: Pop(0)
0x2b8: GOTO 0x2b2
...
0x2be: Pop(0)
0x2bf: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=74
0x2c0: Pop(0)
0x2c1: Stack[-2] = Stack[-10]
0x2c2: Return(); Pop(8)
...
0x33e: Push("all") // @poff=138
0x33f: Push("idle") // @poff=146
...
0x4af: Stack[-1] = Stack[-15]
0x4b0: Pop(1)
0x4b1: @ CreateIntVector(Stack[-13])
0x4b2: Pop(0)
0x4b3: Push((int) 4)
0x4b4: @@ GetItemCount(Stack[-13], Stack[-1]); Obj=30 // @poff=156
0x4b5: Pop(1)
0x4b6: Push("rat") // @poff=169
0x4b7: @ GetInvItemByName(Stack[-12], Stack[-1])
0x4b8: Pop(1)
0x4b9: Push("rat_big") // @poff=177
...
0x4bf: Push((int) 4)
0x4c0: @@ GetItem(Stack[-9], Stack[-10], Stack[-1]); Obj=30 // @poff=193
0x4c1: Pop(1)
0x4c2: @@ GetItemID(Stack[-7]); Obj=8 // @poff=201
0x4c3: Pop(0)
0x4c4: PushEmpty(bool)
0x4c5: Stack[-1] = (bool) 1
0x4c6: Pop(0); Push((bool) Stack[-8] == Stack[-12])
0x4c7: IF (Stack[-1] == 1) GOTO 0x4cb; Pop(1)
...
0x4cc: @@ add(Stack[-8]); Obj=14 // @poff=211
0x4cd: Pop(0)
0x4ce: @@ add(Stack[-9]); Obj=13 // @poff=211
0x4cf: Pop(0)
0x4d0: Stack[-8] = 0
0x4d1: Push((int) 1)
...
0x4d4: @@ size(Stack[-12]); Obj=14 // @poff=215
0x4d5: Pop(0)
0x4d6: Push(Stack[-12])
...
0x4e0: Pop(0)
0x4e1: @@ size(Stack[-12]); Obj=5 // @poff=215
0x4e2: Pop(0)
0x4e3: Push(Stack[-12])
0x4e4: IF (Stack[-1] == 0) GOTO 0x4e9; Pop(1)

0x4e5: Push((int) 0)
0x4e6: @@ get(Stack[-7], Stack[-1]); Obj=6 // @poff=220
0x4e7: Pop(1)
0x4e8: GOTO 0x4ea
...
0x4ea: Stack[-5] = 0
0x4eb: @@ get(Stack[-4], Stack[-6]); Obj=14 // @poff=220
0x4ec: Pop(0)
0x4ed: @@ get(Stack[-3], Stack[-6]); Obj=13 // @poff=220
0x4ee: Pop(0)
0x4ef: Push((int) 1)
0x4f0: Push((int) 4)
0x4f1: @@ RemoveItem(Stack[-5], Stack[-2], Stack[-1]); Obj=31 // @poff=224
0x4f2: Pop(2)
0x4f3: Push("quality") // @poff=235
0x4f4: @@ GetProperty(Stack[-3], Stack[-1]); Obj=5 // @poff=251
0x4f5: Pop(1)
0x4f6: @@ GetItemID(Stack[-1]); Obj=4 // @poff=201
0x4f7: Pop(0)
0x4f8: PushEmpty(string, float)
0x4f9: Pop(0); Push((bool) Stack[-3] == Stack[-12])
0x4fa: IF (Stack[-1] == 0) GOTO 0x4fd; Pop(1)

0x4fb: Stack[-2] = "pers_rat_big" // @poff=263
0x4fc: GOTO 0x4fe

0x4fd: Stack[-2] = "pers_rat" // @poff=289
...
0x518: Push("You've won a rat race") // @poff=307
0x519: @ Trace(Stack[-1])
0x51a: Pop(1)
0x51b: GOTO 0x522
...
0x536: Push("ACHIEVEMENT_HELLO_1") // @poff=389
...
0x53c: Push("ACHIEVEMENT_HELLO_1") // @poff=389
0x53d: Push((int) 1)
0x53e: @ SetVariable(Stack[-2], Stack[-1])
0x53f: Pop(2)
0x540: Push("ACHIEVEMENT_HELLO_1") // @poff=389
...
0x54c: IF (Stack[-1] == 1) GOTO 0x549; Pop(1)
...
0x56c: Stack[-13] = Stack[-1]
0x56d: Call2 0x645

0x56e: Stack[-2] = Stack[-10]
0x56f: Pop(2)
0x570: Push((int) 72)
...
0x575: Stack[-12] = Stack[-1]
0x576: Call2 0x645

0x577: Stack[-2] = Stack[-9]
0x578: Pop(2)
0x579: Push((int) 72)
...
0x58e: Push((float)0.10000000149011612)
0x58f: Push((float)0.4000000059604645)
...
0x596: Stack[-13] = Stack[-3]
0x597: Stack[-12] = Stack[-2]
0x598: Stack[-11] = Stack[-1]
0x599: Call2 0x736

0x59a: Stack[-4] = Stack[-10]
0x59b: Pop(4)
0x59c: Push("winner") // @poff=429
0x59d: @ Trace(Stack[-1])
0x59e: Pop(1)
0x59f: GOTO 0x5aa

0x5a0: PushEmpty(int, int, int, int)
0x5a1: Stack[-13] = Stack[-3]
0x5a2: Stack[-12] = Stack[-2]
0x5a3: Stack[-11] = Stack[-1]
0x5a4: Call2 0x745

0x5a5: Stack[-4] = Stack[-10]
0x5a6: Pop(4)
0x5a7: Push("looser") // @poff=443
0x5a8: @ Trace(Stack[-1])
0x5a9: Pop(1)
0x5aa: Push((int) 1)
...
0x5ad: Stack[-12] = Stack[-5]
0x5ae: Stack[-11] = Stack[-12]
0x5af: Stack[-5] = Stack[-11]
0x5b0: Stack[-5] = 0
0x5b1: GOTO 0x5b9
...
0x5b5: Stack[-12] = Stack[-4]
0x5b6: Stack[-10] = Stack[-12]
0x5b7: Stack[-4] = Stack[-10]
0x5b8: Stack[-4] = 0
0x5b9: @ GetScene(Stack[-3])
0x5ba: Pop(0)
0x5bb: PushEmpty(object, object, string, string, string)
0x5bc: Stack[-8] = Stack[-4]
0x5bd: Stack[-3] = "pt_rat1" // @poff=457
0x5be: Stack[-31] = Stack[-2]
0x5bf: Stack[-1] = "rat_race.xml" // @poff=473
0x5c0: Call2 0x776

0x5c1: Stack[-5] = Stack[-7]
0x5c2: Pop(5)
0x5c3: Push("Index") // @poff=499
0x5c4: Push((int) 1)
0x5c5: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=511
0x5c6: Pop(2)
0x5c7: Push("Race") // @poff=529
0x5c8: @@ SetScriptProperty(Stack[-1], Stack[-13]); Obj=3 // @poff=511
0x5c9: Pop(1)
0x5ca: PushEmpty(object, object, string, string, string)
0x5cb: Stack[-8] = Stack[-4]
0x5cc: Stack[-3] = "pt_rat2" // @poff=539
0x5cd: Stack[-2] = "pers_rat" // @poff=289
0x5ce: Stack[-1] = "rat_race.xml" // @poff=473
0x5cf: Call2 0x776

0x5d0: Stack[-5] = Stack[-7]
0x5d1: Pop(5)
0x5d2: Push("Index") // @poff=499
0x5d3: Push((int) 2)
0x5d4: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=511
0x5d5: Pop(2)
0x5d6: Push("Race") // @poff=529
0x5d7: @@ SetScriptProperty(Stack[-1], Stack[-12]); Obj=3 // @poff=511
0x5d8: Pop(1)
0x5d9: PushEmpty(object, object, string, string, string)
0x5da: Stack[-8] = Stack[-4]
0x5db: Stack[-3] = "pt_rat3" // @poff=555
0x5dc: Stack[-2] = "pers_rat" // @poff=289
0x5dd: Stack[-1] = "rat_race.xml" // @poff=473
0x5de: Call2 0x776

0x5df: Stack[-5] = Stack[-7]
0x5e0: Pop(5)
0x5e1: Push("Index") // @poff=499
0x5e2: Push((int) 3)
0x5e3: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=511
0x5e4: Pop(2)
0x5e5: Push("Race") // @poff=529
0x5e6: @@ SetScriptProperty(Stack[-1], Stack[-11]); Obj=3 // @poff=511
0x5e7: Pop(1)
0x5e8: Stack[-1] = (int) 0
0x5e9: Push((int) 6)
...
0x602: PushEmpty()
0x603: Push("race_over1") // @poff=571
...
0x619: Push("race_over2") // @poff=593
...
0x62f: Push("race_over3") // @poff=615
...
0x64c: Push(Stack[-4])
0x64d: IF (Stack[-1] == 1) GOTO 0x651; Pop(1)
...
0x659: Stack[-1] = (float) 0.6666666865348816
0x65a: Call2 0x766
...
0x68e: @@ add(Stack[-5]); Obj=11 // @poff=211
0x68f: Pop(0)
0x690: Push((int) 0)
...
0x695: Stack[-4] = Stack[-12]
0x696: Return(); Pop(10)

0x697: PushEmpty(object, object)
0x698: Push("rats_track_door") // @poff=637
0x699: Push((int) 1)
...
0x6a0: Push((bool) 0)
0x6a1: @@ Open(Stack[-1]); Obj=2 // @poff=669
0x6a2: Pop(1)
0x6a3: GOTO 0x6a6

0x6a4: @@ Close(); Obj=1 // @poff=674
0x6a5: Pop(0)
0x6a6: Return(); Pop(2)
...
0x6ae: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=251
0x6af: Pop(0)
0x6b0: Pop(0); Push(Stack[-1] + Stack[-3]);
0x6b1: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=680
0x6b2: Pop(1)
0x6b3: Return(); Pop(2)
...
0x6ba: @@ GetPosition(Stack[-8]); Obj=20 // @poff=692
0x6bb: Pop(0)
0x6bc: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=704
0x6bd: Pop(0)
...
0x71b: Push("Can't find lsh animation : ") // @poff=728
...
0x72a: Push("Can't find lsh animation : ") // @poff=728
...
0x757: Push((float)9.999999974752427e-07)
...
0x777: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=784
0x778: Pop(0)
0x779: Pop(0); Push((bool) Stack[-4] == 0)
0x77a: IF (Stack[-1] == 0) GOTO 0x783; Pop(1)

0x77b: Push("Locator ") // @poff=795
0x77c: Pop(1); Push(Stack[-1] + Stack[-12]);
0x77d: Push(" doesn't exist") // @poff=813
...
0x78a: Pop(0)
0x78b: @@ add(Stack[-4]); Obj=1 // @poff=211
0x78c: Pop(0)
0x78d: @@ add(Stack[-3]); Obj=1 // @poff=211
0x78e: Pop(0)
0x78f: Push((int) 3)
...
0x796: Stack[-7] = Stack[-3]
0x797: Stack[-2] = "money" // @poff=843
0x798: Stack[-6] = Stack[-1]
0x799: Call2 0x6ad
...
0x7a9: Pop(0)
0x7aa: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=867
0x7ab: Pop(0)
0x7ac: Stack[-1] = Stack[-7]
0x7ad: Return(); Pop(4)

0x7ae: PushEmpty()
0x7af: Push((int) 1)
0x7b0: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=875
0x7b1: Pop(1)
0x7b2: Return(); Pop(0)

0x7b3: PushEmpty()
0x7b4: Push("ooRatsManager1") // @poff=890
0x7b5: Push((int) 1)
...
0x7b9: PushEmpty()
0x7ba: Push("money500 is given") // @poff=920
0x7bb: @ Trace(Stack[-1])
0x7bc: Pop(1)
...
0x7c3: PushEmpty()
0x7c4: Push("playsound") // @poff=956
0x7c5: Push("givemoney") // @poff=976
...
0x7f2: Stack[-1] = "rat" // @poff=169
0x7f3: Call2 0x7a7

0x7f4: Pop(2)
0x7f5: IF (Stack[-1] == 1) GOTO 0x7fd; Pop(1)

0x7f6: PushEmpty(bool, object, string)
0x7f7: Stack[-5] = Stack[-2]
0x7f8: Stack[-1] = "rat_big" // @poff=177
0x7f9: Call2 0x7a7

0x7fa: Pop(2)
0x7fb: IF (Stack[-1] == 1) GOTO 0x7fd; Pop(1)
...
0x804: Stack[-1] = "ooRatsManager1" // @poff=890
0x805: Call2 0x771
...
0x820: Push("branch") // @poff=996
0x821: @ GetVariable(Stack[-1], Stack[-2])
0x822: Pop(1)
0x823: Stack[-1] = Stack[-3]
0x824: Return(); Pop(2)
...
0x829: Stack[-1] = "ui/NPC_Citizen2.png" // @poff=1010
0x82a: Return(); Pop(0)

0x82b: Stack[-1] = "ui/NPC_Citizen2_b.png" // @poff=1050
0x82c: Return(); Pop(0)
