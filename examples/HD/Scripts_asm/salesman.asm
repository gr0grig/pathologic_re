...
Strings:
	...
	W:reputation
	A:GetProperty
// @pool_raw:
...
0x302: @@ GetPosition(Stack[-7]); Obj=18 // @poff=312
0x303: Pop(0)
0x304: @@ GetEyesHeight(Stack[-8]); Obj=18 // @poff=360
0x305: Pop(0)
...
0x341: Push("Can't find lsh animation : ") // @poff=374
...
0x350: Push("Can't find lsh animation : ") // @poff=374
...
0x356: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=360
0x357: Pop(0)
...
0x36e: Push((int) 0)
0x36f: @@ AddItem(Stack[-2], Stack[-6], Stack[-1]); Obj=7 // @poff=430
0x370: Pop(1)
0x371: Return(); Pop(2)
...
0x37e: @@ AddItem(Stack[-3], Stack[-10], Stack[-2], Stack[-1]); Obj=11 // @poff=430
0x37f: Pop(2)
0x380: Return(); Pop(4)

0x381: PushEmpty(bool, bool)
0x382: PushEmpty(bool, int, int)
0x383: Stack[-7] = Stack[-2]
...
0x38e: Stack[-10] = Stack[-2]
0x38f: Stack[-9] = Stack[-1]
0x390: Call2 0x3bc
...
0x3b5: Push((float)9.999999974752427e-07)
...
0x3e5: Stack[-6] = Stack[-2]
0x3e6: Stack[-5] = Stack[-1]
0x3e7: Call2 0x45d

0x3e8: Stack[-3] = Stack[-7]
0x3e9: Pop(3)
0x3ea: Return(); Pop(0)
...
0x3f0: Stack[-6] = Stack[-2]
0x3f1: Stack[-5] = Stack[-1]
0x3f2: Call2 0x4d6

0x3f3: Stack[-3] = Stack[-7]
0x3f4: Pop(3)
0x3f5: Return(); Pop(0)

0x3f6: PushEmpty(bool, object, int)
0x3f7: Stack[-6] = Stack[-2]
0x3f8: Stack[-5] = Stack[-1]
0x3f9: Call2 0x55b

0x3fa: Stack[-3] = Stack[-7]
0x3fb: Pop(3)
0x3fc: Return(); Pop(0)
...
0x402: Stack[-3] = "drapery" // @poff=438
0x403: Stack[-2] = (int) 1
0x404: Stack[-1] = (int) 2
0x405: Call2 0x381
...
0x40b: Stack[-3] = "halfboot_repel" // @poff=454
0x40c: Stack[-2] = (int) 1
0x40d: Stack[-1] = (int) 3
0x40e: Call2 0x381
...
0x411: Stack[-3] = "glove_disp" // @poff=484
0x412: Stack[-2] = (int) 1
0x413: Stack[-1] = (int) 3
0x414: Call2 0x381
...
0x417: Stack[-3] = "drapery" // @poff=438
0x418: Stack[-2] = (int) 1
0x419: Stack[-1] = (int) 3
0x41a: Call2 0x381
...
0x426: Stack[-3] = "cloak_repel" // @poff=518
0x427: Stack[-2] = (int) 1
0x428: Stack[-1] = (int) 4
0x429: Call2 0x381
...
0x435: Stack[-3] = "boot_repel" // @poff=462
0x436: Stack[-2] = (int) 1
0x437: Stack[-1] = (int) 4
0x438: Call2 0x381
...
0x43e: Stack[-3] = "raincoat_repel" // @poff=552
0x43f: Stack[-2] = (int) 1
0x440: Stack[-1] = (int) 4
0x441: Call2 0x381
...
0x447: Stack[-3] = "glove_army" // @poff=582
0x448: Stack[-2] = (int) 1
0x449: Stack[-1] = (int) 5
0x44a: Call2 0x381
...
0x44d: Stack[-3] = "boot_army" // @poff=604
0x44e: Stack[-2] = (int) 1
0x44f: Stack[-1] = (int) 5
0x450: Call2 0x381
...
0x456: Stack[-3] = "balahon" // @poff=624
0x457: Stack[-2] = (int) 1
0x458: Stack[-1] = (int) 9
0x459: Call2 0x381
...
0x45f: Stack[-9] = Stack[-5]
0x460: Stack[-4] = "tourniquet" // @poff=640
0x461: Stack[-3] = (int) 1
0x462: Stack[-2] = (int) 2
...
0x467: Stack[-9] = Stack[-5]
0x468: Stack[-4] = "alpha_pills" // @poff=662
0x469: Stack[-3] = (int) 1
0x46a: Stack[-2] = (int) 1
...
0x46f: Stack[-9] = Stack[-5]
0x470: Stack[-4] = "meradorm" // @poff=686
0x471: Stack[-3] = (int) 1
0x472: Stack[-2] = (int) 1
0x473: Stack[-1] = (int) 2
0x474: Call2 0x372
...
0x47a: Stack[-9] = Stack[-5]
0x47b: Stack[-4] = "neomicin" // @poff=704
0x47c: Stack[-3] = (int) 1
0x47d: Stack[-2] = (int) 1
0x47e: Stack[-1] = (int) 2
0x47f: Call2 0x372
...
0x485: Stack[-8] = Stack[-4]
0x486: Stack[-3] = "novocaine" // @poff=722
0x487: Stack[-2] = (int) 1
0x488: Stack[-1] = (int) 2
0x489: Call2 0x367
...
0x48c: Stack[-9] = Stack[-5]
0x48d: Stack[-4] = "gamma_pills" // @poff=742
0x48e: Stack[-3] = (int) 1
0x48f: Stack[-2] = (int) 2
0x490: Stack[-1] = (int) 2
0x491: Call2 0x372
...
0x494: Stack[-9] = Stack[-5]
0x495: Stack[-4] = "beta_pills" // @poff=766
0x496: Stack[-3] = (int) 1
0x497: Stack[-2] = (int) 2
0x498: Stack[-1] = (int) 2
0x499: Call2 0x372
...
0x49f: Stack[-8] = Stack[-4]
0x4a0: Stack[-3] = "packet" // @poff=788
0x4a1: Stack[-2] = (int) 1
0x4a2: Stack[-1] = (int) 4
0x4a3: Call2 0x367
...
0x4a6: Stack[-8] = Stack[-4]
0x4a7: Stack[-3] = "morfin" // @poff=802
0x4a8: Stack[-2] = (int) 1
0x4a9: Stack[-1] = (int) 2
0x4aa: Call2 0x367
...
0x4ad: Stack[-8] = Stack[-4]
0x4ae: Stack[-3] = "Scalpel" // @poff=816
0x4af: Stack[-2] = (int) 1
0x4b0: Stack[-1] = (int) 8
0x4b1: Call2 0x367
...
0x4b4: Stack[-9] = Stack[-5]
0x4b5: Stack[-4] = "monomicin" // @poff=832
0x4b6: Stack[-3] = (int) 1
0x4b7: Stack[-2] = (int) 2
0x4b8: Stack[-1] = (int) 2
0x4b9: Call2 0x372
...
0x4bf: Stack[-8] = Stack[-4]
0x4c0: Stack[-3] = "etorfin" // @poff=852
0x4c1: Stack[-2] = (int) 1
0x4c2: Stack[-1] = (int) 2
0x4c3: Call2 0x367
...
0x4c6: Stack[-8] = Stack[-4]
0x4c7: Stack[-3] = "feromicin" // @poff=868
0x4c8: Stack[-2] = (int) 1
0x4c9: Stack[-1] = (int) 2
0x4ca: Call2 0x367
...
0x4cd: Stack[-9] = Stack[-5]
0x4ce: Stack[-4] = "delta_pills" // @poff=888
0x4cf: Stack[-3] = (int) 1
0x4d0: Stack[-2] = (int) 2
0x4d1: Stack[-1] = (int) 2
0x4d2: Call2 0x372
...
0x4ed: Stack[-3] = "lemon" // @poff=912
0x4ee: Stack[-2] = (int) 1
0x4ef: Stack[-4] = Stack[-1]
0x4f0: Call2 0x381

0x4f1: Pop(3)
0x4f2: PushEmpty(string, int, int)
0x4f3: Stack[-3] = "rusk" // @poff=924
0x4f4: Stack[-2] = (int) 1
...
0x4fc: Stack[-4] = "dried_fish" // @poff=934
0x4fd: Stack[-3] = (int) 1
0x4fe: Stack[-2] = (int) 1
0x4ff: Stack[-1] = (int) 2
0x500: Call2 0x38c
...
0x503: Stack[-4] = "smoked_meat" // @poff=956
0x504: Stack[-3] = (int) 1
0x505: Stack[-2] = (int) 1
0x506: Stack[-1] = (int) 2
0x507: Call2 0x38c
...
0x512: Stack[-3] = "dried_fish" // @poff=934
0x513: Stack[-2] = (int) 1
0x514: Stack[-4] = Stack[-1]
0x515: Call2 0x381

0x516: Pop(3)
0x517: PushEmpty(string, int, int)
0x518: Stack[-3] = "smoked_meat" // @poff=956
0x519: Stack[-2] = (int) 1
...
0x52a: Stack[-3] = "vegetables" // @poff=1000
0x52b: Stack[-2] = (int) 1
...
0x536: Stack[-3] = "dried_meat" // @poff=1032
0x537: Stack[-2] = (int) 1
0x538: Stack[-4] = Stack[-1]
0x539: Call2 0x381

0x53a: Pop(3)
0x53b: PushEmpty(string, int, int)
0x53c: Stack[-3] = "fresh_fish" // @poff=1054
0x53d: Stack[-2] = (int) 1
...
0x542: Stack[-3] = "fresh_meat" // @poff=1076
0x543: Stack[-2] = (int) 1
...
0x548: Stack[-3] = "funduk" // @poff=1098
0x549: Stack[-2] = (int) 1
...
0x54e: Stack[-3] = "peanut" // @poff=1112
0x54f: Stack[-2] = (int) 1
...
0x554: Stack[-3] = "walnut" // @poff=1126
0x555: Stack[-2] = (int) 1
...
0x563: Stack[-4] = "needle" // @poff=1150
0x564: Stack[-3] = (int) 2
0x565: Stack[-2] = (int) 3
0x566: Stack[-1] = (int) 3
0x567: Call2 0x38c
...
0x56a: Stack[-5] = "kerosene" // @poff=1164
0x56b: Stack[-4] = (int) 9
...
0x575: Stack[-4] = "rifle_ammo" // @poff=1182
0x576: Stack[-3] = (int) 1
0x577: Stack[-2] = (int) 2
0x578: Stack[-1] = (int) 5
0x579: Call2 0x38c
...
0x5aa: Stack[-1] = "ui/NPC_Citizen1.png" // @poff=1218
0x5ab: Return(); Pop(0)

0x5ac: Stack[-1] = "ui/NPC_Citizen1_b.png" // @poff=1258
0x5ad: Return(); Pop(0)
...
0x5b1: Push("reputation") // @poff=1302
0x5b2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=1324
0x5b3: Pop(1)
0x5b4: Stack[-1] = Stack[-4]
0x5b5: Return(); Pop(2)
