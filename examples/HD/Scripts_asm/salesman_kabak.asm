...
Strings:
	...
	W:hook
	W:morfin
// @pool_raw:
...
0x174: Push("Can't find lsh animation : ") // @poff=156
...
0x17a: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=142
0x17b: Pop(0)
...
0x18b: Push((int) 0)
0x18c: @@ AddItem(Stack[-2], Stack[-6], Stack[-1]); Obj=7 // @poff=212
0x18d: Pop(1)
0x18e: Return(); Pop(2)

0x18f: PushEmpty(int, bool, int, bool)
0x190: PushEmpty(bool, int, int)
0x191: Stack[-10] = Stack[-2]
...
0x19b: @@ AddItem(Stack[-3], Stack[-10], Stack[-2], Stack[-1]); Obj=11 // @poff=212
0x19c: Pop(2)
0x19d: Return(); Pop(4)
...
0x1b4: Stack[-7] = Stack[-5]
0x1b5: Stack[-4] = "coffee" // @poff=220
0x1b6: Stack[-3] = (int) 1
0x1b7: Stack[-2] = (int) 1
0x1b8: Stack[-1] = (int) 2
0x1b9: Call2 0x18f
...
0x1bc: Stack[-7] = Stack[-5]
0x1bd: Stack[-4] = "tvirin" // @poff=234
0x1be: Stack[-3] = (int) 1
0x1bf: Stack[-2] = (int) 1
0x1c0: Stack[-1] = (int) 2
0x1c1: Call2 0x18f
...
0x1c4: Stack[-6] = Stack[-4]
0x1c5: Stack[-3] = "silver_ring" // @poff=248
0x1c6: Stack[-2] = (int) 1
0x1c7: Stack[-1] = (int) 2
0x1c8: Call2 0x184
...
0x1cb: Stack[-6] = Stack[-4]
0x1cc: Stack[-3] = "gold_ring" // @poff=272
0x1cd: Stack[-2] = (int) 1
0x1ce: Stack[-1] = (int) 2
0x1cf: Call2 0x184
...
0x1d2: Stack[-6] = Stack[-4]
0x1d3: Stack[-3] = "bracelet" // @poff=292
0x1d4: Stack[-2] = (int) 1
0x1d5: Stack[-1] = (int) 2
0x1d6: Call2 0x184
...
0x1d9: Stack[-6] = Stack[-4]
0x1da: Stack[-3] = "watch" // @poff=310
0x1db: Stack[-2] = (int) 1
0x1dc: Stack[-1] = (int) 2
0x1dd: Call2 0x184
...
0x1e0: Stack[-6] = Stack[-4]
0x1e1: Stack[-3] = "beads" // @poff=322
0x1e2: Stack[-2] = (int) 1
0x1e3: Stack[-1] = (int) 2
0x1e4: Call2 0x184
...
0x1e7: Stack[-6] = Stack[-4]
0x1e8: Stack[-3] = "ear_ring" // @poff=334
0x1e9: Stack[-2] = (int) 1
0x1ea: Stack[-1] = (int) 2
0x1eb: Call2 0x184
...
0x1ee: Stack[-6] = Stack[-4]
0x1ef: Stack[-3] = "flower" // @poff=352
0x1f0: Stack[-2] = (int) 1
0x1f1: Stack[-1] = (int) 2
0x1f2: Call2 0x184
...
0x1f5: Stack[-6] = Stack[-4]
0x1f6: Stack[-3] = "hook" // @poff=366
0x1f7: Stack[-2] = (int) 1
0x1f8: Stack[-1] = (int) 4
0x1f9: Call2 0x184
...
0x1fc: Stack[-6] = Stack[-4]
0x1fd: Stack[-3] = "morfin" // @poff=376
0x1fe: Stack[-2] = (int) 1
0x1ff: Stack[-1] = (int) 4
0x200: Call2 0x184
