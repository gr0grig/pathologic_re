...
Strings:
	...
	A:Intersect
	A:Next
// @pool_raw:
// @pool_encoding:utf8
...
Events:
EVENT_22 Op = 0xa7a Vars = (object, int, float, float)
EVENT_43 Op = 0xa82 Vars = (object, int, float, float, cvector, cvector)
EVENT_16 Op = 0xa8c Vars = (object, string)
EVENT_41 Op = 0xa99 Vars = (object)
...
0x4f: Stack[-17] = Stack[-7]
0x50: PushEmpty(bool, object)
0x51: Stack[-23] = Stack[-1]
0x52: Call2 0xb
...
0x58: @@ GetPosition(Stack[-5]); Obj=21 // @poff=0
0x59: Pop(0)
...
0x6f: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=12
0x70: Pop(0)
...
0x81: Push((int) 0)
0x82: Push((float)0.30000001192092896)
...
0xa4: Push((int) 0)
0xa5: Push((float)0.30000001192092896)
...
0x121: Stack[-15] = Stack[-5]
0x122: Stack[-14] = Stack[-4]
0x123: Stack[-13] = Stack[-3]
0x124: Stack[-12] = Stack[-2]
0x125: Stack[-11] = Stack[-1]
0x126: Call2 0x16b

0x127: Stack[-6] = Stack[-7]
0x128: Pop(6)
0x129: Push( Stack[2 + Tasks[-1].StackPointer] )
0x12a: IF (Stack[-1] == 0) GOTO 0x12e; Pop(1)

0x12b: Push("head") // @poff=44
...
0x16e: Stack[-17] = Stack[-7]
0x16f: PushEmpty(bool, object)
0x170: Stack[-23] = Stack[-1]
0x171: Call2 0x1f7
...
0x177: @@ GetPosition(Stack[-5]); Obj=21 // @poff=0
0x178: Pop(0)
...
0x18e: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=12
0x18f: Pop(0)
...
0x1a0: Push((int) 0)
0x1a1: Push((float)0.30000001192092896)
...
0x1c3: Push((int) 0)
0x1c4: Push((float)0.30000001192092896)
...
0x1fb: Stack[-2] = Stack[-4]
0x1fc: Pop(2)
0x1fd: Return(); Pop(0)

0x1fe: Stack[-1] = "walk" // @poff=26
0x1ff: Return(); Pop(0)

0x200: Stack[-1] = "run" // @poff=36
0x201: Return(); Pop(0)
...
0x249: Stack[-7] = Stack[-3]
0x24a: Stack[-6] = Stack[-2]
0x24b: Stack[-5] = Stack[-1]
0x24c: Call2 0xa9f
...
0x2f8: Stack[-7] = Stack[-3]
0x2f9: Stack[-6] = Stack[-2]
...
0x382: Pop(1)
0x383: Push("all") // @poff=54
0x384: Push("attack_on") // @poff=62
0x385: @ PlayAnimation(Stack[-2], Stack[-1])
0x386: Pop(2)
0x387: Stack[-3] = (bool) 1
0x388: GOTO 0x38d

0x389: Push("all") // @poff=54
0x38a: Push("bjump") // @poff=82
...
0x399: Pop(1)
0x39a: Push("all") // @poff=54
0x39b: Push("attack_off") // @poff=94
...
0x3aa: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x3ab: IF (Stack[-1] == 0) GOTO 0x3ad; Pop(1)

0x3ac: GOTO 0x3c7

0x3ad: @ Face(Stack[-0]T)
0x3ae: Pop(0)
0x3af: Stack[-1] = 0
0x3b0: GOTO 0x3c4
...
0x3b9: Pop(1)
0x3ba: Push("all") // @poff=54
0x3bb: Push("attack_on") // @poff=62
...
0x3c9: Pop(1)
0x3ca: Push("all") // @poff=54
0x3cb: Push("attack_off") // @poff=94
...
0x41b: Pop(0); PushNull((bool) Stack[-21] == 0)
0x41c: IF (Stack[-1] == 0) GOTO 0x422; Pop(1)

0x41d: PushEmpty(string)
0x41e: Stack[-1] = "fdie" // @poff=116
0x41f: Call2 0x475

0x420: Pop(1)
0x421: GOTO 0x474

0x422: @@ GetPosition(Stack[-10]); Obj=21 // @poff=0
0x423: Pop(0)
...
0x433: Stack[-6] = "fdie" // @poff=116
0x434: GOTO 0x436

0x435: Stack[-6] = "bdie" // @poff=126
...
0x43c: @ StopAsync()
0x43d: Pop(0)
0x43e: Stack[-21] = Stack[-5]
0x43f: Push("GetScriptProperty") // @poff=136
0x440: Push((int) 2)
0x441: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x442: IF (Stack[-1] == 0) GOTO 0x44e; Pop(1)

0x443: Push("Owner") // @poff=172
0x444: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=184
0x445: Pop(1)
0x446: Push(Stack[-4])
0x447: IF (Stack[-1] == 0) GOTO 0x44e; Pop(1)

0x448: Push("Owner") // @poff=172
0x449: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=202
0x44a: Pop(1)
0x44b: Pop(0); PushNull((bool) Stack[-5] == 0)
0x44c: IF (Stack[-1] == 0) GOTO 0x44e; Pop(1)

0x44d: Stack[-21] = Stack[-5]
0x44e: Push("@GetEyesHeight") // @poff=220
0x44f: Push((int) 1)
0x450: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x451: IF (Stack[-1] == 0) GOTO 0x45d; Pop(1)

0x452: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=250
0x453: Pop(0)
...
0x45f: Stack[-7] = Stack[-1]
0x460: Call2 0x6eb

0x461: Pop(1)
0x462: Push("all") // @poff=54
...
0x469: @ StopAsync()
0x46a: Pop(0)
0x46b: Push("head") // @poff=44
0x46c: @ UnlookAsync(Stack[-1])
0x46d: Pop(1)
0x46e: Push("all") // @poff=54
...
0x497: Stack[-12] = Stack[-2]
0x498: Stack[-1] = "disease" // @poff=264
0x499: Call2 0x596
...
0x4ad: Push("all") // @poff=54
0x4ae: Push("attack_on") // @poff=62
...
0x4c2: Stack[-13] = Stack[-2]
0x4c3: Stack[-1] = "cleansed" // @poff=280
0x4c4: Call2 0x596
...
0x4ca: Push("cleansed") // @poff=280
0x4cb: Push((bool) 1)
0x4cc: @@ SetProperty(Stack[-2], Stack[-1]); Obj=11 // @poff=298
0x4cd: Pop(2)
0x4ce: Stack[0 + Tasks[-1].StackPointer] = Stack[-9]
0x4cf: @ GetScene(Stack[-3])
0x4d0: Pop(0)
0x4d1: @@ GetPosition(Stack[-2]); Obj=9 // @poff=0
0x4d2: Pop(0)
0x4d3: Push("scripted") // @poff=310
0x4d4: Push(CVector(0.0, 0.0, 1.0))
0x4d5: Push("corpse_fire.xml") // @poff=328
0x4d6: @ AddActorByType(Stack[-1]T, Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x4d7: Pop(3)
0x4d8: Stack[-3] = 0
0x4d9: Push("all") // @poff=54
0x4da: Push("cattack") // @poff=360
...
0x4e2: IF (Stack[-1] == 1) GOTO 0x4ea; Pop(1)

0x4e3: PushEmpty(bool, object)
0x4e4: Stack[-12] = Stack[-1]
0x4e5: Call2 0x62c
...
0x4ec: Push("disease") // @poff=264
0x4ed: @@ GetProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=376
0x4ee: Pop(1)
0x4ef: Push((float)0.10000000149011612)
0x4f0: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x4f1: IF (Stack[-1] == 0) GOTO 0x4f7; Pop(1)

0x4f2: Push("disease") // @poff=264
0x4f3: Push((float)0.0)
0x4f4: @@ SetProperty(Stack[-2], Stack[-1]); Obj=11 // @poff=298
0x4f5: Pop(2)
0x4f6: GOTO 0x4fd

0x4f7: Push("disease") // @poff=264
0x4f8: Push((float)0.10000000149011612)
0x4f9: Pop(1); Push(Stack[-3] - Stack[-1]);
0x4fa: @@ SetProperty(Stack[-2], Stack[-1]); Obj=11 // @poff=298
0x4fb: Pop(2)
0x4fc: GOTO 0x4bd
...
0x506: Push("cleansed") // @poff=280
0x507: @@@ RemoveProperty(Stack[-1]); Obj=0 // @poff=388
0x508: Pop(1)
0x509: Stack[0 + Tasks[-1].StackPointer] = 0
0x50a: Push(Stack[-4])
0x50b: IF (Stack[-1] == 0) GOTO 0x512; Pop(1)

0x50c: Push("all") // @poff=54
0x50d: Push("attack_off") // @poff=94
...
0x517: Push("cleansed") // @poff=280
0x518: @@@ RemoveProperty(Stack[-1]); Obj=0 // @poff=388
0x519: Pop(1)
0x51a: Return(); Pop(0)
...
0x51d: Push("cleansed") // @poff=280
0x51e: @@@ RemoveProperty(Stack[-1]); Obj=0 // @poff=388
0x51f: Pop(1)
0x520: Push((int) 71)
...
0x56b: Push("continue") // @poff=403
0x56c: @ Trigger(Stack[-1]T, Stack[-1])
0x56d: Pop(1)
0x56e: GOTO 0x573

0x56f: PushEmpty(int)
0x570: Stack[-2] = Stack[-1]
0x571: Call2 0xab9
...
0x57e: Stack[-2] = "bullet" // @poff=431
0x57f: Return(); Pop(0)

0x580: Stack[-2] = "phys" // @poff=445
0x581: Return(); Pop(0)

0x582: PushEmpty(cvector, cvector, cvector, cvector)
0x583: @ GetPosition(Stack[-2])
0x584: Pop(0)
0x585: @@ GetPosition(Stack[-1]); Obj=5 // @poff=0
0x586: Pop(0)
...
0x58b: Pop(0)
0x58c: @@ GetPosition(Stack[-2]); Obj=7 // @poff=0
0x58d: Pop(0)
...
0x593: Pop(0)
0x594: Stack[-1] = Stack[-4]
0x595: Return(); Pop(2)

0x596: PushEmpty(bool, bool)
0x597: Push("HasProperty") // @poff=455
0x598: Push((int) 2)
...
0x59e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=479
0x59f: Pop(0)
0x5a0: Stack[-1] = Stack[-5]
0x5a1: Return(); Pop(2)

0x5a2: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x5a3: PushEmpty(bool, object, string)
0x5a4: Stack[-18] = Stack[-2]
0x5a5: Stack[-1] = "health" // @poff=491
0x5a6: Call2 0x596
...
0x5ad: Stack[-18] = Stack[-2]
0x5ae: Stack[-1] = "armor" // @poff=505
0x5af: Call2 0x596
...
0x5b5: Push("armor") // @poff=505
0x5b6: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=376
0x5b7: Pop(1)
0x5b8: Push("armor_") // @poff=517
0x5b9: PushEmpty(string, int)
0x5ba: Stack[-16] = Stack[-1]
0x5bb: Call2 0x574

0x5bc: Pop(1)
0x5bd: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x5be: PushEmpty(bool, object, string)
0x5bf: Stack[-18] = Stack[-2]
0x5c0: Stack[-8] = Stack[-1]
0x5c1: Call2 0x596
...
0x5c7: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=376
0x5c8: Pop(0)
...
0x5cf: Stack[-3] = Stack[-6]
0x5d0: Pop(3)
0x5d1: Push("health") // @poff=491
0x5d2: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=376
0x5d3: Pop(1)
0x5d4: Push((int) 1)
0x5d5: Pop(1); Push(Stack[-1] - Stack[-4]);
0x5d6: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x5d7: Push("health") // @poff=491
...
0x5dd: Pop(3)
0x5de: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=298
0x5df: Pop(2)
0x5e0: PushEmpty(bool, object)
0x5e1: Stack[-17] = Stack[-1]
0x5e2: Call2 0x591
...
0x5e8: Pop(1)
0x5e9: Stack[-1] = Stack[-16]
0x5ea: Return(); Pop(12)

0x5eb: PushEmpty(bool, bool)
0x5ec: @@ IsDead(Stack[-1]); Obj=3 // @poff=531
0x5ed: Pop(0)
0x5ee: Stack[-1] = Stack[-4]
0x5ef: Return(); Pop(2)

0x5f0: PushEmpty(object, object, object, object)
0x5f1: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x605: Pop(0)
0x606: Pop(0); PushNull((bool) Stack[-2] == 0)
0x607: IF (Stack[-1] == 0) GOTO 0x60a; Pop(1)

0x608: Stack[-6] = (bool) 0
0x609: Return(); Pop(4)

0x60a: @@ GetScene(Stack[-1]); Obj=5 // @poff=552
0x60b: Pop(0)
...
0x61e: Stack[-6] = Stack[-2]
0x61f: Stack[-1] = "noaccess" // @poff=561
0x620: Call2 0x596
...
0x626: Push("noaccess") // @poff=561
0x627: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=376
0x628: Pop(1)
0x629: Push((int) 0)
...
0x62d: Pop(0); PushNull((bool) Stack[-7] == 0)
...
0x632: Pop(0)
0x633: Pop(0); PushNull((bool) Stack[-3] == 0)
0x634: IF (Stack[-1] == 0) GOTO 0x637; Pop(1)

0x635: Stack[-8] = (bool) 0
0x636: Return(); Pop(6)

0x637: @@ GetScene(Stack[-2]); Obj=7 // @poff=552
0x638: Pop(0)
...
0x63e: Stack[-10] = Stack[-2]
0x63f: Stack[-1] = "noaccess" // @poff=561
0x640: Call2 0x596
...
0x646: Push("noaccess") // @poff=561
0x647: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=376
0x648: Pop(1)
0x649: Push((int) 0)
...
0x64f: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x65d: @@ GetPosition(Stack[-5]); Obj=15 // @poff=0
0x65e: Pop(0)
...
0x66e: Stack[-1] = "fhit" // @poff=579
0x66f: GOTO 0x671

0x670: Stack[-1] = "bhit" // @poff=589
0x671: Push("hit_react") // @poff=599
0x672: Push("1") // @poff=619
0x673: Pop(1); Push(Stack[-3] + Stack[-1]);
0x674: Push("2") // @poff=623
...
0x68d: Stack[-25] = Stack[-1]
0x68e: Call2 0x582

0x68f: Stack[-2] = Stack[-3]
0x690: Pop(2)
0x691: Call2 0x771

0x692: Stack[-2] = Stack[-11]
0x693: Pop(2)
0x694: @ CreateVectorVector(Stack[-8])
0x695: Pop(0)
0x696: Stack[-7] = (int) 1
0x697: Push("hit") // @poff=581
...
0x6ac: Pop(0)
0x6ad: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=636
0x6ae: Pop(0)
0x6af: PushEmpty(object, int, float, cvector, cvector)
0x6b0: Stack[-26] = Stack[-5]
0x6b1: Stack[-25] = Stack[-4]
0x6b2: Stack[-24] = Stack[-3]
0x6b3: Stack[-6] = Stack[-2]
...
0x6d2: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=250
0x6d3: Pop(0)
...
0x6de: Stack[-10] = Stack[-2]
0x6df: Stack[-9] = Stack[-1]
0x6e0: Call2 0x78d
...
0x72c: Push("woman") // @poff=668
0x72d: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x72e: IF (Stack[-1] == 1) GOTO 0x733; Pop(1)

0x72f: Push("worker") // @poff=680
0x730: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x731: IF (Stack[-1] == 1) GOTO 0x733; Pop(1)

0x732: Stack[-1] = (bool) 0
0x733: IF (Stack[-1] == 1) GOTO 0x738; Pop(1)

0x734: Push("butcher") // @poff=694
0x735: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x736: IF (Stack[-1] == 1) GOTO 0x738; Pop(1)

0x737: Stack[-1] = (bool) 0
0x738: IF (Stack[-1] == 1) GOTO 0x73d; Pop(1)

0x739: Push("wasted_girl") // @poff=710
0x73a: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x73b: IF (Stack[-1] == 1) GOTO 0x73d; Pop(1)

0x73c: Stack[-1] = (bool) 0
0x73d: IF (Stack[-1] == 1) GOTO 0x742; Pop(1)

0x73e: Push("boy") // @poff=734
0x73f: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x740: IF (Stack[-1] == 1) GOTO 0x742; Pop(1)

0x741: Stack[-1] = (bool) 0
0x742: IF (Stack[-1] == 1) GOTO 0x747; Pop(1)

0x743: Push("vaxxabitka") // @poff=742
0x744: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x745: IF (Stack[-1] == 1) GOTO 0x747; Pop(1)

0x746: Stack[-1] = (bool) 0
0x747: IF (Stack[-1] == 1) GOTO 0x74c; Pop(1)

0x748: Push("unosha") // @poff=764
0x749: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x74a: IF (Stack[-1] == 1) GOTO 0x74c; Pop(1)

0x74b: Stack[-1] = (bool) 0
0x74c: IF (Stack[-1] == 1) GOTO 0x751; Pop(1)

0x74d: Push("wasted_male") // @poff=778
0x74e: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x74f: IF (Stack[-1] == 1) GOTO 0x751; Pop(1)

0x750: Stack[-1] = (bool) 0
0x751: IF (Stack[-1] == 1) GOTO 0x756; Pop(1)

0x752: Push("alkash") // @poff=802
0x753: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x754: IF (Stack[-1] == 1) GOTO 0x756; Pop(1)

0x755: Stack[-1] = (bool) 0
0x756: IF (Stack[-1] == 1) GOTO 0x75b; Pop(1)

0x757: Push("dohodyaga") // @poff=816
0x758: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x759: IF (Stack[-1] == 1) GOTO 0x75b; Pop(1)

0x75a: Stack[-1] = (bool) 0
0x75b: IF (Stack[-1] == 1) GOTO 0x760; Pop(1)

0x75c: Push("vaxxabit") // @poff=836
0x75d: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x75e: IF (Stack[-1] == 1) GOTO 0x760; Pop(1)

0x75f: Stack[-1] = (bool) 0
0x760: IF (Stack[-1] == 1) GOTO 0x765; Pop(1)

0x761: Push("nudegirl") // @poff=854
0x762: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x763: IF (Stack[-1] == 1) GOTO 0x765; Pop(1)

0x764: Stack[-1] = (bool) 0
0x765: IF (Stack[-1] == 1) GOTO 0x76a; Pop(1)

0x766: Push("morlok") // @poff=872
0x767: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x768: IF (Stack[-1] == 1) GOTO 0x76a; Pop(1)
...
0x774: Push((float)9.999999974752427e-07)
...
0x77e: Stack[-2] = Stack[-3]
0x77f: GOTO 0x781

0x780: Stack[-1] = Stack[-3]
0x781: Return(); Pop(0)
...
0x789: Stack[-1] = Stack[-4]
0x78a: Return(); Pop(0)

0x78b: Stack[-3] = Stack[-4]
0x78c: Return(); Pop(0)
...
0x79a: Pop(0)
0x79b: @@ add(Stack[-3]); Obj=1 // @poff=627
0x79c: Pop(0)
0x79d: Push((int) 0)
0x79e: Pop(1); Push((bool) Stack[-4] < Stack[-1])
0x79f: IF (Stack[-1] == 0) GOTO 0x7a4; Pop(1)

0x7a0: Push((float)0.699999988079071)
0x7a1: Push((int) 500)
0x7a2: @ RumblePlay(Stack[-2], Stack[-1])
0x7a3: Pop(2)
0x7a4: Push((int) 15)
0x7a5: @ SendWorldWndMessage(Stack[-1], Stack[-2])
0x7a6: Pop(1)
0x7a7: Return(); Pop(2)

0x7a8: Stack[-1] = 0
0x7a9: PushEmpty(bool, bool)
0x7aa: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7ab: Pop(0)
0x7ac: Push(Stack[-1])
0x7ad: IF (Stack[-1] == 0) GOTO 0x7b1; Pop(1)

0x7ae: Push("attack") // @poff=362
0x7af: @ PlayGlobalMusic(Stack[-1])
0x7b0: Pop(1)
0x7b1: Return(); Pop(2)

0x7b2: PushEmpty(object, object)
0x7b3: @ GetScene(Stack[-1])
0x7b4: Pop(0)
0x7b5: Push("battle") // @poff=886
0x7b6: PushEmpty(object)
0x7b7: Call2 0x76b

0x7b8: Pop(0)
0x7b9: @ BroadcastMessage(Stack[-2], Stack[-1], Stack[-3])
0x7ba: Pop(2)
0x7bb: Return(); Pop(2)

0x7bc: Stack[-1] = 0
0x7bd: PushEmpty(string, string)
0x7be: Stack[-1] = "idle" // @poff=900
0x7bf: Push(Stack[-3])
0x7c0: IF (Stack[-1] == 0) GOTO 0x7c2; Pop(1)

0x7c1: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x7c2: Stack[-1] = Stack[-4]
0x7c3: Return(); Pop(2)

0x7c4: PushEmpty(int, bool, int, bool)
0x7c5: Stack[-2] = (int) 0
0x7c6: Push("all") // @poff=54
0x7c7: PushEmpty(string, int)
0x7c8: Stack[-5] = Stack[-1]
0x7c9: Call2 0x7bd
...
0x7d3: Stack[-2] = Stack[-5]
0x7d4: Return(); Pop(4)

0x7d5: PushEmpty(int, int)
0x7d6: Push("branch") // @poff=910
0x7d7: @ GetVariable(Stack[-1], Stack[-2])
0x7d8: Pop(1)
0x7d9: Stack[-1] = Stack[-3]
0x7da: Return(); Pop(2)
...
0x7de: Pop(0)
0x7df: Push((int) 1)
0x7e0: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x7e1: IF (Stack[-1] == 0) GOTO 0x7e5; Pop(1)

0x7e2: @ WorkWithCorpse(Stack[-1])
0x7e3: Pop(0)
0x7e4: GOTO 0x7e7

0x7e5: @ Barter(Stack[-1])
0x7e6: Pop(0)
0x7e7: Return(); Pop(0)

0x7e8: PushEmpty(int, bool, int, bool)
0x7e9: Pop(0); Push((bool) Stack[-6] > Stack[-5])
0x7ea: IF (Stack[-1] == 0) GOTO 0x7ef; Pop(1)

0x7eb: Push("GenerateMoney: iMin > iMax") // @poff=924
0x7ec: @ Trace(Stack[-1])
0x7ed: Pop(1)
0x7ee: Return(); Pop(4)

0x7ef: Stack[-2] = (int) 0
0x7f0: Pop(0); Push((bool) Stack[-6] != Stack[-5])
0x7f1: IF (Stack[-1] == 0) GOTO 0x7f6; Pop(1)

0x7f2: Pop(0); Push(Stack[-5] - Stack[-6]);
0x7f3: @ irand(Stack[-3], Stack[-1])
0x7f4: Pop(1)
0x7f5: GOTO 0x7fa

0x7f6: Push((int) 0)
0x7f7: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x7f8: IF (Stack[-1] == 0) GOTO 0x7fa; Pop(1)

0x7f9: Return(); Pop(4)

0x7fa: Stack[-2] = Stack[-2] + Stack[-6]; Pop(0);
0x7fb: Push((int) 0)
...
0x7ff: PushEmpty(int, string)
0x800: Stack[-1] = "Money" // @poff=978
0x801: Call2 0x85e

0x802: Pop(1)
0x803: Push((int) 0)
0x804: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x805: Pop(2)
0x806: Return(); Pop(4)

0x807: PushEmpty(object, int, bool, object, int, bool)
0x808: @ CreateInvItem(Stack[-3])
0x809: Pop(0)
0x80a: @@ SetItemName(Stack[-7]); Obj=3 // @poff=990
0x80b: Pop(0)
0x80c: Push("Organ") // @poff=1002
0x80d: Push((int) 1)
0x80e: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=298
0x80f: Pop(2)
0x810: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1014
0x811: Pop(0)
0x812: Push((int) 0)
0x813: Push((int) 1)
0x814: @ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x815: Pop(2)
0x816: Return(); Pop(6)
...
0x820: Stack[-1] = "liver" // @poff=1024
0x821: Call2 0x807

0x822: Pop(1)
0x823: PushEmpty(string)
0x824: Stack[-1] = "kidney" // @poff=1036
0x825: Call2 0x807

0x826: Pop(1)
0x827: PushEmpty(string)
0x828: Stack[-1] = "heart" // @poff=1050
0x829: Call2 0x807

0x82a: Pop(1)
0x82b: PushEmpty(string)
0x82c: Stack[-1] = "blood" // @poff=1062
0x82d: Call2 0x807

0x82e: Pop(1)
0x82f: Return(); Pop(0)

0x830: PushEmpty(int, bool, int, bool)
0x831: Push((int) 0)
0x832: @ ClearSubContainer(Stack[-1])
0x833: Pop(1)
0x834: PushEmpty(int, int)
0x835: Stack[-2] = (int) 600
0x836: Stack[-1] = (int) 1500
0x837: Call2 0x7e8

0x838: Pop(2)
0x839: PushEmpty(string, int, int, int)
0x83a: Stack[-4] = "rusk" // @poff=1074
0x83b: Stack[-3] = (int) 1
0x83c: Stack[-2] = (int) 3
0x83d: Stack[-1] = (int) 2
0x83e: Call2 0x6dc
...
0x841: Stack[-4] = "alpha_pills" // @poff=1084
0x842: Stack[-3] = (int) 1
0x843: Stack[-2] = (int) 3
0x844: Stack[-1] = (int) 5
0x845: Call2 0x6dc
...
0x848: Stack[-4] = "beta_pills" // @poff=1108
0x849: Stack[-3] = (int) 1
0x84a: Stack[-2] = (int) 6
0x84b: Stack[-1] = (int) 4
0x84c: Call2 0x6dc
...
0x84d: Pop(4)
0x84e: PushEmpty(string, int, int, int)
0x84f: Stack[-4] = "gamma_pills" // @poff=1130
0x850: Stack[-3] = (int) 1
0x851: Stack[-2] = (int) 12
0x852: Stack[-1] = (int) 3
0x853: Call2 0x6dc

0x854: Pop(4)
0x855: PushEmpty(int, string)
0x856: Stack[-1] = "ognemet_ammo" // @poff=1154
0x857: Call2 0x85e
...
0x85e: PushEmpty(int, int)
0x85f: @ GetInvItemByName(Stack[-1], Stack[-3])
0x860: Pop(0)
0x861: Stack[-1] = Stack[-4]
0x862: Return(); Pop(2)

0x863: PushEmpty(string, string)
0x864: PushEmpty(bool, object, string)
0x865: Stack[-7] = Stack[-2]
0x866: Stack[-1] = "class" // @poff=1180
0x867: Call2 0x596
...
0x86b: Stack[-5] = (bool) 0
0x86c: Return(); Pop(2)

0x86d: Push("class") // @poff=1180
0x86e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=376
0x86f: Pop(1)
...
0x884: Push("patrol") // @poff=1192
0x885: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x886: IF (Stack[-1] == 1) GOTO 0x88b; Pop(1)

0x887: Push("sanitar") // @poff=1206
0x888: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x889: IF (Stack[-1] == 1) GOTO 0x88b; Pop(1)

0x88a: Stack[-1] = (bool) 0
0x88b: IF (Stack[-1] == 1) GOTO 0x890; Pop(1)

0x88c: Push("soldier") // @poff=1222
0x88d: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x88e: IF (Stack[-1] == 1) GOTO 0x890; Pop(1)

0x88f: Stack[-1] = (bool) 0
0x890: IF (Stack[-1] == 1) GOTO 0x895; Pop(1)

0x891: Push("woman") // @poff=668
0x892: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x893: IF (Stack[-1] == 1) GOTO 0x895; Pop(1)

0x894: Stack[-1] = (bool) 0
0x895: IF (Stack[-1] == 1) GOTO 0x89a; Pop(1)

0x896: Push("wasted_girl") // @poff=710
0x897: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x898: IF (Stack[-1] == 1) GOTO 0x89a; Pop(1)

0x899: Stack[-1] = (bool) 0
0x89a: IF (Stack[-1] == 1) GOTO 0x89f; Pop(1)

0x89b: Push("vaxxabitka") // @poff=742
0x89c: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x89d: IF (Stack[-1] == 1) GOTO 0x89f; Pop(1)

0x89e: Stack[-1] = (bool) 0
0x89f: IF (Stack[-1] == 1) GOTO 0x8a4; Pop(1)

0x8a0: Push("vaxxabit") // @poff=836
0x8a1: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8a2: IF (Stack[-1] == 1) GOTO 0x8a4; Pop(1)

0x8a3: Stack[-1] = (bool) 0
0x8a4: IF (Stack[-1] == 1) GOTO 0x8a9; Pop(1)

0x8a5: Push("little_girl") // @poff=1238
0x8a6: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x8a7: IF (Stack[-1] == 1) GOTO 0x8a9; Pop(1)

0x8a8: Stack[-1] = (bool) 0
0x8a9: IF (Stack[-1] == 1) GOTO 0x8ae; Pop(1)

0x8aa: Push("girl") // @poff=724
0x8ab: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8ac: IF (Stack[-1] == 1) GOTO 0x8ae; Pop(1)

0x8ad: Stack[-1] = (bool) 0
0x8ae: IF (Stack[-1] == 1) GOTO 0x8b3; Pop(1)

0x8af: Push("dohodyaga") // @poff=816
0x8b0: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8b1: IF (Stack[-1] == 1) GOTO 0x8b3; Pop(1)

0x8b2: Stack[-1] = (bool) 0
0x8b3: IF (Stack[-1] == 1) GOTO 0x8b8; Pop(1)

0x8b4: Push("nudegirl") // @poff=854
0x8b5: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8b6: IF (Stack[-1] == 1) GOTO 0x8b8; Pop(1)

0x8b7: Stack[-1] = (bool) 0
0x8b8: IF (Stack[-1] == 0) GOTO 0x8bb; Pop(1)

0x8b9: Stack[-5] = (bool) 1
0x8ba: Return(); Pop(2)

0x8bb: Push(Stack[-3])
0x8bc: IF (Stack[-1] == 0) GOTO 0x8bf; Pop(1)

0x8bd: Stack[-5] = (bool) 0
0x8be: Return(); Pop(2)

0x8bf: Stack[-5] = (bool) 1
0x8c0: PushEmpty(bool)
0x8c1: Stack[-1] = (bool) 1
0x8c2: PushEmpty(bool)
0x8c3: Stack[-1] = (bool) 1
0x8c4: PushEmpty(bool)
0x8c5: Stack[-1] = (bool) 1
0x8c6: PushEmpty(bool)
0x8c7: Stack[-1] = (bool) 1
0x8c8: PushEmpty(bool)
0x8c9: Stack[-1] = (bool) 1
0x8ca: Push("worker") // @poff=680
0x8cb: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8cc: IF (Stack[-1] == 1) GOTO 0x8d1; Pop(1)

0x8cd: Push("butcher") // @poff=694
0x8ce: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x8cf: IF (Stack[-1] == 1) GOTO 0x8d1; Pop(1)

0x8d0: Stack[-1] = (bool) 0
0x8d1: IF (Stack[-1] == 1) GOTO 0x8d6; Pop(1)

0x8d2: Push("boy") // @poff=734
0x8d3: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x8d4: IF (Stack[-1] == 1) GOTO 0x8d6; Pop(1)

0x8d5: Stack[-1] = (bool) 0
0x8d6: IF (Stack[-1] == 1) GOTO 0x8db; Pop(1)

0x8d7: Push("unosha") // @poff=764
0x8d8: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x8d9: IF (Stack[-1] == 1) GOTO 0x8db; Pop(1)

0x8da: Stack[-1] = (bool) 0
0x8db: IF (Stack[-1] == 1) GOTO 0x8e0; Pop(1)

0x8dc: Push("wasted_male") // @poff=778
0x8dd: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x8de: IF (Stack[-1] == 1) GOTO 0x8e0; Pop(1)

0x8df: Stack[-1] = (bool) 0
0x8e0: IF (Stack[-1] == 1) GOTO 0x8e5; Pop(1)

0x8e1: Push("alkash") // @poff=802
0x8e2: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8e3: IF (Stack[-1] == 1) GOTO 0x8e5; Pop(1)

0x8e4: Stack[-1] = (bool) 0
0x8e5: IF (Stack[-1] == 1) GOTO 0x8ea; Pop(1)

0x8e6: Push("morlok") // @poff=872
0x8e7: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x8e8: IF (Stack[-1] == 1) GOTO 0x8ea; Pop(1)

0x8e9: Stack[-5] = (bool) 0
0x8ea: Return(); Pop(2)

0x8eb: PushEmpty(float, object, object, float, object, object)
0x8ec: Push(GlobalVars[4])
0x8ed: PushEmpty(object)
0x8ee: Call2 0x792

0x8ef: Stack[-1] = Stack[-2]
0x8f0: Pop(1)
0x8f1: GlobalVars[4] = Stack[-1]; Pop(1)
0x8f2: @ GetAttackDistance(Stack[-3])
0x8f3: Pop(0)
0x8f4: Push(GlobalVars[2])
0x8f5: Push((float)600.0)
0x8f6: Stack[-2] = Stack[-5] / Stack[-1]; Pop(1);
0x8f7: GlobalVars[2] = Stack[-1]; Pop(1)
0x8f8: @ GetScene(Stack[-2])
0x8f9: Pop(0)
0x8fa: Push("flame") // @poff=1262
0x8fb: Push(CVector(0.0, 0.0, 0.0))
0x8fc: @ AddActorByType(Stack[-3], Stack[-2], Stack[-4], Stack[-1])
0x8fd: Pop(2)
0x8fe: PushEmpty(object)
0x8ff: Call2 0x76b

0x900: Pop(0)
0x901: Push("flame") // @poff=1262
0x902: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=1274
0x903: Pop(2)
0x904: Push(GlobalVars[3])
0x905: Stack[-1] = (bool) 0
0x906: GlobalVars[3] = Stack[-1]; Pop(1)
0x907: Push((float)0.05000000074505806)
0x908: @@ SetLength(Stack[-1]); Obj=2 // @poff=1281
0x909: Pop(1)
0x90a: Push(GlobalVars[0])
0x90b: Stack[-2] = Stack[-1]
0x90c: GlobalVars[0] = Stack[-1]; Pop(1)
0x90d: Push((int) 70)
0x90e: Push((float)0.10000000149011612)
0x90f: @ SetTimer(Stack[-2], Stack[-1])
0x910: Pop(2)
0x911: Return(); Pop(6)

0x912: Stack[-1] = 0
0x913: Stack[-2] = 0
0x914: PushEmpty(float, float, object, cvector, float, float, float, object, cvector, float)
0x915: Push(Stack[-11])
0x916: IF (Stack[-1] == 0) GOTO 0x91b; Pop(1)

0x917: Push(GlobalVars[2])
0x918: Stack[-1] = Stack[-6]
0x919: Pop(1)
0x91a: GOTO 0x91c

0x91b: Stack[-5] = (float) 0.05000000074505806
0x91c: Push(GlobalVars[0])
0x91d: @@ GetLength(Stack[-5]); Obj=1 // @poff=1291
0x91e: Pop(1)
0x91f: Pop(0); Push((bool) Stack[-5] < Stack[-4])
0x920: IF (Stack[-1] == 0) GOTO 0x922; Pop(1)

0x921: Stack[-5] = Stack[-4]
0x922: Push(GlobalVars[0])
0x923: @@ SetLength(Stack[-5]); Obj=1 // @poff=1281
0x924: Pop(1)
0x925: Push(GlobalVars[3])
0x926: Pop(1); Push((bool) Stack[-1] != Stack[-12])
0x927: IF (Stack[-1] == 0) GOTO 0x94b; Pop(1)

0x928: Push(Stack[-11])
0x929: IF (Stack[-1] == 0) GOTO 0x941; Pop(1)

0x92a: Push(GlobalVars[1])
0x92b: Pop(1); PushNull((bool) Stack[-1] == 0)
0x92c: IF (Stack[-1] == 0) GOTO 0x93c; Pop(1)

0x92d: Stack[-2] = CVector(0.0, 0.0, 0.0)
0x92e: @ GetHeight(Stack[-1])
0x92f: Pop(0)
0x930: Push(CvectorIndex(Stack[-2], 1))
0x931: Stack[-2] = Stack[-1]
0x932: CvectorIndex(Stack[-3], 1) = Stack[-1];
0x933: Push("flame_loop") // @poff=1301
0x934: Push((int) 0)
0x935: Push((int) 200)
0x936: @ PlayLoopedGlobalSound(Stack[-6], Stack[-3], Stack[-5], Stack[-2], Stack[-1])
0x937: Pop(3)
0x938: Push(GlobalVars[1])
0x939: Stack[-4] = Stack[-1]
0x93a: GlobalVars[1] = Stack[-1]; Pop(1)
0x93b: Stack[-3] = 0
0x93c: Push(GlobalVars[1])
0x93d: Push((int) 2)
0x93e: @@ FadeIn(Stack[-1]); Obj=2 // @poff=1323
0x93f: Pop(2)
0x940: GOTO 0x948

0x941: Push(GlobalVars[1])
0x942: Pop(1); Push(( Stack[-1] != 0 )
0x943: IF (Stack[-1] == 0) GOTO 0x948; Pop(1)

0x944: Push(GlobalVars[1])
0x945: Push((int) 2)
0x946: @@ FadeOut(Stack[-1]); Obj=2 // @poff=1330
0x947: Pop(2)
0x948: Push(GlobalVars[3])
0x949: Stack[-12] = Stack[-1]
0x94a: GlobalVars[3] = Stack[-1]; Pop(1)
0x94b: Return(); Pop(10)

0x94c: PushEmpty(cvector, float, cvector, float, bool, cvector, float, cvector, float, bool)
0x94d: @ GetPosition(Stack[-5])
0x94e: Pop(0)
0x94f: @ GetHeight(Stack[-4])
0x950: Pop(0)
0x951: Push(CvectorIndex(Stack[-5], 1))
0x952: Push((int) 2)
0x953: Pop(1); Push(Stack[-6] / Stack[-1]);
0x954: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x955: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x956: Stack[-3] = Stack[-11] - Stack[-5]; Pop(0);
0x957: Pop(0); Push(Stack[-3] | Stack[-3]);
0x958: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x959: Push((int) 50)
...
0x95e: Push(CvectorIndex(Stack[-3], 1))
0x95f: Pop(1); Push(Stack[-1] / Stack[-3]);
0x960: Push((float)-0.1428571492433548)
0x961: Stack[-3] = Stack[-2] < Stack[-1]; Pop(2);
0x962: Push("all") // @poff=54
0x963: Push(Stack[-2])
0x964: IF (Stack[-1] == 0) GOTO 0x967; Pop(1)

0x965: Push("cattack") // @poff=360
0x966: GOTO 0x968

0x967: Push("attack") // @poff=362
0x968: @ PlayAnimation(Stack[-2], Stack[-1])
0x969: Pop(2)
0x96a: Return(); Pop(10)

0x96b: PushEmpty(cvector, float, cvector, float)
0x96c: @@ GetPosition(Stack[-2]); Obj=5 // @poff=0
0x96d: Pop(0)
0x96e: Push("@GetHeight") // @poff=1338
0x96f: Push((int) 1)
0x970: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x971: IF (Stack[-1] == 0) GOTO 0x979; Pop(1)

0x972: @@ GetHeight(Stack[-1]); Obj=5 // @poff=1360
0x973: Pop(0)
0x974: Push(CvectorIndex(Stack[-2], 1))
0x975: Push((int) 2)
0x976: Pop(1); Push(Stack[-3] / Stack[-1]);
0x977: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x978: CvectorIndex(Stack[-3], 1) = Stack[-1];
0x979: PushEmpty(cvector)
0x97a: Stack[-3] = Stack[-1]
0x97b: Call2 0x94c

0x97c: Pop(1)
0x97d: Return(); Pop(4)

0x97e: PushEmpty(bool, float, float, string, float, bool, float, float, string, float)
0x97f: PushEmpty(bool, object)
0x980: Stack[-13] = Stack[-1]
0x981: Call2 0x614
...
0x985: Stack[-12] = (bool) 0
0x986: Return(); Pop(10)

0x987: Push(GlobalVars[4])
0x988: @@ in(Stack[-6], Stack[-12]); Obj=1 // @poff=1370
0x989: Pop(1)
0x98a: Push(Stack[-5])
0x98b: IF (Stack[-1] == 0) GOTO 0x98e; Pop(1)

0x98c: Stack[-12] = (bool) 1
0x98d: Return(); Pop(10)

0x98e: PushEmpty(bool, object)
0x98f: Stack[-13] = Stack[-1]
0x990: Call2 0x591

0x991: Pop(1)
0x992: IF (Stack[-1] == 0) GOTO 0x9a1; Pop(1)

0x993: Push("reputation") // @poff=1373
0x994: @@ GetProperty(Stack[-1], Stack[-5]); Obj=12 // @poff=376
0x995: Pop(1)
0x996: Push((float)0.33000001311302185)
0x997: Pop(1); Push((bool) Stack[-5] < Stack[-1])
0x998: IF (Stack[-1] == 0) GOTO 0x99b; Pop(1)

0x999: Stack[-12] = (bool) 1
0x99a: Return(); Pop(10)

0x99b: Push("disease") // @poff=264
0x99c: @@ GetProperty(Stack[-1], Stack[-4]); Obj=12 // @poff=376
0x99d: Pop(1)
0x99e: Push((float)0.33000001311302185)
0x99f: Stack[-13] = Stack[-4] > Stack[-1]; Pop(1);
0x9a0: Return(); Pop(10)

0x9a1: PushEmpty(bool, object, string)
0x9a2: Stack[-14] = Stack[-2]
0x9a3: Stack[-1] = "class" // @poff=1180
0x9a4: Call2 0x596

0x9a5: Pop(2)
0x9a6: Pop(1); Push((bool) Stack[-1] == 0)
0x9a7: IF (Stack[-1] == 0) GOTO 0x9aa; Pop(1)

0x9a8: Stack[-12] = (bool) 0
0x9a9: Return(); Pop(10)

0x9aa: Push("class") // @poff=1180
0x9ab: @@ GetProperty(Stack[-1], Stack[-3]); Obj=12 // @poff=376
0x9ac: Pop(1)
...
0x9b3: Push("bomber") // @poff=1395
0x9b4: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x9b5: IF (Stack[-1] == 1) GOTO 0x9ba; Pop(1)

0x9b6: Push("hunter") // @poff=1409
0x9b7: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x9b8: IF (Stack[-1] == 1) GOTO 0x9ba; Pop(1)

0x9b9: Stack[-1] = (bool) 0
0x9ba: IF (Stack[-1] == 1) GOTO 0x9bf; Pop(1)

0x9bb: Push("grabitel") // @poff=1423
0x9bc: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x9bd: IF (Stack[-1] == 1) GOTO 0x9bf; Pop(1)

0x9be: Stack[-1] = (bool) 0
0x9bf: IF (Stack[-1] == 1) GOTO 0x9c4; Pop(1)

0x9c0: Push("rat_big") // @poff=1441
0x9c1: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9c2: IF (Stack[-1] == 1) GOTO 0x9c4; Pop(1)

0x9c3: Stack[-1] = (bool) 0
0x9c4: IF (Stack[-1] == 0) GOTO 0x9c7; Pop(1)

0x9c5: Stack[-12] = (bool) 1
0x9c6: Return(); Pop(10)

0x9c7: PushEmpty(bool, object, string)
0x9c8: Stack[-14] = Stack[-2]
0x9c9: Stack[-1] = "disease" // @poff=264
0x9ca: Call2 0x596

0x9cb: Pop(2)
0x9cc: Pop(1); Push((bool) Stack[-1] == 0)
0x9cd: IF (Stack[-1] == 0) GOTO 0x9d0; Pop(1)

0x9ce: Stack[-12] = (bool) 0
0x9cf: Return(); Pop(10)

0x9d0: PushEmpty(bool)
0x9d1: Stack[-1] = (bool) 1
0x9d2: PushEmpty(bool, string)
0x9d3: Stack[-5] = Stack[-1]
0x9d4: Call2 0x714

0x9d5: Pop(1)
0x9d6: IF (Stack[-1] == 1) GOTO 0x9db; Pop(1)

0x9d7: Push("dog") // @poff=1457
0x9d8: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x9d9: IF (Stack[-1] == 1) GOTO 0x9db; Pop(1)

0x9da: Stack[-1] = (bool) 0
0x9db: IF (Stack[-1] == 0) GOTO 0x9e2; Pop(1)

0x9dc: Push("disease") // @poff=264
0x9dd: @@ GetProperty(Stack[-1], Stack[-2]); Obj=12 // @poff=376
0x9de: Pop(1)
0x9df: Push((int) 0)
0x9e0: Stack[-13] = Stack[-2] > Stack[-1]; Pop(1);
0x9e1: Return(); Pop(10)

0x9e2: Stack[-12] = (bool) 0
0x9e3: Return(); Pop(10)

0x9e4: PushEmpty()
0x9e5: PushEmpty(object, object)
0x9e6: Stack[-3] = Stack[-1]
0x9e7: Push(-2, 1); TaskCall(4)
0x9e8: Call2 0x35f

0x9e9: Pop(-2, 1); TaskReturn
0x9ea: Stack[-2] = Stack[-3]
0x9eb: Pop(2)
0x9ec: @ ResetAAS()
0x9ed: Pop(0)
...
0x9fb: IF (Stack[-1] == 0) GOTO 0xa04; Pop(1)

0x9fc: PushEmpty(object)
0x9fd: Stack[-2] = Stack[-1]
0x9fe: Push(-1, 2); TaskCall(6)
0x9ff: Call2 0x495

0xa00: Pop(-1, 2); TaskReturn
0xa01: Pop(1)
0xa02: @ ResetAAS()
0xa03: Pop(0)
0xa04: Return(); Pop(0)
...
0xa07: Stack[-3] = Stack[-1]
0xa08: Call2 0xb1d

0xa09: Stack[-2] = Stack[-4]
0xa0a: Pop(2)
0xa0b: Return(); Pop(0)

0xa0c: PushEmpty()
0xa0d: PushEmpty(object)
0xa0e: Stack[-2] = Stack[-1]
0xa0f: Call2 0x9e4
...
0xa16: Stack[-2] = Stack[-4]
0xa17: Pop(2)
0xa18: Return(); Pop(0)

0xa19: PushEmpty()
0xa1a: PushEmpty(object)
0xa1b: Stack[-2] = Stack[-1]
0xa1c: Call2 0x9e4
...
0xa24: Pop(0); PushNull((bool) Stack[-5] == 0)
0xa25: IF (Stack[-1] == 1) GOTO 0xa2d; Pop(1)

0xa26: PushEmpty(bool, object)
0xa27: Stack[-7] = Stack[-1]
0xa28: Call2 0x5eb

0xa29: Pop(1)
0xa2a: Pop(1); Push((bool) Stack[-1] == 0)
0xa2b: IF (Stack[-1] == 1) GOTO 0xa2d; Pop(1)

0xa2c: Stack[-1] = (bool) 0
0xa2d: IF (Stack[-1] == 1) GOTO 0xa36; Pop(1)

0xa2e: PushEmpty(bool, object, string)
0xa2f: Stack[-7] = Stack[-2]
0xa30: Stack[-1] = "disease" // @poff=264
0xa31: Call2 0x596

0xa32: Pop(2)
0xa33: Pop(1); Push((bool) Stack[-1] == 0)
0xa34: IF (Stack[-1] == 1) GOTO 0xa36; Pop(1)

0xa35: Stack[-1] = (bool) 0
0xa36: IF (Stack[-1] == 0) GOTO 0xa39; Pop(1)

0xa37: Stack[-4] = (bool) 0
0xa38: Return(); Pop(2)

0xa39: Push("disease") // @poff=264
0xa3a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=376
0xa3b: Pop(1)
0xa3c: Push((int) 0)
0xa3d: Stack[-5] = Stack[-2] > Stack[-1]; Pop(1);
0xa3e: Return(); Pop(2)

0xa3f: PushEmpty()
0xa40: PushEmpty(object)
0xa41: Stack[-2] = Stack[-1]
0xa42: Push(-1, 2); TaskCall(6)
0xa43: Call2 0x495

0xa44: Pop(-1, 2); TaskReturn
0xa45: Pop(1)
0xa46: @ ResetAAS()
0xa47: Pop(0)
0xa48: Return(); Pop(0)

0xa49: PushEmpty(bool, bool)
0xa4a: Pop(0); PushNull((bool) Stack[-3] == 0)
0xa4b: IF (Stack[-1] == 0) GOTO 0xa4d; Pop(1)

0xa4c: Return(); Pop(2)

0xa4d: Push(GlobalVars[4])
0xa4e: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=1370
0xa4f: Pop(1)
0xa50: Pop(0); Push((bool) Stack[-1] == 0)
0xa51: IF (Stack[-1] == 0) GOTO 0xa55; Pop(1)

0xa52: Push(GlobalVars[4])
0xa53: @@ add(Stack[-4]); Obj=1 // @poff=627
0xa54: Pop(1)
0xa55: PushEmpty(bool, object)
0xa56: Stack[-5] = Stack[-1]
0xa57: Call2 0x591
...
0xa5c: Pop(0)
0xa5d: Push((float)-0.07000000029802322)
0xa5e: @ ReportReputationChange(Stack[-5], Stack[-2], Stack[-1])
0xa5f: Pop(2)
0xa60: Return(); Pop(2)

0xa61: PushEmpty()
0xa62: PushEmpty(object)
0xa63: Stack[-2] = Stack[-1]
0xa64: Call2 0xa49
...
0xa6e: Pop(0)
0xa6f: Push((float)-0.12999999523162842)
0xa70: Push((bool) 1)
0xa71: @ ReportReputationChange(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xa72: Pop(3)
0xa73: PushEmpty(object)
0xa74: Stack[-2] = Stack[-1]
0xa75: Push(-1, 0); TaskCall(5)
0xa76: Call2 0x3e7

0xa77: Pop(-1, 0); TaskReturn
0xa78: Pop(1)
0xa79: Return(); Pop(0)

0xa7a: PushEmpty()
0xa7b: PushEmpty(object, int, float)
0xa7c: Stack[-7] = Stack[-3]
0xa7d: Stack[-6] = Stack[-2]
0xa7e: Stack[-5] = Stack[-1]
0xa7f: Call2 0x67a
...
0xa84: Stack[-11] = Stack[-5]
0xa85: Stack[-10] = Stack[-4]
0xa86: Stack[-9] = Stack[-3]
0xa87: Stack[-7] = Stack[-2]
0xa88: Stack[-6] = Stack[-1]
0xa89: Call2 0x6be
...
0xa8d: Push("health") // @poff=491
0xa8e: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa8f: IF (Stack[-1] == 0) GOTO 0xa98; Pop(1)

0xa90: Push("health") // @poff=491
0xa91: @ GetProperty(Stack[-1], Stack[-2])
0xa92: Pop(1)
0xa93: Push((int) 0)
0xa94: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0xa95: IF (Stack[-1] == 0) GOTO 0xa98; Pop(1)

0xa96: @ SignalDeath(Stack[-4])
0xa97: Pop(0)
0xa98: Return(); Pop(2)

0xa99: PushEmpty()
0xa9a: PushEmpty(object)
0xa9b: Stack[-2] = Stack[-1]
0xa9c: Call2 0xa6b
...
0xaa0: PushEmpty(bool, object, bool)
0xaa1: Stack[-7] = Stack[-2]
0xaa2: Stack[-1] = !Stack[-6]; Pop(0);
0xaa3: Call2 0x863

0xaa4: Pop(2)
0xaa5: IF (Stack[-1] == 0) GOTO 0xab7; Pop(1)

0xaa6: @ CanSee(Stack[-1], Stack[-5])
0xaa7: Pop(0)
0xaa8: PushEmpty(bool)
0xaa9: Stack[-1] = (bool) 1
0xaaa: Push(Stack[-2])
0xaab: IF (Stack[-1] == 1) GOTO 0xab4; Pop(1)

0xaac: PushEmpty(float, object)
0xaad: Stack[-8] = Stack[-1]
0xaae: Call2 0x589

0xaaf: Pop(1)
0xab0: Push((float)490000.0)
0xab1: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xab2: IF (Stack[-1] == 1) GOTO 0xab4; Pop(1)

0xab3: Stack[-1] = (bool) 0
0xab4: IF (Stack[-1] == 0) GOTO 0xab7; Pop(1)

0xab5: Stack[-6] = (bool) 1
0xab6: Return(); Pop(2)

0xab7: Stack[-6] = (bool) 0
0xab8: Return(); Pop(2)

0xab9: PushEmpty(object, float, object, bool, string, float, float, float, object, float, object, bool, string, float, float, float)
0xaba: Push((int) 70)
0xabb: Pop(1); Push((bool) Stack[-18] != Stack[-1])
0xabc: IF (Stack[-1] == 0) GOTO 0xabe; Pop(1)

0xabd: Return(); Pop(16)

0xabe: Push(GlobalVars[0])
0xabf: Pop(1); PushNull((bool) Stack[-1] == 0)
0xac0: IF (Stack[-1] == 0) GOTO 0xac2; Pop(1)

0xac1: Return(); Pop(16)

0xac2: Push(GlobalVars[0])
0xac3: @@ Intersect(Stack[-9], Stack[-8]); Obj=1 // @poff=1465
0xac4: Pop(1)
0xac5: Push(GlobalVars[0])
0xac6: Push(GlobalVars[3])
0xac7: IF (Stack[-1] == 0) GOTO 0xad0; Pop(1)

0xac8: PushEmpty(float, float, float)
0xac9: Stack[-11] = Stack[-2]
0xaca: Push(GlobalVars[2])
0xacb: Stack[-1] = Stack[-2]
0xacc: Pop(1)
0xacd: Call2 0x77b
...
0xad0: Push((float)0.05000000074505806)
0xad1: @@ SetLength(Stack[-1]); Obj=2 // @poff=1281
0xad2: Pop(2)
0xad3: PushEmpty()
0xad4: Call2 0x7b2

0xad5: Pop(0)
0xad6: @@ Next(Stack[-5], Stack[-6]); Obj=8 // @poff=1475
0xad7: Pop(0)
0xad8: Push(Stack[-5])
0xad9: IF (Stack[-1] == 0) GOTO 0xb1a; Pop(1)

0xada: PushEmpty(bool)
0xadb: Stack[-1] = (bool) 0
0xadc: Pop(0); Push(( Stack[-7] != 0 )
...
0xae0: Pop(0)
0xae1: Pop(1); Push((bool) Stack[-8] != Stack[-1])
0xae2: IF (Stack[-1] == 0) GOTO 0xae4; Pop(1)

0xae3: Stack[-1] = (bool) 1
0xae4: IF (Stack[-1] == 0) GOTO 0xb19; Pop(1)

0xae5: PushEmpty(bool, object, string)
0xae6: Stack[-9] = Stack[-2]
0xae7: Stack[-1] = "class" // @poff=1180
0xae8: Call2 0x596

0xae9: Pop(2)
0xaea: IF (Stack[-1] == 0) GOTO 0xaee; Pop(1)

0xaeb: Push("class") // @poff=1180
0xaec: @@ GetProperty(Stack[-1], Stack[-5]); Obj=7 // @poff=376
0xaed: Pop(1)
0xaee: Push("sanitar") // @poff=1206
0xaef: Pop(1); Push((bool) Stack[-5] != Stack[-1])
0xaf0: IF (Stack[-1] == 0) GOTO 0xb19; Pop(1)

0xaf1: PushEmpty(float, object, float, int)
0xaf2: Stack[-10] = Stack[-3]
0xaf3: Stack[-2] = (float) 0.10000000149011612
0xaf4: Stack[-1] = (int) 2
0xaf5: Call2 0x5a2

0xaf6: Stack[-4] = Stack[-7]
0xaf7: Pop(4)
0xaf8: PushEmpty(bool, object, string)
0xaf9: Stack[-9] = Stack[-2]
0xafa: Stack[-1] = "disease" // @poff=264
0xafb: Call2 0x596

0xafc: Pop(2)
0xafd: IF (Stack[-1] == 0) GOTO 0xb0b; Pop(1)

0xafe: Push("disease") // @poff=264
0xaff: @@ GetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=376
0xb00: Pop(1)
0xb01: Push((float)0.10000000149011612)
...
0xb06: Push((float)0.10000000149011612)
0xb07: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0xb08: Push("disease") // @poff=264
0xb09: @@ SetProperty(Stack[-1], Stack[-3]); Obj=7 // @poff=298
0xb0a: Pop(1)
0xb0b: PushEmpty(bool, object, string)
0xb0c: Stack[-9] = Stack[-2]
0xb0d: Stack[-1] = "fire" // @poff=421
0xb0e: Call2 0x596

0xb0f: Pop(2)
0xb10: IF (Stack[-1] == 0) GOTO 0xb19; Pop(1)

0xb11: Push("fire") // @poff=421
0xb12: @@ GetProperty(Stack[-1], Stack[-2]); Obj=7 // @poff=376
0xb13: Pop(1)
0xb14: Push("fire") // @poff=421
0xb15: Push((float)0.10000000149011612)
0xb16: Pop(1); Push(Stack[-3] + Stack[-1]);
0xb17: @@ SetProperty(Stack[-2], Stack[-1]); Obj=8 // @poff=298
0xb18: Pop(2)
0xb19: GOTO 0xad6
...
0xb1f: Stack[-3] = Stack[-1]
0xb20: Call2 0x97e

0xb21: Stack[-2] = Stack[-4]
0xb22: Pop(2)
0xb23: Return(); Pop(0)
