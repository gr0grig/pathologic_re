...
0x57: Pop(0)
0x58: Push((float)0.30000001192092896)
...
0x6c: Stack[-1] = "quest_d8_02" // @poff=158
0x6d: Call2 0x9c
...
0x71: Pop(0)
0x72: Push((float)0.30000001192092896)
...
0x84: @ RemoveActor(Stack[-2]T)
0x85: Pop(0)
0x86: Push( Stack[3 + Tasks[-1].StackPointer] )
0x87: IF (Stack[-1] == 0) GOTO 0x8a; Pop(1)

0x88: @ RemoveActor(Stack[-3]T)
0x89: Pop(0)
0x8a: Return(); Pop(0)

0x8b: PushEmpty()
0x8c: Push("noeva") // @poff=182
...
0xbd: Stack[-5] = Stack[-1]
0xbe: Call2 0xcb

0xbf: Stack[-4] = Stack[-6]
0xc0: Pop(4)
0xc1: Return(); Pop(0)
...
0xc6: Stack[-5] = Stack[-1]
0xc7: Call2 0xcb

0xc8: Stack[-4] = Stack[-6]
0xc9: Pop(4)
0xca: Return(); Pop(0)
