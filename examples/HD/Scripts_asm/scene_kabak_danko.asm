...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x91: @ CreateObjectVector(Stack[-0]T)
0x92: Pop(0)
0x93: @ CreateObjectVector(Stack[-1]T)
0x94: Pop(0)
0x95: @ Hold()
0x96: Pop(0)
0x97: GOTO 0x95
...
0x9a: Stack[-5] = (int) 1
0x9b: Push("pt_fireplace") // @poff=504
...
0xd6: Pop(1)
0xd7: @@ GetItemCount(Stack[-4], Stack[-12]); Obj=13 // @poff=576
0xd8: Pop(0)
0xd9: Stack[-3] = (int) 0
0xda: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0xdb: IF (Stack[-1] == 0) GOTO 0xe8; Pop(1)

0xdc: @@ GetItem(Stack[-2], Stack[-3], Stack[-12]); Obj=13 // @poff=589
0xdd: Pop(0)
0xde: @@ add(Stack[-2]); Obj=5 // @poff=84
0xdf: Pop(0)
0xe0: @@ GetItemAmount(Stack[-1], Stack[-3], Stack[-12]); Obj=13 // @poff=597
0xe1: Pop(0)
0xe2: @@ add(Stack[-1]); Obj=11 // @poff=84
0xe3: Pop(0)
0xe4: Stack[-2] = 0
0xe5: Push((int) 1)
...
0xed: Pop(0)
0xee: @@ GetItemCount(Stack[-3], Stack[-9]); Obj=10 // @poff=576
0xef: Pop(0)
0xf0: Stack[-2] = (int) 0
0xf1: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0xf2: IF (Stack[-1] == 0) GOTO 0xfc; Pop(1)

0xf3: @@ IsItemSelected(Stack[-1], Stack[-2], Stack[-9]); Obj=10 // @poff=611
0xf4: Pop(0)
0xf5: Push(Stack[-1])
0xf6: IF (Stack[-1] == 0) GOTO 0xf9; Pop(1)

0xf7: @@ add(Stack[-2]); Obj=4 // @poff=84
0xf8: Pop(0)
0xf9: Push((int) 1)
0xfa: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0xfb: GOTO 0xf1

0xfc: Stack[-4] = Stack[-11]
0xfd: Return(); Pop(8)

0xfe: Stack[-4] = 0
0xff: PushEmpty(int, int, object, int, bool, int, int, int, int, object, int, bool, int, int)
0x100: @@ RemoveAllItems(Stack[-18]); Obj=19 // @poff=626
0x101: Pop(0)
0x102: @@ size(Stack[-7]); Obj=17 // @poff=641
0x103: Pop(0)
0x104: Stack[-6] = (int) 0
0x105: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x106: IF (Stack[-1] == 0) GOTO 0x111; Pop(1)

0x107: @@ get(Stack[-5], Stack[-6]); Obj=17 // @poff=646
0x108: Pop(0)
0x109: @@ get(Stack[-4], Stack[-6]); Obj=16 // @poff=646
0x10a: Pop(0)
0x10b: @@ AddItem(Stack[-3], Stack[-5], Stack[-18], Stack[-4]); Obj=19 // @poff=650
0x10c: Pop(0)
0x10d: Stack[-5] = 0
0x10e: Push((int) 1)
...
0x111: @@ size(Stack[-7]); Obj=15 // @poff=641
0x112: Pop(0)
0x113: Stack[-2] = (int) 0
0x114: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x115: IF (Stack[-1] == 0) GOTO 0x11e; Pop(1)

0x116: @@ get(Stack[-1], Stack[-2]); Obj=15 // @poff=646
0x117: Pop(0)
0x118: Push((bool) 1)
0x119: @@ SelectItem(Stack[-2], Stack[-1], Stack[-19]); Obj=20 // @poff=658
0x11a: Pop(1)
0x11b: Push((int) 1)
...
0x12c: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=669
0x12d: Pop(0)
0x12e: Pop(0); Push((bool) Stack[-4] == 0)
0x12f: IF (Stack[-1] == 0) GOTO 0x138; Pop(1)

0x130: Push("Locator ") // @poff=680
0x131: Pop(1); Push(Stack[-1] + Stack[-12]);
0x132: Push(" doesn't exist") // @poff=698
...
0x148: @@ size(Stack[-3]); Obj=7 // @poff=641
0x149: Pop(0)
0x14a: Stack[-2] = (int) 0
0x14b: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x14c: IF (Stack[-1] == 0) GOTO 0x157; Pop(1)

0x14d: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=646
0x14e: Pop(0)
0x14f: Push(Stack[-1])
