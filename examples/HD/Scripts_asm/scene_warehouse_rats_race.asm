...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x12: Pop(1)
0x13: Stack[-3] = "pt_manager" // @poff=0
0x14: Stack[-2] = "pers_doberman" // @poff=22
0x15: Stack[-1] = "rats_manager.xml" // @poff=50
0x16: Call2 0x1f
...
0x20: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=84
0x21: Pop(0)
0x22: Pop(0); Push((bool) Stack[-4] == 0)
0x23: IF (Stack[-1] == 0) GOTO 0x2c; Pop(1)

0x24: Push("Locator ") // @poff=95
0x25: Pop(1); Push(Stack[-1] + Stack[-12]);
0x26: Push(" doesn't exist") // @poff=113
