...
Strings:
	...
	W:door_closed
	W:Door is locked
// @pool_raw:6b006500790000004765744974656d436f756e744f66547970650064006f006f0072005f0063006c006f00730065006400000044006f006f00720020006900730020006c006f0063006b00650064000000
...
0x7: Pop(1)
0x8: @@ GetItemCountOfType(Stack[-1], Stack[-2]); Obj=5 // @poff=8
0x9: Pop(0)
0xa: Push(Stack[-1])
...
0x23: Push("door_closed") // @poff=27
0x24: @ PlaySound(Stack[-1])
0x25: Pop(1)
0x26: Push("Door is locked") // @poff=51
0x27: @ Trace(Stack[-1])
0x28: Pop(1)
0x29: Return(); Pop(4)
...
0x4b: IF (Stack[-1] == 1) GOTO 0x53; Pop(1)
