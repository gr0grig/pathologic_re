...
0x334: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x335: Pop(1)
...
0x359: Stack[-7] = Stack[-3]
0x35a: Stack[-6] = Stack[-2]
...
0x373: @ GetPFPosition(Stack[-1]T)
0x374: Pop(0)
0x375: @ GetDirection(Stack[-0]T)
0x376: Pop(0)
0x377: PushEmpty()
0x378: Call2 0x3cb
...
0x394: @ FindPathTo(Stack[-1], Stack[-1]T)
0x395: Pop(0)
...
0x3a3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3a4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3b6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3b7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3d6: Stack[-2] = "bullet" // @poff=529
0x3d7: Return(); Pop(0)

0x3d8: Stack[-2] = "phys" // @poff=543
0x3d9: Return(); Pop(0)

0x3da: PushEmpty(cvector, cvector, cvector, cvector)
0x3db: @ GetPosition(Stack[-2])
0x3dc: Pop(0)
0x3dd: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x3de: Pop(0)
...
0x3e3: Pop(0)
0x3e4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x3e5: Pop(0)
...
0x3eb: Pop(0)
0x3ec: Stack[-1] = Stack[-4]
0x3ed: Return(); Pop(2)

0x3ee: PushEmpty(bool, bool)
0x3ef: Push("HasProperty") // @poff=553
0x3f0: Push((int) 2)
...
0x3f6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=577
0x3f7: Pop(0)
...
0x3fc: Stack[-18] = Stack[-2]
0x3fd: Stack[-1] = "health" // @poff=589
0x3fe: Call2 0x3ee
...
0x405: Stack[-18] = Stack[-2]
0x406: Stack[-1] = "armor" // @poff=603
0x407: Call2 0x3ee
...
0x40d: Push("armor") // @poff=603
0x40e: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=615
0x40f: Pop(1)
0x410: Push("armor_") // @poff=627
0x411: PushEmpty(string, int)
0x412: Stack[-16] = Stack[-1]
0x413: Call2 0x3cc

0x414: Pop(1)
0x415: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x416: PushEmpty(bool, object, string)
0x417: Stack[-18] = Stack[-2]
0x418: Stack[-8] = Stack[-1]
0x419: Call2 0x3ee
...
0x41f: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=615
0x420: Pop(0)
...
0x427: Stack[-3] = Stack[-6]
0x428: Pop(3)
0x429: Push("health") // @poff=589
0x42a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=615
0x42b: Pop(1)
0x42c: Push((int) 1)
0x42d: Pop(1); Push(Stack[-1] - Stack[-4]);
0x42e: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x42f: Push("health") // @poff=589
...
0x435: Pop(3)
0x436: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=641
0x437: Pop(2)
0x438: PushEmpty(bool, object)
0x439: Stack[-17] = Stack[-1]
0x43a: Call2 0x3e9
...
0x440: Pop(1)
0x441: Stack[-1] = Stack[-16]
0x442: Return(); Pop(12)

0x443: PushEmpty(bool, bool)
0x444: @@ IsDead(Stack[-1]); Obj=3 // @poff=653
0x445: Pop(0)
0x446: Stack[-1] = Stack[-4]
0x447: Return(); Pop(2)

0x448: PushEmpty(object, object, object, object)
0x449: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x45d: Pop(0)
0x45e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x45f: IF (Stack[-1] == 0) GOTO 0x462; Pop(1)

0x460: Stack[-6] = (bool) 0
0x461: Return(); Pop(4)

0x462: @@ GetScene(Stack[-1]); Obj=5 // @poff=674
0x463: Pop(0)
...
0x476: Stack[-6] = Stack[-2]
0x477: Stack[-1] = "noaccess" // @poff=683
0x478: Call2 0x3ee
...
0x47e: Push("noaccess") // @poff=683
0x47f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=615
0x480: Pop(1)
0x481: Push((int) 0)
...
0x485: Pop(0); PushNull((bool) Stack[-15] == 0)
...
0x493: @@ GetPosition(Stack[-5]); Obj=15 // @poff=10
0x494: Pop(0)
...
0x4a4: Stack[-1] = "fhit" // @poff=701
0x4a5: GOTO 0x4a7

0x4a6: Stack[-1] = "bhit" // @poff=711
0x4a7: Push("hit_react") // @poff=721
0x4a8: Push("1") // @poff=330
0x4a9: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4aa: Push("2") // @poff=741
...
0x4c3: Stack[-25] = Stack[-1]
0x4c4: Call2 0x3da

0x4c5: Stack[-2] = Stack[-3]
0x4c6: Pop(2)
0x4c7: Call2 0x5b4

0x4c8: Stack[-2] = Stack[-11]
0x4c9: Pop(2)
0x4ca: @ CreateVectorVector(Stack[-8])
0x4cb: Pop(0)
0x4cc: Stack[-7] = (int) 1
0x4cd: Push("hit") // @poff=703
...
0x4e2: Pop(0)
0x4e3: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=754
0x4e4: Pop(0)
0x4e5: PushEmpty(object, int, float, cvector, cvector)
0x4e6: Stack[-26] = Stack[-5]
0x4e7: Stack[-25] = Stack[-4]
0x4e8: Stack[-24] = Stack[-3]
0x4e9: Stack[-6] = Stack[-2]
...
0x503: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x504: Pop(0)
...
0x50f: Pop(0)
0x510: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x511: Pop(0)
...
0x521: Stack[-10] = Stack[-2]
0x522: Stack[-9] = Stack[-1]
0x523: Call2 0x5d4
...
0x56f: Push("woman") // @poff=786
0x570: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x571: IF (Stack[-1] == 1) GOTO 0x576; Pop(1)

0x572: Push("worker") // @poff=798
0x573: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x574: IF (Stack[-1] == 1) GOTO 0x576; Pop(1)

0x575: Stack[-1] = (bool) 0
0x576: IF (Stack[-1] == 1) GOTO 0x57b; Pop(1)

0x577: Push("butcher") // @poff=812
0x578: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x579: IF (Stack[-1] == 1) GOTO 0x57b; Pop(1)

0x57a: Stack[-1] = (bool) 0
0x57b: IF (Stack[-1] == 1) GOTO 0x580; Pop(1)

0x57c: Push("wasted_girl") // @poff=828
0x57d: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x57e: IF (Stack[-1] == 1) GOTO 0x580; Pop(1)

0x57f: Stack[-1] = (bool) 0
0x580: IF (Stack[-1] == 1) GOTO 0x585; Pop(1)

0x581: Push("boy") // @poff=852
0x582: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x583: IF (Stack[-1] == 1) GOTO 0x585; Pop(1)

0x584: Stack[-1] = (bool) 0
0x585: IF (Stack[-1] == 1) GOTO 0x58a; Pop(1)

0x586: Push("vaxxabitka") // @poff=860
0x587: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x588: IF (Stack[-1] == 1) GOTO 0x58a; Pop(1)

0x589: Stack[-1] = (bool) 0
0x58a: IF (Stack[-1] == 1) GOTO 0x58f; Pop(1)

0x58b: Push("unosha") // @poff=882
0x58c: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x58d: IF (Stack[-1] == 1) GOTO 0x58f; Pop(1)

0x58e: Stack[-1] = (bool) 0
0x58f: IF (Stack[-1] == 1) GOTO 0x594; Pop(1)

0x590: Push("wasted_male") // @poff=896
0x591: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x592: IF (Stack[-1] == 1) GOTO 0x594; Pop(1)

0x593: Stack[-1] = (bool) 0
0x594: IF (Stack[-1] == 1) GOTO 0x599; Pop(1)

0x595: Push("alkash") // @poff=920
0x596: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x597: IF (Stack[-1] == 1) GOTO 0x599; Pop(1)

0x598: Stack[-1] = (bool) 0
0x599: IF (Stack[-1] == 1) GOTO 0x59e; Pop(1)

0x59a: Push("dohodyaga") // @poff=934
0x59b: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x59c: IF (Stack[-1] == 1) GOTO 0x59e; Pop(1)

0x59d: Stack[-1] = (bool) 0
0x59e: IF (Stack[-1] == 1) GOTO 0x5a3; Pop(1)

0x59f: Push("vaxxabit") // @poff=954
0x5a0: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x5a1: IF (Stack[-1] == 1) GOTO 0x5a3; Pop(1)

0x5a2: Stack[-1] = (bool) 0
0x5a3: IF (Stack[-1] == 1) GOTO 0x5a8; Pop(1)

0x5a4: Push("nudegirl") // @poff=972
0x5a5: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5a6: IF (Stack[-1] == 1) GOTO 0x5a8; Pop(1)

0x5a7: Stack[-1] = (bool) 0
0x5a8: IF (Stack[-1] == 1) GOTO 0x5ad; Pop(1)

0x5a9: Push("morlok") // @poff=990
0x5aa: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x5ab: IF (Stack[-1] == 1) GOTO 0x5ad; Pop(1)
...
0x5b7: Push((float)9.999999974752427e-07)
...
0x63e: Push("GenerateMoney: iMin > iMax") // @poff=1032
0x63f: @ Trace(Stack[-1])
0x640: Pop(1)
0x641: Return(); Pop(4)
...
0x65c: Pop(0)
0x65d: @@ SetItemName(Stack[-7]); Obj=3 // @poff=1098
0x65e: Pop(0)
0x65f: Push("Organ") // @poff=1110
0x660: Push((int) 1)
0x661: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=641
0x662: Pop(2)
0x663: @@ GetItemID(Stack[-2]); Obj=3 // @poff=1122
0x664: Pop(0)
0x665: Push((int) 0)
0x666: Push((int) 1)
...
0x673: Stack[-1] = "liver" // @poff=1132
0x674: Call2 0x65a

0x675: Pop(1)
0x676: PushEmpty(string)
0x677: Stack[-1] = "kidney" // @poff=1144
0x678: Call2 0x65a

0x679: Pop(1)
0x67a: PushEmpty(string)
0x67b: Stack[-1] = "heart" // @poff=1158
0x67c: Call2 0x65a

0x67d: Pop(1)
0x67e: PushEmpty(string)
0x67f: Stack[-1] = "blood" // @poff=1170
0x680: Call2 0x65a
...
0x68d: Stack[-4] = "rifle_ammo" // @poff=1182
0x68e: Stack[-3] = (int) 1
0x68f: Stack[-2] = (int) 3
0x690: Stack[-1] = (int) 3
0x691: Call2 0x51f
...
0x69b: Stack[-3] = "bandage" // @poff=1214
0x69c: Stack[-2] = (int) 1
0x69d: Stack[-1] = (int) 6
0x69e: Call2 0x514
...
0x6a1: Stack[-3] = "tourniquet" // @poff=1230
0x6a2: Stack[-2] = (int) 1
0x6a3: Stack[-1] = (int) 6
0x6a4: Call2 0x514
...
0x6b6: Stack[-7] = Stack[-3]
0x6b7: Stack[-6] = Stack[-2]
0x6b8: Stack[-5] = Stack[-1]
0x6b9: Call2 0x4b0
...
0x6be: Stack[-11] = Stack[-5]
0x6bf: Stack[-10] = Stack[-4]
0x6c0: Stack[-9] = Stack[-3]
0x6c1: Stack[-7] = Stack[-2]
0x6c2: Stack[-6] = Stack[-1]
0x6c3: Call2 0x4f4
...
0x6db: Pop(0)
0x6dc: Push((float)-0.12999999523162842)
0x6dd: Push((bool) 1)
...
0x6e7: Stack[-7] = Stack[-2]
0x6e8: Stack[-1] = "class" // @poff=1252
0x6e9: Call2 0x3ee
...
0x6ef: Push("class") // @poff=1252
0x6f0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=615
0x6f1: Pop(1)
...
0x706: Push("patrol") // @poff=1264
0x707: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x708: IF (Stack[-1] == 1) GOTO 0x70d; Pop(1)

0x709: Push("sanitar") // @poff=1278
0x70a: Pop(1); Push((bool) Stack[-12] == Stack[-1])
0x70b: IF (Stack[-1] == 1) GOTO 0x70d; Pop(1)

0x70c: Stack[-1] = (bool) 0
0x70d: IF (Stack[-1] == 1) GOTO 0x712; Pop(1)

0x70e: Push("soldier") // @poff=1294
0x70f: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x710: IF (Stack[-1] == 1) GOTO 0x712; Pop(1)

0x711: Stack[-1] = (bool) 0
0x712: IF (Stack[-1] == 1) GOTO 0x717; Pop(1)

0x713: Push("woman") // @poff=786
0x714: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x715: IF (Stack[-1] == 1) GOTO 0x717; Pop(1)

0x716: Stack[-1] = (bool) 0
0x717: IF (Stack[-1] == 1) GOTO 0x71c; Pop(1)

0x718: Push("wasted_girl") // @poff=828
0x719: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x71a: IF (Stack[-1] == 1) GOTO 0x71c; Pop(1)

0x71b: Stack[-1] = (bool) 0
0x71c: IF (Stack[-1] == 1) GOTO 0x721; Pop(1)

0x71d: Push("vaxxabitka") // @poff=860
0x71e: Pop(1); Push((bool) Stack[-8] == Stack[-1])
0x71f: IF (Stack[-1] == 1) GOTO 0x721; Pop(1)

0x720: Stack[-1] = (bool) 0
0x721: IF (Stack[-1] == 1) GOTO 0x726; Pop(1)

0x722: Push("vaxxabit") // @poff=954
0x723: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x724: IF (Stack[-1] == 1) GOTO 0x726; Pop(1)

0x725: Stack[-1] = (bool) 0
0x726: IF (Stack[-1] == 1) GOTO 0x72b; Pop(1)

0x727: Push("little_girl") // @poff=1310
0x728: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x729: IF (Stack[-1] == 1) GOTO 0x72b; Pop(1)

0x72a: Stack[-1] = (bool) 0
0x72b: IF (Stack[-1] == 1) GOTO 0x730; Pop(1)

0x72c: Push("girl") // @poff=842
0x72d: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x72e: IF (Stack[-1] == 1) GOTO 0x730; Pop(1)

0x72f: Stack[-1] = (bool) 0
0x730: IF (Stack[-1] == 1) GOTO 0x735; Pop(1)

0x731: Push("dohodyaga") // @poff=934
0x732: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x733: IF (Stack[-1] == 1) GOTO 0x735; Pop(1)

0x734: Stack[-1] = (bool) 0
0x735: IF (Stack[-1] == 1) GOTO 0x73a; Pop(1)

0x736: Push("nudegirl") // @poff=972
0x737: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x738: IF (Stack[-1] == 1) GOTO 0x73a; Pop(1)
...
0x74c: Push("worker") // @poff=798
0x74d: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x74e: IF (Stack[-1] == 1) GOTO 0x753; Pop(1)

0x74f: Push("butcher") // @poff=812
0x750: Pop(1); Push((bool) Stack[-7] == Stack[-1])
0x751: IF (Stack[-1] == 1) GOTO 0x753; Pop(1)

0x752: Stack[-1] = (bool) 0
0x753: IF (Stack[-1] == 1) GOTO 0x758; Pop(1)

0x754: Push("boy") // @poff=852
0x755: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x756: IF (Stack[-1] == 1) GOTO 0x758; Pop(1)

0x757: Stack[-1] = (bool) 0
0x758: IF (Stack[-1] == 1) GOTO 0x75d; Pop(1)

0x759: Push("unosha") // @poff=882
0x75a: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x75b: IF (Stack[-1] == 1) GOTO 0x75d; Pop(1)

0x75c: Stack[-1] = (bool) 0
0x75d: IF (Stack[-1] == 1) GOTO 0x762; Pop(1)

0x75e: Push("wasted_male") // @poff=896
0x75f: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x760: IF (Stack[-1] == 1) GOTO 0x762; Pop(1)

0x761: Stack[-1] = (bool) 0
0x762: IF (Stack[-1] == 1) GOTO 0x767; Pop(1)

0x763: Push("alkash") // @poff=920
...
0x776: Stack[-4] = Stack[-2]
0x777: Stack[-3] = Stack[-1]
...
0x792: Pop(0)
0x793: Push((float)-0.07000000029802322)
...
0x7a4: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x7a5: Pop(1)
0x7a6: Push(Stack[-1])
...
0x7c9: Stack[-9] = Stack[-1]
0x7ca: Call2 0x3e9

0x7cb: Pop(1)
0x7cc: IF (Stack[-1] == 0) GOTO 0x7d3; Pop(1)

0x7cd: Push("reputation") // @poff=1334
0x7ce: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=615
0x7cf: Pop(1)
0x7d0: Push((float)0.33000001311302185)
0x7d1: Stack[-9] = Stack[-4] < Stack[-1]; Pop(1);
0x7d2: Return(); Pop(6)

0x7d3: PushEmpty(bool, object, string)
0x7d4: Stack[-10] = Stack[-2]
0x7d5: Stack[-1] = "class" // @poff=1252
0x7d6: Call2 0x3ee
...
0x7dc: Push("class") // @poff=1252
0x7dd: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=615
0x7de: Pop(1)
0x7df: PushEmpty(bool)
0x7e0: Stack[-1] = (bool) 1
0x7e1: PushEmpty(bool)
0x7e2: Stack[-1] = (bool) 1
0x7e3: Push("bomber") // @poff=1356
0x7e4: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7e5: IF (Stack[-1] == 1) GOTO 0x7ea; Pop(1)

0x7e6: Push("hunter") // @poff=1370
0x7e7: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x7e8: IF (Stack[-1] == 1) GOTO 0x7ea; Pop(1)

0x7e9: Stack[-1] = (bool) 0
0x7ea: IF (Stack[-1] == 1) GOTO 0x7ef; Pop(1)

0x7eb: Push("grabitel") // @poff=1384
...
0x7f4: Stack[-1] = "disease" // @poff=1402
0x7f5: Call2 0x3ee
...
0x7fe: Stack[-5] = Stack[-1]
0x7ff: Call2 0x557

0x800: Pop(1)
0x801: IF (Stack[-1] == 1) GOTO 0x806; Pop(1)

0x802: Push("dog") // @poff=1418
0x803: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x804: IF (Stack[-1] == 1) GOTO 0x806; Pop(1)

0x805: Stack[-1] = (bool) 0
0x806: IF (Stack[-1] == 0) GOTO 0x80d; Pop(1)

0x807: Push("disease") // @poff=1402
0x808: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=615
0x809: Pop(1)
0x80a: Push((int) 0)
...
0x819: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x81a: Pop(1)
0x81b: Push(Stack[-1])
...
0x836: Push(Stack[-2])
0x837: IF (Stack[-1] == 1) GOTO 0x840; Pop(1)

0x838: PushEmpty(float, object)
0x839: Stack[-8] = Stack[-1]
0x83a: Call2 0x3e1

0x83b: Pop(1)
0x83c: Push((float)490000.0)
0x83d: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x83e: IF (Stack[-1] == 1) GOTO 0x840; Pop(1)
...
0x855: Pop(0)
0x856: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1426
0x857: Pop(1)
0x858: Stack[-1] = 0
