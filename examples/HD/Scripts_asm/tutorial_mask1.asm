...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x1ad: Stack[-1] = "cleanup" // @poff=156
0x1ae: Call2 0x1b1
...
0x1bf: Push("tutorial_light_1") // @poff=172
0x1c0: @ FindActor(Stack[-2], Stack[-1])
0x1c1: Pop(1)
0x1c2: @@ Switch(Stack[-3]); Obj=1 // @poff=206
0x1c3: Pop(0)
0x1c4: Return(); Pop(2)
...
0x26a: @@ GetPosition(Stack[-8]); Obj=20 // @poff=213
0x26b: Pop(0)
0x26c: @@ GetEyesHeight(Stack[-9]); Obj=20 // @poff=225
0x26d: Pop(0)
...
0x293: Pop(0)
0x294: Push((bool) 1)
0x295: @ CameraTransit(Stack[-4], Stack[-6], Stack[-1])
0x296: Pop(1)
0x297: Push(CvectorIndex(Stack[-4], 0))
0x298: Push(CvectorIndex(Stack[-5], 2))
0x299: @ Rotate(Stack[-2], Stack[-1])
0x29a: Pop(2)
...
0x2a0: Push("head") // @poff=239
0x2a1: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2a2: Pop(1)
0x2a3: Push(Stack[-1])
0x2a4: IF (Stack[-1] == 0) GOTO 0x2a8; Pop(1)

0x2a5: Push("head") // @poff=239
0x2a6: @ LookAsyncCamera(Stack[-1])
0x2a7: Pop(1)
0x2a8: @ CameraWaitForPlayFinish()
0x2a9: Pop(0)
0x2aa: @ ResumeWorld()
0x2ab: Pop(0)
0x2ac: Stack[-21] = (bool) 1
0x2ad: Return(); Pop(18)

0x2ae: PushEmpty(bool, bool)
0x2af: Push((bool) 1)
0x2b0: @ CameraSwitchToNormal(Stack[-1])
0x2b1: Pop(1)
...
0x2b7: Push("head") // @poff=239
0x2b8: @ HasAnimationTrack(Stack[-2], Stack[-1])
0x2b9: Pop(1)
0x2ba: Push(Stack[-1])
0x2bb: IF (Stack[-1] == 0) GOTO 0x2bf; Pop(1)

0x2bc: Push("head") // @poff=239
0x2bd: @ UnlookAsync(Stack[-1])
0x2be: Pop(1)
0x2bf: Return(); Pop(2)

0x2c0: PushEmpty(bool, float, float, bool, float, float)
0x2c1: @ lshHasAnimation(Stack[-3], Stack[-7])
0x2c2: Pop(0)
0x2c3: Push(Stack[-3])
0x2c4: IF (Stack[-1] == 0) GOTO 0x2cb; Pop(1)

0x2c5: @ lshGetAnimTimes(Stack[-7], Stack[-2], Stack[-1])
0x2c6: Pop(0)
0x2c7: Push((bool) 0)
0x2c8: @ lshPlayAnimation(Stack[-3], Stack[-2], Stack[-1])
0x2c9: Pop(1)
0x2ca: GOTO 0x2cf

0x2cb: Push("Can't find lsh animation : ") // @poff=249
0x2cc: Pop(1); Push(Stack[-1] + Stack[-8]);
0x2cd: @ Trace(Stack[-1])
0x2ce: Pop(1)
0x2cf: Return(); Pop(6)

0x2d0: PushEmpty(bool, float, float, bool, float, float)
0x2d1: @ lshHasAnimation(Stack[-3], Stack[-8])
0x2d2: Pop(0)
0x2d3: Push(Stack[-3])
0x2d4: IF (Stack[-1] == 0) GOTO 0x2da; Pop(1)

0x2d5: @ lshGetAnimTimes(Stack[-8], Stack[-2], Stack[-1])
0x2d6: Pop(0)
0x2d7: @ lshPlayAnimation(Stack[-2], Stack[-1], Stack[-7])
0x2d8: Pop(0)
0x2d9: GOTO 0x2de

0x2da: Push("Can't find lsh animation : ") // @poff=249
0x2db: Pop(1); Push(Stack[-1] + Stack[-9]);
0x2dc: @ Trace(Stack[-1])
0x2dd: Pop(1)
0x2de: Return(); Pop(6)
...
0x2ef: Push((float)9.999999974752427e-07)
...
0x2f6: PushEmpty(string, string)
0x2f7: Stack[-1] = "idle" // @poff=146
0x2f8: Push(Stack[-3])
0x2f9: IF (Stack[-1] == 0) GOTO 0x2fb; Pop(1)

0x2fa: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x2fb: Stack[-1] = Stack[-4]
0x2fc: Return(); Pop(2)

0x2fd: PushEmpty(int, bool, int, bool)
0x2fe: Stack[-2] = (int) 0
...
0x303: Pop(1)
0x304: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x305: Pop(2)
...
0x309: Push((int) 1)
0x30a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x30b: GOTO 0x2ff

0x30c: Stack[-2] = Stack[-5]
0x30d: Return(); Pop(4)

0x30e: Stack[-1] = (int) 515571
0x30f: Return(); Pop(0)

0x310: Stack[-1] = (int) 504029
0x311: Return(); Pop(0)

0x312: Stack[-1] = "ui/NPC_bmask.png" // @poff=305
0x313: Return(); Pop(0)

0x314: Stack[-1] = "ui/NPC_bmask_b.png" // @poff=339
0x315: Return(); Pop(0)
