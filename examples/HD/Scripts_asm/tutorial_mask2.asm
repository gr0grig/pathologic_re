...
Strings:
	...
	W:branch
// @pool_raw:
// @pool_encoding:utf8
...
0x2be: Push("Can't find lsh animation : ") // @poff=249
...
0x2cd: Push("Can't find lsh animation : ") // @poff=249
...
0x2e2: Push((float)9.999999974752427e-07)
...
0x305: Stack[-1] = "ui/NPC_wmask.png" // @poff=305
0x306: Return(); Pop(0)

0x307: Stack[-1] = "ui/NPC_wmask_b.png" // @poff=339
0x308: Return(); Pop(0)
