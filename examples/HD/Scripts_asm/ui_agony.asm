...
Strings:
	...
	W:slot
	A:GetItemID
// @pool_raw:
...
0x12: Push("agony") // @poff=16
0x13: @@@ GetProperty(Stack[-1], Stack[-6]T); Obj=5 // @poff=28
0x14: Pop(1)
0x15: PushEmpty()
0x16: Call2 0x71
...
0x38: Stack[-1] = "$parent" // @poff=40
0x39: @@ add(Stack[-2]); Obj=3 // @poff=56
0x3a: Pop(0)
0x3b: @@ add(Stack[-1]); Obj=3 // @poff=56
0x3c: Pop(0)
0x3d: Push((int) -1)
0x3e: PushEmpty(string, int)
0x3f: Stack[-7] = Stack[-1]
0x40: Call2 0x30b
...
0x5c: @@@ size(Stack[-3]); Obj=0 // @poff=60
0x5d: Pop(0)
0x5e: Stack[-2] = (int) 0
0x5f: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x60: IF (Stack[-1] == 0) GOTO 0x6f; Pop(1)

0x61: @@@ get(Stack[-1], Stack[-2]); Obj=0 // @poff=65
0x62: Pop(0)
...
0x72: @ CreateObjectVector(Stack[-0]T)
0x73: Pop(0)
0x74: @ CreateFloatVector(Stack[-1]T)
0x75: Pop(0)
0x76: @ CreateIntVector(Stack[-3]T)
0x77: Pop(0)
0x78: @ CreateIntVector(Stack[-4]T)
0x79: Pop(0)
0x7a: Push("player") // @poff=69
0x7b: @ FindActor(Stack[-2]T, Stack[-1])
0x7c: Pop(1)
...
0x82: Push((int) 2)
0x83: @@@ GetItemCount(Stack[-8], Stack[-1]); Obj=2 // @poff=83
0x84: Pop(1)
0x85: Stack[-6] = (int) 0
...
0x88: Push((int) 2)
0x89: @@@ GetItem(Stack[-6], Stack[-7], Stack[-1]); Obj=2 // @poff=96
0x8a: Pop(1)
0x8b: PushEmpty(int, object)
0x8c: Stack[-7] = Stack[-1]
0x8d: Call2 0x31b

0x8e: Stack[-2] = Stack[-6]
0x8f: Pop(2)
0x90: Push("Agony") // @poff=104
...
0x9c: Push("Agony") // @poff=104
0x9d: @ GetInvItemProperty(Stack[-3], Stack[-5], Stack[-1])
0x9e: Pop(1)
0x9f: @@@ GetItemCountOfType(Stack[-1], Stack[-4]); Obj=2 // @poff=116
0xa0: Pop(0)
0xa1: @@@ add(Stack[-5]); Obj=0 // @poff=56
0xa2: Pop(0)
0xa3: @@@ add(Stack[-2]); Obj=1 // @poff=56
0xa4: Pop(0)
0xa5: @@@ add(Stack[-1]); Obj=4 // @poff=56
0xa6: Pop(0)
0xa7: Push((int) 0)
0xa8: @@@ add(Stack[-1]); Obj=3 // @poff=56
0xa9: Pop(1)
0xaa: Stack[-5] = 0
0xab: Push((int) 1)
...
0x167: @@@ size(Stack[-5]); Obj=0 // @poff=60
0x168: Pop(0)
0x169: Stack[-4] = (int) 0
0x16a: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x16b: IF (Stack[-1] == 0) GOTO 0x178; Pop(1)

0x16c: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=65
0x16d: Pop(0)
0x16e: @@@ get(Stack[-2], Stack[-4]); Obj=1 // @poff=65
0x16f: Pop(0)
0x170: @@@ get(Stack[-1], Stack[-4]); Obj=3 // @poff=65
0x171: Pop(0)
...
0x1aa: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=65
0x1ab: Pop(0)
0x1ac: @@@ get(Stack[-2], Stack[-4]); Obj=3 // @poff=65
0x1ad: Pop(0)
0x1ae: @@@ get(Stack[-1], Stack[-4]); Obj=4 // @poff=65
0x1af: Pop(0)
0x1b0: Push(Stack[-2])
...
0x1f2: @@@ size(Stack[-3]); Obj=0 // @poff=60
0x1f3: Pop(0)
0x1f4: Push((int) 4)
0x1f5: Pop(1); Push(Stack[7 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x220: Push("scrollbar") // @poff=167
0x221: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x222: IF (Stack[-1] == 0) GOTO 0x237; Pop(1)

0x223: @@@ size(Stack[-2]); Obj=0 // @poff=60
0x224: Pop(0)
0x225: Push((float)0.009999999776482582)
0x226: Push((int) 4)
...
0x238: Stack[-12] = Stack[-2]
0x239: Stack[-11] = Stack[-1]
0x23a: Call2 0x320

0x23b: Stack[-3] = Stack[-4]
0x23c: Pop(3)
0x23d: Push((int) -1)
...
0x251: Push((int) 2)
0x252: @@@ GetItemCount(Stack[-9], Stack[-1]); Obj=2 // @poff=83
0x253: Pop(1)
0x254: Stack[-7] = (int) -1
0x255: Stack[-5] = (int) 0
...
0x258: Push((int) 2)
0x259: @@@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=2 // @poff=96
0x25a: Pop(1)
...
0x262: Push("disease") // @poff=187
0x263: @@ HasProperty(Stack[-3], Stack[-1]); Obj=5 // @poff=203
0x264: Pop(1)
...
0x29f: Stack[-5] = Stack[-1]
0x2a0: Call2 0x31b

0x2a1: Stack[-2] = Stack[-3]
0x2a2: Pop(2)
0x2a3: Call2 0x250
...
0x2b0: Stack[-1] = Stack[-2]
0x2b1: Pop(1)
0x2b2: Push((float)0.0010000000474974513)
0x2b3: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x2b4: IF (Stack[-1] == 0) GOTO 0x2b6; Pop(1)

0x2b5: Stack[-1] = (int) 0
0x2b6: Push("Do ") // @poff=226
0x2b7: Pop(1); Push(Stack[-1] + Stack[-2]);
0x2b8: @ Trace(Stack[-1])
0x2b9: Pop(1)
0x2ba: Push("agony") // @poff=16
0x2bb: @@@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=234
0x2bc: Pop(1)
0x2bd: PushEmpty()
0x2be: Call2 0x28e
...
0x2c4: @@@ size(Stack[-2]); Obj=3 // @poff=60
0x2c5: Pop(0)
0x2c6: Stack[-1] = (int) 0
...
0x2c9: Push((int) 0)
0x2ca: @@@ set(Stack[-2], Stack[-1]); Obj=3 // @poff=246
0x2cb: Pop(1)
0x2cc: Push((int) 1)
...
0x2d7: @@@ size(Stack[-4]); Obj=3 // @poff=60
0x2d8: Pop(0)
...
0x2dc: @@@ get(Stack[-3], Stack[-9]); Obj=0 // @poff=65
0x2dd: Pop(0)
0x2de: @@@ get(Stack[-2], Stack[-9]); Obj=4 // @poff=65
0x2df: Pop(0)
0x2e0: @@@ get(Stack[-1], Stack[-9]); Obj=3 // @poff=65
0x2e1: Pop(0)
...
0x2e7: @@@ set(Stack[-9], Stack[-1]); Obj=3 // @poff=246
0x2e8: Pop(0)
0x2e9: PushEmpty()
0x2ea: Call2 0x1a0
...
0x2f2: @@@ size(Stack[-3]); Obj=3 // @poff=60
0x2f3: Pop(0)
...
0x2f7: @@@ get(Stack[-2], Stack[-7]); Obj=0 // @poff=65
0x2f8: Pop(0)
0x2f9: @@@ get(Stack[-1], Stack[-7]); Obj=3 // @poff=65
0x2fa: Pop(0)
0x2fb: Push((int) 0)
...
0x301: @@@ set(Stack[-7], Stack[-1]); Obj=3 // @poff=246
0x302: Pop(0)
0x303: PushEmpty()
0x304: Call2 0x1a0
...
0x31c: @@ GetItemID(Stack[-1]); Obj=3 // @poff=272
0x31d: Pop(0)
