...
Strings:
	...
	W:slot0
	W:slot
// @pool_raw:
...
0x12: @ CreateFloatVector(Stack[-6]T)
0x13: Pop(0)
0x14: @ CreateFloatVector(Stack[-5]T)
0x15: Pop(0)
0x16: @ CreateFloatVector(Stack[-7]T)
0x17: Pop(0)
0x18: @ CreateFloatVector(Stack[-8]T)
0x19: Pop(0)
0x1a: Push((float)0.30000001192092896)
0x1b: @@@ add(Stack[-1]); Obj=6 // @poff=44
0x1c: Pop(1)
0x1d: Push((float)0.4000000059604645)
0x1e: @@@ add(Stack[-1]); Obj=5 // @poff=44
0x1f: Pop(1)
0x20: Push((int) 1)
0x21: @@@ add(Stack[-1]); Obj=8 // @poff=44
0x22: Pop(1)
0x23: Push((int) 1)
0x24: @@@ add(Stack[-1]); Obj=7 // @poff=44
0x25: Pop(1)
0x26: Push((float)-0.30000001192092896)
0x27: @@@ add(Stack[-1]); Obj=6 // @poff=44
0x28: Pop(1)
0x29: Push((float)0.4000000059604645)
0x2a: @@@ add(Stack[-1]); Obj=5 // @poff=44
0x2b: Pop(1)
0x2c: Push((int) 1)
0x2d: @@@ add(Stack[-1]); Obj=8 // @poff=44
0x2e: Pop(1)
0x2f: Push((int) 1)
0x30: @@@ add(Stack[-1]); Obj=7 // @poff=44
0x31: Pop(1)
0x32: Push((float)1.0)
0x33: @@@ add(Stack[-1]); Obj=6 // @poff=44
0x34: Pop(1)
0x35: Push((float)-1.0)
0x36: @@@ add(Stack[-1]); Obj=5 // @poff=44
0x37: Pop(1)
0x38: Push((int) 1)
0x39: @@@ add(Stack[-1]); Obj=8 // @poff=44
0x3a: Pop(1)
0x3b: Push((int) 1)
0x3c: @@@ add(Stack[-1]); Obj=7 // @poff=44
0x3d: Pop(1)
0x3e: Push((int) 0)
0x3f: @@@ add(Stack[-1]); Obj=6 // @poff=44
0x40: Pop(1)
0x41: Push((int) 0)
0x42: @@@ add(Stack[-1]); Obj=5 // @poff=44
0x43: Pop(1)
0x44: Push((float)2.0)
0x45: @@@ add(Stack[-1]); Obj=8 // @poff=44
0x46: Pop(1)
0x47: Push((int) 1)
0x48: @@@ add(Stack[-1]); Obj=7 // @poff=44
0x49: Pop(1)
0x4a: Push((int) 0)
0x4b: @@@ add(Stack[-1]); Obj=6 // @poff=44
0x4c: Pop(1)
0x4d: Push((int) 0)
0x4e: @@@ add(Stack[-1]); Obj=5 // @poff=44
0x4f: Pop(1)
0x50: Push((int) 1)
0x51: @@@ add(Stack[-1]); Obj=8 // @poff=44
0x52: Pop(1)
0x53: Push((float)0.5)
0x54: @@@ add(Stack[-1]); Obj=7 // @poff=44
0x55: Pop(1)
0x56: Push("inventory_base.xml") // @poff=48
0x57: Push((bool) 0)
0x58: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x59: Pop(2)
0x5a: PushEmpty(int)
0x5b: Stack[-1] = (int) 4
0x5c: Call2 0x24c
...
0xad: Push((int) 4)
0xae: @@@ GetItemCount(Stack[-5], Stack[-1]); Obj=3 // @poff=130
0xaf: Pop(1)
...
0xb4: Push((int) 4)
0xb5: @@@ GetItemAmount(Stack[-4], Stack[-12], Stack[-1]); Obj=3 // @poff=143
0xb6: Pop(1)
0xb7: Push((int) 4)
0xb8: @@@ GetItem(Stack[-6], Stack[-12], Stack[-1]); Obj=3 // @poff=157
0xb9: Pop(1)
0xba: @@ GetItemID(Stack[-2]); Obj=5 // @poff=165
0xbb: Pop(0)
0xbc: Push((int) 0)
0xbd: Push((int) 1)
0xbe: @@@ AddItem(Stack[-3], Stack[-7], Stack[-2], Stack[-1]); Obj=4 // @poff=175
0xbf: Pop(2)
...
0xc4: Push((int) 1)
0xc5: Push((int) 4)
0xc6: @@@ RemoveItem(Stack[-13], Stack[-2], Stack[-1]); Obj=3 // @poff=183
0xc7: Pop(2)
...
0xd2: @@@ GetItemCount(Stack[-5]); Obj=4 // @poff=130
0xd3: Pop(0)
0xd4: Stack[-4] = (int) 0
0xd5: Stack[-3] = (int) 0
...
0xd8: @@@ GetItem(Stack[-2], Stack[-3]); Obj=4 // @poff=157
0xd9: Pop(0)
...
0xe1: @@@ GetItemAmount(Stack[-1], Stack[-3]); Obj=4 // @poff=143
0xe2: Pop(0)
...
0xf1: @@@ GetItem(Stack[-3], Stack[-4]); Obj=4 // @poff=157
0xf2: Pop(0)
0xf3: PushEmpty(bool, object)
0xf4: Stack[-5] = Stack[-1]
0xf5: Call2 0x122
...
0x110: @@@ GetItem(Stack[-2], Stack[-3]); Obj=4 // @poff=157
0x111: Pop(0)
...
0x11e: Stack[-1] = 0
0x11f: Stack[-1] = Stack[-11]
0x120: Return(); Pop(10)

0x121: Stack[-1] = 0
0x122: PushEmpty(int, bool, int, bool)
0x123: PushEmpty(int, object)
0x124: Stack[-7] = Stack[-1]
0x125: Call2 0x49a

0x126: Stack[-2] = Stack[-4]
0x127: Pop(2)
0x128: Push("Grass") // @poff=194
...
0x12f: Stack[-9] = Stack[-1]
0x130: Call2 0x49a

0x131: Stack[-2] = Stack[-5]
0x132: Pop(2)
0x133: Push("Grass") // @poff=194
...
0x146: @@@ GetItem(Stack[-2], Stack[-3]); Obj=4 // @poff=157
0x147: Pop(0)
0x148: PushEmpty(bool, object)
0x149: Stack[-4] = Stack[-1]
0x14a: Call2 0x122
...
0x15d: @@@ GetItemCount(Stack[-4]); Obj=4 // @poff=130
0x15e: Pop(0)
0x15f: Stack[-3] = (int) 0
0x160: Stack[-2] = (int) 0
...
0x163: @@@ GetItem(Stack[-1], Stack[-2]); Obj=4 // @poff=157
0x164: Pop(0)
...
0x175: Stack[-7] = Stack[-1]
0x176: Call2 0x13f

0x177: Stack[-2] = Stack[-4]
0x178: Pop(2)
0x179: Push((int) -1)
...
0x17f: Stack[-7] = Stack[-1]
0x180: Call2 0xea

0x181: Pop(1)
0x182: Push((int) 4)
0x183: Push((int) 1)
0x184: @@@ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=3 // @poff=175
0x185: Pop(3)
...
0x18a: Push((int) 1)
0x18b: @@@ RemoveItem(Stack[-3], Stack[-1]); Obj=4 // @poff=183
0x18c: Pop(1)
0x18d: PushEmpty(int)
0x18e: Stack[-1] = (int) 4
0x18f: Call2 0x3d5
...
0x1a0: Push((int) 2)
0x1a1: Push((int) 1)
0x1a2: @@@ AddItem(Stack[-3], Stack[-5], Stack[-2], Stack[-1]); Obj=3 // @poff=175
0x1a3: Pop(2)
...
0x1a8: Push((int) 1)
0x1a9: @@@ RemoveItem(Stack[-3], Stack[-1]); Obj=4 // @poff=183
0x1aa: Pop(1)
0x1ab: PushEmpty(int)
0x1ac: Stack[-1] = (int) 2
0x1ad: Call2 0x3d5
...
0x1be: Stack[-2] = Stack[-3]
0x1bf: Pop(2)
0x1c0: Push(Stack[-1])
0x1c1: IF (Stack[-1] == 0) GOTO 0x1ca; Pop(1)

0x1c2: Push((int) 0)
0x1c3: Push("input0") // @poff=102
0x1c4: Push((int) 1)
...
0x20a: Pop(2)
0x20b: @@@ get(Stack[-3], Stack[-4]); Obj=6 // @poff=206
0x20c: Pop(0)
0x20d: Stack[-10] = Stack[-10] + Stack[-3]; Pop(0);
0x20e: @@@ get(Stack[-3], Stack[-4]); Obj=5 // @poff=206
0x20f: Pop(0)
0x210: Stack[-9] = Stack[-9] + Stack[-3]; Pop(0);
0x211: @@@ get(Stack[-3], Stack[-4]); Obj=8 // @poff=206
0x212: Pop(0)
0x213: Stack[-8] = Stack[-8] * Stack[-3]; Pop(0);
0x214: @@@ get(Stack[-3], Stack[-4]); Obj=7 // @poff=206
0x215: Pop(0)
...
0x234: Pop(0)
0x235: Push("grass_combination") // @poff=210
0x236: @@ SetItemName(Stack[-1]); Obj=3 // @poff=246
0x237: Pop(1)
0x238: Push("im_inc") // @poff=258
0x239: Push((float)100.0)
0x23a: Pop(1); Push(Stack[-12] / Stack[-1]);
0x23b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=272
0x23c: Pop(2)
0x23d: Push("hl_inc") // @poff=284
0x23e: Push((float)100.0)
0x23f: Pop(1); Push(Stack[-11] / Stack[-1]);
0x240: Pop(1); Push(( -Stack[-1])
0x241: @@ SetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=272
0x242: Pop(2)
0x243: @@@ RemoveAllItems(); Obj=4 // @poff=298
0x244: Pop(0)
0x245: Push((int) 0)
0x246: Push((int) 1)
0x247: @@@ AddItem(Stack[-3], Stack[-4], Stack[-2], Stack[-1]); Obj=4 // @poff=175
0x248: Pop(2)
...
0x267: Pop(1)
0x268: @@ add(Stack[-1]); Obj=2 // @poff=44
0x269: Pop(1)
...
0x272: Pop(1)
0x273: @@ add(Stack[-1]); Obj=2 // @poff=44
0x274: Pop(1)
0x275: Push((int) -1)
...
0x35d: Stack[-19] = Stack[-3]
0x35e: Stack[-18] = Stack[-2]
0x35f: Stack[-17] = Stack[-1]
0x360: Call2 0x61

0x361: Stack[-4] = Stack[-10]
0x362: Pop(4)
0x363: Return(); Pop(12)

0x364: Push("button_weapon") // @poff=329
...
0x36d: Push("button_clothes") // @poff=357
...
0x376: Push("button_medcine") // @poff=387
...
0x37f: Push("button_food") // @poff=417
...
0x388: Push("button_other") // @poff=441
...
0x39c: Push("noinv_drop") // @poff=535
...
0x3ae: Stack[-1] = Stack[-4]
0x3af: Pop(1)
0x3b0: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=130
0x3b1: Pop(0)
0x3b2: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x3b3: IF (Stack[-1] == 0) GOTO 0x3c4; Pop(1)

0x3b4: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=157
0x3b5: Pop(0)
0x3b6: PushEmpty(bool, object)
0x3b7: Stack[-3] = Stack[-1]
0x3b8: Call2 0x8f
...
0x3bd: Stack[-7] = Stack[-2]
0x3be: Push((int) 0)
0x3bf: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x3c0: Call2 0x9a

0x3c1: Stack[-3] = Stack[-9]
0x3c2: Pop(3)
0x3c3: Stack[-1] = 0
0x3c4: GOTO 0x3c9
...
0x3cc: Stack[-19] = Stack[-3]
0x3cd: Stack[-18] = Stack[-2]
0x3ce: Stack[-17] = Stack[-1]
0x3cf: Call2 0x61

0x3d0: Stack[-4] = Stack[-10]
0x3d1: Pop(4)
0x3d2: Push(Stack[-6])
...
0x3e7: Pop(1)
0x3e8: Push("money") // @poff=557
0x3e9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=569
0x3ea: Pop(1)
...
0x3f9: Push((int) 0)
0x3fa: Push("button_weapon") // @poff=329
0x3fb: @ SendMessage(Stack[-2], Stack[-1])
0x3fc: Pop(2)
0x3fd: GOTO 0x402

0x3fe: Push((int) 1)
0x3ff: Push("button_weapon") // @poff=329
...
0x405: Push((int) 0)
0x406: Push("button_clothes") // @poff=357
0x407: @ SendMessage(Stack[-2], Stack[-1])
0x408: Pop(2)
0x409: GOTO 0x40e

0x40a: Push((int) 1)
0x40b: Push("button_clothes") // @poff=357
...
0x411: Push((int) 0)
0x412: Push("button_medcine") // @poff=387
0x413: @ SendMessage(Stack[-2], Stack[-1])
0x414: Pop(2)
0x415: GOTO 0x41a

0x416: Push((int) 1)
0x417: Push("button_medcine") // @poff=387
...
0x41d: Push((int) 0)
0x41e: Push("button_food") // @poff=417
0x41f: @ SendMessage(Stack[-2], Stack[-1])
0x420: Pop(2)
0x421: GOTO 0x426

0x422: Push((int) 1)
0x423: Push("button_food") // @poff=417
...
0x429: Push((int) 0)
0x42a: Push("button_other") // @poff=441
0x42b: @ SendMessage(Stack[-2], Stack[-1])
0x42c: Pop(2)
0x42d: GOTO 0x432

0x42e: Push((int) 1)
0x42f: Push("button_other") // @poff=441
...
0x436: Stack[-1] = Stack[-8]
0x437: Pop(1)
0x438: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=130
0x439: Pop(0)
0x43a: Stack[-5] = (int) 0
0x43b: Push((int) 12)
...
0x440: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=157
0x441: Pop(0)
0x442: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=143
0x443: Pop(0)
0x444: PushEmpty(bool, int, int)
0x445: Stack[-8] = Stack[-2]
0x446: Stack[-18] = Stack[-1]
0x447: Call2 0x96

0x448: Stack[-3] = Stack[-5]
0x449: Pop(3)
0x44a: PushEmpty(bool, object)
0x44b: Stack[-6] = Stack[-1]
0x44c: Call2 0x8f

0x44d: Stack[-2] = Stack[-3]
0x44e: Pop(2)
0x44f: Push(Stack[-2])
...
0x49b: @@ GetItemID(Stack[-1]); Obj=3 // @poff=165
0x49c: Pop(0)
