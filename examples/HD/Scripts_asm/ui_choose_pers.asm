...
0x73: Push("game_buttons.xml") // @poff=93
0x74: Push((bool) 0)
0x75: @ CreateWindow(Stack[-2], Stack[-1], Stack[-3])
0x76: Pop(2)
0x77: Stack[-1] = Stack[-3]
0x78: Return(); Pop(2)

0x79: Stack[-1] = 0
0x7a: PushEmpty(object, object)
0x7b: Push("game_logo.xml") // @poff=127
0x7c: Push((bool) 0)
...
0x87: @ GetWindowSize(Stack[-0]T, Stack[-1]T)
0x88: Pop(0)
0x89: Push("default") // @poff=155
0x8a: @ SetCursor(Stack[-1])
0x8b: Pop(1)
0x8c: Push("default") // @poff=155
0x8d: @ SetBackground(Stack[-1])
0x8e: Pop(1)
0x8f: Push("menumusic") // @poff=171
...
0x96: Stack[-1] = "" // @poff=64
0x97: Call2 0x382

0x98: Pop(1)
0x99: PushEmpty(string)
0x9a: Stack[-1] = "" // @poff=64
0x9b: Call2 0x387
...
0x9f: Push("game_choose_pers.xml") // @poff=191
0xa0: Push((bool) 0)
0xa1: @ CreateWindow(Stack[-2], Stack[-1], Stack[-5]T)
0xa2: Pop(2)
0xa3: GOTO 0xac
...
0xc1: Stack[-2] = "intro_danko.wmv" // @poff=233
0xc2: Stack[-1] = (bool) 1
...
0xcb: @ DestroyWindow()
0xcc: Pop(0)
0xcd: Push("world_danko.xml") // @poff=265
0xce: Push("player_danko.xml") // @poff=297
...
0xdf: Stack[-2] = "intro_burah.wmv" // @poff=331
0xe0: Stack[-1] = (bool) 1
...
0xe9: @ DestroyWindow()
0xea: Pop(0)
0xeb: Push("world_burah.xml") // @poff=363
0xec: Push("player_burah.xml") // @poff=395
...
0xfd: Stack[-2] = "intro_klara.wmv" // @poff=429
0xfe: Stack[-1] = (bool) 1
...
0x107: @ DestroyWindow()
0x108: Pop(0)
0x109: Push("world_klara.xml") // @poff=461
0x10a: Push("player_klara.xml") // @poff=493
...
0x111: Push("menumusic") // @poff=171
0x112: @ PauseSound(Stack[-1])
0x113: Pop(1)
0x114: Push("Loading : ") // @poff=527
0x115: Pop(1); Push(Stack[-1] + Stack[10 + Tasks[-1].StackPointer]);
0x116: @ Trace(Stack[-1])
0x117: Pop(1)
0x118: @ RemoveWorld()
0x119: Pop(0)
...
0x11c: @ DestroyWindow()
0x11d: Pop(0)
0x11e: @ LoadGame(Stack[-4], Stack[-10]T)
0x11f: Pop(0)
0x120: GOTO 0x13f
...
0x12b: @ DestroyWindow()
0x12c: Pop(0)
0x12d: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=549
0x12e: Pop(0)
...
0x139: @ DestroyWindow()
0x13a: Pop(0)
0x13b: Push("world_intro.xml") // @poff=561
0x13c: Push("player_intro.xml") // @poff=593
...
0x15f: Pop(0)
0x160: Push("load.xml") // @poff=699
0x161: Push((bool) 0)
0x162: @ CreateWindow(Stack[-2], Stack[-1], Stack[-6]T)
0x163: Pop(2)
0x164: Return(); Pop(0)

0x165: GOTO 0x257

0x166: Push("savegame") // @poff=717
...
0x16b: Pop(0)
0x16c: Push("save.xml") // @poff=735
0x16d: Push((bool) 0)
0x16e: @ CreateWindow(Stack[-2], Stack[-1], Stack[-7]T)
0x16f: Pop(2)
0x170: Return(); Pop(0)

0x171: GOTO 0x257

0x172: Push("gameoptions") // @poff=753
...
0x177: Pop(0)
0x178: Push("options.xml") // @poff=777
0x179: Push((bool) 0)
0x17a: @ CreateWindow(Stack[-2], Stack[-1], Stack[-8]T)
0x17b: Pop(2)
0x17c: Return(); Pop(0)

0x17d: GOTO 0x257

0x17e: Push("continue") // @poff=801
...
0x1a0: Stack[-1] = "" // @poff=64
0x1a1: Call2 0x382

0x1a2: Pop(1)
0x1a3: GOTO 0x257

0x1a4: Push("danko") // @poff=835
...
0x1b1: Push((int) 202)
0x1b2: Push("player_name") // @poff=847
0x1b3: @ SendMessage(Stack[-2], Stack[-1])
0x1b4: Pop(2)
0x1b5: Push((int) 203)
0x1b6: Push("player_desc") // @poff=871
...
0x1bd: Push((int) -1)
0x1be: Push("player_name") // @poff=847
0x1bf: @ SendMessage(Stack[-2], Stack[-1])
0x1c0: Pop(2)
0x1c1: Push((int) -1)
0x1c2: Push("player_desc") // @poff=871
...
0x1d4: Push((int) 205)
0x1d5: Push("player_name") // @poff=847
0x1d6: @ SendMessage(Stack[-2], Stack[-1])
0x1d7: Pop(2)
0x1d8: Push((int) 206)
0x1d9: Push("player_desc") // @poff=871
...
0x1e0: Push((int) -1)
0x1e1: Push("player_name") // @poff=847
0x1e2: @ SendMessage(Stack[-2], Stack[-1])
0x1e3: Pop(2)
0x1e4: Push((int) -1)
0x1e5: Push("player_desc") // @poff=871
...
0x206: Push((int) 208)
0x207: Push("player_name") // @poff=847
...
0x218: Push((int) 213)
0x219: Push("player_desc") // @poff=871
0x21a: @ SendMessage(Stack[-2], Stack[-1])
0x21b: Pop(2)
0x21c: GOTO 0x221

0x21d: Push((int) 209)
0x21e: Push("player_desc") // @poff=871
...
0x225: Push((int) -1)
0x226: Push("player_name") // @poff=847
0x227: @ SendMessage(Stack[-2], Stack[-1])
0x228: Pop(2)
0x229: Push((int) -1)
0x22a: Push("player_desc") // @poff=871
...
0x236: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=549
0x237: Pop(0)
...
0x32c: Push((int) 1)
0x32d: Push("newgame") // @poff=627
0x32e: @ SendMessage(Stack[-2], Stack[-1])
0x32f: Pop(2)
0x330: PushEmpty(string)
0x331: Stack[-1] = "newgame" // @poff=627
0x332: Call2 0x382
...
0x393: Push((int) 1)
0x394: Push("quitgame") // @poff=643
0x395: @ SendMessage(Stack[-2], Stack[-1])
0x396: Pop(2)
0x397: PushEmpty(string)
0x398: Stack[-1] = "quitgame" // @poff=643
0x399: Call2 0x382
...
0x456: Push("BurahCompleted") // @poff=939
0x457: Push((int) 0)
...
0x45e: Push("DankoCompleted") // @poff=969
0x45f: Push((int) 0)
