...
Strings:
	...
	A:clear
	A:add
// @pool_raw:640065006600610075006c007400000073697a650067657400630073006c006f00740030000000636c6561720061646400
...
0x16: @@@ size(Stack[-4]); Obj=0 // @poff=16
0x17: Pop(0)
0x18: Stack[-3] = (int) 0
...
0x1f: @@@ get(Stack[-2], Stack[-3]); Obj=0 // @poff=21
0x20: Pop(0)
0x21: Push((int) 0)
0x22: Push("cslot0") // @poff=25
0x23: Push((int) 1)
...
0x4b: @@@ size(Stack[-2]); Obj=0 // @poff=16
0x4c: Pop(0)
...
0x50: Pop(0)
0x51: @@ clear(); Obj=1 // @poff=39
0x52: Pop(0)
0x53: @@ add(Stack[-3]); Obj=1 // @poff=45
0x54: Pop(0)
0x55: @ DestroyWindow()
0x56: Pop(0)
0x57: Stack[-1] = 0
