...
Strings:
	...
	W:cslot
	W:Money
// @pool_raw:
...
0x18: Stack[-2] = Stack[-4]
0x19: Pop(2)
0x1a: GOTO 0x1c

0x1b: Stack[-2] = "$parent" // @poff=38
0x1c: Push((int) 1)
...
0x25: Stack[-2] = Stack[-3]
0x26: Pop(2)
0x27: GOTO 0x29

0x28: Stack[-1] = "$parent" // @poff=38
0x29: @@ add(Stack[-2]); Obj=3 // @poff=54
0x2a: Pop(0)
0x2b: @@ add(Stack[-1]); Obj=3 // @poff=54
0x2c: Pop(0)
0x2d: Push((int) -1)
0x2e: PushEmpty(string, int)
0x2f: Stack[-7] = Stack[-1]
0x30: Call2 0x4e1
...
0x10b: Pop(0)
0x10c: @@ GetItemCount(Stack[-4]); Obj=5 // @poff=58
0x10d: Pop(0)
0x10e: Push((int) 4)
0x10f: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x146: Push("scrollbar") // @poff=71
0x147: Pop(1); Push((bool) Stack[-13] == Stack[-1])
0x148: IF (Stack[-1] == 0) GOTO 0x15e; Pop(1)

0x149: @ GetContainer(Stack[-2])
0x14a: Pop(0)
0x14b: @@ GetItemCount(Stack[-1]); Obj=2 // @poff=58
0x14c: Pop(0)
0x14d: Push((float)0.009999999776482582)
0x14e: Push((int) 4)
...
0x19d: Pop(0)
0x19e: @@ GetItemCount(Stack[-3]); Obj=4 // @poff=58
0x19f: Pop(0)
0x1a0: Push((int) 4)
...
0x1c6: Pop(0)
0x1c7: @@ GetItemCount(Stack[-5]); Obj=6 // @poff=58
0x1c8: Pop(0)
0x1c9: Stack[-4] = Stack[2 + Tasks[-1].StackPointer]
0x1ca: Push((int) 4)
0x1cb: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1d0: @@ GetItem(Stack[-3], Stack[-4]); Obj=6 // @poff=91
0x1d1: Pop(0)
0x1d2: @@ GetItemID(Stack[-2]); Obj=3 // @poff=99
0x1d3: Pop(0)
0x1d4: @@ GetItemAmount(Stack[-1], Stack[-4]); Obj=6 // @poff=109
0x1d5: Pop(0)
0x1d6: Push((int) 0)
...
0x20e: Pop(1)
0x20f: @@ add(Stack[-1]); Obj=2 // @poff=54
0x210: Pop(1)
...
0x219: Pop(1)
0x21a: @@ add(Stack[-1]); Obj=2 // @poff=54
0x21b: Pop(1)
0x21c: Push((int) -1)
...
0x301: Pop(1)
0x302: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=139
0x303: Pop(1)
0x304: Stack[-1] = Stack[-5]
0x305: Return(); Pop(2)
...
0x318: Stack[-19] = Stack[-3]
0x319: Stack[-18] = Stack[-2]
0x31a: Stack[-17] = Stack[-1]
0x31b: Call2 0xee

0x31c: Stack[-4] = Stack[-10]
0x31d: Pop(4)
0x31e: Return(); Pop(12)

0x31f: Push("button_weapon") // @poff=154
...
0x328: Push("button_clothes") // @poff=182
...
0x331: Push("button_medcine") // @poff=212
...
0x33a: Push("button_food") // @poff=242
...
0x343: Push("button_other") // @poff=266
...
0x357: Push("noinv_drop") // @poff=360
...
0x369: Stack[-1] = Stack[-4]
0x36a: Pop(1)
0x36b: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=58
0x36c: Pop(0)
0x36d: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x36e: IF (Stack[-1] == 0) GOTO 0x37f; Pop(1)

0x36f: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=91
0x370: Pop(0)
...
0x387: Stack[-19] = Stack[-3]
0x388: Stack[-18] = Stack[-2]
0x389: Stack[-17] = Stack[-1]
0x38a: Call2 0xee

0x38b: Stack[-4] = Stack[-10]
0x38c: Pop(4)
0x38d: Push(Stack[-6])
...
0x3a2: Pop(1)
0x3a3: Push("money") // @poff=382
0x3a4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=394
0x3a5: Pop(1)
0x3a6: Stack[-1] = Stack[-5]
0x3a7: Return(); Pop(4)
...
0x3ad: Pop(1)
0x3ae: Push("money") // @poff=382
0x3af: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=406
0x3b0: Pop(1)
0x3b1: Return(); Pop(2)
...
0x3be: Push((int) 0)
0x3bf: Push("button_weapon") // @poff=154
0x3c0: @ SendMessage(Stack[-2], Stack[-1])
0x3c1: Pop(2)
0x3c2: GOTO 0x3c7

0x3c3: Push((int) 1)
0x3c4: Push("button_weapon") // @poff=154
...
0x3ca: Push((int) 0)
0x3cb: Push("button_clothes") // @poff=182
0x3cc: @ SendMessage(Stack[-2], Stack[-1])
0x3cd: Pop(2)
0x3ce: GOTO 0x3d3

0x3cf: Push((int) 1)
0x3d0: Push("button_clothes") // @poff=182
...
0x3d6: Push((int) 0)
0x3d7: Push("button_medcine") // @poff=212
0x3d8: @ SendMessage(Stack[-2], Stack[-1])
0x3d9: Pop(2)
0x3da: GOTO 0x3df

0x3db: Push((int) 1)
0x3dc: Push("button_medcine") // @poff=212
...
0x3e2: Push((int) 0)
0x3e3: Push("button_food") // @poff=242
0x3e4: @ SendMessage(Stack[-2], Stack[-1])
0x3e5: Pop(2)
0x3e6: GOTO 0x3eb

0x3e7: Push((int) 1)
0x3e8: Push("button_food") // @poff=242
...
0x3ee: Push((int) 0)
0x3ef: Push("button_other") // @poff=266
0x3f0: @ SendMessage(Stack[-2], Stack[-1])
0x3f1: Pop(2)
0x3f2: GOTO 0x3f7

0x3f3: Push((int) 1)
0x3f4: Push("button_other") // @poff=266
...
0x401: Stack[-1] = Stack[-11]
0x402: Pop(1)
0x403: @ GetContainer(Stack[-11])
0x404: Pop(0)
0x405: @@ GetItemCount(Stack[-8]); Obj=11 // @poff=58
0x406: Pop(0)
...
0x40b: @@ GetItemAmount(Stack[-7], Stack[-23]); Obj=11 // @poff=109
0x40c: Pop(0)
0x40d: Push((int) 0)
...
0x412: @@ GetItem(Stack[-9], Stack[-23]); Obj=11 // @poff=91
0x413: Pop(0)
0x414: @@ GetItemID(Stack[-6]); Obj=9 // @poff=99
0x415: Pop(0)
0x416: Stack[-5] = (bool) 0
0x417: Push("Organ") // @poff=418
0x418: @@ HasProperty(Stack[-6], Stack[-1]); Obj=10 // @poff=430
0x419: Pop(1)
0x41a: Push(Stack[-5])
0x41b: IF (Stack[-1] == 0) GOTO 0x41f; Pop(1)

0x41c: Push("Organ") // @poff=418
0x41d: @@ RemoveProperty(Stack[-1]); Obj=10 // @poff=442
0x41e: Pop(1)
0x41f: Push("Category") // @poff=457
...
0x42f: Pop(1)
0x430: @@ RemoveItem(Stack[-23], Stack[-7]); Obj=11 // @poff=475
0x431: Pop(0)
0x432: PushEmpty()
0x433: Call2 0x3b3
...
0x438: Push((int) 1)
0x439: @@ AddItem(Stack[-2], Stack[-10], Stack[-5], Stack[-1]); Obj=11 // @poff=486
0x43a: Pop(1)
0x43b: Pop(0); Push((bool) Stack[-1] == 0)
0x43c: IF (Stack[-1] == 0) GOTO 0x43f; Pop(1)

0x43d: Stack[-4] = Stack[-25]
0x43e: Return(); Pop(22)

0x43f: Stack[-24] = (bool) 1
0x440: Push((int) 1)
0x441: @@ RemoveItem(Stack[-24], Stack[-1]); Obj=12 // @poff=475
0x442: Pop(1)
0x443: Stack[-4] = Stack[-25]
0x444: Return(); Pop(22)
...
0x44b: Stack[-1] = Stack[-9]
0x44c: Pop(1)
0x44d: @ GetContainer(Stack[-9])
0x44e: Pop(0)
0x44f: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=58
0x450: Pop(0)
...
0x455: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=109
0x456: Pop(0)
0x457: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=91
0x458: Pop(0)
0x459: Push((int) 0)
0x45a: Push((int) 1)
0x45b: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=486
0x45c: Pop(2)
...
0x464: @@ GetItemID(Stack[-3]); Obj=7 // @poff=99
0x465: Pop(0)
0x466: Push("Weapon") // @poff=494
0x467: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x468: Pop(1)
0x469: Push(Stack[-2])
0x46a: IF (Stack[-1] == 0) GOTO 0x472; Pop(1)

0x46b: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=139
0x46c: Pop(0)
0x46d: Push(Stack[-1])
...
0x471: Pop(1)
0x472: Push((int) 1)
0x473: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=475
0x474: Pop(1)
...
0x47e: Pop(1)
0x47f: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=58
0x480: Pop(0)
0x481: Stack[-5] = (int) 0
0x482: Push((int) 12)
...
0x487: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=91
0x488: Pop(0)
0x489: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=109
0x48a: Pop(0)
0x48b: PushEmpty(bool, int, int)
0x48c: Stack[-8] = Stack[-2]
0x48d: Stack[-18] = Stack[-1]
0x48e: Call2 0x2f5
