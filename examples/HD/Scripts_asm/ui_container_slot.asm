...
Strings:
	...
	W:cslot0
	W:cslot
// @pool_raw:640065006600610075006c0074000000240070006100720065006e0074000000676574004765744974656d494400630073006c006f00740030000000630073006c006f0074000000
...
0x73: Push((int) 1)
0x74: Push((int) 1)
0x75: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x76: Pop(2)
0x77: Push((int) 1)
0x78: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] > Stack[-1])
0x79: IF (Stack[-1] == 0) GOTO 0x7f; Pop(1)

0x7a: Push("default") // @poff=0
0x7b: Push((int) 2)
0x7c: Push((int) 35)
0x7d: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x7e: Pop(3)
0x7f: Return(); Pop(0)
...
0x9b: Push((int) 0)
0x9c: @@ get(Stack[-6]T, Stack[-1]); Obj=4 // @poff=32
0x9d: Pop(1)
0x9e: Push((int) 1)
0x9f: @@ get(Stack[-7]T, Stack[-1]); Obj=4 // @poff=32
0xa0: Pop(1)
0xa1: Return(); Pop(2)
...
0xd9: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=36
0xda: Pop(0)
0xdb: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0xdc: Pop(0)
0xdd: @ LoadImage(Stack[-3]T)
0xde: Pop(0)
0xdf: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0xe0: Pop(0)
0xe1: Push((int) 1)
0xe2: Push("") // @poff=13
0xe3: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0xe4: Pop(2)
0xe5: GOTO 0xea
