...
Strings:
	...
	W:ccslot
	W:Money
// @pool_raw:
...
0x1: Push("inventory_base.xml") // @poff=0
0x2: Push((bool) 0)
0x3: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x4: Pop(2)
0x5: PushEmpty()
0x6: Call2 0x2ab
...
0x18: Stack[-2] = Stack[-6]
0x19: Pop(2)
0x1a: GOTO 0x1c

0x1b: Stack[-4] = "$parent" // @poff=38
0x1c: Push((int) 1)
...
0x25: Stack[-2] = Stack[-5]
0x26: Pop(2)
0x27: GOTO 0x29

0x28: Stack[-3] = "$parent" // @poff=38
0x29: @@ add(Stack[-4]); Obj=5 // @poff=54
0x2a: Pop(0)
0x2b: @@ add(Stack[-3]); Obj=5 // @poff=54
0x2c: Pop(0)
0x2d: Push((int) -1)
0x2e: PushEmpty(string, int)
0x2f: Stack[-9] = Stack[-1]
0x30: Call2 0x688
...
0x46: Pop(1)
0x47: @@ add(Stack[-1]); Obj=2 // @poff=54
0x48: Pop(1)
...
0x51: Pop(1)
0x52: @@ add(Stack[-1]); Obj=2 // @poff=54
0x53: Pop(1)
0x54: Push((int) -1)
...
0x95: IF (Stack[-1] == 1) GOTO 0x9a; Pop(1)
...
0xb1: IF (Stack[-1] == 1) GOTO 0xb6; Pop(1)

0xb2: Push((int) 0)
0xb3: Pop(1); Push((bool) Stack[3 + Tasks[-1].StackPointer] == Stack[-1])
0xb4: IF (Stack[-1] == 1) GOTO 0xb6; Pop(1)
...
0x13b: IF (Stack[-1] == 1) GOTO 0x140; Pop(1)

0x13c: Push((int) 2)
0x13d: Pop(1); Push((bool) Stack[3 + Tasks[-1].StackPointer] == Stack[-1])
0x13e: IF (Stack[-1] == 1) GOTO 0x140; Pop(1)
...
0x157: IF (Stack[-1] == 1) GOTO 0x15c; Pop(1)

0x158: Push((int) 0)
0x159: Pop(1); Push((bool) Stack[3 + Tasks[-1].StackPointer] == Stack[-1])
0x15a: IF (Stack[-1] == 1) GOTO 0x15c; Pop(1)
...
0x1e9: Pop(0)
0x1ea: @@ GetItemCount(Stack[-4]); Obj=5 // @poff=58
0x1eb: Pop(0)
0x1ec: Push((int) 4)
0x1ed: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x221: Stack[-8] = Stack[-2]
0x222: Stack[-1] = (bool) 1
0x223: Call2 0x34e

0x224: Stack[-3] = Stack[-5]
0x225: Pop(3)
...
0x23a: Stack[-7] = Stack[-2]
0x23b: Stack[-1] = (bool) 0
0x23c: Call2 0x34e

0x23d: Stack[-3] = Stack[-5]
0x23e: Pop(3)
...
0x24d: Pop(1)
0x24e: Push((float)0.009999999776482582)
0x24f: Push((int) 4)
...
0x27f: Push("take_organ") // @poff=91
0x280: @ PlaySound(Stack[-1])
0x281: Pop(1)
0x282: PushEmpty(int)
0x283: PushEmpty(int, bool, int)
0x284: Stack[-5] = Stack[-2]
0x285: Stack[-8] = Stack[-1]
0x286: Call2 0x59f

0x287: Stack[-3] = Stack[-4]
0x288: Pop(3)
0x289: Call2 0x537
...
0x2d5: Pop(0)
0x2d6: @@ GetItemCount(Stack[-14]); Obj=15 // @poff=58
0x2d7: Pop(0)
...
0x2dc: @@ GetItem(Stack[-11], Stack[-12]); Obj=15 // @poff=113
0x2dd: Pop(0)
0x2de: @@ GetItemID(Stack[-10]); Obj=11 // @poff=121
0x2df: Pop(0)
0x2e0: @@ GetItemAmount(Stack[-9], Stack[-12]); Obj=15 // @poff=131
0x2e1: Pop(0)
0x2e2: Stack[-8] = (bool) 0
0x2e3: Push("Organ") // @poff=145
0x2e4: @@ HasProperty(Stack[-9], Stack[-1]); Obj=12 // @poff=157
0x2e5: Pop(1)
0x2e6: Push(Stack[-8])
...
0x2fc: Push((int) 4)
0x2fd: Pop(1); Push(Stack[-1] + Stack[2 + Tasks[-1].StackPointer]);
...
0x306: Push((int) 4)
0x307: Pop(1); Push(Stack[-1] + Stack[2 + Tasks[-1].StackPointer]);
...
0x318: @@ GetItem(Stack[-5], Stack[-6]); Obj=15 // @poff=113
0x319: Pop(0)
0x31a: @@ GetItemID(Stack[-4]); Obj=5 // @poff=121
0x31b: Pop(0)
0x31c: @@ GetItemAmount(Stack[-3], Stack[-6]); Obj=15 // @poff=131
0x31d: Pop(0)
0x31e: Stack[-2] = (bool) 0
0x31f: Push("Organ") // @poff=145
0x320: @@ HasProperty(Stack[-3], Stack[-1]); Obj=6 // @poff=157
0x321: Pop(1)
...
0x350: Pop(0)
0x351: @@ GetItemCount(Stack[-8]); Obj=9 // @poff=58
0x352: Pop(0)
0x353: Stack[-7] = (int) 0
0x354: Stack[-6] = (int) 0
0x355: Stack[-5] = (int) 0
...
0x358: @@ GetItem(Stack[-4], Stack[-5]); Obj=9 // @poff=113
0x359: Pop(0)
0x35a: @@ GetItemID(Stack[-3]); Obj=4 // @poff=121
0x35b: Pop(0)
0x35c: @@ GetItemAmount(Stack[-2], Stack[-5]); Obj=9 // @poff=131
0x35d: Pop(0)
0x35e: Stack[-1] = (bool) 0
0x35f: Push("Organ") // @poff=145
0x360: @@ HasProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=157
0x361: Pop(1)
0x362: Push(Stack[-1])
...
0x386: Pop(0)
0x387: @@ GetItemCount(Stack[-7]); Obj=8 // @poff=58
0x388: Pop(0)
0x389: Stack[-6] = (int) 0
0x38a: Stack[-5] = (int) 0
...
0x38d: @@ GetItem(Stack[-4], Stack[-5]); Obj=8 // @poff=113
0x38e: Pop(0)
0x38f: @@ GetItemID(Stack[-3]); Obj=4 // @poff=121
0x390: Pop(0)
0x391: @@ GetItemAmount(Stack[-2], Stack[-5]); Obj=8 // @poff=131
0x392: Pop(0)
0x393: Stack[-1] = (bool) 0
0x394: Push("Organ") // @poff=145
0x395: @@ HasProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=157
0x396: Pop(1)
...
0x3bd: Pop(1)
0x3be: @@ add(Stack[-1]); Obj=2 // @poff=54
0x3bf: Pop(1)
...
0x3c8: Pop(1)
0x3c9: @@ add(Stack[-1]); Obj=2 // @poff=54
0x3ca: Pop(1)
0x3cb: Push((int) -1)
...
0x4a8: Pop(1)
0x4a9: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=185
0x4aa: Pop(1)
...
0x4bf: Stack[-19] = Stack[-3]
0x4c0: Stack[-18] = Stack[-2]
0x4c1: Stack[-17] = Stack[-1]
0x4c2: Call2 0x1cc

0x4c3: Stack[-4] = Stack[-10]
0x4c4: Pop(4)
0x4c5: Return(); Pop(12)

0x4c6: Push("button_weapon") // @poff=200
...
0x4cf: Push("button_clothes") // @poff=228
...
0x4d8: Push("button_medcine") // @poff=258
...
0x4e1: Push("button_food") // @poff=288
...
0x4ea: Push("button_other") // @poff=312
...
0x4fe: Push("noinv_drop") // @poff=406
...
0x511: Pop(1)
0x512: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=58
0x513: Pop(0)
0x514: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x515: IF (Stack[-1] == 0) GOTO 0x526; Pop(1)

0x516: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=113
0x517: Pop(0)
...
0x51f: Stack[-7] = Stack[-2]
0x520: Push((int) 0)
0x521: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x522: Call2 0x29e

0x523: Stack[-3] = Stack[-9]
0x524: Pop(3)
0x525: Stack[-1] = 0
0x526: GOTO 0x52b
...
0x52e: Stack[-19] = Stack[-3]
0x52f: Stack[-18] = Stack[-2]
0x530: Stack[-17] = Stack[-1]
0x531: Call2 0x1cc

0x532: Stack[-4] = Stack[-10]
0x533: Pop(4)
0x534: Push(Stack[-6])
...
0x548: Stack[-1] = Stack[-3]
0x549: Pop(1)
0x54a: Push("money") // @poff=428
0x54b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=440
0x54c: Pop(1)
...
0x554: Pop(1)
0x555: Push("money") // @poff=428
0x556: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=452
0x557: Pop(1)
0x558: Return(); Pop(2)
...
0x565: Push((int) 0)
0x566: Push("button_weapon") // @poff=200
0x567: @ SendMessage(Stack[-2], Stack[-1])
0x568: Pop(2)
0x569: GOTO 0x56e

0x56a: Push((int) 1)
0x56b: Push("button_weapon") // @poff=200
...
0x571: Push((int) 0)
0x572: Push("button_clothes") // @poff=228
0x573: @ SendMessage(Stack[-2], Stack[-1])
0x574: Pop(2)
0x575: GOTO 0x57a

0x576: Push((int) 1)
0x577: Push("button_clothes") // @poff=228
...
0x57d: Push((int) 0)
0x57e: Push("button_medcine") // @poff=258
0x57f: @ SendMessage(Stack[-2], Stack[-1])
0x580: Pop(2)
0x581: GOTO 0x586

0x582: Push((int) 1)
0x583: Push("button_medcine") // @poff=258
...
0x589: Push((int) 0)
0x58a: Push("button_food") // @poff=288
0x58b: @ SendMessage(Stack[-2], Stack[-1])
0x58c: Pop(2)
0x58d: GOTO 0x592

0x58e: Push((int) 1)
0x58f: Push("button_food") // @poff=288
...
0x595: Push((int) 0)
0x596: Push("button_other") // @poff=312
0x597: @ SendMessage(Stack[-2], Stack[-1])
0x598: Pop(2)
0x599: GOTO 0x59e

0x59a: Push((int) 1)
0x59b: Push("button_other") // @poff=312
...
0x5ab: Pop(0)
0x5ac: @@ GetItemCount(Stack[-8]); Obj=11 // @poff=58
0x5ad: Pop(0)
...
0x5b2: @@ GetItemAmount(Stack[-7], Stack[-23]); Obj=11 // @poff=131
0x5b3: Pop(0)
0x5b4: Push((int) 0)
...
0x5b9: @@ GetItem(Stack[-9], Stack[-23]); Obj=11 // @poff=113
0x5ba: Pop(0)
0x5bb: @@ GetItemID(Stack[-6]); Obj=9 // @poff=121
0x5bc: Pop(0)
0x5bd: Stack[-5] = (bool) 0
0x5be: Push("Organ") // @poff=145
0x5bf: @@ HasProperty(Stack[-6], Stack[-1]); Obj=10 // @poff=157
0x5c0: Pop(1)
0x5c1: Push(Stack[-5])
0x5c2: IF (Stack[-1] == 0) GOTO 0x5c6; Pop(1)

0x5c3: Push("Organ") // @poff=145
0x5c4: @@ RemoveProperty(Stack[-1]); Obj=10 // @poff=464
0x5c5: Pop(1)
0x5c6: Push("Category") // @poff=479
...
0x5d6: Pop(1)
0x5d7: @@ RemoveItem(Stack[-23], Stack[-7]); Obj=11 // @poff=497
0x5d8: Pop(0)
0x5d9: PushEmpty()
0x5da: Call2 0x55a
...
0x5df: Push((int) 1)
0x5e0: @@ AddItem(Stack[-2], Stack[-10], Stack[-5], Stack[-1]); Obj=11 // @poff=508
0x5e1: Pop(1)
0x5e2: Pop(0); Push((bool) Stack[-1] == 0)
0x5e3: IF (Stack[-1] == 0) GOTO 0x5e6; Pop(1)

0x5e4: Stack[-4] = Stack[-25]
0x5e5: Return(); Pop(22)

0x5e6: Stack[-24] = (bool) 1
0x5e7: Push((int) 1)
0x5e8: @@ RemoveItem(Stack[-24], Stack[-1]); Obj=12 // @poff=497
0x5e9: Pop(1)
0x5ea: Stack[-4] = Stack[-25]
0x5eb: Return(); Pop(22)
...
0x5f2: Stack[-1] = Stack[-9]
0x5f3: Pop(1)
0x5f4: @ GetContainer(Stack[-9])
0x5f5: Pop(0)
0x5f6: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=58
0x5f7: Pop(0)
...
0x5fc: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=131
0x5fd: Pop(0)
0x5fe: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=113
0x5ff: Pop(0)
0x600: Push((int) 0)
0x601: Push((int) 1)
0x602: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=508
0x603: Pop(2)
...
0x60b: @@ GetItemID(Stack[-3]); Obj=7 // @poff=121
0x60c: Pop(0)
0x60d: Push("Weapon") // @poff=516
0x60e: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x60f: Pop(1)
0x610: Push(Stack[-2])
0x611: IF (Stack[-1] == 0) GOTO 0x619; Pop(1)

0x612: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=185
0x613: Pop(0)
0x614: Push(Stack[-1])
...
0x618: Pop(1)
0x619: Push((int) 1)
0x61a: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=497
0x61b: Pop(1)
...
0x624: Stack[-1] = Stack[-8]
0x625: Pop(1)
0x626: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=58
0x627: Pop(0)
0x628: Stack[-5] = (int) 0
0x629: Push((int) 12)
...
0x62e: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=113
0x62f: Pop(0)
0x630: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=131
0x631: Pop(0)
0x632: PushEmpty(bool, int, int)
0x633: Stack[-8] = Stack[-2]
0x634: Stack[-18] = Stack[-1]
0x635: Call2 0x49c

0x636: Stack[-3] = Stack[-5]
0x637: Pop(3)
