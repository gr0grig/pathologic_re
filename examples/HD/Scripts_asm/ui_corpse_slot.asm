...
Strings:
	...
	W:ccslot0
	W:ccslot
// @pool_raw:640065006600610075006c0074000000240070006100720065006e00740000007300630061006c00700065006c000000676574004765744974656d4944006300630073006c006f007400300000006300630073006c006f0074000000
...
0x74: Push((int) 1)
0x75: Push((int) 1)
0x76: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x77: Pop(2)
0x78: Push((int) 1)
0x79: Pop(1); Push((bool) Stack[1 + Tasks[-1].StackPointer] > Stack[-1])
0x7a: IF (Stack[-1] == 0) GOTO 0x80; Pop(1)

0x7b: Push("default") // @poff=0
0x7c: Push((int) 2)
0x7d: Push((int) 35)
0x7e: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x7f: Pop(3)
0x80: Return(); Pop(0)
...
0x9c: Push((int) 0)
0x9d: @@ get(Stack[-6]T, Stack[-1]); Obj=4 // @poff=48
0x9e: Pop(1)
0x9f: Push((int) 1)
0xa0: @@ get(Stack[-7]T, Stack[-1]); Obj=4 // @poff=48
0xa1: Pop(1)
0xa2: Return(); Pop(2)
...
0xda: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=52
0xdb: Pop(0)
0xdc: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0xdd: Pop(0)
0xde: @ LoadImage(Stack[-3]T)
0xdf: Pop(0)
0xe0: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0xe1: Pop(0)
0xe2: Push((int) 1)
0xe3: Push("") // @poff=13
0xe4: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0xe5: Pop(2)
0xe6: GOTO 0xeb
