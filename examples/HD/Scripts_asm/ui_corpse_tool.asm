...
Strings:
	...
	W:pressed
	W:default
// @pool_raw:640069007300610062006c0065006400000070007200650073007300650064000000640065006600610075006c0074000000
...
0x17: Push("default") // @poff=34
0x18: @ SetBackground(Stack[-1])
0x19: Pop(1)
0x1a: GOTO 0x1e

0x1b: Push("disabled") // @poff=0
...
0x21: Push("default") // @poff=34
0x22: @ SetBackground(Stack[-1])
0x23: Pop(1)
0x24: GOTO 0x28

0x25: Push("disabled") // @poff=0
