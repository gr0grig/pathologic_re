...
Strings:
	...
	W:slot
	A:GetItemID
// @pool_raw:
...
0x21a: @@@ RemoveAllItems(); Obj=4 // @poff=258
0x21b: Pop(0)
0x21c: @ CreateInvItem(Stack[-15])
0x21d: Pop(0)
0x21e: Push("burah_serum") // @poff=273
0x21f: @@ SetItemName(Stack[-1]); Obj=16 // @poff=297
0x220: Pop(1)
0x221: Push((int) 0)
0x222: Push((int) 1)
0x223: @@@ AddItem(Stack[-16], Stack[-17], Stack[-2], Stack[-1]); Obj=4 // @poff=168
0x224: Pop(2)
0x225: Stack[-35] = (bool) 1
0x226: Return(); Pop(34)

0x227: Stack[-15] = 0
0x228: Push("im_inc") // @poff=309
0x229: @@ GetProperty(Stack[-14], Stack[-1]); Obj=18 // @poff=323
0x22a: Pop(1)
0x22b: Push("hl_inc") // @poff=335
0x22c: @@ GetProperty(Stack[-13], Stack[-1]); Obj=18 // @poff=323
0x22d: Pop(1)
0x22e: PushEmpty(int, object)
0x22f: Stack[-18] = Stack[-1]
0x230: Call2 0xc3
...
0x236: Stack[-12] = Stack[-9]
0x237: PushEmpty(int, object)
0x238: Stack[-18] = Stack[-1]
0x239: Call2 0xc3
...
0x242: Stack[-6] = Stack[-11]
0x243: Stack[-12] = Stack[-9]
0x244: PushEmpty(int, object)
0x245: Stack[-18] = Stack[-1]
0x246: Call2 0xc3
...
0x25c: Stack[-4] = Stack[-11]
0x25d: Stack[-12] = Stack[-9]
0x25e: PushEmpty(int, object)
0x25f: Stack[-18] = Stack[-1]
0x260: Call2 0xc3
...
0x265: Push((float)0.30000001192092896)
0x266: Push((float)1.0)
0x267: Pop(1); Push(Stack[-1] - Stack[-15]);
0x268: Stack[-5] = Stack[-2] * Stack[-1]; Pop(2);
0x269: Stack[-3] = Stack[-11]
0x26a: Stack[-12] = Stack[-9]
0x26b: Push((int) 1)
0x26c: Pop(1); Push((bool) Stack[-12] > Stack[-1])
0x26d: IF (Stack[-1] == 0) GOTO 0x26f; Pop(1)

0x26e: Stack[-11] = (int) 1
0x26f: Push((float)0.029999999329447746)
0x270: Pop(1); Push((bool) Stack[-12] < Stack[-1])
0x271: IF (Stack[-1] == 0) GOTO 0x273; Pop(1)

0x272: Stack[-11] = (float) 0.029999999329447746
0x273: Push((int) -1)
0x274: Pop(1); Push((bool) Stack[-10] < Stack[-1])
0x275: IF (Stack[-1] == 0) GOTO 0x277; Pop(1)

0x276: Stack[-9] = (int) -1
0x277: @@@ RemoveAllItems(); Obj=4 // @poff=258
0x278: Pop(0)
0x279: @ CreateInvItem(Stack[-2])
0x27a: Pop(0)
0x27b: Push("organ_combination") // @poff=349
0x27c: @@ SetItemName(Stack[-1]); Obj=3 // @poff=297
0x27d: Pop(1)
0x27e: Push("DiseaseRate") // @poff=385
0x27f: @@ SetProperty(Stack[-1], Stack[-12]); Obj=3 // @poff=409
0x280: Pop(1)
0x281: Push("HealthIncrease") // @poff=421
0x282: @@ SetProperty(Stack[-1], Stack[-10]); Obj=3 // @poff=409
0x283: Pop(1)
0x284: Push((int) 0)
0x285: Push((int) 1)
0x286: @@@ AddItem(Stack[-3], Stack[-4], Stack[-2], Stack[-1]); Obj=4 // @poff=168
0x287: Pop(2)
...
0x2a8: Pop(1)
0x2a9: @@ add(Stack[-1]); Obj=2 // @poff=451
0x2aa: Pop(1)
...
0x2b3: Pop(1)
0x2b4: @@ add(Stack[-1]); Obj=2 // @poff=451
0x2b5: Pop(1)
0x2b6: Push((int) -1)
0x2b7: PushEmpty(string, int)
0x2b8: Stack[-5] = Stack[-1]
0x2b9: Call2 0x4cb
...
0x39e: Stack[-19] = Stack[-3]
0x39f: Stack[-18] = Stack[-2]
0x3a0: Stack[-17] = Stack[-1]
0x3a1: Call2 0x1d

0x3a2: Stack[-4] = Stack[-10]
0x3a3: Pop(4)
0x3a4: Return(); Pop(12)

0x3a5: Push("button_weapon") // @poff=471
...
0x3ae: Push("button_clothes") // @poff=499
...
0x3b7: Push("button_medcine") // @poff=529
...
0x3c0: Push("button_food") // @poff=559
...
0x3c9: Push("button_other") // @poff=583
...
0x3dd: Push("noinv_drop") // @poff=677
...
0x3ef: Stack[-1] = Stack[-4]
0x3f0: Pop(1)
0x3f1: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=245
0x3f2: Pop(0)
0x3f3: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x3f4: IF (Stack[-1] == 0) GOTO 0x405; Pop(1)

0x3f5: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=160
0x3f6: Pop(0)
...
0x3fe: Stack[-7] = Stack[-2]
0x3ff: Push((int) 0)
0x400: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x401: Call2 0x59

0x402: Stack[-3] = Stack[-9]
0x403: Pop(3)
0x404: Stack[-1] = 0
0x405: GOTO 0x40a
...
0x40d: Stack[-19] = Stack[-3]
0x40e: Stack[-18] = Stack[-2]
0x40f: Stack[-17] = Stack[-1]
0x410: Call2 0x1d

0x411: Stack[-4] = Stack[-10]
0x412: Pop(4)
0x413: Push(Stack[-6])
...
0x428: Pop(1)
0x429: Push("money") // @poff=699
0x42a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=323
0x42b: Pop(1)
...
0x43a: Push((int) 0)
0x43b: Push("button_weapon") // @poff=471
0x43c: @ SendMessage(Stack[-2], Stack[-1])
0x43d: Pop(2)
0x43e: GOTO 0x443

0x43f: Push((int) 1)
0x440: Push("button_weapon") // @poff=471
...
0x446: Push((int) 0)
0x447: Push("button_clothes") // @poff=499
0x448: @ SendMessage(Stack[-2], Stack[-1])
0x449: Pop(2)
0x44a: GOTO 0x44f

0x44b: Push((int) 1)
0x44c: Push("button_clothes") // @poff=499
...
0x452: Push((int) 0)
0x453: Push("button_medcine") // @poff=529
0x454: @ SendMessage(Stack[-2], Stack[-1])
0x455: Pop(2)
0x456: GOTO 0x45b

0x457: Push((int) 1)
0x458: Push("button_medcine") // @poff=529
...
0x45e: Push((int) 0)
0x45f: Push("button_food") // @poff=559
0x460: @ SendMessage(Stack[-2], Stack[-1])
0x461: Pop(2)
0x462: GOTO 0x467

0x463: Push((int) 1)
0x464: Push("button_food") // @poff=559
...
0x46a: Push((int) 0)
0x46b: Push("button_other") // @poff=583
0x46c: @ SendMessage(Stack[-2], Stack[-1])
0x46d: Pop(2)
0x46e: GOTO 0x473

0x46f: Push((int) 1)
0x470: Push("button_other") // @poff=583
...
0x478: Pop(1)
0x479: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=245
0x47a: Pop(0)
0x47b: Stack[-5] = (int) 0
0x47c: Push((int) 12)
...
0x481: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=160
0x482: Pop(0)
0x483: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=711
0x484: Pop(0)
0x485: PushEmpty(bool, int, int)
0x486: Stack[-8] = Stack[-2]
0x487: Stack[-18] = Stack[-1]
0x488: Call2 0x55

0x489: Stack[-3] = Stack[-5]
0x48a: Pop(3)
...
0x4dc: @@ GetItemID(Stack[-1]); Obj=3 // @poff=747
0x4dd: Pop(0)
