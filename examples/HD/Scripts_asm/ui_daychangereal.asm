...
Strings:
	...
	W:default
	W:branch
// @pool_raw:63005f00690057004d005f005200650061006c004400610079004300680061006e00670065000000640000007100300031000000620000006b00000061006c00690076006500000064006500610064000000640065006600610075006c00740000006200720061006e00630068000000
...
0x3: Stack[-1] = Stack[-5]
0x4: Pop(1)
0x5: Push("c_iWM_RealDayChange") // @poff=0
...
0x25: Stack[0 + Tasks[-1].StackPointer] = "alive" // @poff=60
0x26: Stack[7 + Tasks[-1].StackPointer] = (int)351
0x27: GOTO 0x2b

0x28: Stack[1 + Tasks[-1].StackPointer] = (bool)0
0x29: Stack[0 + Tasks[-1].StackPointer] = "dead" // @poff=72
0x2a: Stack[7 + Tasks[-1].StackPointer] = (int)350
0x2b: @ GetWindowSize(Stack[-4]T, Stack[-5]T)
0x2c: Pop(0)
0x2d: Push((bool) 1)
...
0x4f: @ GetStringByID(Stack[-3], Stack[-7]T)
0x50: Pop(0)
0x51: Push((float)1.0)
0x52: Stack[-3] = Stack[3 + Tasks[-1].StackPointer] / Stack[-1]; Pop(1);
0x53: Push("default") // @poff=82
0x54: Push((int) 0)
0x55: Push((int) 0)
0x56: Push((float)1.0)
0x57: Push((float)1.0)
0x58: Push((float)1.0)
0x59: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-4]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1], Stack[-8])
0x5a: Pop(6)
0x5b: Return(); Pop(6)
...
0x5f: Push("alive") // @poff=60
0x60: @ IsSoundPlaying(Stack[-2], Stack[-1])
0x61: Pop(1)
0x62: GOTO 0x66

0x63: Push("dead") // @poff=72
