...
Strings:
	...
	A:add
	W:history_text
	W:Error: missing replic
	W:ERROR: missing answer
// @pool_raw:
...
0x2: @ GetWindowSize(Stack[-5]T, Stack[-6]T)
0x3: Pop(0)
0x4: Push((bool) 1)
...
0x2f: Pop(1); Push(Stack[-1] / Stack[1 + Tasks[-1].StackPointer]);
0x30: Push("p_scrollbar") // @poff=0
...
0x37: Stack[-1] = Stack[-6]
0x38: Pop(1)
0x39: Push("default") // @poff=24
0x3a: Push((int) 5)
0x3b: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x3c: @ GetTextHeightInWidth(Stack[-9], Stack[-2], Stack[-1], Stack[-7])
0x3d: Pop(2)
0x3e: Stack[-7] = Stack[-6]
0x3f: Push((int) 10)
...
0x51: Stack[-2] = Stack[-3]
0x52: Pop(2)
0x53: Push("default") // @poff=24
0x54: Push((int) 15)
0x55: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x56: Push((int) 5)
...
0x67: Stack[-1] = Stack[-6]
0x68: Pop(1)
0x69: Push("default") // @poff=24
0x6a: Push((int) 0)
0x6b: Push((int) 5)
0x6c: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x6d: Push((float)0.8040000200271606)
0x6e: Push((float)0.8040000200271606)
0x6f: Push((float)0.8040000200271606)
0x70: @ PrintInWidth(Stack[-2]T, Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-11], Stack[-3], Stack[-2], Stack[-1])
0x71: Pop(6)
...
0x7d: Stack[-2] = Stack[-3]
0x7e: Pop(2)
0x7f: Pop(0); Push((bool) Stack[-2] == Stack[3 + Tasks[-1].StackPointer])
0x80: IF (Stack[-1] == 0) GOTO 0x8d; Pop(1)

0x81: Push("default") // @poff=24
0x82: Push((int) 15)
0x83: Push((int) 15)
0x84: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x85: Push((int) 5)
...
0x8d: Push("default") // @poff=24
0x8e: Push((int) 15)
0x8f: Push((int) 15)
0x90: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x91: Push((int) 5)
0x92: Pop(2); Push(Stack[-2] - Stack[-1]);
0x93: Push((float)0.6980000138282776)
0x94: Push((float)0.6589999794960022)
0x95: Push((float)0.6470000147819519)
...
0xa0: Pop(0); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[2 + Tasks[-1].StackPointer]);
0xa1: Push((int) 10)
...
0xaf: Stack[-5] = Stack[-1]
0xb0: Call2 0x174

0xb1: Stack[-2] = Stack[-3]
0xb2: Pop(2)
0xb3: Push("default") // @poff=24
0xb4: Push((int) 15)
0xb5: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0xb6: Push((int) 5)
...
0x168: Stack[-1] = "Error: missing replic" // @poff=70
