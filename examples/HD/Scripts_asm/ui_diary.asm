...
Strings:
	...
	W:button_daytasks
	W:button_othertasks
// @pool_raw:640065006600610075006c00740000007400650078007400000062007500740074006f006e005f006d0069007300730069006f006e00000062007500740074006f006e005f006400610079007400610073006b007300000062007500740074006f006e005f006f0074006800650072007400610073006b0073000000
...
0x0: @ GetDiarySelectedSection(Stack[-0]T)
0x1: Pop(0)
...
0x13: PushEmpty()
0x14: @ SetDiarySelectedSection(Stack[-0]T)
0x15: Pop(0)
0x16: @ DestroyWindow()
0x17: Pop(0)
0x18: Return(); Pop(0)
...
0x72: Push((int) 1000)
0x73: Push("text") // @poff=16
0x74: @ SendMessage(Stack[-2], Stack[-1])
0x75: Pop(2)
0x76: Return(); Pop(0)

0x77: PushEmpty()
0x78: Push("button_mission") // @poff=26
...
0x81: Push("button_daytasks") // @poff=56
...
0x8a: Push("button_othertasks") // @poff=88
...
0x97: Push((int) 0)
0x98: Push("button_mission") // @poff=26
0x99: @ SendMessage(Stack[-2], Stack[-1])
0x9a: Pop(2)
0x9b: GOTO 0xa0

0x9c: Push((int) 1)
0x9d: Push("button_mission") // @poff=26
...
0xa3: Push((int) 0)
0xa4: Push("button_daytasks") // @poff=56
0xa5: @ SendMessage(Stack[-2], Stack[-1])
0xa6: Pop(2)
0xa7: GOTO 0xac

0xa8: Push((int) 1)
0xa9: Push("button_daytasks") // @poff=56
...
0xaf: Push((int) 0)
0xb0: Push("button_othertasks") // @poff=88
0xb1: @ SendMessage(Stack[-2], Stack[-1])
0xb2: Pop(2)
0xb3: GOTO 0xb8

0xb4: Push((int) 1)
0xb5: Push("button_othertasks") // @poff=88
0xb6: @ SendMessage(Stack[-2], Stack[-1])
0xb7: Pop(2)
0xb8: Push("text") // @poff=16
