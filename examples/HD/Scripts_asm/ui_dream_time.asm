...
Strings:
	...
	W: : 
	W:0
// @pool_raw:640065006600610075006c007400000020003a002000000030000000
...
0x36: Push("default") // @poff=0
0x37: Push((float)1.0)
0x38: Push((float)1.0)
0x39: Push((float)1.0)
0x3a: @ Print(Stack[-4], Stack[-1]T, Stack[-2]T, Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x3b: Pop(4)
0x3c: Return(); Pop(0)
