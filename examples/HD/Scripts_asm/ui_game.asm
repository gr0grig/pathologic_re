...
Strings:
	...
	W:world_danko.xml
	W:player_danko.xml
	W:logo_gambitious.wmv
	W:logo_devolver.wmv
	W:logo_generalarcade.wmv
	W:logo_icepick.wmv
	W:intro.wmv
	W:game_buttons.xml
	W:editbox
	...
	W:DankoCompleted
	W:loading map: 
// @pool_raw:
// @pool_encoding:utf8
...
0x6f: Push("world_danko.xml") // @poff=93
0x70: Push("player_danko.xml") // @poff=125
...
0x77: Stack[-2] = "logo_gambitious.wmv" // @poff=159
0x78: Stack[-1] = (bool) 1
...
0x7e: Stack[-2] = "logo_devolver.wmv" // @poff=199
0x7f: Stack[-1] = (bool) 1
...
0x85: Stack[-2] = "logo_generalarcade.wmv" // @poff=235
0x86: Stack[-1] = (bool) 1
...
0x8c: Stack[-2] = "logo_icepick.wmv" // @poff=281
0x8d: Stack[-1] = (bool) 1
...
0x99: Stack[-2] = "intro.wmv" // @poff=315
0x9a: Stack[-1] = (bool) 1
...
0xa5: Push("game_buttons.xml") // @poff=335
0xa6: Push((bool) 0)
...
0xbb: Stack[-8] = Stack[-3]
0xbc: Stack[-7] = Stack[-2]
...
0xc2: Push("game_logo.xml") // @poff=389
0xc3: Push((bool) 0)
...
0xce: @ GetWindowSize(Stack[-0]T, Stack[-1]T)
0xcf: Pop(0)
0xd0: Push("default") // @poff=417
0xd1: @ SetCursor(Stack[-1])
0xd2: Pop(1)
0xd3: Push("default") // @poff=417
0xd4: @ SetBackground(Stack[-1])
0xd5: Pop(1)
0xd6: Push("menumusic") // @poff=433
...
0xdd: Stack[-1] = "" // @poff=64
0xde: Call2 0x3c9

0xdf: Pop(1)
0xe0: PushEmpty(string)
0xe1: Stack[-1] = "" // @poff=64
0xe2: Call2 0x3ce
...
0xe6: Push("game_choose_pers.xml") // @poff=453
0xe7: Push((bool) 0)
0xe8: @ CreateWindow(Stack[-2], Stack[-1], Stack[-5]T)
0xe9: Pop(2)
0xea: GOTO 0xf3
...
0x108: Stack[-2] = "intro_danko.wmv" // @poff=495
...
0x112: @ DestroyWindow()
0x113: Pop(0)
0x114: Push("world_danko.xml") // @poff=93
0x115: Push("player_danko.xml") // @poff=125
...
0x126: Stack[-2] = "intro_burah.wmv" // @poff=527
...
0x130: @ DestroyWindow()
0x131: Pop(0)
0x132: Push("world_burah.xml") // @poff=559
0x133: Push("player_burah.xml") // @poff=591
...
0x144: Stack[-2] = "intro_klara.wmv" // @poff=625
...
0x14e: @ DestroyWindow()
0x14f: Pop(0)
0x150: Push("world_klara.xml") // @poff=657
0x151: Push("player_klara.xml") // @poff=689
...
0x158: Push("menumusic") // @poff=433
0x159: @ PauseSound(Stack[-1])
0x15a: Pop(1)
0x15b: Push("Loading : ") // @poff=723
0x15c: Pop(1); Push(Stack[-1] + Stack[10 + Tasks[-1].StackPointer]);
0x15d: @ Trace(Stack[-1])
0x15e: Pop(1)
0x15f: @ RemoveWorld()
0x160: Pop(0)
...
0x163: @ DestroyWindow()
0x164: Pop(0)
0x165: @ LoadGame(Stack[-4], Stack[-10]T)
0x166: Pop(0)
0x167: GOTO 0x186
...
0x172: @ DestroyWindow()
0x173: Pop(0)
0x174: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=745
0x175: Pop(0)
...
0x180: @ DestroyWindow()
0x181: Pop(0)
0x182: Push("world_intro.xml") // @poff=757
0x183: Push("player_intro.xml") // @poff=789
...
0x1a6: Pop(0)
0x1a7: Push("load.xml") // @poff=895
0x1a8: Push((bool) 0)
0x1a9: @ CreateWindow(Stack[-2], Stack[-1], Stack[-6]T)
0x1aa: Pop(2)
0x1ab: Return(); Pop(0)

0x1ac: GOTO 0x29e

0x1ad: Push("savegame") // @poff=913
...
0x1b2: Pop(0)
0x1b3: Push("save.xml") // @poff=931
0x1b4: Push((bool) 0)
0x1b5: @ CreateWindow(Stack[-2], Stack[-1], Stack[-7]T)
0x1b6: Pop(2)
0x1b7: Return(); Pop(0)

0x1b8: GOTO 0x29e

0x1b9: Push("gameoptions") // @poff=949
...
0x1be: Pop(0)
0x1bf: Push("options.xml") // @poff=973
0x1c0: Push((bool) 0)
0x1c1: @ CreateWindow(Stack[-2], Stack[-1], Stack[-8]T)
0x1c2: Pop(2)
0x1c3: Return(); Pop(0)

0x1c4: GOTO 0x29e

0x1c5: Push("continue") // @poff=997
...
0x1e7: Stack[-1] = "" // @poff=64
0x1e8: Call2 0x3c9

0x1e9: Pop(1)
0x1ea: GOTO 0x29e

0x1eb: Push("danko") // @poff=1031
...
0x1f8: Push((int) 202)
0x1f9: Push("player_name") // @poff=1043
0x1fa: @ SendMessage(Stack[-2], Stack[-1])
0x1fb: Pop(2)
0x1fc: Push((int) 203)
0x1fd: Push("player_desc") // @poff=1067
...
0x204: Push((int) -1)
0x205: Push("player_name") // @poff=1043
0x206: @ SendMessage(Stack[-2], Stack[-1])
0x207: Pop(2)
0x208: Push((int) -1)
0x209: Push("player_desc") // @poff=1067
...
0x21b: Push((int) 205)
0x21c: Push("player_name") // @poff=1043
0x21d: @ SendMessage(Stack[-2], Stack[-1])
0x21e: Pop(2)
0x21f: Push((int) 206)
0x220: Push("player_desc") // @poff=1067
...
0x227: Push((int) -1)
0x228: Push("player_name") // @poff=1043
0x229: @ SendMessage(Stack[-2], Stack[-1])
0x22a: Pop(2)
0x22b: Push((int) -1)
0x22c: Push("player_desc") // @poff=1067
...
0x24d: Push((int) 208)
0x24e: Push("player_name") // @poff=1043
...
0x25f: Push((int) 213)
0x260: Push("player_desc") // @poff=1067
0x261: @ SendMessage(Stack[-2], Stack[-1])
0x262: Pop(2)
0x263: GOTO 0x268

0x264: Push((int) 209)
0x265: Push("player_desc") // @poff=1067
...
0x26c: Push((int) -1)
0x26d: Push("player_name") // @poff=1043
0x26e: @ SendMessage(Stack[-2], Stack[-1])
0x26f: Pop(2)
0x270: Push((int) -1)
0x271: Push("player_desc") // @poff=1067
...
0x27d: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=745
0x27e: Pop(0)
...
0x2f5: Push((int) 1)
0x2f6: Push("danko") // @poff=1031
0x2f7: @ SendMessage(Stack[-2], Stack[-1])
0x2f8: Pop(2)
0x2f9: PushEmpty(string)
0x2fa: Stack[-1] = "danko" // @poff=1031
0x2fb: Call2 0x3ce
...
0x334: Push((int) 1)
0x335: Push("klara") // @poff=1103
0x336: @ SendMessage(Stack[-2], Stack[-1])
0x337: Pop(2)
0x338: PushEmpty(string)
0x339: Stack[-1] = "klara" // @poff=1103
0x33a: Call2 0x3ce
...
0x373: Push((int) 1)
0x374: Push("newgame") // @poff=823
0x375: @ SendMessage(Stack[-2], Stack[-1])
0x376: Pop(2)
0x377: PushEmpty(string)
0x378: Stack[-1] = "newgame" // @poff=823
0x379: Call2 0x3c9
...
0x3da: Push((int) 1)
0x3db: Push("quitgame") // @poff=839
0x3dc: @ SendMessage(Stack[-2], Stack[-1])
0x3dd: Pop(2)
0x3de: PushEmpty(string)
0x3df: Stack[-1] = "quitgame" // @poff=839
0x3e0: Call2 0x3c9
...
0x49d: Push("BurahCompleted") // @poff=1135
0x49e: Push((int) 0)
...
0x4a5: Push("DankoCompleted") // @poff=1165
0x4a6: Push((int) 0)
...
0x4ad: Push("loading map: ") // @poff=1195
