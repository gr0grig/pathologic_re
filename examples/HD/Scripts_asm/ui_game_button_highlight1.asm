...
Strings:
	W:default
	W:disabled
// @pool_raw:640065006600610075006c0074000000640069007300610062006c00650064000000
...
0xe: IF (Stack[-1] == 1) GOTO 0x12; Pop(1)
...
0x35: Stack[0 + Tasks[-1].StackPointer] = (bool)0
0x36: Push((int) 2)
0x37: @ SendMessageToParent(Stack[-1])
0x38: Pop(1)
0x39: GOTO 0x4a
...
0x3e: Push((int) 1)
0x3f: @ SendMessageToParent(Stack[-1])
0x40: Pop(1)
0x41: GOTO 0x4a
...
0x45: Pop(0); Push((bool) Stack[1 + Tasks[-1].StackPointer] == 0)
0x46: IF (Stack[-1] == 0) GOTO 0x4a; Pop(1)

0x47: Push((int) 0)
0x48: @ SendMessageToParent(Stack[-1])
0x49: Pop(1)
0x4a: Return(); Pop(0)
