...
Strings:
	...
	W:BurahCompleted
	W:DankoCompleted
// @pool_raw:
// @pool_encoding:utf8
...
0x74: Stack[-2] = "death_fail.wmv" // @poff=93
0x75: Stack[-1] = (bool) 1
...
0x80: Push("game_buttons.xml") // @poff=123
0x81: Push((bool) 0)
...
0x88: Push("game_logo.xml") // @poff=157
0x89: Push((bool) 0)
...
0x95: Pop(0)
0x96: Push("default") // @poff=185
0x97: @ SetCursor(Stack[-1])
0x98: Pop(1)
0x99: Push("default") // @poff=185
0x9a: @ SetBackground(Stack[-1])
0x9b: Pop(1)
0x9c: Push("menumusic") // @poff=201
...
0xac: Push("game_choose_pers.xml") // @poff=221
0xad: Push((bool) 0)
...
0xce: Stack[-2] = "intro_danko.wmv" // @poff=263
0xcf: Stack[-1] = (bool) 1
...
0xd8: @ DestroyWindow()
0xd9: Pop(0)
0xda: Push("world_danko.xml") // @poff=295
0xdb: Push("player_danko.xml") // @poff=327
...
0xec: Stack[-2] = "intro_burah.wmv" // @poff=361
0xed: Stack[-1] = (bool) 1
...
0xf6: @ DestroyWindow()
0xf7: Pop(0)
0xf8: Push("world_burah.xml") // @poff=393
0xf9: Push("player_burah.xml") // @poff=425
...
0x10a: Stack[-2] = "intro_klara.wmv" // @poff=459
...
0x114: @ DestroyWindow()
0x115: Pop(0)
0x116: Push("world_klara.xml") // @poff=491
0x117: Push("player_klara.xml") // @poff=523
...
0x11e: Push("menumusic") // @poff=201
0x11f: @ PauseSound(Stack[-1])
0x120: Pop(1)
0x121: Push("Loading : ") // @poff=557
...
0x138: @ DestroyWindow()
0x139: Pop(0)
0x13a: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=579
0x13b: Pop(0)
...
0x146: @ DestroyWindow()
0x147: Pop(0)
0x148: Push("world_intro.xml") // @poff=591
0x149: Push("player_intro.xml") // @poff=623
...
0x17f: Push("gameoptions") // @poff=783
...
0x184: Pop(0)
0x185: Push("options.xml") // @poff=807
0x186: Push((bool) 0)
...
0x1be: Push((int) 202)
0x1bf: Push("player_name") // @poff=877
0x1c0: @ SendMessage(Stack[-2], Stack[-1])
0x1c1: Pop(2)
0x1c2: Push((int) 203)
0x1c3: Push("player_desc") // @poff=901
...
0x1ca: Push((int) -1)
0x1cb: Push("player_name") // @poff=877
0x1cc: @ SendMessage(Stack[-2], Stack[-1])
0x1cd: Pop(2)
0x1ce: Push((int) -1)
0x1cf: Push("player_desc") // @poff=901
...
0x1e1: Push((int) 205)
0x1e2: Push("player_name") // @poff=877
0x1e3: @ SendMessage(Stack[-2], Stack[-1])
0x1e4: Pop(2)
0x1e5: Push((int) 206)
0x1e6: Push("player_desc") // @poff=901
...
0x1ed: Push((int) -1)
0x1ee: Push("player_name") // @poff=877
0x1ef: @ SendMessage(Stack[-2], Stack[-1])
0x1f0: Pop(2)
0x1f1: Push((int) -1)
0x1f2: Push("player_desc") // @poff=901
...
0x213: Push((int) 208)
0x214: Push("player_name") // @poff=877
...
0x225: Push((int) 213)
0x226: Push("player_desc") // @poff=901
0x227: @ SendMessage(Stack[-2], Stack[-1])
0x228: Pop(2)
0x229: GOTO 0x22e

0x22a: Push((int) 209)
0x22b: Push("player_desc") // @poff=901
...
0x232: Push((int) -1)
0x233: Push("player_name") // @poff=877
0x234: @ SendMessage(Stack[-2], Stack[-1])
0x235: Pop(2)
0x236: Push((int) -1)
0x237: Push("player_desc") // @poff=901
...
0x243: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=579
0x244: Pop(0)
...
0x339: Push((int) 1)
0x33a: Push("newgame") // @poff=657
0x33b: @ SendMessage(Stack[-2], Stack[-1])
0x33c: Pop(2)
0x33d: PushEmpty(string)
0x33e: Stack[-1] = "newgame" // @poff=657
0x33f: Call2 0x38f
...
0x3a0: Push((int) 1)
0x3a1: Push("quitgame") // @poff=673
0x3a2: @ SendMessage(Stack[-2], Stack[-1])
0x3a3: Pop(2)
0x3a4: PushEmpty(string)
0x3a5: Stack[-1] = "quitgame" // @poff=673
0x3a6: Call2 0x38f
...
0x463: Push("BurahCompleted") // @poff=969
0x464: Push((int) 0)
...
0x46b: Push("DankoCompleted") // @poff=999
0x46c: Push((int) 0)
