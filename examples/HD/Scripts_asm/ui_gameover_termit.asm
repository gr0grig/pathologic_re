...
Strings:
	...
	W:BurahCompleted
	W:DankoCompleted
// @pool_raw:
// @pool_encoding:utf8
...
0x74: Stack[-2] = "fin_termit.wmv" // @poff=93
0x75: Stack[-1] = (bool) 0
...
0x89: Push("game_buttons.xml") // @poff=143
0x8a: Push((bool) 0)
...
0x91: Push("game_logo.xml") // @poff=177
0x92: Push((bool) 0)
...
0x9d: @ GetWindowSize(Stack[-0]T, Stack[-1]T)
0x9e: Pop(0)
0x9f: Push("default") // @poff=205
0xa0: @ SetCursor(Stack[-1])
0xa1: Pop(1)
0xa2: Push("default") // @poff=205
0xa3: @ SetBackground(Stack[-1])
0xa4: Pop(1)
0xa5: Push("menumusic") // @poff=123
...
0xac: Stack[-1] = "" // @poff=64
0xad: Call2 0x398

0xae: Pop(1)
0xaf: PushEmpty(string)
0xb0: Stack[-1] = "" // @poff=64
0xb1: Call2 0x39d
...
0xb5: Push("game_choose_pers.xml") // @poff=221
0xb6: Push((bool) 0)
0xb7: @ CreateWindow(Stack[-2], Stack[-1], Stack[-5]T)
0xb8: Pop(2)
0xb9: GOTO 0xc2
...
0xd7: Stack[-2] = "intro_danko.wmv" // @poff=263
0xd8: Stack[-1] = (bool) 1
...
0xe1: @ DestroyWindow()
0xe2: Pop(0)
0xe3: Push("world_danko.xml") // @poff=295
0xe4: Push("player_danko.xml") // @poff=327
...
0xf5: Stack[-2] = "intro_burah.wmv" // @poff=361
0xf6: Stack[-1] = (bool) 1
...
0xff: @ DestroyWindow()
0x100: Pop(0)
0x101: Push("world_burah.xml") // @poff=393
0x102: Push("player_burah.xml") // @poff=425
...
0x113: Stack[-2] = "intro_klara.wmv" // @poff=459
...
0x11d: @ DestroyWindow()
0x11e: Pop(0)
0x11f: Push("world_klara.xml") // @poff=491
0x120: Push("player_klara.xml") // @poff=523
...
0x127: Push("menumusic") // @poff=123
0x128: @ PauseSound(Stack[-1])
0x129: Pop(1)
0x12a: Push("Loading : ") // @poff=557
0x12b: Pop(1); Push(Stack[-1] + Stack[10 + Tasks[-1].StackPointer]);
0x12c: @ Trace(Stack[-1])
0x12d: Pop(1)
0x12e: @ RemoveWorld()
0x12f: Pop(0)
...
0x132: @ DestroyWindow()
0x133: Pop(0)
0x134: @ LoadGame(Stack[-4], Stack[-10]T)
0x135: Pop(0)
0x136: GOTO 0x155
...
0x141: @ DestroyWindow()
0x142: Pop(0)
0x143: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=579
0x144: Pop(0)
...
0x14f: @ DestroyWindow()
0x150: Pop(0)
0x151: Push("world_intro.xml") // @poff=591
0x152: Push("player_intro.xml") // @poff=623
...
0x175: Pop(0)
0x176: Push("load.xml") // @poff=729
0x177: Push((bool) 0)
0x178: @ CreateWindow(Stack[-2], Stack[-1], Stack[-6]T)
0x179: Pop(2)
0x17a: Return(); Pop(0)

0x17b: GOTO 0x26d

0x17c: Push("savegame") // @poff=747
...
0x181: Pop(0)
0x182: Push("save.xml") // @poff=765
0x183: Push((bool) 0)
0x184: @ CreateWindow(Stack[-2], Stack[-1], Stack[-7]T)
0x185: Pop(2)
0x186: Return(); Pop(0)

0x187: GOTO 0x26d

0x188: Push("gameoptions") // @poff=783
...
0x18d: Pop(0)
0x18e: Push("options.xml") // @poff=807
0x18f: Push((bool) 0)
0x190: @ CreateWindow(Stack[-2], Stack[-1], Stack[-8]T)
0x191: Pop(2)
0x192: Return(); Pop(0)

0x193: GOTO 0x26d

0x194: Push("continue") // @poff=831
...
0x1b6: Stack[-1] = "" // @poff=64
0x1b7: Call2 0x398

0x1b8: Pop(1)
0x1b9: GOTO 0x26d

0x1ba: Push("danko") // @poff=865
...
0x1c7: Push((int) 202)
0x1c8: Push("player_name") // @poff=877
0x1c9: @ SendMessage(Stack[-2], Stack[-1])
0x1ca: Pop(2)
0x1cb: Push((int) 203)
0x1cc: Push("player_desc") // @poff=901
...
0x1d3: Push((int) -1)
0x1d4: Push("player_name") // @poff=877
0x1d5: @ SendMessage(Stack[-2], Stack[-1])
0x1d6: Pop(2)
0x1d7: Push((int) -1)
0x1d8: Push("player_desc") // @poff=901
...
0x1ea: Push((int) 205)
0x1eb: Push("player_name") // @poff=877
0x1ec: @ SendMessage(Stack[-2], Stack[-1])
0x1ed: Pop(2)
0x1ee: Push((int) 206)
0x1ef: Push("player_desc") // @poff=901
...
0x1f6: Push((int) -1)
0x1f7: Push("player_name") // @poff=877
0x1f8: @ SendMessage(Stack[-2], Stack[-1])
0x1f9: Pop(2)
0x1fa: Push((int) -1)
0x1fb: Push("player_desc") // @poff=901
...
0x21c: Push((int) 208)
0x21d: Push("player_name") // @poff=877
...
0x22e: Push((int) 213)
0x22f: Push("player_desc") // @poff=901
0x230: @ SendMessage(Stack[-2], Stack[-1])
0x231: Pop(2)
0x232: GOTO 0x237

0x233: Push((int) 209)
0x234: Push("player_desc") // @poff=901
...
0x23b: Push((int) -1)
0x23c: Push("player_name") // @poff=877
0x23d: @ SendMessage(Stack[-2], Stack[-1])
0x23e: Pop(2)
0x23f: Push((int) -1)
0x240: Push("player_desc") // @poff=901
...
0x24c: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=579
0x24d: Pop(0)
...
0x342: Push((int) 1)
0x343: Push("newgame") // @poff=657
0x344: @ SendMessage(Stack[-2], Stack[-1])
0x345: Pop(2)
0x346: PushEmpty(string)
0x347: Stack[-1] = "newgame" // @poff=657
0x348: Call2 0x398
...
0x3a9: Push((int) 1)
0x3aa: Push("quitgame") // @poff=673
0x3ab: @ SendMessage(Stack[-2], Stack[-1])
0x3ac: Pop(2)
0x3ad: PushEmpty(string)
0x3ae: Stack[-1] = "quitgame" // @poff=673
0x3af: Call2 0x398
...
0x46c: Push("BurahCompleted") // @poff=969
0x46d: Push((int) 0)
...
0x474: Push("DankoCompleted") // @poff=999
0x475: Push((int) 0)
