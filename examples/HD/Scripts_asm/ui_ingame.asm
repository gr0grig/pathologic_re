...
Strings:
	...
	W:BurahCompleted
	W:DankoCompleted
// @pool_raw:
// @pool_encoding:utf8
...
0x75: Push("ingame_buttons.xml") // @poff=93
0x76: Push((bool) 0)
...
0x94: Push((int) 0)
0x95: Push("continue") // @poff=131
0x96: @ SendMessage(Stack[-2], Stack[-1])
0x97: Pop(2)
0x98: Push((int) 0)
0x99: Push("newgame") // @poff=149
0x9a: @ SendMessage(Stack[-2], Stack[-1])
0x9b: Pop(2)
0x9c: Push((int) 0)
0x9d: Push("loadgame") // @poff=165
0x9e: @ SendMessage(Stack[-2], Stack[-1])
0x9f: Pop(2)
0xa0: Push((int) 0)
0xa1: Push("savegame") // @poff=183
0xa2: @ SendMessage(Stack[-2], Stack[-1])
0xa3: Pop(2)
0xa4: Push((int) 0)
0xa5: Push("gameoptions") // @poff=201
0xa6: @ SendMessage(Stack[-2], Stack[-1])
0xa7: Pop(2)
0xa8: Push((int) 0)
0xa9: Push("quitgame") // @poff=225
...
0xb6: Push((int) 1)
0xb7: Push("continue") // @poff=131
0xb8: @ SendMessage(Stack[-2], Stack[-1])
0xb9: Pop(2)
0xba: PushEmpty(string)
0xbb: Stack[-1] = "continue" // @poff=131
0xbc: Call2 0x11b
...
0x127: Push((int) 1)
0x128: Push("quitgame") // @poff=225
0x129: @ SendMessage(Stack[-2], Stack[-1])
0x12a: Pop(2)
0x12b: PushEmpty(string)
0x12c: Stack[-1] = "quitgame" // @poff=225
0x12d: Call2 0x11b
...
0x1c3: Push("game_logo.xml") // @poff=243
0x1c4: Push((bool) 0)
0x1c5: @ CreateWindow(Stack[-2], Stack[-1], Stack[-3])
0x1c6: Pop(2)
0x1c7: Stack[-1] = Stack[-3]
0x1c8: Return(); Pop(2)
...
0x1cf: @ GetWindowSize(Stack[-0]T, Stack[-1]T)
0x1d0: Pop(0)
0x1d1: Push("default") // @poff=271
0x1d2: @ SetCursor(Stack[-1])
0x1d3: Pop(1)
0x1d4: Push("default") // @poff=271
0x1d5: @ SetBackground(Stack[-1])
0x1d6: Pop(1)
0x1d7: Push("menumusic") // @poff=287
...
0x1de: Stack[-1] = "" // @poff=64
0x1df: Call2 0x11b

0x1e0: Pop(1)
0x1e1: PushEmpty(string)
0x1e2: Stack[-1] = "" // @poff=64
0x1e3: Call2 0x3c3
...
0x1e7: Push("game_choose_pers.xml") // @poff=307
0x1e8: Push((bool) 0)
0x1e9: @ CreateWindow(Stack[-2], Stack[-1], Stack[-5]T)
0x1ea: Pop(2)
0x1eb: GOTO 0x1f4
...
0x209: Stack[-2] = "intro_danko.wmv" // @poff=349
...
0x213: @ DestroyWindow()
0x214: Pop(0)
0x215: Push("world_danko.xml") // @poff=381
0x216: Push("player_danko.xml") // @poff=413
...
0x227: Stack[-2] = "intro_burah.wmv" // @poff=447
...
0x231: @ DestroyWindow()
0x232: Pop(0)
0x233: Push("world_burah.xml") // @poff=479
0x234: Push("player_burah.xml") // @poff=511
...
0x245: Stack[-2] = "intro_klara.wmv" // @poff=545
...
0x24f: @ DestroyWindow()
0x250: Pop(0)
0x251: Push("world_klara.xml") // @poff=577
0x252: Push("player_klara.xml") // @poff=609
...
0x259: Push("menumusic") // @poff=287
0x25a: @ PauseSound(Stack[-1])
0x25b: Pop(1)
0x25c: Push("Loading : ") // @poff=643
0x25d: Pop(1); Push(Stack[-1] + Stack[10 + Tasks[-1].StackPointer]);
0x25e: @ Trace(Stack[-1])
0x25f: Pop(1)
0x260: @ RemoveWorld()
0x261: Pop(0)
...
0x264: @ DestroyWindow()
0x265: Pop(0)
0x266: @ LoadGame(Stack[-4], Stack[-10]T)
0x267: Pop(0)
0x268: GOTO 0x287
...
0x273: @ DestroyWindow()
0x274: Pop(0)
0x275: @@@ GetFileName(Stack[-1]); Obj=9 // @poff=665
0x276: Pop(0)
...
0x281: @ DestroyWindow()
0x282: Pop(0)
0x283: Push("world_intro.xml") // @poff=677
0x284: Push("player_intro.xml") // @poff=709
0x285: @ NewGame(Stack[-2], Stack[-1])
0x286: Pop(2)
0x287: Return(); Pop(8)

0x288: PushEmpty()
0x289: Push("newgame") // @poff=149
...
0x29f: Pop(0)
0x2a0: Push("load.xml") // @poff=763
0x2a1: Push((bool) 0)
0x2a2: @ CreateWindow(Stack[-2], Stack[-1], Stack[-6]T)
0x2a3: Pop(2)
0x2a4: Return(); Pop(0)

0x2a5: GOTO 0x397

0x2a6: Push("savegame") // @poff=183
...
0x2ab: Pop(0)
0x2ac: Push("save.xml") // @poff=781
0x2ad: Push((bool) 0)
0x2ae: @ CreateWindow(Stack[-2], Stack[-1], Stack[-7]T)
0x2af: Pop(2)
0x2b0: Return(); Pop(0)

0x2b1: GOTO 0x397

0x2b2: Push("gameoptions") // @poff=201
...
0x2b7: Pop(0)
0x2b8: Push("options.xml") // @poff=799
0x2b9: Push((bool) 0)
0x2ba: @ CreateWindow(Stack[-2], Stack[-1], Stack[-8]T)
0x2bb: Pop(2)
0x2bc: Return(); Pop(0)

0x2bd: GOTO 0x397

0x2be: Push("continue") // @poff=131
...
0x2e0: Stack[-1] = "" // @poff=64
0x2e1: Call2 0x11b

0x2e2: Pop(1)
0x2e3: GOTO 0x397

0x2e4: Push("danko") // @poff=839
...
0x2f1: Push((int) 202)
0x2f2: Push("player_name") // @poff=851
0x2f3: @ SendMessage(Stack[-2], Stack[-1])
0x2f4: Pop(2)
0x2f5: Push((int) 203)
0x2f6: Push("player_desc") // @poff=875
...
0x2fd: Push((int) -1)
0x2fe: Push("player_name") // @poff=851
0x2ff: @ SendMessage(Stack[-2], Stack[-1])
0x300: Pop(2)
0x301: Push((int) -1)
0x302: Push("player_desc") // @poff=875
...
0x314: Push((int) 205)
0x315: Push("player_name") // @poff=851
0x316: @ SendMessage(Stack[-2], Stack[-1])
0x317: Pop(2)
0x318: Push((int) 206)
0x319: Push("player_desc") // @poff=875
...
0x320: Push((int) -1)
0x321: Push("player_name") // @poff=851
0x322: @ SendMessage(Stack[-2], Stack[-1])
0x323: Pop(2)
0x324: Push((int) -1)
0x325: Push("player_desc") // @poff=875
...
0x346: Push((int) 208)
0x347: Push("player_name") // @poff=851
...
0x358: Push((int) 213)
0x359: Push("player_desc") // @poff=875
0x35a: @ SendMessage(Stack[-2], Stack[-1])
0x35b: Pop(2)
0x35c: GOTO 0x361

0x35d: Push((int) 209)
0x35e: Push("player_desc") // @poff=875
...
0x365: Push((int) -1)
0x366: Push("player_name") // @poff=851
0x367: @ SendMessage(Stack[-2], Stack[-1])
0x368: Pop(2)
0x369: Push((int) -1)
0x36a: Push("player_desc") // @poff=875
...
0x376: @@ GetFileName(Stack[-10]T); Obj=1 // @poff=665
0x377: Pop(0)
...
0x3c7: Push("BurahCompleted") // @poff=943
0x3c8: Push((int) 0)
...
0x3cf: Push("DankoCompleted") // @poff=973
0x3d0: Push((int) 0)
