...
Strings:
	...
	A:get
	A:size
// @pool_raw:
...
0x6: @ GetWindowSize(Stack[-3]T, Stack[-4]T)
0x7: Pop(0)
0x8: Push((bool) 1)
...
0x38: Push("intro1") // @poff=72
0x39: @ IsSoundPlaying(Stack[-2], Stack[-1])
0x3a: Pop(1)
0x3b: GOTO 0x3f

0x3c: Push("intro2") // @poff=86
...
0x46: Push((int) 204)
0x47: @ GetStringByID(Stack[-10]T, Stack[-1])
0x48: Pop(1)
0x49: Push("intro_danko") // @poff=0
...
0x50: Push((int) 207)
0x51: @ GetStringByID(Stack[-10]T, Stack[-1])
0x52: Pop(1)
0x53: Push("intro_burah") // @poff=24
...
0x5a: Push((int) 210)
0x5b: @ GetStringByID(Stack[-10]T, Stack[-1])
0x5c: Pop(1)
0x5d: Push("intro_klara") // @poff=48
...
0x64: Push((int) 2)
0x65: @ irand(Stack[-8]T, Stack[-1])
0x66: Pop(1)
0x67: Push( Stack[8 + Tasks[-1].StackPointer] )
0x68: IF (Stack[-1] == 0) GOTO 0x70; Pop(1)

0x69: Push((int) 211)
0x6a: @ GetStringByID(Stack[-10]T, Stack[-1])
0x6b: Pop(1)
0x6c: Push("intro1") // @poff=72
0x6d: @ PlaySound(Stack[-1])
0x6e: Pop(1)
0x6f: GOTO 0x76

0x70: Push((int) 212)
0x71: @ GetStringByID(Stack[-10]T, Stack[-1])
0x72: Pop(1)
0x73: Push("intro2") // @poff=86
0x74: @ PlaySound(Stack[-1])
0x75: Pop(1)
0x76: GOTO 0x7a

0x77: Push((int) 600)
0x78: @ GetStringByID(Stack[-10]T, Stack[-1])
0x79: Pop(1)
0x7a: Push("intro_font") // @poff=100
0x7b: Push((int) 2)
0x7c: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] * Stack[-1]);
0x7d: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] - Stack[-1]);
0x7e: Push((int) 8)
0x7f: Pop(2); Push(Stack[-2] - Stack[-1]);
0x80: @ GetTextHeightInWidth(Stack[-5]T, Stack[-2], Stack[-1], Stack[-10]T)
0x81: Pop(2)
...
0x8b: IF (Stack[-1] == 1) GOTO 0x90; Pop(1)
...
0x8f: Stack[-1] = (bool) 0
0x90: IF (Stack[-1] == 1) GOTO 0x95; Pop(1)
...
0x9e: IF (Stack[-1] == 1) GOTO 0xa3; Pop(1)

0x9f: Push((int) 267)
0xa0: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xa1: IF (Stack[-1] == 1) GOTO 0xa3; Pop(1)

0xa2: Stack[-1] = (bool) 0
0xa3: IF (Stack[-1] == 1) GOTO 0xa8; Pop(1)

0xa4: Push((int) 272)
0xa5: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xa6: IF (Stack[-1] == 1) GOTO 0xa8; Pop(1)
...
0xb3: IF (Stack[-1] == 1) GOTO 0xb8; Pop(1)
...
0xb7: Stack[-1] = (bool) 0
0xb8: IF (Stack[-1] == 1) GOTO 0xbd; Pop(1)

0xb9: Push((int) 257)
0xba: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0xbb: IF (Stack[-1] == 1) GOTO 0xbd; Pop(1)

0xbc: Stack[-1] = (bool) 0
0xbd: IF (Stack[-1] == 1) GOTO 0xc2; Pop(1)

0xbe: Push((int) 262)
0xbf: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0xc0: IF (Stack[-1] == 1) GOTO 0xc2; Pop(1)
...
0xce: IF (Stack[-1] == 1) GOTO 0xd3; Pop(1)
...
0xd2: Stack[-1] = (bool) 0
0xd3: IF (Stack[-1] == 1) GOTO 0xd8; Pop(1)
...
0xe1: IF (Stack[-1] == 1) GOTO 0xe6; Pop(1)
...
0xe5: Stack[-1] = (bool) 0
0xe6: IF (Stack[-1] == 1) GOTO 0xeb; Pop(1)
...
0x103: Push("intro_klara") // @poff=48
...
0x109: Push("intro1") // @poff=72
0x10a: @ PauseSound(Stack[-1])
0x10b: Pop(1)
0x10c: GOTO 0x110

0x10d: Push("intro2") // @poff=86
...
0x131: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] + Stack[5 + Tasks[-1].StackPointer]);
...
0x158: Push("ul") // @poff=122
0x159: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x15a: IF (Stack[-1] == 1) GOTO 0x15f; Pop(1)

0x15b: Push("bl") // @poff=128
0x15c: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x15d: IF (Stack[-1] == 1) GOTO 0x15f; Pop(1)

0x15e: Stack[-1] = (bool) 0
0x15f: IF (Stack[-1] == 1) GOTO 0x164; Pop(1)

0x160: Push("br") // @poff=134
0x161: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x162: IF (Stack[-1] == 1) GOTO 0x164; Pop(1)

0x163: Stack[-1] = (bool) 0
0x164: IF (Stack[-1] == 1) GOTO 0x169; Pop(1)

0x165: Push("ur") // @poff=140
0x166: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x167: IF (Stack[-1] == 1) GOTO 0x169; Pop(1)
...
0x17b: Push("intro_font") // @poff=100
0x17c: Push((int) 4)
0x17d: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] + Stack[-1]);
0x17e: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] - Stack[-5]);
0x17f: Push((int) 2)
0x180: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] * Stack[-1]);
0x181: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] - Stack[-1]);
0x182: Push((int) 8)
0x183: Pop(2); Push(Stack[-2] - Stack[-1]);
0x184: Push((float)0.24313725531101227)
0x185: Push((float)0.12156862765550613)
0x186: Push((float)0.11764705926179886)
0x187: Push((int) 1)
0x188: Pop(1); Push(Stack[-1] - Stack[-10]);
0x189: @ PrintInWidth(Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-10]T, Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x18a: Pop(8)
0x18b: Push("intro_font") // @poff=100
0x18c: Push((int) 4)
0x18d: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] + Stack[-1]);
0x18e: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] - Stack[-5]);
0x18f: Push((int) 1)
0x190: Pop(2); Push(Stack[-2] - Stack[-1]);
0x191: Push((int) 2)
0x192: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] * Stack[-1]);
0x193: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] - Stack[-1]);
0x194: Push((int) 8)
0x195: Pop(2); Push(Stack[-2] - Stack[-1]);
0x196: Push((float)0.24313725531101227)
0x197: Push((float)0.12156862765550613)
0x198: Push((float)0.11764705926179886)
0x199: @ PrintInWidth(Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-10]T, Stack[-3], Stack[-2], Stack[-1], Stack[-9])
0x19a: Pop(7)
0x19b: Return(); Pop(6)

0x19c: Stack[9 + Tasks[-1].StackPointer] = (int)0
0x19d: @ CreateStringVector(Stack[-14]T)
0x19e: Pop(0)
0x19f: Push("ul") // @poff=122
0x1a0: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1a1: Pop(1)
0x1a2: Push("ur") // @poff=140
0x1a3: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1a4: Pop(1)
0x1a5: Push("br") // @poff=134
0x1a6: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1a7: Pop(1)
0x1a8: Push("ul") // @poff=122
0x1a9: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1aa: Pop(1)
0x1ab: Push("br") // @poff=134
0x1ac: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1ad: Pop(1)
0x1ae: Push("ul") // @poff=122
0x1af: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1b0: Pop(1)
0x1b1: Push("bl") // @poff=128
0x1b2: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1b3: Pop(1)
0x1b4: Push("ul") // @poff=122
0x1b5: @@@ add(Stack[-1]); Obj=14 // @poff=146
0x1b6: Pop(1)
0x1b7: Return(); Pop(0)

0x1b8: PushEmpty(string, int, string, int)
0x1b9: @@@ get(Stack[-2], Stack[-9]T); Obj=14 // @poff=150
0x1ba: Pop(0)
0x1bb: Push((int) 0)
...
0x1c0: @@@ size(Stack[-1]); Obj=14 // @poff=154
0x1c1: Pop(0)
