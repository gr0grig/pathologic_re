...
Strings:
	W:intro
// @pool_raw:69006e00740072006f000000
...
0x1: @ GetWindowSize(Stack[-5]T, Stack[-6]T)
0x2: Pop(0)
...
0x8: Push((int) 1)
0x9: Pop(1); Push(Stack[4 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1d: Push((int) 1)
0x1e: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-1]);
0x1f: Push((int) 0)
0x20: Push((int) 0)
0x21: @ StretchBlit(Stack[-3], Stack[-2], Stack[-1], Stack[-5]T, Stack[-6]T, Stack[-2]T)
0x22: Pop(3)
0x23: Return(); Pop(0)

0x24: PushEmpty()
0x25: Push("intro") // @poff=0
...
0x4f: Push((int) 6)
0x50: Push((int) 3)
0x51: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[-1]);
