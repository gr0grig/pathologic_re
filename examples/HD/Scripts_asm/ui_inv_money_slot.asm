...
Strings:
	...
	W:money
	W:selected
// @pool_raw:640065006600610075006c00740000006d006f006e00650079000000730065006c00650063007400650064000000
...
0x10: Push((int) 2)
0x11: Push((int) 35)
0x12: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x13: Pop(3)
0x14: Return(); Pop(0)

0x15: PushEmpty()
0x16: Push("selected") // @poff=28
