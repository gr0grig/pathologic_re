...
Strings:
	...
	W:slot0
	W:slot
// @pool_raw:640065006600610075006c0074000000640069007300610062006c00650064000000730065006c00650063007400650064000000240070006100720065006e0074000000676574004765744974656d49440073006c006f0074003000000073006c006f0074000000
...
0x29: Push((int) 1)
0x2a: Push((int) 1)
0x2b: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x2c: Pop(2)
0x2d: Push((int) 1)
...
0xaa: Push((int) 0)
0xab: @@ get(Stack[-7]T, Stack[-1]); Obj=4 // @poff=68
0xac: Pop(1)
0xad: Push((int) 1)
0xae: @@ get(Stack[-8]T, Stack[-1]); Obj=4 // @poff=68
0xaf: Pop(1)
0xb0: Return(); Pop(2)
...
0xdf: Push("selected") // @poff=34
0xe0: @ SetBackground(Stack[-1])
0xe1: Pop(1)
0xe2: GOTO 0xe6

0xe3: Push("default") // @poff=0
...
0xf8: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=72
0xf9: Pop(0)
0xfa: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0xfb: Pop(0)
0xfc: @ LoadImage(Stack[-3]T)
0xfd: Pop(0)
0xfe: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0xff: Pop(0)
...
0x107: Push((int) 1)
0x108: Push("") // @poff=13
0x109: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x10a: Pop(2)
0x10b: GOTO 0x110
