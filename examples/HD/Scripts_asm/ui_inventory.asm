...
Strings:
	...
	W:slot0
	W:slot
// @pool_raw:
...
0x26: Stack[-1] = Stack[-19]
0x27: Pop(1)
0x28: @@ GetItemCount(Stack[-17], Stack[-0]T); Obj=18 // @poff=38
0x29: Pop(0)
...
0x2d: @@ GetItem(Stack[-16], Stack[-37], Stack[-0]T); Obj=18 // @poff=51
0x2e: Pop(0)
0x2f: @@ GetItemID(Stack[-15]); Obj=16 // @poff=59
0x30: Pop(0)
0x31: @@ GetItemAmount(Stack[-14], Stack[-37], Stack[-0]T); Obj=18 // @poff=69
0x32: Pop(0)
0x33: @@ IsItemSelected(Stack[-13], Stack[-37], Stack[-0]T); Obj=18 // @poff=83
0x34: Pop(0)
0x35: Push((int) 0)
0x36: Pop(1); Push((bool) Stack[0 + Tasks[-1].StackPointer] == Stack[-1])
0x37: IF (Stack[-1] == 0) GOTO 0x56; Pop(1)

0x38: Push("Weapon") // @poff=98
...
0x40: Push((bool) 0)
0x41: @@ SelectItem(Stack[-38], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x42: Pop(1)
0x43: Push((int) -1)
...
0x4c: Push((bool) 0)
0x4d: @@ SelectItem(Stack[-12], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x4e: Pop(1)
0x4f: Push((int) 1)
...
0x52: Push((bool) 1)
0x53: @@ SelectItem(Stack[-38], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x54: Pop(1)
0x55: GOTO 0x9a
...
0x64: Push((bool) 0)
0x65: @@ SelectItem(Stack[-38], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x66: Pop(1)
0x67: GOTO 0x8a
...
0x6b: @@ IsItemSelected(Stack[-7], Stack[-8], Stack[-0]T); Obj=18 // @poff=83
0x6c: Pop(0)
...
0x70: @@ GetItem(Stack[-6], Stack[-8], Stack[-0]T); Obj=18 // @poff=51
0x71: Pop(0)
0x72: @@ GetItemID(Stack[-5]); Obj=6 // @poff=59
0x73: Pop(0)
0x74: Push("Group") // @poff=123
...
0x7f: Push((bool) 0)
0x80: @@ SelectItem(Stack[-9], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x81: Pop(1)
0x82: GOTO 0x87
...
0x87: Push((bool) 1)
0x88: @@ SelectItem(Stack[-38], Stack[-1], Stack[-0]T); Obj=19 // @poff=112
0x89: Pop(1)
0x8a: GOTO 0x9a

0x8b: @ UseItem(Stack[-37], Stack[-0]T, Stack[-2])
0x8c: Pop(0)
0x8d: Push(Stack[-2])
...
0x94: Push((int) 1)
0x95: @@ RemoveItem(Stack[-38], Stack[-1], Stack[-0]T); Obj=19 // @poff=135
0x96: Pop(1)
0x97: GOTO 0x9a

0x98: @@ SetItemAmount(Stack[-14], Stack[-37], Stack[-0]T); Obj=18 // @poff=146
0x99: Pop(0)
0x9a: Return(); Pop(36)
...
0xb8: Pop(1)
0xb9: @@ add(Stack[-1]); Obj=2 // @poff=160
0xba: Pop(1)
...
0xc3: Pop(1)
0xc4: @@ add(Stack[-1]); Obj=2 // @poff=160
0xc5: Pop(1)
0xc6: Push((int) -1)
0xc7: PushEmpty(string, int)
0xc8: Stack[-5] = Stack[-1]
0xc9: Call2 0x321
...
0x1ab: Pop(1)
0x1ac: @@ IsItemSelected(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=83
0x1ad: Pop(1)
...
0x1c2: Stack[-19] = Stack[-3]
0x1c3: Stack[-18] = Stack[-2]
0x1c4: Stack[-17] = Stack[-1]
0x1c5: Call2 0xf

0x1c6: Stack[-4] = Stack[-10]
0x1c7: Pop(4)
0x1c8: Return(); Pop(12)

0x1c9: Push("button_weapon") // @poff=180
...
0x1d2: Push("button_clothes") // @poff=208
...
0x1db: Push("button_medcine") // @poff=238
...
0x1e4: Push("button_food") // @poff=268
...
0x1ed: Push("button_other") // @poff=292
...
0x201: Push("noinv_drop") // @poff=386
...
0x214: Pop(1)
0x215: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=38
0x216: Pop(0)
0x217: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x218: IF (Stack[-1] == 0) GOTO 0x229; Pop(1)

0x219: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=51
0x21a: Pop(0)
...
0x222: Stack[-7] = Stack[-2]
0x223: Push((int) 0)
0x224: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x225: Call2 0x14

0x226: Stack[-3] = Stack[-9]
0x227: Pop(3)
0x228: Stack[-1] = 0
0x229: GOTO 0x22e
...
0x231: Stack[-19] = Stack[-3]
0x232: Stack[-18] = Stack[-2]
0x233: Stack[-17] = Stack[-1]
0x234: Call2 0xf

0x235: Stack[-4] = Stack[-10]
0x236: Pop(4)
0x237: Push(Stack[-6])
...
0x24c: Pop(1)
0x24d: Push("money") // @poff=408
0x24e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=420
0x24f: Pop(1)
0x250: Stack[-1] = Stack[-5]
0x251: Return(); Pop(4)
...
0x25e: Push((int) 0)
0x25f: Push("button_weapon") // @poff=180
0x260: @ SendMessage(Stack[-2], Stack[-1])
0x261: Pop(2)
0x262: GOTO 0x267

0x263: Push((int) 1)
0x264: Push("button_weapon") // @poff=180
...
0x26a: Push((int) 0)
0x26b: Push("button_clothes") // @poff=208
0x26c: @ SendMessage(Stack[-2], Stack[-1])
0x26d: Pop(2)
0x26e: GOTO 0x273

0x26f: Push((int) 1)
0x270: Push("button_clothes") // @poff=208
...
0x276: Push((int) 0)
0x277: Push("button_medcine") // @poff=238
0x278: @ SendMessage(Stack[-2], Stack[-1])
0x279: Pop(2)
0x27a: GOTO 0x27f

0x27b: Push((int) 1)
0x27c: Push("button_medcine") // @poff=238
...
0x282: Push((int) 0)
0x283: Push("button_food") // @poff=268
0x284: @ SendMessage(Stack[-2], Stack[-1])
0x285: Pop(2)
0x286: GOTO 0x28b

0x287: Push((int) 1)
0x288: Push("button_food") // @poff=268
...
0x28e: Push((int) 0)
0x28f: Push("button_other") // @poff=292
0x290: @ SendMessage(Stack[-2], Stack[-1])
0x291: Pop(2)
0x292: GOTO 0x297

0x293: Push((int) 1)
0x294: Push("button_other") // @poff=292
...
0x29e: Pop(0)
0x29f: @@ GetItemCount(Stack[-6], Stack[-20]); Obj=8 // @poff=38
0x2a0: Pop(0)
...
0x2a5: @@ GetItemAmount(Stack[-5], Stack[-19], Stack[-20]); Obj=8 // @poff=69
0x2a6: Pop(0)
0x2a7: @@ GetItem(Stack[-7], Stack[-19], Stack[-20]); Obj=8 // @poff=51
0x2a8: Pop(0)
0x2a9: Push((int) 0)
0x2aa: Push((int) 1)
0x2ab: @@ AddItem(Stack[-6], Stack[-9], Stack[-2], Stack[-1]); Obj=11 // @poff=432
0x2ac: Pop(2)
...
0x2b4: @@ GetItemID(Stack[-3]); Obj=7 // @poff=59
0x2b5: Pop(0)
0x2b6: Push("Weapon") // @poff=98
0x2b7: @ HasInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2b8: Pop(1)
0x2b9: Push(Stack[-2])
0x2ba: IF (Stack[-1] == 0) GOTO 0x2c2; Pop(1)

0x2bb: @@ IsItemSelected(Stack[-1], Stack[-19], Stack[-0]T); Obj=8 // @poff=83
0x2bc: Pop(0)
0x2bd: Push(Stack[-1])
...
0x2c1: Pop(1)
0x2c2: Push((int) 1)
0x2c3: @@ RemoveItem(Stack[-20], Stack[-1], Stack[-21]); Obj=9 // @poff=135
0x2c4: Pop(1)
...
0x2cd: Stack[-1] = Stack[-8]
0x2ce: Pop(1)
0x2cf: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=38
0x2d0: Pop(0)
0x2d1: Stack[-5] = (int) 0
0x2d2: Push((int) 12)
...
0x2d7: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=51
0x2d8: Pop(0)
0x2d9: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=69
0x2da: Pop(0)
0x2db: PushEmpty(bool, int, int)
0x2dc: Stack[-8] = Stack[-2]
0x2dd: Stack[-18] = Stack[-1]
0x2de: Call2 0x19f

0x2df: Stack[-3] = Stack[-5]
0x2e0: Pop(3)
0x2e1: PushEmpty(bool, object)
0x2e2: Stack[-6] = Stack[-1]
0x2e3: Call2 0x19c

0x2e4: Stack[-2] = Stack[-3]
0x2e5: Pop(2)
0x2e6: Push(Stack[-2])
