...
Strings:
	...
	W:0
	W:, 
// @pool_raw:640065006600610075006c007400000020003a0020000000300000002c0020000000
...
0x30: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-0]T)
0x31: Pop(1)
0x32: Pop(0); Push(Stack[-4] - Stack[-1]);
0x33: Push((int) 2)
0x34: Stack[1 + Tasks[-1].StackPointer] = Stack[-2] / Stack[-1]; Pop(2);
0x35: Push("default") // @poff=0
0x36: Push((float)1.0)
0x37: Push((float)1.0)
0x38: Push((float)1.0)
0x39: @ Print(Stack[-4], Stack[-1]T, Stack[-2]T, Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x3a: Pop(4)
0x3b: Return(); Pop(10)
