...
0x58: @@@ get(Stack[-8], Stack[-10]T); Obj=5 // @poff=61
0x59: Pop(0)
0x5a: @ Unbind(Stack[-19])
0x5b: Pop(0)
0x5c: @@@ get(Stack[-7], Stack[-10]T); Obj=7 // @poff=61
0x5d: Pop(0)
0x5e: @@ size(Stack[-6]); Obj=7 // @poff=0
0x5f: Pop(0)
0x60: Push((int) 256)
...
0x69: @@ get(Stack[-2], Stack[-3]); Obj=7 // @poff=61
0x6a: Pop(0)
0x6b: @@@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=61
0x6c: Pop(0)
0x6d: Push(Stack[-5])
...
0x85: Push("wrong key code") // @poff=65
0x86: @ Trace(Stack[-1])
0x87: Pop(1)
...
0xe0: Stack[-1] = "scrollbar" // @poff=95
0xe1: Return(); Pop(0)
...
0xe5: Push("whitepixel") // @poff=115
0xe6: PushEmpty(int)
0xe7: Call2 0x12

0xe8: Pop(0)
0xe9: @ StretchBlit(Stack[-2], Stack[-26], Stack[-25], Stack[-1]T, Stack[-1])
0xea: Pop(2)
0xeb: PushEmpty(string, int)
0xec: Stack[-1] = (int) 108
0xed: Call2 0x2eb

0xee: Stack[-2] = Stack[-13]
0xef: Pop(2)
0xf0: Push("default") // @poff=137
0xf1: @ GetTextWidth(Stack[-11], Stack[-1], Stack[-12])
0xf2: Pop(1)
0xf3: Push("default") // @poff=137
0xf4: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] - Stack[-11]);
0xf5: Push((int) 2)
0xf6: Pop(2); Push(Stack[-2] / Stack[-1]);
0xf7: Pop(1); Push(Stack[-26] + Stack[-1]);
0xf8: Push((float)0.250980406999588)
0xf9: Push((float)0.250980406999588)
0xfa: Push((float)0.250980406999588)
0xfb: @ Print(Stack[-5], Stack[-4], Stack[-28], Stack[-16], Stack[-3], Stack[-2], Stack[-1])
0xfc: Pop(5)
0xfd: Return(); Pop(22)

0xfe: @@@ get(Stack[-9], Stack[-25]); Obj=6 // @poff=61
0xff: Pop(0)
0x100: PushEmpty(string, int)
0x101: Stack[-11] = Stack[-1]
0x102: Call2 0x2eb

0x103: Stack[-2] = Stack[-10]
0x104: Pop(2)
0x105: @@@ get(Stack[-6], Stack[-25]); Obj=7 // @poff=61
0x106: Pop(0)
0x107: @@ size(Stack[-5]); Obj=6 // @poff=0
0x108: Pop(0)
0x109: Stack[-4] = (int) 0
...
0x110: @@ get(Stack[-3], Stack[-4]); Obj=6 // @poff=61
0x111: Pop(0)
0x112: @@@ get(Stack[-2], Stack[-3]); Obj=9 // @poff=61
0x113: Pop(0)
...
0x118: Push("default") // @poff=137
0x119: Push((float)0.5568627715110779)
0x11a: Push((float)0.5568627715110779)
0x11b: Push((float)0.5568627715110779)
0x11c: @ Print(Stack[-4], Stack[-28], Stack[-27], Stack[-12], Stack[-3], Stack[-2], Stack[-1])
0x11d: Pop(4)
0x11e: Push(Stack[-5])
0x11f: IF (Stack[-1] == 0) GOTO 0x12b; Pop(1)

0x120: Push("default") // @poff=137
0x121: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-8])
0x122: Pop(1)
0x123: Push("default") // @poff=137
0x124: Pop(0); Push(Stack[-25] + Stack[1 + Tasks[-1].StackPointer]);
0x125: Pop(1); Push(Stack[-1] - Stack[-3]);
0x126: Push((float)0.5568627715110779)
0x127: Push((float)0.5568627715110779)
0x128: Push((float)0.5568627715110779)
...
0x12e: @@@ add(Stack[-4]); Obj=5 // @poff=161
0x12f: Pop(0)
0x130: @@@ add(Stack[-3]); Obj=6 // @poff=161
0x131: Pop(0)
0x132: @ CreateIntVector(Stack[-1])
0x133: Pop(0)
0x134: @@@ add(Stack[-1]); Obj=7 // @poff=161
0x135: Pop(0)
0x136: Return(); Pop(2)

0x137: Stack[-1] = 0
0x138: PushEmpty(object, bool, int, string, object, bool, int, string)
0x139: @ CreateIntVector(Stack[-8]T)
0x13a: Pop(0)
0x13b: @ CreateStringVector(Stack[-9]T)
0x13c: Pop(0)
...
0x141: @@ Next(Stack[-3], Stack[-2]); Obj=4 // @poff=165
0x142: Pop(0)
...
0x146: @@@ add(Stack[-2]); Obj=8 // @poff=161
0x147: Pop(0)
0x148: @ GetKeyName(Stack[-1], Stack[-2])
0x149: Pop(0)
0x14a: @@@ add(Stack[-1]); Obj=9 // @poff=161
0x14b: Pop(0)
0x14c: GOTO 0x13f

0x14d: @ CreateIntVector(Stack[-5]T)
0x14e: Pop(0)
0x14f: @ CreateIntVector(Stack[-6]T)
0x150: Pop(0)
0x151: @ CreateObjectVector(Stack[-7]T)
0x152: Pop(0)
...
0x1fe: @@@ size(Stack[-3]); Obj=5 // @poff=0
0x1ff: Pop(0)
0x200: Stack[-2] = (int) 0
0x201: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x202: IF (Stack[-1] == 0) GOTO 0x20b; Pop(1)

0x203: @@@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=61
0x204: Pop(0)
0x205: @@ clear(); Obj=1 // @poff=194
0x206: Pop(0)
0x207: Stack[-1] = 0
0x208: Push((int) 1)
...
0x21f: Push("AddKeyToAction fail") // @poff=200
0x220: @ Trace(Stack[-1])
0x221: Pop(1)
0x222: Return(); Pop(8)

0x223: @ GetWindowSize(Stack[-1]T, Stack[-2]T)
0x224: Pop(0)
0x225: Stack[3 + Tasks[-1].StackPointer] = (int)0
0x226: Stack[4 + Tasks[-1].StackPointer] = (int)0
0x227: @ ClientToScreen(Stack[-3]T, Stack[-4]T)
0x228: Pop(0)
...
0x257: Pop(0)
0x258: Pop(1); Push(Stack[-1] - Stack[2 + Tasks[-1].StackPointer]);
...
0x28d: Stack[-7] = Stack[-2]
0x28e: Stack[-6] = Stack[-1]
0x28f: Call2 0x2ad

0x290: Stack[-3] = Stack[-4]
0x291: Pop(3)
0x292: Push((int) -1)
...
0x296: Stack[-4] = Stack[-3]
0x297: Stack[-7] = Stack[-2]
0x298: Stack[-6] = Stack[-1]
0x299: Call2 0xdc
...
0x29e: Stack[-7] = Stack[-2]
0x29f: Stack[-6] = Stack[-1]
0x2a0: Call2 0x2ad

0x2a1: Stack[-3] = Stack[-4]
0x2a2: Pop(3)
0x2a3: Push((int) -1)
...
0x2a7: Stack[-4] = Stack[-3]
0x2a8: Stack[-7] = Stack[-2]
0x2a9: Stack[-6] = Stack[-1]
0x2aa: Call2 0xde
