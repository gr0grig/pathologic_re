...
Strings:
	...
	A:GetGameTime
	A:GetSaveTime
// @pool_raw:
...
0x27: Push((int) 1000)
0x28: Push("load") // @poff=0
0x29: @ SendMessage(Stack[-2], Stack[-1])
0x2a: Pop(2)
0x2b: Return(); Pop(0)

0x2c: PushEmpty()
0x2d: Push("button_text") // @poff=10
...
0x37: @@ GetFileName(Stack[-1]); Obj=3 // @poff=34
0x38: Pop(0)
...
0x47: @ CreateSaveEnumerator(Stack[-8]T)
0x48: Pop(0)
...
0x4c: @ CreateObjectVector(Stack[-9]T)
0x4d: Pop(0)
0x4e: Push(Stack[-7])
0x4f: IF (Stack[-1] == 0) GOTO 0x54; Pop(1)

0x50: Stack[-3] = 0
0x51: @@@ add(Stack[-3]); Obj=9 // @poff=46
0x52: Pop(0)
0x53: Stack[-3] = 0
0x54: Push((int) 1)
0x55: IF (Stack[-1] == 0) GOTO 0x66; Pop(1)

0x56: @@@ Next(Stack[-2]); Obj=8 // @poff=50
0x57: Pop(0)
...
0x5d: @@ IsQuickSave(Stack[-1]); Obj=2 // @poff=55
0x5e: Pop(0)
0x5f: Push(Stack[-1])
...
0x62: @@@ add(Stack[-2]); Obj=9 // @poff=46
0x63: Pop(0)
0x64: Stack[-2] = 0
0x65: GOTO 0x54

0x66: @ GetWindowSize(Stack[-4]T, Stack[-5]T)
0x67: Pop(0)
0x68: Stack[6 + Tasks[-1].StackPointer] = (int)0
0x69: Stack[7 + Tasks[-1].StackPointer] = (int)0
0x6a: @ ClientToScreen(Stack[-6]T, Stack[-7]T)
0x6b: Pop(0)
...
0x72: Pop(1)
0x73: Push("sys_border.xml") // @poff=67
0x74: Push((bool) 0)
0x75: @ CreateWindow(Stack[-2], Stack[-1], Stack[-10]T)
0x76: Pop(2)
0x77: PushEmpty()
0x78: Call2 0x22e
...
0xaa: Pop(1)
0xab: Push((float)0.5568627715110779)
0xac: Push((float)0.5568627715110779)
0xad: Push((float)0.5568627715110779)
0xae: @ Print(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xaf: Pop(7)
0xb0: GOTO 0xc7

0xb1: Push((int) 0)
0xb2: @@ GetProperty(Stack[-1], Stack[-4], Stack[-3]); Obj=9 // @poff=134
0xb3: Pop(1)
0xb4: Push(Stack[-3])
...
0xba: Stack[-2] = Stack[-6]
0xbb: Pop(2)
0xbc: GOTO 0xbe

0xbd: Stack[-4] = "????" // @poff=146
0xbe: Push("default") // @poff=118
0xbf: Push((int) 129)
0xc0: Push((int) 7)
...
0xc8: Stack[-10] = Stack[-1]
0xc9: Call2 0x255

0xca: Stack[-2] = Stack[-3]
0xcb: Pop(2)
0xcc: Push("big") // @poff=156
0xcd: Push((int) 129)
0xce: Push((int) 28)
...
0xd6: Stack[-10] = Stack[-1]
0xd7: Call2 0x26d

0xd8: Stack[-2] = Stack[-3]
0xd9: Pop(2)
0xda: Push("default") // @poff=118
0xdb: Push((int) 129)
0xdc: Push((int) 47)
0xdd: Pop(1); Push(Stack[-1] + Stack[-24]);
0xde: Push((float)0.5568627715110779)
0xdf: Push((float)0.5568627715110779)
0xe0: Push((float)0.5568627715110779)
...
0xe7: Push("button_x_pressed") // @poff=164
0xe8: Push((int) 248)
0xe9: Push((int) 68)
...
0xf6: Stack[-3] = (int) 0
0xf7: Stack[-24] = Stack[-2]
0xf8: Stack[-1] = (bool) 1
0xf9: Call2 0x12e

0xfa: Pop(3)
0xfb: Push("default") // @poff=118
0xfc: Push((int) 129)
0xfd: Push((int) 47)
...
0x102: Pop(1)
0x103: Push((float)0.5568627715110779)
0x104: Push((float)0.5568627715110779)
0x105: Push((float)0.5568627715110779)
...
0x10a: Push("button_pressed") // @poff=216
0x10b: Push((int) 129)
0x10c: Push((int) 67)
...
0x120: Push("separator") // @poff=260
0x121: Push((int) 0)
0x122: Push((int) 15)
0x123: Pop(1); Push(Stack[-24] + Stack[-1]);
0x124: Push((int) 1)
0x125: @ StretchBlit(Stack[-4], Stack[-3], Stack[-2], Stack[-4]T, Stack[-1])
0x126: Pop(4)
0x127: Push((int) 31)
...
0x143: Pop(4)
0x144: Push("shot_border") // @poff=302
0x145: Push((int) 1)
0x146: Push((int) 90)
0x147: @ StretchBlit(Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x148: Pop(3)
0x149: Push("shot_border") // @poff=302
0x14a: Push((int) 120)
...
0x15a: Pop(0)
0x15b: Pop(1); Push(Stack[-1] - Stack[5 + Tasks[-1].StackPointer]);
...
0x1aa: Stack[-9] = Stack[-2]
0x1ab: Stack[-8] = Stack[-1]
0x1ac: Call2 0x1d6
...
0x1b2: @@@ get(Stack[-2], Stack[-2]T); Obj=9 // @poff=102
0x1b3: Pop(0)
...
0x1c4: Stack[-9] = Stack[-2]
0x1c5: Stack[-8] = Stack[-1]
0x1c6: Call2 0x1fd
...
0x1cc: @@@ get(Stack[-1], Stack[-3]T); Obj=9 // @poff=102
0x1cd: Pop(0)
0x1ce: Push(Stack[-1])
...
0x227: @@@ size(Stack[-1]); Obj=9 // @poff=97
0x228: Pop(0)
0x229: PushEmpty(int)
0x22a: Call2 0x224
...
0x26a: Pop(2)
0x26b: Stack[-5] = Stack[-12]
0x26c: Return(); Pop(10)

0x26d: PushEmpty(string, int, int, int, int, int, string, int, int, int, int, int)
0x26e: @@ GetSaveTime(Stack[-5], Stack[-4], Stack[-3], Stack[-1], Stack[-2]); Obj=13 // @poff=358
0x26f: Pop(0)
