...
Strings:
	...
	W:RMap
// @pool_raw:
...
0x2e: @ GetWindowSize(Stack[-3]T, Stack[-4]T)
0x2f: Pop(0)
...
0x47: Pop(1)
0x48: Push("map_chertez_force") // @poff=107
...
0x50: Pop(0)
0x51: Push("map_chertez_force") // @poff=107
0x52: Push((int) 0)
...
0x63: @ CreateObjectVector(Stack[-20]T)
0x64: Pop(0)
0x65: @ GetMainOutdoorScene(Stack[-6])
0x66: Pop(0)
0x67: @ GetActiveScene(Stack[-21]T)
0x68: Pop(0)
...
0x6c: @@@ GetName(Stack[-5]); Obj=21 // @poff=155
0x6d: Pop(0)
0x6e: PushEmpty(cvector, string)
0x6f: Push("pt_gmap_") // @poff=163
0x70: Stack[-2] = Stack[-1] + Stack[-8]; Pop(1);
0x71: Call2 0x42b

0x72: Stack[25 + Tasks[-1].StackPointer] = Stack[-2]
0x73: Pop(2)
0x74: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0))
0x75: Stack[-1] = Stack[-5]
0x76: Pop(1)
0x77: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2))
0x78: Stack[-1] = Stack[-4]
0x79: Pop(1)
0x7a: @@@ ConvertToMapCoordinates(Stack[-4], Stack[-3]); Obj=22 // @poff=83
0x7b: Pop(0)
0x7c: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0))
0x7d: Stack[-5] = Stack[-1]
0x7e: CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0) = Stack[-1];
0x7f: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2))
0x80: Stack[-4] = Stack[-1]
0x81: CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2) = Stack[-1];
0x82: Push("indoor map: pt_gmap_") // @poff=181
0x83: Pop(1); Push(Stack[-1] + Stack[-6]);
0x84: @ Trace(Stack[-1])
0x85: Pop(1)
0x86: GOTO 0x93

0x87: Push("outdoor map") // @poff=223
0x88: @ Trace(Stack[-1])
0x89: Pop(1)
0x8a: Stack[17 + Tasks[-1].StackPointer] = (bool)0
0x8b: @ GetPlayerMapPos(Stack[-2], Stack[-1])
0x8c: Pop(0)
0x8d: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0))
0x8e: Stack[-3] = Stack[-1]
0x8f: CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0) = Stack[-1];
0x90: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2))
...
0xb4: Push("map_chertez_state") // @poff=281
...
0xbd: Stack[26 + Tasks[-1].StackPointer] = "ui\ui_chertez_danko_bg.tex" // @poff=317
0xbe: PushEmpty(bool)
0xbf: Stack[-1] = (bool) 0
0xc0: Push((int) 1)
...
0xc8: Push("ui\ui_chertez_danko_") // @poff=371
0xc9: Pop(1); Push(Stack[-1] + Stack[-2]);
0xca: Push(".tex") // @poff=361
...
0xd3: Stack[26 + Tasks[-1].StackPointer] = "ui\ui_chertez_burah_bg.tex" // @poff=413
0xd4: PushEmpty(bool)
0xd5: Stack[-1] = (bool) 0
0xd6: Push((int) 1)
...
0xde: Push("ui\ui_chertez_burah_") // @poff=467
0xdf: Pop(1); Push(Stack[-1] + Stack[-2]);
0xe0: Push(".tex") // @poff=361
0xe1: Stack[26 + Tasks[-1].StackPointer] = Stack[-2] + Stack[-1]; Pop(2);
0xe2: GOTO 0xf2

0xe3: Stack[26 + Tasks[-1].StackPointer] = "ui\ui_chertez_klara_bg.tex" // @poff=509
0xe4: PushEmpty(bool)
0xe5: Stack[-1] = (bool) 0
0xe6: Push((int) 1)
...
0x122: PushEmpty()
0x123: Push((int) 2)
0x124: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[-1]);
0x125: Pop(1); Push(Stack[-2] - Stack[-1]);
0x126: Pop(1); Push(Stack[-1] / Stack[14 + Tasks[-1].StackPointer]);
0x127: Stack[-3] = Stack[12 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x128: Return(); Pop(0)

0x129: PushEmpty()
0x12a: Push((int) 2)
0x12b: Pop(1); Push(Stack[4 + Tasks[-1].StackPointer] / Stack[-1]);
0x12c: Pop(1); Push(Stack[-2] - Stack[-1]);
0x12d: Pop(1); Push(Stack[-1] / Stack[14 + Tasks[-1].StackPointer]);
0x12e: Stack[-3] = Stack[13 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x12f: Return(); Pop(0)

0x130: PushEmpty()
0x131: Pop(0); Push(Stack[-1] - Stack[12 + Tasks[-1].StackPointer]);
0x132: Pop(1); Push(Stack[-1] * Stack[14 + Tasks[-1].StackPointer]);
0x133: Push((int) 2)
0x134: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[-1]);
0x135: Stack[-4] = Stack[-2] + Stack[-1]; Pop(2);
0x136: Return(); Pop(0)

0x137: PushEmpty()
0x138: Pop(0); Push(Stack[-1] - Stack[13 + Tasks[-1].StackPointer]);
0x139: Pop(1); Push(Stack[-1] * Stack[14 + Tasks[-1].StackPointer]);
0x13a: Push((int) 2)
0x13b: Pop(1); Push(Stack[4 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x157: Push((float)1.100000023841858)
...
0x168: Push((float)1.100000023841858)
...
0x177: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[14 + Tasks[-1].StackPointer]);
0x178: Push((int) 2)
0x179: Pop(2); Push(Stack[-2] / Stack[-1]);
0x17a: Stack[-20] = Stack[12 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x17b: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[14 + Tasks[-1].StackPointer]);
0x17c: Push((int) 2)
0x17d: Pop(2); Push(Stack[-2] / Stack[-1]);
0x17e: Stack[-19] = Stack[12 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x17f: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] / Stack[14 + Tasks[-1].StackPointer]);
0x180: Push((int) 2)
0x181: Pop(2); Push(Stack[-2] / Stack[-1]);
0x182: Stack[-18] = Stack[13 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x183: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] / Stack[14 + Tasks[-1].StackPointer]);
0x184: Push((int) 2)
...
0x1aa: @@@ clear(); Obj=20 // @poff=605
0x1ab: Pop(0)
0x1ac: Stack[-10] = (int) 0
0x1ad: @@@ GetMarkCount(Stack[-11]); Obj=22 // @poff=611
0x1ae: Pop(0)
0x1af: Stack[-9] = (int) 0
0x1b0: Pop(0); Push((bool) Stack[-9] < Stack[-11])
0x1b1: IF (Stack[-1] == 0) GOTO 0x1df; Pop(1)

0x1b2: @@@ GetMark(Stack[-9], Stack[-8]); Obj=22 // @poff=624
0x1b3: Pop(0)
0x1b4: @@ GetLocator(Stack[-7]); Obj=8 // @poff=632
0x1b5: Pop(0)
0x1b6: PushEmpty(cvector, string)
0x1b7: Stack[-9] = Stack[-1]
0x1b8: Call2 0x42b

0x1b9: Stack[-2] = Stack[-8]
0x1ba: Pop(2)
0x1bb: Push(CvectorIndex(Stack[-6], 0))
0x1bc: Stack[-1] = Stack[-14]
0x1bd: Pop(1)
0x1be: Push(CvectorIndex(Stack[-6], 2))
0x1bf: Stack[-1] = Stack[-13]
0x1c0: Pop(1)
0x1c1: @@@ ConvertToMapCoordinates(Stack[-13], Stack[-12]); Obj=22 // @poff=83
0x1c2: Pop(0)
0x1c3: PushEmpty(int, int)
0x1c4: Stack[-15] = Stack[-1]
0x1c5: Call2 0x130

0x1c6: Stack[-2] = Stack[-15]
0x1c7: Pop(2)
0x1c8: PushEmpty(int, int)
0x1c9: Stack[-14] = Stack[-1]
0x1ca: Call2 0x137

0x1cb: Stack[-2] = Stack[-14]
0x1cc: Pop(2)
0x1cd: Pop(0); Push(Stack[-13] - Stack[5 + Tasks[-1].StackPointer]);
0x1ce: Pop(0); Push(Stack[-14] - Stack[5 + Tasks[-1].StackPointer]);
0x1cf: Pop(2); Push(Stack[-2] * Stack[-1]);
0x1d0: Pop(0); Push(Stack[-13] - Stack[6 + Tasks[-1].StackPointer]);
0x1d1: Pop(0); Push(Stack[-14] - Stack[6 + Tasks[-1].StackPointer]);
...
0x1d7: @@@ add(Stack[-8]); Obj=20 // @poff=643
0x1d8: Pop(0)
0x1d9: Push((int) 1)
...
0x1e9: Stack[-2] = Stack[-4]
0x1ea: Pop(2)
0x1eb: @@@ GetObjectFromPoint(Stack[-5], Stack[-3], Stack[-2]); Obj=22 // @poff=647
0x1ec: Pop(0)
0x1ed: Push((int) 0)
0x1ee: Pop(1); Push((bool) Stack[-6] >= Stack[-1])
0x1ef: IF (Stack[-1] == 0) GOTO 0x1ff; Pop(1)

0x1f0: @@@ GetObjectID(Stack[-4], Stack[-5]); Obj=22 // @poff=666
0x1f1: Pop(0)
...
0x1fb: @@@ CreateObjectHighlight(Stack[-23]T, Stack[-5]); Obj=22 // @poff=678
0x1fc: Pop(0)
...
0x206: Push((int) 2)
0x207: Push("") // @poff=25
0x208: @ SetTooltip(Stack[-2], Stack[-1], Stack[-20]T)
0x209: Pop(2)
...
0x215: @@ GetMarkCount(Stack[-6]); Obj=18 // @poff=611
0x216: Pop(0)
0x217: Stack[-5] = (int) 0
0x218: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x219: IF (Stack[-1] == 0) GOTO 0x25b; Pop(1)

0x21a: @@ GetMark(Stack[-5], Stack[-4]); Obj=18 // @poff=624
0x21b: Pop(0)
0x21c: @@ GetLocator(Stack[-3]); Obj=4 // @poff=632
0x21d: Pop(0)
0x21e: @@ GetType(Stack[-2]); Obj=4 // @poff=700
0x21f: Pop(0)
0x220: PushEmpty(cvector, string)
0x221: Stack[-5] = Stack[-1]
0x222: Call2 0x42b

0x223: Stack[-2] = Stack[-3]
0x224: Pop(2)
0x225: Push(CvectorIndex(Stack[-1], 0))
0x226: Stack[-1] = Stack[-9]
0x227: Pop(1)
0x228: Push(CvectorIndex(Stack[-1], 2))
0x229: Stack[-1] = Stack[-8]
0x22a: Pop(1)
0x22b: @@ ConvertToMapCoordinates(Stack[-8], Stack[-7]); Obj=18 // @poff=83
0x22c: Pop(0)
...
0x233: Stack[-9] = Stack[-1]
0x234: Call2 0x137

0x235: Stack[-2] = Stack[-9]
0x236: Pop(2)
...
0x23c: Push("quest_mark") // @poff=708
0x23d: Push((int) 16)
...
0x246: Push("mainquest_mark") // @poff=730
0x247: Push((int) 16)
...
0x27c: Pop(0)
0x27d: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-2]);
0x27e: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] + Stack[-2]);
...
0x285: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-2]);
0x286: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] + Stack[-2]);
...
0x28b: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-2]);
0x28c: Pop(0); Push(Stack[4 + Tasks[-1].StackPointer] + Stack[-2]);
0x28d: @@@ Render(Stack[-4], Stack[-3], Stack[-2], Stack[-1], Stack[-8], Stack[-6], Stack[-7], Stack[-5]); Obj=23 // @poff=780
0x28e: Pop(2)
...
0x2ad: Push((int) 1)
0x2ae: @ StretchBlit(Stack[-26]T, Stack[-7], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x2af: Pop(2)
0x2b0: Return(); Pop(10)
...
0x2c1: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0))
0x2c2: Stack[-1] = Stack[-2]
0x2c3: Pop(1)
0x2c4: Call2 0x130

0x2c5: Stack[-2] = Stack[-5]
0x2c6: Pop(2)
0x2c7: PushEmpty(int, int)
0x2c8: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2))
0x2c9: Stack[-1] = Stack[-2]
0x2ca: Pop(1)
0x2cb: Call2 0x137

0x2cc: Stack[-2] = Stack[-4]
0x2cd: Pop(2)
0x2ce: @ ClientToScreen(Stack[-3], Stack[-2])
0x2cf: Pop(0)
0x2d0: @@@ Blit(Stack[-3], Stack[-2], Stack[-1]); Obj=24 // @poff=787
0x2d1: Pop(0)
0x2d2: GOTO 0x2e5

0x2d3: PushEmpty(int, int)
0x2d4: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 0))
0x2d5: Stack[-1] = Stack[-2]
0x2d6: Pop(1)
0x2d7: Call2 0x130

0x2d8: Stack[-2] = Stack[-5]
0x2d9: Pop(2)
0x2da: PushEmpty(int, int)
0x2db: Push(CvectorIndex(Stack[25 + Tasks[-1].StackPointer], 2))
0x2dc: Stack[-1] = Stack[-2]
0x2dd: Pop(1)
0x2de: Call2 0x137

0x2df: Stack[-2] = Stack[-4]
0x2e0: Pop(2)
0x2e1: @ ClientToScreen(Stack[-3], Stack[-2])
0x2e2: Pop(0)
0x2e3: @@@ Blit(Stack[-3], Stack[-2]); Obj=24 // @poff=787
0x2e4: Pop(0)
0x2e5: Return(); Pop(6)
...
0x2eb: Pop(0)
0x2ec: IF (Stack[-1] == 1) GOTO 0x2f0; Pop(1)
...
0x307: Pop(0); Push(Stack[7 + Tasks[-1].StackPointer] - Stack[-2]);
0x308: Pop(1); Push(Stack[-1] / Stack[14 + Tasks[-1].StackPointer]);
0x309: Stack[12 + Tasks[-1].StackPointer] = Stack[9 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x30a: Pop(0); Push(Stack[8 + Tasks[-1].StackPointer] - Stack[-1]);
0x30b: Pop(1); Push(Stack[-1] / Stack[14 + Tasks[-1].StackPointer]);
...
0x314: Push((float)0.20000000298023224)
0x315: Pop(1); Push((bool) Stack[-6] == Stack[-1])
0x316: IF (Stack[-1] == 0) GOTO 0x318; Pop(1)

0x317: GOTO 0x335

0x318: Push((float)-0.20000000298023224)
...
0x323: Stack[-1] = (float) 1.100000023841858
0x324: Call2 0x336
...
0x32f: Stack[-1] = (float) 1.100000023841858
0x330: Call2 0x346
...
0x381: IF (Stack[-1] == 1) GOTO 0x386; Pop(1)
...
0x38c: IF (Stack[-1] == 1) GOTO 0x391; Pop(1)

0x38d: Push((int) 273)
0x38e: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x38f: IF (Stack[-1] == 1) GOTO 0x391; Pop(1)
...
0x397: IF (Stack[-1] == 1) GOTO 0x39c; Pop(1)
...
0x3a2: IF (Stack[-1] == 1) GOTO 0x3a7; Pop(1)

0x3a3: Push((int) 274)
0x3a4: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x3a5: IF (Stack[-1] == 1) GOTO 0x3a7; Pop(1)
...
0x3b7: IF (Stack[-1] == 1) GOTO 0x3bc; Pop(1)

0x3b8: Push((int) 271)
0x3b9: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x3ba: IF (Stack[-1] == 1) GOTO 0x3bc; Pop(1)
...
0x3c2: IF (Stack[-1] == 1) GOTO 0x3c7; Pop(1)

0x3c3: Push((int) 273)
0x3c4: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x3c5: IF (Stack[-1] == 1) GOTO 0x3c7; Pop(1)
...
0x3cd: IF (Stack[-1] == 1) GOTO 0x3d2; Pop(1)
...
0x3d8: IF (Stack[-1] == 1) GOTO 0x3dd; Pop(1)

0x3d9: Push((int) 274)
0x3da: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x3db: IF (Stack[-1] == 1) GOTO 0x3dd; Pop(1)
...
0x3eb: @@@ ConvertToWorldCoordinates(Stack[-2], Stack[-1]); Obj=22 // @poff=852
0x3ec: Pop(0)
0x3ed: @@@ SetMapParams(Stack[-2], Stack[-1], Stack[-14]T); Obj=22 // @poff=878
0x3ee: Pop(0)
0x3ef: @ DestroyWindow()
0x3f0: Pop(0)
0x3f1: Return(); Pop(4)
...
0x42d: Pop(0)
0x42e: Pop(0); PushNull((bool) Stack[-3] == 0)
0x42f: IF (Stack[-1] == 0) GOTO 0x436; Pop(1)

0x430: Push("Can't find main outdoor scene") // @poff=931
0x431: @ Trace(Stack[-1])
0x432: Pop(1)
0x433: Stack[-5] = CVector(0.0, 0.0, 0.0)
0x434: Stack[-5] = Stack[-12]
0x435: Return(); Pop(10)

0x436: @@ GetLocator(Stack[-11], Stack[-1], Stack[-5], Stack[-4]); Obj=3 // @poff=632
0x437: Pop(0)
0x438: Stack[-5] = Stack[-12]
0x439: Return(); Pop(10)
