...
Strings:
	...
	W:default
	W:button_day
// @pool_raw:74006500780074000000640065006600610075006c007400000062007500740074006f006e005f006400610079000000
...
0x14: Push("text") // @poff=0
0x15: @ SendMessage(Stack[-0]T, Stack[-1])
0x16: Pop(1)
0x17: @ ShowCursor()
0x18: Pop(0)
0x19: Push("default") // @poff=10
