...
Strings:
	...
	W:default
	W:message
// @pool_raw:61646400676574007300630072006f006c006c00620061007200000073697a6500640065006600610075006c00740000006d006500730073006100670065000000
// @pool_encoding:utf8
...
0x6: Pop(1)
0x7: @ GetWindowSize(Stack[-2]T, Stack[-3]T)
0x8: Pop(0)
0x9: Stack[0 + Tasks[-1].StackPointer] = (int)0
0xa: Stack[4 + Tasks[-1].StackPointer] = (int)0
0xb: Stack[5 + Tasks[-1].StackPointer] = (int)-1
0xc: @ CreateObjectVector(Stack[-7]T)
0xd: Pop(0)
0xe: @ CreateObjectVector(Stack[-8]T)
0xf: Pop(0)
0x10: @ CreateObjectVector(Stack[-9]T)
0x11: Pop(0)
0x12: Stack[-12] = (int) 0
0x13: Push((int) 12)
...
0x17: Pop(0)
0x18: @@@ add(Stack[-11]); Obj=7 // @poff=0
0x19: Pop(0)
0x1a: @ CreateStringVector(Stack[-11])
0x1b: Pop(0)
0x1c: @@@ add(Stack[-11]); Obj=8 // @poff=0
0x1d: Pop(0)
0x1e: @ CreateIntVector(Stack[-11])
0x1f: Pop(0)
0x20: @@@ add(Stack[-11]); Obj=9 // @poff=0
0x21: Pop(0)
0x22: Stack[-11] = 0
0x23: Push((int) 1)
...
0x42: @@@ get(Stack[-3], Stack[-5]); Obj=7 // @poff=4
0x43: Pop(0)
0x44: @@@ get(Stack[-2], Stack[-5]); Obj=8 // @poff=4
0x45: Pop(0)
0x46: @@@ get(Stack[-1], Stack[-5]); Obj=9 // @poff=4
0x47: Pop(0)
0x48: @@ add(Stack[-7]); Obj=3 // @poff=0
0x49: Pop(0)
0x4a: @@ add(Stack[-6]); Obj=2 // @poff=0
0x4b: Pop(0)
0x4c: @@ add(Stack[-9]); Obj=1 // @poff=0
0x4d: Pop(0)
0x4e: Stack[-1] = 0
0x4f: Stack[-2] = 0
0x50: Stack[-3] = 0
...
0xa0: Pop(1); Push(Stack[-1] / Stack[1 + Tasks[-1].StackPointer]);
0xa1: Push("scrollbar") // @poff=8
...
0xa6: Stack[-10] = (int) 0
0xa7: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0xa8: Pop(0)
0xa9: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0xaa: Pop(0)
0xab: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0xac: Pop(0)
0xad: @@ size(Stack[-6]); Obj=9 // @poff=28
0xae: Pop(0)
0xaf: Stack[-5] = (int) 0
0xb0: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0xb1: IF (Stack[-1] == 0) GOTO 0xce; Pop(1)

0xb2: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0xb3: Pop(0)
0xb4: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0xb5: Pop(0)
0xb6: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0xb7: Pop(0)
0xb8: Push("default") // @poff=33
0xb9: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0xba: Pop(1)
...
0xc0: Push("default") // @poff=33
0xc1: Push((int) 15)
0xc2: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0xd5: @@@ get(Stack[-10], Stack[-4]T); Obj=7 // @poff=4
0xd6: Pop(0)
0xd7: @@@ get(Stack[-9], Stack[-4]T); Obj=8 // @poff=4
0xd8: Pop(0)
0xd9: @@@ get(Stack[-8], Stack[-4]T); Obj=9 // @poff=4
0xda: Pop(0)
0xdb: @@ size(Stack[-7]); Obj=10 // @poff=28
0xdc: Pop(0)
0xdd: Stack[-6] = (int) 0
0xde: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0xdf: IF (Stack[-1] == 0) GOTO 0x107; Pop(1)

0xe0: Stack[-11] = Stack[-5]
0xe1: @@ get(Stack[-4], Stack[-6]); Obj=10 // @poff=4
0xe2: Pop(0)
0xe3: @@ get(Stack[-3], Stack[-6]); Obj=9 // @poff=4
0xe4: Pop(0)
0xe5: @@ get(Stack[-2], Stack[-6]); Obj=8 // @poff=4
0xe6: Pop(0)
0xe7: Push("default") // @poff=33
0xe8: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0xe9: Pop(1)
...
0xef: Push("default") // @poff=33
0xf0: Push((int) 15)
0xf1: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x10e: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0x10f: Pop(0)
0x110: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0x111: Pop(0)
0x112: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0x113: Pop(0)
0x114: @@ size(Stack[-6]); Obj=9 // @poff=28
0x115: Pop(0)
0x116: Stack[-5] = (int) 0
0x117: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x118: IF (Stack[-1] == 0) GOTO 0x153; Pop(1)

0x119: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0x11a: Pop(0)
0x11b: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0x11c: Pop(0)
0x11d: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0x11e: Pop(0)
0x11f: Pop(0); Push((bool) Stack[-2] == Stack[6 + Tasks[-1].StackPointer])
0x120: IF (Stack[-1] == 0) GOTO 0x129; Pop(1)

0x121: Push("default") // @poff=33
0x122: Push((int) 0)
0x123: Push((float)1.0)
0x124: Push((float)1.0)
0x125: Push((float)1.0)
0x126: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x127: Pop(5)
0x128: GOTO 0x130

0x129: Push("default") // @poff=33
0x12a: Push((int) 0)
0x12b: Push((float)0.8040000200271606)
0x12c: Push((float)0.8040000200271606)
0x12d: Push((float)0.8040000200271606)
0x12e: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x12f: Pop(5)
...
0x137: Push("default") // @poff=33
0x138: Push((int) 15)
0x139: Push((int) 15)
0x13a: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x13b: Push((float)0.8040000200271606)
0x13c: Push((float)0.8040000200271606)
0x13d: Push((float)0.8040000200271606)
0x13e: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-16], Stack[-4], Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x13f: Pop(6)
0x140: GOTO 0x14a

0x141: Push("default") // @poff=33
0x142: Push((int) 15)
0x143: Push((int) 15)
0x144: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0x145: Push((float)0.6980000138282776)
0x146: Push((float)0.6589999794960022)
0x147: Push((float)0.6470000147819519)
...
0x159: Stack[-5] = Stack[-1]
0x15a: Call2 0xd3

0x15b: Stack[-2] = Stack[-3]
0x15c: Pop(2)
0x15d: Push((int) -1)
