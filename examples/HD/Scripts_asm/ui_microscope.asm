...
Strings:
	...
	W:slot
	A:Compare
// @pool_raw:
...
0x8: Push("inventory_base.xml") // @poff=14
0x9: Push((bool) 0)
0xa: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0xb: Pop(2)
0xc: PushEmpty(int)
0xd: Stack[-1] = (int) 4
0xe: Call2 0x6e
...
0x18: @@ GetItemID(Stack[-2]); Obj=5 // @poff=52
0x19: Pop(0)
0x1a: Push("Microscope") // @poff=62
...
0x2b: Pop(1)
0x2c: @@ GetItem(Stack[-2], Stack[-5], Stack[-4]); Obj=1 // @poff=84
0x2d: Pop(1)
...
0x46: Pop(1)
0x47: @@ GetItem(Stack[-3], Stack[-9], Stack[-0]T); Obj=4 // @poff=84
0x48: Pop(0)
0x49: PushEmpty(bool, object, object)
0x4a: Stack[-2] = Stack[2 + Tasks[-1].StackPointer]
0x4b: Stack[-6] = Stack[-1]
0x4c: Call2 0x2cb

0x4d: Stack[-3] = Stack[-5]
0x4e: Pop(3)
0x4f: Push(Stack[-2])
...
0x89: Pop(1)
0x8a: @@ add(Stack[-1]); Obj=2 // @poff=128
0x8b: Pop(1)
...
0x94: Pop(1)
0x95: @@ add(Stack[-1]); Obj=2 // @poff=128
0x96: Pop(1)
0x97: Push((int) -1)
...
0x17f: Stack[-19] = Stack[-3]
0x180: Stack[-18] = Stack[-2]
0x181: Stack[-17] = Stack[-1]
0x182: Call2 0x13

0x183: Stack[-4] = Stack[-10]
0x184: Pop(4)
0x185: Return(); Pop(12)

0x186: Push("button_weapon") // @poff=148
...
0x18f: Push("button_clothes") // @poff=176
...
0x198: Push("button_medcine") // @poff=206
...
0x1a1: Push("button_food") // @poff=236
...
0x1aa: Push("button_other") // @poff=260
...
0x1be: Push("noinv_drop") // @poff=354
...
0x1d1: Pop(1)
0x1d2: @@ GetItemCount(Stack[-2], Stack[-0]T); Obj=3 // @poff=376
0x1d3: Pop(0)
0x1d4: Pop(0); Push((bool) Stack[-2] > Stack[-4])
0x1d5: IF (Stack[-1] == 0) GOTO 0x1e6; Pop(1)

0x1d6: @@ GetItem(Stack[-1], Stack[-4], Stack[-0]T); Obj=3 // @poff=84
0x1d7: Pop(0)
...
0x1df: Stack[-7] = Stack[-2]
0x1e0: Push((int) 0)
0x1e1: Stack[-2] = Stack[-19] == Stack[-1]; Pop(1);
0x1e2: Call2 0x37

0x1e3: Stack[-3] = Stack[-9]
0x1e4: Pop(3)
0x1e5: Stack[-1] = 0
0x1e6: GOTO 0x1eb
...
0x1ee: Stack[-19] = Stack[-3]
0x1ef: Stack[-18] = Stack[-2]
0x1f0: Stack[-17] = Stack[-1]
0x1f1: Call2 0x13

0x1f2: Stack[-4] = Stack[-10]
0x1f3: Pop(4)
0x1f4: Push(Stack[-6])
...
0x209: Pop(1)
0x20a: Push("money") // @poff=389
0x20b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=401
0x20c: Pop(1)
...
0x21b: Push((int) 0)
0x21c: Push("button_weapon") // @poff=148
0x21d: @ SendMessage(Stack[-2], Stack[-1])
0x21e: Pop(2)
0x21f: GOTO 0x224

0x220: Push((int) 1)
0x221: Push("button_weapon") // @poff=148
...
0x227: Push((int) 0)
0x228: Push("button_clothes") // @poff=176
0x229: @ SendMessage(Stack[-2], Stack[-1])
0x22a: Pop(2)
0x22b: GOTO 0x230

0x22c: Push((int) 1)
0x22d: Push("button_clothes") // @poff=176
...
0x233: Push((int) 0)
0x234: Push("button_medcine") // @poff=206
0x235: @ SendMessage(Stack[-2], Stack[-1])
0x236: Pop(2)
0x237: GOTO 0x23c

0x238: Push((int) 1)
0x239: Push("button_medcine") // @poff=206
...
0x23f: Push((int) 0)
0x240: Push("button_food") // @poff=236
0x241: @ SendMessage(Stack[-2], Stack[-1])
0x242: Pop(2)
0x243: GOTO 0x248

0x244: Push((int) 1)
0x245: Push("button_food") // @poff=236
...
0x24b: Push((int) 0)
0x24c: Push("button_other") // @poff=260
0x24d: @ SendMessage(Stack[-2], Stack[-1])
0x24e: Pop(2)
0x24f: GOTO 0x254

0x250: Push((int) 1)
0x251: Push("button_other") // @poff=260
...
0x258: Stack[-1] = Stack[-8]
0x259: Pop(1)
0x25a: @@ GetItemCount(Stack[-6], Stack[-15]); Obj=7 // @poff=376
0x25b: Pop(0)
0x25c: Stack[-5] = (int) 0
0x25d: Push((int) 12)
...
0x262: @@ GetItem(Stack[-4], Stack[-5], Stack[-15]); Obj=7 // @poff=84
0x263: Pop(0)
0x264: @@ GetItemAmount(Stack[-3], Stack[-5], Stack[-15]); Obj=7 // @poff=413
0x265: Pop(0)
0x266: PushEmpty(bool, int, int)
0x267: Stack[-8] = Stack[-2]
0x268: Stack[-18] = Stack[-1]
0x269: Call2 0x1f
...
0x2bd: @@ GetItemID(Stack[-1]); Obj=3 // @poff=52
0x2be: Pop(0)
...
0x2c5: Stack[-2] = Stack[-4]
0x2c6: Pop(2)
0x2c7: @ GetInvItemName(Stack[-1], Stack[-2])
0x2c8: Pop(0)
0x2c9: Stack[-1] = Stack[-6]
0x2ca: Return(); Pop(4)
...
0x2cf: IF (Stack[-1] == 1) GOTO 0x2d3; Pop(1)

0x2d0: Pop(0); Push((bool) Stack[-4] == 0)
0x2d1: IF (Stack[-1] == 1) GOTO 0x2d3; Pop(1)
...
0x2d6: @@ Compare(Stack[-1], Stack[-3]); Obj=4 // @poff=449
0x2d7: Pop(0)
