...
Strings:
	W:options_border.xml
	A:add
	W:video_page
	W:audio_page
	W:control_page
	W:anisotropic_scrollbar
	W:gamma_scrollbar
	W:fov_scrollbar
	W:vsync_check
	W:shadow_check
	...
	W:voice_scrollbar
	W:sounds_scrollbar
	W:sensivity_scrollbar
	W:gamepad_scrollbar
	W:gamepad_ui_scrollbar
	W:invert_mouse_check
	W:invert_gamepad_check
	W:rumble_gamepad_check
	W:key_form
	W:apply
	W:cancel
	W:video
	W:audio
	W:controls
	W:resolution_button_next
	W:resolution_button_prev
	A:DestroyWindow
	W:video_page.xml
	W:audio_page.xml
	W:control_page.xml
// @pool_raw:
...
0x2: Pop(0)
0x3: Push("options_border.xml") // @poff=0
0x4: Push((bool) 0)
0x5: @ CreateWindow(Stack[-2], Stack[-1], Stack[-0]T)
0x6: Pop(2)
...
0x86: PushEmpty()
0x87: Push((int) 100)
0x88: Push((float)0.10000000149011612)
0x89: Pop(1); Push(Stack[-3] - Stack[-1]);
0x8a: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8b: Push((float)4.900000095367432)
0x8c: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x8d: Return(); Pop(0)

0x8e: PushEmpty()
0x8f: Push((float)0.10000000149011612)
0x90: Push((float)4.900000095367432)
...
0x96: PushEmpty()
0x97: Push((float)0.10000000149011612)
0x98: Push((float)4.900000095367432)
...
0x9e: PushEmpty()
0x9f: Push((float)0.10000000149011612)
0xa0: Push((float)4.900000095367432)
...
0xac: Pop(0)
0xad: @@ add(Stack[-2]); Obj=1 // @poff=38
0xae: Pop(0)
0xaf: Push((int) 104)
0xb0: Push("video_page") // @poff=42
...
0xbb: Pop(0)
0xbc: @@ add(Stack[-2]); Obj=1 // @poff=38
0xbd: Pop(0)
0xbe: Pop(0); Push((bool) Stack[-2] != Stack[23 + Tasks[-1].StackPointer])
0xbf: @@ add(Stack[-1]); Obj=2 // @poff=38
0xc0: Pop(1)
0xc1: Push((int) 103)
0xc2: Push("video_page") // @poff=42
...
0xcb: Pop(0)
0xcc: @@ add(Stack[-3]); Obj=1 // @poff=38
0xcd: Pop(0)
0xce: Push((int) 100)
0xcf: Push("video_page") // @poff=42
...
0xda: Pop(0)
0xdb: @@ add(Stack[-2]); Obj=1 // @poff=38
0xdc: Pop(0)
0xdd: Pop(0); Push((bool) Stack[-2] != Stack[22 + Tasks[-1].StackPointer])
0xde: @@ add(Stack[-1]); Obj=2 // @poff=38
0xdf: Pop(1)
0xe0: Push((int) 101)
0xe1: Push("video_page") // @poff=42
...
0xea: Pop(0)
0xeb: @@ add(Stack[-3]); Obj=1 // @poff=38
0xec: Pop(0)
0xed: Push((int) 105)
0xee: Push("audio_page") // @poff=64
...
0xf7: Pop(0)
0xf8: @@ add(Stack[-3]); Obj=1 // @poff=38
0xf9: Pop(0)
0xfa: Push((int) 106)
0xfb: Push("audio_page") // @poff=64
...
0x104: Pop(0)
0x105: @@ add(Stack[-3]); Obj=1 // @poff=38
0x106: Pop(0)
0x107: Push((int) 107)
0x108: Push("audio_page") // @poff=64
...
0x111: Pop(0)
0x112: @@ add(Stack[-3]); Obj=1 // @poff=38
0x113: Pop(0)
0x114: Push((int) 108)
0x115: Push("audio_page") // @poff=64
...
0x11e: Pop(0)
0x11f: @@ add(Stack[-3]); Obj=1 // @poff=38
0x120: Pop(0)
0x121: Push((int) 109)
0x122: Push("control_page") // @poff=86
...
0x12b: Pop(0)
0x12c: @@ add(Stack[-3]); Obj=1 // @poff=38
0x12d: Pop(0)
0x12e: Push((int) 110)
0x12f: Push("control_page") // @poff=86
...
0x138: Pop(0)
0x139: @@ add(Stack[-3]); Obj=1 // @poff=38
0x13a: Pop(0)
0x13b: Push((int) 111)
0x13c: Push("control_page") // @poff=86
...
0x1a0: Pop(1)
0x1a1: @ EnableShadows(Stack[-25]T)
0x1a2: Pop(0)
...
0x1a6: Pop(1)
0x1a7: @ EnableDOF(Stack[-27]T)
0x1a8: Pop(0)
0x1a9: @ EnableSSAO(Stack[-26]T)
0x1aa: Pop(0)
0x1ab: @ EnableBloom(Stack[-28]T)
0x1ac: Pop(0)
0x1ad: @ EnableMotionBlur(Stack[-29]T)
0x1ae: Pop(0)
0x1af: @ EnableFXAA(Stack[-34]T)
0x1b0: Pop(0)
...
0x1cc: Pop(1)
0x1cd: @ InvertMouse(Stack[-31]T)
0x1ce: Pop(0)
0x1cf: @ InvertGamepad(Stack[-32]T)
0x1d0: Pop(0)
0x1d1: @ EnableGamepadRumble(Stack[-33]T)
0x1d2: Pop(0)
0x1d3: @ SaveConfig()
0x1d4: Pop(0)
0x1d5: @ WriteBinds()
...
0x1eb: Pop(1)
0x1ec: @ EnableShadows(Stack[-35]T)
0x1ed: Pop(0)
0x1ee: @ EnableDOF(Stack[-37]T)
0x1ef: Pop(0)
0x1f0: @ EnableSSAO(Stack[-36]T)
0x1f1: Pop(0)
0x1f2: @ EnableBloom(Stack[-38]T)
0x1f3: Pop(0)
0x1f4: @ EnableMotionBlur(Stack[-39]T)
0x1f5: Pop(0)
0x1f6: @ EnableFXAA(Stack[-44]T)
0x1f7: Pop(0)
...
0x213: Pop(1)
0x214: @ InvertMouse(Stack[-41]T)
0x215: Pop(0)
0x216: @ InvertGamepad(Stack[-42]T)
0x217: Pop(0)
0x218: @ EnableGamepadRumble(Stack[-43]T)
0x219: Pop(0)
0x21a: Return(); Pop(0)
...
0x222: Pop(1)
0x223: Push("anisotropic_scrollbar") // @poff=112
...
0x229: Pop(1)
0x22a: Push("gamma_scrollbar") // @poff=156
...
0x230: Pop(1)
0x231: Push("fov_scrollbar") // @poff=188
...
0x238: Push((int) 0)
0x239: Push("vsync_check") // @poff=216
...
0x240: Push((int) 0)
0x241: Push("shadow_check") // @poff=240
...
0x250: Push((int) 0)
0x251: Push("ssao_check") // @poff=286
...
0x258: Push((int) 0)
0x259: Push("bloom_check") // @poff=308
...
0x260: Push((int) 0)
0x261: Push("motionblur_check") // @poff=332
...
0x268: Push((int) 0)
0x269: Push("fxaa_check") // @poff=366
...
0x270: Push((int) 100)
0x271: Pop(1); Push(Stack[-1] * Stack[4 + Tasks[-1].StackPointer]);
0x272: Push("master_scrollbar") // @poff=388
0x273: @ SendMessage(Stack[-2], Stack[-1])
0x274: Pop(2)
0x275: Push((int) 100)
0x276: Pop(1); Push(Stack[-1] * Stack[5 + Tasks[-1].StackPointer]);
0x277: Push("music_scrollbar") // @poff=422
0x278: @ SendMessage(Stack[-2], Stack[-1])
0x279: Pop(2)
0x27a: Push((int) 100)
0x27b: Pop(1); Push(Stack[-1] * Stack[6 + Tasks[-1].StackPointer]);
0x27c: Push("voice_scrollbar") // @poff=454
0x27d: @ SendMessage(Stack[-2], Stack[-1])
0x27e: Pop(2)
0x27f: Push((int) 100)
0x280: Pop(1); Push(Stack[-1] * Stack[7 + Tasks[-1].StackPointer]);
0x281: Push("sounds_scrollbar") // @poff=486
...
0x28b: Pop(1)
0x28c: Push("sensivity_scrollbar") // @poff=520
...
0x292: Pop(1)
0x293: Push("gamepad_scrollbar") // @poff=560
...
0x299: Pop(1)
0x29a: Push("gamepad_ui_scrollbar") // @poff=596
...
0x2a1: Push((int) 0)
0x2a2: Push("invert_mouse_check") // @poff=638
...
0x2a9: Push((int) 0)
0x2aa: Push("invert_gamepad_check") // @poff=676
...
0x2ef: Push("resolution_button_next") // @poff=846
...
0x301: Push("resolution_button_prev") // @poff=892
...
0x33a: Push("vsync_check") // @poff=216
...
0x344: Push("shadow_check") // @poff=240
...
0x350: Push("ssao_check") // @poff=286
...
0x356: Push("bloom_check") // @poff=308
...
0x35c: Push("motionblur_check") // @poff=332
...
0x362: Push("fxaa_check") // @poff=366
...
0x36b: Push("master_scrollbar") // @poff=388
...
0x375: Push("music_scrollbar") // @poff=422
...
0x37f: Push("voice_scrollbar") // @poff=454
...
0x389: Push("sounds_scrollbar") // @poff=486
...
0x3a3: Push("invert_mouse_check") // @poff=638
...
0x3c3: Push("invert_gamepad_check") // @poff=676
...
0x3c9: Push("rumble_gamepad_check") // @poff=718
...
0x3d6: @@@ DestroyWindow(); Obj=1 // @poff=938
0x3d7: Pop(0)
0x3d8: Push((int) 0)
0x3d9: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x3da: IF (Stack[-1] == 0) GOTO 0x3f8; Pop(1)

0x3db: Push("video_page.xml") // @poff=952
0x3dc: Push((bool) 0)
0x3dd: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x3de: Pop(2)
0x3df: Push((int) 1)
0x3e0: Push("video") // @poff=804
0x3e1: @ SendMessage(Stack[-2], Stack[-1])
0x3e2: Pop(2)
0x3e3: Push((int) 0)
0x3e4: Push("audio") // @poff=816
0x3e5: @ SendMessage(Stack[-2], Stack[-1])
0x3e6: Pop(2)
0x3e7: Push((int) 0)
0x3e8: Push("controls") // @poff=828
...
0x3fb: Push("audio_page.xml") // @poff=982
0x3fc: Push((bool) 0)
0x3fd: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x3fe: Pop(2)
0x3ff: Push((int) 0)
0x400: Push("video") // @poff=804
0x401: @ SendMessage(Stack[-2], Stack[-1])
0x402: Pop(2)
0x403: Push((int) 1)
0x404: Push("audio") // @poff=816
0x405: @ SendMessage(Stack[-2], Stack[-1])
0x406: Pop(2)
0x407: Push((int) 0)
0x408: Push("controls") // @poff=828
...
0x40f: Push((int) 0)
0x410: Push("video") // @poff=804
0x411: @ SendMessage(Stack[-2], Stack[-1])
0x412: Pop(2)
0x413: Push((int) 0)
0x414: Push("audio") // @poff=816
0x415: @ SendMessage(Stack[-2], Stack[-1])
0x416: Pop(2)
0x417: Push((int) 1)
0x418: Push("controls") // @poff=828
0x419: @ SendMessage(Stack[-2], Stack[-1])
0x41a: Pop(2)
0x41b: Push("control_page.xml") // @poff=1012
0x41c: Push((bool) 0)
0x41d: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x41e: Pop(2)
0x41f: PushEmpty(int)
