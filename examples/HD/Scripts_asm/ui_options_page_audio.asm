...
Strings:
	...
	W:default
	A:get
// @pool_raw:25000000640065006600610075006c007400000067657400
...
0xe: Push("default") // @poff=4
0xf: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-0]T)
0x10: Pop(1)
0x11: Push((int) 305)
0x12: Push((int) 2)
...
0x24: Push("default") // @poff=4
0x25: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-1]T)
0x26: Pop(1)
0x27: Push((int) 305)
0x28: Push((int) 2)
...
0x3a: Push("default") // @poff=4
0x3b: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-2]T)
0x3c: Pop(1)
0x3d: Push((int) 305)
0x3e: Push((int) 2)
...
0x50: Push("default") // @poff=4
0x51: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-3]T)
0x52: Pop(1)
0x53: Push((int) 305)
0x54: Push((int) 2)
...
0x83: Pop(4)
0x84: Push("default") // @poff=4
0x85: Push((int) 15)
0x86: @ Print(Stack[-2], Stack[-4]T, Stack[-1], Stack[-0]T)
0x87: Pop(2)
0x88: Push("default") // @poff=4
0x89: Push((int) 15)
0x8a: Push((int) 98)
...
0x90: Pop(4)
0x91: Push("default") // @poff=4
0x92: Push((int) 98)
0x93: @ Print(Stack[-2], Stack[-5]T, Stack[-1], Stack[-1]T)
0x94: Pop(2)
0x95: Push("default") // @poff=4
0x96: Push((int) 16)
0x97: Push((int) 182)
...
0x9d: Pop(4)
0x9e: Push("default") // @poff=4
0x9f: Push((int) 182)
0xa0: @ Print(Stack[-2], Stack[-6]T, Stack[-1], Stack[-2]T)
0xa1: Pop(2)
0xa2: Push("default") // @poff=4
0xa3: Push((int) 16)
0xa4: Push((int) 265)
...
0xaa: Pop(4)
0xab: Push("default") // @poff=4
0xac: Push((int) 265)
0xad: @ Print(Stack[-2], Stack[-7]T, Stack[-1], Stack[-3]T)
0xae: Pop(2)
0xaf: Return(); Pop(0)
...
0xb3: Push((int) 0)
0xb4: @@ get(Stack[-2], Stack[-1]); Obj=4 // @poff=20
0xb5: Pop(1)
0xb6: Push((int) 105)
