...
Strings:
	W:default
	A:get
// @pool_raw:640065006600610075006c007400000067657400
...
0x3: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-0]T)
0x4: Pop(1)
0x5: Push((int) 305)
0x6: Push((int) 2)
...
0xd: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-1]T)
0xe: Pop(1)
0xf: Push((int) 305)
0x10: Push((int) 2)
...
0x17: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-2]T)
0x18: Pop(1)
0x19: Push((int) 305)
0x1a: Push((int) 2)
...
0x43: Pop(4)
0x44: Push("default") // @poff=0
0x45: Push((int) 12)
0x46: @ Print(Stack[-2], Stack[-3]T, Stack[-1], Stack[-0]T)
0x47: Pop(2)
0x48: Push("default") // @poff=0
0x49: Push((int) 15)
0x4a: Push((int) 64)
...
0x50: Pop(4)
0x51: Push("default") // @poff=0
0x52: Push((int) 64)
0x53: @ Print(Stack[-2], Stack[-4]T, Stack[-1], Stack[-1]T)
0x54: Pop(2)
0x55: Push("default") // @poff=0
0x56: Push((int) 15)
0x57: Push((int) 112)
...
0x5d: Pop(4)
0x5e: Push("default") // @poff=0
0x5f: Push((int) 112)
0x60: @ Print(Stack[-2], Stack[-5]T, Stack[-1], Stack[-2]T)
0x61: Pop(2)
0x62: Push("default") // @poff=0
0x63: Push((int) 15)
0x64: Push((int) 164)
...
0x81: Push((int) 0)
0x82: @@ get(Stack[-2], Stack[-1]); Obj=4 // @poff=16
0x83: Pop(1)
0x84: Push((int) 109)
