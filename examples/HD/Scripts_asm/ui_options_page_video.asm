...
Strings:
	...
	W:x
	A:get
// @pool_raw:640065006600610075006c00740000007800000067657400
...
0x4: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-3]T)
0x5: Pop(1)
0x6: Push((int) 305)
0x7: Push((int) 2)
...
0xd: Push("default") // @poff=0
0xe: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-0]T)
0xf: Pop(1)
0x10: Push((int) 305)
0x11: Push((int) 2)
...
0x1b: Push("default") // @poff=0
0x1c: @ GetTextWidth(Stack[-2], Stack[-1], Stack[-1]T)
0x1d: Pop(1)
0x1e: Push((int) 332)
...
0x2f: Push("default") // @poff=0
0x30: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-2]T)
0x31: Pop(1)
0x32: Push((int) 305)
0x33: Push((int) 2)
...
0x62: Pop(4)
0x63: Push("default") // @poff=0
0x64: Push((int) 29)
0x65: @ Print(Stack[-2], Stack[-7]T, Stack[-1], Stack[-1]T)
0x66: Pop(2)
0x67: Push("default") // @poff=0
0x68: Push((int) 15)
0x69: Push((int) 62)
...
0x6f: Pop(4)
0x70: Push("default") // @poff=0
0x71: Push((int) 62)
0x72: @ Print(Stack[-2], Stack[-9]T, Stack[-1], Stack[-2]T)
0x73: Pop(2)
0x74: Push("default") // @poff=0
0x75: Push((int) 15)
0x76: Push((int) 112)
...
0x7c: Pop(4)
0x7d: Push("default") // @poff=0
0x7e: Push((int) 112)
0x7f: @ Print(Stack[-2], Stack[-10]T, Stack[-1], Stack[-0]T)
0x80: Pop(2)
0x81: Push("default") // @poff=0
0x82: Push((int) 15)
0x83: Push((int) 162)
...
0x89: Pop(4)
0x8a: Push("default") // @poff=0
0x8b: Push((int) 162)
0x8c: @ Print(Stack[-2], Stack[-8]T, Stack[-1], Stack[-3]T)
0x8d: Pop(2)
0x8e: Push("default") // @poff=0
0x8f: Push((int) 15)
0x90: Push((int) 223)
...
0xe3: Pop(1)
0xe4: Push((float)0.8999999761581421)
0xe5: Push((float)0.0)
0xe6: Push((float)0.0)
...
0xed: Push((int) 0)
0xee: @@ get(Stack[-2], Stack[-1]); Obj=4 // @poff=20
0xef: Pop(1)
0xf0: Push((int) 100)
...
0xfe: Pop(1)
0xff: Push((int) 1)
0x100: @@ get(Stack[-4]T, Stack[-1]); Obj=4 // @poff=20
0x101: Pop(1)
0x102: GOTO 0x11c
...
0x107: Stack[-2] = Stack[-1]
0x108: Call2 0x23

0x109: Pop(1)
0x10a: Push((int) 1)
0x10b: @@ get(Stack[-5]T, Stack[-1]); Obj=4 // @poff=20
0x10c: Pop(1)
0x10d: GOTO 0x11c
...
0x119: Push((int) 1)
0x11a: @@ get(Stack[-6]T, Stack[-1]); Obj=4 // @poff=20
0x11b: Pop(1)
0x11c: Return(); Pop(2)
