...
Strings:
	W:default
	W:branch
// @pool_raw:640065006600610075006c00740000006200720061006e00630068000000
...
0x2d: Push("default") // @poff=0
0x2e: Push((float)0.6549019813537598)
0x2f: Push((float)0.6549019813537598)
0x30: Push((float)0.6549019813537598)
0x31: @ Print(Stack[-4], Stack[-1]T, Stack[-2]T, Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x32: Pop(4)
0x33: Return(); Pop(0)

0x34: PushEmpty(int, int)
0x35: Push("branch") // @poff=16
0x36: @ GetVariable(Stack[-1], Stack[-2])
0x37: Pop(1)
0x38: Stack[-1] = Stack[-3]
0x39: Return(); Pop(2)
