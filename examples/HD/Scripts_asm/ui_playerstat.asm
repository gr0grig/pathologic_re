...
Strings:
	...
	W:walk_distance
	A:HasProperty
// @pool_raw:
...
0x2: @ GetWindowSize(Stack[-12]T, Stack[-13]T)
0x3: Pop(0)
...
0x9: Push("visir.xml") // @poff=0
0xa: Push((bool) 0)
0xb: @ CreateWindow(Stack[-2], Stack[-1], Stack[-0]T)
0xc: Pop(2)
0xd: PushEmpty(int)
0xe: Call2 0x428

0xf: Pop(0)
0x10: Push("charge") // @poff=20
...
0x15: Pop(0)
0x16: @ CreateIntVector(Stack[-5]T)
0x17: Pop(0)
0x18: @ CreateStringVector(Stack[-2]T)
0x19: Pop(0)
0x1a: @ CreateIntVector(Stack[-3]T)
0x1b: Pop(0)
0x1c: @ CreateFloatVector(Stack[-4]T)
0x1d: Pop(0)
0x1e: @ CreateIntVector(Stack[-6]T)
0x1f: Pop(0)
0x20: @ CreateIntVector(Stack[-7]T)
0x21: Pop(0)
0x22: @ CreateFloatVector(Stack[-8]T)
0x23: Pop(0)
0x24: EventDisable(1)
0x25: EventDisable(0)
0x26: Push((bool) 1)
...
0x42: @@@ add(Stack[-7]); Obj=5 // @poff=48
0x43: Pop(0)
0x44: @@@ size(Stack[-3]); Obj=5 // @poff=52
0x45: Pop(0)
0x46: Stack[-2] = (int) 0
0x47: Push((int) 1)
...
0x4b: @@@ get(Stack[-1], Stack[-2]); Obj=5 // @poff=57
0x4c: Pop(0)
0x4d: Pop(0); Push((bool) Stack[-1] == Stack[-7])
0x4e: IF (Stack[-1] == 0) GOTO 0x52; Pop(1)

0x4f: @@@ remove(Stack[-2]); Obj=5 // @poff=61
0x50: Pop(0)
0x51: Return(); Pop(6)
...
0x6b: @@@ add(Stack[-7]); Obj=3 // @poff=48
0x6c: Pop(0)
0x6d: Push((float)4.0)
0x6e: @@@ add(Stack[-1]); Obj=4 // @poff=48
0x6f: Pop(1)
0x70: Return(); Pop(6)

0x71: Push((int) 0)
0x72: @@@ remove(Stack[-1]); Obj=3 // @poff=61
0x73: Pop(1)
0x74: Push((int) 0)
0x75: @@@ remove(Stack[-1]); Obj=4 // @poff=61
0x76: Pop(1)
0x77: Return(); Pop(0)

0x78: PushEmpty(int, float, int, float)
0x79: @@@ size(Stack[-2]); Obj=3 // @poff=52
0x7a: Pop(0)
...
0x7e: Push((int) 0)
0x7f: @@@ get(Stack[-2], Stack[-1]); Obj=4 // @poff=57
0x80: Pop(1)
...
0x85: Push((int) 0)
0x86: @@@ set(Stack[-1], Stack[-2]); Obj=4 // @poff=68
0x87: Pop(1)
0x88: GOTO 0x8c
...
0x8e: @@@ size(Stack[-4]); Obj=3 // @poff=52
0x8f: Pop(0)
...
0x93: Push((int) 0)
0x94: @@@ get(Stack[-4], Stack[-1]); Obj=3 // @poff=57
0x95: Pop(1)
0x96: Push((int) 0)
0x97: @@@ get(Stack[-3], Stack[-1]); Obj=4 // @poff=57
0x98: Pop(1)
0x99: Push((float)6.2829999923706055)
...
0xa0: Push("mail") // @poff=72
0xa1: Push((int) 20)
0xa2: Push((int) 130)
0xa3: Pop(1); Push(Stack[13 + Tasks[-1].StackPointer] - Stack[-1]);
0xa4: Push((float)0.5)
0xa5: Push((float)0.5)
...
0xaf: Push("diary") // @poff=82
0xb0: Push((int) 20)
0xb1: Push((int) 130)
0xb2: Pop(1); Push(Stack[13 + Tasks[-1].StackPointer] - Stack[-1]);
0xb3: Push((float)0.5)
0xb4: Push((float)0.5)
...
0xbe: Push("rep_up") // @poff=94
0xbf: Push((int) 20)
0xc0: Push((int) 100)
0xc1: Pop(1); Push(Stack[13 + Tasks[-1].StackPointer] - Stack[-1]);
0xc2: Push((float)0.5)
0xc3: Push((float)0.5)
...
0xcd: Push("rep_down") // @poff=108
0xce: Push((int) 20)
0xcf: Push((int) 100)
0xd0: Pop(1); Push(Stack[13 + Tasks[-1].StackPointer] - Stack[-1]);
0xd1: Push((float)0.5)
0xd2: Push((float)0.5)
...
0xda: @@@ add(Stack[-4]); Obj=6 // @poff=48
0xdb: Pop(0)
0xdc: @@@ add(Stack[-3]); Obj=7 // @poff=48
0xdd: Pop(0)
0xde: Push((float)4.0)
0xdf: @@@ add(Stack[-1]); Obj=8 // @poff=48
0xe0: Pop(1)
0xe1: @ GetInvItemSprite(Stack[-1], Stack[-4])
0xe2: Pop(0)
0xe3: @ LoadImage(Stack[-1])
0xe4: Pop(0)
0xe5: @@@ add(Stack[-1]); Obj=2 // @poff=48
0xe6: Pop(0)
0xe7: Return(); Pop(2)

0xe8: PushEmpty()
0xe9: @@@ remove(Stack[-1]); Obj=6 // @poff=61
0xea: Pop(0)
0xeb: @@@ remove(Stack[-1]); Obj=8 // @poff=61
0xec: Pop(0)
0xed: @@@ remove(Stack[-1]); Obj=7 // @poff=61
0xee: Pop(0)
0xef: Return(); Pop(0)

0xf0: PushEmpty(int, int, float, int, int, string, int, int, float, int, int, string)
0xf1: @@@ size(Stack[-6]); Obj=6 // @poff=52
0xf2: Pop(0)
...
0xf9: @@@ get(Stack[-4], Stack[-5]); Obj=8 // @poff=57
0xfa: Pop(0)
...
0xff: @@@ set(Stack[-5], Stack[-4]); Obj=8 // @poff=68
0x100: Pop(0)
0x101: GOTO 0x10a
...
0x11c: @@@ clear(); Obj=2 // @poff=126
0x11d: Pop(0)
0x11e: Return(); Pop(12)

0x11f: PushEmpty(int, int, int, int)
0x120: @@@ size(Stack[-2]); Obj=5 // @poff=52
0x121: Pop(0)
...
0x128: Push((int) 0)
0x129: @@@ get(Stack[-2], Stack[-1]); Obj=5 // @poff=57
0x12a: Pop(1)
0x12b: Push((int) 100)
0x12c: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x12d: IF (Stack[-1] == 0) GOTO 0x133; Pop(1)

0x12e: Push("daychange.xml") // @poff=132
0x12f: Push((bool) 0)
0x130: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x131: Pop(2)
0x132: GOTO 0x137

0x133: Push("daychangereal.xml") // @poff=160
0x134: Push((bool) 0)
0x135: @ CreateWindow(Stack[-2], Stack[-1], Stack[-1]T)
0x136: Pop(2)
0x137: PushEmpty()
0x138: Call2 0x56
...
0x140: @@@ size(Stack[-6]); Obj=6 // @poff=52
0x141: Pop(0)
...
0x148: @@@ get(Stack[-4], Stack[-5]); Obj=6 // @poff=57
0x149: Pop(0)
0x14a: @@@ get(Stack[-3], Stack[-5]); Obj=7 // @poff=57
0x14b: Pop(0)
0x14c: @@@ get(Stack[-2], Stack[-5]); Obj=8 // @poff=57
0x14d: Pop(0)
0x14e: Push((float)4.0)
0x14f: Pop(1); Push(Stack[-3] / Stack[-1]);
0x150: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x151: PushEmpty(int, int, int, float)
0x152: Stack[-8] = Stack[-4]
0x153: Stack[-7] = Stack[-3]
0x154: Stack[-9] = Stack[-2]
0x155: Stack[-5] = Stack[-1]
0x156: Call2 0x25f
...
0x168: @@ size(Stack[-6]); Obj=13 // @poff=52
0x169: Pop(0)
0x16a: Push((int) 1)
...
0x16d: Push((int) 0)
0x16e: @@ get(Stack[-10]T, Stack[-1]); Obj=14 // @poff=57
0x16f: Pop(1)
...
0x177: Push("visir.xml") // @poff=0
0x178: Push((bool) 0)
0x179: @ CreateWindow(Stack[-2], Stack[-1], Stack[-0]T)
0x17a: Pop(2)
0x17b: PushEmpty(int)
0x17c: Call2 0x428

0x17d: Pop(0)
0x17e: Push("charge") // @poff=20
...
0x18a: @@@ DestroyWindow(); Obj=0 // @poff=196
0x18b: Pop(0)
0x18c: GOTO 0x227
...
0x190: Push((int) 0)
0x191: @@ get(Stack[-6], Stack[-1]); Obj=14 // @poff=57
0x192: Pop(1)
0x193: Push((int) 1)
0x194: @@ get(Stack[-5], Stack[-1]); Obj=14 // @poff=57
0x195: Pop(1)
0x196: PushEmpty(int, int)
0x197: Stack[-7] = Stack[-2]
0x198: Stack[-6] = Stack[-1]
0x199: Call2 0xd9
...
0x19f: Push((int) 0)
0x1a0: @@ get(Stack[-4], Stack[-1]); Obj=14 // @poff=57
0x1a1: Pop(1)
0x1a2: Push((int) 1)
0x1a3: @@ get(Stack[-3], Stack[-1]); Obj=14 // @poff=57
0x1a4: Pop(1)
0x1a5: GOTO 0x227
...
0x1bc: Pop(1)
0x1bd: Push("mail") // @poff=72
0x1be: @ PlaySound(Stack[-1])
0x1bf: Pop(1)
0x1c0: Push("HasMail") // @poff=210
0x1c1: @ Trace(Stack[-1])
0x1c2: Pop(1)
0x1c3: GOTO 0x227
...
0x1ca: Pop(1)
0x1cb: Push("diary") // @poff=82
0x1cc: @ PlaySound(Stack[-1])
0x1cd: Pop(1)
0x1ce: Push("HasDiary") // @poff=226
0x1cf: @ Trace(Stack[-1])
0x1d0: Pop(1)
0x1d1: GOTO 0x227
...
0x1d5: Push("rep_up") // @poff=94
0x1d6: @ PlaySound(Stack[-1])
0x1d7: Pop(1)
0x1d8: Push("ReputationUP") // @poff=244
0x1d9: @ Trace(Stack[-1])
0x1da: Pop(1)
0x1db: GOTO 0x227
...
0x1df: Push("rep_down") // @poff=108
0x1e0: @ PlaySound(Stack[-1])
0x1e1: Pop(1)
0x1e2: Push("ReputationDown") // @poff=270
0x1e3: @ Trace(Stack[-1])
0x1e4: Pop(1)
0x1e5: GOTO 0x227
...
0x1ea: Stack[-2] = "tiredness" // @poff=300
...
0x1fc: Stack[-2] = "immunity" // @poff=334
...
0x205: Stack[-2] = "disease" // @poff=352
...
0x217: Stack[-2] = "repuatation" // @poff=382
...
0x21f: Push((int) 0)
0x220: @@ get(Stack[-2], Stack[-1]); Obj=14 // @poff=57
0x221: Pop(1)
...
0x283: @ GetStringByID(Stack[-2], Stack[-10]T)
0x284: Pop(0)
0x285: Push((float)3.140000104904175)
0x286: Pop(1); Push(Stack[-1] * Stack[11 + Tasks[-1].StackPointer]);
...
0x2a1: @ CreateStringVector(Stack[-14]T)
0x2a2: Pop(0)
0x2a3: @ CreateFloatVector(Stack[-15]T)
0x2a4: Pop(0)
0x2a5: @ CreateFloatVector(Stack[-16]T)
0x2a6: Pop(0)
0x2a7: @ CreateFloatVector(Stack[-17]T)
0x2a8: Pop(0)
0x2a9: @ CreateFloatVector(Stack[-18]T)
0x2aa: Pop(0)
0x2ab: @ CreateBoolVector(Stack[-19]T)
0x2ac: Pop(0)
0x2ad: Push("player") // @poff=34
0x2ae: @ FindActor(Stack[-6], Stack[-1])
0x2af: Pop(1)
0x2b0: Push(Stack[-5])
0x2b1: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)

0x2b2: Push("health") // @poff=368
0x2b3: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2b4: Pop(1)
0x2b5: Push((bool) 0)
0x2b6: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2b7: Pop(1)
0x2b8: Push("hunger") // @poff=320
0x2b9: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2ba: Pop(1)
0x2bb: Push((bool) 1)
0x2bc: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2bd: Pop(1)
0x2be: Push("tiredness") // @poff=300
0x2bf: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2c0: Pop(1)
0x2c1: Push((bool) 1)
0x2c2: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2c3: Pop(1)
0x2c4: Push("immunity") // @poff=334
0x2c5: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2c6: Pop(1)
0x2c7: Push((bool) 0)
0x2c8: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2c9: Pop(1)
0x2ca: Push("disease") // @poff=352
0x2cb: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2cc: Pop(1)
0x2cd: Push((bool) 1)
0x2ce: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2cf: Pop(1)
0x2d0: Push("reputation") // @poff=456
0x2d1: @@@ add(Stack[-1]); Obj=14 // @poff=48
0x2d2: Pop(1)
0x2d3: Push((bool) 0)
0x2d4: @@@ add(Stack[-1]); Obj=19 // @poff=48
0x2d5: Pop(1)
0x2d6: @@@ size(Stack[-4]); Obj=14 // @poff=52
0x2d7: Pop(0)
0x2d8: Stack[-3] = (int) 0
0x2d9: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x2da: IF (Stack[-1] == 0) GOTO 0x2ec; Pop(1)

0x2db: @@@ get(Stack[-2], Stack[-3]); Obj=14 // @poff=57
0x2dc: Pop(0)
0x2dd: @@ GetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=478
0x2de: Pop(0)
0x2df: @@@ add(Stack[-1]); Obj=15 // @poff=48
0x2e0: Pop(0)
0x2e1: @@@ add(Stack[-1]); Obj=16 // @poff=48
0x2e2: Pop(0)
0x2e3: Push((int) 0)
0x2e4: @@@ add(Stack[-1]); Obj=17 // @poff=48
0x2e5: Pop(1)
0x2e6: Push((int) 0)
0x2e7: @@@ add(Stack[-1]); Obj=18 // @poff=48
0x2e8: Pop(1)
0x2e9: Push((int) 1)
...
0x2ed: Push("BAD PLAYER!") // @poff=490
0x2ee: @ Trace(Stack[-1])
0x2ef: Pop(1)
0x2f0: Return(); Pop(10)
...
0x2f9: @@@ size(Stack[-7]); Obj=14 // @poff=52
0x2fa: Pop(0)
0x2fb: Stack[-6] = (int) 0
0x2fc: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x2fd: IF (Stack[-1] == 0) GOTO 0x329; Pop(1)

0x2fe: @@@ get(Stack[-5], Stack[-6]); Obj=14 // @poff=57
0x2ff: Pop(0)
0x300: Pop(0); Push((bool) Stack[-5] == Stack[-18])
0x301: IF (Stack[-1] == 0) GOTO 0x326; Pop(1)

0x302: @@@ get(Stack[-4], Stack[-6]); Obj=16 // @poff=57
0x303: Pop(0)
0x304: @@ GetProperty(Stack[-5], Stack[-3]); Obj=8 // @poff=478
0x305: Pop(0)
...
0x309: @@@ set(Stack[-6], Stack[-3]); Obj=16 // @poff=68
0x30a: Pop(0)
0x30b: Push(Stack[-17])
0x30c: IF (Stack[-1] == 0) GOTO 0x325; Pop(1)

0x30d: @@@ get(Stack[-2], Stack[-6]); Obj=15 // @poff=57
0x30e: Pop(0)
0x30f: Push((float)2.0)
0x310: @@@ set(Stack[-7], Stack[-1]); Obj=17 // @poff=68
0x311: Pop(1)
...
0x31a: Push((float)0.20000000298023224)
0x31b: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x31c: IF (Stack[-1] == 0) GOTO 0x31f; Pop(1)

0x31d: Stack[-1] = (float) 0.20000000298023224
0x31e: GOTO 0x323
...
0x323: @@@ set(Stack[-6], Stack[-1]); Obj=18 // @poff=68
0x324: Pop(0)
0x325: GOTO 0x329
...
0x32c: @@@ size(Stack[-3]); Obj=14 // @poff=52
0x32d: Pop(0)
0x32e: Stack[-2] = (int) 0
0x32f: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x330: IF (Stack[-1] == 0) GOTO 0x340; Pop(1)

0x331: @@@ get(Stack[-1], Stack[-2]); Obj=17 // @poff=57
0x332: Pop(0)
0x333: Push((int) 0)
...
0x33a: Stack[-1] = (int) 0
0x33b: @@@ set(Stack[-2], Stack[-1]); Obj=17 // @poff=68
0x33c: Pop(0)
0x33d: Push((int) 1)
...
0x36b: @@@ size(Stack[-12]); Obj=14 // @poff=52
0x36c: Pop(0)
0x36d: Stack[-11] = (int) 0
0x36e: Pop(0); Push((bool) Stack[-11] < Stack[-12])
0x36f: IF (Stack[-1] == 0) GOTO 0x402; Pop(1)

0x370: @@@ get(Stack[-10], Stack[-11]); Obj=14 // @poff=57
0x371: Pop(0)
0x372: @@@ get(Stack[-9], Stack[-11]); Obj=16 // @poff=57
0x373: Pop(0)
0x374: @@@ get(Stack[-8], Stack[-11]); Obj=18 // @poff=57
0x375: Pop(0)
0x376: @@@ get(Stack[-7], Stack[-11]); Obj=17 // @poff=57
0x377: Pop(0)
0x378: @@@ get(Stack[-6], Stack[-11]); Obj=19 // @poff=57
0x379: Pop(0)
0x37a: Push("health") // @poff=368
0x37b: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x37c: IF (Stack[-1] == 0) GOTO 0x388; Pop(1)

0x37d: Push((float)0.33000001311302185)
...
0x386: Stack[-5] = (float) 0.20000000298023224
0x387: GOTO 0x3cd

0x388: Push("immunity") // @poff=334
...
0x394: Stack[-5] = (float) 0.20000000298023224
0x395: GOTO 0x3cd

0x396: Push("tiredness") // @poff=300
0x397: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x398: IF (Stack[-1] == 0) GOTO 0x3a4; Pop(1)

0x399: Push((float)0.6600000262260437)
...
0x3a2: Stack[-5] = (float) 0.20000000298023224
0x3a3: GOTO 0x3cd

0x3a4: Push("hunger") // @poff=320
0x3a5: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x3a6: IF (Stack[-1] == 0) GOTO 0x3b2; Pop(1)

0x3a7: Push((float)0.6600000262260437)
...
0x3b0: Stack[-5] = (float) 0.20000000298023224
0x3b1: GOTO 0x3cd

0x3b2: Push("reputation") // @poff=456
0x3b3: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x3b4: IF (Stack[-1] == 0) GOTO 0x3c0; Pop(1)

0x3b5: Push((float)0.6600000262260437)
...
0x3be: Stack[-5] = (float) 0.20000000298023224
0x3bf: GOTO 0x3cd

0x3c0: Push("disease") // @poff=352
0x3c1: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x3c2: IF (Stack[-1] == 0) GOTO 0x3cd; Pop(1)

0x3c3: Push((float)0.33000001311302185)
...
0x3cc: Stack[-5] = (float) 0.20000000298023224
0x3cd: Push((int) 0)
...
0x3d2: Push((float)3.1414999961853027)
...
0x3e3: Push("nerv_b") // @poff=528
0x3e4: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-4]);
0x3e5: Pop(1); Push(Stack[-1] - Stack[-15]);
0x3e6: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-5]);
...
0x3ee: Push("nerv_r") // @poff=542
0x3ef: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-4]);
0x3f0: Pop(1); Push(Stack[-1] - Stack[-15]);
0x3f1: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-5]);
0x3f2: Pop(1); Push(Stack[-1] - Stack[-16]);
0x3f3: Push((int) 43)
0x3f4: @ BlitClipped(Stack[-4], Stack[-3], Stack[-18], Stack[-2], Stack[-18], Stack[-5], Stack[-1], Stack[-8])
0x3f5: Pop(4)
0x3f6: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-3]);
0x3f7: Pop(1); Push(Stack[-1] - Stack[-14]);
0x3f8: Pop(0); Push(Stack[12 + Tasks[-1].StackPointer] - Stack[-4]);
...
0x40d: Push("cross") // @poff=556
0x40e: Push((int) 2)
0x40f: Pop(1); Push(Stack[12 + Tasks[-1].StackPointer] / Stack[-1]);
0x410: Push((int) 1)
0x411: Pop(2); Push(Stack[-2] - Stack[-1]);
0x412: Push((int) 2)
0x413: Pop(1); Push(Stack[13 + Tasks[-1].StackPointer] / Stack[-1]);
0x414: Push((int) 1)
...
0x430: Push("vcharge") // @poff=568
0x431: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=478
0x432: Pop(1)
...
0x43e: @@ IsVisirOn(Stack[-1]); Obj=2 // @poff=584
0x43f: Pop(0)
...
0x44b: Push("visir") // @poff=594
0x44c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=478
0x44d: Pop(1)
...
0x459: @@ IsWeaponHolstered(Stack[-1]); Obj=2 // @poff=606
0x45a: Pop(0)
...
0x466: Push("walk_distance") // @poff=624
0x467: @@ HasProperty(Stack[-1], Stack[-3]); Obj=4 // @poff=652
0x468: Pop(1)
...
0x46d: Push("walk_distance") // @poff=624
0x46e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=478
0x46f: Pop(1)
