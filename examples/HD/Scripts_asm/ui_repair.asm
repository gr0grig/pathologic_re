...
Strings:
	...
	W:money
	A:GetProperty
// @pool_raw:
...
0xe: Pop(1)
0xf: @ GetChooseItems(Stack[-0]T)
0x10: Pop(0)
0x11: @ GetAdditionalData(Stack[-1]T)
0x12: Pop(0)
0x13: @ GetReturnValue(Stack[-2]T)
0x14: Pop(0)
...
0x32: Stack[-2] = Stack[-3]
0x33: Pop(2)
0x34: GOTO 0x36

0x35: Stack[-1] = "$parent" // @poff=16
0x36: @@ add(Stack[-2]); Obj=3 // @poff=32
0x37: Pop(0)
0x38: @@ add(Stack[-1]); Obj=3 // @poff=32
0x39: Pop(0)
0x3a: Push((int) -1)
0x3b: PushEmpty(string, int)
0x3c: Stack[-7] = Stack[-1]
0x3d: Call2 0x266
...
0x66: IF (Stack[-1] == 1) GOTO 0x6b; Pop(1)

0x67: Push((int) 2)
0x68: Pop(1); Push((bool) Stack[6 + Tasks[-1].StackPointer] == Stack[-1])
0x69: IF (Stack[-1] == 1) GOTO 0x6b; Pop(1)
...
0x82: IF (Stack[-1] == 1) GOTO 0x87; Pop(1)

0x83: Push((int) 0)
0x84: Pop(1); Push((bool) Stack[6 + Tasks[-1].StackPointer] == Stack[-1])
0x85: IF (Stack[-1] == 1) GOTO 0x87; Pop(1)
...
0xd0: IF (Stack[-1] == 1) GOTO 0xd5; Pop(1)

0xd1: Push((int) 2)
0xd2: Pop(1); Push((bool) Stack[6 + Tasks[-1].StackPointer] == Stack[-1])
0xd3: IF (Stack[-1] == 1) GOTO 0xd5; Pop(1)
...
0xec: IF (Stack[-1] == 1) GOTO 0xf1; Pop(1)
...
0x141: @@@ get(Stack[-1], Stack[-3]); Obj=1 // @poff=61
0x142: Pop(0)
...
0x173: @@@ size(Stack[-2]); Obj=0 // @poff=56
0x174: Pop(0)
0x175: Push((int) 4)
...
0x192: Pop(0)
0x193: Push("money_slot") // @poff=98
0x194: @ SendMessage(Stack[-2], Stack[-1])
0x195: Pop(2)
0x196: Push("sel_money_slot") // @poff=120
0x197: @ SendMessage(Stack[-4]T, Stack[-1])
0x198: Pop(1)
0x199: @@@ size(Stack[-4]); Obj=0 // @poff=56
0x19a: Pop(0)
0x19b: Stack[-3] = Stack[5 + Tasks[-1].StackPointer]
0x19c: Push((int) 4)
0x19d: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1a2: @@@ get(Stack[-2], Stack[-3]); Obj=0 // @poff=61
0x1a3: Pop(0)
0x1a4: @@@ get(Stack[-1], Stack[-3]); Obj=1 // @poff=61
0x1a5: Pop(0)
0x1a6: PushEmpty(bool, int)
0x1a7: Stack[-5] = Stack[-1]
0x1a8: Call2 0x129
...
0x1e3: @@@ size(Stack[-3]); Obj=0 // @poff=56
0x1e4: Pop(0)
0x1e5: Push((int) 4)
0x1e6: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x216: Push("scrollbar") // @poff=78
0x217: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x218: IF (Stack[-1] == 0) GOTO 0x22d; Pop(1)

0x219: @@@ size(Stack[-2]); Obj=0 // @poff=56
0x21a: Pop(0)
0x21b: Push((float)0.009999999776482582)
0x21c: Push((int) 4)
...
0x22f: Stack[-11] = Stack[-1]
0x230: Call2 0x276

0x231: Stack[-3] = Stack[-4]
0x232: Pop(3)
0x233: Push((int) -1)
...
0x289: Push("player") // @poff=162
0x28a: @ FindActor(Stack[-3], Stack[-1])
0x28b: Pop(1)
0x28c: Push("money") // @poff=176
0x28d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=188
0x28e: Pop(1)
0x28f: Stack[-1] = Stack[-5]
0x290: Return(); Pop(4)
