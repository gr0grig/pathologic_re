...
Strings:
	...
	W:slot0
	W:slot
// @pool_raw:640065006600610075006c0074000000240070006100720065006e0074000000730065006c00650063007400650064000000676574004765744974656d49440073006c006f0074003000000073006c006f0074000000
...
0x10: Push((int) 1)
0x11: Push((int) 1)
0x12: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x13: Pop(2)
0x14: Push((int) 1)
0x15: Pop(1); Push((bool) Stack[0 + Tasks[-1].StackPointer] > Stack[-1])
0x16: IF (Stack[-1] == 0) GOTO 0x1c; Pop(1)

0x17: Push("default") // @poff=0
0x18: Push((int) 2)
0x19: Push((int) 35)
0x1a: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x1b: Pop(3)
0x1c: Return(); Pop(0)
...
0xa5: Push((int) 0)
0xa6: @@ get(Stack[-6]T, Stack[-1]); Obj=8 // @poff=50
0xa7: Pop(1)
0xa8: Push((int) 1)
0xa9: @@ get(Stack[-7]T, Stack[-1]); Obj=8 // @poff=50
0xaa: Pop(1)
0xab: Return(); Pop(6)
...
0xda: Push("selected") // @poff=32
0xdb: @ SetBackground(Stack[-1])
0xdc: Pop(1)
0xdd: GOTO 0xe1

0xde: Push("default") // @poff=0
...
0xf3: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=54
0xf4: Pop(0)
0xf5: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0xf6: Pop(0)
0xf7: @ LoadImage(Stack[-3]T)
0xf8: Pop(0)
0xf9: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0xfa: Pop(0)
0xfb: Push((int) 1)
0xfc: @ SetTooltip(Stack[-1], Stack[-3], Stack[-2]T)
0xfd: Pop(1)
0xfe: GOTO 0x103
