...
Strings:
	...
	A:GetGameTime
	A:GetSaveTime
// @pool_raw:
...
0x27: Push((int) 1000)
0x28: Push("save") // @poff=0
0x29: @ SendMessage(Stack[-2], Stack[-1])
0x2a: Pop(2)
0x2b: Return(); Pop(0)

0x2c: PushEmpty()
0x2d: Pop(0); PushNull((bool) Stack[-3] == 0)
0x2e: IF (Stack[-1] == 0) GOTO 0x33; Pop(1)

0x2f: Push("button_save") // @poff=10
0x30: @ Blit(Stack[-1], Stack[-3], Stack[-2])
0x31: Pop(1)
0x32: GOTO 0x36

0x33: Push("button_overwrite") // @poff=34
...
0x3d: @@ GetFileName(Stack[-1]); Obj=3 // @poff=68
0x3e: Pop(0)
...
0x4d: @ CreateSaveEnumerator(Stack[-8]T)
0x4e: Pop(0)
...
0x52: @ CreateObjectVector(Stack[-9]T)
0x53: Pop(0)
0x54: Push(Stack[-7])
0x55: IF (Stack[-1] == 0) GOTO 0x5a; Pop(1)

0x56: Stack[-3] = 0
0x57: @@@ add(Stack[-3]); Obj=9 // @poff=80
0x58: Pop(0)
0x59: Stack[-3] = 0
0x5a: Push((int) 1)
0x5b: IF (Stack[-1] == 0) GOTO 0x6c; Pop(1)

0x5c: @@@ Next(Stack[-2]); Obj=8 // @poff=84
0x5d: Pop(0)
...
0x63: @@ IsQuickSave(Stack[-1]); Obj=2 // @poff=89
0x64: Pop(0)
0x65: Push(Stack[-1])
...
0x68: @@@ add(Stack[-2]); Obj=9 // @poff=80
0x69: Pop(0)
0x6a: Stack[-2] = 0
0x6b: GOTO 0x5a

0x6c: @ GetWindowSize(Stack[-4]T, Stack[-5]T)
0x6d: Pop(0)
0x6e: Stack[6 + Tasks[-1].StackPointer] = (int)0
0x6f: Stack[7 + Tasks[-1].StackPointer] = (int)0
0x70: @ ClientToScreen(Stack[-6]T, Stack[-7]T)
0x71: Pop(0)
...
0x78: Pop(1)
0x79: Push("sys_border.xml") // @poff=101
0x7a: Push((bool) 0)
0x7b: @ CreateWindow(Stack[-2], Stack[-1], Stack[-10]T)
0x7c: Pop(2)
0x7d: PushEmpty()
0x7e: Call2 0x234
...
0xb0: Pop(1)
0xb1: Push((float)0.5568627715110779)
0xb2: Push((float)0.5568627715110779)
0xb3: Push((float)0.5568627715110779)
0xb4: @ Print(Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xb5: Pop(7)
0xb6: GOTO 0xcd

0xb7: Push((int) 0)
0xb8: @@ GetProperty(Stack[-1], Stack[-4], Stack[-3]); Obj=9 // @poff=168
0xb9: Pop(1)
0xba: Push(Stack[-3])
...
0xc0: Stack[-2] = Stack[-6]
0xc1: Pop(2)
0xc2: GOTO 0xc4

0xc3: Stack[-4] = "????" // @poff=180
0xc4: Push("default") // @poff=152
0xc5: Push((int) 129)
0xc6: Push((int) 7)
0xc7: Pop(1); Push(Stack[-1] + Stack[-24]);
0xc8: Push((float)0.5568627715110779)
0xc9: Push((float)0.5568627715110779)
0xca: Push((float)0.5568627715110779)
...
0xdc: Stack[-10] = Stack[-1]
0xdd: Call2 0x273

0xde: Stack[-2] = Stack[-3]
0xdf: Pop(2)
0xe0: Push("default") // @poff=152
0xe1: Push((int) 129)
0xe2: Push((int) 47)
0xe3: Pop(1); Push(Stack[-1] + Stack[-24]);
0xe4: Push((float)0.5568627715110779)
0xe5: Push((float)0.5568627715110779)
0xe6: Push((float)0.5568627715110779)
...
0xed: Push("button_x_pressed") // @poff=198
0xee: Push((int) 248)
0xef: Push((int) 68)
...
0xfc: Stack[-3] = (int) 0
0xfd: Stack[-24] = Stack[-2]
0xfe: Stack[-1] = (bool) 1
0xff: Call2 0x134

0x100: Pop(3)
0x101: Push("default") // @poff=152
0x102: Push((int) 129)
0x103: Push((int) 47)
...
0x108: Pop(1)
0x109: Push((float)0.5568627715110779)
0x10a: Push((float)0.5568627715110779)
0x10b: Push((float)0.5568627715110779)
...
0x110: Push("button_pressed") // @poff=250
0x111: Push((int) 129)
0x112: Push((int) 67)
...
0x126: Push("separator") // @poff=294
0x127: Push((int) 0)
0x128: Push((int) 15)
0x129: Pop(1); Push(Stack[-24] + Stack[-1]);
0x12a: Push((int) 1)
0x12b: @ StretchBlit(Stack[-4], Stack[-3], Stack[-2], Stack[-4]T, Stack[-1])
0x12c: Pop(4)
0x12d: Push((int) 31)
...
0x149: Pop(4)
0x14a: Push("shot_border") // @poff=336
0x14b: Push((int) 1)
0x14c: Push((int) 90)
0x14d: @ StretchBlit(Stack[-3], Stack[-6], Stack[-5], Stack[-2], Stack[-1])
0x14e: Pop(3)
0x14f: Push("shot_border") // @poff=336
0x150: Push((int) 120)
...
0x160: Pop(0)
0x161: Pop(1); Push(Stack[-1] - Stack[5 + Tasks[-1].StackPointer]);
...
0x1b0: Stack[-9] = Stack[-2]
0x1b1: Stack[-8] = Stack[-1]
0x1b2: Call2 0x1dc
...
0x1b8: @@@ get(Stack[-2], Stack[-2]T); Obj=9 // @poff=136
0x1b9: Pop(0)
...
0x1ca: Stack[-9] = Stack[-2]
0x1cb: Stack[-8] = Stack[-1]
0x1cc: Call2 0x203
...
0x1d2: @@@ get(Stack[-1], Stack[-3]T); Obj=9 // @poff=136
0x1d3: Pop(0)
0x1d4: Push(Stack[-1])
...
0x1ef: @@@ size(Stack[-1]); Obj=9 // @poff=131
0x1f0: Pop(0)
...
0x216: @@@ size(Stack[-1]); Obj=9 // @poff=131
0x217: Pop(0)
...
0x22d: @@@ size(Stack[-1]); Obj=9 // @poff=131
0x22e: Pop(0)
0x22f: PushEmpty(int)
0x230: Call2 0x22a
...
0x25c: @@ GetGameTime(Stack[-4]); Obj=11 // @poff=380
0x25d: Pop(0)
0x25e: Push((int) 24)
...
0x270: Pop(2)
0x271: Stack[-5] = Stack[-12]
0x272: Return(); Pop(10)

0x273: PushEmpty(string, int, int, int, int, int, string, int, int, int, int, int)
0x274: @@ GetSaveTime(Stack[-5], Stack[-4], Stack[-3], Stack[-1], Stack[-2]); Obj=13 // @poff=392
0x275: Pop(0)
