...
0x1e9: Push("HasUses") // @poff=361
0x1ea: @ HasInvItemProperty(Stack[-26], Stack[-38], Stack[-1])
0x1eb: Pop(1)
0x1ec: Push("uses") // @poff=377
0x1ed: @@ HasProperty(Stack[-25], Stack[-1]); Obj=78 // @poff=107
0x1ee: Pop(1)
0x1ef: PushEmpty(bool)
0x1f0: Stack[-1] = (bool) 1
0x1f1: Push(Stack[-25])
0x1f2: IF (Stack[-1] == 1) GOTO 0x1f6; Pop(1)

0x1f3: Push(Stack[-26])
0x1f4: IF (Stack[-1] == 1) GOTO 0x1f6; Pop(1)
...
0x1f9: Push("uses") // @poff=377
0x1fa: @@ GetProperty(Stack[-24], Stack[-1]); Obj=78 // @poff=119
0x1fb: Pop(1)
0x1fc: GOTO 0x1fe
...
0x20b: Stack[-79] = Stack[-1]
0x20c: Call2 0xc1

0x20d: Pop(1)
0x20e: Push("grass_combination") // @poff=387
0x20f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x210: IF (Stack[-1] == 0) GOTO 0x233; Pop(1)

0x211: Stack[-20] = (bool) 1
0x212: Push("im_inc") // @poff=423
0x213: @@ GetProperty(Stack[-20], Stack[-1]); Obj=78 // @poff=119
0x214: Pop(1)
0x215: Push("hl_inc") // @poff=437
0x216: @@ GetProperty(Stack[-19], Stack[-1]); Obj=78 // @poff=119
0x217: Pop(1)
0x218: Push((int) 8)
...
0x234: Stack[-79] = Stack[-1]
0x235: Call2 0xc1

0x236: Pop(1)
0x237: Push("organ_combination") // @poff=457
0x238: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x239: IF (Stack[-1] == 0) GOTO 0x25b; Pop(1)

0x23a: Stack[-20] = (bool) 1
0x23b: Push("DiseaseRate") // @poff=493
0x23c: @@ GetProperty(Stack[-13], Stack[-1]); Obj=78 // @poff=119
0x23d: Pop(1)
0x23e: Push("HealthIncrease") // @poff=517
0x23f: @@ GetProperty(Stack[-11], Stack[-1]); Obj=78 // @poff=119
0x240: Pop(1)
0x241: Push((int) 11)
...
0x275: Stack[-7] = Stack[-5]
0x276: Stack[-6] = Stack[-4]
0x277: Stack[-3] = (int) 300
0x278: Stack[-36] = Stack[-2]
0x279: Stack[-80] = Stack[-1]
0x27a: Call2 0x161
...
0x281: Stack[-81] = Stack[-2]
0x282: Stack[-79] = Stack[-1]
0x283: Call2 0x17c

0x284: Pop(4)
0x285: Push((int) 250)
0x286: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x287: Push("default") // @poff=47
0x288: Push((int) 16)
0x289: Pop(1); Push(Stack[-4] + Stack[-1]);
0x28a: Push((int) 268)
0x28b: Push((float)0.6470588445663452)
0x28c: Push((float)0.6470588445663452)
0x28d: Push((float)0.6470588445663452)
...
0x294: Push(Stack[-29])
0x295: IF (Stack[-1] == 1) GOTO 0x299; Pop(1)

0x296: Push(Stack[-30])
0x297: IF (Stack[-1] == 1) GOTO 0x299; Pop(1)

0x298: Stack[-1] = (bool) 0
0x299: IF (Stack[-1] == 0) GOTO 0x2a4; Pop(1)

0x29a: Push("default") // @poff=47
0x29b: Push((int) 16)
0x29c: Pop(1); Push(Stack[-4] + Stack[-1]);
0x29d: Push((int) 268)
0x29e: Push((float)0.6470588445663452)
0x29f: Push((float)0.6470588445663452)
0x2a0: Push((float)0.6470588445663452)
...
0x2a6: Push(Stack[-25])
0x2a7: IF (Stack[-1] == 1) GOTO 0x2ab; Pop(1)
...
0x2ac: Push("default") // @poff=47
0x2ad: Push((int) 16)
0x2ae: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2af: Push((int) 268)
0x2b0: Push((float)0.6470588445663452)
0x2b1: Push((float)0.6470588445663452)
0x2b2: Push((float)0.6470588445663452)
...
0x2b8: Push("default") // @poff=47
0x2b9: Push((int) 16)
0x2ba: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2bb: Push((int) 268)
0x2bc: Push((float)0.6470588445663452)
0x2bd: Push((float)0.6470588445663452)
0x2be: Push((float)0.6470588445663452)
...
0x2c2: Push("default") // @poff=47
0x2c3: Push((int) 16)
0x2c4: Pop(1); Push(Stack[-4] + Stack[-1]);
0x2c5: Push((int) 268)
0x2c6: Push((float)0.6470588445663452)
0x2c7: Push((float)0.6470588445663452)
0x2c8: Push((float)0.6470588445663452)
...
0x2da: Stack[-87] = Stack[-1]
0x2db: Call2 0x6d

0x2dc: Stack[-2] = Stack[-40]
0x2dd: Pop(2)
0x2de: PushEmpty(int, object, int)
0x2df: Stack[-88] = Stack[-2]
0x2e0: PushEmpty(int)
0x2e1: Call2 0x108

0x2e2: Stack[-1] = Stack[-2]
0x2e3: Pop(1)
0x2e4: Call2 0x72

0x2e5: Stack[-3] = Stack[-40]
0x2e6: Pop(3)
0x2e7: Push(Stack[-84])
0x2e8: IF (Stack[-1] == 0) GOTO 0x2f4; Pop(1)

0x2e9: PushEmpty(float, object, int, int)
0x2ea: Stack[-45] = Stack[-3]
0x2eb: Stack[-43] = Stack[-2]
0x2ec: PushEmpty(int)
0x2ed: Call2 0x108

0x2ee: Stack[-1] = Stack[-2]
0x2ef: Pop(1)
0x2f0: Call2 0xd4

0x2f1: Stack[-4] = Stack[-40]
0x2f2: Pop(4)
0x2f3: GOTO 0x2fe

0x2f4: PushEmpty(float, object, int, int)
0x2f5: Stack[-45] = Stack[-3]
0x2f6: Stack[-43] = Stack[-2]
0x2f7: PushEmpty(int)
0x2f8: Call2 0x108
...
0x30a: Stack[-35] = "Error: Item doesnt have description (FIXME!)" // @poff=235
0x30b: Push("
") // @poff=453
...
0x32a: Push("durability") // @poff=85
0x32b: @@ GetProperty(Stack[-28], Stack[-1]); Obj=86 // @poff=119
0x32c: Pop(1)
0x32d: GOTO 0x32f
...
0x337: Push("default") // @poff=47
0x338: Push((int) 268)
0x339: @ GetTextHeightInWidth(Stack[-28], Stack[-2], Stack[-1], Stack[-32])
0x33a: Pop(2)
0x33b: Stack[-31] = Stack[-31] + Stack[-26]; Pop(0);
0x33c: Push("HasUses") // @poff=361
0x33d: @ HasInvItemProperty(Stack[-25], Stack[-39], Stack[-1])
0x33e: Pop(1)
0x33f: Push("uses") // @poff=377
0x340: @@ HasProperty(Stack[-24], Stack[-1]); Obj=86 // @poff=107
0x341: Pop(1)
0x342: PushEmpty(bool)
0x343: Stack[-1] = (bool) 1
0x344: Push(Stack[-24])
0x345: IF (Stack[-1] == 1) GOTO 0x349; Pop(1)

0x346: Push(Stack[-25])
0x347: IF (Stack[-1] == 1) GOTO 0x349; Pop(1)
...
0x34c: Push("uses") // @poff=377
0x34d: @@ GetProperty(Stack[-23], Stack[-1]); Obj=86 // @poff=119
0x34e: Pop(1)
0x34f: GOTO 0x351
...
0x35e: Stack[-87] = Stack[-1]
0x35f: Call2 0xc1

0x360: Pop(1)
0x361: Push("grass_combination") // @poff=387
0x362: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x363: IF (Stack[-1] == 0) GOTO 0x386; Pop(1)

0x364: Stack[-19] = (bool) 1
0x365: Push("im_inc") // @poff=423
0x366: @@ GetProperty(Stack[-19], Stack[-1]); Obj=86 // @poff=119
0x367: Pop(1)
0x368: Push("hl_inc") // @poff=437
0x369: @@ GetProperty(Stack[-18], Stack[-1]); Obj=86 // @poff=119
0x36a: Pop(1)
0x36b: Push((int) 8)
...
0x387: Stack[-87] = Stack[-1]
0x388: Call2 0xc1

0x389: Pop(1)
0x38a: Push("organ_combination") // @poff=457
0x38b: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x38c: IF (Stack[-1] == 0) GOTO 0x3ae; Pop(1)

0x38d: Stack[-19] = (bool) 1
0x38e: Push("DiseaseRate") // @poff=493
0x38f: @@ GetProperty(Stack[-11], Stack[-1]); Obj=86 // @poff=119
0x390: Pop(1)
0x391: Push("HealthIncrease") // @poff=517
0x392: @@ GetProperty(Stack[-10], Stack[-1]); Obj=86 // @poff=119
0x393: Pop(1)
0x394: Push((int) 11)
...
0x3c6: Stack[-7] = Stack[-5]
0x3c7: Stack[-6] = Stack[-4]
0x3c8: Stack[-3] = (int) 300
0x3c9: Stack[-36] = Stack[-2]
0x3ca: Stack[-88] = Stack[-1]
0x3cb: Call2 0x161
...
0x3d2: Stack[-89] = Stack[-2]
0x3d3: Stack[-87] = Stack[-1]
0x3d4: Call2 0x17c

0x3d5: Pop(4)
0x3d6: Push((int) 250)
0x3d7: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3d8: Push("default") // @poff=47
0x3d9: Push((int) 16)
0x3da: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3db: Push((int) 268)
0x3dc: Push((float)0.6470588445663452)
0x3dd: Push((float)0.6470588445663452)
0x3de: Push((float)0.6470588445663452)
...
0x3e4: Push(Stack[-29])
0x3e5: IF (Stack[-1] == 1) GOTO 0x3e9; Pop(1)

0x3e6: Push(Stack[-30])
0x3e7: IF (Stack[-1] == 1) GOTO 0x3e9; Pop(1)

0x3e8: Stack[-1] = (bool) 0
0x3e9: IF (Stack[-1] == 0) GOTO 0x3f4; Pop(1)

0x3ea: Push("default") // @poff=47
0x3eb: Push((int) 16)
0x3ec: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3ed: Push((int) 268)
0x3ee: Push((float)0.6470588445663452)
0x3ef: Push((float)0.6470588445663452)
0x3f0: Push((float)0.6470588445663452)
...
0x3f6: Push(Stack[-24])
0x3f7: IF (Stack[-1] == 1) GOTO 0x3fb; Pop(1)

0x3f8: Push(Stack[-25])
0x3f9: IF (Stack[-1] == 1) GOTO 0x3fb; Pop(1)

0x3fa: Stack[-1] = (bool) 0
0x3fb: IF (Stack[-1] == 0) GOTO 0x406; Pop(1)

0x3fc: Push("default") // @poff=47
0x3fd: Push((int) 16)
0x3fe: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3ff: Push((int) 268)
0x400: Push((float)0.6470588445663452)
0x401: Push((float)0.6470588445663452)
0x402: Push((float)0.6470588445663452)
...
0x408: Push("default") // @poff=47
0x409: Push((int) 16)
0x40a: Pop(1); Push(Stack[-4] + Stack[-1]);
0x40b: Push((int) 268)
0x40c: Push((float)0.6470588445663452)
0x40d: Push((float)0.6470588445663452)
0x40e: Push((float)0.6470588445663452)
...
0x419: @@ size(Stack[-17]); Obj=36 // @poff=553
0x41a: Pop(0)
...
0x425: @@ get(Stack[-16], Stack[-10]); Obj=36 // @poff=558
0x426: Pop(0)
0x427: @@ GetTime(Stack[-9]); Obj=16 // @poff=562
0x428: Pop(0)
0x429: Pop(0); Push((bool) Stack[-9] > Stack[-11])
0x42a: IF (Stack[-1] == 0) GOTO 0x42d; Pop(1)

0x42b: Stack[-9] = Stack[-11]
0x42c: Stack[-10] = Stack[-12]
0x42d: Push((int) 1)
0x42e: Stack[-11] = Stack[-11] + Stack[-1]; Pop(1);
0x42f: GOTO 0x423

0x430: @@ get(Stack[-16], Stack[-12]); Obj=36 // @poff=558
0x431: Pop(0)
0x432: @@ GetTextID(Stack[-13]); Obj=16 // @poff=570
0x433: Pop(0)
0x434: @ GetStringByID(Stack[-14], Stack[-13])
0x435: Pop(0)
0x436: @@ GetTime(Stack[-8]); Obj=16 // @poff=562
0x437: Pop(0)
0x438: PushEmpty(int)
0x439: Stack[-9] = Stack[-1]
0x43a: Stack[-1] = Stack[-8]
0x43b: Pop(1)
0x43c: Push((int) 60)
...
0x454: @@ remove(Stack[-12]); Obj=36 // @poff=590
0x455: Pop(0)
0x456: Push((int) -1)
...
0x47b: Stack[-7] = Stack[-5]
0x47c: Stack[-6] = Stack[-4]
0x47d: Stack[-3] = (int) 300
0x47e: Stack[-10] = Stack[-2]
0x47f: Stack[-40] = Stack[-1]
0x480: Call2 0x161

0x481: Pop(5)
0x482: Push("default") // @poff=47
0x483: Push((int) 16)
0x484: Pop(1); Push(Stack[-4] + Stack[-1]);
0x485: Push((int) 16)
0x486: Pop(1); Push(Stack[-4] + Stack[-1]);
0x487: Push((int) 268)
0x488: Push((float)0.6470588445663452)
0x489: Push((float)0.6470588445663452)
0x48a: Push((float)0.6470588445663452)
...
0x4af: Stack[-7] = Stack[-5]
0x4b0: Stack[-6] = Stack[-4]
0x4b1: Stack[-3] = (int) 300
0x4b2: Stack[-10] = Stack[-2]
0x4b3: Stack[-16] = Stack[-1]
0x4b4: Call2 0x161

0x4b5: Pop(5)
0x4b6: Push("default") // @poff=47
0x4b7: Push((int) 16)
0x4b8: Pop(1); Push(Stack[-4] + Stack[-1]);
0x4b9: Push((int) 16)
0x4ba: Pop(1); Push(Stack[-4] + Stack[-1]);
0x4bb: Push((int) 268)
0x4bc: Push((float)0.6470588445663452)
0x4bd: Push((float)0.6470588445663452)
0x4be: Push((float)0.6470588445663452)
...
0x4c5: Pop(0); PushNull((bool) Stack[-9] == 0)
...
0x4cf: Pop(0); PushNull((bool) Stack[-8] == 0)
...
0x4d9: Pop(0); PushNull((bool) Stack[-9] == 0)
0x4da: IF (Stack[-1] == 0) GOTO 0x4de; Pop(1)

0x4db: Pop(0); PushNull((bool) Stack[-8] == 0)
