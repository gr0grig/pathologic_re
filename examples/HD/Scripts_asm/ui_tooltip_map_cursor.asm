...
0x196: Push("HasUses") // @poff=361
0x197: @ HasInvItemProperty(Stack[-26], Stack[-38], Stack[-1])
0x198: Pop(1)
0x199: Push("uses") // @poff=377
0x19a: @@ HasProperty(Stack[-25], Stack[-1]); Obj=78 // @poff=107
0x19b: Pop(1)
0x19c: PushEmpty(bool)
0x19d: Stack[-1] = (bool) 1
0x19e: Push(Stack[-25])
0x19f: IF (Stack[-1] == 1) GOTO 0x1a3; Pop(1)
...
0x1a6: Push("uses") // @poff=377
0x1a7: @@ GetProperty(Stack[-24], Stack[-1]); Obj=78 // @poff=119
0x1a8: Pop(1)
0x1a9: GOTO 0x1ab
...
0x1b8: Stack[-79] = Stack[-1]
0x1b9: Call2 0x7b

0x1ba: Pop(1)
0x1bb: Push("grass_combination") // @poff=387
0x1bc: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1bd: IF (Stack[-1] == 0) GOTO 0x1e0; Pop(1)

0x1be: Stack[-20] = (bool) 1
0x1bf: Push("im_inc") // @poff=423
0x1c0: @@ GetProperty(Stack[-20], Stack[-1]); Obj=78 // @poff=119
0x1c1: Pop(1)
0x1c2: Push("hl_inc") // @poff=437
0x1c3: @@ GetProperty(Stack[-19], Stack[-1]); Obj=78 // @poff=119
0x1c4: Pop(1)
0x1c5: Push((int) 8)
...
0x1e1: Stack[-79] = Stack[-1]
0x1e2: Call2 0x7b

0x1e3: Pop(1)
0x1e4: Push("organ_combination") // @poff=457
0x1e5: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x1e6: IF (Stack[-1] == 0) GOTO 0x208; Pop(1)

0x1e7: Stack[-20] = (bool) 1
0x1e8: Push("DiseaseRate") // @poff=493
0x1e9: @@ GetProperty(Stack[-13], Stack[-1]); Obj=78 // @poff=119
0x1ea: Pop(1)
0x1eb: Push("HealthIncrease") // @poff=517
0x1ec: @@ GetProperty(Stack[-11], Stack[-1]); Obj=78 // @poff=119
0x1ed: Pop(1)
0x1ee: Push((int) 11)
...
0x222: Stack[-7] = Stack[-5]
0x223: Stack[-6] = Stack[-4]
0x224: Stack[-3] = (int) 300
0x225: Stack[-36] = Stack[-2]
0x226: Stack[-80] = Stack[-1]
0x227: Call2 0x10e
...
0x22e: Stack[-81] = Stack[-2]
0x22f: Stack[-79] = Stack[-1]
0x230: Call2 0x129

0x231: Pop(4)
0x232: Push((int) 250)
0x233: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x234: Push("default") // @poff=47
0x235: Push((int) 16)
0x236: Pop(1); Push(Stack[-4] + Stack[-1]);
0x237: Push((int) 268)
0x238: Push((float)0.6470588445663452)
0x239: Push((float)0.6470588445663452)
0x23a: Push((float)0.6470588445663452)
...
0x241: Push(Stack[-29])
0x242: IF (Stack[-1] == 1) GOTO 0x246; Pop(1)

0x243: Push(Stack[-30])
0x244: IF (Stack[-1] == 1) GOTO 0x246; Pop(1)

0x245: Stack[-1] = (bool) 0
0x246: IF (Stack[-1] == 0) GOTO 0x251; Pop(1)

0x247: Push("default") // @poff=47
0x248: Push((int) 16)
0x249: Pop(1); Push(Stack[-4] + Stack[-1]);
0x24a: Push((int) 268)
0x24b: Push((float)0.6470588445663452)
0x24c: Push((float)0.6470588445663452)
0x24d: Push((float)0.6470588445663452)
...
0x253: Push(Stack[-25])
0x254: IF (Stack[-1] == 1) GOTO 0x258; Pop(1)

0x255: Push(Stack[-26])
0x256: IF (Stack[-1] == 1) GOTO 0x258; Pop(1)

0x257: Stack[-1] = (bool) 0
0x258: IF (Stack[-1] == 0) GOTO 0x263; Pop(1)

0x259: Push("default") // @poff=47
0x25a: Push((int) 16)
0x25b: Pop(1); Push(Stack[-4] + Stack[-1]);
0x25c: Push((int) 268)
0x25d: Push((float)0.6470588445663452)
0x25e: Push((float)0.6470588445663452)
0x25f: Push((float)0.6470588445663452)
...
0x265: Push("default") // @poff=47
0x266: Push((int) 16)
0x267: Pop(1); Push(Stack[-4] + Stack[-1]);
0x268: Push((int) 268)
0x269: Push((float)0.6470588445663452)
0x26a: Push((float)0.6470588445663452)
0x26b: Push((float)0.6470588445663452)
...
0x26f: Push("default") // @poff=47
0x270: Push((int) 16)
0x271: Pop(1); Push(Stack[-4] + Stack[-1]);
0x272: Push((int) 268)
0x273: Push((float)0.6470588445663452)
0x274: Push((float)0.6470588445663452)
0x275: Push((float)0.6470588445663452)
...
0x287: Stack[-87] = Stack[-1]
0x288: Call2 0x27

0x289: Stack[-2] = Stack[-40]
0x28a: Pop(2)
0x28b: PushEmpty(int, object, int)
0x28c: Stack[-88] = Stack[-2]
0x28d: PushEmpty(int)
0x28e: Call2 0xc2

0x28f: Stack[-1] = Stack[-2]
0x290: Pop(1)
0x291: Call2 0x2c

0x292: Stack[-3] = Stack[-40]
0x293: Pop(3)
0x294: Push(Stack[-84])
0x295: IF (Stack[-1] == 0) GOTO 0x2a1; Pop(1)

0x296: PushEmpty(float, object, int, int)
0x297: Stack[-45] = Stack[-3]
0x298: Stack[-43] = Stack[-2]
0x299: PushEmpty(int)
0x29a: Call2 0xc2

0x29b: Stack[-1] = Stack[-2]
0x29c: Pop(1)
0x29d: Call2 0x8e

0x29e: Stack[-4] = Stack[-40]
0x29f: Pop(4)
0x2a0: GOTO 0x2ab

0x2a1: PushEmpty(float, object, int, int)
0x2a2: Stack[-45] = Stack[-3]
0x2a3: Stack[-43] = Stack[-2]
0x2a4: PushEmpty(int)
0x2a5: Call2 0xc2
...
0x2b7: Stack[-35] = "Error: Item doesnt have description (FIXME!)" // @poff=235
0x2b8: Push("
") // @poff=453
...
0x2c1: Push("default") // @poff=47
0x2c2: Push((int) 268)
0x2c3: @ GetTextHeightInWidth(Stack[-33], Stack[-2], Stack[-1], Stack[-37])
0x2c4: Pop(2)
0x2c5: Push((int) 266)
0x2c6: Stack[-32] = Stack[-32] + Stack[-1]; Pop(1);
0x2c7: Push("HasDurability") // @poff=325
0x2c8: @ HasInvItemProperty(Stack[-30], Stack[-39], Stack[-1])
0x2c9: Pop(1)
0x2ca: Push("durability") // @poff=85
0x2cb: @@ HasProperty(Stack[-29], Stack[-1]); Obj=86 // @poff=107
0x2cc: Pop(1)
0x2cd: PushEmpty(bool)
0x2ce: Stack[-1] = (bool) 1
0x2cf: Push(Stack[-29])
0x2d0: IF (Stack[-1] == 1) GOTO 0x2d4; Pop(1)

0x2d1: Push(Stack[-30])
0x2d2: IF (Stack[-1] == 1) GOTO 0x2d4; Pop(1)
...
0x2d7: Push("durability") // @poff=85
0x2d8: @@ GetProperty(Stack[-28], Stack[-1]); Obj=86 // @poff=119
0x2d9: Pop(1)
0x2da: GOTO 0x2dc
...
0x2f9: Push("uses") // @poff=377
0x2fa: @@ GetProperty(Stack[-23], Stack[-1]); Obj=86 // @poff=119
0x2fb: Pop(1)
0x2fc: GOTO 0x2fe
...
0x30b: Stack[-87] = Stack[-1]
0x30c: Call2 0x7b

0x30d: Pop(1)
0x30e: Push("grass_combination") // @poff=387
0x30f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x310: IF (Stack[-1] == 0) GOTO 0x333; Pop(1)

0x311: Stack[-19] = (bool) 1
0x312: Push("im_inc") // @poff=423
0x313: @@ GetProperty(Stack[-19], Stack[-1]); Obj=86 // @poff=119
0x314: Pop(1)
0x315: Push("hl_inc") // @poff=437
0x316: @@ GetProperty(Stack[-18], Stack[-1]); Obj=86 // @poff=119
0x317: Pop(1)
0x318: Push((int) 8)
...
0x334: Stack[-87] = Stack[-1]
0x335: Call2 0x7b

0x336: Pop(1)
0x337: Push("organ_combination") // @poff=457
0x338: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x339: IF (Stack[-1] == 0) GOTO 0x35b; Pop(1)

0x33a: Stack[-19] = (bool) 1
0x33b: Push("DiseaseRate") // @poff=493
0x33c: @@ GetProperty(Stack[-11], Stack[-1]); Obj=86 // @poff=119
0x33d: Pop(1)
0x33e: Push("HealthIncrease") // @poff=517
0x33f: @@ GetProperty(Stack[-10], Stack[-1]); Obj=86 // @poff=119
0x340: Pop(1)
0x341: Push((int) 11)
...
0x373: Stack[-7] = Stack[-5]
0x374: Stack[-6] = Stack[-4]
0x375: Stack[-3] = (int) 300
0x376: Stack[-36] = Stack[-2]
0x377: Stack[-88] = Stack[-1]
0x378: Call2 0x10e
...
0x37f: Stack[-89] = Stack[-2]
0x380: Stack[-87] = Stack[-1]
0x381: Call2 0x129

0x382: Pop(4)
0x383: Push((int) 250)
0x384: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x385: Push("default") // @poff=47
0x386: Push((int) 16)
0x387: Pop(1); Push(Stack[-4] + Stack[-1]);
0x388: Push((int) 268)
0x389: Push((float)0.6470588445663452)
0x38a: Push((float)0.6470588445663452)
0x38b: Push((float)0.6470588445663452)
...
0x391: Push(Stack[-29])
0x392: IF (Stack[-1] == 1) GOTO 0x396; Pop(1)

0x393: Push(Stack[-30])
0x394: IF (Stack[-1] == 1) GOTO 0x396; Pop(1)

0x395: Stack[-1] = (bool) 0
0x396: IF (Stack[-1] == 0) GOTO 0x3a1; Pop(1)

0x397: Push("default") // @poff=47
0x398: Push((int) 16)
0x399: Pop(1); Push(Stack[-4] + Stack[-1]);
0x39a: Push((int) 268)
0x39b: Push((float)0.6470588445663452)
0x39c: Push((float)0.6470588445663452)
0x39d: Push((float)0.6470588445663452)
...
0x3a3: Push(Stack[-24])
0x3a4: IF (Stack[-1] == 1) GOTO 0x3a8; Pop(1)
...
0x3ac: Push((int) 268)
0x3ad: Push((float)0.6470588445663452)
0x3ae: Push((float)0.6470588445663452)
0x3af: Push((float)0.6470588445663452)
...
0x3b5: Push("default") // @poff=47
0x3b6: Push((int) 16)
0x3b7: Pop(1); Push(Stack[-4] + Stack[-1]);
0x3b8: Push((int) 268)
0x3b9: Push((float)0.6470588445663452)
0x3ba: Push((float)0.6470588445663452)
0x3bb: Push((float)0.6470588445663452)
...
0x3c6: @@ size(Stack[-17]); Obj=36 // @poff=553
0x3c7: Pop(0)
...
0x3d2: @@ get(Stack[-16], Stack[-10]); Obj=36 // @poff=558
0x3d3: Pop(0)
0x3d4: @@ GetTime(Stack[-9]); Obj=16 // @poff=562
0x3d5: Pop(0)
0x3d6: Pop(0); Push((bool) Stack[-9] > Stack[-11])
0x3d7: IF (Stack[-1] == 0) GOTO 0x3da; Pop(1)

0x3d8: Stack[-9] = Stack[-11]
0x3d9: Stack[-10] = Stack[-12]
0x3da: Push((int) 1)
0x3db: Stack[-11] = Stack[-11] + Stack[-1]; Pop(1);
0x3dc: GOTO 0x3d0

0x3dd: @@ get(Stack[-16], Stack[-12]); Obj=36 // @poff=558
0x3de: Pop(0)
0x3df: @@ GetTextID(Stack[-13]); Obj=16 // @poff=570
0x3e0: Pop(0)
0x3e1: @ GetStringByID(Stack[-14], Stack[-13])
0x3e2: Pop(0)
0x3e3: @@ GetTime(Stack[-8]); Obj=16 // @poff=562
0x3e4: Pop(0)
0x3e5: PushEmpty(int)
0x3e6: Stack[-9] = Stack[-1]
0x3e7: Stack[-1] = Stack[-8]
0x3e8: Pop(1)
0x3e9: Push((int) 60)
...
0x401: @@ remove(Stack[-12]); Obj=36 // @poff=590
0x402: Pop(0)
0x403: Push((int) -1)
...
0x428: Stack[-7] = Stack[-5]
0x429: Stack[-6] = Stack[-4]
0x42a: Stack[-3] = (int) 300
0x42b: Stack[-10] = Stack[-2]
0x42c: Stack[-40] = Stack[-1]
0x42d: Call2 0x10e

0x42e: Pop(5)
0x42f: Push("default") // @poff=47
0x430: Push((int) 16)
0x431: Pop(1); Push(Stack[-4] + Stack[-1]);
0x432: Push((int) 16)
0x433: Pop(1); Push(Stack[-4] + Stack[-1]);
0x434: Push((int) 268)
0x435: Push((float)0.6470588445663452)
0x436: Push((float)0.6470588445663452)
0x437: Push((float)0.6470588445663452)
...
0x45c: Stack[-7] = Stack[-5]
0x45d: Stack[-6] = Stack[-4]
0x45e: Stack[-3] = (int) 300
0x45f: Stack[-10] = Stack[-2]
0x460: Stack[-16] = Stack[-1]
0x461: Call2 0x10e
...
0x468: Push((int) 268)
0x469: Push((float)0.6470588445663452)
0x46a: Push((float)0.6470588445663452)
0x46b: Push((float)0.6470588445663452)
