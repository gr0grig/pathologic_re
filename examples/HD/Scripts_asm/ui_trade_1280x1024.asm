...
Strings:
	...
	W:background_left
	W:background_right
	W:l_scroll_button_top
	W:l_scroll_button_bottom
	W:r_scroll_button_top
	W:r_scroll_button_bottom
	W:l_scrollbar
	W:r_scrollbar
	A:clear
	W:r_money_slot
	W:l_money_slot
	W:Error: failed to remove item
	W:Error: failed to add item
	A:set
	W:l_slot0
	W:l_slot
	W:r_slot0
	...
	A:RemoveItem
	A:AddItem
// @pool_raw:
...
0x13: Stack[-9] = Stack[-1]
0x14: Call2 0x969

0x15: Pop(1)
0x16: Push("BarterPrice") // @poff=0
...
0x58: @@@ remove(Stack[-1]); Obj=23 // @poff=33
0x59: Pop(0)
0x5a: Return(); Pop(6)
...
0x5e: @@@ add(Stack[-7]); Obj=24 // @poff=40
0x5f: Pop(0)
0x60: Return(); Pop(6)
...
0x66: Pop(1)
0x67: @ GetContainer(Stack[-29]T)
0x68: Pop(0)
0x69: @ CreateObjectVector(Stack[-23]T)
0x6a: Pop(0)
0x6b: @ CreateObjectVector(Stack[-24]T)
0x6c: Pop(0)
0x6d: @ CreateObjectVector(Stack[-5]T)
0x6e: Pop(0)
0x6f: @ CreateIntVector(Stack[-6]T)
0x70: Pop(0)
0x71: @ CreateIntVector(Stack[-7]T)
0x72: Pop(0)
0x73: @ CreateIntVector(Stack[-8]T)
0x74: Pop(0)
0x75: @ CreateObjectVector(Stack[-9]T)
0x76: Pop(0)
0x77: @ CreateIntVector(Stack[-10]T)
0x78: Pop(0)
0x79: @ CreateIntVector(Stack[-11]T)
0x7a: Pop(0)
0x7b: @ CreateObjectVector(Stack[-12]T)
0x7c: Pop(0)
0x7d: @ CreateIntVector(Stack[-13]T)
0x7e: Pop(0)
0x7f: @ CreateObjectVector(Stack[-14]T)
0x80: Pop(0)
0x81: @ CreateIntVector(Stack[-15]T)
0x82: Pop(0)
0x83: @ CreateObjectVector(Stack[-16]T)
0x84: Pop(0)
0x85: @ CreateIntVector(Stack[-17]T)
0x86: Pop(0)
0x87: @ CreateObjectVector(Stack[-18]T)
0x88: Pop(0)
0x89: @ CreateIntVector(Stack[-19]T)
0x8a: Pop(0)
0x8b: @ CreateObjectVector(Stack[-20]T)
0x8c: Pop(0)
0x8d: @ CreateIntVector(Stack[-21]T)
0x8e: Pop(0)
0x8f: PushEmpty(int)
0x90: Call2 0x959
...
0x92: Pop(1)
0x93: Stack[22 + Tasks[-1].StackPointer] = "" // @poff=21
0x94: Stack[-15] = (int) 0
0x95: Pop(0); Push((bool) Stack[-15] < Stack[0 + Tasks[-1].StackPointer])
0x96: IF (Stack[-1] == 0) GOTO 0xe7; Pop(1)

0x97: Stack[-14] = "" // @poff=21
0x98: Stack[-13] = "" // @poff=21
0x99: Stack[-12] = "$parent" // @poff=44
0x9a: Stack[-11] = "$parent" // @poff=44
0x9b: Push((int) 2)
...
0xba: Stack[-2] = Stack[-14]
0xbb: Pop(2)
0xbc: Push((int) 2)
0xbd: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] - Stack[-1]);
...
0xc4: Stack[-2] = Stack[-13]
0xc5: Pop(2)
0xc6: @ CreateStringVector(Stack[-10])
0xc7: Pop(0)
0xc8: @@ add(Stack[-14]); Obj=10 // @poff=40
0xc9: Pop(0)
0xca: @@ add(Stack[-13]); Obj=10 // @poff=40
0xcb: Pop(0)
0xcc: @@ add(Stack[-12]); Obj=10 // @poff=40
0xcd: Pop(0)
0xce: @@ add(Stack[-11]); Obj=10 // @poff=40
0xcf: Pop(0)
0xd0: Push((int) -1)
0xd1: PushEmpty(string, int)
0xd2: Stack[-18] = Stack[-1]
0xd3: Call2 0x826
...
0xd8: Pop(0)
0xd9: @@ add(Stack[-0]T); Obj=9 // @poff=40
0xda: Pop(0)
0xdb: Push((int) -19)
0xdc: PushEmpty(string, int)
0xdd: Stack[-18] = Stack[-1]
0xde: Call2 0x826
...
0xea: Stack[-7] = "" // @poff=21
0xeb: Stack[-6] = "" // @poff=21
0xec: Stack[-5] = "$parent" // @poff=44
0xed: Stack[-4] = "$parent" // @poff=44
0xee: Push((int) 2)
...
0x10d: Stack[-2] = Stack[-7]
0x10e: Pop(2)
0x10f: Push((int) 2)
0x110: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x11a: Pop(0)
0x11b: @@ add(Stack[-7]); Obj=3 // @poff=40
0x11c: Pop(0)
0x11d: @@ add(Stack[-6]); Obj=3 // @poff=40
0x11e: Pop(0)
0x11f: @@ add(Stack[-5]); Obj=3 // @poff=40
0x120: Pop(0)
0x121: @@ add(Stack[-4]); Obj=3 // @poff=40
0x122: Pop(0)
0x123: Push((int) -1)
...
0x12b: Pop(0)
0x12c: @@ add(Stack[-0]T); Obj=2 // @poff=40
0x12d: Pop(0)
0x12e: Push((int) -19)
0x12f: PushEmpty(string, int)
0x130: Stack[-11] = Stack[-1]
0x131: Call2 0x816
...
0x1ac: Push("cancel_button") // @poff=76
...
0x1b5: Pop(2)
0x1b6: Stack[22 + Tasks[-1].StackPointer] = "" // @poff=21
0x1b7: GOTO 0x1d5

0x1b8: Push("ok_button") // @poff=104
0x1b9: Pop(1); Push((bool) Stack[22 + Tasks[-1].StackPointer] == Stack[-1])
0x1ba: IF (Stack[-1] == 0) GOTO 0x1c1; Pop(1)

0x1bb: Push((int) -4)
0x1bc: Push("cancel_button") // @poff=76
0x1bd: @ SendMessage(Stack[-2], Stack[-1])
0x1be: Pop(2)
0x1bf: Stack[22 + Tasks[-1].StackPointer] = "cancel_button" // @poff=76
0x1c0: GOTO 0x1d5
...
0x22e: Push("cancel_button") // @poff=76
...
0x237: Pop(2)
0x238: Stack[22 + Tasks[-1].StackPointer] = "" // @poff=21
0x239: GOTO 0x257

0x23a: Push("ok_button") // @poff=104
0x23b: Pop(1); Push((bool) Stack[22 + Tasks[-1].StackPointer] == Stack[-1])
0x23c: IF (Stack[-1] == 0) GOTO 0x243; Pop(1)

0x23d: Push((int) -4)
0x23e: Push("cancel_button") // @poff=76
0x23f: @ SendMessage(Stack[-2], Stack[-1])
0x240: Pop(2)
0x241: Stack[22 + Tasks[-1].StackPointer] = "cancel_button" // @poff=76
0x242: GOTO 0x257
...
0x260: Stack[22 + Tasks[-1].StackPointer] = "" // @poff=21
0x261: Push("iSlotResetButtons") // @poff=124
0x262: @ Trace(Stack[-1])
0x263: Pop(1)
0x264: Return(); Pop(2)
...
0x26f: IF (Stack[-1] == 1) GOTO 0x277; Pop(1)
...
0x275: IF (Stack[-1] == 1) GOTO 0x277; Pop(1)
...
0x27b: Stack[22 + Tasks[-1].StackPointer] = "cancel_button" // @poff=76
0x27c: Push((int) -4)
0x27d: @ SendMessage(Stack[-1], Stack[-22]T)
0x27e: Pop(1)
0x27f: Return(); Pop(2)
...
0x28e: IF (Stack[-1] == 1) GOTO 0x297; Pop(1)
...
0x2a4: IF (Stack[-1] == 1) GOTO 0x2ac; Pop(1)
...
0x2aa: IF (Stack[-1] == 1) GOTO 0x2ac; Pop(1)
...
0x2ba: IF (Stack[-1] == 1) GOTO 0x2c3; Pop(1)
...
0x2c1: IF (Stack[-1] == 1) GOTO 0x2c3; Pop(1)
...
0x2ce: Stack[-8] = Stack[-2]
0x2cf: Stack[-7] = Stack[-1]
0x2d0: Call2 0x8fb

0x2d1: Stack[-3] = Stack[-4]
0x2d2: Pop(3)
0x2d3: Push((int) -1)
...
0x2e4: Stack[-8] = Stack[-2]
0x2e5: Stack[-7] = Stack[-1]
0x2e6: Call2 0x910

0x2e7: Stack[-3] = Stack[-4]
0x2e8: Pop(3)
0x2e9: Push((int) -1)
...
0x2f9: Push("cancel_button") // @poff=76
...
0x30c: Pop(0)
0x30d: Push("background_right") // @poff=192
0x30e: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x30f: IF (Stack[-1] == 0) GOTO 0x31a; Pop(1)

0x310: Push("background_right") // @poff=192
...
0x319: Pop(0)
0x31a: Push("l_scroll_button_top") // @poff=226
...
0x323: Push("l_scroll_button_bottom") // @poff=266
...
0x32c: Push("r_scroll_button_top") // @poff=312
...
0x335: Push("r_scroll_button_bottom") // @poff=352
...
0x33e: Push("l_scrollbar") // @poff=398
...
0x34f: Push("r_scrollbar") // @poff=422
...
0x36f: @ GetPlayerMoneyCount(Stack[-3]T)
0x370: Pop(0)
0x371: GOTO 0x373

0x372: Stack[3 + Tasks[-1].StackPointer] = (int)0
0x373: @@@ clear(); Obj=23 // @poff=446
0x374: Pop(0)
0x375: @@@ clear(); Obj=24 // @poff=446
0x376: Pop(0)
0x377: @@@ clear(); Obj=5 // @poff=446
0x378: Pop(0)
0x379: @@@ clear(); Obj=6 // @poff=446
0x37a: Pop(0)
0x37b: @@@ clear(); Obj=7 // @poff=446
0x37c: Pop(0)
0x37d: @@@ clear(); Obj=8 // @poff=446
0x37e: Pop(0)
0x37f: @@@ clear(); Obj=9 // @poff=446
0x380: Pop(0)
0x381: @@@ clear(); Obj=10 // @poff=446
0x382: Pop(0)
0x383: @@@ clear(); Obj=11 // @poff=446
0x384: Pop(0)
0x385: @@@ clear(); Obj=12 // @poff=446
0x386: Pop(0)
0x387: @@@ clear(); Obj=13 // @poff=446
0x388: Pop(0)
0x389: @@@ clear(); Obj=14 // @poff=446
0x38a: Pop(0)
0x38b: @@@ clear(); Obj=15 // @poff=446
0x38c: Pop(0)
0x38d: @@@ clear(); Obj=16 // @poff=446
0x38e: Pop(0)
0x38f: @@@ clear(); Obj=17 // @poff=446
0x390: Pop(0)
0x391: @@@ clear(); Obj=18 // @poff=446
0x392: Pop(0)
0x393: @@@ clear(); Obj=19 // @poff=446
0x394: Pop(0)
0x395: @@@ clear(); Obj=20 // @poff=446
0x396: Pop(0)
0x397: @@@ clear(); Obj=21 // @poff=446
0x398: Pop(0)
0x399: PushEmpty()
0x39a: Call2 0x45b
...
0x3fe: Stack[-14] = Stack[-1]
0x3ff: Call2 0x9d8

0x400: Stack[-2] = Stack[-6]
0x401: Pop(2)
0x402: Stack[-2] = (int) 0
...
0x406: Stack[-15] = Stack[-2]
0x407: Stack[-5] = Stack[-1]
0x408: Call2 0x9f1

0x409: Stack[-3] = Stack[-4]
0x40a: Pop(3)
...
0x415: Stack[-15] = Stack[-2]
0x416: Stack[-5] = Stack[-1]
0x417: Call2 0x9e9

0x418: Stack[-3] = Stack[-6]
0x419: Pop(3)
0x41a: PushEmpty(object, int, int)
0x41b: Stack[-15] = Stack[-2]
0x41c: Stack[-5] = Stack[-1]
0x41d: Call2 0x9e0

0x41e: Stack[-3] = Stack[-8]
0x41f: Pop(3)
...
0x427: Stack[-11] = Stack[-3]
0x428: Stack[-2] = Stack[28 + Tasks[-1].StackPointer]
0x429: Stack[-1] = (bool) 1
0x42a: Call2 0x0

0x42b: Pop(3)
0x42c: IF (Stack[-1] == 1) GOTO 0x430; Pop(1)

0x42d: Push(Stack[-3])
0x42e: IF (Stack[-1] == 1) GOTO 0x430; Pop(1)
...
0x433: @@@ add(Stack[-5]); Obj=5 // @poff=40
0x434: Pop(0)
0x435: @@@ add(Stack[-3]); Obj=6 // @poff=40
0x436: Pop(0)
0x437: Push((int) 0)
0x438: @@@ add(Stack[-1]); Obj=7 // @poff=40
0x439: Pop(1)
0x43a: Push((int) 1)
0x43b: @@@ add(Stack[-1]); Obj=8 // @poff=40
0x43c: Pop(1)
0x43d: GOTO 0x456
...
0x44c: @@@ add(Stack[-5]); Obj=5 // @poff=40
0x44d: Pop(0)
0x44e: @@@ add(Stack[-3]); Obj=6 // @poff=40
0x44f: Pop(0)
0x450: Push((int) 0)
0x451: @@@ add(Stack[-1]); Obj=7 // @poff=40
0x452: Pop(1)
0x453: Push((int) 0)
0x454: @@@ add(Stack[-1]); Obj=8 // @poff=40
0x455: Pop(1)
0x456: Push((int) 1)
...
0x466: Stack[-2] = Stack[-6]
0x467: Pop(2)
0x468: PushEmpty(object, int)
0x469: Stack[-3] = Stack[-1]
0x46a: Call2 0x9f9

0x46b: Stack[-2] = Stack[-4]
0x46c: Pop(2)
0x46d: @@@ add(Stack[-2]); Obj=9 // @poff=40
0x46e: Pop(0)
0x46f: @@@ add(Stack[-4]); Obj=10 // @poff=40
0x470: Pop(0)
0x471: Push((int) 0)
0x472: @@@ add(Stack[-1]); Obj=11 // @poff=40
0x473: Pop(1)
0x474: Push((int) 1)
...
0x49b: Stack[-13] = Stack[-1]
0x49c: Call2 0x9d8

0x49d: Stack[-2] = Stack[-5]
0x49e: Pop(2)
0x49f: Stack[-1] = (int) 0
...
0x4a3: Stack[-14] = Stack[-2]
0x4a4: Stack[-4] = Stack[-1]
0x4a5: Call2 0x9e9

0x4a6: Stack[-3] = Stack[-5]
0x4a7: Pop(3)
0x4a8: PushEmpty(object, int, int)
0x4a9: Stack[-14] = Stack[-2]
0x4aa: Stack[-4] = Stack[-1]
0x4ab: Call2 0x9e0

0x4ac: Stack[-3] = Stack[-7]
0x4ad: Pop(3)
0x4ae: @@ add(Stack[-4]); Obj=10 // @poff=40
0x4af: Pop(0)
0x4b0: @@ add(Stack[-2]); Obj=9 // @poff=40
0x4b1: Pop(0)
0x4b2: Push((int) 1)
...
0x4b8: @@@ size(Stack[-2]); Obj=9 // @poff=24
0x4b9: Pop(0)
0x4ba: Push((int) 2)
...
0x4c0: Push((int) 2)
0x4c1: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x4cb: @@@ size(Stack[-2]); Obj=5 // @poff=24
0x4cc: Pop(0)
0x4cd: Push((int) 2)
...
0x4d3: Push((int) 2)
0x4d4: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x4de: @@@ size(Stack[-7]); Obj=9 // @poff=24
0x4df: Pop(0)
0x4e0: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x4e8: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
0x4e9: Pop(1); Push(Stack[-1] - Stack[-8]);
0x4ea: Stack[1 + Tasks[-1].StackPointer] = Stack[1 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x4eb: GOTO 0x4f1

0x4ec: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x4f6: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x4fb: @@@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=29
0x4fc: Pop(0)
0x4fd: @@@ get(Stack[-3], Stack[-5]); Obj=10 // @poff=29
0x4fe: Pop(0)
0x4ff: Stack[-6] = (int) 0
...
0x514: Pop(0)
0x515: @@ add(Stack[-2]); Obj=1 // @poff=40
0x516: Pop(0)
0x517: @@ add(Stack[-3]); Obj=1 // @poff=40
0x518: Pop(0)
...
0x535: @@@ size(Stack[-8]); Obj=5 // @poff=24
0x536: Pop(0)
0x537: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x53f: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
0x540: Pop(1); Push(Stack[-1] - Stack[-9]);
0x541: Stack[2 + Tasks[-1].StackPointer] = Stack[2 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x542: GOTO 0x548

0x543: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x54d: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[0 + Tasks[-1].StackPointer]);
...
0x552: @@@ get(Stack[-7], Stack[-4]); Obj=5 // @poff=29
0x553: Pop(0)
0x554: @@@ get(Stack[-5], Stack[-4]); Obj=6 // @poff=29
0x555: Pop(0)
0x556: Stack[-6] = (int) 0
...
0x574: Pop(0)
0x575: @@ add(Stack[-3]); Obj=1 // @poff=40
0x576: Pop(0)
0x577: @@ add(Stack[-5]); Obj=1 // @poff=40
0x578: Pop(0)
...
0x593: Stack[-7] = 0
0x594: Push("r_money_slot") // @poff=452
0x595: @ SendMessage(Stack[-3]T, Stack[-1])
0x596: Pop(1)
0x597: Return(); Pop(0)

0x598: Push("l_money_slot") // @poff=478
0x599: @ SendMessage(Stack[-4]T, Stack[-1])
0x59a: Pop(1)
0x59b: Return(); Pop(0)
...
0x5a0: Pop(0)
0x5a1: @@@ size(Stack[-7]); Obj=24 // @poff=24
0x5a2: Pop(0)
0x5a3: Stack[-2] = (int) 0
0x5a4: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x5a5: IF (Stack[-1] == 0) GOTO 0x5c7; Pop(1)

0x5a6: @@@ get(Stack[-5], Stack[-2]); Obj=24 // @poff=29
0x5a7: Pop(0)
0x5a8: PushEmpty(bool, object, object, int)
0x5a9: Stack[-7] = Stack[-3]
0x5aa: Stack[-9] = Stack[-2]
0x5ab: PushEmpty(int, object)
0x5ac: Stack[-11] = Stack[-1]
0x5ad: Call2 0x9bd

0x5ae: Stack[-2] = Stack[-3]
0x5af: Pop(2)
0x5b0: Call2 0xa17

0x5b1: Stack[-4] = Stack[-10]
0x5b2: Pop(4)
0x5b3: Pop(0); Push((bool) Stack[-6] == 0)
0x5b4: IF (Stack[-1] == 0) GOTO 0x5b8; Pop(1)

0x5b5: Push("Error: failed to remove item") // @poff=504
0x5b6: @ Trace(Stack[-1])
0x5b7: Pop(1)
0x5b8: PushEmpty(bool, object, object, int)
0x5b9: Stack[-8] = Stack[-3]
0x5ba: Stack[-9] = Stack[-2]
0x5bb: Stack[-1] = (int) 0
0x5bc: Call2 0xa30

0x5bd: Stack[-4] = Stack[-10]
0x5be: Pop(4)
0x5bf: Pop(0); Push((bool) Stack[-6] == 0)
0x5c0: IF (Stack[-1] == 0) GOTO 0x5c4; Pop(1)

0x5c1: Push("Error: failed to add item") // @poff=562
0x5c2: @ Trace(Stack[-1])
0x5c3: Pop(1)
0x5c4: Push((int) 1)
...
0x5c7: @@@ size(Stack[-7]); Obj=23 // @poff=24
0x5c8: Pop(0)
0x5c9: Stack[-1] = (int) 0
0x5ca: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x5cb: IF (Stack[-1] == 0) GOTO 0x5ed; Pop(1)

0x5cc: @@@ get(Stack[-5], Stack[-1]); Obj=23 // @poff=29
0x5cd: Pop(0)
0x5ce: PushEmpty(bool, object, object, int)
0x5cf: Stack[-8] = Stack[-3]
0x5d0: Stack[-9] = Stack[-2]
0x5d1: Stack[-1] = (int) 0
0x5d2: Call2 0xa17

0x5d3: Stack[-4] = Stack[-10]
0x5d4: Pop(4)
0x5d5: Pop(0); Push((bool) Stack[-6] == 0)
0x5d6: IF (Stack[-1] == 0) GOTO 0x5da; Pop(1)

0x5d7: Push("Error: failed to remove item") // @poff=504
0x5d8: @ Trace(Stack[-1])
0x5d9: Pop(1)
0x5da: PushEmpty(bool, object, object, int)
0x5db: Stack[-7] = Stack[-3]
0x5dc: Stack[-9] = Stack[-2]
...
0x5e3: Stack[-4] = Stack[-10]
0x5e4: Pop(4)
0x5e5: Pop(0); Push((bool) Stack[-6] == 0)
0x5e6: IF (Stack[-1] == 0) GOTO 0x5ea; Pop(1)

0x5e7: Push("Error: failed to add item") // @poff=562
0x5e8: @ Trace(Stack[-1])
0x5e9: Pop(1)
0x5ea: Push((int) 1)
...
0x5f0: @ SetPlayerMoneyCount(Stack[-3]T)
0x5f1: Pop(0)
...
0x681: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=29
0x682: Pop(0)
0x683: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=29
0x684: Pop(0)
0x685: PushEmpty(bool, object, object)
0x686: Stack[-14] = Stack[-2]
0x687: Stack[-6] = Stack[-1]
0x688: Call2 0xa0f
...
0x693: @@ set(Stack[-3], Stack[-1]); Obj=10 // @poff=614
0x694: Pop(1)
...
0x69d: @@ add(Stack[-11]); Obj=10 // @poff=40
0x69e: Pop(0)
0x69f: Push((int) 1)
0x6a0: @@ add(Stack[-1]); Obj=10 // @poff=40
0x6a1: Pop(1)
...
0x6a8: @@ size(Stack[-4]); Obj=10 // @poff=24
0x6a9: Pop(0)
0x6aa: Stack[-2] = (int) 0
0x6ab: Pop(0); Push((bool) Stack[-2] < Stack[-4])
0x6ac: IF (Stack[-1] == 0) GOTO 0x6c8; Pop(1)

0x6ad: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=29
0x6ae: Pop(0)
0x6af: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=29
0x6b0: Pop(0)
0x6b1: PushEmpty(bool, object, object)
0x6b2: Stack[-14] = Stack[-2]
...
0x6bc: @@ remove(Stack[-2]); Obj=10 // @poff=33
0x6bd: Pop(0)
0x6be: @@ remove(Stack[-2]); Obj=9 // @poff=33
0x6bf: Pop(0)
0x6c0: GOTO 0x6c3

0x6c1: @@ set(Stack[-2], Stack[-1]); Obj=9 // @poff=614
0x6c2: Pop(0)
...
0x6d6: @@@ size(Stack[-5]); Obj=11 // @poff=24
0x6d7: Pop(0)
0x6d8: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x6d9: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x6da: IF (Stack[-1] == 0) GOTO 0x6dc; Pop(1)

0x6db: Return(); Pop(10)

0x6dc: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x6dd: @@@ get(Stack[-5], Stack[-1]); Obj=9 // @poff=29
0x6de: Pop(1)
0x6df: PushEmpty(bool, object, int, bool)
0x6e0: Stack[-8] = Stack[-3]
...
0x6e7: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x6e8: @@@ get(Stack[-4], Stack[-1]); Obj=11 // @poff=29
0x6e9: Pop(1)
0x6ea: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x6eb: @@@ get(Stack[-3], Stack[-1]); Obj=10 // @poff=29
0x6ec: Pop(1)
0x6ed: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x6ee: IF (Stack[-1] == 0) GOTO 0x70f; Pop(1)

0x6ef: PushEmpty(int, object, int)
0x6f0: Stack[-7] = Stack[-2]
...
0x704: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x705: @@@ set(Stack[-1], Stack[-4]); Obj=11 // @poff=614
0x706: Pop(1)
0x707: PushEmpty(object)
0x708: Stack[-5] = Stack[-1]
0x709: Call2 0x32
...
0x718: @@@ size(Stack[-5]); Obj=11 // @poff=24
0x719: Pop(0)
0x71a: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x71b: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x71c: IF (Stack[-1] == 0) GOTO 0x71e; Pop(1)

0x71d: Return(); Pop(10)

0x71e: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x71f: @@@ get(Stack[-5], Stack[-1]); Obj=9 // @poff=29
0x720: Pop(1)
0x721: PushEmpty(bool, object, int, bool)
0x722: Stack[-8] = Stack[-3]
...
0x729: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x72a: @@@ get(Stack[-4], Stack[-1]); Obj=11 // @poff=29
0x72b: Pop(1)
0x72c: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x72d: @@@ get(Stack[-3], Stack[-1]); Obj=10 // @poff=29
0x72e: Pop(1)
0x72f: Push((int) 0)
...
0x737: Stack[-5] = Stack[-1]
0x738: Call2 0x4a

0x739: Pop(1)
0x73a: Push((int) -1)
0x73b: Stack[-4] = Stack[-4] + Stack[-1]; Pop(1);
0x73c: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x73d: @@@ set(Stack[-1], Stack[-4]); Obj=11 // @poff=614
0x73e: Pop(1)
0x73f: PushEmpty(int, object, int)
0x740: Stack[-7] = Stack[-2]
...
0x758: @@@ size(Stack[-6]); Obj=7 // @poff=24
0x759: Pop(0)
0x75a: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x75b: Pop(1); Push((bool) Stack[-1] >= Stack[-7])
0x75c: IF (Stack[-1] == 0) GOTO 0x75e; Pop(1)

0x75d: Return(); Pop(12)

0x75e: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x75f: @@@ get(Stack[-6], Stack[-1]); Obj=5 // @poff=29
0x760: Pop(1)
0x761: PushEmpty(bool, object, int, bool)
0x762: Stack[-9] = Stack[-3]
...
0x769: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x76a: @@@ get(Stack[-5], Stack[-1]); Obj=8 // @poff=29
0x76b: Pop(1)
0x76c: Push((int) 0)
...
0x770: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x771: @@@ get(Stack[-4], Stack[-1]); Obj=7 // @poff=29
0x772: Pop(1)
0x773: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x774: @@@ get(Stack[-3], Stack[-1]); Obj=6 // @poff=29
0x775: Pop(1)
0x776: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x777: IF (Stack[-1] == 0) GOTO 0x795; Pop(1)

0x778: PushEmpty(bool, object)
0x779: Stack[-7] = Stack[-1]
0x77a: Call2 0x637
...
0x782: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x783: @@@ set(Stack[-1], Stack[-4]); Obj=7 // @poff=614
0x784: Pop(1)
0x785: PushEmpty(int, object, int)
0x786: Stack[-8] = Stack[-2]
...
0x79e: @@@ size(Stack[-6]); Obj=7 // @poff=24
0x79f: Pop(0)
0x7a0: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7a1: Pop(1); Push((bool) Stack[-1] >= Stack[-7])
0x7a2: IF (Stack[-1] == 0) GOTO 0x7a4; Pop(1)

0x7a3: Return(); Pop(12)

0x7a4: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7a5: @@@ get(Stack[-6], Stack[-1]); Obj=5 // @poff=29
0x7a6: Pop(1)
0x7a7: PushEmpty(bool, object, int, bool)
0x7a8: Stack[-9] = Stack[-3]
...
0x7af: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7b0: @@@ get(Stack[-5], Stack[-1]); Obj=8 // @poff=29
0x7b1: Pop(1)
0x7b2: Push((int) 0)
...
0x7b6: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7b7: @@@ get(Stack[-4], Stack[-1]); Obj=7 // @poff=29
0x7b8: Pop(1)
0x7b9: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7ba: @@@ get(Stack[-3], Stack[-1]); Obj=6 // @poff=29
0x7bb: Pop(1)
0x7bc: Push((int) 0)
...
0x7d5: Stack[-6] = Stack[-1]
0x7d6: Call2 0x32

0x7d7: Pop(1)
0x7d8: Pop(0); Push(Stack[-13] + Stack[2 + Tasks[-1].StackPointer]);
0x7d9: @@@ set(Stack[-1], Stack[-4]); Obj=7 // @poff=614
0x7da: Pop(1)
0x7db: PushEmpty(int)
0x7dc: PushEmpty(int, object, int)
0x7dd: Stack[-9] = Stack[-2]
...
0x7f4: @@@ size(Stack[-2]); Obj=11 // @poff=24
0x7f5: Pop(0)
0x7f6: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
...
0x7fb: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
0x7fc: @@@ get(Stack[-2], Stack[-1]); Obj=11 // @poff=29
0x7fd: Pop(1)
0x7fe: Stack[-1] = Stack[-6]
0x7ff: Return(); Pop(4)

0x800: PushEmpty(int, int, int, int)
0x801: @@@ size(Stack[-2]); Obj=7 // @poff=24
0x802: Pop(0)
0x803: Pop(0); Push(Stack[-5] + Stack[2 + Tasks[-1].StackPointer]);
...
0x808: Pop(0); Push(Stack[-5] + Stack[2 + Tasks[-1].StackPointer]);
0x809: @@@ get(Stack[-2], Stack[-1]); Obj=7 // @poff=29
0x80a: Pop(1)
0x80b: Stack[-1] = Stack[-6]
0x80c: Return(); Pop(4)
...
0x92f: Push("sellf") // @poff=678
0x930: Pop(1); Push(Stack[-1] + Stack[-3]);
0x931: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=690
0x932: Pop(1)
0x933: Push(Stack[-1])
0x934: IF (Stack[-1] == 0) GOTO 0x939; Pop(1)

0x935: Push("sellf") // @poff=678
0x936: Pop(1); Push(Stack[-1] + Stack[-3]);
0x937: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=702
0x938: Pop(1)
0x939: Push((int) 1)
...
0x949: Push("buyf") // @poff=714
0x94a: Pop(1); Push(Stack[-1] + Stack[-3]);
0x94b: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=690
0x94c: Pop(1)
0x94d: Push(Stack[-1])
0x94e: IF (Stack[-1] == 0) GOTO 0x953; Pop(1)

0x94f: Push("buyf") // @poff=714
0x950: Pop(1); Push(Stack[-1] + Stack[-3]);
0x951: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=702
0x952: Pop(1)
0x953: Push((int) 1)
...
0x95b: Pop(0)
0x95c: Push("barter") // @poff=724
0x95d: @@ HasProperty(Stack[-1], Stack[-3]); Obj=4 // @poff=690
0x95e: Pop(1)
...
0x963: Push("barter") // @poff=724
0x964: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=702
0x965: Pop(1)
0x966: Stack[-1] = Stack[-7]
0x967: Return(); Pop(6)

0x968: Stack[-3] = 0
0x969: PushEmpty(int, int)
0x96a: @@ GetItemID(Stack[-1]); Obj=3 // @poff=738
0x96b: Pop(0)
...
0x991: Push("durability") // @poff=748
0x992: @@ HasProperty(Stack[-5], Stack[-1]); Obj=21 // @poff=690
0x993: Pop(1)
0x994: Push(Stack[-4])
0x995: IF (Stack[-1] == 0) GOTO 0x9a0; Pop(1)

0x996: Push("durability") // @poff=748
0x997: @@ GetProperty(Stack[-4], Stack[-1]); Obj=21 // @poff=702
0x998: Pop(1)
...
0x9a0: Stack[-8] = Stack[-21]
0x9a1: Return(); Pop(18)

0x9a2: PushEmpty(int, object)
0x9a3: Stack[-22] = Stack[-1]
0x9a4: Call2 0x969

0x9a5: Pop(1)
0x9a6: Push("BarterPrice") // @poff=0
...
0x9af: Stack[-22] = Stack[-1]
0x9b0: Call2 0x969

0x9b1: Pop(1)
0x9b2: Push("BarterPrice") // @poff=0
...
0x9d2: Pop(0)
0x9d3: @@ GetItemCount(Stack[-2]); Obj=1 // @poff=788
0x9d4: Pop(0)
0x9d5: Stack[-2] = Stack[-5]
0x9d6: Return(); Pop(4)
...
0x9da: Pop(0)
0x9db: @@ GetItemCount(Stack[-2], Stack[-5]); Obj=1 // @poff=788
0x9dc: Pop(0)
0x9dd: Stack[-2] = Stack[-6]
0x9de: Return(); Pop(4)
...
0x9e2: Pop(0)
0x9e3: @@ GetItem(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=801
0x9e4: Pop(0)
...
0x9eb: Pop(0)
0x9ec: @@ GetItemAmount(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=809
0x9ed: Pop(0)
0x9ee: Stack[-1] = Stack[-7]
0x9ef: Return(); Pop(4)
...
0x9f3: Pop(0)
0x9f4: @@ IsItemSelected(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=823
0x9f5: Pop(0)
0x9f6: Stack[-1] = Stack[-7]
0x9f7: Return(); Pop(4)
...
0x9fb: Pop(0)
0x9fc: @@ GetItem(Stack[-1], Stack[-5]); Obj=2 // @poff=801
0x9fd: Pop(0)
0x9fe: Stack[-1] = Stack[-6]
0x9ff: Return(); Pop(4)
...
0xa04: Pop(0)
0xa05: @@ GetItemAmount(Stack[-1], Stack[-5]); Obj=2 // @poff=809
0xa06: Pop(0)
0xa07: Stack[-1] = Stack[-6]
0xa08: Return(); Pop(4)

0xa09: Stack[-2] = 0
0xa0a: PushEmpty(bool, bool)
0xa0b: @@ Compare(Stack[-1], Stack[-3]); Obj=4 // @poff=838
0xa0c: Pop(0)
0xa0d: Stack[-1] = Stack[-5]
0xa0e: Return(); Pop(2)

0xa0f: PushEmpty()
0xa10: PushEmpty(bool, object, object)
0xa11: Stack[-5] = Stack[-2]
0xa12: Stack[-4] = Stack[-1]
0xa13: Call2 0xa0a

0xa14: Stack[-3] = Stack[-6]
0xa15: Pop(3)
0xa16: Return(); Pop(0)

0xa17: PushEmpty(int, object, int, int, object, int)
0xa18: @@ GetItemCount(Stack[-3], Stack[-7]); Obj=9 // @poff=788
0xa19: Pop(0)
0xa1a: Stack[-1] = (int) 0
0xa1b: Pop(0); Push((bool) Stack[-1] < Stack[-3])
0xa1c: IF (Stack[-1] == 0) GOTO 0xa2d; Pop(1)

0xa1d: @@ GetItem(Stack[-2], Stack[-1], Stack[-7]); Obj=9 // @poff=801
0xa1e: Pop(0)
0xa1f: PushEmpty(bool, object, object)
0xa20: Stack[-11] = Stack[-2]
...
0xa25: Push((int) 1)
0xa26: @@ RemoveItem(Stack[-2], Stack[-1], Stack[-8]); Obj=10 // @poff=846
0xa27: Pop(1)
...
0xa31: Push((int) 1)
0xa32: @@ AddItem(Stack[-2], Stack[-5], Stack[-4], Stack[-1]); Obj=6 // @poff=857
0xa33: Pop(1)
0xa34: Stack[-1] = Stack[-6]
0xa35: Return(); Pop(2)
