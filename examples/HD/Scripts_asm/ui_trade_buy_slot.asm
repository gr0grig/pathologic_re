...
0xad: Push((int) 0)
0xae: @@ get(Stack[-7]T, Stack[-1]); Obj=4 // @poff=54
0xaf: Pop(1)
0xb0: Push((int) 1)
0xb1: @@ get(Stack[-8]T, Stack[-1]); Obj=4 // @poff=54
0xb2: Pop(1)
0xb3: Push((int) 2)
0xb4: @@ get(Stack[-9]T, Stack[-1]); Obj=4 // @poff=54
0xb5: Pop(1)
0xb6: Push((int) 3)
0xb7: @@ get(Stack[-10]T, Stack[-1]); Obj=4 // @poff=54
0xb8: Pop(1)
0xb9: Return(); Pop(2)
...
0xbd: Push((int) 0)
0xbe: @@ get(Stack[-11]T, Stack[-1]); Obj=4 // @poff=54
0xbf: Pop(1)
0xc0: Return(); Pop(2)
...
0x10f: Push((int) 0)
0x110: @@ get(Stack[-0]T, Stack[-1]); Obj=4 // @poff=54
0x111: Pop(1)
0x112: Push((int) 1)
0x113: @@ get(Stack[-1]T, Stack[-1]); Obj=4 // @poff=54
0x114: Pop(1)
0x115: Return(); Pop(2)
...
0x119: Push("selected") // @poff=58
0x11a: @ SetBackground(Stack[-1])
0x11b: Pop(1)
0x11c: GOTO 0x120

0x11d: Push("default") // @poff=0
...
0x132: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=76
0x133: Pop(0)
0x134: @ GetItemImage(Stack[-1], Stack[-4]T)
0x135: Pop(0)
0x136: @ LoadImage(Stack[-4]T)
0x137: Pop(0)
...
0x13f: Push((int) 4)
0x140: Push("") // @poff=13
0x141: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x142: Pop(2)
0x143: GOTO 0x148
