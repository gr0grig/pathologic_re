...
Strings:
	...
	W:r_slot0
	W:r_slot
// @pool_raw:
...
0x17: Push((int) 1)
0x18: Push((int) 1)
0x19: @ Blit(Stack[-4]T, Stack[-2], Stack[-1])
0x1a: Pop(2)
0x1b: PushEmpty(bool)
0x1c: Stack[-1] = (bool) 0
0x1d: Push((int) 1)
...
0x24: Push("/") // @poff=16
0x25: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
0x26: Stack[-4] = Stack[-1] + Stack[1 + Tasks[-1].StackPointer]; Pop(1);
0x27: Push("default") // @poff=0
...
0xb5: Push((int) 0)
0xb6: @@ get(Stack[-7]T, Stack[-1]); Obj=4 // @poff=54
0xb7: Pop(1)
0xb8: Push((int) 1)
0xb9: @@ get(Stack[-8]T, Stack[-1]); Obj=4 // @poff=54
0xba: Pop(1)
0xbb: Push((int) 2)
0xbc: @@ get(Stack[-9]T, Stack[-1]); Obj=4 // @poff=54
0xbd: Pop(1)
0xbe: Push((int) 3)
0xbf: @@ get(Stack[-10]T, Stack[-1]); Obj=4 // @poff=54
0xc0: Pop(1)
0xc1: Return(); Pop(2)
...
0xc5: Push((int) 0)
0xc6: @@ get(Stack[-11]T, Stack[-1]); Obj=4 // @poff=54
0xc7: Pop(1)
0xc8: Return(); Pop(2)
...
0x117: Push((int) 0)
0x118: @@ get(Stack[-0]T, Stack[-1]); Obj=4 // @poff=54
0x119: Pop(1)
0x11a: Push((int) 1)
0x11b: @@ get(Stack[-1]T, Stack[-1]); Obj=4 // @poff=54
0x11c: Pop(1)
0x11d: Return(); Pop(2)
...
0x121: Push("selected") // @poff=58
0x122: @ SetBackground(Stack[-1])
0x123: Pop(1)
0x124: GOTO 0x128

0x125: Push("default") // @poff=0
...
0x13a: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=76
0x13b: Pop(0)
0x13c: @ GetItemImage(Stack[-1], Stack[-4]T)
0x13d: Pop(0)
0x13e: @ LoadImage(Stack[-4]T)
0x13f: Pop(0)
...
0x147: Push((int) 3)
0x148: Push("") // @poff=13
0x149: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x14a: Pop(2)
0x14b: GOTO 0x150
