...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:62006f00740074006c0065005f0065006d00700074007900000049734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
...
0x2b: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=26
0x2c: Pop(0)
0x2d: Push(Stack[-2])
...
0x3a: Stack[-10] = Stack[-2]
0x3b: Stack[-9] = Stack[-1]
0x3c: Call2 0x47
...
0x4d: Push("nouse_container") // @poff=37
