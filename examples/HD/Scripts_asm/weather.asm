...
Strings:
	...
	W:Region
	W:State
// @pool_raw:
...
0x10: Push(CVector(0.27450981736183167, 0.27450981736183167, 0.27450981736183167))
0x11: Push((float)3000.0)
0x12: Push((float)5000.0)
0x13: Push(CVector(0.19607844948768616, 0.19607844948768616, 0.19607843458652496))
0x14: Push(CVector(0.19607844948768616, 0.19607844948768616, 0.19607843458652496))
...
0x33: Push((bool) 0)
0x34: Push(CVector(0.5098039507865906, 0.27450981736183167, 0.18039216101169586))
0x35: Push(CVector(0.7058823704719543, 0.5058823823928833, 0.32156863808631897))
0x36: Push((float)3000.0)
0x37: Push((float)5000.0)
0x38: Push(CVector(0.6000000238418579, 0.4392157196998596, 0.2823529541492462))
0x39: Push(CVector(0.4862745404243469, 0.34117648005485535, 0.21176470816135406))
...
0x53: IF (Stack[-1] == 1) GOTO 0x5b; Pop(1)
...
0x59: IF (Stack[-1] == 1) GOTO 0x5b; Pop(1)

0x5a: Stack[-1] = (bool) 0
0x5b: IF (Stack[-1] == 0) GOTO 0x75; Pop(1)

0x5c: Push("day_clear_bk.tex") // @poff=622
0x5d: Push("day_clear_ft.tex") // @poff=656
0x5e: Push("day_clear_lt.tex") // @poff=690
0x5f: Push("day_clear_rt.tex") // @poff=724
0x60: Push("day_clear_up.tex") // @poff=758
0x61: Push("day_rain_bk.tex") // @poff=792
0x62: Push("day_rain_ft.tex") // @poff=824
0x63: Push("day_rain_lt.tex") // @poff=856
0x64: Push("day_rain_rt.tex") // @poff=888
0x65: Push("day_rain_up.tex") // @poff=920
0x66: Push((bool) 0)
0x67: Push(CVector(0.3921568989753723, 0.3921568989753723, 0.3921568691730499))
0x68: Push(CVector(0.5882353186607361, 0.5098039507865906, 0.47058823704719543))
0x69: Push((float)3000.0)
0x6a: Push((float)5000.0)
0x6b: Push(CVector(0.5882353186607361, 0.5098039507865906, 0.4313725531101227))
0x6c: Push(CVector(0.37254902720451355, 0.32549020648002625, 0.29019609093666077))
0x6d: PushEmpty(float, float, float)
0x6e: Stack[-2] = (float) 11.0
0x6f: Stack[-21] = Stack[-1]
0x70: Call2 0x2ae
...
0x75: Push("day_bk.tex") // @poff=952
0x76: Push("day_ft.tex") // @poff=974
0x77: Push("day_lt.tex") // @poff=996
0x78: Push("day_rt.tex") // @poff=1018
0x79: Push("day_up.tex") // @poff=1040
0x7a: Push("day_rain_bk.tex") // @poff=792
0x7b: Push("day_rain_ft.tex") // @poff=824
0x7c: Push("day_rain_lt.tex") // @poff=856
0x7d: Push("day_rain_rt.tex") // @poff=888
0x7e: Push("day_rain_up.tex") // @poff=920
0x7f: Push((bool) 0)
0x80: Push(CVector(0.2352941334247589, 0.2039215862751007, 0.16862745583057404))
0x81: Push(CVector(0.5882353186607361, 0.5490196347236633, 0.3921568691730499))
0x82: Push((float)3000.0)
0x83: Push((float)5000.0)
0x84: Push(CVector(0.364705890417099, 0.34117648005485535, 0.25882354378700256))
0x85: Push(CVector(0.37254902720451355, 0.32549020648002625, 0.29019609093666077))
0x86: PushEmpty(float, float, float)
0x87: Stack[-2] = (float) 11.0
0x88: Stack[-21] = Stack[-1]
0x89: Call2 0x2ae
...
0x97: Pop(0)
0x98: Push("dawn_bk.tex") // @poff=332
0x99: Push("dawn_ft.tex") // @poff=356
0x9a: Push("dawn_lt.tex") // @poff=380
0x9b: Push("dawn_rt.tex") // @poff=404
0x9c: Push("dawn_up.tex") // @poff=428
0x9d: Push("dawn_rain_bk.tex") // @poff=452
0x9e: Push("dawn_rain_ft.tex") // @poff=486
0x9f: Push("dawn_rain_lt.tex") // @poff=520
0xa0: Push("dawn_rain_rt.tex") // @poff=554
0xa1: Push("dawn_rain_up.tex") // @poff=588
0xa2: Push((bool) 0)
0xa3: Push(CVector(0.5098039507865906, 0.27450981736183167, 0.18039216101169586))
0xa4: Push(CVector(0.7058823704719543, 0.5058823823928833, 0.32156863808631897))
0xa5: Push((float)3000.0)
0xa6: Push((float)5000.0)
0xa7: Push(CVector(0.6000000238418579, 0.4392157196998596, 0.2823529541492462))
0xa8: Push(CVector(0.4862745404243469, 0.34117648005485535, 0.21176470816135406))
0xa9: PushEmpty(float, float, float)
0xaa: Stack[-2] = (float) 19.0
0xab: Stack[-21] = Stack[-1]
0xac: Call2 0x2ae
...
0xba: Pop(0)
0xbb: Push("night_bk.tex") // @poff=0
0xbc: Push("night_ft.tex") // @poff=26
0xbd: Push("night_lt.tex") // @poff=52
0xbe: Push("night_rt.tex") // @poff=78
0xbf: Push("night_up.tex") // @poff=104
0xc0: Push("night_rain_bk.tex") // @poff=130
0xc1: Push("night_rain_ft.tex") // @poff=166
0xc2: Push("night_rain_lt.tex") // @poff=202
0xc3: Push("night_rain_rt.tex") // @poff=238
0xc4: Push("night_rain_up.tex") // @poff=274
0xc5: Push((bool) 0)
0xc6: Push(CVector(0.0, 0.0, 0.0))
0xc7: Push(CVector(0.27450981736183167, 0.27450981736183167, 0.27450981736183167))
0xc8: Push((float)3000.0)
0xc9: Push((float)5000.0)
0xca: Push(CVector(0.19607844948768616, 0.19607844948768616, 0.19607843458652496))
0xcb: Push(CVector(0.19607844948768616, 0.19607844948768616, 0.19607843458652496))
0xcc: PushEmpty(float, float, float)
0xcd: Stack[-2] = (float) 21.0
0xce: Stack[-21] = Stack[-1]
0xcf: Call2 0x2ae
...
0xe5: Pop(1)
0xe6: Push("Forecast: rain begins in ") // @poff=1062
0xe7: Pop(1); Push(Stack[-1] + Stack[-2]);
0xe8: Push(" hours") // @poff=1114
...
0xf4: Pop(1)
0xf5: Push("Forecast: rain ends in ") // @poff=1128
0xf6: Pop(1); Push(Stack[-1] + Stack[-2]);
0xf7: Push(" hours") // @poff=1114
...
0x114: @ Rain()
0x115: Pop(0)
0x116: Push((float)0.20000000298023224)
0x117: Push((int) 1)
...
0x14f: Pop(0)
0x150: Push((float)0.30000001192092896)
...
0x169: Push(CVector(1.0, 1.0, 0.7176470756530762))
...
0x16f: Pop(1)
0x170: Push((float)0.009999999776482582)
0x171: Push((float)0.014999999664723873)
0x172: @ rand(Stack[-7], Stack[-2], Stack[-1])
0x173: Pop(2)
0x174: Push((int) 1)
0x175: Pop(1); Push(Stack[-16] + Stack[-1]);
0x176: PushEmpty(float, float)
0x177: Stack[-8] = Stack[-1]
0x178: Call2 0x28b
...
0x188: Stack[-4] = (float) 0.10000000149011612
0x189: GOTO 0x18e
...
0x1c6: Push(CVector(1.0, 1.0, 0.7176470756530762))
0x1c7: @ SetAmbientMod(Stack[-1])
0x1c8: Pop(1)
0x1c9: Push(Stack[-3])
0x1ca: IF (Stack[-1] == 0) GOTO 0x1cd; Pop(1)

0x1cb: Stack[-1] = (float) 0.014999999664723873
0x1cc: GOTO 0x1d1

0x1cd: Push((float)0.009999999776482582)
0x1ce: Push((float)0.014999999664723873)
...
0x1fb: Push("lightning") // @poff=1319
...
0x231: Push((float)0.20000000298023224)
...
0x240: Pop(1)
0x241: Push((int) 0)
0x242: Push(CVector(1.5563921928405762, 1.2026666402816772, 0.2379607856273651))
0x243: Push((float)0.20000000298023224)
...
0x248: Pop(1)
0x249: Push((int) 1)
0x24a: Push(CVector(1.5563921928405762, 1.2026666402816772, 0.2379607856273651))
0x24b: Push((float)0.20000000298023224)
...
0x250: Pop(1)
0x251: Push((int) 2)
0x252: Push(CVector(1.5563921928405762, 1.2026666402816772, 0.2379607856273651))
0x253: Push((float)0.20000000298023224)
...
0x25f: Pop(1)
0x260: Push((int) 0)
0x261: Push(CVector(0.7058823704719543, 1.0, 0.9098039269447327))
0x262: Push((float)0.20000000298023224)
...
0x267: Pop(1)
0x268: Push((int) 1)
0x269: Push(CVector(0.7058823704719543, 1.0, 0.9098039269447327))
0x26a: Push((float)0.20000000298023224)
...
0x26f: Pop(1)
0x270: Push((int) 2)
0x271: Push(CVector(0.7058823704719543, 1.0, 0.9098039269447327))
0x272: Push((float)0.20000000298023224)
0x273: @ LinearColorMod(Stack[-3], Stack[-4], Stack[-2], Stack[-1])
0x274: Pop(3)
0x275: Return(); Pop(2)

0x276: PushEmpty()
0x277: Push("lightning") // @poff=1319
...
0x290: PushEmpty()
0x291: Push("Region") // @poff=1339
0x292: Pop(1); Push(Stack[-1] + Stack[-2]);
0x293: Push("State") // @poff=1353
