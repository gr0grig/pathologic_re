		...
		if(var_74_bool != 0) {
			...
			if(var_35_float >= (var_16_float * var_16_float)) {
				...
				if(var_219_bool != 0) {
					...
					var_488_bool = !var_487_bool; //@nz
					if(var_488_bool == 0) goto Label_365;
					bool var_489_bool;
					func_156(var_489_bool, var_0_object);
					if(!var_489_bool) { //@nz
						goto Label_375;
					}
					var_0_object->GetPFPosition(var_29_cvector); //@t
...
void func_427(object var_0_object, float var_357_float, int var_358_int)
{
	...
	if(var_362_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_442_int, var_364_float, var_373_float);
		object var_443_object; float var_444_float;
...
void func_819(bool var_467_bool)
{
	var_467_bool = true;
}
...
void func_1473(object var_95_object)
{
	bool var_97_bool;
...
void func_466(object var_0_object, int var_1_int, bool var_320_bool, float var_321_float)
{
	...
	if(var_327_bool != 0) {
		...
		func_805(var_329_string);
		bool var_452_bool;
		func_156(var_452_bool, var_0_object);
		if(!var_452_bool) { //@nz
			@StopAsync();
			var_320_bool = false;
			return 8;
		}
		float var_455_float; int var_456_int;
		var_321_float = var_455_float;
		func_427(var_329_string, var_455_float, var_456_int);
		var_328_int = 1;

		for(;;) {
			var_329_string = (("attack_middle" + var_456_int) + "_") + var_328_int;
			...
			if(!var_327_bool) { //@nz
				...
				func_805(var_329_string);
				bool var_478_bool;
				func_156(var_478_bool, var_0_object);
				if(!var_478_bool) { //@nz
					@StopAsync();
					var_320_bool = false;
					return 8;
...
// @pe
void func_1493(object var_10_object)
{
...
void func_603(bool var_468_bool, float var_469_float)
{
	float var_472_float; bool var_473_bool;
	@rand(var_472_float);
	if(var_472_float < var_469_float) {
