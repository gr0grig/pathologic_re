...
// @pe
void func_1547(bool var_74_bool, string var_75_string)
{
	var_74_bool = true;
...
void func_2086(bool var_14_bool, object var_15_object, object var_16_object)
{
	bool var_18_bool;
...
void func_2118(bool var_14_bool, object var_15_object)
{
...
void func_1634(object var_159_object)
{
	object var_161_object;
	@self(var_161_object);
	var_161_object = var_159_object;
}
EMIT "Stack[-1] = 0";
...
void func_1640(cvector var_43_cvector, cvector var_44_cvector)
{
...
// @pe
void func_1650(float var_47_float, float var_48_float, float var_49_float, float var_50_float)
{
...
void func_1661(bool var_89_bool, int var_90_int, int var_91_int)
{
	int var_93_int;
...
void func_2174(object var_52_object)
{
...
// @pe
void func_1672(bool var_18_bool, object var_19_object, float var_20_float)
{
	if(!var_19_object) { //@nz
		var_18_bool = false;
		return 0;
...
void func_1707(float var_25_float)
{
...
void func_683(bool var_0_bool, bool var_1_bool, object var_59_object, object var_131_object)
{
	...
	for(;;) {
		bool var_127_bool;
		func_1295(var_127_bool, var_59_object);
		if(var_127_bool != 0) {
			if(!var_1_bool) { //@nz
				@StopAsync();
				object var_130_object;
				TaskCall(5);
				func_893(var_131_object, var_130_object);
				TaskReturn();
	...
	Label_749:
		...
		var_81_float = sqrt((1 - (var_194_float * var_195_float)) / ((var_198_float * var_199_float) + (var_201_float * var_202_float)));
		var_206_float = GetByIndex(var_78_cvector, 0);
		var_207_float = GetByIndex(var_75_cvector, 0);
		SetByIndex(var_78_cvector, 0) = (var_207_float * var_81_float);
		var_208_float = GetByIndex(var_78_cvector, 2);
		var_209_float = GetByIndex(var_75_cvector, 2);
		SetByIndex(var_78_cvector, 2) = (var_209_float * var_81_float);
		var_0_bool->GetPosition(var_74_cvector); //@t
		float var_210_float; cvector var_211_cvector; cvector var_212_cvector; cvector var_213_cvector;
		...
		if(var_82_float < 0) {
			...
			float var_265_float; int var_266_int; float var_267_float;
			var_76_int = var_266_int;
			var_82_float = var_267_float;
			func_1967(var_266_int, var_267_float);
			var_265_float = var_82_float;
		}
		var_80_object->SetScriptProperty("StartVelocity", (var_213_cvector * var_82_float));
		}
		...
		if(var_76_int == 1) {
			@irand(var_83_int, 2);
			@PlayGlobalSound(("scream" + (var_83_int + 1)), [0.0, 150.0, 0.0], 1, 500);
...
void func_1717(object var_134_object)
{
	bool var_136_bool;
...
void func_1726(string var_68_string, int var_69_int)
{
...
void func_1232(bool var_29_bool, object var_30_object, string var_31_string, float var_32_float, float var_33_float, float var_34_float)
{
	...
	func_1650(var_47_float, (var_36_float + var_32_float), var_49_float, var_50_float);
	var_30_object->SetProperty(var_31_string, var_47_float);
	var_29_bool = true;
}


void func_1750(int var_116_int)
{
	int var_118_int;
...
// @pe
void func_1756(object var_15_object)
{
	int var_16_int;
...
void func_1254(bool var_113_bool, object var_114_object)
{
	bool var_116_bool;
...
void func_1769(int var_65_int, int var_66_int)
{
...
void func_1259(bool var_102_bool, object var_103_object)
{
...
void func_1800(string var_122_string)
{
...
void func_1295(bool var_98_bool, object var_99_object)
{
...
void func_1319(bool var_88_bool, cvector var_89_cvector)
{
...
void func_1329(bool var_84_bool, object var_85_object)
{
...
void func_1878(int var_77_int, string var_78_string)
{
	int var_80_int;
...
void func_1883(bool var_19_bool, object var_20_object)
{
...
void func_1901(float var_210_float, cvector var_211_cvector, cvector var_212_cvector, cvector var_213_cvector)
{
	...
	float var_219_float = sqrt((var_224_float * var_225_float) + (var_227_float * var_228_float));
	...
	float var_221_float = sqrt(((var_232_float - var_233_float) * (var_235_float - var_236_float)) + ((var_239_float - var_240_float) * (var_242_float - var_243_float)));
	var_249_float = GetByIndex(var_212_cvector, 1);
	var_250_float = GetByIndex(var_211_cvector, 1);
	float var_222_float = 500.0 / ((var_221_float * (var_231_float / var_219_float)) - (var_249_float - var_250_float));
	if(var_222_float < 0)
		var_210_float = -1;
	var_256_float = sqrt(var_222_float);
	float var_223_float = (var_221_float / var_219_float) * var_256_float;
	var_223_float = var_210_float;
}


void func_893(bool var_0_bool, object var_130_object)
{
	@Sleep(5);
...
// @pe
void func_1945(int var_139_int, float var_140_float)
{
...
void func_417(bool var_0_bool, bool var_1_bool, cvector var_2_cvector, object var_119_object, bool var_120_bool, float var_142_float)
{
	bool var_122_bool;
	bool var_123_bool;
	func_1295(var_123_bool, var_1_bool);
	if(!var_123_bool) //@nz
		return 2;
	var_1_bool = var_119_object;
...
Label_436:
	...
	if(var_2_cvector == null) {
		...
		Label_451:
			...
			TaskCall(6);
			func_943(var_142_float, var_143_float, var_144_object, var_140_object, var_1_bool);
			TaskReturn();
			var_1_bool = var_142_float;
			@SetTimer(61, 0.5);
			bool var_166_bool;
			func_1295(var_166_bool, var_1_bool);
			if(!var_166_bool) { //@nz
				goto Label_477;
			}
			var_1_bool->GetPFPosition(var_0_bool); //@t
...
// @pe
void func_1959(float var_259_float, int var_260_int)
{
	if(var_260_int == 1)
		var_259_float = 30;
	var_259_float = 700;
...
void func_943(bool var_0_bool, bool var_1_bool, cvector var_2_cvector, object var_140_object, object var_141_object)
{
	bool var_147_bool;
	@GetSeeThreshold(var_0_bool);
	@GetSeeFOV(var_1_bool);
	@SetSeeThreshold(var_0_bool / 1.5);
	func_1717(var_141_object);
	int var_148_int = 0;
	...
	for(;;) {
		if(var_148_int < 3) {
			...
			if(!var_147_bool) { //@nz
					...
					if(var_161_bool == 0) goto Label_982;
			}
		}
		for(;;) {
...
// @pe
void func_1967(float var_265_float, float var_267_float)
{
	if(var_267_float < 10) {
		var_265_float = 10;
		return 0;
...
void func_1464(bool var_58_bool)
{
	bool var_60_bool;
...
// @pe
void func_1981(bool var_12_bool, object var_13_object)
{
	object var_15_object;
...
void func_1469(object var_180_object)
{
	float var_183_float;
	var_180_object->GetEyesHeight(var_183_float);
	cvector var_184_cvector = [0.0, 0.0, 0.0];
...
// @pe
void func_1988(object var_114_object)
{
...
// @pe
void func_1996(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
...
// @pe
void func_2003(object var_114_object)
{
	TaskCall(4);
	object var_115_object;
...
// @pe
void func_2013(object var_51_object)
{
...
// @pe
void func_2045(object var_12_object)
{
	object var_13_object;
	...
	if(var_14_bool != 0) {
		...
		func_1672(var_18_bool, var_19_object, 0.05);
	}
