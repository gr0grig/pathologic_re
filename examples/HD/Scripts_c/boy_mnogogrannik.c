...
void func_2564(string var_158_string)
{
...
// @pe
void func_3092(int var_123_int)
{
	var_123_int = 0;
}
...
// @pe
void func_3100(object var_24_object)
{
...
// @pe
void func_3107(bool var_19_bool)
{
	var_19_bool = false;
}
		...
		if(var_188_bool != 0) {
			...
			if(var_149_float >= (var_130_float * var_130_float)) {
				...
				if(var_316_bool != 0) {
					...
					var_579_bool = !var_578_bool; //@nz
					if(var_579_bool == 0) goto Label_1266;
					bool var_580_bool;
					func_2149(var_580_bool, var_0_bool);
					if(!var_580_bool) { //@nz
						goto Label_1276;
					}
					var_0_bool->GetPFPosition(var_143_cvector); //@t
...
void func_3112(bool var_26_bool, object var_27_object)
{
	bool var_29_bool;
...
// @pe
void func_3127(object var_54_object)
{
...
// @pe
void func_3133(bool var_43_bool)
{
	var_43_bool = false;
}
...
// @pe
void func_3138(bool var_21_bool)
{
	var_21_bool = false;
}
...
void func_2633(bool var_15_bool)
{
	@ClearSubContainer(0);
	int var_23_int;
...
void func_3151(object var_25_object)
{
	bool var_27_bool;
...
void func_3165(bool var_58_bool)
{
	var_58_bool = false;
}
...
// @pe
void func_3167(bool var_18_bool, object var_19_object, object var_20_object, bool var_21_bool)
{
	object var_23_object;
	...
	bool var_22_bool;
	func_3058(var_22_bool, var_23_object, var_24_object, 700.0, var_26_bool);
...
// @pe
void func_3177(object var_96_object)
{
...
void func_2733(int var_131_int, string var_132_string)
{
	int var_134_int;
...
void func_1711(int var_533_int)
{
	var_533_int = 0;
}
...
// @pe
void func_2738(object var_14_object)
{
	object var_15_object;
...
void func_1720(bool var_558_bool)
{
	var_558_bool = true;
}
...
// @pe
void func_2783(bool var_17_bool, object var_18_object, string var_19_string)
{
...
// @pe
void func_2815(object var_47_object, string var_48_string)
{
...
Label_2839:
	...
	if(!(var_48_string == "battle")) goto Label_2839;
	object var_122_object;
...
void func_2840(bool var_14_bool, object var_15_object)
{
	bool var_17_bool;
...
// @pe
void func_2863(object var_28_object)
{
	object var_29_object;
...
void func_1328(bool var_0_bool, float var_454_float, int var_455_int)
{
	...
	if(var_459_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_533_int, var_461_float, var_470_float);
		object var_534_object; float var_535_float;
...
// @pe
void func_2869(object var_16_object)
{
...
void func_2882(bool var_14_bool, string var_15_string)
{
	object var_17_object;
...
void func_2898(string var_25_string)
{
	object var_27_object;
...
void func_1367(bool var_0_bool, bool var_1_bool, bool var_417_bool, float var_418_float)
{
	...
	if(var_424_bool != 0) {
		...
		func_1706(var_426_string);
		bool var_543_bool;
		func_2149(var_543_bool, var_0_bool);
		if(!var_543_bool) { //@nz
			@StopAsync();
			var_417_bool = false;
			return 8;
		}
		float var_546_float; int var_547_int;
		var_418_float = var_546_float;
		func_1328(var_426_string, var_546_float, var_547_int);
		var_425_int = 1;

		for(;;) {
			var_426_string = (("attack_middle" + var_547_int) + "_") + var_425_int;
			...
			if(!var_424_bool) { //@nz
				...
				func_1706(var_426_string);
				bool var_569_bool;
				func_2149(var_569_bool, var_0_bool);
				if(!var_569_bool) { //@nz
					@StopAsync();
					var_417_bool = false;
					return 8;
				}
				float var_572_float; int var_573_int;
...
void func_2911(string var_149_string, int var_150_int)
{
...
void func_2918(int var_143_int)
{
...
// @pe
void func_2944(object var_55_object)
{
...
// @pe
void func_2952(int var_83_int, object var_84_object)
{
...
// @pe
void func_2962(object var_120_object)
{
...
void func_2970(bool var_29_bool, object var_30_object, bool var_31_bool)
{
...
void func_2494(object var_16_object)
{
	bool var_18_bool;
...
void func_2514(int var_152_int)
{
	int var_154_int;
...
// @pe
void func_2520(object var_30_object)
{
	int var_31_int;
...
void func_1504(bool var_559_bool, float var_560_float)
{
	float var_563_float; bool var_564_bool;
	@rand(var_563_float);
	if(var_563_float < var_560_float) {
...
// @pe
void func_3045(int var_80_int, object var_81_object)
{
...
void func_2533(int var_110_int, int var_111_int)
{
...
// @pe
void func_3052(object var_119_object)
{
...
void func_3058(bool var_22_bool, object var_23_object, object var_24_object, float var_25_float, bool var_26_bool)
{
	object var_30_object;
	var_24_object = var_30_object;
	bool var_29_bool;
	func_2970(var_29_bool, var_30_object, !var_26_bool);
	if(!var_29_bool) { //@nz
		var_22_bool = false;
		return 2;
	}
