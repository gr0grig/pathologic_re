...
{
	var_465_float = 0.05000000074505806;
	return 0;
}
...
func_2035(var_468_float, var_469_object, var_470_float, var_471_int)
{
	...
	func_2383(var_506_float, var_507_float, (float)1);
	...
	func_2390(var_516_float, var_517_float, (float)0, (float)1);
