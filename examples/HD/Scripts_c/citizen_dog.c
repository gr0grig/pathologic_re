...
// @pe
void func_3078(bool var_46_bool)
{
	var_46_bool = false;
}
...
// @pe
void func_3083(bool var_24_bool)
{
	var_24_bool = false;
}
...
void func_3094(bool var_61_bool)
{
	var_61_bool = false;
}
...
// @pe
void func_3096(bool var_21_bool, object var_22_object, object var_23_object, bool var_24_bool)
{
	object var_26_object;
	...
	bool var_25_bool;
	func_3001(var_25_bool, var_26_object, var_27_object, 500.0, var_29_bool);
...
// @pe
void func_3106(object var_99_object)
{
		...
		if(var_191_bool != 0) {
			...
			if(var_152_float >= (var_133_float * var_133_float)) {
				...
				if(var_319_bool != 0) {
					...
					var_582_bool = !var_581_bool; //@nz
					if(var_582_bool == 0) goto Label_1266;
					bool var_583_bool;
					func_2348(var_583_bool, var_0_bool);
					if(!var_583_bool) { //@nz
						goto Label_1276;
					}
					var_0_bool->GetPFPosition(var_146_cvector); //@t
...
// @pe
void func_3070(object var_57_object)
{
...
void func_2661(object var_19_object)
{
	bool var_21_bool;
...
// @pe
void func_2681(object var_17_object)
{
	object var_18_object;
...
// @pe
void func_2726(bool var_20_bool, object var_21_object, string var_22_string)
{
...
void func_1711(int var_536_int)
{
	var_536_int = 0;
}
...
void func_1720(bool var_561_bool)
{
	var_561_bool = true;
}
...
// @pe
void func_2758(object var_50_object, string var_51_string)
{
...
Label_2782:
	...
	if(!(var_51_string == "battle")) goto Label_2782;
...
void func_2783(bool var_17_bool, object var_18_object)
{
	bool var_20_bool;
...
// @pe
void func_2806(object var_31_object)
{
	object var_32_object;
...
// @pe
void func_2812(object var_19_object)
{
...
void func_2825(bool var_17_bool, string var_18_string)
{
	object var_20_object;
...
void func_2841(string var_28_string)
{
	object var_30_object;
...
void func_2854(string var_71_string, int var_72_int)
{
...
void func_1328(bool var_0_bool, float var_457_float, int var_458_int)
{
	...
	if(var_462_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_536_int, var_464_float, var_473_float);
		object var_537_object; float var_538_float;
...
// @pe
void func_2887(object var_67_object)
{
	object var_68_object;
...
// @pe
void func_2895(int var_86_int, object var_87_object)
{
...
void func_1367(bool var_0_bool, bool var_1_bool, bool var_420_bool, float var_421_float)
{
	...
	if(var_427_bool != 0) {
		...
		func_1706(var_429_string);
		bool var_546_bool;
		func_2348(var_546_bool, var_0_bool);
		if(!var_546_bool) { //@nz
			@StopAsync();
			var_420_bool = false;
			return 8;
		}
		float var_549_float; int var_550_int;
		var_421_float = var_549_float;
		func_1328(var_429_string, var_549_float, var_550_int);
		var_428_int = 1;

		for(;;) {
			var_429_string = (("attack_middle" + var_550_int) + "_") + var_428_int;
			...
			if(!var_427_bool) { //@nz
				...
				func_1706(var_429_string);
				bool var_572_bool;
				func_2348(var_572_bool, var_0_bool);
				if(!var_572_bool) { //@nz
					@StopAsync();
					var_420_bool = false;
					return 8;
...
// @pe
void func_2905(object var_123_object)
{
...
void func_2913(bool var_32_bool, object var_33_object, bool var_34_bool)
{
...
// @pe
void func_2988(int var_83_int, object var_84_object)
{
...
// @pe
void func_2995(object var_122_object)
{
...
void func_3001(bool var_25_bool, object var_26_object, object var_27_object, float var_28_float, bool var_29_bool)
{
	object var_33_object;
	var_27_object = var_33_object;
	bool var_32_bool;
	func_2913(var_32_bool, var_33_object, !var_29_bool);
	if(!var_32_bool) { //@nz
		var_25_bool = false;
		return 2;
	}
...
// @pe
void func_3035(int var_133_int)
{
	var_133_int = 0;
}
...
// @pe
void func_3040(int var_19_int)
{
	var_19_int = 2;
}


void func_1504(bool var_562_bool, float var_563_float)
{
	float var_566_float; bool var_567_bool;
	@rand(var_566_float);
	if(var_566_float < var_563_float) {
...
// @pe
void func_3043(object var_27_object)
{
...
// @pe
void func_3050(bool var_22_bool)
{
	var_22_bool = false;
}
...
void func_3055(bool var_29_bool, object var_30_object)
{
	bool var_32_bool;
