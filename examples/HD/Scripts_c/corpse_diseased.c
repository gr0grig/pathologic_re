// @IMPORTS: Hold/0,Trace/1,IsOverrideActive/1,Barter/1,SetVisibility/1,GetPosition/1,GetScene/1,GetGameTime/1,GetVariable/2,GetInvItemByName/2,AddItem/4
// @STRINGS: W:Trying to use|A:IsOnGround|W:blooddiseased|W:Can't add corpse item|W:I am in region |W: and visible|W: and not visible|A:GetRegionByPt|W:Region|W:State
// @RUN_OP: 0x0
// @RUN_TASK: 0
// @TASK_0: vars= params=0
// @EVENT_0: op=0x7 vars=object
// @EVENT_5: op=0x18 vars=
// @PE: 0x0,0x18,0x6a,0x70
...
func_40()
{
	...
	if(var_20_bool != 0) {
		...
		var_35_int = "I am in region " + var_1_int;
		var_37_int = var_35_int + " and visible";
		Trace(var_37_int);
	} else {
		SetVisibility((bool)1);
		var_40_int = "I am in region " + var_1_int;
		var_42_int = var_40_int + " and not visible";
		Trace(var_42_int);
	}
	return 2;
...
func_28()
{
	...
	func_135(var_0_bool, "blooddiseased", (int)1, (int)0);
