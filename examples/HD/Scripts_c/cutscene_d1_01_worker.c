...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, int var_10_int, int var_11_int, bool var_12_bool, float var_13_float, int var_14_int, bool var_15_bool, object var_16_object, bool var_17_bool)
	{
		if(1 != 0) {
			func_2270();
			if(var_16_object == 19232) {
				func_132(var_17_bool, "Neutral");
				var_0_object->SetMessage(518113); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(518114, -1, 19233); //@t
				var_0_object->AddReply(534586, -1, 36224); //@t
				return 0;
			}
			var_3_string = true;
			bool var_46_bool;
...
{
	func_2378(var_0_object);
}


void func_1545(int var_477_int)
{
	var_477_int = 0;
}
...
void func_1554(bool var_502_bool)
{
	var_502_bool = true;
}
...
void func_2621(int var_44_int, string var_45_string)
{
	int var_47_int;
...
// @pe
void func_2626(object var_17_object)
{
	object var_18_object;
...
void func_2141(bool var_38_bool, object var_39_object, float var_40_float)
{
	...
	func_2324(var_65_cvector, (var_54_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_57_bool != 0)
		var_38_bool = false;
	@StopWorld();
	@CameraTransit((var_52_cvector + var_55_cvector), var_54_cvector, true);
	...
	if(var_81_bool != 0) {
		...
		if(var_58_bool == 0) goto Label_2204;
...
// @pe
void func_2671(bool var_20_bool, object var_21_object, string var_22_string)
{
...
// @pe
void func_132(object var_2_object, string var_106_string)
{
	bool var_107_bool;
...
void func_1162(object var_0_object, float var_398_float, int var_399_int)
{
	...
	if(var_403_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_477_int, var_405_float, var_414_float);
		object var_478_object; float var_479_float;
...
// @pe
void func_2703(object var_35_object, string var_36_string)
{
...
Label_2727:
	...
	if(!(var_36_string == "battle")) goto Label_2727;
...
void func_2210(void)
{
	...
	if(var_153_bool != 0) {
		...
		if(var_151_bool == 0) goto Label_2227;
		@UnlookAsync("head");
	}
Label_2227:
...
void func_2728(bool var_17_bool, object var_18_object)
{
	bool var_20_bool;
...
void func_1201(object var_0_object, object var_1_object, bool var_361_bool, float var_362_float)
{
	...
	if(var_368_bool != 0) {
		...
		func_1540(var_370_string);
		bool var_487_bool;
		func_1975(var_487_bool, var_0_object);
		if(!var_487_bool) { //@nz
			@StopAsync();
			var_361_bool = false;
			return 8;
		}
		float var_490_float; int var_491_int;
		var_362_float = var_490_float;
		func_1162(var_370_string, var_490_float, var_491_int);
		var_369_int = 1;

		for(;;) {
			var_370_string = (("attack_middle" + var_491_int) + "_") + var_369_int;
			...
			if(!var_368_bool) { //@nz
				...
				func_1540(var_370_string);
				bool var_513_bool;
				func_1975(var_513_bool, var_0_object);
				if(!var_513_bool) { //@nz
					@StopAsync();
					var_361_bool = false;
					return 8;
...
void func_2228(string var_132_string)
{
...
// @pe
void func_2751(object var_29_object)
{
	object var_30_object;
...
void func_2244(string var_110_string, bool var_111_bool)
{
	...
	if(var_117_bool != 0) {
		...
		@Trace("Can't find lsh animation : " + var_110_string);
	}
...
// @pe
void func_2757(object var_19_object)
{
...
void func_2770(bool var_17_bool, string var_18_string)
{
	object var_20_object;
...
void func_2259(object var_20_object)
{
	float var_23_float;
...
void func_2786(string var_26_string)
{
...
void func_2277(string var_42_string)
{
	...
	if(var_64_bool == 0) goto Label_2297;
}
...
void func_2799(string var_187_string, int var_188_int)
{
...
void func_2806(int var_181_int)
{
...
// @pe
void func_2823(int var_28_int, object var_29_object)
{
...
void func_2318(object var_135_object)
{
...
// @pe
void func_2833(object var_68_object)
{
...
void func_2324(cvector var_48_cvector, cvector var_49_cvector)
{
...
// @pe
void func_2334(float var_450_float, float var_451_float, float var_452_float)
{
...
// @pe
void func_2341(float var_460_float, float var_461_float, float var_462_float, float var_463_float)
{
...
// @pe
void func_2859(object var_25_object)
{
...
void func_2352(float var_468_float)
{
...
// @pe
void func_2865(bool var_22_bool)
{
	var_22_bool = false;
}
...
// @pe
void func_2870(bool var_29_bool)
{
	var_29_bool = false;
}
...
void func_1338(bool var_503_bool, float var_504_float)
{
	float var_507_float; bool var_508_bool;
	@rand(var_507_float);
	if(var_507_float < var_504_float) {
...
// @pe
void func_2875(bool var_33_bool)
{
	var_33_bool = false;
}
...
// @pe
void func_2880(bool var_24_bool)
{
	var_24_bool = false;
}
...
void func_1861(float var_412_float, object var_413_object, float var_414_float, int var_415_int)
{
	...
	float var_450_float;
	func_2334(var_450_float, ((var_425_int + var_427_int) / 100.0), (float)1);
	float var_428_float;
	...
	float var_460_float;
	func_2341(var_460_float, (var_429_float - var_430_float), (float)0, (float)1);
...
void func_2887(int var_86_int)
{
	var_86_int = 503353;
}


void func_2889(string var_88_string)
{
	var_88_string = "ui/NPC_Citizen1.png";
}


void func_2378(object var_19_object)
{
	bool var_21_bool;
...
void func_2891(string var_89_string)
{
	var_89_string = "ui/NPC_Citizen1_b.png";
}


void func_2893(bool var_81_bool)
{
	var_81_bool = false;
}
...
// @pe
void func_2900(object var_26_object)
{
	object var_28_object;
...
// @pe
void func_2908(bool var_21_bool)
{
	var_21_bool = false;
}
...
void func_2415(int var_23_int, int var_24_int)
{
		...
		if(var_134_bool != 0) {
			...
			if(var_97_float >= (var_78_float * var_78_float)) {
				...
				if(var_260_bool != 0) {
					...
					var_523_bool = !var_522_bool; //@nz
					if(var_523_bool == 0) goto Label_1100;
					bool var_524_bool;
					func_1975(var_524_bool, var_0_object);
					if(!var_524_bool) { //@nz
						goto Label_1110;
					}
					var_0_object->GetPFPosition(var_91_cvector); //@t
...
void func_2446(bool var_17_bool)
{
	int var_20_int; bool var_21_bool;
	if(var_17_bool != 0) {
		int var_26_int;
		func_2369(var_26_int);
		func_2415(0, (100 + (var_26_int * 100)));
		@irand(var_20_int, 8);
		if(var_20_int == 0) {
			int var_54_int;
