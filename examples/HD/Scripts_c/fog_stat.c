// @IMPORTS: Sleep/1,GetHeight/1,PlayLoopedGlobalSound/3,FogLinear/2,ReportHit/4,GetPosition/1,FindActor/2,IsPlayerActor/2,IsLoaded/1,self/1,CreateFloatVector/1,SendWorldWndMessage/2,RemoveActor/1,Hold/0
// @STRINGS: W:attack|A:FadeOut|A:GetPosition|W:player|W:HasProperty|A:HasProperty|A:GetProperty|A:SetProperty|W:disease|W:armor_disease|W:immunity|A:add
// @RUN_OP: 0x0
// @RUN_TASK: 0
// @TASK_0: vars= params=0
// @TASK_1: vars= params=1
// @STANDALONE_EVENT_6: op=0x101 vars=
// @PE: 0xd7,0xec,0xf9
