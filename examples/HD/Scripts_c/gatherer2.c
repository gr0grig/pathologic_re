...
// @pe
void func_901(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, string var_4_string, float var_56_float, float var_57_float)
{
	bool var_58_bool;
...
void func_1305(string var_87_string, int var_88_int)
{
...
void func_1059(bool var_106_bool)
{
	var_106_bool = true;
}
...
void func_1447(int var_32_int, string var_33_string)
{
	int var_35_int;
...
void func_1074(bool var_58_bool)
{
	bool var_60_bool;
...
void func_832(object var_6_object, float var_47_float, float var_48_float)
{
	...
	for(;;) {
		...
		func_901(var_57_float, var_49_float, var_50_bool, var_51_float, var_52_bool, var_56_float, var_57_float);
		var_6_object = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_1479(string var_92_string)
{
...
void func_1481(string var_93_string)
{
	var_93_string = "ui/NPC_Morlok_b.png";
}


void func_1483(bool var_85_bool)
{
	var_85_bool = false;
}
...
void func_980(void)
{
	...
	for(;;) {
		...
		if(var_94_bool != 0) {
			@irand(var_74_int, 3);
			if(var_74_int == 0) {
				if(var_72_int == 0) goto Label_1027;
			...
			if(var_74_int == 1) {
				...
				goto Label_1056;
					...
					if(var_107_bool == 0) goto Label_1051;
			}
		}
	Label_1056:
		for(;;) {
