...
func_901(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_51_float, var_52_float)
{
	var_53_bool = 0;
	...
	func_980();
	var_111_bool = var_3_object == 0; //@nz
	if(var_111_bool != 0) {
		KillTimer((int)10);
	}
	return 0;
...
{
	var_44_float = 0; var_45_bool = 0; var_46_float = 0; var_47_bool = 0;
	var_6_object = false;
	
Label_834:
	rand(var_46_float, (int)3);
	var_50_int = var_46_float + (int)3;
	Sleep(var_50_int, var_47_bool);
	var_6_object = true;
	var_51_float = 0; var_52_float = 0;
	var_42_float = var_51_float;
	var_43_float = var_52_float;
	func_901(var_43_float, var_44_float, var_45_bool, var_46_float, var_47_bool, var_51_float, var_52_float);
	var_6_object = false;
	goto Label_834;
}
EMIT "Return(); Pop(4)";
...
func_980()
{
	var_60_int = 0; var_61_int = 0; var_62_int = 0; var_63_int = 0; var_64_bool = 0; var_65_float = 0; var_66_bool = 0; var_67_int = 0; var_68_int = 0; var_69_int = 0; var_70_int = 0; var_71_bool = 0; var_72_float = 0; var_73_bool = 0;
	WaitForAnimEnd();
	var_74_bool = 0;
...
Label_994:
	...
	if(var_89_bool != 0) {
		irand(var_69_int, (int)3);
		var_95_bool = var_69_int == (int)0;
		if(var_95_bool != 0) {
			var_96_int = var_67_int;
			if(var_96_int == 0) goto Label_1027;
			...
			var_100_bool = var_71_bool == 0; //@nz
			if(var_100_bool != 0) {
			} else {
		} else {
				var_105_bool = var_69_int == (int)1;
				if(var_105_bool != 0) {
					rand(var_72_float, (int)4);
					var_108_int = var_72_float + (int)1;
					Sleep(var_108_int, var_73_bool);
					var_109_bool = var_73_bool == 0; //@nz
					if(var_109_bool != 0) {
						goto Label_1056;
					}
					goto Label_1045;
				}
				var_110_int = var_68_int;
				if(var_110_int == 0) goto Label_1045;
				goto Label_1056;
		}
		Label_1045:
			var_101_bool = 0;
...
func_1406()
{
	...
	irand(var_28_int, (int)10);
	var_28_int = var_28_int + (int)3;
