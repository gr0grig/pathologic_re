...
{
	var_154_string = ""; var_155_string = "";
	var_156_int = var_153_int;
	if(var_156_int != 0) {
		"idle" = "idle" + var_153_int;
	}
...
{
	var_147_int = 0; var_148_bool = 0; var_149_int = 0; var_150_bool = 0;
	var_149_int = 0;
...
func_533()
{
	var_130_int = 0; var_131_int = 0; var_132_int = 0; var_133_int = 0; var_134_bool = 0; var_135_float = 0; var_136_bool = 0; var_137_int = 0; var_138_int = 0; var_139_int = 0; var_140_int = 0; var_141_bool = 0; var_142_float = 0; var_143_bool = 0;
	WaitForAnimEnd();
	var_144_bool = 0;
...
Label_547:
	var_159_bool = 0;
	var_159_bool = 0;
	var_161_bool = var_138_int < (int)5;
	if(var_161_bool != 0) {
		var_162_bool = 0;
	...
	if(var_159_bool != 0) {
		irand(var_139_int, (int)3);
		var_165_bool = var_139_int == (int)0;
		if(var_165_bool != 0) {
			var_166_int = var_137_int;
			if(var_166_int == 0) goto Label_580;
			...
			if(var_170_bool != 0) {
				...
				var_175_bool = var_139_int == (int)1;
				if(var_175_bool != 0) {
					rand(var_142_float, (int)4);
					var_178_int = var_142_float + (int)1;
					Sleep(var_178_int, var_143_bool);
					var_179_bool = var_143_bool == 0; //@nz
					if(var_179_bool != 0) {
						goto Label_609;
					}
					goto Label_598;
				}
				var_180_int = var_138_int;
				if(var_180_int == 0) goto Label_598;
				goto Label_609;
		}
		Label_598:
			var_171_bool = 0;
...
{
	var_19_int = 0; var_20_bool = 0; var_21_int = 0; var_22_int = 0; var_23_bool = 0; var_24_int = 0;
	ClearSubContainer((int)0);
	func_1911((int)0);
	var_26_int = var_24_int;
	var_32_bool = var_18_bool;
	if(var_32_bool != 0) {
		var_33_string = ""; var_34_int = 0; var_35_int = 0; var_36_int = 0;
		func_1831("alpha_pills", (int)1, (int)2, (int)4);
		var_49_string = ""; var_50_int = 0; var_51_int = 0; var_52_int = 0;
		func_1831("meradorm", (int)2, (int)3, (int)3);
		var_54_bool = var_24_int >= (int)3;
		if(var_54_bool != 0) {
			var_55_string = ""; var_56_int = 0; var_57_int = 0;
			func_1820("beta_pills", (int)1, (int)4);
		}
		var_65_bool = var_24_int >= (int)8;
		if(var_65_bool != 0) {
			var_66_string = ""; var_67_int = 0; var_68_int = 0; var_69_int = 0;
			func_1831("monomicin", (int)1, (int)2, (int)2);
		} else {
			var_71_bool = var_24_int >= (int)4;
			if(var_71_bool == 0) goto Label_2359;
			var_72_string = ""; var_73_int = 0; var_74_int = 0;
			func_1820("monomicin", (int)1, (int)2);
	}
		var_75_string = ""; var_76_int = 0; var_77_int = 0;
		func_1820("lockpick", (int)1, (int)4);
		var_78_string = ""; var_79_int = 0; var_80_int = 0;
		func_1820("rifle_ammo", (int)1, (int)2);
		var_81_string = ""; var_82_int = 0; var_83_int = 0;
		func_1820("revolver_ammo", (int)1, (int)2);
		var_84_string = ""; var_85_int = 0; var_86_int = 0; var_87_int = 0;
		func_1831("samopal_ammo", (int)1, (int)2, (int)2);
		var_89_bool = var_24_int >= (int)8;
		if(var_89_bool != 0) {
			var_90_string = ""; var_91_int = 0; var_92_int = 0; var_93_int = 0;
			func_1831("monomicin", (int)1, (int)2, (int)2);
			goto Label_2405;
		}
		var_95_bool = var_24_int >= (int)4;
		if(var_95_bool == 0) goto Label_2405;
...
{
	var_103_float = 0; var_104_cvector = CVector(0,0,0); var_105_cvector = CVector(0,0,0); var_106_bool = 0; var_107_object = Obj(); var_108_bool = 0; var_109_float = 0; var_110_cvector = CVector(0,0,0); var_111_cvector = CVector(0,0,0); var_112_bool = 0; var_113_object = Obj(); var_114_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_109_float, (float)0.5);
	Sleep(var_109_float);
	
Label_284:
	var_116_bool = var_0_bool == 0; //@nz
	if(var_116_bool != 0) {
		var_117_bool = var_1_bool == 0; //@nz
		if(var_117_bool != 0) {
...
Label_304:
	var_122_object = Obj(); var_123_cvector = CVector(0,0,0);
...
func_1820(var_55_string, var_56_int, var_57_int)
{
	...
	if(var_60_bool != 0) {
		AddItem(var_59_bool, var_55_string, (int)0);
	}
	return 2;
}
...
func_1831(var_33_string, var_34_int, var_35_int, var_36_int)
{
	var_37_int = 0; var_38_bool = 0; var_39_int = 0; var_40_bool = 0;
	var_41_bool = 0; var_42_int = 0; var_43_int = 0;
	var_34_int = var_42_int;
	var_35_int = var_43_int;
	func_1862(var_41_bool, var_42_int, var_43_int);
	if(var_41_bool != 0) {
		irand(var_39_int, var_36_int);
		var_48_int = var_39_int + (int)1;
		AddItem(var_40_bool, var_33_string, (int)0, var_48_int);
	}
	return 4;
}
...
func_2434(var_21_bool, var_22_object, var_23_object)
{
...
func_2014(var_19_object)
{
	...
	if(var_20_bool != 0) {
		var_24_object = Obj();
		func_1846(var_24_object);
		ReportReputationChange(var_19_object, var_24_object, (float)-0.05000000074505806);
	}
	return 0;
}
