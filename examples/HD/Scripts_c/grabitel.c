...
void func_0(bool var_0_bool, bool var_92_bool, object var_93_object, object var_210_object)
{
	...
	func_2759(var_152_cvector, var_153_cvector, var_154_cvector, 2000.0);
...
void func_3091(string var_112_string)
{
...
void func_2129(bool var_616_bool, object var_617_object)
{
...
void func_3162(int var_81_int, string var_82_string)
{
	int var_84_int;
...
void func_2699(float var_29_float)
{
...
void func_2709(object var_109_object)
{
	bool var_111_bool;
...
void func_2729(bool var_627_bool)
{
	bool var_629_bool;
...
void func_2735(string var_73_string, int var_74_int)
{
...
void func_2759(cvector var_152_cvector, cvector var_153_cvector, cvector var_154_cvector, float var_155_float)
{
		...
		if(var_275_bool != 0) {
			...
			if(var_238_float >= (var_219_float * var_219_float)) {
				...
				if(var_397_bool != 0) {
					...
					bool var_678_bool;
					func_2201(var_678_bool, var_0_bool);
					if(!var_678_bool) { //@nz
						goto Label_415;
					}
					var_0_bool->GetPFPosition(var_232_cvector); //@t
...
void func_2819(bool var_19_bool, object var_20_object)
{
	float var_25_float;
...
// @pe
void func_2864(bool var_17_bool, object var_18_object)
{
	object var_20_object;
...
// @pe
void func_2871(object var_114_object)
{
	object var_116_object;
...
// @pe
void func_2888(bool var_17_bool, object var_18_object)
{
	object var_20_object;
	var_18_object = var_20_object;
	bool var_19_bool;
...
{
	func_2709(var_0_bool);
}


// @pe
void func_2895(object var_114_object)
{
	object var_116_object;
	var_114_object = var_116_object;
	TaskCall(7);
...
void func_2912(object var_20_object)
{
...
// @pe
void func_2925(object var_19_object)
{
	object var_20_object;
...
void func_2953(bool var_19_bool, object var_20_object, object var_21_object)
{
...
// @pe
void func_2986(object var_17_object)
{
	object var_19_object;
...
void func_3041(int var_106_int)
{
	int var_108_int;
...
// @pe
void func_3047(object var_20_object)
{
	int var_21_int;
...
void func_3060(int var_69_int, int var_70_int)
{
...
void func_506(bool var_0_bool, object var_1_object, bool var_498_bool, float var_499_float)
{
	...
	if(var_505_bool != 0) {
		...
		func_847(var_507_string);
		bool var_641_bool;
		func_2201(var_641_bool, var_0_bool);
		if(!var_641_bool) { //@nz
			@StopAsync();
			var_498_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_505_bool) { //@nz
				...
				func_847(var_507_string);
				bool var_667_bool;
				func_2201(var_667_bool, var_0_bool);
				if(!var_667_bool) { //@nz
					@StopAsync();
					var_498_bool = false;
					return 8;
