...
maintask task_0
{
	...
	void OnCollision(object actor, object var_1_object, cvector var_2_cvector, cvector var_3_cvector)
	{
		...
		for(;;) {
			...
			if(var_16_bool == 0) goto Label_81;
			...
			if(var_130_object != var_17_object) {
				var_132_object = GlobalVars[0];
				@ReportHit(var_17_object, var_132_object, 3, var_21_float, var_61_float);
			}
...
void func_259(bool var_76_bool, object var_77_object, string var_78_string)
{
...
// @pe
void func_355(float var_101_float, float var_102_float, float var_103_float)
{
...
// @pe
void func_230(string var_91_string, int var_92_int)
{
	if(var_92_int == 2) {
		var_91_string = "fire";
		return 0;
...
// @pe
void func_362(float var_111_float, float var_112_float, float var_113_float, float var_114_float)
{
...
void func_271(float var_59_float, object var_60_object, float var_61_float, int var_62_int)
{
	...
	float var_101_float;
	func_355(var_101_float, ((var_70_int + var_72_int) / 100.0), (float)1);
	float var_73_float;
	...
	float var_111_float;
	func_362(var_111_float, (var_74_float - var_75_float), (float)0, (float)1);
...
void func_244(cvector var_37_cvector)
{
...
void func_373(float var_121_float)
{
...
void func_254(bool var_117_bool, object var_118_object)
{
	bool var_120_bool;
...
void func_344(object var_0_object)
{
	object var_2_object;
	@self(var_2_object);
...
void func_249(cvector var_41_cvector, object var_42_object)
{
...
void func_350(float var_46_float, cvector var_47_cvector, cvector var_48_cvector)
{
