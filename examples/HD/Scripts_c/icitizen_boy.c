...
void func_5134(bool var_0_bool, object var_1_object, bool var_179_bool, object var_180_object, float var_181_float, float var_182_float, bool var_183_bool, bool var_184_bool)
{
	bool var_193_bool; object var_195_object; cvector var_196_cvector; cvector var_197_cvector; float var_199_float; object var_200_object;
	var_0_bool = false;
	...
	for(;;) {
		...
		var_199_float = (var_196_cvector - var_197_cvector) | (var_196_cvector - var_197_cvector);
		bool var_206_bool = false;
		if(var_182_float > 0) {
			if(var_199_float > (var_182_float * var_182_float))
				var_206_bool = true;
		}
		if(var_206_bool != 0) {
			@Stop();
		...
		if(var_199_float > (var_181_float * var_181_float)) {
			...
			if(var_195_object != null) {
				if(var_194_bool == 0) goto Label_5187;
				var_194_bool = false;
...
void func_4624(bool var_0_bool, float var_405_float, int var_406_int)
{
	object var_410_object; float var_411_float; float var_412_float;
	@GetVictim((var_405_float * 0.9), var_410_object);
	@ReportAttack(var_0_bool);
	if(var_410_object == var_0_bool) {
		float var_416_float; object var_417_object; int var_418_int;
		var_410_object = var_417_object;
		var_406_int = var_418_int;
		func_4354(var_418_int);
		var_416_float = var_411_float;
		float var_419_float; object var_420_object; float var_421_float; int var_422_int;
		var_410_object = var_420_object;
		int var_423_int; object var_424_object; int var_425_int;
		...
		@ReportHit(var_0_bool, var_484_int, var_412_float, var_421_float);
...
void func_4663(bool var_0_bool, object var_1_object, bool var_368_bool, float var_369_float)
{
	...
	@SetAttackState(true);
	func_5998();
	@PlayAnimation("all", ("attack_begin" + (var_374_int + 1)));
	@WaitForAnimEnd();
	int var_376_int;
	func_4970(var_376_int, var_377_string);
	bool var_402_bool;
	func_5445(var_402_bool, var_0_bool);
	if(!var_402_bool) { //@nz
		@StopAsync();
		var_368_bool = false;
		return 8;
	}
	float var_405_float; int var_406_int;
	var_369_float = var_405_float;
	var_374_int = var_406_int;
	func_4624(var_377_string, var_405_float, var_406_int);
	bool var_375_bool;
	@HasAnimation(var_375_bool, "all", ("attack_middle" + var_374_int));
	if(var_375_bool != 0) {
		func_5998();
		@PlayAnimation("all", ("attack_middle" + var_374_int));
		@WaitForAnimEnd();
		func_5002(var_377_string);
		bool var_494_bool;
		func_5445(var_494_bool, var_0_bool);
		if(!var_494_bool) { //@nz
			@StopAsync();
			var_368_bool = false;
			return 8;
		...
		for(;;) {
			var_377_string = (("attack_middle" + var_498_int) + "_") + var_376_int;
			...
			if(!var_375_bool) { //@nz
				...
				func_5002(var_377_string);
				bool var_520_bool;
				func_5445(var_520_bool, var_0_bool);
				if(!var_520_bool) { //@nz
					@StopAsync();
					var_368_bool = false;
					return 8;
		...
		@PlayAnimation("all", ("attack_end" + var_374_int));
		bool var_509_bool;
		func_5016(var_509_bool);
		if(var_509_bool != 0) {
			bool var_510_bool;
			func_4800(var_510_bool, 0.75);
			@StopAsync();
		}
		var_368_bool = true;
		return 8;
...
// @pe
void func_6749(int var_28_int, object var_29_object)
{
...
// @pe
void func_6759(object var_71_object)
{
	object var_72_object;
...
void func_5281(string var_219_string)
{
	var_219_string = "walk";
}


void func_5283(string var_220_string)
{
	var_220_string = "run";
}
...
// @pe
void func_5285(string var_447_string, int var_448_int)
{
	if(var_448_int == 2) {
		var_447_string = "fire";
		return 0;
...
void func_4800(bool var_510_bool, float var_511_float)
{
...
void func_5331(float var_419_float, object var_420_object, float var_421_float, int var_422_int)
{
	int var_432_int; int var_434_int;
	...
	if(!var_442_bool) //@nz
		...
		var_443_object->GetProperty("armor", var_432_int);
	string var_447_string; int var_448_int;
	var_422_int = var_448_int;
	func_5285(var_447_string, var_448_int);
	string var_433_string = "armor_" + var_447_string;
	bool var_453_bool; object var_454_object; string var_455_string;
	var_420_object = var_454_object;
	func_5319(var_453_bool, var_454_object, var_455_string);
	if(!var_453_bool) //@nz
		var_434_int = 0;
	else
		var_420_object->GetProperty(var_455_string, var_434_int);

	float var_457_float;
	func_5891(var_457_float, ((var_432_int + var_434_int) / 100.0), (float)1);
	float var_435_float;
	var_457_float = var_435_float;
	float var_436_float;
	var_420_object->GetProperty("health", var_436_float);
	float var_437_float = var_421_float * (1 - var_435_float);
	float var_467_float;
	func_5898(var_467_float, (var_436_float - var_437_float), (float)0, (float)1);
	...
	if(var_473_bool != 0) {
		float var_475_float = -var_437_float;
...
void func_4827(bool var_0_bool, bool var_307_bool, float var_308_float)
{
	bool var_314_bool; cvector var_315_cvector; cvector var_316_cvector; cvector var_317_cvector; float var_318_float;
	...
	for(;;) {
		...
		bool var_363_bool;
		func_5445(var_363_bool, var_0_bool);
		if(!var_363_bool) { //@nz
			var_307_bool = false;
			return 10;
		}
		...
		if(var_318_float < (var_308_float * var_308_float)) {
...
// @pe
void func_6887(object var_30_object)
{
	object var_31_object;
	func_6975(var_31_object, var_31_object);
}
...
void func_6894(int var_22_int, object var_23_object)
{
...
// @pe
void func_4346(object var_72_object)
{
	object var_79_object;
	func_4360(var_75_int, var_76_bool, var_77_float, var_78_int, var_79_object, var_79_object, true, 180.0);
}


// @pe
void func_6910(object var_70_object)
{
	object var_71_object;
...
// @pe
void func_4354(float var_416_float)
{
	var_416_float = 0.03;
}
...
// @pe
void func_5891(float var_457_float, float var_458_float, float var_459_float)
{
...
// @pe
void func_6916(int var_129_int)
{
	var_129_int = 0;
}
...
// @pe
void func_4357(int var_423_int)
{
	var_423_int = 0;
}


void func_4870(bool var_0_bool, bool var_322_bool)
{
	cvector var_328_cvector; cvector var_329_cvector;
	bool var_333_bool;
	func_5445(var_333_bool, var_0_bool);
	if(!var_333_bool) { //@nz
		var_322_bool = false;
		return 10;
	}
	...
	if(var_336_bool != 0) {
		var_0_bool->GetPFPosition(var_328_cvector); //@t
		@GetPFPosition(var_329_cvector);
		var_0_bool->GetAttackDistance(var_332_float); //@t
		var_322_bool = ((var_328_cvector - var_329_cvector) | (var_328_cvector - var_329_cvector)) <= ((var_332_float + 50) * (var_332_float + 50));
		return 10;
	}
	var_322_bool = false;
}
...
void func_4360(bool var_0_bool, object var_3_object, bool var_5_bool, object var_79_object, bool var_80_bool, float var_81_float, bool var_156_bool, bool var_248_bool)
{
	float var_93_float; cvector var_94_cvector; cvector var_95_cvector; bool var_97_bool; float var_100_float; cvector var_101_cvector; bool var_102_bool; float var_103_float;
	func_4589(var_101_cvector, var_102_bool, var_103_float);
	var_5_bool = 0;
	var_128_bool = IsFuncExist(var_79_object, "@GetAttackDistance", 1);
	if(var_128_bool != 0) {
...
Label_4400:
	for(;;) {
		...
		bool var_140_bool;
		func_5445(var_140_bool, var_0_bool);
		if(var_140_bool != 0) {
			if(!var_3_object) //@nz
				var_139_bool = true;
		}
		if(var_139_bool != 0) {
			...
			var_100_float = (var_94_cvector - var_95_cvector) | (var_94_cvector - var_95_cvector);
			if(var_100_float >= ((400.0 + var_93_float) * (400.0 + var_93_float))) {
				bool var_150_bool; float var_152_float;
				var_93_float = var_152_float;
				TaskCall(8);
				func_5029(var_158_bool, var_150_bool, var_0_bool, var_152_float, 3000.0, true, false);
				TaskReturn();
				if(!var_156_bool) { //@nz
				} else {
					var_97_bool = false;
			} else {
			if(var_100_float >= (var_81_float * var_81_float)) {
				var_0_bool->GetPFPosition(var_101_cvector); //@t
				@CanReachByPF(var_102_bool, var_101_cvector);
				if(!var_102_bool) { //@nz
					bool var_242_bool; float var_244_float;
					var_93_float = var_244_float;
					TaskCall(8);
					func_5029(var_250_bool, var_242_bool, var_0_bool, var_244_float, 3000.0, true, false);
					TaskReturn();
					if(!var_248_bool) { //@nz
						goto Label_4572;
					}
				...
				if(!var_97_bool) { //@nz
					...
					var_97_bool = true;
					bool var_264_bool;
					func_5445(var_264_bool, var_0_bool);
					if(!var_264_bool) { //@nz
						goto Label_4572;
					}
				}
				@rand(var_103_float);
				bool var_267_bool;
				var_269_bool = var_103_float < 0.25;
				if(var_269_bool != 1) {
					bool var_270_bool;
					func_4959(true, var_270_bool);
					if(var_270_bool != 1)
						var_267_bool = false;
				}
				if(var_267_bool != 0) {
					...
					bool var_307_bool; float var_308_float;
					...
					bool var_531_bool;
					func_5445(var_531_bool, var_0_bool);
					if(!var_531_bool) { //@nz
						goto Label_4572;
					}
					var_0_bool->GetPFPosition(var_94_cvector); //@t
					@GetPFPosition(var_95_cvector);
					if(!(((var_94_cvector - var_95_cvector) | (var_94_cvector - var_95_cvector)) < (var_308_float * var_308_float))) goto Label_4562;
...
// @pe
void func_6921(bool var_25_bool)
{
	var_25_bool = false;
}
...
// @pe
void func_5898(float var_467_float, float var_468_float, float var_469_float, float var_470_float)
{
	if(var_468_float < var_469_float) {
		var_469_float = var_467_float;
		return 0;
	}
	if(var_468_float > var_470_float) {
...
void func_6926(bool var_32_bool, object var_33_object)
{
	bool var_35_bool;
...
// @pe
void func_6941(object var_60_object)
{
...
void func_4898(bool var_320_bool)
{
...
// @pe
void func_6947(bool var_49_bool)
{
	var_49_bool = false;
}
...
// @pe
void func_6952(bool var_27_bool)
{
	var_27_bool = false;
}
...
void func_6957(int var_104_int)
{
	var_104_int = 515558;
}
...
void func_6959(int var_103_int)
{
	var_103_int = 503343;
}


void func_6961(string var_105_string)
{
	var_105_string = "ui/NPC_Citizen3.png";
}


void func_4914(bool var_0_bool, string var_4_string, bool var_339_bool)
{
	object var_345_object; float var_347_float; cvector var_348_cvector; cvector var_349_cvector;
	@GetScene(var_345_object);
	bool var_346_bool = false;
	
	for(;;) {
		cvector var_350_cvector;
		func_5299(var_350_cvector, var_0_bool);
		var_356_int = -var_350_cvector;
		@FindDirLength(var_347_float, var_356_int, var_4_string);
		if(var_347_float < var_4_string) {
		} else {
				@Face(var_0_bool);
				@PlayAnimation("all", "bjump");
				var_0_bool->GetPFPosition(var_348_cvector); //@t
				...
				if(var_362_bool == 0) goto Label_4955;
		}
		for(;;) {
...
void func_6963(string var_106_string)
{
	var_106_string = "ui/NPC_Citizen3_b.png";
}


void func_6965(bool var_98_bool)
{
	var_98_bool = false;
}
...
void func_6975(object var_31_object, object var_46_object)
{
	bool var_33_bool;
...
void func_5955(float var_475_float)
{
	...
	if(var_475_float < 0)
		@RumblePlay(0.7, 500);
	@SendWorldWndMessage(15, var_477_object);
}
EMIT "Stack[-1] = 0";
...
void func_4959(bool var_0_bool, bool var_270_bool)
{
	bool var_272_bool;
	var_275_bool = IsFuncExist(var_0_bool, "IsAttacking", 1);
	if(var_275_bool != 0) {
		var_0_bool->IsAttacking(var_272_bool); //@t
...
void func_7015(bool var_64_bool)
{
	var_64_bool = false;
}
...
// @pe
void func_7017(bool var_24_bool, object var_25_object, object var_26_object, bool var_27_bool)
{
	object var_29_object;
	...
	bool var_28_bool;
	func_6855(var_28_bool, var_29_object, var_30_object, 500.0, var_32_bool);
...
void func_4970(object var_2_object, bool var_5_bool)
{
	...
	if(var_389_float < var_396_float) {
		@irand(var_390_int, var_2_object);
		@Speak("attack" + (var_390_int + 1));
		int var_401_int;
...
// @pe
void func_7027(object var_102_object)
{
...
void func_5007(int var_484_int)
{
	var_484_int = 0;
}
...
void func_5016(bool var_509_bool)
{
	var_509_bool = true;
}


void func_5018(int var_401_int)
{
	var_401_int = 1;
}


void func_5020(float var_396_float)
{
	var_396_float = 0.5;
}
...
void func_5029(object var_2_object, bool var_150_bool, object var_151_object, float var_152_float, float var_153_float, bool var_154_bool, bool var_155_bool)
{
	object var_163_object;
	func_5989(var_163_object);
	@SetTimer(1, 5);
	bool var_161_bool;
	@CanSee(var_161_bool, var_163_object);
	if(var_161_bool != 0) {
		var_2_object = true;
	...
	if(var_174_bool != 0) {
		...
		@SendPlayerEnemy(var_175_object, var_178_object);
	}
	bool var_179_bool; object var_180_object; float var_181_float; float var_182_float; bool var_183_bool; bool var_184_bool;
...
{
	bool var_107_bool; bool var_108_bool; cvector var_109_cvector;
	var_1_object = 0;
	
	for(;;) {
		@HasAnimation(var_107_bool, "all", ("attack_begin" + (var_1_object + 1)));
		if(!var_107_bool) { //@nz
		} else {
			var_1_object += 1;
		}
		...
		for(;;) {
			@IsExisting3DSound(var_108_bool, ("attack" + (var_2_object + 1)));
			if(!var_108_bool) //@nz
				break;
			var_2_object += 1;
		}
