...
// @PE: 0x0,0x1a,0x72,0x2e6,0x2fc,0xce0,0xcfd,0xd5c,0xd76,0xd78,0xd7a,0xe15,0xe23,0xe36,0xe3c,0xe48,0xe5f,0xed0,0xf6e,0xf7c,0xf83,0x10a0,0x10b9,0x10e5,0x10ec,0x10fa,0x1102,0x1105,0x1396,0x139e,0x13d6,0x13f1,0x1400,0x1474,0x1486,0x1491,0x149a,0x14a5,0x1642,0x167a,0x1703,0x170a,0x171a,0x1723,0x172d,0x1779,0x177e,0x178a,0x1796,0x17a0,0x17aa,0x17b4,0x17be,0x17c8,0x17d2,0x17dc,0x17e6,0x17f0,0x17fa,0x1804,0x180e,0x1818,0x1822,0x1829,0x1830,0x1837,0x183e,0x1845,0x184c,0x1853,0x185a,0x1861,0x1868,0x186f,0x1876,0x188b,0x18ad,0x1987,0x199c,0x19a2,0x19aa,0x19b4,0x19d4,0x1a04,0x1a0a,0x1a4c,0x1a55,0x1a5d,0x1a67,0x1aba,0x1ac1,0x1ae4,0x1ae7,0x1afe,0x1b04,0x1b07,0x1b09,0x1b0c,0x1b1d,0x1b23,0x1b26,0x1b28,0x1b2b,0x1b69,0x1b73
...
task_4_event_40(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	var_22_int = var_21_int;
	var_65_bool = var_21_int > (int)0;
	if(var_65_bool != 0) {
		var_67_bool = var_21_int > (int)1;
		if(var_67_bool != 0) {
			func_3663(var_21_int);
		}
		var_69_object = Obj();
		var_19_bool = var_69_object;
		func_6910(var_69_object);
	}
	return 2;
}
...
task_5_event_40(var_0_bool, var_1_object, var_2_object, var_3_object, var_4_string, var_5_bool, var_6_bool, var_7_bool, var_8_bool, var_9_object, var_10_object, var_11_object, var_12_int, var_13_int, var_14_bool, var_15_float, var_16_int, var_17_bool, var_18_object, var_19_bool)
{
	...
	if(var_65_bool != 0) {
		...
		var_68_object = Obj();
		var_19_bool = var_68_object;
		func_6910(var_68_object);
	}
	return 2;
}
...
Label_5138:
	...
	var_211_float = var_181_float * var_181_float;
	var_212_bool = var_199_float > var_211_float;
	if(var_212_bool != 0) {
		@@var_180_object:GetPFPosition(var_196_cvector);
		FindPathTo(var_200_object, var_196_cvector);
		var_213_bool = var_200_object != 0; //@nn
		if(var_213_bool != 0) {
			var_200_object = var_195_object;
			var_200_object = 0;
		}
		var_214_bool = var_195_object != 0; //@nn
		if(var_214_bool != 0) {
			var_215_bool = var_194_bool;
			if(var_215_bool == 0) goto Label_5187;
			var_194_bool = 0;
			RotatePath(var_195_object, var_193_bool);
			var_216_bool = var_193_bool == 0; //@nz
			if(var_216_bool != 0) {
			} else {
				...
				FollowPath(var_195_object, var_183_bool, var_193_bool, var_219_string, var_220_string);
				var_221_bool = var_193_bool == 0; //@nz
				if(var_221_bool != 0) {
					...
					KillTimer((int)0);
					Sleep((float)0.5, var_193_bool);
					var_225_bool = var_193_bool == 0; //@nz
					if(var_225_bool != 0) {
...
{
	var_407_object = Obj(); var_408_float = 0; var_409_float = 0; var_410_object = Obj(); var_411_float = 0; var_412_float = 0;
	var_414_float = var_405_float * (float)0.8999999761581421;
	GetVictim(var_414_float, var_410_object);
	ReportAttack(var_0_bool);
	var_415_bool = var_410_object == var_0_bool;
	if(var_415_bool != 0) {
		var_416_float = 0; var_417_object = Obj(); var_418_int = 0;
		var_410_object = var_417_object;
		var_406_int = var_418_int;
		func_4354(var_418_int);
		var_416_float = var_411_float;
		var_419_float = 0; var_420_object = Obj(); var_421_float = 0; var_422_int = 0;
		var_410_object = var_420_object;
		var_411_float = var_421_float;
		var_423_int = 0; var_424_object = Obj(); var_425_int = 0;
		var_410_object = var_424_object;
		var_406_int = var_425_int;
		func_4357(var_425_int);
		var_423_int = var_422_int;
		func_5331(var_419_float, var_420_object, var_421_float, var_422_int);
		var_419_float = var_412_float;
		var_484_int = 0;
		func_5007(var_484_int);
		ReportHit(var_0_bool, var_484_int, var_412_float, var_411_float);
		var_485_object = Obj(); var_486_float = 0;
		var_410_object = var_485_object;
		var_412_float = var_486_float;
		func_5014();
	}
	return 6;
}
...
func_4663(var_0_bool, var_1_object, var_368_bool, var_369_float)
{
	var_370_int = 0; var_371_bool = 0; var_372_int = 0; var_373_string = ""; var_374_int = 0; var_375_bool = 0; var_376_int = 0; var_377_string = "";
	func_5002(var_377_string);
	irand(var_374_int, var_1_object);
	var_374_int = var_374_int + (int)1;
	Face(var_0_bool);
	SetAttackState((bool)1);
	func_5998();
	var_386_int = "attack_begin" + var_374_int;
	PlayAnimation("all", var_386_int);
	WaitForAnimEnd();
	func_4970(var_376_int, var_377_string);
	var_402_bool = 0; var_403_object = Obj();
	var_403_object = var_0_bool;
	func_5445(var_402_bool, var_403_object);
	...
	var_405_float = 0; var_406_int = 0;
	var_369_float = var_405_float;
	var_374_int = var_406_int;
	func_4624(var_377_string, var_405_float, var_406_int);
	var_489_int = "attack_middle" + var_374_int;
	HasAnimation(var_375_bool, "all", var_489_int);
	var_490_bool = var_375_bool;
	if(var_490_bool != 0) {
		func_5998();
		var_493_int = "attack_middle" + var_374_int;
		PlayAnimation("all", var_493_int);
		WaitForAnimEnd();
		func_5002(var_377_string);
		var_494_bool = 0; var_495_object = Obj();
		var_495_object = var_0_bool;
		func_5445(var_494_bool, var_495_object);
		...
		var_369_float = var_497_float;
		var_374_int = var_498_int;
		func_4624(var_377_string, var_497_float, var_498_int);
		var_376_int = 1;

	Label_4740:
		var_500_int = "attack_middle" + var_374_int;
		var_502_int = var_500_int + "_";
		var_377_string = var_502_int + var_376_int;
		HasAnimation(var_375_bool, "all", var_377_string);
		var_504_bool = var_375_bool == 0; //@nz
		if(var_504_bool != 0) {
		} else {
			func_5998();
			PlayAnimation("all", var_377_string);
			WaitForAnimEnd();
			func_5002(var_377_string);
			var_520_bool = 0; var_521_object = Obj();
			var_521_object = var_0_bool;
			func_5445(var_520_bool, var_521_object);
			var_522_bool = var_520_bool == 0; //@nz
			if(var_522_bool != 0) {
				StopAsync();
				var_368_bool = 0;
				var_523_float = 0; var_524_int = 0;
				var_369_float = var_523_float;
				var_374_int = var_524_int;
				func_4624(var_377_string, var_523_float, var_524_int);
	...
	var_508_int = "attack_end" + var_374_int;
	PlayAnimation("all", var_508_int);
	var_509_bool = 0;
	func_5016(var_509_bool);
	if(var_509_bool != 0) {
		var_510_bool = 0; var_511_float = 0;
		func_4800(var_510_bool, (float)0.75);
		StopAsync();
	}
	var_368_bool = 1;
	return 8;
...
func_6749(var_28_int, var_29_object)
{
	...
	func_5445(var_30_bool, var_31_object);
	if(var_30_bool != 0) {
		var_28_int = 2;
	} else {
		var_28_int = 0;
...
{
	var_450_bool = var_448_int == (int)2;
	if(var_450_bool != 0) {
		var_447_string = "fire";
		return 0;
	EMIT "GOTO 0x14b1";
	}
	var_452_bool = var_448_int == (int)1;
	if(var_452_bool != 0) {
		var_447_string = "bullet";
		return 0;
	}
	var_447_string = "phys";
	return 0;
...
{
	var_512_float = 0; var_513_bool = 0; var_514_float = 0; var_515_bool = 0;
	rand(var_514_float);
	var_516_bool = var_514_float < var_511_float;
	if(var_516_bool != 0) {
...
func_5331(var_419_float, var_420_object, var_421_float, var_422_int)
{
	var_426_int = 0; var_427_string = ""; var_428_int = 0; var_429_float = 0; var_430_float = 0; var_431_float = 0; var_432_int = 0; var_433_string = ""; var_434_int = 0; var_435_float = 0; var_436_float = 0; var_437_float = 0;
	var_438_bool = 0; var_439_object = Obj(); var_440_string = "";
	var_420_object = var_439_object;
	func_5319(var_438_bool, var_439_object, "health");
	...
	func_5319(var_442_bool, var_443_object, "armor");
	var_445_bool = var_442_bool == 0; //@nz
	if(var_445_bool != 0) {
		var_432_int = 0;
	} else {
			@@var_420_object:GetProperty("armor", var_432_int);
	}
	var_447_string = ""; var_448_int = 0;
	var_422_int = var_448_int;
	func_5285(var_447_string, var_448_int);
	var_433_string = "armor_" + var_447_string;
	var_453_bool = 0; var_454_object = Obj(); var_455_string = "";
	var_420_object = var_454_object;
	var_433_string = var_455_string;
	func_5319(var_453_bool, var_454_object, var_455_string);
	var_456_bool = var_453_bool == 0; //@nz
	if(var_456_bool != 0) {
		var_434_int = 0;
	} else {
		@@var_420_object:GetProperty(var_433_string, var_434_int);

	}
	var_457_float = 0; var_458_float = 0; var_459_float = 0;
	var_460_int = var_432_int + var_434_int;
	var_458_float = var_460_int / (float)100.0;
	func_5891(var_457_float, var_458_float, (float)1);
	var_457_float = var_435_float;
	@@var_420_object:GetProperty("health", var_436_float);
	var_465_int = (int)1 - var_435_float;
	var_437_float = var_421_float * var_465_int;
	var_467_float = 0; var_468_float = 0; var_469_float = 0; var_470_float = 0;
	var_468_float = var_436_float - var_437_float;
	func_5898(var_467_float, var_468_float, (float)0, (float)1);
	@@var_420_object:SetProperty("health", var_467_float);
	var_473_bool = 0; var_474_object = Obj();
	var_420_object = var_474_object;
	func_5314(var_473_bool, var_474_object);
	if(var_473_bool != 0) {
		var_475_float = 0;
		var_475_float = -var_437_float;
		func_5955(var_475_float);
	}
	var_437_float = var_419_float;
	return 12;
...
{
	var_309_bool = 0; var_310_cvector = CVector(0,0,0); var_311_cvector = CVector(0,0,0); var_312_cvector = CVector(0,0,0); var_313_float = 0; var_314_bool = 0; var_315_cvector = CVector(0,0,0); var_316_cvector = CVector(0,0,0); var_317_cvector = CVector(0,0,0); var_318_float = 0;
	
Label_4828:
	IsAnimationPlaying(var_314_bool);
	var_319_bool = var_314_bool == 0; //@nz
	if(var_319_bool != 0) {
	} else {
		var_320_bool = 0;
		...
		func_5445(var_363_bool, var_364_object);
		...
		var_366_float = var_308_float * var_308_float;
		var_367_bool = var_318_float < var_366_float;
		if(var_367_bool != 0) {
			var_368_bool = 0; var_369_float = 0;
			var_308_float = var_369_float;
			func_4663(var_317_cvector, var_318_float, var_368_bool, var_369_float);
			var_307_bool = 1;
			sync();
			goto Label_4828;
		}
...
func_6887(var_30_object)
{
	...
	func_6975(var_30_object, var_31_object);
	return 0;
}
...
func_4346(var_72_object)
{
	var_79_object = Obj(); var_80_bool = 0; var_81_float = 0;
	var_72_object = var_79_object;
	func_4360(var_75_int, var_76_bool, var_77_float, var_78_int, var_72_object, var_79_object, (bool)1, (float)180.0);
	return 0;
}
...
{
	var_416_float = 0.029999999329447746;
	return 0;
}
...
{
	var_462_bool = var_458_float < var_459_float;
	if(var_462_bool != 0) {
...
{
	var_323_cvector = CVector(0,0,0); var_324_cvector = CVector(0,0,0); var_325_cvector = CVector(0,0,0); var_326_float = 0; var_327_float = 0; var_328_cvector = CVector(0,0,0); var_329_cvector = CVector(0,0,0); var_330_cvector = CVector(0,0,0); var_331_float = 0; var_332_float = 0;
	var_333_bool = 0; var_334_object = Obj();
	var_334_object = var_0_bool;
	func_5445(var_333_bool, var_334_object);
	...
	var_336_bool = 0;
	func_4959(var_332_float, var_336_bool);
	if(var_336_bool != 0) {
		@@@var_0_bool:GetPFPosition(var_328_cvector);
		GetPFPosition(var_329_cvector);
		var_330_cvector = var_328_cvector - var_329_cvector;
		var_331_float = var_330_cvector | var_330_cvector;
		@@@var_0_bool:GetAttackDistance(var_332_float);
		var_332_float = var_332_float + (int)50;
		var_338_float = var_332_float * var_332_float;
		var_322_bool = var_331_float <= var_338_float;
		return 10;
	}
	var_322_bool = 0;
	return 10;
...
{
	var_82_float = 0; var_83_cvector = CVector(0,0,0); var_84_cvector = CVector(0,0,0); var_85_bool = 0; var_86_bool = 0; var_87_float = 0; var_88_cvector = CVector(0,0,0); var_89_float = 0; var_90_cvector = CVector(0,0,0); var_91_bool = 0; var_92_float = 0; var_93_float = 0; var_94_cvector = CVector(0,0,0); var_95_cvector = CVector(0,0,0); var_96_bool = 0; var_97_bool = 0; var_98_float = 0; var_99_cvector = CVector(0,0,0); var_100_float = 0; var_101_cvector = CVector(0,0,0); var_102_bool = 0; var_103_float = 0;
	func_4589(var_101_cvector, var_102_bool, var_103_float);
	var_5_bool = 0;
	var_128_bool = IsFuncExist(var_79_object, "@GetAttackDistance", (int)1);
	if(var_128_bool != 0) {
		@@var_79_object:GetAttackDistance(var_93_float);
		var_93_float = var_93_float + (int)50;
	} else {
							var_81_float = var_93_float;
	}
	var_131_bool = var_93_float >= (int)150;
	if(var_131_bool != 0) {
		var_93_float = 150;
	}
	var_3_object = false;
	var_0_bool = var_79_object;
	IsPlayerActor(var_0_bool, var_96_bool);
	var_132_bool = var_96_bool;
	if(var_132_bool != 0) {
		PlayGlobalMusic("attack");
		var_134_object = Obj();
		func_5875(var_134_object);
		SendPlayerEnemy(var_79_object, var_134_object);
	}
	var_137_bool = var_80_bool;
	if(var_137_bool != 0) {
		var_97_bool = 0;
	} else {
						var_97_bool = 1;
	...
	var_98_float = (float)400.0 + var_93_float;
...
Label_4400:
	...
	func_5445(var_140_bool, var_141_object);
	if(var_140_bool != 0) {
		var_142_bool = var_3_object == 0; //@nz
		if(var_142_bool != 0) {
			var_139_bool = 1;
		}
	}
	if(var_139_bool != 0) {
		func_5002(var_103_float);
		@@@var_0_bool:GetPFPosition(var_94_cvector);
		GetPFPosition(var_95_cvector);
		var_99_cvector = var_94_cvector - var_95_cvector;
		var_100_float = var_99_cvector | var_99_cvector;
		var_148_float = var_98_float * var_98_float;
		var_149_bool = var_100_float >= var_148_float;
		if(var_149_bool != 0) {
			var_150_bool = 0; var_151_object = Obj(); var_152_float = 0; var_153_float = 0; var_154_bool = 0; var_155_bool = 0;
			var_151_object = var_0_bool;
			var_93_float = var_152_float;
			TaskCall(8);
			func_5029(var_158_bool, var_150_bool, var_151_object, var_152_float, (float)3000.0, (bool)1, (bool)0);
			TaskReturn();
			var_233_bool = var_156_bool == 0; //@nz
			if(var_233_bool != 0) {
			} else {
				var_97_bool = 0;
		} else {
				var_239_float = var_81_float * var_81_float;
				var_240_bool = var_100_float >= var_239_float;
				if(var_240_bool != 0) {
					@@@var_0_bool:GetPFPosition(var_101_cvector);
					CanReachByPF(var_102_bool, var_101_cvector);
					var_241_bool = var_102_bool == 0; //@nz
					if(var_241_bool != 0) {
						var_242_bool = 0; var_243_object = Obj(); var_244_float = 0; var_245_float = 0; var_246_bool = 0; var_247_bool = 0;
						var_243_object = var_0_bool;
						var_93_float = var_244_float;
						TaskCall(8);
						func_5029(var_250_bool, var_242_bool, var_243_object, var_244_float, (float)3000.0, (bool)1, (bool)0);
						TaskReturn();
						var_251_bool = var_248_bool == 0; //@nz
						if(var_251_bool != 0) {
							goto Label_4572;
						}
						var_97_bool = 0;
					...
					var_252_bool = var_97_bool == 0; //@nz
					if(var_252_bool != 0) {
						var_253_object = Obj();
						var_253_object = var_0_bool;
						func_5595(var_253_object);
						...
						func_5445(var_264_bool, var_265_object);
					...
					rand(var_103_float);
					var_267_bool = 0;
					var_269_bool = var_103_float < (float)0.25;
					if(var_269_bool != 1) {
						var_270_bool = 0;
						func_4959((bool)1, var_270_bool);
						if(var_270_bool != 1) {
							var_267_bool = 0;
						}
					}
					if(var_267_bool != 0) {
						...
						var_307_bool = 0; var_308_float = 0;
						var_81_float = var_308_float;
						func_4827(var_103_float, var_307_bool, var_308_float);
						StopAsync();
					} else {
						Face(var_0_bool);
						...
						StopAsync();
						var_529_bool = 0;
						func_4959(var_103_float, var_529_bool);
						var_530_bool = var_529_bool == 0; //@nz
						if(var_530_bool == 0) goto Label_4562;
						var_531_bool = 0; var_532_object = Obj();
						var_532_object = var_0_bool;
						func_5445(var_531_bool, var_532_object);
						...
						var_99_cvector = var_94_cvector - var_95_cvector;
						var_100_float = var_99_cvector | var_99_cvector;
						var_534_float = var_81_float * var_81_float;
						var_535_bool = var_100_float < var_534_float;
						if(var_535_bool == 0) goto Label_4562;
						var_536_bool = 0; var_537_float = 0;
						var_81_float = var_537_float;
						func_4663(var_102_bool, var_103_float, var_536_bool, var_537_float);
						var_538_bool = var_536_bool == 0; //@nz
						if(var_538_bool == 0) goto Label_4562;
						goto Label_4572;
				}
					var_539_bool = 0; var_540_float = 0;
					var_81_float = var_540_float;
					func_4663(var_102_bool, var_103_float, var_539_bool, var_540_float);
...
Label_4572:
	WaitForAnimEnd();
	var_234_object = var_3_object;
	if(var_234_object != 0) {
		return 22;
	}
	PlayAnimation("all", "attack_off");
	WaitForAnimEnd();
	var_237_bool = var_96_bool;
	if(var_237_bool != 0) {
		Sleep((float)2.0);
	}
	return 22;
...
{
	var_471_bool = var_468_float < var_469_float;
	if(var_471_bool != 0) {
		var_469_float = var_467_float;
		return 0;
	}
	var_472_bool = var_468_float > var_470_float;
	if(var_472_bool != 0) {
		var_470_float = var_467_float;
		return 0;
	}
	var_468_float = var_467_float;
	return 0;
}
...
func_4898(var_320_bool)
{
	...
	var_321_bool = 0;
	var_322_bool = 0;
	func_4870(var_321_bool, var_322_bool);
	if(var_322_bool != 0) {
		var_339_bool = 0;
		func_4914(var_320_bool, var_321_bool, var_339_bool);
		if(var_339_bool != 0) {
			var_321_bool = 1;
		}
	}
...
{
	var_340_object = Obj(); var_341_bool = 0; var_342_float = 0; var_343_cvector = CVector(0,0,0); var_344_cvector = CVector(0,0,0); var_345_object = Obj(); var_346_bool = 0; var_347_float = 0; var_348_cvector = CVector(0,0,0); var_349_cvector = CVector(0,0,0);
	GetScene(var_345_object);
	var_346_bool = 0;
	
Label_4918:
	var_350_cvector = CVector(0,0,0); var_351_object = Obj();
	var_351_object = var_0_bool;
	func_5299(var_350_cvector, var_351_object);
	var_356_int = -var_350_cvector;
	FindDirLength(var_347_float, var_356_int, var_4_string);
	var_357_bool = var_347_float < var_4_string;
	if(var_357_bool != 0) {
	} else {
		Face(var_0_bool);
		PlayAnimation("all", "bjump");
		@@@var_0_bool:GetPFPosition(var_348_cvector);
		GetPFPosition(var_349_cvector);
		WaitForAnimEnd();
		func_5002(var_349_cvector);
		StopAsync();
		SetSpeed(CVector(0.0, 0.0, 0.0));
		var_346_bool = 1;
		var_361_bool = 0;
		func_4870(var_349_cvector, var_361_bool);
...
func_5955(var_475_float)
{
	...
	CreateFloatVector(var_477_object);
	@@var_477_object:add(var_475_float);
	var_479_bool = var_475_float < (int)0;
	if(var_479_bool != 0) {
		RumblePlay((float)0.699999988079071, (int)500);
	}
	SendWorldWndMessage((int)15, var_477_object);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_4959(var_0_bool, var_270_bool)
{
	...
	var_275_bool = IsFuncExist(var_0_bool, "IsAttacking", (int)1);
	if(var_275_bool != 0) {
		@@@var_0_bool:IsAttacking(var_272_bool);
...
func_7017(var_24_bool, var_25_object, var_26_object, var_27_bool)
{
	...
	func_6855(var_28_bool, var_29_object, var_30_object, (float)500.0, var_32_bool);
...
{
	var_387_float = 0; var_388_int = 0; var_389_float = 0; var_390_int = 0;
	var_391_bool = var_2_object == 0; //@nz
	if(var_391_bool != 0) {
		return 4;
	}
	var_392_bool = var_5_bool;
	if(var_392_bool != 0) {
		var_5_bool = var_5_bool + (int)-1;
		var_395_bool = var_5_bool > (int)0;
		if(var_395_bool != 0) {
			return 4;
		}
	}
	...
	var_397_bool = var_389_float < var_396_float;
	if(var_397_bool != 0) {
		irand(var_390_int, var_2_object);
		var_390_int = var_390_int + (int)1;
		var_400_int = "attack" + var_390_int;
		Speak(var_400_int);
		var_401_int = 0;
		func_5018(var_401_int);
		var_5_bool = var_401_int;
	}
	return 4;
}
...
func_5998()
{
	...
	GetScene(var_381_object);
	var_383_object = Obj();
	func_5875(var_383_object);
	BroadcastMessage("battle", var_383_object, var_381_object);
	return 2;
}
EMIT "Stack[-1] = 0";
...
{
	var_143_object = Obj();
	var_143_object = var_0_bool;
	func_5989(var_143_object);
	return 0;
}
...
{
	var_159_bool = 0; var_160_bool = 0; var_161_bool = 0; var_162_bool = 0;
	var_163_object = Obj();
	var_151_object = var_163_object;
	func_5989(var_163_object);
	SetTimer((int)1, (int)5);
	CanSee(var_161_bool, var_151_object);
	var_166_bool = var_161_bool;
	if(var_166_bool != 0) {
		var_2_object = true;
		var_167_object = Obj();
		var_151_object = var_167_object;
		func_5790(var_167_object);
	} else {
		var_2_object = false;
	}
	var_174_bool = 0; var_175_object = Obj();
	var_151_object = var_175_object;
	func_5314(var_174_bool, var_175_object);
	if(var_174_bool != 0) {
		var_178_object = Obj();
		func_5875(var_178_object);
		SendPlayerEnemy(var_151_object, var_178_object);
	}
	...
	var_152_float = var_181_float;
	var_153_float = var_182_float;
	var_154_bool = var_183_bool;
	var_155_bool = var_184_bool;
	func_5134(var_161_bool, var_162_bool, var_179_bool, var_180_object, var_181_float, var_182_float, var_183_bool, var_184_bool);
	var_179_bool = var_162_bool;
	var_230_object = var_2_object;
	if(var_230_object != 0) {
		UnlookAsync("head");
	}
	KillTimer((int)1);
	var_162_bool = var_150_bool;
	return 4;
...
{
	var_104_bool = 0; var_105_bool = 0; var_106_cvector = CVector(0,0,0); var_107_bool = 0; var_108_bool = 0; var_109_cvector = CVector(0,0,0);
	var_1_object = 0;
	
Label_4591:
	var_113_int = var_1_object + (int)1;
	var_114_int = "attack_begin" + var_113_int;
	HasAnimation(var_107_bool, "all", var_114_int);
	var_115_bool = var_107_bool == 0; //@nz
	if(var_115_bool != 0) {
	} else {
...
Label_4605:
	var_118_int = var_2_object + (int)1;
	var_119_int = "attack" + var_118_int;
	IsExisting3DSound(var_108_bool, var_119_int);
	var_120_bool = var_108_bool == 0; //@nz
	if(var_120_bool != 0) {
	} else {
	...
	GetAnimationOffset(var_109_cvector, "all", "bjump");
	var_123_float = GetByIndex(var_109_cvector, 2);
	var_4_string = -var_123_float;
	return 6;
