		...
		if(1 != 0) {
			...
			if(var_22_int == 45665) {
				...
				if(var_67_bool != 0) {
					...
					bool var_94_bool;
					func_6236(var_94_bool, var_1_bool);
					if(var_94_bool != 1) {
						bool var_105_bool;
						func_6256(var_105_bool, var_1_bool);
						if(var_105_bool != 1)
							var_93_bool = false;
					}
					if(var_93_bool != 0)
					...
					bool var_117_bool;
					func_6166(var_117_bool, var_1_bool);
					if(var_117_bool != 1) {
						bool var_123_bool;
						func_6186(var_123_bool, var_1_bool);
						if(var_123_bool != 1)
							var_116_bool = false;
					}
					if(var_116_bool != 1) {
						bool var_129_bool;
						func_6206(var_129_bool, var_1_bool);
						if(var_129_bool != 1)
							var_115_bool = false;
					}
					if(var_115_bool != 1) {
						bool var_135_bool;
						func_6196(var_135_bool, var_1_bool);
						if(var_135_bool != 1)
							var_114_bool = false;
					}
					if(var_114_bool != 0)
					...
					bool var_144_bool;
					func_6176(var_144_bool, var_1_bool);
					if(var_144_bool != 0)
					...
					bool var_156_bool;
					func_6166(var_156_bool, var_1_bool);
					if(var_156_bool != 1) {
						bool var_158_bool;
						func_6176(var_158_bool, var_1_bool);
						if(var_158_bool != 1)
							var_155_bool = false;
					}
					if(var_155_bool != 1) {
						bool var_160_bool;
						func_6186(var_160_bool, var_1_bool);
						if(var_160_bool != 1)
							var_154_bool = false;
					}
					if(var_154_bool != 1) {
						bool var_162_bool;
						func_6196(var_162_bool, var_1_bool);
						if(var_162_bool != 1)
							var_153_bool = false;
					}
					if(var_153_bool != 0)
					...
					bool var_169_bool;
					func_6206(var_169_bool, var_1_bool);
					if(var_169_bool != 1) {
						bool var_171_bool;
						func_6216(var_171_bool, var_1_bool);
						if(var_171_bool != 1)
							var_168_bool = false;
					}
					if(var_168_bool != 1) {
						bool var_177_bool;
						func_6226(var_177_bool, var_1_bool);
						if(var_177_bool != 1)
							var_167_bool = false;
					}
					if(var_167_bool != 0)
					...
					bool var_190_bool;
					func_6236(var_190_bool, var_1_bool);
					if(var_190_bool != 1) {
						bool var_192_bool;
						func_6246(var_192_bool, var_1_bool);
						if(var_192_bool != 1)
							var_189_bool = false;
					}
					if(var_189_bool != 1) {
						bool var_198_bool;
						func_6256(var_198_bool, var_1_bool);
						if(var_198_bool != 1)
							var_188_bool = false;
					}
					if(var_188_bool != 1) {
						bool var_200_bool;
						func_6266(var_200_bool, var_1_bool);
						if(var_200_bool != 1)
							var_187_bool = false;
					}
					if(var_187_bool != 1) {
						bool var_206_bool;
						func_6276(var_206_bool, var_1_bool);
						if(var_206_bool != 1)
							var_186_bool = false;
					}
					if(var_186_bool != 0)
					...
					bool var_219_bool;
					func_6166(var_219_bool, var_1_bool);
					if(var_219_bool != 1) {
						bool var_221_bool;
						func_6176(var_221_bool, var_1_bool);
						if(var_221_bool != 1)
							var_218_bool = false;
					}
					if(var_218_bool != 1) {
						bool var_223_bool;
						func_6196(var_223_bool, var_1_bool);
						if(var_223_bool != 1)
							var_217_bool = false;
					}
					if(var_217_bool != 1) {
						bool var_225_bool;
						func_6206(var_225_bool, var_1_bool);
						if(var_225_bool != 1)
							var_216_bool = false;
					}
					if(var_216_bool != 1) {
						bool var_227_bool;
						func_6226(var_227_bool, var_1_bool);
						if(var_227_bool != 1)
							var_215_bool = false;
					}
					if(var_215_bool != 0)
					...
					bool var_238_bool;
					func_6186(var_238_bool, var_1_bool);
					if(var_238_bool != 1) {
						bool var_240_bool;
						func_6216(var_240_bool, var_1_bool);
						if(var_240_bool != 1)
							var_237_bool = false;
					}
					if(var_237_bool != 1) {
						bool var_242_bool;
						func_6246(var_242_bool, var_1_bool);
						if(var_242_bool != 1)
							var_236_bool = false;
					}
					if(var_236_bool != 1) {
						bool var_244_bool;
						func_6276(var_244_bool, var_1_bool);
						if(var_244_bool != 1)
							var_235_bool = false;
					}
					if(var_235_bool != 1) {
						bool var_246_bool;
						func_6176(var_246_bool, var_1_bool);
						if(var_246_bool != 1)
							var_234_bool = false;
					}
					if(var_234_bool != 1) {
						bool var_248_bool;
						func_6236(var_248_bool, var_1_bool);
						if(var_248_bool != 1)
							var_233_bool = false;
					}
					if(var_233_bool != 1) {
						bool var_250_bool;
						func_6256(var_250_bool, var_1_bool);
						if(var_250_bool != 1)
							var_232_bool = false;
					}
					if(var_232_bool != 0)
					...
					bool var_258_bool;
					func_6266(var_258_bool, var_1_bool);
					if(var_258_bool != 1) {
						bool var_260_bool;
						func_6246(var_260_bool, var_1_bool);
						if(var_260_bool != 1)
							var_257_bool = false;
					}
					if(var_257_bool != 1) {
						bool var_262_bool;
						func_6236(var_262_bool, var_1_bool);
						if(var_262_bool != 1)
							var_256_bool = false;
					}
					if(var_256_bool != 1) {
						bool var_264_bool;
						func_6226(var_264_bool, var_1_bool);
						if(var_264_bool != 1)
							var_255_bool = false;
					}
					if(var_255_bool != 0)
				...
				bool var_275_bool;
				func_6142(var_1_bool);
				if(var_275_bool != 0) {
					bool var_281_bool;
					func_6166(var_281_bool, var_1_bool);
					if(var_281_bool != 0)
						var_274_bool = true;
				}
				if(var_274_bool != 0)
				...
				bool var_286_bool;
				func_6166(var_286_bool, var_1_bool);
				if(var_286_bool != 0)
					var_0_bool->AddReply(537277, 39122, 39121); //@t
				bool var_291_bool;
				func_6176(var_291_bool, var_1_bool);
				if(var_291_bool != 0)
					var_0_bool->AddReply(537329, 39176, 39175); //@t
				bool var_296_bool = false;
				bool var_297_bool;
				func_6186(var_297_bool, var_1_bool);
				if(var_297_bool != 0) {
					bool var_299_bool;
					func_6286(var_299_bool, var_1_bool);
					if(var_299_bool != 0)
						var_296_bool = true;
				}
				if(var_296_bool != 0)
				...
				if(var_319_bool != 0) {
					bool var_321_bool;
					func_6186(var_321_bool, var_1_bool);
					if(var_321_bool != 0)
						var_318_bool = true;
				}
				if(var_318_bool != 0) {
					bool var_323_bool;
					func_6296(var_323_bool, var_1_bool);
					if(var_323_bool != 0)
						var_317_bool = true;
				}
				if(var_317_bool != 0)
				...
				bool var_334_bool;
				func_6196(var_334_bool, var_1_bool);
				if(var_334_bool != 0) {
					bool var_336_bool;
					func_6286(var_336_bool, var_1_bool);
					if(var_336_bool != 0)
						var_333_bool = true;
				}
				if(var_333_bool != 0)
				...
				bool var_342_bool;
				func_6196(var_342_bool, var_1_bool);
				if(var_342_bool != 0) {
					bool var_344_bool;
					func_6296(var_344_bool, var_1_bool);
					if(var_344_bool != 0)
						var_341_bool = true;
				}
				if(var_341_bool != 0)
				...
				bool var_349_bool;
				func_6206(var_349_bool, var_1_bool);
				if(var_349_bool != 0)
				...
				if(var_355_bool != 0) {
					bool var_357_bool;
					func_6216(var_357_bool, var_1_bool);
					if(var_357_bool != 0)
						var_354_bool = true;
				}
				if(var_354_bool != 0)
				...
				bool var_362_bool;
				func_6226(var_362_bool, var_1_bool);
				if(var_362_bool != 0)
				...
				if(var_368_bool != 0) {
					bool var_370_bool;
					func_6236(var_370_bool, var_1_bool);
					if(var_370_bool != 0)
						var_367_bool = true;
				}
				if(var_367_bool != 0)
				...
				if(var_376_bool != 0) {
					bool var_378_bool;
					func_6246(var_378_bool, var_1_bool);
					if(var_378_bool != 0)
						var_375_bool = true;
				}
				if(var_375_bool != 0)
				...
				if(var_384_bool != 0) {
					bool var_386_bool;
					func_6266(var_386_bool, var_1_bool);
					if(var_386_bool != 0)
						var_383_bool = true;
				}
				if(var_383_bool != 0)
				...
				bool var_391_bool;
				func_6266(var_391_bool, var_1_bool);
				if(var_391_bool != 0)
					var_0_bool->AddReply(537483, 39331, 39330); //@t
				bool var_396_bool;
				func_6276(var_396_bool, var_1_bool);
				if(var_396_bool != 0)
			...
			if(var_22_int == 45690) {
				...
				bool var_1293_bool;
				func_6186(var_1293_bool, var_1_bool);
				if(var_1293_bool != 1) {
					bool var_1295_bool;
					func_6206(var_1295_bool, var_1_bool);
					if(var_1295_bool != 1)
						var_1292_bool = false;
				}
				if(var_1292_bool != 1) {
					bool var_1297_bool;
					func_6196(var_1297_bool, var_1_bool);
					if(var_1297_bool != 1)
						var_1291_bool = false;
				}
				if(var_1291_bool != 0) {
				...
				bool var_1307_bool;
				func_6166(var_1307_bool, var_1_bool);
				if(var_1307_bool != 0) {
					func_2447(var_23_int, "Neutral");
...
// @pe
void func_6154(bool var_67_bool)
{
	int var_69_int;
...
// @pe
void func_6166(bool var_117_bool, object var_118_object)
{
...
// @pe
void func_6176(bool var_144_bool, object var_145_object)
{
...
// @pe
void func_6186(bool var_123_bool, object var_124_object)
{
...
// @pe
void func_6196(bool var_135_bool, object var_136_object)
{
...
// @pe
void func_6206(bool var_129_bool, object var_130_object)
{
...
// @pe
void func_6216(bool var_171_bool, object var_172_object)
{
...
// @pe
void func_6226(bool var_177_bool, object var_178_object)
{
...
// @pe
void func_6236(bool var_94_bool, object var_95_object)
{
...
// @pe
void func_6246(bool var_192_bool, object var_193_object)
{
...
// @pe
void func_6256(bool var_105_bool, object var_106_object)
{
...
// @pe
void func_6266(bool var_200_bool, object var_201_object)
{
...
// @pe
void func_6276(bool var_206_bool, object var_207_object)
{
...
// @pe
void func_6286(bool var_299_bool, object var_300_object)
{
...
void func_659(bool var_0_bool, object var_74_object)
{
	...
	func_5323(var_89_cvector, var_0_bool);
...
// @pe
void func_6296(bool var_323_bool, object var_324_object)
{
...
// @pe
void func_6306(bool var_119_bool)
{
	int var_121_int;
...
// @pe
void func_6313(bool var_146_bool)
{
	int var_148_int;
...
// @pe
void func_6320(bool var_125_bool)
{
	int var_127_int;
...
// @pe
void func_6327(bool var_137_bool)
{
	int var_139_int;
...
// @pe
void func_6334(bool var_131_bool)
{
	int var_133_int;
...
// @pe
void func_6341(bool var_173_bool)
{
	int var_175_int;
...
// @pe
void func_6348(bool var_179_bool)
{
	int var_181_int;
...
// @pe
void func_6355(bool var_96_bool)
{
	int var_98_int;
...
// @pe
void func_6362(bool var_194_bool)
{
	int var_196_int;
...
// @pe
void func_6369(bool var_107_bool)
{
	int var_109_int;
...
// @pe
void func_6376(bool var_202_bool)
{
	int var_204_int;
...
// @pe
void func_6383(bool var_208_bool)
{
	int var_210_int;
...
// @pe
void func_6390(bool var_301_bool)
{
...
// @pe
void func_6411(bool var_325_bool)
{
	int var_327_int;
...
void func_1805(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_119_object, object var_120_object)
{
	...
	if(1 != 0) {
		...
		if(var_126_bool != 0) {
			...
			bool var_153_bool;
			func_6236(var_153_bool, var_1_bool);
			if(var_153_bool != 1) {
				bool var_164_bool;
				func_6256(var_164_bool, var_1_bool);
				if(var_164_bool != 1)
					var_152_bool = false;
			}
			if(var_152_bool != 0)
			...
			bool var_176_bool;
			func_6166(var_176_bool, var_1_bool);
			if(var_176_bool != 1) {
				bool var_182_bool;
				func_6186(var_182_bool, var_1_bool);
				if(var_182_bool != 1)
					var_175_bool = false;
			}
			if(var_175_bool != 1) {
				bool var_188_bool;
				func_6206(var_188_bool, var_1_bool);
				if(var_188_bool != 1)
					var_174_bool = false;
			}
			if(var_174_bool != 1) {
				bool var_194_bool;
				func_6196(var_194_bool, var_1_bool);
				if(var_194_bool != 1)
					var_173_bool = false;
			}
			if(var_173_bool != 0)
				var_0_bool->AddReply(543233, 45690, 45689); //@t
			bool var_203_bool;
			func_6176(var_203_bool, var_1_bool);
			if(var_203_bool != 0)
				var_0_bool->AddReply(543214, 45672, 45670); //@t
			...
			bool var_215_bool;
			func_6166(var_215_bool, var_1_bool);
			if(var_215_bool != 1) {
				bool var_217_bool;
				func_6176(var_217_bool, var_1_bool);
				if(var_217_bool != 1)
					var_214_bool = false;
			}
			if(var_214_bool != 1) {
				bool var_219_bool;
				func_6186(var_219_bool, var_1_bool);
				if(var_219_bool != 1)
					var_213_bool = false;
			}
			if(var_213_bool != 1) {
				bool var_221_bool;
				func_6196(var_221_bool, var_1_bool);
				if(var_221_bool != 1)
					var_212_bool = false;
			}
			if(var_212_bool != 0)
			...
			bool var_228_bool;
			func_6206(var_228_bool, var_1_bool);
			if(var_228_bool != 1) {
				bool var_230_bool;
				func_6216(var_230_bool, var_1_bool);
				if(var_230_bool != 1)
					var_227_bool = false;
			}
			if(var_227_bool != 1) {
				bool var_236_bool;
				func_6226(var_236_bool, var_1_bool);
				if(var_236_bool != 1)
					var_226_bool = false;
			}
			if(var_226_bool != 0)
			...
			bool var_249_bool;
			func_6236(var_249_bool, var_1_bool);
			if(var_249_bool != 1) {
				bool var_251_bool;
				func_6246(var_251_bool, var_1_bool);
				if(var_251_bool != 1)
					var_248_bool = false;
			}
			if(var_248_bool != 1) {
				bool var_257_bool;
				func_6256(var_257_bool, var_1_bool);
				if(var_257_bool != 1)
					var_247_bool = false;
			}
			if(var_247_bool != 1) {
				bool var_259_bool;
				func_6266(var_259_bool, var_1_bool);
				if(var_259_bool != 1)
					var_246_bool = false;
			}
			if(var_246_bool != 1) {
				bool var_265_bool;
				func_6276(var_265_bool, var_1_bool);
				if(var_265_bool != 1)
					var_245_bool = false;
			}
			if(var_245_bool != 0)
			...
			bool var_278_bool;
			func_6166(var_278_bool, var_1_bool);
			if(var_278_bool != 1) {
				bool var_280_bool;
				func_6176(var_280_bool, var_1_bool);
				if(var_280_bool != 1)
					var_277_bool = false;
			}
			if(var_277_bool != 1) {
				bool var_282_bool;
				func_6196(var_282_bool, var_1_bool);
				if(var_282_bool != 1)
					var_276_bool = false;
			}
			if(var_276_bool != 1) {
				bool var_284_bool;
				func_6206(var_284_bool, var_1_bool);
				if(var_284_bool != 1)
					var_275_bool = false;
			}
			if(var_275_bool != 1) {
				bool var_286_bool;
				func_6226(var_286_bool, var_1_bool);
				if(var_286_bool != 1)
					var_274_bool = false;
			}
			if(var_274_bool != 0)
			...
			if(var_297_bool != 1) {
				bool var_299_bool;
				func_6216(var_299_bool, var_1_bool);
				if(var_299_bool != 1)
					var_296_bool = false;
			}
			if(var_296_bool != 1) {
				bool var_301_bool;
				func_6246(var_301_bool, var_1_bool);
				if(var_301_bool != 1)
					var_295_bool = false;
			}
			if(var_295_bool != 1) {
				bool var_303_bool;
				func_6276(var_303_bool, var_1_bool);
				if(var_303_bool != 1)
					var_294_bool = false;
			}
			if(var_294_bool != 1) {
				bool var_305_bool;
				func_6176(var_305_bool, var_1_bool);
				if(var_305_bool != 1)
					var_293_bool = false;
			}
			if(var_293_bool != 1) {
				bool var_307_bool;
				func_6236(var_307_bool, var_1_bool);
				if(var_307_bool != 1)
					var_292_bool = false;
			}
			if(var_292_bool != 1) {
				bool var_309_bool;
				func_6256(var_309_bool, var_1_bool);
				if(var_309_bool != 1)
					var_291_bool = false;
			}
			if(var_291_bool != 0)
			...
			bool var_317_bool;
			func_6266(var_317_bool, var_1_bool);
			if(var_317_bool != 1) {
				bool var_319_bool;
				func_6246(var_319_bool, var_1_bool);
				if(var_319_bool != 1)
					var_316_bool = false;
			}
			if(var_316_bool != 1) {
				bool var_321_bool;
				func_6236(var_321_bool, var_1_bool);
				if(var_321_bool != 1)
					var_315_bool = false;
			}
			if(var_315_bool != 1) {
				bool var_323_bool;
				func_6226(var_323_bool, var_1_bool);
				if(var_323_bool != 1)
					var_314_bool = false;
			}
			if(var_314_bool != 0)
				var_0_bool->AddReply(543219, -1, 45675); //@t
					...
					if(var_352_bool != 0) {
						bool var_358_bool;
						func_6166(var_358_bool, var_1_bool);
						if(var_358_bool != 0)
							var_351_bool = true;
					}
					if(var_351_bool != 0)
						var_0_bool->AddReply(537242, 39086, 39085); //@t
					bool var_363_bool;
					func_6166(var_363_bool, var_1_bool);
					if(var_363_bool != 0)
						var_0_bool->AddReply(537277, 39122, 39121); //@t
					bool var_368_bool;
					func_6176(var_368_bool, var_1_bool);
					if(var_368_bool != 0)
						var_0_bool->AddReply(537329, 39176, 39175); //@t
					bool var_373_bool = false;
					bool var_374_bool;
					func_6186(var_374_bool, var_1_bool);
					if(var_374_bool != 0) {
						bool var_376_bool;
						func_6286(var_376_bool, var_1_bool);
						if(var_376_bool != 0)
							var_373_bool = true;
					}
					if(var_373_bool != 0)
					...
					if(var_396_bool != 0) {
						bool var_398_bool;
						func_6186(var_398_bool, var_1_bool);
						if(var_398_bool != 0)
							var_395_bool = true;
					}
					if(var_395_bool != 0) {
						bool var_400_bool;
						func_6296(var_400_bool, var_1_bool);
						if(var_400_bool != 0)
							var_394_bool = true;
					}
					if(var_394_bool != 0)
					...
					bool var_411_bool;
					func_6196(var_411_bool, var_1_bool);
					if(var_411_bool != 0) {
						bool var_413_bool;
						func_6286(var_413_bool, var_1_bool);
						if(var_413_bool != 0)
							var_410_bool = true;
					}
					if(var_410_bool != 0)
					...
					bool var_419_bool;
					func_6196(var_419_bool, var_1_bool);
					if(var_419_bool != 0) {
						bool var_421_bool;
						func_6296(var_421_bool, var_1_bool);
						if(var_421_bool != 0)
							var_418_bool = true;
					}
					if(var_418_bool != 0)
						var_0_bool->AddReply(537390, 39237, 39236); //@t
					bool var_426_bool;
					func_6206(var_426_bool, var_1_bool);
					if(var_426_bool != 0)
						var_0_bool->AddReply(537400, 39247, 39246); //@t
					...
					if(var_432_bool != 0) {
						bool var_434_bool;
						func_6216(var_434_bool, var_1_bool);
						if(var_434_bool != 0)
							var_431_bool = true;
					}
					if(var_431_bool != 0)
						var_0_bool->AddReply(537423, 39270, 39269); //@t
					bool var_439_bool;
					func_6226(var_439_bool, var_1_bool);
					if(var_439_bool != 0)
						var_0_bool->AddReply(537433, 39280, 39279); //@t
					...
					if(var_445_bool != 0) {
						bool var_447_bool;
						func_6236(var_447_bool, var_1_bool);
						if(var_447_bool != 0)
							var_444_bool = true;
					}
					if(var_444_bool != 0)
					...
					if(var_453_bool != 0) {
						bool var_455_bool;
						func_6246(var_455_bool, var_1_bool);
						if(var_455_bool != 0)
							var_452_bool = true;
					}
					if(var_452_bool != 0)
					...
					if(var_461_bool != 0) {
						bool var_463_bool;
						func_6266(var_463_bool, var_1_bool);
						if(var_463_bool != 0)
							var_460_bool = true;
					}
					if(var_460_bool != 0)
						var_0_bool->AddReply(537473, 39321, 39320); //@t
					bool var_468_bool;
					func_6266(var_468_bool, var_1_bool);
					if(var_468_bool != 0)
						var_0_bool->AddReply(537483, 39331, 39330); //@t
					bool var_473_bool;
					func_6276(var_473_bool, var_1_bool);
					if(var_473_bool != 0)
						var_0_bool->AddReply(537493, 39341, 39340); //@t
					var_0_bool->AddReply(537503, -1, 39350); //@t
					var_0_bool->AddReply(537504, -1, 39351); //@t
...
void func_6422(int var_110_int)
{
	int var_112_int;
...
// @pe
void func_5926(object var_73_object)
{
	object var_74_object;
...
// @pe
void func_6445(object var_39_object)
{
	int var_40_int;
...
// @pe
void func_5934(int var_31_int, object var_32_object)
{
	object var_34_object;
...
// @pe
void func_5944(object var_74_object)
{
	object var_75_object;
...
void func_6458(bool var_24_bool)
{
	@ClearSubContainer(0);
	int var_32_int;
...
// @pe
void func_5952(int var_76_int, object var_77_object)
{
...
// @pe
void func_5962(object var_113_object)
{
...
// @pe
void func_6039(object var_33_object)
{
	object var_34_object;
	func_6576(var_34_object, var_34_object);
}
...
void func_6046(int var_25_int, object var_26_object)
{
...
void func_6558(int var_107_int)
{
	var_107_int = 515559;
}


void func_6560(int var_106_int)
{
	var_106_int = 503344;
}


void func_6562(string var_108_string)
{
	var_108_string = "ui/NPC_Citizen1.png";
}


void func_6564(string var_109_string)
{
	var_109_string = "ui/NPC_Citizen1_b.png";
}


void func_6566(bool var_25_bool)
{
	var_25_bool = false;
}
...
// @pe
void func_6062(object var_73_object)
{
	object var_74_object;
	var_73_object = var_74_object;
	func_5944(var_74_object);
...
void func_6576(object var_34_object, object var_49_object)
{
	bool var_36_bool;
...
// @pe
void func_6068(int var_209_int)
{
	var_209_int = 0;
}
...
void func_6073(bool var_28_bool, object var_29_object)
{
	bool var_31_bool;
...
// @pe
void func_6078(object var_40_object)
{
...
void func_6086(bool var_37_bool, object var_38_object)
{
	bool var_40_bool;
...
// @pe
void func_6101(object var_139_object)
{
...
void func_6616(bool var_67_bool)
{
	var_67_bool = true;
}
...
// @pe
void func_6618(bool var_27_bool, object var_28_object, object var_29_object)
{
	object var_32_object;
	...
	bool var_31_bool;
	func_5970(var_31_bool, var_32_object, var_33_object, 500.0);
	if(var_31_bool != 0) {
...
// @pe
void func_6109(bool var_54_bool, object var_55_object)
{
...
// @pe
void func_6116(object var_207_object)
{
...
// @pe
void func_6122(bool var_30_bool)
{
	var_30_bool = false;
}
...
void func_5615(object var_82_object)
{
	float var_85_float;
...
// @pe
void func_6137(object var_29_object)
{
...
// @pe
void func_6142(bool var_275_bool)
{
	int var_277_int;
