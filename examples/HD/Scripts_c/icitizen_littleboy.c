...
func_5697(var_33_object)
{
	...
	func_6183(var_33_object, var_34_object);
	return 0;
}
...
func_6225(var_27_bool, var_28_object, var_29_object)
{
	...
	func_5628(var_31_bool, var_32_object, var_33_object, (float)500.0);
	if(var_31_bool != 0) {
...
func_659(var_0_bool, var_74_object)
{
	...
	func_4992(var_89_cvector, var_90_object);
...
func_6089(var_24_bool)
{
	...
	if(var_28_bool != 0) {
		...
		if(var_84_bool == 0) goto Label_6164;
