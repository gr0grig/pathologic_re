...
// @pe
void func_3589(object var_33_object)
{
	object var_34_object;
	func_4019(var_34_object, var_34_object);
}
...
// @pe
void func_3601(int var_209_int)
{
	var_209_int = 0;
}
...
void func_3176(object var_82_object)
{
	float var_85_float;
...
void func_659(bool var_0_bool, object var_74_object)
{
	...
	func_2884(var_89_cvector, var_0_bool);
...
// @pe
void func_3912(object var_39_object)
{
	int var_40_int;
...
void func_3925(bool var_24_bool)
{
	int var_26_int;
	@ClearSubContainer(0);
	if(var_24_bool != 0) {
		...
		if(!(var_26_int >= 6)) goto Label_4000;
...
// @pe
void func_3476(object var_73_object)
{
	object var_74_object;
...
void func_4001(int var_107_int)
{
	var_107_int = 515561;
}


void func_4003(int var_106_int)
{
	var_106_int = 503346;
}
...
void func_4005(string var_108_string)
{
	var_108_string = "ui/NPC_Citizen1.png";
}


void func_4007(string var_109_string)
{
	var_109_string = "ui/NPC_Citizen1_b.png";
}


void func_4009(bool var_25_bool)
{
	var_25_bool = false;
}
...
// @pe
void func_3502(int var_76_int, object var_77_object)
{
...
void func_4019(object var_34_object, object var_49_object)
{
	bool var_36_bool;
...
// @pe
void func_3512(object var_113_object)
{
	object var_114_object;
...
void func_4059(bool var_67_bool)
{
	var_67_bool = true;
}
...
// @pe
void func_4061(bool var_27_bool, object var_28_object, object var_29_object)
{
	object var_32_object;
	...
	bool var_31_bool;
	func_3520(var_31_bool, var_32_object, var_33_object, 500.0);
	if(var_31_bool != 0) {
