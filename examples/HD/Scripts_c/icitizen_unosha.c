...
void func_2570(bool var_13_bool, string var_14_string)
{
	object var_16_object;
...
void func_1039(bool var_0_bool, bool var_1_bool, bool var_361_bool, float var_362_float)
{
	...
	if(var_368_bool != 0) {
		...
		func_1378(var_370_string);
		bool var_487_bool;
		func_1821(var_487_bool, var_0_bool);
		if(!var_487_bool) { //@nz
			@StopAsync();
			var_361_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_368_bool) { //@nz
				...
				func_1378(var_370_string);
				bool var_513_bool;
				func_1821(var_513_bool, var_0_bool);
				if(!var_513_bool) { //@nz
					@StopAsync();
					var_361_bool = false;
					return 8;
...
void func_2586(string var_24_string)
{
...
// @pe
void func_2608(object var_54_object)
{
...
// @pe
void func_2616(int var_21_int, object var_22_object)
{
...
void func_2634(bool var_28_bool, object var_29_object, bool var_30_bool)
{
...
void func_2155(int var_219_int)
{
	int var_221_int;
...
void func_2174(int var_24_int, int var_25_int)
{
...
// @pe
void func_2709(int var_79_int, object var_80_object)
{
...
void func_1176(bool var_503_bool, float var_504_float)
{
...
// @pe
void func_2716(object var_118_object)
{
...
void func_2205(string var_225_string)
{
...
void func_2722(bool var_21_bool, object var_22_object, object var_23_object, float var_24_float, bool var_25_bool)
{
	object var_29_object;
	var_23_object = var_29_object;
	bool var_28_bool;
	func_2634(var_28_bool, var_29_object, !var_25_bool);
	if(!var_28_bool) { //@nz
		var_21_bool = false;
		return 2;
	}
...
// @pe
void func_2754(object var_23_object)
{
	object var_24_object;
...
void func_2246(bool var_18_bool)
{
	int var_21_int; bool var_22_bool;
	if(var_18_bool != 0) {
		int var_27_int;
		func_2126(var_27_int);
		func_2174(0, (100 + (var_27_int * 100)));
		@irand(var_21_int, 8);
		if(var_21_int == 0) {
			int var_55_int;
...
void func_2761(int var_15_int, object var_16_object)
{
...
// @pe
void func_2777(object var_63_object)
{
...
// @pe
void func_2783(int var_122_int)
{
	var_122_int = 0;
}
		...
		if(var_132_bool != 0) {
			...
			if(var_93_float >= (var_74_float * var_74_float)) {
				...
				if(var_260_bool != 0) {
					...
					bool var_524_bool;
					func_1821(var_524_bool, var_0_bool);
					if(!var_524_bool) { //@nz
						goto Label_948;
					}
					var_0_bool->GetPFPosition(var_87_cvector); //@t
...
// @pe
void func_2788(bool var_18_bool)
{
	var_18_bool = false;
}
...
void func_2793(bool var_25_bool, object var_26_object)
{
	bool var_28_bool;
...
// @pe
void func_2808(object var_53_object)
{
...
// @pe
void func_2814(bool var_42_bool)
{
	var_42_bool = false;
}
...
// @pe
void func_2819(bool var_20_bool)
{
	var_20_bool = false;
}
...
void func_2824(string var_146_string, int var_147_int)
{
...
void func_2839(object var_24_object)
{
	bool var_26_bool;
...
void func_2882(bool var_23_bool)
{
	var_23_bool = true;
}
...
// @pe
void func_2884(bool var_17_bool, object var_18_object, object var_19_object, bool var_20_bool)
{
	...
	bool var_21_bool;
	func_2722(var_21_bool, var_22_object, var_23_object, 500.0, var_25_bool);
	var_21_bool = var_17_bool;
}


// @pe
void func_2894(object var_95_object)
{
...
{
	func_2135(var_0_bool);
}


void func_1383(int var_477_int)
{
	var_477_int = 0;
}
...
void func_1392(bool var_502_bool)
{
	var_502_bool = true;
}
...
void func_2421(int var_45_int, string var_46_string)
{
	int var_48_int;
...
// @pe
void func_2426(object var_13_object)
{
	object var_14_object;
...
// @pe
void func_2471(bool var_16_bool, object var_17_object, string var_18_string)
{
...
// @pe
void func_2503(object var_46_object, string var_47_string)
{
...
Label_2527:
	...
	if(!(var_47_string == "battle")) goto Label_2527;
...
void func_2528(bool var_13_bool, object var_14_object)
{
	bool var_16_bool;
...
void func_1000(bool var_0_bool, float var_398_float, int var_399_int)
{
	...
	if(var_403_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_477_int, var_405_float, var_414_float);
...
// @pe
void func_2557(object var_15_object)
{
