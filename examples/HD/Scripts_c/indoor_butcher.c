...
void func_2078(object var_133_object)
{
	bool var_135_bool;
...
void func_1067(int var_472_int)
{
	var_472_int = 0;
}
...
void func_2098(int var_130_int)
{
	int var_132_int;
...
void func_1076(bool var_497_bool)
{
	var_497_bool = true;
}
...
// @pe
void func_2104(object var_26_object)
{
	int var_27_int;
...
void func_2117(string var_136_string)
{
...
// @pe
void func_2175(object var_12_object)
{
	object var_13_object;
...
// @pe
void func_2220(bool var_15_bool, object var_16_object, string var_17_string)
{
...
// @pe
void func_2252(object var_30_object, string var_31_string)
{
...
Label_2276:
	...
	if(!(var_31_string == "battle")) goto Label_2276;
...
void func_723(object var_0_object, int var_1_int, bool var_356_bool, float var_357_float)
{
	...
	if(var_363_bool != 0) {
		...
		func_1062(var_365_string);
		bool var_482_bool;
		func_1778(var_482_bool, var_0_object);
		if(!var_482_bool) { //@nz
			@StopAsync();
			var_356_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_363_bool) { //@nz
				...
				func_1062(var_365_string);
				bool var_508_bool;
				func_1778(var_508_bool, var_0_object);
				if(!var_508_bool) { //@nz
					@StopAsync();
					var_356_bool = false;
					return 8;
...
void func_2277(bool var_12_bool, object var_13_object)
{
	bool var_15_bool;
...
// @pe
void func_2300(object var_24_object)
{
...
// @pe
void func_2306(object var_14_object)
{
...
void func_2319(bool var_12_bool, string var_13_string)
{
	object var_15_object;
...
void func_2335(string var_21_string)
{
...
void func_2348(string var_66_string, int var_67_int)
{
...
// @pe
void func_2372(int var_23_int, object var_24_object)
{
...
// @pe
void func_2382(object var_63_object)
{
...
// @pe
void func_2395(int var_14_int)
{
	var_14_int = 0;
}


void func_860(bool var_498_bool, float var_499_float)
{
...
// @pe
void func_2408(object var_20_object)
{
...
// @pe
void func_2415(bool var_17_bool)
{
	var_17_bool = false;
}
...
// @pe
void func_2420(bool var_24_bool)
{
	var_24_bool = false;
}
...
// @pe
void func_2425(bool var_28_bool)
{
	var_28_bool = false;
}
...
// @pe
void func_2430(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_2435(object var_21_object)
{
	bool var_23_bool;
...
// @pe
void func_2452(bool var_16_bool)
{
	var_16_bool = false;
}
...
// @pe
void func_2455(object var_94_object)
{
		...
		if(var_129_bool != 0) {
			...
			if(var_92_float >= (var_73_float * var_73_float)) {
				...
				if(var_255_bool != 0) {
					...
					bool var_519_bool;
					func_1778(var_519_bool, var_0_object);
					if(!var_519_bool) { //@nz
						goto Label_632;
					}
					var_0_object->GetPFPosition(var_86_cvector); //@t
