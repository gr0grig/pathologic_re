...
void func_2081(object var_147_object)
{
	bool var_149_bool;
...
void func_1067(int var_488_int)
{
	var_488_int = 0;
}
...
void func_1076(bool var_513_bool)
{
	var_513_bool = true;
}


void func_2101(int var_130_int)
{
	int var_132_int;
...
// @pe
void func_2107(object var_26_object)
{
	int var_27_int;
...
void func_2120(string var_136_string)
{
...
// @pe
void func_2178(object var_12_object)
{
	object var_13_object;
...
void func_684(object var_0_object, float var_409_float, int var_410_int)
{
	...
	if(var_414_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_488_int, var_416_float, var_425_float);
		object var_489_object; float var_490_float;
...
// @pe
void func_2223(bool var_15_bool, object var_16_object, string var_17_string)
{
...
// @pe
void func_2255(object var_30_object, string var_31_string)
{
...
Label_2279:
	...
	if(!(var_31_string == "battle")) goto Label_2279;
...
void func_723(object var_0_object, int var_1_int, bool var_372_bool, float var_373_float)
{
	...
	if(var_379_bool != 0) {
		...
		func_1062(var_381_string);
		bool var_498_bool;
		func_1781(var_498_bool, var_0_object);
		if(!var_498_bool) { //@nz
			@StopAsync();
			var_372_bool = false;
			return 8;
		...
		for(;;) {
			var_381_string = (("attack_middle" + var_502_int) + "_") + var_380_int;
			...
			if(!var_379_bool) { //@nz
				...
				func_1062(var_381_string);
				bool var_524_bool;
				func_1781(var_524_bool, var_0_object);
				if(!var_524_bool) { //@nz
					@StopAsync();
					var_372_bool = false;
					return 8;
...
void func_2280(bool var_12_bool, object var_13_object)
{
	bool var_15_bool;
...
// @pe
void func_2303(object var_24_object)
{
...
// @pe
void func_2309(object var_14_object)
{
...
void func_2322(bool var_12_bool, string var_13_string)
{
	object var_15_object;
...
void func_2338(string var_21_string)
{
...
void func_2351(string var_68_string, int var_69_int)
{
...
// @pe
void func_2375(int var_40_int, object var_41_object)
{
...
// @pe
void func_2385(object var_75_object)
{
...
// @pe
void func_2393(int var_37_int, object var_38_object)
{
...
void func_860(bool var_514_bool, float var_515_float)
{
	float var_518_float; bool var_519_bool;
	@rand(var_518_float);
	if(var_518_float < var_515_float) {
...
// @pe
void func_2400(object var_74_object)
{
...
// @pe
void func_2419(object var_20_object)
{
...
// @pe
void func_2426(bool var_17_bool)
{
	var_17_bool = false;
}
...
// @pe
void func_2431(bool var_24_bool)
{
	var_24_bool = false;
}
...
// @pe
void func_2436(bool var_28_bool)
{
	var_28_bool = false;
}
...
// @pe
void func_2441(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_2446(object var_21_object)
{
	bool var_23_bool;
...
void func_2463(bool var_16_bool, object var_18_object)
{
		...
		if(var_143_bool != 0) {
			...
			if(var_104_float >= (var_85_float * var_85_float)) {
				...
				if(var_271_bool != 0) {
					...
					var_534_bool = !var_533_bool; //@nz
					if(var_534_bool == 0) goto Label_622;
					bool var_535_bool;
					func_1781(var_535_bool, var_0_object);
					if(!var_535_bool) { //@nz
						goto Label_632;
					}
					var_0_object->GetPFPosition(var_98_cvector); //@t
...
// @pe
void func_2485(object var_94_object)
{
