...
main()
{
	...
	func_56(var_0_bool, "health", (float)-0.014999999664723873, (float)0, (float)1);
	var_16_float = 0;
	func_126((float)-0.014999999664723873);
	var_24_bool = 0; var_25_string = ""; var_26_float = 0; var_27_float = 0; var_28_float = 0;
	func_56(var_24_bool, "immunity", (float)0.15000000596046448, (float)0, (float)1);
	var_29_float = 0;
	func_106((float)0.15000000596046448);
