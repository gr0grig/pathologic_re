...
main(var_0_bool)
{
	...
	var_5_bool = var_2_float < (float)0.8999999761581421;
	if(var_5_bool != 0) {
		SetProperty("immunity", (float)0.8999999761581421);
	}
	var_8_float = 0;
	func_33((float)4.0);
	return 2;
...
func_16(var_20_bool, var_21_float)
{
	...
	var_26_bool = var_23_float < (float)0.8999999761581421;
	if(var_26_bool != 0) {
		var_27_bool = 0; var_28_string = ""; var_29_float = 0; var_30_float = 0; var_31_float = 0;
		var_29_float = var_21_float * (float)1.5;
		func_65(var_27_bool, "immunity", var_29_float, (float)0, (float)0.8999999761581421);
	}
	var_20_bool = 0;
	return 2;
}
