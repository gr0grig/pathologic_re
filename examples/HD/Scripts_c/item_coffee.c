...
// @STRINGS: W:drink|W:health|W:immunity|W:disease|W:hunger|W:tiredness|A:add
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
main()
{
	...
	func_59(var_1_bool, "health", (float)-0.05000000074505806, (float)0, (float)1);
	var_17_float = 0;
	func_129((float)-0.05000000074505806);
	var_25_bool = 0; var_26_string = ""; var_27_float = 0; var_28_float = 0; var_29_float = 0;
	func_59(var_25_bool, "immunity", (float)0.0, (float)0, (float)1);
	var_30_float = 0;
	func_109((float)0.0);
	...
	func_59(var_43_bool, "hunger", (float)0.0, (float)0, (float)1);
	var_48_float = 0;
	func_99((float)0.0);
	var_52_bool = 0; var_53_string = ""; var_54_float = 0; var_55_float = 0; var_56_float = 0;
	func_59(var_52_bool, "tiredness", (float)-0.20000000298023224, (float)0, (float)1);
	var_57_float = 0;
	func_89((float)-0.20000000298023224);
	return 0;
}
