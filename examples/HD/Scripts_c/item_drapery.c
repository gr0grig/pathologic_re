...
Label_28:
	...
	var_12_int = var_11_float / (float)0.23999999463558197;
	var_91_bool = var_12_int > (int)0;
	if(var_91_bool != 0) {
		var_93_int = var_11_float % (float)0.23999999463558197;
...
func_212(var_42_int)
{
	...
	func_274(var_44_int, "armor", var_46_int, var_47_int, (int)0);
