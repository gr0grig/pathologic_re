...
main()
{
	...
	var_5_float = var_1_float * (float)0.20000000298023224;
	SetProperty("disease", var_5_float);
	var_6_float = 0;
	var_8_float = var_1_float * (float)0.20000000298023224;
	var_6_float = var_1_float - var_8_float;
	func_78(var_6_float);
	var_12_bool = 0; var_13_string = ""; var_14_float = 0; var_15_float = 0; var_16_float = 0;
	func_38(var_12_bool, "tiredness", (float)0.30000001192092896, (float)0, (float)1);
	var_28_float = 0;
	func_68((float)0.30000001192092896);
	var_32_bool = 0; var_33_string = ""; var_34_float = 0; var_35_float = 0; var_36_float = 0;
	func_38(var_32_bool, "health", (float)-0.30000001192092896, (float)0, (float)1);
	var_37_float = 0;
	func_88((float)-0.30000001192092896);
	return 2;
}
