...
main(var_0_bool)
{
	...
	func_82(var_1_bool, "health", (float)0.029999999329447746, (float)0, (float)1);
	var_17_float = 0;
	func_135((float)0.029999999329447746);
	var_25_bool = 0; var_26_string = ""; var_27_float = 0; var_28_float = 0; var_29_float = 0;
	func_82(var_25_bool, "tiredness", (float)0.25, (float)0, (float)1);
	var_30_float = 0;
	func_125((float)0.25);
	var_34_float = 0;
	func_50((float)5.0);
...
func_27(var_46_bool, var_47_float)
{
	...
	if(var_48_bool != 0) {
		...
		var_58_float = var_47_float * (float)0.07999999821186066;
		...
		var_64_float = var_47_float * (float)-0.05000000074505806;
