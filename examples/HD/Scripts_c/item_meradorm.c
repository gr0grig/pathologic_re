maintask task_0
{
	...
	{
		bool var_1_bool;
		func_82(var_1_bool, "health", 0.03, (float)0, (float)1);
		func_135(0.03);
		bool var_25_bool;
		func_82(var_25_bool, "tiredness", 0.25, (float)0, (float)1);
		func_125(0.25);
		func_50(5.0);
	}
...
void func_27(bool var_46_bool, float var_47_float)
{
	...
	if(var_48_bool != 0) {
		bool var_56_bool;
		func_82(var_56_bool, "health", (var_47_float * 0.08), (float)0, (float)1);
		bool var_62_bool;
		func_82(var_62_bool, "tiredness", (var_47_float * -0.05), (float)0, (float)1);
	}
	var_46_bool = false;
}
