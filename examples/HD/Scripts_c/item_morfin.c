...
main(var_0_bool)
{
	...
	func_82(var_1_bool, "health", (float)0.15000000596046448, (float)0, (float)1);
	var_17_float = 0;
	func_135((float)0.15000000596046448);
...
func_27(var_46_bool, var_47_float)
{
	...
	if(var_48_bool != 0) {
		...
		var_58_float = var_47_float * (float)0.20000000298023224;
