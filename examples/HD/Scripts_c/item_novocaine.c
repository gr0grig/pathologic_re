...
main(var_0_bool)
{
	...
	func_82(var_1_bool, "health", (float)0.10000000149011612, (float)0, (float)1);
	var_17_float = 0;
	func_135((float)0.10000000149011612);
	var_25_bool = 0; var_26_string = ""; var_27_float = 0; var_28_float = 0; var_29_float = 0;
	func_82(var_25_bool, "tiredness", (float)0.10000000149011612, (float)0, (float)1);
	var_30_float = 0;
	func_125((float)0.10000000149011612);
	var_34_float = 0;
	func_50((float)10.0);
	return 0;
}
...
func_27(var_46_bool, var_47_float)
{
	...
	if(var_48_bool != 0) {
		...
		var_58_float = var_47_float * (float)0.12999999523162842;
		...
		var_64_float = var_47_float * (float)-0.07999999821186066;
