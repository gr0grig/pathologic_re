...
Label_28:
	...
	if(var_91_bool != 0) {
		var_93_int = var_11_float % (float)0.47999998927116394;
...
func_212(var_42_int)
{
	...
	func_274(var_44_int, "armor", var_46_int, var_47_int, (int)15);
	...
	func_274(var_61_int, "armor_fire", var_63_int, var_64_int, (int)10);
	...
	func_274(var_82_int, "armor_disease", var_84_int, var_85_int, (int)35);
