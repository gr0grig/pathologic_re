...
void func_1416(object var_97_object)
{
	...
	float var_164_float; object var_165_object;
	func_1013(var_164_float, var_165_object, 0.05);
	var_164_float = var_99_float;
	@ReportHit(var_165_object, 5, var_99_float, 0.05);
}
...
void func_918(bool var_184_bool, object var_185_object, string var_186_string, float var_187_float, float var_188_float, float var_189_float)
{
	...
	float var_196_float; float var_198_float; float var_199_float;
	var_188_float = var_198_float;
	var_189_float = var_199_float;
	func_1215(var_196_float, (var_191_float + var_187_float), var_198_float, var_199_float);
...
// @pe
void func_1303(bool var_67_bool, object var_68_object)
{
...
void func_1439(object var_10_object)
{
	object var_13_object;
...
// @pe
void func_1318(bool var_10_bool, object var_11_object)
{
	object var_13_object;
...
// @pe
void func_1325(object var_53_object)
{
	TaskCall(3);
...
// @pe
void func_1335(object var_45_object)
{
	TaskCall(3);
...
void func_1352(bool var_11_bool, object var_12_object, string var_13_string)
{
...
void func_465(bool var_0_bool, bool var_1_bool, bool var_237_bool, object var_238_object, float var_239_float, float var_240_float, bool var_241_bool, bool var_242_bool)
{
	bool var_252_bool; object var_254_object; cvector var_255_cvector; cvector var_256_cvector; float var_258_float; object var_259_object;
	var_0_bool = false;
	...
	for(;;) {
		...
		var_258_float = (var_255_cvector - var_256_cvector) | (var_255_cvector - var_256_cvector);
		bool var_265_bool = false;
		if(var_240_float > 0) {
			if(var_258_float > (var_240_float * var_240_float))
				var_265_bool = true;
		}
		if(var_265_bool != 0) {
			@Stop();
		...
		if(var_258_float > (var_239_float * var_239_float)) {
			...
			if(var_254_object != null) {
				if(var_253_bool == 0) goto Label_518;
				var_253_bool = false;
...
void func_603(string var_278_string)
{
	var_278_string = "walk";
}
...
void func_605(string var_279_string)
{
	var_279_string = "run";
}
...
void func_1379(object var_61_object, string var_62_string)
{
	float var_64_float;
...
void func_228(bool var_0_bool, object var_46_object, bool var_227_bool)
{
	...
	for(;;) {
		bool var_67_bool;
		func_1303(var_67_bool, var_0_bool);
		if(var_67_bool != 0) {
					...
					@SetAttackState(false);
						...
						if(var_94_bool != 0) {
							...
							if(var_65_object == var_0_bool)
								func_1416(var_0_bool);
							var_65_object = null;
						}
						@SetAttackState(false);
						@PlayAnimation("all", "attack_end");
						@WaitForAnimEnd(var_59_bool);
						var_223_bool = !var_59_bool; //@nz
						if(var_223_bool == 0) goto Label_305;
				}
		}
		Label_321:
			for(;;) {
		...
		TaskCall(4);
		func_370(var_224_bool, var_0_bool, var_226_float);
		TaskReturn();
		if(!var_227_bool) { //@nz
			goto Label_321;
		}
...
void func_1265(float var_214_float)
{
	object var_216_object;
	@CreateFloatVector(var_216_object);
	var_216_object->add(var_214_float);
	@SendWorldWndMessage(14, var_216_object);
}
EMIT "Stack[-1] = 0";


void func_370(bool var_224_bool, object var_225_object, float var_226_float)
{
	func_389();
	...
	bool var_229_bool;
	bool var_230_bool;
	func_465(var_229_bool, var_230_bool, var_237_bool, var_238_object, (var_226_float * 0.9), (float)5000, true, true);
...
void func_1013(float var_164_float, object var_165_object, float var_166_float)
{
	float var_170_float;
	...
	float var_169_float = 0;
	bool var_175_bool; object var_176_object;
	func_906(var_175_bool, var_176_object, "armor_disease");
	if(var_175_bool != 0) {
		var_176_object->GetProperty("armor_disease", var_169_float);
		var_169_float /= 100;
	}
	bool var_180_bool; object var_181_object;
	func_906(var_180_bool, var_181_object, "immunity");
	if(var_180_bool != 0) {
		var_181_object->GetProperty("immunity", var_170_float);
		var_169_float += var_170_float;
		bool var_184_bool; object var_185_object; float var_187_float;
	...
	var_166_float *= ((1 - var_169_float) / 2);
	bool var_206_bool; object var_207_object; float var_209_float;
