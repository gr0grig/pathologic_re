...
void func_1057(int var_472_int)
{
	var_472_int = 0;
}
...
void func_1066(bool var_497_bool)
{
	var_497_bool = true;
}
...
// @pe
void func_2111(bool var_18_bool, object var_19_object)
{
	object var_21_object;
...
// @pe
void func_2118(object var_55_object)
{
...
void func_674(int var_0_int, float var_393_float, int var_394_int)
{
	...
	if(var_398_object == var_0_int) {
		...
		@ReportHit(var_0_int, var_472_int, var_400_float, var_409_float);
...
void func_713(int var_0_int, int var_1_int, bool var_356_bool, float var_357_float)
{
	...
	if(var_363_bool != 0) {
		...
		func_1052(var_365_string);
		bool var_482_bool;
		func_1669(var_482_bool, var_0_int);
		if(!var_482_bool) { //@nz
			@StopAsync();
			var_356_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_363_bool) { //@nz
				...
				func_1052(var_365_string);
				bool var_508_bool;
				func_1669(var_508_bool, var_0_int);
				if(!var_508_bool) { //@nz
					@StopAsync();
					var_356_bool = false;
					return 8;
...
void func_850(bool var_498_bool, float var_499_float)
{
		...
		if(var_127_bool != 0) {
			...
			if(var_90_float >= (var_71_float * var_71_float)) {
				...
				if(var_255_bool != 0) {
					...
					bool var_519_bool;
					func_1669(var_519_bool, var_0_int);
					if(!var_519_bool) { //@nz
						goto Label_622;
					}
					var_0_int->GetPFPosition(var_84_cvector); //@t
...
void func_1981(float var_30_float)
{
...
void func_1991(object var_20_object)
{
	bool var_22_bool;
...
void func_2011(string var_49_string, int var_50_int)
{
...
// @pe
void func_2041(object var_21_object)
{
	int var_22_int;
