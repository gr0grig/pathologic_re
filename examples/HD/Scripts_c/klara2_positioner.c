...
maintask task_0
{
	...
	Label_85:
		...
		if(!(var_4_string == "klara_stay")) goto Label_85;
		func_310();
	}
...
void func_323(object var_106_object)
{
...
// @pe
void func_262(int var_141_int, float var_142_float)
{
	float var_146_float;
	var_142_float = var_146_float;
	int var_143_int;
	func_364(var_143_int, 538510, 538509, var_146_float);
	var_143_int = var_141_int;
}


void func_203(float var_68_float)
{
	float var_70_float;
...
void func_271(void)
{
	...
	@CreateDiaryEntry(var_93_object, 723, 2, 539102);
	bool var_97_bool; object var_98_object;
	var_93_object = var_98_object;
	func_336(var_97_bool, var_98_object, -1);
}
EMIT "Stack[-1] = 0";


void func_208(int var_8_int)
{
	float var_10_float;
...
void func_336(bool var_97_bool, object var_98_object, int var_99_int)
{
...
void func_149(object var_2_object, int var_65_int, float var_66_float)
{
	bool var_72_bool;
...
void func_86(int var_0_int, object var_1_object, object var_3_object)
{
	if(var_1_object != 0)
...
// @pe
void func_217(int var_149_int, float var_150_float)
{
	float var_154_float;
	var_150_float = var_154_float;
	int var_151_int;
	func_364(var_151_int, 538512, 538511, var_154_float);
...
void func_284(void)
{
	...
	@CreateDiaryEntry(var_116_object, 724, 2, 539103);
	bool var_120_bool; object var_121_object;
	var_116_object = var_121_object;
	func_336(var_120_bool, var_121_object, 723);
}
EMIT "Stack[-1] = 0";


// @pe
void func_226(int var_157_int, float var_158_float)
{
	float var_162_float;
	var_158_float = var_162_float;
	int var_159_int;
	func_364(var_159_int, 538514, 538513, var_162_float);
	var_159_int = var_157_int;
}


void func_100(int var_0_int, object var_1_object, object var_3_object, int var_7_int)
{
	if(var_1_object != 0)
	...
	if(var_18_object != 0) {
		...
		func_185(var_41_object, var_42_object, ("pt_klara" + var_7_int), "NPC_Klara", "k2system_klara2.xml");
...
// @pe
void func_421(int var_79_int, float var_80_float)
{
	if(var_79_int == 6) {
...
void func_168(object var_3_object)
{
	int var_23_int; bool var_24_bool;
	var_23_int = 0;
	
	while(var_23_int < 12) {
		var_3_object->get(var_24_bool, var_23_int); //@t
		bool var_28_bool;
		var_24_bool = var_28_bool;
		func_372((var_23_int + 1), var_28_bool);
		var_23_int += 1;
	}
...
void func_297(void)
{
	...
	@CreateDiaryEntry(var_186_object, 725, 2, 539104);
	bool var_190_bool; object var_191_object;
	var_186_object = var_191_object;
	func_336(var_190_bool, var_191_object, 723);
}
EMIT "Stack[-1] = 0";


// @pe
void func_235(int var_83_int, float var_84_float)
{
	float var_88_float;
	var_84_float = var_88_float;
	int var_85_int;
	func_364(var_85_int, 538504, 538503, var_88_float);
	var_85_int = var_83_int;
}


void func_364(int var_85_int, int var_86_int, int var_87_int, float var_88_float)
{
	int var_90_int;
...
// @pe
void func_372(int var_27_int, bool var_28_bool)
{
	if(var_28_bool != 0)
		var_33_int = 1;
	else
		var_34_int = 0; //@pi
	@SetVariable(("K2System" + var_27_int), var_33_int);
	
}


// @pe
void func_244(int var_125_int, float var_126_float)
{
	float var_130_float;
	var_126_float = var_130_float;
	int var_127_int;
	func_364(var_127_int, 538506, 538505, var_130_float);
...
void func_310(void)
{
	...
	@CreateDiaryEntry(var_196_object, 726, 2, 539105);
	bool var_200_bool; object var_201_object;
	var_196_object = var_201_object;
	func_336(var_200_bool, var_201_object, 723);
}
EMIT "Stack[-1] = 0";


void func_185(object var_41_object, object var_42_object, string var_43_string, string var_44_string, string var_45_string)
{
...
// @pe
void func_253(int var_133_int, float var_134_float)
{
	float var_138_float;
	var_134_float = var_138_float;
	int var_135_int;
	func_364(var_135_int, 538508, 538507, var_138_float);
	var_135_int = var_133_int;
}


// @pe
void func_383(string var_24_string, int var_25_int)
{
	if(var_25_int == 6) {
