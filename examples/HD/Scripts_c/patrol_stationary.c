...
void func_2561(string var_64_string, int var_65_int, int var_66_int)
{
	bool var_68_bool;
	int var_70_int;
...
void func_0(bool var_0_bool)
{
	...
	for(;;) {
		...
		if(var_357_bool == 0) goto Label_15;
		func_2512("Neutral");
		@lshWaitForAnimEnd();
		break;
	Label_24:
...
void func_1541(bool var_588_bool, float var_589_float)
{
...
void func_2572(string var_34_string, int var_35_int, int var_36_int, int var_37_int)
{
...
void func_3091(void)
{
	@ClearSubContainer(0);
	int var_260_int;
	func_2786(var_260_int);
	int var_258_int;
	var_260_int = var_258_int;
	func_2892(0, (10 + (var_258_int * 5)));
	func_2561("bottle_water", 1, 3);
	func_2561("rusk", 1, 20);
	func_2561("hook", 1, 30);
	func_2561("watch", 1, 30);
	if(var_258_int >= 3)
		func_2572("alpha_pills", 1, 4, 3);
	if(var_258_int >= 4)
		func_2572("beta_pills", 1, 8, 3);
	if(var_258_int >= 6)
		func_2572("gamma_pills", 1, 16, 3);
}
...
void func_2587(string var_194_string)
{
	...
	if(var_216_bool == 0) goto Label_2607;
}
...
void func_40(bool var_0_bool, int var_141_int, object var_142_object)
{
	...
	for(;;) {
		var_311_bool = !var_151_bool; //@nz
		if(var_311_bool == 0) goto Label_103;
		@sync();
		var_148_object->IsDialogEnd(var_151_bool);
	}
...
void func_2089(float var_497_float, object var_498_object, float var_499_float, int var_500_int)
{
	...
	float var_535_float;
	func_2735(var_535_float, ((var_510_int + var_512_int) / 100.0), (float)1);
	float var_513_float;
	...
	float var_545_float;
	func_2742(var_545_float, (var_514_float - var_515_float), (float)0, (float)1);
...
// @pe
void func_2628(bool var_86_bool, string var_87_string)
{
	var_86_bool = true;
		...
		if(var_219_bool != 0) {
			...
			if(var_182_float >= (var_163_float * var_163_float)) {
				...
				if(var_345_bool != 0) {
					...
					bool var_609_bool;
					func_2203(var_609_bool, var_0_bool);
					if(!var_609_bool) { //@nz
						goto Label_1313;
					}
					var_0_bool->GetPFPosition(var_176_cvector); //@t
...
void func_3162(void)
{
	...
	func_2572("fresh_meat", 1, 4, 3);
	func_2572("dried_meat", 1, 4, 3);
	func_2572("smoked_meat", 1, 4, 3);
	func_2572("vegetables", 1, 3, 3);
	if(var_26_int >= 3) {
		func_2561("revolver_ammo", 1, 5);
		func_2561("rifle_ammo", 1, 5);
		func_2561("samopal_ammo", 1, 5);
	}
}
...
// @pe
void func_114(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_213_object, object var_214_object)
{
...
void func_3220(int var_66_int, string var_67_string)
{
	int var_69_int;
...
void func_3225(bool var_26_bool, object var_27_object, bool var_28_bool)
{
...
void func_2715(object var_23_object)
{
...
void func_2721(cvector var_49_cvector, cvector var_50_cvector)
{
...
void func_2731(float var_93_float, cvector var_94_cvector, cvector var_95_cvector)
{
	var_93_float = (var_95_cvector - var_94_cvector) | (var_95_cvector - var_94_cvector);
}
...
// @pe
void func_2735(float var_535_float, float var_536_float, float var_537_float)
{
...
// @pe
void func_2742(float var_545_float, float var_546_float, float var_547_float, float var_548_float)
{
...
void func_2753(bool var_42_bool, int var_43_int, int var_44_int)
{
	int var_46_int;
...
void func_2758(object var_18_object)
{
...
{
	int var_83_int; bool var_84_bool; cvector var_85_cvector; object var_86_object;
	...
	for(;;) {
		func_635();
		@irand(var_83_int, 10);
		@Sleep((var_83_int + 5), var_84_bool);
		if(var_84_bool != 0) {
			func_640();
		} else {
		for(;;) {
			...
			float var_93_float; cvector var_95_cvector;
			var_85_cvector = var_95_cvector;
			func_2731(var_93_float, var_1_object, var_95_cvector);
			if(var_93_float > 40000) {
				@FindPathTo(var_86_object, var_1_object);
				if(var_86_object != null) {
					@RotatePath(var_86_object, var_84_bool);
					if(!var_84_bool) { //@nz
					} else {
					@FollowPath(var_86_object, false, var_84_bool);
					if(!var_84_bool) { //@nz
						goto Label_795;
					}
...
void func_2764(int var_240_int, string var_241_string)
{
	int var_243_int;
...
{
	func_2795(var_0_bool);
}


void func_2769(float var_553_float)
{
...
void func_1748(int var_562_int)
{
	var_562_int = 0;
}
...
void func_1757(bool var_587_bool)
{
	var_587_bool = true;
}
...
void func_2795(object var_223_object)
{
	bool var_225_bool;
...
// @pe
void func_243(object var_2_object, string var_220_string)
{
	bool var_221_bool;
...
// @pe
void func_2815(object var_24_object)
{
...
// @pe
void func_2820(bool var_255_bool)
{
	int var_257_int;
...
// @pe
void func_2832(bool var_238_bool)
{
	int var_240_int;
...
// @pe
void func_2844(bool var_269_bool)
{
	int var_271_int;
...
void func_2856(int var_204_int)
{
	int var_206_int;
...
// @pe
void func_3368(object var_321_object)
{
...
void func_2873(int var_150_int)
{
	int var_152_int;
...
// @pe
void func_3387(bool var_18_bool, object var_19_object)
{
	object var_21_object;
...
void func_2364(bool var_152_bool, object var_153_object, float var_154_float)
{
	...
	func_2721(var_179_cvector, (var_168_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_171_bool != 0)
		var_152_bool = false;
	@StopWorld();
	@CameraTransit((var_166_cvector + var_169_cvector), var_168_cvector, true);
	...
	if(var_195_bool != 0) {
		...
		if(var_172_bool == 0) goto Label_2427;
...
// @pe
void func_2879(object var_21_object)
{
	int var_22_int;
...
// @pe
void func_3394(object var_143_object)
{
	object var_144_object;
...
// @pe
void func_3400(bool var_18_bool, object var_19_object)
{
	object var_21_object;
	var_19_object = var_21_object;
	bool var_20_bool;
...
void func_2892(int var_51_int, int var_52_int)
{
...
// @pe
void func_3407(object var_141_object)
{
	object var_142_object;
...
// @pe
void func_3413(object var_144_object)
{
...
void func_3424(object var_136_object)
{
...
void func_2923(string var_156_string)
{
...
// @pe
void func_3448(object var_151_object)
{
	object var_152_object;
...
void func_1404(bool var_0_bool, object var_1_object, bool var_446_bool, float var_447_float)
{
	...
	if(var_453_bool != 0) {
		...
		func_1743(var_455_string);
		bool var_572_bool;
		func_2203(var_572_bool, var_0_bool);
		if(!var_572_bool) { //@nz
			@StopAsync();
			var_446_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_453_bool) { //@nz
				...
				func_1743(var_455_string);
				bool var_598_bool;
				func_2203(var_598_bool, var_0_bool);
				if(!var_598_bool) { //@nz
					@StopAsync();
					var_446_bool = false;
					return 8;
...
void func_2433(void)
{
	...
	if(var_316_bool != 0) {
		...
		if(var_314_bool == 0) goto Label_2450;
		@UnlookAsync("head");
	}
Label_2450:
...
// @pe
void func_3463(object var_18_object)
{
...
// @pe
void func_2451(bool var_322_bool, object var_323_object)
{
...
void func_2964(void)
{
	@ClearSubContainer(0);
	int var_45_int;
	func_2786(var_45_int);
	int var_43_int;
	var_45_int = var_43_int;
	func_2892(0, (100 + (var_43_int * 100)));
	func_2561("tourniquet", 1, 7);
	func_2561("bandage", 1, 7);
	func_2561("packet", 1, 10);
	func_2561("bottle_water", 1, 3);
	func_2572("rusk", 1, 3, 4);
	func_2561("hook", 1, 20);
	func_2561("watch", 1, 20);
	...
	if(var_113_bool != 0)
		func_2572("alpha_pills", 1, 2, 3);
	if(var_43_int >= 4)
		func_2572("beta_pills", 1, 4, 3);
	if(var_43_int >= 6) {
		func_2572("alpha_pills", 1, 2, 8);
		func_2572("gamma_pills", 1, 8, 3);
	}
	if(var_43_int >= 8) {
		func_2561("revolver_ammo", 1, 3);
		func_2561("rifle_ammo", 1, 3);
	}
	int var_146_int;
...
void func_2459(bool var_324_bool, object var_325_object, float var_326_float)
{
	cvector var_336_cvector;
	...
	SetByIndex(var_336_cvector, 1) = (var_343_float + var_335_float);
	cvector var_337_cvector;
	@GetPosition(var_337_cvector);
	@GetEyesHeight(var_335_float);
	var_344_float = GetByIndex(var_337_cvector, 1);
	SetByIndex(var_337_cvector, 1) = (var_344_float + var_335_float);
	cvector var_338_cvector = var_336_cvector - var_337_cvector;
	var_345_float = GetByIndex(var_338_cvector, 1);
	SetByIndex(var_338_cvector, 1) = (float)0;
	var_347_float = sqrt(var_338_cvector | var_338_cvector);
	var_338_cvector /= var_347_float;
	cvector var_339_cvector = -var_338_cvector;
	cvector var_340_cvector = (var_338_cvector * var_326_float) - [0.0, 10.0, 0.0];
	bool var_342_bool;
	@IsOverrideActive(var_342_bool);
	if(var_342_bool != 0)
		var_324_bool = false;
	@StopWorld();
	@CameraTransit((var_337_cvector + var_340_cvector), var_339_cvector, true);
...
void func_3527(bool var_20_bool, object var_21_object, object var_22_object, bool var_23_bool)
{
	bool var_25_bool;
	object var_27_object;
	var_22_object = var_27_object;
	bool var_26_bool;
	func_3225(var_26_bool, var_27_object, !var_23_bool);
	if(var_26_bool != 0) {
...
void func_2512(string var_295_string)
{
	bool var_299_bool; float var_300_float; float var_301_float;
	@lshHasAnimation(var_299_bool, var_295_string);
	if(var_299_bool != 0) {
		@lshGetAnimTimes(var_295_string, var_300_float, var_301_float);
		@lshPlayAnimation(var_300_float, var_301_float, false);
	} else {
		@Trace("Can't find lsh animation : " + var_295_string);
	}
	
}


void func_2528(string var_224_string, bool var_225_bool)
{
...
void func_3553(int var_201_int)
{
	var_201_int = 515572;
}


void func_3555(int var_200_int)
{
	var_200_int = 504031;
}


void func_3557(string var_202_string)
{
	var_202_string = "ui/NPC_Citizen2.png";
}


void func_3559(string var_203_string)
{
	var_203_string = "ui/NPC_Citizen2_b.png";
}


void func_3561(bool var_195_bool)
{
	var_195_bool = false;
}


void func_3563(bool var_20_bool, object var_21_object)
{
...
void func_2543(object var_247_object)
{
	float var_250_float;
