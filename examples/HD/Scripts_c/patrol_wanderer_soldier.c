...
void func_2059(void)
{
	@ClearSubContainer(0);
	int var_33_int;
	func_1915(var_33_int);
	int var_31_int;
	var_33_int = var_31_int;
	func_1987(0, (100 + (var_31_int * 100)));
...
void func_1059(bool var_582_bool, float var_583_float)
{
	float var_586_float; bool var_587_bool;
	@rand(var_586_float);
	if(var_586_float < var_583_float) {
...
void func_2603(bool var_14_bool, object var_15_object, object var_16_object, bool var_17_bool)
{
	bool var_19_bool;
	object var_21_object;
	var_16_object = var_21_object;
	bool var_20_bool;
	func_2320(var_20_bool, var_21_object, !var_17_bool);
	if(var_20_bool != 0) {
...
void func_2629(bool var_14_bool, object var_15_object)
{
...
{
	float var_79_float; cvector var_80_cvector; cvector var_81_cvector; bool var_82_bool; object var_83_object; bool var_84_bool;
	@rand(var_79_float, 0.5);
	@Sleep(var_79_float);
	...
	Label_102:
		object var_92_object; cvector var_93_cvector;
		...
		if(var_213_bool != 0) {
			...
			if(var_176_float >= (var_157_float * var_157_float)) {
				...
				if(var_339_bool != 0) {
					...
					var_602_bool = !var_601_bool; //@nz
					if(var_602_bool == 0) goto Label_821;
					bool var_603_bool;
					func_1609(var_603_bool, var_0_bool);
					if(!var_603_bool) { //@nz
						goto Label_831;
					}
					var_0_bool->GetPFPosition(var_170_cvector); //@t
...
void func_133(float var_88_float)
{
	float var_90_float;
...
void func_2186(void)
{
	@ClearSubContainer(0);
	int var_248_int;
	func_1915(var_248_int);
	int var_246_int;
	var_248_int = var_246_int;
	func_1987(0, (10 + (var_246_int * 5)));
	func_1786("bottle_water", 1, 3);
	func_1786("rusk", 1, 20);
	func_1786("hook", 1, 30);
...
void func_161(bool var_98_bool)
{
	var_98_bool = false;
}


void func_163(object var_92_object, cvector var_93_cvector)
{
...
void func_1770(bool var_114_bool)
{
	bool var_116_bool;
...
void func_235(void)
{
	int var_109_int; int var_110_int; bool var_111_bool; float var_112_float; bool var_113_bool;
	@WaitForAnimEnd();
	bool var_114_bool;
	...
	for(;;) {
		...
		if(var_131_bool != 0) {
			@irand(var_109_int, 3);
			if(var_109_int == 0) {
				if(var_107_int == 0) goto Label_282;
			...
			if(var_109_int == 1) {
				@rand(var_112_float, 4);
				@Sleep((var_112_float + 1), var_113_bool);
				if(!var_113_bool) { //@nz
					goto Label_311;
				}
			} else if(var_108_int != 0) {
				goto Label_311;
			}
			}
					bool var_143_bool;
					...
					if(var_144_bool == 0) goto Label_306;
			}
		}
	Label_311:
		for(;;) {
...
void func_1266(int var_556_int)
{
	var_556_int = 0;
}
...
void func_1275(bool var_581_bool)
{
	var_581_bool = true;
}
...
void func_2315(int var_54_int, string var_55_string)
{
	int var_57_int;
...
void func_2320(bool var_20_bool, object var_21_object, bool var_22_bool)
{
...
void func_314(bool var_143_bool)
{
	var_143_bool = true;
}
...
void func_883(bool var_0_bool, float var_477_float, int var_478_int)
{
	...
	if(var_482_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_556_int, var_484_float, var_493_float);
		object var_557_object; float var_558_float;
...
void func_1924(object var_14_object)
{
	bool var_16_bool;
...
void func_1944(string var_124_string, int var_125_int)
{
	string var_127_string = "idle";
	if(var_125_int != 0)
		var_127_string += var_125_int;
...
void func_922(bool var_0_bool, bool var_1_bool, bool var_440_bool, float var_441_float)
{
	...
	if(var_447_bool != 0) {
		...
		func_1261(var_449_string);
		bool var_566_bool;
		func_1609(var_566_bool, var_0_bool);
		if(!var_566_bool) { //@nz
			@StopAsync();
			var_440_bool = false;
			return 8;
		}
		float var_569_float; int var_570_int;
		var_441_float = var_569_float;
		func_883(var_449_string, var_569_float, var_570_int);
		var_448_int = 1;

		for(;;) {
			var_449_string = (("attack_middle" + var_570_int) + "_") + var_448_int;
			...
			if(!var_447_bool) { //@nz
				...
				func_1261(var_449_string);
				bool var_592_bool;
				func_1609(var_592_bool, var_0_bool);
				if(!var_592_bool) { //@nz
					@StopAsync();
					var_440_bool = false;
					return 8;
				}
				float var_595_float; int var_596_int;
...
// @pe
void func_2463(bool var_12_bool, object var_13_object)
{
	object var_15_object;
...
void func_1951(int var_118_int)
{
	int var_121_int; bool var_122_bool;
	var_121_int = 0;
...
// @pe
void func_2470(object var_76_object)
{
...
// @pe
void func_2476(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
...
void func_1968(int var_138_int)
{
	int var_140_int;
...
// @pe
void func_2483(object var_76_object)
{
	object var_77_object;
	var_76_object = var_77_object;
	func_2489(var_77_object);
...
// @pe
void func_1974(object var_15_object)
{
	int var_16_int;
...
// @pe
void func_2489(object var_77_object)
{
...
void func_1987(int var_39_int, int var_40_int)
{
...
void func_2500(object var_12_object)
{
...
// @pe
void func_2524(object var_145_object)
{
...
void func_2018(string var_144_string)
{
...
// @pe
void func_2539(object var_12_object)
{
