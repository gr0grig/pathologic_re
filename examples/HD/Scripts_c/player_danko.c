...
func_3280()
{
	...
	AddBlankActor(var_77_object, var_76_object, "player_death", "play_death_danko.bin");
	SetDeathState();
	return 4;
}
EMIT "Stack[-1] = 0";
