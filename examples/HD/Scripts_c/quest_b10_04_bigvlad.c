...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Distrust|W:cleanup|W:restore|W:player|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:b10q04PlennikTalk|W:branch|W:ui/NPC_BigVlad.png|W:ui/NPC_BigVlad_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x13f
// @RUN_TASK: 2
...
// @PE: 0x51,0xaa,0xc0,0x137,0x13f,0x164,0x1ad,0x1d3,0x1ef,0x3d0,0x3d6

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_bool)
{
	if((int)1 != 0) {
		func_915();
		var_12_bool = var_7_cvector == (int)31752;
		if(var_12_bool != 0) {
			var_13_bool = 0; var_14_object = Obj();
			var_14_object = var_1_object;
			func_982(var_14_object);
			...
			if(var_21_bool != 0) {
				...
				@@@var_0_object:SetMessage((int)530380);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)530381, (int)32786, (int)31753);
				@@@var_0_object:AddReply((int)530382, (int)32786, (int)31754);
				return 0;
			}
			var_50_string = "";
			func_170(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)530383);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)530384, (int)-1, (int)31756);
			@@@var_0_object:AddReply((int)531445, (int)-1, (int)32792);
			return 0;
		}
		var_59_bool = var_7_cvector == (int)32786;
		if(var_59_bool != 0) {
			var_60_string = "";
			func_170(var_8_bool, "Distrust");
			@@@var_0_object:SetMessage((int)531440);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)531441, (int)32788, (int)32787);
			@@@var_0_object:AddReply((int)531444, (int)32788, (int)32790);
			return 0;
		}
		var_69_bool = var_7_cvector == (int)32788;
		if(var_69_bool != 0) {
			var_70_string = "";
			func_170(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)531442);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)531443, (int)-1, (int)32789);
			@@@var_0_object:AddReply((int)531446, (int)-1, (int)32794);
			return 0;
		}
		var_3_string = true;
		var_78_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_17_bool == 0) goto Label_342;
		var_1_object = false;
	}
Label_342:
	return 2;
...
func_0(var_0_object, var_26_int, var_27_object)
{
	...
	func_644(var_37_bool, var_38_object, (float)70.0);
...
func_644(var_37_bool, var_38_object, var_39_float)
{
	...
	if(var_80_bool != 0) {
		...
		if(var_82_bool == 0) goto Label_707;
...
func_713()
{
	...
	if(var_268_bool != 0) {
		...
		if(var_270_bool == 0) goto Label_730;
		UnlookAsync("head");
	}
Label_730:
	return 2;
