...
void func_0(object var_0_object, int var_26_int, object var_27_object)
{
	...
	func_698(var_37_bool, var_38_object, 70.0);
	if(!var_37_bool) { //@nz
		var_26_int = -2;
		return 8;
	}
...
// @pe
void func_1036(bool var_200_bool)
{
	int var_202_int;
...
void func_785(bool var_98_bool, object var_99_object)
{
...
void func_659(bool var_45_bool)
{
	var_45_bool = true;
}
...
void func_666(float var_22_float, object var_23_object)
{
...
void func_923(string var_239_string)
{
...
void func_414(object var_0_object)
{
	bool var_7_bool;
	func_693(var_7_bool);
	if(!var_7_bool) //@nz
...
void func_674(bool var_15_bool, cvector var_16_cvector)
{
...
void func_1067(int var_85_int)
{
	var_85_int = 502872;
}


void func_939(string var_217_string, bool var_218_bool)
{
...
void func_1069(string var_87_string)
{
	var_87_string = "ui/NPC_MladVlad.png";
}


void func_684(bool var_11_bool, object var_12_object)
{
...
void func_1071(string var_88_string)
{
	var_88_string = "ui/NPC_MladVlad_b.png";
}


void func_428(bool var_32_bool)
{
...
void func_1073(bool var_80_bool)
{
	var_80_bool = true;
}


void func_693(bool var_7_bool)
{
	bool var_9_bool;
	@IsLoaded(var_9_bool);
...
void func_698(bool var_37_bool, object var_38_object, float var_39_float)
{
	...
	func_982(var_64_cvector, (var_53_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_80_bool != 0) {
		...
		if(var_57_bool == 0) goto Label_761;
...
void func_443(object var_0_object)
{
...
void func_954(bool var_132_bool, string var_133_string)
{
	bool var_135_bool;
	bool var_136_bool;
...
void func_448(bool var_15_bool)
{
...
void func_843(bool var_109_bool, object var_110_object)
{
		...
		if(var_38_bool != 0) {
			...
			goto Label_656;
				...
				Label_645:
					...
					if(var_46_bool == 0) goto Label_651;
			}
		}
	Label_656:
		for(;;) {
...
void func_976(object var_100_object)
{
...
void func_982(cvector var_64_cvector, cvector var_65_cvector)
{
...
void func_992(int var_202_int, string var_203_string)
{
	int var_205_int;
...
// @pe
void func_365(object var_25_object)
{
...
void func_1006(string var_31_string, int var_32_int)
{
...
void func_880(bool var_140_bool, object var_141_object)
{
...
void func_767(void)
{
	...
	if(var_268_bool != 0) {
		...
		if(var_266_bool == 0) goto Label_784;
		@UnlookAsync("head");
	}
Label_784:
