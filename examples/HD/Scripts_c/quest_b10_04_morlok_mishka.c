...
// @STRINGS: W:cleanup|W:player|W:head|W:all|A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:idle|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |A:add|A:GetItemID|W:Category|A:AddItem|A:DropItems|A:SetItemName|W:ui/NPC_Morlok.png|W:ui/NPC_Morlok_b.png|W:avroks blood is given|W:avroks_blood|W:b10q04MishkaTalk|W:b10q04MorlokGotoMishka|W:pt_map_mishka|A:AddMark|W:oob10MorlokMishka1|W:playsound|W:giveitem|A:ShowMap|W:b10q04NotkinTalk|W:b10q04Spi4kaTalk|W:b10q04LaskaTalk|W:b10q04|W:b10q04MorlokTalk|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:Can't find main outdoor scene|A:GetMap|A:GetLocator|W:Warning: outdoor scene locator |W: doesnt exist|W:Can't find map|A:SetMapParams|W:branch
// @GLOBALS: 0:object:
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_2_event_11(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_bool, var_6_bool, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int)
{
	if((int)1 != 0) {
		func_808();
		var_17_bool = var_13_int == (int)31789;
		if(var_17_bool != 0) {
		...
		var_88_bool = var_13_int == (int)31791;
		if(var_88_bool != 0) {
		...
		var_94_bool = var_13_int == (int)31793;
		if(var_94_bool != 0) {
		...
		var_124_bool = var_13_int == (int)31795;
		if(var_124_bool != 0) {
		...
		var_130_bool = var_12_int == (int)31890;
		if(var_130_bool != 0) {
			...
			if(var_139_bool != 0) {
				...
				@@@var_0_int:SetMessage((int)530543);
				@@@var_0_int:ClearReplies();
				@@@var_0_int:AddReply((int)530544, (int)-1, (int)31891);
				return 0;
			}
			var_161_bool = 0; var_162_object = Obj();
			var_162_object = var_1_int;
			func_1050(var_162_object);
			if(var_161_bool != 0) {
				var_167_string = "";
				func_446(var_13_int, "Neutral");
				@@@var_0_int:SetMessage((int)530416);
				@@@var_0_int:ClearReplies();
				@@@var_0_int:AddReply((int)530417, (int)-1, (int)31789);
				return 0;
			}
			var_172_string = "";
			func_446(var_13_int, "Neutral");
			@@@var_0_int:SetMessage((int)530418);
			@@@var_0_int:ClearReplies();
			var_174_bool = 0;
			var_174_bool = 0;
			var_175_bool = 0;
			...
			if(var_175_bool != 0) {
				...
				var_190_object = var_1_int;
				func_1062(var_190_object);
				if(var_189_bool != 0) {
					var_174_bool = 1;
				}
			}
			if(var_174_bool != 0) {
				@@@var_0_int:AddReply((int)530419, (int)31792, (int)31791);
			}
			@@@var_0_int:AddReply((int)530424, (int)-1, (int)31796);
			return 0;
		}
		var_202_bool = var_12_int == (int)31792;
		if(var_202_bool != 0) {
			...
			if(var_203_bool != 0) {
				var_224_string = "";
				func_446(var_13_int, "Neutral");
				@@@var_0_int:SetMessage((int)530420);
				@@@var_0_int:ClearReplies();
				@@@var_0_int:AddReply((int)530421, (int)-1, (int)31793);
				return 0;
			}
			...
			if(var_231_bool != 0) {
				var_232_string = "";
				func_446(var_13_int, "Neutral");
				@@@var_0_int:SetMessage((int)530422);
				@@@var_0_int:ClearReplies();
				@@@var_0_int:AddReply((int)530423, (int)-1, (int)31795);
				return 0;
			}
		}
		var_3_bool = true;
...
func_1038(var_182_bool)
{
	...
	var_187_bool = var_184_int == (int)-1;
	if(var_187_bool != 0) {
		var_182_bool = 1;
		return 0;
	}
...
func_930()
{
	...
	SetVariable("b10q04MishkaTalk", (int)1);
	func_1140(Obj());
	var_24_object = var_21_object;
	var_35_float = 0;
	func_880(var_35_float);
	@@var_21_object:AddMark("b10q04MorlokGotoMishka", "pt_map_mishka", (int)0, (int)530550, var_35_float);
	func_1086();
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_953()
{
	SetVariable("oob10MorlokMishka1", (int)1);
	return 0;
}
...
func_1086()
{
	...
	CreateDiaryEntry(var_39_object, (int)549, (int)2, (int)530440);
		...
		if(var_104_bool != 0) {
			...
			@@@var_0_int:AddReply((int)530544, (int)-1, (int)31891);
				...
				if(var_158_bool != 0) {
					...
					var_173_object = var_1_int;
					func_1062(var_173_object);
					if(var_172_bool != 0) {
						var_157_bool = 1;
					}
				}
