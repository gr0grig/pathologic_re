...
// @pe
void func_1038(bool var_188_bool)
{
	int var_190_int;
...
// @pe
void func_1050(bool var_182_bool)
{
	int var_184_int;
...
void func_930(void)
{
	...
	var_21_object->AddMark("b10q04MorlokGotoSpi4ka", "pt_map_spi4ka", 0, 530552, var_35_float);
	func_1086();
}
EMIT "Stack[-1] = 0";
...
// @pe
void func_1062(bool var_161_bool)
{
	int var_163_int;
...
void func_1086(void)
{
	...
	@CreateDiaryEntry(var_39_object, 548, 2, 530439);
