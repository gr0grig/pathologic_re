...
maintask task_2
{
	...
	{
		func_318(var_11_bool, (float)300, (float)100);
	}
	...
	{
		func_452(var_11_bool, var_12_object);
	...
	{
		if(var_6_int != 0)
			func_452(var_10_bool, var_11_bool);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, bool var_11_bool, int var_12_int)
	{
		if(var_12_int == 10) {
			bool var_15_bool;
			func_414(var_10_bool, var_11_bool, var_12_int, var_15_bool);
			if(var_15_bool != 0) {
				if(!var_2_object) { //@nz
					func_683(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_565(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_385(bool var_18_bool)
{
	var_18_bool = true;
}
...
// @pe
void func_387(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_21_float, float var_22_float)
{
	bool var_23_bool;
...
void func_652(string var_129_string)
{
...
void func_668(string var_99_string, bool var_100_bool)
{
...
void func_414(object var_0_object, object var_1_object, bool var_4_bool, bool var_15_bool)
{
	if(var_4_bool == null)
		var_15_bool = false;
	float var_19_float;
	func_552(var_19_float, var_4_bool);
...
void func_545(bool var_71_bool)
{
	var_71_bool = true;
}
...
void func_552(float var_19_float, object var_20_object)
{
...
void func_683(object var_29_object)
{
	float var_32_float;
...
void func_560(bool var_23_bool)
{
	bool var_25_bool;
...
void func_565(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_707(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_628;
...
void func_701(object var_19_object)
{
...
void func_318(int var_6_int, float var_12_float, float var_13_float)
{
	...
	for(;;) {
		...
		func_387(var_22_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
		var_6_int = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_707(cvector var_54_cvector, cvector var_55_cvector)
{
...
// @pe
void func_452(object var_2_object, string var_3_string)
{
	func_547();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_717(int var_115_int, string var_116_string)
{
	int var_118_int;
...
void func_336(int var_5_int)
{
	...
	bool var_16_bool;
	func_560(var_16_bool);
	if(!var_16_bool) { //@nz
		bool var_20_bool;
		func_385(var_20_bool);
		if(var_20_bool != 0)
			var_15_bool = true;
	}
	if(var_15_bool != 0) {
		object var_21_object;
		func_701(var_21_object);
...
void func_466(void)
{
	...
	for(;;) {
		...
		if(var_59_bool != 0) {
			@irand(var_39_int, 3);
			if(var_39_int == 0) {
				if(var_37_int == 0) goto Label_513;
				@irand(var_40_int, var_37_int);
				string var_68_string; int var_69_int;
				var_40_int = var_69_int;
				func_722(var_68_string, var_69_int);
			...
			if(var_39_int == 1) {
				...
				goto Label_542;
					...
					if(var_72_bool == 0) goto Label_537;
			}
		}
	Label_542:
		for(;;) {
...
void func_722(string var_52_string, int var_53_int)
{
...
// @pe
void func_762(bool var_113_bool)
{
	int var_115_int;
	func_717(var_115_int, "oob10Officer1");
	if(var_115_int == 0) {
		var_113_bool = true;
		return 0;
	}
...
void func_746(int var_76_int)
{
	var_76_int = 515597;
}


void func_748(int var_75_int)
{
	var_75_int = 514841;
}


void func_750(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png";
}


void func_752(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_754(bool var_70_bool)
{
	var_70_bool = false;
}
...
void func_634(void)
{
	...
	bool var_150_bool;
	func_754(var_150_bool);
	if(var_150_bool != 0) {
	} else {
		@HasAnimationTrack(var_148_bool, "head");
		if(var_148_bool == 0) goto Label_651;
		@UnlookAsync("head");
	}
Label_651:
