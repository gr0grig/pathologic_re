...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Dream|A:SetMessage|A:ClearReplies|A:AddReply|W:Neutral|W:all|W:idle|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:Can't find lsh animation : |W:ui/NPC_Anna.png|W:ui/NPC_Anna_b.png|W:b11q01KnowWhoKilled|W:b11q01VictimChoosed|W:b11q01KillAnna|W:volonteers_burah|W:disease|W:anna|W:Anna is diseased|W:oob11Anna1|W:b11q01|W:quest_b11_01|W:open_well_exit|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:branch
// @GLOBALS: 0:object:
// @RUN_OP: 0x261
// @RUN_TASK: 2
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int)
{
	if((int)1 != 0) {
		...
		var_63_bool = var_6_int == (int)23210;
		if(var_63_bool != 0) {
		...
		var_71_bool = var_5_int == (int)23204;
		if(var_71_bool != 0) {
			var_72_bool = 0;
			var_72_bool = 0;
			...
			if(var_72_bool != 0) {
				...
				func_1042();
				var_92_string = "";
				func_215(var_6_int, "Dream");
				@@@var_0_object:SetMessage((int)522034);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)523328, (int)24543, (int)24542);
				return 0;
			}
			var_113_bool = 0; var_114_object = Obj();
			var_114_object = var_1_object;
			func_1059(var_114_object);
			var_115_bool = var_113_bool == 0; //@nz
			if(var_115_bool != 0) {
				var_116_string = "";
				func_215(var_6_int, "Neutral");
				@@@var_0_object:SetMessage((int)522039);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)522040, (int)-1, (int)23210);
				@@@var_0_object:AddReply((int)522041, (int)-1, (int)23211);
				return 0;
			}
			var_124_string = "";
			func_215(var_6_int, "Neutral");
			@@@var_0_object:SetMessage((int)522042);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522043, (int)-1, (int)23213);
			var_129_bool = 0; var_130_object = Obj();
			var_130_object = var_1_object;
			func_1083(var_130_object);
			if(var_129_bool != 0) {
				@@@var_0_object:AddReply((int)522602, (int)-1, (int)23788);
			}
			var_138_bool = 0; var_139_object = Obj();
			var_139_object = var_1_object;
			func_1083(var_139_object);
			if(var_138_bool != 0) {
				@@@var_0_object:AddReply((int)522603, (int)-1, (int)23789);
			}
			return 0;
		}
		var_144_bool = var_5_int == (int)24543;
		if(var_144_bool != 0) {
			var_145_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523329);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523323, (int)24540, (int)24537);
			@@@var_0_object:AddReply((int)523322, (int)24538, (int)24536);
			@@@var_0_object:AddReply((int)522035, (int)24546, (int)23205);
			return 0;
		}
		var_157_bool = var_5_int == (int)24546;
		if(var_157_bool != 0) {
			var_158_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523332);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523337, (int)24555, (int)24551);
			@@@var_0_object:AddReply((int)541843, (int)24548, (int)44061);
			return 0;
		}
		var_167_bool = var_5_int == (int)24548;
		if(var_167_bool != 0) {
			var_168_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523334);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523335, (int)24550, (int)24549);
			return 0;
		}
		var_174_bool = var_5_int == (int)24555;
		if(var_174_bool != 0) {
			var_175_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523340);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523341, (int)24550, (int)24556);
			return 0;
		}
		var_181_bool = var_5_int == (int)24538;
		if(var_181_bool != 0) {
			var_182_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523324);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523325, (int)23214, (int)24539);
			return 0;
		}
		var_188_bool = var_5_int == (int)23214;
		if(var_188_bool != 0) {
			var_189_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)522044);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522045, (int)-1, (int)23215);
			@@@var_0_object:AddReply((int)523321, (int)24550, (int)24535);
			return 0;
		}
		var_198_bool = var_5_int == (int)24550;
		if(var_198_bool != 0) {
			var_199_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523336);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523338, (int)-1, (int)24553);
			@@@var_0_object:AddReply((int)523339, (int)-1, (int)24554);
			return 0;
		}
		var_208_bool = var_5_int == (int)24540;
		if(var_208_bool != 0) {
			var_209_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523326);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523327, (int)24544, (int)24541);
			return 0;
		}
		var_215_bool = var_5_int == (int)24544;
		if(var_215_bool != 0) {
			var_216_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)523330);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523331, (int)23206, (int)24545);
			return 0;
		}
		var_222_bool = var_5_int == (int)23206;
		if(var_222_bool != 0) {
			var_223_string = "";
			func_215(var_6_int, "Dream");
			@@@var_0_object:SetMessage((int)522036);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522037, (int)-1, (int)23207);
			@@@var_0_object:AddReply((int)522038, (int)-1, (int)23208);
			return 0;
		}
		var_3_string = true;
		var_231_bool = 0;
		func_1012(var_231_bool);
		if(var_231_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object)
{
	...
	if(var_8_bool != 0) {
		...
		func_658(var_9_bool, var_10_object);
		EventEnable(0);
		var_23_object = Obj();
...
func_0(var_0_object, var_24_int, var_25_object)
{
	...
	func_672(var_35_bool, var_36_object, (float)70.0);
...
func_1048()
{
	...
	func_971(var_29_bool, "quest_b11_01", "open_well_exit");
	return 0;
}
...
func_672(var_35_bool, var_36_object, var_37_float)
{
	...
	if(var_78_bool != 0) {
		...
		if(var_80_bool == 0) goto Label_735;
...
func_1059(var_199_bool)
{
	...
	func_966(var_201_int, "b11q01VictimChoosed");
...
func_1071(var_208_bool)
{
	...
	func_966(var_210_int, "oob11Anna1");
...
func_817(var_107_bool, var_108_object)
{
...
func_1083(var_273_bool)
{
	...
	func_966(var_275_int, "b11q01KillAnna");
...
func_1095()
{
	...
	func_1121(var_44_bool, var_45_object, (int)313);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_854(var_138_bool, var_139_object)
{
...
Label_863:
	...
	func_928(var_170_bool, var_171_string);
...
func_1010(var_86_string)
{
	var_86_string = "ui/NPC_Anna_b.png";
	return 0;
}
...
func_1023()
{
	...
	SetVariable("b11q01KillAnna", (int)1);
	var_17_bool = 0; var_18_string = ""; var_19_string = ""; var_20_string = "";
	func_983(var_17_bool, "volonteers_burah", "disease", "anna");
