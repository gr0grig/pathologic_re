...
maintask task_0
{
	void init(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, object var_6_object, object var_7_object, object var_8_object, object var_9_object, object var_10_object, object var_11_object, object var_12_object, object var_13_object, object var_14_object)
	{
		...
		@GetSceneByName(var_196_object, "termitnik2");
...
void func_636(bool var_155_bool, string var_156_string, string var_157_string, string var_158_string)
{
...
void func_1283(bool var_86_bool)
{
	int var_88_int;
...
void func_1029(bool var_201_bool)
{
	var_201_bool = false;
...
// @pe
void func_774(object var_131_object, bool var_132_bool, int var_133_int)
{
	var_131_object->add(18);
	var_131_object->add(24);
	var_131_object->add(20);
	var_131_object->add(14);
	if(var_132_bool == false) {
		var_131_object->add(10);
		var_131_object->add(17);
		var_131_object->add(8);
	} else if(var_133_int != 1) {
		var_131_object->add(10);
	}
...
void func_1290(bool var_96_bool)
{
	int var_98_int;
...
void func_1297(bool var_24_bool)
{
	bool var_26_bool;
...
// @pe
void func_1048(int var_162_int)
{
...
void func_668(void)
{
	...
	@CreateDiaryEntry(var_165_object, 613, 1, 532002);
	bool var_169_bool; object var_170_object;
	var_165_object = var_170_object;
	func_707(var_169_bool, var_170_object, -1);
}
EMIT "Stack[-1] = 0";


void func_1053(int var_69_int)
{
	int var_71_int;
...
void func_930(bool var_90_bool)
{
	...
	while(var_97_int < var_96_int) {
		...
		bool var_116_bool; int var_117_int;
...
void func_681(void)
{
	...
	@CreateDiaryEntry(var_188_object, 694, 1, 535402);
	bool var_192_bool; object var_193_object;
	var_188_object = var_193_object;
	func_707(var_192_bool, var_193_object, 613);
}
EMIT "Stack[-1] = 0";
...
void func_566(object var_323_object)
{
...
void func_707(bool var_169_bool, object var_170_object, int var_171_int)
{
	...
	if(!var_176_object) { //@nz
		@Trace("Can't find diary parent with id: " + var_171_int);
		var_169_bool = false;
	}
...
void func_583(object var_214_object, object var_215_object, string var_216_string, string var_217_string, string var_218_string)
{
	bool var_223_bool; cvector var_224_cvector; cvector var_225_cvector;
	var_215_object->GetLocator(var_216_string, var_223_bool, var_224_cvector, var_225_cvector);
	if(!var_223_bool) //@nz
		@Trace(("Locator " + var_216_string) + " doesn't exist");
	else
		@AddActor(Obj(), var_217_string, var_215_object, var_224_cvector, var_225_cvector, var_218_string);
	object var_226_object = var_214_object;
...
// @pe
void func_840(object var_54_object, bool var_55_bool)
{
	var_54_object->add(7);
...
void func_968(bool var_45_bool)
{
...
void func_601(object var_195_object, object var_196_object, string var_197_string, string var_198_string, string var_199_string)
{
	bool var_204_bool; cvector var_205_cvector; cvector var_206_cvector;
	var_196_object->GetLocator(var_197_string, var_204_bool, var_205_cvector, var_206_cvector);
	if(!var_204_bool) //@nz
		@Trace(("Locator " + var_197_string) + " doesn't exist");
	else
		var_196_object->AddStationaryActor(Obj(), var_205_cvector, var_206_cvector, var_198_string, var_199_string);
	object var_207_object = var_195_object;
...
void func_872(bool var_79_bool, int var_80_int)
{
	int var_82_int;
...
void func_1006(bool var_42_bool)
{
	int var_44_int = 0;
	bool var_45_bool;
...
void func_882(bool var_70_bool, int var_71_int)
{
	int var_73_int;
...
void func_892(bool var_122_bool)
{
	object var_127_object; int var_130_int;
	@CreateIntVector(var_127_object);
	object var_131_object;
	var_127_object = var_131_object;
	func_774(var_131_object, false, -1);
	int var_128_int;
	...
	while(var_129_int < var_128_int) {
		...
		bool var_148_bool; int var_149_int;
