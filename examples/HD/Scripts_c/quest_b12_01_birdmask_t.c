...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:b12q01TheaterIsVisited|W:player|W:head|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |W:ui/NPC_bmask.png|W:ui/NPC_bmask_b.png|W:oob12BirdmaskT1|W:quest_b12_01|W:init_theater|W:oob12BirdmaskT2|W:b12q01ChildsAreVisited|W:branch|A:add|W:vol_|A:size|A:get
// @GLOBALS: 0:object:
// @RUN_OP: 0x205
// @RUN_TASK: 2
...
// @PE: 0x4a,0xe3,0xf9,0x221,0x24b,0x262,0x398,0x39e,0x3a5,0x3ab,0x3b5,0x3c1,0x3cd,0x3d9,0x3f0,0x411,0x432

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_852();
		var_15_bool = var_11_object == (int)23339;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_11_object == (int)23898;
		if(var_21_bool != 0) {
		...
		var_31_bool = var_10_bool == (int)23338;
		if(var_31_bool != 0) {
			...
			if(var_144_bool != 0) {
				...
				@@@var_0_object:SetMessage((int)522171);
				@@@var_0_object:ClearReplies();
				var_163_bool = 0; var_164_object = Obj();
				var_164_object = var_1_object;
				func_973(var_164_object);
				if(var_163_bool != 0) {
					@@@var_0_object:AddReply((int)522172, (int)23999, (int)23339);
				}
				@@@var_0_object:AddReply((int)523159, (int)-1, (int)24361);
				return 0;
			}
			var_177_bool = 0; var_178_object = Obj();
			var_178_object = var_1_object;
			func_961(var_178_object);
			var_183_bool = var_177_bool == 0; //@nz
			if(var_183_bool != 0) {
				var_184_string = "";
				func_227(var_11_object, "Neutral");
				@@@var_0_object:SetMessage((int)541621);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)541622, (int)43795, (int)43794);
				@@@var_0_object:AddReply((int)541626, (int)-1, (int)43798);
				return 0;
			}
			var_192_bool = 0;
			var_192_bool = 0;
			...
			if(var_192_bool != 0) {
				...
				var_208_string = "";
				func_227(var_11_object, "Neutral");
				@@@var_0_object:SetMessage((int)522704);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)522705, (int)-1, (int)23898);
				return 0;
			}
			var_213_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)522706);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522707, (int)-1, (int)23900);
			return 0;
		}
		var_219_bool = var_10_bool == (int)43795;
		if(var_219_bool != 0) {
			var_220_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)541623);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541624, (int)-1, (int)43796);
			@@@var_0_object:AddReply((int)541627, (int)-1, (int)43799);
			return 0;
		}
		var_229_bool = var_10_bool == (int)23999;
		if(var_229_bool != 0) {
			var_230_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)522816);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522817, (int)24001, (int)24000);
			@@@var_0_object:AddReply((int)522819, (int)24003, (int)24002);
			return 0;
		}
		var_239_bool = var_10_bool == (int)24003;
		if(var_239_bool != 0) {
			var_240_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)522820);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522821, (int)24006, (int)24004);
			@@@var_0_object:AddReply((int)522822, (int)-1, (int)24005);
			return 0;
		}
		var_249_bool = var_10_bool == (int)24006;
		if(var_249_bool != 0) {
			var_250_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)522823);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522824, (int)-1, (int)24007);
			@@@var_0_object:AddReply((int)522825, (int)-1, (int)24008);
			return 0;
		}
		var_259_bool = var_10_bool == (int)24001;
		if(var_259_bool != 0) {
			var_260_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)522818);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522826, (int)-1, (int)24009);
			@@@var_0_object:AddReply((int)522827, (int)-1, (int)24010);
			return 0;
		}
		var_3_string = true;
		var_268_bool = 0;
...
task_2_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_object)
{
	...
	GetVariable("b12q01TheaterIsVisited", var_12_int);
...
func_920()
{
	SetVariable("oob12BirdmaskT1", (int)1);
	return 0;
}
...
func_926()
{
	...
	func_874(var_24_bool, "quest_b12_01", "init_theater");
	return 0;
}
...
func_933()
{
	SetVariable("oob12BirdmaskT2", (int)1);
	return 0;
}
...
func_949(var_279_bool)
{
	...
	func_869(var_281_int, "oob12BirdmaskT1");
...
func_961(var_260_bool)
{
	...
	func_869(var_262_int, "b12q01ChildsAreVisited");
...
func_973(var_228_bool)
{
	...
	func_869(var_230_int, "oob12BirdmaskT2");
