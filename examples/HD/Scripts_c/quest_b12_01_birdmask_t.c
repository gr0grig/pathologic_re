	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 23338) {
				...
				if(!var_177_bool) { //@nz
					func_227(var_11_object, "Neutral");
					var_0_object->SetMessage(541621); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(541622, 43795, 43794); //@t
					var_0_object->AddReply(541626, -1, 43798); //@t
					return 0;
				}
				bool var_192_bool = false;
				bool var_193_bool = false;
				bool var_194_bool;
				func_939(var_194_bool, var_1_object);
				if(var_194_bool != 0) {
					bool var_196_bool;
				...
				if(var_192_bool != 0) {
					...
					func_920();
					func_227(var_11_object, "Neutral");
					var_0_object->SetMessage(522704); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(522705, -1, 23898); //@t
					return 0;
				}
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(522706); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(522707, -1, 23900); //@t
				return 0;
			}
			if(var_10_bool == 43795) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(541623); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(541624, -1, 43796); //@t
				var_0_object->AddReply(541627, -1, 43799); //@t
				return 0;
			}
			if(var_10_bool == 23999) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(522816); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(522817, 24001, 24000); //@t
				var_0_object->AddReply(522819, 24003, 24002); //@t
				return 0;
			}
			if(var_10_bool == 24003) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(522820); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(522821, 24006, 24004); //@t
				var_0_object->AddReply(522822, -1, 24005); //@t
				return 0;
			}
			if(var_10_bool == 24006) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(522823); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(522824, -1, 24007); //@t
				var_0_object->AddReply(522825, -1, 24008); //@t
				return 0;
			}
			if(var_10_bool == 24001) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(522818); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(522826, -1, 24009); //@t
				var_0_object->AddReply(522827, -1, 24010); //@t
				return 0;
			}
			var_3_string = true;
			bool var_268_bool;
...
// @pe
void func_949(bool var_279_bool)
{
	int var_281_int;
...
// @pe
void func_961(bool var_260_bool)
{
	int var_262_int;
...
Label_137:
	...
	bool var_277_bool;
	func_939(var_277_bool, var_1_object);
	if(var_277_bool != 0) {
		bool var_279_bool;
		func_949(var_1_object);
		if(var_279_bool != 0)
