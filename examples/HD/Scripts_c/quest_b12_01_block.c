...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Doubt|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:Door |W: not found|W:locked|A:SetProperty|W:game_final|W:isobor@door1|W:b12q01DankoInSobor|W:b12q01KlaraInSobor|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:branch|W:ui/NPC_Block.png|W:ui/NPC_Block_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x25e
// @RUN_TASK: 2
...
// @PE: 0x51,0xb9,0xcf,0x25e,0x262,0x3e1,0x3e7,0x3ed,0x3f3,0x3fa,0x3ff,0x404,0x409,0x40f,0x414,0x420,0x42c

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_939();
		var_11_bool = var_7_bool == (int)24053;
		if(var_11_bool != 0) {
		...
		var_54_bool = var_7_bool == (int)41989;
		if(var_54_bool != 0) {
		...
		var_72_bool = var_7_bool == (int)24059;
		if(var_72_bool != 0) {
		...
		var_90_bool = var_7_bool == (int)42261;
		if(var_90_bool != 0) {
		...
		var_108_bool = var_6_int == (int)24039;
		if(var_108_bool != 0) {
			var_109_bool = 0; var_110_object = Obj();
			var_110_object = var_1_object;
			func_1044(var_110_object);
			var_117_bool = var_109_bool == 0; //@nz
			if(var_117_bool != 0) {
				var_118_string = "";
				func_185(var_7_bool, "Neutral");
				@@@var_0_object:SetMessage((int)522855);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)523022, (int)24216, (int)24215);
				@@@var_0_object:AddReply((int)522876, (int)33440, (int)24060);
				var_142_bool = 0; var_143_object = Obj();
				var_143_object = var_1_object;
				func_1056(var_143_object);
				if(var_142_bool != 0) {
					@@@var_0_object:AddReply((int)540014, (int)41986, (int)41985);
				}
				var_151_bool = 0; var_152_object = Obj();
				var_152_object = var_1_object;
				func_1068(var_152_object);
				if(var_151_bool != 0) {
					@@@var_0_object:AddReply((int)522878, (int)33448, (int)24064);
				}
				@@@var_0_object:AddReply((int)540279, (int)42260, (int)42259);
				return 0;
			}
			var_163_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)523170);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523172, (int)-1, (int)24374);
			return 0;
		}
		var_169_bool = var_6_int == (int)42260;
		if(var_169_bool != 0) {
			var_170_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)540280);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540281, (int)-1, (int)42261);
			return 0;
		}
		var_176_bool = var_6_int == (int)33448;
		if(var_176_bool != 0) {
			var_177_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)532048);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)532049, (int)24055, (int)33449);
			return 0;
		}
		var_183_bool = var_6_int == (int)24055;
		if(var_183_bool != 0) {
			var_184_string = "";
			func_185(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)522871);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522875, (int)-1, (int)24059);
			return 0;
		}
		var_190_bool = var_6_int == (int)41986;
		if(var_190_bool != 0) {
			var_191_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)540015);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540016, (int)41988, (int)41987);
			return 0;
		}
		var_197_bool = var_6_int == (int)41988;
		if(var_197_bool != 0) {
			var_198_string = "";
			func_185(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)540017);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540018, (int)-1, (int)41989);
			return 0;
		}
		var_204_bool = var_6_int == (int)33440;
		if(var_204_bool != 0) {
			var_205_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)532040);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)532041, (int)41997, (int)33441);
			return 0;
		}
		var_211_bool = var_6_int == (int)41997;
		if(var_211_bool != 0) {
			var_212_string = "";
			func_185(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)540026);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540027, (int)33442, (int)41998);
			return 0;
		}
		var_218_bool = var_6_int == (int)33442;
		if(var_218_bool != 0) {
			var_219_string = "";
			func_185(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)532042);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)532043, (int)33446, (int)33443);
			return 0;
		}
		var_225_bool = var_6_int == (int)33446;
		if(var_225_bool != 0) {
			var_226_string = "";
			func_185(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)532046);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)532047, (int)24049, (int)33447);
			@@@var_0_object:AddReply((int)540114, (int)42082, (int)42081);
			return 0;
		}
		var_235_bool = var_6_int == (int)42082;
		if(var_235_bool != 0) {
			var_236_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)540115);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540116, (int)42084, (int)42083);
			return 0;
		}
		var_242_bool = var_6_int == (int)42084;
		if(var_242_bool != 0) {
			var_243_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)540117);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540118, (int)24049, (int)42085);
			return 0;
		}
		var_249_bool = var_6_int == (int)24049;
		if(var_249_bool != 0) {
			var_250_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)522865);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)522869, (int)-1, (int)24053);
			return 0;
		}
		var_256_bool = var_6_int == (int)24216;
		if(var_256_bool != 0) {
			var_257_string = "";
			func_185(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)523023);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523024, (int)-1, (int)24217);
			return 0;
		}
		var_3_string = true;
		var_262_bool = 0;
		func_1198(var_262_bool);
		if(var_262_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_11_bool != 0) {
			var_14_object = Obj();
			func_946(var_14_object);
			RemoveActor(var_14_object);
		}
	} else {
		var_18_bool = var_6_string == "restore";
		if(var_18_bool == 0) goto Label_649;
		var_0_object = false;
	}
Label_649:
	return 2;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_668(var_18_bool, var_19_object, (float)70.0);
...
func_1044(var_181_bool)
{
	...
	func_962(var_183_int, "game_final");
...
func_668(var_18_bool, var_19_object, var_20_float)
{
	...
	if(var_61_bool != 0) {
		...
		if(var_63_bool == 0) goto Label_731;
...
func_1056(var_214_bool)
{
	...
	func_962(var_216_int, "b12q01DankoInSobor");
...
func_1068(var_223_bool)
{
	...
	func_962(var_225_int, "b12q01KlaraInSobor");
...
func_813(var_90_bool, var_91_object)
{
...
func_1080()
{
	...
	CreateDiaryEntry(var_100_object, (int)772, (int)1, (int)540273);
	var_104_bool = 0; var_105_object = Obj(); var_106_int = 0;
	var_100_object = var_105_object;
	func_1145(var_104_bool, var_105_object, (int)613);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_1093()
{
	...
	CreateDiaryEntry(var_82_object, (int)618, (int)1, (int)532007);
	var_86_bool = 0; var_87_object = Obj(); var_88_int = 0;
	var_82_object = var_87_object;
	func_1145(var_86_bool, var_87_object, (int)613);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_81(var_0_object, var_1_object, var_2_object, var_3_string, var_174_object, var_175_object)
{
	...
	if((int)1 != 0) {
		...
		func_1044(var_182_object);
		var_189_bool = var_181_bool == 0; //@nz
		if(var_189_bool != 0) {
			var_190_string = "";
			func_185(var_175_object, "Neutral");
			@@@var_0_object:SetMessage((int)522855);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)523022, (int)24216, (int)24215);
			@@@var_0_object:AddReply((int)522876, (int)33440, (int)24060);
...
func_850(var_121_bool, var_122_object)
{
...
Label_859:
	...
	func_924(var_153_bool, var_154_string);
...
func_1106()
{
	...
	CreateDiaryEntry(var_31_object, (int)616, (int)1, (int)532005);
	var_35_bool = 0; var_36_object = Obj(); var_37_int = 0;
	var_31_object = var_36_object;
	func_1145(var_35_bool, var_36_object, (int)613);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_1119()
{
	...
	CreateDiaryEntry(var_64_object, (int)617, (int)1, (int)532006);
	var_68_bool = 0; var_69_object = Obj(); var_70_int = 0;
	var_64_object = var_69_object;
	func_1145(var_68_bool, var_69_object, (int)613);
	return 2;
}
EMIT "Stack[-1] = 0";
