...
// @STRINGS: W:quest_b12_01|W:theater_cutscene_end|W:theater|W:cs_d12_theater_birdmask|W:cs_play_all.bin|W:cs_d12_theater_whitemask|A:ForceGeometryLoad|W:player|W:cs_d12_theater.mot|W:noaccess|A:HasProperty|A:GetProperty|A:SetProperty|A:RemoveProperty
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
main()
{
	...
	func_118(var_46_bool, "quest_b12_01", "theater_cutscene_end");
	var_52_object = Obj();
