...
maintask task_0
{
	...
	Label_49:
		...
		if(!(var_1_string == "cleanup")) goto Label_49;
		func_69(var_3_object);
	}
...
void func_129(bool var_1_bool, string var_2_string, string var_3_string)
{
	object var_5_object;
...
void func_69(object var_0_object)
{
	if(var_0_object != 0) {
...
void func_105(object var_16_object)
{
...
void func_111(object var_6_object, object var_7_object, string var_8_string, string var_9_string, string var_10_string)
{
