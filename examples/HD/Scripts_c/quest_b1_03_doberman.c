...
maintask task_2
{
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, object var_5_object, object var_6_object, cvector var_7_cvector, bool var_8_bool, object var_9_object, int var_10_int, int var_11_int, bool var_12_bool, float var_13_float, int var_14_int, bool var_15_bool, object var_16_object, bool var_17_bool)
	{
		...
		if(var_19_int == 0) {
			...
			func_2406(var_152_bool, var_153_object, 0.05);
...
// @pe
void func_2561(object var_21_object)
{
	int var_22_int;
...
void func_2305(object var_21_object)
{
	float var_24_float;
...
void func_2574(int var_80_int)
{
	var_80_int = 518097;
}


void func_2576(int var_79_int)
{
	var_79_int = 518096;
}
...
// @pe
void func_529(object var_190_object)
{
	func_2584();
	object var_199_object;
	func_582(var_192_cvector, var_193_bool, var_199_object, var_199_object);
}


void func_2578(string var_81_string)
{
...
void func_2580(string var_82_string)
{
	var_82_string = "ui/NPC_Citizen2_b.png";
}


void func_2323(string var_102_string)
{
	...
	if(var_124_bool == 0) goto Label_2343;
}


void func_2582(bool var_74_bool)
{
	var_74_bool = false;
}
...
// @pe
void func_2594(object var_18_object)
{
	...
	if(var_19_bool != 0) {
		...
		func_2406(var_23_bool, var_24_object, -0.1);
		bool var_61_bool;
...
void func_552(object var_0_object, cvector var_31_cvector, float var_32_float)
{
	...
	func_2370(var_47_cvector, (var_39_cvector - var_40_cvector));
	func_2370(var_45_cvector, (var_47_cvector + (var_41_cvector * 0.75)));
...
void func_1068(object var_0_object, object var_1_object, bool var_356_bool, float var_357_float)
{
	...
	if(var_363_bool != 0) {
		...
		func_1407(var_365_string);
		bool var_482_bool;
		func_2021(var_482_bool, var_0_object);
		if(!var_482_bool) { //@nz
			@StopAsync();
			var_356_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_363_bool) { //@nz
				...
				func_1407(var_365_string);
				bool var_508_bool;
				func_2021(var_508_bool, var_0_object);
				if(!var_508_bool) { //@nz
					@StopAsync();
					var_356_bool = false;
					return 8;
...
void func_2364(object var_69_object)
{
...
void func_2370(cvector var_49_cvector, cvector var_50_cvector)
{
...
void func_582(object var_0_object, object var_1_object, object var_2_object, object var_199_object)
{
	float var_206_float; cvector var_208_cvector; float var_209_float;
	cvector var_210_cvector;
	func_552(var_209_float, var_210_cvector, 1.7453294);
	cvector var_205_cvector;
	var_210_cvector = var_205_cvector;
	if((var_205_cvector | var_205_cvector) < 2500.0) {
		cvector var_237_cvector;
		func_552(var_209_float, var_237_cvector, 2.6179938);
		var_237_cvector = var_205_cvector;
		var_206_float = var_205_cvector | var_205_cvector;
		if(var_206_float < 2500.0) {
			var_242_float = sqrt(var_206_float);
			@Trace("Can't retreat, distance: " + var_242_float);
			@Sleep(0.5);
			return 10;
		}
	}
...
Label_624:
	bool var_207_bool;
	@MovePoint((var_247_cvector + var_205_cvector), 1, var_207_bool);
	if(var_207_bool != 0) {
		...
		Label_654:
			...
			cvector var_255_cvector;
			func_552(var_209_float, var_255_cvector, 2.6179938);
			var_255_cvector = var_208_cvector;
			if((var_208_cvector | var_208_cvector) >= 2500.0) {
...
// @pe
void func_2380(float var_445_float, float var_446_float, float var_447_float)
{
...
// @pe
void func_2387(float var_52_float, float var_53_float, float var_54_float, float var_55_float)
{
...
void func_1885(bool var_34_bool, object var_35_object, string var_36_string, float var_37_float, float var_38_float, float var_39_float)
{
	...
	func_2387(var_52_float, (var_41_float + var_37_float), var_54_float, var_55_float);
...
// @pe
void func_2398(float var_80_float, cvector var_81_cvector, cvector var_82_cvector)
{
...
// @pe
void func_2657(bool var_18_bool, object var_19_object)
{
	object var_21_object;
...
// @pe
void func_2406(bool var_23_bool, object var_24_object, float var_25_float)
{
	if(!var_24_object) { //@nz
		var_23_bool = false;
		return 0;
...
// @pe
void func_2664(object var_55_object)
{
...
void func_1907(float var_407_float, object var_408_object, float var_409_float, int var_410_int)
{
	...
	float var_445_float;
	func_2380(var_445_float, ((var_420_int + var_422_int) / 100.0), (float)1);
	float var_423_float;
	...
	float var_455_float;
	func_2387(var_455_float, (var_424_float - var_425_float), (float)0, (float)1);
...
void func_1412(int var_472_int)
{
	var_472_int = 0;
}
...
void func_2441(float var_463_float)
{
...
void func_2187(bool var_31_bool, object var_32_object, float var_33_float)
{
	...
	func_2370(var_58_cvector, (var_47_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_74_bool != 0) {
		...
		if(var_51_bool == 0) goto Label_2250;
...
void func_1421(bool var_497_bool)
{
	var_497_bool = true;
}
...
void func_2458(float var_30_float)
{
...
void func_2468(bool var_61_bool, string var_62_string, string var_63_string)
{
...
void func_2480(object var_20_object)
{
	bool var_22_bool;
	@IsPlayerActor(var_20_object, var_22_bool);
	if(var_22_bool != 0)
...
void func_1205(bool var_498_bool, float var_499_float)
{
...
void func_2500(string var_42_string, int var_43_int)
{
...
void func_2256(void)
{
	...
	if(var_146_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_2273;
		@UnlookAsync("head");
	}
Label_2273:
...
// @pe
void func_2524(object var_31_object)
{
...
// @pe
void func_2529(object var_24_object)
{
...
void func_2274(string var_125_string)
{
...
void func_2290(string var_103_string, bool var_104_bool)
{
		...
		if(var_127_bool != 0) {
			...
			if(var_90_float >= (var_71_float * var_71_float)) {
				...
				if(var_255_bool != 0) {
					...
					bool var_519_bool;
					func_2021(var_519_bool, var_0_object);
					if(!var_519_bool) { //@nz
						goto Label_977;
					}
					var_0_object->GetPFPosition(var_84_cvector); //@t
