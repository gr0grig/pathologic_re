...
void func_2059(float var_24_float)
{
...
void func_2069(object var_13_object)
{
	bool var_15_bool;
		...
		if(var_265_bool != 0) {
			...
			if(var_228_float >= (var_209_float * var_209_float)) {
				...
				if(var_389_bool != 0) {
					...
					bool var_670_bool;
					func_1704(var_670_bool, var_0_object);
					if(!var_670_bool) { //@nz
						goto Label_751;
					}
					var_0_object->GetPFPosition(var_222_cvector); //@t
...
void func_2089(bool var_619_bool)
{
	bool var_621_bool;
...
void func_2095(string var_35_string, int var_36_int)
{
...
// @pe
void func_2119(object var_11_object)
{
...
void func_1632(bool var_608_bool, object var_609_object)
{
...
// @pe
void func_2164(bool var_15_bool, object var_16_object)
{
...
// @pe
void func_2171(object var_51_object)
{
...
// @pe
void func_2183(object var_14_object)
{
	int var_15_int;
...
void func_2196(string var_61_string)
{
...
void func_1193(bool var_648_bool)
{
	var_648_bool = true;
}
...
void func_2237(object var_52_object)
{
...
void func_2257(cvector var_142_cvector, cvector var_143_cvector, cvector var_144_cvector, float var_145_float)
{
...
// @pe
void func_2294(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_803(object var_0_object, float var_523_float, int var_524_int)
{
	...
	if(var_528_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_602_int, var_530_float, var_539_float);
...
void func_299(bool var_61_bool, object var_62_object, bool var_84_bool, object var_689_object)
{
...
void func_842(object var_0_object, bool var_1_bool, bool var_490_bool, float var_491_float)
{
	...
	if(var_497_bool != 0) {
		...
		func_1183(var_499_string);
		bool var_633_bool;
		func_1704(var_633_bool, var_0_object);
		if(!var_633_bool) { //@nz
			@StopAsync();
			var_490_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_497_bool) { //@nz
				...
				func_1183(var_499_string);
				bool var_659_bool;
				func_1704(var_659_bool, var_0_object);
				if(!var_659_bool) { //@nz
					@StopAsync();
					var_490_bool = false;
					return 8;
...
void func_336(object var_0_object, bool var_82_bool, object var_83_object, object var_200_object)
{
	...
	func_2257(var_142_cvector, var_143_cvector, var_144_cvector, 2000.0);
...
void func_981(bool var_649_bool, float var_650_float)
{
...
// @pe
void func_498(object var_603_object, float var_604_float)
{
