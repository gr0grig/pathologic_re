// @IMPORTS: FindActor/2,SetTimer/2,KillTimer/1,UnlookAsync/1,WaitForAnimEnd/0,irand/2,PlayAnimation/2,WaitForAnimEnd/1,rand/2,Sleep/2,ResetAAS/0,GetPosition/1,IsLoaded/1,LookAsync/3,HasAnimation/3
...
Label_90:
	...
	if(var_44_bool != 0) {
		...
		if(var_50_bool != 0) {
			...
			if(var_51_int == 0) goto Label_123;
			...
			if(var_55_bool != 0) {
				...
				if(var_65_int == 0) goto Label_141;
				goto Label_152;
		}
		Label_141:
			var_56_bool = 0;
