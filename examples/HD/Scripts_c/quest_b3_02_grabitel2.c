...
void func_0(bool var_0_bool, bool var_79_bool, object var_80_object, object var_197_object)
{
	...
	func_2112(var_139_cvector, var_140_cvector, var_141_cvector, 2000.0);
...
void func_2052(float var_28_float)
{
...
void func_2062(object var_96_object)
{
	bool var_98_bool;
...
void func_2082(bool var_616_bool)
{
	bool var_618_bool;
...
void func_2112(cvector var_139_cvector, cvector var_140_cvector, cvector var_141_cvector, float var_142_float)
{
...
void func_1609(bool var_605_bool, object var_606_object)
{
	...
	float var_608_float;
	var_615_object->GetProperty("health", var_608_float);
	var_605_bool = var_608_float <= 0.0;
}
...
void func_2147(int var_102_int)
{
	int var_104_int;
...
void func_2166(int var_65_int, int var_66_int)
{
...
void func_645(bool var_646_bool, float var_647_float)
{
	float var_650_float; bool var_651_bool;
	@rand(var_650_float);
	if(var_650_float < var_647_float) {
...
void func_2197(string var_108_string)
{
...
// @pe
void func_162(object var_600_object, float var_601_float)
{
		...
		if(var_262_bool != 0) {
			...
			if(var_225_float >= (var_206_float * var_206_float)) {
				...
				if(var_386_bool != 0) {
					...
					var_666_bool = !var_665_bool; //@nz
					if(var_666_bool == 0) goto Label_405;
					bool var_667_bool;
					func_1681(var_667_bool, var_0_bool);
					if(!var_667_bool) { //@nz
						goto Label_415;
					}
					var_0_bool->GetPFPosition(var_219_cvector); //@t
...
void func_2268(int var_77_int, string var_78_string)
{
	int var_80_int;
...
void func_2273(object var_11_object)
{
...
// @pe
void func_2336(bool var_15_bool, object var_16_object)
{
...
// @pe
void func_2343(object var_51_object)
{
...
// @pe
void func_2351(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_2354(object var_52_object)
{
...
void func_857(bool var_645_bool)
{
	var_645_bool = true;
}
...
void func_1431(bool var_58_bool, object var_59_object, bool var_81_bool, object var_686_object)
{
...
void func_467(bool var_0_bool, float var_520_float, int var_521_int)
{
	...
	if(var_525_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_599_int, var_527_float, var_536_float);
		object var_600_object; float var_601_float;
...
void func_506(bool var_0_bool, object var_1_object, bool var_487_bool, float var_488_float)
{
	...
	if(var_494_bool != 0) {
		...
		func_847(var_496_string);
		bool var_630_bool;
		func_1681(var_630_bool, var_0_bool);
		if(!var_630_bool) { //@nz
			@StopAsync();
			var_487_bool = false;
			return 8;
		}
		float var_633_float; int var_634_int;
		var_488_float = var_633_float;
		func_467(var_496_string, var_633_float, var_634_int);
		var_495_int = 1;

		for(;;) {
			var_496_string = (("attack_middle" + var_634_int) + "_") + var_495_int;
			...
			if(!var_494_bool) { //@nz
				...
				func_847(var_496_string);
				bool var_656_bool;
				func_1681(var_656_bool, var_0_bool);
				if(!var_656_bool) { //@nz
					@StopAsync();
					var_487_bool = false;
					return 8;
				}
				float var_659_float; int var_660_int;
