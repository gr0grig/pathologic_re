...
// @pe
void func_1664(object var_15_object)
{
	int var_16_int;
...
void func_1542(string var_70_string)
{
	...
	if(var_92_bool == 0) goto Label_1562;
}
...
void func_1677(string var_27_string)
{
		...
		if(var_85_bool != 0) {
			...
			if(var_46_float >= (var_27_float * var_27_float)) {
				...
				if(var_245_bool != 0) {
					...
					bool var_509_bool;
					func_1370(var_509_bool, var_0_cvector);
					if(!var_509_bool) { //@nz
						goto Label_366;
					}
					var_0_cvector->GetPFPosition(var_40_cvector); //@t
...
void func_418(cvector var_0_cvector, float var_383_float, int var_384_int)
{
	...
	if(var_388_object == var_0_cvector) {
		...
		@ReportHit(var_0_cvector, var_462_int, var_390_float, var_399_float);
...
// @pe
void func_1186(string var_69_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_810(bool var_487_bool)
{
	var_487_bool = true;
}
...
void func_1583(object var_43_object)
{
...
// @pe
void func_1072(object var_46_object)
{
...
void func_1728(object var_12_object)
{
	bool var_14_bool;
...
void func_1095(object var_47_object)
{
...
void func_457(cvector var_0_cvector, cvector var_1_cvector, bool var_346_bool, float var_347_float)
{
	...
	if(var_353_bool != 0) {
		...
		func_796(var_355_string);
		bool var_472_bool;
		func_1370(var_472_bool, var_0_cvector);
		if(!var_472_bool) { //@nz
			@StopAsync();
			var_346_bool = false;
			return 8;
		...
		for(;;) {
			var_355_string = (("attack_middle" + var_476_int) + "_") + var_354_int;
			...
			if(!var_353_bool) { //@nz
				...
				func_796(var_355_string);
				bool var_498_bool;
				func_1370(var_498_bool, var_0_cvector);
				if(!var_498_bool) { //@nz
					@StopAsync();
					var_346_bool = false;
					return 8;
...
void func_594(bool var_488_bool, float var_489_float)
{
...
void func_1638(object var_14_object)
{
	bool var_16_bool;
