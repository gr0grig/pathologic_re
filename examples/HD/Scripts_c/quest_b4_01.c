maintask task_0
{
	...
	{
		func_437("cot_alexandr@door1", true);
		object var_21_object;
		func_402(var_21_object);
		var_7_object = var_21_object;
		func_437("warehouse_gangster@door1", true);
	...
	void OnTrigger(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object, object var_6_object, object var_7_object, object var_8_object, object var_9_object, bool var_10_bool, string var_11_string)
	{
		...
		if(var_11_string == "rubin_unlock") {
			...
			var_21_object = null;
				...
				func_437("warehouse_gangster@door1", false);
				var_0_bool = true;
				var_23_object = null;
		}
	Label_273:
		...
		if(var_11_string == "wg_unload") {
			...
			func_437("ifactory_grid_door", false);
		...
		if(var_11_string == "cleanup") {
			...
			if(var_29_int != 1000)
				...
				func_314(var_153_cvector, var_28_bool, var_29_int);
...
void func_290(bool var_0_bool, object var_1_object, object var_2_object, object var_3_object, object var_4_object)
{
	if(var_0_bool != 0) {
		if(var_1_object != 0)
...
void func_419(object var_48_object, object var_49_object, string var_50_string, string var_51_string, string var_52_string)
{
...
void func_388(object var_21_object, cvector var_22_cvector)
{
...
void func_454(object var_198_object, string var_199_string)
{
	...
	if(var_198_object != 0) {
		...
		for(;;) {
			if(!(var_204_int < var_203_int)) goto Label_472;
...
void func_396(object var_163_object)
{
...
void func_402(object var_21_object)
{
...
void func_437(string var_11_string, bool var_12_bool)
{
	object var_14_object;
...
void func_408(object var_116_object, string var_117_string)
{
...
void func_314(object var_5_object, object var_6_object, object var_7_object)
{
	if(var_10_bool != 0) {
	}
	@KillTimer(0);
