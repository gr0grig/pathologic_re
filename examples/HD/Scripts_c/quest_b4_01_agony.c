// @IMPORTS: Hold/0,StopGroup0/0,sync/0,RemoveEnvelope/0,SetRTEnvelope/2,Is3DSoundLoaded/2,PlayGlobalSound/2,PlayAnimation/2,WaitForAnimEnd/1,WaitForAnimEnd/0,LockAnimationEnd/2,SetDeathState/0,IsPlayerActor/2,IsDead/1,RemoveActor/1,GetProperty/2,StopAnimation/0,GetSecondaryAnimationType/1,GetPosition/1,GetDirection/1,FadeSecondaryAnimation/4,GetScene/1,AddActorByType/6,IsLoaded/1,self/1,rand/1,SendWorldWndMessage/1,CreateFloatVector/1,SendWorldWndMessage/2,SignalDeath/1
// @STRINGS: W:agony|W:all|W:sleep|W:agony_sleep|W:death|W:agony_die|W:HasProperty|A:HasProperty|A:GetProperty|A:SetProperty|A:GetPosition|W:fhit|W:bhit|W:hit_react|W:1|W:2|W:scripted|W:blood_dir.xml|W:reputation|A:add|W:health|W:cleanup
// @GLOBALS: 0:bool:
// @RUN_OP: 0x10
// @RUN_TASK: 1
...
// @STANDALONE_EVENT_16: op=0x14b vars=object,string
// @STANDALONE_EVENT_43: op=0x158 vars=object,int,float,float,cvector,cvector
// @STANDALONE_EVENT_26: op=0x162 vars=string
// @STANDALONE_EVENT_6: op=0x173 vars=
// @PE: 0xd,0x80,0x10e,0x11e,0x158
...
task_1_event_41(var_0_int, var_1_object)
{
	...
	if(var_7_bool != 0) {
		...
		if(var_8_bool != 0) {
			...
			func_286(var_9_bool, var_10_object, (float)-0.30000001192092896);
...
Label_34:
	...
	if(var_13_bool != 0) {
		...
		func_281(var_14_bool, (float)0.3333333432674408);
		if(var_14_bool != 0) {
			var_12_bool = 1;
		}
	}
