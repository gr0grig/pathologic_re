...
// @pe
void func_1538(object var_10_object)
{
		...
		if(var_79_bool != 0) {
			...
			if(var_40_float >= (var_21_float * var_21_float)) {
				...
				if(var_239_bool != 0) {
					...
					bool var_503_bool;
					func_1246(var_503_bool, var_0_object);
					if(!var_503_bool) { //@nz
						goto Label_256;
					}
					var_0_object->GetPFPosition(var_34_cvector); //@t
...
void func_700(bool var_481_bool)
{
	var_481_bool = true;
}
...
void func_347(object var_0_object, int var_1_int, bool var_340_bool, float var_341_float)
{
	...
	if(var_347_bool != 0) {
		...
		func_686(var_349_string);
		bool var_466_bool;
		func_1246(var_466_bool, var_0_object);
		if(!var_466_bool) { //@nz
			@StopAsync();
			var_340_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_347_bool) { //@nz
				...
				func_686(var_349_string);
				bool var_492_bool;
				func_1246(var_492_bool, var_0_object);
				if(!var_492_bool) { //@nz
					@StopAsync();
					var_340_bool = false;
					return 8;
...
void func_484(bool var_482_bool, float var_483_float)
{
...
void func_1510(object var_12_object)
{
	bool var_14_bool;
