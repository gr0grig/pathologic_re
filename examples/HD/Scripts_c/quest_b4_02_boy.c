...
void OnDeath(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, float var_10_float, int var_11_int, bool var_12_bool, object var_13_object, bool var_14_bool, object var_15_object)
{
	...
	if(var_16_bool != 0) {
		...
		var_15_object = var_21_object;
		func_2302(var_20_bool, var_21_object, -0.1);
	}
...
void func_1806(float var_398_float, object var_399_object, float var_400_float, int var_401_int)
{
	...
	float var_436_float;
	func_2279(var_436_float, ((var_411_int + var_413_int) / 100.0), (float)1);
	float var_414_float;
	...
	float var_446_float;
	func_2286(var_446_float, (var_415_float - var_416_float), (float)0, (float)1);
...
void func_2337(float var_454_float)
{
...
void func_2086(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_2269(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_2149;
...
void func_1327(int var_463_int)
{
	var_463_int = 0;
}
...
void func_2354(float var_27_float)
{
	object var_29_object;
...
void func_1336(bool var_488_bool)
{
	var_488_bool = true;
}
...
void func_2364(bool var_23_bool, string var_24_string, string var_25_string)
{
...
void func_2376(object var_18_object)
{
	bool var_20_bool;
	...
	if(1 != 0) {
		...
		if(var_95_bool != 0) {
			...
			var_0_object->AddReply(518962, 20075, 20074); //@t
					...
					bool var_146_bool;
					func_2461(var_1_object);
					if(var_146_bool == 0) goto Label_135;
...
void func_2398(int var_75_int)
{
	var_75_int = 503343;
}


void func_1120(bool var_489_bool, float var_490_float)
{
...
void func_2400(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen3.png";
}


void func_2402(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen3_b.png";
}


void func_2404(bool var_70_bool)
{
	var_70_bool = false;
}


void func_2406(string var_39_string, int var_40_int)
{
...
void func_2155(void)
{
	...
	if(var_177_bool != 0) {
		...
		if(var_175_bool == 0) goto Label_2172;
		@UnlookAsync("head");
	}
Label_2172:
...
void func_2173(string var_130_string)
{
...
void func_2189(string var_111_string, bool var_112_bool)
{
...
// @pe
void func_2449(bool var_95_bool)
{
	int var_97_int;
...
void func_2204(object var_19_object)
{
	float var_22_float;
...
// @pe
void func_2461(bool var_146_bool)
{
	int var_148_int;
		...
		if(var_86_bool != 0) {
			...
			if(var_49_float >= (var_30_float * var_30_float)) {
				...
				if(var_246_bool != 0) {
					...
					bool var_510_bool;
					func_1920(var_510_bool, var_0_object);
					if(!var_510_bool) { //@nz
						goto Label_892;
					}
					var_0_object->GetPFPosition(var_43_cvector); //@t
...
void func_2222(string var_83_string)
{
	...
	if(var_105_bool == 0) goto Label_2242;
}
...
void func_944(object var_0_object, float var_384_float, int var_385_int)
{
	...
	if(var_389_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_463_int, var_391_float, var_400_float);
...
// @pe
void func_187(object var_2_object, string var_107_string)
{
	bool var_108_bool;
...
// @pe
void func_2496(object var_19_object)
{
	int var_20_int;
...
// @pe
void func_2509(object var_58_object)
{
...
void func_2263(object var_25_object)
{
	object var_27_object;
	@self(var_27_object);
...
void func_983(object var_0_object, object var_1_object, bool var_347_bool, float var_348_float)
{
	...
	if(var_354_bool != 0) {
		...
		func_1322(var_356_string);
		bool var_473_bool;
		func_1920(var_473_bool, var_0_object);
		if(!var_473_bool) { //@nz
			@StopAsync();
			var_347_bool = false;
			return 8;
		...
		for(;;) {
			var_356_string = (("attack_middle" + var_477_int) + "_") + var_355_int;
			...
			if(!var_354_bool) { //@nz
				...
				func_1322(var_356_string);
				bool var_499_bool;
				func_1920(var_499_bool, var_0_object);
				if(!var_499_bool) { //@nz
					@StopAsync();
					var_347_bool = false;
					return 8;
...
void func_2269(cvector var_47_cvector, cvector var_48_cvector)
{
...
// @pe
void func_2279(float var_436_float, float var_437_float, float var_438_float)
{
...
// @pe
void func_2286(float var_49_float, float var_50_float, float var_51_float, float var_52_float)
{
...
void func_1784(bool var_31_bool, object var_32_object, string var_33_string, float var_34_float, float var_35_float, float var_36_float)
{
	...
	func_2286(var_49_float, (var_38_float + var_34_float), var_51_float, var_52_float);
	var_32_object->SetProperty(var_33_string, var_49_float);
	var_31_bool = true;
}


void func_2297(int var_97_int, string var_98_string)
{
	int var_100_int;
...
// @pe
void func_2302(bool var_20_bool, object var_21_object, float var_22_float)
{
	if(!var_21_object) { //@nz
		var_20_bool = false;
		return 0;
