...
void func_1537(object var_14_object)
{
	...
	if(var_20_bool != 0) {
		...
		func_1385(var_24_bool, var_25_object, -0.1);
	}
...
void func_1527(int var_77_int)
{
	var_77_int = 515593;
}


void func_1286(object var_30_object)
{
	float var_33_float;
...
void func_1420(float var_31_float)
{
...
void func_1168(bool var_28_bool, object var_29_object, float var_30_float)
{
	...
	func_1351(var_55_cvector, (var_44_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_71_bool != 0) {
		...
		if(var_48_bool == 0) goto Label_1231;
...
void func_1430(bool var_21_bool, string var_22_string, string var_23_string)
{
...
void func_1304(string var_88_string)
{
	...
	if(var_110_bool == 0) goto Label_1324;
}
...
void func_1442(string var_44_string, int var_45_int)
{
...
void func_1345(object var_17_object)
{
	object var_19_object;
	@self(var_19_object);
...
// @pe
void func_1479(bool var_96_bool)
{
	int var_98_int;
...
void func_1351(cvector var_45_cvector, cvector var_46_cvector)
{
...
// @pe
void func_1361(float var_53_float, float var_54_float, float var_55_float, float var_56_float)
{
...
void func_1237(void)
{
	...
	if(var_160_bool != 0) {
		...
		if(var_158_bool == 0) goto Label_1254;
		@UnlookAsync("head");
	}
Label_1254:
...
// @pe
void func_1372(float var_76_float, cvector var_77_cvector, cvector var_78_cvector)
{
...
void func_1380(int var_98_int, string var_99_string)
{
	int var_101_int;
...
void func_1255(string var_131_string)
{
...
// @pe
void func_1385(bool var_24_bool, object var_25_object, float var_26_float)
{
	if(!var_25_object) { //@nz
		var_24_bool = false;
		return 0;
...
// @pe
void func_1514(object var_17_object)
{
	int var_18_int;
...
void func_1271(string var_112_string, bool var_113_bool)
{
...
void func_1015(bool var_35_bool, object var_36_object, string var_37_string, float var_38_float, float var_39_float, float var_40_float)
{
	...
	func_1361(var_53_float, (var_42_float + var_38_float), var_55_float, var_56_float);
	var_36_object->SetProperty(var_37_string, var_53_float);
	var_35_bool = true;
}


void func_1529(int var_76_int)
{
	var_76_int = 512582;
}


void func_1531(string var_78_string)
{
...
void func_636(object var_0_object, cvector var_27_cvector, float var_28_float)
{
	...
	func_1351(var_43_cvector, (var_35_cvector - var_36_cvector));
	func_1351(var_41_cvector, (var_43_cvector + (var_37_cvector * 0.75)));
...
void func_1533(string var_79_string)
{
	var_79_string = "ui/NPC_Citizen1_b.png";
}


void func_1535(bool var_71_bool)
{
	var_71_bool = false;
}
