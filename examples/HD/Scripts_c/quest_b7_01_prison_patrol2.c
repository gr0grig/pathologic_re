	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool)
	{
		if(1 != 0) {
			...
			if(var_6_int == 22207) {
				...
				var_0_object->SetMessage(520994); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(520995, 29851, 22208); //@t
				var_0_object->AddReply(528463, -1, 29850); //@t
				return 0;
			}
			if(var_6_int == 29851) {
				func_132(var_7_bool, "Neutral");
				var_0_object->SetMessage(528464); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(528465, -1, 29852); //@t
				return 0;
			}
			var_3_string = true;
			bool var_43_bool;
...
void func_0(object var_0_object, int var_7_int, object var_8_object)
{
	...
	func_388(var_18_bool, var_19_object, 70.0);
	if(!var_18_bool) { //@nz
		var_7_int = -2;
		return 8;
	}
...
void func_388(bool var_18_bool, object var_19_object, float var_20_float)
{
	...
	func_519(var_45_cvector, (var_34_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_61_bool != 0) {
		...
		if(var_38_bool == 0) goto Label_451;
...
void func_519(cvector var_45_cvector, cvector var_46_cvector)
{
...
void func_529(string var_37_string, int var_38_int)
{
...
void func_570(int var_67_int)
{
	var_67_int = 515572;
}


void func_572(int var_66_int)
{
	var_66_int = 504031;
}


void func_574(string var_68_string)
{
	var_68_string = "ui/NPC_Citizen2.png";
}


void func_576(string var_69_string)
{
...
void func_457(void)
{
	...
	if(var_133_bool != 0) {
		...
		if(var_131_bool == 0) goto Label_474;
		@UnlookAsync("head");
	}
Label_474:
...
void func_475(string var_112_string)
{
...
void func_491(string var_90_string, bool var_91_bool)
{
