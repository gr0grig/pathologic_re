...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_506();
		var_11_bool = var_6_int == (int)22207;
		if(var_11_bool != 0) {
			var_12_string = "";
			func_132(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)520994);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)520995, (int)29851, (int)22208);
			@@@var_0_object:AddReply((int)528463, (int)-1, (int)29850);
			return 0;
		}
		var_37_bool = var_6_int == (int)29851;
		if(var_37_bool != 0) {
			var_38_string = "";
			func_132(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)528464);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528465, (int)-1, (int)29852);
			return 0;
		}
		var_3_string = true;
		var_43_bool = 0;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_388(var_18_bool, var_19_object, (float)70.0);
