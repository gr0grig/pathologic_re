...
void func_0(bool var_0_bool, bool var_67_bool, object var_68_object, object var_187_object)
{
	...
	func_1979(var_129_cvector, var_130_cvector, var_131_cvector, 2000.0);
...
void func_2064(string var_102_string)
{
...
void func_2135(int var_33_int, string var_34_string)
{
	int var_36_int;
...
// @pe
void func_2148(object var_11_object)
{
	object var_13_object;
...
// @pe
void func_2174(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_645(bool var_636_bool, float var_637_float)
{
	float var_640_float; bool var_641_bool;
	@rand(var_640_float);
	if(var_640_float < var_637_float) {
...
void func_1179(bool var_14_bool, object var_15_object, bool var_69_bool, object var_676_object)
{
...
// @pe
void func_162(object var_590_object, float var_591_float)
{
		...
		if(var_252_bool != 0) {
			...
			if(var_215_float >= (var_196_float * var_196_float)) {
				...
				if(var_376_bool != 0) {
					...
					var_656_bool = !var_655_bool; //@nz
					if(var_656_bool == 0) goto Label_405;
					bool var_657_bool;
					func_1577(var_657_bool, var_0_bool);
					if(!var_657_bool) { //@nz
						goto Label_415;
					}
					var_0_bool->GetPFPosition(var_209_cvector); //@t
...
void func_857(bool var_635_bool)
{
	var_635_bool = true;
}
...
void func_1943(float var_65_float)
{
...
void func_1953(object var_84_object)
{
	bool var_86_bool;
...
void func_1973(bool var_606_bool)
{
	bool var_608_bool;
...
void func_1979(cvector var_129_cvector, cvector var_130_cvector, cvector var_131_cvector, float var_132_float)
{
...
void func_467(bool var_0_bool, float var_510_float, int var_511_int)
{
	...
	if(var_515_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_589_int, var_517_float, var_526_float);
		object var_590_object; float var_591_float;
...
void func_1505(bool var_595_bool, object var_596_object)
{
	...
	float var_598_float;
	var_605_object->GetProperty("health", var_598_float);
	var_595_bool = var_598_float <= 0.0;
}


// @pe
void func_2020(object var_14_object)
{
	int var_15_int;
...
void func_2033(int var_21_int, int var_22_int)
{
...
void func_506(bool var_0_bool, object var_1_object, bool var_477_bool, float var_478_float)
{
	...
	if(var_484_bool != 0) {
		...
		func_847(var_486_string);
		bool var_620_bool;
		func_1577(var_620_bool, var_0_bool);
		if(!var_620_bool) { //@nz
			@StopAsync();
			var_477_bool = false;
			return 8;
		}
		float var_623_float; int var_624_int;
		var_478_float = var_623_float;
		func_467(var_486_string, var_623_float, var_624_int);
		var_485_int = 1;

		for(;;) {
			var_486_string = (("attack_middle" + var_624_int) + "_") + var_485_int;
			...
			if(!var_484_bool) { //@nz
				...
				func_847(var_486_string);
				bool var_646_bool;
				func_1577(var_646_bool, var_0_bool);
				if(!var_646_bool) { //@nz
					@StopAsync();
					var_477_bool = false;
					return 8;
				}
				float var_649_float; int var_650_int;
