...
// @STRINGS: W:quest_b8_02|W:book_taken|W:cleanup|W:object|A:Enable|W:HasProperty|A:HasProperty|A:IsDead|W:IsDead|A:GetScene|W:noaccess|A:GetProperty|A:add|A:GetItemID|W:Category|A:AddItem
// @RUN_OP: 0xb
// @RUN_TASK: 0
...
func_0(var_60_object)
{
	...
	func_201(var_61_bool, "quest_b8_02", "book_taken");
	var_60_object = Obj();
	func_82();
	return 0;
}
