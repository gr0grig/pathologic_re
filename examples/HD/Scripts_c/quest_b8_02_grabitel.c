...
// @STANDALONE_EVENT_22: op=0xbd1 vars=object,int,float,float
// @STANDALONE_EVENT_43: op=0xbd9 vars=object,int,float,float,cvector,cvector
// @STANDALONE_EVENT_16: op=0xbe3 vars=object,string
// @STANDALONE_EVENT_41: op=0xbf0 vars=object
// @STANDALONE_EVENT_6: op=0xc9b vars=
// @PE: 0x6b,0x71,0x78,0x7e,0x9a,0x9d,0xa2,0xb6,0xbc,0xc3,0x35f,0x365,0x36c,0x3a8,0x3c3,0x3d2,0x446,0x458,0x463,0x46c,0x477,0x484,0x48b,0x4bb,0x4c9,0x4d7,0x4e0,0x52c,0x549,0x557,0x565,0x56e,0x5d9,0x5e2,0x5f0,0x5fe,0x607,0x63d,0x651,0x65a,0x6c9,0x6db,0x6ea,0x720,0x736,0x7aa,0x7c4,0x7c6,0x7c8,0x7ca,0x9c8,0xa2f,0xa36,0xa4e,0xa59,0xa6c,0xb45,0xb4c,0xb5d,0xb64,0xb82,0xbbf,0xbd1,0xbd9,0xbf0,0xbfc
...
func_0(var_0_bool, var_92_bool, var_93_object, var_210_object)
{
	...
	func_2780(var_152_cvector, var_153_cvector, var_154_cvector, (float)2000.0);
...
func_3081(var_66_int, var_67_int)
{
	...
	if(var_74_bool != 0) {
		...
		if(var_84_bool == 0) goto Label_3099;
		return 4;
	}
Label_3099:
...
func_2062(var_545_float, var_546_object, var_547_float, var_548_int)
{
	...
	func_2607(var_583_float, var_584_float, (float)1);
	...
	func_2638(var_593_float, var_594_float, (float)0, (float)1);
...
{
	var_141_object = Obj(); var_142_int = 0; var_143_bool = 0; var_144_object = Obj(); var_145_int = 0; var_146_bool = 0;
	CreateInvItem(var_144_object);
	@@var_144_object:SetItemName(var_140_string);
	@@var_144_object:SetProperty("Organ", (int)1);
	@@var_144_object:GetItemID(var_145_int);
	AddItem(var_146_bool, var_144_object, (int)0, (int)1);
	return 6;
}
EMIT "Stack[-3] = 0";
...
func_3153()
{
	...
	func_3081((int)1500, (int)3000);
	var_85_string = ""; var_86_int = 0; var_87_int = 0;
	func_2437("Knife", (int)1, (int)4);
	var_96_string = ""; var_97_int = 0; var_98_int = 0;
	func_2437("lockpick", (int)1, (int)3);
	var_99_string = ""; var_100_int = 0; var_101_int = 0; var_102_int = 0;
	func_2448("rifle_ammo", (int)1, (int)3, (int)3);
	var_113_string = ""; var_114_int = 0; var_115_int = 0; var_116_int = 0;
	func_2448("samopal_ammo", (int)1, (int)3, (int)3);
	var_117_string = ""; var_118_int = 0; var_119_int = 0; var_120_int = 0;
	func_2448("revolver_ammo", (int)1, (int)3, (int)3);
	var_121_string = ""; var_122_int = 0; var_123_int = 0;
	func_2437("Samopal", (int)1, (int)20);
	var_124_string = ""; var_125_int = 0; var_126_int = 0;
	func_2437("Revolver", (int)1, (int)20);
	var_127_string = ""; var_128_int = 0; var_129_int = 0;
	func_2437("Rifle", (int)1, (int)20);
	var_130_int = 0; var_131_string = "";
	func_3222(var_130_int, "grabitel_mark");
	AddItem(var_64_bool, var_130_int, (int)0, (int)1);
	return 4;
}
...
Label_673:
	...
	if(var_449_bool != 0) {
		...
		func_2207(var_493_bool, var_494_object);
...
Label_243:
	...
	func_2207(var_276_bool, var_277_object);
	if(var_276_bool != 0) {
			...
			if(var_363_bool != 0) {
				...
				if(var_370_bool != 0) {
					...
					if(var_382_bool != 0) {
						...
						func_2207(var_394_bool, var_395_object);
					...
					if(var_397_bool != 0) {
						...
						func_2207(var_678_bool, var_679_object);
...
func_715(var_0_bool, var_452_bool)
{
	...
	func_2207(var_463_bool, var_464_object);
...
Label_763:
	...
	func_2008(var_480_cvector, var_481_object);
...
func_1787(var_71_bool, var_72_object, var_94_bool, var_697_object)
{
	...
	func_2649(var_86_bool, var_87_float, (float)250000.0, (float)3240000.0);
	if(var_86_bool != 0) {
...
func_1824(var_60_object)
{
	...
	if(var_154_bool != 0) {
		var_156_bool = 0; var_157_object = Obj(); var_158_float = 0;
		var_60_object = var_157_object;
		func_2668(var_156_bool, var_157_object, (float)0.009999999776482582);
	}
	var_159_object = Obj();
...
func_1871(var_160_object)
{
	...
	if(var_181_bool != 0) {
		...
		var_216_float = var_214_float * var_215_float;
		var_217_float = GetByIndex(var_174_cvector, 2);
		var_218_float = GetByIndex(var_173_cvector, 2);
		var_219_float = var_217_float * var_218_float;
		var_220_int = var_216_float + var_219_float;
		var_222_bool = var_220_int >= (int)0;
		if(var_222_bool != 0) {
			var_175_string = "fdie";
		} else {
				var_175_string = "bdie";
		...
		var_225_bool = IsFuncExist(var_160_object, "GetScriptProperty", (int)2);
		if(var_225_bool != 0) {
			@@var_160_object:HasScriptProperty(var_177_bool, "Owner");
			var_227_bool = var_177_bool;
			if(var_227_bool != 0) {
				@@var_160_object:GetScriptProperty(var_176_object, "Owner");
				var_229_bool = var_176_object == 0; //@ne
				if(var_229_bool != 0) {
					var_160_object = var_176_object;
				}
			}
		}
		var_232_bool = IsFuncExist(var_176_object, "@GetEyesHeight", (int)1);
		if(var_232_bool != 0) {
			@@var_176_object:GetEyesHeight(var_179_float);
			var_180_cvector = CVector(0.0, 0.0, 0.0);
...
func_2448(var_99_string, var_100_int, var_101_int, var_102_int)
{
	...
	var_107_bool = 0; var_108_int = 0; var_109_int = 0;
	...
	if(var_107_bool != 0) {
		...
		var_112_int = var_105_int + (int)1;
		AddItem(var_106_bool, var_99_string, (int)0, var_112_int);
	}
	return 4;
}
...
{
	var_184_bool = 0; var_185_int = 0; var_186_bool = 0; var_187_int = 0; var_188_bool = 0; var_189_float = 0; var_190_cvector = CVector(0,0,0); var_191_cvector = CVector(0,0,0); var_192_bool = 0; var_193_int = 0; var_194_bool = 0; var_195_int = 0; var_196_bool = 0; var_197_float = 0; var_198_cvector = CVector(0,0,0); var_199_cvector = CVector(0,0,0);
	IsExisting3DSound(var_192_bool, var_183_string);
	var_200_bool = var_192_bool == 0; //@nz
	if(var_200_bool != 0) {
		var_193_int = 0;

	Label_2469:
		var_202_int = var_193_int + (int)1;
		var_203_int = var_183_string + var_202_int;
		IsExisting3DSound(var_194_bool, var_203_int);
		var_204_bool = var_194_bool == 0; //@nz
		if(var_204_bool != 0) {
		} else {
			var_193_int = var_193_int + (int)1;
			goto Label_2469;
		}
		var_205_bool = var_193_int == 0; //@nz
		if(var_205_bool != 0) {
			return 16;
		}
		irand(var_195_int, var_193_int);
		var_207_int = var_195_int + (int)1;
		var_183_string = var_183_string + var_207_int;
	}
	...
	if(var_208_bool != 0) {
		...
		var_199_cvector = var_198_cvector * (int)50;
		var_210_float = GetByIndex(var_199_cvector, 1);
		var_210_float = var_210_float + var_197_float;
		SetByIndex(var_199_cvector, 1) = var_210_float;
...
func_3007(var_17_object)
{
	...
	if(var_18_bool != 0) {
		...
		func_2668(var_22_bool, var_23_object, (float)0.05000000074505806);
	}
	var_60_object = Obj();
...
func_506(var_0_bool, var_1_object, var_498_bool, var_499_float)
{
	...
	func_2207(var_528_bool, var_529_object);
	...
	if(var_637_bool != 0) {
		...
		func_2207(var_641_bool, var_642_object);
	...
	Label_583:
		...
		if(var_651_bool != 0) {
			...
			func_2207(var_667_bool, var_668_object);
