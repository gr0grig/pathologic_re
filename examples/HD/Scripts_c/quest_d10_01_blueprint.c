...
// @STRINGS: W:cleanup|W:quest_d10_01|W:soldier_fight|W:object|A:Enable|W:HasProperty|A:HasProperty|A:IsDead|W:IsDead|A:GetScene|W:noaccess|A:GetProperty|A:add|A:GetItemID|W:Category|A:AddItem
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
func_32(var_60_object)
{
	...
	func_201(var_61_bool, "quest_d10_01", "soldier_fight");
	var_60_object = Obj();
	func_82();
	return 0;
}
