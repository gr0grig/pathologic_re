...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:cleanup|W:player|W:head|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |W:ood10Salesman1|W:d10q03|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:branch|W:ui/NPC_Citizen3.png|W:ui/NPC_Citizen3_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x131
// @RUN_TASK: 2
...
// @PE: 0x4a,0xa2,0xb8,0x137,0x168,0x187,0x1b1,0x1c8,0x2ee,0x2f4,0x2fd

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	if((int)1 != 0) {
		func_698();
		var_17_bool = var_13_bool == (int)35730;
		if(var_17_bool != 0) {
		...
		if(var_46_bool != 0) {
			...
			if(var_47_bool != 0) {
				...
				@@@var_0_object:SetMessage((int)534142);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)534435, (int)36067, (int)36066);
				@@@var_0_object:AddReply((int)534437, (int)36067, (int)36068);
				return 0;
			}
			var_83_string = "";
			func_162(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)534144);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)534145, (int)-1, (int)35732);
			@@@var_0_object:AddReply((int)534443, (int)-1, (int)36076);
			return 0;
		}
		var_92_bool = var_12_bool == (int)36067;
		if(var_92_bool != 0) {
			var_93_string = "";
			func_162(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)534436);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)534438, (int)36070, (int)36069);
			@@@var_0_object:AddReply((int)534442, (int)36070, (int)36074);
			return 0;
		}
		var_102_bool = var_12_bool == (int)36070;
		if(var_102_bool != 0) {
			var_103_string = "";
			func_162(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)534439);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)534143, (int)-1, (int)35730);
			return 0;
		}
		var_3_string = true;
		var_108_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	if(var_14_bool != 0) {
		...
		if(var_15_bool != 0) {
			...
			if(var_36_object == 0) goto Label_455;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_569(var_27_bool, var_28_object, (float)70.0);
...
func_391(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_21_float, var_22_float)
{
	var_23_bool = 0;
...
func_777()
{
	...
	CreateDiaryEntry(var_23_object, (int)674, (int)2, (int)534159);
	var_27_bool = 0; var_28_object = Obj(); var_29_int = 0;
	var_23_object = var_28_object;
	func_803(var_27_bool, var_28_object, (int)672);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_418(var_0_object, var_1_object, var_4_bool, var_15_bool)
{
	...
	func_556(var_19_float, var_20_object);
...
func_569(var_27_bool, var_28_object, var_29_float)
{
	...
	if(var_70_bool != 0) {
		...
		if(var_72_bool == 0) goto Label_632;
...
Label_324:
	...
	func_391(var_13_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
	var_6_int = false;
	goto Label_324;
}
EMIT "Return(); Pop(4)";
...
Label_484:
	...
	if(var_59_bool != 0) {
		...
		if(var_65_bool != 0) {
			...
			if(var_66_int == 0) goto Label_517;
			...
			if(var_70_bool != 0) {
				...
				if(var_80_int == 0) goto Label_535;
				goto Label_546;
		}
		Label_535:
			var_71_bool = 0;
...
func_750()
{
	SetVariable("ood10Salesman1", (int)1);
	return 0;
}
...
func_638()
{
	...
	if(var_162_bool != 0) {
		...
		if(var_164_bool == 0) goto Label_655;
		UnlookAsync("head");
	}
Label_655:
	return 2;
