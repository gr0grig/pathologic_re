...
// @PE: 0x4a,0xd0,0xe6,0x213,0x31d,0x323,0x32e,0x334,0x345,0x356,0x35c,0x361,0x36d,0x379,0x385,0x391,0x39d
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		...
		var_55_bool = var_8_bool == (int)15376;
		if(var_55_bool != 0) {
		...
		var_61_bool = var_8_bool == (int)15378;
		if(var_61_bool != 0) {
			...
			func_860(var_110_object);
		}
		var_113_bool = var_8_bool == (int)41554;
		if(var_113_bool != 0) {
			...
			func_860(var_117_object);
		}
		var_119_bool = var_8_bool == (int)15379;
		if(var_119_bool != 0) {
		...
		var_125_bool = var_8_bool == (int)15381;
		if(var_125_bool != 0) {
			var_126_object = Obj(); var_127_object = Obj();
			var_126_object = var_1_object;
			var_127_object = var_0_object;
			func_860(var_127_object);
		}
		var_129_bool = var_7_bool == (int)15370;
		if(var_129_bool != 0) {
			var_130_bool = 0; var_131_object = Obj();
			var_131_object = var_1_object;
			func_877(var_131_object);
			if(var_130_bool != 0) {
				var_136_string = "";
				func_208(var_8_bool, "Neutral");
				@@@var_0_object:SetMessage((int)514156);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)514169, (int)15384, (int)15383);
				@@@var_0_object:AddReply((int)539603, (int)15384, (int)41547);
				return 0;
			}
			var_160_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514161);
			@@@var_0_object:ClearReplies();
			var_162_bool = 0;
			var_162_bool = 1;
			var_163_bool = 0;
			...
			if(var_162_bool != 0) {
				@@@var_0_object:AddReply((int)514162, (int)15377, (int)15376);
			}
			var_188_bool = 0;
			var_188_bool = 0;
			var_189_bool = 0; var_190_object = Obj();
			var_190_object = var_1_object;
			func_901(var_190_object);
			if(var_189_bool != 0) {
				var_195_bool = 0; var_196_object = Obj();
				var_196_object = var_1_object;
				func_865(var_196_object);
				if(var_195_bool != 0) {
					var_188_bool = 1;
				}
			}
			if(var_188_bool != 0) {
				@@@var_0_object:AddReply((int)514165, (int)15380, (int)15379);
			}
			@@@var_0_object:AddReply((int)514168, (int)-1, (int)15382);
			return 0;
		}
		var_208_bool = var_7_bool == (int)15380;
		if(var_208_bool != 0) {
			var_209_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514166);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514167, (int)-1, (int)15381);
			return 0;
		}
		var_215_bool = var_7_bool == (int)15377;
		if(var_215_bool != 0) {
			var_216_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514163);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514164, (int)-1, (int)15378);
			@@@var_0_object:AddReply((int)539608, (int)-1, (int)41554);
			return 0;
		}
		var_225_bool = var_7_bool == (int)15384;
		if(var_225_bool != 0) {
			var_226_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514170);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514157, (int)15372, (int)15371);
			@@@var_0_object:AddReply((int)539604, (int)41550, (int)41549);
			return 0;
		}
		var_235_bool = var_7_bool == (int)41550;
		if(var_235_bool != 0) {
			var_236_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)539605);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539606, (int)15372, (int)41551);
			@@@var_0_object:AddReply((int)539609, (int)-1, (int)41555);
			return 0;
		}
		var_245_bool = var_7_bool == (int)15372;
		if(var_245_bool != 0) {
			var_246_string = "";
			func_208(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514158);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514159, (int)-1, (int)15373);
			@@@var_0_object:AddReply((int)514160, (int)-1, (int)15374);
			return 0;
		}
		var_3_string = true;
		var_254_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_19_bool == 0) goto Label_576;
		var_0_object = false;
	}
Label_576:
	return 2;
...
func_0(var_0_object, var_9_int, var_10_object)
{
	...
	func_595(var_20_bool, var_21_object, (float)70.0);
...
func_664()
{
	...
	if(var_190_bool != 0) {
		...
		if(var_192_bool == 0) goto Label_681;
		UnlookAsync("head");
	}
Label_681:
	return 2;
...
func_803(var_81_object)
{
	...
	func_772(var_84_object, "powder", (int)1);
	return 0;
}
...
func_937()
{
	...
	func_989(var_22_bool, var_23_object, (int)-1);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_950()
{
	...
	func_989(var_75_bool, var_76_object, (int)197);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_963()
{
	...
	func_989(var_45_bool, var_46_object, (int)197);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_595(var_20_bool, var_21_object, var_22_float)
{
	...
	if(var_63_bool != 0) {
		...
		if(var_65_bool == 0) goto Label_658;
