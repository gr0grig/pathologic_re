...
maintask task_4
{
	...
	void OnTrigger(object var_0_object, object var_1_object, bool var_2_bool, object var_3_object, object var_4_object, bool var_5_bool, bool var_6_bool, string var_7_string, cvector var_8_cvector, cvector var_9_cvector, bool var_10_bool)
	{
		...
		func_835(var_365_string, var_365_string);
	}
...
// @pe
void func_1568(bool var_87_bool, string var_88_string)
{
	var_87_bool = true;
...
// @pe
void func_2166(object var_136_object, bool var_137_bool)
{
...
void func_1655(object var_16_object)
{
...
// @pe
void func_1144(string var_279_string, int var_280_int)
{
	if(var_280_int == 2) {
		var_279_string = "fire";
		return 0;
...
void func_635(object var_0_object)
{
	...
	func_1814(var_0_object);
	@ReportAttack(var_0_object);
	bool var_197_bool;
	func_1180(var_197_bool, var_0_object);
	if(var_197_bool != 0) {
	...
	func_1158(var_200_cvector, var_0_object);
	...
	func_1158(var_242_cvector, var_0_object);
	var_242_cvector = var_183_cvector;
	var_244_float = GetByIndex(var_183_cvector, 1);
	float var_245_float;
	func_1494(var_245_float, var_0_object);
	SetByIndex(var_183_cvector, 1) = (var_244_float + var_245_float);
	...
	if(var_190_object != null) {
		if(var_190_object == var_0_object) {
			float var_254_float;
			func_1219(var_254_float, var_0_object, 1.5, 1);
...
void func_1661(cvector var_42_cvector, cvector var_43_cvector)
{
...
void func_2177(object var_129_object)
{
...
void func_1158(cvector var_44_cvector, object var_45_object)
{
...
void func_1671(float var_314_float, cvector var_315_cvector, cvector var_316_cvector)
{
	var_314_float = (var_316_cvector - var_315_cvector) | (var_316_cvector - var_315_cvector);
}


// @pe
void func_1675(float var_289_float, float var_290_float, float var_291_float)
{
	if(var_290_float < var_291_float)
...
void func_1165(float var_376_float, object var_377_object)
{
	cvector var_381_cvector;
	@GetPosition(var_381_cvector);
	cvector var_382_cvector;
	var_377_object->GetPosition(var_382_cvector);
	var_376_float = (var_382_cvector - var_381_cvector) | (var_382_cvector - var_381_cvector);
}


// @pe
void func_1682(float var_58_float, float var_59_float, float var_60_float, float var_61_float)
{
...
void func_1173(object var_14_object)
{
	object var_16_object;
...
// @pe
void func_2201(object var_144_object)
{
	object var_145_object;
	...
	func_2166(var_146_object, true);
}


void func_1180(bool var_11_bool, object var_12_object)
{
	bool var_14_bool;
...
void func_1693(bool var_103_bool, int var_104_int, int var_105_int)
{
	int var_107_int;
...
void func_1185(bool var_48_bool, object var_49_object, string var_50_string)
{
...
void func_1698(object var_21_object)
{
...
void func_2212(object var_131_object)
{
...
void func_165(object var_0_object, object var_129_object)
{
	...
	for(;;) {
		...
		if(var_135_bool != 1) {
			bool var_136_bool;
			func_1333(var_136_bool, var_129_object);
...
// @pe
void func_1704(float var_209_float, cvector var_210_cvector, cvector var_211_cvector)
{
...
void func_1197(bool var_40_bool, object var_41_object, string var_42_string, float var_43_float, float var_44_float, float var_45_float)
{
	...
	func_1682(var_58_float, (var_47_float + var_43_float), var_60_float, var_61_float);
...
// @pe
void func_1713(float var_218_float, cvector var_219_cvector)
{
...
// @pe
void func_2233(bool var_374_bool, object var_375_object)
{
	object var_377_object;
	var_375_object = var_377_object;
	float var_376_float;
	func_1165(var_376_float, var_377_object);
	var_374_bool = var_376_float <= 40000.0;
}


// @pe
void func_1723(float var_206_float, cvector var_207_cvector, cvector var_208_cvector)
{
...
void func_2241(bool var_52_bool, object var_53_object)
{
...
void func_1219(float var_254_float, object var_255_object, float var_256_float, int var_257_int)
{
	int var_264_int; int var_266_int;
	...
	if(!var_270_bool) //@nz
		var_254_float = 0.0;
	bool var_274_bool; object var_275_object;
	func_1185(var_274_bool, var_275_object, "armor");
	if(!var_274_bool) //@nz
		var_264_int = 0;
	else
		var_275_object->GetProperty("armor", var_264_int);
	string var_279_string; int var_280_int;
	var_257_int = var_280_int;
	func_1144(var_279_string, var_280_int);
	string var_265_string = "armor_" + var_279_string;
	bool var_285_bool; object var_286_object; string var_287_string;
	var_255_object = var_286_object;
	func_1185(var_285_bool, var_286_object, var_287_string);
	if(!var_285_bool) //@nz
		var_266_int = 0;
	else
		var_255_object->GetProperty(var_287_string, var_266_int);

	float var_289_float;
	func_1675(var_289_float, ((var_264_int + var_266_int) / 100.0), (float)1);
	float var_267_float;
	var_289_float = var_267_float;
	float var_268_float;
	var_255_object->GetProperty("health", var_268_float);
	float var_269_float = var_256_float * (1 - var_267_float);
	float var_299_float;
	func_1682(var_299_float, (var_268_float - var_269_float), (float)0, (float)1);
	...
	if(var_305_bool != 0) {
		float var_307_float = -var_269_float;
...
// @pe
void func_1740(bool var_29_bool, object var_30_object, float var_31_float)
{
	if(!var_30_object) { //@nz
		var_29_bool = false;
		return 0;
...
void func_1775(float var_307_float)
{
	...
	if(var_307_float < 0)
		@RumblePlay(0.7, 500);
	@SendWorldWndMessage(15, var_309_object);
}
EMIT "Stack[-1] = 0";


void func_1792(float var_36_float)
{
...
void func_1802(bool var_10_bool, string var_11_string, string var_12_string)
{
	object var_14_object;
...
void func_1292(bool var_30_bool, object var_31_object)
{
	bool var_33_bool;
...
void func_2321(bool var_11_bool, object var_12_object)
{
...
void func_1297(bool var_19_bool, object var_20_object)
{
...
void func_1814(object var_147_object)
{
	bool var_149_bool;
...
void func_285(object var_0_object, object var_1_object, object var_363_object)
{
	...
	if(var_1_object != 0) {
		bool var_374_bool;
		func_2233(var_374_bool, var_0_object);
		if(var_374_bool != 0) {
			func_2166(var_0_object, true);
			return 6;
		}
		@Face(var_0_object);
	}
	...
	for(;;) {
		if(var_371_int < 20) {
			...
			if(var_1_object != 0) {
				var_370_int = 0;
				bool var_405_bool;
				func_2233(var_405_bool, var_0_object);
				if(var_405_bool != 0) {
					func_439();
					func_2166(var_0_object, false);
					return 6;
				}
				@Face(var_0_object);
			} else {
			@StopAsync();
			if(!((var_370_int + 1) == 4)) goto Label_394;
			@PlayAnimation("all", "attack_off");
			@WaitForAnimEnd();
			return 6;
		}
		...
		func_2166(var_415_object, false);
		return 6;
		}
	Label_394:
		var_371_int += 1;
...
// @pe
void func_2343(object var_131_object)
{
...
void func_1834(int var_127_int)
{
	int var_129_int;
...
void func_2349(bool var_13_bool, object var_14_object, object var_15_object, bool var_16_bool)
{
	bool var_18_bool;
	object var_20_object;
	var_15_object = var_20_object;
	bool var_19_bool;
	func_2023(var_19_bool, var_20_object, !var_16_bool);
	if(var_19_bool != 0) {
...
// @pe
void func_1840(object var_14_object)
{
	int var_15_int;
...
void func_1333(bool var_15_bool, object var_16_object)
{
	object var_20_object;
...
void func_1853(int var_76_int, int var_77_int)
{
...
void func_835(object var_0_object, string var_365_string)
{
	bool var_367_bool;
	if(var_365_string == "cleanup") {
		var_0_object = true;
	...
	} else if(var_365_string == "restore") {
		var_0_object = false;
	}
...
void func_1357(object var_27_object)
{
...
// @pe
void func_2388(object var_130_object)
{
	object var_131_object;
...
// @pe
void func_2394(object var_20_object)
{
	bool var_21_bool;
	...
	if(var_27_bool != 0) {
		...
		func_1740(var_29_bool, var_30_object, 0.03);
	}
...
void func_1884(string var_133_string)
{
...
void func_879(bool var_12_bool)
{
	var_12_bool = true;
}
...
// @pe
void func_881(object var_13_object)
{
	func_2159();
	object var_24_object;
...
void func_1401(object var_14_object, int var_15_int, float var_16_float)
{
	...
	if(var_32_int == 0) goto Label_1463;
	int var_33_int;
...
void func_1925(void)
{
	@ClearSubContainer(0);
	func_1853(500, 1000);
	func_1512("rifle_ammo", 1, 3, 3);
	func_1512("rusk", 1, 3, 2);
	func_1501("bandage", 1, 6);
	func_1501("tourniquet", 1, 6);
}
...
void func_1961(int var_88_int, string var_89_string)
{
	int var_91_int;
...
// @pe
void func_1966(object var_67_object)
{
...
void func_1469(object var_16_object, cvector var_19_cvector, cvector var_20_cvector)
{
	object var_23_object;
	@GetScene(var_23_object);
	object var_24_object;
...
void func_455(object var_0_object, object var_1_object, bool var_2_bool, object var_138_object, bool var_139_bool)
{
...
Label_481:
	for(;;) {
		bool var_164_bool;
		func_1333(var_164_bool, var_0_object);
		if(var_164_bool != 0) {
			...
			if(var_146_bool != 0) {
				...
				bool var_345_bool;
				func_1333(var_345_bool, var_0_object);
				if(!var_345_bool) { //@nz
				} else {
						@CanSee(var_146_bool, var_0_object);
						if(var_146_bool != 0) {
						...
						bool var_359_bool;
						func_1333(var_359_bool, var_0_object);
						var_361_bool = !var_359_bool; //@nz
						if(var_361_bool == 0) goto Label_565;
				}
		}
		Label_587:
			for(;;) {
...
void func_980(object var_0_object, object var_1_object)
{
	int var_306_int; bool var_307_bool; cvector var_308_cvector; object var_309_object;
	@GetPFPosition(var_1_object);
	@GetDirection(var_0_object);
	
	for(;;) {
		func_1069();
		@irand(var_306_int, 10);
		@Sleep((var_306_int + 5), var_307_bool);
		if(var_307_bool != 0) {
			func_902();
		} else {
		for(;;) {
			...
			float var_314_float; cvector var_316_cvector;
			var_308_cvector = var_316_cvector;
			func_1671(var_314_float, var_1_object, var_316_cvector);
			if(var_314_float > 40000) {
				@FindPathTo(var_309_object, var_1_object);
				if(var_309_object != null) {
					@RotatePath(var_309_object, var_307_bool);
					if(!var_307_bool) { //@nz
					} else {
					@FollowPath(var_309_object, false, var_307_bool);
					if(!var_307_bool) { //@nz
						goto Label_1061;
					}
...
void func_1494(float var_245_float, object var_246_object)
{
	float var_249_float;
...
void func_1501(string var_115_string, int var_116_int, int var_117_int)
{
	bool var_119_bool;
	int var_121_int;
...
void func_2023(bool var_19_bool, object var_20_object, bool var_21_bool)
{
...
void func_1512(string var_95_string, int var_96_int, int var_97_int, int var_98_int)
{
...
void func_1527(string var_171_string)
{
	...
	if(var_193_bool == 0) goto Label_1547;
}
