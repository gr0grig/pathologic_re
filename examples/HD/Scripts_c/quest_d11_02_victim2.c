...
// @STANDALONE_EVENT_6: op=0x1c8 vars=
// @PE: 0x4a,0x84,0x9a,0xc4

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		func_421();
		var_12_bool = var_7_bool == (int)15389;
		if(var_12_bool != 0) {
			var_13_string = "";
			func_132(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514175);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514176, (int)-1, (int)15390);
			@@@var_0_object:AddReply((int)539614, (int)-1, (int)41561);
			return 0;
		}
		var_3_string = true;
		var_37_bool = 0;
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_303(var_27_bool, var_28_object, (float)70.0);
...
func_257(var_0_object, var_17_string)
{
	...
	if(var_21_bool != 0) {
		...
		if(var_29_bool == 0) goto Label_284;
		var_0_object = false;
	}
Label_284:
	return 2;
...
func_303(var_27_bool, var_28_object, var_29_float)
{
	...
	if(var_70_bool != 0) {
		...
		if(var_72_bool == 0) goto Label_366;
...
func_372()
{
	...
	if(var_142_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_389;
		UnlookAsync("head");
	}
Label_389:
	return 2;
