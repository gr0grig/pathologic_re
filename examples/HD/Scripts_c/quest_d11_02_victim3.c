...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_339(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_517(int var_75_int)
{
	var_75_int = 503349;
}


void func_519(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png";
}


void func_521(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_523(bool var_70_bool)
{
	var_70_bool = false;
}
...
void func_408(void)
{
	...
	if(var_142_bool != 0) {
		...
		if(var_140_bool == 0) goto Label_425;
		@UnlookAsync("head");
	}
Label_425:
...
void func_293(object var_0_object, string var_17_string)
{
	bool var_19_bool;
...
void func_426(string var_121_string)
{
...
void func_442(string var_99_string, bool var_100_bool)
{
...
void func_464(object var_10_object)
{
...
void func_337(bool var_9_bool)
{
	var_9_bool = true;
}


void func_339(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_470(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_402;
...
void func_470(cvector var_54_cvector, cvector var_55_cvector)
{
...
void func_480(bool var_7_bool, string var_8_string, string var_9_string)
{
...
// @pe
void func_232(object var_15_object)
{
