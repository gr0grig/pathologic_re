...
maintask task_2
{
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, bool var_5_bool, bool var_6_bool, string var_7_string)
	{
		...
		if(var_7_string == "execute") {
			...
			func_280(var_9_bool, var_17_string);
		}
...
{
	bool var_7_bool;
	func_467(var_7_bool, "quest_d11_02", "actor_unload");
}
...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_326(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_395(void)
{
	...
	bool var_142_bool;
	func_510(var_142_bool);
	if(var_142_bool != 0) {
	} else {
		@HasAnimationTrack(var_140_bool, "head");
		if(var_140_bool == 0) goto Label_412;
		@UnlookAsync("head");
	}
Label_412:
...
void func_280(object var_0_object, string var_17_string)
{
	bool var_19_bool;
	if(var_17_string == "cleanup") {
		...
		if(!var_19_bool) { //@nz
			bool var_24_bool;
			func_324(var_24_bool);
			if(var_24_bool != 0)
				var_22_bool = true;
		}
		if(var_22_bool != 0) {
			object var_25_object;
			func_451(var_25_object);
...
void func_413(string var_121_string)
{
...
void func_429(string var_99_string, bool var_100_bool)
{
...
{
	bool var_10_bool;
	func_510(var_10_bool);
	if(var_10_bool != 0)
		@lshStopSpeech();
}


void func_451(object var_10_object)
{
...
void func_324(bool var_9_bool)
{
	var_9_bool = true;
}


void func_326(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_457(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_389;
...
void func_457(cvector var_54_cvector, cvector var_55_cvector)
{
...
void func_467(bool var_7_bool, string var_8_string, string var_9_string)
{
...
// @pe
void func_219(object var_15_object)
{
...
void func_502(int var_76_int)
{
	var_76_int = 515564;
}


void func_504(int var_75_int)
{
	var_75_int = 503349;
}


void func_506(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen2.png";
}


void func_508(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen2_b.png";
}


void func_510(bool var_70_bool)
{
	var_70_bool = false;
}
