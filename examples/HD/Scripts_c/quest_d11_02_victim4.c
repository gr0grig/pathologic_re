...
// @STANDALONE_EVENT_6: op=0x1df vars=
// @PE: 0x4a,0x84,0x9a,0xdb

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		func_444();
		var_12_bool = var_7_bool == (int)15395;
		if(var_12_bool != 0) {
			var_13_string = "";
			func_132(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514181);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514182, (int)15397, (int)15396);
			@@@var_0_object:AddReply((int)539616, (int)-1, (int)41563);
			return 0;
		}
		var_38_bool = var_7_bool == (int)15397;
		if(var_38_bool != 0) {
			var_39_string = "";
			func_132(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)514183);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514184, (int)-1, (int)15398);
			@@@var_0_object:AddReply((int)539617, (int)-1, (int)41564);
			return 0;
		}
		var_3_string = true;
		var_47_bool = 0;
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_326(var_27_bool, var_28_object, (float)70.0);
...
func_395()
{
	...
	if(var_142_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_412;
		UnlookAsync("head");
	}
Label_412:
	return 2;
...
func_280(var_0_object, var_17_string)
{
	...
	if(var_21_bool != 0) {
		...
		if(var_29_bool == 0) goto Label_307;
		var_0_object = false;
	}
Label_307:
	return 2;
...
func_326(var_27_bool, var_28_object, var_29_float)
{
	...
	if(var_70_bool != 0) {
		...
		if(var_72_bool == 0) goto Label_389;
