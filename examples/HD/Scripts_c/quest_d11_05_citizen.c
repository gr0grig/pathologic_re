...
void func_1837(object var_51_object)
{
		...
		if(var_122_bool != 0) {
			...
			if(var_85_float >= (var_66_float * var_66_float)) {
				...
				if(var_250_bool != 0) {
					...
					bool var_514_bool;
					func_1402(var_514_bool, var_0_object);
					if(!var_514_bool) { //@nz
						goto Label_522;
					}
					var_0_object->GetPFPosition(var_79_cvector); //@t
...
void func_574(object var_0_object, float var_388_float, int var_389_int)
{
	...
	if(var_393_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_467_int, var_395_float, var_404_float);
...
void func_966(bool var_492_bool)
{
	var_492_bool = true;
}
...
void func_613(object var_0_object, object var_1_object, bool var_351_bool, float var_352_float)
{
	...
	if(var_358_bool != 0) {
		...
		func_952(var_360_string);
		bool var_477_bool;
		func_1402(var_477_bool, var_0_object);
		if(!var_477_bool) { //@nz
			@StopAsync();
			var_351_bool = false;
			return 8;
		...
		for(;;) {
			var_360_string = (("attack_middle" + var_481_int) + "_") + var_359_int;
			...
			if(!var_358_bool) { //@nz
				...
				func_952(var_360_string);
				bool var_503_bool;
				func_1402(var_503_bool, var_0_object);
				if(!var_503_bool) { //@nz
					@StopAsync();
					var_351_bool = false;
					return 8;
...
void func_750(bool var_493_bool, float var_494_float)
{
