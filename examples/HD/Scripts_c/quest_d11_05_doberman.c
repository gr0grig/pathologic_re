...
// @PE: 0x4a,0x84,0x9a,0xd5,0xe0,0x10a,0x121,0x252

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_531();
		var_15_bool = var_11_object == (int)40713;
		if(var_15_bool != 0) {
		...
		var_25_bool = var_10_bool == (int)40712;
		if(var_25_bool != 0) {
			var_26_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)538795);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538796, (int)-1, (int)40713);
			@@@var_0_object:AddReply((int)538805, (int)-1, (int)40723);
			return 0;
		}
		var_3_string = true;
		var_50_bool = 0;
		func_592(var_50_bool);
		if(var_50_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_288;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_402(var_25_bool, var_26_object, (float)70.0);
...
func_389(var_17_float, var_18_object)
{
...
func_402(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_465;
...
func_594()
{
	...
	func_548(var_18_bool, "quest_d11_05", "teleport");
	return 0;
}
...
func_224(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_11_float, var_12_float)
{
	var_13_bool = 0;
	func_397(var_13_bool);
	...
	if(var_49_bool != 0) {
		...
		if(var_55_bool != 0) {
			...
			if(var_60_bool != 0) {
				...
				if(var_70_int == 0) goto Label_368;
				goto Label_379;
		}
		Label_368:
			var_61_bool = 0;
