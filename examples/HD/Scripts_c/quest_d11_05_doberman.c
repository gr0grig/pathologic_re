...
void func_520(object var_27_object)
{
	float var_30_float;
...
void func_584(int var_74_int)
{
	var_74_int = 518097;
}


void func_586(int var_73_int)
{
	var_73_int = 518096;
}
...
void func_588(string var_75_string)
{
...
void func_590(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen2_b.png";
}


void func_592(bool var_68_bool)
{
	var_68_bool = false;
}
...
void func_402(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_538(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_68_bool != 0) {
		...
		if(var_45_bool == 0) goto Label_465;
...
void func_471(void)
{
	...
	if(var_140_bool != 0) {
		...
		if(var_138_bool == 0) goto Label_488;
		@UnlookAsync("head");
	}
Label_488:
...
void func_538(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_548(bool var_18_bool, string var_19_string, string var_20_string)
{
...
void func_489(string var_119_string)
{
...
void func_560(string var_42_string, int var_43_int)
{
...
void func_505(string var_97_string, bool var_98_bool)
{
