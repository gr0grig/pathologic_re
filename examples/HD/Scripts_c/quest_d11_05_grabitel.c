		...
		if(var_263_bool != 0) {
			...
			if(var_226_float >= (var_207_float * var_207_float)) {
				...
				if(var_387_bool != 0) {
					...
					bool var_668_bool;
					func_1697(var_668_bool, var_0_object);
					if(!var_668_bool) { //@nz
						goto Label_744;
					}
					var_0_object->GetPFPosition(var_220_cvector); //@t
...
void func_2082(bool var_617_bool)
{
	bool var_619_bool;
...
void func_1625(bool var_606_bool, object var_607_object)
{
...
void func_2189(object var_52_object)
{
...
void func_2205(cvector var_140_cvector, cvector var_141_cvector, cvector var_142_cvector, float var_143_float)
{
...
void func_1186(bool var_646_bool)
{
	var_646_bool = true;
}
...
// @pe
void func_2242(bool var_13_bool)
{
	var_13_bool = false;
}
...
void func_796(object var_0_object, float var_521_float, int var_522_int)
{
	...
	if(var_526_object == var_0_object) {
		...
		@ReportHit(var_0_object, var_600_int, var_528_float, var_537_float);
...
void func_292(bool var_59_bool, object var_60_object, bool var_82_bool, object var_687_object)
{
...
void func_835(object var_0_object, bool var_1_bool, bool var_488_bool, float var_489_float)
{
	...
	if(var_495_bool != 0) {
		...
		func_1176(var_497_string);
		bool var_631_bool;
		func_1697(var_631_bool, var_0_object);
		if(!var_631_bool) { //@nz
			@StopAsync();
			var_488_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_495_bool) { //@nz
				...
				func_1176(var_497_string);
				bool var_657_bool;
				func_1697(var_657_bool, var_0_object);
				if(!var_657_bool) { //@nz
					@StopAsync();
					var_488_bool = false;
					return 8;
...
void func_329(object var_0_object, bool var_80_bool, object var_81_object, object var_198_object)
{
	...
	func_2205(var_140_cvector, var_141_cvector, var_142_cvector, 2000.0);
...
void func_974(bool var_647_bool, float var_648_float)
{
...
// @pe
void func_491(object var_601_object, float var_602_float)
{
