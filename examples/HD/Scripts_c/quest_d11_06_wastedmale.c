...
// @PE: 0x4a,0x89,0x9f,0x104,0x10f,0x139,0x150,0x28d,0x29b

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_578();
		var_15_bool = var_11_object == (int)36162;
		if(var_15_bool != 0) {
		...
		var_50_bool = var_10_bool == (int)36161;
		if(var_50_bool != 0) {
			var_51_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)534520);
			@@@var_0_object:ClearReplies();
			var_69_bool = 0; var_70_object = Obj();
			var_70_object = var_1_object;
			func_667(var_69_bool, var_70_object);
			if(var_69_bool != 0) {
				@@@var_0_object:AddReply((int)539598, (int)41545, (int)41544);
			}
			@@@var_0_object:AddReply((int)539597, (int)-1, (int)41543);
			return 0;
		}
		var_95_bool = var_10_bool == (int)41545;
		if(var_95_bool != 0) {
			var_96_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)539599);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540801, (int)42853, (int)42852);
			return 0;
		}
		var_102_bool = var_10_bool == (int)42853;
		if(var_102_bool != 0) {
			var_103_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)540802);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)534521, (int)-1, (int)36162);
			return 0;
		}
		var_3_string = true;
		var_108_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_335;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_449(var_25_bool, var_26_object, (float)70.0);
...
func_518()
{
	...
	if(var_159_bool != 0) {
		...
		if(var_161_bool == 0) goto Label_535;
		UnlookAsync("head");
	}
Label_535:
	return 2;
...
func_271(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_10_float, var_11_float)
{
	var_12_bool = 0;
...
func_298(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_436(var_17_float, var_18_object);
...
func_695()
{
	...
	func_721(var_25_bool, var_26_object, (int)686);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_449(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_512;
...
func_600(var_114_bool, var_115_object, var_116_string)
{
...
Label_364:
	...
	if(var_48_bool != 0) {
		...
		if(var_54_bool != 0) {
			...
			if(var_55_int == 0) goto Label_397;
			...
			if(var_59_bool != 0) {
				...
				if(var_69_int == 0) goto Label_415;
				goto Label_426;
		}
		Label_415:
			var_60_bool = 0;
