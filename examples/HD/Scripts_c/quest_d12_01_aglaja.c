...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Isee|W:Threat|W:Arrogance|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ood12AglajaSobor1|W:branch|W:ui/NPC_Aglaja.png|W:ui/NPC_Aglaja_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x1d5
// @RUN_TASK: 2
...
// @PE: 0x51,0x95,0xab,0x1d5,0x1d9,0x347,0x34d

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_802();
		var_11_bool = var_7_bool == (int)40335;
		if(var_11_bool != 0) {
		...
		var_17_bool = var_6_int == (int)40334;
		if(var_17_bool != 0) {
			var_18_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538452);
			@@@var_0_object:ClearReplies();
			var_36_bool = 0; var_37_object = Obj();
			var_37_object = var_1_object;
			func_845(var_37_object);
			if(var_36_bool != 0) {
				@@@var_0_object:AddReply((int)538453, (int)40350, (int)40335);
			}
			@@@var_0_object:AddReply((int)538470, (int)-1, (int)40352);
			@@@var_0_object:AddReply((int)538472, (int)-1, (int)40354);
			return 0;
		}
		var_54_bool = var_6_int == (int)40350;
		if(var_54_bool != 0) {
			var_55_string = "";
			func_149(var_7_bool, "Isee");
			@@@var_0_object:SetMessage((int)538468);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539946, (int)41911, (int)41910);
			@@@var_0_object:AddReply((int)539948, (int)-1, (int)41912);
			return 0;
		}
		var_64_bool = var_6_int == (int)41911;
		if(var_64_bool != 0) {
			var_65_string = "";
			func_149(var_7_bool, "Isee");
			@@@var_0_object:SetMessage((int)539947);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539949, (int)41914, (int)41913);
			@@@var_0_object:AddReply((int)539951, (int)-1, (int)41915);
			return 0;
		}
		var_74_bool = var_6_int == (int)41914;
		if(var_74_bool != 0) {
			var_75_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)539950);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538469, (int)40336, (int)40351);
			@@@var_0_object:AddReply((int)539952, (int)40338, (int)41916);
			return 0;
		}
		var_84_bool = var_6_int == (int)40336;
		if(var_84_bool != 0) {
			var_85_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538454);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538455, (int)40338, (int)40337);
			@@@var_0_object:AddReply((int)539953, (int)40342, (int)41918);
			return 0;
		}
		var_94_bool = var_6_int == (int)40338;
		if(var_94_bool != 0) {
			var_95_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538456);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538457, (int)40340, (int)40339);
			return 0;
		}
		var_101_bool = var_6_int == (int)40340;
		if(var_101_bool != 0) {
			var_102_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538458);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538459, (int)40342, (int)40341);
			return 0;
		}
		var_108_bool = var_6_int == (int)40342;
		if(var_108_bool != 0) {
			var_109_string = "";
			func_149(var_7_bool, "Threat");
			@@@var_0_object:SetMessage((int)538460);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538461, (int)40344, (int)40343);
			@@@var_0_object:AddReply((int)538475, (int)40344, (int)40358);
			return 0;
		}
		var_118_bool = var_6_int == (int)40344;
		if(var_118_bool != 0) {
			var_119_string = "";
			func_149(var_7_bool, "Threat");
			@@@var_0_object:SetMessage((int)538462);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538463, (int)40346, (int)40345);
			return 0;
		}
		var_125_bool = var_6_int == (int)40346;
		if(var_125_bool != 0) {
			var_126_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538464);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538465, (int)40348, (int)40347);
			@@@var_0_object:AddReply((int)538474, (int)40348, (int)40356);
			return 0;
		}
		var_135_bool = var_6_int == (int)40348;
		if(var_135_bool != 0) {
			var_136_string = "";
			func_149(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538466);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538467, (int)16089, (int)40349);
			@@@var_0_object:AddReply((int)538473, (int)16089, (int)40355);
			return 0;
		}
		var_145_bool = var_6_int == (int)16089;
		if(var_145_bool != 0) {
			var_146_string = "";
			func_149(var_7_bool, "Arrogance");
			@@@var_0_object:SetMessage((int)514843);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)514844, (int)-1, (int)16090);
			@@@var_0_object:AddReply((int)514845, (int)-1, (int)16091);
			return 0;
		}
		var_3_string = true;
		var_154_bool = 0;
		func_882(var_154_bool);
		if(var_154_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_11_bool != 0) {
			var_14_object = Obj();
			func_809(var_14_object);
			RemoveActor(var_14_object);
		}
	} else {
		var_18_bool = var_6_string == "restore";
		if(var_18_bool == 0) goto Label_512;
		var_0_object = false;
	}
Label_512:
	return 2;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_531(var_18_bool, var_19_object, (float)70.0);
...
func_839()
{
	SetVariable("ood12AglajaSobor1", (int)1);
	return 0;
}


func_713(var_121_bool, var_122_object)
{
...
Label_722:
	...
	func_787(var_153_bool, var_154_string);
...
func_845(var_199_bool)
{
	...
	func_825(var_201_int, "ood12AglajaSobor1");
...
func_531(var_18_bool, var_19_object, var_20_float)
{
	...
	if(var_61_bool != 0) {
		...
		if(var_63_bool == 0) goto Label_594;
...
func_676(var_90_bool, var_91_object)
{
