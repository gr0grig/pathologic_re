...
void func_0(object var_0_object, int var_7_int, object var_8_object)
{
	...
	func_531(var_18_bool, var_19_object, 70.0);
	if(!var_18_bool) { //@nz
		var_7_int = -2;
		return 8;
	}
...
void func_772(string var_185_string, bool var_186_bool)
{
...
void func_713(bool var_121_bool, object var_122_object)
{
...
// @pe
void func_845(bool var_199_bool)
{
	int var_201_int;
...
void func_531(bool var_18_bool, object var_19_object, float var_20_float)
{
	...
	func_815(var_45_cvector, (var_34_cvector ^ [0.0, 1.0, 0.0]));
...
void func_787(bool var_113_bool, string var_114_string)
{
	bool var_116_bool;
	bool var_117_bool;
...
void func_600(void)
{
	...
	if(var_239_bool != 0) {
		...
		if(var_237_bool == 0) goto Label_617;
		@UnlookAsync("head");
	}
Label_617:
...
void func_676(bool var_90_bool, object var_91_object)
{
...
void func_809(object var_9_object)
{
...
void func_874(int var_67_int)
{
	var_67_int = 515527;
}


void func_618(bool var_79_bool, object var_80_object)
{
...
void func_878(string var_68_string)
{
	var_68_string = "ui/NPC_Aglaja.png";
}


void func_815(cvector var_45_cvector, cvector var_46_cvector)
{
...
void func_880(string var_69_string)
{
	var_69_string = "ui/NPC_Aglaja_b.png";
}


void func_882(bool var_61_bool)
{
	var_61_bool = true;
}


void func_756(string var_218_string)
{
...
void func_825(int var_201_int, string var_202_string)
{
	int var_204_int;
