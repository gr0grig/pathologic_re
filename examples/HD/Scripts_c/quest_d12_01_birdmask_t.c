	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 37172) {
				...
				if(!var_177_bool) { //@nz
					func_227(var_11_object, "Neutral");
					var_0_object->SetMessage(541615); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(541616, 43789, 43788); //@t
					var_0_object->AddReply(541620, -1, 43792); //@t
					return 0;
				}
			...
			if(var_10_bool == 43789) {
				func_227(var_11_object, "Neutral");
				var_0_object->SetMessage(541617); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(541618, -1, 43790); //@t
				var_0_object->AddReply(541619, -1, 43791); //@t
				return 0;
			}
...
// @pe
void func_949(bool var_281_bool)
{
	int var_283_int;
...
// @pe
void func_961(bool var_228_bool)
{
	int var_230_int;
...
// @pe
void func_973(bool var_260_bool)
{
	int var_262_int;
