...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Sexy|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Love|W:Neutral|W:Fear|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ood12EvaRevenant1|W:branch|W:ui/NPC_Eva.png|W:ui/NPC_Eva_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x229
// @RUN_TASK: 2
...
// @PE: 0x51,0xa4,0xba,0x229,0x22d,0x39b,0x3a1

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_886();
		var_11_bool = var_7_bool == (int)43835;
		if(var_11_bool != 0) {
		...
		var_17_bool = var_7_bool == (int)43839;
		if(var_17_bool != 0) {
		...
		var_21_bool = var_7_bool == (int)43844;
		if(var_21_bool != 0) {
		...
		var_25_bool = var_6_int == (int)43834;
		if(var_25_bool != 0) {
			var_26_string = "";
			func_164(var_7_bool, "Sexy");
			@@@var_0_object:SetMessage((int)541659);
			@@@var_0_object:ClearReplies();
			var_44_bool = 0; var_45_object = Obj();
			var_45_object = var_1_object;
			func_929(var_45_object);
			if(var_44_bool != 0) {
				@@@var_0_object:AddReply((int)541660, (int)43852, (int)43835);
			}
			var_55_bool = 0; var_56_object = Obj();
			var_56_object = var_1_object;
			func_929(var_56_object);
			if(var_55_bool != 0) {
				@@@var_0_object:AddReply((int)541664, (int)43840, (int)43839);
			}
			var_60_bool = 0; var_61_object = Obj();
			var_61_object = var_1_object;
			func_929(var_61_object);
			if(var_60_bool != 0) {
				@@@var_0_object:AddReply((int)541668, (int)43845, (int)43844);
			}
			@@@var_0_object:AddReply((int)541661, (int)-1, (int)43836);
			return 0;
		}
		var_69_bool = var_6_int == (int)43845;
		if(var_69_bool != 0) {
			var_70_string = "";
			func_164(var_7_bool, "Love");
			@@@var_0_object:SetMessage((int)541669);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541670, (int)43840, (int)43846);
			@@@var_0_object:AddReply((int)541682, (int)43860, (int)43859);
			return 0;
		}
		var_79_bool = var_6_int == (int)43860;
		if(var_79_bool != 0) {
			var_80_string = "";
			func_164(var_7_bool, "Love");
			@@@var_0_object:SetMessage((int)541683);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541684, (int)43863, (int)43861);
			@@@var_0_object:AddReply((int)541685, (int)-1, (int)43862);
			return 0;
		}
		var_89_bool = var_6_int == (int)43863;
		if(var_89_bool != 0) {
			var_90_string = "";
			func_164(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)541686);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541687, (int)-1, (int)43864);
			@@@var_0_object:AddReply((int)541688, (int)-1, (int)43865);
			return 0;
		}
		var_99_bool = var_6_int == (int)43840;
		if(var_99_bool != 0) {
			var_100_string = "";
			func_164(var_7_bool, "Sexy");
			@@@var_0_object:SetMessage((int)541665);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541666, (int)43852, (int)43841);
			@@@var_0_object:AddReply((int)541667, (int)43851, (int)43842);
			return 0;
		}
		var_109_bool = var_6_int == (int)43851;
		if(var_109_bool != 0) {
			var_110_string = "";
			func_164(var_7_bool, "Fear");
			@@@var_0_object:SetMessage((int)541675);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541680, (int)43838, (int)43856);
			@@@var_0_object:AddReply((int)541681, (int)-1, (int)43857);
			return 0;
		}
		var_119_bool = var_6_int == (int)43852;
		if(var_119_bool != 0) {
			var_120_string = "";
			func_164(var_7_bool, "Sexy");
			@@@var_0_object:SetMessage((int)541676);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541677, (int)43854, (int)43853);
			@@@var_0_object:AddReply((int)541689, (int)-1, (int)43867);
			return 0;
		}
		var_129_bool = var_6_int == (int)43854;
		if(var_129_bool != 0) {
			var_130_string = "";
			func_164(var_7_bool, "Sexy");
			@@@var_0_object:SetMessage((int)541678);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541679, (int)43838, (int)43855);
			@@@var_0_object:AddReply((int)541690, (int)43850, (int)43869);
			return 0;
		}
		var_139_bool = var_6_int == (int)43838;
		if(var_139_bool != 0) {
			var_140_string = "";
			func_164(var_7_bool, "Fear");
			@@@var_0_object:SetMessage((int)541663);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541671, (int)43848, (int)43847);
			@@@var_0_object:AddReply((int)541691, (int)43871, (int)43870);
			return 0;
		}
		var_149_bool = var_6_int == (int)43871;
		if(var_149_bool != 0) {
			var_150_string = "";
			func_164(var_7_bool, "Love");
			@@@var_0_object:SetMessage((int)541692);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541694, (int)43875, (int)43873);
			@@@var_0_object:AddReply((int)541858, (int)43875, (int)44083);
			return 0;
		}
		var_159_bool = var_6_int == (int)43848;
		if(var_159_bool != 0) {
			var_160_string = "";
			func_164(var_7_bool, "Fear");
			@@@var_0_object:SetMessage((int)541672);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541673, (int)43875, (int)43849);
			@@@var_0_object:AddReply((int)541693, (int)43850, (int)43872);
			return 0;
		}
		var_169_bool = var_6_int == (int)43850;
		if(var_169_bool != 0) {
			var_170_string = "";
			func_164(var_7_bool, "Fear");
			@@@var_0_object:SetMessage((int)541674);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541698, (int)43875, (int)43879);
			@@@var_0_object:AddReply((int)541699, (int)-1, (int)43881);
			return 0;
		}
		var_179_bool = var_6_int == (int)43875;
		if(var_179_bool != 0) {
			var_180_string = "";
			func_164(var_7_bool, "Love");
			@@@var_0_object:SetMessage((int)541695);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541696, (int)-1, (int)43876);
			@@@var_0_object:AddReply((int)541697, (int)-1, (int)43877);
			return 0;
		}
		var_3_string = true;
		var_188_bool = 0;
		func_966(var_188_bool);
		if(var_188_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_11_bool != 0) {
			var_14_object = Obj();
			func_893(var_14_object);
			RemoveActor(var_14_object);
		}
	} else {
		var_18_bool = var_6_string == "restore";
		if(var_18_bool == 0) goto Label_596;
		var_0_object = false;
	}
Label_596:
	return 2;
...
func_964(var_69_string)
{
	var_69_string = "ui/NPC_Eva_b.png";
	return 0;
}
...
func_840(var_225_string)
{
	...
	lshHasAnimation(var_229_bool, var_225_string);
	var_232_bool = var_229_bool;
	if(var_232_bool != 0) {
		lshGetAnimTimes(var_225_string, var_230_float, var_231_float);
		lshPlayAnimation(var_230_float, var_231_float, (bool)0);
	} else {
		var_235_int = "Can't find lsh animation : " + var_225_string;
		Trace(var_235_int);
	}
	return 6;
...
func_923()
{
	SetVariable("ood12EvaRevenant1", (int)1);
	return 0;
}
...
Label_806:
	...
	func_871(var_153_bool, var_154_string);
...
func_929(var_199_bool)
{
	...
	func_909(var_201_int, "ood12EvaRevenant1");
