...
// @STRINGS: W:quest_d12_01|W:hidden_room_cutscene_end|W:hidden_room|W:cs_d12_littlegirl_big|W:cs_play_all.bin|W:cs_d12_littleboy_big|A:ForceGeometryLoad|W:player|W:cs_d12_hidden_room.mot|W:noaccess|A:HasProperty|A:GetProperty|A:SetProperty|A:RemoveProperty
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
main()
{
	...
	func_118(var_46_bool, "quest_d12_01", "hidden_room_cutscene_end");
	var_52_object = Obj();
