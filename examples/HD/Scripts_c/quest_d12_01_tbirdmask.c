...
void func_513(bool var_18_bool)
{
	var_18_bool = true;
}
...
// @pe
void func_515(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_21_float, float var_22_float)
{
	bool var_23_bool;
...
// @pe
void func_904(bool var_125_bool)
{
	int var_127_int;
...
void func_780(string var_141_string)
{
...
void func_796(string var_111_string, bool var_112_bool)
{
...
void func_542(object var_0_object, object var_1_object, bool var_4_bool, bool var_15_bool)
{
	if(var_4_bool == null)
		var_15_bool = false;
	float var_19_float;
	func_680(var_19_float, var_4_bool);
...
void func_673(bool var_71_bool)
{
	var_71_bool = true;
}
...
void func_933(int var_76_int)
{
	var_76_int = 515571;
}


void func_935(int var_75_int)
{
	var_75_int = 504029;
}


void func_680(float var_19_float, object var_20_object)
{
...
void func_939(string var_78_string)
{
	var_78_string = "ui/NPC_bmask_b.png";
}


void func_811(object var_29_object)
{
	float var_32_float;
...
void func_941(bool var_70_bool)
{
	var_70_bool = false;
}


void func_688(bool var_23_bool)
{
	bool var_25_bool;
...
void func_693(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_835(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
...
void func_829(object var_19_object)
{
...
void func_446(int var_6_int, float var_12_float, float var_13_float)
{
	...
	for(;;) {
		...
		func_515(var_22_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
		var_6_int = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_835(cvector var_54_cvector, cvector var_55_cvector)
{
...
void func_845(int var_127_int, string var_128_string)
{
	int var_130_int;
...
void func_594(void)
{
	...
	for(;;) {
		...
		if(var_59_bool != 0) {
			@irand(var_39_int, 3);
			if(var_39_int == 0) {
				if(var_37_int == 0) goto Label_641;
			...
			if(var_39_int == 1) {
				...
				goto Label_670;
					...
					if(var_72_bool == 0) goto Label_665;
			}
		}
	Label_670:
		for(;;) {
...
void func_850(string var_97_string, bool var_98_bool)
{
...
void func_867(string var_52_string, int var_53_int)
{
...
void func_762(void)
{
	...
	if(var_162_bool != 0) {
		...
		if(var_160_bool == 0) goto Label_779;
		@UnlookAsync("head");
	}
Label_779:
