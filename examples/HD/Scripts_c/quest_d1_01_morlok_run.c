...
void func_644(int var_0_int, int var_1_int, bool var_344_bool, float var_345_float)
{
	...
	if(var_351_bool != 0) {
		...
		func_983(var_353_string);
		bool var_470_bool;
		func_1567(var_470_bool, var_0_int);
		if(!var_470_bool) { //@nz
			@StopAsync();
			var_344_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_351_bool) { //@nz
				...
				func_983(var_353_string);
				bool var_496_bool;
				func_1567(var_496_bool, var_0_int);
				if(!var_496_bool) { //@nz
					@StopAsync();
					var_344_bool = false;
					return 8;
...
void func_781(bool var_486_bool, float var_487_float)
{
...
void func_1948(object var_16_object)
{
...
void func_1836(object var_18_object)
{
	bool var_20_bool;
...
void func_1856(string var_74_string, int var_75_int)
{
		...
		if(var_83_bool != 0) {
			...
			if(var_44_float >= (var_25_float * var_25_float)) {
				...
				if(var_243_bool != 0) {
					...
					bool var_507_bool;
					func_1567(var_507_bool, var_0_int);
					if(!var_507_bool) { //@nz
						goto Label_553;
					}
					var_0_int->GetPFPosition(var_38_cvector); //@t
...
void func_605(int var_0_int, float var_381_float, int var_382_int)
{
	...
	if(var_386_object == var_0_int) {
		...
		@ReportHit(var_0_int, var_460_int, var_388_float, var_397_float);
...
// @pe
void func_1886(object var_19_object)
{
	int var_20_int;
...
void func_997(bool var_485_bool)
{
	var_485_bool = true;
}
...
void func_1899(string var_25_string)
{
	object var_29_object;
