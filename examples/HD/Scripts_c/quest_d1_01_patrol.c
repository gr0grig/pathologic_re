...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:cleanup|W:player|W:head|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |W:ui/NPC_Citizen2.png|W:ui/NPC_Citizen2_b.png|W:d1q01|W:d1q01PatrolGotoAlexandr|W:pt_map_alexandr|A:AddMark|A:ShowMap|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:Can't find main outdoor scene|A:GetMap|A:GetLocator|W:Warning: outdoor scene locator |W: doesnt exist|W:Can't find map|A:SetMapParams|W:branch
// @GLOBALS: 0:object:
// @RUN_OP: 0x16c
// @RUN_TASK: 2
...
// @PE: 0x4a,0x9d,0xb3,0x172,0x1a3,0x1c2,0x1ec,0x203,0x34f,0x35f

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	if((int)1 != 0) {
		func_757();
		var_17_bool = var_13_bool == (int)33064;
		if(var_17_bool != 0) {
			...
			func_847(var_62_object);
		}
		var_88_bool = var_12_bool == (int)33063;
		if(var_88_bool != 0) {
			var_89_bool = 0; var_90_object = Obj();
			var_90_object = var_1_object;
			func_863(var_90_object);
			if(var_89_bool != 0) {
				var_97_string = "";
				func_157(var_13_bool, "Neutral");
				@@@var_0_object:SetMessage((int)531679);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)533040, (int)34551, (int)34550);
				@@@var_0_object:AddReply((int)533055, (int)34553, (int)34561);
				return 0;
			}
			var_121_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)531681);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)531682, (int)-1, (int)33066);
			@@@var_0_object:AddReply((int)533033, (int)-1, (int)34543);
			return 0;
		}
		var_130_bool = var_12_bool == (int)34551;
		if(var_130_bool != 0) {
			var_131_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)533041);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533042, (int)34553, (int)34552);
			@@@var_0_object:AddReply((int)533056, (int)34545, (int)34562);
			return 0;
		}
		var_140_bool = var_12_bool == (int)34553;
		if(var_140_bool != 0) {
			var_141_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)533043);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533034, (int)34545, (int)34544);
			@@@var_0_object:AddReply((int)533058, (int)34547, (int)34567);
			return 0;
		}
		var_150_bool = var_12_bool == (int)34545;
		if(var_150_bool != 0) {
			var_151_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)533035);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533036, (int)34547, (int)34546);
			return 0;
		}
		var_157_bool = var_12_bool == (int)34547;
		if(var_157_bool != 0) {
			var_158_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)533037);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533038, (int)34549, (int)34548);
			@@@var_0_object:AddReply((int)533059, (int)34549, (int)34569);
			return 0;
		}
		var_167_bool = var_12_bool == (int)34549;
		if(var_167_bool != 0) {
			var_168_string = "";
			func_157(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)533039);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)531680, (int)-1, (int)33064);
			return 0;
		}
		var_3_string = true;
		var_173_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	if(var_14_bool != 0) {
		...
		if(var_15_bool != 0) {
			...
			if(var_36_object == 0) goto Label_514;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_628(var_27_bool, var_28_object, (float)70.0);
...
Label_543:
	...
	if(var_59_bool != 0) {
		...
		if(var_65_bool != 0) {
			...
			if(var_66_int == 0) goto Label_576;
			...
			if(var_70_bool != 0) {
				...
				if(var_80_int == 0) goto Label_594;
				goto Label_605;
		}
		Label_594:
			var_71_bool = 0;
...
func_824()
{
	...
	SetVariable("d1q01", (int)3);
	func_929(Obj());
	var_24_object = var_21_object;
	var_35_float = 0;
	func_785(var_35_float);
	@@var_21_object:AddMark("d1q01PatrolGotoAlexandr", "pt_map_alexandr", (int)1, (int)508632, var_35_float);
	func_875();
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_697()
{
	...
	if(var_158_bool != 0) {
		...
		if(var_160_bool == 0) goto Label_714;
		UnlookAsync("head");
	}
Label_714:
	return 2;
...
func_450(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_21_float, var_22_float)
{
	var_23_bool = 0;
...
func_477(var_0_object, var_1_object, var_4_bool, var_15_bool)
{
	...
	func_615(var_19_float, var_20_object);
...
func_875()
{
	...
	CreateDiaryEntry(var_39_object, (int)33, (int)1, (int)512115);
	var_43_bool = 0; var_44_object = Obj(); var_45_int = 0;
	var_39_object = var_44_object;
	func_901(var_43_bool, var_44_object, (int)2);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_628(var_27_bool, var_28_object, var_29_float)
{
	...
	if(var_70_bool != 0) {
		...
		if(var_72_bool == 0) goto Label_691;
...
Label_383:
	...
	func_450(var_13_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
	var_6_int = false;
	goto Label_383;
}
EMIT "Return(); Pop(4)";
