...
// @pe
void func_3585(object var_60_object)
{
		...
		if(var_141_bool != 0) {
			...
			if(var_102_float >= (var_83_float * var_83_float)) {
				...
				if(var_269_bool != 0) {
					...
					bool var_533_bool;
					func_2625(var_533_bool, var_0_object);
					if(!var_533_bool) { //@nz
						goto Label_1752;
					}
					var_0_object->GetPFPosition(var_96_cvector); //@t
...
void func_3074(float var_477_float)
{
...
// @pe
void func_3593(int var_30_int, object var_31_object)
{
	object var_33_object;
...
// @pe
void func_3603(object var_73_object)
{
...
// @pe
void func_3611(int var_27_int, object var_28_object)
{
	object var_31_object;
...
void func_3100(object var_21_object)
{
	bool var_23_bool;
...
// @pe
void func_3618(object var_72_object)
{
...
// @pe
void func_3627(object var_29_object)
{
...
// @pe
void func_3634(int var_128_int)
{
	var_128_int = 0;
}
...
// @pe
void func_3126(bool var_122_bool)
{
	int var_124_int;
...
// @pe
void func_3639(bool var_24_bool)
{
	var_24_bool = false;
}
...
void func_3644(bool var_31_bool, object var_32_object)
{
	bool var_34_bool;
...
void func_3138(int var_106_int)
{
	int var_108_int;
...
// @pe
void func_3659(object var_59_object)
{
...
// @pe
void func_3665(bool var_48_bool)
{
	var_48_bool = false;
}


void func_3069(int var_124_int, string var_125_string)
{
	int var_127_int;
...
void func_3155(int var_157_int)
{
	int var_159_int;
...
// @pe
void func_3675(bool var_26_bool)
{
	var_26_bool = false;
}
...
// @pe
void func_3161(object var_35_object)
{
	int var_36_int;
...
void func_3680(int var_103_int)
{
	var_103_int = 518097;
}


void func_3682(int var_102_int)
{
	var_102_int = 518096;
}


void func_3684(string var_104_string)
{
	var_104_string = "ui/NPC_Citizen2.png";
}


void func_3686(string var_105_string)
{
...
void func_3688(bool var_97_bool)
{
	var_97_bool = false;
}


void func_3174(int var_115_int, int var_116_int)
{
...
void func_3698(object var_30_object)
{
	bool var_32_bool;
...
void func_3716(bool var_63_bool)
{
	var_63_bool = false;
}


void func_3205(string var_163_string)
{
...
// @pe
void func_3718(bool var_23_bool)
{
	var_23_bool = true;
}
...
{
	func_3100(var_0_object);
}


// @pe
void func_3721(object var_101_object)
{
...
void func_2187(int var_486_int)
{
	var_486_int = 0;
}
...
void func_2196(bool var_511_bool)
{
	var_511_bool = true;
}
...
// @pe
void func_3749(object var_42_object)
{
...
void func_3246(void)
{
	...
	func_3174(0, (10 + (var_118_int * 10)));
	func_2927("hook", 1, 4);
	func_2927("watch", 1, 10);
}
...
void func_3274(bool var_20_bool)
{
	@ClearSubContainer(0);
	int var_28_int;
	...
	if(var_20_bool != 0) {
		func_2938("alpha_pills", 1, 2, 4);
		func_2938("meradorm", 2, 3, 3);
		if(var_26_int >= 3)
			func_2927("beta_pills", 1, 4);
		if(var_26_int >= 8) {
			func_2938("monomicin", 1, 2, 2);
		} else {
				if(var_26_int >= 4)
					func_2927("monomicin", 1, 2);
				func_2927("lockpick", 1, 4);
				func_2927("rifle_ammo", 1, 2);
				func_2927("revolver_ammo", 1, 2);
				func_2938("samopal_ammo", 1, 2, 2);
				if(var_26_int >= 8)
					func_2938("monomicin", 1, 2, 2);
			}
...
void func_2791(bool var_54_bool, object var_55_object, float var_56_float)
{
	...
	func_3000(var_81_cvector, (var_70_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_97_bool != 0) {
		...
		if(var_74_bool == 0) goto Label_2854;
...
void func_2860(void)
{
	...
	if(var_189_bool != 0) {
		...
		if(var_187_bool == 0) goto Label_2877;
		@UnlookAsync("head");
	}
Label_2877:
...
void func_3374(int var_136_int, string var_137_string)
{
	int var_139_int;
...
void func_1843(object var_0_object, object var_1_object, bool var_370_bool, float var_371_float)
{
	...
	if(var_377_bool != 0) {
		...
		func_2182(var_379_string);
		bool var_496_bool;
		func_2625(var_496_bool, var_0_object);
		if(!var_496_bool) { //@nz
			@StopAsync();
			var_370_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_377_bool) { //@nz
				...
				func_2182(var_379_string);
				bool var_522_bool;
				func_2625(var_522_bool, var_0_object);
				if(!var_522_bool) { //@nz
					@StopAsync();
					var_370_bool = false;
					return 8;
...
// @pe
void func_3379(object var_19_object)
{
	object var_20_object;
...
void func_2878(string var_160_string)
{
...
void func_2894(string var_138_string, bool var_139_bool)
{
...
void func_2909(object var_22_object)
{
	float var_25_float;
...
// @pe
void func_3424(bool var_22_bool, object var_23_object, string var_24_string)
{
...
void func_2927(string var_57_string, int var_58_int, int var_59_int)
{
	bool var_61_bool;
	int var_63_int;
...
void func_2938(string var_35_string, int var_36_int, int var_37_int, int var_38_int)
{
...
// @pe
void func_3456(object var_52_object, string var_53_string)
{
...
Label_3480:
	...
	if(!(var_53_string == "battle")) goto Label_3480;
...
void func_2953(string var_44_string)
{
	...
	if(var_66_bool == 0) goto Label_2973;
}
...
void func_3481(bool var_19_bool, object var_20_object)
{
	bool var_22_bool;
...
// @pe
void func_3504(object var_33_object)
{
	object var_34_object;
...
void func_2994(object var_106_object)
{
...
// @pe
void func_3510(object var_21_object)
{
...
void func_3000(cvector var_50_cvector, cvector var_51_cvector)
{
...
void func_1980(bool var_512_bool, float var_513_float)
{
...
// @pe
void func_3010(float var_459_float, float var_460_float, float var_461_float)
{
...
void func_3523(bool var_19_bool, string var_20_string)
{
	object var_22_object;
...
// @pe
void func_3017(float var_469_float, float var_470_float, float var_471_float, float var_472_float)
{
...
void func_2511(float var_421_float, object var_422_object, float var_423_float, int var_424_int)
{
	...
	float var_459_float;
	func_3010(var_459_float, ((var_434_int + var_436_int) / 100.0), (float)1);
	float var_437_float;
	...
	float var_469_float;
	func_3017(var_469_float, (var_438_float - var_439_float), (float)0, (float)1);
...
void func_3539(string var_30_string)
{
	object var_32_object;
...
void func_3028(bool var_43_bool, int var_44_int, int var_45_int)
{
	int var_47_int;
...
// @pe
void func_3033(float var_71_float, cvector var_72_cvector, cvector var_73_cvector)
{
...
void func_3552(string var_154_string, int var_155_int)
{
...
// @pe
void func_3042(float var_80_float, cvector var_81_cvector)
{
...
void func_3559(int var_148_int)
{
...
// @pe
void func_3052(float var_68_float, cvector var_69_cvector, cvector var_70_cvector)
{
