// @IMPORTS: GetLocator/3,Trace/1,GetProperty/2,GetLocator/4,RandOneOf/11,AddActorByType/6,RandVec2D/2,RandOneOf/15,RandOneOf/13,CreateIntVector/1,Hold/0,RemoveActor/1,self/1,rand/1,CreateObjectVector/1,AddActor/6
// @STRINGS: W:pt_child|W:not enough locators for quest b4q01|A:add|W:pers_doberman|W:d1q04_doberman1.xml|W:d1q04_doberman2.xml|W:nailed|W:pt_item_food|W:pt_item_pfood|W:pt_item_knife|W:pt_item_bottle|W:bread|W:bottle_water|W:milk|W:vegetables|W:lemon|W:scripted_container|W:item_|W:_steal.xml|W:item_plate.xml|W:rusk|W:dried_fish|W:dried_meat|W:smoked_meat|W:fresh_fish|W:fresh_meat|W:tvirin|W:item_knife_steal.xml|W:bottle_empty|W:egg|A:size|A:get|A:IsDead|W:ToDie|A:remove|W:HasProperty|A:HasProperty|A:GetLocator|W:Locator |W: doesn't exist|A:clear
// @RUN_OP: 0x39
// @RUN_TASK: 0
// @TASK_0: vars=object,object params=0
// @EVENT_5: op=0x178 vars=
// @EVENT_6: op=0x1b8 vars=
// @PE: 0x1c,0x25,0x28,0x39
...
{
	var_208_int = 0; var_209_string = ""; var_210_bool = 0; var_211_cvector = CVector(0,0,0); var_212_int = 0; var_213_int = 0; var_214_string = ""; var_215_bool = 0; var_216_cvector = CVector(0,0,0); var_217_int = 0;
	var_213_int = 1;
	
Label_2:
	var_219_bool = var_213_int <= (int)2;
	if(var_219_bool != 0) {
		var_214_string = "pt_child" + var_213_int;
		GetLocator(var_214_string, var_215_bool, var_216_cvector);
		...
		if(var_221_bool != 0) {
			...
			var_217_int = var_213_int - (int)1;
			@@var_207_object:add(var_217_int);
			var_213_int = var_213_int + (int)1;
			goto Label_2;
		}
	}
	return 10;
...
func_514(var_57_object, var_58_object, var_59_string, var_60_string, var_61_string)
{
	var_65_bool = 0; var_66_cvector = CVector(0,0,0); var_67_cvector = CVector(0,0,0); var_68_object = Obj(); var_69_bool = 0; var_70_cvector = CVector(0,0,0); var_71_cvector = CVector(0,0,0); var_72_object = Obj();
	@@var_58_object:GetLocator(var_59_string, var_69_bool, var_70_cvector, var_71_cvector);
	var_73_bool = var_69_bool == 0; //@nz
	if(var_73_bool != 0) {
		var_75_int = "Locator " + var_59_string;
		var_77_int = var_75_int + " doesn't exist";
		Trace(var_77_int);
	} else {
		AddActor(Obj(), var_60_string, var_58_object, var_70_cvector, var_71_cvector, var_61_string);
	}
	var_72_object = var_57_object;
	return 8;
...
func_220(var_76_cvector, var_77_cvector, var_78_bool)
{
	...
	if(var_97_bool != 0) {
		...
		func_503(var_128_bool, (float)0.5);
...
func_161(var_17_cvector, var_18_cvector, var_19_bool)
{
	...
	if(var_32_bool != 0) {
		...
		func_503(var_55_bool, (float)0.5);
...
func_40(var_48_string, var_49_int, var_50_int)
{
	var_52_bool = var_49_int == (int)0;
	if(var_52_bool != 0) {
		var_54_bool = var_50_int == (int)0;
		if(var_54_bool != 0) {
			var_48_string = "d1q04_doberman1.xml";
			return 0;
		EMIT "GOTO 0x37";
		}
		var_56_bool = var_50_int == (int)1;
		if(var_56_bool != 0) {
