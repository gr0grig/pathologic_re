	...
	if(var_11_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			var_1_object = 0;
				...
				var_137_bool = var_6_string == "patrol1_unload";
				if(var_137_bool != 0) {
					@@@var_2_object:Remove();
					var_2_object = 0;
					goto Label_36;
				}
				var_139_bool = var_6_string == "patrol2_unload";
				if(var_139_bool == 0) goto Label_36;
				@@@var_3_object:Remove();
				var_3_object = 0;
		}
	}
Label_36:
	...
	if(var_14_bool != 0) {
		...
		if(var_16_bool != 0) {
			...
			var_123_bool = var_6_string == "completed";
			if(var_123_bool == 0) goto Label_107;
			func_162();
	}
		var_125_bool = var_6_string == "driver_unload";
		if(var_125_bool != 0) {
			var_126_int = 0;
			func_196(var_7_object, var_8_object, var_9_object, var_10_object, (int)0);
			goto Label_139;
		}
		var_128_bool = var_6_string == "mpatrol_unload";
		if(var_128_bool != 0) {
			var_129_int = 0;
			func_196(var_7_object, var_8_object, var_9_object, var_10_object, (int)1);
			goto Label_139;
		}
		var_131_bool = var_6_string == "patrol1_unload";
		if(var_131_bool != 0) {
			var_132_int = 0;
			func_196(var_7_object, var_8_object, var_9_object, var_10_object, (int)2);
			goto Label_139;
		}
		var_134_bool = var_6_string == "patrol2_unload";
		if(var_134_bool == 0) goto Label_139;
		var_135_int = 0;
...
func_364(var_27_object)
{
	...
	GetDiaryRoot(var_29_object);
	var_30_bool = var_29_object == 0; //@nz
	if(var_30_bool != 0) {
...
func_338()
{
	...
	CreateDiaryEntry(var_66_object, (int)61, (int)2, (int)512143);
	var_70_bool = 0; var_71_object = Obj(); var_72_int = 0;
	var_66_object = var_71_object;
	func_377(var_70_bool, var_71_object, (int)11);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_377(var_18_bool, var_19_object, var_20_int)
{
	...
	@@var_24_object:Find(var_20_int, var_25_object);
	var_32_bool = var_25_object == 0; //@nz
	if(var_32_bool != 0) {
		var_34_int = "Can't find diary parent with id: " + var_20_int;
		Trace(var_34_int);
		var_18_bool = 0;
		return 6;
	}
	@@var_25_object:AddChild(var_19_object);
	SendWorldWndMessage((int)7);
	@@var_19_object:GetCategory(var_26_int);
	SetDiarySection(var_26_int);
	var_18_bool = 0;
	return 6;
}
EMIT "Stack[-2] = 0";
...
func_351()
{
	...
	CreateDiaryEntry(var_14_object, (int)62, (int)2, (int)512144);
	var_18_bool = 0; var_19_object = Obj(); var_20_int = 0;
	var_14_object = var_19_object;
	func_377(var_18_bool, var_19_object, (int)11);
	return 2;
}
EMIT "Stack[-1] = 0";
