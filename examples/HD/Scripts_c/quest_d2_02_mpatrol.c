...
void func_2051(bool var_16_bool, string var_17_string, string var_18_string)
{
	object var_20_object;
...
void func_2063(object var_125_object)
{
	bool var_127_bool;
...
void func_536(object var_0_object, object var_1_object, bool var_350_bool, float var_351_float)
{
	...
	if(var_357_bool != 0) {
		...
		func_875(var_359_string);
		bool var_476_bool;
		func_1613(var_476_bool, var_0_object);
		if(!var_476_bool) { //@nz
			@StopAsync();
			var_350_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_357_bool) { //@nz
				...
				func_875(var_359_string);
				bool var_502_bool;
				func_1613(var_502_bool, var_0_object);
				if(!var_502_bool) { //@nz
					@StopAsync();
					var_350_bool = false;
					return 8;
...
void func_1843(void)
{
	...
	if(var_146_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_1860;
		@UnlookAsync("head");
	}
Label_1860:
...
void func_1861(string var_125_string)
{
...
void func_1349(object var_0_object, object var_1_object)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			func_1967(var_30_float, var_1_object, var_32_cvector);
...
// @pe
void func_2120(object var_20_object)
{
	int var_21_int;
...
void func_2133(string var_74_string)
{
...
void func_1877(string var_103_string, bool var_104_bool)
{
...
void func_1892(object var_149_object)
{
	float var_152_float;
...
void func_1910(string var_112_string)
{
	...
	if(var_134_bool == 0) goto Label_1930;
}
...
void func_889(bool var_491_bool)
{
	var_491_bool = true;
}
...
void func_2197(object var_17_object)
{
	bool var_19_bool;
	...
	if(var_26_bool != 0) {
		...
		func_1989(var_30_bool, var_31_object, -0.15);
	}
	func_2150();
...
void func_1951(object var_84_object)
{
...
void func_673(bool var_492_bool, float var_493_float)
{
...
void func_1967(float var_30_float, cvector var_31_cvector, cvector var_32_cvector)
{
...
// @pe
void func_1971(float var_439_float, float var_440_float, float var_441_float)
{
...
// @pe
void func_1978(float var_59_float, float var_60_float, float var_61_float, float var_62_float)
{
...
void func_1477(bool var_41_bool, object var_42_object, string var_43_string, float var_44_float, float var_45_float, float var_46_float)
{
	...
	func_1978(var_59_float, (var_48_float + var_44_float), var_61_float, var_62_float);
...
// @pe
void func_1989(bool var_30_bool, object var_31_object, float var_32_float)
{
	if(!var_31_object) { //@nz
		var_30_bool = false;
		return 0;
...
void func_2265(int var_80_int)
{
	var_80_int = 515572;
}


void func_2267(int var_79_int)
{
	var_79_int = 504031;
}
...
void func_1499(float var_401_float, object var_402_object, float var_403_float, int var_404_int)
{
	...
	float var_439_float;
	func_1971(var_439_float, ((var_414_int + var_416_int) / 100.0), (float)1);
	float var_417_float;
	...
	float var_449_float;
	func_1978(var_449_float, (var_418_float - var_419_float), (float)0, (float)1);
...
void func_2269(string var_81_string)
{
	var_81_string = "ui/NPC_Citizen2.png";
}


void func_2271(string var_82_string)
{
	var_82_string = "ui/NPC_Citizen2_b.png";
}


void func_2273(bool var_74_bool)
{
	var_74_bool = false;
}
		...
		if(var_89_bool != 0) {
			...
			if(var_50_float >= (var_31_float * var_31_float)) {
				...
				if(var_249_bool != 0) {
					...
					bool var_513_bool;
					func_1613(var_513_bool, var_0_object);
					if(!var_513_bool) { //@nz
						goto Label_445;
					}
					var_0_object->GetPFPosition(var_44_cvector); //@t
...
void func_2024(float var_457_float)
{
...
void func_1774(bool var_31_bool, object var_32_object, float var_33_float)
{
	...
	func_1957(var_58_cvector, (var_47_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_74_bool != 0) {
		...
		if(var_51_bool == 0) goto Label_1837;
...
void func_2041(float var_37_float)
{
