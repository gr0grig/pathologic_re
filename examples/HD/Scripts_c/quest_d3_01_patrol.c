...
// @PE: 0x4a,0x84,0x9a,0x15b,0x15e,0x3ef,0x428,0x443,0x452,0x4c6,0x4d8,0x4e3,0x4ec,0x4f7,0x569,0x583,0x585,0x587,0x590,0x59a,0x60c,0x820,0x827,0x832,0x89b,0x8f0,0x8f8,0x90f
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_float, var_12_int, var_13_bool, var_14_object, var_15_bool, var_16_cvector, var_17_cvector, var_18_bool)
{
	if((int)1 != 0) {
		func_2012();
		var_22_bool = var_17_cvector == (int)9981;
		if(var_22_bool != 0) {
			var_23_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509102);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509103, (int)9989, (int)9982);
			@@@var_0_object:AddReply((int)509104, (int)9985, (int)9983);
			return 0;
		}
		var_48_bool = var_17_cvector == (int)9985;
		if(var_48_bool != 0) {
			var_49_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509106);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509107, (int)9984, (int)9986);
			return 0;
		}
		var_55_bool = var_17_cvector == (int)9984;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509105);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509108, (int)9988, (int)9987);
			return 0;
		}
		var_62_bool = var_17_cvector == (int)9988;
		if(var_62_bool != 0) {
			var_63_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509109);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509112, (int)9992, (int)9991);
			return 0;
		}
		var_69_bool = var_17_cvector == (int)9989;
		if(var_69_bool != 0) {
			var_70_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509110);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509111, (int)9992, (int)9990);
			return 0;
		}
		var_76_bool = var_17_cvector == (int)9992;
		if(var_76_bool != 0) {
			var_77_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509113);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509114, (int)9994, (int)9993);
			@@@var_0_object:AddReply((int)509116, (int)-1, (int)9995);
			return 0;
		}
		var_86_bool = var_17_cvector == (int)9994;
		if(var_86_bool != 0) {
			var_87_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509115);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509117, (int)-1, (int)9997);
			@@@var_0_object:AddReply((int)509118, (int)9999, (int)9998);
			return 0;
		}
		var_96_bool = var_17_cvector == (int)9999;
		if(var_96_bool != 0) {
			var_97_string = "";
			func_132(var_18_bool, "Neutral");
			@@@var_0_object:SetMessage((int)509119);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)509120, (int)-1, (int)10000);
			return 0;
		}
		var_3_string = true;
		var_102_bool = 0;
...
task_3_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_int, var_15_cvector, var_16_cvector, var_17_bool)
{
	...
	if(var_19_bool != 0) {
		...
		func_2160(var_20_object);
	} else {
		var_25_int = 0;
		var_17_bool = var_25_int;
		func_1222(var_16_cvector, var_17_bool, var_25_int);
	}
	return 0;
...
task_5_event_0(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_float, var_10_int, var_11_bool, var_12_object, var_13_bool, var_14_cvector, var_15_cvector, var_16_bool, var_17_object)
{
	...
	if(var_18_bool != 0) {
		...
		func_1424(var_17_object, var_19_object);
	}
	return 0;
}
...
func_0(var_0_object, var_20_int, var_21_object)
{
	...
	func_1883(var_31_bool, var_32_object, (float)70.0);
...
Label_821:
	...
	if(var_303_bool != 0) {
		...
		func_1722(var_347_bool, var_348_object);
...
func_1608(var_403_float, var_404_object, var_405_float, var_406_int)
{
	...
	func_2080(var_441_float, var_442_float, (float)1);
	...
	func_2087(var_451_float, var_452_float, (float)0, (float)1);
...
func_332()
{
	...
	func_353(var_24_bool, var_25_float, var_26_int, var_27_object, var_28_object, var_31_object, (bool)1, (float)180.0);
	return 2;
}
EMIT "Stack[-1] = 0";


func_1872(var_237_object)
{
...
func_1883(var_31_bool, var_32_object, var_33_float)
{
	...
	func_2066(var_58_cvector, var_59_cvector);
	...
	if(var_74_bool != 0) {
		...
		if(var_76_bool == 0) goto Label_1946;
...
func_863(var_0_object, var_306_bool)
{
	...
	func_1722(var_317_bool, var_318_object);
...
Label_1124:
	...
	if(var_196_bool != 0) {
		...
		if(var_198_bool != 0) {
			...
			if(var_199_bool == 0) goto Label_1173;
			var_178_bool = 0;
...
Label_393:
	...
	if(var_91_bool != 0) {
		...
		if(var_133_bool != 0) {
			...
			TaskCall(3);
			func_1015(var_142_bool, var_134_bool, var_135_object, var_136_float, (float)10000.0, (bool)1, (bool)0);
			TaskReturn();
			...
			if(var_217_bool != 0) {
				...
				if(var_224_bool != 0) {
					...
					if(var_225_bool != 0) {
						...
						TaskCall(3);
						func_1015(var_234_bool, var_226_bool, var_227_object, var_228_float, (float)10000.0, (bool)1, (bool)0);
						TaskReturn();
					...
					if(var_236_bool != 0) {
						...
						func_1722(var_248_bool, var_249_object);
					...
					if(var_251_bool != 0) {
						...
						func_1722(var_515_bool, var_516_object);
						...
						if(var_519_bool == 0) goto Label_555;
...
Label_911:
	...
	func_1562(var_334_cvector, var_335_object);
...
func_656(var_0_object, var_1_object, var_352_bool, var_353_float)
{
	...
	func_1722(var_386_bool, var_387_object);
	...
	if(var_474_bool != 0) {
		...
		func_1722(var_478_bool, var_479_object);
	...
	Label_733:
		...
		if(var_488_bool != 0) {
			...
			func_1722(var_504_bool, var_505_object);
	...
	if(var_493_bool != 0) {
		...
		func_793(var_494_bool, (float)0.75);
		StopAsync();
	}
	var_352_bool = 1;
	return 8;
...
func_1952()
{
	...
	if(var_146_bool != 0) {
		...
		if(var_148_bool == 0) goto Label_1969;
		UnlookAsync("head");
	}
Label_1969:
	return 2;
...
func_1222(var_0_object, var_1_object, var_25_int)
{
	...
	func_1260(var_28_bool, var_29_object);
...
func_2257(var_18_object)
{
	...
	if(var_47_bool != 0) {
		...
		func_2098(var_51_bool, var_52_object, (float)-0.20000000298023224);
	}
	var_89_object = Obj();
