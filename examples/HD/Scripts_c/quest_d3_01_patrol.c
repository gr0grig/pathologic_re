...
void func_2060(object var_86_object)
{
...
void func_2066(cvector var_49_cvector, cvector var_50_cvector)
{
...
void func_793(bool var_494_bool, float var_495_float)
{
	...
	@WaitForAnimEnd();
	func_995(var_499_bool);
}


void func_2076(float var_29_float, cvector var_30_cvector, cvector var_31_cvector)
{
...
// @pe
void func_2080(float var_441_float, float var_442_float, float var_443_float)
{
...
// @pe
void func_2087(float var_80_float, float var_81_float, float var_82_float, float var_83_float)
{
...
void func_1586(bool var_62_bool, object var_63_object, string var_64_string, float var_65_float, float var_66_float, float var_67_float)
{
	...
	func_2087(var_80_float, (var_69_float + var_65_float), var_82_float, var_83_float);
...
// @pe
void func_2098(bool var_51_bool, object var_52_object, float var_53_float)
{
	if(!var_52_object) { //@nz
		var_51_bool = false;
		return 0;
...
void func_1608(float var_403_float, object var_404_object, float var_405_float, int var_406_int)
{
	...
	float var_441_float;
	func_2080(var_441_float, ((var_416_int + var_418_int) / 100.0), (float)1);
	float var_419_float;
	...
	float var_451_float;
	func_2087(var_451_float, (var_420_float - var_421_float), (float)0, (float)1);
...
void func_2133(float var_459_float)
{
...
void func_1883(bool var_31_bool, object var_32_object, float var_33_float)
{
	...
	func_2066(var_58_cvector, (var_47_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_74_bool != 0) {
		...
		if(var_51_bool == 0) goto Label_1946;
		...
		if(var_91_bool != 0) {
			...
			if(var_52_float >= (var_33_float * var_33_float)) {
				...
				if(var_251_bool != 0) {
					...
					@StopAsync();
					bool var_513_bool;
					func_952(var_55_float, var_513_bool);
					var_514_bool = !var_513_bool; //@nz
					if(var_514_bool == 0) goto Label_555;
					bool var_515_bool;
					func_1722(var_515_bool, var_0_object);
					if(!var_515_bool) { //@nz
						goto Label_565;
					}
					var_0_object->GetPFPosition(var_46_cvector); //@t
					...
					func_656(var_54_bool, var_55_float, var_520_bool, var_521_float);
					var_522_bool = !var_520_bool; //@nz
					if(var_522_bool == 0) goto Label_555;
					goto Label_565;
			}
				bool var_523_bool; float var_524_float;
				var_33_float = var_524_float;
				func_656(var_54_bool, var_55_float, var_523_bool, var_524_float);
				if(!var_523_bool) { //@nz
					goto Label_565;
				}
				var_49_bool = true;
...
void func_2150(float var_58_float)
{
...
void func_2160(object var_127_object)
{
	bool var_129_bool;
...
// @pe
void func_132(object var_2_object, string var_99_string)
{
	bool var_100_bool;
...
void func_656(object var_0_object, object var_1_object, bool var_352_bool, float var_353_float)
{
	...
	if(var_359_bool != 0) {
		...
		func_995(var_361_string);
		bool var_478_bool;
		func_1722(var_478_bool, var_0_object);
		if(!var_478_bool) { //@nz
			@StopAsync();
			var_352_bool = false;
			return 8;
		...
		func_617(var_361_string, var_481_float, var_482_int);
		var_360_int = 1;
		...
		for(;;) {
			...
			if(!var_359_bool) { //@nz
				...
				func_995(var_361_string);
				bool var_504_bool;
				func_1722(var_504_bool, var_0_object);
				if(!var_504_bool) { //@nz
					@StopAsync();
					var_352_bool = false;
					return 8;
				...
				func_617(var_361_string, var_507_float, var_508_int);
				var_360_int += 1;
			}
	}
...
void func_1952(void)
{
	...
	bool var_146_bool;
	func_2333(var_146_bool);
	if(var_146_bool != 0) {
	} else {
		@HasAnimationTrack(var_144_bool, "head");
		if(var_144_bool == 0) goto Label_1969;
		@UnlookAsync("head");
	}
Label_1969:
...
void func_1970(string var_125_string)
{
	bool var_129_bool; float var_130_float; float var_131_float;
	...
	if(var_129_bool != 0) {
		...
		@Trace("Can't find lsh animation : " + var_125_string);
	}
...
void func_1458(object var_0_object, object var_1_object)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			func_2076(var_29_float, var_1_object, var_31_cvector);
...
void func_1986(string var_103_string, bool var_104_bool)
{
...
void func_2257(object var_18_object)
{
	...
	if(var_47_bool != 0) {
		...
		func_2098(var_51_bool, var_52_object, -0.2);
	}
...
void func_2001(object var_151_object)
{
	float var_154_float;
...
{
	func_2160(var_0_object);
}


void func_2019(string var_113_string)
{
	...
	if(var_135_bool == 0) goto Label_2039;
}


void func_1000(int var_468_int)
{
	var_468_int = 0;
}
...
void func_1009(bool var_493_bool)
{
	var_493_bool = true;
}
