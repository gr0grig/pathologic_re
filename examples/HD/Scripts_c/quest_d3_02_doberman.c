...
// @PE: 0x4a,0x89,0x9f,0xee,0x11f,0x13e,0x168,0x17f,0x2bb,0x2c2

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	if((int)1 != 0) {
		func_625();
		var_17_bool = var_13_bool == (int)37103;
		if(var_17_bool != 0) {
		...
		var_27_bool = var_12_bool == (int)37100;
		if(var_27_bool != 0) {
			var_28_string = "";
			func_137(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)535420);
			@@@var_0_object:ClearReplies();
			var_46_bool = 0; var_47_object = Obj();
			var_47_object = var_1_object;
			func_706(var_47_object);
			if(var_46_bool != 0) {
				@@@var_0_object:AddReply((int)535421, (int)37102, (int)37101);
			}
			@@@var_0_object:AddReply((int)535424, (int)-1, (int)37104);
			return 0;
		}
		var_61_bool = var_12_bool == (int)37102;
		if(var_61_bool != 0) {
			var_62_string = "";
			func_137(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)535422);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)535423, (int)-1, (int)37103);
			return 0;
		}
		var_3_string = true;
		var_67_bool = 0;
...
{
	func_383(var_11_bool, var_12_object);
...
task_2_event_6(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool)
{
	...
	if(var_12_int != 0) {
		func_383(var_10_bool, var_11_bool);
	}
	var_16_bool = 0;
	var_16_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	if(var_14_bool != 0) {
		var_15_bool = 0;
		func_345(var_10_bool, var_11_bool, var_12_int, var_15_bool);
		if(var_15_bool != 0) {
			...
			if(var_36_object == 0) goto Label_382;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
main(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool)
{
	...
	func_249(var_11_bool, (float)300, (float)100);
	return 0;
}
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_496(var_27_bool, var_28_object, (float)70.0);
...
func_267(var_5_int)
{
	...
	var_15_bool = 0;
	var_16_bool = 0;
	func_491(var_16_bool);
	var_19_bool = var_16_bool == 0; //@nz
	if(var_19_bool != 0) {
		var_20_bool = 0;
		func_316(var_20_bool);
		if(var_20_bool != 0) {
			var_15_bool = 1;
		}
	}
...
Label_411:
	...
	if(var_59_bool != 0) {
		...
		if(var_65_bool != 0) {
			...
			if(var_66_int == 0) goto Label_444;
			irand(var_40_int, var_37_int);
			var_68_string = ""; var_69_int = 0;
			var_40_int = var_69_int;
			func_665(var_68_string, var_69_int);
			...
			if(var_70_bool != 0) {
				...
				if(var_80_int == 0) goto Label_462;
				goto Label_473;
		}
		Label_462:
			var_71_bool = 0;
...
func_699()
{
	...
	func_653(var_20_bool, "quest_d3_02", "teleport");
	return 0;
}
...
func_318(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_21_float, var_22_float)
{
	var_23_bool = 0;
...
func_345(var_0_object, var_1_object, var_4_bool, var_15_bool)
{
	...
	func_483(var_19_float, var_20_object);
...
func_496(var_27_bool, var_28_object, var_29_float)
{
...
Label_251:
	...
	func_318(var_13_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
	var_6_int = false;
	goto Label_251;
}
EMIT "Return(); Pop(4)";
