...
// @pe
void func_163(bool var_29_bool, int var_30_int)
{
	var_29_bool = false;
	if(var_30_int >= 1) {
		if(var_30_int < 1000)
...
void func_139(object var_10_object)
{
...
void func_145(object var_8_object, object var_9_object, string var_10_string, string var_11_string, string var_12_string)
{
