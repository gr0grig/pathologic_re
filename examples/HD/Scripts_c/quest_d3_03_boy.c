	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, cvector var_10_cvector, bool var_11_bool)
	{
		if(1 != 0) {
			...
			if(var_11_bool == 12062) {
				...
				func_1471(var_0_object);
				object var_50_object = var_1_object;
				func_1490(var_0_object);
...
void func_1537(object var_36_object)
{
...
void func_1416(object var_53_object, string var_54_string, int var_55_int)
{
...
void func_1288(string var_116_string)
{
...
void func_1550(bool var_27_bool, object var_28_object, int var_29_int)
{
...
void func_655(bool var_221_bool)
{
	var_221_bool = true;
}


void func_528(float var_166_float)
{
	float var_168_float;
...
void func_1429(bool var_14_bool, string var_15_string, string var_16_string)
{
	object var_18_object;
...
void func_662(object var_0_object, cvector var_24_cvector, float var_25_float)
{
	...
	func_1367(var_40_cvector, (var_32_cvector - var_33_cvector));
	func_1367(var_38_cvector, (var_40_cvector + (var_34_cvector * 0.75)));
...
void func_1304(string var_94_string, bool var_95_bool)
{
...
void func_1441(string var_202_string, int var_203_int)
{
	string var_205_string = "idle";
	if(var_203_int != 0)
		var_205_string += var_203_int;
...
void func_1448(int var_196_int)
{
	int var_199_int; bool var_200_bool;
	var_199_int = 0;
...
void func_556(object var_170_object, cvector var_171_cvector)
{
...
void func_1196(bool var_192_bool)
{
	bool var_194_bool;
...
void func_1326(string var_36_string)
{
	...
	if(var_58_bool == 0) goto Label_1346;
}
...
void func_1201(bool var_22_bool, object var_23_object, float var_24_float)
{
	...
	func_1367(var_49_cvector, (var_38_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_65_bool != 0) {
		...
		if(var_42_bool == 0) goto Label_1264;
...
void func_1595(int var_71_int)
{
	var_71_int = 515560;
}


void func_1597(int var_70_int)
{
	var_70_int = 503345;
}


void func_1471(object var_16_object)
{
	@SetVariable("d3q03", 2);
	func_1511();
	float var_19_float;
...
void func_1599(string var_72_string)
{
	var_72_string = "ui/NPC_Citizen3.png";
}


void func_1601(string var_73_string)
{
...
void func_576(void)
{
	int var_187_int; int var_188_int; bool var_189_bool; float var_190_float; bool var_191_bool;
	@WaitForAnimEnd();
	bool var_192_bool;
	...
	for(;;) {
		...
		if(var_209_bool != 0) {
			@irand(var_187_int, 3);
			if(var_187_int == 0) {
				if(var_185_int == 0) goto Label_623;
				@irand(var_188_int, var_185_int);
				string var_218_string; int var_219_int;
			...
			if(var_187_int == 1) {
				@rand(var_190_float, 4);
				@Sleep((var_190_float + 1), var_191_bool);
				if(!var_191_bool) { //@nz
					goto Label_652;
				}
			} else if(var_186_int != 0) {
				goto Label_652;
			}
			}
					bool var_221_bool;
					func_655(var_221_bool);
					var_222_bool = !var_221_bool; //@nz
					if(var_222_bool == 0) goto Label_647;
			}
		}
	Label_652:
		for(;;) {
...
void func_1603(bool var_65_bool)
{
	var_65_bool = false;
}
...
void func_453(bool var_176_bool)
{
	var_176_bool = true;
}
...
// @pe
void func_1605(object var_11_object)
{
	object var_12_object;
...
// @pe
void func_1490(object var_50_object)
{
	@Trace("powder is given");
	object var_53_object;
	var_50_object = var_53_object;
	func_1416(var_53_object, "powder", 1);
}


void func_469(object var_0_object, object var_1_object)
{
	float var_157_float; cvector var_158_cvector; cvector var_159_cvector; bool var_160_bool; object var_161_object; bool var_162_bool;
	@rand(var_157_float, 0.5);
	@Sleep(var_157_float);
	...
	Label_497:
		object var_170_object; cvector var_171_cvector;
...
void func_1367(cvector var_42_cvector, cvector var_43_cvector)
{
...
// @pe
void func_1377(float var_73_float, cvector var_74_cvector, cvector var_75_cvector)
{
...
void func_1511(void)
{
	...
	func_1550(var_27_bool, var_28_object, 27);
}
EMIT "Stack[-1] = 0";


void func_1385(int var_69_int, int var_70_int)
{
...
// @pe
void func_1650(bool var_11_bool, object var_12_object)
{
	object var_14_object;
...
void func_1524(void)
{
	...
	func_1550(var_87_bool, var_88_object, 27);
}
EMIT "Stack[-1] = 0";


void func_1397(object var_58_object, object var_59_object, int var_60_int)
{
	int var_64_int;
...
void func_1270(void)
{
	...
	if(var_137_bool != 0) {
		...
		if(var_135_bool == 0) goto Label_1287;
		@UnlookAsync("head");
	}
Label_1287:
...
// @pe
void func_1657(object var_47_object)
{
