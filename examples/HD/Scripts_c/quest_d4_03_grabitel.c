maintask task_0
{
	...
	void OnTrigger(bool var_0_bool, string var_1_string, object var_2_object, int var_3_int, int var_4_int, bool var_5_bool, float var_6_float, int var_7_int, bool var_8_bool, object var_9_object, bool var_10_bool)
	{
		if(var_10_bool == "attack") {
			...
			func_81(var_517_string, var_517_string);
		}
...
void func_1794(int var_66_int, int var_67_int)
{
		...
		if(var_82_bool != 0) {
			...
			if(var_43_float >= (var_24_float * var_24_float)) {
				...
				if(var_242_bool != 0) {
					...
					bool var_506_bool;
					func_1418(var_506_bool, var_0_bool);
					if(!var_506_bool) { //@nz
						goto Label_365;
					}
					var_0_bool->GetPFPosition(var_37_cvector); //@t
...
void func_417(bool var_0_bool, float var_380_float, int var_381_int)
{
	...
	if(var_385_object == var_0_bool) {
		...
		@ReportHit(var_0_bool, var_459_int, var_387_float, var_396_float);
...
void func_809(bool var_484_bool)
{
	var_484_bool = true;
}
...
void func_1855(int var_78_int, string var_79_string)
{
	int var_81_int;
...
// @pe
void func_1860(object var_11_object)
{
	bool var_12_bool;
...
void func_1733(float var_29_float)
{
...
void func_456(bool var_0_bool, string var_1_string, bool var_343_bool, float var_344_float)
{
	...
	if(var_350_bool != 0) {
		...
		func_795(var_352_string);
		bool var_469_bool;
		func_1418(var_469_bool, var_0_bool);
		if(!var_469_bool) { //@nz
			@StopAsync();
			var_343_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_350_bool) { //@nz
				...
				func_795(var_352_string);
				bool var_495_bool;
				func_1418(var_495_bool, var_0_bool);
				if(!var_495_bool) { //@nz
					@StopAsync();
					var_343_bool = false;
					return 8;
...
void func_1743(bool var_12_bool, string var_13_string, string var_14_string)
{
	object var_16_object;
...
void func_81(bool var_0_bool, string var_517_string)
{
	bool var_519_bool;
	if(var_517_string == "cleanup") {
		var_0_bool = true;
	...
	} else if(var_517_string == "restore") {
		var_0_bool = false;
	}
...
void func_593(bool var_485_bool, float var_486_float)
{
...
void func_1755(object var_13_object)
{
	bool var_15_bool;
...
// @pe
void func_1781(object var_14_object)
{
	int var_15_int;
