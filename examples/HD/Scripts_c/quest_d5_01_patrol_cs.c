...
// @STANDALONE_EVENT_22: op=0x65b vars=object,int,float,float
// @STANDALONE_EVENT_43: op=0x663 vars=object,int,float,float,cvector,cvector
// @STANDALONE_EVENT_16: op=0x66d vars=object,string
// @STANDALONE_EVENT_41: op=0x67a vars=object
// @PE: 0x19,0x1c,0x2ad,0x2e6,0x301,0x310,0x384,0x396,0x3a1,0x3aa,0x3b5,0x437,0x451,0x453,0x455,0x457,0x5d4,0x5db,0x61d,0x653,0x65b,0x663,0x67a
...
task_2_event_7(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_float, var_5_int, var_6_bool, var_7_object, var_8_bool, var_9_int)
{
	...
	if(var_11_bool != 0) {
		...
		func_1539(var_12_object);
	} else {
		var_17_int = 0;
		var_9_int = var_17_int;
		func_900(var_8_bool, var_9_int, var_17_int);
	}
	return 0;
...
func_900(var_0_object, var_1_int, var_17_int)
{
	...
	func_938(var_20_bool, var_21_object);
...
func_10()
{
	...
	func_31(var_12_bool, var_13_float, var_14_int, var_15_object, var_16_object, var_19_object, (bool)1, (float)180.0);
	return 2;
}
EMIT "Stack[-1] = 0";
...
{
	var_388_float = 0.30000001192092896;
	return 0;
}
...
func_541(var_0_object, var_294_bool)
{
	...
	func_1263(var_305_bool, var_306_object);
...
Label_802:
	...
	if(var_184_bool != 0) {
		...
		if(var_186_bool != 0) {
			...
			if(var_187_bool == 0) goto Label_851;
			var_166_bool = 0;
...
Label_71:
	...
	if(var_79_bool != 0) {
		...
		if(var_121_bool != 0) {
			...
			TaskCall(2);
			func_693(var_130_bool, var_122_bool, var_123_object, var_124_float, (float)10000.0, (bool)1, (bool)0);
			TaskReturn();
			...
			if(var_205_bool != 0) {
				...
				if(var_212_bool != 0) {
					...
					if(var_213_bool != 0) {
						...
						TaskCall(2);
						func_693(var_222_bool, var_214_bool, var_215_object, var_216_float, (float)10000.0, (bool)1, (bool)0);
						TaskReturn();
					...
					if(var_224_bool != 0) {
						...
						func_1263(var_236_bool, var_237_object);
					...
					if(var_239_bool != 0) {
						...
						func_1263(var_503_bool, var_504_object);
						...
						if(var_507_bool == 0) goto Label_233;
...
Label_589:
	...
	func_1125(var_322_cvector, var_323_object);
...
func_334(var_0_object, var_1_int, var_340_bool, var_341_float)
{
	...
	func_1263(var_374_bool, var_375_object);
	...
	if(var_462_bool != 0) {
		...
		func_1263(var_466_bool, var_467_object);
	...
	Label_411:
		...
		if(var_476_bool != 0) {
			...
			func_1263(var_492_bool, var_493_object);
	...
	if(var_481_bool != 0) {
		...
		func_471(var_482_bool, (float)0.75);
		StopAsync();
	}
	var_340_bool = 1;
	return 8;
...
Label_499:
	...
	if(var_291_bool != 0) {
		...
		func_1263(var_335_bool, var_336_object);
...
func_1149(var_391_float, var_392_object, var_393_float, var_394_int)
{
	...
	func_1492(var_429_float, var_430_float, (float)1);
	...
	func_1499(var_439_float, var_440_float, (float)0, (float)1);
