...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_580();
		var_15_bool = var_10_bool == (int)11683;
		if(var_15_bool != 0) {
			var_16_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)510591);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)510592, (int)11685, (int)11684);
			@@@var_0_object:AddReply((int)510599, (int)11685, (int)11692);
			@@@var_0_object:AddReply((int)510600, (int)-1, (int)11694);
			return 0;
		}
		var_44_bool = var_10_bool == (int)11685;
		if(var_44_bool != 0) {
			var_45_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)510593);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)510594, (int)11687, (int)11686);
			@@@var_0_object:AddReply((int)510598, (int)11687, (int)11690);
			return 0;
		}
		var_54_bool = var_10_bool == (int)11687;
		if(var_54_bool != 0) {
			var_55_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)510595);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)510596, (int)-1, (int)11688);
			@@@var_0_object:AddReply((int)510597, (int)-1, (int)11689);
			return 0;
		}
		var_3_string = true;
		var_63_bool = 0;
