...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			func_598();
			if(var_10_bool == 38121) {
				func_132(var_11_object, "Neutral");
				var_0_object->SetMessage(536339); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(536340, 38123, 38122); //@t
				var_0_object->AddReply(536351, -1, 38133); //@t
				return 0;
			}
			if(var_10_bool == 38123) {
				func_132(var_11_object, "Neutral");
				var_0_object->SetMessage(536341); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(536342, 38125, 38124); //@t
				var_0_object->AddReply(536350, -1, 38132); //@t
				return 0;
			}
			if(var_10_bool == 38125) {
				func_132(var_11_object, "Neutral");
				var_0_object->SetMessage(536343); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(536344, -1, 38126); //@t
				var_0_object->AddReply(536345, -1, 38127); //@t
				var_0_object->AddReply(536346, 38129, 38128); //@t
				return 0;
			}
			if(var_10_bool == 38129) {
				func_132(var_11_object, "Neutral");
				var_0_object->SetMessage(536347); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(536348, -1, 38130); //@t
				var_0_object->AddReply(536349, -1, 38131); //@t
				return 0;
			}
			var_3_string = true;
			bool var_73_bool;
...
void func_0(object var_0_object, int var_14_int, object var_15_object)
{
	...
	func_469(var_25_bool, var_26_object, 70.0);
	if(!var_25_bool) { //@nz
		var_14_int = -2;
		return 8;
	}
...
void func_449(bool var_61_bool)
{
	var_61_bool = true;
}
...
void func_456(float var_17_float, object var_18_object)
{
...
void func_587(object var_27_object)
{
	float var_30_float;
...
void func_656(int var_74_int)
{
	var_74_int = 515556;
}


void func_464(bool var_13_bool)
{
	bool var_15_bool;
...
void func_658(int var_73_int)
{
	var_73_int = 503341;
}


void func_660(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen3.png";
}


void func_469(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_605(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_68_bool != 0) {
		...
		if(var_45_bool == 0) goto Label_532;
...
void func_662(string var_76_string)
{
...
void func_664(bool var_68_bool)
{
	var_68_bool = false;
}
...
void func_538(void)
{
	...
	if(var_140_bool != 0) {
		...
		if(var_138_bool == 0) goto Label_555;
		@UnlookAsync("head");
	}
Label_555:
...
void func_605(cvector var_52_cvector, cvector var_53_cvector)
{
...
// @pe
void func_291(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_11_float, float var_12_float)
{
	bool var_13_bool;
...
// @pe
void func_356(object var_2_object, string var_3_string)
{
	func_451();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_615(string var_42_string, int var_43_int)
{
...
void func_556(string var_119_string)
{
...
void func_370(void)
{
	...
	for(;;) {
		...
		if(var_49_bool != 0) {
			@irand(var_29_int, 3);
			if(var_29_int == 0) {
				if(var_27_int == 0) goto Label_417;
			...
			if(var_29_int == 1) {
				...
				goto Label_446;
					...
					if(var_62_bool == 0) goto Label_441;
			}
		}
	Label_446:
		for(;;) {
...
void func_572(string var_97_string, bool var_98_bool)
{
...
void func_318(object var_0_object, object var_1_object, bool var_4_bool, bool var_13_bool)
{
	if(var_4_bool == null)
		var_13_bool = false;
	float var_17_float;
	func_456(var_17_float, var_4_bool);
