	...
	if(var_8_bool != 0) {
		...
		if(var_39_bool != 0) {
			...
			if(var_42_bool != 0) {
				...
				func_185(var_44_object, var_45_object, "pt_gorbun", "pers_gorbun", "d5q02_gorbun.xml");
