...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_631();
		var_15_bool = var_11_object == (int)4316;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_10_bool == (int)4315;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503963);
			@@@var_0_object:ClearReplies();
			var_40_bool = 0; var_41_object = Obj();
			var_41_object = var_1_object;
			func_693(var_41_object);
			if(var_40_bool != 0) {
				@@@var_0_object:AddReply((int)503964, (int)4318, (int)4316);
			}
			@@@var_0_object:AddReply((int)503965, (int)-1, (int)4317);
			return 0;
		}
		var_55_bool = var_10_bool == (int)4318;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503966);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503967, (int)4322, (int)4319);
			@@@var_0_object:AddReply((int)503968, (int)4321, (int)4320);
			return 0;
		}
		var_65_bool = var_10_bool == (int)4321;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503969);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503971, (int)-1, (int)4323);
			return 0;
		}
		var_72_bool = var_10_bool == (int)4322;
		if(var_72_bool != 0) {
			var_73_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503970);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503972, (int)4326, (int)4324);
			@@@var_0_object:AddReply((int)503976, (int)-1, (int)4329);
			return 0;
		}
		var_82_bool = var_10_bool == (int)4326;
		if(var_82_bool != 0) {
			var_83_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503973);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503974, (int)-1, (int)4327);
			@@@var_0_object:AddReply((int)503975, (int)-1, (int)4328);
			return 0;
		}
		var_3_string = true;
		var_91_bool = 0;
