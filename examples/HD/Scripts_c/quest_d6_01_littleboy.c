...
void func_584(int var_113_int, string var_114_string)
{
	int var_116_int;
...
void func_525(string var_127_string)
{
...
void func_589(string var_43_string, int var_44_int)
{
	...
	for(;;) {
		...
		if(var_50_bool != 0) {
			...
			if(var_30_int == 0) {
				...
				func_589(var_59_string, var_60_int);
...
void func_541(string var_97_string, bool var_98_bool)
{
...
void func_613(int var_74_int)
{
	var_74_int = 515560;
}


void func_615(int var_73_int)
{
	var_73_int = 503345;
}
...
void func_617(string var_75_string)
{
	var_75_string = "ui/NPC_Citizen3.png";
}


void func_619(string var_76_string)
{
	var_76_string = "ui/NPC_Citizen3_b.png";
}


void func_556(object var_27_object)
{
	float var_30_float;
...
void func_621(bool var_68_bool)
{
	var_68_bool = false;
}
...
// @pe
void func_629(bool var_111_bool)
{
	int var_113_int;
	func_584(var_113_int, "ood6Littleboy1");
	if(var_113_int == 0) {
		var_111_bool = true;
		return 0;
	}
...
void func_438(bool var_25_bool, object var_26_object, float var_27_float)
{
	...
	func_574(var_52_cvector, (var_41_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_68_bool != 0) {
		...
		if(var_45_bool == 0) goto Label_501;
...
void func_507(void)
{
	...
	bool var_148_bool;
	func_621(var_148_bool);
	if(var_148_bool != 0) {
	} else {
		@HasAnimationTrack(var_146_bool, "head");
		if(var_146_bool == 0) goto Label_524;
		@UnlookAsync("head");
	}
Label_524:
...
void func_574(cvector var_52_cvector, cvector var_53_cvector)
{
