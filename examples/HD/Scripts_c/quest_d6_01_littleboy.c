...
// @PE: 0x4a,0x89,0x9f,0xf9,0x104,0x12e,0x145,0x26f,0x275

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_567();
		var_15_bool = var_11_object == (int)4367;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_10_bool == (int)4366;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504011);
			@@@var_0_object:ClearReplies();
			var_40_bool = 0; var_41_object = Obj();
			var_41_object = var_1_object;
			func_629(var_41_object);
			if(var_40_bool != 0) {
				@@@var_0_object:AddReply((int)504012, (int)4369, (int)4367);
			}
			@@@var_0_object:AddReply((int)504013, (int)-1, (int)4368);
			return 0;
		}
		var_55_bool = var_10_bool == (int)4369;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504014);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)504015, (int)-1, (int)4370);
			@@@var_0_object:AddReply((int)504016, (int)-1, (int)4371);
			return 0;
		}
		var_3_string = true;
		var_64_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_324;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_438(var_25_bool, var_26_object, (float)70.0);
...
func_260(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_12_float, var_13_float)
{
	var_14_bool = 0;
...
Label_353:
	...
	if(var_50_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_57_int == 0) goto Label_386;
			...
			if(var_61_bool != 0) {
				...
				if(var_71_int == 0) goto Label_404;
				goto Label_415;
		}
		Label_404:
			var_62_bool = 0;
...
func_287(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_425(var_17_float, var_18_object);
...
func_623()
{
	SetVariable("ood6Littleboy1", (int)1);
	return 0;
}
...
func_438(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_501;
...
func_507()
{
	...
	if(var_148_bool != 0) {
		...
		if(var_150_bool == 0) goto Label_524;
		UnlookAsync("head");
	}
Label_524:
	return 2;
