...
// @PE: 0x4a,0x93,0xa9,0x139,0x144,0x16e,0x185,0x2af,0x2b5,0x2bb,0x2c7

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_631();
		var_15_bool = var_11_object == (int)4332;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_11_object == (int)4333;
		if(var_21_bool != 0) {
		...
		var_27_bool = var_10_bool == (int)4331;
		if(var_27_bool != 0) {
			var_28_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503978);
			@@@var_0_object:ClearReplies();
			var_46_bool = 0; var_47_object = Obj();
			var_47_object = var_1_object;
			func_699(var_47_object);
			if(var_46_bool != 0) {
				@@@var_0_object:AddReply((int)503979, (int)4336, (int)4332);
			}
			var_57_bool = 0; var_58_object = Obj();
			var_58_object = var_1_object;
			func_711(var_58_object);
			if(var_57_bool != 0) {
				@@@var_0_object:AddReply((int)503980, (int)4334, (int)4333);
			}
			@@@var_0_object:AddReply((int)536325, (int)-1, (int)38106);
			return 0;
		}
		var_70_bool = var_10_bool == (int)4334;
		if(var_70_bool != 0) {
			var_71_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503981);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503982, (int)-1, (int)4335);
			return 0;
		}
		var_77_bool = var_10_bool == (int)4336;
		if(var_77_bool != 0) {
			var_78_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503983);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503984, (int)4338, (int)4337);
			@@@var_0_object:AddReply((int)503986, (int)-1, (int)4339);
			return 0;
		}
		var_87_bool = var_10_bool == (int)4338;
		if(var_87_bool != 0) {
			var_88_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503985);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503987, (int)-1, (int)4340);
			return 0;
		}
		var_3_string = true;
		var_93_bool = 0;
		func_685(var_93_bool);
		if(var_93_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
func_711(var_122_bool)
{
	...
	func_648(var_124_int, "ood6Littlegirl2");
...
func_687()
{
	SetVariable("ood6Littlegirl1", (int)1);
	return 0;
}
...
func_693()
{
	SetVariable("ood6Littlegirl2", (int)1);
	return 0;
}
...
func_699(var_111_bool)
{
	...
	func_648(var_113_int, "ood6Littlegirl1");
