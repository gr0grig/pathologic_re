	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object)
	{
		if(1 != 0) {
			...
			if(var_10_bool == 4331) {
				...
				bool var_46_bool;
				func_699(var_1_object);
				if(var_46_bool != 0)
					var_0_object->AddReply(503979, 4336, 4332); //@t
				bool var_57_bool;
				func_711(var_1_object);
				if(var_57_bool != 0)
...
// @pe
void func_711(bool var_122_bool)
{
	int var_124_int;
...
void func_589(string var_136_string)
{
...
void func_571(void)
{
	...
	if(var_157_bool != 0) {
		...
		if(var_155_bool == 0) goto Label_588;
		@UnlookAsync("head");
	}
Label_588:
...
// @pe
void func_699(bool var_111_bool)
{
	int var_113_int;
