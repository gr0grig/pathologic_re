...
// @PE: 0x4a,0x93,0xa9,0x131,0x13c,0x166,0x17d,0x2a7,0x2ad,0x2b3,0x2bf

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_623();
		var_15_bool = var_11_object == (int)4374;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_11_object == (int)4376;
		if(var_21_bool != 0) {
		...
		var_27_bool = var_10_bool == (int)4373;
		if(var_27_bool != 0) {
			var_28_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504018);
			@@@var_0_object:ClearReplies();
			var_46_bool = 0; var_47_object = Obj();
			var_47_object = var_1_object;
			func_691(var_47_object);
			if(var_46_bool != 0) {
				@@@var_0_object:AddReply((int)504019, (int)4375, (int)4374);
			}
			var_57_bool = 0; var_58_object = Obj();
			var_58_object = var_1_object;
			func_703(var_58_object);
			if(var_57_bool != 0) {
				@@@var_0_object:AddReply((int)504021, (int)4377, (int)4376);
			}
			@@@var_0_object:AddReply((int)536329, (int)-1, (int)38110);
			return 0;
		}
		var_70_bool = var_10_bool == (int)4377;
		if(var_70_bool != 0) {
			var_71_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504022);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)504023, (int)-1, (int)4378);
			@@@var_0_object:AddReply((int)504024, (int)-1, (int)4379);
			@@@var_0_object:AddReply((int)504025, (int)-1, (int)4380);
			return 0;
		}
		var_83_bool = var_10_bool == (int)4375;
		if(var_83_bool != 0) {
			var_84_string = "";
			func_147(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504020);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)504026, (int)-1, (int)4381);
			@@@var_0_object:AddReply((int)504027, (int)-1, (int)4382);
			return 0;
		}
		var_3_string = true;
		var_92_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_380;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_494(var_25_bool, var_26_object, (float)70.0);
...
Label_409:
	...
	if(var_50_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_57_int == 0) goto Label_442;
			...
			if(var_61_bool != 0) {
				...
				if(var_71_int == 0) goto Label_460;
				goto Label_471;
		}
		Label_460:
			var_62_bool = 0;
...
func_343(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_481(var_17_float, var_18_object);
...
func_685()
{
	SetVariable("ood6Unosha2", (int)1);
	return 0;
}


func_494(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_557;
...
func_563()
{
	...
	if(var_157_bool != 0) {
		...
		if(var_159_bool == 0) goto Label_580;
		UnlookAsync("head");
	}
Label_580:
	return 2;
...
func_316(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_12_float, var_13_float)
{
	var_14_bool = 0;
	func_489(var_14_bool);
