...
// @PE: 0x4a,0x89,0x9f,0x143,0x14e,0x178,0x18f,0x2b9,0x2bf

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_641();
		var_15_bool = var_11_object == (int)4190;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_10_bool == (int)4189;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503852);
			@@@var_0_object:ClearReplies();
			var_40_bool = 0; var_41_object = Obj();
			var_41_object = var_1_object;
			func_703(var_41_object);
			if(var_40_bool != 0) {
				@@@var_0_object:AddReply((int)503853, (int)4193, (int)4190);
			}
			@@@var_0_object:AddReply((int)503855, (int)-1, (int)4192);
			return 0;
		}
		var_55_bool = var_10_bool == (int)4193;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503856);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503857, (int)4196, (int)4195);
			@@@var_0_object:AddReply((int)503864, (int)4196, (int)4204);
			return 0;
		}
		var_65_bool = var_10_bool == (int)4196;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503858);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503859, (int)4200, (int)4197);
			@@@var_0_object:AddReply((int)503860, (int)4200, (int)4198);
			@@@var_0_object:AddReply((int)503861, (int)4200, (int)4199);
			return 0;
		}
		var_78_bool = var_10_bool == (int)4200;
		if(var_78_bool != 0) {
			var_79_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503862);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503863, (int)4207, (int)4203);
			@@@var_0_object:AddReply((int)503865, (int)-1, (int)4206);
			return 0;
		}
		var_88_bool = var_10_bool == (int)4207;
		if(var_88_bool != 0) {
			var_89_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503866);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503867, (int)-1, (int)4208);
			@@@var_0_object:AddReply((int)503868, (int)-1, (int)4209);
			return 0;
		}
		var_3_string = true;
		var_97_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_398;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_512(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_575;
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_512(var_25_bool, var_26_object, (float)70.0);
...
func_581()
{
	...
	if(var_148_bool != 0) {
		...
		if(var_150_bool == 0) goto Label_598;
		UnlookAsync("head");
	}
Label_598:
	return 2;
...
func_334(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_12_float, var_13_float)
{
	var_14_bool = 0;
...
Label_427:
	...
	if(var_50_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_57_int == 0) goto Label_460;
			...
			if(var_61_bool != 0) {
				...
				if(var_71_int == 0) goto Label_478;
				goto Label_489;
		}
		Label_478:
			var_62_bool = 0;
...
func_361(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_499(var_17_float, var_18_object);
...
func_697()
{
	SetVariable("ood6WastedWoman1", (int)1);
	return 0;
}
