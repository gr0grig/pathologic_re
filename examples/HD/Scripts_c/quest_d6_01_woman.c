...
// @PE: 0x4a,0x89,0x9f,0x110,0x11b,0x145,0x15c,0x286,0x28c

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_590();
		var_15_bool = var_11_object == (int)4357;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_10_bool == (int)4356;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504001);
			@@@var_0_object:ClearReplies();
			var_40_bool = 0; var_41_object = Obj();
			var_41_object = var_1_object;
			func_652(var_41_object);
			if(var_40_bool != 0) {
				@@@var_0_object:AddReply((int)504002, (int)4359, (int)4357);
			}
			@@@var_0_object:AddReply((int)504003, (int)-1, (int)4358);
			return 0;
		}
		var_55_bool = var_10_bool == (int)4359;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504004);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)504005, (int)4362, (int)4360);
			@@@var_0_object:AddReply((int)504006, (int)-1, (int)4361);
			return 0;
		}
		var_65_bool = var_10_bool == (int)4362;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)504007);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)504008, (int)-1, (int)4363);
			@@@var_0_object:AddReply((int)504009, (int)-1, (int)4364);
			return 0;
		}
		var_3_string = true;
		var_74_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_347;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_461(var_25_bool, var_26_object, (float)70.0);
...
func_448(var_17_float, var_18_object)
{
...
func_461(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_524;
...
func_530()
{
	...
	if(var_148_bool != 0) {
		...
		if(var_150_bool == 0) goto Label_547;
		UnlookAsync("head");
	}
Label_547:
	return 2;
...
func_283(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_12_float, var_13_float)
{
	var_14_bool = 0;
	func_456(var_14_bool);
...
Label_376:
	...
	if(var_50_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_57_int == 0) goto Label_409;
			...
			if(var_61_bool != 0) {
				...
				if(var_71_int == 0) goto Label_427;
				goto Label_438;
		}
		Label_427:
			var_62_bool = 0;
