...
// @PE: 0x4a,0x89,0x9f,0x127,0x132,0x15c,0x173,0x29d,0x2a3

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_613();
		var_15_bool = var_11_object == (int)4302;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_10_bool == (int)4301;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503950);
			@@@var_0_object:ClearReplies();
			var_40_bool = 0; var_41_object = Obj();
			var_41_object = var_1_object;
			func_675(var_41_object);
			if(var_40_bool != 0) {
				@@@var_0_object:AddReply((int)503951, (int)4304, (int)4302);
			}
			@@@var_0_object:AddReply((int)503952, (int)-1, (int)4303);
			return 0;
		}
		var_55_bool = var_10_bool == (int)4304;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503953);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503954, (int)4306, (int)4305);
			@@@var_0_object:AddReply((int)503957, (int)4309, (int)4308);
			return 0;
		}
		var_65_bool = var_10_bool == (int)4309;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503958);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503959, (int)-1, (int)4310);
			@@@var_0_object:AddReply((int)503960, (int)4306, (int)4311);
			return 0;
		}
		var_75_bool = var_10_bool == (int)4306;
		if(var_75_bool != 0) {
			var_76_string = "";
			func_137(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)503955);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)503956, (int)-1, (int)4307);
			@@@var_0_object:AddReply((int)503961, (int)-1, (int)4313);
			return 0;
		}
		var_3_string = true;
		var_84_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_370;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_484(var_25_bool, var_26_object, (float)70.0);
...
Label_399:
	...
	if(var_50_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_57_int == 0) goto Label_432;
			...
			if(var_61_bool != 0) {
				...
				if(var_71_int == 0) goto Label_450;
				goto Label_461;
		}
		Label_450:
			var_62_bool = 0;
...
func_333(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_471(var_17_float, var_18_object);
...
func_484(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_547;
...
func_553()
{
	...
	if(var_148_bool != 0) {
		...
		if(var_150_bool == 0) goto Label_570;
		UnlookAsync("head");
	}
Label_570:
	return 2;
...
func_306(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_12_float, var_13_float)
{
	var_14_bool = 0;
	func_479(var_14_bool);
