// @IMPORTS: SetVariable/2,Trace/1,GetMainOutdoorScene/1,AddActor/6,RemoveActor/1,GetVariable/2,GetGameTime/1,SetTimeEvent/2,Hold/0,self/1,CreateDiaryEntry/4,GetDiaryRoot/1,SendWorldWndMessage/1,SetDiarySection/1
// @STRINGS: W:d6q02|W:completed|W:fail|W:place_trigger|W:d6q02_trigger_bombers|W:d6q02_trigger.xml|W:d6q02Trigger|W:pt_d6q02_bomber1|W:pers_bomber|W:d6q02_bomber.xml|W:pt_d6q02_bomber2|W:pt_d6q02_bomber3|W:pt_d6q02_bomber4|W:pt_d6q02_gorbun|W:pers_gorbun|W:d6q02_gorbun.xml|W:gorbun_death|W:d6q02GorbunDeath|A:GetLocator|W:Locator |W: doesn't exist|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
func_198()
{
	...
	CreateDiaryEntry(var_77_object, (int)103, (int)2, (int)513726);
	var_81_bool = 0; var_82_object = Obj(); var_83_int = 0;
	var_77_object = var_82_object;
	func_224(var_81_bool, var_82_object, (int)102);
	return 2;
}
EMIT "Stack[-1] = 0";
