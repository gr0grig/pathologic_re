...
// @pe
void func_1563(float var_53_float, float var_54_float, float var_55_float, float var_56_float)
{
...
void func_1574(bool var_95_bool, int var_96_int, int var_97_int)
{
	int var_99_int;
...
// @pe
void func_1579(bool var_24_bool, object var_25_object, float var_26_float)
{
	if(!var_25_object) { //@nz
		var_24_bool = false;
		return 0;
...
void func_1614(float var_31_float)
{
...
void func_1624(bool var_14_bool, string var_15_string, string var_16_string)
{
...
void func_1636(object var_128_object)
{
	bool var_130_bool;
...
void func_1645(string var_64_string, int var_65_int)
{
...
void func_1669(int var_122_int)
{
	int var_124_int;
...
// @pe
void func_1675(object var_15_object)
{
	int var_16_int;
...
void func_1688(int var_71_int, int var_72_int)
{
...
void func_1719(string var_128_string)
{
...
void func_1215(bool var_20_bool, object var_21_object)
{
	bool var_23_bool;
...
void func_1220(bool var_43_bool, object var_44_object, string var_45_string)
{
...
void func_1232(bool var_35_bool, object var_36_object, string var_37_string, float var_38_float, float var_39_float, float var_40_float)
{
	...
	func_1563(var_53_float, (var_42_float + var_38_float), var_55_float, var_56_float);
...
void func_1797(int var_83_int, string var_84_string)
{
	int var_86_int;
...
void func_1802(bool var_19_bool, object var_20_object)
{
...
void func_1820(float var_204_float, cvector var_205_cvector, cvector var_206_cvector, cvector var_207_cvector)
{
...
// @pe
void func_1864(int var_133_int, float var_134_float)
{
...
// @pe
void func_1878(float var_253_float, int var_254_int)
{
	if(var_254_int == 1)
		var_253_float = 30;
	var_253_float = 700;
...
// @pe
void func_1886(float var_259_float, float var_261_float)
{
	if(var_261_float < 10) {
		var_259_float = 10;
		return 0;
...
// @pe
void func_1907(object var_70_object)
{
...
// @pe
void func_1915(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
...
// @pe
void func_1922(object var_70_object)
{
	TaskCall(4);
	object var_71_object;
...
// @pe
void func_1932(object var_51_object)
{
...
// @pe
void func_1964(object var_12_object)
{
	object var_13_object;
	...
	if(var_20_bool != 0) {
		...
		func_1579(var_24_bool, var_25_object, 0.05);
	}
...
void func_1480(string var_90_string, int var_91_int, int var_92_int)
{
	bool var_94_bool;
	int var_96_int;
...
void func_1491(string var_101_string, int var_102_int, int var_103_int, int var_104_int)
{
...
void func_2005(bool var_14_bool, object var_15_object, object var_16_object)
{
	bool var_18_bool;
...
void func_1506(string var_166_string)
{
	...
	if(var_188_bool == 0) goto Label_1526;
}
...
void func_2031(bool var_14_bool, object var_15_object)
{
