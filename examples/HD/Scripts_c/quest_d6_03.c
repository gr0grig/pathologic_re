// @IMPORTS: SetVariable/2,Trace/1,GetMainOutdoorScene/1,GetVariable/2,RemoveActor/1,GetGameTime/1,SetTimeEvent/2,Hold/0,self/1,CreateDiaryEntry/4,GetDiaryRoot/1,SendWorldWndMessage/1,SetDiarySection/1
...
func_164()
{
	...
	CreateDiaryEntry(var_53_object, (int)108, (int)2, (int)513731);
	var_57_bool = 0; var_58_object = Obj(); var_59_int = 0;
	var_53_object = var_58_object;
	func_190(var_57_bool, var_58_object, (int)107);
	return 2;
}
EMIT "Stack[-1] = 0";
