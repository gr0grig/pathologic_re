...
// @PE: 0x51,0xa9,0xbf,0x159,0x2c7,0x2cd

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_674();
		var_11_bool = var_6_int == (int)34774;
		if(var_11_bool != 0) {
			var_12_bool = 0; var_13_object = Obj();
			var_13_object = var_1_object;
			func_717(var_13_object);
			if(var_12_bool != 0) {
				...
				@@@var_0_object:SetMessage((int)533260);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)533261, (int)34776, (int)34775);
				@@@var_0_object:AddReply((int)535781, (int)34776, (int)37465);
				return 0;
			}
			var_48_string = "";
			func_169(var_7_bool, "Angry");
			@@@var_0_object:SetMessage((int)533258);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533259, (int)-1, (int)34773);
			@@@var_0_object:AddReply((int)535778, (int)-1, (int)37462);
			return 0;
		}
		var_57_bool = var_6_int == (int)34776;
		if(var_57_bool != 0) {
			var_58_string = "";
			func_169(var_7_bool, "Angry");
			@@@var_0_object:SetMessage((int)533262);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)533263, (int)37460, (int)34777);
			@@@var_0_object:AddReply((int)535782, (int)37467, (int)37466);
			return 0;
		}
		var_67_bool = var_6_int == (int)37467;
		if(var_67_bool != 0) {
			var_68_string = "";
			func_169(var_7_bool, "Angry");
			@@@var_0_object:SetMessage((int)535783);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)535784, (int)37463, (int)37468);
			return 0;
		}
		var_74_bool = var_6_int == (int)37460;
		if(var_74_bool != 0) {
			var_75_string = "";
			func_169(var_7_bool, "Angry");
			@@@var_0_object:SetMessage((int)535776);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)535777, (int)37463, (int)37461);
			return 0;
		}
		var_81_bool = var_6_int == (int)37463;
		if(var_81_bool != 0) {
			var_82_string = "";
			func_169(var_7_bool, "Staring");
			@@@var_0_object:SetMessage((int)535779);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)535780, (int)-1, (int)37464);
			@@@var_0_object:AddReply((int)535785, (int)-1, (int)37469);
			return 0;
		}
		var_3_string = true;
		var_90_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_18_bool == 0) goto Label_384;
		var_0_object = false;
	}
Label_384:
	return 2;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_403(var_18_bool, var_19_object, (float)70.0);
...
func_711()
{
	SetVariable("ood7MariaPetr1", (int)1);
	return 0;
}
...
func_403(var_18_bool, var_19_object, var_20_float)
{
...
func_472()
{
	...
	if(var_248_bool != 0) {
		...
		if(var_250_bool == 0) goto Label_489;
		UnlookAsync("head");
	}
Label_489:
	return 2;
