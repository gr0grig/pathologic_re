				...
				if(2 == var_959_int) {
					...
					if(2 == var_976_int) {
						...
						if(2 == var_979_int) {
							...
							if(!var_981_bool) { //@nz
								bool var_989_bool;
								func_3340(var_989_bool, 3);
							} else {
								bool var_991_bool;
								func_3082(var_991_bool, 0.5);
...
void func_3082(bool var_991_bool, float var_992_float)
{
	float var_994_float;
	@rand(var_994_float);
...
void func_3104(object var_216_object)
{
	bool var_218_bool;
...
void func_3113(string var_861_string, int var_862_int)
{
...
void func_3120(int var_855_int)
{
...
// @pe
void func_3143(object var_24_object)
{
	int var_25_int;
...
void func_3164(bool var_22_bool, object var_23_object, string var_24_string)
{
	...
	if(var_24_string == var_45_string) {
		...
		if(var_47_bool != 0) {
			...
			if(!(var_24_string == var_55_string)) goto Label_3207;
...
Label_3207:
	if(!(var_24_string == "player_shot")) goto Label_3236;
	...
	if(!(var_40_float < 12250000.0)) goto Label_3236;
...
// @pe
void func_3238(bool var_21_bool, object var_22_object)
{
...
// @pe
void func_3289(bool var_21_bool, object var_22_object)
{
	object var_24_object;
...
void func_3303(bool var_42_bool)
{
...
// @pe
void func_3340(bool var_87_bool, int var_88_int)
{
...
// @pe
void func_3386(bool var_43_bool, object var_44_object)
{
...
// @pe
void func_3404(bool var_47_bool, object var_48_object)
{
...
// @pe
void func_3422(bool var_27_bool, object var_28_object)
{
...
// @pe
void func_3440(bool var_21_bool, object var_22_object)
{
...
void func_3458(bool var_995_bool)
{
...
// @pe
void func_3469(bool var_759_bool)
{
...
void func_3483(bool var_981_bool)
{
...
void func_3496(bool var_1008_bool)
{
...
void func_3558(string var_59_string)
{
...
void func_3560(string var_55_string)
{
	var_55_string = "d7q04_helpme";
}


void func_3562(string var_1081_string)
{
...
void func_3564(string var_760_string)
{
...
void func_3566(int var_987_int)
{
	var_987_int = 3;
}
