...
task_1_event_1(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_bool, var_7_float, var_8_int, var_9_object, var_10_object, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_bool, var_18_bool, var_19_bool, var_20_bool)
{
	...
	if(var_21_bool != 0) {
		...
		func_3440(var_28_bool, var_29_object);
	}
	return 0;
}
...
task_3_event_17(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_bool, var_7_float, var_8_int, var_9_object, var_10_bool, var_11_object, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool, var_17_object, var_18_bool, var_19_bool, var_20_bool)
{
	...
	var_22_bool = 0; var_23_object = Obj();
	var_20_bool = var_23_object;
	func_3440(var_22_bool, var_23_object);
	return 0;
}
				...
				if(var_977_bool != 0) {
					...
					if(var_980_bool != 0) {
						...
						if(var_988_bool != 0) {
							...
							func_3340(var_989_bool, (int)3);
						} else {
							var_991_bool = 0; var_992_float = 0;
							func_3082(var_991_bool, (float)0.5);
						...
						if(var_1007_bool != 0) {
							...
							func_3082(var_1021_bool, (float)0.5);
	...
	if(var_46_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_58_bool != 0) {
				...
				func_3440(var_59_bool, var_60_object);
				if(var_59_bool != 0) {
					var_22_bool = 1;
					return 16;
				}
		...
		if(var_68_bool == 0) goto Label_3236;
		...
		if(var_70_bool != 0) {
			...
			func_3440(var_71_bool, var_72_object);
			if(var_71_bool != 0) {
				var_22_bool = 1;
				return 16;
			}
		...
		if(var_74_bool == 0) goto Label_3236;
		var_75_bool = 0; var_76_object = Obj();
		var_23_object = var_76_object;
		func_3404(var_75_bool, var_76_object);
		if(var_75_bool == 0) goto Label_3236;
		var_22_bool = 1;
		return 16;
	}
Label_3236:
...
func_2716(var_511_float, var_512_object, var_513_float, var_514_int)
{
	...
	func_3064(var_549_float, var_550_float, (float)1);
	...
	func_3071(var_559_float, var_560_float, (float)0, (float)1);
...
func_3238(var_21_bool, var_22_object)
{
	...
	if(var_51_bool != 0) {
		...
		func_3440(var_55_bool, var_56_object);
...
Label_1847:
	...
	if(var_868_bool != 0) {
		...
		if(var_874_bool != 0) {
			...
			func_3113(var_877_string, var_878_int);
...
func_2520(var_70_object)
{
	...
	if(var_91_bool != 0) {
		...
		var_129_float = var_127_float * var_128_float;
		var_130_int = var_126_float + var_129_float;
		var_132_bool = var_130_int >= (int)0;
		if(var_132_bool != 0) {
			var_85_string = "fdie";
		} else {
				var_85_string = "bdie";
		...
		var_135_bool = IsFuncExist(var_70_object, "GetScriptProperty", (int)2);
		if(var_135_bool != 0) {
			@@var_70_object:HasScriptProperty(var_87_bool, "Owner");
			var_137_bool = var_87_bool;
			if(var_137_bool != 0) {
				@@var_70_object:GetScriptProperty(var_86_object, "Owner");
				var_139_bool = var_86_object == 0; //@ne
				if(var_139_bool != 0) {
					var_70_object = var_86_object;
				}
			}
		}
		var_142_bool = IsFuncExist(var_86_object, "@GetEyesHeight", (int)1);
		if(var_142_bool != 0) {
...
func_3564(var_760_string)
{
	var_760_string = "pt_d7q04_bonfire";
	return 0;
}
...
func_3568()
{
	var_47_object = Obj(); var_48_float = 0; var_49_float = 0; var_50_bool = 0; var_51_object = Obj(); var_52_float = 0; var_53_float = 0; var_54_bool = 0;
	CreateInvItem(var_51_object);
	rand(var_52_float, (int)40, (int)80);
	rand(var_53_float, (int)5, (int)20);
	@@var_51_object:SetItemName("grass_combination");
	var_62_float = var_52_float / (float)100.0;
	@@var_51_object:SetProperty("im_inc", var_62_float);
	var_65_float = var_53_float / (float)100.0;
	var_66_int = -var_65_float;
	@@var_51_object:SetProperty("hl_inc", var_66_int);
	AddItem(var_54_bool, var_51_object, (int)0, (int)1);
	return 8;
}
EMIT "Stack[-4] = 0";
