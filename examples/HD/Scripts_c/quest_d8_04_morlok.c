...
void func_2312(void)
{
	...
	func_2338(var_30_bool, var_31_object, 649);
}
EMIT "Stack[-1] = 0";


void func_2061(string var_133_string)
{
...
void func_2325(object var_39_object)
{
...
void func_2077(string var_100_string, bool var_101_bool)
{
...
void func_2338(bool var_30_bool, object var_31_object, int var_32_int)
{
...
void func_2043(void)
{
	...
	if(var_154_bool != 0) {
		...
		if(var_152_bool == 0) goto Label_2060;
		@UnlookAsync("head");
	}
Label_2060:
...
void func_2092(object var_19_object)
{
	float var_22_float;
...
void func_2110(string var_47_string)
{
	...
	if(var_69_bool == 0) goto Label_2130;
}


void func_2366(int var_80_int)
{
	int var_82_int;
		...
		if(var_89_bool != 0) {
			...
			if(var_50_float >= (var_31_float * var_31_float)) {
				...
				if(var_249_bool != 0) {
					...
					bool var_513_bool;
					func_1808(var_513_bool, var_0_object);
					if(!var_513_bool) { //@nz
						goto Label_795;
					}
					var_0_object->GetPFPosition(var_44_cvector); //@t
...
// @pe
void func_2389(object var_19_object)
{
	int var_20_int;
...
void func_2402(int var_77_int)
{
	var_77_int = 521048;
}


void func_2404(int var_76_int)
{
	var_76_int = 521047;
}


void func_2406(string var_78_string)
{
	var_78_string = "ui/NPC_Morlok.png";
}


void func_2151(object var_15_object)
{
...
void func_2408(string var_79_string)
{
	var_79_string = "ui/NPC_Morlok_b.png";
}


void func_2410(bool var_71_bool)
{
	var_71_bool = false;
}
...
// @pe
void func_2412(object var_22_object)
{
...
void func_2157(cvector var_47_cvector, cvector var_48_cvector)
{
...
void func_886(object var_0_object, object var_1_object, bool var_350_bool, float var_351_float)
{
	...
	if(var_357_bool != 0) {
		...
		func_1225(var_359_string);
		bool var_476_bool;
		func_1808(var_476_bool, var_0_object);
		if(!var_476_bool) { //@nz
			@StopAsync();
			var_350_bool = false;
			return 8;
		...
		for(;;) {
			...
			if(!var_357_bool) { //@nz
				...
				func_1225(var_359_string);
				bool var_502_bool;
				func_1808(var_502_bool, var_0_object);
				if(!var_502_bool) { //@nz
					@StopAsync();
					var_350_bool = false;
					return 8;
...
// @pe
void func_2167(float var_439_float, float var_440_float, float var_441_float)
{
...
// @pe
void func_2174(float var_449_float, float var_450_float, float var_451_float, float var_452_float)
{
...
void func_2185(int var_116_int, string var_117_string)
{
	int var_119_int;
...
// @pe
void func_142(object var_2_object, string var_96_string)
{
	bool var_97_bool;
...
void func_2190(float var_457_float)
{
...
void func_2207(bool var_16_bool, string var_17_string, string var_18_string)
{
	object var_20_object;
...
void func_1694(float var_401_float, object var_402_object, float var_403_float, int var_404_int)
{
	...
	float var_439_float;
	func_2167(var_439_float, ((var_414_int + var_416_int) / 100.0), (float)1);
	float var_417_float;
	...
	float var_449_float;
	func_2174(var_449_float, (var_418_float - var_419_float), (float)0, (float)1);
...
void func_2219(object var_18_object)
{
	bool var_20_bool;
...
void func_1974(bool var_28_bool, object var_29_object, float var_30_float)
{
	...
	func_2157(var_55_cvector, (var_44_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_71_bool != 0) {
		...
		if(var_48_bool == 0) goto Label_2037;
...
{
	func_2219(var_0_object);
}


void func_1230(int var_466_int)
{
	var_466_int = 0;
}
...
// @pe
void func_2263(object var_49_object)
{
	var_49_object->SetReturnValue(1);
}


void func_1239(bool var_491_bool)
{
	var_491_bool = true;
}
...
// @pe
void func_2287(bool var_114_bool)
{
	int var_116_int;
...
void func_2299(void)
{
	...
	func_2338(var_64_bool, var_65_object, 649);
}
EMIT "Stack[-1] = 0";


void func_1023(bool var_492_bool, float var_493_float)
{
