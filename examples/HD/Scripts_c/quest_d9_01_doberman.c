...
// @PE: 0x4a,0x84,0x9a,0x11b,0x126,0x150,0x167,0x298

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_601();
		var_15_bool = var_11_object == (int)38151;
		if(var_15_bool != 0) {
		...
		var_25_bool = var_11_object == (int)40373;
		if(var_25_bool != 0) {
		...
		var_29_bool = var_10_bool == (int)38148;
		if(var_29_bool != 0) {
			var_30_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)536373);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)536374, (int)38150, (int)38149);
			@@@var_0_object:AddReply((int)538483, (int)-1, (int)40367);
			return 0;
		}
		var_55_bool = var_10_bool == (int)38150;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)536375);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538484, (int)40369, (int)40368);
			@@@var_0_object:AddReply((int)538489, (int)-1, (int)40373);
			return 0;
		}
		var_65_bool = var_10_bool == (int)40369;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)538485);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538486, (int)40371, (int)40370);
			@@@var_0_object:AddReply((int)538488, (int)40371, (int)40372);
			return 0;
		}
		var_75_bool = var_10_bool == (int)40371;
		if(var_75_bool != 0) {
			var_76_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)538487);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)536376, (int)-1, (int)38151);
			return 0;
		}
		var_3_string = true;
		var_81_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_358;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_472(var_25_bool, var_26_object, (float)70.0);
...
func_321(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_459(var_17_float, var_18_object);
...
func_472(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_535;
...
func_541()
{
	...
	if(var_140_bool != 0) {
		...
		if(var_142_bool == 0) goto Label_558;
		UnlookAsync("head");
	}
Label_558:
	return 2;
...
func_294(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_10_float, var_11_float)
{
	var_12_bool = 0;
	func_467(var_12_bool);
...
Label_387:
	...
	if(var_48_bool != 0) {
		...
		if(var_54_bool != 0) {
			...
			if(var_55_int == 0) goto Label_420;
			...
			if(var_59_bool != 0) {
				...
				if(var_69_int == 0) goto Label_438;
				goto Label_449;
		}
		Label_438:
			var_60_bool = 0;
