...
// @PE: 0x15,0x21,0x2d,0x3d,0x54,0x60,0x6b,0xb4,0xcb,0xe2,0xfd,0x10a,0x146,0x1ba,0x1d4,0x1d6,0x1d8,0x1da,0x348,0x3af,0x3b6,0x3ee,0x60f,0x61e,0x626,0x63d,0x6c1,0x6ce,0x6dc,0x6ea
...
task_1_event_1(var_0_object, var_1_bool, var_2_object)
{
	...
	if(var_5_bool != 0) {
		var_147_bool = 0; var_148_object = Obj(); var_149_object = Obj();
...
func_1425(var_12_bool, var_13_object)
{
	var_14_bool = 0; var_15_float = 0; var_16_float = 0; var_17_string = ""; var_18_float = 0; var_19_bool = 0; var_20_float = 0; var_21_float = 0; var_22_string = ""; var_23_float = 0;
	var_24_bool = 0; var_25_object = Obj();
	var_13_object = var_25_object;
	...
	@@var_59_object:in(var_19_bool, var_13_object);
	var_60_bool = var_19_bool;
	if(var_60_bool != 0) {
		var_12_bool = 1;
		return 10;
	}
	...
	if(var_61_bool != 0) {
		...
		var_67_bool = var_20_float < (float)0.33000001311302185;
		if(var_67_bool != 0) {
			var_12_bool = 1;
			return 10;
		}
		@@var_13_object:GetProperty("disease", var_21_float);
		var_12_bool = var_21_float > (float)0.33000001311302185;
		return 10;
	}
	...
	@@var_13_object:GetProperty("class", var_22_string);
	var_75_bool = 0;
	var_75_bool = 1;
	var_76_bool = 0;
	var_76_bool = 1;
	...
	var_90_bool = 0;
	var_90_bool = 1;
	var_91_bool = 0; var_92_string = "";
	var_22_string = var_92_string;
	func_840(var_91_bool, var_92_string);
	if(var_91_bool != 1) {
		var_131_bool = var_22_string == "dog";
		if(var_131_bool != 1) {
			var_90_bool = 0;
		}
	}
	if(var_90_bool != 0) {
		@@var_13_object:GetProperty("disease", var_23_float);
		var_12_bool = var_23_float > (int)0;
		return 10;
	}
	var_12_bool = 0;
	return 10;
...
func_1742(var_5_bool, var_6_object)
{
	...
	if(var_7_bool != 0) {
		...
		func_1729(var_134_bool, var_135_object);
		if(var_134_bool != 0) {
			var_5_bool = 1;
		}
	}
...
{
	var_300_cvector = CVector(0,0,0); var_301_float = 0; var_302_cvector = CVector(0,0,0); var_303_float = 0; var_304_bool = 0; var_305_cvector = CVector(0,0,0); var_306_float = 0; var_307_cvector = CVector(0,0,0); var_308_float = 0; var_309_bool = 0;
	GetPosition(var_305_cvector);
	GetHeight(var_306_float);
	var_310_float = GetByIndex(var_305_cvector, 1);
	var_312_float = var_306_float / (int)2;
	var_310_float = var_310_float + var_312_float;
	SetByIndex(var_305_cvector, 1) = var_310_float;
	var_307_cvector = var_299_cvector - var_305_cvector;
	var_313_int = var_307_cvector | var_307_cvector;
	var_308_float = sqrt(var_313_int);
	var_315_bool = var_308_float < (int)50;
	if(var_315_bool != 0) {
		var_309_bool = 0;
	} else {
			var_320_float = GetByIndex(var_307_cvector, 1);
			var_321_float = var_320_float / var_308_float;
			var_309_bool = var_321_float < (float)-0.1428571492433548;
	}
	var_317_bool = var_309_bool;
	if(var_317_bool != 0) {
...
func_1770(var_147_bool, var_148_object, var_149_object)
{
	...
	func_1796(var_151_bool, var_152_object);
	var_153_bool = var_151_bool == 0; //@nz
	if(var_153_bool != 1) {
		var_154_float = 0; var_155_object = Obj();
		var_149_object = var_155_object;
		func_495(var_154_float, var_155_object);
		var_156_float = 0; var_157_object = Obj();
		var_148_object = var_157_object;
		func_495(var_156_float, var_157_object);
		var_159_int = var_156_float - (int)25;
		var_160_bool = var_154_float < var_159_int;
		if(var_160_bool != 1) {
			var_147_bool = 0;
		}
	}
...
Label_125:
	...
	if(var_177_bool != 0) {
		...
		var_274_bool = var_181_bool == 0; //@nz
		if(var_274_bool != 1) {
			var_275_bool = 0; var_276_object = Obj();
			var_276_object = var_0_object;
			func_1729(var_275_bool, var_276_object);
			var_282_bool = var_275_bool == 0; //@nz
			if(var_282_bool != 1) {
				var_180_bool = 0;
			}
		}
...
func_1406(var_288_object)
{
	var_289_cvector = CVector(0,0,0); var_290_float = 0; var_291_cvector = CVector(0,0,0); var_292_float = 0;
	@@var_288_object:GetPosition(var_291_cvector);
	var_295_bool = IsFuncExist(var_288_object, "@GetHeight", (int)1);
	if(var_295_bool != 0) {
		@@var_288_object:GetHeight(var_292_float);
		var_296_float = GetByIndex(var_291_cvector, 1);
		var_298_float = var_292_float / (int)2;
		var_296_float = var_296_float + var_298_float;
		SetByIndex(var_291_cvector, 1) = var_296_float;
	}
	var_299_cvector = CVector(0,0,0);
