...
task task_1
{
	...
	void OnSee(object actor, bool var_1_bool, object var_2_object)
	{
		...
		if(var_5_bool != 0) {
			...
			func_1770(var_147_bool, actor, var_149_object);
			if(var_147_bool != 0)
				var_4_bool = true;
		}
		if(var_4_bool != 0) {
...
void func_1425(bool var_12_bool, object var_13_object)
{
...
void func_1375(cvector var_299_cvector)
{
...
// @pe
void func_1770(bool var_147_bool, object var_148_object, object var_149_object)
{
...
Label_112:
	...
	for(;;) {
		...
		if(var_177_bool != 0) {
			...
			if(var_274_bool != 1) {
				bool var_275_bool;
				func_1729(var_275_bool, var_0_object);
...
void func_1406(object var_288_object)
{
