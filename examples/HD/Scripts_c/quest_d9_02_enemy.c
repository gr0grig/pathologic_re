...
{
	var_63_bool = var_57_object == 0; //@nz
	if(var_63_bool != 0) {
		var_56_bool = 0;
		return 0;
	}
	var_65_bool = var_58_float > (int)0;
	if(var_65_bool != 0) {
		SendWorldWndMessage((int)8);
	} else {
		var_96_bool = var_58_float < (int)0;
		if(var_96_bool != 0) {
...
Label_3137:
	...
	var_71_bool = 0; var_72_object = Obj(); var_73_string = ""; var_74_float = 0; var_75_float = 0; var_76_float = 0;
...
func_3642()
{
	var_47_bool = 0; var_48_int = 0; var_49_bool = 0; var_50_int = 0;
	irand(var_50_int, (int)6);
	var_55_int = var_50_int + (int)1;
	AddItem(var_49_bool, "rusk", (int)0, var_55_int);
	var_56_bool = 0; var_57_object = Obj(); var_58_float = 0;
	func_2699(Obj());
	var_59_object = var_57_object;
	func_3116(var_56_bool, var_57_object, (float)-0.029999999329447746);
	return 4;
}
...
func_3168(var_67_float)
{
	...
	SendWorldWndMessage((int)16, var_69_object);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_2723(var_71_bool, var_72_object, var_73_string, var_74_float, var_75_float, var_76_float)
{
	...
	var_90_float = var_78_float + var_74_float;
	var_75_float = var_91_float;
	var_76_float = var_92_float;
	func_3100(var_89_float, var_90_float, var_91_float, var_92_float);
