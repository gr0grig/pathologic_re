...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Smile|W:Sorrow|W:Doubt|W:Agression|W:cleanup|W:restore|W:player|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ui/NPC_Burah.png|W:ui/NPC_Burah_b.png|W:d9q05|W:ood9Burah1|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:branch
// @GLOBALS: 0:object:
// @RUN_OP: 0x1e8
// @RUN_TASK: 2
...
// @PE: 0x51,0x9a,0xb0,0x1e0,0x1e8,0x20d,0x256,0x27c,0x298,0x483,0x48c,0x492,0x49e

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_bool)
{
	if((int)1 != 0) {
		func_1084();
		var_12_bool = var_8_bool == (int)15199;
		if(var_12_bool != 0) {
		...
		var_41_bool = var_8_bool == (int)40555;
		if(var_41_bool != 0) {
		...
		var_45_bool = var_8_bool == (int)40548;
		if(var_45_bool != 0) {
		...
		var_49_bool = var_8_bool == (int)15212;
		if(var_49_bool != 0) {
		...
		var_55_bool = var_7_cvector == (int)15184;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_154(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)513949);
			@@@var_0_object:ClearReplies();
			var_74_bool = 0; var_75_object = Obj();
			var_75_object = var_1_object;
			func_1170(var_75_object);
			if(var_74_bool != 0) {
				@@@var_0_object:AddReply((int)513950, (int)15186, (int)15185);
			}
			var_85_bool = 0; var_86_object = Obj();
			var_86_object = var_1_object;
			func_1182(var_86_object);
			if(var_85_bool != 0) {
				@@@var_0_object:AddReply((int)513977, (int)15213, (int)15212);
			}
			@@@var_0_object:AddReply((int)513980, (int)-1, (int)15215);
			return 0;
		}
		var_98_bool = var_7_cvector == (int)15213;
		if(var_98_bool != 0) {
			var_99_string = "";
			func_154(var_8_bool, "Smile");
			@@@var_0_object:SetMessage((int)513978);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513979, (int)-1, (int)15214);
			@@@var_0_object:AddReply((int)538655, (int)-1, (int)40549);
			return 0;
		}
		var_108_bool = var_7_cvector == (int)15186;
		if(var_108_bool != 0) {
			var_109_string = "";
			func_154(var_8_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)513951);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513952, (int)15188, (int)15187);
			@@@var_0_object:AddReply((int)538654, (int)-1, (int)40548);
			return 0;
		}
		var_118_bool = var_7_cvector == (int)15188;
		if(var_118_bool != 0) {
			var_119_string = "";
			func_154(var_8_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)513953);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513954, (int)15190, (int)15189);
			return 0;
		}
		var_125_bool = var_7_cvector == (int)15190;
		if(var_125_bool != 0) {
			var_126_string = "";
			func_154(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)513955);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538657, (int)40553, (int)40551);
			@@@var_0_object:AddReply((int)538658, (int)40554, (int)40552);
			return 0;
		}
		var_135_bool = var_7_cvector == (int)40554;
		if(var_135_bool != 0) {
			var_136_string = "";
			func_154(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538660);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)538661, (int)-1, (int)40555);
			@@@var_0_object:AddReply((int)538662, (int)40553, (int)40556);
			return 0;
		}
		var_145_bool = var_7_cvector == (int)40553;
		if(var_145_bool != 0) {
			var_146_string = "";
			func_154(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)538659);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513956, (int)15192, (int)15191);
			@@@var_0_object:AddReply((int)538663, (int)15194, (int)40558);
			return 0;
		}
		var_155_bool = var_7_cvector == (int)15192;
		if(var_155_bool != 0) {
			var_156_string = "";
			func_154(var_8_bool, "Doubt");
			@@@var_0_object:SetMessage((int)513957);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513958, (int)15194, (int)15193);
			@@@var_0_object:AddReply((int)538664, (int)15196, (int)40560);
			return 0;
		}
		var_165_bool = var_7_cvector == (int)15194;
		if(var_165_bool != 0) {
			var_166_string = "";
			func_154(var_8_bool, "Agression");
			@@@var_0_object:SetMessage((int)513959);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513960, (int)15196, (int)15195);
			return 0;
		}
		var_172_bool = var_7_cvector == (int)15196;
		if(var_172_bool != 0) {
			var_173_string = "";
			func_154(var_8_bool, "Agression");
			@@@var_0_object:SetMessage((int)513961);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513962, (int)15198, (int)15197);
			@@@var_0_object:AddReply((int)538665, (int)15198, (int)40562);
			return 0;
		}
		var_182_bool = var_7_cvector == (int)15198;
		if(var_182_bool != 0) {
			var_183_string = "";
			func_154(var_8_bool, "Doubt");
			@@@var_0_object:SetMessage((int)513963);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)513964, (int)-1, (int)15199);
			return 0;
		}
		var_3_string = true;
		var_188_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_17_bool == 0) goto Label_511;
		var_1_object = false;
	}
Label_511:
	return 2;
...
func_0(var_0_object, var_26_int, var_27_object)
{
	...
	func_813(var_37_bool, var_38_object, (float)70.0);
...
func_1038(var_243_string)
{
	...
	if(var_250_bool != 0) {
		...
		lshPlayAnimation(var_248_float, var_249_float, (bool)0);
	} else {
		var_253_int = "Can't find lsh animation : " + var_243_string;
		Trace(var_253_int);
	}
	return 6;
...
func_1194()
{
	...
	CreateDiaryEntry(var_18_object, (int)766, (int)2, (int)540063);
	var_22_bool = 0; var_23_object = Obj(); var_24_int = 0;
	var_18_object = var_23_object;
	func_1220(var_22_bool, var_23_object, (int)764);
	return 2;
}
EMIT "Stack[-1] = 0";


func_813(var_37_bool, var_38_object, var_39_float)
{
	...
	if(var_80_bool != 0) {
		...
		if(var_82_bool == 0) goto Label_876;
...
func_882()
{
	...
	if(var_264_bool != 0) {
		...
		if(var_266_bool == 0) goto Label_899;
		UnlookAsync("head");
	}
Label_899:
	return 2;
