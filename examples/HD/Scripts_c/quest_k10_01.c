...
maintask task_0
{
	void init(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object, object var_6_object, object var_7_object, object var_8_object, object var_9_object, object var_10_object)
	{
		...
		func_437("warehouse_rubin@door1", false);
	...
	void OnTrigger(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object, object var_6_object, object var_7_object, object var_8_object, object var_9_object, object var_10_object, string var_11_string)
	{
		...
		if(var_11_string == "warehouse_rubin_load") {
			if(!var_0_object) { //@nz
				...
				func_437("uprava_prison@door1", true);
				func_437("uprava_admin@door1", false);
				var_30_object = null;
		}
	Label_281:
		for(;;) {
		...
		if(var_11_string == "remove_soldiers") {
			...
			func_437("uprava_prison@door1", false);
			goto Label_281;
		}
		...
		if(var_11_string == "free_prisoner") {
			...
			if(var_40_object != 0) {
				...
				func_437("ihouse_vlad@door2", true);
...
void func_419(object var_70_object, object var_71_object, string var_72_string, string var_73_string, string var_74_string)
{
...
void func_454(bool var_220_bool, string var_221_string, string var_222_string)
{
...
void func_389(object var_243_object)
{
...
void func_298(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object, object var_6_object, object var_7_object, object var_8_object, object var_9_object, object var_10_object)
{
	...
	func_437("uprava_prison@door1", false);
	func_437("ihouse_vlad@door2", false);
	func_437("factory@door1", false);
	if(var_0_object != 0)
...
void func_395(object var_13_object)
{
...
void func_401(object var_50_object, object var_51_object, string var_52_string, string var_53_string, string var_54_string)
{
...
void func_466(object var_204_object, string var_205_string)
{
	int var_209_int; int var_210_int; object var_211_object;
	if(var_204_object != 0) {
		var_204_object->size(var_209_int);
		var_210_int = 0;

		for(;;) {
			if(!(var_210_int < var_209_int)) goto Label_484;
...
void func_437(string var_20_string, bool var_21_bool)
{
