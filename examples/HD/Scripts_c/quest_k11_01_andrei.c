...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Untrust|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Smile|W:Neutral|W:cleanup|W:restore|W:player|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ook11Andrei1|W:branch|W:ui/NPC_Andrei.png|W:ui/NPC_Andrei_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x118
// @RUN_TASK: 2
...
// @PE: 0x51,0x95,0xab,0x110,0x118,0x13d,0x186,0x1ac,0x1c8,0x3a9,0x3af

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_bool)
{
	if((int)1 != 0) {
		func_876();
		var_12_bool = var_8_bool == (int)29399;
		if(var_12_bool != 0) {
		...
		var_18_bool = var_7_cvector == (int)29398;
		if(var_18_bool != 0) {
			var_19_string = "";
			func_149(var_8_bool, "Untrust");
			@@@var_0_object:SetMessage((int)528036);
			@@@var_0_object:ClearReplies();
			var_37_bool = 0; var_38_object = Obj();
			var_38_object = var_1_object;
			func_943(var_38_object);
			if(var_37_bool != 0) {
				@@@var_0_object:AddReply((int)528037, (int)29400, (int)29399);
			}
			@@@var_0_object:AddReply((int)528040, (int)-1, (int)29402);
			@@@var_0_object:AddReply((int)541066, (int)-1, (int)43171);
			return 0;
		}
		var_55_bool = var_7_cvector == (int)29400;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_149(var_8_bool, "Smile");
			@@@var_0_object:SetMessage((int)528038);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528039, (int)43172, (int)29401);
			return 0;
		}
		var_62_bool = var_7_cvector == (int)43172;
		if(var_62_bool != 0) {
			var_63_string = "";
			func_149(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)541067);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541068, (int)-1, (int)43173);
			@@@var_0_object:AddReply((int)541069, (int)-1, (int)43174);
			return 0;
		}
		var_3_string = true;
		var_71_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_17_bool == 0) goto Label_303;
		var_1_object = false;
	}
Label_303:
	return 2;
...
func_0(var_0_object, var_26_int, var_27_object)
{
	...
	func_605(var_37_bool, var_38_object, (float)70.0);
...
func_674()
{
	...
	if(var_258_bool != 0) {
		...
		if(var_260_bool == 0) goto Label_691;
		UnlookAsync("head");
	}
Label_691:
	return 2;
...
func_937()
{
	SetVariable("ook11Andrei1", (int)1);
	return 0;
}
...
func_605(var_37_bool, var_38_object, var_39_float)
{
	...
	if(var_80_bool != 0) {
		...
		if(var_82_bool == 0) goto Label_668;
