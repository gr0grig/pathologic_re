...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_598(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
// @pe
void func_785(bool var_122_bool)
{
	int var_124_int;
...
void func_667(void)
{
	...
	if(var_160_bool != 0) {
		...
		if(var_158_bool == 0) goto Label_684;
		@UnlookAsync("head");
	}
Label_684:
...
// @pe
void func_797(bool var_114_bool)
{
	int var_116_int;
...
void func_418(bool var_18_bool)
{
	var_18_bool = true;
}
...
// @pe
void func_420(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_21_float, float var_22_float)
{
	bool var_23_bool;
...
void func_685(string var_139_string)
{
...
void func_826(int var_76_int)
{
	var_76_int = 527721;
}


void func_828(int var_75_int)
{
	var_75_int = 527720;
}


void func_701(string var_99_string, bool var_100_bool)
{
...
void func_830(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen1.png";
}


void func_447(object var_0_object, object var_1_object, bool var_4_bool, bool var_15_bool)
{
	if(var_4_bool == null)
		var_15_bool = false;
	float var_19_float;
	func_585(var_19_float, var_4_bool);
...
void func_832(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen1_b.png";
}


void func_834(bool var_70_bool)
{
	var_70_bool = false;
}


void func_578(bool var_71_bool)
{
	var_71_bool = true;
}
...
void func_585(float var_19_float, object var_20_object)
{
...
void func_716(object var_29_object)
{
	float var_32_float;
...
void func_593(bool var_23_bool)
{
	bool var_25_bool;
...
void func_598(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_740(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_661;
...
void func_734(object var_19_object)
{
...
void func_351(int var_6_int, float var_12_float, float var_13_float)
{
	...
	for(;;) {
		...
		func_420(var_22_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
		var_6_int = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_740(cvector var_54_cvector, cvector var_55_cvector)
{
...
void func_750(int var_116_int, string var_117_string)
{
	int var_119_int;
...
void func_499(void)
{
	...
	for(;;) {
		...
		if(var_59_bool != 0) {
			@irand(var_39_int, 3);
			if(var_39_int == 0) {
				if(var_37_int == 0) goto Label_546;
			...
			if(var_39_int == 1) {
				...
				goto Label_575;
					...
					if(var_72_bool == 0) goto Label_570;
			}
		}
	Label_575:
		for(;;) {
...
void func_755(string var_52_string, int var_53_int)
{
