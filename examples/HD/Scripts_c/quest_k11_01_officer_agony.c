...
maintask task_1
{
	void init(int var_0_int)
	{
		...
		for(;;) {
			...
			if(var_2_bool != 0) {
				bool var_14_bool;
				func_261(var_14_bool, 0.33333334);
				if(var_14_bool != 0)
					var_12_bool = true;
			}
			if(var_12_bool != 0)
	...
	void OnDeath(int var_0_int, object var_1_object)
	{
		...
		if(var_4_bool != 0) {
			...
			if(!var_5_bool) { //@nz
				...
				func_266(var_9_bool, var_10_object, -0.3);
...
void func_225(object var_7_object, cvector var_10_cvector, cvector var_11_cvector)
{
...
void func_261(bool var_14_bool, float var_15_float)
{
	float var_17_float;
	@rand(var_17_float);
...
// @pe
void func_266(bool var_9_bool, object var_10_object, float var_11_float)
{
	if(!var_10_object) { //@nz
		var_9_bool = false;
		return 0;
...
void func_301(float var_16_float)
{
	object var_18_object;
...
void func_147(bool var_28_bool, object var_29_object, string var_30_string)
{
...
void func_244(object var_2_object)
{
	object var_4_object;
	@self(var_4_object);
...
void func_181(object var_18_object)
{
...
void func_311(bool var_4_bool, string var_5_string, string var_6_string)
{
	object var_8_object;
...
// @pe
void func_250(float var_38_float, float var_39_float, float var_40_float, float var_41_float)
{
...
void func_159(bool var_20_bool, object var_21_object, string var_22_string, float var_23_float, float var_24_float, float var_25_float)
{
	...
	func_250(var_38_float, (var_27_float + var_23_float), var_40_float, var_41_float);
