...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Isee|W:Confusion|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:game_final|W:branch|W:ui/NPC_Aglaja.png|W:ui/NPC_Aglaja_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x172
// @RUN_TASK: 2
...
// @PE: 0x51,0xa5,0xbb,0x176,0x2e0

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_699();
		var_11_bool = var_6_int == (int)41142;
		if(var_11_bool != 0) {
			var_12_bool = 0; var_13_object = Obj();
			var_13_object = var_1_object;
			func_736(var_13_object);
			var_20_bool = var_12_bool == 0; //@nz
			if(var_20_bool != 0) {
				var_21_string = "";
				func_165(var_7_bool, "Neutral");
				@@@var_0_object:SetMessage((int)539199);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)540975, (int)43646, (int)43065);
				@@@var_0_object:AddReply((int)539200, (int)43646, (int)41143);
				return 0;
			}
			var_45_string = "";
			func_165(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)539201);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539202, (int)-1, (int)41145);
			@@@var_0_object:AddReply((int)540976, (int)-1, (int)43066);
			return 0;
		}
		var_54_bool = var_6_int == (int)43646;
		if(var_54_bool != 0) {
			var_55_string = "";
			func_165(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)541486);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541487, (int)43653, (int)43647);
			@@@var_0_object:AddReply((int)541488, (int)43649, (int)43648);
			return 0;
		}
		var_64_bool = var_6_int == (int)43649;
		if(var_64_bool != 0) {
			var_65_string = "";
			func_165(var_7_bool, "Isee");
			@@@var_0_object:SetMessage((int)541489);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541490, (int)45215, (int)43650);
			@@@var_0_object:AddReply((int)541491, (int)43653, (int)43651);
			return 0;
		}
		var_74_bool = var_6_int == (int)43653;
		if(var_74_bool != 0) {
			var_75_string = "";
			func_165(var_7_bool, "Confusion");
			@@@var_0_object:SetMessage((int)541492);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541493, (int)43657, (int)43655);
			@@@var_0_object:AddReply((int)541494, (int)45215, (int)43656);
			return 0;
		}
		var_84_bool = var_6_int == (int)43657;
		if(var_84_bool != 0) {
			var_85_string = "";
			func_165(var_7_bool, "Confusion");
			@@@var_0_object:SetMessage((int)541495);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541496, (int)45215, (int)43658);
			@@@var_0_object:AddReply((int)541497, (int)45215, (int)43659);
			return 0;
		}
		var_94_bool = var_6_int == (int)45215;
		if(var_94_bool != 0) {
			var_95_string = "";
			func_165(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542795);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542797, (int)-1, (int)45220);
			@@@var_0_object:AddReply((int)542796, (int)-1, (int)45219);
			return 0;
		}
		var_3_string = true;
		var_103_bool = 0;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_428(var_18_bool, var_19_object, (float)70.0);
...
func_653(var_216_string)
{
	...
	if(var_223_bool != 0) {
		...
		lshPlayAnimation(var_221_float, var_222_float, (bool)0);
	} else {
		var_226_int = "Can't find lsh animation : " + var_216_string;
		Trace(var_226_int);
	}
	return 6;
...
Label_135:
	...
	Label_139:
		lshWaitForAnimEnd();
		var_215_string = var_3_string;
		if(var_215_string != 0) {
		} else {
			var_216_string = "";
			var_216_string = var_2_object;
			func_653(var_216_string);
			goto Label_139;
	}
...
func_428(var_18_bool, var_19_object, var_20_float)
{
	...
	if(var_61_bool != 0) {
		...
		if(var_63_bool == 0) goto Label_491;
...
func_497()
{
	...
	if(var_245_bool != 0) {
		...
		if(var_247_bool == 0) goto Label_514;
		UnlookAsync("head");
	}
Label_514:
	return 2;
