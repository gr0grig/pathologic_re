...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:k12q01TheaterIsVisited|W:player|W:head|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |W:ui/NPC_bmask.png|W:ui/NPC_bmask_b.png|W:ook12BirdmaskT1|W:quest_k12_01|W:init_theater|W:ook12BirdmaskT2|W:k12q01ChildsAreVisited|W:branch|A:add|W:vol_|A:size|A:get
// @GLOBALS: 0:object:
// @RUN_OP: 0x205
// @RUN_TASK: 2
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_852();
		var_15_bool = var_11_object == (int)41172;
		if(var_15_bool != 0) {
		...
		var_21_bool = var_11_object == (int)41187;
		if(var_21_bool != 0) {
		...
		var_31_bool = var_10_bool == (int)41171;
		if(var_31_bool != 0) {
			...
			if(var_144_bool != 0) {
				...
				@@@var_0_object:SetMessage((int)539228);
				@@@var_0_object:ClearReplies();
				var_163_bool = 0; var_164_object = Obj();
				var_164_object = var_1_object;
				func_973(var_164_object);
				if(var_163_bool != 0) {
					@@@var_0_object:AddReply((int)539229, (int)45272, (int)41172);
				}
				@@@var_0_object:AddReply((int)539242, (int)-1, (int)41185);
				return 0;
			}
			var_177_bool = 0; var_178_object = Obj();
			var_178_object = var_1_object;
			func_949(var_178_object);
			var_183_bool = var_177_bool == 0; //@nz
			if(var_183_bool != 0) {
				var_184_string = "";
				func_227(var_11_object, "Neutral");
				@@@var_0_object:SetMessage((int)541628);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)541629, (int)43802, (int)43801);
				@@@var_0_object:AddReply((int)541633, (int)-1, (int)43805);
				return 0;
			}
			var_192_bool = 0;
			var_192_bool = 0;
			...
			if(var_192_bool != 0) {
				...
				var_208_string = "";
				func_227(var_11_object, "Neutral");
				@@@var_0_object:SetMessage((int)539243);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)539244, (int)-1, (int)41187);
				return 0;
			}
			var_213_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)539245);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539246, (int)-1, (int)41189);
			return 0;
		}
		var_219_bool = var_10_bool == (int)43802;
		if(var_219_bool != 0) {
			var_220_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)541630);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541631, (int)-1, (int)43803);
			@@@var_0_object:AddReply((int)541632, (int)-1, (int)43804);
			return 0;
		}
		var_229_bool = var_10_bool == (int)45272;
		if(var_229_bool != 0) {
			var_230_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)542846);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542847, (int)45275, (int)45273);
			@@@var_0_object:AddReply((int)542848, (int)-1, (int)45274);
			return 0;
		}
		var_239_bool = var_10_bool == (int)45275;
		if(var_239_bool != 0) {
			var_240_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)542849);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542850, (int)-1, (int)45276);
			@@@var_0_object:AddReply((int)542851, (int)45278, (int)45277);
			@@@var_0_object:AddReply((int)542855, (int)45282, (int)45281);
			return 0;
		}
		var_252_bool = var_10_bool == (int)45282;
		if(var_252_bool != 0) {
			var_253_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)542856);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542857, (int)-1, (int)45283);
			return 0;
		}
		var_259_bool = var_10_bool == (int)45278;
		if(var_259_bool != 0) {
			var_260_string = "";
			func_227(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)542852);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542853, (int)-1, (int)45279);
			@@@var_0_object:AddReply((int)542854, (int)-1, (int)45280);
			return 0;
		}
		var_3_string = true;
		var_268_bool = 0;
...
func_920()
{
	SetVariable("ook12BirdmaskT1", (int)1);
	return 0;
}
...
func_933()
{
	SetVariable("ook12BirdmaskT2", (int)1);
	return 0;
}
