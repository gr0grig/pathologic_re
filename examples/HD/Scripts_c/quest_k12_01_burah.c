...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Doubt|W:Sorrow|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ook12BurahSobor1|W:game_final|W:branch|W:ui/NPC_Burah.png|W:ui/NPC_Burah_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x191
// @RUN_TASK: 2
...
// @PE: 0x51,0xaa,0xc0,0x191,0x195,0x303,0x309,0x315

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_734();
		var_11_bool = var_7_bool == (int)41153;
		if(var_11_bool != 0) {
		...
		var_17_bool = var_6_int == (int)41152;
		if(var_17_bool != 0) {
			var_18_bool = 0; var_19_object = Obj();
			var_19_object = var_1_object;
			func_777(var_19_object);
			var_26_bool = var_18_bool == 0; //@nz
			if(var_26_bool != 0) {
				var_27_string = "";
				func_170(var_7_bool, "Neutral");
				@@@var_0_object:SetMessage((int)539209);
				@@@var_0_object:ClearReplies();
				var_45_bool = 0; var_46_object = Obj();
				var_46_object = var_1_object;
				func_789(var_46_object);
				if(var_45_bool != 0) {
					@@@var_0_object:AddReply((int)539210, (int)43660, (int)41153);
				}
				@@@var_0_object:AddReply((int)543010, (int)-1, (int)45462);
				return 0;
			}
			var_57_string = "";
			func_170(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)539211);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539212, (int)-1, (int)41155);
			@@@var_0_object:AddReply((int)541503, (int)-1, (int)43665);
			return 0;
		}
		var_66_bool = var_6_int == (int)43660;
		if(var_66_bool != 0) {
			var_67_string = "";
			func_170(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)541498);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541499, (int)43662, (int)43661);
			@@@var_0_object:AddReply((int)542901, (int)45332, (int)45330);
			return 0;
		}
		var_76_bool = var_6_int == (int)43662;
		if(var_76_bool != 0) {
			var_77_string = "";
			func_170(var_7_bool, "Doubt");
			@@@var_0_object:SetMessage((int)541500);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541501, (int)43664, (int)43663);
			return 0;
		}
		var_83_bool = var_6_int == (int)43664;
		if(var_83_bool != 0) {
			var_84_string = "";
			func_170(var_7_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)541502);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541504, (int)45332, (int)43666);
			@@@var_0_object:AddReply((int)542902, (int)45332, (int)45331);
			return 0;
		}
		var_93_bool = var_6_int == (int)45332;
		if(var_93_bool != 0) {
			var_94_string = "";
			func_170(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542903);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542904, (int)-1, (int)45335);
			@@@var_0_object:AddReply((int)542905, (int)45337, (int)45336);
			return 0;
		}
		var_103_bool = var_6_int == (int)45337;
		if(var_103_bool != 0) {
			var_104_string = "";
			func_170(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542906);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542907, (int)45339, (int)45338);
			return 0;
		}
		var_110_bool = var_6_int == (int)45339;
		if(var_110_bool != 0) {
			var_111_string = "";
			func_170(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542908);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542909, (int)-1, (int)45340);
			@@@var_0_object:AddReply((int)542910, (int)-1, (int)45341);
			return 0;
		}
		var_3_string = true;
		var_119_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_18_bool == 0) goto Label_444;
		var_0_object = false;
	}
Label_444:
	return 2;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_463(var_18_bool, var_19_object, (float)70.0);
...
func_771()
{
	SetVariable("ook12BurahSobor1", (int)1);
	return 0;
}
...
func_463(var_18_bool, var_19_object, var_20_float)
{
	...
	if(var_61_bool != 0) {
		...
		if(var_63_bool == 0) goto Label_526;
...
func_532()
{
	...
	if(var_251_bool != 0) {
		...
		var_253_bool = var_249_bool;
		if(var_253_bool == 0) goto Label_549;
		UnlookAsync("head");
	}
Label_549:
	return 2;
