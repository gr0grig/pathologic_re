...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Sorrow|W:cleanup|W:restore|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ook12DankoSobor1|W:game_final|W:branch|W:ui/NPC_Bakalavr.png|W:ui/NPC_Bakalavr_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x1ad
// @RUN_TASK: 2
...
// @PE: 0x51,0xb4,0xca,0x1ad,0x1b1,0x31f,0x325,0x331

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool)
{
	if((int)1 != 0) {
		func_762();
		var_11_bool = var_7_bool == (int)41148;
		if(var_11_bool != 0) {
		...
		var_17_bool = var_7_bool == (int)43668;
		if(var_17_bool != 0) {
		...
		var_21_bool = var_6_int == (int)41147;
		if(var_21_bool != 0) {
			var_22_bool = 0; var_23_object = Obj();
			var_23_object = var_1_object;
			func_805(var_23_object);
			var_30_bool = var_22_bool == 0; //@nz
			if(var_30_bool != 0) {
				var_31_string = "";
				func_180(var_7_bool, "Neutral");
				@@@var_0_object:SetMessage((int)539204);
				@@@var_0_object:ClearReplies();
				var_49_bool = 0; var_50_object = Obj();
				var_50_object = var_1_object;
				func_817(var_50_object);
				if(var_49_bool != 0) {
					@@@var_0_object:AddReply((int)539205, (int)43669, (int)41148);
				}
				var_58_bool = 0; var_59_object = Obj();
				var_59_object = var_1_object;
				func_817(var_59_object);
				if(var_58_bool != 0) {
					@@@var_0_object:AddReply((int)541506, (int)45318, (int)43668);
				}
				@@@var_0_object:AddReply((int)543011, (int)-1, (int)45463);
				return 0;
			}
			var_66_string = "";
			func_180(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)539206);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)539207, (int)-1, (int)41150);
			@@@var_0_object:AddReply((int)541505, (int)-1, (int)43667);
			return 0;
		}
		var_75_bool = var_6_int == (int)43669;
		if(var_75_bool != 0) {
			var_76_string = "";
			func_180(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)541507);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541508, (int)43671, (int)43670);
			@@@var_0_object:AddReply((int)541510, (int)43673, (int)43672);
			return 0;
		}
		var_85_bool = var_6_int == (int)43671;
		if(var_85_bool != 0) {
			var_86_string = "";
			func_180(var_7_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)541509);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541513, (int)43673, (int)43675);
			return 0;
		}
		var_92_bool = var_6_int == (int)43673;
		if(var_92_bool != 0) {
			var_93_string = "";
			func_180(var_7_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)541511);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)541512, (int)45318, (int)43674);
			@@@var_0_object:AddReply((int)541514, (int)45318, (int)43677);
			return 0;
		}
		var_102_bool = var_6_int == (int)45318;
		if(var_102_bool != 0) {
			var_103_string = "";
			func_180(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542892);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542893, (int)-1, (int)45319);
			@@@var_0_object:AddReply((int)542894, (int)45323, (int)45320);
			return 0;
		}
		var_112_bool = var_6_int == (int)45323;
		if(var_112_bool != 0) {
			var_113_string = "";
			func_180(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542895);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542896, (int)45325, (int)45324);
			return 0;
		}
		var_119_bool = var_6_int == (int)45325;
		if(var_119_bool != 0) {
			var_120_string = "";
			func_180(var_7_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542897);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542899, (int)-1, (int)45328);
			@@@var_0_object:AddReply((int)542900, (int)-1, (int)45329);
			return 0;
		}
		var_3_string = true;
		var_128_bool = 0;
		func_854(var_128_bool);
		if(var_128_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string)
{
	...
	if(var_10_bool != 0) {
		...
		if(var_11_bool != 0) {
			var_14_object = Obj();
			func_769(var_14_object);
			RemoveActor(var_14_object);
		}
	} else {
		var_18_bool = var_6_string == "restore";
		if(var_18_bool == 0) goto Label_472;
		var_0_object = false;
	}
Label_472:
	return 2;
...
func_0(var_0_object, var_7_int, var_8_object)
{
	...
	func_491(var_18_bool, var_19_object, (float)70.0);
...
func_716(var_227_string)
{
	...
	lshHasAnimation(var_231_bool, var_227_string);
	var_234_bool = var_231_bool;
	if(var_234_bool != 0) {
		lshGetAnimTimes(var_227_string, var_232_float, var_233_float);
		lshPlayAnimation(var_232_float, var_233_float, (bool)0);
	} else {
		var_237_int = "Can't find lsh animation : " + var_227_string;
		Trace(var_237_int);
	}
	return 6;
...
func_799()
{
	SetVariable("ook12DankoSobor1", (int)1);
	return 0;
}
...
Label_682:
	...
	func_747(var_153_bool, var_154_string);
...
func_805(var_181_bool)
{
	...
	func_785(var_183_int, "game_final");
...
func_491(var_18_bool, var_19_object, var_20_float)
{
	...
	if(var_61_bool != 0) {
		...
		if(var_63_bool == 0) goto Label_554;
...
func_560()
{
	...
	var_256_bool = 0;
	func_854(var_256_bool);
	if(var_256_bool != 0) {
	} else {
		HasAnimationTrack(var_254_bool, "head");
		var_258_bool = var_254_bool;
		if(var_258_bool == 0) goto Label_577;
		UnlookAsync("head");
	}
Label_577:
	return 2;
...
func_817(var_208_bool)
{
	...
	func_785(var_210_int, "ook12DankoSobor1");
