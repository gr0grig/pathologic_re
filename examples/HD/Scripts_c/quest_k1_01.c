...
maintask task_0
{
	...
	{
		func_482("storojka@door1", false);
		func_482("burah_home@door1", false);
		func_482("cot_katerina@door1", true);
		func_482("cot_alexandr@door1", true);
	...
	Label_275:
		...
		if(var_13_string == "remove_katerina") {
			...
			func_482("cot_katerina@door1", false);
			func_482("cot_alexandr@door1", false);
		} else if(var_13_string == "init_alexandr") {
			func_482("cot_anna@door1", false);
			...
			func_499(var_164_bool, var_165_object, 0.25);
			if(var_4_object != 0)
				var_4_object->Remove(); //@t
			if(var_8_object != 0)
		...
		if(var_13_string == "cleanup") {
			...
			if(var_19_int != 1000)
				...
				func_292(var_8_object, var_98_object, var_149_object, var_11_object, var_12_object, var_13_string, var_14_object, var_15_object, var_16_int, Obj(), Obj(), var_19_int);
...
void func_583(bool var_118_bool, object var_119_object, int var_120_int)
{
...
void func_399(object var_235_object)
{
...
void func_463(object var_31_object, object var_32_object, string var_33_string, string var_34_string, string var_35_string)
{
...
// @pe
void func_405(float var_197_float, float var_198_float, float var_199_float, float var_200_float)
{
...
void func_534(float var_175_float)
{
...
void func_544(void)
{
	...
	func_583(var_118_bool, var_119_object, 318);
}
EMIT "Stack[-1] = 0";


void func_416(object var_138_object, string var_139_string)
{
...
void func_482(string var_15_string, bool var_16_bool)
{
...
void func_292(object var_0_object, object var_1_object, object var_2_object, object var_3_object, object var_4_object, object var_5_object, object var_6_object, object var_8_object, object var_9_object, object var_10_object, object var_11_object, object var_12_object)
{
	if(var_1_object != 0)
		var_1_object->Remove(); //@t
	if(var_0_object != 0)
...
void func_358(object var_167_object)
{
...
void func_427(object var_79_object, object var_80_object, string var_81_string, string var_82_string, string var_83_string)
{
...
void func_557(void)
{
	...
	func_583(var_161_bool, var_162_object, 318);
}
EMIT "Stack[-1] = 0";


void func_365(bool var_187_bool, object var_188_object, string var_189_string)
{
...
// @pe
void func_499(bool var_164_bool, object var_165_object, float var_166_float)
{
...
void func_377(bool var_179_bool, object var_180_object, string var_181_string, float var_182_float, float var_183_float, float var_184_float)
{
	...
	func_405(var_197_float, (var_186_float + var_182_float), var_199_float, var_200_float);
	var_180_object->SetProperty(var_181_string, var_197_float);
	var_179_bool = true;
}


void func_570(object var_127_object)
{
...
void func_445(object var_55_object, object var_56_object, string var_57_string, string var_58_string, string var_59_string)
{
