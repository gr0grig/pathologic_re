...
// @STRINGS: W:heal|W:quest_k1_01|W:cure_worker|W:agony|W:all|W:sleep|W:agony_sleep|W:death|W:agony_die|W:HasProperty|A:HasProperty|A:GetProperty|A:SetProperty|A:GetPosition|W:fhit|W:bhit|W:hit_react|W:2|W:scripted|W:blood_dir.xml|W:reputation|A:add|W:health|W:cleanup
// @GLOBALS: 0:bool:
// @RUN_OP: 0x1a
// @RUN_TASK: 1
...
// @STANDALONE_EVENT_16: op=0x161 vars=object,string
// @STANDALONE_EVENT_43: op=0x16e vars=object,int,float,float,cvector,cvector
// @STANDALONE_EVENT_26: op=0x178 vars=string
// @STANDALONE_EVENT_6: op=0x189 vars=
// @PE: 0xd,0x18,0x8a,0x118,0x128,0x16e
...
task_1_event_41(var_0_int, var_1_object)
{
	...
	if(var_7_bool != 0) {
		...
		if(var_8_bool != 0) {
			...
			func_296(var_9_bool, var_10_object, (float)-0.30000001192092896);
...
Label_44:
	...
	if(var_13_bool != 0) {
		...
		func_291(var_14_bool, (float)0.3333333432674408);
		if(var_14_bool != 0) {
			var_12_bool = 1;
		}
	}
