...
// @PE: 0x4a,0x84,0x9a,0x100,0x131,0x150,0x17a,0x191,0x2be

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object, var_12_bool, var_13_bool)
{
	if((int)1 != 0) {
		func_643();
		var_17_bool = var_13_bool == (int)31278;
		if(var_17_bool != 0) {
		...
		var_27_bool = var_12_bool == (int)31277;
		if(var_27_bool != 0) {
			var_28_string = "";
			func_132(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)529830);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)530225, (int)31614, (int)31613);
			@@@var_0_object:AddReply((int)530227, (int)31616, (int)31615);
			return 0;
		}
		var_53_bool = var_12_bool == (int)31616;
		if(var_53_bool != 0) {
			var_54_string = "";
			func_132(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)530228);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)530229, (int)31614, (int)31617);
			@@@var_0_object:AddReply((int)530230, (int)-1, (int)31618);
			return 0;
		}
		var_63_bool = var_12_bool == (int)31614;
		if(var_63_bool != 0) {
			var_64_string = "";
			func_132(var_13_bool, "Neutral");
			@@@var_0_object:SetMessage((int)530226);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)529831, (int)-1, (int)31278);
			@@@var_0_object:AddReply((int)529832, (int)-1, (int)31279);
			return 0;
		}
		var_3_string = true;
		var_72_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_bool, var_11_bool, var_12_int)
{
	...
	if(var_14_bool != 0) {
		...
		if(var_15_bool != 0) {
			...
			if(var_36_object == 0) goto Label_400;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_16_int, var_17_object)
{
	...
	func_514(var_27_bool, var_28_object, (float)70.0);
...
func_514(var_27_bool, var_28_object, var_29_float)
{
	...
	if(var_70_bool != 0) {
		...
		if(var_72_bool == 0) goto Label_577;
...
Label_269:
	...
	func_336(var_13_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
	var_6_int = false;
	goto Label_269;
}
EMIT "Return(); Pop(4)";
...
Label_429:
	...
	if(var_59_bool != 0) {
		...
		if(var_65_bool != 0) {
			...
			if(var_66_int == 0) goto Label_462;
			...
			if(var_70_bool != 0) {
				...
				if(var_80_int == 0) goto Label_480;
				goto Label_491;
		}
		Label_480:
			var_71_bool = 0;
...
func_583()
{
	...
	if(var_142_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_600;
		UnlookAsync("head");
	}
Label_600:
	return 2;
...
func_336(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_21_float, var_22_float)
{
	var_23_bool = 0;
...
func_363(var_0_object, var_1_object, var_4_bool, var_15_bool)
{
	...
	func_501(var_19_float, var_20_object);
