...
maintask task_2
{
	...
	{
		func_267(var_11_bool, (float)300, (float)100);
	}
	...
	{
		func_401(var_11_bool, var_12_object);
	...
	{
		if(var_6_int != 0)
			func_401(var_10_bool, var_11_bool);
	...
	void OnTimer(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, bool var_7_bool, bool var_8_bool, object var_9_object, bool var_10_bool, bool var_11_bool, int var_12_int)
	{
		if(var_12_int == 10) {
			bool var_15_bool;
			func_363(var_10_bool, var_11_bool, var_12_int, var_15_bool);
			if(var_15_bool != 0) {
				if(!var_2_object) { //@nz
					func_632(var_4_bool);
					var_2_object = true;
...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_514(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_514(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_656(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_577;
...
void func_650(object var_19_object)
{
...
void func_267(int var_6_int, float var_12_float, float var_13_float)
{
	...
	for(;;) {
		...
		func_336(var_22_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
		var_6_int = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_656(cvector var_54_cvector, cvector var_55_cvector)
{
...
// @pe
void func_401(object var_2_object, string var_3_string)
{
	func_496();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_666(bool var_20_bool, string var_21_string, string var_22_string)
{
...
void func_285(int var_5_int)
{
	var_5_int = true;
	bool var_15_bool = false;
	bool var_16_bool;
	func_509(var_16_bool);
	if(!var_16_bool) { //@nz
		bool var_20_bool;
		func_334(var_20_bool);
		if(var_20_bool != 0)
			var_15_bool = true;
	}
	if(var_15_bool != 0) {
		object var_21_object;
		func_650(var_21_object);
...
void func_415(void)
{
	...
	for(;;) {
		...
		if(var_59_bool != 0) {
			@irand(var_39_int, 3);
			if(var_39_int == 0) {
				if(var_37_int == 0) goto Label_462;
				@irand(var_40_int, var_37_int);
				string var_68_string; int var_69_int;
				var_40_int = var_69_int;
				func_678(var_68_string, var_69_int);
			...
			if(var_39_int == 1) {
				...
				goto Label_491;
					...
					if(var_72_bool == 0) goto Label_486;
			}
		}
	Label_491:
		for(;;) {
...
void func_678(string var_52_string, int var_53_int)
{
...
{
	bool var_20_bool;
	func_666(var_20_bool, "quest_k4_01", "cutscene");
}


void func_709(int var_79_int)
{
	int var_81_int;
...
void func_583(void)
{
	...
	if(var_142_bool != 0) {
		...
		if(var_140_bool == 0) goto Label_600;
		@UnlookAsync("head");
	}
Label_600:
...
void func_334(bool var_18_bool)
{
	var_18_bool = true;
}
...
// @pe
void func_336(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_21_float, float var_22_float)
{
	bool var_23_bool;
...
void func_726(int var_76_int)
{
	var_76_int = 529826;
}


void func_728(int var_75_int)
{
	var_75_int = 529825;
}


void func_601(string var_121_string)
{
...
void func_730(string var_77_string)
{
	var_77_string = "ui/NPC_Citizen1.png";
}


void func_732(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen1_b.png";
}


void func_734(bool var_70_bool)
{
	var_70_bool = false;
}


void func_617(string var_99_string, bool var_100_bool)
{
...
void func_363(object var_0_object, object var_1_object, bool var_4_bool, bool var_15_bool)
{
	if(var_4_bool == null)
		var_15_bool = false;
	float var_19_float;
	func_501(var_19_float, var_4_bool);
...
void func_494(bool var_71_bool)
{
	var_71_bool = true;
}
...
void func_501(float var_19_float, object var_20_object)
{
...
void func_632(object var_29_object)
{
	float var_32_float;
...
void func_509(bool var_23_bool)
{
	bool var_25_bool;
