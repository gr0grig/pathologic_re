...
task_1_event_1(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_bool, var_7_float, var_8_int, var_9_object, var_10_object, var_11_bool, var_12_object, var_13_bool, var_14_object, var_15_bool, var_16_object, var_17_bool, var_18_bool, var_19_bool, var_20_bool)
{
	...
	if(var_21_bool != 0) {
		...
		func_3460(var_28_bool, var_29_object);
	}
	return 0;
}
...
task_3_event_17(var_0_cvector, var_1_cvector, var_2_object, var_3_int, var_4_int, var_5_bool, var_6_bool, var_7_float, var_8_int, var_9_object, var_10_bool, var_11_object, var_12_bool, var_13_object, var_14_bool, var_15_object, var_16_bool, var_17_object, var_18_bool, var_19_bool, var_20_bool)
{
	...
	var_22_bool = 0; var_23_object = Obj();
	var_20_bool = var_23_object;
	func_3460(var_22_bool, var_23_object);
	return 0;
}
				...
				if(var_977_bool != 0) {
					...
					if(var_980_bool != 0) {
						...
						if(var_988_bool != 0) {
							...
							func_3360(var_989_bool, (int)3);
						} else {
							var_991_bool = 0; var_992_float = 0;
							func_3097(var_991_bool, (float)0.5);
						...
						if(var_1007_bool != 0) {
							...
							func_3097(var_1021_bool, (float)0.5);
...
{
	var_760_string = "pt_k5q03_center";
	return 0;
}
...
func_3588()
{
	...
	func_3007("gold_ring", (int)1, (int)2, (int)2);
	var_63_string = ""; var_64_int = 0; var_65_int = 0; var_66_int = 0;
	func_3007("silver_ring", (int)1, (int)2, (int)3);
	var_67_string = ""; var_68_int = 0; var_69_int = 0; var_70_int = 0;
	func_3007("beads", (int)1, (int)2, (int)3);
	var_71_string = ""; var_72_int = 0; var_73_int = 0; var_74_int = 0;
	func_3007("bracelet", (int)1, (int)2, (int)2);
	return 0;
}
...
func_1058(var_0_cvector, var_412_bool)
{
	...
	func_2830(var_424_bool, var_425_object);
	...
	if(var_46_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_58_bool != 0) {
				...
				func_3460(var_59_bool, var_60_object);
				if(var_59_bool != 0) {
					var_22_bool = 1;
					return 16;
				}
		...
		if(var_68_bool == 0) goto Label_3256;
		...
		if(var_70_bool != 0) {
			...
			func_3460(var_71_bool, var_72_object);
			if(var_71_bool != 0) {
				var_22_bool = 1;
				return 16;
			}
		...
		if(var_74_bool == 0) goto Label_3256;
		var_75_bool = 0; var_76_object = Obj();
		var_23_object = var_76_object;
		func_3424(var_75_bool, var_76_object);
		if(var_75_bool == 0) goto Label_3256;
		var_22_bool = 1;
		return 16;
	}
Label_3256:
...
func_2716(var_511_float, var_512_object, var_513_float, var_514_int)
{
	...
	func_3079(var_549_float, var_550_float, (float)1);
	...
	func_3086(var_559_float, var_560_float, (float)0, (float)1);
...
func_3258(var_21_bool, var_22_object)
{
	...
	if(var_51_bool != 0) {
		...
		func_3460(var_55_bool, var_56_object);
...
func_1767(var_710_bool, var_711_object)
{
	...
	func_2830(var_712_bool, var_713_object);
...
Label_1847:
	...
	if(var_868_bool != 0) {
		...
		if(var_874_bool != 0) {
			...
			func_3133(var_877_string, var_878_int);
...
func_836(var_0_cvector, var_1_cvector, var_462_bool, var_463_float)
{
	...
	func_2830(var_493_bool, var_494_object);
	...
	if(var_582_bool != 0) {
		...
		func_2830(var_587_bool, var_588_object);
	...
	Label_919:
		...
		if(var_598_bool != 0) {
			...
			func_2830(var_615_bool, var_616_object);
...
func_2520(var_76_object)
{
	var_77_cvector = CVector(0,0,0); var_78_cvector = CVector(0,0,0); var_79_cvector = CVector(0,0,0); var_80_cvector = CVector(0,0,0); var_81_string = ""; var_82_object = Obj(); var_83_bool = 0; var_84_bool = 0; var_85_float = 0; var_86_cvector = CVector(0,0,0); var_87_cvector = CVector(0,0,0); var_88_cvector = CVector(0,0,0); var_89_cvector = CVector(0,0,0); var_90_cvector = CVector(0,0,0); var_91_string = ""; var_92_object = Obj(); var_93_bool = 0; var_94_bool = 0; var_95_float = 0; var_96_cvector = CVector(0,0,0);
	var_97_bool = var_76_object == 0; //@ne
	if(var_97_bool != 0) {
		var_98_string = "";
		func_2611("fdie");
	} else {
		@@var_76_object:GetPosition(var_87_cvector);
		GetPosition(var_88_cvector);
		GetDirection(var_89_cvector);
		var_90_cvector = var_88_cvector - var_87_cvector;
		var_130_float = GetByIndex(var_90_cvector, 0);
		var_131_float = GetByIndex(var_89_cvector, 0);
		var_132_float = var_130_float * var_131_float;
		var_133_float = GetByIndex(var_90_cvector, 2);
		var_134_float = GetByIndex(var_89_cvector, 2);
		var_135_float = var_133_float * var_134_float;
		var_136_int = var_132_float + var_135_float;
		var_138_bool = var_136_int >= (int)0;
		if(var_138_bool != 0) {
			var_91_string = "fdie";
		} else {
				var_91_string = "bdie";
		...
		var_141_bool = IsFuncExist(var_76_object, "GetScriptProperty", (int)2);
		if(var_141_bool != 0) {
			@@var_76_object:HasScriptProperty(var_93_bool, "Owner");
			var_143_bool = var_93_bool;
			if(var_143_bool != 0) {
				@@var_76_object:GetScriptProperty(var_92_object, "Owner");
				var_145_bool = var_92_object == 0; //@ne
				if(var_145_bool != 0) {
					var_76_object = var_92_object;
				}
			}
		}
		var_148_bool = IsFuncExist(var_92_object, "@GetEyesHeight", (int)1);
		if(var_148_bool != 0) {
			@@var_92_object:GetEyesHeight(var_95_float);
			var_96_cvector = CVector(0.0, 0.0, 0.0);
			var_149_float = GetByIndex(var_96_cvector, 1);
			var_95_float = var_149_float;
			SetByIndex(var_96_cvector, 1) = var_149_float;
			LookAsync(var_76_object, "head", var_96_cvector);
			var_94_bool = 1;
		} else {
			var_94_bool = 0;
		...
		var_151_string = "";
		var_91_string = var_151_string;
		func_3022(var_151_string);
		PlayAnimation("all", var_91_string);
		WaitForAnimEnd();
		var_153_bool = var_94_bool;
		if(var_153_bool != 0) {
			StopAsync();
			UnlookAsync("head");
		}
		LockAnimationEnd("all", var_91_string);
		RemoveEnvelope();
		var_92_object = 0;
	}
	return 20;
...
func_1519(var_674_object, var_675_float)
{
	...
	func_2830(var_680_bool, var_681_object);
	var_682_bool = var_680_bool == 0; //@nz
	if(var_682_bool != 0) {
		var_683_bool = 0; var_684_int = 0;
		func_3360(var_683_bool, (int)2);
		return 0;
	}
...
Label_1010:
	...
	if(var_409_bool != 0) {
		...
		func_2830(var_456_bool, var_457_object);
			...
			if(var_318_bool != 0) {
				...
				if(var_327_bool != 0) {
					...
					if(var_340_bool != 0) {
						...
						func_2830(var_353_bool, var_354_object);
					...
					if(var_357_bool != 0) {
						...
						func_2830(var_628_bool, var_629_object);
