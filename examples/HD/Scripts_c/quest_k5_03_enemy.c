				...
				if(2 == var_959_int) {
					...
					if(2 == var_976_int) {
						...
						if(2 == var_979_int) {
							...
							if(!var_981_bool) { //@nz
								bool var_989_bool;
								func_3360(var_989_bool, 3);
							} else {
								bool var_991_bool;
								func_3097(var_991_bool, 0.5);
...
void func_3584(string var_760_string)
{
	var_760_string = "pt_k5q03_center";
}


void func_3586(int var_987_int)
{
	var_987_int = 3;
}
...
void func_3588(void)
{
	func_3007("gold_ring", 1, 2, 2);
	func_3007("silver_ring", 1, 2, 3);
	func_3007("beads", 1, 2, 3);
	func_3007("bracelet", 1, 2, 2);
}


// @pe
void func_3079(float var_549_float, float var_550_float, float var_551_float)
{
...
// @pe
void func_3086(float var_559_float, float var_560_float, float var_561_float, float var_562_float)
{
...
void func_3097(bool var_991_bool, float var_992_float)
{
	float var_994_float;
	@rand(var_994_float);
...
void func_3102(bool var_55_bool, int var_56_int, int var_57_int)
{
	int var_59_int;
...
void func_3107(float var_567_float)
{
...
// @pe
void func_2611(string var_98_string)
{
	@RemoveRTEnvelope();
	@SetDeathState();
	@Stop();
...
void func_3124(object var_216_object)
{
	bool var_218_bool;
...
void func_3133(string var_861_string, int var_862_int)
{
...
void func_3140(int var_855_int)
{
...
// @pe
void func_3163(object var_24_object)
{
	int var_25_int;
...
void func_3184(bool var_22_bool, object var_23_object, string var_24_string)
{
	...
	if(var_24_string == var_45_string) {
		...
		if(var_47_bool != 0) {
			...
			if(!(var_24_string == var_55_string)) goto Label_3227;
...
Label_3227:
	if(!(var_24_string == "player_shot")) goto Label_3256;
	...
	if(!(var_40_float < 12250000.0)) goto Label_3256;
...
void func_2716(float var_511_float, object var_512_object, float var_513_float, int var_514_int)
{
	...
	float var_549_float;
	func_3079(var_549_float, ((var_524_int + var_526_int) / 100.0), (float)1);
	float var_527_float;
	...
	float var_559_float;
	func_3086(var_559_float, (var_528_float - var_529_float), (float)0, (float)1);
...
// @pe
void func_3258(bool var_21_bool, object var_22_object)
{
...
// @pe
void func_3309(bool var_21_bool, object var_22_object)
{
	object var_24_object;
...
void func_3323(bool var_42_bool)
{
...
// @pe
void func_3360(bool var_87_bool, int var_88_int)
{
...
void func_836(cvector var_0_cvector, cvector var_1_cvector, bool var_462_bool, float var_463_float)
{
	...
	if(var_469_bool != 0) {
		...
		bool var_587_bool;
		func_2830(var_587_bool, var_0_cvector);
		...
		for(;;) {
			...
			if(!var_469_bool) { //@nz
				...
				bool var_615_bool;
				func_2830(var_615_bool, var_0_cvector);
...
// @pe
void func_3406(bool var_43_bool, object var_44_object)
{
...
// @pe
void func_3424(bool var_47_bool, object var_48_object)
{
...
// @pe
void func_3442(bool var_27_bool, object var_28_object)
{
...
// @pe
void func_3460(bool var_21_bool, object var_22_object)
{
...
void func_3478(bool var_995_bool)
{
...
// @pe
void func_3489(bool var_759_bool)
{
...
void func_3503(bool var_981_bool)
{
...
void func_3516(bool var_1008_bool)
{
...
// @pe
void func_2495(object var_75_object)
{
...
void func_3007(string var_47_string, int var_48_int, int var_49_int, int var_50_int)
{
...
void func_3022(string var_366_string)
{
	...
	if(var_388_bool == 0) goto Label_3042;
}
...
void func_2520(object var_76_object)
{
	cvector var_87_cvector; cvector var_88_cvector; cvector var_89_cvector; cvector var_90_cvector; string var_91_string; object var_92_object; bool var_93_bool; bool var_94_bool; float var_95_float; cvector var_96_cvector;
	if(var_76_object == null) {
		...
		if(((var_130_float * var_131_float) + (var_133_float * var_134_float)) >= 0)
			var_91_string = "fdie";
		else
			var_91_string = "bdie";
		@RemoveRTEnvelope();
		...
		var_141_bool = IsFuncExist(var_76_object, "GetScriptProperty", 2);
		if(var_141_bool != 0) {
		...
		var_148_bool = IsFuncExist(var_92_object, "@GetEyesHeight", 1);
		if(var_148_bool != 0) {
			var_92_object->GetEyesHeight(var_95_float);
			var_96_cvector = [0.0, 0.0, 0.0];
...
void func_3063(object var_72_object)
{
		...
		if(var_178_bool != 0) {
			...
			if(var_142_float >= (var_123_float * var_123_float)) {
				...
				if(var_357_bool != 0) {
					...
					bool var_628_bool;
					func_2830(var_628_bool, var_0_cvector);
...
void func_3578(string var_59_string)
{
	var_59_string = "pt_k5q03_patrol";
}


void func_3580(string var_55_string)
{
	var_55_string = "k5q03_helpme";
}


void func_3069(cvector var_52_cvector, cvector var_53_cvector)
{
...
void func_3582(string var_1081_string)
{
