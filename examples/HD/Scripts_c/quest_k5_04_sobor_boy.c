// @IMPORTS: Sleep/1,FindActor/2,SetTimer/2,KillTimer/1,UnlookAsync/1,WaitForAnimEnd/0,irand/2,PlayAnimation/2,WaitForAnimEnd/1,rand/2,Sleep/2,ResetAAS/0,StopAnimation/0,StopGroup0/0,GetPosition/1,IsLoaded/1,LookAsync/3,HasAnimation/3
...
task_0_event_7(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_int)
{
	...
	if(var_7_bool != 0) {
		...
		if(var_8_bool != 0) {
			...
			if(var_29_bool == 0) goto Label_79;
			UnlookAsync("head");
			var_2_bool = false;
		}
	}
...
func_42(var_0_int, var_1_int, var_4_object, var_8_bool)
{
	...
	func_180(var_12_float, var_13_object);
...
Label_108:
	...
	if(var_44_bool != 0) {
		...
		if(var_50_bool != 0) {
			...
			if(var_51_int == 0) goto Label_141;
			...
			if(var_55_bool != 0) {
				...
				if(var_65_int == 0) goto Label_159;
				goto Label_170;
		}
		Label_159:
			var_56_bool = 0;
