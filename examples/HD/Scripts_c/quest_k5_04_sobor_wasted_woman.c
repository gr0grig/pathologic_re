...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:player|W:head|A:GetPosition|A:GetEyesHeight|W:Can't find lsh animation : |W:branch|W:ui/NPC_Citizen2.png|W:ui/NPC_Citizen2_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0xc4
// @RUN_TASK: 2
...
// @PE: 0x4a,0x84,0x9a,0xce,0xd9,0x103,0x11a

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_int, var_8_int, var_9_bool, var_10_bool, var_11_object)
{
	if((int)1 != 0) {
		func_524();
		var_15_bool = var_10_bool == (int)41383;
		if(var_15_bool != 0) {
			var_16_string = "";
			func_132(var_11_object, "Neutral");
			@@@var_0_object:SetMessage((int)539452);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)540736, (int)-1, (int)42774);
			@@@var_0_object:AddReply((int)539453, (int)-1, (int)41384);
			return 0;
		}
		var_3_string = true;
		var_40_bool = 0;
...
task_2_event_7(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool, var_9_object, var_10_int)
{
	...
	if(var_12_bool != 0) {
		...
		if(var_13_bool != 0) {
			...
			if(var_34_object == 0) goto Label_281;
			UnlookAsync("head");
			var_2_object = false;
		}
	}
...
func_0(var_0_object, var_14_int, var_15_object)
{
	...
	func_395(var_25_bool, var_26_object, (float)70.0);
...
func_395(var_25_bool, var_26_object, var_27_float)
{
	...
	if(var_68_bool != 0) {
		...
		if(var_70_bool == 0) goto Label_458;
...
func_464()
{
	...
	if(var_140_bool != 0) {
		...
		if(var_142_bool == 0) goto Label_481;
		UnlookAsync("head");
	}
Label_481:
	return 2;
...
func_217(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_11_float, var_12_float)
{
	var_13_bool = 0;
	func_390(var_13_bool);
...
Label_310:
	...
	if(var_49_bool != 0) {
		...
		if(var_55_bool != 0) {
			...
			if(var_56_int == 0) goto Label_343;
			...
			if(var_60_bool != 0) {
				...
				if(var_70_int == 0) goto Label_361;
				goto Label_372;
		}
		Label_361:
			var_61_bool = 0;
...
func_244(var_0_object, var_1_object, var_4_bool, var_13_bool)
{
	...
	func_382(var_17_float, var_18_object);
