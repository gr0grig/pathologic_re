// @IMPORTS: rand/2,Sleep/2,RemoveActor/1,FindActor/2,SetTimer/2,KillTimer/1,UnlookAsync/1,WaitForAnimEnd/0,irand/2,PlayAnimation/2,WaitForAnimEnd/1,ResetAAS/0,StopAnimation/0,StopGroup0/0,GetPosition/1,IsLoaded/1,LookAsync/3,self/1,HasAnimation/3
...
task_0_event_7(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_5_bool, var_6_bool, var_7_int)
{
	...
	if(var_9_bool != 0) {
		...
		if(var_10_bool != 0) {
			...
			if(var_31_bool == 0) goto Label_139;
			UnlookAsync("head");
			var_2_bool = false;
		}
	}
...
func_102(var_0_int, var_1_int, var_4_object, var_10_bool)
{
	...
	func_240(var_14_float, var_15_object);
...
Label_8:
	...
	func_75(var_8_float, var_9_float, var_10_bool, var_11_float, var_12_bool, var_16_float, var_17_float);
	var_6_bool = false;
	goto Label_8;
}
EMIT "Return(); Pop(4)";
...
func_75(var_0_int, var_1_int, var_2_bool, var_3_bool, var_4_object, var_16_float, var_17_float)
{
	var_18_bool = 0;
...
Label_168:
	...
	if(var_54_bool != 0) {
		...
		if(var_60_bool != 0) {
			...
			if(var_61_int == 0) goto Label_201;
			...
			if(var_65_bool != 0) {
				...
				if(var_75_int == 0) goto Label_219;
				goto Label_230;
		}
		Label_219:
			var_66_bool = 0;
