...
maintask task_0
{
	...
	{
		func_6(var_6_bool, (float)300, (float)100);
	}
	...
	{
		if(var_6_bool != 0)
			func_140(var_5_bool, var_6_bool);
	...
	void OnTimer(int iID, int var_1_int, bool var_2_bool, bool var_3_bool, object var_4_object, bool var_5_bool, bool var_6_bool, int var_7_int)
	{
		if(var_7_int == 10) {
			bool var_10_bool;
			func_102(var_5_bool, var_6_bool, var_7_int, var_10_bool);
			if(var_10_bool != 0) {
				if(!var_2_bool) { //@nz
					func_253(var_4_object);
					var_2_bool = true;
				}
...
void func_102(int var_0_int, int var_1_int, object var_4_object, bool var_10_bool)
{
	if(var_4_object == null)
		var_10_bool = false;
	float var_14_float;
	func_240(var_14_float, var_4_object);
...
void func_6(bool var_6_bool, float var_7_float, float var_8_float)
{
	...
	for(;;) {
		...
		func_75(var_17_float, var_9_float, var_10_bool, var_11_float, var_12_bool, var_16_float, var_17_float);
		var_6_bool = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_264(object var_14_object)
{
...
void func_73(bool var_13_bool)
{
	var_13_bool = true;
}


void func_233(bool var_66_bool)
{
	var_66_bool = true;
}
...
// @pe
void func_75(int var_0_int, int var_1_int, bool var_2_bool, bool var_3_bool, object var_4_object, float var_16_float, float var_17_float)
{
	bool var_18_bool;
...
// @pe
void func_140(bool var_2_bool, bool var_3_bool)
{
	func_235();
	@KillTimer(10);
	if(var_2_bool != 0) {
...
void func_270(string var_47_string, int var_48_int)
{
...
void func_240(float var_14_float, object var_15_object)
{
...
void func_248(bool var_18_bool)
{
	bool var_20_bool;
...
void func_24(bool var_5_bool)
{
	var_5_bool = true;
	bool var_10_bool = false;
	bool var_11_bool;
	func_248(var_11_bool);
	if(!var_11_bool) { //@nz
		bool var_15_bool;
		func_73(var_15_bool);
		if(var_15_bool != 0)
		...
		if(var_54_bool != 0) {
			...
			if(var_34_int == 1) {
				...
				goto Label_230;
					...
					if(var_67_bool == 0) goto Label_225;
			}
		}
	Label_230:
		for(;;) {
...
void func_253(object var_24_object)
{
	float var_27_float;
