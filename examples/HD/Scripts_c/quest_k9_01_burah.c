...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:Smile|W:Agression|W:Sorrow|W:Doubt|W:cleanup|W:restore|W:player|A:GetPosition|A:GetEyesHeight|W:head|W:voice_common|W:c|A:HasProperty|A:GetProperty|W:m|W:Can't find lsh animation : |W:ook9BurahTermitnik2_1|W:k9q01BurahTalk|W:k9q01DankoTalk|W:k9q01|W:Can't retrieve diary root|A:Find|W:Can't find diary parent with id: |A:AddChild|A:GetCategory|W:branch|W:ui/NPC_Burah.png|W:ui/NPC_Burah_b.png
// @GLOBALS: 0:object:
// @RUN_OP: 0x1c1
// @RUN_TASK: 2
...
// @PE: 0x51,0x99,0xaf,0x1b9,0x1c1,0x1e6,0x22f,0x255,0x271,0x452,0x458,0x45e,0x479,0x485

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_cvector, var_8_bool)
{
	if((int)1 != 0) {
		func_1045();
		var_12_bool = var_8_bool == (int)27767;
		if(var_12_bool != 0) {
		...
		var_60_bool = var_7_cvector == (int)27765;
		if(var_60_bool != 0) {
			var_61_string = "";
			func_153(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)526499);
			@@@var_0_object:ClearReplies();
			var_79_bool = 0;
			var_79_bool = 0;
			var_80_bool = 0; var_81_object = Obj();
			var_81_object = var_1_object;
			func_1145(var_81_object);
			if(var_80_bool != 0) {
				var_86_bool = 0; var_87_object = Obj();
				var_87_object = var_1_object;
				func_1157(var_87_object);
				if(var_86_bool != 0) {
					var_79_bool = 1;
				}
			}
			if(var_79_bool != 0) {
				@@@var_0_object:AddReply((int)526501, (int)27768, (int)27767);
			}
			@@@var_0_object:AddReply((int)526500, (int)-1, (int)27766);
			return 0;
		}
		var_99_bool = var_7_cvector == (int)27768;
		if(var_99_bool != 0) {
			var_100_string = "";
			func_153(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)526502);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)526503, (int)30235, (int)27769);
			@@@var_0_object:AddReply((int)528825, (int)30242, (int)30241);
			return 0;
		}
		var_109_bool = var_7_cvector == (int)30242;
		if(var_109_bool != 0) {
			var_110_string = "";
			func_153(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)528826);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528827, (int)30235, (int)30243);
			return 0;
		}
		var_116_bool = var_7_cvector == (int)30235;
		if(var_116_bool != 0) {
			var_117_string = "";
			func_153(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)528819);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528820, (int)30246, (int)30236);
			@@@var_0_object:AddReply((int)528828, (int)30246, (int)30245);
			return 0;
		}
		var_126_bool = var_7_cvector == (int)30246;
		if(var_126_bool != 0) {
			var_127_string = "";
			func_153(var_8_bool, "Smile");
			@@@var_0_object:SetMessage((int)528829);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528830, (int)30248, (int)30247);
			@@@var_0_object:AddReply((int)528833, (int)30252, (int)30251);
			return 0;
		}
		var_136_bool = var_7_cvector == (int)30252;
		if(var_136_bool != 0) {
			var_137_string = "";
			func_153(var_8_bool, "Agression");
			@@@var_0_object:SetMessage((int)528834);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528835, (int)30248, (int)30253);
			return 0;
		}
		var_143_bool = var_7_cvector == (int)30248;
		if(var_143_bool != 0) {
			var_144_string = "";
			func_153(var_8_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)528831);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528832, (int)30237, (int)30249);
			@@@var_0_object:AddReply((int)542482, (int)44868, (int)44867);
			return 0;
		}
		var_153_bool = var_7_cvector == (int)30237;
		if(var_153_bool != 0) {
			var_154_string = "";
			func_153(var_8_bool, "Sorrow");
			@@@var_0_object:SetMessage((int)528821);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528822, (int)30239, (int)30238);
			return 0;
		}
		var_160_bool = var_7_cvector == (int)30239;
		if(var_160_bool != 0) {
			var_161_string = "";
			func_153(var_8_bool, "Doubt");
			@@@var_0_object:SetMessage((int)528823);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)528824, (int)-1, (int)30240);
			@@@var_0_object:AddReply((int)541115, (int)44868, (int)43231);
			return 0;
		}
		var_170_bool = var_7_cvector == (int)44868;
		if(var_170_bool != 0) {
			var_171_string = "";
			func_153(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)542483);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)542484, (int)-1, (int)44870);
			@@@var_0_object:AddReply((int)542485, (int)-1, (int)44871);
			return 0;
		}
		var_3_string = true;
		var_179_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_cvector, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_17_bool == 0) goto Label_472;
		var_1_object = false;
	}
Label_472:
	return 2;
...
func_0(var_0_object, var_26_int, var_27_object)
{
	...
	func_774(var_37_bool, var_38_object, (float)70.0);
...
func_774(var_37_bool, var_38_object, var_39_float)
{
	...
	if(var_80_bool != 0) {
		...
		if(var_82_bool == 0) goto Label_837;
...
func_1169()
{
	...
	func_1195(var_41_bool, var_42_object, (int)517);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_546()
{
	var_268_float = 0; var_269_float = 0;
	rand(var_269_float, (int)8, (int)16);
	SetTimer((int)10, var_269_float);
	return 2;
}
...
func_843()
{
	...
	if(var_262_bool != 0) {
		...
		if(var_264_bool == 0) goto Label_860;
		UnlookAsync("head");
	}
Label_860:
	return 2;
...
func_1106()
{
	SetVariable("ook9BurahTermitnik2_1", (int)1);
	return 0;
}
...
func_1112()
{
	SetVariable("k9q01BurahTalk", (int)1);
	return 0;
}
