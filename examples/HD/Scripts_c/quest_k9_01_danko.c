	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, cvector var_7_cvector, bool var_8_bool)
	{
		if(1 != 0) {
			...
			if(var_7_cvector == 27757) {
				func_158(var_8_bool, "Neutral");
				var_0_object->SetMessage(526491); //@t
				var_0_object->ClearReplies(); //@t
				bool var_79_bool = false;
				bool var_80_bool;
				func_1073(var_1_object);
				if(var_80_bool != 0) {
					bool var_86_bool;
					func_1085(var_1_object);
					if(var_86_bool != 0)
						var_79_bool = true;
				}
				if(var_79_bool != 0)
			...
			if(var_7_cvector == 27759) {
				...
				var_0_object->AddReply(541112, 30256, 43226); //@t
				return 0;
			}
			if(var_7_cvector == 30256) {
				func_158(var_8_bool, "Untrust");
				var_0_object->SetMessage(528838); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(528839, 30258, 30257); //@t
				var_0_object->AddReply(541113, 27761, 43228); //@t
				return 0;
			}
			if(var_7_cvector == 30258) {
				...
				var_0_object->AddReply(542479, 44864, 44863); //@t
				return 0;
			}
			if(var_7_cvector == 44864) {
				func_158(var_8_bool, "Untrust");
				var_0_object->SetMessage(542480); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(542481, 27761, 44865); //@t
				return 0;
			}
			if(var_7_cvector == 27761) {
				...
				var_0_object->AddReply(541114, -1, 43230); //@t
				return 0;
			}
			var_3_string = true;
			bool var_148_bool;
			func_1176(var_148_bool);
			if(var_148_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
maintask task_2
{
		...
		if(var_7_int == 10) {
			...
			if(var_11_bool != 0) {
				...
				if(var_32_bool != 0) {
					...
					func_980(var_53_object);
					var_53_object = var_52_object;
					func_847(var_51_bool, var_52_object);
				}
			} else {
				func_447(var_7_int);
				func_474();
	...
	void OnUse(object actor, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, cvector var_5_cvector, bool var_6_bool, object var_7_object)
	{
		...
		if(!var_9_bool) { //@nz
			...
			func_688(var_11_bool, var_12_object);
			enable OnUse;
...
void func_0(object var_0_object, int var_26_int, object var_27_object)
{
	...
	func_702(var_37_bool, var_38_object, 70.0);
	if(!var_37_bool) { //@nz
		var_26_int = -2;
		return 8;
	}
	...
	for(;;) {
		var_260_bool = !var_36_bool; //@nz
		if(var_260_bool == 0) goto Label_70;
		@sync();
		var_33_object->IsDialogEnd(var_36_bool);
	}
...
void func_771(void)
{
	...
	bool var_265_bool;
	func_1176(var_265_bool);
	if(var_265_bool != 0) {
	} else {
		@HasAnimationTrack(var_263_bool, "head");
		if(var_263_bool == 0) goto Label_788;
		@UnlookAsync("head");
	}
Label_788:
...
void func_1170(int var_85_int)
{
	var_85_int = 504032;
}


void func_1172(string var_87_string)
{
	var_87_string = "ui/NPC_Bakalavr.png";
}


void func_789(bool var_98_bool, object var_99_object)
{
	...
	if(var_105_int != 0) {
		...
		func_847(var_109_bool, var_110_object);
		if(!var_109_bool) { //@nz
			bool var_140_bool; object var_141_object;
			var_99_object = var_141_object;
			func_884(var_140_bool, var_141_object);
			if(!var_140_bool) { //@nz
				var_98_bool = false;
				return 4;
			}
		...
		func_884(var_185_bool, var_186_object);
		if(!var_185_bool) { //@nz
			bool var_188_bool; object var_189_object;
			var_99_object = var_189_object;
			func_847(var_188_bool, var_189_object);
			if(!var_188_bool) { //@nz
				var_98_bool = false;
				return 4;
			}
...
void func_1174(string var_88_string)
{
	var_88_string = "ui/NPC_Bakalavr_b.png";
}


void func_663(bool var_45_bool)
{
	var_45_bool = true;
}
...
void func_1046(void)
{
	...
	int var_24_int;
	func_996(var_24_int, "k9q01BurahTalk");
	if(var_24_int != 0) {
		int var_30_int;
		func_996(var_30_int, "k9q01DankoTalk");
		if(var_30_int != 0)
			var_23_bool = true;
	}
	if(var_23_bool != 0) {
...
void func_1176(bool var_80_bool)
{
	var_80_bool = true;
}
...
void func_670(float var_22_float, object var_23_object)
{
...
// @pe
void func_158(object var_2_object, string var_200_string)
{
	bool var_201_bool;
	func_1176(var_201_bool);
	if(!var_201_bool) //@nz
		return 0;
...
void func_927(string var_244_string)
{
...
void func_418(object var_0_object)
{
	bool var_7_bool;
	func_697(var_7_bool);
	if(!var_7_bool) //@nz
...
void func_678(bool var_15_bool, cvector var_16_cvector)
{
...
void func_943(string var_204_string, bool var_205_bool)
{
...
void func_688(bool var_11_bool, object var_12_object)
{
...
// @pe
void func_1073(bool var_219_bool)
{
	int var_221_int;
	func_996(var_221_int, "k9q01");
	if(var_221_int == 2)
		var_219_bool = true;
	var_219_bool = false;
}
...
void func_432(bool var_32_bool)
{
	...
	func_688(var_37_bool, var_38_object);
	var_37_bool = var_32_bool;
}
EMIT "Stack[-1] = 0";


void func_697(bool var_7_bool)
{
	bool var_9_bool;
	@IsLoaded(var_9_bool);
...
// @pe
void func_1085(bool var_227_bool)
{
	int var_229_int;
	func_996(var_229_int, "ook9DankoTermitnik2_1");
	if(var_229_int == 0) {
		var_227_bool = true;
		return 0;
	}
...
void func_702(bool var_37_bool, object var_38_object, float var_39_float)
{
	...
	func_986(var_64_cvector, (var_53_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_80_bool != 0) {
		...
		if(var_57_bool == 0) goto Label_765;
...
void func_447(object var_0_object)
{
...
void func_958(bool var_132_bool, string var_133_string)
{
	bool var_135_bool;
	bool var_136_bool;
	func_1176(var_136_bool);
	if(var_136_bool != 0) {
...
void func_452(bool var_15_bool)
{
	...
	func_670(var_22_float, var_23_object);
...
void func_1097(void)
{
	...
	func_1123(var_41_bool, var_42_object, 517);
}
EMIT "Stack[-1] = 0";
...
{
	bool var_10_bool;
	func_1176(var_10_bool);
	if(var_10_bool != 0)
		@lshStopSpeech();
}


void func_847(bool var_109_bool, object var_110_object)
{
...
void func_81(object var_0_object, object var_1_object, object var_2_object, string var_3_string, object var_193_object, object var_194_object)
{
	...
	var_3_string = false;
	if(1 != 0) {
		func_158(var_194_object, "Neutral");
		var_0_object->SetMessage(526491); //@t
		var_0_object->ClearReplies(); //@t
...
void func_594(void)
{
	...
	for(;;) {
		...
		if(var_38_bool != 0) {
			...
			func_1010(var_52_string, var_53_int);
			@PlayAnimation("all", var_52_string);
			@WaitForAnimEnd(var_22_bool);
			var_54_bool = !var_22_bool; //@nz
			if(var_54_bool == 0) goto Label_649;
			goto Label_660;
			}
				Label_649:
					bool var_45_bool;
					...
					if(var_46_bool == 0) goto Label_655;
			}
		}
	Label_660:
		for(;;) {
...
void func_980(object var_100_object)
{
...
void func_1110(object var_50_object)
{
...
{
	float var_272_float;
	@rand(var_272_float, 8, 16);
	@SetTimer(10, var_272_float);
}


void func_986(cvector var_64_cvector, cvector var_65_cvector)
{
...
void func_996(int var_221_int, string var_222_string)
{
	int var_224_int;
...
void func_1123(bool var_41_bool, object var_42_object, int var_43_int)
{
...
void func_1001(int var_153_int)
{
	float var_155_float;
...
// @pe
void func_369(object var_25_object)
{
...
void func_1010(string var_31_string, int var_32_int)
{
...
void func_884(bool var_140_bool, object var_141_object)
{
	...
	for(;;) {
		...
		func_958(var_172_bool, var_173_string);
