...
task task_1
{
	...
	void event_11(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, int var_5_int, int var_6_int, int var_7_int, int var_8_int, bool var_9_bool, bool var_10_bool, object var_11_object, bool var_12_bool, bool var_13_bool)
	{
		if(1 != 0) {
			func_749();
			if(var_12_bool == 31248) {
				bool var_18_bool;
				func_803(var_1_object);
				if(var_18_bool != 0) {
...
void func_0(object var_0_object, int var_16_int, object var_17_object)
{
	...
	func_620(var_27_bool, var_28_object, 70.0);
	if(!var_27_bool) { //@nz
		var_16_int = -2;
		return 8;
	}
...
void func_896(string var_52_string, int var_53_int)
{
...
void func_772(int var_97_int, string var_98_string)
{
	int var_100_int;
...
void func_521(void)
{
	...
	for(;;) {
		...
		if(var_59_bool != 0) {
			@irand(var_39_int, 3);
			if(var_39_int == 0) {
				if(var_37_int == 0) goto Label_568;
...
void func_894(bool var_70_bool)
{
	var_70_bool = false;
}
...
// @pe
void func_162(object var_2_object, string var_140_string)
{
	bool var_141_bool;
...
// @pe
void func_803(bool var_95_bool)
{
	int var_97_int;
...
void func_815(void)
{
	...
	func_841(var_122_bool, var_123_object, 517);
}
EMIT "Stack[-1] = 0";
...
void func_689(void)
{
	...
	if(var_192_bool != 0) {
		...
		if(var_190_bool == 0) goto Label_706;
		@UnlookAsync("head");
	}
Label_706:
...
void func_440(bool var_18_bool)
{
	var_18_bool = true;
}
...
// @pe
void func_442(object var_0_object, object var_1_object, object var_2_object, string var_3_string, bool var_4_bool, float var_21_float, float var_22_float)
{
	bool var_23_bool;
...
void func_828(object var_131_object)
{
...
void func_707(string var_163_string)
{
	bool var_167_bool; float var_168_float; float var_169_float;
	@lshHasAnimation(var_167_bool, var_163_string);
	if(var_167_bool != 0) {
		@lshGetAnimTimes(var_163_string, var_168_float, var_169_float);
		@lshPlayAnimation(var_168_float, var_169_float, false);
	} else {
		@Trace("Can't find lsh animation : " + var_163_string);
	}
	
}


void func_841(bool var_122_bool, object var_123_object, int var_124_int)
{
...
void func_723(string var_144_string, bool var_145_bool)
{
...
void func_469(object var_0_object, object var_1_object, bool var_4_bool, bool var_15_bool)
{
	if(var_4_bool == null)
		var_15_bool = false;
	float var_19_float;
	func_607(var_19_float, var_4_bool);
...
void func_600(bool var_71_bool)
{
	var_71_bool = true;
}
...
void func_607(float var_19_float, object var_20_object)
{
...
void func_738(object var_29_object)
{
	float var_32_float;
...
void func_615(bool var_23_bool)
{
	bool var_25_bool;
...
void func_620(bool var_27_bool, object var_28_object, float var_29_float)
{
	...
	func_762(var_54_cvector, (var_43_cvector ^ [0.0, 1.0, 0.0]));
	...
	if(var_70_bool != 0) {
		...
		if(var_47_bool == 0) goto Label_683;
...
void func_756(object var_19_object)
{
	object var_21_object;
	@self(var_21_object);
...
void func_373(int var_6_int, float var_12_float, float var_13_float)
{
	...
	for(;;) {
		...
		func_442(var_22_float, var_14_float, var_15_bool, var_16_float, var_17_bool, var_21_float, var_22_float);
		var_6_int = false;
	}
}
EMIT "Return(); Pop(4)";
...
void func_886(int var_76_int)
{
	var_76_int = 515560;
}


void func_888(int var_75_int)
{
	var_75_int = 503345;
}


void func_762(cvector var_54_cvector, cvector var_55_cvector)
{
...
// @pe
void func_507(object var_2_object, string var_3_string)
{
	func_602();
	@KillTimer(10);
	if(var_2_object != 0) {
...
void func_892(string var_78_string)
{
	var_78_string = "ui/NPC_Citizen3_b.png";
}


void func_890(string var_77_string)
{
