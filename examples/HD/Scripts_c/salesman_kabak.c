...
void func_0(bool var_0_bool)
{
	...
	for(;;) {
		...
		if(var_135_bool == 0) goto Label_15;
		func_361("Neutral");
		@lshWaitForAnimEnd();
		break;
	Label_24:
...
void func_388(object var_59_object, string var_60_string, int var_61_int, int var_62_int)
{
	bool var_64_bool;
	int var_66_int;
...
void func_516(string var_46_string, int var_47_int)
{
...
void func_399(object var_37_object, string var_38_string, int var_39_int, int var_40_int, int var_41_int)
{
...
void func_540(bool var_135_bool)
{
	var_135_bool = false;
}


void func_414(object var_33_object)
{
...
void func_420(bool var_46_bool, int var_47_int, int var_48_int)
{
	int var_50_int;
...
// @pe
void func_434(bool var_30_bool, object var_31_object)
{
	object var_37_object;
	var_31_object = var_37_object;
	func_399(var_37_object, "coffee", 1, 1, 2);
	object var_54_object;
	var_31_object = var_54_object;
	func_399(var_54_object, "tvirin", 1, 1, 2);
	object var_59_object;
	var_31_object = var_59_object;
	func_388(var_59_object, "silver_ring", 1, 2);
	object var_69_object;
	var_31_object = var_69_object;
	func_388(var_69_object, "gold_ring", 1, 2);
	object var_73_object;
	var_31_object = var_73_object;
	func_388(var_73_object, "bracelet", 1, 2);
	object var_77_object;
	var_31_object = var_77_object;
	func_388(var_77_object, "watch", 1, 2);
	object var_81_object;
	var_31_object = var_81_object;
	func_388(var_81_object, "beads", 1, 2);
	object var_85_object;
	var_31_object = var_85_object;
	func_388(var_85_object, "ear_ring", 1, 2);
	object var_89_object;
	var_31_object = var_89_object;
	func_388(var_89_object, "flower", 1, 2);
	object var_93_object;
	var_31_object = var_93_object;
	func_388(var_93_object, "hook", 1, 4);
	object var_97_object;
	var_31_object = var_97_object;
	func_388(var_97_object, "morfin", 1, 4);
	var_30_bool = true;
}
...
void func_308(bool var_103_bool, object var_104_object, float var_105_float)
{
	...
	if(var_121_bool != 0)
		var_103_bool = false;
	@StopWorld();
	@CameraTransit((var_116_cvector + var_119_cvector), var_118_cvector, true);
...
void func_361(string var_136_string)
{
...
void func_377(object var_29_object)
{
	float var_32_float;
