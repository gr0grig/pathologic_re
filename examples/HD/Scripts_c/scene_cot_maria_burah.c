...
// @STRINGS: W:pt_maria|W:NPC_Maria|W:NPC_Burah_Maria.xml|W:nomaria|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_maria", "NPC_Maria", "NPC_Burah_Maria.xml");
...
{
	var_4_bool = var_2_string == "nomaria";
	if(var_4_bool != 0) {
		var_0_bool = false;
	} else {
		var_6_bool = var_2_string == "maria";
