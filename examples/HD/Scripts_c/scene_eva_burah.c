...
// @STRINGS: W:pt_Danko|W:NPC_Bakalavr|W:NPC_Burah_Danko.xml|W:pt_eva|W:NPC_Eva|W:NPC_Burah_Eva.xml|W:nodanko|W:noeva|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
