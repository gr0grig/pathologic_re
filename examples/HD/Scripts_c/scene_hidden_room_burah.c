...
// @STRINGS: W:quest_b12_01|W:hidden_room_load|W:hidden_room_unload
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5()
{
	...
	func_16(var_0_bool, "quest_b12_01", "hidden_room_load");
	return 0;
}
...
{
	var_0_bool = 0; var_1_string = ""; var_2_string = "";
	func_16(var_0_bool, "quest_b12_01", "hidden_room_unload");
	return 0;
}
