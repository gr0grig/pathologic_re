...
// @STRINGS: W:pt_kapella|W:NPC_Kapella|W:NPC_Klara_Kapella.xml|W:nokapella|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_kapella", "NPC_Kapella", "NPC_Klara_Kapella.xml");
...
{
	var_4_bool = var_2_string == "nokapella";
	if(var_4_bool != 0) {
		var_0_bool = false;
	} else {
		var_6_bool = var_2_string == "kapella";
