...
// @STRINGS: W:pt_spi4ka|W:NPC_Spi4ka|W:NPC_Klara_Spi4ka.xml|W:nospi4ka|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_spi4ka", "NPC_Spi4ka", "NPC_Klara_Spi4ka.xml");
