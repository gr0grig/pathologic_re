...
// @STRINGS: A:size|A:resize|W:inited|W:day|A:SetProperty|A:get|W:strActorName: |W:strXMLName: |W:pt_k2s_svita|W:setting property|W:index|W:property set|A:set|W:dead|A:HasProperty|A:GetLocator|W:Locator |W: doesn't exist|W:pt_k2s_npc|W:NPC_Bakalavr|W:k2system_danko.xml|W:pers_wasted_male|A:add|W:k2system_wasted_male.xml|W:pers_patrool|W:k2system_patrol.xml
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
func_166(var_31_object, var_32_object)
{
	...
	func_139(var_36_object, var_37_object, "pt_k2s_npc", "NPC_Bakalavr", "k2system_danko.xml");
...
func_176(var_15_object, var_16_object, var_17_object)
{
	@@var_15_object:add("pers_wasted_male");
	@@var_16_object:add("k2system_wasted_male.xml");
	@@var_17_object:add((bool)0);
	@@var_15_object:add("pers_wasted_male");
	@@var_16_object:add("k2system_wasted_male.xml");
	@@var_17_object:add((bool)0);
	@@var_15_object:add("pers_patrool");
	@@var_16_object:add("k2system_patrol.xml");
	@@var_17_object:add((bool)0);
	return 0;
}
