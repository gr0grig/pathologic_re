...
// @STRINGS: W:pt_han|W:NPC_Han|W:NPC_Danko_Han.xml|W:nohan|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_object, var_1_bool)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_han", "NPC_Han", "NPC_Danko_Han.xml");
