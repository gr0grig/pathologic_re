...
// @STRINGS: W:pt_han|W:NPC_Han|W:NPC_Klara_Han.xml|W:nohan|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_object, var_1_bool)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_han", "NPC_Han", "NPC_Klara_Han.xml");
...
{
	var_4_bool = var_2_string == "nohan";
	if(var_4_bool != 0) {
		var_1_bool = false;
	} else {
		var_6_bool = var_2_string == "han";
