...
// @STRINGS: W:sobor_aglaja|W:pt_Aglaja|W:NPC_Aglaja|W:NPC_Burah_Aglaja.xml|W:pt_sobor_mask1|W:pers_whitemask|W:sobor_whitemask.xml|W:pt_sobor_mask2|W:quest_b12_01|W:sobor_load|W:sobor_unload|W:noaglaja|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_object, var_1_object, var_2_object)
{
	...
	if(var_6_int != 0) {
		...
		func_90(var_7_object, var_8_object, "pt_Aglaja", "NPC_Aglaja", "NPC_Burah_Aglaja.xml");
	...
	func_108(var_40_bool, "quest_b12_01", "sobor_load");
	return 2;
}
...
task_0_event_6(var_0_object, var_1_object, var_2_object)
{
	...
	func_108(var_6_bool, "quest_b12_01", "sobor_unload");
	return 0;
}
