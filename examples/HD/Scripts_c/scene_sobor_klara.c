...
// @STRINGS: W:sobor_aglaja|W:pt_Aglaja|W:NPC_Aglaja|W:NPC_Klara_Aglaja.xml|W:pt_sobor_mask1|W:pers_whitemask|W:sobor_whitemask.xml|W:pt_sobor_mask2|W:quest_k12_01|W:sobor_load|W:quest_k5_04|W:quest_k7_01|W:sobor_unload|W:noaglaja|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_object, var_1_object, var_2_object)
{
	...
	if(var_6_int != 0) {
		...
		func_105(var_7_object, var_8_object, "pt_Aglaja", "NPC_Aglaja", "NPC_Klara_Aglaja.xml");
		...
		func_105(var_28_object, var_29_object, "pt_sobor_mask1", "pers_whitemask", "sobor_whitemask.xml");
		...
		func_105(var_34_object, var_35_object, "pt_sobor_mask2", "pers_whitemask", "sobor_whitemask.xml");
		var_2_object = var_34_object;
	}
	var_40_bool = 0; var_41_string = ""; var_42_string = "";
	func_123(var_40_bool, "quest_k12_01", "sobor_load");
	var_46_bool = 0; var_47_string = ""; var_48_string = "";
	func_123(var_46_bool, "quest_k5_04", "sobor_load");
	var_49_bool = 0; var_50_string = ""; var_51_string = "";
	func_123(var_49_bool, "quest_k7_01", "sobor_load");
	return 2;
}
...
task_0_event_6(var_0_object, var_1_object, var_2_object)
{
	...
	func_123(var_6_bool, "quest_k12_01", "sobor_unload");
	var_12_bool = 0; var_13_string = ""; var_14_string = "";
	func_123(var_12_bool, "quest_k5_04", "sobor_unload");
	return 0;
}
