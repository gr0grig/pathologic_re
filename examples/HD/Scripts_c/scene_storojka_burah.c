...
// @STRINGS: W:pt_laska|W:NPC_Laska|W:NPC_Burah_Laska.xml|W:quest_b11_01|W:storojka_unload|W:nolaska|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_46(var_3_object, var_4_object, "pt_laska", "NPC_Laska", "NPC_Burah_Laska.xml");
...
task_0_event_6(var_0_bool, var_1_object)
{
	...
	func_64(var_3_bool, "quest_b11_01", "storojka_unload");
	return 0;
}
...
{
	var_4_bool = var_2_string == "nolaska";
	if(var_4_bool != 0) {
		var_0_bool = false;
	} else {
		var_6_bool = var_2_string == "laska";
