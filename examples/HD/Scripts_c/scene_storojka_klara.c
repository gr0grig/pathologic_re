...
// @STRINGS: W:pt_laska|W:NPC_Laska|W:NPC_Klara_Laska.xml|W:nolaska|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_41(var_3_object, var_4_object, "pt_laska", "NPC_Laska", "NPC_Klara_Laska.xml");
