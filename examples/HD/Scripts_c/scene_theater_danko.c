...
// @STRINGS: W:quest_d12_01|W:theater_load|W:theater_unload|W:Performance|W:cs_mask_danko|W:cs_mask_danko.xml|A:ForceGeometryLoad|W:.mot|W:nightmask|W:.ogg|W:NightMasks|W:.wmv|W:STAT_LOOK|W:Day: |W:Before stat |W:After stat |W:ACHIEVEMENT_LOOK|W:Achievement Unlocked!!!|W:player|W:noaccess|A:HasProperty|A:GetProperty|A:SetProperty|A:RemoveProperty
// @RUN_OP: 0xf
// @RUN_TASK: 0
...
func_19()
{
	...
	if(var_12_bool != 0) {
		...
		var_42_object = Obj();
		func_175(var_42_object);
		AddActor(var_8_object, "cs_mask_danko", var_42_object, CVector(0.0, 0.0, 0.0), CVector(0.0, 0.0, 1.0), "cs_mask_danko.xml");
		...
		var_69_int = "cs_mask_danko" + var_68_int;
