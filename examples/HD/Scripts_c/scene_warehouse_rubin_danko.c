...
// @STRINGS: W:pt_rubin|W:NPC_Rubin|W:NPC_Danko_Rubin.xml|W:quest_k10_01|W:warehouse_rubin_load|W:norubin|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool, var_1_object)
{
	...
	if(var_2_bool != 0) {
		...
		func_46(var_3_object, var_4_object, "pt_rubin", "NPC_Rubin", "NPC_Danko_Rubin.xml");
