...
// @PE: 0x0,0x11,0x85,0x9f,0xa1,0xa3,0xc5,0xce,0xd7,0xe3,0xf7,0x104,0x112,0x196,0x1aa,0x1be,0x257,0x265,0x2f7,0x30f,0x31c,0x343,0x357,0x364,0x3cc,0x557,0x5c2,0x5c9,0x5df,0x5e8,0x5f2,0x62e,0x6ac,0x6b4,0x6bc,0x6d3,0x774,0x797,0x7b7,0x825,0x845
...
func_0(var_25_object)
{
	...
	func_1001(var_26_bool, var_27_object);
	if(var_26_bool != 0) {
		func_1667();
	}
	func_1643();
	var_104_object = Obj();
	var_25_object = var_104_object;
...
func_133(var_127_string)
{
	...
	var_128_string = "";
	var_127_string = var_128_string;
	func_1326(var_128_string);
	PlayAnimation("all", var_127_string);
	WaitForAnimEnd();
	LockAnimationEnd("all", var_127_string);
	RemoveEnvelope();
	return 0;
}
...
func_1300(var_72_string, var_73_int, var_74_int)
{
	...
	var_74_int = var_79_int;
	func_1492(var_77_bool, var_78_int, var_79_int);
	if(var_77_bool != 0) {
		AddItem(var_76_bool, var_72_string, (int)0);
	}
	return 2;
}
...
func_42(var_105_object)
{
	var_106_cvector = CVector(0,0,0); var_107_cvector = CVector(0,0,0); var_108_cvector = CVector(0,0,0); var_109_cvector = CVector(0,0,0); var_110_string = ""; var_111_object = Obj(); var_112_bool = 0; var_113_bool = 0; var_114_float = 0; var_115_cvector = CVector(0,0,0); var_116_cvector = CVector(0,0,0); var_117_cvector = CVector(0,0,0); var_118_cvector = CVector(0,0,0); var_119_cvector = CVector(0,0,0); var_120_string = ""; var_121_object = Obj(); var_122_bool = 0; var_123_bool = 0; var_124_float = 0; var_125_cvector = CVector(0,0,0);
	var_126_bool = var_105_object == 0; //@ne
	if(var_126_bool != 0) {
		var_127_string = "";
		func_133("fdie");
	} else {
		@@var_105_object:GetPosition(var_116_cvector);
		GetPosition(var_117_cvector);
		GetDirection(var_118_cvector);
		var_119_cvector = var_117_cvector - var_116_cvector;
		var_159_float = GetByIndex(var_119_cvector, 0);
		var_160_float = GetByIndex(var_118_cvector, 0);
		var_161_float = var_159_float * var_160_float;
		var_162_float = GetByIndex(var_119_cvector, 2);
		var_163_float = GetByIndex(var_118_cvector, 2);
		var_164_float = var_162_float * var_163_float;
		var_165_int = var_161_float + var_164_float;
		var_167_bool = var_165_int >= (int)0;
		if(var_167_bool != 0) {
			var_120_string = "fdie";
		} else {
				var_120_string = "bdie";
		...
		Stop();
		StopAsync();
		var_105_object = var_121_object;
		var_170_bool = IsFuncExist(var_105_object, "GetScriptProperty", (int)2);
		if(var_170_bool != 0) {
			@@var_105_object:HasScriptProperty(var_122_bool, "Owner");
			var_172_bool = var_122_bool;
			if(var_172_bool != 0) {
				@@var_105_object:GetScriptProperty(var_121_object, "Owner");
				var_174_bool = var_121_object == 0; //@ne
				if(var_174_bool != 0) {
					var_105_object = var_121_object;
				}
			}
		}
		var_177_bool = IsFuncExist(var_121_object, "@GetEyesHeight", (int)1);
		if(var_177_bool != 0) {
			@@var_121_object:GetEyesHeight(var_124_float);
			var_125_cvector = CVector(0.0, 0.0, 0.0);
			var_178_float = GetByIndex(var_125_cvector, 1);
			var_124_float = var_178_float;
			SetByIndex(var_125_cvector, 1) = var_178_float;
			LookAsync(var_105_object, "head", var_125_cvector);
			var_123_bool = 1;
		} else {
			var_123_bool = 0;
		...
		var_180_string = "";
		var_120_string = var_180_string;
		func_1326(var_180_string);
		PlayAnimation("all", var_120_string);
		WaitForAnimEnd();
		var_182_bool = var_123_bool;
		if(var_182_bool != 0) {
			StopAsync();
			UnlookAsync("head");
		}
...
func_1326(var_128_string)
{
	var_129_bool = 0; var_130_int = 0; var_131_bool = 0; var_132_int = 0; var_133_bool = 0; var_134_float = 0; var_135_cvector = CVector(0,0,0); var_136_cvector = CVector(0,0,0); var_137_bool = 0; var_138_int = 0; var_139_bool = 0; var_140_int = 0; var_141_bool = 0; var_142_float = 0; var_143_cvector = CVector(0,0,0); var_144_cvector = CVector(0,0,0);
	IsExisting3DSound(var_137_bool, var_128_string);
	var_145_bool = var_137_bool == 0; //@nz
	if(var_145_bool != 0) {
		var_138_int = 0;

	Label_1332:
		var_147_int = var_138_int + (int)1;
		var_148_int = var_128_string + var_147_int;
		IsExisting3DSound(var_139_bool, var_148_int);
		var_149_bool = var_139_bool == 0; //@nz
		if(var_149_bool != 0) {
		} else {
			var_138_int = var_138_int + (int)1;
			goto Label_1332;
		}
		var_150_bool = var_138_int == 0; //@nz
		if(var_150_bool != 0) {
			return 16;
		}
		irand(var_140_int, var_138_int);
		var_152_int = var_140_int + (int)1;
		var_128_string = var_128_string + var_152_int;
	}
	Is3DSoundLoaded(var_141_bool, var_128_string);
	var_153_bool = var_141_bool;
	if(var_153_bool != 0) {
		GetEyesHeight(var_142_float);
		GetDirection(var_143_cvector);
		var_144_cvector = var_143_cvector * (int)50;
		var_155_float = GetByIndex(var_144_cvector, 1);
		var_155_float = var_155_float + var_142_float;
		SetByIndex(var_144_cvector, 1) = var_155_float;
		PlayGlobalSound(var_128_string, var_144_cvector);
	}
	return 16;
...
func_1595(var_33_int, var_34_int)
{
	...
	var_39_bool = var_33_int > var_34_int;
	if(var_39_bool != 0) {
		Trace("GenerateMoney: iMin > iMax");
		return 4;
	}
	var_37_int = 0;
	var_41_bool = var_33_int != var_34_int;
	if(var_41_bool != 0) {
		var_42_int = var_34_int - var_33_int;
		irand(var_37_int, var_42_int);
	} else {
		var_51_bool = var_33_int == (int)0;
		if(var_51_bool == 0) goto Label_1613;
		return 4;
	}
Label_1613:
	var_37_int = var_37_int + var_33_int;
	var_44_bool = var_37_int == (int)0;
	if(var_44_bool != 0) {
		return 4;
	}
	var_45_int = 0; var_46_string = "";
	func_1703(var_45_int, "Money");
...
func_2123(var_18_object)
{
	...
	if(var_21_bool != 0) {
		...
		var_23_object = Obj();
		func_1454(var_23_object);
		@@var_20_object:RemoveStationaryActor(var_23_object);
		var_20_object = 0;
	}
	var_24_object = Obj();
...
func_1492(var_60_bool, var_61_int, var_62_int)
{
	...
	var_60_bool = var_64_int < var_61_int;
	return 2;
}
...
{
	var_91_object = Obj(); var_92_int = 0; var_93_bool = 0; var_94_object = Obj(); var_95_int = 0; var_96_bool = 0;
	CreateInvItem(var_94_object);
	@@var_94_object:SetItemName(var_90_string);
	@@var_94_object:SetProperty("Organ", (int)1);
	@@var_94_object:GetItemID(var_95_int);
	AddItem(var_96_bool, var_94_object, (int)0, (int)1);
	return 6;
}
EMIT "Stack[-3] = 0";
