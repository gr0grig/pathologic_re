...
// @STRINGS: A:SetNPCName|A:SetNPCDescription|A:SetPhoto|A:SetPhoto2|A:SetPlayerName|A:IsDialogEnd|A:GetReturnValue|W:Neutral|A:SetMessage|A:ClearReplies|A:AddReply|W:all|W:idle|W:cleanup|W:tutorial_light_2|A:Switch|A:GetPosition|A:GetEyesHeight|W:head|W:Can't find lsh animation : |W:ui/NPC_wmask.png|W:ui/NPC_wmask_b.png|W:branch
// @GLOBALS: 0:object:
// @RUN_OP: 0x189
// @RUN_TASK: 2
...
// @PE: 0x4a,0x89,0x9f,0x192,0x1a4,0x1e2

task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		func_722();
		var_12_bool = var_7_bool == (int)18970;
		if(var_12_bool != 0) {
			var_13_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517835);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517836, (int)18972, (int)18971);
			@@@var_0_object:AddReply((int)517855, (int)18992, (int)18991);
			@@@var_0_object:AddReply((int)517859, (int)-1, (int)18996);
			return 0;
		}
		var_41_bool = var_7_bool == (int)18992;
		if(var_41_bool != 0) {
			var_42_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517856);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517857, (int)18972, (int)18993);
			@@@var_0_object:AddReply((int)517858, (int)-1, (int)18995);
			return 0;
		}
		var_51_bool = var_7_bool == (int)18972;
		if(var_51_bool != 0) {
			var_52_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517837);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517838, (int)18974, (int)18973);
			@@@var_0_object:AddReply((int)517854, (int)18974, (int)18989);
			return 0;
		}
		var_61_bool = var_7_bool == (int)18974;
		if(var_61_bool != 0) {
			var_62_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517839);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517840, (int)18976, (int)18975);
			@@@var_0_object:AddReply((int)532787, (int)-1, (int)34258);
			return 0;
		}
		var_71_bool = var_7_bool == (int)18976;
		if(var_71_bool != 0) {
			var_72_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517841);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517842, (int)18978, (int)18977);
			return 0;
		}
		var_78_bool = var_7_bool == (int)18978;
		if(var_78_bool != 0) {
			var_79_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517843);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517844, (int)18980, (int)18979);
			@@@var_0_object:AddReply((int)532788, (int)-1, (int)34259);
			return 0;
		}
		var_88_bool = var_7_bool == (int)18980;
		if(var_88_bool != 0) {
			var_89_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517845);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517846, (int)18982, (int)18981);
			return 0;
		}
		var_95_bool = var_7_bool == (int)18982;
		if(var_95_bool != 0) {
			var_96_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517847);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517848, (int)18984, (int)18983);
			return 0;
		}
		var_102_bool = var_7_bool == (int)18984;
		if(var_102_bool != 0) {
			var_103_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517849);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517850, (int)18986, (int)18985);
			@@@var_0_object:AddReply((int)517853, (int)-1, (int)18988);
			return 0;
		}
		var_112_bool = var_7_bool == (int)18986;
		if(var_112_bool != 0) {
			var_113_string = "";
			func_137(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)517851);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)517852, (int)-1, (int)18987);
			return 0;
		}
		var_3_string = true;
		var_118_bool = 0;
...
func_0(var_0_object, var_9_int, var_10_object)
{
	...
	func_604(var_20_bool, var_21_object, (float)70.0);
...
Label_527:
	...
	if(var_49_bool != 0) {
		...
		if(var_55_bool != 0) {
			...
			if(var_56_int == 0) goto Label_560;
			...
			if(var_60_bool != 0) {
				...
				if(var_70_int == 0) goto Label_578;
				goto Label_589;
		}
		Label_578:
			var_61_bool = 0;
...
func_604(var_20_bool, var_21_object, var_22_float)
{
	...
	if(var_63_bool != 0) {
		...
		if(var_65_bool == 0) goto Label_667;
...
func_673()
{
	...
	if(var_138_bool != 0) {
		...
		if(var_140_bool == 0) goto Label_690;
		UnlookAsync("head");
	}
Label_690:
	return 2;
