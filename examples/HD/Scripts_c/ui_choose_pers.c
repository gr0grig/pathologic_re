// @IMPORTS: SetOwnerDraw/1,ShowCursor/1,CaptureKeyboard/0,GetWindowSize/2,LoadVideo/1,FindVideo/2,ProcessEvents/0,ReleaseVideo/1,StopEventProcessing/0,CreateWindow/3,SendMessage/2,SetCursor/1,SetBackground/1,PlaySound/1,PauseSound/1,RemoveWorld/0,UISync/0,DestroyWindow/0,NewGame/2,Trace/1,LoadGame/2,SaveGame/1,SaveGame/2,UITrace/1,Quit/0,HideCursor/0,GetRegistryData/3
// @STRINGS: A:Play|A:IsLost|A:Restore|A:IsPlaying|A:StretchBlit|A:Stop|W:intro.xml|W:intro|A:DestroyWindow|W:game_buttons.xml|W:game_logo.xml|W:default|W:menumusic|W:game_choose_pers.xml|W:intro_danko.wmv|W:world_danko.xml|W:player_danko.xml|W:intro_burah.wmv|W:world_burah.xml|W:player_burah.xml|W:intro_klara.wmv|W:world_klara.xml|W:player_klara.xml|W:Loading : |A:GetFileName|W:world_intro.xml|W:player_intro.xml|W:newgame|W:quitgame|W:Quit game|W:loadgame|W:load.xml|W:savegame|W:save.xml|W:gameoptions|W:options.xml|W:continue|W:credits|W:danko|W:player_name|W:player_desc|W:burah|W:klara|W:load|W:save|W:BurahCompleted|W:DankoCompleted
// @RUN_OP: 0x6d
// @RUN_TASK: 2
...
// @PE: 0x0,0x38,0x59,0x64,0x140,0x148,0x2a5,0x2e4,0x323,0x382,0x387,0x38a,0x3e7,0x40e
	...
	if(var_25_bool != 0) {
		...
		if(var_69_bool != 0) {
			...
			if(var_71_bool != 0) {
				...
				if(var_79_bool == 0) goto Label_453;
			...
			if(var_85_bool != 0) {
				...
				if(var_87_bool != 0) {
					...
					if(var_95_bool == 0) goto Label_488;
					SendMessage((int)-1, "player_name");
					SendMessage((int)-1, "player_desc");
			}
				...
				if(var_101_bool != 0) {
					...
					if(var_103_bool != 0) {
						...
						if(var_120_bool != 0) {
							...
							if(var_133_bool == 0) goto Label_557;
							SendMessage((int)-1, "player_name");
							SendMessage((int)-1, "player_desc");
				}
						...
						if(var_139_bool != 0) {
							...
							if(var_146_bool != 0) {
								...
								if(var_150_bool == 0) goto Label_599;
								func_600(var_22_string, var_23_object);
								return 0;
							}
							return 0;
...
task_2_event_102(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_72_bool == 0) goto Label_1019;
			HideCursor();
			func_803();
	}
		...
		if(var_142_bool == 0) goto Label_1037;
		HideCursor();
		func_740();
	}
Label_1019:
...
task_2_event_101(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_110_bool == 0) goto Label_1074;
			var_111_string = "";
			func_896(var_21_int, var_111_string);
			var_113_bool = var_111_string != "";
			if(var_113_bool == 0) goto Label_1074;
			var_114_int = 2;
			var_115_string = "";
		...
		if(var_175_bool == 0) goto Label_1108;
		var_176_string = "";
		func_901(var_21_int, var_176_string);
		var_178_bool = var_176_string != "";
		if(var_178_bool == 0) goto Label_1108;
		var_179_int = 2;
		var_180_string = "";
...
{
	var_21_bool = 0;
	func_130(var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, (bool)1);
	return 0;
}
...
func_130(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_9_object, var_10_object, var_14_object, var_21_bool)
{
...
Label_172:
	...
	if(var_47_bool != 0) {
		...
		if(var_99_bool != 0) {
			...
			if(var_102_bool == 0) goto Label_319;
			RemoveWorld();
			UISync();
			DestroyWindow();
...
func_906()
{
	...
	if(var_37_bool != 0) {
		...
		if(var_67_bool == 0) goto Label_998;
...
func_803()
{
	...
	if(var_75_bool != 0) {
		...
		if(var_105_bool == 0) goto Label_895;
		SendMessage((int)1, "newgame");
		var_108_string = "";
		func_898(var_21_int, "newgame");
	}
...
func_677()
{
	...
	if(var_126_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_739;
		SendMessage((int)1, "danko");
		var_147_string = "";
		func_903(var_21_int, "danko");
	}
...
func_740()
{
	...
	if(var_152_bool != 0) {
		...
		if(var_170_bool == 0) goto Label_802;
		SendMessage((int)1, "klara");
		var_173_string = "";
		func_903(var_21_int, "klara");
	}
...
func_616(var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object)
{
...
func_114(var_105_object)
{
	...
	CreateWindow("game_buttons.xml", (bool)0, var_107_object);
