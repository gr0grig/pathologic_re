// @IMPORTS: SetBackground/1,SetOwnerDraw/1,ProcessEvents/0,SendMessage/2,SendMessageToParent/1,ClientToScreen/2,GetWindowSize/2,SetMousePos/2,GetCursorPos/2,Blit/3,Print/4,SetTooltip/2,GetInvItemSprite/2,LoadImage/1,GetInvItemMaxStackSize/2,SetTooltip/3
// @STRINGS: W:default|W:$parent|W:scalpel|A:get|A:GetItemID|W:ccslot0|W:ccslot
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_0(var_0_int, var_1_int, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_string, var_7_string)
{
	...
	if(var_8_bool != 0) {
		Blit("scalpel", (int)1, (int)1);
		return 0;
	}
	Blit(var_3_string, (int)1, (int)1);
	var_15_bool = var_1_int > (int)1;
	if(var_15_bool != 0) {
...
func_236(var_14_string, var_15_int)
{
	...
	if(var_19_bool != 0) {
		...
		var_14_string = "ccslot0" + var_22_int;
		return 0;
	}
	var_25_int = var_15_int + (int)1;
	var_14_string = "ccslot" + var_25_int;
	return 0;
}
