		...
		if(var_8_int == -5) {
			...
			if((var_8_int & 32768) != 0) {
				...
				@SetTooltip(-1, "");
					...
					if(var_2_object == 0) goto Label_231;
...
// @pe
void func_236(string var_14_string, int var_15_int)
{
	if((var_15_int + 1) < 10)
		var_14_string = "ccslot0" + (var_15_int + 1);
	var_14_string = "ccslot" + (var_15_int + 1);
}
