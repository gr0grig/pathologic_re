// @IMPORTS: SetOwnerDraw/1,ShowCursor/1,CaptureKeyboard/0,GetWindowSize/2,LoadVideo/1,FindVideo/2,ProcessEvents/0,ReleaseVideo/1,StopEventProcessing/0,CreateWindow/3,SendMessage/2,PlaySound/1,SetCursor/1,SetBackground/1,PauseSound/1,RemoveWorld/0,UISync/0,DestroyWindow/0,NewGame/2,Trace/1,LoadGame/2,SaveGame/1,SaveGame/2,UITrace/1,Quit/0,HideCursor/0,GetRegistryData/3
// @STRINGS: A:Play|A:IsLost|A:Restore|A:IsPlaying|A:StretchBlit|A:Stop|W:intro.xml|W:intro|A:DestroyWindow|W:menumusic|W:game_buttons.xml|W:game_logo.xml|W:default|W:game_choose_pers.xml|W:intro_danko.wmv|W:world_danko.xml|W:player_danko.xml|W:intro_burah.wmv|W:world_burah.xml|W:player_burah.xml|W:intro_klara.wmv|W:world_klara.xml|W:player_klara.xml|W:Loading : |A:GetFileName|W:world_intro.xml|W:player_intro.xml|W:newgame|W:quitgame|W:Quit game|W:loadgame|W:load.xml|W:savegame|W:save.xml|W:gameoptions|W:options.xml|W:continue|W:credits|W:danko|W:player_name|W:player_desc|W:burah|W:klara|W:load|W:save|W:BurahCompleted|W:DankoCompleted
// @RUN_OP: 0x6d
// @RUN_TASK: 2
...
// @PE: 0x0,0x38,0x59,0x64,0x149,0x151,0x2ae,0x2ed,0x32c,0x38b,0x390,0x393,0x3f0,0x417
	...
	if(var_25_bool != 0) {
		...
		if(var_69_bool != 0) {
			...
			if(var_71_bool != 0) {
				...
				if(var_79_bool == 0) goto Label_462;
			...
			if(var_85_bool != 0) {
				...
				if(var_87_bool != 0) {
					...
					if(var_95_bool == 0) goto Label_497;
					SendMessage((int)-1, "player_name");
					SendMessage((int)-1, "player_desc");
			}
				...
				if(var_101_bool != 0) {
					...
					if(var_103_bool != 0) {
						...
						if(var_120_bool != 0) {
							...
							if(var_133_bool == 0) goto Label_566;
							SendMessage((int)-1, "player_name");
							SendMessage((int)-1, "player_desc");
				}
						...
						if(var_139_bool != 0) {
							...
							if(var_146_bool != 0) {
								...
								if(var_150_bool == 0) goto Label_608;
								func_609(var_22_string, var_23_object);
								return 0;
							}
							return 0;
...
task_2_event_102(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_72_bool == 0) goto Label_1028;
			HideCursor();
			func_812();
	}
		...
		if(var_142_bool == 0) goto Label_1046;
		HideCursor();
		func_749();
	}
Label_1028:
...
task_2_event_101(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_110_bool == 0) goto Label_1083;
			var_111_string = "";
			func_905(var_21_int, var_111_string);
			var_113_bool = var_111_string != "";
			if(var_113_bool == 0) goto Label_1083;
			var_114_int = 2;
			var_115_string = "";
		...
		if(var_175_bool == 0) goto Label_1117;
		var_176_string = "";
		func_910(var_21_int, var_176_string);
		var_178_bool = var_176_string != "";
		if(var_178_bool == 0) goto Label_1117;
		var_179_int = 2;
		var_180_string = "";
...
main(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object)
{
	...
	var_22_int = 0;
	TaskCall(1);
	func_89(var_23_object, (int)8);
	TaskReturn();
	var_27_bool = 0;
	func_139(var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, (bool)0);
	return 0;
}


func_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_57_string, var_58_bool)
{
...
func_131(var_113_object)
{
	...
	CreateWindow("game_logo.xml", (bool)0, var_115_object);
...
func_139(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_9_object, var_10_object, var_14_object, var_27_bool)
{
	var_28_bool = 0; var_29_bool = 0; var_30_bool = 0; var_31_string = ""; var_32_bool = 0; var_33_bool = 0; var_34_bool = 0; var_35_string = "";
...
Label_181:
	var_45_bool = var_2_int == 0; //@nz
	if(var_45_bool != 0) {
		ProcessEvents();
		goto Label_181;
	}
	func_625(var_30_bool, var_31_string, var_32_bool, var_33_bool, var_34_bool, var_35_string);
	var_53_bool = var_2_int == (int)1;
	if(var_53_bool != 0) {
		PauseSound("menumusic");
		var_55_int = 0;
		TaskCall(1);
		func_89(var_56_object, (int)1);
		TaskReturn();
		var_57_string = ""; var_58_bool = 0;
		TaskCall(0);
		func_0(var_59_object, var_60_int, var_61_int, var_62_bool, "intro_danko.wmv", (bool)1);
		TaskReturn();
		RemoveWorld();
		UISync();
		DestroyWindow();
		...
		var_71_bool = var_2_int == (int)2;
		if(var_71_bool != 0) {
			PauseSound("menumusic");
			var_73_int = 0;
			TaskCall(1);
			func_89(var_74_object, (int)2);
			TaskReturn();
			var_75_string = ""; var_76_bool = 0;
			TaskCall(0);
			func_0(var_77_object, var_78_int, var_79_int, var_80_bool, "intro_burah.wmv", (bool)1);
			TaskReturn();
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_84_bool = var_2_int == (int)3;
		if(var_84_bool != 0) {
			PauseSound("menumusic");
			var_86_int = 0;
			TaskCall(1);
			func_89(var_87_object, (int)3);
			TaskReturn();
			var_88_string = ""; var_89_bool = 0;
			TaskCall(0);
			func_0(var_90_object, var_91_int, var_92_int, var_93_bool, "intro_klara.wmv", (bool)1);
			TaskReturn();
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_97_bool = var_2_int == (int)4;
		if(var_97_bool != 0) {
			PauseSound("menumusic");
			var_100_int = "Loading : " + var_10_object;
			Trace(var_100_int);
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_102_bool = var_2_int == (int)5;
		if(var_102_bool != 0) {
			var_103_bool = var_9_object == 0; //@nz
			if(var_103_bool != 0) {
				DestroyWindow();
				SaveGame(var_33_bool);
			} else {
				DestroyWindow();
				@@@var_9_object:GetFileName(var_35_string);
				SaveGame(var_34_bool, var_35_string);
		}
			var_105_bool = var_2_int == (int)7;
			if(var_105_bool == 0) goto Label_328;
			RemoveWorld();
			UISync();
			DestroyWindow();
...
func_915()
{
	...
	if(var_37_bool != 0) {
		...
		if(var_67_bool == 0) goto Label_1007;
...
func_812()
{
	...
	if(var_75_bool != 0) {
		...
		if(var_105_bool == 0) goto Label_904;
		SendMessage((int)1, "newgame");
		var_108_string = "";
		func_907(var_21_int, "newgame");
	}
...
func_686()
{
	...
	if(var_126_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_748;
		SendMessage((int)1, "danko");
		var_147_string = "";
		func_912(var_21_int, "danko");
	}
...
func_749()
{
	...
	if(var_152_bool != 0) {
		...
		if(var_170_bool == 0) goto Label_811;
		SendMessage((int)1, "klara");
		var_173_string = "";
		func_912(var_21_int, "klara");
	}
...
func_625(var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object)
{
	var_46_bool = var_3_bool;
	if(var_46_bool != 0) {
		@@@var_3_bool:DestroyWindow();
	}
	var_47_object = var_4_object;
	if(var_47_object != 0) {
		@@@var_4_object:DestroyWindow();
	}
	var_48_int = var_5_int;
	if(var_48_int != 0) {
		@@@var_5_int:DestroyWindow();
	}
	var_49_int = var_6_int;
	if(var_49_int != 0) {
		@@@var_6_int:DestroyWindow();
	}
	var_50_int = var_7_int;
	if(var_50_int != 0) {
...
func_123(var_108_object)
{
	...
	CreateWindow("game_buttons.xml", (bool)0, var_110_object);
