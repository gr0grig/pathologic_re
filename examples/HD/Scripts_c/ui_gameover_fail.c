// @IMPORTS: SetOwnerDraw/1,ShowCursor/1,CaptureKeyboard/0,GetWindowSize/2,LoadVideo/1,FindVideo/2,ProcessEvents/0,ReleaseVideo/1,StopEventProcessing/0,CreateWindow/3,SendMessage/2,UISync/0,SetCursor/1,SetBackground/1,PlaySound/1,PauseSound/1,RemoveWorld/0,DestroyWindow/0,NewGame/2,Trace/1,LoadGame/2,SaveGame/1,SaveGame/2,UITrace/1,Quit/0,HideCursor/0,GetRegistryData/3
// @STRINGS: A:Play|A:IsLost|A:Restore|A:IsPlaying|A:StretchBlit|A:Stop|W:intro.xml|W:intro|A:DestroyWindow|W:death_fail.wmv|W:game_buttons.xml|W:game_logo.xml|W:default|W:menumusic|W:game_choose_pers.xml|W:intro_danko.wmv|W:world_danko.xml|W:player_danko.xml|W:intro_burah.wmv|W:world_burah.xml|W:player_burah.xml|W:intro_klara.wmv|W:world_klara.xml|W:player_klara.xml|W:Loading : |A:GetFileName|W:world_intro.xml|W:player_intro.xml|W:newgame|W:quitgame|W:Quit game|W:loadgame|W:load.xml|W:savegame|W:save.xml|W:gameoptions|W:options.xml|W:continue|W:credits|W:danko|W:player_name|W:player_desc|W:burah|W:klara|W:load|W:save|W:BurahCompleted|W:DankoCompleted
// @RUN_OP: 0x6d
// @RUN_TASK: 2
...
// @PE: 0x0,0x38,0x59,0x64,0x14d,0x155,0x2b2,0x2f1,0x330,0x38f,0x394,0x397,0x3f4,0x41b
	...
	if(var_25_bool != 0) {
		...
		if(var_69_bool != 0) {
			...
			if(var_71_bool != 0) {
				...
				if(var_79_bool == 0) goto Label_466;
			...
			if(var_85_bool != 0) {
				...
				if(var_87_bool != 0) {
					...
					if(var_95_bool == 0) goto Label_501;
					SendMessage((int)-1, "player_name");
					SendMessage((int)-1, "player_desc");
			}
				...
				if(var_101_bool != 0) {
					...
					if(var_103_bool != 0) {
						...
						if(var_120_bool != 0) {
							...
							if(var_133_bool == 0) goto Label_570;
							SendMessage((int)-1, "player_name");
							SendMessage((int)-1, "player_desc");
				}
						...
						if(var_139_bool != 0) {
							...
							if(var_146_bool != 0) {
								...
								if(var_150_bool == 0) goto Label_612;
								func_613(var_22_string, var_23_object);
								return 0;
							}
							return 0;
...
task_2_event_102(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_72_bool == 0) goto Label_1032;
			HideCursor();
			func_816();
	}
		...
		if(var_142_bool == 0) goto Label_1050;
		HideCursor();
		func_753();
	}
Label_1032:
...
task_2_event_101(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, var_21_int)
{
	...
	if(var_22_bool != 0) {
		...
		if(var_24_bool != 0) {
			...
			if(var_110_bool == 0) goto Label_1087;
			var_111_string = "";
			func_909(var_21_int, var_111_string);
			var_113_bool = var_111_string != "";
			if(var_113_bool == 0) goto Label_1087;
			var_114_int = 2;
			var_115_string = "";
		...
		if(var_175_bool == 0) goto Label_1121;
		var_176_string = "";
		func_914(var_21_int, var_176_string);
		var_178_bool = var_176_string != "";
		if(var_178_bool == 0) goto Label_1121;
		var_179_int = 2;
		var_180_string = "";
...
main(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object)
{
	...
	TaskCall(0);
	func_0(var_23_object, var_24_int, var_25_int, var_26_bool, "death_fail.wmv", (bool)1);
	TaskReturn();
	var_32_bool = 0;
	func_143(var_12_object, var_13_object, var_14_object, var_15_string, var_16_string, var_17_string, var_18_string, var_19_bool, var_20_object, (bool)0);
	return 0;
}
...
func_135(var_116_object)
{
	...
	CreateWindow("game_logo.xml", (bool)0, var_118_object);
...
func_143(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_object, var_5_int, var_9_object, var_10_object, var_14_object, var_32_bool)
{
	var_33_bool = 0; var_34_bool = 0; var_35_bool = 0; var_36_string = ""; var_37_bool = 0; var_38_bool = 0; var_39_bool = 0; var_40_string = "";
...
Label_185:
	var_50_bool = var_2_int == 0; //@nz
	if(var_50_bool != 0) {
		ProcessEvents();
		goto Label_185;
	}
	func_629(var_35_bool, var_36_string, var_37_bool, var_38_bool, var_39_bool, var_40_string);
	var_58_bool = var_2_int == (int)1;
	if(var_58_bool != 0) {
		PauseSound("menumusic");
		var_60_int = 0;
		TaskCall(1);
		func_89(var_61_object, (int)1);
		TaskReturn();
		var_65_string = ""; var_66_bool = 0;
		TaskCall(0);
		func_0(var_67_object, var_68_int, var_69_int, var_70_bool, "intro_danko.wmv", (bool)1);
		TaskReturn();
		RemoveWorld();
		UISync();
		DestroyWindow();
		...
		var_74_bool = var_2_int == (int)2;
		if(var_74_bool != 0) {
			PauseSound("menumusic");
			var_76_int = 0;
			TaskCall(1);
			func_89(var_77_object, (int)2);
			TaskReturn();
			var_78_string = ""; var_79_bool = 0;
			TaskCall(0);
			func_0(var_80_object, var_81_int, var_82_int, var_83_bool, "intro_burah.wmv", (bool)1);
			TaskReturn();
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_87_bool = var_2_int == (int)3;
		if(var_87_bool != 0) {
			PauseSound("menumusic");
			var_89_int = 0;
			TaskCall(1);
			func_89(var_90_object, (int)3);
			TaskReturn();
			var_91_string = ""; var_92_bool = 0;
			TaskCall(0);
			func_0(var_93_object, var_94_int, var_95_int, var_96_bool, "intro_klara.wmv", (bool)1);
			TaskReturn();
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_100_bool = var_2_int == (int)4;
		if(var_100_bool != 0) {
			PauseSound("menumusic");
			var_103_int = "Loading : " + var_10_object;
			Trace(var_103_int);
			RemoveWorld();
			UISync();
			DestroyWindow();
		...
		var_105_bool = var_2_int == (int)5;
		if(var_105_bool != 0) {
			var_106_bool = var_9_object == 0; //@nz
			if(var_106_bool != 0) {
				DestroyWindow();
				SaveGame(var_38_bool);
			} else {
				DestroyWindow();
				@@@var_9_object:GetFileName(var_40_string);
				SaveGame(var_39_bool, var_40_string);
		}
			var_108_bool = var_2_int == (int)7;
			if(var_108_bool == 0) goto Label_332;
			RemoveWorld();
			UISync();
			DestroyWindow();
...
func_919()
{
	...
	if(var_37_bool != 0) {
		...
		if(var_67_bool == 0) goto Label_1011;
...
func_816()
{
	...
	if(var_75_bool != 0) {
		...
		if(var_105_bool == 0) goto Label_908;
		SendMessage((int)1, "newgame");
		var_108_string = "";
		func_911(var_21_int, "newgame");
	}
...
func_690()
{
	...
	if(var_126_bool != 0) {
		...
		if(var_144_bool == 0) goto Label_752;
		SendMessage((int)1, "danko");
		var_147_string = "";
		func_916(var_21_int, "danko");
	}
...
func_753()
{
	...
	if(var_152_bool != 0) {
		...
		if(var_170_bool == 0) goto Label_815;
		SendMessage((int)1, "klara");
		var_173_string = "";
		func_916(var_21_int, "klara");
	}
...
func_629(var_3_bool, var_4_object, var_5_int, var_6_int, var_7_int, var_8_object)
{
	var_51_bool = var_3_bool;
	if(var_51_bool != 0) {
		@@@var_3_bool:DestroyWindow();
	}
	var_52_object = var_4_object;
	if(var_52_object != 0) {
		@@@var_4_object:DestroyWindow();
	}
	var_53_int = var_5_int;
	if(var_53_int != 0) {
		@@@var_5_int:DestroyWindow();
	}
	var_54_int = var_6_int;
	if(var_54_int != 0) {
		@@@var_6_int:DestroyWindow();
	}
	var_55_int = var_7_int;
	if(var_55_int != 0) {
		@@@var_7_int:DestroyWindow();
	}
	var_56_object = var_8_object;
	if(var_56_object != 0) {
...
func_127(var_111_object)
{
	...
	CreateWindow("game_buttons.xml", (bool)0, var_113_object);
