task task_0
{
	...
	void event_101(object var_0_object, int var_1_int, int var_2_int, bool var_3_bool, int var_4_int)
	{
		...
		bool var_7_bool = true;
		bool var_8_bool = true;
		var_10_bool = var_4_int == 27;
		if(var_10_bool != 1) {
			var_12_bool = var_4_int == 32;
			if(var_12_bool != 1)
				var_8_bool = false;
		}
		if(var_8_bool != 1) {
			var_14_bool = var_4_int == 257;
			if(var_14_bool != 1)
				var_7_bool = false;
		}
		if(var_7_bool != 1) {
			var_16_bool = var_4_int == 262;
			if(var_16_bool != 1)
				var_6_bool = false;
		}
		if(var_6_bool != 0) {
...
maintask task_1
{
	void init(object var_0_object, int var_1_int, int var_2_int, bool var_3_bool)
	{
		...
		enable OnUse;
		TaskCall(0);
		func_0(var_6_object, var_7_int, var_8_int, var_9_bool, "fin_termit.wmv", false);
		TaskReturn();
		@DestroyWindow();
