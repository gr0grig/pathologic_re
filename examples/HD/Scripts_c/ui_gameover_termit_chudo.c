...
// @STRINGS: A:Play|A:IsLost|A:Restore|A:IsPlaying|A:StretchBlit|A:Stop|W:fin_termit.wmv|W:world_final.xml|W:player_final.xml
// @RUN_OP: 0x59
// @RUN_TASK: 1
...
main(var_0_object, var_1_int, var_2_int, var_3_bool)
{
	...
	TaskCall(0);
	func_0(var_6_object, var_7_int, var_8_int, var_9_bool, "fin_termit.wmv", (bool)0);
	TaskReturn();
	DestroyWindow();
