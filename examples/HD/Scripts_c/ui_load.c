maintask task_0
{
	void init(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object)
	{
		...
		while(true != 0) {
			func_67(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, false);
		}
	...
	{
		if(var_11_int == 267) {
			@SendMessage(1001, "load");
		} else if(var_11_int == 268) {
			@SendMessage(1000, "load");
		}
	...
	Label_368:
		...
		if(!(var_11_int == 1001)) goto Label_368;
	...
	void OnStopSee(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int)
	{
		...
		func_470(var_14_int, var_15_int, var_13_int, var_14_int, var_15_int);
		var_2_int = var_13_int;
		int var_36_int; int var_37_int; int var_38_int;
		func_509(var_37_int, var_38_int, var_36_int, var_37_int, var_38_int);
...
void func_509(int var_1_int, object var_9_object, int var_50_int, int var_51_int, int var_52_int)
{
	if(var_51_int < 248) {
		var_50_int = -1;
		return 8;
...
void func_67(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, bool var_12_bool)
{
	...
	for(;;) {
		if(1 != 0) {
			...
			if(!var_17_object) { //@nz
				...
				if(var_12_bool == 0) goto Label_98;
				var_17_object->IsQuickSave(var_18_bool);
				if(var_18_bool == 0) goto Label_98;
			}
		}
...
// @pe
void func_134(int var_12_int, int var_13_int)
{
	var_13_int = var_12_int;
}


void func_550(object var_9_object, int var_29_int)
{
	int var_31_int;
...
void func_137(int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_9_object, int var_11_int)
{
				...
				if(var_29_bool != 0) {
					...
					@Print("default", 129, (7 + var_37_int), var_68_string, 0.5568628, 0.5568628, 0.5568628);
							...
							if(var_31_bool != 0) {
								...
								func_592(var_166_string, (500 + var_32_int));
							...
							func_302(0, var_177_int, true);
							string var_183_string;
							func_592(var_183_string, 32);
...
// @pe
void func_44(int var_144_int, int var_145_int)
{
	@Blit("button_text", var_144_int, var_145_int);
}


void func_621(string var_106_string, object var_107_object)
{
	...
	func_592(var_120_string, 19);
	string var_122_string;
	func_592(var_122_string, (20 + var_119_int));
...
void func_558(int var_1_int, int var_5_int)
{
	int var_28_int;
	int var_29_int;
...
// @pe
void func_302(int var_36_int, int var_37_int, bool var_38_bool)
{
	if(var_38_bool != 0)
...
void func_592(string var_68_string, int var_69_int)
{
...
// @pe
void func_49(object var_44_object)
{
	@SendMessageToParent(0, var_44_object);
}


void func_597(string var_75_string, object var_76_object)
{
	float var_83_float;
	var_76_object->GetGameTime(var_83_float);
	string var_95_string;
	func_592(var_95_string, 18);
...
void func_470(int var_1_int, object var_9_object, int var_19_int, int var_20_int, int var_21_int)
{
	if(var_20_int < 129) {
		var_19_int = -1;
		return 8;
...
void func_54(object var_76_object)
{
