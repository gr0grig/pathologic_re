...
// @STRINGS: W:save|W:button_save|W:button_overwrite|A:GetFileName|A:add|A:Next|A:IsQuickSave|W:sys_border.xml|A:size|A:get|A:BlitClipped|W:default|A:GetProperty|W:????|W:big|W:button_x_pressed|W:button_x|W:button_pressed|W:button|W:separator|W:shot_black|W:shot_border|W:scrollbar|A:GetGameTime|A:GetSaveTime
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
// @PE: 0xa,0x1b,0x2c,0x37,0x44,0x8c,0x134,0x159,0x19d
...
task_0_event_200(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_int, var_12_string, var_13_object)
{
	...
	if(var_15_bool != 0) {
		...
		if(var_51_bool == 0) goto Label_374;
...
task_0_event_2(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int)
{
	...
	func_476(var_11_int, var_12_int, var_13_int, var_14_int, var_15_int);
	var_2_int = var_13_int;
	var_36_int = 0; var_37_int = 0; var_38_int = 0;
	var_11_int = var_37_int;
	var_12_int = var_38_int;
	func_515(var_11_int, var_12_int, var_36_int, var_37_int, var_38_int);
...
task_0_event_3(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_int, var_12_int)
{
	...
	if(var_18_bool != 0) {
		...
		if(var_74_bool == 0) goto Label_475;
...
Label_2:
	if((bool)1 != 0) {
		var_12_bool = 0;
		func_73(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, (bool)1);
		goto Label_2;
	}
	return 0;
}
...
func_515(var_1_int, var_9_object, var_50_int, var_51_int, var_52_int)
{
...
func_73(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_12_bool)
{
...
{
	var_147_bool = var_143_object == 0; //@ne
	if(var_147_bool != 0) {
...
func_556(var_9_object, var_29_int)
{
...
func_143(var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_9_object, var_11_int)
{
		...
		if(var_35_object != 0) {
			...
			if(var_63_bool != 0) {
				...
				Print("default", (int)129, var_67_int, var_68_string, (float)0.5568627715110779, (float)0.5568627715110779, (float)0.5568627715110779);
							...
							var_167_bool = var_31_bool;
							if(var_167_bool != 0) {
								var_168_string = ""; var_169_int = 0;
								var_169_int = (int)500 + var_32_int;
								func_598(var_168_string, var_169_int);
								var_168_string = var_30_string;
							} else {
								var_30_string = "????";
		}
							var_178_int = 0; var_179_int = 0; var_180_bool = 0;
							var_11_int = var_179_int;
							func_308((int)0, var_179_int, (bool)1);
							var_184_int = (int)47 + var_11_int;
							var_185_string = ""; var_186_int = 0;
							func_598(var_185_string, (int)32);
							Print("default", (int)129, var_184_int, var_185_string, (float)0.5568627715110779, (float)0.5568627715110779, (float)0.5568627715110779);
	}
						return 20;
					}
					var_174_int = (int)7 + var_11_int;
					Print("default", (int)129, var_174_int, var_30_string, (float)0.5568627715110779, (float)0.5568627715110779, (float)0.5568627715110779);
	}
	...
	if(var_132_bool != 0) {
		...
		if(var_133_bool != 0) {
			...
			Blit("button_x_pressed", (int)248, var_137_int);
				...
				var_165_int = (int)68 + var_11_int;
				Blit("button_x", (int)248, var_165_int);
...
Label_270:
	...
	if(var_138_bool != 0) {
		...
		var_161_int = (int)67 + var_11_int;
		Blit("button", (int)129, var_161_int);

	}
	var_143_object = Obj(); var_144_int = 0; var_145_int = 0;
	var_26_object = var_143_object;
	var_145_int = (int)67 + var_11_int;
	func_44(var_143_object, (int)129, var_145_int);
	var_11_int = var_11_int + (int)90;
	var_154_int = var_11_int + (int)15;
	StretchBlit("separator", (int)0, var_154_int, var_4_int, (int)1);
...
func_627(var_106_string, var_107_object)
{
	...
	func_598(var_120_string, (int)19);
	var_122_string = ""; var_123_int = 0;
	var_123_int = (int)20 + var_119_int;
	func_598(var_122_string, var_123_int);
...
func_564(var_1_int, var_5_int)
{
	...
	if(var_36_bool != 0) {
		var_1_int = -var_28_int;
			...
			if(var_47_bool == 0) goto Label_582;
			var_1_int = 0;
	}
Label_582:
...
func_476(var_1_int, var_9_object, var_19_int, var_20_int, var_21_int)
{
