maintask task_0
{
	void init(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object)
	{
		...
		while(true != 0) {
			func_73(var_0_bool, var_1_int, var_2_int, var_3_int, var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, true);
		}
	
	}

	// @pe
	void event_101(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int)
	{
		if(var_11_int == 267) {
			@SendMessage(1001, "save");
		} else if(var_11_int == 268) {
			@SendMessage(1000, "save");
		}
	
	}

	// @pe
	void event_102(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int)
	{
		if(var_11_int == 272) {
			@SendMessage(1001, "save");
		} else if(var_11_int == 274) {
			@SendMessage(1000, "save");
		}
	...
	{
		int var_12_int;
		func_140(var_12_int, var_1_int);
		int var_11_int;
		var_12_int = var_11_int;
		func_143(var_4_int, var_5_int, var_6_int, var_7_int, var_8_object, var_9_object, var_10_object, var_11_int);
	}
	...
	void event_200(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, string var_12_string, object var_13_object)
	{
		if(var_12_string == "scrollbar") {
			...
			int var_17_int;
			func_556(var_16_int, var_17_int);
			var_1_int = (var_16_int * (var_17_int - var_5_int)) / 100;
			func_564(var_12_string, var_13_object);
		} else if(var_11_int == 1000) {
				func_400(var_13_object);
		}
	Label_374:
		for(;;) {
		...
		if(!(var_11_int == 1001)) goto Label_374;
		func_387(var_13_object);
	}
	...
	void OnPlayerHolsterWeapon(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int, float var_13_float)
	{
		...
		int var_14_int;
		func_564(var_14_int, var_15_int);
	}
	...
	void OnStopSee(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int)
	{
		...
		func_476(var_14_int, var_15_int, var_13_int, var_14_int, var_15_int);
		var_2_int = var_13_int;
		int var_36_int; int var_37_int; int var_38_int;
		func_515(var_37_int, var_38_int, var_36_int, var_37_int, var_38_int);
	...
	void OnHear(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, int var_11_int, int var_12_int)
	{
		...
		if(var_2_int != -1) {
			...
			func_476(var_15_object, var_16_object, var_19_int, var_20_int, var_21_int);
...
void func_515(int var_1_int, object var_9_object, int var_50_int, int var_51_int, int var_52_int)
{
	if(var_51_int < 248) {
		var_50_int = -1;
		return 8;
...
void func_387(int var_1_int)
{
	int var_55_int;
	func_554(var_55_int);
	int var_53_int = (2 * var_55_int) / 2;
	var_1_int += var_53_int;
	int var_52_int;
	func_564(var_52_int, var_53_int);
}


void func_73(bool var_0_bool, int var_1_int, int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_8_object, object var_9_object, object var_10_object, bool var_12_bool)
{
	...
	for(;;) {
		if(1 != 0) {
			...
			if(!var_17_object) { //@nz
				...
				if(var_12_bool == 0) goto Label_104;
				var_17_object->IsQuickSave(var_18_bool);
				if(var_18_bool == 0) goto Label_104;
			}
		}
		...
		func_564(var_17_object, var_18_bool);
		@ProcessEvents();
		return 6;
...
// @pe
void func_140(int var_12_int, int var_13_int)
{
...
// @pe
void func_44(object var_143_object, int var_144_int, int var_145_int)
{
	if(var_143_object == null)
		@Blit("button_save", var_144_int, var_145_int);
	else
		@Blit("button_overwrite", var_144_int, var_145_int);
	
}


void func_556(object var_9_object, int var_29_int)
{
	int var_31_int;
...
void func_143(int var_2_int, int var_3_int, int var_4_int, int var_5_int, int var_6_int, int var_7_int, object var_9_object, int var_11_int)
{
	...
	for(;;) {
				...
				if(var_29_bool != 0) {
					...
					@Print("default", 129, (7 + var_37_int), var_68_string, 0.5568628, 0.5568628, 0.5568628);
							...
							if(var_31_bool != 0) {
								...
								func_598(var_168_string, (500 + var_32_int));
								var_168_string = var_30_string;
							} else {
								var_30_string = "????";
			}
							int var_179_int;
							var_11_int = var_179_int;
							func_308(0, var_179_int, true);
							string var_185_string;
							func_598(var_185_string, 32);
							@Print("default", 129, (47 + var_11_int), var_185_string, 0.5568628, 0.5568628, 0.5568628);
		}
					}
		...
		func_603(var_75_string, var_76_object);
		...
		func_627(var_106_string, var_107_object);
	...
	Label_270:
		...
		func_44(var_143_object, 129, (67 + var_11_int));
		var_11_int += 90;
...
void func_400(int var_1_int)
{
	int var_47_int;
	func_554(var_47_int);
	int var_45_int = (-2 * var_47_int) / 2;
	var_1_int += var_45_int;
	int var_44_int;
	func_564(var_44_int, var_45_int);
}


void func_60(object var_76_object)
{
...
void func_627(string var_106_string, object var_107_object)
{
	...
	func_598(var_120_string, 19);
	string var_122_string;
	func_598(var_122_string, (20 + var_119_int));
...
void func_564(int var_1_int, int var_5_int)
{
	int var_28_int;
	int var_29_int;
	func_556(var_28_int, var_29_int);
...
// @pe
void func_308(int var_36_int, int var_37_int, bool var_38_bool)
{
	if(var_38_bool != 0)
...
void func_598(string var_68_string, int var_69_int)
{
...
// @pe
void func_55(object var_44_object)
{
	@SendMessageToParent(0, var_44_object);
}


void func_603(string var_75_string, object var_76_object)
{
	float var_83_float;
	var_76_object->GetGameTime(var_83_float);
	string var_95_string;
	func_598(var_95_string, 18);
...
void func_476(int var_1_int, object var_9_object, int var_19_int, int var_20_int, int var_21_int)
{
	if(var_20_int < 129) {
		var_19_int = -1;
		return 8;
