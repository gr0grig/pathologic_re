maintask task_0
{
	...
	{
		string var_15_string; int var_16_int; int var_17_int;
		if(!var_2_object) { //@nz
		}
		...
		if(var_21_bool != 0) {
			var_15_string = (var_0_int + "/") + var_1_int;
			@GetTextWidth(var_16_int, "default", var_15_string);
			if((48 - var_16_int) < 2)
				var_17_int = 2;
			@Print("default", var_17_int, 35, var_15_string);
		}
		if(var_3_bool != 0)
	...
	void event_200(int var_0_int, int var_1_int, object var_2_object, bool var_3_bool, string var_4_string, bool var_5_bool, bool var_6_bool, string var_7_string, string var_8_string, string var_9_string, string var_10_string, int var_11_int, int var_12_int, string var_13_string, object var_14_object)
	{
		...
		if(var_12_int == -13) {
			if(var_5_bool != 0)
				func_121(var_16_int, var_7_string);
			return 2;
		}
		if(var_12_int == -14) {
			if(var_5_bool != 0)
				func_121(var_16_int, var_8_string);
			return 2;
		}
		if(var_12_int == -15) {
			if(var_5_bool != 0)
				func_121(var_16_int, var_9_string);
			return 2;
		}
		if(var_12_int == -16) {
			if(var_5_bool != 0)
				func_121(var_16_int, var_10_string);
			return 2;
		}
		if(var_12_int == -4) {
			var_5_bool = true;
...
// @pe
void func_337(string var_18_string, int var_19_int)
{
	if((var_19_int + 1) < 10)
...
// @pe
void func_353(string var_31_string, int var_32_int)
{
	if((var_32_int + 1) < 10)
...
void func_121(bool var_5_bool, string var_49_string)
{
