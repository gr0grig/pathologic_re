...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_bdf_a0_i());
		L0->SetNPCDescription(f_bdd_a0_i());
		L0->SetPhoto(f_be1_a0_s());
		L0->SetPhoto2(f_be3_a0_s());
		L0->SetPlayerName(f_dd3_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_c93_a1_b(tv1) && f_c7b_a1_b(tv1) && !f_cb5_a1_b(tv1)) {
				tv0->AddReply(531048, 32378, 32377);
			}
			if (f_ca9_a1_b(tv1) && !f_c9d_a1_b(tv1) && f_cc1_a1_b(tv1)) {
...
task t6
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_ccd_a1_b(tv1) && f_cd9_a1_b(tv1)) {
...
maintask t13
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_91d_a0_v();
			if (f_9fa_a0_b() && f_8fe_a0_b()) {
				if (f_8ea_a0_b()) {
					f_a90_a1_b(f_b6c_a0_o());
				}
			} else {
				f_8f9_a0_v();
				f_914_a0_v();
...
void f_98c_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_9fa_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_bc5_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_9ff_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_b72_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	return f_ae8_a2_b(a0, 70);
}

bool f_ae8_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_b18_a1_v(object a0)
{
	@CameraSwitchToNormal(true);
}

void f_b1d_a1_v(string a0)
{
	bool L0;
...
void f_b2d_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_b52_a3_v(string a0, int a1, int a2)
{
	if (f_b7c_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
void f_b5d_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_b7c_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
void f_b92_a2_v(object a0, int a1)
{
...
bool f_ba5_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_bbf_a1_b(int a0)
{
	return f_bb6_a0_i() == a0;
}

string f_bc5_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_bcc_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_bc5_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_be1_a0_s(void)
{
	return "ui/NPC_Andrei.png";
}

string f_be3_a0_s(void)
{
	return "ui/NPC_Andrei_b.png";
}

bool f_be5_a0_b(void)
{
	return true;
}

void f_be7_a2_v(object a0, object a1)
{
	@SetVariable("oob5Andrei1", 1);
}

void f_bed_a2_v(object a0, object a1)
{
...
void f_bfd_a2_v(object a0, object a1)
{
...
void f_c09_a2_v(object a0, object a1)
{
	...
	f_cfc_a0_v();
	f_d09_a0_v();
	f_ba5_a2_b("quest_b2_03", "place_maria");
}
...
void f_c1a_a2_v(object a0, object a1)
{
	...
	int L1;
	L0 = f_d73_a0_o();
	L0->AddMark("b2q03GoodShop", "pt_b2q03_good_shop", 3, 531061, f_bb1_a0_f());
	f_d16_a0_v();
	a0->RemoveItemByType(L1, "grass_brown_tvir", 10);
	f_ba5_a2_b("quest_b2_03", "completed");
}

void f_c36_a2_v(object a0, object a1)
{
	@SetVariable("b2AndreiVisit", 1);
}

void f_c3c_a2_v(object a0, object a1)
{
	f_d84_a3_v(f_d73_a0_o(), "pt_b2q03_good_shop", 2);
	a1->ShowMap(f_d73_a0_o());
}

void f_c4c_a2_v(object a0, object a1)
{
...
void f_c58_a2_v(object a0, object a1)
{
	if (f_b81_a1_i("b2q03_1") != 0) {
		f_d3d_a0_v();
	}
}
...
bool f_c9d_a1_b(object a0)
{
	if (f_b81_a1_i("b2q03") == 1000) {
		return true;
	}
	return false;
}

bool f_ca9_a1_b(object a0)
{
	if (f_b81_a1_i("b2q03_1") == 1) {
		return true;
	}
	return false;
}

bool f_cb5_a1_b(object a0)
{
	if (f_b81_a1_i("b2q03_1") == 2) {
		return true;
	}
	return false;
}

bool f_cc1_a1_b(object a0)
{
	if (f_b81_a1_i("oob2Andrei3") == 0) {
		return true;
	}
	return false;
}

bool f_ccd_a1_b(object a0)
{
	if (f_b81_a1_i("b5q01") == 1) {
		return true;
	}
	return false;
}

bool f_cd9_a1_b(object a0)
{
	if (f_b81_a1_i("oob5Andrei1") == 0) {
		return true;
	}
	return false;
}

bool f_ce5_a1_b(object a0)
{
	if (f_b81_a1_i("oob2Andrei1") == 0) {
		return true;
	}
	return false;
}
...
bool f_d57_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_d84_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
void f_da5_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L0 = f_bb6_a0_i();
	f_b5d_a4_v("samopal_ammo", 1, 1, 6);
	f_b5d_a4_v("rifle_ammo", 1, 1, 8);
	f_b5d_a4_v("revolver_ammo", 1, 1, 8);
	f_b5d_a4_v("tvirin", 1, 1, 3);
	if (L0 >= 5) {
		f_b52_a3_v("Samopal", 1, 1);
	}
}
...
void f_de4_a1_v(object a0)
{
	...
	if (L0 != f_bb6_a0_i()) {
		f_da5_a0_v();
		@SetVariable("tr_andrei", f_bb6_a0_i());
	}
	...
	if (f_bbf_a1_b(3) || f_bbf_a1_b(4) || f_bbf_a1_b(6) || f_bbf_a1_b(7) || f_bbf_a1_b(8) || f_bbf_a1_b(9) || f_bbf_a1_b(10) || f_bbf_a1_b(11)) {
		if (1000 == t7{a0}) {
			if (!f_ae0_a1_b(a0)) {
				return;
			}
