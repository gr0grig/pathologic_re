...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_761_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_8d9_a0_i());
		L0->SetNPCDescription(f_8d7_a0_i());
		L0->SetPhoto(f_8db_a0_s());
		L0->SetPhoto2(f_8dd_a0_s());
		L0->SetPlayerName(f_9ef_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_95e_a1_b(tv1) && f_975_a1_b(tv1)) {
				tv0->AddReply(521523, 25213, 22684);
			}
			if (f_947_a1_b(tv1) && f_975_a1_b(tv1)) {
...
maintask t8
{
	...
	bool f_64c_a0_b(void)
	{
		...
		return f_753_a1_b(L0);
	}

	void f_65b_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_660_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_67f_a0_v();
			if (f_75c_a0_b() && f_660_a0_b()) {
				if (f_64c_a0_b()) {
					f_7f2_a1_b(f_877_a0_o());
				}
			} else {
				f_65b_a0_v();
				f_676_a0_v();
...
void f_742_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_761_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_87d_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_7f2_a1_b(object a0)
{
	...
	return f_861_a1_b(L4);
}

bool f_817_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_8b0_a0_i() + "m";
	int L1;
...
void f_852_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_898_a2_v(object a0, int a1)
{
	f_742_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_8b9_a1_b(int a0)
{
	return f_8b0_a0_i() == a0;
}
...
void f_8e1_a2_v(object a0, object a1)
{
	...
	@SetVariable("b8q03", 1);
	L0 = f_9de_a0_o();
	L0->AddMark("b8q03GeorgGotoKaterina", "pt_map_katerina", 0, 530663, f_8ab_a0_f());
	f_981_a0_v();
	f_98e_a0_v();
}

void f_8fb_a2_v(object a0, object a1)
{
	@SetVariable("oob8Georg1", 1);
}

void f_901_a2_v(object a0, object a1)
{
	@SetVariable("oob8Georg2", 1);
}

void f_907_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_90d_a2_v(object a0, object a1)
{
	@SetVariable("b8GeorgVisit", 1);
}

void f_913_a2_v(object a0, object a1)
{
...
void f_925_a2_v(object a0, object a1)
{
	@Trace("money3000 is given");
	f_898_a2_v(a0, 3000);
}

bool f_92f_a1_b(object a0)
{
	if (f_887_a1_i("oob8Georg1") == 0) {
		return true;
	}
	return false;
}

bool f_93b_a1_b(object a0)
{
	if (f_887_a1_i("b8q03") == 0) {
		return true;
	}
	return false;
}

bool f_947_a1_b(object a0)
{
	if (f_887_a1_i("b8q03") == 3 && f_887_a1_i("b8q03MladVladIsVictim") != 0) {
		return true;
	}
	return false;
}

bool f_95e_a1_b(object a0)
{
	if (f_887_a1_i("b8q03") == 3 && f_887_a1_i("b8q03MladVladIsVictim") == 0) {
		return true;
	}
...
bool f_975_a1_b(object a0)
{
	if (f_887_a1_i("oob8Georg2") == 0) {
		return true;
	}
	return false;
}
...
bool f_9c2_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
