...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_8a3_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_a08_a0_i());
		L0->SetNPCDescription(f_a06_a0_i());
		L0->SetPhoto(f_a0a_a0_s());
		L0->SetPhoto2(f_a0c_a0_s());
		L0->SetPlayerName(f_b03_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_a7c_a1_b(tv1) && f_a88_a1_b(tv1)) {
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_a5a_a1_b(tv1) && f_a4e_a1_b(tv1)) {
...
maintask t12
{
	...
	bool f_795_a0_b(void)
	{
		...
		return f_895_a1_b(L0);
	}

	void f_7a4_a0_v(void)
	{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_7c8_a0_v();
			if (f_89e_a0_b() && f_7a9_a0_b()) {
				if (f_795_a0_b()) {
					f_934_a1_b(f_9b9_a0_o());
				}
			} else {
				f_7a4_a0_v();
				f_7bf_a0_v();
...
void f_837_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_89e_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_9ee_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_87c_a0_b(void)
{
	return true;
}

void f_87e_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_883_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_8a3_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_9bf_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_994_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_9ce_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_9e8_a1_b(int a0)
{
	return f_9df_a0_i() == a0;
}

string f_9ee_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_9f5_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_9ee_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_a0a_a0_s(void)
{
	return "ui/NPC_Lara.png";
}

string f_a0c_a0_s(void)
{
	return "ui/NPC_Lara_b.png";
}

bool f_a0e_a0_b(void)
{
	return true;
}

void f_a10_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("b4q01", 2);
	L0 = f_ad1_a0_o();
	L0->AddMark("b4q01LaraGotoRubin", "pt_map_warehouse_gangster", 1, 518593, f_9da_a0_f());
	f_a9b_a0_v();
	f_9ce_a2_b("quest_b4_01", "place_rubin");
}
...
void f_a38_a2_v(object a0, object a1)
{
...
{
	f_ae2_a3_v(f_ad1_a0_o(), "pt_map_warehouse_gangster", 2);
	a1->ShowMap(f_ad1_a0_o());
}

bool f_a4e_a1_b(object a0)
{
	if (f_9c9_a1_i("b8q02") == 1) {
		return true;
	}
	return false;
}

bool f_a5a_a1_b(object a0)
{
	if (f_9c9_a1_i("oob8Lara1") == 0) {
		return true;
	}
	return false;
}
...
bool f_a70_a1_b(object a0)
{
	if (f_9c9_a1_i("b4q01") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_9c9_a1_i("b4q01LaraWasBadRep") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_9c9_a1_i("oob4Lara1") == 0) {
		return true;
	}
	return false;
}

bool f_a94_a1_b(object a0)
{
	float L0;
...
bool f_ab5_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_ae2_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
