...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3e2_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_531_a0_i());
		L0->SetNPCDescription(f_52f_a0_i());
		L0->SetPhoto(f_533_a0_s());
		L0->SetPhoto2(f_535_a0_s());
		L0->SetPlayerName(f_539_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t6
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_307_a0_v();
			if (f_3dd_a0_b() && f_2e8_a0_b()) {
				if (f_2d4_a0_b()) {
					f_473_a1_b(f_4f8_a0_o());
				}
			} else {
				f_2e3_a0_v();
				f_2fe_a0_v();
...
bool f_3e2_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_4fe_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_511_a1_b(int a0)
{
	return f_508_a0_i() == a0;
}
