...
maintask t4
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_213_a0_v();
			if (f_2e9_a0_b() && f_1f4_a0_b()) {
				if (f_1e0_a0_b()) {
					f_37f_a1_b(f_404_a0_o());
				}
			} else {
				f_1ef_a0_v();
				f_20a_a0_v();
...
void f_282_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_2e9_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_423_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_2ee_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_40a_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_3df_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_41d_a1_b(int a0)
{
	return f_414_a0_i() == a0;
}

string f_423_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_42a_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_423_a1_s(L0));
		if (!L1) {
			break;
		}
	}
