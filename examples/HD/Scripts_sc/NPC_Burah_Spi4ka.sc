...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_8c6_a0_i());
		L0->SetNPCDescription(f_8c4_a0_i());
		L0->SetPhoto(f_8c8_a0_s());
		L0->SetPhoto2(f_8ca_a0_s());
		L0->SetPlayerName(f_998_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_930_a1_b(tv1) && f_93c_a1_b(tv1)) {
...
maintask t10
{
	...
	bool f_64d_a0_b(void)
	{
		...
		return f_74d_a1_b(L0);
	}

	void f_65c_a0_v(void)
	{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_680_a0_v();
			if (f_756_a0_b() && f_661_a0_b()) {
				if (f_64d_a0_b()) {
					f_7ec_a1_b(f_871_a0_o());
				}
			} else {
				f_65c_a0_v();
				f_677_a0_v();
...
void f_6ef_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_756_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_8ac_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_74d_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_743_a1_b(L0);
}
...
bool f_75b_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_877_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_891_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_8a6_a1_b(int a0)
{
	return f_89d_a0_i() == a0;
}

string f_8ac_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_8b3_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_8ac_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_8c8_a0_s(void)
{
	return "ui/NPC_Spi4ka.png";
}

string f_8ca_a0_s(void)
{
	return "ui/NPC_Spi4ka_b.png";
}

bool f_8cc_a0_b(void)
{
	return true;
}

void f_8ce_a2_v(object a0, object a1)
{
	f_955_a0_v();
	f_962_a0_v();
	f_886_a1_o("quest_b4_02");
	f_891_a2_b("quest_b4_02", "place_boy");
}

void f_8df_a2_v(object a0, object a1)
{
...
void f_8f4_a2_v(object a0, object a1)
{
...
{
	if (f_881_a1_i("b10q04Spi4kaTalk") == 1) {
		return true;
	}
	return false;
}
...
bool f_97c_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
