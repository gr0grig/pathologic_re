...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1c44_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1e0d_a0_i());
		L0->SetNPCDescription(f_1e0b_a0_i());
		L0->SetPhoto(f_1e0f_a0_s());
		L0->SetPhoto2(f_1e11_a0_s());
		L0->SetPlayerName(f_23fc_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2154_a1_b(tv1) && f_2160_a1_b(tv1) && !f_216c_a1_b(tv1)) {
				tv0->AddReply(513125, 14345, 14344);
			}
			if (f_216c_a1_b(tv1) && f_218b_a1_b(tv1)) {
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_21c7_a1_b(tv1) && f_21d3_a1_b(tv1)) {
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			f_b3d_a1_v("Arrogance");
			tv0->SetMessage(512905);
			tv0->ClearReplies();
			if (f_2263_a1_b(tv1) && f_226f_a1_b(tv1)) {
				tv0->AddReply(512906, 40435, 14108);
			}
			if (f_224b_a1_b(tv1) && f_2257_a1_b(tv1)) {
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_221b_a1_b(tv1) && f_21df_a1_b(tv1)) {
				tv0->AddReply(513819, 15047, 15046);
			}
			if (f_20df_a1_b(tv1) && f_20eb_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2203_a1_b(tv1) && f_210f_a1_b(tv1)) {
				tv0->AddReply(514223, 15442, 15441);
			}
			if (f_2103_a1_b(tv1) && f_2126_a1_b(tv1)) {
...
task t11
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			f_17a2_a1_v("Neutral");
			tv0->SetMessage(533096);
			tv0->ClearReplies();
			tv0->AddReply(533097, 34607, 34606);
			tv0->AddReply(533103, 34615, 34614);
			break;
			return;
		}
		if (f_1e13_a0_b()) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 34615) {
				f_17a2_a1_v("Threat");
				tv0->SetMessage(533104);
				tv0->ClearReplies();
				tv0->AddReply(533105, 34617, 34616);
				if (!f_206a_a1_b(tv1)) {
					tv0->AddReply(533125, 34637, 34636);
				}
				return;
			}
			if (a0 == 34637) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533126);
				tv0->ClearReplies();
				if (f_205e_a1_b(tv1)) {
					tv0->AddReply(533127, 34639, 34638);
				}
				if (f_20a3_a1_b(tv1)) {
					tv0->AddReply(533130, 34643, 34642);
				}
				if (f_20af_a1_b(tv1)) {
					tv0->AddReply(533141, 34643, 34654);
				}
				if (f_2097_a1_b(tv1)) {
					tv0->AddReply(533142, 34643, 34656);
				}
				if (f_2132_a1_b(tv1)) {
					tv0->AddReply(533143, 34643, 34658);
				}
				return;
			}
			if (a0 == 34643) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533131);
				tv0->ClearReplies();
				tv0->AddReply(533132, 34645, 34644);
				tv0->AddReply(534457, 34647, 36092);
				tv0->AddReply(534458, 34647, 36094);
				return;
			}
			if (a0 == 34645) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533133);
				tv0->ClearReplies();
				tv0->AddReply(533134, 34647, 34646);
				tv0->AddReply(534459, 34647, 36096);
				return;
			}
			if (a0 == 34647) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533135);
				tv0->ClearReplies();
				tv0->AddReply(533136, 34649, 34648);
				tv0->AddReply(534460, 34619, 36098);
				return;
			}
			if (a0 == 34649) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533137);
				tv0->ClearReplies();
				tv0->AddReply(533138, 34651, 34650);
				return;
			}
			if (a0 == 34651) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533139);
				tv0->ClearReplies();
				tv0->AddReply(533140, 34619, 34652);
				return;
			}
			if (a0 == 34639) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533128);
				tv0->ClearReplies();
				tv0->AddReply(533129, 34643, 34640);
				return;
			}
			if (a0 == 34617) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533106);
				tv0->ClearReplies();
				tv0->AddReply(533107, 34619, 34618);
				tv0->AddReply(534054, 34619, 35636);
				return;
			}
			if (a0 == 34619) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533108);
				tv0->ClearReplies();
				tv0->AddReply(533109, 34621, 34620);
				tv0->AddReply(534055, 35639, 35638);
				return;
			}
			if (a0 == 35639) {
				f_17a2_a1_v("Isee");
				tv0->SetMessage(534056);
				tv0->ClearReplies();
				tv0->AddReply(534057, 34621, 35640);
				tv0->AddReply(534058, 34621, 35642);
				return;
			}
			if (a0 == 34621) {
				f_17a2_a1_v("Isee");
				tv0->SetMessage(533110);
				tv0->ClearReplies();
				tv0->AddReply(533111, 34623, 34622);
				tv0->AddReply(534059, 34623, 35644);
				return;
			}
			if (a0 == 34623) {
				f_17a2_a1_v("Isee");
				tv0->SetMessage(533112);
				tv0->ClearReplies();
				tv0->AddReply(533113, 34625, 34624);
				tv0->AddReply(534461, 34628, 36100);
				return;
			}
			if (a0 == 34625) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533114);
				tv0->ClearReplies();
				tv0->AddReply(533115, -1, 34626);
				tv0->AddReply(533116, 34628, 34627);
				tv0->AddReply(533124, -1, 34635);
				return;
			}
			if (a0 == 34628) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533117);
				tv0->ClearReplies();
				tv0->AddReply(533118, 34630, 34629);
				tv0->AddReply(534462, -1, 36102);
				return;
			}
			if (a0 == 34630) {
				f_17a2_a1_v("Threat");
				tv0->SetMessage(533119);
				tv0->ClearReplies();
				tv0->AddReply(533120, 34632, 34631);
				return;
			}
			if (a0 == 34632) {
				f_17a2_a1_v("Neutral");
				tv0->SetMessage(533121);
				tv0->ClearReplies();
				tv0->AddReply(533122, -1, 34633);
				tv0->AddReply(533123, -1, 34634);
				return;
			}
			if (a0 == 34607) {
				f_17a2_a1_v("Threat");
				tv0->SetMessage(533098);
				tv0->ClearReplies();
				tv0->AddReply(533099, 34609, 34608);
				tv0->AddReply(533102, 34615, 34612);
				return;
			}
			if (a0 == 34609) {
				f_17a2_a1_v("Threat");
				tv0->SetMessage(533100);
				tv0->ClearReplies();
				tv0->AddReply(533101, 34615, 34610);
				return;
			}
			tv3 = true;
			if (f_1e13_a0_b()) {
...
maintask t14
{
	...
	bool f_1b2f_a0_b(void)
	{
		...
		return f_1c36_a1_b(L0);
	}

	void f_1b3e_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_1b43_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_1b62_a0_v();
			if (f_1c3f_a0_b() && f_1b43_a0_b()) {
				if (f_1b2f_a0_b()) {
					f_1cd5_a1_b(f_1d5a_a0_o());
				}
			} else {
				f_1b3e_a0_v();
				f_1b59_a0_v();
...
void f_1bd1_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_1c3f_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_1df3_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_1c25_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_1c36_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1c2c_a1_b(L0);
}

bool f_1c3f_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1c44_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1d60_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1cd5_a1_b(object a0)
{
	...
	return f_1d44_a1_b(L4);
}

bool f_1cfa_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1dd1_a0_i() + "m";
	int L1;
...
void f_1d35_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_1d7a_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1d86_a2_v(object a0, int a1)
{
	f_1c25_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_1d99_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_1dac_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1d99_a3_v(a0, L0, a2);
}

bool f_1db9_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_1dc0_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1dda_a1_b(int a0)
{
	return f_1dd1_a0_i() == a0;
}

bool f_1de0_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_1dfa_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1df3_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1e0b_a0_i(void)
{
	return 515527;
}

int f_1e0d_a0_i(void)
{
	return 513334;
}

string f_1e0f_a0_s(void)
{
	return "ui/NPC_Aglaja.png";
}

string f_1e11_a0_s(void)
{
	return "ui/NPC_Aglaja_b.png";
}

bool f_1e13_a0_b(void)
{
	return true;
}
...
void f_1e21_a2_v(object a0, object a1)
{
...
void f_1e2b_a2_v(object a0, object a1)
{
	...
	f_2339_a0_v();
	f_2346_a0_v();
	f_1d6f_a1_o("quest_d7_03");
}

void f_1e3b_a2_v(object a0, object a1)
{
	@SetVariable("d7q03", 4);
	f_2353_a0_v();
	f_1dc0_a2_b("quest_d7_03", "init_house_petr");
}

void f_1e49_a2_v(object a0, object a1)
{
	@Trace("burah_serum is given");
	f_1dac_a3_v(a0, "burah_serum", 1);
}

void f_1e54_a2_v(object a0, object a1)
{
	f_22aa_a0_v();
	f_1dc0_a2_b("quest_d10_02", "completed");
}

void f_1e5e_a2_v(object a0, object a1)
{
	@SetVariable("d11q05", 1);
	f_22de_a0_v();
	f_22eb_a0_v();
	f_1d6f_a1_o("quest_d11_05");
}

void f_1e6e_a2_v(object a0, object a1)
{
	@SetVariable("ood8Aglaja3", 1);
}

void f_1e74_a2_v(object a0, object a1)
{
	@SetVariable("d8AglajaVisit", 1);
}

void f_1e7a_a2_v(object a0, object a1)
{
	@SetVariable("d10AglajaVisit", 1);
}

void f_1e80_a2_v(object a0, object a1)
{
	@SetVariable("ood9Aglaja6", 1);
}

void f_1e86_a2_v(object a0, object a1)
{
	@SetVariable("d9AglajaVisit", 1);
}

void f_1e8c_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d9q05", 1);
	L0 = f_23ca_a0_o();
	L0->AddMark("d9q05AglajaGotoBurah", "pt_map_mat", 0, 515304, f_1dcc_a0_f());
	f_237a_a0_v();
	f_2387_a0_v();
	f_1d6f_a1_o("quest_d9_05");
}

void f_1eaa_a2_v(object a0, object a1)
{
	f_2394_a0_v();
	f_1dc0_a2_b("quest_d9_05", "completed");
}

void f_1eb4_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "d10q01_blueprint", 1);
}

void f_1eba_a2_v(object a0, object a1)
{
	if (f_1d6a_a1_i("map_chertez_state") <= 1) {
		@SetVariable("map_chertez_state", 1);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_1ecb_a2_v(object a0, object a1)
{
	f_23db_a3_v(f_23ca_a0_o(), "pt_map_aglaja", -1);
	a1->ShowMap(f_23ca_a0_o());
}

void f_1edb_a2_v(object a0, object a1)
{
...
void f_1ee7_a2_v(object a0, object a1)
{
	@SetVariable("ood12AglajaNight1", 1);
}

void f_1eed_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1ef3_a2_v(object a0, object a1)
{
...
void f_1f03_a2_v(object a0, object a1)
{
	...
	@SetVariable("d7q01", 1);
	L0 = f_23ca_a0_o();
	L0->AddMark("d7q01AglajaGotoBirdmaskSelf", "pt_map_aglaja", 1, 515410, f_1dcc_a0_f());
	L0->AddMark("d7q01BirdmaskD", "pt_map_d7q01_dbirdmask", 1, 515408, f_1dcc_a0_f());
	L0->AddMark("d7q01BirdmaskM", "pt_map_d7q01_mbirdmask", 1, 515409, f_1dcc_a0_f());
	L0->AddMark("d7q01BirdmaskU", "pt_map_d7q01_ubirdmask", 1, 515407, f_1dcc_a0_f());
	f_22f8_a0_v();
	f_2305_a0_v();
	f_1dc0_a2_b("quest_d7_01", "place_birdmasks");
}
...
void f_1f43_a2_v(object a0, object a1)
{
	...
	@SetVariable("d7q01", 2);
	L0 = f_23ca_a0_o();
	L0->AddMark("d7q01AglajaFindLierSelf", "pt_map_aglaja", 1, 515411, f_1dcc_a0_f());
	f_231f_a0_v();
...
void f_1f72_a2_v(object a0, object a1)
{
	...
	f_2312_a0_v();
	f_1dc0_a2_b("quest_d7_01", "completed");
}
...
void f_1fae_a2_v(object a0, object a1)
{
	...
	f_2360_a0_v();
	f_236d_a0_v();
	f_1dc0_a2_b("quest_d8_01", "block_well");
}

void f_1fbf_a2_v(object a0, object a1)
{
	@SetVariable("ood8Aglaja1", 1);
}

void f_1fc5_a2_v(object a0, object a1)
{
	@SetVariable("ood8Aglaja2", 1);
}

void f_1fcb_a2_v(object a0, object a1)
{
...
void f_1fd7_a2_v(object a0, object a1)
{
	...
	f_22b7_a0_v();
	f_22c4_a0_v();
	f_1dc0_a2_b("quest_d11_01", "init_girl");
	f_1dc0_a2_b("quest_d11_01", "remove_andrei");
}

void f_1fed_a2_v(object a0, object a1)
{
	f_22d1_a0_v();
	f_1dc0_a2_b("quest_d11_01", "completed");
}

void f_1ff7_a2_v(object a0, object a1)
{
...
void f_200f_a2_v(object a0, object a1)
{
	...
	L0 = f_23ca_a0_o();
	L0->AddMark("d10q01AglajaGotoPetr", "pt_map_petr", 1, 515451, f_1dcc_a0_f());
	f_2283_a0_v();
	f_2290_a0_v();
	f_1dc0_a2_b("quest_d10_01", "init_house");
}

void f_202e_a2_v(object a0, object a1)
{
	@SetVariable("ood10Aglaja1", 1);
}

void f_2034_a2_v(object a0, object a1)
{
	object L0;
	object L1;
	L0 = f_23ca_a0_o();
	...
	f_229d_a0_v();
	f_1dc0_a2_b("quest_d10_01", "completed");
}

void f_2052_a2_v(object a0, object a1)
{
	@SetVariable("ood10Aglaja2", 1);
}

void f_2058_a2_v(object a0, object a1)
{
	@SetVariable("d11AglajaVisit", 1);
}

bool f_205e_a1_b(object a0)
{
	if (f_1d6a_a1_i("d6q01KlaraVolonteer") != 0) {
		return true;
	}
	return false;
}

bool f_206a_a1_b(object a0)
{
	if (f_1d6a_a1_i("d6q01JuliaVolonteer") == 0 && f_1d6a_a1_i("d6q01KlaraVolonteer") == 0 && f_1d6a_a1_i("d6q01LaraVolonteer") == 0 && f_1d6a_a1_i("d6q01OspinaVolonteer") == 0) {
		return true;
	}
	return false;
}

bool f_2097_a1_b(object a0)
{
	if (f_1d6a_a1_i("d6q01JuliaVolonteer") != 0) {
		return true;
	}
	return false;
}

bool f_20a3_a1_b(object a0)
{
	if (f_1d6a_a1_i("d6q01LaraVolonteer") != 0) {
		return true;
	}
	return false;
}

bool f_20af_a1_b(object a0)
{
	if (f_1d6a_a1_i("d6q01OspinaVolonteer") != 0) {
		return true;
	}
	return false;
}

bool f_20bb_a1_b(object a0)
{
	if (f_1d6a_a1_i("d7q03") == 3) {
		return true;
	}
	return false;
}

bool f_20c7_a1_b(object a0)
{
	if (f_1d6a_a1_i("d10q02") == 4) {
		return true;
	}
	return false;
}

bool f_20d3_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood8Aglaja3") == 0) {
		return true;
	}
	return false;
}

bool f_20df_a1_b(object a0)
{
	if (f_1d6a_a1_i("d9q01") == 1000) {
		return true;
	}
	return false;
}

bool f_20eb_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood9Aglaja6") == 0) {
		return true;
	}
	return false;
}

bool f_20f7_a1_b(object a0)
{
	if (f_1d6a_a1_i("d9q05") == 2) {
		return true;
	}
	return false;
}

bool f_2103_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood11Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_210f_a1_b(object a0)
{
	if (f_1db9_a2_b(a0, "d11q01_blueprint")) {
		return true;
	}
	return false;
}

bool f_211a_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood12AglajaNight1") == 0) {
		return true;
	}
	return false;
}

bool f_2126_a1_b(object a0)
{
	if (f_1d6a_a1_i("d11RotaTalk") != 0) {
		return true;
	}
	return false;
}

bool f_2132_a1_b(object a0)
{
	if (f_2279_a1_b(a0)) {
		return true;
	}
...
{
	if (f_1db9_a2_b(a0, "d7q01_dreport") && f_1db9_a2_b(a0, "d7q01_mreport") && f_1db9_a2_b(a0, "d7q01_ureport")) {
		return true;
	}
	return false;
}

bool f_218b_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood7Aglaja5") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1d6a_a1_i("d8q01") == 0) {
		return true;
	}
	return false;
}

bool f_21bb_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood8Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_21c7_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood8Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_21d3_a1_b(object a0)
{
	if (f_1d6a_a1_i("d8TermitnikLoad") != 0) {
		return true;
	}
	return false;
}

bool f_21df_a1_b(object a0)
{
	if (f_1d6a_a1_i("d9TalkToPolkovodec") != 0) {
		return true;
	}
	return false;
}

bool f_21eb_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood11Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_21f7_a1_b(object a0)
{
	if (f_1d6a_a1_i("d11q01") == 0) {
		return true;
	}
	return false;
}

bool f_2203_a1_b(object a0)
{
	if (f_1d6a_a1_i("d11q01") == 4) {
		return true;
	}
	return false;
}

bool f_220f_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood9Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_221b_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood9Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_2227_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood9Aglaja4") == 0) {
		return true;
	}
	return false;
}

bool f_2233_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood9Aglaja5") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1d6a_a1_i("ood10Aglaja1") == 0) {
		return true;
	}
	return false;
}

bool f_224b_a1_b(object a0)
{
	if (f_1d6a_a1_i("d10q01") == 1000) {
		return true;
	}
	return false;
}

bool f_2257_a1_b(object a0)
{
	if (f_1d6a_a1_i("ood10Aglaja2") == 0) {
		return true;
	}
	return false;
}

bool f_2263_a1_b(object a0)
{
	if (f_1d6a_a1_i("d10q01") == 3) {
		return true;
	}
	return false;
}

bool f_226f_a1_b(object a0)
{
	if (f_227c_a1_b(a0)) {
		return true;
	}
...
bool f_23ae_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_23db_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
