...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_15ab_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_176b_a0_i());
		L0->SetNPCDescription(f_1769_a0_i());
		L0->SetPhoto(f_176d_a0_s());
		L0->SetPhoto2(f_176f_a0_s());
		L0->SetPlayerName(f_1c8e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			f_225_a1_v("Adoration");
			tv0->SetMessage(512719);
			tv0->ClearReplies();
			if (f_1b37_a1_b(tv1) && f_1b13_a1_b(tv1)) {
				tv0->AddReply(512720, 4261, 13913);
			}
			if (f_1b1f_a1_b(tv1) && f_1b43_a1_b(tv1)) {
				tv0->AddReply(512721, 13915, 13914);
			}
			if (f_1b5b_a1_b(tv1) && !f_1b67_a1_b(tv1) && !f_1b73_a1_b(tv1) && f_1b7f_a1_b(tv1)) {
	...
	void OnDialogReply(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 40688) {
				...
				tv0->ClearReplies();
				tv0->AddReply(538772, 13919, 40689);
				return;
			}
			if (a0 == 13917) {
				f_225_a1_v("Fear");
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1afb_a1_b(tv1) && f_19ff_a1_b(tv1)) {
				f_1929_a2_v(tv1, tv0);
				f_53e_a1_v("Fear");
			...
			if (f_19f3_a1_b(tv1) && f_1b07_a1_b(tv1)) {
				f_192f_a2_v(tv1, tv0);
				f_53e_a1_v("Adoration");
			...
			if (f_1b2b_a1_b(tv1) && f_1a0b_a1_b(tv1) && !f_19e7_a1_b(tv1)) {
				tv0->AddReply(506583, 5521, 7252);
			}
			if (f_1a17_a1_b(tv1) && f_19f3_a1_b(tv1) && f_1b4f_a1_b(tv1)) {
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1a6b_a1_b(tv1) && f_1a83_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_1a9b_a1_b(tv1) && f_1aa7_a1_b(tv1)) {
				tv0->AddReply(511346, 12544, 12543);
			}
			if (f_1aa7_a1_b(tv1) && !f_1ab3_a1_b(tv1) && !f_1a9b_a1_b(tv1)) {
				tv0->AddReply(511473, 12680, 12679);
			}
			if (f_1acb_a1_b(tv1) && f_1abf_a1_b(tv1)) {
...
task t11
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1ad7_a1_b(tv1) && f_1a5f_a1_b(tv1)) {
				f_17e9_a2_v(tv1, tv0);
				f_1826_a2_v(tv1, tv0);
				f_de1_a1_v("Adoration");
			...
			if (f_1aef_a1_b(tv1) && f_1b8b_a1_b(tv1)) {
...
task t13
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_1a2f_a1_b(tv1) && f_1a3b_a1_b(tv1)) {
				f_1800_a2_v(tv1, tv0);
				f_182c_a2_v(tv1, tv0);
				f_1122_a1_v("Adoration");
			...
			tv0->ClearReplies();
			if (f_1a47_a1_b(tv1) && !f_1a2f_a1_b(tv1)) {
...
maintask t18
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_14c9_a0_v();
			if (f_15a6_a0_b() && f_14aa_a0_b()) {
				if (f_1496_a0_b()) {
					f_163c_a1_b(f_16c1_a0_o());
				}
			} else {
				f_14a5_a0_v();
				f_14c0_a0_v();
...
void f_1538_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_15a6_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_1751_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_157d_a0_b(void)
{
	return true;
}

void f_157f_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1584_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_158c_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_159d_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1593_a1_b(L0);
}

bool f_15a6_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_15ab_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_16c7_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_163c_a1_b(object a0)
{
	...
	return f_16ab_a1_b(L4);
}

bool f_1661_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1742_a0_i() + "m";
	int L1;
...
void f_169c_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_16e1_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
void f_16f2_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_16fe_a2_v(object a0, int a1)
{
	f_158c_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_1711_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_1724_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1711_a3_v(a0, L0, a2);
}

bool f_1731_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_174b_a1_b(int a0)
{
	return f_1742_a0_i() == a0;
}

string f_1751_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_1758_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1751_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1769_a0_i(void)
{
	return 515530;
}

int f_176b_a0_i(void)
{
	return 502856;
}

string f_176d_a0_s(void)
{
	return "ui/NPC_Anna.png";
}

string f_176f_a0_s(void)
{
	return "ui/NPC_Anna_b.png";
}

bool f_1771_a0_b(void)
{
	return true;
}
...
void f_177c_a2_v(object a0, object a1)
{
	@SetVariable("KnowKapella", 1);
}

void f_1782_a2_v(object a0, object a1)
{
	@Trace("beta_pills 5 is given");
	f_1724_a3_v(a0, "beta_pills", 5);
}

void f_178d_a2_v(object a0, object a1)
{
	@Trace("money1000 is given");
	f_16fe_a2_v(a0, 1000);
}

void f_1797_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_179d_a2_v(object a0, object a1)
{
	@Trace("gold_ring is given");
	f_1724_a3_v(a0, "gold_ring", 1);
}

void f_17a8_a2_v(object a0, object a1)
{
	f_1c6d_a3_v(f_1c5c_a0_o(), "pt_map_station", 2);
	a1->ShowMap(f_1c5c_a0_o());
}
...
void f_17b8_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_1c5c_a0_o();
	L0->AddMark("d1q01AnnaMapMarkMladVlad", "pt_map_mladvlad", 3, 508689, f_173d_a0_f());
}

void f_17c8_a2_v(object a0, object a1)
{
	@Trace("silver_ring is given");
	f_1724_a3_v(a0, "silver_ring", 1);
}

void f_17d3_a2_v(object a0, object a1)
{
	@Trace("bracelet is given");
	f_1724_a3_v(a0, "bracelet", 1);
}

void f_17de_a2_v(object a0, object a1)
{
	@Trace("beads is given");
	f_1724_a3_v(a0, "beads", 1);
}

void f_17e9_a2_v(object a0, object a1)
{
...
void f_17f5_a2_v(object a0, object a1)
{
	@Trace("burah_serum is given");
	f_1724_a3_v(a0, "burah_serum", 1);
}

void f_1800_a2_v(object a0, object a1)
{
	@SetVariable("ood9Anna1", 1);
}

void f_1806_a2_v(object a0, object a1)
{
	@SetVariable("d9q04", 1);
	f_1c0c_a0_v();
	f_1c19_a0_v();
...
void f_1812_a2_v(object a0, object a1)
{
	@Trace("Gun_danko is given");
	f_1724_a3_v(a0, "Gun_danko", 1);
}
...
void f_1826_a2_v(object a0, object a1)
{
	@SetVariable("ood5Anna2", 1);
}

void f_182c_a2_v(object a0, object a1)
{
	@SetVariable("d9AnnaVisit", 1);
}

void f_1832_a2_v(object a0, object a1)
{
	f_1be5_a0_v();
}

void f_1837_a2_v(object a0, object a1)
{
	@SetVariable("ood2Anna1", 1);
}

void f_183d_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d2q01", 2);
	L0 = f_1c5c_a0_o();
	L0->AddMark("d2q01AnnaGotoKapella", "pt_map_kapella", 1, 511388, f_173d_a0_f());
	f_1bb1_a0_v();
}

void f_1854_a2_v(object a0, object a1)
{
	f_1c6d_a3_v(f_1c5c_a0_o(), "pt_map_laska", 2);
	a1->ShowMap(f_1c5c_a0_o());
}
...
void f_1864_a2_v(object a0, object a1)
{
	...
	@SetVariable("d1q02", 2);
	L0 = f_1c5c_a0_o();
	L0->AddMark("d1q02AnnaGotoLaska", "pt_map_laska", 0, 508635, f_173d_a0_f());
	f_1b97_a0_v();
	f_1731_a2_b("quest_d1_02", "init_storojka");
}

void f_1880_a2_v(object a0, object a1)
{
	f_1c6d_a3_v(f_1c5c_a0_o(), "pt_map_kapella", 2);
	a1->ShowMap(f_1c5c_a0_o());
}
...
{
	if (f_16d1_a1_i("d4q02AnnaGivesMedcine") == 1 && f_16d1_a1_i("d4q02JuliaGivesMedcine") == 1 && f_16d1_a1_i("d4q02LaraGivesMedcine") == 1) {
		object L0;
		@SetVariable("d4q02", 2);
		L0 = f_1c5c_a0_o();
		L0->AddMark("d4q02BirdmaskNearHome", "pt_d4q02_birdmask", 0, 511842, f_173d_a0_f());
		f_1731_a2_b("quest_d4_02", "birdmask");
		f_1c6d_a3_v(f_1c5c_a0_o(), "pt_d4q02_birdmask", 2);
		a1->ShowMap(f_1c5c_a0_o());
	}
}

void f_18e0_a2_v(object a0, object a1)
{
	@SetVariable("ood4Anna2", 1);
}

void f_18e6_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d5q02", 1);
	L0 = f_1c5c_a0_o();
	L0->AddMark("d5q02AnnaGotoGorbun", "pt_map_gorbun", 0, 515360, f_173d_a0_f());
	L0->AddMark("d5q02AnnaGotoGorbunSelf", "pt_map_anna", 0, 515361, f_173d_a0_f());
	f_1bbe_a0_v();
	f_1bcb_a0_v();
	f_16d6_a1_o("quest_d5_02");
	f_1731_a2_b("quest_d5_02", "place_gorbun");
}

void f_1912_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d5q02", 3);
	L0 = f_1c5c_a0_o();
	L0->AddMark("d5q02AnnaGotoKabak", "pt_map_andrei", 0, 515363, f_173d_a0_f());
	f_1bd8_a0_v();
}

void f_1929_a2_v(object a0, object a1)
{
	@SetVariable("ood1Anna1", 1);
}

void f_192f_a2_v(object a0, object a1)
{
	@SetVariable("ood1Anna2", 1);
}

void f_1935_a2_v(object a0, object a1)
{
	if (f_16d1_a1_i("d5q01") < 7 && f_16d1_a1_i("d5q01") != -1) {
		f_1731_a2_b("quest_d5_02", "place_girl");
	}
}
...
{
	if (f_16d1_a1_i("d6q01KnowKillerIsKlara") == 0) {
		object L0;
		@SetVariable("d6q01KnowKillerIsKlara", 1);
		L0 = f_1c5c_a0_o();
		L0->AddMark("d6q01KillerIsKlara", "pt_map_alexandr", 1, 515396, f_173d_a0_f());
		f_1bff_a0_v();
		f_1731_a2_b("quest_d6_01", "saburov_klara");
	}
}

void f_1989_a2_v(object a0, object a1)
{
	@SetVariable("KnowAnna", 1);
}

void f_198f_a2_v(object a0, object a1)
{
	f_1bf2_a0_v();
	@Trace("anna blood is given");
	f_1724_a3_v(a0, "d6q01_anna_blood", 1);
}
...
void f_19a9_a2_v(object a0, object a1)
{
	...
	f_1724_a3_v(a0, "beta_pills", 1);
}

void f_19b4_a2_v(object a0, object a1)
{
	@Trace("gamma_pills is given");
	f_1724_a3_v(a0, "gamma_pills", 1);
}

void f_19bf_a2_v(object a0, object a1)
{
	@Trace("delta_pills is given");
	f_1724_a3_v(a0, "delta_pills", 1);
}

void f_19ca_a2_v(object a0, object a1)
{
	@SetVariable("ood5Anna1", 1);
}

void f_19d0_a2_v(object a0, object a1)
{
	f_1c6d_a3_v(f_1c5c_a0_o(), "pt_map_gorbun", 2);
	a1->ShowMap(f_1c5c_a0_o());
}

void f_19e0_a2_v(object a0, object a1)
{
	f_16e1_a2_v("lc_House6_05@door1", false);
}

bool f_19e7_a1_b(object a0)
{
	if (f_16d1_a1_i("d1q01") == 1000) {
		return true;
	}
	return false;
}
...
{
	if (f_16d1_a1_i("d1q01FirstGeorgVisit") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_16d1_a1_i("d4q02AnnaGivesMedcine") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_16d1_a1_i("d5q02KnowNudeIsDead") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_16d1_a1_i("microscope_d6q01_anna_blood") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_16d1_a1_i("ood5Anna1") == 0) {
		return true;
	}
	return false;
}

void f_1b97_a0_v(void)
{
	object L0;
...
bool f_1c40_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1c6d_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
