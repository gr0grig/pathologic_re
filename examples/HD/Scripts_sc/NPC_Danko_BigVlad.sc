...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1d7f_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1ef7_a0_i());
		L0->SetNPCDescription(f_1ef5_a0_i());
		L0->SetPhoto(f_1ef9_a0_s());
		L0->SetPhoto2(f_1efb_a0_s());
		L0->SetPlayerName(f_2579_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_23bf_a1_b(tv1) && f_2413_a1_b(tv1)) {
				f_210a_a2_v(tv1, tv0);
				f_21ce_a2_v(tv1, tv0);
				f_22a_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_23bf_a1_b(tv1) && f_23cb_a1_b(tv1)) {
				tv0->AddReply(512027, 13248, 13245);
			}
			if (f_239b_a1_b(tv1) && f_23a7_a1_b(tv1) && !f_2383_a1_b(tv1) && !f_238f_a1_b(tv1) && !f_23b3_a1_b(tv1) && !f_2377_a1_b(tv1)) {
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_225b_a1_b(tv1) && f_2295_a1_b(tv1)) {
				f_1f46_a2_v(tv1, tv0);
				f_575_a1_v("Neutral");
			...
			if (f_2267_a1_b(tv1) && f_22a1_a1_b(tv1)) {
				f_1f4c_a2_v(tv1, tv0);
				f_575_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_2273_a1_b(tv1) && f_2295_a1_b(tv1)) {
				tv0->AddReply(507084, 7809, 7807);
			}
			if (f_227f_a1_b(tv1) && f_2437_a1_b(tv1)) {
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_22ad_a1_b(tv1) && f_22b9_a1_b(tv1)) {
				tv0->AddReply(508977, 9847, 9846);
			}
			if (f_2212_a1_b(tv1) && f_22dd_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_22e9_a1_b(tv1) && f_22f5_a1_b(tv1)) {
				f_21b5_a2_v(tv1, tv0);
				f_df6_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_2301_a1_b(tv1) && f_230d_a1_b(tv1)) {
				tv0->AddReply(510839, 11148, 11983);
			}
			if (f_228b_a1_b(tv1)) {
				tv0->AddReply(510838, 10519, 11982);
			}
			if (f_2319_a1_b(tv1) && f_224f_a1_b(tv1)) {
				tv0->AddReply(511508, 12709, 12708);
			}
			if (f_2337_a1_b(tv1) && f_2353_a1_b(tv1)) {
...
task t13
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_23ef_a1_b(tv1) && f_23d7_a1_b(tv1)) {
				tv0->AddReply(513661, 14920, 14919);
			}
			if (f_23fb_a1_b(tv1) && f_23e3_a1_b(tv1) && !f_242b_a1_b(tv1)) {
				tv0->AddReply(513669, 14928, 14927);
			}
			if (f_23e3_a1_b(tv1) && f_2407_a1_b(tv1) && !f_241f_a1_b(tv1)) {
...
task t15
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_2443_a1_b(tv1) && f_21ee_a1_b(tv1)) {
				tv0->AddReply(531736, 33124, 33123);
			}
			if (f_21fa_a1_b(tv1) && f_2237_a1_b(tv1) || f_2206_a1_b(tv1) && f_2237_a1_b(tv1)) {
...
bool f_1d71_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1d67_a1_b(L0);
}

bool f_1d7a_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1d7f_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1e9b_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_1e70_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_1eaa_a2_v(string a0, bool a1)
{
	object L0;
	@FindActor(L0, a0);
	if (!L0) {
...
bool f_1ebb_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_1ec2_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1edc_a1_b(int a0)
{
	return f_1ed3_a0_i() == a0;
}

bool f_1ee2_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_1ef5_a0_i(void)
{
	return 515531;
}

int f_1ef7_a0_i(void)
{
	return 502857;
}

string f_1ef9_a0_s(void)
{
	return "ui/NPC_BigVlad.png";
}

string f_1efb_a0_s(void)
{
	return "ui/NPC_BigVlad_b.png";
}

bool f_1efd_a0_b(void)
{
	return true;
}

void f_1eff_a2_v(object a0, object a1)
{
	if (f_1ea5_a1_i("d2q01BigVladVisit") != 0 && f_1ea5_a1_i("d2q01GeorgVisit") != 0) {
		f_2482_a0_v();
	}
}

void f_1f16_a2_v(object a0, object a1)
{
	@SetVariable("ood1BigVlad1", 1);
}

void f_1f1c_a2_v(object a0, object a1)
{
	f_248f_a0_v();
	f_1ec2_a2_b("quest_d3_01", "fail");
}

void f_1f26_a2_v(object a0, object a1)
{
...
void f_1f2c_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2547_a0_o();
	L0->AddMark("d5q01BigVladGotoLara", "pt_map_lara", 1, 511959, f_1ece_a0_f());
}

void f_1f3c_a2_v(object a0, object a1)
{
	f_24ea_a0_v();
	f_1ec2_a2_b("quest_d5_01", "fail");
}

void f_1f46_a2_v(object a0, object a1)
{
	@SetVariable("ood2BigVlad1", 1);
}

void f_1f4c_a2_v(object a0, object a1)
{
...
void f_1f58_a2_v(object a0, object a1)
{
...
{
	f_1ec2_a2_b("quest_d5_01", "factory");
}

void f_1f65_a2_v(object a0, object a1)
{
	@SetVariable("ood4BigVlad4", 1);
}
...
void f_1f74_a2_v(object a0, object a1)
{
...
void f_1f8c_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d3q01", 6);
	L0 = f_2547_a0_o();
	L0->AddMark("d3q01BigVladAgreed", "pt_map_ospina", 1, 515300, f_1ece_a0_f());
	f_249c_a0_v();
}

void f_1fa3_a2_v(object a0, object a1)
{
	f_2558_a3_v(f_2547_a0_o(), "pt_map_alexandr", 2);
	a1->ShowMap(f_2547_a0_o());
}
...
void f_1fb9_a2_v(object a0, object a1)
{
	...
	@SetVariable("d4q01", 1);
	L0 = f_2547_a0_o();
	L0->AddMark("d4q01BigVladGotoLara", "pt_map_lara", 1, 511481, f_1ece_a0_f());
	L0->AddMark("d4q01BigVladGotoSklad", "pt_map_warehouse_gangster", 1, 511482, f_1ece_a0_f());
	f_24a9_a0_v();
	f_24b6_a0_v();
}

void f_1fdc_a2_v(object a0, object a1)
{
	@SetVariable("ood4BigVlad1", 1);
}

void f_1fe2_a2_v(object a0, object a1)
{
	f_2558_a3_v(f_2547_a0_o(), "pt_map_lara", 2);
	a1->ShowMap(f_2547_a0_o());
}

void f_1ff2_a2_v(object a0, object a1)
{
...
void f_1ff8_a2_v(object a0, object a1)
{
	...
	@SetVariable("d4q01", 4);
	L0 = f_2547_a0_o();
	L0->AddMark("d4q01BigVladGotoSobor", "pt_map_sobor", 1, 515325, f_1ece_a0_f());
	L0->AddMark("d4q01BigVladGotoTheater", "pt_map_theater", 1, 515326, f_1ece_a0_f());
	f_24c3_a0_v();
	f_1ec2_a2_b("quest_d4_01", "pers");
	f_1ec2_a2_b("quest_d4_01", "key_actors");
}
...
void f_2028_a2_v(object a0, object a1)
{
	object L0;
	object L1;
	int L2;
	...
	f_24d0_a0_v();
	f_1ec2_a2_b("quest_d4_01", "completed");
	a0->RemoveItemByType(L2, "d4q01_sobor_key", 1);
	a0->RemoveItemByType(L2, "d4q01_theater_key", 1);
	f_1eaa_a2_v("theater@door1", true);
	f_1eaa_a2_v("sobor@door1", true);
}
...
void f_20ba_a2_v(object a0, object a1)
{
	...
	@SetVariable("d5q01", 2);
	L0 = f_2547_a0_o();
	L0->AddMark("d5q01BigVladGotoAlexandr", "pt_map_alexandr", 1, 511957, f_1ece_a0_f());
	L0->AddMark("d5q01BigVladGotoLara", "pt_map_lara", 1, 511959, f_1ece_a0_f());
	f_24f7_a0_v();
}

void f_20da_a2_v(object a0, object a1)
{
	@SetVariable("ood5BigVlad1", 1);
}

void f_20e0_a2_v(object a0, object a1)
{
	@SetVariable("ood6BigVlad1", 1);
}

void f_20e6_a2_v(object a0, object a1)
{
	@SetVariable("ood6BigVlad2", 1);
}

void f_20ec_a2_v(object a0, object a1)
{
	@SetVariable("KnowBigVlad", 1);
}

void f_20f2_a2_v(object a0, object a1)
{
	@SetVariable("d8q01BigVladIsVictim", 1);
}

void f_20f8_a2_v(object a0, object a1)
{
	@SetVariable("ood8BigVlad1", 1);
}

void f_20fe_a2_v(object a0, object a1)
{
...
void f_2110_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2547_a0_o();
	L0->AddMark("d6q01BigVladGotoAnna", "pt_map_anna", 1, 515390, f_1ece_a0_f());
	L0->AddMark("d6q01BigVladGotoOspina", "pt_map_ospina", 1, 515389, f_1ece_a0_f());
	L0->AddMark("d6q01BigVladGotoAnnaOspinaSelf", "pt_map_bigvlad", 1, 515391, f_1ece_a0_f());
	f_2504_a0_v();
}
...
void f_2135_a2_v(object a0, object a1)
{
	...
	f_24dd_a0_v();
	f_1ec2_a2_b("quest_d4_01", "failed");
}

void f_21b5_a2_v(object a0, object a1)
{
	@SetVariable("d4BigVladVisit", 1);
}

void f_21bb_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2547_a0_o();
	L0->AddMark("d6q02BigVlad", "pt_map_bigvlad", 0, 515380, f_1ece_a0_f());
	f_2511_a0_v();
}
...
void f_21d4_a2_v(object a0, object a1)
{
	@SetVariable("d1q01", 6);
	f_2468_a0_v();
	f_1ec2_a2_b("quest_d1_01", "place_morlok_run");
}

bool f_21e2_a1_b(object a0)
{
	if (f_1ea5_a1_i("d1q01FirstGeorgVisit") == 1) {
		return true;
	}
	return false;
}

bool f_21ee_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood1BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_21fa_a1_b(object a0)
{
	if (f_1ea5_a1_i("d1q01") == 5) {
		return true;
	}
	return false;
}

bool f_2206_a1_b(object a0)
{
	if (f_1ea5_a1_i("d1q01") == 6) {
		return true;
	}
	return false;
}

bool f_2212_a1_b(object a0)
{
	if (!(f_1ea5_a1_i("d3q02") == 1000) && !(f_1ea5_a1_i("d3q02") == 0) && !(f_1ea5_a1_i("d3q02") == -1)) {
		return true;
	}
	return false;
}
...
bool f_2295_a1_b(object a0)
{
	if (f_1ea5_a1_i("d2q01") == 0) {
		return true;
	}
	return false;
}

bool f_22a1_a1_b(object a0)
{
	if (f_1ea5_a1_i("d2q01") == 6) {
		return true;
	}
	return false;
}

bool f_22ad_a1_b(object a0)
{
	if (f_1ea5_a1_i("d3q01") == 3) {
		return true;
	}
	return false;
}

bool f_22b9_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood3BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_22c5_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood3BigVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_22d1_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood3BigVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_22dd_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood3BigVlad4") == 0) {
		return true;
	}
	return false;
}

bool f_22e9_a1_b(object a0)
{
	if (f_1ea5_a1_i("d4q01") == 0) {
		return true;
	}
	return false;
}

bool f_22f5_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood4BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2301_a1_b(object a0)
{
	if (f_1ea5_a1_i("d4q01") == 3) {
		return true;
	}
	return false;
}

bool f_230d_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood4BigVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2319_a1_b(object a0)
{
	if (!f_1ebb_a2_b(a0, "d4q01_sobor_key") || !f_1ebb_a2_b(a0, "d4q01_theater_key")) {
		if (f_1ea5_a1_i("d4q01") == 4) {
			return true;
		}
	}
	return false;
...
bool f_2353_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood4BigVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_235f_a1_b(object a0)
{
	if (f_1ea5_a1_i("d5q01") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1ea5_a1_i("ood5BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2377_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q02") == 0) {
		return true;
	}
	return false;
}

bool f_2383_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q02") == 1000) {
		return true;
	}
	return false;
}

bool f_238f_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q02") == -1) {
		return true;
	}
	return false;
}

bool f_239b_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood6BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_23a7_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q02KnowAboutAttack") == 1) {
		return true;
	}
	return false;
}

bool f_23b3_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q02Trigger") != 0) {
		return true;
	}
	return false;
}

bool f_23bf_a1_b(object a0)
{
	if (f_1ea5_a1_i("d6q01") == 1) {
		return true;
	}
	return false;
}

bool f_23cb_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood6BigVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_23d7_a1_b(object a0)
{
	if (f_1ea5_a1_i("d8q01MladVladIsBad") == 1) {
		return true;
	}
	return false;
}

bool f_23e3_a1_b(object a0)
{
	if (f_1ea5_a1_i("d8q01BringBadBoy") == 1) {
		return true;
	}
	return false;
}

bool f_23ef_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood8BigVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_23fb_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood8BigVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2407_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood8BigVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2413_a1_b(object a0)
{
	if (f_1ea5_a1_i("ood6BigVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_241f_a1_b(object a0)
{
	if (f_1ea5_a1_i("d8q01BigVladIsVictim") == 1) {
		return true;
	}
	return false;
}

bool f_242b_a1_b(object a0)
{
	if (f_1ea5_a1_i("d8q01MladVladIsVictim") == 1) {
		return true;
	}
	return false;
}

bool f_2437_a1_b(object a0)
{
	if (f_1ea5_a1_i("d2KnowBigVladIsBad") == 1) {
		return true;
	}
	return false;
}

bool f_2443_a1_b(object a0)
{
	if (f_1ea5_a1_i("d1q01") != 0 && f_1ea5_a1_i("d1q01") != 1000 && f_1ea5_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}

bool f_2465_a1_b(object a0)
{
	return false;
}
...
void f_2558_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
