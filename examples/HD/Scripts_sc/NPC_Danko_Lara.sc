...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1b95_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1d7b_a0_i());
		L0->SetNPCDescription(f_1d79_a0_i());
		L0->SetPhoto(f_1d7d_a0_s());
		L0->SetPhoto2(f_1d7f_a0_s());
		L0->SetPlayerName(f_2405_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			f_277_a1_v("Tiredness");
			tv0->SetMessage(503662);
			tv0->ClearReplies();
			if (f_2222_a1_b(tv1) && f_222e_a1_b(tv1)) {
				tv0->AddReply(512735, 11881, 13929);
			}
			if (f_223a_a1_b(tv1) && f_2246_a1_b(tv1) && !f_226a_a1_b(tv1) && !f_2276_a1_b(tv1)) {
				tv0->AddReply(512736, 11904, 13930);
			}
			if (f_2252_a1_b(tv1) && f_219e_a1_b(tv1)) {
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_2136_a1_b(tv1) && f_2166_a1_b(tv1)) {
				f_1eb2_a2_v(tv1, tv0);
				f_2001_a2_v(tv1, tv0);
				f_602_a1_v("Sympathy");
			...
			tv0->ClearReplies();
			if (f_2142_a1_b(tv1) && f_2192_a1_b(tv1) && f_217c_a1_b(tv1)) {
				tv0->AddReply(506900, 7607, 7606);
			}
			if (f_214e_a1_b(tv1) && f_217c_a1_b(tv1) && f_2186_a1_b(tv1)) {
				tv0->AddReply(506902, 7609, 7608);
			}
			if (f_2172_a1_b(tv1) && f_2186_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_21b6_a1_b(tv1) && f_21aa_a1_b(tv1)) {
				tv0->AddReply(510152, 11195, 11194);
			}
			if (f_21c2_a1_b(tv1) && f_21ce_a1_b(tv1)) {
				tv0->AddReply(510995, 12163, 12162);
			}
			if (f_21e6_a1_b(tv1) && f_21da_a1_b(tv1)) {
				tv0->AddReply(511435, 12638, 12637);
			}
			if (f_21da_a1_b(tv1) && !f_21f2_a1_b(tv1) && !f_21e6_a1_b(tv1)) {
...
task t11
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			f_ed6_a1_v("Tiredness");
			tv0->SetMessage(511662);
			tv0->ClearReplies();
			if (f_2216_a1_b(tv1) || f_21fe_a1_b(tv1) || f_220a_a1_b(tv1)) {
...
task t13
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_20a8_a1_b(tv1) && f_209c_a1_b(tv1) && f_2084_a1_b(tv1)) {
				tv0->AddReply(531945, 33350, 33349);
			}
			if (f_2078_a1_b(tv1)) {
				tv0->AddReply(532734, 34209, 34208);
			}
			if (f_20c0_a1_b(tv1) && f_2090_a1_b(tv1)) {
...
task t17
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_20cb_a1_b(tv1) && f_20d7_a1_b(tv1)) {
...
task t19
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_20fb_a1_b(tv1) && f_2106_a1_b(tv1)) {
...
maintask t26
{
	...
	bool f_1a80_a0_b(void)
	{
		...
		return f_1b87_a1_b(L0);
	}

	void f_1a8f_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_1a94_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_1ab3_a0_v();
			if (f_1b90_a0_b() && f_1a94_a0_b()) {
				if (f_1a80_a0_b()) {
					f_1c26_a1_b(f_1cab_a0_o());
				}
			} else {
				f_1a8f_a0_v();
				f_1aaa_a0_v();
...
void f_1b22_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_1b90_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_1d61_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_1b69_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1b6e_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_1b76_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_1b87_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_1b7d_a1_b(L0);
}

bool f_1b90_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1b95_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1cb1_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1c26_a1_b(object a0)
{
	...
	return f_1c95_a1_b(L4);
}

bool f_1c4b_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_1d3f_a0_i() + "m";
	int L1;
...
void f_1c86_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_1ccb_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1cd7_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_1ce3_a2_v(object a0, int a1)
{
	f_1b76_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_1cf6_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_1d09_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_1cf6_a3_v(a0, L0, a2);
}

bool f_1d16_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_1d1d_a2_b(object a0, string a1)
{
	int L0;
	int L1;
	bool L2;
...
bool f_1d2e_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1d48_a1_b(int a0)
{
	return f_1d3f_a0_i() == a0;
}

bool f_1d4e_a1_b(int a0)
{
	float L0;
	int L1;
	int L2;
...
int f_1d68_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_1d61_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1d79_a0_i(void)
{
	return 515541;
}

int f_1d7b_a0_i(void)
{
	return 502866;
}

string f_1d7d_a0_s(void)
{
	return "ui/NPC_Lara.png";
}

string f_1d7f_a0_s(void)
{
	return "ui/NPC_Lara_b.png";
}

bool f_1d81_a0_b(void)
{
	return true;
}

void f_1d83_a2_v(object a0, object a1)
{
	f_22cd_a0_v();
	f_22f4_a0_v();
	f_1cc0_a1_o("quest_d1_04");
}
...
void f_1d8f_a2_v(object a0, object a1)
{
	...
	f_22da_a0_v();
	f_1d2e_a2_b("quest_d1_04", "completed");
}

void f_1db4_a2_v(object a0, object a1)
{
	@Trace("money1000 is given");
	f_1ce3_a2_v(a0, 1000);
}

void f_1dbe_a2_v(object a0, object a1)
{
	@Trace("funduk3 is given");
	f_1d09_a3_v(a0, "funduk", 3);
}

void f_1dc9_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_1dcf_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1dd5_a2_v(object a0, object a1)
{
	object L0;
	object L1;
	L0 = f_23d3_a0_o();
	...
	f_22e7_a0_v();
	f_1d2e_a2_b("quest_d1_04", "fail");
}

void f_1dfa_a2_v(object a0, object a1)
{
	f_23e4_a3_v(f_23d3_a0_o(), "pt_map_station", 2);
	a1->ShowMap(f_23d3_a0_o());
}

void f_1e0a_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_23d3_a0_o();
	L0->AddMark("d1q01LaraMarkMladVlad", "pt_map_mladvlad", 3, 508647, f_1d3a_a0_f());
}

void f_1e1a_a2_v(object a0, object a1)
{
	@SetVariable("ood1Lara1", 1);
}

void f_1e20_a2_v(object a0, object a1)
{
...
{
	f_1d1d_a2_b(a0, "powder");
}

void f_1e2d_a2_v(object a0, object a1)
{
	@SetVariable("ood8Lara1", 1);
}

void f_1e33_a2_v(object a0, object a1)
{
	@Trace("burah_serum is given");
	f_1d09_a3_v(a0, "burah_serum", 1);
}

void f_1e3e_a2_v(object a0, object a1)
{
...
void f_1e50_a2_v(object a0, object a1)
{
	@SetVariable("d9q03", 1000);
	f_2383_a0_v();
}

void f_1e59_a2_v(object a0, object a1)
{
	if (f_1cbb_a1_i("d9q04") == 1) {
		@SetVariable("d9q04", 2);
		f_239d_a0_v();
	}
}

void f_1e69_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "Gun_danko", 1);
}

void f_1e6f_a2_v(object a0, object a1)
{
	@Trace("walnut2 is given");
	f_1d09_a3_v(a0, "walnut", 2);
}

void f_1e7a_a2_v(object a0, object a1)
{
	@Trace("peanut3 is given");
	f_1d09_a3_v(a0, "peanut", 3);
}

void f_1e85_a2_v(object a0, object a1)
{
	@Trace("milk is given");
	f_1d09_a3_v(a0, "milk", 1);
}
...
void f_1ea1_a2_v(object a0, object a1)
{
	@SetVariable("ood10Lara1", 1);
}

void f_1ea7_a2_v(object a0, object a1)
{
	@Trace("lens is given");
	f_1d09_a3_v(a0, "lens", 1);
}
...
void f_1eb8_a2_v(object a0, object a1)
{
...
void f_1eca_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d2q03", 1);
	L0 = f_23d3_a0_o();
	L0->AddMark("d2q03LaraGotoMoneyFoodSelf", "pt_map_lara", 0, 515286, f_1d3a_a0_f());
	L0->AddMark("d2q03LaraGotoJulia", "pt_map_julia", 0, 515288, f_1d3a_a0_f());
	L0->AddMark("d2q03LaraGotoMaria", "pt_map_maria", 0, 515289, f_1d3a_a0_f());
	L0->AddMark("d2q03LaraGotoMladVlad", "pt_map_mladvlad", 0, 515287, f_1d3a_a0_f());
	f_2301_a0_v();
	f_230e_a0_v();
	f_1cc0_a1_o("quest_d2_03");
}
...
void f_1f03_a2_v(object a0, object a1)
{
	...
	@SetVariable("d2q03", 2);
	L0 = f_23d3_a0_o();
	L0->AddMark("d2q03LaraGotoSklad", "pt_map_d2q03_shouse", 0, 515290, f_1d3a_a0_f());
	f_231b_a0_v();
}

void f_1f1a_a2_v(object a0, object a1)
{
	int L0;
	f_2328_a0_v();
	...
	f_1d2e_a2_b("quest_d2_03", "completed");
}
...
{
	f_1d2e_a2_b("quest_d2_03", "birdmask");
}

void f_1f3d_a2_v(object a0, object a1)
{
	f_23e4_a3_v(f_23d3_a0_o(), "pt_map_ospina", 2);
	a1->ShowMap(f_23d3_a0_o());
}

void f_1f4d_a2_v(object a0, object a1)
{
	f_23e4_a3_v(f_23d3_a0_o(), "pt_map_mladvlad", 2);
	a1->ShowMap(f_23d3_a0_o());
}

void f_1f5d_a2_v(object a0, object a1)
{
	@Trace("bread is given");
	f_1d09_a3_v(a0, "bread", 1);
}

void f_1f68_a2_v(object a0, object a1)
{
	@SetVariable("ood4Lara1", 1);
}

void f_1f6e_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d4q01", 2);
	L0 = f_23d3_a0_o();
	L0->AddMark("d4q01LaraGotoMladVlad", "pt_map_mladvlad", 1, 511483, f_1d3a_a0_f());
	L0->AddMark("d4q01LaraGotoMladVladSelf", "pt_map_lara", 1, 515321, f_1d3a_a0_f());
	f_2335_a0_v();
}

void f_1f8e_a2_v(object a0, object a1)
{
	@SetVariable("ood4Lara2", 1);
}

void f_1f94_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d4q01_subquest", 3);
	L0 = f_23d3_a0_o();
	L0->AddMark("d4q01LaraGotoOspina", "pt_map_ospina", 0, 511506, f_1d3a_a0_f());
}
...
{
	if (f_1cbb_a1_i("d4q02AnnaGivesMedcine") == 1 && f_1cbb_a1_i("d4q02JuliaGivesMedcine") == 1 && f_1cbb_a1_i("d4q02LaraGivesMedcine") == 1) {
		object L0;
		@SetVariable("d4q02", 2);
		L0 = f_23d3_a0_o();
		L0->AddMark("d4q02BirdmaskNearHome", "pt_d4q02_birdmask", 0, 511842, f_1d3a_a0_f());
		f_1d2e_a2_b("quest_d4_02", "birdmask");
		f_23e4_a3_v(f_23d3_a0_o(), "pt_d4q02_birdmask", 2);
		a1->ShowMap(f_23d3_a0_o());
	}
}

void f_1ff8_a2_v(object a0, object a1)
{
	@SetVariable("d5q01", 5);
	f_2342_a0_v();
}

void f_2001_a2_v(object a0, object a1)
{
	@SetVariable("d2LaraVisit", 1);
}

void f_2007_a2_v(object a0, object a1)
{
	@SetVariable("ood6Lara1", 1);
}

void f_200d_a2_v(object a0, object a1)
{
	f_234f_a0_v();
	@Trace("lara blood is given");
	f_1d09_a3_v(a0, "d6q01_lara_blood", 1);
}
...
void f_2021_a2_v(object a0, object a1)
{
	@SetVariable("ood6Lara2", 1);
}

void f_2027_a2_v(object a0, object a1)
{
	@SetVariable("ood6Lara3", 1);
}

void f_202d_a2_v(object a0, object a1)
{
	@SetVariable("ood6Lara4", 1);
}

void f_2033_a2_v(object a0, object a1)
{
	@SetVariable("d6q01LaraVolonteer", 1);
	f_235c_a0_v();
	f_1d2e_a2_b("quest_d6_01", "completed");
}
...
void f_2047_a2_v(object a0, object a1)
{
	f_23e4_a3_v(f_23d3_a0_o(), "pt_map_d2q03_shouse", 2);
	a1->ShowMap(f_23d3_a0_o());
}
...
void f_2057_a2_v(object a0, object a1)
{
	...
	f_1d09_a3_v(a0, "morfin", 1);
}

void f_2062_a2_v(object a0, object a1)
{
	@Trace("etorfin is given");
	f_1d09_a3_v(a0, "etorfin", 1);
}

void f_206d_a2_v(object a0, object a1)
{
	@Trace("novocaine is given");
	f_1d09_a3_v(a0, "novocaine", 1);
}

bool f_2078_a1_b(object a0)
{
	if (f_1cbb_a1_i("d1q04") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_1cbb_a1_i("ood1Lara1") == 0) {
		return true;
	}
	return false;
}

bool f_20b4_a1_b(object a0)
{
	if (f_1cbb_a1_i("ood1Lara2") == 0) {
		return true;
	}
	return false;
}

bool f_20c0_a1_b(object a0)
{
	if (f_1d16_a2_b(a0, "powder")) {
		return true;
	}
	return false;
}
...
{
	if (f_1cbb_a1_i("d9q02") == 1) {
		return true;
	}
	return false;
}

bool f_20ef_a1_b(object a0)
{
	if (f_1cbb_a1_i("ood9Lara1") == 0) {
		return true;
	}
	return false;
}

bool f_20fb_a1_b(object a0)
{
	if (f_1d16_a2_b(a0, "Gun_danko")) {
		return true;
	}
	return false;
}
...
{
	if (f_1cbb_a1_i("ood2Lara4") == 0) {
		return true;
	}
	return false;
}

bool f_2166_a1_b(object a0)
{
	if (f_1cbb_a1_i("d2q03") == 0) {
		return true;
	}
	return false;
}

bool f_2172_a1_b(object a0)
{
	if (f_2282_a1_b(a0)) {
		return true;
	}
...
{
	if (f_1cbb_a1_i("d4q01_subquest") == 2) {
		return true;
	}
	return false;
}
...
{
	if (f_1cbb_a1_i("d4q02LaraGivesMedcine") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_1cbb_a1_i("microscope_d6q01_lara_blood") != 0) {
		return true;
	}
	return false;
}
...
bool f_23b7_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_23e4_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
