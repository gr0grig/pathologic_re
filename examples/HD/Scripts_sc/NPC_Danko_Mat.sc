...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_994_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_b44_a0_i());
		L0->SetNPCDescription(f_b42_a0_i());
		L0->SetPhoto(f_b46_a0_s());
		L0->SetPhoto2(f_b48_a0_s());
		L0->SetPlayerName(f_d79_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_c37_a1_b(tv1) && f_c43_a1_b(tv1)) {
				f_b89_a2_v(tv1, tv0);
				f_bf0_a2_v(tv1, tv0);
				f_133_a1_v("Neutral");
...
maintask t6
{
	...
	void f_873_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_878_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_897_a0_v();
			if (f_98f_a0_b() && f_878_a0_b()) {
				if (f_864_a0_b()) {
					f_a25_a1_b(f_aaa_a0_o());
				}
			} else {
				f_873_a0_v();
				f_88e_a0_v();
...
void f_906_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_98f_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_b2a_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_94b_a0_b(void)
{
	return true;
}

void f_94d_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_952_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_95a_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_966_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_95a_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_aba_a3_f(L0 + a2, a3, a4));
	return true;
}

bool f_97c_a1_b(Vector a0)
{
	Vector L0;
	Vector L1;
	bool L2;
...
bool f_986_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_97c_a1_b(L0);
}

bool f_98f_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_994_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_ab0_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_a25_a1_b(object a0)
{
	...
	return f_a94_a1_b(L4);
}

bool f_a4a_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_b1b_a0_i() + "m";
	int L1;
...
void f_a85_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_aba_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_aca_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_ad1_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_af4_a1_v(a1);
	f_966_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}
...
bool f_afe_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_b0a_a3_b(string a0, string a1, string a2)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_b24_a1_b(int a0)
{
	return f_b1b_a0_i() == a0;
}

string f_b2a_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_b31_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_b2a_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_b46_a0_s(void)
{
	return "ui/NPC_Mat.png";
}

string f_b48_a0_s(void)
{
	return "ui/NPC_Mat_b.png";
}

bool f_b4a_a0_b(void)
{
	return true;
}
...
void f_b4c_a2_v(object a0, object a1)
{
	...
	if (L0 != 0) {
		f_b0a_a3_b("volonteers_danko", "kill", "mladvlad");
	}
	@GetVariable("d8q01BigVladIsVictim", L0);
	if (L0 != 0) {
		f_b0a_a3_b("volonteers_danko", "kill", "bigvlad");
	}
}

void f_b66_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "toy_horse", 1);
}

void f_b6c_a2_v(object a0, object a1)
{
	f_d58_a3_v(f_d47_a0_o(), "pt_map_boiny_main_entrance", 2);
	a1->ShowMap(f_d47_a0_o());
}

void f_b7c_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_b82_a2_v(object a0, object a1)
{
	f_ad1_a2_b(a0, 0.10000000149011612);
}

void f_b89_a2_v(object a0, object a1)
{
	@SetVariable("ood8Mat1", 1);
}

void f_b8f_a2_v(object a0, object a1)
{
	@SetVariable("d8q01BringBadBoy", 1);
	f_cdd_a0_v();
}

void f_b98_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d8q01MatBringToy", 1);
	L0 = f_d47_a0_o();
	L0->AddMark("d8q01MatGotoToyHouse", "pt_map_d8q01_toyhouse", 1, 515444, f_b16_a0_f());
	f_cea_a0_v();
	f_afe_a2_b("quest_d8_01", "place_toy");
}

void f_bb4_a2_v(object a0, object a1)
{
	@SetVariable("ood8Mat2", 1);
}

void f_bba_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_d47_a0_o();
	L0->AddMark("d8q01MatGotoBoiny", "pt_map_boiny_main_entrance", 1, 515324, f_b16_a0_f());
	f_cf7_a0_v();
	f_afe_a2_b("quest_d8_01", "unlock_boiny");
}

void f_bd2_a2_v(object a0, object a1)
{
	@SetVariable("ood8Mat3", 1);
}

void f_bd8_a2_v(object a0, object a1)
{
	@SetVariable("ood8Mat4", 1);
}

void f_bde_a2_v(object a0, object a1)
{
...
void f_bea_a2_v(object a0, object a1)
{
	@SetVariable("ood8Mat7", 1);
}

void f_bf0_a2_v(object a0, object a1)
{
	@SetVariable("d8TalkToMat", 1);
}

void f_bf6_a2_v(object a0, object a1)
{
	f_d04_a0_v();
	f_afe_a2_b("quest_d8_02", "completed");
}
...
void f_c09_a2_v(object a0, object a1)
{
	int L0;
	a0->RemoveItemByType(L0, "feromicin", 1);
}

void f_c0f_a2_v(object a0, object a1)
{
	f_d58_a3_v(f_d47_a0_o(), "pt_map_d8q01_toyhouse", 2);
	a1->ShowMap(f_d47_a0_o());
}

bool f_c1f_a1_b(object a0)
{
	if (f_ac5_a1_i("d8q02") == 2) {
		return true;
	}
	return false;
}

bool f_c2b_a1_b(object a0)
{
	if (f_ac5_a1_i("d8q04") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_ac5_a1_i("ood8Mat1") == 0) {
		return true;
	}
	return false;
}

bool f_c4f_a1_b(object a0)
{
	if (f_ac5_a1_i("d8q01MatBringToy") == 1) {
		return true;
	}
	return false;
}

bool f_c5b_a1_b(object a0)
{
	if (f_aca_a2_b(a0, "toy_horse")) {
		return true;
	}
	return false;
}
...
{
	if (f_ac5_a1_i("ood8Mat5") == 0) {
		return true;
	}
	return false;
}

bool f_c96_a1_b(object a0)
{
	if (f_ac5_a1_i("d8q01BigVladIsVictim") == 1) {
		return true;
	}
	return false;
}

bool f_ca2_a1_b(object a0)
{
	if (f_ac5_a1_i("d8q01MladVladIsVictim") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_aca_a2_b(a0, "feromicin")) {
		return true;
	}
	return false;
}

void f_cdd_a0_v(void)
{
	object L0;
...
bool f_d2b_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_d58_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
