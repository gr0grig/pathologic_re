...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_636_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_78a_a0_i());
		L0->SetNPCDescription(f_788_a0_i());
		L0->SetPhoto(f_78c_a0_s());
		L0->SetPhoto2(f_78e_a0_s());
		L0->SetPlayerName(f_7b6_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			f_290_a1_v("Suspicion");
			tv0->SetMessage(512800);
			tv0->ClearReplies();
			if (f_79e_a1_b(tv1) && f_7aa_a1_b(tv1)) {
...
maintask t10
{
	...
	bool f_528_a0_b(void)
	{
		...
		return f_628_a1_b(L0);
	}

	void f_537_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_53c_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_55b_a0_v();
			if (f_631_a0_b() && f_53c_a0_b()) {
				if (f_528_a0_b()) {
					f_6c7_a1_b(f_74c_a0_o());
				}
			} else {
				f_537_a0_v();
				f_552_a0_v();
...
void f_5ca_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_631_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_770_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_60f_a0_b(void)
{
	return true;
}

void f_611_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_616_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_628_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_61e_a1_b(L0);
}

bool f_631_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_636_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_752_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_727_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_76a_a1_b(int a0)
{
	return f_761_a0_i() == a0;
}

string f_770_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_777_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_770_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_78c_a0_s(void)
{
	return "ui/NPC_Mishka.png";
}

string f_78e_a0_s(void)
{
	return "ui/NPC_Mishka_b.png";
}

bool f_790_a0_b(void)
{
	return true;
}

void f_792_a2_v(object a0, object a1)
{
	@SetVariable("ood6Mishka1", 1);
}

void f_798_a2_v(object a0, object a1)
{
	@SetVariable("KnowMishka", 1);
}

bool f_79e_a1_b(object a0)
{
	if (f_75c_a1_i("d6q01") == 4) {
		return true;
	}
	return false;
}
