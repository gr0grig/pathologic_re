	...
	void init(int a0)
	{
		...
		if (L1) {
			...
			if (L5) {
				int L6;
				@irand(L6, L5);
				@PlayAnimation("all", f_28df_a1_s(L6));
				@WaitForAnimEnd();
			}
		}
	}
...
task t4
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_26f5_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_2907_a0_i());
		L0->SetNPCDescription(f_2905_a0_i());
		L0->SetPhoto(f_2909_a0_s());
		L0->SetPhoto2(f_290b_a0_s());
		L0->SetPlayerName(f_3018_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2cd8_a1_b(tv1) && f_2cc0_a1_b(tv1)) {
...
task t9
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2cf0_a1_b(tv1) && f_2cfc_a1_b(tv1)) {
				tv0->AddReply(510213, 11260, 11259);
			}
			if (f_2c30_a1_b(tv1) && !f_2ce4_a1_b(tv1)) {
				tv0->AddReply(510302, 11359, 11358);
			}
			if (f_2d08_a1_b(tv1) && f_2cb4_a1_b(tv1) || f_2d14_a1_b(tv1) && f_2cb4_a1_b(tv1)) {
...
task t11
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_2d38_a1_b(tv1) && !f_2d20_a1_b(tv1)) {
				f_29a3_a2_v(tv1, tv0);
				f_921_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_2d2c_a1_b(tv1) && f_2d20_a1_b(tv1)) {
				tv0->AddReply(510815, 11956, 11955);
			}
			if (f_2d50_a1_b(tv1) && f_2d44_a1_b(tv1)) {
...
task t13
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_2dd4_a1_b(tv1) && !f_2d98_a1_b(tv1) && !f_2da4_a1_b(tv1)) {
				f_2b67_a2_v(tv1, tv0);
				f_dd6_a1_v("Rage");
			...
			tv0->ClearReplies();
			if (f_2db0_a1_b(tv1) && f_2dbc_a1_b(tv1)) {
				tv0->AddReply(512574, 13744, 13743);
			}
			if (f_2d98_a1_b(tv1) && f_2dc8_a1_b(tv1)) {
...
task t15
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_2d74_a1_b(tv1) && f_2de0_a1_b(tv1)) {
				tv0->AddReply(512516, 13688, 13686);
			}
			if (f_2d80_a1_b(tv1) && f_2dec_a1_b(tv1) && !f_2de0_a1_b(tv1)) {
	...
	void OnDialogReply(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 13334) {
				...
				tv0->AddReply(541861, 13667, 44088);
				return;
			}
			if (a0 == 13336) {
				f_10c1_a1_v("Sly");
				...
				tv0->AddReply(541862, 13667, 44090);
				return;
			}
			if (a0 == 13338) {
				f_10c1_a1_v("Fear");
				...
				tv0->AddReply(541863, 44093, 44092);
				return;
			}
			if (a0 == 44093) {
				f_10c1_a1_v("Sly");
				tv0->SetMessage(541864);
				tv0->ClearReplies();
				tv0->AddReply(541865, 13667, 44094);
				return;
			}
			if (a0 == 13665) {
				f_10c1_a1_v("Fear");
				...
				tv0->AddReply(541866, 13667, 44096);
				return;
			}
			if (a0 == 13667) {
				f_10c1_a1_v("Neutral");
...
task t17
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_2df8_a1_b(tv1) && f_2e10_a1_b(tv1) && !f_2e04_a1_b(tv1)) {
				tv0->AddReply(512412, 13577, 13576);
			}
			if (f_2e04_a1_b(tv1) && f_2e1c_a1_b(tv1)) {
				tv0->AddReply(513588, 14840, 14839);
			}
			if (f_2e28_a1_b(tv1) && f_2e04_a1_b(tv1) && f_2e34_a1_b(tv1) && !f_2e58_a1_b(tv1)) {
				tv0->AddReply(513607, 14868, 14862);
			}
			if (f_2e28_a1_b(tv1) && f_2e4c_a1_b(tv1) && !f_2e64_a1_b(tv1)) {
				tv0->AddReply(513618, 14874, 14873);
			}
			if (!f_2e04_a1_b(tv1) && f_2df8_a1_b(tv1) && f_2e40_a1_b(tv1)) {
...
task t27
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_2c6c_a1_b(tv1) && f_2c3c_a1_b(tv1) && f_2e70_a1_b(tv1)) {
				f_2991_a2_v(tv1, tv0);
				f_1ff0_a1_v("Untrust");
			...
			tv0->ClearReplies();
			if (f_2c78_a1_b(tv1) && f_2e70_a1_b(tv1)) {
				tv0->AddReply(532702, 34178, 34177);
			}
			if (f_2c60_a1_b(tv1)) {
				tv0->AddReply(531954, 33359, 33358);
			}
			if (f_2c3c_a1_b(tv1) && !f_2c6c_a1_b(tv1)) {
				tv0->AddReply(532699, 34175, 34174);
			}
			if (!f_2c54_a1_b(tv1) && f_2c84_a1_b(tv1) && f_2c48_a1_b(tv1)) {
...
maintask t32
{
	...
	void f_260d_a0_v(void)
	{
		...
		for (tv2 = 0; ; tv2++) {
			bool L1;
			L0->GetLocator(f_28f7_a1_s(tv2), L1);
			if (!L1) {
				break;
			}
		}
		...
		for (; ; ) {
			...
			Vector L6;
			@irand(L2, tv2);
			L0->GetLocator(f_28f7_a1_s(L2), L3, L4, L5);
			L6 = L4 - f_269c_a0_V();
			if (f_282e_a1_f(L6) > tv1) {
				float L7;
				Vector L8;
				bool L9;
				@GetHeight(L7);
...
bool f_26a9_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_26b5_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_26a9_a2_b(a0, a1)) {
		return false;
	}
	a0->GetProperty(a1, L0);
	a0->SetProperty(a1, f_2823_a3_f(L0 + a2, a3, a4));
	return true;
}

void f_26cb_a3_v(object a0, string a1, int a2)
{
	int L0;
	a0->GetProperty(a1, L0);
...
bool f_26dc_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_26d2_a1_b(L0);
}

void f_26e5_a1_v(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_26f5_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_2811_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_2786_a1_b(object a0)
{
	...
	return f_27f5_a1_b(L4);
}

bool f_27ab_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_28d0_a0_i() + "m";
	int L1;
...
void f_27e6_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_281b_a1_f(float a0)
{
	return a0 < 0 ? -a0 : a0;
}

float f_2823_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_282e_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

int f_2838_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_2853_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_285f_a2_v(object a0, int a1)
{
	f_26cb_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_2872_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_2885_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_2872_a3_v(a0, L0, a2);
}

bool f_2892_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_28b5_a1_v(a1);
	f_26b5_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_28b5_a1_v(float a0)
{
	object L0;
...
bool f_28bf_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_28d9_a1_b(int a0)
{
	return f_28d0_a0_i() == a0;
}

string f_28df_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_28e6_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_28df_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_2905_a0_i(void)
{
	return 515547;
}

int f_2907_a0_i(void)
{
	return 502872;
}

string f_2909_a0_s(void)
{
	return "ui/NPC_MladVlad.png";
}

string f_290b_a0_s(void)
{
	return "ui/NPC_MladVlad_b.png";
}

bool f_290d_a0_b(void)
{
	return true;
}

void f_290f_a2_v(object a0, object a1)
{
	@Trace("money 4000 is given");
	f_285f_a2_v(a0, 4000);
}

void f_2919_a2_v(object a0, object a1)
{
	@Trace("money20000 is given");
	f_285f_a2_v(a0, 20000);
}

void f_2923_a2_v(object a0, object a1)
{
	int L0;
	L0 = f_28d0_a0_i();
...
void f_292e_a2_v(object a0, object a1)
{
	f_285f_a2_v(a0, -1000);
}

void f_2935_a2_v(object a0, object a1)
{
	@SetVariable("ood3MladVlad2", 1);
}

void f_293b_a2_v(object a0, object a1)
{
...
void f_2945_a2_v(object a0, object a1)
{
	...
	L0 = f_2fe6_a0_o();
	L0->AddMark("d1q03MladVladGotoOspina", "pt_map_ospina", 0, 508642, f_28cb_a0_f());
	f_2ed3_a0_v();
	f_2ee0_a0_v();
	f_283d_a1_o("quest_d1_03");
}

void f_2963_a2_v(object a0, object a1)
{
	@Trace("money10000 is given");
	f_285f_a2_v(a0, 10000);
}

void f_296d_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_2973_a2_v(object a0, object a1)
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_map_mat", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_2983_a2_v(object a0, object a1)
{
	@SetVariable("d1q01", 7);
	f_2ec6_a0_v();
	f_28bf_a2_b("quest_d1_01", "place_rubin");
}

void f_2991_a2_v(object a0, object a1)
{
	@SetVariable("ood1MladVlad1", 1);
}

void f_2997_a2_v(object a0, object a1)
{
	@SetVariable("ood1MladVlad2", 1);
}

void f_299d_a2_v(object a0, object a1)
{
	@SetVariable("ood1MladVlad3", 1);
}

void f_29a3_a2_v(object a0, object a1)
{
	@SetVariable("d4MladVladVisit", 1);
}

void f_29a9_a2_v(object a0, object a1)
{
	@SetVariable("ood8MladVlad6", 1);
}

void f_29af_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d8q04", 3);
	L0 = f_2fe6_a0_o();
	L0->AddMark("d8q04MladVladGotoMark", "pt_map_theater", 0, 515322, f_28cb_a0_f());
	f_2fa3_a0_v();
}

void f_29c6_a2_v(object a0, object a1)
{
	@SetVariable("d8MladVladVisit", 1);
}

void f_29cc_a2_v(object a0, object a1)
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_gmap_r7_house2_01", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_29dc_a2_v(object a0, object a1)
{
	f_2eb9_a0_v();
	f_28bf_a2_b("quest_d11_05", "place_enemy_after");
	f_28bf_a2_b("quest_d11_05", "completed");
}

void f_29eb_a2_v(object a0, object a1)
{
	@SetVariable("ood3MladVlad3", 1);
}

void f_29f1_a2_v(object a0, object a1)
{
	if (f_2838_a1_i("map_chertez_state") <= 2) {
		@SetVariable("map_chertez_state", 2);
		@SetVariable("map_chertez_force", 1);
	}
}

void f_2a02_a2_v(object a0, object a1)
{
	@Trace("lens is given");
	f_2885_a3_v(a0, "lens", 1);
}

void f_2a0d_a2_v(object a0, object a1)
{
...
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_map_theater", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_2a2f_a2_v(object a0, object a1)
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_map_anna", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_2a3f_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "mapmark");
}

void f_2a45_a2_v(object a0, object a1)
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_map_ospina", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_2a55_a2_v(object a0, object a1)
{
	f_2ff7_a3_v(f_2fe6_a0_o(), "pt_map_bigvlad", 2);
	a1->ShowMap(f_2fe6_a0_o());
}

void f_2a65_a2_v(object a0, object a1)
{
	@Trace("money3000 is given");
	f_285f_a2_v(a0, 3000);
}

void f_2a6f_a2_v(object a0, object a1)
{
	@SetVariable("ood3MladVlad1", 1);
}

void f_2a75_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d3q02", 2);
	L0 = f_2fe6_a0_o();
	L0->AddMark("d3q02MladVladGotoViktor", "pt_map_viktor", 0, 511384, f_28cb_a0_f());
	f_2eed_a0_v();
}

void f_2a8c_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2fe6_a0_o();
	L0->AddMark("d3q02MladVladGotoButcher", "pt_gmap_r7_house2_01", 0, 524631, f_28cb_a0_f());
	f_2efa_a0_v();
}
...
void f_2aa5_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d4q01", 3);
	L0 = f_2fe6_a0_o();
	L0->AddMark("d4q01MladVladGotoBigVlad", "pt_map_bigvlad", 1, 511507, f_28cb_a0_f());
	f_2f07_a0_v();
}
...
void f_2abc_a2_v(object a0, object a1)
{
	...
	L0 = f_2fe6_a0_o();
	L0->AddMark("d4q01MladVladGotoOspina", "pt_map_ospina", 1, 511503, f_28cb_a0_f());
}

void f_2ad0_a2_v(object a0, object a1)
{
	@SetVariable("ood4MladVlad2", 1);
}

void f_2ad6_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2fe6_a0_o();
	L0->AddMark("d4q02MladVladGotoAnna", "pt_map_anna", 0, 511526, f_28cb_a0_f());
	L0->AddMark("d4q02MladVladGotoJulia", "pt_map_julia", 0, 511524, f_28cb_a0_f());
	L0->AddMark("d4q02MladVladGotoLara", "pt_map_lara", 0, 511525, f_28cb_a0_f());
	f_2f14_a0_v();
	f_2f21_a0_v();
	f_2848_a1_o("quest_d4_02");
}

void f_2b02_a2_v(object a0, object a1)
{
	@SetVariable("ood4MladVlad3", 1);
}

void f_2b08_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2fe6_a0_o();
	L0->AddMark("d6q02MladVladGotoBigVlad", "pt_map_bigvlad", 0, 515378, f_28cb_a0_f());
	L0->AddMark("d6q02MladVladGotoBigVladSelf", "pt_map_mladvlad", 0, 515379, f_28cb_a0_f());
	f_2f48_a0_v();
	f_2f62_a0_v();
	f_283d_a1_o("quest_d6_02");
	f_28bf_a2_b("quest_d6_02", "place_trigger");
}

void f_2b30_a2_v(object a0, object a1)
{
	@SetVariable("ood6MladVlad1", 1);
}

void f_2b36_a2_v(object a0, object a1)
{
	@SetVariable("ood6MladVlad2", 1);
}

void f_2b3c_a2_v(object a0, object a1)
{
...
{
	f_2f6f_a0_v();
	f_28bf_a2_b("quest_d6_03", "failed");
}

void f_2b52_a2_v(object a0, object a1)
{
	f_2892_a2_b(a0, 0.30000001192092896);
}

void f_2b59_a2_v(object a0, object a1)
{
	@SetVariable("ood5MladVlad1", 1);
}

void f_2b5f_a2_v(object a0, object a1)
{
	@SetVariable("ood5MladVlad2", 1);
}

void f_2b65_a2_v(object a0, object a1)
{
}

void f_2b67_a2_v(object a0, object a1)
{
	@SetVariable("ood5MladVlad3", 1);
}

void f_2b6d_a2_v(object a0, object a1)
{
	object L0;
	object L1;
	L0 = f_2fe6_a0_o();
...
void f_2b94_a2_v(object a0, object a1)
{
	@SetVariable("ood8MladVlad1", 1);
}

void f_2b9a_a2_v(object a0, object a1)
{
	@SetVariable("ood8MladVlad2", 1);
}

void f_2ba0_a2_v(object a0, object a1)
{
	if (f_2838_a1_i("d8q01BringBadBoy") != 1 && f_2838_a1_i("d8q01MatBringToy") != 1) {
		object L0;
		L0 = f_2fe6_a0_o();
		L0->AddMark("d8q01MladVladGotoMat", "pt_map_mat", 1, 515327, f_28cb_a0_f());
		f_2f7c_a0_v();
	}
}

void f_2bc5_a2_v(object a0, object a1)
{
	@SetVariable("ood8MladVlad3", 1);
}

void f_2bcb_a2_v(object a0, object a1)
{
...
void f_2bd7_a2_v(object a0, object a1)
{
	@SetVariable("ood8MladVlad5", 1);
}

void f_2bdd_a2_v(object a0, object a1)
{
	@SetVariable("d8q04", 1);
	f_2f96_a0_v();
	f_2fb0_a0_v();
	f_283d_a1_o("quest_d8_04");
}

void f_2bed_a2_v(object a0, object a1)
{
	@SetVariable("KnowMladVlad", 1);
}

void f_2bf3_a2_v(object a0, object a1)
{
	if (f_2838_a1_i("d5q03") == 0) {
		object L0;
		@SetVariable("d5q03", 1);
		L0 = f_2fe6_a0_o();
		L0->AddMark("d5q03SavePrisoners", "pt_map_uprava_prison", 0, 515370, f_28cb_a0_f());
		f_2f2e_a0_v();
		f_2f3b_a0_v();
		f_283d_a1_o("quest_d5_03");
		f_28bf_a2_b("quest_d5_03", "place_prisoners");
	}
}

void f_2c1d_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_2fe6_a0_o();
	L0->AddMark("d8q01MladVladgotoOspina", "pt_map_ospina", 1, 515320, f_28cb_a0_f());
	f_2f89_a0_v();
}

bool f_2c30_a1_b(object a0)
{
	if (f_2838_a1_i("ood3MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2c3c_a1_b(object a0)
{
	if (f_2838_a1_i("d1q03") == 0) {
		return true;
	}
	return false;
}

bool f_2c48_a1_b(object a0)
{
	if (f_2838_a1_i("d1q03") == 1000) {
		return true;
	}
	return false;
}

bool f_2c54_a1_b(object a0)
{
	if (f_2838_a1_i("d1q03IsKapella") == 1) {
		return true;
	}
	return false;
}

bool f_2c60_a1_b(object a0)
{
	if (f_2838_a1_i("d1q01") == 6) {
		return true;
	}
	return false;
}

bool f_2c6c_a1_b(object a0)
{
	if (f_2838_a1_i("ood1MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2c78_a1_b(object a0)
{
	if (f_2838_a1_i("ood1MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2c84_a1_b(object a0)
{
	if (f_2838_a1_i("ood1MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2c90_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad6") == 0) {
		return true;
	}
	return false;
}

bool f_2c9c_a1_b(object a0)
{
	if (f_2838_a1_i("d8q04") == 2) {
		return true;
	}
	return false;
}

bool f_2ca8_a1_b(object a0)
{
	if (f_2838_a1_i("d11q05") == 2) {
		return true;
	}
	return false;
}

bool f_2cb4_a1_b(object a0)
{
	if (f_2838_a1_i("ood3MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2cc0_a1_b(object a0)
{
	if (f_2838_a1_i("d2q03") == 1) {
		return true;
	}
	return false;
}

bool f_2ccc_a1_b(object a0)
{
	if (f_2838_a1_i("ood2MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2cd8_a1_b(object a0)
{
	if (f_2838_a1_i("ood2MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2ce4_a1_b(object a0)
{
	if (f_2838_a1_i("d3q01") == 0) {
		return true;
	}
	return false;
}

bool f_2cf0_a1_b(object a0)
{
	if (f_2838_a1_i("d3q02") == 1) {
		return true;
	}
	return false;
}

bool f_2cfc_a1_b(object a0)
{
	if (f_2838_a1_i("ood3MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2d08_a1_b(object a0)
{
	if (f_2838_a1_i("d3q02") == 3) {
		return true;
	}
	return false;
}

bool f_2d14_a1_b(object a0)
{
	if (f_2838_a1_i("d3q02") == 4) {
		return true;
	}
	return false;
}

bool f_2d20_a1_b(object a0)
{
	if (f_2838_a1_i("d4q01") == 2) {
		return true;
	}
	return false;
}

bool f_2d2c_a1_b(object a0)
{
	if (f_2838_a1_i("ood4MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2d38_a1_b(object a0)
{
	if (f_2838_a1_i("ood4MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2d44_a1_b(object a0)
{
	if (f_2838_a1_i("d4q02") == 1000) {
		return true;
	}
	return false;
}

bool f_2d50_a1_b(object a0)
{
	if (f_2838_a1_i("ood4MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2d5c_a1_b(object a0)
{
	if (f_2838_a1_i("d6q02") == 0) {
		return true;
	}
	return false;
}

bool f_2d68_a1_b(object a0)
{
	if (f_2838_a1_i("ood6MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2d74_a1_b(object a0)
{
	if (f_2838_a1_i("ood6MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2d80_a1_b(object a0)
{
	if (f_2838_a1_i("ood6MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2d8c_a1_b(object a0)
{
	if (f_2838_a1_i("d5q03") == 0) {
		return true;
	}
...
bool f_2d98_a1_b(object a0)
{
	if (f_2838_a1_i("d5q03") == 1000) {
		return true;
	}
	return false;
}

bool f_2da4_a1_b(object a0)
{
	if (f_2838_a1_i("d5q03") == -1) {
		return true;
	}
	return false;
}

bool f_2db0_a1_b(object a0)
{
	if (f_2838_a1_i("d5q03") == 2) {
		return true;
	}
	return false;
}

bool f_2dbc_a1_b(object a0)
{
	if (f_2838_a1_i("ood5MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2dc8_a1_b(object a0)
{
	if (f_2838_a1_i("ood5MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2dd4_a1_b(object a0)
{
	if (f_2838_a1_i("ood5MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2de0_a1_b(object a0)
{
	if (f_2838_a1_i("d6q02GorbunDeath") != 0) {
		return true;
	}
	return false;
}

bool f_2dec_a1_b(object a0)
{
	if (f_2838_a1_i("d6q02Trigger") != 0) {
		return true;
	}
	return false;
}

bool f_2df8_a1_b(object a0)
{
	if (f_2838_a1_i("d8q01") == 1) {
		return true;
	}
	return false;
}

bool f_2e04_a1_b(object a0)
{
	if (f_2838_a1_i("d8q01MladVladIsBad") == 1) {
		return true;
	}
	return false;
}

bool f_2e10_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad1") == 0) {
		return true;
	}
	return false;
}

bool f_2e1c_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad2") == 0) {
		return true;
	}
	return false;
}

bool f_2e28_a1_b(object a0)
{
	if (f_2838_a1_i("d8q01BringBadBoy") == 1) {
		return true;
	}
	return false;
}

bool f_2e34_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad3") == 0) {
		return true;
	}
	return false;
}

bool f_2e40_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad4") == 0) {
		return true;
	}
	return false;
}

bool f_2e4c_a1_b(object a0)
{
	if (f_2838_a1_i("ood8MladVlad5") == 0) {
		return true;
	}
	return false;
}

bool f_2e58_a1_b(object a0)
{
	if (f_2838_a1_i("d8q01BigVladIsVictim") == 1) {
		return true;
	}
	return false;
}

bool f_2e64_a1_b(object a0)
{
	if (f_2838_a1_i("d8q01MladVladIsVictim") == 1) {
		return true;
	}
	return false;
}

bool f_2e70_a1_b(object a0)
{
	if (f_2838_a1_i("d1q01") != 0 && f_2838_a1_i("d1q01") != 1000 && f_2838_a1_i("d1q01") != -1) {
		return true;
	}
	return false;
}

bool f_2e92_a1_b(object a0)
{
	if (f_2ea6_a1_b(a0)) {
		return true;
	}
...
bool f_2fca_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_2ff7_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
