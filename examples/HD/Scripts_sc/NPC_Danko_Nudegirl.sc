...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_561_a0_i());
		L0->SetNPCDescription(f_55f_a0_i());
		L0->SetPhoto(f_563_a0_s());
		L0->SetPhoto2(f_565_a0_s());
...
maintask t4
{
	...
	{
		tv5 = true;
		if (!f_3e1_a0_b() && f_332_a0_b()) {
			@RemoveActor(f_507_a0_o());
		}
	}
	...
	bool f_332_a0_b(void)
	{
		return true;
	}

	void f_334_a2_v(float a0, float a1)
	{
		if (!f_3e1_a0_b()) {
			return;
		}
	...
	for (L1 = 0; L1 < 5 && f_3e1_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_547_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_3e6_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_50d_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_4d7_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_527_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_541_a1_b(int a0)
{
	return f_538_a0_i() == a0;
}

string f_547_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_54e_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_547_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
bool f_567_a0_b(void)
{
	return false;
}

void f_569_a2_v(object a0, object a1)
{
	@SetVariable("ood7Nudegirl1", 1);
}

void f_56f_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d7q04", 1);
	L0 = f_60f_a0_o();
	L0->AddMark("d7q04NudeGotoAndrei", "pt_map_andrei", 0, 515352, f_533_a0_f());
	f_5cc_a0_v();
	f_5d9_a0_v();
	f_51c_a1_o("quest_d7_04");
	f_527_a2_b("quest_d7_04", "init_kabak");
}

void f_592_a2_v(object a0, object a1)
{
	@SetVariable("ood7Nudegirl2", 1);
}

void f_598_a2_v(object a0, object a1)
{
	f_620_a3_v(f_60f_a0_o(), "pt_map_andrei", 2);
	a1->ShowMap(f_60f_a0_o());
}

bool f_5a8_a1_b(object a0)
{
	if (f_517_a1_i("ood7Nudegirl1") == 0) {
		return true;
	}
	return false;
}
...
bool f_5f3_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_620_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
