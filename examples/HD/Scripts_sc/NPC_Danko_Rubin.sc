...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_1293_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1448_a0_i());
		L0->SetNPCDescription(f_1446_a0_i());
		L0->SetPhoto(f_144a_a0_s());
		L0->SetPhoto2(f_144c_a0_s());
		L0->SetPlayerName(f_1781_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_1603_a1_b(tv1) && f_160f_a1_b(tv1)) {
				f_15b5_a2_v(tv1, tv0);
				f_134_a1_v("Neutral");
			...
			if (f_164b_a1_b(tv1) && !f_163f_a1_b(tv1) && !f_15d3_a1_b(tv1)) {
				f_134_a1_v("Neutral");
			...
			if (f_164b_a1_b(tv1) && !f_163f_a1_b(tv1)) {
				f_134_a1_v("Neutral");
			...
			if (f_1633_a1_b(tv1) && !f_1603_a1_b(tv1) && !f_163f_a1_b(tv1)) {
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_166e_a1_b(tv1) && f_1662_a1_b(tv1) && f_167a_a1_b(tv1)) {
				f_152d_a2_v(tv1, tv0);
				f_791_a1_v("Neutral");
			...
			if (f_169d_a1_b(tv1) && f_16a9_a1_b(tv1)) {
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_1685_a1_b(tv1) && f_15f7_a1_b(tv1)) {
				f_1496_a2_v(tv1, tv0);
				f_d65_a1_v("Warning");
	...
	void OnDialogReply(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 13240) {
				...
				tv0->AddReply(541856, 13242, 44080);
				return;
			}
			if (a0 == 13242) {
				f_d65_a1_v("Warning");
...
maintask t14
{
	...
	bool f_1185_a0_b(void)
	{
		...
		return f_1285_a1_b(L0);
	}

	void f_1194_a0_v(void)
	{
		@RotateAsync(tv0.x, tv0.z);
	}

	bool f_1199_a0_b(void)
	{
		object L0;
		bool L1;
		@FindActor(L0, "player");
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_11b8_a0_v();
			if (f_128e_a0_b() && f_1199_a0_b()) {
				if (f_1185_a0_b()) {
					f_1324_a1_b(f_13a9_a0_o());
				}
			} else {
				f_1194_a0_v();
				f_11af_a0_v();
...
void f_1227_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_128e_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_142e_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_126c_a0_b(void)
{
	return true;
}

void f_126e_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_1273_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_1285_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_127b_a1_b(L0);
}

bool f_128e_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_1293_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_13af_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_1324_a1_b(object a0)
{
	...
	return f_1393_a1_b(L4);
}

bool f_1349_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_141f_a0_i() + "m";
	int L1;
...
void f_1384_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_13be_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_13ca_a2_v(int a0, int a1)
{
	object L0;
	@CreateIntVector(L0);
	L0->add(a0);
...
void f_13d6_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_13e9_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
	f_13d6_a3_v(a0, L0, a2);
}

bool f_13f6_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
bool f_13fd_a2_b(object a0, string a1)
{
	int L0;
	int L1;
	bool L2;
...
bool f_140e_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_1428_a1_b(int a0)
{
	return f_141f_a0_i() == a0;
}

string f_142e_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_1435_a0_i(void)
{
	int L0;
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_142e_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_1446_a0_i(void)
{
	return 515551;
}

int f_1448_a0_i(void)
{
	return 502876;
}

string f_144a_a0_s(void)
{
	return "ui/NPC_Rubin.png";
}

string f_144c_a0_s(void)
{
	return "ui/NPC_Rubin_b.png";
}

bool f_144e_a0_b(void)
{
	return true;
}

void f_1450_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_1456_a2_v(object a0, object a1)
{
	f_13fd_a2_b(a0, "d3q01_blood");
}

void f_145d_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d10q02", 2);
	L0 = f_174f_a0_o();
	L0->AddMark("d10q02RubinGotoMaria", "pt_map_maria", 0, 515297, f_141a_a0_f());
	f_16cb_a0_v();
}
...
void f_1474_a2_v(object a0, object a1)
{
	...
	f_13e9_a3_v(a0, "blue_vaccine", 1);
}

void f_147f_a2_v(object a0, object a1)
{
...
{
	@Trace("lens is given");
	f_13e9_a3_v(a0, "lens", 1);
}

void f_1496_a2_v(object a0, object a1)
{
	@SetVariable("ood6Rubin1", 1);
}
...
void f_14a2_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d3q01", 1);
	L0 = f_174f_a0_o();
	L0->AddMark("d3q01RubinGotoAlexandr", "pt_map_alexandr", 1, 511151, f_141a_a0_f());
	f_16d8_a0_v();
	f_16e5_a0_v();
}
...
void f_14c2_a2_v(object a0, object a1)
{
	@SetVariable("ood3Rubin2", 1);
}

void f_14c8_a2_v(object a0, object a1)
{
	@SetVariable("ood3Rubin3", 1);
}

void f_14ce_a2_v(object a0, object a1)
{
	@SetVariable("ood3Rubin4", 1);
}

void f_14d4_a2_v(object a0, object a1)
{
	f_1760_a3_v(f_174f_a0_o(), "pt_map_alexandr", 2);
	a1->ShowMap(f_174f_a0_o());
}

void f_14e4_a2_v(object a0, object a1)
{
	f_1760_a3_v(f_174f_a0_o(), "pt_map_bigvlad", 2);
	a1->ShowMap(f_174f_a0_o());
}

void f_14f4_a2_v(object a0, object a1)
{
	f_16f2_a0_v();
	f_140e_a2_b("quest_d3_01", "completed");
}

void f_14fe_a2_v(object a0, object a1)
{
	@SetVariable("d3RubinToldWhereIsSimon", 1);
}

void f_1504_a2_v(object a0, object a1)
{
...
void f_150a_a2_v(object a0, object a1)
{
	...
	@SetVariable("d5q01", 1);
	L0 = f_174f_a0_o();
	L0->AddMark("d5q01RubinGotoBigVlad", "pt_map_bigvlad", 1, 511956, f_141a_a0_f());
	L0->AddMark("d5q01RubinGotoBigVladSelf", "pt_map_rubin", 1, 515348, f_141a_a0_f());
	f_16ff_a0_v();
	f_170c_a0_v();
}

void f_152d_a2_v(object a0, object a1)
{
...
void f_1533_a2_v(object a0, object a1)
{
	...
	f_140e_a2_b("quest_d5_01", "completed");
}

void f_158d_a2_v(object a0, object a1)
{
	object L0;
...
void f_159a_a2_v(object a0, object a1)
{
	@Trace("whitevaccine is given");
	f_13e9_a3_v(a0, "white_vaccine", 1);
}

void f_15a5_a2_v(object a0, object a1)
{
	f_1760_a3_v(f_174f_a0_o(), "pt_map_maria", 2);
	a1->ShowMap(f_174f_a0_o());
}

void f_15b5_a2_v(object a0, object a1)
{
...
void f_15c1_a2_v(object a0, object a1)
{
	@SetVariable("ood5Rubin3", 1);
}

bool f_15c7_a1_b(object a0)
{
	if (f_13b9_a1_i("d10q02") == 1) {
		return true;
	}
	return false;
}

bool f_15d3_a1_b(object a0)
{
	if (f_13b9_a1_i("microscope_d3q01_blood") != 0) {
		return true;
	}
	return false;
}

bool f_15df_a1_b(object a0)
{
	if (f_13b9_a1_i("ood4Rubin1") == 0) {
		return true;
	}
	return false;
}

bool f_15eb_a1_b(object a0)
{
	if (f_13b9_a1_i("ood4Rubin2") == 0) {
		return true;
	}
	return false;
}

bool f_15f7_a1_b(object a0)
{
	if (f_13b9_a1_i("ood6Rubin1") == 0) {
		return true;
	}
	return false;
}

bool f_1603_a1_b(object a0)
{
	if (f_13b9_a1_i("d3q01") == 0) {
		return true;
	}
	return false;
}

bool f_160f_a1_b(object a0)
{
	if (f_13b9_a1_i("ood3Rubin1") == 0) {
		return true;
	}
	return false;
}

bool f_161b_a1_b(object a0)
{
	if (f_13b9_a1_i("ood3Rubin2") == 0) {
		return true;
	}
	return false;
}

bool f_1627_a1_b(object a0)
{
	if (f_13b9_a1_i("ood3Rubin3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_13b9_a1_i("ood3Rubin4") == 0) {
		return true;
	}
	return false;
}

bool f_163f_a1_b(object a0)
{
	if (f_13b9_a1_i("d3q01") == 1000) {
		return true;
	}
	return false;
}

bool f_164b_a1_b(object a0)
{
	if (f_13f6_a2_b(a0, "d3q01_blood")) {
		return true;
	}
	return false;
}
...
{
	if (f_13b9_a1_i("ood5Rubin1") == 0) {
		return true;
	}
	return false;
}

bool f_1662_a1_b(object a0)
{
	if (f_13b9_a1_i("d5q01") == 7) {
		return true;
	}
	return false;
}

bool f_166e_a1_b(object a0)
{
	if (f_13b9_a1_i("ood5Rubin2") == 0) {
		return true;
	}
	return false;
}

bool f_167a_a1_b(object a0)
{
	if (f_13f6_a2_b(a0, "d5q01_heart")) {
		return true;
	}
	return false;
}

bool f_1685_a1_b(object a0)
{
	if (f_13b9_a1_i("d6RubinGoesToGeorg") != 0) {
		return true;
	}
	return false;
}

bool f_1691_a1_b(object a0)
{
	if (f_13b9_a1_i("d5q01") == 0) {
		return true;
	}
	return false;
}

bool f_169d_a1_b(object a0)
{
	if (f_13b9_a1_i("ood5Rubin3") == 0) {
		return true;
	}
	return false;
}

bool f_16a9_a1_b(object a0)
{
	if (f_13b9_a1_i("d5q01") != 0 && f_13b9_a1_i("d5q01") != -1 && f_13b9_a1_i("d5q01") != 1000) {
		return true;
	}
	return false;
}

void f_16cb_a0_v(void)
{
	object L0;
...
bool f_1733_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_1760_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
