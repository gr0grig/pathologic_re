...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_a40_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_bc4_a0_i());
		L0->SetNPCDescription(f_bc2_a0_i());
		L0->SetPhoto(f_bc6_a0_s());
		L0->SetPhoto2(f_bc8_a0_s());
		L0->SetPlayerName(f_d4c_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_c50_a1_b(tv1) && f_c5c_a1_b(tv1)) {
...
task t5
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_c68_a1_b(tv1) && f_c74_a1_b(tv1)) {
				tv0->AddReply(526038, 30287, 27323);
			}
			if (f_c80_a1_b(tv1) && f_c8c_a1_b(tv1)) {
...
task t7
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_c98_a1_b(tv1) && f_ca4_a1_b(tv1)) {
...
maintask t12
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_95e_a0_v();
			if (f_a3b_a0_b() && f_93f_a0_b()) {
				if (f_92b_a0_b()) {
					f_ad1_a1_b(f_b56_a0_o());
				}
			} else {
				f_93a_a0_v();
				f_955_a0_v();
...
void f_9cd_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_a3b_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_baa_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_a12_a0_b(void)
{
	return true;
}

void f_a14_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_a19_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
void f_a21_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_a32_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_a28_a1_b(L0);
}

bool f_a3b_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_a40_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_b5c_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_ad1_a1_b(object a0)
{
	...
	return f_b40_a1_b(L4);
}

bool f_af6_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_b9b_a0_i() + "m";
	int L1;
...
void f_b77_a2_v(object a0, int a1)
{
	f_a21_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_b8a_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_ba4_a1_b(int a0)
{
	return f_b9b_a0_i() == a0;
}

string f_baa_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_bb1_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_baa_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_bc6_a0_s(void)
{
	return "ui/NPC_Eva.png";
}

string f_bc8_a0_s(void)
{
	return "ui/NPC_Eva_b.png";
}

bool f_bca_a0_b(void)
{
	return true;
}
...
void f_bcc_a2_v(object a0, object a1)
{
	object L0;
	L0 = f_d1a_a0_o();
	L0->AddMark("k3q03EvaGotoSklad", "pt_region01_center01", 0, 525574, f_b96_a0_f());
}

void f_bdc_a2_v(object a0, object a1)
{
	@SetVariable("k3q02", 3);
	f_cca_a0_v();
}
...
void f_bfc_a2_v(object a0, object a1)
{
	a0->SelectWeapon();
	f_b8a_a2_b("quest_k6_01", "unlock_eva");
}

void f_c05_a2_v(object a0, object a1)
{
	f_ce4_a0_v();
}
...
void f_c1f_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "givemoney");
}

void f_c25_a2_v(object a0, object a1)
{
	f_d2b_a3_v(f_d1a_a0_o(), "pt_region01_center01", 2);
	a1->ShowMap(f_d1a_a0_o());
}

void f_c35_a2_v(object a0, object a1)
{
	@SetVariable("k3q02", -1);
	f_cbd_a0_v();
}

void f_c3e_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

bool f_c44_a1_b(object a0)
{
	if (f_b66_a1_i("k3q02") == 2) {
		return true;
	}
	return false;
}

bool f_c50_a1_b(object a0)
{
	if (f_b66_a1_i("k3q03") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_b66_a1_i("ook6Eva1") == 0) {
		return true;
	}
	return false;
}

bool f_c80_a1_b(object a0)
{
	if (f_b66_a1_i("k6q01") == 2) {
		return true;
	}
	return false;
}
...
{
	if (f_b66_a1_i("ook6Eva2") == 0) {
		return true;
	}
	return false;
}

bool f_c98_a1_b(object a0)
{
	if (f_b66_a1_i("k11q01") == 1) {
		return true;
	}
	return false;
}

bool f_ca4_a1_b(object a0)
{
	if (f_b66_a1_i("ook11Eva1") == 0) {
		return true;
	}
	return false;
}

void f_cb0_a0_v(void)
{
	object L0;
...
{
	object L0;
	@CreateDiaryEntry(L0, 787, 2, 542506);
	f_cfe_a2_b(L0, 344);
}

void f_cca_a0_v(void)
{
	object L0;
...
bool f_cfe_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_d2b_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
