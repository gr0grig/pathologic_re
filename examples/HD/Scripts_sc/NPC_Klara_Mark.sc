...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3e7_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_536_a0_i());
		L0->SetNPCDescription(f_534_a0_i());
		L0->SetPhoto(f_538_a0_s());
		L0->SetPhoto2(f_53a_a0_s());
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->AddReply(541845, 44064, 44063);
			break;
			return;
		}
		if (f_53c_a0_b()) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 44064) {
				f_8b_a1_v("Rage");
				tv0->SetMessage(541846);
				tv0->ClearReplies();
				tv0->AddReply(541847, 30769, 44065);
				tv0->AddReply(541848, 30769, 44066);
				return;
			}
			if (a0 == 30769) {
				f_8b_a1_v("Rage");
...
maintask t6
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_30c_a0_v();
			if (f_3e2_a0_b() && f_2ed_a0_b()) {
				if (f_2d9_a0_b()) {
					f_478_a1_b(f_4fd_a0_o());
				}
			} else {
				f_2e8_a0_v();
				f_303_a0_v();
...
void f_37b_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_3e2_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_51c_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_3e7_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_4d8_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_516_a1_b(int a0)
{
	return f_50d_a0_i() == a0;
}
...
int f_523_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_51c_a1_s(L0));
		if (!L1) {
			break;
		}
	}
