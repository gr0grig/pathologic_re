...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_5eb_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_74b_a0_i());
		L0->SetNPCDescription(f_749_a0_i());
		L0->SetPhoto(f_74d_a0_s());
		L0->SetPhoto2(f_74f_a0_s());
		L0->SetPlayerName(f_7dc_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t8
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_510_a0_v();
			if (f_5e6_a0_b() && f_4f1_a0_b()) {
				if (f_4dd_a0_b()) {
					f_67c_a1_b(f_701_a0_o());
				}
			} else {
				f_4ec_a0_v();
				f_507_a0_v();
...
void f_57f_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_5e6_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_731_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_5c4_a0_b(void)
{
	return true;
}

void f_5c6_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_5cb_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_5dd_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_5d3_a1_b(L0);
}

bool f_5e6_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_5eb_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_707_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_6dc_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_716_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
bool f_72b_a1_b(int a0)
{
	return f_722_a0_i() == a0;
}

string f_731_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_738_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_731_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_74d_a0_s(void)
{
	return "ui/NPC_Mat.png";
}

string f_74f_a0_s(void)
{
	return "ui/NPC_Mat_b.png";
}

bool f_751_a0_b(void)
{
	return true;
}

void f_753_a2_v(object a0, object a1)
{
	@SetVariable("k8q01", 2);
	f_799_a0_v();
}

void f_75c_a2_v(object a0, object a1)
{
	@SetVariable("k8q01", 4);
	f_7a6_a0_v();
	f_716_a2_b("quest_k8_01", "unlock_boiny");
}

void f_76a_a2_v(object a0, object a1)
{
	f_78c_a0_v();
	f_716_a2_b("quest_k8_01", "fail");
}

bool f_774_a1_b(object a0)
{
	if (f_711_a1_i("k8q01") == 1) {
		return true;
	}
	return false;
}
...
bool f_7c0_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
