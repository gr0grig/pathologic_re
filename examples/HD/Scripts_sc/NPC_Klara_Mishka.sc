...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3d3_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_522_a0_i());
		L0->SetNPCDescription(f_520_a0_i());
		L0->SetPhoto(f_524_a0_s());
		L0->SetPhoto2(f_526_a0_s());
...
maintask t6
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_2f8_a0_v();
			if (f_3ce_a0_b() && f_2d9_a0_b()) {
				if (f_2c5_a0_b()) {
					f_464_a1_b(f_4e9_a0_o());
				}
			} else {
				f_2d4_a0_v();
				f_2ef_a0_v();
...
void f_367_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_3ce_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_508_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_3d3_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_4ef_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_4c4_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_502_a1_b(int a0)
{
	return f_4f9_a0_i() == a0;
}

string f_508_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_50f_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_508_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_524_a0_s(void)
{
	return "ui/NPC_Mishka.png";
}

string f_526_a0_s(void)
{
