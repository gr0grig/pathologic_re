		...
		for (L1 = 0; L1 < 5 && f_7f3_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_9fc_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
void f_87c_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_94a_a1_i("Money"), 0, L0);
}

void f_89b_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_87c_a2_v(0, 100 + f_85f_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_94a_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_94a_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_94a_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_94a_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_94a_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_94a_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_87c_a2_v(0, 50 + f_85f_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_94a_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_94a_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_94a_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_94a_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_94a_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_94a_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
bool f_97c_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_abb_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_ac0_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_ac5_a1_b(a0);
			}
		}
	}
	return false;
...
void f_99c_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_abe_a1_v(a0);
	} else {
...
bool f_9b5_a1_b(object a0)
{
	if (f_abb_a1_b(a0) && f_6cf_a1_b(a0)) {
		bool L0;
...
bool f_9df_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_aca_a1_b(L0);
	}
	return false;
}

void f_9ef_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_a03_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_9fc_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_a14_a1_i(object a0)
{
	return f_ad7_a1_b(a0) ? 2 : 0;
}

void f_a1e_a1_v(object a0)
{
	f_a2e_a1_v(a0);
}

int f_a24_a1_i(object a0)
{
	return f_752_a1_b(a0) ? 2 : 0;
}

void f_a2e_a1_v(object a0)
{
	t3{a0};
}

bool f_a36_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
...
int f_a81_a2_i(object a0, bool a1)
{
	return f_a24_a1_i(a0);
}
...
bool f_a8e_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_a36_a2_b(a1, !a3)) {
		return false;
...
int f_ab0_a2_i(string a0, object a1)
{
	return 0;
}

void f_ab3_a2_v(string a0, object a1)
{
}

int f_ab5_a1_i(object a0)
{
	return 0;
}
...
void f_ac3_a1_v(object a0)
{
}

bool f_ac5_a1_b(object a0)
{
	return false;
}

void f_ac8_a1_v(object a0)
{
}

bool f_aca_a1_b(object a0)
{
	return false;
}
...
{
	return f_a8e_a4_b(a0, a1, 700.0, a2);
}

void f_ae6_a1_v(object a0)
{
	if (f_6cf_a1_b(a0)) {
