...
{
	if (a1 == "unholster") {
		return f_1af8_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1afd_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_1b12_a1_b(a0);
			}
		}
	}
	return false;
...
{
	if (f_1af8_a1_b(a0) && f_14c2_a1_b(a0)) {
		bool L0;
...
int f_1ae9_a2_i(string a0, object a1)
{
	return 0;
}

void f_1aec_a2_v(string a0, object a1)
{
}
...
void f_1af1_a1_v(object a0)
{
	f_1b2e_a1_v(a0);
}

void f_1af7_a0_v(void)
{
}

bool f_1af8_a1_b(object a0)
{
	return false;
}

void f_1afb_a1_v(object a0)
{
}
...
bool f_1b12_a1_b(object a0)
{
	return false;
}

void f_1b15_a1_v(object a0)
{
}
...
void f_1b26_a0_v(void)
{
	g0 = false;
	f_191e_a1_v(true);
}

void f_1b2e_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_1b56_a0_b(void)
{
	return false;
}

bool f_1b58_a3_b(object a0, object a1, bool a2)
{
	return f_1ac7_a4_b(a0, a1, 700.0, a2);
}

void f_1b62_a1_v(object a0)
{
	if (f_14c2_a1_b(a0)) {
