...
task t8
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_1825_a0_i());
		L0->SetNPCDescription(f_1823_a0_i());
		L0->SetPhoto(f_1827_a0_s());
		L0->SetPhoto2(f_1829_a0_s());
...
int f_1643_a2_i(string a0, object a1)
{
	return 0;
}

void f_1646_a2_v(string a0, object a1)
{
}
...
int f_1823_a0_i(void)
{
	return 515560;
}

int f_1825_a0_i(void)
{
	return 503345;
}

string f_1827_a0_s(void)
{
	return "ui/NPC_Citizen3.png";
}

string f_1829_a0_s(void)
{
	return "ui/NPC_Citizen3_b.png";
}

bool f_182b_a0_b(void)
{
	return false;
}

void f_182d_a0_v(void)
{
	g0 = false;
	f_17d7_a1_v(true);
}

void f_1835_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
bool f_185d_a0_b(void)
{
	return f_17bc_a0_f() > 0.4000000059604645;
}

bool f_1863_a3_b(object a0, object a1, bool a2)
{
	return f_15fc_a3_b(a0, a1, 700.0);
}
