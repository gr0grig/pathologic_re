...
task t8
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_fb1_a0_i());
		L0->SetNPCDescription(f_faf_a0_i());
		L0->SetPhoto(f_fb3_a0_s());
		L0->SetPhoto2(f_fb5_a0_s());
...
int f_e07_a2_i(string a0, object a1)
{
	return 0;
}

void f_e0a_a2_v(string a0, object a1)
{
}
...
string f_fb3_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_fb5_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_fb7_a0_b(void)
{
	return false;
}

void f_fb9_a0_v(void)
{
	g0 = false;
	f_f63_a1_v(false);
}

void f_fc1_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
{
	return f_f48_a0_f() > 0.20000000298023224;
}

bool f_fef_a3_b(object a0, object a1, bool a2)
{
	return f_dc0_a3_b(a0, a1, 700.0);
}
