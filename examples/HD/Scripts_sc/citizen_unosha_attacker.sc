...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_f8f_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_1439_a0_i());
		L0->SetNPCDescription(f_1437_a0_i());
		L0->SetPhoto(f_143b_a0_s());
		L0->SetPhoto2(f_143d_a0_s());
		L0->SetPlayerName(f_116a_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_10e6_a1_b(tv1) && f_1106_a1_b(tv1)) {
				f_1a8_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (f_10f2_a1_b(tv1) && f_10da_a1_b(tv1)) {
			...
			if (f_10f2_a1_b(tv1) && f_1124_a1_b(tv1) && f_10da_a1_b(tv1)) {
				tv0->AddReply(538017, 39883, 39882);
			}
			if (f_10fc_a1_b(tv1) && f_111a_a1_b(tv1) && f_10da_a1_b(tv1)) {
				tv0->AddReply(538043, 39911, 39910);
			}
			if (f_1110_a1_b(tv1) && f_111a_a1_b(tv1) && f_10da_a1_b(tv1)) {
				tv0->AddReply(538083, 39952, 39951);
			}
			if (f_1110_a1_b(tv1) && f_1124_a1_b(tv1) && f_10da_a1_b(tv1)) {
...
maintask t4
{
	...
	{
		if (f_1486_a3_b(a0, a1, a2)) {
			int L0;
			L0 = f_13bc_a2_i(a0, a2);
			if (L0 > 0) {
				if (L0 > 1) {
					f_906_a0_v();
				}
	...
	{
		if (f_12b7_a2_b(a0, a1)) {
			f_906_a0_v();
			f_12d7_a2_v(a0, a1);
		} else {
			int L0;
			L0 = f_13eb_a2_i(a1, a0);
			if (L0 > 0) {
				if (L0 > 1) {
					f_906_a0_v();
				}
...
task t6
{
	...
	void init(object a0)
	{
		f_aac_a3_v(a0, true, 180.0);
	}

	float f_aa6_a2_f(object a0, int a1)
	{
		return 0.05000000074505806;
	}

	int f_aa9_a2_i(object a0, int a1)
	{
		return 0;
	}

	void f_aac_a3_v(object a0, bool a1, float a2)
	{
		float L0;
		Vector L1;
		Vector L2;
		...
		if (L3) {
			...
			@SendPlayerEnemy(a0, f_107d_a0_o());
		}
		if (a1) {
			L4 = false;
		} else {
	...
	void f_bb4_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_aa6_a2_f(L0, a1);
			L2 = f_e77_a3_f(L0, L1, f_aa9_a2_i(L0, a1));
			@ReportHit(tv0, f_d33_a0_i(), L2, L1);
			f_d3a_a2_v(L0, L2);
		}
	}

	bool f_bdb_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_d2e_a0_v();
	...
	bool f_cc6_a0_b(void)
	{
		if (f_caa_a0_b() && f_cd6_a0_b()) {
			return true;
		}
		return false;
	}

	bool f_cd6_a0_b(void)
	{
		object L0;
		bool L1;
		@GetScene(L0);
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_e57_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	void f_d35_a0_v(void)
	{
		f_1054_a1_v("attack_stay");
	}

	void f_d3a_a2_v(object a0, float a1)
	{
	}

	bool f_d3c_a0_b(void)
	{
		return true;
	}
...
task t7
{
	...
	bool f_db2_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_e45_a0_s(), f_e47_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
...
bool f_e3e_a1_b(object a0)
{
	return f_ee9_a1_b(a0);
}

string f_e45_a0_s(void)
{
	return "walk";
}

string f_e47_a0_s(void)
{
	return "run";
}

string f_e49_a1_s(int a0)
{
	if (a0 == 2) {
		return "fire";
	} else {
...
bool f_e6b_a2_b(object a0, string a1)
{
	bool L0;
...
float f_e77_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_e6b_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_e6b_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_e49_a1_s(a2);
	if (!f_e6b_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_108d_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_1094_a3_f(L4 - L5, 0, 1));
	if (f_e66_a1_b(a0)) {
		f_10a4_a1_v(-L5);
	}
	return L5;
...
bool f_ec5_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_ec0_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_ee9_a1_b(object a0)
{
	int L0;
	if (!f_ec5_a1_b(a0)) {
		return false;
	}
	if (!f_e6b_a2_b(a0, "noaccess")) {
		return true;
	}
...
void f_f2d_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_1083_a1_V(f_e57_a1_V(a0));
		object L1;
...
void f_f71_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
bool f_f8f_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_1083_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	return f_fee_a2_b(a0, 70);
}

bool f_fee_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_1033_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_108d_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_1094_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_10cf_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_107d_a0_o(), L0);
}

bool f_10da_a1_b(object a0)
{
	if (f_109f_a1_i("branch") == 0) {
		return true;
	}
	return false;
}

bool f_10e6_a1_b(object a0)
{
	if (f_109f_a1_i("branch") == 2) {
		return true;
	}
	return false;
}

bool f_10f2_a1_b(object a0)
{
	if (f_112e_a1_b(a0)) {
		return true;
	}
...
{
	return f_10b5_a0_i() == 1;
}

bool f_1135_a1_b(object a0)
{
	return f_10b5_a0_i() == 2;
}

bool f_113c_a1_b(object a0)
{
	return f_10b5_a0_i() == 4;
}

bool f_1143_a1_b(object a0)
{
	return f_10b5_a0_i() == 5;
}

bool f_114a_a1_b(object a0)
{
	if (f_10be_a0_i() >= 0 && f_10be_a0_i() < 12) {
		return true;
	}
	return false;
}
...
void f_118e_a2_v(int a0, int a1)
{
	int L0;
	bool L1;
	if (a0 > a1) {
	...
	@AddItem(L1, f_1285_a1_i("Money"), 0, L0);
}
...
void f_11d6_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_118e_a2_v(0, 100 + f_10b5_a0_i() * 100);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_1285_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_1285_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_1285_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_1285_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_1285_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_1285_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_118e_a2_v(0, 50 + f_10b5_a0_i() * 50);
		@irand(L0, 7);
		if (L0 == 0) {
			@AddItem(L1, f_1285_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_1285_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_1285_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_1285_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_1285_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_1285_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
{
	f_f71_a5_v(a0, a1, a2, a4, a5);
}

bool f_12b7_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_1423_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_1428_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_142d_a1_b(a0);
			}
		}
	}
	return false;
...
void f_12d7_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_1426_a1_v(a0);
	} else {
...
{
	if (f_1423_a1_b(a0) && f_e66_a1_b(a0)) {
		bool L0;
...
void f_1307_a1_v(object a0)
{
	f_1426_a1_v(a0);
}

void f_130d_a1_v(object a0)
{
	if (f_e66_a1_b(a0)) {
		@ReportReputationChange(a0, f_107d_a0_o(), -0.009999999776482582);
	}
}

bool f_131a_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_1432_a1_b(L0);
	}
	return false;
}

void f_132a_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_134f_a1_i(object a0)
{
	return f_1473_a1_b(a0) ? 2 : 0;
}

void f_1359_a1_v(object a0)
{
	f_1369_a1_v(a0);
}

int f_135f_a1_i(object a0)
{
	return f_ee9_a1_b(a0) ? 2 : 0;
}
...
bool f_1371_a2_b(object a0, bool a1)
{
	string L0;
	string L1;
	if (!f_e6b_a2_b(a0, "class")) {
		return false;
	}
...
int f_13bc_a2_i(object a0, bool a1)
{
	return f_135f_a1_i(a0);
}
...
bool f_13c9_a4_b(object a0, object a1, float a2, bool a3)
{
	bool L0;
	if (!f_1371_a2_b(a1, !a3)) {
		return false;
	}
	@CanSee(L0, a0);
	if (L0 || f_e5e_a1_f(a0) <= a2 * a2) {
		return true;
	}
	return false;
}

int f_13e6_a1_i(object a0)
{
	return 0;
}
...
int f_13eb_a2_i(string a0, object a1)
{
	if (a0 == "killme") {
		return f_1401_a1_i(a1);
	}
	return 0;
}

void f_13f7_a2_v(string a0, object a1)
{
	if (a0 == "killme") {
		f_1413_a1_v(a1);
		return;
...
int f_1401_a1_i(object a0)
{
	if (!f_ee9_a1_b(a0)) {
		return 0;
	}
	return f_1483_a1_b(a0) ? 2 : 0;
}
...
int f_1419_a1_i(object a0)
{
	return 2;
}

void f_141c_a1_v(object a0)
{
	f_1445_a1_v(a0);
}

void f_1422_a0_v(void)
{
}
...
void f_1426_a1_v(object a0)
{
}

bool f_1428_a1_b(object a0)
{
	return false;
}
...
bool f_142d_a1_b(object a0)
{
	return false;
}

void f_1430_a1_v(object a0)
{
}
...
void f_1435_a1_v(object a0)
{
}

int f_1437_a0_i(void)
{
	return 515564;
}

int f_1439_a0_i(void)
{
	return 503349;
}

string f_143b_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_143d_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_143f_a0_b(void)
{
	return false;
}
...
bool f_1483_a1_b(object a0)
{
	return true;
}

bool f_1486_a3_b(object a0, object a1, bool a2)
{
	return f_13c9_a4_b(a0, a1, 700.0, a2);
}

void f_1490_a1_v(object a0)
{
	if (f_e66_a1_b(a0)) {
		@ReportReputationChange(a0, f_107d_a0_o(), -0.03999999910593033, true);
		f_11d6_a1_v(true);
	}
	f_11be_a0_v();
	g0 = true;
