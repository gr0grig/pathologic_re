...
task t1
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_437_a2_b(a0, 110.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_5c5_a0_i());
		L0->SetNPCDescription(f_5c3_a0_i());
		L0->SetPhoto(f_5c7_a0_s());
		L0->SetPhoto2(f_5c9_a0_s());
		L0->SetPlayerName(f_5ac_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_567_a1_b(tv1) && !f_55d_a1_b(tv1)) {
				f_f8_a1_v("Neutral");
...
maintask t5
{
	...
	void f_340_a2_v(float a0, float a1)
	{
		tv6 = false;
		for (; ; ) {
			float L0;
	...
	{
		tv5 = true;
		if (!f_432_a0_b() && f_383_a0_b()) {
			@RemoveActor(f_4f4_a0_o());
		}
	}
	...
	void f_385_a2_v(float a0, float a1)
	{
		if (!f_432_a0_b()) {
			return;
		}
	...
	for (L1 = 0; L1 < 5 && f_432_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_519_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_437_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_4fa_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_48e_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_4be_a1_v(object a0)
{
	@CameraSwitchToNormal(true);
}

void f_4c3_a1_v(string a0)
{
	bool L0;
...
bool f_509_a2_b(object a0, string a1)
{
	int L0;
	bool L1;
...
int f_520_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_519_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_531_a2_v(object a0, object a1)
{
	int L0;
	int L1;
	L0 = f_510_a0_i();
...
void f_540_a2_v(object a0, object a1)
{
	@SetVariable("oobSysGatherer2_1", 1);
}

void f_546_a2_v(object a0, object a1)
{
	@TriggerWorld("playsound", "giveitem");
}

void f_54c_a2_v(object a0, object a1)
{
...
{
	if (f_504_a1_i("oobSysGatherer2_1") == 0) {
		return true;
	}
	return false;
}
...
void f_57e_a0_v(void)
{
	...
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_5a7_a1_i("grass_black_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_5a7_a1_i("grass_blood_tvir"), 0, L1);
	@irand(L1, 15);
	L1 = L1 + 5;
	@AddItem(L0, f_5a7_a1_i("grass_brown_tvir"), 0, L1);
}

int f_5a7_a1_i(string a0)
{
	int L0;
