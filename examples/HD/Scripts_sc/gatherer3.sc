...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_5b9_a0_i());
		L0->SetNPCDescription(f_5b7_a0_i());
		L0->SetPhoto(f_5bb_a0_s());
		L0->SetPhoto2(f_5bd_a0_s());
		L0->SetPlayerName(f_5a0_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
void f_57e_a0_v(void)
{
	...
	@irand(L1, 10);
	L1 = L1 + 3;
	@AddItem(L0, f_59b_a1_i("grass_savyur"), 0, L1);
	@irand(L1, 10);
	L1 = L1 + 3;
	@AddItem(L0, f_59b_a1_i("grass_white_plet"), 0, L1);
}
...
string f_5bb_a0_s(void)
{
	return "ui/NPC_Morlok.png";
}

string f_5bd_a0_s(void)
{
	return "ui/NPC_Morlok_b.png";
}

bool f_5bf_a0_b(void)
{
	return false;
}
