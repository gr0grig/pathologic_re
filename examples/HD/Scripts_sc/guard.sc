...
bool f_761_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_915_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_91a_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_91f_a1_b(a0);
			}
		}
	}
	return false;
...
void f_781_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_918_a1_v(a0);
	} else {
...
{
	if (f_915_a1_b(a0) && f_5a0_a1_b(a0)) {
		bool L0;
...
bool f_7c4_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_924_a1_b(L0);
	}
	return false;
}

void f_7d4_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
void f_7f4_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_864_a1_i("Money"), 0, L0);
}
...
void f_83c_a0_v(void)
{
	bool L0;
	@ClearSubContainer(0);
	f_7f4_a2_v(30, 50 + f_744_a0_i() * 40);
...
int f_89d_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_896_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_8b4_a0_v(void)
{
	...
	int L3;
	@irand(L3, L2);
	@PlayAnimation("all", f_896_a1_s(L3));
	@WaitForAnimEnd();
	@UnlookAsync("head");
}

int f_8dd_a1_i(object a0)
{
...
int f_8ef_a2_i(object a0, bool a1)
{
	return f_8dd_a1_i(a0);
}
...
void f_8fc_a0_v(void)
{
	t0{};
}

int f_902_a1_i(object a0)
{
	return 2;
}

void f_905_a1_v(object a0)
{
	f_92d_a1_v(a0);
}

int f_90b_a1_i(object a0)
{
	return 0;
}
...
int f_910_a2_i(string a0, object a1)
{
	return 0;
}

void f_913_a2_v(string a0, object a1)
{
}

bool f_915_a1_b(object a0)
{
	return false;
}

void f_918_a1_v(object a0)
{
}
...
bool f_936_a3_b(object a0, object a1, bool a2)
{
	string L0;
	bool L1;
