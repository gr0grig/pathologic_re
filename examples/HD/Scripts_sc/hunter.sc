		...
		for (L1 = 0; L1 < 5 && f_720_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_8d0_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
void f_80c_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_87e_a1_i("Money"), 0, L0);
}

void f_82b_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_854_a0_v(void)
{
	...
	@AddItem(L1, f_87e_a1_i("hunter_mark"), 0, 1);
}

int f_87e_a1_i(string a0)
{
	int L0;
...
{
	if (f_5e6_a1_b(a0)) {
		if (f_7f9_a0_i() == 2 && f_7dc_a0_i() == 6) {
			f_79e_a2_b(a0, 0.10000000149011612);
		} else {
...
int f_8d7_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_8d0_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
bool f_917_a1_b(object a0)
{
	return f_8ef_a1_b(a0);
}
