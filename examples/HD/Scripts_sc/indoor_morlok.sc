		...
		for (L1 = 0; L1 < 5 && f_796_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_92f_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
bool f_8af_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_97a_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_97f_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_984_a1_b(a0);
			}
		}
	}
	return false;
...
void f_8cf_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_97d_a1_v(a0);
	} else {
...
bool f_8e8_a1_b(object a0)
{
	if (f_97a_a1_b(a0) && f_672_a1_b(a0)) {
		bool L0;
...
bool f_912_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_989_a1_b(L0);
	}
	return false;
}

void f_922_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_936_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_92f_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_959_a2_i(object a0, bool a1)
{
	return f_947_a1_i(a0);
}

void f_960_a1_v(object a0)
{
	f_951_a1_v(a0);
}

int f_966_a1_i(object a0)
{
	return 0;
}

void f_969_a1_v(object a0)
{
}

int f_96b_a2_i(string a0, object a1)
{
	return 0;
}

void f_96e_a2_v(string a0, object a1)
{
}

int f_970_a1_i(object a0)
{
	return 2;
}
...
bool f_99f_a3_b(object a0, object a1, bool a2)
{
	string L0;
