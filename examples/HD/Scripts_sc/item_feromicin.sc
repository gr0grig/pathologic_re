maintask t0
{
	void init(void)
	{
		...
		@SetProperty("disease", L0 * 0.20000000298023224);
		f_4e_a1_v(L0 - L0 * 0.20000000298023224);
		f_26_a4_b("tiredness", 0.30000001192092896, 0, 1);
		f_44_a1_v(0.30000001192092896);
		f_26_a4_b("health", -0.30000001192092896, 0, 1);
		f_58_a1_v(-0.30000001192092896);
	}
}
