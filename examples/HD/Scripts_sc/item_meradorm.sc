maintask t0
{
	...
	void init(void)
	{
		f_52_a4_b("health", 0.029999999329447746, 0, 1);
		f_87_a1_v(0.029999999329447746);
		f_52_a4_b("tiredness", 0.25, 0, 1);
		f_7d_a1_v(0.25);
		f_32_a1_v(5.0);
	}
	...
	{
		if (f_65_a0_b()) {
			f_52_a4_b("health", a0 * 0.07999999821186066, 0, 1);
			f_52_a4_b("tiredness", a0 * -0.05000000074505806, 0, 1);
		}
		return false;
	}
