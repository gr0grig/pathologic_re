...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3cf_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_546_a0_i());
		L0->SetNPCDescription(f_544_a0_i());
		L0->SetPhoto(f_548_a0_s());
		L0->SetPhoto2(f_54a_a0_s());
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			if (f_4bd_a1_b(tv1)) {
				...
				tv0->AddReply(538621, 40494, 40512);
				break;
			}
			if (f_4c7_a1_b(tv1)) {
				f_1b7_a1_v("Neutral");
...
maintask t4
{
	...
	void OnUse(object a0)
	{
		...
		if (L0 == f_46d_a0_i()) {
			...
			L1 = t2{a0};
			if (L1 == 1) {
				f_461_a2_b("klara2_svita_positioner", "wonder");
			} else {
				if (L1 == 2) {
					f_461_a2_b("klara2_svita_positioner", "wrong_wonder");
				}
			}
		} else {
			t0{a0};
	...
	void f_31d_a2_v(float a0, float a1)
	{
		if (!f_3ca_a0_b()) {
			return;
		}
	...
	for (L1 = 0; L1 < 5 && f_3ca_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_476_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
void f_3bd_a0_v(void)
{
	@StopAnimation();
	@StopGroup0();
}

float f_3c2_a1_f(object a0)
{
	Vector L0;
	Vector L1;
	Vector L2;
...
bool f_3cf_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_436_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_461_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_47d_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_476_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_48e_a2_v(object a0, object a1)
{
	f_52d_a1_v("AlbinosLate1");
}

void f_494_a2_v(object a0, object a1)
{
	f_461_a2_b("klara2_svita_positioner", "wonder");
}

void f_49b_a2_v(object a0, object a1)
{
	f_461_a2_b("klara2_svita_positioner", "bad_wonder");
}
...
void f_4ae_a2_v(object a0, object a1)
{
	f_4e6_a0_v();
}
...
bool f_4d1_a1_b(object a0)
{
	return f_538_a1_b("AlbinosLate1");
}

bool f_4d8_a1_b(object a0)
{
	return f_538_a1_b("Albinos1");
}

bool f_4df_a1_b(object a0)
{
	return !f_538_a1_b("BadKlara");
}

void f_4e6_a0_v(void)
{
	object L0;
	@CreateDiaryEntry(L0, 785, 2, 542470);
	f_500_a2_b(L0, 723);
}
...
string f_548_a0_s(void)
{
	return "ui/NPC_Albinos.png";
}

string f_54a_a0_s(void)
{
	return "ui/NPC_Albinos_b.png";
}

bool f_54c_a0_b(void)
{
	return false;
}
