...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_de3_a0_i());
		L0->SetNPCDescription(f_de1_a0_i());
		L0->SetPhoto(f_de5_a0_s());
		L0->SetPhoto2(f_de7_a0_s());
		L0->SetPlayerName(f_b28_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t6
{
	void init(object a0)
	{
		if (f_818_a1_b(a0)) {
			object L0;
			@GetScene(L0);
			L0->RemoveStationaryActor(f_a9b_a0_o());
		}
		f_6f6_a1_v(a0);
	}
...
float f_829_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_aaf_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_ab6_a3_f(L4 - L5, 0, 1));
	if (f_818_a1_b(a0)) {
		f_ad1_a1_v(-L5);
	}
	return L5;
...
bool f_93c_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_aa1_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	return f_99b_a2_b(a0, 70);
}

bool f_99b_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_9e0_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_a01_a3_v(string a0, int a1, int a2)
{
	if (f_ac1_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
void f_a0c_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_ac1_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
float f_aab_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_aaf_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_ab6_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_af4_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_a9b_a0_o(), L0);
}

void f_aff_a2_v(object a0, object a1)
{
	a1->SetReturnValue(1000);
}

bool f_b04_a1_b(object a0)
{
	if (f_acc_a1_i("branch") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_acc_a1_i("branch") == 1) {
		return true;
	}
	return false;
}

bool f_b1c_a1_b(object a0)
{
	if (f_acc_a1_i("branch") == 2) {
		return true;
	}
	return false;
}
...
void f_b4c_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_c94_a1_i("Money"), 0, L0);
}
...
void f_b94_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_ae2_a0_i();
	f_b4c_a2_v(0, 100 + L2 * 100);
	f_a01_a3_v("tourniquet", 1, 7);
	f_a01_a3_v("bandage", 1, 7);
	f_a01_a3_v("packet", 1, 10);
	f_a01_a3_v("bottle_water", 1, 3);
	f_a0c_a4_v("rusk", 1, 3, 4);
	f_a01_a3_v("hook", 1, 20);
	f_a01_a3_v("watch", 1, 20);
	if (L2 >= 3 && L2 < 6) {
		f_a0c_a4_v("alpha_pills", 1, 2, 3);
	}
	if (L2 >= 4) {
		f_a0c_a4_v("beta_pills", 1, 4, 3);
	}
	if (L2 >= 6) {
		f_a0c_a4_v("alpha_pills", 1, 2, 8);
		f_a0c_a4_v("gamma_pills", 1, 8, 3);
	}
	if (L2 >= 8) {
		f_a01_a3_v("revolver_ammo", 1, 3);
		f_a01_a3_v("rifle_ammo", 1, 3);
	}
	@AddItem(L1, f_c94_a1_i("patrol_mark"), 0, 1);
}

void f_c13_a0_v(void)
{
	int L0;
	bool L1;
	int L2;
	@ClearSubContainer(0);
	L2 = f_ae2_a0_i();
	f_b4c_a2_v(0, 10 + L2 * 5);
	f_a01_a3_v("bottle_water", 1, 3);
	f_a01_a3_v("rusk", 1, 20);
	f_a01_a3_v("hook", 1, 30);
	f_a01_a3_v("watch", 1, 30);
	if (L2 >= 3) {
		f_a0c_a4_v("alpha_pills", 1, 4, 3);
	}
	if (L2 >= 4) {
		f_a0c_a4_v("beta_pills", 1, 8, 3);
	}
	if (L2 >= 6) {
		f_a0c_a4_v("gamma_pills", 1, 16, 3);
	}
}
...
void f_c5a_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_ae2_a0_i();
	f_a0c_a4_v("fresh_meat", 1, 4, 3);
	f_a0c_a4_v("dried_meat", 1, 4, 3);
	f_a0c_a4_v("smoked_meat", 1, 4, 3);
	f_a0c_a4_v("vegetables", 1, 3, 3);
	if (L2 >= 3) {
		f_a01_a3_v("revolver_ammo", 1, 5);
		f_a01_a3_v("rifle_ammo", 1, 5);
		f_a01_a3_v("samopal_ammo", 1, 5);
	}
}
...
bool f_c99_a2_b(object a0, bool a1)
{
	string L0;
...
void f_d21_a0_v(void)
{
	g0 = f_ac6_a0_o();
}

void f_d28_a1_v(object a0)
{
	if (!f_993_a1_b(a0)) {
		return;
	}
...
{
	return f_deb_a1_b(a0);
}

void f_d42_a1_v(object a0)
{
	f_d55_a1_v(a0);
}

bool f_d48_a1_b(object a0)
{
	return f_deb_a1_b(a0);
}
...
void f_d55_a1_v(object a0)
{
	t5{a0, true};
	@ResetAAS();
}

void f_d60_a1_v(object a0)
{
	bool L0;
	if (a0 == null) {
		return;
	...
	if (f_818_a1_b(a0)) {
		@ReportReputationChange(a0, f_a9b_a0_o(), -0.07000000029802322);
	}
}

void f_d78_a1_v(object a0)
{
	f_d60_a1_v(a0);
	t5{a0, true};
	@ResetAAS();
...
void f_d87_a1_v(object a0)
{
	if (f_818_a1_b(a0)) {
		@ReportReputationChange(a0, f_a9b_a0_o(), -0.12999999523162842, true);
	}
	t6{a0};
}
...
bool f_dc7_a3_b(object a0, object a1, bool a2)
{
	if (f_c99_a2_b(a1, !a2)) {
		bool L0;
		@CanSee(L0, a0);
...
string f_de5_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_de7_a0_s(void)
{
...
bool f_deb_a1_b(object a0)
{
	...
	if (f_81d_a2_b(a0, "class")) {
		...
		if (f_a44_a1_b(L2) && f_81d_a2_b(a0, "disease")) {
			float L3;
