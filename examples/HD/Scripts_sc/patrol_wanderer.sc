...
task t1
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_c31_a0_i());
		L0->SetNPCDescription(f_c2f_a0_i());
		L0->SetPhoto(f_c33_a0_s());
		L0->SetPhoto2(f_c35_a0_s());
		L0->SetPlayerName(f_976_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
		...
		for (L1 = 0; L1 < 5 && f_7f6_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_95e_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
float f_6e3_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_913_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_91a_a3_f(L4 - L5, 0, 1));
	if (f_6d2_a1_b(a0)) {
		f_930_a1_v(-L5);
	}
	return L5;
...
bool f_7fb_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_909_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_852_a1_b(object a0)
{
	return f_85a_a2_b(a0, 70);
}

bool f_85a_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
void f_88a_a1_v(object a0)
{
	@CameraSwitchToNormal(true);
}

void f_88f_a1_v(string a0)
{
	bool L0;
...
void f_89f_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_8c0_a3_v(string a0, int a1, int a2)
{
	if (f_925_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
void f_8cb_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_925_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
float f_913_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_91a_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_953_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_903_a0_o(), L0);
}

string f_95e_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_965_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_95e_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_99a_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_ae2_a1_i("Money"), 0, L0);
}
...
void f_9e2_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_941_a0_i();
	f_99a_a2_v(0, 100 + L2 * 100);
	f_8c0_a3_v("tourniquet", 1, 7);
	f_8c0_a3_v("bandage", 1, 7);
	f_8c0_a3_v("packet", 1, 10);
	f_8c0_a3_v("bottle_water", 1, 3);
	f_8cb_a4_v("rusk", 1, 3, 4);
	f_8c0_a3_v("hook", 1, 20);
	f_8c0_a3_v("watch", 1, 20);
	if (L2 >= 3 && L2 < 6) {
		f_8cb_a4_v("alpha_pills", 1, 2, 3);
	}
	if (L2 >= 4) {
		f_8cb_a4_v("beta_pills", 1, 4, 3);
	}
	if (L2 >= 6) {
		f_8cb_a4_v("alpha_pills", 1, 2, 8);
		f_8cb_a4_v("gamma_pills", 1, 8, 3);
	}
	if (L2 >= 8) {
		f_8c0_a3_v("revolver_ammo", 1, 3);
		f_8c0_a3_v("rifle_ammo", 1, 3);
	}
	@AddItem(L1, f_ae2_a1_i("patrol_mark"), 0, 1);
}

void f_a61_a0_v(void)
{
	int L0;
	bool L1;
	int L2;
	@ClearSubContainer(0);
	L2 = f_941_a0_i();
	f_99a_a2_v(0, 10 + L2 * 5);
	f_8c0_a3_v("bottle_water", 1, 3);
	f_8c0_a3_v("rusk", 1, 20);
	f_8c0_a3_v("hook", 1, 30);
	f_8c0_a3_v("watch", 1, 30);
	if (L2 >= 3) {
		f_8cb_a4_v("alpha_pills", 1, 4, 3);
	}
	if (L2 >= 4) {
		f_8cb_a4_v("beta_pills", 1, 8, 3);
	}
	if (L2 >= 6) {
		f_8cb_a4_v("gamma_pills", 1, 16, 3);
	}
}
...
void f_aa8_a0_v(void)
{
	...
	@ClearSubContainer(0);
	L2 = f_941_a0_i();
	f_8cb_a4_v("fresh_meat", 1, 4, 3);
	f_8cb_a4_v("dried_meat", 1, 4, 3);
	f_8cb_a4_v("smoked_meat", 1, 4, 3);
	f_8cb_a4_v("vegetables", 1, 3, 3);
	if (L2 >= 3) {
		f_8c0_a3_v("revolver_ammo", 1, 5);
		f_8c0_a3_v("rifle_ammo", 1, 5);
		f_8c0_a3_v("samopal_ammo", 1, 5);
	}
}

int f_ae2_a1_i(string a0)
{
	int L0;
...
bool f_ae7_a2_b(object a0, bool a1)
{
	string L0;
...
void f_b6f_a0_v(void)
{
	g0 = f_92a_a0_o();
}

void f_b76_a1_v(object a0)
{
	if (!f_852_a1_b(a0)) {
		return;
	}
...
bool f_b96_a1_b(object a0)
{
	return f_c39_a1_b(a0);
}

void f_b9d_a1_v(object a0)
{
	f_ba3_a1_v(a0);
}
...
void f_bae_a1_v(object a0)
{
	...
	if (f_6d2_a1_b(a0)) {
		@ReportReputationChange(a0, f_903_a0_o(), -0.07000000029802322);
	}
}

void f_bc6_a1_v(object a0)
{
	f_bae_a1_v(a0);
	t6{a0, true};
	@ResetAAS();
...
void f_bd5_a1_v(object a0)
{
	if (f_6d2_a1_b(a0)) {
		@ReportReputationChange(a0, f_903_a0_o(), -0.12999999523162842, true);
	}
	t7{a0};
}
...
bool f_c15_a3_b(object a0, object a1, bool a2)
{
	if (f_ae7_a2_b(a1, !a2)) {
		bool L0;
		@CanSee(L0, a0);
...
string f_c33_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_c35_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_c37_a0_b(void)
{
	return false;
}

bool f_c39_a1_b(object a0)
{
	bool L0;
	if (!f_755_a1_b(a0)) {
		return false;
