		...
		for (L1 = 0; L1 < 5 && f_6ea_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_798_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
int f_79f_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_798_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_7c3_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_90b_a1_i("Money"), 0, L0);
}

void f_7e2_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_80b_a0_v(void)
{
	...
	@AddItem(L1, f_90b_a1_i("patrol_mark"), 0, 1);
}
...
bool f_910_a2_b(object a0, bool a1)
{
	string L0;
...
bool f_a2b_a3_b(object a0, object a1, bool a2)
{
	if (f_910_a2_b(a1, !a2)) {
		bool L0;
		@CanSee(L0, a0);
