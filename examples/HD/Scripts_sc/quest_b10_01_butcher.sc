...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_845_a0_i());
		L0->SetNPCDescription(f_843_a0_i());
		L0->SetPhoto(f_847_a0_s());
		L0->SetPhoto2(f_849_a0_s());
		L0->SetPlayerName(f_7f6_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_7d6_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
string f_847_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_849_a0_s(void)
{
...
{
	object L0;
	f_7d6_a2_b("quest_b10_01", "butcher_dead");
	f_82b_a0_v();
	@GetScene(L0);
