...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_370_a2_b(a0, 130.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_446_a0_i());
		L0->SetNPCDescription(f_444_a0_i());
		L0->SetPhoto(f_448_a0_s());
		L0->SetPhoto2(f_44a_a0_s());
		L0->SetPlayerName(f_4c9_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_488_a1_b(tv1) && f_474_a1_b(tv1)) {
				f_44e_a2_v(tv1, tv0);
				f_e9_a1_v("Neutral");
...
maintask t2
{
	...
	void f_2be_a2_v(float a0, float a1)
	{
		if (!f_36b_a0_b()) {
			return;
		}
	...
	for (L1 = 0; L1 < 5 && f_36b_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_42c_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_370_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_3f8_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_3d7_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
bool f_418_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_433_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_42c_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
string f_448_a0_s(void)
{
	return "ui/NPC_bmask.png";
}

string f_44a_a0_s(void)
{
...
{
	f_418_a2_b("quest_b12_01", "init_sobor");
}
...
void f_46d_a2_v(object a0, object a1)
{
	f_407_a2_v("sobor@door1", false);
}
...
{
	if (f_402_a1_i("oob12BirdmaskS1") == 0) {
		return true;
	}
	return false;
}

bool f_494_a1_b(object a0)
{
	if (f_402_a1_i("oob12BirdmaskS2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_402_a1_i("oob12BirdmaskS3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_402_a1_i("oob12BirdmaskS4") == 0) {
		return true;
	}
	return false;
}
...
void f_4da_a3_v(object a0, bool a1, int a2)
{
	a0->add(18);
	a0->add(24);
	a0->add(20);
...
bool f_50f_a0_b(void)
{
	...
	int L2;
	@CreateIntVector(L0);
	f_4da_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_505_a1_b(L3) || f_4fb_a1_b(L3)) {
			return false;
		}
	}
	return true;
