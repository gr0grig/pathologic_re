...
bool f_261_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_37d_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_352_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_3a7_a2_v(object a0, object a1)
{
...
{
	if (f_387_a1_i("oob12DankoSobor1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_387_a1_i("oob12DankoSobor2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_387_a1_i("oob12DankoSobor3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_387_a1_i("oob12DankoSobor4") == 0) {
		return true;
	}
	return false;
}
