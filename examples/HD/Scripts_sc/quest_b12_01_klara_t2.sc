...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_786_a0_i());
		L0->SetNPCDescription(f_784_a0_i());
		L0->SetPhoto(f_788_a0_s());
		L0->SetPhoto2(f_78a_a0_s());
		L0->SetPlayerName(f_719_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_666_a1_b(tv1) && !f_6a2_a1_b(tv1)) {
				f_638_a2_v(tv1, tv0);
				f_63e_a2_v(tv1, tv0);
				f_106_a1_v("Sly");
			...
			tv0->ClearReplies();
			if (f_6ae_a1_b(tv1) && !f_6b8_a1_b(tv1) && !f_6a2_a1_b(tv1)) {
				tv0->AddReply(540264, 42248, 42247);
			}
			if (f_672_a1_b(tv1) && f_68a_a1_b(tv1)) {
				tv0->AddReply(522121, 24262, 23288);
			}
			if (f_67e_a1_b(tv1) && f_696_a1_b(tv1)) {
...
bool f_4fb_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_617_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_58c_a1_b(object a0)
{
	...
	return f_5fb_a1_b(L4);
}

bool f_5b1_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_626_a0_i() + "m";
	int L1;
...
void f_62f_a2_v(object a0, object a1)
{
...
{
	if (f_621_a1_i("oob12KlaraT2_1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("b12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("b12q01TheaterIsVisited") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("oob12KlaraT2_2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("oob12KlaraT2_3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("game_final") != 0) {
		return true;
	}
	return false;
}

bool f_6ae_a1_b(object a0)
{
	if (f_6d0_a1_b(a0)) {
		return true;
	}
...
{
	if (f_621_a1_i("b12q01KlaraInSobor") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_621_a1_i("oob12KlaraT2_4") == 0) {
		return true;
	}
	return false;
}
...
bool f_6fd_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_72a_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
bool f_75e_a0_b(void)
{
	object L0;
	int L1;
	int L2;
	@CreateIntVector(L0);
	f_72a_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_754_a1_b(L3) || f_74a_a1_b(L3)) {
			return false;
		}
	}
	return true;
...
string f_788_a0_s(void)
{
	return "ui/NPC_Klara.png";
}

string f_78a_a0_s(void)
{
