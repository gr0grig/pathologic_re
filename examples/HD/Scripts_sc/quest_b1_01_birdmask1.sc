...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_3d3_a0_i());
		L0->SetNPCDescription(f_3d1_a0_i());
		L0->SetPhoto(f_3d5_a0_s());
		L0->SetPhoto2(f_3d7_a0_s());
		L0->SetPlayerName(f_44c_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
	...
	for (L1 = 0; L1 < 5 && f_329_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_3db_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_32e_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_3b6_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_3c5_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
string f_3d5_a0_s(void)
{
	return "ui/NPC_bmask.png";
}

string f_3d7_a0_s(void)
{
	return "ui/NPC_bmask_b.png";
}

bool f_3d9_a0_b(void)
{
	return false;
}

string f_3db_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_3e2_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_3db_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_3f3_a2_v(object a0, object a1)
{
	...
	f_3c5_a2_b("quest_b1_01", "remove1");
}

void f_3fe_a2_v(object a0, object a1)
{
	f_42b_a3_v(f_41a_a0_o(), "pt_map_bigvlad", 2);
	a1->ShowMap(f_41a_a0_o());
}

bool f_40e_a1_b(object a0)
{
	if (f_3c0_a1_i("oob1Birdmask1_1") == 0) {
		return true;
	}
	return false;
}

object f_41a_a0_o(void)
{
	object L0;
	object L1;
...
void f_42b_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
