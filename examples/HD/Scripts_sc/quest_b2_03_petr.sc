...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_2d8_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_473_a0_i());
		L0->SetNPCDescription(f_471_a0_i());
		L0->SetPhoto(f_475_a0_s());
		L0->SetPhoto2(f_477_a0_s());
		L0->SetPlayerName(f_460_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_430_a1_b(tv1) && f_43c_a1_b(tv1)) {
				f_424_a2_v(tv1, tv0);
				f_d4_a1_v("Neutral");
			...
			if (f_454_a1_b(tv1) && f_448_a1_b(tv1)) {
				f_42a_a2_v(tv1, tv0);
				f_d4_a1_v("Neutral");
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_1fd_a0_v();
			if (f_2d3_a0_b() && f_1de_a0_b()) {
				if (f_1ca_a0_b()) {
					f_369_a1_b(f_3ee_a0_o());
				}
			} else {
				f_1d9_a0_v();
				f_1f4_a0_v();
...
void f_26c_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_2d3_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_40c_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_2d8_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_3f4_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_3c9_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
int f_413_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_40c_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_424_a2_v(object a0, object a1)
{
...
{
	if (f_3fe_a1_i("oob2PetrKabak1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_3fe_a1_i("oob2PetrKabak2") == 0) {
		return true;
	}
	return false;
}
...
string f_477_a0_s(void)
{
	return "ui/NPC_Petr_b.png";
}

bool f_479_a0_b(void)
{
	return true;
}
