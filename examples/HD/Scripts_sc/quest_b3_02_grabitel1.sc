...
task t0
{
	...
	bool init(object a0)
	{
		...
		L3->SetScriptProperty("Owner", f_9bf_a0_o());
		L3->SetScriptProperty("Target", a0);
		a0->GetPosition(L4);
		a0->GetEyesHeight(L5);
		L4.y += L5 - 10;
		L6 = f_a6f_a3_V(L1, L4, 2000.0);
...
task t3
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_a94_a0_i());
		L0->SetNPCDescription(f_a92_a0_i());
		L0->SetPhoto(f_a96_a0_s());
		L0->SetPhoto2(f_a98_a0_s());
		L0->SetPlayerName(f_acd_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t5
{
	...
	void OnAttacked(object a0)
	{
		f_a49_a2_b("quest_b3_02", "grabitel_attack");
	}
		...
		for (L1 = 0; L1 < 5 && f_8fe_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_a9c_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t6
{
	...
	bool f_6a9_a1_b(object a0)
	{
		...
		L0 = f_783_a1_f(a0);
		if (f_9f9_a3_b(L0, 250000.0, 3240000.0)) {
			return t0{a0};
		}
		return t1{a0};
	}
...
bool f_7a3_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_9ee_a3_f(L0 + a2, a3, a4));
	return true;
}
...
float f_7b9_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_9cf_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_9ee_a3_f(L4 - L5, 0, 1));
	if (f_792_a1_b(a0)) {
		f_a2e_a1_v(-L5);
	}
	return L5;
...
bool f_903_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_9c5_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_96a_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_98b_a3_v(string a0, int a1, int a2)
{
	if (f_a01_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
float f_9cf_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_9d6_a3_f(float a0, float a1, float a2)
{
	return a1 * a1 - 4 * a0 * a2;
}

float f_9dd_a4_f(float a0, float a1, float a2, float a3)
{
	float L0;
	L0 = (-a1 - a3) / (2 * a0);
	if (L0 > 0) {
...
float f_9ee_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_9f9_a3_b(float a0, float a1, float a2)
{
	return a0 >= a1 && a0 <= a2;
}

bool f_a01_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
bool f_a0b_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_a49_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_a5e_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_9bf_a0_o(), L0);
}

bool f_a69_a0_b(void)
{
	bool L0;
...
Vector f_a6f_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
	...
	L2 = L0.y * 1000 - a2 * a2;
	L3 = L0 | L0;
	L4 = f_9d6_a3_f(L1, L2, L3);
	if (L4 < 0) {
		L5 = 1;
	} else {
		L5 = sqrt(f_9dd_a4_f(L1, L2, L3, sqrt(L4)));
	}
...
string f_a96_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_a98_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_a9a_a0_b(void)
{
	return false;
}

string f_a9c_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_aa3_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_a9c_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_ab4_a2_v(object a0, object a1)
{
	@SetVariable("b3q02GrabitelTalk", 1);
}

void f_aba_a2_v(object a0, object a1)
{
	f_a49_a2_b("quest_b3_02", "grabitel_attack");
}

bool f_ac1_a1_b(object a0)
{
	if (f_a06_a1_i("b3q02") > 3) {
		return true;
	}
	return false;
}
...
void f_af1_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_b57_a1_i("Money"), 0, L0);
}

void f_b10_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_b39_a0_v(void)
{
	int L0;
	bool L1;
	@ClearSubContainer(0);
	f_af1_a2_v(300, 750);
	f_98b_a3_v("Knife", 1, 8);
	f_98b_a3_v("lockpick", 1, 6);
	@AddItem(L1, f_b57_a1_i("grabitel_mark"), 0, 1);
}

int f_b57_a1_i(string a0)
{
	int L0;
...
void f_b5c_a1_v(object a0)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_9bf_a0_o());
	f_a49_a2_b("quest_b3_02", "grabitel_dead");
	if (f_792_a1_b(a0)) {
		f_a0b_a2_b(a0, 0.029999999329447746);
	}
	t7{a0};
}
...
void f_ba0_a1_v(object a0)
{
}

bool f_ba2_a2_b(object a0, object a1)
{
	return false;
}
