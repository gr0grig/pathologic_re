...
task t0
{
	...
	bool init(object a0)
	{
		...
		L3->SetScriptProperty("Owner", f_789_a0_o());
		L3->SetScriptProperty("Target", a0);
		a0->GetPosition(L4);
		a0->GetEyesHeight(L5);
		L4.y += L5 - 10;
		L6 = f_840_a3_V(L1, L4, 2000.0);
...
task t1
{
	...
	void f_1d3_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_9a_a2_f(L0, a1);
			L2 = f_600_a3_f(L0, L1, f_9d_a2_i(L0, a1));
	...
	bool f_2f7_a0_b(void)
	{
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_5ca_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
...
task t5
{
	bool init(object a0)
	{
		...
		L0 = f_5d1_a1_f(a0);
		if (f_7c3_a3_b(L0, 250000.0, 3240000.0)) {
			return t0{a0};
		}
		return t1{a0};
	}
...
bool f_5de_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_5ea_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_5de_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_7b8_a3_f(L0 + a2, a3, a4));
	return true;
}

float f_600_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_5de_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_5de_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_5bc_a1_s(a2);
	if (!f_5de_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_799_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_7b8_a3_f(L4 - L5, 0, 1));
	if (f_5d9_a1_b(a0)) {
		f_7f3_a1_v(-L5);
	}
	return L5;
...
bool f_66d_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_668_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_6b3_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_6a9_a1_b(L0);
}

void f_6bc_a1_v(object a0)
{
	bool L0;
	int L1;
	Vector L2;
...
void f_72c_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
void f_755_a3_v(string a0, int a1, int a2)
{
	if (f_7cb_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
float f_799_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_7a0_a3_f(float a0, float a1, float a2)
{
	return a1 * a1 - 4 * a0 * a2;
}

float f_7a7_a4_f(float a0, float a1, float a2, float a3)
{
	float L0;
	L0 = (-a1 - a3) / (2 * a0);
	if (L0 > 0) {
...
float f_7b8_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_7c3_a3_b(float a0, float a1, float a2)
{
	return a0 >= a1 && a0 <= a2;
}

bool f_7cb_a2_b(int a0, int a1)
{
	int L0;
	@irand(L0, a1);
	return L0 < a0;
...
bool f_7d0_a2_b(object a0, float a1)
{
	...
	f_804_a1_v(a1);
	f_5ea_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}
...
void f_817_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_789_a0_o(), L0);
}
...
Vector f_840_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
	...
	L2 = L0.y * 1000 - a2 * a2;
	L3 = L0 | L0;
	L4 = f_7a0_a3_f(L1, L2, L3);
	if (L4 < 0) {
		L5 = 1;
	} else {
		L5 = sqrt(f_7a7_a4_f(L1, L2, L3, sqrt(L4)));
	}
...
void f_876_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_8dc_a1_i("Money"), 0, L0);
}

void f_895_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_8be_a0_v(void)
{
	...
	@ClearSubContainer(0);
	f_876_a2_v(300, 750);
	f_755_a3_v("Knife", 1, 8);
	f_755_a3_v("lockpick", 1, 6);
	@AddItem(L1, f_8dc_a1_i("grabitel_mark"), 0, 1);
}

int f_8dc_a1_i(string a0)
{
	int L0;
...
void f_8e1_a1_v(object a0)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_789_a0_o());
	if (f_5d9_a1_b(a0)) {
		f_7d0_a2_b(a0, 0.019999999552965164);
	}
	t4{a0};
}
...
bool f_92f_a2_b(object a0, object a1)
{
	return false;
}
