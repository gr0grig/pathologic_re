		...
		for (L1 = 0; L1 < 5 && f_75b_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_83e_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
int f_845_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_83e_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_8a3_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_909_a1_i("Money"), 0, L0);
}
...
void f_8eb_a0_v(void)
{
	...
	@AddItem(L1, f_909_a1_i("grabitel_mark"), 0, 1);
}

int f_909_a1_i(string a0)
{
	int L0;
...
Vector f_90e_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
...
void f_941_a1_v(object a0)
{
}

bool f_943_a2_b(object a0, object a1)
{
	return false;
}
