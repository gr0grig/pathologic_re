...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_5f9_a0_i());
		L0->SetNPCDescription(f_5f7_a0_i());
		L0->SetPhoto(f_5fb_a0_s());
		L0->SetPhoto2(f_5fd_a0_s());
		L0->SetPlayerName(f_5d3_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
		...
		for (L1 = 0; L1 < 5 && f_48b_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_5a2_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t3
{
	...
	void init(void)
	{
		object L0;
		@GetScene(L0);
		L0->RemoveStationaryActor(f_541_a0_o());
		for (; ; ) {
	...
	Vector f_27c_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_547_a1_V(f_547_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_327_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_3d0_a1_V(tv0);
		return f_55c_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
bool f_3f7_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_551_a3_f(L0 + a2, a3, a4));
	return true;
}
...
bool f_490_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_547_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_4f7_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_551_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_55c_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

int f_564_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
bool f_569_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_596_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_5a9_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_5a2_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
{
	f_596_a2_b("quest_b5_01", "vera_retreat");
}

void f_5c1_a2_v(object a0, object a1)
{
...
string f_5fb_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_5fd_a0_s(void)
{
...
void f_601_a1_v(object a0)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_541_a0_o());
	if (f_3e6_a1_b(a0)) {
		f_569_a2_b(a0, -0.10000000149011612);
	}
