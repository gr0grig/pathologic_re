...
Vector f_7bb_a3_V(Vector a0, Vector a1, float a2)
{
	Vector L0;
	float L1;
	float L2;
...
void f_839_a0_v(void)
{
	...
	@AddItem(L1, f_857_a1_i("grabitel_mark"), 0, 1);
}
...
void f_87c_a1_v(object a0)
{
}

bool f_87e_a2_b(object a0, object a1)
{
	return false;
}
