...
task t0
{
	...
	void f_11d_a2_v(float a0, int a1)
	{
		object L0;
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_f_a2_f(L0, a1);
			L2 = f_4ba_a3_f(L0, L1, f_12_a2_i(L0, a1));
			@ReportHit(tv0, f_29c_a0_i(), L2, L1);
			f_2a3_a2_v(L0, L2);
		}
	}

	bool f_144_a1_b(float a0)
	{
		int L0;
		bool L1;
		f_297_a0_v();
	...
	bool f_22f_a0_b(void)
	{
		if (f_213_a0_b() && f_23f_a0_b()) {
			return true;
		}
		return false;
	}
	...
	bool f_23f_a0_b(void)
	{
		...
		for (; ; ) {
			...
			Vector L3;
			Vector L4;
			@FindDirLength(L2, -f_48c_a1_V(tv0), tv4);
			if (L2 < tv4) {
				break;
			}
			@Face(tv0);
	...
	{
		f_5d8_a1_v("attack_stay");
	}

	void f_2a3_a2_v(object a0, float a1)
	{
	}

	bool f_2a5_a0_b(void)
	{
		return true;
	}
...
task t1
{
	...
	bool f_314_a5_b(object a0, float a1, float a2, bool a3, bool a4)
	{
		bool L0;
		bool L1;
		tv0 = false;
		...
		for (; ; ) {
			...
			if (L6 > a1 * a1) {
				...
				if (L2 != null) {
					...
					@FollowPath(L2, a3, L0, f_3a7_a0_s(), f_3a9_a0_s());
					if (!L0) {
						if (tv0) {
							L2 = null;
							break;
	...
	bool f_3a0_a1_b(object a0)
	{
		return f_52c_a1_b(a0);
	}
...
task t2
{
	void init(object a0)
	{
		f_661_a2_b("quest_b9_01", "doberman_dead");
		f_3dc_a1_v(a0);
		@SetRTEnvelope(50, 40);
		f_6a5_a0_v();
		if (f_493_a1_b(a0)) {
			f_623_a2_b(a0, -0.029999999329447746);
		}
		for (; ; ) {
			@Hold();
		}
...
maintask t3
{
	...
	void OnAttacked(object a0)
	{
		...
		@IsPlayerActor(a0, L0);
		if (L0) {
			f_661_a2_b("quest_b9_01", "factory_fight");
		}
	}
...
float f_4ba_a3_f(object a0, float a1, int a2)
{
	...
	L1 = "armor_" + f_47e_a1_s(a2);
	if (!f_498_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_611_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_618_a3_f(L4 - L5, 0, 1));
	if (f_493_a1_b(a0)) {
		f_646_a1_v(-L5);
	}
	return L5;
...
float f_611_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}
...
bool f_623_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_661_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_676_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_601_a0_o(), L0);
}
