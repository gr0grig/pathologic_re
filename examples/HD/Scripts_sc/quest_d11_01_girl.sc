...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_385_a0_i());
		L0->SetNPCDescription(f_383_a0_i());
		L0->SetPhoto(f_387_a0_s());
		L0->SetPhoto2(f_389_a0_s());
		L0->SetPlayerName(f_372_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_2f2_a1_b(tv1) && f_2fe_a1_b(tv1)) {
				f_2c7_a2_v(tv1, tv0);
				f_ab_a1_v("Neutral");
...
bool f_214_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_297_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
bool f_2a6_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
{
	f_351_a3_v(f_340_a0_o(), "pt_map_uprava_admin", 2);
	a1->ShowMap(f_340_a0_o());
}
...
void f_2cd_a2_v(object a0, object a1)
{
	...
	L0 = f_340_a0_o();
	L0->AddMark("d11q01NudeGotoRastrel", "pt_d11q01_msoldier", 1, 515482, f_2b2_a0_f());
	L0->AddMark("d11q01NudeGotoBlock", "pt_map_uprava_admin", 1, 515305, f_2b2_a0_f());
	f_30a_a0_v();
	f_2a6_a2_b("quest_d11_01", "init_soldiers");
}

bool f_2f2_a1_b(object a0)
{
	if (f_2a1_a1_i("d11q01") == 1) {
		return true;
	}
	return false;
}
...
bool f_324_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_351_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
