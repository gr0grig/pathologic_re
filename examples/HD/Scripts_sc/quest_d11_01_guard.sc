...
task t2
{
	...
	void f_1d6_a0_v(void)
	{
		...
		@ReportAttack(tv0);
		if (f_416_a1_b(tv0)) {
			@SendPlayerEnemy(tv0, f_5c1_a0_o());
		}
		Vector L0;
		@GetDirection(L0);
		Vector L1;
		L1 = f_407_a1_V(tv0);
		if (f_600_a2_f(L0, L1) < 0.9993908405303955) {
			return;
		}
		f_62b_a0_v();
...
bool f_41b_a2_b(object a0, string a1)
{
	bool L0;
...
float f_427_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_41b_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_41b_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_3f9_a1_s(a2);
	if (!f_41b_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_5d5_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_5dc_a3_f(L4 - L5, 0, 1));
	if (f_416_a1_b(a0)) {
		f_611_a1_v(-L5);
	}
	return L5;
...
bool f_475_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_470_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_4dd_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_5c7_a1_V(f_407_a1_V(a0));
		object L1;
...
void f_521_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
float f_5d1_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_5d5_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_5dc_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_5ed_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_5f6_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_600_a2_f(Vector a0, Vector a1)
{
	return f_5ed_a2_f(a0, a1) / (f_5f6_a1_f(a0) * f_5f6_a1_f(a1));
}

void f_611_a1_v(float a0)
{
	object L0;
...
void f_62b_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_5c1_a0_o(), L0);
}
...
{
	if (f_416_a1_b(a0)) {
		@ReportReputationChange(a0, f_5c1_a0_o(), 0.05000000074505806, true);
	}
	f_7e0_a1_v(a0);
}

bool f_67a_a2_b(object a0, bool a1)
{
	string L0;
	if (!f_41b_a2_b(a0, "class")) {
		return false;
	}
...
void f_709_a2_v(object a0, bool a1)
{
	t2{a0, a1};
	@ResetAAS();
}
...
void f_714_a1_v(object a0)
{
	...
	if (f_416_a1_b(a0)) {
		@ReportReputationChange(a0, f_5c1_a0_o(), 0.0);
	}
}
...
bool f_754_a1_b(object a0)
{
	...
	if (!f_41b_a2_b(a0, "disease")) {
		return false;
	}
	if (f_56a_a1_b(L1) || L1 == "dog") {
		float L2;
...
void f_7ba_a1_v(object a0)
{
	f_7da_a1_v(a0);
}

bool f_7c0_a3_b(object a0, object a1, bool a2)
{
	if (f_67a_a2_b(a1, !a2)) {
		bool L0;
		@CanSee(L0, a0);
		if (L0 || f_40e_a1_f(a0) <= 490000.0) {
			return true;
		}
	}
	return false;
...
void f_7e0_a1_v(object a0)
{
	object L0;
	@GetScene(L0);
	L0->RemoveStationaryActor(f_5c1_a0_o());
	t5{a0};
}
