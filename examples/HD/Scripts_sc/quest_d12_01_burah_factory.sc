...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_4b0_a1_b(tv1) && !f_498_a1_b(tv1)) {
				f_457_a2_v(tv1, tv0);
				f_476_a2_v(tv1, tv0);
				f_e9_a1_v("Neutral");
			...
			tv0->ClearReplies();
			if (!f_4a4_a1_b(tv1) && f_482_a1_b(tv1) && !f_498_a1_b(tv1)) {
				tv0->AddReply(535631, 37319, 37317);
			}
			if (f_48c_a1_b(tv1) && f_4bc_a1_b(tv1)) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 42055) {
				...
				tv0->AddReply(541860, 37260, 44086);
				return;
			}
			if (a0 == 42039) {
				f_e9_a1_v("Neutral");
...
bool f_323_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_43f_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_414_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_457_a2_v(object a0, object a1)
{
...
void f_466_a2_v(object a0, object a1)
{
	if (f_449_a1_i("d12q01_Burah") == 0) {
...
{
	if (f_449_a1_i("b12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_449_a1_i("d12q01BurahInSobor") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_449_a1_i("ood12BurahFactory1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_449_a1_i("ood12BurahFactory2") == 0) {
		return true;
	}
	return false;
}
...
bool f_4f5_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_522_a3_v(object a0, bool a1, int a2)
{
	a0->add(18);
	a0->add(24);
	a0->add(20);
...
bool f_557_a0_b(void)
{
	...
	int L2;
	@CreateIntVector(L0);
	f_522_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_54d_a1_b(L3) || f_543_a1_b(L3)) {
			return false;
		}
	}
	return true;
