...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_739_a0_i());
		L0->SetNPCDescription(f_737_a0_i());
		L0->SetPhoto(f_73b_a0_s());
		L0->SetPhoto2(f_73d_a0_s());
		L0->SetPlayerName(f_6cc_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (!f_631_a1_b(tv1) && f_653_a1_b(tv1)) {
				f_5fd_a2_v(tv1, tv0);
				f_61f_a2_v(tv1, tv0);
				f_fc_a1_v("Sly");
			...
			tv0->ClearReplies();
			if (f_63d_a1_b(tv1) && !f_647_a1_b(tv1) && !f_631_a1_b(tv1)) {
				tv0->AddReply(535654, 37341, 37340);
			}
			if (f_677_a1_b(tv1) && f_65f_a1_b(tv1)) {
				tv0->AddReply(540429, 42419, 42418);
			}
			if (f_625_a1_b(tv1) && f_66b_a1_b(tv1)) {
...
bool f_4c0_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_5dc_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_5b1_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_5f4_a2_v(object a0, object a1)
{
...
{
	if (f_5e6_a1_i("d12q01_Klara") == 0) {
		@SetVariable("d12q01_Klara", 1);
		f_696_a0_v();
	}
}

void f_613_a2_v(object a0, object a1)
{
...
void f_61f_a2_v(object a0, object a1)
{
...
{
	if (f_5e6_a1_i("b12q01TheaterIsVisited") != 0) {
		return true;
	}
	return false;
}

bool f_631_a1_b(object a0)
{
	if (f_5e6_a1_i("game_final") != 0) {
		return true;
	}
	return false;
}
...
bool f_647_a1_b(object a0)
{
	if (f_5e6_a1_i("d12q01KlaraInSobor") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_5e6_a1_i("ood12KlaraT2_1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_5e6_a1_i("ood12KlaraT2_2") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_5e6_a1_i("ood12KlaraT2_3") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_5e6_a1_i("d12q01ChildsAreVisited") != 0) {
		return true;
	}
	return false;
}
...
bool f_6b0_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_6dd_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
bool f_711_a0_b(void)
{
	object L0;
	int L1;
	int L2;
	@CreateIntVector(L0);
	f_6dd_a3_v(L0, false, -1);
	L0->size(L1);
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_707_a1_b(L3) || f_6fd_a1_b(L3)) {
			return false;
		}
	}
	return true;
...
string f_73b_a0_s(void)
{
	return "ui/NPC_Klara.png";
}

string f_73d_a0_s(void)
{
