...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_30b_a0_i());
		L0->SetNPCDescription(f_309_a0_i());
		L0->SetPhoto(f_30d_a0_s());
		L0->SetPhoto2(f_30f_a0_s());
		L0->SetPlayerName(f_2f8_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_243_a1_b(object a0)
{
	...
	return f_2b2_a1_b(L4);
}

bool f_268_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_2dd_a0_i() + "m";
	int L1;
...
void f_2a3_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
{
	if (f_2d8_a1_i("ood12MariaSobor1") == 0) {
		return true;
	}
	return false;
}
