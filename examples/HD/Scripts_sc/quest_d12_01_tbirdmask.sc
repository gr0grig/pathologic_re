...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_3a7_a0_i());
		L0->SetNPCDescription(f_3a5_a0_i());
		L0->SetPhoto(f_3a9_a0_s());
		L0->SetPhoto2(f_3ab_a0_s());
		L0->SetPlayerName(f_394_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t2
{
	...
	{
		tv5 = true;
		if (!f_2b0_a0_b() && f_201_a0_b()) {
			@RemoveActor(f_33d_a0_o());
		}
	}
...
bool f_2b5_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_343_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	f_352_a2_v("itheater@door1", false);
}

void f_382_a2_v(object a0, object a1)
{
...
{
	if (f_34d_a1_i("ood12TBirdmask1") == 0) {
		return true;
	}
	return false;
}
