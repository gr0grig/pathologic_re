...
maintask t0
{
	...
	{
		f_e_a0_v();
		f_76_a2_b("quest_d12_01", "theater_cutscene_end");
	...
	void f_e_a0_v(void)
	{
		...
		@AddScriptedActor(L1, "cs_d12_theater_birdmask", "cs_play_all.bin", L0, [0.0, 0.0, 0.0]);
		@AddScriptedActor(L2, "cs_d12_theater_whitemask", "cs_play_all.bin", L0, [0.0, 0.0, 0.0]);
