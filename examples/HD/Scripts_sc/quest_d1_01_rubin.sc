...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3c3_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_56d_a0_i());
		L0->SetNPCDescription(f_56b_a0_i());
		L0->SetPhoto(f_56f_a0_s());
		L0->SetPhoto2(f_571_a0_s());
		L0->SetPlayerName(f_55a_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_2e8_a0_v();
			if (f_3be_a0_b() && f_2c9_a0_b()) {
				if (f_2b5_a0_b()) {
					f_454_a1_b(f_4d9_a0_o());
				}
			} else {
				f_2c4_a0_v();
				f_2df_a0_v();
...
void f_357_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_3be_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_4f7_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_3c3_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_4df_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_4b4_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
int f_4fe_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_4f7_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
bool f_53e_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_56f_a0_s(void)
{
	return "ui/NPC_Rubin.png";
}

string f_571_a0_s(void)
{
	return "ui/NPC_Rubin_b.png";
}

bool f_573_a0_b(void)
{
	return true;
}
