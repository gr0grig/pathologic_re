...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_791_a0_i());
		L0->SetNPCDescription(f_78f_a0_i());
		L0->SetPhoto(f_793_a0_s());
		L0->SetPhoto2(f_795_a0_s());
		L0->SetPlayerName(f_77e_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	{
		object L0;
		f_75e_a2_b("quest_d1_03", "butcher_battle");
		@FindActor(L0, "player");
...
float f_567_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_73b_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_742_a3_f(L4 - L5, 0, 1));
	if (f_556_a1_b(a0)) {
		f_74d_a1_v(-L5);
	}
	return L5;
...
bool f_67a_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_731_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_6e1_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_73b_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_742_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_75e_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_773_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_72b_a0_o(), L0);
}
...
string f_793_a0_s(void)
{
	return "ui/NPC_Citizen1.png";
}

string f_795_a0_s(void)
{
	return "ui/NPC_Citizen1_b.png";
}

bool f_797_a0_b(void)
{
	return false;
}
...
{
	@RemoveActor(f_72b_a0_o());
	f_75e_a2_b("quest_d1_03", "butcher_fail");
}

void f_7a4_a1_v(object a0)
{
	f_75e_a2_b("quest_d1_03", "butcher_death");
	t5{a0};
}
