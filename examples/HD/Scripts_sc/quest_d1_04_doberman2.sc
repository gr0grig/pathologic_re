...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_e5d_a0_i());
		L0->SetNPCDescription(f_e5b_a0_i());
		L0->SetPhoto(f_e5f_a0_s());
		L0->SetPhoto2(f_e61_a0_s());
		L0->SetPlayerName(f_c3d_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
		...
		for (L1 = 0; L1 < 5 && f_add_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_ddb_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t5
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_9aa_a1_V(tv0);
		if (f_be7_a2_f(L0, L1) < 0.4999999701976776) {
			f_ad2_a1_v(tv0);
		}
	}
...
float f_9ca_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_bbd_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_bc4_a3_f(L4 - L5, 0, 1));
	if (f_9b9_a1_b(a0)) {
		f_bfd_a1_v(-L5);
	}
	return L5;
...
bool f_ae2_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_bb3_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_b49_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_b6a_a3_v(string a0, int a1, int a2)
{
	if (f_bcf_a2_b(a1, a2)) {
		bool L0;
		@AddItem(L0, a0, 0);
...
void f_b75_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_bcf_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
float f_bbd_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_bc4_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_bd4_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_bdd_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_be7_a2_f(Vector a0, Vector a1)
{
	return f_bd4_a2_f(a0, a1) / (f_bdd_a1_f(a0) * f_bdd_a1_f(a1));
}

int f_bf8_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
void f_c20_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_bad_a0_o(), L0);
}

void f_c2b_a2_v(object a0, object a1)
{
...
{
	if (f_bf8_a1_i("ood1Doberman2_1") == 0) {
		return true;
	}
	return false;
}
...
void f_c61_a2_v(int a0, int a1)
{
	...
	@AddItem(L1, f_d29_a1_i("Money"), 0, L0);
}

void f_c80_a1_v(string a0)
{
	object L0;
	int L1;
	bool L2;
...
void f_ca9_a1_v(bool a0)
{
	bool L0;
	@ClearSubContainer(0);
	f_c61_a2_v(0, 10 + f_c0e_a0_i() * 10);
	f_b6a_a3_v("hook", 1, 4);
	f_b6a_a3_v("watch", 1, 10);
}

void f_cc5_a1_v(bool a0)
{
	int L0;
	bool L1;
	int L2;
	...
	L2 = f_c0e_a0_i();
	if (a0) {
		f_b75_a4_v("alpha_pills", 1, 2, 4);
		f_b75_a4_v("meradorm", 2, 3, 3);
		if (L2 >= 3) {
			f_b6a_a3_v("beta_pills", 1, 4);
		}
		if (L2 >= 8) {
			f_b75_a4_v("monomicin", 1, 2, 2);
		} else {
			if (L2 >= 4) {
				f_b6a_a3_v("monomicin", 1, 2);
			}
		}
	} else {
		f_b6a_a3_v("lockpick", 1, 4);
		f_b6a_a3_v("rifle_ammo", 1, 2);
		f_b6a_a3_v("revolver_ammo", 1, 2);
		f_b75_a4_v("samopal_ammo", 1, 2, 2);
		if (L2 >= 8) {
			f_b75_a4_v("monomicin", 1, 2, 2);
		} else {
			if (L2 >= 4) {
...
bool f_d5b_a2_b(object a0, string a1)
{
	if (a1 == "unholster") {
		return f_e32_a1_b(a0);
	} else {
		if (a1 == "player_shot") {
			return f_e37_a1_b(a0);
		} else {
			if (a1 == "battle") {
				return f_e4c_a1_b(a0);
			}
		}
	}
	return false;
...
void f_d7b_a2_v(object a0, string a1)
{
	if (a1 == "unholster") {
		f_e35_a1_v(a0);
	} else {
...
bool f_d94_a1_b(object a0)
{
	if (f_e32_a1_b(a0) && f_9b9_a1_b(a0)) {
		bool L0;
...
void f_dab_a1_v(object a0)
{
	f_e35_a1_v(a0);
}

void f_db1_a1_v(object a0)
{
	if (f_9b9_a1_b(a0)) {
		@ReportReputationChange(a0, f_bad_a0_o(), -0.05000000074505806);
	}
}

bool f_dbe_a1_b(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
		return f_e56_a1_b(L0);
	}
	return false;
}

void f_dce_a1_v(string a0)
{
	if (a0 == "heal") {
		object L0;
		@FindActor(L0, "player");
...
int f_de2_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_ddb_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_df3_a1_i(object a0)
{
	return f_e7f_a0_b() ? 2 : 0;
}

void f_dfc_a1_v(object a0)
{
	t5{a0};
}

int f_e04_a1_i(object a0)
{
	return f_a3c_a1_b(a0) ? 2 : 0;
}

void f_e0e_a1_v(object a0)
{
	t6{a0};
}

int f_e16_a2_i(object a0, bool a1)
{
	return f_e04_a1_i(a0);
}

void f_e1d_a1_v(object a0)
{
	f_e0e_a1_v(a0);
}
...
int f_e2d_a2_i(string a0, object a1)
{
	return 0;
}

void f_e30_a2_v(string a0, object a1)
{
}

bool f_e32_a1_b(object a0)
{
	return false;
}

void f_e35_a1_v(object a0)
{
}
...
void f_e46_a1_v(object a0)
{
	f_dfc_a1_v(a0);
}

bool f_e4c_a1_b(object a0)
{
	return false;
}

void f_e4f_a1_v(object a0)
{
}

int f_e51_a1_i(object a0)
{
	return 0;
}
...
string f_e5f_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_e61_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_e63_a0_b(void)
{
	return false;
}
...
bool f_e7f_a0_b(void)
{
	return false;
}

bool f_e81_a3_b(object a0, object a1, bool a2)
{
	return true;
}
...
{
	if (f_9b9_a1_b(a0)) {
		@ReportReputationChange(a0, f_bad_a0_o(), -0.10000000149011612, true);
		f_ca9_a1_v(true);
	}
	f_c91_a0_v();
	g0 = true;
