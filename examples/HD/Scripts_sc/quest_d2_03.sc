...
maintask t0
{
	...
	void OnTrigger(string a0)
	{
		...
		if (a0 == "birdmask") {
			...
			f_97_a2_v("r4_house_2_02@door1", false);
			f_97_a2_v("r4_house_2_02@door2", false);
			tv0 = f_85_a4_o(L0, "pt_d2q03_birdmask", "pers_birdmask", "d2q03_birdmask.xml");
		} else {
			if (a0 == "completed") {
				f_47_a0_v();
			}
