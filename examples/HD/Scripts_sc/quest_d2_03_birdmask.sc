...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_32b_a0_i());
		L0->SetNPCDescription(f_329_a0_i());
		L0->SetPhoto(f_32d_a0_s());
		L0->SetPhoto2(f_32f_a0_s());
...
bool f_1f9_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_27c_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_260_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_290_a2_v(object a0, object a1)
{
	@SetVariable("ood2Birdmask1", 1);
}

void f_296_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d2q03", 3);
	L0 = f_307_a0_o();
	L0->AddMark("d2q03BirdmaskGotoLara", "pt_map_lara", 0, 515293, f_28b_a0_f());
	f_2d1_a0_v();
}

bool f_2ad_a1_b(object a0)
{
	if (f_286_a1_i("KnowTheater") == 1) {
		return true;
	}
	return false;
}
...
bool f_2eb_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_32d_a0_s(void)
{
	return "ui/NPC_bmask.png";
}

string f_32f_a0_s(void)
{
