...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_354_a0_i());
		L0->SetNPCDescription(f_352_a0_i());
		L0->SetPhoto(f_356_a0_s());
		L0->SetPhoto2(f_358_a0_s());
		L0->SetPlayerName(f_341_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_311_a1_b(tv1) && !f_31d_a1_b(tv1)) {
				f_b6_a1_v("Neutral");
...
bool f_256_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_2de_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	if (f_2e8_a1_i("d4q01KeyWasted") != 0) {
		return true;
	}
	return false;
}
...
{
	if (f_2e8_a1_i("ood4SoborGuard1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_2e8_a1_i("ood4TheaterGuard2") == 0) {
		return true;
	}
	return false;
}
