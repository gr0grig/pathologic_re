...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_41c_a0_i());
		L0->SetNPCDescription(f_41a_a0_i());
		L0->SetPhoto(f_41e_a0_s());
		L0->SetPhoto2(f_420_a0_s());
		L0->SetPlayerName(f_409_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_24f_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_36b_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_340_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_394_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d5q01", 7);
	L0 = f_3f8_a0_o();
	L0->AddMark("d5q01BurahMeeting", "pt_d5q01_girl_corpse1", 1, 515351, f_386_a0_f());
	f_3c2_a0_v();
	f_37a_a2_b("quest_d5_01", "burah_free");
}
...
bool f_3dc_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_41e_a0_s(void)
{
	return "ui/NPC_Burah.png";
}

string f_420_a0_s(void)
{
