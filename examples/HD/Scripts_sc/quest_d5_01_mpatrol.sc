...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_916_a0_i());
		L0->SetNPCDescription(f_914_a0_i());
		L0->SetPhoto(f_918_a0_s());
		L0->SetPhoto2(f_91a_a0_s());
		L0->SetPlayerName(f_8a2_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t5
{
	...
	void OnAttacked(object a0)
	{
		...
		@IsPlayerActor(a0, L0);
		if (L0) {
			f_815_a2_b("quest_d5_01", "factory_fight");
		}
	}
...
float f_619_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_7ed_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_7f4_a3_f(L4 - L5, 0, 1));
	if (f_608_a1_b(a0)) {
		f_804_a1_v(-L5);
	}
	return L5;
...
bool f_72c_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_7e3_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_793_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_7ed_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_7f4_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_815_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_82f_a0_v(void)
{
	object L0;
	@GetScene(L0);
	@BroadcastMessage("battle", f_7dd_a0_o(), L0);
}

void f_83a_a2_v(object a0, object a1)
{
	f_881_a3_v(f_870_a0_o(), "pt_map_grif", 2);
	a1->ShowMap(f_870_a0_o());
}
...
void f_850_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d5q01", 6);
	L0 = f_870_a0_o();
	L0->AddMark("d5q01PatrolGotoGrif", "pt_map_grif", 1, 515349, f_821_a0_f());
}

bool f_864_a1_b(object a0)
{
	if (f_7ff_a1_i("ood5PatrolGuard1") == 0) {
		return true;
	}
	return false;
}

object f_870_a0_o(void)
{
	object L0;
	object L1;
...
void f_881_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
...
string f_918_a0_s(void)
{
	return "ui/NPC_Citizen2.png";
}

string f_91a_a0_s(void)
{
	return "ui/NPC_Citizen2_b.png";
}

bool f_91c_a0_b(void)
{
	return false;
}

void f_91e_a1_v(object a0)
{
	bool L0;
