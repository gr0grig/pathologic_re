...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_4f7_a0_i());
		L0->SetNPCDescription(f_4f5_a0_i());
		L0->SetPhoto(f_4f9_a0_s());
		L0->SetPhoto2(f_4fb_a0_s());
		L0->SetPlayerName(f_4e4_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->ClearReplies();
			if (f_46c_a1_b(tv1) && f_432_a1_b(tv1)) {
				tv0->AddReply(512563, 13734, 13732);
			}
			if (f_43c_a1_b(tv1) && !f_454_a1_b(tv1) && !f_460_a1_b(tv1)) {
...
maintask t2
{
	...
	{
		if (t0{a0} == 1) {
			f_399_a2_b("quest_d5_03", "completed");
		}
	}
...
bool f_293_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_33d_a3_f(L0 + a2, a3, a4));
	return true;
}
...
bool f_2b0_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_333_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_317_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_33d_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_359_a2_v(object a0, int a1)
{
...
bool f_36c_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_399_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_402_a2_v(object a0, object a1)
{
	object L0;
	@SetVariable("d5q03", 2);
	L0 = f_4d3_a0_o();
	L0->AddMark("d5q03BirdmaskBringMoneySelf", "pt_map_uprava_prison", 0, 515372, f_3a5_a0_f());
	L0->AddMark("d5q03BirdmaskGotoMladVlad", "pt_map_mladvlad", 0, 515374, f_3a5_a0_f());
	L0->AddMark("d5q03BirdmaskGotoViktor", "pt_map_viktor", 0, 515373, f_3a5_a0_f());
	f_490_a0_v();
}

void f_42b_a2_v(object a0, object a1)
{
	f_36c_a2_b(a0, -0.30000001192092896);
}
...
{
	if (f_348_a1_i("d5q03") == 1) {
		return true;
	}
	return false;
}

bool f_454_a1_b(object a0)
{
	if (f_348_a1_i("d5q03") == 1000) {
		return true;
	}
	return false;
}
...
bool f_4b7_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
