...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_611_a0_i());
		L0->SetNPCDescription(f_60f_a0_i());
		L0->SetPhoto(f_613_a0_s());
		L0->SetPhoto2(f_615_a0_s());
		L0->SetPlayerName(f_5fe_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t3
{
	...
	void OnUnload(void)
	{
		f_5b9_a2_b("quest_d6_03", "albinos_retreated");
		@Hold();
	}
	...
	Vector f_1fc_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_57f_a1_V(f_57f_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_2a7_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_34e_a1_V(tv0);
		return f_59b_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
float f_36e_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_589_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_590_a3_f(L4 - L5, 0, 1));
	if (f_35d_a1_b(a0)) {
		f_5a8_a1_v(-L5);
	}
	return L5;
...
bool f_43a_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_57f_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_52b_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_589_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_590_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_59b_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

int f_5a3_a1_i(string a0)
{
	int L0;
	@GetVariable(a0, L0);
	return L0;
...
bool f_5b9_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_5e6_a2_v(object a0, object a1)
{
	@SetVariable("d6q03", 2);
}

void f_5ec_a2_v(object a0, object a1)
{
...
string f_613_a0_s(void)
{
	return "ui/NPC_Albinos.png";
}

string f_615_a0_s(void)
{
	return "ui/NPC_Albinos_b.png";
}

bool f_617_a0_b(void)
{
	return false;
}

void f_619_a1_v(object a0)
{
	@KillTimer(100);
	f_5b9_a2_b("quest_d6_03", "albinos_dead");
	t4{a0};
}

void f_629_a0_v(void)
{
	object L0;
	@FindActor(L0, "player");
	if (L0) {
