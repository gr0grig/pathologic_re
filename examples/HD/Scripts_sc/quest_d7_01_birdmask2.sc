...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_3dd_a1_b(tv1) && f_3c7_a1_b(tv1)) {
				f_cd_a1_v("Neutral");
			...
			if (f_3bb_a1_b(tv1) && f_3d3_a1_b(tv1)) {
				f_cd_a1_v("Neutral");
...
bool f_2d9_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_356_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_371_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_384_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_391_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void f_39d_a2_v(object a0, object a1)
{
...
{
	f_391_a2_b("quest_d7_01", "kill_player");
}

bool f_3bb_a1_b(object a0)
{
	if (f_360_a1_i("d7q01") == 2) {
		return true;
	}
	return false;
}
...
{
	if (f_360_a1_i("ood7DBirdmask1") == 0) {
		return true;
	}
	return false;
}
