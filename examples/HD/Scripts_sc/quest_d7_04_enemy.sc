							...
							if (2 == g2) {
								...
								if (3 == g2) {
									...
									for (L3 = 0; L3 < g1; L3++) {
										...
										L0->GetLocator(f_de6_a0_s() + (L7 + 1), L4, L5, L6);
										t5{L5, L6, false};
										if (3 != g2) {
											break;
										}
										...
										if (4 == g2) {
											...
											if (4 == g2) {
												...
												if (4 == g2) {
													...
													@BroadcastMessage(f_dea_a0_s(), f_be8_a0_o(), L10);
													t5{L8, L8, true};
													if (4 == g2) {
														t7{3};
														if (4 == g2) {
...
task t1
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 1) {
			object L0;
			@GetMainOutdoorScene(L0);
			@BroadcastMessage(f_de8_a0_s(), tv7, L0);
			@Trace("helpme timer");
		}
	}
...
task t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 2) {
			object L0;
			@GetMainOutdoorScene(L0);
			@BroadcastMessage(f_de8_a0_s(), tv3, L0);
			@Trace("helpme timer");
		} else {
			f_520_a1_v(a0);
		}
		...
		for (L1 = 0; L1 < 5 && f_baf_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_c29_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t6
{
	...
	bool init(void)
	{
		...
		L1->GetLocator(f_dec_a0_s(), L0, L2, L3);
		if (!L0) {
			return false;
		}
...
float f_a9c_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_bf8_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_bff_a3_f(L4 - L5, 0, 1));
	if (f_a8b_a1_b(a0)) {
		f_c0f_a1_v(-L5);
	}
	return L5;
...
float f_bf8_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_bff_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
int f_c30_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_c29_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
bool f_c5c_a2_b(object a0, string a1)
{
	if (a0 == f_be8_a0_o()) {
		return false;
	}
...
bool f_ca6_a1_b(object a0)
{
	if (a0->FuncExist("IsDead", 1) && f_ae5_a1_b(a0)) {
		if (f_a90_a2_b(a0, f_dea_a0_s())) {
			return false;
		}
		a0->SetProperty(f_dea_a0_s(), 1);
		return f_d3a_a1_b(a0);
	} else {
		if (f_a8b_a1_b(a0)) {
			return f_d70_a1_b(a0);
		}
	}
	return false;
}
...
{
	if (f_a8b_a1_b(a0)) {
		return f_d5e_a1_b(a0);
	}
	return false;
}

bool f_ce7_a0_b(void)
{
	object L0;
	Vector L1;
	Vector L2;
	...
	g1 = 0;
	while (true) {
		L0->GetLocator(f_de6_a0_s() + (g1 + 1), L4, L2, L3);
		if (!L4) {
			break;
		}
		g1++;
...
bool f_d82_a0_b(void)
{
	int L0;
	@GetVariable(f_dec_a0_s() + "_locked", L0);
	return L0 != 0;
}

void f_d8d_a1_v(bool a0)
{
	@SetVariable(f_dec_a0_s() + "_locked", a0 ? 1 : 0);
}

bool f_d9b_a0_b(void)
{
	int L0;
	@GetVariable(f_de6_a0_s() + "_locked", L0);
	return L0 >= f_dee_a0_i();
}

void f_da8_a1_v(bool a0)
{
	int L0;
	@GetVariable(f_de6_a0_s() + "_locked", L0);
	if (a0) {
	...
	@SetVariable(f_de6_a0_s() + "_locked", L0);
}
...
string f_de6_a0_s(void)
{
	return "pt_d7q04_patrol";
}

string f_de8_a0_s(void)
{
	return "d7q04_helpme";
}

string f_dea_a0_s(void)
{
	return "d7q04_corpse";
}

string f_dec_a0_s(void)
{
...
void f_df0_a0_v(void)
{
	...
	L0->SetProperty("im_inc", L1 / 100.0);
	L0->SetProperty("hl_inc", -(L2 / 100.0));
	@AddItem(L3, L0, 0, 1);
}
