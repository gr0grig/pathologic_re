...
maintask t2
{
	...
	void f_192_a0_v(void)
	{
		tv5 = true;
		if (!f_272_a0_b() && f_1c3_a0_b()) {
			@RemoveActor(f_2ff_a0_o());
		}
	}
...
bool f_277_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_305_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_320_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_333_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_340_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
{
	f_3f0_a3_v(f_3df_a0_o(), "pt_gatherer2", 2);
	a1->ShowMap(f_3df_a0_o());
}
...
void f_361_a2_v(object a0, object a1)
{
	...
	@SetVariable("d7q04", 2);
	L0 = f_3df_a0_o();
	L0->AddMark("d7q04WastedGotoGatherer", "pt_gatherer2", 0, 508638, f_34c_a0_f());
	f_3a9_a0_v();
	f_340_a2_b("quest_d7_04", "init_andrei");
}
...
void f_392_a2_v(object a0, object a1)
{
	...
	f_333_a3_v(a0, "rifle_ammo", 10);
}

bool f_39d_a1_b(object a0)
{
	if (f_30f_a1_i("d7q04") == 1) {
		return true;
	}
	return false;
}
...
bool f_3c3_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
void f_3f0_a3_v(object a0, string a1, float a2)
{
	Vector L0;
	Vector L1;
	object L2;
