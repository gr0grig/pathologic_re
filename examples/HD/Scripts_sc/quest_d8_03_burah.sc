...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_56f_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_810_a0_i());
		L0->SetNPCDescription(f_80e_a0_i());
		L0->SetPhoto(f_812_a0_s());
		L0->SetPhoto2(f_814_a0_s());
		L0->SetPlayerName(f_7fd_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			if (f_77c_a1_b(tv1) && f_788_a1_b(tv1)) {
				tv0->AddReply(513447, 37690, 14683);
			}
			if (f_794_a1_b(tv1)) {
				tv0->AddReply(513433, 14670, 14669);
			}
			if (f_740_a1_b(tv1) && f_74c_a1_b(tv1)) {
				tv0->AddReply(535977, 37706, 37705);
			}
			if (f_758_a1_b(tv1) && f_764_a1_b(tv1)) {
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_494_a0_v();
			if (f_56a_a0_b() && f_475_a0_b()) {
				if (f_461_a0_b()) {
					f_600_a1_b(f_685_a0_o());
				}
			} else {
				f_470_a0_v();
				f_48b_a0_v();
...
void f_503_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_56a_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_6db_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_561_a1_b(object a0)
{
	Vector L0;
	a0->GetPosition(L0);
	return f_557_a1_b(L0);
}

bool f_56a_a0_b(void)
{
	bool L0;
	@IsLoaded(L0);
	return L0;
...
bool f_56f_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_68b_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_660_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_6a6_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_6b9_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_6c6_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_6e2_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_6db_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_6f3_a2_v(object a0, object a1)
{
...
{
	f_7ba_a0_v();
	f_6c6_a2_b("quest_d8_03", "completed");
}

void f_71b_a2_v(object a0, object a1)
{
	@Trace("burah gives blood");
	f_6b9_a3_v(a0, "d8q03_blood", 1);
}
...
void f_72f_a2_v(object a0, object a1)
{
	...
	f_6b9_a3_v(a0, "burah_serum", 1);
}

void f_73a_a2_v(object a0, object a1)
{
...
{
	if (f_695_a1_i("d8q03") == 0) {
		return true;
	}
	return false;
}

bool f_77c_a1_b(object a0)
{
	if (f_695_a1_i("microscope_d8q03_blood") == 1) {
		return true;
	}
	return false;
}
...
bool f_7e1_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_812_a0_s(void)
{
	return "ui/NPC_Burah.png";
}

string f_814_a0_s(void)
{
	return "ui/NPC_Burah_b.png";
}

bool f_816_a0_b(void)
{
	return true;
}
