...
maintask t0
{
	...
	void OnTrigger(string a0)
	{
		...
		if (a0 == "termitnik_load") {
			...
			for (L1 = 0; L1 < tv1; L1++) {
				tv0->add(f_95_a4_o(L0, "pt_d8q04_morlok" + (L1 + 1), "pers_morlok", "d8q04_morlok.xml"));
			}
		} else {
			if (a0 == "death") {
				tv1 = tv1 + -1;
...
void f_cd_a2_v(object a0, string a1)
{
	if (a0) {
		int L0;
		int L1;
