...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_4d8_a0_i());
		L0->SetNPCDescription(f_4d6_a0_i());
		L0->SetPhoto(f_4da_a0_s());
		L0->SetPhoto2(f_4dc_a0_s());
		L0->SetPlayerName(f_4c5_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
	...
	void OnDialogReply(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 29488) {
				...
				tv0->AddReply(541107, 43221, 43220);
				return;
			}
			if (a0 == 43221) {
				f_9f_a1_v("Confusion");
				tv0->SetMessage(541108);
				tv0->ClearReplies();
				tv0->AddReply(541109, 29499, 43222);
				return;
			}
			if (a0 == 29499) {
				f_9f_a1_v("Warning");
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_20c_a0_v();
			if (f_2e2_a0_b() && f_1ed_a0_b()) {
				if (f_1d9_a0_b()) {
					f_378_a1_b(f_3fd_a0_o());
				}
			} else {
				f_1e8_a0_v();
				f_203_a0_v();
...
void f_27b_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_2e2_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_427_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_412_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_42e_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_427_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
{
	f_47e_a0_v();
	f_412_a2_b("quest_k10_01", "completed");
}

void f_449_a2_v(object a0, object a1)
{
	if (f_40d_a1_i("K_Mission4") == 0) {
...
{
	object L0;
	@CreateDiaryEntry(L0, 570, 0, 530584);
	f_498_a2_b(L0, -1);
}
...
bool f_498_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
