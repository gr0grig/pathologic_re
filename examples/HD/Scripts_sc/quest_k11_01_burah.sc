...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_311_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_4de_a0_i());
		L0->SetNPCDescription(f_4dc_a0_i());
		L0->SetPhoto(f_4e0_a0_s());
		L0->SetPhoto2(f_4e2_a0_s());
		L0->SetPlayerName(f_4cb_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_236_a0_v();
			if (f_30c_a0_b() && f_217_a0_b()) {
				if (f_203_a0_b()) {
					f_3a2_a1_b(f_427_a0_o());
				}
			} else {
				f_212_a0_v();
				f_22d_a0_v();
...
void f_2a5_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_30c_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_451_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
bool f_311_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
...
bool f_3a2_a1_b(object a0)
{
	...
	return f_411_a1_b(L4);
}

bool f_3c7_a1_b(object a0)
{
	string L0;
	L0 = "d" + f_448_a0_i() + "m";
	int L1;
...
bool f_43c_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_458_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_451_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_469_a2_v(object a0, object a1)
{
	@SetVariable("k11q01", 7);
	f_495_a0_v();
}

void f_472_a2_v(object a0, object a1)
{
	f_488_a0_v();
	f_43c_a2_b("quest_k11_01", "fail");
}

bool f_47c_a1_b(object a0)
{
	if (f_437_a1_i("k11q01") == 6) {
		return true;
	}
	return false;
}

void f_488_a0_v(void)
{
	object L0;
	@CreateDiaryEntry(L0, 778, 1, 541642);
	f_4af_a2_b(L0, 480);
}
...
bool f_4af_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_4e0_a0_s(void)
{
	return "ui/NPC_Burah.png";
}

string f_4e2_a0_s(void)
{
	return "ui/NPC_Burah_b.png";
}

bool f_4e4_a0_b(void)
{
	return true;
}
