...
void f_338_a3_v(object a0, bool a1, int a2)
{
	a0->add(7);
	a0->add(23);
	a0->add(21);
...
bool f_36c_a0_b(void)
{
	...
	for (L2 = 0; L2 < L1; L2++) {
		int L3;
		L0->get(L3, L2);
		if (f_362_a1_b(L3) || f_358_a1_b(L3)) {
			return false;
		}
	}
	return true;
...
bool f_3f5_a0_b(void)
{
	return f_3b8_a0_b() && f_392_a0_b() && f_36c_a0_b();
}

void f_408_a1_v(int a0)
{
