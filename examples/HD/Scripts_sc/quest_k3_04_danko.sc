...
task t0
{
	...
	int init(object a0)
	{
		...
		bool L3;
		tv0 = a0;
		if (!f_3d7_a2_b(a0, 70.0)) {
			return -2;
		}
		@CreateDialog(L0);
		L0->SetNPCName(f_653_a0_i());
		L0->SetNPCDescription(f_651_a0_i());
		L0->SetPhoto(f_655_a0_s());
		L0->SetPhoto2(f_657_a0_s());
		L0->SetPlayerName(f_640_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
maintask t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 10) {
			f_2f5_a0_v();
			if (f_3d2_a0_b() && f_2d6_a0_b()) {
				if (f_2c2_a0_b()) {
					f_468_a1_b(f_4ed_a0_o());
				}
			} else {
				f_2d1_a0_v();
				f_2ec_a0_v();
...
void f_364_a0_v(void)
{
	...
	for (L1 = 0; L1 < 5 && f_3d2_a0_b(); L1++) {
		if (!L0) {
			...
			@PlayAnimation("all", f_556_a1_s(L3));
			@WaitForAnimEnd(L5);
			if (!L5) {
				break;
			}
...
void f_3b8_a3_v(object a0, string a1, int a2)
{
	int L0;
...
bool f_3d7_a2_b(object a0, float a1)
{
	float L0;
	Vector L1;
	Vector L2;
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_4f3_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
void f_4c8_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
void f_50e_a2_v(object a0, int a1)
{
	f_3b8_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
void f_521_a3_v(object a0, object a1, int a2)
{
	int L0;
	int L1;
	bool L2;
...
void f_534_a3_v(object a0, string a1, int a2)
{
	object L0;
	@CreateInvItem(L0);
	L0->SetItemName(a1);
...
bool f_541_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_55d_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_556_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_577_a2_v(object a0, object a1)
{
	f_5f0_a0_v();
	f_541_a2_b("quest_k3_04", "completed");
}
...
{
	f_5fd_a0_v();
	f_541_a2_b("quest_k3_04", "fail");
}

void f_5b4_a2_v(object a0, object a1)
{
	@Trace("neomicin is given");
	f_534_a3_v(a0, "neomicin", 1);
}

bool f_5bf_a1_b(object a0)
{
	if (f_4fd_a1_i("k3q04") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_4fd_a1_i("k3q04LopuhTalk") != 0) {
		return true;
	}
	return false;
}
...
{
	object L0;
	@CreateDiaryEntry(L0, 784, 2, 542469);
	f_624_a2_b(L0, 354);
}

void f_60a_a0_v(void)
{
	object L0;
...
bool f_624_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
string f_655_a0_s(void)
{
	return "ui/NPC_Bakalavr.png";
}

string f_657_a0_s(void)
{
	return "ui/NPC_Bakalavr_b.png";
}

bool f_659_a0_b(void)
{
	return true;
}
