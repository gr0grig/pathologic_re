...
task t1
{
	...
	void init(object a0, object a1)
	{
		...
		tv3 = false;
		while (1) {
			if (f_403_a1_b(tv1) && !f_427_a1_b(tv1)) {
				f_b5_a1_v("Neutral");
	...
	void OnDialogReply(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 43036) {
				...
				tv0->AddReply(542080, 44374, 44373);
				return;
			}
			if (a0 == 44374) {
				f_b5_a1_v("Neutral");
				tv0->SetMessage(542081);
				tv0->ClearReplies();
				tv0->AddReply(542082, 44377, 44375);
				tv0->AddReply(542083, 44377, 44376);
				return;
			}
			if (a0 == 44377) {
				f_b5_a1_v("Neutral");
				tv0->SetMessage(542084);
				tv0->ClearReplies();
				tv0->AddReply(542085, 27063, 44379);
				return;
			}
			if (a0 == 27063) {
				f_b5_a1_v("Neutral");
	...
	for (L1 = 0; L1 < 5 && f_2bb_a0_b(); L1++) {
		...
		if (L2 == 0) {
			if (L0) {
				...
				bool L4;
				@irand(L3, L0);
				@PlayAnimation("all", f_3c4_a1_s(L3));
				@WaitForAnimEnd(L4);
				if (!L4) {
					break;
				}
...
bool f_292_a2_b(object a0, string a1)
{
	bool L0;
...
bool f_29e_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	float L0;
	if (!f_292_a2_b(a0, a1)) {
		return false;
	...
	a0->SetProperty(a1, f_352_a3_f(L0 + a2, a3, a4));
	return true;
}

void f_2b4_a3_v(object a0, string a1, int a2)
{
	int L0;
	a0->GetProperty(a1, L0);
...
void f_327_a2_v(string a0, bool a1)
{
	bool L0;
	@lshHasAnimation(L0, a0);
	if (L0) {
...
float f_352_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_36e_a2_v(object a0, int a1)
{
	f_2b4_a3_v(a0, "money", a1);
	if (a1 > 0) {
		int L0;
...
bool f_381_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
	...
	f_3a4_a1_v(a1);
	f_29e_a5_b(a0, "reputation", a1, 0, 1);
	return true;
}

void f_3a4_a1_v(float a0)
{
	object L0;
...
bool f_3ae_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
int f_3cb_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_3c4_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
{
	f_3ae_a2_b("quest_k4_02", "init_theater");
}
...
void f_3fc_a2_v(object a0, object a1)
{
	f_381_a2_b(a0, 0.10000000149011612);
}

bool f_403_a1_b(object a0)
{
	if (f_35d_a1_i("k4q02") == 1) {
		return true;
	}
	return false;
}
...
{
	if (f_35d_a1_i("ook4BirdmaskTheater1") == 0) {
		return true;
	}
	return false;
}
...
{
	if (f_35d_a1_i("k4q02BirdmaskGotoMaria") != 0) {
		return true;
	}
	return false;
}
...
bool f_462_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
