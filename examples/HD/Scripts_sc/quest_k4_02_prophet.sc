...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_3c5_a0_i());
		L0->SetNPCDescription(f_3c3_a0_i());
		L0->SetPhoto(f_3c7_a0_s());
		L0->SetPhoto2(f_3c9_a0_s());
		L0->SetPlayerName(f_3b2_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 43042) {
				...
				tv0->ClearReplies();
				tv0->AddReply(540963, 43046, 43048);
				return;
			}
			if (a0 == 43044) {
				f_9d_a1_v("Neutral");
...
maintask t2
{
	...
	void f_1cd_a0_v(void)
	{
		tv5 = true;
		if (!f_2ad_a0_b() && f_1fe_a0_b()) {
			@RemoveActor(f_33a_a0_o());
		}
	}
...
bool f_2b2_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_340_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
{
	if (f_34a_a1_i("k4q02") == 2) {
		return true;
	}
	return false;
}

void f_37c_a0_v(void)
{
	object L0;
...
bool f_396_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
