							...
							if (2 == g2) {
								...
								if (3 == g2) {
									...
									for (L3 = 0; L3 < g1; L3++) {
										...
										L0->GetLocator(f_dfa_a0_s() + (L7 + 1), L4, L5, L6);
										t5{L5, L6, false};
										if (3 != g2) {
											break;
										}
										...
										if (4 == g2) {
											...
											if (4 == g2) {
												...
												if (4 == g2) {
													...
													@BroadcastMessage(f_dfe_a0_s(), f_bf7_a0_o(), L10);
													t5{L8, L8, true};
													if (4 == g2) {
														t7{3};
														if (4 == g2) {
...
task t1
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 1) {
			object L0;
			@GetMainOutdoorScene(L0);
			@BroadcastMessage(f_dfc_a0_s(), tv7, L0);
			@Trace("helpme timer");
		}
	}
	...
	void f_31d_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_1c3_a2_f(L0, a1);
			L2 = f_a9c_a3_f(L0, L1, f_1c6_a2_i(L0, a1));
...
task t2
{
	...
	void OnTimer(int a0)
	{
		if (a0 == 2) {
			object L0;
			@GetMainOutdoorScene(L0);
			@BroadcastMessage(f_dfc_a0_s(), tv3, L0);
			@Trace("helpme timer");
		} else {
			f_520_a1_v(a0);
		}
		...
		for (L1 = 0; L1 < 5 && f_baf_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_c3d_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t6
{
	...
	bool init(void)
	{
		...
		L1->GetLocator(f_e00_a0_s(), L0, L2, L3);
		if (!L0) {
			return false;
		}
...
bool f_a90_a2_b(object a0, string a1)
{
	bool L0;
...
float f_a9c_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_a90_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_a90_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
	...
	L3 = f_c07_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_c0e_a3_f(L4 - L5, 0, 1));
	if (f_a8b_a1_b(a0)) {
		f_c23_a1_v(-L5);
	}
	return L5;
...
bool f_aea_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_ae5_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
bool f_b0e_a1_b(object a0)
{
	int L0;
	if (!f_aea_a1_b(a0)) {
		return false;
	}
	if (!f_a90_a2_b(a0, "noaccess")) {
		return true;
	}
...
void f_b52_a3_v(object a0, int a1, float a2)
{
	if (a0 && a1 != 4 && a1 != 5) {
		Vector L0;
		L0 = f_bfd_a1_V(f_a84_a1_V(a0));
		object L1;
...
void f_b96_a5_v(object a0, int a1, float a2, Vector a3, Vector a4)
{
	object L0;
	object L1;
	@GetScene(L0);
...
void f_bbf_a4_v(string a0, int a1, int a2, int a3)
{
	if (f_c1e_a2_b(a1, a2)) {
		int L0;
		bool L1;
...
float f_c07_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_c0e_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
int f_c44_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_c3d_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
bool f_c70_a2_b(object a0, string a1)
{
	if (a0 == f_bf7_a0_o()) {
		return false;
	}
...
{
	if (a0->FuncExist("IsDead", 1) && f_ae5_a1_b(a0)) {
		if (f_a90_a2_b(a0, f_dfe_a0_s())) {
			return false;
		}
		a0->SetProperty(f_dfe_a0_s(), 1);
		return f_d4e_a1_b(a0);
	} else {
		if (f_a8b_a1_b(a0)) {
			return f_d84_a1_b(a0);
		}
	}
	return false;
}

bool f_ced_a1_b(object a0)
{
	if (f_a8b_a1_b(a0)) {
		return f_d72_a1_b(a0);
	}
	return false;
}

bool f_cfb_a0_b(void)
{
	object L0;
	Vector L1;
	Vector L2;
	...
	g1 = 0;
	while (true) {
		L0->GetLocator(f_dfa_a0_s() + (g1 + 1), L4, L2, L3);
		if (!L4) {
			break;
		}
		g1++;
...
bool f_d96_a0_b(void)
{
	int L0;
	@GetVariable(f_e00_a0_s() + "_locked", L0);
	return L0 != 0;
}

void f_da1_a1_v(bool a0)
{
	@SetVariable(f_e00_a0_s() + "_locked", a0 ? 1 : 0);
}

bool f_daf_a0_b(void)
{
	int L0;
	@GetVariable(f_dfa_a0_s() + "_locked", L0);
	return L0 >= f_e02_a0_i();
}

void f_dbc_a1_v(bool a0)
{
	int L0;
	@GetVariable(f_dfa_a0_s() + "_locked", L0);
	if (a0) {
	...
	@SetVariable(f_dfa_a0_s() + "_locked", L0);
}
...
string f_dfa_a0_s(void)
{
	return "pt_k5q03_patrol";
}

string f_dfc_a0_s(void)
{
	return "k5q03_helpme";
}

string f_dfe_a0_s(void)
{
	return "k5q03_corpse";
}

string f_e00_a0_s(void)
{
...
void f_e04_a0_v(void)
{
	f_bbf_a4_v("gold_ring", 1, 2, 2);
	f_bbf_a4_v("silver_ring", 1, 2, 3);
	f_bbf_a4_v("beads", 1, 2, 3);
	f_bbf_a4_v("bracelet", 1, 2, 2);
}
