...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_657_a0_i());
		L0->SetNPCDescription(f_655_a0_i());
		L0->SetPhoto(f_659_a0_s());
		L0->SetPhoto2(f_65b_a0_s());
		L0->SetPlayerName(f_6b7_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t2
{
	...
	void OnUnload(void)
	{
		f_649_a2_b("quest_k6_03", "abinos_unload");
		@Hold();
	}
		...
		for (L1 = 0; L1 < 5 && f_52b_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_65f_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
maintask t3
{
	...
	void init(void)
	{
		object L0;
		@GetScene(L0);
		L0->RemoveStationaryActor(f_5e1_a0_o());
...
task t4
{
	...
	void OnUnload(void)
	{
		f_649_a2_b("quest_k6_03", "albinos_retreated");
		@Hold();
	}
	...
	Vector f_2dc_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_5e7_a1_V(f_5e7_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_387_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_42e_a1_V(tv0);
		return f_603_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
bool f_44e_a5_b(object a0, string a1, float a2, float a3, float a4)
{
	...
	a0->SetProperty(a1, f_5f8_a3_f(L0 + a2, a3, a4));
	return true;
}
...
float f_464_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_5f1_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_5f8_a3_f(L4 - L5, 0, 1));
	if (f_43d_a1_b(a0)) {
		f_62e_a1_v(-L5);
	}
	return L5;
...
bool f_530_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_5e7_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
float f_5f1_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_5f8_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_603_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

bool f_60b_a2_b(object a0, float a1)
{
	if (!a0) {
		return false;
	}
...
bool f_649_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
string f_659_a0_s(void)
{
	return "ui/NPC_Albinos.png";
}

string f_65b_a0_s(void)
{
	return "ui/NPC_Albinos_b.png";
}

bool f_65d_a0_b(void)
{
	return false;
}

string f_65f_a1_s(int a0)
{
	string L0;
	L0 = "idle";
	if (a0) {
...
int f_666_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_65f_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
{
	f_681_a0_v();
	f_649_a2_b("quest_k6_03", "completed");
}

void f_681_a0_v(void)
{
	object L0;
...
bool f_69b_a2_b(object a0, int a1)
{
	object L0;
	object L1;
	int L2;
...
{
	if (f_43d_a1_b(a0)) {
		f_60b_a2_b(a0, -0.10000000149011612);
	}
	f_6e2_a1_v(a0);
}
