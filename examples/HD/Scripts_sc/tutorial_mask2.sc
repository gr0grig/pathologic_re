...
task t0
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_303_a0_i());
		L0->SetNPCDescription(f_301_a0_i());
		L0->SetPhoto(f_305_a0_s());
		L0->SetPhoto2(f_307_a0_s());
		L0->SetPlayerName(f_30b_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
bool f_25c_a2_b(object a0, float a1)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * a1 + f_2df_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
string f_305_a0_s(void)
{
	return "ui/NPC_wmask.png";
}

string f_307_a0_s(void)
{
