...
maintask t2
{
	...
	void init(void)
	{
		...
		t0{"logo_gambitious.wmv", true};
		t0{"logo_devolver.wmv", true};
		t0{"logo_generalarcade.wmv", true};
		t0{"logo_icepick.wmv", true};
		t1{0};
		t0{"intro.wmv", true};
		f_c9_a1_v(false);
	}
	...
	void f_18f_a3_v(int a0, string a1, object a2)
	{
		if (a1 == "newgame") {
			tv2 = 7;
			@StopEventProcessing();
	...
	void f_36a_a0_v(void)
	{
		...
		if (f_3c7_a0_s() == "") {
			...
			if (f_3c7_a0_s() == "newgame") {
				@SendMessage(1, "loadgame");
				f_3c9_a1_v("loadgame");
			} else {
				if (f_3c7_a0_s() == "loadgame") {
					@SendMessage(1, "gameoptions");
					f_3c9_a1_v("gameoptions");
				} else {
					if (f_3c7_a0_s() == "gameoptions") {
						@SendMessage(1, "credits");
						f_3c9_a1_v("credits");
					} else {
						if (f_3c7_a0_s() == "credits") {
							@SendMessage(1, "quitgame");
							f_3c9_a1_v("quitgame");
						} else {
							if (f_3c7_a0_s() == "quitgame") {
								@SendMessage(1, "newgame");
								f_3c9_a1_v("newgame");
							}
						}
...
void f_4ac_a1_v(string a0)
{
	bool L0;
	@UITrace("loading map: " + a0);
	@LoadMap(L0, a0);
}
