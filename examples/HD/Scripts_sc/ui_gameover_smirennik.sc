...
maintask t2
{
	...
	void f_339_a0_v(void)
	{
		...
		if (f_396_a0_s() == "") {
			...
			if (f_396_a0_s() == "newgame") {
				@SendMessage(1, "loadgame");
				f_398_a1_v("loadgame");
			} else {
				if (f_396_a0_s() == "loadgame") {
					@SendMessage(1, "gameoptions");
					f_398_a1_v("gameoptions");
				} else {
					if (f_396_a0_s() == "gameoptions") {
						@SendMessage(1, "credits");
						f_398_a1_v("credits");
					} else {
						if (f_396_a0_s() == "credits") {
							@SendMessage(1, "quitgame");
							f_398_a1_v("quitgame");
						} else {
							if (f_396_a0_s() == "quitgame") {
								@SendMessage(1, "newgame");
								f_398_a1_v("newgame");
							}
						}
