...
maintask t2
{
	...
	{
		object L0;
		@CreateWindow("ingame_buttons.xml", false, L0);
		return L0;
	}
	...
	void f_ad_a0_v(void)
	{
		...
		if (f_119_a0_s() == "") {
			...
			if (f_119_a0_s() == "continue") {
				@SendMessage(1, "newgame");
				f_11b_a1_v("newgame");
			} else {
				if (f_119_a0_s() == "newgame") {
					@SendMessage(1, "loadgame");
					f_11b_a1_v("loadgame");
				} else {
					if (f_119_a0_s() == "loadgame") {
						@SendMessage(1, "savegame");
						f_11b_a1_v("savegame");
					} else {
						if (f_119_a0_s() == "savegame") {
							@SendMessage(1, "gameoptions");
							f_11b_a1_v("gameoptions");
						} else {
							if (f_119_a0_s() == "gameoptions") {
								@SendMessage(1, "quitgame");
								f_11b_a1_v("quitgame");
							} else {
								if (f_119_a0_s() == "quitgame") {
									@SendMessage(1, "continue");
									f_11b_a1_v("continue");
								}
							}
	...
	string f_119_a0_s(void)
	{
		return tv11;
	}

	void f_11b_a1_v(string a0)
	{
		tv11 = a0;
	}
