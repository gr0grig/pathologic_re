...
maintask t0
{
	...
	int f_129_a1_i(int a0)
	{
		return tv13 + (a0 - tv4 / 2) / tv14;
	}

	int f_130_a1_i(int a0)
	{
		return (a0 - tv12) * tv14 + tv3 / 2;
	}

	int f_137_a1_i(int a0)
	{
	...
	void OnUpdate(float a0)
	{
		...
		if (tv31) {
			if (!tv18) {
				tv14 = tv14 + 1.100000023841858 * a0;
				if (tv14 > 2.0) {
					tv14 = 2.0;
				}
				tv0 = tv0 + -1;
	...
	void f_214_a2_v(object a0, int a1)
	{
		float L0;
		float L1;
		int L2;
	...
	void f_2bb_a0_v(void)
	{
		...
		if (!tv17) {
			...
			L0 = f_130_a1_i(tv25.x);
			L1 = f_137_a1_i(tv25.z);
		...
		if (a2 == 0.20000000298023224) {
			...
			if (a2 == -0.20000000298023224) {
				...
				if (a2 > 0) {
					int L0;
					for (L0 = 0; L0 < a2; L0++) {
						f_336_a1_v(1.100000023841858);
					}
				} else {
					int L1;
					for (L1 = 0; L1 < -a2; L1++) {
						f_346_a1_v(1.100000023841858);
					}
				}
			}
		}
	...
	{
		if (a1 == "button_plus") {
			f_336_a1_v(1.399999976158142);
		} else {
			if (a1 == "button_minus") {
				f_346_a1_v(1.399999976158142);
			} else {
				if (a1 == "tavro") {
					tv18 = a0 == 0;
					@SendMessage(tv18 ? 1 : 0, "tavro");
...
string f_401_a1_s(int a0)
{
	return "Region" + a0 + "State";
}

bool f_407_a1_b(int a0)
{
	int L0;
	@GetVariable(f_401_a1_s(a0), L0);
	return (L0 & 3) == 0;
}

bool f_413_a1_b(int a0)
{
	int L0;
	@GetVariable(f_401_a1_s(a0), L0);
	return (L0 & 3) == 1;
