...
maintask t0
{
	...
	void f_f_a0_v(void)
	{
		...
		@CreateIntVector(tv5);
		if (f_55d_a0_i() == 1) {
			f_4dd_a3_v(tv5, false, 1);
		} else {
			if (f_55d_a0_i() == 0) {
				f_4fe_a3_v(tv5, false, 0);
			} else {
				f_51f_a3_v(tv5, false, 2);
			}
		}
		tv5->size(L0);
		L1 = 0;
	...
	int f_77_a1_i(int a0)
	{
		...
		for (; L4 < L3; L4++) {
			...
			if (f_549_a1_b(L5)) {
				L2 = false;
				@StretchBlit(f_327_a1_s(L5), 0, L0, 152, 126);
				L6 = f_171_a1_i(L5);
				@GetStringByID(L7, L6);
...
void f_4dd_a3_v(object a0, bool a1, int a2)
{
	a0->add(18);
	a0->add(24);
	a0->add(20);
...
void f_4fe_a3_v(object a0, bool a1, int a2)
{
	a0->add(6);
	a0->add(26);
	a0->add(2);
