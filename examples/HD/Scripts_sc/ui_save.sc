...
maintask t0
{
	...
	void OnDraw(void)
	{
		f_8f_a1_v(f_8c_a1_i(tv1));
	}

	int f_8c_a1_i(int a0)
	{
		return a0;
	}

	void f_8f_a1_v(int a0)
	{
		int L0;
		int L1;
		tv9->size(L0);
		for (L1 = 0; L1 < L0; L1++) {
			...
			if (L2) {
				...
				f_134_a3_v(0, a0, false);
				bool L5;
				L2->IsQuickSave(L5);
				if (L5) {
					@Print("default", 129, 7 + a0, f_256_a1_s(17), 0.5568627715110779, 0.5568627715110779, 0.5568627715110779);
				} else {
					string L6;
					bool L7;
					int L8;
				...
				f_134_a3_v(0, a0, true);
				@Print("default", 129, 47 + a0, f_256_a1_s(32), 0.5568627715110779, 0.5568627715110779, 0.5568627715110779);
			}
			if (tv2 == L1) {
	...
	void f_134_a3_v(int a0, int a1, bool a2)
	{
		if (a2) {
	...
	{
		tv2 = f_1dc_a2_i(a0, a1);
		tv3 = f_203_a2_i(a0, a1);
	}
...
string f_25b_a1_s(object a0)
{
	...
	L3 = L1 - L2 * 24;
	L4 = (L1 - L2 * 24 - L3) * 60;
	@format(L0, f_256_a1_s(18), L2 + 1, L3, L4);
	return L0;
}

string f_273_a1_s(object a0)
{
	string L0;
	int L1;
	int L2;
	...
	@format(L0, f_256_a1_s(19), L4, f_256_a1_s(20 + L5), L3, L2, L1);
	return L0;
}
