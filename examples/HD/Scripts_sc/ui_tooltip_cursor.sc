...
maintask t0
{
	...
	void OnUpdate(float a0)
	{
		...
		if (!f_4c2_a2_b(L2, tv0) || L0 != tv3 || L1 != tv2) {
			tv3 = L0;
			tv2 = L1;
			tv0 = L2;
			f_118_a3_v(tv3, tv2, tv0);
...
void f_125_a6_v(int a0, string a1, object a2, int a3, int a4, float a5)
{
	if (a0 == 1) {
		...
		if (a0 == 2) {
			f_414_a4_v(a3, a4, a2, a5);
		} else {
			if (a0 == 3) {
				f_2cd_a5_v(a3, a4, a2, true, a5);
			} else {
				if (a0 == 4) {
					f_2cd_a5_v(a3, a4, a2, false, a5);
				} else {
					if (a0 == 5) {
						f_48f_a5_v(a3, a4, a1, a2, a5);
					}
				}
			}
		}
...
void f_1a8_a5_v(int a0, int a1, object a2, string a3, float a4)
{
	...
	f_161_a5_v(L35, L36, 300, L6, a4);
	f_17c_a4_v(L35 + 41, L36 + 16, a2, a4);
	L36 = L36 + 250;
...
void f_2cd_a5_v(int a0, int a1, object a2, bool a3, float a4)
{
	object L0;
	float L1;
	int L2;
...
void f_414_a4_v(int a0, int a1, object a2, float a3)
{
	if (!a2) {
		return;
	}
