...
Strings:
	...
	W:end: 
	W:No
// @pool_raw:4e00650075007400720061006c000000476574506f736974696f6e0070006c006100790069006e00670020000000730074006100720074003a002000000065006e0064003a00200000004e006f000000
...
0x32: @@ GetPosition(Stack[-4]); Obj=9 // @poff=16
0x33: Pop(0)
...
0x4a: Pop(0)
0x4b: Push("start: ") // @poff=46
0x4c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x4d: @ Trace(Stack[-1])
0x4e: Pop(1)
0x4f: Push("end: ") // @poff=62
