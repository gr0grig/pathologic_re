...
Strings:
	...
	W:d11q01
	W:player
// @pool_raw:
...
0xac: Push((int) -1)
0xad: Push((int) 15182)
0xae: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xaf: Pop(3)
0xb0: GOTO 0xb3
...
0xc2: Push("all") // @poff=110
0xc3: Push("idle") // @poff=118
...
0xcb: Push("all") // @poff=110
0xcc: Push("idle") // @poff=118
...
0x124: Stack[-1] = "Neutral" // @poff=0
0x125: Call 0xd1

0x126: Pop(1)
0x127: Push((int) 13882)
0x128: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x129: Pop(1)
0x12a: @@@ ClearReplies(); Obj=0 // @poff=88
0x12b: Pop(0)
...
0x156: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x157: Pop(3)
0x158: Return(); Pop(0)
...
0x15d: Stack[-1] = "Neutral" // @poff=0
0x15e: Call 0xd1

0x15f: Pop(1)
0x160: Push((int) 13925)
0x161: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x162: Pop(1)
0x163: @@@ ClearReplies(); Obj=0 // @poff=88
0x164: Pop(0)
0x165: Push((int) 13926)
0x166: Push((int) 15158)
0x167: Push((int) 15157)
0x168: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x169: Pop(3)
...
0x174: Stack[-1] = "Neutral" // @poff=0
0x175: Call 0xd1

0x176: Pop(1)
0x177: Push((int) 13927)
0x178: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x179: Pop(1)
0x17a: @@@ ClearReplies(); Obj=0 // @poff=88
0x17b: Pop(0)
0x17c: Push((int) 13928)
0x17d: Push((int) 15160)
0x17e: Push((int) 15159)
0x17f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x180: Pop(3)
0x181: Push((int) 13945)
0x182: Push((int) 15160)
0x183: Push((int) 15178)
0x184: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x185: Pop(3)
0x186: Return(); Pop(0)
...
0x18b: Stack[-1] = "Neutral" // @poff=0
0x18c: Call 0xd1

0x18d: Pop(1)
0x18e: Push((int) 13929)
0x18f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x190: Pop(1)
0x191: @@@ ClearReplies(); Obj=0 // @poff=88
0x192: Pop(0)
0x193: Push((int) 13930)
0x194: Push((int) 15162)
0x195: Push((int) 15161)
0x196: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x197: Pop(3)
0x198: Push((int) 13944)
0x199: Push((int) 15162)
0x19a: Push((int) 15176)
0x19b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x19c: Pop(3)
0x19d: Return(); Pop(0)
...
0x1ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1ae: Pop(3)
0x1af: Push((int) 13941)
0x1b0: Push((int) 15173)
0x1b1: Push((int) 15172)
0x1b2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1b3: Pop(3)
0x1b4: Return(); Pop(0)
...
0x1b9: Stack[-1] = "Neutral" // @poff=0
0x1ba: Call 0xd1

0x1bb: Pop(1)
0x1bc: Push((int) 13942)
0x1bd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1be: Pop(1)
0x1bf: @@@ ClearReplies(); Obj=0 // @poff=88
0x1c0: Pop(0)
...
0x1cb: Stack[-1] = "Neutral" // @poff=0
0x1cc: Call 0xd1

0x1cd: Pop(1)
0x1ce: Push((int) 13933)
0x1cf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1d0: Pop(1)
0x1d1: @@@ ClearReplies(); Obj=0 // @poff=88
0x1d2: Pop(0)
...
0x1e8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1e9: Pop(3)
0x1ea: Return(); Pop(0)
...
0x1ef: Stack[-1] = "Neutral" // @poff=0
0x1f0: Call 0xd1

0x1f1: Pop(1)
0x1f2: Push((int) 13937)
0x1f3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1f4: Pop(1)
0x1f5: @@@ ClearReplies(); Obj=0 // @poff=88
0x1f6: Pop(0)
...
0x201: Stack[-1] = "Neutral" // @poff=0
0x202: Call 0xd1

0x203: Pop(1)
0x204: Push((int) 13939)
0x205: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x206: Pop(1)
0x207: @@@ ClearReplies(); Obj=0 // @poff=88
0x208: Pop(0)
...
0x225: Stack[-1] = "Neutral" // @poff=0
0x226: Call 0xd1

0x227: Pop(1)
0x228: Push((int) 13909)
0x229: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x22a: Pop(1)
0x22b: @@@ ClearReplies(); Obj=0 // @poff=88
0x22c: Pop(0)
...
0x237: Stack[-1] = "Neutral" // @poff=0
0x238: Call 0xd1

0x239: Pop(1)
0x23a: Push((int) 13911)
0x23b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x23c: Pop(1)
0x23d: @@@ ClearReplies(); Obj=0 // @poff=88
0x23e: Pop(0)
...
0x260: Stack[-1] = "Neutral" // @poff=0
0x261: Call 0xd1

0x262: Pop(1)
0x263: Push((int) 13923)
0x264: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x265: Pop(1)
0x266: @@@ ClearReplies(); Obj=0 // @poff=88
0x267: Pop(0)
...
0x304: Stack[-1] = "Neutral" // @poff=0
0x305: Call 0xd1

0x306: Pop(1)
0x307: Push((int) 13888)
0x308: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x309: Pop(1)
0x30a: @@@ ClearReplies(); Obj=0 // @poff=88
0x30b: Pop(0)
...
0x314: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x315: Pop(3)
0x316: Return(); Pop(0)
...
0x31b: Stack[-1] = "Neutral" // @poff=0
0x31c: Call 0xd1

0x31d: Pop(1)
0x31e: Push((int) 13890)
0x31f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x320: Pop(1)
0x321: @@@ ClearReplies(); Obj=0 // @poff=88
0x322: Pop(0)
...
0x32b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x32c: Pop(3)
0x32d: Return(); Pop(0)
...
0x332: Stack[-1] = "Neutral" // @poff=0
0x333: Call 0xd1

0x334: Pop(1)
0x335: Push((int) 13892)
0x336: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x337: Pop(1)
0x338: @@@ ClearReplies(); Obj=0 // @poff=88
0x339: Pop(0)
...
0x372: Pop(0)
0x373: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x374: Pop(1)
0x375: PushEmpty(string)
0x376: Call 0x698

0x377: Pop(0)
0x378: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=27
0x379: Pop(1)
0x37a: PushEmpty(int)
0x37b: Call 0x75f

0x37c: Pop(0)
0x37d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=36
0x37e: Pop(1)
0x37f: Stack[-2] = (int) -1
...
0x389: Stack[-11] = Stack[-2]
0x38a: Stack[-6] = Stack[-1]
0x38b: Push(-2, 4); TaskCall(5)
0x38c: Call 0x3a3

0x38d: Pop(-2, 4); TaskReturn
0x38e: Pop(2)
0x38f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x390: Pop(0)
...
0x393: @ sync()
0x394: Pop(0)
0x395: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x396: Pop(0)
0x397: GOTO 0x391

0x398: PushEmpty(object)
0x399: Stack[-10] = Stack[-1]
0x39a: Call 0x638

0x39b: Pop(1)
0x39c: @ StopDialog(Stack[-4])
0x39d: Pop(0)
0x39e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=62
0x39f: Pop(0)
0x3a0: Stack[-2] = Stack[-10]
0x3a1: Return(); Pop(8)
...
0x3ee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x3ef: Pop(3)
0x3f0: GOTO 0x3f3
...
0x402: Push("all") // @poff=110
0x403: Push("idle") // @poff=118
...
0x40b: Push("all") // @poff=110
0x40c: Push("idle") // @poff=118
...
0x487: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x488: Pop(3)
0x489: Return(); Pop(0)
...
0x492: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x493: Pop(1)
0x494: @@@ ClearReplies(); Obj=0 // @poff=88
0x495: Pop(0)
0x496: Push((int) 14319)
0x497: Push((int) 15542)
0x498: Push((int) 15541)
0x499: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x49a: Pop(3)
0x49b: Return(); Pop(0)
...
0x4a0: Stack[-1] = "Neutral" // @poff=0
0x4a1: Call 0x411

0x4a2: Pop(1)
0x4a3: Push((int) 14320)
0x4a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4a5: Pop(1)
0x4a6: @@@ ClearReplies(); Obj=0 // @poff=88
0x4a7: Pop(0)
...
0x4b2: Stack[-1] = "Neutral" // @poff=0
0x4b3: Call 0x411

0x4b4: Pop(1)
0x4b5: Push((int) 14322)
0x4b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4b7: Pop(1)
0x4b8: @@@ ClearReplies(); Obj=0 // @poff=88
0x4b9: Pop(0)
...
0x4d6: Stack[-1] = "Neutral" // @poff=0
0x4d7: Call 0x411

0x4d8: Pop(1)
0x4d9: Push((int) 14309)
0x4da: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4db: Pop(1)
0x4dc: @@@ ClearReplies(); Obj=0 // @poff=88
0x4dd: Pop(0)
...
0x50c: Stack[-1] = "Neutral" // @poff=0
0x50d: Call 0x411

0x50e: Pop(1)
0x50f: Push((int) 14315)
0x510: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x511: Pop(1)
0x512: @@@ ClearReplies(); Obj=0 // @poff=88
0x513: Pop(0)
0x514: Push((int) 14316)
0x515: Push((int) -1)
0x516: Push((int) 15538)
0x517: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x518: Pop(3)
0x519: Return(); Pop(0)
...
0x51e: Stack[-1] = "Neutral" // @poff=0
0x51f: Call 0x411

0x520: Pop(1)
0x521: Push((int) 14282)
0x522: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x523: Pop(1)
0x524: @@@ ClearReplies(); Obj=0 // @poff=88
0x525: Pop(0)
0x526: Push((int) 14283)
0x527: Push((int) 15504)
0x528: Push((int) 15503)
0x529: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x52a: Pop(3)
0x52b: Return(); Pop(0)
...
0x530: Stack[-1] = "Neutral" // @poff=0
0x531: Call 0x411

0x532: Pop(1)
0x533: Push((int) 14284)
0x534: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x535: Pop(1)
0x536: @@@ ClearReplies(); Obj=0 // @poff=88
0x537: Pop(0)
0x538: Push((int) 14285)
0x539: Push((int) 15506)
0x53a: Push((int) 15505)
0x53b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x53c: Pop(3)
...
0x547: Stack[-1] = "Neutral" // @poff=0
0x548: Call 0x411

0x549: Pop(1)
0x54a: Push((int) 14291)
0x54b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x54c: Pop(1)
0x54d: @@@ ClearReplies(); Obj=0 // @poff=88
0x54e: Pop(0)
...
0x5b0: Stack[-1] = "Neutral" // @poff=0
0x5b1: Call 0x411

0x5b2: Pop(1)
0x5b3: Push((int) 14297)
0x5b4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5b5: Pop(1)
0x5b6: @@@ ClearReplies(); Obj=0 // @poff=88
0x5b7: Pop(0)
0x5b8: Push((int) 14298)
0x5b9: Push((int) -1)
0x5ba: Push((int) 15518)
0x5bb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5bc: Pop(3)
0x5bd: Return(); Pop(0)
...
0x5cd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5ce: Pop(3)
0x5cf: Return(); Pop(0)
...
0x5d4: Stack[-1] = "Neutral" // @poff=0
0x5d5: Call 0x411

0x5d6: Pop(1)
0x5d7: Push((int) 14288)
0x5d8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5d9: Pop(1)
0x5da: @@@ ClearReplies(); Obj=0 // @poff=88
0x5db: Pop(0)
0x5dc: Push((int) 14289)
0x5dd: Push((int) -1)
0x5de: Push((int) 15509)
0x5df: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5e0: Pop(3)
0x5e1: Return(); Pop(0)
...
0x5f0: @@ GetPosition(Stack[-4]); Obj=9 // @poff=128
0x5f1: Pop(0)
...
0x601: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x602: Pop(0)
0x603: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x604: Pop(0)
...
0x644: Pop(0)
0x645: Push("start: ") // @poff=172
0x646: Pop(1); Push(Stack[-1] + Stack[-3]);
0x647: @ Trace(Stack[-1])
0x648: Pop(1)
0x649: Push("end: ") // @poff=188
...
0x658: Push((float)9.999999974752427e-07)
...
0x661: Pop(0)
0x662: Stack[-1] = Stack[-4]
0x663: Return(); Pop(2)

0x664: PushEmpty(int, int, bool, int, int, bool)
0x665: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0x666: Pop(0)
0x667: Push("Category") // @poff=210
0x668: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x669: Pop(1)
0x66a: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0x66b: Pop(0)
0x66c: Pop(0); Push((bool) Stack[-1] == 0)
0x66d: IF (Stack[-1] == 0) GOTO 0x670; Pop(1)

0x66e: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0x66f: Pop(0)
0x670: Return(); Pop(6)
...
0x673: Pop(0)
0x674: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0x675: Pop(0)
0x676: PushEmpty(object, object, int)
0x677: Stack[-8] = Stack[-3]
0x678: Stack[-4] = Stack[-2]
0x679: Stack[-6] = Stack[-1]
0x67a: Call 0x664
...
0x698: Stack[-1] = "ui/NPC_Burah.png" // @poff=264
0x699: Return(); Pop(0)
...
0x69c: PushEmpty()
0x69d: Push("playsound") // @poff=298
0x69e: Push("giveitem") // @poff=318
0x69f: @ TriggerWorld(Stack[-2], Stack[-1])
0x6a0: Pop(2)
0x6a1: Return(); Pop(0)

0x6a2: PushEmpty()
0x6a3: Push("d9TalkToPolkovodec") // @poff=336
0x6a4: Push((int) 1)
...
0x6a8: PushEmpty()
0x6a9: Push("ood9Block1") // @poff=374
0x6aa: Push((int) 1)
...
0x6af: Push("Rifle is given") // @poff=396
0x6b0: @ Trace(Stack[-1])
0x6b1: Pop(1)
0x6b2: @ CreateInvItem(Stack[-1])
0x6b3: Pop(0)
0x6b4: Push("Rifle") // @poff=426
0x6b5: @@ SetItemName(Stack[-1]); Obj=2 // @poff=246
0x6b6: Pop(1)
0x6b7: Push("durability") // @poff=438
0x6b8: Push((int) 100)
0x6b9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=460
0x6ba: Pop(2)
0x6bb: PushEmpty(object, object, int)
0x6bc: Stack[-7] = Stack[-3]
0x6bd: Stack[-4] = Stack[-2]
0x6be: Stack[-1] = (int) 1
0x6bf: Call 0x664
...
0x6c2: Stack[-1] = 0
0x6c3: PushEmpty()
0x6c4: Push("ood11Block1") // @poff=472
0x6c5: Push((int) 1)
...
0x6c9: PushEmpty()
0x6ca: Push("ood11Block2") // @poff=496
0x6cb: Push((int) 1)
...
0x6cf: PushEmpty()
0x6d0: Push("ood11Block3") // @poff=520
0x6d1: Push((int) 1)
...
0x6d5: PushEmpty()
0x6d6: Push("rifle ammo10 is given") // @poff=544
0x6d7: @ Trace(Stack[-1])
0x6d8: Pop(1)
0x6d9: PushEmpty(object, string, int)
0x6da: Stack[-5] = Stack[-3]
0x6db: Stack[-2] = "rifle_ammo" // @poff=588
...
0x6e0: PushEmpty()
0x6e1: Push("ood9Block2") // @poff=610
0x6e2: Push((int) 1)
...
0x6fe: Stack[-1] = "ood9Block1" // @poff=374
0x6ff: Call 0x65f
...
0x722: Stack[-1] = "ood11Block1" // @poff=472
0x723: Call 0x65f
...
0x73a: Stack[-1] = "ood11Block2" // @poff=496
0x73b: Call 0x65f
...
0x746: Stack[-1] = "ood11Block3" // @poff=520
0x747: Call 0x65f
...
0x752: Stack[-1] = "ood9Block2" // @poff=610
0x753: Call 0x65f
