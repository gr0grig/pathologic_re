...
// @pool_raw:
...
0x13c: Pop(0)
0x13d: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x13e: Pop(1)
0x13f: PushEmpty(string)
0x140: Call 0xa8c

0x141: Pop(0)
0x142: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=27
0x143: Pop(1)
0x144: PushEmpty(int)
0x145: Call 0xca6

0x146: Pop(0)
0x147: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=36
0x148: Pop(1)
0x149: Stack[-2] = (int) -1
...
0x153: Stack[-11] = Stack[-2]
0x154: Stack[-6] = Stack[-1]
0x155: Push(-2, 4); TaskCall(5)
0x156: Call 0x16d

0x157: Pop(-2, 4); TaskReturn
0x158: Pop(2)
0x159: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x15a: Pop(0)
...
0x15d: @ sync()
0x15e: Pop(0)
0x15f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x160: Pop(0)
0x161: GOTO 0x15b

0x162: PushEmpty(object)
0x163: Stack[-10] = Stack[-1]
0x164: Call 0xa13

0x165: Pop(1)
0x166: @ StopDialog(Stack[-4])
0x167: Pop(0)
0x168: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=62
0x169: Pop(0)
0x16a: Stack[-2] = Stack[-10]
0x16b: Return(); Pop(8)
...
0x182: Stack[-1] = "Neutral" // @poff=0
0x183: Call 0x26c

0x184: Pop(1)
0x185: Push((int) 5050)
0x186: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x187: Pop(1)
0x188: @@@ ClearReplies(); Obj=0 // @poff=88
0x189: Pop(0)
0x18a: Push((int) 5051)
0x18b: Push((int) 5555)
0x18c: Push((int) 5554)
0x18d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x18e: Pop(3)
0x18f: Push((int) 5073)
0x190: Push((int) 5582)
0x191: Push((int) 5581)
0x192: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x193: Pop(3)
0x194: GOTO 0x24e

0x195: PushEmpty(string)
0x196: Stack[-1] = "Neutral" // @poff=0
0x197: Call 0x26c

0x198: Pop(1)
0x199: Push((int) 8066)
0x19a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x19b: Pop(1)
0x19c: @@@ ClearReplies(); Obj=0 // @poff=88
0x19d: Pop(0)
...
0x1b6: IF (Stack[-1] == 1) GOTO 0x1cf; Pop(1)
...
0x1cd: IF (Stack[-1] == 1) GOTO 0x1cf; Pop(1)
...
0x1e4: IF (Stack[-1] == 1) GOTO 0x1f4; Pop(1)
...
0x1f6: Push((int) 5592)
0x1f7: Push((int) 8891)
0x1f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1f9: Pop(3)
...
0x22f: Push((int) 8918)
0x230: Push((int) 8901)
0x231: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x232: Pop(3)
...
0x242: Push((int) 8919)
0x243: Push((int) 8913)
0x244: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x245: Pop(3)
0x246: Push((int) 8697)
0x247: Push((int) -1)
0x248: Push((int) 9534)
0x249: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x24a: Pop(3)
0x24b: GOTO 0x24e
...
0x25d: Push("all") // @poff=110
0x25e: Push("idle") // @poff=118
...
0x266: Push("all") // @poff=110
0x267: Push("idle") // @poff=118
...
0x338: Pop(1)
0x339: Push((int) 5050)
0x33a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x33b: Pop(1)
0x33c: @@@ ClearReplies(); Obj=0 // @poff=88
0x33d: Pop(0)
0x33e: Push((int) 5051)
0x33f: Push((int) 5555)
0x340: Push((int) 5554)
...
0x34a: Stack[-1] = "Neutral" // @poff=0
0x34b: Call 0x26c

0x34c: Pop(1)
0x34d: Push((int) 8066)
0x34e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x34f: Pop(1)
0x350: @@@ ClearReplies(); Obj=0 // @poff=88
0x351: Pop(0)
...
0x36a: IF (Stack[-1] == 1) GOTO 0x383; Pop(1)
...
0x381: IF (Stack[-1] == 1) GOTO 0x383; Pop(1)
...
0x398: IF (Stack[-1] == 1) GOTO 0x3a8; Pop(1)
...
0x3a6: IF (Stack[-1] == 1) GOTO 0x3a8; Pop(1)
...
0x3aa: Push((int) 5592)
0x3ab: Push((int) 8891)
0x3ac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x3ad: Pop(3)
...
0x463: Stack[-1] = "Neutral" // @poff=0
0x464: Call 0x26c

0x465: Pop(1)
0x466: Push((int) 5092)
0x467: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x468: Pop(1)
0x469: @@@ ClearReplies(); Obj=0 // @poff=88
0x46a: Pop(0)
0x46b: Push((int) 5093)
0x46c: Push((int) 5596)
0x46d: Push((int) 5604)
0x46e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x46f: Pop(3)
0x470: Push((int) 5094)
0x471: Push((int) -1)
0x472: Push((int) 5606)
...
0x4bb: Push((int) 5609)
0x4bc: Push((int) 5614)
0x4bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x4be: Pop(3)
0x4bf: Return(); Pop(0)
...
0x4c4: Stack[-1] = "Neutral" // @poff=0
0x4c5: Call 0x26c

0x4c6: Pop(1)
0x4c7: Push((int) 5097)
0x4c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4c9: Pop(1)
0x4ca: @@@ ClearReplies(); Obj=0 // @poff=88
0x4cb: Pop(0)
0x4cc: Push((int) 5098)
0x4cd: Push((int) 5616)
0x4ce: Push((int) 5610)
0x4cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x4d0: Pop(3)
0x4d1: Push((int) 5099)
0x4d2: Push((int) 5612)
0x4d3: Push((int) 5611)
0x4d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x4d5: Pop(3)
0x4d6: Return(); Pop(0)
...
0x4db: Stack[-1] = "Neutral" // @poff=0
0x4dc: Call 0x26c

0x4dd: Pop(1)
0x4de: Push((int) 5100)
0x4df: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4e0: Pop(1)
0x4e1: @@@ ClearReplies(); Obj=0 // @poff=88
0x4e2: Pop(0)
0x4e3: Push((int) 5101)
0x4e4: Push((int) -1)
0x4e5: Push((int) 5613)
0x4e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x4e7: Pop(3)
0x4e8: Return(); Pop(0)
...
0x4ed: Stack[-1] = "Neutral" // @poff=0
0x4ee: Call 0x26c

0x4ef: Pop(1)
0x4f0: Push((int) 5103)
0x4f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4f2: Pop(1)
0x4f3: @@@ ClearReplies(); Obj=0 // @poff=88
0x4f4: Pop(0)
0x4f5: Push((int) 5104)
0x4f6: Push((int) -1)
0x4f7: Push((int) 5617)
0x4f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x4f9: Pop(3)
0x4fa: Return(); Pop(0)
...
0x4ff: Stack[-1] = "Neutral" // @poff=0
0x500: Call 0x26c

0x501: Pop(1)
0x502: Push((int) 5074)
0x503: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x504: Pop(1)
0x505: @@@ ClearReplies(); Obj=0 // @poff=88
0x506: Pop(0)
0x507: Push((int) 5075)
0x508: Push((int) 5584)
0x509: Push((int) 5583)
...
0x52d: Stack[-1] = "Neutral" // @poff=0
0x52e: Call 0x26c

0x52f: Pop(1)
0x530: Push((int) 5076)
0x531: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x532: Pop(1)
0x533: @@@ ClearReplies(); Obj=0 // @poff=88
0x534: Pop(0)
0x535: Push((int) 5077)
0x536: Push((int) 5555)
0x537: Push((int) 5585)
0x538: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x539: Pop(3)
0x53a: Return(); Pop(0)
...
0x53f: Stack[-1] = "Neutral" // @poff=0
0x540: Call 0x26c

0x541: Pop(1)
0x542: Push((int) 5052)
0x543: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x544: Pop(1)
0x545: @@@ ClearReplies(); Obj=0 // @poff=88
0x546: Pop(0)
0x547: Push((int) 5053)
0x548: Push((int) 5557)
0x549: Push((int) 5556)
...
0x58d: Push((int) 5566)
0x58e: Push((int) 5565)
0x58f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x590: Pop(3)
0x591: Return(); Pop(0)
...
0x596: Stack[-1] = "Neutral" // @poff=0
0x597: Call 0x26c

0x598: Pop(1)
0x599: Push((int) 5063)
0x59a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x59b: Pop(1)
0x59c: @@@ ClearReplies(); Obj=0 // @poff=88
0x59d: Pop(0)
0x59e: Push((int) 5064)
0x59f: Push((int) 5561)
0x5a0: Push((int) 5567)
...
0x5a4: Push((int) 5570)
0x5a5: Push((int) 5569)
0x5a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5a7: Pop(3)
0x5a8: Return(); Pop(0)
...
0x5ad: Stack[-1] = "Neutral" // @poff=0
0x5ae: Call 0x26c

0x5af: Pop(1)
0x5b0: Push((int) 5066)
0x5b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5b2: Pop(1)
0x5b3: @@@ ClearReplies(); Obj=0 // @poff=88
0x5b4: Pop(0)
0x5b5: Push((int) 5067)
0x5b6: Push((int) 5561)
0x5b7: Push((int) 5571)
0x5b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5b9: Pop(3)
0x5ba: Return(); Pop(0)
...
0x5c1: Pop(1)
0x5c2: Push((int) 5058)
0x5c3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5c4: Pop(1)
0x5c5: @@@ ClearReplies(); Obj=0 // @poff=88
0x5c6: Pop(0)
0x5c7: Push((int) 5059)
0x5c8: Push((int) -1)
0x5c9: Push((int) 5562)
...
0x5cd: Push((int) -1)
0x5ce: Push((int) 5563)
0x5cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5d0: Pop(3)
0x5d1: Push((int) 5061)
0x5d2: Push((int) -1)
0x5d3: Push((int) 5564)
0x5d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5d5: Pop(3)
0x5d6: Return(); Pop(0)
...
0x5f2: Pop(0)
0x5f3: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x5f4: Pop(1)
0x5f5: PushEmpty(string)
0x5f6: Call 0xa8c

0x5f7: Pop(0)
0x5f8: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=27
0x5f9: Pop(1)
0x5fa: PushEmpty(int)
0x5fb: Call 0xca6

0x5fc: Pop(0)
0x5fd: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=36
0x5fe: Pop(1)
0x5ff: Stack[-2] = (int) -1
...
0x60e: Pop(2)
0x60f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x610: Pop(0)
...
0x613: @ sync()
0x614: Pop(0)
0x615: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x616: Pop(0)
0x617: GOTO 0x611

0x618: PushEmpty(object)
0x619: Stack[-10] = Stack[-1]
0x61a: Call 0xa13

0x61b: Pop(1)
0x61c: @ StopDialog(Stack[-4])
0x61d: Pop(0)
0x61e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=62
0x61f: Pop(0)
0x620: Stack[-2] = Stack[-10]
0x621: Return(); Pop(8)
...
0x64e: Push("all") // @poff=110
0x64f: Push("idle") // @poff=118
...
0x657: Push("all") // @poff=110
0x658: Push("idle") // @poff=118
...
0x690: Pop(1)
0x691: Push((int) 9475)
0x692: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x693: Pop(1)
0x694: @@@ ClearReplies(); Obj=0 // @poff=88
0x695: Pop(0)
0x696: Push((int) 9476)
0x697: Push((int) 10419)
0x698: Push((int) 10418)
0x699: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x69a: Pop(3)
0x69b: Push((int) 9481)
0x69c: Push((int) 10424)
0x69d: Push((int) 10423)
0x69e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x69f: Pop(3)
0x6a0: Return(); Pop(0)
...
0x6a7: Pop(1)
0x6a8: Push((int) 9482)
0x6a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x6aa: Pop(1)
0x6ab: @@@ ClearReplies(); Obj=0 // @poff=88
0x6ac: Pop(0)
0x6ad: Push((int) 9483)
...
0x6b7: Stack[-1] = "Neutral" // @poff=0
0x6b8: Call 0x65d

0x6b9: Pop(1)
0x6ba: Push((int) 9484)
0x6bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x6bc: Pop(1)
0x6bd: @@@ ClearReplies(); Obj=0 // @poff=88
0x6be: Pop(0)
0x6bf: Push((int) 9485)
0x6c0: Push((int) -1)
0x6c1: Push((int) 10427)
0x6c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6c3: Pop(3)
0x6c4: Push((int) 9486)
0x6c5: Push((int) -1)
0x6c6: Push((int) 10428)
0x6c7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6c8: Pop(3)
0x6c9: Return(); Pop(0)
...
0x6ce: Stack[-1] = "Neutral" // @poff=0
0x6cf: Call 0x65d

0x6d0: Pop(1)
0x6d1: Push((int) 9477)
0x6d2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x6d3: Pop(1)
0x6d4: @@@ ClearReplies(); Obj=0 // @poff=88
0x6d5: Pop(0)
0x6d6: Push((int) 9478)
0x6d7: Push((int) -1)
0x6d8: Push((int) 10420)
0x6d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6da: Pop(3)
0x6db: Push((int) 9479)
0x6dc: Push((int) -1)
0x6dd: Push((int) 10421)
0x6de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6df: Pop(3)
0x6e0: Push((int) 9480)
0x6e1: Push((int) -1)
...
0x701: Pop(0)
0x702: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x703: Pop(1)
0x704: PushEmpty(string)
0x705: Call 0xa8c

0x706: Pop(0)
0x707: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=27
0x708: Pop(1)
0x709: PushEmpty(int)
0x70a: Call 0xca6

0x70b: Pop(0)
0x70c: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=36
0x70d: Pop(1)
0x70e: Stack[-2] = (int) -1
...
0x71d: Pop(2)
0x71e: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x71f: Pop(0)
...
0x722: @ sync()
0x723: Pop(0)
0x724: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x725: Pop(0)
0x726: GOTO 0x720

0x727: PushEmpty(object)
0x728: Stack[-10] = Stack[-1]
0x729: Call 0xa13

0x72a: Pop(1)
0x72b: @ StopDialog(Stack[-4])
0x72c: Pop(0)
0x72d: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=62
0x72e: Pop(0)
0x72f: Stack[-2] = Stack[-10]
0x730: Return(); Pop(8)
...
0x743: Stack[-1] = "Neutral" // @poff=0
0x744: Call 0x785

0x745: Pop(1)
0x746: Push((int) 9951)
0x747: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x748: Pop(1)
0x749: @@@ ClearReplies(); Obj=0 // @poff=88
0x74a: Pop(0)
0x74b: Push((int) 9952)
...
0x757: Stack[-1] = "Neutral" // @poff=0
0x758: Call 0x785

0x759: Pop(1)
0x75a: Push((int) 15314)
0x75b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x75c: Pop(1)
0x75d: @@@ ClearReplies(); Obj=0 // @poff=88
0x75e: Pop(0)
...
0x776: Push("all") // @poff=110
0x777: Push("idle") // @poff=118
...
0x77f: Push("all") // @poff=110
0x780: Push("idle") // @poff=118
...
0x7b6: Stack[-1] = "Neutral" // @poff=0
0x7b7: Call 0x785

0x7b8: Pop(1)
0x7b9: Push((int) 9951)
0x7ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x7bb: Pop(1)
0x7bc: @@@ ClearReplies(); Obj=0 // @poff=88
0x7bd: Pop(0)
0x7be: Push((int) 9952)
...
0x7ce: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x7cf: Pop(1)
0x7d0: @@@ ClearReplies(); Obj=0 // @poff=88
0x7d1: Pop(0)
0x7d2: Push((int) 15315)
0x7d3: Push((int) -1)
0x7d4: Push((int) 16553)
0x7d5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7d6: Pop(3)
0x7d7: Return(); Pop(0)
...
0x7dc: Stack[-1] = "Neutral" // @poff=0
0x7dd: Call 0x785

0x7de: Pop(1)
0x7df: Push((int) 9953)
0x7e0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x7e1: Pop(1)
0x7e2: @@@ ClearReplies(); Obj=0 // @poff=88
0x7e3: Pop(0)
0x7e4: Push((int) 9954)
0x7e5: Push((int) -1)
0x7e6: Push((int) 10971)
0x7e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7e8: Pop(3)
0x7e9: Push((int) 9955)
0x7ea: Push((int) 10973)
0x7eb: Push((int) 10972)
0x7ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7ed: Pop(3)
0x7ee: Return(); Pop(0)
...
0x7f3: Stack[-1] = "Neutral" // @poff=0
0x7f4: Call 0x785

0x7f5: Pop(1)
0x7f6: Push((int) 9956)
0x7f7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x7f8: Pop(1)
0x7f9: @@@ ClearReplies(); Obj=0 // @poff=88
0x7fa: Pop(0)
0x7fb: Push((int) 9957)
...
0x833: Pop(0)
0x834: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=16
0x835: Pop(1)
0x836: PushEmpty(string)
0x837: Call 0xa8c

0x838: Pop(0)
0x839: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=27
0x83a: Pop(1)
0x83b: PushEmpty(int)
0x83c: Call 0xca6

0x83d: Pop(0)
0x83e: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=36
0x83f: Pop(1)
0x840: Stack[-2] = (int) -1
...
0x84a: Stack[-11] = Stack[-2]
0x84b: Stack[-6] = Stack[-1]
0x84c: Push(-2, 4); TaskCall(11)
0x84d: Call 0x864

0x84e: Pop(-2, 4); TaskReturn
0x84f: Pop(2)
0x850: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x851: Pop(0)
...
0x854: @ sync()
0x855: Pop(0)
0x856: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=50
0x857: Pop(0)
0x858: GOTO 0x852

0x859: PushEmpty(object)
0x85a: Stack[-10] = Stack[-1]
0x85b: Call 0xa13

0x85c: Pop(1)
0x85d: @ StopDialog(Stack[-4])
0x85e: Pop(0)
0x85f: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=62
0x860: Pop(0)
0x861: Stack[-2] = Stack[-10]
0x862: Return(); Pop(8)
...
0x86b: Stack[-1] = "Neutral" // @poff=0
0x86c: Call 0x8ac

0x86d: Pop(1)
0x86e: Push((int) 12815)
0x86f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x870: Pop(1)
0x871: @@@ ClearReplies(); Obj=0 // @poff=88
0x872: Pop(0)
...
0x884: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x885: Pop(3)
...
0x89d: Push("all") // @poff=110
0x89e: Push("idle") // @poff=118
...
0x8a6: Push("all") // @poff=110
0x8a7: Push("idle") // @poff=118
...
0x93d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x93e: Pop(1)
0x93f: @@@ ClearReplies(); Obj=0 // @poff=88
0x940: Pop(0)
...
0x94b: Stack[-1] = "Neutral" // @poff=0
0x94c: Call 0x8ac

0x94d: Pop(1)
0x94e: Push((int) 12819)
0x94f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x950: Pop(1)
0x951: @@@ ClearReplies(); Obj=0 // @poff=88
0x952: Pop(0)
0x953: Push((int) 12820)
0x954: Push((int) 14021)
0x955: Push((int) 14020)
0x956: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x957: Pop(3)
0x958: Return(); Pop(0)
...
0x95d: Stack[-1] = "Neutral" // @poff=0
0x95e: Call 0x8ac

0x95f: Pop(1)
0x960: Push((int) 12821)
0x961: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x962: Pop(1)
0x963: @@@ ClearReplies(); Obj=0 // @poff=88
0x964: Pop(0)
...
0x97f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x980: Pop(3)
0x981: Return(); Pop(0)
...
0x9cb: @@ GetPosition(Stack[-4]); Obj=9 // @poff=128
0x9cc: Pop(0)
...
0x9dc: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x9dd: Pop(0)
0x9de: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x9df: Pop(0)
...
0xa1f: Pop(0)
0xa20: Push("start: ") // @poff=172
0xa21: Pop(1); Push(Stack[-1] + Stack[-3]);
0xa22: @ Trace(Stack[-1])
0xa23: Pop(1)
0xa24: Push("end: ") // @poff=188
...
0xa33: Push((float)9.999999974752427e-07)
...
0xa40: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0xa41: Pop(0)
0xa42: Push("Category") // @poff=210
0xa43: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xa44: Pop(1)
0xa45: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0xa46: Pop(0)
0xa47: Pop(0); Push((bool) Stack[-1] == 0)
0xa48: IF (Stack[-1] == 0) GOTO 0xa4b; Pop(1)

0xa49: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0xa4a: Pop(0)
0xa4b: Return(); Pop(6)
...
0xa4e: Pop(0)
0xa4f: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0xa50: Pop(0)
0xa51: PushEmpty(object, object, int)
0xa52: Stack[-8] = Stack[-3]
0xa53: Stack[-4] = Stack[-2]
0xa54: Stack[-6] = Stack[-1]
0xa55: Call 0xa3f
...
0xa5b: Pop(0)
0xa5c: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0xa83: Stack[-1] = "No" // @poff=258
0xa84: Call 0xa17

0xa85: Pop(1)
0xa86: @ lshWaitForAnimEnd(Stack[-1])
0xa87: Pop(0)
0xa88: Stack[-1] = Stack[-3]
0xa89: Return(); Pop(2)

0xa8a: Stack[-1] = (int) 2867
0xa8b: Return(); Pop(0)

0xa8c: Stack[-1] = "ui/NPC_Laska.png" // @poff=264
0xa8d: Return(); Pop(0)
...
0xa94: Pop(1)
0xa95: Push("d1q02AnnaGotoLaska") // @poff=298
0xa96: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=336
0xa97: Pop(1)
0xa98: Push(Stack[-1])
0xa99: IF (Stack[-1] == 0) GOTO 0xa9c; Pop(1)

0xa9a: @@ Remove(); Obj=1 // @poff=345
0xa9b: Pop(0)
0xa9c: Push("d1q02ViktorGotoAnna") // @poff=352
0xa9d: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=336
0xa9e: Pop(1)
0xa9f: Push(Stack[-1])
0xaa0: IF (Stack[-1] == 0) GOTO 0xaa3; Pop(1)

0xaa1: @@ Remove(); Obj=1 // @poff=345
0xaa2: Pop(0)
0xaa3: PushEmpty()
0xaa4: Call 0xcb7
...
0xaab: Stack[-2] = "quest_d1_02" // @poff=392
0xaac: Stack[-1] = "completed" // @poff=416
0xaad: Call 0xa59
...
0xab3: Push("lockpick1time is given") // @poff=436
0xab4: @ Trace(Stack[-1])
0xab5: Pop(1)
0xab6: @ CreateInvItem(Stack[-1])
0xab7: Pop(0)
0xab8: Push("lockpick") // @poff=482
0xab9: @@ SetItemName(Stack[-1]); Obj=2 // @poff=246
0xaba: Pop(1)
0xabb: Push("uses") // @poff=500
0xabc: Push((int) 1)
0xabd: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=510
0xabe: Pop(2)
0xabf: PushEmpty(object, object, int)
0xac0: Stack[-7] = Stack[-3]
0xac1: Stack[-4] = Stack[-2]
0xac2: Stack[-1] = (int) 1
0xac3: Call 0xa3f
...
0xac6: Stack[-1] = 0
0xac7: PushEmpty()
0xac8: Push("playsound") // @poff=522
0xac9: Push("giveitem") // @poff=542
0xaca: @ TriggerWorld(Stack[-2], Stack[-1])
0xacb: Pop(2)
0xacc: Return(); Pop(0)

0xacd: PushEmpty()
0xace: Push("ood1Laska4") // @poff=560
0xacf: Push((int) 1)
...
0xad3: PushEmpty()
0xad4: Push("ood1Laska5") // @poff=582
0xad5: Push((int) 1)
...
0xad9: PushEmpty()
0xada: Push("ood1Laska6") // @poff=604
0xadb: Push((int) 1)
...
0xadf: PushEmpty()
0xae0: Push("ood1Laska7") // @poff=626
0xae1: Push((int) 1)
...
0xae5: PushEmpty()
0xae6: Push("powder is given") // @poff=648
0xae7: @ Trace(Stack[-1])
0xae8: Pop(1)
0xae9: PushEmpty(object, string, int)
0xaea: Stack[-5] = Stack[-3]
0xaeb: Stack[-2] = "powder" // @poff=680
0xaec: Stack[-1] = (int) 1
0xaed: Call 0xa4c
...
0xaf0: PushEmpty()
0xaf1: Push("ood6Laska1") // @poff=694
0xaf2: Push((int) 1)
...
0xafd: Stack[-1] = Stack[-2]
0xafe: Pop(1)
0xaff: Push("d6q01LaskaGotoAlbinos") // @poff=728
0xb00: Push("pt_d6q03_albinos") // @poff=772
0xb01: Push((int) 1)
...
0xb05: Pop(0)
0xb06: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=806
0xb07: Pop(5)
0xb08: PushEmpty()
0xb09: Call 0xcc7
...
0xb0c: Stack[-2] = "quest_d6_01" // @poff=814
0xb0d: Stack[-1] = "albinos_klara" // @poff=838
0xb0e: Call 0xa59
...
0xb11: Stack[-1] = 0
0xb12: PushEmpty()
0xb13: Push("d6q01") // @poff=716
0xb14: Push((int) 4)
0xb15: @ SetVariable(Stack[-2], Stack[-1])
0xb16: Pop(2)
0xb17: PushEmpty(bool, string, string)
0xb18: Stack[-2] = "quest_d6_01" // @poff=814
0xb19: Stack[-1] = "eva_klara" // @poff=866
0xb1a: Call 0xa59
...
0xb23: PushEmpty()
0xb24: Push("ood1Laska1") // @poff=906
0xb25: Push((int) 1)
...
0xb29: PushEmpty()
0xb2a: Push("ood3Laska1") // @poff=928
0xb2b: Push((int) 1)
...
0xb2f: PushEmpty()
0xb30: Push("ood1Laska2") // @poff=950
0xb31: Push((int) 1)
...
0xb35: PushEmpty()
0xb36: Push("ood1Laska3") // @poff=972
0xb37: Push((int) 1)
...
0xb3d: Stack[-1] = "d1q01FirstGeorgVisit" // @poff=994
0xb3e: Call 0xa3a
...
0xb55: Stack[-1] = "ood1Laska4" // @poff=560
0xb56: Call 0xa3a
...
0xb61: Stack[-1] = "ood1Laska5" // @poff=582
0xb62: Call 0xa3a
...
0xb6d: Stack[-1] = "ood1Laska6" // @poff=604
0xb6e: Call 0xa3a
...
0xb79: Stack[-1] = "ood1Laska7" // @poff=626
0xb7a: Call 0xa3a
...
0xba3: Stack[-1] = "d6q03AlbinosKilled" // @poff=1048
0xba4: Call 0xa3a
...
0xbbb: Stack[-1] = "ood6Laska1" // @poff=694
0xbbc: Call 0xa3a
...
0xbc7: Stack[-1] = "KnowKaterina" // @poff=1086
0xbc8: Call 0xa3a
...
0xbd3: Stack[-1] = "KnowMaria" // @poff=1112
0xbd4: Call 0xa3a
...
0xbdf: Stack[-1] = "KnowMishka" // @poff=1132
0xbe0: Call 0xa3a
...
0xbeb: Stack[-1] = "ood3Laska1" // @poff=928
0xbec: Call 0xa3a
...
0xbf7: Stack[-1] = "KnowOspina" // @poff=1154
0xbf8: Call 0xa3a
...
0xc03: Stack[-1] = "ood1Laska1" // @poff=906
0xc04: Call 0xa3a
...
0xc0f: Stack[-1] = "ood1Laska2" // @poff=950
0xc10: Call 0xa3a
...
0xc1b: Stack[-1] = "ood1Laska3" // @poff=972
0xc1c: Call 0xa3a
...
0xc5f: Push("Can't retrieve diary root") // @poff=1176
0xc60: @ Trace(Stack[-1])
0xc61: Pop(1)
...
0xc6a: Stack[-1] = Stack[-4]
0xc6b: Pop(1)
0xc6c: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1228
0xc6d: Pop(0)
0xc6e: Pop(0); Push((bool) Stack[-2] == 0)
0xc6f: IF (Stack[-1] == 0) GOTO 0xc76; Pop(1)

0xc70: Push("Can't find diary parent with id: ") // @poff=1233
...
0xc76: @@ AddChild(Stack[-8]); Obj=2 // @poff=1301
0xc77: Pop(0)
0xc78: Push("player_diary") // @poff=1310
0xc79: Push((int) 1)
0xc7a: @ SetVariable(Stack[-2], Stack[-1])
0xc7b: Pop(2)
0xc7c: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1336
0xc7d: Pop(0)
...
0xc87: Stack[-1] = Stack[-3]
0xc88: Pop(1)
0xc89: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=1228
0xc8a: Pop(0)
...
0xc97: Pop(0)
0xc98: Pop(0); PushNull((bool) Stack[-2] == 0)
0xc99: IF (Stack[-1] == 0) GOTO 0xca0; Pop(1)

0xc9a: Push("Can't find main outdoor scene") // @poff=1348
0xc9b: @ Trace(Stack[-1])
0xc9c: Pop(1)
0xc9d: Stack[-1] = 0
...
0xca0: @@ GetMap(Stack[-1]); Obj=2 // @poff=1408
0xca1: Pop(0)
0xca2: Stack[-1] = Stack[-5]
0xca3: Return(); Pop(4)

0xca4: Stack[-1] = 0
0xca5: Stack[-2] = 0
0xca6: PushEmpty(int, int)
0xca7: Push("player") // @poff=1415
...
0xcb8: Push("Adding diary entry") // @poff=1429
0xcb9: @ Trace(Stack[-1])
0xcba: Pop(1)
0xcbb: Push((int) 36)
0xcbc: Push((int) 2)
...
0xcc8: Push("Adding diary entry") // @poff=1429
0xcc9: @ Trace(Stack[-1])
0xcca: Pop(1)
0xccb: Push((int) 117)
0xccc: Push((int) 1)
