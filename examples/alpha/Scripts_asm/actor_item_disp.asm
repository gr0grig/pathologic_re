...
Strings:
	...
	W:Category
	A:AddItem
// @pool_raw:
...
0x53: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=61
0x54: Pop(0)
0x55: Stack[-1] = Stack[-5]
0x56: Return(); Pop(2)

0x57: PushEmpty(bool, bool)
0x58: @@ IsDead(Stack[-1]); Obj=3 // @poff=73
0x59: Pop(0)
0x5a: Stack[-1] = Stack[-4]
0x5b: Return(); Pop(2)

0x5c: PushEmpty(object, object, object, object)
0x5d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x71: Pop(0)
0x72: Pop(0); PushNull((bool) Stack[-2] == 0)
0x73: IF (Stack[-1] == 0) GOTO 0x76; Pop(1)

0x74: Stack[-6] = (bool) 0
0x75: Return(); Pop(4)

0x76: @@ GetScene(Stack[-1]); Obj=5 // @poff=94
0x77: Pop(0)
...
0x8b: Stack[-1] = "noaccess" // @poff=103
0x8c: Call 0x4b
...
0x92: Push("noaccess") // @poff=103
0x93: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=121
0x94: Pop(1)
0x95: Push((int) 0)
...
0x9f: @@ GetItemID(Stack[-3]); Obj=8 // @poff=133
0xa0: Pop(0)
0xa1: Push("Category") // @poff=143
0xa2: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0xa3: Pop(1)
0xa4: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=161
0xa5: Pop(0)
