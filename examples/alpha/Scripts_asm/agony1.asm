...
Strings:
	...
	A:GetProperty
	A:SetProperty
// @pool_raw:
...
0x1b: Pop(2)
0x1c: Push("all") // @poff=24
0x1d: Push("agony") // @poff=0
...
0x32: Push("all") // @poff=24
0x33: Push("agony_die") // @poff=32
...
0x3a: Push("all") // @poff=24
0x3b: Push("agony_die") // @poff=32
...
0x66: Push("agony") // @poff=0
0x67: Push((int) 0)
0x68: @ SetProperty(Stack[-2], Stack[-1])
0x69: Pop(2)
0x6a: PushEmpty(bool, object, string, float, float, float)
0x6b: Stack[-17] = Stack[-5]
0x6c: Stack[-4] = "reputation" // @poff=72
0x6d: Stack[-3] = (float) 0.20000000298023224
0x6e: Stack[-2] = (int) 0
0x6f: Stack[-1] = (int) 1
0x70: Call 0x9b
...
0x78: Push("all") // @poff=24
0x79: Push("agony_die") // @poff=32
...
0x97: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=118
0x98: Pop(0)
...
0xa5: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=130
0xa6: Pop(0)
0xa7: PushEmpty(float, float, float, float)
0xa8: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0xa9: Stack[-8] = Stack[-2]
0xaa: Stack[-7] = Stack[-1]
0xab: Call 0xb7

0xac: Pop(3)
0xad: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=142
0xae: Pop(1)
0xaf: Stack[-8] = (bool) 1
0xb0: Return(); Pop(2)
