...
Strings:
	...
	W:1
	W:2
// @pool_raw:
...
0x54: @ StopAsync()
0x55: Pop(0)
0x56: Push("head") // @poff=160
0x57: @ UnlookAsync(Stack[-1])
0x58: Pop(1)
0x59: Push("all") // @poff=170
...
0x8d: Stack[-1] = 0
0x8e: PushEmpty()
0x8f: Stack[-3] = (float) 0.10000000149011612
0x90: Return(); Pop(0)
...
0x9e: Push("attack_begin") // @poff=192
0x9f: Push((int) 1)
0xa0: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xab: Push("attack") // @poff=218
0xac: Push((int) 1)
0xad: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0xc8: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0xc9: Pop(0)
0xca: Push(Stack[-22])
...
0xda: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=288
0xdb: Pop(0)
...
0xfe: Pop(1)
0xff: Push("all") // @poff=170
0x100: Push("attack_on") // @poff=302
...
0x10c: Push((float)0.6000000238418579)
0x10d: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x10e: IF (Stack[-1] == 1) GOTO 0x114; Pop(1)

0x10f: PushEmpty(bool)
0x110: Call 0x253

0x111: Pop(0)
0x112: IF (Stack[-1] == 1) GOTO 0x114; Pop(1)

0x113: Stack[-1] = (bool) 0
0x114: IF (Stack[-1] == 0) GOTO 0x122; Pop(1)

0x115: @ Face(Stack[-0]T)
0x116: Pop(0)
0x117: Push("all") // @poff=170
0x118: Push("attack_stay") // @poff=322
...
0x122: @ Face(Stack[-0]T)
0x123: Pop(0)
0x124: Push("all") // @poff=170
0x125: Push("fjump") // @poff=346
...
0x13d: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=288
0x13e: Pop(0)
...
0x15c: Push("all") // @poff=170
0x15d: Push("attack_off") // @poff=358
...
0x169: Push((float)0.8999999761581421)
0x16a: Pop(1); Push(Stack[-9] * Stack[-1]);
0x16b: @ GetVictim(Stack[-1], Stack[-4])
0x16c: Pop(1)
0x16d: @ ReportAttack(Stack[-0]T)
0x16e: Pop(0)
...
0x172: Stack[-6] = Stack[-2]
0x173: Stack[-10] = Stack[-1]
0x174: Call 0x8e

0x175: Stack[-3] = Stack[-5]
0x176: Pop(3)
0x177: PushEmpty(float, object, float, int)
0x178: Stack[-7] = Stack[-3]
0x179: Stack[-6] = Stack[-2]
0x17a: PushEmpty(int, object, int)
0x17b: Stack[-10] = Stack[-2]
0x17c: Stack[-14] = Stack[-1]
0x17d: Call 0x91

0x17e: Stack[-3] = Stack[-4]
0x17f: Pop(3)
0x180: Call 0x331

0x181: Stack[-4] = Stack[-5]
0x182: Pop(4)
0x183: PushEmpty(int)
0x184: Call 0x27e

0x185: Pop(0)
0x186: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x187: Pop(1)
0x188: PushEmpty(object, float)
0x189: Stack[-5] = Stack[-2]
...
0x190: @ irand(Stack[-2], Stack[-1]T)
0x191: Pop(0)
0x192: Push((int) 1)
0x193: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x194: @ Face(Stack[-0]T)
0x195: Pop(0)
0x196: Push((bool) 1)
0x197: @ SetAttackState(Stack[-1])
0x198: Pop(1)
0x199: Push("all") // @poff=170
0x19a: Push("attack_begin") // @poff=192
...
0x1ae: Stack[-7] = Stack[-2]
0x1af: Stack[-4] = Stack[-1]
0x1b0: Call 0x168

0x1b1: Pop(2)
0x1b2: Push("all") // @poff=170
0x1b3: Push("attack_middle") // @poff=380
...
0x1b9: Push("all") // @poff=170
0x1ba: Push("attack_middle") // @poff=380
...
0x1d1: Pop(1)
0x1d2: Push("all") // @poff=170
0x1d3: Push("attack_end") // @poff=408
...
0x20b: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=288
0x20c: Pop(0)
...
0x241: @ Face(Stack[-0]T)
0x242: Pop(0)
0x243: Push("all") // @poff=170
0x244: Push("bjump") // @poff=430
0x245: @ PlayAnimation(Stack[-2], Stack[-1])
0x246: Pop(2)
0x247: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=288
0x248: Pop(0)
...
0x271: @ irand(Stack[-1], Stack[-2]T)
0x272: Pop(0)
0x273: Push((int) 1)
0x274: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x275: Push("attack") // @poff=218
...
0x299: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x29a: Pop(0)
...
0x2b0: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=288
0x2b1: Pop(0)
...
0x2c2: Push((int) 0)
0x2c3: Push((float)0.30000001192092896)
...
0x2e5: Push((int) 0)
0x2e6: Push((float)0.30000001192092896)
...
0x319: Stack[-1] = "walk" // @poff=478
0x31a: Return(); Pop(0)

0x31b: Stack[-1] = "run" // @poff=488
0x31c: Return(); Pop(0)
...
0x321: Stack[-2] = "fire" // @poff=496
0x322: Return(); Pop(0)

0x323: Stack[-2] = "phys" // @poff=506
0x324: Return(); Pop(0)

0x325: PushEmpty(bool, bool)
0x326: Push("HasProperty") // @poff=516
0x327: Push((int) 2)
...
0x32d: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=540
0x32e: Pop(0)
...
0x333: Stack[-18] = Stack[-2]
0x334: Stack[-1] = "health" // @poff=552
0x335: Call 0x325
...
0x33c: Stack[-18] = Stack[-2]
0x33d: Stack[-1] = "armor" // @poff=566
0x33e: Call 0x325
...
0x344: Push("armor") // @poff=566
0x345: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=578
0x346: Pop(1)
0x347: Push("armor_") // @poff=590
0x348: PushEmpty(string, int)
0x349: Stack[-16] = Stack[-1]
0x34a: Call 0x31d

0x34b: Pop(1)
0x34c: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x34d: PushEmpty(bool, object, string)
0x34e: Stack[-18] = Stack[-2]
0x34f: Stack[-8] = Stack[-1]
0x350: Call 0x325
...
0x356: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=578
0x357: Pop(0)
...
0x35e: Stack[-3] = Stack[-6]
0x35f: Pop(3)
0x360: Push("health") // @poff=552
0x361: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=578
0x362: Pop(1)
0x363: Push((int) 1)
0x364: Pop(1); Push(Stack[-1] - Stack[-4]);
0x365: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x366: Push("health") // @poff=552
...
0x36c: Pop(3)
0x36d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=604
0x36e: Pop(2)
0x36f: Stack[-1] = Stack[-16]
0x370: Return(); Pop(12)

0x371: PushEmpty(bool, bool)
0x372: @@ IsDead(Stack[-1]); Obj=3 // @poff=616
0x373: Pop(0)
0x374: Stack[-1] = Stack[-4]
0x375: Return(); Pop(2)

0x376: PushEmpty(object, object, object, object)
0x377: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x390: @@ GetScene(Stack[-1]); Obj=5 // @poff=637
0x391: Pop(0)
...
0x3c0: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x3c1: Pop(0)
...
0x3d1: Stack[-1] = "fhit" // @poff=684
0x3d2: GOTO 0x3d4

0x3d3: Stack[-1] = "bhit" // @poff=694
0x3d4: Push("hit_react") // @poff=704
0x3d5: Push("1") // @poff=724
0x3d6: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3d7: Push("2") // @poff=728
...
0x3de: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x3df: Pop(0)
...
0x404: Stack[-7] = Stack[-3]
0x405: Stack[-6] = Stack[-2]
0x406: Stack[-5] = Stack[-1]
0x407: Call 0x39a
