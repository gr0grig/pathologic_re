...
Strings:
	...
	W:nouse_container
	W:idle
// @pool_raw:
...
0x69: @ GetPFPosition(Stack[-1]T)
0x6a: Pop(0)
0x6b: @ GetDirection(Stack[-0]T)
0x6c: Pop(0)
0x6d: Push((int) 60)
...
0x84: @ FindPathTo(Stack[-1], Stack[-1]T)
0x85: Pop(0)
...
0x93: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x94: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0xa6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xa7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x11f: @@ RemoveAllItems(Stack[-11]); Obj=25 // @poff=32
0x120: Pop(0)
0x121: Push((int) 1)
...
0x125: Pop(0)
0x126: Push("pt_arena_player") // @poff=47
0x127: @@ GetLocator(Stack[-1], Stack[-6], Stack[-10], Stack[-9]); Obj=11 // @poff=79
0x128: Pop(1)
0x129: Push("pt_arena_enemy") // @poff=90
0x12a: @@ GetLocator(Stack[-1], Stack[-6], Stack[-8], Stack[-7]); Obj=11 // @poff=79
0x12b: Pop(1)
0x12c: @ Teleport(Stack[-25], Stack[-10], Stack[-9], Stack[-8])
0x12d: Pop(0)
0x12e: Push("pers_butcher") // @poff=120
0x12f: Push("arena_fighter.xml") // @poff=146
0x130: @ AddActor(Stack[-6], Stack[-2], Stack[-12], Stack[-9], Stack[-8], Stack[-1])
0x131: Pop(2)
0x132: PushEmpty(object, string, string, string)
0x133: Stack[-14] = Stack[-4]
0x134: Stack[-3] = "pers_worker" // @poff=182
0x135: Stack[-2] = "arena_spectator_worker.xml" // @poff=206
0x136: Stack[-1] = "pt_arena_spectator1" // @poff=260
0x137: Call 0x203

0x138: Pop(4)
0x139: PushEmpty(object, string, string, string)
0x13a: Stack[-14] = Stack[-4]
0x13b: Stack[-3] = "pers_worker" // @poff=182
0x13c: Stack[-2] = "arena_spectator_worker.xml" // @poff=206
0x13d: Stack[-1] = "pt_arena_spectator2" // @poff=300
0x13e: Call 0x203

0x13f: Pop(4)
0x140: PushEmpty(object, string, string, string)
0x141: Stack[-14] = Stack[-4]
0x142: Stack[-3] = "pers_unosha" // @poff=340
0x143: Stack[-2] = "arena_spectator_unosha.xml" // @poff=364
0x144: Stack[-1] = "pt_arena_spectator3" // @poff=418
0x145: Call 0x203

0x146: Pop(4)
0x147: PushEmpty(object, string, string, string)
0x148: Stack[-14] = Stack[-4]
0x149: Stack[-3] = "pers_unosha" // @poff=340
0x14a: Stack[-2] = "arena_spectator_unosha.xml" // @poff=364
0x14b: Stack[-1] = "pt_arena_spectator4" // @poff=458
0x14c: Call 0x203

0x14d: Pop(4)
0x14e: PushEmpty(object, string, string, string)
0x14f: Stack[-14] = Stack[-4]
0x150: Stack[-3] = "pers_unosha" // @poff=340
0x151: Stack[-2] = "arena_spectator_unosha2.xml" // @poff=498
0x152: Stack[-1] = "pt_arena_spectator5" // @poff=554
0x153: Call 0x203

0x154: Pop(4)
0x155: PushEmpty(object, string, string, string)
0x156: Stack[-14] = Stack[-4]
0x157: Stack[-3] = "pers_dohodyaga" // @poff=594
0x158: Stack[-2] = "arena_spectator_dohodyaga.xml" // @poff=624
0x159: Stack[-1] = "pt_arena_spectator6" // @poff=684
0x15a: Call 0x203

0x15b: Pop(4)
0x15c: PushEmpty(object, string, string, string)
0x15d: Stack[-14] = Stack[-4]
0x15e: Stack[-3] = "pers_boy" // @poff=724
0x15f: Stack[-2] = "arena_spectator_boy.xml" // @poff=742
0x160: Stack[-1] = "pt_arena_spectator7" // @poff=790
0x161: Call 0x203
...
0x17a: @@ IsDead(Stack[-3]); Obj=4 // @poff=830
0x17b: Pop(0)
0x17c: Push(Stack[-3])
...
0x1b3: Pop(4)
0x1b4: @@ SelectWeapon(); Obj=25 // @poff=837
0x1b5: Pop(0)
0x1b6: Push("pt_arena_return") // @poff=850
0x1b7: @@ GetLocator(Stack[-1], Stack[-6], Stack[-3], Stack[-2]); Obj=11 // @poff=79
0x1b8: Pop(1)
...
0x1d7: Push((int) 0)
0x1d8: @@ GetItemCount(Stack[-9], Stack[-1]); Obj=18 // @poff=882
0x1d9: Pop(1)
0x1da: Stack[-7] = (int) 0
0x1db: Pop(0); Push((bool) Stack[-7] < Stack[-8])
0x1dc: IF (Stack[-1] == 0) GOTO 0x202; Pop(1)

0x1dd: @@ GetItem(Stack[-6], Stack[-7]); Obj=17 // @poff=895
0x1de: Pop(0)
0x1df: @@ GetItemID(Stack[-5]); Obj=6 // @poff=903
0x1e0: Pop(0)
0x1e1: Push("Group") // @poff=913
0x1e2: @ HasInvItemProperty(Stack[-5], Stack[-6], Stack[-1])
0x1e3: Pop(1)
0x1e4: Push(Stack[-4])
0x1e5: IF (Stack[-1] == 0) GOTO 0x1f4; Pop(1)

0x1e6: Push("Group") // @poff=913
...
0x1ee: Push((int) 0)
0x1ef: @@ IsItemSelected(Stack[-3], Stack[-8], Stack[-1]); Obj=18 // @poff=925
0x1f0: Pop(1)
0x1f1: Push(Stack[-2])
...
0x1f4: Push((int) 0)
0x1f5: @@ GetItemAmount(Stack[-2], Stack[-8], Stack[-1]); Obj=18 // @poff=940
0x1f6: Pop(1)
0x1f7: Push((int) 0)
0x1f8: @@ RemoveItem(Stack[-8], Stack[-2], Stack[-1]); Obj=18 // @poff=954
0x1f9: Pop(1)
0x1fa: Push((int) -1)
...
0x204: @@ GetLocator(Stack[-9], Stack[-2], Stack[-4], Stack[-3]); Obj=12 // @poff=79
0x205: Pop(0)
0x206: Pop(0); Push((bool) Stack[-2] == 0)
0x207: IF (Stack[-1] == 0) GOTO 0x20d; Pop(1)

0x208: Push("Locator doesn't exist for arena spectator ") // @poff=965
...
0x20d: Push((bool) 1)
0x20e: @@ AddStationaryActor(Stack[-2], Stack[-5], Stack[-4], Stack[-12], Stack[-11], Stack[-1]); Obj=13 // @poff=1051
0x20f: Pop(1)
0x210: @@@ add(Stack[-1]); Obj=10 // @poff=1070
0x211: Pop(0)
0x212: Return(); Pop(8)

0x213: Stack[-1] = 0
0x214: PushEmpty(int, int, object, object, int, int, object, object)
0x215: @@@ size(Stack[-4]); Obj=10 // @poff=1074
0x216: Pop(0)
0x217: Stack[-3] = (int) 0
0x218: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x219: IF (Stack[-1] == 0) GOTO 0x229; Pop(1)

0x21a: @@@ get(Stack[-2], Stack[-3]); Obj=10 // @poff=1079
0x21b: Pop(0)
0x21c: @@ GetActor(Stack[-1]); Obj=2 // @poff=1083
0x21d: Pop(0)
...
0x22e: Pop(0)
0x22f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=1105
0x230: Pop(0)
...
0x238: Push("noaccess") // @poff=1117
0x239: @@ HasProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=1135
0x23a: Pop(1)
0x23b: Push(Stack[-2])
0x23c: IF (Stack[-1] == 0) GOTO 0x246; Pop(1)

0x23d: Push("noaccess") // @poff=1117
0x23e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=1147
0x23f: Pop(1)
0x240: Push("noaccess") // @poff=1117
0x241: Push((int) 1)
0x242: Pop(1); Push(Stack[-3] + Stack[-1]);
0x243: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=1159
0x244: Pop(2)
0x245: GOTO 0x24a

0x246: Push("noaccess") // @poff=1117
0x247: Push((int) 1)
0x248: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=1159
0x249: Pop(2)
0x24a: Return(); Pop(4)
...
0x24f: Push("noaccess") // @poff=1117
0x250: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=1147
0x251: Pop(1)
0x252: Push((int) 1)
0x253: Pop(1); Push((bool) Stack[-2] > Stack[-1])
0x254: IF (Stack[-1] == 0) GOTO 0x25b; Pop(1)

0x255: Push("noaccess") // @poff=1117
0x256: Push((int) 1)
0x257: Pop(1); Push(Stack[-3] - Stack[-1]);
0x258: @@ SetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=1159
0x259: Pop(2)
0x25a: GOTO 0x25e

0x25b: Push("noaccess") // @poff=1117
0x25c: @@ RemoveProperty(Stack[-1]); Obj=4 // @poff=1171
0x25d: Pop(1)
0x25e: Return(); Pop(2)
...
0x262: Stack[-1] = Stack[-5]
0x263: Pop(1)
0x264: @@ GetItemCount(Stack[-3], Stack[-9]); Obj=10 // @poff=882
0x265: Pop(0)
0x266: Stack[-2] = (int) 0
0x267: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x268: IF (Stack[-1] == 0) GOTO 0x271; Pop(1)

0x269: @@ GetItem(Stack[-1], Stack[-2], Stack[-9]); Obj=10 // @poff=895
0x26a: Pop(0)
0x26b: @@ add(Stack[-1]); Obj=4 // @poff=1070
0x26c: Pop(0)
0x26d: Stack[-1] = 0
0x26e: Push((int) 1)
...
0x276: Pop(0)
0x277: @@ GetItemCount(Stack[-3], Stack[-9]); Obj=10 // @poff=882
0x278: Pop(0)
0x279: Stack[-2] = (int) 0
0x27a: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x27b: IF (Stack[-1] == 0) GOTO 0x285; Pop(1)

0x27c: @@ IsItemSelected(Stack[-1], Stack[-2], Stack[-9]); Obj=10 // @poff=925
0x27d: Pop(0)
0x27e: Push(Stack[-1])
0x27f: IF (Stack[-1] == 0) GOTO 0x282; Pop(1)

0x280: @@ add(Stack[-2]); Obj=4 // @poff=1070
0x281: Pop(0)
0x282: Push((int) 1)
0x283: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x284: GOTO 0x27a

0x285: Stack[-4] = Stack[-11]
0x286: Return(); Pop(8)

0x287: Stack[-4] = 0
0x288: PushEmpty(int, int, object, bool, int, int, int, int, object, bool, int, int)
0x289: @@ RemoveAllItems(Stack[-15]); Obj=16 // @poff=32
0x28a: Pop(0)
0x28b: @@ size(Stack[-6]); Obj=14 // @poff=1074
0x28c: Pop(0)
0x28d: Stack[-5] = (int) 0
0x28e: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x28f: IF (Stack[-1] == 0) GOTO 0x298; Pop(1)

0x290: @@ get(Stack[-4], Stack[-5]); Obj=14 // @poff=1079
0x291: Pop(0)
0x292: @@ AddItem(Stack[-3], Stack[-4], Stack[-15]); Obj=16 // @poff=1186
0x293: Pop(0)
0x294: Stack[-4] = 0
0x295: Push((int) 1)
...
0x298: @@ size(Stack[-6]); Obj=13 // @poff=1074
0x299: Pop(0)
0x29a: Stack[-2] = (int) 0
0x29b: Pop(0); Push((bool) Stack[-2] < Stack[-6])
0x29c: IF (Stack[-1] == 0) GOTO 0x2a5; Pop(1)

0x29d: @@ get(Stack[-1], Stack[-2]); Obj=13 // @poff=1079
0x29e: Pop(0)
0x29f: Push((bool) 1)
0x2a0: @@ SelectItem(Stack[-2], Stack[-1], Stack[-16]); Obj=17 // @poff=1194
0x2a1: Pop(1)
0x2a2: Push((int) 1)
...
0x2a7: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=1205
0x2a8: Pop(0)
...
0x2c3: Stack[-2] = "noinv_drop" // @poff=1219
0x2c4: Stack[-1] = (int) -1
0x2c5: Call 0x2bb
...
0x2c9: Stack[-2] = "noinv_drop" // @poff=1219
0x2ca: Stack[-1] = (int) 1
0x2cb: Call 0x2bb
...
0x2cf: Stack[-2] = "nouse_container" // @poff=1241
0x2d0: Stack[-1] = (int) -1
0x2d1: Call 0x2bb
...
0x2d5: Stack[-2] = "nouse_container" // @poff=1241
0x2d6: Stack[-1] = (int) 1
0x2d7: Call 0x2bb
...
0x2f6: Stack[-2] = (int) 0
0x2f7: Push("all") // @poff=24
0x2f8: PushEmpty(string, int)
0x2f9: Stack[-5] = Stack[-1]
0x2fa: Call 0x2ee
...
0x304: Stack[-2] = Stack[-5]
0x305: Return(); Pop(4)

0x306: PushEmpty(float, float)
0x307: Pop(0); PushNull((bool) Stack[-3] == 0)
