...
Strings:
	...
	W:disease
	A:add
// @pool_raw:
...
Events:
EVENT_22 Op = 0x5ec Vars = (object, int, float, float)
EVENT_16 Op = 0x600 Vars = (object, string)
EVENT_41 Op = 0x60d Vars = (object)
...
0x509: @ CreateObjectSet(Stack[-1])
0x50a: Pop(0)
0x50b: Stack[-1] = Stack[-3]
0x50c: Return(); Pop(2)

0x50d: Stack[-1] = 0
0x50e: PushEmpty(string, string)
0x50f: Stack[-1] = "idle" // @poff=672
0x510: Push(Stack[-3])
0x511: IF (Stack[-1] == 0) GOTO 0x513; Pop(1)

0x512: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x513: Stack[-1] = Stack[-4]
0x514: Return(); Pop(2)

0x515: PushEmpty(int, bool, int, bool)
0x516: Stack[-2] = (int) 0
0x517: Push("all") // @poff=170
0x518: PushEmpty(string, int)
0x519: Stack[-5] = Stack[-1]
0x51a: Call 0x50e

0x51b: Pop(1)
0x51c: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x51d: Pop(2)
...
0x521: Push((int) 1)
0x522: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x523: GOTO 0x517

0x524: Stack[-2] = Stack[-5]
0x525: Return(); Pop(4)

0x526: PushEmpty(int, int, int, bool, int, int, int, bool)
0x527: Pop(0); Push((bool) Stack[-10] > Stack[-9])
0x528: IF (Stack[-1] == 0) GOTO 0x52d; Pop(1)

0x529: Push("GenerateMoney: iMin > iMax") // @poff=682
0x52a: @ Trace(Stack[-1])
0x52b: Pop(1)
0x52c: Return(); Pop(8)

0x52d: Stack[-4] = (int) 0
0x52e: Pop(0); Push((bool) Stack[-10] != Stack[-9])
0x52f: IF (Stack[-1] == 0) GOTO 0x534; Pop(1)

0x530: Pop(0); Push(Stack[-9] - Stack[-10]);
0x531: @ irand(Stack[-4], Stack[-1])
0x532: Pop(1)
0x533: GOTO 0x538

0x534: Push((int) 0)
0x535: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x536: IF (Stack[-1] == 0) GOTO 0x538; Pop(1)

0x537: Return(); Pop(8)

0x538: Stack[-4] = Stack[-4] + Stack[-10]; Pop(0);
0x539: Push((int) 0)
0x53a: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x53b: IF (Stack[-1] == 0) GOTO 0x53d; Pop(1)

0x53c: Return(); Pop(8)

0x53d: Push("Money") // @poff=736
0x53e: @ GetInvItemByName(Stack[-3], Stack[-1])
0x53f: Pop(1)
0x540: Push((int) 0)
0x541: @ AddItem(Stack[-2], Stack[-3], Stack[-1], Stack[-5])
0x542: Pop(1)
0x543: Return(); Pop(8)

0x544: PushEmpty(int, bool, int, bool)
0x545: Push((int) 0)
0x546: @ ClearSubContainer(Stack[-1])
0x547: Pop(1)
0x548: PushEmpty(int, int)
0x549: Stack[-2] = (int) 500
0x54a: Stack[-1] = (int) 1000
0x54b: Call 0x526

0x54c: Pop(2)
0x54d: Push((int) 4)
0x54e: @ irand(Stack[-3], Stack[-1])
0x54f: Pop(1)
0x550: Push((int) 0)
0x551: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0x552: IF (Stack[-1] == 0) GOTO 0x55a; Pop(1)

0x553: PushEmpty(int, string)
0x554: Stack[-1] = "rifle_ammo" // @poff=748
0x555: Call 0x569

0x556: Pop(1)
0x557: Push((int) 0)
0x558: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x559: Pop(2)
0x55a: Push((int) 3)
0x55b: @ irand(Stack[-3], Stack[-1])
0x55c: Pop(1)
0x55d: Push((int) 0)
0x55e: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x55f: IF (Stack[-1] == 0) GOTO 0x568; Pop(1)

0x560: PushEmpty(int, string)
0x561: Stack[-1] = "rusk" // @poff=770
0x562: Call 0x569

0x563: Pop(1)
0x564: Push((int) 0)
0x565: Push((int) 1)
0x566: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x567: Pop(3)
0x568: Return(); Pop(4)

0x569: PushEmpty(int, int)
0x56a: @ GetInvItemByName(Stack[-1], Stack[-3])
0x56b: Pop(0)
0x56c: Stack[-1] = Stack[-4]
0x56d: Return(); Pop(2)

0x56e: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x56f: Push(CvectorIndex(Stack[-11], 0))
0x570: Push(CvectorIndex(Stack[-12], 0))
0x571: Pop(2); Push(Stack[-2] * Stack[-1]);
0x572: Push(CvectorIndex(Stack[-12], 2))
0x573: Push(CvectorIndex(Stack[-13], 2))
0x574: Pop(2); Push(Stack[-2] * Stack[-1]);
0x575: Pop(2); Push(Stack[-2] + Stack[-1]);
0x576: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x577: Push(CvectorIndex(Stack[-11], 1))
0x578: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x579: Push(CvectorIndex(Stack[-13], 0))
0x57a: Push(CvectorIndex(Stack[-13], 0))
0x57b: Pop(2); Push(Stack[-2] - Stack[-1]);
0x57c: Push(CvectorIndex(Stack[-14], 0))
0x57d: Push(CvectorIndex(Stack[-14], 0))
0x57e: Pop(2); Push(Stack[-2] - Stack[-1]);
0x57f: Pop(2); Push(Stack[-2] * Stack[-1]);
0x580: Push(CvectorIndex(Stack[-14], 2))
0x581: Push(CvectorIndex(Stack[-14], 2))
0x582: Pop(2); Push(Stack[-2] - Stack[-1]);
0x583: Push(CvectorIndex(Stack[-15], 2))
0x584: Push(CvectorIndex(Stack[-15], 2))
0x585: Pop(2); Push(Stack[-2] - Stack[-1]);
0x586: Pop(2); Push(Stack[-2] * Stack[-1]);
0x587: Pop(2); Push(Stack[-2] + Stack[-1]);
0x588: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x589: Push((float)500.0)
0x58a: Pop(0); Push(Stack[-4] * Stack[-5]);
0x58b: Push(CvectorIndex(Stack[-14], 1))
0x58c: Push(CvectorIndex(Stack[-16], 1))
0x58d: Pop(2); Push(Stack[-2] - Stack[-1]);
0x58e: Pop(2); Push(Stack[-2] - Stack[-1]);
0x58f: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x590: Push((int) 0)
0x591: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x592: IF (Stack[-1] == 0) GOTO 0x595; Pop(1)

0x593: Stack[-14] = (int) -1
0x594: Return(); Pop(10)

0x595: Pop(0); Push(Stack[-3] / Stack[-5]);
0x596: Pop(0); Push(Sqrt(Stack[-3]))
0x597: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x598: Stack[-1] = Stack[-14]
0x599: Return(); Pop(10)
...
0x5ac: Stack[-2] = (int) 30
0x5ad: Return(); Pop(0)

0x5ae: Stack[-2] = (int) 700
0x5af: Return(); Pop(0)

0x5b0: PushEmpty()
0x5b1: Push((int) 10)
0x5b2: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x5b3: IF (Stack[-1] == 0) GOTO 0x5b7; Pop(1)

0x5b4: Stack[-3] = (int) 10
0x5b5: Return(); Pop(0)
...
0x5c0: Stack[-3] = Stack[-1]
0x5c1: Call 0x63f

0x5c2: Stack[-2] = Stack[-4]
0x5c3: Pop(2)
0x5c4: Return(); Pop(0)
...
0x5c8: Push(-1, 3); TaskCall(2)
0x5c9: Call 0x13f

0x5ca: Pop(-1, 3); TaskReturn
0x5cb: Pop(1)
0x5cc: Return(); Pop(0)

0x5cd: PushEmpty()
0x5ce: PushEmpty(bool, object)
0x5cf: Stack[-3] = Stack[-1]
0x5d0: Call 0x63f
...
0x5d7: Push(-1, 2); TaskCall(4)
0x5d8: Call 0x26f

0x5d9: Pop(-1, 2); TaskReturn
0x5da: Pop(1)
0x5db: @ ResetAAS()
0x5dc: Pop(0)
0x5dd: Return(); Pop(0)
...
0x5e5: Push(-1, 2); TaskCall(4)
0x5e6: Call 0x26f

0x5e7: Pop(-1, 2); TaskReturn
0x5e8: Pop(1)
0x5e9: @ ResetAAS()
0x5ea: Pop(0)
0x5eb: Return(); Pop(0)
...
0x5ec: PushEmpty()
0x5ed: PushEmpty(object, int, float)
0x5ee: Stack[-7] = Stack[-3]
0x5ef: Stack[-6] = Stack[-2]
0x5f0: Stack[-5] = Stack[-1]
0x5f1: Call 0x4b5
...
0x5f4: PushEmpty()
0x5f5: PushEmpty(object)
0x5f6: Stack[-2] = Stack[-1]
0x5f7: Call 0x672

0x5f8: Pop(1)
0x5f9: PushEmpty(object)
0x5fa: Stack[-2] = Stack[-1]
0x5fb: Push(-1, 0); TaskCall(1)
0x5fc: Call 0xac
...
0x601: Push("health") // @poff=780
0x602: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x603: IF (Stack[-1] == 0) GOTO 0x60c; Pop(1)

0x604: Push("health") // @poff=780
0x605: @ GetProperty(Stack[-1], Stack[-2])
0x606: Pop(1)
0x607: Push((int) 0)
0x608: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x609: IF (Stack[-1] == 0) GOTO 0x60c; Pop(1)

0x60a: @ SignalDeath(Stack[-4])
0x60b: Pop(0)
0x60c: Return(); Pop(2)
...
0x613: PushEmpty(string, bool, string, bool)
0x614: PushEmpty(bool, object, string)
0x615: Stack[-8] = Stack[-2]
0x616: Stack[-1] = "class" // @poff=794
0x617: Call 0x45c
...
0x61b: Stack[-7] = (bool) 0
0x61c: Return(); Pop(4)

0x61d: Push("class") // @poff=794
0x61e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=592
0x61f: Pop(1)
0x620: Push("bomber") // @poff=806
0x621: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0x622: IF (Stack[-1] == 0) GOTO 0x625; Pop(1)

0x623: Stack[-7] = (bool) 0
0x624: Return(); Pop(4)

0x625: @ CanSee(Stack[-1], Stack[-6])
0x626: Pop(0)
0x627: PushEmpty(bool)
0x628: Stack[-1] = (bool) 1
0x629: Push(Stack[-2])
0x62a: IF (Stack[-1] == 1) GOTO 0x633; Pop(1)

0x62b: PushEmpty(float, object)
0x62c: Stack[-9] = Stack[-1]
0x62d: Call 0x454

0x62e: Pop(1)
0x62f: Push((float)160000.0)
0x630: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x631: IF (Stack[-1] == 1) GOTO 0x633; Pop(1)

0x632: Stack[-1] = (bool) 0
0x633: IF (Stack[-1] == 0) GOTO 0x636; Pop(1)

0x634: Stack[-7] = (bool) 1
0x635: Return(); Pop(4)

0x636: Stack[-7] = (bool) 0
0x637: Return(); Pop(4)

0x638: Push(GlobalVars[0])
0x639: PushEmpty(object)
0x63a: Call 0x508

0x63b: Stack[-1] = Stack[-2]
0x63c: Pop(1)
0x63d: GlobalVars[0] = Stack[-1]; Pop(1)
0x63e: Return(); Pop(0)

0x63f: PushEmpty(bool, float, bool, bool, float, bool)
0x640: PushEmpty(bool, object)
0x641: Stack[-9] = Stack[-1]
0x642: Call 0x491
...
0x648: Push(GlobalVars[0])
0x649: @@ in(Stack[-4], Stack[-8]); Obj=1 // @poff=820
0x64a: Pop(1)
0x64b: Push(Stack[-3])
0x64c: IF (Stack[-1] == 0) GOTO 0x64f; Pop(1)

0x64d: Stack[-8] = (bool) 1
0x64e: Return(); Pop(6)

0x64f: PushEmpty(bool, object, string)
0x650: Stack[-10] = Stack[-2]
0x651: Stack[-1] = "disease" // @poff=823
0x652: Call 0x45c

0x653: Pop(2)
0x654: Pop(1); Push((bool) Stack[-1] == 0)
0x655: IF (Stack[-1] == 0) GOTO 0x658; Pop(1)

0x656: Stack[-8] = (bool) 0
0x657: Return(); Pop(6)

0x658: Push("disease") // @poff=823
0x659: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=592
0x65a: Pop(1)
0x65b: @ IsPlayerActor(Stack[-7], Stack[-1])
0x65c: Pop(0)
0x65d: Push(Stack[-1])
0x65e: IF (Stack[-1] == 0) GOTO 0x662; Pop(1)

0x65f: Push((float)0.0)
0x660: Stack[-9] = Stack[-3] > Stack[-1]; Pop(1);
0x661: Return(); Pop(6)

0x662: Push((float)0.75)
0x663: Stack[-9] = Stack[-3] > Stack[-1]; Pop(1);
0x664: Return(); Pop(6)

0x665: PushEmpty(bool, bool)
0x666: Pop(0); PushNull((bool) Stack[-3] == 0)
0x667: IF (Stack[-1] == 0) GOTO 0x669; Pop(1)

0x668: Return(); Pop(2)

0x669: Push(GlobalVars[0])
0x66a: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=820
0x66b: Pop(1)
0x66c: Pop(0); Push((bool) Stack[-1] == 0)
0x66d: IF (Stack[-1] == 0) GOTO 0x671; Pop(1)

0x66e: Push(GlobalVars[0])
0x66f: @@ add(Stack[-4]); Obj=1 // @poff=839
0x670: Pop(1)
0x671: Return(); Pop(2)
