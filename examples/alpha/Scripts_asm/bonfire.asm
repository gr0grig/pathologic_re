...
Strings:
	...
	A:AddSource
	A:Enable
// @pool_raw:62006f006e0066006900720065000000430061006e00270074002000660069006e0064002000660069007200650020007000610072007400690063006c0065002000730079007300740065006d000000416464536f7572636500456e61626c6500
...
0x10: Pop(0)
0x11: Push("bonfire") // @poff=0
0x12: @ FindParticleSystem(Stack[-1], Stack[-2])
0x13: Pop(1)
0x14: Pop(0); PushNull((bool) Stack[-1] == 0)
0x15: IF (Stack[-1] == 0) GOTO 0x1a; Pop(1)

0x16: Push("Can't find fire particle system") // @poff=16
0x17: @ Trace(Stack[-1])
0x18: Pop(1)
0x19: Return(); Pop(2)
...
0x1c: Push((float)0.0)
0x1d: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x1e: Pop(3)
0x1f: Push(CVector(10.0, 0.0, 0.0))
0x20: Push(CVector(0.0, 1.0, 0.0))
0x21: Push((float)0.0)
0x22: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x23: Pop(3)
0x24: Push(CVector(0.0, 0.0, 10.0))
0x25: Push(CVector(0.0, 1.0, 0.0))
0x26: Push((float)0.0)
0x27: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x28: Pop(3)
0x29: Push(CVector(-10.0, 0.0, 0.0))
0x2a: Push(CVector(0.0, 1.0, 0.0))
0x2b: Push((float)0.0)
0x2c: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x2d: Pop(3)
0x2e: Push(CVector(0.0, 0.0, -10.0))
0x2f: Push(CVector(0.0, 1.0, 0.0))
0x30: Push((float)0.0)
0x31: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x32: Pop(3)
0x33: Push(CVector(10.0, 0.0, 10.0))
0x34: Push(CVector(0.0, 1.0, 0.0))
0x35: Push((float)0.0)
0x36: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x37: Pop(3)
0x38: Push(CVector(-10.0, 0.0, -10.0))
0x39: Push(CVector(0.0, 1.0, 0.0))
0x3a: Push((float)0.0)
0x3b: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x3c: Pop(3)
0x3d: Push(CVector(-10.0, 0.0, 10.0))
0x3e: Push(CVector(0.0, 1.0, 0.0))
0x3f: Push((float)0.0)
0x40: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x41: Pop(3)
0x42: Push(CVector(10.0, 0.0, -10.0))
0x43: Push(CVector(0.0, 1.0, 0.0))
0x44: Push((float)0.0)
0x45: @@ AddSource(Stack[-3], Stack[-2], Stack[-1]); Obj=4 // @poff=80
0x46: Pop(3)
0x47: @@ Enable(); Obj=1 // @poff=90
0x48: Pop(0)
0x49: @ Hold()
0x4a: Pop(0)
0x4b: GOTO 0x49
