...
Strings:
	...
	W:Locator 
	W: doesn't exist
// @pool_raw:
...
0x1: Push("light") // @poff=0
0x2: @ GetProperty(Stack[-1], Stack[-2])
0x3: Pop(1)
0x4: @ FindActor(Stack[-1]T, Stack[-1])
0x5: Pop(0)
0x6: Push((bool) 1)
0x7: @@@ Switch(Stack[-1]); Obj=1 // @poff=12
0x8: Pop(1)
0x9: Push((bool) 1)
...
0x15: Pop(0)
0x16: Push("fire_loc") // @poff=19
0x17: @ GetProperty(Stack[-1], Stack[-2])
0x18: Pop(1)
0x19: PushEmpty(object, object, string, string, string)
0x1a: Stack[-7] = Stack[-4]
0x1b: Stack[-6] = Stack[-3]
0x1c: Stack[-2] = "scripted" // @poff=37
0x1d: Stack[-1] = "bonfire.xml" // @poff=55
0x1e: Call 0x61
...
0x24: Pop(0)
0x25: Push((bool) 0)
0x26: @@@ Switch(Stack[-1]); Obj=1 // @poff=12
0x27: Pop(1)
0x28: Return(); Pop(0)
