...
Strings:
	W:all
	W:idle
// @pool_raw:61006c006c000000690064006c0065000000
...
0x35: Pop(0)
0x36: Push("all") // @poff=0
0x37: PushEmpty(string, int)
0x38: Stack[-4] = Stack[-1]
0x39: Call 0x62
...
0x40: Push("all") // @poff=0
0x41: Push("idle") // @poff=8
