...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x385: PushEmpty()
0x386: Stack[-3] = (float) 0.05000000074505806
0x387: Return(); Pop(0)
...
0x66a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x66b: Pop(3)
0x66c: GOTO 0x6a1

0x66d: PushEmpty(string)
0x66e: Stack[-1] = "Neutral" // @poff=553
0x66f: Call 0x6bf

0x670: Pop(1)
0x671: Push((int) 14699)
0x672: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x673: Pop(1)
0x674: @@@ ClearReplies(); Obj=0 // @poff=580
0x675: Pop(0)
...
0x67e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x67f: Pop(3)
0x680: Push((int) 14707)
0x681: Push((int) -1)
0x682: Push((int) 15948)
0x683: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x684: Pop(3)
0x685: GOTO 0x6a1

0x686: PushEmpty(string)
0x687: Stack[-1] = "Neutral" // @poff=553
0x688: Call 0x6bf

0x689: Pop(1)
0x68a: Push((int) 14708)
0x68b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x68c: Pop(1)
0x68d: @@@ ClearReplies(); Obj=0 // @poff=580
0x68e: Pop(0)
0x68f: Push((int) 14709)
0x690: Push((int) 15951)
0x691: Push((int) 15950)
0x692: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x693: Pop(3)
0x694: Push((int) 14720)
0x695: Push((int) -1)
0x696: Push((int) 15963)
0x697: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x698: Pop(3)
0x699: Push((int) 14719)
0x69a: Push((int) -1)
0x69b: Push((int) 15962)
0x69c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x69d: Pop(3)
0x69e: GOTO 0x6a1
...
0x6b0: Push("all") // @poff=0
0x6b1: Push("idle") // @poff=8
...
0x6b9: Push("all") // @poff=0
0x6ba: Push("idle") // @poff=8
...
0x6e1: Stack[-1] = "Neutral" // @poff=553
0x6e2: Call 0x6bf

0x6e3: Pop(1)
0x6e4: Push((int) 13794)
0x6e5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6e6: Pop(1)
0x6e7: @@@ ClearReplies(); Obj=0 // @poff=580
0x6e8: Pop(0)
0x6e9: Push((int) 13795)
0x6ea: Push((int) -1)
0x6eb: Push((int) 15021)
0x6ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6ed: Pop(3)
0x6ee: Push((int) 13796)
0x6ef: Push((int) -1)
0x6f0: Push((int) 15022)
0x6f1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6f2: Pop(3)
0x6f3: Return(); Pop(0)

0x6f4: PushEmpty(string)
0x6f5: Stack[-1] = "Neutral" // @poff=553
0x6f6: Call 0x6bf

0x6f7: Pop(1)
0x6f8: Push((int) 14699)
0x6f9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6fa: Pop(1)
0x6fb: @@@ ClearReplies(); Obj=0 // @poff=580
0x6fc: Pop(0)
...
0x705: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x706: Pop(3)
0x707: Push((int) 14707)
0x708: Push((int) -1)
0x709: Push((int) 15948)
0x70a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x70b: Pop(3)
0x70c: Return(); Pop(0)

0x70d: PushEmpty(string)
0x70e: Stack[-1] = "Neutral" // @poff=553
0x70f: Call 0x6bf

0x710: Pop(1)
0x711: Push((int) 14708)
0x712: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x713: Pop(1)
0x714: @@@ ClearReplies(); Obj=0 // @poff=580
0x715: Pop(0)
0x716: Push((int) 14709)
0x717: Push((int) 15951)
0x718: Push((int) 15950)
0x719: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x71a: Pop(3)
0x71b: Push((int) 14720)
0x71c: Push((int) -1)
0x71d: Push((int) 15963)
0x71e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x71f: Pop(3)
0x720: Push((int) 14719)
0x721: Push((int) -1)
0x722: Push((int) 15962)
0x723: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x724: Pop(3)
0x725: Return(); Pop(0)
...
0x72a: Stack[-1] = "Neutral" // @poff=553
0x72b: Call 0x6bf

0x72c: Pop(1)
0x72d: Push((int) 14710)
0x72e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x72f: Pop(1)
0x730: @@@ ClearReplies(); Obj=0 // @poff=580
0x731: Pop(0)
0x732: Push((int) 14711)
0x733: Push((int) 15953)
0x734: Push((int) 15952)
0x735: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x736: Pop(3)
0x737: Push((int) 14718)
0x738: Push((int) 15955)
0x739: Push((int) 15960)
0x73a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x73b: Pop(3)
0x73c: Return(); Pop(0)
...
0x741: Stack[-1] = "Neutral" // @poff=553
0x742: Call 0x6bf

0x743: Pop(1)
0x744: Push((int) 14712)
0x745: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x746: Pop(1)
0x747: @@@ ClearReplies(); Obj=0 // @poff=580
0x748: Pop(0)
0x749: Push((int) 14713)
0x74a: Push((int) 15955)
0x74b: Push((int) 15954)
0x74c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x74d: Pop(3)
0x74e: Push((int) 14717)
0x74f: Push((int) 15955)
0x750: Push((int) 15958)
0x751: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x752: Pop(3)
0x753: Return(); Pop(0)
...
0x758: Stack[-1] = "Neutral" // @poff=553
0x759: Call 0x6bf

0x75a: Pop(1)
0x75b: Push((int) 14714)
0x75c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x75d: Pop(1)
0x75e: @@@ ClearReplies(); Obj=0 // @poff=580
0x75f: Pop(0)
0x760: Push((int) 14715)
0x761: Push((int) -1)
0x762: Push((int) 15956)
0x763: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x764: Pop(3)
0x765: Push((int) 14716)
0x766: Push((int) -1)
0x767: Push((int) 15957)
0x768: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x769: Pop(3)
0x76a: Return(); Pop(0)
...
0x76f: Stack[-1] = "Neutral" // @poff=553
0x770: Call 0x6bf

0x771: Pop(1)
0x772: Push((int) 14701)
0x773: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x774: Pop(1)
0x775: @@@ ClearReplies(); Obj=0 // @poff=580
0x776: Pop(0)
0x777: Push((int) 14702)
0x778: Push((int) 15943)
0x779: Push((int) 15942)
0x77a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x77b: Pop(3)
0x77c: Push((int) 14706)
0x77d: Push((int) 15943)
0x77e: Push((int) 15946)
0x77f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x780: Pop(3)
0x781: Return(); Pop(0)
...
0x786: Stack[-1] = "Neutral" // @poff=553
0x787: Call 0x6bf

0x788: Pop(1)
0x789: Push((int) 14703)
0x78a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x78b: Pop(1)
0x78c: @@@ ClearReplies(); Obj=0 // @poff=580
0x78d: Pop(0)
0x78e: Push((int) 14705)
0x78f: Push((int) -1)
0x790: Push((int) 15945)
0x791: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x792: Pop(3)
0x793: Push((int) 14704)
0x794: Push((int) -1)
0x795: Push((int) 15944)
0x796: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x797: Pop(3)
0x798: Return(); Pop(0)
...
0x7aa: Stack[-2] = "fire" // @poff=602
0x7ab: Return(); Pop(0)

0x7ac: Stack[-2] = "phys" // @poff=612
0x7ad: Return(); Pop(0)

0x7ae: PushEmpty(cvector, cvector, cvector, cvector)
0x7af: @ GetPosition(Stack[-2])
0x7b0: Pop(0)
0x7b1: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x7b2: Pop(0)
0x7b3: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x7b4: Return(); Pop(4)

0x7b5: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x7b6: @ GetPosition(Stack[-3])
0x7b7: Pop(0)
0x7b8: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x7b9: Pop(0)
0x7ba: Stack[-1] = Stack[-2] - Stack[-3]; Pop(0);
0x7bb: Stack[-8] = Stack[-1] | Stack[-1]; Pop(0);
0x7bc: Return(); Pop(6)

0x7bd: PushEmpty(bool, bool)
0x7be: Push("HasProperty") // @poff=622
0x7bf: Push((int) 2)
0x7c0: Pop(2); Push(IsFuncExist(Stack[-6], Stack[-2], Stack[-1]))
...
0x7c5: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x7c6: Pop(0)
0x7c7: Stack[-1] = Stack[-5]
0x7c8: Return(); Pop(2)

0x7c9: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x7ca: PushEmpty(bool, object, string)
0x7cb: Stack[-18] = Stack[-2]
0x7cc: Stack[-1] = "health" // @poff=658
0x7cd: Call 0x7bd
...
0x7d4: Stack[-18] = Stack[-2]
0x7d5: Stack[-1] = "armor" // @poff=672
0x7d6: Call 0x7bd
...
0x7dc: Push("armor") // @poff=672
0x7dd: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x7de: Pop(1)
0x7df: Push("armor_") // @poff=696
0x7e0: PushEmpty(string, int)
0x7e1: Stack[-16] = Stack[-1]
0x7e2: Call 0x7a6

0x7e3: Pop(1)
0x7e4: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x7e5: PushEmpty(bool, object, string)
0x7e6: Stack[-18] = Stack[-2]
0x7e7: Stack[-8] = Stack[-1]
0x7e8: Call 0x7bd
...
0x7ee: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x7ef: Pop(0)
0x7f0: PushEmpty(float, float, float)
0x7f1: Pop(0); Push(Stack[-9] + Stack[-7]);
0x7f2: Push((float)100.0)
0x7f3: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x7f4: Stack[-1] = (int) 1
0x7f5: Call 0x93b

0x7f6: Stack[-3] = Stack[-6]
0x7f7: Pop(3)
0x7f8: Push("health") // @poff=658
0x7f9: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x7fa: Pop(1)
0x7fb: Push((int) 1)
0x7fc: Pop(1); Push(Stack[-1] - Stack[-4]);
0x7fd: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x7fe: Push("health") // @poff=658
0x7ff: PushEmpty(float, float, float, float)
0x800: Stack[-3] = Stack[-7] - Stack[-6]; Pop(0);
0x801: Stack[-2] = (int) 0
0x802: Stack[-1] = (int) 1
0x803: Call 0x942

0x804: Pop(3)
0x805: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x806: Pop(2)
0x807: Stack[-1] = Stack[-16]
0x808: Return(); Pop(12)

0x809: PushEmpty(bool, bool)
0x80a: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x80b: Pop(0)
0x80c: Stack[-1] = Stack[-4]
0x80d: Return(); Pop(2)

0x80e: PushEmpty(object, object, object, object)
0x80f: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x815: Push("IsDead") // @poff=729
0x816: Push((int) 1)
0x817: Pop(2); Push(IsFuncExist(Stack[-8], Stack[-2], Stack[-1]))
0x818: IF (Stack[-1] == 0) GOTO 0x81f; Pop(1)

0x819: PushEmpty(bool, object)
0x81a: Stack[-8] = Stack[-1]
0x81b: Call 0x809
...
0x823: Pop(0)
0x824: Pop(0); PushNull((bool) Stack[-2] == 0)
0x825: IF (Stack[-1] == 0) GOTO 0x828; Pop(1)

0x826: Stack[-6] = (bool) 0
0x827: Return(); Pop(4)

0x828: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x829: Pop(0)
...
0x83c: Stack[-6] = Stack[-2]
0x83d: Stack[-1] = "noaccess" // @poff=752
0x83e: Call 0x7bd
...
0x844: Push("noaccess") // @poff=752
0x845: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x846: Pop(1)
0x847: Push((int) 0)
0x848: Stack[-5] = Stack[-2] == Stack[-1]; Pop(1);
0x849: Return(); Pop(2)
...
0x85a: Pop(0)
0x85b: Push(CvectorIndex(Stack[-8], 1))
0x85c: Push((int) 2)
0x85d: Pop(1); Push(Stack[-9] / Stack[-1]);
0x85e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x85f: CvectorIndex(Stack[-9], 1) = Stack[-1];
0x860: Push("scripted") // @poff=770
0x861: Push(CVector(0.0, 0.0, 1.0))
0x862: Push("blood.xml") // @poff=788
0x863: @ AddActorByType(Stack[-12], Stack[-3], Stack[-13], Stack[-11], Stack[-2], Stack[-1])
0x864: Pop(3)
0x865: Stack[-9] = 0
0x866: Stack[-10] = 0
0x867: Pop(0); PushNull((bool) Stack[-23] == 0)
...
0x870: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x871: Pop(0)
0x872: @ GetPosition(Stack[-4])
0x873: Pop(0)
0x874: @ GetDirection(Stack[-3])
0x875: Pop(0)
0x876: Stack[-2] = Stack[-4] - Stack[-5]; Pop(0);
0x877: Push(CvectorIndex(Stack[-2], 0))
0x878: Push(CvectorIndex(Stack[-4], 0))
0x879: Pop(2); Push(Stack[-2] * Stack[-1]);
0x87a: Push(CvectorIndex(Stack[-3], 2))
...
0x881: Stack[-1] = "fhit" // @poff=808
0x882: GOTO 0x884

0x883: Stack[-1] = "bhit" // @poff=818
0x884: Push("hit_react") // @poff=828
0x885: Push("1") // @poff=848
0x886: Pop(1); Push(Stack[-3] + Stack[-1]);
0x887: Push("2") // @poff=852
...
0x88e: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x88f: Pop(0)
0x890: @ GetPosition(Stack[-2])
0x891: Pop(0)
0x892: Stack[-1] = Stack[-3] - Stack[-2]; Pop(0);
0x893: Push(CvectorIndex(Stack[-1], 0))
0x894: Push(CvectorIndex(Stack[-2], 2))
...
0x89e: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x89f: Pop(0)
0x8a0: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x8a1: Pop(0)
0x8a2: Push(CvectorIndex(Stack[-7], 1))
0x8a3: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x8a4: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x8a5: @ GetPosition(Stack[-6])
0x8a6: Pop(0)
0x8a7: @ GetEyesHeight(Stack[-8])
0x8a8: Pop(0)
0x8a9: Push(CvectorIndex(Stack[-6], 1))
0x8aa: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x8ab: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x8ac: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x8ad: Push(CvectorIndex(Stack[-5], 1))
0x8ae: Stack[-1] = (int) 0
0x8af: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x8b0: Pop(0); Push(Stack[-5] | Stack[-5]);
0x8b1: Pop(1); Push(Sqrt(Stack[-1]))
0x8b2: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x8b3: Stack[-4] = -Stack[-5]; Pop(0);
0x8b4: Push((int) 70)
0x8b5: Pop(1); Push(Stack[-6] * Stack[-1]);
0x8b6: PushEmpty(cvector, cvector)
0x8b7: Push(CVector(0.0, 1.0, 0.0))
0x8b8: Stack[-2] = Stack[-8] ^ Stack[-1]; Pop(1);
0x8b9: Call 0x931

0x8ba: Pop(1)
0x8bb: Push((int) 25)
0x8bc: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8bd: Pop(2); Push(Stack[-2] + Stack[-1]);
0x8be: Push(CVector(0.0, 10.0, 0.0))
0x8bf: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x8c0: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
...
0x8ca: Pop(0)
0x8cb: Push(CvectorIndex(Stack[-3], 0))
0x8cc: Push(CvectorIndex(Stack[-4], 2))
...
0x8da: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x8db: Pop(0)
0x8dc: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x8dd: Pop(0)
0x8de: Push(CvectorIndex(Stack[-7], 1))
0x8df: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x8e0: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x8e1: @ GetPosition(Stack[-6])
0x8e2: Pop(0)
0x8e3: @ GetEyesHeight(Stack[-8])
0x8e4: Pop(0)
0x8e5: Push(CvectorIndex(Stack[-6], 1))
0x8e6: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x8e7: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x8e8: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x8e9: Push(CvectorIndex(Stack[-5], 1))
0x8ea: Stack[-1] = (int) 0
0x8eb: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x8ec: Pop(0); Push(Stack[-5] | Stack[-5]);
0x8ed: Pop(1); Push(Sqrt(Stack[-1]))
0x8ee: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x8ef: Stack[-4] = -Stack[-5]; Pop(0);
0x8f0: Push((int) 70)
0x8f1: Pop(1); Push(Stack[-6] * Stack[-1]);
0x8f2: Push(CVector(0.0, 10.0, 0.0))
0x8f3: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x8f4: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
...
0x8fe: Pop(0)
0x8ff: Push(CvectorIndex(Stack[-3], 0))
0x900: Push(CvectorIndex(Stack[-4], 2))
...
0x90e: Push("playing ") // @poff=856
0x90f: Pop(1); Push(Stack[-1] + Stack[-6]);
0x910: @ Trace(Stack[-1])
0x911: Pop(1)
...
0x915: Pop(0)
0x916: Push("start: ") // @poff=874
0x917: Pop(1); Push(Stack[-1] + Stack[-3]);
0x918: @ Trace(Stack[-1])
0x919: Pop(1)
0x91a: Push("end: ") // @poff=890
0x91b: Pop(1); Push(Stack[-1] + Stack[-2]);
0x91c: @ Trace(Stack[-1])
0x91d: Pop(1)
0x91e: Return(); Pop(4)

0x91f: PushEmpty(float, cvector, float, cvector)
0x920: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x921: Pop(0)
0x922: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x923: Push(CvectorIndex(Stack[-1], 1))
0x924: Stack[-3] = Stack[-1]
0x925: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x926: Push("head") // @poff=178
...
0x932: Pop(0); Push(Stack[-3] | Stack[-3]);
0x933: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x934: Push((float)9.999999974752427e-07)
...
0x939: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x93a: Return(); Pop(2)
...
0x945: Stack[-2] = Stack[-4]
0x946: Return(); Pop(0)

0x947: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x948: IF (Stack[-1] == 0) GOTO 0x94b; Pop(1)

0x949: Stack[-1] = Stack[-4]
0x94a: Return(); Pop(0)

0x94b: Stack[-3] = Stack[-4]
0x94c: Return(); Pop(0)

0x94d: PushEmpty()
0x94e: Push(CvectorIndex(Stack[-2], 0))
0x94f: Push(CvectorIndex(Stack[-2], 0))
0x950: Pop(2); Push(Stack[-2] * Stack[-1]);
0x951: Push(CvectorIndex(Stack[-3], 2))
0x952: Push(CvectorIndex(Stack[-3], 2))
0x953: Pop(2); Push(Stack[-2] * Stack[-1]);
0x954: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x955: Return(); Pop(0)

0x956: PushEmpty()
0x957: Push(CvectorIndex(Stack[-1], 0))
0x958: Push(CvectorIndex(Stack[-2], 0))
0x959: Pop(2); Push(Stack[-2] * Stack[-1]);
0x95a: Push(CvectorIndex(Stack[-2], 2))
0x95b: Push(CvectorIndex(Stack[-3], 2))
0x95c: Pop(2); Push(Stack[-2] * Stack[-1]);
0x95d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x95e: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x95f: Return(); Pop(0)

0x960: PushEmpty()
0x961: PushEmpty(float, cvector, cvector)
0x962: Stack[-5] = Stack[-2]
...
0x96b: Stack[-5] = Stack[-1]
0x96c: Call 0x956

0x96d: Pop(1)
0x96e: Pop(2); Push(Stack[-2] * Stack[-1]);
0x96f: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x970: Return(); Pop(0)
...
0x97a: PushEmpty(int)
0x97b: Push((int) 24)
0x97c: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x97d: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x97e: Return(); Pop(2)

0x97f: PushEmpty()
0x980: PushEmpty(object)
0x981: Stack[-2] = Stack[-1]
0x982: Push(-1, 0); TaskCall(1)
0x983: Call 0x16
...
0x99c: Stack[-7] = Stack[-3]
0x99d: Stack[-6] = Stack[-2]
...
0x9a3: Stack[-1] = "idle" // @poff=8
0x9a4: Push(Stack[-3])
0x9a5: IF (Stack[-1] == 0) GOTO 0x9a7; Pop(1)

0x9a6: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x9a7: Stack[-1] = Stack[-4]
0x9a8: Return(); Pop(2)

0x9a9: PushEmpty(int, bool, int, bool)
0x9aa: Stack[-2] = (int) 0
0x9ab: Push("all") // @poff=0
...
0x9b1: Pop(2)
0x9b2: Pop(0); Push((bool) Stack[-1] == 0)
0x9b3: IF (Stack[-1] == 0) GOTO 0x9b5; Pop(1)

0x9b4: GOTO 0x9b8

0x9b5: Push((int) 1)
0x9b6: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x9b7: GOTO 0x9ab
...
0x9c6: Push(-1, 1); TaskCall(4)
0x9c7: Call 0x29b

0x9c8: Pop(-1, 1); TaskReturn
0x9c9: Pop(1)
0x9ca: Return(); Pop(0)
...
0x9d7: Stack[-2] = Stack[-1]
0x9d8: Push(-1, 5); TaskCall(5)
0x9d9: Call 0x37d

0x9da: Pop(-1, 5); TaskReturn
0x9db: Pop(1)
0x9dc: Return(); Pop(0)
...
0xa27: PushEmpty()
0xa28: Push((int) 1000)
0xa29: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=916
0xa2a: Pop(1)
0xa2b: Return(); Pop(0)
...
0xa4c: Push("GenerateMoney: iMin > iMax") // @poff=967
0xa4d: @ Trace(Stack[-1])
0xa4e: Pop(1)
0xa4f: Return(); Pop(8)
...
0xa53: Pop(0); Push(Stack[-9] - Stack[-10]);
...
0xa5b: Stack[-4] = Stack[-4] + Stack[-10]; Pop(0);
0xa5c: Push((int) 0)
...
0xa70: Pop(0)
0xa71: Push((int) 30)
0xa72: Pop(2); Push(Stack[-2] * Stack[-1]);
0xa73: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0xa74: Call 0xa49
...
0xa82: Stack[-1] = "bandage" // @poff=1033
0xa83: Call 0xa98
...
0xa90: Stack[-1] = "tourniquet" // @poff=1049
0xa91: Call 0xa98
...
0xa9f: Stack[-1] = "ui/NPC_None.png" // @poff=1071
0xaa0: Return(); Pop(0)
...
0xaa5: GlobalVars[1] = Stack[-1]; Pop(1)
0xaa6: PushEmpty()
0xaa7: Call 0xa77
...
0xaae: Pop(0)
0xaaf: Pop(0); Push((bool) Stack[-1] == 0)
...
0xab7: Stack[-6] = Stack[-1]
0xab8: Push(-2, 1); TaskCall(7)
0xab9: Call 0x614
...
0xabf: Stack[-5] = Stack[-1]
0xac0: Call 0x8d9

0xac1: Pop(1)
0xac2: Pop(1); Push((bool) Stack[-1] == 0)
0xac3: IF (Stack[-1] == 0) GOTO 0xac5; Pop(1)

0xac4: Return(); Pop(2)

0xac5: PushEmpty(object)
0xac6: Stack[-4] = Stack[-1]
0xac7: Push(-1, 1); TaskCall(0)
0xac8: Call 0x0

0xac9: Pop(-1, 1); TaskReturn
0xaca: Pop(1)
0xacb: PushEmpty(object)
0xacc: Stack[-4] = Stack[-1]
0xacd: Call 0x909
...
0xad7: Stack[-8] = Stack[-2]
0xad8: Stack[-1] = "class" // @poff=1103
0xad9: Call 0x7bd

0xada: Pop(2)
0xadb: Pop(1); Push((bool) Stack[-1] == 0)
0xadc: IF (Stack[-1] == 0) GOTO 0xadf; Pop(1)

0xadd: Stack[-7] = (bool) 0
0xade: Return(); Pop(4)

0xadf: Push("class") // @poff=1103
0xae0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=684
0xae1: Pop(1)
0xae2: Push("rat") // @poff=1115
...
0xb06: GlobalVars[1] = Stack[-1]; Pop(1)
0xb07: Push((int) 50)
0xb08: Push((int) 40)
