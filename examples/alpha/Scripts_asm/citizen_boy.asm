...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0xa20: PushEmpty()
0xa21: Push((int) 1000)
0xa22: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=902
0xa23: Pop(1)
0xa24: Return(); Pop(0)

0xa25: PushEmpty(int, int)
0xa26: Push("player") // @poff=917
...
0xa39: Push("GenerateMoney: iMin > iMax") // @poff=931
0xa3a: @ Trace(Stack[-1])
0xa3b: Pop(1)
0xa3c: Return(); Pop(8)
...
0xa8d: Stack[-1] = "alpha_pills" // @poff=1019
0xa8e: Call 0xaca
...
0xa9a: Stack[-1] = "meradorm" // @poff=1043
0xa9b: Call 0xaca
...
0xaa8: Stack[-1] = "lockpick" // @poff=1061
0xaa9: Call 0xaca
...
0xab6: Stack[-1] = "rifle_ammo" // @poff=1079
0xab7: Call 0xaca
...
0xac3: Stack[-1] = "revolver_ammo" // @poff=1101
0xac4: Call 0xaca
...
0xad1: Stack[-1] = "ui/NPC_None.png" // @poff=1129
0xad2: Return(); Pop(0)
...
0xb0f: Push("class") // @poff=1161
0xb10: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=684
0xb11: Pop(1)
0xb12: Push("rat") // @poff=1173
