...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x6c: @ StopAsync()
0x6d: Pop(0)
0x6e: Push("head") // @poff=160
0x6f: @ UnlookAsync(Stack[-1])
0x70: Pop(1)
0x71: Push("all") // @poff=170
...
0x82: Pop(0)
0x83: Push("all") // @poff=170
0x84: @ PlayAnimation(Stack[-1], Stack[-2])
0x85: Pop(1)
0x86: @ WaitForAnimEnd()
0x87: Pop(0)
0x88: Push("all") // @poff=170
...
0xd6: Stack[-7] = Stack[-2]
0xd7: Stack[-6] = Stack[-1]
0xd8: Call 0x883
...
0x104: Stack[-6] = Stack[-2]
0x105: Stack[-7] = Stack[-1]
0x106: Call 0x808

0x107: Stack[-3] = Stack[-4]
0x108: Pop(3)
0x109: Push((int) 0)
...
0x1f2: Stack[-7] = Stack[-2]
0x1f3: Stack[-6] = Stack[-1]
0x1f4: Call 0x883
...
0x221: Stack[-7] = Stack[-1]
0x222: Call 0x808

0x223: Stack[-3] = Stack[-4]
0x224: Pop(3)
0x225: Push((int) 0)
...
0x2ba: Push("all") // @poff=170
0x2bb: Push("dattack_begin") // @poff=178
...
0x2cb: Stack[-6] = Stack[-2]
0x2cc: Stack[-1] = (float) 0.20000000298023224
0x2cd: Call 0x6b0

0x2ce: Pop(3)
0x2cf: Push("all") // @poff=170
0x2d0: Push("dattack_end") // @poff=206
...
0x30d: Stack[-6] = Stack[-8]
0x30e: Pop(6)
0x30f: Return(); Pop(0)

0x310: Stack[-1] = "zwalk" // @poff=230
0x311: Return(); Pop(0)
...
0x315: Stack[-17] = Stack[-7]
0x316: PushEmpty(bool, object)
0x317: Stack[-23] = Stack[-1]
0x318: Call 0x39e
...
0x31e: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x31f: Pop(0)
...
0x335: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=242
0x336: Pop(0)
...
0x347: Push((int) 0)
0x348: Push((float)0.30000001192092896)
...
0x36a: Push((int) 0)
0x36b: Push((float)0.30000001192092896)
...
0x3a0: Stack[-3] = Stack[-1]
0x3a1: Call 0x718

0x3a2: Stack[-2] = Stack[-4]
0x3a3: Pop(2)
0x3a4: Return(); Pop(0)

0x3a5: Stack[-1] = "run" // @poff=256
0x3a6: Return(); Pop(0)

0x3a7: PushEmpty()
0x3a8: PushEmpty(object, bool, float)
0x3a9: Stack[-4] = Stack[-3]
...
0x3af: PushEmpty()
0x3b0: Stack[-3] = (float) 0.029999999329447746
0x3b1: Return(); Pop(0)
...
0x3b7: Push("all") // @poff=170
0x3b8: Push("attack_begin") // @poff=180
0x3b9: Push((int) 1)
0x3ba: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3c5: Push("attack") // @poff=264
0x3c6: Push((int) 1)
0x3c7: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3e2: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x3e3: Pop(0)
0x3e4: Push(Stack[-22])
...
0x3f4: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=242
0x3f5: Pop(0)
...
0x418: Pop(1)
0x419: Push("all") // @poff=170
0x41a: Push("attack_on") // @poff=334
...
0x426: Push((float)0.6000000238418579)
0x427: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x428: IF (Stack[-1] == 1) GOTO 0x42e; Pop(1)
...
0x43c: @ Face(Stack[-0]T)
0x43d: Pop(0)
0x43e: Push("all") // @poff=170
0x43f: Push("fjump") // @poff=378
...
0x457: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=242
0x458: Pop(0)
...
0x476: Push("all") // @poff=170
0x477: Push("attack_off") // @poff=390
...
0x483: Push((float)0.8999999761581421)
0x484: Pop(1); Push(Stack[-9] * Stack[-1]);
0x485: @ GetVictim(Stack[-1], Stack[-4])
0x486: Pop(1)
0x487: @ ReportAttack(Stack[-0]T)
0x488: Pop(0)
...
0x48c: Stack[-6] = Stack[-2]
0x48d: Stack[-10] = Stack[-1]
0x48e: Call 0x3af

0x48f: Stack[-3] = Stack[-5]
0x490: Pop(3)
0x491: PushEmpty(float, object, float, int)
0x492: Stack[-7] = Stack[-3]
0x493: Stack[-6] = Stack[-2]
0x494: PushEmpty(int, object, int)
0x495: Stack[-10] = Stack[-2]
0x496: Stack[-14] = Stack[-1]
0x497: Call 0x3b2

0x498: Stack[-3] = Stack[-4]
0x499: Pop(3)
0x49a: Call 0x670

0x49b: Stack[-4] = Stack[-5]
0x49c: Pop(4)
0x49d: PushEmpty(int)
0x49e: Call 0x598

0x49f: Pop(0)
0x4a0: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x4a1: Pop(1)
0x4a2: PushEmpty(object, float)
0x4a3: Stack[-5] = Stack[-2]
...
0x4b2: Pop(1)
0x4b3: Push("all") // @poff=170
0x4b4: Push("attack_begin") // @poff=180
...
0x4c8: Stack[-7] = Stack[-2]
0x4c9: Stack[-4] = Stack[-1]
0x4ca: Call 0x482

0x4cb: Pop(2)
0x4cc: Push("all") // @poff=170
0x4cd: Push("attack_middle") // @poff=412
...
0x4d3: Push("all") // @poff=170
0x4d4: Push("attack_middle") // @poff=412
...
0x4eb: Pop(1)
0x4ec: Push("all") // @poff=170
0x4ed: Push("attack_end") // @poff=208
...
0x525: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=242
0x526: Pop(0)
...
0x55b: @ Face(Stack[-0]T)
0x55c: Pop(0)
0x55d: Push("all") // @poff=170
0x55e: Push("bjump") // @poff=440
0x55f: @ PlayAnimation(Stack[-2], Stack[-1])
0x560: Pop(2)
0x561: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=242
0x562: Pop(0)
...
0x58b: @ irand(Stack[-1], Stack[-2]T)
0x58c: Pop(0)
0x58d: Push((int) 1)
0x58e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x58f: Push("attack") // @poff=264
...
0x5b3: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x5b4: Pop(0)
...
0x5ca: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=242
0x5cb: Pop(0)
...
0x63a: Stack[-1] = "walk" // @poff=232
0x63b: Return(); Pop(0)

0x63c: Stack[-1] = "run" // @poff=256
0x63d: Return(); Pop(0)
...
0x642: Stack[-2] = "fire" // @poff=488
0x643: Return(); Pop(0)

0x644: Stack[-2] = "phys" // @poff=498
0x645: Return(); Pop(0)

0x646: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x647: @ GetPosition(Stack[-3])
0x648: Pop(0)
0x649: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x64a: Pop(0)
...
0x64f: Push("HasProperty") // @poff=508
0x650: Push((int) 2)
...
0x656: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=532
0x657: Pop(0)
0x658: Stack[-1] = Stack[-5]
0x659: Return(); Pop(2)

0x65a: PushEmpty(float, float)
0x65b: PushEmpty(bool, object, string)
0x65c: Stack[-10] = Stack[-2]
0x65d: Stack[-9] = Stack[-1]
0x65e: Call 0x64e
...
0x664: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=544
0x665: Pop(0)
0x666: PushEmpty(float, float, float, float)
0x667: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x668: Stack[-8] = Stack[-2]
0x669: Stack[-7] = Stack[-1]
0x66a: Call 0x78a

0x66b: Pop(3)
0x66c: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=556
0x66d: Pop(1)
...
0x672: Stack[-18] = Stack[-2]
0x673: Stack[-1] = "health" // @poff=568
0x674: Call 0x64e
...
0x67b: Stack[-18] = Stack[-2]
0x67c: Stack[-1] = "armor" // @poff=582
0x67d: Call 0x64e
...
0x683: Push("armor") // @poff=582
0x684: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=544
0x685: Pop(1)
0x686: Push("armor_") // @poff=594
0x687: PushEmpty(string, int)
0x688: Stack[-16] = Stack[-1]
0x689: Call 0x63e

0x68a: Pop(1)
0x68b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x68c: PushEmpty(bool, object, string)
0x68d: Stack[-18] = Stack[-2]
0x68e: Stack[-8] = Stack[-1]
0x68f: Call 0x64e
...
0x695: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=544
0x696: Pop(0)
...
0x69d: Stack[-3] = Stack[-6]
0x69e: Pop(3)
0x69f: Push("health") // @poff=568
0x6a0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=544
0x6a1: Pop(1)
0x6a2: Push((int) 1)
0x6a3: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6a4: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6a5: Push("health") // @poff=568
...
0x6ab: Pop(3)
0x6ac: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=556
0x6ad: Pop(2)
0x6ae: Stack[-1] = Stack[-16]
0x6af: Return(); Pop(12)

0x6b0: PushEmpty(int, float, float, int, float, float)
0x6b1: PushEmpty(bool, object, string)
0x6b2: Stack[-11] = Stack[-2]
0x6b3: Stack[-1] = "disease" // @poff=608
0x6b4: Call 0x64e
...
0x6bc: Stack[-1] = "armor_disease" // @poff=624
0x6bd: Call 0x64e

0x6be: Pop(2)
0x6bf: IF (Stack[-1] == 0) GOTO 0x6ce; Pop(1)

0x6c0: Push("armor_disease") // @poff=624
0x6c1: @@ GetProperty(Stack[-1], Stack[-4]); Obj=9 // @poff=544
0x6c2: Pop(1)
0x6c3: Push((int) 100)
...
0x6cf: Stack[-11] = Stack[-2]
0x6d0: Stack[-1] = "immunity" // @poff=652
0x6d1: Call 0x64e

0x6d2: Pop(2)
0x6d3: IF (Stack[-1] == 0) GOTO 0x6e5; Pop(1)

0x6d4: Push("immunity") // @poff=652
0x6d5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=9 // @poff=544
0x6d6: Pop(1)
0x6d7: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x6d8: IF (Stack[-1] == 0) GOTO 0x6df; Pop(1)

0x6d9: Push("immunity") // @poff=652
0x6da: Push((int) 0)
0x6db: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=556
0x6dc: Pop(2)
0x6dd: Stack[-2] = Stack[-7] - Stack[-1]; Pop(0);
0x6de: GOTO 0x6e5

0x6df: Push("immunity") // @poff=652
0x6e0: Pop(0); Push(Stack[-2] - Stack[-8]);
0x6e1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=556
0x6e2: Pop(2)
0x6e3: Stack[-7] = Stack[-9]
0x6e4: Return(); Pop(6)

0x6e5: PushEmpty(bool, object, string, float, float, float)
0x6e6: Stack[-14] = Stack[-5]
0x6e7: Stack[-4] = "disease" // @poff=608
0x6e8: Stack[-8] = Stack[-3]
0x6e9: Stack[-2] = (int) 0
0x6ea: Stack[-1] = (int) 1
0x6eb: Call 0x65a

0x6ec: Pop(6)
0x6ed: Stack[-7] = Stack[-9]
0x6ee: Return(); Pop(6)

0x6ef: PushEmpty(bool, bool)
0x6f0: @@ IsDead(Stack[-1]); Obj=3 // @poff=670
0x6f1: Pop(0)
0x6f2: Stack[-1] = Stack[-4]
0x6f3: Return(); Pop(2)

0x6f4: PushEmpty(object, object, object, object)
0x6f5: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x709: Pop(0)
0x70a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x70b: IF (Stack[-1] == 0) GOTO 0x70e; Pop(1)

0x70c: Stack[-6] = (bool) 0
0x70d: Return(); Pop(4)

0x70e: @@ GetScene(Stack[-1]); Obj=5 // @poff=691
0x70f: Pop(0)
...
0x722: Stack[-6] = Stack[-2]
0x723: Stack[-1] = "noaccess" // @poff=700
0x724: Call 0x64e
...
0x72a: Push("noaccess") // @poff=700
0x72b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=544
0x72c: Pop(1)
0x72d: Push((int) 0)
...
0x756: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x757: Pop(0)
...
0x767: Stack[-1] = "fhit" // @poff=756
0x768: GOTO 0x76a

0x769: Stack[-1] = "bhit" // @poff=766
0x76a: Push("hit_react") // @poff=776
0x76b: Push("1") // @poff=796
0x76c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x76d: Push("2") // @poff=800
...
0x774: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x775: Pop(0)
...
0x7bb: Stack[-7] = Stack[-3]
0x7bc: Stack[-6] = Stack[-2]
0x7bd: Stack[-5] = Stack[-1]
0x7be: Call 0x730
...
0x7c9: Stack[-2] = (int) 0
0x7ca: Push("all") // @poff=170
0x7cb: PushEmpty(string, int)
0x7cc: Stack[-5] = Stack[-1]
0x7cd: Call 0x7c1
...
0x81a: Push("GenerateMoney: iMin > iMax") // @poff=814
0x81b: @ Trace(Stack[-1])
0x81c: Pop(1)
0x81d: Return(); Pop(8)
...
0x835: PushEmpty(bool, int, bool, int)
0x836: Push((int) 0)
...
0x84b: Stack[-1] = "hook" // @poff=880
0x84c: Call 0x861

0x84d: Pop(1)
0x84e: Push((int) 0)
0x84f: Push((int) 1)
0x850: @ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0x851: Pop(3)
0x852: Push((int) 10)
0x853: @ irand(Stack[-2], Stack[-1])
0x854: Pop(1)
0x855: Push((int) 0)
0x856: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x857: IF (Stack[-1] == 0) GOTO 0x860; Pop(1)

0x858: PushEmpty(int, string)
0x859: Stack[-1] = "watch" // @poff=890
0x85a: Call 0x861

0x85b: Pop(1)
0x85c: Push((int) 0)
0x85d: Push((int) 1)
0x85e: @ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0x85f: Pop(3)
0x860: Return(); Pop(4)

0x861: PushEmpty(int, int)
0x862: @ GetInvItemByName(Stack[-1], Stack[-3])
0x863: Pop(0)
0x864: Stack[-1] = Stack[-4]
0x865: Return(); Pop(2)

0x866: Push(GlobalVars[0])
0x867: Stack[-1] = (bool) 0
0x868: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x870: IF (Stack[-1] == 0) GOTO 0x878; Pop(1)

0x871: @ IsOverrideActive(Stack[-1])
0x872: Pop(0)
0x873: Pop(0); Push((bool) Stack[-1] == 0)
0x874: IF (Stack[-1] == 0) GOTO 0x877; Pop(1)

0x875: @ WorkWithCorpse(Stack[-3])
0x876: Pop(0)
0x877: Return(); Pop(2)

0x878: Return(); Pop(2)

0x879: PushEmpty(bool, bool)
0x87a: @ IsPlayerActor(Stack[-3], Stack[-1])
0x87b: Pop(0)
0x87c: Stack[-1] = Stack[-4]
0x87d: Return(); Pop(2)
...
0x883: PushEmpty(string, bool, string, bool)
0x884: PushEmpty(bool, object, string)
0x885: Stack[-8] = Stack[-2]
0x886: Stack[-1] = "class" // @poff=902
0x887: Call 0x64e

0x888: Pop(2)
0x889: Pop(1); Push((bool) Stack[-1] == 0)
0x88a: IF (Stack[-1] == 0) GOTO 0x88d; Pop(1)

0x88b: Stack[-7] = (bool) 0
0x88c: Return(); Pop(4)

0x88d: Push("class") // @poff=902
0x88e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=544
0x88f: Pop(1)
0x890: Push("rat") // @poff=914
0x891: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x892: IF (Stack[-1] == 0) GOTO 0x896; Pop(1)

0x893: Stack[-7] = (bool) 0
0x894: Return(); Pop(4)

0x895: GOTO 0x89b

0x896: Push("dog") // @poff=922
0x897: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x898: IF (Stack[-1] == 0) GOTO 0x89b; Pop(1)

0x899: Stack[-7] = (bool) 0
0x89a: Return(); Pop(4)

0x89b: @ CanSee(Stack[-1], Stack[-6])
0x89c: Pop(0)
0x89d: PushEmpty(bool)
0x89e: Stack[-1] = (bool) 1
0x89f: Push(Stack[-2])
0x8a0: IF (Stack[-1] == 1) GOTO 0x8a9; Pop(1)

0x8a1: PushEmpty(float, object)
0x8a2: Stack[-9] = Stack[-1]
0x8a3: Call 0x646

0x8a4: Pop(1)
0x8a5: Push((float)250000.0)
0x8a6: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x8a7: IF (Stack[-1] == 1) GOTO 0x8a9; Pop(1)

0x8a8: Stack[-1] = (bool) 0
0x8a9: IF (Stack[-1] == 0) GOTO 0x8af; Pop(1)

0x8aa: Push((float)-0.30000001192092896)
0x8ab: @ ReportReputationChange(Stack[-7], Stack[-6], Stack[-1])
0x8ac: Pop(1)
0x8ad: Stack[-7] = (bool) 1
0x8ae: Return(); Pop(4)

0x8af: Stack[-7] = (bool) 0
0x8b0: Return(); Pop(4)

0x8b1: PushEmpty()
0x8b2: Push(GlobalVars[0])
0x8b3: Stack[-1] = (bool) 1
0x8b4: GlobalVars[0] = Stack[-1]; Pop(1)
0x8b5: Push((int) 50)
0x8b6: Push((int) 40)
0x8b7: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x8b8: Pop(2)
0x8b9: Return(); Pop(0)
