...
Strings:
	...
	W:woman
	W:butcher
// @pool_raw:
...
0x28f: Stack[-2] = Stack[-4]
0x290: Pop(2)
0x291: PushEmpty(float, cvector, cvector)
0x292: Stack[-6] = Stack[-2]
0x293: Stack[-5] = Stack[-1]
0x294: Call 0x725
...
0x315: Stack[-6] = Stack[-2]
0x316: Stack[-7] = Stack[-1]
0x317: Call 0x7af

0x318: Stack[-3] = Stack[-4]
0x319: Pop(3)
0x31a: Push((int) 0)
...
0x351: Stack[-2] = Stack[-3]
0x352: Pop(2)
0x353: PushEmpty(float, cvector, cvector)
0x354: Stack[-5] = Stack[-2]
0x355: Stack[-4] = Stack[-1]
0x356: Call 0x725

0x357: Pop(2)
0x358: Push((float)0.4999999701976776)
...
0x36f: PushEmpty()
0x370: Stack[-3] = (float) 0.05000000074505806
0x371: Return(); Pop(0)
...
0x377: Push("all") // @poff=170
0x378: Push("attack_begin") // @poff=178
0x379: Push((int) 1)
0x37a: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x385: Push("attack") // @poff=204
0x386: Push((int) 1)
0x387: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3a2: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x3a3: Pop(0)
0x3a4: Push(Stack[-22])
...
0x3b4: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x3b5: Pop(0)
...
0x3d8: Pop(1)
0x3d9: Push("all") // @poff=170
0x3da: Push("attack_on") // @poff=288
...
0x3e6: Push((float)0.6000000238418579)
0x3e7: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x3e8: IF (Stack[-1] == 1) GOTO 0x3ee; Pop(1)
...
0x3ef: @ Face(Stack[-0]T)
0x3f0: Pop(0)
0x3f1: Push("all") // @poff=170
0x3f2: Push("attack_stay") // @poff=308
0x3f3: @ PlayAnimation(Stack[-2], Stack[-1])
0x3f4: Pop(2)
0x3f5: PushEmpty(bool, float)
0x3f6: Stack[-23] = Stack[-1]
0x3f7: Call 0x4d1
...
0x3fc: @ Face(Stack[-0]T)
0x3fd: Pop(0)
0x3fe: Push("all") // @poff=170
0x3ff: Push("fjump") // @poff=332
...
0x417: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x418: Pop(0)
...
0x436: Push("all") // @poff=170
0x437: Push("attack_off") // @poff=344
...
0x443: Push((float)0.8999999761581421)
0x444: Pop(1); Push(Stack[-9] * Stack[-1]);
0x445: @ GetVictim(Stack[-1], Stack[-4])
0x446: Pop(1)
0x447: @ ReportAttack(Stack[-0]T)
0x448: Pop(0)
...
0x44c: Stack[-6] = Stack[-2]
0x44d: Stack[-10] = Stack[-1]
0x44e: Call 0x36f

0x44f: Stack[-3] = Stack[-5]
0x450: Pop(3)
0x451: PushEmpty(float, object, float, int)
0x452: Stack[-7] = Stack[-3]
0x453: Stack[-6] = Stack[-2]
0x454: PushEmpty(int, object, int)
0x455: Stack[-10] = Stack[-2]
0x456: Stack[-14] = Stack[-1]
0x457: Call 0x372

0x458: Stack[-3] = Stack[-4]
0x459: Pop(3)
0x45a: Call 0x621

0x45b: Stack[-4] = Stack[-5]
0x45c: Pop(4)
0x45d: PushEmpty(int)
0x45e: Call 0x558

0x45f: Pop(0)
0x460: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x461: Pop(1)
0x462: PushEmpty(object, float)
0x463: Stack[-5] = Stack[-2]
...
0x46a: @ irand(Stack[-2], Stack[-1]T)
0x46b: Pop(0)
0x46c: Push((int) 1)
0x46d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x46e: @ Face(Stack[-0]T)
0x46f: Pop(0)
0x470: Push((bool) 1)
0x471: @ SetAttackState(Stack[-1])
0x472: Pop(1)
0x473: Push("all") // @poff=170
0x474: Push("attack_begin") // @poff=178
...
0x48b: Pop(2)
0x48c: Push("all") // @poff=170
0x48d: Push("attack_middle") // @poff=366
...
0x493: Push("all") // @poff=170
0x494: Push("attack_middle") // @poff=366
...
0x4ab: Pop(1)
0x4ac: Push("all") // @poff=170
0x4ad: Push("attack_end") // @poff=394
...
0x4e5: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=274
0x4e6: Pop(0)
...
0x51b: @ Face(Stack[-0]T)
0x51c: Pop(0)
0x51d: Push("all") // @poff=170
0x51e: Push("bjump") // @poff=416
0x51f: @ PlayAnimation(Stack[-2], Stack[-1])
0x520: Pop(2)
0x521: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=274
0x522: Pop(0)
...
0x54b: @ irand(Stack[-1], Stack[-2]T)
0x54c: Pop(0)
0x54d: Push((int) 1)
0x54e: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x54f: Push("attack") // @poff=204
...
0x573: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x574: Pop(0)
...
0x58a: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=274
0x58b: Pop(0)
...
0x5fa: Stack[-1] = "walk" // @poff=464
0x5fb: Return(); Pop(0)

0x5fc: Stack[-1] = "run" // @poff=474
0x5fd: Return(); Pop(0)
...
0x602: Stack[-2] = "fire" // @poff=482
0x603: Return(); Pop(0)

0x604: Stack[-2] = "phys" // @poff=492
0x605: Return(); Pop(0)

0x606: PushEmpty(cvector, cvector, cvector, cvector)
0x607: @ GetPosition(Stack[-2])
0x608: Pop(0)
0x609: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x60a: Pop(0)
...
0x60f: Pop(0)
0x610: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x611: Pop(0)
...
0x616: Push("HasProperty") // @poff=502
0x617: Push((int) 2)
...
0x61d: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=526
0x61e: Pop(0)
0x61f: Stack[-1] = Stack[-5]
0x620: Return(); Pop(2)

0x621: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x622: PushEmpty(bool, object, string)
0x623: Stack[-18] = Stack[-2]
0x624: Stack[-1] = "health" // @poff=538
0x625: Call 0x615
...
0x62c: Stack[-18] = Stack[-2]
0x62d: Stack[-1] = "armor" // @poff=552
0x62e: Call 0x615
...
0x634: Push("armor") // @poff=552
0x635: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=564
0x636: Pop(1)
0x637: Push("armor_") // @poff=576
0x638: PushEmpty(string, int)
0x639: Stack[-16] = Stack[-1]
0x63a: Call 0x5fe

0x63b: Pop(1)
0x63c: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x63d: PushEmpty(bool, object, string)
0x63e: Stack[-18] = Stack[-2]
0x63f: Stack[-8] = Stack[-1]
0x640: Call 0x615
...
0x646: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=564
0x647: Pop(0)
...
0x64e: Stack[-3] = Stack[-6]
0x64f: Pop(3)
0x650: Push("health") // @poff=538
0x651: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=564
0x652: Pop(1)
0x653: Push((int) 1)
0x654: Pop(1); Push(Stack[-1] - Stack[-4]);
0x655: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x656: Push("health") // @poff=538
...
0x65c: Pop(3)
0x65d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=590
0x65e: Pop(2)
0x65f: Stack[-1] = Stack[-16]
0x660: Return(); Pop(12)

0x661: PushEmpty(bool, bool)
0x662: @@ IsDead(Stack[-1]); Obj=3 // @poff=602
0x663: Pop(0)
0x664: Stack[-1] = Stack[-4]
0x665: Return(); Pop(2)

0x666: PushEmpty(object, object, object, object)
0x667: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x67b: Pop(0)
0x67c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x67d: IF (Stack[-1] == 0) GOTO 0x680; Pop(1)

0x67e: Stack[-6] = (bool) 0
0x67f: Return(); Pop(4)

0x680: @@ GetScene(Stack[-1]); Obj=5 // @poff=623
0x681: Pop(0)
...
0x694: Stack[-6] = Stack[-2]
0x695: Stack[-1] = "noaccess" // @poff=632
0x696: Call 0x615
...
0x69c: Push("noaccess") // @poff=632
0x69d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=564
0x69e: Pop(1)
0x69f: Push((int) 0)
...
0x6c8: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x6c9: Pop(0)
...
0x6d9: Stack[-1] = "fhit" // @poff=688
0x6da: GOTO 0x6dc

0x6db: Stack[-1] = "bhit" // @poff=698
0x6dc: Push("hit_react") // @poff=708
0x6dd: Push("1") // @poff=728
0x6de: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6df: Push("2") // @poff=732
...
0x6e6: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x6e7: Pop(0)
...
0x6f6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x6f7: Pop(0)
...
0x703: Stack[-2] = Stack[-3]
0x704: GOTO 0x706

0x705: Stack[-1] = Stack[-3]
0x706: Return(); Pop(0)
...
0x727: Stack[-5] = Stack[-2]
0x728: Stack[-4] = Stack[-1]
0x729: Call 0x712
...
0x75c: Stack[-7] = Stack[-3]
0x75d: Stack[-6] = Stack[-2]
0x75e: Stack[-5] = Stack[-1]
0x75f: Call 0x6a2
...
0x79f: Stack[-3] = Stack[-1]
0x7a0: Call 0x78b

0x7a1: Stack[-2] = Stack[-4]
0x7a2: Pop(2)
0x7a3: Return(); Pop(0)
...
0x7c1: Push("GenerateMoney: iMin > iMax") // @poff=746
0x7c2: @ Trace(Stack[-1])
0x7c3: Pop(1)
0x7c4: Return(); Pop(8)
...
0x815: Stack[-1] = "syringe" // @poff=844
0x816: Call 0x88b
...
0x853: Stack[-1] = "bracelet" // @poff=896
0x854: Call 0x88b
...
0x85f: Stack[-1] = "ear_ring" // @poff=914
0x860: Call 0x88b
...
0x86b: Stack[-1] = "gold_ring" // @poff=932
0x86c: Call 0x88b
...
0x877: Stack[-1] = "silver_ring" // @poff=952
0x878: Call 0x88b
...
0x8a7: Stack[-8] = Stack[-2]
0x8a8: Stack[-1] = "class" // @poff=990
0x8a9: Call 0x615
...
0x8af: Push("class") // @poff=990
0x8b0: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=564
0x8b1: Pop(1)
...
0x8be: Push("littleboy") // @poff=1002
0x8bf: Pop(1); Push((bool) Stack[-9] != Stack[-1])
0x8c0: IF (Stack[-1] == 0) GOTO 0x8c5; Pop(1)

0x8c1: Push("littlegirl") // @poff=1022
0x8c2: Pop(1); Push((bool) Stack[-9] != Stack[-1])
0x8c3: IF (Stack[-1] == 0) GOTO 0x8c5; Pop(1)

0x8c4: Stack[-1] = (bool) 1
0x8c5: IF (Stack[-1] == 0) GOTO 0x8ca; Pop(1)

0x8c6: Push("boy") // @poff=1014
0x8c7: Pop(1); Push((bool) Stack[-8] != Stack[-1])
0x8c8: IF (Stack[-1] == 0) GOTO 0x8ca; Pop(1)

0x8c9: Stack[-1] = (bool) 1
0x8ca: IF (Stack[-1] == 0) GOTO 0x8cf; Pop(1)

0x8cb: Push("girl") // @poff=1034
0x8cc: Pop(1); Push((bool) Stack[-7] != Stack[-1])
0x8cd: IF (Stack[-1] == 0) GOTO 0x8cf; Pop(1)

0x8ce: Stack[-1] = (bool) 1
0x8cf: IF (Stack[-1] == 0) GOTO 0x8d4; Pop(1)

0x8d0: Push("wasted_girl") // @poff=1044
0x8d1: Pop(1); Push((bool) Stack[-6] != Stack[-1])
0x8d2: IF (Stack[-1] == 0) GOTO 0x8d4; Pop(1)

0x8d3: Stack[-1] = (bool) 1
0x8d4: IF (Stack[-1] == 0) GOTO 0x8d9; Pop(1)

0x8d5: Push("woman") // @poff=1068
...
0x8da: Push("butcher") // @poff=1080
0x8db: Pop(1); Push((bool) Stack[-4] != Stack[-1])
0x8dc: IF (Stack[-1] == 0) GOTO 0x8de; Pop(1)

0x8dd: Stack[-1] = (bool) 1
0x8de: IF (Stack[-1] == 0) GOTO 0x8e1; Pop(1)

0x8df: Stack[-7] = (bool) 0
0x8e0: Return(); Pop(4)

0x8e1: @ CanSee(Stack[-1], Stack[-6])
0x8e2: Pop(0)
0x8e3: PushEmpty(bool)
0x8e4: Stack[-1] = (bool) 1
0x8e5: Push(Stack[-2])
0x8e6: IF (Stack[-1] == 1) GOTO 0x8ef; Pop(1)

0x8e7: PushEmpty(float, object)
0x8e8: Stack[-9] = Stack[-1]
0x8e9: Call 0x60d

0x8ea: Pop(1)
0x8eb: Push((float)250000.0)
0x8ec: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x8ed: IF (Stack[-1] == 1) GOTO 0x8ef; Pop(1)

0x8ee: Stack[-1] = (bool) 0
0x8ef: IF (Stack[-1] == 0) GOTO 0x8f5; Pop(1)

0x8f0: Push((float)-0.30000001192092896)
0x8f1: @ ReportReputationChange(Stack[-7], Stack[-6], Stack[-1])
0x8f2: Pop(1)
0x8f3: Stack[-7] = (bool) 1
0x8f4: Return(); Pop(4)

0x8f5: Stack[-7] = (bool) 0
0x8f6: Return(); Pop(4)

0x8f7: PushEmpty()
0x8f8: Push(GlobalVars[0])
0x8f9: Stack[-1] = (bool) 1
0x8fa: GlobalVars[0] = Stack[-1]; Pop(1)
0x8fb: Push((int) 50)
0x8fc: Push((int) 40)
0x8fd: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x8fe: Pop(2)
0x8ff: Return(); Pop(0)
