...
Strings:
	...
	W:woman
	W:unosha
// @pool_raw:
...
Events:
EVENT_16 Op = 0x73e Vars = (object, string)
EVENT_41 Op = 0x74b Vars = (object)
EVENT_22 Op = 0x751 Vars = (object, int, float, float)
...
0x36f: PushEmpty()
0x370: Stack[-3] = (float) 0.20000000298023224
0x371: Return(); Pop(0)
...
0x739: Push(-1, 0); TaskCall(0)
0x73a: Call 0x0

0x73b: Pop(-1, 0); TaskReturn
0x73c: Pop(1)
0x73d: Return(); Pop(0)

0x73e: PushEmpty(float, float)
0x73f: Push("health") // @poff=538
0x740: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x741: IF (Stack[-1] == 0) GOTO 0x74a; Pop(1)

0x742: Push("health") // @poff=538
0x743: @ GetProperty(Stack[-1], Stack[-2])
0x744: Pop(1)
0x745: Push((int) 0)
0x746: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x747: IF (Stack[-1] == 0) GOTO 0x74a; Pop(1)

0x748: @ SignalDeath(Stack[-4])
0x749: Pop(0)
0x74a: Return(); Pop(2)
...
0x751: PushEmpty()
0x752: PushEmpty(object, int, float)
0x753: Stack[-7] = Stack[-3]
0x754: Stack[-6] = Stack[-2]
0x755: Stack[-5] = Stack[-1]
0x756: Call 0x6a2

0x757: Pop(3)
0x758: Return(); Pop(0)

0x759: PushEmpty(string, string)
0x75a: Stack[-1] = "idle" // @poff=736
0x75b: Push(Stack[-3])
0x75c: IF (Stack[-1] == 0) GOTO 0x75e; Pop(1)

0x75d: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x75e: Stack[-1] = Stack[-4]
0x75f: Return(); Pop(2)

0x760: PushEmpty(int, bool, int, bool)
0x761: Stack[-2] = (int) 0
0x762: Push("all") // @poff=170
0x763: PushEmpty(string, int)
0x764: Stack[-5] = Stack[-1]
0x765: Call 0x759

0x766: Pop(1)
0x767: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x768: Pop(2)
...
0x76c: Push((int) 1)
0x76d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x76e: GOTO 0x762
...
0x77d: Push(-1, 1); TaskCall(3)
0x77e: Call 0x285

0x77f: Pop(-1, 1); TaskReturn
0x780: Pop(1)
0x781: Return(); Pop(0)
...
0x78f: Push(-1, 5); TaskCall(4)
0x790: Call 0x367

0x791: Pop(-1, 5); TaskReturn
0x792: Pop(1)
0x793: Return(); Pop(0)

0x794: PushEmpty()
0x795: PushEmpty(int, object)
0x796: Stack[-3] = Stack[-1]
0x797: Call 0x782

0x798: Stack[-2] = Stack[-4]
0x799: Pop(2)
0x79a: Return(); Pop(0)
...
0x7b5: Push(GlobalVars[0])
0x7b6: Stack[-1] = (bool) 0
0x7b7: GlobalVars[0] = Stack[-1]; Pop(1)
0x7b8: Return(); Pop(0)

0x7b9: PushEmpty(bool, bool)
0x7ba: Push(GlobalVars[0])
0x7bb: IF (Stack[-1] == 0) GOTO 0x7c3; Pop(1)

0x7bc: @ IsOverrideActive(Stack[-1])
0x7bd: Pop(0)
0x7be: Pop(0); Push((bool) Stack[-1] == 0)
0x7bf: IF (Stack[-1] == 0) GOTO 0x7c2; Pop(1)

0x7c0: @ WorkWithCorpse(Stack[-3])
0x7c1: Pop(0)
0x7c2: Return(); Pop(2)
...
0x7c6: PushEmpty(string, bool, string, bool)
0x7c7: PushEmpty(bool, object, string)
0x7c8: Stack[-8] = Stack[-2]
0x7c9: Stack[-1] = "class" // @poff=746
0x7ca: Call 0x615

0x7cb: Pop(2)
0x7cc: Pop(1); Push((bool) Stack[-1] == 0)
0x7cd: IF (Stack[-1] == 0) GOTO 0x7d0; Pop(1)

0x7ce: Stack[-7] = (bool) 0
0x7cf: Return(); Pop(4)

0x7d0: Push("class") // @poff=746
0x7d1: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=564
0x7d2: Pop(1)
...
0x7df: Push("littleboy") // @poff=758
0x7e0: Pop(1); Push((bool) Stack[-9] != Stack[-1])
0x7e1: IF (Stack[-1] == 0) GOTO 0x7e6; Pop(1)

0x7e2: Push("littlegirl") // @poff=778
0x7e3: Pop(1); Push((bool) Stack[-9] != Stack[-1])
0x7e4: IF (Stack[-1] == 0) GOTO 0x7e6; Pop(1)

0x7e5: Stack[-1] = (bool) 1
0x7e6: IF (Stack[-1] == 0) GOTO 0x7eb; Pop(1)

0x7e7: Push("boy") // @poff=770
0x7e8: Pop(1); Push((bool) Stack[-8] != Stack[-1])
0x7e9: IF (Stack[-1] == 0) GOTO 0x7eb; Pop(1)

0x7ea: Stack[-1] = (bool) 1
0x7eb: IF (Stack[-1] == 0) GOTO 0x7f0; Pop(1)

0x7ec: Push("girl") // @poff=790
0x7ed: Pop(1); Push((bool) Stack[-7] != Stack[-1])
0x7ee: IF (Stack[-1] == 0) GOTO 0x7f0; Pop(1)

0x7ef: Stack[-1] = (bool) 1
0x7f0: IF (Stack[-1] == 0) GOTO 0x7f5; Pop(1)

0x7f1: Push("wasted_girl") // @poff=800
0x7f2: Pop(1); Push((bool) Stack[-6] != Stack[-1])
0x7f3: IF (Stack[-1] == 0) GOTO 0x7f5; Pop(1)

0x7f4: Stack[-1] = (bool) 1
0x7f5: IF (Stack[-1] == 0) GOTO 0x7fa; Pop(1)

0x7f6: Push("woman") // @poff=824
0x7f7: Pop(1); Push((bool) Stack[-5] != Stack[-1])
0x7f8: IF (Stack[-1] == 0) GOTO 0x7fa; Pop(1)

0x7f9: Stack[-1] = (bool) 1
0x7fa: IF (Stack[-1] == 0) GOTO 0x7ff; Pop(1)

0x7fb: Push("unosha") // @poff=836
0x7fc: Pop(1); Push((bool) Stack[-4] != Stack[-1])
0x7fd: IF (Stack[-1] == 0) GOTO 0x7ff; Pop(1)

0x7fe: Stack[-1] = (bool) 1
0x7ff: IF (Stack[-1] == 0) GOTO 0x802; Pop(1)

0x800: Stack[-7] = (bool) 0
0x801: Return(); Pop(4)

0x802: @ CanSee(Stack[-1], Stack[-6])
0x803: Pop(0)
0x804: PushEmpty(bool)
0x805: Stack[-1] = (bool) 1
0x806: Push(Stack[-2])
0x807: IF (Stack[-1] == 1) GOTO 0x810; Pop(1)

0x808: PushEmpty(float, object)
0x809: Stack[-9] = Stack[-1]
0x80a: Call 0x60d

0x80b: Pop(1)
0x80c: Push((float)250000.0)
0x80d: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x80e: IF (Stack[-1] == 1) GOTO 0x810; Pop(1)

0x80f: Stack[-1] = (bool) 0
0x810: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x811: Stack[-7] = (bool) 1
0x812: Return(); Pop(4)

0x813: Stack[-7] = (bool) 0
0x814: Return(); Pop(4)

0x815: PushEmpty()
0x816: Push(GlobalVars[0])
0x817: Stack[-1] = (bool) 1
0x818: GlobalVars[0] = Stack[-1]; Pop(1)
0x819: Push((int) 50)
0x81a: Push((int) 40)
0x81b: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x81c: Pop(2)
0x81d: Return(); Pop(0)
