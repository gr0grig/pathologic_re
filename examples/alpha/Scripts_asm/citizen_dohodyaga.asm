...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
...
Events:
EVENT_16 Op = 0x888 Vars = (object, string)
EVENT_41 Op = 0x895 Vars = (object)
EVENT_22 Op = 0x89b Vars = (object, int, float, float)
...
0x385: PushEmpty()
0x386: Stack[-3] = (float) 0.029999999329447746
0x387: Return(); Pop(0)
...
0x38d: Push("all") // @poff=0
0x38e: Push("attack_begin") // @poff=188
0x38f: Push((int) 1)
0x390: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x39b: Push("attack") // @poff=214
0x39c: Push((int) 1)
0x39d: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x3b8: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x3b9: Pop(0)
0x3ba: Push(Stack[-22])
...
0x3ca: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=284
0x3cb: Pop(0)
...
0x3ee: Pop(1)
0x3ef: Push("all") // @poff=0
0x3f0: Push("attack_on") // @poff=298
...
0x3fc: Push((float)0.6000000238418579)
0x3fd: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x3fe: IF (Stack[-1] == 1) GOTO 0x404; Pop(1)

0x3ff: PushEmpty(bool)
0x400: Call 0x543

0x401: Pop(0)
0x402: IF (Stack[-1] == 1) GOTO 0x404; Pop(1)

0x403: Stack[-1] = (bool) 0
0x404: IF (Stack[-1] == 0) GOTO 0x412; Pop(1)

0x405: @ Face(Stack[-0]T)
0x406: Pop(0)
0x407: Push("all") // @poff=0
0x408: Push("attack_stay") // @poff=318
0x409: @ PlayAnimation(Stack[-2], Stack[-1])
0x40a: Pop(2)
0x40b: PushEmpty(bool, float)
0x40c: Stack[-23] = Stack[-1]
0x40d: Call 0x4e7
...
0x412: @ Face(Stack[-0]T)
0x413: Pop(0)
0x414: Push("all") // @poff=0
0x415: Push("fjump") // @poff=342
...
0x42d: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=284
0x42e: Pop(0)
...
0x44c: Push("all") // @poff=0
0x44d: Push("attack_off") // @poff=354
...
0x459: Push((float)0.8999999761581421)
0x45a: Pop(1); Push(Stack[-9] * Stack[-1]);
0x45b: @ GetVictim(Stack[-1], Stack[-4])
0x45c: Pop(1)
0x45d: @ ReportAttack(Stack[-0]T)
0x45e: Pop(0)
...
0x462: Stack[-6] = Stack[-2]
0x463: Stack[-10] = Stack[-1]
0x464: Call 0x385

0x465: Stack[-3] = Stack[-5]
0x466: Pop(3)
0x467: PushEmpty(float, object, float, int)
0x468: Stack[-7] = Stack[-3]
0x469: Stack[-6] = Stack[-2]
0x46a: PushEmpty(int, object, int)
0x46b: Stack[-10] = Stack[-2]
0x46c: Stack[-14] = Stack[-1]
0x46d: Call 0x388

0x46e: Stack[-3] = Stack[-4]
0x46f: Pop(3)
0x470: Call 0x6d8

0x471: Stack[-4] = Stack[-5]
0x472: Pop(4)
0x473: PushEmpty(int)
0x474: Call 0x56e

0x475: Pop(0)
0x476: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x477: Pop(1)
0x478: PushEmpty(object, float)
0x479: Stack[-5] = Stack[-2]
0x47a: Stack[-3] = Stack[-1]
0x47b: Call 0x570
...
0x480: @ irand(Stack[-2], Stack[-1]T)
0x481: Pop(0)
0x482: Push((int) 1)
0x483: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x484: @ Face(Stack[-0]T)
0x485: Pop(0)
0x486: Push((bool) 1)
0x487: @ SetAttackState(Stack[-1])
0x488: Pop(1)
0x489: Push("all") // @poff=0
0x48a: Push("attack_begin") // @poff=188
...
0x4a1: Pop(2)
0x4a2: Push("all") // @poff=0
0x4a3: Push("attack_middle") // @poff=376
...
0x4a9: Push("all") // @poff=0
0x4aa: Push("attack_middle") // @poff=376
...
0x4bb: Stack[-7] = Stack[-2]
0x4bc: Stack[-4] = Stack[-1]
0x4bd: Call 0x458
...
0x4c1: Pop(1)
0x4c2: Push("all") // @poff=0
0x4c3: Push("attack_end") // @poff=404
...
0x4fb: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=284
0x4fc: Pop(0)
...
0x531: @ Face(Stack[-0]T)
0x532: Pop(0)
0x533: Push("all") // @poff=0
0x534: Push("bjump") // @poff=426
0x535: @ PlayAnimation(Stack[-2], Stack[-1])
0x536: Pop(2)
0x537: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=284
0x538: Pop(0)
...
0x561: @ irand(Stack[-1], Stack[-2]T)
0x562: Pop(0)
0x563: Push((int) 1)
0x564: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x565: Push("attack") // @poff=214
...
0x580: Stack[-17] = Stack[-7]
0x581: PushEmpty(bool, object)
0x582: Stack[-23] = Stack[-1]
0x583: Call 0x609
...
0x589: @@ GetPosition(Stack[-5]); Obj=21 // @poff=28
0x58a: Pop(0)
...
0x5a0: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=284
0x5a1: Pop(0)
...
0x5b2: Push((int) 0)
0x5b3: Push((float)0.30000001192092896)
...
0x5d5: Push((int) 0)
0x5d6: Push((float)0.30000001192092896)
...
0x60d: Stack[-2] = Stack[-4]
0x60e: Pop(2)
0x60f: Return(); Pop(0)

0x610: Stack[-1] = "walk" // @poff=474
0x611: Return(); Pop(0)

0x612: Stack[-1] = "run" // @poff=484
0x613: Return(); Pop(0)
...
0x622: Pop(0)
0x623: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=492
0x624: Pop(1)
0x625: PushEmpty(string)
0x626: Call 0x912

0x627: Pop(0)
0x628: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=503
0x629: Pop(1)
0x62a: PushEmpty(int)
0x62b: Call 0x8ff

0x62c: Pop(0)
0x62d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=512
0x62e: Pop(1)
0x62f: Stack[-2] = (int) -1
...
0x63e: Pop(2)
0x63f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=526
0x640: Pop(0)
...
0x643: @ sync()
0x644: Pop(0)
0x645: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=526
0x646: Pop(0)
0x647: GOTO 0x641
...
0x64d: Pop(0)
0x64e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=538
0x64f: Pop(0)
...
0x65a: Stack[-1] = "Neutral" // @poff=553
0x65b: Call 0x688

0x65c: Pop(1)
0x65d: Push((int) 14535)
0x65e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x65f: Pop(1)
0x660: @@@ ClearReplies(); Obj=0 // @poff=580
0x661: Pop(0)
0x662: Push((int) 15227)
0x663: Push((int) -1)
0x664: Push((int) 16504)
0x665: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x666: Pop(3)
0x667: GOTO 0x66a
...
0x679: Push("all") // @poff=0
0x67a: Push("idle") // @poff=8
...
0x682: Push("all") // @poff=0
0x683: Push("idle") // @poff=8
...
0x695: Pop(1)
0x696: Stack[2 + Tasks[-1].StackPointer] = Stack[-1]
0x697: Return(); Pop(0)

0x698: PushEmpty()
0x699: Push((int) 1)
0x69a: IF (Stack[-1] == 0) GOTO 0x6bc; Pop(1)

0x69b: PushEmpty()
0x69c: Call 0x839

0x69d: Pop(0)
0x69e: Push((int) 15766)
0x69f: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x6a0: IF (Stack[-1] == 0) GOTO 0x6b0; Pop(1)

0x6a1: PushEmpty(string)
0x6a2: Stack[-1] = "Neutral" // @poff=553
0x6a3: Call 0x688

0x6a4: Pop(1)
0x6a5: Push((int) 14535)
0x6a6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6a7: Pop(1)
0x6a8: @@@ ClearReplies(); Obj=0 // @poff=580
0x6a9: Pop(0)
0x6aa: Push((int) 15227)
0x6ab: Push((int) -1)
0x6ac: Push((int) 16504)
0x6ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6ae: Pop(3)
0x6af: Return(); Pop(0)

0x6b0: Stack[3 + Tasks[-1].StackPointer] = (bool)1
...
0x6c1: Stack[-2] = "fire" // @poff=602
0x6c2: Return(); Pop(0)

0x6c3: Stack[-2] = "phys" // @poff=612
0x6c4: Return(); Pop(0)

0x6c5: PushEmpty(cvector, cvector, cvector, cvector)
0x6c6: @ GetPosition(Stack[-2])
0x6c7: Pop(0)
0x6c8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x6c9: Pop(0)
0x6ca: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x6cb: Return(); Pop(4)

0x6cc: PushEmpty(bool, bool)
0x6cd: Push("HasProperty") // @poff=622
0x6ce: Push((int) 2)
0x6cf: Pop(2); Push(IsFuncExist(Stack[-6], Stack[-2], Stack[-1]))
0x6d0: Pop(1); Push((bool) Stack[-1] == 0)
0x6d1: IF (Stack[-1] == 0) GOTO 0x6d4; Pop(1)

0x6d2: Stack[-5] = (bool) 0
0x6d3: Return(); Pop(2)

0x6d4: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x6d5: Pop(0)
0x6d6: Stack[-1] = Stack[-5]
0x6d7: Return(); Pop(2)

0x6d8: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x6d9: PushEmpty(bool, object, string)
0x6da: Stack[-18] = Stack[-2]
0x6db: Stack[-1] = "health" // @poff=658
0x6dc: Call 0x6cc
...
0x6e0: Stack[-16] = (float) 0.0
0x6e1: Return(); Pop(12)

0x6e2: PushEmpty(bool, object, string)
0x6e3: Stack[-18] = Stack[-2]
0x6e4: Stack[-1] = "armor" // @poff=672
0x6e5: Call 0x6cc
...
0x6eb: Push("armor") // @poff=672
0x6ec: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x6ed: Pop(1)
0x6ee: Push("armor_") // @poff=696
0x6ef: PushEmpty(string, int)
0x6f0: Stack[-16] = Stack[-1]
0x6f1: Call 0x6bd

0x6f2: Pop(1)
0x6f3: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x6f4: PushEmpty(bool, object, string)
0x6f5: Stack[-18] = Stack[-2]
0x6f6: Stack[-8] = Stack[-1]
0x6f7: Call 0x6cc
...
0x6fd: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x6fe: Pop(0)
0x6ff: PushEmpty(float, float, float)
0x700: Pop(0); Push(Stack[-9] + Stack[-7]);
0x701: Push((float)100.0)
0x702: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x703: Stack[-1] = (int) 1
0x704: Call 0x84a

0x705: Stack[-3] = Stack[-6]
0x706: Pop(3)
0x707: Push("health") // @poff=658
0x708: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x709: Pop(1)
0x70a: Push((int) 1)
0x70b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x70c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x70d: Push("health") // @poff=658
0x70e: PushEmpty(float, float, float, float)
0x70f: Stack[-3] = Stack[-7] - Stack[-6]; Pop(0);
0x710: Stack[-2] = (int) 0
0x711: Stack[-1] = (int) 1
0x712: Call 0x851

0x713: Pop(3)
0x714: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x715: Pop(2)
0x716: Stack[-1] = Stack[-16]
0x717: Return(); Pop(12)

0x718: PushEmpty(bool, bool)
0x719: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x71a: Pop(0)
0x71b: Stack[-1] = Stack[-4]
0x71c: Return(); Pop(2)

0x71d: PushEmpty(object, object, object, object)
0x71e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x724: Push("IsDead") // @poff=729
0x725: Push((int) 1)
0x726: Pop(2); Push(IsFuncExist(Stack[-8], Stack[-2], Stack[-1]))
0x727: IF (Stack[-1] == 0) GOTO 0x72e; Pop(1)

0x728: PushEmpty(bool, object)
0x729: Stack[-8] = Stack[-1]
0x72a: Call 0x718
...
0x72f: Stack[-6] = (bool) 0
0x730: Return(); Pop(4)

0x731: @ GetScene(Stack[-2])
0x732: Pop(0)
0x733: Pop(0); PushNull((bool) Stack[-2] == 0)
0x734: IF (Stack[-1] == 0) GOTO 0x737; Pop(1)

0x735: Stack[-6] = (bool) 0
0x736: Return(); Pop(4)

0x737: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x738: Pop(0)
0x739: Pop(0); Push((bool) Stack[-2] != Stack[-1])
0x73a: IF (Stack[-1] == 0) GOTO 0x73d; Pop(1)

0x73b: Stack[-6] = (bool) 0
0x73c: Return(); Pop(4)

0x73d: Stack[-6] = (bool) 1
0x73e: Return(); Pop(4)
...
0x748: Stack[-4] = (bool) 0
0x749: Return(); Pop(2)

0x74a: PushEmpty(bool, object, string)
0x74b: Stack[-6] = Stack[-2]
0x74c: Stack[-1] = "noaccess" // @poff=752
0x74d: Call 0x6cc
...
0x751: Stack[-4] = (bool) 1
0x752: Return(); Pop(2)

0x753: Push("noaccess") // @poff=752
0x754: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x755: Pop(1)
0x756: Push((int) 0)
0x757: Stack[-5] = Stack[-2] == Stack[-1]; Pop(1);
0x758: Return(); Pop(2)

0x759: PushEmpty(object, object, cvector, float, int, cvector, cvector, cvector, cvector, string, object, object, cvector, float, int, cvector, cvector, cvector, cvector, string)
0x75a: PushEmpty(bool)
0x75b: Stack[-1] = (bool) 0
0x75c: Push((int) 4)
0x75d: Pop(1); Push((bool) Stack[-24] != Stack[-1])
0x75e: IF (Stack[-1] == 0) GOTO 0x763; Pop(1)

0x75f: Push((int) 5)
0x760: Pop(1); Push((bool) Stack[-24] != Stack[-1])
0x761: IF (Stack[-1] == 0) GOTO 0x763; Pop(1)

0x762: Stack[-1] = (bool) 1
0x763: IF (Stack[-1] == 0) GOTO 0x776; Pop(1)

0x764: @ GetScene(Stack[-10])
0x765: Pop(0)
0x766: @ GetPosition(Stack[-8])
0x767: Pop(0)
0x768: @ GetEyesHeight(Stack[-7])
0x769: Pop(0)
0x76a: Push(CvectorIndex(Stack[-8], 1))
0x76b: Push((int) 2)
0x76c: Pop(1); Push(Stack[-9] / Stack[-1]);
0x76d: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x76e: CvectorIndex(Stack[-9], 1) = Stack[-1];
0x76f: Push("scripted") // @poff=770
0x770: Push(CVector(0.0, 0.0, 1.0))
0x771: Push("blood.xml") // @poff=788
0x772: @ AddActorByType(Stack[-12], Stack[-3], Stack[-13], Stack[-11], Stack[-2], Stack[-1])
0x773: Pop(3)
0x774: Stack[-9] = 0
0x775: Stack[-10] = 0
0x776: Pop(0); PushNull((bool) Stack[-23] == 0)
0x777: IF (Stack[-1] == 0) GOTO 0x779; Pop(1)

0x778: Return(); Pop(20)

0x779: @ GetSecondaryAnimationType(Stack[-6])
0x77a: Pop(0)
0x77b: Push((int) 0)
0x77c: Pop(1); Push((bool) Stack[-7] < Stack[-1])
0x77d: IF (Stack[-1] == 0) GOTO 0x77f; Pop(1)

0x77e: Return(); Pop(20)

0x77f: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x780: Pop(0)
0x781: @ GetPosition(Stack[-4])
0x782: Pop(0)
0x783: @ GetDirection(Stack[-3])
0x784: Pop(0)
0x785: Stack[-2] = Stack[-4] - Stack[-5]; Pop(0);
0x786: Push(CvectorIndex(Stack[-2], 0))
0x787: Push(CvectorIndex(Stack[-4], 0))
0x788: Pop(2); Push(Stack[-2] * Stack[-1]);
0x789: Push(CvectorIndex(Stack[-3], 2))
0x78a: Push(CvectorIndex(Stack[-5], 2))
0x78b: Pop(2); Push(Stack[-2] * Stack[-1]);
0x78c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x78d: Push((int) 0)
0x78e: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0x78f: IF (Stack[-1] == 0) GOTO 0x792; Pop(1)

0x790: Stack[-1] = "fhit" // @poff=808
0x791: GOTO 0x793

0x792: Stack[-1] = "bhit" // @poff=818
0x793: Push("hit_react") // @poff=828
0x794: Push("1") // @poff=848
0x795: Pop(1); Push(Stack[-3] + Stack[-1]);
0x796: Push("2") // @poff=852
0x797: Pop(1); Push(Stack[-4] + Stack[-1]);
0x798: Push((int) -10)
0x799: @ FadeSecondaryAnimation(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x79a: Pop(4)
0x79b: Return(); Pop(20)

0x79c: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x79d: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x79e: Pop(0)
0x79f: @ GetPosition(Stack[-2])
0x7a0: Pop(0)
0x7a1: Stack[-1] = Stack[-3] - Stack[-2]; Pop(0);
0x7a2: Push(CvectorIndex(Stack[-1], 0))
0x7a3: Push(CvectorIndex(Stack[-2], 2))
0x7a4: @ RotateAsync(Stack[-2], Stack[-1])
0x7a5: Pop(2)
0x7a6: Return(); Pop(6)

0x7a7: PushEmpty(bool, bool)
0x7a8: @ IsLoaded(Stack[-1])
0x7a9: Pop(0)
0x7aa: Stack[-1] = Stack[-3]
0x7ab: Return(); Pop(2)

0x7ac: PushEmpty(float, cvector, cvector, cvector, cvector, cvector, cvector, bool, float, cvector, cvector, cvector, cvector, cvector, cvector, bool)
0x7ad: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x7ae: Pop(0)
0x7af: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x7b0: Pop(0)
0x7b1: Push(CvectorIndex(Stack[-7], 1))
0x7b2: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x7b3: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x7b4: @ GetPosition(Stack[-6])
0x7b5: Pop(0)
0x7b6: @ GetEyesHeight(Stack[-8])
0x7b7: Pop(0)
0x7b8: Push(CvectorIndex(Stack[-6], 1))
0x7b9: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x7ba: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x7bb: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x7bc: Push(CvectorIndex(Stack[-5], 1))
0x7bd: Stack[-1] = (int) 0
0x7be: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x7bf: Pop(0); Push(Stack[-5] | Stack[-5]);
0x7c0: Pop(1); Push(Sqrt(Stack[-1]))
0x7c1: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x7c2: Stack[-4] = -Stack[-5]; Pop(0);
0x7c3: Push((int) 70)
0x7c4: Pop(1); Push(Stack[-6] * Stack[-1]);
0x7c5: PushEmpty(cvector, cvector)
0x7c6: Push(CVector(0.0, 1.0, 0.0))
0x7c7: Stack[-2] = Stack[-8] ^ Stack[-1]; Pop(1);
0x7c8: Call 0x840
...
0x7cd: Push(CVector(0.0, 10.0, 0.0))
0x7ce: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x7cf: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
0x7d0: @ IsOverrideActive(Stack[-1])
0x7d1: Pop(0)
0x7d2: Push(Stack[-1])
0x7d3: IF (Stack[-1] == 0) GOTO 0x7d6; Pop(1)

0x7d4: Stack[-18] = (bool) 0
0x7d5: Return(); Pop(16)

0x7d6: @ StopWorld()
0x7d7: Pop(0)
0x7d8: @ CameraTransit(Stack[-2], Stack[-4])
0x7d9: Pop(0)
0x7da: Push(CvectorIndex(Stack[-3], 0))
0x7db: Push(CvectorIndex(Stack[-4], 2))
0x7dc: @ Rotate(Stack[-2], Stack[-1])
0x7dd: Pop(2)
0x7de: @ CameraWaitForPlayFinish()
0x7df: Pop(0)
0x7e0: @ ResumeWorld()
0x7e1: Pop(0)
0x7e2: Stack[-18] = (bool) 1
0x7e3: Return(); Pop(16)

0x7e4: PushEmpty()
0x7e5: @ CameraSwitchToNormal()
0x7e6: Pop(0)
0x7e7: Return(); Pop(0)

0x7e8: PushEmpty(float, cvector, cvector, cvector, cvector, cvector, cvector, bool, float, cvector, cvector, cvector, cvector, cvector, cvector, bool)
0x7e9: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x7ea: Pop(0)
0x7eb: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x7ec: Pop(0)
0x7ed: Push(CvectorIndex(Stack[-7], 1))
0x7ee: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x7ef: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x7f0: @ GetPosition(Stack[-6])
0x7f1: Pop(0)
0x7f2: @ GetEyesHeight(Stack[-8])
0x7f3: Pop(0)
0x7f4: Push(CvectorIndex(Stack[-6], 1))
0x7f5: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x7f6: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x7f7: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x7f8: Push(CvectorIndex(Stack[-5], 1))
0x7f9: Stack[-1] = (int) 0
0x7fa: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x7fb: Pop(0); Push(Stack[-5] | Stack[-5]);
0x7fc: Pop(1); Push(Sqrt(Stack[-1]))
0x7fd: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x7fe: Stack[-4] = -Stack[-5]; Pop(0);
0x7ff: Push((int) 70)
0x800: Pop(1); Push(Stack[-6] * Stack[-1]);
0x801: Push(CVector(0.0, 10.0, 0.0))
0x802: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x803: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
0x804: @ IsOverrideActive(Stack[-1])
0x805: Pop(0)
0x806: Push(Stack[-1])
0x807: IF (Stack[-1] == 0) GOTO 0x80a; Pop(1)

0x808: Stack[-18] = (bool) 0
0x809: Return(); Pop(16)

0x80a: @ StopWorld()
0x80b: Pop(0)
0x80c: @ CameraTransit(Stack[-2], Stack[-4])
0x80d: Pop(0)
0x80e: Push(CvectorIndex(Stack[-3], 0))
0x80f: Push(CvectorIndex(Stack[-4], 2))
0x810: @ Rotate(Stack[-2], Stack[-1])
0x811: Pop(2)
0x812: @ CameraWaitForPlayFinish()
0x813: Pop(0)
0x814: @ ResumeWorld()
0x815: Pop(0)
0x816: Stack[-18] = (bool) 1
0x817: Return(); Pop(16)

0x818: PushEmpty()
0x819: @ CameraSwitchToNormal()
0x81a: Pop(0)
0x81b: Return(); Pop(0)

0x81c: PushEmpty(float, float, float, float)
0x81d: Push("playing ") // @poff=856
0x81e: Pop(1); Push(Stack[-1] + Stack[-6]);
0x81f: @ Trace(Stack[-1])
0x820: Pop(1)
0x821: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x822: Pop(0)
0x823: @ lshPlayAnimation(Stack[-2], Stack[-1])
0x824: Pop(0)
0x825: Push("start: ") // @poff=874
0x826: Pop(1); Push(Stack[-1] + Stack[-3]);
0x827: @ Trace(Stack[-1])
0x828: Pop(1)
0x829: Push("end: ") // @poff=890
0x82a: Pop(1); Push(Stack[-1] + Stack[-2]);
0x82b: @ Trace(Stack[-1])
0x82c: Pop(1)
0x82d: Return(); Pop(4)

0x82e: PushEmpty(float, cvector, float, cvector)
0x82f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x830: Pop(0)
0x831: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x832: Push(CvectorIndex(Stack[-1], 1))
0x833: Stack[-3] = Stack[-1]
0x834: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x835: Push("head") // @poff=178
0x836: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x837: Pop(1)
0x838: Return(); Pop(4)
...
0x840: PushEmpty(float, float)
0x841: Pop(0); Push(Stack[-3] | Stack[-3]);
0x842: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x843: Push((float)9.999999974752427e-07)
0x844: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x845: IF (Stack[-1] == 0) GOTO 0x848; Pop(1)

0x846: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x847: Return(); Pop(2)

0x848: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x849: Return(); Pop(2)

0x84a: PushEmpty()
0x84b: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x84c: IF (Stack[-1] == 0) GOTO 0x84f; Pop(1)

0x84d: Stack[-2] = Stack[-3]
0x84e: GOTO 0x850

0x84f: Stack[-1] = Stack[-3]
0x850: Return(); Pop(0)

0x851: PushEmpty()
0x852: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x853: IF (Stack[-1] == 0) GOTO 0x856; Pop(1)

0x854: Stack[-2] = Stack[-4]
0x855: Return(); Pop(0)

0x856: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x857: IF (Stack[-1] == 0) GOTO 0x85a; Pop(1)

0x858: Stack[-1] = Stack[-4]
0x859: Return(); Pop(0)

0x85a: Stack[-3] = Stack[-4]
0x85b: Return(); Pop(0)

0x85c: PushEmpty()
0x85d: Push(CvectorIndex(Stack[-2], 0))
0x85e: Push(CvectorIndex(Stack[-2], 0))
0x85f: Pop(2); Push(Stack[-2] * Stack[-1]);
0x860: Push(CvectorIndex(Stack[-3], 2))
0x861: Push(CvectorIndex(Stack[-3], 2))
0x862: Pop(2); Push(Stack[-2] * Stack[-1]);
0x863: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x864: Return(); Pop(0)

0x865: PushEmpty()
0x866: Push(CvectorIndex(Stack[-1], 0))
0x867: Push(CvectorIndex(Stack[-2], 0))
0x868: Pop(2); Push(Stack[-2] * Stack[-1]);
0x869: Push(CvectorIndex(Stack[-2], 2))
0x86a: Push(CvectorIndex(Stack[-3], 2))
0x86b: Pop(2); Push(Stack[-2] * Stack[-1]);
0x86c: Pop(2); Push(Stack[-2] + Stack[-1]);
0x86d: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x86e: Return(); Pop(0)

0x86f: PushEmpty()
0x870: PushEmpty(float, cvector, cvector)
0x871: Stack[-5] = Stack[-2]
0x872: Stack[-4] = Stack[-1]
0x873: Call 0x85c

0x874: Pop(2)
0x875: PushEmpty(float, cvector)
0x876: Stack[-5] = Stack[-1]
0x877: Call 0x865

0x878: Pop(1)
0x879: PushEmpty(float, cvector)
0x87a: Stack[-5] = Stack[-1]
0x87b: Call 0x865

0x87c: Pop(1)
0x87d: Pop(2); Push(Stack[-2] * Stack[-1]);
0x87e: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x87f: Return(); Pop(0)

0x880: PushEmpty()
0x881: PushEmpty(object)
0x882: Stack[-2] = Stack[-1]
0x883: Push(-1, 0); TaskCall(1)
0x884: Call 0x16

0x885: Pop(-1, 0); TaskReturn
0x886: Pop(1)
0x887: Return(); Pop(0)

0x888: PushEmpty(float, float)
0x889: Push("health") // @poff=658
0x88a: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x88b: IF (Stack[-1] == 0) GOTO 0x894; Pop(1)

0x88c: Push("health") // @poff=658
0x88d: @ GetProperty(Stack[-1], Stack[-2])
0x88e: Pop(1)
0x88f: Push((int) 0)
0x890: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x891: IF (Stack[-1] == 0) GOTO 0x894; Pop(1)

0x892: @ SignalDeath(Stack[-4])
0x893: Pop(0)
0x894: Return(); Pop(2)

0x895: PushEmpty()
0x896: PushEmpty(object)
0x897: Stack[-2] = Stack[-1]
0x898: Call 0x880
...
0x89b: PushEmpty()
0x89c: PushEmpty(object, int, float)
0x89d: Stack[-7] = Stack[-3]
0x89e: Stack[-6] = Stack[-2]
...
0x8c7: Push(-1, 1); TaskCall(4)
0x8c8: Call 0x29b

0x8c9: Pop(-1, 1); TaskReturn
0x8ca: Pop(1)
0x8cb: Return(); Pop(0)
...
0x8d8: Stack[-2] = Stack[-1]
0x8d9: Push(-1, 5); TaskCall(5)
0x8da: Call 0x37d

0x8db: Pop(-1, 5); TaskReturn
0x8dc: Pop(1)
0x8dd: Return(); Pop(0)

0x8de: PushEmpty()
0x8df: PushEmpty(int, object)
0x8e0: Stack[-3] = Stack[-1]
0x8e1: Call 0x8cc

0x8e2: Stack[-2] = Stack[-4]
0x8e3: Pop(2)
0x8e4: Return(); Pop(0)

0x8e5: PushEmpty()
0x8e6: PushEmpty(object)
0x8e7: Stack[-2] = Stack[-1]
0x8e8: Call 0x8d6
...
0x8ff: PushEmpty(int, int)
0x900: Push("player") // @poff=902
0x901: @ GetVariable(Stack[-1], Stack[-2])
0x902: Pop(1)
0x903: Push((int) 0)
0x904: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x905: IF (Stack[-1] == 0) GOTO 0x909; Pop(1)

0x906: Stack[-3] = (int) 200001
0x907: Return(); Pop(2)
...
0x90c: Stack[-3] = (int) 200002
0x90d: Return(); Pop(2)

0x90e: Stack[-3] = (int) 200003
0x90f: Return(); Pop(2)

0x910: Stack[-1] = (int) 3348
0x911: Return(); Pop(0)

0x912: Stack[-1] = "ui/NPC_None.png" // @poff=916
0x913: Return(); Pop(0)

0x914: Stack[-1] = (bool) 0
0x915: Return(); Pop(0)

0x916: Push(GlobalVars[0])
0x917: Stack[-1] = (bool) 0
0x918: GlobalVars[0] = Stack[-1]; Pop(1)
0x919: Return(); Pop(0)

0x91a: PushEmpty(bool, bool)
0x91b: Push(GlobalVars[0])
0x91c: IF (Stack[-1] == 0) GOTO 0x925; Pop(1)

0x91d: @ IsOverrideActive(Stack[-1])
0x91e: Pop(0)
0x91f: Pop(0); Push((bool) Stack[-1] == 0)
0x920: IF (Stack[-1] == 0) GOTO 0x923; Pop(1)

0x921: @ WorkWithCorpse(Stack[-3])
0x922: Pop(0)
0x923: Return(); Pop(2)
...
0x925: Push((int) 1000)
0x926: PushEmpty(int, object)
0x927: Stack[-6] = Stack[-1]
0x928: Push(-2, 1); TaskCall(7)
0x929: Call 0x614

0x92a: Pop(-2, 1); TaskReturn
0x92b: Pop(1)
0x92c: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x92d: IF (Stack[-1] == 0) GOTO 0x93f; Pop(1)

0x92e: PushEmpty(bool, object)
0x92f: Stack[-5] = Stack[-1]
0x930: Call 0x7e8

0x931: Pop(1)
0x932: Pop(1); Push((bool) Stack[-1] == 0)
0x933: IF (Stack[-1] == 0) GOTO 0x935; Pop(1)

0x934: Return(); Pop(2)

0x935: PushEmpty(object)
0x936: Stack[-4] = Stack[-1]
0x937: Push(-1, 1); TaskCall(0)
0x938: Call 0x0

0x939: Pop(-1, 1); TaskReturn
0x93a: Pop(1)
0x93b: PushEmpty(object)
0x93c: Stack[-4] = Stack[-1]
0x93d: Call 0x818
...
0x942: PushEmpty()
0x943: Stack[-3] = (bool) 0
0x944: Return(); Pop(0)

0x945: PushEmpty()
0x946: Push(GlobalVars[0])
0x947: Stack[-1] = (bool) 1
0x948: GlobalVars[0] = Stack[-1]; Pop(1)
0x949: Push((int) 50)
0x94a: Push((int) 40)
0x94b: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x94c: Pop(2)
0x94d: Return(); Pop(0)
