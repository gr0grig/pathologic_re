...
Strings:
	...
	W:2
	W:idle
// @pool_raw:
...
0x36f: PushEmpty()
0x370: Stack[-3] = (float) 0.029999999329447746
0x371: Return(); Pop(0)
...
0x60e: Push("HasProperty") // @poff=502
0x60f: Push((int) 2)
...
0x615: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=526
0x616: Pop(0)
...
0x62c: Push("armor") // @poff=552
0x62d: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=564
0x62e: Pop(1)
0x62f: Push("armor_") // @poff=576
...
0x63e: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=564
0x63f: Pop(0)
...
0x647: Pop(3)
0x648: Push("health") // @poff=538
0x649: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=564
0x64a: Pop(1)
0x64b: Push((int) 1)
0x64c: Pop(1); Push(Stack[-1] - Stack[-4]);
0x64d: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x64e: Push("health") // @poff=538
...
0x654: Pop(3)
0x655: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=590
0x656: Pop(2)
0x657: Stack[-1] = Stack[-16]
0x658: Return(); Pop(12)

0x659: PushEmpty(bool, bool)
0x65a: @@ IsDead(Stack[-1]); Obj=3 // @poff=602
0x65b: Pop(0)
0x65c: Stack[-1] = Stack[-4]
0x65d: Return(); Pop(2)

0x65e: PushEmpty(object, object, object, object)
0x65f: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x673: Pop(0)
0x674: Pop(0); PushNull((bool) Stack[-2] == 0)
0x675: IF (Stack[-1] == 0) GOTO 0x678; Pop(1)

0x676: Stack[-6] = (bool) 0
0x677: Return(); Pop(4)

0x678: @@ GetScene(Stack[-1]); Obj=5 // @poff=623
0x679: Pop(0)
...
0x68c: Stack[-6] = Stack[-2]
0x68d: Stack[-1] = "noaccess" // @poff=632
0x68e: Call 0x60d
...
0x694: Push("noaccess") // @poff=632
0x695: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=564
0x696: Pop(1)
0x697: Push((int) 0)
...
0x6c0: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x6c1: Pop(0)
...
0x6d1: Stack[-1] = "fhit" // @poff=688
0x6d2: GOTO 0x6d4

0x6d3: Stack[-1] = "bhit" // @poff=698
0x6d4: Push("hit_react") // @poff=708
0x6d5: Push("1") // @poff=728
0x6d6: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6d7: Push("2") // @poff=732
...
0x6de: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x6df: Pop(0)
...
0x6ee: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x6ef: Pop(0)
...
0x71f: Stack[-5] = Stack[-2]
0x720: Stack[-4] = Stack[-1]
0x721: Call 0x70a

0x722: Pop(2)
0x723: PushEmpty(float, cvector)
0x724: Stack[-5] = Stack[-1]
0x725: Call 0x713
...
0x74b: Stack[-7] = Stack[-3]
0x74c: Stack[-6] = Stack[-2]
...
0x759: Stack[-2] = (int) 0
0x75a: Push("all") // @poff=170
0x75b: PushEmpty(string, int)
0x75c: Stack[-5] = Stack[-1]
0x75d: Call 0x751
