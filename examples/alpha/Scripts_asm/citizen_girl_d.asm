...
Strings:
	...
	W:class
	W:rat
// @pool_raw:
...
0x5b0: Push((float)9.999999974752427e-07)
...
0x5d4: Stack[-5] = Stack[-2]
0x5d5: Stack[-4] = Stack[-1]
0x5d6: Call 0x5bf
...
0x673: Push("GenerateMoney: iMin > iMax") // @poff=502
0x674: @ Trace(Stack[-1])
0x675: Pop(1)
0x676: Return(); Pop(8)
...
0x6d6: Stack[-8] = Stack[-2]
0x6d7: Stack[-1] = "class" // @poff=590
0x6d8: Call 0x502
...
0x6de: Push("class") // @poff=590
0x6df: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=380
0x6e0: Pop(1)
0x6e1: Push("rat") // @poff=602
...
0x6ea: Push(Stack[-2])
0x6eb: IF (Stack[-1] == 1) GOTO 0x6f4; Pop(1)

0x6ec: PushEmpty(float, object)
0x6ed: Stack[-9] = Stack[-1]
0x6ee: Call 0x4fa
...
0x6f5: Push((float)-0.30000001192092896)
