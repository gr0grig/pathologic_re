...
Strings:
	...
	W:class
	W:rat
// @pool_raw:
...
0x957: Push("reputation") // @poff=905
0x958: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=500
0x959: Pop(1)
0x95a: Stack[-1] = Stack[-5]
0x95b: Return(); Pop(4)

0x95c: Stack[-2] = 0
0x95d: Stack[-1] = (int) 3345
0x95e: Return(); Pop(0)

0x95f: Stack[-1] = "ui/NPC_None.png" // @poff=927
0x960: Return(); Pop(0)
...
0x9a1: Push("class") // @poff=959
0x9a2: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=500
0x9a3: Pop(1)
0x9a4: Push("rat") // @poff=971
...
0x9c1: Push(Stack[-2])
0x9c2: IF (Stack[-1] == 1) GOTO 0x9cb; Pop(1)

0x9c3: PushEmpty(float, object)
0x9c4: Stack[-8] = Stack[-1]
0x9c5: Call 0x693

0x9c6: Pop(1)
0x9c7: Push((float)250000.0)
0x9c8: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x9c9: IF (Stack[-1] == 1) GOTO 0x9cb; Pop(1)
