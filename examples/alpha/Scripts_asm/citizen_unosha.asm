...
Strings:
	...
	W:woman
	W:unosha
// @pool_raw:
...
0x66f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x670: Pop(3)
0x671: Push((int) 14572)
0x672: Push((int) -1)
0x673: Push((int) 15806)
0x674: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x675: Pop(3)
0x676: Push((int) 14573)
0x677: Push((int) -1)
0x678: Push((int) 15807)
0x679: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x67a: Pop(3)
...
0x688: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x689: Pop(3)
0x68a: Push((int) 14578)
0x68b: Push((int) -1)
0x68c: Push((int) 15812)
0x68d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x68e: Pop(3)
0x68f: GOTO 0x6a6

0x690: PushEmpty(string)
0x691: Stack[-1] = "Neutral" // @poff=553
0x692: Call 0x6c4

0x693: Pop(1)
0x694: Push((int) 14579)
0x695: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x696: Pop(1)
0x697: @@@ ClearReplies(); Obj=0 // @poff=580
0x698: Pop(0)
...
0x6a1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6a2: Pop(3)
0x6a3: GOTO 0x6a6
...
0x6b5: Push("all") // @poff=0
0x6b6: Push("idle") // @poff=8
...
0x6be: Push("all") // @poff=0
0x6bf: Push("idle") // @poff=8
...
0x6de: Stack[-1] = "Neutral" // @poff=553
0x6df: Call 0x6c4

0x6e0: Pop(1)
0x6e1: Push((int) 14538)
0x6e2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6e3: Pop(1)
0x6e4: @@@ ClearReplies(); Obj=0 // @poff=580
0x6e5: Pop(0)
0x6e6: Push((int) 14539)
0x6e7: Push((int) 15771)
0x6e8: Push((int) 15770)
0x6e9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6ea: Pop(3)
0x6eb: Push((int) 14564)
0x6ec: Push((int) 15799)
0x6ed: Push((int) 15798)
0x6ee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6ef: Pop(3)
0x6f0: Push((int) 14571)
0x6f1: Push((int) -1)
0x6f2: Push((int) 15805)
0x6f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6f4: Pop(3)
0x6f5: Push((int) 14572)
0x6f6: Push((int) -1)
0x6f7: Push((int) 15806)
0x6f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6f9: Pop(3)
0x6fa: Push((int) 14573)
0x6fb: Push((int) -1)
0x6fc: Push((int) 15807)
0x6fd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6fe: Pop(3)
0x6ff: Push((int) 14574)
0x700: Push((int) -1)
0x701: Push((int) 15808)
0x702: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x703: Pop(3)
0x704: Push((int) 14575)
0x705: Push((int) -1)
0x706: Push((int) 15809)
0x707: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x708: Pop(3)
0x709: Push((int) 14576)
0x70a: Push((int) 15811)
0x70b: Push((int) 15810)
0x70c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x70d: Pop(3)
0x70e: Push((int) 14578)
0x70f: Push((int) -1)
0x710: Push((int) 15812)
0x711: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x712: Pop(3)
0x713: Return(); Pop(0)

0x714: PushEmpty(string)
0x715: Stack[-1] = "Neutral" // @poff=553
0x716: Call 0x6c4

0x717: Pop(1)
0x718: Push((int) 14579)
0x719: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x71a: Pop(1)
0x71b: @@@ ClearReplies(); Obj=0 // @poff=580
0x71c: Pop(0)
0x71d: Push((int) 14580)
0x71e: Push((int) 15815)
0x71f: Push((int) 15814)
0x720: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x721: Pop(3)
0x722: Push((int) 14589)
0x723: Push((int) -1)
0x724: Push((int) 15823)
0x725: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x726: Pop(3)
0x727: Return(); Pop(0)
...
0x72c: Stack[-1] = "Neutral" // @poff=553
0x72d: Call 0x6c4

0x72e: Pop(1)
0x72f: Push((int) 14581)
0x730: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x731: Pop(1)
0x732: @@@ ClearReplies(); Obj=0 // @poff=580
0x733: Pop(0)
0x734: Push((int) 14582)
0x735: Push((int) 15817)
0x736: Push((int) 15816)
0x737: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x738: Pop(3)
0x739: Push((int) 14585)
0x73a: Push((int) 15820)
0x73b: Push((int) 15819)
0x73c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x73d: Pop(3)
0x73e: Return(); Pop(0)
...
0x743: Stack[-1] = "Neutral" // @poff=553
0x744: Call 0x6c4

0x745: Pop(1)
0x746: Push((int) 14586)
0x747: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x748: Pop(1)
0x749: @@@ ClearReplies(); Obj=0 // @poff=580
0x74a: Pop(0)
0x74b: Push((int) 14587)
0x74c: Push((int) -1)
0x74d: Push((int) 15821)
0x74e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x74f: Pop(3)
0x750: Push((int) 14588)
0x751: Push((int) -1)
0x752: Push((int) 15822)
0x753: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x754: Pop(3)
0x755: Return(); Pop(0)
...
0x75a: Stack[-1] = "Neutral" // @poff=553
0x75b: Call 0x6c4

0x75c: Pop(1)
0x75d: Push((int) 14583)
0x75e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x75f: Pop(1)
0x760: @@@ ClearReplies(); Obj=0 // @poff=580
0x761: Pop(0)
0x762: Push((int) 14584)
0x763: Push((int) -1)
0x764: Push((int) 15818)
0x765: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x766: Pop(3)
0x767: Return(); Pop(0)
...
0x76c: Stack[-1] = "Neutral" // @poff=553
0x76d: Call 0x6c4

0x76e: Pop(1)
0x76f: Push((int) 14577)
0x770: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x771: Pop(1)
0x772: @@@ ClearReplies(); Obj=0 // @poff=580
0x773: Pop(0)
0x774: Return(); Pop(0)
...
0x779: Stack[-1] = "Neutral" // @poff=553
0x77a: Call 0x6c4

0x77b: Pop(1)
0x77c: Push((int) 14565)
0x77d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x77e: Pop(1)
0x77f: @@@ ClearReplies(); Obj=0 // @poff=580
0x780: Pop(0)
0x781: Push((int) 14566)
0x782: Push((int) 15801)
0x783: Push((int) 15800)
0x784: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x785: Pop(3)
0x786: Return(); Pop(0)
...
0x78b: Stack[-1] = "Neutral" // @poff=553
0x78c: Call 0x6c4

0x78d: Pop(1)
0x78e: Push((int) 14567)
0x78f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x790: Pop(1)
0x791: @@@ ClearReplies(); Obj=0 // @poff=580
0x792: Pop(0)
...
0x79b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x79c: Pop(3)
0x79d: Return(); Pop(0)
...
0x7a2: Stack[-1] = "Neutral" // @poff=553
0x7a3: Call 0x6c4

0x7a4: Pop(1)
0x7a5: Push((int) 14569)
0x7a6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7a7: Pop(1)
0x7a8: @@@ ClearReplies(); Obj=0 // @poff=580
0x7a9: Pop(0)
0x7aa: Return(); Pop(0)
...
0x7af: Stack[-1] = "Neutral" // @poff=553
0x7b0: Call 0x6c4

0x7b1: Pop(1)
0x7b2: Push((int) 14540)
0x7b3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7b4: Pop(1)
0x7b5: @@@ ClearReplies(); Obj=0 // @poff=580
0x7b6: Pop(0)
0x7b7: Push((int) 14541)
0x7b8: Push((int) 15773)
0x7b9: Push((int) 15772)
0x7ba: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7bb: Pop(3)
0x7bc: Push((int) 14545)
0x7bd: Push((int) 15778)
0x7be: Push((int) 15777)
0x7bf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7c0: Pop(3)
0x7c1: Push((int) 14557)
0x7c2: Push((int) 15790)
0x7c3: Push((int) 15789)
0x7c4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7c5: Pop(3)
0x7c6: Push((int) 14563)
0x7c7: Push((int) -1)
0x7c8: Push((int) 15797)
0x7c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7ca: Pop(3)
0x7cb: Return(); Pop(0)
...
0x7d0: Stack[-1] = "Neutral" // @poff=553
0x7d1: Call 0x6c4

0x7d2: Pop(1)
0x7d3: Push((int) 14558)
0x7d4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7d5: Pop(1)
0x7d6: @@@ ClearReplies(); Obj=0 // @poff=580
0x7d7: Pop(0)
0x7d8: Push((int) 14559)
0x7d9: Push((int) 15773)
0x7da: Push((int) 15791)
0x7db: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7dc: Pop(3)
0x7dd: Push((int) 14560)
0x7de: Push((int) 15794)
0x7df: Push((int) 15793)
0x7e0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7e1: Pop(3)
0x7e2: Return(); Pop(0)
...
0x7e7: Stack[-1] = "Neutral" // @poff=553
0x7e8: Call 0x6c4

0x7e9: Pop(1)
0x7ea: Push((int) 14561)
0x7eb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7ec: Pop(1)
0x7ed: @@@ ClearReplies(); Obj=0 // @poff=580
0x7ee: Pop(0)
0x7ef: Push((int) 14562)
0x7f0: Push((int) 15778)
0x7f1: Push((int) 15795)
0x7f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7f3: Pop(3)
0x7f4: Return(); Pop(0)
...
0x7f9: Stack[-1] = "Neutral" // @poff=553
0x7fa: Call 0x6c4

0x7fb: Pop(1)
0x7fc: Push((int) 14546)
0x7fd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7fe: Pop(1)
0x7ff: @@@ ClearReplies(); Obj=0 // @poff=580
0x800: Pop(0)
0x801: Push((int) 14547)
0x802: Push((int) 15780)
0x803: Push((int) 15779)
0x804: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x805: Pop(3)
0x806: Push((int) 14556)
0x807: Push((int) -1)
0x808: Push((int) 15788)
0x809: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x80a: Pop(3)
0x80b: Return(); Pop(0)
...
0x810: Stack[-1] = "Neutral" // @poff=553
0x811: Call 0x6c4

0x812: Pop(1)
0x813: Push((int) 14548)
0x814: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x815: Pop(1)
0x816: @@@ ClearReplies(); Obj=0 // @poff=580
0x817: Pop(0)
0x818: Push((int) 14549)
0x819: Push((int) 15782)
0x81a: Push((int) 15781)
0x81b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x81c: Pop(3)
0x81d: Push((int) 14555)
0x81e: Push((int) -1)
0x81f: Push((int) 15787)
0x820: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x821: Pop(3)
0x822: Return(); Pop(0)
...
0x827: Stack[-1] = "Neutral" // @poff=553
0x828: Call 0x6c4

0x829: Pop(1)
0x82a: Push((int) 14550)
0x82b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x82c: Pop(1)
0x82d: @@@ ClearReplies(); Obj=0 // @poff=580
0x82e: Pop(0)
0x82f: Push((int) 14551)
0x830: Push((int) 15784)
0x831: Push((int) 15783)
0x832: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x833: Pop(3)
0x834: Push((int) 14554)
0x835: Push((int) -1)
0x836: Push((int) 15786)
0x837: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x838: Pop(3)
0x839: Return(); Pop(0)
...
0x83e: Stack[-1] = "Neutral" // @poff=553
0x83f: Call 0x6c4

0x840: Pop(1)
0x841: Push((int) 14552)
0x842: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x843: Pop(1)
0x844: @@@ ClearReplies(); Obj=0 // @poff=580
0x845: Pop(0)
0x846: Push((int) 14553)
0x847: Push((int) -1)
0x848: Push((int) 15785)
0x849: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x84a: Pop(3)
0x84b: Return(); Pop(0)
...
0x850: Stack[-1] = "Neutral" // @poff=553
0x851: Call 0x6c4

0x852: Pop(1)
0x853: Push((int) 14542)
0x854: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x855: Pop(1)
0x856: @@@ ClearReplies(); Obj=0 // @poff=580
0x857: Pop(0)
0x858: Push((int) 14543)
0x859: Push((int) 15778)
0x85a: Push((int) 15774)
0x85b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x85c: Pop(3)
0x85d: Push((int) 14544)
0x85e: Push((int) -1)
0x85f: Push((int) 15776)
0x860: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x861: Pop(3)
0x862: Return(); Pop(0)
...
0x874: Stack[-2] = "fire" // @poff=602
0x875: Return(); Pop(0)

0x876: Stack[-2] = "phys" // @poff=612
0x877: Return(); Pop(0)

0x878: PushEmpty(cvector, cvector, cvector, cvector)
0x879: @ GetPosition(Stack[-2])
0x87a: Pop(0)
0x87b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x87c: Pop(0)
...
0x881: Pop(0)
0x882: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x883: Pop(0)
...
0x888: Push("HasProperty") // @poff=622
0x889: Push((int) 2)
...
0x88f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x890: Pop(0)
0x891: Stack[-1] = Stack[-5]
0x892: Return(); Pop(2)

0x893: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x894: PushEmpty(bool, object, string)
0x895: Stack[-18] = Stack[-2]
0x896: Stack[-1] = "health" // @poff=658
0x897: Call 0x887
...
0x89e: Stack[-18] = Stack[-2]
0x89f: Stack[-1] = "armor" // @poff=672
0x8a0: Call 0x887
...
0x8a6: Push("armor") // @poff=672
0x8a7: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x8a8: Pop(1)
0x8a9: Push("armor_") // @poff=696
0x8aa: PushEmpty(string, int)
0x8ab: Stack[-16] = Stack[-1]
0x8ac: Call 0x870

0x8ad: Pop(1)
0x8ae: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x8af: PushEmpty(bool, object, string)
0x8b0: Stack[-18] = Stack[-2]
0x8b1: Stack[-8] = Stack[-1]
0x8b2: Call 0x887
...
0x8b8: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x8b9: Pop(0)
...
0x8c0: Stack[-3] = Stack[-6]
0x8c1: Pop(3)
0x8c2: Push("health") // @poff=658
0x8c3: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x8c4: Pop(1)
0x8c5: Push((int) 1)
0x8c6: Pop(1); Push(Stack[-1] - Stack[-4]);
0x8c7: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x8c8: Push("health") // @poff=658
...
0x8ce: Pop(3)
0x8cf: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x8d0: Pop(2)
0x8d1: Stack[-1] = Stack[-16]
0x8d2: Return(); Pop(12)

0x8d3: PushEmpty(bool, bool)
0x8d4: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x8d5: Pop(0)
0x8d6: Stack[-1] = Stack[-4]
0x8d7: Return(); Pop(2)

0x8d8: PushEmpty(object, object, object, object)
0x8d9: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x8ed: Pop(0)
0x8ee: Pop(0); PushNull((bool) Stack[-2] == 0)
0x8ef: IF (Stack[-1] == 0) GOTO 0x8f2; Pop(1)

0x8f0: Stack[-6] = (bool) 0
0x8f1: Return(); Pop(4)

0x8f2: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x8f3: Pop(0)
...
0x906: Stack[-6] = Stack[-2]
0x907: Stack[-1] = "noaccess" // @poff=752
0x908: Call 0x887
...
0x90e: Push("noaccess") // @poff=752
0x90f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x910: Pop(1)
0x911: Push((int) 0)
...
0x93a: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x93b: Pop(0)
...
0x94b: Stack[-1] = "fhit" // @poff=808
0x94c: GOTO 0x94e

0x94d: Stack[-1] = "bhit" // @poff=818
0x94e: Push("hit_react") // @poff=828
0x94f: Push("1") // @poff=848
0x950: Pop(1); Push(Stack[-3] + Stack[-1]);
0x951: Push("2") // @poff=852
...
0x958: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x959: Pop(0)
...
0x968: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x969: Pop(0)
0x96a: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x96b: Pop(0)
...
0x9a4: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x9a5: Pop(0)
0x9a6: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x9a7: Pop(0)
...
0x9df: Pop(0)
0x9e0: Push("start: ") // @poff=874
0x9e1: Pop(1); Push(Stack[-1] + Stack[-3]);
0x9e2: @ Trace(Stack[-1])
0x9e3: Pop(1)
0x9e4: Push("end: ") // @poff=890
...
0x9fe: Push((float)9.999999974752427e-07)
...
0xa2c: Stack[-5] = Stack[-2]
0xa2d: Stack[-4] = Stack[-1]
0xa2e: Call 0xa17

0xa2f: Pop(2)
0xa30: PushEmpty(float, cvector)
0xa31: Stack[-5] = Stack[-1]
0xa32: Call 0xa20

0xa33: Pop(1)
0xa34: PushEmpty(float, cvector)
0xa35: Stack[-5] = Stack[-1]
0xa36: Call 0xa20
...
0xa61: Stack[-7] = Stack[-3]
0xa62: Stack[-6] = Stack[-2]
...
0xb00: Push("GenerateMoney: iMin > iMax") // @poff=930
0xb01: @ Trace(Stack[-1])
0xb02: Pop(1)
0xb03: Return(); Pop(8)
...
0xb54: Stack[-1] = "syringe" // @poff=1028
0xb55: Call 0xbca
...
0xb92: Stack[-1] = "bracelet" // @poff=1080
0xb93: Call 0xbca
...
0xb9e: Stack[-1] = "ear_ring" // @poff=1098
0xb9f: Call 0xbca
...
0xbaa: Stack[-1] = "gold_ring" // @poff=1116
0xbab: Call 0xbca
...
0xbb6: Stack[-1] = "silver_ring" // @poff=1136
0xbb7: Call 0xbca
...
0xbc2: Stack[-1] = "flower" // @poff=1160
0xbc3: Call 0xbca
...
0xbd1: Stack[-1] = "ui/NPC_None.png" // @poff=1174
0xbd2: Return(); Pop(0)
...
0xc0a: Stack[-8] = Stack[-2]
0xc0b: Stack[-1] = "class" // @poff=1206
0xc0c: Call 0x887
...
0xc12: Push("class") // @poff=1206
0xc13: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=684
0xc14: Pop(1)
...
0xc33: Push("wasted_girl") // @poff=1260
