...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x3b0: Pop(0)
0x3b1: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x3b2: Pop(0)
...
0x3cf: Stack[-1] = (float) 1.7453293800354004
0x3d0: Call 0x3ae

0x3d1: Stack[-2] = Stack[-7]
0x3d2: Pop(2)
...
0x3d7: Push("Can't retreat, distance: ") // @poff=264
...
0x3ed: Push((int) 1)
0x3ee: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3ef: Pop(1)
0x3f0: Push(Stack[-3])
0x3f1: IF (Stack[-1] == 0) GOTO 0x409; Pop(1)

0x3f2: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3f7: Stack[-1] = (float) 2.6179938316345215
0x3f8: Call 0x3ae

0x3f9: Stack[-2] = Stack[-4]
0x3fa: Pop(2)
...
0x40a: IF (Stack[-1] == 1) GOTO 0x3ed; Pop(1)
...
0x411: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x420: Stack[-1] = (float) 1.7453293800354004
0x421: Call 0x3ae

0x422: Stack[-2] = Stack[-4]
0x423: Pop(2)
...
0x430: IF (Stack[-1] == 1) GOTO 0x436; Pop(1)
...
0x45c: Pop(2)
0x45d: Push((float)-0.3420201241970062)
...
0x462: Pop(0)
0x463: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x464: Pop(0)
...
0x481: Stack[-1] = (float) 1.7453293800354004
0x482: Call 0x460

0x483: Stack[-2] = Stack[-7]
0x484: Pop(2)
...
0x489: Push("Can't retreat, distance: ") // @poff=264
...
0x49f: Push((int) 1)
0x4a0: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x4a1: Pop(1)
0x4a2: Push(Stack[-3])
0x4a3: IF (Stack[-1] == 0) GOTO 0x4bb; Pop(1)

0x4a4: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4a9: Stack[-1] = (float) 2.6179938316345215
0x4aa: Call 0x460
...
0x4bc: IF (Stack[-1] == 1) GOTO 0x49f; Pop(1)
...
0x4c3: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4d2: Stack[-1] = (float) 1.7453293800354004
0x4d3: Call 0x460

0x4d4: Stack[-2] = Stack[-4]
0x4d5: Pop(2)
...
0x4e2: IF (Stack[-1] == 1) GOTO 0x4e8; Pop(1)

0x4e3: PushEmpty(bool)
0x4e4: Call 0x502

0x4e5: Pop(0)
0x4e6: IF (Stack[-1] == 1) GOTO 0x4e8; Pop(1)
...
0x508: Stack[-2] = Stack[-3]
0x509: Pop(2)
0x50a: PushEmpty(float, cvector, cvector)
0x50b: Stack[-5] = Stack[-2]
0x50c: Stack[-4] = Stack[-1]
0x50d: Call 0x625

0x50e: Pop(2)
0x50f: Push((float)-0.3420201241970062)
...
0x519: Pop(0)
0x51a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x51b: Pop(0)
...
0x520: Pop(0)
0x521: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x522: Pop(0)
...
0x527: Push("HasProperty") // @poff=316
0x528: Push((int) 2)
...
0x52e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=340
0x52f: Pop(0)
...
0x53c: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=352
0x53d: Pop(0)
0x53e: PushEmpty(float, float, float, float)
0x53f: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x540: Stack[-8] = Stack[-2]
0x541: Stack[-7] = Stack[-1]
0x542: Call 0x61a

0x543: Pop(3)
0x544: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=364
0x545: Pop(1)
...
0x54a: Stack[-11] = Stack[-2]
0x54b: Stack[-1] = "disease" // @poff=376
0x54c: Call 0x526
...
0x553: Stack[-11] = Stack[-2]
0x554: Stack[-1] = "armor_disease" // @poff=392
0x555: Call 0x526

0x556: Pop(2)
0x557: IF (Stack[-1] == 0) GOTO 0x566; Pop(1)

0x558: Push("armor_disease") // @poff=392
0x559: @@ GetProperty(Stack[-1], Stack[-4]); Obj=9 // @poff=352
0x55a: Pop(1)
0x55b: Push((int) 100)
...
0x567: Stack[-11] = Stack[-2]
0x568: Stack[-1] = "immunity" // @poff=420
0x569: Call 0x526

0x56a: Pop(2)
0x56b: IF (Stack[-1] == 0) GOTO 0x57d; Pop(1)

0x56c: Push("immunity") // @poff=420
0x56d: @@ GetProperty(Stack[-1], Stack[-2]); Obj=9 // @poff=352
0x56e: Pop(1)
0x56f: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x570: IF (Stack[-1] == 0) GOTO 0x577; Pop(1)

0x571: Push("immunity") // @poff=420
0x572: Push((int) 0)
0x573: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=364
0x574: Pop(2)
0x575: Stack[-2] = Stack[-7] - Stack[-1]; Pop(0);
0x576: GOTO 0x57d

0x577: Push("immunity") // @poff=420
0x578: Pop(0); Push(Stack[-2] - Stack[-8]);
0x579: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=364
0x57a: Pop(2)
0x57b: Stack[-7] = Stack[-9]
0x57c: Return(); Pop(6)

0x57d: PushEmpty(bool, object, string, float, float, float)
0x57e: Stack[-14] = Stack[-5]
0x57f: Stack[-4] = "disease" // @poff=376
0x580: Stack[-8] = Stack[-3]
0x581: Stack[-2] = (int) 0
0x582: Stack[-1] = (int) 1
0x583: Call 0x532

0x584: Pop(6)
0x585: Stack[-7] = Stack[-9]
0x586: Return(); Pop(6)

0x587: PushEmpty(bool, bool)
0x588: @@ IsDead(Stack[-1]); Obj=3 // @poff=438
0x589: Pop(0)
0x58a: Stack[-1] = Stack[-4]
0x58b: Return(); Pop(2)

0x58c: PushEmpty(object, object, object, object)
0x58d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5a1: Pop(0)
0x5a2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5a3: IF (Stack[-1] == 0) GOTO 0x5a6; Pop(1)

0x5a4: Stack[-6] = (bool) 0
0x5a5: Return(); Pop(4)

0x5a6: @@ GetScene(Stack[-1]); Obj=5 // @poff=459
0x5a7: Pop(0)
...
0x5ba: Stack[-6] = Stack[-2]
0x5bb: Stack[-1] = "noaccess" // @poff=468
0x5bc: Call 0x526
...
0x5c2: Push("noaccess") // @poff=468
0x5c3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=352
0x5c4: Pop(1)
0x5c5: Push((int) 0)
...
0x5ee: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x5ef: Pop(0)
...
0x5ff: Stack[-1] = "fhit" // @poff=524
0x600: GOTO 0x602

0x601: Stack[-1] = "bhit" // @poff=534
0x602: Push("hit_react") // @poff=544
0x603: Push("1") // @poff=564
0x604: Pop(1); Push(Stack[-3] + Stack[-1]);
0x605: Push("2") // @poff=568
...
0x6b7: Push("GenerateMoney: iMin > iMax") // @poff=596
0x6b8: @ Trace(Stack[-1])
0x6b9: Pop(1)
0x6ba: Return(); Pop(8)
...
0x70b: Stack[-1] = "syringe" // @poff=694
0x70c: Call 0x781
...
0x749: Stack[-1] = "bracelet" // @poff=746
0x74a: Call 0x781
...
0x755: Stack[-1] = "ear_ring" // @poff=764
0x756: Call 0x781
...
0x761: Stack[-1] = "gold_ring" // @poff=782
0x762: Call 0x781
...
0x76d: Stack[-1] = "silver_ring" // @poff=802
0x76e: Call 0x781
...
0x7a5: Stack[-8] = Stack[-2]
0x7a6: Stack[-1] = "class" // @poff=840
0x7a7: Call 0x526
...
0x7ad: Push("class") // @poff=840
0x7ae: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=352
0x7af: Pop(1)
0x7b0: Push("rat") // @poff=852
