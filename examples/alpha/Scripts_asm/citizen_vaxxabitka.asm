...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x569: Push("all") // @poff=0
0x56a: Push("idle") // @poff=8
...
0x572: Push("all") // @poff=0
0x573: Push("idle") // @poff=8
...
0x58d: Pop(0)
0x58e: Push((int) 16507)
0x58f: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x590: IF (Stack[-1] == 0) GOTO 0x5a0; Pop(1)

0x591: PushEmpty(string)
0x592: Stack[-1] = "Neutral" // @poff=367
0x593: Call 0x578

0x594: Pop(1)
0x595: Push((int) 15230)
0x596: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x597: Pop(1)
0x598: @@@ ClearReplies(); Obj=0 // @poff=394
0x599: Pop(0)
0x59a: Push((int) 15231)
0x59b: Push((int) -1)
0x59c: Push((int) 16508)
0x59d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x59e: Pop(3)
0x59f: Return(); Pop(0)
...
0x5b4: Pop(0)
0x5b5: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x5b6: Pop(0)
...
0x5bb: Pop(0)
0x5bc: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x5bd: Pop(0)
...
0x5c2: Push("HasProperty") // @poff=416
0x5c3: Push((int) 2)
...
0x5c9: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=440
0x5ca: Pop(0)
0x5cb: Stack[-1] = Stack[-5]
0x5cc: Return(); Pop(2)

0x5cd: PushEmpty(bool, bool)
0x5ce: @@ IsDead(Stack[-1]); Obj=3 // @poff=452
0x5cf: Pop(0)
0x5d0: Stack[-1] = Stack[-4]
0x5d1: Return(); Pop(2)

0x5d2: PushEmpty(object, object, object, object)
0x5d3: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5e7: Pop(0)
0x5e8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5e9: IF (Stack[-1] == 0) GOTO 0x5ec; Pop(1)

0x5ea: Stack[-6] = (bool) 0
0x5eb: Return(); Pop(4)

0x5ec: @@ GetScene(Stack[-1]); Obj=5 // @poff=473
0x5ed: Pop(0)
...
0x600: Stack[-6] = Stack[-2]
0x601: Stack[-1] = "noaccess" // @poff=482
0x602: Call 0x5c1
...
0x608: Push("noaccess") // @poff=482
0x609: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=500
0x60a: Pop(1)
0x60b: Push((int) 0)
...
0x634: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x635: Pop(0)
...
0x645: Stack[-1] = "fhit" // @poff=550
0x646: GOTO 0x648

0x647: Stack[-1] = "bhit" // @poff=560
0x648: Push("hit_react") // @poff=570
0x649: Push("1") // @poff=590
0x64a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x64b: Push("2") // @poff=594
...
0x652: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x653: Pop(0)
...
0x662: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x663: Pop(0)
0x664: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x665: Pop(0)
...
0x69e: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x69f: Pop(0)
0x6a0: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x6a1: Pop(0)
...
0x6d9: Pop(0)
0x6da: Push("start: ") // @poff=616
0x6db: Pop(1); Push(Stack[-1] + Stack[-3]);
0x6dc: @ Trace(Stack[-1])
0x6dd: Pop(1)
0x6de: Push("end: ") // @poff=632
...
0x6e4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x6e5: Pop(0)
...
0x6f8: Push((float)9.999999974752427e-07)
...
0x751: Stack[-7] = Stack[-3]
0x752: Stack[-6] = Stack[-2]
...
0x7cc: Push("GenerateMoney: iMin > iMax") // @poff=672
0x7cd: @ Trace(Stack[-1])
0x7ce: Pop(1)
0x7cf: Return(); Pop(8)
...
0x820: Stack[-1] = "syringe" // @poff=770
0x821: Call 0x896
...
0x85e: Stack[-1] = "bracelet" // @poff=822
0x85f: Call 0x896
...
0x86a: Stack[-1] = "ear_ring" // @poff=840
0x86b: Call 0x896
...
0x876: Stack[-1] = "gold_ring" // @poff=858
0x877: Call 0x896
...
0x882: Stack[-1] = "silver_ring" // @poff=878
0x883: Call 0x896
...
0x89b: Stack[-1] = (int) 3351
0x89c: Return(); Pop(0)

0x89d: Stack[-1] = "ui/NPC_None.png" // @poff=916
0x89e: Return(); Pop(0)

0x89f: Stack[-1] = (bool) 0
0x8a0: Return(); Pop(0)

0x8a1: PushEmpty(object, float, object, float)
0x8a2: Push("player") // @poff=658
0x8a3: @ FindActor(Stack[-3], Stack[-1])
0x8a4: Pop(1)
0x8a5: Pop(0); Push((bool) Stack[-2] == 0)
0x8a6: IF (Stack[-1] == 0) GOTO 0x8a9; Pop(1)

0x8a7: Stack[-5] = (int) 0
0x8a8: Return(); Pop(4)

0x8a9: Push("reputation") // @poff=948
0x8aa: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=500
0x8ab: Pop(1)
0x8ac: Stack[-1] = Stack[-5]
0x8ad: Return(); Pop(4)

0x8ae: Stack[-2] = 0
0x8af: Push(GlobalVars[1])
0x8b0: Stack[-1] = (bool) 0
0x8b1: GlobalVars[1] = Stack[-1]; Pop(1)
...
0x8b7: PushEmpty(bool, bool)
0x8b8: Push(GlobalVars[1])
0x8b9: IF (Stack[-1] == 0) GOTO 0x8c2; Pop(1)

0x8ba: @ IsOverrideActive(Stack[-1])
0x8bb: Pop(0)
0x8bc: Pop(0); Push((bool) Stack[-1] == 0)
0x8bd: IF (Stack[-1] == 0) GOTO 0x8c0; Pop(1)

0x8be: @ WorkWithCorpse(Stack[-3])
0x8bf: Pop(0)
0x8c0: Return(); Pop(2)
...
0x8c4: Stack[-6] = Stack[-1]
0x8c5: Push(-2, 1); TaskCall(7)
0x8c6: Call 0x504

0x8c7: Pop(-2, 1); TaskReturn
0x8c8: Pop(1)
0x8c9: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x8ca: IF (Stack[-1] == 0) GOTO 0x8dc; Pop(1)

0x8cb: PushEmpty(bool, object)
0x8cc: Stack[-5] = Stack[-1]
0x8cd: Call 0x69d
...
0x8d2: PushEmpty(object)
0x8d3: Stack[-4] = Stack[-1]
0x8d4: Push(-1, 1); TaskCall(0)
0x8d5: Call 0x0

0x8d6: Pop(-1, 1); TaskReturn
0x8d7: Pop(1)
0x8d8: PushEmpty(object)
0x8d9: Stack[-4] = Stack[-1]
0x8da: Call 0x6cd

0x8db: Pop(1)
0x8dc: Return(); Pop(2)

0x8dd: PushEmpty(float)
0x8de: Call 0x8a1

0x8df: Pop(0)
0x8e0: Push((float)0.8999999761581421)
0x8e1: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0x8e2: Return(); Pop(0)

0x8e3: PushEmpty(string, bool, string, bool)
0x8e4: PushEmpty(bool, object, string)
0x8e5: Stack[-8] = Stack[-2]
0x8e6: Stack[-1] = "class" // @poff=970
0x8e7: Call 0x5c1
...
0x8ed: Push("class") // @poff=970
0x8ee: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=500
0x8ef: Pop(1)
0x8f0: Push("rat") // @poff=982
0x8f1: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8f2: IF (Stack[-1] == 0) GOTO 0x8f6; Pop(1)

0x8f3: Stack[-7] = (bool) 0
0x8f4: Return(); Pop(4)

0x8f5: GOTO 0x8fb

0x8f6: Push("dog") // @poff=990
0x8f7: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8f8: IF (Stack[-1] == 0) GOTO 0x8fb; Pop(1)

0x8f9: Stack[-7] = (bool) 0
0x8fa: Return(); Pop(4)

0x8fb: @ CanSee(Stack[-1], Stack[-6])
0x8fc: Pop(0)
0x8fd: PushEmpty(bool)
0x8fe: Stack[-1] = (bool) 1
0x8ff: Push(Stack[-2])
0x900: IF (Stack[-1] == 1) GOTO 0x909; Pop(1)

0x901: PushEmpty(float, object)
0x902: Stack[-9] = Stack[-1]
0x903: Call 0x5b9

0x904: Pop(1)
0x905: Push((float)250000.0)
0x906: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x907: IF (Stack[-1] == 1) GOTO 0x909; Pop(1)

0x908: Stack[-1] = (bool) 0
0x909: IF (Stack[-1] == 0) GOTO 0x90f; Pop(1)

0x90a: Push((float)-0.30000001192092896)
0x90b: @ ReportReputationChange(Stack[-7], Stack[-6], Stack[-1])
0x90c: Pop(1)
0x90d: Stack[-7] = (bool) 1
0x90e: Return(); Pop(4)

0x90f: Stack[-7] = (bool) 0
0x910: Return(); Pop(4)

0x911: PushEmpty()
0x912: Push(GlobalVars[1])
0x913: Stack[-1] = (bool) 1
0x914: GlobalVars[1] = Stack[-1]; Pop(1)
0x915: Push((int) 50)
0x916: Push((int) 40)
0x917: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x918: Pop(2)
0x919: Return(); Pop(0)
