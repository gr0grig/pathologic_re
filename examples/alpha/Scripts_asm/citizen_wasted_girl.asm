...
0x587: Push("all") // @poff=0
0x588: Push("idle") // @poff=8
...
0x590: Push("all") // @poff=0
0x591: Push("idle") // @poff=8
...
0x5b0: Stack[-1] = "Neutral" // @poff=367
0x5b1: Call 0x596

0x5b2: Pop(1)
0x5b3: Push((int) 14610)
0x5b4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5b5: Pop(1)
0x5b6: @@@ ClearReplies(); Obj=0 // @poff=394
0x5b7: Pop(0)
...
0x5c0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5c1: Pop(3)
0x5c2: Return(); Pop(0)

0x5c3: PushEmpty(string)
0x5c4: Stack[-1] = "Neutral" // @poff=367
0x5c5: Call 0x596

0x5c6: Pop(1)
0x5c7: Push((int) 14619)
0x5c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5c9: Pop(1)
0x5ca: @@@ ClearReplies(); Obj=0 // @poff=394
0x5cb: Pop(0)
...
0x5d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5d5: Pop(3)
0x5d6: Push((int) 14622)
0x5d7: Push((int) 15860)
0x5d8: Push((int) 15859)
0x5d9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5da: Pop(3)
0x5db: Return(); Pop(0)
...
0x5f7: Stack[-1] = "Neutral" // @poff=367
0x5f8: Call 0x596

0x5f9: Pop(1)
0x5fa: Push((int) 14612)
0x5fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5fc: Pop(1)
0x5fd: @@@ ClearReplies(); Obj=0 // @poff=394
0x5fe: Pop(0)
0x5ff: Push((int) 14613)
0x600: Push((int) -1)
0x601: Push((int) 15849)
0x602: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x603: Pop(3)
0x604: Push((int) 14614)
0x605: Push((int) -1)
0x606: Push((int) 15850)
0x607: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x608: Pop(3)
0x609: Push((int) 14615)
0x60a: Push((int) 15852)
0x60b: Push((int) 15851)
0x60c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x60d: Pop(3)
0x60e: Return(); Pop(0)
...
0x613: Stack[-1] = "Neutral" // @poff=367
0x614: Call 0x596

0x615: Pop(1)
0x616: Push((int) 14616)
0x617: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x618: Pop(1)
0x619: @@@ ClearReplies(); Obj=0 // @poff=394
0x61a: Pop(0)
0x61b: Push((int) 14617)
0x61c: Push((int) -1)
0x61d: Push((int) 15853)
0x61e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x61f: Pop(3)
0x620: Return(); Pop(0)
...
0x635: Pop(0)
0x636: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x637: Pop(0)
...
0x63c: Pop(0)
0x63d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x63e: Pop(0)
...
0x643: Push("HasProperty") // @poff=416
0x644: Push((int) 2)
...
0x64a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=440
0x64b: Pop(0)
0x64c: Stack[-1] = Stack[-5]
0x64d: Return(); Pop(2)

0x64e: PushEmpty(bool, bool)
0x64f: @@ IsDead(Stack[-1]); Obj=3 // @poff=452
0x650: Pop(0)
0x651: Stack[-1] = Stack[-4]
0x652: Return(); Pop(2)

0x653: PushEmpty(object, object, object, object)
0x654: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x668: Pop(0)
0x669: Pop(0); PushNull((bool) Stack[-2] == 0)
0x66a: IF (Stack[-1] == 0) GOTO 0x66d; Pop(1)

0x66b: Stack[-6] = (bool) 0
0x66c: Return(); Pop(4)

0x66d: @@ GetScene(Stack[-1]); Obj=5 // @poff=473
0x66e: Pop(0)
...
0x682: Stack[-1] = "noaccess" // @poff=482
0x683: Call 0x642
...
0x689: Push("noaccess") // @poff=482
0x68a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=500
0x68b: Pop(1)
0x68c: Push((int) 0)
...
0x6b5: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x6b6: Pop(0)
...
0x6c6: Stack[-1] = "fhit" // @poff=550
0x6c7: GOTO 0x6c9

0x6c8: Stack[-1] = "bhit" // @poff=560
0x6c9: Push("hit_react") // @poff=570
0x6ca: Push("1") // @poff=590
0x6cb: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6cc: Push("2") // @poff=594
...
0x6d3: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x6d4: Pop(0)
...
0x6e3: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x6e4: Pop(0)
0x6e5: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x6e6: Pop(0)
...
0x71f: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x720: Pop(0)
0x721: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x722: Pop(0)
...
0x75a: Pop(0)
0x75b: Push("start: ") // @poff=616
0x75c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x75d: @ Trace(Stack[-1])
0x75e: Pop(1)
0x75f: Push("end: ") // @poff=632
...
0x765: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x766: Pop(0)
...
0x779: Push((float)9.999999974752427e-07)
...
0x7d2: Stack[-7] = Stack[-3]
0x7d3: Stack[-6] = Stack[-2]
...
0x7e0: Stack[-2] = (int) 0
0x7e1: Push("all") // @poff=0
0x7e2: PushEmpty(string, int)
0x7e3: Stack[-5] = Stack[-1]
0x7e4: Call 0x7d8
...
0x84d: Push("GenerateMoney: iMin > iMax") // @poff=672
0x84e: @ Trace(Stack[-1])
0x84f: Pop(1)
0x850: Return(); Pop(8)
...
0x8a1: Stack[-1] = "syringe" // @poff=770
0x8a2: Call 0x917
...
0x8df: Stack[-1] = "bracelet" // @poff=822
0x8e0: Call 0x917
...
0x8eb: Stack[-1] = "ear_ring" // @poff=840
0x8ec: Call 0x917
...
0x8f7: Stack[-1] = "gold_ring" // @poff=858
0x8f8: Call 0x917
...
0x903: Stack[-1] = "silver_ring" // @poff=878
0x904: Call 0x917
...
0x919: Pop(0)
0x91a: Stack[-1] = Stack[-4]
0x91b: Return(); Pop(2)

0x91c: PushEmpty(object, float, object, float)
0x91d: Push("player") // @poff=658
...
0x924: Push("reputation") // @poff=916
0x925: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=500
0x926: Pop(1)
0x927: Stack[-1] = Stack[-5]
0x928: Return(); Pop(4)
...
0x92c: Stack[-1] = "ui/NPC_None.png" // @poff=938
0x92d: Return(); Pop(0)
...
0x96e: Push("class") // @poff=970
0x96f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=500
0x970: Pop(1)
0x971: Push("rat") // @poff=982
...
0x98b: Push((float)-0.30000001192092896)
...
0x994: Push(Stack[-2])
0x995: IF (Stack[-1] == 1) GOTO 0x99e; Pop(1)
...
0x99c: IF (Stack[-1] == 1) GOTO 0x99e; Pop(1)
