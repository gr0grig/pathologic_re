...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x3ab: Push("attack_on") // @poff=264
0x3ac: @ PlayAnimation(Stack[-2], Stack[-1])
0x3ad: Pop(2)
0x3ae: @ WaitForAnimEnd()
0x3af: Pop(0)
0x3b0: Push("all") // @poff=170
0x3b1: Push("attack_stay") // @poff=284
0x3b2: @ PlayAnimation(Stack[-2], Stack[-1])
0x3b3: Pop(2)
0x3b4: @ WaitForAnimEnd()
0x3b5: Pop(0)
0x3b6: Push("all") // @poff=170
0x3b7: Push("attack_off") // @poff=308
...
0x3cc: Pop(0)
0x3cd: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x3ce: Pop(0)
...
0x3eb: Stack[-1] = (float) 1.7453293800354004
0x3ec: Call 0x3ca

0x3ed: Stack[-2] = Stack[-7]
0x3ee: Pop(2)
...
0x3f3: Push("Can't retreat, distance: ") // @poff=330
...
0x409: Push((int) 1)
0x40a: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x40b: Pop(1)
0x40c: Push(Stack[-3])
0x40d: IF (Stack[-1] == 0) GOTO 0x425; Pop(1)

0x40e: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x413: Stack[-1] = (float) 2.6179938316345215
0x414: Call 0x3ca
...
0x426: IF (Stack[-1] == 1) GOTO 0x409; Pop(1)
...
0x42d: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x43c: Stack[-1] = (float) 1.7453293800354004
0x43d: Call 0x3ca
...
0x44c: IF (Stack[-1] == 1) GOTO 0x452; Pop(1)

0x44d: PushEmpty(bool)
0x44e: Call 0x46c

0x44f: Pop(0)
0x450: IF (Stack[-1] == 1) GOTO 0x452; Pop(1)
...
0x472: Stack[-2] = Stack[-3]
0x473: Pop(2)
0x474: PushEmpty(float, cvector, cvector)
0x475: Stack[-5] = Stack[-2]
0x476: Stack[-4] = Stack[-1]
0x477: Call 0x641

0x478: Pop(2)
0x479: Push((float)-0.3420201241970062)
...
0x47e: Pop(0)
0x47f: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x480: Pop(0)
...
0x49d: Stack[-1] = (float) 1.7453293800354004
0x49e: Call 0x47c

0x49f: Stack[-2] = Stack[-7]
0x4a0: Pop(2)
...
0x4a5: Push("Can't retreat, distance: ") // @poff=330
...
0x4bb: Push((int) 1)
0x4bc: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x4bd: Pop(1)
0x4be: Push(Stack[-3])
0x4bf: IF (Stack[-1] == 0) GOTO 0x4d7; Pop(1)

0x4c0: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4c5: Stack[-1] = (float) 2.6179938316345215
0x4c6: Call 0x47c

0x4c7: Stack[-2] = Stack[-4]
0x4c8: Pop(2)
...
0x4d8: IF (Stack[-1] == 1) GOTO 0x4bb; Pop(1)
...
0x4df: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4ee: Stack[-1] = (float) 1.7453293800354004
0x4ef: Call 0x47c
...
0x4fe: IF (Stack[-1] == 1) GOTO 0x504; Pop(1)

0x4ff: PushEmpty(bool)
0x500: Call 0x51e

0x501: Pop(0)
0x502: IF (Stack[-1] == 1) GOTO 0x504; Pop(1)
...
0x52a: Pop(2)
0x52b: Push((float)-0.3420201241970062)
...
0x535: Pop(0)
0x536: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x537: Pop(0)
...
0x53c: Pop(0)
0x53d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x53e: Pop(0)
...
0x543: Push("HasProperty") // @poff=382
0x544: Push((int) 2)
...
0x54a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=406
0x54b: Pop(0)
...
0x550: Stack[-10] = Stack[-2]
0x551: Stack[-9] = Stack[-1]
0x552: Call 0x542
...
0x558: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=418
0x559: Pop(0)
0x55a: PushEmpty(float, float, float, float)
0x55b: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x55c: Stack[-8] = Stack[-2]
0x55d: Stack[-7] = Stack[-1]
0x55e: Call 0x636

0x55f: Pop(3)
0x560: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=430
0x561: Pop(1)
...
0x567: Stack[-1] = "disease" // @poff=442
0x568: Call 0x542
...
0x56f: Stack[-11] = Stack[-2]
0x570: Stack[-1] = "armor_disease" // @poff=458
0x571: Call 0x542

0x572: Pop(2)
0x573: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x574: Push("armor_disease") // @poff=458
0x575: @@ GetProperty(Stack[-1], Stack[-4]); Obj=9 // @poff=418
0x576: Pop(1)
0x577: Push((int) 100)
...
0x583: Stack[-11] = Stack[-2]
0x584: Stack[-1] = "immunity" // @poff=486
0x585: Call 0x542

0x586: Pop(2)
0x587: IF (Stack[-1] == 0) GOTO 0x599; Pop(1)

0x588: Push("immunity") // @poff=486
0x589: @@ GetProperty(Stack[-1], Stack[-2]); Obj=9 // @poff=418
0x58a: Pop(1)
0x58b: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x58c: IF (Stack[-1] == 0) GOTO 0x593; Pop(1)

0x58d: Push("immunity") // @poff=486
0x58e: Push((int) 0)
0x58f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=430
0x590: Pop(2)
0x591: Stack[-2] = Stack[-7] - Stack[-1]; Pop(0);
0x592: GOTO 0x599

0x593: Push("immunity") // @poff=486
0x594: Pop(0); Push(Stack[-2] - Stack[-8]);
0x595: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=430
0x596: Pop(2)
0x597: Stack[-7] = Stack[-9]
0x598: Return(); Pop(6)

0x599: PushEmpty(bool, object, string, float, float, float)
0x59a: Stack[-14] = Stack[-5]
0x59b: Stack[-4] = "disease" // @poff=442
0x59c: Stack[-8] = Stack[-3]
0x59d: Stack[-2] = (int) 0
0x59e: Stack[-1] = (int) 1
0x59f: Call 0x54e

0x5a0: Pop(6)
0x5a1: Stack[-7] = Stack[-9]
0x5a2: Return(); Pop(6)

0x5a3: PushEmpty(bool, bool)
0x5a4: @@ IsDead(Stack[-1]); Obj=3 // @poff=504
0x5a5: Pop(0)
0x5a6: Stack[-1] = Stack[-4]
0x5a7: Return(); Pop(2)

0x5a8: PushEmpty(object, object, object, object)
0x5a9: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x5bd: Pop(0)
0x5be: Pop(0); PushNull((bool) Stack[-2] == 0)
0x5bf: IF (Stack[-1] == 0) GOTO 0x5c2; Pop(1)

0x5c0: Stack[-6] = (bool) 0
0x5c1: Return(); Pop(4)

0x5c2: @@ GetScene(Stack[-1]); Obj=5 // @poff=525
0x5c3: Pop(0)
...
0x5d6: Stack[-6] = Stack[-2]
0x5d7: Stack[-1] = "noaccess" // @poff=534
0x5d8: Call 0x542
...
0x5de: Push("noaccess") // @poff=534
0x5df: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=418
0x5e0: Pop(1)
0x5e1: Push((int) 0)
...
0x60a: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x60b: Pop(0)
...
0x61b: Stack[-1] = "fhit" // @poff=590
0x61c: GOTO 0x61e

0x61d: Stack[-1] = "bhit" // @poff=600
0x61e: Push("hit_react") // @poff=610
0x61f: Push("1") // @poff=630
0x620: Pop(1); Push(Stack[-3] + Stack[-1]);
0x621: Push("2") // @poff=634
...
0x66f: Stack[-7] = Stack[-3]
0x670: Stack[-6] = Stack[-2]
...
0x67d: Stack[-2] = (int) 0
0x67e: Push("all") // @poff=170
0x67f: PushEmpty(string, int)
0x680: Stack[-5] = Stack[-1]
0x681: Call 0x675
...
0x6d3: Push("GenerateMoney: iMin > iMax") // @poff=662
0x6d4: @ Trace(Stack[-1])
0x6d5: Pop(1)
0x6d6: Return(); Pop(8)
...
0x6ee: PushEmpty(int, bool, int, bool)
0x6ef: Push(Stack[-5])
0x6f0: IF (Stack[-1] == 0) GOTO 0x747; Pop(1)

0x6f1: PushEmpty(int, int)
0x6f2: Stack[-2] = (int) 0
0x6f3: Push((int) 100)
0x6f4: PushEmpty(int)
0x6f5: Call 0x649
...
0x6f9: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x6fa: Call 0x6d0

0x6fb: Pop(2)
0x6fc: Push((int) 9)
0x6fd: @ irand(Stack[-3], Stack[-1])
0x6fe: Pop(1)
0x6ff: Push((int) 0)
0x700: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x701: IF (Stack[-1] == 0) GOTO 0x70b; Pop(1)

0x702: PushEmpty(int, string)
0x703: Stack[-1] = "lemon" // @poff=728
0x704: Call 0x79d

0x705: Pop(1)
0x706: Push((int) 0)
0x707: Push((int) 1)
0x708: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x709: Pop(3)
0x70a: GOTO 0x746

0x70b: Push((int) 1)
0x70c: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x70d: IF (Stack[-1] == 0) GOTO 0x717; Pop(1)

0x70e: PushEmpty(int, string)
0x70f: Stack[-1] = "rusk" // @poff=740
0x710: Call 0x79d
...
0x719: IF (Stack[-1] == 0) GOTO 0x723; Pop(1)

0x71a: PushEmpty(int, string)
0x71b: Stack[-1] = "hook" // @poff=750
0x71c: Call 0x79d
...
0x725: IF (Stack[-1] == 0) GOTO 0x72f; Pop(1)

0x726: PushEmpty(int, string)
0x727: Stack[-1] = "syringe" // @poff=760
0x728: Call 0x79d

0x729: Pop(1)
0x72a: Push((int) 0)
0x72b: Push((int) 1)
0x72c: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x72d: Pop(3)
0x72e: GOTO 0x746

0x72f: Push((int) 5)
0x730: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x731: IF (Stack[-1] == 0) GOTO 0x73b; Pop(1)

0x732: PushEmpty(int, string)
0x733: Stack[-1] = "watch" // @poff=776
0x734: Call 0x79d

0x735: Pop(1)
0x736: Push((int) 0)
0x737: Push((int) 1)
0x738: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x739: Pop(3)
0x73a: GOTO 0x746

0x73b: Push((int) 6)
0x73c: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x73d: IF (Stack[-1] == 0) GOTO 0x746; Pop(1)

0x73e: PushEmpty(int, string)
0x73f: Stack[-1] = "razor" // @poff=788
0x740: Call 0x79d
...
0x74f: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x750: Call 0x6d0

0x751: Pop(2)
0x752: Push((int) 8)
0x753: @ irand(Stack[-3], Stack[-1])
0x754: Pop(1)
0x755: Push((int) 0)
0x756: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x757: IF (Stack[-1] == 0) GOTO 0x761; Pop(1)

0x758: PushEmpty(int, string)
0x759: Stack[-1] = "beads" // @poff=800
0x75a: Call 0x79d
...
0x763: IF (Stack[-1] == 0) GOTO 0x76d; Pop(1)

0x764: PushEmpty(int, string)
0x765: Stack[-1] = "bracelet" // @poff=812
0x766: Call 0x79d

0x767: Pop(1)
0x768: Push((int) 0)
0x769: Push((int) 1)
0x76a: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x76b: Pop(3)
0x76c: GOTO 0x79c

0x76d: Push((int) 2)
0x76e: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x76f: IF (Stack[-1] == 0) GOTO 0x779; Pop(1)

0x770: PushEmpty(int, string)
0x771: Stack[-1] = "ear_ring" // @poff=830
0x772: Call 0x79d

0x773: Pop(1)
0x774: Push((int) 0)
0x775: Push((int) 1)
0x776: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x777: Pop(3)
0x778: GOTO 0x79c

0x779: Push((int) 3)
0x77a: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x77b: IF (Stack[-1] == 0) GOTO 0x785; Pop(1)

0x77c: PushEmpty(int, string)
0x77d: Stack[-1] = "gold_ring" // @poff=848
0x77e: Call 0x79d

0x77f: Pop(1)
0x780: Push((int) 0)
0x781: Push((int) 1)
0x782: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x783: Pop(3)
0x784: GOTO 0x79c

0x785: Push((int) 4)
0x786: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x787: IF (Stack[-1] == 0) GOTO 0x791; Pop(1)

0x788: PushEmpty(int, string)
0x789: Stack[-1] = "silver_ring" // @poff=868
0x78a: Call 0x79d

0x78b: Pop(1)
0x78c: Push((int) 0)
0x78d: Push((int) 1)
0x78e: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x78f: Pop(3)
0x790: GOTO 0x79c

0x791: Push((int) 5)
0x792: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x793: IF (Stack[-1] == 0) GOTO 0x79c; Pop(1)

0x794: PushEmpty(int, string)
0x795: Stack[-1] = "flower" // @poff=892
0x796: Call 0x79d

0x797: Pop(1)
0x798: Push((int) 0)
0x799: Push((int) 1)
0x79a: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x79b: Pop(3)
0x79c: Return(); Pop(4)

0x79d: PushEmpty(int, int)
0x79e: @ GetInvItemByName(Stack[-1], Stack[-3])
0x79f: Pop(0)
0x7a0: Stack[-1] = Stack[-4]
0x7a1: Return(); Pop(2)

0x7a2: Push(GlobalVars[0])
0x7a3: Stack[-1] = (bool) 0
0x7a4: GlobalVars[0] = Stack[-1]; Pop(1)
...
0x7ab: Push(GlobalVars[0])
0x7ac: IF (Stack[-1] == 0) GOTO 0x7b4; Pop(1)

0x7ad: @ IsOverrideActive(Stack[-1])
0x7ae: Pop(0)
0x7af: Pop(0); Push((bool) Stack[-1] == 0)
0x7b0: IF (Stack[-1] == 0) GOTO 0x7b3; Pop(1)

0x7b1: @ WorkWithCorpse(Stack[-3])
0x7b2: Pop(0)
0x7b3: Return(); Pop(2)
...
0x7b6: @ IsPlayerActor(Stack[-3], Stack[-1])
0x7b7: Pop(0)
0x7b8: Stack[-1] = Stack[-4]
0x7b9: Return(); Pop(2)
...
0x7bf: PushEmpty(string, bool, string, bool)
0x7c0: PushEmpty(bool, object, string)
0x7c1: Stack[-8] = Stack[-2]
0x7c2: Stack[-1] = "class" // @poff=906
0x7c3: Call 0x542
...
0x7c7: Stack[-7] = (bool) 0
0x7c8: Return(); Pop(4)

0x7c9: Push("class") // @poff=906
0x7ca: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=418
0x7cb: Pop(1)
0x7cc: Push("rat") // @poff=918
...
0x7d2: Push("dog") // @poff=926
0x7d3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x7d4: IF (Stack[-1] == 0) GOTO 0x7d7; Pop(1)

0x7d5: Stack[-7] = (bool) 0
0x7d6: Return(); Pop(4)

0x7d7: @ CanSee(Stack[-1], Stack[-6])
0x7d8: Pop(0)
0x7d9: PushEmpty(bool)
0x7da: Stack[-1] = (bool) 1
0x7db: Push(Stack[-2])
0x7dc: IF (Stack[-1] == 1) GOTO 0x7e5; Pop(1)

0x7dd: PushEmpty(float, object)
0x7de: Stack[-9] = Stack[-1]
0x7df: Call 0x53a

0x7e0: Pop(1)
0x7e1: Push((float)250000.0)
...
0x7e6: Push((float)-0.30000001192092896)
0x7e7: @ ReportReputationChange(Stack[-7], Stack[-6], Stack[-1])
0x7e8: Pop(1)
0x7e9: Stack[-7] = (bool) 1
0x7ea: Return(); Pop(4)

0x7eb: Stack[-7] = (bool) 0
0x7ec: Return(); Pop(4)

0x7ed: PushEmpty()
0x7ee: Push(GlobalVars[0])
0x7ef: Stack[-1] = (bool) 1
0x7f0: GlobalVars[0] = Stack[-1]; Pop(1)
0x7f1: Push((int) 50)
0x7f2: Push((int) 40)
0x7f3: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x7f4: Pop(2)
0x7f5: Return(); Pop(0)
