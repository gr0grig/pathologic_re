...
Strings:
	...
	W:wasted_girl
	W:woman
// @pool_raw:
...
0x385: PushEmpty()
0x386: Stack[-3] = (float) 0.10000000149011612
0x387: Return(); Pop(0)
...
0x69c: Push("all") // @poff=0
0x69d: Push("idle") // @poff=8
...
0x6a5: Push("all") // @poff=0
0x6a6: Push("idle") // @poff=8
...
0x6c5: Stack[-1] = "Neutral" // @poff=553
0x6c6: Call 0x6ab

0x6c7: Pop(1)
0x6c8: Push((int) 14593)
0x6c9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6ca: Pop(1)
0x6cb: @@@ ClearReplies(); Obj=0 // @poff=580
0x6cc: Pop(0)
...
0x6da: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6db: Pop(3)
0x6dc: Return(); Pop(0)
...
0x6fa: Stack[-1] = "Neutral" // @poff=553
0x6fb: Call 0x6ab

0x6fc: Pop(1)
0x6fd: Push((int) 14604)
0x6fe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6ff: Pop(1)
0x700: @@@ ClearReplies(); Obj=0 // @poff=580
0x701: Pop(0)
...
0x711: Stack[-1] = "Neutral" // @poff=553
0x712: Call 0x6ab

0x713: Pop(1)
0x714: Push((int) 14600)
0x715: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x716: Pop(1)
0x717: @@@ ClearReplies(); Obj=0 // @poff=580
0x718: Pop(0)
0x719: Push((int) 14601)
0x71a: Push((int) -1)
0x71b: Push((int) 15836)
0x71c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x71d: Pop(3)
0x71e: Return(); Pop(0)
...
0x723: Stack[-1] = "Neutral" // @poff=553
0x724: Call 0x6ab

0x725: Pop(1)
0x726: Push((int) 14595)
0x727: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x728: Pop(1)
0x729: @@@ ClearReplies(); Obj=0 // @poff=580
0x72a: Pop(0)
0x72b: Push((int) 14596)
0x72c: Push((int) -1)
0x72d: Push((int) 15830)
0x72e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x72f: Pop(3)
...
0x747: Stack[-2] = "fire" // @poff=602
0x748: Return(); Pop(0)

0x749: Stack[-2] = "phys" // @poff=612
0x74a: Return(); Pop(0)

0x74b: PushEmpty(cvector, cvector, cvector, cvector)
0x74c: @ GetPosition(Stack[-2])
0x74d: Pop(0)
0x74e: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x74f: Pop(0)
...
0x754: Pop(0)
0x755: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x756: Pop(0)
...
0x75b: Push("HasProperty") // @poff=622
0x75c: Push((int) 2)
...
0x762: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x763: Pop(0)
...
0x768: Stack[-18] = Stack[-2]
0x769: Stack[-1] = "health" // @poff=658
0x76a: Call 0x75a
...
0x771: Stack[-18] = Stack[-2]
0x772: Stack[-1] = "armor" // @poff=672
0x773: Call 0x75a
...
0x779: Push("armor") // @poff=672
0x77a: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x77b: Pop(1)
0x77c: Push("armor_") // @poff=696
0x77d: PushEmpty(string, int)
0x77e: Stack[-16] = Stack[-1]
0x77f: Call 0x743

0x780: Pop(1)
0x781: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x782: PushEmpty(bool, object, string)
0x783: Stack[-18] = Stack[-2]
0x784: Stack[-8] = Stack[-1]
0x785: Call 0x75a
...
0x78b: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x78c: Pop(0)
...
0x793: Stack[-3] = Stack[-6]
0x794: Pop(3)
0x795: Push("health") // @poff=658
0x796: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x797: Pop(1)
0x798: Push((int) 1)
0x799: Pop(1); Push(Stack[-1] - Stack[-4]);
0x79a: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x79b: Push("health") // @poff=658
...
0x7a1: Pop(3)
0x7a2: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x7a3: Pop(2)
0x7a4: Stack[-1] = Stack[-16]
0x7a5: Return(); Pop(12)

0x7a6: PushEmpty(bool, bool)
0x7a7: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x7a8: Pop(0)
0x7a9: Stack[-1] = Stack[-4]
0x7aa: Return(); Pop(2)

0x7ab: PushEmpty(object, object, object, object)
0x7ac: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7c0: Pop(0)
0x7c1: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7c2: IF (Stack[-1] == 0) GOTO 0x7c5; Pop(1)

0x7c3: Stack[-6] = (bool) 0
0x7c4: Return(); Pop(4)

0x7c5: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x7c6: Pop(0)
...
0x7d9: Stack[-6] = Stack[-2]
0x7da: Stack[-1] = "noaccess" // @poff=752
0x7db: Call 0x75a
...
0x7e1: Push("noaccess") // @poff=752
0x7e2: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x7e3: Pop(1)
0x7e4: Push((int) 0)
...
0x80d: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x80e: Pop(0)
...
0x81e: Stack[-1] = "fhit" // @poff=808
0x81f: GOTO 0x821

0x820: Stack[-1] = "bhit" // @poff=818
0x821: Push("hit_react") // @poff=828
0x822: Push("1") // @poff=848
0x823: Pop(1); Push(Stack[-3] + Stack[-1]);
0x824: Push("2") // @poff=852
...
0x82b: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x82c: Pop(0)
...
0x83b: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x83c: Pop(0)
0x83d: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x83e: Pop(0)
...
0x877: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x878: Pop(0)
0x879: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x87a: Pop(0)
...
0x8b2: Pop(0)
0x8b3: Push("start: ") // @poff=874
0x8b4: Pop(1); Push(Stack[-1] + Stack[-3]);
0x8b5: @ Trace(Stack[-1])
0x8b6: Pop(1)
0x8b7: Push("end: ") // @poff=890
...
0x8bd: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x8be: Pop(0)
...
0x8d1: Push((float)9.999999974752427e-07)
...
0x900: Stack[-4] = Stack[-1]
0x901: Call 0x8ea

0x902: Pop(2)
0x903: PushEmpty(float, cvector)
0x904: Stack[-5] = Stack[-1]
0x905: Call 0x8f3

0x906: Pop(1)
0x907: PushEmpty(float, cvector)
0x908: Stack[-5] = Stack[-1]
0x909: Call 0x8f3
...
0x934: Stack[-7] = Stack[-3]
0x935: Stack[-6] = Stack[-2]
0x936: Stack[-5] = Stack[-1]
0x937: Call 0x7e7
...
0x979: Stack[-2] = Stack[-4]
0x97a: Pop(2)
0x97b: Return(); Pop(0)

0x97c: PushEmpty()
0x97d: PushEmpty(object)
0x97e: Stack[-2] = Stack[-1]
0x97f: Call 0x96d
...
0x9d3: Push("GenerateMoney: iMin > iMax") // @poff=930
0x9d4: @ Trace(Stack[-1])
0x9d5: Pop(1)
0x9d6: Return(); Pop(8)
...
0xa27: Stack[-1] = "syringe" // @poff=1028
0xa28: Call 0xa9d
...
0xa65: Stack[-1] = "bracelet" // @poff=1080
0xa66: Call 0xa9d
...
0xa71: Stack[-1] = "ear_ring" // @poff=1098
0xa72: Call 0xa9d
...
0xa7d: Stack[-1] = "gold_ring" // @poff=1116
0xa7e: Call 0xa9d
...
0xa89: Stack[-1] = "silver_ring" // @poff=1136
0xa8a: Call 0xa9d
...
0xa95: Stack[-1] = "flower" // @poff=1160
0xa96: Call 0xa9d
...
0xaa4: Stack[-1] = "ui/NPC_None.png" // @poff=1174
0xaa5: Return(); Pop(0)
...
0xadd: Stack[-8] = Stack[-2]
0xade: Stack[-1] = "class" // @poff=1206
0xadf: Call 0x75a
...
0xae5: Push("class") // @poff=1206
0xae6: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=684
0xae7: Pop(1)
...
0xb06: Push("wasted_male") // @poff=1260
...
0xb0b: Push("wasted_girl") // @poff=1284
