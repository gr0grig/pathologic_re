...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
Events:
EVENT_16 Op = 0x7e1 Vars = (object, string)
EVENT_41 Op = 0x7ee Vars = (object)
EVENT_22 Op = 0x7f4 Vars = (object, int, float, float)
...
0x27: Stack[-5] = Stack[-1]
0x28: Call 0x853

0x29: Stack[-2] = Stack[-3]
0x2a: Pop(2)
0x2b: Push((int) 0)
...
0x38: Pop(0); PushNull((bool) Stack[-21] == 0)
0x39: IF (Stack[-1] == 0) GOTO 0x3f; Pop(1)

0x3a: PushEmpty(string)
0x3b: Stack[-1] = "fdie" // @poff=18
0x3c: Call 0x8e

0x3d: Pop(1)
0x3e: GOTO 0x8d

0x3f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=28
0x40: Pop(0)
...
0x50: Stack[-6] = "fdie" // @poff=18
0x51: GOTO 0x53

0x52: Stack[-6] = "bdie" // @poff=40
...
0x59: @ StopAsync()
0x5a: Pop(0)
0x5b: Stack[-21] = Stack[-5]
0x5c: Push("GetScriptProperty") // @poff=50
0x5d: Push((int) 2)
0x5e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x5f: IF (Stack[-1] == 0) GOTO 0x6b; Pop(1)

0x60: Push("Owner") // @poff=86
0x61: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=98
0x62: Pop(1)
0x63: Push(Stack[-4])
0x64: IF (Stack[-1] == 0) GOTO 0x6b; Pop(1)

0x65: Push("Owner") // @poff=86
0x66: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=116
0x67: Pop(1)
0x68: Pop(0); PushNull((bool) Stack[-5] == 0)
0x69: IF (Stack[-1] == 0) GOTO 0x6b; Pop(1)

0x6a: Stack[-21] = Stack[-5]
0x6b: Push("@GetEyesHeight") // @poff=134
0x6c: Push((int) 1)
0x6d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x6e: IF (Stack[-1] == 0) GOTO 0x7a; Pop(1)

0x6f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x70: Pop(0)
0x71: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x72: Push(CvectorIndex(Stack[-1], 1))
0x73: Stack[-3] = Stack[-1]
0x74: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x75: Push("head") // @poff=178
...
0x82: @ StopAsync()
0x83: Pop(0)
0x84: Push("head") // @poff=178
0x85: @ UnlookAsync(Stack[-1])
0x86: Pop(1)
0x87: Push("all") // @poff=0
...
0x98: Pop(0)
0x99: Push("all") // @poff=0
0x9a: @ PlayAnimation(Stack[-1], Stack[-2])
0x9b: Pop(1)
0x9c: @ WaitForAnimEnd()
0x9d: Pop(0)
0x9e: Push("all") // @poff=0
...
0xec: Stack[-7] = Stack[-2]
0xed: Stack[-6] = Stack[-1]
0xee: Call 0x988
...
0x11a: Stack[-6] = Stack[-2]
0x11b: Stack[-7] = Stack[-1]
0x11c: Call 0x84e

0x11d: Stack[-3] = Stack[-4]
0x11e: Pop(3)
0x11f: Push((int) 0)
...
0x129: Stack[-5] = Stack[-2]
0x12a: Stack[-6] = Stack[-1]
0x12b: Call 0x851
...
0x1e0: Stack[-5] = Stack[-1]
0x1e1: Call 0x853

0x1e2: Stack[-2] = Stack[-3]
0x1e3: Pop(2)
0x1e4: Push((int) 0)
...
0x1f4: Stack[-5] = Stack[-1]
0x1f5: Call 0x825

0x1f6: Stack[-2] = Stack[-3]
0x1f7: Pop(2)
0x1f8: Push((int) 0)
...
0x20e: Stack[-6] = Stack[-1]
0x20f: Call 0x837

0x210: Stack[-2] = Stack[-3]
0x211: Pop(2)
0x212: Push((int) 0)
...
0x222: Stack[-5] = Stack[-1]
0x223: Call 0x849

0x224: Stack[-2] = Stack[-3]
0x225: Pop(2)
0x226: Push((int) 0)
...
0x236: Stack[-6] = Stack[-2]
0x237: Stack[-7] = Stack[-1]
0x238: Call 0x84e

0x239: Stack[-3] = Stack[-4]
0x23a: Pop(3)
0x23b: Push((int) 0)
...
0x273: Pop(0)
0x274: Push("all") // @poff=0
0x275: PushEmpty(string, int)
0x276: Stack[-7] = Stack[-1]
0x277: Call 0x7fc
...
0x2a5: Stack[-2] = Stack[-4]
0x2a6: Pop(2)
0x2a7: PushEmpty(float, cvector, cvector)
0x2a8: Stack[-6] = Stack[-2]
0x2a9: Stack[-5] = Stack[-1]
0x2aa: Call 0x7bf
...
0x2fd: Stack[-7] = Stack[-2]
0x2fe: Stack[-6] = Stack[-1]
0x2ff: Call 0x988
...
0x303: Stack[-6] = Stack[-1]
0x304: Call 0x837

0x305: Stack[-2] = Stack[-3]
0x306: Pop(2)
0x307: Push((int) 0)
...
0x36d: Pop(2)
0x36e: Push((float)0.4999999701976776)
...
0x37e: @ Face(Stack[-1])
0x37f: Pop(0)
0x380: Push("all") // @poff=0
0x381: Push("attack_on") // @poff=188
0x382: @ PlayAnimation(Stack[-2], Stack[-1])
0x383: Pop(2)
0x384: @ WaitForAnimEnd()
0x385: Pop(0)
0x386: Push("all") // @poff=0
0x387: Push("attack_stay") // @poff=208
0x388: @ PlayAnimation(Stack[-2], Stack[-1])
0x389: Pop(2)
0x38a: @ WaitForAnimEnd()
0x38b: Pop(0)
0x38c: Push("all") // @poff=0
0x38d: Push("attack_off") // @poff=232
...
0x3a2: Pop(0)
0x3a3: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=28
0x3a4: Pop(0)
...
0x3c1: Stack[-1] = (float) 1.7453293800354004
0x3c2: Call 0x3a0
...
0x3c9: Push("Can't retreat, distance: ") // @poff=254
...
0x454: Pop(0)
0x455: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=28
0x456: Pop(0)
...
0x47b: Push("Can't retreat, distance: ") // @poff=254
...
0x491: Push((int) 1)
0x492: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x493: Pop(1)
0x494: Push(Stack[-3])
0x495: IF (Stack[-1] == 0) GOTO 0x4ad; Pop(1)

0x496: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x49b: Stack[-1] = (float) 2.6179938316345215
0x49c: Call 0x452
...
0x4ae: IF (Stack[-1] == 1) GOTO 0x491; Pop(1)
...
0x4b5: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x4c4: Stack[-1] = (float) 1.7453293800354004
0x4c5: Call 0x452
...
0x4d4: IF (Stack[-1] == 1) GOTO 0x4da; Pop(1)

0x4d5: PushEmpty(bool)
0x4d6: Call 0x4f4

0x4d7: Pop(0)
0x4d8: IF (Stack[-1] == 1) GOTO 0x4da; Pop(1)
...
0x4fa: Stack[-2] = Stack[-3]
0x4fb: Pop(2)
0x4fc: PushEmpty(float, cvector, cvector)
0x4fd: Stack[-5] = Stack[-2]
0x4fe: Stack[-4] = Stack[-1]
0x4ff: Call 0x7a4

0x500: Pop(2)
0x501: Push((float)-0.3420201241970062)
...
0x512: Pop(0)
0x513: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=306
0x514: Pop(1)
0x515: PushEmpty(string)
0x516: Call 0x950

0x517: Pop(0)
0x518: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=317
0x519: Pop(1)
0x51a: PushEmpty(int)
0x51b: Call 0x85d

0x51c: Pop(0)
0x51d: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=326
0x51e: Pop(1)
0x51f: Stack[-2] = (int) -1
...
0x529: Stack[-11] = Stack[-2]
0x52a: Stack[-6] = Stack[-1]
0x52b: Push(-2, 4); TaskCall(8)
0x52c: Call 0x543

0x52d: Pop(-2, 4); TaskReturn
0x52e: Pop(2)
0x52f: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=340
0x530: Pop(0)
...
0x533: @ sync()
0x534: Pop(0)
0x535: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=340
0x536: Pop(0)
0x537: GOTO 0x531
...
0x53d: Pop(0)
0x53e: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=352
0x53f: Pop(0)
0x540: Stack[-2] = Stack[-10]
0x541: Return(); Pop(8)
...
0x547: Push((int) 1)
0x548: IF (Stack[-1] == 0) GOTO 0x573; Pop(1)

0x549: PushEmpty(string)
0x54a: Stack[-1] = "Neutral" // @poff=367
0x54b: Call 0x591

0x54c: Pop(1)
0x54d: Push((int) 14627)
0x54e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x54f: Pop(1)
0x550: @@@ ClearReplies(); Obj=0 // @poff=394
0x551: Pop(0)
0x552: Push((int) 14628)
0x553: Push((int) 15866)
0x554: Push((int) 15865)
0x555: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x556: Pop(3)
0x557: Push((int) 14632)
0x558: Push((int) 15870)
0x559: Push((int) 15869)
0x55a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x55b: Pop(3)
0x55c: GOTO 0x573

0x55d: PushEmpty(string)
0x55e: Stack[-1] = "Neutral" // @poff=367
0x55f: Call 0x591

0x560: Pop(1)
0x561: Push((int) 14639)
0x562: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x563: Pop(1)
0x564: @@@ ClearReplies(); Obj=0 // @poff=394
0x565: Pop(0)
0x566: Push((int) 14640)
0x567: Push((int) 15878)
0x568: Push((int) 15877)
0x569: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x56a: Pop(3)
0x56b: Push((int) 14647)
0x56c: Push((int) -1)
0x56d: Push((int) 15884)
0x56e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x56f: Pop(3)
0x570: GOTO 0x573
...
0x575: Pop(0)
0x576: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x577: @ lshWaitForAnimEnd()
0x578: Pop(0)
0x579: Push( Stack[3 + Tasks[-1].StackPointer] )
0x57a: IF (Stack[-1] == 0) GOTO 0x57c; Pop(1)

0x57b: GOTO 0x581

0x57c: PushEmpty(string)
0x57d: Stack[-1] = Stack[2 + Tasks[-1].StackPointer]
0x57e: Call 0x776
...
0x582: Push("all") // @poff=0
0x583: Push("idle") // @poff=8
0x584: @ PlayAnimation(Stack[-2], Stack[-1])
0x585: Pop(2)
0x586: @ WaitForAnimEnd()
0x587: Pop(0)
0x588: Push( Stack[3 + Tasks[-1].StackPointer] )
0x589: IF (Stack[-1] == 0) GOTO 0x58b; Pop(1)

0x58a: GOTO 0x590

0x58b: Push("all") // @poff=0
0x58c: Push("idle") // @poff=8
...
0x598: Pop(0); Push((bool) Stack[-1] == Stack[2 + Tasks[-1].StackPointer])
...
0x59e: Pop(1)
0x59f: Stack[2 + Tasks[-1].StackPointer] = Stack[-1]
0x5a0: Return(); Pop(0)

0x5a1: PushEmpty()
0x5a2: Push((int) 1)
0x5a3: IF (Stack[-1] == 0) GOTO 0x651; Pop(1)

0x5a4: PushEmpty()
0x5a5: Call 0x793

0x5a6: Pop(0)
0x5a7: Push((int) 15864)
0x5a8: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5a9: IF (Stack[-1] == 0) GOTO 0x5d2; Pop(1)

0x5aa: PushEmpty(string)
0x5ab: Stack[-1] = "Neutral" // @poff=367
0x5ac: Call 0x591

0x5ad: Pop(1)
0x5ae: Push((int) 14627)
0x5af: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5b0: Pop(1)
0x5b1: @@@ ClearReplies(); Obj=0 // @poff=394
0x5b2: Pop(0)
0x5b3: Push((int) 14628)
0x5b4: Push((int) 15866)
0x5b5: Push((int) 15865)
0x5b6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5b7: Pop(3)
0x5b8: Push((int) 14632)
0x5b9: Push((int) 15870)
0x5ba: Push((int) 15869)
0x5bb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5bc: Pop(3)
0x5bd: Return(); Pop(0)

0x5be: PushEmpty(string)
0x5bf: Stack[-1] = "Neutral" // @poff=367
0x5c0: Call 0x591

0x5c1: Pop(1)
0x5c2: Push((int) 14639)
0x5c3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5c4: Pop(1)
0x5c5: @@@ ClearReplies(); Obj=0 // @poff=394
0x5c6: Pop(0)
0x5c7: Push((int) 14640)
0x5c8: Push((int) 15878)
0x5c9: Push((int) 15877)
0x5ca: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5cb: Pop(3)
0x5cc: Push((int) 14647)
0x5cd: Push((int) -1)
0x5ce: Push((int) 15884)
0x5cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5d0: Pop(3)
0x5d1: Return(); Pop(0)

0x5d2: Push((int) 15878)
0x5d3: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5d4: IF (Stack[-1] == 0) GOTO 0x5e9; Pop(1)

0x5d5: PushEmpty(string)
0x5d6: Stack[-1] = "Neutral" // @poff=367
0x5d7: Call 0x591

0x5d8: Pop(1)
0x5d9: Push((int) 14641)
0x5da: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5db: Pop(1)
0x5dc: @@@ ClearReplies(); Obj=0 // @poff=394
0x5dd: Pop(0)
0x5de: Push((int) 14642)
0x5df: Push((int) 15880)
0x5e0: Push((int) 15879)
0x5e1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5e2: Pop(3)
0x5e3: Push((int) 14646)
0x5e4: Push((int) -1)
0x5e5: Push((int) 15883)
0x5e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5e7: Pop(3)
0x5e8: Return(); Pop(0)

0x5e9: Push((int) 15880)
0x5ea: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5eb: IF (Stack[-1] == 0) GOTO 0x600; Pop(1)

0x5ec: PushEmpty(string)
0x5ed: Stack[-1] = "Neutral" // @poff=367
0x5ee: Call 0x591

0x5ef: Pop(1)
0x5f0: Push((int) 14643)
0x5f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5f2: Pop(1)
0x5f3: @@@ ClearReplies(); Obj=0 // @poff=394
0x5f4: Pop(0)
0x5f5: Push((int) 14644)
0x5f6: Push((int) -1)
0x5f7: Push((int) 15881)
0x5f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5f9: Pop(3)
0x5fa: Push((int) 14645)
0x5fb: Push((int) -1)
0x5fc: Push((int) 15882)
0x5fd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5fe: Pop(3)
0x5ff: Return(); Pop(0)

0x600: Push((int) 15870)
0x601: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x602: IF (Stack[-1] == 0) GOTO 0x617; Pop(1)

0x603: PushEmpty(string)
0x604: Stack[-1] = "Neutral" // @poff=367
0x605: Call 0x591

0x606: Pop(1)
0x607: Push((int) 14633)
0x608: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x609: Pop(1)
0x60a: @@@ ClearReplies(); Obj=0 // @poff=394
0x60b: Pop(0)
0x60c: Push((int) 14634)
0x60d: Push((int) 15872)
0x60e: Push((int) 15871)
0x60f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x610: Pop(3)
0x611: Push((int) 14638)
0x612: Push((int) -1)
0x613: Push((int) 15875)
0x614: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x615: Pop(3)
0x616: Return(); Pop(0)

0x617: Push((int) 15872)
0x618: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x619: IF (Stack[-1] == 0) GOTO 0x62e; Pop(1)

0x61a: PushEmpty(string)
0x61b: Stack[-1] = "Neutral" // @poff=367
0x61c: Call 0x591

0x61d: Pop(1)
0x61e: Push((int) 14635)
0x61f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x620: Pop(1)
0x621: @@@ ClearReplies(); Obj=0 // @poff=394
0x622: Pop(0)
0x623: Push((int) 14636)
0x624: Push((int) -1)
0x625: Push((int) 15873)
0x626: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x627: Pop(3)
0x628: Push((int) 14637)
0x629: Push((int) -1)
0x62a: Push((int) 15874)
0x62b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x62c: Pop(3)
0x62d: Return(); Pop(0)

0x62e: Push((int) 15866)
0x62f: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x630: IF (Stack[-1] == 0) GOTO 0x645; Pop(1)

0x631: PushEmpty(string)
0x632: Stack[-1] = "Neutral" // @poff=367
0x633: Call 0x591

0x634: Pop(1)
0x635: Push((int) 14629)
0x636: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x637: Pop(1)
0x638: @@@ ClearReplies(); Obj=0 // @poff=394
0x639: Pop(0)
0x63a: Push((int) 14630)
0x63b: Push((int) -1)
0x63c: Push((int) 15867)
0x63d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x63e: Pop(3)
0x63f: Push((int) 14631)
0x640: Push((int) -1)
0x641: Push((int) 15868)
0x642: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x643: Pop(3)
0x644: Return(); Pop(0)

0x645: Stack[3 + Tasks[-1].StackPointer] = (bool)1
...
0x652: PushEmpty(cvector, cvector)
0x653: @ GetPosition(Stack[-1])
0x654: Pop(0)
0x655: Stack[-1] = Stack[-3]
0x656: Return(); Pop(2)

0x657: PushEmpty(cvector, cvector, cvector, cvector)
0x658: @ GetPosition(Stack[-2])
0x659: Pop(0)
0x65a: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x65b: Pop(0)
0x65c: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x65d: Return(); Pop(4)

0x65e: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x65f: @ GetPosition(Stack[-3])
0x660: Pop(0)
0x661: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x662: Pop(0)
0x663: Stack[-1] = Stack[-2] - Stack[-3]; Pop(0);
0x664: Stack[-8] = Stack[-1] | Stack[-1]; Pop(0);
0x665: Return(); Pop(6)

0x666: PushEmpty(bool, bool)
0x667: Push("HasProperty") // @poff=416
0x668: Push((int) 2)
0x669: Pop(2); Push(IsFuncExist(Stack[-6], Stack[-2], Stack[-1]))
0x66a: Pop(1); Push((bool) Stack[-1] == 0)
0x66b: IF (Stack[-1] == 0) GOTO 0x66e; Pop(1)

0x66c: Stack[-5] = (bool) 0
0x66d: Return(); Pop(2)

0x66e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=440
0x66f: Pop(0)
0x670: Stack[-1] = Stack[-5]
0x671: Return(); Pop(2)

0x672: PushEmpty(bool, bool)
0x673: @@ IsDead(Stack[-1]); Obj=3 // @poff=452
0x674: Pop(0)
0x675: Stack[-1] = Stack[-4]
0x676: Return(); Pop(2)

0x677: PushEmpty(object, object, object, object)
0x678: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x67e: Push("IsDead") // @poff=459
0x67f: Push((int) 1)
0x680: Pop(2); Push(IsFuncExist(Stack[-8], Stack[-2], Stack[-1]))
0x681: IF (Stack[-1] == 0) GOTO 0x688; Pop(1)

0x682: PushEmpty(bool, object)
0x683: Stack[-8] = Stack[-1]
0x684: Call 0x672
...
0x68b: @ GetScene(Stack[-2])
0x68c: Pop(0)
0x68d: Pop(0); PushNull((bool) Stack[-2] == 0)
0x68e: IF (Stack[-1] == 0) GOTO 0x691; Pop(1)

0x68f: Stack[-6] = (bool) 0
0x690: Return(); Pop(4)

0x691: @@ GetScene(Stack[-1]); Obj=5 // @poff=473
0x692: Pop(0)
0x693: Pop(0); Push((bool) Stack[-2] != Stack[-1])
0x694: IF (Stack[-1] == 0) GOTO 0x697; Pop(1)

0x695: Stack[-6] = (bool) 0
0x696: Return(); Pop(4)

0x697: Stack[-6] = (bool) 1
0x698: Return(); Pop(4)

0x699: Stack[-1] = 0
0x69a: Stack[-2] = 0
0x69b: PushEmpty(int, int)
0x69c: PushEmpty(bool, object)
0x69d: Stack[-5] = Stack[-1]
0x69e: Call 0x677
...
0x6a2: Stack[-4] = (bool) 0
0x6a3: Return(); Pop(2)

0x6a4: PushEmpty(bool, object, string)
0x6a5: Stack[-6] = Stack[-2]
0x6a6: Stack[-1] = "noaccess" // @poff=482
0x6a7: Call 0x666
...
0x6ab: Stack[-4] = (bool) 1
0x6ac: Return(); Pop(2)

0x6ad: Push("noaccess") // @poff=482
0x6ae: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=500
0x6af: Pop(1)
0x6b0: Push((int) 0)
0x6b1: Stack[-5] = Stack[-2] == Stack[-1]; Pop(1);
0x6b2: Return(); Pop(2)

0x6b3: PushEmpty(object, object, cvector, float, int, cvector, cvector, cvector, cvector, string, object, object, cvector, float, int, cvector, cvector, cvector, cvector, string)
0x6b4: PushEmpty(bool)
0x6b5: Stack[-1] = (bool) 0
0x6b6: Push((int) 4)
0x6b7: Pop(1); Push((bool) Stack[-24] != Stack[-1])
0x6b8: IF (Stack[-1] == 0) GOTO 0x6bd; Pop(1)

0x6b9: Push((int) 5)
0x6ba: Pop(1); Push((bool) Stack[-24] != Stack[-1])
0x6bb: IF (Stack[-1] == 0) GOTO 0x6bd; Pop(1)

0x6bc: Stack[-1] = (bool) 1
0x6bd: IF (Stack[-1] == 0) GOTO 0x6d0; Pop(1)

0x6be: @ GetScene(Stack[-10])
0x6bf: Pop(0)
0x6c0: @ GetPosition(Stack[-8])
0x6c1: Pop(0)
0x6c2: @ GetEyesHeight(Stack[-7])
0x6c3: Pop(0)
0x6c4: Push(CvectorIndex(Stack[-8], 1))
0x6c5: Push((int) 2)
0x6c6: Pop(1); Push(Stack[-9] / Stack[-1]);
0x6c7: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x6c8: CvectorIndex(Stack[-9], 1) = Stack[-1];
0x6c9: Push("scripted") // @poff=512
0x6ca: Push(CVector(0.0, 0.0, 1.0))
0x6cb: Push("blood.xml") // @poff=530
0x6cc: @ AddActorByType(Stack[-12], Stack[-3], Stack[-13], Stack[-11], Stack[-2], Stack[-1])
0x6cd: Pop(3)
0x6ce: Stack[-9] = 0
0x6cf: Stack[-10] = 0
0x6d0: Pop(0); PushNull((bool) Stack[-23] == 0)
0x6d1: IF (Stack[-1] == 0) GOTO 0x6d3; Pop(1)

0x6d2: Return(); Pop(20)

0x6d3: @ GetSecondaryAnimationType(Stack[-6])
0x6d4: Pop(0)
0x6d5: Push((int) 0)
...
0x6d9: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x6da: Pop(0)
0x6db: @ GetPosition(Stack[-4])
0x6dc: Pop(0)
0x6dd: @ GetDirection(Stack[-3])
0x6de: Pop(0)
0x6df: Stack[-2] = Stack[-4] - Stack[-5]; Pop(0);
0x6e0: Push(CvectorIndex(Stack[-2], 0))
0x6e1: Push(CvectorIndex(Stack[-4], 0))
0x6e2: Pop(2); Push(Stack[-2] * Stack[-1]);
0x6e3: Push(CvectorIndex(Stack[-3], 2))
0x6e4: Push(CvectorIndex(Stack[-5], 2))
0x6e5: Pop(2); Push(Stack[-2] * Stack[-1]);
0x6e6: Pop(2); Push(Stack[-2] + Stack[-1]);
0x6e7: Push((int) 0)
0x6e8: Pop(2); Push((bool) Stack[-2] >= Stack[-1])
0x6e9: IF (Stack[-1] == 0) GOTO 0x6ec; Pop(1)

0x6ea: Stack[-1] = "fhit" // @poff=550
0x6eb: GOTO 0x6ed

0x6ec: Stack[-1] = "bhit" // @poff=560
0x6ed: Push("hit_react") // @poff=570
0x6ee: Push("1") // @poff=590
0x6ef: Pop(1); Push(Stack[-3] + Stack[-1]);
0x6f0: Push("2") // @poff=594
0x6f1: Pop(1); Push(Stack[-4] + Stack[-1]);
0x6f2: Push((int) -10)
0x6f3: @ FadeSecondaryAnimation(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x6f4: Pop(4)
0x6f5: Return(); Pop(20)

0x6f6: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x6f7: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x6f8: Pop(0)
0x6f9: @ GetPosition(Stack[-2])
0x6fa: Pop(0)
0x6fb: Stack[-1] = Stack[-3] - Stack[-2]; Pop(0);
0x6fc: Push(CvectorIndex(Stack[-1], 0))
0x6fd: Push(CvectorIndex(Stack[-2], 2))
0x6fe: @ RotateAsync(Stack[-2], Stack[-1])
0x6ff: Pop(2)
0x700: Return(); Pop(6)

0x701: PushEmpty(bool, bool)
0x702: @ IsLoaded(Stack[-1])
0x703: Pop(0)
0x704: Stack[-1] = Stack[-3]
0x705: Return(); Pop(2)

0x706: PushEmpty(float, cvector, cvector, cvector, cvector, cvector, cvector, bool, float, cvector, cvector, cvector, cvector, cvector, cvector, bool)
0x707: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x708: Pop(0)
0x709: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x70a: Pop(0)
0x70b: Push(CvectorIndex(Stack[-7], 1))
0x70c: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x70d: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x70e: @ GetPosition(Stack[-6])
0x70f: Pop(0)
0x710: @ GetEyesHeight(Stack[-8])
0x711: Pop(0)
0x712: Push(CvectorIndex(Stack[-6], 1))
0x713: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x714: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x715: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x716: Push(CvectorIndex(Stack[-5], 1))
0x717: Stack[-1] = (int) 0
0x718: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x719: Pop(0); Push(Stack[-5] | Stack[-5]);
0x71a: Pop(1); Push(Sqrt(Stack[-1]))
0x71b: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x71c: Stack[-4] = -Stack[-5]; Pop(0);
0x71d: Push((int) 70)
0x71e: Pop(1); Push(Stack[-6] * Stack[-1]);
0x71f: PushEmpty(cvector, cvector)
0x720: Push(CVector(0.0, 1.0, 0.0))
0x721: Stack[-2] = Stack[-8] ^ Stack[-1]; Pop(1);
0x722: Call 0x79a
...
0x727: Push(CVector(0.0, 10.0, 0.0))
0x728: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x729: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
0x72a: @ IsOverrideActive(Stack[-1])
0x72b: Pop(0)
0x72c: Push(Stack[-1])
0x72d: IF (Stack[-1] == 0) GOTO 0x730; Pop(1)

0x72e: Stack[-18] = (bool) 0
0x72f: Return(); Pop(16)

0x730: @ StopWorld()
0x731: Pop(0)
0x732: @ CameraTransit(Stack[-2], Stack[-4])
0x733: Pop(0)
0x734: Push(CvectorIndex(Stack[-3], 0))
0x735: Push(CvectorIndex(Stack[-4], 2))
0x736: @ Rotate(Stack[-2], Stack[-1])
0x737: Pop(2)
0x738: @ CameraWaitForPlayFinish()
0x739: Pop(0)
0x73a: @ ResumeWorld()
0x73b: Pop(0)
0x73c: Stack[-18] = (bool) 1
0x73d: Return(); Pop(16)

0x73e: PushEmpty()
0x73f: @ CameraSwitchToNormal()
0x740: Pop(0)
0x741: Return(); Pop(0)

0x742: PushEmpty(float, cvector, cvector, cvector, cvector, cvector, cvector, bool, float, cvector, cvector, cvector, cvector, cvector, cvector, bool)
0x743: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x744: Pop(0)
0x745: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x746: Pop(0)
0x747: Push(CvectorIndex(Stack[-7], 1))
0x748: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x749: CvectorIndex(Stack[-8], 1) = Stack[-1];
0x74a: @ GetPosition(Stack[-6])
0x74b: Pop(0)
0x74c: @ GetEyesHeight(Stack[-8])
0x74d: Pop(0)
0x74e: Push(CvectorIndex(Stack[-6], 1))
0x74f: Stack[-1] = Stack[-1] + Stack[-9]; Pop(0);
0x750: CvectorIndex(Stack[-7], 1) = Stack[-1];
0x751: Stack[-5] = Stack[-7] - Stack[-6]; Pop(0);
0x752: Push(CvectorIndex(Stack[-5], 1))
0x753: Stack[-1] = (int) 0
0x754: CvectorIndex(Stack[-6], 1) = Stack[-1];
0x755: Pop(0); Push(Stack[-5] | Stack[-5]);
0x756: Pop(1); Push(Sqrt(Stack[-1]))
0x757: Stack[-6] = Stack[-6] / Stack[-1]; Pop(1);
0x758: Stack[-4] = -Stack[-5]; Pop(0);
0x759: Push((int) 70)
0x75a: Pop(1); Push(Stack[-6] * Stack[-1]);
0x75b: Push(CVector(0.0, 10.0, 0.0))
0x75c: Stack[-5] = Stack[-2] - Stack[-1]; Pop(2);
0x75d: Stack[-2] = Stack[-6] + Stack[-3]; Pop(0);
0x75e: @ IsOverrideActive(Stack[-1])
0x75f: Pop(0)
0x760: Push(Stack[-1])
0x761: IF (Stack[-1] == 0) GOTO 0x764; Pop(1)

0x762: Stack[-18] = (bool) 0
0x763: Return(); Pop(16)

0x764: @ StopWorld()
0x765: Pop(0)
0x766: @ CameraTransit(Stack[-2], Stack[-4])
0x767: Pop(0)
0x768: Push(CvectorIndex(Stack[-3], 0))
0x769: Push(CvectorIndex(Stack[-4], 2))
0x76a: @ Rotate(Stack[-2], Stack[-1])
0x76b: Pop(2)
0x76c: @ CameraWaitForPlayFinish()
0x76d: Pop(0)
0x76e: @ ResumeWorld()
0x76f: Pop(0)
0x770: Stack[-18] = (bool) 1
0x771: Return(); Pop(16)

0x772: PushEmpty()
0x773: @ CameraSwitchToNormal()
0x774: Pop(0)
0x775: Return(); Pop(0)

0x776: PushEmpty(float, float, float, float)
0x777: Push("playing ") // @poff=598
0x778: Pop(1); Push(Stack[-1] + Stack[-6]);
0x779: @ Trace(Stack[-1])
0x77a: Pop(1)
0x77b: @ lshGetAnimTimes(Stack[-5], Stack[-2], Stack[-1])
0x77c: Pop(0)
0x77d: @ lshPlayAnimation(Stack[-2], Stack[-1])
0x77e: Pop(0)
0x77f: Push("start: ") // @poff=616
0x780: Pop(1); Push(Stack[-1] + Stack[-3]);
0x781: @ Trace(Stack[-1])
0x782: Pop(1)
0x783: Push("end: ") // @poff=632
0x784: Pop(1); Push(Stack[-1] + Stack[-2]);
0x785: @ Trace(Stack[-1])
0x786: Pop(1)
0x787: Return(); Pop(4)

0x788: PushEmpty(float, cvector, float, cvector)
0x789: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x78a: Pop(0)
0x78b: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x78c: Push(CvectorIndex(Stack[-1], 1))
0x78d: Stack[-3] = Stack[-1]
0x78e: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x78f: Push("head") // @poff=178
0x790: @ LookAsync(Stack[-6], Stack[-1], Stack[-2])
0x791: Pop(1)
0x792: Return(); Pop(4)
...
0x79a: PushEmpty(float, float)
0x79b: Pop(0); Push(Stack[-3] | Stack[-3]);
0x79c: Stack[-2] = Sqrt(Stack[-1]); Pop(1);
0x79d: Push((float)9.999999974752427e-07)
0x79e: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x79f: IF (Stack[-1] == 0) GOTO 0x7a2; Pop(1)

0x7a0: Stack[-4] = CVector(0.0, 0.0, 0.0)
0x7a1: Return(); Pop(2)

0x7a2: Stack[-4] = Stack[-3] / Stack[-1]; Pop(0);
0x7a3: Return(); Pop(2)

0x7a4: PushEmpty()
0x7a5: Pop(0); Push(Stack[-2] | Stack[-1]);
0x7a6: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7a7: Pop(0); Push(Stack[-3] | Stack[-3]);
0x7a8: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7a9: Pop(1); Push(Sqrt(Stack[-1]))
0x7aa: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x7ab: Return(); Pop(0)

0x7ac: PushEmpty()
0x7ad: Push(CvectorIndex(Stack[-2], 0))
...
0x7b2: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7b3: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x7b4: Return(); Pop(0)

0x7b5: PushEmpty()
0x7b6: Push(CvectorIndex(Stack[-1], 0))
0x7b7: Push(CvectorIndex(Stack[-2], 0))
0x7b8: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7b9: Push(CvectorIndex(Stack[-2], 2))
0x7ba: Push(CvectorIndex(Stack[-3], 2))
0x7bb: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7bc: Pop(2); Push(Stack[-2] + Stack[-1]);
0x7bd: Stack[-3] = Sqrt(Stack[-1]); Pop(1);
0x7be: Return(); Pop(0)

0x7bf: PushEmpty()
0x7c0: PushEmpty(float, cvector, cvector)
0x7c1: Stack[-5] = Stack[-2]
0x7c2: Stack[-4] = Stack[-1]
0x7c3: Call 0x7ac

0x7c4: Pop(2)
0x7c5: PushEmpty(float, cvector)
0x7c6: Stack[-5] = Stack[-1]
0x7c7: Call 0x7b5

0x7c8: Pop(1)
0x7c9: PushEmpty(float, cvector)
0x7ca: Stack[-5] = Stack[-1]
0x7cb: Call 0x7b5

0x7cc: Pop(1)
0x7cd: Pop(2); Push(Stack[-2] * Stack[-1]);
0x7ce: Stack[-5] = Stack[-2] / Stack[-1]; Pop(2);
0x7cf: Return(); Pop(0)

0x7d0: PushEmpty(float, float)
0x7d1: @ GetGameTime(Stack[-1])
0x7d2: Pop(0)
0x7d3: Push((int) 1)
0x7d4: PushEmpty(int)
0x7d5: Push((int) 24)
0x7d6: Stack[-2] = Stack[-4] / Stack[-1]; Pop(1);
0x7d7: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x7d8: Return(); Pop(2)

0x7d9: PushEmpty()
0x7da: PushEmpty(object)
0x7db: Stack[-2] = Stack[-1]
0x7dc: Push(-1, 0); TaskCall(1)
0x7dd: Call 0x16

0x7de: Pop(-1, 0); TaskReturn
0x7df: Pop(1)
0x7e0: Return(); Pop(0)

0x7e1: PushEmpty(float, float)
0x7e2: Push("health") // @poff=644
0x7e3: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x7e4: IF (Stack[-1] == 0) GOTO 0x7ed; Pop(1)

0x7e5: Push("health") // @poff=644
0x7e6: @ GetProperty(Stack[-1], Stack[-2])
0x7e7: Pop(1)
0x7e8: Push((int) 0)
0x7e9: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x7ea: IF (Stack[-1] == 0) GOTO 0x7ed; Pop(1)

0x7eb: @ SignalDeath(Stack[-4])
0x7ec: Pop(0)
0x7ed: Return(); Pop(2)
...
0x7f4: PushEmpty()
0x7f5: PushEmpty(object, int, float)
0x7f6: Stack[-7] = Stack[-3]
0x7f7: Stack[-6] = Stack[-2]
0x7f8: Stack[-5] = Stack[-1]
0x7f9: Call 0x6b3

0x7fa: Pop(3)
0x7fb: Return(); Pop(0)

0x7fc: PushEmpty(string, string)
0x7fd: Stack[-1] = "idle" // @poff=8
0x7fe: Push(Stack[-3])
0x7ff: IF (Stack[-1] == 0) GOTO 0x801; Pop(1)

0x800: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x801: Stack[-1] = Stack[-4]
0x802: Return(); Pop(2)

0x803: PushEmpty(int, bool, int, bool)
0x804: Stack[-2] = (int) 0
0x805: Push("all") // @poff=0
0x806: PushEmpty(string, int)
0x807: Stack[-5] = Stack[-1]
0x808: Call 0x7fc

0x809: Pop(1)
0x80a: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x80b: Pop(2)
...
0x80f: Push((int) 1)
0x810: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x811: GOTO 0x805

0x812: Stack[-2] = Stack[-5]
0x813: Return(); Pop(4)
...
0x820: Push(-1, 1); TaskCall(4)
0x821: Call 0x29b

0x822: Pop(-1, 1); TaskReturn
0x823: Pop(1)
0x824: Return(); Pop(0)
...
0x82f: PushEmpty()
0x830: PushEmpty(object)
0x831: Stack[-2] = Stack[-1]
0x832: Push(-1, 3); TaskCall(5)
0x833: Call 0x37d

0x834: Pop(-1, 3); TaskReturn
0x835: Pop(1)
0x836: Return(); Pop(0)

0x837: PushEmpty()
0x838: PushEmpty(bool, object)
0x839: Stack[-3] = Stack[-1]
0x83a: Call 0x69b
...
0x843: Stack[-2] = Stack[-1]
0x844: Push(-1, 3); TaskCall(6)
0x845: Call 0x470

0x846: Pop(-1, 3); TaskReturn
0x847: Pop(1)
0x848: Return(); Pop(0)
...
0x85e: Push("player") // @poff=658
0x85f: @ GetVariable(Stack[-1], Stack[-2])
0x860: Pop(1)
0x861: Push((int) 0)
0x862: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0x863: IF (Stack[-1] == 0) GOTO 0x867; Pop(1)

0x864: Stack[-3] = (int) 200001
0x865: Return(); Pop(2)
...
0x86a: Stack[-3] = (int) 200002
0x86b: Return(); Pop(2)

0x86c: Stack[-3] = (int) 200003
0x86d: Return(); Pop(2)

0x86e: PushEmpty(int, int, int, bool, int, int, int, bool)
0x86f: Pop(0); Push((bool) Stack[-10] > Stack[-9])
0x870: IF (Stack[-1] == 0) GOTO 0x875; Pop(1)

0x871: Push("GenerateMoney: iMin > iMax") // @poff=672
0x872: @ Trace(Stack[-1])
0x873: Pop(1)
0x874: Return(); Pop(8)

0x875: Stack[-4] = (int) 0
0x876: Pop(0); Push((bool) Stack[-10] != Stack[-9])
0x877: IF (Stack[-1] == 0) GOTO 0x87c; Pop(1)

0x878: Pop(0); Push(Stack[-9] - Stack[-10]);
0x879: @ irand(Stack[-4], Stack[-1])
0x87a: Pop(1)
0x87b: GOTO 0x880

0x87c: Push((int) 0)
0x87d: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x87e: IF (Stack[-1] == 0) GOTO 0x880; Pop(1)

0x87f: Return(); Pop(8)

0x880: Stack[-4] = Stack[-4] + Stack[-10]; Pop(0);
0x881: Push((int) 0)
0x882: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x883: IF (Stack[-1] == 0) GOTO 0x885; Pop(1)

0x884: Return(); Pop(8)

0x885: Push("Money") // @poff=726
0x886: @ GetInvItemByName(Stack[-3], Stack[-1])
0x887: Pop(1)
0x888: Push((int) 0)
0x889: @ AddItem(Stack[-2], Stack[-3], Stack[-1], Stack[-5])
0x88a: Pop(1)
0x88b: Return(); Pop(8)

0x88c: PushEmpty(int, bool, int, bool)
0x88d: Push(Stack[-5])
0x88e: IF (Stack[-1] == 0) GOTO 0x8e5; Pop(1)

0x88f: PushEmpty(int, int)
0x890: Stack[-2] = (int) 0
0x891: Push((int) 100)
0x892: PushEmpty(int)
0x893: Call 0x7d0
...
0x894: Pop(0)
0x895: Push((int) 100)
0x896: Pop(2); Push(Stack[-2] * Stack[-1]);
0x897: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x898: Call 0x86e

0x899: Pop(2)
0x89a: Push((int) 9)
0x89b: @ irand(Stack[-3], Stack[-1])
0x89c: Pop(1)
0x89d: Push((int) 0)
...
0x8c4: PushEmpty(int, string)
0x8c5: Stack[-1] = "syringe" // @poff=770
0x8c6: Call 0x93b

0x8c7: Pop(1)
0x8c8: Push((int) 0)
0x8c9: Push((int) 1)
0x8ca: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8cb: Pop(3)
0x8cc: GOTO 0x8e4

0x8cd: Push((int) 5)
0x8ce: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8cf: IF (Stack[-1] == 0) GOTO 0x8d9; Pop(1)

0x8d0: PushEmpty(int, string)
0x8d1: Stack[-1] = "watch" // @poff=786
0x8d2: Call 0x93b

0x8d3: Pop(1)
0x8d4: Push((int) 0)
0x8d5: Push((int) 1)
0x8d6: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8d7: Pop(3)
0x8d8: GOTO 0x8e4

0x8d9: Push((int) 6)
0x8da: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x8db: IF (Stack[-1] == 0) GOTO 0x8e4; Pop(1)

0x8dc: PushEmpty(int, string)
0x8dd: Stack[-1] = "razor" // @poff=798
0x8de: Call 0x93b

0x8df: Pop(1)
0x8e0: Push((int) 0)
0x8e1: Push((int) 1)
0x8e2: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x8e3: Pop(3)
0x8e4: GOTO 0x93a
...
0x8ea: Pop(0)
0x8eb: Push((int) 50)
0x8ec: Pop(2); Push(Stack[-2] * Stack[-1]);
0x8ed: Stack[-3] = Stack[-2] + Stack[-1]; Pop(2);
0x8ee: Call 0x86e

0x8ef: Pop(2)
0x8f0: Push((int) 8)
0x8f1: @ irand(Stack[-3], Stack[-1])
0x8f2: Pop(1)
0x8f3: Push((int) 0)
...
0x903: Stack[-1] = "bracelet" // @poff=822
0x904: Call 0x93b
...
0x90d: IF (Stack[-1] == 0) GOTO 0x917; Pop(1)

0x90e: PushEmpty(int, string)
0x90f: Stack[-1] = "ear_ring" // @poff=840
0x910: Call 0x93b
...
0x919: IF (Stack[-1] == 0) GOTO 0x923; Pop(1)

0x91a: PushEmpty(int, string)
0x91b: Stack[-1] = "gold_ring" // @poff=858
0x91c: Call 0x93b

0x91d: Pop(1)
0x91e: Push((int) 0)
0x91f: Push((int) 1)
0x920: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x921: Pop(3)
0x922: GOTO 0x93a

0x923: Push((int) 4)
0x924: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x925: IF (Stack[-1] == 0) GOTO 0x92f; Pop(1)

0x926: PushEmpty(int, string)
0x927: Stack[-1] = "silver_ring" // @poff=878
0x928: Call 0x93b

0x929: Pop(1)
0x92a: Push((int) 0)
0x92b: Push((int) 1)
0x92c: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x92d: Pop(3)
0x92e: GOTO 0x93a

0x92f: Push((int) 5)
0x930: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x931: IF (Stack[-1] == 0) GOTO 0x93a; Pop(1)

0x932: PushEmpty(int, string)
0x933: Stack[-1] = "flower" // @poff=902
0x934: Call 0x93b

0x935: Pop(1)
0x936: Push((int) 0)
0x937: Push((int) 1)
0x938: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x939: Pop(3)
0x93a: Return(); Pop(4)

0x93b: PushEmpty(int, int)
0x93c: @ GetInvItemByName(Stack[-1], Stack[-3])
0x93d: Pop(0)
0x93e: Stack[-1] = Stack[-4]
0x93f: Return(); Pop(2)

0x940: PushEmpty(object, float, object, float)
0x941: Push("player") // @poff=658
0x942: @ FindActor(Stack[-3], Stack[-1])
0x943: Pop(1)
0x944: Pop(0); Push((bool) Stack[-2] == 0)
0x945: IF (Stack[-1] == 0) GOTO 0x948; Pop(1)

0x946: Stack[-5] = (int) 0
0x947: Return(); Pop(4)

0x948: Push("reputation") // @poff=916
0x949: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=500
0x94a: Pop(1)
0x94b: Stack[-1] = Stack[-5]
0x94c: Return(); Pop(4)

0x94d: Stack[-2] = 0
0x94e: Stack[-1] = (int) 3352
0x94f: Return(); Pop(0)

0x950: Stack[-1] = "ui/NPC_None.png" // @poff=938
0x951: Return(); Pop(0)

0x952: Stack[-1] = (bool) 0
0x953: Return(); Pop(0)

0x954: Push(GlobalVars[1])
0x955: Stack[-1] = (bool) 0
0x956: GlobalVars[1] = Stack[-1]; Pop(1)
...
0x95c: PushEmpty(bool, bool)
0x95d: Push(GlobalVars[1])
0x95e: IF (Stack[-1] == 0) GOTO 0x967; Pop(1)

0x95f: @ IsOverrideActive(Stack[-1])
0x960: Pop(0)
0x961: Pop(0); Push((bool) Stack[-1] == 0)
0x962: IF (Stack[-1] == 0) GOTO 0x965; Pop(1)

0x963: @ WorkWithCorpse(Stack[-3])
0x964: Pop(0)
0x965: Return(); Pop(2)
...
0x967: Push((int) 1000)
0x968: PushEmpty(int, object)
0x969: Stack[-6] = Stack[-1]
0x96a: Push(-2, 1); TaskCall(7)
0x96b: Call 0x504

0x96c: Pop(-2, 1); TaskReturn
0x96d: Pop(1)
0x96e: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x96f: IF (Stack[-1] == 0) GOTO 0x981; Pop(1)

0x970: PushEmpty(bool, object)
0x971: Stack[-5] = Stack[-1]
0x972: Call 0x742
...
0x979: Push(-1, 1); TaskCall(0)
0x97a: Call 0x0

0x97b: Pop(-1, 1); TaskReturn
0x97c: Pop(1)
...
0x982: PushEmpty(float)
0x983: Call 0x940

0x984: Pop(0)
0x985: Push((float)0.699999988079071)
0x986: Stack[-3] = Stack[-2] > Stack[-1]; Pop(2);
0x987: Return(); Pop(0)

0x988: PushEmpty(string, bool, string, bool)
0x989: PushEmpty(bool, object, string)
0x98a: Stack[-8] = Stack[-2]
0x98b: Stack[-1] = "class" // @poff=970
0x98c: Call 0x666
...
0x990: Stack[-7] = (bool) 0
0x991: Return(); Pop(4)

0x992: Push("class") // @poff=970
0x993: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=500
0x994: Pop(1)
0x995: Push("rat") // @poff=982
0x996: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x997: IF (Stack[-1] == 0) GOTO 0x99b; Pop(1)

0x998: Stack[-7] = (bool) 0
0x999: Return(); Pop(4)

0x99a: GOTO 0x9a0

0x99b: Push("dog") // @poff=990
0x99c: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x99d: IF (Stack[-1] == 0) GOTO 0x9a0; Pop(1)

0x99e: Stack[-7] = (bool) 0
0x99f: Return(); Pop(4)

0x9a0: @ CanSee(Stack[-1], Stack[-6])
0x9a1: Pop(0)
0x9a2: PushEmpty(bool)
0x9a3: Stack[-1] = (bool) 1
0x9a4: Push(Stack[-2])
0x9a5: IF (Stack[-1] == 1) GOTO 0x9ae; Pop(1)

0x9a6: PushEmpty(float, object)
0x9a7: Stack[-9] = Stack[-1]
0x9a8: Call 0x65e

0x9a9: Pop(1)
0x9aa: Push((float)250000.0)
0x9ab: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x9ac: IF (Stack[-1] == 1) GOTO 0x9ae; Pop(1)

0x9ad: Stack[-1] = (bool) 0
0x9ae: IF (Stack[-1] == 0) GOTO 0x9b4; Pop(1)

0x9af: Push((float)-0.30000001192092896)
0x9b0: @ ReportReputationChange(Stack[-7], Stack[-6], Stack[-1])
0x9b1: Pop(1)
0x9b2: Stack[-7] = (bool) 1
0x9b3: Return(); Pop(4)

0x9b4: @ CanSee(Stack[-1], Stack[-5])
0x9b5: Pop(0)
0x9b6: PushEmpty(bool)
0x9b7: Stack[-1] = (bool) 1
0x9b8: Push(Stack[-2])
0x9b9: IF (Stack[-1] == 1) GOTO 0x9c2; Pop(1)

0x9ba: PushEmpty(float, object)
0x9bb: Stack[-8] = Stack[-1]
0x9bc: Call 0x65e

0x9bd: Pop(1)
0x9be: Push((float)250000.0)
0x9bf: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x9c0: IF (Stack[-1] == 1) GOTO 0x9c2; Pop(1)

0x9c1: Stack[-1] = (bool) 0
0x9c2: IF (Stack[-1] == 0) GOTO 0x9c5; Pop(1)

0x9c3: Stack[-7] = (bool) 1
0x9c4: Return(); Pop(4)

0x9c5: Stack[-7] = (bool) 0
0x9c6: Return(); Pop(4)

0x9c7: PushEmpty()
0x9c8: Push(GlobalVars[1])
0x9c9: Stack[-1] = (bool) 1
0x9ca: GlobalVars[1] = Stack[-1]; Pop(1)
0x9cb: Push((int) 50)
0x9cc: Push((int) 40)
0x9cd: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x9ce: Pop(2)
0x9cf: Return(); Pop(0)
