...
Strings:
	...
	W:rat
	W:dog
// @pool_raw:
...
0x368: @ Face(Stack[-1])
0x369: Pop(0)
0x36a: Push("all") // @poff=170
0x36b: Push("attack_on") // @poff=178
0x36c: @ PlayAnimation(Stack[-2], Stack[-1])
0x36d: Pop(2)
0x36e: @ WaitForAnimEnd()
0x36f: Pop(0)
0x370: Push("all") // @poff=170
0x371: Push("attack_stay") // @poff=198
0x372: @ PlayAnimation(Stack[-2], Stack[-1])
0x373: Pop(2)
0x374: @ WaitForAnimEnd()
0x375: Pop(0)
0x376: Push("all") // @poff=170
0x377: Push("attack_off") // @poff=222
...
0x38c: Pop(0)
0x38d: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x38e: Pop(0)
...
0x3ab: Stack[-1] = (float) 1.7453293800354004
0x3ac: Call 0x38a

0x3ad: Stack[-2] = Stack[-7]
0x3ae: Pop(2)
...
0x3b3: Push("Can't retreat, distance: ") // @poff=244
...
0x3c9: Push((int) 1)
0x3ca: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x3cb: Pop(1)
0x3cc: Push(Stack[-3])
0x3cd: IF (Stack[-1] == 0) GOTO 0x3e5; Pop(1)

0x3ce: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3d3: Stack[-1] = (float) 2.6179938316345215
0x3d4: Call 0x38a

0x3d5: Stack[-2] = Stack[-4]
0x3d6: Pop(2)
...
0x3e6: IF (Stack[-1] == 1) GOTO 0x3c9; Pop(1)
...
0x3ed: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3fc: Stack[-1] = (float) 1.7453293800354004
0x3fd: Call 0x38a

0x3fe: Stack[-2] = Stack[-4]
0x3ff: Pop(2)
...
0x40c: IF (Stack[-1] == 1) GOTO 0x412; Pop(1)

0x40d: PushEmpty(bool)
0x40e: Call 0x42c

0x40f: Pop(0)
0x410: IF (Stack[-1] == 1) GOTO 0x412; Pop(1)
...
0x432: Stack[-2] = Stack[-3]
0x433: Pop(2)
0x434: PushEmpty(float, cvector, cvector)
0x435: Stack[-5] = Stack[-2]
0x436: Stack[-4] = Stack[-1]
0x437: Call 0x5bd

0x438: Pop(2)
0x439: Push((float)-0.3420201241970062)
...
0x43e: Pop(0)
0x43f: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x440: Pop(0)
...
0x45d: Stack[-1] = (float) 1.7453293800354004
0x45e: Call 0x43c

0x45f: Stack[-2] = Stack[-7]
0x460: Pop(2)
...
0x465: Push("Can't retreat, distance: ") // @poff=244
...
0x47b: Push((int) 1)
0x47c: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x47d: Pop(1)
0x47e: Push(Stack[-3])
0x47f: IF (Stack[-1] == 0) GOTO 0x497; Pop(1)

0x480: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x485: Stack[-1] = (float) 2.6179938316345215
0x486: Call 0x43c
...
0x498: IF (Stack[-1] == 1) GOTO 0x47b; Pop(1)
...
0x4ae: Stack[-1] = (float) 1.7453293800354004
0x4af: Call 0x43c
...
0x4be: IF (Stack[-1] == 1) GOTO 0x4c4; Pop(1)
...
0x4e4: Stack[-2] = Stack[-3]
0x4e5: Pop(2)
0x4e6: PushEmpty(float, cvector, cvector)
0x4e7: Stack[-5] = Stack[-2]
0x4e8: Stack[-4] = Stack[-1]
0x4e9: Call 0x5bd

0x4ea: Pop(2)
0x4eb: Push((float)-0.3420201241970062)
...
0x4fc: Pop(0)
0x4fd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x4fe: Pop(0)
...
0x503: Push("HasProperty") // @poff=296
0x504: Push((int) 2)
...
0x50a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=320
0x50b: Pop(0)
0x50c: Stack[-1] = Stack[-5]
0x50d: Return(); Pop(2)

0x50e: PushEmpty(bool, bool)
0x50f: @@ IsDead(Stack[-1]); Obj=3 // @poff=332
0x510: Pop(0)
0x511: Stack[-1] = Stack[-4]
0x512: Return(); Pop(2)

0x513: PushEmpty(object, object, object, object)
0x514: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x528: Pop(0)
0x529: Pop(0); PushNull((bool) Stack[-2] == 0)
0x52a: IF (Stack[-1] == 0) GOTO 0x52d; Pop(1)

0x52b: Stack[-6] = (bool) 0
0x52c: Return(); Pop(4)

0x52d: @@ GetScene(Stack[-1]); Obj=5 // @poff=353
0x52e: Pop(0)
...
0x542: Stack[-1] = "noaccess" // @poff=362
0x543: Call 0x502
...
0x549: Push("noaccess") // @poff=362
0x54a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=380
0x54b: Pop(1)
0x54c: Push((int) 0)
...
0x575: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x576: Pop(0)
...
0x586: Stack[-1] = "fhit" // @poff=430
0x587: GOTO 0x589

0x588: Stack[-1] = "bhit" // @poff=440
0x589: Push("hit_react") // @poff=450
0x58a: Push("1") // @poff=470
0x58b: Pop(1); Push(Stack[-3] + Stack[-1]);
0x58c: Push("2") // @poff=474
...
0x593: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x594: Pop(0)
...
0x59f: Pop(0)
0x5a0: Stack[-1] = Stack[-3]
0x5a1: Return(); Pop(2)

0x5a2: PushEmpty(float, cvector, float, cvector)
0x5a3: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x5a4: Pop(0)
...
0x5b6: Push((float)9.999999974752427e-07)
...
0x679: Push("GenerateMoney: iMin > iMax") // @poff=502
0x67a: @ Trace(Stack[-1])
0x67b: Pop(1)
0x67c: Return(); Pop(8)
...
0x6cd: Stack[-1] = "syringe" // @poff=600
0x6ce: Call 0x743
...
0x70b: Stack[-1] = "bracelet" // @poff=652
0x70c: Call 0x743
...
0x717: Stack[-1] = "ear_ring" // @poff=670
0x718: Call 0x743
...
0x723: Stack[-1] = "gold_ring" // @poff=688
0x724: Call 0x743
...
0x72f: Stack[-1] = "silver_ring" // @poff=708
0x730: Call 0x743
...
0x750: Push("reputation") // @poff=760
0x751: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=380
0x752: Pop(1)
...
0x78b: Push("class") // @poff=796
0x78c: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=380
0x78d: Pop(1)
0x78e: Push("rat") // @poff=808
...
0x7b1: Push(Stack[-2])
0x7b2: IF (Stack[-1] == 1) GOTO 0x7bb; Pop(1)

0x7b3: PushEmpty(float, object)
0x7b4: Stack[-8] = Stack[-1]
0x7b5: Call 0x4fa

0x7b6: Pop(1)
0x7b7: Push((float)250000.0)
0x7b8: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x7b9: IF (Stack[-1] == 1) GOTO 0x7bb; Pop(1)
