...
Strings:
	...
	W:woman
	W:worker
// @pool_raw:
...
0x673: Stack[-1] = "Neutral" // @poff=553
0x674: Call 0x6a6

0x675: Pop(1)
0x676: Push((int) 14660)
0x677: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x678: Pop(1)
0x679: @@@ ClearReplies(); Obj=0 // @poff=580
0x67a: Pop(0)
...
0x697: Push("all") // @poff=0
0x698: Push("idle") // @poff=8
...
0x6a0: Push("all") // @poff=0
0x6a1: Push("idle") // @poff=8
...
0x6c0: Stack[-1] = "Neutral" // @poff=553
0x6c1: Call 0x6a6

0x6c2: Pop(1)
0x6c3: Push((int) 14649)
0x6c4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6c5: Pop(1)
0x6c6: @@@ ClearReplies(); Obj=0 // @poff=580
0x6c7: Pop(0)
0x6c8: Push((int) 14650)
0x6c9: Push((int) 15888)
0x6ca: Push((int) 15887)
0x6cb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6cc: Pop(3)
0x6cd: Push((int) 14658)
0x6ce: Push((int) -1)
0x6cf: Push((int) 15895)
0x6d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6d1: Pop(3)
0x6d2: Push((int) 14659)
0x6d3: Push((int) -1)
0x6d4: Push((int) 15896)
0x6d5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6d6: Pop(3)
0x6d7: Return(); Pop(0)

0x6d8: PushEmpty(string)
0x6d9: Stack[-1] = "Neutral" // @poff=553
0x6da: Call 0x6a6

0x6db: Pop(1)
0x6dc: Push((int) 14660)
0x6dd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6de: Pop(1)
0x6df: @@@ ClearReplies(); Obj=0 // @poff=580
0x6e0: Pop(0)
0x6e1: Push((int) 14661)
0x6e2: Push((int) 15899)
0x6e3: Push((int) 15898)
0x6e4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6e5: Pop(3)
...
0x6f0: Stack[-1] = "Neutral" // @poff=553
0x6f1: Call 0x6a6

0x6f2: Pop(1)
0x6f3: Push((int) 14668)
0x6f4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6f5: Pop(1)
0x6f6: @@@ ClearReplies(); Obj=0 // @poff=580
0x6f7: Pop(0)
...
0x700: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x701: Pop(3)
0x702: Return(); Pop(0)
...
0x707: Stack[-1] = "Neutral" // @poff=553
0x708: Call 0x6a6

0x709: Pop(1)
0x70a: Push((int) 14662)
0x70b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x70c: Pop(1)
0x70d: @@@ ClearReplies(); Obj=0 // @poff=580
0x70e: Pop(0)
0x70f: Push((int) 14663)
0x710: Push((int) 15901)
0x711: Push((int) 15900)
0x712: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x713: Pop(3)
0x714: Return(); Pop(0)
...
0x719: Stack[-1] = "Neutral" // @poff=553
0x71a: Call 0x6a6

0x71b: Pop(1)
0x71c: Push((int) 14664)
0x71d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x71e: Pop(1)
0x71f: @@@ ClearReplies(); Obj=0 // @poff=580
0x720: Pop(0)
0x721: Push((int) 14665)
0x722: Push((int) -1)
0x723: Push((int) 15902)
0x724: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x725: Pop(3)
0x726: Push((int) 14666)
0x727: Push((int) -1)
0x728: Push((int) 15903)
0x729: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x72a: Pop(3)
0x72b: Return(); Pop(0)
...
0x730: Stack[-1] = "Neutral" // @poff=553
0x731: Call 0x6a6

0x732: Pop(1)
0x733: Push((int) 14651)
0x734: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x735: Pop(1)
0x736: @@@ ClearReplies(); Obj=0 // @poff=580
0x737: Pop(0)
0x738: Push((int) 14652)
0x739: Push((int) 15890)
0x73a: Push((int) 15889)
0x73b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x73c: Pop(3)
0x73d: Push((int) 14657)
0x73e: Push((int) -1)
0x73f: Push((int) 15894)
0x740: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x741: Pop(3)
0x742: Return(); Pop(0)
...
0x747: Stack[-1] = "Neutral" // @poff=553
0x748: Call 0x6a6

0x749: Pop(1)
0x74a: Push((int) 14653)
0x74b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x74c: Pop(1)
0x74d: @@@ ClearReplies(); Obj=0 // @poff=580
0x74e: Pop(0)
0x74f: Push((int) 14654)
0x750: Push((int) -1)
0x751: Push((int) 15891)
0x752: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x753: Pop(3)
0x754: Push((int) 14655)
0x755: Push((int) -1)
0x756: Push((int) 15892)
0x757: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x758: Pop(3)
0x759: Push((int) 14656)
0x75a: Push((int) -1)
0x75b: Push((int) 15893)
0x75c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x75d: Pop(3)
0x75e: Return(); Pop(0)
...
0x770: Stack[-2] = "fire" // @poff=602
0x771: Return(); Pop(0)

0x772: Stack[-2] = "phys" // @poff=612
0x773: Return(); Pop(0)

0x774: PushEmpty(cvector, cvector, cvector, cvector)
0x775: @ GetPosition(Stack[-2])
0x776: Pop(0)
0x777: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x778: Pop(0)
...
0x77d: Pop(0)
0x77e: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x77f: Pop(0)
...
0x784: Push("HasProperty") // @poff=622
0x785: Push((int) 2)
...
0x78b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x78c: Pop(0)
0x78d: Stack[-1] = Stack[-5]
0x78e: Return(); Pop(2)

0x78f: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x790: PushEmpty(bool, object, string)
0x791: Stack[-18] = Stack[-2]
0x792: Stack[-1] = "health" // @poff=658
0x793: Call 0x783
...
0x79a: Stack[-18] = Stack[-2]
0x79b: Stack[-1] = "armor" // @poff=672
0x79c: Call 0x783
...
0x7a2: Push("armor") // @poff=672
0x7a3: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x7a4: Pop(1)
0x7a5: Push("armor_") // @poff=696
0x7a6: PushEmpty(string, int)
0x7a7: Stack[-16] = Stack[-1]
0x7a8: Call 0x76c

0x7a9: Pop(1)
0x7aa: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x7ab: PushEmpty(bool, object, string)
0x7ac: Stack[-18] = Stack[-2]
...
0x7b4: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x7b5: Pop(0)
...
0x7bc: Stack[-3] = Stack[-6]
0x7bd: Pop(3)
0x7be: Push("health") // @poff=658
0x7bf: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x7c0: Pop(1)
0x7c1: Push((int) 1)
0x7c2: Pop(1); Push(Stack[-1] - Stack[-4]);
0x7c3: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x7c4: Push("health") // @poff=658
...
0x7ca: Pop(3)
0x7cb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x7cc: Pop(2)
0x7cd: Stack[-1] = Stack[-16]
0x7ce: Return(); Pop(12)

0x7cf: PushEmpty(bool, bool)
0x7d0: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x7d1: Pop(0)
0x7d2: Stack[-1] = Stack[-4]
0x7d3: Return(); Pop(2)

0x7d4: PushEmpty(object, object, object, object)
0x7d5: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x7e9: Pop(0)
0x7ea: Pop(0); PushNull((bool) Stack[-2] == 0)
0x7eb: IF (Stack[-1] == 0) GOTO 0x7ee; Pop(1)

0x7ec: Stack[-6] = (bool) 0
0x7ed: Return(); Pop(4)

0x7ee: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x7ef: Pop(0)
...
0x802: Stack[-6] = Stack[-2]
0x803: Stack[-1] = "noaccess" // @poff=752
0x804: Call 0x783
...
0x80a: Push("noaccess") // @poff=752
0x80b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x80c: Pop(1)
0x80d: Push((int) 0)
...
0x836: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x837: Pop(0)
...
0x847: Stack[-1] = "fhit" // @poff=808
0x848: GOTO 0x84a

0x849: Stack[-1] = "bhit" // @poff=818
0x84a: Push("hit_react") // @poff=828
0x84b: Push("1") // @poff=848
0x84c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x84d: Push("2") // @poff=852
...
0x854: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x855: Pop(0)
...
0x864: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x865: Pop(0)
0x866: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x867: Pop(0)
...
0x8a0: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x8a1: Pop(0)
0x8a2: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x8a3: Pop(0)
...
0x8db: Pop(0)
0x8dc: Push("start: ") // @poff=874
0x8dd: Pop(1); Push(Stack[-1] + Stack[-3]);
0x8de: @ Trace(Stack[-1])
0x8df: Pop(1)
0x8e0: Push("end: ") // @poff=890
...
0x8e6: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x8e7: Pop(0)
...
0x8fa: Push((float)9.999999974752427e-07)
...
0x928: Stack[-5] = Stack[-2]
0x929: Stack[-4] = Stack[-1]
0x92a: Call 0x913

0x92b: Pop(2)
0x92c: PushEmpty(float, cvector)
0x92d: Stack[-5] = Stack[-1]
0x92e: Call 0x91c

0x92f: Pop(1)
0x930: PushEmpty(float, cvector)
0x931: Stack[-5] = Stack[-1]
0x932: Call 0x91c
...
0x95d: Stack[-7] = Stack[-3]
0x95e: Stack[-6] = Stack[-2]
...
0x9fc: Push("GenerateMoney: iMin > iMax") // @poff=930
0x9fd: @ Trace(Stack[-1])
0x9fe: Pop(1)
0x9ff: Return(); Pop(8)
...
0xa50: Stack[-1] = "syringe" // @poff=1028
0xa51: Call 0xac6
...
0xa8e: Stack[-1] = "bracelet" // @poff=1080
0xa8f: Call 0xac6
...
0xa9a: Stack[-1] = "ear_ring" // @poff=1098
0xa9b: Call 0xac6
...
0xaa6: Stack[-1] = "gold_ring" // @poff=1116
0xaa7: Call 0xac6
...
0xab2: Stack[-1] = "silver_ring" // @poff=1136
0xab3: Call 0xac6
...
0xabe: Stack[-1] = "flower" // @poff=1160
0xabf: Call 0xac6
...
0xacd: Stack[-1] = "ui/NPC_None.png" // @poff=1174
0xace: Return(); Pop(0)
...
0xb06: Stack[-8] = Stack[-2]
0xb07: Stack[-1] = "class" // @poff=1206
0xb08: Call 0x783
...
0xb0e: Push("class") // @poff=1206
0xb0f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=684
0xb10: Pop(1)
...
0xb2f: Push("wasted_girl") // @poff=1260
