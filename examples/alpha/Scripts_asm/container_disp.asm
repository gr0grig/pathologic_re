...
Strings:
	...
	A:GetProperty
	W:nouse_container
// @pool_raw:49734f6e47726f756e640075006e0064006900730070006f007300610062006c006500000048617350726f70657274790047657450726f7065727479006e006f007500730065005f0063006f006e007400610069006e00650072000000
// @pool_encoding:utf8
...
0x21: @ StopGroup0()
0x22: Pop(0)
0x23: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=0
0x24: Pop(0)
0x25: Push(Stack[-2])
...
0x4c: Pop(0)
0x4d: Push("undisposable") // @poff=11
0x4e: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=37
0x4f: Pop(1)
0x50: Push(Stack[-2])
0x51: IF (Stack[-1] == 0) GOTO 0x58; Pop(1)

0x52: Push("undisposable") // @poff=11
0x53: @@ GetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=49
0x54: Pop(1)
0x55: Push(Stack[-1])
...
0x63: Push("nouse_container") // @poff=61
