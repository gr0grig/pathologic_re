...
Strings:
	...
	W:Category
	A:AddItem
// @pool_raw:
...
0x86: @@ GetItemID(Stack[-3]); Obj=8 // @poff=128
0x87: Pop(0)
0x88: Push("Category") // @poff=138
0x89: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x8a: Pop(1)
0x8b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=156
0x8c: Pop(0)
