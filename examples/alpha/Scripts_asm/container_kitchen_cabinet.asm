...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0x7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=14
0x8: Pop(1)
0x9: Push(Stack[-1])
0xa: IF (Stack[-1] == 0) GOTO 0x35; Pop(1)

0xb: PushEmpty(string, int, int)
0xc: Stack[-3] = "Knife" // @poff=26
0xd: Stack[-2] = (int) 1
0xe: Stack[-1] = (int) 10
0xf: Call 0xb7
...
0x65: Stack[-3] = "dried_fish" // @poff=116
0x66: Stack[-2] = (int) 1
0x67: Stack[-1] = (int) 50
0x68: Call 0xb7
...
0x71: Stack[-3] = "vegetables" // @poff=146
0x72: Stack[-2] = (int) 1
0x73: Stack[-1] = (int) 50
0x74: Call 0xb7
...
0x7d: Stack[-3] = "dried_meat" // @poff=178
0x7e: Stack[-2] = (int) 1
0x7f: Stack[-1] = (int) 50
0x80: Call 0xb7
...
0x83: Stack[-3] = "smoked_meat" // @poff=200
0x84: Stack[-2] = (int) 1
0x85: Stack[-1] = (int) 50
0x86: Call 0xb7
...
0x89: Stack[-3] = "fresh_fish" // @poff=224
0x8a: Stack[-2] = (int) 1
0x8b: Stack[-1] = (int) 50
0x8c: Call 0xb7
...
0x8f: Stack[-3] = "fresh_meat" // @poff=246
0x90: Stack[-2] = (int) 1
0x91: Stack[-1] = (int) 50
0x92: Call 0xb7
...
0xaa: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=280
0xab: Pop(0)
0xac: Push(Stack[-2])
...
0xd7: Push("nouse_container") // @poff=291
