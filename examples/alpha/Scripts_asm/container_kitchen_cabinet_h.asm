...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:4b006e006900660065000000540076006900720069006e0000004c0065006d006f006e000000460075006e00640075006b0000005000650061006e00750074000000570061006c006e0075007400000049734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
...
0x37: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=80
0x38: Pop(0)
0x39: Push(Stack[-2])
...
0x51: Stack[-10] = Stack[-2]
0x52: Stack[-9] = Stack[-1]
0x53: Call 0x5e
...
0x64: Push("nouse_container") // @poff=91
