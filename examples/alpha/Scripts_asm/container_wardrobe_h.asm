...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:
...
0x11: Stack[-4] = "rifle_ammo" // @poff=30
0x12: Stack[-3] = (int) 1
0x13: Stack[-2] = (int) 20
0x14: Stack[-1] = (int) 3
0x15: Call 0x8b
...
0x18: Stack[-4] = "revolver_ammo" // @poff=52
0x19: Stack[-3] = (int) 1
0x1a: Stack[-2] = (int) 20
0x1b: Stack[-1] = (int) 6
0x1c: Call 0x8b
...
0x26: Stack[-3] = "halfboot_repel" // @poff=80
0x27: Stack[-2] = (int) 1
0x28: Stack[-1] = (int) 15
0x29: Call 0x80
...
0x2c: Stack[-3] = "boot_repel" // @poff=88
0x2d: Stack[-2] = (int) 1
0x2e: Stack[-1] = (int) 20
0x2f: Call 0x80
...
0x38: Stack[-3] = "cloak_repel" // @poff=126
0x39: Stack[-2] = (int) 1
0x3a: Stack[-1] = (int) 15
0x3b: Call 0x80
...
0x3e: Stack[-3] = "raincoat_repel" // @poff=150
0x3f: Stack[-2] = (int) 1
0x40: Stack[-1] = (int) 35
0x41: Call 0x80
...
0x44: Stack[-3] = "glove_disp" // @poff=180
0x45: Stack[-2] = (int) 1
0x46: Stack[-1] = (int) 20
0x47: Call 0x80
...
0x53: Stack[-3] = "boot_army" // @poff=214
0x54: Stack[-2] = (int) 1
0x55: Stack[-1] = (int) 40
0x56: Call 0x80
...
0x59: Stack[-3] = "glove_army" // @poff=234
0x5a: Stack[-2] = (int) 1
0x5b: Stack[-1] = (int) 50
0x5c: Call 0x80
...
0x73: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=272
0x74: Pop(0)
0x75: Push(Stack[-2])
...
0x8d: Stack[-10] = Stack[-2]
0x8e: Stack[-9] = Stack[-1]
0x8f: Call 0x9a
...
0xa0: Push("nouse_container") // @poff=283
