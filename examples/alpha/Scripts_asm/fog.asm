...
Strings:
	...
	W:GetCurrentRegion
	A:GetCurrentRegion
// @pool_raw:
...
0x2c: Stack[-1] = (float) 0.20000000298023224
0x2d: Call 0x1e9
...
0x111: Stack[-17] = Stack[-7]
0x112: PushEmpty(bool, object)
0x113: Stack[-23] = Stack[-1]
0x114: Call 0x107
...
0x11a: @@ GetPosition(Stack[-5]); Obj=21 // @poff=42
0x11b: Pop(0)
...
0x131: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=14
0x132: Pop(0)
...
0x143: Push((int) 0)
0x144: Push((float)0.30000001192092896)
...
0x166: Push((int) 0)
0x167: Push((float)0.30000001192092896)
...
0x19a: Stack[-1] = "walk" // @poff=54
0x19b: Return(); Pop(0)

0x19c: Stack[-1] = "run" // @poff=64
0x19d: Return(); Pop(0)
...
0x1bc: @@ GetPosition(Stack[-1]); Obj=3 // @poff=42
0x1bd: Pop(0)
0x1be: Stack[-1] = Stack[-4]
0x1bf: Return(); Pop(2)

0x1c0: PushEmpty(object, object)
0x1c1: Push("player") // @poff=72
...
0x1c8: Push("HasProperty") // @poff=86
0x1c9: Push((int) 2)
...
0x1cf: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=110
0x1d0: Pop(0)
0x1d1: Stack[-1] = Stack[-5]
0x1d2: Return(); Pop(2)

0x1d3: PushEmpty(float, float)
0x1d4: PushEmpty(bool, object, string)
0x1d5: Stack[-10] = Stack[-2]
0x1d6: Stack[-9] = Stack[-1]
0x1d7: Call 0x1c7
...
0x1dd: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=122
0x1de: Pop(0)
0x1df: PushEmpty(float, float, float, float)
0x1e0: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x1e1: Stack[-8] = Stack[-2]
0x1e2: Stack[-7] = Stack[-1]
0x1e3: Call 0x273

0x1e4: Pop(3)
0x1e5: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=134
0x1e6: Pop(1)
...
0x1eb: Stack[-11] = Stack[-2]
0x1ec: Stack[-1] = "disease" // @poff=146
0x1ed: Call 0x1c7
...
0x1f4: Stack[-11] = Stack[-2]
0x1f5: Stack[-1] = "armor_disease" // @poff=162
0x1f6: Call 0x1c7

0x1f7: Pop(2)
0x1f8: IF (Stack[-1] == 0) GOTO 0x207; Pop(1)

0x1f9: Push("armor_disease") // @poff=162
0x1fa: @@ GetProperty(Stack[-1], Stack[-4]); Obj=9 // @poff=122
0x1fb: Pop(1)
0x1fc: Push((int) 100)
...
0x209: Stack[-1] = "immunity" // @poff=190
0x20a: Call 0x1c7

0x20b: Pop(2)
0x20c: IF (Stack[-1] == 0) GOTO 0x21e; Pop(1)

0x20d: Push("immunity") // @poff=190
0x20e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=9 // @poff=122
0x20f: Pop(1)
0x210: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x211: IF (Stack[-1] == 0) GOTO 0x218; Pop(1)

0x212: Push("immunity") // @poff=190
0x213: Push((int) 0)
0x214: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=134
0x215: Pop(2)
0x216: Stack[-2] = Stack[-7] - Stack[-1]; Pop(0);
0x217: GOTO 0x21e

0x218: Push("immunity") // @poff=190
0x219: Pop(0); Push(Stack[-2] - Stack[-8]);
0x21a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=10 // @poff=134
0x21b: Pop(2)
0x21c: Stack[-7] = Stack[-9]
0x21d: Return(); Pop(6)

0x21e: PushEmpty(bool, object, string, float, float, float)
0x21f: Stack[-14] = Stack[-5]
0x220: Stack[-4] = "disease" // @poff=146
0x221: Stack[-8] = Stack[-3]
0x222: Stack[-2] = (int) 0
0x223: Stack[-1] = (int) 1
0x224: Call 0x1d3

0x225: Pop(6)
0x226: Stack[-7] = Stack[-9]
0x227: Return(); Pop(6)

0x228: PushEmpty(bool, bool)
0x229: @@ IsDead(Stack[-1]); Obj=3 // @poff=208
0x22a: Pop(0)
0x22b: Stack[-1] = Stack[-4]
0x22c: Return(); Pop(2)
...
0x242: Pop(0)
0x243: Pop(0); PushNull((bool) Stack[-2] == 0)
0x244: IF (Stack[-1] == 0) GOTO 0x247; Pop(1)

0x245: Stack[-6] = (bool) 0
0x246: Return(); Pop(4)

0x247: @@ GetScene(Stack[-1]); Obj=5 // @poff=229
0x248: Pop(0)
...
0x25c: Stack[-1] = "noaccess" // @poff=238
0x25d: Call 0x1c7
...
0x263: Push("noaccess") // @poff=238
0x264: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=122
0x265: Pop(1)
0x266: Push((int) 0)
...
0x2a9: Push("GetCurrentRegion") // @poff=256
0x2aa: Push((int) 1)
...
0x2af: @@ GetCurrentRegion(Stack[-1]); Obj=2 // @poff=290
0x2b0: Pop(0)
