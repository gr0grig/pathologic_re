...
Strings:
	...
	W:noaccess
	A:GetProperty
// @pool_raw:
...
0x1b: Stack[-17] = Stack[-7]
0x1c: PushEmpty(bool, object)
0x1d: Stack[-23] = Stack[-1]
0x1e: Call 0xa4
...
0x24: @@ GetPosition(Stack[-5]); Obj=21 // @poff=14
0x25: Pop(0)
...
0x3b: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=26
0x3c: Pop(0)
...
0x4d: Push((int) 0)
0x4e: Push((float)0.30000001192092896)
...
0x70: Push((int) 0)
0x71: Push((float)0.30000001192092896)
...
0xa6: Stack[-3] = Stack[-1]
0xa7: Call 0xe4

0xa8: Stack[-2] = Stack[-4]
0xa9: Pop(2)
0xaa: Return(); Pop(0)

0xab: Stack[-1] = "walk" // @poff=40
0xac: Return(); Pop(0)

0xad: Stack[-1] = "run" // @poff=50
0xae: Return(); Pop(0)

0xaf: PushEmpty(bool, bool)
0xb0: Push("HasProperty") // @poff=58
0xb1: Push((int) 2)
...
0xb7: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=82
0xb8: Pop(0)
0xb9: Stack[-1] = Stack[-5]
0xba: Return(); Pop(2)

0xbb: PushEmpty(bool, bool)
0xbc: @@ IsDead(Stack[-1]); Obj=3 // @poff=94
0xbd: Pop(0)
...
0xda: @@ GetScene(Stack[-1]); Obj=5 // @poff=115
0xdb: Pop(0)
...
0xef: Stack[-1] = "noaccess" // @poff=124
0xf0: Call 0xaf
...
0xf6: Push("noaccess") // @poff=124
0xf7: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=142
0xf8: Pop(1)
0xf9: Push((int) 0)
