...
Strings:
	...
	A:GetProperty
	A:SetProperty
// @pool_raw:680075006e0067006500720000006400720069006e006b000000480061007300500072006f0070006500720074007900000048617350726f70657274790047657450726f70657274790053657450726f706572747900
...
0x1d: Stack[-3] = (float) -0.05000000074505806
0x1e: Stack[-2] = (int) 0
0x1f: Stack[-1] = (int) 1
0x20: Call 0x36

0x21: Pop(6)
0x22: Push("drink") // @poff=14
...
0x32: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=50
0x33: Pop(0)
...
0x38: Stack[-10] = Stack[-2]
0x39: Stack[-9] = Stack[-1]
0x3a: Call 0x2a
...
0x40: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=62
0x41: Pop(0)
0x42: PushEmpty(float, float, float, float)
0x43: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x44: Stack[-8] = Stack[-2]
0x45: Stack[-7] = Stack[-1]
0x46: Call 0x4c

0x47: Pop(3)
0x48: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=74
0x49: Pop(1)
0x4a: Stack[-8] = (bool) 1
0x4b: Return(); Pop(2)
