...
Strings:
	...
	W:grabitel
	A:add
// @pool_raw:
...
0x21: Pop(0); PushNull((bool) Stack[-21] == 0)
0x22: IF (Stack[-1] == 0) GOTO 0x28; Pop(1)

0x23: PushEmpty(string)
0x24: Stack[-1] = "fdie" // @poff=0
0x25: Call 0x77

0x26: Pop(1)
0x27: GOTO 0x76

0x28: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x29: Pop(0)
...
0x39: Stack[-6] = "fdie" // @poff=0
0x3a: GOTO 0x3c

0x3b: Stack[-6] = "bdie" // @poff=22
...
0x6b: @ StopAsync()
0x6c: Pop(0)
0x6d: Push("head") // @poff=160
0x6e: @ UnlookAsync(Stack[-1])
0x6f: Pop(1)
0x70: Push("all") // @poff=170
...
0x81: Pop(0)
0x82: Push("all") // @poff=170
0x83: @ PlayAnimation(Stack[-1], Stack[-2])
0x84: Pop(1)
0x85: @ WaitForAnimEnd()
0x86: Pop(0)
0x87: Push("all") // @poff=170
...
0x97: Push((int) 130)
0x98: Push((float)0.30000001192092896)
...
0xba: Pop(0)
0xbb: Push((float)0.20000000298023224)
...
0xd2: Push((int) 130)
0xd3: Push((float)0.30000001192092896)
...
0x236: Stack[-17] = Stack[-1]
0x237: Call 0x732

0x238: Pop(2)
0x239: PushEmpty(bool, object)
0x23a: Stack[-17] = Stack[-1]
0x23b: Call 0x6f8
...
0x253: Push("all") // @poff=170
0x254: Push("aattack_end1") // @poff=208
0x255: @ PlayAnimation(Stack[-2], Stack[-1])
0x256: Pop(2)
0x257: @ GetScene(Stack[-7])
0x258: Pop(0)
0x259: Push("knife") // @poff=234
0x25a: @ GetGeometryLocator(Stack[-1], Stack[-6], Stack[-7])
0x25b: Pop(1)
0x25c: Push("scripted") // @poff=246
0x25d: Push(CVector(0.0, 0.0, 1.0))
0x25e: Push("grabitel_knife.xml") // @poff=264
0x25f: @ AddActorByType(Stack[-7], Stack[-3], Stack[-10], Stack[-9], Stack[-2], Stack[-1])
0x260: Pop(3)
0x261: Push("Owner") // @poff=68
0x262: PushEmpty(object)
0x263: Call 0x791

0x264: Pop(0)
0x265: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=302
0x266: Pop(2)
0x267: @@ GetPosition(Stack[-3]); Obj=15 // @poff=10
0x268: Pop(0)
0x269: @@ GetEyesHeight(Stack[-2]); Obj=15 // @poff=146
0x26a: Pop(0)
...
0x271: Stack[-10] = Stack[-3]
0x272: Stack[-7] = Stack[-2]
0x273: Stack[-1] = (float) 2000.0
0x274: Call 0x833

0x275: Stack[-4] = Stack[-5]
0x276: Pop(4)
0x277: Push("StartDirection") // @poff=320
0x278: @@ SetScriptProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=302
0x279: Pop(1)
...
0x2b9: Push("all") // @poff=170
0x2ba: Push("attack_off") // @poff=360
...
0x2c3: PushEmpty()
0x2c4: Stack[-3] = (float) 0.10000000149011612
0x2c5: Return(); Pop(0)
...
0x2f4: Push("all") // @poff=170
0x2f5: Push("attack_begin") // @poff=382
0x2f6: Push((int) 1)
0x2f7: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x302: Push("attack") // @poff=408
0x303: Push((int) 1)
0x304: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x31f: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x320: Pop(0)
0x321: Push(Stack[-22])
...
0x331: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=478
0x332: Pop(0)
...
0x355: Pop(1)
0x356: Push("all") // @poff=170
0x357: Push("attack_on") // @poff=492
...
0x363: Push((float)0.19999998807907104)
...
0x36d: Pop(0)
0x36e: Push("all") // @poff=170
0x36f: Push("attack_stay") // @poff=512
0x370: @ PlayAnimation(Stack[-2], Stack[-1])
0x371: Pop(2)
0x372: PushEmpty(bool, float)
0x373: Stack[-23] = Stack[-1]
0x374: Call 0x450
...
0x379: @ Face(Stack[-0]T)
0x37a: Pop(0)
0x37b: Push("all") // @poff=170
0x37c: Push("fjump") // @poff=536
...
0x394: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=478
0x395: Pop(0)
...
0x3b4: Push("attack_off") // @poff=360
...
0x3c0: Push((float)0.8999999761581421)
0x3c1: Pop(1); Push(Stack[-9] * Stack[-1]);
0x3c2: @ GetVictim(Stack[-1], Stack[-4])
0x3c3: Pop(1)
0x3c4: @ ReportAttack(Stack[-0]T)
0x3c5: Pop(0)
...
0x3c9: Stack[-6] = Stack[-2]
0x3ca: Stack[-10] = Stack[-1]
0x3cb: Call 0x2c3

0x3cc: Stack[-3] = Stack[-5]
0x3cd: Pop(3)
0x3ce: PushEmpty(float, object, float, int)
0x3cf: Stack[-7] = Stack[-3]
0x3d0: Stack[-6] = Stack[-2]
0x3d1: PushEmpty(int, object, int)
0x3d2: Stack[-10] = Stack[-2]
0x3d3: Stack[-14] = Stack[-1]
0x3d4: Call 0x2c6

0x3d5: Stack[-3] = Stack[-4]
0x3d6: Pop(3)
0x3d7: Call 0x67f
...
0x3dc: Pop(0)
0x3dd: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x3de: Pop(1)
0x3df: PushEmpty(object, float)
0x3e0: Stack[-5] = Stack[-2]
0x3e1: Stack[-3] = Stack[-1]
0x3e2: Call 0x2c9
...
0x3e7: @ irand(Stack[-2], Stack[-1]T)
0x3e8: Pop(0)
0x3e9: Push((int) 1)
0x3ea: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x3eb: @ Face(Stack[-0]T)
0x3ec: Pop(0)
0x3ed: Push((bool) 1)
0x3ee: @ SetAttackState(Stack[-1])
0x3ef: Pop(1)
0x3f0: Push("all") // @poff=170
0x3f1: Push("attack_begin") // @poff=382
...
0x405: Stack[-7] = Stack[-2]
0x406: Stack[-4] = Stack[-1]
0x407: Call 0x3bf

0x408: Pop(2)
0x409: Push("all") // @poff=170
0x40a: Push("attack_middle") // @poff=548
...
0x410: Push("all") // @poff=170
0x411: Push("attack_middle") // @poff=548
...
0x42a: Push("attack_end") // @poff=576
...
0x464: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=478
0x465: Pop(0)
...
0x49a: @ Face(Stack[-0]T)
0x49b: Pop(0)
0x49c: Push("all") // @poff=170
0x49d: Push("bjump") // @poff=598
0x49e: @ PlayAnimation(Stack[-2], Stack[-1])
0x49f: Pop(2)
0x4a0: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=478
0x4a1: Pop(0)
...
0x4ca: @ irand(Stack[-1], Stack[-2]T)
0x4cb: Pop(0)
0x4cc: Push((int) 1)
0x4cd: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x4ce: Push("attack") // @poff=408
...
0x4f8: Stack[-17] = Stack[-7]
0x4f9: PushEmpty(bool, object)
0x4fa: Stack[-23] = Stack[-1]
0x4fb: Call 0x581
...
0x501: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x502: Pop(0)
...
0x518: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=478
0x519: Pop(0)
...
0x52a: Push((int) 0)
0x52b: Push((float)0.30000001192092896)
...
0x54d: Push((int) 0)
0x54e: Push((float)0.30000001192092896)
...
0x585: Stack[-2] = Stack[-4]
0x586: Pop(2)
0x587: Return(); Pop(0)

0x588: Stack[-1] = "walk" // @poff=646
0x589: Return(); Pop(0)

0x58a: Stack[-1] = "run" // @poff=656
0x58b: Return(); Pop(0)
...
0x5aa: Push("all") // @poff=170
0x5ab: Push("hunt") // @poff=664
...
0x5df: Stack[-17] = Stack[-7]
0x5e0: PushEmpty(bool, object)
0x5e1: Stack[-23] = Stack[-1]
0x5e2: Call 0x5b6
...
0x5e8: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x5e9: Pop(0)
...
0x5ff: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=478
0x600: Pop(0)
...
0x611: Push((int) 0)
0x612: Push((float)0.30000001192092896)
...
0x634: Push((int) 0)
0x635: Push((float)0.30000001192092896)
...
0x65f: Stack[-1] = "walk" // @poff=646
0x660: Return(); Pop(0)

0x661: Stack[-1] = "run" // @poff=656
0x662: Return(); Pop(0)
...
0x667: Stack[-2] = "fire" // @poff=674
0x668: Return(); Pop(0)

0x669: Stack[-2] = "phys" // @poff=684
0x66a: Return(); Pop(0)

0x66b: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x66c: @ GetPosition(Stack[-3])
0x66d: Pop(0)
0x66e: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x66f: Pop(0)
...
0x674: Push("HasProperty") // @poff=694
0x675: Push((int) 2)
...
0x67b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=718
0x67c: Pop(0)
0x67d: Stack[-1] = Stack[-5]
0x67e: Return(); Pop(2)

0x67f: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x680: PushEmpty(bool, object, string)
0x681: Stack[-18] = Stack[-2]
0x682: Stack[-1] = "health" // @poff=730
0x683: Call 0x673
...
0x68a: Stack[-18] = Stack[-2]
0x68b: Stack[-1] = "armor" // @poff=744
0x68c: Call 0x673
...
0x692: Push("armor") // @poff=744
0x693: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=756
0x694: Pop(1)
0x695: Push("armor_") // @poff=768
0x696: PushEmpty(string, int)
0x697: Stack[-16] = Stack[-1]
0x698: Call 0x663

0x699: Pop(1)
0x69a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x69b: PushEmpty(bool, object, string)
0x69c: Stack[-18] = Stack[-2]
0x69d: Stack[-8] = Stack[-1]
0x69e: Call 0x673
...
0x6a4: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=756
0x6a5: Pop(0)
...
0x6ac: Stack[-3] = Stack[-6]
0x6ad: Pop(3)
0x6ae: Push("health") // @poff=730
0x6af: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=756
0x6b0: Pop(1)
0x6b1: Push((int) 1)
0x6b2: Pop(1); Push(Stack[-1] - Stack[-4]);
0x6b3: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x6b4: Push("health") // @poff=730
...
0x6ba: Pop(3)
0x6bb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=782
0x6bc: Pop(2)
0x6bd: Stack[-1] = Stack[-16]
0x6be: Return(); Pop(12)

0x6bf: PushEmpty(float, float)
0x6c0: PushEmpty(bool, object, string)
0x6c1: Stack[-6] = Stack[-2]
0x6c2: Stack[-1] = "health" // @poff=730
0x6c3: Call 0x673
...
0x6c9: Push("health") // @poff=730
0x6ca: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=756
0x6cb: Pop(1)
...
0x6d0: @@ IsDead(Stack[-1]); Obj=3 // @poff=794
0x6d1: Pop(0)
0x6d2: Stack[-1] = Stack[-4]
0x6d3: Return(); Pop(2)

0x6d4: PushEmpty(object, object, object, object)
0x6d5: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6e9: Pop(0)
0x6ea: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6eb: IF (Stack[-1] == 0) GOTO 0x6ee; Pop(1)

0x6ec: Stack[-6] = (bool) 0
0x6ed: Return(); Pop(4)

0x6ee: @@ GetScene(Stack[-1]); Obj=5 // @poff=815
0x6ef: Pop(0)
...
0x703: Stack[-1] = "noaccess" // @poff=824
0x704: Call 0x673
...
0x70a: Push("noaccess") // @poff=824
0x70b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=756
0x70c: Pop(1)
0x70d: Push((int) 0)
...
0x711: Pop(0); PushNull((bool) Stack[-7] == 0)
...
0x716: Pop(0)
0x717: Pop(0); PushNull((bool) Stack[-3] == 0)
0x718: IF (Stack[-1] == 0) GOTO 0x71b; Pop(1)

0x719: Stack[-8] = (bool) 0
0x71a: Return(); Pop(6)

0x71b: @@ GetScene(Stack[-2]); Obj=7 // @poff=815
0x71c: Pop(0)
...
0x722: Stack[-10] = Stack[-2]
0x723: Stack[-1] = "noaccess" // @poff=824
0x724: Call 0x673
...
0x72a: Push("noaccess") // @poff=824
0x72b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=756
0x72c: Pop(1)
0x72d: Push((int) 0)
...
0x733: @@ GetPosition(Stack[-4]); Obj=9 // @poff=10
0x734: Pop(0)
...
0x764: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x765: Pop(0)
...
0x775: Stack[-1] = "fhit" // @poff=862
0x776: GOTO 0x778

0x777: Stack[-1] = "bhit" // @poff=872
0x778: Push("hit_react") // @poff=882
0x779: Push("1") // @poff=204
0x77a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x77b: Push("2") // @poff=902
...
0x782: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x783: Pop(0)
...
0x7d6: Stack[-2] = (int) 0
0x7d7: Push("all") // @poff=170
0x7d8: PushEmpty(string, int)
0x7d9: Stack[-5] = Stack[-1]
0x7da: Call 0x7ce
...
0x7e9: Push("GenerateMoney: iMin > iMax") // @poff=916
0x7ea: @ Trace(Stack[-1])
0x7eb: Pop(1)
0x7ec: Return(); Pop(8)
...
0x814: Stack[-1] = "bottle_weapon" // @poff=982
0x815: Call 0x82e
...
0x827: Stack[-1] = "ognemet_ammo" // @poff=1010
0x828: Call 0x82e
...
0x85a: @@ in(Stack[-3], Stack[-6]); Obj=1 // @poff=1036
0x85b: Pop(1)
0x85c: Push(Stack[-2])
...
0x861: Stack[-8] = Stack[-2]
0x862: Stack[-1] = "class" // @poff=1039
0x863: Call 0x673

0x864: Pop(2)
0x865: IF (Stack[-1] == 0) GOTO 0x86e; Pop(1)

0x866: Push("class") // @poff=1039
0x867: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=756
0x868: Pop(1)
0x869: Push("grabitel") // @poff=1051
...
0x8cb: Stack[-10] = Stack[-2]
0x8cc: Stack[-1] = "class" // @poff=1039
0x8cd: Call 0x673
...
0x8d3: Push("class") // @poff=1039
0x8d4: @@ GetProperty(Stack[-1], Stack[-4]); Obj=8 // @poff=756
0x8d5: Pop(1)
0x8d6: Push("grabitel") // @poff=1051
...
0x8de: Stack[-10] = Stack[-1]
0x8df: Call 0x66b

0x8e0: Stack[-2] = Stack[-3]
0x8e1: Pop(2)
...
0x8e9: Push(Stack[-4])
0x8ea: IF (Stack[-1] == 1) GOTO 0x8ef; Pop(1)
...
0x900: Stack[-7] = Stack[-3]
0x901: Stack[-6] = Stack[-2]
