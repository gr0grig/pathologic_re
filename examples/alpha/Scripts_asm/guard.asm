...
Strings:
	...
	W:class
	W:guard
// @pool_raw:
...
0x199: PushEmpty()
0x19a: Stack[-3] = (float) 0.05000000074505806
0x19b: Return(); Pop(0)
...
0x52c: Stack[-3] = Stack[-4]
0x52d: Return(); Pop(0)

0x52e: PushEmpty()
0x52f: PushEmpty(object)
0x530: Stack[-2] = Stack[-1]
...
0x54b: Stack[-7] = Stack[-3]
0x54c: Stack[-6] = Stack[-2]
...
0x594: Stack[-3] = Stack[-1]
0x595: Call 0x580

0x596: Stack[-2] = Stack[-4]
0x597: Pop(2)
0x598: Return(); Pop(0)
...
0x5c5: Stack[-8] = Stack[-2]
0x5c6: Stack[-1] = "class" // @poff=746
0x5c7: Call 0x438
...
0x5cd: Push("class") // @poff=746
0x5ce: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=564
0x5cf: Pop(1)
0x5d0: Push("guard") // @poff=758
...
0x5d9: Push(Stack[-2])
0x5da: IF (Stack[-1] == 1) GOTO 0x5e3; Pop(1)

0x5db: PushEmpty(float, object)
0x5dc: Stack[-9] = Stack[-1]
0x5dd: Call 0x430
