...
Strings:
	...
	W:ui/NPC_None.png
	W:class
// @pool_raw:
...
0x682: Stack[-1] = "Neutral" // @poff=553
0x683: Call 0x6b5

0x684: Pop(1)
0x685: Push((int) 14684)
0x686: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x687: Pop(1)
0x688: @@@ ClearReplies(); Obj=0 // @poff=580
0x689: Pop(0)
...
0x6a6: Push("all") // @poff=0
0x6a7: Push("idle") // @poff=8
...
0x6af: Push("all") // @poff=0
0x6b0: Push("idle") // @poff=8
...
0x6d7: Stack[-1] = "Neutral" // @poff=553
0x6d8: Call 0x6b5

0x6d9: Pop(1)
0x6da: Push((int) 13402)
0x6db: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6dc: Pop(1)
0x6dd: @@@ ClearReplies(); Obj=0 // @poff=580
0x6de: Pop(0)
0x6df: Push((int) 13403)
0x6e0: Push((int) -1)
0x6e1: Push((int) 14637)
0x6e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6e3: Pop(3)
0x6e4: Push((int) 13404)
0x6e5: Push((int) -1)
0x6e6: Push((int) 14638)
0x6e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6e8: Pop(3)
0x6e9: Return(); Pop(0)

0x6ea: PushEmpty(string)
0x6eb: Stack[-1] = "Neutral" // @poff=553
0x6ec: Call 0x6b5

0x6ed: Pop(1)
0x6ee: Push((int) 14671)
0x6ef: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x6f0: Pop(1)
0x6f1: @@@ ClearReplies(); Obj=0 // @poff=580
0x6f2: Pop(0)
0x6f3: Push((int) 14672)
0x6f4: Push((int) 15911)
0x6f5: Push((int) 15910)
0x6f6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6f7: Pop(3)
0x6f8: Push((int) 14681)
0x6f9: Push((int) 15921)
0x6fa: Push((int) 15920)
0x6fb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x6fc: Pop(3)
0x6fd: Return(); Pop(0)

0x6fe: PushEmpty(string)
0x6ff: Stack[-1] = "Neutral" // @poff=553
0x700: Call 0x6b5

0x701: Pop(1)
0x702: Push((int) 14684)
0x703: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x704: Pop(1)
0x705: @@@ ClearReplies(); Obj=0 // @poff=580
0x706: Pop(0)
...
0x70f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x710: Pop(3)
0x711: Return(); Pop(0)
...
0x716: Stack[-1] = "Neutral" // @poff=553
0x717: Call 0x6b5

0x718: Pop(1)
0x719: Push((int) 14697)
0x71a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x71b: Pop(1)
0x71c: @@@ ClearReplies(); Obj=0 // @poff=580
0x71d: Pop(0)
0x71e: Push((int) 14698)
0x71f: Push((int) -1)
0x720: Push((int) 15938)
0x721: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x722: Pop(3)
0x723: Return(); Pop(0)
...
0x728: Stack[-1] = "Neutral" // @poff=553
0x729: Call 0x6b5

0x72a: Pop(1)
0x72b: Push((int) 14686)
0x72c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x72d: Pop(1)
0x72e: @@@ ClearReplies(); Obj=0 // @poff=580
0x72f: Pop(0)
0x730: Push((int) 14687)
0x731: Push((int) 15928)
0x732: Push((int) 15927)
0x733: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x734: Pop(3)
0x735: Push((int) 14695)
0x736: Push((int) -1)
0x737: Push((int) 15935)
0x738: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x739: Pop(3)
0x73a: Return(); Pop(0)
...
0x73f: Stack[-1] = "Neutral" // @poff=553
0x740: Call 0x6b5

0x741: Pop(1)
0x742: Push((int) 14688)
0x743: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x744: Pop(1)
0x745: @@@ ClearReplies(); Obj=0 // @poff=580
0x746: Pop(0)
0x747: Push((int) 14689)
0x748: Push((int) 15930)
0x749: Push((int) 15929)
0x74a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x74b: Pop(3)
0x74c: Push((int) 14694)
0x74d: Push((int) -1)
0x74e: Push((int) 15934)
0x74f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x750: Pop(3)
0x751: Return(); Pop(0)
...
0x756: Stack[-1] = "Neutral" // @poff=553
0x757: Call 0x6b5

0x758: Pop(1)
0x759: Push((int) 14690)
0x75a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x75b: Pop(1)
0x75c: @@@ ClearReplies(); Obj=0 // @poff=580
0x75d: Pop(0)
0x75e: Push((int) 14691)
0x75f: Push((int) -1)
0x760: Push((int) 15931)
0x761: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x762: Pop(3)
0x763: Push((int) 14692)
0x764: Push((int) -1)
0x765: Push((int) 15932)
0x766: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x767: Pop(3)
0x768: Push((int) 14693)
0x769: Push((int) -1)
0x76a: Push((int) 15933)
0x76b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x76c: Pop(3)
0x76d: Return(); Pop(0)
...
0x772: Stack[-1] = "Neutral" // @poff=553
0x773: Call 0x6b5

0x774: Pop(1)
0x775: Push((int) 14682)
0x776: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x777: Pop(1)
0x778: @@@ ClearReplies(); Obj=0 // @poff=580
0x779: Pop(0)
0x77a: Push((int) 14683)
0x77b: Push((int) 15913)
0x77c: Push((int) 15922)
0x77d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x77e: Pop(3)
0x77f: Return(); Pop(0)
...
0x784: Stack[-1] = "Neutral" // @poff=553
0x785: Call 0x6b5

0x786: Pop(1)
0x787: Push((int) 14673)
0x788: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x789: Pop(1)
0x78a: @@@ ClearReplies(); Obj=0 // @poff=580
0x78b: Pop(0)
0x78c: Push((int) 14674)
0x78d: Push((int) 15913)
0x78e: Push((int) 15912)
0x78f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x790: Pop(3)
0x791: Push((int) 14678)
0x792: Push((int) 15917)
0x793: Push((int) 15916)
0x794: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x795: Pop(3)
0x796: Return(); Pop(0)
...
0x79b: Stack[-1] = "Neutral" // @poff=553
0x79c: Call 0x6b5

0x79d: Pop(1)
0x79e: Push((int) 14679)
0x79f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7a0: Pop(1)
0x7a1: @@@ ClearReplies(); Obj=0 // @poff=580
0x7a2: Pop(0)
0x7a3: Push((int) 14680)
0x7a4: Push((int) 15913)
0x7a5: Push((int) 15918)
0x7a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7a7: Pop(3)
0x7a8: Return(); Pop(0)
...
0x7ad: Stack[-1] = "Neutral" // @poff=553
0x7ae: Call 0x6b5

0x7af: Pop(1)
0x7b0: Push((int) 14675)
0x7b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=569
0x7b2: Pop(1)
0x7b3: @@@ ClearReplies(); Obj=0 // @poff=580
0x7b4: Pop(0)
0x7b5: Push((int) 14676)
0x7b6: Push((int) -1)
0x7b7: Push((int) 15914)
0x7b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7b9: Pop(3)
0x7ba: Push((int) 14677)
0x7bb: Push((int) -1)
0x7bc: Push((int) 15915)
0x7bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=593
0x7be: Pop(3)
0x7bf: Return(); Pop(0)
...
0x7d1: Stack[-2] = "fire" // @poff=602
0x7d2: Return(); Pop(0)

0x7d3: Stack[-2] = "phys" // @poff=612
0x7d4: Return(); Pop(0)

0x7d5: PushEmpty(cvector, cvector, cvector, cvector)
0x7d6: @ GetPosition(Stack[-2])
0x7d7: Pop(0)
0x7d8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x7d9: Pop(0)
...
0x7de: Pop(0)
0x7df: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x7e0: Pop(0)
...
0x7e5: Push("HasProperty") // @poff=622
0x7e6: Push((int) 2)
...
0x7ec: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=646
0x7ed: Pop(0)
0x7ee: Stack[-1] = Stack[-5]
0x7ef: Return(); Pop(2)

0x7f0: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x7f1: PushEmpty(bool, object, string)
0x7f2: Stack[-18] = Stack[-2]
0x7f3: Stack[-1] = "health" // @poff=658
0x7f4: Call 0x7e4
...
0x7fb: Stack[-18] = Stack[-2]
0x7fc: Stack[-1] = "armor" // @poff=672
0x7fd: Call 0x7e4
...
0x803: Push("armor") // @poff=672
0x804: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=684
0x805: Pop(1)
0x806: Push("armor_") // @poff=696
0x807: PushEmpty(string, int)
0x808: Stack[-16] = Stack[-1]
0x809: Call 0x7cd

0x80a: Pop(1)
0x80b: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x80c: PushEmpty(bool, object, string)
0x80d: Stack[-18] = Stack[-2]
0x80e: Stack[-8] = Stack[-1]
0x80f: Call 0x7e4
...
0x815: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=684
0x816: Pop(0)
...
0x81d: Stack[-3] = Stack[-6]
0x81e: Pop(3)
0x81f: Push("health") // @poff=658
0x820: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=684
0x821: Pop(1)
0x822: Push((int) 1)
0x823: Pop(1); Push(Stack[-1] - Stack[-4]);
0x824: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x825: Push("health") // @poff=658
...
0x82b: Pop(3)
0x82c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=710
0x82d: Pop(2)
0x82e: Stack[-1] = Stack[-16]
0x82f: Return(); Pop(12)

0x830: PushEmpty(bool, bool)
0x831: @@ IsDead(Stack[-1]); Obj=3 // @poff=722
0x832: Pop(0)
0x833: Stack[-1] = Stack[-4]
0x834: Return(); Pop(2)

0x835: PushEmpty(object, object, object, object)
0x836: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x84a: Pop(0)
0x84b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x84c: IF (Stack[-1] == 0) GOTO 0x84f; Pop(1)

0x84d: Stack[-6] = (bool) 0
0x84e: Return(); Pop(4)

0x84f: @@ GetScene(Stack[-1]); Obj=5 // @poff=743
0x850: Pop(0)
...
0x863: Stack[-6] = Stack[-2]
0x864: Stack[-1] = "noaccess" // @poff=752
0x865: Call 0x7e4
...
0x86b: Push("noaccess") // @poff=752
0x86c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=684
0x86d: Pop(1)
0x86e: Push((int) 0)
...
0x897: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x898: Pop(0)
...
0x8a8: Stack[-1] = "fhit" // @poff=808
0x8a9: GOTO 0x8ab

0x8aa: Stack[-1] = "bhit" // @poff=818
0x8ab: Push("hit_react") // @poff=828
0x8ac: Push("1") // @poff=848
0x8ad: Pop(1); Push(Stack[-3] + Stack[-1]);
0x8ae: Push("2") // @poff=852
...
0x8b5: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x8b6: Pop(0)
...
0x8c5: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x8c6: Pop(0)
0x8c7: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x8c8: Pop(0)
...
0x901: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x902: Pop(0)
0x903: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x904: Pop(0)
...
0x93c: Pop(0)
0x93d: Push("start: ") // @poff=874
0x93e: Pop(1); Push(Stack[-1] + Stack[-3]);
0x93f: @ Trace(Stack[-1])
0x940: Pop(1)
0x941: Push("end: ") // @poff=890
...
0x95b: Push((float)9.999999974752427e-07)
...
0x9be: Stack[-7] = Stack[-3]
0x9bf: Stack[-6] = Stack[-2]
...
0xa01: Stack[-3] = Stack[-1]
0xa02: Call 0x9ed

0xa03: Stack[-2] = Stack[-4]
0xa04: Pop(2)
0xa05: Return(); Pop(0)

0xa06: PushEmpty()
0xa07: PushEmpty(object)
0xa08: Stack[-2] = Stack[-1]
0xa09: Call 0x9f7
...
0xa16: PushEmpty(bool, bool)
0xa17: @ CanSee(Stack[-1], Stack[-3])
0xa18: Pop(0)
0xa19: Push(Stack[-1])
0xa1a: IF (Stack[-1] == 0) GOTO 0xa21; Pop(1)

0xa1b: PushEmpty(int, object)
0xa1c: Stack[-5] = Stack[-1]
0xa1d: Call 0x9ed

0xa1e: Stack[-2] = Stack[-6]
0xa1f: Pop(2)
0xa20: Return(); Pop(2)
...
0xa2e: PushEmpty()
0xa2f: Push((int) 1000)
0xa30: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=902
0xa31: Pop(1)
0xa32: Return(); Pop(0)

0xa33: PushEmpty(int, int)
0xa34: Push("player") // @poff=917
0xa35: @ GetVariable(Stack[-1], Stack[-2])
0xa36: Pop(1)
0xa37: Push((int) 0)
0xa38: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa39: IF (Stack[-1] == 0) GOTO 0xa3d; Pop(1)

0xa3a: Stack[-3] = (int) 200001
0xa3b: Return(); Pop(2)

0xa3c: GOTO 0xa42

0xa3d: Push((int) 1)
0xa3e: Pop(1); Push((bool) Stack[-2] == Stack[-1])
0xa3f: IF (Stack[-1] == 0) GOTO 0xa42; Pop(1)

0xa40: Stack[-3] = (int) 200002
0xa41: Return(); Pop(2)

0xa42: Stack[-3] = (int) 200003
0xa43: Return(); Pop(2)

0xa44: PushEmpty(int, int, int, bool, int, int, int, bool)
0xa45: Pop(0); Push((bool) Stack[-10] > Stack[-9])
0xa46: IF (Stack[-1] == 0) GOTO 0xa4b; Pop(1)

0xa47: Push("GenerateMoney: iMin > iMax") // @poff=931
0xa48: @ Trace(Stack[-1])
0xa49: Pop(1)
0xa4a: Return(); Pop(8)

0xa4b: Stack[-4] = (int) 0
0xa4c: Pop(0); Push((bool) Stack[-10] != Stack[-9])
0xa4d: IF (Stack[-1] == 0) GOTO 0xa52; Pop(1)

0xa4e: Pop(0); Push(Stack[-9] - Stack[-10]);
0xa4f: @ irand(Stack[-4], Stack[-1])
0xa50: Pop(1)
0xa51: GOTO 0xa56

0xa52: Push((int) 0)
0xa53: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0xa54: IF (Stack[-1] == 0) GOTO 0xa56; Pop(1)

0xa55: Return(); Pop(8)

0xa56: Stack[-4] = Stack[-4] + Stack[-10]; Pop(0);
0xa57: Push((int) 0)
0xa58: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0xa59: IF (Stack[-1] == 0) GOTO 0xa5b; Pop(1)

0xa5a: Return(); Pop(8)

0xa5b: Push("Money") // @poff=985
0xa5c: @ GetInvItemByName(Stack[-3], Stack[-1])
0xa5d: Pop(1)
0xa5e: Push((int) 0)
0xa5f: @ AddItem(Stack[-2], Stack[-3], Stack[-1], Stack[-5])
0xa60: Pop(1)
0xa61: Return(); Pop(8)

0xa62: PushEmpty(bool, int, bool, int)
0xa63: Push((int) 0)
0xa64: @ ClearSubContainer(Stack[-1])
0xa65: Pop(1)
0xa66: PushEmpty(int, int)
0xa67: Stack[-2] = (int) 0
0xa68: Push((int) 10)
0xa69: PushEmpty(int)
0xa6a: Call 0x998
...
0xa6b: Pop(0)
0xa6c: Push((int) 10)
0xa6d: Pop(2); Push(Stack[-2] * Stack[-1]);
...
0xa86: Stack[-1] = "watch" // @poff=1007
0xa87: Call 0xad8

0xa88: Pop(1)
0xa89: Push((int) 0)
0xa8a: Push((int) 1)
0xa8b: @ AddItem(Stack[-5], Stack[-3], Stack[-2], Stack[-1])
0xa8c: Pop(3)
0xa8d: Return(); Pop(4)

0xa8e: PushEmpty(int, bool, int, bool)
0xa8f: Push((int) 0)
0xa90: @ ClearSubContainer(Stack[-1])
0xa91: Pop(1)
0xa92: Push(Stack[-5])
0xa93: IF (Stack[-1] == 0) GOTO 0xaaf; Pop(1)

0xa94: Push((int) 3)
0xa95: @ irand(Stack[-3], Stack[-1])
0xa96: Pop(1)
0xa97: Push((int) 0)
0xa98: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0xa99: IF (Stack[-1] == 0) GOTO 0xaa1; Pop(1)

0xa9a: PushEmpty(int, string)
0xa9b: Stack[-1] = "alpha_pills" // @poff=1019
0xa9c: Call 0xad8

0xa9d: Pop(1)
0xa9e: Push((int) 0)
0xa9f: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xaa0: Pop(2)
0xaa1: Push((int) 3)
...
0xaa6: IF (Stack[-1] == 0) GOTO 0xaae; Pop(1)

0xaa7: PushEmpty(int, string)
0xaa8: Stack[-1] = "meradorm" // @poff=1043
0xaa9: Call 0xad8

0xaaa: Pop(1)
0xaab: Push((int) 0)
0xaac: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xaad: Pop(2)
0xaae: GOTO 0xad7
...
0xab6: Stack[-1] = "lockpick" // @poff=1061
0xab7: Call 0xad8

0xab8: Pop(1)
0xab9: Push((int) 0)
0xaba: Push((int) 1)
0xabb: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0xabc: Pop(3)
0xabd: Push((int) 4)
0xabe: @ irand(Stack[-3], Stack[-1])
0xabf: Pop(1)
0xac0: Push((int) 0)
0xac1: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0xac2: IF (Stack[-1] == 0) GOTO 0xaca; Pop(1)

0xac3: PushEmpty(int, string)
0xac4: Stack[-1] = "rifle_ammo" // @poff=1079
0xac5: Call 0xad8

0xac6: Pop(1)
0xac7: Push((int) 0)
0xac8: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xac9: Pop(2)
0xaca: Push((int) 4)
0xacb: @ irand(Stack[-3], Stack[-1])
0xacc: Pop(1)
0xacd: Push((int) 0)
...
0xad1: Stack[-1] = "revolver_ammo" // @poff=1101
0xad2: Call 0xad8

0xad3: Pop(1)
0xad4: Push((int) 0)
0xad5: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0xad6: Pop(2)
0xad7: Return(); Pop(4)

0xad8: PushEmpty(int, int)
0xad9: @ GetInvItemByName(Stack[-1], Stack[-3])
0xada: Pop(0)
0xadb: Stack[-1] = Stack[-4]
0xadc: Return(); Pop(2)

0xadd: Stack[-1] = (int) 3343
0xade: Return(); Pop(0)

0xadf: Stack[-1] = "ui/NPC_None.png" // @poff=1129
0xae0: Return(); Pop(0)

0xae1: Stack[-1] = (bool) 0
0xae2: Return(); Pop(0)

0xae3: Push(GlobalVars[1])
0xae4: Stack[-1] = (bool) 0
0xae5: GlobalVars[1] = Stack[-1]; Pop(1)
...
0xaec: Push(GlobalVars[1])
0xaed: IF (Stack[-1] == 0) GOTO 0xaf6; Pop(1)

0xaee: @ IsOverrideActive(Stack[-1])
0xaef: Pop(0)
0xaf0: Pop(0); Push((bool) Stack[-1] == 0)
0xaf1: IF (Stack[-1] == 0) GOTO 0xaf4; Pop(1)

0xaf2: @ WorkWithCorpse(Stack[-3])
0xaf3: Pop(0)
0xaf4: Return(); Pop(2)
...
0xaf8: Stack[-6] = Stack[-1]
0xaf9: Push(-2, 1); TaskCall(7)
0xafa: Call 0x614
...
0xb13: PushEmpty(string, bool, string, bool)
0xb14: PushEmpty(bool, object, string)
0xb15: Stack[-8] = Stack[-2]
0xb16: Stack[-1] = "class" // @poff=1161
0xb17: Call 0x7e4
...
0xb21: Push(Stack[-2])
0xb22: IF (Stack[-1] == 1) GOTO 0xb2b; Pop(1)

0xb23: PushEmpty(float, object)
0xb24: Stack[-9] = Stack[-1]
0xb25: Call 0x7dc
...
0xb2c: Push((float)-0.30000001192092896)
...
0xb35: Push(Stack[-2])
0xb36: IF (Stack[-1] == 1) GOTO 0xb3f; Pop(1)

0xb37: PushEmpty(float, object)
0xb38: Stack[-8] = Stack[-1]
0xb39: Call 0x7dc

0xb3a: Pop(1)
0xb3b: Push((float)250000.0)
0xb3c: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0xb3d: IF (Stack[-1] == 1) GOTO 0xb3f; Pop(1)
