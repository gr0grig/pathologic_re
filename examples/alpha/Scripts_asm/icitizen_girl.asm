...
Strings:
	...
	W:ui/NPC_None.png
	W:ToDie
// @pool_raw:
...
0x8d3: PushEmpty()
0x8d4: Push((int) 1000)
0x8d5: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=658
0x8d6: Pop(1)
0x8d7: Return(); Pop(0)

0x8d8: PushEmpty(int, int)
0x8d9: Push("player") // @poff=673
...
0x8ec: Push("GenerateMoney: iMin > iMax") // @poff=687
0x8ed: @ Trace(Stack[-1])
0x8ee: Pop(1)
0x8ef: Return(); Pop(8)
...
0x940: Stack[-1] = "alpha_pills" // @poff=775
0x941: Call 0x97d
...
0x94d: Stack[-1] = "meradorm" // @poff=799
0x94e: Call 0x97d
...
0x95b: Stack[-1] = "lockpick" // @poff=817
0x95c: Call 0x97d
...
0x969: Stack[-1] = "rifle_ammo" // @poff=835
0x96a: Call 0x97d
...
0x976: Stack[-1] = "revolver_ammo" // @poff=857
0x977: Call 0x97d
...
0x984: Stack[-1] = "ui/NPC_None.png" // @poff=885
0x985: Return(); Pop(0)
...
0x9bd: Push(Stack[-2])
0x9be: IF (Stack[-1] == 1) GOTO 0x9c7; Pop(1)
...
0x9d5: Push(Stack[-2])
0x9d6: IF (Stack[-1] == 1) GOTO 0x9df; Pop(1)
...
0x9dd: IF (Stack[-1] == 1) GOTO 0x9df; Pop(1)

0x9de: Stack[-1] = (bool) 0
0x9df: IF (Stack[-1] == 0) GOTO 0x9e6; Pop(1)

0x9e0: Push("ToDie") // @poff=917
0x9e1: Push((bool) 1)
