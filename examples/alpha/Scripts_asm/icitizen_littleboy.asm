...
Strings:
	...
	W:ui/NPC_None.png
	W:ToDie
// @pool_raw:
...
0x560: Pop(1)
0x561: Push((int) 14749)
0x562: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x563: Pop(1)
0x564: @@@ ClearReplies(); Obj=0 // @poff=394
0x565: Pop(0)
0x566: Push((int) 14750)
0x567: Push((int) 15997)
0x568: Push((int) 15996)
0x569: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x56a: Pop(3)
0x56b: Push((int) 14760)
0x56c: Push((int) -1)
0x56d: Push((int) 16006)
0x56e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x56f: Pop(3)
0x570: GOTO 0x587

0x571: PushEmpty(string)
0x572: Stack[-1] = "Neutral" // @poff=367
0x573: Call 0x5a5

0x574: Pop(1)
0x575: Push((int) 14761)
0x576: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x577: Pop(1)
0x578: @@@ ClearReplies(); Obj=0 // @poff=394
0x579: Pop(0)
0x57a: Push((int) 14762)
0x57b: Push((int) 16009)
0x57c: Push((int) 16008)
0x57d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x57e: Pop(3)
0x57f: Push((int) 14770)
0x580: Push((int) -1)
0x581: Push((int) 16016)
...
0x596: Push("all") // @poff=0
0x597: Push("idle") // @poff=8
...
0x5c2: Pop(2)
0x5c3: Push((int) 14628)
0x5c4: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x5c5: IF (Stack[-1] == 0) GOTO 0x602; Pop(1)

0x5c6: PushEmpty(string)
0x5c7: Stack[-1] = "Neutral" // @poff=367
0x5c8: Call 0x5a5

0x5c9: Pop(1)
0x5ca: Push((int) 13394)
0x5cb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5cc: Pop(1)
0x5cd: @@@ ClearReplies(); Obj=0 // @poff=394
0x5ce: Pop(0)
0x5cf: Push((int) 13396)
0x5d0: Push((int) -1)
0x5d1: Push((int) 14630)
0x5d2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5d3: Pop(3)
0x5d4: Push((int) 13395)
0x5d5: Push((int) -1)
0x5d6: Push((int) 14629)
0x5d7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5d8: Pop(3)
0x5d9: Return(); Pop(0)

0x5da: PushEmpty(string)
0x5db: Stack[-1] = "Neutral" // @poff=367
0x5dc: Call 0x5a5

0x5dd: Pop(1)
0x5de: Push((int) 14749)
0x5df: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5e0: Pop(1)
0x5e1: @@@ ClearReplies(); Obj=0 // @poff=394
0x5e2: Pop(0)
0x5e3: Push((int) 14750)
0x5e4: Push((int) 15997)
0x5e5: Push((int) 15996)
0x5e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5e7: Pop(3)
0x5e8: Push((int) 14760)
0x5e9: Push((int) -1)
0x5ea: Push((int) 16006)
0x5eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5ec: Pop(3)
0x5ed: Return(); Pop(0)

0x5ee: PushEmpty(string)
0x5ef: Stack[-1] = "Neutral" // @poff=367
0x5f0: Call 0x5a5

0x5f1: Pop(1)
0x5f2: Push((int) 14761)
0x5f3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x5f4: Pop(1)
0x5f5: @@@ ClearReplies(); Obj=0 // @poff=394
0x5f6: Pop(0)
0x5f7: Push((int) 14762)
0x5f8: Push((int) 16009)
0x5f9: Push((int) 16008)
0x5fa: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x5fb: Pop(3)
0x5fc: Push((int) 14770)
0x5fd: Push((int) -1)
0x5fe: Push((int) 16016)
0x5ff: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x600: Pop(3)
0x601: Return(); Pop(0)

0x602: Push((int) 16009)
0x603: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x604: IF (Stack[-1] == 0) GOTO 0x619; Pop(1)

0x605: PushEmpty(string)
0x606: Stack[-1] = "Neutral" // @poff=367
0x607: Call 0x5a5

0x608: Pop(1)
0x609: Push((int) 14763)
0x60a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x60b: Pop(1)
0x60c: @@@ ClearReplies(); Obj=0 // @poff=394
0x60d: Pop(0)
0x60e: Push((int) 14764)
0x60f: Push((int) 16011)
0x610: Push((int) 16010)
0x611: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x612: Pop(3)
0x613: Push((int) 14769)
0x614: Push((int) -1)
0x615: Push((int) 16015)
0x616: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x617: Pop(3)
0x618: Return(); Pop(0)

0x619: Push((int) 16011)
0x61a: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x61b: IF (Stack[-1] == 0) GOTO 0x635; Pop(1)

0x61c: PushEmpty(string)
0x61d: Stack[-1] = "Neutral" // @poff=367
0x61e: Call 0x5a5

0x61f: Pop(1)
0x620: Push((int) 14765)
0x621: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x622: Pop(1)
0x623: @@@ ClearReplies(); Obj=0 // @poff=394
0x624: Pop(0)
0x625: Push((int) 14766)
0x626: Push((int) -1)
0x627: Push((int) 16012)
0x628: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x629: Pop(3)
0x62a: Push((int) 14767)
0x62b: Push((int) -1)
0x62c: Push((int) 16013)
0x62d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x62e: Pop(3)
0x62f: Push((int) 14768)
0x630: Push((int) -1)
0x631: Push((int) 16014)
0x632: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x633: Pop(3)
0x634: Return(); Pop(0)

0x635: Push((int) 15997)
0x636: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x637: IF (Stack[-1] == 0) GOTO 0x64c; Pop(1)

0x638: PushEmpty(string)
0x639: Stack[-1] = "Neutral" // @poff=367
0x63a: Call 0x5a5

0x63b: Pop(1)
0x63c: Push((int) 14751)
0x63d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x63e: Pop(1)
0x63f: @@@ ClearReplies(); Obj=0 // @poff=394
0x640: Pop(0)
0x641: Push((int) 14752)
0x642: Push((int) 15999)
0x643: Push((int) 15998)
0x644: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x645: Pop(3)
0x646: Push((int) 14759)
0x647: Push((int) -1)
0x648: Push((int) 16005)
0x649: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x64a: Pop(3)
0x64b: Return(); Pop(0)

0x64c: Push((int) 15999)
0x64d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x64e: IF (Stack[-1] == 0) GOTO 0x663; Pop(1)

0x64f: PushEmpty(string)
0x650: Stack[-1] = "Neutral" // @poff=367
0x651: Call 0x5a5

0x652: Pop(1)
0x653: Push((int) 14753)
0x654: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x655: Pop(1)
0x656: @@@ ClearReplies(); Obj=0 // @poff=394
0x657: Pop(0)
0x658: Push((int) 14754)
0x659: Push((int) -1)
0x65a: Push((int) 16000)
0x65b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x65c: Pop(3)
0x65d: Push((int) 14755)
0x65e: Push((int) 16002)
0x65f: Push((int) 16001)
0x660: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x661: Pop(3)
0x662: Return(); Pop(0)

0x663: Push((int) 16002)
0x664: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x665: IF (Stack[-1] == 0) GOTO 0x67a; Pop(1)

0x666: PushEmpty(string)
0x667: Stack[-1] = "Neutral" // @poff=367
0x668: Call 0x5a5

0x669: Pop(1)
0x66a: Push((int) 14756)
0x66b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x66c: Pop(1)
0x66d: @@@ ClearReplies(); Obj=0 // @poff=394
0x66e: Pop(0)
0x66f: Push((int) 14757)
0x670: Push((int) -1)
0x671: Push((int) 16003)
0x672: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x673: Pop(3)
0x674: Push((int) 14758)
0x675: Push((int) -1)
0x676: Push((int) 16004)
...
0x68e: Pop(0)
0x68f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=28
0x690: Pop(0)
...
0x695: Pop(0)
0x696: @@ GetPosition(Stack[-2]); Obj=7 // @poff=28
0x697: Pop(0)
...
0x69c: Push("HasProperty") // @poff=416
0x69d: Push((int) 2)
...
0x6a3: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=440
0x6a4: Pop(0)
0x6a5: Stack[-1] = Stack[-5]
0x6a6: Return(); Pop(2)

0x6a7: PushEmpty(bool, bool)
0x6a8: @@ IsDead(Stack[-1]); Obj=3 // @poff=452
0x6a9: Pop(0)
0x6aa: Stack[-1] = Stack[-4]
0x6ab: Return(); Pop(2)

0x6ac: PushEmpty(object, object, object, object)
0x6ad: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x6c1: Pop(0)
0x6c2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6c3: IF (Stack[-1] == 0) GOTO 0x6c6; Pop(1)

0x6c4: Stack[-6] = (bool) 0
0x6c5: Return(); Pop(4)

0x6c6: @@ GetScene(Stack[-1]); Obj=5 // @poff=473
0x6c7: Pop(0)
...
0x6da: Stack[-6] = Stack[-2]
0x6db: Stack[-1] = "noaccess" // @poff=482
0x6dc: Call 0x69b
...
0x6e2: Push("noaccess") // @poff=482
0x6e3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=500
0x6e4: Pop(1)
0x6e5: Push((int) 0)
...
0x70e: @@ GetPosition(Stack[-5]); Obj=23 // @poff=28
0x70f: Pop(0)
...
0x71f: Stack[-1] = "fhit" // @poff=550
0x720: GOTO 0x722

0x721: Stack[-1] = "bhit" // @poff=560
0x722: Push("hit_react") // @poff=570
0x723: Push("1") // @poff=590
0x724: Pop(1); Push(Stack[-3] + Stack[-1]);
0x725: Push("2") // @poff=594
...
0x72c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=28
0x72d: Pop(0)
...
0x73c: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x73d: Pop(0)
0x73e: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x73f: Pop(0)
...
0x778: @@ GetPosition(Stack[-7]); Obj=17 // @poff=28
0x779: Pop(0)
0x77a: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=164
0x77b: Pop(0)
...
0x7b3: Pop(0)
0x7b4: Push("start: ") // @poff=616
0x7b5: Pop(1); Push(Stack[-1] + Stack[-3]);
0x7b6: @ Trace(Stack[-1])
0x7b7: Pop(1)
0x7b8: Push("end: ") // @poff=632
...
0x7be: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=164
0x7bf: Pop(0)
...
0x82b: Stack[-7] = Stack[-3]
0x82c: Stack[-6] = Stack[-2]
0x82d: Stack[-5] = Stack[-1]
0x82e: Call 0x6e8
...
0x839: Stack[-2] = (int) 0
0x83a: Push("all") // @poff=0
0x83b: PushEmpty(string, int)
0x83c: Stack[-5] = Stack[-1]
0x83d: Call 0x831
...
0x892: PushEmpty()
0x893: Push((int) 1000)
0x894: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=658
0x895: Pop(1)
0x896: Return(); Pop(0)

0x897: PushEmpty(int, int)
0x898: Push("player") // @poff=673
...
0x8ab: Push("GenerateMoney: iMin > iMax") // @poff=687
0x8ac: @ Trace(Stack[-1])
0x8ad: Pop(1)
0x8ae: Return(); Pop(8)
...
0x8ff: Stack[-1] = "rifle_ammo" // @poff=781
0x900: Call 0x94a
...
0x90c: Stack[-1] = "revolver_ammo" // @poff=803
0x90d: Call 0x94a
...
0x91a: Stack[-1] = "lockpick" // @poff=831
0x91b: Call 0x94a
...
0x928: Stack[-1] = "alpha_pills" // @poff=849
0x929: Call 0x94a
...
0x935: Stack[-1] = "meradorm" // @poff=873
0x936: Call 0x94a
...
0x94c: Pop(0)
0x94d: Stack[-1] = Stack[-4]
0x94e: Return(); Pop(2)

0x94f: Stack[-1] = (int) 3345
0x950: Return(); Pop(0)

0x951: Stack[-1] = "ui/NPC_None.png" // @poff=905
0x952: Return(); Pop(0)

0x953: Stack[-1] = (bool) 0
0x954: Return(); Pop(0)

0x955: Push(GlobalVars[1])
0x956: Stack[-1] = (bool) 0
0x957: GlobalVars[1] = Stack[-1]; Pop(1)
...
0x95d: PushEmpty(bool, bool)
0x95e: Push(GlobalVars[1])
0x95f: IF (Stack[-1] == 0) GOTO 0x968; Pop(1)

0x960: @ IsOverrideActive(Stack[-1])
0x961: Pop(0)
0x962: Pop(0); Push((bool) Stack[-1] == 0)
0x963: IF (Stack[-1] == 0) GOTO 0x966; Pop(1)

0x964: @ WorkWithCorpse(Stack[-3])
0x965: Pop(0)
0x966: Return(); Pop(2)
...
0x96b: Push(-2, 1); TaskCall(7)
0x96c: Call 0x504

0x96d: Pop(-2, 1); TaskReturn
0x96e: Pop(1)
0x96f: Pop(2); Push((bool) Stack[-2] == Stack[-1])
0x970: IF (Stack[-1] == 0) GOTO 0x982; Pop(1)
...
0x979: Stack[-4] = Stack[-1]
0x97a: Push(-1, 1); TaskCall(0)
0x97b: Call 0x0

0x97c: Pop(-1, 1); TaskReturn
0x97d: Pop(1)
...
0x986: @ CanSee(Stack[-1], Stack[-4])
0x987: Pop(0)
0x988: PushEmpty(bool)
0x989: Stack[-1] = (bool) 1
0x98a: Push(Stack[-2])
0x98b: IF (Stack[-1] == 1) GOTO 0x994; Pop(1)

0x98c: PushEmpty(float, object)
0x98d: Stack[-7] = Stack[-1]
0x98e: Call 0x693

0x98f: Pop(1)
0x990: Push((float)250000.0)
0x991: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x992: IF (Stack[-1] == 1) GOTO 0x994; Pop(1)

0x993: Stack[-1] = (bool) 0
0x994: IF (Stack[-1] == 0) GOTO 0x99e; Pop(1)

0x995: Push((float)-0.30000001192092896)
0x996: @ ReportReputationChange(Stack[-5], Stack[-4], Stack[-1])
0x997: Pop(1)
0x998: Push("ToDie") // @poff=937
0x999: Push((bool) 1)
0x99a: @ SetProperty(Stack[-2], Stack[-1])
0x99b: Pop(2)
0x99c: Stack[-5] = (bool) 1
0x99d: Return(); Pop(2)

0x99e: @ CanSee(Stack[-1], Stack[-3])
0x99f: Pop(0)
0x9a0: PushEmpty(bool)
0x9a1: Stack[-1] = (bool) 1
0x9a2: Push(Stack[-2])
0x9a3: IF (Stack[-1] == 1) GOTO 0x9ac; Pop(1)

0x9a4: PushEmpty(float, object)
0x9a5: Stack[-6] = Stack[-1]
0x9a6: Call 0x693

0x9a7: Pop(1)
0x9a8: Push((float)250000.0)
0x9a9: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x9aa: IF (Stack[-1] == 1) GOTO 0x9ac; Pop(1)

0x9ab: Stack[-1] = (bool) 0
0x9ac: IF (Stack[-1] == 0) GOTO 0x9b3; Pop(1)

0x9ad: Push("ToDie") // @poff=937
0x9ae: Push((bool) 1)
0x9af: @ SetProperty(Stack[-2], Stack[-1])
0x9b0: Pop(2)
0x9b1: Stack[-5] = (bool) 1
0x9b2: Return(); Pop(2)

0x9b3: Stack[-5] = (bool) 0
0x9b4: Return(); Pop(2)

0x9b5: PushEmpty()
0x9b6: Push(GlobalVars[1])
0x9b7: Stack[-1] = (bool) 1
0x9b8: GlobalVars[1] = Stack[-1]; Pop(1)
0x9b9: Push((int) 50)
0x9ba: Push((int) 40)
0x9bb: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x9bc: Pop(2)
