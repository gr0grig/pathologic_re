...
0x634: Stack[-1] = "Neutral" // @poff=367
0x635: Call 0x5a5

0x636: Pop(1)
0x637: Push((int) 14782)
0x638: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=383
0x639: Pop(1)
0x63a: @@@ ClearReplies(); Obj=0 // @poff=394
0x63b: Pop(0)
0x63c: Push((int) 14783)
0x63d: Push((int) -1)
0x63e: Push((int) 16029)
0x63f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=407
0x640: Pop(3)
...
0x9af: Stack[-5] = (bool) 0
0x9b0: Return(); Pop(2)

0x9b1: PushEmpty()
0x9b2: Push(GlobalVars[1])
0x9b3: Stack[-1] = (bool) 1
0x9b4: GlobalVars[1] = Stack[-1]; Pop(1)
0x9b5: Push((int) 50)
0x9b6: Push((int) 40)
0x9b7: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x9b8: Pop(2)
