...
Strings:
	...
	W:idle
	W:ToDie
// @pool_raw:
...
0x26a: @ Face(Stack[-1])
0x26b: Pop(0)
0x26c: Push("all") // @poff=170
0x26d: Push("attack_on") // @poff=178
0x26e: @ PlayAnimation(Stack[-2], Stack[-1])
0x26f: Pop(2)
0x270: @ WaitForAnimEnd()
0x271: Pop(0)
0x272: Push("all") // @poff=170
0x273: Push("attack_stay") // @poff=198
0x274: @ PlayAnimation(Stack[-2], Stack[-1])
0x275: Pop(2)
0x276: @ WaitForAnimEnd()
0x277: Pop(0)
0x278: Push("all") // @poff=170
0x279: Push("attack_off") // @poff=222
...
0x28e: Pop(0)
0x28f: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x290: Pop(0)
...
0x2ad: Stack[-1] = (float) 1.7453293800354004
0x2ae: Call 0x28c

0x2af: Stack[-2] = Stack[-7]
0x2b0: Pop(2)
...
0x2b5: Push("Can't retreat, distance: ") // @poff=244
...
0x2cb: Push((int) 1)
0x2cc: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x2cd: Pop(1)
0x2ce: Push(Stack[-3])
0x2cf: IF (Stack[-1] == 0) GOTO 0x2e7; Pop(1)

0x2d0: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2d5: Stack[-1] = (float) 2.6179938316345215
0x2d6: Call 0x28c

0x2d7: Stack[-2] = Stack[-4]
0x2d8: Pop(2)
...
0x2e8: IF (Stack[-1] == 1) GOTO 0x2cb; Pop(1)
...
0x2ef: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2fe: Stack[-1] = (float) 1.7453293800354004
0x2ff: Call 0x28c

0x300: Stack[-2] = Stack[-4]
0x301: Pop(2)
...
0x30e: IF (Stack[-1] == 1) GOTO 0x314; Pop(1)
...
0x33a: Pop(2)
0x33b: Push((float)-0.3420201241970062)
...
0x340: Pop(0)
0x341: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=10
0x342: Pop(0)
...
0x35f: Stack[-1] = (float) 1.7453293800354004
0x360: Call 0x33e

0x361: Stack[-2] = Stack[-7]
0x362: Pop(2)
...
0x367: Push("Can't retreat, distance: ") // @poff=244
...
0x37d: Push((int) 1)
0x37e: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x37f: Pop(1)
0x380: Push(Stack[-3])
0x381: IF (Stack[-1] == 0) GOTO 0x399; Pop(1)

0x382: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x387: Stack[-1] = (float) 2.6179938316345215
0x388: Call 0x33e
...
0x39a: IF (Stack[-1] == 1) GOTO 0x37d; Pop(1)
...
0x3a1: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x3b0: Stack[-1] = (float) 1.7453293800354004
0x3b1: Call 0x33e
...
0x3c0: IF (Stack[-1] == 1) GOTO 0x3c6; Pop(1)

0x3c1: PushEmpty(bool)
0x3c2: Call 0x3e0

0x3c3: Pop(0)
0x3c4: IF (Stack[-1] == 1) GOTO 0x3c6; Pop(1)
...
0x3e6: Stack[-2] = Stack[-3]
0x3e7: Pop(2)
0x3e8: PushEmpty(float, cvector, cvector)
0x3e9: Stack[-5] = Stack[-2]
0x3ea: Stack[-4] = Stack[-1]
0x3eb: Call 0x4b9

0x3ec: Pop(2)
0x3ed: Push((float)-0.3420201241970062)
...
0x3f7: Pop(0)
0x3f8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x3f9: Pop(0)
...
0x3fe: Pop(0)
0x3ff: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x400: Pop(0)
...
0x405: Push("HasProperty") // @poff=296
0x406: Push((int) 2)
...
0x40c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=320
0x40d: Pop(0)
0x40e: Stack[-1] = Stack[-5]
0x40f: Return(); Pop(2)

0x410: PushEmpty(bool, bool)
0x411: @@ IsDead(Stack[-1]); Obj=3 // @poff=332
0x412: Pop(0)
0x413: Stack[-1] = Stack[-4]
0x414: Return(); Pop(2)

0x415: PushEmpty(object, object, object, object)
0x416: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x42a: Pop(0)
0x42b: Pop(0); PushNull((bool) Stack[-2] == 0)
0x42c: IF (Stack[-1] == 0) GOTO 0x42f; Pop(1)

0x42d: Stack[-6] = (bool) 0
0x42e: Return(); Pop(4)

0x42f: @@ GetScene(Stack[-1]); Obj=5 // @poff=353
0x430: Pop(0)
...
0x443: Stack[-6] = Stack[-2]
0x444: Stack[-1] = "noaccess" // @poff=362
0x445: Call 0x404
...
0x44b: Push("noaccess") // @poff=362
0x44c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=380
0x44d: Pop(1)
0x44e: Push((int) 0)
...
0x477: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x478: Pop(0)
...
0x488: Stack[-1] = "fhit" // @poff=430
0x489: GOTO 0x48b

0x48a: Stack[-1] = "bhit" // @poff=440
0x48b: Push("hit_react") // @poff=450
0x48c: Push("1") // @poff=470
0x48d: Pop(1); Push(Stack[-3] + Stack[-1]);
0x48e: Push("2") // @poff=474
...
0x495: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x496: Pop(0)
...
0x4b2: Push((float)9.999999974752427e-07)
...
0x4d6: Stack[-5] = Stack[-2]
0x4d7: Stack[-4] = Stack[-1]
0x4d8: Call 0x4c1
...
0x50b: Stack[-7] = Stack[-3]
0x50c: Stack[-6] = Stack[-2]
0x50d: Stack[-5] = Stack[-1]
0x50e: Call 0x451
...
0x56b: Push("GenerateMoney: iMin > iMax") // @poff=492
0x56c: @ Trace(Stack[-1])
0x56d: Pop(1)
0x56e: Return(); Pop(8)
...
0x5bf: Stack[-1] = "syringe" // @poff=590
0x5c0: Call 0x635
...
0x5fd: Stack[-1] = "bracelet" // @poff=642
0x5fe: Call 0x635
...
0x609: Stack[-1] = "ear_ring" // @poff=660
0x60a: Call 0x635
...
0x615: Stack[-1] = "gold_ring" // @poff=678
0x616: Call 0x635
...
0x621: Stack[-1] = "silver_ring" // @poff=698
0x622: Call 0x635
...
0x664: Pop(0)
0x665: Push("all") // @poff=170
0x666: PushEmpty(string, int)
0x667: Stack[-4] = Stack[-1]
0x668: Call 0x63a
...
0x691: Push(Stack[-2])
0x692: IF (Stack[-1] == 1) GOTO 0x69b; Pop(1)
...
0x699: IF (Stack[-1] == 1) GOTO 0x69b; Pop(1)

0x69a: Stack[-1] = (bool) 0
0x69b: IF (Stack[-1] == 0) GOTO 0x6a2; Pop(1)

0x69c: Push("ToDie") // @poff=746
0x69d: Push((bool) 1)
