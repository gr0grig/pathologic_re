...
Strings:
	...
	W:worker
	W:wasted_male
// @pool_raw:
...
0x103: Stack[-5] = Stack[-1]
0x104: Call 0x69e

0x105: Stack[-2] = Stack[-3]
0x106: Pop(2)
0x107: Push((int) 0)
...
0x170: Stack[-7] = Stack[-1]
0x171: Call 0x664

0x172: Stack[-2] = Stack[-3]
0x173: Pop(2)
0x174: Push((int) 0)
...
0x1d5: Stack[-5] = Stack[-1]
0x1d6: Call 0x675

0x1d7: Stack[-2] = Stack[-3]
0x1d8: Pop(2)
0x1d9: Push((int) 0)
...
0x1e9: Stack[-7] = Stack[-2]
0x1ea: Stack[-6] = Stack[-1]
0x1eb: Call 0x7c2
...
0x217: Stack[-6] = Stack[-2]
0x218: Stack[-7] = Stack[-1]
0x219: Call 0x6b1

0x21a: Stack[-3] = Stack[-4]
0x21b: Pop(3)
0x21c: Push((int) 0)
...
0x226: Stack[-5] = Stack[-2]
0x227: Stack[-6] = Stack[-1]
0x228: Call 0x6b4
...
0x253: Stack[-2] = Stack[-3]
0x254: Pop(2)
0x255: PushEmpty(float, cvector, cvector)
0x256: Stack[-5] = Stack[-2]
0x257: Stack[-4] = Stack[-1]
0x258: Call 0x627

0x259: Pop(2)
0x25a: Push((float)0.4999999701976776)
...
0x271: PushEmpty()
0x272: Stack[-3] = (float) 0.05000000074505806
0x273: Return(); Pop(0)
...
0x279: Push("all") // @poff=170
0x27a: Push("attack_begin") // @poff=178
0x27b: Push((int) 1)
0x27c: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x287: Push("attack") // @poff=204
0x288: Push((int) 1)
0x289: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2a4: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x2a5: Pop(0)
0x2a6: Push(Stack[-22])
...
0x2b6: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x2b7: Pop(0)
...
0x2e8: Push((float)0.6000000238418579)
0x2e9: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x2ea: IF (Stack[-1] == 1) GOTO 0x2f0; Pop(1)

0x2eb: PushEmpty(bool)
0x2ec: Call 0x42f

0x2ed: Pop(0)
0x2ee: IF (Stack[-1] == 1) GOTO 0x2f0; Pop(1)
...
0x2f2: Pop(0)
0x2f3: Push("all") // @poff=170
0x2f4: Push("attack_stay") // @poff=308
0x2f5: @ PlayAnimation(Stack[-2], Stack[-1])
0x2f6: Pop(2)
0x2f7: PushEmpty(bool, float)
0x2f8: Stack[-23] = Stack[-1]
0x2f9: Call 0x3d3
...
0x2fe: @ Face(Stack[-0]T)
0x2ff: Pop(0)
0x300: Push("all") // @poff=170
0x301: Push("fjump") // @poff=332
...
0x319: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x31a: Pop(0)
...
0x338: Push("all") // @poff=170
0x339: Push("attack_off") // @poff=344
...
0x345: Push((float)0.8999999761581421)
0x346: Pop(1); Push(Stack[-9] * Stack[-1]);
0x347: @ GetVictim(Stack[-1], Stack[-4])
0x348: Pop(1)
0x349: @ ReportAttack(Stack[-0]T)
0x34a: Pop(0)
...
0x34e: Stack[-6] = Stack[-2]
0x34f: Stack[-10] = Stack[-1]
0x350: Call 0x271

0x351: Stack[-3] = Stack[-5]
0x352: Pop(3)
0x353: PushEmpty(float, object, float, int)
0x354: Stack[-7] = Stack[-3]
0x355: Stack[-6] = Stack[-2]
0x356: PushEmpty(int, object, int)
0x357: Stack[-10] = Stack[-2]
0x358: Stack[-14] = Stack[-1]
0x359: Call 0x274

0x35a: Stack[-3] = Stack[-4]
0x35b: Pop(3)
0x35c: Call 0x523

0x35d: Stack[-4] = Stack[-5]
0x35e: Pop(4)
0x35f: PushEmpty(int)
0x360: Call 0x45a

0x361: Pop(0)
0x362: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x363: Pop(1)
...
0x36c: @ irand(Stack[-2], Stack[-1]T)
0x36d: Pop(0)
0x36e: Push((int) 1)
0x36f: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x370: @ Face(Stack[-0]T)
0x371: Pop(0)
0x372: Push((bool) 1)
0x373: @ SetAttackState(Stack[-1])
0x374: Pop(1)
0x375: Push("all") // @poff=170
0x376: Push("attack_begin") // @poff=178
...
0x38a: Stack[-7] = Stack[-2]
0x38b: Stack[-4] = Stack[-1]
0x38c: Call 0x344

0x38d: Pop(2)
0x38e: Push("all") // @poff=170
0x38f: Push("attack_middle") // @poff=366
...
0x395: Push("all") // @poff=170
0x396: Push("attack_middle") // @poff=366
...
0x3ad: Pop(1)
0x3ae: Push("all") // @poff=170
0x3af: Push("attack_end") // @poff=394
...
0x3e7: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=274
0x3e8: Pop(0)
...
0x41d: @ Face(Stack[-0]T)
0x41e: Pop(0)
0x41f: Push("all") // @poff=170
0x420: Push("bjump") // @poff=416
0x421: @ PlayAnimation(Stack[-2], Stack[-1])
0x422: Pop(2)
0x423: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=274
0x424: Pop(0)
...
0x44d: @ irand(Stack[-1], Stack[-2]T)
0x44e: Pop(0)
0x44f: Push((int) 1)
0x450: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x451: Push("attack") // @poff=204
...
0x46c: Stack[-17] = Stack[-7]
0x46d: PushEmpty(bool, object)
0x46e: Stack[-23] = Stack[-1]
0x46f: Call 0x4f5
...
0x475: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x476: Pop(0)
...
0x48c: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=274
0x48d: Pop(0)
...
0x49e: Push((int) 0)
0x49f: Push((float)0.30000001192092896)
...
0x4c1: Push((int) 0)
0x4c2: Push((float)0.30000001192092896)
...
0x4fc: Stack[-1] = "walk" // @poff=464
0x4fd: Return(); Pop(0)

0x4fe: Stack[-1] = "run" // @poff=474
0x4ff: Return(); Pop(0)
...
0x504: Stack[-2] = "fire" // @poff=482
0x505: Return(); Pop(0)

0x506: Stack[-2] = "phys" // @poff=492
0x507: Return(); Pop(0)

0x508: PushEmpty(cvector, cvector, cvector, cvector)
0x509: @ GetPosition(Stack[-2])
0x50a: Pop(0)
0x50b: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x50c: Pop(0)
...
0x511: Pop(0)
0x512: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x513: Pop(0)
...
0x518: Push("HasProperty") // @poff=502
0x519: Push((int) 2)
...
0x51f: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=526
0x520: Pop(0)
...
0x525: Stack[-18] = Stack[-2]
0x526: Stack[-1] = "health" // @poff=538
0x527: Call 0x517
...
0x52e: Stack[-18] = Stack[-2]
0x52f: Stack[-1] = "armor" // @poff=552
0x530: Call 0x517
...
0x536: Push("armor") // @poff=552
0x537: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=564
0x538: Pop(1)
0x539: Push("armor_") // @poff=576
0x53a: PushEmpty(string, int)
0x53b: Stack[-16] = Stack[-1]
0x53c: Call 0x500

0x53d: Pop(1)
0x53e: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x53f: PushEmpty(bool, object, string)
0x540: Stack[-18] = Stack[-2]
...
0x548: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=564
0x549: Pop(0)
...
0x550: Stack[-3] = Stack[-6]
0x551: Pop(3)
0x552: Push("health") // @poff=538
0x553: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=564
0x554: Pop(1)
0x555: Push((int) 1)
0x556: Pop(1); Push(Stack[-1] - Stack[-4]);
0x557: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x558: Push("health") // @poff=538
...
0x55e: Pop(3)
0x55f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=590
0x560: Pop(2)
0x561: Stack[-1] = Stack[-16]
0x562: Return(); Pop(12)

0x563: PushEmpty(bool, bool)
0x564: @@ IsDead(Stack[-1]); Obj=3 // @poff=602
0x565: Pop(0)
0x566: Stack[-1] = Stack[-4]
0x567: Return(); Pop(2)

0x568: PushEmpty(object, object, object, object)
0x569: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x57d: Pop(0)
0x57e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x57f: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x580: Stack[-6] = (bool) 0
0x581: Return(); Pop(4)

0x582: @@ GetScene(Stack[-1]); Obj=5 // @poff=623
0x583: Pop(0)
...
0x596: Stack[-6] = Stack[-2]
0x597: Stack[-1] = "noaccess" // @poff=632
0x598: Call 0x517
...
0x59e: Push("noaccess") // @poff=632
0x59f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=564
0x5a0: Pop(1)
0x5a1: Push((int) 0)
...
0x5ca: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x5cb: Pop(0)
...
0x5db: Stack[-1] = "fhit" // @poff=688
0x5dc: GOTO 0x5de

0x5dd: Stack[-1] = "bhit" // @poff=698
0x5de: Push("hit_react") // @poff=708
0x5df: Push("1") // @poff=728
0x5e0: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5e1: Push("2") // @poff=732
...
0x5e8: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x5e9: Pop(0)
...
0x605: Stack[-2] = Stack[-3]
0x606: GOTO 0x608

0x607: Stack[-1] = Stack[-3]
0x608: Return(); Pop(0)
...
0x6b9: Push("GenerateMoney: iMin > iMax") // @poff=736
0x6ba: @ Trace(Stack[-1])
0x6bb: Pop(1)
0x6bc: Return(); Pop(8)
...
0x70d: Stack[-1] = "syringe" // @poff=834
0x70e: Call 0x783
...
0x74b: Stack[-1] = "bracelet" // @poff=886
0x74c: Call 0x783
...
0x757: Stack[-1] = "ear_ring" // @poff=904
0x758: Call 0x783
...
0x763: Stack[-1] = "gold_ring" // @poff=922
0x764: Call 0x783
...
0x76f: Stack[-1] = "silver_ring" // @poff=942
0x770: Call 0x783
...
0x785: Pop(0)
0x786: Stack[-1] = Stack[-4]
0x787: Return(); Pop(2)

0x788: PushEmpty(string, string)
0x789: Stack[-1] = "idle" // @poff=980
0x78a: Push(Stack[-3])
...
0x7b2: Pop(0)
0x7b3: Push("all") // @poff=170
0x7b4: PushEmpty(string, int)
0x7b5: Stack[-4] = Stack[-1]
0x7b6: Call 0x788
...
0x7c4: Stack[-8] = Stack[-2]
0x7c5: Stack[-1] = "class" // @poff=990
0x7c6: Call 0x517
...
0x7cc: Push("class") // @poff=990
0x7cd: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=564
0x7ce: Pop(1)
...
0x7ef: Push("wasted_girl") // @poff=1044
...
0x7fe: Push("wasted_male") // @poff=1094
...
0x809: Push(Stack[-2])
0x80a: IF (Stack[-1] == 1) GOTO 0x813; Pop(1)

0x80b: PushEmpty(float, object)
0x80c: Stack[-9] = Stack[-1]
0x80d: Call 0x50f
...
0x814: Push((float)-0.30000001192092896)
...
0x81e: GlobalVars[1] = Stack[-1]; Pop(1)
0x81f: Push((int) 50)
0x820: Push((int) 40)
