...
Strings:
	...
	W:tiredness
	W:sleeping
// @pool_raw:6800650061006c00740068000000740069007200650064006e00650073007300000073006c0065006500700069006e0067000000
...
0x19: Stack[-4] = "health" // @poff=0
0x1a: Push((float)0.009999999776482582)
...
0x21: Stack[-4] = "tiredness" // @poff=14
0x22: Push((float)-0.009999999776482582)
...
0x52: Stack[-10] = Stack[-2]
0x53: Stack[-9] = Stack[-1]
0x54: Call 0x67
