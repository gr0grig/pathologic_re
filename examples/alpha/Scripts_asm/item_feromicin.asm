...
Strings:
	...
	W:DiseaseSpeed
	W:hunger
// @pool_raw:6800650061006c00740068000000640069007300650061007300650000004400690073006500610073006500530070006500650064000000680075006e006700650072000000
...
0x1e: Pop(0)
0x1f: Push("DiseaseSpeed") // @poff=30
0x20: @ GetProperty(Stack[-1], Stack[-3])
0x21: Pop(1)
0x22: Push("DiseaseSpeed") // @poff=30
...
0x3a: Push("hunger") // @poff=56
0x3b: @ GetProperty(Stack[-1], Stack[-4])
0x3c: Pop(1)
0x3d: Push((float)0.33000001311302185)
0x3e: Push((int) 1)
0x3f: Push((float)1.0)
...
0x51: Stack[-4] = "health" // @poff=0
0x52: Push((float)-0.05000000074505806)
...
0x82: Stack[-10] = Stack[-2]
0x83: Stack[-9] = Stack[-1]
0x84: Call 0x8a
