...
Strings:
	...
	W:disease
	W:hunger
// @pool_raw:6800650061006c00740068000000440069007300650061007300650053007000650065006400000064006900730065006100730065000000680075006e006700650072000000
...
0x5: Stack[-4] = "health" // @poff=0
0x6: Stack[-3] = (float) -0.05000000074505806
0x7: Stack[-2] = (int) 0
0x8: Stack[-1] = (int) 1
0x9: Call 0x6f

0xa: Pop(5)
0xb: Push("DiseaseSpeed") // @poff=14
0xc: @ GetProperty(Stack[-1], Stack[-3])
0xd: Pop(1)
0xe: Push((float)0.5)
0xf: Stack[-2] = Stack[-3] * Stack[-1]; Pop(1);
0x10: Push("DiseaseSpeed") // @poff=14
...
0x16: Pop(0)
0x17: Push("DiseaseSpeed") // @poff=14
0x18: @ GetProperty(Stack[-1], Stack[-3])
0x19: Pop(1)
0x1a: Push("DiseaseSpeed") // @poff=14
...
0x2d: Push((float)0.6000000238418579)
...
0x49: Stack[-4] = "health" // @poff=0
0x4a: Push((float)-0.05000000074505806)
...
0x7a: Stack[-10] = Stack[-2]
0x7b: Stack[-9] = Stack[-1]
0x7c: Call 0x82
