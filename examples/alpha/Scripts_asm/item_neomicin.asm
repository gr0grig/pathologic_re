...
Strings:
	...
	W:hunger
	W:health
// @pool_raw:64006900730065006100730065000000680075006e0067006500720000006800650061006c00740068000000
...
0x6: Push("disease") // @poff=0
0x7: @ GetProperty(Stack[-1], Stack[-2])
0x8: Pop(1)
0x9: Push("disease") // @poff=0
0xa: Push((float)0.5)
...
0x20: Push((float)0.4000000059604645)
...
0x25: Push("hunger") // @poff=16
0x26: @ GetProperty(Stack[-1], Stack[-4])
0x27: Pop(1)
0x28: Push((float)0.15000000596046448)
0x29: Push((int) 1)
0x2a: Push((float)2.0)
...
0x3c: Stack[-4] = "health" // @poff=30
0x3d: Push((float)-0.009999999776482582)
