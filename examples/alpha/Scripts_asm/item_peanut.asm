...
Strings:
	W:hunger
// @pool_raw:680075006e006700650072000000
...
0x1: Stack[-4] = "hunger" // @poff=0
0x2: Stack[-3] = (float) -0.009999999776482582
0x3: Stack[-2] = (int) 0
0x4: Stack[-1] = (int) 1
0x5: Call 0x8
...
0x13: Stack[-10] = Stack[-2]
0x14: Stack[-9] = Stack[-1]
0x15: Call 0x1b
