...
Strings:
	...
	W:visibility
	W:audibility
// @pool_raw:
...
0x31: Pop(1)
0x32: Push("durability") // @poff=0
0x33: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=22
0x34: Pop(1)
0x35: Push(Stack[-2])
0x36: IF (Stack[-1] == 0) GOTO 0x42; Pop(1)

0x37: Push("durability") // @poff=0
0x38: @@ GetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=34
0x39: Pop(1)
...
0x3f: Stack[-4] = Stack[-5]
0x40: Pop(4)
0x41: GOTO 0x43

0x42: Stack[-1] = (int) 100
0x43: Push("durability") // @poff=0
0x44: @@ SetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=46
0x45: Pop(1)
0x46: Push((int) 1)
...
0x5d: Stack[-2] = "armor_fire" // @poff=70
...
0x63: Stack[-2] = "armor_phys" // @poff=92
...
0x69: Stack[-2] = "armor_disease" // @poff=114
...
0x6f: Stack[-2] = "visibility" // @poff=142
...
0x75: Stack[-2] = "audibility" // @poff=164
...
0x87: Pop(1)
0x88: Push("durability") // @poff=0
0x89: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=22
0x8a: Pop(1)
0x8b: Pop(0); Push((bool) Stack[-2] == 0)
0x8c: IF (Stack[-1] == 0) GOTO 0x96; Pop(1)

0x8d: Stack[-1] = (int) 100
0x8e: Push("durability") // @poff=0
0x8f: @@ SetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=46
0x90: Pop(1)
0x91: Push((int) 1)
...
0x96: Push("durability") // @poff=0
0x97: @@ GetProperty(Stack[-2], Stack[-1]); Obj=4 // @poff=34
0x98: Pop(1)
0x99: PushEmpty(int)
...
0xa2: Stack[-6] = Stack[-3]
0xa3: Stack[-5] = Stack[-2]
...
0x12b: Stack[-8] = Stack[-2]
0x12c: Stack[-1] = Stack[-3] - Stack[-7]; Pop(0);
0x12d: Call 0xc8

0x12e: Pop(2)
0x12f: Stack[-1] = Stack[-7]
0x130: Return(); Pop(2)
...
0x15a: Pop(1)
0x15b: Push("durability") // @poff=0
0x15c: @@ HasProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=22
0x15d: Pop(1)
0x15e: Push(Stack[-3])
...
0x165: Pop(1)
0x166: Push("durability") // @poff=0
0x167: @@ GetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=34
0x168: Pop(1)
...
0x16e: Stack[-4] = Stack[-5]
0x16f: Pop(4)
0x170: Push("durability") // @poff=0
0x171: @@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=46
0x172: Pop(1)
0x173: Push((int) 1)
