...
Strings:
	...
	W:tiredness
	W:sleeping
// @pool_raw:6800650061006c0074006800000069006d006d0075006e006900740079000000740069007200650064006e00650073007300000073006c0065006500700069006e0067000000
...
0x9: Stack[-3] = (float) 0.05000000074505806
0xa: Stack[-2] = (int) 0
0xb: Stack[-1] = (int) 1
0xc: Call 0x46
...
0x20: Stack[-4] = "tiredness" // @poff=32
0x21: Push((float)-0.10000000149011612)
