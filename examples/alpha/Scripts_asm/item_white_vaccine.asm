...
Strings:
	W:immunity
	W:health
// @pool_raw:69006d006d0075006e0069007400790000006800650061006c00740068000000
...
0x19: Stack[-4] = "immunity" // @poff=0
0x1a: Push((float)2.0)
0x1b: Stack[-4] = Stack[-7] * Stack[-1]; Pop(1);
0x1c: Stack[-2] = (int) 0
0x1d: Stack[-1] = (float) 0.9900000095367432
0x1e: Call 0x47

0x1f: Pop(5)
0x20: PushEmpty(bool, string, float, float, float)
0x21: Stack[-4] = "health" // @poff=18
0x22: Push((float)-0.05000000074505806)
