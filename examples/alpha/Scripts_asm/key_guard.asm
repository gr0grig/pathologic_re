...
// @pool_raw:
...
Events:
EVENT_16 Op = 0x53c Vars = (object, string)
EVENT_41 Op = 0x549 Vars = (object)
EVENT_22 Op = 0x54f Vars = (object, int, float, float)
...
0x76: Stack[-6] = Stack[-2]
0x77: Stack[-7] = Stack[-1]
0x78: Call 0x5b9

0x79: Stack[-3] = Stack[-4]
0x7a: Pop(3)
0x7b: Push((int) 0)
...
0xab: @ GetPFPosition(Stack[-1]T)
0xac: Pop(0)
0xad: @ GetDirection(Stack[-0]T)
0xae: Pop(0)
0xaf: Push((int) 60)
...
0xc6: @ FindPathTo(Stack[-1], Stack[-1]T)
0xc7: Pop(0)
...
0xd5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xd6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0xe8: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0xe9: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x11f: Pop(0); PushNull((bool) Stack[-21] == 0)
0x120: IF (Stack[-1] == 0) GOTO 0x126; Pop(1)

0x121: PushEmpty(string)
0x122: Stack[-1] = "fdie" // @poff=0
0x123: Call 0x175

0x124: Pop(1)
0x125: GOTO 0x174

0x126: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x127: Pop(0)
...
0x137: Stack[-6] = "fdie" // @poff=0
0x138: GOTO 0x13a

0x139: Stack[-6] = "bdie" // @poff=22
...
0x140: @ StopAsync()
0x141: Pop(0)
0x142: Stack[-21] = Stack[-5]
0x143: Push("GetScriptProperty") // @poff=32
0x144: Push((int) 2)
0x145: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x146: IF (Stack[-1] == 0) GOTO 0x152; Pop(1)

0x147: Push("Owner") // @poff=68
0x148: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0x149: Pop(1)
0x14a: Push(Stack[-4])
0x14b: IF (Stack[-1] == 0) GOTO 0x152; Pop(1)

0x14c: Push("Owner") // @poff=68
0x14d: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0x14e: Pop(1)
0x14f: Pop(0); PushNull((bool) Stack[-5] == 0)
0x150: IF (Stack[-1] == 0) GOTO 0x152; Pop(1)

0x151: Stack[-21] = Stack[-5]
0x152: Push("@GetEyesHeight") // @poff=116
0x153: Push((int) 1)
0x154: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x155: IF (Stack[-1] == 0) GOTO 0x161; Pop(1)

0x156: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x157: Pop(0)
...
0x169: @ StopAsync()
0x16a: Pop(0)
0x16b: Push("head") // @poff=160
0x16c: @ UnlookAsync(Stack[-1])
0x16d: Pop(1)
0x16e: Push("all") // @poff=170
...
0x199: PushEmpty()
0x19a: Stack[-3] = (float) 0.07000000029802322
0x19b: Return(); Pop(0)
...
0x1a1: Push("all") // @poff=170
0x1a2: Push("attack_begin") // @poff=178
0x1a3: Push((int) 1)
0x1a4: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1af: Push("attack") // @poff=204
0x1b0: Push((int) 1)
0x1b1: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1cc: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x1cd: Pop(0)
0x1ce: Push(Stack[-22])
...
0x1de: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x1df: Pop(0)
...
0x202: Pop(1)
0x203: Push("all") // @poff=170
0x204: Push("attack_on") // @poff=288
...
0x227: Pop(0)
0x228: Push("all") // @poff=170
0x229: Push("fjump") // @poff=332
...
0x241: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=274
0x242: Pop(0)
...
0x260: Push("all") // @poff=170
0x261: Push("attack_off") // @poff=344
...
0x26d: Push((float)0.8999999761581421)
0x26e: Pop(1); Push(Stack[-9] * Stack[-1]);
0x26f: @ GetVictim(Stack[-1], Stack[-4])
0x270: Pop(1)
0x271: @ ReportAttack(Stack[-0]T)
0x272: Pop(0)
...
0x276: Stack[-6] = Stack[-2]
0x277: Stack[-10] = Stack[-1]
0x278: Call 0x199

0x279: Stack[-3] = Stack[-5]
0x27a: Pop(3)
0x27b: PushEmpty(float, object, float, int)
0x27c: Stack[-7] = Stack[-3]
0x27d: Stack[-6] = Stack[-2]
0x27e: PushEmpty(int, object, int)
0x27f: Stack[-10] = Stack[-2]
0x280: Stack[-14] = Stack[-1]
0x281: Call 0x19c

0x282: Stack[-3] = Stack[-4]
0x283: Pop(3)
0x284: Call 0x444

0x285: Stack[-4] = Stack[-5]
0x286: Pop(4)
0x287: PushEmpty(int)
0x288: Call 0x382

0x289: Pop(0)
0x28a: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x28b: Pop(1)
0x28c: PushEmpty(object, float)
0x28d: Stack[-5] = Stack[-2]
...
0x29c: Pop(1)
0x29d: Push("all") // @poff=170
0x29e: Push("attack_begin") // @poff=178
...
0x2b2: Stack[-7] = Stack[-2]
0x2b3: Stack[-4] = Stack[-1]
0x2b4: Call 0x26c

0x2b5: Pop(2)
0x2b6: Push("all") // @poff=170
0x2b7: Push("attack_middle") // @poff=366
...
0x2bd: Push("all") // @poff=170
0x2be: Push("attack_middle") // @poff=366
...
0x2d5: Pop(1)
0x2d6: Push("all") // @poff=170
0x2d7: Push("attack_end") // @poff=394
...
0x30f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=274
0x310: Pop(0)
...
0x345: @ Face(Stack[-0]T)
0x346: Pop(0)
0x347: Push("all") // @poff=170
0x348: Push("bjump") // @poff=416
0x349: @ PlayAnimation(Stack[-2], Stack[-1])
0x34a: Pop(2)
0x34b: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=274
0x34c: Pop(0)
...
0x375: @ irand(Stack[-1], Stack[-2]T)
0x376: Pop(0)
0x377: Push((int) 1)
0x378: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x379: Push("attack") // @poff=204
...
0x394: Stack[-17] = Stack[-7]
0x395: PushEmpty(bool, object)
0x396: Stack[-23] = Stack[-1]
0x397: Call 0x41d
...
0x39d: @@ GetPosition(Stack[-5]); Obj=21 // @poff=10
0x39e: Pop(0)
...
0x3b4: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=274
0x3b5: Pop(0)
...
0x3c6: Push((int) 0)
0x3c7: Push((float)0.30000001192092896)
...
0x3e9: Push((int) 0)
0x3ea: Push((float)0.30000001192092896)
...
0x424: Stack[-1] = "walk" // @poff=464
0x425: Return(); Pop(0)

0x426: Stack[-1] = "run" // @poff=474
0x427: Return(); Pop(0)
...
0x42c: Stack[-2] = "fire" // @poff=482
0x42d: Return(); Pop(0)

0x42e: Stack[-2] = "phys" // @poff=492
0x42f: Return(); Pop(0)

0x430: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x431: @ GetPosition(Stack[-3])
0x432: Pop(0)
0x433: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x434: Pop(0)
...
0x439: Push("HasProperty") // @poff=502
0x43a: Push((int) 2)
...
0x440: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=526
0x441: Pop(0)
0x442: Stack[-1] = Stack[-5]
0x443: Return(); Pop(2)

0x444: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x445: PushEmpty(bool, object, string)
0x446: Stack[-18] = Stack[-2]
0x447: Stack[-1] = "health" // @poff=538
0x448: Call 0x438
...
0x44f: Stack[-18] = Stack[-2]
0x450: Stack[-1] = "armor" // @poff=552
0x451: Call 0x438
...
0x457: Push("armor") // @poff=552
0x458: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=564
0x459: Pop(1)
0x45a: Push("armor_") // @poff=576
0x45b: PushEmpty(string, int)
0x45c: Stack[-16] = Stack[-1]
0x45d: Call 0x428

0x45e: Pop(1)
0x45f: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x460: PushEmpty(bool, object, string)
0x461: Stack[-18] = Stack[-2]
0x462: Stack[-8] = Stack[-1]
0x463: Call 0x438
...
0x469: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=564
0x46a: Pop(0)
...
0x471: Stack[-3] = Stack[-6]
0x472: Pop(3)
0x473: Push("health") // @poff=538
0x474: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=564
0x475: Pop(1)
0x476: Push((int) 1)
0x477: Pop(1); Push(Stack[-1] - Stack[-4]);
0x478: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x479: Push("health") // @poff=538
...
0x47f: Pop(3)
0x480: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=590
0x481: Pop(2)
0x482: Stack[-1] = Stack[-16]
0x483: Return(); Pop(12)

0x484: PushEmpty(bool, bool)
0x485: @@ IsDead(Stack[-1]); Obj=3 // @poff=602
0x486: Pop(0)
0x487: Stack[-1] = Stack[-4]
0x488: Return(); Pop(2)

0x489: PushEmpty(object, object, object, object)
0x48a: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x49e: Pop(0)
0x49f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4a0: IF (Stack[-1] == 0) GOTO 0x4a3; Pop(1)

0x4a1: Stack[-6] = (bool) 0
0x4a2: Return(); Pop(4)

0x4a3: @@ GetScene(Stack[-1]); Obj=5 // @poff=623
0x4a4: Pop(0)
...
0x4b8: Stack[-1] = "noaccess" // @poff=632
0x4b9: Call 0x438
...
0x4bf: Push("noaccess") // @poff=632
0x4c0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=564
0x4c1: Pop(1)
0x4c2: Push((int) 0)
...
0x4eb: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x4ec: Pop(0)
...
0x4fc: Stack[-1] = "fhit" // @poff=688
0x4fd: GOTO 0x4ff

0x4fe: Stack[-1] = "bhit" // @poff=698
0x4ff: Push("hit_react") // @poff=708
0x500: Push("1") // @poff=728
0x501: Pop(1); Push(Stack[-3] + Stack[-1]);
0x502: Push("2") // @poff=732
...
0x509: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x50a: Pop(0)
...
0x51f: Stack[-1] = Stack[-3] - Stack[-4]; Pop(0);
0x520: Stack[-5] = Stack[-1] | Stack[-1]; Pop(0);
0x521: Return(); Pop(2)

0x522: PushEmpty()
0x523: Pop(0); Push((bool) Stack[-2] < Stack[-1])
0x524: IF (Stack[-1] == 0) GOTO 0x527; Pop(1)

0x525: Stack[-2] = Stack[-3]
0x526: GOTO 0x528
...
0x529: PushEmpty()
0x52a: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x52b: IF (Stack[-1] == 0) GOTO 0x52e; Pop(1)

0x52c: Stack[-2] = Stack[-4]
0x52d: Return(); Pop(0)

0x52e: Pop(0); Push((bool) Stack[-3] > Stack[-1])
0x52f: IF (Stack[-1] == 0) GOTO 0x532; Pop(1)

0x530: Stack[-1] = Stack[-4]
0x531: Return(); Pop(0)

0x532: Stack[-3] = Stack[-4]
0x533: Return(); Pop(0)

0x534: PushEmpty()
0x535: PushEmpty(object)
0x536: Stack[-2] = Stack[-1]
0x537: Push(-1, 0); TaskCall(2)
0x538: Call 0xfd

0x539: Pop(-1, 0); TaskReturn
0x53a: Pop(1)
0x53b: Return(); Pop(0)

0x53c: PushEmpty(float, float)
0x53d: Push("health") // @poff=538
0x53e: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x53f: IF (Stack[-1] == 0) GOTO 0x548; Pop(1)

0x540: Push("health") // @poff=538
...
0x54f: PushEmpty()
0x550: PushEmpty(object, int, float)
0x551: Stack[-7] = Stack[-3]
0x552: Stack[-6] = Stack[-2]
0x553: Stack[-5] = Stack[-1]
0x554: Call 0x4c5

0x555: Pop(3)
0x556: Return(); Pop(0)

0x557: PushEmpty(string, string)
0x558: Stack[-1] = "idle" // @poff=736
0x559: Push(Stack[-3])
0x55a: IF (Stack[-1] == 0) GOTO 0x55c; Pop(1)

0x55b: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x55c: Stack[-1] = Stack[-4]
0x55d: Return(); Pop(2)

0x55e: PushEmpty(int, bool, int, bool)
0x55f: Stack[-2] = (int) 0
0x560: Push("all") // @poff=170
0x561: PushEmpty(string, int)
0x562: Stack[-5] = Stack[-1]
0x563: Call 0x557

0x564: Pop(1)
0x565: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x566: Pop(2)
...
0x56a: Push((int) 1)
0x56b: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x56c: GOTO 0x560
...
0x576: Pop(1)
0x577: Pop(0); Push((bool) Stack[-2] == 0)
0x578: IF (Stack[-1] == 0) GOTO 0x57a; Pop(1)

0x579: Return(); Pop(4)

0x57a: @ irand(Stack[-1], Stack[-2])
0x57b: Pop(0)
0x57c: Push("all") // @poff=170
0x57d: PushEmpty(string, int)
0x57e: Stack[-4] = Stack[-1]
0x57f: Call 0x557

0x580: Pop(1)
0x581: @ PlayAnimation(Stack[-2], Stack[-1])
0x582: Pop(2)
0x583: @ WaitForAnimEnd()
0x584: Pop(0)
0x585: Return(); Pop(4)
...
0x592: Stack[-2] = Stack[-1]
0x593: Push(-1, 5); TaskCall(3)
0x594: Call 0x191

0x595: Pop(-1, 5); TaskReturn
0x596: Pop(1)
0x597: Return(); Pop(0)

0x598: PushEmpty()
0x599: PushEmpty(int, object)
0x59a: Stack[-3] = Stack[-1]
0x59b: Call 0x586

0x59c: Stack[-2] = Stack[-4]
0x59d: Pop(2)
0x59e: Return(); Pop(0)
...
0x5a5: PushEmpty()
0x5a6: Push(-0, 0); TaskCall(0)
0x5a7: Call 0x0

0x5a8: Pop(-0, 0); TaskReturn
0x5a9: Pop(0)
0x5aa: Return(); Pop(0)
...
0x5be: PushEmpty(string, object, int, bool, string, object, int, bool)
0x5bf: Push(GlobalVars[0])
0x5c0: Stack[-1] = (bool) 0
0x5c1: GlobalVars[0] = Stack[-1]; Pop(1)
0x5c2: Push("guard_scene") // @poff=746
0x5c3: @ GetProperty(Stack[-1], Stack[-5])
0x5c4: Pop(1)
0x5c5: @ CreateInvItem(Stack[-3])
0x5c6: Pop(0)
0x5c7: Push("uni_key") // @poff=770
0x5c8: @ GetInvItemByName(Stack[-3], Stack[-1])
0x5c9: Pop(1)
0x5ca: @@ SetItemID(Stack[-2]); Obj=3 // @poff=786
0x5cb: Pop(0)
0x5cc: Push("key_scene_name") // @poff=796
0x5cd: @@ SetProperty(Stack[-1], Stack[-5]); Obj=4 // @poff=590
0x5ce: Pop(1)
0x5cf: Push((int) 0)
0x5d0: @ AddItem(Stack[-2], Stack[-4], Stack[-1])
0x5d1: Pop(1)
0x5d2: Return(); Pop(8)
...
0x5d7: @ WorkWithCorpse(Stack[-1])
0x5d8: Pop(0)
0x5d9: Return(); Pop(0)

0x5da: Return(); Pop(0)

0x5db: PushEmpty(string, bool, string, bool)
0x5dc: PushEmpty(bool, object, string)
0x5dd: Stack[-8] = Stack[-2]
0x5de: Stack[-1] = "class" // @poff=826
0x5df: Call 0x438
...
0x5e3: Stack[-7] = (bool) 0
0x5e4: Return(); Pop(4)

0x5e5: Push("class") // @poff=826
0x5e6: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=564
0x5e7: Pop(1)
0x5e8: Push("guard") // @poff=838
0x5e9: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0x5ea: IF (Stack[-1] == 0) GOTO 0x5ed; Pop(1)

0x5eb: Stack[-7] = (bool) 0
0x5ec: Return(); Pop(4)

0x5ed: @ CanSee(Stack[-1], Stack[-6])
0x5ee: Pop(0)
0x5ef: PushEmpty(bool)
0x5f0: Stack[-1] = (bool) 1
0x5f1: Push(Stack[-2])
0x5f2: IF (Stack[-1] == 1) GOTO 0x5fb; Pop(1)

0x5f3: PushEmpty(float, object)
0x5f4: Stack[-9] = Stack[-1]
0x5f5: Call 0x430

0x5f6: Pop(1)
0x5f7: Push((float)1000000.0)
0x5f8: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x5f9: IF (Stack[-1] == 1) GOTO 0x5fb; Pop(1)

0x5fa: Stack[-1] = (bool) 0
0x5fb: IF (Stack[-1] == 0) GOTO 0x5fe; Pop(1)

0x5fc: Stack[-7] = (bool) 1
0x5fd: Return(); Pop(4)

0x5fe: Stack[-7] = (bool) 0
0x5ff: Return(); Pop(4)

0x600: PushEmpty(object, object)
0x601: Push(GlobalVars[0])
0x602: Stack[-1] = (bool) 1
0x603: GlobalVars[0] = Stack[-1]; Pop(1)
0x604: Push((int) 50)
0x605: Push((int) 40)
0x606: @ SetRTEnvelope(Stack[-2], Stack[-1])
0x607: Pop(2)
0x608: @ GetScene(Stack[-1])
0x609: Pop(0)
0x60a: PushEmpty(object)
0x60b: Call 0x518

0x60c: Pop(0)
0x60d: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=850
0x60e: Pop(1)
0x60f: Return(); Pop(2)
