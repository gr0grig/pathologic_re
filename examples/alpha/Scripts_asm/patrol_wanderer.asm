...
Strings:
	...
	A:in
	A:add
// @pool_raw:
...
0xe1: Stack[-5] = Stack[-2]
0xe2: Stack[-4] = Stack[-1]
0xe3: Call 0x7c2
...
0x1d3: Stack[-17] = Stack[-7]
0x1d4: PushEmpty(bool, object)
0x1d5: Stack[-23] = Stack[-1]
0x1d6: Call 0x25c
...
0x1dc: @@ GetPosition(Stack[-5]); Obj=21 // @poff=18
0x1dd: Pop(0)
...
0x1f3: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=30
0x1f4: Pop(0)
...
0x205: Push((int) 0)
0x206: Push((float)0.30000001192092896)
...
0x228: Push((int) 0)
0x229: Push((float)0.30000001192092896)
...
0x260: Stack[-2] = Stack[-4]
0x261: Pop(2)
0x262: Return(); Pop(0)

0x263: Stack[-1] = "walk" // @poff=44
0x264: Return(); Pop(0)

0x265: Stack[-1] = "run" // @poff=54
0x266: Return(); Pop(0)

0x267: PushEmpty()
0x268: PushEmpty(object, bool, float)
0x269: Stack[-5] = Stack[-3]
0x26a: Stack[-4] = Stack[-2]
...
0x26f: PushEmpty()
0x270: Stack[-3] = (float) 0.10000000149011612
0x271: Return(); Pop(0)
...
0x284: Push("all") // @poff=0
0x285: Push("attack_begin") // @poff=62
0x286: Push((int) 1)
0x287: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x292: Push("attack") // @poff=88
0x293: Push((int) 1)
0x294: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2af: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x2b0: Pop(0)
0x2b1: Push(Stack[-22])
...
0x2c1: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=30
0x2c2: Pop(0)
...
0x2e5: Pop(1)
0x2e6: Push("all") // @poff=0
0x2e7: Push("attack_on") // @poff=158
...
0x2f3: Push((float)0.6000000238418579)
0x2f4: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x2f5: IF (Stack[-1] == 1) GOTO 0x2fb; Pop(1)

0x2f6: PushEmpty(bool)
0x2f7: Call 0x43a

0x2f8: Pop(0)
0x2f9: IF (Stack[-1] == 1) GOTO 0x2fb; Pop(1)

0x2fa: Stack[-1] = (bool) 0
0x2fb: IF (Stack[-1] == 0) GOTO 0x309; Pop(1)

0x2fc: @ Face(Stack[-0]T)
0x2fd: Pop(0)
0x2fe: Push("all") // @poff=0
0x2ff: Push("attack_stay") // @poff=178
0x300: @ PlayAnimation(Stack[-2], Stack[-1])
0x301: Pop(2)
0x302: PushEmpty(bool, float)
0x303: Stack[-23] = Stack[-1]
0x304: Call 0x3de
...
0x309: @ Face(Stack[-0]T)
0x30a: Pop(0)
0x30b: Push("all") // @poff=0
0x30c: Push("fjump") // @poff=202
...
0x324: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=30
0x325: Pop(0)
...
0x343: Push("all") // @poff=0
0x344: Push("attack_off") // @poff=214
...
0x395: Stack[-7] = Stack[-2]
0x396: Stack[-4] = Stack[-1]
0x397: Call 0x34f

0x398: Pop(2)
0x399: Push("all") // @poff=0
0x39a: Push("attack_middle") // @poff=236
...
0x3a1: Push("attack_middle") // @poff=236
...
0x3b8: Pop(1)
0x3b9: Push("all") // @poff=0
0x3ba: Push("attack_end") // @poff=264
...
0x3f2: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=30
0x3f3: Pop(0)
...
0x428: @ Face(Stack[-0]T)
0x429: Pop(0)
0x42a: Push("all") // @poff=0
0x42b: Push("bjump") // @poff=286
0x42c: @ PlayAnimation(Stack[-2], Stack[-1])
0x42d: Pop(2)
0x42e: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=30
0x42f: Pop(0)
...
0x458: @ irand(Stack[-1], Stack[-2]T)
0x459: Pop(0)
0x45a: Push((int) 1)
0x45b: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x45c: Push("attack") // @poff=88
...
0x473: Stack[-9] = Stack[-5]
0x474: Stack[-4] = "reputation" // @poff=334
0x475: Stack[-3] = (float) -0.30000001192092896
0x476: Stack[-2] = (int) 0
0x477: Stack[-1] = (int) 1
0x478: Call 0x528
...
0x49a: Pop(0); PushNull((bool) Stack[-21] == 0)
0x49b: IF (Stack[-1] == 0) GOTO 0x4a1; Pop(1)

0x49c: PushEmpty(string)
0x49d: Stack[-1] = "fdie" // @poff=356
0x49e: Call 0x4f0

0x49f: Pop(1)
0x4a0: GOTO 0x4ef

0x4a1: @@ GetPosition(Stack[-10]); Obj=21 // @poff=18
0x4a2: Pop(0)
...
0x4b2: Stack[-6] = "fdie" // @poff=356
0x4b3: GOTO 0x4b5

0x4b4: Stack[-6] = "bdie" // @poff=366
...
0x4bb: @ StopAsync()
0x4bc: Pop(0)
0x4bd: Stack[-21] = Stack[-5]
0x4be: Push("GetScriptProperty") // @poff=376
0x4bf: Push((int) 2)
0x4c0: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4c1: IF (Stack[-1] == 0) GOTO 0x4cd; Pop(1)

0x4c2: Push("Owner") // @poff=412
0x4c3: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=424
0x4c4: Pop(1)
0x4c5: Push(Stack[-4])
0x4c6: IF (Stack[-1] == 0) GOTO 0x4cd; Pop(1)

0x4c7: Push("Owner") // @poff=412
0x4c8: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=442
0x4c9: Pop(1)
0x4ca: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4cb: IF (Stack[-1] == 0) GOTO 0x4cd; Pop(1)

0x4cc: Stack[-21] = Stack[-5]
0x4cd: Push("@GetEyesHeight") // @poff=460
0x4ce: Push((int) 1)
0x4cf: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4d0: IF (Stack[-1] == 0) GOTO 0x4dc; Pop(1)

0x4d1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=490
0x4d2: Pop(0)
0x4d3: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x4d4: Push(CvectorIndex(Stack[-1], 1))
0x4d5: Stack[-3] = Stack[-1]
0x4d6: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x4d7: Push("head") // @poff=504
...
0x510: Stack[-2] = "fire" // @poff=514
0x511: Return(); Pop(0)

0x512: Stack[-2] = "phys" // @poff=524
0x513: Return(); Pop(0)

0x514: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x515: @ GetPosition(Stack[-3])
0x516: Pop(0)
0x517: @@ GetPosition(Stack[-2]); Obj=7 // @poff=18
0x518: Pop(0)
...
0x51d: Push("HasProperty") // @poff=534
0x51e: Push((int) 2)
...
0x524: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=558
0x525: Pop(0)
0x526: Stack[-1] = Stack[-5]
0x527: Return(); Pop(2)

0x528: PushEmpty(float, float)
0x529: PushEmpty(bool, object, string)
0x52a: Stack[-10] = Stack[-2]
0x52b: Stack[-9] = Stack[-1]
0x52c: Call 0x51c
...
0x532: @@ GetProperty(Stack[-6], Stack[-1]); Obj=7 // @poff=570
0x533: Pop(0)
0x534: PushEmpty(float, float, float, float)
0x535: Stack[-3] = Stack[-5] + Stack[-9]; Pop(0);
0x536: Stack[-8] = Stack[-2]
0x537: Stack[-7] = Stack[-1]
0x538: Call 0x619

0x539: Pop(3)
0x53a: @@ SetProperty(Stack[-7], Stack[-1]); Obj=8 // @poff=582
0x53b: Pop(1)
...
0x549: Stack[-18] = Stack[-2]
0x54a: Stack[-1] = "armor" // @poff=608
0x54b: Call 0x51c
...
0x551: Push("armor") // @poff=608
0x552: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=570
0x553: Pop(1)
0x554: Push("armor_") // @poff=620
...
0x563: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=570
0x564: Pop(0)
...
0x56b: Stack[-3] = Stack[-6]
0x56c: Pop(3)
0x56d: Push("health") // @poff=594
0x56e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=570
0x56f: Pop(1)
0x570: Push((int) 1)
0x571: Pop(1); Push(Stack[-1] - Stack[-4]);
0x572: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x573: Push("health") // @poff=594
...
0x579: Pop(3)
0x57a: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=582
0x57b: Pop(2)
0x57c: Stack[-1] = Stack[-16]
0x57d: Return(); Pop(12)

0x57e: PushEmpty(bool, bool)
0x57f: @@ IsDead(Stack[-1]); Obj=3 // @poff=634
0x580: Pop(0)
0x581: Stack[-1] = Stack[-4]
0x582: Return(); Pop(2)

0x583: PushEmpty(object, object, object, object)
0x584: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x598: Pop(0)
0x599: Pop(0); PushNull((bool) Stack[-2] == 0)
0x59a: IF (Stack[-1] == 0) GOTO 0x59d; Pop(1)

0x59b: Stack[-6] = (bool) 0
0x59c: Return(); Pop(4)

0x59d: @@ GetScene(Stack[-1]); Obj=5 // @poff=655
0x59e: Pop(0)
...
0x5b2: Stack[-1] = "noaccess" // @poff=664
0x5b3: Call 0x51c
...
0x5b9: Push("noaccess") // @poff=664
0x5ba: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=570
0x5bb: Pop(1)
0x5bc: Push((int) 0)
...
0x5e5: @@ GetPosition(Stack[-5]); Obj=23 // @poff=18
0x5e6: Pop(0)
...
0x5f6: Stack[-1] = "fhit" // @poff=720
0x5f7: GOTO 0x5f9

0x5f8: Stack[-1] = "bhit" // @poff=730
0x5f9: Push("hit_react") // @poff=740
0x5fa: Push("1") // @poff=760
0x5fb: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5fc: Push("2") // @poff=764
...
0x603: @@ GetPosition(Stack[-3]); Obj=7 // @poff=18
0x604: Pop(0)
...
0x64e: Push("GenerateMoney: iMin > iMax") // @poff=778
0x64f: @ Trace(Stack[-1])
0x650: Pop(1)
0x651: Return(); Pop(8)
...
0x683: Stack[-1] = "bottle_water" // @poff=844
0x684: Call 0x731
...
0x69f: Stack[-1] = "bandage" // @poff=880
0x6a0: Call 0x731
...
0x6ad: Stack[-1] = "tourniquet" // @poff=896
0x6ae: Call 0x731
...
0x6e8: Stack[-1] = "alpha_pills" // @poff=954
0x6e9: Call 0x731
...
0x6f9: Stack[-1] = "beta_pills" // @poff=978
0x6fa: Call 0x731
...
0x70a: Stack[-1] = "gamma_pills" // @poff=1000
0x70b: Call 0x731
...
0x71b: Stack[-1] = "revolver_ammo" // @poff=1024
0x71c: Call 0x731
...
0x729: Stack[-1] = "rifle_ammo" // @poff=1052
0x72a: Call 0x731
...
0x747: @@ in(Stack[-3], Stack[-6]); Obj=1 // @poff=1074
0x748: Pop(1)
0x749: Push(Stack[-2])
...
0x74e: Stack[-8] = Stack[-2]
0x74f: Stack[-1] = "reputation" // @poff=334
0x750: Call 0x51c
...
0x756: Push("reputation") // @poff=334
0x757: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=570
0x758: Pop(1)
0x759: Push((float)0.10000000149011612)
...
0x766: Stack[-2] = Stack[-6]
0x767: Pop(2)
0x768: Return(); Pop(2)

0x769: PushEmpty()
0x76a: PushEmpty(object)
0x76b: Stack[-2] = Stack[-1]
...
0x773: Stack[-3] = Stack[-1]
0x774: Call 0x73d

0x775: Stack[-2] = Stack[-4]
0x776: Pop(2)
0x777: Return(); Pop(0)

0x778: PushEmpty()
0x779: PushEmpty(object, bool)
0x77a: Stack[-3] = Stack[-2]
...
0x7a9: Stack[-7] = Stack[-3]
0x7aa: Stack[-6] = Stack[-2]
0x7ab: Stack[-5] = Stack[-1]
0x7ac: Call 0x5bf
...
0x7c5: Stack[-1] = "reputation" // @poff=334
0x7c6: Call 0x51c
...
0x7cc: Push("reputation") // @poff=334
0x7cd: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=570
0x7ce: Pop(1)
...
0x7d8: Push(Stack[-2])
0x7d9: IF (Stack[-1] == 1) GOTO 0x7e2; Pop(1)

0x7da: PushEmpty(float, object)
0x7db: Stack[-9] = Stack[-1]
0x7dc: Call 0x514
...
0x7e3: Push((float)-0.20000000298023224)
