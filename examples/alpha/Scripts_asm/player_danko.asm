...
Strings:
	...
	W:vcharge
	W:people.xml
// @pool_raw:
...
0x32: Stack[-2] = "armor_phys" // @poff=32
...
0x49: Stack[-2] = "armor_phys" // @poff=32
...
0x5a: Pop(0)
0x5b: IF (Stack[-1] == 1) GOTO 0x29; Pop(1)
...
0x79: Push("hitblock") // @poff=90
0x7a: @ PlayAnimation(Stack[-1])
0x7b: Pop(1)
0x7c: Return(); Pop(0)

0x7d: Stack[-1] = "punch" // @poff=108
0x7e: Return(); Pop(0)
...
0x82: Stack[-2] = (float) 0.4000000059604645
0x83: GOTO 0x85

0x84: Stack[-2] = (float) 0.20000000298023224
0x85: Return(); Pop(0)
...
0x8f: Push("attack") // @poff=120
0x90: Pop(1); Push(Stack[-1] + Stack[-15]);
0x91: Push("_phase1") // @poff=134
...
0xc3: Push("GetDirection") // @poff=150
0xc4: Push((int) 1)
...
0xc8: Pop(0)
0xc9: @@ GetDirection(Stack[-4]); Obj=7 // @poff=176
0xca: Pop(0)
0xcb: PushEmpty(float, cvector, cvector)
0xcc: Stack[-8] = Stack[-2]
0xcd: Stack[-7] = Stack[-1]
0xce: Call 0xb0f

0xcf: Pop(2)
0xd0: Push((float)0.4999999701976776)
0xd1: Stack[-8] = Stack[-2] >= Stack[-1]; Pop(2);
0xd2: GOTO 0xd4

0xd3: Stack[-6] = (bool) 0
0xd4: PushEmpty(float, bool)
0xd5: Stack[-8] = Stack[-1]
0xd6: Call 0x10d

0xd7: Stack[-2] = Stack[-5]
0xd8: Pop(2)
0xd9: PushEmpty(float, object, float, int)
0xda: Stack[-11] = Stack[-3]
0xdb: Stack[-7] = Stack[-2]
0xdc: PushEmpty(int)
0xdd: Call 0x86
...
0x10a: Pop(0)
0x10b: IF (Stack[-1] == 1) GOTO 0x9e; Pop(1)
...
0x131: Pop(0)
0x132: Stack[-1] = Stack[-3]
0x133: Return(); Pop(2)

0x134: Stack[-1] = "scalpel" // @poff=215
0x135: Return(); Pop(0)
...
0x139: Stack[-2] = (float) 0.20000000298023224
0x13a: GOTO 0x13c

0x13b: Stack[-2] = (float) 0.4000000059604645
0x13c: Return(); Pop(0)
...
0x160: Push("attack") // @poff=120
0x161: Pop(1); Push(Stack[-1] + Stack[-15]);
0x162: Push("_phase1") // @poff=134
...
0x194: Push("GetDirection") // @poff=150
0x195: Push((int) 1)
...
0x199: Pop(0)
0x19a: @@ GetDirection(Stack[-4]); Obj=7 // @poff=176
0x19b: Pop(0)
0x19c: PushEmpty(float, cvector, cvector)
0x19d: Stack[-8] = Stack[-2]
0x19e: Stack[-7] = Stack[-1]
0x19f: Call 0xb0f

0x1a0: Pop(2)
0x1a1: Push((float)0.4999999701976776)
0x1a2: Stack[-8] = Stack[-2] >= Stack[-1]; Pop(2);
0x1a3: GOTO 0x1a5

0x1a4: Stack[-6] = (bool) 0
0x1a5: PushEmpty(float, bool)
0x1a6: Stack[-8] = Stack[-1]
0x1a7: Call 0x145

0x1a8: Stack[-2] = Stack[-5]
0x1a9: Pop(2)
0x1aa: PushEmpty(float, object, float, int)
0x1ab: Stack[-11] = Stack[-3]
0x1ac: Stack[-7] = Stack[-2]
0x1ad: PushEmpty(int)
0x1ae: Call 0x141
...
0x1db: Pop(0)
0x1dc: IF (Stack[-1] == 1) GOTO 0x16f; Pop(1)
...
0x202: Stack[-2] = (float) 0.6000000238418579
0x203: GOTO 0x205

0x204: Stack[-2] = (float) 0.30000001192092896
0x205: Return(); Pop(0)
...
0x229: Push("attack") // @poff=120
0x22a: Pop(1); Push(Stack[-1] + Stack[-15]);
0x22b: Push("_phase1") // @poff=134
...
0x25d: Push("GetDirection") // @poff=150
0x25e: Push((int) 1)
...
0x2a4: Pop(0)
0x2a5: IF (Stack[-1] == 1) GOTO 0x238; Pop(1)
...
0x2cb: Stack[-2] = (float) 0.30000001192092896
0x2cc: GOTO 0x2ce

0x2cd: Stack[-2] = (float) 0.30000001192092896
0x2ce: Return(); Pop(0)
...
0x2f2: Push("attack") // @poff=120
0x2f3: Pop(1); Push(Stack[-1] + Stack[-15]);
0x2f4: Push("_phase1") // @poff=134
...
0x326: Push("GetDirection") // @poff=150
0x327: Push((int) 1)
...
0x32b: Pop(0)
0x32c: @@ GetDirection(Stack[-4]); Obj=7 // @poff=176
0x32d: Pop(0)
0x32e: PushEmpty(float, cvector, cvector)
0x32f: Stack[-8] = Stack[-2]
0x330: Stack[-7] = Stack[-1]
0x331: Call 0xb0f

0x332: Pop(2)
0x333: Push((float)0.4999999701976776)
...
0x33d: Stack[-11] = Stack[-3]
0x33e: Stack[-7] = Stack[-2]
0x33f: PushEmpty(int)
0x340: Call 0x2d3
...
0x36d: Pop(0)
0x36e: IF (Stack[-1] == 1) GOTO 0x301; Pop(1)
...
0x394: Stack[-2] = (float) 0.30000001192092896
0x395: GOTO 0x397

0x396: Stack[-2] = (float) 0.20000000298023224
0x397: Return(); Pop(0)
...
0x3bb: Push("attack") // @poff=120
0x3bc: Pop(1); Push(Stack[-1] + Stack[-15]);
0x3bd: Push("_phase1") // @poff=134
...
0x3ef: Push("GetDirection") // @poff=150
0x3f0: Push((int) 1)
...
0x3f4: Pop(0)
0x3f5: @@ GetDirection(Stack[-4]); Obj=7 // @poff=176
0x3f6: Pop(0)
0x3f7: PushEmpty(float, cvector, cvector)
0x3f8: Stack[-8] = Stack[-2]
0x3f9: Stack[-7] = Stack[-1]
0x3fa: Call 0xb0f

0x3fb: Pop(2)
0x3fc: Push((float)0.4999999701976776)
0x3fd: Stack[-8] = Stack[-2] >= Stack[-1]; Pop(2);
0x3fe: GOTO 0x400

0x3ff: Stack[-6] = (bool) 0
0x400: PushEmpty(float, bool)
0x401: Stack[-8] = Stack[-1]
0x402: Call 0x3a0

0x403: Stack[-2] = Stack[-5]
0x404: Pop(2)
0x405: PushEmpty(float, object, float, int)
0x406: Stack[-11] = Stack[-3]
0x407: Stack[-7] = Stack[-2]
0x408: PushEmpty(int)
0x409: Call 0x39c
...
0x436: Pop(0)
0x437: IF (Stack[-1] == 1) GOTO 0x3ca; Pop(1)
...
0x476: Stack[-1] = (float) 0.01745329238474369
0x477: Return(); Pop(0)

0x478: PushEmpty(bool, bool)
0x479: Push("ammo") // @poff=269
0x47a: Push((bool) 0)
...
0x47f: Stack[-2] = "rifle_ammo" // @poff=279
0x480: Stack[-1] = (int) 1
0x481: Call 0xb26
...
0x4a5: Pop(1)
0x4a6: Stack[-18] = "attack1" // @poff=343
0x4a7: Push((bool) 1)
...
0x4e0: Stack[-13] = Stack[-3]
0x4e1: Stack[-19] = Stack[-2]
0x4e2: PushEmpty(int)
0x4e3: Call 0x495
...
0x4e7: Stack[-4] = Stack[-10]
0x4e8: Pop(4)
0x4e9: Push(Stack[-6])
0x4ea: IF (Stack[-1] == 0) GOTO 0x4f3; Pop(1)

0x4eb: @@ add(Stack[-9]); Obj=12 // @poff=371
0x4ec: Pop(0)
0x4ed: PushEmpty(int)
0x4ee: Call 0x497
...
0x4f9: Pop(0)
0x4fa: Push("scripted") // @poff=375
0x4fb: Push(CVector(0.0, 0.0, 1.0))
0x4fc: Push("richochet.xml") // @poff=393
0x4fd: @ AddActorByType(Stack[-7], Stack[-3], Stack[-8], Stack[-10], Stack[-2], Stack[-1])
0x4fe: Pop(3)
0x4ff: Push("Material") // @poff=421
0x500: @@ SetScriptProperty(Stack[-1], Stack[-9]); Obj=5 // @poff=439
0x501: Pop(1)
...
0x509: @@ iterator(Stack[-3]); Obj=12 // @poff=457
0x50a: Pop(0)
0x50b: @@ Next(Stack[-1], Stack[-2]); Obj=3 // @poff=466
0x50c: Pop(0)
0x50d: Push(Stack[-1])
...
0x525: Pop(0)
0x526: IF (Stack[-1] == 1) GOTO 0x49b; Pop(1)
...
0x566: Stack[-1] = (float) 0.02617993950843811
0x567: Return(); Pop(0)

0x568: PushEmpty(bool, int, bool, int)
0x569: Push("ammo") // @poff=269
0x56a: @ GetWeaponProperty(Stack[-3], Stack[-1], Stack[-2])
0x56b: Pop(1)
0x56c: Push("ammo") // @poff=269
0x56d: Push((int) 1)
...
0x591: Stack[-1] = "revolver" // @poff=499
0x592: Return(); Pop(0)

0x593: Stack[-1] = (float) 0.800000011920929
0x594: Return(); Pop(0)
...
0x5a5: Pop(1)
0x5a6: Stack[-18] = "attack1" // @poff=343
0x5a7: Push((bool) 1)
...
0x5e0: Stack[-13] = Stack[-3]
0x5e1: Stack[-19] = Stack[-2]
0x5e2: PushEmpty(int)
0x5e3: Call 0x595
...
0x5e7: Stack[-4] = Stack[-10]
0x5e8: Pop(4)
0x5e9: Push(Stack[-6])
0x5ea: IF (Stack[-1] == 0) GOTO 0x5f3; Pop(1)

0x5eb: @@ add(Stack[-9]); Obj=12 // @poff=371
0x5ec: Pop(0)
0x5ed: PushEmpty(int)
0x5ee: Call 0x597
...
0x5f9: Pop(0)
0x5fa: Push("scripted") // @poff=375
0x5fb: Push(CVector(0.0, 0.0, 1.0))
0x5fc: Push("richochet.xml") // @poff=393
0x5fd: @ AddActorByType(Stack[-7], Stack[-3], Stack[-8], Stack[-10], Stack[-2], Stack[-1])
0x5fe: Pop(3)
0x5ff: Push("Material") // @poff=421
0x600: @@ SetScriptProperty(Stack[-1], Stack[-9]); Obj=5 // @poff=439
0x601: Pop(1)
...
0x609: @@ iterator(Stack[-3]); Obj=12 // @poff=457
0x60a: Pop(0)
0x60b: @@ Next(Stack[-1], Stack[-2]); Obj=3 // @poff=466
0x60c: Pop(0)
0x60d: Push(Stack[-1])
...
0x625: Pop(0)
0x626: IF (Stack[-1] == 1) GOTO 0x59b; Pop(1)
...
0x666: Stack[-1] = (float) 0.1745329350233078
0x667: Return(); Pop(0)

0x668: PushEmpty(bool, int, bool, int)
0x669: Push("ammo") // @poff=269
0x66a: @ GetWeaponProperty(Stack[-3], Stack[-1], Stack[-2])
0x66b: Pop(1)
0x66c: Push("ammo") // @poff=269
0x66d: Push((int) 1)
...
0x691: Stack[-1] = "samopal" // @poff=543
0x692: Return(); Pop(0)

0x693: Stack[-1] = (float) 0.800000011920929
0x694: Return(); Pop(0)
...
0x6a5: Pop(1)
0x6a6: Stack[-18] = "attack1" // @poff=343
0x6a7: Push((bool) 1)
...
0x6e0: Stack[-13] = Stack[-3]
0x6e1: Stack[-19] = Stack[-2]
0x6e2: PushEmpty(int)
0x6e3: Call 0x695
...
0x6e7: Stack[-4] = Stack[-10]
0x6e8: Pop(4)
0x6e9: Push(Stack[-6])
0x6ea: IF (Stack[-1] == 0) GOTO 0x6f3; Pop(1)

0x6eb: @@ add(Stack[-9]); Obj=12 // @poff=371
0x6ec: Pop(0)
0x6ed: PushEmpty(int)
0x6ee: Call 0x697
...
0x6f9: Pop(0)
0x6fa: Push("scripted") // @poff=375
0x6fb: Push(CVector(0.0, 0.0, 1.0))
0x6fc: Push("richochet.xml") // @poff=393
0x6fd: @ AddActorByType(Stack[-7], Stack[-3], Stack[-8], Stack[-10], Stack[-2], Stack[-1])
0x6fe: Pop(3)
0x6ff: Push("Material") // @poff=421
0x700: @@ SetScriptProperty(Stack[-1], Stack[-9]); Obj=5 // @poff=439
0x701: Pop(1)
...
0x709: @@ iterator(Stack[-3]); Obj=12 // @poff=457
0x70a: Pop(0)
0x70b: @@ Next(Stack[-1], Stack[-2]); Obj=3 // @poff=466
0x70c: Pop(0)
0x70d: Push(Stack[-1])
...
0x725: Pop(0)
0x726: IF (Stack[-1] == 1) GOTO 0x69b; Pop(1)
...
0x755: Pop(0)
0x756: Push("flame") // @poff=559
0x757: Push(CVector(0.0, 0.0, 0.0))
0x758: @ AddActorByType(Stack[-0]T, Stack[-2], Stack[-4], Stack[-1])
0x759: Pop(2)
0x75a: PushEmpty(object)
0x75b: Call 0xad3

0x75c: Pop(0)
0x75d: Push("flame") // @poff=559
0x75e: @@@ Attach(Stack[-2], Stack[-1]); Obj=0 // @poff=571
0x75f: Pop(2)
0x760: Push((float)0.8333333134651184)
0x761: @@@ SetLength(Stack[-1]); Obj=0 // @poff=578
0x762: Pop(1)
0x763: Push((int) 20)
0x764: Push((float)0.10000000149011612)
0x765: @ SetTimer(Stack[-2], Stack[-1])
0x766: Pop(2)
0x767: Push("attack") // @poff=120
...
0x771: @@@ GetActualLength(Stack[-1]); Obj=0 // @poff=588
0x772: Pop(0)
0x773: Push((float)0.01666666753590107)
...
0x784: Pop(1)
0x785: @ RemoveActor(Stack[-0]T)
0x786: Pop(0)
0x787: Push("flame") // @poff=559
...
0x79c: @ RemoveActor(Stack[-0]T)
0x79d: Pop(0)
0x79e: Push("flame") // @poff=559
...
0x7b2: Push((float)0.8333333134651184)
0x7b3: @@@ SetLength(Stack[-1]); Obj=0 // @poff=578
0x7b4: Pop(1)
0x7b5: Return(); Pop(0)
...
0x7bc: @@@ SetLength(Stack[-1]); Obj=0 // @poff=578
0x7bd: Pop(1)
0x7be: Return(); Pop(0)
...
0x7d6: @@@ Intersect(Stack[-9], Stack[-8]); Obj=0 // @poff=604
0x7d7: Pop(0)
0x7d8: Pop(0); Push((bool) Stack[1 + Tasks[-1].StackPointer] == 0)
0x7d9: IF (Stack[-1] == 0) GOTO 0x7e1; Pop(1)

0x7da: PushEmpty(float, float, float)
0x7db: Stack[-11] = Stack[-2]
0x7dc: Stack[-1] = (float) 0.8333333134651184
0x7dd: Call 0xad9

0x7de: Pop(2)
0x7df: @@@ SetLength(Stack[-1]); Obj=0 // @poff=578
0x7e0: Pop(1)
0x7e1: PushEmpty(float)
0x7e2: Call 0x858

0x7e3: Stack[-1] = Stack[-8]
0x7e4: Pop(1)
0x7e5: Stack[-6] = (bool) 0
0x7e6: @@ Next(Stack[-4], Stack[-5]); Obj=9 // @poff=466
0x7e7: Pop(0)
0x7e8: Push(Stack[-4])
...
0x7f7: Stack[-9] = Stack[-3]
0x7f8: Stack[-11] = Stack[-2]
0x7f9: PushEmpty(int)
0x7fa: Call 0x85a
...
0x7fe: Stack[-4] = Stack[-7]
0x7ff: Pop(4)
0x800: PushEmpty(bool, object, string)
0x801: Stack[-8] = Stack[-2]
0x802: Stack[-1] = "disease" // @poff=614
0x803: Call 0xa59

0x804: Pop(2)
0x805: IF (Stack[-1] == 0) GOTO 0x813; Pop(1)

0x806: Push("disease") // @poff=614
0x807: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=630
0x808: Pop(1)
0x809: Push((float)0.10000000149011612)
...
0x80e: Push((float)0.10000000149011612)
0x80f: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0x810: Push("disease") // @poff=614
0x811: @@ SetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=642
0x812: Pop(1)
0x813: PushEmpty(bool, object, string)
0x814: Stack[-8] = Stack[-2]
0x815: Stack[-1] = "fire" // @poff=654
0x816: Call 0xa59

0x817: Pop(2)
0x818: IF (Stack[-1] == 0) GOTO 0x821; Pop(1)

0x819: Push("fire") // @poff=654
0x81a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=630
0x81b: Pop(1)
0x81c: Push("fire") // @poff=654
0x81d: Push((float)0.10000000149011612)
0x81e: Pop(1); Push(Stack[-3] + Stack[-1]);
0x81f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=642
0x820: Pop(2)
...
0x835: Push((float)0.10000000149011612)
...
0x83d: Stack[-1] = Stack[-4]
0x83e: Pop(1)
0x83f: Stack[-11] = Stack[-2]
0x840: PushEmpty(int)
0x841: Call 0x85a
...
0x850: Push("ognemet_ammo") // @poff=664
0x851: @ GetInvItemByName(Stack[-3], Stack[-1])
0x852: Pop(1)
0x853: Push((int) 1)
0x854: @ RemoveItemByType(Stack[-2], Stack[-3], Stack[-1])
0x855: Pop(1)
0x856: Stack[-1] = Stack[-5]
0x857: Return(); Pop(4)

0x858: Stack[-1] = (float) 0.06499999761581421
0x859: Return(); Pop(0)
...
0x87a: Pop(0)
0x87b: Push("scripted") // @poff=375
0x87c: Push(CVector(0.0, 0.0, 1.0))
0x87d: Push("player_grenade.xml") // @poff=690
0x87e: @ AddActorByType(Stack[-6], Stack[-3], Stack[-7], Stack[-9], Stack[-2], Stack[-1])
0x87f: Pop(3)
0x880: Push("Owner") // @poff=728
0x881: PushEmpty(object)
0x882: Call 0xad3

0x883: Pop(0)
0x884: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=439
0x885: Pop(2)
0x886: Push("StartVelocity") // @poff=740
0x887: Push((int) 1000)
0x888: Pop(1); Push(Stack[-9] * Stack[-1]);
0x889: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=439
0x88a: Pop(2)
0x88b: Push("DamageAmount") // @poff=768
0x88c: PushEmpty(float)
0x88d: Call 0x8c6

0x88e: Pop(0)
0x88f: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=439
0x890: Pop(2)
0x891: Push("DamageType") // @poff=794
0x892: PushEmpty(int)
0x893: Call 0x8c8

0x894: Pop(0)
0x895: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=439
0x896: Pop(2)
0x897: Push("bottle_weapon") // @poff=816
...
0x8aa: Push("aunholster") // @poff=860
...
0x8d9: Stack[-10] = Stack[-2]
0x8da: Stack[-1] = "lp" // @poff=902
0x8db: Call 0xa59

0x8dc: Pop(2)
0x8dd: IF (Stack[-1] == 0) GOTO 0x905; Pop(1)

0x8de: Push("lp") // @poff=902
0x8df: @@ GetProperty(Stack[-1], Stack[-6]); Obj=8 // @poff=630
0x8e0: Pop(1)
0x8e1: Push(Stack[-5])
0x8e2: IF (Stack[-1] == 0) GOTO 0x905; Pop(1)

0x8e3: Push("locked") // @poff=908
0x8e4: @@ GetProperty(Stack[-1], Stack[-5]); Obj=8 // @poff=630
0x8e5: Pop(1)
0x8e6: Push(Stack[-4])
0x8e7: IF (Stack[-1] == 0) GOTO 0x905; Pop(1)

0x8e8: Stack[-6] = (bool) 1
0x8e9: Push("locked") // @poff=908
0x8ea: Push((bool) 0)
0x8eb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=9 // @poff=642
0x8ec: Pop(2)
0x8ed: Stack[-2] = (int) 0
0x8ee: Push("uses") // @poff=922
...
0x907: Push("use_success") // @poff=932
0x908: @ PlayAnimation(Stack[-1])
0x909: Pop(1)
0x90a: GOTO 0x90e

0x90b: Push("use_fail") // @poff=956
...
0x9aa: Push("effects") // @poff=1034
0x9ab: @ HasProperty(Stack[-1], Stack[-5])
0x9ac: Pop(1)
0x9ad: Pop(0); Push((bool) Stack[-4] == 0)
0x9ae: IF (Stack[-1] == 0) GOTO 0x9c5; Pop(1)

0x9af: Push("effects") // @poff=1034
0x9b0: Push((bool) 1)
0x9b1: @ SetProperty(Stack[-2], Stack[-1])
0x9b2: Pop(2)
0x9b3: Push("player_disease.bin") // @poff=1050
0x9b4: @ ApplyEffect(Stack[-1])
0x9b5: Pop(1)
0x9b6: Push("player_stat.bin") // @poff=1088
0x9b7: @ ApplyEffect(Stack[-1])
0x9b8: Pop(1)
0x9b9: Push("player_hit.bin") // @poff=1120
0x9ba: @ ApplyEffect(Stack[-1])
0x9bb: Pop(1)
0x9bc: Push("player_head.bin") // @poff=1150
0x9bd: @ ApplyEffect(Stack[-1])
0x9be: Pop(1)
0x9bf: Push("player_flashlight.bin") // @poff=1182
0x9c0: @ ApplyEffect(Stack[-1])
0x9c1: Pop(1)
0x9c2: Push("player_visir.bin") // @poff=1226
...
0x9e0: Push((float)0.10000000149011612)
0x9e1: @ Sleep(Stack[-1])
0x9e2: Pop(1)
0x9e3: GOTO 0x9d2
...
0xa55: Stack[-2] = "fire" // @poff=654
0xa56: Return(); Pop(0)

0xa57: Stack[-2] = "phys" // @poff=44
0xa58: Return(); Pop(0)

0xa59: PushEmpty(bool, bool)
0xa5a: Push("HasProperty") // @poff=1294
0xa5b: Push((int) 2)
...
0xa61: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=1318
0xa62: Pop(0)
...
0xa77: Stack[-10] = Stack[-2]
0xa78: Stack[-9] = Stack[-1]
0xa79: Call 0xae0
...
0xa81: Stack[-18] = Stack[-2]
0xa82: Stack[-1] = "health" // @poff=1260
0xa83: Call 0xa59
...
0xa8a: Stack[-18] = Stack[-2]
0xa8b: Stack[-1] = "armor" // @poff=1330
0xa8c: Call 0xa59
...
0xa92: Push("armor") // @poff=1330
0xa93: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=630
0xa94: Pop(1)
0xa95: Push("armor_") // @poff=1342
0xa96: PushEmpty(string, int)
0xa97: Stack[-16] = Stack[-1]
0xa98: Call 0xa51

0xa99: Pop(1)
0xa9a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0xa9b: PushEmpty(bool, object, string)
0xa9c: Stack[-18] = Stack[-2]
0xa9d: Stack[-8] = Stack[-1]
0xa9e: Call 0xa59
...
0xaa4: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=630
0xaa5: Pop(0)
...
0xaac: Stack[-3] = Stack[-6]
0xaad: Pop(3)
0xaae: Push("health") // @poff=1260
0xaaf: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=630
0xab0: Pop(1)
0xab1: Push((int) 1)
0xab2: Pop(1); Push(Stack[-1] - Stack[-4]);
0xab3: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0xab4: Push("health") // @poff=1260
...
0xaba: Pop(3)
0xabb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=642
0xabc: Pop(2)
0xabd: Stack[-1] = Stack[-16]
0xabe: Return(); Pop(12)
...
0xacf: Stack[-2] = "ground" // @poff=1378
0xad0: Return(); Pop(0)

0xad1: Stack[-2] = "stone" // @poff=1392
0xad2: Return(); Pop(0)

0xad3: PushEmpty(object, object)
0xad4: @ self(Stack[-1])
0xad5: Pop(0)
0xad6: Stack[-1] = Stack[-3]
0xad7: Return(); Pop(2)
...
0xb3f: Push("durability") // @poff=1422
...
0xb4a: Push("durability") // @poff=1422
...
0xb54: Stack[-4] = Stack[-5]
0xb55: Pop(4)
0xb56: GOTO 0xb58

0xb57: Stack[-1] = (int) 100
0xb58: Push("durability") // @poff=1422
...
0xb6c: Stack[-9] = Stack[-1]
0xb6d: Call 0xabf

0xb6e: Stack[-2] = Stack[-8]
0xb6f: Pop(2)
0xb70: Stack[-5] = (int) 0
0xb71: Push("step_") // @poff=1444
...
0xba8: Pop(0)
0xba9: Push("player_death") // @poff=1456
0xbaa: Push("play_death_danko.bin") // @poff=1482
...
0xbbc: Pop(0)
0xbbd: Push((int) 11)
0xbbe: Push((float)0.15000000596046448)
...
0xbd1: Pop(0)
0xbd2: Push((int) 10)
0xbd3: Push((float)0.3499999940395355)
...
0xc01: @@ in(Stack[-2], Stack[-5]); Obj=1 // @poff=1532
0xc02: Pop(1)
0xc03: Push(Stack[-1])
...
0xc07: @@ add(Stack[-5]); Obj=1 // @poff=371
0xc08: Pop(1)
0xc09: PushEmpty(bool, string, float, float, float)
0xc0a: Stack[-4] = "reputation" // @poff=1535
0xc0b: Stack[-8] = Stack[-3]
0xc0c: Stack[-2] = (int) 0
0xc0d: Stack[-1] = (int) 1
0xc0e: Call 0xa6c
...
0xc30: Push((float)0.003499999875202775)
...
0xc36: Pop(1)
0xc37: Stack[-6] = Stack[-2]
0xc38: Stack[-1] = (int) 0
0xc39: Call 0xa7f

0xc3a: Stack[-4] = Stack[-5]
0xc3b: Pop(4)
...
0xc50: Pop(0)
0xc51: Pop(0); PushNull((bool) Stack[-12] == 0)
0xc52: IF (Stack[-1] == 0) GOTO 0xc57; Pop(1)

0xc53: Push("Can't find main outdoor oscene") // @poff=1557
0xc54: @ Trace(Stack[-1])
0xc55: Pop(1)
0xc56: Return(); Pop(24)

0xc57: @@ GetMap(Stack[-10]); Obj=12 // @poff=1619
0xc58: Pop(0)
0xc59: Pop(0); PushNull((bool) Stack[-10] == 0)
0xc5a: IF (Stack[-1] == 0) GOTO 0xc5f; Pop(1)

0xc5b: Push("Can't find map") // @poff=1626
0xc5c: @ Trace(Stack[-1])
0xc5d: Pop(1)
0xc5e: Return(); Pop(24)
...
0xc64: @@ GetName(Stack[-8]); Obj=11 // @poff=1656
0xc65: Pop(0)
0xc66: Push("pt_gmap_") // @poff=1664
0xc67: Pop(1); Push(Stack[-1] + Stack[-9]);
0xc68: @@ GetLocator(Stack[-1], Stack[-8], Stack[-10], Stack[-7]); Obj=13 // @poff=1682
0xc69: Pop(1)
0xc6a: Pop(0); Push((bool) Stack[-7] == 0)
0xc6b: IF (Stack[-1] == 0) GOTO 0xc71; Pop(1)

0xc6c: Push("FIXME: No map locator for scene : ") // @poff=1693
...
0xc73: @@ SetMapParams(Stack[-2], Stack[-1]); Obj=12 // @poff=1763
0xc74: Pop(2)
...
0xc96: Pop(1)
0xc97: Push("flashlight_off") // @poff=1776
...
0xca1: Pop(1)
0xca2: Push("flashlight_on") // @poff=1806
0xca3: @ PlaySound(Stack[-1])
0xca4: Pop(1)
0xca5: GOTO 0xca9

0xca6: Push("flashlight_nofuel") // @poff=1834
...
0xccc: Push("people.xml") // @poff=1898
0xccd: Push((bool) 1)
