...
Strings:
	...
	W:kerosene
	W:sleeping
// @pool_raw:66006c006100730068006c0069006700680074005f006f006600660000006b00650072006f00730065006e006500000073006c0065006500700069006e0067000000
...
0x20: Push((float)0.9200000166893005)
0x21: Push((float)1.0)
0x22: @ rand(Stack[-6], Stack[-2], Stack[-1])
0x23: Pop(2)
0x24: Push(CVector(0.480392187833786, 0.4333333671092987, 0.29019609093666077))
0x25: Pop(1); Push(Stack[-1] * Stack[-5]);
0x26: @ SetFlashlightColor(Stack[-1])
0x27: Pop(1)
0x28: Push((float)0.07500000298023224)
0x29: Push((float)0.10000000149011612)
...
0x33: IF (Stack[-1] == 1) GOTO 0x39; Pop(1)
...
0x54: Pop(1)
0x55: Push("flashlight_off") // @poff=0
0x56: @ PlaySound(Stack[-1])
0x57: Pop(1)
0x58: Return(); Pop(12)

0x59: PushEmpty(int, int)
0x5a: Push("kerosene") // @poff=30
