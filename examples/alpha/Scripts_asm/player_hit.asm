...
Strings:
	...
	W:scream_mental
	W:GetPosition
// @pool_raw:
// @pool_encoding:utf8
...
0x1a: Stack[-9] = Stack[-4]
0x1b: Push((float)0.20000000298023224)
0x1c: Pop(1); Push((bool) Stack[-5] < Stack[-1])
0x1d: IF (Stack[-1] == 0) GOTO 0x1f; Pop(1)

0x1e: Stack[-4] = (float) 0.20000000298023224
...
0x45: Stack[-3] = (int) 0
0x46: Stack[-5] = Stack[-2]
0x47: Stack[-6] = Stack[-1]
0x48: Call 0x154
...
0x5b: Stack[-9] = Stack[-3]
0x5c: Stack[-8] = Stack[-2]
0x5d: Stack[-7] = Stack[-1]
0x5e: Call 0x124

0x5f: Pop(3)
0x60: PushEmpty(float, float)
0x61: Stack[-6] = Stack[-1]
0x62: Call 0xa6

0x63: Stack[-2] = Stack[-3]
0x64: Pop(2)
...
0x71: Pop(0)
0x72: @@ GetPosition(Stack[-1]); Obj=5 // @poff=0
0x73: Pop(0)
...
0x7f: Push((float)9.999999974752427e-07)
...
0xe8: Stack[-1] = "hit_physical1" // @poff=48
0xe9: Call 0xbe

0xea: Pop(1)
0xeb: PushEmpty(string)
0xec: Stack[-1] = "scream_physical1" // @poff=76
0xed: Call 0xd8
...
0xf4: Stack[-1] = "hit_physical2" // @poff=110
0xf5: Call 0xbe

0xf6: Pop(1)
0xf7: PushEmpty(string)
0xf8: Stack[-1] = "scream_physical2" // @poff=138
0xf9: Call 0xd8
...
0x100: Stack[-1] = "hit_bullet" // @poff=172
0x101: Call 0xbe

0x102: Pop(1)
0x103: PushEmpty(string)
0x104: Stack[-1] = "scream_bullet" // @poff=194
0x105: Call 0xd8
...
0x10c: Stack[-1] = "hit_oscoloc" // @poff=222
0x10d: Call 0xbe

0x10e: Pop(1)
0x10f: PushEmpty(string)
0x110: Stack[-1] = "scream_oscoloc" // @poff=246
0x111: Call 0xd8
...
0x118: Stack[-1] = "hit_mental" // @poff=276
0x119: Call 0xbe

0x11a: Pop(1)
0x11b: PushEmpty(string)
0x11c: Stack[-1] = "scream_mental" // @poff=298
0x11d: Call 0xd8
...
0x13a: Push("GetPosition") // @poff=326
0x13b: Push((int) 1)
...
0x144: Stack[-9] = Stack[-1]
0x145: Call 0x6f

0x146: Stack[-2] = Stack[-3]
0x147: Pop(2)
0x148: Call 0x7c
...
0x15b: Push((int) 1)
0x15c: Push((float)0.10000000149011612)
