...
0x15: Push((float)0.699999988079071)
0x16: Stack[-7] = Stack[-8] * Stack[-1]; Pop(1);
0x17: PushEmpty(bool, string, float, float, float)
0x18: Stack[-4] = "hunger" // @poff=26
0x19: Push((float)0.0416666679084301)
...
0x36: Push((float)0.009999999776482582)
...
0x72: Stack[-10] = Stack[-2]
0x73: Stack[-9] = Stack[-1]
0x74: Call 0x87
