...
Strings:
	...
	W:vcharge
	W:sleeping
// @pool_raw:7600690073006900720000007600630068006100720067006500000073006c0065006500700069006e0067000000
...
0x3e: IF (Stack[-1] == 1) GOTO 0x44; Pop(1)
...
0x69: Stack[-4] = Stack[-5]
0x6a: Pop(4)
0x6b: Push("vcharge") // @poff=12
...
0x78: Push("sleeping") // @poff=28
0x79: @ GetProperty(Stack[-1], Stack[-2])
0x7a: Pop(1)
0x7b: Stack[-1] = Stack[-5]
0x7c: Return(); Pop(4)
