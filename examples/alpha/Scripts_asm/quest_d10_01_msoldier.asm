...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x14: Pop(0)
0x15: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x16: Pop(1)
0x17: PushEmpty(string)
0x18: Call 0x80d

0x19: Pop(0)
0x1a: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=11
0x1b: Pop(1)
0x1c: PushEmpty(int)
0x1d: Call 0x6f2

0x1e: Pop(0)
0x1f: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=20
0x20: Pop(1)
0x21: Stack[-2] = (int) -1
...
0x2b: Stack[-11] = Stack[-2]
0x2c: Stack[-6] = Stack[-1]
...
0x35: @ sync()
0x36: Pop(0)
0x37: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=34
0x38: Pop(0)
0x39: GOTO 0x33
...
0x3f: Pop(0)
0x40: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=46
0x41: Pop(0)
0x42: Stack[-2] = Stack[-10]
0x43: Return(); Pop(8)
...
0x56: Stack[-1] = "Neutral" // @poff=61
0x57: Call 0xc5

0x58: Pop(1)
0x59: Push((int) 15453)
0x5a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5b: Pop(1)
0x5c: @@@ ClearReplies(); Obj=0 // @poff=88
0x5d: Pop(0)
0x5e: Push((int) 15454)
0x5f: Push((int) 16572)
0x60: Push((int) 16571)
0x61: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x62: Pop(3)
0x63: GOTO 0xa7
...
0x6f: Stack[-1] = "Neutral" // @poff=61
0x70: Call 0xc5

0x71: Pop(1)
0x72: Push((int) 15459)
0x73: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x74: Pop(1)
0x75: @@@ ClearReplies(); Obj=0 // @poff=88
0x76: Pop(0)
0x77: Push((int) 15460)
0x78: Push((int) -1)
0x79: Push((int) 16577)
0x7a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7b: Pop(3)
0x7c: GOTO 0xa7
...
0x88: Stack[-1] = "Neutral" // @poff=61
0x89: Call 0xc5

0x8a: Pop(1)
0x8b: Push((int) 15461)
0x8c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x8d: Pop(1)
0x8e: @@@ ClearReplies(); Obj=0 // @poff=88
0x8f: Pop(0)
0x90: Push((int) 15462)
0x91: Push((int) 16580)
0x92: Push((int) 16579)
0x93: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x94: Pop(3)
0x95: GOTO 0xa7

0x96: PushEmpty(string)
0x97: Stack[-1] = "Neutral" // @poff=61
0x98: Call 0xc5

0x99: Pop(1)
0x9a: Push((int) 15465)
0x9b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x9c: Pop(1)
0x9d: @@@ ClearReplies(); Obj=0 // @poff=88
0x9e: Pop(0)
0x9f: Push((int) 15466)
0xa0: Push((int) -1)
0xa1: Push((int) 16583)
...
0xb6: Push("all") // @poff=110
0xb7: Push("idle") // @poff=118
...
0xbf: Push("all") // @poff=110
0xc0: Push("idle") // @poff=118
...
0x117: Stack[-1] = "Neutral" // @poff=61
0x118: Call 0xc5

0x119: Pop(1)
0x11a: Push((int) 15459)
0x11b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x11c: Pop(1)
0x11d: @@@ ClearReplies(); Obj=0 // @poff=88
0x11e: Pop(0)
0x11f: Push((int) 15460)
0x120: Push((int) -1)
0x121: Push((int) 16577)
0x122: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x123: Pop(3)
0x124: Return(); Pop(0)
...
0x130: Stack[-1] = "Neutral" // @poff=61
0x131: Call 0xc5

0x132: Pop(1)
0x133: Push((int) 15461)
0x134: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x135: Pop(1)
0x136: @@@ ClearReplies(); Obj=0 // @poff=88
0x137: Pop(0)
0x138: Push((int) 15462)
0x139: Push((int) 16580)
0x13a: Push((int) 16579)
0x13b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x13c: Pop(3)
0x13d: Return(); Pop(0)

0x13e: PushEmpty(string)
0x13f: Stack[-1] = "Neutral" // @poff=61
0x140: Call 0xc5

0x141: Pop(1)
0x142: Push((int) 15465)
0x143: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x144: Pop(1)
0x145: @@@ ClearReplies(); Obj=0 // @poff=88
0x146: Pop(0)
0x147: Push((int) 15466)
0x148: Push((int) -1)
0x149: Push((int) 16583)
0x14a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x14b: Pop(3)
0x14c: Return(); Pop(0)
...
0x151: Stack[-1] = "Neutral" // @poff=61
0x152: Call 0xc5

0x153: Pop(1)
0x154: Push((int) 15463)
0x155: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x156: Pop(1)
0x157: @@@ ClearReplies(); Obj=0 // @poff=88
0x158: Pop(0)
0x159: Push((int) 15464)
0x15a: Push((int) -1)
0x15b: Push((int) 16581)
0x15c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x15d: Pop(3)
0x15e: Return(); Pop(0)
...
0x163: Stack[-1] = "Neutral" // @poff=61
0x164: Call 0xc5

0x165: Pop(1)
0x166: Push((int) 15455)
0x167: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x168: Pop(1)
0x169: @@@ ClearReplies(); Obj=0 // @poff=88
0x16a: Pop(0)
0x16b: Push((int) 15456)
0x16c: Push((int) 16574)
0x16d: Push((int) 16573)
0x16e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x16f: Pop(3)
0x170: Return(); Pop(0)
...
0x175: Stack[-1] = "Neutral" // @poff=61
0x176: Call 0xc5

0x177: Pop(1)
0x178: Push((int) 15457)
0x179: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x17a: Pop(1)
0x17b: @@@ ClearReplies(); Obj=0 // @poff=88
0x17c: Pop(0)
0x17d: Push((int) 15458)
0x17e: Push((int) -1)
0x17f: Push((int) 16575)
0x180: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x181: Pop(3)
0x182: Return(); Pop(0)
...
0x1b1: Pop(0); PushNull((bool) Stack[-21] == 0)
0x1b2: IF (Stack[-1] == 0) GOTO 0x1b8; Pop(1)

0x1b3: PushEmpty(string)
0x1b4: Stack[-1] = "fdie" // @poff=128
0x1b5: Call 0x207

0x1b6: Pop(1)
0x1b7: GOTO 0x206

0x1b8: @@ GetPosition(Stack[-10]); Obj=21 // @poff=138
0x1b9: Pop(0)
...
0x1c9: Stack[-6] = "fdie" // @poff=128
0x1ca: GOTO 0x1cc

0x1cb: Stack[-6] = "bdie" // @poff=150
...
0x1d2: @ StopAsync()
0x1d3: Pop(0)
0x1d4: Stack[-21] = Stack[-5]
0x1d5: Push("GetScriptProperty") // @poff=160
0x1d6: Push((int) 2)
0x1d7: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x1d8: IF (Stack[-1] == 0) GOTO 0x1e4; Pop(1)

0x1d9: Push("Owner") // @poff=196
0x1da: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=208
0x1db: Pop(1)
0x1dc: Push(Stack[-4])
0x1dd: IF (Stack[-1] == 0) GOTO 0x1e4; Pop(1)

0x1de: Push("Owner") // @poff=196
0x1df: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=226
0x1e0: Pop(1)
0x1e1: Pop(0); PushNull((bool) Stack[-5] == 0)
0x1e2: IF (Stack[-1] == 0) GOTO 0x1e4; Pop(1)

0x1e3: Stack[-21] = Stack[-5]
0x1e4: Push("@GetEyesHeight") // @poff=244
0x1e5: Push((int) 1)
0x1e6: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x1e7: IF (Stack[-1] == 0) GOTO 0x1f3; Pop(1)

0x1e8: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=274
0x1e9: Pop(0)
...
0x1fb: @ StopAsync()
0x1fc: Pop(0)
0x1fd: Push("head") // @poff=288
0x1fe: @ UnlookAsync(Stack[-1])
0x1ff: Pop(1)
0x200: Push("all") // @poff=110
...
0x22d: IF (Stack[-1] == 1) GOTO 0x235; Pop(1)
...
0x2a0: Push("all") // @poff=110
0x2a1: Push("attack_on") // @poff=298
0x2a2: @ PlayAnimation(Stack[-2], Stack[-1])
0x2a3: Pop(2)
0x2a4: @ WaitForAnimEnd()
0x2a5: Pop(0)
0x2a6: Push("all") // @poff=110
0x2a7: Push("attack_on") // @poff=298
...
0x2b2: @ CanSee(Stack[-1], Stack[-0]T)
0x2b3: Pop(0)
0x2b4: Push(Stack[-1])
...
0x2bf: Push("all") // @poff=110
0x2c0: Push("hunt") // @poff=318
...
0x2cb: Pop(0)
0x2cc: Push("all") // @poff=110
0x2cd: Push("attack_on") // @poff=298
...
0x2e3: Push("all") // @poff=110
0x2e4: Push("attack_on") // @poff=298
...
0x2f0: Pop(0)
0x2f1: Push("all") // @poff=110
0x2f2: Push("attack_on") // @poff=298
...
0x2fe: @ CanSee(Stack[-1], Stack[-0]T)
0x2ff: Pop(0)
0x300: Push(Stack[-1])
0x301: IF (Stack[-1] == 0) GOTO 0x308; Pop(1)

0x302: @ Face(Stack[-0]T)
0x303: Pop(0)
0x304: PushEmpty()
0x305: Call 0x343
...
0x316: @ StopAsync()
0x317: Pop(0)
0x318: Push("all") // @poff=110
0x319: Push("attack_off") // @poff=328
...
0x34b: Stack[-2] = Stack[-10]
0x34c: Pop(2)
0x34d: PushEmpty(float, cvector, cvector)
0x34e: Stack[-12] = Stack[-2]
0x34f: Stack[-11] = Stack[-1]
0x350: Call 0x60f

0x351: Pop(2)
0x352: Push((float)0.9659258127212524)
0x353: Pop(2); Push((bool) Stack[-2] < Stack[-1])
0x354: IF (Stack[-1] == 0) GOTO 0x356; Pop(1)

0x355: Return(); Pop(18)

0x356: Push("all") // @poff=110
0x357: Push("attack_begin1") // @poff=372
0x358: @ PlayAnimation(Stack[-2], Stack[-1])
0x359: Pop(2)
0x35a: @ WaitForAnimEnd()
0x35b: Pop(0)
0x35c: Push("shot") // @poff=400
0x35d: @ Speak(Stack[-1])
0x35e: Pop(1)
...
0x36d: Push((float)0.2617993950843811)
...
0x37b: Stack[-4] = Stack[-7]
0x37c: Pop(4)
0x37d: Push((int) 2)
0x37e: Push((float)1.5)
0x37f: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x380: Pop(2)
0x381: GOTO 0x391
...
0x386: Pop(0)
0x387: Push("scripted") // @poff=410
0x388: Push(CVector(0.0, 0.0, 1.0))
0x389: Push("richochet.xml") // @poff=428
0x38a: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x38b: Pop(3)
0x38c: Push("Material") // @poff=456
0x38d: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=474
0x38e: Pop(1)
0x38f: Stack[-1] = 0
0x390: Stack[-2] = 0
0x391: Push("all") // @poff=110
0x392: Push("attack_end1") // @poff=492
0x393: @ PlayAnimation(Stack[-2], Stack[-1])
0x394: Pop(2)
0x395: @ WaitForAnimEnd()
0x396: Pop(0)
0x397: Push("all") // @poff=110
0x398: Push("attack_on") // @poff=298
...
0x3b7: Stack[-5] = Stack[-2]
0x3b8: Stack[-4] = Stack[-1]
0x3b9: Call 0x7b9
...
0x3ce: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x3cf: Pop(1)
...
0x3ea: Stack[-2] = "quest_d10_01" // @poff=533
0x3eb: Stack[-1] = "soldier_fight" // @poff=559
0x3ec: Call 0x625
...
0x403: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x404: Pop(1)
0x405: Push(Stack[-1])
...
0x444: @ FindPathTo(Stack[-1], Stack[-1]T)
0x445: Pop(0)
...
0x453: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x454: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x466: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x467: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x47f: Stack[-2] = "fire" // @poff=587
0x480: Return(); Pop(0)

0x481: Stack[-2] = "phys" // @poff=597
0x482: Return(); Pop(0)

0x483: PushEmpty(cvector, cvector, cvector, cvector)
0x484: @ GetPosition(Stack[-2])
0x485: Pop(0)
0x486: @@ GetPosition(Stack[-1]); Obj=5 // @poff=138
0x487: Pop(0)
...
0x48c: Pop(0)
0x48d: @@ GetPosition(Stack[-2]); Obj=7 // @poff=138
0x48e: Pop(0)
...
0x49a: Push("HasProperty") // @poff=621
0x49b: Push((int) 2)
...
0x4a1: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=645
0x4a2: Pop(0)
...
0x4a7: Stack[-18] = Stack[-2]
0x4a8: Stack[-1] = "health" // @poff=657
0x4a9: Call 0x499
...
0x4b8: Push("armor") // @poff=671
0x4b9: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=683
0x4ba: Pop(1)
0x4bb: Push("armor_") // @poff=695
0x4bc: PushEmpty(string, int)
0x4bd: Stack[-16] = Stack[-1]
0x4be: Call 0x47b

0x4bf: Pop(1)
0x4c0: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4c1: PushEmpty(bool, object, string)
0x4c2: Stack[-18] = Stack[-2]
0x4c3: Stack[-8] = Stack[-1]
0x4c4: Call 0x499
...
0x4ca: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=683
0x4cb: Pop(0)
...
0x4d2: Stack[-3] = Stack[-6]
0x4d3: Pop(3)
0x4d4: Push("health") // @poff=657
0x4d5: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=683
0x4d6: Pop(1)
0x4d7: Push((int) 1)
0x4d8: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4d9: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4da: Push("health") // @poff=657
...
0x4e0: Pop(3)
0x4e1: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=709
0x4e2: Pop(2)
0x4e3: Stack[-1] = Stack[-16]
0x4e4: Return(); Pop(12)

0x4e5: PushEmpty(bool, bool)
0x4e6: @@ IsDead(Stack[-1]); Obj=3 // @poff=721
0x4e7: Pop(0)
0x4e8: Stack[-1] = Stack[-4]
0x4e9: Return(); Pop(2)

0x4ea: PushEmpty(object, object, object, object)
0x4eb: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4ff: Pop(0)
0x500: Pop(0); PushNull((bool) Stack[-2] == 0)
0x501: IF (Stack[-1] == 0) GOTO 0x504; Pop(1)

0x502: Stack[-6] = (bool) 0
0x503: Return(); Pop(4)

0x504: @@ GetScene(Stack[-1]); Obj=5 // @poff=742
0x505: Pop(0)
...
0x518: Stack[-6] = Stack[-2]
0x519: Stack[-1] = "noaccess" // @poff=751
0x51a: Call 0x499
...
0x520: Push("noaccess") // @poff=751
0x521: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=683
0x522: Pop(1)
0x523: Push((int) 0)
...
0x54c: @@ GetPosition(Stack[-5]); Obj=23 // @poff=138
0x54d: Pop(0)
...
0x55d: Stack[-1] = "fhit" // @poff=789
0x55e: GOTO 0x560

0x55f: Stack[-1] = "bhit" // @poff=799
0x560: Push("hit_react") // @poff=809
0x561: Push("1") // @poff=396
0x562: Pop(1); Push(Stack[-3] + Stack[-1]);
0x563: Push("2") // @poff=829
...
0x56a: @@ GetPosition(Stack[-3]); Obj=7 // @poff=138
0x56b: Pop(0)
...
0x576: Pop(0)
0x577: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=274
0x578: Pop(0)
...
0x57c: @@ GetPosition(Stack[-7]); Obj=17 // @poff=138
0x57d: Pop(0)
0x57e: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=274
0x57f: Pop(0)
...
0x5bf: Pop(0)
0x5c0: Push("start: ") // @poff=851
0x5c1: Pop(1); Push(Stack[-1] + Stack[-3]);
0x5c2: @ Trace(Stack[-1])
0x5c3: Pop(1)
0x5c4: Push("end: ") // @poff=867
...
0x627: Pop(0)
0x628: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x633: Pop(0)
0x634: Stack[-1] = Stack[-3]
0x635: Return(); Pop(2)

0x636: PushEmpty()
0x637: Push("ood10MSoldier1") // @poff=879
0x638: Push((int) 1)
...
0x63c: PushEmpty()
0x63d: Push("ood10MSoldier2") // @poff=909
0x63e: Push((int) 1)
...
0x642: PushEmpty()
0x643: Push("ood10MSoldier3") // @poff=939
0x644: Push((int) 1)
...
0x64c: Pop(1)
0x64d: Push("d10q01SoldierGotoPetr") // @poff=969
0x64e: Push("pt_d10q01_petr") // @poff=1013
0x64f: Push((int) 1)
...
0x653: Pop(0)
0x654: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1043
0x655: Pop(5)
0x656: PushEmpty()
0x657: Call 0x7fb
...
0x65d: Stack[-2] = "quest_d10_01" // @poff=533
0x65e: Stack[-1] = "soldier_fight" // @poff=559
0x65f: Call 0x625
...
0x667: Pop(1)
0x668: Stack[-2] = "pt_d10q01_petr" // @poff=1013
0x669: Stack[-1] = (int) 2
0x66a: Call 0x6d1
...
0x66e: Pop(0)
0x66f: @@ ShowMap(Stack[-1]); Obj=2 // @poff=1051
0x670: Pop(1)
0x671: Return(); Pop(0)

0x672: PushEmpty()
0x673: PushEmpty(int, string)
0x674: Stack[-1] = "ood10MSoldier1" // @poff=879
0x675: Call 0x620
...
0x680: Stack[-1] = "ood10MSoldier2" // @poff=909
0x681: Call 0x620
...
0x68c: Stack[-1] = "ood10MSoldier3" // @poff=939
0x68d: Call 0x620
...
0x69b: Push("Can't retrieve diary root") // @poff=1059
0x69c: @ Trace(Stack[-1])
0x69d: Pop(1)
...
0x6a7: Pop(1)
0x6a8: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1111
0x6a9: Pop(0)
0x6aa: Pop(0); Push((bool) Stack[-2] == 0)
0x6ab: IF (Stack[-1] == 0) GOTO 0x6b2; Pop(1)

0x6ac: Push("Can't find diary parent with id: ") // @poff=1116
...
0x6b2: @@ AddChild(Stack[-8]); Obj=2 // @poff=1184
0x6b3: Pop(0)
0x6b4: Push("player_diary") // @poff=1193
0x6b5: Push((int) 1)
0x6b6: @ SetVariable(Stack[-2], Stack[-1])
0x6b7: Pop(2)
0x6b8: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1219
0x6b9: Pop(0)
...
0x6c2: Pop(0)
0x6c3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6c4: IF (Stack[-1] == 0) GOTO 0x6cb; Pop(1)

0x6c5: Push("Can't find main outdoor scene") // @poff=1231
0x6c6: @ Trace(Stack[-1])
0x6c7: Pop(1)
0x6c8: Stack[-1] = 0
...
0x6cb: @@ GetMap(Stack[-1]); Obj=2 // @poff=1291
0x6cc: Pop(0)
0x6cd: Stack[-1] = Stack[-5]
0x6ce: Return(); Pop(4)
...
0x6d3: Pop(0)
0x6d4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6d5: IF (Stack[-1] == 0) GOTO 0x6da; Pop(1)

0x6d6: Push("Can't find main outdoor scene") // @poff=1231
0x6d7: @ Trace(Stack[-1])
0x6d8: Pop(1)
0x6d9: Return(); Pop(8)

0x6da: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=1298
0x6db: Pop(0)
0x6dc: Pop(0); Push((bool) Stack[-1] == 0)
0x6dd: IF (Stack[-1] == 0) GOTO 0x6e4; Pop(1)

0x6de: Push("Warning: outdoor scene locator ") // @poff=1309
0x6df: Pop(1); Push(Stack[-1] + Stack[-11]);
0x6e0: Push(" doesnt exist") // @poff=1373
0x6e1: Pop(2); Push(Stack[-2] + Stack[-1]);
0x6e2: @ Trace(Stack[-1])
0x6e3: Pop(1)
0x6e4: @@ GetMap(Stack[-11]); Obj=2 // @poff=1291
0x6e5: Pop(0)
0x6e6: Pop(0); PushNull((bool) Stack[-11] == 0)
0x6e7: IF (Stack[-1] == 0) GOTO 0x6ec; Pop(1)

0x6e8: Push("Can't find map") // @poff=1401
0x6e9: @ Trace(Stack[-1])
0x6ea: Pop(1)
0x6eb: Return(); Pop(8)
...
0x6ee: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=1431
0x6ef: Pop(2)
0x6f0: Return(); Pop(8)

0x6f1: Stack[-2] = 0
0x6f2: PushEmpty(int, int)
0x6f3: Push("player") // @poff=607
...
0x706: Push("GenerateMoney: iMin > iMax") // @poff=1444
0x707: @ Trace(Stack[-1])
0x708: Pop(1)
0x709: Return(); Pop(8)
...
0x731: Stack[-1] = "rifle_ammo" // @poff=1510
0x732: Call 0x746
...
0x755: Stack[-7] = Stack[-3]
0x756: Stack[-6] = Stack[-2]
...
0x7a7: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=516
0x7a8: Pop(1)
0x7a9: Push(Stack[-1])
...
0x7ae: Stack[-5] = Stack[-1]
0x7af: Call 0x798

0x7b0: Stack[-2] = Stack[-6]
0x7b1: Pop(2)
0x7b2: Return(); Pop(2)
...
0x7bb: Stack[-8] = Stack[-2]
0x7bc: Stack[-1] = "reputation" // @poff=1546
0x7bd: Call 0x499
...
0x7c3: Push("reputation") // @poff=1546
0x7c4: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=683
0x7c5: Pop(1)
...
0x7fc: Push("Adding diary entry") // @poff=1568
0x7fd: @ Trace(Stack[-1])
0x7fe: Pop(1)
0x7ff: Push((int) 188)
0x800: Push((int) 1)
...
0x80d: Stack[-1] = "ui/NPC_Black.png" // @poff=1606
0x80e: Return(); Pop(0)
