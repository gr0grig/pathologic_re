...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x59: Stack[-1] = "Neutral" // @poff=61
0x5a: Call 0xcf

0x5b: Pop(1)
0x5c: Push((int) 12853)
0x5d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5e: Pop(1)
0x5f: @@@ ClearReplies(); Obj=0 // @poff=88
0x60: Pop(0)
0x61: Push((int) 12854)
0x62: Push((int) 14056)
0x63: Push((int) 14055)
0x64: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x65: Pop(3)
0x66: GOTO 0xb1
...
0x92: Push((int) 16586)
0x93: Push((int) 16585)
0x94: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x95: Pop(3)
0x96: PushEmpty(bool)
0x97: Stack[-1] = (bool) 0
...
0xaa: Push((int) -1)
0xab: Push((int) 14092)
0xac: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xad: Pop(3)
0xae: GOTO 0xb1
...
0xc0: Push("all") // @poff=110
0xc1: Push("idle") // @poff=118
...
0xc9: Push("all") // @poff=110
0xca: Push("idle") // @poff=118
...
0x12b: Stack[-1] = "Neutral" // @poff=61
0x12c: Call 0xcf

0x12d: Pop(1)
0x12e: Push((int) 12871)
0x12f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x130: Pop(1)
0x131: @@@ ClearReplies(); Obj=0 // @poff=88
0x132: Pop(0)
...
0x188: Stack[-1] = "Neutral" // @poff=61
0x189: Call 0xcf

0x18a: Pop(1)
0x18b: Push((int) 12882)
0x18c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x18d: Pop(1)
0x18e: @@@ ClearReplies(); Obj=0 // @poff=88
0x18f: Pop(0)
0x190: Push((int) 12883)
0x191: Push((int) 14086)
0x192: Push((int) 14085)
0x193: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x194: Pop(3)
0x195: Return(); Pop(0)
...
0x19a: Stack[-1] = "Neutral" // @poff=61
0x19b: Call 0xcf

0x19c: Pop(1)
0x19d: Push((int) 12884)
0x19e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x19f: Pop(1)
0x1a0: @@@ ClearReplies(); Obj=0 // @poff=88
0x1a1: Pop(0)
0x1a2: Push((int) 12885)
0x1a3: Push((int) 14088)
0x1a4: Push((int) 14087)
0x1a5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1a6: Pop(3)
0x1a7: Return(); Pop(0)
...
0x1ac: Stack[-1] = "Neutral" // @poff=61
0x1ad: Call 0xcf

0x1ae: Pop(1)
0x1af: Push((int) 12886)
0x1b0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1b1: Pop(1)
0x1b2: @@@ ClearReplies(); Obj=0 // @poff=88
0x1b3: Pop(0)
0x1b4: Push((int) 12887)
0x1b5: Push((int) 14090)
0x1b6: Push((int) 14089)
0x1b7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1b8: Pop(3)
0x1b9: Return(); Pop(0)
...
0x1be: Stack[-1] = "Neutral" // @poff=61
0x1bf: Call 0xcf

0x1c0: Pop(1)
0x1c1: Push((int) 12888)
0x1c2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1c3: Pop(1)
0x1c4: @@@ ClearReplies(); Obj=0 // @poff=88
0x1c5: Pop(0)
0x1c6: Push((int) 12889)
0x1c7: Push((int) -1)
0x1c8: Push((int) 14091)
0x1c9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1ca: Pop(3)
0x1cb: Return(); Pop(0)
...
0x1e2: Stack[-1] = "Neutral" // @poff=61
0x1e3: Call 0xcf

0x1e4: Pop(1)
0x1e5: Push((int) 15471)
0x1e6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1e7: Pop(1)
0x1e8: @@@ ClearReplies(); Obj=0 // @poff=88
0x1e9: Pop(0)
0x1ea: Push((int) 15472)
0x1eb: Push((int) -1)
0x1ec: Push((int) 16589)
0x1ed: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1ee: Pop(3)
0x1ef: Return(); Pop(0)
...
0x1f4: Stack[-1] = "Neutral" // @poff=61
0x1f5: Call 0xcf

0x1f6: Pop(1)
0x1f7: Push((int) 12873)
0x1f8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1f9: Pop(1)
0x1fa: @@@ ClearReplies(); Obj=0 // @poff=88
0x1fb: Pop(0)
...
0x206: Stack[-1] = "Neutral" // @poff=61
0x207: Call 0xcf

0x208: Pop(1)
0x209: Push((int) 12875)
0x20a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x20b: Pop(1)
0x20c: @@@ ClearReplies(); Obj=0 // @poff=88
0x20d: Pop(0)
0x20e: Push((int) 12876)
0x20f: Push((int) 14079)
0x210: Push((int) 14078)
0x211: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x212: Pop(3)
0x213: Return(); Pop(0)
...
0x22a: Stack[-1] = "Neutral" // @poff=61
0x22b: Call 0xcf

0x22c: Pop(1)
0x22d: Push((int) 12855)
0x22e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x22f: Pop(1)
0x230: @@@ ClearReplies(); Obj=0 // @poff=88
0x231: Pop(0)
...
0x23c: Stack[-1] = "Neutral" // @poff=61
0x23d: Call 0xcf

0x23e: Pop(1)
0x23f: Push((int) 12857)
0x240: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x241: Pop(1)
0x242: @@@ ClearReplies(); Obj=0 // @poff=88
0x243: Pop(0)
...
0x24c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x24d: Pop(3)
...
0x263: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x264: Pop(3)
0x265: Return(); Pop(0)
...
0x26a: Stack[-1] = "Neutral" // @poff=61
0x26b: Call 0xcf

0x26c: Pop(1)
0x26d: Push((int) 12860)
0x26e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x26f: Pop(1)
0x270: @@@ ClearReplies(); Obj=0 // @poff=88
0x271: Pop(0)
...
0x287: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x288: Pop(3)
0x289: Return(); Pop(0)
...
0x28e: Stack[-1] = "Neutral" // @poff=61
0x28f: Call 0xcf

0x290: Pop(1)
0x291: Push((int) 12866)
0x292: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x293: Pop(1)
0x294: @@@ ClearReplies(); Obj=0 // @poff=88
0x295: Pop(0)
0x296: Push((int) 12867)
0x297: Push((int) 14070)
0x298: Push((int) 14068)
0x299: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x29a: Pop(3)
0x29b: Return(); Pop(0)
...
0x2a0: Stack[-1] = "Neutral" // @poff=61
0x2a1: Call 0xcf

0x2a2: Pop(1)
0x2a3: Push((int) 12869)
0x2a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2a5: Pop(1)
0x2a6: @@@ ClearReplies(); Obj=0 // @poff=88
0x2a7: Pop(0)
0x2a8: Push((int) 12870)
0x2a9: Push((int) -1)
0x2aa: Push((int) 14072)
0x2ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2ac: Pop(3)
0x2ad: Return(); Pop(0)
...
0x2f6: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x2f7: Pop(0)
0x2f8: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x2f9: Pop(0)
...
0x339: Pop(0)
0x33a: Push("start: ") // @poff=204
0x33b: Pop(1); Push(Stack[-1] + Stack[-3]);
0x33c: @ Trace(Stack[-1])
0x33d: Pop(1)
0x33e: Push("end: ") // @poff=220
...
0x360: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x361: Pop(0)
0x362: Push("Category") // @poff=242
0x363: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x364: Pop(1)
0x365: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x366: Pop(0)
0x367: Pop(0); Push((bool) Stack[-1] == 0)
0x368: IF (Stack[-1] == 0) GOTO 0x36b; Pop(1)

0x369: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x36a: Pop(0)
0x36b: Return(); Pop(6)
...
0x36e: Pop(0)
0x36f: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x370: Pop(0)
0x371: PushEmpty(object, object, int)
0x372: Stack[-8] = Stack[-3]
0x373: Stack[-4] = Stack[-2]
...
0x378: Stack[-1] = 0
0x379: PushEmpty()
0x37a: Push("ood10Petr1") // @poff=290
0x37b: Push((int) 1)
...
0x388: PushEmpty()
0x389: Push("ood10Petr2") // @poff=326
0x38a: Push((int) 1)
...
0x395: Pop(0)
0x396: Push("blueprint is given") // @poff=348
0x397: @ Trace(Stack[-1])
0x398: Pop(1)
0x399: PushEmpty(object, string, int)
0x39a: Stack[-5] = Stack[-3]
0x39b: Stack[-2] = "d10q01_blueprint" // @poff=386
0x39c: Stack[-1] = (int) 1
0x39d: Call 0x36c
...
0x3a0: PushEmpty()
0x3a1: Push("ood10Petr3") // @poff=420
0x3a2: Push((int) 1)
...
0x3a8: Stack[-1] = "ood10Petr1" // @poff=290
0x3a9: Call 0x35a
...
0x3b4: Stack[-1] = "d10q01MariaSavePetr" // @poff=442
0x3b5: Call 0x35a
...
0x3cc: Stack[-1] = "ood10Petr2" // @poff=326
0x3cd: Call 0x35a
...
0x3fa: Stack[-1] = "ood10Petr3" // @poff=420
0x3fb: Call 0x35a
...
0x405: Push("tvirin") // @poff=482
0x406: @@ GetItemCountOfType(Stack[-2], Stack[-1]); Obj=4 // @poff=496
0x407: Pop(1)
0x408: Push((int) 5)
...
0x414: Push("Can't retrieve diary root") // @poff=515
0x415: @ Trace(Stack[-1])
0x416: Pop(1)
...
0x41f: Stack[-1] = Stack[-4]
0x420: Pop(1)
0x421: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=567
0x422: Pop(0)
0x423: Pop(0); Push((bool) Stack[-2] == 0)
0x424: IF (Stack[-1] == 0) GOTO 0x42b; Pop(1)

0x425: Push("Can't find diary parent with id: ") // @poff=572
...
0x42b: @@ AddChild(Stack[-8]); Obj=2 // @poff=640
0x42c: Pop(0)
0x42d: Push("player_diary") // @poff=649
0x42e: Push((int) 1)
0x42f: @ SetVariable(Stack[-2], Stack[-1])
0x430: Pop(2)
0x431: @@ GetCategory(Stack[-1]); Obj=8 // @poff=675
0x432: Pop(0)
...
0x44b: Push("Adding diary entry") // @poff=701
0x44c: @ Trace(Stack[-1])
0x44d: Pop(1)
0x44e: Push((int) 189)
0x44f: Push((int) 1)
...
0x45b: Push("Adding diary entry") // @poff=701
0x45c: @ Trace(Stack[-1])
0x45d: Pop(1)
0x45e: Push((int) 190)
0x45f: Push((int) 1)
...
0x46c: Stack[-1] = "ui/NPC_Black.png" // @poff=739
0x46d: Return(); Pop(0)
