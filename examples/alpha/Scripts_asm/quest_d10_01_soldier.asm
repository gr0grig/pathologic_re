...
Strings:
	...
	A:add
	W:reputation
// @pool_raw:
...
0x27: Pop(0); PushNull((bool) Stack[-21] == 0)
0x28: IF (Stack[-1] == 0) GOTO 0x2e; Pop(1)

0x29: PushEmpty(string)
0x2a: Stack[-1] = "fdie" // @poff=0
0x2b: Call 0x7d

0x2c: Pop(1)
0x2d: GOTO 0x7c

0x2e: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0x2f: Pop(0)
...
0x3f: Stack[-6] = "fdie" // @poff=0
0x40: GOTO 0x42

0x41: Stack[-6] = "bdie" // @poff=22
...
0x71: @ StopAsync()
0x72: Pop(0)
0x73: Push("head") // @poff=160
0x74: @ UnlookAsync(Stack[-1])
0x75: Pop(1)
0x76: Push("all") // @poff=170
...
0xa3: IF (Stack[-1] == 1) GOTO 0xab; Pop(1)
...
0xa9: IF (Stack[-1] == 1) GOTO 0xab; Pop(1)
...
0xed: Stack[-5] = Stack[-2]
0xee: Stack[-4] = Stack[-1]
0xef: Call 0x4f3
...
0x128: @ CanSee(Stack[-1], Stack[-0]T)
0x129: Pop(0)
0x12a: Push(Stack[-1])
...
0x135: Push("all") // @poff=170
0x136: Push("hunt") // @poff=198
...
0x141: Pop(0)
0x142: Push("all") // @poff=170
0x143: Push("attack_on") // @poff=178
...
0x159: Push("all") // @poff=170
0x15a: Push("attack_on") // @poff=178
...
0x166: Pop(0)
0x167: Push("all") // @poff=170
0x168: Push("attack_on") // @poff=178
...
0x174: @ CanSee(Stack[-1], Stack[-0]T)
0x175: Pop(0)
0x176: Push(Stack[-1])
0x177: IF (Stack[-1] == 0) GOTO 0x17e; Pop(1)

0x178: @ Face(Stack[-0]T)
0x179: Pop(0)
0x17a: PushEmpty()
0x17b: Call 0x1b9
...
0x18c: @ StopAsync()
0x18d: Pop(0)
0x18e: Push("all") // @poff=170
0x18f: Push("attack_off") // @poff=208
...
0x1c4: Stack[-12] = Stack[-2]
0x1c5: Stack[-11] = Stack[-1]
0x1c6: Call 0x420

0x1c7: Pop(2)
0x1c8: Push((float)0.9659258127212524)
...
0x1cd: Push("attack_begin1") // @poff=252
0x1ce: @ PlayAnimation(Stack[-2], Stack[-1])
0x1cf: Pop(2)
0x1d0: @ WaitForAnimEnd()
0x1d1: Pop(0)
0x1d2: Push("shot") // @poff=280
0x1d3: @ Speak(Stack[-1])
0x1d4: Pop(1)
...
0x1e3: Push((float)0.2617993950843811)
...
0x1f5: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x1f6: Pop(2)
0x1f7: GOTO 0x207
...
0x1fc: Pop(0)
0x1fd: Push("scripted") // @poff=290
0x1fe: Push(CVector(0.0, 0.0, 1.0))
0x1ff: Push("richochet.xml") // @poff=308
0x200: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x201: Pop(3)
0x202: Push("Material") // @poff=336
0x203: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=354
0x204: Pop(1)
0x205: Stack[-1] = 0
0x206: Stack[-2] = 0
0x207: Push("all") // @poff=170
0x208: Push("attack_end1") // @poff=372
0x209: @ PlayAnimation(Stack[-2], Stack[-1])
0x20a: Pop(2)
0x20b: @ WaitForAnimEnd()
0x20c: Pop(0)
0x20d: Push("all") // @poff=170
0x20e: Push("attack_on") // @poff=178
...
0x22d: Stack[-5] = Stack[-2]
0x22e: Stack[-4] = Stack[-1]
0x22f: Call 0x4f3
...
0x23e: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=396
0x23f: Pop(1)
...
0x25a: Stack[-2] = "quest_d10_01" // @poff=413
0x25b: Stack[-1] = "soldier_fight" // @poff=439
0x25c: Call 0x431
...
0x273: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=396
0x274: Pop(1)
0x275: Push(Stack[-1])
...
0x299: @ GetPFPosition(Stack[-1]T)
0x29a: Pop(0)
0x29b: @ GetDirection(Stack[-0]T)
0x29c: Pop(0)
0x29d: Push((int) 60)
...
0x2b4: @ FindPathTo(Stack[-1], Stack[-1]T)
0x2b5: Pop(0)
...
0x2c3: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2c4: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x2d6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x2d7: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x2ef: Stack[-2] = "fire" // @poff=467
0x2f0: Return(); Pop(0)

0x2f1: Stack[-2] = "phys" // @poff=477
0x2f2: Return(); Pop(0)

0x2f3: PushEmpty(cvector, cvector, cvector, cvector)
0x2f4: @ GetPosition(Stack[-2])
0x2f5: Pop(0)
0x2f6: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x2f7: Pop(0)
...
0x2fc: Pop(0)
0x2fd: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x2fe: Pop(0)
...
0x30a: Push("HasProperty") // @poff=501
0x30b: Push((int) 2)
...
0x311: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=525
0x312: Pop(0)
...
0x317: Stack[-18] = Stack[-2]
0x318: Stack[-1] = "health" // @poff=537
0x319: Call 0x309
...
0x320: Stack[-18] = Stack[-2]
0x321: Stack[-1] = "armor" // @poff=551
0x322: Call 0x309
...
0x328: Push("armor") // @poff=551
0x329: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=563
0x32a: Pop(1)
0x32b: Push("armor_") // @poff=575
0x32c: PushEmpty(string, int)
0x32d: Stack[-16] = Stack[-1]
0x32e: Call 0x2eb

0x32f: Pop(1)
0x330: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x331: PushEmpty(bool, object, string)
0x332: Stack[-18] = Stack[-2]
...
0x33a: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=563
0x33b: Pop(0)
...
0x342: Stack[-3] = Stack[-6]
0x343: Pop(3)
0x344: Push("health") // @poff=537
0x345: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=563
0x346: Pop(1)
0x347: Push((int) 1)
0x348: Pop(1); Push(Stack[-1] - Stack[-4]);
0x349: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x34a: Push("health") // @poff=537
...
0x350: Pop(3)
0x351: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=589
0x352: Pop(2)
0x353: Stack[-1] = Stack[-16]
0x354: Return(); Pop(12)

0x355: PushEmpty(bool, bool)
0x356: @@ IsDead(Stack[-1]); Obj=3 // @poff=601
0x357: Pop(0)
0x358: Stack[-1] = Stack[-4]
0x359: Return(); Pop(2)

0x35a: PushEmpty(object, object, object, object)
0x35b: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x36f: Pop(0)
0x370: Pop(0); PushNull((bool) Stack[-2] == 0)
0x371: IF (Stack[-1] == 0) GOTO 0x374; Pop(1)

0x372: Stack[-6] = (bool) 0
0x373: Return(); Pop(4)

0x374: @@ GetScene(Stack[-1]); Obj=5 // @poff=622
0x375: Pop(0)
...
0x388: Stack[-6] = Stack[-2]
0x389: Stack[-1] = "noaccess" // @poff=631
0x38a: Call 0x309
...
0x390: Push("noaccess") // @poff=631
0x391: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=563
0x392: Pop(1)
0x393: Push((int) 0)
...
0x3bc: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x3bd: Pop(0)
...
0x3cd: Stack[-1] = "fhit" // @poff=669
0x3ce: GOTO 0x3d0

0x3cf: Stack[-1] = "bhit" // @poff=679
0x3d0: Push("hit_react") // @poff=689
0x3d1: Push("1") // @poff=276
0x3d2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3d3: Push("2") // @poff=709
...
0x3da: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x3db: Pop(0)
...
0x3e6: Pop(0)
0x3e7: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x3e8: Pop(0)
...
0x433: Pop(0)
0x434: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x440: Push("GenerateMoney: iMin > iMax") // @poff=713
0x441: @ Trace(Stack[-1])
0x442: Pop(1)
0x443: Return(); Pop(8)
...
0x46b: Stack[-1] = "rifle_ammo" // @poff=779
0x46c: Call 0x480
...
0x4e1: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=396
0x4e2: Pop(1)
0x4e3: Push(Stack[-1])
...
0x4f5: Stack[-8] = Stack[-2]
0x4f6: Stack[-1] = "reputation" // @poff=815
0x4f7: Call 0x309
...
0x4fd: Push("reputation") // @poff=815
0x4fe: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=563
0x4ff: Pop(1)
