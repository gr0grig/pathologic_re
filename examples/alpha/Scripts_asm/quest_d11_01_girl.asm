...
Strings:
	...
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x6d: Stack[-1] = "Neutral" // @poff=61
0x6e: Call 0x9b

0x6f: Pop(1)
0x70: Push((int) 14502)
0x71: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x72: Pop(1)
0x73: @@@ ClearReplies(); Obj=0 // @poff=88
0x74: Pop(0)
0x75: Push((int) 14503)
0x76: Push((int) -1)
0x77: Push((int) 15740)
...
0xec: Stack[-1] = "Neutral" // @poff=61
0xed: Call 0x9b

0xee: Pop(1)
0xef: Push((int) 14502)
0xf0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf1: Pop(1)
0xf2: @@@ ClearReplies(); Obj=0 // @poff=88
0xf3: Pop(0)
0xf4: Push((int) 14503)
0xf5: Push((int) -1)
0xf6: Push((int) 15740)
0xf7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xf8: Pop(3)
0xf9: Return(); Pop(0)
...
0x155: Stack[-1] = "Neutral" // @poff=61
0x156: Call 0x9b

0x157: Pop(1)
0x158: Push((int) 14427)
0x159: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x15a: Pop(1)
0x15b: @@@ ClearReplies(); Obj=0 // @poff=88
0x15c: Pop(0)
0x15d: Push((int) 14428)
0x15e: Push((int) 15654)
0x15f: Push((int) 15653)
0x160: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x161: Pop(3)
0x162: Return(); Pop(0)
...
0x167: Stack[-1] = "Neutral" // @poff=61
0x168: Call 0x9b

0x169: Pop(1)
0x16a: Push((int) 14429)
0x16b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x16c: Pop(1)
0x16d: @@@ ClearReplies(); Obj=0 // @poff=88
0x16e: Pop(0)
...
0x179: Stack[-1] = "Neutral" // @poff=61
0x17a: Call 0x9b

0x17b: Pop(1)
0x17c: Push((int) 14431)
0x17d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x17e: Pop(1)
0x17f: @@@ ClearReplies(); Obj=0 // @poff=88
0x180: Pop(0)
...
0x1e6: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x1e7: Pop(0)
0x1e8: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x1e9: Pop(0)
...
0x229: Pop(0)
0x22a: Push("start: ") // @poff=204
0x22b: Pop(1); Push(Stack[-1] + Stack[-3]);
0x22c: @ Trace(Stack[-1])
0x22d: Pop(1)
0x22e: Push("end: ") // @poff=220
...
0x251: Pop(0)
0x252: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x260: PushEmpty()
0x261: Push("ood11Nude1") // @poff=232
0x262: Push((int) 1)
...
0x26e: Pop(1)
0x26f: Push("d11q01NudeGotoRastrel") // @poff=268
0x270: Push("pt_d11q01_msoldier") // @poff=312
0x271: Push((int) 1)
...
0x275: Pop(0)
0x276: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=350
0x277: Pop(5)
0x278: PushEmpty()
0x279: Call 0x2e6
...
0x27c: Stack[-2] = "quest_d11_01" // @poff=358
0x27d: Stack[-1] = "init_soldiers" // @poff=384
0x27e: Call 0x24f
...
0x290: Stack[-1] = "ood11Nude1" // @poff=232
0x291: Call 0x24a
...
0x29f: Push("Can't retrieve diary root") // @poff=412
0x2a0: @ Trace(Stack[-1])
0x2a1: Pop(1)
0x2a2: Stack[-3] = (bool) 0
0x2a3: Return(); Pop(2)

0x2a4: Stack[-1] = Stack[-3]
0x2a5: Return(); Pop(2)
...
0x2ab: Pop(1)
0x2ac: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=464
0x2ad: Pop(0)
0x2ae: Pop(0); Push((bool) Stack[-2] == 0)
0x2af: IF (Stack[-1] == 0) GOTO 0x2b6; Pop(1)

0x2b0: Push("Can't find diary parent with id: ") // @poff=469
...
0x2b6: @@ AddChild(Stack[-8]); Obj=2 // @poff=537
0x2b7: Pop(0)
0x2b8: Push("player_diary") // @poff=546
0x2b9: Push((int) 1)
0x2ba: @ SetVariable(Stack[-2], Stack[-1])
0x2bb: Pop(2)
0x2bc: @@ GetCategory(Stack[-1]); Obj=8 // @poff=572
0x2bd: Pop(0)
...
0x2c6: Pop(0)
0x2c7: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2c8: IF (Stack[-1] == 0) GOTO 0x2cf; Pop(1)

0x2c9: Push("Can't find main outdoor scene") // @poff=584
0x2ca: @ Trace(Stack[-1])
0x2cb: Pop(1)
0x2cc: Stack[-1] = 0
...
0x2cf: @@ GetMap(Stack[-1]); Obj=2 // @poff=644
0x2d0: Pop(0)
...
0x2e7: Push("Adding diary entry") // @poff=665
0x2e8: @ Trace(Stack[-1])
0x2e9: Pop(1)
0x2ea: Push((int) 194)
0x2eb: Push((int) 1)
...
0x2f8: Stack[-1] = "ui/NPC_None.png" // @poff=703
0x2f9: Return(); Pop(0)
