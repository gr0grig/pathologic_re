...
// @pool_raw:
// @pool_encoding:utf8
...
0x50: Stack[-1] = "Neutral" // @poff=61
0x51: Call 0x83

0x52: Pop(1)
0x53: Push((int) 14445)
0x54: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x55: Pop(1)
0x56: @@@ ClearReplies(); Obj=0 // @poff=88
0x57: Pop(0)
0x58: Push((int) 14446)
0x59: Push((int) 15675)
0x5a: Push((int) 15674)
0x5b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x5c: Pop(3)
0x5d: Push((int) 14456)
0x5e: Push((int) 15687)
0x5f: Push((int) 15686)
0x60: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x61: Pop(3)
0x62: GOTO 0x65
...
0x74: Push("all") // @poff=110
0x75: Push("idle") // @poff=118
...
0x7d: Push("all") // @poff=110
0x7e: Push("idle") // @poff=118
...
0xb7: Stack[-1] = "Neutral" // @poff=61
0xb8: Call 0x83

0xb9: Pop(1)
0xba: Push((int) 14445)
0xbb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xbc: Pop(1)
0xbd: @@@ ClearReplies(); Obj=0 // @poff=88
0xbe: Pop(0)
0xbf: Push((int) 14446)
0xc0: Push((int) 15675)
0xc1: Push((int) 15674)
...
0xe0: Stack[-1] = "Neutral" // @poff=61
0xe1: Call 0x83

0xe2: Pop(1)
0xe3: Push((int) 14459)
0xe4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe5: Pop(1)
0xe6: @@@ ClearReplies(); Obj=0 // @poff=88
0xe7: Pop(0)
0xe8: Push((int) 14460)
0xe9: Push((int) 15681)
0xea: Push((int) 15690)
...
0x161: Pop(0); PushNull((bool) Stack[-21] == 0)
0x162: IF (Stack[-1] == 0) GOTO 0x168; Pop(1)

0x163: PushEmpty(string)
0x164: Stack[-1] = "fdie" // @poff=128
0x165: Call 0x1b7

0x166: Pop(1)
0x167: GOTO 0x1b6

0x168: @@ GetPosition(Stack[-10]); Obj=21 // @poff=138
0x169: Pop(0)
...
0x179: Stack[-6] = "fdie" // @poff=128
0x17a: GOTO 0x17c

0x17b: Stack[-6] = "bdie" // @poff=150
...
0x182: @ StopAsync()
0x183: Pop(0)
0x184: Stack[-21] = Stack[-5]
0x185: Push("GetScriptProperty") // @poff=160
0x186: Push((int) 2)
0x187: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x188: IF (Stack[-1] == 0) GOTO 0x194; Pop(1)

0x189: Push("Owner") // @poff=196
0x18a: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=208
0x18b: Pop(1)
0x18c: Push(Stack[-4])
0x18d: IF (Stack[-1] == 0) GOTO 0x194; Pop(1)

0x18e: Push("Owner") // @poff=196
0x18f: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=226
0x190: Pop(1)
0x191: Pop(0); PushNull((bool) Stack[-5] == 0)
0x192: IF (Stack[-1] == 0) GOTO 0x194; Pop(1)

0x193: Stack[-21] = Stack[-5]
0x194: Push("@GetEyesHeight") // @poff=244
0x195: Push((int) 1)
0x196: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x197: IF (Stack[-1] == 0) GOTO 0x1a3; Pop(1)

0x198: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=274
0x199: Pop(0)
...
0x1ab: @ StopAsync()
0x1ac: Pop(0)
0x1ad: Push("head") // @poff=288
0x1ae: @ UnlookAsync(Stack[-1])
0x1af: Pop(1)
0x1b0: Push("all") // @poff=110
...
0x1dd: IF (Stack[-1] == 1) GOTO 0x1e5; Pop(1)
...
0x1e3: IF (Stack[-1] == 1) GOTO 0x1e5; Pop(1)
...
0x24c: @ CanSee(Stack[-1]T, Stack[-0]T)
0x24d: Pop(0)
...
0x25b: @ Face(Stack[-0]T)
0x25c: Pop(0)
0x25d: Push("all") // @poff=110
0x25e: Push("shoot_begin") // @poff=298
...
0x268: Push("shot") // @poff=322
0x269: @ Speak(Stack[-1])
0x26a: Pop(1)
0x26b: Push("all") // @poff=110
0x26c: Push("shoot_end") // @poff=332
...
0x276: Push("all") // @poff=110
0x277: Push("attack_on") // @poff=352
...
0x285: @ CanSee(Stack[-1]T, Stack[-0]T)
0x286: Pop(0)
...
0x2a2: Push("all") // @poff=110
0x2a3: Push("attack_off") // @poff=372
...
0x2cb: Stack[-5] = Stack[-2]
0x2cc: Stack[-4] = Stack[-1]
0x2cd: Call 0x799
...
0x2fd: @ CanSee(Stack[-1], Stack[-0]T)
0x2fe: Pop(0)
0x2ff: Push(Stack[-1])
...
0x30a: Push("all") // @poff=110
0x30b: Push("hunt") // @poff=394
...
0x316: Pop(0)
0x317: Push("all") // @poff=110
0x318: Push("attack_on") // @poff=352
...
0x32e: Push("all") // @poff=110
0x32f: Push("attack_on") // @poff=352
...
0x33b: Pop(0)
0x33c: Push("all") // @poff=110
0x33d: Push("attack_on") // @poff=352
...
0x349: @ CanSee(Stack[-1], Stack[-0]T)
0x34a: Pop(0)
0x34b: Push(Stack[-1])
...
0x361: @ StopAsync()
0x362: Pop(0)
0x363: Push("all") // @poff=110
0x364: Push("attack_off") // @poff=372
...
0x3b8: Push((float)0.2617993950843811)
...
0x3c6: Stack[-4] = Stack[-7]
0x3c7: Pop(4)
0x3c8: Push((int) 2)
0x3c9: Push((float)1.5)
0x3ca: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x3cb: Pop(2)
0x3cc: GOTO 0x3dc
...
0x3d1: Pop(0)
0x3d2: Push("scripted") // @poff=454
0x3d3: Push(CVector(0.0, 0.0, 1.0))
0x3d4: Push("richochet.xml") // @poff=472
0x3d5: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x3d6: Pop(3)
0x3d7: Push("Material") // @poff=500
0x3d8: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=518
0x3d9: Pop(1)
0x3da: Stack[-1] = 0
0x3db: Stack[-2] = 0
0x3dc: Push("all") // @poff=110
0x3dd: Push("attack_end1") // @poff=536
0x3de: @ PlayAnimation(Stack[-2], Stack[-1])
0x3df: Pop(2)
0x3e0: @ WaitForAnimEnd()
0x3e1: Pop(0)
0x3e2: Push("all") // @poff=110
0x3e3: Push("attack_on") // @poff=352
...
0x41a: Stack[-2] = "quest_d11_01" // @poff=560
0x41b: Stack[-1] = "soldier_attack" // @poff=586
0x41c: Call 0x687
...
0x44d: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=616
0x44e: Pop(1)
...
0x48b: @ GetPFPosition(Stack[-1]T)
0x48c: Pop(0)
0x48d: @ GetDirection(Stack[-0]T)
0x48e: Pop(0)
0x48f: Push((int) 60)
...
0x4a6: @ FindPathTo(Stack[-1], Stack[-1]T)
0x4a7: Pop(0)
...
0x4b5: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4b6: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x4c8: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4c9: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x4e1: Stack[-2] = "fire" // @poff=619
0x4e2: Return(); Pop(0)

0x4e3: Stack[-2] = "phys" // @poff=629
0x4e4: Return(); Pop(0)

0x4e5: PushEmpty(cvector, cvector, cvector, cvector)
0x4e6: @ GetPosition(Stack[-2])
0x4e7: Pop(0)
0x4e8: @@ GetPosition(Stack[-1]); Obj=5 // @poff=138
0x4e9: Pop(0)
...
0x4ee: Pop(0)
0x4ef: @@ GetPosition(Stack[-2]); Obj=7 // @poff=138
0x4f0: Pop(0)
...
0x4f5: Push("player") // @poff=639
0x4f6: @ FindActor(Stack[-2], Stack[-1])
0x4f7: Pop(1)
0x4f8: Stack[-1] = Stack[-3]
0x4f9: Return(); Pop(2)

0x4fa: Stack[-1] = 0
0x4fb: PushEmpty(bool, bool)
0x4fc: Push("HasProperty") // @poff=653
0x4fd: Push((int) 2)
...
0x503: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=677
0x504: Pop(0)
...
0x509: Stack[-18] = Stack[-2]
0x50a: Stack[-1] = "health" // @poff=689
0x50b: Call 0x4fb
...
0x512: Stack[-18] = Stack[-2]
0x513: Stack[-1] = "armor" // @poff=703
0x514: Call 0x4fb
...
0x51a: Push("armor") // @poff=703
0x51b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=715
0x51c: Pop(1)
0x51d: Push("armor_") // @poff=727
0x51e: PushEmpty(string, int)
0x51f: Stack[-16] = Stack[-1]
0x520: Call 0x4dd

0x521: Pop(1)
0x522: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x523: PushEmpty(bool, object, string)
0x524: Stack[-18] = Stack[-2]
0x525: Stack[-8] = Stack[-1]
0x526: Call 0x4fb
...
0x52c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=715
0x52d: Pop(0)
...
0x534: Stack[-3] = Stack[-6]
0x535: Pop(3)
0x536: Push("health") // @poff=689
0x537: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=715
0x538: Pop(1)
0x539: Push((int) 1)
0x53a: Pop(1); Push(Stack[-1] - Stack[-4]);
0x53b: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x53c: Push("health") // @poff=689
...
0x542: Pop(3)
0x543: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=741
0x544: Pop(2)
0x545: Stack[-1] = Stack[-16]
0x546: Return(); Pop(12)

0x547: PushEmpty(bool, bool)
0x548: @@ IsDead(Stack[-1]); Obj=3 // @poff=753
0x549: Pop(0)
0x54a: Stack[-1] = Stack[-4]
0x54b: Return(); Pop(2)
...
0x561: Pop(0)
0x562: Pop(0); PushNull((bool) Stack[-2] == 0)
0x563: IF (Stack[-1] == 0) GOTO 0x566; Pop(1)

0x564: Stack[-6] = (bool) 0
0x565: Return(); Pop(4)

0x566: @@ GetScene(Stack[-1]); Obj=5 // @poff=774
0x567: Pop(0)
...
0x57b: Stack[-1] = "noaccess" // @poff=783
0x57c: Call 0x4fb
...
0x582: Push("noaccess") // @poff=783
0x583: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=715
0x584: Pop(1)
0x585: Push((int) 0)
...
0x5ae: @@ GetPosition(Stack[-5]); Obj=23 // @poff=138
0x5af: Pop(0)
...
0x5bf: Stack[-1] = "fhit" // @poff=821
0x5c0: GOTO 0x5c2

0x5c1: Stack[-1] = "bhit" // @poff=831
0x5c2: Push("hit_react") // @poff=841
0x5c3: Push("1") // @poff=450
0x5c4: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5c5: Push("2") // @poff=861
...
0x5cc: @@ GetPosition(Stack[-3]); Obj=7 // @poff=138
0x5cd: Pop(0)
...
0x5d8: Pop(0)
0x5d9: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=274
0x5da: Pop(0)
...
0x5de: @@ GetPosition(Stack[-7]); Obj=17 // @poff=138
0x5df: Pop(0)
0x5e0: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=274
0x5e1: Pop(0)
...
0x621: Pop(0)
0x622: Push("start: ") // @poff=883
0x623: Pop(1); Push(Stack[-1] + Stack[-3]);
0x624: @ Trace(Stack[-1])
0x625: Pop(1)
0x626: Push("end: ") // @poff=899
...
0x63b: Push((float)9.999999974752427e-07)
...
0x692: Stack[-1] = 0
0x693: PushEmpty()
0x694: Push("d11q01") // @poff=911
0x695: Push((int) 3)
0x696: @ SetVariable(Stack[-2], Stack[-1])
0x697: Pop(2)
0x698: PushEmpty(bool, string, string)
0x699: Stack[-2] = "quest_d11_01" // @poff=560
0x69a: Stack[-1] = "soldier_attack" // @poff=586
0x69b: Call 0x687

0x69c: Pop(3)
0x69d: PushEmpty(bool, string, string)
0x69e: Stack[-2] = "quest_d11_01" // @poff=560
0x69f: Stack[-1] = "restore_andrei" // @poff=925
0x6a0: Call 0x687
...
0x6a3: PushEmpty()
0x6a4: Push("ood11Officer1") // @poff=955
0x6a5: Push((int) 1)
...
0x6ab: Stack[-1] = "ood11Officer1" // @poff=955
0x6ac: Call 0x682
...
0x6c9: Push("GenerateMoney: iMin > iMax") // @poff=983
0x6ca: @ Trace(Stack[-1])
0x6cb: Pop(1)
0x6cc: Return(); Pop(8)
...
0x6f4: Stack[-1] = "rifle_ammo" // @poff=1049
0x6f5: Call 0x709
...
0x718: Stack[-7] = Stack[-3]
0x719: Stack[-6] = Stack[-2]
0x71a: Stack[-5] = Stack[-1]
0x71b: Call 0x588
...
0x787: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=616
0x788: Pop(1)
0x789: Push(Stack[-1])
...
0x78e: Stack[-5] = Stack[-1]
0x78f: Call 0x778

0x790: Stack[-2] = Stack[-6]
0x791: Pop(2)
0x792: Return(); Pop(2)

0x793: PushEmpty()
0x794: PushEmpty(object)
0x795: Stack[-2] = Stack[-1]
0x796: Call 0x7c7
...
0x79b: Stack[-8] = Stack[-2]
0x79c: Stack[-1] = "reputation" // @poff=1085
0x79d: Call 0x4fb
...
0x7a3: Push("reputation") // @poff=1085
0x7a4: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=715
0x7a5: Pop(1)
...
0x7af: Push(Stack[-2])
0x7b0: IF (Stack[-1] == 1) GOTO 0x7b9; Pop(1)

0x7b1: PushEmpty(float, object)
0x7b2: Stack[-9] = Stack[-1]
0x7b3: Call 0x4ec
...
0x7ba: Push((float)-0.20000000298023224)
...
0x7c3: Stack[-1] = "ui/NPC_Black.png" // @poff=1107
0x7c4: Return(); Pop(0)
...
0x7d2: Pop(0)
0x7d3: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=1141
0x7d4: Pop(1)
0x7d5: PushEmpty(object)
0x7d6: Stack[-4] = Stack[-1]
0x7d7: Call 0x70e
