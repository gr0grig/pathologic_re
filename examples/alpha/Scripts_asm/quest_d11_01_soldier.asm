...
// @pool_raw:
...
0x2de: Stack[-2] = "quest_d11_01" // @poff=440
0x2df: Stack[-1] = "soldier_attack" // @poff=466
0x2e0: Call 0x59f
...
0x2fc: Pop(1)
0x2fd: Push("all") // @poff=170
0x2fe: Push("attack_off") // @poff=252
...
0x30b: Stack[-2] = "quest_d11_01" // @poff=440
0x30c: Stack[-1] = "soldier_attack" // @poff=466
0x30d: Call 0x59f
...
0x31e: Push("all") // @poff=170
0x31f: Push("attack_on") // @poff=232
...
0x331: Stack[-5] = Stack[-2]
0x332: Stack[-4] = Stack[-1]
0x333: Call 0x58e

0x334: Pop(2)
0x335: Push((float)0.7071067690849304)
...
0x33a: Stack[-1] = (float) 4.71238899230957
0x33b: Call 0x547
...
0x34d: IF (Stack[-1] == 1) GOTO 0x329; Pop(1)

0x34e: @ StopAsync()
0x34f: Pop(0)
0x350: Push("spine") // @poff=496
...
0x356: Pop(0)
0x357: @@@ GetEyesHeight(Stack[-2]); Obj=0 // @poff=146
0x358: Pop(0)
...
0x35d: Push("spine") // @poff=496
0x35e: @ DirLookAsyncRel(Stack[-0]T, Stack[-1], Stack[-2])
0x35f: Pop(1)
0x360: Return(); Pop(6)
...
0x36a: Pop(1)
0x36b: Push("all") // @poff=170
0x36c: Push("attack_on") // @poff=232
...
0x386: Stack[-2] = "quest_d11_01" // @poff=440
0x387: Stack[-1] = "soldier_attack" // @poff=466
0x388: Call 0x59f
...
0x3be: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=508
0x3bf: Pop(1)
...
0x3e3: Stack[-5] = Stack[-2]
0x3e4: Stack[-4] = Stack[-1]
0x3e5: Call 0x67e
...
0x3fc: @ GetPFPosition(Stack[-1]T)
0x3fd: Pop(0)
0x3fe: @ GetDirection(Stack[-0]T)
0x3ff: Pop(0)
0x400: Push((int) 60)
...
0x417: @ FindPathTo(Stack[-1], Stack[-1]T)
0x418: Pop(0)
...
0x426: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x427: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x439: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x43a: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x452: Stack[-2] = "fire" // @poff=511
0x453: Return(); Pop(0)

0x454: Stack[-2] = "phys" // @poff=521
0x455: Return(); Pop(0)

0x456: PushEmpty(cvector, cvector, cvector, cvector)
0x457: @ GetPosition(Stack[-2])
0x458: Pop(0)
0x459: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x45a: Pop(0)
...
0x45f: Pop(0)
0x460: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x461: Pop(0)
...
0x46d: Push("HasProperty") // @poff=545
0x46e: Push((int) 2)
...
0x474: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=569
0x475: Pop(0)
0x476: Stack[-1] = Stack[-5]
0x477: Return(); Pop(2)

0x478: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x479: PushEmpty(bool, object, string)
0x47a: Stack[-18] = Stack[-2]
0x47b: Stack[-1] = "health" // @poff=581
0x47c: Call 0x46c
...
0x483: Stack[-18] = Stack[-2]
0x484: Stack[-1] = "armor" // @poff=595
0x485: Call 0x46c
...
0x48b: Push("armor") // @poff=595
0x48c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=607
0x48d: Pop(1)
0x48e: Push("armor_") // @poff=619
0x48f: PushEmpty(string, int)
0x490: Stack[-16] = Stack[-1]
0x491: Call 0x44e

0x492: Pop(1)
0x493: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x494: PushEmpty(bool, object, string)
0x495: Stack[-18] = Stack[-2]
0x496: Stack[-8] = Stack[-1]
0x497: Call 0x46c
...
0x49d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=607
0x49e: Pop(0)
...
0x4a5: Stack[-3] = Stack[-6]
0x4a6: Pop(3)
0x4a7: Push("health") // @poff=581
0x4a8: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=607
0x4a9: Pop(1)
0x4aa: Push((int) 1)
0x4ab: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4ac: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4ad: Push("health") // @poff=581
...
0x4b3: Pop(3)
0x4b4: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=633
0x4b5: Pop(2)
0x4b6: Stack[-1] = Stack[-16]
0x4b7: Return(); Pop(12)

0x4b8: PushEmpty(bool, bool)
0x4b9: @@ IsDead(Stack[-1]); Obj=3 // @poff=645
0x4ba: Pop(0)
0x4bb: Stack[-1] = Stack[-4]
0x4bc: Return(); Pop(2)
...
0x4d2: Pop(0)
0x4d3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4d4: IF (Stack[-1] == 0) GOTO 0x4d7; Pop(1)

0x4d5: Stack[-6] = (bool) 0
0x4d6: Return(); Pop(4)

0x4d7: @@ GetScene(Stack[-1]); Obj=5 // @poff=666
0x4d8: Pop(0)
...
0x4ec: Stack[-1] = "noaccess" // @poff=675
0x4ed: Call 0x46c
...
0x4f3: Push("noaccess") // @poff=675
0x4f4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=607
0x4f5: Pop(1)
0x4f6: Push((int) 0)
...
0x51f: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x520: Pop(0)
...
0x530: Stack[-1] = "fhit" // @poff=713
0x531: GOTO 0x533

0x532: Stack[-1] = "bhit" // @poff=723
0x533: Push("hit_react") // @poff=733
0x534: Push("1") // @poff=330
0x535: Pop(1); Push(Stack[-3] + Stack[-1]);
0x536: Push("2") // @poff=753
...
0x53d: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x53e: Pop(0)
...
0x548: @@ GetPosition(Stack[-3]); Obj=8 // @poff=10
0x549: Pop(0)
...
0x554: Pop(0)
0x555: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x556: Pop(0)
...
0x5a1: Pop(0)
0x5a2: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5ae: Push("GenerateMoney: iMin > iMax") // @poff=757
0x5af: @ Trace(Stack[-1])
0x5b0: Pop(1)
0x5b1: Return(); Pop(8)
...
0x5d9: Stack[-1] = "rifle_ammo" // @poff=823
0x5da: Call 0x5ee
...
0x66c: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=508
0x66d: Pop(1)
0x66e: Push(Stack[-1])
...
0x680: Stack[-8] = Stack[-2]
0x681: Stack[-1] = "reputation" // @poff=859
0x682: Call 0x46c
...
0x688: Push("reputation") // @poff=859
0x689: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=607
0x68a: Pop(1)
...
0x694: Push(Stack[-2])
0x695: IF (Stack[-1] == 1) GOTO 0x69e; Pop(1)

0x696: PushEmpty(float, object)
0x697: Stack[-9] = Stack[-1]
0x698: Call 0x45d
...
0x69f: Push((float)-0.20000000298023224)
...
0x6b1: Pop(0)
0x6b2: @@ RemoveStationaryActor(Stack[-1]); Obj=2 // @poff=881
0x6b3: Pop(1)
