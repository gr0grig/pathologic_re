...
0x15a: @@ size(Stack[-3]); Obj=7 // @poff=912
0x15b: Pop(0)
0x15c: Stack[-2] = (int) 0
0x15d: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x15e: IF (Stack[-1] == 0) GOTO 0x169; Pop(1)

0x15f: @@ get(Stack[-1], Stack[-2]); Obj=7 // @poff=917
0x160: Pop(0)
0x161: Push(Stack[-1])
...
0x165: Stack[-1] = 0
0x166: Push((int) 1)
0x167: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x168: GOTO 0x15d

0x169: @@ clear(); Obj=7 // @poff=1033
0x16a: Pop(0)
0x16b: Return(); Pop(6)

0x16c: PushEmpty(int, int, object, int, int, object)
0x16d: @@ size(Stack[-3]); Obj=8 // @poff=912
0x16e: Pop(0)
0x16f: Stack[-2] = (int) 0
0x170: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x171: IF (Stack[-1] == 0) GOTO 0x17c; Pop(1)

0x172: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=917
0x173: Pop(0)
0x174: Push(Stack[-1])
