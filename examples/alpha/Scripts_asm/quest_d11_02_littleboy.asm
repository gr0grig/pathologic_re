...
Strings:
	...
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x1a3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1a4: Pop(3)
0x1a5: Return(); Pop(0)
...
0x1f9: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x1fa: Pop(0)
0x1fb: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x1fc: Pop(0)
...
0x23c: Pop(0)
0x23d: Push("start: ") // @poff=204
0x23e: Pop(1); Push(Stack[-1] + Stack[-3]);
0x23f: @ Trace(Stack[-1])
0x240: Pop(1)
0x241: Push("end: ") // @poff=220
...
0x256: Push((float)9.999999974752427e-07)
...
0x263: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x264: Pop(0)
0x265: Push("Category") // @poff=242
0x266: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x267: Pop(1)
0x268: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x269: Pop(0)
0x26a: Pop(0); Push((bool) Stack[-1] == 0)
0x26b: IF (Stack[-1] == 0) GOTO 0x26e; Pop(1)

0x26c: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x26d: Pop(0)
0x26e: Return(); Pop(6)
...
0x271: Pop(0)
0x272: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x273: Pop(0)
0x274: PushEmpty(object, object, int)
0x275: Stack[-8] = Stack[-3]
...
0x287: Stack[-1] = 0
0x288: PushEmpty()
0x289: Push("playsound") // @poff=290
0x28a: Push("giveitem") // @poff=310
0x28b: @ TriggerWorld(Stack[-2], Stack[-1])
0x28c: Pop(2)
0x28d: Return(); Pop(0)

0x28e: PushEmpty()
0x28f: Push("revolver ammo6 is given") // @poff=328
0x290: @ Trace(Stack[-1])
0x291: Pop(1)
0x292: PushEmpty(object, string, int)
0x293: Stack[-5] = Stack[-3]
0x294: Stack[-2] = "revolver_ammo" // @poff=376
0x295: Stack[-1] = (int) 6
0x296: Call 0x26f
...
0x2a5: Stack[-2] = "quest_d11_02" // @poff=418
0x2a6: Stack[-1] = "init_graveyard" // @poff=444
0x2a7: Call 0x27c
...
0x2b6: Stack[-2] = "quest_d11_02" // @poff=418
0x2b7: Stack[-1] = "completed" // @poff=474
0x2b8: Call 0x27c
...
0x2bb: PushEmpty()
0x2bc: Push("ood11ULittleBoy1") // @poff=494
0x2bd: Push((int) 1)
...
0x2c1: PushEmpty()
0x2c2: Push("ood11ULittleBoy2") // @poff=528
0x2c3: Push((int) 1)
...
0x2c7: PushEmpty()
0x2c8: Push((int) 1000)
0x2c9: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=562
0x2ca: Pop(1)
0x2cb: Return(); Pop(0)

0x2cc: PushEmpty()
0x2cd: PushEmpty(int, string)
0x2ce: Stack[-1] = "d11q02" // @poff=404
0x2cf: Call 0x25d
...
0x2fe: Stack[-1] = "ood11ULittleBoy1" // @poff=494
0x2ff: Call 0x25d
...
0x30a: Stack[-1] = "ood11ULittleBoy2" // @poff=528
0x30b: Call 0x25d
...
0x319: Push("Can't retrieve diary root") // @poff=577
0x31a: @ Trace(Stack[-1])
0x31b: Pop(1)
...
0x324: Stack[-1] = Stack[-4]
0x325: Pop(1)
0x326: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=629
0x327: Pop(0)
0x328: Pop(0); Push((bool) Stack[-2] == 0)
0x329: IF (Stack[-1] == 0) GOTO 0x330; Pop(1)

0x32a: Push("Can't find diary parent with id: ") // @poff=634
...
0x330: @@ AddChild(Stack[-8]); Obj=2 // @poff=702
0x331: Pop(0)
0x332: Push("player_diary") // @poff=711
0x333: Push((int) 1)
0x334: @ SetVariable(Stack[-2], Stack[-1])
0x335: Pop(2)
0x336: @@ GetCategory(Stack[-1]); Obj=8 // @poff=737
0x337: Pop(0)
...
0x350: Push("Adding diary entry") // @poff=763
0x351: @ Trace(Stack[-1])
0x352: Pop(1)
0x353: Push((int) 197)
0x354: Push((int) 2)
...
0x360: Push("Adding diary entry") // @poff=763
0x361: @ Trace(Stack[-1])
0x362: Pop(1)
0x363: Push((int) 198)
0x364: Push((int) 2)
...
0x370: Push("Adding diary entry") // @poff=763
0x371: @ Trace(Stack[-1])
0x372: Pop(1)
0x373: Push((int) 199)
0x374: Push((int) 2)
...
0x381: Stack[-1] = "ui/NPC_None.png" // @poff=801
0x382: Return(); Pop(0)
