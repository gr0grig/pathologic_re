...
Strings:
	...
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x70: Stack[-1] = (bool) 1
0x71: IF (Stack[-1] == 1) GOTO 0x81; Pop(1)
...
0x83: Push((int) 15377)
0x84: Push((int) 15376)
0x85: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x86: Pop(3)
0x87: PushEmpty(bool)
0x88: Stack[-1] = (bool) 0
...
0x96: Push((int) 15380)
0x97: Push((int) 15379)
0x98: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x99: Pop(3)
0x9a: Push((int) 14168)
0x9b: Push((int) -1)
0x9c: Push((int) 15382)
...
0xb1: Push("all") // @poff=110
0xb2: Push("idle") // @poff=118
...
0xba: Push("all") // @poff=110
0xbb: Push("idle") // @poff=118
...
0x116: Stack[-1] = "Neutral" // @poff=61
0x117: Call 0xc0

0x118: Pop(1)
0x119: Push((int) 14156)
0x11a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x11b: Pop(1)
0x11c: @@@ ClearReplies(); Obj=0 // @poff=88
0x11d: Pop(0)
...
0x13c: IF (Stack[-1] == 1) GOTO 0x14c; Pop(1)
...
0x14a: IF (Stack[-1] == 1) GOTO 0x14c; Pop(1)
...
0x163: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x164: Pop(3)
...
0x20b: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x20c: Pop(0)
0x20d: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x20e: Pop(0)
...
0x24e: Pop(0)
0x24f: Push("start: ") // @poff=204
0x250: Pop(1); Push(Stack[-1] + Stack[-3]);
0x251: @ Trace(Stack[-1])
0x252: Pop(1)
0x253: Push("end: ") // @poff=220
...
0x268: Push((float)9.999999974752427e-07)
...
0x271: Pop(0)
0x272: Stack[-1] = Stack[-4]
0x273: Return(); Pop(2)

0x274: PushEmpty(int, int, bool, int, int, bool)
0x275: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x276: Pop(0)
0x277: Push("Category") // @poff=242
0x278: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x279: Pop(1)
0x27a: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x27b: Pop(0)
0x27c: Pop(0); Push((bool) Stack[-1] == 0)
0x27d: IF (Stack[-1] == 0) GOTO 0x280; Pop(1)

0x27e: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x27f: Pop(0)
0x280: Return(); Pop(6)
...
0x283: Pop(0)
0x284: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x285: Pop(0)
0x286: PushEmpty(object, object, int)
0x287: Stack[-8] = Stack[-3]
0x288: Stack[-4] = Stack[-2]
0x289: Stack[-6] = Stack[-1]
0x28a: Call 0x274
...
0x290: Pop(0)
0x291: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x299: Stack[-1] = 0
0x29a: PushEmpty()
0x29b: Push("playsound") // @poff=290
0x29c: Push("giveitem") // @poff=310
0x29d: @ TriggerWorld(Stack[-2], Stack[-1])
0x29e: Pop(2)
0x29f: Return(); Pop(0)

0x2a0: PushEmpty()
0x2a1: Push("powder is given") // @poff=328
0x2a2: @ Trace(Stack[-1])
0x2a3: Pop(1)
0x2a4: PushEmpty(object, string, int)
0x2a5: Stack[-5] = Stack[-3]
0x2a6: Stack[-2] = "powder" // @poff=360
0x2a7: Stack[-1] = (int) 1
0x2a8: Call 0x281
...
0x2ab: PushEmpty()
0x2ac: Push("ood11ULittleGirl1") // @poff=374
0x2ad: Push((int) 1)
...
0x2bd: Stack[-2] = "quest_d11_02" // @poff=424
0x2be: Stack[-1] = "init_graveyard" // @poff=450
0x2bf: Call 0x28e
...
0x2ce: Stack[-2] = "quest_d11_02" // @poff=424
0x2cf: Stack[-1] = "completed" // @poff=480
0x2d0: Call 0x28e
...
0x2d3: PushEmpty()
0x2d4: Push("ood11ULittleGirl2") // @poff=500
0x2d5: Push((int) 1)
...
0x2d9: PushEmpty()
0x2da: Push((int) 1000)
0x2db: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=536
0x2dc: Pop(1)
0x2dd: Return(); Pop(0)

0x2de: PushEmpty()
0x2df: PushEmpty(int, string)
0x2e0: Stack[-1] = "ood11ULittleGirl1" // @poff=374
0x2e1: Call 0x26f
...
0x310: Stack[-1] = "ood11ULittleGirl2" // @poff=500
0x311: Call 0x26f
...
0x32b: Push("Can't retrieve diary root") // @poff=551
0x32c: @ Trace(Stack[-1])
0x32d: Pop(1)
...
0x337: Pop(1)
0x338: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=603
0x339: Pop(0)
0x33a: Pop(0); Push((bool) Stack[-2] == 0)
0x33b: IF (Stack[-1] == 0) GOTO 0x342; Pop(1)

0x33c: Push("Can't find diary parent with id: ") // @poff=608
...
0x342: @@ AddChild(Stack[-8]); Obj=2 // @poff=676
0x343: Pop(0)
0x344: Push("player_diary") // @poff=685
0x345: Push((int) 1)
0x346: @ SetVariable(Stack[-2], Stack[-1])
0x347: Pop(2)
0x348: @@ GetCategory(Stack[-1]); Obj=8 // @poff=711
0x349: Pop(0)
...
0x362: Push("Adding diary entry") // @poff=737
0x363: @ Trace(Stack[-1])
0x364: Pop(1)
0x365: Push((int) 197)
0x366: Push((int) 2)
...
0x372: Push("Adding diary entry") // @poff=737
0x373: @ Trace(Stack[-1])
0x374: Pop(1)
0x375: Push((int) 198)
0x376: Push((int) 2)
...
0x382: Push("Adding diary entry") // @poff=737
0x383: @ Trace(Stack[-1])
0x384: Pop(1)
0x385: Push((int) 199)
0x386: Push((int) 2)
...
0x393: Stack[-1] = "ui/NPC_None.png" // @poff=775
0x394: Return(); Pop(0)
