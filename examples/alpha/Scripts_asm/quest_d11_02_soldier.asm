...
Strings:
	...
	W:actor_unload
	W:soldier_dead
// @pool_raw:
...
0x9d: IF (Stack[-1] == 1) GOTO 0xa5; Pop(1)
...
0x10c: @ CanSee(Stack[-1]T, Stack[-0]T)
0x10d: Pop(0)
...
0x11b: @ Face(Stack[-0]T)
0x11c: Pop(0)
0x11d: Push("all") // @poff=170
0x11e: Push("shoot_begin") // @poff=178
...
0x128: Push("shot") // @poff=202
0x129: @ Speak(Stack[-1])
0x12a: Pop(1)
0x12b: Push("all") // @poff=170
0x12c: Push("shoot_end") // @poff=212
...
0x145: @ CanSee(Stack[-1]T, Stack[-0]T)
0x146: Pop(0)
...
0x163: Push("attack_off") // @poff=252
...
0x18b: Stack[-5] = Stack[-2]
0x18c: Stack[-4] = Stack[-1]
0x18d: Call 0x642
...
0x1ab: Push("all") // @poff=170
0x1ac: Push("attack_on") // @poff=232
0x1ad: @ PlayAnimation(Stack[-2], Stack[-1])
0x1ae: Pop(2)
0x1af: @ WaitForAnimEnd()
0x1b0: Pop(0)
0x1b1: Push("all") // @poff=170
0x1b2: Push("attack_on") // @poff=232
...
0x1bd: @ CanSee(Stack[-1], Stack[-0]T)
0x1be: Pop(0)
0x1bf: Push(Stack[-1])
...
0x1ca: Push("all") // @poff=170
0x1cb: Push("hunt") // @poff=274
...
0x1ee: Push("all") // @poff=170
0x1ef: Push("attack_on") // @poff=232
...
0x1fb: Pop(0)
0x1fc: Push("all") // @poff=170
0x1fd: Push("attack_on") // @poff=232
...
0x209: @ CanSee(Stack[-1], Stack[-0]T)
0x20a: Pop(0)
0x20b: Push(Stack[-1])
0x20c: IF (Stack[-1] == 0) GOTO 0x213; Pop(1)

0x20d: @ Face(Stack[-0]T)
0x20e: Pop(0)
0x20f: PushEmpty()
0x210: Call 0x24e
...
0x221: @ StopAsync()
0x222: Pop(0)
0x223: Push("all") // @poff=170
0x224: Push("attack_off") // @poff=252
...
0x256: Stack[-2] = Stack[-10]
0x257: Pop(2)
0x258: PushEmpty(float, cvector, cvector)
0x259: Stack[-12] = Stack[-2]
0x25a: Stack[-11] = Stack[-1]
0x25b: Call 0x552

0x25c: Pop(2)
0x25d: Push((float)0.9659258127212524)
0x25e: Pop(2); Push((bool) Stack[-2] < Stack[-1])
0x25f: IF (Stack[-1] == 0) GOTO 0x261; Pop(1)

0x260: Return(); Pop(18)

0x261: Push("all") // @poff=170
0x262: Push("attack_begin1") // @poff=306
0x263: @ PlayAnimation(Stack[-2], Stack[-1])
0x264: Pop(2)
0x265: @ WaitForAnimEnd()
0x266: Pop(0)
0x267: Push("shot") // @poff=202
0x268: @ Speak(Stack[-1])
0x269: Pop(1)
...
0x278: Push((float)0.2617993950843811)
...
0x286: Stack[-4] = Stack[-7]
0x287: Pop(4)
0x288: Push((int) 2)
0x289: Push((float)1.5)
0x28a: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-5], Stack[-1])
0x28b: Pop(2)
0x28c: GOTO 0x29c
...
0x291: Pop(0)
0x292: Push("scripted") // @poff=334
0x293: Push(CVector(0.0, 0.0, 1.0))
0x294: Push("richochet.xml") // @poff=352
0x295: @ AddActorByType(Stack[-4], Stack[-3], Stack[-5], Stack[-7], Stack[-2], Stack[-1])
0x296: Pop(3)
0x297: Push("Material") // @poff=380
0x298: @@ SetScriptProperty(Stack[-1], Stack[-6]); Obj=2 // @poff=398
0x299: Pop(1)
0x29a: Stack[-1] = 0
0x29b: Stack[-2] = 0
0x29c: Push("all") // @poff=170
0x29d: Push("attack_end1") // @poff=416
0x29e: @ PlayAnimation(Stack[-2], Stack[-1])
0x29f: Pop(2)
0x2a0: @ WaitForAnimEnd()
0x2a1: Pop(0)
0x2a2: Push("all") // @poff=170
0x2a3: Push("attack_on") // @poff=232
...
0x2c2: Stack[-5] = Stack[-2]
0x2c3: Stack[-4] = Stack[-1]
0x2c4: Call 0x642
...
0x2ea: Stack[-2] = "quest_d11_02" // @poff=470
0x2eb: Stack[-1] = "soldier_attack" // @poff=496
0x2ec: Call 0x563
...
0x346: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=558
0x347: Pop(1)
...
0x384: @ GetPFPosition(Stack[-1]T)
0x385: Pop(0)
0x386: @ GetDirection(Stack[-0]T)
0x387: Pop(0)
0x388: Push((int) 60)
...
0x39f: @ FindPathTo(Stack[-1], Stack[-1]T)
0x3a0: Pop(0)
...
0x3ae: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3af: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3c1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x3c2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x3d7: Push("all") // @poff=170
0x3d8: Push("attack_on") // @poff=232
...
0x3df: Push("all") // @poff=170
0x3e0: Push("attack_on") // @poff=232
...
0x3e8: Push("all") // @poff=170
0x3e9: Push("attack_begin1") // @poff=306
0x3ea: @ PlayAnimation(Stack[-2], Stack[-1])
0x3eb: Pop(2)
0x3ec: @ WaitForAnimEnd()
0x3ed: Pop(0)
0x3ee: PushEmpty(bool, string, string)
0x3ef: Stack[-2] = "quest_d11_02" // @poff=470
0x3f0: Stack[-1] = "execute" // @poff=454
0x3f1: Call 0x563

0x3f2: Pop(3)
0x3f3: Push("shot") // @poff=202
0x3f4: @ Speak(Stack[-1])
0x3f5: Pop(1)
0x3f6: Push("all") // @poff=170
0x3f7: Push("attack_begin2") // @poff=561
0x3f8: @ PlayAnimation(Stack[-2], Stack[-1])
0x3f9: Pop(2)
0x3fa: @ WaitForAnimEnd()
0x3fb: Pop(0)
0x3fc: Push("all") // @poff=170
0x3fd: Push("attack_off") // @poff=252
...
0x410: Stack[-2] = "quest_d11_02" // @poff=470
0x411: Stack[-1] = "soldier_attack" // @poff=496
0x412: Call 0x563
...
0x421: Stack[-2] = "fire" // @poff=589
0x422: Return(); Pop(0)

0x423: Stack[-2] = "phys" // @poff=599
0x424: Return(); Pop(0)

0x425: PushEmpty(cvector, cvector, cvector, cvector)
0x426: @ GetPosition(Stack[-2])
0x427: Pop(0)
0x428: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x429: Pop(0)
...
0x42e: Pop(0)
0x42f: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x430: Pop(0)
...
0x43c: Push("HasProperty") // @poff=623
0x43d: Push((int) 2)
...
0x443: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=647
0x444: Pop(0)
...
0x449: Stack[-18] = Stack[-2]
0x44a: Stack[-1] = "health" // @poff=659
0x44b: Call 0x43b
...
0x452: Stack[-18] = Stack[-2]
0x453: Stack[-1] = "armor" // @poff=673
0x454: Call 0x43b
...
0x45a: Push("armor") // @poff=673
0x45b: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=685
0x45c: Pop(1)
0x45d: Push("armor_") // @poff=697
0x45e: PushEmpty(string, int)
0x45f: Stack[-16] = Stack[-1]
0x460: Call 0x41d

0x461: Pop(1)
0x462: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x463: PushEmpty(bool, object, string)
0x464: Stack[-18] = Stack[-2]
0x465: Stack[-8] = Stack[-1]
0x466: Call 0x43b
...
0x46c: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=685
0x46d: Pop(0)
...
0x474: Stack[-3] = Stack[-6]
0x475: Pop(3)
0x476: Push("health") // @poff=659
0x477: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=685
0x478: Pop(1)
0x479: Push((int) 1)
0x47a: Pop(1); Push(Stack[-1] - Stack[-4]);
0x47b: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x47c: Push("health") // @poff=659
...
0x482: Pop(3)
0x483: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=711
0x484: Pop(2)
0x485: Stack[-1] = Stack[-16]
0x486: Return(); Pop(12)

0x487: PushEmpty(bool, bool)
0x488: @@ IsDead(Stack[-1]); Obj=3 // @poff=723
0x489: Pop(0)
0x48a: Stack[-1] = Stack[-4]
0x48b: Return(); Pop(2)

0x48c: PushEmpty(object, object, object, object)
0x48d: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4a1: Pop(0)
0x4a2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4a3: IF (Stack[-1] == 0) GOTO 0x4a6; Pop(1)

0x4a4: Stack[-6] = (bool) 0
0x4a5: Return(); Pop(4)

0x4a6: @@ GetScene(Stack[-1]); Obj=5 // @poff=744
0x4a7: Pop(0)
...
0x4ba: Stack[-6] = Stack[-2]
0x4bb: Stack[-1] = "noaccess" // @poff=753
0x4bc: Call 0x43b
...
0x4c2: Push("noaccess") // @poff=753
0x4c3: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=685
0x4c4: Pop(1)
0x4c5: Push((int) 0)
...
0x4ee: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x4ef: Pop(0)
...
0x4ff: Stack[-1] = "fhit" // @poff=791
0x500: GOTO 0x502

0x501: Stack[-1] = "bhit" // @poff=801
0x502: Push("hit_react") // @poff=811
0x503: Push("1") // @poff=330
0x504: Pop(1); Push(Stack[-3] + Stack[-1]);
0x505: Push("2") // @poff=492
...
0x50c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x50d: Pop(0)
...
0x518: Pop(0)
0x519: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x51a: Pop(0)
...
0x565: Pop(0)
0x566: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x572: Push("GenerateMoney: iMin > iMax") // @poff=831
0x573: @ Trace(Stack[-1])
0x574: Pop(1)
0x575: Return(); Pop(8)
...
0x59d: Stack[-1] = "rifle_ammo" // @poff=897
0x59e: Call 0x5b2
...
0x5c1: Stack[-7] = Stack[-3]
0x5c2: Stack[-6] = Stack[-2]
...
0x606: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=558
0x607: Pop(1)
0x608: Push(Stack[-1])
...
0x630: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=558
0x631: Pop(1)
0x632: Push(Stack[-1])
...
0x637: Stack[-5] = Stack[-1]
0x638: Call 0x621

0x639: Stack[-2] = Stack[-6]
0x63a: Pop(2)
0x63b: Return(); Pop(2)
...
0x644: Stack[-8] = Stack[-2]
0x645: Stack[-1] = "reputation" // @poff=933
0x646: Call 0x43b
...
0x64c: Push("reputation") // @poff=933
0x64d: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=685
0x64e: Pop(1)
...
0x658: Push(Stack[-2])
0x659: IF (Stack[-1] == 1) GOTO 0x662; Pop(1)

0x65a: PushEmpty(float, object)
0x65b: Stack[-9] = Stack[-1]
0x65c: Call 0x42c
...
0x663: Push((float)-0.20000000298023224)
...
0x66b: Stack[-2] = "quest_d11_02" // @poff=470
0x66c: Stack[-1] = "actor_unload" // @poff=955
0x66d: Call 0x563
...
0x67f: Stack[-2] = "quest_d11_02" // @poff=470
0x680: Stack[-1] = "soldier_dead" // @poff=981
0x681: Call 0x563
