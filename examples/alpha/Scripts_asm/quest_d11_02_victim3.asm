...
0xc3: Push("all") // @poff=110
0xc4: Push("bdie") // @poff=144
0xc5: @ LockAnimationEnd(Stack[-2], Stack[-1])
0xc6: Pop(2)
0xc7: GOTO 0xcc

0xc8: PushEmpty(string)
0xc9: Stack[-4] = Stack[-1]
0xca: Call 0xe0
...
0xcf: Push("all") // @poff=110
0xd0: Push("bdie") // @poff=144
0xd1: @ LockAnimationEnd(Stack[-2], Stack[-1])
0xd2: Pop(2)
0xd3: Return(); Pop(0)

0xd4: PushEmpty(int, int)
0xd5: Push("d11q02") // @poff=154
...
0x10f: @@ GetPosition(Stack[-7]); Obj=17 // @poff=200
0x110: Pop(0)
0x111: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=212
0x112: Pop(0)
...
0x152: Pop(0)
0x153: Push("start: ") // @poff=244
0x154: Pop(1); Push(Stack[-1] + Stack[-3]);
0x155: @ Trace(Stack[-1])
0x156: Pop(1)
0x157: Push("end: ") // @poff=260
...
0x16c: Push((float)9.999999974752427e-07)
...
0x175: Pop(0)
0x176: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x180: Stack[-2] = "quest_d11_02" // @poff=272
0x181: Stack[-1] = "actor_unload" // @poff=298
0x182: Call 0x173
...
0x196: Stack[-1] = (int) 3349
0x197: Return(); Pop(0)

0x198: Stack[-1] = "ui/NPC_None.png" // @poff=338
0x199: Return(); Pop(0)
