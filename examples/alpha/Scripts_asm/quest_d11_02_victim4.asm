...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0xd5: Push("all") // @poff=110
0xd6: Push("bdie") // @poff=144
...
0xe1: Push("all") // @poff=110
0xe2: Push("bdie") // @poff=144
0xe3: @ LockAnimationEnd(Stack[-2], Stack[-1])
0xe4: Pop(2)
0xe5: Return(); Pop(0)

0xe6: PushEmpty(int, int)
0xe7: Push("d11q02") // @poff=154
...
0x121: @@ GetPosition(Stack[-7]); Obj=17 // @poff=200
0x122: Pop(0)
0x123: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=212
0x124: Pop(0)
...
0x164: Pop(0)
0x165: Push("start: ") // @poff=244
0x166: Pop(1); Push(Stack[-1] + Stack[-3]);
0x167: @ Trace(Stack[-1])
0x168: Pop(1)
0x169: Push("end: ") // @poff=260
...
0x17e: Push((float)9.999999974752427e-07)
...
0x187: Pop(0)
0x188: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x192: Stack[-2] = "quest_d11_02" // @poff=272
0x193: Stack[-1] = "actor_unload" // @poff=298
0x194: Call 0x185
...
0x1aa: Stack[-1] = "ui/NPC_None.png" // @poff=338
0x1ab: Return(); Pop(0)
