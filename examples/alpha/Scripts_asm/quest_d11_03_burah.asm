...
Strings:
	...
	W:player
	W:ui/NPC_Burah.png
// @pool_raw:
// @pool_encoding:utf8
...
0xb1: Stack[-1] = "Neutral" // @poff=61
0xb2: Call 0x8d

0xb3: Pop(1)
0xb4: Push((int) 14326)
0xb5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xb6: Pop(1)
0xb7: @@@ ClearReplies(); Obj=0 // @poff=88
0xb8: Pop(0)
0xb9: Push((int) 14327)
0xba: Push((int) 15550)
0xbb: Push((int) 15549)
0xbc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xbd: Pop(3)
0xbe: Return(); Pop(0)

0xbf: PushEmpty(string)
0xc0: Stack[-1] = "Neutral" // @poff=61
0xc1: Call 0x8d

0xc2: Pop(1)
0xc3: Push((int) 14532)
0xc4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc5: Pop(1)
0xc6: @@@ ClearReplies(); Obj=0 // @poff=88
0xc7: Pop(0)
0xc8: Push((int) 14533)
0xc9: Push((int) -1)
0xca: Push((int) 15764)
...
0xd2: Stack[-1] = "Neutral" // @poff=61
0xd3: Call 0x8d

0xd4: Pop(1)
0xd5: Push((int) 14328)
0xd6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xd7: Pop(1)
0xd8: @@@ ClearReplies(); Obj=0 // @poff=88
0xd9: Pop(0)
0xda: Push((int) 14329)
0xdb: Push((int) 15552)
0xdc: Push((int) 15551)
0xdd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xde: Pop(3)
0xdf: Return(); Pop(0)
...
0xe4: Stack[-1] = "Neutral" // @poff=61
0xe5: Call 0x8d

0xe6: Pop(1)
0xe7: Push((int) 14330)
0xe8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe9: Pop(1)
0xea: @@@ ClearReplies(); Obj=0 // @poff=88
0xeb: Pop(0)
0xec: Push((int) 14331)
0xed: Push((int) 15554)
0xee: Push((int) 15553)
...
0x1cf: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x1d0: Pop(0)
0x1d1: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x1d2: Pop(0)
...
0x212: Pop(0)
0x213: Push("start: ") // @poff=204
0x214: Pop(1); Push(Stack[-1] + Stack[-3]);
0x215: @ Trace(Stack[-1])
0x216: Pop(1)
0x217: Push("end: ") // @poff=220
...
0x22c: Push((float)9.999999974752427e-07)
...
0x238: PushEmpty()
0x239: Push("ood11Burah1") // @poff=232
0x23a: Push((int) 1)
...
0x240: Stack[-1] = "ood11Burah1" // @poff=232
0x241: Call 0x233
...
0x25d: Stack[-1] = "ui/NPC_Burah.png" // @poff=270
0x25e: Return(); Pop(0)
