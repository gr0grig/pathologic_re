...
Strings:
	...
	W:player
	W:ui/NPC_Klara.png
// @pool_raw:
// @pool_encoding:utf8
...
0xf6: Stack[-1] = "Neutral" // @poff=61
0xf7: Call 0x8d

0xf8: Pop(1)
0xf9: Push((int) 14356)
0xfa: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xfb: Pop(1)
0xfc: @@@ ClearReplies(); Obj=0 // @poff=88
0xfd: Pop(0)
0xfe: Push((int) 14357)
0xff: Push((int) 15581)
0x100: Push((int) 15580)
0x101: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x102: Pop(3)
0x103: Return(); Pop(0)
...
0x108: Stack[-1] = "Neutral" // @poff=61
0x109: Call 0x8d

0x10a: Pop(1)
0x10b: Push((int) 14358)
0x10c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x10d: Pop(1)
0x10e: @@@ ClearReplies(); Obj=0 // @poff=88
0x10f: Pop(0)
0x110: Push((int) 14359)
0x111: Push((int) 15583)
0x112: Push((int) 15582)
0x113: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x114: Pop(3)
0x115: Return(); Pop(0)
...
0x11a: Stack[-1] = "Neutral" // @poff=61
0x11b: Call 0x8d

0x11c: Pop(1)
0x11d: Push((int) 14360)
0x11e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x11f: Pop(1)
0x120: @@@ ClearReplies(); Obj=0 // @poff=88
0x121: Pop(0)
...
0x12c: Stack[-1] = "Neutral" // @poff=61
0x12d: Call 0x8d

0x12e: Pop(1)
0x12f: Push((int) 14362)
0x130: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x131: Pop(1)
0x132: @@@ ClearReplies(); Obj=0 // @poff=88
0x133: Pop(0)
...
0x150: Stack[-1] = "Neutral" // @poff=61
0x151: Call 0x8d

0x152: Pop(1)
0x153: Push((int) 14366)
0x154: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x155: Pop(1)
0x156: @@@ ClearReplies(); Obj=0 // @poff=88
0x157: Pop(0)
0x158: Push((int) 14367)
0x159: Push((int) -1)
0x15a: Push((int) 15590)
0x15b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x15c: Pop(3)
0x15d: Return(); Pop(0)
...
0x1a6: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x1a7: Pop(0)
0x1a8: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x1a9: Pop(0)
...
0x1e9: Pop(0)
0x1ea: Push("start: ") // @poff=204
0x1eb: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1ec: @ Trace(Stack[-1])
0x1ed: Pop(1)
0x1ee: Push("end: ") // @poff=220
...
0x203: Push((float)9.999999974752427e-07)
...
0x20f: PushEmpty()
0x210: Push("ood11Klara1") // @poff=232
0x211: Push((int) 1)
...
0x217: Stack[-1] = "ood11Klara1" // @poff=232
0x218: Call 0x20a
...
0x234: Stack[-1] = "ui/NPC_Klara.png" // @poff=270
0x235: Return(); Pop(0)
