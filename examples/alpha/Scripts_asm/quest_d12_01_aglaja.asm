...
Strings:
	...
	W:player
	W:ui/NPC_Aglaja.png
// @pool_raw:
// @pool_encoding:utf8
...
0xc0: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0xc1: Pop(0)
0xc2: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0xc3: Pop(0)
...
0x103: Pop(0)
0x104: Push("start: ") // @poff=172
0x105: Pop(1); Push(Stack[-1] + Stack[-3]);
0x106: @ Trace(Stack[-1])
0x107: Pop(1)
0x108: Push("end: ") // @poff=188
...
0x117: Push((float)9.999999974752427e-07)
...
0x131: Stack[-1] = "ui/NPC_Aglaja.png" // @poff=214
0x132: Return(); Pop(0)
