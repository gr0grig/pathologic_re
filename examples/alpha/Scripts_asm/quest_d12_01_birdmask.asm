...
Strings:
	...
	W:player
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0xe6: Stack[-1] = "Neutral" // @poff=61
0xe7: Call 0xab

0xe8: Pop(1)
0xe9: Push((int) 14849)
0xea: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xeb: Pop(1)
0xec: @@@ ClearReplies(); Obj=0 // @poff=88
0xed: Pop(0)
...
0x154: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x155: Pop(3)
0x156: Return(); Pop(0)
...
0x15b: Stack[-1] = "Neutral" // @poff=61
0x15c: Call 0xab

0x15d: Pop(1)
0x15e: Push((int) 14861)
0x15f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x160: Pop(1)
0x161: @@@ ClearReplies(); Obj=0 // @poff=88
0x162: Pop(0)
...
0x1ed: Stack[-1] = "Neutral" // @poff=61
0x1ee: Call 0xab

0x1ef: Pop(1)
0x1f0: Push((int) 15495)
0x1f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1f2: Pop(1)
0x1f3: @@@ ClearReplies(); Obj=0 // @poff=88
0x1f4: Pop(0)
...
0x1ff: Stack[-1] = "Neutral" // @poff=61
0x200: Call 0xab

0x201: Pop(1)
0x202: Push((int) 14853)
0x203: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x204: Pop(1)
0x205: @@@ ClearReplies(); Obj=0 // @poff=88
0x206: Pop(0)
...
0x211: Stack[-1] = "Neutral" // @poff=61
0x212: Call 0xab

0x213: Pop(1)
0x214: Push((int) 14851)
0x215: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x216: Pop(1)
0x217: @@@ ClearReplies(); Obj=0 // @poff=88
0x218: Pop(0)
0x219: Push((int) 15337)
0x21a: Push((int) -1)
0x21b: Push((int) 16560)
0x21c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x21d: Pop(3)
0x21e: Return(); Pop(0)
...
0x239: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x23a: Pop(0)
0x23b: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x23c: Pop(0)
...
0x27c: Pop(0)
0x27d: Push("start: ") // @poff=172
0x27e: Pop(1); Push(Stack[-1] + Stack[-3]);
0x27f: @ Trace(Stack[-1])
0x280: Pop(1)
0x281: Push("end: ") // @poff=188
...
0x290: Push((float)9.999999974752427e-07)
...
0x29c: Push("Door ") // @poff=200
0x29d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x29e: Push(" not found") // @poff=212
0x29f: Pop(2); Push(Stack[-2] + Stack[-1]);
0x2a0: @ Trace(Stack[-1])
0x2a1: Pop(1)
0x2a2: Push("locked") // @poff=234
0x2a3: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=248
0x2a4: Pop(1)
0x2a5: Return(); Pop(2)
...
0x2a9: Pop(0)
0x2aa: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2bd: Stack[-2] = "sobor@door1" // @poff=260
...
0x2c4: Stack[-2] = "quest_d12_01" // @poff=284
0x2c5: Stack[-1] = "init_sobor" // @poff=310
0x2c6: Call 0x2a7
...
0x2fe: Stack[-1] = "ui/NPC_Black.png" // @poff=346
0x2ff: Return(); Pop(0)
