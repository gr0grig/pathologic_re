...
0x9d: Stack[-1] = "Neutral" // @poff=61
0x9e: Call 0x83

0x9f: Pop(1)
0xa0: Push((int) 14884)
0xa1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xa2: Pop(1)
0xa3: @@@ ClearReplies(); Obj=0 // @poff=88
0xa4: Pop(0)
0xa5: Push((int) 14885)
0xa6: Push((int) 16132)
0xa7: Push((int) 16131)
...
0xab: Push((int) 16132)
0xac: Push((int) 16151)
0xad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xae: Pop(3)
0xaf: Push((int) 14906)
0xb0: Push((int) 16132)
0xb1: Push((int) 16153)
...
0xb5: Push((int) 16132)
0xb6: Push((int) 16155)
0xb7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xb8: Pop(3)
0xb9: Return(); Pop(0)
...
0xbe: Stack[-1] = "Neutral" // @poff=61
0xbf: Call 0x83

0xc0: Pop(1)
0xc1: Push((int) 14886)
0xc2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc3: Pop(1)
0xc4: @@@ ClearReplies(); Obj=0 // @poff=88
0xc5: Pop(0)
0xc6: Push((int) 14887)
0xc7: Push((int) 16134)
0xc8: Push((int) 16133)
...
0xda: Stack[-1] = "Neutral" // @poff=61
0xdb: Call 0x83

0xdc: Pop(1)
0xdd: Push((int) 14900)
0xde: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xdf: Pop(1)
0xe0: @@@ ClearReplies(); Obj=0 // @poff=88
0xe1: Pop(0)
0xe2: Push((int) 14901)
0xe3: Push((int) 16148)
0xe4: Push((int) 16147)
0xe5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xe6: Pop(3)
0xe7: Push((int) 14904)
0xe8: Push((int) -1)
0xe9: Push((int) 16150)
...
0xf1: Stack[-1] = "Neutral" // @poff=61
0xf2: Call 0x83

0xf3: Pop(1)
0xf4: Push((int) 14902)
0xf5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf6: Pop(1)
0xf7: @@@ ClearReplies(); Obj=0 // @poff=88
0xf8: Pop(0)
0xf9: Push((int) 14903)
0xfa: Push((int) -1)
0xfb: Push((int) 16149)
...
0x16b: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x16c: Pop(0)
0x16d: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x16e: Pop(0)
...
0x1ae: Pop(0)
0x1af: Push("start: ") // @poff=172
0x1b0: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1b1: @ Trace(Stack[-1])
0x1b2: Pop(1)
0x1b3: Push("end: ") // @poff=188
...
0x1c2: Push((float)9.999999974752427e-07)
...
0x1dc: Stack[-1] = "ui/NPC_Black.png" // @poff=214
0x1dd: Return(); Pop(0)
