...
Strings:
	...
	W:player
	W:ui/NPC_Burah.png
// @pool_raw:
// @pool_encoding:utf8
...
0xb3: Push((int) -1)
0xb4: Push((int) 16180)
0xb5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xb6: Pop(3)
0xb7: Return(); Pop(0)
...
0xbc: Stack[-1] = "Neutral" // @poff=61
0xbd: Call 0x7e

0xbe: Pop(1)
0xbf: Push((int) 14911)
0xc0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc1: Pop(1)
0xc2: @@@ ClearReplies(); Obj=0 // @poff=88
0xc3: Pop(0)
0xc4: Push((int) 14912)
0xc5: Push((int) 16162)
0xc6: Push((int) 16161)
...
0xca: Push((int) 16172)
0xcb: Push((int) 16171)
0xcc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xcd: Pop(3)
0xce: Push((int) 14925)
0xcf: Push((int) 16176)
0xd0: Push((int) 16175)
0xd1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xd2: Pop(3)
0xd3: Return(); Pop(0)
...
0x15c: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x15d: Pop(0)
0x15e: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x15f: Pop(0)
...
0x19f: Pop(0)
0x1a0: Push("start: ") // @poff=172
0x1a1: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1a2: @ Trace(Stack[-1])
0x1a3: Pop(1)
0x1a4: Push("end: ") // @poff=188
...
0x1b3: Push((float)9.999999974752427e-07)
...
0x1bf: PushEmpty()
0x1c0: Push("ood12Burah1") // @poff=200
0x1c1: Push((int) 1)
...
0x1c7: Stack[-1] = "ood12Burah1" // @poff=200
0x1c8: Call 0x1ba
...
0x1e4: Stack[-1] = "ui/NPC_Burah.png" // @poff=238
0x1e5: Return(); Pop(0)
