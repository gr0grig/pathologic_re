...
Strings:
	...
	W:player
	W:ui/NPC_Klara.png
// @pool_raw:
// @pool_encoding:utf8
...
0x157: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x158: Pop(0)
0x159: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x15a: Pop(0)
...
0x19a: Pop(0)
0x19b: Push("start: ") // @poff=172
0x19c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x19d: @ Trace(Stack[-1])
0x19e: Pop(1)
0x19f: Push("end: ") // @poff=188
...
0x1ae: Push((float)9.999999974752427e-07)
...
0x1ba: PushEmpty()
0x1bb: Push("ood12Klara1") // @poff=200
0x1bc: Push((int) 1)
...
0x1c2: Stack[-1] = "ood12Klara1" // @poff=200
0x1c3: Call 0x1b5
...
0x1df: Stack[-1] = "ui/NPC_Klara.png" // @poff=238
0x1e0: Return(); Pop(0)
