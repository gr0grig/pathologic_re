...
Strings:
	...
	W:ood12Littleboy1
	W:ood12Littleboy2
	W:d12q01DankoKnowHeIsToy
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x55: Stack[-1] = "Neutral" // @poff=61
0x56: Call 0xb0

0x57: Pop(1)
0x58: Push((int) 14956)
0x59: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5a: Pop(1)
0x5b: @@@ ClearReplies(); Obj=0 // @poff=88
0x5c: Pop(0)
0x5d: Push((int) 14957)
0x5e: Push((int) 16211)
0x5f: Push((int) 16210)
...
0x63: Push((int) 16231)
0x64: Push((int) 16230)
0x65: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x66: Pop(3)
0x67: Push((int) 14977)
0x68: Push((int) 16233)
0x69: Push((int) 16232)
...
0x6e: Stack[-1] = "Neutral" // @poff=61
0x6f: Call 0xb0

0x70: Pop(1)
0x71: Push((int) 14988)
0x72: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x73: Pop(1)
0x74: @@@ ClearReplies(); Obj=0 // @poff=88
0x75: Pop(0)
...
0x8b: Push((int) -1)
0x8c: Push((int) 16244)
0x8d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x8e: Pop(3)
0x8f: GOTO 0x92
...
0xa1: Push("all") // @poff=110
0xa2: Push("idle") // @poff=118
...
0x11c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x11d: Pop(3)
...
0x128: Stack[-1] = "Neutral" // @poff=61
0x129: Call 0xb0

0x12a: Pop(1)
0x12b: Push((int) 15001)
0x12c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x12d: Pop(1)
0x12e: @@@ ClearReplies(); Obj=0 // @poff=88
0x12f: Pop(0)
0x130: Push((int) 15002)
0x131: Push((int) 16251)
0x132: Push((int) 16258)
0x133: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x134: Pop(3)
...
0x156: Stack[-1] = "Neutral" // @poff=61
0x157: Call 0xb0

0x158: Pop(1)
0x159: Push((int) 14993)
0x15a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x15b: Pop(1)
0x15c: @@@ ClearReplies(); Obj=0 // @poff=88
0x15d: Pop(0)
0x15e: Push((int) 14994)
0x15f: Push((int) -1)
0x160: Push((int) 16249)
0x161: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x162: Pop(3)
0x163: Push((int) 14995)
0x164: Push((int) 16251)
0x165: Push((int) 16250)
0x166: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x167: Pop(3)
0x168: Return(); Pop(0)
...
0x16d: Stack[-1] = "Neutral" // @poff=61
0x16e: Call 0xb0

0x16f: Pop(1)
0x170: Push((int) 14996)
0x171: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x172: Pop(1)
0x173: @@@ ClearReplies(); Obj=0 // @poff=88
0x174: Pop(0)
...
0x17d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x17e: Pop(3)
0x17f: Return(); Pop(0)
...
0x19b: Stack[-1] = "Neutral" // @poff=61
0x19c: Call 0xb0

0x19d: Pop(1)
0x19e: Push((int) 14980)
0x19f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1a0: Pop(1)
0x1a1: @@@ ClearReplies(); Obj=0 // @poff=88
0x1a2: Pop(0)
...
0x1b2: Stack[-1] = "Neutral" // @poff=61
0x1b3: Call 0xb0

0x1b4: Pop(1)
0x1b5: Push((int) 14982)
0x1b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1b7: Pop(1)
0x1b8: @@@ ClearReplies(); Obj=0 // @poff=88
0x1b9: Pop(0)
...
0x2fa: @@ GetPosition(Stack[-7]); Obj=17 // @poff=144
0x2fb: Pop(0)
0x2fc: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=156
0x2fd: Pop(0)
...
0x33d: Pop(0)
0x33e: Push("start: ") // @poff=188
0x33f: Pop(1); Push(Stack[-1] + Stack[-3]);
0x340: @ Trace(Stack[-1])
0x341: Pop(1)
0x342: Push("end: ") // @poff=204
...
0x357: Push((float)9.999999974752427e-07)
...
0x360: Pop(0)
0x361: Stack[-1] = Stack[-4]
0x362: Return(); Pop(2)

0x363: PushEmpty()
0x364: Push("ood12Littleboy1") // @poff=216
0x365: Push((int) 1)
...
0x369: PushEmpty()
0x36a: Push("ood12Littleboy2") // @poff=248
0x36b: Push((int) 1)
...
0x36f: PushEmpty()
0x370: Push("d12q01DankoKnowHeIsToy") // @poff=280
0x371: Push((int) 1)
...
0x377: Stack[-1] = "ood12Littleboy1" // @poff=216
0x378: Call 0x35e
...
0x383: Stack[-1] = "ood12Littleboy2" // @poff=248
0x384: Call 0x35e
...
0x3a0: Stack[-1] = "ui/NPC_None.png" // @poff=340
0x3a1: Return(); Pop(0)
...
0x3ac: Stack[-2] = (int) 0
0x3ad: Push("all") // @poff=110
0x3ae: PushEmpty(string, int)
0x3af: Stack[-5] = Stack[-1]
0x3b0: Call 0x3a4
