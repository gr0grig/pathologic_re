...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x6c: Push((int) 16278)
0x6d: Push((int) 16277)
0x6e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6f: Pop(3)
0x70: GOTO 0x73
...
0x82: Push("all") // @poff=110
0x83: Push("idle") // @poff=118
...
0x8b: Push("all") // @poff=110
0x8c: Push("idle") // @poff=118
...
0x1dd: @@ GetPosition(Stack[-7]); Obj=17 // @poff=144
0x1de: Pop(0)
0x1df: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=156
0x1e0: Pop(0)
...
0x220: Pop(0)
0x221: Push("start: ") // @poff=188
0x222: Pop(1); Push(Stack[-1] + Stack[-3]);
0x223: @ Trace(Stack[-1])
0x224: Pop(1)
0x225: Push("end: ") // @poff=204
...
0x23a: Push((float)9.999999974752427e-07)
...
0x246: PushEmpty()
0x247: Push("ood12Littlegirl1") // @poff=216
0x248: Push((int) 1)
...
0x24e: Stack[-1] = "d12q01DankoKnowHeIsToy" // @poff=250
0x24f: Call 0x241
...
0x25a: Stack[-1] = "ood12Littlegirl1" // @poff=216
0x25b: Call 0x241
...
0x277: Stack[-1] = "ui/NPC_None.png" // @poff=310
0x278: Return(); Pop(0)
