...
Strings:
	...
	W:player
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x8e: Stack[-1] = "Neutral" // @poff=61
0x8f: Call 0x74

0x90: Pop(1)
0x91: Push((int) 15498)
0x92: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x93: Pop(1)
0x94: @@@ ClearReplies(); Obj=0 // @poff=88
0x95: Pop(0)
0x96: Push((int) 15499)
0x97: Push((int) 16596)
0x98: Push((int) 16595)
0x99: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x9a: Pop(3)
0x9b: Return(); Pop(0)
...
0xae: Push((int) 16620)
0xaf: Push((int) 16619)
0xb0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xb1: Pop(3)
0xb2: Return(); Pop(0)
...
0x149: Stack[-1] = "Neutral" // @poff=61
0x14a: Call 0x74

0x14b: Pop(1)
0x14c: Push((int) 15508)
0x14d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x14e: Pop(1)
0x14f: @@@ ClearReplies(); Obj=0 // @poff=88
0x150: Pop(0)
...
0x160: Stack[-1] = "Neutral" // @poff=61
0x161: Call 0x74

0x162: Pop(1)
0x163: Push((int) 15510)
0x164: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x165: Pop(1)
0x166: @@@ ClearReplies(); Obj=0 // @poff=88
0x167: Pop(0)
0x168: Push((int) 15511)
0x169: Push((int) -1)
0x16a: Push((int) 16607)
0x16b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x16c: Pop(3)
0x16d: Return(); Pop(0)
...
0x188: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x189: Pop(0)
0x18a: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x18b: Pop(0)
...
0x1cb: Pop(0)
0x1cc: Push("start: ") // @poff=172
0x1cd: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1ce: @ Trace(Stack[-1])
0x1cf: Pop(1)
0x1d0: Push("end: ") // @poff=188
...
0x1df: Push((float)9.999999974752427e-07)
...
0x1f9: Stack[-1] = "ui/NPC_Black.png" // @poff=214
0x1fa: Return(); Pop(0)
