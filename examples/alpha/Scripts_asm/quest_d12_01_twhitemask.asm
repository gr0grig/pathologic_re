...
Strings:
	...
	W:player
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0xfa: Push((int) -1)
0xfb: Push((int) 16336)
0xfc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xfd: Pop(3)
0xfe: Return(); Pop(0)
...
0x11a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x11b: Pop(3)
...
0x14c: Stack[-1] = "Neutral" // @poff=61
0x14d: Call 0xb0

0x14e: Pop(1)
0x14f: Push((int) 15083)
0x150: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x151: Pop(1)
0x152: @@@ ClearReplies(); Obj=0 // @poff=88
0x153: Pop(0)
...
0x1ec: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x1ed: Pop(0)
0x1ee: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x1ef: Pop(0)
...
0x22f: Pop(0)
0x230: Push("start: ") // @poff=172
0x231: Pop(1); Push(Stack[-1] + Stack[-3]);
0x232: @ Trace(Stack[-1])
0x233: Pop(1)
0x234: Push("end: ") // @poff=188
...
0x24f: PushEmpty()
0x250: Push("ood12Whitemask1") // @poff=200
0x251: Push((int) 1)
...
0x255: PushEmpty()
0x256: Push("ood12Whitemask2") // @poff=232
0x257: Push((int) 1)
...
0x25d: Stack[-1] = "ood12Whitemask1" // @poff=200
0x25e: Call 0x24a
...
0x269: Stack[-1] = "ood12Whitemask2" // @poff=232
0x26a: Call 0x24a
...
0x286: Stack[-1] = "ui/NPC_Black.png" // @poff=278
0x287: Return(); Pop(0)
