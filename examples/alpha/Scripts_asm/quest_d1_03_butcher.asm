...
Strings:
	...
	W:butcher_fail
	W:butcher_death
// @pool_raw:
// @pool_encoding:utf8
...
0x54: Push((int) -1)
0x55: Push((int) 6665)
0x56: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x57: Pop(3)
0x58: GOTO 0x5b
...
0x6a: Push("all") // @poff=110
0x6b: Push("idle") // @poff=118
...
0x73: Push("all") // @poff=110
0x74: Push("idle") // @poff=118
...
0x93: Stack[-1] = "Neutral" // @poff=61
0x94: Call 0x79

0x95: Pop(1)
0x96: Push((int) 5264)
0x97: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x98: Pop(1)
0x99: @@@ ClearReplies(); Obj=0 // @poff=88
0x9a: Pop(0)
0x9b: Push((int) 5265)
0x9c: Push((int) -1)
0x9d: Push((int) 5802)
0x9e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x9f: Pop(3)
0xa0: Push((int) 6042)
0xa1: Push((int) -1)
0xa2: Push((int) 6665)
...
0xe6: Stack[-2] = "quest_d1_03" // @poff=144
0xe7: Stack[-1] = "butcher_battle" // @poff=168
0xe8: Call 0x55f

0xe9: Pop(3)
0xea: Push("player") // @poff=198
0xeb: @ FindActor(Stack[-2], Stack[-1])
0xec: Pop(1)
0xed: PushEmpty(object, bool, float)
0xee: Stack[-4] = Stack[-3]
0xef: Stack[-2] = (bool) 1
...
0xf7: Stack[-1] = 0
0xf8: PushEmpty()
0xf9: Stack[-3] = (float) 0.10000000149011612
0xfa: Return(); Pop(0)
...
0x106: Push("all") // @poff=110
0x107: Push("attack_begin") // @poff=212
0x108: Push((int) 1)
...
0x131: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x132: Pop(0)
0x133: Push(Stack[-22])
...
0x143: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=308
0x144: Pop(0)
...
0x167: Pop(1)
0x168: Push("all") // @poff=110
0x169: Push("attack_on") // @poff=322
...
0x175: Push((float)0.6000000238418579)
0x176: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x177: IF (Stack[-1] == 1) GOTO 0x17d; Pop(1)
...
0x17e: @ Face(Stack[-0]T)
0x17f: Pop(0)
0x180: Push("all") // @poff=110
0x181: Push("attack_stay") // @poff=342
0x182: @ PlayAnimation(Stack[-2], Stack[-1])
0x183: Pop(2)
0x184: PushEmpty(bool, float)
0x185: Stack[-23] = Stack[-1]
0x186: Call 0x260
...
0x18b: @ Face(Stack[-0]T)
0x18c: Pop(0)
0x18d: Push("all") // @poff=110
0x18e: Push("fjump") // @poff=366
...
0x1a6: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=308
0x1a7: Pop(0)
...
0x1c5: Push("all") // @poff=110
0x1c6: Push("attack_off") // @poff=378
...
0x1d2: Push((float)0.8999999761581421)
0x1d3: Pop(1); Push(Stack[-9] * Stack[-1]);
0x1d4: @ GetVictim(Stack[-1], Stack[-4])
0x1d5: Pop(1)
0x1d6: @ ReportAttack(Stack[-0]T)
0x1d7: Pop(0)
...
0x1db: Stack[-6] = Stack[-2]
0x1dc: Stack[-10] = Stack[-1]
0x1dd: Call 0xf8

0x1de: Stack[-3] = Stack[-5]
0x1df: Pop(3)
0x1e0: PushEmpty(float, object, float, int)
0x1e1: Stack[-7] = Stack[-3]
0x1e2: Stack[-6] = Stack[-2]
0x1e3: PushEmpty(int, object, int)
0x1e4: Stack[-10] = Stack[-2]
0x1e5: Stack[-14] = Stack[-1]
0x1e6: Call 0xfb

0x1e7: Stack[-3] = Stack[-4]
0x1e8: Pop(3)
0x1e9: Call 0x41f

0x1ea: Stack[-4] = Stack[-5]
0x1eb: Pop(4)
0x1ec: PushEmpty(int)
0x1ed: Call 0x2e7

0x1ee: Pop(0)
0x1ef: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x1f0: Pop(1)
0x1f1: PushEmpty(object, float)
0x1f2: Stack[-5] = Stack[-2]
...
0x203: Push("attack_begin") // @poff=212
...
0x217: Stack[-7] = Stack[-2]
0x218: Stack[-4] = Stack[-1]
0x219: Call 0x1d1

0x21a: Pop(2)
0x21b: Push("all") // @poff=110
0x21c: Push("attack_middle") // @poff=400
...
0x222: Push("all") // @poff=110
0x223: Push("attack_middle") // @poff=400
...
0x23a: Pop(1)
0x23b: Push("all") // @poff=110
0x23c: Push("attack_end") // @poff=428
...
0x274: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=308
0x275: Pop(0)
...
0x2aa: @ Face(Stack[-0]T)
0x2ab: Pop(0)
0x2ac: Push("all") // @poff=110
0x2ad: Push("bjump") // @poff=450
0x2ae: @ PlayAnimation(Stack[-2], Stack[-1])
0x2af: Pop(2)
0x2b0: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=308
0x2b1: Pop(0)
...
0x2da: @ irand(Stack[-1], Stack[-2]T)
0x2db: Pop(0)
0x2dc: Push((int) 1)
0x2dd: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x2de: Push("attack") // @poff=238
...
0x2f8: Stack[-17] = Stack[-7]
0x2f9: PushEmpty(bool, object)
0x2fa: Stack[-23] = Stack[-1]
0x2fb: Call 0x381
...
0x301: @@ GetPosition(Stack[-5]); Obj=21 // @poff=498
0x302: Pop(0)
...
0x318: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=308
0x319: Pop(0)
...
0x32a: Push((int) 0)
0x32b: Push((float)0.30000001192092896)
...
0x34d: Push((int) 0)
0x34e: Push((float)0.30000001192092896)
...
0x383: Stack[-3] = Stack[-1]
0x384: Call 0x488

0x385: Stack[-2] = Stack[-4]
0x386: Pop(2)
0x387: Return(); Pop(0)

0x388: Stack[-1] = "walk" // @poff=510
0x389: Return(); Pop(0)

0x38a: Stack[-1] = "run" // @poff=520
0x38b: Return(); Pop(0)
...
0x399: Pop(0); PushNull((bool) Stack[-21] == 0)
0x39a: IF (Stack[-1] == 0) GOTO 0x3a0; Pop(1)

0x39b: PushEmpty(string)
0x39c: Stack[-1] = "fdie" // @poff=528
0x39d: Call 0x3ef

0x39e: Pop(1)
0x39f: GOTO 0x3ee

0x3a0: @@ GetPosition(Stack[-10]); Obj=21 // @poff=498
0x3a1: Pop(0)
...
0x3b1: Stack[-6] = "fdie" // @poff=528
0x3b2: GOTO 0x3b4

0x3b3: Stack[-6] = "bdie" // @poff=538
...
0x3bd: Push("GetScriptProperty") // @poff=548
0x3be: Push((int) 2)
0x3bf: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3c0: IF (Stack[-1] == 0) GOTO 0x3cc; Pop(1)

0x3c1: Push("Owner") // @poff=584
0x3c2: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=596
0x3c3: Pop(1)
0x3c4: Push(Stack[-4])
0x3c5: IF (Stack[-1] == 0) GOTO 0x3cc; Pop(1)

0x3c6: Push("Owner") // @poff=584
0x3c7: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=614
0x3c8: Pop(1)
0x3c9: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3ca: IF (Stack[-1] == 0) GOTO 0x3cc; Pop(1)

0x3cb: Stack[-21] = Stack[-5]
0x3cc: Push("@GetEyesHeight") // @poff=632
0x3cd: Push((int) 1)
0x3ce: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x3cf: IF (Stack[-1] == 0) GOTO 0x3db; Pop(1)

0x3d0: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=662
0x3d1: Pop(0)
0x3d2: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x3d3: Push(CvectorIndex(Stack[-1], 1))
0x3d4: Stack[-3] = Stack[-1]
0x3d5: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x3d6: Push("head") // @poff=676
...
0x3e3: @ StopAsync()
0x3e4: Pop(0)
0x3e5: Push("head") // @poff=676
0x3e6: @ UnlookAsync(Stack[-1])
0x3e7: Pop(1)
0x3e8: Push("all") // @poff=110
...
0x40f: Stack[-2] = "fire" // @poff=686
0x410: Return(); Pop(0)

0x411: Stack[-2] = "phys" // @poff=696
0x412: Return(); Pop(0)

0x413: PushEmpty(bool, bool)
0x414: Push("HasProperty") // @poff=706
0x415: Push((int) 2)
...
0x41b: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=730
0x41c: Pop(0)
0x41d: Stack[-1] = Stack[-5]
0x41e: Return(); Pop(2)

0x41f: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x420: PushEmpty(bool, object, string)
0x421: Stack[-18] = Stack[-2]
0x422: Stack[-1] = "health" // @poff=742
0x423: Call 0x413
...
0x42a: Stack[-18] = Stack[-2]
0x42b: Stack[-1] = "armor" // @poff=756
0x42c: Call 0x413
...
0x432: Push("armor") // @poff=756
0x433: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=768
0x434: Pop(1)
0x435: Push("armor_") // @poff=780
0x436: PushEmpty(string, int)
0x437: Stack[-16] = Stack[-1]
0x438: Call 0x40b

0x439: Pop(1)
0x43a: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x43b: PushEmpty(bool, object, string)
0x43c: Stack[-18] = Stack[-2]
0x43d: Stack[-8] = Stack[-1]
0x43e: Call 0x413
...
0x444: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=768
0x445: Pop(0)
...
0x44c: Stack[-3] = Stack[-6]
0x44d: Pop(3)
0x44e: Push("health") // @poff=742
0x44f: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=768
0x450: Pop(1)
0x451: Push((int) 1)
0x452: Pop(1); Push(Stack[-1] - Stack[-4]);
0x453: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x454: Push("health") // @poff=742
...
0x45a: Pop(3)
0x45b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=794
0x45c: Pop(2)
0x45d: Stack[-1] = Stack[-16]
0x45e: Return(); Pop(12)

0x45f: PushEmpty(bool, bool)
0x460: @@ IsDead(Stack[-1]); Obj=3 // @poff=806
0x461: Pop(0)
0x462: Stack[-1] = Stack[-4]
0x463: Return(); Pop(2)

0x464: PushEmpty(object, object, object, object)
0x465: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x479: Pop(0)
0x47a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x47b: IF (Stack[-1] == 0) GOTO 0x47e; Pop(1)

0x47c: Stack[-6] = (bool) 0
0x47d: Return(); Pop(4)

0x47e: @@ GetScene(Stack[-1]); Obj=5 // @poff=827
0x47f: Pop(0)
...
0x492: Stack[-6] = Stack[-2]
0x493: Stack[-1] = "noaccess" // @poff=836
0x494: Call 0x413
...
0x49a: Push("noaccess") // @poff=836
0x49b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=768
0x49c: Pop(1)
0x49d: Push((int) 0)
...
0x4c6: @@ GetPosition(Stack[-5]); Obj=23 // @poff=498
0x4c7: Pop(0)
...
0x4d7: Stack[-1] = "fhit" // @poff=892
0x4d8: GOTO 0x4da

0x4d9: Stack[-1] = "bhit" // @poff=902
0x4da: Push("hit_react") // @poff=912
0x4db: Push("1") // @poff=932
0x4dc: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4dd: Push("2") // @poff=936
...
0x4e4: @@ GetPosition(Stack[-3]); Obj=7 // @poff=498
0x4e5: Pop(0)
...
0x4ef: @@ GetPosition(Stack[-7]); Obj=17 // @poff=498
0x4f0: Pop(0)
0x4f1: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=662
0x4f2: Pop(0)
...
0x532: Pop(0)
0x533: Push("start: ") // @poff=958
0x534: Pop(1); Push(Stack[-1] + Stack[-3]);
0x535: @ Trace(Stack[-1])
0x536: Pop(1)
0x537: Push("end: ") // @poff=974
...
0x57e: Stack[-1] = "ui/NPC_None.png" // @poff=986
0x57f: Return(); Pop(0)
...
0x585: Stack[-2] = "quest_d1_03" // @poff=144
0x586: Stack[-1] = "butcher_fail" // @poff=1018
0x587: Call 0x55f
...
0x58c: Stack[-2] = "quest_d1_03" // @poff=144
0x58d: Stack[-1] = "butcher_death" // @poff=1044
0x58e: Call 0x55f

0x58f: Pop(3)
0x590: PushEmpty(object)
0x591: Stack[-2] = Stack[-1]
...
0x599: Stack[-7] = Stack[-3]
0x59a: Stack[-6] = Stack[-2]
0x59b: Stack[-5] = Stack[-1]
0x59c: Call 0x4a0
