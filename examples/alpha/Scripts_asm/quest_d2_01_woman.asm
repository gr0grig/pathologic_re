...
Strings:
	...
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x64: Stack[-1] = "Neutral" // @poff=61
0x65: Call 0x92

0x66: Pop(1)
0x67: Push((int) 6753)
0x68: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x69: Pop(1)
0x6a: @@@ ClearReplies(); Obj=0 // @poff=88
0x6b: Pop(0)
0x6c: Push((int) 6754)
0x6d: Push((int) 8102)
0x6e: Push((int) 7444)
...
0x83: Push("all") // @poff=110
0x84: Push("idle") // @poff=118
...
0xc3: Stack[-1] = "Neutral" // @poff=61
0xc4: Call 0x92

0xc5: Pop(1)
0xc6: Push((int) 6748)
0xc7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc8: Pop(1)
0xc9: @@@ ClearReplies(); Obj=0 // @poff=88
0xca: Pop(0)
0xcb: Push((int) 6749)
0xcc: Push((int) 7440)
0xcd: Push((int) 7439)
...
0xd1: Push((int) 7440)
0xd2: Push((int) 8098)
0xd3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xd4: Pop(3)
0xd5: Push((int) 7350)
0xd6: Push((int) 7440)
0xd7: Push((int) 8104)
...
0xdc: Stack[-1] = "Neutral" // @poff=61
0xdd: Call 0x92

0xde: Pop(1)
0xdf: Push((int) 6753)
0xe0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe1: Pop(1)
0xe2: @@@ ClearReplies(); Obj=0 // @poff=88
0xe3: Pop(0)
0xe4: Push((int) 6754)
0xe5: Push((int) 8102)
0xe6: Push((int) 7444)
...
0x100: Stack[-1] = "Neutral" // @poff=61
0x101: Call 0x92

0x102: Pop(1)
0x103: Push((int) 6750)
0x104: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x105: Pop(1)
0x106: @@@ ClearReplies(); Obj=0 // @poff=88
0x107: Pop(0)
0x108: Push((int) 6751)
0x109: Push((int) 8099)
0x10a: Push((int) 7441)
...
0x137: Push((int) 7442)
0x138: Push((int) 8113)
0x139: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x13a: Pop(3)
0x13b: Return(); Pop(0)
...
0x1ad: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x1ae: Pop(0)
0x1af: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x1b0: Pop(0)
...
0x1f0: Pop(0)
0x1f1: Push("start: ") // @poff=204
0x1f2: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1f3: @ Trace(Stack[-1])
0x1f4: Pop(1)
0x1f5: Push("end: ") // @poff=220
...
0x20a: Push((float)9.999999974752427e-07)
...
0x217: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x218: Pop(0)
0x219: Push("Category") // @poff=242
0x21a: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x21b: Pop(1)
0x21c: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x21d: Pop(0)
0x21e: Pop(0); Push((bool) Stack[-1] == 0)
0x21f: IF (Stack[-1] == 0) GOTO 0x222; Pop(1)

0x220: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x221: Pop(0)
0x222: Return(); Pop(6)
...
0x225: Pop(0)
0x226: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x227: Pop(0)
0x228: PushEmpty(object, object, int)
0x229: Stack[-8] = Stack[-3]
...
0x232: Pop(0)
0x233: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x241: PushEmpty()
0x242: Push("playsound") // @poff=290
0x243: Push("giveitem") // @poff=310
0x244: @ TriggerWorld(Stack[-2], Stack[-1])
0x245: Pop(2)
0x246: Return(); Pop(0)

0x247: PushEmpty()
0x248: Push("ood2WomanD1") // @poff=328
0x249: Push((int) 1)
...
0x254: Stack[-1] = Stack[-2]
0x255: Pop(1)
0x256: Push("d2q01WomanDGotoAlexandr") // @poff=364
0x257: Push("pt_map_alexandr") // @poff=412
0x258: Push((int) 1)
...
0x25c: Pop(0)
0x25d: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=444
0x25e: Pop(5)
0x25f: PushEmpty()
0x260: Call 0x2ca

0x261: Pop(0)
0x262: Push("key is given") // @poff=452
0x263: @ Trace(Stack[-1])
0x264: Pop(1)
0x265: PushEmpty(object, string, int)
0x266: Stack[-7] = Stack[-3]
0x267: Stack[-2] = "d2q01_key" // @poff=478
0x268: Stack[-1] = (int) 1
0x269: Call 0x223

0x26a: Pop(3)
0x26b: PushEmpty(bool, string, string)
0x26c: Stack[-2] = "quest_d2_01" // @poff=498
0x26d: Stack[-1] = "cursed_women" // @poff=522
0x26e: Call 0x230
...
0x274: Stack[-1] = "ood2WomanD1" // @poff=328
0x275: Call 0x211
...
0x283: Push("Can't retrieve diary root") // @poff=548
0x284: @ Trace(Stack[-1])
0x285: Pop(1)
...
0x28f: Pop(1)
0x290: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=600
0x291: Pop(0)
0x292: Pop(0); Push((bool) Stack[-2] == 0)
0x293: IF (Stack[-1] == 0) GOTO 0x29a; Pop(1)

0x294: Push("Can't find diary parent with id: ") // @poff=605
...
0x29a: @@ AddChild(Stack[-8]); Obj=2 // @poff=673
0x29b: Pop(0)
0x29c: Push("player_diary") // @poff=682
0x29d: Push((int) 1)
0x29e: @ SetVariable(Stack[-2], Stack[-1])
0x29f: Pop(2)
0x2a0: @@ GetCategory(Stack[-1]); Obj=8 // @poff=708
0x2a1: Pop(0)
...
0x2aa: Pop(0)
0x2ab: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2ac: IF (Stack[-1] == 0) GOTO 0x2b3; Pop(1)

0x2ad: Push("Can't find main outdoor scene") // @poff=720
0x2ae: @ Trace(Stack[-1])
0x2af: Pop(1)
0x2b0: Stack[-1] = 0
...
0x2b3: @@ GetMap(Stack[-1]); Obj=2 // @poff=780
0x2b4: Pop(0)
0x2b5: Stack[-1] = Stack[-5]
0x2b6: Return(); Pop(4)

0x2b7: Stack[-1] = 0
0x2b8: Stack[-2] = 0
0x2b9: PushEmpty(int, int)
0x2ba: Push("player") // @poff=787
...
0x2cb: Push("Adding diary entry") // @poff=801
0x2cc: @ Trace(Stack[-1])
0x2cd: Pop(1)
0x2ce: Push((int) 54)
0x2cf: Push((int) 1)
...
0x2dc: Stack[-1] = "ui/NPC_None.png" // @poff=839
0x2dd: Return(); Pop(0)
