...
// @pool_raw:
...
0x157: Push("Can't retrieve diary root") // @poff=648
0x158: @ Trace(Stack[-1])
0x159: Pop(1)
...
0x163: Pop(1)
0x164: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=700
0x165: Pop(0)
0x166: Pop(0); Push((bool) Stack[-2] == 0)
0x167: IF (Stack[-1] == 0) GOTO 0x16e; Pop(1)

0x168: Push("Can't find diary parent with id: ") // @poff=705
...
0x16e: @@ AddChild(Stack[-8]); Obj=2 // @poff=773
0x16f: Pop(0)
0x170: Push("player_diary") // @poff=782
0x171: Push((int) 1)
0x172: @ SetVariable(Stack[-2], Stack[-1])
0x173: Pop(2)
0x174: @@ GetCategory(Stack[-1]); Obj=8 // @poff=808
0x175: Pop(0)
...
0x17d: Push("Adding diary entry") // @poff=820
0x17e: @ Trace(Stack[-1])
0x17f: Pop(1)
0x180: Push((int) 61)
0x181: Push((int) 2)
...
0x18d: Push("Adding diary entry") // @poff=820
0x18e: @ Trace(Stack[-1])
0x18f: Pop(1)
0x190: Push((int) 62)
0x191: Push((int) 2)
