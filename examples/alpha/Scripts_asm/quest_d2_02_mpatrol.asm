...
Strings:
	...
	W:completed
	W:ui/NPC_Black.png
// @pool_raw:
...
0x3c2: Stack[-1] = "Neutral" // @poff=557
0x3c3: Call 0x398

0x3c4: Pop(1)
0x3c5: Push((int) 7522)
0x3c6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3c7: Pop(1)
0x3c8: @@@ ClearReplies(); Obj=0 // @poff=584
0x3c9: Pop(0)
0x3ca: Push((int) 7523)
0x3cb: Push((int) -1)
0x3cc: Push((int) 8305)
0x3cd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3ce: Pop(3)
0x3cf: Push((int) 7524)
0x3d0: Push((int) -1)
0x3d1: Push((int) 8306)
0x3d2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3d3: Pop(3)
0x3d4: Return(); Pop(0)
...
0x40c: PushEmpty()
0x40d: Push("kill_player") // @poff=616
...
0x417: @ GetPFPosition(Stack[-1]T)
0x418: Pop(0)
0x419: @ GetDirection(Stack[-0]T)
0x41a: Pop(0)
0x41b: Push((int) 60)
...
0x432: @ FindPathTo(Stack[-1], Stack[-1]T)
0x433: Pop(0)
...
0x454: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x455: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x46d: Stack[-2] = "fire" // @poff=640
0x46e: Return(); Pop(0)

0x46f: Stack[-2] = "phys" // @poff=650
0x470: Return(); Pop(0)

0x471: PushEmpty(bool, bool)
0x472: Push("HasProperty") // @poff=660
0x473: Push((int) 2)
...
0x479: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=684
0x47a: Pop(0)
...
0x490: Push("armor") // @poff=710
0x491: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=722
0x492: Pop(1)
0x493: Push("armor_") // @poff=734
...
0x4a2: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=722
0x4a3: Pop(0)
...
0x4ab: Pop(3)
0x4ac: Push("health") // @poff=696
0x4ad: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=722
0x4ae: Pop(1)
0x4af: Push((int) 1)
0x4b0: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4b1: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4b2: Push("health") // @poff=696
...
0x4b8: Pop(3)
0x4b9: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=748
0x4ba: Pop(2)
0x4bb: Stack[-1] = Stack[-16]
0x4bc: Return(); Pop(12)

0x4bd: PushEmpty(bool, bool)
0x4be: @@ IsDead(Stack[-1]); Obj=3 // @poff=760
0x4bf: Pop(0)
0x4c0: Stack[-1] = Stack[-4]
0x4c1: Return(); Pop(2)

0x4c2: PushEmpty(object, object, object, object)
0x4c3: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4d7: Pop(0)
0x4d8: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4d9: IF (Stack[-1] == 0) GOTO 0x4dc; Pop(1)

0x4da: Stack[-6] = (bool) 0
0x4db: Return(); Pop(4)

0x4dc: @@ GetScene(Stack[-1]); Obj=5 // @poff=781
0x4dd: Pop(0)
...
0x4f1: Stack[-1] = "noaccess" // @poff=790
0x4f2: Call 0x471
...
0x4f8: Push("noaccess") // @poff=790
0x4f9: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=722
0x4fa: Pop(1)
0x4fb: Push((int) 0)
...
0x524: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x525: Pop(0)
...
0x535: Stack[-1] = "fhit" // @poff=846
0x536: GOTO 0x538

0x537: Stack[-1] = "bhit" // @poff=856
0x538: Push("hit_react") // @poff=866
0x539: Push("1") // @poff=886
0x53a: Pop(1); Push(Stack[-3] + Stack[-1]);
0x53b: Push("2") // @poff=890
...
0x542: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x543: Pop(0)
...
0x54d: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x54e: Pop(0)
0x54f: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=472
0x550: Pop(0)
...
0x590: Pop(0)
0x591: Push("start: ") // @poff=912
0x592: Pop(1); Push(Stack[-1] + Stack[-3]);
0x593: @ Trace(Stack[-1])
0x594: Pop(1)
0x595: Push("end: ") // @poff=928
...
0x5a4: Push((float)9.999999974752427e-07)
...
0x5b2: Stack[-2] = Stack[-3]
0x5b3: GOTO 0x5b5

0x5b4: Stack[-1] = Stack[-3]
0x5b5: Return(); Pop(0)
...
0x5bd: Stack[-1] = Stack[-4]
0x5be: Return(); Pop(0)

0x5bf: Stack[-3] = Stack[-4]
0x5c0: Return(); Pop(0)

0x5c1: PushEmpty(object, object)
0x5c2: @ FindActor(Stack[-1], Stack[-4])
0x5c3: Pop(0)
0x5c4: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5d9: Stack[-2] = "quest_d2_02" // @poff=940
0x5da: Stack[-1] = "player_attack" // @poff=964
0x5db: Call 0x5c1
...
0x5df: Stack[-2] = "quest_d2_02" // @poff=940
0x5e0: Stack[-1] = "mpatrol_unload" // @poff=992
0x5e1: Call 0x5c1
...
0x5e5: Push("revolver_ammo") // @poff=1022
0x5e6: Push((int) 0)
0x5e7: Push((int) 2)
0x5e8: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5e9: Pop(3)
0x5ea: Push("alpha_pills") // @poff=1050
0x5eb: Push((int) 0)
0x5ec: Push((int) 2)
...
0x5f8: Stack[-7] = Stack[-3]
0x5f9: Stack[-6] = Stack[-2]
0x5fa: Stack[-5] = Stack[-1]
0x5fb: Call 0x4fe
...
0x613: Stack[-2] = "quest_d2_02" // @poff=940
0x614: Stack[-1] = "player_attack" // @poff=964
0x615: Call 0x5c1
...
0x61a: Stack[-2] = "quest_d2_02" // @poff=940
0x61b: Stack[-1] = "completed" // @poff=1074
0x61c: Call 0x5c1
...
0x632: Stack[-1] = "ui/NPC_Black.png" // @poff=1094
0x633: Return(); Pop(0)
