...
Strings:
	...
	W:alpha_pills
	W:ui/NPC_Black.png
// @pool_raw:
...
0x3ad: Stack[-1] = "Neutral" // @poff=557
0x3ae: Call 0x393

0x3af: Pop(1)
0x3b0: Push((int) 7526)
0x3b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3b2: Pop(1)
0x3b3: @@@ ClearReplies(); Obj=0 // @poff=584
0x3b4: Pop(0)
0x3b5: Push((int) 7527)
0x3b6: Push((int) -1)
0x3b7: Push((int) 8309)
0x3b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3b9: Pop(3)
0x3ba: Return(); Pop(0)
...
0x3e5: PushEmpty()
0x3e6: Push("kill_player") // @poff=616
...
0x3f2: @ GetPFPosition(Stack[-1]T)
0x3f3: Pop(0)
0x3f4: @ GetDirection(Stack[-0]T)
0x3f5: Pop(0)
0x3f6: Push((int) 60)
...
0x40d: @ FindPathTo(Stack[-1], Stack[-1]T)
0x40e: Pop(0)
...
0x41c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x41d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x42f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x430: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x448: Stack[-2] = "fire" // @poff=640
0x449: Return(); Pop(0)

0x44a: Stack[-2] = "phys" // @poff=650
0x44b: Return(); Pop(0)

0x44c: PushEmpty(bool, bool)
0x44d: Push("HasProperty") // @poff=660
0x44e: Push((int) 2)
...
0x454: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=684
0x455: Pop(0)
0x456: Stack[-1] = Stack[-5]
0x457: Return(); Pop(2)

0x458: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x459: PushEmpty(bool, object, string)
0x45a: Stack[-18] = Stack[-2]
0x45b: Stack[-1] = "health" // @poff=696
0x45c: Call 0x44c
...
0x463: Stack[-18] = Stack[-2]
0x464: Stack[-1] = "armor" // @poff=710
0x465: Call 0x44c
...
0x46b: Push("armor") // @poff=710
0x46c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=722
0x46d: Pop(1)
0x46e: Push("armor_") // @poff=734
0x46f: PushEmpty(string, int)
0x470: Stack[-16] = Stack[-1]
0x471: Call 0x444

0x472: Pop(1)
0x473: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x474: PushEmpty(bool, object, string)
0x475: Stack[-18] = Stack[-2]
0x476: Stack[-8] = Stack[-1]
0x477: Call 0x44c
...
0x47d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=722
0x47e: Pop(0)
...
0x485: Stack[-3] = Stack[-6]
0x486: Pop(3)
0x487: Push("health") // @poff=696
0x488: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=722
0x489: Pop(1)
0x48a: Push((int) 1)
0x48b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x48c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x48d: Push("health") // @poff=696
...
0x493: Pop(3)
0x494: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=748
0x495: Pop(2)
0x496: Stack[-1] = Stack[-16]
0x497: Return(); Pop(12)

0x498: PushEmpty(bool, bool)
0x499: @@ IsDead(Stack[-1]); Obj=3 // @poff=760
0x49a: Pop(0)
0x49b: Stack[-1] = Stack[-4]
0x49c: Return(); Pop(2)

0x49d: PushEmpty(object, object, object, object)
0x49e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4b2: Pop(0)
0x4b3: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4b4: IF (Stack[-1] == 0) GOTO 0x4b7; Pop(1)

0x4b5: Stack[-6] = (bool) 0
0x4b6: Return(); Pop(4)

0x4b7: @@ GetScene(Stack[-1]); Obj=5 // @poff=781
0x4b8: Pop(0)
...
0x4cb: Stack[-6] = Stack[-2]
0x4cc: Stack[-1] = "noaccess" // @poff=790
0x4cd: Call 0x44c
...
0x4d3: Push("noaccess") // @poff=790
0x4d4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=722
0x4d5: Pop(1)
0x4d6: Push((int) 0)
...
0x4ff: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x500: Pop(0)
...
0x510: Stack[-1] = "fhit" // @poff=846
0x511: GOTO 0x513

0x512: Stack[-1] = "bhit" // @poff=856
0x513: Push("hit_react") // @poff=866
0x514: Push("1") // @poff=886
0x515: Pop(1); Push(Stack[-3] + Stack[-1]);
0x516: Push("2") // @poff=890
...
0x51d: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x51e: Pop(0)
...
0x528: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x529: Pop(0)
0x52a: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=472
0x52b: Pop(0)
...
0x56b: Pop(0)
0x56c: Push("start: ") // @poff=912
0x56d: Pop(1); Push(Stack[-1] + Stack[-3]);
0x56e: @ Trace(Stack[-1])
0x56f: Pop(1)
0x570: Push("end: ") // @poff=928
...
0x57f: Push((float)9.999999974752427e-07)
...
0x59e: Pop(0)
0x59f: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x5b4: Stack[-2] = "quest_d2_02" // @poff=940
0x5b5: Stack[-1] = "player_attack" // @poff=964
0x5b6: Call 0x59c
...
0x5ba: Stack[-2] = "quest_d2_02" // @poff=940
0x5bb: Stack[-1] = "patrol2_unload" // @poff=992
0x5bc: Call 0x59c
...
0x5d3: Stack[-7] = Stack[-3]
0x5d4: Stack[-6] = Stack[-2]
...
0x5ff: Stack[-1] = "ui/NPC_Black.png" // @poff=1074
0x600: Return(); Pop(0)
