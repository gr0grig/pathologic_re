...
Strings:
	...
	A:Find
	A:Remove
// @pool_raw:
...
0x14: Stack[-3] = "pt_d2q03_birdmask" // @poff=58
0x15: Stack[-2] = "pers_birdmask" // @poff=94
0x16: Stack[-1] = "d2q03_birdmask.xml" // @poff=122
0x17: Call 0x74
...
0x37: Push("icot_lara_supply") // @poff=180
0x38: @ FindActor(Stack[-2], Stack[-1])
0x39: Pop(1)
0x3a: Push("enabled") // @poff=214
0x3b: Push((bool) 1)
0x3c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=230
0x3d: Pop(2)
0x3e: Push("d2q03") // @poff=0
0x3f: Push((int) 1000)
...
0x4d: Push("cleanup") // @poff=242
0x4e: @ Trigger(Stack[-0]T, Stack[-1])
0x4f: Pop(1)
...
0x75: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=258
0x76: Pop(0)
0x77: Pop(0); Push((bool) Stack[-4] == 0)
0x78: IF (Stack[-1] == 0) GOTO 0x81; Pop(1)

0x79: Push("Locator ") // @poff=269
0x7a: Pop(1); Push(Stack[-1] + Stack[-12]);
0x7b: Push(" doesn't exist") // @poff=287
...
0x8b: Push("Can't retrieve diary root") // @poff=317
0x8c: @ Trace(Stack[-1])
0x8d: Pop(1)
0x8e: Stack[-3] = (bool) 0
0x8f: Return(); Pop(2)
...
0x97: Pop(1)
0x98: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=369
0x99: Pop(0)
