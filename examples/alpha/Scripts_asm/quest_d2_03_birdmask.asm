...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0xd1: Stack[-1] = "Neutral" // @poff=61
0xd2: Call 0x83

0xd3: Pop(1)
0xd4: Push((int) 6910)
0xd5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xd6: Pop(1)
0xd7: @@@ ClearReplies(); Obj=0 // @poff=88
0xd8: Pop(0)
0xd9: Push((int) 6911)
0xda: Push((int) 7618)
0xdb: Push((int) 7617)
0xdc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xdd: Pop(3)
...
0xff: Stack[-1] = "Neutral" // @poff=61
0x100: Call 0x83

0x101: Pop(1)
0x102: Push((int) 7255)
0x103: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x104: Pop(1)
0x105: @@@ ClearReplies(); Obj=0 // @poff=88
0x106: Pop(0)
0x107: Push((int) 7256)
0x108: Push((int) 7997)
0x109: Push((int) 7996)
0x10a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x10b: Pop(3)
0x10c: Return(); Pop(0)
...
0x111: Stack[-1] = "Neutral" // @poff=61
0x112: Call 0x83

0x113: Pop(1)
0x114: Push((int) 7257)
0x115: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x116: Pop(1)
0x117: @@@ ClearReplies(); Obj=0 // @poff=88
0x118: Pop(0)
0x119: Push((int) 7258)
0x11a: Push((int) 7999)
0x11b: Push((int) 7998)
...
0x1e9: @@ GetPosition(Stack[-7]); Obj=17 // @poff=172
0x1ea: Pop(0)
0x1eb: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=184
0x1ec: Pop(0)
...
0x22c: Pop(0)
0x22d: Push("start: ") // @poff=216
0x22e: Pop(1); Push(Stack[-1] + Stack[-3]);
0x22f: @ Trace(Stack[-1])
0x230: Pop(1)
0x231: Push("end: ") // @poff=232
...
0x246: Push((float)9.999999974752427e-07)
...
0x254: Pop(0)
0x255: Stack[-1] = Stack[-3]
0x256: Return(); Pop(2)

0x257: PushEmpty()
0x258: Push("ood2Birdmask1") // @poff=244
0x259: Push((int) 1)
...
0x265: Pop(1)
0x266: Push("d2q03BirdmaskGotoLara") // @poff=272
0x267: Push("pt_map_lara") // @poff=316
0x268: Push((int) 0)
...
0x26c: Pop(0)
0x26d: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=340
0x26e: Pop(5)
0x26f: Push("d2q03BirdmaskGotoLaraSelf") // @poff=348
0x270: Push("") // @poff=74
0x271: Push((int) 0)
...
0x275: Pop(0)
0x276: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=340
0x277: Pop(5)
0x278: PushEmpty()
0x279: Call 0x2ed
...
0x27f: Stack[-1] = "KnowTheater" // @poff=400
0x280: Call 0x24d
...
0x28b: Stack[-1] = "ood2Birdmask1" // @poff=244
0x28c: Call 0x24d
...
0x2a6: Push("Can't retrieve diary root") // @poff=424
0x2a7: @ Trace(Stack[-1])
0x2a8: Pop(1)
...
0x2b2: Pop(1)
0x2b3: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=476
0x2b4: Pop(0)
0x2b5: Pop(0); Push((bool) Stack[-2] == 0)
0x2b6: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2b7: Push("Can't find diary parent with id: ") // @poff=481
...
0x2bd: @@ AddChild(Stack[-8]); Obj=2 // @poff=549
0x2be: Pop(0)
0x2bf: Push("player_diary") // @poff=558
0x2c0: Push((int) 1)
0x2c1: @ SetVariable(Stack[-2], Stack[-1])
0x2c2: Pop(2)
0x2c3: @@ GetCategory(Stack[-1]); Obj=8 // @poff=584
0x2c4: Pop(0)
...
0x2cd: Pop(0)
0x2ce: Pop(0); PushNull((bool) Stack[-2] == 0)
0x2cf: IF (Stack[-1] == 0) GOTO 0x2d6; Pop(1)

0x2d0: Push("Can't find main outdoor scene") // @poff=596
0x2d1: @ Trace(Stack[-1])
0x2d2: Pop(1)
0x2d3: Stack[-1] = 0
0x2d4: Stack[-1] = Stack[-5]
0x2d5: Return(); Pop(4)

0x2d6: @@ GetMap(Stack[-1]); Obj=2 // @poff=656
0x2d7: Pop(0)
...
0x2ee: Push("Adding diary entry") // @poff=677
0x2ef: @ Trace(Stack[-1])
0x2f0: Pop(1)
0x2f1: Push((int) 133)
0x2f2: Push((int) 2)
...
0x2ff: Stack[-1] = "ui/NPC_Black.png" // @poff=715
0x300: Return(); Pop(0)
