...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
...
0x2ad: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2ae: IF (Stack[-1] == 0) GOTO 0x2b4; Pop(1)

0x2af: PushEmpty(string)
0x2b0: Stack[-1] = "fdie" // @poff=338
0x2b1: Call 0x303

0x2b2: Pop(1)
0x2b3: GOTO 0x302

0x2b4: @@ GetPosition(Stack[-10]); Obj=21 // @poff=308
0x2b5: Pop(0)
...
0x2c5: Stack[-6] = "fdie" // @poff=338
0x2c6: GOTO 0x2c8

0x2c7: Stack[-6] = "bdie" // @poff=348
...
0x2ce: @ StopAsync()
0x2cf: Pop(0)
0x2d0: Stack[-21] = Stack[-5]
0x2d1: Push("GetScriptProperty") // @poff=358
0x2d2: Push((int) 2)
0x2d3: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2d4: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2d5: Push("Owner") // @poff=394
0x2d6: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=406
0x2d7: Pop(1)
0x2d8: Push(Stack[-4])
0x2d9: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2da: Push("Owner") // @poff=394
0x2db: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=424
0x2dc: Pop(1)
0x2dd: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2de: IF (Stack[-1] == 0) GOTO 0x2e0; Pop(1)

0x2df: Stack[-21] = Stack[-5]
0x2e0: Push("@GetEyesHeight") // @poff=442
0x2e1: Push((int) 1)
0x2e2: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2e3: IF (Stack[-1] == 0) GOTO 0x2ef; Pop(1)

0x2e4: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=472
0x2e5: Pop(0)
...
0x2f7: @ StopAsync()
0x2f8: Pop(0)
0x2f9: Push("head") // @poff=486
0x2fa: @ UnlookAsync(Stack[-1])
0x2fb: Pop(1)
0x2fc: Push("all") // @poff=14
...
0x32d: Pop(0)
0x32e: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=496
0x32f: Pop(1)
0x330: PushEmpty(string)
0x331: Call 0x672

0x332: Pop(0)
0x333: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=507
0x334: Pop(1)
0x335: PushEmpty(int)
0x336: Call 0x64f

0x337: Pop(0)
0x338: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=516
0x339: Pop(1)
0x33a: Stack[-2] = (int) -1
...
0x349: Pop(2)
0x34a: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=530
0x34b: Pop(0)
...
0x34e: @ sync()
0x34f: Pop(0)
0x350: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=530
0x351: Pop(0)
0x352: GOTO 0x34c

0x353: PushEmpty(object)
0x354: Stack[-10] = Stack[-1]
0x355: Call 0x5a5

0x356: Pop(1)
0x357: @ StopDialog(Stack[-4])
0x358: Pop(0)
0x359: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=542
0x35a: Pop(0)
0x35b: Stack[-2] = Stack[-10]
0x35c: Return(); Pop(8)
...
0x365: Stack[-1] = "Neutral" // @poff=557
0x366: Call 0x393

0x367: Pop(1)
0x368: Push((int) 9122)
0x369: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x36a: Pop(1)
0x36b: @@@ ClearReplies(); Obj=0 // @poff=584
0x36c: Pop(0)
0x36d: Push((int) 9123)
0x36e: Push((int) 10004)
0x36f: Push((int) 10003)
0x370: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x371: Pop(3)
0x372: GOTO 0x375
...
0x384: Push("all") // @poff=14
0x385: Push("idle") // @poff=606
...
0x38d: Push("all") // @poff=14
0x38e: Push("idle") // @poff=606
...
0x3c5: Stack[-1] = "Neutral" // @poff=557
0x3c6: Call 0x393

0x3c7: Pop(1)
0x3c8: Push((int) 9122)
0x3c9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3ca: Pop(1)
0x3cb: @@@ ClearReplies(); Obj=0 // @poff=584
0x3cc: Pop(0)
0x3cd: Push((int) 9123)
0x3ce: Push((int) 10004)
0x3cf: Push((int) 10003)
0x3d0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3d1: Pop(3)
0x3d2: Return(); Pop(0)
...
0x3d7: Stack[-1] = "Neutral" // @poff=557
0x3d8: Call 0x393

0x3d9: Pop(1)
0x3da: Push((int) 9124)
0x3db: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3dc: Pop(1)
0x3dd: @@@ ClearReplies(); Obj=0 // @poff=584
0x3de: Pop(0)
0x3df: Push((int) 9125)
0x3e0: Push((int) -1)
0x3e1: Push((int) 10005)
0x3e2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3e3: Pop(3)
0x3e4: Push((int) 9126)
0x3e5: Push((int) -1)
0x3e6: Push((int) 10006)
0x3e7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3e8: Pop(3)
0x3e9: Push((int) 9127)
0x3ea: Push((int) 10008)
0x3eb: Push((int) 10007)
0x3ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3ed: Pop(3)
0x3ee: Return(); Pop(0)
...
0x3f3: Stack[-1] = "Neutral" // @poff=557
0x3f4: Call 0x393

0x3f5: Pop(1)
0x3f6: Push((int) 9128)
0x3f7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3f8: Pop(1)
0x3f9: @@@ ClearReplies(); Obj=0 // @poff=584
0x3fa: Pop(0)
0x3fb: Push((int) 9129)
0x3fc: Push((int) -1)
0x3fd: Push((int) 10009)
0x3fe: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3ff: Pop(3)
0x400: Return(); Pop(0)
...
0x438: @ GetPFPosition(Stack[-1]T)
0x439: Pop(0)
0x43a: @ GetDirection(Stack[-0]T)
0x43b: Pop(0)
0x43c: Push((int) 60)
...
0x453: @ FindPathTo(Stack[-1], Stack[-1]T)
0x454: Pop(0)
...
0x462: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x463: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x475: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x476: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x48e: Stack[-2] = "fire" // @poff=616
0x48f: Return(); Pop(0)

0x490: Stack[-2] = "phys" // @poff=626
0x491: Return(); Pop(0)

0x492: PushEmpty(bool, bool)
0x493: Push("HasProperty") // @poff=636
0x494: Push((int) 2)
...
0x49a: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=660
0x49b: Pop(0)
...
0x4a0: Stack[-18] = Stack[-2]
0x4a1: Stack[-1] = "health" // @poff=672
0x4a2: Call 0x492
...
0x4a9: Stack[-18] = Stack[-2]
0x4aa: Stack[-1] = "armor" // @poff=686
0x4ab: Call 0x492
...
0x4b1: Push("armor") // @poff=686
0x4b2: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=698
0x4b3: Pop(1)
0x4b4: Push("armor_") // @poff=710
...
0x4bb: Stack[-18] = Stack[-2]
0x4bc: Stack[-8] = Stack[-1]
0x4bd: Call 0x492
...
0x4c3: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=698
0x4c4: Pop(0)
...
0x4cb: Stack[-3] = Stack[-6]
0x4cc: Pop(3)
0x4cd: Push("health") // @poff=672
0x4ce: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=698
0x4cf: Pop(1)
0x4d0: Push((int) 1)
0x4d1: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4d2: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4d3: Push("health") // @poff=672
...
0x4d9: Pop(3)
0x4da: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=724
0x4db: Pop(2)
0x4dc: Stack[-1] = Stack[-16]
0x4dd: Return(); Pop(12)

0x4de: PushEmpty(bool, bool)
0x4df: @@ IsDead(Stack[-1]); Obj=3 // @poff=736
0x4e0: Pop(0)
0x4e1: Stack[-1] = Stack[-4]
0x4e2: Return(); Pop(2)

0x4e3: PushEmpty(object, object, object, object)
0x4e4: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4f8: Pop(0)
0x4f9: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4fa: IF (Stack[-1] == 0) GOTO 0x4fd; Pop(1)

0x4fb: Stack[-6] = (bool) 0
0x4fc: Return(); Pop(4)

0x4fd: @@ GetScene(Stack[-1]); Obj=5 // @poff=757
0x4fe: Pop(0)
...
0x512: Stack[-1] = "noaccess" // @poff=766
0x513: Call 0x492
...
0x519: Push("noaccess") // @poff=766
0x51a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=698
0x51b: Pop(1)
0x51c: Push((int) 0)
...
0x545: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x546: Pop(0)
...
0x556: Stack[-1] = "fhit" // @poff=822
0x557: GOTO 0x559

0x558: Stack[-1] = "bhit" // @poff=832
0x559: Push("hit_react") // @poff=842
0x55a: Push("1") // @poff=862
0x55b: Pop(1); Push(Stack[-3] + Stack[-1]);
0x55c: Push("2") // @poff=866
...
0x563: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x564: Pop(0)
...
0x56e: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x56f: Pop(0)
0x570: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=472
0x571: Pop(0)
...
0x5b1: Pop(0)
0x5b2: Push("start: ") // @poff=888
0x5b3: Pop(1); Push(Stack[-1] + Stack[-3]);
0x5b4: @ Trace(Stack[-1])
0x5b5: Pop(1)
0x5b6: Push("end: ") // @poff=904
...
0x5c5: Push((float)9.999999974752427e-07)
...
0x5ef: Push("revolver_ammo") // @poff=916
0x5f0: Push((int) 0)
0x5f1: Push((int) 2)
0x5f2: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x5f3: Pop(3)
0x5f4: Push("alpha_pills") // @poff=944
0x5f5: Push((int) 0)
0x5f6: Push((int) 2)
...
0x602: Stack[-7] = Stack[-3]
0x603: Stack[-6] = Stack[-2]
...
0x620: Stack[-2] = "quest_d3_01" // @poff=968
0x621: Stack[-1] = "patrol_talk" // @poff=992
0x622: Call 0x5e2
...
0x62a: Push("Can't retrieve diary root") // @poff=1016
0x62b: @ Trace(Stack[-1])
0x62c: Pop(1)
...
0x636: Pop(1)
0x637: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1068
0x638: Pop(0)
0x639: Pop(0); Push((bool) Stack[-2] == 0)
0x63a: IF (Stack[-1] == 0) GOTO 0x641; Pop(1)

0x63b: Push("Can't find diary parent with id: ") // @poff=1073
...
0x641: @@ AddChild(Stack[-8]); Obj=2 // @poff=1141
0x642: Pop(0)
0x643: Push("player_diary") // @poff=1150
0x644: Push((int) 1)
0x645: @ SetVariable(Stack[-2], Stack[-1])
0x646: Pop(2)
0x647: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1176
0x648: Pop(0)
...
0x661: Push("Adding diary entry") // @poff=1188
0x662: @ Trace(Stack[-1])
0x663: Pop(1)
0x664: Push((int) 72)
0x665: Push((int) 1)
...
0x672: Stack[-1] = "ui/NPC_Black.png" // @poff=1226
0x673: Return(); Pop(0)
