...
Strings:
	...
	W: doesn't exist
	W:nouse_container
// @pool_raw:
...
0x1d: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=42
0x1e: Pop(0)
0x1f: Push(Stack[-2])
...
0x3c: Push("light") // @poff=65
0x3d: @ GetProperty(Stack[-1], Stack[-2])
0x3e: Pop(1)
0x3f: @ FindActor(Stack[-1]T, Stack[-1])
0x40: Pop(0)
0x41: Push((bool) 1)
0x42: @@@ Switch(Stack[-1]); Obj=1 // @poff=77
0x43: Pop(1)
0x44: Push((bool) 1)
...
0x50: Pop(0)
0x51: Push("fire_loc") // @poff=84
0x52: @ GetProperty(Stack[-1], Stack[-2])
0x53: Pop(1)
0x54: PushEmpty(object, object, string, string, string)
0x55: Stack[-7] = Stack[-4]
0x56: Stack[-6] = Stack[-3]
0x57: Stack[-2] = "scripted" // @poff=102
0x58: Stack[-1] = "bonfire.xml" // @poff=120
0x59: Call 0x9a
...
0x5d: Stack[-2] = 0
0x5e: @ RemoveActor(Stack[-2]T)
0x5f: Pop(0)
0x60: Push((bool) 0)
0x61: @@@ Switch(Stack[-1]); Obj=1 // @poff=77
0x62: Pop(1)
0x63: Return(); Pop(0)
...
0x9b: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=176
0x9c: Pop(0)
0x9d: Pop(0); Push((bool) Stack[-4] == 0)
0x9e: IF (Stack[-1] == 0) GOTO 0xa7; Pop(1)

0x9f: Push("Locator ") // @poff=187
0xa0: Pop(1); Push(Stack[-1] + Stack[-12]);
0xa1: Push(" doesn't exist") // @poff=205
...
0xa8: Pop(0)
0xa9: Stack[-1] = Stack[-13]
0xaa: Return(); Pop(8)

0xab: Stack[-1] = 0
0xac: PushEmpty(int, int)
0xad: Push("nouse_container") // @poff=235
