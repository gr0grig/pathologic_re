...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
// @pool_encoding:utf8
...
0x46: Stack[-1] = "Neutral" // @poff=61
0x47: Call 0x74

0x48: Pop(1)
0x49: Push((int) 9131)
0x4a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x4b: Pop(1)
0x4c: @@@ ClearReplies(); Obj=0 // @poff=88
0x4d: Pop(0)
0x4e: Push((int) 9132)
0x4f: Push((int) 10013)
0x50: Push((int) 10012)
0x51: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x52: Pop(3)
0x53: GOTO 0x56
...
0x65: Push("all") // @poff=110
0x66: Push("idle") // @poff=118
...
0x6e: Push("all") // @poff=110
0x6f: Push("idle") // @poff=118
...
0xc2: Stack[-1] = "Neutral" // @poff=61
0xc3: Call 0x74

0xc4: Pop(1)
0xc5: Push((int) 9131)
0xc6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc7: Pop(1)
0xc8: @@@ ClearReplies(); Obj=0 // @poff=88
0xc9: Pop(0)
0xca: Push((int) 9132)
0xcb: Push((int) 10013)
0xcc: Push((int) 10012)
0xcd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xce: Pop(3)
0xcf: Return(); Pop(0)
...
0xd4: Stack[-1] = "Neutral" // @poff=61
0xd5: Call 0x74

0xd6: Pop(1)
0xd7: Push((int) 9133)
0xd8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xd9: Pop(1)
0xda: @@@ ClearReplies(); Obj=0 // @poff=88
0xdb: Pop(0)
0xdc: Push((int) 9134)
0xdd: Push((int) 10019)
0xde: Push((int) 10014)
...
0xe2: Push((int) 10016)
0xe3: Push((int) 10015)
0xe4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xe5: Pop(3)
0xe6: Return(); Pop(0)
...
0xeb: Stack[-1] = "Neutral" // @poff=61
0xec: Call 0x74

0xed: Pop(1)
0xee: Push((int) 9136)
0xef: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf0: Pop(1)
0xf1: @@@ ClearReplies(); Obj=0 // @poff=88
0xf2: Pop(0)
0xf3: Push((int) 9137)
0xf4: Push((int) -1)
0xf5: Push((int) 10017)
0xf6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xf7: Pop(3)
0xf8: Push((int) 9138)
0xf9: Push((int) -1)
0xfa: Push((int) 10018)
...
0x102: Stack[-1] = "Neutral" // @poff=61
0x103: Call 0x74

0x104: Pop(1)
0x105: Push((int) 9139)
0x106: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x107: Pop(1)
0x108: @@@ ClearReplies(); Obj=0 // @poff=88
0x109: Pop(0)
0x10a: Push((int) 9140)
0x10b: Push((int) 10021)
0x10c: Push((int) 10020)
0x10d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x10e: Pop(3)
0x10f: Return(); Pop(0)
...
0x114: Stack[-1] = "Neutral" // @poff=61
0x115: Call 0x74

0x116: Pop(1)
0x117: Push((int) 9141)
0x118: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x119: Pop(1)
0x11a: @@@ ClearReplies(); Obj=0 // @poff=88
0x11b: Pop(0)
0x11c: Push((int) 9142)
0x11d: Push((int) 10023)
0x11e: Push((int) 10022)
0x11f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x120: Pop(3)
...
0x129: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x12a: Pop(3)
0x12b: Return(); Pop(0)
...
0x145: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x146: Pop(3)
0x147: Return(); Pop(0)
...
0x161: PushEmpty()
0x162: Push("kill_player") // @poff=128
...
0x16e: Push("talk_player") // @poff=152
...
0x179: Stack[-2] = "quest_d3_01" // @poff=176
0x17a: Stack[-1] = "kill_player" // @poff=128
0x17b: Call 0x64f
...
0x17f: @ GetPFPosition(Stack[-1]T)
0x180: Pop(0)
0x181: @ GetDirection(Stack[-0]T)
0x182: Pop(0)
0x183: Push((int) 60)
...
0x19a: @ FindPathTo(Stack[-1], Stack[-1]T)
0x19b: Pop(0)
...
0x1a9: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1aa: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x1bc: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x1bd: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x1df: Stack[-1] = 0
0x1e0: PushEmpty()
0x1e1: Stack[-3] = (float) 0.15000000596046448
0x1e2: Return(); Pop(0)
...
0x1e8: Push("all") // @poff=110
0x1e9: Push("attack_begin") // @poff=200
0x1ea: Push((int) 1)
0x1eb: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x1f6: Push("attack") // @poff=226
0x1f7: Push((int) 1)
0x1f8: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x213: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x214: Pop(0)
0x215: Push(Stack[-22])
...
0x225: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=296
0x226: Pop(0)
...
0x249: Pop(1)
0x24a: Push("all") // @poff=110
0x24b: Push("attack_on") // @poff=310
...
0x257: Push((float)0.6000000238418579)
0x258: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x259: IF (Stack[-1] == 1) GOTO 0x25f; Pop(1)

0x25a: PushEmpty(bool)
0x25b: Call 0x39e

0x25c: Pop(0)
0x25d: IF (Stack[-1] == 1) GOTO 0x25f; Pop(1)

0x25e: Stack[-1] = (bool) 0
0x25f: IF (Stack[-1] == 0) GOTO 0x26d; Pop(1)

0x260: @ Face(Stack[-0]T)
0x261: Pop(0)
0x262: Push("all") // @poff=110
0x263: Push("attack_stay") // @poff=330
0x264: @ PlayAnimation(Stack[-2], Stack[-1])
0x265: Pop(2)
0x266: PushEmpty(bool, float)
0x267: Stack[-23] = Stack[-1]
0x268: Call 0x342
...
0x26d: @ Face(Stack[-0]T)
0x26e: Pop(0)
0x26f: Push("all") // @poff=110
0x270: Push("fjump") // @poff=354
...
0x288: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=296
0x289: Pop(0)
...
0x2a7: Push("all") // @poff=110
0x2a8: Push("attack_off") // @poff=366
...
0x2b4: Push((float)0.8999999761581421)
0x2b5: Pop(1); Push(Stack[-9] * Stack[-1]);
0x2b6: @ GetVictim(Stack[-1], Stack[-4])
0x2b7: Pop(1)
0x2b8: @ ReportAttack(Stack[-0]T)
0x2b9: Pop(0)
...
0x2be: Stack[-10] = Stack[-1]
0x2bf: Call 0x1e0

0x2c0: Stack[-3] = Stack[-5]
0x2c1: Pop(3)
0x2c2: PushEmpty(float, object, float, int)
0x2c3: Stack[-7] = Stack[-3]
0x2c4: Stack[-6] = Stack[-2]
0x2c5: PushEmpty(int, object, int)
0x2c6: Stack[-10] = Stack[-2]
0x2c7: Stack[-14] = Stack[-1]
0x2c8: Call 0x1e3

0x2c9: Stack[-3] = Stack[-4]
0x2ca: Pop(3)
0x2cb: Call 0x50b

0x2cc: Stack[-4] = Stack[-5]
0x2cd: Pop(4)
0x2ce: PushEmpty(int)
0x2cf: Call 0x3c9

0x2d0: Pop(0)
0x2d1: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x2d2: Pop(1)
...
0x2e3: Pop(1)
0x2e4: Push("all") // @poff=110
0x2e5: Push("attack_begin") // @poff=200
...
0x2f9: Stack[-7] = Stack[-2]
0x2fa: Stack[-4] = Stack[-1]
0x2fb: Call 0x2b3

0x2fc: Pop(2)
0x2fd: Push("all") // @poff=110
0x2fe: Push("attack_middle") // @poff=388
...
0x304: Push("all") // @poff=110
0x305: Push("attack_middle") // @poff=388
...
0x31c: Pop(1)
0x31d: Push("all") // @poff=110
0x31e: Push("attack_end") // @poff=416
...
0x356: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=296
0x357: Pop(0)
...
0x38c: @ Face(Stack[-0]T)
0x38d: Pop(0)
0x38e: Push("all") // @poff=110
0x38f: Push("bjump") // @poff=438
0x390: @ PlayAnimation(Stack[-2], Stack[-1])
0x391: Pop(2)
0x392: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=296
0x393: Pop(0)
...
0x3bc: @ irand(Stack[-1], Stack[-2]T)
0x3bd: Pop(0)
0x3be: Push((int) 1)
0x3bf: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x3c0: Push("attack") // @poff=226
...
0x3d4: Stack[-17] = Stack[-7]
0x3d5: PushEmpty(bool, object)
0x3d6: Stack[-23] = Stack[-1]
0x3d7: Call 0x45d
...
0x3dd: @@ GetPosition(Stack[-5]); Obj=21 // @poff=486
0x3de: Pop(0)
...
0x3f4: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=296
0x3f5: Pop(0)
...
0x406: Push((int) 0)
0x407: Push((float)0.30000001192092896)
...
0x429: Push((int) 0)
0x42a: Push((float)0.30000001192092896)
...
0x461: Stack[-2] = Stack[-4]
0x462: Pop(2)
0x463: Return(); Pop(0)

0x464: Stack[-1] = "walk" // @poff=498
0x465: Return(); Pop(0)

0x466: Stack[-1] = "run" // @poff=508
0x467: Return(); Pop(0)
...
0x47e: Pop(0); PushNull((bool) Stack[-21] == 0)
0x47f: IF (Stack[-1] == 0) GOTO 0x485; Pop(1)

0x480: PushEmpty(string)
0x481: Stack[-1] = "fdie" // @poff=516
0x482: Call 0x4d4

0x483: Pop(1)
0x484: GOTO 0x4d3

0x485: @@ GetPosition(Stack[-10]); Obj=21 // @poff=486
0x486: Pop(0)
...
0x496: Stack[-6] = "fdie" // @poff=516
0x497: GOTO 0x499

0x498: Stack[-6] = "bdie" // @poff=526
...
0x49f: @ StopAsync()
0x4a0: Pop(0)
0x4a1: Stack[-21] = Stack[-5]
0x4a2: Push("GetScriptProperty") // @poff=536
0x4a3: Push((int) 2)
0x4a4: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x4a5: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)

0x4a6: Push("Owner") // @poff=572
0x4a7: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=584
0x4a8: Pop(1)
0x4a9: Push(Stack[-4])
0x4aa: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)

0x4ab: Push("Owner") // @poff=572
0x4ac: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=602
0x4ad: Pop(1)
0x4ae: Pop(0); PushNull((bool) Stack[-5] == 0)
0x4af: IF (Stack[-1] == 0) GOTO 0x4b1; Pop(1)

0x4b0: Stack[-21] = Stack[-5]
0x4b1: Push("@GetEyesHeight") // @poff=620
0x4b2: Push((int) 1)
0x4b3: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x4b4: IF (Stack[-1] == 0) GOTO 0x4c0; Pop(1)

0x4b5: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=650
0x4b6: Pop(0)
...
0x4c8: @ StopAsync()
0x4c9: Pop(0)
0x4ca: Push("head") // @poff=664
0x4cb: @ UnlookAsync(Stack[-1])
0x4cc: Pop(1)
0x4cd: Push("all") // @poff=110
...
0x4f4: Stack[-2] = "fire" // @poff=674
0x4f5: Return(); Pop(0)

0x4f6: Stack[-2] = "phys" // @poff=684
0x4f7: Return(); Pop(0)

0x4f8: PushEmpty(bool, bool)
0x4f9: Push("HasProperty") // @poff=694
0x4fa: Push((int) 2)
...
0x500: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=718
0x501: Pop(0)
0x502: Stack[-1] = Stack[-5]
0x503: Return(); Pop(2)

0x504: PushEmpty(int, int)
0x505: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=730
0x506: Pop(0)
0x507: Pop(0); Push(Stack[-1] + Stack[-3]);
0x508: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=742
0x509: Pop(1)
0x50a: Return(); Pop(2)

0x50b: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x50c: PushEmpty(bool, object, string)
0x50d: Stack[-18] = Stack[-2]
0x50e: Stack[-1] = "health" // @poff=754
0x50f: Call 0x4f8
...
0x516: Stack[-18] = Stack[-2]
0x517: Stack[-1] = "armor" // @poff=768
0x518: Call 0x4f8
...
0x51e: Push("armor") // @poff=768
0x51f: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=730
0x520: Pop(1)
0x521: Push("armor_") // @poff=780
0x522: PushEmpty(string, int)
0x523: Stack[-16] = Stack[-1]
0x524: Call 0x4f0

0x525: Pop(1)
0x526: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x527: PushEmpty(bool, object, string)
0x528: Stack[-18] = Stack[-2]
0x529: Stack[-8] = Stack[-1]
0x52a: Call 0x4f8
...
0x530: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=730
0x531: Pop(0)
...
0x538: Stack[-3] = Stack[-6]
0x539: Pop(3)
0x53a: Push("health") // @poff=754
0x53b: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=730
0x53c: Pop(1)
0x53d: Push((int) 1)
0x53e: Pop(1); Push(Stack[-1] - Stack[-4]);
0x53f: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x540: Push("health") // @poff=754
...
0x546: Pop(3)
0x547: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=742
0x548: Pop(2)
0x549: Stack[-1] = Stack[-16]
0x54a: Return(); Pop(12)

0x54b: PushEmpty(bool, bool)
0x54c: @@ IsDead(Stack[-1]); Obj=3 // @poff=794
0x54d: Pop(0)
0x54e: Stack[-1] = Stack[-4]
0x54f: Return(); Pop(2)

0x550: PushEmpty(object, object, object, object)
0x551: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x565: Pop(0)
0x566: Pop(0); PushNull((bool) Stack[-2] == 0)
0x567: IF (Stack[-1] == 0) GOTO 0x56a; Pop(1)

0x568: Stack[-6] = (bool) 0
0x569: Return(); Pop(4)

0x56a: @@ GetScene(Stack[-1]); Obj=5 // @poff=815
0x56b: Pop(0)
...
0x57e: Stack[-6] = Stack[-2]
0x57f: Stack[-1] = "noaccess" // @poff=824
0x580: Call 0x4f8
...
0x586: Push("noaccess") // @poff=824
0x587: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x588: Pop(1)
0x589: Push((int) 0)
...
0x5b2: @@ GetPosition(Stack[-5]); Obj=23 // @poff=486
0x5b3: Pop(0)
...
0x5c3: Stack[-1] = "fhit" // @poff=880
0x5c4: GOTO 0x5c6

0x5c5: Stack[-1] = "bhit" // @poff=890
0x5c6: Push("hit_react") // @poff=900
0x5c7: Push("1") // @poff=196
0x5c8: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5c9: Push("2") // @poff=920
...
0x5d0: @@ GetPosition(Stack[-3]); Obj=7 // @poff=486
0x5d1: Pop(0)
...
0x5db: @@ GetPosition(Stack[-7]); Obj=17 // @poff=486
0x5dc: Pop(0)
0x5dd: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=650
0x5de: Pop(0)
...
0x61e: Pop(0)
0x61f: Push("start: ") // @poff=942
0x620: Pop(1); Push(Stack[-1] + Stack[-3]);
0x621: @ Trace(Stack[-1])
0x622: Pop(1)
0x623: Push("end: ") // @poff=958
...
0x632: Push((float)9.999999974752427e-07)
...
0x65a: Stack[-1] = 0
0x65b: PushEmpty()
0x65c: Push("d3q01") // @poff=970
0x65d: Push((int) 8)
0x65e: @ SetVariable(Stack[-2], Stack[-1])
0x65f: Pop(2)
0x660: PushEmpty(bool, string, string)
0x661: Stack[-2] = "quest_d3_01" // @poff=176
0x662: Stack[-1] = "gpatrol_attack" // @poff=982
0x663: Call 0x64f
...
0x668: Stack[-5] = Stack[-3]
0x669: Stack[-2] = "money" // @poff=1012
...
0x670: Stack[-2] = "quest_d3_01" // @poff=176
0x671: Stack[-1] = "gpatrol_talk" // @poff=1024
0x672: Call 0x64f
...
0x675: PushEmpty()
0x676: Push("playsound") // @poff=1050
0x677: Push("givemoney") // @poff=1070
...
0x686: Push("money") // @poff=1012
0x687: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=730
0x688: Pop(1)
...
0x69f: Stack[-1] = "ui/NPC_Black.png" // @poff=1090
0x6a0: Return(); Pop(0)
...
0x6b7: Stack[-7] = Stack[-3]
0x6b8: Stack[-6] = Stack[-2]
