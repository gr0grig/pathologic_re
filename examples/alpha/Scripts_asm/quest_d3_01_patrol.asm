...
Strings:
	...
	W:alpha_pills
	W:ui/NPC_Black.png
// @pool_raw:
...
0x373: Push((int) 9985)
0x374: Push((int) 9983)
0x375: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x376: Pop(3)
0x377: GOTO 0x37a
...
0x389: Push("all") // @poff=14
0x38a: Push("idle") // @poff=606
...
0x392: Push("all") // @poff=14
0x393: Push("idle") // @poff=606
...
0x3b2: Stack[-1] = "Neutral" // @poff=557
0x3b3: Call 0x398

0x3b4: Pop(1)
0x3b5: Push((int) 9102)
0x3b6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3b7: Pop(1)
0x3b8: @@@ ClearReplies(); Obj=0 // @poff=584
0x3b9: Pop(0)
0x3ba: Push((int) 9103)
0x3bb: Push((int) 9989)
0x3bc: Push((int) 9982)
0x3bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3be: Pop(3)
0x3bf: Push((int) 9104)
0x3c0: Push((int) 9985)
0x3c1: Push((int) 9983)
0x3c2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3c3: Pop(3)
0x3c4: Return(); Pop(0)
...
0x3c9: Stack[-1] = "Neutral" // @poff=557
0x3ca: Call 0x398

0x3cb: Pop(1)
0x3cc: Push((int) 9106)
0x3cd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3ce: Pop(1)
0x3cf: @@@ ClearReplies(); Obj=0 // @poff=584
0x3d0: Pop(0)
0x3d1: Push((int) 9107)
0x3d2: Push((int) 9984)
0x3d3: Push((int) 9986)
0x3d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3d5: Pop(3)
0x3d6: Return(); Pop(0)
...
0x3db: Stack[-1] = "Neutral" // @poff=557
0x3dc: Call 0x398

0x3dd: Pop(1)
0x3de: Push((int) 9105)
0x3df: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3e0: Pop(1)
0x3e1: @@@ ClearReplies(); Obj=0 // @poff=584
0x3e2: Pop(0)
0x3e3: Push((int) 9108)
0x3e4: Push((int) 9988)
0x3e5: Push((int) 9987)
0x3e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3e7: Pop(3)
0x3e8: Return(); Pop(0)
...
0x3ed: Stack[-1] = "Neutral" // @poff=557
0x3ee: Call 0x398

0x3ef: Pop(1)
0x3f0: Push((int) 9109)
0x3f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x3f2: Pop(1)
0x3f3: @@@ ClearReplies(); Obj=0 // @poff=584
0x3f4: Pop(0)
0x3f5: Push((int) 9112)
0x3f6: Push((int) 9992)
0x3f7: Push((int) 9991)
0x3f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x3f9: Pop(3)
0x3fa: Return(); Pop(0)
...
0x3ff: Stack[-1] = "Neutral" // @poff=557
0x400: Call 0x398

0x401: Pop(1)
0x402: Push((int) 9110)
0x403: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x404: Pop(1)
0x405: @@@ ClearReplies(); Obj=0 // @poff=584
0x406: Pop(0)
0x407: Push((int) 9111)
0x408: Push((int) 9992)
0x409: Push((int) 9990)
0x40a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x40b: Pop(3)
0x40c: Return(); Pop(0)
...
0x411: Stack[-1] = "Neutral" // @poff=557
0x412: Call 0x398

0x413: Pop(1)
0x414: Push((int) 9113)
0x415: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x416: Pop(1)
0x417: @@@ ClearReplies(); Obj=0 // @poff=584
0x418: Pop(0)
0x419: Push((int) 9114)
0x41a: Push((int) 9994)
0x41b: Push((int) 9993)
0x41c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x41d: Pop(3)
0x41e: Push((int) 9116)
0x41f: Push((int) -1)
0x420: Push((int) 9995)
0x421: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x422: Pop(3)
0x423: Return(); Pop(0)
...
0x428: Stack[-1] = "Neutral" // @poff=557
0x429: Call 0x398

0x42a: Pop(1)
0x42b: Push((int) 9115)
0x42c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x42d: Pop(1)
0x42e: @@@ ClearReplies(); Obj=0 // @poff=584
0x42f: Pop(0)
0x430: Push((int) 9117)
0x431: Push((int) -1)
0x432: Push((int) 9997)
0x433: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x434: Pop(3)
0x435: Push((int) 9118)
0x436: Push((int) 9999)
0x437: Push((int) 9998)
0x438: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x439: Pop(3)
0x43a: Return(); Pop(0)
...
0x43f: Stack[-1] = "Neutral" // @poff=557
0x440: Call 0x398

0x441: Pop(1)
0x442: Push((int) 9119)
0x443: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=573
0x444: Pop(1)
0x445: @@@ ClearReplies(); Obj=0 // @poff=584
0x446: Pop(0)
0x447: Push((int) 9120)
0x448: Push((int) -1)
0x449: Push((int) 10000)
0x44a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=597
0x44b: Pop(3)
0x44c: Return(); Pop(0)
...
0x484: @ GetPFPosition(Stack[-1]T)
0x485: Pop(0)
0x486: @ GetDirection(Stack[-0]T)
0x487: Pop(0)
0x488: Push((int) 60)
...
0x49f: @ FindPathTo(Stack[-1], Stack[-1]T)
0x4a0: Pop(0)
...
0x4ae: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4af: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x4c1: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x4c2: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x4da: Stack[-2] = "fire" // @poff=616
0x4db: Return(); Pop(0)

0x4dc: Stack[-2] = "phys" // @poff=626
0x4dd: Return(); Pop(0)

0x4de: PushEmpty(bool, bool)
0x4df: Push("HasProperty") // @poff=636
0x4e0: Push((int) 2)
...
0x4e6: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=660
0x4e7: Pop(0)
...
0x4ec: Stack[-18] = Stack[-2]
0x4ed: Stack[-1] = "health" // @poff=672
0x4ee: Call 0x4de
...
0x4f5: Stack[-18] = Stack[-2]
0x4f6: Stack[-1] = "armor" // @poff=686
0x4f7: Call 0x4de
...
0x4fd: Push("armor") // @poff=686
0x4fe: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=698
0x4ff: Pop(1)
0x500: Push("armor_") // @poff=710
0x501: PushEmpty(string, int)
0x502: Stack[-16] = Stack[-1]
0x503: Call 0x4d6

0x504: Pop(1)
0x505: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x506: PushEmpty(bool, object, string)
0x507: Stack[-18] = Stack[-2]
0x508: Stack[-8] = Stack[-1]
0x509: Call 0x4de
...
0x50f: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=698
0x510: Pop(0)
...
0x517: Stack[-3] = Stack[-6]
0x518: Pop(3)
0x519: Push("health") // @poff=672
0x51a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=698
0x51b: Pop(1)
0x51c: Push((int) 1)
0x51d: Pop(1); Push(Stack[-1] - Stack[-4]);
0x51e: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x51f: Push("health") // @poff=672
...
0x525: Pop(3)
0x526: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=724
0x527: Pop(2)
0x528: Stack[-1] = Stack[-16]
0x529: Return(); Pop(12)

0x52a: PushEmpty(bool, bool)
0x52b: @@ IsDead(Stack[-1]); Obj=3 // @poff=736
0x52c: Pop(0)
...
0x549: @@ GetScene(Stack[-1]); Obj=5 // @poff=757
0x54a: Pop(0)
...
0x55e: Stack[-1] = "noaccess" // @poff=766
0x55f: Call 0x4de
...
0x565: Push("noaccess") // @poff=766
0x566: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=698
0x567: Pop(1)
0x568: Push((int) 0)
...
0x591: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x592: Pop(0)
...
0x5a2: Stack[-1] = "fhit" // @poff=822
0x5a3: GOTO 0x5a5

0x5a4: Stack[-1] = "bhit" // @poff=832
0x5a5: Push("hit_react") // @poff=842
0x5a6: Push("1") // @poff=862
0x5a7: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5a8: Push("2") // @poff=866
...
0x5af: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x5b0: Pop(0)
...
0x5ba: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x5bb: Pop(0)
0x5bc: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=472
0x5bd: Pop(0)
...
0x5fd: Pop(0)
0x5fe: Push("start: ") // @poff=888
0x5ff: Pop(1); Push(Stack[-1] + Stack[-3]);
0x600: @ Trace(Stack[-1])
0x601: Pop(1)
0x602: Push("end: ") // @poff=904
...
0x61f: Stack[-2] = Stack[-3]
0x620: GOTO 0x622

0x621: Stack[-1] = Stack[-3]
0x622: Return(); Pop(0)
...
0x62c: Stack[-3] = Stack[-4]
0x62d: Return(); Pop(0)

0x62e: PushEmpty(bool, bool)
0x62f: Push("revolver_ammo") // @poff=916
0x630: Push((int) 0)
0x631: Push((int) 2)
0x632: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x633: Pop(3)
0x634: Push("alpha_pills") // @poff=944
0x635: Push((int) 0)
0x636: Push((int) 2)
...
0x642: Stack[-7] = Stack[-3]
0x643: Stack[-6] = Stack[-2]
0x644: Stack[-5] = Stack[-1]
0x645: Call 0x56b
...
0x66e: Stack[-1] = "ui/NPC_Black.png" // @poff=968
0x66f: Return(); Pop(0)
