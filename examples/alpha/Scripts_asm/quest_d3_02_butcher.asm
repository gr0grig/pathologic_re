...
Strings:
	...
	W:quest_d1_03
	W:butcher_death
// @pool_raw:
...
0x61: Stack[-1] = 0
0x62: PushEmpty()
0x63: Stack[-3] = (float) 0.10000000149011612
0x64: Return(); Pop(0)
...
0x72: Push("all") // @poff=74
0x73: Push("attack_begin") // @poff=82
0x74: Push((int) 1)
0x75: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x80: Push("attack") // @poff=108
0x81: Push((int) 1)
0x82: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x9d: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x9e: Pop(0)
0x9f: Push(Stack[-22])
...
0xaf: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=178
0xb0: Pop(0)
...
0xd3: Pop(1)
0xd4: Push("all") // @poff=74
0xd5: Push("attack_on") // @poff=192
...
0xdf: PushEmpty(bool)
0xe0: Stack[-1] = (bool) 1
0xe1: Push((float)0.6000000238418579)
0xe2: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0xe3: IF (Stack[-1] == 1) GOTO 0xe9; Pop(1)

0xe4: PushEmpty(bool)
0xe5: Call 0x228

0xe6: Pop(0)
0xe7: IF (Stack[-1] == 1) GOTO 0xe9; Pop(1)
...
0xea: @ Face(Stack[-0]T)
0xeb: Pop(0)
0xec: Push("all") // @poff=74
0xed: Push("attack_stay") // @poff=212
0xee: @ PlayAnimation(Stack[-2], Stack[-1])
0xef: Pop(2)
0xf0: PushEmpty(bool, float)
0xf1: Stack[-23] = Stack[-1]
0xf2: Call 0x1cc
...
0xf7: @ Face(Stack[-0]T)
0xf8: Pop(0)
0xf9: Push("all") // @poff=74
0xfa: Push("fjump") // @poff=236
...
0x112: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=178
0x113: Pop(0)
...
0x131: Push("all") // @poff=74
0x132: Push("attack_off") // @poff=248
...
0x165: @ irand(Stack[-2], Stack[-1]T)
0x166: Pop(0)
0x167: Push((int) 1)
0x168: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x169: @ Face(Stack[-0]T)
0x16a: Pop(0)
0x16b: Push((bool) 1)
0x16c: @ SetAttackState(Stack[-1])
0x16d: Pop(1)
0x16e: Push("all") // @poff=74
0x16f: Push("attack_begin") // @poff=82
...
0x183: Stack[-7] = Stack[-2]
0x184: Stack[-4] = Stack[-1]
0x185: Call 0x13d

0x186: Pop(2)
0x187: Push("all") // @poff=74
0x188: Push("attack_middle") // @poff=270
...
0x18e: Push("all") // @poff=74
0x18f: Push("attack_middle") // @poff=270
...
0x1a0: Stack[-7] = Stack[-2]
0x1a1: Stack[-4] = Stack[-1]
0x1a2: Call 0x13d
...
0x1a6: Pop(1)
0x1a7: Push("all") // @poff=74
0x1a8: Push("attack_end") // @poff=298
...
0x1e0: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=178
0x1e1: Pop(0)
...
0x216: @ Face(Stack[-0]T)
0x217: Pop(0)
0x218: Push("all") // @poff=74
0x219: Push("bjump") // @poff=320
0x21a: @ PlayAnimation(Stack[-2], Stack[-1])
0x21b: Pop(2)
0x21c: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=178
0x21d: Pop(0)
...
0x246: @ irand(Stack[-1], Stack[-2]T)
0x247: Pop(0)
0x248: Push((int) 1)
0x249: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x24a: Push("attack") // @poff=108
...
0x266: Stack[-17] = Stack[-7]
0x267: PushEmpty(bool, object)
0x268: Stack[-23] = Stack[-1]
0x269: Call 0x2ef
...
0x26f: @@ GetPosition(Stack[-5]); Obj=21 // @poff=368
0x270: Pop(0)
...
0x286: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=178
0x287: Pop(0)
...
0x298: Push((int) 0)
0x299: Push((float)0.30000001192092896)
...
0x2bb: Push((int) 0)
0x2bc: Push((float)0.30000001192092896)
...
0x2f6: Stack[-1] = "walk" // @poff=380
0x2f7: Return(); Pop(0)

0x2f8: Stack[-1] = "run" // @poff=390
0x2f9: Return(); Pop(0)
...
0x304: Pop(0); PushNull((bool) Stack[-21] == 0)
0x305: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x306: PushEmpty(string)
0x307: Stack[-1] = "fdie" // @poff=398
0x308: Call 0x35a

0x309: Pop(1)
0x30a: GOTO 0x359

0x30b: @@ GetPosition(Stack[-10]); Obj=21 // @poff=368
0x30c: Pop(0)
...
0x31c: Stack[-6] = "fdie" // @poff=398
0x31d: GOTO 0x31f

0x31e: Stack[-6] = "bdie" // @poff=408
...
0x325: @ StopAsync()
0x326: Pop(0)
0x327: Stack[-21] = Stack[-5]
0x328: Push("GetScriptProperty") // @poff=418
0x329: Push((int) 2)
0x32a: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x32b: IF (Stack[-1] == 0) GOTO 0x337; Pop(1)

0x32c: Push("Owner") // @poff=454
0x32d: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=466
0x32e: Pop(1)
0x32f: Push(Stack[-4])
0x330: IF (Stack[-1] == 0) GOTO 0x337; Pop(1)

0x331: Push("Owner") // @poff=454
0x332: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=484
0x333: Pop(1)
0x334: Pop(0); PushNull((bool) Stack[-5] == 0)
0x335: IF (Stack[-1] == 0) GOTO 0x337; Pop(1)

0x336: Stack[-21] = Stack[-5]
0x337: Push("@GetEyesHeight") // @poff=502
0x338: Push((int) 1)
0x339: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x33a: IF (Stack[-1] == 0) GOTO 0x346; Pop(1)

0x33b: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=532
0x33c: Pop(0)
...
0x34e: @ StopAsync()
0x34f: Pop(0)
0x350: Push("head") // @poff=546
0x351: @ UnlookAsync(Stack[-1])
0x352: Pop(1)
0x353: Push("all") // @poff=74
...
0x37a: Stack[-2] = "fire" // @poff=556
0x37b: Return(); Pop(0)

0x37c: Stack[-2] = "phys" // @poff=566
0x37d: Return(); Pop(0)

0x37e: PushEmpty(bool, bool)
0x37f: Push("HasProperty") // @poff=576
0x380: Push((int) 2)
...
0x386: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=600
0x387: Pop(0)
...
0x38c: Stack[-18] = Stack[-2]
0x38d: Stack[-1] = "health" // @poff=612
0x38e: Call 0x37e
...
0x395: Stack[-18] = Stack[-2]
0x396: Stack[-1] = "armor" // @poff=626
0x397: Call 0x37e
...
0x39d: Push("armor") // @poff=626
0x39e: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=638
0x39f: Pop(1)
0x3a0: Push("armor_") // @poff=650
0x3a1: PushEmpty(string, int)
0x3a2: Stack[-16] = Stack[-1]
0x3a3: Call 0x376

0x3a4: Pop(1)
0x3a5: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3a6: PushEmpty(bool, object, string)
0x3a7: Stack[-18] = Stack[-2]
0x3a8: Stack[-8] = Stack[-1]
0x3a9: Call 0x37e
...
0x3af: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=638
0x3b0: Pop(0)
...
0x3b7: Stack[-3] = Stack[-6]
0x3b8: Pop(3)
0x3b9: Push("health") // @poff=612
0x3ba: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=638
0x3bb: Pop(1)
0x3bc: Push((int) 1)
0x3bd: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3be: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3bf: Push("health") // @poff=612
...
0x3c5: Pop(3)
0x3c6: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=664
0x3c7: Pop(2)
0x3c8: Stack[-1] = Stack[-16]
0x3c9: Return(); Pop(12)

0x3ca: PushEmpty(bool, bool)
0x3cb: @@ IsDead(Stack[-1]); Obj=3 // @poff=676
0x3cc: Pop(0)
0x3cd: Stack[-1] = Stack[-4]
0x3ce: Return(); Pop(2)

0x3cf: PushEmpty(object, object, object, object)
0x3d0: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3e4: Pop(0)
0x3e5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3e6: IF (Stack[-1] == 0) GOTO 0x3e9; Pop(1)

0x3e7: Stack[-6] = (bool) 0
0x3e8: Return(); Pop(4)

0x3e9: @@ GetScene(Stack[-1]); Obj=5 // @poff=697
0x3ea: Pop(0)
...
0x3fd: Stack[-6] = Stack[-2]
0x3fe: Stack[-1] = "noaccess" // @poff=706
0x3ff: Call 0x37e
...
0x405: Push("noaccess") // @poff=706
0x406: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=638
0x407: Pop(1)
0x408: Push((int) 0)
...
0x431: @@ GetPosition(Stack[-5]); Obj=23 // @poff=368
0x432: Pop(0)
...
0x442: Stack[-1] = "fhit" // @poff=762
0x443: GOTO 0x445

0x444: Stack[-1] = "bhit" // @poff=772
0x445: Push("hit_react") // @poff=782
0x446: Push("1") // @poff=802
0x447: Pop(1); Push(Stack[-3] + Stack[-1]);
0x448: Push("2") // @poff=806
...
0x44f: @@ GetPosition(Stack[-3]); Obj=7 // @poff=368
0x450: Pop(0)
...
0x47f: Stack[-2] = "quest_d1_03" // @poff=810
0x480: Stack[-1] = "butcher_death" // @poff=834
0x481: Call 0x471
...
0x48c: Stack[-7] = Stack[-3]
0x48d: Stack[-6] = Stack[-2]
