...
Strings:
	...
	W:health
	W:boy_attacked
// @pool_raw:
// @pool_encoding:utf8
...
0xa0: Stack[-1] = "Neutral" // @poff=61
0xa1: Call 0x74

0xa2: Pop(1)
0xa3: Push((int) 10904)
0xa4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xa5: Pop(1)
0xa6: @@@ ClearReplies(); Obj=0 // @poff=88
0xa7: Pop(0)
0xa8: Push((int) 10905)
0xa9: Push((int) 12054)
0xaa: Push((int) 12053)
0xab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xac: Pop(3)
0xad: Return(); Pop(0)
...
0xb2: Stack[-1] = "Neutral" // @poff=61
0xb3: Call 0x74

0xb4: Pop(1)
0xb5: Push((int) 10906)
0xb6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xb7: Pop(1)
0xb8: @@@ ClearReplies(); Obj=0 // @poff=88
0xb9: Pop(0)
0xba: Push((int) 10907)
0xbb: Push((int) 12056)
0xbc: Push((int) 12055)
0xbd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xbe: Pop(3)
0xbf: Return(); Pop(0)
...
0xc4: Stack[-1] = "Neutral" // @poff=61
0xc5: Call 0x74

0xc6: Pop(1)
0xc7: Push((int) 10908)
0xc8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xc9: Pop(1)
0xca: @@@ ClearReplies(); Obj=0 // @poff=88
0xcb: Pop(0)
0xcc: Push((int) 10909)
0xcd: Push((int) 12058)
0xce: Push((int) 12057)
0xcf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xd0: Pop(3)
0xd1: Return(); Pop(0)
...
0xd6: Stack[-1] = "Neutral" // @poff=61
0xd7: Call 0x74

0xd8: Pop(1)
0xd9: Push((int) 10910)
0xda: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xdb: Pop(1)
0xdc: @@@ ClearReplies(); Obj=0 // @poff=88
0xdd: Pop(0)
0xde: Push((int) 10911)
0xdf: Push((int) 12061)
0xe0: Push((int) 12059)
0xe1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xe2: Pop(3)
0xe3: Push((int) 10912)
0xe4: Push((int) 12061)
0xe5: Push((int) 12060)
...
0xed: Stack[-1] = "Neutral" // @poff=61
0xee: Call 0x74

0xef: Pop(1)
0xf0: Push((int) 10913)
0xf1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf2: Pop(1)
0xf3: @@@ ClearReplies(); Obj=0 // @poff=88
0xf4: Pop(0)
0xf5: Push((int) 10914)
0xf6: Push((int) -1)
0xf7: Push((int) 12062)
0xf8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xf9: Pop(3)
0xfa: Return(); Pop(0)
...
0x11a: Stack[-2] = "quest_d3_03" // @poff=128
0x11b: Stack[-1] = "boy_free" // @poff=152
0x11c: Call 0x42f

0x11d: Pop(3)
0x11e: Push("noaccess") // @poff=170
0x11f: Push((int) 0)
...
0x1b7: Pop(0)
0x1b8: Push("all") // @poff=110
0x1b9: PushEmpty(string, int)
0x1ba: Stack[-7] = Stack[-1]
0x1bb: Call 0x43b
...
0x1e1: Pop(0)
0x1e2: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=188
0x1e3: Pop(0)
...
0x200: Stack[-1] = (float) 1.7453293800354004
0x201: Call 0x1df
...
0x208: Push("Can't retreat, distance: ") // @poff=200
...
0x29e: Stack[-1] = "fdie" // @poff=252
0x29f: Call 0x2f1

0x2a0: Pop(1)
0x2a1: GOTO 0x2f0

0x2a2: @@ GetPosition(Stack[-10]); Obj=21 // @poff=188
0x2a3: Pop(0)
...
0x2b3: Stack[-6] = "fdie" // @poff=252
0x2b4: GOTO 0x2b6

0x2b5: Stack[-6] = "bdie" // @poff=262
...
0x2e5: @ StopAsync()
0x2e6: Pop(0)
0x2e7: Push("head") // @poff=400
0x2e8: @ UnlookAsync(Stack[-1])
0x2e9: Pop(1)
0x2ea: Push("all") // @poff=110
...
0x314: Pop(0)
0x315: @@ GetPosition(Stack[-1]); Obj=5 // @poff=188
0x316: Pop(0)
0x317: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x318: Return(); Pop(4)

0x319: PushEmpty(bool, bool)
0x31a: Push("HasProperty") // @poff=410
0x31b: Push((int) 2)
...
0x321: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=434
0x322: Pop(0)
0x323: Stack[-1] = Stack[-5]
0x324: Return(); Pop(2)

0x325: PushEmpty(bool, bool)
0x326: @@ IsDead(Stack[-1]); Obj=3 // @poff=446
0x327: Pop(0)
0x328: Stack[-1] = Stack[-4]
0x329: Return(); Pop(2)

0x32a: PushEmpty(object, object, object, object)
0x32b: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x344: @@ GetScene(Stack[-1]); Obj=5 // @poff=467
0x345: Pop(0)
...
0x358: Stack[-6] = Stack[-2]
0x359: Stack[-1] = "noaccess" // @poff=170
0x35a: Call 0x319
...
0x360: Push("noaccess") // @poff=170
0x361: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=476
0x362: Pop(1)
0x363: Push((int) 0)
...
0x38c: @@ GetPosition(Stack[-5]); Obj=23 // @poff=188
0x38d: Pop(0)
...
0x39d: Stack[-1] = "fhit" // @poff=526
0x39e: GOTO 0x3a0

0x39f: Stack[-1] = "bhit" // @poff=536
0x3a0: Push("hit_react") // @poff=546
0x3a1: Push("1") // @poff=566
0x3a2: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3a3: Push("2") // @poff=570
...
0x3af: @@ GetPosition(Stack[-7]); Obj=17 // @poff=188
0x3b0: Pop(0)
0x3b1: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=386
0x3b2: Pop(0)
...
0x3f2: Pop(0)
0x3f3: Push("start: ") // @poff=592
0x3f4: Pop(1); Push(Stack[-1] + Stack[-3]);
0x3f5: @ Trace(Stack[-1])
0x3f6: Pop(1)
0x3f7: Push("end: ") // @poff=608
...
0x406: Push((float)9.999999974752427e-07)
...
0x416: @@ GetItemID(Stack[-3]); Obj=8 // @poff=620
0x417: Pop(0)
0x418: Push("Category") // @poff=630
0x419: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x41a: Pop(1)
0x41b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=648
0x41c: Pop(0)
0x41d: Pop(0); Push((bool) Stack[-1] == 0)
0x41e: IF (Stack[-1] == 0) GOTO 0x421; Pop(1)

0x41f: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=656
0x420: Pop(0)
0x421: Return(); Pop(6)
...
0x424: Pop(0)
0x425: @@ SetItemName(Stack[-4]); Obj=1 // @poff=666
0x426: Pop(0)
0x427: PushEmpty(object, object, int)
0x428: Stack[-8] = Stack[-3]
0x429: Stack[-4] = Stack[-2]
0x42a: Stack[-6] = Stack[-1]
0x42b: Call 0x415
...
0x431: Pop(0)
0x432: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x443: Stack[-2] = (int) 0
0x444: Push("all") // @poff=110
0x445: PushEmpty(string, int)
0x446: Stack[-5] = Stack[-1]
0x447: Call 0x43b
...
0x451: Stack[-2] = Stack[-5]
0x452: Return(); Pop(4)

0x453: PushEmpty()
0x454: Push("playsound") // @poff=678
0x455: Push("giveitem") // @poff=698
0x456: @ TriggerWorld(Stack[-2], Stack[-1])
0x457: Pop(2)
0x458: Return(); Pop(0)

0x459: PushEmpty(float, float)
0x45a: Push("d3q03") // @poff=716
0x45b: Push((int) 2)
...
0x460: Pop(0)
0x461: Push("disease") // @poff=728
0x462: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=476
0x463: Pop(1)
0x464: Push((float)0.5)
0x465: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x466: IF (Stack[-1] == 0) GOTO 0x46b; Pop(1)

0x467: Push("disease") // @poff=728
0x468: Push((float)0.5)
0x469: @@ SetProperty(Stack[-2], Stack[-1]); Obj=6 // @poff=744
0x46a: Pop(2)
0x46b: Return(); Pop(2)

0x46c: PushEmpty()
0x46d: Push("powder is given") // @poff=756
0x46e: @ Trace(Stack[-1])
0x46f: Pop(1)
0x470: PushEmpty(object, string, int)
0x471: Stack[-5] = Stack[-3]
0x472: Stack[-2] = "powder" // @poff=788
0x473: Stack[-1] = (int) 1
0x474: Call 0x422
...
0x47c: Push("Can't retrieve diary root") // @poff=802
0x47d: @ Trace(Stack[-1])
0x47e: Pop(1)
...
0x488: Pop(1)
0x489: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=854
0x48a: Pop(0)
0x48b: Pop(0); Push((bool) Stack[-2] == 0)
0x48c: IF (Stack[-1] == 0) GOTO 0x493; Pop(1)

0x48d: Push("Can't find diary parent with id: ") // @poff=859
...
0x493: @@ AddChild(Stack[-8]); Obj=2 // @poff=927
0x494: Pop(0)
0x495: Push("player_diary") // @poff=936
0x496: Push((int) 1)
0x497: @ SetVariable(Stack[-2], Stack[-1])
0x498: Pop(2)
0x499: @@ GetCategory(Stack[-1]); Obj=8 // @poff=962
0x49a: Pop(0)
...
0x4b3: Push("Adding diary entry") // @poff=988
0x4b4: @ Trace(Stack[-1])
0x4b5: Pop(1)
0x4b6: Push((int) 84)
0x4b7: Push((int) 2)
...
0x4c4: Stack[-1] = "ui/NPC_None.png" // @poff=1026
0x4c5: Return(); Pop(0)
...
0x4d2: Stack[-7] = Stack[-3]
0x4d3: Stack[-6] = Stack[-2]
...
0x500: Stack[-2] = "quest_d3_03" // @poff=128
0x501: Stack[-1] = "boy_attacked" // @poff=1072
0x502: Call 0x42f
