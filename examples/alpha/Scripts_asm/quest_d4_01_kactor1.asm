...
Strings:
	...
	W:player
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x27f: Push("all") // @poff=44
0x280: Push("idle") // @poff=162
...
0x288: Push("all") // @poff=44
0x289: Push("idle") // @poff=162
...
0x2e1: Stack[-1] = "Neutral" // @poff=113
0x2e2: Call 0x28e

0x2e3: Pop(1)
0x2e4: Push((int) 9667)
0x2e5: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x2e6: Pop(1)
0x2e7: @@@ ClearReplies(); Obj=0 // @poff=140
0x2e8: Pop(0)
0x2e9: Push((int) 9668)
0x2ea: Push((int) 10643)
0x2eb: Push((int) 10642)
0x2ec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x2ed: Pop(3)
0x2ee: Push((int) 9677)
0x2ef: Push((int) 10653)
0x2f0: Push((int) 10652)
0x2f1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x2f2: Pop(3)
0x2f3: Return(); Pop(0)

0x2f4: PushEmpty(string)
0x2f5: Stack[-1] = "Neutral" // @poff=113
0x2f6: Call 0x28e

0x2f7: Pop(1)
0x2f8: Push((int) 9681)
0x2f9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x2fa: Pop(1)
0x2fb: @@@ ClearReplies(); Obj=0 // @poff=140
0x2fc: Pop(0)
0x2fd: Push((int) 9682)
0x2fe: Push((int) 10660)
0x2ff: Push((int) 10659)
0x300: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x301: Pop(3)
0x302: Push((int) 9699)
0x303: Push((int) -1)
0x304: Push((int) 10678)
0x305: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x306: Pop(3)
0x307: Return(); Pop(0)
...
0x30c: Stack[-1] = "Neutral" // @poff=113
0x30d: Call 0x28e

0x30e: Pop(1)
0x30f: Push((int) 9683)
0x310: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x311: Pop(1)
0x312: @@@ ClearReplies(); Obj=0 // @poff=140
0x313: Pop(0)
0x314: Push((int) 9684)
0x315: Push((int) 10662)
0x316: Push((int) 10661)
0x317: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x318: Pop(3)
0x319: Push((int) 9694)
0x31a: Push((int) 10672)
0x31b: Push((int) 10671)
0x31c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x31d: Pop(3)
0x31e: Push((int) 9698)
0x31f: Push((int) 10662)
0x320: Push((int) 10676)
0x321: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x322: Pop(3)
0x323: Return(); Pop(0)
...
0x328: Stack[-1] = "Neutral" // @poff=113
0x329: Call 0x28e

0x32a: Pop(1)
0x32b: Push((int) 9695)
0x32c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x32d: Pop(1)
0x32e: @@@ ClearReplies(); Obj=0 // @poff=140
0x32f: Pop(0)
0x330: Push((int) 9696)
0x331: Push((int) 10665)
0x332: Push((int) 10673)
0x333: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x334: Pop(3)
0x335: Push((int) 9697)
0x336: Push((int) -1)
0x337: Push((int) 10675)
0x338: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x339: Pop(3)
0x33a: Return(); Pop(0)
...
0x33f: Stack[-1] = "Neutral" // @poff=113
0x340: Call 0x28e

0x341: Pop(1)
0x342: Push((int) 9685)
0x343: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x344: Pop(1)
0x345: @@@ ClearReplies(); Obj=0 // @poff=140
0x346: Pop(0)
0x347: Push((int) 9686)
0x348: Push((int) -1)
0x349: Push((int) 10663)
0x34a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x34b: Pop(3)
0x34c: Push((int) 9687)
0x34d: Push((int) 10665)
0x34e: Push((int) 10664)
0x34f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x350: Pop(3)
0x351: Return(); Pop(0)
...
0x356: Stack[-1] = "Neutral" // @poff=113
0x357: Call 0x28e

0x358: Pop(1)
0x359: Push((int) 9688)
0x35a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x35b: Pop(1)
0x35c: @@@ ClearReplies(); Obj=0 // @poff=140
0x35d: Pop(0)
0x35e: Push((int) 9689)
0x35f: Push((int) -1)
0x360: Push((int) 10666)
0x361: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x362: Pop(3)
0x363: Push((int) 9690)
0x364: Push((int) 10668)
0x365: Push((int) 10667)
0x366: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x367: Pop(3)
0x368: Return(); Pop(0)
...
0x36d: Stack[-1] = "Neutral" // @poff=113
0x36e: Call 0x28e

0x36f: Pop(1)
0x370: Push((int) 9691)
0x371: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x372: Pop(1)
0x373: @@@ ClearReplies(); Obj=0 // @poff=140
0x374: Pop(0)
0x375: Push((int) 9692)
0x376: Push((int) -1)
0x377: Push((int) 10669)
0x378: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x379: Pop(3)
0x37a: Push((int) 9693)
0x37b: Push((int) -1)
0x37c: Push((int) 10670)
0x37d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x37e: Pop(3)
0x37f: Return(); Pop(0)
...
0x384: Stack[-1] = "Neutral" // @poff=113
0x385: Call 0x28e

0x386: Pop(1)
0x387: Push((int) 9678)
0x388: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x389: Pop(1)
0x38a: @@@ ClearReplies(); Obj=0 // @poff=140
0x38b: Pop(0)
0x38c: Push((int) 9679)
0x38d: Push((int) 10643)
0x38e: Push((int) 10654)
0x38f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x390: Pop(3)
0x391: Push((int) 9680)
0x392: Push((int) 10643)
0x393: Push((int) 10656)
0x394: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x395: Pop(3)
0x396: Return(); Pop(0)
...
0x39b: Stack[-1] = "Neutral" // @poff=113
0x39c: Call 0x28e

0x39d: Pop(1)
0x39e: Push((int) 9669)
0x39f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3a0: Pop(1)
0x3a1: @@@ ClearReplies(); Obj=0 // @poff=140
0x3a2: Pop(0)
0x3a3: Push((int) 9670)
0x3a4: Push((int) 10645)
0x3a5: Push((int) 10644)
0x3a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3a7: Pop(3)
0x3a8: Return(); Pop(0)
...
0x3ad: Stack[-1] = "Neutral" // @poff=113
0x3ae: Call 0x28e

0x3af: Pop(1)
0x3b0: Push((int) 9671)
0x3b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3b2: Pop(1)
0x3b3: @@@ ClearReplies(); Obj=0 // @poff=140
0x3b4: Pop(0)
0x3b5: Push((int) 9672)
0x3b6: Push((int) 10647)
0x3b7: Push((int) 10646)
0x3b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3b9: Pop(3)
0x3ba: Push((int) 9676)
0x3bb: Push((int) 10647)
0x3bc: Push((int) 10650)
0x3bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3be: Pop(3)
0x3bf: Return(); Pop(0)
...
0x3c4: Stack[-1] = "Neutral" // @poff=113
0x3c5: Call 0x28e

0x3c6: Pop(1)
0x3c7: Push((int) 9673)
0x3c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3c9: Pop(1)
0x3ca: @@@ ClearReplies(); Obj=0 // @poff=140
0x3cb: Pop(0)
0x3cc: Push((int) 9674)
0x3cd: Push((int) -1)
0x3ce: Push((int) 10648)
0x3cf: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3d0: Pop(3)
0x3d1: Push((int) 9675)
0x3d2: Push((int) -1)
0x3d3: Push((int) 10649)
0x3d4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3d5: Pop(3)
0x3d6: Return(); Pop(0)
...
0x408: Stack[-2] = "quest_d4_01" // @poff=172
0x409: Stack[-1] = "key1_done" // @poff=196
0x40a: Call 0x56d

0x40b: Pop(3)
0x40c: PushEmpty(object)
0x40d: Stack[-4] = Stack[-1]
...
0x423: Stack[-2] = "quest_d4_01" // @poff=172
0x424: Stack[-1] = "key1_done" // @poff=196
0x425: Call 0x56d
...
0x497: Pop(0)
0x498: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=216
0x499: Pop(1)
...
0x49e: Push("HasProperty") // @poff=230
0x49f: Push((int) 2)
...
0x4a5: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=254
0x4a6: Pop(0)
0x4a7: Stack[-1] = Stack[-5]
0x4a8: Return(); Pop(2)

0x4a9: PushEmpty(bool, bool)
0x4aa: @@ IsDead(Stack[-1]); Obj=3 // @poff=266
0x4ab: Pop(0)
0x4ac: Stack[-1] = Stack[-4]
0x4ad: Return(); Pop(2)

0x4ae: PushEmpty(object, object, object, object)
0x4af: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4c3: Pop(0)
0x4c4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4c5: IF (Stack[-1] == 0) GOTO 0x4c8; Pop(1)

0x4c6: Stack[-6] = (bool) 0
0x4c7: Return(); Pop(4)

0x4c8: @@ GetScene(Stack[-1]); Obj=5 // @poff=287
0x4c9: Pop(0)
...
0x4dc: Stack[-6] = Stack[-2]
0x4dd: Stack[-1] = "noaccess" // @poff=296
0x4de: Call 0x49d
...
0x4e4: Push("noaccess") // @poff=296
0x4e5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=314
0x4e6: Pop(1)
0x4e7: Push((int) 0)
...
0x4f0: @@ GetPosition(Stack[-7]); Obj=17 // @poff=0
0x4f1: Pop(0)
0x4f2: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=326
0x4f3: Pop(0)
...
0x533: Pop(0)
0x534: Push("start: ") // @poff=358
0x535: Pop(1); Push(Stack[-1] + Stack[-3]);
0x536: @ Trace(Stack[-1])
0x537: Pop(1)
0x538: Push("end: ") // @poff=374
...
0x550: Pop(0)
0x551: Stack[-1] = Stack[-4]
0x552: Return(); Pop(2)

0x553: PushEmpty(int, int, bool, int, int, bool)
0x554: @@ GetItemID(Stack[-3]); Obj=8 // @poff=386
0x555: Pop(0)
0x556: Push("Category") // @poff=396
0x557: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x558: Pop(1)
0x559: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=414
0x55a: Pop(0)
0x55b: Pop(0); Push((bool) Stack[-1] == 0)
0x55c: IF (Stack[-1] == 0) GOTO 0x55f; Pop(1)

0x55d: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=422
0x55e: Pop(0)
0x55f: Return(); Pop(6)
...
0x562: Pop(0)
0x563: @@ SetItemName(Stack[-4]); Obj=1 // @poff=432
0x564: Pop(0)
0x565: PushEmpty(object, object, int)
0x566: Stack[-8] = Stack[-3]
0x567: Stack[-4] = Stack[-2]
0x568: Stack[-6] = Stack[-1]
0x569: Call 0x553
...
0x56f: Pop(0)
0x570: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x593: PushEmpty()
0x594: Push("playsound") // @poff=444
0x595: Push("giveitem") // @poff=464
0x596: @ TriggerWorld(Stack[-2], Stack[-1])
0x597: Pop(2)
0x598: Return(); Pop(0)

0x599: PushEmpty()
0x59a: Push("ood4WhiteMask1") // @poff=482
0x59b: Push((int) 1)
...
0x59f: PushEmpty()
0x5a0: Push("theaterkey is given") // @poff=512
0x5a1: @ Trace(Stack[-1])
0x5a2: Pop(1)
0x5a3: PushEmpty(object, string, int)
0x5a4: Stack[-5] = Stack[-3]
0x5a5: Stack[-2] = "d4q01_theater_key" // @poff=552
0x5a6: Stack[-1] = (int) 1
0x5a7: Call 0x560
...
0x5aa: PushEmpty()
0x5ab: Push("tvirin is given") // @poff=588
0x5ac: @ Trace(Stack[-1])
0x5ad: Pop(1)
0x5ae: PushEmpty(object, string, int)
0x5af: Stack[-5] = Stack[-3]
0x5b0: Stack[-2] = "tvirin" // @poff=620
0x5b1: Stack[-1] = (int) 1
0x5b2: Call 0x560
...
0x5b5: PushEmpty()
0x5b6: Push((int) 0)
0x5b7: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=634
0x5b8: Pop(1)
0x5b9: Return(); Pop(0)

0x5ba: PushEmpty()
0x5bb: Push((int) 1)
0x5bc: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=634
0x5bd: Pop(1)
0x5be: Return(); Pop(0)

0x5bf: PushEmpty()
0x5c0: PushEmpty(int, string)
0x5c1: Stack[-1] = "ood4WhiteMask1" // @poff=482
0x5c2: Call 0x54e
...
0x5de: Stack[-1] = "ui/NPC_Black.png" // @poff=663
0x5df: Return(); Pop(0)
