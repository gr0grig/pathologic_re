...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0x1d9: Pop(0)
0x1da: Push("all") // @poff=44
0x1db: PushEmpty(string, int)
0x1dc: Stack[-7] = Stack[-1]
0x1dd: Call 0x582
...
0x20a: Pop(0)
0x20b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=52
0x20c: Pop(1)
0x20d: PushEmpty(string)
0x20e: Call 0x5f4

0x20f: Pop(0)
0x210: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=63
0x211: Pop(1)
0x212: PushEmpty(int)
0x213: Call 0x5e1

0x214: Pop(0)
0x215: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=72
0x216: Pop(1)
0x217: Stack[-2] = (int) -1
...
0x221: Stack[-11] = Stack[-2]
0x222: Stack[-6] = Stack[-1]
0x223: Push(-2, 4); TaskCall(5)
0x224: Call 0x23b

0x225: Pop(-2, 4); TaskReturn
0x226: Pop(2)
0x227: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=86
0x228: Pop(0)
...
0x22b: @ sync()
0x22c: Pop(0)
0x22d: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=86
0x22e: Pop(0)
0x22f: GOTO 0x229

0x230: PushEmpty(object)
0x231: Stack[-10] = Stack[-1]
0x232: Call 0x530

0x233: Pop(1)
0x234: @ StopDialog(Stack[-4])
0x235: Pop(0)
0x236: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=98
0x237: Pop(0)
0x238: Stack[-2] = Stack[-10]
0x239: Return(); Pop(8)
...
0x247: Stack[-1] = "Neutral" // @poff=113
0x248: Call 0x2b1

0x249: Pop(1)
0x24a: Push((int) 9701)
0x24b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x24c: Pop(1)
0x24d: @@@ ClearReplies(); Obj=0 // @poff=140
0x24e: Pop(0)
0x24f: Push((int) 9702)
0x250: Push((int) 10682)
0x251: Push((int) 10681)
0x252: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x253: Pop(3)
0x254: Push((int) 9711)
0x255: Push((int) 10682)
0x256: Push((int) 10691)
0x257: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x258: Pop(3)
0x259: GOTO 0x293

0x25a: PushEmpty(string)
0x25b: Stack[-1] = "Neutral" // @poff=113
0x25c: Call 0x2b1

0x25d: Pop(1)
0x25e: Push((int) 9712)
0x25f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x260: Pop(1)
0x261: @@@ ClearReplies(); Obj=0 // @poff=140
0x262: Pop(0)
0x263: Push((int) 9713)
0x264: Push((int) 10695)
0x265: Push((int) 10694)
0x266: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x267: Pop(3)
0x268: Push((int) 9720)
0x269: Push((int) 10702)
0x26a: Push((int) 10701)
0x26b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x26c: Pop(3)
0x26d: Push((int) 9723)
0x26e: Push((int) 10695)
0x26f: Push((int) 10705)
0x270: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x271: Pop(3)
0x272: Push((int) 9724)
0x273: Push((int) -1)
0x274: Push((int) 10707)
0x275: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x276: Pop(3)
0x277: GOTO 0x293
...
0x27e: Stack[-1] = "Neutral" // @poff=113
0x27f: Call 0x2b1

0x280: Pop(1)
0x281: Push((int) 11013)
0x282: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x283: Pop(1)
0x284: @@@ ClearReplies(); Obj=0 // @poff=140
0x285: Pop(0)
0x286: Push((int) 11014)
0x287: Push((int) 12186)
0x288: Push((int) 12185)
0x289: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x28a: Pop(3)
0x28b: Push((int) 11017)
0x28c: Push((int) -1)
0x28d: Push((int) 12188)
0x28e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x28f: Pop(3)
0x290: GOTO 0x293
...
0x2a2: Push("all") // @poff=44
0x2a3: Push("idle") // @poff=162
...
0x2ab: Push("all") // @poff=44
0x2ac: Push("idle") // @poff=162
...
0x304: Stack[-1] = "Neutral" // @poff=113
0x305: Call 0x2b1

0x306: Pop(1)
0x307: Push((int) 9701)
0x308: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x309: Pop(1)
0x30a: @@@ ClearReplies(); Obj=0 // @poff=140
0x30b: Pop(0)
0x30c: Push((int) 9702)
0x30d: Push((int) 10682)
0x30e: Push((int) 10681)
0x30f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x310: Pop(3)
0x311: Push((int) 9711)
0x312: Push((int) 10682)
0x313: Push((int) 10691)
0x314: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x315: Pop(3)
0x316: Return(); Pop(0)

0x317: PushEmpty(string)
0x318: Stack[-1] = "Neutral" // @poff=113
0x319: Call 0x2b1

0x31a: Pop(1)
0x31b: Push((int) 9712)
0x31c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x31d: Pop(1)
0x31e: @@@ ClearReplies(); Obj=0 // @poff=140
0x31f: Pop(0)
0x320: Push((int) 9713)
0x321: Push((int) 10695)
0x322: Push((int) 10694)
0x323: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x324: Pop(3)
0x325: Push((int) 9720)
0x326: Push((int) 10702)
0x327: Push((int) 10701)
0x328: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x329: Pop(3)
0x32a: Push((int) 9723)
0x32b: Push((int) 10695)
0x32c: Push((int) 10705)
0x32d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x32e: Pop(3)
0x32f: Push((int) 9724)
0x330: Push((int) -1)
0x331: Push((int) 10707)
0x332: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x333: Pop(3)
0x334: Return(); Pop(0)
...
0x33b: Stack[-1] = "Neutral" // @poff=113
0x33c: Call 0x2b1

0x33d: Pop(1)
0x33e: Push((int) 11013)
0x33f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x340: Pop(1)
0x341: @@@ ClearReplies(); Obj=0 // @poff=140
0x342: Pop(0)
0x343: Push((int) 11014)
0x344: Push((int) 12186)
0x345: Push((int) 12185)
0x346: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x347: Pop(3)
0x348: Push((int) 11017)
0x349: Push((int) -1)
0x34a: Push((int) 12188)
0x34b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x34c: Pop(3)
0x34d: Return(); Pop(0)
...
0x352: Stack[-1] = "Neutral" // @poff=113
0x353: Call 0x2b1

0x354: Pop(1)
0x355: Push((int) 11015)
0x356: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x357: Pop(1)
0x358: @@@ ClearReplies(); Obj=0 // @poff=140
0x359: Pop(0)
0x35a: Push((int) 11016)
0x35b: Push((int) -1)
0x35c: Push((int) 12187)
0x35d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x35e: Pop(3)
0x35f: Return(); Pop(0)
...
0x364: Stack[-1] = "Neutral" // @poff=113
0x365: Call 0x2b1

0x366: Pop(1)
0x367: Push((int) 9721)
0x368: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x369: Pop(1)
0x36a: @@@ ClearReplies(); Obj=0 // @poff=140
0x36b: Pop(0)
0x36c: Push((int) 9722)
0x36d: Push((int) 10697)
0x36e: Push((int) 10703)
0x36f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x370: Pop(3)
0x371: Return(); Pop(0)
...
0x376: Stack[-1] = "Neutral" // @poff=113
0x377: Call 0x2b1

0x378: Pop(1)
0x379: Push((int) 9714)
0x37a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x37b: Pop(1)
0x37c: @@@ ClearReplies(); Obj=0 // @poff=140
0x37d: Pop(0)
0x37e: Push((int) 9715)
0x37f: Push((int) 10697)
0x380: Push((int) 10696)
0x381: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x382: Pop(3)
0x383: Push((int) 9719)
0x384: Push((int) -1)
0x385: Push((int) 10700)
0x386: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x387: Pop(3)
0x388: Return(); Pop(0)
...
0x38d: Stack[-1] = "Neutral" // @poff=113
0x38e: Call 0x2b1

0x38f: Pop(1)
0x390: Push((int) 9716)
0x391: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x392: Pop(1)
0x393: @@@ ClearReplies(); Obj=0 // @poff=140
0x394: Pop(0)
0x395: Push((int) 9717)
0x396: Push((int) -1)
0x397: Push((int) 10698)
0x398: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x399: Pop(3)
0x39a: Push((int) 9718)
0x39b: Push((int) -1)
0x39c: Push((int) 10699)
0x39d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x39e: Pop(3)
0x39f: Return(); Pop(0)
...
0x3a4: Stack[-1] = "Neutral" // @poff=113
0x3a5: Call 0x2b1

0x3a6: Pop(1)
0x3a7: Push((int) 9703)
0x3a8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3a9: Pop(1)
0x3aa: @@@ ClearReplies(); Obj=0 // @poff=140
0x3ab: Pop(0)
0x3ac: Push((int) 9704)
0x3ad: Push((int) 10684)
0x3ae: Push((int) 10683)
0x3af: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3b0: Pop(3)
0x3b1: Push((int) 9710)
0x3b2: Push((int) 10684)
0x3b3: Push((int) 10689)
0x3b4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3b5: Pop(3)
0x3b6: Return(); Pop(0)
...
0x3bb: Stack[-1] = "Neutral" // @poff=113
0x3bc: Call 0x2b1

0x3bd: Pop(1)
0x3be: Push((int) 9705)
0x3bf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3c0: Pop(1)
0x3c1: @@@ ClearReplies(); Obj=0 // @poff=140
0x3c2: Pop(0)
0x3c3: Push((int) 9706)
0x3c4: Push((int) 10686)
0x3c5: Push((int) 10685)
0x3c6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3c7: Pop(3)
0x3c8: Return(); Pop(0)
...
0x3cd: Stack[-1] = "Neutral" // @poff=113
0x3ce: Call 0x2b1

0x3cf: Pop(1)
0x3d0: Push((int) 9707)
0x3d1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=129
0x3d2: Pop(1)
0x3d3: @@@ ClearReplies(); Obj=0 // @poff=140
0x3d4: Pop(0)
0x3d5: Push((int) 9708)
0x3d6: Push((int) -1)
0x3d7: Push((int) 10687)
0x3d8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3d9: Pop(3)
0x3da: Push((int) 9709)
0x3db: Push((int) -1)
0x3dc: Push((int) 10688)
0x3dd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=153
0x3de: Pop(3)
0x3df: Return(); Pop(0)
...
0x411: Stack[-2] = "quest_d4_01" // @poff=172
0x412: Stack[-1] = "key2_done" // @poff=196
0x413: Call 0x576
...
0x42c: Stack[-2] = "quest_d4_01" // @poff=172
0x42d: Stack[-1] = "key2_done" // @poff=196
0x42e: Call 0x576
...
0x4a0: Pop(0)
0x4a1: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=216
0x4a2: Pop(1)
...
0x4a7: Push("HasProperty") // @poff=230
0x4a8: Push((int) 2)
...
0x4ae: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=254
0x4af: Pop(0)
0x4b0: Stack[-1] = Stack[-5]
0x4b1: Return(); Pop(2)

0x4b2: PushEmpty(bool, bool)
0x4b3: @@ IsDead(Stack[-1]); Obj=3 // @poff=266
0x4b4: Pop(0)
0x4b5: Stack[-1] = Stack[-4]
0x4b6: Return(); Pop(2)

0x4b7: PushEmpty(object, object, object, object)
0x4b8: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x4cc: Pop(0)
0x4cd: Pop(0); PushNull((bool) Stack[-2] == 0)
0x4ce: IF (Stack[-1] == 0) GOTO 0x4d1; Pop(1)

0x4cf: Stack[-6] = (bool) 0
0x4d0: Return(); Pop(4)

0x4d1: @@ GetScene(Stack[-1]); Obj=5 // @poff=287
0x4d2: Pop(0)
...
0x4e5: Stack[-6] = Stack[-2]
0x4e6: Stack[-1] = "noaccess" // @poff=296
0x4e7: Call 0x4a6
...
0x4ed: Push("noaccess") // @poff=296
0x4ee: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=314
0x4ef: Pop(1)
0x4f0: Push((int) 0)
...
0x4f9: @@ GetPosition(Stack[-7]); Obj=17 // @poff=0
0x4fa: Pop(0)
0x4fb: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=326
0x4fc: Pop(0)
...
0x53c: Pop(0)
0x53d: Push("start: ") // @poff=358
0x53e: Pop(1); Push(Stack[-1] + Stack[-3]);
0x53f: @ Trace(Stack[-1])
0x540: Pop(1)
0x541: Push("end: ") // @poff=374
...
0x550: Push((float)9.999999974752427e-07)
...
0x559: Pop(0)
0x55a: Stack[-1] = Stack[-4]
0x55b: Return(); Pop(2)

0x55c: PushEmpty(int, int, bool, int, int, bool)
0x55d: @@ GetItemID(Stack[-3]); Obj=8 // @poff=386
0x55e: Pop(0)
0x55f: Push("Category") // @poff=396
0x560: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x561: Pop(1)
0x562: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=414
0x563: Pop(0)
0x564: Pop(0); Push((bool) Stack[-1] == 0)
0x565: IF (Stack[-1] == 0) GOTO 0x568; Pop(1)

0x566: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=422
0x567: Pop(0)
0x568: Return(); Pop(6)
...
0x56b: Pop(0)
0x56c: @@ SetItemName(Stack[-4]); Obj=1 // @poff=432
0x56d: Pop(0)
0x56e: PushEmpty(object, object, int)
0x56f: Stack[-8] = Stack[-3]
0x570: Stack[-4] = Stack[-2]
0x571: Stack[-6] = Stack[-1]
0x572: Call 0x55c
...
0x578: Pop(0)
0x579: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x59c: PushEmpty()
0x59d: Push("playsound") // @poff=444
0x59e: Push("giveitem") // @poff=464
0x59f: @ TriggerWorld(Stack[-2], Stack[-1])
0x5a0: Pop(2)
0x5a1: Return(); Pop(0)

0x5a2: PushEmpty()
0x5a3: Push("soborkey is given") // @poff=482
0x5a4: @ Trace(Stack[-1])
0x5a5: Pop(1)
0x5a6: PushEmpty(object, string, int)
0x5a7: Stack[-5] = Stack[-3]
0x5a8: Stack[-2] = "d4q01_sobor_key" // @poff=518
0x5a9: Stack[-1] = (int) 1
0x5aa: Call 0x569
...
0x5ad: PushEmpty()
0x5ae: Push("ood4WastedMale1") // @poff=550
0x5af: Push((int) 1)
...
0x5b3: PushEmpty()
0x5b4: Push("tvirin is given") // @poff=582
0x5b5: @ Trace(Stack[-1])
0x5b6: Pop(1)
0x5b7: PushEmpty(object, string, int)
0x5b8: Stack[-5] = Stack[-3]
0x5b9: Stack[-2] = "tvirin" // @poff=614
0x5ba: Stack[-1] = (int) 1
0x5bb: Call 0x569
...
0x5be: PushEmpty()
0x5bf: Push((int) 0)
0x5c0: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=628
0x5c1: Pop(1)
0x5c2: Return(); Pop(0)

0x5c3: PushEmpty()
0x5c4: Push((int) 1)
0x5c5: @@ SetReturnValue(Stack[-1]); Obj=2 // @poff=628
0x5c6: Pop(1)
0x5c7: Return(); Pop(0)
...
0x5d4: Stack[-1] = "ood4WastedMale1" // @poff=550
0x5d5: Call 0x557
...
0x5f4: Stack[-1] = "ui/NPC_None.png" // @poff=657
0x5f5: Return(); Pop(0)
