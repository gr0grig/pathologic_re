...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0xba: Stack[-1] = "Neutral" // @poff=61
0xbb: Call 0x79

0xbc: Pop(1)
0xbd: Push((int) 9726)
0xbe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xbf: Pop(1)
0xc0: @@@ ClearReplies(); Obj=0 // @poff=88
0xc1: Pop(0)
0xc2: Push((int) 9727)
0xc3: Push((int) 10711)
0xc4: Push((int) 10710)
0xc5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xc6: Pop(3)
0xc7: Push((int) 9742)
0xc8: Push((int) 10728)
0xc9: Push((int) 10727)
...
0xe3: Stack[-1] = "Neutral" // @poff=61
0xe4: Call 0x79

0xe5: Pop(1)
0xe6: Push((int) 9728)
0xe7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe8: Pop(1)
0xe9: @@@ ClearReplies(); Obj=0 // @poff=88
0xea: Pop(0)
0xeb: Push((int) 9729)
0xec: Push((int) 10713)
0xed: Push((int) 10712)
0xee: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xef: Pop(3)
0xf0: Push((int) 9736)
0xf1: Push((int) 10720)
0xf2: Push((int) 10719)
0xf3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xf4: Pop(3)
0xf5: Return(); Pop(0)
...
0xfa: Stack[-1] = "Neutral" // @poff=61
0xfb: Call 0x79

0xfc: Pop(1)
0xfd: Push((int) 9737)
0xfe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xff: Pop(1)
0x100: @@@ ClearReplies(); Obj=0 // @poff=88
0x101: Pop(0)
0x102: Push((int) 9738)
...
0x171: Stack[-2] = "quest_d4_01" // @poff=128
0x172: Stack[-1] = "wastedwoman_done" // @poff=152
0x173: Call 0x224
...
0x1c6: @@ GetPosition(Stack[-7]); Obj=17 // @poff=186
0x1c7: Pop(0)
0x1c8: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=198
0x1c9: Pop(0)
...
0x209: Pop(0)
0x20a: Push("start: ") // @poff=230
0x20b: Pop(1); Push(Stack[-1] + Stack[-3]);
0x20c: @ Trace(Stack[-1])
0x20d: Pop(1)
0x20e: Push("end: ") // @poff=246
...
0x21d: Push((float)9.999999974752427e-07)
...
0x226: Pop(0)
0x227: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x23d: Stack[-2] = (int) 0
0x23e: Push("all") // @poff=110
0x23f: PushEmpty(string, int)
0x240: Stack[-5] = Stack[-1]
0x241: Call 0x235
...
0x250: Stack[-1] = Stack[-2]
0x251: Pop(1)
0x252: Push("d4q01WastedMale") // @poff=258
0x253: Push("pt_d4q01_key2") // @poff=290
0x254: Push((int) 1)
...
0x258: Pop(0)
0x259: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=318
0x25a: Pop(5)
0x25b: Return(); Pop(2)
...
0x261: Stack[-1] = Stack[-4]
0x262: Pop(1)
0x263: Stack[-2] = "pt_d4q01_wastedmale" // @poff=326
0x264: Stack[-1] = (int) 2
0x265: Call 0x27e
...
0x269: Pop(0)
0x26a: @@ ShowMap(Stack[-1]); Obj=2 // @poff=366
0x26b: Pop(1)
0x26c: Return(); Pop(0)
...
0x26f: Pop(0)
0x270: Pop(0); PushNull((bool) Stack[-2] == 0)
0x271: IF (Stack[-1] == 0) GOTO 0x278; Pop(1)

0x272: Push("Can't find main outdoor scene") // @poff=374
0x273: @ Trace(Stack[-1])
0x274: Pop(1)
0x275: Stack[-1] = 0
0x276: Stack[-1] = Stack[-5]
0x277: Return(); Pop(4)

0x278: @@ GetMap(Stack[-1]); Obj=2 // @poff=434
0x279: Pop(0)
...
0x280: Pop(0)
0x281: Pop(0); PushNull((bool) Stack[-2] == 0)
0x282: IF (Stack[-1] == 0) GOTO 0x287; Pop(1)

0x283: Push("Can't find main outdoor scene") // @poff=374
0x284: @ Trace(Stack[-1])
0x285: Pop(1)
0x286: Return(); Pop(8)

0x287: @@ GetLocator(Stack[-10], Stack[-1], Stack[-4], Stack[-3]); Obj=2 // @poff=441
0x288: Pop(0)
0x289: Pop(0); Push((bool) Stack[-1] == 0)
0x28a: IF (Stack[-1] == 0) GOTO 0x291; Pop(1)

0x28b: Push("Warning: outdoor scene locator ") // @poff=452
0x28c: Pop(1); Push(Stack[-1] + Stack[-11]);
0x28d: Push(" doesnt exist") // @poff=516
0x28e: Pop(2); Push(Stack[-2] + Stack[-1]);
0x28f: @ Trace(Stack[-1])
0x290: Pop(1)
0x291: @@ GetMap(Stack[-11]); Obj=2 // @poff=434
0x292: Pop(0)
0x293: Pop(0); PushNull((bool) Stack[-11] == 0)
0x294: IF (Stack[-1] == 0) GOTO 0x299; Pop(1)

0x295: Push("Can't find map") // @poff=544
0x296: @ Trace(Stack[-1])
0x297: Pop(1)
0x298: Return(); Pop(8)
...
0x29b: @@ SetMapParams(Stack[-2], Stack[-1], Stack[-11]); Obj=13 // @poff=574
0x29c: Pop(2)
0x29d: Return(); Pop(8)

0x29e: Stack[-2] = 0
0x29f: PushEmpty(int, int)
0x2a0: Push("player") // @poff=587
...
0x2b2: Stack[-1] = "ui/NPC_None.png" // @poff=601
0x2b3: Return(); Pop(0)
