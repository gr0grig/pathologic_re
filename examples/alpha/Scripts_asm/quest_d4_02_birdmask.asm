...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x60: Stack[-1] = "Neutral" // @poff=61
0x61: Call 0xab

0x62: Pop(1)
0x63: Push((int) 11847)
0x64: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x65: Pop(1)
0x66: @@@ ClearReplies(); Obj=0 // @poff=88
0x67: Pop(0)
0x68: Push((int) 11848)
0x69: Push((int) -1)
0x6a: Push((int) 13061)
0x6b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6c: Pop(3)
0x6d: GOTO 0x8d
...
0xee: Stack[-1] = "Neutral" // @poff=61
0xef: Call 0xab

0xf0: Pop(1)
0xf1: Push((int) 11843)
0xf2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf3: Pop(1)
0xf4: @@@ ClearReplies(); Obj=0 // @poff=88
0xf5: Pop(0)
0xf6: Push((int) 11844)
0xf7: Push((int) 13058)
0xf8: Push((int) 13057)
...
0x103: Stack[-1] = "Neutral" // @poff=61
0x104: Call 0xab

0x105: Pop(1)
0x106: Push((int) 11847)
0x107: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x108: Pop(1)
0x109: @@@ ClearReplies(); Obj=0 // @poff=88
0x10a: Pop(0)
...
0x144: Stack[-1] = "Neutral" // @poff=61
0x145: Call 0xab

0x146: Pop(1)
0x147: Push((int) 11845)
0x148: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x149: Pop(1)
0x14a: @@@ ClearReplies(); Obj=0 // @poff=88
0x14b: Pop(0)
0x14c: Push((int) 11846)
0x14d: Push((int) -1)
0x14e: Push((int) 13059)
0x14f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x150: Pop(3)
0x151: Return(); Pop(0)
...
0x194: Pop(0)
0x195: Push("all") // @poff=110
0x196: PushEmpty(string, int)
0x197: Stack[-7] = Stack[-1]
0x198: Call 0x24b
...
0x1c2: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x1c3: Pop(0)
0x1c4: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x1c5: Pop(0)
...
0x205: Pop(0)
0x206: Push("start: ") // @poff=172
0x207: Pop(1); Push(Stack[-1] + Stack[-3]);
0x208: @ Trace(Stack[-1])
0x209: Pop(1)
0x20a: Push("end: ") // @poff=188
...
0x219: Push((float)9.999999974752427e-07)
...
0x226: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0x227: Pop(0)
0x228: Push("Category") // @poff=210
0x229: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x22a: Pop(1)
0x22b: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0x22c: Pop(0)
0x22d: Pop(0); Push((bool) Stack[-1] == 0)
0x22e: IF (Stack[-1] == 0) GOTO 0x231; Pop(1)

0x22f: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0x230: Pop(0)
0x231: Return(); Pop(6)
...
0x234: Pop(0)
0x235: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0x236: Pop(0)
0x237: PushEmpty(object, object, int)
0x238: Stack[-8] = Stack[-3]
0x239: Stack[-4] = Stack[-2]
0x23a: Stack[-6] = Stack[-1]
0x23b: Call 0x225
...
0x241: Pop(0)
0x242: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x253: Stack[-2] = (int) 0
0x254: Push("all") // @poff=110
0x255: PushEmpty(string, int)
0x256: Stack[-5] = Stack[-1]
0x257: Call 0x24b
...
0x261: Stack[-2] = Stack[-5]
0x262: Return(); Pop(4)

0x263: PushEmpty()
0x264: Push("playsound") // @poff=258
0x265: Push("giveitem") // @poff=278
0x266: @ TriggerWorld(Stack[-2], Stack[-1])
0x267: Pop(2)
0x268: Return(); Pop(0)

0x269: PushEmpty()
0x26a: Push("powder is given") // @poff=296
0x26b: @ Trace(Stack[-1])
0x26c: Pop(1)
0x26d: PushEmpty(object, string, int)
0x26e: Stack[-5] = Stack[-3]
0x26f: Stack[-2] = "powder" // @poff=328
0x270: Stack[-1] = (int) 1
0x271: Call 0x232
...
0x274: PushEmpty()
0x275: Push("ood4BirdmaskHome1") // @poff=342
0x276: Push((int) 1)
...
0x27a: PushEmpty()
0x27b: Push("ood4BirdmaskHome2") // @poff=378
0x27c: Push((int) 1)
...
0x284: Pop(1)
0x285: Push("d4q02BirdmaskNearHome") // @poff=414
0x286: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=458
0x287: Pop(1)
0x288: Push(Stack[-1])
0x289: IF (Stack[-1] == 0) GOTO 0x28c; Pop(1)

0x28a: @@ Remove(); Obj=1 // @poff=467
0x28b: Pop(0)
0x28c: Push("d4q02MladVladGotoAJLSelf") // @poff=474
0x28d: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=458
0x28e: Pop(1)
0x28f: Push(Stack[-1])
0x290: IF (Stack[-1] == 0) GOTO 0x293; Pop(1)

0x291: @@ Remove(); Obj=1 // @poff=467
0x292: Pop(0)
0x293: Push("d4q02MladVladGotoAnna") // @poff=524
0x294: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=458
0x295: Pop(1)
0x296: Push(Stack[-1])
0x297: IF (Stack[-1] == 0) GOTO 0x29a; Pop(1)

0x298: @@ Remove(); Obj=1 // @poff=467
0x299: Pop(0)
0x29a: Push("d4q02MladVladGotoJulia") // @poff=568
0x29b: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=458
0x29c: Pop(1)
0x29d: Push(Stack[-1])
0x29e: IF (Stack[-1] == 0) GOTO 0x2a1; Pop(1)

0x29f: @@ Remove(); Obj=1 // @poff=467
0x2a0: Pop(0)
0x2a1: Push("d4q02MladVladGotoLara") // @poff=614
0x2a2: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=458
0x2a3: Pop(1)
0x2a4: Push(Stack[-1])
0x2a5: IF (Stack[-1] == 0) GOTO 0x2a8; Pop(1)

0x2a6: @@ Remove(); Obj=1 // @poff=467
0x2a7: Pop(0)
0x2a8: PushEmpty()
0x2a9: Call 0x33d
...
0x2ac: Stack[-2] = "quest_d4_02" // @poff=658
0x2ad: Stack[-1] = "completed" // @poff=682
0x2ae: Call 0x23f
...
0x2b8: Stack[-2] = "quest_d4_02" // @poff=658
0x2b9: Stack[-1] = "birdmask_talk" // @poff=702
0x2ba: Call 0x23f
...
0x2bf: Stack[-1] = "ood4BirdmaskHome1" // @poff=342
0x2c0: Call 0x220
...
0x2cb: Stack[-1] = "ood4BirdmaskHome2" // @poff=378
0x2cc: Call 0x220
...
0x2d7: Stack[-1] = "d4q02_survived" // @poff=730
0x2d8: Call 0x220
...
0x2e6: Push("Can't retrieve diary root") // @poff=760
0x2e7: @ Trace(Stack[-1])
0x2e8: Pop(1)
...
0x2f2: Pop(1)
0x2f3: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=812
0x2f4: Pop(0)
0x2f5: Pop(0); Push((bool) Stack[-2] == 0)
0x2f6: IF (Stack[-1] == 0) GOTO 0x2fd; Pop(1)

0x2f7: Push("Can't find diary parent with id: ") // @poff=817
...
0x2fd: @@ AddChild(Stack[-8]); Obj=2 // @poff=885
0x2fe: Pop(0)
0x2ff: Push("player_diary") // @poff=894
0x300: Push((int) 1)
0x301: @ SetVariable(Stack[-2], Stack[-1])
0x302: Pop(2)
0x303: @@ GetCategory(Stack[-1]); Obj=8 // @poff=920
0x304: Pop(0)
...
0x30d: Pop(0)
0x30e: Pop(0); PushNull((bool) Stack[-2] == 0)
0x30f: IF (Stack[-1] == 0) GOTO 0x316; Pop(1)

0x310: Push("Can't find main outdoor scene") // @poff=932
0x311: @ Trace(Stack[-1])
0x312: Pop(1)
0x313: Stack[-1] = 0
...
0x316: @@ GetMap(Stack[-1]); Obj=2 // @poff=992
0x317: Pop(0)
...
0x32e: Push("Adding diary entry") // @poff=1013
0x32f: @ Trace(Stack[-1])
0x330: Pop(1)
0x331: Push((int) 138)
0x332: Push((int) 2)
...
0x33e: Push("Adding diary entry") // @poff=1013
0x33f: @ Trace(Stack[-1])
0x340: Pop(1)
0x341: Push((int) 94)
0x342: Push((int) 2)
...
0x34f: Stack[-1] = "ui/NPC_Black.png" // @poff=1051
0x350: Return(); Pop(0)
