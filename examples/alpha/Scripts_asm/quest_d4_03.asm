...
Strings:
	...
	W:locked
	A:SetProperty
// @pool_raw:
...
0x1: Push("d4q03") // @poff=0
0x2: Push((int) 1)
0x3: @ SetVariable(Stack[-2], Stack[-1])
0x4: Pop(2)
0x5: PushEmpty(string, bool)
0x6: Stack[-2] = "warehouse_gangster@door1" // @poff=12
0x7: Stack[-1] = (bool) 0
0x8: Call 0xf0

0x9: Pop(2)
0xa: PushEmpty(string, bool)
0xb: Stack[-2] = "iwarehouse_gangster@door1" // @poff=62
0xc: Stack[-1] = (bool) 1
0xd: Call 0xf0
...
0x14: Stack[-1] = "warehouse_gangster" // @poff=114
0x15: Call 0xd8

0x16: Stack[-2] = Stack[-4]
0x17: Pop(2)
0x18: Stack[-1] = (int) 0
0x19: Push((int) 7)
...
0x1d: Stack[-7] = Stack[-4]
0x1e: Push("pt_gangster") // @poff=152
0x1f: Push((int) 1)
0x20: Pop(1); Push(Stack[-8] + Stack[-1]);
0x21: Stack[-5] = Stack[-2] + Stack[-1]; Pop(2);
0x22: Stack[-2] = "pers_grabitel" // @poff=176
0x23: Stack[-1] = "d4q03_grabitel.xml" // @poff=204
0x24: Call 0xde

0x25: Pop(4)
0x26: @@@ add(Stack[-1]); Obj=0 // @poff=242
0x27: Pop(1)
0x28: Push((int) 1)
...
0x39: Stack[-1] = "attack" // @poff=268
0x3a: Call 0x100

0x3b: Pop(2)
0x3c: Push("door") // @poff=282
0x3d: @ PlaySound(Stack[-1])
0x3e: Pop(1)
0x3f: Push("gang_attack") // @poff=292
...
0x44: Stack[-1] = "attack" // @poff=268
0x45: Call 0x100

0x46: Pop(2)
0x47: GOTO 0x72

0x48: Push("death") // @poff=316
0x49: Pop(1); Push((bool) Stack[-10] == Stack[-1])
0x4a: IF (Stack[-1] == 0) GOTO 0x6c; Pop(1)

0x4b: @@@ size(Stack[-4]); Obj=0 // @poff=328
0x4c: Pop(0)
0x4d: Stack[-3] = (int) 0
0x4e: Pop(0); Push((bool) Stack[-3] < Stack[-4])
0x4f: IF (Stack[-1] == 0) GOTO 0x5b; Pop(1)

0x50: @@@ get(Stack[-2], Stack[-3]); Obj=0 // @poff=333
0x51: Pop(0)
0x52: @@ IsDead(Stack[-1]); Obj=2 // @poff=337
0x53: Pop(0)
...
0x5d: Push("d4q03_alldead") // @poff=344
0x5e: Push((int) 1)
0x5f: @ SetVariable(Stack[-2], Stack[-1])
0x60: Pop(2)
0x61: PushEmpty(string, bool)
0x62: Stack[-2] = "iwarehouse_gangster@door1" // @poff=62
0x63: Stack[-1] = (bool) 0
0x64: Call 0xf0

0x65: Pop(2)
0x66: PushEmpty(string, bool)
0x67: Stack[-2] = "warehouse_gangster@door1" // @poff=12
0x68: Stack[-1] = (bool) 1
0x69: Call 0xf0
...
0x9f: Stack[-1] = "cleanup" // @poff=392
0xa0: Call 0x100

0xa1: Pop(2)
0xa2: PushEmpty(string, bool)
0xa3: Stack[-2] = "iwarehouse_gangster@door1" // @poff=62
0xa4: Stack[-1] = (bool) 0
0xa5: Call 0xf0

0xa6: Pop(2)
0xa7: PushEmpty(string, bool)
0xa8: Stack[-2] = "warehouse_gangster@door1" // @poff=12
0xa9: Stack[-1] = (bool) 1
0xaa: Call 0xf0

0xab: Pop(2)
0xac: @@@ clear(); Obj=0 // @poff=408
0xad: Pop(0)
...
0xdf: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=414
0xe0: Pop(0)
0xe1: Pop(0); Push((bool) Stack[-4] == 0)
0xe2: IF (Stack[-1] == 0) GOTO 0xeb; Pop(1)

0xe3: Push("Locator ") // @poff=425
0xe4: Pop(1); Push(Stack[-1] + Stack[-12]);
0xe5: Push(" doesn't exist") // @poff=443
...
0xf5: Push("Door ") // @poff=473
0xf6: Pop(1); Push(Stack[-1] + Stack[-5]);
0xf7: Push(" not found") // @poff=485
0xf8: Pop(2); Push(Stack[-2] + Stack[-1]);
0xf9: @ Trace(Stack[-1])
0xfa: Pop(1)
0xfb: Push("locked") // @poff=507
0xfc: @@ SetProperty(Stack[-1], Stack[-4]); Obj=2 // @poff=521
0xfd: Pop(1)
0xfe: Return(); Pop(2)

0xff: Stack[-1] = 0
0x100: PushEmpty(int, int, object, int, int, object)
0x101: @@ size(Stack[-3]); Obj=8 // @poff=328
0x102: Pop(0)
0x103: Stack[-2] = (int) 0
0x104: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x105: IF (Stack[-1] == 0) GOTO 0x110; Pop(1)

0x106: @@ get(Stack[-1], Stack[-2]); Obj=8 // @poff=333
0x107: Pop(0)
0x108: Push(Stack[-1])
