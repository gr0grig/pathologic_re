...
Strings:
	...
	W:2
	W:death
// @pool_raw:
...
0xd: Stack[-2] = "quest_d4_03" // @poff=0
0xe: Stack[-1] = "gang_attack" // @poff=24
0xf: Call 0x47b
...
0x63: Stack[-1] = 0
0x64: PushEmpty()
0x65: Stack[-3] = (float) 0.10000000149011612
0x66: Return(); Pop(0)
...
0x74: Push("all") // @poff=94
0x75: Push("attack_begin") // @poff=102
0x76: Push((int) 1)
0x77: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x9f: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0xa0: Pop(0)
0xa1: Push(Stack[-22])
...
0xb1: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=184
0xb2: Pop(0)
...
0xd5: Pop(1)
0xd6: Push("all") // @poff=94
0xd7: Push("attack_on") // @poff=198
...
0xe1: PushEmpty(bool)
0xe2: Stack[-1] = (bool) 1
0xe3: Push((float)0.6000000238418579)
0xe4: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0xe5: IF (Stack[-1] == 1) GOTO 0xeb; Pop(1)

0xe6: PushEmpty(bool)
0xe7: Call 0x22a

0xe8: Pop(0)
0xe9: IF (Stack[-1] == 1) GOTO 0xeb; Pop(1)
...
0xec: @ Face(Stack[-0]T)
0xed: Pop(0)
0xee: Push("all") // @poff=94
0xef: Push("attack_stay") // @poff=218
0xf0: @ PlayAnimation(Stack[-2], Stack[-1])
0xf1: Pop(2)
0xf2: PushEmpty(bool, float)
0xf3: Stack[-23] = Stack[-1]
0xf4: Call 0x1ce
...
0xf9: @ Face(Stack[-0]T)
0xfa: Pop(0)
0xfb: Push("all") // @poff=94
0xfc: Push("fjump") // @poff=242
...
0x114: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=184
0x115: Pop(0)
...
0x133: Push("all") // @poff=94
0x134: Push("attack_off") // @poff=254
...
0x140: Push((float)0.8999999761581421)
0x141: Pop(1); Push(Stack[-9] * Stack[-1]);
0x142: @ GetVictim(Stack[-1], Stack[-4])
0x143: Pop(1)
0x144: @ ReportAttack(Stack[-0]T)
0x145: Pop(0)
...
0x14a: Stack[-10] = Stack[-1]
0x14b: Call 0x64

0x14c: Stack[-3] = Stack[-5]
0x14d: Pop(3)
0x14e: PushEmpty(float, object, float, int)
0x14f: Stack[-7] = Stack[-3]
0x150: Stack[-6] = Stack[-2]
0x151: PushEmpty(int, object, int)
0x152: Stack[-10] = Stack[-2]
0x153: Stack[-14] = Stack[-1]
0x154: Call 0x67

0x155: Stack[-3] = Stack[-4]
0x156: Pop(3)
0x157: Call 0x394

0x158: Stack[-4] = Stack[-5]
0x159: Pop(4)
0x15a: PushEmpty(int)
0x15b: Call 0x255

0x15c: Pop(0)
0x15d: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x15e: Pop(1)
0x15f: PushEmpty(object, float)
0x160: Stack[-5] = Stack[-2]
...
0x167: @ irand(Stack[-2], Stack[-1]T)
0x168: Pop(0)
0x169: Push((int) 1)
0x16a: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x16b: @ Face(Stack[-0]T)
0x16c: Pop(0)
0x16d: Push((bool) 1)
0x16e: @ SetAttackState(Stack[-1])
0x16f: Pop(1)
0x170: Push("all") // @poff=94
0x171: Push("attack_begin") // @poff=102
...
0x185: Stack[-7] = Stack[-2]
0x186: Stack[-4] = Stack[-1]
0x187: Call 0x13f

0x188: Pop(2)
0x189: Push("all") // @poff=94
0x18a: Push("attack_middle") // @poff=276
...
0x190: Push("all") // @poff=94
0x191: Push("attack_middle") // @poff=276
...
0x1a2: Stack[-7] = Stack[-2]
0x1a3: Stack[-4] = Stack[-1]
0x1a4: Call 0x13f
...
0x1a8: Pop(1)
0x1a9: Push("all") // @poff=94
0x1aa: Push("attack_end") // @poff=304
...
0x1e2: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=184
0x1e3: Pop(0)
...
0x218: @ Face(Stack[-0]T)
0x219: Pop(0)
0x21a: Push("all") // @poff=94
0x21b: Push("bjump") // @poff=326
0x21c: @ PlayAnimation(Stack[-2], Stack[-1])
0x21d: Pop(2)
0x21e: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=184
0x21f: Pop(0)
...
0x248: @ irand(Stack[-1], Stack[-2]T)
0x249: Pop(0)
0x24a: Push((int) 1)
0x24b: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x24c: Push("attack") // @poff=34
...
0x268: Stack[-17] = Stack[-7]
0x269: PushEmpty(bool, object)
0x26a: Stack[-23] = Stack[-1]
0x26b: Call 0x2f1
...
0x271: @@ GetPosition(Stack[-5]); Obj=21 // @poff=374
0x272: Pop(0)
...
0x288: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=184
0x289: Pop(0)
...
0x29a: Push((int) 0)
0x29b: Push((float)0.30000001192092896)
...
0x2bd: Push((int) 0)
0x2be: Push((float)0.30000001192092896)
...
0x2f8: Stack[-1] = "walk" // @poff=386
0x2f9: Return(); Pop(0)

0x2fa: Stack[-1] = "run" // @poff=396
0x2fb: Return(); Pop(0)
...
0x30e: Pop(0); PushNull((bool) Stack[-21] == 0)
0x30f: IF (Stack[-1] == 0) GOTO 0x315; Pop(1)

0x310: PushEmpty(string)
0x311: Stack[-1] = "fdie" // @poff=404
0x312: Call 0x364

0x313: Pop(1)
0x314: GOTO 0x363

0x315: @@ GetPosition(Stack[-10]); Obj=21 // @poff=374
0x316: Pop(0)
...
0x326: Stack[-6] = "fdie" // @poff=404
0x327: GOTO 0x329

0x328: Stack[-6] = "bdie" // @poff=414
...
0x32f: @ StopAsync()
0x330: Pop(0)
0x331: Stack[-21] = Stack[-5]
0x332: Push("GetScriptProperty") // @poff=424
0x333: Push((int) 2)
0x334: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x335: IF (Stack[-1] == 0) GOTO 0x341; Pop(1)

0x336: Push("Owner") // @poff=460
0x337: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=472
0x338: Pop(1)
0x339: Push(Stack[-4])
0x33a: IF (Stack[-1] == 0) GOTO 0x341; Pop(1)

0x33b: Push("Owner") // @poff=460
0x33c: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=490
0x33d: Pop(1)
0x33e: Pop(0); PushNull((bool) Stack[-5] == 0)
0x33f: IF (Stack[-1] == 0) GOTO 0x341; Pop(1)

0x340: Stack[-21] = Stack[-5]
0x341: Push("@GetEyesHeight") // @poff=508
0x342: Push((int) 1)
0x343: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x344: IF (Stack[-1] == 0) GOTO 0x350; Pop(1)

0x345: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=538
0x346: Pop(0)
...
0x358: @ StopAsync()
0x359: Pop(0)
0x35a: Push("head") // @poff=552
0x35b: @ UnlookAsync(Stack[-1])
0x35c: Pop(1)
0x35d: Push("all") // @poff=94
...
0x384: Stack[-2] = "fire" // @poff=562
0x385: Return(); Pop(0)

0x386: Stack[-2] = "phys" // @poff=572
0x387: Return(); Pop(0)

0x388: PushEmpty(bool, bool)
0x389: Push("HasProperty") // @poff=582
0x38a: Push((int) 2)
...
0x390: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=606
0x391: Pop(0)
...
0x396: Stack[-18] = Stack[-2]
0x397: Stack[-1] = "health" // @poff=618
0x398: Call 0x388
...
0x39f: Stack[-18] = Stack[-2]
0x3a0: Stack[-1] = "armor" // @poff=632
0x3a1: Call 0x388
...
0x3a7: Push("armor") // @poff=632
0x3a8: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=644
0x3a9: Pop(1)
0x3aa: Push("armor_") // @poff=656
0x3ab: PushEmpty(string, int)
0x3ac: Stack[-16] = Stack[-1]
0x3ad: Call 0x380

0x3ae: Pop(1)
0x3af: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3b0: PushEmpty(bool, object, string)
0x3b1: Stack[-18] = Stack[-2]
...
0x3b9: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=644
0x3ba: Pop(0)
...
0x3c1: Stack[-3] = Stack[-6]
0x3c2: Pop(3)
0x3c3: Push("health") // @poff=618
0x3c4: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=644
0x3c5: Pop(1)
0x3c6: Push((int) 1)
0x3c7: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3c8: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3c9: Push("health") // @poff=618
...
0x3cf: Pop(3)
0x3d0: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=670
0x3d1: Pop(2)
0x3d2: Stack[-1] = Stack[-16]
0x3d3: Return(); Pop(12)

0x3d4: PushEmpty(bool, bool)
0x3d5: @@ IsDead(Stack[-1]); Obj=3 // @poff=682
0x3d6: Pop(0)
0x3d7: Stack[-1] = Stack[-4]
0x3d8: Return(); Pop(2)

0x3d9: PushEmpty(object, object, object, object)
0x3da: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3ee: Pop(0)
0x3ef: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3f0: IF (Stack[-1] == 0) GOTO 0x3f3; Pop(1)

0x3f1: Stack[-6] = (bool) 0
0x3f2: Return(); Pop(4)

0x3f3: @@ GetScene(Stack[-1]); Obj=5 // @poff=703
0x3f4: Pop(0)
...
0x407: Stack[-6] = Stack[-2]
0x408: Stack[-1] = "noaccess" // @poff=712
0x409: Call 0x388
...
0x40f: Push("noaccess") // @poff=712
0x410: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=644
0x411: Pop(1)
0x412: Push((int) 0)
...
0x43b: @@ GetPosition(Stack[-5]); Obj=23 // @poff=374
0x43c: Pop(0)
...
0x44c: Stack[-1] = "fhit" // @poff=768
0x44d: GOTO 0x44f

0x44e: Stack[-1] = "bhit" // @poff=778
0x44f: Push("hit_react") // @poff=788
0x450: Push("1") // @poff=808
0x451: Pop(1); Push(Stack[-3] + Stack[-1]);
0x452: Push("2") // @poff=812
...
0x459: @@ GetPosition(Stack[-3]); Obj=7 // @poff=374
0x45a: Pop(0)
...
0x489: Stack[-2] = "quest_d4_03" // @poff=0
0x48a: Stack[-1] = "death" // @poff=816
0x48b: Call 0x47b
...
0x496: Stack[-7] = Stack[-3]
0x497: Stack[-6] = Stack[-2]
0x498: Stack[-5] = Stack[-1]
0x499: Call 0x415
