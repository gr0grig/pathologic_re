...
Strings:
	...
	W:ui/NPC_Burah.png
// @pool_raw:
// @pool_encoding:utf8
...
0x69: Stack[-1] = "Neutral" // @poff=61
0x6a: Call 0xab

0x6b: Pop(1)
0x6c: Push((int) 11865)
0x6d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x6e: Pop(1)
0x6f: @@@ ClearReplies(); Obj=0 // @poff=88
0x70: Pop(0)
0x71: Push((int) 11866)
0x72: Push((int) 13080)
0x73: Push((int) 13079)
0x74: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x75: Pop(3)
0x76: GOTO 0x8d
...
0x7d: Stack[-1] = "Neutral" // @poff=61
0x7e: Call 0xab

0x7f: Pop(1)
0x80: Push((int) 12536)
0x81: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x82: Pop(1)
0x83: @@@ ClearReplies(); Obj=0 // @poff=88
0x84: Pop(0)
0x85: Push((int) 12537)
0x86: Push((int) 13707)
0x87: Push((int) 13706)
0x88: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x89: Pop(3)
0x8a: GOTO 0x8d
...
0x9c: Push("all") // @poff=110
0x9d: Push("idle") // @poff=118
...
0xd7: Stack[-1] = "Neutral" // @poff=61
0xd8: Call 0xab

0xd9: Pop(1)
0xda: Push((int) 10543)
0xdb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xdc: Pop(1)
0xdd: @@@ ClearReplies(); Obj=0 // @poff=88
0xde: Pop(0)
0xdf: Push((int) 10544)
0xe0: Push((int) 11634)
0xe1: Push((int) 11633)
0xe2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xe3: Pop(3)
0xe4: Push((int) 10560)
0xe5: Push((int) 11650)
0xe6: Push((int) 11649)
0xe7: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xe8: Pop(3)
0xe9: Push((int) 10566)
0xea: Push((int) 11634)
0xeb: Push((int) 11655)
0xec: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xed: Pop(3)
0xee: Return(); Pop(0)
...
0xf5: Stack[-1] = "Neutral" // @poff=61
0xf6: Call 0xab

0xf7: Pop(1)
0xf8: Push((int) 11865)
0xf9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xfa: Pop(1)
0xfb: @@@ ClearReplies(); Obj=0 // @poff=88
0xfc: Pop(0)
0xfd: Push((int) 11866)
0xfe: Push((int) 13080)
0xff: Push((int) 13079)
0x100: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x101: Pop(3)
0x102: Return(); Pop(0)
...
0x126: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x127: Pop(3)
0x128: Return(); Pop(0)
...
0x12d: Stack[-1] = "Neutral" // @poff=61
0x12e: Call 0xab

0x12f: Pop(1)
0x130: Push((int) 11867)
0x131: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x132: Pop(1)
0x133: @@@ ClearReplies(); Obj=0 // @poff=88
0x134: Pop(0)
0x135: Push((int) 11868)
0x136: Push((int) 13082)
0x137: Push((int) 13081)
0x138: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x139: Pop(3)
0x13a: Return(); Pop(0)
...
0x1a8: Stack[-1] = "Neutral" // @poff=61
0x1a9: Call 0xab

0x1aa: Pop(1)
0x1ab: Push((int) 10554)
0x1ac: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1ad: Pop(1)
0x1ae: @@@ ClearReplies(); Obj=0 // @poff=88
0x1af: Pop(0)
...
0x1bf: Stack[-1] = "Neutral" // @poff=61
0x1c0: Call 0xab

0x1c1: Pop(1)
0x1c2: Push((int) 10547)
0x1c3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1c4: Pop(1)
0x1c5: @@@ ClearReplies(); Obj=0 // @poff=88
0x1c6: Pop(0)
...
0x1d6: Stack[-1] = "Neutral" // @poff=61
0x1d7: Call 0xab

0x1d8: Pop(1)
0x1d9: Push((int) 10550)
0x1da: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1db: Pop(1)
0x1dc: @@@ ClearReplies(); Obj=0 // @poff=88
0x1dd: Pop(0)
0x1de: Push((int) 10551)
0x1df: Push((int) -1)
0x1e0: Push((int) 11640)
0x1e1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1e2: Pop(3)
...
0x231: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x232: Pop(0)
0x233: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x234: Pop(0)
...
0x274: Pop(0)
0x275: Push("start: ") // @poff=204
0x276: Pop(1); Push(Stack[-1] + Stack[-3]);
0x277: @ Trace(Stack[-1])
0x278: Pop(1)
0x279: Push("end: ") // @poff=220
...
0x28e: Push((float)9.999999974752427e-07)
...
0x29c: Pop(0)
0x29d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x2b3: Pop(1)
0x2b4: Push("d5q01BurahMeeting1") // @poff=244
0x2b5: Push("pt_d5q01_girl_corpse1") // @poff=282
0x2b6: Push((int) 1)
...
0x2ba: Pop(0)
0x2bb: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=326
0x2bc: Pop(5)
0x2bd: Push("d5q01BurahMeeting2") // @poff=334
0x2be: Push("pt_d5q01_girl_corpse2") // @poff=372
0x2bf: Push((int) 1)
...
0x2c3: Pop(0)
0x2c4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=326
0x2c5: Pop(5)
0x2c6: PushEmpty()
0x2c7: Call 0x33b
...
0x2ca: Stack[-2] = "quest_d5_01" // @poff=416
0x2cb: Stack[-1] = "burah_free" // @poff=440
0x2cc: Call 0x29a
...
0x2cf: Stack[-1] = 0
0x2d0: PushEmpty()
0x2d1: Push("ood5Burah1") // @poff=462
0x2d2: Push((int) 1)
...
0x2e2: Stack[-1] = "ood5Burah1" // @poff=462
0x2e3: Call 0x295
...
0x2f4: Push("Can't retrieve diary root") // @poff=484
0x2f5: @ Trace(Stack[-1])
0x2f6: Pop(1)
...
0x300: Pop(1)
0x301: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=536
0x302: Pop(0)
0x303: Pop(0); Push((bool) Stack[-2] == 0)
0x304: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x305: Push("Can't find diary parent with id: ") // @poff=541
...
0x30b: @@ AddChild(Stack[-8]); Obj=2 // @poff=609
0x30c: Pop(0)
0x30d: Push("player_diary") // @poff=618
0x30e: Push((int) 1)
0x30f: @ SetVariable(Stack[-2], Stack[-1])
0x310: Pop(2)
0x311: @@ GetCategory(Stack[-1]); Obj=8 // @poff=644
0x312: Pop(0)
...
0x31b: Pop(0)
0x31c: Pop(0); PushNull((bool) Stack[-2] == 0)
0x31d: IF (Stack[-1] == 0) GOTO 0x324; Pop(1)

0x31e: Push("Can't find main outdoor scene") // @poff=656
0x31f: @ Trace(Stack[-1])
0x320: Pop(1)
0x321: Stack[-1] = 0
...
0x324: @@ GetMap(Stack[-1]); Obj=2 // @poff=716
0x325: Pop(0)
...
0x33c: Push("Adding diary entry") // @poff=737
0x33d: @ Trace(Stack[-1])
0x33e: Pop(1)
0x33f: Push((int) 146)
0x340: Push((int) 1)
...
0x34d: Stack[-1] = "ui/NPC_Burah.png" // @poff=775
0x34e: Return(); Pop(0)
