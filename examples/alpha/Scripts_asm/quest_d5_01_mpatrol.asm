...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
...
0xe: Stack[-1] = 0
0xf: PushEmpty()
0x10: Stack[-3] = (float) 0.30000001192092896
0x11: Return(); Pop(0)
...
0x17: Push("all") // @poff=14
0x18: Push("attack_begin") // @poff=22
0x19: Push((int) 1)
0x1a: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x25: Push("attack") // @poff=48
0x26: Push((int) 1)
0x27: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x42: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x43: Pop(0)
0x44: Push(Stack[-22])
...
0x54: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=118
0x55: Pop(0)
...
0x78: Pop(1)
0x79: Push("all") // @poff=14
0x7a: Push("attack_on") // @poff=132
...
0x84: PushEmpty(bool)
0x85: Stack[-1] = (bool) 1
0x86: Push((float)0.6000000238418579)
0x87: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x88: IF (Stack[-1] == 1) GOTO 0x8e; Pop(1)

0x89: PushEmpty(bool)
0x8a: Call 0x1cd

0x8b: Pop(0)
0x8c: IF (Stack[-1] == 1) GOTO 0x8e; Pop(1)
...
0x8f: @ Face(Stack[-0]T)
0x90: Pop(0)
0x91: Push("all") // @poff=14
0x92: Push("attack_stay") // @poff=152
0x93: @ PlayAnimation(Stack[-2], Stack[-1])
0x94: Pop(2)
0x95: PushEmpty(bool, float)
0x96: Stack[-23] = Stack[-1]
0x97: Call 0x171
...
0x9c: @ Face(Stack[-0]T)
0x9d: Pop(0)
0x9e: Push("all") // @poff=14
0x9f: Push("fjump") // @poff=176
...
0xb7: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=118
0xb8: Pop(0)
...
0xd6: Push("all") // @poff=14
0xd7: Push("attack_off") // @poff=188
...
0xe3: Push((float)0.8999999761581421)
0xe4: Pop(1); Push(Stack[-9] * Stack[-1]);
0xe5: @ GetVictim(Stack[-1], Stack[-4])
0xe6: Pop(1)
0xe7: @ ReportAttack(Stack[-0]T)
0xe8: Pop(0)
...
0xec: Stack[-6] = Stack[-2]
0xed: Stack[-10] = Stack[-1]
0xee: Call 0xf

0xef: Stack[-3] = Stack[-5]
0xf0: Pop(3)
0xf1: PushEmpty(float, object, float, int)
0xf2: Stack[-7] = Stack[-3]
0xf3: Stack[-6] = Stack[-2]
0xf4: PushEmpty(int, object, int)
0xf5: Stack[-10] = Stack[-2]
0xf6: Stack[-14] = Stack[-1]
0xf7: Call 0x12

0xf8: Stack[-3] = Stack[-4]
0xf9: Pop(3)
0xfa: Call 0x4af

0xfb: Stack[-4] = Stack[-5]
0xfc: Pop(4)
0xfd: PushEmpty(int)
0xfe: Call 0x1f8

0xff: Pop(0)
0x100: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x101: Pop(1)
0x102: PushEmpty(object, float)
0x103: Stack[-5] = Stack[-2]
...
0x10a: @ irand(Stack[-2], Stack[-1]T)
0x10b: Pop(0)
0x10c: Push((int) 1)
0x10d: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x10e: @ Face(Stack[-0]T)
0x10f: Pop(0)
0x110: Push((bool) 1)
0x111: @ SetAttackState(Stack[-1])
0x112: Pop(1)
0x113: Push("all") // @poff=14
0x114: Push("attack_begin") // @poff=22
...
0x128: Stack[-7] = Stack[-2]
0x129: Stack[-4] = Stack[-1]
0x12a: Call 0xe2

0x12b: Pop(2)
0x12c: Push("all") // @poff=14
0x12d: Push("attack_middle") // @poff=210
...
0x133: Push("all") // @poff=14
0x134: Push("attack_middle") // @poff=210
...
0x145: Stack[-7] = Stack[-2]
0x146: Stack[-4] = Stack[-1]
0x147: Call 0xe2
...
0x14b: Pop(1)
0x14c: Push("all") // @poff=14
0x14d: Push("attack_end") // @poff=238
...
0x185: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=118
0x186: Pop(0)
...
0x1bb: @ Face(Stack[-0]T)
0x1bc: Pop(0)
0x1bd: Push("all") // @poff=14
0x1be: Push("bjump") // @poff=260
0x1bf: @ PlayAnimation(Stack[-2], Stack[-1])
0x1c0: Pop(2)
0x1c1: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=118
0x1c2: Pop(0)
...
0x1eb: @ irand(Stack[-1], Stack[-2]T)
0x1ec: Pop(0)
0x1ed: Push((int) 1)
0x1ee: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x1ef: Push("attack") // @poff=48
...
0x203: Stack[-17] = Stack[-7]
0x204: PushEmpty(bool, object)
0x205: Stack[-23] = Stack[-1]
0x206: Call 0x28c
...
0x20c: @@ GetPosition(Stack[-5]); Obj=21 // @poff=308
0x20d: Pop(0)
...
0x223: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=118
0x224: Pop(0)
...
0x235: Push((int) 0)
0x236: Push((float)0.30000001192092896)
...
0x258: Push((int) 0)
0x259: Push((float)0.30000001192092896)
...
0x293: Stack[-1] = "walk" // @poff=320
0x294: Return(); Pop(0)

0x295: Stack[-1] = "run" // @poff=330
0x296: Return(); Pop(0)

0x297: PushEmpty()
0x298: PushEmpty(bool, string, string)
0x299: Stack[-2] = "quest_d5_01" // @poff=338
0x29a: Stack[-1] = "dead" // @poff=362
0x29b: Call 0x5fa
...
0x2ba: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2bb: IF (Stack[-1] == 0) GOTO 0x2c1; Pop(1)

0x2bc: PushEmpty(string)
0x2bd: Stack[-1] = "fdie" // @poff=372
0x2be: Call 0x310

0x2bf: Pop(1)
0x2c0: GOTO 0x30f

0x2c1: @@ GetPosition(Stack[-10]); Obj=21 // @poff=308
0x2c2: Pop(0)
...
0x2d2: Stack[-6] = "fdie" // @poff=372
0x2d3: GOTO 0x2d5

0x2d4: Stack[-6] = "bdie" // @poff=382
...
0x2db: @ StopAsync()
0x2dc: Pop(0)
0x2dd: Stack[-21] = Stack[-5]
0x2de: Push("GetScriptProperty") // @poff=392
0x2df: Push((int) 2)
0x2e0: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2e1: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)

0x2e2: Push("Owner") // @poff=428
0x2e3: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=440
0x2e4: Pop(1)
0x2e5: Push(Stack[-4])
0x2e6: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)

0x2e7: Push("Owner") // @poff=428
0x2e8: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=458
0x2e9: Pop(1)
0x2ea: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2eb: IF (Stack[-1] == 0) GOTO 0x2ed; Pop(1)

0x2ec: Stack[-21] = Stack[-5]
0x2ed: Push("@GetEyesHeight") // @poff=476
0x2ee: Push((int) 1)
0x2ef: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2f0: IF (Stack[-1] == 0) GOTO 0x2fc; Pop(1)

0x2f1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=506
0x2f2: Pop(0)
...
0x304: @ StopAsync()
0x305: Pop(0)
0x306: Push("head") // @poff=520
0x307: @ UnlookAsync(Stack[-1])
0x308: Pop(1)
0x309: Push("all") // @poff=14
...
0x33a: Pop(0)
0x33b: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=530
0x33c: Pop(1)
0x33d: PushEmpty(string)
0x33e: Call 0x670

0x33f: Pop(0)
0x340: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=541
0x341: Pop(1)
0x342: PushEmpty(int)
0x343: Call 0x65d

0x344: Pop(0)
0x345: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=550
0x346: Pop(1)
0x347: Stack[-2] = (int) -1
...
0x356: Pop(2)
0x357: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=564
0x358: Pop(0)
...
0x35b: @ sync()
0x35c: Pop(0)
0x35d: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=564
0x35e: Pop(0)
0x35f: GOTO 0x359

0x360: PushEmpty(object)
0x361: Stack[-10] = Stack[-1]
0x362: Call 0x5b6

0x363: Pop(1)
0x364: @ StopDialog(Stack[-4])
0x365: Pop(0)
0x366: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=576
0x367: Pop(0)
0x368: Stack[-2] = Stack[-10]
0x369: Return(); Pop(8)
...
0x377: Stack[-1] = "Neutral" // @poff=591
0x378: Call 0x3b4

0x379: Pop(1)
0x37a: Push((int) 11690)
0x37b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x37c: Pop(1)
0x37d: @@@ ClearReplies(); Obj=0 // @poff=618
0x37e: Pop(0)
0x37f: Push((int) 11691)
0x380: Push((int) 12894)
0x381: Push((int) 12893)
0x382: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x383: Pop(3)
0x384: GOTO 0x396

0x385: PushEmpty(string)
0x386: Stack[-1] = "Neutral" // @poff=591
0x387: Call 0x3b4

0x388: Pop(1)
0x389: Push((int) 12483)
0x38a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x38b: Pop(1)
0x38c: @@@ ClearReplies(); Obj=0 // @poff=618
0x38d: Pop(0)
0x38e: Push((int) 12484)
0x38f: Push((int) -1)
0x390: Push((int) 13652)
0x391: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x392: Pop(3)
0x393: GOTO 0x396
...
0x3a5: Push("all") // @poff=14
0x3a6: Push("idle") // @poff=640
...
0x3ae: Push("all") // @poff=14
0x3af: Push("idle") // @poff=640
...
0x3ed: Stack[-1] = "Neutral" // @poff=591
0x3ee: Call 0x3b4

0x3ef: Pop(1)
0x3f0: Push((int) 11690)
0x3f1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x3f2: Pop(1)
0x3f3: @@@ ClearReplies(); Obj=0 // @poff=618
0x3f4: Pop(0)
0x3f5: Push((int) 11691)
0x3f6: Push((int) 12894)
0x3f7: Push((int) 12893)
0x3f8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x3f9: Pop(3)
0x3fa: Return(); Pop(0)

0x3fb: PushEmpty(string)
0x3fc: Stack[-1] = "Neutral" // @poff=591
0x3fd: Call 0x3b4

0x3fe: Pop(1)
0x3ff: Push((int) 12483)
0x400: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x401: Pop(1)
0x402: @@@ ClearReplies(); Obj=0 // @poff=618
0x403: Pop(0)
0x404: Push((int) 12484)
0x405: Push((int) -1)
0x406: Push((int) 13652)
0x407: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x408: Pop(3)
0x409: Return(); Pop(0)
...
0x40e: Stack[-1] = "Neutral" // @poff=591
0x40f: Call 0x3b4

0x410: Pop(1)
0x411: Push((int) 11692)
0x412: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x413: Pop(1)
0x414: @@@ ClearReplies(); Obj=0 // @poff=618
0x415: Pop(0)
0x416: Push((int) 11693)
0x417: Push((int) 12901)
0x418: Push((int) 12895)
0x419: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x41a: Pop(3)
0x41b: Push((int) 11694)
0x41c: Push((int) 12898)
0x41d: Push((int) 12896)
0x41e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x41f: Pop(3)
0x420: Push((int) 11695)
0x421: Push((int) 12898)
0x422: Push((int) 12897)
0x423: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x424: Pop(3)
0x425: Return(); Pop(0)
...
0x42a: Stack[-1] = "Neutral" // @poff=591
0x42b: Call 0x3b4

0x42c: Pop(1)
0x42d: Push((int) 11696)
0x42e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x42f: Pop(1)
0x430: @@@ ClearReplies(); Obj=0 // @poff=618
0x431: Pop(0)
0x432: Push((int) 11697)
0x433: Push((int) 12901)
0x434: Push((int) 12900)
0x435: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x436: Pop(3)
0x437: Return(); Pop(0)
...
0x43c: Stack[-1] = "Neutral" // @poff=591
0x43d: Call 0x3b4

0x43e: Pop(1)
0x43f: Push((int) 11698)
0x440: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x441: Pop(1)
0x442: @@@ ClearReplies(); Obj=0 // @poff=618
0x443: Pop(0)
0x444: Push((int) 11699)
0x445: Push((int) 12904)
0x446: Push((int) 12902)
0x447: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x448: Pop(3)
0x449: Return(); Pop(0)
...
0x44e: Stack[-1] = "Neutral" // @poff=591
0x44f: Call 0x3b4

0x450: Pop(1)
0x451: Push((int) 11700)
0x452: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x453: Pop(1)
0x454: @@@ ClearReplies(); Obj=0 // @poff=618
0x455: Pop(0)
0x456: Push((int) 11701)
0x457: Push((int) -1)
0x458: Push((int) 12905)
0x459: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x45a: Pop(3)
0x45b: Push((int) 11702)
0x45c: Push((int) -1)
0x45d: Push((int) 12906)
0x45e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x45f: Pop(3)
0x460: Return(); Pop(0)
...
0x48c: Stack[-2] = "quest_d5_01" // @poff=338
0x48d: Stack[-1] = "factory_fight" // @poff=650
0x48e: Call 0x5fa
...
0x49f: Stack[-2] = "fire" // @poff=678
0x4a0: Return(); Pop(0)

0x4a1: Stack[-2] = "phys" // @poff=688
0x4a2: Return(); Pop(0)

0x4a3: PushEmpty(bool, bool)
0x4a4: Push("HasProperty") // @poff=698
0x4a5: Push((int) 2)
...
0x4ab: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=722
0x4ac: Pop(0)
...
0x4b1: Stack[-18] = Stack[-2]
0x4b2: Stack[-1] = "health" // @poff=734
0x4b3: Call 0x4a3
...
0x4ba: Stack[-18] = Stack[-2]
0x4bb: Stack[-1] = "armor" // @poff=748
0x4bc: Call 0x4a3
...
0x4c2: Push("armor") // @poff=748
0x4c3: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=760
0x4c4: Pop(1)
0x4c5: Push("armor_") // @poff=772
0x4c6: PushEmpty(string, int)
0x4c7: Stack[-16] = Stack[-1]
0x4c8: Call 0x49b

0x4c9: Pop(1)
0x4ca: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4cb: PushEmpty(bool, object, string)
0x4cc: Stack[-18] = Stack[-2]
0x4cd: Stack[-8] = Stack[-1]
0x4ce: Call 0x4a3
...
0x4d4: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=760
0x4d5: Pop(0)
...
0x4dc: Stack[-3] = Stack[-6]
0x4dd: Pop(3)
0x4de: Push("health") // @poff=734
0x4df: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=760
0x4e0: Pop(1)
0x4e1: Push((int) 1)
0x4e2: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4e3: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4e4: Push("health") // @poff=734
...
0x4ea: Pop(3)
0x4eb: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=786
0x4ec: Pop(2)
0x4ed: Stack[-1] = Stack[-16]
0x4ee: Return(); Pop(12)

0x4ef: PushEmpty(bool, bool)
0x4f0: @@ IsDead(Stack[-1]); Obj=3 // @poff=798
0x4f1: Pop(0)
0x4f2: Stack[-1] = Stack[-4]
0x4f3: Return(); Pop(2)

0x4f4: PushEmpty(object, object, object, object)
0x4f5: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x509: Pop(0)
0x50a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x50b: IF (Stack[-1] == 0) GOTO 0x50e; Pop(1)

0x50c: Stack[-6] = (bool) 0
0x50d: Return(); Pop(4)

0x50e: @@ GetScene(Stack[-1]); Obj=5 // @poff=819
0x50f: Pop(0)
...
0x522: Stack[-6] = Stack[-2]
0x523: Stack[-1] = "noaccess" // @poff=828
0x524: Call 0x4a3
...
0x52a: Push("noaccess") // @poff=828
0x52b: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=760
0x52c: Pop(1)
0x52d: Push((int) 0)
...
0x556: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x557: Pop(0)
...
0x567: Stack[-1] = "fhit" // @poff=884
0x568: GOTO 0x56a

0x569: Stack[-1] = "bhit" // @poff=894
0x56a: Push("hit_react") // @poff=904
0x56b: Push("1") // @poff=358
0x56c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x56d: Push("2") // @poff=924
...
0x574: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x575: Pop(0)
...
0x57f: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x580: Pop(0)
0x581: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=506
0x582: Pop(0)
...
0x5c2: Pop(0)
0x5c3: Push("start: ") // @poff=946
0x5c4: Pop(1); Push(Stack[-1] + Stack[-3]);
0x5c5: @ Trace(Stack[-1])
0x5c6: Pop(1)
0x5c7: Push("end: ") // @poff=962
...
0x5dc: Push((float)9.999999974752427e-07)
...
0x5e6: Stack[-2] = Stack[-3]
0x5e7: GOTO 0x5e9

0x5e8: Stack[-1] = Stack[-3]
0x5e9: Return(); Pop(0)
...
0x608: Pop(0)
0x609: Stack[-1] = Stack[-3]
0x60a: Return(); Pop(2)

0x60b: PushEmpty()
0x60c: PushEmpty(object, int, float)
0x60d: Stack[-7] = Stack[-3]
0x60e: Stack[-6] = Stack[-2]
0x60f: Stack[-5] = Stack[-1]
0x610: Call 0x530
...
0x626: PushEmpty()
0x627: Push("ood5PatrolGuard1") // @poff=974
0x628: Push((int) 1)
...
0x633: Stack[-1] = Stack[-2]
0x634: Pop(1)
0x635: Push("d5q01PatrolGotoGrif") // @poff=1020
0x636: Push("pt_map_grif") // @poff=1060
0x637: Push((int) 1)
...
0x63b: Pop(0)
0x63c: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=1084
0x63d: Pop(5)
0x63e: Return(); Pop(2)
...
0x642: Stack[-1] = "ood5PatrolGuard1" // @poff=974
0x643: Call 0x5f5
...
0x64e: Pop(0)
0x64f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x650: IF (Stack[-1] == 0) GOTO 0x657; Pop(1)

0x651: Push("Can't find main outdoor scene") // @poff=1092
0x652: @ Trace(Stack[-1])
0x653: Pop(1)
0x654: Stack[-1] = 0
...
0x657: @@ GetMap(Stack[-1]); Obj=2 // @poff=1152
0x658: Pop(0)
0x659: Stack[-1] = Stack[-5]
0x65a: Return(); Pop(4)

0x65b: Stack[-1] = 0
0x65c: Stack[-2] = 0
0x65d: PushEmpty(int, int)
0x65e: Push("player") // @poff=0
...
0x670: Stack[-1] = "ui/NPC_Black.png" // @poff=1159
0x671: Return(); Pop(0)
