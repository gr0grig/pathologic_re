...
Strings:
	...
	W:revolver_ammo
	W:alpha_pills
// @pool_raw:
...
0x372: Stack[-1] = "Neutral" // @poff=591
0x373: Call 0x3a0

0x374: Pop(1)
0x375: Push((int) 12541)
0x376: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x377: Pop(1)
0x378: @@@ ClearReplies(); Obj=0 // @poff=618
0x379: Pop(0)
0x37a: Push((int) 12542)
0x37b: Push((int) -1)
0x37c: Push((int) 13711)
0x37d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x37e: Pop(3)
0x37f: GOTO 0x382
...
0x391: Push("all") // @poff=14
0x392: Push("idle") // @poff=640
...
0x39a: Push("all") // @poff=14
0x39b: Push("idle") // @poff=640
...
0x3ba: Stack[-1] = "Neutral" // @poff=591
0x3bb: Call 0x3a0

0x3bc: Pop(1)
0x3bd: Push((int) 12541)
0x3be: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=607
0x3bf: Pop(1)
0x3c0: @@@ ClearReplies(); Obj=0 // @poff=618
0x3c1: Pop(0)
0x3c2: Push((int) 12542)
0x3c3: Push((int) -1)
0x3c4: Push((int) 13711)
0x3c5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=631
0x3c6: Pop(3)
0x3c7: Return(); Pop(0)
...
0x3f3: Stack[-2] = "quest_d5_01" // @poff=338
0x3f4: Stack[-1] = "factory_fight" // @poff=650
0x3f5: Call 0x55c
...
0x406: Stack[-2] = "fire" // @poff=678
0x407: Return(); Pop(0)

0x408: Stack[-2] = "phys" // @poff=688
0x409: Return(); Pop(0)

0x40a: PushEmpty(bool, bool)
0x40b: Push("HasProperty") // @poff=698
0x40c: Push((int) 2)
...
0x412: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=722
0x413: Pop(0)
...
0x418: Stack[-18] = Stack[-2]
0x419: Stack[-1] = "health" // @poff=734
0x41a: Call 0x40a
...
0x429: Push("armor") // @poff=748
0x42a: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=760
0x42b: Pop(1)
0x42c: Push("armor_") // @poff=772
0x42d: PushEmpty(string, int)
0x42e: Stack[-16] = Stack[-1]
0x42f: Call 0x402

0x430: Pop(1)
0x431: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x432: PushEmpty(bool, object, string)
0x433: Stack[-18] = Stack[-2]
...
0x43b: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=760
0x43c: Pop(0)
...
0x443: Stack[-3] = Stack[-6]
0x444: Pop(3)
0x445: Push("health") // @poff=734
0x446: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=760
0x447: Pop(1)
0x448: Push((int) 1)
0x449: Pop(1); Push(Stack[-1] - Stack[-4]);
0x44a: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x44b: Push("health") // @poff=734
...
0x451: Pop(3)
0x452: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=786
0x453: Pop(2)
0x454: Stack[-1] = Stack[-16]
0x455: Return(); Pop(12)

0x456: PushEmpty(bool, bool)
0x457: @@ IsDead(Stack[-1]); Obj=3 // @poff=798
0x458: Pop(0)
0x459: Stack[-1] = Stack[-4]
0x45a: Return(); Pop(2)

0x45b: PushEmpty(object, object, object, object)
0x45c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x470: Pop(0)
0x471: Pop(0); PushNull((bool) Stack[-2] == 0)
0x472: IF (Stack[-1] == 0) GOTO 0x475; Pop(1)

0x473: Stack[-6] = (bool) 0
0x474: Return(); Pop(4)

0x475: @@ GetScene(Stack[-1]); Obj=5 // @poff=819
0x476: Pop(0)
...
0x48a: Stack[-1] = "noaccess" // @poff=828
0x48b: Call 0x40a
...
0x491: Push("noaccess") // @poff=828
0x492: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=760
0x493: Pop(1)
0x494: Push((int) 0)
...
0x4bd: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x4be: Pop(0)
...
0x4ce: Stack[-1] = "fhit" // @poff=884
0x4cf: GOTO 0x4d1

0x4d0: Stack[-1] = "bhit" // @poff=894
0x4d1: Push("hit_react") // @poff=904
0x4d2: Push("1") // @poff=358
0x4d3: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4d4: Push("2") // @poff=924
...
0x4db: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x4dc: Pop(0)
...
0x4e6: @@ GetPosition(Stack[-7]); Obj=17 // @poff=308
0x4e7: Pop(0)
0x4e8: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=506
0x4e9: Pop(0)
...
0x529: Pop(0)
0x52a: Push("start: ") // @poff=946
0x52b: Pop(1); Push(Stack[-1] + Stack[-3]);
0x52c: @ Trace(Stack[-1])
0x52d: Pop(1)
0x52e: Push("end: ") // @poff=962
...
0x543: Push((float)9.999999974752427e-07)
...
0x54d: Stack[-2] = Stack[-3]
0x54e: GOTO 0x550

0x54f: Stack[-1] = Stack[-3]
0x550: Return(); Pop(0)
...
0x56a: Stack[-7] = Stack[-3]
0x56b: Stack[-6] = Stack[-2]
0x56c: Stack[-5] = Stack[-1]
0x56d: Call 0x497
...
0x596: Stack[-1] = "ui/NPC_Black.png" // @poff=974
0x597: Return(); Pop(0)
...
0x59b: Push("revolver_ammo") // @poff=1008
0x59c: Push((int) 0)
0x59d: Push((int) 2)
0x59e: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x59f: Pop(3)
0x5a0: Push("alpha_pills") // @poff=1036
0x5a1: Push((int) 0)
0x5a2: Push((int) 2)
