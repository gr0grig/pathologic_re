...
Strings:
	...
	W:hit_react
	W:2
// @pool_raw:
...
0x21: Push("all") // @poff=14
0x22: Push("attack_begin") // @poff=22
0x23: Push((int) 1)
0x24: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x2f: Push("attack") // @poff=48
0x30: Push((int) 1)
0x31: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x4c: @ IsPlayerActor(Stack[-0]T, Stack[-5])
0x4d: Pop(0)
0x4e: Push(Stack[-22])
...
0x5e: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=118
0x5f: Pop(0)
...
0x82: Pop(1)
0x83: Push("all") // @poff=14
0x84: Push("attack_on") // @poff=132
...
0x8e: PushEmpty(bool)
0x8f: Stack[-1] = (bool) 1
0x90: Push((float)0.6000000238418579)
0x91: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x92: IF (Stack[-1] == 1) GOTO 0x98; Pop(1)

0x93: PushEmpty(bool)
0x94: Call 0x1d7

0x95: Pop(0)
0x96: IF (Stack[-1] == 1) GOTO 0x98; Pop(1)
...
0x99: @ Face(Stack[-0]T)
0x9a: Pop(0)
0x9b: Push("all") // @poff=14
0x9c: Push("attack_stay") // @poff=152
0x9d: @ PlayAnimation(Stack[-2], Stack[-1])
0x9e: Pop(2)
0x9f: PushEmpty(bool, float)
0xa0: Stack[-23] = Stack[-1]
0xa1: Call 0x17b
...
0xa6: @ Face(Stack[-0]T)
0xa7: Pop(0)
0xa8: Push("all") // @poff=14
0xa9: Push("fjump") // @poff=176
...
0xc1: @@@ GetPFPosition(Stack[-7]); Obj=0 // @poff=118
0xc2: Pop(0)
...
0xe0: Push("all") // @poff=14
0xe1: Push("attack_off") // @poff=188
...
0xed: Push((float)0.8999999761581421)
0xee: Pop(1); Push(Stack[-9] * Stack[-1]);
0xef: @ GetVictim(Stack[-1], Stack[-4])
0xf0: Pop(1)
0xf1: @ ReportAttack(Stack[-0]T)
0xf2: Pop(0)
...
0xf6: Stack[-6] = Stack[-2]
0xf7: Stack[-10] = Stack[-1]
0xf8: Call 0x19

0xf9: Stack[-3] = Stack[-5]
0xfa: Pop(3)
0xfb: PushEmpty(float, object, float, int)
0xfc: Stack[-7] = Stack[-3]
0xfd: Stack[-6] = Stack[-2]
0xfe: PushEmpty(int, object, int)
0xff: Stack[-10] = Stack[-2]
0x100: Stack[-14] = Stack[-1]
0x101: Call 0x1c

0x102: Stack[-3] = Stack[-4]
0x103: Pop(3)
0x104: Call 0x34a

0x105: Stack[-4] = Stack[-5]
0x106: Pop(4)
0x107: PushEmpty(int)
0x108: Call 0x202

0x109: Pop(0)
0x10a: @ ReportHit(Stack[-0]T, Stack[-1], Stack[-2], Stack[-3])
0x10b: Pop(1)
0x10c: PushEmpty(object, float)
0x10d: Stack[-5] = Stack[-2]
...
0x114: @ irand(Stack[-2], Stack[-1]T)
0x115: Pop(0)
0x116: Push((int) 1)
0x117: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x118: @ Face(Stack[-0]T)
0x119: Pop(0)
0x11a: Push((bool) 1)
0x11b: @ SetAttackState(Stack[-1])
0x11c: Pop(1)
0x11d: Push("all") // @poff=14
0x11e: Push("attack_begin") // @poff=22
...
0x132: Stack[-7] = Stack[-2]
0x133: Stack[-4] = Stack[-1]
0x134: Call 0xec

0x135: Pop(2)
0x136: Push("all") // @poff=14
0x137: Push("attack_middle") // @poff=210
...
0x13d: Push("all") // @poff=14
0x13e: Push("attack_middle") // @poff=210
...
0x155: Pop(1)
0x156: Push("all") // @poff=14
0x157: Push("attack_end") // @poff=238
...
0x18f: @@@ GetPFPosition(Stack[-4]); Obj=0 // @poff=118
0x190: Pop(0)
...
0x1c6: Pop(0)
0x1c7: Push("all") // @poff=14
0x1c8: Push("bjump") // @poff=260
0x1c9: @ PlayAnimation(Stack[-2], Stack[-1])
0x1ca: Pop(2)
0x1cb: @@@ GetPFPosition(Stack[-2]); Obj=0 // @poff=118
0x1cc: Pop(0)
...
0x1f5: @ irand(Stack[-1], Stack[-2]T)
0x1f6: Pop(0)
0x1f7: Push((int) 1)
0x1f8: Stack[-2] = Stack[-2] + Stack[-1]; Pop(1);
0x1f9: Push("attack") // @poff=48
...
0x20d: Stack[-17] = Stack[-7]
0x20e: PushEmpty(bool, object)
0x20f: Stack[-23] = Stack[-1]
0x210: Call 0x296
...
0x216: @@ GetPosition(Stack[-5]); Obj=21 // @poff=308
0x217: Pop(0)
...
0x22d: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=118
0x22e: Pop(0)
...
0x23f: Push((int) 0)
0x240: Push((float)0.30000001192092896)
...
0x262: Push((int) 0)
0x263: Push((float)0.30000001192092896)
...
0x29a: Stack[-2] = Stack[-4]
0x29b: Pop(2)
0x29c: Return(); Pop(0)

0x29d: Stack[-1] = "walk" // @poff=320
0x29e: Return(); Pop(0)

0x29f: Stack[-1] = "run" // @poff=330
0x2a0: Return(); Pop(0)

0x2a1: PushEmpty()
0x2a2: PushEmpty(bool, string, string)
0x2a3: Stack[-2] = "quest_d5_01" // @poff=338
0x2a4: Stack[-1] = "dead" // @poff=362
0x2a5: Call 0x431
...
0x2c4: Pop(0); PushNull((bool) Stack[-21] == 0)
0x2c5: IF (Stack[-1] == 0) GOTO 0x2cb; Pop(1)

0x2c6: PushEmpty(string)
0x2c7: Stack[-1] = "fdie" // @poff=372
0x2c8: Call 0x31a

0x2c9: Pop(1)
0x2ca: GOTO 0x319

0x2cb: @@ GetPosition(Stack[-10]); Obj=21 // @poff=308
0x2cc: Pop(0)
...
0x2dc: Stack[-6] = "fdie" // @poff=372
0x2dd: GOTO 0x2df

0x2de: Stack[-6] = "bdie" // @poff=382
...
0x2e5: @ StopAsync()
0x2e6: Pop(0)
0x2e7: Stack[-21] = Stack[-5]
0x2e8: Push("GetScriptProperty") // @poff=392
0x2e9: Push((int) 2)
0x2ea: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2eb: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2ec: Push("Owner") // @poff=428
0x2ed: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=440
0x2ee: Pop(1)
0x2ef: Push(Stack[-4])
0x2f0: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f1: Push("Owner") // @poff=428
0x2f2: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=458
0x2f3: Pop(1)
0x2f4: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2f5: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f6: Stack[-21] = Stack[-5]
0x2f7: Push("@GetEyesHeight") // @poff=476
0x2f8: Push((int) 1)
0x2f9: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2fa: IF (Stack[-1] == 0) GOTO 0x306; Pop(1)

0x2fb: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=506
0x2fc: Pop(0)
...
0x33a: Stack[-2] = "fire" // @poff=530
0x33b: Return(); Pop(0)

0x33c: Stack[-2] = "phys" // @poff=540
0x33d: Return(); Pop(0)

0x33e: PushEmpty(bool, bool)
0x33f: Push("HasProperty") // @poff=550
0x340: Push((int) 2)
...
0x346: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=574
0x347: Pop(0)
...
0x34c: Stack[-18] = Stack[-2]
0x34d: Stack[-1] = "health" // @poff=586
0x34e: Call 0x33e
...
0x355: Stack[-18] = Stack[-2]
0x356: Stack[-1] = "armor" // @poff=600
0x357: Call 0x33e
...
0x35d: Push("armor") // @poff=600
0x35e: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=612
0x35f: Pop(1)
0x360: Push("armor_") // @poff=624
...
0x367: Stack[-18] = Stack[-2]
0x368: Stack[-8] = Stack[-1]
0x369: Call 0x33e
...
0x36f: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=612
0x370: Pop(0)
...
0x377: Stack[-3] = Stack[-6]
0x378: Pop(3)
0x379: Push("health") // @poff=586
0x37a: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=612
0x37b: Pop(1)
0x37c: Push((int) 1)
0x37d: Pop(1); Push(Stack[-1] - Stack[-4]);
0x37e: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x37f: Push("health") // @poff=586
...
0x385: Pop(3)
0x386: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=638
0x387: Pop(2)
0x388: Stack[-1] = Stack[-16]
0x389: Return(); Pop(12)

0x38a: PushEmpty(bool, bool)
0x38b: @@ IsDead(Stack[-1]); Obj=3 // @poff=650
0x38c: Pop(0)
0x38d: Stack[-1] = Stack[-4]
0x38e: Return(); Pop(2)

0x38f: PushEmpty(object, object, object, object)
0x390: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3a4: Pop(0)
0x3a5: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3a6: IF (Stack[-1] == 0) GOTO 0x3a9; Pop(1)

0x3a7: Stack[-6] = (bool) 0
0x3a8: Return(); Pop(4)

0x3a9: @@ GetScene(Stack[-1]); Obj=5 // @poff=671
0x3aa: Pop(0)
...
0x3bd: Stack[-6] = Stack[-2]
0x3be: Stack[-1] = "noaccess" // @poff=680
0x3bf: Call 0x33e
...
0x3c5: Push("noaccess") // @poff=680
0x3c6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=612
0x3c7: Pop(1)
0x3c8: Push((int) 0)
...
0x3f1: @@ GetPosition(Stack[-5]); Obj=23 // @poff=308
0x3f2: Pop(0)
...
0x402: Stack[-1] = "fhit" // @poff=736
0x403: GOTO 0x405

0x404: Stack[-1] = "bhit" // @poff=746
0x405: Push("hit_react") // @poff=756
0x406: Push("1") // @poff=358
0x407: Pop(1); Push(Stack[-3] + Stack[-1]);
0x408: Push("2") // @poff=776
...
0x40f: @@ GetPosition(Stack[-3]); Obj=7 // @poff=308
0x410: Pop(0)
