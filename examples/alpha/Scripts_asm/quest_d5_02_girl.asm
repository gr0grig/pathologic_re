...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0xb0: Stack[-1] = "Neutral" // @poff=61
0xb1: Call 0x79

0xb2: Pop(1)
0xb3: Push((int) 11988)
0xb4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xb5: Pop(1)
0xb6: @@@ ClearReplies(); Obj=0 // @poff=88
0xb7: Pop(0)
0xb8: Push((int) 11989)
0xb9: Push((int) 13205)
0xba: Push((int) 13204)
0xbb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xbc: Pop(3)
0xbd: Return(); Pop(0)
...
0xd0: Push((int) 13207)
0xd1: Push((int) 13219)
0xd2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xd3: Pop(3)
0xd4: Return(); Pop(0)
...
0xd9: Stack[-1] = "Neutral" // @poff=61
0xda: Call 0x79

0xdb: Pop(1)
0xdc: Push((int) 11992)
0xdd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xde: Pop(1)
0xdf: @@@ ClearReplies(); Obj=0 // @poff=88
0xe0: Pop(0)
0xe1: Push((int) 11993)
0xe2: Push((int) 13209)
0xe3: Push((int) 13208)
...
0xe7: Push((int) 13209)
0xe8: Push((int) 13221)
0xe9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xea: Pop(3)
0xeb: Return(); Pop(0)
...
0xf0: Stack[-1] = "Neutral" // @poff=61
0xf1: Call 0x79

0xf2: Pop(1)
0xf3: Push((int) 11994)
0xf4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xf5: Pop(1)
0xf6: @@@ ClearReplies(); Obj=0 // @poff=88
0xf7: Pop(0)
0xf8: Push((int) 11995)
0xf9: Push((int) 13211)
0xfa: Push((int) 13210)
...
0x107: Stack[-1] = "Neutral" // @poff=61
0x108: Call 0x79

0x109: Pop(1)
0x10a: Push((int) 11996)
0x10b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x10c: Pop(1)
0x10d: @@@ ClearReplies(); Obj=0 // @poff=88
0x10e: Pop(0)
...
0x119: Stack[-1] = "Neutral" // @poff=61
0x11a: Call 0x79

0x11b: Pop(1)
0x11c: Push((int) 11998)
0x11d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x11e: Pop(1)
0x11f: @@@ ClearReplies(); Obj=0 // @poff=88
0x120: Pop(0)
0x121: Push((int) 12001)
0x122: Push((int) 13217)
0x123: Push((int) 13216)
0x124: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x125: Pop(3)
...
0x18b: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x18c: Pop(0)
0x18d: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x18e: Pop(0)
...
0x1ce: Pop(0)
0x1cf: Push("start: ") // @poff=204
0x1d0: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1d1: @ Trace(Stack[-1])
0x1d2: Pop(1)
0x1d3: Push("end: ") // @poff=220
...
0x1e8: Push((float)9.999999974752427e-07)
...
0x20d: Pop(1)
0x20e: Push("d5q02NudeMeeting") // @poff=244
0x20f: Push("pt_d5q01_girl_corpse1") // @poff=278
0x210: Push((int) 0)
...
0x214: Pop(0)
0x215: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=322
0x216: Pop(5)
0x217: PushEmpty()
0x218: Call 0x279
...
0x21b: Stack[-2] = "quest_d5_02" // @poff=330
0x21c: Stack[-1] = "remove_girl" // @poff=354
0x21d: Call 0x1f4
...
0x232: Push("Can't retrieve diary root") // @poff=378
0x233: @ Trace(Stack[-1])
0x234: Pop(1)
...
0x23e: Pop(1)
0x23f: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=430
0x240: Pop(0)
0x241: Pop(0); Push((bool) Stack[-2] == 0)
0x242: IF (Stack[-1] == 0) GOTO 0x249; Pop(1)

0x243: Push("Can't find diary parent with id: ") // @poff=435
...
0x249: @@ AddChild(Stack[-8]); Obj=2 // @poff=503
0x24a: Pop(0)
0x24b: Push("player_diary") // @poff=512
0x24c: Push((int) 1)
0x24d: @ SetVariable(Stack[-2], Stack[-1])
0x24e: Pop(2)
0x24f: @@ GetCategory(Stack[-1]); Obj=8 // @poff=538
0x250: Pop(0)
...
0x259: Pop(0)
0x25a: Pop(0); PushNull((bool) Stack[-2] == 0)
0x25b: IF (Stack[-1] == 0) GOTO 0x262; Pop(1)

0x25c: Push("Can't find main outdoor scene") // @poff=550
0x25d: @ Trace(Stack[-1])
0x25e: Pop(1)
0x25f: Stack[-1] = 0
...
0x262: @@ GetMap(Stack[-1]); Obj=2 // @poff=610
0x263: Pop(0)
...
0x27a: Push("Adding diary entry") // @poff=631
0x27b: @ Trace(Stack[-1])
0x27c: Pop(1)
0x27d: Push((int) 152)
0x27e: Push((int) 2)
...
0x28b: Stack[-1] = "ui/NPC_Black.png" // @poff=669
0x28c: Return(); Pop(0)
