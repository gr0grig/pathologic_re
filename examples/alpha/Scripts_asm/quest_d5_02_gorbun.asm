...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x54: Stack[-1] = "Neutral" // @poff=61
0x55: Call 0xcb

0x56: Pop(1)
0x57: Push((int) 11917)
0x58: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x59: Pop(1)
0x5a: @@@ ClearReplies(); Obj=0 // @poff=88
0x5b: Pop(0)
0x5c: Push((int) 11918)
0x5d: Push((int) 13135)
0x5e: Push((int) 13134)
0x5f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x60: Pop(3)
0x61: GOTO 0xad

0x62: PushEmpty(string)
0x63: Stack[-1] = "Neutral" // @poff=61
0x64: Call 0xcb

0x65: Pop(1)
0x66: Push((int) 11935)
0x67: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x68: Pop(1)
0x69: @@@ ClearReplies(); Obj=0 // @poff=88
0x6a: Pop(0)
...
0x71: Push((int) 13660)
0x72: Push((int) 13658)
0x73: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x74: Pop(3)
0x75: PushEmpty(bool)
0x76: Stack[-1] = (bool) 0
0x77: PushEmpty(bool)
...
0xa1: Push((int) 13156)
0xa2: Push((int) 13154)
0xa3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xa4: Pop(3)
0xa5: Push((int) 12490)
0xa6: Push((int) -1)
0xa7: Push((int) 13659)
0xa8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xa9: Pop(3)
0xaa: GOTO 0xad
...
0xbc: Push("all") // @poff=110
0xbd: Push("idle") // @poff=118
...
0xc5: Push("all") // @poff=110
0xc6: Push("idle") // @poff=118
...
0x143: Stack[-1] = "Neutral" // @poff=61
0x144: Call 0xcb

0x145: Pop(1)
0x146: Push((int) 11917)
0x147: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x148: Pop(1)
0x149: @@@ ClearReplies(); Obj=0 // @poff=88
0x14a: Pop(0)
...
0x197: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x198: Pop(3)
0x199: Return(); Pop(0)
...
0x19e: Stack[-1] = "Neutral" // @poff=61
0x19f: Call 0xcb

0x1a0: Pop(1)
0x1a1: Push((int) 11939)
0x1a2: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1a3: Pop(1)
0x1a4: @@@ ClearReplies(); Obj=0 // @poff=88
0x1a5: Pop(0)
...
0x1d4: Stack[-1] = "Neutral" // @poff=61
0x1d5: Call 0xcb

0x1d6: Pop(1)
0x1d7: Push((int) 11954)
0x1d8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1d9: Pop(1)
0x1da: @@@ ClearReplies(); Obj=0 // @poff=88
0x1db: Pop(0)
...
0x215: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x216: Pop(3)
0x217: Return(); Pop(0)
...
0x21c: Stack[-1] = "Neutral" // @poff=61
0x21d: Call 0xcb

0x21e: Pop(1)
0x21f: Push((int) 11945)
0x220: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x221: Pop(1)
0x222: @@@ ClearReplies(); Obj=0 // @poff=88
0x223: Pop(0)
...
0x22e: Stack[-1] = "Neutral" // @poff=61
0x22f: Call 0xcb

0x230: Pop(1)
0x231: Push((int) 11952)
0x232: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x233: Pop(1)
0x234: @@@ ClearReplies(); Obj=0 // @poff=88
0x235: Pop(0)
...
0x252: Stack[-1] = "Neutral" // @poff=61
0x253: Call 0xcb

0x254: Pop(1)
0x255: Push((int) 11919)
0x256: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x257: Pop(1)
0x258: @@@ ClearReplies(); Obj=0 // @poff=88
0x259: Pop(0)
0x25a: Push((int) 11920)
0x25b: Push((int) 13137)
0x25c: Push((int) 13136)
0x25d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x25e: Pop(3)
0x25f: Return(); Pop(0)
...
0x264: Stack[-1] = "Neutral" // @poff=61
0x265: Call 0xcb

0x266: Pop(1)
0x267: Push((int) 11921)
0x268: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x269: Pop(1)
0x26a: @@@ ClearReplies(); Obj=0 // @poff=88
0x26b: Pop(0)
0x26c: Push((int) 11924)
0x26d: Push((int) 13141)
0x26e: Push((int) 13140)
0x26f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x270: Pop(3)
0x271: Push((int) 11922)
0x272: Push((int) 13139)
0x273: Push((int) 13138)
0x274: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x275: Pop(3)
0x276: Return(); Pop(0)
...
0x27b: Stack[-1] = "Neutral" // @poff=61
0x27c: Call 0xcb

0x27d: Pop(1)
0x27e: Push((int) 11923)
0x27f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x280: Pop(1)
0x281: @@@ ClearReplies(); Obj=0 // @poff=88
0x282: Pop(0)
0x283: Push((int) 11929)
0x284: Push((int) 13141)
0x285: Push((int) 13145)
0x286: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x287: Pop(3)
0x288: Return(); Pop(0)
...
0x28d: Stack[-1] = "Neutral" // @poff=61
0x28e: Call 0xcb

0x28f: Pop(1)
0x290: Push((int) 11925)
0x291: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x292: Pop(1)
0x293: @@@ ClearReplies(); Obj=0 // @poff=88
0x294: Pop(0)
0x295: Push((int) 11926)
0x296: Push((int) 13143)
0x297: Push((int) 13142)
0x298: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x299: Pop(3)
...
0x2b6: Stack[-1] = "Neutral" // @poff=61
0x2b7: Call 0xcb

0x2b8: Pop(1)
0x2b9: Push((int) 11933)
0x2ba: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2bb: Pop(1)
0x2bc: @@@ ClearReplies(); Obj=0 // @poff=88
0x2bd: Pop(0)
0x2be: Push((int) 11934)
0x2bf: Push((int) -1)
0x2c0: Push((int) 13151)
0x2c1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2c2: Pop(3)
0x2c3: Return(); Pop(0)
...
0x2c8: Stack[-1] = "Neutral" // @poff=61
0x2c9: Call 0xcb

0x2ca: Pop(1)
0x2cb: Push((int) 11927)
0x2cc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2cd: Pop(1)
0x2ce: @@@ ClearReplies(); Obj=0 // @poff=88
0x2cf: Pop(0)
0x2d0: Push((int) 11928)
0x2d1: Push((int) -1)
0x2d2: Push((int) 13144)
0x2d3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2d4: Pop(3)
0x2d5: Return(); Pop(0)
...
0x31e: @@ GetProperty(Stack[-4], Stack[-1]); Obj=5 // @poff=160
0x31f: Pop(0)
0x320: Pop(0); Push(Stack[-1] + Stack[-3]);
0x321: @@ SetProperty(Stack[-5], Stack[-1]); Obj=6 // @poff=172
0x322: Pop(1)
0x323: Return(); Pop(2)
...
0x325: @@ GetPosition(Stack[-7]); Obj=17 // @poff=184
0x326: Pop(0)
0x327: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=196
0x328: Pop(0)
...
0x368: Pop(0)
0x369: Push("start: ") // @poff=228
0x36a: Pop(1); Push(Stack[-1] + Stack[-3]);
0x36b: @ Trace(Stack[-1])
0x36c: Pop(1)
0x36d: Push("end: ") // @poff=244
...
0x393: PushEmpty()
0x394: Push("money10000 is given") // @poff=256
0x395: @ Trace(Stack[-1])
0x396: Pop(1)
0x397: PushEmpty(object, string, int)
0x398: Stack[-5] = Stack[-3]
0x399: Stack[-2] = "money" // @poff=296
...
0x39e: PushEmpty()
0x39f: Push("playsound") // @poff=308
0x3a0: Push("givemoney") // @poff=328
0x3a1: @ TriggerWorld(Stack[-2], Stack[-1])
0x3a2: Pop(2)
0x3a3: Return(); Pop(0)

0x3a4: PushEmpty(object, object)
0x3a5: Push("d5q02") // @poff=348
0x3a6: Push((int) 2)
...
0x3ac: Pop(1)
0x3ad: Push("d5q02GorbunFindTheDaughter") // @poff=360
0x3ae: Push("pt_map_gorbun") // @poff=414
0x3af: Push((int) 0)
...
0x3b3: Pop(0)
0x3b4: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=442
0x3b5: Pop(5)
0x3b6: PushEmpty()
0x3b7: Call 0x49e
...
0x3ba: Stack[-1] = 0
0x3bb: PushEmpty()
0x3bc: Push("ood5Gorbun1") // @poff=450
0x3bd: Push((int) 1)
...
0x3c9: Pop(1)
0x3ca: Push("d5q02AnnaGotoGorbun") // @poff=474
0x3cb: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=514
0x3cc: Pop(1)
0x3cd: Push(Stack[-1])
0x3ce: IF (Stack[-1] == 0) GOTO 0x3d1; Pop(1)

0x3cf: @@ Remove(); Obj=1 // @poff=523
0x3d0: Pop(0)
0x3d1: Push("d5q02AnnaGotoGorbunSelf") // @poff=530
0x3d2: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=514
0x3d3: Pop(1)
0x3d4: Push(Stack[-1])
0x3d5: IF (Stack[-1] == 0) GOTO 0x3d8; Pop(1)

0x3d6: @@ Remove(); Obj=1 // @poff=523
0x3d7: Pop(0)
0x3d8: Push("d5q02AnnaGotoKabak") // @poff=578
0x3d9: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=514
0x3da: Pop(1)
0x3db: Push(Stack[-1])
0x3dc: IF (Stack[-1] == 0) GOTO 0x3df; Pop(1)

0x3dd: @@ Remove(); Obj=1 // @poff=523
0x3de: Pop(0)
0x3df: Push("d5q02GorbunFindTheDaughter") // @poff=360
0x3e0: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=514
0x3e1: Pop(1)
0x3e2: Push(Stack[-1])
0x3e3: IF (Stack[-1] == 0) GOTO 0x3e6; Pop(1)

0x3e4: @@ Remove(); Obj=1 // @poff=523
0x3e5: Pop(0)
0x3e6: Push("d5q02NudeMeeting") // @poff=616
0x3e7: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=514
0x3e8: Pop(1)
0x3e9: Push(Stack[-1])
0x3ea: IF (Stack[-1] == 0) GOTO 0x3ed; Pop(1)

0x3eb: @@ Remove(); Obj=1 // @poff=523
0x3ec: Pop(0)
0x3ed: PushEmpty()
0x3ee: Call 0x4ae
...
0x3f2: Stack[-2] = 0
0x3f3: PushEmpty()
0x3f4: Push("ood5Gorbun2") // @poff=650
0x3f5: Push((int) 1)
...
0x3f9: PushEmpty()
0x3fa: Push("ood5Gorbun3") // @poff=674
0x3fb: Push((int) 1)
...
0x3ff: PushEmpty()
0x400: Push("money 50000 is given") // @poff=698
0x401: @ Trace(Stack[-1])
0x402: Pop(1)
0x403: PushEmpty(object, string, int)
0x404: Stack[-5] = Stack[-3]
0x405: Stack[-2] = "money" // @poff=296
...
0x418: Stack[-1] = "ood5Gorbun1" // @poff=450
0x419: Call 0x389
...
0x430: Stack[-1] = "d5q02KnowNudeIsDead" // @poff=740
0x431: Call 0x389
...
0x43c: Stack[-1] = "ood5Gorbun2" // @poff=650
0x43d: Call 0x389
...
0x448: Stack[-1] = "ood5Gorbun3" // @poff=674
0x449: Call 0x389
...
0x457: Push("Can't retrieve diary root") // @poff=780
0x458: @ Trace(Stack[-1])
0x459: Pop(1)
0x45a: Stack[-3] = (bool) 0
0x45b: Return(); Pop(2)

0x45c: Stack[-1] = Stack[-3]
0x45d: Return(); Pop(2)
...
0x463: Pop(1)
0x464: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=832
0x465: Pop(0)
0x466: Pop(0); Push((bool) Stack[-2] == 0)
0x467: IF (Stack[-1] == 0) GOTO 0x46e; Pop(1)

0x468: Push("Can't find diary parent with id: ") // @poff=837
...
0x46e: @@ AddChild(Stack[-8]); Obj=2 // @poff=905
0x46f: Pop(0)
0x470: Push("player_diary") // @poff=914
0x471: Push((int) 1)
0x472: @ SetVariable(Stack[-2], Stack[-1])
0x473: Pop(2)
0x474: @@ GetCategory(Stack[-1]); Obj=8 // @poff=940
0x475: Pop(0)
...
0x47e: Pop(0)
0x47f: Pop(0); PushNull((bool) Stack[-2] == 0)
0x480: IF (Stack[-1] == 0) GOTO 0x487; Pop(1)

0x481: Push("Can't find main outdoor scene") // @poff=952
0x482: @ Trace(Stack[-1])
0x483: Pop(1)
0x484: Stack[-1] = 0
...
0x487: @@ GetMap(Stack[-1]); Obj=2 // @poff=1012
0x488: Pop(0)
...
0x49f: Push("Adding diary entry") // @poff=1033
0x4a0: @ Trace(Stack[-1])
0x4a1: Pop(1)
0x4a2: Push((int) 150)
0x4a3: Push((int) 2)
...
0x4af: Push("Adding diary entry") // @poff=1033
0x4b0: @ Trace(Stack[-1])
0x4b1: Pop(1)
0x4b2: Push((int) 153)
0x4b3: Push((int) 2)
...
0x4c0: Stack[-1] = "ui/NPC_Black.png" // @poff=1071
0x4c1: Return(); Pop(0)
