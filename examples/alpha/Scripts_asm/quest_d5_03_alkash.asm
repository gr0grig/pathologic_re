...
Strings:
	...
	W:player
	W:ui/NPC_None.png
// @pool_raw:
// @pool_encoding:utf8
...
0xd0: Stack[-1] = "Neutral" // @poff=61
0xd1: Call 0x8d

0xd2: Pop(1)
0xd3: Push((int) 12549)
0xd4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xd5: Pop(1)
0xd6: @@@ ClearReplies(); Obj=0 // @poff=88
0xd7: Pop(0)
0xd8: Push((int) 12550)
0xd9: Push((int) -1)
0xda: Push((int) 13719)
0xdb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xdc: Pop(3)
0xdd: Return(); Pop(0)
...
0xe2: Stack[-1] = "Neutral" // @poff=61
0xe3: Call 0x8d

0xe4: Pop(1)
0xe5: Push((int) 11809)
0xe6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe7: Pop(1)
0xe8: @@@ ClearReplies(); Obj=0 // @poff=88
0xe9: Pop(0)
0xea: Push((int) 11810)
0xeb: Push((int) 13015)
0xec: Push((int) 13020)
...
0x1b9: @@ GetPosition(Stack[-7]); Obj=17 // @poff=144
0x1ba: Pop(0)
0x1bb: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=156
0x1bc: Pop(0)
...
0x1fc: Pop(0)
0x1fd: Push("start: ") // @poff=188
0x1fe: Pop(1); Push(Stack[-1] + Stack[-3]);
0x1ff: @ Trace(Stack[-1])
0x200: Pop(1)
0x201: Push("end: ") // @poff=204
...
0x216: Push((float)9.999999974752427e-07)
...
0x23a: PushEmpty()
0x23b: Push("ood5Prisoner1") // @poff=216
0x23c: Push((int) 1)
...
0x242: Stack[-1] = "ood5Prisoner1" // @poff=216
0x243: Call 0x21d
...
0x25d: Stack[-1] = (int) 3342
0x25e: Return(); Pop(0)

0x25f: Stack[-1] = "ui/NPC_None.png" // @poff=258
0x260: Return(); Pop(0)
