...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x4b: Stack[-1] = "Neutral" // @poff=61
0x4c: Call 0xb9

0x4d: Pop(1)
0x4e: Push((int) 12551)
0x4f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x50: Pop(1)
0x51: @@@ ClearReplies(); Obj=0 // @poff=88
0x52: Pop(0)
0x53: Push((int) 12552)
0x54: Push((int) 13722)
0x55: Push((int) 13721)
...
0x5a: Stack[-1] = "Neutral" // @poff=61
0x5b: Call 0xb9

0x5c: Pop(1)
0x5d: Push((int) 12562)
0x5e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x5f: Pop(1)
0x60: @@@ ClearReplies(); Obj=0 // @poff=88
0x61: Pop(0)
0x62: PushEmpty(bool)
0x63: Stack[-1] = (bool) 0
...
0x10c: Stack[-1] = "Neutral" // @poff=61
0x10d: Call 0xb9

0x10e: Pop(1)
0x10f: Push((int) 12551)
0x110: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x111: Pop(1)
0x112: @@@ ClearReplies(); Obj=0 // @poff=88
0x113: Pop(0)
...
0x11b: Stack[-1] = "Neutral" // @poff=61
0x11c: Call 0xb9

0x11d: Pop(1)
0x11e: Push((int) 12562)
0x11f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x120: Pop(1)
0x121: @@@ ClearReplies(); Obj=0 // @poff=88
0x122: Pop(0)
...
0x157: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x158: Pop(3)
0x159: Return(); Pop(0)
...
0x15e: Stack[-1] = "Neutral" // @poff=61
0x15f: Call 0xb9

0x160: Pop(1)
0x161: Push((int) 12568)
0x162: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x163: Pop(1)
0x164: @@@ ClearReplies(); Obj=0 // @poff=88
0x165: Pop(0)
0x166: Push((int) 12609)
0x167: Push((int) 13785)
0x168: Push((int) 13784)
0x169: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x16a: Pop(3)
0x16b: Return(); Pop(0)
...
0x170: Stack[-1] = "Neutral" // @poff=61
0x171: Call 0xb9

0x172: Pop(1)
0x173: Push((int) 12610)
0x174: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x175: Pop(1)
0x176: @@@ ClearReplies(); Obj=0 // @poff=88
0x177: Pop(0)
...
0x194: Stack[-1] = "Neutral" // @poff=61
0x195: Call 0xb9

0x196: Pop(1)
0x197: Push((int) 12553)
0x198: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x199: Pop(1)
0x19a: @@@ ClearReplies(); Obj=0 // @poff=88
0x19b: Pop(0)
0x19c: Push((int) 12554)
0x19d: Push((int) 13724)
0x19e: Push((int) 13723)
0x19f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1a0: Pop(3)
...
0x1ab: Stack[-1] = "Neutral" // @poff=61
0x1ac: Call 0xb9

0x1ad: Pop(1)
0x1ae: Push((int) 12605)
0x1af: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1b0: Pop(1)
0x1b1: @@@ ClearReplies(); Obj=0 // @poff=88
0x1b2: Pop(0)
...
0x216: Stack[-2] = "quest_d5_03" // @poff=128
0x217: Stack[-1] = "completed" // @poff=152
0x218: Call 0x2b7
...
0x24e: @@ GetPosition(Stack[-7]); Obj=17 // @poff=204
0x24f: Pop(0)
0x250: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=216
0x251: Pop(0)
...
0x291: Pop(0)
0x292: Push("start: ") // @poff=248
0x293: Pop(1); Push(Stack[-1] + Stack[-3]);
0x294: @ Trace(Stack[-1])
0x295: Pop(1)
0x296: Push("end: ") // @poff=264
...
0x2ab: Push((float)9.999999974752427e-07)
...
0x2c8: PushEmpty()
0x2c9: Push("playsound") // @poff=276
0x2ca: Push("givemoney") // @poff=296
0x2cb: @ TriggerWorld(Stack[-2], Stack[-1])
0x2cc: Pop(2)
0x2cd: Return(); Pop(0)

0x2ce: PushEmpty()
0x2cf: Push("ood5Birdmask1") // @poff=316
0x2d0: Push((int) 1)
...
0x2d5: Push("money") // @poff=304
0x2d6: @@ GetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=344
0x2d7: Pop(1)
...
0x2dd: Stack[-1] = (int) 0
0x2de: Push("money") // @poff=304
0x2df: @@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=356
0x2e0: Pop(1)
0x2e1: Push("money 50000 removed") // @poff=368
0x2e2: @ Trace(Stack[-1])
0x2e3: Pop(1)
0x2e4: Return(); Pop(2)
...
0x2e9: Pop(1)
0x2ea: Push("d5q03BirdmaskBringMoneySelf") // @poff=408
0x2eb: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x2ec: Pop(1)
0x2ed: Push(Stack[-1])
0x2ee: IF (Stack[-1] == 0) GOTO 0x2f1; Pop(1)

0x2ef: @@ Remove(); Obj=1 // @poff=473
0x2f0: Pop(0)
0x2f1: Push("d5q03BirdmaskGotoMladVlad") // @poff=480
0x2f2: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x2f3: Pop(1)
0x2f4: Push(Stack[-1])
0x2f5: IF (Stack[-1] == 0) GOTO 0x2f8; Pop(1)

0x2f6: @@ Remove(); Obj=1 // @poff=473
0x2f7: Pop(0)
0x2f8: Push("d5q03BirdmaskGotoViktor") // @poff=532
0x2f9: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x2fa: Pop(1)
0x2fb: Push(Stack[-1])
0x2fc: IF (Stack[-1] == 0) GOTO 0x2ff; Pop(1)

0x2fd: @@ Remove(); Obj=1 // @poff=473
0x2fe: Pop(0)
0x2ff: Push("d5q03MladVladSavePrisonersSelf") // @poff=580
0x300: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x301: Pop(1)
0x302: Push(Stack[-1])
0x303: IF (Stack[-1] == 0) GOTO 0x306; Pop(1)

0x304: @@ Remove(); Obj=1 // @poff=473
0x305: Pop(0)
0x306: Push("d5q03SavePrisoners") // @poff=642
0x307: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x308: Pop(1)
0x309: Push(Stack[-1])
0x30a: IF (Stack[-1] == 0) GOTO 0x30d; Pop(1)

0x30b: @@ Remove(); Obj=1 // @poff=473
0x30c: Pop(0)
0x30d: Push("d5q03ViktorSavePrisonersSelf") // @poff=680
0x30e: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=464
0x30f: Pop(1)
0x310: Push(Stack[-1])
0x311: IF (Stack[-1] == 0) GOTO 0x314; Pop(1)

0x312: @@ Remove(); Obj=1 // @poff=473
0x313: Pop(0)
0x314: PushEmpty()
0x315: Call 0x3f3
...
0x316: Pop(0)
0x317: Push((int) 1)
0x318: @@ SetReturnValue(Stack[-1]); Obj=6 // @poff=738
0x319: Pop(1)
0x31a: Return(); Pop(4)
...
0x325: Pop(1)
0x326: Push("d5q03BirdmaskBringMoneySelf") // @poff=408
0x327: Push("pt_map_uprava_prison") // @poff=765
0x328: Push((int) 0)
...
0x32c: Pop(0)
0x32d: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=807
0x32e: Pop(5)
0x32f: Push("d5q03BirdmaskGotoMladVlad") // @poff=480
0x330: Push("pt_map_mladvlad") // @poff=815
0x331: Push((int) 0)
...
0x335: Pop(0)
0x336: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=807
0x337: Pop(5)
0x338: Push("d5q03BirdmaskGotoViktor") // @poff=532
0x339: Push("pt_map_viktor") // @poff=847
0x33a: Push((int) 0)
...
0x33e: Pop(0)
0x33f: @@ AddMark(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=807
0x340: Pop(5)
0x341: PushEmpty()
0x342: Call 0x3e3
...
0x352: Stack[-1] = "ood5Birdmask1" // @poff=316
0x353: Call 0x2b2
...
0x38d: Push("money") // @poff=304
0x38e: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=344
0x38f: Pop(1)
...
0x39c: Push("Can't retrieve diary root") // @poff=875
0x39d: @ Trace(Stack[-1])
0x39e: Pop(1)
...
0x3a8: Pop(1)
0x3a9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=927
0x3aa: Pop(0)
0x3ab: Pop(0); Push((bool) Stack[-2] == 0)
0x3ac: IF (Stack[-1] == 0) GOTO 0x3b3; Pop(1)

0x3ad: Push("Can't find diary parent with id: ") // @poff=932
...
0x3b3: @@ AddChild(Stack[-8]); Obj=2 // @poff=1000
0x3b4: Pop(0)
0x3b5: Push("player_diary") // @poff=1009
0x3b6: Push((int) 1)
0x3b7: @ SetVariable(Stack[-2], Stack[-1])
0x3b8: Pop(2)
0x3b9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1035
0x3ba: Pop(0)
...
0x3c3: Pop(0)
0x3c4: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3c5: IF (Stack[-1] == 0) GOTO 0x3cc; Pop(1)

0x3c6: Push("Can't find main outdoor scene") // @poff=1047
0x3c7: @ Trace(Stack[-1])
0x3c8: Pop(1)
0x3c9: Stack[-1] = 0
0x3ca: Stack[-1] = Stack[-5]
0x3cb: Return(); Pop(4)

0x3cc: @@ GetMap(Stack[-1]); Obj=2 // @poff=1107
0x3cd: Pop(0)
0x3ce: Stack[-1] = Stack[-5]
0x3cf: Return(); Pop(4)

0x3d0: Stack[-1] = 0
0x3d1: Stack[-2] = 0
0x3d2: PushEmpty(int, int)
0x3d3: Push("player") // @poff=1114
...
0x3e4: Push("Adding diary entry") // @poff=1128
0x3e5: @ Trace(Stack[-1])
0x3e6: Pop(1)
0x3e7: Push((int) 156)
0x3e8: Push((int) 2)
...
0x3f4: Push("Adding diary entry") // @poff=1128
0x3f5: @ Trace(Stack[-1])
0x3f6: Pop(1)
0x3f7: Push((int) 157)
0x3f8: Push((int) 2)
...
0x405: Stack[-1] = "ui/NPC_Black.png" // @poff=1166
0x406: Return(); Pop(0)
