...
Strings:
	...
	W:ui/NPC_Klara.png
// @pool_raw:
// @pool_encoding:utf8
...
0xe: Pop(0)
0xf: @@ SetNPCName(Stack[-1]); Obj=5 // @poff=0
0x10: Pop(1)
0x11: PushEmpty(string)
0x12: Call 0x6e0

0x13: Pop(0)
0x14: @@ SetPhoto(Stack[-1]); Obj=5 // @poff=11
0x15: Pop(1)
0x16: PushEmpty(int)
0x17: Call 0x6bd

0x18: Pop(0)
0x19: @@ SetPlayerName(Stack[-1]); Obj=5 // @poff=20
0x1a: Pop(1)
0x1b: Stack[-2] = (int) -1
...
0x25: Stack[-11] = Stack[-2]
0x26: Stack[-6] = Stack[-1]
0x27: Push(-2, 4); TaskCall(1)
0x28: Call 0x3f

0x29: Pop(-2, 4); TaskReturn
0x2a: Pop(2)
0x2b: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=34
0x2c: Pop(0)
...
0x2f: @ sync()
0x30: Pop(0)
0x31: @@ IsDialogEnd(Stack[-1]); Obj=4 // @poff=34
0x32: Pop(0)
0x33: GOTO 0x2d

0x34: PushEmpty(object)
0x35: Stack[-10] = Stack[-1]
0x36: Call 0x4ec

0x37: Pop(1)
0x38: @ StopDialog(Stack[-4])
0x39: Pop(0)
0x3a: @@ GetReturnValue(Stack[-2]); Obj=4 // @poff=46
0x3b: Pop(0)
0x3c: Stack[-2] = Stack[-10]
0x3d: Return(); Pop(8)
...
0x53: Stack[-1] = (bool) 1
0x54: IF (Stack[-1] == 1) GOTO 0x64; Pop(1)
...
0x61: Stack[-1] = (bool) 1
0x62: IF (Stack[-1] == 1) GOTO 0x64; Pop(1)
...
0x6b: Stack[-1] = "Neutral" // @poff=61
0x6c: Call 0xf1

0x6d: Pop(1)
0x6e: Push((int) 12737)
0x6f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x70: Pop(1)
0x71: @@@ ClearReplies(); Obj=0 // @poff=88
0x72: Pop(0)
0x73: Push((int) 12738)
0x74: Push((int) 13933)
0x75: Push((int) 13932)
0x76: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x77: Pop(3)
0x78: Push((int) 12744)
0x79: Push((int) 13965)
0x7a: Push((int) 13938)
0x7b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7c: Pop(3)
0x7d: Push((int) 12745)
0x7e: Push((int) 13954)
0x7f: Push((int) 13939)
0x80: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x81: Pop(3)
0x82: GOTO 0xd3
...
0x88: Pop(1)
0x89: IF (Stack[-1] == 1) GOTO 0x90; Pop(1)
...
0x8d: Pop(1)
0x8e: IF (Stack[-1] == 1) GOTO 0x90; Pop(1)

0x8f: Stack[-1] = (bool) 0
0x90: IF (Stack[-1] == 0) GOTO 0xd1; Pop(1)

0x91: PushEmpty(string)
0x92: Stack[-1] = "Neutral" // @poff=61
0x93: Call 0xf1
...
0xc7: Push((int) 11864)
0xc8: Push((int) 13944)
0xc9: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xca: Pop(3)
0xcb: Push((int) 12769)
0xcc: Push((int) -1)
0xcd: Push((int) 13968)
0xce: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xcf: Pop(3)
0xd0: GOTO 0xd3
...
0xe2: Push("all") // @poff=110
0xe3: Push("idle") // @poff=118
...
0xeb: Push("all") // @poff=110
0xec: Push("idle") // @poff=118
...
0x14b: IF (Stack[-1] == 1) GOTO 0x15b; Pop(1)
...
0x159: IF (Stack[-1] == 1) GOTO 0x15b; Pop(1)
...
0x162: Stack[-1] = "Neutral" // @poff=61
0x163: Call 0xf1

0x164: Pop(1)
0x165: Push((int) 12737)
0x166: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x167: Pop(1)
0x168: @@@ ClearReplies(); Obj=0 // @poff=88
0x169: Pop(0)
0x16a: Push((int) 12738)
0x16b: Push((int) 13933)
0x16c: Push((int) 13932)
0x16d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x16e: Pop(3)
0x16f: Push((int) 12744)
0x170: Push((int) 13965)
0x171: Push((int) 13938)
0x172: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x173: Pop(3)
0x174: Push((int) 12745)
0x175: Push((int) 13954)
0x176: Push((int) 13939)
0x177: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x178: Pop(3)
0x179: Return(); Pop(0)
...
0x17f: Pop(1)
0x180: IF (Stack[-1] == 1) GOTO 0x187; Pop(1)
...
0x184: Pop(1)
0x185: IF (Stack[-1] == 1) GOTO 0x187; Pop(1)

0x186: Stack[-1] = (bool) 0
0x187: IF (Stack[-1] == 0) GOTO 0x1c8; Pop(1)

0x188: PushEmpty(string)
0x189: Stack[-1] = "Neutral" // @poff=61
0x18a: Call 0xf1

0x18b: Pop(1)
0x18c: Push((int) 12748)
0x18d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x18e: Pop(1)
0x18f: @@@ ClearReplies(); Obj=0 // @poff=88
0x190: Pop(0)
...
0x199: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x19a: Pop(3)
...
0x1cc: Stack[-1] = "Neutral" // @poff=61
0x1cd: Call 0xf1

0x1ce: Pop(1)
0x1cf: Push((int) 10739)
0x1d0: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1d1: Pop(1)
0x1d2: @@@ ClearReplies(); Obj=0 // @poff=88
0x1d3: Pop(0)
...
0x1dc: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1dd: Pop(3)
0x1de: Return(); Pop(0)
...
0x1e3: Stack[-1] = "Neutral" // @poff=61
0x1e4: Call 0xf1

0x1e5: Pop(1)
0x1e6: Push((int) 10741)
0x1e7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1e8: Pop(1)
0x1e9: @@@ ClearReplies(); Obj=0 // @poff=88
0x1ea: Pop(0)
...
0x1f3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1f4: Pop(3)
0x1f5: Return(); Pop(0)
...
0x1fa: Stack[-1] = "Neutral" // @poff=61
0x1fb: Call 0xf1

0x1fc: Pop(1)
0x1fd: Push((int) 10743)
0x1fe: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1ff: Pop(1)
0x200: @@@ ClearReplies(); Obj=0 // @poff=88
0x201: Pop(0)
...
0x216: Stack[-1] = "Neutral" // @poff=61
0x217: Call 0xf1

0x218: Pop(1)
0x219: Push((int) 10745)
0x21a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x21b: Pop(1)
0x21c: @@@ ClearReplies(); Obj=0 // @poff=88
0x21d: Pop(0)
...
0x226: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x227: Pop(3)
...
0x232: Stack[-1] = "Neutral" // @poff=61
0x233: Call 0xf1

0x234: Pop(1)
0x235: Push((int) 3483)
0x236: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x237: Pop(1)
0x238: @@@ ClearReplies(); Obj=0 // @poff=88
0x239: Pop(0)
0x23a: Push((int) 3484)
0x23b: Push((int) 3756)
0x23c: Push((int) 3754)
0x23d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x23e: Pop(3)
0x23f: Push((int) 3485)
0x240: Push((int) 3778)
0x241: Push((int) 3755)
0x242: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x243: Pop(3)
0x244: Push((int) 3508)
0x245: Push((int) 3763)
0x246: Push((int) 3783)
...
0x24e: Stack[-1] = "Neutral" // @poff=61
0x24f: Call 0xf1

0x250: Pop(1)
0x251: Push((int) 3505)
0x252: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x253: Pop(1)
0x254: @@@ ClearReplies(); Obj=0 // @poff=88
0x255: Pop(0)
0x256: Push((int) 3506)
0x257: Push((int) 3775)
0x258: Push((int) 3779)
0x259: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x25a: Pop(3)
0x25b: Push((int) 3507)
0x25c: Push((int) 3763)
0x25d: Push((int) 3781)
...
0x265: Stack[-1] = "Neutral" // @poff=61
0x266: Call 0xf1

0x267: Pop(1)
0x268: Push((int) 3486)
0x269: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x26a: Pop(1)
0x26b: @@@ ClearReplies(); Obj=0 // @poff=88
0x26c: Pop(0)
0x26d: Push((int) 3487)
0x26e: Push((int) 3775)
0x26f: Push((int) 3757)
...
0x273: Push((int) 3770)
0x274: Push((int) 3758)
0x275: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x276: Pop(3)
0x277: Push((int) 3489)
0x278: Push((int) 3760)
0x279: Push((int) 3759)
...
0x286: Stack[-1] = "Neutral" // @poff=61
0x287: Call 0xf1

0x288: Pop(1)
0x289: Push((int) 3490)
0x28a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x28b: Pop(1)
0x28c: @@@ ClearReplies(); Obj=0 // @poff=88
0x28d: Pop(0)
0x28e: Push((int) 3492)
0x28f: Push((int) 3763)
0x290: Push((int) 3762)
0x291: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x292: Pop(3)
0x293: Push((int) 3509)
0x294: Push((int) 3786)
0x295: Push((int) 3785)
0x296: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x297: Pop(3)
0x298: Return(); Pop(0)
...
0x29d: Stack[-1] = "Neutral" // @poff=61
0x29e: Call 0xf1

0x29f: Pop(1)
0x2a0: Push((int) 3510)
0x2a1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2a2: Pop(1)
0x2a3: @@@ ClearReplies(); Obj=0 // @poff=88
0x2a4: Pop(0)
0x2a5: Push((int) 3511)
0x2a6: Push((int) 3788)
0x2a7: Push((int) 3787)
...
0x2ab: Push((int) 3766)
0x2ac: Push((int) 3793)
0x2ad: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2ae: Pop(3)
0x2af: Return(); Pop(0)
...
0x2b4: Stack[-1] = "Neutral" // @poff=61
0x2b5: Call 0xf1

0x2b6: Pop(1)
0x2b7: Push((int) 3512)
0x2b8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2b9: Pop(1)
0x2ba: @@@ ClearReplies(); Obj=0 // @poff=88
0x2bb: Pop(0)
0x2bc: Push((int) 3513)
0x2bd: Push((int) 3775)
0x2be: Push((int) 3789)
...
0x2cb: Stack[-1] = "Neutral" // @poff=61
0x2cc: Call 0xf1

0x2cd: Pop(1)
0x2ce: Push((int) 3493)
0x2cf: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2d0: Pop(1)
0x2d1: @@@ ClearReplies(); Obj=0 // @poff=88
0x2d2: Pop(0)
0x2d3: Push((int) 3494)
0x2d4: Push((int) 3766)
0x2d5: Push((int) 3764)
...
0x2e2: Stack[-1] = "Neutral" // @poff=61
0x2e3: Call 0xf1

0x2e4: Pop(1)
0x2e5: Push((int) 3496)
0x2e6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2e7: Pop(1)
0x2e8: @@@ ClearReplies(); Obj=0 // @poff=88
0x2e9: Pop(0)
0x2ea: Push((int) 3497)
0x2eb: Push((int) 3771)
0x2ec: Push((int) 3769)
...
0x2f0: Push((int) 3797)
0x2f1: Push((int) 3773)
0x2f2: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2f3: Pop(3)
0x2f4: Push((int) 3502)
0x2f5: Push((int) -1)
0x2f6: Push((int) 3774)
...
0x30c: Push((int) -1)
0x30d: Push((int) 3799)
0x30e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x30f: Pop(3)
0x310: Push((int) 3520)
0x311: Push((int) 3801)
0x312: Push((int) 3800)
...
0x343: Stack[-1] = "Neutral" // @poff=61
0x344: Call 0xf1

0x345: Pop(1)
0x346: Push((int) 3499)
0x347: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x348: Pop(1)
0x349: @@@ ClearReplies(); Obj=0 // @poff=88
0x34a: Pop(0)
0x34b: Push((int) 3500)
0x34c: Push((int) 3770)
0x34d: Push((int) 3772)
...
0x4b5: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x4b6: Pop(0)
0x4b7: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x4b8: Pop(0)
...
0x4f8: Pop(0)
0x4f9: Push("start: ") // @poff=204
0x4fa: Pop(1); Push(Stack[-1] + Stack[-3]);
0x4fb: @ Trace(Stack[-1])
0x4fc: Pop(1)
0x4fd: Push("end: ") // @poff=220
...
0x512: Push((float)9.999999974752427e-07)
...
0x51f: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x520: Pop(0)
0x521: Push("Category") // @poff=242
0x522: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x523: Pop(1)
0x524: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x525: Pop(0)
0x526: Pop(0); Push((bool) Stack[-1] == 0)
0x527: IF (Stack[-1] == 0) GOTO 0x52a; Pop(1)

0x528: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x529: Pop(0)
0x52a: Return(); Pop(6)
...
0x52d: Pop(0)
0x52e: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x52f: Pop(0)
0x530: PushEmpty(object, object, int)
0x531: Stack[-8] = Stack[-3]
0x532: Stack[-4] = Stack[-2]
0x533: Stack[-6] = Stack[-1]
0x534: Call 0x51e
...
0x53a: Pop(0)
0x53b: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x547: Pop(0)
0x548: Push("klara blood is given") // @poff=290
0x549: @ Trace(Stack[-1])
0x54a: Pop(1)
0x54b: PushEmpty(object, string, int)
0x54c: Stack[-5] = Stack[-3]
0x54d: Stack[-2] = "d6q01_klara_blood" // @poff=332
0x54e: Stack[-1] = (int) 1
0x54f: Call 0x52b
...
0x552: PushEmpty()
0x553: Push("playsound") // @poff=368
0x554: Push("giveitem") // @poff=388
0x555: @ TriggerWorld(Stack[-2], Stack[-1])
0x556: Pop(2)
0x557: Return(); Pop(0)

0x558: PushEmpty()
0x559: Push("ood6Klara1") // @poff=406
0x55a: Push((int) 1)
...
0x55e: PushEmpty()
0x55f: Push("ood6Klara2") // @poff=428
0x560: Push((int) 1)
...
0x565: Push("d6q01KlaraVolonteer") // @poff=450
0x566: Push((int) 1)
...
0x56c: Pop(1)
0x56d: Push("d6q01AlexandrGotoJulia") // @poff=490
0x56e: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x56f: Pop(1)
0x570: Push(Stack[-1])
0x571: IF (Stack[-1] == 0) GOTO 0x574; Pop(1)

0x572: @@ Remove(); Obj=1 // @poff=545
0x573: Pop(0)
0x574: Push("d6q01AlexandrGotoKaterina") // @poff=552
0x575: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x576: Pop(1)
0x577: Push(Stack[-1])
0x578: IF (Stack[-1] == 0) GOTO 0x57b; Pop(1)

0x579: @@ Remove(); Obj=1 // @poff=545
0x57a: Pop(0)
0x57b: Push("d6q01AlexandrGotoLara") // @poff=604
0x57c: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x57d: Pop(1)
0x57e: Push(Stack[-1])
0x57f: IF (Stack[-1] == 0) GOTO 0x582; Pop(1)

0x580: @@ Remove(); Obj=1 // @poff=545
0x581: Pop(0)
0x582: Push("d6q01AlexangrGotoJulLaraSelf") // @poff=648
0x583: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x584: Pop(1)
0x585: Push(Stack[-1])
0x586: IF (Stack[-1] == 0) GOTO 0x589; Pop(1)

0x587: @@ Remove(); Obj=1 // @poff=545
0x588: Pop(0)
0x589: Push("d6q01BigVladGotoAnna") // @poff=706
0x58a: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x58b: Pop(1)
0x58c: Push(Stack[-1])
0x58d: IF (Stack[-1] == 0) GOTO 0x590; Pop(1)

0x58e: @@ Remove(); Obj=1 // @poff=545
0x58f: Pop(0)
0x590: Push("d6q01BigVladGotoAnnaOspinaSelf") // @poff=748
0x591: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x592: Pop(1)
0x593: Push(Stack[-1])
0x594: IF (Stack[-1] == 0) GOTO 0x597; Pop(1)

0x595: @@ Remove(); Obj=1 // @poff=545
0x596: Pop(0)
0x597: Push("d6q01BigVladGotoOspina") // @poff=810
0x598: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x599: Pop(1)
0x59a: Push(Stack[-1])
0x59b: IF (Stack[-1] == 0) GOTO 0x59e; Pop(1)

0x59c: @@ Remove(); Obj=1 // @poff=545
0x59d: Pop(0)
0x59e: Push("d6q01KaterinaGotoLaska") // @poff=856
0x59f: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5a0: Pop(1)
0x5a1: Push(Stack[-1])
0x5a2: IF (Stack[-1] == 0) GOTO 0x5a5; Pop(1)

0x5a3: @@ Remove(); Obj=1 // @poff=545
0x5a4: Pop(0)
0x5a5: Push("d6q01KaterinagotoLaskaSelf") // @poff=902
0x5a6: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5a7: Pop(1)
0x5a8: Push(Stack[-1])
0x5a9: IF (Stack[-1] == 0) GOTO 0x5ac; Pop(1)

0x5aa: @@ Remove(); Obj=1 // @poff=545
0x5ab: Pop(0)
0x5ac: Push("d6q01KillerIsKlara") // @poff=956
0x5ad: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5ae: Pop(1)
0x5af: Push(Stack[-1])
0x5b0: IF (Stack[-1] == 0) GOTO 0x5b3; Pop(1)

0x5b1: @@ Remove(); Obj=1 // @poff=545
0x5b2: Pop(0)
0x5b3: Push("d6q01LaskaGotoAlbinos") // @poff=994
0x5b4: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5b5: Pop(1)
0x5b6: Push(Stack[-1])
0x5b7: IF (Stack[-1] == 0) GOTO 0x5ba; Pop(1)

0x5b8: @@ Remove(); Obj=1 // @poff=545
0x5b9: Pop(0)
0x5ba: Push("d6q01ViktorGotoAlexandr") // @poff=1038
0x5bb: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5bc: Pop(1)
0x5bd: Push(Stack[-1])
0x5be: IF (Stack[-1] == 0) GOTO 0x5c1; Pop(1)

0x5bf: @@ Remove(); Obj=1 // @poff=545
0x5c0: Pop(0)
0x5c1: Push("d6q01ViktorGotoAlxBigSelf") // @poff=1086
0x5c2: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5c3: Pop(1)
0x5c4: Push(Stack[-1])
0x5c5: IF (Stack[-1] == 0) GOTO 0x5c8; Pop(1)

0x5c6: @@ Remove(); Obj=1 // @poff=545
0x5c7: Pop(0)
0x5c8: Push("d6q01ViktorGotoBigVlad") // @poff=1138
0x5c9: @@ FindMark(Stack[-2], Stack[-1]); Obj=3 // @poff=536
0x5ca: Pop(1)
0x5cb: Push(Stack[-1])
0x5cc: IF (Stack[-1] == 0) GOTO 0x5cf; Pop(1)

0x5cd: @@ Remove(); Obj=1 // @poff=545
0x5ce: Pop(0)
...
0x5ec: Stack[-2] = "quest_d6_01" // @poff=1184
0x5ed: Stack[-1] = "completed" // @poff=1208
0x5ee: Call 0x538
...
0x5f2: Stack[-2] = 0
0x5f3: PushEmpty()
0x5f4: Push("ood6Klara3") // @poff=1228
0x5f5: Push((int) 1)
...
0x61f: Stack[-1] = "ood6Klara1" // @poff=406
0x620: Call 0x519
...
0x637: Stack[-1] = "ood6Klara2" // @poff=428
0x638: Call 0x519
...
0x643: Stack[-1] = "microscope_d6q01_klara_blood" // @poff=1262
0x644: Call 0x519
...
0x667: Stack[-1] = "ood6Klara3" // @poff=1228
0x668: Call 0x519
...
0x676: Push("Can't retrieve diary root") // @poff=1320
0x677: @ Trace(Stack[-1])
0x678: Pop(1)
0x679: Stack[-3] = (bool) 0
0x67a: Return(); Pop(2)

0x67b: Stack[-1] = Stack[-3]
0x67c: Return(); Pop(2)
...
0x682: Pop(1)
0x683: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=1372
0x684: Pop(0)
0x685: Pop(0); Push((bool) Stack[-2] == 0)
0x686: IF (Stack[-1] == 0) GOTO 0x68d; Pop(1)

0x687: Push("Can't find diary parent with id: ") // @poff=1377
...
0x68d: @@ AddChild(Stack[-8]); Obj=2 // @poff=1445
0x68e: Pop(0)
0x68f: Push("player_diary") // @poff=1454
0x690: Push((int) 1)
0x691: @ SetVariable(Stack[-2], Stack[-1])
0x692: Pop(2)
0x693: @@ GetCategory(Stack[-1]); Obj=8 // @poff=1480
0x694: Pop(0)
...
0x69e: Stack[-1] = Stack[-3]
0x69f: Pop(1)
0x6a0: @@ Find(Stack[-5], Stack[-1]); Obj=2 // @poff=1372
0x6a1: Pop(0)
...
0x6ae: Pop(0)
0x6af: Pop(0); PushNull((bool) Stack[-2] == 0)
0x6b0: IF (Stack[-1] == 0) GOTO 0x6b7; Pop(1)

0x6b1: Push("Can't find main outdoor scene") // @poff=1492
0x6b2: @ Trace(Stack[-1])
0x6b3: Pop(1)
0x6b4: Stack[-1] = 0
0x6b5: Stack[-1] = Stack[-5]
0x6b6: Return(); Pop(4)

0x6b7: @@ GetMap(Stack[-1]); Obj=2 // @poff=1552
0x6b8: Pop(0)
...
0x6cf: Push("Adding diary entry") // @poff=1573
0x6d0: @ Trace(Stack[-1])
0x6d1: Pop(1)
0x6d2: Push((int) 163)
0x6d3: Push((int) 1)
...
0x6e0: Stack[-1] = "ui/NPC_Klara.png" // @poff=1611
0x6e1: Return(); Pop(0)
