...
Strings:
	...
	W:bomber
	W:rat
// @pool_raw:
...
0x523: Push("GenerateMoney: iMin > iMax") // @poff=682
0x524: @ Trace(Stack[-1])
0x525: Pop(1)
0x526: Return(); Pop(8)
...
0x54e: Stack[-1] = "rifle_ammo" // @poff=748
0x54f: Call 0x563
...
0x617: Push("class") // @poff=794
0x618: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=592
0x619: Pop(1)
0x61a: Push("bomber") // @poff=806
...
0x623: Push(Stack[-2])
0x624: IF (Stack[-1] == 1) GOTO 0x62d; Pop(1)

0x625: PushEmpty(float, object)
0x626: Stack[-9] = Stack[-1]
0x627: Call 0x454

0x628: Pop(1)
0x629: Push((float)160000.0)
0x62a: Pop(2); Push((bool) Stack[-2] <= Stack[-1])
0x62b: IF (Stack[-1] == 1) GOTO 0x62d; Pop(1)
...
0x647: Stack[-1] = "class" // @poff=794
0x648: Call 0x45c

0x649: Pop(2)
0x64a: IF (Stack[-1] == 0) GOTO 0x65a; Pop(1)

0x64b: Push("class") // @poff=794
0x64c: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=592
0x64d: Pop(1)
0x64e: PushEmpty(bool)
0x64f: Stack[-1] = (bool) 1
0x650: Push("rat") // @poff=820
0x651: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x652: IF (Stack[-1] == 1) GOTO 0x657; Pop(1)

0x653: Push("bomber") // @poff=806
