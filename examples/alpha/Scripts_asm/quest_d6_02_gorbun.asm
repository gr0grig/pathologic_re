...
Strings:
	...
	W:quest_d6_02
	W:gorbun_death
// @pool_raw:
...
Events:
EVENT_22 Op = 0x5f2 Vars = (object, int, float, float)
EVENT_16 Op = 0x606 Vars = (object, string)
EVENT_41 Op = 0x613 Vars = (object)
...
0xcd: Pop(0); PushNull((bool) Stack[-21] == 0)
0xce: IF (Stack[-1] == 0) GOTO 0xd4; Pop(1)

0xcf: PushEmpty(string)
0xd0: Stack[-1] = "fdie" // @poff=0
0xd1: Call 0x123

0xd2: Pop(1)
0xd3: GOTO 0x122

0xd4: @@ GetPosition(Stack[-10]); Obj=21 // @poff=10
0xd5: Pop(0)
...
0xe5: Stack[-6] = "fdie" // @poff=0
0xe6: GOTO 0xe8

0xe7: Stack[-6] = "bdie" // @poff=22
...
0xee: @ StopAsync()
0xef: Pop(0)
0xf0: Stack[-21] = Stack[-5]
0xf1: Push("GetScriptProperty") // @poff=32
0xf2: Push((int) 2)
0xf3: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0xf4: IF (Stack[-1] == 0) GOTO 0x100; Pop(1)

0xf5: Push("Owner") // @poff=68
0xf6: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=80
0xf7: Pop(1)
0xf8: Push(Stack[-4])
0xf9: IF (Stack[-1] == 0) GOTO 0x100; Pop(1)

0xfa: Push("Owner") // @poff=68
0xfb: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=98
0xfc: Pop(1)
0xfd: Pop(0); PushNull((bool) Stack[-5] == 0)
0xfe: IF (Stack[-1] == 0) GOTO 0x100; Pop(1)

0xff: Stack[-21] = Stack[-5]
0x100: Push("@GetEyesHeight") // @poff=116
0x101: Push((int) 1)
0x102: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x103: IF (Stack[-1] == 0) GOTO 0x10f; Pop(1)

0x104: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=146
0x105: Pop(0)
0x106: Stack[-1] = CVector(0.0, 0.0, 0.0)
0x107: Push(CvectorIndex(Stack[-1], 1))
0x108: Stack[-3] = Stack[-1]
0x109: CvectorIndex(Stack[-2], 1) = Stack[-1];
0x10a: Push("head") // @poff=160
...
0x117: @ StopAsync()
0x118: Pop(0)
0x119: Push("head") // @poff=160
0x11a: @ UnlookAsync(Stack[-1])
0x11b: Pop(1)
0x11c: Push("all") // @poff=170
...
0x17e: Stack[-3] = Stack[-1]
0x17f: Call 0x63f

0x180: Stack[-2] = Stack[-4]
0x181: Pop(2)
0x182: Return(); Pop(0)

0x183: PushEmpty(bool, bool)
0x184: Stack[1 + Tasks[-1].StackPointer] = Stack[-4]
0x185: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x186: Pop(0)
0x187: Push((int) 61)
0x188: Push((float)0.5)
0x189: @ SetTimer(Stack[-2], Stack[-1])
0x18a: Pop(2)
0x18b: @ FindPathTo(Stack[-2]T, Stack[-0]T)
0x18c: Pop(0)
0x18d: Pop(0); PushNull((bool) Stack[2 + Tasks[-1].StackPointer] == 0)
0x18e: IF (Stack[-1] == 0) GOTO 0x193; Pop(1)

0x18f: Push("Can't find path to noise source") // @poff=192
0x190: @ Trace(Stack[-1])
0x191: Pop(1)
0x192: GOTO 0x1b0

0x193: @ FollowPath(Stack[-2]T, Stack[-3], Stack[-1])
0x194: Pop(0)
0x195: Pop(0); Push((bool) Stack[-1] == 0)
0x196: IF (Stack[-1] == 0) GOTO 0x19b; Pop(1)

0x197: Pop(0); PushNull((bool) Stack[2 + Tasks[-1].StackPointer] == 0)
...
0x1a8: Pop(2)
0x1a9: Pop(0); PushNull((bool) Stack[1 + Tasks[-1].StackPointer] == 0)
0x1aa: IF (Stack[-1] == 0) GOTO 0x1ac; Pop(1)

0x1ab: GOTO 0x1b0

0x1ac: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x1ad: Pop(0)
0x1ae: Pop(0); Push(( Stack[2 + Tasks[-1].StackPointer] != 0 )
0x1af: IF (Stack[-1] == 1) GOTO 0x18b; Pop(1)
...
0x1da: @@@ GetPFPosition(Stack[-0]T); Obj=1 // @poff=178
0x1db: Pop(0)
0x1dc: Push("new hunt point") // @poff=256
0x1dd: @ Trace(Stack[-1])
0x1de: Pop(1)
0x1df: @ Stop()
0x1e0: Pop(0)
...
0x247: Pop(0)
0x248: Push("all") // @poff=170
0x249: PushEmpty(string, int)
0x24a: Stack[-7] = Stack[-1]
0x24b: Call 0x514
...
0x271: @ CanSee(Stack[-1]T, Stack[-25])
0x272: Pop(0)
0x273: PushEmpty(bool, object)
0x274: Stack[-27] = Stack[-1]
0x275: Call 0x4a9

0x276: Pop(2)
0x277: PushEmpty(bool, object)
0x278: Stack[-27] = Stack[-1]
0x279: Call 0x491
...
0x2da: Stack[-15] = Stack[-3]
0x2db: Stack[-14] = Stack[-2]
0x2dc: Stack[-11] = Stack[-1]
0x2dd: Call 0x574

0x2de: Stack[-4] = Stack[-6]
0x2df: Pop(4)
0x2e0: Push((int) 0)
...
0x2e4: Stack[-11] = Stack[-1]
0x2e5: Call 0x5ae

0x2e6: Stack[-2] = Stack[-4]
0x2e7: Pop(2)
0x2e8: GOTO 0x2ef

0x2e9: PushEmpty(float, int, float)
0x2ea: Stack[-12] = Stack[-2]
0x2eb: Stack[-5] = Stack[-1]
0x2ec: Call 0x5b6

0x2ed: Stack[-3] = Stack[-5]
0x2ee: Pop(3)
0x2ef: Push("StartVelocity") // @poff=408
0x2f0: Pop(0); Push(Stack[-8] * Stack[-3]);
0x2f1: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=390
0x2f2: Pop(2)
0x2f3: Push("DamageAmount") // @poff=436
0x2f4: Push((float)0.800000011920929)
0x2f5: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=390
0x2f6: Pop(2)
0x2f7: Push("DamageType") // @poff=462
0x2f8: Push((int) 1)
0x2f9: @@ SetScriptProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=390
0x2fa: Pop(2)
...
0x302: Pop(1)
0x303: Push("scream") // @poff=484
0x304: Push((int) 1)
0x305: Pop(1); Push(Stack[-3] + Stack[-1]);
0x306: Pop(2); Push(Stack[-2] + Stack[-1]);
0x307: @ Speak(Stack[-1])
0x308: Pop(1)
0x309: Push("all") // @poff=170
0x30a: Push("scream") // @poff=484
0x30b: Push((int) 1)
...
0x34e: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x35c: @ GetSeeThreshold(Stack[-0]T)
0x35d: Pop(0)
0x35e: @ GetSeeFOV(Stack[-1]T)
0x35f: Pop(0)
0x360: Push((float)1.5)
0x361: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x369: Push((float)1.7999999523162842)
0x36a: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[-1]);
0x36b: @ SetSeeFOV(Stack[-1])
0x36c: Pop(1)
0x36d: Push("all") // @poff=170
0x36e: Push("hunt") // @poff=498
0x36f: @ PlayAnimation(Stack[-2], Stack[-1])
0x370: Pop(2)
0x371: @ WaitForAnimEnd(Stack[-2])
0x372: Pop(0)
0x373: @ SetSeeFOV(Stack[-1]T)
0x374: Pop(0)
...
0x398: @ IsPlayerActor(Stack[-2]T, Stack[-1])
0x399: Pop(0)
0x39a: Push(Stack[-1])
...
0x3c3: @ SetSeeThreshold(Stack[-0]T)
0x3c4: Pop(0)
0x3c5: @ SetSeeFOV(Stack[-1]T)
0x3c6: Pop(0)
0x3c7: @ Stop()
0x3c8: Pop(0)
0x3c9: @ StopGroup0()
...
0x429: @ rand(Stack[-2])
0x42a: Pop(0)
0x42b: Push((float)0.30000001192092896)
0x42c: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x42d: IF (Stack[-1] == 0) GOTO 0x438; Pop(1)

0x42e: Push("all") // @poff=170
0x42f: Push("hunt") // @poff=498
...
0x456: Pop(0)
0x457: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x458: Pop(0)
...
0x45d: Push("HasProperty") // @poff=508
0x45e: Push((int) 2)
...
0x464: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=532
0x465: Pop(0)
0x466: Stack[-1] = Stack[-5]
0x467: Return(); Pop(2)

0x468: PushEmpty(bool, bool)
0x469: @@ IsDead(Stack[-1]); Obj=3 // @poff=544
0x46a: Pop(0)
0x46b: Stack[-1] = Stack[-4]
0x46c: Return(); Pop(2)

0x46d: PushEmpty(object, object, object, object)
0x46e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x482: Pop(0)
0x483: Pop(0); PushNull((bool) Stack[-2] == 0)
0x484: IF (Stack[-1] == 0) GOTO 0x487; Pop(1)

0x485: Stack[-6] = (bool) 0
0x486: Return(); Pop(4)

0x487: @@ GetScene(Stack[-1]); Obj=5 // @poff=565
0x488: Pop(0)
...
0x49c: Stack[-1] = "noaccess" // @poff=574
0x49d: Call 0x45c
...
0x4a3: Push("noaccess") // @poff=574
0x4a4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=592
0x4a5: Pop(1)
0x4a6: Push((int) 0)
...
0x4aa: @@ GetPosition(Stack[-4]); Obj=9 // @poff=10
0x4ab: Pop(0)
...
0x4db: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x4dc: Pop(0)
...
0x4ec: Stack[-1] = "fhit" // @poff=624
0x4ed: GOTO 0x4ef

0x4ee: Stack[-1] = "bhit" // @poff=634
0x4ef: Push("hit_react") // @poff=644
0x4f0: Push("1") // @poff=664
0x4f1: Pop(1); Push(Stack[-3] + Stack[-1]);
0x4f2: Push("2") // @poff=668
...
0x509: @ FindActor(Stack[-1], Stack[-4])
0x50a: Pop(0)
0x50b: Pop(0); PushNull((bool) Stack[-1] == 0)
0x50c: IF (Stack[-1] == 0) GOTO 0x50f; Pop(1)

0x50d: Stack[-5] = (bool) 0
0x50e: Return(); Pop(2)

0x50f: @ Trigger(Stack[-1], Stack[-3])
0x510: Pop(0)
0x511: Stack[-5] = (bool) 1
0x512: Return(); Pop(2)

0x513: Stack[-1] = 0
0x514: PushEmpty(string, string)
0x515: Stack[-1] = "idle" // @poff=672
0x516: Push(Stack[-3])
0x517: IF (Stack[-1] == 0) GOTO 0x519; Pop(1)

0x518: Stack[-1] = Stack[-1] + Stack[-3]; Pop(0);
0x519: Stack[-1] = Stack[-4]
0x51a: Return(); Pop(2)

0x51b: PushEmpty(int, bool, int, bool)
0x51c: Stack[-2] = (int) 0
0x51d: Push("all") // @poff=170
0x51e: PushEmpty(string, int)
0x51f: Stack[-5] = Stack[-1]
0x520: Call 0x514

0x521: Pop(1)
0x522: @ HasAnimation(Stack[-3], Stack[-2], Stack[-1])
0x523: Pop(2)
0x524: Pop(0); Push((bool) Stack[-1] == 0)
0x525: IF (Stack[-1] == 0) GOTO 0x527; Pop(1)

0x526: GOTO 0x52a

0x527: Push((int) 1)
0x528: Stack[-3] = Stack[-3] + Stack[-1]; Pop(1);
0x529: GOTO 0x51d

0x52a: Stack[-2] = Stack[-5]
0x52b: Return(); Pop(4)

0x52c: PushEmpty(int, int, int, bool, int, int, int, bool)
0x52d: Pop(0); Push((bool) Stack[-10] > Stack[-9])
0x52e: IF (Stack[-1] == 0) GOTO 0x533; Pop(1)

0x52f: Push("GenerateMoney: iMin > iMax") // @poff=682
0x530: @ Trace(Stack[-1])
0x531: Pop(1)
0x532: Return(); Pop(8)

0x533: Stack[-4] = (int) 0
0x534: Pop(0); Push((bool) Stack[-10] != Stack[-9])
0x535: IF (Stack[-1] == 0) GOTO 0x53a; Pop(1)

0x536: Pop(0); Push(Stack[-9] - Stack[-10]);
0x537: @ irand(Stack[-4], Stack[-1])
0x538: Pop(1)
0x539: GOTO 0x53e

0x53a: Push((int) 0)
0x53b: Pop(1); Push((bool) Stack[-11] == Stack[-1])
0x53c: IF (Stack[-1] == 0) GOTO 0x53e; Pop(1)

0x53d: Return(); Pop(8)

0x53e: Stack[-4] = Stack[-4] + Stack[-10]; Pop(0);
0x53f: Push((int) 0)
...
0x543: Push("Money") // @poff=736
0x544: @ GetInvItemByName(Stack[-3], Stack[-1])
0x545: Pop(1)
0x546: Push((int) 0)
0x547: @ AddItem(Stack[-2], Stack[-3], Stack[-1], Stack[-5])
0x548: Pop(1)
0x549: Return(); Pop(8)

0x54a: PushEmpty(int, bool, int, bool)
0x54b: Push((int) 0)
0x54c: @ ClearSubContainer(Stack[-1])
0x54d: Pop(1)
0x54e: PushEmpty(int, int)
0x54f: Stack[-2] = (int) 500
0x550: Stack[-1] = (int) 1000
0x551: Call 0x52c

0x552: Pop(2)
0x553: Push((int) 4)
0x554: @ irand(Stack[-3], Stack[-1])
0x555: Pop(1)
0x556: Push((int) 0)
0x557: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0x558: IF (Stack[-1] == 0) GOTO 0x560; Pop(1)

0x559: PushEmpty(int, string)
0x55a: Stack[-1] = "rifle_ammo" // @poff=748
0x55b: Call 0x56f

0x55c: Pop(1)
0x55d: Push((int) 0)
0x55e: @ AddItem(Stack[-3], Stack[-2], Stack[-1], Stack[-4])
0x55f: Pop(2)
0x560: Push((int) 3)
0x561: @ irand(Stack[-3], Stack[-1])
0x562: Pop(1)
0x563: Push((int) 0)
0x564: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x565: IF (Stack[-1] == 0) GOTO 0x56e; Pop(1)

0x566: PushEmpty(int, string)
0x567: Stack[-1] = "rusk" // @poff=770
0x568: Call 0x56f

0x569: Pop(1)
0x56a: Push((int) 0)
0x56b: Push((int) 1)
0x56c: @ AddItem(Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x56d: Pop(3)
0x56e: Return(); Pop(4)

0x56f: PushEmpty(int, int)
0x570: @ GetInvItemByName(Stack[-1], Stack[-3])
0x571: Pop(0)
0x572: Stack[-1] = Stack[-4]
0x573: Return(); Pop(2)

0x574: PushEmpty(float, float, float, float, float, float, float, float, float, float)
0x575: Push(CvectorIndex(Stack[-11], 0))
0x576: Push(CvectorIndex(Stack[-12], 0))
0x577: Pop(2); Push(Stack[-2] * Stack[-1]);
0x578: Push(CvectorIndex(Stack[-12], 2))
0x579: Push(CvectorIndex(Stack[-13], 2))
0x57a: Pop(2); Push(Stack[-2] * Stack[-1]);
0x57b: Pop(2); Push(Stack[-2] + Stack[-1]);
0x57c: Stack[-6] = Sqrt(Stack[-1]); Pop(1);
0x57d: Push(CvectorIndex(Stack[-11], 1))
0x57e: Stack[-5] = Stack[-1] / Stack[-6]; Pop(1);
0x57f: Push(CvectorIndex(Stack[-13], 0))
0x580: Push(CvectorIndex(Stack[-13], 0))
0x581: Pop(2); Push(Stack[-2] - Stack[-1]);
0x582: Push(CvectorIndex(Stack[-14], 0))
0x583: Push(CvectorIndex(Stack[-14], 0))
0x584: Pop(2); Push(Stack[-2] - Stack[-1]);
0x585: Pop(2); Push(Stack[-2] * Stack[-1]);
0x586: Push(CvectorIndex(Stack[-14], 2))
0x587: Push(CvectorIndex(Stack[-14], 2))
0x588: Pop(2); Push(Stack[-2] - Stack[-1]);
0x589: Push(CvectorIndex(Stack[-15], 2))
0x58a: Push(CvectorIndex(Stack[-15], 2))
0x58b: Pop(2); Push(Stack[-2] - Stack[-1]);
0x58c: Pop(2); Push(Stack[-2] * Stack[-1]);
0x58d: Pop(2); Push(Stack[-2] + Stack[-1]);
0x58e: Stack[-4] = Sqrt(Stack[-1]); Pop(1);
0x58f: Push((float)500.0)
0x590: Pop(0); Push(Stack[-4] * Stack[-5]);
0x591: Push(CvectorIndex(Stack[-14], 1))
0x592: Push(CvectorIndex(Stack[-16], 1))
0x593: Pop(2); Push(Stack[-2] - Stack[-1]);
0x594: Pop(2); Push(Stack[-2] - Stack[-1]);
0x595: Stack[-4] = Stack[-2] / Stack[-1]; Pop(2);
0x596: Push((int) 0)
0x597: Pop(1); Push((bool) Stack[-3] < Stack[-1])
0x598: IF (Stack[-1] == 0) GOTO 0x59b; Pop(1)

0x599: Stack[-14] = (int) -1
0x59a: Return(); Pop(10)

0x59b: Pop(0); Push(Stack[-3] / Stack[-5]);
0x59c: Pop(0); Push(Sqrt(Stack[-3]))
0x59d: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x59e: Stack[-1] = Stack[-14]
0x59f: Return(); Pop(10)
...
0x5b2: Stack[-2] = (int) 30
0x5b3: Return(); Pop(0)

0x5b4: Stack[-2] = (int) 700
0x5b5: Return(); Pop(0)
...
0x5c6: Stack[-3] = Stack[-1]
0x5c7: Call 0x63f

0x5c8: Stack[-2] = Stack[-4]
0x5c9: Pop(2)
0x5ca: Return(); Pop(0)
...
0x5ce: Push(-1, 3); TaskCall(2)
0x5cf: Call 0x13f

0x5d0: Pop(-1, 3); TaskReturn
0x5d1: Pop(1)
0x5d2: Return(); Pop(0)
...
0x5dd: Push(-1, 2); TaskCall(4)
0x5de: Call 0x26f

0x5df: Pop(-1, 2); TaskReturn
0x5e0: Pop(1)
0x5e1: @ ResetAAS()
0x5e2: Pop(0)
0x5e3: Return(); Pop(0)
...
0x5eb: Push(-1, 2); TaskCall(4)
0x5ec: Call 0x26f

0x5ed: Pop(-1, 2); TaskReturn
0x5ee: Pop(1)
0x5ef: @ ResetAAS()
0x5f0: Pop(0)
0x5f1: Return(); Pop(0)
...
0x5f2: PushEmpty()
0x5f3: PushEmpty(object, int, float)
0x5f4: Stack[-7] = Stack[-3]
0x5f5: Stack[-6] = Stack[-2]
0x5f6: Stack[-5] = Stack[-1]
0x5f7: Call 0x4b5
...
0x607: Push("health") // @poff=780
0x608: Pop(1); Push((bool) Stack[-4] == Stack[-1])
0x609: IF (Stack[-1] == 0) GOTO 0x612; Pop(1)

0x60a: Push("health") // @poff=780
0x60b: @ GetProperty(Stack[-1], Stack[-2])
0x60c: Pop(1)
0x60d: Push((int) 0)
0x60e: Pop(1); Push((bool) Stack[-2] <= Stack[-1])
0x60f: IF (Stack[-1] == 0) GOTO 0x612; Pop(1)

0x610: @ SignalDeath(Stack[-4])
0x611: Pop(0)
0x612: Return(); Pop(2)

0x613: PushEmpty()
0x614: PushEmpty(object)
0x615: Stack[-2] = Stack[-1]
0x616: Call 0x5fa

0x617: Pop(1)
0x618: Return(); Pop(0)

0x619: PushEmpty(string, bool, string, bool)
0x61a: PushEmpty(bool, object, string)
0x61b: Stack[-8] = Stack[-2]
0x61c: Stack[-1] = "class" // @poff=794
0x61d: Call 0x45c
...
0x621: Stack[-7] = (bool) 0
0x622: Return(); Pop(4)

0x623: Push("class") // @poff=794
0x624: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=592
0x625: Pop(1)
0x626: Push("bomber") // @poff=806
0x627: Pop(1); Push((bool) Stack[-3] != Stack[-1])
0x628: IF (Stack[-1] == 0) GOTO 0x62b; Pop(1)

0x629: Stack[-7] = (bool) 0
0x62a: Return(); Pop(4)

0x62b: @ CanSee(Stack[-1], Stack[-6])
0x62c: Pop(0)
0x62d: PushEmpty(bool)
0x62e: Stack[-1] = (bool) 1
0x62f: Push(Stack[-2])
0x630: IF (Stack[-1] == 1) GOTO 0x639; Pop(1)

0x631: PushEmpty(float, object)
0x632: Stack[-9] = Stack[-1]
0x633: Call 0x454

0x634: Pop(1)
0x635: Push((float)160000.0)
...
0x63a: Stack[-7] = (bool) 1
0x63b: Return(); Pop(4)

0x63c: Stack[-7] = (bool) 0
0x63d: Return(); Pop(4)

0x63e: Return(); Pop(0)

0x63f: PushEmpty(string, string)
0x640: PushEmpty(bool, object)
0x641: Stack[-5] = Stack[-1]
0x642: Call 0x491
...
0x646: Stack[-4] = (bool) 0
0x647: Return(); Pop(2)

0x648: PushEmpty(bool, object, string)
0x649: Stack[-6] = Stack[-2]
0x64a: Stack[-1] = "health" // @poff=780
0x64b: Call 0x45c
...
0x64f: Stack[-4] = (bool) 0
0x650: Return(); Pop(2)

0x651: PushEmpty(bool, object, string)
0x652: Stack[-6] = Stack[-2]
0x653: Stack[-1] = "class" // @poff=794
0x654: Call 0x45c

0x655: Pop(2)
0x656: IF (Stack[-1] == 0) GOTO 0x666; Pop(1)

0x657: Push("class") // @poff=794
0x658: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=592
0x659: Pop(1)
0x65a: PushEmpty(bool)
0x65b: Stack[-1] = (bool) 1
0x65c: Push("rat") // @poff=820
0x65d: Pop(1); Push((bool) Stack[-3] == Stack[-1])
0x65e: IF (Stack[-1] == 1) GOTO 0x663; Pop(1)

0x65f: Push("bomber") // @poff=806
...
0x664: Stack[-4] = (bool) 0
0x665: Return(); Pop(2)

0x666: Stack[-4] = (bool) 1
0x667: Return(); Pop(2)
...
0x672: PushEmpty()
0x673: PushEmpty(bool, string, string)
0x674: Stack[-2] = "quest_d6_02" // @poff=828
0x675: Stack[-1] = "gorbun_death" // @poff=852
0x676: Call 0x508
