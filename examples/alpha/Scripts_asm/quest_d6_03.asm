...
// @pool_raw:
...
0xa9: Push("Can't retrieve diary root") // @poff=385
0xaa: @ Trace(Stack[-1])
0xab: Pop(1)
0xac: Stack[-3] = (bool) 0
0xad: Return(); Pop(2)
...
0xb5: Pop(1)
0xb6: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=437
0xb7: Pop(0)
0xb8: Pop(0); Push((bool) Stack[-2] == 0)
0xb9: IF (Stack[-1] == 0) GOTO 0xc0; Pop(1)

0xba: Push("Can't find diary parent with id: ") // @poff=442
...
0xc0: @@ AddChild(Stack[-8]); Obj=2 // @poff=510
0xc1: Pop(0)
0xc2: Push("player_diary") // @poff=519
0xc3: Push((int) 1)
0xc4: @ SetVariable(Stack[-2], Stack[-1])
0xc5: Pop(2)
0xc6: @@ GetCategory(Stack[-1]); Obj=8 // @poff=545
0xc7: Pop(0)
...
0xcf: Push("Adding diary entry") // @poff=557
0xd0: @ Trace(Stack[-1])
0xd1: Pop(1)
0xd2: Push((int) 108)
0xd3: Push((int) 2)
