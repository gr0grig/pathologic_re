...
Strings:
	...
	W:ui/NPC_Black.png
	W:albinos_dead
// @pool_raw:
// @pool_encoding:utf8
...
0x68: Push((int) -1)
0x69: Push((int) 14237)
0x6a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6b: Pop(3)
0x6c: GOTO 0x6f
...
0x7e: Push("all") // @poff=110
0x7f: Push("idle") // @poff=118
...
0x87: Push("all") // @poff=110
0x88: Push("idle") // @poff=118
...
0xb9: Stack[-1] = "Neutral" // @poff=61
0xba: Call 0x8d

0xbb: Pop(1)
0xbc: Push((int) 12071)
0xbd: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xbe: Pop(1)
0xbf: @@@ ClearReplies(); Obj=0 // @poff=88
0xc0: Pop(0)
0xc1: Push((int) 12072)
0xc2: Push((int) 13294)
0xc3: Push((int) 13293)
0xc4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xc5: Pop(3)
0xc6: Push((int) 12083)
0xc7: Push((int) 13294)
0xc8: Push((int) 13306)
...
0xcd: Stack[-1] = "Neutral" // @poff=61
0xce: Call 0x8d

0xcf: Pop(1)
0xd0: Push((int) 13029)
0xd1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xd2: Pop(1)
0xd3: @@@ ClearReplies(); Obj=0 // @poff=88
0xd4: Pop(0)
0xd5: Push((int) 13030)
0xd6: Push((int) -1)
0xd7: Push((int) 14237)
0xd8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xd9: Pop(3)
0xda: Return(); Pop(0)
...
0xdf: Stack[-1] = "Neutral" // @poff=61
0xe0: Call 0x8d

0xe1: Pop(1)
0xe2: Push((int) 12073)
0xe3: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xe4: Pop(1)
0xe5: @@@ ClearReplies(); Obj=0 // @poff=88
0xe6: Pop(0)
0xe7: Push((int) 12074)
0xe8: Push((int) 13298)
0xe9: Push((int) 13295)
0xea: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xeb: Pop(3)
0xec: Push((int) 12075)
0xed: Push((int) 13298)
0xee: Push((int) 13296)
0xef: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xf0: Pop(3)
0xf1: Push((int) 12076)
0xf2: Push((int) 13298)
0xf3: Push((int) 13297)
...
0xfb: Stack[-1] = "Neutral" // @poff=61
0xfc: Call 0x8d

0xfd: Pop(1)
0xfe: Push((int) 12077)
0xff: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x100: Pop(1)
0x101: @@@ ClearReplies(); Obj=0 // @poff=88
0x102: Pop(0)
0x103: Push((int) 12078)
0x104: Push((int) 13302)
0x105: Push((int) 13301)
0x106: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x107: Pop(3)
0x108: Push((int) 12082)
0x109: Push((int) 13302)
0x10a: Push((int) 13305)
0x10b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x10c: Pop(3)
0x10d: Return(); Pop(0)
...
0x112: Stack[-1] = "Neutral" // @poff=61
0x113: Call 0x8d

0x114: Pop(1)
0x115: Push((int) 12079)
0x116: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x117: Pop(1)
0x118: @@@ ClearReplies(); Obj=0 // @poff=88
0x119: Pop(0)
0x11a: Push((int) 12080)
0x11b: Push((int) 13304)
0x11c: Push((int) 13303)
0x11d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x11e: Pop(3)
...
0x129: Stack[-1] = "Neutral" // @poff=61
0x12a: Call 0x8d

0x12b: Pop(1)
0x12c: Push((int) 12081)
0x12d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x12e: Pop(1)
0x12f: @@@ ClearReplies(); Obj=0 // @poff=88
0x130: Pop(0)
...
0x1ba: Stack[-2] = "quest_d6_03" // @poff=128
0x1bb: Stack[-1] = "albinos_retreated" // @poff=152
0x1bc: Call 0x42a
...
0x1d0: Pop(0)
0x1d1: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=188
0x1d2: Pop(0)
...
0x1ef: Stack[-1] = (float) 1.7453293800354004
0x1f0: Call 0x1ce

0x1f1: Stack[-2] = Stack[-7]
0x1f2: Pop(2)
...
0x1f7: Push("Can't retreat, distance: ") // @poff=200
...
0x20d: Push((int) 1)
0x20e: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x20f: Pop(1)
0x210: Push(Stack[-3])
0x211: IF (Stack[-1] == 0) GOTO 0x229; Pop(1)

0x212: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x217: Stack[-1] = (float) 2.6179938316345215
0x218: Call 0x1ce
...
0x22a: IF (Stack[-1] == 1) GOTO 0x20d; Pop(1)
...
0x231: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x240: Stack[-1] = (float) 1.7453293800354004
0x241: Call 0x1ce

0x242: Stack[-2] = Stack[-4]
0x243: Pop(2)
...
0x250: IF (Stack[-1] == 1) GOTO 0x256; Pop(1)
...
0x27c: Pop(2)
0x27d: Push((float)-0.3420201241970062)
...
0x28a: Pop(0); PushNull((bool) Stack[-21] == 0)
0x28b: IF (Stack[-1] == 0) GOTO 0x291; Pop(1)

0x28c: PushEmpty(string)
0x28d: Stack[-1] = "fdie" // @poff=252
0x28e: Call 0x2e0

0x28f: Pop(1)
0x290: GOTO 0x2df

0x291: @@ GetPosition(Stack[-10]); Obj=21 // @poff=188
0x292: Pop(0)
...
0x2a2: Stack[-6] = "fdie" // @poff=252
0x2a3: GOTO 0x2a5

0x2a4: Stack[-6] = "bdie" // @poff=262
...
0x2ab: @ StopAsync()
0x2ac: Pop(0)
0x2ad: Stack[-21] = Stack[-5]
0x2ae: Push("GetScriptProperty") // @poff=272
0x2af: Push((int) 2)
0x2b0: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x2b1: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2b2: Push("Owner") // @poff=308
0x2b3: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=320
0x2b4: Pop(1)
0x2b5: Push(Stack[-4])
0x2b6: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2b7: Push("Owner") // @poff=308
0x2b8: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=338
0x2b9: Pop(1)
0x2ba: Pop(0); PushNull((bool) Stack[-5] == 0)
0x2bb: IF (Stack[-1] == 0) GOTO 0x2bd; Pop(1)

0x2bc: Stack[-21] = Stack[-5]
0x2bd: Push("@GetEyesHeight") // @poff=356
0x2be: Push((int) 1)
0x2bf: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x2c0: IF (Stack[-1] == 0) GOTO 0x2cc; Pop(1)

0x2c1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=386
0x2c2: Pop(0)
...
0x2d4: @ StopAsync()
0x2d5: Pop(0)
0x2d6: Push("head") // @poff=400
0x2d7: @ UnlookAsync(Stack[-1])
0x2d8: Pop(1)
0x2d9: Push("all") // @poff=110
...
0x300: Stack[-2] = "fire" // @poff=410
0x301: Return(); Pop(0)

0x302: Stack[-2] = "phys" // @poff=420
0x303: Return(); Pop(0)
...
0x30b: Pop(0)
0x30c: @@ GetPosition(Stack[-1]); Obj=5 // @poff=188
0x30d: Pop(0)
...
0x312: Pop(0)
0x313: @@ GetPosition(Stack[-2]); Obj=7 // @poff=188
0x314: Pop(0)
...
0x319: Push("HasProperty") // @poff=430
0x31a: Push((int) 2)
...
0x320: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=454
0x321: Pop(0)
0x322: Stack[-1] = Stack[-5]
0x323: Return(); Pop(2)

0x324: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x325: PushEmpty(bool, object, string)
0x326: Stack[-18] = Stack[-2]
0x327: Stack[-1] = "health" // @poff=466
0x328: Call 0x318
...
0x32f: Stack[-18] = Stack[-2]
0x330: Stack[-1] = "armor" // @poff=480
0x331: Call 0x318
...
0x337: Push("armor") // @poff=480
0x338: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=492
0x339: Pop(1)
0x33a: Push("armor_") // @poff=504
0x33b: PushEmpty(string, int)
0x33c: Stack[-16] = Stack[-1]
0x33d: Call 0x2fc

0x33e: Pop(1)
0x33f: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x340: PushEmpty(bool, object, string)
0x341: Stack[-18] = Stack[-2]
0x342: Stack[-8] = Stack[-1]
0x343: Call 0x318
...
0x349: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=492
0x34a: Pop(0)
...
0x351: Stack[-3] = Stack[-6]
0x352: Pop(3)
0x353: Push("health") // @poff=466
0x354: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=492
0x355: Pop(1)
0x356: Push((int) 1)
0x357: Pop(1); Push(Stack[-1] - Stack[-4]);
0x358: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x359: Push("health") // @poff=466
...
0x35f: Pop(3)
0x360: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=518
0x361: Pop(2)
...
0x38a: @@ GetPosition(Stack[-5]); Obj=23 // @poff=188
0x38b: Pop(0)
...
0x39b: Stack[-1] = "fhit" // @poff=568
0x39c: GOTO 0x39e

0x39d: Stack[-1] = "bhit" // @poff=578
0x39e: Push("hit_react") // @poff=588
0x39f: Push("1") // @poff=608
0x3a0: Pop(1); Push(Stack[-3] + Stack[-1]);
0x3a1: Push("2") // @poff=612
...
0x3ad: @@ GetPosition(Stack[-7]); Obj=17 // @poff=188
0x3ae: Pop(0)
0x3af: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=386
0x3b0: Pop(0)
...
0x3f0: Pop(0)
0x3f1: Push("start: ") // @poff=634
0x3f2: Pop(1); Push(Stack[-1] + Stack[-3]);
0x3f3: @ Trace(Stack[-1])
0x3f4: Pop(1)
0x3f5: Push("end: ") // @poff=650
...
0x404: Push((float)9.999999974752427e-07)
...
0x42c: Pop(0)
0x42d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x454: PushEmpty()
0x455: Push("ood6Albinos1") // @poff=674
0x456: Push((int) 1)
...
0x45c: Stack[-1] = "ood6Albinos1" // @poff=674
0x45d: Call 0x425
...
0x479: Stack[-1] = "ui/NPC_Black.png" // @poff=714
0x47a: Return(); Pop(0)
...
0x482: Stack[-2] = "quest_d6_03" // @poff=128
0x483: Stack[-1] = "albinos_dead" // @poff=748
0x484: Call 0x42a
...
0x49b: Stack[-6] = Stack[-3]
0x49c: Stack[-2] = (float) 0.05000000074505806
0x49d: Stack[-1] = (int) 0
0x49e: Call 0x324

0x49f: Stack[-4] = Stack[-5]
0x4a0: Pop(4)
0x4a1: Push((int) 6)
0x4a2: Push((float)0.05000000074505806)
...
0x4a9: Stack[-7] = Stack[-3]
0x4aa: Stack[-6] = Stack[-2]
