...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x71: Stack[-1] = "Neutral" // @poff=61
0x72: Call 0xd1

0x73: Pop(1)
0x74: Push((int) 13197)
0x75: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x76: Pop(1)
0x77: @@@ ClearReplies(); Obj=0 // @poff=88
0x78: Pop(0)
0x79: Push((int) 13198)
0x7a: Push((int) 14433)
0x7b: Push((int) 14421)
0x7c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7d: Pop(3)
0x7e: Push((int) 13199)
0x7f: Push((int) 14428)
0x80: Push((int) 14422)
0x81: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x82: Pop(3)
0x83: Push((int) 13200)
0x84: Push((int) 14424)
0x85: Push((int) 14423)
0x86: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x87: Pop(3)
0x88: Push((int) 13330)
0x89: Push((int) -1)
0x8a: Push((int) 14562)
0x8b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x8c: Pop(3)
0x8d: Push((int) 13331)
0x8e: Push((int) -1)
0x8f: Push((int) 14563)
...
0x99: Stack[-1] = "Neutral" // @poff=61
0x9a: Call 0xd1

0x9b: Pop(1)
0x9c: Push((int) 13175)
0x9d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x9e: Pop(1)
0x9f: @@@ ClearReplies(); Obj=0 // @poff=88
0xa0: Pop(0)
0xa1: Push((int) 13177)
0xa2: Push((int) 14398)
0xa3: Push((int) 14397)
0xa4: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xa5: Pop(3)
0xa6: Push((int) 13195)
0xa7: Push((int) 14411)
0xa8: Push((int) 14417)
...
0x14d: Stack[-1] = "Neutral" // @poff=61
0x14e: Call 0xd1

0x14f: Pop(1)
0x150: Push((int) 13197)
0x151: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x152: Pop(1)
0x153: @@@ ClearReplies(); Obj=0 // @poff=88
0x154: Pop(0)
...
0x185: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x186: Pop(3)
...
0x191: Stack[-1] = "Neutral" // @poff=61
0x192: Call 0xd1

0x193: Pop(1)
0x194: Push((int) 13178)
0x195: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x196: Pop(1)
0x197: @@@ ClearReplies(); Obj=0 // @poff=88
0x198: Pop(0)
...
0x1a1: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1a2: Pop(3)
0x1a3: Push((int) 13181)
0x1a4: Push((int) 14404)
0x1a5: Push((int) 14401)
0x1a6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1a7: Pop(3)
0x1a8: Return(); Pop(0)
...
0x1ad: Stack[-1] = "Neutral" // @poff=61
0x1ae: Call 0xd1

0x1af: Pop(1)
0x1b0: Push((int) 13184)
0x1b1: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1b2: Pop(1)
0x1b3: @@@ ClearReplies(); Obj=0 // @poff=88
0x1b4: Pop(0)
0x1b5: Push((int) 13189)
0x1b6: Push((int) -1)
0x1b7: Push((int) 14409)
0x1b8: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1b9: Pop(3)
0x1ba: Push((int) 13190)
0x1bb: Push((int) 14411)
0x1bc: Push((int) 14410)
0x1bd: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1be: Pop(3)
0x1bf: Return(); Pop(0)
...
0x1c4: Stack[-1] = "Neutral" // @poff=61
0x1c5: Call 0xd1

0x1c6: Pop(1)
0x1c7: Push((int) 13183)
0x1c8: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1c9: Pop(1)
0x1ca: @@@ ClearReplies(); Obj=0 // @poff=88
0x1cb: Pop(0)
...
0x1db: Stack[-1] = "Neutral" // @poff=61
0x1dc: Call 0xd1

0x1dd: Pop(1)
0x1de: Push((int) 13182)
0x1df: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1e0: Pop(1)
0x1e1: @@@ ClearReplies(); Obj=0 // @poff=88
0x1e2: Pop(0)
0x1e3: Push((int) 13185)
0x1e4: Push((int) 14411)
0x1e5: Push((int) 14405)
0x1e6: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1e7: Pop(3)
0x1e8: Push((int) 13186)
0x1e9: Push((int) -1)
0x1ea: Push((int) 14406)
0x1eb: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1ec: Pop(3)
0x1ed: Return(); Pop(0)
...
0x1f2: Stack[-1] = "Neutral" // @poff=61
0x1f3: Call 0xd1

0x1f4: Pop(1)
0x1f5: Push((int) 13191)
0x1f6: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1f7: Pop(1)
0x1f8: @@@ ClearReplies(); Obj=0 // @poff=88
0x1f9: Pop(0)
...
0x204: Stack[-1] = "Neutral" // @poff=61
0x205: Call 0xd1

0x206: Pop(1)
0x207: Push((int) 13201)
0x208: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x209: Pop(1)
0x20a: @@@ ClearReplies(); Obj=0 // @poff=88
0x20b: Pop(0)
...
0x219: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x21a: Pop(3)
0x21b: Return(); Pop(0)
...
0x220: Stack[-1] = "Neutral" // @poff=61
0x221: Call 0xd1

0x222: Pop(1)
0x223: Push((int) 13206)
0x224: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x225: Pop(1)
0x226: @@@ ClearReplies(); Obj=0 // @poff=88
0x227: Pop(0)
...
0x249: Stack[-1] = "Neutral" // @poff=61
0x24a: Call 0xd1

0x24b: Pop(1)
0x24c: Push((int) 13210)
0x24d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x24e: Pop(1)
0x24f: @@@ ClearReplies(); Obj=0 // @poff=88
0x250: Pop(0)
...
0x288: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x289: Pop(0)
0x28a: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x28b: Pop(0)
...
0x2cb: Pop(0)
0x2cc: Push("start: ") // @poff=172
0x2cd: Pop(1); Push(Stack[-1] + Stack[-3]);
0x2ce: @ Trace(Stack[-1])
0x2cf: Pop(1)
0x2d0: Push("end: ") // @poff=188
...
0x2df: Push((float)9.999999974752427e-07)
...
0x2ec: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0x2ed: Pop(0)
0x2ee: Push("Category") // @poff=210
0x2ef: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2f0: Pop(1)
0x2f1: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0x2f2: Pop(0)
0x2f3: Pop(0); Push((bool) Stack[-1] == 0)
0x2f4: IF (Stack[-1] == 0) GOTO 0x2f7; Pop(1)

0x2f5: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0x2f6: Pop(0)
0x2f7: Return(); Pop(6)
...
0x2fa: Pop(0)
0x2fb: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0x2fc: Pop(0)
0x2fd: PushEmpty(object, object, int)
0x2fe: Stack[-8] = Stack[-3]
0x2ff: Stack[-4] = Stack[-2]
...
0x307: Pop(0)
0x308: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x310: Stack[-1] = 0
0x311: PushEmpty()
0x312: Push("playsound") // @poff=258
0x313: Push("giveitem") // @poff=278
0x314: @ TriggerWorld(Stack[-2], Stack[-1])
0x315: Pop(2)
0x316: Return(); Pop(0)

0x317: PushEmpty()
0x318: Push("d7q01") // @poff=296
0x319: Push((int) 3)
...
0x320: PushEmpty()
0x321: Push("ood7UBirdmask1") // @poff=308
0x322: Push((int) 1)
...
0x326: PushEmpty()
0x327: Push("ureport is given") // @poff=338
0x328: @ Trace(Stack[-1])
0x329: Pop(1)
0x32a: PushEmpty(object, string, int)
0x32b: Stack[-5] = Stack[-3]
0x32c: Stack[-2] = "d7q01_ureport" // @poff=372
0x32d: Stack[-1] = (int) 1
0x32e: Call 0x2f8
...
0x333: Stack[-2] = "quest_d7_01" // @poff=400
0x334: Stack[-1] = "kill_player" // @poff=424
0x335: Call 0x305
...
0x33a: Stack[-2] = "quest_d7_01" // @poff=400
0x33b: Stack[-1] = "sobor_teleport" // @poff=448
0x33c: Call 0x305
...
0x363: Stack[-1] = "ood7UBirdmask1" // @poff=308
0x364: Call 0x2e6
...
0x36e: Push((int) 1)
0x36f: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=478
0x370: Pop(1)
0x371: Push("bird_mask") // @poff=491
0x372: @ GetInvItemByName(Stack[-10], Stack[-1])
0x373: Pop(1)
0x374: Push("bird_balahon") // @poff=511
...
0x37c: Push((int) 1)
0x37d: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=537
0x37e: Pop(1)
0x37f: @@ GetItemID(Stack[-3]); Obj=4 // @poff=200
0x380: Pop(0)
0x381: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x382: IF (Stack[-1] == 0) GOTO 0x38a; Pop(1)

0x383: Push((int) 1)
0x384: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=545
0x385: Pop(1)
0x386: Push(Stack[-2])
...
0x38c: Push((int) 1)
0x38d: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=545
0x38e: Pop(1)
0x38f: Push(Stack[-1])
...
0x3a2: Push("Can't retrieve diary root") // @poff=560
0x3a3: @ Trace(Stack[-1])
0x3a4: Pop(1)
...
0x3ad: Stack[-1] = Stack[-4]
0x3ae: Pop(1)
0x3af: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=612
0x3b0: Pop(0)
0x3b1: Pop(0); Push((bool) Stack[-2] == 0)
0x3b2: IF (Stack[-1] == 0) GOTO 0x3b9; Pop(1)

0x3b3: Push("Can't find diary parent with id: ") // @poff=617
...
0x3b9: @@ AddChild(Stack[-8]); Obj=2 // @poff=685
0x3ba: Pop(0)
0x3bb: Push("player_diary") // @poff=694
0x3bc: Push((int) 1)
0x3bd: @ SetVariable(Stack[-2], Stack[-1])
0x3be: Pop(2)
0x3bf: @@ GetCategory(Stack[-1]); Obj=8 // @poff=720
0x3c0: Pop(0)
...
0x3d9: Push("Adding diary entry") // @poff=732
0x3da: @ Trace(Stack[-1])
0x3db: Pop(1)
0x3dc: Push((int) 169)
0x3dd: Push((int) 1)
...
0x3ea: Stack[-1] = "ui/NPC_Black.png" // @poff=770
0x3eb: Return(); Pop(0)
