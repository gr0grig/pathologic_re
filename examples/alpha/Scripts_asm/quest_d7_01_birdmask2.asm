...
Strings:
	...
	A:IsItemSelected
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0xb1: Push((int) -1)
0xb2: Push((int) 14536)
0xb3: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0xb4: Pop(3)
0xb5: GOTO 0xb8
...
0xd0: Push("all") // @poff=110
0xd1: Push("idle") // @poff=118
...
0x13a: Stack[-1] = "Neutral" // @poff=61
0x13b: Call 0xd6

0x13c: Pop(1)
0x13d: Push((int) 13261)
0x13e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x13f: Pop(1)
0x140: @@@ ClearReplies(); Obj=0 // @poff=88
0x141: Pop(0)
...
0x157: Stack[-1] = "Neutral" // @poff=61
0x158: Call 0xd6

0x159: Pop(1)
0x15a: Push((int) 13279)
0x15b: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x15c: Pop(1)
0x15d: @@@ ClearReplies(); Obj=0 // @poff=88
0x15e: Pop(0)
...
0x171: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x172: Pop(3)
...
0x184: Stack[-1] = "Neutral" // @poff=61
0x185: Call 0xd6

0x186: Pop(1)
0x187: Push((int) 13289)
0x188: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x189: Pop(1)
0x18a: @@@ ClearReplies(); Obj=0 // @poff=88
0x18b: Pop(0)
...
0x1a0: Stack[-1] = "Neutral" // @poff=61
0x1a1: Call 0xd6

0x1a2: Pop(1)
0x1a3: Push((int) 13291)
0x1a4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1a5: Pop(1)
0x1a6: @@@ ClearReplies(); Obj=0 // @poff=88
0x1a7: Pop(0)
0x1a8: Push((int) 13292)
0x1a9: Push((int) 14524)
0x1aa: Push((int) 14523)
0x1ab: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1ac: Pop(3)
0x1ad: Push((int) 13296)
0x1ae: Push((int) 14528)
0x1af: Push((int) 14527)
0x1b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1b1: Pop(3)
0x1b2: Push((int) 13300)
0x1b3: Push((int) 14532)
0x1b4: Push((int) 14531)
0x1b5: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1b6: Pop(3)
0x1b7: Return(); Pop(0)
...
0x1d3: Stack[-1] = "Neutral" // @poff=61
0x1d4: Call 0xd6

0x1d5: Pop(1)
0x1d6: Push((int) 13309)
0x1d7: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1d8: Pop(1)
0x1d9: @@@ ClearReplies(); Obj=0 // @poff=88
0x1da: Pop(0)
0x1db: Push((int) 13310)
0x1dc: Push((int) 14524)
0x1dd: Push((int) 14541)
0x1de: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1df: Pop(3)
0x1e0: Return(); Pop(0)
...
0x1e5: Stack[-1] = "Neutral" // @poff=61
0x1e6: Call 0xd6

0x1e7: Pop(1)
0x1e8: Push((int) 13297)
0x1e9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1ea: Pop(1)
0x1eb: @@@ ClearReplies(); Obj=0 // @poff=88
0x1ec: Pop(0)
0x1ed: Push((int) 13298)
0x1ee: Push((int) -1)
0x1ef: Push((int) 14529)
0x1f0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x1f1: Pop(3)
...
0x1fc: Stack[-1] = "Neutral" // @poff=61
0x1fd: Call 0xd6

0x1fe: Pop(1)
0x1ff: Push((int) 13293)
0x200: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x201: Pop(1)
0x202: @@@ ClearReplies(); Obj=0 // @poff=88
0x203: Pop(0)
0x204: Push((int) 13295)
0x205: Push((int) -1)
0x206: Push((int) 14526)
0x207: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x208: Pop(3)
...
0x253: Stack[-1] = "Neutral" // @poff=61
0x254: Call 0xd6

0x255: Pop(1)
0x256: Push((int) 13263)
0x257: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x258: Pop(1)
0x259: @@@ ClearReplies(); Obj=0 // @poff=88
0x25a: Pop(0)
...
0x268: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x269: Pop(3)
0x26a: Return(); Pop(0)
...
0x26f: Stack[-1] = "Neutral" // @poff=61
0x270: Call 0xd6

0x271: Pop(1)
0x272: Push((int) 13275)
0x273: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x274: Pop(1)
0x275: @@@ ClearReplies(); Obj=0 // @poff=88
0x276: Pop(0)
...
0x281: Stack[-1] = "Neutral" // @poff=61
0x282: Call 0xd6

0x283: Pop(1)
0x284: Push((int) 13277)
0x285: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x286: Pop(1)
0x287: @@@ ClearReplies(); Obj=0 // @poff=88
0x288: Pop(0)
0x289: Push((int) 13278)
0x28a: Push((int) 14499)
0x28b: Push((int) 14507)
0x28c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x28d: Pop(3)
0x28e: Return(); Pop(0)
...
0x293: Stack[-1] = "Neutral" // @poff=61
0x294: Call 0xd6

0x295: Pop(1)
0x296: Push((int) 13270)
0x297: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x298: Pop(1)
0x299: @@@ ClearReplies(); Obj=0 // @poff=88
0x29a: Pop(0)
0x29b: Push((int) 13271)
0x29c: Push((int) 14501)
0x29d: Push((int) 14500)
0x29e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x29f: Pop(3)
0x2a0: Return(); Pop(0)
...
0x2a5: Stack[-1] = "Neutral" // @poff=61
0x2a6: Call 0xd6

0x2a7: Pop(1)
0x2a8: Push((int) 13272)
0x2a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2aa: Pop(1)
0x2ab: @@@ ClearReplies(); Obj=0 // @poff=88
0x2ac: Pop(0)
0x2ad: Push((int) 13273)
0x2ae: Push((int) -1)
0x2af: Push((int) 14502)
0x2b0: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x2b1: Pop(3)
0x2b2: Return(); Pop(0)
...
0x2b7: Stack[-1] = "Neutral" // @poff=61
0x2b8: Call 0xd6

0x2b9: Pop(1)
0x2ba: Push((int) 13265)
0x2bb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x2bc: Pop(1)
0x2bd: @@@ ClearReplies(); Obj=0 // @poff=88
0x2be: Pop(0)
...
0x2f1: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x2f2: Pop(0)
0x2f3: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x2f4: Pop(0)
...
0x334: Pop(0)
0x335: Push("start: ") // @poff=172
0x336: Pop(1); Push(Stack[-1] + Stack[-3]);
0x337: @ Trace(Stack[-1])
0x338: Pop(1)
0x339: Push("end: ") // @poff=188
...
0x348: Push((float)9.999999974752427e-07)
...
0x351: Pop(0)
0x352: Stack[-1] = Stack[-4]
0x353: Return(); Pop(2)

0x354: PushEmpty(int, int, bool, int, int, bool)
0x355: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0x356: Pop(0)
0x357: Push("Category") // @poff=210
0x358: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x359: Pop(1)
0x35a: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0x35b: Pop(0)
0x35c: Pop(0); Push((bool) Stack[-1] == 0)
0x35d: IF (Stack[-1] == 0) GOTO 0x360; Pop(1)

0x35e: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0x35f: Pop(0)
0x360: Return(); Pop(6)
...
0x363: Pop(0)
0x364: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0x365: Pop(0)
0x366: PushEmpty(object, object, int)
0x367: Stack[-8] = Stack[-3]
...
0x370: Pop(0)
0x371: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x379: Stack[-1] = 0
0x37a: PushEmpty()
0x37b: Push("playsound") // @poff=258
0x37c: Push("giveitem") // @poff=278
0x37d: @ TriggerWorld(Stack[-2], Stack[-1])
0x37e: Pop(2)
0x37f: Return(); Pop(0)

0x380: PushEmpty()
0x381: Push("dreport is given") // @poff=296
0x382: @ Trace(Stack[-1])
0x383: Pop(1)
0x384: PushEmpty(object, string, int)
0x385: Stack[-5] = Stack[-3]
0x386: Stack[-2] = "d7q01_dreport" // @poff=330
0x387: Stack[-1] = (int) 1
0x388: Call 0x361
...
0x38b: PushEmpty()
0x38c: Push("ood7DBirdmask1") // @poff=358
0x38d: Push((int) 1)
...
0x393: Stack[-2] = "quest_d7_01" // @poff=388
0x394: Stack[-1] = "kill_player" // @poff=412
0x395: Call 0x36e
...
0x3c6: Stack[-1] = "ood7DBirdmask1" // @poff=358
0x3c7: Call 0x34f
...
0x3d4: Push((int) 1)
0x3d5: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=448
0x3d6: Pop(1)
0x3d7: Push("bird_mask") // @poff=461
0x3d8: @ GetInvItemByName(Stack[-10], Stack[-1])
0x3d9: Pop(1)
0x3da: Push("bird_balahon") // @poff=481
...
0x3e2: Push((int) 1)
0x3e3: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=507
0x3e4: Pop(1)
0x3e5: @@ GetItemID(Stack[-3]); Obj=4 // @poff=200
0x3e6: Pop(0)
0x3e7: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x3e8: IF (Stack[-1] == 0) GOTO 0x3f0; Pop(1)

0x3e9: Push((int) 1)
0x3ea: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=515
0x3eb: Pop(1)
0x3ec: Push(Stack[-2])
...
0x3f2: Push((int) 1)
0x3f3: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=515
0x3f4: Pop(1)
0x3f5: Push(Stack[-1])
...
0x416: Stack[-1] = "ui/NPC_Black.png" // @poff=530
0x417: Return(); Pop(0)
