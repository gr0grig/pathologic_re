...
Strings:
	...
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x68: Stack[-1] = "Neutral" // @poff=61
0x69: Call 0xbe

0x6a: Pop(1)
0x6b: Push((int) 13216)
0x6c: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x6d: Pop(1)
0x6e: @@@ ClearReplies(); Obj=0 // @poff=88
0x6f: Pop(0)
0x70: Push((int) 13217)
0x71: Push((int) 14441)
0x72: Push((int) 14440)
...
0x76: Push((int) 14444)
0x77: Push((int) 14443)
0x78: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x79: Pop(3)
0x7a: Push((int) 13224)
0x7b: Push((int) 14441)
0x7c: Push((int) 14447)
0x7d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7e: Pop(3)
0x7f: GOTO 0xa0
...
0x86: Stack[-1] = "Neutral" // @poff=61
0x87: Call 0xbe

0x88: Pop(1)
0x89: Push((int) 13231)
0x8a: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x8b: Pop(1)
0x8c: @@@ ClearReplies(); Obj=0 // @poff=88
0x8d: Pop(0)
0x8e: Push((int) 13232)
0x8f: Push((int) 14456)
0x90: Push((int) 14455)
...
0x99: Push((int) -1)
0x9a: Push((int) 14475)
0x9b: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x9c: Pop(3)
0x9d: GOTO 0xa0
...
0xaf: Push("all") // @poff=110
0xb0: Push("idle") // @poff=118
...
0xb8: Push("all") // @poff=110
0xb9: Push("idle") // @poff=118
...
0x140: Stack[-1] = "Neutral" // @poff=61
0x141: Call 0xbe

0x142: Pop(1)
0x143: Push((int) 13216)
0x144: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x145: Pop(1)
0x146: @@@ ClearReplies(); Obj=0 // @poff=88
0x147: Pop(0)
...
0x150: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x151: Pop(3)
...
0x17a: Stack[-1] = "Neutral" // @poff=61
0x17b: Call 0xbe

0x17c: Pop(1)
0x17d: Push((int) 13233)
0x17e: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x17f: Pop(1)
0x180: @@@ ClearReplies(); Obj=0 // @poff=88
0x181: Pop(0)
...
0x202: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x203: Pop(3)
0x204: Return(); Pop(0)
...
0x209: Stack[-1] = "Neutral" // @poff=61
0x20a: Call 0xbe

0x20b: Pop(1)
0x20c: Push((int) 13218)
0x20d: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x20e: Pop(1)
0x20f: @@@ ClearReplies(); Obj=0 // @poff=88
0x210: Pop(0)
...
0x266: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x267: Pop(3)
0x268: Return(); Pop(0)
...
0x26d: Stack[-1] = "Neutral" // @poff=61
0x26e: Call 0xbe

0x26f: Pop(1)
0x270: Push((int) 13254)
0x271: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x272: Pop(1)
0x273: @@@ ClearReplies(); Obj=0 // @poff=88
0x274: Pop(0)
...
0x295: @@ GetPosition(Stack[-7]); Obj=17 // @poff=128
0x296: Pop(0)
0x297: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=140
0x298: Pop(0)
...
0x2d8: Pop(0)
0x2d9: Push("start: ") // @poff=172
0x2da: Pop(1); Push(Stack[-1] + Stack[-3]);
0x2db: @ Trace(Stack[-1])
0x2dc: Pop(1)
0x2dd: Push("end: ") // @poff=188
...
0x2ec: Push((float)9.999999974752427e-07)
...
0x2f9: @@ GetItemID(Stack[-3]); Obj=8 // @poff=200
0x2fa: Pop(0)
0x2fb: Push("Category") // @poff=210
0x2fc: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x2fd: Pop(1)
0x2fe: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=228
0x2ff: Pop(0)
0x300: Pop(0); Push((bool) Stack[-1] == 0)
0x301: IF (Stack[-1] == 0) GOTO 0x304; Pop(1)

0x302: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=236
0x303: Pop(0)
0x304: Return(); Pop(6)
...
0x307: Pop(0)
0x308: @@ SetItemName(Stack[-4]); Obj=1 // @poff=246
0x309: Pop(0)
0x30a: PushEmpty(object, object, int)
0x30b: Stack[-8] = Stack[-3]
0x30c: Stack[-4] = Stack[-2]
...
0x31d: Stack[-1] = 0
0x31e: PushEmpty()
0x31f: Push("playsound") // @poff=258
0x320: Push("giveitem") // @poff=278
0x321: @ TriggerWorld(Stack[-2], Stack[-1])
0x322: Pop(2)
0x323: Return(); Pop(0)

0x324: PushEmpty()
0x325: Push("d7q01") // @poff=296
0x326: Push((int) 3)
...
0x32d: PushEmpty()
0x32e: Push("mreport is given") // @poff=308
0x32f: @ Trace(Stack[-1])
0x330: Pop(1)
0x331: PushEmpty(object, string, int)
0x332: Stack[-5] = Stack[-3]
0x333: Stack[-2] = "d7q01_mreport" // @poff=342
0x334: Stack[-1] = (int) 1
0x335: Call 0x305
...
0x338: PushEmpty()
0x339: Push("ood7MBirdmask1") // @poff=370
0x33a: Push((int) 1)
...
0x340: Stack[-2] = "quest_d7_01" // @poff=400
0x341: Stack[-1] = "sobor_teleport" // @poff=424
0x342: Call 0x312
...
0x35d: Stack[-1] = "ood7MBirdmask1" // @poff=370
0x35e: Call 0x2f3
...
0x368: Push((int) 1)
0x369: @@ GetItemCount(Stack[-11], Stack[-1]); Obj=22 // @poff=454
0x36a: Pop(1)
0x36b: Push("bird_mask") // @poff=467
0x36c: @ GetInvItemByName(Stack[-10], Stack[-1])
0x36d: Pop(1)
0x36e: Push("bird_balahon") // @poff=487
...
0x376: Push((int) 1)
0x377: @@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=22 // @poff=513
0x378: Pop(1)
0x379: @@ GetItemID(Stack[-3]); Obj=4 // @poff=200
0x37a: Pop(0)
0x37b: Pop(0); Push((bool) Stack[-3] == Stack[-9])
0x37c: IF (Stack[-1] == 0) GOTO 0x384; Pop(1)

0x37d: Push((int) 1)
0x37e: @@ IsItemSelected(Stack[-3], Stack[-6], Stack[-1]); Obj=22 // @poff=521
0x37f: Pop(1)
0x380: Push(Stack[-2])
...
0x386: Push((int) 1)
0x387: @@ IsItemSelected(Stack[-2], Stack[-6], Stack[-1]); Obj=22 // @poff=521
0x388: Pop(1)
0x389: Push(Stack[-1])
...
0x39c: Push("Can't retrieve diary root") // @poff=536
0x39d: @ Trace(Stack[-1])
0x39e: Pop(1)
...
0x3a8: Pop(1)
0x3a9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=588
0x3aa: Pop(0)
0x3ab: Pop(0); Push((bool) Stack[-2] == 0)
0x3ac: IF (Stack[-1] == 0) GOTO 0x3b3; Pop(1)

0x3ad: Push("Can't find diary parent with id: ") // @poff=593
...
0x3b3: @@ AddChild(Stack[-8]); Obj=2 // @poff=661
0x3b4: Pop(0)
0x3b5: Push("player_diary") // @poff=670
0x3b6: Push((int) 1)
0x3b7: @ SetVariable(Stack[-2], Stack[-1])
0x3b8: Pop(2)
0x3b9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=696
0x3ba: Pop(0)
...
0x3d3: Push("Adding diary entry") // @poff=722
0x3d4: @ Trace(Stack[-1])
0x3d5: Pop(1)
0x3d6: Push((int) 169)
0x3d7: Push((int) 1)
...
0x3e4: Stack[-1] = "ui/NPC_Black.png" // @poff=760
0x3e5: Return(); Pop(0)
