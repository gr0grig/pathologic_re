...
Strings:
	...
	W:cleanup
	W:restore
// @pool_raw:640037007100300032004200690072006400420061006c00610068006f006e000000640037007100300032000000710075006500730074005f00640037005f0030003200000063006f006d0070006c006500740065006400000063006c00650061006e0075007000000072006500730074006f00720065000000
...
0xd: Stack[-2] = "quest_d7_02" // @poff=46
0xe: Stack[-1] = "completed" // @poff=70
0xf: Call 0x74
...
0x19: Push("d7q02BirdBalahon") // @poff=0
...
0x76: Pop(0)
0x77: Pop(0); PushNull((bool) Stack[-1] == 0)
