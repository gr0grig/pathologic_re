...
Strings:
	...
	W:ui/NPC_Burah.png
// @pool_raw:
// @pool_encoding:utf8
...
0x67: Push((int) 14684)
0x68: Push((int) 14683)
0x69: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x6a: Pop(3)
...
0x8c: Push("all") // @poff=110
0x8d: Push("idle") // @poff=118
...
0x95: Push("all") // @poff=110
0x96: Push("idle") // @poff=118
...
0x122: Stack[-1] = "Neutral" // @poff=61
0x123: Call 0x9b

0x124: Pop(1)
0x125: Push((int) 13434)
0x126: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x127: Pop(1)
0x128: @@@ ClearReplies(); Obj=0 // @poff=88
0x129: Pop(0)
...
0x16f: Stack[-1] = "Neutral" // @poff=61
0x170: Call 0x9b

0x171: Pop(1)
0x172: Push((int) 13495)
0x173: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x174: Pop(1)
0x175: @@@ ClearReplies(); Obj=0 // @poff=88
0x176: Pop(0)
0x177: Push((int) 13439)
0x178: Push((int) 14676)
0x179: Push((int) 14675)
0x17a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x17b: Pop(3)
0x17c: Return(); Pop(0)
...
0x181: Stack[-1] = "Neutral" // @poff=61
0x182: Call 0x9b

0x183: Pop(1)
0x184: Push((int) 13440)
0x185: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x186: Pop(1)
0x187: @@@ ClearReplies(); Obj=0 // @poff=88
0x188: Pop(0)
0x189: Push((int) 13441)
0x18a: Push((int) 14678)
0x18b: Push((int) 14677)
0x18c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x18d: Pop(3)
0x18e: Return(); Pop(0)
...
0x193: Stack[-1] = "Neutral" // @poff=61
0x194: Call 0x9b

0x195: Pop(1)
0x196: Push((int) 13442)
0x197: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x198: Pop(1)
0x199: @@@ ClearReplies(); Obj=0 // @poff=88
0x19a: Pop(0)
0x19b: Push((int) 13444)
0x19c: Push((int) 14681)
0x19d: Push((int) 14680)
0x19e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x19f: Pop(3)
0x1a0: Return(); Pop(0)
...
0x1a5: Stack[-1] = "Neutral" // @poff=61
0x1a6: Call 0x9b

0x1a7: Pop(1)
0x1a8: Push((int) 13445)
0x1a9: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1aa: Pop(1)
0x1ab: @@@ ClearReplies(); Obj=0 // @poff=88
0x1ac: Pop(0)
...
0x1e0: Stack[-1] = "Neutral" // @poff=61
0x1e1: Call 0x9b

0x1e2: Pop(1)
0x1e3: Push((int) 13454)
0x1e4: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1e5: Pop(1)
0x1e6: @@@ ClearReplies(); Obj=0 // @poff=88
0x1e7: Pop(0)
...
0x1f7: Stack[-1] = "Neutral" // @poff=61
0x1f8: Call 0x9b

0x1f9: Pop(1)
0x1fa: Push((int) 13450)
0x1fb: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x1fc: Pop(1)
0x1fd: @@@ ClearReplies(); Obj=0 // @poff=88
0x1fe: Pop(0)
...
0x21b: Stack[-1] = "Neutral" // @poff=61
0x21c: Call 0x9b

0x21d: Pop(1)
0x21e: Push((int) 13425)
0x21f: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x220: Pop(1)
0x221: @@@ ClearReplies(); Obj=0 // @poff=88
0x222: Pop(0)
...
0x22d: Stack[-1] = "Neutral" // @poff=61
0x22e: Call 0x9b

0x22f: Pop(1)
0x230: Push((int) 13427)
0x231: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x232: Pop(1)
0x233: @@@ ClearReplies(); Obj=0 // @poff=88
0x234: Pop(0)
0x235: Push((int) 13428)
0x236: Push((int) 14665)
0x237: Push((int) 14664)
0x238: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x239: Pop(3)
0x23a: Return(); Pop(0)
...
0x23f: Stack[-1] = "Neutral" // @poff=61
0x240: Call 0x9b

0x241: Pop(1)
0x242: Push((int) 13429)
0x243: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x244: Pop(1)
0x245: @@@ ClearReplies(); Obj=0 // @poff=88
0x246: Pop(0)
0x247: Push((int) 13430)
0x248: Push((int) 14667)
0x249: Push((int) 14666)
0x24a: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x24b: Pop(3)
0x24c: Return(); Pop(0)
...
0x251: Stack[-1] = "Neutral" // @poff=61
0x252: Call 0x9b

0x253: Pop(1)
0x254: Push((int) 13431)
0x255: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x256: Pop(1)
0x257: @@@ ClearReplies(); Obj=0 // @poff=88
0x258: Pop(0)
0x259: Push((int) 13432)
0x25a: Push((int) -1)
0x25b: Push((int) 14668)
0x25c: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x25d: Pop(3)
0x25e: Return(); Pop(0)
...
0x2a7: @@ GetPosition(Stack[-7]); Obj=17 // @poff=160
0x2a8: Pop(0)
0x2a9: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=172
0x2aa: Pop(0)
...
0x2ea: Pop(0)
0x2eb: Push("start: ") // @poff=204
0x2ec: Pop(1); Push(Stack[-1] + Stack[-3]);
0x2ed: @ Trace(Stack[-1])
0x2ee: Pop(1)
0x2ef: Push("end: ") // @poff=220
...
0x311: @@ GetItemID(Stack[-3]); Obj=8 // @poff=232
0x312: Pop(0)
0x313: Push("Category") // @poff=242
0x314: @ GetInvItemProperty(Stack[-3], Stack[-4], Stack[-1])
0x315: Pop(1)
0x316: @@ AddItem(Stack[-1], Stack[-8], Stack[-2], Stack[-7]); Obj=9 // @poff=260
0x317: Pop(0)
0x318: Pop(0); Push((bool) Stack[-1] == 0)
0x319: IF (Stack[-1] == 0) GOTO 0x31c; Pop(1)

0x31a: @@ DropItems(Stack[-8], Stack[-7]); Obj=9 // @poff=268
0x31b: Pop(0)
0x31c: Return(); Pop(6)
...
0x31f: Pop(0)
0x320: @@ SetItemName(Stack[-4]); Obj=1 // @poff=278
0x321: Pop(0)
0x322: PushEmpty(object, object, int)
0x323: Stack[-8] = Stack[-3]
0x324: Stack[-4] = Stack[-2]
...
0x329: Stack[-1] = 0
0x32a: PushEmpty()
0x32b: Push("playsound") // @poff=290
0x32c: Push("giveitem") // @poff=310
0x32d: @ TriggerWorld(Stack[-2], Stack[-1])
0x32e: Pop(2)
0x32f: Return(); Pop(0)

0x330: PushEmpty()
0x331: Push("d8q03") // @poff=328
0x332: Push((int) 1)
...
0x342: PushEmpty()
0x343: Push("burah gives blood") // @poff=340
0x344: @ Trace(Stack[-1])
0x345: Pop(1)
0x346: PushEmpty(object, string, int)
0x347: Stack[-5] = Stack[-3]
0x348: Stack[-2] = "d8q03_blood" // @poff=376
0x349: Stack[-1] = (int) 1
0x34a: Call 0x31d
...
0x356: PushEmpty()
0x357: Push("burah gives serum") // @poff=400
0x358: @ Trace(Stack[-1])
0x359: Pop(1)
0x35a: PushEmpty(object, string, int)
0x35b: Stack[-5] = Stack[-3]
0x35c: Stack[-2] = "burah_serum" // @poff=436
0x35d: Stack[-1] = (int) 1
0x35e: Call 0x31d
...
0x361: PushEmpty()
0x362: Push("ood8Burah1") // @poff=460
0x363: Push((int) 1)
...
0x375: Stack[-1] = "microscope_d8q03_blood" // @poff=482
0x376: Call 0x30b
...
0x38d: Stack[-1] = "ood8Burah1" // @poff=460
0x38e: Call 0x30b
...
0x39c: Push("Can't retrieve diary root") // @poff=528
0x39d: @ Trace(Stack[-1])
0x39e: Pop(1)
...
0x3a8: Pop(1)
0x3a9: @@ Find(Stack[-7], Stack[-2]); Obj=3 // @poff=580
0x3aa: Pop(0)
0x3ab: Pop(0); Push((bool) Stack[-2] == 0)
0x3ac: IF (Stack[-1] == 0) GOTO 0x3b3; Pop(1)

0x3ad: Push("Can't find diary parent with id: ") // @poff=585
...
0x3b3: @@ AddChild(Stack[-8]); Obj=2 // @poff=653
0x3b4: Pop(0)
0x3b5: Push("player_diary") // @poff=662
0x3b6: Push((int) 1)
0x3b7: @ SetVariable(Stack[-2], Stack[-1])
0x3b8: Pop(2)
0x3b9: @@ GetCategory(Stack[-1]); Obj=8 // @poff=688
0x3ba: Pop(0)
...
0x3d3: Push("Adding diary entry") // @poff=714
0x3d4: @ Trace(Stack[-1])
0x3d5: Pop(1)
0x3d6: Push((int) 124)
0x3d7: Push((int) 2)
...
0x3e3: Push("Adding diary entry") // @poff=714
0x3e4: @ Trace(Stack[-1])
0x3e5: Pop(1)
0x3e6: Push((int) 125)
0x3e7: Push((int) 2)
...
0x3f3: Push("Adding diary entry") // @poff=714
0x3f4: @ Trace(Stack[-1])
0x3f5: Pop(1)
0x3f6: Push((int) 126)
0x3f7: Push((int) 2)
...
0x404: Stack[-1] = "ui/NPC_Burah.png" // @poff=752
0x405: Return(); Pop(0)
