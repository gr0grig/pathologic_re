...
Strings:
	...
	A:Intersect
	A:Next
// @pool_raw:
...
0x75: Pop(1)
0x76: Push("all") // @poff=0
0x77: Push("attack_on") // @poff=8
...
0x7e: PushEmpty(bool)
0x7f: Stack[-1] = (bool) 1
0x80: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x81: IF (Stack[-1] == 1) GOTO 0x85; Pop(1)

0x82: Pop(0); Push((bool) Stack[1 + Tasks[-1].StackPointer] == 0)
0x83: IF (Stack[-1] == 1) GOTO 0x85; Pop(1)
...
0x8d: IF (Stack[-1] == 1) GOTO 0x95; Pop(1)
...
0x93: IF (Stack[-1] == 1) GOTO 0x95; Pop(1)
...
0xa8: @ StopAsync()
0xa9: Pop(0)
0xaa: Push("all") // @poff=0
0xab: Push("attack_off") // @poff=28
0xac: @ PlayAnimation(Stack[-2], Stack[-1])
0xad: Pop(2)
0xae: @ WaitForAnimEnd()
0xaf: Pop(0)
0xb0: Pop(0); Push(( Stack[0 + Tasks[-1].StackPointer] != 0 )
0xb1: IF (Stack[-1] == 1) GOTO 0x6f; Pop(1)
...
0xe9: Stack[-4] = Stack[-1]
0xea: Call 0x23f

0xeb: Pop(1)
0xec: Pop(1); Push((bool) Stack[-1] == 0)
0xed: IF (Stack[-1] == 1) GOTO 0xf5; Pop(1)
...
0xf3: IF (Stack[-1] == 1) GOTO 0xf5; Pop(1)
...
0x148: Pop(0); PushNull((bool) Stack[-21] == 0)
0x149: IF (Stack[-1] == 0) GOTO 0x14f; Pop(1)

0x14a: PushEmpty(string)
0x14b: Stack[-1] = "fdie" // @poff=50
0x14c: Call 0x19e

0x14d: Pop(1)
0x14e: GOTO 0x19d

0x14f: @@ GetPosition(Stack[-10]); Obj=21 // @poff=60
0x150: Pop(0)
...
0x160: Stack[-6] = "fdie" // @poff=50
0x161: GOTO 0x163

0x162: Stack[-6] = "bdie" // @poff=72
...
0x169: @ StopAsync()
0x16a: Pop(0)
0x16b: Stack[-21] = Stack[-5]
0x16c: Push("GetScriptProperty") // @poff=82
0x16d: Push((int) 2)
0x16e: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x16f: IF (Stack[-1] == 0) GOTO 0x17b; Pop(1)

0x170: Push("Owner") // @poff=118
0x171: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=130
0x172: Pop(1)
0x173: Push(Stack[-4])
0x174: IF (Stack[-1] == 0) GOTO 0x17b; Pop(1)

0x175: Push("Owner") // @poff=118
0x176: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=148
0x177: Pop(1)
0x178: Pop(0); PushNull((bool) Stack[-5] == 0)
0x179: IF (Stack[-1] == 0) GOTO 0x17b; Pop(1)

0x17a: Stack[-21] = Stack[-5]
0x17b: Push("@GetEyesHeight") // @poff=166
0x17c: Push((int) 1)
0x17d: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x17e: IF (Stack[-1] == 0) GOTO 0x18a; Pop(1)

0x17f: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=196
0x180: Pop(0)
...
0x192: @ StopAsync()
0x193: Pop(0)
0x194: Push("head") // @poff=210
0x195: @ UnlookAsync(Stack[-1])
0x196: Pop(1)
0x197: Push("all") // @poff=0
...
0x1be: Stack[-2] = "fire" // @poff=220
0x1bf: Return(); Pop(0)

0x1c0: Stack[-2] = "phys" // @poff=230
0x1c1: Return(); Pop(0)

0x1c2: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x1c3: @ GetPosition(Stack[-3])
0x1c4: Pop(0)
0x1c5: @@ GetPosition(Stack[-2]); Obj=7 // @poff=60
0x1c6: Pop(0)
...
0x1cb: Push("HasProperty") // @poff=240
0x1cc: Push((int) 2)
...
0x1d2: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=264
0x1d3: Pop(0)
...
0x1d8: Stack[-18] = Stack[-2]
0x1d9: Stack[-1] = "health" // @poff=276
0x1da: Call 0x1ca
...
0x1e1: Stack[-18] = Stack[-2]
0x1e2: Stack[-1] = "armor" // @poff=290
0x1e3: Call 0x1ca
...
0x1e9: Push("armor") // @poff=290
0x1ea: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=302
0x1eb: Pop(1)
0x1ec: Push("armor_") // @poff=314
0x1ed: PushEmpty(string, int)
0x1ee: Stack[-16] = Stack[-1]
0x1ef: Call 0x1ba

0x1f0: Pop(1)
0x1f1: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x1f2: PushEmpty(bool, object, string)
0x1f3: Stack[-18] = Stack[-2]
...
0x1fb: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=302
0x1fc: Pop(0)
...
0x203: Stack[-3] = Stack[-6]
0x204: Pop(3)
0x205: Push("health") // @poff=276
0x206: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=302
0x207: Pop(1)
0x208: Push((int) 1)
0x209: Pop(1); Push(Stack[-1] - Stack[-4]);
0x20a: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x20b: Push("health") // @poff=276
...
0x211: Pop(3)
0x212: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=328
0x213: Pop(2)
0x214: Stack[-1] = Stack[-16]
0x215: Return(); Pop(12)

0x216: PushEmpty(bool, bool)
0x217: @@ IsDead(Stack[-1]); Obj=3 // @poff=340
0x218: Pop(0)
0x219: Stack[-1] = Stack[-4]
0x21a: Return(); Pop(2)

0x21b: PushEmpty(object, object, object, object)
0x21c: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x230: Pop(0)
0x231: Pop(0); PushNull((bool) Stack[-2] == 0)
0x232: IF (Stack[-1] == 0) GOTO 0x235; Pop(1)

0x233: Stack[-6] = (bool) 0
0x234: Return(); Pop(4)

0x235: @@ GetScene(Stack[-1]); Obj=5 // @poff=361
0x236: Pop(0)
...
0x249: Stack[-6] = Stack[-2]
0x24a: Stack[-1] = "noaccess" // @poff=370
0x24b: Call 0x1ca
...
0x251: Push("noaccess") // @poff=370
0x252: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=302
0x253: Pop(1)
0x254: Push((int) 0)
...
0x27d: @@ GetPosition(Stack[-5]); Obj=23 // @poff=60
0x27e: Pop(0)
...
0x28e: Stack[-1] = "fhit" // @poff=426
0x28f: GOTO 0x291

0x290: Stack[-1] = "bhit" // @poff=436
0x291: Push("hit_react") // @poff=446
0x292: Push("1") // @poff=466
0x293: Pop(1); Push(Stack[-3] + Stack[-1]);
0x294: Push("2") // @poff=470
...
0x2bb: Push("GenerateMoney: iMin > iMax") // @poff=474
0x2bc: @ Trace(Stack[-1])
0x2bd: Pop(1)
0x2be: Return(); Pop(8)
...
0x2e6: Stack[-1] = "ognemet_ammo" // @poff=540
0x2e7: Call 0x2fb
...
0x315: Pop(0)
0x316: Push("flame") // @poff=576
0x317: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=588
0x318: Pop(2)
0x319: Push(GlobalVars[3])
0x31a: Stack[-1] = (bool) 0
0x31b: GlobalVars[3] = Stack[-1]; Pop(1)
0x31c: Push((float)0.05000000074505806)
0x31d: @@ SetLength(Stack[-1]); Obj=2 // @poff=595
0x31e: Pop(1)
0x31f: Push(GlobalVars[0])
0x320: Stack[-2] = Stack[-1]
0x321: GlobalVars[0] = Stack[-1]; Pop(1)
0x322: Push((int) 70)
0x323: Push((float)0.10000000149011612)
...
0x330: Stack[-5] = (float) 0.05000000074505806
0x331: Push(GlobalVars[0])
0x332: @@ GetLength(Stack[-5]); Obj=1 // @poff=605
0x333: Pop(1)
...
0x338: @@ SetLength(Stack[-5]); Obj=1 // @poff=595
0x339: Pop(1)
...
0x340: Pop(1); PushNull((bool) Stack[-1] == 0)
...
0x35a: Push((int) 2)
0x35b: @@ FadeOut(Stack[-1]); Obj=2 // @poff=644
0x35c: Pop(2)
0x35d: Push(GlobalVars[3])
0x35e: Stack[-12] = Stack[-1]
...
0x39d: @@ in(Stack[-3], Stack[-6]); Obj=1 // @poff=700
0x39e: Pop(1)
0x39f: Push(Stack[-2])
...
0x3a4: Stack[-8] = Stack[-2]
0x3a5: Stack[-1] = "disease" // @poff=703
0x3a6: Call 0x1ca
...
0x3ac: Push("disease") // @poff=703
0x3ad: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=302
0x3ae: Pop(1)
0x3af: Push((int) 0)
...
0x3cd: Stack[-7] = Stack[-3]
0x3ce: Stack[-6] = Stack[-2]
...
0x3e8: Stack[-8] = Stack[-2]
0x3e9: Stack[-1] = "reputation" // @poff=723
0x3ea: Call 0x1ca
...
0x3f0: Push("reputation") // @poff=723
0x3f1: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=302
0x3f2: Pop(1)
...
0x414: Pop(1); PushNull((bool) Stack[-1] == 0)
0x415: IF (Stack[-1] == 0) GOTO 0x417; Pop(1)

0x416: Return(); Pop(14)

0x417: Push(GlobalVars[0])
0x418: @@ Intersect(Stack[-8], Stack[-7]); Obj=1 // @poff=745
0x419: Pop(1)
...
0x425: Push((float)0.05000000074505806)
0x426: @@ SetLength(Stack[-1]); Obj=2 // @poff=595
0x427: Pop(2)
0x428: @@ Next(Stack[-4], Stack[-5]); Obj=7 // @poff=755
0x429: Pop(0)
0x42a: Push(Stack[-4])
...
0x438: Stack[-9] = Stack[-3]
0x439: Stack[-2] = (float) 0.10000000149011612
0x43a: Stack[-1] = (int) 1
0x43b: Call 0x1d6

0x43c: Stack[-4] = Stack[-7]
0x43d: Pop(4)
0x43e: PushEmpty(bool, object, string)
0x43f: Stack[-8] = Stack[-2]
0x440: Stack[-1] = "disease" // @poff=703
0x441: Call 0x1ca

0x442: Pop(2)
0x443: IF (Stack[-1] == 0) GOTO 0x451; Pop(1)

0x444: Push("disease") // @poff=703
0x445: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=302
0x446: Pop(1)
0x447: Push((float)0.019999999552965164)
...
0x44c: Push((float)0.019999999552965164)
0x44d: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0x44e: Push("disease") // @poff=703
0x44f: @@ SetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=328
0x450: Pop(1)
0x451: PushEmpty(bool, object, string)
0x452: Stack[-8] = Stack[-2]
0x453: Stack[-1] = "fire" // @poff=220
0x454: Call 0x1ca

0x455: Pop(2)
0x456: IF (Stack[-1] == 0) GOTO 0x45f; Pop(1)

0x457: Push("fire") // @poff=220
0x458: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=302
0x459: Pop(1)
0x45a: Push("fire") // @poff=220
0x45b: Push((float)0.10000000149011612)
0x45c: Pop(1); Push(Stack[-3] + Stack[-1]);
0x45d: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=328
0x45e: Pop(2)
0x45f: GOTO 0x428
...
0x48c: PushEmpty()
0x48d: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x497: IF (Stack[-1] == 1) GOTO 0x4a5; Pop(1)
...
0x4a3: IF (Stack[-1] == 1) GOTO 0x4a5; Pop(1)

0x4a4: Stack[-3] = (bool) 0
0x4a5: Return(); Pop(0)

0x4a6: PushEmpty(bool, bool)
0x4a7: @ IsPlayerActor(Stack[-3], Stack[-1])
0x4a8: Pop(0)
0x4a9: Stack[-4] = (bool) 1
0x4aa: Push(Stack[-1])
0x4ab: IF (Stack[-1] == 1) GOTO 0x4b2; Pop(1)
