...
Strings:
	...
	A:GetScene
	W:noaccess
// @pool_raw:
...
0x92: Push("death") // @poff=14
0x93: @ Speak(Stack[-1])
0x94: Pop(1)
0x95: PushEmpty(string)
0x96: Stack[-1] = "die" // @poff=26
0x97: Call 0x9a
...
0xad: Pop(0)
0xae: Push("all") // @poff=34
0xaf: @ PlayAnimation(Stack[-1], Stack[-2])
0xb0: Pop(1)
0xb1: @ WaitForAnimEnd()
0xb2: Pop(0)
0xb3: Push("all") // @poff=34
...
0xcc: @@@ GetPosition(Stack[-7]); Obj=0 // @poff=42
0xcd: Pop(0)
...
0xe0: Pop(1)
0xe1: Push("all") // @poff=34
0xe2: Push("attack_begin") // @poff=68
...
0xf9: Stack[-6] = Stack[-3]
0xfa: Stack[-2] = (float) 0.05000000074505806
0xfb: Stack[-1] = (int) 0
0xfc: Call 0x328

0xfd: Stack[-4] = Stack[-5]
0xfe: Pop(4)
0xff: Push((int) 0)
0x100: Push((float)0.05000000074505806)
0x101: @ ReportHit(Stack[-0]T, Stack[-2], Stack[-3], Stack[-1])
0x102: Pop(2)
0x103: Stack[-2] = 0
0x104: Push((bool) 0)
0x105: @ SetAttackState(Stack[-1])
0x106: Pop(1)
0x107: Push("all") // @poff=34
0x108: Push("attack_end") // @poff=94
...
0x148: Stack[-10] = Stack[-5]
0x149: Push((float)0.8999999761581421)
...
0x14f: Stack[-6] = Stack[-7]
0x150: Pop(6)
0x151: PushEmpty()
0x152: Call 0x160

0x153: Pop(0)
0x154: Stack[-1] = Stack[-5]
0x155: Return(); Pop(2)
...
0x192: Stack[-17] = Stack[-7]
0x193: PushEmpty(bool, object)
0x194: Stack[-23] = Stack[-1]
0x195: Call 0x200
...
0x19b: @@ GetPosition(Stack[-5]); Obj=21 // @poff=42
0x19c: Pop(0)
...
0x1b2: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=124
0x1b3: Pop(0)
...
0x1c4: Push((int) 0)
0x1c5: Push((float)0.30000001192092896)
...
0x1e7: Push((int) 0)
0x1e8: Push((float)0.30000001192092896)
...
0x207: Stack[-1] = "walk" // @poff=138
0x208: Return(); Pop(0)

0x209: Stack[-1] = "run" // @poff=116
0x20a: Return(); Pop(0)

0x20b: PushEmpty()
0x20c: Stack[3 + Tasks[-1].StackPointer] = Stack[-1]
0x20d: Push("retreat") // @poff=148
0x20e: @ Speak(Stack[-1])
0x20f: Pop(1)
0x210: Push((int) 110)
0x211: Push((int) 1)
...
0x22b: Pop(0)
0x22c: @@@ GetPosition(Stack[-1]); Obj=3 // @poff=42
0x22d: Pop(0)
...
0x261: Pop(0)
0x262: @@@ GetPosition(Stack[-5]); Obj=0 // @poff=42
0x263: Pop(0)
...
0x280: Stack[-1] = (float) 1.7453293800354004
0x281: Call 0x25f

0x282: Stack[-2] = Stack[-7]
0x283: Pop(2)
...
0x288: Push("Can't retreat, distance: ") // @poff=164
...
0x29e: Push((int) 1)
0x29f: @ MovePoint(Stack[-1]T, Stack[-1], Stack[-4])
0x2a0: Pop(1)
0x2a1: Push(Stack[-3])
0x2a2: IF (Stack[-1] == 0) GOTO 0x2ba; Pop(1)

0x2a3: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2a8: Stack[-1] = (float) 2.6179938316345215
0x2a9: Call 0x25f
...
0x2bb: IF (Stack[-1] == 1) GOTO 0x29e; Pop(1)
...
0x2c2: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
...
0x2d1: Stack[-1] = (float) 1.7453293800354004
0x2d2: Call 0x25f

0x2d3: Stack[-2] = Stack[-4]
0x2d4: Pop(2)
...
0x2e1: IF (Stack[-1] == 1) GOTO 0x2e7; Pop(1)

0x2e2: PushEmpty(bool)
0x2e3: Call 0x2f8

0x2e4: Pop(0)
0x2e5: IF (Stack[-1] == 1) GOTO 0x2e7; Pop(1)
...
0x30c: Stack[-2] = "fire" // @poff=216
0x30d: Return(); Pop(0)

0x30e: Stack[-2] = "phys" // @poff=226
0x30f: Return(); Pop(0)
...
0x317: Pop(0)
0x318: @@ GetPosition(Stack[-1]); Obj=5 // @poff=42
0x319: Pop(0)
0x31a: Stack[-6] = Stack[-1] - Stack[-2]; Pop(0);
0x31b: Return(); Pop(4)

0x31c: PushEmpty(bool, bool)
0x31d: Push("HasProperty") // @poff=236
0x31e: Push((int) 2)
...
0x324: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=260
0x325: Pop(0)
...
0x32a: Stack[-18] = Stack[-2]
0x32b: Stack[-1] = "health" // @poff=0
0x32c: Call 0x31c
...
0x33b: Push("armor") // @poff=272
0x33c: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=284
0x33d: Pop(1)
0x33e: Push("armor_") // @poff=296
0x33f: PushEmpty(string, int)
0x340: Stack[-16] = Stack[-1]
0x341: Call 0x308

0x342: Pop(1)
0x343: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x344: PushEmpty(bool, object, string)
0x345: Stack[-18] = Stack[-2]
0x346: Stack[-8] = Stack[-1]
0x347: Call 0x31c
...
0x34d: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=284
0x34e: Pop(0)
...
0x355: Stack[-3] = Stack[-6]
0x356: Pop(3)
0x357: Push("health") // @poff=0
0x358: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=284
0x359: Pop(1)
0x35a: Push((int) 1)
0x35b: Pop(1); Push(Stack[-1] - Stack[-4]);
0x35c: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x35d: Push("health") // @poff=0
...
0x363: Pop(3)
0x364: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=310
0x365: Pop(2)
0x366: Stack[-1] = Stack[-16]
0x367: Return(); Pop(12)

0x368: PushEmpty(bool, bool)
0x369: @@ IsDead(Stack[-1]); Obj=3 // @poff=322
0x36a: Pop(0)
0x36b: Stack[-1] = Stack[-4]
0x36c: Return(); Pop(2)

0x36d: PushEmpty(object, object, object, object)
0x36e: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x382: Pop(0)
0x383: Pop(0); PushNull((bool) Stack[-2] == 0)
0x384: IF (Stack[-1] == 0) GOTO 0x387; Pop(1)

0x385: Stack[-6] = (bool) 0
0x386: Return(); Pop(4)

0x387: @@ GetScene(Stack[-1]); Obj=5 // @poff=343
0x388: Pop(0)
...
0x39b: Stack[-6] = Stack[-2]
0x39c: Stack[-1] = "noaccess" // @poff=352
0x39d: Call 0x31c
...
0x3a3: Push("noaccess") // @poff=352
0x3a4: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=284
0x3a5: Pop(1)
0x3a6: Push((int) 0)
