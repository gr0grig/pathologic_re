...
Strings:
	...
	A:IsOnGround
	W:nouse_container
// @pool_raw:77006100740063006800000062006f00740074006c0065005f0065006d007000740079000000720061007a006f007200000067006f006c0064005f00720069006e006700000049734f6e47726f756e64006e006f007500730065005f0063006f006e007400610069006e00650072000000
...
0x2b: Push("bottle_empty") // @poff=12
0x2c: Push((int) 0)
0x2d: Push((int) 2)
...
0x34: Push("bottle_empty") // @poff=12
0x35: Push((int) 0)
0x36: Push((int) 1)
...
0x57: @@ IsOnGround(Stack[-2]); Obj=5 // @poff=70
0x58: Pop(0)
0x59: Push(Stack[-2])
...
0x65: Push("nouse_container") // @poff=81
