...
Strings:
	...
	A:Intersect
	A:Next
// @pool_raw:
// @pool_encoding:utf8
...
0x105: Stack[-17] = Stack[-7]
0x106: PushEmpty(bool, object)
0x107: Stack[-23] = Stack[-1]
0x108: Call 0x18e
...
0x10e: @@ GetPosition(Stack[-5]); Obj=21 // @poff=0
0x10f: Pop(0)
...
0x125: @@ GetPFPosition(Stack[-5]); Obj=21 // @poff=12
0x126: Pop(0)
...
0x137: Push((int) 0)
0x138: Push((float)0.30000001192092896)
...
0x15a: Push((int) 0)
0x15b: Push((float)0.30000001192092896)
...
0x192: Stack[-2] = Stack[-4]
0x193: Pop(2)
0x194: Return(); Pop(0)

0x195: Stack[-1] = "walk" // @poff=26
0x196: Return(); Pop(0)

0x197: Stack[-1] = "run" // @poff=36
0x198: Return(); Pop(0)
...
0x1e0: Stack[-5] = Stack[-2]
0x1e1: Stack[-4] = Stack[-1]
0x1e2: Call 0x783
...
0x2b3: Pop(0)
0x2b4: Push("all") // @poff=44
0x2b5: PushEmpty(string, int)
0x2b6: Stack[-7] = Stack[-1]
0x2b7: Call 0x5ce
...
0x2f8: Pop(1)
0x2f9: Push("all") // @poff=44
0x2fa: Push("attack_on") // @poff=52
0x2fb: @ PlayAnimation(Stack[-2], Stack[-1])
0x2fc: Pop(2)
0x2fd: Stack[-3] = (bool) 1
0x2fe: GOTO 0x303

0x2ff: Push("all") // @poff=44
0x300: Push("bjump") // @poff=72
...
0x30f: Pop(1)
0x310: Push("all") // @poff=44
0x311: Push("attack_off") // @poff=84
...
0x31d: Stack[-2] = Stack[-3]
0x31e: Pop(2)
0x31f: Stack[0 + Tasks[-1].StackPointer] = Stack[-1]
0x320: Pop(0); PushNull((bool) Stack[0 + Tasks[-1].StackPointer] == 0)
0x321: IF (Stack[-1] == 0) GOTO 0x323; Pop(1)

0x322: GOTO 0x33f

0x323: @ Face(Stack[-0]T)
0x324: Pop(0)
0x325: Stack[-1] = 0
0x326: GOTO 0x33a
...
0x32f: Pop(1)
0x330: Push("all") // @poff=44
0x331: Push("attack_on") // @poff=52
...
0x341: Pop(1)
0x342: Push("all") // @poff=44
0x343: Push("attack_off") // @poff=84
...
0x38a: Pop(0); PushNull((bool) Stack[-21] == 0)
0x38b: IF (Stack[-1] == 0) GOTO 0x391; Pop(1)

0x38c: PushEmpty(string)
0x38d: Stack[-1] = "fdie" // @poff=106
0x38e: Call 0x3e0

0x38f: Pop(1)
0x390: GOTO 0x3df

0x391: @@ GetPosition(Stack[-10]); Obj=21 // @poff=0
0x392: Pop(0)
...
0x3a2: Stack[-6] = "fdie" // @poff=106
0x3a3: GOTO 0x3a5

0x3a4: Stack[-6] = "bdie" // @poff=116
...
0x3ab: @ StopAsync()
0x3ac: Pop(0)
0x3ad: Stack[-21] = Stack[-5]
0x3ae: Push("GetScriptProperty") // @poff=126
0x3af: Push((int) 2)
0x3b0: Pop(2); Push(IsFuncExist(Stack[-23], Stack[-2], Stack[-1]))
0x3b1: IF (Stack[-1] == 0) GOTO 0x3bd; Pop(1)

0x3b2: Push("Owner") // @poff=162
0x3b3: @@ HasScriptProperty(Stack[-5], Stack[-1]); Obj=22 // @poff=174
0x3b4: Pop(1)
0x3b5: Push(Stack[-4])
0x3b6: IF (Stack[-1] == 0) GOTO 0x3bd; Pop(1)

0x3b7: Push("Owner") // @poff=162
0x3b8: @@ GetScriptProperty(Stack[-6], Stack[-1]); Obj=22 // @poff=192
0x3b9: Pop(1)
0x3ba: Pop(0); PushNull((bool) Stack[-5] == 0)
0x3bb: IF (Stack[-1] == 0) GOTO 0x3bd; Pop(1)

0x3bc: Stack[-21] = Stack[-5]
0x3bd: Push("@GetEyesHeight") // @poff=210
0x3be: Push((int) 1)
0x3bf: Pop(2); Push(IsFuncExist(Stack[-7], Stack[-2], Stack[-1]))
0x3c0: IF (Stack[-1] == 0) GOTO 0x3cc; Pop(1)

0x3c1: @@ GetEyesHeight(Stack[-2]); Obj=5 // @poff=240
0x3c2: Pop(0)
...
0x3d4: @ StopAsync()
0x3d5: Pop(0)
0x3d6: Push("head") // @poff=254
0x3d7: @ UnlookAsync(Stack[-1])
0x3d8: Pop(1)
0x3d9: Push("all") // @poff=44
...
0x3fe: Stack[-10] = Stack[-2]
0x3ff: Stack[-1] = "disease" // @poff=264
0x400: Call 0x4b9
...
0x414: Push("all") // @poff=44
0x415: Push("attack_on") // @poff=52
...
0x41f: Pop(1)
0x420: Push("all") // @poff=44
0x421: Push("cattack") // @poff=280
...
0x429: IF (Stack[-1] == 1) GOTO 0x431; Pop(1)
...
0x42f: IF (Stack[-1] == 1) GOTO 0x431; Pop(1)
...
0x433: Push("disease") // @poff=264
0x434: @@ GetProperty(Stack[-1], Stack[-3]); Obj=8 // @poff=296
0x435: Pop(1)
0x436: Push((float)0.019999999552965164)
0x437: Pop(1); Push((bool) Stack[-3] <= Stack[-1])
0x438: IF (Stack[-1] == 0) GOTO 0x43e; Pop(1)

0x439: Push("disease") // @poff=264
0x43a: Push((float)0.0)
0x43b: @@ SetProperty(Stack[-2], Stack[-1]); Obj=9 // @poff=308
0x43c: Pop(2)
0x43d: GOTO 0x452

0x43e: Push("disease") // @poff=264
0x43f: Push((float)0.019999999552965164)
0x440: Pop(1); Push(Stack[-4] - Stack[-1]);
0x441: @@ SetProperty(Stack[-2], Stack[-1]); Obj=9 // @poff=308
0x442: Pop(2)
0x443: PushEmpty(bool, object, string)
0x444: Stack[-10] = Stack[-2]
0x445: Stack[-1] = "fire" // @poff=320
0x446: Call 0x4b9

0x447: Pop(2)
0x448: IF (Stack[-1] == 0) GOTO 0x451; Pop(1)

0x449: Push("fire") // @poff=320
0x44a: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=296
0x44b: Pop(1)
0x44c: Push("fire") // @poff=320
0x44d: Push((float)0.10000000149011612)
0x44e: Pop(1); Push(Stack[-3] + Stack[-1]);
0x44f: @@ SetProperty(Stack[-2], Stack[-1]); Obj=9 // @poff=308
0x450: Pop(2)
0x451: GOTO 0x420
...
0x458: Push("all") // @poff=44
0x459: Push("attack_off") // @poff=84
...
0x4ad: Stack[-2] = "fire" // @poff=320
0x4ae: Return(); Pop(0)

0x4af: Stack[-2] = "phys" // @poff=330
0x4b0: Return(); Pop(0)

0x4b1: PushEmpty(cvector, cvector, cvector, cvector, cvector, cvector)
0x4b2: @ GetPosition(Stack[-3])
0x4b3: Pop(0)
0x4b4: @@ GetPosition(Stack[-2]); Obj=7 // @poff=0
0x4b5: Pop(0)
...
0x4ba: Push("HasProperty") // @poff=340
0x4bb: Push((int) 2)
...
0x4c1: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=364
0x4c2: Pop(0)
...
0x4c7: Stack[-18] = Stack[-2]
0x4c8: Stack[-1] = "health" // @poff=376
0x4c9: Call 0x4b9
...
0x4d0: Stack[-18] = Stack[-2]
0x4d1: Stack[-1] = "armor" // @poff=390
0x4d2: Call 0x4b9
...
0x4d8: Push("armor") // @poff=390
0x4d9: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=296
0x4da: Pop(1)
0x4db: Push("armor_") // @poff=402
0x4dc: PushEmpty(string, int)
0x4dd: Stack[-16] = Stack[-1]
0x4de: Call 0x4a9

0x4df: Pop(1)
0x4e0: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x4e1: PushEmpty(bool, object, string)
0x4e2: Stack[-18] = Stack[-2]
0x4e3: Stack[-8] = Stack[-1]
0x4e4: Call 0x4b9
...
0x4ea: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=296
0x4eb: Pop(0)
...
0x4f2: Stack[-3] = Stack[-6]
0x4f3: Pop(3)
0x4f4: Push("health") // @poff=376
0x4f5: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=296
0x4f6: Pop(1)
0x4f7: Push((int) 1)
0x4f8: Pop(1); Push(Stack[-1] - Stack[-4]);
0x4f9: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x4fa: Push("health") // @poff=376
...
0x500: Pop(3)
0x501: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=308
0x502: Pop(2)
0x503: Stack[-1] = Stack[-16]
0x504: Return(); Pop(12)

0x505: PushEmpty(bool, bool)
0x506: @@ IsDead(Stack[-1]); Obj=3 // @poff=416
0x507: Pop(0)
0x508: Stack[-1] = Stack[-4]
0x509: Return(); Pop(2)

0x50a: PushEmpty(object, object, object, object)
0x50b: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x524: @@ GetScene(Stack[-1]); Obj=5 // @poff=437
0x525: Pop(0)
...
0x538: Stack[-6] = Stack[-2]
0x539: Stack[-1] = "noaccess" // @poff=446
0x53a: Call 0x4b9
...
0x540: Push("noaccess") // @poff=446
0x541: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=296
0x542: Pop(1)
0x543: Push((int) 0)
...
0x547: Pop(0); PushNull((bool) Stack[-7] == 0)
...
0x54c: Pop(0)
0x54d: Pop(0); PushNull((bool) Stack[-3] == 0)
0x54e: IF (Stack[-1] == 0) GOTO 0x551; Pop(1)

0x54f: Stack[-8] = (bool) 0
0x550: Return(); Pop(6)

0x551: @@ GetScene(Stack[-2]); Obj=7 // @poff=437
0x552: Pop(0)
...
0x559: Stack[-1] = "noaccess" // @poff=446
0x55a: Call 0x4b9
...
0x560: Push("noaccess") // @poff=446
0x561: @@ GetProperty(Stack[-1], Stack[-2]); Obj=8 // @poff=296
0x562: Pop(1)
0x563: Push((int) 0)
...
0x58e: @@ GetPosition(Stack[-5]); Obj=23 // @poff=0
0x58f: Pop(0)
...
0x59f: Stack[-1] = "fhit" // @poff=502
0x5a0: GOTO 0x5a2

0x5a1: Stack[-1] = "bhit" // @poff=512
0x5a2: Push("hit_react") // @poff=522
0x5a3: Push("1") // @poff=542
0x5a4: Pop(1); Push(Stack[-3] + Stack[-1]);
0x5a5: Push("2") // @poff=546
...
0x5c4: Stack[-1] = Stack[-4]
0x5c5: Return(); Pop(0)

0x5c6: Stack[-3] = Stack[-4]
0x5c7: Return(); Pop(0)
...
0x5e9: Push("GenerateMoney: iMin > iMax") // @poff=560
0x5ea: @ Trace(Stack[-1])
0x5eb: Pop(1)
0x5ec: Return(); Pop(8)
...
0x614: Stack[-1] = "ognemet_ammo" // @poff=626
0x615: Call 0x629
...
0x643: Pop(0)
0x644: Push("flame") // @poff=662
0x645: @@ Attach(Stack[-2], Stack[-1]); Obj=3 // @poff=674
0x646: Pop(2)
0x647: Push(GlobalVars[3])
0x648: Stack[-1] = (bool) 0
0x649: GlobalVars[3] = Stack[-1]; Pop(1)
0x64a: Push((float)0.05000000074505806)
0x64b: @@ SetLength(Stack[-1]); Obj=2 // @poff=681
0x64c: Pop(1)
0x64d: Push(GlobalVars[0])
0x64e: Stack[-2] = Stack[-1]
0x64f: GlobalVars[0] = Stack[-1]; Pop(1)
0x650: Push((int) 70)
0x651: Push((float)0.10000000149011612)
...
0x65b: Stack[-1] = Stack[-6]
0x65c: Pop(1)
0x65d: GOTO 0x65f

0x65e: Stack[-5] = (float) 0.05000000074505806
0x65f: Push(GlobalVars[0])
0x660: @@ GetLength(Stack[-5]); Obj=1 // @poff=691
0x661: Pop(1)
0x662: Pop(0); Push((bool) Stack[-5] < Stack[-4])
0x663: IF (Stack[-1] == 0) GOTO 0x665; Pop(1)

0x664: Stack[-5] = Stack[-4]
0x665: Push(GlobalVars[0])
0x666: @@ SetLength(Stack[-5]); Obj=1 // @poff=681
0x667: Pop(1)
...
0x66e: Pop(1); PushNull((bool) Stack[-1] == 0)
...
0x676: Push("flame_loop") // @poff=701
0x677: Push((int) 0)
0x678: Push((int) 200)
...
0x680: Push((int) 2)
0x681: @@ FadeIn(Stack[-1]); Obj=2 // @poff=723
0x682: Pop(2)
0x683: GOTO 0x68b
...
0x688: Push((int) 2)
0x689: @@ FadeOut(Stack[-1]); Obj=2 // @poff=730
0x68a: Pop(2)
0x68b: Push(GlobalVars[3])
0x68c: Stack[-12] = Stack[-1]
...
0x6cb: @@ in(Stack[-3], Stack[-6]); Obj=1 // @poff=770
0x6cc: Pop(1)
0x6cd: Push(Stack[-2])
...
0x6d2: Stack[-8] = Stack[-2]
0x6d3: Stack[-1] = "disease" // @poff=264
0x6d4: Call 0x4b9
...
0x6da: Push("disease") // @poff=264
0x6db: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=296
0x6dc: Pop(1)
0x6dd: Push((int) 0)
...
0x703: Stack[-3] = Stack[-1]
0x704: Call 0x800

0x705: Stack[-2] = Stack[-4]
0x706: Pop(2)
0x707: Return(); Pop(0)

0x708: PushEmpty()
0x709: PushEmpty(object)
0x70a: Stack[-2] = Stack[-1]
0x70b: Call 0x6e0
...
0x720: Pop(0); PushNull((bool) Stack[-5] == 0)
0x721: IF (Stack[-1] == 1) GOTO 0x729; Pop(1)

0x722: PushEmpty(bool, object)
0x723: Stack[-7] = Stack[-1]
0x724: Call 0x505

0x725: Pop(1)
0x726: Pop(1); Push((bool) Stack[-1] == 0)
0x727: IF (Stack[-1] == 1) GOTO 0x729; Pop(1)

0x728: Stack[-1] = (bool) 0
0x729: IF (Stack[-1] == 1) GOTO 0x732; Pop(1)

0x72a: PushEmpty(bool, object, string)
0x72b: Stack[-7] = Stack[-2]
0x72c: Stack[-1] = "disease" // @poff=264
0x72d: Call 0x4b9

0x72e: Pop(2)
0x72f: Pop(1); Push((bool) Stack[-1] == 0)
0x730: IF (Stack[-1] == 1) GOTO 0x732; Pop(1)
...
0x735: Push("disease") // @poff=264
0x736: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=296
0x737: Pop(1)
0x738: Push((int) 0)
...
0x785: Stack[-8] = Stack[-2]
0x786: Stack[-1] = "reputation" // @poff=777
0x787: Call 0x4b9
...
0x78d: Push("reputation") // @poff=777
0x78e: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=296
0x78f: Pop(1)
...
0x799: Push(Stack[-2])
0x79a: IF (Stack[-1] == 1) GOTO 0x7a3; Pop(1)

0x79b: PushEmpty(float, object)
0x79c: Stack[-9] = Stack[-1]
0x79d: Call 0x4b1
...
0x7a4: Push((float)-0.20000000298023224)
...
0x7b1: Pop(1); PushNull((bool) Stack[-1] == 0)
0x7b2: IF (Stack[-1] == 0) GOTO 0x7b4; Pop(1)

0x7b3: Return(); Pop(14)

0x7b4: Push(GlobalVars[0])
0x7b5: @@ Intersect(Stack[-8], Stack[-7]); Obj=1 // @poff=799
0x7b6: Pop(1)
...
0x7c2: Push((float)0.05000000074505806)
0x7c3: @@ SetLength(Stack[-1]); Obj=2 // @poff=681
0x7c4: Pop(2)
0x7c5: @@ Next(Stack[-4], Stack[-5]); Obj=7 // @poff=809
0x7c6: Pop(0)
0x7c7: Push(Stack[-4])
...
0x7d5: Stack[-9] = Stack[-3]
0x7d6: Stack[-2] = (float) 0.10000000149011612
0x7d7: Stack[-1] = (int) 1
0x7d8: Call 0x4c5

0x7d9: Stack[-4] = Stack[-7]
0x7da: Pop(4)
0x7db: PushEmpty(bool, object, string)
0x7dc: Stack[-8] = Stack[-2]
0x7dd: Stack[-1] = "disease" // @poff=264
0x7de: Call 0x4b9

0x7df: Pop(2)
0x7e0: IF (Stack[-1] == 0) GOTO 0x7ee; Pop(1)

0x7e1: Push("disease") // @poff=264
0x7e2: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=296
0x7e3: Pop(1)
0x7e4: Push((float)0.019999999552965164)
...
0x7e9: Push((float)0.019999999552965164)
0x7ea: Stack[-3] = Stack[-3] - Stack[-1]; Pop(1);
0x7eb: Push("disease") // @poff=264
0x7ec: @@ SetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=308
0x7ed: Pop(1)
0x7ee: PushEmpty(bool, object, string)
0x7ef: Stack[-8] = Stack[-2]
0x7f0: Stack[-1] = "fire" // @poff=320
0x7f1: Call 0x4b9

0x7f2: Pop(2)
0x7f3: IF (Stack[-1] == 0) GOTO 0x7fc; Pop(1)

0x7f4: Push("fire") // @poff=320
0x7f5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=6 // @poff=296
0x7f6: Pop(1)
0x7f7: Push("fire") // @poff=320
0x7f8: Push((float)0.10000000149011612)
0x7f9: Pop(1); Push(Stack[-3] + Stack[-1]);
0x7fa: @@ SetProperty(Stack[-2], Stack[-1]); Obj=7 // @poff=308
0x7fb: Pop(2)
0x7fc: GOTO 0x7c5
