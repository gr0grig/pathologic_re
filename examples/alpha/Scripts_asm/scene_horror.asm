...
Strings:
	...
	W:fog
	W:horror_fog.xml
// @pool_raw:4e0065007700200066006f0067002000610074002000000066006f006700000068006f00720072006f0072005f0066006f0067002e0078006d006c000000
