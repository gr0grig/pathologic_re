...
Strings:
// @pool_raw:
// @pool_encoding:utf8
...
0x13: @ CreateIntVector(Stack[-0]T)
0x14: Pop(0)
0x15: PushEmpty()
0x16: Call 0x20
...
0x36: Stack[-4] = (int) 1
0x37: Push("pt_item_food") // @poff=16
...
0x3f: Stack[-5] = Stack[-3]
0x40: Stack[-4] = Stack[-2]
0x41: Stack[-12] = Stack[-1]
0x42: Call 0x81
...
0x49: Stack[-4] = (int) 1
0x4a: Push("pt_item_pfood") // @poff=42
...
0x52: Stack[-5] = Stack[-3]
0x53: Stack[-4] = Stack[-2]
0x54: Stack[-12] = Stack[-1]
0x55: Call 0xa3
...
0x5c: Stack[-4] = (int) 1
0x5d: Push("pt_item_knife") // @poff=70
...
0x65: Stack[-5] = Stack[-3]
0x66: Stack[-4] = Stack[-2]
0x67: Stack[-12] = Stack[-1]
0x68: Call 0xdd
...
0x6f: Stack[-4] = (int) 1
0x70: Push("pt_item_bottle") // @poff=98
...
0x78: Stack[-5] = Stack[-3]
0x79: Stack[-4] = Stack[-2]
0x7a: Stack[-12] = Stack[-1]
0x7b: Call 0xf0
...
0x85: Stack[-1] = (float) 0.10000000149011612
0x86: GOTO 0x88

0x87: Stack[-1] = (float) 0.20000000298023224
0x88: Call 0x193
...
0x8e: Push((int) 2)
0x8f: Push((int) 3)
0x90: Push("bread") // @poff=128
0x91: Push("bottle_water") // @poff=140
0x92: Push("milk") // @poff=166
0x93: Push("vegetables") // @poff=176
0x94: Push("lemon") // @poff=198
0x95: @ RandOneOf(Stack[-12], Stack[-10], Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x96: Pop(10)
0x97: Push("scripted_container") // @poff=210
0x98: PushEmpty(object)
0x99: Call 0x18d

0x9a: Pop(0)
0x9b: Push("item_") // @poff=248
0x9c: Pop(1); Push(Stack[-1] + Stack[-5]);
0x9d: Push("_steal.xml") // @poff=260
...
0xa7: Stack[-1] = (float) 0.10000000149011612
0xa8: GOTO 0xaa

0xa9: Stack[-1] = (float) 0.20000000298023224
0xaa: Call 0x193
...
0xb2: Push((int) 2)
0xb3: Push((int) 1)
0xb4: Push("rusk") // @poff=282
0xb5: Push("dried_fish") // @poff=292
0xb6: Push("dried_meat") // @poff=314
0xb7: Push("smoked_meat") // @poff=336
0xb8: Push("fresh_fish") // @poff=360
0xb9: Push("fresh_meat") // @poff=382
0xba: Push("tvirin") // @poff=404
...
0xc8: Push("scripted_container") // @poff=210
0xc9: PushEmpty(object)
0xca: Call 0x18d

0xcb: Pop(0)
0xcc: Push("item_plate.xml") // @poff=418
0xcd: @ AddActorByType(Stack[-7], Stack[-3], Stack[-2], Stack[-16], Stack[-4], Stack[-1])
0xce: Pop(3)
0xcf: Push("scripted_container") // @poff=210
...
0xd5: Push("item_") // @poff=248
0xd6: Pop(1); Push(Stack[-1] + Stack[-9]);
0xd7: Push("_steal.xml") // @poff=260
...
0xe1: Stack[-1] = (float) 0.10000000149011612
0xe2: GOTO 0xe4

0xe3: Stack[-1] = (float) 0.10000000149011612
0xe4: Call 0x193

0xe5: Pop(1)
0xe6: IF (Stack[-1] == 0) GOTO 0xef; Pop(1)

0xe7: Push("scripted_container") // @poff=210
0xe8: PushEmpty(object)
0xe9: Call 0x18d

0xea: Pop(0)
0xeb: Push("item_knife_steal.xml") // @poff=448
...
0xf4: Stack[-1] = (float) 0.20000000298023224
0xf5: GOTO 0xf7

0xf6: Stack[-1] = (float) 0.4000000059604645
0xf7: Call 0x193
...
0xfe: Push((int) 3)
0xff: Push((int) 1)
0x100: Push("bottle_water") // @poff=140
0x101: Push("bottle_empty") // @poff=490
0x102: Push("vegetables") // @poff=176
0x103: Push("milk") // @poff=166
0x104: Push("egg") // @poff=516
0x105: Push("tvirin") // @poff=404
...
0x107: Pop(12)
0x108: Push("scripted_container") // @poff=210
0x109: PushEmpty(object)
0x10a: Call 0x18d

0x10b: Pop(0)
0x10c: Push("item_") // @poff=248
0x10d: Pop(1); Push(Stack[-1] + Stack[-5]);
0x10e: Push("_steal.xml") // @poff=260
...
0x11d: @ CreateIntVector(Stack[-0]T)
0x11e: Pop(0)
...
0x16d: Pop(0)
0x16e: @@@ remove(Stack[-3]); Obj=1 // @poff=556
0x16f: Pop(0)
0x170: Push((int) 3)
...
0x176: @@@ remove(Stack[-2], Stack[-1]); Obj=0 // @poff=556
0x177: Pop(2)
0x178: Push((int) -1)
...
0x182: Push("HasProperty") // @poff=563
0x183: Push((int) 2)
...
0x189: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=587
0x18a: Pop(0)
...
0x19f: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=599
0x1a0: Pop(0)
0x1a1: Pop(0); Push((bool) Stack[-4] == 0)
0x1a2: IF (Stack[-1] == 0) GOTO 0x1ab; Pop(1)

0x1a3: Push("Locator ") // @poff=610
0x1a4: Pop(1); Push(Stack[-1] + Stack[-12]);
0x1a5: Push(" doesn't exist") // @poff=628
