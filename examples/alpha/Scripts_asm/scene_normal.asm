...
Strings:
	...
	W: doesn't exist
	A:clear
// @pool_raw:
...
0x106: @ CreateIntVector(Stack[-0]T)
0x107: Pop(0)
0x108: PushEmpty()
0x109: Call 0x113
...
0x129: Stack[-4] = (int) 1
0x12a: Push("pt_item_food") // @poff=618
...
0x132: Stack[-5] = Stack[-3]
0x133: Stack[-4] = Stack[-2]
0x134: Stack[-12] = Stack[-1]
0x135: Call 0x174
...
0x13c: Stack[-4] = (int) 1
0x13d: Push("pt_item_pfood") // @poff=644
...
0x145: Stack[-5] = Stack[-3]
0x146: Stack[-4] = Stack[-2]
0x147: Stack[-12] = Stack[-1]
0x148: Call 0x196
...
0x14f: Stack[-4] = (int) 1
0x150: Push("pt_item_knife") // @poff=672
...
0x158: Stack[-5] = Stack[-3]
0x159: Stack[-4] = Stack[-2]
0x15a: Stack[-12] = Stack[-1]
0x15b: Call 0x1d0
...
0x162: Stack[-4] = (int) 1
0x163: Push("pt_item_bottle") // @poff=700
...
0x16b: Stack[-5] = Stack[-3]
0x16c: Stack[-4] = Stack[-2]
0x16d: Stack[-12] = Stack[-1]
0x16e: Call 0x1e3
...
0x178: Stack[-1] = (float) 0.10000000149011612
0x179: GOTO 0x17b

0x17a: Stack[-1] = (float) 0.20000000298023224
0x17b: Call 0x286
...
0x181: Push((int) 2)
0x182: Push((int) 3)
0x183: Push("bread") // @poff=730
0x184: Push("bottle_water") // @poff=742
0x185: Push("milk") // @poff=768
0x186: Push("vegetables") // @poff=778
0x187: Push("lemon") // @poff=800
0x188: @ RandOneOf(Stack[-12], Stack[-10], Stack[-9], Stack[-8], Stack[-7], Stack[-6], Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x189: Pop(10)
0x18a: Push("scripted_container") // @poff=812
0x18b: PushEmpty(object)
0x18c: Call 0x280

0x18d: Pop(0)
0x18e: Push("item_") // @poff=850
0x18f: Pop(1); Push(Stack[-1] + Stack[-5]);
0x190: Push("_steal.xml") // @poff=862
...
0x19a: Stack[-1] = (float) 0.10000000149011612
0x19b: GOTO 0x19d

0x19c: Stack[-1] = (float) 0.20000000298023224
0x19d: Call 0x286
...
0x1a5: Push((int) 2)
0x1a6: Push((int) 1)
0x1a7: Push("rusk") // @poff=884
0x1a8: Push("dried_fish") // @poff=894
0x1a9: Push("dried_meat") // @poff=916
0x1aa: Push("smoked_meat") // @poff=938
0x1ab: Push("fresh_fish") // @poff=962
0x1ac: Push("fresh_meat") // @poff=984
0x1ad: Push("tvirin") // @poff=1006
...
0x1bb: Push("scripted_container") // @poff=812
0x1bc: PushEmpty(object)
0x1bd: Call 0x280

0x1be: Pop(0)
0x1bf: Push("item_plate.xml") // @poff=1020
0x1c0: @ AddActorByType(Stack[-7], Stack[-3], Stack[-2], Stack[-16], Stack[-4], Stack[-1])
0x1c1: Pop(3)
0x1c2: Push("scripted_container") // @poff=812
...
0x1c8: Push("item_") // @poff=850
0x1c9: Pop(1); Push(Stack[-1] + Stack[-9]);
0x1ca: Push("_steal.xml") // @poff=862
...
0x1d4: Stack[-1] = (float) 0.10000000149011612
0x1d5: GOTO 0x1d7

0x1d6: Stack[-1] = (float) 0.10000000149011612
0x1d7: Call 0x286

0x1d8: Pop(1)
0x1d9: IF (Stack[-1] == 0) GOTO 0x1e2; Pop(1)

0x1da: Push("scripted_container") // @poff=812
0x1db: PushEmpty(object)
0x1dc: Call 0x280

0x1dd: Pop(0)
0x1de: Push("item_knife_steal.xml") // @poff=1050
...
0x1e7: Stack[-1] = (float) 0.20000000298023224
0x1e8: GOTO 0x1ea

0x1e9: Stack[-1] = (float) 0.4000000059604645
0x1ea: Call 0x286
...
0x1f1: Push((int) 3)
0x1f2: Push((int) 1)
0x1f3: Push("bottle_water") // @poff=742
0x1f4: Push("bottle_empty") // @poff=1092
0x1f5: Push("vegetables") // @poff=778
0x1f6: Push("milk") // @poff=768
0x1f7: Push("egg") // @poff=1118
0x1f8: Push("tvirin") // @poff=1006
...
0x1fa: Pop(12)
0x1fb: Push("scripted_container") // @poff=812
0x1fc: PushEmpty(object)
0x1fd: Call 0x280

0x1fe: Pop(0)
0x1ff: Push("item_") // @poff=850
0x200: Pop(1); Push(Stack[-1] + Stack[-5]);
0x201: Push("_steal.xml") // @poff=862
...
0x210: @ CreateIntVector(Stack[-0]T)
0x211: Pop(0)
...
0x215: Pop(1)
0x216: @@@ size(Stack[-8]); Obj=0 // @poff=1126
0x217: Pop(0)
0x218: Stack[-7] = (int) 0
0x219: Pop(0); Push((bool) Stack[-7] < Stack[-8])
0x21a: IF (Stack[-1] == 0) GOTO 0x246; Pop(1)

0x21b: @@@ get(Stack[-6], Stack[-7]); Obj=0 // @poff=1131
0x21c: Pop(0)
0x21d: Push((int) 1)
0x21e: Pop(1); Push(Stack[-8] + Stack[-1]);
0x21f: @@@ get(Stack[-6], Stack[-1]); Obj=0 // @poff=1131
0x220: Pop(1)
0x221: Push((int) 2)
0x222: Pop(1); Push(Stack[-8] + Stack[-1]);
0x223: @@@ get(Stack[-5], Stack[-1]); Obj=0 // @poff=1131
0x224: Pop(1)
0x225: PushEmpty(string, int, int)
0x226: Stack[-9] = Stack[-2]
0x227: Stack[-8] = Stack[-1]
0x228: Call 0x41

0x229: Stack[-3] = Stack[-6]
0x22a: Pop(3)
0x22b: PushEmpty(string, int, int)
0x22c: Stack[-9] = Stack[-2]
0x22d: Stack[-7] = Stack[-1]
0x22e: Call 0x58

0x22f: Stack[-3] = Stack[-5]
0x230: Pop(3)
0x231: PushEmpty(string, int, int)
0x232: Stack[-9] = Stack[-2]
0x233: Stack[-7] = Stack[-1]
0x234: Call 0xab

0x235: Stack[-3] = Stack[-4]
0x236: Pop(3)
0x237: PushEmpty(object, object, string, string, string)
0x238: PushEmpty(object)
0x239: Call 0x280

0x23a: Stack[-1] = Stack[-5]
0x23b: Pop(1)
0x23c: Stack[-8] = Stack[-3]
0x23d: Stack[-7] = Stack[-2]
0x23e: Stack[-6] = Stack[-1]
0x23f: Call 0x291

0x240: Pop(4)
0x241: @@@ add(Stack[-1]); Obj=1 // @poff=18
0x242: Pop(1)
0x243: Push((int) 3)
...
0x260: Pop(0)
0x261: @@@ remove(Stack[-3]); Obj=1 // @poff=1154
0x262: Pop(0)
0x263: Push((int) 3)
...
0x269: @@@ remove(Stack[-2], Stack[-1]); Obj=0 // @poff=1154
0x26a: Pop(2)
0x26b: Push((int) -1)
...
0x275: Push("HasProperty") // @poff=1161
0x276: Push((int) 2)
...
0x27c: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=1185
0x27d: Pop(0)
...
0x292: @@ GetLocator(Stack[-11], Stack[-4], Stack[-3], Stack[-2]); Obj=12 // @poff=1197
0x293: Pop(0)
0x294: Pop(0); Push((bool) Stack[-4] == 0)
0x295: IF (Stack[-1] == 0) GOTO 0x29e; Pop(1)

0x296: Push("Locator ") // @poff=1208
0x297: Pop(1); Push(Stack[-1] + Stack[-12]);
0x298: Push(" doesn't exist") // @poff=1226
