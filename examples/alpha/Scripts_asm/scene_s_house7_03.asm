...
Strings:
	...
	W:fog
	W:horror_fog.xml
// @pool_raw:
...
0x1a: Stack[-2] = "quest_d4_02" // @poff=0
0x1b: Stack[-1] = "scene_unload" // @poff=46
0x1c: Call 0x51
...
0x3d: Push("New fog at ") // @poff=72
0x3e: Pop(1); Push(Stack[-1] + Stack[-4]);
0x3f: @ Trace(Stack[-1])
0x40: Pop(1)
0x41: Push("fog") // @poff=96
0x42: PushEmpty(object)
0x43: Call 0x4b

0x44: Pop(0)
0x45: Push(CVector(0.0, 0.0, 1.0))
0x46: Push("horror_fog.xml") // @poff=104
...
0x53: Pop(0)
0x54: Pop(0); PushNull((bool) Stack[-1] == 0)
