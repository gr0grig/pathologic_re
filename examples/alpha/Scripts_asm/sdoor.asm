...
Strings:
	W:locked
// @pool_raw:6c006f0063006b00650064000000
...
0x8: IF (Stack[-1] == 1) GOTO 0x10; Pop(1)
...
0xe: IF (Stack[-1] == 1) GOTO 0x10; Pop(1)
...
0x33: IF (Stack[-1] == 1) GOTO 0x3b; Pop(1)
