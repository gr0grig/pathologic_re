...
Strings:
	...
	W:locked
// @pool_raw:6b006500790000004765744974656d436f756e744f6654797065006c006f0063006b00650064000000
...
0x1d: IF (Stack[-1] == 1) GOTO 0x25; Pop(1)

0x1e: PushEmpty(bool, object)
0x1f: Stack[-8] = Stack[-1]
0x20: Call 0x58

0x21: Pop(1)
0x22: Pop(1); Push((bool) Stack[-1] == 0)
0x23: IF (Stack[-1] == 1) GOTO 0x25; Pop(1)
...
0x48: IF (Stack[-1] == 1) GOTO 0x50; Pop(1)
