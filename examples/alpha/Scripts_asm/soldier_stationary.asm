...
Strings:
	...
	A:add
	W:reputation
// @pool_raw:
...
0x2e4: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=440
0x2e5: Pop(1)
...
0x322: @ GetPFPosition(Stack[-1]T)
0x323: Pop(0)
0x324: @ GetDirection(Stack[-0]T)
0x325: Pop(0)
0x326: Push((int) 60)
...
0x33d: @ FindPathTo(Stack[-1], Stack[-1]T)
0x33e: Pop(0)
...
0x34c: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x34d: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x35f: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 0))
0x360: Push(CvectorIndex(Stack[0 + Tasks[-1].StackPointer], 2))
...
0x378: Stack[-2] = "fire" // @poff=443
0x379: Return(); Pop(0)

0x37a: Stack[-2] = "phys" // @poff=453
0x37b: Return(); Pop(0)

0x37c: PushEmpty(cvector, cvector, cvector, cvector)
0x37d: @ GetPosition(Stack[-2])
0x37e: Pop(0)
0x37f: @@ GetPosition(Stack[-1]); Obj=5 // @poff=10
0x380: Pop(0)
...
0x385: Pop(0)
0x386: @@ GetPosition(Stack[-2]); Obj=7 // @poff=10
0x387: Pop(0)
...
0x38c: Push("HasProperty") // @poff=463
0x38d: Push((int) 2)
...
0x393: @@ HasProperty(Stack[-3], Stack[-1]); Obj=4 // @poff=487
0x394: Pop(0)
0x395: Stack[-1] = Stack[-5]
0x396: Return(); Pop(2)

0x397: PushEmpty(int, string, int, float, float, float, int, string, int, float, float, float)
0x398: PushEmpty(bool, object, string)
0x399: Stack[-18] = Stack[-2]
0x39a: Stack[-1] = "health" // @poff=499
0x39b: Call 0x38b
...
0x3aa: Push("armor") // @poff=513
0x3ab: @@ GetProperty(Stack[-1], Stack[-7]); Obj=16 // @poff=525
0x3ac: Pop(1)
0x3ad: Push("armor_") // @poff=537
0x3ae: PushEmpty(string, int)
0x3af: Stack[-16] = Stack[-1]
0x3b0: Call 0x374

0x3b1: Pop(1)
0x3b2: Stack[-7] = Stack[-2] + Stack[-1]; Pop(2);
0x3b3: PushEmpty(bool, object, string)
0x3b4: Stack[-18] = Stack[-2]
0x3b5: Stack[-8] = Stack[-1]
0x3b6: Call 0x38b
...
0x3bc: @@ GetProperty(Stack[-5], Stack[-4]); Obj=15 // @poff=525
0x3bd: Pop(0)
...
0x3c4: Stack[-3] = Stack[-6]
0x3c5: Pop(3)
0x3c6: Push("health") // @poff=499
0x3c7: @@ GetProperty(Stack[-1], Stack[-3]); Obj=16 // @poff=525
0x3c8: Pop(1)
0x3c9: Push((int) 1)
0x3ca: Pop(1); Push(Stack[-1] - Stack[-4]);
0x3cb: Stack[-2] = Stack[-15] * Stack[-1]; Pop(1);
0x3cc: Push("health") // @poff=499
...
0x3d2: Pop(3)
0x3d3: @@ SetProperty(Stack[-2], Stack[-1]); Obj=17 // @poff=551
0x3d4: Pop(2)
0x3d5: Stack[-1] = Stack[-16]
0x3d6: Return(); Pop(12)

0x3d7: PushEmpty(bool, bool)
0x3d8: @@ IsDead(Stack[-1]); Obj=3 // @poff=563
0x3d9: Pop(0)
0x3da: Stack[-1] = Stack[-4]
0x3db: Return(); Pop(2)

0x3dc: PushEmpty(object, object, object, object)
0x3dd: Pop(0); PushNull((bool) Stack[-5] == 0)
...
0x3f1: Pop(0)
0x3f2: Pop(0); PushNull((bool) Stack[-2] == 0)
0x3f3: IF (Stack[-1] == 0) GOTO 0x3f6; Pop(1)

0x3f4: Stack[-6] = (bool) 0
0x3f5: Return(); Pop(4)

0x3f6: @@ GetScene(Stack[-1]); Obj=5 // @poff=584
0x3f7: Pop(0)
...
0x40a: Stack[-6] = Stack[-2]
0x40b: Stack[-1] = "noaccess" // @poff=593
0x40c: Call 0x38b
...
0x412: Push("noaccess") // @poff=593
0x413: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=525
0x414: Pop(1)
0x415: Push((int) 0)
...
0x43e: @@ GetPosition(Stack[-5]); Obj=23 // @poff=10
0x43f: Pop(0)
...
0x44f: Stack[-1] = "fhit" // @poff=631
0x450: GOTO 0x452

0x451: Stack[-1] = "bhit" // @poff=641
0x452: Push("hit_react") // @poff=651
0x453: Push("1") // @poff=330
0x454: Pop(1); Push(Stack[-3] + Stack[-1]);
0x455: Push("2") // @poff=671
...
0x45c: @@ GetPosition(Stack[-3]); Obj=7 // @poff=10
0x45d: Pop(0)
...
0x468: Pop(0)
0x469: @@ GetEyesHeight(Stack[-1]); Obj=5 // @poff=146
0x46a: Pop(0)
...
0x4b0: Push("GenerateMoney: iMin > iMax") // @poff=675
0x4b1: @ Trace(Stack[-1])
0x4b2: Pop(1)
0x4b3: Return(); Pop(8)
...
0x4db: Stack[-1] = "rifle_ammo" // @poff=741
0x4dc: Call 0x4f0
...
0x544: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=440
0x545: Pop(1)
0x546: Push(Stack[-1])
...
0x56e: @@ in(Stack[-2], Stack[-4]); Obj=1 // @poff=440
0x56f: Pop(1)
0x570: Push(Stack[-1])
...
0x582: Stack[-8] = Stack[-2]
0x583: Stack[-1] = "reputation" // @poff=777
0x584: Call 0x38b
...
0x58a: Push("reputation") // @poff=777
0x58b: @@ GetProperty(Stack[-1], Stack[-3]); Obj=6 // @poff=525
0x58c: Pop(1)
