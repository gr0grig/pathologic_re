...
Strings:
	...
	W:sound0
	W:sound
// @pool_raw:476574506f736974696f6e00476574526567696f6e427950740070006c006100790065007200000052006500670069006f006e00000053007400610074006500000073006f0075006e0064003000000073006f0075006e0064000000
// @pool_encoding:utf8
...
0x35: Pop(1)
0x36: Pop(0); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-2]);
0x37: Push((int) 1)
...
0x60: Pop(1)
0x61: Pop(0); PushNull((bool) Stack[-3] == 0)
...
0x9d: Stack[-1] = (bool) 1
0x9e: IF (Stack[-1] == 1) GOTO 0xaa; Pop(1)
...
0xa9: Stack[-1] = (bool) 0
0xaa: IF (Stack[-1] == 1) GOTO 0xb6; Pop(1)
...
0xb5: Stack[-1] = (bool) 0
0xb6: IF (Stack[-1] == 1) GOTO 0xc2; Pop(1)
...
0xd9: Pop(0)
0xda: @@ GetPosition(Stack[-2]); Obj=7 // @poff=0
0xdb: Pop(0)
...
0xe4: Pop(0)
0xe5: @@ GetRegionByPt(Stack[-2], Stack[-1]); Obj=3 // @poff=12
0xe6: Pop(1)
0xe7: Stack[-1] = Stack[-5]
0xe8: Return(); Pop(4)

0xe9: Stack[-2] = 0
0xea: PushEmpty(object, object)
0xeb: Push("player") // @poff=26
...
0xfe: PushEmpty()
0xff: Push("Region") // @poff=40
0x100: Pop(1); Push(Stack[-1] + Stack[-2]);
0x101: Push("State") // @poff=54
...
0x176: IF (Stack[-1] == 1) GOTO 0x17b; Pop(1)
