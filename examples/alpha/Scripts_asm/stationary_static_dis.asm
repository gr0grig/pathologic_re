...
0x14: Push((int) 4)
0x15: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] / Stack[-1]);
0x16: Push((int) 256)
...
0x27: Pop(0)
0x28: Push((int) 255)
0x29: @@ BlockPolygons(Stack[-0]T, Stack[-1]); Obj=2 // @poff=0
0x2a: Pop(1)
0x2b: Push((bool) 1)
...
0x38: Pop(1)
0x39: Push((int) 255)
0x3a: @@ UnblockPolygons(Stack[-0]T, Stack[-1]); Obj=2 // @poff=14
0x3b: Pop(1)
0x3c: Stack[-1] = 0
0x3d: GOTO 0x43
