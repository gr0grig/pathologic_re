...
Strings:
	...
	W:slot
	A:GetItemID
// @pool_raw:
...
0x21: @@@ size(Stack[-3]); Obj=0 // @poff=40
0x22: Pop(0)
0x23: Stack[-2] = (int) 0
0x24: Pop(0); Push((bool) Stack[-2] < Stack[-3])
0x25: IF (Stack[-1] == 0) GOTO 0x34; Pop(1)

0x26: @@@ get(Stack[-1], Stack[-2]); Obj=0 // @poff=45
0x27: Pop(0)
...
0x37: @ CreateObjectVector(Stack[-0]T)
0x38: Pop(0)
0x39: @ CreateFloatVector(Stack[-1]T)
0x3a: Pop(0)
0x3b: @ CreateIntVector(Stack[-3]T)
0x3c: Pop(0)
0x3d: @ CreateIntVector(Stack[-4]T)
0x3e: Pop(0)
0x3f: Push("player") // @poff=49
0x40: @ FindActor(Stack[-2]T, Stack[-1])
0x41: Pop(1)
...
0x47: Push((int) 2)
0x48: @@@ GetItemCount(Stack[-8], Stack[-1]); Obj=2 // @poff=63
0x49: Pop(1)
0x4a: Stack[-6] = (int) 0
...
0x4d: Push((int) 2)
0x4e: @@@ GetItem(Stack[-6], Stack[-7], Stack[-1]); Obj=2 // @poff=76
0x4f: Pop(1)
0x50: PushEmpty(int, object)
0x51: Stack[-7] = Stack[-1]
0x52: Call 0x1be

0x53: Stack[-2] = Stack[-6]
0x54: Pop(2)
0x55: Push("Agony") // @poff=84
...
0x61: Push("Agony") // @poff=84
0x62: @ GetInvItemProperty(Stack[-3], Stack[-5], Stack[-1])
0x63: Pop(1)
0x64: @@@ GetItemCountOfType(Stack[-1], Stack[-4]); Obj=2 // @poff=96
0x65: Pop(0)
0x66: @@@ add(Stack[-5]); Obj=0 // @poff=115
0x67: Pop(0)
0x68: @@@ add(Stack[-2]); Obj=1 // @poff=115
0x69: Pop(0)
0x6a: @@@ add(Stack[-1]); Obj=4 // @poff=115
0x6b: Pop(0)
0x6c: Push((int) 0)
0x6d: @@@ add(Stack[-1]); Obj=3 // @poff=115
0x6e: Pop(1)
0x6f: Stack[-5] = 0
0x70: Push((int) 1)
...
0x7a: @@@ size(Stack[-5]); Obj=0 // @poff=40
0x7b: Pop(0)
0x7c: Stack[-4] = (int) 0
0x7d: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x7e: IF (Stack[-1] == 0) GOTO 0x8b; Pop(1)

0x7f: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=45
0x80: Pop(0)
0x81: @@@ get(Stack[-2], Stack[-4]); Obj=1 // @poff=45
0x82: Pop(0)
0x83: @@@ get(Stack[-1], Stack[-4]); Obj=3 // @poff=45
0x84: Pop(0)
...
0x9f: @@@ get(Stack[-3], Stack[-4]); Obj=0 // @poff=45
0xa0: Pop(0)
0xa1: @@@ get(Stack[-2], Stack[-4]); Obj=3 // @poff=45
0xa2: Pop(0)
0xa3: @@@ get(Stack[-1], Stack[-4]); Obj=4 // @poff=45
0xa4: Pop(0)
0xa5: Push(Stack[-2])
...
0xf4: Push((int) 2)
0xf5: @@@ GetItemCount(Stack[-9], Stack[-1]); Obj=2 // @poff=63
0xf6: Pop(1)
0xf7: Stack[-7] = (int) -1
0xf8: Stack[-5] = (int) 0
...
0xfb: Push((int) 2)
0xfc: @@@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=2 // @poff=76
0xfd: Pop(1)
0xfe: PushEmpty(int, object)
0xff: Stack[-6] = Stack[-1]
0x100: Call 0x1be

0x101: Stack[-2] = Stack[-5]
0x102: Pop(2)
0x103: Pop(0); Push((bool) Stack[-3] == Stack[-17])
0x104: IF (Stack[-1] == 0) GOTO 0x125; Pop(1)

0x105: Push("disease") // @poff=151
0x106: @@ HasProperty(Stack[-3], Stack[-1]); Obj=5 // @poff=167
0x107: Pop(1)
...
0x10e: IF (Stack[-1] == 1) GOTO 0x113; Pop(1)
...
0x114: Stack[-5] = Stack[-7]
0x115: Stack[-6] = (int) 0
0x116: GOTO 0x125

0x117: Push("disease") // @poff=151
0x118: @@ GetProperty(Stack[-2], Stack[-1]); Obj=5 // @poff=28
0x119: Pop(1)
0x11a: PushEmpty(bool)
0x11b: Stack[-1] = (bool) 1
0x11c: Push((int) -1)
0x11d: Pop(1); Push((bool) Stack[-9] == Stack[-1])
0x11e: IF (Stack[-1] == 1) GOTO 0x122; Pop(1)

0x11f: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x120: IF (Stack[-1] == 1) GOTO 0x122; Pop(1)

0x121: Stack[-1] = (bool) 0
0x122: IF (Stack[-1] == 0) GOTO 0x125; Pop(1)

0x123: Stack[-5] = Stack[-7]
0x124: Stack[-1] = Stack[-6]
0x125: Stack[-4] = 0
0x126: Push((int) 1)
...
0x154: Pop(1)
0x155: Push((float)0.0010000000474974513)
0x156: Pop(1); Push((bool) Stack[-2] < Stack[-1])
0x157: IF (Stack[-1] == 0) GOTO 0x159; Pop(1)

0x158: Stack[-1] = (int) 0
0x159: Push("Do ") // @poff=190
0x15a: Pop(1); Push(Stack[-1] + Stack[-2]);
0x15b: @ Trace(Stack[-1])
0x15c: Pop(1)
0x15d: Push("agony") // @poff=16
0x15e: @@@ SetProperty(Stack[-1], Stack[-2]); Obj=5 // @poff=198
0x15f: Pop(1)
0x160: PushEmpty()
0x161: Call 0x131
...
0x167: @@@ size(Stack[-2]); Obj=3 // @poff=40
0x168: Pop(0)
0x169: Stack[-1] = (int) 0
...
0x16c: Push((int) 0)
0x16d: @@@ set(Stack[-2], Stack[-1]); Obj=3 // @poff=210
0x16e: Pop(1)
0x16f: Push((int) 1)
...
0x17a: @@@ size(Stack[-4]); Obj=3 // @poff=40
0x17b: Pop(0)
...
0x17f: @@@ get(Stack[-3], Stack[-9]); Obj=0 // @poff=45
0x180: Pop(0)
0x181: @@@ get(Stack[-2], Stack[-9]); Obj=4 // @poff=45
0x182: Pop(0)
0x183: @@@ get(Stack[-1], Stack[-9]); Obj=3 // @poff=45
0x184: Pop(0)
...
0x18a: @@@ set(Stack[-9], Stack[-1]); Obj=3 // @poff=210
0x18b: Pop(0)
0x18c: PushEmpty()
0x18d: Call 0x96
...
0x195: @@@ size(Stack[-3]); Obj=3 // @poff=40
0x196: Pop(0)
...
0x19a: @@@ get(Stack[-2], Stack[-7]); Obj=0 // @poff=45
0x19b: Pop(0)
0x19c: @@@ get(Stack[-1], Stack[-7]); Obj=3 // @poff=45
0x19d: Pop(0)
0x19e: Push((int) 0)
...
0x1a4: @@@ set(Stack[-7], Stack[-1]); Obj=3 // @poff=210
0x1a5: Pop(0)
0x1a6: PushEmpty()
0x1a7: Call 0x96
...
0x1bf: @@ GetItemID(Stack[-1]); Obj=3 // @poff=236
0x1c0: Pop(0)
