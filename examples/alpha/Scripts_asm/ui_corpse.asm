...
Strings:
	...
	W:has slot
	W:squirt
// @pool_raw:7300630061006c00700065006c000000680061007300200073006c006f00740000007300710075006900720074000000
...
0x11: Push("has slot") // @poff=16
0x12: @ UITrace(Stack[-1])
0x13: Pop(1)
0x14: GOTO 0x1f

0x15: Push("squirt") // @poff=34
