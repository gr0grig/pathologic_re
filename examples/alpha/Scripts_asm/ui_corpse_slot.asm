...
0x33: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=16
0x34: Pop(0)
0x35: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x36: Pop(0)
0x37: @ LoadImage(Stack[-3]T)
0x38: Pop(0)
0x39: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x3a: Pop(0)
0x3b: Push((int) 1)
0x3c: Push("") // @poff=13
0x3d: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x3e: Pop(2)
0x3f: GOTO 0x44
