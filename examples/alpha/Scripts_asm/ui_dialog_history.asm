...
0x3: @ CreateStringVector(Stack[-8]T)
0x4: Pop(0)
0x5: @ CreateStringVector(Stack[-9]T)
0x6: Pop(0)
0x7: @ GetConversation(Stack[-1])
0x8: Pop(0)
0x9: Pop(0); PushNull((bool) Stack[-1] == 0)
0xa: IF (Stack[-1] == 0) GOTO 0xf; Pop(1)

0xb: Push("null conversation") // @poff=0
0xc: @ UITrace(Stack[-1])
0xd: Pop(1)
0xe: Return(); Pop(2)

0xf: @@ GetNPCName(Stack[-10]T); Obj=1 // @poff=36
0x10: Pop(0)
0x11: @ _strupr(Stack[-10]T)
0x12: Pop(0)
0x13: @@ GetPlayerName(Stack[-11]T); Obj=1 // @poff=47
0x14: Pop(0)
0x15: @ _strupr(Stack[-11]T)
0x16: Pop(0)
0x17: @ GetWindowSize(Stack[-6]T, Stack[-7]T)
0x18: Pop(0)
0x19: PushEmpty()
0x1a: Call 0x27
...
0x30: Push((int) 16484)
0x31: Push("h_scrollbar") // @poff=61
0x32: @ SendMessage(Stack[-2], Stack[-1])
0x33: Pop(2)
0x34: GOTO 0x39

0x35: Push((int) 100)
0x36: Push("h_scrollbar") // @poff=61
...
0x3c: Stack[-4] = (int) 0
0x3d: @@@ size(Stack[-6]); Obj=8 // @poff=85
0x3e: Pop(0)
0x3f: Stack[-3] = (int) 0
0x40: Pop(0); Push((bool) Stack[-3] < Stack[-6])
0x41: IF (Stack[-1] == 0) GOTO 0x5d; Pop(1)

0x42: @@@ get(Stack[-2], Stack[-3]); Obj=8 // @poff=90
0x43: Pop(0)
0x44: @@@ get(Stack[-1], Stack[-3]); Obj=9 // @poff=90
0x45: Pop(0)
0x46: Push("default") // @poff=94
0x47: Push((int) 159)
0x48: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x4e: Push("default") // @poff=94
0x4f: Push((int) 159)
0x50: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x5d: Stack[-4] = Stack[-13]
0x5e: Return(); Pop(12)

0x5f: PushEmpty(int, int, int, string, string, int, int, int, int, string, string, int)
0x60: Stack[-6] = Stack[1 + Tasks[-1].StackPointer]
0x61: @@@ size(Stack[-5]); Obj=8 // @poff=85
0x62: Pop(0)
0x63: Stack[-4] = (int) 0
0x64: Pop(0); Push((bool) Stack[-4] < Stack[-5])
0x65: IF (Stack[-1] == 0) GOTO 0x93; Pop(1)

0x66: @@@ get(Stack[-3], Stack[-4]); Obj=8 // @poff=90
0x67: Pop(0)
0x68: @@@ get(Stack[-2], Stack[-4]); Obj=9 // @poff=90
0x69: Pop(0)
0x6a: Push("default") // @poff=94
0x6b: Push((int) 159)
0x6c: Push((int) 159)
0x6d: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
0x6e: Push((float)0.8040000200271606)
0x6f: Push((float)0.8040000200271606)
0x70: Push((float)0.8040000200271606)
0x71: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0x72: Pop(6)
0x73: Push("default") // @poff=94
0x74: Push((int) 0)
0x75: Push((float)0.8040000200271606)
0x76: Push((float)0.8040000200271606)
0x77: Push((float)0.8040000200271606)
0x78: @ Print(Stack[-5], Stack[-4], Stack[-11], Stack[-10]T, Stack[-3], Stack[-2], Stack[-1])
0x79: Pop(5)
0x7a: Stack[-6] = Stack[-6] + Stack[-1]; Pop(0);
0x7b: Push((int) 10)
0x7c: Stack[-7] = Stack[-7] + Stack[-1]; Pop(1);
0x7d: Push("default") // @poff=94
0x7e: Push((int) 159)
0x7f: Push((int) 159)
0x80: Pop(1); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-1]);
0x81: Push((float)0.6980000138282776)
0x82: Push((float)0.6589999794960022)
0x83: Push((float)0.6470000147819519)
0x84: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-12], Stack[-4], Stack[-8], Stack[-3], Stack[-2], Stack[-1])
0x85: Pop(6)
0x86: Push("default") // @poff=94
0x87: Push((int) 0)
0x88: Push((float)0.6980000138282776)
0x89: Push((float)0.6589999794960022)
0x8a: Push((float)0.6470000147819519)
0x8b: @ Print(Stack[-5], Stack[-4], Stack[-11], Stack[-11]T, Stack[-3], Stack[-2], Stack[-1])
0x8c: Pop(5)
...
0x9d: Push("dialog_text") // @poff=110
...
0xa3: Pop(0)
0xa4: @@@ add(Stack[-2]); Obj=8 // @poff=134
0xa5: Pop(0)
0xa6: @@@ add(Stack[-1]); Obj=9 // @poff=134
0xa7: Pop(0)
0xa8: PushEmpty()
0xa9: Call 0x27
