...
Strings:
	...
	W:default
	W:history_text
// @pool_raw:70005f007300630072006f006c006c006200610072000000640065006600610075006c007400000068006900730074006f00720079005f0074006500780074000000
...
0x21: Pop(1); Push(Stack[-1] / Stack[1 + Tasks[-1].StackPointer]);
0x22: Push("p_scrollbar") // @poff=0
...
0x28: Pop(0)
0x29: Push("default") // @poff=24
0x2a: @ GetTextHeightInWidth(Stack[-8], Stack[-1], Stack[-5]T, Stack[-6])
0x2b: Pop(1)
0x2c: Stack[-7] = Stack[-6]
0x2d: Push((int) 15)
...
0x3d: Pop(0)
0x3e: Push("default") // @poff=24
0x3f: Push((int) 15)
0x40: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x4f: Pop(0)
0x50: Push("default") // @poff=24
0x51: Push((int) 0)
0x52: Push((float)0.8040000200271606)
0x53: Push((float)0.8040000200271606)
0x54: Push((float)0.8040000200271606)
0x55: @ PrintInWidth(Stack[-2]T, Stack[-5], Stack[-4], Stack[-11], Stack[-5]T, Stack[-10], Stack[-3], Stack[-2], Stack[-1])
0x56: Pop(5)
...
0x63: Push("default") // @poff=24
0x64: Push((int) 15)
0x65: Push((int) 15)
0x66: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x67: Push((float)1.0)
0x68: Push((float)1.0)
0x69: Push((float)1.0)
...
0x6d: Push("default") // @poff=24
0x6e: Push((int) 15)
0x6f: Push((int) 15)
0x70: Pop(1); Push(Stack[5 + Tasks[-1].StackPointer] - Stack[-1]);
0x71: Push((float)0.6980000138282776)
0x72: Push((float)0.6589999794960022)
0x73: Push((float)0.6470000147819519)
...
0x7e: Pop(0); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[2 + Tasks[-1].StackPointer]);
0x7f: Push((int) 15)
...
0x88: Pop(0)
0x89: Push("default") // @poff=24
0x8a: @ GetTextHeightInWidth(Stack[-5], Stack[-1], Stack[-5]T, Stack[-3])
0x8b: Pop(1)
0x8c: PushEmpty(bool)
0x8d: Stack[-1] = (bool) 0
...
0xa3: Push("history_text") // @poff=40
0xa4: @ SendMessage(Stack[-3]T, Stack[-1])
0xa5: Pop(1)
