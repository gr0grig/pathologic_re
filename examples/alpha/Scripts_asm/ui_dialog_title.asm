...
0xa: Push("null conversation") // @poff=0
0xb: @ UITrace(Stack[-1])
0xc: Pop(1)
0xd: Return(); Pop(2)

0xe: @@ GetNPCName(Stack[-0]T); Obj=1 // @poff=36
0xf: Pop(0)
0x10: @ _strupr(Stack[-0]T)
0x11: Pop(0)
0x12: @ ProcessEvents()
0x13: Pop(0)
0x14: Return(); Pop(2)
...
0x15: Stack[-1] = 0
0x16: Push("default") // @poff=47
0x17: Push((int) 0)
0x18: Push((int) 0)
0x19: Push((float)1.0)
0x1a: Push((float)1.0)
0x1b: Push((float)1.0)
0x1c: @ Print(Stack[-6], Stack[-5], Stack[-4], Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x1d: Pop(6)
0x1e: Return(); Pop(0)
