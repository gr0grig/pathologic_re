...
Strings:
	...
	W:button_othertasks
	W:text
// @pool_raw:640065006600610075006c007400000062007500740074006f006e005f006d0069007300730069006f006e00000062007500740074006f006e005f006400610079007400610073006b007300000062007500740074006f006e005f006f0074006800650072007400610073006b007300000074006500780074000000
...
0x19: PushEmpty()
0x1a: Push("button_mission") // @poff=16
...
0x1f: Push("button_daytasks") // @poff=46
...
0x24: Push("button_othertasks") // @poff=78
...
0x31: Push((int) 0)
0x32: Push("button_mission") // @poff=16
0x33: @ SendMessage(Stack[-2], Stack[-1])
0x34: Pop(2)
0x35: GOTO 0x3a

0x36: Push((int) 1)
0x37: Push("button_mission") // @poff=16
...
0x3d: Push((int) 0)
0x3e: Push("button_daytasks") // @poff=46
0x3f: @ SendMessage(Stack[-2], Stack[-1])
0x40: Pop(2)
0x41: GOTO 0x46

0x42: Push((int) 1)
0x43: Push("button_daytasks") // @poff=46
...
0x49: Push((int) 0)
0x4a: Push("button_othertasks") // @poff=78
0x4b: @ SendMessage(Stack[-2], Stack[-1])
0x4c: Pop(2)
0x4d: GOTO 0x52

0x4e: Push((int) 1)
0x4f: Push("button_othertasks") // @poff=78
0x50: @ SendMessage(Stack[-2], Stack[-1])
0x51: Pop(2)
0x52: Push("text") // @poff=114
