...
Strings:
	...
	W:button_plus
	W:button_minus
// @pool_raw:
...
0x20: Pop(0)
0x21: Push("sleeping") // @poff=46
0x22: Push((bool) 0)
0x23: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=64
0x24: Pop(2)
0x25: Return(); Pop(2)
...
0x29: Pop(0)
0x2a: Push("sleeping") // @poff=46
0x2b: Push((bool) 1)
0x2c: @@ SetProperty(Stack[-2], Stack[-1]); Obj=3 // @poff=64
0x2d: Pop(2)
...
0x35: Pop(0)
0x36: Pop(0); Push(Stack[1 + Tasks[-1].StackPointer] * Stack[-1]);
...
0x75: Pop(1); Push(Stack[-1] * Stack[1 + Tasks[-1].StackPointer]);
...
0x80: Pop(1); Push(Stack[-1] * Stack[1 + Tasks[-1].StackPointer]);
...
0x86: Push("dream_progress") // @poff=0
...
0x94: Push("dream_button") // @poff=162
...
0xa4: Push("button_plus") // @poff=188
...
0xb5: Push((int) 100)
0xb6: Pop(1); Push(Stack[-1] * Stack[2 + Tasks[-1].StackPointer]);
0xb7: Push((float)6.0)
0xb8: Pop(2); Push(Stack[-2] / Stack[-1]);
0xb9: Push("dream_progress") // @poff=0
0xba: @ SendMessage(Stack[-2], Stack[-1])
0xbb: Pop(2)
0xbc: GOTO 0xd5

0xbd: Push("button_minus") // @poff=212
...
0xce: Push((int) 100)
0xcf: Pop(1); Push(Stack[-1] * Stack[2 + Tasks[-1].StackPointer]);
0xd0: Push((float)6.0)
0xd1: Pop(2); Push(Stack[-2] / Stack[-1]);
0xd2: Push("dream_progress") // @poff=0
