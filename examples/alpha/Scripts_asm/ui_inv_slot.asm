...
0x38: Push("selected") // @poff=16
0x39: @ SetBackground(Stack[-1])
0x3a: Pop(1)
0x3b: GOTO 0x3f

0x3c: Push("default") // @poff=0
...
0x4b: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=34
0x4c: Pop(0)
0x4d: @ GetInvItemSprite(Stack[-3]T, Stack[-1])
0x4e: Pop(0)
0x4f: @ LoadImage(Stack[-3]T)
0x50: Pop(0)
0x51: @ GetInvItemMaxStackSize(Stack[-1]T, Stack[-1])
0x52: Pop(0)
0x53: Push((int) 1)
0x54: Push("") // @poff=13
0x55: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x56: Pop(2)
0x57: GOTO 0x5c
