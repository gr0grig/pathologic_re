...
Strings:
	...
	W:Group
	A:SetItemAmount
// @pool_raw:
...
0x2a: Push("button_weapon") // @poff=16
...
0x2f: Push("button_clothes") // @poff=44
...
0x34: Push("button_medcine") // @poff=74
...
0x39: Push("button_food") // @poff=104
...
0x3e: Push("button_other") // @poff=128
...
0x43: Push("button_detector") // @poff=154
0x44: Pop(1); Push((bool) Stack[-15] == Stack[-1])
0x45: IF (Stack[-1] == 0) GOTO 0x47; Pop(1)

0x46: GOTO 0x95

0x47: Push("button_anticeptic") // @poff=186
...
0x64: Stack[-8] = Stack[-1]
0x65: Call 0xdf

0x66: Stack[-3] = Stack[-7]
0x67: Pop(3)
0x68: GOTO 0x78
...
0x74: Stack[-8] = Stack[-1]
0x75: Call 0xdf

0x76: Stack[-3] = Stack[-6]
0x77: Pop(3)
0x78: GOTO 0x7c
...
0xcf: Pop(0)
0xd0: Pop(0); PushNull((bool) Stack[-2] == 0)
0xd1: IF (Stack[-1] == 0) GOTO 0xd4; Pop(1)

0xd2: Stack[-5] = (int) 0
0xd3: Return(); Pop(4)

0xd4: @@ GetCapacity(Stack[-1]); Obj=2 // @poff=292
0xd5: Pop(0)
...
0xe0: Push("MoveToContainer") // @poff=316
0xe1: @ Trace(Stack[-1])
0xe2: Pop(1)
...
0xe6: Pop(0)
0xe7: @@ GetItemCount(Stack[-4], Stack[-16]); Obj=6 // @poff=348
0xe8: Pop(0)
...
0xed: @@ GetItemAmount(Stack[-3], Stack[-15], Stack[-16]); Obj=6 // @poff=361
0xee: Pop(0)
0xef: @@ GetItem(Stack[-5], Stack[-15], Stack[-16]); Obj=6 // @poff=375
0xf0: Pop(0)
0xf1: @@ GetItemID(Stack[-2]); Obj=5 // @poff=383
0xf2: Pop(0)
0xf3: Push((int) 0)
0xf4: Push((int) 1)
0xf5: @@ AddItem(Stack[-3], Stack[-7], Stack[-2], Stack[-1]); Obj=9 // @poff=393
0xf6: Pop(2)
...
0xfb: Push((int) 1)
0xfc: @@ RemoveItem(Stack[-16], Stack[-1], Stack[-17]); Obj=7 // @poff=401
0xfd: Pop(1)
...
0x104: Push("MoveToPlayerContainer") // @poff=412
0x105: @ Trace(Stack[-1])
0x106: Pop(1)
...
0x10a: Pop(0)
0x10b: @@ GetItemCount(Stack[-7]); Obj=10 // @poff=348
0x10c: Pop(0)
...
0x111: @@ GetItemAmount(Stack[-6], Stack[-21]); Obj=10 // @poff=361
0x112: Pop(0)
0x113: Push((int) 0)
...
0x118: @@ GetItem(Stack[-8], Stack[-21]); Obj=10 // @poff=375
0x119: Pop(0)
0x11a: @@ GetItemID(Stack[-5]); Obj=8 // @poff=383
0x11b: Pop(0)
0x11c: Push("Category") // @poff=456
...
0x128: Pop(0)
0x129: @@ RemoveItem(Stack[-21], Stack[-6]); Obj=10 // @poff=401
0x12a: Pop(0)
0x12b: PushEmpty()
0x12c: Call 0x13f
...
0x130: Push((int) 1)
0x131: @@ AddItem(Stack[-2], Stack[-9], Stack[-5], Stack[-1]); Obj=10 // @poff=393
0x132: Pop(1)
...
0x137: Push((int) 1)
0x138: @@ RemoveItem(Stack[-22], Stack[-1]); Obj=11 // @poff=401
0x139: Pop(1)
0x13a: Stack[-4] = Stack[-22]
0x13b: Return(); Pop(20)
...
0x14e: Pop(0)
0x14f: @@ GetItemCount(Stack[-6]); Obj=7 // @poff=348
0x150: Pop(0)
0x151: PushEmpty(int)
0x152: Call 0xc6

0x153: Stack[-1] = Stack[-6]
0x154: Pop(1)
0x155: Stack[-4] = (int) 0
...
0x15a: @@ GetItem(Stack[-3], Stack[-4]); Obj=7 // @poff=375
0x15b: Pop(0)
0x15c: @@ GetItemID(Stack[-2]); Obj=3 // @poff=383
0x15d: Pop(0)
0x15e: @@ GetItemAmount(Stack[-1], Stack[-4]); Obj=7 // @poff=361
0x15f: Pop(0)
0x160: Push((int) 0)
0x161: PushEmpty(string, int)
0x162: Stack[-7] = Stack[-1]
0x163: Call 0xb1
...
0x17f: Pop(0)
0x180: @@ GetItemCount(Stack[-5], Stack[-13]); Obj=6 // @poff=348
0x181: Pop(0)
0x182: Stack[-4] = (int) 0
0x183: Push((int) 12)
...
0x188: @@ GetItem(Stack[-3], Stack[-4], Stack[-13]); Obj=6 // @poff=375
0x189: Pop(0)
0x18a: @@ GetItemAmount(Stack[-2], Stack[-4], Stack[-13]); Obj=6 // @poff=361
0x18b: Pop(0)
0x18c: @@ IsItemSelected(Stack[-1], Stack[-4], Stack[-13]); Obj=6 // @poff=486
0x18d: Pop(0)
0x18e: Push(Stack[-1])
...
0x1b9: Push((int) 0)
0x1ba: Push("button_weapon") // @poff=16
0x1bb: @ SendMessage(Stack[-2], Stack[-1])
0x1bc: Pop(2)
0x1bd: GOTO 0x1c2

0x1be: Push((int) 1)
0x1bf: Push("button_weapon") // @poff=16
...
0x1c5: Push((int) 0)
0x1c6: Push("button_clothes") // @poff=44
0x1c7: @ SendMessage(Stack[-2], Stack[-1])
0x1c8: Pop(2)
0x1c9: GOTO 0x1ce

0x1ca: Push((int) 1)
0x1cb: Push("button_clothes") // @poff=44
...
0x1d1: Push((int) 0)
0x1d2: Push("button_medcine") // @poff=74
0x1d3: @ SendMessage(Stack[-2], Stack[-1])
0x1d4: Pop(2)
0x1d5: GOTO 0x1da

0x1d6: Push((int) 1)
0x1d7: Push("button_medcine") // @poff=74
...
0x1dd: Push((int) 0)
0x1de: Push("button_food") // @poff=104
0x1df: @ SendMessage(Stack[-2], Stack[-1])
0x1e0: Pop(2)
0x1e1: GOTO 0x1e6

0x1e2: Push((int) 1)
0x1e3: Push("button_food") // @poff=104
...
0x1e9: Push((int) 0)
0x1ea: Push("button_other") // @poff=128
0x1eb: @ SendMessage(Stack[-2], Stack[-1])
0x1ec: Pop(2)
0x1ed: GOTO 0x1f2

0x1ee: Push((int) 1)
0x1ef: Push("button_other") // @poff=128
...
0x1f5: Pop(0)
0x1f6: @@ GetItemCount(Stack[-17], Stack[-38]); Obj=18 // @poff=348
0x1f7: Pop(0)
...
0x1fb: @@ GetItem(Stack[-16], Stack[-37], Stack[-38]); Obj=18 // @poff=375
0x1fc: Pop(0)
0x1fd: @@ GetItemID(Stack[-15]); Obj=16 // @poff=383
0x1fe: Pop(0)
0x1ff: @@ GetItemAmount(Stack[-14], Stack[-37], Stack[-38]); Obj=18 // @poff=361
0x200: Pop(0)
0x201: @@ IsItemSelected(Stack[-13], Stack[-37], Stack[-38]); Obj=18 // @poff=486
0x202: Pop(0)
0x203: Push((int) 0)
0x204: Pop(1); Push((bool) Stack[-39] == Stack[-1])
0x205: IF (Stack[-1] == 0) GOTO 0x224; Pop(1)

0x206: Push("Weapon") // @poff=501
...
0x20e: Push((bool) 0)
0x20f: @@ SelectItem(Stack[-38], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x210: Pop(1)
0x211: Push((int) -1)
...
0x21a: Push((bool) 0)
0x21b: @@ SelectItem(Stack[-12], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x21c: Pop(1)
0x21d: Push((int) 1)
...
0x220: Push((bool) 1)
0x221: @@ SelectItem(Stack[-38], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x222: Pop(1)
0x223: GOTO 0x268
...
0x232: Push((bool) 0)
0x233: @@ SelectItem(Stack[-38], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x234: Pop(1)
0x235: GOTO 0x258
...
0x239: @@ IsItemSelected(Stack[-7], Stack[-8], Stack[-38]); Obj=18 // @poff=486
0x23a: Pop(0)
...
0x23e: @@ GetItem(Stack[-6], Stack[-8], Stack[-38]); Obj=18 // @poff=375
0x23f: Pop(0)
0x240: @@ GetItemID(Stack[-5]); Obj=6 // @poff=383
0x241: Pop(0)
0x242: Push("Group") // @poff=526
...
0x24d: Push((bool) 0)
0x24e: @@ SelectItem(Stack[-9], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x24f: Pop(1)
0x250: GOTO 0x255
...
0x255: Push((bool) 1)
0x256: @@ SelectItem(Stack[-38], Stack[-1], Stack[-39]); Obj=19 // @poff=515
0x257: Pop(1)
0x258: GOTO 0x268
...
0x262: Push((int) 1)
0x263: @@ RemoveItem(Stack[-38], Stack[-1], Stack[-39]); Obj=19 // @poff=401
0x264: Pop(1)
0x265: GOTO 0x268

0x266: @@ SetItemAmount(Stack[-14], Stack[-37], Stack[-38]); Obj=18 // @poff=538
0x267: Pop(0)
0x268: PushEmpty(int)
0x269: Stack[-39] = Stack[-1]
0x26a: Call 0x17d
