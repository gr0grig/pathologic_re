...
// @pool_raw:
...
0x1: Push((float)0.009999999776482582)
...
0xa: @ GetMap(Stack[-19]T)
0xb: Pop(0)
0xc: Pop(0); PushNull((bool) Stack[19 + Tasks[-1].StackPointer] == 0)
0xd: IF (Stack[-1] == 0) GOTO 0x12; Pop(1)

0xe: Push("Map not found") // @poff=0
0xf: @ Trace(Stack[-1])
0x10: Pop(1)
0x11: Return(); Pop(16)

0x12: @@@ GetSize(Stack[-0]T, Stack[-1]T); Obj=19 // @poff=28
0x13: Pop(0)
0x14: @@@ GetMapParams(Stack[-8], Stack[-7], Stack[-13]T); Obj=19 // @poff=36
0x15: Pop(0)
0x16: @@@ ConvertToMapCoordinates(Stack[-8], Stack[-7]); Obj=19 // @poff=49
0x17: Pop(0)
...
0x1b: @ GetWindowSize(Stack[-2]T, Stack[-3]T)
0x1c: Pop(0)
...
0x2b: @ CreateObjectVector(Stack[-17]T)
0x2c: Pop(0)
0x2d: @ GetMainOutdoorScene(Stack[-6])
0x2e: Pop(0)
0x2f: @ GetActiveScene(Stack[-18]T)
0x30: Pop(0)
...
0x34: @@@ GetName(Stack[-5]); Obj=18 // @poff=73
0x35: Pop(0)
0x36: PushEmpty(cvector, string)
0x37: Push("pt_gmap_") // @poff=81
0x38: Stack[-2] = Stack[-1] + Stack[-8]; Pop(1);
0x39: Call 0x211

0x3a: Stack[21 + Tasks[-1].StackPointer] = Stack[-2]
0x3b: Pop(2)
0x3c: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0))
0x3d: Stack[-1] = Stack[-5]
0x3e: Pop(1)
0x3f: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2))
0x40: Stack[-1] = Stack[-4]
0x41: Pop(1)
0x42: @@@ ConvertToMapCoordinates(Stack[-4], Stack[-3]); Obj=19 // @poff=49
0x43: Pop(0)
0x44: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0))
0x45: Stack[-5] = Stack[-1]
0x46: CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0) = Stack[-1];
0x47: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2))
0x48: Stack[-4] = Stack[-1]
0x49: CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2) = Stack[-1];
0x4a: Push("indoor map: pt_gmap_") // @poff=99
0x4b: Pop(1); Push(Stack[-1] + Stack[-6]);
0x4c: @ Trace(Stack[-1])
0x4d: Pop(1)
0x4e: GOTO 0x5b

0x4f: Push("outdoor map") // @poff=141
0x50: @ Trace(Stack[-1])
0x51: Pop(1)
0x52: Stack[16 + Tasks[-1].StackPointer] = (bool)0
0x53: @ GetPlayerMapPos(Stack[-2], Stack[-1])
0x54: Pop(0)
0x55: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0))
0x56: Stack[-3] = Stack[-1]
0x57: CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0) = Stack[-1];
0x58: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2))
0x59: Stack[-2] = Stack[-1]
0x5a: CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2) = Stack[-1];
0x5b: @ ShowCursor()
0x5c: Pop(0)
0x5d: Push("default") // @poff=165
...
0x65: Pop(1)
0x66: Push("default") // @poff=165
0x67: @ SetBackground(Stack[-1])
0x68: Pop(1)
0x69: @ CaptureKeyboard()
0x6a: Pop(0)
0x6b: Push("map_open") // @poff=181
...
0x72: PushEmpty()
0x73: Push((int) 2)
0x74: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[-1]);
0x75: Pop(1); Push(Stack[-2] - Stack[-1]);
0x76: Pop(1); Push(Stack[-1] / Stack[13 + Tasks[-1].StackPointer]);
0x77: Stack[-3] = Stack[11 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x78: Return(); Pop(0)

0x79: PushEmpty()
0x7a: Push((int) 2)
0x7b: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[-1]);
0x7c: Pop(1); Push(Stack[-2] - Stack[-1]);
0x7d: Pop(1); Push(Stack[-1] / Stack[13 + Tasks[-1].StackPointer]);
0x7e: Stack[-3] = Stack[12 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x7f: Return(); Pop(0)

0x80: PushEmpty()
0x81: Pop(0); Push(Stack[-1] - Stack[11 + Tasks[-1].StackPointer]);
0x82: Pop(1); Push(Stack[-1] * Stack[13 + Tasks[-1].StackPointer]);
0x83: Push((int) 2)
0x84: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[-1]);
0x85: Stack[-4] = Stack[-2] + Stack[-1]; Pop(2);
0x86: Return(); Pop(0)

0x87: PushEmpty()
0x88: Pop(0); Push(Stack[-1] - Stack[12 + Tasks[-1].StackPointer]);
0x89: Pop(1); Push(Stack[-1] * Stack[13 + Tasks[-1].StackPointer]);
0x8a: Push((int) 2)
0x8b: Pop(1); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[-1]);
...
0x8f: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x90: Push((int) 2)
0x91: Pop(2); Push(Stack[-2] / Stack[-1]);
0x92: Stack[-20] = Stack[11 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x93: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x94: Push((int) 2)
0x95: Pop(2); Push(Stack[-2] / Stack[-1]);
0x96: Stack[-19] = Stack[11 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x97: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x98: Push((int) 2)
0x99: Pop(2); Push(Stack[-2] / Stack[-1]);
0x9a: Stack[-18] = Stack[12 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x9b: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x9c: Push((int) 2)
...
0xb7: @@@ clear(); Obj=17 // @poff=199
0xb8: Pop(0)
0xb9: Stack[-10] = (int) 0
0xba: @@@ GetMarkCount(Stack[-11]); Obj=19 // @poff=205
0xbb: Pop(0)
0xbc: Stack[-9] = (int) 0
0xbd: Pop(0); Push((bool) Stack[-9] < Stack[-11])
0xbe: IF (Stack[-1] == 0) GOTO 0xec; Pop(1)

0xbf: @@@ GetMark(Stack[-9], Stack[-8]); Obj=19 // @poff=218
0xc0: Pop(0)
0xc1: @@ GetLocator(Stack[-7]); Obj=8 // @poff=226
0xc2: Pop(0)
0xc3: PushEmpty(cvector, string)
0xc4: Stack[-9] = Stack[-1]
0xc5: Call 0x211

0xc6: Stack[-2] = Stack[-8]
0xc7: Pop(2)
0xc8: Push(CvectorIndex(Stack[-6], 0))
0xc9: Stack[-1] = Stack[-14]
0xca: Pop(1)
0xcb: Push(CvectorIndex(Stack[-6], 2))
0xcc: Stack[-1] = Stack[-13]
0xcd: Pop(1)
0xce: @@@ ConvertToMapCoordinates(Stack[-13], Stack[-12]); Obj=19 // @poff=49
0xcf: Pop(0)
0xd0: PushEmpty(int, int)
0xd1: Stack[-15] = Stack[-1]
0xd2: Call 0x80

0xd3: Stack[-2] = Stack[-15]
0xd4: Pop(2)
0xd5: PushEmpty(int, int)
0xd6: Stack[-14] = Stack[-1]
0xd7: Call 0x87

0xd8: Stack[-2] = Stack[-14]
0xd9: Pop(2)
0xda: Pop(0); Push(Stack[-13] - Stack[4 + Tasks[-1].StackPointer]);
0xdb: Pop(0); Push(Stack[-14] - Stack[4 + Tasks[-1].StackPointer]);
0xdc: Pop(2); Push(Stack[-2] * Stack[-1]);
0xdd: Pop(0); Push(Stack[-13] - Stack[5 + Tasks[-1].StackPointer]);
0xde: Pop(0); Push(Stack[-14] - Stack[5 + Tasks[-1].StackPointer]);
...
0xe4: @@@ add(Stack[-8]); Obj=17 // @poff=237
0xe5: Pop(0)
0xe6: Push((int) 1)
...
0xf1: Stack[-2] = Stack[-5]
0xf2: Pop(2)
0xf3: PushEmpty(int, int)
0xf4: Stack[-1] = Stack[5 + Tasks[-1].StackPointer]
0xf5: Call 0x79

0xf6: Stack[-2] = Stack[-4]
0xf7: Pop(2)
0xf8: @@@ GetObjectFromPoint(Stack[-5], Stack[-3], Stack[-2]); Obj=19 // @poff=241
0xf9: Pop(0)
0xfa: Push((int) 0)
0xfb: Pop(1); Push((bool) Stack[-6] >= Stack[-1])
0xfc: IF (Stack[-1] == 0) GOTO 0x10c; Pop(1)

0xfd: @@@ GetObjectID(Stack[-4], Stack[-5]); Obj=19 // @poff=260
0xfe: Pop(0)
...
0x108: @@@ CreateObjectHighlight(Stack[-20]T, Stack[-5]); Obj=19 // @poff=272
0x109: Pop(0)
...
0x113: Push((int) 2)
0x114: Push("") // @poff=25
0x115: @ SetTooltip(Stack[-2], Stack[-1], Stack[-17]T)
0x116: Pop(2)
...
0x120: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x121: Push((int) 2)
0x122: Pop(2); Push(Stack[-2] / Stack[-1]);
0x123: Stack[-17] = Stack[11 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x124: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x125: Push((int) 2)
0x126: Pop(2); Push(Stack[-2] / Stack[-1]);
0x127: Stack[-16] = Stack[11 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x128: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x129: Push((int) 2)
0x12a: Pop(2); Push(Stack[-2] / Stack[-1]);
0x12b: Stack[-15] = Stack[12 + Tasks[-1].StackPointer] - Stack[-1]; Pop(1);
0x12c: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] / Stack[13 + Tasks[-1].StackPointer]);
0x12d: Push((int) 2)
...
0x133: Pop(0)
0x134: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-12]);
0x135: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-12]);
...
0x13a: Pop(0); Push(Stack[2 + Tasks[-1].StackPointer] + Stack[-12]);
0x13b: Pop(0); Push(Stack[3 + Tasks[-1].StackPointer] + Stack[-12]);
0x13c: @@@ Render(Stack[-14], Stack[-13], Stack[-2], Stack[-1], Stack[-18], Stack[-16], Stack[-17], Stack[-15]); Obj=20 // @poff=294
0x13d: Pop(2)
0x13e: @@@ GetMarkCount(Stack[-8]); Obj=19 // @poff=205
0x13f: Pop(0)
0x140: Stack[-7] = (int) 0
0x141: Pop(0); Push((bool) Stack[-7] < Stack[-8])
0x142: IF (Stack[-1] == 0) GOTO 0x182; Pop(1)

0x143: @@@ GetMark(Stack[-7], Stack[-6]); Obj=19 // @poff=218
0x144: Pop(0)
0x145: @@ GetLocator(Stack[-5]); Obj=6 // @poff=226
0x146: Pop(0)
0x147: @@ GetType(Stack[-4]); Obj=6 // @poff=301
0x148: Pop(0)
0x149: PushEmpty(cvector, string)
0x14a: Stack[-7] = Stack[-1]
0x14b: Call 0x211

0x14c: Stack[-2] = Stack[-5]
0x14d: Pop(2)
0x14e: Push(CvectorIndex(Stack[-3], 0))
0x14f: Stack[-1] = Stack[-11]
0x150: Pop(1)
0x151: Push(CvectorIndex(Stack[-3], 2))
0x152: Stack[-1] = Stack[-10]
0x153: Pop(1)
0x154: @@@ ConvertToMapCoordinates(Stack[-10], Stack[-9]); Obj=19 // @poff=49
0x155: Pop(0)
0x156: PushEmpty(int, int)
0x157: Stack[-12] = Stack[-1]
0x158: Call 0x80

0x159: Stack[-2] = Stack[-12]
0x15a: Pop(2)
0x15b: PushEmpty(int, int)
0x15c: Stack[-11] = Stack[-1]
0x15d: Call 0x87

0x15e: Stack[-2] = Stack[-11]
0x15f: Pop(2)
0x160: Push((int) 0)
0x161: Pop(1); Push((bool) Stack[-5] == Stack[-1])
0x162: IF (Stack[-1] == 0) GOTO 0x16a; Pop(1)

0x163: Push("quest_mark") // @poff=309
0x164: Push((int) 16)
...
0x16d: Push("mainquest_mark") // @poff=331
0x16e: Push((int) 16)
...
0x185: Pop(0)
0x186: Push((float)6.28000020980835)
0x187: Pop(1); Push(Stack[-3] / Stack[-1]);
0x188: Push((int) 16)
0x189: Stack[-3] = Stack[-2] * Stack[-1]; Pop(2);
0x18a: PushEmpty(int, int)
0x18b: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0))
0x18c: Stack[-1] = Stack[-2]
0x18d: Pop(1)
0x18e: Call 0x80

0x18f: Stack[-2] = Stack[-12]
0x190: Pop(2)
0x191: PushEmpty(int, int)
0x192: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2))
0x193: Stack[-1] = Stack[-2]
0x194: Pop(1)
0x195: Call 0x87

0x196: Stack[-2] = Stack[-11]
0x197: Pop(2)
0x198: Push("player") // @poff=381
...
0x1a2: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 0))
0x1a3: Stack[-1] = Stack[-2]
0x1a4: Pop(1)
0x1a5: Call 0x80

0x1a6: Stack[-2] = Stack[-12]
0x1a7: Pop(2)
0x1a8: PushEmpty(int, int)
0x1a9: Push(CvectorIndex(Stack[21 + Tasks[-1].StackPointer], 2))
0x1aa: Stack[-1] = Stack[-2]
0x1ab: Pop(1)
0x1ac: Call 0x87

0x1ad: Stack[-2] = Stack[-11]
0x1ae: Pop(2)
0x1af: Push("player0") // @poff=395
0x1b0: Push((int) 8)
...
0x1d2: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[-2]);
0x1d3: Pop(1); Push(Stack[-1] / Stack[13 + Tasks[-1].StackPointer]);
0x1d4: Stack[11 + Tasks[-1].StackPointer] = Stack[8 + Tasks[-1].StackPointer] + Stack[-1]; Pop(1);
0x1d5: Pop(0); Push(Stack[7 + Tasks[-1].StackPointer] - Stack[-1]);
0x1d6: Pop(1); Push(Stack[-1] / Stack[13 + Tasks[-1].StackPointer]);
...
0x1db: Push((float)1.399999976158142)
...
0x1e2: Push((float)1.399999976158142)
...
0x1eb: PushEmpty()
0x1ec: Push("button_plus") // @poff=421
...
0x1f1: Pop(0)
0x1f2: Push("button_minus") // @poff=445
...
0x20a: @@@ ConvertToWorldCoordinates(Stack[-2], Stack[-1]); Obj=19 // @poff=471
0x20b: Pop(0)
0x20c: @@@ SetMapParams(Stack[-2], Stack[-1], Stack[-13]T); Obj=19 // @poff=497
0x20d: Pop(0)
0x20e: @ DestroyWindow()
0x20f: Pop(0)
0x210: Return(); Pop(4)
...
0x213: Pop(0)
0x214: Pop(0); PushNull((bool) Stack[-3] == 0)
0x215: IF (Stack[-1] == 0) GOTO 0x21c; Pop(1)

0x216: Push("Can't find main outdoor scene") // @poff=510
0x217: @ Trace(Stack[-1])
0x218: Pop(1)
0x219: Stack[-5] = CVector(0.0, 0.0, 0.0)
0x21a: Stack[-5] = Stack[-12]
0x21b: Return(); Pop(10)

0x21c: @@ GetLocator(Stack[-11], Stack[-1], Stack[-5], Stack[-4]); Obj=3 // @poff=226
0x21d: Pop(0)
0x21e: Stack[-5] = Stack[-12]
0x21f: Return(); Pop(10)
