...
0xd: Push("text") // @poff=0
0xe: @ SendMessage(Stack[-2], Stack[-1])
0xf: Pop(2)
0x10: @ ShowCursor()
0x11: Pop(0)
0x12: Push("default") // @poff=10
