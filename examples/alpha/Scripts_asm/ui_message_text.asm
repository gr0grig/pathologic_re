...
Strings:
	...
	W:default
	W:scrollbar
// @pool_raw:616464006765740073697a6500640065006600610075006c00740000007300630072006f006c006c006200610072000000
// @pool_encoding:utf8
...
0x17: Pop(0)
0x18: @@@ add(Stack[-10]); Obj=7 // @poff=0
0x19: Pop(0)
0x1a: @ CreateStringVector(Stack[-10])
0x1b: Pop(0)
0x1c: @@@ add(Stack[-10]); Obj=8 // @poff=0
0x1d: Pop(0)
0x1e: @ CreateIntVector(Stack[-10])
0x1f: Pop(0)
0x20: @@@ add(Stack[-10]); Obj=9 // @poff=0
0x21: Pop(0)
0x22: Stack[-10] = 0
0x23: Push((int) 1)
...
0x2f: @@@ get(Stack[-3], Stack[-4]); Obj=7 // @poff=4
0x30: Pop(0)
0x31: @@@ get(Stack[-2], Stack[-4]); Obj=8 // @poff=4
0x32: Pop(0)
0x33: @@@ get(Stack[-1], Stack[-4]); Obj=9 // @poff=4
0x34: Pop(0)
0x35: @@ add(Stack[-6]); Obj=3 // @poff=0
0x36: Pop(0)
0x37: @@ add(Stack[-5]); Obj=2 // @poff=0
0x38: Pop(0)
0x39: @@ add(Stack[-8]); Obj=1 // @poff=0
0x3a: Pop(0)
0x3b: Stack[-1] = 0
0x3c: Stack[-2] = 0
0x3d: Stack[-3] = 0
...
0x4f: Stack[-10] = (int) 0
0x50: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0x51: Pop(0)
0x52: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0x53: Pop(0)
0x54: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0x55: Pop(0)
0x56: @@ size(Stack[-6]); Obj=9 // @poff=8
0x57: Pop(0)
0x58: Stack[-5] = (int) 0
0x59: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0x5a: IF (Stack[-1] == 0) GOTO 0x77; Pop(1)

0x5b: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0x5c: Pop(0)
0x5d: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0x5e: Pop(0)
0x5f: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0x60: Pop(0)
0x61: Push("default") // @poff=13
0x62: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0x63: Pop(1)
...
0x69: Push("default") // @poff=13
0x6a: Push((int) 15)
0x6b: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0x7e: @@@ get(Stack[-10], Stack[-4]T); Obj=7 // @poff=4
0x7f: Pop(0)
0x80: @@@ get(Stack[-9], Stack[-4]T); Obj=8 // @poff=4
0x81: Pop(0)
0x82: @@@ get(Stack[-8], Stack[-4]T); Obj=9 // @poff=4
0x83: Pop(0)
0x84: @@ size(Stack[-7]); Obj=10 // @poff=8
0x85: Pop(0)
0x86: Stack[-6] = (int) 0
0x87: Pop(0); Push((bool) Stack[-6] < Stack[-7])
0x88: IF (Stack[-1] == 0) GOTO 0xb0; Pop(1)

0x89: Stack[-11] = Stack[-5]
0x8a: @@ get(Stack[-4], Stack[-6]); Obj=10 // @poff=4
0x8b: Pop(0)
0x8c: @@ get(Stack[-3], Stack[-6]); Obj=9 // @poff=4
0x8d: Pop(0)
0x8e: @@ get(Stack[-2], Stack[-6]); Obj=8 // @poff=4
0x8f: Pop(0)
0x90: Push("default") // @poff=13
0x91: @ GetTextHeightInWidth(Stack[-2], Stack[-1], Stack[-2]T, Stack[-5])
0x92: Pop(1)
...
0x98: Push("default") // @poff=13
0x99: Push((int) 15)
0x9a: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
...
0xba: @@@ get(Stack[-9], Stack[-4]T); Obj=7 // @poff=4
0xbb: Pop(0)
0xbc: @@@ get(Stack[-8], Stack[-4]T); Obj=8 // @poff=4
0xbd: Pop(0)
0xbe: @@@ get(Stack[-7], Stack[-4]T); Obj=9 // @poff=4
0xbf: Pop(0)
0xc0: @@ size(Stack[-6]); Obj=9 // @poff=8
0xc1: Pop(0)
0xc2: Stack[-5] = (int) 0
0xc3: Pop(0); Push((bool) Stack[-5] < Stack[-6])
0xc4: IF (Stack[-1] == 0) GOTO 0xff; Pop(1)

0xc5: @@ get(Stack[-4], Stack[-5]); Obj=9 // @poff=4
0xc6: Pop(0)
0xc7: @@ get(Stack[-3], Stack[-5]); Obj=8 // @poff=4
0xc8: Pop(0)
0xc9: @@ get(Stack[-2], Stack[-5]); Obj=7 // @poff=4
0xca: Pop(0)
0xcb: Pop(0); Push((bool) Stack[-2] == Stack[6 + Tasks[-1].StackPointer])
0xcc: IF (Stack[-1] == 0) GOTO 0xd5; Pop(1)

0xcd: Push("default") // @poff=13
0xce: Push((int) 0)
0xcf: Push((float)1.0)
0xd0: Push((float)1.0)
0xd1: Push((float)1.0)
0xd2: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0xd3: Pop(5)
0xd4: GOTO 0xdc

0xd5: Push("default") // @poff=13
0xd6: Push((int) 0)
0xd7: Push((float)0.8040000200271606)
0xd8: Push((float)0.8040000200271606)
0xd9: Push((float)0.8040000200271606)
0xda: @ PrintInWidth(Stack[-6], Stack[-5], Stack[-4], Stack[-15], Stack[-2]T, Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0xdb: Pop(5)
...
0xe3: Push("default") // @poff=13
0xe4: Push((int) 15)
0xe5: Push((int) 15)
0xe6: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0xe7: Push((float)0.8040000200271606)
0xe8: Push((float)0.8040000200271606)
0xe9: Push((float)0.8040000200271606)
0xea: @ PrintInWidth(Stack[-7], Stack[-6], Stack[-5], Stack[-16], Stack[-4], Stack[-9], Stack[-3], Stack[-2], Stack[-1])
0xeb: Pop(6)
0xec: GOTO 0xf6

0xed: Push("default") // @poff=13
0xee: Push((int) 15)
0xef: Push((int) 15)
0xf0: Pop(1); Push(Stack[2 + Tasks[-1].StackPointer] - Stack[-1]);
0xf1: Push((float)0.6980000138282776)
0xf2: Push((float)0.6589999794960022)
0xf3: Push((float)0.6470000147819519)
