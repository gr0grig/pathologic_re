...
Strings:
	...
	W:slot
	A:GetItemID
// @pool_raw:
...
0x15: @ CreateObjectVector(Stack[-1]T)
0x16: Pop(0)
0x17: @ CreateIntVector(Stack[-2]T)
0x18: Pop(0)
0x19: Push("player") // @poff=16
0x1a: @ FindActor(Stack[-3]T, Stack[-1])
0x1b: Pop(1)
...
0x21: Push((int) 4)
0x22: @@@ GetItemCount(Stack[-7], Stack[-1]); Obj=3 // @poff=30
0x23: Pop(1)
0x24: Stack[-5] = (int) 0
...
0x27: Push((int) 4)
0x28: @@@ GetItem(Stack[-5], Stack[-6], Stack[-1]); Obj=3 // @poff=43
0x29: Pop(1)
0x2a: PushEmpty(int, object)
0x2b: Stack[-6] = Stack[-1]
0x2c: Call 0xa7

0x2d: Stack[-2] = Stack[-5]
0x2e: Pop(2)
0x2f: Push("Microscope") // @poff=51
...
0x35: Push("Microscope") // @poff=51
0x36: @ GetInvItemProperty(Stack[-2], Stack[-4], Stack[-1])
0x37: Pop(1)
0x38: @@@ add(Stack[-4]); Obj=1 // @poff=73
0x39: Pop(0)
0x3a: @@@ add(Stack[-1]); Obj=2 // @poff=73
0x3b: Pop(0)
0x3c: Stack[-4] = 0
0x3d: Push((int) 1)
...
0x46: @@@ size(Stack[-4]); Obj=1 // @poff=77
0x47: Pop(0)
0x48: Stack[-3] = (int) 0
0x49: Push((int) 12)
...
0x4e: @@@ get(Stack[-2], Stack[-3]); Obj=1 // @poff=82
0x4f: Pop(0)
0x50: @@@ get(Stack[-1], Stack[-3]); Obj=2 // @poff=82
0x51: Pop(0)
...
0x56: Stack[-6] = Stack[-1]
0x57: Call 0x97

0x58: Pop(1)
0x59: @ SendMessage(Stack[-2], Stack[-1], Stack[-4])
0x5a: Pop(2)
0x5b: Push("video") // @poff=86
0x5c: @ SendMessage(Stack[-2], Stack[-1])
0x5d: Pop(1)
0x5e: Push("microscope_") // @poff=98
...
0xa8: @@ GetItemID(Stack[-1]); Obj=3 // @poff=144
0xa9: Pop(0)
0xaa: Stack[-1] = Stack[-4]
0xab: Return(); Pop(2)
