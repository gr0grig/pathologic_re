...
Strings:
	...
	W:ui_good_blood.wmv
	W:ui_bad_blood.wmv
// @pool_raw:
// @pool_encoding:utf8
...
0x10: @@@ StretchBlit(Stack[-1]T, Stack[-2]T, Stack[-3]T, Stack[-4]T); Obj=0 // @poff=0
0x11: Pop(0)
0x12: Push("ocular") // @poff=12
0x13: Push((int) 0)
0x14: Push((int) 0)
...
0x28: Push("ui_no_blood.wmv") // @poff=31
0x29: Push((bool) 1)
0x2a: @ LoadImage(Stack[-2], Stack[-1])
0x2b: Pop(2)
0x2c: Push("ui_no_blood.wmv") // @poff=31
0x2d: @ FindVideo(Stack[-0]T, Stack[-1])
0x2e: Pop(1)
0x2f: Push((bool) 1)
0x30: @@@ Play(Stack[-1]); Obj=0 // @poff=63
0x31: Pop(1)
0x32: GOTO 0x4e
...
0x36: Push("ui_good_blood.wmv") // @poff=68
0x37: Push((bool) 1)
0x38: @ LoadImage(Stack[-2], Stack[-1])
0x39: Pop(2)
0x3a: Push("ui_good_blood.wmv") // @poff=68
0x3b: @ FindVideo(Stack[-0]T, Stack[-1])
0x3c: Pop(1)
0x3d: Push((bool) 1)
0x3e: @@@ Play(Stack[-1]); Obj=0 // @poff=63
0x3f: Pop(1)
0x40: GOTO 0x4e
...
0x44: Push("ui_bad_blood.wmv") // @poff=104
0x45: Push((bool) 1)
0x46: @ LoadImage(Stack[-2], Stack[-1])
0x47: Pop(2)
0x48: Push("ui_bad_blood.wmv") // @poff=104
0x49: @ FindVideo(Stack[-0]T, Stack[-1])
0x4a: Pop(1)
0x4b: Push((bool) 1)
0x4c: @@@ Play(Stack[-1]); Obj=0 // @poff=63
0x4d: Pop(1)
0x4e: Return(); Pop(0)
