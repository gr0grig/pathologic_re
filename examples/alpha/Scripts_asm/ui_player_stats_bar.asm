...
Strings:
	...
	W:start
	W:end
// @pool_raw:6d006900640064006c006500000073007400610072007400000065006e0064000000
...
0xf: Pop(0)
0x10: Pop(0); Push(Stack[-3] * Stack[0 + Tasks[-1].StackPointer]);
0x11: Push((int) 100)
