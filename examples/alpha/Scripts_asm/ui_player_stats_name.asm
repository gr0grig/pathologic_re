...
Strings:
	W:default
	W:player
// @pool_raw:640065006600610075006c007400000070006c0061007900650072000000
...
0x3: Pop(0)
0x4: @ GetStringByID(Stack[-0]T, Stack[-1])
0x5: Pop(1)
0x6: @ _strupr(Stack[-0]T)
0x7: Pop(0)
0x8: @ GetWindowSize(Stack[-4], Stack[-3])
0x9: Pop(0)
0xa: Push("default") // @poff=0
0xb: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-0]T)
0xc: Pop(1)
...
0x24: Push("default") // @poff=0
0x25: Push((float)1.0)
0x26: Push((float)1.0)
0x27: Push((float)1.0)
0x28: @ Print(Stack[-4], Stack[-1]T, Stack[-2]T, Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x29: Pop(4)
0x2a: Return(); Pop(0)

0x2b: PushEmpty(int, int)
0x2c: Push("player") // @poff=16
