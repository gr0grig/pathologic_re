...
Strings:
	...
	W:0
	W:default
// @pool_raw:20003a002000000030000000640065006600610075006c0074000000
...
0x20: Pop(0)
0x21: Push("default") // @poff=12
0x22: @ GetTextWidth(Stack[-3], Stack[-1], Stack[-0]T)
0x23: Pop(1)
...
0x3a: Push("default") // @poff=12
0x3b: Push((float)1.0)
0x3c: Push((float)1.0)
0x3d: Push((float)1.0)
0x3e: @ Print(Stack[-4], Stack[-1]T, Stack[-2]T, Stack[-0]T, Stack[-3], Stack[-2], Stack[-1])
0x3f: Pop(4)
0x40: Return(); Pop(0)
