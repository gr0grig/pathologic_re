...
Strings:
	...
	W:reputation
	A:GetProperty
// @pool_raw:
...
0x1c: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[7 + Tasks[-1].StackPointer]);
0x1d: Push((float)2.0)
...
0x28: Push((float)6.2829999923706055)
0x29: Stack[-8] = Stack[-8] * Stack[-1]; Pop(1);
0x2a: Push("rep_down") // @poff=12
0x2b: Push((int) 20)
0x2c: Push((int) 500)
0x2d: Push((float)0.5)
0x2e: Push((float)0.5)
...
0x37: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[7 + Tasks[-1].StackPointer]);
0x38: Push((float)2.0)
...
0x43: Push((float)6.2829999923706055)
0x44: Stack[-7] = Stack[-7] * Stack[-1]; Pop(1);
0x45: Push("rep_up") // @poff=30
0x46: Push((int) 20)
0x47: Push((int) 500)
0x48: Push((float)0.5)
0x49: Push((float)0.5)
...
0x59: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[7 + Tasks[-1].StackPointer]);
0x5a: Push((float)1.0)
...
0x60: Push("player_exchange") // @poff=44
0x61: Push((int) 0)
0x62: @ SetVariable(Stack[-2], Stack[-1])
0x63: Pop(2)
0x64: Return(); Pop(14)

0x65: Push((float)6.2829999923706055)
0x66: Stack[-6] = Stack[-6] * Stack[-1]; Pop(1);
0x67: Push("exchange") // @poff=58
0x68: Push((int) 20)
0x69: Push((int) 500)
0x6a: Push((float)0.5)
0x6b: Push((float)0.5)
...
0x7b: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[7 + Tasks[-1].StackPointer]);
0x7c: Push((float)2.0)
...
0x82: Push("player_mail") // @poff=76
0x83: Push((int) 0)
0x84: @ SetVariable(Stack[-2], Stack[-1])
0x85: Pop(2)
0x86: Return(); Pop(14)

0x87: Push((float)6.2829999923706055)
0x88: Stack[-5] = Stack[-5] * Stack[-1]; Pop(1);
0x89: Push("mail") // @poff=90
0x8a: Push((int) 20)
0x8b: Push((int) 500)
0x8c: Push((float)0.5)
0x8d: Push((float)0.5)
...
0x9d: Pop(0); Push(Stack[6 + Tasks[-1].StackPointer] - Stack[7 + Tasks[-1].StackPointer]);
0x9e: Push((float)2.0)
...
0xa4: Push("player_diary") // @poff=100
0xa5: Push((int) 0)
0xa6: @ SetVariable(Stack[-2], Stack[-1])
0xa7: Pop(2)
0xa8: Return(); Pop(14)

0xa9: Push((float)6.2829999923706055)
0xaa: Stack[-4] = Stack[-4] * Stack[-1]; Pop(1);
0xab: Push("diary") // @poff=114
0xac: Push((int) 20)
0xad: Push((int) 470)
0xae: Push((float)0.5)
0xaf: Push((float)0.5)
...
0xd7: Push((float)0.30000001192092896)
0xd8: Pop(1); Push((bool) Stack[-2] >= Stack[-1])
0xd9: IF (Stack[-1] == 0) GOTO 0xde; Pop(1)

0xda: Push("rep_down_big") // @poff=126
0xdb: @ PlaySound(Stack[-1])
0xdc: Pop(1)
0xdd: GOTO 0xe1

0xde: Push("rep_down_small") // @poff=152
...
0x102: Push("player_mail") // @poff=76
...
0x109: Push("player_diary") // @poff=100
...
0x110: Push("player_exchange") // @poff=44
...
0x11e: Push("reputation") // @poff=196
0x11f: @@ GetProperty(Stack[-1], Stack[-2]); Obj=3 // @poff=218
0x120: Pop(1)
