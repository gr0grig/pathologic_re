...
Strings:
	...
	W:: 
// @pool_raw:
...
0x13: @@ GetTooltipType(Stack[-3]); Obj=6 // @poff=16
0x14: Pop(0)
0x15: @@ GetTooltipText(Stack[-2]); Obj=6 // @poff=31
0x16: Pop(0)
0x17: @@ GetTooltipObject(Stack[-1]); Obj=6 // @poff=46
0x18: Pop(0)
0x19: PushEmpty(int, string, object, int, int)
0x1a: Stack[-8] = Stack[-5]
0x1b: Stack[-7] = Stack[-4]
0x1c: Stack[-6] = Stack[-3]
0x1d: Stack[-10] = Stack[-2]
0x1e: Stack[-9] = Stack[-1]
0x1f: Call 0xaa
...
0x37: Push(" doesn't have price") // @poff=105
...
0x3e: Stack[-12] = Stack[-1]
0x3f: Call 0x61

0x40: Pop(1)
0x41: Push("Price") // @poff=63
0x42: @ GetInvItemProperty(Stack[-5], Stack[-2], Stack[-1])
0x43: Pop(2)
0x44: Stack[-3] = Stack[-11]
0x45: Return(); Pop(8)

0x46: PushEmpty(int, object)
0x47: Stack[-12] = Stack[-1]
0x48: Call 0x61

0x49: Pop(1)
0x4a: Push("BarterPrice") // @poff=145
...
0x53: Stack[-12] = Stack[-1]
0x54: Call 0x61

0x55: Pop(1)
0x56: Push("BarterPrice") // @poff=145
...
0x62: @@ GetItemID(Stack[-1]); Obj=3 // @poff=169
0x63: Pop(0)
0x64: Stack[-1] = Stack[-4]
0x65: Return(); Pop(2)
...
0x70: Push("sellf") // @poff=179
0x71: Pop(1); Push(Stack[-1] + Stack[-3]);
0x72: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=191
0x73: Pop(1)
0x74: Push(Stack[-1])
0x75: IF (Stack[-1] == 0) GOTO 0x7a; Pop(1)

0x76: Push("sellf") // @poff=179
0x77: Pop(1); Push(Stack[-1] + Stack[-3]);
0x78: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=203
0x79: Pop(1)
0x7a: Push((int) 1)
...
0x8a: Push("buyf") // @poff=215
0x8b: Pop(1); Push(Stack[-1] + Stack[-3]);
0x8c: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=191
0x8d: Pop(1)
0x8e: Push(Stack[-1])
0x8f: IF (Stack[-1] == 0) GOTO 0x94; Pop(1)

0x90: Push("buyf") // @poff=215
0x91: Pop(1); Push(Stack[-1] + Stack[-3]);
0x92: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=203
0x93: Pop(1)
0x94: Push((int) 1)
...
0x9c: Pop(0)
0x9d: Push("barter") // @poff=225
0x9e: @@ HasProperty(Stack[-1], Stack[-3]); Obj=4 // @poff=191
0x9f: Pop(1)
...
0xa4: Push("barter") // @poff=225
0xa5: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=203
0xa6: Pop(1)
0xa7: Stack[-1] = Stack[-7]
0xa8: Return(); Pop(6)
...
0xaf: Stack[-5] = Stack[-3]
0xb0: Stack[-4] = Stack[-2]
0xb1: Stack[-6] = Stack[-1]
0xb2: Call 0x129
...
0xc4: Stack[-5] = Stack[-3]
0xc5: Stack[-7] = Stack[-2]
0xc6: Stack[-1] = (bool) 1
0xc7: Call 0x1e7
...
0xce: Stack[-6] = Stack[-4]
0xcf: Stack[-5] = Stack[-3]
0xd0: Stack[-7] = Stack[-2]
0xd1: Stack[-1] = (bool) 0
0xd2: Call 0x1e7
...
0xd9: Stack[-6] = Stack[-4]
0xda: Stack[-5] = Stack[-3]
0xdb: Stack[-8] = Stack[-2]
0xdc: Stack[-7] = Stack[-1]
0xdd: Call 0x265
...
0x100: Stack[-7] = Stack[-1]
0x101: Call 0x61

0x102: Stack[-2] = Stack[-4]
0x103: Pop(2)
...
0x13d: Stack[-8] = "Error: Item doesnt have description (FIXME!)" // @poff=283
0x13e: Push("default") // @poff=0
0x13f: Push((int) 218)
...
0x161: Stack[-22] = Stack[-1]
0x162: Call 0xfb

0x163: Pop(3)
0x164: Push("default") // @poff=0
0x165: Push((int) 16)
...
0x16d: Push((int) 218)
0x16e: Push((float)0.6470588445663452)
0x16f: Push((float)0.6470588445663452)
0x170: Push((float)0.6470588445663452)
...
0x178: @@ size(Stack[-17]); Obj=35 // @poff=373
0x179: Pop(0)
...
0x184: @@ get(Stack[-16], Stack[-10]); Obj=35 // @poff=378
0x185: Pop(0)
0x186: @@ GetTime(Stack[-9]); Obj=16 // @poff=382
0x187: Pop(0)
0x188: Pop(0); Push((bool) Stack[-9] > Stack[-11])
0x189: IF (Stack[-1] == 0) GOTO 0x18c; Pop(1)

0x18a: Stack[-9] = Stack[-11]
0x18b: Stack[-10] = Stack[-12]
0x18c: Push((int) 1)
0x18d: Stack[-11] = Stack[-11] + Stack[-1]; Pop(1);
0x18e: GOTO 0x182

0x18f: @@ get(Stack[-16], Stack[-12]); Obj=35 // @poff=378
0x190: Pop(0)
0x191: @@ GetTextID(Stack[-13]); Obj=16 // @poff=390
0x192: Pop(0)
0x193: @ GetStringByID(Stack[-14], Stack[-13])
0x194: Pop(0)
0x195: @@ GetTime(Stack[-8]); Obj=16 // @poff=382
0x196: Pop(0)
0x197: PushEmpty(int)
0x198: Stack[-9] = Stack[-1]
...
0x1b3: @@ remove(Stack[-12]); Obj=35 // @poff=410
0x1b4: Pop(0)
0x1b5: Push((int) -1)
...
0x1d0: Stack[-36] = Stack[-1]
0x1d1: @ ScreenToClient(Stack[-2], Stack[-1])
0x1d2: Pop(0)
0x1d3: PushEmpty(int, int, int, int)
0x1d4: Stack[-6] = Stack[-4]
0x1d5: Stack[-5] = Stack[-3]
0x1d6: Stack[-2] = (int) 250
0x1d7: Stack[-9] = Stack[-1]
0x1d8: Call 0xe0

0x1d9: Pop(4)
0x1da: Push("default") // @poff=0
0x1db: Push((int) 16)
0x1dc: Pop(1); Push(Stack[-4] + Stack[-1]);
0x1dd: Push((int) 16)
0x1de: Pop(1); Push(Stack[-4] + Stack[-1]);
0x1df: Push((int) 218)
0x1e0: Push((float)0.6470588445663452)
0x1e1: Push((float)0.6470588445663452)
0x1e2: Push((float)0.6470588445663452)
...
0x1f4: Stack[-34] = Stack[-1]
0x1f5: Call 0x61

0x1f6: Stack[-2] = Stack[-14]
0x1f7: Pop(2)
0x1f8: PushEmpty(int, object, int)
0x1f9: Stack[-35] = Stack[-2]
0x1fa: PushEmpty(int)
0x1fb: Call 0x9a
...
0x20b: Stack[-4] = Stack[-14]
0x20c: Pop(4)
0x20d: GOTO 0x218

0x20e: PushEmpty(float, object, int, int)
0x20f: Stack[-19] = Stack[-3]
0x210: Stack[-17] = Stack[-2]
0x211: PushEmpty(int)
0x212: Call 0x9a
...
0x224: Stack[-9] = "Error: Item doesnt have description (FIXME!)" // @poff=283
0x225: Push("
") // @poff=419
...
0x251: Stack[-35] = Stack[-1]
0x252: Call 0xfb

0x253: Pop(3)
0x254: Push("default") // @poff=0
0x255: Push((int) 16)
...
0x260: Push((float)0.6470588445663452)
