...
Strings:
	...
	A:RemoveItem
	A:AddItem
// @pool_raw:
// @pool_encoding:utf8
...
0xa6: Push("l_scroll_button_top") // @poff=64
...
0xaf: Push("l_scroll_button_bottom") // @poff=104
...
0xb8: Push("r_scroll_button_top") // @poff=150
...
0xc1: Push("r_scroll_button_bottom") // @poff=190
...
0xc8: Push("l_scrollbar") // @poff=236
...
0xd9: Push("r_scrollbar") // @poff=260
...
0xf9: @ GetPlayerMoneyCount(Stack[-2]T)
0xfa: Pop(0)
0xfb: GOTO 0xfd

0xfc: Stack[2 + Tasks[-1].StackPointer] = (int)0
0xfd: @@@ clear(); Obj=20 // @poff=304
0xfe: Pop(0)
0xff: @@@ clear(); Obj=21 // @poff=304
0x100: Pop(0)
0x101: @@@ clear(); Obj=4 // @poff=304
0x102: Pop(0)
0x103: @@@ clear(); Obj=5 // @poff=304
0x104: Pop(0)
0x105: @@@ clear(); Obj=6 // @poff=304
0x106: Pop(0)
0x107: @@@ clear(); Obj=7 // @poff=304
0x108: Pop(0)
0x109: @@@ clear(); Obj=8 // @poff=304
0x10a: Pop(0)
0x10b: @@@ clear(); Obj=9 // @poff=304
0x10c: Pop(0)
0x10d: @@@ clear(); Obj=10 // @poff=304
0x10e: Pop(0)
0x10f: @@@ clear(); Obj=11 // @poff=304
0x110: Pop(0)
0x111: @@@ clear(); Obj=12 // @poff=304
0x112: Pop(0)
0x113: @@@ clear(); Obj=13 // @poff=304
0x114: Pop(0)
0x115: @@@ clear(); Obj=14 // @poff=304
0x116: Pop(0)
0x117: @@@ clear(); Obj=15 // @poff=304
0x118: Pop(0)
0x119: @@@ clear(); Obj=16 // @poff=304
0x11a: Pop(0)
0x11b: @@@ clear(); Obj=17 // @poff=304
0x11c: Pop(0)
0x11d: @@@ clear(); Obj=18 // @poff=304
0x11e: Pop(0)
0x11f: @@@ clear(); Obj=19 // @poff=304
0x120: Pop(0)
0x121: PushEmpty()
0x122: Call 0x189
...
0x135: Pop(0)
0x136: @@@ size(Stack[-1]); Obj=7 // @poff=0
0x137: Pop(0)
0x138: Push((int) 18)
...
0x13c: Push("l_scrollbar") // @poff=236
0x13d: @ SendMessage(Stack[-2], Stack[-1])
0x13e: Pop(2)
0x13f: GOTO 0x144

0x140: Push((int) 0)
0x141: Push("l_scrollbar") // @poff=236
0x142: @ SendMessage(Stack[-2], Stack[-1])
0x143: Pop(2)
0x144: @@@ size(Stack[-1]); Obj=4 // @poff=0
0x145: Pop(0)
0x146: Push((int) 18)
...
0x14a: Push("r_scrollbar") // @poff=260
0x14b: @ SendMessage(Stack[-2], Stack[-1])
0x14c: Pop(2)
0x14d: GOTO 0x152

0x14e: Push((int) 0)
0x14f: Push("r_scrollbar") // @poff=260
...
0x16a: Stack[-11] = Stack[-1]
0x16b: Call 0x602

0x16c: Stack[-2] = Stack[-5]
0x16d: Pop(2)
0x16e: Stack[-1] = (int) 0
...
0x172: Stack[-12] = Stack[-2]
0x173: Stack[-4] = Stack[-1]
0x174: Call 0x613

0x175: Stack[-3] = Stack[-5]
0x176: Pop(3)
0x177: PushEmpty(object, int, int)
0x178: Stack[-12] = Stack[-2]
0x179: Stack[-4] = Stack[-1]
0x17a: Call 0x60a

0x17b: Stack[-3] = Stack[-7]
0x17c: Pop(3)
0x17d: @@@ add(Stack[-4]); Obj=4 // @poff=16
0x17e: Pop(0)
0x17f: @@@ add(Stack[-2]); Obj=5 // @poff=16
0x180: Pop(0)
0x181: Push((int) 0)
0x182: @@@ add(Stack[-1]); Obj=6 // @poff=16
0x183: Pop(1)
0x184: Push((int) 1)
...
0x199: Stack[-2] = Stack[-4]
0x19a: Pop(2)
0x19b: @@@ add(Stack[-2]); Obj=7 // @poff=16
0x19c: Pop(0)
0x19d: @@@ add(Stack[-4]); Obj=8 // @poff=16
0x19e: Pop(0)
0x19f: Push((int) 0)
0x1a0: @@@ add(Stack[-1]); Obj=9 // @poff=16
0x1a1: Pop(1)
0x1a2: Push((int) 1)
...
0x1d1: Stack[-14] = Stack[-2]
0x1d2: Stack[-4] = Stack[-1]
0x1d3: Call 0x613

0x1d4: Stack[-3] = Stack[-5]
0x1d5: Pop(3)
0x1d6: PushEmpty(object, int, int)
0x1d7: Stack[-14] = Stack[-2]
0x1d8: Stack[-4] = Stack[-1]
0x1d9: Call 0x60a

0x1da: Stack[-3] = Stack[-7]
0x1db: Pop(3)
0x1dc: @@ add(Stack[-4]); Obj=10 // @poff=16
0x1dd: Pop(0)
0x1de: @@ add(Stack[-2]); Obj=9 // @poff=16
0x1df: Pop(0)
0x1e0: Push((int) 1)
...
0x1e6: @@@ size(Stack[-2]); Obj=7 // @poff=0
0x1e7: Pop(0)
0x1e8: Push((int) 2)
...
0x1f8: @@@ size(Stack[-2]); Obj=4 // @poff=0
0x1f9: Pop(0)
0x1fa: Push((int) 2)
...
0x207: Stack[-1] = Stack[-5]
0x208: Return(); Pop(4)

0x209: PushEmpty(int, int, int, object, int, int, int, int, object, int)
0x20a: @@@ size(Stack[-5]); Obj=7 // @poff=0
0x20b: Pop(0)
0x20c: Push((int) 18)
0x20d: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x225: Push((int) 18)
0x226: Pop(1); Push(Stack[0 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x22b: @@@ get(Stack[-2], Stack[-3]); Obj=7 // @poff=5
0x22c: Pop(0)
0x22d: Stack[-4] = (int) 0
...
0x25d: @@@ size(Stack[-6]); Obj=4 // @poff=0
0x25e: Pop(0)
0x25f: Push((int) 18)
0x260: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x278: Push((int) 18)
0x279: Pop(1); Push(Stack[1 + Tasks[-1].StackPointer] + Stack[-1]);
...
0x27e: @@@ get(Stack[-5], Stack[-2]); Obj=4 // @poff=5
0x27f: Pop(0)
0x280: @@@ get(Stack[-3], Stack[-2]); Obj=5 // @poff=5
0x281: Pop(0)
0x282: Stack[-4] = (int) 0
...
0x2b1: Stack[-5] = 0
0x2b2: Push("r_money_slot") // @poff=310
0x2b3: @ SendMessage(Stack[-2]T, Stack[-1])
0x2b4: Pop(1)
0x2b5: Return(); Pop(0)

0x2b6: Push("l_money_slot") // @poff=336
0x2b7: @ SendMessage(Stack[-3]T, Stack[-1])
0x2b8: Pop(1)
0x2b9: Return(); Pop(0)
...
0x2be: Pop(0)
0x2bf: @@@ size(Stack[-7]); Obj=21 // @poff=0
0x2c0: Pop(0)
0x2c1: Stack[-2] = (int) 0
0x2c2: Pop(0); Push((bool) Stack[-2] < Stack[-7])
0x2c3: IF (Stack[-1] == 0) GOTO 0x2e5; Pop(1)

0x2c4: @@@ get(Stack[-5], Stack[-2]); Obj=21 // @poff=5
0x2c5: Pop(0)
0x2c6: PushEmpty(bool, object, object, int)
0x2c7: Stack[-7] = Stack[-3]
0x2c8: Stack[-9] = Stack[-2]
0x2c9: PushEmpty(int, object)
0x2ca: Stack[-11] = Stack[-1]
0x2cb: Call 0x5e7

0x2cc: Stack[-2] = Stack[-3]
0x2cd: Pop(2)
0x2ce: Call 0x674

0x2cf: Stack[-4] = Stack[-10]
0x2d0: Pop(4)
0x2d1: Pop(0); Push((bool) Stack[-6] == 0)
0x2d2: IF (Stack[-1] == 0) GOTO 0x2d6; Pop(1)

0x2d3: Push("Error: failed to remove item") // @poff=362
0x2d4: @ Trace(Stack[-1])
0x2d5: Pop(1)
0x2d6: PushEmpty(bool, object, object, int)
0x2d7: Stack[-8] = Stack[-3]
0x2d8: Stack[-9] = Stack[-2]
0x2d9: Stack[-1] = (int) 0
0x2da: Call 0x68d

0x2db: Stack[-4] = Stack[-10]
0x2dc: Pop(4)
0x2dd: Pop(0); Push((bool) Stack[-6] == 0)
0x2de: IF (Stack[-1] == 0) GOTO 0x2e2; Pop(1)

0x2df: Push("Error: failed to add item") // @poff=420
0x2e0: @ Trace(Stack[-1])
0x2e1: Pop(1)
0x2e2: Push((int) 1)
...
0x2e5: @@@ size(Stack[-7]); Obj=20 // @poff=0
0x2e6: Pop(0)
0x2e7: Stack[-1] = (int) 0
0x2e8: Pop(0); Push((bool) Stack[-1] < Stack[-7])
0x2e9: IF (Stack[-1] == 0) GOTO 0x30b; Pop(1)

0x2ea: @@@ get(Stack[-5], Stack[-1]); Obj=20 // @poff=5
0x2eb: Pop(0)
0x2ec: PushEmpty(bool, object, object, int)
0x2ed: Stack[-8] = Stack[-3]
0x2ee: Stack[-9] = Stack[-2]
0x2ef: Stack[-1] = (int) 0
0x2f0: Call 0x674

0x2f1: Stack[-4] = Stack[-10]
0x2f2: Pop(4)
0x2f3: Pop(0); Push((bool) Stack[-6] == 0)
0x2f4: IF (Stack[-1] == 0) GOTO 0x2f8; Pop(1)

0x2f5: Push("Error: failed to remove item") // @poff=362
0x2f6: @ Trace(Stack[-1])
0x2f7: Pop(1)
0x2f8: PushEmpty(bool, object, object, int)
0x2f9: Stack[-7] = Stack[-3]
0x2fa: Stack[-9] = Stack[-2]
0x2fb: PushEmpty(int, object)
0x2fc: Stack[-11] = Stack[-1]
0x2fd: Call 0x5e7

0x2fe: Stack[-2] = Stack[-3]
0x2ff: Pop(2)
0x300: Call 0x68d

0x301: Stack[-4] = Stack[-10]
0x302: Pop(4)
0x303: Pop(0); Push((bool) Stack[-6] == 0)
0x304: IF (Stack[-1] == 0) GOTO 0x308; Pop(1)

0x305: Push("Error: failed to add item") // @poff=420
0x306: @ Trace(Stack[-1])
0x307: Pop(1)
0x308: Push((int) 1)
...
0x30e: @ SetPlayerMoneyCount(Stack[-2]T)
0x30f: Pop(0)
...
0x31a: Stack[-5] = Stack[-1]
0x31b: Call 0x5e7

0x31c: Stack[-2] = Stack[-3]
0x31d: Pop(2)
0x31e: Push((int) 0)
...
0x39f: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=5
0x3a0: Pop(0)
0x3a1: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=5
0x3a2: Pop(0)
0x3a3: PushEmpty(bool, object, object)
0x3a4: Stack[-14] = Stack[-2]
0x3a5: Stack[-6] = Stack[-1]
0x3a6: Call 0x637
...
0x3b1: @@ set(Stack[-3], Stack[-1]); Obj=10 // @poff=472
0x3b2: Pop(1)
...
0x3bb: @@ add(Stack[-11]); Obj=10 // @poff=16
0x3bc: Pop(0)
0x3bd: Push((int) 1)
0x3be: @@ add(Stack[-1]); Obj=10 // @poff=16
0x3bf: Pop(1)
...
0x3c6: @@ size(Stack[-4]); Obj=10 // @poff=0
0x3c7: Pop(0)
0x3c8: Stack[-2] = (int) 0
0x3c9: Pop(0); Push((bool) Stack[-2] < Stack[-4])
0x3ca: IF (Stack[-1] == 0) GOTO 0x3e6; Pop(1)

0x3cb: @@ get(Stack[-3], Stack[-2]); Obj=10 // @poff=5
0x3cc: Pop(0)
0x3cd: @@ get(Stack[-1], Stack[-2]); Obj=9 // @poff=5
0x3ce: Pop(0)
0x3cf: PushEmpty(bool, object, object)
0x3d0: Stack[-14] = Stack[-2]
...
0x3da: @@ remove(Stack[-2]); Obj=10 // @poff=9
0x3db: Pop(0)
0x3dc: @@ remove(Stack[-2]); Obj=9 // @poff=9
0x3dd: Pop(0)
0x3de: GOTO 0x3e1

0x3df: @@ set(Stack[-2], Stack[-1]); Obj=9 // @poff=472
0x3e0: Pop(0)
...
0x3f4: @@@ size(Stack[-5]); Obj=9 // @poff=0
0x3f5: Pop(0)
0x3f6: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x3f7: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x3f8: IF (Stack[-1] == 0) GOTO 0x3fa; Pop(1)

0x3f9: Return(); Pop(10)

0x3fa: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x3fb: @@@ get(Stack[-5], Stack[-1]); Obj=7 // @poff=5
0x3fc: Pop(1)
0x3fd: PushEmpty(bool, object, int, bool)
0x3fe: Stack[-8] = Stack[-3]
...
0x405: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x406: @@@ get(Stack[-4], Stack[-1]); Obj=9 // @poff=5
0x407: Pop(1)
0x408: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x409: @@@ get(Stack[-3], Stack[-1]); Obj=8 // @poff=5
0x40a: Pop(1)
0x40b: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x40c: IF (Stack[-1] == 0) GOTO 0x42d; Pop(1)

0x40d: PushEmpty(int, object, int)
0x40e: Stack[-7] = Stack[-2]
...
0x422: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x423: @@@ set(Stack[-1], Stack[-4]); Obj=9 // @poff=472
0x424: Pop(1)
0x425: PushEmpty(object)
0x426: Stack[-5] = Stack[-1]
0x427: Call 0x0
...
0x436: @@@ size(Stack[-5]); Obj=9 // @poff=0
0x437: Pop(0)
0x438: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x439: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x43a: IF (Stack[-1] == 0) GOTO 0x43c; Pop(1)

0x43b: Return(); Pop(10)

0x43c: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x43d: @@@ get(Stack[-5], Stack[-1]); Obj=7 // @poff=5
0x43e: Pop(1)
0x43f: PushEmpty(bool, object, int, bool)
0x440: Stack[-8] = Stack[-3]
...
0x447: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x448: @@@ get(Stack[-4], Stack[-1]); Obj=9 // @poff=5
0x449: Pop(1)
0x44a: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x44b: @@@ get(Stack[-3], Stack[-1]); Obj=8 // @poff=5
0x44c: Pop(1)
0x44d: Push((int) 0)
...
0x45a: Pop(0); Push(Stack[-11] + Stack[0 + Tasks[-1].StackPointer]);
0x45b: @@@ set(Stack[-1], Stack[-4]); Obj=9 // @poff=472
0x45c: Pop(1)
...
0x476: @@@ size(Stack[-5]); Obj=6 // @poff=0
0x477: Pop(0)
0x478: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x479: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x47a: IF (Stack[-1] == 0) GOTO 0x47c; Pop(1)

0x47b: Return(); Pop(10)

0x47c: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x47d: @@@ get(Stack[-5], Stack[-1]); Obj=4 // @poff=5
0x47e: Pop(1)
0x47f: PushEmpty(bool, object, int, bool)
0x480: Stack[-8] = Stack[-3]
...
0x487: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x488: @@@ get(Stack[-4], Stack[-1]); Obj=6 // @poff=5
0x489: Pop(1)
0x48a: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x48b: @@@ get(Stack[-3], Stack[-1]); Obj=5 // @poff=5
0x48c: Pop(1)
0x48d: Pop(0); Push((bool) Stack[-3] < Stack[-2])
0x48e: IF (Stack[-1] == 0) GOTO 0x4ac; Pop(1)

0x48f: PushEmpty(bool, object)
0x490: Stack[-6] = Stack[-1]
0x491: Call 0x355

0x492: Pop(2)
0x493: PushEmpty(object)
0x494: Stack[-5] = Stack[-1]
0x495: Call 0x18

0x496: Pop(1)
0x497: Push((int) 1)
0x498: Stack[-4] = Stack[-4] + Stack[-1]; Pop(1);
0x499: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x49a: @@@ set(Stack[-1], Stack[-4]); Obj=6 // @poff=472
0x49b: Pop(1)
0x49c: PushEmpty(int, object, int)
0x49d: Stack[-7] = Stack[-2]
...
0x4b5: @@@ size(Stack[-5]); Obj=6 // @poff=0
0x4b6: Pop(0)
0x4b7: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4b8: Pop(1); Push((bool) Stack[-1] >= Stack[-6])
0x4b9: IF (Stack[-1] == 0) GOTO 0x4bb; Pop(1)

0x4ba: Return(); Pop(10)

0x4bb: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4bc: @@@ get(Stack[-5], Stack[-1]); Obj=4 // @poff=5
0x4bd: Pop(1)
0x4be: PushEmpty(bool, object, int, bool)
0x4bf: Stack[-8] = Stack[-3]
...
0x4c6: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4c7: @@@ get(Stack[-4], Stack[-1]); Obj=6 // @poff=5
0x4c8: Pop(1)
0x4c9: Pop(0); Push(Stack[-11] + Stack[1 + Tasks[-1].StackPointer]);
0x4ca: @@@ get(Stack[-3], Stack[-1]); Obj=5 // @poff=5
0x4cb: Pop(1)
0x4cc: Push((int) 0)
...
0x504: @@@ size(Stack[-2]); Obj=9 // @poff=0
0x505: Pop(0)
0x506: Pop(0); Push(Stack[-5] + Stack[0 + Tasks[-1].StackPointer]);
...
0x50b: Pop(0); Push(Stack[-5] + Stack[0 + Tasks[-1].StackPointer]);
0x50c: @@@ get(Stack[-2], Stack[-1]); Obj=9 // @poff=5
0x50d: Pop(1)
0x50e: Stack[-1] = Stack[-6]
0x50f: Return(); Pop(4)

0x510: PushEmpty(int, int, int, int)
0x511: @@@ size(Stack[-2]); Obj=6 // @poff=0
0x512: Pop(0)
0x513: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
...
0x518: Pop(0); Push(Stack[-5] + Stack[1 + Tasks[-1].StackPointer]);
0x519: @@@ get(Stack[-2], Stack[-1]); Obj=6 // @poff=5
0x51a: Pop(1)
0x51b: Stack[-1] = Stack[-6]
0x51c: Return(); Pop(4)
...
0x56b: Push("sellf") // @poff=536
0x56c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x56d: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=548
0x56e: Pop(1)
0x56f: Push(Stack[-1])
0x570: IF (Stack[-1] == 0) GOTO 0x575; Pop(1)

0x571: Push("sellf") // @poff=536
0x572: Pop(1); Push(Stack[-1] + Stack[-3]);
0x573: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=560
0x574: Pop(1)
0x575: Push((int) 1)
...
0x585: Push("buyf") // @poff=572
0x586: Pop(1); Push(Stack[-1] + Stack[-3]);
0x587: @@ HasProperty(Stack[-1], Stack[-2]); Obj=10 // @poff=548
0x588: Pop(1)
0x589: Push(Stack[-1])
0x58a: IF (Stack[-1] == 0) GOTO 0x58f; Pop(1)

0x58b: Push("buyf") // @poff=572
0x58c: Pop(1); Push(Stack[-1] + Stack[-3]);
0x58d: @@ GetProperty(Stack[-1], Stack[-4]); Obj=10 // @poff=560
0x58e: Pop(1)
0x58f: Push((int) 1)
...
0x597: Pop(0)
0x598: Push("barter") // @poff=582
0x599: @@ HasProperty(Stack[-1], Stack[-3]); Obj=4 // @poff=548
0x59a: Pop(1)
...
0x59f: Push("barter") // @poff=582
0x5a0: @@ GetProperty(Stack[-1], Stack[-2]); Obj=4 // @poff=560
0x5a1: Pop(1)
0x5a2: Stack[-1] = Stack[-7]
0x5a3: Return(); Pop(6)
...
0x5bf: Stack[-12] = Stack[-1]
0x5c0: Call 0x5e2

0x5c1: Pop(1)
0x5c2: Push("Price") // @poff=596
0x5c3: @ GetInvItemProperty(Stack[-5], Stack[-2], Stack[-1])
0x5c4: Pop(2)
0x5c5: Stack[-3] = Stack[-11]
0x5c6: Return(); Pop(8)

0x5c7: PushEmpty(int, object)
0x5c8: Stack[-12] = Stack[-1]
0x5c9: Call 0x5e2

0x5ca: Pop(1)
0x5cb: Push("BarterPrice") // @poff=678
...
0x5d4: Stack[-12] = Stack[-1]
0x5d5: Call 0x5e2

0x5d6: Pop(1)
0x5d7: Push("BarterPrice") // @poff=678
...
0x5e3: @@ GetItemID(Stack[-1]); Obj=3 // @poff=702
0x5e4: Pop(0)
0x5e5: Stack[-1] = Stack[-4]
0x5e6: Return(); Pop(2)

0x5e7: PushEmpty(int, int)
0x5e8: PushEmpty(int, object)
0x5e9: Stack[-5] = Stack[-1]
0x5ea: Call 0x5e2

0x5eb: Pop(1)
0x5ec: Push("Category") // @poff=712
...
0x5f7: Pop(1)
0x5f8: Stack[-1] = Stack[-4]
0x5f9: Return(); Pop(2)

0x5fa: PushEmpty(int, object, int, object)
0x5fb: @ GetContainer(Stack[-1])
0x5fc: Pop(0)
0x5fd: @@ GetItemCount(Stack[-2]); Obj=1 // @poff=730
0x5fe: Pop(0)
0x5ff: Stack[-2] = Stack[-5]
0x600: Return(); Pop(4)
...
0x604: Pop(0)
0x605: @@ GetItemCount(Stack[-2], Stack[-5]); Obj=1 // @poff=730
0x606: Pop(0)
...
0x60c: Pop(0)
0x60d: @@ GetItem(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=743
0x60e: Pop(0)
...
0x615: Pop(0)
0x616: @@ GetItemAmount(Stack[-1], Stack[-5], Stack[-6]); Obj=2 // @poff=751
0x617: Pop(0)
0x618: Stack[-1] = Stack[-7]
0x619: Return(); Pop(4)
...
0x61d: Pop(0)
0x61e: @@ GetItem(Stack[-1], Stack[-5]); Obj=2 // @poff=743
0x61f: Pop(0)
0x620: Stack[-1] = Stack[-6]
0x621: Return(); Pop(4)
...
0x626: Pop(0)
0x627: @@ GetItemAmount(Stack[-1], Stack[-5]); Obj=2 // @poff=751
0x628: Pop(0)
0x629: Stack[-1] = Stack[-6]
0x62a: Return(); Pop(4)

0x62b: Stack[-2] = 0
0x62c: PushEmpty()
0x62d: PushEmpty(int, object)
0x62e: Stack[-4] = Stack[-1]
0x62f: Call 0x5e2

0x630: Pop(1)
0x631: PushEmpty(int, object)
0x632: Stack[-4] = Stack[-1]
0x633: Call 0x5e2
...
0x649: Stack[-9] = Stack[-1]
0x64a: Call 0x5e2

0x64b: Pop(1)
0x64c: Push("BarterPrice") // @poff=678
...
0x655: Stack[-9] = Stack[-1]
0x656: Call 0x5e2

0x657: Pop(1)
0x658: Push("BarterPrice") // @poff=678
...
0x675: @@ GetItemCount(Stack[-3], Stack[-7]); Obj=9 // @poff=730
0x676: Pop(0)
0x677: Stack[-1] = (int) 0
0x678: Pop(0); Push((bool) Stack[-1] < Stack[-3])
0x679: IF (Stack[-1] == 0) GOTO 0x68a; Pop(1)

0x67a: @@ GetItem(Stack[-2], Stack[-1], Stack[-7]); Obj=9 // @poff=743
0x67b: Pop(0)
0x67c: PushEmpty(bool, object, object)
0x67d: Stack[-11] = Stack[-2]
...
0x682: Push((int) 1)
0x683: @@ RemoveItem(Stack[-2], Stack[-1], Stack[-8]); Obj=10 // @poff=765
0x684: Pop(1)
...
0x68e: Push((int) 1)
0x68f: @@ AddItem(Stack[-2], Stack[-5], Stack[-4], Stack[-1]); Obj=6 // @poff=776
0x690: Pop(1)
