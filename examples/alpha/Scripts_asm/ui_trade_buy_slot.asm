...
Strings:
	...
	W:selected
	A:GetItemID
// @pool_raw:640065006600610075006c0074000000640069007300610062006c00650064000000730065006c006500630074006500640000004765744974656d494400
...
0xf: Push((int) 1)
0x10: Push((int) 1)
0x11: @ Blit(Stack[-3]T, Stack[-2], Stack[-1])
0x12: Pop(2)
0x13: Push((int) 2)
...
0x19: Push("default") // @poff=0
0x1a: Push((int) 2)
0x1b: Push((int) 35)
0x1c: @ Print(Stack[-3], Stack[-2], Stack[-1], Stack[-0]T)
0x1d: Pop(3)
0x1e: Push( Stack[4 + Tasks[-1].StackPointer] )
0x1f: IF (Stack[-1] == 0) GOTO 0x27; Pop(1)

0x20: Push("disabled") // @poff=16
0x21: Push((int) 0)
0x22: Push((int) 0)
0x23: Push((int) 50)
0x24: Push((int) 50)
0x25: @ StretchBlit(Stack[-5], Stack[-4], Stack[-3], Stack[-2], Stack[-1])
0x26: Pop(5)
0x27: Return(); Pop(0)
...
0x3e: Push("selected") // @poff=34
0x3f: @ SetBackground(Stack[-1])
0x40: Pop(1)
0x41: GOTO 0x45

0x42: Push("default") // @poff=0
...
0x57: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=52
0x58: Pop(0)
0x59: @ GetItemImage(Stack[-1], Stack[-3]T)
0x5a: Pop(0)
0x5b: @ LoadImage(Stack[-3]T)
0x5c: Pop(0)
0x5d: @ GetItemMaxStackSize(Stack[-1], Stack[-1]T)
0x5e: Pop(0)
...
0x66: Push((int) 4)
0x67: Push("") // @poff=13
0x68: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x69: Pop(2)
0x6a: GOTO 0x6f
