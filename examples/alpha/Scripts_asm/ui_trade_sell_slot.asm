...
0xf: Push((int) 1)
0x10: Push((int) 1)
0x11: @ Blit(Stack[-4]T, Stack[-2], Stack[-1])
0x12: Pop(2)
0x13: Push((int) 1)
...
0x3b: Push("selected") // @poff=34
0x3c: @ SetBackground(Stack[-1])
0x3d: Pop(1)
0x3e: GOTO 0x42

0x3f: Push("default") // @poff=0
...
0x54: @@@ GetItemID(Stack[-1]); Obj=2 // @poff=52
0x55: Pop(0)
0x56: @ GetItemImage(Stack[-1], Stack[-4]T)
0x57: Pop(0)
0x58: @ LoadImage(Stack[-4]T)
0x59: Pop(0)
0x5a: @ GetItemMaxStackSize(Stack[-1], Stack[-1]T)
0x5b: Pop(0)
...
0x63: Push((int) 3)
0x64: Push("") // @poff=13
0x65: @ SetTooltip(Stack[-2], Stack[-1], Stack[-2]T)
0x66: Pop(2)
0x67: GOTO 0x6c
