...
Strings:
	...
	W:vol_
	W:ui/NPC_Black.png
// @pool_raw:
// @pool_encoding:utf8
...
0x5f: Stack[-1] = "Neutral" // @poff=61
0x60: Call 0xa1

0x61: Pop(1)
0x62: Push((int) 14079)
0x63: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x64: Pop(1)
0x65: @@@ ClearReplies(); Obj=0 // @poff=88
0x66: Pop(0)
...
0x6d: Push((int) 15318)
0x6e: Push((int) 15317)
0x6f: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x70: Pop(3)
...
0x77: Push((int) 15326)
0x78: Push((int) 15325)
0x79: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7a: Pop(3)
0x7b: Push((int) 14082)
0x7c: Push((int) -1)
0x7d: Push((int) 15319)
0x7e: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x7f: Pop(3)
0x80: GOTO 0x83
...
0x92: Push("all") // @poff=110
0x93: Push("idle") // @poff=118
...
0xf8: Stack[-1] = "Neutral" // @poff=61
0xf9: Call 0xa1

0xfa: Pop(1)
0xfb: Push((int) 14079)
0xfc: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0xfd: Pop(1)
0xfe: @@@ ClearReplies(); Obj=0 // @poff=88
0xff: Pop(0)
...
0x108: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x109: Pop(3)
...
0x112: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x113: Pop(3)
0x114: Push((int) 14082)
0x115: Push((int) -1)
0x116: Push((int) 15319)
0x117: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x118: Pop(3)
0x119: Return(); Pop(0)
...
0x11e: Stack[-1] = "Neutral" // @poff=61
0x11f: Call 0xa1

0x120: Pop(1)
0x121: Push((int) 14111)
0x122: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x123: Pop(1)
0x124: @@@ ClearReplies(); Obj=0 // @poff=88
0x125: Pop(0)
...
0x142: Stack[-1] = "Neutral" // @poff=61
0x143: Call 0xa1

0x144: Pop(1)
0x145: Push((int) 14077)
0x146: @@@ SetMessage(Stack[-1]); Obj=0 // @poff=77
0x147: Pop(1)
0x148: @@@ ClearReplies(); Obj=0 // @poff=88
0x149: Pop(0)
0x14a: Push((int) 14078)
0x14b: Push((int) -1)
0x14c: Push((int) 15315)
0x14d: @@@ AddReply(Stack[-3], Stack[-2], Stack[-1]); Obj=0 // @poff=101
0x14e: Pop(3)
0x14f: Return(); Pop(0)
...
0x1cc: @@ GetPosition(Stack[-7]); Obj=17 // @poff=136
0x1cd: Pop(0)
0x1ce: @@ GetEyesHeight(Stack[-8]); Obj=17 // @poff=148
0x1cf: Pop(0)
...
0x20f: Pop(0)
0x210: Push("start: ") // @poff=180
0x211: Pop(1); Push(Stack[-1] + Stack[-3]);
0x212: @ Trace(Stack[-1])
0x213: Pop(1)
0x214: Push("end: ") // @poff=196
...
0x223: Push((float)9.999999974752427e-07)
...
0x22c: Pop(0)
0x22d: @@ HasItem(Stack[-2], Stack[-1]); Obj=6 // @poff=208
0x22e: Pop(0)
...
0x233: Pop(0)
0x234: Pop(0); PushNull((bool) Stack[-1] == 0)
...
0x253: Stack[-2] = Stack[-5]
0x254: Return(); Pop(4)

0x255: PushEmpty()
0x256: Push("playsound") // @poff=216
0x257: Push("giveitem") // @poff=236
0x258: @ TriggerWorld(Stack[-2], Stack[-1])
0x259: Pop(2)
0x25a: Return(); Pop(0)

0x25b: PushEmpty(string, string)
0x25c: Push("npc") // @poff=128
0x25d: @ GetProperty(Stack[-1], Stack[-2])
0x25e: Pop(1)
0x25f: Push("oo") // @poff=254
0x260: Pop(1); Push(Stack[-1] + Stack[-2]);
0x261: Push("1") // @poff=260
...
0x268: Push("powder") // @poff=264
0x269: Push((int) 1)
0x26a: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=278
0x26b: Pop(2)
0x26c: Return(); Pop(2)

0x26d: PushEmpty(int, int)
0x26e: Push("burah_serum") // @poff=295
0x26f: Push((int) 1)
0x270: @@ RemoveItemByType(Stack[-3], Stack[-2], Stack[-1]); Obj=6 // @poff=278
0x271: Pop(2)
0x272: Return(); Pop(2)

0x273: PushEmpty(string, string)
0x274: Push("npc") // @poff=128
0x275: @ GetProperty(Stack[-1], Stack[-2])
0x276: Pop(1)
0x277: PushEmpty(bool, string, string, string)
0x278: Stack[-3] = "volonteers_danko" // @poff=319
0x279: Stack[-2] = "rescue" // @poff=353
...
0x280: Stack[-4] = Stack[-2]
0x281: Stack[-1] = "burah_serum" // @poff=295
0x282: Call 0x22a
...
0x28b: Stack[-4] = Stack[-2]
0x28c: Stack[-1] = "powder" // @poff=264
0x28d: Call 0x22a
...
0x29f: Push("npc") // @poff=128
0x2a0: @ GetProperty(Stack[-1], Stack[-3])
0x2a1: Pop(1)
0x2a2: Push("oo") // @poff=254
0x2a3: Pop(1); Push(Stack[-1] + Stack[-3]);
0x2a4: Push("1") // @poff=260
...
0x341: Push("wasted_woman") // @poff=707
...
0x346: Push("wasted_male") // @poff=733
...
0x35f: Push("littlegirl") // @poff=809
...
0x378: Push("vaxxabitka") // @poff=899
...
0x3aa: Push("butcher_d") // @poff=1017
...
0x3af: Push("dohodyaga_d") // @poff=1037
...
0x3b9: Push("littleboy_d") // @poff=1075
...
0x3be: Push("littlegirl_d") // @poff=1099
...
0x3cd: Push("unosha2_d") // @poff=1159
...
0x3d2: Push("vaxxabit_d") // @poff=1179
...
0x3d7: Push("vaxxabitka_d") // @poff=1201
...
0x3dc: Push("wasted_male_d") // @poff=1227
...
0x3e1: Push("wasted_woman_d") // @poff=1255
...
0x3f5: Push("worker2_d") // @poff=1319
...
0x3ff: Push("gorbun_daughter") // @poff=1351
...
0x430: Stack[-1] = "ui/NPC_Black.png" // @poff=1475
0x431: Return(); Pop(0)
