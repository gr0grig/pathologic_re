...
// @pe
void func_2566(object var_100_object)
{
...
void func_1552(string var_201_string)
{
	var_201_string = "walk";
}
...
// @pe
void func_2577(int var_21_int)
{
	var_21_int = 0;
}


void func_1554(string var_202_string)
{
	var_202_string = "run";
}
...
// @pe
void func_2585(object var_28_object)
{
	object var_29_object;
	func_2781(var_29_object, var_29_object);
}
...
// @pe
void func_2592(object var_24_object)
{
	var_24_object->SetReturnValue(1000);
}


void func_2597(int var_89_int)
{
	int var_91_int;
...
void func_2614(int var_80_int, int var_81_int)
{
	int var_96_int;
...
void func_1112(bool var_0_bool, float var_315_float, int var_316_int)
{
	object var_320_object; float var_321_float; float var_322_float;
	@GetVictim((var_315_float * 0.9), var_320_object);
	@ReportAttack(var_0_bool);
	if(var_320_object == var_0_bool) {
		float var_326_float; object var_327_object; int var_328_int;
		var_320_object = var_327_object;
		var_316_int = var_328_int;
		func_901(var_328_int);
		var_326_float = var_321_float;
		float var_329_float; object var_330_object; float var_331_float; int var_332_int;
		var_320_object = var_330_object;
		int var_333_int; object var_334_object; int var_335_int;
		...
		@ReportHit(var_0_bool, var_382_int, var_322_float, var_331_float);
		object var_383_object; float var_384_float;
...
void func_1151(bool var_0_bool, bool var_1_bool, bool var_286_bool, float var_287_float)
{
	int var_290_int;
	...
	@Face(var_0_bool);
	@SetAttackState(true);
	@PlayAnimation("all", ("attack_begin" + var_290_int));
	@WaitForAnimEnd();
	bool var_291_bool;
	func_1358(var_290_int, var_291_bool);
	bool var_312_bool;
	func_2137(var_312_bool, var_0_bool);
	if(!var_312_bool) { //@nz
		@StopAsync();
		var_286_bool = false;
		return 4;
	}
	float var_315_float; int var_316_int;
	var_287_float = var_315_float;
	var_290_int = var_316_int;
	func_1112(var_291_bool, var_315_float, var_316_int);
	@HasAnimation(var_291_bool, "all", ("attack_middle" + var_290_int));
	if(var_291_bool != 0) {
		@PlayAnimation("all", ("attack_middle" + var_290_int));
		@WaitForAnimEnd();
		bool var_392_bool;
		func_2137(var_392_bool, var_0_bool);
		if(!var_392_bool) { //@nz
			@StopAsync();
			var_286_bool = false;
			return 4;
	...
	@PlayAnimation("all", ("attack_end" + var_290_int));
	bool var_401_bool;
	func_1231(var_401_bool, 0.75);
	@StopAsync();
	var_286_bool = true;
}


void func_2688(bool var_19_bool)
{
	...
	if(var_19_bool != 0) {
		...
		@irand(var_22_int, 4);
		if(!(var_22_int != 0)) goto Label_2761;
		int var_56_int;
...
void func_2762(int var_29_int, string var_30_string)
{
	int var_32_int;
...
void func_1231(bool var_401_bool, float var_402_float)
{
	float var_405_float; bool var_406_bool;
	@rand(var_405_float);
	if(var_405_float < var_402_float) {
...
void func_2767(int var_87_int)
{
	var_87_int = 3343;
}


void func_2769(string var_88_string)
{
	var_88_string = "ui/NPC_None.png";
}


void func_2771(bool var_20_bool)
{
	var_20_bool = false;
}
...
void func_2781(object var_29_object, object var_37_object)
{
	bool var_31_bool;
...
void func_1255(bool var_0_bool, bool var_243_bool, float var_244_float)
{
	bool var_250_bool; cvector var_251_cvector; cvector var_252_cvector; cvector var_253_cvector; float var_254_float;
	...
	for(;;) {
		...
		bool var_281_bool;
		func_2137(var_281_bool, var_0_bool);
		if(!var_281_bool) { //@nz
			var_243_bool = false;
			return 10;
		}
		...
		if(var_254_float < (var_244_float * var_244_float)) {
...
void func_2819(bool var_62_bool)
{
	var_62_bool = false;
}


void func_2821(bool var_21_bool, object var_22_object, object var_23_object)
{
	object var_29_object;
	...
	if(var_27_bool != 1) {
		...
		var_61_bool = var_58_float <= 250000.0;
		if(var_61_bool != 1)
			var_56_bool = false;
	}
	if(var_56_bool != 0) {
...
void func_1295(bool var_0_bool, bool var_256_bool)
{
	cvector var_262_cvector; cvector var_263_cvector;
	bool var_267_bool;
	func_2137(var_267_bool, var_0_bool);
	if(!var_267_bool) { //@nz
		var_256_bool = false;
		return 10;
	}
	...
	if(var_270_bool != 0) {
		var_0_bool->GetPFPosition(var_262_cvector); //@t
		@GetPFPosition(var_263_cvector);
		var_0_bool->GetAttackDistance(var_266_float); //@t
		var_266_float += 50;
		if(((var_262_cvector - var_263_cvector) | (var_262_cvector - var_263_cvector)) <= (var_266_float * var_266_float)) {
...
void func_1328(bool var_0_bool)
{
	...
	var_0_bool->GetPFPosition(var_276_cvector); //@t
...
void func_1347(bool var_0_bool, bool var_235_bool)
{
	bool var_237_bool;
	var_240_bool = IsFuncExist(var_0_bool, "IsAttacking", 1);
	if(var_240_bool != 0) {
		var_0_bool->IsAttacking(var_237_bool); //@t
...
void func_1358(bool var_2_bool, object var_4_object)
{
	...
	if(var_299_float < var_306_float) {
		@irand(var_300_int, var_2_bool);
		@Speak("attack" + (var_300_int + 1));
		int var_311_int;
...
// @pe
void func_2402(float var_365_float, float var_366_float, float var_367_float)
{
	if(var_366_float < var_367_float)
...
// @pe
void func_2409(float var_375_float, float var_376_float, float var_377_float, float var_378_float)
{
	if(var_376_float < var_377_float) {
		var_377_float = var_375_float;
		return 0;
	}
	if(var_376_float > var_378_float) {
...
void func_1390(int var_382_int)
{
	var_382_int = 0;
}
...
void func_1394(int var_311_int)
{
	var_311_int = 1;
}


void func_1396(float var_306_float)
{
	var_306_float = 0.5;
}
...
void func_1405(bool var_0_bool, bool var_1_bool, bool var_159_bool, object var_160_object, float var_161_float, float var_162_float, bool var_163_bool, bool var_164_bool)
{
	...
	for(;;) {
		...
		if(var_181_float > (var_161_float * var_161_float)) {
			...
			if(var_177_object != null) {
				if(var_176_bool == 0) goto Label_1458;
				var_176_bool = false;
...
// @pe
void func_893(object var_102_object)
{
	object var_108_object;
	func_907(var_103_object, var_104_int, var_105_int, var_106_bool, var_107_int, var_108_object, var_108_object, true, 180.0);
}


// @pe
void func_901(float var_326_float)
{
	var_326_float = 0.03;
}
...
// @pe
void func_904(int var_333_int)
{
	var_333_int = 0;
}


void func_907(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_108_object, bool var_109_bool, float var_110_float, bool var_165_bool)
{
	bool var_121_bool; bool var_122_bool; float var_123_float; cvector var_124_cvector; cvector var_125_cvector; bool var_126_bool; bool var_127_bool; float var_129_float; float var_130_float;
	var_1_bool = 0;
	
	for(;;) {
		@HasAnimation(var_121_bool, "all", ("attack_begin" + (var_1_bool + 1)));
		if(!var_121_bool) { //@nz
		} else {
			var_1_bool += 1;
		}
		...
		for(;;) {
			@IsExisting3DSound(var_122_bool, ("attack" + (var_2_bool + 1)));
			if(!var_122_bool) { //@nz
			} else {
									var_2_bool += 1;
			}
			var_4_object = 0;
			var_144_bool = IsFuncExist(var_108_object, "@GetAttackDistance", 1);
			if(var_144_bool != 0) {
			...
			for(;;) {
				...
				bool var_150_bool;
				func_2137(var_150_bool, var_0_bool);
				if(var_150_bool != 0) {
					if(!var_3_bool) //@nz
						var_149_bool = true;
				}
				if(var_149_bool != 0) {
					...
					var_129_float = (var_124_cvector - var_125_cvector) | (var_124_cvector - var_125_cvector);
					if(var_129_float >= ((400.0 + var_123_float) * (400.0 + var_123_float))) {
						bool var_159_bool; float var_161_float;
						var_123_float = var_161_float;
						TaskCall(6);
						func_1405(var_165_bool, var_166_object, var_159_bool, var_0_bool, var_161_float, 3000.0, true, false);
						TaskReturn();
						if(!var_165_bool) { //@nz
						} else {
							var_127_bool = false;
					...
					if(var_129_float >= (var_110_float * var_110_float)) {
						...
						@rand(var_130_float);
						bool var_232_bool;
						var_234_bool = var_130_float < 0.6;
						if(var_234_bool != 1) {
							bool var_235_bool;
							func_1347(true, var_235_bool);
							if(var_235_bool != 1)
								var_232_bool = false;
						}
						if(var_232_bool != 0) {
							...
							bool var_243_bool; float var_244_float;
							...
							bool var_415_bool;
							func_2137(var_415_bool, var_0_bool);
							if(!var_415_bool) { //@nz
								goto Label_1095;
							}
							var_0_bool->GetPFPosition(var_124_cvector); //@t
							@GetPFPosition(var_125_cvector);
							var_129_float = (var_124_cvector - var_125_cvector) | (var_124_cvector - var_125_cvector);
							if(!(var_129_float < (var_244_float * var_244_float))) goto Label_1085;
...
// @pe
void func_1997(string var_357_string, int var_358_int)
{
	if(var_358_int == 1)
		var_357_string = "fire";
	var_357_string = "phys";
...
void func_2012(float var_45_float, object var_46_object)
{
...
// @pe
void func_2541(int var_64_int, object var_65_object)
{
...
void func_2032(float var_329_float, object var_330_object, float var_331_float, int var_332_int)
{
	int var_342_int; int var_344_int;
	...
	if(!var_352_bool) //@nz
		...
		var_353_object->GetProperty("armor", var_342_int);
	string var_357_string; int var_358_int;
	var_332_int = var_358_int;
	func_1997(var_357_string, var_358_int);
	string var_343_string = "armor_" + var_357_string;
	bool var_361_bool; object var_362_object; string var_363_string;
	var_330_object = var_362_object;
	func_2020(var_361_bool, var_362_object, var_363_string);
	if(!var_361_bool) //@nz
		var_344_int = 0;
	else
		var_330_object->GetProperty(var_363_string, var_344_int);

	float var_365_float;
	func_2402(var_365_float, ((var_342_int + var_344_int) / 100.0), (float)1);
	float var_345_float;
	var_365_float = var_345_float;
	float var_346_float;
	var_330_object->GetProperty("health", var_346_float);
	float var_375_float;
	func_2409(var_375_float, (var_346_float - (var_331_float * (1 - var_345_float))), (float)0, (float)1);
	var_330_object->SetProperty("health", var_375_float);
	float var_347_float = var_329_float;
	
}


// @pe
void func_2551(object var_101_object)
{
...
// @pe
void func_2559(int var_62_int, object var_63_object)
{
