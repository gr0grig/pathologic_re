...
void func_2101(bool var_14_bool)
{
	int var_17_int; bool var_18_bool;
	if(var_14_bool != 0) {
		int var_23_int;
		func_1941(var_23_int);
		func_2071(0, (100 + (var_23_int * 100)));
		@irand(var_17_int, 9);
		if(var_17_int == 0) {
			int var_52_int;
			func_2276(var_52_int, "lemon");
			@AddItem(var_18_bool, var_52_int, 0, 1);
		} else {
				if(var_17_int == 1) {
					int var_60_int;
					func_2276(var_60_int, "rusk");
					@AddItem(var_18_bool, var_60_int, 0, 1);
			}
...
void func_571(void)
{
	int var_167_int; int var_168_int; bool var_169_bool; float var_170_float; bool var_171_bool;
	@WaitForAnimEnd();
	bool var_172_bool;
	...
	for(;;) {
		...
		if(var_187_bool != 0) {
			@irand(var_167_int, 3);
			if(var_167_int == 0) {
				if(var_165_int == 0) goto Label_618;
				@irand(var_168_int, var_165_int);
				string var_196_string; int var_197_int;
			...
			if(var_167_int == 1) {
				@rand(var_170_float, 4);
				@Sleep((var_170_float + 1), var_171_bool);
				if(!var_171_bool) { //@nz
					goto Label_639;
				}
			} else if(var_166_int != 0) {
				goto Label_639;
			}
			}
				var_166_int += 1;
...
void func_2276(int var_52_int, string var_53_string)
{
	int var_55_int;
...
void func_2289(object var_22_object)
{
	bool var_24_bool;
...
void func_2300(bool var_64_bool, object var_65_object)
{
	bool var_67_bool;
...
void func_2310(bool var_16_bool, object var_17_object, object var_18_object)
{
...
{
	float var_142_float; cvector var_143_cvector; cvector var_144_cvector; float var_145_float; bool var_146_bool; object var_147_object; bool var_148_bool;
	@rand(var_142_float, 0.5);
	@Sleep(var_142_float);
	...
	for(;;) {
		if(!false) { //@nz
			...
			Label_388:
				...
				@GetRandomPFPointInCircle(var_143_cvector, var_144_cvector, (var_145_float * 2.5), var_146_bool);
				if(var_146_bool != 0) {
				} else {
					@Sleep(1);
					goto Label_388;
...
void func_1918(bool var_131_bool)
{
	bool var_133_bool;
...
void func_1985(string var_180_string, int var_181_int)
{
	string var_183_string = "idle";
	if(var_181_int != 0)
		var_183_string += var_181_int;
	var_183_string = var_180_string;
}


void func_454(bool var_156_bool)
{
	var_156_bool = false;
}


void func_1992(int var_174_int)
{
	int var_177_int; bool var_178_bool;
	var_177_int = 0;
	
	for(;;) {
		string var_180_string; int var_181_int;
