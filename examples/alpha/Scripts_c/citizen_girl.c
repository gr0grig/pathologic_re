...
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x5aa,0x5ba,0x7a6,0x7da,0x80c,0x814,0x81d,0x827,0x841,0x856,0x85c,0x87c,0x885,0x88d,0x897,0x89f,0x8a9,0x8b1,0x8b4,0x8b6,0x8b9,0x8bb,0x8be,0x8c5,0x9f5
...
func_667(var_0_bool, var_77_object)
{
	...
	func_1727(var_92_cvector, var_93_object);
...
func_2267(var_79_int, var_80_int)
{
	...
	if(var_100_bool != 0) {
		...
		if(var_107_bool == 0) goto Label_2285;
		return 8;
	}
Label_2285:
...
func_2341(var_18_bool)
{
	...
	if(var_24_bool != 0) {
		...
		if(var_54_bool == 0) goto Label_2414;
...
func_2486(var_61_bool)
{
	var_62_float = 0;
	func_2420(var_62_float);
	var_61_bool = var_62_float > (float)0.6000000238418579;
	return 0;
}
