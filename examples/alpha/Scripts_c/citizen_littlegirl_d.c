// @IMPORTS: Hold/0,GetPosition/1,GetDirection/1,RemoveRTEnvelope/0,SetDeathState/0,Stop/0,StopAsync/0,LookAsync/3,PlayAnimation/2,WaitForAnimEnd/0,UnlookAsync/1,LockAnimationEnd/2,RemoveEnvelope/0,StopSecondaryAnimation/0,SensePlayerOnly/1,KillTimer/1,ResetAAS/0,IsPlayerActor/2,SetTimer/2,rand/2,Sleep/1,GetCameraFarDistance/1,GetRandomPFPointInCircle/4,FindShiftedPathTo/2,RotatePath/2,FollowPath/3,RequestClearPath/1,StopGroup0/0,irand/2,WaitForAnimEnd/1,Sleep/2,StopAnimation/0,Face/1,FindPathTo/2,FollowPath/5,FindLongestDir/6,Trace/1,Rotate/2,MovePoint/3,FindDirLength/3,GetScene/1,GetEyesHeight/1,AddActorByType/6,GetSecondaryAnimationType/1,FadeSecondaryAnimation/4,IsLoaded/1,GetGameTime/1,GetProperty/2,SignalDeath/1,HasAnimation/3,GetInvItemByName/2,AddItem/4,ClearSubContainer/1,IsOverrideActive/1,WorkWithCorpse/1,CanSee/2,ReportReputationChange/3,SetRTEnvelope/2
// @STRINGS: W:fdie|A:GetPosition|W:bdie|W:GetScriptProperty|W:Owner|A:HasScriptProperty|A:GetScriptProperty|W:@GetEyesHeight|A:GetEyesHeight|W:head|W:all|W:dattack_begin|W:dattack_end|W:zwalk|A:GetPFPosition|W:run|W:attack_on|W:attack_stay|W:attack_off|W:Can't retreat, distance: |W:HasProperty|A:HasProperty|A:GetProperty|A:SetProperty|W:disease|W:armor_disease|W:immunity|A:IsDead|W:IsDead|A:GetScene|W:noaccess|W:scripted|W:blood.xml|W:fhit|W:bhit|W:hit_react|W:1|W:2|W:health|W:idle|W:GenerateMoney: iMin > iMax|W:Money|W:flower|W:needle|W:class|W:rat
// @GLOBALS: 0:bool:
// @RUN_OP: 0x94
// @RUN_TASK: 1
...
// @PE: 0x0,0x78,0x8e,0x90,0x92,0x118,0x11e,0x124,0x147,0x1b1,0x285,0x2e1,0x305,0x378,0x38a,0x395,0x39e,0x3a7,0x463,0x515,0x636,0x641,0x652,0x667,0x66d,0x68d,0x690,0x698,0x6a2,0x6aa,0x6b4,0x6bc,0x6bf,0x6c1,0x6c4,0x6c6,0x6c9,0x737,0x73a,0x764
...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_bool, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool)
{
	...
	if(var_15_bool != 0) {
		...
		var_79_bool = var_14_int > (int)0;
		if(var_79_bool != 0) {
			var_81_bool = var_14_int > (int)1;
			if(var_81_bool != 0) {
				func_311(var_14_int);
			}
			var_83_object = Obj();
...
func_1178(var_0_bool, var_1_bool, var_2_bool, var_83_object)
{
	...
	func_1148(var_96_float, var_97_cvector, (float)1.7453293800354004);
	var_97_cvector = var_92_cvector;
	var_93_float = var_92_cvector | var_92_cvector;
	var_128_bool = var_93_float < (float)10000.0;
	if(var_128_bool != 0) {
		var_130_float = sqrt(var_93_float);
		var_131_int = "Can't retreat, distance: " + var_130_float;
		Trace(var_131_int);
		Sleep((float)0.5);
		return 10;
	}
	...
	var_1_bool = var_135_cvector + var_92_cvector;
	SetTimer((int)120, (float)0.5);
	var_2_bool = false;
	
Label_1211:
	MovePoint(var_1_bool, (int)1, var_94_bool);
	var_141_bool = var_94_bool;
	if(var_141_bool != 0) {
		var_142_bool = var_0_bool == 0; //@ne
		if(var_142_bool != 0) {
			goto Label_1241;
		EMIT "GOTO 0x4d7";
		...
		var_143_cvector = CVector(0,0,0); var_144_float = 0;
		func_1148(var_96_float, var_143_cvector, (float)2.6179938316345215);
		var_143_cvector = var_95_cvector;
		var_96_float = var_95_cvector | var_95_cvector;
		var_146_bool = var_96_float >= (float)10000.0;
		if(var_146_bool != 0) {
	...
	var_150_bool = var_2_bool == 0; //@nz
	if(var_150_bool == 1) goto Label_1211;
...
func_571()
{
	var_91_int = 0; var_92_int = 0; var_93_int = 0; var_94_int = 0; var_95_bool = 0; var_96_float = 0; var_97_bool = 0; var_98_int = 0; var_99_int = 0; var_100_int = 0; var_101_int = 0; var_102_bool = 0; var_103_float = 0; var_104_bool = 0;
	WaitForAnimEnd();
	var_105_bool = 0;
...
Label_585:
	...
	if(var_120_bool != 0) {
		irand(var_100_int, (int)3);
		var_126_bool = var_100_int == (int)0;
		if(var_126_bool != 0) {
			var_127_int = var_98_int;
			if(var_127_int == 0) goto Label_618;
			...
			var_131_bool = var_102_bool == 0; //@nz
			if(var_131_bool != 0) {
			} else {
		} else {
				var_134_bool = var_100_int == (int)1;
				if(var_134_bool != 0) {
					rand(var_103_float, (int)4);
					var_137_int = var_103_float + (int)1;
					Sleep(var_137_int, var_104_bool);
					var_138_bool = var_104_bool == 0; //@nz
					if(var_138_bool != 0) {
						goto Label_639;
					}
					goto Label_636;
				}
				var_139_int = var_99_int;
				if(var_139_int == 0) goto Label_636;
				goto Label_639;
		}
		Label_636:
...
func_1852(var_15_bool, var_16_object, var_17_object)
{
	...
	if(var_36_bool != 1) {
		...
		var_46_bool = var_37_float <= (float)250000.0;
		if(var_46_bool != 1) {
			var_35_bool = 0;
		}
	}
...
func_1774()
{
	...
	var_22_int = 0;
	func_1609(var_22_int);
	var_29_float = var_22_int * (int)5;
	var_20_int = (int)3 + var_29_float;
	...
	irand(var_17_int, (int)5);
	var_59_bool = var_17_int == (int)0;
	if(var_59_bool != 0) {
		var_60_int = 0; var_61_string = "";
		func_1818(var_60_int, "needle");
		AddItem(var_16_bool, var_60_int, (int)0, (int)1);
	}
	return 4;
}
...
{
	var_115_string = ""; var_116_string = "";
	var_117_int = var_114_int;
	if(var_117_int != 0) {
		"idle" = "idle" + var_114_int;
	}
...
{
	var_68_float = 0; var_69_cvector = CVector(0,0,0); var_70_cvector = CVector(0,0,0); var_71_float = 0; var_72_bool = 0; var_73_object = Obj(); var_74_bool = 0; var_75_float = 0; var_76_cvector = CVector(0,0,0); var_77_cvector = CVector(0,0,0); var_78_float = 0; var_79_bool = 0; var_80_object = Obj(); var_81_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_75_float, (float)0.5);
	Sleep(var_75_float);
	
Label_384:
	var_83_bool = var_0_bool == 0; //@nz
	if(var_83_bool != 0) {
		var_84_bool = var_1_bool == 0; //@nz
		if(var_84_bool != 0) {

		Label_388:
			GetPosition(var_77_cvector);
			GetCameraFarDistance(var_78_float);
			var_78_float = var_78_float * (float)2.5;
			GetRandomPFPointInCircle(var_76_cvector, var_77_cvector, var_78_float, var_79_bool);
...
{
	var_108_int = 0; var_109_bool = 0; var_110_int = 0; var_111_bool = 0;
	var_110_int = 0;
