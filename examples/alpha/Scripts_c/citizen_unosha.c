...
// @STANDALONE_EVENT_16: op=0xa4c vars=object,string
// @STANDALONE_EVENT_41: op=0xa59 vars=object
// @STANDALONE_EVENT_22: op=0xa5f vars=object,int,float,float
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x385,0x388,0x570,0x5e3,0x5f5,0x600,0x609,0x653,0x6c4,0x6d4,0x870,0x99f,0x9d3,0xa05,0xa0c,0xa17,0xa20,0xa2a,0xa44,0xa59,0xa5f,0xa7f,0xa88,0xa90,0xa9a,0xaa2,0xaa9,0xaaf,0xab2,0xab4,0xac0,0xaca,0xadc,0xae2,0xae5,0xc05,0xc5a
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2300(var_24_bool, var_25_object);
	...
	func_2168(var_61_cvector, var_62_object);
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool, var_17_int, var_18_int)
{
	if((int)1 != 0) {
		func_2548();
		var_22_bool = var_17_int == (int)15769;
		if(var_22_bool != 0) {
			var_23_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14538);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14539, (int)15771, (int)15770);
			@@@var_0_bool:AddReply((int)14564, (int)15799, (int)15798);
			@@@var_0_bool:AddReply((int)14571, (int)-1, (int)15805);
			@@@var_0_bool:AddReply((int)14572, (int)-1, (int)15806);
			@@@var_0_bool:AddReply((int)14573, (int)-1, (int)15807);
			@@@var_0_bool:AddReply((int)14574, (int)-1, (int)15808);
			@@@var_0_bool:AddReply((int)14575, (int)-1, (int)15809);
			@@@var_0_bool:AddReply((int)14576, (int)15811, (int)15810);
			@@@var_0_bool:AddReply((int)14578, (int)-1, (int)15812);
			return 0;
		...
		var_67_bool = var_17_int == (int)15815;
		if(var_67_bool != 0) {
			var_68_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14581);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14582, (int)15817, (int)15816);
			@@@var_0_bool:AddReply((int)14585, (int)15820, (int)15819);
			return 0;
		}
		var_77_bool = var_17_int == (int)15820;
		if(var_77_bool != 0) {
			var_78_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14586);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14587, (int)-1, (int)15821);
			@@@var_0_bool:AddReply((int)14588, (int)-1, (int)15822);
			return 0;
		}
		var_87_bool = var_17_int == (int)15817;
		if(var_87_bool != 0) {
			var_88_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14583);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14584, (int)-1, (int)15818);
			return 0;
		}
		var_94_bool = var_17_int == (int)15811;
		if(var_94_bool != 0) {
			var_95_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14577);
			@@@var_0_bool:ClearReplies();
			return 0;
		}
		var_98_bool = var_17_int == (int)15799;
		if(var_98_bool != 0) {
			var_99_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14565);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14566, (int)15801, (int)15800);
			return 0;
		}
		var_105_bool = var_17_int == (int)15801;
		if(var_105_bool != 0) {
			var_106_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14567);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14568, (int)15803, (int)15802);
			@@@var_0_bool:AddReply((int)14570, (int)-1, (int)15804);
			return 0;
		}
		var_115_bool = var_17_int == (int)15803;
		if(var_115_bool != 0) {
			var_116_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14569);
			@@@var_0_bool:ClearReplies();
			return 0;
		}
		var_119_bool = var_17_int == (int)15771;
		if(var_119_bool != 0) {
			var_120_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14540);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14541, (int)15773, (int)15772);
			@@@var_0_bool:AddReply((int)14545, (int)15778, (int)15777);
			@@@var_0_bool:AddReply((int)14557, (int)15790, (int)15789);
			@@@var_0_bool:AddReply((int)14563, (int)-1, (int)15797);
			return 0;
		}
		var_135_bool = var_17_int == (int)15790;
		if(var_135_bool != 0) {
			var_136_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14558);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14559, (int)15773, (int)15791);
			@@@var_0_bool:AddReply((int)14560, (int)15794, (int)15793);
			return 0;
		}
		var_145_bool = var_17_int == (int)15794;
		if(var_145_bool != 0) {
			var_146_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14561);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14562, (int)15778, (int)15795);
			return 0;
		}
		var_152_bool = var_17_int == (int)15778;
		if(var_152_bool != 0) {
			var_153_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14546);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14547, (int)15780, (int)15779);
			@@@var_0_bool:AddReply((int)14556, (int)-1, (int)15788);
			return 0;
		}
		var_162_bool = var_17_int == (int)15780;
		if(var_162_bool != 0) {
			var_163_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14548);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14549, (int)15782, (int)15781);
			@@@var_0_bool:AddReply((int)14555, (int)-1, (int)15787);
			return 0;
		}
		var_172_bool = var_17_int == (int)15782;
		if(var_172_bool != 0) {
			var_173_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14550);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14551, (int)15784, (int)15783);
			@@@var_0_bool:AddReply((int)14554, (int)-1, (int)15786);
			return 0;
		}
		var_182_bool = var_17_int == (int)15784;
		if(var_182_bool != 0) {
			var_183_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14552);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14553, (int)-1, (int)15785);
			return 0;
		}
		var_189_bool = var_17_int == (int)15773;
		if(var_189_bool != 0) {
			var_190_string = "";
			func_1732(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14542);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14543, (int)15778, (int)15774);
			@@@var_0_bool:AddReply((int)14544, (int)-1, (int)15776);
			return 0;
		}
		var_3_bool = true;
		var_198_bool = 0;
...
func_3080(var_21_bool, var_22_object, var_23_object)
{
	...
	if(var_42_bool != 0) {
		var_54_bool = var_26_string != "wasted_girl";
		if(var_54_bool != 0) {
			var_41_bool = 1;
		}
	}
	if(var_41_bool != 0) {
		var_56_bool = var_26_string != "woman";
		if(var_56_bool != 0) {
			var_40_bool = 1;
		}
	}
	if(var_40_bool != 0) {
		var_58_bool = var_26_string != "unosha";
		if(var_58_bool != 0) {
			var_39_bool = 1;
		}
	}
...
Label_1702:
	...
	Label_1706:
		lshWaitForAnimEnd();
		var_149_bool = var_3_bool;
		if(var_149_bool != 0) {
		} else {
			var_150_string = "";
			var_150_string = var_2_bool;
			func_2519(var_150_string);
			goto Label_1706;
	}
		PlayAnimation("all", "idle");
...
func_1151(var_0_bool, var_1_bool, var_261_bool, var_262_float)
{
	...
	func_2300(var_287_bool, var_288_object);
	...
	if(var_363_bool != 0) {
		...
		func_2300(var_367_bool, var_368_object);
...
func_2195(var_304_float, var_305_object, var_306_float, var_307_int)
{
	...
	func_2565(var_340_float, var_341_float, (float)1);
	...
	func_2572(var_350_float, var_351_float, (float)0, (float)1);
...
func_667(var_0_bool, var_69_object)
{
	...
	func_2168(var_84_cvector, var_85_object);
...
func_2789(var_28_object)
{
	...
	func_3037(var_28_object, var_29_object);
	return 0;
}
...
Label_1256:
	...
	if(var_230_bool != 0) {
		...
		func_2300(var_256_bool, var_257_object);
...
func_2813(var_25_int, var_26_int)
{
	...
	if(var_46_bool != 0) {
		...
		if(var_53_bool == 0) goto Label_2831;
		return 8;
	}
Label_2831:
...
func_1295(var_0_bool, var_231_bool)
{
	...
	func_2300(var_242_bool, var_243_object);
...
func_2843(var_19_bool)
{
	...
	if(var_24_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_88_bool == 0) goto Label_2931;
		...
		if(var_131_bool == 0) goto Label_3017;
...
Label_959:
	...
	var_126_object = var_0_bool;
	func_2300(var_125_bool, var_126_object);
	if(var_125_bool != 0) {
			...
			if(var_187_bool != 0) {
				...
				if(var_194_bool != 0) {
					...
					if(var_207_bool != 0) {
						...
						func_2300(var_390_bool, var_391_object);
...
{
	var_161_float = 0; var_162_cvector = CVector(0,0,0); var_163_cvector = CVector(0,0,0); var_164_cvector = CVector(0,0,0); var_165_cvector = CVector(0,0,0); var_166_cvector = CVector(0,0,0); var_167_cvector = CVector(0,0,0); var_168_bool = 0; var_169_float = 0; var_170_cvector = CVector(0,0,0); var_171_cvector = CVector(0,0,0); var_172_cvector = CVector(0,0,0); var_173_cvector = CVector(0,0,0); var_174_cvector = CVector(0,0,0); var_175_cvector = CVector(0,0,0); var_176_bool = 0;
	...
	var_177_float = var_177_float + var_169_float;
	SetByIndex(var_170_cvector, 1) = var_177_float;
	GetPosition(var_171_cvector);
	GetEyesHeight(var_169_float);
	var_178_float = GetByIndex(var_171_cvector, 1);
	var_178_float = var_178_float + var_169_float;
	SetByIndex(var_171_cvector, 1) = var_178_float;
	...
	var_180_int = var_172_cvector | var_172_cvector;
	var_181_float = sqrt(var_180_int);
	var_172_cvector = var_172_cvector / var_181_float;
	var_173_cvector = -var_172_cvector;
	var_183_float = var_172_cvector * (int)70;
	var_174_cvector = var_183_float - CVector(0.0, 10.0, 0.0);
	var_175_cvector = var_171_cvector + var_174_cvector;
	IsOverrideActive(var_176_bool);
	var_185_bool = var_176_bool;
	if(var_185_bool != 0) {
		var_159_bool = 0;
		return 16;
	}
	StopWorld();
	CameraTransit(var_175_cvector, var_173_cvector);
...
func_3037(var_29_object, var_37_object)
{
	...
	TaskReturn();
	var_158_bool = (int)1000 == var_37_object;
	if(var_158_bool != 0) {
		var_159_bool = 0; var_160_object = Obj();
		var_29_object = var_160_object;
		func_2467(var_159_bool, var_160_object);
		var_188_bool = var_159_bool == 0; //@nz
		if(var_188_bool != 0) {
			return 2;
		}
		var_189_object = Obj();
