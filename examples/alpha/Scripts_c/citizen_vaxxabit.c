	...
	void event_11(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, object var_12_object, object var_13_object, string var_14_string, bool var_15_bool, int var_16_int, int var_17_int)
	{
		if(1 != 0) {
			...
			if(var_16_int == 16505) {
				...
				var_0_bool->SetMessage(15228); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(15229, -1, 16506); //@t
				return 0;
			}
			var_3_bool = true;
			bool var_41_bool;
...
void func_667(bool var_0_bool, object var_68_object)
{
	...
	func_1458(var_83_cvector, var_0_bool);
...
void func_2217(object var_28_object, object var_36_object)
{
	bool var_30_bool;
...
void func_2255(bool var_61_bool)
{
	var_61_bool = true;
}


void func_2257(bool var_20_bool, object var_21_object, object var_22_object)
{
...
void func_1763(object var_76_object)
{
	float var_79_float;
...
// @pe
void func_1912(object var_67_object)
{
...
{
	object var_28_object;
	func_2217(var_28_object, var_28_object);
}
