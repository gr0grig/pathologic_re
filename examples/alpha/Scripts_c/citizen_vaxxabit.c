...
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x578,0x588,0x699,0x6cd,0x6ff,0x707,0x710,0x71a,0x734,0x749,0x74f,0x76f,0x778,0x780,0x78a,0x792,0x79c,0x7a4,0x7a7,0x7a9,0x7ac,0x7ae,0x7b1,0x8ff
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_string, var_15_bool, var_16_int, var_17_int)
{
	if((int)1 != 0) {
		func_1774();
		var_21_bool = var_16_int == (int)16505;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_1400(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)15228);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)15229, (int)-1, (int)16506);
			return 0;
		}
		var_3_bool = true;
		var_41_bool = 0;
...
func_667(var_0_bool, var_68_object)
{
	...
	func_1458(var_83_cvector, var_84_object);
	...
	func_1818(var_89_float, var_90_cvector, var_91_cvector);
	var_114_bool = var_89_float < (int)0;
	if(var_114_bool != 0) {
		var_115_object = Obj();
		var_115_object = var_0_bool;
		func_1617(var_115_object);
		var_75_bool = 1;
	} else {
...
func_1969(var_27_object)
{
	...
	func_2217(var_27_object, var_28_object);
	return 0;
}
