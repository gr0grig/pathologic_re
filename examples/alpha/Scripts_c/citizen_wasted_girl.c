...
// @STANDALONE_EVENT_16: op=0x7bd vars=object,string
// @STANDALONE_EVENT_41: op=0x7ca vars=object
// @STANDALONE_EVENT_22: op=0x7d0 vars=object,int,float,float
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x596,0x5a6,0x71a,0x74e,0x780,0x788,0x791,0x79b,0x7b5,0x7ca,0x7d0,0x7f0,0x7f9,0x801,0x80b,0x813,0x81d,0x825,0x828,0x82a,0x82d,0x82f,0x832,0x9a3
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_1587(var_60_cvector, var_61_object);
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_string, var_15_bool, var_16_int, var_17_int)
{
	if((int)1 != 0) {
		func_1903();
		var_21_bool = var_16_int == (int)15846;
		if(var_21_bool != 0) {
			var_22_string = "";
			func_1430(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14610);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14611, (int)15848, (int)15847);
			@@@var_0_bool:AddReply((int)14618, (int)15848, (int)15854);
			return 0;
		...
		var_45_bool = var_16_int == (int)15860;
		if(var_45_bool != 0) {
			var_46_string = "";
			func_1430(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14623);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14624, (int)-1, (int)15861);
			@@@var_0_bool:AddReply((int)14625, (int)-1, (int)15862);
			return 0;
		}
		var_55_bool = var_16_int == (int)15848;
		if(var_55_bool != 0) {
			var_56_string = "";
			func_1430(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14612);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14613, (int)-1, (int)15849);
			@@@var_0_bool:AddReply((int)14614, (int)-1, (int)15850);
			@@@var_0_bool:AddReply((int)14615, (int)15852, (int)15851);
			return 0;
		}
		var_68_bool = var_16_int == (int)15852;
		if(var_68_bool != 0) {
			var_69_string = "";
			func_1430(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14616);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14617, (int)-1, (int)15853);
			return 0;
		}
		var_3_bool = true;
		var_74_bool = 0;
...
func_2098(var_27_object)
{
	...
	func_2360(var_27_object, var_28_object);
	return 0;
}


func_1587(var_73_cvector, var_74_object)
{
...
func_2122(var_24_int, var_25_int)
{
	...
	if(var_45_bool != 0) {
		...
		if(var_52_bool == 0) goto Label_2140;
		return 8;
	}
Label_2140:
...
func_1106(var_0_bool, var_30_cvector, var_31_float)
{
	...
	func_1910(var_44_cvector, var_45_cvector);
...
func_2152(var_18_bool)
{
	...
	if(var_23_bool != 0) {
		...
		if(var_55_bool != 0) {
			...
			if(var_87_bool == 0) goto Label_2240;
		...
		if(var_130_bool == 0) goto Label_2326;
...
func_667(var_0_bool, var_77_object)
{
	...
	func_1587(var_92_cvector, var_93_object);
...
func_1762(var_45_bool, var_46_object)
{
	...
	func_1910(var_70_cvector, var_71_cvector);
