...
task task_4
{
	...
	void OnTimer(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, int var_5_int, object var_6_object, cvector var_7_cvector, bool var_8_bool, object var_9_object, cvector var_10_cvector, bool var_11_bool, object var_12_object, object var_13_object, object var_14_object, string var_15_string, bool var_16_bool)
	{
		if(var_16_bool != 111)
			return 4;
		bool var_23_bool;
		func_1655(var_23_bool, var_0_bool);
		if(!var_23_bool) { //@nz
			func_831();
			return 4;
		}
		...
		func_1587(var_60_cvector, var_0_bool);
...
task task_8
{
	...
	void event_11(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, object var_12_object, object var_13_object, string var_14_string, bool var_15_bool, int var_16_int, int var_17_int)
	{
		if(1 != 0) {
			func_1903();
			if(var_16_int == 15846) {
				func_1430(var_17_int, "Neutral");
				var_0_bool->SetMessage(14610); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14611, 15848, 15847); //@t
				var_0_bool->AddReply(14618, 15848, 15854); //@t
				return 0;
			...
			if(var_16_int == 15860) {
				func_1430(var_17_int, "Neutral");
				var_0_bool->SetMessage(14623); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14624, -1, 15861); //@t
				var_0_bool->AddReply(14625, -1, 15862); //@t
				return 0;
			}
			if(var_16_int == 15848) {
				func_1430(var_17_int, "Neutral");
				var_0_bool->SetMessage(14612); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14613, -1, 15849); //@t
				var_0_bool->AddReply(14614, -1, 15850); //@t
				var_0_bool->AddReply(14615, 15852, 15851); //@t
				return 0;
			}
			if(var_16_int == 15852) {
				func_1430(var_17_int, "Neutral");
				var_0_bool->SetMessage(14616); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14617, -1, 15853); //@t
				return 0;
			}
			var_3_bool = true;
			bool var_74_bool;
			func_2350(var_74_bool);
			if(var_74_bool != 0)
				@lshStopAnimation();
			else
				@StopAnimation();
...
void OnHit(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, object var_12_object, object var_13_object, string var_14_string, bool var_15_bool, object var_16_object, int var_17_int, float var_18_float, float var_19_float)
{
	...
	func_1679(var_21_int, var_22_float);
}
...
// @pe
void func_2049(int var_19_int, object var_20_object)
{
	object var_22_object;
	var_20_object = var_22_object;
	bool var_21_bool;
	func_1655(var_21_bool, var_22_object);
	if(var_21_bool != 0)
		var_19_int = 2;
	else
		var_19_int = 0;
...
// @pe
void func_2059(object var_61_object)
{
...
// @pe
void func_2067(int var_61_int, object var_62_object)
{
	object var_64_object;
	var_62_object = var_64_object;
	bool var_63_bool;
	func_1655(var_63_bool, var_64_object);
	if(var_63_bool != 0)
		var_61_int = 2;
	else
		var_61_int = 0;
...
// @pe
void func_2077(object var_97_object)
{
...
void func_1582(cvector var_88_cvector)
{
...
// @pe
void func_2098(object var_27_object)
{
	object var_28_object;
	func_2360(var_28_object, var_28_object);
}


void func_1587(cvector var_73_cvector, object var_74_object)
{
...
void func_1594(float var_44_float, object var_45_object)
{
...
void func_1090(bool var_0_bool, bool var_68_bool)
{
	...
	func_1587(var_73_cvector, var_0_bool);
...
void func_1602(bool var_45_bool, object var_46_object, string var_47_string)
{
...
void func_2122(int var_24_int, int var_25_int)
{
	int var_40_int;
...
void func_1614(bool var_38_bool, object var_39_object)
{
	bool var_41_bool;
	...
	for(;;) {
		...
		if(var_191_bool != 0) {
			...
			if(var_171_int == 0) {
				...
				func_2008(var_200_string, var_201_int);
...
void func_1106(bool var_0_bool, cvector var_30_cvector, float var_31_float)
{
	...
	func_1910(var_46_cvector, (var_38_cvector - var_39_cvector));
	func_1910(var_44_cvector, (var_46_cvector + (var_40_cvector * 0.75)));
...
void func_1619(bool var_27_bool, object var_28_object)
{
	...
	if(var_37_bool != 0) {
		...
		func_1614(var_38_bool, var_39_object);
		if(var_38_bool != 0)
			var_34_bool = true;
	}
	if(var_34_bool != 0) {
...
void func_2152(bool var_18_bool)
{
	int var_21_int; bool var_22_bool;
	if(var_18_bool != 0) {
		int var_27_int;
		func_1964(var_27_int);
		func_2122(0, (100 + (var_27_int * 100)));
		@irand(var_21_int, 9);
		if(var_21_int == 0) {
			int var_56_int;
			func_2327(var_56_int, "lemon");
			@AddItem(var_22_bool, var_56_int, 0, 1);
		} else {
				if(var_21_int == 1) {
					int var_64_int;
					func_2327(var_64_int, "rusk");
...
void func_1655(bool var_23_bool, object var_24_object)
{
	object var_28_object;
	...
	func_1602(var_45_bool, var_46_object, "noaccess");
	if(!var_45_bool) { //@nz
		var_23_bool = true;
		return 2;
	}
...
void func_1679(object var_20_object, int var_21_int)
{
...
void func_667(bool var_0_bool, object var_77_object)
{
	...
	func_1587(var_92_cvector, var_0_bool);
	...
	func_1947(var_98_float, var_99_cvector, var_100_cvector);
	if(var_98_float < 0) {
		func_1746(var_0_bool);
		var_84_bool = true;
	} else {
...
{
	func_1892(var_0_bool);
}


void func_1746(object var_92_object)
{
...
void func_1757(bool var_135_bool)
{
	bool var_137_bool;
...
void func_1762(bool var_45_bool, object var_46_object)
{
	...
	func_1910(var_70_cvector, (var_59_cvector ^ [0.0, 1.0, 0.0]));
...
void func_1284(bool var_0_bool, int var_34_int, object var_35_object)
{
	...
	func_1762(var_45_bool, var_46_object);
	if(!var_45_bool) { //@nz
		var_34_int = -2;
		return 8;
	}
...
void func_2327(int var_56_int, string var_57_string)
{
	int var_59_int;
...
void func_2332(float var_62_float)
{
...
void func_1822(bool var_137_bool, object var_138_object)
{
...
void func_2346(int var_86_int)
{
	var_86_int = 3340;
}


void func_2348(string var_87_string)
{
	var_87_string = "ui/NPC_None.png";
}


void func_2350(bool var_19_bool)
{
	var_19_bool = false;
}
...
void func_2360(object var_28_object, object var_36_object)
{
	bool var_30_bool;
	...
	if(1000 == var_36_object) {
		...
		func_1822(var_137_bool, var_138_object);
		if(!var_137_bool) //@nz
			return 2;
...
void func_1347(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_97_object, object var_98_object)
{
	...
	var_3_bool = false;
	if(1 != 0) {
		func_1430(var_98_object, "Neutral");
		var_0_bool->SetMessage(14610); //@t
		var_0_bool->ClearReplies(); //@t
		var_0_bool->AddReply(14611, 15848, 15847); //@t
		var_0_bool->AddReply(14618, 15848, 15854); //@t
...
void func_1874(string var_26_string)
{
...
void func_2398(bool var_61_bool)
{
	float var_62_float;
...
void func_2404(bool var_20_bool, object var_21_object, object var_22_object)
{
	object var_28_object;
	var_22_object = var_28_object;
	bool var_27_bool;
	func_1602(var_27_bool, var_28_object, "class");
	if(!var_27_bool) { //@nz
		var_20_bool = false;
		return 4;
	}
	...
	if(var_26_bool != 1) {
		...
		func_1594(var_44_float, var_45_object);
	...
	if(var_26_bool != 1) {
		...
		func_1594(var_57_float, var_58_object);
...
void func_1892(object var_85_object)
{
	float var_88_float;
...
void func_358(bool var_2_bool, object var_17_object)
{
	...
	func_1655(var_22_bool, var_23_object);
	if(!var_22_bool) //@nz
		return 4;
	if(var_2_bool != 0)
		return 4;
...
void func_1910(cvector var_46_cvector, cvector var_47_cvector)
{
...
// @pe
void func_1920(float var_79_float, cvector var_80_cvector, cvector var_81_cvector)
{
...
// @pe
void func_1928(float var_69_float, cvector var_70_cvector, cvector var_71_cvector)
{
...
// @pe
void func_1937(float var_78_float, cvector var_79_cvector)
{
...
// @pe
void func_1430(bool var_2_bool, string var_22_string)
{
	bool var_23_bool;
	func_2350(var_23_bool);
	if(!var_23_bool) //@nz
		return 0;
...
// @pe
void func_1947(float var_66_float, cvector var_67_cvector, cvector var_68_cvector)
{
	cvector var_70_cvector;
	...
	func_1937(var_87_float, var_88_cvector);
...
// @pe
void func_1973(object var_17_object)
{
	object var_18_object;
...
void func_2008(string var_184_string, int var_185_int)
{
...
void func_2015(int var_178_int)
{
...
// @pe
void func_2041(object var_76_object)
{
