...
task task_4
{
	...
	void OnTimer(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, int var_5_int, object var_6_object, int var_7_int, int var_8_int, bool var_9_bool, int var_10_int, bool var_11_bool, object var_12_object, object var_13_object, object var_14_object, object var_15_object, string var_16_string, bool var_17_bool)
	{
		if(var_17_bool != 111)
			return 4;
		bool var_24_bool;
		func_1999(var_24_bool, var_0_bool);
		if(!var_24_bool) { //@nz
			func_831();
			return 4;
		}
		...
		func_1867(var_61_cvector, var_0_bool);
	...
	void event_11(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, int var_6_int, int var_7_int, bool var_8_bool, int var_9_int, bool var_10_bool, object var_11_object, object var_12_object, object var_13_object, object var_14_object, string var_15_string, bool var_16_bool, int var_17_int, int var_18_int)
	{
		if(1 != 0) {
			...
			if(var_17_int == 15827) {
				...
				var_0_bool->SetMessage(14593); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14594, 15829, 15828); //@t
				var_0_bool->AddReply(14598, 15829, 15832); //@t
				var_0_bool->AddReply(14599, 15835, 15834); //@t
				return 0;
			...
			if(var_17_int == 15839) {
				func_1707(var_18_int, "Neutral");
				var_0_bool->SetMessage(14604); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14605, -1, 15840); //@t
				var_0_bool->AddReply(14606, -1, 15841); //@t
				return 0;
			}
			if(var_17_int == 15835) {
				func_1707(var_18_int, "Neutral");
				var_0_bool->SetMessage(14600); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14601, -1, 15836); //@t
				return 0;
			}
			if(var_17_int == 15829) {
				func_1707(var_18_int, "Neutral");
				var_0_bool->SetMessage(14595); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14596, -1, 15830); //@t
				var_0_bool->AddReply(14597, -1, 15831); //@t
				return 0;
			}
			var_3_bool = true;
			bool var_75_bool;
...
void func_2090(object var_93_object)
{
...
void func_2101(bool var_136_bool)
{
	bool var_138_bool;
...
void func_2106(bool var_46_bool, object var_47_object)
{
	...
	func_2254(var_71_cvector, (var_60_cvector ^ [0.0, 1.0, 0.0]));
...
void func_2166(bool var_141_bool, object var_142_object)
{
...
void func_1151(bool var_0_bool, bool var_1_bool, bool var_261_bool, float var_262_float)
{
	...
	bool var_287_bool;
	func_1999(var_287_bool, var_0_bool);
	if(!var_287_bool) { //@nz
		@StopAsync();
		var_261_bool = false;
		return 4;
	...
	if(var_266_bool != 0) {
		...
		@WaitForAnimEnd();
		bool var_367_bool;
		func_1999(var_367_bool, var_0_bool);
		if(!var_367_bool) { //@nz
			@StopAsync();
			var_261_bool = false;
			return 4;
...
void func_667(bool var_0_bool, object var_69_object)
{
	...
	func_1867(var_84_cvector, var_0_bool);
...
void func_2717(int var_57_int, string var_58_string)
{
	int var_60_int;
...
void func_2722(int var_87_int)
{
	var_87_int = 3341;
}


void func_2724(string var_88_string)
{
	var_88_string = "ui/NPC_None.png";
}


void func_2726(bool var_20_bool)
{
	var_20_bool = false;
}
...
void func_2218(string var_27_string)
{
...
// @pe
void func_1707(bool var_2_bool, string var_23_string)
{
	bool var_24_bool;
...
void func_2736(object var_29_object, object var_37_object)
{
	bool var_31_bool;
...
void func_2236(object var_77_object)
{
	float var_80_float;
...
void func_2254(cvector var_71_cvector, cvector var_72_cvector)
{
...
void func_2774(bool var_62_bool)
{
	var_62_bool = false;
}
...
// @pe
void func_2264(float var_340_float, float var_341_float, float var_342_float)
{
...
// @pe
void func_2776(bool var_63_bool)
{
	var_63_bool = true;
}


void func_2779(bool var_21_bool, object var_22_object, object var_23_object)
{
...
// @pe
void func_2271(float var_350_float, float var_351_float, float var_352_float, float var_353_float)
{
...
void func_1255(bool var_0_bool, bool var_218_bool, float var_219_float)
{
	...
	for(;;) {
		...
		bool var_256_bool;
		func_1999(var_256_bool, var_0_bool);
		if(!var_256_bool) { //@nz
			var_218_bool = false;
			return 10;
		}
...
// @pe
void func_2282(float var_70_float, cvector var_71_cvector, cvector var_72_cvector)
{
...
// @pe
void func_2291(float var_79_float, cvector var_80_cvector)
{
...
// @pe
void func_2301(float var_67_float, cvector var_68_cvector, cvector var_69_cvector)
{
	cvector var_71_cvector;
...
void func_1295(bool var_0_bool, bool var_231_bool)
{
	...
	bool var_242_bool;
	func_1999(var_242_bool, var_0_bool);
	if(!var_242_bool) { //@nz
		var_231_bool = false;
		return 10;
	}
...
// @pe
void func_2327(object var_18_object)
{
	object var_19_object;
...
void func_2362(string var_185_string, int var_186_int)
{
...
void func_2369(int var_179_int)
{
...
// @pe
void func_1859(string var_332_string, int var_333_int)
{
	if(var_333_int == 1)
		var_332_string = "fire";
	var_332_string = "phys";
...
void func_1867(cvector var_61_cvector, object var_62_object)
{
...
void func_1874(float var_61_float, object var_62_object)
{
	cvector var_66_cvector;
...
void func_1882(bool var_44_bool, object var_45_object, string var_46_string)
{
...
// @pe
void func_2395(object var_68_object)
{
...
// @pe
void func_2403(int var_74_int, object var_75_object)
{
...
void func_1894(float var_304_float, object var_305_object, float var_306_float, int var_307_int)
{
	...
	float var_340_float;
	func_2264(var_340_float, ((var_317_int + var_319_int) / 100.0), (float)1);
	float var_320_float;
	var_340_float = var_320_float;
	float var_321_float;
	var_305_object->GetProperty("health", var_321_float);
	float var_350_float;
	func_2271(var_350_float, (var_321_float - (var_306_float * (1 - var_320_float))), (float)0, (float)1);
...
// @pe
void func_2413(object var_76_object)
{
	object var_77_object;
...
// @pe
void func_2421(int var_72_int, object var_73_object)
{
...
// @pe
void func_2428(object var_110_object)
{
...
// @pe
void func_2439(int var_21_int, string var_22_string, object var_23_object)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			for(;;) {
				...
				bool var_125_bool;
				func_1999(var_125_bool, var_0_bool);
				if(var_125_bool != 0) {
					if(!var_3_bool) //@nz
						var_124_bool = true;
				}
				if(var_124_bool != 0) {
					...
					if(var_104_float >= (var_85_float * var_85_float)) {
						...
						if(var_207_bool != 0) {
							...
							bool var_390_bool;
							func_1999(var_390_bool, var_0_bool);
							if(!var_390_bool) { //@nz
								goto Label_1095;
							}
							var_0_bool->GetPFPosition(var_99_cvector); //@t
...
// @pe
void func_2451(string var_71_string, object var_72_object)
{
...
// @pe
void func_2461(int var_26_int, object var_27_object)
{
	object var_29_object;
...
void func_1958(bool var_37_bool, object var_38_object)
{
	bool var_40_bool;
...
void func_1963(bool var_26_bool, object var_27_object)
{
...
// @pe
void func_2479(object var_75_object)
{
...
// @pe
void func_2488(object var_28_object)
{
	object var_29_object;
	func_2736(var_29_object, var_29_object);
}
...
void func_1999(bool var_22_bool, object var_23_object)
{
	object var_27_object;
	var_23_object = var_27_object;
	bool var_26_bool;
...
void func_2512(int var_25_int, int var_26_int)
{
	int var_41_int;
...
void func_2023(object var_21_object, int var_22_int)
{
...
void func_2542(bool var_19_bool)
{
	int var_22_int; bool var_23_bool;
	if(var_19_bool != 0) {
		int var_28_int;
		func_2318(var_28_int);
		func_2512(0, (100 + (var_28_int * 100)));
		@irand(var_22_int, 9);
		if(var_22_int == 0) {
			int var_57_int;
