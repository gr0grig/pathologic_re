...
// @STANDALONE_EVENT_16: op=0x91f vars=object,string
// @STANDALONE_EVENT_41: op=0x92c vars=object
// @STANDALONE_EVENT_22: op=0x932 vars=object,int,float,float
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x385,0x388,0x570,0x5e3,0x5f5,0x600,0x609,0x653,0x6ab,0x6bb,0x743,0x872,0x8a6,0x8d8,0x8df,0x8ea,0x8f3,0x8fd,0x917,0x92c,0x932,0x952,0x95b,0x963,0x96d,0x975,0x97c,0x982,0x985,0x987,0x993,0x99d,0x9af,0x9b5,0x9b8,0xad8,0xb2d
...
task_2_event_17(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	var_20_int = 0; var_21_object = Obj();
	var_17_bool = var_21_object;
	func_2403(var_20_int, var_21_object);
	var_20_int = var_19_int;
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_int, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_object, var_17_string, var_18_bool)
{
	...
	if(var_21_bool != 0) {
		...
		var_105_bool = var_20_int > (int)0;
		if(var_105_bool != 0) {
			var_107_bool = var_20_int > (int)1;
			if(var_107_bool != 0) {
				func_333(var_20_int);
			}
			var_109_object = Obj();
...
task_2_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_int, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_object, var_17_string, var_18_bool)
{
	...
	if(var_66_bool != 0) {
		...
		func_2451(var_70_string, var_71_object);
	}
	return 2;
}
...
task_3_event_42(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_string, var_6_object, var_7_object, var_8_int, var_9_int, var_10_bool, var_11_int, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_object, var_17_string, var_18_bool)
{
	...
	if(var_66_bool != 0) {
		...
		func_2451(var_69_string, var_70_object);
	}
	return 2;
}
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_1999(var_24_bool, var_25_object);
	...
	func_1867(var_61_cvector, var_62_object);
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool, var_17_int, var_18_int)
{
	if((int)1 != 0) {
		func_2247();
		var_22_bool = var_17_int == (int)15827;
		if(var_22_bool != 0) {
			var_23_string = "";
			func_1707(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14593);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14594, (int)15829, (int)15828);
			@@@var_0_bool:AddReply((int)14598, (int)15829, (int)15832);
			@@@var_0_bool:AddReply((int)14599, (int)15835, (int)15834);
			return 0;
		...
		var_49_bool = var_17_int == (int)15839;
		if(var_49_bool != 0) {
			var_50_string = "";
			func_1707(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14604);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14605, (int)-1, (int)15840);
			@@@var_0_bool:AddReply((int)14606, (int)-1, (int)15841);
			return 0;
		}
		var_59_bool = var_17_int == (int)15835;
		if(var_59_bool != 0) {
			var_60_string = "";
			func_1707(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14600);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14601, (int)-1, (int)15836);
			return 0;
		}
		var_66_bool = var_17_int == (int)15829;
		if(var_66_bool != 0) {
			var_67_string = "";
			func_1707(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14595);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14596, (int)-1, (int)15830);
			@@@var_0_bool:AddReply((int)14597, (int)-1, (int)15831);
			return 0;
		}
		var_3_bool = true;
		var_75_bool = 0;
		func_2726(var_75_bool);
		if(var_75_bool != 0) {
			lshStopAnimation();
		} else {
			StopAnimation();
...
event_22(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool, var_17_object, var_18_int, var_19_float, var_20_float)
{
	...
	func_2023(var_22_int, var_23_float);
	return 0;
}
...
func_1556(var_0_bool, var_35_int, var_36_object)
{
	...
	func_2106(var_46_bool, var_47_object);
...
func_593()
{
	var_163_int = 0; var_164_int = 0; var_165_int = 0; var_166_int = 0; var_167_bool = 0; var_168_float = 0; var_169_bool = 0; var_170_int = 0; var_171_int = 0; var_172_int = 0; var_173_int = 0; var_174_bool = 0; var_175_float = 0; var_176_bool = 0;
	WaitForAnimEnd();
	var_177_bool = 0;
	func_2101(var_177_bool);
...
Label_607:
	var_192_bool = 0;
	var_192_bool = 0;
	var_194_bool = var_171_int < (int)5;
	if(var_194_bool != 0) {
		var_195_bool = 0;
		func_2101(var_195_bool);
		if(var_195_bool != 0) {
			var_192_bool = 1;
		}
	}
	if(var_192_bool != 0) {
		irand(var_172_int, (int)3);
		var_198_bool = var_172_int == (int)0;
		if(var_198_bool != 0) {
			var_199_int = var_170_int;
			if(var_199_int == 0) goto Label_640;
			irand(var_173_int, var_170_int);
			var_201_string = ""; var_202_int = 0;
			var_173_int = var_202_int;
			func_2362(var_201_string, var_202_int);
			PlayAnimation("all", var_201_string);
			WaitForAnimEnd(var_174_bool);
			var_203_bool = var_174_bool == 0; //@nz
			if(var_203_bool != 0) {
			} else {
		} else {
				var_206_bool = var_172_int == (int)1;
				if(var_206_bool != 0) {
					rand(var_175_float, (int)4);
					var_209_int = var_175_float + (int)1;
					Sleep(var_209_int, var_176_bool);
					var_210_bool = var_176_bool == 0; //@nz
					if(var_210_bool != 0) {
						goto Label_661;
					}
					goto Label_658;
				}
				var_211_int = var_171_int;
				if(var_211_int == 0) goto Label_658;
				goto Label_661;
		}
		Label_658:
...
func_1619(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_98_object, var_99_object)
{
	...
	if((int)1 != 0) {
		var_105_string = "";
		func_1707(var_99_object, "Neutral");
		@@@var_0_bool:SetMessage((int)14593);
		@@@var_0_bool:ClearReplies();
		@@@var_0_bool:AddReply((int)14594, (int)15829, (int)15828);
		@@@var_0_bool:AddReply((int)14598, (int)15829, (int)15832);
...
Label_1677:
	...
	Label_1681:
		...
		if(var_131_bool != 0) {
			...
			var_132_string = "";
			var_132_string = var_2_bool;
			func_2218(var_132_string);
			goto Label_1681;
	}
		PlayAnimation("all", "idle");
...
func_2166(var_141_bool, var_142_object)
{
	...
	var_159_float = var_159_float + var_151_float;
	SetByIndex(var_152_cvector, 1) = var_159_float;
	GetPosition(var_153_cvector);
	GetEyesHeight(var_151_float);
	var_160_float = GetByIndex(var_153_cvector, 1);
	var_160_float = var_160_float + var_151_float;
	SetByIndex(var_153_cvector, 1) = var_160_float;
	var_154_cvector = var_152_cvector - var_153_cvector;
	var_161_float = GetByIndex(var_154_cvector, 1);
	SetByIndex(var_154_cvector, 1) = (float)0;
	var_162_int = var_154_cvector | var_154_cvector;
	var_163_float = sqrt(var_162_int);
	var_154_cvector = var_154_cvector / var_163_float;
	var_155_cvector = -var_154_cvector;
	var_165_float = var_154_cvector * (int)70;
	var_156_cvector = var_165_float - CVector(0.0, 10.0, 0.0);
	var_157_cvector = var_153_cvector + var_156_cvector;
	IsOverrideActive(var_158_bool);
	var_167_bool = var_158_bool;
	if(var_167_bool != 0) {
		var_141_bool = 0;
		return 16;
	}
	StopWorld();
	CameraTransit(var_157_cvector, var_155_cvector);
...
func_1151(var_0_bool, var_1_bool, var_261_bool, var_262_float)
{
	...
	func_1999(var_287_bool, var_288_object);
	...
	if(var_363_bool != 0) {
		...
		func_1999(var_367_bool, var_368_object);
...
func_667(var_0_bool, var_69_object)
{
	...
	func_1867(var_84_cvector, var_85_object);
	...
	func_2301(var_90_float, var_91_cvector, var_92_cvector);
	var_115_bool = var_90_float < (int)0;
	if(var_115_bool != 0) {
		var_116_object = Obj();
		var_116_object = var_0_bool;
		func_2090(var_116_object);
		var_76_bool = 1;
	} else {
...
func_2736(var_29_object, var_37_object)
{
	...
	TaskReturn();
	var_140_bool = (int)1000 == var_37_object;
	if(var_140_bool != 0) {
		var_141_bool = 0; var_142_object = Obj();
		var_29_object = var_142_object;
		func_2166(var_141_bool, var_142_object);
		var_170_bool = var_141_bool == 0; //@nz
		if(var_170_bool != 0) {
			return 2;
		}
		var_171_object = Obj();
...
func_2779(var_21_bool, var_22_object, var_23_object)
{
	...
	func_1882(var_28_bool, var_29_object, "class");
	...
	var_44_bool = 0;
	var_44_bool = 0;
	var_46_bool = var_26_string != "littleboy";
	if(var_46_bool != 0) {
		var_48_bool = var_26_string != "littlegirl";
		if(var_48_bool != 0) {
			var_44_bool = 1;
		}
	}
	if(var_44_bool != 0) {
		var_50_bool = var_26_string != "boy";
		if(var_50_bool != 0) {
			var_43_bool = 1;
		}
	}
	if(var_43_bool != 0) {
		var_52_bool = var_26_string != "girl";
		if(var_52_bool != 0) {
			var_42_bool = 1;
		}
	}
	if(var_42_bool != 0) {
		var_54_bool = var_26_string != "wasted_male";
		if(var_54_bool != 0) {
			var_41_bool = 1;
		}
	}
	if(var_41_bool != 0) {
		var_56_bool = var_26_string != "wasted_girl";
		if(var_56_bool != 0) {
			var_40_bool = 1;
		}
	}
	if(var_40_bool != 0) {
		var_58_bool = var_26_string != "woman";
		if(var_58_bool != 0) {
			var_39_bool = 1;
		}
	}
	...
	var_59_bool = 0;
	var_59_bool = 1;
	var_60_bool = var_27_bool;
	if(var_60_bool != 1) {
		var_61_float = 0; var_62_object = Obj();
		var_22_object = var_62_object;
		func_1874(var_61_float, var_62_object);
		var_70_bool = var_61_float <= (float)250000.0;
		if(var_70_bool != 1) {
			var_59_bool = 0;
		}
	}
...
Label_1256:
	...
	if(var_230_bool != 0) {
		...
		func_1999(var_256_bool, var_257_object);
...
func_2301(var_67_float, var_68_cvector, var_69_cvector)
{
	...
	func_2291(var_88_float, var_89_cvector);
...
func_1295(var_0_bool, var_231_bool)
{
	...
	func_1999(var_242_bool, var_243_object);
...
{
	var_180_int = 0; var_181_bool = 0; var_182_int = 0; var_183_bool = 0;
	var_182_int = 0;
...
Label_2371:
	...
	var_190_bool = var_183_bool == 0; //@nz
	if(var_190_bool != 0) {
	} else {
...
func_2403(var_74_int, var_75_object)
{
	...
	func_1999(var_76_bool, var_77_object);
	if(var_76_bool != 0) {
		var_74_int = 2;
	} else {
		var_74_int = 0;
...
func_358(var_2_bool, var_18_object)
{
	...
	func_1999(var_23_bool, var_24_object);
...
func_1894(var_304_float, var_305_object, var_306_float, var_307_int)
{
	...
	func_1882(var_323_bool, var_324_object, "health");
	...
	func_1882(var_327_bool, var_328_object, "armor");
	...
	func_1882(var_336_bool, var_337_object, var_338_string);
	...
	func_2264(var_340_float, var_341_float, (float)1);
	...
	func_2271(var_350_float, var_351_float, (float)0, (float)1);
...
{
	var_301_float = 0.10000000149011612;
	return 0;
}
...
Label_959:
	...
	var_126_object = var_0_bool;
	func_1999(var_125_bool, var_126_object);
	if(var_125_bool != 0) {
			...
			if(var_187_bool != 0) {
				...
				if(var_194_bool != 0) {
					...
					if(var_207_bool != 0) {
						...
						func_1999(var_390_bool, var_391_object);
...
{
	var_140_float = 0; var_141_cvector = CVector(0,0,0); var_142_cvector = CVector(0,0,0); var_143_float = 0; var_144_bool = 0; var_145_object = Obj(); var_146_bool = 0; var_147_float = 0; var_148_cvector = CVector(0,0,0); var_149_cvector = CVector(0,0,0); var_150_float = 0; var_151_bool = 0; var_152_object = Obj(); var_153_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_147_float, (float)0.5);
	Sleep(var_147_float);
	
Label_406:
	var_155_bool = var_0_bool == 0; //@nz
	if(var_155_bool != 0) {
		var_156_bool = var_1_bool == 0; //@nz
		if(var_156_bool != 0) {

		Label_410:
			GetPosition(var_149_cvector);
			GetCameraFarDistance(var_150_float);
			var_150_float = var_150_float * (float)2.5;
			GetRandomPFPointInCircle(var_148_cvector, var_149_cvector, var_150_float, var_151_bool);
...
Label_427:
	...
	var_159_bool = var_152_object != 0; //@nn
	if(var_159_bool != 0) {
...
func_2461(var_26_int, var_27_object)
{
	...
	func_1999(var_28_bool, var_29_object);
...
func_1958(var_37_bool, var_38_object)
{
...
func_2488(var_28_object)
{
	...
	func_2736(var_28_object, var_29_object);
	return 0;
}
...
func_1999(var_22_bool, var_23_object)
{
	...
	func_1882(var_44_bool, var_45_object, "noaccess");
...
{
	var_36_int = 0; var_37_int = 0; var_38_int = 0; var_39_bool = 0; var_40_int = 0; var_41_int = 0; var_42_int = 0; var_43_bool = 0;
	var_44_bool = var_25_int > var_26_int;
	if(var_44_bool != 0) {
		Trace("GenerateMoney: iMin > iMax");
		return 8;
	}
	var_46_bool = var_25_int != var_26_int;
	if(var_46_bool != 0) {
		var_47_int = var_26_int - var_25_int;
		irand(var_41_int, var_47_int);
	} else {
		var_53_bool = var_25_int == (int)0;
		if(var_53_bool == 0) goto Label_2530;
		return 8;
	}
Label_2530:
	...
	AddItem(var_43_bool, var_42_int, (int)0, var_40_int);
	return 8;
...
func_2542(var_19_bool)
{
	...
	if(var_24_bool != 0) {
		...
		var_28_int = 0;
		func_2318(var_28_int);
		var_35_float = var_28_int * (int)100;
		var_26_int = (int)100 + var_35_float;
		func_2512((int)0, var_26_int);
		irand(var_22_int, (int)9);
		var_56_bool = var_22_int == (int)0;
		if(var_56_bool != 0) {
			var_57_int = 0; var_58_string = "";
			func_2717(var_57_int, "lemon");
			AddItem(var_23_bool, var_57_int, (int)0, (int)1);
		} else {
			var_64_bool = var_22_int == (int)1;
			if(var_64_bool != 0) {
				var_65_int = 0; var_66_string = "";
				func_2717(var_65_int, "rusk");
				AddItem(var_23_bool, var_65_int, (int)0, (int)1);
				goto Label_2630;
			}
			var_70_bool = var_22_int == (int)2;
			if(var_70_bool != 0) {
				var_71_int = 0; var_72_string = "";
				func_2717(var_71_int, "hook");
				AddItem(var_23_bool, var_71_int, (int)0, (int)1);
				goto Label_2630;
			}
			var_76_bool = var_22_int == (int)4;
			if(var_76_bool != 0) {
				var_77_int = 0; var_78_string = "";
				func_2717(var_77_int, "syringe");
				AddItem(var_23_bool, var_77_int, (int)0, (int)1);
				goto Label_2630;
			}
			var_82_bool = var_22_int == (int)5;
			if(var_82_bool != 0) {
				var_83_int = 0; var_84_string = "";
				func_2717(var_83_int, "watch");
				AddItem(var_23_bool, var_83_int, (int)0, (int)1);
				goto Label_2630;
			}
			var_88_bool = var_22_int == (int)6;
			if(var_88_bool == 0) goto Label_2630;
			var_89_int = 0; var_90_string = "";
			func_2717(var_89_int, "razor");
			AddItem(var_23_bool, var_89_int, (int)0, (int)1);
	}
		var_93_int = 0; var_94_int = 0;
		var_96_int = 0;
		func_2318(var_96_int);
		var_98_float = var_96_int * (int)50;
		var_94_int = (int)50 + var_98_float;
		func_2512((int)0, var_94_int);
		irand(var_22_int, (int)8);
		var_101_bool = var_22_int == (int)0;
		if(var_101_bool != 0) {
			var_102_int = 0; var_103_string = "";
			func_2717(var_102_int, "beads");
			AddItem(var_23_bool, var_102_int, (int)0, (int)1);
			goto Label_2716;
		}
		var_107_bool = var_22_int == (int)1;
		if(var_107_bool != 0) {
			var_108_int = 0; var_109_string = "";
			func_2717(var_108_int, "bracelet");
			AddItem(var_23_bool, var_108_int, (int)0, (int)1);
			goto Label_2716;
		}
		var_113_bool = var_22_int == (int)2;
		if(var_113_bool != 0) {
			var_114_int = 0; var_115_string = "";
			func_2717(var_114_int, "ear_ring");
			AddItem(var_23_bool, var_114_int, (int)0, (int)1);
			goto Label_2716;
		}
		var_119_bool = var_22_int == (int)3;
		if(var_119_bool != 0) {
			var_120_int = 0; var_121_string = "";
			func_2717(var_120_int, "gold_ring");
			AddItem(var_23_bool, var_120_int, (int)0, (int)1);
			goto Label_2716;
		}
		var_125_bool = var_22_int == (int)4;
		if(var_125_bool != 0) {
			var_126_int = 0; var_127_string = "";
			func_2717(var_126_int, "silver_ring");
			AddItem(var_23_bool, var_126_int, (int)0, (int)1);
			goto Label_2716;
		}
		var_131_bool = var_22_int == (int)5;
		if(var_131_bool == 0) goto Label_2716;
		var_132_int = 0; var_133_string = "";
		func_2717(var_132_int, "flower");
		AddItem(var_23_bool, var_132_int, (int)0, (int)1);
	}
Label_2630:
	goto Label_2716;
