...
// @PE: 0x0,0x78,0x8e,0x90,0x92,0x118,0x11e,0x124,0x147,0x1b1,0x285,0x2e1,0x305,0x378,0x38a,0x395,0x39e,0x3a7,0x3af,0x3b2,0x59a,0x60d,0x61f,0x62a,0x633,0x63e,0x783,0x78a,0x79e,0x7b3,0x7b9,0x7d9,0x7dc,0x7e4,0x7ee,0x7f6,0x7fd,0x803,0x806,0x808,0x80b,0x80d,0x810,0x901,0x904,0x934
...
func_2101(var_14_bool)
{
	...
	if(var_19_bool != 0) {
		...
		irand(var_17_int, (int)9);
		var_51_bool = var_17_int == (int)0;
		if(var_51_bool != 0) {
			var_52_int = 0; var_53_string = "";
			func_2276(var_52_int, "lemon");
			AddItem(var_18_bool, var_52_int, (int)0, (int)1);
		} else {
			var_59_bool = var_17_int == (int)1;
			if(var_59_bool != 0) {
				var_60_int = 0; var_61_string = "";
				func_2276(var_60_int, "rusk");
				AddItem(var_18_bool, var_60_int, (int)0, (int)1);
				goto Label_2189;
			}
			var_65_bool = var_17_int == (int)2;
			if(var_65_bool != 0) {
				var_66_int = 0; var_67_string = "";
				func_2276(var_66_int, "hook");
				AddItem(var_18_bool, var_66_int, (int)0, (int)1);
				goto Label_2189;
			}
			var_71_bool = var_17_int == (int)4;
			if(var_71_bool != 0) {
				var_72_int = 0; var_73_string = "";
				func_2276(var_72_int, "syringe");
				AddItem(var_18_bool, var_72_int, (int)0, (int)1);
				goto Label_2189;
			}
			var_77_bool = var_17_int == (int)5;
			if(var_77_bool != 0) {
				var_78_int = 0; var_79_string = "";
				func_2276(var_78_int, "watch");
				AddItem(var_18_bool, var_78_int, (int)0, (int)1);
				goto Label_2189;
			}
			var_83_bool = var_17_int == (int)6;
			if(var_83_bool == 0) goto Label_2189;
			var_84_int = 0; var_85_string = "";
			func_2276(var_84_int, "razor");
			AddItem(var_18_bool, var_84_int, (int)0, (int)1);
	}
		var_88_int = 0; var_89_int = 0;
		var_91_int = 0;
		func_1941(var_91_int);
		var_93_float = var_91_int * (int)50;
		var_89_int = (int)50 + var_93_float;
		func_2071((int)0, var_89_int);
		irand(var_17_int, (int)8);
		var_96_bool = var_17_int == (int)0;
		if(var_96_bool != 0) {
			var_97_int = 0; var_98_string = "";
			func_2276(var_97_int, "beads");
			AddItem(var_18_bool, var_97_int, (int)0, (int)1);
			goto Label_2275;
		}
		var_102_bool = var_17_int == (int)1;
		if(var_102_bool != 0) {
			var_103_int = 0; var_104_string = "";
			func_2276(var_103_int, "bracelet");
			AddItem(var_18_bool, var_103_int, (int)0, (int)1);
			goto Label_2275;
		}
		var_108_bool = var_17_int == (int)2;
		if(var_108_bool != 0) {
			var_109_int = 0; var_110_string = "";
			func_2276(var_109_int, "ear_ring");
			AddItem(var_18_bool, var_109_int, (int)0, (int)1);
			goto Label_2275;
		}
		var_114_bool = var_17_int == (int)3;
		if(var_114_bool != 0) {
			var_115_int = 0; var_116_string = "";
			func_2276(var_115_int, "gold_ring");
			AddItem(var_18_bool, var_115_int, (int)0, (int)1);
			goto Label_2275;
		}
		var_120_bool = var_17_int == (int)4;
		if(var_120_bool != 0) {
			var_121_int = 0; var_122_string = "";
			func_2276(var_121_int, "silver_ring");
			AddItem(var_18_bool, var_121_int, (int)0, (int)1);
			goto Label_2275;
		}
		var_126_bool = var_17_int == (int)5;
		if(var_126_bool == 0) goto Label_2275;
		var_127_int = 0; var_128_string = "";
		func_2276(var_127_int, "flower");
		AddItem(var_18_bool, var_127_int, (int)0, (int)1);
	}
Label_2189:
	goto Label_2275;
...
func_571()
{
	var_158_int = 0; var_159_int = 0; var_160_int = 0; var_161_int = 0; var_162_bool = 0; var_163_float = 0; var_164_bool = 0; var_165_int = 0; var_166_int = 0; var_167_int = 0; var_168_int = 0; var_169_bool = 0; var_170_float = 0; var_171_bool = 0;
	WaitForAnimEnd();
	var_172_bool = 0;
	func_1918(var_172_bool);
...
Label_585:
	var_187_bool = 0;
	var_187_bool = 0;
	var_189_bool = var_166_int < (int)5;
	if(var_189_bool != 0) {
		var_190_bool = 0;
		func_1918(var_190_bool);
		if(var_190_bool != 0) {
			var_187_bool = 1;
		}
	}
	if(var_187_bool != 0) {
		irand(var_167_int, (int)3);
		var_193_bool = var_167_int == (int)0;
		if(var_193_bool != 0) {
			var_194_int = var_165_int;
			if(var_194_int == 0) goto Label_618;
			irand(var_168_int, var_165_int);
			var_196_string = ""; var_197_int = 0;
			var_168_int = var_197_int;
			func_1985(var_196_string, var_197_int);
			PlayAnimation("all", var_196_string);
			WaitForAnimEnd(var_169_bool);
			var_198_bool = var_169_bool == 0; //@nz
			if(var_198_bool != 0) {
			} else {
		} else {
				var_201_bool = var_167_int == (int)1;
				if(var_201_bool != 0) {
					rand(var_170_float, (int)4);
					var_204_int = var_170_float + (int)1;
					Sleep(var_204_int, var_171_bool);
					var_205_bool = var_171_bool == 0; //@nz
					if(var_205_bool != 0) {
						goto Label_639;
					}
					goto Label_636;
				}
				var_206_int = var_166_int;
				if(var_206_int == 0) goto Label_636;
				goto Label_639;
		}
		Label_636:
...
{
	var_135_float = 0; var_136_cvector = CVector(0,0,0); var_137_cvector = CVector(0,0,0); var_138_float = 0; var_139_bool = 0; var_140_object = Obj(); var_141_bool = 0; var_142_float = 0; var_143_cvector = CVector(0,0,0); var_144_cvector = CVector(0,0,0); var_145_float = 0; var_146_bool = 0; var_147_object = Obj(); var_148_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_142_float, (float)0.5);
	Sleep(var_142_float);
	
Label_384:
	var_150_bool = var_0_bool == 0; //@nz
	if(var_150_bool != 0) {
		var_151_bool = var_1_bool == 0; //@nz
		if(var_151_bool != 0) {

		Label_388:
			GetPosition(var_144_cvector);
			GetCameraFarDistance(var_145_float);
			var_145_float = var_145_float * (float)2.5;
			GetRandomPFPointInCircle(var_143_cvector, var_144_cvector, var_145_float, var_146_bool);
...
Label_405:
	FindShiftedPathTo(var_147_object, var_143_cvector);
	var_154_bool = var_147_object != 0; //@nn
	if(var_154_bool != 0) {
		RotatePath(var_147_object, var_148_bool);
		var_155_bool = var_148_bool;
		if(var_155_bool != 0) {
			var_156_bool = 0;
			func_454(var_156_bool);
			FollowPath(var_147_object, var_156_bool, var_148_bool);
			var_147_object = 0;
			var_157_bool = var_148_bool;
			if(var_157_bool != 0) {
				TaskCall(2);
				func_571();
				TaskReturn();
...
{
	var_313_float = 0.10000000149011612;
	return 0;
}
...
func_1985(var_180_string, var_181_int)
{
	...
	if(var_184_int != 0) {
		"idle" = "idle" + var_181_int;
	}
	var_183_string = var_180_string;
	return 2;
}
...
{
	var_175_int = 0; var_176_bool = 0; var_177_int = 0; var_178_bool = 0;
	var_177_int = 0;
	
Label_1994:
	var_180_string = ""; var_181_int = 0;
	var_177_int = var_181_int;
	func_1985(var_180_string, var_181_int);
	HasAnimation(var_178_bool, "all", var_180_string);
	var_185_bool = var_178_bool == 0; //@nz
	if(var_185_bool != 0) {
	} else {
