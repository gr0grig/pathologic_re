...
void func_1178(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_85_object)
{
	cvector var_97_cvector; float var_98_float;
	cvector var_99_cvector;
	func_1148(var_98_float, var_99_cvector, 1.7453294);
...
Label_1211:
	...
	if(var_96_bool != 0) {
		...
		Label_1241:
			...
			func_1148(var_98_float, var_145_cvector, 2.6179938);
...
void func_1949(int var_51_int, string var_52_string)
{
	int var_54_int;
...
void func_1575(bool var_130_bool)
{
	bool var_132_bool;
...
// @pe
void func_1706(int var_50_int, object var_51_object)
{
...
void func_1962(object var_21_object)
{
	bool var_23_bool;
...
// @pe
void func_1716(object var_84_object)
{
	object var_85_object;
...
void func_1973(bool var_63_bool, object var_64_object)
{
	bool var_66_bool;
...
void func_1338(float var_39_float, object var_40_object)
{
...
void func_1983(bool var_15_bool, object var_16_object, object var_17_object)
{
...
void func_1774(bool var_13_bool)
{
	int var_16_int; bool var_17_bool;
	if(var_13_bool != 0) {
		int var_22_int;
		func_1609(var_22_int);
		func_1744(0, (100 + (var_22_int * 100)));
		@irand(var_16_int, 9);
		if(var_16_int == 0) {
			int var_51_int;
...
void func_1653(string var_179_string, int var_180_int)
{
...
void func_1660(int var_173_int)
{
