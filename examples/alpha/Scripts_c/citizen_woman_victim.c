// @IMPORTS: Hold/0,GetPosition/1,GetDirection/1,RemoveRTEnvelope/0,SetDeathState/0,Stop/0,StopAsync/0,LookAsync/3,PlayAnimation/2,WaitForAnimEnd/0,UnlookAsync/1,LockAnimationEnd/2,RemoveEnvelope/0,StopSecondaryAnimation/0,SensePlayerOnly/1,KillTimer/1,ResetAAS/0,IsPlayerActor/2,SetTimer/2,rand/2,Sleep/1,GetCameraFarDistance/1,GetRandomPFPointInCircle/4,FindShiftedPathTo/2,RotatePath/2,FollowPath/3,RequestClearPath/1,StopGroup0/0,irand/2,WaitForAnimEnd/1,Sleep/2,StopAnimation/0,Face/1,FindLongestDir/6,Trace/1,Rotate/2,MovePoint/3,FindDirLength/3,GetScene/1,GetEyesHeight/1,AddActorByType/6,GetSecondaryAnimationType/1,FadeSecondaryAnimation/4,RotateAsync/2,IsLoaded/1,self/1,GetGameTime/1,GetProperty/2,SignalDeath/1,HasAnimation/3,GetInvItemByName/2,AddItem/4,FindActor/2,GetActiveScene/1,BroadcastMessage/3,IsOverrideActive/1,WorkWithCorpse/1,CanSee/2,ReportReputationChange/3,SetRTEnvelope/2
// @STRINGS: W:fdie|A:GetPosition|W:bdie|W:GetScriptProperty|W:Owner|A:HasScriptProperty|A:GetScriptProperty|W:@GetEyesHeight|A:GetEyesHeight|W:head|W:all|W:attack_on|W:attack_stay|W:attack_off|W:Can't retreat, distance: |W:HasProperty|A:HasProperty|A:IsDead|W:IsDead|A:GetScene|W:noaccess|A:GetProperty|W:scripted|W:blood.xml|W:fhit|W:bhit|W:hit_react|W:1|W:2|W:health|W:idle|W:GenerateMoney: iMin > iMax|W:Money|W:lemon|W:rusk|W:hook|W:syringe|W:watch|W:razor|W:beads|W:bracelet|W:ear_ring|W:gold_ring|W:silver_ring|W:flower|W:player|W:reputation|W:killme|W:class|W:rat|W:dog
...
// @STANDALONE_EVENT_16: op=0x5fa vars=object,string
// @STANDALONE_EVENT_41: op=0x607 vars=object
// @STANDALONE_EVENT_22: op=0x60d vars=object,int,float,float
// @PE: 0x0,0x78,0x8e,0x90,0x92,0x118,0x11e,0x124,0x147,0x1b1,0x334,0x367,0x423,0x4d5,0x5bd,0x5c5,0x5ce,0x5d8,0x5f2,0x607,0x60d,0x62d,0x636,0x63e,0x648,0x650,0x65a,0x662,0x665,0x667,0x66a,0x66c,0x66f,0x7c0
...
task_1_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_object, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool)
{
	...
	if(var_14_bool != 0) {
		...
		var_86_bool = var_13_int > (int)0;
		if(var_86_bool != 0) {
			var_88_bool = var_13_int > (int)1;
			if(var_88_bool != 0) {
				func_311(var_13_int);
			}
			var_90_object = Obj();
...
func_1921(var_14_bool, var_15_object, var_16_object)
{
	...
	var_36_bool = 0;
	var_36_bool = 1;
	var_37_bool = var_20_bool;
	if(var_37_bool != 1) {
		var_38_float = 0; var_39_object = Obj();
		var_15_object = var_39_object;
		func_1274(var_38_float, var_39_object);
		var_47_bool = var_38_float <= (float)250000.0;
		if(var_47_bool != 1) {
			var_36_bool = 0;
		}
	}
...
func_645(var_0_bool, var_77_object)
{
	...
	func_1267(var_92_cvector, var_93_object);
...
func_906(var_0_bool, var_24_cvector, var_25_float)
{
	...
	func_1459(var_38_cvector, var_39_cvector);
...
func_1684(var_12_bool)
{
	...
	if(var_17_bool != 0) {
		...
		var_28_float = var_21_int * (int)100;
		var_19_int = (int)100 + var_28_float;
		func_1654((int)0, var_19_int);
		irand(var_15_int, (int)9);
		var_49_bool = var_15_int == (int)0;
		if(var_49_bool != 0) {
			var_50_int = 0; var_51_string = "";
			func_1859(var_50_int, "lemon");
			AddItem(var_16_bool, var_50_int, (int)0, (int)1);
		} else {
			var_57_bool = var_15_int == (int)1;
			if(var_57_bool != 0) {
				var_58_int = 0; var_59_string = "";
				func_1859(var_58_int, "rusk");
				AddItem(var_16_bool, var_58_int, (int)0, (int)1);
				goto Label_1772;
			}
			var_63_bool = var_15_int == (int)2;
			if(var_63_bool != 0) {
				var_64_int = 0; var_65_string = "";
				func_1859(var_64_int, "hook");
				AddItem(var_16_bool, var_64_int, (int)0, (int)1);
				goto Label_1772;
			}
			var_69_bool = var_15_int == (int)4;
			if(var_69_bool != 0) {
				var_70_int = 0; var_71_string = "";
				func_1859(var_70_int, "syringe");
				AddItem(var_16_bool, var_70_int, (int)0, (int)1);
				goto Label_1772;
			}
			var_75_bool = var_15_int == (int)5;
			if(var_75_bool != 0) {
				var_76_int = 0; var_77_string = "";
				func_1859(var_76_int, "watch");
				AddItem(var_16_bool, var_76_int, (int)0, (int)1);
				goto Label_1772;
			}
			var_81_bool = var_15_int == (int)6;
			if(var_81_bool == 0) goto Label_1772;
			var_82_int = 0; var_83_string = "";
			func_1859(var_82_int, "razor");
			AddItem(var_16_bool, var_82_int, (int)0, (int)1);
	}
		...
		func_1654((int)0, var_87_int);
		irand(var_15_int, (int)8);
		var_94_bool = var_15_int == (int)0;
		if(var_94_bool != 0) {
			var_95_int = 0; var_96_string = "";
			func_1859(var_95_int, "beads");
			AddItem(var_16_bool, var_95_int, (int)0, (int)1);
			goto Label_1858;
		}
		var_100_bool = var_15_int == (int)1;
		if(var_100_bool != 0) {
			var_101_int = 0; var_102_string = "";
			func_1859(var_101_int, "bracelet");
			AddItem(var_16_bool, var_101_int, (int)0, (int)1);
			goto Label_1858;
		}
		var_106_bool = var_15_int == (int)2;
		if(var_106_bool != 0) {
			var_107_int = 0; var_108_string = "";
			func_1859(var_107_int, "ear_ring");
			AddItem(var_16_bool, var_107_int, (int)0, (int)1);
			goto Label_1858;
		}
		var_112_bool = var_15_int == (int)3;
		if(var_112_bool != 0) {
			var_113_int = 0; var_114_string = "";
			func_1859(var_113_int, "gold_ring");
			AddItem(var_16_bool, var_113_int, (int)0, (int)1);
			goto Label_1858;
		}
		var_118_bool = var_15_int == (int)4;
		if(var_118_bool != 0) {
			var_119_int = 0; var_120_string = "";
			func_1859(var_119_int, "silver_ring");
			AddItem(var_16_bool, var_119_int, (int)0, (int)1);
			goto Label_1858;
		}
		var_124_bool = var_15_int == (int)5;
		if(var_124_bool == 0) goto Label_1858;
		var_125_int = 0; var_126_string = "";
		func_1859(var_125_int, "flower");
		AddItem(var_16_bool, var_125_int, (int)0, (int)1);
	}
Label_1772:
	goto Label_1858;
...
{
	var_180_string = ""; var_181_string = "";
	var_182_int = var_179_int;
	if(var_182_int != 0) {
		"idle" = "idle" + var_179_int;
	}
...
func_1912(var_55_bool)
{
	...
	var_55_bool = var_62_float > (float)0.699999988079071;
	return 0;
}
...
{
	var_173_int = 0; var_174_bool = 0; var_175_int = 0; var_176_bool = 0;
	var_175_int = 0;
	
Label_1566:
	var_178_string = ""; var_179_int = 0;
	var_175_int = var_179_int;
	func_1557(var_178_string, var_179_int);
	HasAnimation(var_176_bool, "all", var_178_string);
	var_183_bool = var_176_bool == 0; //@nz
	if(var_183_bool != 0) {
	} else {
...
func_571()
{
	var_156_int = 0; var_157_int = 0; var_158_int = 0; var_159_int = 0; var_160_bool = 0; var_161_float = 0; var_162_bool = 0; var_163_int = 0; var_164_int = 0; var_165_int = 0; var_166_int = 0; var_167_bool = 0; var_168_float = 0; var_169_bool = 0;
	WaitForAnimEnd();
	var_170_bool = 0;
	func_1437(var_170_bool);
	var_171_bool = var_170_bool == 0; //@nz
	if(var_171_bool != 0) {
		return 14;
	}
	func_1564((int)0);
...
Label_585:
	var_185_bool = 0;
	var_185_bool = 0;
	var_187_bool = var_164_int < (int)5;
	if(var_187_bool != 0) {
		var_188_bool = 0;
	...
	if(var_185_bool != 0) {
		...
		var_191_bool = var_165_int == (int)0;
		if(var_191_bool != 0) {
			var_192_int = var_163_int;
			if(var_192_int == 0) goto Label_618;
			...
			var_196_bool = var_167_bool == 0; //@nz
			if(var_196_bool != 0) {
			} else {
		} else {
				var_199_bool = var_165_int == (int)1;
				if(var_199_bool != 0) {
					rand(var_168_float, (int)4);
					var_202_int = var_168_float + (int)1;
					Sleep(var_202_int, var_169_bool);
					var_203_bool = var_169_bool == 0; //@nz
					if(var_203_bool != 0) {
						goto Label_639;
					}
					goto Label_636;
				}
				var_204_int = var_164_int;
				if(var_204_int == 0) goto Label_636;
				goto Label_639;
		}
		Label_636:
...
func_336(var_2_bool, var_11_object)
{
	...
	var_72_bool = var_15_int > (int)0;
	if(var_72_bool != 0) {
		var_74_bool = var_15_int > (int)1;
		if(var_74_bool != 0) {
			func_319(var_15_int);
		}
		var_76_object = Obj();
...
func_1114(var_0_bool, var_1_bool, var_2_bool, var_92_object)
{
	...
	func_1084(var_105_float, var_106_cvector, (float)1.7453293800354004);
...
Label_1147:
	...
	if(var_150_bool != 0) {
		...
		func_1084(var_105_float, var_152_cvector, (float)2.6179938316345215);
	...
	if(var_159_bool == 1) goto Label_1147;
...
{
	var_133_float = 0; var_134_cvector = CVector(0,0,0); var_135_cvector = CVector(0,0,0); var_136_float = 0; var_137_bool = 0; var_138_object = Obj(); var_139_bool = 0; var_140_float = 0; var_141_cvector = CVector(0,0,0); var_142_cvector = CVector(0,0,0); var_143_float = 0; var_144_bool = 0; var_145_object = Obj(); var_146_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_140_float, (float)0.5);
	Sleep(var_140_float);
	
Label_384:
	var_148_bool = var_0_bool == 0; //@nz
	if(var_148_bool != 0) {
		var_149_bool = var_1_bool == 0; //@nz
		if(var_149_bool != 0) {

		Label_388:
			GetPosition(var_142_cvector);
			GetCameraFarDistance(var_143_float);
			var_143_float = var_143_float * (float)2.5;
			GetRandomPFPointInCircle(var_141_cvector, var_142_cvector, var_143_float, var_144_bool);
			var_151_bool = var_144_bool;
			if(var_151_bool != 0) {
			} else {
					Sleep((int)1);
					goto Label_388;
...
func_1654(var_18_int, var_19_int)
{
	...
	if(var_39_bool != 0) {
		...
		if(var_46_bool == 0) goto Label_1672;
		return 8;
	}
Label_1672:
