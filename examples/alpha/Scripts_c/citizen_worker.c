...
// @STANDALONE_EVENT_16: op=0x948 vars=object,string
// @STANDALONE_EVENT_41: op=0x955 vars=object
// @STANDALONE_EVENT_22: op=0x95b vars=object,int,float,float
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x385,0x388,0x570,0x5e3,0x5f5,0x600,0x609,0x653,0x6a6,0x6b6,0x76c,0x89b,0x8cf,0x901,0x908,0x913,0x91c,0x926,0x940,0x955,0x95b,0x97b,0x984,0x98c,0x996,0x99e,0x9a5,0x9ab,0x9ae,0x9b0,0x9bc,0x9c6,0x9d8,0x9de,0x9e1,0xb01,0xb56
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_object, var_7_int, var_8_int, var_9_bool, var_10_int, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	func_2040(var_24_bool, var_25_object);
	...
	func_1908(var_61_cvector, var_62_object);
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool, var_17_int, var_18_int)
{
	if((int)1 != 0) {
		func_2288();
		var_22_bool = var_17_int == (int)15886;
		if(var_22_bool != 0) {
			var_23_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14649);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14650, (int)15888, (int)15887);
			@@@var_0_bool:AddReply((int)14658, (int)-1, (int)15895);
			@@@var_0_bool:AddReply((int)14659, (int)-1, (int)15896);
			return 0;
		...
		var_49_bool = var_17_int == (int)15905;
		if(var_49_bool != 0) {
			var_50_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14668);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14669, (int)15899, (int)15906);
			@@@var_0_bool:AddReply((int)14670, (int)-1, (int)15908);
			return 0;
		}
		var_59_bool = var_17_int == (int)15899;
		if(var_59_bool != 0) {
			var_60_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14662);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14663, (int)15901, (int)15900);
			return 0;
		}
		var_66_bool = var_17_int == (int)15901;
		if(var_66_bool != 0) {
			var_67_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14664);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14665, (int)-1, (int)15902);
			@@@var_0_bool:AddReply((int)14666, (int)-1, (int)15903);
			return 0;
		}
		var_76_bool = var_17_int == (int)15888;
		if(var_76_bool != 0) {
			var_77_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14651);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14652, (int)15890, (int)15889);
			@@@var_0_bool:AddReply((int)14657, (int)-1, (int)15894);
			return 0;
		}
		var_86_bool = var_17_int == (int)15890;
		if(var_86_bool != 0) {
			var_87_string = "";
			func_1702(var_18_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14653);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14654, (int)-1, (int)15891);
			@@@var_0_bool:AddReply((int)14655, (int)-1, (int)15892);
			@@@var_0_bool:AddReply((int)14656, (int)-1, (int)15893);
			return 0;
		}
		var_3_bool = true;
		var_98_bool = 0;
...
func_2583(var_19_bool)
{
	...
	if(var_24_bool != 0) {
		...
		if(var_56_bool != 0) {
			...
			if(var_88_bool == 0) goto Label_2671;
		...
		if(var_131_bool == 0) goto Label_2757;
...
func_2553(var_25_int, var_26_int)
{
	...
	if(var_46_bool != 0) {
		...
		if(var_53_bool == 0) goto Label_2571;
		return 8;
	}
Label_2571:
...
func_1151(var_0_bool, var_1_bool, var_261_bool, var_262_float)
{
	...
	func_2040(var_287_bool, var_288_object);
	...
	if(var_363_bool != 0) {
		...
		func_2040(var_367_bool, var_368_object);
...
func_667(var_0_bool, var_69_object)
{
	...
	func_1908(var_84_cvector, var_85_object);
...
Label_1256:
	...
	if(var_230_bool != 0) {
		...
		func_2040(var_256_bool, var_257_object);
...
func_2820(var_21_bool, var_22_object, var_23_object)
{
	...
	if(var_40_bool != 0) {
		var_58_bool = var_26_string != "worker";
		if(var_58_bool != 0) {
			var_39_bool = 1;
		}
	}
...
func_1295(var_0_bool, var_231_bool)
{
	...
	func_2040(var_242_bool, var_243_object);
...
Label_959:
	...
	var_126_object = var_0_bool;
	func_2040(var_125_bool, var_126_object);
	if(var_125_bool != 0) {
			...
			if(var_187_bool != 0) {
				...
				if(var_194_bool != 0) {
					...
					if(var_207_bool != 0) {
						...
						func_2040(var_390_bool, var_391_object);
...
func_1935(var_304_float, var_305_object, var_306_float, var_307_int)
{
	...
	func_2305(var_340_float, var_341_float, (float)1);
	...
	func_2312(var_350_float, var_351_float, (float)0, (float)1);
...
func_2529(var_28_object)
{
	...
	func_2777(var_28_object, var_29_object);
	return 0;
}
