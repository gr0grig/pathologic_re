// @IMPORTS: SetVisibility/1,Hold/0,GetItem/2,GetItemAmount/2,RemoveActor/1,GetScene/1,self/1,GetVariable/2,GetInvItemProperty/3
// @STRINGS: W:HasProperty|A:HasProperty|A:IsDead|W:IsDead|A:GetScene|W:noaccess|A:GetProperty|W:nouse_container|A:GetItemID|W:Category|A:AddItem
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_0(var_0_object)
{
	...
	func_133(var_48_bool, var_49_object, var_50_object, var_51_int);
	if(var_48_bool != 0) {
		var_59_object = Obj();
