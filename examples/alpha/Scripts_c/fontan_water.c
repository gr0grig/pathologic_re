maintask task_0
{
	...
	void OnUse(bool var_0_bool, object var_1_object)
	{
		...
		bool var_2_bool;
		func_54(var_2_bool, var_3_object, "hunger", -0.05, (float)0, (float)1);
		@PlaySound("drink");
		@Sleep(1);
		disable OnUse;
		enable OnUse;
...
void func_42(bool var_10_bool, object var_11_object, string var_12_string)
{
...
// @pe
void func_76(float var_20_float, float var_21_float, float var_22_float, float var_23_float)
{
...
void func_54(bool var_2_bool, object var_3_object, string var_4_string, float var_5_float, float var_6_float, float var_7_float)
{
	...
	func_76(var_20_float, (var_9_float + var_5_float), var_22_float, var_23_float);
