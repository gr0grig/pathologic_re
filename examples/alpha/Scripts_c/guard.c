...
// @STANDALONE_EVENT_16: op=0x536 vars=object,string
// @STANDALONE_EVENT_41: op=0x543 vars=object
// @STANDALONE_EVENT_22: op=0x549 vars=object,int,float,float
// @PE: 0x9b,0xfd,0x175,0x18b,0x18d,0x18f,0x191,0x199,0x19c,0x384,0x3f7,0x409,0x414,0x41d,0x428,0x51c,0x523,0x52e,0x543,0x549,0x580,0x58a,0x592,0x599,0x5a5,0x5a8,0x5ae,0x5b1,0x5b3,0x5b6,0x5bc,0x5e8
...
task_1_event_17(var_0_cvector, var_1_cvector, var_2_bool, var_3_object, var_4_object, var_5_int, var_6_int, var_7_bool, var_8_int, var_9_bool, var_10_object)
{
	...
	var_13_int = 0; var_14_object = Obj();
	var_10_object = var_14_object;
	func_1408(var_13_int, var_14_object);
	var_13_int = var_12_int;
...
func_1304(var_49_float, var_50_cvector, var_51_cvector)
{
	...
	var_53_cvector = var_51_cvector - var_50_cvector;
	var_49_float = var_53_cvector | var_53_cvector;
	return 2;
}
...
{
	var_309_float = 0.05000000074505806;
	return 0;
}
...
Label_175:
	irand(var_20_int, (int)60);
	var_26_int = var_20_int + (int)30;
	Sleep(var_26_int, var_21_bool);
	var_27_bool = var_21_bool;
	if(var_27_bool != 0) {
		func_164(var_23_object);
	} else {
		GetPFPosition(var_22_cvector);
		var_49_float = 0; var_50_cvector = CVector(0,0,0); var_51_cvector = CVector(0,0,0);
		var_50_cvector = var_1_cvector;
		var_22_cvector = var_51_cvector;
		func_1304(var_49_float, var_50_cvector, var_51_cvector);
		var_55_bool = var_49_float > (int)40000;
		if(var_55_bool != 0) {
			FindPathTo(var_23_object, var_1_cvector);
			var_56_bool = var_23_object != 0; //@nn
			if(var_56_bool != 0) {
				...
				if(var_57_bool != 0) {
					...
					var_60_float = GetByIndex(var_0_cvector, 0);
					var_61_float = GetByIndex(var_0_cvector, 2);
					Rotate(var_60_float, var_61_float, var_21_bool);
					var_62_bool = var_21_bool == 0; //@nz
					if(var_62_bool != 0) {
						goto Label_245;
					}
					WaitForAnimEnd(var_21_bool);
					var_63_bool = var_21_bool == 0; //@nz
					if(var_63_bool != 0) {
						goto Label_245;
					}
					goto Label_246;
			...
			Rotate(var_65_float, var_66_float, var_21_bool);
			var_67_bool = var_21_bool == 0; //@nz
			if(var_67_bool != 0) {
				goto Label_245;
			}
			WaitForAnimEnd(var_21_bool);
...
func_1092(var_312_float, var_313_object, var_314_float, var_315_int)
{
	...
	func_1308(var_348_float, var_349_float, (float)1);
	...
	func_1315(var_358_float, var_359_float, (float)0, (float)1);
...
func_1361(var_38_string, var_39_int)
{
	...
	if(var_42_int != 0) {
		"idle" = "idle" + var_39_int;
	}
	var_41_string = var_38_string;
	return 2;
}
...
Label_1370:
	...
	var_35_int = var_39_int;
	func_1361(var_38_string, var_39_int);
	HasAnimation(var_36_bool, "all", var_38_string);
	var_43_bool = var_36_bool == 0; //@nz
	if(var_43_bool != 0) {
	} else {
...
func_1388()
{
	var_28_int = 0; var_29_int = 0; var_30_int = 0; var_31_int = 0;
	func_1368((int)0);
	var_32_int = var_30_int;
	var_45_bool = var_30_int == 0; //@nz
	if(var_45_bool != 0) {
		return 4;
	}
	...
	func_1361(var_47_string, var_48_int);
