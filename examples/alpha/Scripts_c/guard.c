...
// @pe
void func_1408(int var_48_int, object var_49_object)
{
...
// @pe
void func_1418(object var_84_object)
{
...
// @pe
void func_1426(int var_46_int, object var_47_object)
{
...
void func_1299(bool var_12_bool)
{
	bool var_14_bool;
...
void func_1304(float var_49_float, cvector var_50_cvector, cvector var_51_cvector)
{
	var_49_float = (var_51_cvector - var_50_cvector) | (var_51_cvector - var_50_cvector);
}


// @pe
void func_1433(object var_83_object)
{
...
// @pe
void func_1308(float var_348_float, float var_349_float, float var_350_float)
{
...
// @pe
void func_1448(object var_17_object)
{
...
void func_170(cvector var_0_cvector, cvector var_1_cvector)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			float var_49_float; cvector var_51_cvector;
			var_22_cvector = var_51_cvector;
			func_1304(var_49_float, var_1_cvector, var_51_cvector);
			if(var_49_float > 40000) {
...
// @pe
void func_1315(float var_358_float, float var_359_float, float var_360_float, float var_361_float)
{
...
// @pe
void func_1326(object var_11_object)
{
	object var_12_object;
...
// @pe
void func_1468(object var_18_object)
{
...
void func_1475(bool var_14_bool, object var_15_object, object var_16_object)
{
...
void func_1092(float var_312_float, object var_313_object, float var_314_float, int var_315_int)
{
	...
	float var_348_float;
	func_1308(var_348_float, ((var_325_int + var_327_int) / 100.0), (float)1);
	float var_328_float;
	var_348_float = var_328_float;
	float var_329_float;
	var_313_object->GetProperty("health", var_329_float);
	float var_358_float;
	func_1315(var_358_float, (var_329_float - (var_314_float * (1 - var_328_float))), (float)0, (float)1);
...
void func_1361(string var_38_string, int var_39_int)
{
	string var_41_string = "idle";
	if(var_39_int != 0)
		var_41_string += var_39_int;
