// @IMPORTS: FogLinear/2,GetHeight/1,PlayGlobalSound/2,MovePoint/2,PlaySound/1,ReportHit/4,SetVisirVisibility/1,Sleep/1,RemoveActor/1,PutOnGrid/0,SetTimer/2,FindActor/2,GetPosition/1,Stop/0,FindPathTo/2,RotatePath/2,FollowPath/5,KillTimer/1,Sleep/2,RequestClearPath/1,GetScene/1,self/1,Hold/0
// @STRINGS: W:breath|A:GetPFPosition|W:attack|W:player|A:GetPosition|W:walk|W:run|W:HasProperty|A:HasProperty|A:GetProperty|A:SetProperty|W:disease|W:armor_disease|W:immunity|A:IsDead|W:IsDead|A:GetScene|W:noaccess
// @RUN_OP: 0x44
// @RUN_TASK: 1
...
// @STANDALONE_EVENT_41: op=0x1d8 vars=object
// @STANDALONE_EVENT_7: op=0x1da vars=int
// @STANDALONE_EVENT_6: op=0x1f3 vars=
// @PE: 0x6b,0x76,0xe6,0xf8,0x103,0x10c,0x1cd,0x1d8,0x1da
...
func_0(var_98_object)
{
	...
	if(var_112_bool != 0) {
		...
		if(var_127_bool != 0) {
			...
			func_323(var_129_float, var_130_object, (float)0.20000000298023224);
			var_129_float = var_106_float;
			ReportHit(var_98_object, (int)5, var_106_float, (float)0.20000000298023224);
		}
	}
	SetVisirVisibility((bool)0);
	FogLinear((int)0, (int)2);
...
func_301(var_159_bool, var_160_object, var_161_string, var_162_float, var_163_float, var_164_float)
{
	...
	var_171_float = 0; var_172_float = 0; var_173_float = 0; var_174_float = 0;
	var_172_float = var_166_float + var_162_float;
...
{
	var_132_int = 0; var_133_float = 0; var_134_float = 0; var_135_int = 0; var_136_float = 0; var_137_float = 0;
	...
	var_130_object = var_143_object;
	func_289(var_142_bool, var_143_object, "armor_disease");
	if(var_142_bool != 0) {
		@@var_130_object:GetProperty("armor_disease", var_135_int);
		var_147_bool = var_135_int < (int)100;
		if(var_147_bool != 0) {
			var_150_float = var_135_int / (float)100.0;
			var_151_int = (int)1 - var_150_float;
			var_131_float = var_131_float * var_151_int;
		} else {
					var_129_float = 0;
					return 6;
		}
	...
	if(var_152_bool != 0) {
		...
		var_156_bool = var_137_float < var_131_float;
		if(var_156_bool != 0) {
			@@var_130_object:SetProperty("immunity", (int)0);
			var_136_float = var_131_float - var_137_float;
		} else {
			var_178_int = var_137_float - var_131_float;
			@@var_130_object:SetProperty("immunity", var_178_int);
			var_131_float = var_129_float;
			return 6;

		}
	}
	var_159_bool = 0; var_160_object = Obj(); var_161_string = ""; var_162_float = 0; var_163_float = 0; var_164_float = 0;
...
func_461(var_171_float, var_172_float, var_173_float, var_174_float)
{
	var_175_bool = var_172_float < var_173_float;
	if(var_175_bool != 0) {
		var_173_float = var_171_float;
		return 0;
	}
	var_176_bool = var_172_float > var_174_float;
	if(var_176_bool != 0) {
