...
// @STANDALONE_EVENT_16: op=0x849 vars=object,string
// @STANDALONE_EVENT_41: op=0x856 vars=object
// @STANDALONE_EVENT_22: op=0x85c vars=object,int,float,float
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x5aa,0x5ba,0x7a6,0x7da,0x80c,0x814,0x81d,0x827,0x841,0x856,0x85c,0x87c,0x885,0x88d,0x897,0x89f,0x8a9,0x8b1,0x8b4,0x8c8,0x8ce,0x8d1,0x8d3,0x9e8
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	if(var_20_bool != 0) {
		...
		var_16_string = var_49_object;
		func_2207(var_48_int, var_49_object);
		var_48_int = var_19_int;
		var_85_bool = var_19_int > (int)0;
		if(var_85_bool != 0) {
			var_87_bool = var_19_int > (int)1;
			if(var_87_bool != 0) {
				func_333(var_19_int);
			}
			var_89_object = Obj();
			var_16_string = var_89_object;
			func_2217(var_89_object);
		}
	}
	return 2;
}
...
task_2_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	if(var_61_bool != 0) {
		...
		var_65_object = Obj();
		var_16_bool = var_65_object;
		func_2248(var_65_object);
	}
	return 2;
}
...
task_3_event_40(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	if(var_61_bool != 0) {
		...
		var_64_object = Obj();
		var_16_bool = var_64_object;
		func_2248(var_64_object);
	}
	return 2;
}
...
task_4_event_7(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_int, var_6_object, var_7_cvector, var_8_bool, var_9_object, var_10_cvector, var_11_bool, var_12_object, var_13_object, var_14_object, var_15_string, var_16_bool)
{
	...
	func_1727(var_60_cvector, var_61_object);
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_string, var_15_bool, var_16_int, var_17_int)
{
	if((int)1 != 0) {
		func_2043();
		var_21_bool = var_17_int == (int)14641;
		if(var_21_bool != 0) {
			var_22_object = Obj(); var_23_object = Obj();
			var_22_object = var_1_bool;
			var_23_object = var_0_bool;
			func_2259(var_23_object);
		}
		var_26_bool = var_16_int == (int)14640;
		if(var_26_bool != 0) {
			var_27_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)13406);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)13407, (int)-1, (int)14641);
			@@@var_0_bool:AddReply((int)13408, (int)-1, (int)14642);
			return 0;
		...
		var_50_bool = var_16_int == (int)15980;
		if(var_50_bool != 0) {
			var_51_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14736);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14737, (int)15982, (int)15981);
			@@@var_0_bool:AddReply((int)14744, (int)15989, (int)15988);
			return 0;
		}
		var_60_bool = var_16_int == (int)15989;
		if(var_60_bool != 0) {
			var_61_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14745);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14746, (int)15982, (int)15990);
			@@@var_0_bool:AddReply((int)14747, (int)-1, (int)15992);
			return 0;
		}
		var_70_bool = var_16_int == (int)15982;
		if(var_70_bool != 0) {
			var_71_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14738);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14739, (int)15984, (int)15983);
			@@@var_0_bool:AddReply((int)14743, (int)-1, (int)15987);
			return 0;
		}
		var_80_bool = var_16_int == (int)15984;
		if(var_80_bool != 0) {
			var_81_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14740);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14741, (int)-1, (int)15985);
			@@@var_0_bool:AddReply((int)14742, (int)-1, (int)15986);
			return 0;
		}
		var_90_bool = var_16_int == (int)15966;
		if(var_90_bool != 0) {
			var_91_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14723);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14724, (int)15968, (int)15967);
			@@@var_0_bool:AddReply((int)14731, (int)15968, (int)15974);
			return 0;
		}
		var_100_bool = var_16_int == (int)15968;
		if(var_100_bool != 0) {
			var_101_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14725);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14726, (int)15970, (int)15969);
			@@@var_0_bool:AddReply((int)14730, (int)-1, (int)15973);
			return 0;
		}
		var_110_bool = var_16_int == (int)15970;
		if(var_110_bool != 0) {
			var_111_string = "";
			func_1450(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14727);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14728, (int)-1, (int)15971);
			@@@var_0_bool:AddReply((int)14729, (int)-1, (int)15972);
			return 0;
		}
		var_3_bool = true;
		var_119_bool = 0;
...
func_1090(var_0_bool, var_68_bool)
{
	...
	func_1727(var_73_cvector, var_74_object);
...
Label_607:
	...
	if(var_114_bool != 0) {
		...
		if(var_120_bool != 0) {
			...
			if(var_121_int == 0) goto Label_640;
			...
			if(var_125_bool != 0) {
				...
				var_128_bool = var_94_int == (int)1;
				if(var_128_bool != 0) {
					rand(var_97_float, (int)4);
					var_131_int = var_97_float + (int)1;
					Sleep(var_131_int, var_98_bool);
					var_132_bool = var_98_bool == 0; //@nz
					if(var_132_bool != 0) {
						goto Label_661;
					}
					goto Label_658;
				}
				var_133_int = var_93_int;
				if(var_133_int == 0) goto Label_658;
				goto Label_661;
		}
		Label_658:
...
func_1106(var_0_bool, var_30_cvector, var_31_float)
{
	...
	func_2050(var_44_cvector, var_45_cvector);
...
{
	var_95_cvector = CVector(0,0,0); var_96_float = 0; var_97_bool = 0; var_98_cvector = CVector(0,0,0); var_99_float = 0; var_100_cvector = CVector(0,0,0); var_101_float = 0; var_102_bool = 0; var_103_cvector = CVector(0,0,0); var_104_float = 0;
	var_0_bool = var_91_object;
	var_105_cvector = CVector(0,0,0); var_106_float = 0;
	func_1106(var_104_float, var_105_cvector, (float)1.7453293800354004);
	var_105_cvector = var_100_cvector;
	var_101_float = var_100_cvector | var_100_cvector;
	var_136_bool = var_101_float < (float)10000.0;
	if(var_136_bool != 0) {
		var_138_float = sqrt(var_101_float);
		var_139_int = "Can't retreat, distance: " + var_138_float;
		Trace(var_139_int);
		Sleep((float)0.5);
		return 10;
	}
	var_141_float = GetByIndex(var_100_cvector, 0);
	var_142_float = GetByIndex(var_100_cvector, 2);
	Rotate(var_141_float, var_142_float);
	var_143_cvector = CVector(0,0,0);
	func_1722(var_143_cvector);
	var_1_bool = var_143_cvector + var_100_cvector;
	SetTimer((int)120, (float)0.5);
	var_2_bool = false;
	
Label_1169:
	MovePoint(var_1_bool, (int)1, var_102_bool);
	var_149_bool = var_102_bool;
	if(var_149_bool != 0) {
		var_150_bool = var_0_bool == 0; //@ne
		if(var_150_bool != 0) {
			goto Label_1199;
		EMIT "GOTO 0x4ad";
		...
		var_151_cvector = CVector(0,0,0); var_152_float = 0;
		func_1106(var_104_float, var_151_cvector, (float)2.6179938316345215);
		var_151_cvector = var_103_cvector;
		var_104_float = var_103_cvector | var_103_cvector;
		var_154_bool = var_104_float >= (float)10000.0;
		if(var_154_bool != 0) {
			var_155_cvector = CVector(0,0,0);
			func_1722(var_155_cvector);
			var_1_bool = var_155_cvector + var_103_cvector;
			SetTimer((int)120, (float)0.5);
		} else {
			goto Label_1199;
		}
	}
	var_158_bool = var_2_bool == 0; //@nz
	if(var_158_bool == 1) goto Label_1169;
...
func_2189(var_24_int, var_25_object)
{
	...
	func_1795(var_26_bool, var_27_object);
	if(var_26_bool != 0) {
		var_24_int = 2;
	} else {
		var_24_int = 0;
...
func_667(var_0_bool, var_68_object)
{
	...
	func_1727(var_83_cvector, var_84_object);
	...
	func_2087(var_89_float, var_90_cvector, var_91_cvector);
	var_114_bool = var_89_float < (int)0;
	if(var_114_bool != 0) {
		var_115_object = Obj();
		var_115_object = var_0_bool;
		func_1886(var_115_object);
		var_75_bool = 1;
	} else {
...
func_2207(var_48_int, var_49_object)
{
	...
	func_1795(var_50_bool, var_51_object);
	if(var_50_bool != 0) {
		var_48_int = 2;
	} else {
		var_48_int = 0;
...
func_2217(var_90_object)
{
	...
	TaskCall(6);
	func_1136(var_92_object, var_93_cvector, var_94_bool, var_91_object);
	TaskReturn();
	return 0;
}
...
func_2228(var_27_object)
{
	...
	func_2448(var_27_object, var_28_object);
	return 0;
}
...
func_2235(var_19_int, var_20_object)
{
	...
	CanSee(var_22_bool, var_20_object);
...
func_1734(var_27_float, var_28_object)
{
...
func_2281(var_79_int, var_80_int)
{
	...
	if(var_100_bool != 0) {
		...
		if(var_107_bool == 0) goto Label_2299;
		return 8;
	}
Label_2299:
...
func_2355(var_18_bool)
{
	...
	ClearSubContainer((int)0);
	var_24_bool = var_18_bool;
	if(var_24_bool != 0) {
		irand(var_21_int, (int)3);
		var_27_bool = var_21_int != (int)0;
		if(var_27_bool != 0) {
			var_28_int = 0; var_29_string = "";
			func_2429(var_28_int, "alpha_pills");
			AddItem(var_22_bool, var_28_int, (int)0, var_21_int);
		}
		irand(var_21_int, (int)3);
		var_35_bool = var_21_int != (int)0;
		if(var_35_bool != 0) {
			var_36_int = 0; var_37_string = "";
			func_2429(var_36_int, "meradorm");
			AddItem(var_22_bool, var_36_int, (int)0, var_21_int);
		}
	} else {
		irand(var_21_int, (int)3);
		var_41_bool = var_21_int == (int)0;
		if(var_41_bool != 0) {
			var_42_int = 0; var_43_string = "";
			func_2429(var_42_int, "lockpick");
			AddItem(var_22_bool, var_42_int, (int)0, (int)1);
		}
		irand(var_21_int, (int)4);
		var_48_bool = var_21_int != (int)0;
		if(var_48_bool != 0) {
			var_49_int = 0; var_50_string = "";
			func_2429(var_49_int, "rifle_ammo");
			AddItem(var_22_bool, var_49_int, (int)0, var_21_int);
		}
		irand(var_21_int, (int)4);
		var_54_bool = var_21_int != (int)0;
		if(var_54_bool == 0) goto Label_2428;
		var_55_int = 0; var_56_string = "";
		func_2429(var_55_int, "revolver_ammo");
		AddItem(var_22_bool, var_55_int, (int)0, var_21_int);
	}
Label_2428:
	return 4;
...
func_1902(var_45_bool, var_46_object)
{
	...
	func_2050(var_70_cvector, var_71_cvector);
...
func_893(var_68_object)
{
	...
	func_958(var_70_cvector, var_71_bool, var_68_object, var_78_object);
	return 0;
}
...
{
	var_62_float = 0; var_63_cvector = CVector(0,0,0); var_64_cvector = CVector(0,0,0); var_65_float = 0; var_66_bool = 0; var_67_object = Obj(); var_68_bool = 0; var_69_float = 0; var_70_cvector = CVector(0,0,0); var_71_cvector = CVector(0,0,0); var_72_float = 0; var_73_bool = 0; var_74_object = Obj(); var_75_bool = 0;
	var_0_bool = false;
	var_1_bool = false;
	rand(var_69_float, (float)0.5);
	Sleep(var_69_float);
	
Label_406:
	var_77_bool = var_0_bool == 0; //@nz
	if(var_77_bool != 0) {
		var_78_bool = var_1_bool == 0; //@nz
		if(var_78_bool != 0) {

		Label_410:
			GetPosition(var_71_cvector);
			GetCameraFarDistance(var_72_float);
			var_72_float = var_72_float * (float)2.5;
			GetRandomPFPointInCircle(var_70_cvector, var_71_cvector, var_72_float, var_73_bool);
			var_80_bool = var_73_bool;
			if(var_80_bool != 0) {
			} else {
					Sleep((int)1);
					goto Label_410;
...
Label_427:
	...
	var_81_bool = var_74_object != 0; //@nn
	if(var_81_bool != 0) {
...
func_2488(var_20_bool, var_21_object, var_22_object)
{
	...
	if(var_26_bool != 1) {
		...
		func_1734(var_27_float, var_28_object);
		var_36_bool = var_27_float <= (float)250000.0;
		if(var_36_bool != 1) {
			var_25_bool = 0;
		}
	}
...
func_958(var_0_bool, var_1_bool, var_2_bool, var_78_object)
{
	...
	func_928(var_88_float, var_89_cvector, (float)1.7453293800354004);
	var_89_cvector = var_84_cvector;
	var_85_float = var_84_cvector | var_84_cvector;
	var_120_bool = var_85_float < (float)10000.0;
	if(var_120_bool != 0) {
		var_122_float = sqrt(var_85_float);
		var_123_int = "Can't retreat, distance: " + var_122_float;
		Trace(var_123_int);
		Sleep((float)0.5);
		return 10;
	}
	var_125_float = GetByIndex(var_84_cvector, 0);
	var_126_float = GetByIndex(var_84_cvector, 2);
	Rotate(var_125_float, var_126_float);
	var_127_cvector = CVector(0,0,0);
	func_1722(var_127_cvector);
	var_1_bool = var_127_cvector + var_84_cvector;
	SetTimer((int)120, (float)0.5);
	var_2_bool = false;
	
Label_991:
	MovePoint(var_1_bool, (int)1, var_86_bool);
	var_133_bool = var_86_bool;
	if(var_133_bool != 0) {
		...
		func_928(var_88_float, var_135_cvector, (float)2.6179938316345215);
		var_135_cvector = var_87_cvector;
		var_88_float = var_87_cvector | var_87_cvector;
		var_138_bool = var_88_float >= (float)10000.0;
		if(var_138_bool != 0) {
			var_139_cvector = CVector(0,0,0);
			func_1722(var_139_cvector);
			var_1_bool = var_139_cvector + var_87_cvector;
			SetTimer((int)120, (float)0.5);
		} else {
			goto Label_1021;
		}
	...
	if(var_142_bool == 1) goto Label_991;
