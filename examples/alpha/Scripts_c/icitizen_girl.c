...
void func_1136(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_91_object)
{
	cvector var_103_cvector; float var_104_float;
	cvector var_105_cvector;
	func_1106(var_104_float, var_105_cvector, 1.7453294);
	cvector var_100_cvector;
	var_105_cvector = var_100_cvector;
	float var_101_float = var_100_cvector | var_100_cvector;
	if(var_101_float < 10000.0) {
		var_138_float = sqrt(var_101_float);
		@Trace("Can't retreat, distance: " + var_138_float);
		@Sleep(0.5);
		return 10;
	}
...
Label_1169:
	bool var_102_bool;
	@MovePoint((var_143_cvector + var_100_cvector), 1, var_102_bool);
	if(var_102_bool != 0) {
		...
		Label_1199:
			...
			func_1106(var_104_float, var_151_cvector, 2.6179938);
			var_151_cvector = var_103_cvector;
			if((var_103_cvector | var_103_cvector) >= 10000.0) {
...
// @pe
void func_2181(object var_67_object)
{
...
// @pe
void func_2189(int var_24_int, object var_25_object)
{
	object var_27_object;
...
// @pe
void func_2199(object var_67_object)
{
	object var_68_object;
	var_67_object = var_68_object;
	TaskCall(5);
...
void func_667(bool var_0_bool, object var_68_object)
{
	...
	func_1727(var_83_cvector, var_0_bool);
...
// @pe
void func_2207(int var_48_int, object var_49_object)
{
...
// @pe
void func_2217(object var_90_object)
{
...
// @pe
void func_2228(object var_27_object)
{
...
void func_2235(int var_19_int, object var_20_object)
{
	bool var_22_bool;
...
void func_1734(float var_27_float, object var_28_object)
{
...
// @pe
void func_2248(object var_66_object)
{
...
// @pe
void func_2259(object var_23_object)
{
	var_23_object->SetReturnValue(1000);
}


void func_2264(int var_88_int)
{
	int var_90_int;
...
void func_2281(int var_79_int, int var_80_int)
{
	int var_95_int;
...
void func_2355(bool var_18_bool)
{
	...
	if(var_18_bool != 0) {
		...
		@irand(var_21_int, 4);
		if(!(var_21_int != 0)) goto Label_2428;
		int var_55_int;
...
void func_2429(int var_28_int, string var_29_string)
{
	int var_31_int;
...
// @pe
void func_893(object var_68_object)
{
	@Face(var_68_object);
	...
	func_958(var_70_cvector, var_71_bool, var_78_object, var_78_object);
}
...
void func_2488(bool var_20_bool, object var_21_object, object var_22_object)
{
	bool var_24_bool;
...
void func_958(bool var_0_bool, bool var_1_bool, bool var_2_bool, object var_78_object)
{
	cvector var_87_cvector; float var_88_float;
	cvector var_89_cvector;
	func_928(var_88_float, var_89_cvector, 1.7453294);
	cvector var_84_cvector;
	var_89_cvector = var_84_cvector;
	float var_85_float = var_84_cvector | var_84_cvector;
	if(var_85_float < 10000.0) {
...
Label_991:
	bool var_86_bool;
	@MovePoint((var_127_cvector + var_84_cvector), 1, var_86_bool);
	if(var_86_bool != 0) {
		...
		Label_1021:
			...
			func_928(var_88_float, var_135_cvector, 2.6179938);
			var_135_cvector = var_87_cvector;
			if((var_87_cvector | var_87_cvector) >= 10000.0) {
...
void func_2032(object var_76_object)
{
	float var_79_float;
