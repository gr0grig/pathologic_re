	...
	void event_11(bool var_0_bool, bool var_1_bool, bool var_2_bool, bool var_3_bool, object var_4_object, object var_5_object, cvector var_6_cvector, bool var_7_bool, object var_8_object, cvector var_9_cvector, bool var_10_bool, object var_11_object, object var_12_object, object var_13_object, string var_14_string, bool var_15_bool, int var_16_int, int var_17_int)
	{
		if(1 != 0) {
			...
			if(var_16_int == 14628) {
				...
				var_0_bool->SetMessage(13394); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(13396, -1, 14630); //@t
				var_0_bool->AddReply(13395, -1, 14629); //@t
				return 0;
			...
			if(var_16_int == 16009) {
				func_1445(var_17_int, "Neutral");
				var_0_bool->SetMessage(14763); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14764, 16011, 16010); //@t
				var_0_bool->AddReply(14769, -1, 16015); //@t
				return 0;
			}
			if(var_16_int == 16011) {
				func_1445(var_17_int, "Neutral");
				var_0_bool->SetMessage(14765); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14766, -1, 16012); //@t
				var_0_bool->AddReply(14767, -1, 16013); //@t
				var_0_bool->AddReply(14768, -1, 16014); //@t
				return 0;
			}
			if(var_16_int == 15997) {
				func_1445(var_17_int, "Neutral");
				var_0_bool->SetMessage(14751); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14752, 15999, 15998); //@t
				var_0_bool->AddReply(14759, -1, 16005); //@t
				return 0;
			}
			if(var_16_int == 15999) {
				func_1445(var_17_int, "Neutral");
				var_0_bool->SetMessage(14753); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14754, -1, 16000); //@t
				var_0_bool->AddReply(14755, 16002, 16001); //@t
				return 0;
			}
			if(var_16_int == 16002) {
				func_1445(var_17_int, "Neutral");
				var_0_bool->SetMessage(14756); //@t
				var_0_bool->ClearReplies(); //@t
				var_0_bool->AddReply(14757, -1, 16003); //@t
				var_0_bool->AddReply(14758, -1, 16004); //@t
				return 0;
			}
			var_3_bool = true;
			bool var_102_bool;
...
// @pe
void func_2156(int var_48_int, object var_49_object)
{
...
// @pe
void func_2166(object var_90_object)
{
