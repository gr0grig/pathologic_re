...
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x5a5,0x5b5,0x773,0x7a7,0x7d9,0x7e1,0x7ea,0x7f4,0x80e,0x823,0x829,0x849,0x852,0x85a,0x864,0x86c,0x876,0x87e,0x881,0x888,0x88b,0x88d,0x890,0x892,0x9b5
...
task_8_event_11(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_cvector, var_7_bool, var_8_object, var_9_cvector, var_10_bool, var_11_object, var_12_object, var_13_object, var_14_string, var_15_bool, var_16_int, var_17_int)
{
	if((int)1 != 0) {
		func_1992();
		var_21_bool = var_17_int == (int)14630;
		if(var_21_bool != 0) {
		...
		var_26_bool = var_16_int == (int)14628;
		if(var_26_bool != 0) {
			var_27_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)13394);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)13396, (int)-1, (int)14630);
			@@@var_0_bool:AddReply((int)13395, (int)-1, (int)14629);
			return 0;
		...
		var_50_bool = var_16_int == (int)16009;
		if(var_50_bool != 0) {
			var_51_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14763);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14764, (int)16011, (int)16010);
			@@@var_0_bool:AddReply((int)14769, (int)-1, (int)16015);
			return 0;
		}
		var_60_bool = var_16_int == (int)16011;
		if(var_60_bool != 0) {
			var_61_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14765);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14766, (int)-1, (int)16012);
			@@@var_0_bool:AddReply((int)14767, (int)-1, (int)16013);
			@@@var_0_bool:AddReply((int)14768, (int)-1, (int)16014);
			return 0;
		}
		var_73_bool = var_16_int == (int)15997;
		if(var_73_bool != 0) {
			var_74_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14751);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14752, (int)15999, (int)15998);
			@@@var_0_bool:AddReply((int)14759, (int)-1, (int)16005);
			return 0;
		}
		var_83_bool = var_16_int == (int)15999;
		if(var_83_bool != 0) {
			var_84_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14753);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14754, (int)-1, (int)16000);
			@@@var_0_bool:AddReply((int)14755, (int)16002, (int)16001);
			return 0;
		}
		var_93_bool = var_16_int == (int)16002;
		if(var_93_bool != 0) {
			var_94_string = "";
			func_1445(var_17_int, "Neutral");
			@@@var_0_bool:SetMessage((int)14756);
			@@@var_0_bool:ClearReplies();
			@@@var_0_bool:AddReply((int)14757, (int)-1, (int)16003);
			@@@var_0_bool:AddReply((int)14758, (int)-1, (int)16004);
			return 0;
		}
		var_3_bool = true;
		var_102_bool = 0;
...
func_2156(var_48_int, var_49_object)
{
	...
	func_1744(var_50_bool, var_51_object);
	if(var_50_bool != 0) {
		var_48_int = 2;
	} else {
		var_48_int = 0;
...
func_2177(var_27_object)
{
	...
	func_2397(var_27_object, var_28_object);
	return 0;
}
...
func_667(var_0_bool, var_68_object)
{
	...
	func_1676(var_83_cvector, var_84_object);
