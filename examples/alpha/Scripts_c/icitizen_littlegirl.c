...
// @PE: 0x0,0xf,0x16,0x8e,0xa4,0xa6,0xa8,0x12e,0x134,0x13a,0x15d,0x1c7,0x34a,0x37d,0x439,0x4eb,0x543,0x5a5,0x5b5,0x773,0x7a7,0x7d9,0x7e1,0x7ea,0x7f4,0x80e,0x823,0x829,0x849,0x852,0x85a,0x864,0x86c,0x876,0x87e,0x881,0x888,0x88b,0x88d,0x890,0x892,0x9b1
...
task_2_event_30(var_0_bool, var_1_bool, var_2_bool, var_3_bool, var_4_object, var_5_object, var_6_object, var_7_object, var_8_cvector, var_9_bool, var_10_object, var_11_cvector, var_12_bool, var_13_object, var_14_object, var_15_object, var_16_string, var_17_bool)
{
	...
	if(var_20_bool != 0) {
		...
		var_83_bool = var_19_int > (int)0;
		if(var_83_bool != 0) {
			var_85_bool = var_19_int > (int)1;
			if(var_85_bool != 0) {
				func_333(var_19_int);
			}
			var_87_object = Obj();
...
{
	var_93_cvector = CVector(0,0,0); var_94_float = 0; var_95_bool = 0; var_96_cvector = CVector(0,0,0); var_97_float = 0; var_98_cvector = CVector(0,0,0); var_99_float = 0; var_100_bool = 0; var_101_cvector = CVector(0,0,0); var_102_float = 0;
	var_0_bool = var_89_object;
	var_103_cvector = CVector(0,0,0); var_104_float = 0;
	func_1106(var_102_float, var_103_cvector, (float)1.7453293800354004);
	var_103_cvector = var_98_cvector;
	var_99_float = var_98_cvector | var_98_cvector;
	var_134_bool = var_99_float < (float)10000.0;
	if(var_134_bool != 0) {
		var_136_float = sqrt(var_99_float);
		var_137_int = "Can't retreat, distance: " + var_136_float;
		Trace(var_137_int);
		Sleep((float)0.5);
		return 10;
	}
	...
	var_1_bool = var_141_cvector + var_98_cvector;
	SetTimer((int)120, (float)0.5);
	var_2_bool = false;
	
Label_1169:
	MovePoint(var_1_bool, (int)1, var_100_bool);
	var_147_bool = var_100_bool;
	if(var_147_bool != 0) {
		var_148_bool = var_0_bool == 0; //@ne
		if(var_148_bool != 0) {
			goto Label_1199;
		EMIT "GOTO 0x4ad";
		...
		func_1106(var_102_float, var_149_cvector, (float)2.6179938316345215);
		var_149_cvector = var_101_cvector;
		var_102_float = var_101_cvector | var_101_cvector;
		var_152_bool = var_102_float >= (float)10000.0;
		if(var_152_bool != 0) {
			var_153_cvector = CVector(0,0,0);
	...
	var_156_bool = var_2_bool == 0; //@nz
	if(var_156_bool == 1) goto Label_1169;
