...
// @pe
void func_1671(int var_65_int, object var_66_object)
{
...
// @pe
void func_1678(object var_103_object)
{
...
void func_1295(float var_54_float, object var_55_object)
{
	cvector var_59_cvector;
	@GetPosition(var_59_cvector);
	cvector var_60_cvector;
	var_55_object->GetPosition(var_60_cvector);
	var_54_float = (var_60_cvector - var_59_cvector) | (var_60_cvector - var_59_cvector);
}
...
void func_1986(bool var_14_bool, object var_15_object, object var_16_object)
{
	...
	if(var_20_bool != 1) {
		...
		var_63_bool = var_54_float <= 250000.0;
		if(var_63_bool != 1)
			var_52_bool = false;
	}
	if(var_52_bool != 0) {
		@ReportReputationChange(var_55_object, var_16_object, -0.3);
		var_14_bool = true;
		return 4;
	}
	var_14_bool = false;
