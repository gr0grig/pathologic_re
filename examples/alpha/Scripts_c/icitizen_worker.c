...
// @STRINGS: W:fdie|A:GetPosition|W:bdie|W:GetScriptProperty|W:Owner|A:HasScriptProperty|A:GetScriptProperty|W:@GetEyesHeight|A:GetEyesHeight|W:head|W:all|W:attack_begin|W:attack|W:@GetAttackDistance|A:GetAttackDistance|A:GetPFPosition|W:attack_on|W:attack_stay|W:fjump|W:attack_off|W:attack_middle|W:attack_end|W:bjump|W:IsAttacking|A:IsAttacking|W:walk|W:run|W:fire|W:phys|W:HasProperty|A:HasProperty|W:health|W:armor|A:GetProperty|W:armor_|A:SetProperty|A:IsDead|W:IsDead|A:GetScene|W:noaccess|W:scripted|W:blood.xml|W:fhit|W:bhit|W:hit_react|W:1|W:2|W:GenerateMoney: iMin > iMax|W:Money|W:lemon|W:rusk|W:hook|W:syringe|W:watch|W:razor|W:beads|W:bracelet|W:ear_ring|W:gold_ring|W:silver_ring|W:flower|W:idle|W:class|W:littleboy|W:littlegirl|W:wasted_girl|W:woman|W:worker|W:wasted_male
...
// @PE: 0x0,0x78,0x8e,0x90,0x92,0x12b,0x134,0x13d,0x15d,0x236,0x269,0x271,0x274,0x45c,0x4cf,0x4e1,0x4ec,0x4f5,0x500,0x602,0x609,0x614,0x61d,0x627,0x641,0x656,0x65c,0x664,0x66d,0x675,0x67f,0x687,0x68e,0x694,0x697,0x6ab,0x6b1,0x6b4,0x81b
...
task_1_event_30(var_0_bool, var_1_bool, var_2_object, var_3_object, var_4_object, var_5_object, var_6_int, var_7_int, var_8_bool, var_9_int, var_10_bool, var_11_object)
{
	...
	if(var_14_bool != 0) {
		...
		var_101_bool = var_13_int > (int)0;
		if(var_101_bool != 0) {
			var_103_bool = var_13_int > (int)1;
			if(var_103_bool != 0) {
				func_336(var_13_int);
			}
			var_106_object = Obj();
...
{
	var_59_cvector = CVector(0,0,0); var_60_cvector = CVector(0,0,0); var_61_cvector = CVector(0,0,0); var_62_cvector = CVector(0,0,0); var_63_cvector = CVector(0,0,0); var_64_cvector = CVector(0,0,0);
	GetPosition(var_62_cvector);
	@@var_58_object:GetPosition(var_63_cvector);
	var_64_cvector = var_63_cvector - var_62_cvector;
	var_57_float = var_64_cvector | var_64_cvector;
	return 6;
}
...
func_1986(var_14_bool, var_15_object, var_16_object)
{
	...
	var_38_bool = 0;
	var_38_bool = 0;
	var_40_bool = var_19_string != "littleboy";
	if(var_40_bool != 0) {
		var_42_bool = var_19_string != "littlegirl";
		if(var_42_bool != 0) {
			var_38_bool = 1;
		}
	}
	if(var_38_bool != 0) {
		var_44_bool = var_19_string != "boy";
		if(var_44_bool != 0) {
			var_37_bool = 1;
		}
	}
	if(var_37_bool != 0) {
		var_46_bool = var_19_string != "girl";
		if(var_46_bool != 0) {
			var_36_bool = 1;
		}
	}
	if(var_36_bool != 0) {
		var_48_bool = var_19_string != "wasted_girl";
		if(var_48_bool != 0) {
			var_35_bool = 1;
		}
	}
	if(var_35_bool != 0) {
		var_50_bool = var_19_string != "woman";
		if(var_50_bool != 0) {
			var_34_bool = 1;
		}
	}
	if(var_34_bool != 0) {
		var_52_bool = var_19_string != "worker";
		if(var_52_bool != 0) {
			var_33_bool = 1;
		}
	}
	if(var_33_bool != 0) {
		var_54_bool = var_19_string != "wasted_male";
		if(var_54_bool != 0) {
			var_32_bool = 1;
		}
	}
	...
	if(var_56_bool != 1) {
		...
		func_1295(var_57_float, var_58_object);
		var_66_bool = var_57_float <= (float)250000.0;
		if(var_66_bool != 1) {
			var_55_bool = 0;
		}
	}
...
{
	var_286_float = 0.05000000074505806;
	return 0;
}
