...
func_218(var_42_int)
{
	...
	func_292(var_44_int, "armor", var_46_int, var_47_int, (int)40);
	...
	func_292(var_61_int, "armor_fire", var_63_int, var_64_int, (int)15);
	...
	func_292(var_75_int, "armor_disease", var_77_int, var_78_int, (int)60);
	...
	func_292(var_82_int, "visibility", var_84_int, var_85_int, (int)-30);
