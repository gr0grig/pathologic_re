...
main()
{
	...
	var_4_bool = var_1_float < (float)0.800000011920929;
	if(var_4_bool != 0) {
		SetProperty("immunity", (float)0.800000011920929);
	}
...
func_23(var_34_bool, var_35_float)
{
	...
	var_38_float = var_35_float * (float)1.0;
	func_71(var_36_bool, "immunity", var_38_float, (float)0, (float)0.800000011920929);
	var_42_bool = 0; var_43_string = ""; var_44_float = 0; var_45_float = 0; var_46_float = 0;
	var_44_float = var_35_float * (float)-0.10000000149011612;
