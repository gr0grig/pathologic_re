...
Label_28:
	...
	var_12_int = var_11_float / (float)0.9599999785423279;
	var_98_bool = var_12_int > (int)0;
	if(var_98_bool != 0) {
		var_100_int = var_11_float % (float)0.9599999785423279;
...
func_218(var_42_int)
{
	...
	func_292(var_44_int, "armor", var_46_int, var_47_int, (int)15);
	...
	func_292(var_61_int, "armor_fire", var_63_int, var_64_int, (int)10);
	...
	func_292(var_75_int, "armor_disease", var_77_int, var_78_int, (int)30);
	...
	func_292(var_89_int, "audibility", var_91_int, var_92_int, (int)-10);
