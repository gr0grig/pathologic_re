...
maintask task_0
{
	void init(bool var_0_bool)
	{
		...
		for(;;) {
			...
			var_12_int = var_11_float / 0.96;
			if(var_12_int > 0) {
				var_100_int = var_11_float % 0.96;
...
void func_218(int var_42_int)
{
	...
	func_292(var_44_int, "armor", var_46_int, var_47_int, 15);
	...
	func_292(var_61_int, "armor_fire", var_63_int, var_64_int, 10);
	...
	func_292(var_75_int, "armor_disease", var_77_int, var_78_int, 30);
	...
	func_292(var_89_int, "audibility", var_91_int, var_92_int, -10);
