...
void func_218(int var_42_int)
{
	...
	func_292(var_44_int, "armor", var_46_int, var_47_int, 5);
	...
	func_292(var_61_int, "armor_fire", var_63_int, var_64_int, 5);
	...
	func_292(var_75_int, "armor_disease", var_77_int, var_78_int, 15);
	...
	func_292(var_89_int, "audibility", var_91_int, var_92_int, -5);
