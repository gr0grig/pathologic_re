maintask task_0
{
	...
	{
		bool var_0_bool;
		func_71(var_0_bool, "health", 0.03, (float)0, (float)1);
		bool var_16_bool;
...
void func_19(bool var_32_bool, float var_33_float)
{
	...
	if(var_34_bool != 0) {
		bool var_42_bool;
		func_71(var_42_bool, "health", (var_33_float * 0.1), (float)0, (float)1);
		bool var_48_bool;
		func_71(var_48_bool, "tiredness", (var_33_float * -0.1), (float)0, (float)1);
	}
	var_32_bool = false;
}
