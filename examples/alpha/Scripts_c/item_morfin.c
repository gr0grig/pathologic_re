...
main()
{
	...
	func_71(var_0_bool, "health", (float)0.20000000298023224, (float)0, (float)1);
...
func_19(var_32_bool, var_33_float)
{
	...
	if(var_34_bool != 0) {
		...
		var_44_float = var_33_float * (float)0.15000000596046448;
		...
		var_50_float = var_33_float * (float)-0.15000000596046448;
