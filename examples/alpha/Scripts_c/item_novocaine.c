...
main()
{
	...
	func_71(var_0_bool, "health", (float)0.10000000149011612, (float)0, (float)1);
	var_16_bool = 0; var_17_string = ""; var_18_float = 0; var_19_float = 0; var_20_float = 0;
	func_71(var_16_bool, "tiredness", (float)0.10000000149011612, (float)0, (float)1);
	var_21_float = 0;
	func_42((float)10.0);
	return 0;
}
...
func_19(var_32_bool, var_33_float)
{
	...
	if(var_34_bool != 0) {
		...
		var_44_float = var_33_float * (float)0.10000000149011612;
		...
		var_50_float = var_33_float * (float)-0.10000000149011612;
