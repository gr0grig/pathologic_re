...
Label_28:
	...
	var_12_int = var_11_float / (float)0.7200000286102295;
	var_98_bool = var_12_int > (int)0;
	if(var_98_bool != 0) {
		var_100_int = var_11_float % (float)0.7200000286102295;
...
func_218(var_42_int)
{
	...
	func_292(var_61_int, "armor_fire", var_63_int, var_64_int, (int)5);
	...
	func_292(var_75_int, "armor_disease", var_77_int, var_78_int, (int)35);
	...
	func_292(var_82_int, "visibility", var_84_int, var_85_int, (int)-10);
