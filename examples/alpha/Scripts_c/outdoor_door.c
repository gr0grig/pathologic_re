maintask task_0
{
	...
	void OnUse(object actor)
	{
		...
		func_79(var_24_int, var_25_string, "@");
		int var_10_int;
...
void func_89(string var_32_string, string var_33_string, int var_34_int, int var_35_int)
{
...
void func_84(string var_39_string, string var_40_string, int var_41_int)
{
...
void func_79(int var_24_int, string var_25_string, string var_26_string)
{
	int var_28_int;
