// @IMPORTS: sync/1,IsVisirOn/1,GetProperty/2,SetProperty/2,SwitchVisir/1,HasProperty/2
...
Label_2:
	...
	if(var_12_bool != 0) {
		...
		var_55_bool = var_9_bool;
		if(var_55_bool != 0) {
			(float)0 = (float)0 + var_7_float;
			var_56_int = 0;
			var_6_float = var_56_int;
			var_10_int = var_56_int / (int)3;
			var_58_int = var_10_int;
			if(var_58_int != 0) {
				GetProperty("vcharge", var_11_int);
				var_61_int = 0; var_62_int = 0; var_63_int = 0; var_64_int = 0;
				var_62_int = var_11_int + var_10_int;
				func_125(var_61_int, var_62_int, (int)0, (int)100);
...
func_96(var_30_bool, var_31_int)
{
	...
	func_125(var_35_int, var_36_int, (int)0, (int)100);
