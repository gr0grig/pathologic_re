maintask task_0
{
	...
	Label_122:
		if(var_9_string == "d11q02_trigger") {
			func_364(var_3_object, "execute");
			var_6_bool = true;
		} else if(var_9_string == "execute") {
			func_364(var_4_object, "execute");
			func_232();
		} else if(var_9_string == "soldier_attack") {
			func_364(var_3_object, "attack");
		}
...
void func_364(object var_90_object, string var_91_string)
{
	int var_95_int; object var_97_object;
	var_90_object->size(var_95_int);
	int var_96_int = 0;
	
	while(var_96_int < var_95_int) {
...
void func_345(object var_126_object)
{
