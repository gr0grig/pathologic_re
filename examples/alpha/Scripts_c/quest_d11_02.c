...
task_0_event_26(var_0_object, var_1_object, var_2_object, var_3_object, var_4_object, var_5_bool, var_6_bool, var_7_int, var_8_bool, var_9_string)
{
	...
	if(var_23_bool != 0) {
		...
		if(var_89_bool != 0) {
			...
			func_364(var_90_object, "execute");
			var_6_bool = true;
			goto Label_220;
		}
		var_102_bool = var_9_string == "execute";
		if(var_102_bool != 0) {
			var_103_object = Obj(); var_104_string = "";
			var_103_object = var_4_object;
			func_364(var_103_object, "execute");
			var_6_bool = false;
			func_232();
			goto Label_220;
		}
		var_118_bool = var_9_string == "soldier_attack";
		if(var_118_bool != 0) {
			var_119_object = Obj(); var_120_string = "";
			var_119_object = var_3_object;
			func_364(var_119_object, "attack");
			goto Label_220;
		}
		var_122_bool = var_9_string == "actor_unload";
		if(var_122_bool != 0) {
			var_123_int = var_7_int;
			if(var_123_int != 0) {
				var_125_bool = var_7_int == (int)1;
				if(var_125_bool != 0) {
					func_248(var_19_int, var_20_object, var_21_bool);
				}
			} else {
				var_139_bool = var_6_bool;
				if(var_139_bool == 0) goto Label_175;
				var_6_bool = false;
				func_232();
				func_248(var_19_int, var_20_object, var_21_bool);
		}
			var_141_bool = var_9_string == "soldier_dead";
			if(var_141_bool != 0) {
				@@@var_3_object:size(var_18_int);
				var_19_int = 0;

			Label_182:
				var_142_bool = var_19_int < var_18_int;
				if(var_142_bool != 0) {
					@@@var_3_object:get(var_20_object, var_19_int);
					var_143_object = var_20_object;
					if(var_143_object == 0) goto Label_193;
					@@var_20_object:IsDead(var_21_bool);
					var_144_bool = var_21_bool == 0; //@nz
					if(var_144_bool != 0) {
					} else {
						var_20_object = 0;
					...
					var_151_bool = var_9_string == "fail";
					if(var_151_bool != 0) {
						func_232();
						goto Label_220;
					}
					var_153_bool = var_9_string == "completed";
					if(var_153_bool == 0) goto Label_220;
					func_240();
				}
			}
			var_145_bool = var_19_int == var_18_int;
			if(var_145_bool != 0) {
				SetVariable("d11q02", (int)2);
				var_148_bool = var_7_int == 0; //@nz
				if(var_148_bool != 0) {
					var_7_int = 1;
				}
			}
...
func_364(var_90_object, var_91_string)
{
...
Label_368:
	var_98_bool = var_96_int < var_95_int;
	if(var_98_bool != 0) {
...
func_248(var_3_object, var_4_object, var_7_int)
{
	...
	func_345(var_126_object);
	var_136_object = Obj();
	var_136_object = var_4_object;
	func_345(var_136_object);
	var_137_bool = var_8_bool;
	if(var_137_bool != 0) {
		var_138_object = Obj();
		func_315(var_138_object);
