...
// @PE: 0x3f,0xc0,0xd0,0x1b8,0x230,0x288,0x28e,0x299,0x2aa,0x2bb,0x2c1,0x2c7,0x2cc,0x2d8,0x2e4,0x2f0,0x2fc,0x308
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		...
		var_58_bool = var_8_bool == (int)15363;
		if(var_58_bool != 0) {
		...
		var_64_bool = var_8_bool == (int)15365;
		if(var_64_bool != 0) {
			...
			func_711(var_109_object);
		}
		var_112_bool = var_8_bool == (int)15366;
		if(var_112_bool != 0) {
		...
		var_118_bool = var_8_bool == (int)15368;
		if(var_118_bool != 0) {
			var_119_object = Obj(); var_120_object = Obj();
			var_119_object = var_1_object;
			var_120_object = var_0_object;
			func_711(var_120_object);
		}
		var_122_bool = var_7_bool == (int)15356;
		if(var_122_bool != 0) {
			var_123_bool = 0; var_124_object = Obj();
			var_124_object = var_1_object;
			func_716(var_124_object);
			if(var_123_bool != 0) {
				var_129_string = "";
				func_192(var_8_bool, "Neutral");
				@@@var_0_object:SetMessage((int)14142);
				@@@var_0_object:ClearReplies();
				@@@var_0_object:AddReply((int)14143, (int)15359, (int)15357);
				return 0;
			}
			var_148_string = "";
			func_192(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)14147);
			@@@var_0_object:ClearReplies();
			var_150_bool = 0;
			var_150_bool = 1;
			var_151_bool = 0;
			...
			if(var_150_bool != 0) {
				@@@var_0_object:AddReply((int)14149, (int)15364, (int)15363);
			}
			var_176_bool = 0;
			var_176_bool = 0;
			var_177_bool = 0; var_178_object = Obj();
			var_178_object = var_1_object;
			func_740(var_178_object);
			if(var_177_bool != 0) {
				var_183_bool = 0; var_184_object = Obj();
				var_184_object = var_1_object;
				func_776(var_184_object);
				if(var_183_bool != 0) {
					var_176_bool = 1;
				}
			}
			if(var_176_bool != 0) {
				@@@var_0_object:AddReply((int)14152, (int)15367, (int)15366);
			}
			@@@var_0_object:AddReply((int)14148, (int)-1, (int)15362);
			return 0;
		}
		var_196_bool = var_7_bool == (int)15367;
		if(var_196_bool != 0) {
			var_197_string = "";
			func_192(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)14153);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)14154, (int)-1, (int)15368);
			return 0;
		}
		var_203_bool = var_7_bool == (int)15364;
		if(var_203_bool != 0) {
			var_204_string = "";
			func_192(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)14150);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)14151, (int)-1, (int)15365);
			return 0;
		}
		var_210_bool = var_7_bool == (int)15359;
		if(var_210_bool != 0) {
			var_211_string = "";
			func_192(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)14145);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)14146, (int)-1, (int)15360);
			@@@var_0_object:AddReply((int)14144, (int)-1, (int)15358);
			return 0;
		}
		var_3_string = true;
		var_219_bool = 0;
...
task_2_event_26(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_bool, var_6_bool, var_7_string)
{
	...
	if(var_11_bool != 0) {
		...
		if(var_19_bool == 0) goto Label_485;
		var_0_object = false;
	}
Label_485:
	return 2;
...
func_654(var_85_object)
{
	...
	func_623(var_88_object, "revolver_ammo", (int)6);
	return 0;
}
...
func_847()
{
	...
	func_801(var_23_bool, var_24_object, (int)-1);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_863()
{
	...
	func_801(var_79_bool, var_80_object, (int)197);
	return 2;
}
EMIT "Stack[-1] = 0";
...
func_879()
{
	...
	func_801(var_48_bool, var_49_object, (int)197);
	return 2;
}
EMIT "Stack[-1] = 0";
