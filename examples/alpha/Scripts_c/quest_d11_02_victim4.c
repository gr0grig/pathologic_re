...
// @STANDALONE_EVENT_6: op=0x191 vars=
// @PE: 0x3f,0x74,0x84,0xbb,0x158
...
task_1_event_11(var_0_object, var_1_object, var_2_object, var_3_string, var_4_bool, var_5_int, var_6_int, var_7_bool, var_8_bool)
{
	if((int)1 != 0) {
		...
		if(var_12_bool != 0) {
			...
			@@@var_0_object:SetMessage((int)14181);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)14182, (int)15397, (int)15396);
			return 0;
		}
		var_33_bool = var_7_bool == (int)15397;
		if(var_33_bool != 0) {
			var_34_string = "";
			func_116(var_8_bool, "Neutral");
			@@@var_0_object:SetMessage((int)14183);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)14184, (int)-1, (int)15398);
			return 0;
		}
		var_3_string = true;
		var_39_bool = 0;
...
func_242(var_0_object, var_17_string)
{
	...
	if(var_21_bool != 0) {
		...
		if(var_29_bool == 0) goto Label_269;
		var_0_object = false;
	}
Label_269:
	return 2;
