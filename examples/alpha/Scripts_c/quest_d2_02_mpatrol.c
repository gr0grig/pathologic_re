...
// @STANDALONE_EVENT_17: op=0x5cd vars=object
// @STANDALONE_EVENT_6: op=0x5de vars=
// @STANDALONE_EVENT_22: op=0x5f6 vars=object,int,float,float
// @STANDALONE_EVENT_16: op=0x5fe vars=object,string
// @STANDALONE_EVENT_41: op=0x60b vars=object
// @PE: 0xf,0x12,0x1fa,0x266,0x278,0x283,0x28c,0x297,0x303,0x319,0x31b,0x31d,0x35e,0x398,0x3a8,0x3e9,0x3ff,0x40c,0x469,0x584,0x5af,0x5b6,0x5f6,0x60b,0x611,0x618
...
task_4_event_11(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_int, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int, var_14_cvector, var_15_cvector)
{
	if((int)1 != 0) {
		func_1434();
		var_19_bool = var_15_cvector == (int)8305;
		if(var_19_bool != 0) {
		...
		var_29_bool = var_15_cvector == (int)8306;
		if(var_29_bool != 0) {
		...
		var_36_bool = var_14_cvector == (int)8304;
		if(var_36_bool != 0) {
			var_37_string = "";
			func_920(var_15_cvector, "Neutral");
			@@@var_0_object:SetMessage((int)7522);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)7523, (int)-1, (int)8305);
			@@@var_0_object:AddReply((int)7524, (int)-1, (int)8306);
			return 0;
		}
		var_3_bool = true;
		var_59_bool = 0;
...
func_265(var_0_object, var_1_int, var_236_bool, var_237_float)
{
	...
	func_1254(var_262_bool, var_263_object);
	...
	if(var_338_bool != 0) {
		...
		func_1254(var_342_bool, var_343_object);
			...
			if(var_162_bool != 0) {
				...
				if(var_169_bool != 0) {
					...
					if(var_182_bool != 0) {
						...
						func_1254(var_365_bool, var_366_object);
...
func_1560()
{
	var_32_bool = 0; var_33_string = ""; var_34_string = "";
...
func_409(var_0_object, var_206_bool)
{
	...
	func_1254(var_217_bool, var_218_object);
...
Label_370:
	...
	if(var_205_bool != 0) {
		...
		func_1254(var_231_bool, var_232_object);
...
func_1149(var_279_float, var_280_object, var_281_float, var_282_int)
{
	...
	func_1455(var_315_float, var_316_float, (float)1);
	...
	func_1462(var_325_float, var_326_float, (float)0, (float)1);
