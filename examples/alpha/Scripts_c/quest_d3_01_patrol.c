...
// @STANDALONE_EVENT_22: op=0x640 vars=object,int,float,float
// @STANDALONE_EVENT_16: op=0x648 vars=object,string
// @STANDALONE_EVENT_41: op=0x655 vars=object
// @PE: 0xf,0x12,0x1fa,0x266,0x278,0x283,0x28c,0x297,0x303,0x319,0x31b,0x31d,0x35e,0x398,0x3a8,0x461,0x46b,0x4d6,0x5f1,0x61c,0x623,0x640,0x655
...
task_4_event_11(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_int, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int, var_14_cvector, var_15_cvector, var_16_bool)
{
	if((int)1 != 0) {
		func_1543();
		var_20_bool = var_15_cvector == (int)9981;
		if(var_20_bool != 0) {
			var_21_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9102);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9103, (int)9989, (int)9982);
			@@@var_0_object:AddReply((int)9104, (int)9985, (int)9983);
			return 0;
		}
		var_44_bool = var_15_cvector == (int)9985;
		if(var_44_bool != 0) {
			var_45_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9106);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9107, (int)9984, (int)9986);
			return 0;
		}
		var_51_bool = var_15_cvector == (int)9984;
		if(var_51_bool != 0) {
			var_52_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9105);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9108, (int)9988, (int)9987);
			return 0;
		}
		var_58_bool = var_15_cvector == (int)9988;
		if(var_58_bool != 0) {
			var_59_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9109);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9112, (int)9992, (int)9991);
			return 0;
		}
		var_65_bool = var_15_cvector == (int)9989;
		if(var_65_bool != 0) {
			var_66_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9110);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9111, (int)9992, (int)9990);
			return 0;
		}
		var_72_bool = var_15_cvector == (int)9992;
		if(var_72_bool != 0) {
			var_73_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9113);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9114, (int)9994, (int)9993);
			@@@var_0_object:AddReply((int)9116, (int)-1, (int)9995);
			return 0;
		}
		var_82_bool = var_15_cvector == (int)9994;
		if(var_82_bool != 0) {
			var_83_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9115);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9117, (int)-1, (int)9997);
			@@@var_0_object:AddReply((int)9118, (int)9999, (int)9998);
			return 0;
		}
		var_92_bool = var_15_cvector == (int)9999;
		if(var_92_bool != 0) {
			var_93_string = "";
			func_920(var_16_bool, "Neutral");
			@@@var_0_object:SetMessage((int)9119);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)9120, (int)-1, (int)10000);
			return 0;
		}
		var_3_bool = true;
		var_98_bool = 0;
...
task_5_event_0(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_int, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_cvector, var_13_cvector, var_14_bool, var_15_object)
{
	...
	if(var_16_bool != 0) {
		...
		func_1121(var_15_object, var_17_object);
	}
	return 0;
}
...
func_265(var_0_object, var_1_int, var_238_bool, var_239_float)
{
	...
	func_1363(var_264_bool, var_265_object);
	...
	if(var_340_bool != 0) {
		...
		func_1363(var_344_bool, var_345_object);
			...
			if(var_164_bool != 0) {
				...
				if(var_171_bool != 0) {
					...
					if(var_184_bool != 0) {
						...
						func_1363(var_367_bool, var_368_object);
...
func_409(var_0_object, var_208_bool)
{
	...
	func_1363(var_219_bool, var_220_object);
...
Label_890:
	...
	Label_894:
		...
		if(var_111_bool != 0) {
			...
			var_112_string = "";
			var_112_string = var_2_int;
			func_1525(var_112_string);
			goto Label_894;
	}
...
func_1258(var_281_float, var_282_object, var_283_float, var_284_int)
{
	...
	func_1564(var_317_float, var_318_float, (float)1);
	...
	func_1571(var_327_float, var_328_float, (float)0, (float)1);
...
Label_370:
	...
	if(var_207_bool != 0) {
		...
		func_1363(var_233_bool, var_234_object);
