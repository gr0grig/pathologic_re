		...
		if(1 != 0) {
			...
			if(var_12_int == 12892) {
				...
				if(var_50_bool != 0) {
					...
					var_0_object->SetMessage(11690); //@t
					var_0_object->ClearReplies(); //@t
					var_0_object->AddReply(11691, 12894, 12893); //@t
					return 0;
				}
				func_948(var_13_int, "Neutral");
				var_0_object->SetMessage(12483); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(12484, -1, 13652); //@t
				return 0;
			}
			if(var_12_int == 12894) {
				func_948(var_13_int, "Neutral");
				var_0_object->SetMessage(11692); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(11693, 12901, 12895); //@t
				var_0_object->AddReply(11694, 12898, 12896); //@t
				var_0_object->AddReply(11695, 12898, 12897); //@t
				return 0;
			}
			if(var_12_int == 12898) {
				func_948(var_13_int, "Neutral");
				var_0_object->SetMessage(11696); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(11697, 12901, 12900); //@t
				return 0;
			}
			if(var_12_int == 12901) {
				func_948(var_13_int, "Neutral");
				var_0_object->SetMessage(11698); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(11699, 12904, 12902); //@t
				return 0;
			}
			if(var_12_int == 12904) {
				func_948(var_13_int, "Neutral");
				var_0_object->SetMessage(11700); //@t
				var_0_object->ClearReplies(); //@t
				var_0_object->AddReply(11701, -1, 12905); //@t
				var_0_object->AddReply(11702, -1, 12906); //@t
				return 0;
			}
			var_3_bool = true;
			bool var_119_bool;
...
void func_1156(bool var_13_bool)
{
	var_13_bool = true;
}


void func_1542(float var_39_float)
{
	float var_41_float;
...
void func_265(object var_0_object, int var_1_int, bool var_234_bool, float var_235_float)
{
	...
	bool var_260_bool;
	func_1304(var_260_bool, var_0_object);
	if(!var_260_bool) { //@nz
		@StopAsync();
		var_234_bool = false;
		return 4;
	...
	if(var_239_bool != 0) {
		...
		@WaitForAnimEnd();
		bool var_340_bool;
		func_1304(var_340_bool, var_0_object);
		if(!var_340_bool) { //@nz
			@StopAsync();
			var_234_bool = false;
			return 4;
...
void func_1530(bool var_23_bool, string var_24_string, string var_25_string)
{
	...
	for(;;) {
		...
		for(;;) {
			...
			for(;;) {
				...
				bool var_66_bool;
				func_1304(var_66_bool, var_0_object);
				if(var_66_bool != 0) {
					if(!var_3_bool) //@nz
						var_65_bool = true;
				}
				if(var_65_bool != 0) {
					...
					if(var_45_float >= (var_26_float * var_26_float)) {
						...
						if(var_180_bool != 0) {
							...
							bool var_363_bool;
							func_1304(var_363_bool, var_0_object);
							if(!var_363_bool) { //@nz
								goto Label_209;
							}
							var_0_object->GetPFPosition(var_40_cvector); //@t
...
void func_1304(bool var_66_bool, object var_67_object)
{
...
void func_409(object var_0_object, bool var_204_bool)
{
	...
	bool var_215_bool;
	func_1304(var_215_bool, var_0_object);
	if(!var_215_bool) { //@nz
		var_204_bool = false;
		return 10;
	}
...
// @pe
void func_1179(string var_305_string, int var_306_int)
{
	if(var_306_int == 1)
		var_305_string = "fire";
	var_305_string = "phys";
...
void func_1406(bool var_26_bool, object var_27_object)
{
	...
	func_1497(var_51_cvector, (var_40_cvector ^ [0.0, 1.0, 0.0]));
...
void func_1187(bool var_88_bool, object var_89_object, string var_90_string)
{
...
void func_1580(void)
{
	...
	var_25_object->AddMark("d5q01PatrolGotoGrif", "pt_map_grif", 1, 15349, var_39_float);
}
EMIT "Stack[-1] = 0";
...
void func_812(object var_0_object, int var_15_int, object var_16_object)
{
	...
	for(;;) {
		...
		if(var_125_bool == 0) goto Label_864;
		@sync();
		var_22_object->IsDialogEnd(var_25_bool);
	}
...
void func_1199(float var_277_float, object var_278_object, float var_279_float, int var_280_int)
{
	...
	float var_313_float;
	func_1507(var_313_float, ((var_290_int + var_292_int) / 100.0), (float)1);
	float var_293_float;
	var_313_float = var_293_float;
	float var_294_float;
	var_278_object->GetProperty("health", var_294_float);
	float var_323_float;
	func_1514(var_323_float, (var_294_float - (var_279_float * (1 - var_293_float))), (float)0, (float)1);
...
void func_1328(object var_16_object, int var_17_int)
{
...
// @pe
void func_948(int var_2_int, string var_93_string)
{
	bool var_94_bool;
	func_1650(var_94_bool);
	if(!var_94_bool) //@nz
		return 0;
	if(var_93_string == var_2_int)
		return 0;
	string var_97_string;
	func_1466(var_97_string);
	var_2_int = var_97_string;
}
...
void func_1466(string var_97_string)
{
	@Trace("playing " + var_97_string);
	float var_100_float;
	float var_101_float;
	@lshGetAnimTimes(var_97_string, var_100_float, var_101_float);
	@lshPlayAnimation(var_100_float, var_101_float);
	@Trace("start: " + var_100_float);
	@Trace("end: " + var_101_float);
}


// @pe
void func_1600(bool var_85_bool)
{
	int var_87_int;
...
void func_1612(object var_28_object)
{
...
void func_1491(object var_12_object)
{
	object var_14_object;
	@self(var_14_object);
...
void func_1497(cvector var_51_cvector, cvector var_52_cvector)
{
...
// @pe
void func_1507(float var_313_float, float var_314_float, float var_315_float)
{
...
// @pe
void func_1514(float var_323_float, float var_324_float, float var_325_float, float var_326_float)
{
...
// @pe
void func_1134(object var_14_object)
{
	object var_16_object;
...
void func_1648(string var_68_string)
{
...
void func_369(object var_0_object, bool var_191_bool, float var_192_float)
{
	...
	for(;;) {
		...
		bool var_229_bool;
		func_1304(var_229_bool, var_0_object);
		if(!var_229_bool) { //@nz
			var_191_bool = false;
			return 10;
		}
...
void func_1650(bool var_94_bool)
{
	var_94_bool = false;
}


void func_1395(object var_169_object)
{
...
void func_1263(bool var_81_bool, object var_82_object)
{
	bool var_84_bool;
...
void func_1268(bool var_70_bool, object var_71_object)
{
...
void func_1652(object var_13_object)
{
	bool var_15_bool;
...
void func_1525(int var_87_int, string var_88_string)
{
	int var_90_int;
