...
// @STANDALONE_EVENT_22: op=0x568 vars=object,int,float,float
// @STANDALONE_EVENT_16: op=0x570 vars=object,string
// @STANDALONE_EVENT_41: op=0x57d vars=object
// @PE: 0xf,0x12,0x1fa,0x266,0x278,0x283,0x28c,0x297,0x310,0x326,0x328,0x32a,0x36b,0x3a0,0x3b0,0x3d5,0x3e1,0x3f8,0x402,0x51d,0x54a,0x551,0x568,0x57d
...
task_4_event_11(var_0_object, var_1_int, var_2_int, var_3_bool, var_4_int, var_5_bool, var_6_object, var_7_object, var_8_object, var_9_object, var_10_string, var_11_bool, var_12_int, var_13_int)
{
	if((int)1 != 0) {
		func_1331();
		var_17_bool = var_12_int == (int)13710;
		if(var_17_bool != 0) {
			var_18_string = "";
			func_928(var_13_int, "Neutral");
			@@@var_0_object:SetMessage((int)12541);
			@@@var_0_object:ClearReplies();
			@@@var_0_object:AddReply((int)12542, (int)-1, (int)13711);
			return 0;
		}
		var_3_bool = true;
		var_37_bool = 0;
...
func_265(var_0_object, var_1_int, var_234_bool, var_235_float)
{
	...
	func_1151(var_260_bool, var_261_object);
	...
	if(var_336_bool != 0) {
		...
		func_1151(var_340_bool, var_341_object);
			...
			if(var_160_bool != 0) {
				...
				if(var_167_bool != 0) {
					...
					if(var_180_bool != 0) {
						...
						func_1151(var_363_bool, var_364_object);
...
func_1046(var_277_float, var_278_object, var_279_float, var_280_int)
{
	...
	func_1354(var_313_float, var_314_float, (float)1);
	...
	func_1361(var_323_float, var_324_float, (float)0, (float)1);
...
func_409(var_0_object, var_204_bool)
{
	...
	func_1151(var_215_bool, var_216_object);
...
func_928(var_2_int, var_85_string)
{
	...
	var_88_bool = var_85_string == var_2_int;
	if(var_88_bool != 0) {
		return 0;
	}
	var_89_string = "";
...
Label_898:
	...
	Label_902:
		lshWaitForAnimEnd();
		var_105_bool = var_3_bool;
		if(var_105_bool != 0) {
		} else {
			var_106_string = "";
			var_106_string = var_2_int;
			func_1313(var_106_string);
			goto Label_902;
	}
...
Label_370:
	...
	if(var_203_bool != 0) {
		...
		func_1151(var_229_bool, var_230_object);
