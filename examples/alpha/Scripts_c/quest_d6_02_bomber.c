...
void func_1288(string var_60_string, int var_61_int)
{
...
void func_1549(bool var_13_bool, object var_14_object, object var_15_object)
{
...
// @pe
void func_1428(int var_124_int, float var_125_float)
{
...
void func_1312(int var_20_int, int var_21_int)
{
	int var_27_int;
...
// @pe
void func_1442(float var_208_float, int var_209_int)
{
	if(var_209_int == 1)
		var_208_float = 30;
	var_208_float = 700;
	...
	for(;;) {
		...
		if(var_67_bool != 0) {
			...
			if(var_45_int == 0) {
				...
				func_1288(var_76_string, var_77_int);
...
// @pe
void func_1450(float var_230_float, float var_232_float)
{
	if(var_232_float < 10) {
		var_230_float = 10;
		return 0;
...
void func_1587(bool var_14_bool, object var_15_object)
{
...
// @pe
void func_1464(bool var_12_bool, object var_13_object)
{
	object var_15_object;
...
void func_1342(void)
{
	...
	if(var_17_int != 0) {
		int var_43_int;
		func_1379(var_43_int, "rifle_ammo");
		@AddItem(var_18_bool, var_43_int, 0, var_17_int);
	}
	@irand(var_17_int, 3);
	if(var_17_int == 0) {
		int var_51_int;
		func_1379(var_51_int, "rusk");
...
// @pe
void func_1471(object var_67_object)
{
...
// @pe
void func_1479(bool var_12_bool, object var_13_object)
{
	object var_15_object;
	var_13_object = var_15_object;
	bool var_14_bool;
...
void func_843(bool var_0_bool, object var_46_object)
{
	...
	if(var_0_bool == null) {
		...
		func_1587(var_49_bool, var_50_object);
		if(var_49_bool != 0)
			var_47_bool = true;
	}
	if(var_47_bool != 0) {
...
// @pe
void func_1486(object var_67_object)
{
	TaskCall(4);
	object var_68_object;
...
// @pe
void func_1496(object var_47_object)
{
...
void func_1379(int var_43_int, string var_44_string)
{
	int var_46_int;
...
void func_1384(float var_159_float, cvector var_160_cvector, cvector var_161_cvector, cvector var_162_cvector)
{
...
void func_361(bool var_70_bool, object var_71_object, object var_72_object)
{
	...
	func_1587(var_76_bool, var_77_object);
	if(!var_76_bool) { //@nz
		var_70_bool = false;
		return 2;
	}
...
// @pe
void func_1518(object var_12_object)
{
	object var_13_object;
...
void func_623(bool var_0_bool, bool var_1_bool, object var_49_object, object var_121_object)
{
	...
	Label_690:
		...
		func_1450(var_231_int, var_232_float);
