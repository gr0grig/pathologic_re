...
// @PE: 0x15,0x21,0x2d,0x3d,0x53,0x5f,0x6a,0xb3,0xca,0xe1,0xfc,0x108,0x114,0x11d,0x130,0x19e,0x1b4,0x1b6,0x1b8,0x1ba,0x2a0,0x2a7,0x3c3,0x3cb,0x3e0,0x463,0x470,0x47e,0x48c
...
{
	var_159_cvector = CVector(0,0,0); var_160_float = 0; var_161_cvector = CVector(0,0,0); var_162_float = 0;
	@@var_158_object:GetPosition(var_161_cvector);
	var_165_bool = IsFuncExist(var_158_object, "@GetHeight", (int)1);
	if(var_165_bool != 0) {
		@@var_158_object:GetHeight(var_162_float);
		var_166_float = GetByIndex(var_161_cvector, 1);
		var_168_float = var_162_float / (int)2;
		var_166_float = var_166_float + var_168_float;
		SetByIndex(var_161_cvector, 1) = var_166_float;
	}
	var_169_cvector = CVector(0,0,0);
...
func_1164(var_74_bool, var_75_object, var_76_object)
{
	var_77_bool = var_76_object == 0; //@ne
	if(var_77_bool != 0) {
		var_74_bool = 0;
		return 0;
	}
	...
	if(var_80_bool != 1) {
		...
		var_83_float = 0; var_84_object = Obj();
		var_75_object = var_84_object;
		func_450(var_83_float, var_84_object);
		var_86_int = var_83_float - (int)25;
		var_87_bool = var_81_float < var_86_int;
		if(var_87_bool != 1) {
			var_74_bool = 0;
		}
	}
...
{
	var_14_bool = 0; var_15_float = 0; var_16_bool = 0; var_17_float = 0;
	...
	@@var_53_object:in(var_16_bool, var_13_object);
	var_54_bool = var_16_bool;
	if(var_54_bool != 0) {
		var_12_bool = 1;
		return 4;
	}
	...
	@@var_13_object:GetProperty("disease", var_17_float);
	var_12_bool = var_17_float > (int)0;
	return 4;
}
...
func_865(var_169_cvector)
{
	var_170_cvector = CVector(0,0,0); var_171_float = 0; var_172_cvector = CVector(0,0,0); var_173_float = 0; var_174_bool = 0; var_175_cvector = CVector(0,0,0); var_176_float = 0; var_177_cvector = CVector(0,0,0); var_178_float = 0; var_179_bool = 0;
	GetPosition(var_175_cvector);
	GetHeight(var_176_float);
	var_180_float = GetByIndex(var_175_cvector, 1);
	var_182_float = var_176_float / (int)2;
	var_180_float = var_180_float + var_182_float;
	SetByIndex(var_175_cvector, 1) = var_180_float;
	var_177_cvector = var_169_cvector - var_175_cvector;
	var_183_int = var_177_cvector | var_177_cvector;
	var_178_float = sqrt(var_183_int);
	var_185_bool = var_178_float < (int)50;
	if(var_185_bool != 0) {
		var_179_bool = 0;
	} else {
			var_190_float = GetByIndex(var_177_cvector, 1);
			var_191_float = var_190_float / var_178_float;
			var_179_bool = var_191_float < (float)-0.1428571492433548;
	}
...
Label_124:
	...
	if(var_118_bool != 0) {
		...
		var_144_bool = var_122_bool == 0; //@nz
		if(var_144_bool != 1) {
			var_145_bool = 0; var_146_object = Obj();
			var_146_object = var_0_object;
			func_1123(var_145_bool, var_146_object);
