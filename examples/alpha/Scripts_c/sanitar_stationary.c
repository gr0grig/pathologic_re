...
task task_1
{
	...
	void OnSee(object actor, bool var_1_bool, object var_2_object)
	{
		...
		if(var_5_bool != 0) {
			bool var_71_bool; object var_73_object;
			var_2_object = var_73_object;
			func_1164(var_71_bool, actor, var_73_object);
			if(var_71_bool != 0)
				var_4_bool = true;
		}
		if(var_4_bool != 0) {
...
void func_896(object var_155_object)
{
	cvector var_158_cvector; float var_159_float;
	var_155_object->GetPosition(var_158_cvector);
	var_162_bool = IsFuncExist(var_155_object, "@GetHeight", 1);
	if(var_162_bool != 0) {
		var_155_object->GetHeight(var_159_float);
		var_163_float = GetByIndex(var_158_cvector, 1);
		SetByIndex(var_158_cvector, 1) = (var_163_float + (var_159_float / 2));
	}
...
// @pe
void func_1164(bool var_71_bool, object var_72_object, object var_73_object)
{
...
void func_915(bool var_9_bool, object var_10_object)
{
	...
	bool var_13_bool;
	var_50_object->in(var_13_bool, var_16_object);
	if(var_13_bool != 0) {
		var_9_bool = true;
		return 4;
	}
	...
	float var_14_float;
	var_53_object->GetProperty("disease", var_14_float);
	var_9_bool = var_14_float > 0;
}
...
void func_865(cvector var_166_cvector)
{
	cvector var_172_cvector; bool var_176_bool;
	@GetPosition(var_172_cvector);
	float var_173_float;
	@GetHeight(var_173_float);
	var_177_float = GetByIndex(var_172_cvector, 1);
	SetByIndex(var_172_cvector, 1) = (var_177_float + (var_173_float / 2));
	cvector var_174_cvector = var_166_cvector - var_172_cvector;
	float var_175_float = sqrt(var_174_cvector | var_174_cvector);
	if(var_175_float < 50) {
		var_176_bool = false;
	} else {
			var_187_float = GetByIndex(var_174_cvector, 1);
			var_176_bool = (var_187_float / var_175_float) < -0.14285715;
	}
	if(var_176_bool != 0)
...
Label_111:
	...
	for(;;) {
		...
		if(var_118_bool != 0) {
			...
			var_141_bool = !var_122_bool; //@nz
			if(var_141_bool != 1) {
				bool var_142_bool;
				func_1123(var_142_bool, var_0_object);
				var_149_bool = !var_142_bool; //@nz
				if(var_149_bool != 1)
					var_121_bool = false;
			}
			if(var_121_bool != 0)
