...
// @STRINGS: W:quest_d8_01|W:termitnik_load|W:pt_d11q04_Klara|W:NPC_Klara|W:d11q04_Klara.xml|A:GetLocator|W:Locator |W: doesn't exist
// @RUN_OP: 0x0
// @RUN_TASK: 0
...
task_0_event_5(var_0_bool)
{
	...
	func_54(var_3_bool, "quest_d8_01", "termitnik_load");
	var_9_bool = var_0_bool == 0; //@nz
	if(var_9_bool != 0) {
		GetGameTime(var_2_float);
		var_11_bool = var_2_float >= (int)240;
		if(var_11_bool != 0) {
			var_0_bool = true;
			var_12_object = Obj(); var_13_object = Obj(); var_14_string = ""; var_15_string = ""; var_16_string = "";
			func_30(Obj());
			var_17_object = var_13_object;
			func_36(var_12_object, var_13_object, "pt_d11q04_Klara", "NPC_Klara", "d11q04_Klara.xml");
		}
	}
	return 2;
}
