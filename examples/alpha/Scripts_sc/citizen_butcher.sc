		...
		for (; L1 < 5 && f_6f0_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_762_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t3
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_606_a1_V(tv0);
		if (f_725_a2_f(L0, L1) < 0.4999999701976776) {
			f_6e5_a1_v(tv0);
		}
	}
...
task t4
{
	...
	void f_442_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_36f_a2_f(L0, a1);
			L2 = f_621_a3_f(L0, L1, f_372_a2_i(L0, a1));
...
bool f_615_a2_b(object a0, string a1)
{
	bool L0;
...
float f_621_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_615_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_615_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
	...
	L3 = f_700_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_707_a3_f(L4 - L5, 0, 1));
	return L5;
}
...
bool f_666_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_661_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_6a2_a3_v(object a0, int a1, float a2)
{
	if (a1 != 4 && a1 != 5) {
		object L0;
		object L1;
...
float f_700_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_707_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
float f_712_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_71b_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_725_a2_f(Vector a0, Vector a1)
{
	return f_712_a2_f(a0, a1) / (f_71b_a1_f(a0) * f_71b_a1_f(a1));
}
...
int f_769_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_762_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_78b_a1_i(object a0)
{
	return f_68a_a1_b(a0) ? 2 : 0;
}
...
int f_79d_a1_i(object a0)
{
	return f_78b_a1_i(a0);
}
...
int f_7af_a2_i(string a0, object a1)
{
	return 0;
}

void f_7b2_a2_v(string a0, object a1)
{
}

int f_7b4_a1_i(object a0)
{
	return 2;
}

void f_7b7_a1_v(object a0)
{
	f_898_a1_v(a0);
}
...
void f_7dc_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_7be_a2_v(0, 100 + f_736_a0_i() * 100);
		@irand(L0, 9);
		if (L0 == 0) {
			@AddItem(L1, f_88b_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_88b_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_88b_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_88b_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_88b_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_88b_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_7be_a2_v(0, 50 + f_736_a0_i() * 50);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_88b_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_88b_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_88b_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_88b_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_88b_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_88b_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
bool f_8a3_a0_b(void)
{
	return false;
}

bool f_8a5_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
	if (!f_615_a2_b(a1, "class")) {
		return false;
	}
	a1->GetProperty("class", L0);
	if (L0 != "littleboy" && L0 != "littlegirl" && L0 != "boy" && L0 != "girl" && L0 != "wasted_girl" && L0 != "woman" && L0 != "butcher") {
		return false;
	}
	@CanSee(L1, a0);
	if (L1 || f_60d_a1_f(a0) <= 250000.0) {
