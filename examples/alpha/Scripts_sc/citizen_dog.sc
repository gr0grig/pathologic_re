		...
		for (; L1 < 5 && f_6f0_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_759_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
int f_760_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_759_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_771_a1_i(object a0)
{
	return f_7c4_a0_b() ? 2 : 0;
}

void f_77a_a1_v(object a0)
{
	t3{a0};
}

int f_782_a1_i(object a0)
{
...
int f_794_a1_i(object a0)
{
	return f_782_a1_i(a0);
}
...
int f_7a6_a2_i(string a0, object a1)
{
	return 0;
}

void f_7a9_a2_v(string a0, object a1)
{
}

int f_7ab_a1_i(object a0)
{
	return 2;
}
...
void f_7b4_a0_v(void)
{
}

void f_7b5_a0_v(void)
{
	g0 = false;
}
...
bool f_7c4_a0_b(void)
{
	return false;
}

bool f_7c6_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
