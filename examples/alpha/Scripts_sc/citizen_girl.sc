...
int f_8b6_a2_i(string a0, object a1)
{
	return 0;
}

void f_8b9_a2_v(string a0, object a1)
{
}
...
void f_8be_a1_v(object a0)
{
	f_990_a1_v(a0);
}

void f_8c4_a0_v(void)
{
}
...
void f_8f9_a1_v(bool a0)
{
	bool L0;
	int L1;
	@ClearSubContainer(0);
	f_8db_a2_v(0, 10 + f_838_a0_i() * 10);
	@irand(L1, 4);
	if (L1 == 0) {
		@AddItem(L0, f_96f_a1_i("hook"), 0, 1);
	}
	@irand(L1, 10);
	if (L1 == 0) {
		@AddItem(L0, f_96f_a1_i("watch"), 0, 1);
	}
}

void f_925_a1_v(bool a0)
{
	int L0;
	bool L1;
	@ClearSubContainer(0);
	if (a0) {
		@irand(L0, 3);
		if (L0 != 0) {
			@AddItem(L1, f_96f_a1_i("alpha_pills"), 0, L0);
		}
		@irand(L0, 3);
		if (L0 != 0) {
			@AddItem(L1, f_96f_a1_i("meradorm"), 0, L0);
		}
	} else {
		@irand(L0, 3);
		if (L0 == 0) {
			@AddItem(L1, f_96f_a1_i("lockpick"), 0, 1);
		}
		@irand(L0, 4);
		if (L0 != 0) {
			@AddItem(L1, f_96f_a1_i("rifle_ammo"), 0, L0);
		}
		@irand(L0, 4);
		if (L0 != 0) {
			@AddItem(L1, f_96f_a1_i("revolver_ammo"), 0, L0);
		}
	}
}

int f_96f_a1_i(string a0)
{
	int L0;
...
{
	return f_974_a0_f() > 0.6000000238418579;
}

bool f_9bc_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
	if (!f_6ce_a2_b(a1, "class")) {
		return false;
	}
	...
	@CanSee(L1, a0);
	if (L1 || f_6c6_a1_f(a0) <= 250000.0) {
		@ReportReputationChange(a0, a1, -0.30000001192092896);
		return true;
	}
	@CanSee(L1, a1);
	if (L1 || f_6c6_a1_f(a1) <= 250000.0) {
		return true;
	}
	return false;
}

void f_9f5_a1_v(object a0)
{
	g1 = true;
	@SetRTEnvelope(50, 40);
	f_8f9_a1_v(false);
