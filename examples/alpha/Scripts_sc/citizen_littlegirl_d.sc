...
void f_6ee_a1_v(bool a0)
{
	...
	int L1;
	@ClearSubContainer(0);
	f_6d0_a2_v(0, 3 + f_649_a0_i() * 5);
	@irand(L1, 4);
	if (L1 == 0) {
		@AddItem(L0, f_71a_a1_i("flower"), 0, 1);
	}
	@irand(L1, 5);
	if (L1 == 0) {
		@AddItem(L0, f_71a_a1_i("needle"), 0, 1);
	}
}

int f_71a_a1_i(string a0)
{
	int L0;
...
bool f_73c_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
