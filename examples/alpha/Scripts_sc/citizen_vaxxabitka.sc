...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			f_578_a1_v("Neutral");
			tv0->SetMessage(15230);
			tv0->ClearReplies();
			tv0->AddReply(15231, -1, 16508);
			break;
			return;
		}
		if (f_89f_a0_b()) {
...
bool f_8dd_a0_b(void)
{
	return f_8a1_a0_f() > 0.8999999761581421;
}

bool f_8e3_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
