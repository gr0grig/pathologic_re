		...
		for (; L1 < 5 && f_59d_a0_b(); L1++) {
			...
			if (L2 == 0) {
				if (L0) {
					...
					bool L4;
					@irand(L3, L0);
					@PlayAnimation("all", f_615_a1_s(L3));
					@WaitForAnimEnd(L4);
					if (!L4) {
						break;
					}
...
task t3
{
	...
	void OnTimer(int a0)
	{
		...
		@GetDirection(L0);
		L1 = f_4f3_a1_V(tv0);
		if (f_5d8_a2_f(L0, L1) < 0.4999999701976776) {
			f_592_a1_v(tv0);
		}
	}
...
task t4
{
	...
	Vector f_38a_a1_V(float a0)
	{
		...
		tv0->GetPosition(L1);
		@GetDirection(L2);
		L3 = f_5b3_a1_V(f_5b3_a1_V(L0 - L1) + L2 * 0.75);
	...
	bool f_42c_a0_b(void)
	{
		...
		@GetDirection(L0);
		L1 = f_4f3_a1_V(tv0);
		return f_5bd_a2_f(L0, L1) >= -0.3420201241970062;
	}
}
...
float f_5bd_a2_f(Vector a0, Vector a1)
{
	return (a0 | a1) / sqrt((a0 | a0) * (a1 | a1));
}

float f_5c5_a2_f(Vector a0, Vector a1)
{
	return a0.x * a1.x + a0.z * a1.z;
}

float f_5ce_a1_f(Vector a0)
{
	return sqrt(a0.x * a0.x + a0.z * a0.z);
}

float f_5d8_a2_f(Vector a0, Vector a1)
{
	return f_5c5_a2_f(a0, a1) / (f_5ce_a1_f(a0) * f_5ce_a1_f(a1));
}
...
int f_61c_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_615_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
int f_62d_a1_i(object a0)
{
	return f_778_a0_b() ? 2 : 0;
}
...
int f_650_a1_i(object a0)
{
	return f_537_a1_b(a0) ? 2 : 0;
}

void f_65a_a1_v(object a0)
{
	t5{a0};
}

int f_662_a1_i(object a0)
{
	return 0;
}
...
int f_667_a2_i(string a0, object a1)
{
	return 0;
}

void f_66a_a2_v(string a0, object a1)
{
}

int f_66c_a1_i(object a0)
{
	return 2;
}
...
void f_694_a1_v(bool a0)
{
	int L0;
	bool L1;
	if (a0) {
		f_676_a2_v(0, 100 + f_5e9_a0_i() * 100);
		@irand(L0, 9);
		if (L0 == 0) {
			@AddItem(L1, f_743_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_743_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_743_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_743_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_743_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_743_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_676_a2_v(0, 50 + f_5e9_a0_i() * 50);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_743_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_743_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_743_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_743_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_743_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_743_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
void f_756_a0_v(void)
{
	object L0;
	@GetActiveScene(L0);
	@BroadcastMessage("killme", f_5ad_a0_o(), L0);
}

void f_761_a0_v(void)
{
	g1 = false;
	f_694_a1_v(false);
}
...
{
	f_756_a0_v();
	return f_748_a0_f() > 0.699999988079071;
}

bool f_781_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
	...
	@CanSee(L1, a1);
	if (L1 || f_4fa_a1_f(a1) <= 250000.0) {
		return true;
	}
	return false;
}

void f_7c0_a1_v(object a0)
{
	g1 = true;
	@SetRTEnvelope(50, 40);
}
