...
void f_835_a1_v(bool a0)
{
	...
	bool L1;
	if (a0) {
		f_817_a2_v(0, 100 + f_795_a0_i() * 100);
		@irand(L0, 9);
		if (L0 == 0) {
			@AddItem(L1, f_8e4_a1_i("lemon"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_8e4_a1_i("rusk"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_8e4_a1_i("hook"), 0, 1);
				} else {
					if (L0 == 4) {
						@AddItem(L1, f_8e4_a1_i("syringe"), 0, 1);
					} else {
						if (L0 == 5) {
							@AddItem(L1, f_8e4_a1_i("watch"), 0, 1);
						} else {
							if (L0 == 6) {
								@AddItem(L1, f_8e4_a1_i("razor"), 0, 1);
							}
						}
					}
				}
		...
		f_817_a2_v(0, 50 + f_795_a0_i() * 50);
		@irand(L0, 8);
		if (L0 == 0) {
			@AddItem(L1, f_8e4_a1_i("beads"), 0, 1);
		} else {
			if (L0 == 1) {
				@AddItem(L1, f_8e4_a1_i("bracelet"), 0, 1);
			} else {
				if (L0 == 2) {
					@AddItem(L1, f_8e4_a1_i("ear_ring"), 0, 1);
				} else {
					if (L0 == 3) {
						@AddItem(L1, f_8e4_a1_i("gold_ring"), 0, 1);
					} else {
						if (L0 == 4) {
							@AddItem(L1, f_8e4_a1_i("silver_ring"), 0, 1);
						} else {
							if (L0 == 5) {
								@AddItem(L1, f_8e4_a1_i("flower"), 0, 1);
							}
						}
					}
				}
...
void f_8e9_a0_v(void)
{
	g0 = false;
	f_835_a1_v(true);
}

void f_8f1_a1_v(object a0)
{
	if (g0) {
		bool L0;
		@IsOverrideActive(L0);
...
int f_901_a1_i(object a0)
{
	return 0;
}

void f_904_a1_v(object a0)
{
}

bool f_906_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
