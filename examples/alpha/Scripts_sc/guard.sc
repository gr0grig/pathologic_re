...
float f_444_a3_f(object a0, float a1, int a2)
{
	...
	L3 = f_51c_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_523_a3_f(L4 - L5, 0, 1));
	return L5;
}
...
float f_518_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_51c_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_523_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
int f_558_a0_i(void)
{
	...
	for (L0 = 0; ; L0++) {
		bool L1;
		@HasAnimation(L1, "all", f_551_a1_s(L0));
		if (!L1) {
			break;
		}
	}
...
void f_56c_a0_v(void)
{
	...
	@irand(L1, L0);
	@PlayAnimation("all", f_551_a1_s(L1));
	@WaitForAnimEnd();
}

int f_580_a1_i(object a0)
{
...
int f_592_a1_i(object a0)
{
	return f_580_a1_i(a0);
}
...
void f_59f_a0_v(void)
{
	t0{};
}

int f_5a5_a1_i(object a0)
{
	return 2;
}
...
int f_5ae_a1_i(object a0)
{
	return 0;
}

void f_5b1_a1_v(object a0)
{
}

int f_5b3_a2_i(string a0, object a1)
{
	return 0;
}

void f_5b6_a2_v(string a0, object a1)
{
}

void f_5b8_a0_v(void)
{
	g0 = false;
}

void f_5bc_a1_v(object a0)
{
	if (g0) {
		@WorkWithCorpse(a0);
		return;
...
bool f_5c3_a2_b(object a0, object a1)
{
	string L0;
	bool L1;
