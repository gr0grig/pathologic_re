...
task t8
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			f_5a5_a1_v("Neutral");
			tv0->SetMessage(13394);
			tv0->ClearReplies();
			tv0->AddReply(13396, -1, 14630);
			tv0->AddReply(13395, -1, 14629);
			break;
			f_5a5_a1_v("Neutral");
			tv0->SetMessage(14749);
			tv0->ClearReplies();
			tv0->AddReply(14750, 15997, 15996);
			tv0->AddReply(14760, -1, 16006);
			break;
			f_5a5_a1_v("Neutral");
			tv0->SetMessage(14761);
			tv0->ClearReplies();
			tv0->AddReply(14762, 16009, 16008);
			tv0->AddReply(14770, -1, 16016);
			break;
			return;
		}
		if (f_953_a0_b()) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 16009) {
				f_5a5_a1_v("Neutral");
				tv0->SetMessage(14763);
				tv0->ClearReplies();
				tv0->AddReply(14764, 16011, 16010);
				tv0->AddReply(14769, -1, 16015);
				return;
			}
			if (a0 == 16011) {
				f_5a5_a1_v("Neutral");
				tv0->SetMessage(14765);
				tv0->ClearReplies();
				tv0->AddReply(14766, -1, 16012);
				tv0->AddReply(14767, -1, 16013);
				tv0->AddReply(14768, -1, 16014);
				return;
			}
			if (a0 == 15997) {
				f_5a5_a1_v("Neutral");
				tv0->SetMessage(14751);
				tv0->ClearReplies();
				tv0->AddReply(14752, 15999, 15998);
				tv0->AddReply(14759, -1, 16005);
				return;
			}
			if (a0 == 15999) {
				f_5a5_a1_v("Neutral");
				tv0->SetMessage(14753);
				tv0->ClearReplies();
				tv0->AddReply(14754, -1, 16000);
				tv0->AddReply(14755, 16002, 16001);
				return;
			}
			if (a0 == 16002) {
				f_5a5_a1_v("Neutral");
				tv0->SetMessage(14756);
				tv0->ClearReplies();
				tv0->AddReply(14757, -1, 16003);
				tv0->AddReply(14758, -1, 16004);
				return;
			}
			tv3 = true;
			if (f_953_a0_b()) {
...
int f_88d_a2_i(string a0, object a1)
{
	return 0;
}

void f_890_a2_v(string a0, object a1)
{
}
...
bool f_983_a0_b(void)
{
	return true;
}

bool f_985_a2_b(object a0, object a1)
{
	bool L0;
	@CanSee(L0, a0);
	if (L0 || f_693_a1_f(a0) <= 250000.0) {
		@ReportReputationChange(a0, a1, -0.30000001192092896);
		@SetProperty("ToDie", true);
		return true;
	}
	@CanSee(L0, a1);
	if (L0 || f_693_a1_f(a1) <= 250000.0) {
		@SetProperty("ToDie", true);
		return true;
	}
	return false;
