maintask t0
{
	void init(void)
	{
		f_47_a4_b("health", 0.3499999940395355, 0, 1);
		f_47_a4_b("tiredness", 0.05000000074505806, 0, 1);
		f_2a_a1_v(10.0);
	}
}
...
{
	if (f_5a_a0_b()) {
		f_47_a4_b("health", a0 * 0.009999999776482582, 0, 1);
		f_47_a4_b("tiredness", a0 * -0.009999999776482582, 0, 1);
	}
	return false;
}
