maintask t0
{
	void init(void)
	{
		f_47_a4_b("health", 0.20000000298023224, 0, 1);
		f_47_a4_b("tiredness", 0.25, 0, 1);
		f_2a_a1_v(10.0);
	}
}
...
{
	if (f_5a_a0_b()) {
		f_47_a4_b("health", a0 * 0.15000000596046448, 0, 1);
		f_47_a4_b("tiredness", a0 * -0.15000000596046448, 0, 1);
	}
	return false;
}
