...
maintask t0
{
	...
	void init(void)
	{
		...
		for (; ; ) {
			...
			@GetGameTime(L1);
			L2 = L1 - L0;
			L3 = L2 / 0.7200000286102295;
			if (L3 > 0) {
				int L4;
				L0 = L1 - L2 % 0.7200000286102295;
...
{
	g3 = f_124_a4_i("armor", g3, a0, 10);
	g4 = f_124_a4_i("armor_fire", g4, a0, 5);
	g5 = f_124_a4_i("armor_phys", g5, a0, 0);
	g6 = f_124_a4_i("armor_disease", g6, a0, 35);
	g7 = f_124_a4_i("visibility", g7, a0, -10);
	g8 = f_124_a4_i("audibility", g8, a0, 0);
}
