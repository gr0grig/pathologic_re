...
maintask t0
{
	...
	void OnUse(object a0)
	{
		...
		L2 = f_59_a3_s(L0, 0, L1);
		L3 = "pt_" + f_54_a2_s(L0, L1 + 1);
...
int f_4f_a2_i(string a0, string a1)
{
	int L0;
	@_strchr(L0, a0, a1);
	return L0;
...
string f_54_a2_s(string a0, int a1)
{
	string L0;
	@_strsub(L0, a0, a1);
	return L0;
...
string f_59_a3_s(string a0, int a1, int a2)
{
	string L0;
	@_strsub(L0, a0, a1, a2);
	return L0;
