...
task t0
{
	...
	void f_e2_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_f_a2_f(L0, a1);
			L2 = f_47d_a3_f(L0, L1, f_12_a2_i(L0, a1));
...
task t3
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_630_a0_i());
		L0->SetPhoto(f_632_a0_s());
		L0->SetPlayerName(f_61f_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			...
			tv0->SetMessage(7522);
			tv0->ClearReplies();
			tv0->AddReply(7523, -1, 8305);
			tv0->AddReply(7524, -1, 8306);
			break;
			return;
		}
		if (f_634_a0_b()) {
...
maintask t5
{
	...
	void f_3f7_a0_v(void)
	{
		g0 = false;
		f_416_a0_v();
	}

	void f_3fe_a0_v(void)
	{
	}
...
float f_47d_a3_f(object a0, float a1, int a2)
{
	...
	L1 = "armor_" + f_469_a1_s(a2);
	if (!f_471_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_5af_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_5b6_a3_f(L4 - L5, 0, 1));
	return L5;
}
...
bool f_4c2_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_4bd_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_4fe_a3_v(object a0, int a1, float a2)
{
	if (a1 != 4 && a1 != 5) {
		object L0;
		object L1;
...
bool f_54c_a1_b(object a0)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * 70 + f_5a1_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
float f_5ab_a2_f(Vector a0, Vector a1)
{
	Vector L0;
	L0 = a1 - a0;
	return L0 | L0;
...
float f_5af_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_5b6_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
bool f_5c1_a2_b(string a0, string a1)
{
	object L0;
	@FindActor(L0, a0);
	if (L0 == null) {
...
void OnAttacked(object a0)
{
	...
	if (L0) {
		g0 = true;
		f_5c1_a2_b("quest_d2_02", "player_attack");
	}
}

void OnUnload(void)
{
	f_5c1_a2_b("quest_d2_02", "mpatrol_unload");
}
...
void f_611_a2_v(object a0, object a1)
{
	f_5c1_a2_b("quest_d2_02", "player_attack");
}
...
{
	f_5c1_a2_b("quest_d2_02", "completed");
}
...
string f_632_a0_s(void)
{
	return "ui/NPC_Black.png";
}

bool f_634_a0_b(void)
{
	return false;
}
