...
task t0
{
	...
	void f_e2_a2_v(float a0, int a1)
	{
		...
		if (L0 == tv0) {
			...
			float L2;
			L1 = f_f_a2_f(L0, a1);
			L2 = f_4af_a3_f(L0, L1, f_12_a2_i(L0, a1));
...
task t3
{
	...
	int init(object a0)
	{
		...
		@CreateDialog(L0);
		L0->SetNPCName(f_66e_a0_i());
		L0->SetPhoto(f_670_a0_s());
		L0->SetPlayerName(f_65d_a0_i());
		L2 = -1;
		@IsOverrideActive(L1);
		if (L1) {
			return -2;
...
task t4
{
	...
	void init(object a0, object a1)
	{
		...
		while (1) {
			if (f_640_a1_b(tv1)) {
				f_3b4_a1_v("Neutral");
				tv0->SetMessage(11690);
				tv0->ClearReplies();
				tv0->AddReply(11691, 12894, 12893);
				break;
			}
			f_3b4_a1_v("Neutral");
			tv0->SetMessage(12483);
			tv0->ClearReplies();
			tv0->AddReply(12484, -1, 13652);
			break;
			return;
		}
		if (f_672_a0_b()) {
	...
	void evt_11(int a0, int a1)
	{
		while (1) {
			...
			if (a0 == 12894) {
				f_3b4_a1_v("Neutral");
				tv0->SetMessage(11692);
				tv0->ClearReplies();
				tv0->AddReply(11693, 12901, 12895);
				tv0->AddReply(11694, 12898, 12896);
				tv0->AddReply(11695, 12898, 12897);
				return;
			}
			if (a0 == 12898) {
				f_3b4_a1_v("Neutral");
				tv0->SetMessage(11696);
				tv0->ClearReplies();
				tv0->AddReply(11697, 12901, 12900);
				return;
			}
			if (a0 == 12901) {
				f_3b4_a1_v("Neutral");
				tv0->SetMessage(11698);
				tv0->ClearReplies();
				tv0->AddReply(11699, 12904, 12902);
				return;
			}
			if (a0 == 12904) {
				f_3b4_a1_v("Neutral");
				tv0->SetMessage(11700);
				tv0->ClearReplies();
				tv0->AddReply(11701, -1, 12905);
				tv0->AddReply(11702, -1, 12906);
				return;
			}
			tv3 = true;
			if (f_672_a0_b()) {
...
maintask t5
{
	...
	void OnAttacked(object a0)
	{
		...
		@IsPlayerActor(a0, L0);
		if (L0) {
			f_5fa_a2_b("quest_d5_01", "factory_fight");
		}
	}
...
bool f_4a3_a2_b(object a0, string a1)
{
	bool L0;
...
float f_4af_a3_f(object a0, float a1, int a2)
{
	int L0;
	string L1;
	int L2;
	...
	float L4;
	float L5;
	if (!f_4a3_a2_b(a0, "health")) {
		return 0.0;
	}
	if (!f_4a3_a2_b(a0, "armor")) {
		L0 = 0;
	} else {
		a0->GetProperty("armor", L0);
	}
	L1 = "armor_" + f_49b_a1_s(a2);
	if (!f_4a3_a2_b(a0, L1)) {
		L2 = 0;
	} else {
		a0->GetProperty(L1, L2);
	}
	L3 = f_5e3_a2_f((L0 + L2) / 100.0, 1);
	a0->GetProperty("health", L4);
	L5 = a1 * (1 - L3);
	a0->SetProperty("health", f_5ea_a3_f(L4 - L5, 0, 1));
	return L5;
}
...
bool f_4f4_a1_b(object a0)
{
	...
	if (a0->FuncExist("IsDead", 1) && f_4ef_a1_b(a0)) {
		return false;
	}
	@GetScene(L0);
	if (L0 == null) {
...
void f_530_a3_v(object a0, int a1, float a2)
{
	if (a1 != 4 && a1 != 5) {
		object L0;
		object L1;
...
bool f_57e_a1_b(object a0)
{
	...
	L3 = L3 / sqrt(L3 | L3);
	L4 = -L3;
	L5 = L3 * 70 + f_5d9_a1_V(L4 ^ [0.0, 1.0, 0.0]) * 25 - [0.0, 10.0, 0.0];
	L6 = L2 + L5;
	@IsOverrideActive(L7);
	if (L7) {
		return false;
...
float f_5e3_a2_f(float a0, float a1)
{
	return a0 < a1 ? a0 : a1;
}

float f_5ea_a3_f(float a0, float a1, float a2)
{
	if (a0 < a1) {
		return a1;
	}
...
void f_626_a2_v(object a0, object a1)
{
...
void f_62c_a2_v(object a0, object a1)
{
	...
	@SetVariable("d5q01", 6);
	L0 = f_64c_a0_o();
	L0->AddMark("d5q01PatrolGotoGrif", "pt_map_grif", 1, 15349, f_606_a0_f());
}

bool f_640_a1_b(object a0)
{
	if (f_5f5_a1_i("ood5PatrolGuard1") == 0) {
		return true;
	}
	return false;
}

object f_64c_a0_o(void)
{
	object L0;
	object L1;
